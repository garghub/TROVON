...
{
struct V_284 * V_107 = F_107 ( V_108 ) ;
...
if ( ! V_130 )
return - V_151 ;
snprintf ( V_2 -> V_292 , sizeof( V_2 -> V_292 ) , L_7 ,
F_115 ( V_2 -> V_169 ) ) ;
V_130 -> V_167 = V_2 -> V_107 -> V_161 ;
V_130 -> V_292 = V_2 -> V_292 ;
V_130 -> V_129 . V_293 = V_294 ;
V_130 -> V_129 . V_295 = V_2 -> V_169 -> V_295 ;
V_130 -> V_129 . V_296 = V_2 -> V_169 -> V_159 ;
V_130 -> V_108 . V_297 = & V_2 -> V_169 -> V_108 ;
F_116 ( V_298 , V_130 -> V_299 ) ;
F_116 ( V_131 , V_130 -> V_300 ) ;
F_116 ( V_133 , V_130 -> V_300 ) ;
F_116 ( V_132 , V_130 -> V_300 ) ;
V_45 = F_117 ( V_130 ) ;
if ( V_45 ) {
F_118 ( V_130 ) ;
return V_45 ;
...
static int F_119 ( struct V_301 * V_159 )
{
struct V_1 * V_2 = V_159 -> V_302 ;
return F_96 ( V_2 ) ;
}
static int
F_120 ( struct V_284 * V_107 , struct V_245 * V_169 ,
int V_303 ,
int V_240 ,
struct V_1 * * V_304 )
{
...
static struct V_307 V_202 = {
. V_308 = F_119 ,
} ;
* V_304 = NULL ;
if ( F_121 ( V_169 ) )
return - V_309 ;
if ( F_122 ( V_169 , F_123 ( 28 ) ) < 0 ||
F_124 ( V_169 , F_123 ( 28 ) ) < 0 ) {
F_37 ( V_107 -> V_108 ,
L_8 ) ;
F_105 ( V_169 ) ;
return - V_46 ;
}
V_2 = F_125 ( sizeof( * V_2 ) , V_310 ) ;
if ( V_2 == NULL ) {
F_105 ( V_169 ) ;
return - V_151 ;
}
...
V_306 = F_128 ( V_169 , V_318 ) ;
if ( V_306 ) {
F_129 ( V_107 -> V_108 , L_10 ,
F_130 ( V_306 ) ) ;
V_2 -> V_189 = 1 ;
}
V_306 = F_128 ( V_169 , V_319 ) ;
if ( V_306 )
V_2 -> V_261 = V_306 -> V_3 ;
if ( F_128 ( V_169 , V_320 ) )
V_2 -> V_244 = 1 ;
V_2 -> V_146 = V_321 ;
...
F_88 ( V_2 , 1 ) ;
F_89 ( V_2 ) ;
if ( F_136 ( V_169 -> V_134 , F_56 , V_322 ,
V_323 , V_2 ) ) {
...
#ifdef F_100
V_2 -> V_283 = F_137 ( sizeof( T_1 ) * ( V_324 + V_325 ) ) ;
if ( V_2 -> V_283 == NULL )
F_138 ( V_107 -> V_108 , L_14 ) ;
#endif
if ( ( V_45 = F_139 ( V_107 , V_326 , V_2 , & V_202 ) ) < 0 ) {
F_96 ( V_2 ) ;
return V_45 ;
}
if ( ( V_45 = F_80 ( V_2 ) ) < 0 )
...
static int
F_140 ( struct V_245 * V_169 , const struct V_327 * V_328 )
{
static int V_108 ;
struct V_284 * V_107 ;
struct V_1 * V_2 ;
int V_45 ;
if ( ( ( V_169 -> V_329 >> 8 ) & 0xffff ) != V_330 )
return - V_331 ;
if ( V_108 >= V_332 )
return - V_331 ;
if ( ! V_236 [ V_108 ] ) {
...
V_45 = F_141 ( & V_169 -> V_108 , V_7 [ V_108 ] , V_129 [ V_108 ] , V_334 ,
0 , & V_107 ) ;
if ( V_45 < 0 )
return V_45 ;
switch ( V_169 -> V_159 ) {
...
V_107 -> V_44 = V_2 ;
sprintf ( V_107 -> V_335 , L_19 , V_107 -> V_161 ) ;
sprintf ( V_107 -> V_336 , L_20 ,
V_107 -> V_335 , V_2 -> V_5 , V_2 -> V_134 ) ;
...
static void F_145 ( struct V_245 * V_169 )
{
F_142 ( F_146 ( V_169 ) ) ;
}
