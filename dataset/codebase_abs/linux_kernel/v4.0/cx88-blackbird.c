...
static int F_95 ( struct V_40 * V_41 )
{
int V_51 ;
V_41 -> V_196 = F_96 ( V_41 -> V_2 , V_41 -> V_67 ,
& V_197 , L_30 ) ;
V_41 -> V_196 -> V_198 = & V_41 -> V_74 . V_179 ;
F_97 ( V_41 -> V_196 , V_41 ) ;
V_41 -> V_196 -> V_199 = & V_41 -> V_166 ;
V_51 = F_98 ( V_41 -> V_196 , V_200 , - 1 ) ;
if ( V_51 < 0 ) {
F_99 ( V_201 L_31 ,
V_41 -> V_2 -> V_177 ) ;
return V_51 ;
...
F_99 ( V_201 L_32 ,
V_41 -> V_2 -> V_177 , F_100 ( V_41 -> V_196 ) ) ;
return 0 ;
}
static int F_101 ( struct V_126 * V_127 )
{
struct V_1 * V_2 = V_127 -> V_2 ;
...
V_41 -> V_74 . V_34 = V_41 ;
V_51 = F_102 ( & V_41 -> V_74 , 36 ) ;
if ( V_51 )
goto V_206;
F_103 ( & V_41 -> V_74 . V_179 , & V_2 -> V_210 , NULL ) ;
F_99 ( L_35 ,
V_2 -> V_177 ) ;
F_1 ( V_41 -> V_2 ) ;
F_26 ( V_41 ) ;
...
static int F_105 ( struct V_126 * V_127 )
{
struct V_1 * V_2 = V_127 -> V_2 ;
struct V_40 * V_41 = V_2 -> V_202 ;
F_91 ( V_127 -> V_2 -> V_202 ) ;
F_106 ( & V_41 -> V_74 . V_179 ) ;
return 0 ;
}
