...
static int
F_87 ( unsigned V_38 , struct V_112 * V_113 )
{
struct V_19 * V_20 ;
int V_102 = 0 ;
F_46 ( & V_70 [ V_38 ] . V_71 ) ;
...
V_20 = F_88 ( sizeof( struct V_19 ) , V_5 ) ;
if ( V_20 == NULL ) {
V_102 = - V_6 ;
goto V_46;
}
...
F_90 ( & V_20 -> V_36 ) ;
F_90 ( & V_20 -> V_85 ) ;
F_91 ( & V_20 -> V_58 , F_28 , ( unsigned long ) V_20 ) ;
F_92 ( & V_20 -> V_45 ) ;
F_92 ( & V_20 -> V_51 ) ;
F_92 ( & V_20 -> V_25 ) ;
V_20 -> V_38 = V_38 ;
...
{
F_95 ( & V_20 -> V_58 ) ;
F_96 ( V_20 -> V_85 , F_93 ( V_20 ) ) ;
F_51 ( V_20 -> V_29 != NULL ) ;
F_97 ( & V_20 -> V_20 ) ;
F_4 ( V_20 ) ;
}
void F_98 ( unsigned char V_38 )
{
struct V_19 * V_20 ;
F_46 ( & V_70 [ V_38 ] . V_71 ) ;
...
int F_100 ( unsigned char * V_116 )
{
struct V_112 V_113 ;
struct V_117 * V_118 ;
int V_102 ;
int V_38 ;
V_113 . V_119 = F_101 ( 9600 ) ;
V_113 . V_120 = 8 ;
V_113 . V_121 = V_122 ;
V_113 . V_123 = V_124 ;
for ( V_38 = 0 ; V_38 < V_125 ; V_38 ++ ) {
V_102 = F_87 ( V_38 , & V_113 ) ;
if ( V_102 == - V_74 )
continue;
if ( V_102 )
return V_102 ;
...
if ( V_102 )
return V_102 ;
V_118 = F_102 ( & V_70 [ V_38 ] . V_20 -> V_20 ,
V_115 , V_38 , NULL ) ;
if ( F_78 ( V_118 ) ) {
struct V_19 * V_20 ;
F_69 ( L_27 ,
...
int F_103 ( struct V_78 * V_79 , V_39 V_38 )
{
struct V_19 * V_20 ;
unsigned long V_86 ;
int V_27 ;
...
V_27 = F_104 ( V_79 -> V_26 ) ;
if ( V_27 < 0 )
return V_27 ;
V_79 -> V_26 -> V_59 = V_20 ;
V_27 = F_104 ( V_79 -> V_46 ) ;
if ( V_27 < 0 )
goto V_128;
V_79 -> V_46 -> V_59 = V_20 ;
F_55 ( & V_20 -> V_40 , V_86 ) ;
