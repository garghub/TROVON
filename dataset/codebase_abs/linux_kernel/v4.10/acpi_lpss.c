...
T_1 V_101 = V_102 ;
T_1 V_103 = V_104 ;
T_1 V_105 , V_106 , V_107 , V_108 = 0xfe000ffe ;
int V_59 ;
V_59 = F_64 ( V_109 , & V_105 ) ;
if ( V_59 )
return;
F_65 ( & V_110 ) ;
V_59 = F_64 ( V_111 , & V_106 ) ;
if ( V_59 )
goto exit;
V_107 = ( ~ ( V_106 | V_105 ) ) & V_108 ;
if ( V_107 )
goto exit;
F_66 ( V_112 , V_113 ,
V_114 , V_101 , V_103 ) ;
...
{
struct V_57 * V_58 = F_75 ( V_127 ) ;
struct V_1 * V_2 ;
struct V_25 * V_26 ;
const struct V_51 * V_52 ;
V_52 = F_76 ( V_128 , & V_58 -> V_29 ) ;
if ( ! V_52 || ! V_52 -> V_60 )
return 0 ;
...
return 0 ;
if ( V_2 -> V_8 &&
V_2 -> V_37 < V_2 -> V_5 -> V_6 + V_129 ) {
F_77 ( & V_58 -> V_29 , L_11 ) ;
return 0 ;
}
switch ( V_126 ) {
case V_130 :
F_78 ( & V_58 -> V_29 , & V_131 ) ;
break;
case V_132 :
case V_133 :
F_78 ( & V_58 -> V_29 , NULL ) ;
...
case V_134 :
F_78 ( & V_58 -> V_29 , & V_131 ) ;
if ( V_2 -> V_5 -> V_42 & V_135 )
return F_79 ( & V_58 -> V_29 . V_136 ,
& V_137 ) ;
break;
case V_138 :
if ( V_2 -> V_5 -> V_42 & V_135 )
F_80 ( & V_58 -> V_29 . V_136 , & V_137 ) ;
F_78 ( & V_58 -> V_29 , NULL ) ;
break;
default:
break;
...
{
struct V_1 * V_2 = F_42 ( F_47 ( V_29 ) ) ;
if ( ! V_2 || ! V_2 -> V_8 || ! ( V_2 -> V_5 -> V_42 & V_135 ) )
return;
if ( V_2 -> V_37 >= V_2 -> V_5 -> V_6 + V_129 )
V_29 -> V_70 . V_139 = F_46 ;
else
F_77 ( V_29 , L_11 ) ;
}
static void F_82 ( struct V_69 * V_29 )
{
V_29 -> V_70 . V_139 = NULL ;
}
void T_5 F_83 ( void )
{
const struct V_140 * V_52 ;
int V_59 ;
V_59 = F_84 () ;
if ( V_59 )
return;
