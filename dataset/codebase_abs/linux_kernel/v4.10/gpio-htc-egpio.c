...
if ( F_22 ( V_24 , & V_26 -> V_29 ) ) {
return ! ! ( V_26 -> V_30 & ( 1 << V_24 ) ) ;
} else {
V_1 = F_3 ( V_3 , V_4 ) ;
F_6 ( L_7 ,
...
static int F_23 ( struct V_22 * V_23 , unsigned V_24 )
{
struct V_25 * V_26 ;
V_26 = F_21 ( V_23 ) ;
return F_22 ( V_24 , & V_26 -> V_29 ) ? - V_31 : 0 ;
}
...
int V_34 ;
F_6 ( L_8 ,
V_23 -> V_35 , V_24 , V_24 + V_23 -> V_27 , V_1 ) ;
V_26 = F_21 ( V_23 ) ;
V_3 = F_16 ( V_26 -> V_19 ) ;
V_20 = F_19 ( V_3 , V_24 ) ;
V_33 = F_18 ( V_3 , V_24 ) ;
...
V_4 , ( V_26 -> V_30 >> V_34 ) & V_3 -> V_36 ) ;
F_25 ( & V_3 -> V_37 , V_32 ) ;
if ( V_1 )
V_26 -> V_30 |= ( 1 << V_24 ) ;
else
V_26 -> V_30 &= ~ ( 1 << V_24 ) ;
F_1 ( ( V_26 -> V_30 >> V_34 ) & V_3 -> V_36 , V_3 , V_4 ) ;
F_26 ( & V_3 -> V_37 , V_32 ) ;
}
...
static int F_28 ( struct V_22 * V_23 , unsigned V_24 )
{
struct V_25 * V_26 ;
V_26 = F_21 ( V_23 ) ;
return ! F_22 ( V_24 , & V_26 -> V_29 ) ;
}
...
if ( ! V_26 -> V_29 )
continue;
for ( V_34 = 0 ; V_34 < V_26 -> V_23 . V_40 ;
V_34 += ( 1 << V_3 -> V_21 ) ) {
int V_4 = V_26 -> V_28 + F_18 ( V_3 , V_34 ) ;
if ( ! ( ( V_26 -> V_29 >> V_34 ) & V_3 -> V_36 ) )
continue;
F_6 ( L_12 , V_4 ,
( V_26 -> V_30 >> V_34 ) & V_3 -> V_36 ,
F_3 ( V_3 , V_4 ) ) ;
F_1 ( ( V_26 -> V_30 >> V_34 )
& V_3 -> V_36 , V_3 , V_4 ) ;
}
...
{
struct V_43 * V_44 = F_31 ( & V_42 -> V_19 ) ;
struct V_45 * V_46 ;
struct V_2 * V_3 ;
struct V_22 * V_23 ;
...
int V_38 ;
int V_48 ;
V_3 = F_32 ( & V_42 -> V_19 , sizeof( * V_3 ) , V_49 ) ;
if ( ! V_3 )
return - V_50 ;
F_33 ( & V_3 -> V_37 ) ;
V_48 = - V_31 ;
V_46 = F_34 ( V_42 , V_51 , 0 ) ;
if ( V_46 )
V_3 -> V_52 = V_46 -> V_53 ;
V_46 = F_34 ( V_42 , V_54 , 0 ) ;
if ( ! V_46 )
goto V_55;
V_3 -> V_5 = F_35 ( & V_42 -> V_19 , V_46 -> V_53 ,
F_36 ( V_46 ) ) ;
if ( ! V_3 -> V_5 )
goto V_55;
...
goto V_55;
V_3 -> V_6 = F_37 ( V_44 -> V_57 - 1 ) - 3 ;
F_6 ( L_14 , V_3 -> V_6 ) ;
if ( ( V_44 -> V_58 != 8 ) && ( V_44 -> V_58 != 16 ) )
goto V_55;
V_3 -> V_21 = F_37 ( V_44 -> V_58 - 1 ) ;
F_6 ( L_15 , V_3 -> V_21 ) ;
V_3 -> V_36 = ( 1 << V_44 -> V_58 ) - 1 ;
F_38 ( V_42 , V_3 ) ;
V_3 -> V_39 = V_44 -> V_59 ;
V_3 -> V_23 = F_32 ( & V_42 -> V_19 ,
...
V_3 -> V_23 [ V_38 ] . V_30 = V_44 -> V_23 [ V_38 ] . V_60 ;
...
V_23 -> V_68 = F_27 ;
V_23 -> V_69 = F_28 ;
V_23 -> V_27 = V_44 -> V_23 [ V_38 ] . V_70 ;
V_23 -> V_40 = V_44 -> V_23 [ V_38 ] . V_71 ;
F_39 ( V_23 , & V_3 -> V_23 [ V_38 ] ) ;
}
F_29 ( V_3 ) ;
V_3 -> V_13 = V_44 -> V_72 ;
V_3 -> V_73 = V_44 -> V_74 ;
...
static int F_47 ( struct V_41 * V_42 , T_3 V_82 )
{
struct V_2 * V_3 = F_48 ( V_42 ) ;
if ( V_3 -> V_52 && F_49 ( & V_42 -> V_19 ) )
F_50 ( V_3 -> V_52 ) ;
return 0 ;
}
