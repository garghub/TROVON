...
int F_13 ( const struct V_15 * V_15 , struct V_4 * V_4 , T_1 V_16 )
{
struct V_4 * V_17 ;
struct V_1 * V_18 ;
int V_19 = 0 ;
...
int F_16 ( struct V_1 * V_26 , T_1 V_16 , const void * V_30 , int V_31 ,
...
T_1 V_52 = ( V_16 & ~ V_21 ) ;
if ( V_31 == V_22 )
V_3 = F_21 ( ( ( const struct V_15 * ) V_30 ) -> V_3 ) ;
else
V_3 = NULL ;
if ( F_22 ( & V_26 -> V_53 ) &&
( ! V_3 || F_22 ( & V_3 -> V_54 ) ) )
...
if ( ( V_16 & V_38 ) ||
( V_52 & V_26 -> V_20 ) )
V_46 = F_24 ( V_26 -> V_53 . V_57 ,
& V_56 ) ;
if ( V_3 && ( ( V_16 & V_38 ) ||
( V_52 & V_3 -> V_55 ) ) ) {
V_47 = F_24 ( V_3 -> V_54 . V_57 ,
& V_56 ) ;
V_46 = F_24 ( V_26 -> V_53 . V_57 ,
& V_56 ) ;
}
...
V_29 = NULL ;
if ( V_46 ) {
V_28 = F_25 ( F_24 ( V_46 , & V_56 ) ,
struct V_27 , V_58 ) ;
V_48 = V_28 -> V_35 ;
}
if ( V_47 ) {
V_29 = F_25 ( F_24 ( V_47 , & V_56 ) ,
struct V_27 , V_58 ) ;
V_49 = V_29 -> V_35 ;
}
if ( V_48 && V_49 ) {
