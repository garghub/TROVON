...
int V_20 ;
int (* F_48)( void );
V_16 = F_40 ( & V_69 -> V_22 , sizeof( * V_16 ) , V_28 ) ;
if ( ! V_16 )
return - V_29 ;
V_16 -> V_22 = & V_69 -> V_22 ;
V_47 = F_49 ( V_69 , V_70 , 0 ) ;
if ( ! V_47 ) {
F_14 ( V_16 -> V_22 , L_17 ) ;
return - V_62 ;
}
V_26 = F_29 ( V_47 ) ;
if ( ! F_50 ( V_16 -> V_22 , V_47 -> V_19 , V_26 , V_69 -> V_27 ) ) {
F_14 ( V_16 -> V_22 , L_18 ) ;
return - V_71 ;
}
if ( F_51 ( V_69 -> V_22 . V_50 , L_19 ) )
V_16 -> V_37 = F_52 ( V_16 -> V_22 , V_47 -> V_19 , V_26 ) ;
else
V_16 -> V_37 = F_53 ( V_16 -> V_22 , V_47 -> V_19 , V_26 ) ;
if ( ! V_16 -> V_37 )
return - V_29 ;
