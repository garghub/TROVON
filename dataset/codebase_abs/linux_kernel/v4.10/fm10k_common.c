...
V_57 = F_8 ( V_2 , F_9 ( V_58 ) ) ;
F_10 ( V_2 , F_9 ( V_58 ) ,
V_57 & ~ V_60 ) ;
V_57 = F_8 ( V_2 , F_11 ( V_58 ) ) ;
F_10 ( V_2 , F_11 ( V_58 ) ,
V_57 & ~ V_61 ) ;
}
F_12 ( V_2 ) ;
F_13 ( 1 ) ;
for ( V_58 = 0 , time = V_62 ; time ; ) {
if ( V_58 == V_56 )
return 0 ;
V_57 = F_8 ( V_2 , F_9 ( V_58 ) ) ;
if ( ! ~ V_57 || ! ( V_57 & V_60 ) ) {
...
{
return F_6 ( V_2 , V_2 -> V_51 . V_64 ) ;
}
T_3 F_15 ( struct V_1 * V_2 , T_3 V_65 ,
struct V_66 * V_67 )
{
T_3 V_68 = F_8 ( V_2 , V_65 ) - V_67 -> V_69 ;
if ( F_7 ( V_2 -> V_59 ) )
V_67 -> V_70 = 0 ;
return V_68 ;
}
static T_4 F_16 ( struct V_1 * V_2 , T_3 V_65 ,
struct V_66 * V_67 )
{
T_3 V_71 ;
T_3 V_72 ;
...
V_68 = ( ( T_4 ) ( V_72 - V_67 -> V_70 ) << 32 ) + V_71 ;
V_68 -= V_67 -> V_69 ;
return V_68 & V_74 ;
}
static void F_17 ( struct V_66 * V_67 , T_4 V_68 )
{
if ( ! V_68 )
return;
V_68 += V_67 -> V_69 ;
V_67 -> V_69 = ( T_3 ) V_68 ;
V_67 -> V_70 += ( T_3 ) ( V_68 >> 32 ) ;
}
...
T_3 V_78 , V_79 , V_80 ;
T_4 V_81 = 0 ;
V_78 = F_8 ( V_2 , F_19 ( V_77 ) ) ;
do {
V_80 = F_15 ( V_2 , F_20 ( V_77 ) ,
& V_76 -> V_80 ) ;
if ( V_80 )
V_81 = F_16 ( V_2 ,
F_21 ( V_77 ) ,
...
T_4 V_90 = 0 ;
V_86 = F_8 ( V_2 , F_11 ( V_77 ) ) ;
do {
V_89 = F_15 ( V_2 , F_24 ( V_77 ) ,
& V_76 -> V_89 ) ;
V_88 = F_15 ( V_2 , F_25 ( V_77 ) ,
& V_76 -> V_88 ) ;
if ( V_88 )
V_90 = F_16 ( V_2 ,
F_26 ( V_77 ) ,
...
struct V_50 * V_51 = & V_2 -> V_51 ;
T_1 V_96 = 0 ;
T_3 V_97 = F_8 ( V_2 , F_9 ( 0 ) ) ;
V_95 -> V_98 . V_99 ( V_2 , V_95 ) ;
if ( ! ( ~ V_97 ) || ! ( V_97 & V_60 ) )
V_51 -> V_100 = true ;
if ( ! V_51 -> V_100 || ! ( ~ V_97 ) )
goto V_101;
if ( V_2 -> V_51 . V_55 && ! ( V_97 & V_60 ) ) {
V_96 = V_102 ;
goto V_101;
}
if ( ! V_95 -> V_103 ) {
