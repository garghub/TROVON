...
if ( ! V_2 || ! V_14 || ! V_21 )
return - V_5 ;
V_21 = F_14 ( T_2 , V_21 , sizeof( V_23 ) - 1 ) ;
...
F_5 ( V_2 ) ;
F_19 ( & V_2 -> V_29 , L_13 ) ;
V_26 = F_20 ( & V_2 -> V_29 , & V_2 -> V_10 -> V_29 , L_13 ) ;
F_21 ( V_26 ) ;
F_22 ( & V_2 -> V_17 ) ;
F_17 (KERN_INFO PDCS_PREFIX L_14 ,
entry->name, buf) ;
return V_21 ;
}
static T_1
F_23 ( struct V_1 * V_2 , char * V_14 )
{
char * V_15 = V_14 ;
struct V_3 * V_4 ;
short V_16 ;
...
static T_1
F_24 ( struct V_1 * V_2 , const char * V_14 , T_2 V_21 )
{
unsigned int V_30 [ 6 ] ;
unsigned short V_16 ;
char V_23 [ 64 ] , * V_24 ;
...
F_5 ( V_2 ) ;
F_22 ( & V_2 -> V_17 ) ;
F_17 (KERN_INFO PDCS_PREFIX L_19 ,
entry->name, buf) ;
return V_21 ;
}
static T_1
F_26 ( struct V_31 * V_29 , struct V_32 * V_33 , char * V_14 )
{
struct V_1 * V_2 = F_27 ( V_29 ) ;
struct V_34 * V_35 = F_28 ( V_33 ) ;
T_1 V_26 = 0 ;
if ( V_35 -> V_36 )
...
static T_1
F_29 ( struct V_31 * V_29 , struct V_32 * V_33 ,
...
{
return F_32 ( V_29 , V_33 , V_14 , V_46 ) ;
}
static T_1 F_34 ( struct V_31 * V_29 ,
struct V_40 * V_33 , char * V_14 )
{
return F_32 ( V_29 , V_33 , V_14 , V_47 ) ;
}
...
F_5 ( V_43 ) ;
F_22 ( & V_43 -> V_17 ) ;
F_17 (KERN_INFO PDCS_PREFIX L_31 ,
...
const char * V_14 , T_2 V_21 )
{
return F_42 ( V_29 , V_33 , V_14 , V_21 , V_46 ) ;
}
static T_1 F_45 ( struct V_31 * V_29 ,
struct V_40 * V_33 ,
const char * V_14 , T_2 V_21 )
{
return F_42 ( V_29 , V_33 , V_14 , V_21 , V_47 ) ;
}
...
static T_1 F_47 ( struct V_31 * V_29 ,
struct V_40 * V_33 ,
const char * V_14 , T_2 V_21 )
{
unsigned long V_54 ;
...
V_2 -> V_12 = 2 ;
if ( V_2 -> V_10 ) {
V_62 = F_20 ( & V_2 -> V_29 , & V_2 -> V_10 -> V_29 , L_13 ) ;
F_21 ( V_62 ) ;
}
F_22 ( & V_2 -> V_17 ) ;
F_51 ( & V_2 -> V_29 , V_67 ) ;
...
if ( V_41 < 96 )
return - V_18 ;
F_17 (KERN_INFO PDCS_PREFIX L_36 , PDCS_VERSION) ;
...
error = F_57 ( V_72 , & V_76 ) ;
V_65 = F_58 ( L_38 , NULL , V_72 ) ;
if ( ! V_65 ) {
V_68 = - V_74 ;
goto V_77;
}
...
F_53 ( V_72 ) ;
V_75:
F_17 (KERN_INFO PDCS_PREFIX L_39 ) ;
return V_68 ;
}
static void T_6
F_60 ( void )
