...
if ( F_71 ( V_177 + V_178 + V_167
+ F_72 ( struct V_103 ,
V_59 . V_128 . V_61 ) ,
V_135 -> V_59 . V_60 . V_109 -> V_61 ,
strlen ( V_135 -> V_59 . V_60 . V_109 -> V_61 ) + 1 )
!= 0 ) {
V_14 = - V_181 ;
goto V_182;
}
...
static void F_74 ( void * V_24 , const void * V_20 )
{
int V_115 = * ( V_183 * ) V_20 ;
if ( V_115 > 0 )
V_115 += F_75 ( V_83 , V_115 ) ;
memcpy ( V_24 , & V_115 , sizeof( V_115 ) ) ;
}
static int F_76 ( void T_3 * V_24 , const void * V_20 )
{
V_183 V_184 = * ( int * ) V_20 ;
if ( V_184 > 0 )
V_184 -= F_75 ( V_83 , V_184 ) ;
return F_71 ( V_24 , & V_184 , sizeof( V_184 ) ) ? - V_181 : 0 ;
}
static int F_77 ( const struct V_44 * V_47 ,
...
F_30 (ematch, e)
V_178 += F_78 ( V_104 -> V_59 . V_60 . V_109 ) ;
V_57 = F_14 ( V_47 ) ;
V_178 += F_79 ( V_57 -> V_59 . V_60 . V_58 ) ;
V_120 -> V_130 -= V_178 ;
V_14 = F_80 ( V_83 , V_185 , V_178 ) ;
if ( V_14 )
return V_14 ;
for ( V_167 = 0 ; V_167 < V_123 ; V_167 ++ ) {
if ( V_2 -> V_80 [ V_167 ] &&
...
static int F_81 ( const struct V_75 * V_2 ,
struct V_75 * V_120 )
{
struct V_44 * V_78 ;
const void * V_180 ;
...
V_14 = F_77 ( V_78 , V_2 , V_180 , V_120 ) ;
if ( V_14 != 0 )
return V_14 ;
}
return 0 ;
}
static int F_83 ( struct V_69 * V_69 , void T_3 * V_128 ,
...
return - V_162 ;
if ( F_84 ( V_61 , V_128 , sizeof( V_61 ) ) != 0 )
return - V_181 ;
V_61 [ V_189 - 1 ] = '\0' ;
#ifdef F_85
if ( V_188 )
...
static int
F_92 ( struct V_69 * V_69 , struct V_192 T_3 * V_193 ,
const int * V_112 )
{
int V_14 ;
struct V_192 V_194 ;
...
static int
F_93 ( struct V_69 * V_69 , const char * V_61 , unsigned int V_99 ,
...
V_199 = F_94 ( V_57 , V_197 , V_120 , & V_14 ) ;
if ( ! V_199 )
goto V_201;
...
static int
F_97 ( struct V_69 * V_69 , const void T_3 * V_128 , unsigned int V_112 )
{
int V_14 ;
struct V_165 V_172 ;
struct V_75 * V_120 ;
void * V_180 ;
struct V_44 * V_78 ;
if ( F_84 ( & V_172 , V_128 , sizeof( V_172 ) ) != 0 )
return - V_181 ;
...
V_120 = F_98 ( V_172 . V_130 ) ;
if ( ! V_120 )
return - V_155 ;
V_180 = V_120 -> V_79 ;
if ( F_84 ( V_180 , V_128 + sizeof( V_172 ) ,
V_172 . V_130 ) != 0 ) {
V_14 = - V_181 ;
goto V_203;
}
...
if ( V_14 != 0 )
goto V_203;
V_14 = F_93 ( V_69 , V_172 . V_61 , V_172 . V_99 , V_120 ,
...
struct V_44 * V_78 ;
unsigned int V_98 ;
V_206 = F_100 ( V_128 , V_112 , & V_172 , V_188 ) ;
if ( F_45 ( V_206 ) )
return F_46 ( V_206 ) ;
V_57 = F_88 ( V_69 , V_83 , V_172 . V_61 ) ;
if ( ! V_57 ) {
V_14 = - V_191 ;
goto free;
}
...
static int
F_101 ( struct V_44 * V_47 , void T_3 * * V_208 ,
...
F_30 (ematch, e) {
V_14 = F_102 ( V_104 , V_208 , V_130 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_49 = V_47 -> V_49 - ( V_210 - * V_130 ) ;
V_57 = F_15 ( V_47 ) ;
V_14 = F_103 ( V_57 , V_208 , V_130 ) ;
if ( V_14 )
return V_14 ;
V_86 = V_47 -> V_86 - ( V_210 - * V_130 ) ;
if ( F_104 ( V_49 , & V_209 -> V_49 ) != 0 ||
F_104 ( V_86 , & V_209 -> V_86 ) != 0 )
return - V_181 ;
return 0 ;
}
static int
F_105 ( struct V_103 * V_135 ,
...
static void F_106 ( struct V_186 * V_47 )
{
struct V_50 * V_57 ;
struct V_103 * V_104 ;
F_30 (ematch, e)
...
V_153 = 0 ;
F_30 (ematch, e) {
V_14 = F_105 ( V_104 , & V_47 -> V_16 , & V_178 ) ;
if ( V_14 != 0 )
goto V_212;
++ V_153 ;
}
...
static void
F_110 ( struct V_186 * V_47 , void * * V_208 ,
unsigned int * V_130 ,
...
* V_130 += sizeof( struct V_44 ) - sizeof( struct V_186 ) ;
F_30 (ematch, e)
F_111 ( V_104 , V_208 , V_130 ) ;
V_213 -> V_49 = V_47 -> V_49 - ( V_210 - * V_130 ) ;
V_57 = F_107 ( V_47 ) ;
F_112 ( V_57 , V_208 , V_130 ) ;
...
V_153 = 0 ;
F_86 ( V_83 ) ;
F_82 ( V_83 , V_217 -> V_168 ) ;
F_18 (iter0, entry0, compatr->size) {
V_14 = F_108 ( V_219 , V_2 , & V_130 ,
V_121 ,
V_121 + V_217 -> V_130 ) ;
if ( V_14 != 0 )
goto V_220;
...
static int
F_114 ( struct V_69 * V_69 , void T_3 * V_128 , unsigned int V_112 )
{
int V_14 ;
struct V_216 V_172 ;
struct V_75 * V_120 ;
...
V_14 = F_113 ( V_69 , & V_120 , & V_180 , & V_172 ) ;
if ( V_14 != 0 )
goto V_203;
V_14 = F_93 ( V_69 , V_172 . V_61 , V_172 . V_99 , V_120 ,
V_172 . V_197 , F_115 ( V_172 . V_111 ) ) ;
if ( V_14 )
goto V_204;
return 0 ;
V_204:
...
static int
F_116 ( struct V_221 * V_222 , int V_223 , void T_3 * V_128 ,
unsigned int V_112 )
{
int V_14 ;
...
switch ( V_223 ) {
case V_227 :
V_14 = F_114 ( F_118 ( V_222 ) , V_128 , V_112 ) ;
break;
case V_228 :
V_14 = F_99 ( F_118 ( V_222 ) , V_128 , V_112 , 1 ) ;
break;
default:
V_14 = - V_162 ;
}
...
static int
F_119 ( unsigned int V_176 , struct V_1 * V_89 ,
void T_3 * V_177 )
{
struct V_105 * V_111 ;
const struct V_75 * V_76 = V_89 -> V_76 ;
...
static int
F_120 ( struct V_69 * V_69 , struct V_229 T_3 * V_193 ,
int * V_112 )
{
int V_14 ;
struct V_229 V_194 ;
...
static int
F_121 ( struct V_221 * V_222 , int V_223 , void T_3 * V_128 , int * V_112 )
{
int V_14 ;
if ( ! F_117 ( F_118 ( V_222 ) -> V_224 , V_225 ) )
return - V_226 ;
switch ( V_223 ) {
case V_230 :
V_14 = F_83 ( F_118 ( V_222 ) , V_128 , V_112 , 1 ) ;
break;
case V_231 :
V_14 = F_120 ( F_118 ( V_222 ) , V_128 , V_112 ) ;
break;
default:
V_14 = F_122 ( V_222 , V_223 , V_128 , V_112 ) ;
}
return V_14 ;
}
static int
F_123 ( struct V_221 * V_222 , int V_223 , void T_3 * V_128 , unsigned int V_112 )
{
int V_14 ;
if ( ! F_117 ( F_118 ( V_222 ) -> V_224 , V_225 ) )
return - V_226 ;
switch ( V_223 ) {
case V_227 :
V_14 = F_97 ( F_118 ( V_222 ) , V_128 , V_112 ) ;
break;
case V_228 :
V_14 = F_99 ( F_118 ( V_222 ) , V_128 , V_112 , 0 ) ;
break;
default:
V_14 = - V_162 ;
}
...
static int
F_122 ( struct V_221 * V_222 , int V_223 , void T_3 * V_128 , int * V_112 )
{
int V_14 ;
if ( ! F_117 ( F_118 ( V_222 ) -> V_224 , V_225 ) )
return - V_226 ;
switch ( V_223 ) {
case V_230 :
V_14 = F_83 ( F_118 ( V_222 ) , V_128 , V_112 , 0 ) ;
break;
case V_231 :
V_14 = F_92 ( F_118 ( V_222 ) , V_128 , V_112 ) ;
break;
case V_232 :
case V_233 : {
struct V_234 V_235 ;
...
if ( F_84 ( & V_235 , V_128 , sizeof( V_235 ) ) != 0 ) {
V_14 = - V_181 ;
break;
}
...
if ( V_14 != 0 )
goto V_169;
V_242 = F_128 ( V_69 , V_89 , & V_241 , V_120 ) ;
if ( F_45 ( V_242 ) ) {
V_14 = F_46 ( V_242 ) ;
goto V_169;
}
F_129 ( * V_240 , V_242 ) ;
V_14 = F_130 ( V_69 , V_239 , F_131 ( V_89 -> V_99 ) ) ;
if ( V_14 != 0 ) {
F_125 ( V_69 , V_242 ) ;
* V_240 = NULL ;
}
...
const struct V_238 * V_239 )
{
F_133 ( V_69 , V_239 , F_131 ( V_89 -> V_99 ) ) ;
F_125 ( V_69 , V_89 ) ;
}
static inline bool
F_134 ( T_6 V_243 , T_6 V_244 , T_6 V_245 ,
T_6 type , T_6 V_246 ,
bool V_247 )
{
...
if ( V_41 -> V_12 != 0 )
return false ;
V_249 = F_136 ( V_6 , V_41 -> V_107 , sizeof( V_250 ) , & V_250 ) ;
if ( V_249 == NULL ) {
V_41 -> V_13 = true ;
return false ;
}
return F_134 ( V_252 -> type ,
V_252 -> V_246 [ 0 ] ,
V_252 -> V_246 [ 1 ] ,
...
static int T_7 F_138 ( struct V_69 * V_69 )
{
return F_139 ( V_69 , V_138 ) ;
}
static void T_8 F_140 ( struct V_69 * V_69 )
{
F_141 ( V_69 , V_138 ) ;
}
...
if ( V_14 < 0 )
goto V_257;
V_14 = F_144 ( V_258 , F_145 ( V_258 ) ) ;
if ( V_14 < 0 )
goto V_259;
V_14 = F_146 ( V_260 , F_145 ( V_260 ) ) ;
if ( V_14 < 0 )
goto V_261;
V_14 = F_147 ( & V_262 ) ;
if ( V_14 < 0 )
...
return 0 ;
V_263:
F_149 ( V_260 , F_145 ( V_260 ) ) ;
V_261:
F_150 ( V_258 , F_145 ( V_258 ) ) ;
V_259:
F_151 ( & V_256 ) ;
V_257:
return V_14 ;
