...
V_37 -> V_44 = V_45 ;
V_37 -> V_46 = F_24 ( ( unsigned short ) V_38 ) ;
V_39 = F_25 ( V_28 , - 1 ,
...
V_35 -> V_49 = V_50 ;
V_35 -> V_51 = F_24 ( ( unsigned short ) V_38 ) ;
V_35 -> V_52 . V_53 = F_26 ( V_30 ) ;
}
...
static T_1 F_31 ( struct V_2 * V_3 , char * V_5 )
{
struct V_60 * V_61 = F_32 ( V_3 ) ;
struct V_62 * V_63 ;
struct V_64 * V_65 ;
struct V_66 * V_67 ;
T_1 V_9 = 0 ;
...
L_49 ) ;
F_35 ( & V_63 -> V_90 ) ;
F_36 (conn, &sess->sess_conn_list, conn_list) {
...
char * V_5 )
{
return sprintf ( V_5 , L_64 , F_32 ( V_3 ) -> V_103 ) ;
}
...
static T_1 F_42 ( struct V_2 * V_3 , char * V_5 )
{
return snprintf ( V_5 , V_112 , L_10 , F_32 ( V_3 ) -> V_113 ) ;
}
...
L_71 , & V_118 ) ;
F_47 ( & V_115 -> V_116 . V_117 ,
& V_61 -> V_119 ) ;
return 0 ;
}
static T_1 F_48 ( struct V_2 * V_3 , char * V_5 )
{
struct V_23 * V_24 = F_49 ( V_3 ) ;
struct V_14 * V_15 = F_2 ( V_24 ,
struct V_14 , V_54 ) ;
T_1 V_120 ;
F_35 ( & V_15 -> V_121 ) ;
...
V_128 += 5 ;
V_39 = F_56 ( V_128 , 0 , & V_58 ) ;
if ( V_39 )
return NULL ;
V_15 = F_57 ( V_127 , V_58 ) ;
if ( ! V_15 )
return NULL ;
V_39 = F_58 ( V_125 , & V_15 -> V_54 , V_130 ) ;
if ( V_39 < 0 )
return NULL ;
V_39 = F_59 ( V_127 , V_15 ) ;
if ( V_39 != 0 )
goto V_20;
F_27 ( L_76 , V_127 -> V_127 ) ;
F_27 ( L_77 ,
V_27 ) ;
return & V_15 -> V_54 ;
V_20:
...
static struct V_124 * F_65 (
struct V_133 * V_134 ,
struct V_25 * V_26 ,
const char * V_27 )
{
struct V_126 * V_127 ;
V_127 = F_66 ( ( unsigned char * ) V_27 ) ;
if ( F_13 ( V_127 ) )
return F_29 ( V_127 ) ;
F_27 ( L_76 , V_127 -> V_127 ) ;
F_27 ( L_81
...
L_83 , & V_137 ) ;
F_47 ( & V_127 -> V_135 . V_136 ,
& V_127 -> V_129 . V_138 ) ;
F_46 ( & V_127 -> V_135 . V_139 ,
L_84 , & V_140 ) ;
F_47 ( & V_127 -> V_135 . V_139 ,
& V_127 -> V_129 . V_138 ) ;
F_46 ( & V_127 -> V_135 . V_141 ,
L_85 , & V_142 ) ;
F_47 ( & V_127 -> V_135 . V_141 ,
& V_127 -> V_129 . V_138 ) ;
F_46 ( & V_127 -> V_135 . V_143 ,
L_86 , & V_144 ) ;
F_47 ( & V_127 -> V_135 . V_143 ,
& V_127 -> V_129 . V_138 ) ;
F_46 ( & V_127 -> V_135 . V_145 ,
L_87 , & V_146 ) ;
F_47 ( & V_127 -> V_135 . V_145 ,
& V_127 -> V_129 . V_138 ) ;
}
static void F_68 (
struct V_124 * V_125 )
...
static int F_75 ( struct V_162 * V_162 )
{
...
static int F_81 ( struct V_162 * V_162 )
{
struct V_163 * V_164 = F_2 ( V_162 , struct V_163 , V_162 ) ;
V_164 -> V_165 = V_177 ;
if ( V_164 -> V_162 . V_178 || V_164 -> V_179 ) {
F_82 ( V_164 , V_164 -> V_65 , V_164 -> V_165 ) ;
return 0 ;
}
...
static void F_84 ( struct V_162 * V_162 )
{
struct V_163 * V_164 = F_2 ( V_162 , struct V_163 , V_162 ) ;
V_164 -> V_65 -> V_169 -> V_182 ( V_164 -> V_65 , V_164 ) ;
}
static inline struct V_14 * F_85 ( struct V_23 * V_24 )
{
return F_2 ( V_24 , struct V_14 , V_54 ) ;
}
static char * F_86 ( struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_131 -> V_127 ;
}
static T_4 F_87 ( struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_58 ;
}
static T_3 F_88 ( struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_160 . V_183 ;
}
static int F_89 ( struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_160 . V_184 ;
}
static int F_90 ( struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_160 . V_185 ;
}
static int F_91 (
struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_160 . V_186 ;
}
static int F_92 (
struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_160 . V_187 ;
}
static int F_93 (
struct V_23 * V_24 )
{
if ( ! F_85 ( V_24 ) -> V_160 . V_188 )
return 0 ;
return F_85 ( V_24 ) -> V_160 . V_189 ;
}
...
static T_3 F_99 ( struct V_23 * V_24 )
{
return F_85 ( V_24 ) -> V_131 -> V_196 ;
}
