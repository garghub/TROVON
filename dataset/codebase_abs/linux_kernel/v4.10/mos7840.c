...
{
if ( V_7 -> V_250 < V_7 -> V_19 ||
V_7 -> V_251 < V_7 -> V_19 ) {
F_35 ( & V_7 -> V_252 -> V_6 , L_84 ) ;
return - V_120 ;
}
return 0 ;
}
...
F_95 ( & V_23 -> V_111 ) ;
V_23 -> V_60 = V_253 + 1 ;
F_2 ( & V_2 -> V_6 , L_86 , V_2 -> V_138 ) ;
F_2 ( & V_2 -> V_6 , L_87 , V_23 -> V_60 ) ;
if ( V_23 -> V_60 == 1 ) {
V_23 -> V_24 = 0x0 ;
V_23 -> V_25 = 0x1 ;
V_23 -> V_26 = 0x4 ;
...
V_23 -> V_25 , & V_92 ) ;
if ( V_52 < 0 ) {
F_2 ( & V_2 -> V_6 , L_88 , V_52 ) ;
goto V_57;
} else
F_2 ( & V_2 -> V_6 , L_89 , V_92 , V_52 ) ;
V_92 |= 0x08 ;
V_92 |= 0x04 ;
V_52 = F_1 ( V_2 ,
V_23 -> V_25 , V_92 ) ;
...
( ( T_1 ) V_23 -> V_60 ) ) , V_92 ) ;
F_2 ( & V_2 -> V_6 , L_104 ,
( T_1 ) ( V_257 + ( ( T_1 ) V_23 -> V_60 ) ) ) ;
if ( V_52 < 0 ) {
F_2 ( & V_2 -> V_6 , L_105 , V_253 + 2 , V_52 ) ;
goto V_57;
} else
F_2 ( & V_2 -> V_6 , L_106 , V_253 + 2 , V_52 ) ;
} else {
V_92 = 0xff ;
V_52 = F_1 ( V_2 ,
( T_1 ) ( V_257 +
...
F_2 ( & V_2 -> V_6 , L_104 ,
( T_1 ) ( V_257 + ( ( T_1 ) V_23 -> V_60 ) - 0x1 ) ) ;
if ( V_52 < 0 ) {
F_2 ( & V_2 -> V_6 , L_105 , V_253 + 1 , V_52 ) ;
goto V_57;
} else
F_2 ( & V_2 -> V_6 , L_106 , V_253 + 1 , V_52 ) ;
}
