...
{
struct V_1 * V_2 = F_25 ( V_63 ) ;
V_2 -> V_188 = F_46 ( V_63 -> V_5 , L_16 ) ;
if ( F_47 ( V_2 -> V_188 ) == - V_190 )
return - V_190 ;
V_2 -> V_63 = V_63 ;
return 0 ;
}
static int F_48 ( void * V_191 , unsigned int V_6 , unsigned int * V_171 )
{
struct V_192 * V_193 = V_191 ;
struct V_1 * V_2 = F_49 ( V_193 ) ;
F_50 ( V_2 -> V_3 , V_6 | V_53 , V_171 ) ;
return 0 ;
}
static int F_51 ( void * V_191 , unsigned int V_6 , unsigned int V_171 )
{
struct V_192 * V_193 = V_191 ;
struct V_1 * V_2 = F_49 ( V_193 ) ;
...
static int F_54 ( struct V_192 * V_194 ,
const struct V_195 * V_104 )
{
struct V_196 * V_85 = F_55 ( & V_194 -> V_5 ) ;
struct V_1 * V_2 ;
int V_149 ;
unsigned int V_171 ;
V_2 = F_56 ( & V_194 -> V_5 , sizeof( struct V_1 ) ,
V_197 ) ;
if ( V_2 == NULL )
return - V_198 ;
F_57 ( V_194 , V_2 ) ;
if ( V_85 )
V_2 -> V_85 = * V_85 ;
else if ( V_194 -> V_5 . V_199 )
F_52 ( V_2 , & V_194 -> V_5 ) ;
V_2 -> V_3 = F_58 ( V_194 , & V_200 ) ;
if ( F_42 ( V_2 -> V_3 ) ) {
V_149 = F_47 ( V_2 -> V_3 ) ;
F_14 ( & V_194 -> V_5 , L_18 ,
V_149 ) ;
...
V_2 -> V_73 = F_59 ( & V_194 -> V_5 , NULL , V_194 , & V_201 ) ;
if ( F_42 ( V_2 -> V_73 ) ) {
V_149 = F_47 ( V_2 -> V_73 ) ;
F_14 ( & V_194 -> V_5 , L_18 ,
V_149 ) ;
...
F_22 ( & V_194 -> V_5 , L_20 ,
V_149 ) ;
V_149 = F_60 ( V_2 -> V_73 , V_204 ,
F_17 ( V_204 ) ) ;
if ( V_149 != 0 )
F_22 ( & V_194 -> V_5 , L_21 , V_149 ) ;
return F_61 ( & V_194 -> V_5 , & V_205 ,
V_206 , F_17 ( V_206 ) ) ;
}
static int F_62 ( struct V_192 * V_194 )
{
F_63 ( & V_194 -> V_5 ) ;
return 0 ;
}
