...
{
V_49 -> V_51 = F_24 ( V_53 * 4 , V_54 ) ;
V_49 -> V_52 = F_25 ( V_49 -> V_51 * sizeof( struct V_55 * ) , V_56 ) ;
if ( ! V_49 -> V_52 )
return - V_57 ;
return 0 ;
}
...
V_87 . V_68 , V_56 ) ;
V_59 -> V_96 . V_101 = F_27 ( V_87 . V_59 ,
V_87 . V_68 , V_56 ) ;
if ( V_59 -> V_96 . V_101 ) {
V_99 = strchr ( V_59 -> V_96 . V_101 , '@' ) ;
if ( V_99 ) {
* V_99 = '\0' ;
V_99 = strchr ( V_59 -> V_96 . V_101 , '/' ) ;
if ( V_99 ) * V_99 = '@' ;
...
if ( ! V_99 ) {
F_22 ( V_59 -> V_96 . V_101 ) ;
V_59 -> V_96 . V_101 = NULL ;
}
}
}
F_22 ( V_87 . V_59 ) ;
