...
static void F_16 ( struct V_33 * V_34 , struct V_1 * V_2 ,
...
F_18 ( V_34 , L_16 , V_15 [ V_13 ] ) ;
F_17 ( V_34 , L_17 ) ;
}
}
void F_19 ( struct V_33 * V_34 , struct V_11 const * V_12 )
{
struct V_1 * V_2 ;
V_2 = F_8 ( V_12 -> V_36 ) ;
switch ( V_12 -> type ) {
...
F_18 ( V_34 , L_20 , V_12 -> V_14 . V_15 . V_16 ) ;
F_16 ( V_34 , V_2 , V_12 -> V_14 . V_15 . V_15 ,
V_12 -> V_14 . V_15 . V_18 ) ;
}
...
F_16 ( V_34 , V_2 , V_30 -> V_14 . V_15 . V_15 ,
V_30 -> V_14 . V_15 . V_18 ) ;
}
...
F_18 ( V_34 , L_28 , V_25 , V_47 ) ;
F_25 ( V_2 , V_34 , V_25 , V_47 ) ;
F_18 ( V_34 , L_17 ) ;
V_25 ++ ;
}
return 0 ;
...
{
return F_28 ( V_52 , F_24 , V_51 -> V_53 ) ;
}
...
if ( V_12 -> type != V_59 -> V_62 )
continue;
if ( strcmp ( V_12 -> V_23 , V_59 -> V_23 ) )
continue;
if ( strcmp ( V_12 -> V_17 , V_59 -> V_63 ) )
continue;
if ( ! strcmp ( V_12 -> V_14 . V_15 . V_16 , V_59 -> V_64 ) ) {
V_57 = V_12 ;
break;
}
}
if ( ! V_57 ) {
F_18 ( V_34 , L_29 ) ;
F_18 ( V_34 , L_30 , V_59 -> V_23 ) ;
F_18 ( V_34 , L_31 , V_59 -> V_63 ) ;
F_18 ( V_34 , L_32 , V_59 -> V_64 ) ;
F_18 ( V_34 , L_33\
L_34 ) ;
goto exit;
}
V_2 = F_8 ( V_57 -> V_36 ) ;
F_18 ( V_34 , L_35 ,
V_59 -> V_23 , V_59 -> V_64 , V_59 -> V_63 ) ;
F_16 ( V_34 , V_2 , V_57 -> V_14 . V_15 . V_15 ,
V_57 -> V_14 . V_15 . V_18 ) ;
exit:
F_11 ( & V_61 ) ;
return 0 ;
...
const char T_2 * V_65 , T_3 V_66 , T_4 * V_67 )
{
struct V_55 * V_56 ;
const struct V_11 * V_12 ;
const struct V_11 * V_57 = NULL ;
...
char * V_73 ;
int V_13 ;
V_72 = F_33 ( V_66 , sizeof( V_70 ) - 1 ) ;
if ( F_34 ( V_70 , V_65 , V_72 ) )
return - V_74 ;
V_70 [ V_72 ] = 0 ;
V_73 = F_35 ( & V_71 , L_36 ) ;
if ( ! V_73 )
...
if ( strlen ( V_73 ) >= V_69 )
return - V_10 ;
strncpy ( V_59 -> V_23 , V_73 , V_69 ) ;
V_73 = F_35 ( & V_71 , L_36 ) ;
if ( V_73 == NULL )
return - V_10 ;
if ( strlen ( V_73 ) >= V_69 )
return - V_10 ;
strncpy ( V_59 -> V_63 , V_73 , V_69 ) ;
V_73 = F_35 ( & V_71 , L_36 ) ;
if ( V_73 == NULL )
return - V_10 ;
if ( strlen ( V_73 ) >= V_69 )
return - V_10 ;
strncpy ( V_59 -> V_64 , V_73 , V_69 ) ;
V_73 = F_35 ( & V_71 , L_36 ) ;
if ( V_73 == NULL )
return - V_10 ;
if ( strlen ( V_73 ) >= V_69 )
return - V_10 ;
strncpy ( V_20 , V_73 , V_69 ) ;
F_9 ( & V_61 ) ;
F_31 (maps_node, i, map) {
if ( strcmp ( V_12 -> V_23 , V_59 -> V_23 ) )
continue;
