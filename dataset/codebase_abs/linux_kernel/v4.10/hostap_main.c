...
F_64 ( V_3 -> V_7 ) ;
V_3 -> F_29 -> V_196 ( V_7 , & V_195 ) ;
F_11 ( V_22 L_38
L_39 ,
V_7 -> V_6 , V_195 . V_113 , V_195 . V_197 , V_195 . V_198 , V_195 . V_199 ,
V_195 . V_200 ) ;
V_3 -> F_29 -> V_201 ( V_3 ) ;
}
...
V_231 ,
& V_230 , sizeof( V_230 ) , 1 ) >= 0 ) {
V_3 -> V_232 = ( V_233 ) F_89 ( V_230 . V_234 ) ;
V_3 -> V_235 = ( V_233 ) F_89 ( V_230 . V_236 ) ;
V_3 -> V_237 = ( V_233 ) F_89 ( V_230 . V_238 ) ;
V_3 -> V_239 = V_140 ;
} else
V_11 = - 1 ;
} else {
if ( V_3 -> F_29 -> V_93 ( V_3 -> V_7 , V_240 ,
& V_230 , sizeof( V_230 ) , 1 ) >= 0 ) {
V_3 -> V_232 = F_89 ( V_230 . V_234 ) ;
V_3 -> V_235 = F_90 (
F_89 ( V_230 . V_236 ) ) ;
V_3 -> V_237 = F_90 (
F_89 ( V_230 . V_238 ) ) ;
...
int F_91 ( T_2 * V_3 , T_1 * V_241 , T_3 V_242 ,
T_1 * V_243 , T_5 V_244 )
{
struct V_50 * V_160 ;
struct V_245 * V_246 ;
struct V_247 * V_248 ;
struct V_1 * V_7 = V_3 -> V_7 ;
V_160 = F_92 ( V_249 + V_244 ) ;
if ( V_160 == NULL )
return - V_45 ;
V_246 = (struct V_245 * )
F_93 ( V_160 , V_249 ) ;
memset ( V_246 , 0 , V_249 ) ;
V_246 -> V_141 = F_36 ( V_250 | V_242 ) ;
memcpy ( V_246 -> V_251 , V_241 , V_37 ) ;
memcpy ( V_246 -> V_252 , V_7 -> V_189 , V_37 ) ;
memcpy ( V_246 -> V_253 , V_241 , V_37 ) ;
if ( V_243 )
memcpy ( F_93 ( V_160 , V_244 ) , V_243 , V_244 ) ;
V_248 = (struct V_247 * ) V_160 -> V_60 ;
...
F_21 ( V_3 -> V_253 , L_45 ) )
return 0 ;
V_11 = F_91 ( V_3 , V_3 -> V_253 , V_259 ,
( T_1 * ) & V_63 , 2 ) ;
F_27 ( V_258 . V_260 . V_187 ) ;
F_98 ( V_3 -> V_7 , V_261 , & V_258 , NULL ) ;
return V_11 ;
}
static int T_6 F_99 ( void )
{
if ( V_262 . V_263 != NULL ) {
V_264 = F_100 ( L_46 , V_262 . V_263 ) ;
if ( ! V_264 )
F_11 ( V_21 L_47
L_48 ) ;
} else
