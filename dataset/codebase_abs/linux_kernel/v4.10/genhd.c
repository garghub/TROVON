...
F_85 ( V_3 -> V_76 ) ;
if ( ! V_73 )
F_82 ( V_74 , F_86 ( F_48 ( V_3 ) ) ) ;
F_58 ( F_48 ( V_3 ) , false ) ;
F_57 ( F_48 ( V_3 ) ) ;
}
static T_4 F_87 ( struct V_66 * V_86 ,
struct V_88 * V_89 ,
char * V_90 )
{
struct V_2 * V_3 = F_88 ( V_86 ) ;
if ( ! V_3 -> V_91 )
return sprintf ( V_90 , L_11 ) ;
return F_89 ( V_3 -> V_91 , V_90 , 0 ) ;
}
...
if ( ! V_3 -> V_91 )
return - V_92 ;
return F_91 ( V_3 -> V_91 , V_90 , V_9 , 0 ) ;
}
...
struct V_93 V_94 ;
struct V_66 * V_86 ;
F_99 ( & V_94 , & V_95 , NULL , & V_96 ) ;
while ( ( V_86 = F_100 ( & V_94 ) ) ) {
struct V_2 * V_3 = F_88 ( V_86 ) ;
struct V_10 V_11 ;
struct V_1 * V_5 ;
char V_97 [ V_98 ] ;
...
static void * F_102 ( struct V_27 * V_28 , T_7 * V_105 )
{
T_7 V_106 = * V_105 ;
struct V_93 * V_94 ;
struct V_66 * V_86 ;
...
static void * F_104 ( struct V_27 * V_28 , void * V_108 , T_7 * V_105 )
{
struct V_66 * V_86 ;
( * V_105 ) ++ ;
V_86 = F_100 ( V_28 -> V_107 ) ;
if ( V_86 )
return F_88 ( V_86 ) ;
return NULL ;
}
static void F_105 ( struct V_27 * V_28 , void * V_108 )
{
...
static void * F_106 ( struct V_27 * V_28 , T_7 * V_105 )
{
void * V_37 ;
V_37 = F_102 ( V_28 , V_105 ) ;
if ( ! F_107 ( V_37 ) && ! * V_105 )
F_108 ( V_28 , L_17 ) ;
return V_37 ;
}
static int F_109 ( struct V_27 * V_28 , void * V_108 )
{
struct V_2 * V_109 = V_108 ;
struct V_10 V_11 ;
struct V_1 * V_5 ;
char V_58 [ V_98 ] ;
if ( ! F_61 ( V_109 ) || ( ! F_110 ( V_109 ) &&
( V_109 -> V_12 & V_110 ) ) )
return 0 ;
if ( V_109 -> V_12 & V_100 )
return 0 ;
...
static int F_111 ( struct V_111 * V_111 , struct V_112 * V_112 )
{
return F_112 ( V_112 , & V_113 ) ;
}
...
static T_4 F_119 ( struct V_66 * V_86 ,
struct V_88 * V_89 , char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_86 ) ;
return sprintf ( V_58 , L_23 , V_3 -> V_50 ) ;
}
static T_4 F_120 ( struct V_66 * V_86 ,
struct V_88 * V_89 , char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_86 ) ;
...
static T_4 F_125 ( struct V_66 * V_86 ,
struct V_88 * V_89 ,
char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_86 ) ;
return sprintf ( V_58 , L_23 , F_126 ( V_3 -> V_85 ) ) ;
}
...
if ( V_119 < 0 )
return - V_121 ;
if ( F_110 ( V_3 ) && V_119 > F_110 ( V_3 ) )
return - V_121 ;
if ( V_119 <= V_9 )
return 0 ;
V_120 = sizeof( * V_116 ) + V_119 * sizeof( V_116 -> V_5 [ 0 ] ) ;
V_116 = F_132 ( V_120 , V_42 , V_3 -> V_122 ) ;
if ( ! V_116 )
return - V_43 ;
V_116 -> V_9 = V_119 ;
...
static void F_133 ( struct V_66 * V_86 )
{
struct V_2 * V_3 = F_88 ( V_86 ) ;
F_40 ( V_86 -> V_49 ) ;
F_134 ( V_3 ) ;
...
static char * F_137 ( struct V_66 * V_86 , T_8 * V_124 ,
...
static int F_138 ( struct V_27 * V_28 , void * V_108 )
{
...
F_20 ( V_28 , L_25
L_26 ,
F_41 ( F_97 ( V_129 ) ) , F_43 ( F_97 ( V_129 ) ) ,
V_72 ( V_128 , V_129 -> V_4 , V_58 ) ,
F_142 ( V_129 , V_131 [ V_132 ] ) ,
F_142 ( V_129 , V_133 [ V_132 ] ) ,
F_142 ( V_129 , V_134 [ V_132 ] ) ,
F_143 ( F_142 ( V_129 , V_135 [ V_132 ] ) ) ,
F_142 ( V_129 , V_131 [ V_136 ] ) ,
F_142 ( V_129 , V_133 [ V_136 ] ) ,
F_142 ( V_129 , V_134 [ V_136 ] ) ,
F_143 ( F_142 ( V_129 , V_135 [ V_136 ] ) ) ,
F_144 ( V_129 ) ,
F_143 ( F_142 ( V_129 , V_137 ) ) ,
F_143 ( F_142 ( V_129 , V_138 ) )
) ;
}
F_13 ( & V_11 ) ;
return 0 ;
}
static int F_145 ( struct V_111 * V_111 , struct V_112 * V_112 )
{
return F_112 ( V_112 , & V_139 ) ;
}
static int T_6 F_146 ( void )
{
F_147 ( L_27 , 0 , NULL , & V_140 ) ;
F_147 ( L_28 , 0 , NULL , & V_141 ) ;
return 0 ;
}
...
{
return F_150 ( V_50 , V_142 ) ;
}
struct V_2 * F_150 ( int V_50 , int V_122 )
{
struct V_2 * V_3 ;
V_3 = F_132 ( sizeof( struct V_2 ) , V_42 , V_122 ) ;
if ( V_3 ) {
if ( ! F_151 ( & V_3 -> V_24 ) ) {
F_27 ( V_3 ) ;
return NULL ;
...
static void F_161 ( struct V_2 * V_148 , int V_149 )
{
char V_150 [] = L_29 ;
char * V_151 [] = { V_150 , NULL } ;
if ( ! V_149 )
V_150 [ 8 ] = '0' ;
F_162 ( & F_48 ( V_148 ) -> V_65 , V_152 , V_151 ) ;
}
void F_163 ( struct V_69 * V_70 , int V_153 )
{
V_70 -> V_154 -> V_155 = V_153 ;
}
void F_164 ( struct V_2 * V_3 , int V_153 )
{
struct V_10 V_11 ;
struct V_1 * V_5 ;
...
return;
F_19 ( & V_158 -> V_165 ) ;
F_172 ( & V_158 -> V_166 , V_12 ) ;
V_164 = ! V_158 -> V_167 ++ ;
F_173 ( & V_158 -> V_166 , V_12 ) ;
if ( V_164 )
F_174 ( & V_3 -> V_158 -> V_168 ) ;
F_21 ( & V_158 -> V_165 ) ;
}
static void F_175 ( struct V_2 * V_3 , bool V_169 )
{
struct V_157 * V_158 = V_3 -> V_158 ;
unsigned long V_170 ;
unsigned long V_12 ;
...
void F_177 ( struct V_2 * V_3 )
{
if ( V_3 -> V_158 )
F_175 ( V_3 , false ) ;
}
void F_178 ( struct V_2 * V_3 , unsigned int V_173 )
{
struct V_157 * V_158 = V_3 -> V_158 ;
if ( ! V_158 )
return;
...
unsigned int F_182 ( struct V_2 * V_3 , unsigned int V_173 )
{
...
F_181 ( & V_158 -> V_166 ) ;
F_183 ( V_158 , & V_174 ) ;
F_175 ( V_3 , V_158 -> V_174 ? true : false ) ;
F_179 ( & V_158 -> V_166 ) ;
...
static void F_184 ( struct V_180 * V_181 )
{
struct V_182 * V_168 = F_185 ( V_181 ) ;
struct V_157 * V_158 = F_186 ( V_168 , struct V_157 , V_168 ) ;
F_183 ( V_158 , & V_158 -> V_174 ) ;
}
...
if ( V_185 )
F_162 ( & F_48 ( V_3 ) -> V_65 , V_152 , V_151 ) ;
}
static T_4 F_187 ( unsigned int V_161 , char * V_58 )
{
...
static T_4 F_188 ( struct V_66 * V_86 ,
struct V_88 * V_89 , char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_86 ) ;
return F_187 ( V_3 -> V_161 , V_58 ) ;
}
static T_4 F_189 ( struct V_66 * V_86 ,
struct V_88 * V_89 , char * V_58 )
{
struct V_2 * V_3 = F_88 ( V_86 ) ;
return F_187 ( V_3 -> V_162 , V_58 ) ;
}
...
static int F_192 ( const char * V_190 ,
const struct V_191 * V_192 )
{
struct V_157 * V_158 ;
int V_39 ;
V_39 = F_193 ( V_190 , V_192 ) ;
if ( V_39 < 0 )
return V_39 ;
F_19 ( & V_193 ) ;
F_194 (ev, &disk_events, node)
F_178 ( V_158 -> V_3 , 0 ) ;
F_21 ( & V_193 ) ;
return 0 ;
}
...
if ( ! V_3 -> V_158 )
return;
if ( F_201 ( & F_48 ( V_3 ) -> V_65 , V_195 ) < 0 )
F_196 ( L_35 ,
V_3 -> V_72 ) ;
F_19 ( & V_193 ) ;
F_202 ( & V_3 -> V_158 -> V_194 , & V_157 ) ;
F_21 ( & V_193 ) ;
F_175 ( V_3 , true ) ;
}
...
F_171 ( V_3 ) ;
F_19 ( & V_193 ) ;
F_203 ( & V_3 -> V_158 -> V_194 ) ;
F_21 ( & V_193 ) ;
F_204 ( & F_48 ( V_3 ) -> V_65 , V_195 ) ;
}
