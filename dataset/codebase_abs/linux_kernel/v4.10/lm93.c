...
{
struct V_33 * V_34 = F_48 ( V_68 ) ;
struct V_64 * V_65 = V_34 -> V_65 ;
const unsigned long V_53 = V_76 + ( V_76 / 2 ) ;
F_49 ( & V_34 -> V_77 ) ;
if ( F_50 ( V_78 , V_34 -> V_79 + V_53 ) ||
! V_34 -> V_80 ) {
V_34 -> V_81 ( V_34 , V_65 ) ;
V_34 -> V_79 = V_78 ;
V_34 -> V_80 = 1 ;
...
V_34 -> V_16 [ V_42 ] = F_34 ( V_65 , F_55 ( V_42 ) ) ;
for ( V_42 = 0 ; V_42 < 2 ; V_42 ++ )
...
V_95 ) ;
for ( V_42 = 0 ; V_42 < 4 ; V_42 ++ )
V_34 -> V_36 [ V_42 ] = F_34 ( V_65 , F_58 ( V_42 ) ) ;
...
static T_3 F_73 ( struct V_75 * V_68 , struct V_123 * V_124 ,
char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
return sprintf ( V_125 , L_10 , F_3 ( V_2 , V_34 -> V_110 [ V_2 ] ) ) ;
}
static T_3 F_75 ( struct V_75 * V_68 ,
...
V_128 = F_76 ( V_34 -> V_89 [ V_127 ] , V_16 ) ;
} else {
V_128 = F_3 ( V_2 , V_34 -> V_111 [ V_2 ] . V_84 ) ;
}
return sprintf ( V_125 , L_11 , V_128 ) ;
}
static T_3 F_77 ( struct V_75 * V_68 , struct V_123 * V_124 ,
...
static T_3 F_79 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
if ( ( V_2 == 6 || V_2 == 7 ) && V_57 [ V_127 ] ) {
V_16 = F_1 ( V_34 -> V_16 [ V_127 ] ) ;
V_128 = F_80 ( V_34 -> V_89 [ V_127 ] , V_16 ) ;
} else {
V_128 = F_3 ( V_2 , V_34 -> V_111 [ V_2 ] . V_85 ) ;
}
return sprintf ( V_125 , L_11 , V_128 ) ;
}
static T_3 F_81 ( struct V_75 * V_68 , struct V_123 * V_124 ,
const char * V_125 , T_4 V_44 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_48 ( V_68 ) ;
...
static T_3 F_82 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static T_3 F_84 ( struct V_75 * V_68 , struct V_123 * V_124 ,
const char * V_125 , T_4 V_44 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_48 ( V_68 ) ;
...
long V_11 ;
int V_129 ;
V_129 = F_85 ( V_125 , 10 , & V_11 ) ;
if ( V_129 )
return V_129 ;
F_49 ( & V_34 -> V_77 ) ;
V_34 -> V_83 [ V_2 ] . V_84 = F_9 ( V_11 ) ;
F_39 ( V_65 , F_53 ( V_2 ) , V_34 -> V_83 [ V_2 ] . V_84 ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
static T_3 F_86 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static T_3 F_87 ( struct V_75 * V_68 , struct V_123 * V_124 ,
const char * V_125 , T_4 V_44 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_48 ( V_68 ) ;
...
F_39 ( V_65 , F_54 ( V_2 ) , V_34 -> V_83 [ V_2 ] . V_85 ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
static T_3 F_88 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
F_39 ( V_65 , F_71 ( V_2 ) , V_34 -> V_117 . V_121 [ V_2 ] ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
...
F_39 ( V_65 , F_58 ( V_2 ) , V_34 -> V_36 [ V_2 ] ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
...
static T_3 F_95 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
struct V_130 * V_131 = F_96 ( V_124 ) ;
int V_2 = V_131 -> V_126 ;
int V_132 = V_131 -> V_2 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
int V_25 = F_10 ( V_34 -> V_24 , V_2 ) ;
...
static T_3 F_97 ( struct V_75 * V_68 ,
struct V_123 * V_124 ,
const char * V_125 , T_4 V_44 )
{
struct V_130 * V_131 = F_96 ( V_124 ) ;
...
return V_129 ;
F_49 ( & V_34 -> V_77 ) ;
V_1 = F_34 ( V_65 , F_100 ( V_2 ) ) ;
V_133 = F_34 ( V_65 , F_70 ( V_2 , V_134 ) ) ;
V_1 = ( V_1 & 0x0f ) |
F_18 ( V_11 , ( V_133 & 0x07 ) ?
V_135 :
V_136 ) << 4 ;
V_34 -> V_98 [ V_2 / 2 ] = V_1 ;
F_39 ( V_65 , F_100 ( V_2 ) , V_1 ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
static T_3 F_101 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static T_3 F_105 ( struct V_75 * V_68 , struct V_123 * V_124 ,
const char * V_125 , T_4 V_44 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_48 ( V_68 ) ;
...
F_43 ( V_65 , F_69 ( V_2 ) , V_34 -> V_115 [ V_2 ] ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
static T_3 F_106 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static void F_107 ( struct V_64 * V_65 ,
...
static T_3 F_108 ( struct V_75 * V_68 ,
struct V_123 * V_124 ,
const char * V_125 , T_4 V_44 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
...
F_107 ( V_65 , V_34 , V_2 , V_11 ) ;
}
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
static T_3 F_109 ( struct V_75 * V_68 , struct V_123 * V_124 ,
char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
return V_129 ;
F_49 ( & V_34 -> V_77 ) ;
V_140 = F_34 ( V_65 , F_70 ( V_2 , V_141 ) ) ;
V_133 = F_34 ( V_65 , F_70 ( V_2 , V_134 ) ) ;
...
( V_133 & 0x07 ) ? V_135 :
V_136 ) ;
F_39 ( V_65 , F_70 ( V_2 , V_141 ) , V_140 ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
static T_3 F_111 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static T_3 F_113 ( struct V_75 * V_68 , struct V_123 * V_124 ,
char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static T_3 F_115 ( struct V_75 * V_68 ,
struct V_123 * V_124 ,
const char * V_125 , T_4 V_44 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
...
if ( ! V_133 )
F_114 ( V_65 , V_34 , V_2 ) ;
F_39 ( V_65 , F_70 ( V_2 , V_134 ) , V_133 ) ;
F_51 ( & V_34 -> V_77 ) ;
return V_44 ;
}
...
static T_3 F_126 ( struct V_75 * V_68 , struct V_123 * V_124 ,
char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static T_3 F_128 ( struct V_75 * V_68 ,
struct V_123 * V_124 , char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static T_3 F_139 ( struct V_75 * V_68 , struct V_123 * V_124 ,
char * V_125 )
{
int V_2 = ( F_74 ( V_124 ) ) -> V_126 ;
struct V_33 * V_34 = F_47 ( V_68 ) ;
...
static int F_144 ( struct V_64 * V_65 , struct V_156 * V_157 )
{
struct V_158 * V_159 = V_65 -> V_159 ;
int V_160 , V_161 ;
const char * V_162 ;
if ( ! F_145 ( V_159 , V_163 ) )
return - V_164 ;
...
F_146 ( V_157 -> type , V_162 , V_172 ) ;
F_60 ( & V_159 -> V_68 , L_17 ,
V_65 -> V_162 , F_147 ( V_65 -> V_159 ) ,
V_65 -> V_173 ) ;
return 0 ;
}
...
{
struct V_75 * V_68 = & V_65 -> V_68 ;
struct V_33 * V_34 ;
struct V_75 * V_176 ;
int V_177 ;
void (* V_81)( struct V_33 * , struct V_64 * );
V_177 = F_149 ( V_65 -> V_159 ) ;
if ( ( ( V_178 & V_177 ) == V_178 ) &&
( ! V_179 ) ) {
F_60 ( V_68 , L_18 ) ;
V_81 = F_59 ;
} else if ( ( V_163 & V_177 ) == V_163 ) {
F_60 ( V_68 , L_19 ) ;
V_81 = F_61 ;
} else {
F_60 ( V_68 , L_20 ) ;
...
V_34 = F_150 ( V_68 , sizeof( struct V_33 ) , V_180 ) ;
if ( ! V_34 )
return - V_181 ;
V_34 -> V_65 = V_65 ;
V_34 -> V_81 = V_81 ;
