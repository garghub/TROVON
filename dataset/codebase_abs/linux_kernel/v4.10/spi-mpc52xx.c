...
static int F_21 ( struct V_22 * V_7 , struct V_31 * V_78 )
{
struct V_1 * V_2 = F_22 ( V_7 -> V_27 ) ;
unsigned long V_77 ;
V_78 -> V_68 = 0 ;
V_78 -> V_20 = - V_79 ;
F_19 ( & V_2 -> V_74 , V_77 ) ;
F_23 ( & V_78 -> V_29 , & V_2 -> V_29 ) ;
F_20 ( & V_2 -> V_74 , V_77 ) ;
F_14 ( & V_2 -> V_72 ) ;
return 0 ;
}
...
F_25 ( & V_81 -> V_28 , L_5 ) ;
V_27 = F_27 ( & V_81 -> V_28 , sizeof *V_2 ) ;
if ( ! V_27 ) {
V_70 = - V_89 ;
goto V_90;
}
V_27 -> V_13 = F_21 ;
V_27 -> V_91 = V_38 | V_36 | V_40 ;
V_27 -> V_92 = F_28 ( 8 ) ;
V_27 -> V_28 . V_84 = V_81 -> V_28 . V_84 ;
F_29 ( V_81 , V_27 ) ;
V_2 = F_22 ( V_27 ) ;
V_2 -> V_27 = V_27 ;
V_2 -> V_10 = V_10 ;
V_2 -> V_53 = F_30 ( V_81 -> V_28 . V_84 , 0 ) ;
V_2 -> V_93 = F_30 ( V_81 -> V_28 . V_84 , 1 ) ;
V_2 -> V_50 = F_6 ;
V_2 -> V_43 = F_31 ( V_81 -> V_28 . V_84 ) ;
V_2 -> V_5 = F_32 ( V_81 -> V_28 . V_84 ) ;
if ( V_2 -> V_5 > 0 ) {
V_27 -> V_94 = V_2 -> V_5 ;
...
for ( V_83 = 0 ; V_83 < V_2 -> V_5 ; V_83 ++ ) {
V_9 = F_34 ( V_81 -> V_28 . V_84 , V_83 ) ;
if ( V_9 < 0 ) {
F_7 ( & V_81 -> V_28 ,
L_6
L_7 ) ;
...
F_39 ( & V_2 -> V_29 ) ;
F_40 ( & V_2 -> V_72 , F_18 ) ;
if ( V_2 -> V_53 && V_2 -> V_93 ) {
V_70 = F_41 ( V_2 -> V_53 , F_15 , 0 ,
L_10 , V_2 ) ;
V_70 |= F_41 ( V_2 -> V_93 , F_15 , 0 ,
L_11 , V_2 ) ;
if ( V_70 ) {
F_42 ( V_2 -> V_53 , V_2 ) ;
F_42 ( V_2 -> V_93 , V_2 ) ;
...
static int F_49 ( struct V_80 * V_81 )
{
struct V_82 * V_27 = F_50 ( F_51 ( V_81 ) ) ;
