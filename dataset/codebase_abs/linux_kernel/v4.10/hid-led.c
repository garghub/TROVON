...
int V_4 ;
F_2 ( & V_2 -> V_5 ) ;
memcpy ( V_2 -> V_3 , V_3 , V_2 -> V_6 -> V_7 ) ;
if ( V_2 -> V_6 -> V_8 == V_9 )
V_4 = F_3 ( V_2 -> V_10 , V_3 [ 0 ] , V_2 -> V_3 ,
V_2 -> V_6 -> V_7 ,
V_11 ,
V_12 ) ;
else if ( V_2 -> V_6 -> V_8 == V_13 )
V_4 = F_4 ( V_2 -> V_10 , V_2 -> V_3 ,
V_2 -> V_6 -> V_7 ) ;
else
V_4 = - V_14 ;
F_5 ( & V_2 -> V_5 ) ;
...
V_11 ,
V_17 ) ;
memcpy ( V_3 , V_2 -> V_3 , V_2 -> V_6 -> V_7 ) ;
V_16:
F_5 ( & V_2 -> V_5 ) ;
return V_4 < 0 ? V_4 : 0 ;
}
...
V_33 -> V_25 . V_63 = V_64 ;
V_33 -> V_19 = V_19 ;
return F_25 ( & V_19 -> V_2 -> V_10 -> V_65 , & V_33 -> V_25 ) ;
}
...
static int F_27 ( struct V_66 * V_10 , const struct V_67 * V_68 )
{
struct V_1 * V_2 ;
unsigned int V_55 ;
int V_4 , V_69 ;
V_2 = F_28 ( & V_10 -> V_65 , sizeof( * V_2 ) , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
V_2 -> V_3 = F_29 ( & V_10 -> V_65 , V_34 , V_70 ) ;
if ( ! V_2 -> V_3 )
return - V_71 ;
V_4 = F_30 ( V_10 ) ;
if ( V_4 )
...
V_2 -> V_10 = V_10 ;
F_31 ( & V_2 -> V_5 ) ;
for ( V_69 = 0 ; ! V_2 -> V_6 && V_69 < F_32 ( V_72 ) ; V_69 ++ )
...
V_2 -> V_19 = F_33 ( & V_10 -> V_65 , V_2 -> V_6 -> V_57 ,
...
if ( V_4 )
return V_4 ;
V_55 = ( (struct V_76 * ) V_10 -> V_76 ) -> V_55 ;
