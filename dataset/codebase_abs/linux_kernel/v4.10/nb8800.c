...
static int F_136 ( struct V_21 * V_22 , struct V_216 * V_217 , int V_15 )
{
return F_137 ( V_22 -> V_165 , V_217 , V_15 ) ;
}
...
static int F_141 ( struct V_21 * V_22 , int V_223 )
{
if ( V_223 == V_224 )
return V_225 ;
return - V_226 ;
}
static void F_142 ( struct V_21 * V_22 , T_2 V_223 , T_1 * V_113 )
{
if ( V_223 == V_224 )
memcpy ( V_113 , & V_227 , sizeof( V_227 ) ) ;
}
static T_2 F_143 ( struct V_21 * V_22 , int V_228 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
F_5 ( V_2 , V_229 , V_228 ) ;
...
V_234 = F_143 ( V_22 , V_33 ) ;
V_235 = F_143 ( V_22 , V_33 | 0x80 ) ;
V_233 [ V_33 ] = V_234 ;
...
if ( V_16 )
return V_16 ;
F_18 ( V_2 , V_31 , F_148 ( 7 ) ) ;
V_2 -> V_196 |= V_270 ;
return 0 ;
}
static int F_156 ( struct V_271 * V_272 )
{
...
int V_130 ;
int V_132 ;
V_274 = F_157 ( V_280 , & V_272 -> V_22 ) ;
if ( V_274 )
V_276 = V_274 -> V_46 ;
V_130 = F_158 ( V_272 , 0 ) ;
if ( V_130 <= 0 ) {
F_151 ( & V_272 -> V_22 , L_9 ) ;
return - V_264 ;
}
V_278 = F_159 ( V_272 , V_281 , 0 ) ;
V_4 = F_160 ( & V_272 -> V_22 , V_278 ) ;
if ( F_161 ( V_4 ) )
return F_162 ( V_4 ) ;
F_163 ( & V_272 -> V_22 , L_10 , & V_278 -> V_282 ) ;
V_22 = F_164 ( sizeof( * V_2 ) ) ;
if ( ! V_22 )
return - V_47 ;
F_165 ( V_272 , V_22 ) ;
F_166 ( V_22 , & V_272 -> V_22 ) ;
V_2 = F_29 ( V_22 ) ;
V_2 -> V_4 = V_4 ;
V_2 -> V_158 = F_167 ( V_272 -> V_22 . V_283 ) ;
if ( V_2 -> V_158 < 0 )
V_2 -> V_158 = V_159 ;
V_2 -> V_160 = F_168 ( & V_272 -> V_22 , NULL ) ;
if ( F_161 ( V_2 -> V_160 ) ) {
F_151 ( & V_272 -> V_22 , L_11 ) ;
V_132 = F_162 ( V_2 -> V_160 ) ;
goto V_284;
}
V_132 = F_169 ( V_2 -> V_160 ) ;
if ( V_132 )
goto V_284;
F_170 ( & V_2 -> V_97 ) ;
...
V_12 -> V_2 = V_2 ;
V_132 = F_172 ( V_12 , V_272 -> V_22 . V_283 ) ;
if ( V_132 ) {
F_151 ( & V_272 -> V_22 , L_14 ) ;
goto V_286;
}
if ( F_173 ( V_272 -> V_22 . V_283 ) ) {
V_132 = F_174 ( V_272 -> V_22 . V_283 ) ;
if ( V_132 < 0 ) {
F_151 ( & V_272 -> V_22 , L_15 ) ;
goto V_292;
}
V_2 -> V_213 = F_175 ( V_272 -> V_22 . V_283 ) ;
}
if ( ! V_2 -> V_213 )
V_2 -> V_213 = F_176 ( V_272 -> V_22 . V_283 ,
L_16 , 0 ) ;
if ( ! V_2 -> V_213 ) {
F_151 ( & V_272 -> V_22 , L_17 ) ;
V_132 = - V_214 ;
goto V_292;
}
V_2 -> V_11 = V_12 ;
...
if ( V_132 )
goto V_293;
if ( V_276 && V_276 -> V_294 ) {
V_132 = V_276 -> V_294 ( V_22 ) ;
if ( V_132 )
goto V_293;
}
V_22 -> V_295 = & V_296 ;
...
F_182 ( V_22 , & V_2 -> V_34 , F_56 , V_300 ) ;
F_183 ( V_22 , L_19 , V_22 -> V_177 ) ;
return 0 ;
V_212:
F_115 ( V_22 ) ;
V_293:
if ( F_173 ( V_272 -> V_22 . V_283 ) )
F_184 ( V_272 -> V_22 . V_283 ) ;
V_292:
F_185 ( V_2 -> V_213 ) ;
F_186 ( V_12 ) ;
V_286:
...
static int F_189 ( struct V_271 * V_272 )
{
struct V_21 * V_301 = F_190 ( V_272 ) ;
