...
struct V_134 * V_135 ;
F_70 ( & V_2 -> V_44 , V_7 ) ;
V_135 = F_87 ( V_16 , V_129 ) ;
F_69 ( & V_2 -> V_44 , V_7 ) ;
if ( ! V_135 ) {
V_135 = F_88 ( V_129 , V_16 ) ;
if ( V_135 ) {
F_89 ( & V_4 -> V_21 -> V_136 ) ;
V_135 -> V_21 = V_4 -> V_21 ;
F_80 ( & V_135 -> V_28 , & V_4 -> V_29 ) ;
}
}
F_70 ( & V_2 -> V_44 , V_7 ) ;
F_90 ( V_16 , V_73 , V_4 -> V_21 , V_137 ) ;
if ( V_135 )
F_91 ( V_135 ) ;
return;
}
...
static int F_95 ( const T_2 * V_138 , const T_2 * V_43 )
{
if ( memcmp ( V_138 , V_43 , 6 ) )
return 0 ;
if ( memcmp ( V_138 + 7 , V_43 + 7 , 3 ) )
return 0 ;
return 1 ;
}
void F_96 ( struct V_74 * V_75 )
{
struct V_1 * V_2 =
F_41 ( V_75 , struct V_1 , V_139 ) ;
struct V_15 * V_16 = V_2 -> V_16 ;
struct V_140 * V_141 ;
struct V_3 * V_4 , * V_38 ;
F_93 ( V_128 ) ;
...
F_100 (ha, dev) {
union V_34 V_19 ;
if ( ! F_95 ( V_141 -> V_138 , V_16 -> V_43 ) )
continue;
memcpy ( V_19 . V_20 , V_141 -> V_138 + 4 , sizeof V_19 ) ;
V_4 = F_20 ( V_16 , & V_19 ) ;
if ( ! V_4 || F_2 ( V_57 , & V_4 -> V_7 ) ) {
struct V_3 * V_143 ;
if ( F_2 ( V_144 , & V_2 -> V_7 ) &&
! F_101 ( V_2 -> V_79 , V_2 -> V_64 , & V_19 , & V_89 ) ) {
F_6 ( V_2 , L_31 ,
V_19 . V_20 ) ;
continue;
}
...
F_67 ( V_142 , & V_143 -> V_7 ) ;
V_143 -> V_18 . V_19 = V_19 ;
if ( V_4 ) {
F_102 ( & V_4 -> V_28 , & V_128 ) ;
F_103 ( & V_4 -> V_30 ,
& V_143 -> V_30 ,
& V_2 -> V_32 ) ;
} else
F_22 ( V_16 , V_143 ) ;
F_80 ( & V_143 -> V_28 , & V_2 -> V_131 ) ;
}
if ( V_4 )
F_67 ( V_142 , & V_4 -> V_7 ) ;
}
F_82 (mcast, tmcast, &priv->multicast_list, list) {
if ( ! F_2 ( V_142 , & V_4 -> V_7 ) &&
! F_2 ( V_57 , & V_4 -> V_7 ) ) {
F_6 ( V_2 , L_1 ,
V_4 -> V_18 . V_19 . V_20 ) ;
F_79 ( & V_4 -> V_30 , & V_2 -> V_32 ) ;
...
struct V_145 * F_107 ( struct V_15 * V_16 )
{
struct V_145 * V_146 ;
V_146 = F_108 ( sizeof *V_146 , V_25 ) ;
if ( ! V_146 )
return NULL ;
V_146 -> V_16 = V_16 ;
memset ( V_146 -> V_19 . V_20 , 0 , 16 ) ;
if ( F_109 ( V_146 ) ) {
F_15 ( V_146 ) ;
return NULL ;
}
...
int F_109 ( struct V_145 * V_146 )
{
struct V_1 * V_2 = F_7 ( V_146 -> V_16 ) ;
struct V_30 * V_31 ;
struct V_3 * V_4 ;
int V_33 = 1 ;
F_26 ( & V_2 -> V_44 ) ;
...
while ( V_31 ) {
V_4 = F_21 ( V_31 , struct V_3 , V_30 ) ;
if ( memcmp ( V_146 -> V_19 . V_20 , V_4 -> V_18 . V_19 . V_20 ,
sizeof ( union V_34 ) ) < 0 ) {
V_146 -> V_19 = V_4 -> V_18 . V_19 ;
V_146 -> V_27 = V_4 -> V_27 ;
V_146 -> V_147 = F_84 ( & V_4 -> V_22 ) ;
V_146 -> F_55 = ! ! V_4 -> V_21 ;
V_146 -> V_148 = ! ! ( V_4 -> V_7 & ( 1 << V_57 ) ) ;
V_33 = 0 ;
break;
}
V_31 = F_111 ( V_31 ) ;
