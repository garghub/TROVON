...
static void F_74 ( struct V_1 * V_2 , int V_121 ,
struct V_3 * V_4 )
{
int V_49 , V_122 = 0 ;
T_3 V_123 ;
if ( V_2 -> V_5 != V_15 ||
F_75 ( V_2 , V_121 ) < V_124 ||
V_121 != V_125 ||
! ( F_12 ( V_4 -> V_56 + V_126 ) & 1 ) )
return;
V_123 = F_76 ( V_4 -> V_56 + V_127 ) ;
for ( V_49 = 0 ; V_49 < V_128 ; V_49 ++ ) {
if ( ( V_123 & ( 1 << V_49 ) ) == 0 )
continue;
if ( F_12 ( V_4 -> V_56 + F_77 ( V_49 ) )
!= V_129 )
continue;
V_122 ++ ;
}
if ( ! V_122 )
return;
F_57 ( & V_2 -> V_8 , L_59 , V_122 ) ;
F_57 ( & V_2 -> V_8 , L_60 ) ;
}
static int F_78 ( struct V_13 * V_14 , int V_52 )
{
return F_79 ( F_5 ( V_14 -> V_8 ) , V_52 ) ;
}
static int F_80 ( struct V_1 * V_2 , unsigned int V_110 ,
struct V_3 * V_4 )
{
int V_130 ;
if ( V_4 -> V_10 & V_131 )
return - V_132 ;
if ( V_110 > 1 ) {
V_130 = F_81 ( V_2 , V_110 , V_133 ,
V_134 | V_135 ) ;
if ( V_130 > 0 ) {
if ( ! ( F_12 ( V_4 -> V_56 + V_58 ) & V_136 ) ) {
V_4 -> V_137 = F_78 ;
V_4 -> V_10 |= V_138 ;
return V_130 ;
}
...
V_130 = F_81 ( V_2 , 1 , 1 , V_135 ) ;
if ( V_130 == 1 )
return V_130 ;
return F_81 ( V_2 , 1 , 1 , V_134 ) ;
}
static int F_83 ( struct V_1 * V_2 , const struct V_106 * V_139 )
{
unsigned int V_140 = V_139 -> V_95 ;
struct V_141 V_142 = V_143 [ V_140 ] ;
const struct V_141 * V_144 [] = { & V_142 , NULL } ;
...
int V_145 = V_125 ;
F_13 ( L_4 ) ;
F_84 ( ( int ) V_146 > V_147 ) ;
F_85 ( & V_2 -> V_8 , V_148 ) ;
if ( V_2 -> V_5 == V_149 && ! V_150 )
return - V_132 ;
if ( F_38 ( V_2 ) )
F_39 ( V_2 ) ;
if ( V_2 -> V_5 == V_151 )
F_2 ( & V_2 -> V_8 ,
L_62 ) ;
if ( V_2 -> V_5 == V_152 && V_2 -> V_7 == 0xCC06 )
V_145 = V_153 ;
...
V_31 = F_88 ( V_2 , 1 << V_145 , V_158 ) ;
if ( V_31 == - V_159 )
F_89 ( V_2 ) ;
if ( V_31 )
return V_31 ;
V_4 = F_90 ( V_8 , sizeof( * V_4 ) , V_160 ) ;
if ( ! V_4 )
return - V_161 ;
V_4 -> V_10 |= ( unsigned long ) V_142 . V_16 ;
if ( V_140 == V_162 &&
( V_2 -> V_163 == 0xa1 || V_2 -> V_163 == 0xa2 ) )
V_4 -> V_10 |= V_131 ;
if ( V_140 == V_164 && V_2 -> V_163 >= 0x40 )
V_4 -> V_10 &= ~ V_165 ;
if ( F_54 ( V_2 ) )
V_4 -> V_10 &= ~ V_166 ;
V_4 -> V_56 = F_91 ( V_2 ) [ V_145 ] ;
F_74 ( V_2 , V_145 , V_4 ) ;
if ( F_63 ( V_2 ) )
V_4 -> V_10 |= V_167 ;
#ifdef F_92
...
V_110 = F_94 ( F_95 ( V_4 -> V_123 ) , F_96 ( V_4 -> V_18 ) ) ;
V_14 = F_97 ( & V_2 -> V_8 , V_144 , V_110 ) ;
if ( ! V_14 )
return - V_161 ;
V_14 -> V_16 = V_4 ;
if ( F_80 ( V_2 , V_110 , V_4 ) < 0 ) {
F_98 ( V_2 , 1 ) ;
}
V_4 -> V_113 = F_79 ( V_2 , 0 ) ;
if ( ! ( V_4 -> V_123 & V_178 ) || V_179 )
V_14 -> V_10 |= V_180 ;
else
F_2 ( & V_2 -> V_8 , L_66 ) ;
if ( V_142 . V_10 & V_181 )
...
for ( V_49 = 0 ; V_49 < V_14 -> V_110 ; V_49 ++ ) {
struct V_28 * V_29 = V_14 -> V_83 [ V_49 ] ;
F_100 ( V_29 , V_145 , - 1 , L_67 ) ;
F_100 ( V_29 , V_145 ,
0x100 + V_29 -> V_53 * 0x80 , L_68 ) ;
if ( V_29 -> V_10 & V_181 )
V_29 -> V_182 = V_4 -> V_183 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_49 ) ) )
V_29 -> V_84 = & V_184 ;
}
F_47 ( V_14 ) ;
F_66 ( V_14 ) ;
V_31 = F_41 ( V_2 , V_4 -> V_123 & V_185 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
