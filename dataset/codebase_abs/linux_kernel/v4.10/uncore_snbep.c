...
{
int V_69 = V_59 . V_143 ;
if ( V_144 . V_58 > V_59 . V_60 )
V_144 . V_58 = V_59 . V_60 ;
if ( V_72 [ V_69 ] . V_73 [ V_145 ] ) {
T_1 V_146 ;
F_3 ( V_72 [ V_69 ] . V_73 [ V_145 ] ,
0x94 , & V_146 ) ;
if ( ( ( V_146 >> 6 ) & 0x3 ) == 0 )
V_147 . V_58 = 2 ;
}
...
struct V_10 * V_11 = & V_9 -> V_12 ;
T_2 V_15 = 0 ;
F_3 ( V_4 , V_149 [ V_11 -> V_22 ] , ( T_1 * ) & V_15 ) ;
F_3 ( V_4 , V_149 [ V_11 -> V_22 ] + 4 , ( T_1 * ) & V_15 + 1 ) ;
return V_15 ;
}
int F_79 ( void )
{
...
void F_80 ( void )
{
if ( V_152 . V_58 > V_59 . V_60 )
V_152 . V_58 = V_59 . V_60 ;
V_61 = V_153 ;
}
int F_81 ( void )
{
...
{
struct V_3 * V_160 = NULL ;
int V_79 , V_15 = 0 ;
while ( 1 ) {
V_160 = F_41 ( V_85 , 0x208d , V_160 ) ;
if ( ! V_160 )
break;
if ( V_15 == 0 )
V_79 = V_160 -> V_79 -> V_86 ;
if ( V_79 != V_160 -> V_79 -> V_86 )
break;
V_15 ++ ;
}
F_47 ( V_160 ) ;
...
int F_91 ( void )
{
int V_90 = F_40 ( 0x2014 , V_166 , V_167 , false ) ;
if ( V_90 )
return V_90 ;
V_93 = V_168 ;
V_95 = & V_169 ;
