...
V_8 -> system = V_180 ;
V_156 -> V_182 ( V_156 , V_183 , V_184 ) ;
F_72 ( V_185 L_65 ,
F_73 ( & V_13 -> V_42 ) ) ;
if ( V_8 -> V_123 & V_186 ) {
V_10 = F_70 ( V_13 , V_187 ) ;
if ( ! V_10 ) {
V_8 -> system = V_187 ;
V_156 -> V_182 ( V_156 , V_183 ,
V_188 ) ;
F_72 ( V_185
L_66 ,
F_73 ( & V_13 -> V_42 ) ) ;
...
F_73 ( & V_13 -> V_42 ) ) ;
V_8 -> system = V_189 ;
V_156 -> V_182 ( V_156 , V_190 , V_191 ) ;
F_74 ( 10 ) ;
V_156 -> V_182 ( V_156 , V_190 , V_192 ) ;
V_156 -> V_182 ( V_156 , V_183 , V_193 ) ;
V_10 = F_75 ( V_13 ) ;
if ( ! V_10 )
...
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_194 * V_29 = NULL ;
struct V_27 * V_44 = NULL ;
unsigned char * V_43 = NULL ;
int V_45 , V_10 , V_195 ;
unsigned int V_196 , V_197 = 0 , V_198 = V_8 -> V_59 ;
V_29 = F_77 ( V_8 -> V_59 , V_199 ) ;
if ( ! V_29 )
return - V_152 ;
...
if ( F_18 ( V_29 -> V_202 ) != V_203 ) {
F_72 ( V_204 L_69 ,
F_73 ( & V_13 -> V_42 ) , F_18 ( V_29 -> V_202 ) ) ;
V_10 = - V_176 ;
goto V_201;
}
if ( V_29 -> V_148 > V_205 ) {
...
V_195 = V_29 -> V_148 ;
V_8 -> V_206 . V_207 = F_79 ( V_195 + 1 ,
sizeof( * V_8 -> V_206 . V_207 ) ,
V_199 ) ;
if ( ! V_8 -> V_206 . V_207 ) {
V_10 = - V_152 ;
goto V_201;
...
V_8 -> V_206 . V_91 = L_71 ;
V_43 = F_80 ( V_29 , V_198 , V_199 ) ;
if ( ! V_43 ) {
V_10 = - V_152 ;
goto V_201;
}
for ( V_45 = 0 ; V_45 < V_195 ; ++ V_45 ) {
V_44 = F_81 ( sizeof( struct V_27 ) , V_199 ) ;
if ( ! V_44 ) {
V_10 = - V_152 ;
goto V_208;
}
V_8 -> V_206 . V_207 [ V_45 ] = & V_44 -> V_31 . V_29 ;
V_196 = F_20 ( V_29 -> V_209 [ V_45 ] . V_210 ) ;
V_44 -> V_46 = F_20 ( V_29 -> V_209 [ V_45 ] . V_46 ) ;
F_34 ( & V_13 -> V_42 , L_72
L_73 , V_45 , V_29 -> V_209 [ V_45 ] . V_211 , V_196 ,
V_44 -> V_46 ) ;
V_44 -> V_211 = V_29 -> V_209 [ V_45 ] . V_211 ;
if ( F_14 ( V_44 -> V_211 ) )
snprintf ( V_44 -> V_91 , sizeof( V_44 -> V_91 ) , L_35 ,
F_14 ( V_29 -> V_209 [ V_45 ] . V_211 ) ) ;
else
snprintf ( V_44 -> V_91 , sizeof( V_44 -> V_91 ) ,
L_74 , V_29 -> V_209 [ V_45 ] . V_211 ) ;
F_82 ( & V_44 -> V_31 . V_29 ) ;
V_44 -> V_31 . V_29 . V_91 = V_44 -> V_91 ;
V_44 -> V_31 . V_29 . V_3 = V_212 ;
V_44 -> V_31 . V_213 = F_25 ( V_44 -> V_211 ) ;
if ( ! V_44 -> V_46 )
continue;
V_44 -> V_48 = F_77 ( V_44 -> V_46 , V_199 ) ;
if ( ! V_44 -> V_48 ) {
V_10 = - V_152 ;
goto V_208;
}
if ( ( ( V_196 / V_8 -> V_59 ) == ( V_197 / V_8 -> V_59 ) )
&& ( ( ( V_196 + V_44 -> V_46 - 1 ) / V_8 -> V_59 )
== ( V_197 / V_8 -> V_59 ) ) ) {
memcpy ( V_44 -> V_48 , V_43 + V_196 % V_8 -> V_59 ,
V_44 -> V_46 ) ;
continue;
}
V_197 = ( V_196 / V_8 -> V_59 ) * V_8 -> V_59 ;
if ( ( V_197 + V_198 ) < ( V_196 + V_44 -> V_46 ) ) {
F_7 ( V_43 ) ;
V_198 = ( ( ( V_196 + V_44 -> V_46 ) / V_8 -> V_59 )
+ 1 ) * V_8 -> V_59 - V_197 ;
V_43 = F_77 ( V_198 , V_199 ) ;
if ( ! V_43 ) {
V_10 = - V_152 ;
goto V_201;
}
}
F_78 ( & V_8 -> V_128 [ 0 ] , V_43 , V_198 ) ;
V_8 -> V_131 = 1 ;
V_8 -> V_129 = 0 ;
V_8 -> V_127 = 0 ;
V_8 -> V_135 = V_136 ;
...
V_8 -> system = V_189 ;
V_8 -> V_153 = F_43 ;
V_13 -> V_214 . V_215 = F_32 ( struct V_216 , V_217 ) ;
V_13 -> V_214 . V_218 = sizeof( struct V_105 ) ;
V_13 -> V_214 . V_219 = F_32 ( struct V_216 , V_140 ) ;
V_13 -> V_214 . V_220 = sizeof( struct V_139 ) ;
if ( F_75 ( V_13 ) )
return - V_221 ;
...
static int F_84 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_178 * V_156 = V_13 -> V_156 ;
struct V_95 * V_223 = NULL ;
struct V_50 * V_224 = NULL ;
struct V_27 * V_44 = NULL ;
int V_10 , V_18 ;
T_5 V_225 = V_226 ;
unsigned long V_227 ;
if ( V_156 -> V_42 . V_228 && * ( V_156 -> V_42 . V_228 ) )
V_225 = * ( V_156 -> V_42 . V_228 ) ;
for ( V_10 = 0 ; V_8 -> V_206 . V_207 [ V_10 ] ; ++ V_10 ) {
V_44 = F_12 ( V_8 -> V_206 . V_207 [ V_10 ] ) ;
if ( V_44 -> V_211 == V_40 )
V_223 = V_44 -> V_48 ;
else if ( V_44 -> V_211 == V_33 )
V_224 = V_44 -> V_48 ;
}
if ( ! V_223 || ! V_224 )
return - V_176 ;
V_8 -> V_26 = F_18 ( V_223 -> V_26 ) ;
V_8 -> V_23 = F_18 ( V_223 -> V_23 ) ;
V_8 -> V_25 = F_18 ( V_223 -> V_25 ) ;
V_8 -> V_59 = F_18 ( V_224 -> V_71 ) ;
F_2 ( & V_12 ) ;
V_18 = F_85 ( & V_20 , V_13 , 0 , 256 , V_199 ) ;
F_3 ( & V_12 ) ;
if ( V_18 < 0 )
return V_18 ;
V_8 -> V_5 = F_86 ( 1 << V_19 ) ;
...
V_8 -> V_157 = F_87 ( F_67 , & V_8 -> V_161 ) ;
if ( ! V_8 -> V_157 ) {
V_10 = - V_152 ;
goto V_230;
}
V_8 -> V_157 -> V_174 = V_13 ;
F_88 ( V_8 -> V_157 , F_65 ) ;
F_89 ( V_8 -> V_157 , V_225 ) ;
F_90 ( V_8 -> V_157 , V_231 ) ;
F_91 ( V_8 -> V_157 , V_232 ) ;
F_92 ( V_8 -> V_157 ,
V_231 * V_8 -> V_59 ) ;
V_8 -> V_5 -> V_233 = V_233 ;
V_8 -> V_5 -> V_234 = V_18 << V_19 ;
V_8 -> V_5 -> V_235 = & V_236 ;
V_8 -> V_14 = 1 ;
V_8 -> V_5 -> V_9 = V_8 ;
V_8 -> V_5 -> V_157 = V_8 -> V_157 ;
sprintf ( V_8 -> V_5 -> V_237 , L_79 , V_18 ) ;
F_93 ( V_8 -> V_157 , V_8 -> V_59 ) ;
V_227 = F_18 ( V_224 -> V_58 ) ;
V_227 *= F_18 ( V_224 -> V_56 ) ;
V_227 *= V_8 -> V_59 >> 9 ;
F_94 ( V_8 -> V_5 , V_227 ) ;
F_34 ( & V_13 -> V_42 , L_80 , V_227 ) ;
F_95 ( & V_13 -> V_42 , V_8 -> V_5 ) ;
V_8 -> V_238 = 1 ;
return 0 ;
V_230:
F_9 ( V_8 -> V_5 ) ;
...
struct V_27 * V_44 ;
if ( V_8 -> V_206 . V_207 ) {
for ( V_45 = 0 ; V_8 -> V_206 . V_207 [ V_45 ] ; ++ V_45 ) {
V_44 = F_12 ( V_8 -> V_206
. V_207 [ V_45 ] ) ;
F_7 ( V_44 -> V_48 ) ;
F_7 ( V_44 ) ;
...
static int F_98 ( struct V_99 * V_13 )
{
struct V_7 * V_8 ;
int V_10 = 0 ;
V_8 = F_81 ( sizeof( struct V_7 ) , V_199 ) ;
if ( ! V_8 )
return - V_152 ;
F_99 ( V_13 , V_8 ) ;
V_8 -> V_13 = V_13 ;
...
if ( V_10 )
goto V_239;
V_10 = F_101 ( & V_13 -> V_42 . V_240 , & V_8 -> V_206 ) ;
if ( V_10 )
goto V_239;
V_10 = F_84 ( V_13 ) ;
if ( ! V_10 ) {
...
F_102 ( & V_13 -> V_42 . V_240 , & V_8 -> V_206 ) ;
V_239:
F_99 ( V_13 , NULL ) ;
F_96 ( V_8 ) ;
F_7 ( V_8 ) ;
...
static void F_103 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
static int F_106 ( struct V_99 * V_13 , T_6 V_244 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
static int F_107 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
int V_10 = 0 ;
...
struct V_7 * V_245 ;
struct V_178 * V_156 = V_13 -> V_156 ;
struct V_27 * V_44 , * V_246 ;
unsigned char V_45 ;
F_2 ( & V_156 -> V_247 ) ;
V_245 = F_81 ( sizeof( struct V_7 ) , V_199 ) ;
if ( ! V_245 ) {
V_10 = - V_152 ;
goto V_248;
}
...
if ( F_83 ( V_13 ) )
goto V_239;
for ( V_45 = 0 ; V_245 -> V_206 . V_207 [ V_45 ]
&& V_8 -> V_206 . V_207 [ V_45 ] ; ++ V_45 ) {
V_44 = F_12 ( V_245 -> V_206 . V_207 [ V_45 ] ) ;
V_246 = F_12 ( V_8 -> V_206 . V_207 [ V_45 ] ) ;
if ( V_44 -> V_211 == V_33
&& V_246 -> V_211 == V_44 -> V_211 ) {
if ( memcmp ( V_44 -> V_48 , V_246 -> V_48 , V_44 -> V_46 ) )
break;
V_8 -> V_238 = 1 ;
break;
}
