...
V_16 = F_7 ( V_4 -> V_19 ) ;
F_8 ( & V_16 ) ;
V_17 = F_13 ( & V_4 -> V_5 , V_8 , V_4 -> V_20 ,
& V_16 , V_12 ) ;
if ( V_17 )
return V_17 ;
V_4 -> V_7 = false ;
...
int V_17 ;
T_3 V_16 ;
V_17 = F_15 ( & V_4 -> V_5 , V_8 , V_21 , & V_16 ) ;
if ( V_17 )
return V_17 ;
V_4 -> V_19 = F_16 ( V_16 ) ;
V_4 -> V_7 = true ;
...
{
int V_17 ;
unsigned V_23 = V_22 % V_14 ;
V_17 = F_17 ( V_4 , V_8 , V_22 , V_12 ) ;
if ( V_17 )
return V_17 ;
F_19 ( V_23 , ( unsigned long * ) & V_4 -> V_19 ) ;
V_4 -> V_18 = true ;
return 0 ;
}
...
if ( V_17 )
return V_17 ;
F_21 ( V_23 , ( unsigned long * ) & V_4 -> V_19 ) ;
V_4 -> V_18 = true ;
return 0 ;
}
int F_22 ( struct V_3 * V_4 , T_1 V_8 ,
T_2 V_22 , T_1 * V_12 , bool * V_24 )
{
int V_17 ;
unsigned V_23 = V_22 % V_14 ;
V_17 = F_17 ( V_4 , V_8 , V_22 , V_12 ) ;
if ( V_17 )
return V_17 ;
* V_24 = F_23 ( V_23 , ( unsigned long * ) & V_4 -> V_19 ) ;
return 0 ;
}
