...
{
struct V_57 * V_58 = F_34 ( V_81 , V_68 ) ;
struct V_82 * V_69 ;
...
static int F_61 ( struct V_88 * V_89 ,
unsigned long * V_90 )
{
* V_90 = V_39 ;
return 0 ;
...
static int F_67 ( struct V_95 * V_96 , void * V_97 )
{
int V_17 = 0 ;
F_68 ( V_96 , L_9 , V_71 ) ;
F_68 ( V_96 , L_10 ) ;
...
static int F_69 ( struct V_99 * V_99 ,
struct V_100 * V_100 )
{
return F_70 ( V_100 , F_67 , V_99 -> V_101 ) ;
}
static inline void F_71 ( void )
{
V_102 = F_72 ( L_12 , NULL ) ;
if ( ! V_102 )
return;
if ( ! F_73 ( L_13 , V_103 , V_102 ,
V_35 , & V_104 ) )
goto V_105;
return;
V_105:
...
int V_106 ;
int V_107 ;
V_107 = F_76 ( F_54 () ) * sizeof( long ) ;
V_83 = F_77 ( V_107 , V_108 ) ;
if ( ! V_83 )
return - V_109 ;
V_106 = F_65 () ;
if ( V_106 )
...
goto V_110;
V_112 = V_106 ;
V_81 = F_79 ( struct V_57 ) ;
if ( ! V_81 ) {
V_106 = - V_109 ;
goto V_113;
}
V_114 = F_80 ( L_12 , NULL ,
& V_115 ) ;
if ( F_36 ( V_114 ) ) {
V_106 = - V_94 ;
goto V_116;
