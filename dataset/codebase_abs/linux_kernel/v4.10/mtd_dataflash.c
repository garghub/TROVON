...
V_2 -> V_78 -> V_79 , V_2 -> V_80 ,
V_70 ) ;
V_63 = & V_11 -> V_7 ;
V_63 -> V_70 = ( V_75 && V_75 -> V_70 ) ? V_75 -> V_70 : V_11 -> V_70 ;
V_63 -> V_81 = V_71 * V_72 ;
V_63 -> V_82 = V_72 ;
V_63 -> V_83 = V_72 ;
V_63 -> type = V_84 ;
...
V_63 -> V_89 = F_18 ;
V_63 -> V_11 = V_11 ;
V_63 -> V_5 . V_90 = & V_2 -> V_5 ;
F_32 ( V_63 , V_2 -> V_5 . V_91 ) ;
if ( V_64 >= 'c' )
V_76 = F_28 ( V_63 , V_64 ) ;
F_33 ( & V_2 -> V_5 , L_23 ,
V_70 , ( long long ) ( ( V_63 -> V_81 + 1023 ) >> 10 ) ,
V_72 , V_76 ) ;
F_34 ( V_2 , V_11 ) ;
V_77 = F_35 ( V_63 ,
V_75 ? V_75 -> V_92 : NULL ,
...
static inline int F_36 ( struct V_1 * V_2 , char * V_70 ,
int V_71 , int V_72 , int V_73 )
{
return F_29 ( V_2 , V_70 , V_71 , V_72 ,
V_73 , 0 ) ;
}
static struct V_94 * F_37 ( struct V_1 * V_2 )
{
int V_95 ;
T_1 V_96 = V_97 ;
T_1 V_98 [ 3 ] ;
...
switch ( V_4 & 0x3c ) {
case 0x0c :
V_4 = F_36 ( V_2 , L_29 , 512 , 264 , 9 ) ;
break;
case 0x14 :
V_4 = F_36 ( V_2 , L_30 , 1024 , 264 , 9 ) ;
break;
case 0x1c :
V_4 = F_36 ( V_2 , L_31 , 2048 , 264 , 9 ) ;
break;
case 0x24 :
V_4 = F_36 ( V_2 , L_32 , 4096 , 264 , 9 ) ;
break;
case 0x2c :
V_4 = F_36 ( V_2 , L_33 , 4096 , 528 , 10 ) ;
break;
case 0x34 :
V_4 = F_36 ( V_2 , L_34 , 8192 , 528 , 10 ) ;
break;
case 0x38 :
case 0x3c :
V_4 = F_36 ( V_2 , L_35 , 8192 , 1056 , 11 ) ;
break;
default:
F_33 ( & V_2 -> V_5 , L_36 ,
V_4 & 0x3c ) ;
