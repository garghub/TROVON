...
struct V_1 * V_6 ;
int V_47 ;
V_6 = F_29 ( V_45 -> V_48 , sizeof( * V_6 ) , V_49 ) ;
if ( ! V_6 )
return - V_50 ;
V_6 -> V_8 = V_8 ;
V_5 = & V_6 -> V_5 ;
V_10 -> V_11 = F_30 ( V_10 -> V_48 -> V_51 ) ;
V_5 -> V_52 = F_31 ( V_10 -> V_48 -> V_51 ) ;
if ( F_14 ( V_10 -> V_11 ) && F_14 ( V_5 -> V_52 ) ) {
F_32 ( V_45 -> V_48 , L_7 ) ;
return 0 ;
}
F_33 ( & V_6 -> V_5 ,
...
if ( ! F_14 ( V_5 -> V_52 ) ) {
V_5 -> V_52 -> V_5 = & V_6 -> V_5 ;
V_47 = F_41 ( V_45 , V_5 -> V_52 ) ;
if ( V_47 ) {
F_35 ( V_45 -> V_48 , L_11 ) ;
goto V_61;
}
