...
V_3 [ V_92 ] = ( ( ( V_93 >> 16 ) & 0xFFFF ) + V_266 ) & 0xFFFF ;
}
} else {
for ( V_92 = 0 ; V_92 < V_264 -> V_92 ; V_92 ++ ) {
F_23 ( V_2 , V_213 ,
...
V_392 |= V_167 ;
#endif
F_23 ( V_2 , V_16 -> V_394 | V_395 ,
V_396 ) ;
F_23 ( V_2 , V_16 -> V_394 , V_396 ) ;
for ( V_72 = 0 ; V_72 < V_71 ; V_72 ++ ) {
F_52 ( 1 ) ;
if ( ( F_27 ( V_2 , V_397 ) &
V_398 ) == 0 )
...
V_83 -> V_104 -> V_308 = NULL ;
if ( V_16 -> V_393 ) {
V_166 = F_157 ( V_2 , V_83 ) ;
if ( V_166 )
return V_166 ;
}
F_23 ( V_2 , V_407 | V_16 -> V_408 ,
V_409 ) ;
return 0 ;
}
...
F_23 ( V_2 , V_16 -> V_419 , V_422 ) ;
if ( V_142 -> V_290 == V_292 ) {
V_418 = V_423 |
V_424 ;
} else {
V_418 = F_164 ( F_105 ( V_142 -> V_298 ) + 1 ) ;
if ( V_142 -> V_298 & V_299 )
V_418 |= V_425 ;
if ( V_142 -> V_298 & V_300 )
V_418 |= V_423 ;
}
F_23 ( V_2 , V_418 , V_426 ) ;
V_16 -> V_394 &= ~ V_427 ;
F_23 ( V_2 , V_16 -> V_394 , V_396 ) ;
F_23 ( V_2 , V_417 , V_188 ) ;
}
...
F_23 ( V_2 , V_16 -> V_419 , V_422 ) ;
V_16 -> V_428 &= ~ V_429 ;
F_23 ( V_2 , V_16 -> V_428 , V_430 ) ;
F_26 ( V_2 , 0 , V_431 ) ;
F_23 ( V_2 , V_432 , V_403 ) ;
V_16 -> V_428 &= ~ V_433 ;
F_23 ( V_2 , V_16 -> V_428 , V_430 ) ;
{
...
if ( V_16 -> V_19 ) {
F_26 ( V_2 , V_283 - 1 , V_434 ) ;
F_23 ( V_2 , V_435 ,
V_403 ) ;
} else {
F_26 ( V_2 , V_283 , V_434 ) ;
F_23 ( V_2 , V_435 ,
V_403 ) ;
F_26 ( V_2 , V_283 - 1 , V_434 ) ;
}
...
unsigned int V_440 ;
V_16 -> V_408 &= ~ V_441 ;
V_440 = F_118 ( V_2 , V_142 -> V_301 ,
V_274 ) ;
F_26 ( V_2 , 1 , V_442 ) ;
F_23 ( V_2 , V_443 , V_403 ) ;
F_26 ( V_2 , V_440 - 1 , V_442 ) ;
} else {
V_16 -> V_408 |= V_441 ;
V_16 -> V_419 |= F_167 (
F_105 ( V_142 -> V_301 ) ) ;
...
static int F_175 ( struct V_1 * V_2 , struct V_82 * V_83 ,
struct V_141 * V_142 )
{
const struct V_99 * V_100 = V_2 -> V_101 ;
struct V_15 * V_16 = V_2 -> V_17 ;
...
static int F_176 ( struct V_1 * V_2 , struct V_82 * V_83 )
{
struct V_15 * V_16 = V_2 -> V_17 ;
F_47 ( V_2 ) ;
if ( V_16 -> V_19 )
F_23 ( V_2 , V_461 , V_188 ) ;
F_23 ( V_2 , V_410 , V_188 ) ;
F_23 ( V_2 , V_462 , V_403 ) ;
V_16 -> V_402 = 0 ;
V_16 -> V_408 = 0 ;
V_16 -> V_419 = 0 ;
V_16 -> V_428 = 0 ;
...
F_23 ( V_2 , 0 , V_426 ) ;
F_57 ( V_2 , V_30 , ~ 0 , 0 ) ;
F_23 ( V_2 , V_411 , V_416 ) ;
F_23 ( V_2 , V_464 , V_162 ) ;
if ( V_16 -> V_95 ) {
...
struct V_15 * V_16 = V_2 -> V_17 ;
int V_166 ;
V_166 = F_178 ( V_2 , V_83 , V_264 , V_3 , 0 ) ;
if ( V_166 )
return V_166 ;
V_16 -> V_467 &= ~ V_468 ;
V_16 -> V_467 |= F_179 ( V_83 -> V_469 ) ;
F_23 ( V_2 , V_16 -> V_467 , V_470 ) ;
return V_264 -> V_92 ;
}
...
{
struct V_15 * V_16 = V_2 -> V_17 ;
if ( ( V_3 [ 0 ] & ( V_471 | V_472 ) ) &&
V_16 -> V_473 )
return - V_45 ;
if ( F_181 ( V_83 , V_3 ) ) {
V_16 -> V_474 &= ~ V_475 ;
V_16 -> V_474 |= F_182 ( V_83 -> V_476 ) ;
F_23 ( V_2 , V_16 -> V_474 , V_477 ) ;
}
V_3 [ 1 ] = F_27 ( V_2 , V_478 ) ;
return V_264 -> V_92 ;
}
...
{
if ( F_181 ( V_83 , V_3 ) )
F_1 ( V_2 , V_83 -> V_476 , V_480 ) ;
V_3 [ 1 ] = F_10 ( V_2 , V_480 ) ;
return V_264 -> V_92 ;
}
...
V_489 = V_491 |
V_492 |
F_190 ( F_105 ( V_142 -> V_301 ) ) ;
if ( V_142 -> V_301 & V_299 )
V_489 |= V_493 ;
F_1 ( V_2 , V_489 , V_494 ) ;
if ( V_83 -> V_469 ) {
F_1 ( V_2 , V_83 -> V_476 , V_495 ) ;
F_1 ( V_2 , V_496 , V_488 ) ;
F_1 ( V_2 , V_83 -> V_469 , V_497 ) ;
} else {
F_30 ( V_2 -> V_10 ,
L_29 ) ;
return - V_180 ;
...
V_83 -> V_104 -> V_179 /
F_123 ( V_83 ) ) ;
V_83 -> V_104 -> V_308 = F_188 ;
return 0 ;
}
static int F_191 ( struct V_1 * V_2 , struct V_82 * V_83 )
{
F_1 ( V_2 , V_498 |
V_499 |
V_500 |
...
struct V_15 * V_16 = V_2 -> V_17 ;
unsigned int V_502 ;
struct V_82 * V_83 = & V_2 -> V_128 [ V_503 ] ;
unsigned long V_18 ;
F_24 ( & V_16 -> V_43 , V_18 ) ;
if ( V_16 -> V_64 )
F_193 ( V_16 -> V_64 , V_83 , true ) ;
F_25 ( & V_16 -> V_43 , V_18 ) ;
V_502 = F_10 ( V_2 , V_482 ) ;
if ( V_502 & V_504 ) {
F_1 ( V_2 , V_505 ,
V_488 ) ;
V_83 -> V_104 -> V_105 |= V_106 ;
...
V_16 -> V_474 &= ~ V_510 ;
V_16 -> V_474 |= F_195 ( V_507 ) ;
F_23 ( V_2 , V_16 -> V_474 , V_477 ) ;
V_509 = F_27 ( V_2 , V_511 ) ;
if ( V_509 & V_512 ) {
V_287 = - V_45 ;
goto error;
}
...
F_23 ( V_2 , V_16 -> V_467 , V_470 ) ;
V_16 -> V_467 &= ~ V_513 ;
while ( ( V_509 = F_27 ( V_2 , V_511 ) ) &
V_512 ) {
F_52 ( ( V_16 -> V_473 + 999 ) / 1000 ) ;
if ( -- V_211 < 0 ) {
F_30 ( V_2 -> V_10 ,
L_30 ) ;
V_287 = - V_269 ;
...
V_16 -> V_467 |= V_516 ;
F_23 ( V_2 , V_16 -> V_467 , V_470 ) ;
F_52 ( ( V_16 -> V_473 + 999 ) / 2000 ) ;
V_16 -> V_467 &= ~ V_516 ;
F_23 ( V_2 , V_16 -> V_467 , V_470 ) ;
F_52 ( ( V_16 -> V_473 + 999 ) / 2000 ) ;
if ( F_27 ( V_2 , V_478 ) & V_471 )
V_515 |= V_265 ;
}
if ( V_508 )
* V_508 = V_515 ;
...
{
struct V_15 * V_16 = V_2 -> V_17 ;
unsigned int V_517 = V_16 -> V_518 ;
int V_287 = V_264 -> V_92 ;
unsigned char V_519 , V_520 = 0 ;
if ( V_264 -> V_92 != 2 )
return - V_305 ;
switch ( V_3 [ 0 ] ) {
case V_521 :
...
V_519 = V_3 [ 1 ] & 0xFF ;
if ( V_16 -> V_522 ) {
V_287 = F_194 ( V_2 , V_83 , V_519 ,
& V_520 ) ;
} else if ( V_16 -> V_473 > 0 ) {
V_287 = F_196 ( V_2 , V_83 , V_519 ,
& V_520 ) ;
} else {
F_30 ( V_2 -> V_10 , L_31 ) ;
return - V_305 ;
...
static void F_198 ( struct V_1 * V_2 , struct V_82 * V_83 )
{
int V_72 ;
for ( V_72 = 0 ; V_72 < V_83 -> V_215 ; V_72 ++ ) {
...
static unsigned int F_199 ( struct V_1 * V_2 ,
enum V_535 V_4 )
{
const struct V_7 * V_8 ;
if ( V_4 < F_20 ( V_536 ) ) {
...
static void F_200 ( struct V_58 * V_59 , unsigned int V_42 ,
enum V_535 V_4 )
{
struct V_1 * V_2 = V_59 -> V_60 -> V_2 ;
unsigned int V_537 = F_199 ( V_2 , V_4 ) ;
if ( V_537 == 0 )
return;
switch ( V_4 ) {
case V_538 :
...
static unsigned int F_201 ( struct V_58 * V_59 ,
enum V_535 V_4 )
{
struct V_1 * V_2 = V_59 -> V_60 -> V_2 ;
unsigned int V_537 = F_199 ( V_2 , V_4 ) ;
...
case V_554 :
case V_555 :
return F_13 ( V_2 , V_537 ) ;
case V_556 :
case V_557 :
case V_558 :
case V_559 :
return F_28 ( V_2 , V_537 ) ;
default:
return F_27 ( V_2 , V_537 ) ;
}
}
...
{
struct V_15 * V_16 = V_2 -> V_17 ;
unsigned int V_24 = F_203 ( V_16 -> V_518 ) ;
int V_72 ;
for ( V_72 = 0 ; V_72 < V_264 -> V_92 ; V_72 ++ )
V_3 [ V_72 ] = V_24 ;
return V_264 -> V_92 ;
...
int V_46 , int V_569 , int V_3 , unsigned long V_6 )
{
if ( V_46 ) {
F_7 ( V_2 , V_3 , V_6 + 2 * V_569 ) ;
return 0 ;
}
return F_16 ( V_2 , V_6 + 2 * V_569 ) ;
}
static int F_208 ( struct V_1 * V_2 , unsigned int * V_3 )
{
struct V_15 * V_16 = V_2 -> V_17 ;
V_3 [ 1 ] = V_16 -> V_570 * V_16 -> V_275 ;
V_3 [ 2 ] = V_16 -> V_571 * V_16 -> V_275 ;
return 3 ;
}
...
if ( V_572 * V_16 -> V_275 != V_3 [ 2 ] ||
V_573 * V_16 -> V_275 != V_3 [ 4 ] ) {
V_3 [ 2 ] = V_572 * V_16 -> V_275 ;
V_3 [ 4 ] = V_573 * V_16 -> V_275 ;
return - V_575 ;
}
F_1 ( V_2 , F_210 ( V_572 ) |
F_211 ( V_573 ) ,
...
static int F_213 ( int V_78 , int V_24 , int * V_580 )
{
V_78 ++ ;
* V_580 = ( ( V_78 & 0x1 ) << 11 ) |
( ( V_78 & 0x2 ) << 9 ) |
...
static int F_214 ( int V_78 , int V_24 , int * V_580 )
{
* V_580 = ( ( V_78 & 0x7 ) << 8 ) | ( V_24 & 0xff ) ;
return 11 ;
}
static int F_215 ( int V_78 , int V_24 , int * V_580 )
{
* V_580 = V_24 & 0xfff ;
return 12 ;
}
static int F_216 ( int V_78 , int V_24 , int * V_580 )
{
* V_580 = ( V_24 & 0xfff ) | ( V_78 ? 0xc000 : 0xa000 ) ;
return 16 ;
}
static int F_217 ( int V_78 , int V_24 , int * V_580 )
{
* V_580 = ( ( V_78 & 0xf ) << 8 ) | ( V_24 & 0xff ) ;
return 12 ;
}
static int F_218 ( int V_78 , int V_24 , int * V_580 )
{
* V_580 = ( ( V_78 + 1 ) << 8 ) | ( V_24 & 0xff ) ;
return 12 ;
}
static void F_219 ( struct V_1 * V_2 , int V_78 , int V_24 )
{
const struct V_99 * V_100 = V_2 -> V_101 ;
struct V_15 * V_16 = V_2 -> V_17 ;
unsigned int V_581 = 0 , V_42 = 0 , V_582 , V_580 = 0 ;
unsigned int V_142 ;
int V_72 ;
int type ;
if ( V_16 -> V_583 [ V_78 ] == V_24 )
return;
V_16 -> V_583 [ V_78 ] = V_24 ;
for ( V_72 = 0 ; V_72 < 3 ; V_72 ++ ) {
type = V_100 -> V_584 [ V_72 ] ;
if ( type == V_585 )
break;
if ( V_78 < V_583 [ type ] . V_368 ) {
V_42 = V_583 [ type ] . F_220 ( V_78 , V_24 , & V_580 ) ;
V_581 = F_221 ( V_72 ) ;
break;
}
V_78 -= V_583 [ type ] . V_368 ;
}
if ( V_42 == 0 )
return;
for ( V_582 = 1 << ( V_42 - 1 ) ; V_582 ; V_582 >>= 1 ) {
V_142 = ( V_582 & V_580 ) ? V_586 : 0 ;
F_7 ( V_2 , V_142 , V_587 ) ;
F_52 ( 1 ) ;
F_7 ( V_2 , V_588 | V_142 , V_587 ) ;
F_52 ( 1 ) ;
}
F_7 ( V_2 , V_581 , V_587 ) ;
F_52 ( 1 ) ;
...
unsigned int * V_3 )
{
F_219 ( V_2 , F_105 ( V_264 -> V_267 ) , V_3 [ 0 ] ) ;
return 1 ;
}
...
{
struct V_15 * V_16 = V_2 -> V_17 ;
V_3 [ 0 ] = V_16 -> V_583 [ F_105 ( V_264 -> V_267 ) ] ;
return 1 ;
}
static void F_224 ( struct V_1 * V_2 , struct V_82 * V_83 )
{
const struct V_99 * V_100 = V_2 -> V_101 ;
struct V_15 * V_16 = V_2 -> V_17 ;
int V_72 , V_589 ;
...
if ( type == V_585 )
return;
V_591 = V_583 [ type ] . V_591 ;
for ( V_72 = 0 ; V_72 < 3 ; V_72 ++ ) {
type = V_100 -> V_584 [ V_72 ] ;
if ( type == V_585 )
break;
if ( V_583 [ type ] . V_591 != V_591 )
V_592 = 1 ;
V_368 += V_583 [ type ] . V_368 ;
}
V_590 = V_72 ;
V_83 -> V_215 = V_368 ;
if ( V_592 ) {
unsigned int * V_593 = V_16 -> V_594 ;
if ( V_368 > V_595 )
F_30 ( V_2 -> V_10 ,
L_32 ) ;
V_83 -> V_593 = V_593 ;
V_217 = 0 ;
for ( V_72 = 0 ; V_72 < V_590 ; V_72 ++ ) {
type = V_100 -> V_584 [ V_72 ] ;
for ( V_589 = 0 ; V_589 < V_583 [ type ] . V_368 ; V_589 ++ ) {
V_593 [ V_217 ] =
( 1 << V_583 [ type ] . V_591 ) - 1 ;
V_217 ++ ;
}
}
for ( V_217 = 0 ; V_217 < V_83 -> V_215 ; V_217 ++ )
F_219 ( V_2 , V_72 , V_83 -> V_593 [ V_72 ] / 2 ) ;
} else {
type = V_100 -> V_584 [ 0 ] ;
V_83 -> V_246 = ( 1 << V_583 [ type ] . V_591 ) - 1 ;
for ( V_217 = 0 ; V_217 < V_83 -> V_215 ; V_217 ++ )
F_219 ( V_2 , V_72 , V_83 -> V_246 / 2 ) ;
}
}
static int F_225 ( struct V_1 * V_2 , int V_78 )
{
unsigned int V_142 = V_596 ;
int V_582 ;
int V_580 ;
V_580 = 0x0300 | ( ( V_78 & 0x100 ) << 3 ) | ( V_78 & 0xff ) ;
F_7 ( V_2 , V_142 , V_587 ) ;
for ( V_582 = 0x8000 ; V_582 ; V_582 >>= 1 ) {
if ( V_582 & V_580 )
V_142 |= V_586 ;
else
V_142 &= ~ V_586 ;
...
V_142 = V_596 ;
V_580 = 0 ;
for ( V_582 = 0x80 ; V_582 ; V_582 >>= 1 ) {
F_7 ( V_2 , V_142 , V_587 ) ;
F_7 ( V_2 , V_588 | V_142 , V_587 ) ;
if ( F_16 ( V_2 , V_120 ) & V_597 )
V_580 |= V_582 ;
}
F_7 ( V_2 , 0 , V_587 ) ;
return V_580 ;
...
unsigned int * V_3 )
{
V_3 [ 0 ] = F_225 ( V_2 , F_105 ( V_264 -> V_267 ) ) ;
return 1 ;
}
...
{
struct V_15 * V_16 = V_2 -> V_17 ;
V_3 [ 0 ] = V_16 -> V_598 [ F_105 ( V_264 -> V_267 ) ] ;
return 1 ;
}
...
unsigned int V_217 , unsigned int V_609 )
{
if ( V_609 != F_228 ( V_2 , V_217 ) )
return - V_305 ;
return 2 ;
}
static unsigned int F_230 ( struct V_1 * V_2 ,
unsigned int V_217 )
{
struct V_15 * V_16 = V_2 -> V_17 ;
const unsigned int V_610 = V_217 / 3 ;
return F_231 ( V_217 ,
V_16 -> V_611 [ V_610 ] ) ;
}
...
{
struct V_15 * V_16 = V_2 -> V_17 ;
unsigned int V_612 = V_217 / 3 ;
unsigned short V_24 = V_16 -> V_611 [ V_612 ] ;
if ( ( V_609 & 0x1f ) != V_609 )
return - V_305 ;
V_24 &= ~ F_233 ( V_217 ) ;
V_24 |= F_234 ( V_217 , V_609 ) ;
F_4 ( V_2 , V_24 , F_235 ( V_612 ) ) ;
V_16 -> V_611 [ V_612 ] = V_24 ;
return 2 ;
}
...
struct V_15 * V_16 = V_2 -> V_17 ;
return ( V_16 -> V_19 )
? F_232 ( V_2 , V_217 , V_609 )
: F_229 ( V_2 , V_217 , V_609 ) ;
}
...
return 0 ;
case V_619 :
return F_237 ( V_2 , V_217 , V_3 [ 1 ] ) ;
case V_620 :
V_3 [ 1 ] = F_236 ( V_2 , V_217 ) ;
break;
case V_621 :
return F_238 ( V_2 , V_217 , V_3 [ 1 ] ) ;
default:
return - V_305 ;
}
return 0 ;
...
return - V_616 ;
if ( F_181 ( V_83 , V_3 ) )
F_4 ( V_2 , V_83 -> V_476 , V_622 ) ;
V_3 [ 1 ] = F_13 ( V_2 , V_623 ) ;
return V_264 -> V_92 ;
}
static int F_243 ( struct V_1 * V_2 )
{
unsigned short V_140 ;
const int V_71 = V_624 ;
int V_72 ;
for ( V_72 = 0 ; V_72 < V_71 ; V_72 ++ ) {
V_140 = F_56 ( V_2 , V_625 ) ;
if ( ( V_140 & V_626 ) == 0 )
break;
F_244 ( V_627 ) ;
if ( F_245 ( 1 ) )
...
static void F_246 ( struct V_1 * V_2 , unsigned short V_81 )
{
...
{
int V_92 , V_85 ;
unsigned short V_634 ;
unsigned int V_635 ;
const unsigned int V_636 = 0x1000 ;
if ( V_264 -> V_267 & V_223 )
V_635 = V_636 ;
else
V_635 = F_105 ( V_264 -> V_267 ) ;
F_54 ( V_2 , V_635 , V_637 ) ;
for ( V_92 = 0 ; V_92 < V_264 -> V_92 ; V_92 ++ ) {
V_85 = F_247 ( V_2 , & V_634 ) ;
if ( V_85 < 0 )
return V_85 ;
V_3 [ V_92 ] = V_634 ;
}
...
static void F_249 ( struct V_1 * V_2 , unsigned int V_81 ,
unsigned int V_638 )
{
F_54 ( V_2 , ( V_81 >> 16 ) & 0xff , V_639 ) ;
F_54 ( V_2 , V_81 & 0xffff , V_640 ) ;
V_638 &= V_641 ;
F_246 ( V_2 , V_629 | V_638 ) ;
if ( F_243 ( V_2 ) )
F_30 ( V_2 -> V_10 ,
L_38 , V_11 ) ;
}
...
{
unsigned int V_233 = V_642 |
V_643 ;
#if 1
F_249 ( V_2 , V_233 | V_644 ,
V_645 ) ;
F_247 ( V_2 , NULL ) ;
#else
F_249 ( V_2 , 0x400000 , V_646 ) ;
F_249 ( V_2 , V_233 | V_647 ,
V_645 ) ;
if ( F_243 ( V_2 ) )
F_30 ( V_2 -> V_10 ,
L_38 , V_11 ) ;
...
static int F_251 ( unsigned int V_648 ,
unsigned int * V_649 ,
unsigned int * V_650 ,
unsigned int * V_651 )
{
...
unsigned int V_653 ;
unsigned int V_654 = 1 ;
static const unsigned int V_655 = 1000 ;
const unsigned int V_656 = V_648 *
V_655 ;
static const unsigned int V_657 = 12500 ;
int V_658 = 0 ;
for ( div = 1 ; div <= V_659 ; ++ div ) {
for ( V_653 = 1 ; V_653 <= V_660 ; ++ V_653 ) {
unsigned int V_661 =
( V_656 * div ) / V_653 ;
if ( abs ( V_661 - V_657 ) <
abs ( V_658 - V_657 ) ) {
...
{
struct V_15 * V_16 = V_2 -> V_17 ;
static const unsigned int V_663 = 50 ;
static const unsigned int V_664 = 1000 ;
...
break;
default:
for ( V_666 = 0 ; V_666 <= V_680 ; ++ V_666 ) {
if ( V_609 == F_253 ( V_666 ) ) {
V_16 -> V_673 |=
F_254 ( V_666 ) ;
break;
}
...
F_4 ( V_2 , V_16 -> V_673 , V_681 ) ;
V_665 |= F_255 ( V_649 ) |
F_256 ( V_650 ) ;
F_4 ( V_2 , V_665 , V_682 ) ;
V_16 -> V_683 = V_609 ;
for ( V_72 = 0 ; V_72 < V_71 ; ++ V_72 ) {
if ( F_13 ( V_2 , V_684 ) & V_685 )
break;
F_52 ( 1 ) ;
}
if ( V_72 == V_71 ) {
...
unsigned int V_609 , unsigned int V_662 )
{
struct V_15 * V_16 = V_2 -> V_17 ;
if ( V_609 == V_687 ) {
V_16 -> V_668 &= ~ V_669 ;
...
unsigned int V_217 , unsigned int V_700 )
{
struct V_15 * V_16 = V_2 -> V_17 ;
if ( F_258 ( V_2 , V_217 , V_700 ) == 0 )
return - V_305 ;
if ( V_217 < 4 ) {
V_16 -> V_701 &= ~ F_261 ( V_217 ) ;
V_16 -> V_701 |= F_262 ( V_217 , V_700 ) ;
F_23 ( V_2 , V_16 -> V_701 ,
V_702 ) ;
} else if ( V_217 < 8 ) {
V_16 -> V_703 &= ~ F_261 ( V_217 ) ;
V_16 -> V_703 |= F_262 ( V_217 , V_700 ) ;
F_23 ( V_2 , V_16 -> V_703 ,
V_704 ) ;
}
return 2 ;
}
static unsigned int F_263 ( struct V_1 * V_2 ,
unsigned int V_217 )
{
struct V_15 * V_16 = V_2 -> V_17 ;
if ( V_217 < 4 ) {
...
struct V_15 * V_16 = V_2 -> V_17 ;
unsigned int V_217 = F_105 ( V_264 -> V_267 ) ;
unsigned int V_705 = F_259 ( V_16 -> V_19 ) ;
switch ( V_3 [ 0 ] ) {
case V_706 :
if ( V_217 < V_705 ) {
V_16 -> V_668 |=
F_266 ( V_217 , V_16 -> V_19 ) ;
} else if ( V_217 == V_689 ) {
V_16 -> V_668 |=
V_707 ;
}
...
return 2 ;
case V_562 :
return F_257 ( V_2 , V_3 [ 1 ] , V_3 [ 2 ] ) ;
case V_566 :
V_3 [ 1 ] = V_16 -> V_683 ;
V_3 [ 2 ] = V_16 -> V_275 ;
return 3 ;
case V_619 :
return F_260 ( V_2 , V_217 , V_3 [ 1 ] ) ;
case V_620 :
V_3 [ 1 ] = F_263 ( V_2 , V_217 ) ;
return 2 ;
default:
return - V_305 ;
}
...
static int F_269 ( struct V_1 * V_2 , struct V_82 * V_83 )
{
...
return F_271 ( V_2 , V_83 ) ;
}
static int F_272 ( struct V_1 * V_2 , struct V_82 * V_83 )
{
struct V_58 * V_59 = V_83 -> V_17 ;
int V_85 ;
V_85 = F_273 ( V_59 ) ;
...
static T_3 F_274 ( int V_315 , void * V_93 )
{
struct V_1 * V_2 = V_93 ;
struct V_82 * V_710 = V_2 -> V_84 ;
struct V_82 * V_711 = V_2 -> V_182 ;
...
if ( V_16 -> V_21 ) {
unsigned long V_714 ;
F_24 ( & V_16 -> V_43 , V_714 ) ;
if ( V_710 && V_16 -> V_48 )
F_193 ( V_16 -> V_48 , V_710 , false ) ;
if ( V_711 && V_16 -> V_53 )
F_193 ( V_16 -> V_53 , V_711 , false ) ;
F_25 ( & V_16 -> V_43 , V_714 ) ;
}
#endif
F_82 ( V_2 , V_129 ) ;
F_85 ( V_2 , V_88 ) ;
...
F_23 ( V_2 , V_16 -> V_518 , V_531 ) ;
V_166 = F_280 ( V_2 , V_728 ) ;
if ( V_166 )
return V_166 ;
V_83 = & V_2 -> V_128 [ V_729 ] ;
if ( V_100 -> V_730 ) {
V_83 -> type = V_731 ;
V_83 -> V_175 = V_732 | V_733 | V_734 ;
if ( ! V_16 -> V_112 )
V_83 -> V_175 |= V_735 | V_736 | V_737 ;
if ( V_100 -> V_738 > 0xffff )
V_83 -> V_175 |= V_176 ;
if ( V_16 -> V_19 )
V_83 -> V_175 |= V_739 ;
V_83 -> V_215 = V_100 -> V_730 ;
V_83 -> V_246 = V_100 -> V_738 ;
V_83 -> V_376 = V_740 [ V_100 -> V_226 ] ;
V_83 -> V_741 = F_117 ;
V_83 -> V_742 = F_140 ;
if ( V_2 -> V_315 ) {
V_2 -> V_84 = V_83 ;
...
V_83 = & V_2 -> V_128 [ V_752 ] ;
if ( V_100 -> V_721 ) {
V_83 -> type = V_753 ;
V_83 -> V_175 = V_754 | V_755 | V_735 ;
if ( V_16 -> V_19 )
V_83 -> V_175 |= V_739 ;
V_83 -> V_215 = V_100 -> V_721 ;
V_83 -> V_246 = V_100 -> V_756 ;
V_83 -> V_376 = V_100 -> V_757 ;
V_83 -> V_742 = F_159 ;
V_83 -> V_758 = F_153 ;
V_166 = F_281 ( V_83 ) ;
if ( V_166 )
...
V_83 = & V_2 -> V_128 [ V_503 ] ;
V_83 -> type = V_762 ;
V_83 -> V_175 = V_754 | V_732 ;
V_83 -> V_215 = V_100 -> V_763 ? 32 : 8 ;
V_83 -> V_246 = 1 ;
V_83 -> V_376 = & V_764 ;
if ( V_16 -> V_19 ) {
#ifdef F_45
...
V_83 -> V_742 = F_177 ;
V_16 -> V_467 = F_179 ( V_83 -> V_469 ) ;
F_4 ( V_2 , V_16 -> V_467 , V_470 ) ;
}
V_83 = & V_2 -> V_128 [ V_768 ] ;
if ( V_100 -> V_769 ) {
V_166 = F_282 ( V_2 , V_83 , F_207 ,
V_770 ) ;
if ( V_166 )
return V_166 ;
} else {
...
V_83 = & V_2 -> V_128 [ V_771 ] ;
V_83 -> type = V_751 ;
V_83 = & V_2 -> V_128 [ V_772 ] ;
V_83 -> type = V_773 ;
V_83 -> V_175 = V_774 ;
V_83 -> V_215 = 1 ;
V_83 -> V_246 = 0 ;
...
V_83 = & V_2 -> V_128 [ V_775 ] ;
V_83 -> type = V_776 ;
V_83 -> V_175 = V_732 | V_774 ;
V_83 -> V_246 = 0xff ;
if ( V_16 -> V_19 ) {
V_83 -> V_215 = V_777 ;
V_83 -> V_741 = F_227 ;
...
V_83 -> type = V_762 ;
V_83 -> V_175 = V_732 | V_754 | V_774 ;
V_83 -> V_246 = 1 ;
if ( V_16 -> V_19 ) {
V_83 -> V_215 = 16 ;
V_83 -> V_765 = F_242 ;
F_4 ( V_2 , V_83 -> V_476 , V_622 ) ;
for ( V_72 = 0 ; V_72 < V_779 ; ++ V_72 ) {
F_4 ( V_2 , V_16 -> V_611 [ V_72 ] ,
F_235 ( V_72 ) ) ;
}
} else {
V_83 -> V_215 = 10 ;
...
if ( ! V_16 -> V_60 )
return - V_718 ;
for ( V_72 = 0 ; V_72 < V_787 ; ++ V_72 ) {
struct V_58 * V_788 = & V_16 -> V_60 -> V_61 [ V_72 ] ;
V_788 -> V_789 = 0 ;
V_788 -> V_127 = V_72 ;
F_284 ( V_788 ) ;
V_83 = & V_2 -> V_128 [ F_79 ( V_72 ) ] ;
V_83 -> type = V_790 ;
V_83 -> V_175 = V_732 | V_754 | V_176 ;
V_83 -> V_215 = 3 ;
...
V_83 = & V_2 -> V_128 [ V_795 ] ;
V_83 -> type = V_790 ;
V_83 -> V_175 = V_732 | V_754 ;
V_83 -> V_215 = 1 ;
V_83 -> V_246 = 0xf ;
V_83 -> V_741 = F_202 ;
V_83 -> V_758 = F_204 ;
...
int V_49 ;
for ( V_49 = 0 ; V_49 < V_100 -> V_721 ; ++ V_49 ) {
F_7 ( V_2 , 0xf ,
F_147 ( V_49 ) ) ;
F_7 ( V_2 , 0x0 ,
F_148 ( V_49 ) ) ;
