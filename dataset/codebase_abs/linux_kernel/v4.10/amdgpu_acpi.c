...
if ( ( V_94 -> V_82 & V_116 ) &&
F_20 () ) {
F_21 ( V_94 -> V_117 -> V_102 ) ;
F_22 ( V_94 -> V_117 ) ;
F_23 ( V_94 -> V_117 -> V_102 ) ;
F_24 ( V_94 -> V_117 -> V_102 ) ;
}
}
return V_118 ;
}
...
V_120 . V_13 = & V_119 [ 0 ] ;
V_119 [ 0 ] . type = V_14 ;
V_119 [ 0 ] . integer . V_15 = V_3 ;
if ( V_5 ) {
V_119 [ 1 ] . type = V_16 ;
V_119 [ 1 ] . V_10 . V_17 = V_5 -> V_17 ;
V_119 [ 1 ] . V_10 . V_13 = V_5 -> V_13 ;
} else {
V_119 [ 1 ] . type = V_14 ;
V_119 [ 1 ] . integer . V_15 = 0 ;
}
V_6 = F_2 ( V_2 , L_13 , & V_120 , & V_10 ) ;
if ( F_3 ( V_6 ) && V_6 != V_18 ) {
F_4 ( L_14 ,
F_5 ( V_6 ) ) ;
F_6 ( V_10 . V_13 ) ;
...
static void F_26 ( struct V_121 * V_41 , T_3 V_21 )
{
V_41 -> V_122 = V_21 & V_123 ;
...
{
struct V_130 * V_131 = & V_94 -> V_131 ;
if ( V_131 -> V_77 . V_124 && V_131 -> V_77 . V_126 )
return true ;
return false ;
}
...
if ( ! V_131 -> V_77 . V_124 )
return - V_72 ;
V_138 . V_67 = sizeof( struct V_137 ) ;
V_138 . V_142 = V_94 -> V_101 -> V_143 | ( V_94 -> V_101 -> V_144 -> V_145 << 8 ) ;
V_138 . V_146 = V_147 ;
V_138 . V_82 = V_148 ;
if ( V_136 )
V_138 . V_82 |= V_149 ;
V_138 . V_150 = V_151 ;
V_138 . V_135 = V_135 ;
V_5 . V_17 = sizeof( struct V_137 ) ;
V_5 . V_13 = & V_138 ;
while ( V_141 -- ) {
V_64 = F_25 ( V_2 , V_152 , & V_5 ) ;
if ( ! V_64 )
return - V_70 ;
...
V_67 = F_11 ( sizeof( V_140 ) , V_67 ) ;
memcpy ( & V_140 , V_64 -> V_10 . V_13 , V_67 ) ;
F_6 ( V_64 ) ;
switch ( V_140 . V_153 ) {
case V_154 :
default:
...
static int F_32 ( struct V_157 * V_158 ,
unsigned long V_159 ,
void * V_160 )
{
struct V_93 * V_94 = F_33 ( V_158 , struct V_93 , V_161 ) ;
struct V_95 * V_162 = (struct V_95 * ) V_160 ;
if ( strcmp ( V_162 -> V_97 , V_163 ) == 0 ) {
if ( F_34 () > 0 )
F_4 ( L_17 ) ;
else
F_4 ( L_18 ) ;
...
if ( V_63 -> V_75 . V_36 ) {
struct V_166 * V_167 ;
F_37 (tmp, &adev->ddev->mode_config.encoder_list,
head) {
struct V_104 * V_105 = F_38 ( V_167 ) ;
