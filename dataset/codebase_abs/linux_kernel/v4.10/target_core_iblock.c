...
static T_5
F_49 ( struct V_59 * V_60 , T_4 V_72 , T_4 V_92 )
{
struct V_15 * V_93 = F_1 ( V_60 -> V_76 ) -> V_36 ;
...
static T_5
F_52 ( struct V_15 * V_93 , struct V_59 * V_60 )
{
struct V_2 * V_3 = V_60 -> V_76 ;
struct V_95 * V_96 = & V_60 -> V_97 [ 0 ] ;
struct V_98 * V_98 = NULL ;
int V_20 ;
if ( V_96 -> V_99 ) {
V_98 = F_53 ( V_12 ) ;
if ( ! V_98 )
return V_100 ;
F_54 ( V_96 , V_60 -> V_101 , F_55 ( V_98 ) ,
V_3 -> V_37 . V_58 ) ;
}
V_20 = F_56 ( V_93 ,
F_51 ( V_3 , V_60 -> V_102 ) ,
...
V_96 = & V_60 -> V_97 [ 0 ] ;
if ( V_60 -> V_101 > 1 ||
V_96 -> V_107 != V_60 -> V_76 -> V_37 . V_58 ) {
F_8 ( L_24
L_25 , V_60 -> V_101 , V_96 -> V_107 ,
V_60 -> V_76 -> V_37 . V_58 ) ;
return V_108 ;
}
if ( F_61 ( V_93 ) )
return F_52 ( V_93 , V_60 ) ;
V_62 = F_7 ( sizeof( struct V_61 ) , V_12 ) ;
if ( ! V_62 )
goto V_109;
V_60 -> V_63 = V_62 ;
V_69 = F_38 ( V_60 , V_104 , 1 , V_90 , 0 ) ;
if ( ! V_69 )
goto V_110;
F_62 ( & V_84 ) ;
F_63 ( & V_84 , V_69 ) ;
F_64 ( & V_62 -> V_65 , 1 ) ;
while ( V_105 ) {
while ( F_65 ( V_69 , F_58 ( V_96 ) , V_96 -> V_107 , V_96 -> V_99 )
!= V_96 -> V_107 ) {
V_69 = F_38 ( V_60 , V_104 , 1 , V_90 ,
0 ) ;
if ( ! V_69 )
goto V_111;
F_35 ( & V_62 -> V_65 ) ;
...
const char * V_98 , T_6 V_113 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
char * V_114 , * V_115 , * V_116 , * V_117 ;
T_7 args [ V_118 ] ;
int V_20 = 0 , V_119 ;
unsigned long V_120 ;
V_117 = F_67 ( V_98 , V_12 ) ;
if ( ! V_117 )
return - V_21 ;
V_114 = V_117 ;
while ( ( V_115 = F_68 ( & V_117 , L_26 ) ) != NULL ) {
if ( ! * V_115 )
continue;
V_119 = F_69 ( V_115 , V_121 , args ) ;
switch ( V_119 ) {
case V_122 :
if ( V_11 -> V_36 ) {
F_8 ( L_27
...
V_27:
F_24 ( V_114 ) ;
return ( ! V_20 ) ? V_113 : V_20 ;
}
static T_6 F_73 ( struct V_2 * V_3 , char * V_127 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
...
T_6 V_130 = 0 ;
if ( V_16 )
V_130 += sprintf ( V_127 + V_130 , L_33 ,
F_74 ( V_16 , V_128 ) ) ;
if ( V_11 -> V_22 & V_23 )
V_130 += sprintf ( V_127 + V_130 , L_34 ,
V_11 -> V_28 ) ;
V_130 += sprintf ( V_127 + V_130 , L_35 , V_11 -> V_31 ) ;
V_130 += sprintf ( V_127 + V_130 , L_36 ) ;
if ( V_16 ) {
V_130 += sprintf ( V_127 + V_130 , L_37 ,
F_75 ( V_16 -> V_131 ) , F_76 ( V_16 -> V_131 ) , ( ! V_16 -> V_132 ) ?
L_38 : ( V_16 -> V_133 == V_11 ) ?
L_39 : L_40 ) ;
} else {
V_130 += sprintf ( V_127 + V_130 , L_41 ) ;
}
return V_130 ;
}
static int
...
V_135 = F_78 ( V_69 , V_78 , V_60 -> V_139 ) ;
if ( F_12 ( V_135 ) ) {
F_8 ( L_43 ) ;
return F_13 ( V_135 ) ;
}
V_135 -> V_140 . V_141 = ( V_60 -> V_142 / V_3 -> V_37 . V_58 ) *
V_3 -> V_143 ;
V_135 -> V_140 . V_82 = V_69 -> V_81 . V_82 ;
F_4 ( L_44 , V_135 -> V_140 . V_141 ,
( unsigned long long ) V_135 -> V_140 . V_82 ) ;
F_79 (cmd->t_prot_sg, sg, cmd->t_prot_nents, i) {
V_137 = F_80 ( V_69 , F_58 ( V_96 ) , V_96 -> V_107 ,
V_96 -> V_99 ) ;
if ( V_137 != V_96 -> V_107 ) {
F_8 ( L_45 , V_137 ) ;
return - V_21 ;
...
F_4 ( L_46 ,
F_58 ( V_96 ) , V_96 -> V_107 , V_96 -> V_99 ) ;
}
return 0 ;
}
static T_5
F_81 ( struct V_59 * V_60 , struct V_95 * V_144 , T_1 V_145 ,
enum V_146 V_147 )
{
struct V_2 * V_3 = V_60 -> V_76 ;
T_4 V_104 = F_51 ( V_3 , V_60 -> V_102 ) ;
struct V_61 * V_62 ;
struct V_69 * V_69 , * V_148 ;
struct V_83 V_84 ;
struct V_95 * V_96 ;
T_1 V_73 = V_145 ;
unsigned V_149 ;
int V_136 , V_74 , V_75 = 0 ;
if ( V_147 == V_150 ) {
struct V_1 * V_11 = F_1 ( V_3 ) ;
struct V_13 * V_14 = F_14 ( V_11 -> V_36 ) ;
V_74 = V_90 ;
if ( F_82 ( V_151 , & V_14 -> V_152 ) ) {
if ( V_60 -> V_153 & V_154 )
V_75 = V_155 ;
else if ( ! F_82 ( V_156 , & V_14 -> V_152 ) )
V_75 = V_155 ;
}
} else {
V_74 = V_157 ;
...
V_69 = F_38 ( V_60 , V_104 , V_145 , V_74 , V_75 ) ;
if ( ! V_69 )
goto V_110;
V_148 = V_69 ;
F_62 ( & V_84 ) ;
...
V_69 = F_38 ( V_60 , V_104 , V_73 , V_74 ,
V_75 ) ;
if ( ! V_69 )
goto V_111;
F_35 ( & V_62 -> V_65 ) ;
...
if ( V_60 -> V_159 && V_3 -> V_37 . V_49 ) {
int V_137 = F_77 ( V_60 , V_148 ) ;
if ( V_137 )
goto V_111;
}
F_41 ( & V_84 ) ;
