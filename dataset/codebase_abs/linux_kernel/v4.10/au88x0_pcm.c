...
#endif
F_49 ( & V_46 -> V_48 ) ;
V_67 = F_53 ( V_13 -> V_16 , V_67 ) ;
if ( V_67 >= V_13 -> V_16 -> V_68 )
V_67 = 0 ;
return V_67 ;
}
static int F_54 ( struct V_3 * V_69 , struct V_70 * V_71 )
{
V_71 -> type = V_72 ;
V_71 -> V_73 = 1 ;
return 0 ;
...
static int F_56 ( struct V_3 * V_69 , struct V_74 * V_75 )
{
T_1 * V_14 = F_57 ( V_69 ) ;
...
static int F_58 ( struct V_3 * V_69 , struct V_74 * V_75 )
{
T_1 * V_14 = F_57 ( V_69 ) ;
int V_28 = 48000 ;
...
static int F_62 ( struct V_3 * V_69 ,
struct V_74 * V_75 )
{
int V_88 ;
int V_94 = 0 ;
...
static int F_64 ( T_1 * V_46 , int V_97 , int V_98 )
{
struct V_99 * V_21 ;
struct V_3 * V_4 ;
int V_88 ;
...
V_100 = 0 ;
V_17 = F_65 ( V_46 -> V_2 , V_103 [ V_97 ] , V_97 , V_98 ,
V_100 , & V_21 ) ;
if ( V_17 < 0 )
return V_17 ;
...
if ( F_8 ( V_21 ) == V_26 ) {
for ( V_88 = 0 ; V_88 < F_70 ( V_112 ) ; V_88 ++ ) {
V_4 = F_71 ( & V_112 [ V_88 ] , V_46 ) ;
if ( ! V_4 )
return - V_113 ;
