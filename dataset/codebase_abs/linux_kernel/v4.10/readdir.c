...
static void F_71 ( struct V_51 * V_51 , int V_90 )
{
int V_32 ;
struct V_80 * V_45 = V_51 -> V_36 -> V_49 ;
F_72 ( V_28 ) ;
struct V_1 * V_10 ;
struct V_13 V_14 = {
. V_42 . V_64 = F_20 ,
...
V_36 = F_24 ( V_10 -> V_7 , V_51 -> V_36 , V_10 -> V_8 ) ;
if ( F_25 ( V_36 ) )
continue;
if ( V_36 -> V_49 )
F_73 ( V_45 , V_51 -> V_93 , V_36 , V_90 ) ;
F_27 ( V_36 ) ;
}
F_28 ( V_45 ) ;
V_91:
...
void F_73 ( struct V_80 * V_45 , struct V_94 * V_93 ,
struct V_36 * V_36 , int V_90 )
{
int V_32 ;
if ( ! F_74 ( V_36 ) || V_90 > 1 ) {
F_68 ( V_45 , V_36 ) ;
...
V_32 = F_75 ( V_45 , V_36 ) ;
if ( V_32 ) {
struct V_51 V_51 = { . V_93 = V_93 , . V_36 = V_36 } ;
F_28 ( V_45 ) ;
F_71 ( & V_51 , V_90 + 1 ) ;
F_66 ( V_45 , V_92 ) ;
F_68 ( V_45 , V_36 ) ;
