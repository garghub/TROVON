...
snprintf ( V_2 -> V_168 , V_169 , L_33 , V_160 ) ;
snprintf ( V_2 -> V_170 , V_171 , L_33 , V_161 ) ;
V_2 -> V_172 = V_162 ;
V_2 -> V_7 = V_164 ;
F_42 ( & V_2 -> V_128 , & V_31 -> V_173 ) ;
F_12 ( L_37
L_38 , ( V_164 ) ? L_39 : L_29 ) ;
return 0 ;
}
static void F_45 (
struct V_13 * V_14 ,
...
snprintf ( V_160 , V_169 , L_33 , V_59 -> V_52 ) ;
snprintf ( V_161 , V_171 , L_33 ,
...
V_40 = V_2 -> V_112 -> V_42 ;
if ( V_2 -> V_5 )
snprintf ( V_237 , 32 , L_85 ,
V_2 -> V_6 ) ;
if ( V_14 -> V_110 == V_2 ) {
snprintf ( V_236 , 512 , L_86
L_87
L_88
L_89
L_90
...
V_238 += sprintf ( V_3 + V_238 , L_33 , V_236 ) ;
snprintf ( V_236 , 512 , L_99
L_100
...
snprintf ( V_248 , 512 , L_105 , V_250 , & V_242 -> V_249 [ 0 ] ) ;
...
F_12 ( L_126
L_127
L_128 , V_12 -> V_262 -> V_48 () ,
( V_181 == V_183 ) ? L_48 : L_29 ,
V_2 -> V_112 -> V_52 ,
V_2 -> V_111 , V_2 -> V_186 ) ;
} else {
type = V_2 -> V_8 ;
...
F_12 ( L_161
L_147 ,
V_150 -> V_48 () , ( V_274 == V_275 ) ? L_162 : L_29 ,
F_20 ( type ) ,
( V_2 -> V_138 ) ? 1 : 0 ) ;
F_12 ( L_163 ,
V_150 -> V_48 () , ( V_274 == V_275 ) ? L_162 : L_29 ,
...
default:
F_10 ( L_166
L_167 , ( V_274 == V_275 ) ? L_162 : L_29 , type ) ;
return V_261 ;
}
}
static T_2
...
V_3 = NULL ;
F_12 ( L_185
L_186 , V_282 -> V_48 () , ( V_222 != NULL ) ?
L_187 : L_188 , V_284 , ( V_222 != NULL ) ?
V_222 : L_29 ) ;
V_112 = V_2 -> V_112 ;
V_287 = ( ! strcmp ( V_284 ,
V_112 -> V_52 ) ) ? 1 : 0 ;
