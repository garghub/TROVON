...
int F_105 ( const struct V_203 * V_204 ,
struct V_205 * V_206 ,
...
if ( V_20 -> V_223 == F_106 ( V_224 ) ) {
F_107 ( V_20 ) ;
V_222 = 1 ;
}
V_16 = F_108 ( V_213 , V_211 ) ;
if ( V_16 )
goto V_28;
if ( V_20 -> V_144 == V_156 ) {
...
if ( V_210 && ! V_210 -> V_235 &&
V_20 -> V_144 == V_240 ) {
F_114 ( & V_218 , 2 , V_218 . V_241 [ 1 ] ,
V_218 . V_242 [ 1 ] ) ;
F_114 ( & V_218 , 1 , V_218 . V_241 [ 0 ] ,
V_218 . V_242 [ 0 ] ) ;
F_113 ( & V_218 , 0 ,
V_210 -> V_243 ) ;
}
V_216 = F_115 ( V_20 -> V_144 , & V_218 ) ;
V_216 -> V_99 = V_20 -> V_99 ;
V_216 -> V_244 = V_20 -> V_244 ;
if ( V_20 -> V_245 != 0 &&
( V_20 -> V_147 >> 32 ) == 0 ) {
T_2 V_246 = ( T_2 ) ( V_20 -> V_147 & 0xffffffff ) ;
V_216 -> V_147 =
F_116 ( F_117 ( V_20 -> V_245 , 0 ) , V_246 ) ;
F_95 ( L_79 ,
V_20 -> V_245 , V_246 ,
F_90 ( V_216 -> V_147 ) ) ;
} else {
...
F_119 ( NULL , V_206 , V_208 , V_182 ) ;
}
return V_16 ;
}
int F_120 ( const struct V_203 * V_204 , struct V_249 * V_250 ,
...
int V_16 ;
F_8 ( V_11 , L_82 , V_24 ) ;
V_16 = F_121 ( V_204 , V_250 , & V_254 , NULL , V_24 , V_256 ) ;
if ( V_16 )
return V_16 ;
V_16 = F_122 ( V_204 , V_254 , V_257 , NULL ) ;
if ( V_16 )
goto V_258;
if ( V_251 ) {
...
V_253 . V_262 = 0 ;
V_16 = F_123 ( V_204 , V_254 , V_255 , V_251 , & V_253 ) ;
F_8 ( V_88 , L_83 , V_24 ,
...
static int F_125 ( struct V_207 * V_208 , char * V_1 ,
int V_263 )
{
struct V_19 * V_20 = (struct V_19 * ) ( V_208 + 1 ) ;
char * V_4 = V_1 ;
char * V_140 = V_1 + V_263 ;
int V_16 = 0 ;
F_39 ( V_208 -> V_214 == V_215 ) ;
V_16 = F_108 ( V_20 , V_208 -> V_212 ) ;
if ( V_16 < 0 )
return V_16 ;
...
if ( V_20 -> V_147 ) {
char V_264 [ V_265 ] ;
F_126 ( V_20 -> V_147 , V_264 , sizeof( V_264 ) ) ;
...
int F_119 ( const struct V_203 * V_204 ,
struct V_205 * V_206 ,
struct V_207 * V_208 , void * V_182 )
{
char * V_266 ;
int V_16 = 0 ;
V_266 = F_72 ( 256 , V_111 ) ;
if ( ! V_266 )
return - V_68 ;
if ( V_208 -> V_214 == V_215 ) {
F_125 ( V_208 , V_266 , 256 ) ;
F_127 ( V_267 , L_91 , V_266 ) ;
} else {
F_127 ( V_267 , L_92 , V_208 -> V_214 ) ;
V_16 = - V_9 ;
}
F_75 ( V_266 ) ;
return V_16 ;
...
F_8 ( V_88 , L_97 ,
V_22 -> V_31 , V_268 ) ;
F_129 ( & V_218 , V_22 -> V_31 ) ;
F_113 ( & V_218 , 1 , V_268 ) ;
V_20 = F_115 ( V_171 , & V_218 ) ;
if ( ! V_20 )
return - V_68 ;
V_16 = F_89 ( V_20 ) ;
if ( V_16 ) {
...
static unsigned int
F_130 ( struct V_270 * V_271 , const void * V_2 , unsigned int V_272 )
{
return F_131 ( ( (struct V_47 * ) V_2 ) -> V_25 ,
sizeof( ( (struct V_47 * ) V_2 ) -> V_25 ) , V_272 ) ;
}
static void *
F_132 ( struct V_273 * V_274 )
{
struct V_53 * exp ;
exp = F_133 ( V_274 , struct V_53 , V_275 ) ;
return & exp -> V_276 ;
}
static int
F_134 ( const void * V_2 , struct V_273 * V_274 )
{
struct V_53 * exp ;
F_39 ( V_2 ) ;
exp = F_133 ( V_274 , struct V_53 , V_275 ) ;
return F_135 ( V_2 , & exp -> V_276 ) &&
! exp -> V_277 ;
}
static void *
F_136 ( struct V_273 * V_274 )
{
return F_133 ( V_274 , struct V_53 , V_275 ) ;
}
static void
...
static void
F_139 ( struct V_270 * V_271 , struct V_273 * V_274 )
{
struct V_53 * exp ;
exp = F_133 ( V_274 , struct V_53 , V_275 ) ;
F_43 ( exp ) ;
