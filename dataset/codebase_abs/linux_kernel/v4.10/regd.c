...
if ( ! V_115 )
return;
V_2 -> V_121 = V_115 -> V_122 ;
switch ( V_115 -> V_93 ) {
case V_123 :
if ( ! F_6 ( & V_119 -> V_124 ) )
break;
memcpy ( V_2 , & V_119 -> V_124 ,
sizeof( struct V_1 ) ) ;
break;
case V_125 :
break;
...
int V_102 ;
if ( V_126 & V_67 ) {
T_1 V_127 = V_126 & ~ V_67 ;
F_30 ( V_117
L_3
L_4 ) ;
for ( V_102 = 0 ; V_102 < F_26 ( V_111 ) ; V_102 ++ )
if ( V_111 [ V_102 ] . V_113 == V_127 )
return true ;
} else {
if ( V_126 != V_128 )
F_30 ( V_117 L_5
L_6 ) ;
for ( V_102 = 0 ; V_102 < F_26 ( V_129 ) ; V_102 ++ )
if ( V_129 [ V_102 ] . V_76 == V_126 )
return true ;
}
F_30 ( V_117
L_7 , V_126 ) ;
...
int V_102 ;
for ( V_102 = 0 ; V_102 < F_26 ( V_111 ) ; V_102 ++ ) {
if ( V_111 [ V_102 ] . V_132 == V_131 )
return & V_111 [ V_102 ] ;
}
return NULL ;
}
static T_1 F_37 ( T_1 V_126 )
{
if ( V_126 & V_67 ) {
struct V_130 * V_133 = NULL ;
T_1 V_127 = V_126 & ~ V_67 ;
V_133 = F_35 ( V_127 ) ;
if ( V_133 != NULL )
return V_127 ;
...
V_133 = F_36 ( V_131 ) ;
if ( V_133 ) {
V_2 -> V_110 [ 0 ] = V_133 -> V_112 [ 0 ] ;
V_2 -> V_110 [ 1 ] = V_133 -> V_112 [ 1 ] ;
} else {
V_2 -> V_110 [ 0 ] = '0' ;
V_2 -> V_110 [ 1 ] = '0' ;
}
