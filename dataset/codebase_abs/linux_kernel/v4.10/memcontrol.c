...
static int F_276 ( struct V_309 * V_310 , void * V_311 )
{
struct V_312 {
const char * V_313 ;
unsigned int V_58 ;
...
int V_17 ;
unsigned long V_60 ;
struct V_4 * V_5 = F_70 ( F_277 ( V_310 ) ) ;
for ( V_47 = V_314 ; V_47 < V_314 + F_278 ( V_314 ) ; V_47 ++ ) {
V_60 = F_60 ( V_5 , V_47 -> V_58 ) ;
F_279 ( V_310 , L_17 , V_47 -> V_313 , V_60 ) ;
F_61 (nid, N_MEMORY) {
V_60 = F_53 ( V_5 , V_17 ,
V_47 -> V_58 ) ;
F_279 ( V_310 , L_18 , V_17 , V_60 ) ;
}
F_280 ( V_310 , '\n' ) ;
}
for ( V_47 = V_314 ; V_47 < V_314 + F_278 ( V_314 ) ; V_47 ++ ) {
...
F_279 ( V_310 , L_19 , V_47 -> V_313 , V_60 ) ;
F_61 (nid, N_MEMORY) {
V_60 = 0 ;
F_85 (iter, memcg)
V_60 += F_53 (
...
static int F_281 ( struct V_309 * V_310 , void * V_311 )
{
struct V_4 * V_5 = F_70 ( F_277 ( V_310 ) ) ;
...
if ( V_100 == V_130 && ! F_1 () )
continue;
F_279 ( V_310 , L_20 , V_131 [ V_100 ] ,
F_43 ( V_5 , V_100 ) * V_230 ) ;
}
for ( V_100 = 0 ; V_100 < V_318 ; V_100 ++ )
F_279 ( V_310 , L_20 , V_317 [ V_100 ] ,
F_46 ( V_5 , V_100 ) ) ;
for ( V_100 = 0 ; V_100 < V_132 ; V_100 ++ )
F_279 ( V_310 , L_20 , V_133 [ V_100 ] ,
...
continue;
F_85 (mi, memcg)
V_45 += F_43 ( V_316 , V_100 ) * V_230 ;
F_279 ( V_310 , L_23 , V_131 [ V_100 ] , V_45 ) ;
}
for ( V_100 = 0 ; V_100 < V_318 ; V_100 ++ ) {
unsigned long long V_45 = 0 ;
F_85 (mi, memcg)
V_45 += F_46 ( V_316 , V_100 ) ;
F_279 ( V_310 , L_23 ,
V_317 [ V_100 ] , V_45 ) ;
}
for ( V_100 = 0 ; V_100 < V_132 ; V_100 ++ ) {
...
F_279 ( V_310 , L_23 , V_133 [ V_100 ] , V_45 ) ;
}
#ifdef F_283
{
T_4 * V_93 ;
...
F_279 ( V_310 , L_24 , V_322 [ 0 ] ) ;
F_279 ( V_310 , L_25 , V_322 [ 1 ] ) ;
F_279 ( V_310 , L_26 , V_323 [ 0 ] ) ;
F_279 ( V_310 , L_27 , V_323 [ 1 ] ) ;
}
#endif
return 0 ;
}
...
if ( ! V_328 )
goto V_120;
V_329 = F_251 ( V_5 , V_137 ) ;
V_100 = V_328 -> V_333 ;
for (; V_100 >= 0 && F_66 ( V_328 -> V_334 [ V_100 ] . V_335 > V_329 ) ; V_100 -- )
F_288 ( V_328 -> V_334 [ V_100 ] . V_336 , 1 ) ;
V_100 ++ ;
...
static int F_289 ( const void * V_337 , const void * V_338 )
{
...
V_103 = F_270 ( args , L_12 , & V_335 ) ;
if ( V_103 )
return V_103 ;
F_117 ( & V_5 -> V_347 ) ;
if ( type == V_286 ) {
V_330 = & V_5 -> V_330 ;
V_329 = F_251 ( V_5 , false ) ;
} else if ( type == V_287 ) {
V_330 = & V_5 -> V_332 ;
V_329 = F_251 ( V_5 , true ) ;
} else
F_254 () ;
if ( V_330 -> V_331 )
F_287 ( V_5 , type == V_287 ) ;
V_110 = V_330 -> V_331 ? V_330 -> V_331 -> V_110 + 1 : 1 ;
V_346 = F_212 ( sizeof( * V_346 ) + V_110 * sizeof( struct F_67 ) ,
V_208 ) ;
if ( ! V_346 ) {
V_103 = - V_231 ;
goto V_120;
...
F_293 ( V_346 -> V_334 , V_110 , sizeof( struct F_67 ) ,
F_289 , NULL ) ;
V_346 -> V_333 = - 1 ;
...
{
return F_292 ( V_5 , V_336 , args , V_286 ) ;
}
static int F_297 ( struct V_4 * V_5 ,
struct V_343 * V_336 , const char * args )
{
return F_292 ( V_5 , V_336 , args , V_287 ) ;
}
...
struct V_343 * V_336 )
{
return F_298 ( V_5 , V_336 , V_286 ) ;
}
static void F_300 ( struct V_4 * V_5 ,
struct V_343 * V_336 )
{
return F_298 ( V_5 , V_336 , V_287 ) ;
}
static int F_301 ( struct V_4 * V_5 ,
struct V_343 * V_336 , const char * args )
{
struct V_341 * V_351 ;
V_351 = F_212 ( sizeof( * V_351 ) , V_208 ) ;
if ( ! V_351 )
return - V_231 ;
F_100 ( & V_163 ) ;
V_351 -> V_336 = V_336 ;
F_302 ( & V_351 -> V_352 , & V_5 -> V_353 ) ;
if ( V_5 -> V_166 )
F_288 ( V_336 , 1 ) ;
F_101 ( & V_163 ) ;
return 0 ;
...
static int F_306 ( struct V_309 * V_355 , void * V_311 )
{
struct V_4 * V_5 = F_70 ( F_277 ( V_355 ) ) ;
F_279 ( V_355 , L_28 , V_5 -> V_187 ) ;
F_279 ( V_355 , L_29 , ( bool ) V_5 -> V_166 ) ;
return 0 ;
}
...
struct V_356 * F_308 ( struct V_4 * V_5 )
{
return & V_5 -> V_357 ;
}
static int F_309 ( struct V_4 * V_5 , T_3 V_254 )
{
return F_310 ( & V_5 -> V_358 , V_254 ) ;
}
...
struct V_359 * F_315 ( struct V_360 * V_361 )
{
...
void F_316 ( struct V_360 * V_361 , unsigned long * V_363 ,
unsigned long * V_364 , unsigned long * V_365 ,
unsigned long * V_366 )
{
struct V_4 * V_5 = F_70 ( V_361 -> V_362 ) ;
struct V_4 * V_28 ;
* V_365 = F_43 ( V_5 , V_367 ) ;
...
{
struct V_373 * V_351 =
F_5 ( V_204 , struct V_373 , remove ) ;
struct V_4 * V_5 = V_351 -> V_5 ;
F_318 ( V_351 -> V_374 , & V_351 -> V_123 ) ;
V_351 -> V_375 ( V_5 , V_351 -> V_336 ) ;
F_288 ( V_351 -> V_336 , 1 ) ;
F_319 ( V_351 -> V_336 ) ;
F_210 ( V_351 ) ;
F_79 ( & V_5 -> V_9 ) ;
...
int V_168 , void * V_376 )
{
struct V_373 * V_351 =
F_5 ( V_123 , struct V_373 , V_123 ) ;
struct V_4 * V_5 = V_351 -> V_5 ;
unsigned long V_13 = ( unsigned long ) V_376 ;
if ( V_13 & V_377 ) {
F_100 ( & V_5 -> V_378 ) ;
if ( ! F_321 ( & V_351 -> V_352 ) ) {
F_322 ( & V_351 -> V_352 ) ;
F_186 ( & V_351 -> remove ) ;
}
F_101 ( & V_5 -> V_378 ) ;
...
static void F_323 ( struct V_379 * V_379 ,
T_10 * V_374 , T_11 * V_380 )
{
struct V_373 * V_351 =
F_5 ( V_380 , struct V_373 , V_380 ) ;
V_351 -> V_374 = V_374 ;
F_324 ( V_374 , & V_351 -> V_123 ) ;
}
...
int V_103 ;
V_276 = F_269 ( V_276 ) ;
V_382 = F_326 ( V_276 , & V_387 , 10 ) ;
if ( * V_387 != ' ' )
return - V_261 ;
V_276 = V_387 + 1 ;
V_383 = F_326 ( V_276 , & V_387 , 10 ) ;
if ( ( * V_387 != ' ' ) && ( * V_387 != '\0' ) )
return - V_261 ;
V_276 = V_387 + 1 ;
V_351 = F_327 ( sizeof( * V_351 ) , V_208 ) ;
if ( ! V_351 )
return - V_231 ;
V_351 -> V_5 = V_5 ;
F_144 ( & V_351 -> V_352 ) ;
F_328 ( & V_351 -> V_380 , F_323 ) ;
F_329 ( & V_351 -> V_123 , F_320 ) ;
F_213 ( & V_351 -> remove , F_317 ) ;
V_385 = F_330 ( V_382 ) ;
if ( ! V_385 . V_379 ) {
V_103 = - V_388 ;
goto V_389;
}
V_351 -> V_336 = F_331 ( V_385 . V_379 ) ;
if ( F_332 ( V_351 -> V_336 ) ) {
V_103 = F_333 ( V_351 -> V_336 ) ;
goto V_390;
}
V_386 = F_330 ( V_383 ) ;
if ( ! V_386 . V_379 ) {
...
V_103 = F_334 ( F_335 ( V_386 . V_379 ) , V_392 ) ;
if ( V_103 < 0 )
goto V_393;
V_313 = V_386 . V_379 -> V_394 . V_395 -> V_396 . V_313 ;
if ( ! strcmp ( V_313 , L_30 ) ) {
V_351 -> V_397 = F_296 ;
V_351 -> V_375 = F_299 ;
} else if ( ! strcmp ( V_313 , L_31 ) ) {
V_351 -> V_397 = F_301 ;
V_351 -> V_375 = F_303 ;
...
V_381 = F_336 ( V_386 . V_379 -> V_394 . V_395 -> V_400 ,
& V_1 ) ;
V_103 = - V_261 ;
if ( F_332 ( V_381 ) )
goto V_393;
...
V_103 = V_351 -> V_397 ( V_5 , V_351 -> V_336 , V_276 ) ;
if ( V_103 )
goto V_401;
V_385 . V_379 -> V_402 -> V_403 ( V_385 . V_379 , & V_351 -> V_380 ) ;
F_100 ( & V_5 -> V_378 ) ;
F_302 ( & V_351 -> V_352 , & V_5 -> V_404 ) ;
F_101 ( & V_5 -> V_378 ) ;
F_337 ( V_386 ) ;
F_337 ( V_385 ) ;
return V_277 ;
...
static void F_338 ( struct V_4 * V_5 , unsigned int V_405 )
{
F_56 ( F_122 ( & V_5 -> V_236 . V_406 ) <= 0 ) ;
F_339 ( V_405 , & V_5 -> V_236 . V_406 ) ;
}
static void F_340 ( struct V_4 * V_5 , unsigned int V_405 )
{
F_56 ( F_122 ( & V_5 -> V_236 . V_406 ) < V_405 ) ;
if ( F_341 ( V_405 , & V_5 -> V_236 . V_406 ) ) {
F_342 ( & V_407 , V_5 -> V_236 . V_236 ) ;
V_5 -> V_236 . V_236 = 0 ;
F_79 ( & V_5 -> V_9 ) ;
}
}
...
{
F_346 ( ! F_347 () ) ;
return F_348 ( & V_407 , V_236 ) ;
}
static int F_349 ( struct V_4 * V_5 , int V_153 )
{
struct V_16 * V_408 ;
int V_354 = V_153 ;
if ( ! F_350 ( V_153 , V_409 ) )
V_354 = - 1 ;
V_408 = F_351 ( sizeof( * V_408 ) , V_208 , V_354 ) ;
if ( ! V_408 )
return 1 ;
F_352 ( & V_408 -> V_59 ) ;
V_408 -> V_31 = 0 ;
...
if ( ! V_5 )
return NULL ;
V_5 -> V_236 . V_236 = F_357 ( & V_407 , NULL ,
1 , V_410 ,
V_208 ) ;
if ( V_5 -> V_236 . V_236 < 0 )
goto V_411;
V_5 -> V_47 = F_358 ( struct V_412 ) ;
if ( ! V_5 -> V_47 )
goto V_411;
F_35 (node)
if ( F_349 ( V_5 , V_153 ) )
...
F_144 ( & V_5 -> V_357 ) ;
#endif
F_364 ( & V_407 , V_5 , V_5 -> V_236 . V_236 ) ;
return V_5 ;
V_411:
if ( V_5 -> V_236 . V_236 > 0 )
F_342 ( & V_407 , V_5 -> V_236 . V_236 ) ;
...
V_5 -> V_38 = V_319 ;
if ( V_28 ) {
V_5 -> V_325 = F_115 ( V_28 ) ;
V_5 -> V_187 = V_28 -> V_187 ;
}
if ( V_28 && V_28 -> V_91 ) {
V_5 -> V_91 = true ;
F_367 ( & V_5 -> V_37 , & V_28 -> V_37 ) ;
F_367 ( & V_5 -> V_137 , & V_28 -> V_137 ) ;
F_367 ( & V_5 -> V_116 , & V_28 -> V_116 ) ;
F_367 ( & V_5 -> V_128 , & V_28 -> V_128 ) ;
F_367 ( & V_5 -> V_290 , & V_28 -> V_290 ) ;
} else {
F_367 ( & V_5 -> V_37 , NULL ) ;
F_367 ( & V_5 -> V_137 , NULL ) ;
F_367 ( & V_5 -> V_116 , NULL ) ;
F_367 ( & V_5 -> V_128 , NULL ) ;
F_367 ( & V_5 -> V_290 , NULL ) ;
if ( V_28 != V_6 )
V_1 . V_416 = true ;
}
if ( ! V_28 ) {
...
static int F_368 ( struct V_7 * V_9 )
{
struct V_4 * V_5 = F_70 ( V_9 ) ;
F_126 ( & V_5 -> V_236 . V_406 , 1 ) ;
F_95 ( V_9 ) ;
return 0 ;
}
static void F_369 ( struct V_7 * V_9 )
{
struct V_4 * V_5 = F_70 ( V_9 ) ;
struct V_373 * V_351 , * V_354 ;
F_100 ( & V_5 -> V_378 ) ;
...
{
struct V_4 * V_5 = F_70 ( V_9 ) ;
F_236 ( & V_5 -> V_37 , V_319 ) ;
F_236 ( & V_5 -> V_137 , V_319 ) ;
F_236 ( & V_5 -> V_116 , V_319 ) ;
F_236 ( & V_5 -> V_128 , V_319 ) ;
F_236 ( & V_5 -> V_290 , V_319 ) ;
V_5 -> V_418 = 0 ;
V_5 -> V_205 = V_319 ;
V_5 -> V_38 = V_319 ;
F_313 ( V_5 ) ;
}
static int F_376 ( unsigned long V_48 )
{
int V_103 ;
V_103 = F_174 ( V_119 . V_118 , V_208 & ~ V_419 , V_48 ) ;
if ( ! V_103 ) {
V_119 . V_420 += V_48 ;
return V_103 ;
}
...
static struct V_11 * F_378 ( struct V_421 * V_422 ,
unsigned long V_423 , T_13 V_424 )
{
struct V_11 * V_11 = F_379 ( V_422 , V_423 , V_424 ) ;
if ( ! V_11 || ! F_380 ( V_11 ) )
return NULL ;
if ( F_48 ( V_11 ) ) {
if ( ! ( V_119 . V_13 & V_425 ) )
...
static struct V_11 * F_382 ( struct V_421 * V_422 ,
T_13 V_424 , T_6 * V_258 )
{
struct V_11 * V_11 = NULL ;
T_6 V_427 = F_383 ( V_424 ) ;
if ( ! ( V_119 . V_13 & V_425 ) || F_384 ( V_427 ) )
return NULL ;
V_11 = F_385 ( F_386 ( V_427 ) , F_387 ( V_427 ) ) ;
if ( F_1 () )
V_258 -> V_45 = V_427 . V_45 ;
return V_11 ;
}
static struct V_11 * F_382 ( struct V_421 * V_422 ,
T_13 V_424 , T_6 * V_258 )
...
static struct V_11 * F_388 ( struct V_421 * V_422 ,
unsigned long V_423 , T_13 V_424 , T_6 * V_258 )
{
struct V_11 * V_11 = NULL ;
struct V_428 * V_429 ;
T_14 V_430 ;
...
V_430 = F_389 ( V_422 , V_423 ) ;
#ifdef F_390
if ( F_391 ( V_429 ) ) {
V_11 = F_392 ( V_429 , V_430 ) ;
if ( F_393 ( V_11 ) ) {
T_6 V_433 = F_394 ( V_11 ) ;
if ( F_1 () )
* V_258 = V_433 ;
V_11 = F_385 ( F_386 ( V_433 ) ,
F_387 ( V_433 ) ) ;
}
} else
V_11 = F_385 ( V_429 , V_430 ) ;
#else
V_11 = F_385 ( V_429 , V_430 ) ;
#endif
return V_11 ;
}
static int F_395 ( struct V_11 * V_11 ,
bool V_51 ,
struct V_4 * V_117 ,
struct V_4 * V_118 )
{
unsigned long V_13 ;
unsigned int V_36 = V_51 ? F_396 ( V_11 ) : 1 ;
int V_103 ;
bool V_434 ;
F_56 ( V_117 == V_118 ) ;
F_50 ( F_192 ( V_11 ) , V_11 ) ;
...
if ( ! V_434 && F_380 ( V_11 ) ) {
F_228 ( V_117 -> V_47 -> V_48 [ V_435 ] ,
V_36 ) ;
F_49 ( V_118 -> V_47 -> V_48 [ V_435 ] ,
V_36 ) ;
}
if ( ! V_434 && F_398 ( V_11 ) ) {
struct V_428 * V_429 = F_399 ( V_11 ) ;
if ( F_400 ( V_429 ) ) {
F_228 ( V_117 -> V_47 -> V_48 [ V_367 ] ,
V_36 ) ;
F_49 ( V_118 -> V_47 -> V_48 [ V_367 ] ,
V_36 ) ;
}
}
if ( F_401 ( V_11 ) ) {
...
static enum V_436 F_405 ( struct V_421 * V_422 ,
...
T_6 V_427 = { . V_45 = 0 } ;
if ( F_406 ( V_424 ) )
V_11 = F_378 ( V_422 , V_423 , V_424 ) ;
else if ( F_407 ( V_424 ) )
V_11 = F_382 ( V_422 , V_424 , & V_427 ) ;
else if ( F_408 ( V_424 ) )
V_11 = F_388 ( V_422 , V_423 , V_424 , & V_427 ) ;
if ( ! V_11 && ! V_427 . V_45 )
return V_103 ;
if ( V_11 ) {
...
static enum V_436 F_411 ( struct V_421 * V_422 ,
unsigned long V_423 , T_15 V_441 , union V_437 * V_65 )
{
struct V_11 * V_11 = NULL ;
enum V_436 V_103 = V_438 ;
V_11 = F_412 ( V_441 ) ;
F_50 ( ! V_11 || ! F_413 ( V_11 ) , V_11 ) ;
if ( ! ( V_119 . V_13 & V_425 ) )
return V_103 ;
if ( V_11 -> V_4 == V_119 . V_117 ) {
V_103 = V_439 ;
...
static inline enum V_436 F_411 ( struct V_421 * V_422 ,
unsigned long V_423 , T_15 V_441 , union V_437 * V_65 )
{
return V_438 ;
}
static int F_415 ( T_15 * V_441 ,
...
T_13 * V_445 ;
T_16 * V_446 ;
V_446 = F_416 ( V_441 , V_422 ) ;
if ( V_446 ) {
if ( F_411 ( V_422 , V_423 , * V_441 , NULL ) == V_439 )
V_119 . V_420 += V_256 ;
F_101 ( V_446 ) ;
return 0 ;
}
if ( F_417 ( V_441 ) )
return 0 ;
V_445 = F_418 ( V_422 -> V_447 , V_441 , V_423 , & V_446 ) ;
for (; V_423 != V_442 ; V_445 ++ , V_423 += V_230 )
if ( F_405 ( V_422 , V_423 , * V_445 , NULL ) )
V_119 . V_420 ++ ;
F_419 ( V_445 - 1 , V_446 ) ;
F_377 () ;
return 0 ;
}
static unsigned long F_420 ( struct V_80 * V_81 )
{
unsigned long V_420 ;
struct V_443 V_448 = {
. V_449 = F_415 ,
...
static int F_422 ( struct V_80 * V_81 )
{
unsigned long V_420 = F_420 ( V_81 ) ;
F_56 ( V_119 . V_121 ) ;
V_119 . V_121 = V_122 ;
return F_376 ( V_420 ) ;
}
...
if ( V_119 . V_420 ) {
F_188 ( V_119 . V_118 , V_119 . V_420 ) ;
V_119 . V_420 = 0 ;
}
if ( V_119 . V_452 ) {
F_188 ( V_119 . V_117 , V_119 . V_452 ) ;
V_119 . V_452 = 0 ;
}
if ( V_119 . V_453 ) {
if ( ! F_6 ( V_119 . V_117 ) )
F_153 ( & V_119 . V_117 -> V_116 , V_119 . V_453 ) ;
F_340 ( V_119 . V_117 , V_119 . V_453 ) ;
if ( ! F_6 ( V_119 . V_118 ) )
F_153 ( & V_119 . V_118 -> V_37 , V_119 . V_453 ) ;
F_338 ( V_119 . V_118 , V_119 . V_453 ) ;
F_154 ( & V_119 . V_118 -> V_9 , V_119 . V_453 ) ;
V_119 . V_453 = 0 ;
}
F_140 ( V_117 ) ;
F_140 ( V_118 ) ;
...
static int F_427 ( struct V_454 * V_455 )
{
struct V_7 * V_9 ;
struct V_4 * V_5 = NULL ;
struct V_4 * V_117 ;
...
static void F_430 ( struct V_454 * V_455 )
{
if ( V_119 . V_118 )
F_425 () ;
}
static int F_431 ( T_15 * V_441 ,
unsigned long V_423 , unsigned long V_442 ,
struct V_443 * V_444 )
{
int V_103 = 0 ;
...
V_458 = F_411 ( V_422 , V_423 , * V_441 , & V_65 ) ;
if ( V_458 == V_439 ) {
V_11 = V_65 . V_11 ;
if ( ! F_432 ( V_11 ) ) {
if ( ! F_395 ( V_11 , true ,
...
if ( ! V_119 . V_420 )
break;
switch ( F_405 ( V_422 , V_423 , V_424 , & V_65 ) ) {
case V_439 :
V_11 = V_65 . V_11 ;
if ( F_434 ( V_11 ) )
goto V_459;
...
case V_440 :
V_427 = V_65 . V_427 ;
if ( ! F_231 ( V_427 , V_119 . V_117 , V_119 . V_118 ) ) {
V_119 . V_420 -- ;
V_119 . V_453 ++ ;
}
break;
...
F_295 () ;
V_41:
if ( F_66 ( ! F_436 ( & V_119 . V_81 -> V_450 ) ) ) {
F_423 () ;
F_377 () ;
goto V_41;
}
F_421 ( 0 , V_119 . V_81 -> V_451 , & V_460 ) ;
F_10 ( & V_119 . V_81 -> V_450 ) ;
F_437 ( & V_119 . V_117 -> V_189 ) ;
}
...
static void F_439 ( struct V_7 * V_461 )
{
if ( F_2 ( V_1 ) )
V_6 -> V_91 = true ;
else
...
static V_126 F_440 ( struct V_7 * V_9 ,
struct V_279 * V_280 )
{
struct V_4 * V_5 = F_70 ( V_9 ) ;
return ( V_126 ) F_32 ( & V_5 -> V_37 ) * V_230 ;
}
static int F_441 ( struct V_309 * V_310 , void * V_311 )
{
struct V_4 * V_5 = F_70 ( F_277 ( V_310 ) ) ;
...
F_279 ( V_310 , L_35 , ( V_126 ) V_418 * V_230 ) ;
return 0 ;
}
static T_7 F_443 ( struct V_274 * V_275 ,
char * V_276 , T_8 V_277 , T_9 V_278 )
{
struct V_4 * V_5 = F_70 ( F_246 ( V_275 ) ) ;
unsigned long V_418 ;
...
F_279 ( V_310 , L_35 , ( V_126 ) V_205 * V_230 ) ;
return 0 ;
}
static T_7 F_445 ( struct V_274 * V_275 ,
char * V_276 , T_8 V_277 , T_9 V_278 )
{
struct V_4 * V_5 = F_70 ( F_246 ( V_275 ) ) ;
unsigned long V_36 ;
...
static int F_446 ( struct V_309 * V_310 , void * V_311 )
{
struct V_4 * V_5 = F_70 ( F_277 ( V_310 ) ) ;
...
F_279 ( V_310 , L_35 , ( V_126 ) F_175 * V_230 ) ;
return 0 ;
}
static T_7 F_447 ( struct V_274 * V_275 ,
char * V_276 , T_8 V_277 , T_9 V_278 )
{
struct V_4 * V_5 = F_70 ( F_246 ( V_275 ) ) ;
...
{
struct V_4 * V_5 = F_70 ( F_277 ( V_310 ) ) ;
F_279 ( V_310 , L_37 , F_46 ( V_5 , V_463 ) ) ;
F_279 ( V_310 , L_38 , F_46 ( V_5 , V_206 ) ) ;
F_279 ( V_310 , L_39 , F_46 ( V_5 , V_225 ) ) ;
F_279 ( V_310 , L_40 , F_46 ( V_5 , V_229 ) ) ;
return 0 ;
}
static int F_450 ( struct V_309 * V_310 , void * V_311 )
{
struct V_4 * V_5 = F_70 ( F_277 ( V_310 ) ) ;
...
bool F_451 ( struct V_4 * V_83 , struct V_4 * V_5 )
{
if ( F_75 () )
return false ;
if ( V_5 == V_6 )
...
int F_452 ( struct V_11 * V_11 , struct V_80 * V_81 ,
T_3 V_139 , struct V_4 * * V_470 ,
bool V_51 )
{
struct V_4 * V_5 = NULL ;
unsigned int V_36 = V_51 ? F_396 ( V_11 ) : 1 ;
...
goto V_92;
if ( F_453 ( V_11 ) ) {
F_50 ( ! F_454 ( V_11 ) , V_11 ) ;
if ( V_11 -> V_4 )
goto V_92;
if ( V_2 ) {
T_6 V_427 = { . V_45 = F_455 ( V_11 ) , } ;
unsigned short V_236 = F_410 ( V_427 ) ;
F_13 () ;
V_5 = F_345 ( V_236 ) ;
if ( V_5 && ! F_39 ( & V_5 -> V_9 ) )
V_5 = NULL ;
...
void F_456 ( struct V_11 * V_11 , struct V_4 * V_5 ,
...
static void F_459 ( struct V_4 * V_5 , unsigned long V_471 ,
unsigned long V_472 , unsigned long V_473 ,
unsigned long V_474 , unsigned long V_475 ,
struct V_11 * V_476 )
{
unsigned long V_36 = V_472 + V_473 + V_475 ;
unsigned long V_13 ;
if ( ! F_6 ( V_5 ) ) {
F_153 ( & V_5 -> V_37 , V_36 ) ;
if ( F_1 () )
F_153 ( & V_5 -> V_116 , V_36 ) ;
if ( ! F_2 ( V_1 ) && V_475 )
F_153 ( & V_5 -> V_128 , V_475 ) ;
F_140 ( V_5 ) ;
}
F_149 ( V_13 ) ;
F_228 ( V_5 -> V_47 -> V_48 [ V_52 ] , V_472 ) ;
F_228 ( V_5 -> V_47 -> V_48 [ V_53 ] , V_473 ) ;
F_228 ( V_5 -> V_47 -> V_48 [ V_54 ] , V_474 ) ;
F_49 ( V_5 -> V_47 -> V_50 [ V_56 ] , V_471 ) ;
F_49 ( V_5 -> V_47 -> V_57 , V_36 ) ;
F_65 ( V_5 , V_476 ) ;
F_151 ( V_13 ) ;
if ( ! F_6 ( V_5 ) )
...
static void F_460 ( struct V_356 * V_477 )
{
struct V_4 * V_5 = NULL ;
...
V_66 = V_477 -> V_66 ;
do {
V_11 = F_461 ( V_66 , struct V_11 , V_62 ) ;
V_66 = V_11 -> V_62 . V_66 ;
F_50 ( F_192 ( V_11 ) , V_11 ) ;
F_50 ( F_462 ( V_11 ) , V_11 ) ;
if ( ! V_11 -> V_4 )
continue;
if ( V_5 != V_11 -> V_4 ) {
if ( V_5 ) {
F_459 ( V_5 , V_471 , V_472 , V_473 ,
V_474 , V_475 , V_11 ) ;
V_471 = V_472 = V_473 =
V_474 = V_475 = 0 ;
}
...
void F_466 ( struct V_11 * V_478 , struct V_11 * V_479 )
{
struct V_4 * V_5 ;
unsigned int V_36 ;
bool V_51 ;
unsigned long V_13 ;
F_50 ( ! F_454 ( V_478 ) , V_478 ) ;
F_50 ( ! F_454 ( V_479 ) , V_479 ) ;
F_50 ( F_48 ( V_478 ) != F_48 ( V_479 ) , V_479 ) ;
F_50 ( F_51 ( V_478 ) != F_51 ( V_479 ) ,
V_479 ) ;
if ( F_75 () )
return;
if ( V_479 -> V_4 )
...
return;
V_51 = F_51 ( V_479 ) ;
V_36 = V_51 ? F_396 ( V_479 ) : 1 ;
F_183 ( & V_5 -> V_37 , V_36 ) ;
if ( F_1 () )
F_183 ( & V_5 -> V_116 , V_36 ) ;
F_184 ( & V_5 -> V_9 , V_36 ) ;
F_199 ( V_479 , V_5 , false ) ;
F_149 ( V_13 ) ;
F_47 ( V_5 , V_479 , V_51 , V_36 ) ;
F_65 ( V_5 , V_479 ) ;
F_151 ( V_13 ) ;
}
void F_467 ( struct V_480 * V_481 )
{
struct V_4 * V_5 ;
if ( ! V_482 )
return;
if ( V_481 -> V_483 ) {
F_84 ( F_6 ( V_481 -> V_483 ) ) ;
F_95 ( & V_481 -> V_483 -> V_9 ) ;
return;
}
F_13 () ;
V_5 = F_69 ( V_122 ) ;
...
void F_468 ( struct V_480 * V_481 )
{
if ( V_481 -> V_483 )
F_79 ( & V_481 -> V_483 -> V_9 ) ;
}
bool F_469 ( struct V_4 * V_5 , unsigned int V_36 )
{
T_3 V_139 = V_208 ;
if ( ! F_2 ( V_1 ) ) {
struct V_214 * V_411 ;
if ( F_176 ( & V_5 -> V_290 , V_36 , & V_411 ) ) {
V_5 -> V_484 = 0 ;
return true ;
}
...
if ( F_470 () )
V_139 = V_247 ;
F_230 ( V_5 -> V_47 -> V_48 [ V_467 ] , V_36 ) ;
if ( F_174 ( V_5 , V_139 , V_36 ) == 0 )
return true ;
F_174 ( V_5 , V_139 | V_228 , V_36 ) ;
return false ;
}
void F_471 ( struct V_4 * V_5 , unsigned int V_36 )
{
if ( ! F_2 ( V_1 ) ) {
F_153 ( & V_5 -> V_290 , V_36 ) ;
return;
}
F_472 ( V_5 -> V_47 -> V_48 [ V_467 ] , V_36 ) ;
F_153 ( & V_5 -> V_37 , V_36 ) ;
F_154 ( & V_5 -> V_9 , V_36 ) ;
}
static int T_17 F_473 ( char * V_485 )
{
char * V_486 ;
while ( ( V_486 = F_474 ( & V_485 , L_54 ) ) != NULL ) {
if ( ! * V_486 )
continue;
if ( ! strcmp ( V_486 , L_55 ) )
V_417 = true ;
if ( ! strcmp ( V_486 , L_56 ) )
V_298 = true ;
}
return 0 ;
}
static int T_17 F_475 ( void )
{
int V_46 , V_153 ;
#ifndef F_362
V_248 =
...
F_84 ( ! V_248 ) ;
#endif
F_477 ( V_487 , L_58 , NULL ,
F_167 ) ;
F_44 (cpu)
F_213 ( & F_478 ( & V_196 , V_46 ) -> V_204 ,
F_155 ) ;
F_35 (node) {
struct V_19 * V_488 ;
V_488 = F_351 ( sizeof( * V_488 ) , V_208 ,
F_479 ( V_153 ) ? V_153 : V_489 ) ;
V_488 -> V_27 = V_490 ;
F_360 ( & V_488 -> V_35 ) ;
V_20 . V_21 [ V_153 ] = V_488 ;
}
return 0 ;
}
static struct V_4 * F_480 ( struct V_4 * V_5 )
{
while ( ! F_481 ( & V_5 -> V_236 . V_406 ) ) {
if ( F_346 ( V_5 == V_6 ) ) {
F_56 ( 1 ) ;
break;
}
...
void F_482 ( struct V_11 * V_11 , T_6 V_258 )
{
...
int F_485 ( struct V_11 * V_11 , T_6 V_258 )
{
struct V_4 * V_5 ;
struct V_214 * V_215 ;
unsigned short V_492 ;
...
V_492 = F_483 ( V_258 , F_232 ( V_5 ) ) ;
F_50 ( V_492 , V_11 ) ;
F_229 ( V_5 , true ) ;
return 0 ;
}
void F_457 ( T_6 V_258 )
{
struct V_4 * V_5 ;
...
long F_486 ( struct V_4 * V_5 )
{
long V_493 = F_487 () ;
if ( ! V_2 || ! F_2 ( V_1 ) )
return V_493 ;
for (; V_5 != V_6 ; V_5 = F_15 ( V_5 ) )
V_493 = F_488 ( long , V_493 ,
F_14 ( V_5 -> V_137 . V_115 ) -
F_32 ( & V_5 -> V_137 ) ) ;
return V_493 ;
}
bool F_489 ( struct V_11 * V_11 )
{
struct V_4 * V_5 ;
F_50 ( ! F_454 ( V_11 ) , V_11 ) ;
if ( F_490 () )
...
static int T_17 F_491 ( char * V_485 )
{
if ( ! strcmp ( V_485 , L_59 ) )
V_494 = 1 ;
else if ( ! strcmp ( V_485 , L_60 ) )
V_494 = 0 ;
return 1 ;
}
static V_126 F_492 ( struct V_7 * V_9 ,
struct V_279 * V_280 )
{
struct V_4 * V_5 = F_70 ( V_9 ) ;
return ( V_126 ) F_32 ( & V_5 -> V_137 ) * V_230 ;
}
static int F_493 ( struct V_309 * V_310 , void * V_311 )
{
struct V_4 * V_5 = F_70 ( F_277 ( V_310 ) ) ;
...
static T_7 F_494 ( struct V_274 * V_275 ,
char * V_276 , T_8 V_277 , T_9 V_278 )
{
struct V_4 * V_5 = F_70 ( F_246 ( V_275 ) ) ;
unsigned long F_175 ;
