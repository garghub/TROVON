...
static int F_81 ( struct V_235 * V_37 , struct V_270 * V_271 , int V_199 )
{
struct V_272 V_273 ;
struct V_274 V_275 ;
struct V_276 V_277 ;
...
{
int V_285 = 1 ;
if ( ! F_82 ( V_286 ) ) return - V_287 ;
if ( ! V_200 ) return - V_288 ;
if ( V_94 >= V_289 )
return - V_218 ;
if ( F_83 ( & V_277 , V_200 , sizeof( V_277 ) ) )
return - V_288 ;
...
if ( V_285 )
{
F_85 ( V_95 [ 2 * V_94 + V_280 ] . V_9 , 1 , L_20 ) ;
F_85 ( V_95 [ 2 * V_94 + V_280 ] . V_25 , 1 , L_21 ) ;
if ( V_94 + V_280 != 0 &&
F_62 ( V_281 ,
& V_95 [ 2 * V_94 + V_280 ] ) )
return - V_218 ;
...
if ( V_199 == V_299 )
{
if ( ! F_82 ( V_300 ) ) return - V_287 ;
if ( ! V_200 ) return - V_218 ;
V_8 -> V_22 . V_69 = V_301 ;
if ( F_83 ( & V_8 -> V_28 , V_200 , sizeof( struct V_302 ) ) )
return - V_218 ;
...
case V_305 :
if ( ! F_82 ( V_286 ) ) return - V_287 ;
if ( ! V_200 || F_83 ( & V_275 , V_200 , sizeof( V_275 ) ) )
return - V_218 ;
V_8 -> V_22 . V_69 = V_275 . V_69 ;
return 0 ;
case V_306 :
if ( ! V_200 || F_88 ( V_200 , & V_8 -> V_22 , sizeof( V_8 -> V_22 ) ) )
return - V_218 ;
return 0 ;
case V_307 :
if ( ! V_200 || F_83 ( & V_273 , V_200 , sizeof( V_273 ) ) )
return - V_218 ;
V_273 . V_308 = F_57 ( V_8 , V_273 . V_309 ) ;
if ( F_88 ( V_200 , & V_273 , sizeof( V_273 ) ) )
return - V_218 ;
return 0 ;
case V_310 :
if ( ! F_82 ( V_300 ) ) return - V_287 ;
...
case V_311 :
if ( ! F_82 ( V_286 ) ) return - V_287 ;
if ( ! V_200 || F_83 ( & V_279 , V_200 , sizeof( V_279 ) ) || V_279 . time == 0 )
return - V_218 ;
...
static int F_89 ( struct V_235 * V_37 , void * V_312 )
{
struct V_313 * V_314 = (struct V_313 * ) V_312 ;
memcpy ( V_37 -> V_249 , V_314 -> V_315 , V_37 -> V_257 ) ;
return 0 ;
}
static struct V_316 * F_90 ( struct V_235 * V_37 )
{
struct V_7 * V_8 = (struct V_7 * ) V_37 -> V_239 ;
...
static inline struct V_7 * F_91 ( T_5 V_321 )
{
int V_24 ;
for ( V_24 = 0 ; V_24 < V_94 * 2 ; ++ V_24 ) {
if ( ! V_95 [ V_24 ] . V_258 )
...
static void * F_92 ( struct V_322 * V_323 , T_5 * V_321 )
{
return * V_321 ? F_91 ( * V_321 - 1 ) : V_324 ;
}
static void * F_93 ( struct V_322 * V_323 , void * V_325 , T_5 * V_321 )
{
unsigned V_24 ;
...
static void F_94 ( struct V_322 * V_323 , void * V_325 )
{
}
static int F_95 ( struct V_322 * V_323 , void * V_325 )
{
if ( V_325 == V_324 ) {
F_96 ( V_323 , L_22 V_326 L_8 ) ;
} else if ( ! V_232 ) {
F_96 ( V_323 , L_23 ) ;
} else if ( ! V_94 ) {
F_96 ( V_323 , L_24 ) ;
...
V_22 -> V_23 , V_22 -> V_40 ) ;
#define F_98 ( T_6 ) kiss->x
F_97 ( V_323 , L_29 ,
F_98 ( V_61 ) , F_98 ( V_192 ) , F_98 ( V_193 ) , F_98 ( V_182 ) ,
F_98 ( V_19 ) , F_98 ( V_212 ) , F_98 ( V_197 ) , F_98 ( V_173 ) ,
F_98 ( V_177 ) , F_98 ( V_171 ) , F_98 ( V_163 ) , F_98 ( V_186 ) ) ;
#undef F_98
#ifdef F_99
{
int V_2 ;
...
F_97 ( V_323 , L_31 , V_8 -> V_10 [ V_2 ] ) ;
F_97 ( V_323 , L_8 ) ;
F_97 ( V_323 , L_32 , F_1 ( V_8 -> V_9 , V_42 ) , F_1 ( V_8 -> V_9 , V_74 ) ) ;
for ( V_2 = 3 ; V_2 < 8 ; V_2 ++ )
F_97 ( V_323 , L_31 , F_1 ( V_8 -> V_9 , V_2 ) ) ;
F_97 ( V_323 , L_33 ) ;
...
static int F_101 ( struct V_329 * V_329 , struct V_330 * V_330 )
{
return F_102 ( V_330 , & V_331 ) ;
}
...
F_105 () ;
F_106 ( L_36 , 0 , V_335 . V_336 , & V_337 ) ;
return 0 ;
}
...
for ( V_24 = 0 ; V_24 < V_225 ; V_24 ++ )
if ( V_226 [ V_24 ] . V_227 ) F_110 ( V_24 , NULL ) ;
F_111 () ;
for ( V_24 = 0 ; V_24 < V_94 * 2 ; V_24 ++ )
{
V_8 = & V_95 [ V_24 ] ;
