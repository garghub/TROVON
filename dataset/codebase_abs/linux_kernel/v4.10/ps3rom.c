...
V_22 = F_20 ( V_7 -> V_8 . V_45 , & V_47 , & V_66 ) ;
if ( V_47 != V_7 -> V_47 )
F_10 ( & V_7 -> V_8 . V_9 ,
L_9 ,
...
if ( F_24 ( V_66 , & V_67 , & V_68 , & V_69 ) ) {
V_17 -> V_61 = V_49 << 16 ;
goto F_18;
}
F_25 ( 0 , V_17 -> V_59 , V_67 , V_68 , V_69 ) ;
V_17 -> V_61 = V_74 ;
F_18:
V_4 -> V_55 = NULL ;
V_17 -> V_56 ( V_17 ) ;
