...
static int F_93 ( struct V_129 * V_130 , T_3 V_87 , T_3 * V_182 )
{
* V_182 = V_37 ;
return 0 ;
}
...
F_5 ( ! V_12 ) ;
V_12 -> V_66 = 0 ;
F_97 ( V_130 , V_184 , V_185 ) ;
F_97 ( V_130 , V_186 , V_146 ) ;
F_98 ( V_12 -> V_91 ) ;
F_53 ( V_12 ) ;
V_89 = F_66 ( V_130 , 0 , V_187 ,
F_52 ( 2 ) , L_43 ) ;
if ( V_89 < 0 ) {
F_59 (KERN_ERR PFX L_44 , retval) ;
return V_89 ;
}
V_89 = F_70 ( V_130 , V_188 , 0 , NULL ) ;
if ( V_89 < 0 ) {
...
int V_89 = 0 ;
int V_79 ;
V_40 = F_117 ( sizeof( * V_12 ) , & V_15 -> V_22 ,
F_94 , NULL ) ;
if ( ! V_40 ) {
F_31 ( L_53 ) ;
V_89 = - V_110 ;
...
F_120 ( & V_12 -> V_46 ) ;
V_12 -> V_15 = V_15 ;
V_130 -> V_209 = ( void V_210 V_211 * ) & V_12 -> V_212 ;
V_130 -> V_213 = V_214 ;
V_130 -> V_40 = V_12 ;
V_130 -> V_215 = & V_216 ;
V_204 = & V_200 -> V_217 [ 0 ] . V_218 ;
for ( V_79 = 0 ; V_79 < V_204 -> V_219 ; ++ V_79 ) {
V_206 = & V_200 -> V_217 [ 0 ] . V_220 [ V_79 ] . V_218 ;
if ( F_121 ( V_206 ) ) {
if ( V_12 -> V_91 != NULL ) {
F_40 ( L_54 ) ;
continue;
...
if ( ! V_12 -> V_91 )
goto error;
if ( F_43 ( V_206 -> V_221 ) != 64 )
F_40 ( L_55 ) ;
if ( V_206 -> V_222 != ( 2 | V_223 ) )
F_40 ( L_56 ,
V_206 -> V_222 ) ;
V_12 -> V_93 = F_122 ( V_15 ,
V_206 ->
V_222 ) ;
V_12 -> V_91 -> V_62 =
F_18 ( V_27 , V_109 ) ;
...
F_40 ( L_60 ,
V_206 -> V_222 ) ;
V_12 -> V_125 = F_124 ( V_15 ,
V_206 ->
V_222 ) ;
V_12 -> V_197 = F_18 ( V_27 , V_109 ) ;
if ( ! V_12 -> V_197 ) {
F_31 ( L_61 ) ;
goto error;
}
...
if ( ! V_12 -> V_197 || ! V_12 -> V_91 ) {
F_31 ( L_62 ) ;
goto error;
}
if ( F_125 ( & V_208 , L_63 ,
& V_200 -> V_22 ) == 0 ) {
V_207 . V_87 = V_208 -> V_87 ;
V_207 . V_112 = V_208 -> V_76 ;
}
if ( V_207 . V_87 && V_207 . V_112 ) {
if ( F_58 ( V_12 , & V_207 ) < 0 )
goto error;
} else {
F_31 ( L_64 ) ;
goto error;
...
if ( F_127 ( V_40 , 0 , 0 , & V_224 ) != 0 ) {
V_12 -> V_22 = NULL ;
F_31 ( L_69 , V_70 ) ;
F_108 ( F_109 ( V_40 ) ) ;
goto error;
}
V_12 -> V_22 = V_40 -> V_225 ;
goto exit;
error:
F_101 ( V_12 ) ;
if ( V_12 -> V_22 ) {
