...
V_14 = F_43 ( V_10 -> V_16 ) ;
if ( V_14 )
F_44 (ifa, &indev->addr_list, if_list) {
...
static struct V_1 *
F_45 ( struct V_9 * V_10 , int V_77 , int V_42 ,
const struct V_64 * V_65 ,
struct V_1 * V_2 )
{
const struct V_78 * V_47 = F_46 ( V_10 ) ;
struct V_29 V_48 , * V_20 ;
const struct V_69 * V_67 = V_65 -> V_68 ;
...
if ( V_20 -> V_49 && ! V_20 -> V_50 && ! V_20 -> V_51 && ! V_20 -> V_52 ) {
struct V_1 * V_53 ;
V_53 = F_26 ( F_40 ( V_65 ) , V_10 , V_42 , V_20 , V_77 ,
& V_47 -> V_22 ,
F_42 ( V_10 , & V_67 -> V_15 . V_79 , & V_47 -> V_12 ) ,
V_20 -> V_54 ,
...
int V_42 = 0 ;
int V_77 ;
V_77 = F_48 ( V_10 , & V_42 , - 1 , NULL , NULL ) ;
if ( V_77 < 0 ) {
F_23 ( L_5 ) ;
return V_61 ;
}
...
V_2 = F_26 ( F_40 ( V_65 ) , V_10 , V_42 , V_20 , V_77 ,
& V_47 -> V_22 , & V_47 -> V_12 ,
V_20 -> V_54 , V_20 -> V_55 ,
F_49 ( V_65 ) , V_36 ) ;
V_15 = F_42 ( V_10 , & V_67 -> V_15 . V_79 , & V_47 -> V_12 ) ;
V_45 = V_67 -> V_45 ? V_67 -> V_45 : V_20 -> V_55 ;
if ( V_2 && V_2 -> V_3 == V_4 )
V_2 = F_45 ( V_10 , V_77 , V_42 , V_65 , V_2 ) ;
else if ( ! V_2 )
...
if ( V_84 )
return V_84 ;
if ( ( V_82 -> V_85 == V_31 || V_82 -> V_85 == V_37 ) &&
! ( V_82 -> V_86 & V_87 ) )
return 0 ;
F_52 ( L_9
L_10 ) ;
...
static int F_53 ( const struct V_80 * V_65 )
{
const struct V_89 * V_82 = V_65 -> V_83 ;
int V_84 ;
V_84 = F_54 ( V_65 -> V_19 ) ;
if ( V_84 )
return V_84 ;
