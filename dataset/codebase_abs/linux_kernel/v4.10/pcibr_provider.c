...
V_33 = F_24 ( V_23 ) ;
V_35 = (struct V_35 * ) ( F_25 ( V_33 ) -> V_48 ) ;
if ( V_35 -> V_49 . V_50 ) {
V_36 = V_35 -> V_49 .
V_50 [ ( int ) V_2 -> V_12 . V_51 ] ;
if ( V_36 ) {
...
if ( ! V_61 -> V_65 )
return;
V_62 = (struct V_62 * ) V_61 -> V_66 ;
if ( V_62 ) {
V_1 =
(struct V_1 * ) V_62 -> V_67 ->
V_68 ;
F_29 ( V_1 , V_63 ) ;
}
}
void F_30 ( struct V_61 * V_61 )
{
struct V_62 * V_62 ;
struct V_1 * V_1 ;
int V_63 = V_61 -> V_64 ;
