...
struct V_29 * V_30 ,
int (* V_7)( struct V_29 * , const unsigned char * ) ,
int (* F_19)( struct V_29 * ,
const unsigned char * ) )
{
struct V_8 * V_9 , * V_28 ;
int V_26 ;
F_15 (ha, tmp, &list->list, list) {
if ( ! V_9 -> V_17 || V_9 -> V_14 != 1 )
continue;
if ( F_19 && F_19 ( V_30 , V_9 -> V_3 ) )
continue;
V_9 -> V_17 -- ;
F_7 ( V_2 , V_9 , false , false ) ;
}
F_15 (ha, tmp, &list->list, list) {
if ( V_9 -> V_17 )
continue;
V_26 = V_7 ( V_30 , V_9 -> V_3 ) ;
if ( V_26 )
return V_26 ;
V_9 -> V_17 ++ ;
V_9 -> V_14 ++ ;
...
int F_30 ( struct V_29 * V_30 , const unsigned char * V_3 ,
unsigned char V_5 )
{
int V_26 ;
struct V_8 * V_9 ;
...
int F_31 ( struct V_29 * V_30 , const unsigned char * V_3 )
{
struct V_8 * V_9 ;
int V_26 ;
F_32 ( V_30 ) ;
...
int F_35 ( struct V_29 * V_30 , const unsigned char * V_3 )
{
int V_26 ;
F_32 ( V_30 ) ;
...
int F_36 ( struct V_29 * V_30 , const unsigned char * V_3 )
{
int V_26 ;
F_32 ( V_30 ) ;
...
int F_40 ( struct V_29 * V_38 , struct V_29 * V_39 )
{
int V_26 = 0 ;
if ( V_38 -> V_4 != V_39 -> V_4 )
return - V_21 ;
...
void F_41 ( struct V_29 * V_38 , struct V_29 * V_39 )
{
if ( V_38 -> V_4 != V_39 -> V_4 )
return;
F_32 ( V_39 ) ;
...
static int F_48 ( struct V_29 * V_30 , const unsigned char * V_3 ,
bool V_6 )
{
int V_26 ;
F_32 ( V_30 ) ;
...
int F_49 ( struct V_29 * V_30 , const unsigned char * V_3 )
{
return F_48 ( V_30 , V_3 , false ) ;
}
int F_50 ( struct V_29 * V_30 , const unsigned char * V_3 )
{
return F_48 ( V_30 , V_3 , true ) ;
}
int F_51 ( struct V_29 * V_38 , struct V_29 * V_39 )
{
int V_26 = 0 ;
if ( V_38 -> V_4 != V_39 -> V_4 )
return - V_21 ;
...
int F_52 ( struct V_29 * V_38 , struct V_29 * V_39 )
{
int V_26 = 0 ;
if ( V_38 -> V_4 != V_39 -> V_4 )
return - V_21 ;
...
void F_53 ( struct V_29 * V_38 , struct V_29 * V_39 )
{
if ( V_38 -> V_4 != V_39 -> V_4 )
return;
F_32 ( V_39 ) ;
