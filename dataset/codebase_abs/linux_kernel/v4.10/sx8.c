...
V_90 -> type = V_86 ;
V_90 -> V_70 = V_91 ;
V_90 -> V_72 = F_24 ( F_25 ( V_62 ) ) ;
V_90 -> V_92 = 1 ;
V_90 -> V_93 = V_94 ;
V_90 -> V_95 = F_24 ( V_23 -> V_96 + ( V_97 >> 1 ) ) ;
V_90 -> V_98 = F_24 ( V_97 >> 1 ) ;
V_90 -> V_99 = F_24 ( V_23 -> V_96 + ( 16 * 1024 ) ) ;
V_90 -> V_100 = F_24 ( 1024 ) ;
V_90 -> V_101 = F_24 ( V_23 -> V_96 ) ;
V_90 -> V_102 = F_24 ( V_103 ) ;
V_90 -> V_104 = F_24 ( V_23 -> V_96 + V_105 ) ;
V_90 -> V_106 = F_24 ( V_107 ) ;
V_90 -> V_49 [ 0 ] . V_108 = F_24 ( V_23 -> V_96 + ( V_97 >> 1 ) ) ;
V_90 -> V_49 [ 0 ] . V_98 = F_24 ( 65536 ) ;
return sizeof( struct V_89 ) ;
}
...
V_61 -> V_73 = F_24 ( V_63 ) ;
V_82 += V_109 ;
memset ( V_82 , V_112 , V_113 ) ;
return V_109 + V_113 ;
}
static unsigned int F_34 ( struct V_22 * V_23 ,
unsigned int V_62 , void * V_82 )
{
struct V_114 * V_61 = V_82 ;
...
static inline void F_37 ( struct V_22 * V_23 , struct V_117 * V_118 )
{
unsigned int V_62 = V_23 -> V_119 % V_120 ;
F_38 ( V_118 ) ;
F_9 ( L_5 , V_118 ) ;
V_23 -> V_121 [ V_62 ] = V_118 ;
V_23 -> V_119 ++ ;
F_23 ( V_23 -> V_119 == V_23 -> V_122 ) ;
}
static inline struct V_117 * F_39 ( struct V_22 * V_23 )
{
unsigned int V_62 ;
if ( V_23 -> V_119 == V_23 -> V_122 )
return NULL ;
V_62 = V_23 -> V_122 % V_120 ;
V_23 -> V_122 ++ ;
return V_23 -> V_121 [ V_62 ] ;
}
static inline void F_40 ( struct V_22 * V_23 )
{
struct V_117 * V_118 = F_39 ( V_23 ) ;
if ( V_118 ) {
F_41 ( V_118 ) ;
F_9 ( L_6 , V_118 ) ;
}
...
V_49 = & V_29 -> V_49 [ 0 ] ;
V_46 = F_50 ( V_118 , V_53 , V_49 ) ;
if ( V_46 <= 0 ) {
F_42 ( V_23 , V_29 , - V_133 ) ;
return;
}
V_46 = F_51 ( V_23 -> V_134 , V_49 , V_46 , V_129 ) ;
if ( V_46 <= 0 ) {
F_42 ( V_23 , V_29 , - V_133 ) ;
return;
}
...
V_30 -> V_140 = F_24 ( F_52 ( V_53 ) & 0xffffffff ) ;
V_34 = ( F_52 ( V_53 ) >> 16 ) >> 16 ;
V_30 -> V_141 = F_53 ( ( V_142 ) V_34 ) ;
V_30 -> V_143 = F_53 ( F_54 ( V_53 ) ) ;
V_16 = sizeof( struct V_126 ) - sizeof( V_30 -> V_49 ) ;
for ( V_17 = 0 ; V_17 < V_46 ; V_17 ++ ) {
struct V_144 * V_145 = & V_30 -> V_49 [ V_17 ] ;
V_145 -> V_108 = F_24 ( F_55 ( & V_29 -> V_49 [ V_17 ] ) ) ;
V_145 -> V_98 = F_24 ( F_56 ( & V_29 -> V_49 [ V_17 ] ) ) ;
...
struct F_22 * V_146 = (struct F_22 * ) V_63 ;
T_6 V_147 , V_148 ;
int V_149 ;
T_7 V_150 ;
F_11 ( L_1 ) ;
...
if ( error )
goto V_151;
if ( F_58 ( V_146 -> V_152 ) & V_153 )
goto V_151;
V_149 = V_23 -> V_154 ;
if ( ( V_149 < 0 ) || ( V_149 >= V_113 ) ) {
F_59 (KERN_ERR PFX L_11 ,
cur_port, (int) desc->array_id) ;
goto V_151;
}
V_6 = & V_23 -> V_6 [ V_149 ] ;
V_147 = ( T_6 ) F_58 ( V_146 -> V_155 ) ;
V_148 = ( T_6 ) F_60 ( V_146 -> V_156 ) ;
V_6 -> V_157 = V_147 | ( V_148 << 32 ) ;
V_6 -> V_11 = F_60 ( V_146 -> V_158 ) ;
V_6 -> V_13 = F_60 ( V_146 -> V_159 ) ;
V_6 -> V_15 = F_60 ( V_146 -> V_160 ) ;
V_23 -> V_161 |= ( 1 << V_149 ) ;
...
V_129 = V_132 ;
F_65 ( V_23 -> V_134 , & V_29 -> V_49 [ 0 ] , V_29 -> V_46 , V_129 ) ;
F_42 ( V_23 , V_29 , error ) ;
}
...
break;
case V_115 : {
struct V_116 * V_176 = (struct V_116 * )
( V_82 + sizeof( struct V_114 ) ) ;
if ( ! error ) {
V_23 -> V_177 = F_58 ( V_176 -> V_178 ) ;
...
unsigned int V_62 = V_23 -> V_185 % V_103 ;
while ( 1 ) {
T_1 V_171 = F_58 ( V_182 [ V_62 ] . V_171 ) ;
if ( V_171 == 0xffffffff ) {
F_9 ( L_19 , V_62 ) ;
...
F_9 ( L_20 , V_62 ) ;
F_66 ( V_23 , V_182 [ V_62 ] . V_187 , V_171 ) ;
V_182 [ V_62 ] . V_171 = F_24 ( 0xffffffff ) ;
}
...
static T_9 F_72 ( int V_190 , void * V_191 )
{
...
static void F_74 ( struct V_199 * V_184 )
{
struct V_22 * V_23 =
F_75 ( V_184 , struct V_22 , V_163 ) ;
unsigned long V_51 ;
unsigned int V_74 ;
int V_35 , V_17 , V_200 ;
int V_201 = 0 ;
...
case V_76 :
V_200 = - 1 ;
for ( V_17 = V_23 -> V_154 + 1 ; V_17 < V_113 ; V_17 ++ )
...
static int F_79 ( void T_2 * V_20 , T_1 V_210 , unsigned int V_211 )
{
unsigned int V_17 ;
...
V_182 [ V_17 ] . V_171 = F_24 ( 0xffffffff ) ;
F_5 ( 0 , V_20 + V_186 ) ;
}
...
F_11 ( L_1 ) ;
F_5 ( 0 , V_20 + V_214 ) ;
V_213 = F_84 ( V_20 + V_215 ) ;
if ( V_213 & 0x01 ) {
V_213 &= ~ 0x01 ;
F_85 ( V_213 , V_20 + V_215 ) ;
F_84 ( V_20 + V_215 ) ;
F_11 ( L_33 ) ;
F_19 ( 5000 ) ;
}
...
F_5 ( V_34 , V_20 + V_36 ) ;
F_10 ( V_20 + V_36 ) ;
V_35 = F_79 ( V_20 , V_217 | V_216 , 0 ) ;
if ( V_35 ) {
F_11 ( L_38 ) ;
return V_35 ;
}
F_4 ( V_20 ) ;
F_5 ( V_23 -> V_96 & 0xffffffff , V_20 + V_218 ) ;
F_5 ( ( V_23 -> V_96 >> 16 ) >> 16 , V_20 + V_219 ) ;
F_5 ( V_105 , V_20 + V_220 ) ;
V_34 = F_10 ( V_20 + V_36 ) ;
V_34 |= ( V_217 | V_216 | V_221 ) ;
F_5 ( V_34 , V_20 + V_36 ) ;
F_10 ( V_20 + V_36 ) ;
V_35 = F_79 ( V_20 , V_217 | V_216 , 1 ) ;
if ( V_35 ) {
F_11 ( L_39 ) ;
return V_35 ;
}
...
( unsigned int ) ( V_23 -> V_137 * V_113 ) + V_17 ) ;
V_207 -> V_227 = V_23 -> V_227 ;
V_207 -> V_228 = V_17 * V_224 ;
V_207 -> V_229 = & V_230 ;
V_207 -> V_8 = V_6 ;
V_118 = F_88 ( F_46 , & V_23 -> V_55 ) ;
if ( ! V_118 ) {
V_35 = - V_64 ;
break;
}
...
if ( V_207 ) {
struct V_117 * V_118 = V_207 -> V_231 ;
if ( V_207 -> V_51 & V_233 )
F_92 ( V_207 ) ;
if ( V_118 )
F_93 ( V_118 ) ;
...
{
V_23 -> V_183 = F_96 ( V_23 -> V_134 , V_234 ,
& V_23 -> V_96 ) ;
if ( ! V_23 -> V_183 )
return - V_64 ;
V_23 -> V_25 = V_23 -> V_183 + V_105 ;
V_23 -> V_27 = V_23 -> V_96 + V_105 ;
memset ( V_23 -> V_183 , 0xff , V_105 ) ;
memset ( V_23 -> V_25 , 0 , V_97 - V_105 ) ;
return 0 ;
}
static int F_97 ( struct V_235 * V_134 , const struct V_236 * V_237 )
{
struct V_22 * V_23 ;
unsigned int V_238 ;
int V_35 ;
...
if ( V_35 )
return V_35 ;
V_35 = F_100 ( V_134 , V_226 ) ;
if ( V_35 )
goto V_65;
#ifdef F_101
V_35 = F_102 ( V_134 , F_103 ( 64 ) ) ;
if ( ! V_35 ) {
V_35 = F_104 ( V_134 , F_103 ( 64 ) ) ;
if ( V_35 ) {
...
if ( ! F_112 ( 0 , & V_244 ) )
V_23 -> V_227 = 160 ;
else if ( ! F_112 ( 1 , & V_244 ) )
V_23 -> V_227 = 161 ;
else
V_23 -> V_51 |= V_245 ;
V_23 -> V_137 = V_246 ;
sprintf ( V_23 -> V_162 , V_226 L_49 , V_246 ) ;
V_35 = F_113 ( V_23 -> V_227 , V_23 -> V_162 ) ;
if ( V_35 < 0 )
goto V_247;
if ( V_23 -> V_51 & V_245 )
V_23 -> V_227 = V_35 ;
...
goto V_248;
F_114 ( V_134 ) ;
V_35 = F_115 ( V_134 -> V_190 , F_72 , V_249 , V_226 , V_23 ) ;
if ( V_35 ) {
...
F_116 ( & V_23 -> V_209 ) ;
F_59 ( V_251 L_52 ,
V_23 -> V_162 , F_117 ( V_134 ) , ( int ) V_113 ,
( unsigned long long ) F_110 ( V_134 , 0 ) ,
V_134 -> V_190 , V_23 -> V_227 ) ;
V_246 ++ ;
F_118 ( V_134 , V_23 ) ;
return 0 ;
V_250:
F_119 ( V_134 -> V_190 , V_23 ) ;
V_248:
F_91 ( V_23 ) ;
F_120 ( V_23 -> V_227 , V_23 -> V_162 ) ;
V_247:
if ( V_23 -> V_227 == 160 )
F_121 ( 0 , & V_244 ) ;
...
F_93 ( V_23 -> V_56 ) ;
V_243:
F_122 ( V_134 , V_234 , V_23 -> V_183 , V_23 -> V_96 ) ;
V_242:
F_123 ( V_23 -> V_20 ) ;
V_241:
F_124 ( V_23 ) ;
...
static void F_127 ( struct V_235 * V_134 )
{
struct V_22 * V_23 = F_128 ( V_134 ) ;
if ( ! V_23 ) {
