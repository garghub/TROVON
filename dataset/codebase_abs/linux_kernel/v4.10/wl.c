...
int V_60 , int V_61 , int V_44 , bool V_62 )
{
struct V_20 * V_63 ;
F_3 ( V_2 ) ;
F_21 ( L_10 ,
V_2 -> V_14 , V_2 -> V_11 , V_44 ) ;
V_63 = F_46 ( sizeof( struct V_20 ) , V_49 ) ;
if ( ! V_63 )
return - V_50 ;
V_63 -> V_28 = & V_64 ;
V_63 -> V_2 = V_2 ;
...
V_63 . V_61 = V_61 ;
V_63 . V_44 = V_44 ;
return F_48 ( V_16 , & V_63 ) ;
}
static int F_49 ( struct V_15 * V_16 , int V_62 )
{
int V_19 = 0 ;
struct V_1 * V_8 ;
struct V_1 * V_65 ;
...
static int F_48 ( struct V_15 * V_16 , struct V_20 * V_63 )
{
...
int V_19 , V_73 = 0 ;
F_21 ( L_14 ,
V_14 , V_2 -> V_11 , V_63 -> V_60 , V_63 -> V_61 ) ;
V_19 = F_32 ( V_16 , V_2 , V_63 -> V_44 ) ;
if ( ! V_19 ) {
F_11 ( & V_16 -> V_23 ) ;
F_1 ( V_2 , & V_16 -> free ) ;
V_16 -> V_42 ++ ;
...
V_19 == - V_76 ) {
int V_77 ;
V_77 = F_45 ( V_16 , V_2 , V_60 , V_61 , 0 , false ) ;
if ( V_77 ) {
F_6 ( V_16 , V_2 ) ;
V_19 = V_77 ;
goto V_78;
...
static int V_64 ( struct V_15 * V_16 , struct V_20 * V_63 ,
int V_86 )
{
int V_87 ;
if ( V_86 ) {
...
F_13 ( & V_16 -> V_23 ) ;
V_19 = F_45 ( V_16 , V_2 , V_60 , V_61 , V_44 , false ) ;
if ( V_19 ) {
F_11 ( & V_16 -> V_23 ) ;
F_1 ( V_2 , & V_16 -> V_57 ) ;
F_13 ( & V_16 -> V_23 ) ;
...
if ( F_45 ( V_16 , V_2 , V_116 -> V_60 , V_116 -> V_61 , 0 , false ) ) {
F_6 ( V_16 , V_2 ) ;
goto V_51;
}
V_110 ++ ;
