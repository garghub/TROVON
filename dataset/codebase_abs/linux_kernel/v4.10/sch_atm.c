...
V_74 = V_78 ;
V_7 = NULL ;
if ( F_27 ( V_29 -> V_79 ) != V_3 -> V_42 ||
! ( V_7 = (struct V_1 * ) F_9 ( V_3 , V_29 -> V_79 ) ) ) {
struct V_70 * V_80 ;
F_3 (flow, &p->flows, list) {
V_80 = F_40 ( V_7 -> V_19 ) ;
if ( V_80 ) {
V_74 = F_41 ( V_29 , V_80 , & V_73 , true ) ;
if ( V_74 < 0 )
continue;
V_7 = (struct V_1 * ) V_73 . V_81 ;
if ( ! V_7 )
V_7 = F_1 ( V_3 , V_73 . V_4 ) ;
goto V_82;
}
}
V_7 = NULL ;
...
if ( F_74 ( V_29 , V_119 , sizeof( V_109 ) , & V_109 ) )
goto V_107;
V_110 = F_75 ( V_7 -> V_22 -> V_120 ) ;
if ( F_76 ( V_29 , V_121 , V_110 ) )
goto V_107;
}
if ( V_7 -> V_25 ) {
...
struct V_1 * V_7 = (struct V_1 * ) V_8 ;
if ( F_80 ( F_81 ( V_3 ) ,
V_123 , NULL , & V_7 -> V_97 ) < 0 ||
F_82 ( V_123 , NULL , & V_7 -> V_91 , V_7 -> V_14 -> V_14 . V_93 ) < 0 )
return - 1 ;
return 0 ;
}
