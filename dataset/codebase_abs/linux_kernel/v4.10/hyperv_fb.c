...
static int F_40 ( struct V_1 * V_2 , struct V_14 * V_15 )
{
struct V_62 * V_63 = V_15 -> V_63 ;
...
if ( ! ( F_43 ( V_156 , 0 ) & V_164 ) ||
F_44 ( V_156 , 0 ) < V_101 )
goto V_165;
V_161 = F_45 ( V_156 , 0 ) ;
V_160 = V_161 - V_101 + 1 ;
}
V_6 = F_46 ( & V_63 -> V_166 , V_2 , V_160 , V_161 ,
V_101 , 0x100000 , true ) ;
if ( V_6 != 0 ) {
F_5 ( L_11 ) ;
goto V_165;
}
V_157 = F_47 ( V_63 -> V_166 -> V_167 , V_101 ) ;
if ( ! V_157 )
goto V_168;
V_15 -> V_169 = F_48 ( 1 ) ;
if ( ! V_15 -> V_169 )
goto V_170;
if ( V_158 ) {
V_15 -> V_169 -> V_171 [ 0 ] . V_172 = V_173 . V_174 ;
V_15 -> V_169 -> V_171 [ 0 ] . V_9 = V_173 . V_175 ;
F_49 ( V_15 -> V_169 ,
V_151 , false ) ;
} else {
V_15 -> V_169 -> V_171 [ 0 ] . V_172 = F_50 ( V_156 , 0 ) ;
V_15 -> V_169 -> V_171 [ 0 ] . V_9 = F_44 ( V_156 , 0 ) ;
}
V_15 -> V_34 . V_109 = V_63 -> V_166 -> V_167 ;
V_15 -> V_34 . V_176 = V_101 ;
V_15 -> V_177 = V_157 ;
V_15 -> V_178 = V_101 ;
if ( ! V_158 )
F_51 ( V_156 ) ;
...
struct V_62 * V_63 ;
int V_6 ;
V_15 = F_56 ( sizeof( struct V_62 ) , & V_2 -> V_53 ) ;
if ( ! V_15 ) {
F_5 ( L_12 ) ;
return - V_179 ;
}
...
V_15 -> V_27 . V_186 = V_187 ;
V_15 -> V_27 . V_49 = - 1 ;
V_15 -> V_27 . V_48 = - 1 ;
V_15 -> V_27 . V_188 = V_189 ;
strcpy ( V_15 -> V_34 . V_190 , V_151 ) ;
V_15 -> V_34 . type = V_191 ;
V_15 -> V_34 . V_192 = V_193 ;
V_15 -> V_34 . V_35 = V_125 * V_98 / 8 ;
V_15 -> V_34 . V_194 = V_195 ;
V_15 -> V_196 = & V_197 ;
...
static void F_69 ( struct V_155 * V_156 )
{
}
