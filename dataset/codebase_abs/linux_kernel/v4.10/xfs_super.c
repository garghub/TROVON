...
int error ;
F_173 () ;
F_174 (KERN_INFO XFS_VERSION_STRING L_92
XFS_BUILD_OPTIONS L_93 ) ;
F_175 () ;
F_176 () ;
F_177 () ;
F_178 () ;
...
if ( error )
goto V_425;
V_308 = F_184 ( L_94 , NULL , V_426 ) ;
if ( ! V_308 ) {
error = - V_9 ;
goto V_427;
}
V_328 . V_428 . V_306 . V_307 = V_308 ;
V_328 . V_327 = F_135 ( struct V_328 ) ;
if ( ! V_328 . V_327 ) {
error = - V_9 ;
goto V_429;
}
error = F_185 ( & V_328 . V_428 , & V_430 , NULL ,
L_95 ) ;
if ( error )
goto V_330;
#ifdef F_186
V_431 . V_306 . V_307 = V_308 ;
error = F_185 ( & V_431 , & V_432 , NULL , L_96 ) ;
if ( error )
goto V_433;
#endif
error = F_187 () ;
