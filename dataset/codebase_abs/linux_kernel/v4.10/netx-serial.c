...
static void F_14 ( struct V_1 * V_2 , unsigned long * V_24 )
{
unsigned char V_25 , V_26 , V_27 ;
while ( ! ( F_2 ( V_2 -> V_4 + V_19 ) & V_28 ) ) {
V_25 = F_2 ( V_2 -> V_4 + V_13 ) ;
V_26 = V_29 ;
V_2 -> V_14 . V_25 ++ ;
V_27 = F_2 ( V_2 -> V_4 + V_30 ) ;
if ( V_27 & V_31 ) {
F_3 ( 0 , V_2 -> V_4 + V_30 ) ;
if ( F_15 ( V_2 ) )
continue;
}
if ( F_16 ( V_27 & ( V_32 | V_33 | V_34 ) ) ) {
if ( V_27 & V_33 )
V_2 -> V_14 . V_35 ++ ;
else if ( V_27 & V_32 )
V_2 -> V_14 . V_36 ++ ;
...
if ( F_17 ( V_2 , V_25 ) )
continue;
F_18 ( V_2 , V_27 , V_34 , V_25 , V_26 ) ;
}
F_19 ( & V_2 -> V_42 , * V_24 ) ;
F_20 ( & V_2 -> V_11 -> V_2 ) ;
F_21 ( & V_2 -> V_42 , * V_24 ) ;
}
static T_1 F_22 ( int V_43 , void * V_44 )
{
struct V_1 * V_2 = V_44 ;
unsigned long V_24 ;
unsigned char V_27 ;
F_21 ( & V_2 -> V_42 , V_24 ) ;
V_27 = F_2 ( V_2 -> V_4 + V_45 ) & V_46 ;
while ( V_27 ) {
if ( V_27 & V_47 )
F_14 ( V_2 , & V_24 ) ;
if ( V_27 & V_48 )
...
{
int V_52 ;
V_52 = F_30 ( V_2 -> V_43 , F_22 , 0 ,
V_64 , V_2 ) ;
if ( V_52 ) {
F_31 ( V_2 -> V_65 , L_1 , V_2 -> V_43 ) ;
goto exit;
}
...
if ( V_126 ) {
F_51 ( V_126 , & V_72 , & V_35 , & V_123 , & V_124 ) ;
} else {
...
return F_52 ( & V_128 -> V_2 , V_117 , V_72 , V_35 , V_123 , V_124 ) ;
}
