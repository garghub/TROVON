...
if ( V_7 )
goto V_114;
if ( memcmp ( V_121 , V_120 , V_22 -> V_39 -> V_40 ) != 0 ) {
V_7 = V_122 ;
goto V_114;
}
...
int
F_57 ( struct V_21 * V_22 , struct V_1 * V_92 ,
unsigned char * V_123 )
{
struct V_124 * V_95 ;
struct V_125 * V_64 ;
...
int V_31 ;
F_5 ( L_10 , V_41 ) ;
V_95 = F_58 ( V_22 -> V_39 -> V_47 , 0 , 0 ) ;
if ( F_21 ( V_95 ) ) {
F_5 ( L_11 ,
V_41 , F_59 ( V_95 ) , V_22 -> V_39 -> V_47 ) ;
return F_59 ( V_95 ) ;
}
V_64 = F_19 ( sizeof( * V_64 ) + F_60 ( V_95 ) ,
V_44 ) ;
if ( ! V_64 ) {
F_5 ( L_12 ,
V_41 , V_22 -> V_39 -> V_47 ) ;
...
V_64 -> V_2 = V_95 ;
V_64 -> V_129 = 0 ;
V_31 = F_62 ( V_95 , V_22 -> V_130 , V_22 -> V_39 -> V_51 ) ;
if ( V_31 )
goto V_114;
V_31 = F_63 ( V_64 , ( T_2 * ) & V_128 , 4 , V_126 ) ;
if ( V_31 )
goto V_114;
V_31 = F_62 ( V_95 , V_126 , V_22 -> V_39 -> V_51 ) ;
if ( V_31 )
goto V_114;
V_31 = F_63 ( V_64 , V_123 , 8 , V_126 ) ;
if ( V_31 )
goto V_114;
V_31 = F_64 ( V_92 , V_126 , V_22 -> V_39 -> V_51 ) ;
if ( V_31 )
goto V_114;
V_31 = 0 ;
V_114:
...
int
F_66 ( struct V_21 * V_22 , struct V_1 * V_92 ,
T_3 V_131 )
{
struct V_124 * V_95 ;
struct V_125 * V_64 ;
...
V_31 = F_62 ( V_95 , V_132 , V_22 -> V_39 -> V_51 ) ;
if ( V_31 )
goto V_114;
V_31 = F_63 ( V_64 , V_128 , 4 , V_132 ) ;
if ( V_31 )
goto V_114;
V_31 = F_62 ( V_95 , V_132 , V_22 -> V_39 -> V_51 ) ;
if ( V_31 )
...
V_31 = F_63 ( V_64 , V_133 , 4 , V_132 ) ;
if ( V_31 )
goto V_114;
V_31 = F_64 ( V_92 , V_132 , V_22 -> V_39 -> V_51 ) ;
if ( V_31 )
goto V_114;
V_31 = 0 ;
V_114:
