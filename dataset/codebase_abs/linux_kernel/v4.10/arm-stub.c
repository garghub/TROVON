...
V_90:
F_26 ( V_63 , V_60 ) ;
F_25 ( V_63 , V_72 , ( unsigned long ) V_71 ) ;
V_82:
return V_83 ;
}
static int F_27 ( const void * V_95 , const void * V_96 )
{
...
void F_30 ( T_12 * V_110 , unsigned long V_111 ,
...
int V_95 ;
F_31 ( V_110 , V_111 / V_112 , V_112 , F_27 , NULL ) ;
...
if ( ! F_28 ( V_118 , V_117 ) ||
! F_29 ( V_118 , V_117 ) ) {
V_119 = F_32 ( V_117 -> V_99 , V_120 ) ;
V_10 += V_117 -> V_99 - V_119 ;
if ( F_33 ( V_117 -> V_99 , V_121 ) && V_10 >= V_121 )
V_115 = F_34 ( V_115 , V_121 ) ;
else
V_115 = F_34 ( V_115 , V_120 ) ;
}
