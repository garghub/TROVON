...
V_36 -> V_33 , V_36 -> V_43 , V_36 -> V_44 , F_32 ( V_36 ) ) ;
return true ;
}
...
{
while ( V_2 -> V_8 > 1 ) {
struct V_3 * V_49 = V_2 -> V_7 , * V_4 = V_49 + 1 ;
if ( V_2 -> V_8 > 2 &&
F_42 ( V_4 [ 0 ] , V_4 [ 1 ] ) )
V_4 ++ ;
if ( F_4 ( V_49 -> V_5 , & F_43 ( V_4 -> V_5 ) ) <= 0 )
break;
if ( ! F_12 ( V_4 -> V_5 ) ) {
F_1 ( V_2 , V_4 ) ;
F_45 ( V_2 , V_4 - V_49 , F_42 ) ;
continue;
}
if ( V_49 -> V_5 > V_4 -> V_5 ) {
if ( F_4 ( V_49 -> V_5 , V_4 -> V_5 ) >= 0 )
F_1 ( V_2 , V_4 ) ;
else
F_46 ( V_49 -> V_5 , V_4 -> V_5 ) ;
F_45 ( V_2 , V_4 - V_49 , F_42 ) ;
} else {
F_47 ( ! F_4 ( & F_43 ( V_49 -> V_5 ) , & F_43 ( V_4 -> V_5 ) ) ) ;
if ( F_4 ( V_4 -> V_5 , V_49 -> V_5 ) < 0 ) {
F_48 ( V_48 , V_49 -> V_5 ) ;
F_49 ( & F_43 ( V_4 -> V_5 ) , V_48 ) ;
F_46 ( V_4 -> V_5 , V_49 -> V_5 ) ;
F_45 ( V_2 , 0 , F_42 ) ;
return V_48 ;
} else {
F_49 ( & F_43 ( V_4 -> V_5 ) , V_49 -> V_5 ) ;
}
}
}
return NULL ;
...
static bool F_52 ( struct V_27 * V_30 ,
struct V_13 * V_45 ,
struct V_1 * V_2 ,
struct V_13 * V_46 )
{
struct V_12 * V_11 = F_24 ( V_30 , struct V_29 , V_28 ) -> V_11 ;
T_3 V_52 ;
unsigned V_53 , V_54 = 0 ;
F_47 ( ! F_40 ( V_45 ) ) ;
F_47 ( ! F_12 ( V_45 ) ) ;
while ( 1 ) {
struct V_13 * V_5 = F_53 ( V_2 ) ;
if ( ! V_5 )
break;
if ( F_4 ( & F_43 ( V_5 ) , V_45 ) >= 0 ) {
if ( F_12 ( V_5 ) )
break;
else
continue;
}
if ( F_4 ( V_5 , & F_43 ( V_45 ) ) <= 0 )
continue;
V_52 = F_18 ( V_5 ) ;
V_53 = F_12 ( V_5 ) ;
if ( V_46 && F_12 ( V_5 ) ) {
...
T_3 V_50 = F_18 ( V_5 ) -
F_18 ( V_46 ) ;
if ( F_18 ( V_5 ) < F_18 ( V_46 ) ||
F_40 ( V_5 ) > F_40 ( V_46 ) )
goto V_55;
if ( F_18 ( V_5 ) > F_18 ( V_45 ) + V_54 )
goto V_55;
if ( ! F_54 ( V_5 , V_46 ) )
goto V_55;
V_50 <<= 8 ;
F_47 ( ! F_6 ( V_46 ) ) ;
for ( V_4 = 0 ; V_4 < F_6 ( V_46 ) ; V_4 ++ )
if ( V_5 -> V_26 [ V_4 ] != V_46 -> V_26 [ V_4 ] + V_50 )
goto V_55;
V_54 = F_40 ( V_5 ) - F_18 ( V_45 ) ;
}
if ( F_4 ( V_45 , V_5 ) < 0 &&
F_4 ( & F_43 ( V_45 ) , & F_43 ( V_5 ) ) > 0 ) {
struct V_13 * V_49 ;
F_50 ( V_5 , V_11 , F_18 ( V_45 ) ,
F_12 ( V_45 ) ) ;
if ( F_55 ( V_30 , V_5 ) ) {
V_49 = F_56 ( V_30 , F_57 ( V_30 ) ,
V_45 ) ;
F_58 ( V_30 , V_49 , V_5 ) ;
} else {
F_59 (key) V_56 ;
F_48 ( & V_56 . V_57 , V_5 ) ;
F_58 ( V_30 , V_5 , & V_56 . V_57 ) ;
V_49 = F_2 ( V_5 ) ;
}
F_46 ( V_45 , V_49 ) ;
F_49 ( & F_43 ( V_45 ) , V_5 ) ;
...
F_50 ( V_5 , V_11 , V_52 , V_53 - F_12 ( V_5 ) ) ;
}
V_55:
if ( V_46 ) {
if ( ! V_54 ) {
return true ;
} else if ( V_54 < F_12 ( V_45 ) ) {
F_62 ( V_45 , F_40 ( V_45 ) -
( F_12 ( V_45 ) - V_54 ) ) ;
F_63 ( V_45 , V_54 ) ;
}
...
bool F_64 ( struct V_12 * V_11 , const struct V_13 * V_5 )
{
char V_22 [ 80 ] ;
if ( ! F_12 ( V_5 ) )
return true ;
...
V_34:
F_15 ( V_22 , sizeof( V_22 ) , V_5 ) ;
F_28 ( V_11 , L_22 , V_22 , F_13 ( V_11 , V_5 ) ) ;
return true ;
}
static bool F_65 ( struct V_27 * V_35 , const struct V_13 * V_5 )
{
struct V_29 * V_30 = F_24 ( V_35 , struct V_29 , V_28 ) ;
return F_64 ( V_30 -> V_11 , V_5 ) ;
}
static bool F_66 ( struct V_29 * V_30 , const struct V_13 * V_5 ,
unsigned V_26 )
{
...
static bool F_67 ( struct V_27 * V_35 , const struct V_13 * V_5 )
{
struct V_29 * V_30 = F_24 ( V_35 , struct V_29 , V_28 ) ;
struct V_16 * V_36 ;
unsigned V_4 , V_59 ;
...
for ( V_4 = 0 ; V_4 < F_6 ( V_5 ) ; V_4 ++ ) {
V_36 = F_26 ( V_30 -> V_11 , V_5 , V_4 ) ;
V_59 = F_14 ( V_30 -> V_11 , V_5 , V_4 ) ;
F_68 ( V_59 > 96 , V_30 ,
L_24 ,
V_59 , V_30 -> V_11 -> V_60 ) ;
F_68 ( V_59 && F_21 ( V_5 ) && F_12 ( V_5 ) ,
V_30 , L_25 ) ;
if ( V_59 )
return true ;
if ( F_38 ( V_30 -> V_11 ) &&
...
static T_3 F_69 ( struct V_13 * V_9 , struct V_13 * V_10 )
{
return ( V_9 -> V_26 [ F_6 ( V_9 ) ] + V_10 -> V_26 [ F_6 ( V_10 ) ] ) &
~ ( ( T_3 ) 1 << 63 ) ;
}
static bool F_70 ( struct V_27 * V_35 , struct V_13 * V_9 , struct V_13 * V_10 )
{
struct V_29 * V_30 = F_24 ( V_35 , struct V_29 , V_28 ) ;
unsigned V_4 ;
if ( F_71 ( V_30 -> V_11 ) )
...
if ( V_9 -> V_26 [ V_4 ] + F_72 ( 0 , F_12 ( V_9 ) , 0 ) != V_10 -> V_26 [ V_4 ] ||
F_9 ( V_30 -> V_11 , V_9 , V_4 ) != F_9 ( V_30 -> V_11 , V_10 , V_4 ) )
return false ;
if ( F_12 ( V_9 ) + F_12 ( V_10 ) > V_61 ) {
F_62 ( V_9 , F_40 ( V_9 ) + V_61 - F_12 ( V_9 ) ) ;
F_63 ( V_9 , V_61 ) ;
F_46 ( V_9 , V_10 ) ;
return false ;
}
if ( F_22 ( V_9 ) ) {
if ( F_22 ( V_10 ) )
V_9 -> V_26 [ F_6 ( V_9 ) ] = F_69 ( V_9 , V_10 ) ;
else
F_73 ( V_9 , 0 ) ;
}
F_62 ( V_9 , F_40 ( V_9 ) + F_12 ( V_10 ) ) ;
F_63 ( V_9 , F_12 ( V_9 ) + F_12 ( V_10 ) ) ;
return true ;
}
