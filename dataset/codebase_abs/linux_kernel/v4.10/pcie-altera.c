...
static int F_19 ( struct V_1 * V_2 , T_2 V_48 ,
...
static int F_21 ( struct V_9 * V_10 , unsigned int V_11 ,
int V_41 , int V_49 , T_1 * V_3 )
{
struct V_1 * V_2 = V_10 -> V_53 ;
if ( F_6 ( V_10 , V_11 , V_41 ) )
return V_54 ;
if ( ! F_9 ( V_2 , V_10 , F_22 ( V_11 ) ) ) {
* V_3 = 0xffffffff ;
return V_34 ;
}
return F_19 ( V_2 , V_10 -> V_23 , V_11 , V_41 , V_49 ,
V_3 ) ;
}
static int F_23 ( struct V_9 * V_10 , unsigned int V_11 ,
int V_41 , int V_49 , T_1 V_3 )
{
struct V_1 * V_2 = V_10 -> V_53 ;
if ( F_6 ( V_10 , V_11 , V_41 ) )
...
static int F_24 ( struct V_1 * V_2 , T_2 V_48 ,
unsigned int V_11 , int V_12 , T_3 * V_3 )
{
T_1 V_37 ;
int V_45 ;
V_45 = F_19 ( V_2 , V_48 , V_11 ,
...
V_59 = V_60 ;
for (; ; ) {
F_24 ( V_2 , V_2 -> V_24 , V_61 ,
V_62 , & V_58 ) ;
if ( ! ( V_58 & V_63 ) )
break;
if ( F_27 ( V_60 , V_59 + V_64 ) ) {
F_28 ( V_22 , L_1 ) ;
break;
}
F_12 ( 100 ) ;
...
if ( ! F_5 ( V_2 ) )
return;
F_24 ( V_2 , V_2 -> V_24 , V_61 , V_69 ,
& V_66 ) ;
if ( ( V_66 & V_70 ) <= V_71 )
return;
F_24 ( V_2 , V_2 -> V_24 , V_61 , V_62 ,
& V_67 ) ;
if ( ( V_67 & V_72 ) == V_73 ) {
F_24 ( V_2 , V_2 -> V_24 , V_61 ,
V_74 , & V_68 ) ;
...
static int F_30 ( struct V_76 * V_77 , unsigned int V_78 ,
T_4 V_79 )
{
F_31 ( V_78 , & V_80 , V_81 ) ;
F_32 ( V_78 , V_77 -> V_82 ) ;
...
& V_91 ) != 0 ) {
F_37 (bit, &status, INTX_NUM) {
F_1 ( V_2 , 1 << V_88 , V_90 ) ;
V_89 = F_38 ( V_2 -> V_76 , V_88 + 1 ) ;
if ( V_89 )
F_39 ( V_89 ) ;
else
F_28 ( V_22 , L_3 , V_88 ) ;
...
struct V_97 * V_98 ;
V_92 = F_42 ( V_95 , 0 , 0xff , & V_2 -> V_99 ,
NULL ) ;
if ( V_92 )
return V_92 ;
V_92 = F_43 ( V_22 , & V_2 -> V_99 ) ;
if ( V_92 )
goto V_100;
F_44 (win, &pcie->resources) {
...
struct V_101 * V_112 ;
V_112 = F_50 ( V_57 , V_103 , L_6 ) ;
V_2 -> V_5 = F_51 ( V_22 , V_112 ) ;
if ( F_52 ( V_2 -> V_5 ) )
return F_53 ( V_2 -> V_5 ) ;
V_2 -> V_78 = F_54 ( V_57 , 0 ) ;
if ( V_2 -> V_78 <= 0 ) {
F_28 ( V_22 , L_7 , V_2 -> V_78 ) ;
return - V_106 ;
}
F_55 ( V_2 -> V_78 , F_33 , V_2 ) ;
return 0 ;
}
...
static int F_57 ( struct V_111 * V_57 )
{
...
struct V_9 * V_113 ;
int V_45 ;
V_2 = F_58 ( V_22 , sizeof( * V_2 ) , V_114 ) ;
if ( ! V_2 )
return - V_110 ;
V_2 -> V_57 = V_57 ;
V_45 = F_49 ( V_2 ) ;
...
F_1 ( V_2 , V_115 , V_116 ) ;
F_56 ( V_2 ) ;
V_10 = F_60 ( V_22 , V_2 -> V_24 , & V_117 ,
V_2 , & V_2 -> V_99 ) ;
if ( ! V_10 )
return - V_110 ;
F_61 ( V_118 , V_119 ) ;
F_62 ( V_10 ) ;
F_63 (child, &bus->children, node)
F_64 ( V_113 ) ;
F_65 ( V_10 ) ;
return V_45 ;
}
