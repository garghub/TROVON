...
F_5 ( F_12 ( V_16 -> V_30 ) , V_18 -> V_29 + V_21 , V_22 ) ;
V_23 = 0 ;
V_26:
if ( ! F_13 ( V_16 , V_23 ) )
V_16 = F_7 ( V_14 ) ;
...
static T_5 F_14 ( struct V_31 * V_31 , T_5 V_21 , int V_32 )
{
T_5 V_33 ;
F_15 ( & V_34 ) ;
switch ( V_32 ) {
...
static T_6 F_17 ( struct V_31 * V_31 , char T_7 * V_8 ,
T_3 V_9 , T_5 * V_37 )
{
...
static T_6 F_19 ( struct V_31 * V_31 , const char T_7 * V_8 ,
T_3 V_42 , T_5 * V_37 )
{
return - V_43 ;
}
static int F_20 ( unsigned long V_44 )
{
unsigned long V_4 ;
V_4 = 0x20400000 ;
F_2 ( V_4 , 0xAAAAAAAA ) ;
...
static long F_23 ( struct V_31 * V_51 , unsigned int V_52 , unsigned long V_44 )
{
F_15 ( & V_34 ) ;
int error = - V_53 ;
...
static int F_25 ( struct V_31 * V_31 , struct V_63 * V_64 )
{
return - V_65 ;
}
static int F_26 ( struct V_66 * V_66 , struct V_31 * V_67 )
{
F_15 ( & V_34 ) ;
if ( V_58 . V_68 == 0 ) {
F_16 ( & V_34 ) ;
...
static int F_28 ( struct V_66 * V_66 , struct V_31 * V_31 )
{
V_58 . V_69 = 0 ;
return 0 ;
}
