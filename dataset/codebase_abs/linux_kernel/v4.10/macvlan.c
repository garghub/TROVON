...
{
if ( V_157 [ V_192 ] ) {
if ( F_167 ( V_157 [ V_192 ] ) != V_25 )
return - V_129 ;
if ( ! F_100 ( F_168 ( V_157 [ V_192 ] ) ) )
return - V_121 ;
}
if ( V_86 && V_86 [ V_193 ] &&
F_169 ( V_86 [ V_193 ] ) & ~ V_102 )
return - V_129 ;
if ( V_86 && V_86 [ V_194 ] ) {
switch ( F_170 ( V_86 [ V_194 ] ) ) {
case V_63 :
case V_64 :
case V_52 :
case V_65 :
...
if ( V_86 && V_86 [ V_201 ] ) {
if ( F_167 ( V_86 [ V_201 ] ) != V_25 )
return - V_129 ;
if ( ! F_100 ( F_168 ( V_86 [ V_201 ] ) ) )
return - V_121 ;
}
if ( V_86 && V_86 [ V_202 ] )
return - V_129 ;
...
if ( ! V_86 || ! V_86 [ V_206 ] )
return 0 ;
V_205 = F_168 ( V_86 [ V_206 ] ) ;
V_53 = F_167 ( V_86 [ V_206 ] ) ;
F_172 (nla, head, len, rem) {
if ( F_173 ( V_204 ) != V_201 ||
F_167 ( V_204 ) != V_25 )
continue;
V_1 = F_168 ( V_204 ) ;
V_71 = F_13 ( V_10 , V_1 ) ;
...
int F_174 ( struct V_207 * V_208 , struct V_5 * V_6 ,
...
if ( ! V_157 [ V_211 ] )
return - V_129 ;
V_88 = F_175 ( V_208 , F_170 ( V_157 [ V_211 ] ) ) ;
if ( V_88 == NULL )
return - V_212 ;
if ( F_176 ( V_88 ) )
V_88 = F_177 ( V_88 ) ;
...
V_10 -> V_41 = V_64 ;
if ( V_86 && V_86 [ V_194 ] )
V_10 -> V_41 = F_170 ( V_86 [ V_194 ] ) ;
if ( V_86 && V_86 [ V_193 ] )
V_10 -> V_72 = F_169 ( V_86 [ V_193 ] ) ;
if ( V_10 -> V_41 == V_65 ) {
if ( V_9 -> V_143 ) {
V_44 = - V_129 ;
goto V_215;
...
V_209 = F_170 ( V_86 [ V_196 ] ) ;
V_44 = F_171 ( V_10 , V_209 , V_86 ) ;
if ( V_44 )
goto V_215;
}
V_44 = F_182 ( V_6 ) ;
...
static int F_188 ( struct V_207 * V_208 , struct V_5 * V_6 ,
struct V_156 * V_157 [] , struct V_156 * V_86 [] )
{
return F_174 ( V_208 , V_6 , V_157 , V_86 ) ;
}
void F_189 ( struct V_5 * V_6 , struct V_218 * V_205 )
{
struct V_8 * V_10 = F_73 ( V_6 ) ;
if ( V_10 -> V_41 == V_195 )
F_59 ( V_10 -> V_9 , V_10 ) ;
...
return 0 ;
return F_195 ( 0 )
+ V_10 -> V_21 * F_195 ( sizeof( V_222 ) * V_25 ) ;
}
...
if ( V_14 -> V_10 != V_10 )
continue;
if ( F_198 ( V_27 , V_201 , V_25 , V_14 -> V_1 ) )
return 1 ;
}
return 0 ;
}
...
int V_43 ;
struct V_156 * V_223 ;
if ( F_200 ( V_27 , V_194 , V_10 -> V_41 ) )
goto V_224;
if ( F_201 ( V_27 , V_193 , V_10 -> V_72 ) )
goto V_224;
if ( F_200 ( V_27 , V_202 , V_10 -> V_21 ) )
goto V_224;
if ( V_10 -> V_21 > 0 ) {
V_223 = F_202 ( V_27 , V_206 ) ;
if ( V_223 == NULL )
goto V_224;
for ( V_43 = 0 ; V_43 < V_48 ; V_43 ++ ) {
...
int F_204 ( struct V_106 * V_226 )
{
V_226 -> V_227 = sizeof( struct V_8 ) ;
V_226 -> V_228 = F_166 ;
V_226 -> V_229 = V_230 ;
V_226 -> V_231 = V_232 ;
V_226 -> V_233 = F_193 ;
...
static struct V_207 * F_206 ( const struct V_5 * V_6 )
{
return F_69 ( F_177 ( V_6 ) ) ;
}
static int F_207 ( struct V_236 * V_237 ,
unsigned long V_238 , void * V_239 )
{
struct V_5 * V_6 = F_208 ( V_239 ) ;
struct V_8 * V_10 , * V_240 ;
struct V_4 * V_9 ;
F_209 ( V_241 ) ;
if ( ! F_179 ( V_6 ) )
return V_242 ;
...
V_10 -> V_6 -> V_106 -> V_252 ( V_10 -> V_6 , & V_241 ) ;
F_215 ( & V_241 ) ;
break;
case V_253 :
return V_248 ;
