...
return F_8 ( V_12 ) ;
V_7 = F_8 ( V_12 ) ;
if ( ! V_7 || ( V_7 -> V_28 & V_29 ) )
return NULL ;
V_7 -> V_28 |= V_29 ;
V_9 = F_1 ( V_12 -> V_3 ) ;
if ( ! V_9 )
return NULL ;
for ( V_26 = 0 ; V_26 < F_17 ( V_12 ) ; V_26 ++ ) {
struct V_30 * T_1 V_31 ;
V_7 = F_9 ( V_9 , NULL , V_26 ,
F_18 ( V_12 , V_26 ) ,
F_19 ( V_12 , V_26 ) ) ;
if ( ! V_7 ) {
F_11 ( & V_12 -> V_13 , L_2 ,
...
if ( V_7 -> V_16 != F_18 ( V_12 , V_26 ) ||
V_7 -> V_10 != F_19 ( V_12 , V_26 ) )
continue;
#ifdef F_20
T_1 = F_25 ( V_7 ) ;
if ( T_1 ) {
...
struct V_5 * V_6 )
{
const T_2 * type = F_30 ( V_6 , L_3 , NULL ) ;
const T_2 * V_37 ;
struct V_5 * V_9 ;
struct V_1 * V_7 ;
#ifdef F_20
...
V_7 -> V_43 = V_37 ? F_31 ( V_37 , 1 ) : 0 ;
V_7 -> V_44 = ( type && F_31 ( type , 1 ) == 1 ) ;
#ifdef F_20
T_1 = F_21 ( V_7 ) ;
if ( ! T_1 ) {
F_26 ( V_7 ) ;
...
static struct V_1 * F_38 ( struct V_1 * V_54 ,
struct V_1 * V_7 )
{
struct V_55 * V_56 = V_7 -> V_24 . V_56 ;
if ( V_56 != & V_7 -> V_24 )
return F_39 ( V_56 , struct V_1 , V_25 ) ;
while ( 1 ) {
if ( V_7 == V_54 )
return NULL ;
V_56 = V_7 -> V_25 . V_56 ;
...
void * F_40 ( struct V_1 * V_54 ,
void * (* F_37)( struct V_1 * , void * ) ,
void * V_38 )
{
struct V_1 * V_7 = V_54 ;
void * V_47 ;
for ( V_7 = F_38 ( V_54 , V_7 ) ; V_7 ;
V_7 = F_38 ( V_54 , V_7 ) ) {
V_47 = F_37 ( V_7 , V_38 ) ;
if ( V_47 )
return V_47 ;
