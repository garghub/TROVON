...
F_2 ( & V_5 -> V_8 -> V_2 . V_9 . V_10 . V_12 ) ;
F_3 ( V_7 -> V_13 , V_3 ) ;
F_4 ( & V_5 -> V_8 -> V_2 . V_9 . V_10 . V_12 ) ;
}
static int
F_5 ( struct V_1 * V_2 ,
struct V_14 * V_15 )
...
struct V_4 * V_5 = V_4 ( V_2 ) ;
struct V_6 * V_7 = V_5 -> V_8 -> V_2 . V_9 . V_10 . V_11 -> V_7 ;
T_1 V_16 = 0x80000000 | V_5 -> V_2 . V_17 << 24 ;
T_1 V_18 = V_15 -> V_18 ;
int V_19 ;
switch ( V_15 -> V_9 -> V_10 . V_20 ) {
case V_21 :
case V_22 : V_16 |= 0x00000000 ; break;
case V_23 : V_16 |= 0x00010000 ; break;
case V_24 : V_16 |= 0x00020000 ; break;
default:
F_6 ( 1 ) ;
return - V_25 ;
}
F_2 ( & V_5 -> V_8 -> V_2 . V_9 . V_10 . V_12 ) ;
V_19 = F_7 ( V_7 -> V_13 , V_15 , V_5 -> V_2 . V_17 , 4 ,
V_18 , V_16 ) ;
F_4 ( & V_5 -> V_8 -> V_2 . V_9 . V_10 . V_12 ) ;
return V_19 ;
}
...
F_10 ( V_11 , V_38 , 0 ) ;
V_17 = F_11 ( V_11 , V_39 ) & V_34 ;
if ( V_17 == V_5 -> V_2 . V_17 ) {
...
F_12 ( V_11 , V_54 , 1 << V_5 -> V_2 . V_17 , 0 ) ;
F_10 ( V_11 , V_38 , 1 ) ;
...
void * V_36 , T_1 V_58 , struct V_14 * * V_59 )
{
struct V_14 * V_60 = V_57 -> V_60 ;
union {
struct V_61 V_62 ;
} * args = V_36 ;
...
int V_63 = - V_64 ;
F_21 ( V_60 , L_1 , V_58 ) ;
if ( ! ( V_63 = F_22 ( V_63 , & V_36 , & V_58 , args -> V_62 , 0 , 0 , false ) ) ) {
F_21 ( V_60 , L_2
L_3 , args -> V_62 . V_65 ,
args -> V_62 . V_66 , args -> V_62 . V_67 ) ;
if ( ! args -> V_62 . V_66 )
return - V_25 ;
} else
return V_63 ;
if ( ! ( V_5 = F_23 ( sizeof( * V_5 ) , V_68 ) ) )
return - V_69 ;
* V_59 = & V_5 -> V_2 . V_15 ;
V_63 = F_24 ( & V_70 , & V_8 -> V_2 ,
0x1000 , 0x1000 , false , 0 , args -> V_62 . V_66 ,
( 1ULL << V_21 ) |
( 1ULL << V_23 ) |
( 1ULL << V_22 ) ,
...
if ( V_63 )
return V_63 ;
args -> V_62 . V_17 = V_5 -> V_2 . V_17 ;
V_5 -> V_30 = V_5 -> V_2 . V_17 * 32 ;
F_18 ( V_7 -> V_30 ) ;
F_14 ( V_7 -> V_30 , V_5 -> V_30 + 0x00 , args -> V_62 . V_67 ) ;
F_14 ( V_7 -> V_30 , V_5 -> V_30 + 0x04 , args -> V_62 . V_67 ) ;
F_14 ( V_7 -> V_30 , V_5 -> V_30 + 0x08 , V_5 -> V_2 . V_71 -> V_72 >> 4 ) ;
