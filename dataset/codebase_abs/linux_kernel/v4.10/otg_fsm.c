...
static enum V_48 F_36 ( struct V_49 * V_8 )
{
struct V_9 * V_10 = F_37 ( V_8 , struct V_9 , V_36 ) ;
T_3 V_50 , * V_51 ;
unsigned long V_38 ;
unsigned long V_26 ;
enum V_25 V_39 , V_40 = V_29 ;
...
{
F_39 ( & V_10 -> V_36 , V_56 , V_37 ) ;
V_10 -> V_36 . V_57 = F_36 ;
return 0 ;
}
static void F_40 ( struct V_58 * V_12 , enum V_25 V_8 )
{
...
static void F_41 ( struct V_58 * V_12 , enum V_25 V_8 )
{
struct V_9 * V_10 = F_37 ( V_12 , struct V_9 , V_12 ) ;
if ( V_8 < V_29 )
F_20 ( V_10 , V_8 ) ;
...
static void F_42 ( struct V_58 * V_12 , int V_59 )
{
int V_52 ;
struct V_9 * V_10 = F_37 ( V_12 , struct V_9 , V_12 ) ;
if ( V_59 ) {
F_43 ( V_10 , V_60 , V_61 | V_62 ,
V_62 ) ;
if ( V_10 -> V_63 -> V_64 ) {
V_52 = F_44 ( V_10 -> V_63 -> V_64 ) ;
if ( V_52 ) {
F_45 ( V_10 -> V_2 ,
L_2 ,
V_52 ) ;
...
static void F_47 ( struct V_58 * V_12 , int V_59 )
{
struct V_9 * V_10 = F_37 ( V_12 , struct V_9 , V_12 ) ;
if ( V_59 )
F_43 ( V_10 , V_67 , V_68 , V_68 ) ;
else
F_43 ( V_10 , V_67 , V_68 , 0 ) ;
}
static void F_48 ( struct V_58 * V_12 , int V_59 )
{
struct V_69 * V_70 ;
if ( ! V_12 -> V_17 -> V_71 )
return;
V_70 = F_49 ( V_12 -> V_17 -> V_71 -> V_72 , 1 ) ;
if ( ! V_70 )
return;
if ( V_59 ) {
F_50 ( V_70 ) ;
...
static void F_53 ( struct V_58 * V_12 )
{
struct V_9 * V_10 = F_37 ( V_12 , struct V_9 , V_12 ) ;
F_33 ( V_10 , V_73 , V_73 ) ;
F_54 ( V_10 -> V_2 ) ;
...
static int F_55 ( struct V_58 * V_12 , int V_59 )
{
struct V_9 * V_10 = F_37 ( V_12 , struct V_9 , V_12 ) ;
if ( V_59 ) {
F_56 ( V_10 ) ;
...
V_10 -> V_12 . V_44 = 1 ;
V_10 -> V_12 . V_77 = F_69 ( V_10 , V_107 ) ? 1 : 0 ;
V_10 -> V_12 . V_17 -> V_18 = V_118 ;
V_10 -> V_12 . V_119 = & V_120 ;
V_10 -> V_20 . V_121 = 1 ;
V_10 -> V_12 . V_122 = F_74 ( V_10 -> V_2 , 1 , V_123 ) ;
if ( ! V_10 -> V_12 . V_122 )
return - V_124 ;
F_75 ( & V_10 -> V_12 . V_15 ) ;
V_102 = F_38 ( V_10 ) ;
...
V_10 -> V_34 = 0 ;
V_10 -> V_35 = V_29 ;
V_102 = F_76 ( & V_10 -> V_2 -> V_125 , & V_126 ) ;
if ( V_102 < 0 ) {
F_77 ( V_10 -> V_2 ,
L_4 , V_102 ) ;
return V_102 ;
}
F_33 ( V_10 , V_127 , V_127 ) ;
if ( V_10 -> V_12 . V_77 ) {
V_10 -> V_12 . V_46 =
F_69 ( V_10 , V_87 ) ? 0 : 1 ;
V_10 -> V_12 . V_82 =
