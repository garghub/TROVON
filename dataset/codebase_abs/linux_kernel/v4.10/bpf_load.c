...
if ( V_22 < 0 )
return 1 ;
V_61 = F_23 ( V_22 , V_93 , NULL ) ;
if ( ! V_61 )
return 1 ;
if ( F_24 ( V_61 , & V_62 ) != & V_62 )
return 1 ;
V_54 = system ( L_24 ) ;
for ( V_54 = 1 ; V_54 < V_62 . V_94 ; V_54 ++ ) {
if ( F_12 ( V_61 , V_54 , & V_62 , & V_63 , & V_64 , & V_65 ) )
continue;
if ( 0 )
printf ( L_25 ,
V_54 , V_63 , V_65 -> V_95 , V_65 -> V_96 ,
V_64 . V_97 , ( int ) V_64 . V_98 ) ;
if ( strcmp ( V_63 , L_26 ) == 0 ) {
V_99 [ V_54 ] = true ;
memcpy ( V_39 , V_65 -> V_95 , V_65 -> V_96 ) ;
} else if ( strcmp ( V_63 , L_27 ) == 0 ) {
V_99 [ V_54 ] = true ;
if ( V_65 -> V_96 != sizeof( int ) ) {
printf ( L_28 ,
V_65 -> V_96 ) ;
return 1 ;
}
memcpy ( & V_40 , V_65 -> V_95 , sizeof( int ) ) ;
} else if ( strcmp ( V_63 , L_29 ) == 0 ) {
V_99 [ V_54 ] = true ;
if ( F_10 ( V_65 -> V_95 , V_65 -> V_96 ) )
return 1 ;
...
! ( V_88 . V_98 & V_106 ) )
continue;
V_103 = (struct V_7 * ) V_89 -> V_95 ;
V_99 [ V_64 . V_104 ] = true ;
V_99 [ V_54 ] = true ;
