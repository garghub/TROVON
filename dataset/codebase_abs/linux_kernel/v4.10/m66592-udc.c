...
V_240 = V_237 & V_238 ;
if ( V_240 ) {
T_1 V_241 = F_2 ( V_1 , V_190 ) ;
T_1 V_242 = F_2 ( V_1 , V_129 ) ;
T_1 V_243 = F_2 ( V_1 , V_244 ) ;
T_1 V_245 = F_2 ( V_1 , V_246 ) ;
if ( V_240 & V_247 ) {
F_6 ( V_1 , 0xffff & ~ V_247 ,
V_135 ) ;
F_60 ( V_1 ) ;
V_1 -> V_248 = F_2 ( V_1 , V_135 )
& V_249 ;
V_1 -> V_250 = V_251 ;
F_84 ( & V_1 -> V_252 ,
V_253 + F_85 ( 50 ) ) ;
...
if ( V_237 & V_225 )
F_80 ( V_1 ) ;
if ( ( V_237 & V_254 ) && ( V_238 & V_10 )
&& ( V_241 & V_243 ) ) {
F_70 ( V_1 , V_241 , V_243 ) ;
}
if ( ( V_237 & V_255 ) && ( V_238 & V_8 )
&& ( V_242 & V_245 ) ) {
F_71 ( V_1 , V_242 , V_245 ) ;
}
if ( V_237 & V_231 )
F_82 ( V_1 ) ;
}
...
static int F_89 ( struct V_258 * V_259 ,
const struct V_84 * V_85 )
{
struct V_45 * V_23 ;
V_23 = F_90 ( V_259 , struct V_45 , V_23 ) ;
return F_36 ( V_23 , V_85 ) ;
}
static int F_91 ( struct V_258 * V_259 )
{
struct V_45 * V_23 ;
struct V_121 * V_122 ;
unsigned long V_257 ;
...
V_122 = F_64 ( V_23 -> V_24 . V_176 , struct V_121 , V_24 ) ;
F_87 ( & V_23 -> V_1 -> V_17 , V_257 ) ;
F_47 ( V_23 , V_122 , - V_260 ) ;
F_88 ( & V_23 -> V_1 -> V_17 , V_257 ) ;
}
F_42 ( V_23 -> V_1 , V_23 -> V_4 ) ;
return F_38 ( V_23 ) ;
}
static struct V_261 * F_92 ( struct V_258 * V_259 ,
T_4 V_262 )
{
struct V_121 * V_122 ;
V_122 = F_93 ( sizeof( struct V_121 ) , V_262 ) ;
if ( ! V_122 )
return NULL ;
F_13 ( & V_122 -> V_24 ) ;
return & V_122 -> V_122 ;
}
static void F_94 ( struct V_258 * V_259 , struct V_261 * V_263 )
{
struct V_121 * V_122 ;
V_122 = F_90 ( V_263 , struct V_121 , V_122 ) ;
F_95 ( V_122 ) ;
}
static int F_75 ( struct V_258 * V_259 , struct V_261 * V_263 ,
T_4 V_262 )
{
struct V_45 * V_23 ;
struct V_121 * V_122 ;
...
static int F_97 ( struct V_258 * V_259 , struct V_261 * V_263 )
{
struct V_45 * V_23 ;
struct V_121 * V_122 ;
unsigned long V_257 ;
...
static int F_98 ( struct V_258 * V_259 , int V_266 )
{
struct V_45 * V_23 = F_90 ( V_259 , struct V_45 , V_23 ) ;
unsigned long V_257 ;
int V_33 = 0 ;
F_87 ( & V_23 -> V_1 -> V_17 , V_257 ) ;
if ( ! F_62 ( & V_23 -> V_24 ) ) {
...
static void F_99 ( struct V_258 * V_259 )
{
struct V_45 * V_23 ;
unsigned long V_257 ;
V_23 = F_90 ( V_259 , struct V_45 , V_23 ) ;
...
static int F_100 ( struct V_268 * V_269 ,
struct V_270 * V_21 )
{
struct V_1 * V_1 = F_101 ( V_269 ) ;
V_21 -> V_21 . V_271 = NULL ;
V_1 -> V_21 = V_21 ;
F_5 ( V_1 , V_272 | V_273 , V_7 ) ;
if ( F_2 ( V_1 , V_135 ) & V_249 ) {
F_60 ( V_1 ) ;
V_1 -> V_248 = F_2 ( V_1 ,
V_135 ) & V_249 ;
V_1 -> V_250 = V_251 ;
F_84 ( & V_1 -> V_252 , V_253 + F_85 ( 50 ) ) ;
}
return 0 ;
}
...
{
struct V_1 * V_1 = F_101 ( V_269 ) ;
F_4 ( V_1 , V_272 | V_273 , V_7 ) ;
F_56 ( V_1 ) ;
F_12 ( V_1 ) ;
V_1 -> V_21 = NULL ;
return 0 ;
}
static int F_103 ( struct V_268 * V_274 )
{
struct V_1 * V_1 = F_104 ( V_274 ) ;
return F_2 ( V_1 , V_275 ) & 0x03FF ;
}
static int F_105 ( struct V_268 * V_18 , int V_276 )
{
...
static int F_106 ( struct V_277 * V_278 )
{
struct V_1 * V_1 = F_107 ( V_278 ) ;
F_108 ( & V_1 -> V_18 ) ;
F_109 ( & V_1 -> V_252 ) ;
F_110 ( V_1 -> V_5 ) ;
F_111 ( F_112 ( V_278 , 0 ) , V_1 ) ;
...
static void F_115 ( struct V_258 * V_23 , struct V_261 * V_280 )
{
}
static int F_116 ( struct V_277 * V_278 )
{
...
int V_33 = 0 ;
int V_177 ;
V_282 = F_117 ( V_278 , V_285 , 0 ) ;
if ( ! V_282 ) {
V_33 = - V_112 ;
F_16 ( L_19 ) ;
goto V_286;
}
V_283 = F_117 ( V_278 , V_287 , 0 ) ;
if ( ! V_283 ) {
V_33 = - V_112 ;
F_118 ( & V_278 -> V_288 ,
L_20 ) ;
...
V_5 = F_119 ( V_282 -> V_289 , F_120 ( V_282 ) ) ;
if ( V_5 == NULL ) {
V_33 = - V_75 ;
F_16 ( L_21 ) ;
goto V_286;
}
if ( F_121 ( & V_278 -> V_288 ) == NULL ) {
F_118 ( & V_278 -> V_288 , L_22 ) ;
V_33 = - V_112 ;
goto V_286;
}
...
V_1 -> V_51 = F_121 ( & V_278 -> V_288 ) ;
V_1 -> V_160 = V_283 -> V_257 & V_290 ;
F_122 ( & V_1 -> V_17 ) ;
F_123 ( V_278 , V_1 ) ;
V_1 -> V_18 . V_291 = & V_292 ;
V_1 -> V_18 . V_293 = V_221 ;
V_1 -> V_18 . V_294 = V_295 ;
F_124 ( & V_1 -> V_252 ) ;
V_1 -> V_252 . V_296 = F_86 ;
V_1 -> V_252 . V_297 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
V_33 = F_125 ( V_283 -> V_289 , F_83 , V_298 ,
V_295 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_23 , V_33 ) ;
goto V_286;
...
if ( V_1 -> V_51 -> V_52 ) {
snprintf ( V_284 , sizeof( V_284 ) , L_24 , V_278 -> V_299 ) ;
V_1 -> V_279 = F_126 ( & V_278 -> V_288 , V_284 ) ;
if ( F_127 ( V_1 -> V_279 ) ) {
F_118 ( & V_278 -> V_288 , L_25 ,
V_284 ) ;
V_33 = F_128 ( V_1 -> V_279 ) ;
goto V_300;
}
F_129 ( V_1 -> V_279 ) ;
}
...
F_13 ( & V_1 -> V_18 . V_205 -> V_301 ) ;
for ( V_177 = 0 ; V_177 < V_29 ; V_177 ++ ) {
struct V_45 * V_23 = & V_1 -> V_23 [ V_177 ] ;
if ( V_177 != 0 ) {
F_13 ( & V_1 -> V_23 [ V_177 ] . V_23 . V_301 ) ;
F_96 ( & V_1 -> V_23 [ V_177 ] . V_23 . V_301 ,
& V_1 -> V_18 . V_301 ) ;
}
V_23 -> V_1 = V_1 ;
F_13 ( & V_23 -> V_24 ) ;
V_23 -> V_23 . V_294 = V_302 [ V_177 ] ;
V_23 -> V_23 . V_291 = & V_303 ;
F_130 ( & V_23 -> V_23 , 512 ) ;
if ( V_177 == 0 ) {
V_23 -> V_23 . V_304 . V_305 = true ;
} else {
V_23 -> V_23 . V_304 . V_306 = true ;
V_23 -> V_23 . V_304 . V_307 = true ;
V_23 -> V_23 . V_304 . V_308 = true ;
}
V_23 -> V_23 . V_304 . V_62 = true ;
V_23 -> V_23 . V_304 . V_309 = true ;
}
...
V_1 -> V_204 -> V_311 = F_115 ;
F_56 ( V_1 ) ;
V_33 = F_131 ( & V_278 -> V_288 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_312;
F_132 ( & V_278 -> V_288 , L_26 , V_313 ) ;
return 0 ;
V_312:
F_94 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_204 ) ;
V_310:
