...
V_25 -> V_42 -- ;
if ( ! V_25 -> V_42 )
F_15 ( & V_25 -> V_44 -> V_23 , V_25 -> V_43 , 4096 ,
V_46 ) ;
}
...
F_86 ( V_25 -> V_45 [ V_49 ] , V_180 , 4096 ) ;
V_180 += 4096 ;
}
return 0 ;
}
static int F_87 ( struct V_208 * V_23 )
{
struct V_211 * V_44 = F_88 ( V_23 ) ;
struct V_209 * V_134 = F_82 ( V_23 ) ;
struct V_24 * V_25 = V_134 -> V_56 ;
void T_2 * V_180 = V_25 -> V_180 ;
int V_49 ;
...
if ( F_89 ( V_44 -> V_22 , F_8 , V_212 ,
V_213 , V_25 ) ) {
F_61 ( & V_44 -> V_23 , L_6 , V_44 -> V_22 ) ;
goto error;
}
for ( V_49 = 0 ; V_49 < 4 ; V_49 ++ ) {
F_90 ( V_180 , V_25 -> V_45 [ V_49 ] , 4096 ) ;
V_180 += 4096 ;
}
...
int V_49 ;
for ( V_49 = 0 ; V_49 < V_176 ; V_49 ++ ) {
V_25 -> V_45 [ V_49 ] = F_94 ( 4096 , V_215 ) ;
if ( ! V_25 -> V_45 [ V_49 ] )
return - V_58 ;
}
memset ( V_25 -> V_45 [ 0 ] , 0 , 4096 ) ;
...
static int F_95 ( struct V_209 * V_134 ,
struct V_211 * V_44 )
{
struct V_24 * V_25 = V_134 -> V_56 ;
struct V_1 * V_1 ;
static struct V_216 V_169 = {
. V_217 = F_73 ,
} ;
int V_116 ;
int V_49 ;
...
V_116 = - V_183 ;
V_25 -> V_180 = F_103 ( F_101 ( V_44 , 1 ) , 0x4000 ) ;
if ( ! V_25 -> V_180 ) {
F_61 ( & V_44 -> V_23 , L_9 ) ;
goto V_220;
}
...
if ( V_116 )
goto V_220;
V_116 = F_89 ( V_44 -> V_22 , F_8 , V_212 , V_213 ,
V_25 ) ;
if ( V_116 ) {
F_61 ( & V_44 -> V_23 , L_11 , V_25 -> V_22 ) ;
goto V_220;
}
V_25 -> V_22 = V_44 -> V_22 ;
F_104 ( V_44 ) ;
...
V_1 = & V_25 -> V_34 [ V_49 ] ;
V_1 -> V_104 = V_49 ;
V_1 -> V_4 = F_105 ( V_25 -> V_180 , V_49 ) ;
V_1 -> V_64 = F_106 ( V_25 -> V_180 , V_49 ) ;
}
V_1 = & V_25 -> V_37 ;
V_1 -> V_8 = V_103 ;
V_1 -> V_104 = V_221 ;
V_1 -> V_4 = F_107 ( V_25 -> V_180 , V_1 -> V_104 ) ;
V_116 = F_108 ( V_134 , V_222 , V_25 , & V_169 ) ;
if ( V_116 )
goto V_220;
return 0 ;
V_220:
...
static int F_109 ( struct V_211 * V_44 ,
...
if ( ! V_186 )
V_186 = V_173 ;
V_116 = F_110 ( & V_44 -> V_23 , V_227 , V_228 , V_229 ,
sizeof( * V_25 ) , & V_134 ) ;
if ( V_116 < 0 )
goto V_218;
strcpy ( V_134 -> V_230 , L_1 ) ;
strcpy ( V_134 -> V_231 , L_1 ) ;
V_116 = F_95 ( V_134 , V_44 ) ;
if ( V_116 )
goto V_232;
V_25 = V_134 -> V_56 ;
V_116 = F_64 ( V_25 ) ;
...
if ( V_116 )
goto V_232;
snprintf ( V_134 -> V_233 , sizeof( V_134 -> V_233 ) ,
L_12 ,
V_134 -> V_231 , F_111 ( V_25 -> V_114 [ 0 ] ) ,
V_25 -> V_27 , V_25 -> V_22 ) ;
V_116 = F_112 ( V_134 ) ;
if ( V_116 )
goto V_232;
...
static void F_115 ( struct V_211 * V_44 )
{
F_114 ( F_116 ( V_44 ) ) ;
}
