...
V_5 -> V_126 = V_2 -> V_126 ;
V_5 -> V_132 = V_2 -> V_132 ;
F_79 ( V_2 -> V_84 , & V_5 -> V_133 ) ;
if ( V_2 -> V_37 == V_38 ) {
V_5 -> V_133 . V_134 = 0x02a1 ;
}
V_5 -> V_6 . V_135 = & V_2 -> V_51 -> V_6 ;
F_80 ( V_5 , V_2 ) ;
if ( V_2 -> V_37 != V_38 ) {
V_5 -> V_136 = F_72 ;
V_5 -> V_137 = F_73 ;
}
F_81 ( V_138 , V_5 -> V_139 ) ;
if ( ! ( V_2 -> V_7 & V_8 ) ) {
F_81 ( V_140 , V_5 -> V_139 ) ;
for ( V_65 = 0 ; V_141 [ V_65 ] >= 0 ; V_65 ++ )
F_74 ( V_5 , V_141 [ V_65 ] ) ;
}
for ( V_65 = 0 ; V_142 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_142 [ V_65 ] , V_5 -> V_143 ) ;
if ( V_2 -> V_37 == V_58 || V_2 -> V_37 == V_38 ||
V_2 -> V_37 == V_60 ) {
for ( V_65 = 0 ; V_144 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_144 [ V_65 ] , V_5 -> V_143 ) ;
} else {
for ( V_65 = 0 ; V_145 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_145 [ V_65 ] , V_5 -> V_143 ) ;
}
if ( V_2 -> V_7 & V_20 ) {
for ( V_65 = 0 ; V_146 [ V_65 ] >= 0 ; V_65 ++ )
F_81 ( V_146 [ V_65 ] , V_5 -> V_143 ) ;
}
if ( ! ( V_2 -> V_7 & V_20 ) ||
V_2 -> V_37 == V_38 ) {
...
F_81 ( V_148 [ V_65 ] , V_5 -> V_143 ) ;
} else {
for ( V_65 = 0 ; V_149 [ V_65 ] >= 0 ; V_65 ++ )
F_74 ( V_5 , V_149 [ V_65 ] ) ;
}
error = F_50 ( V_2 ) ;
if ( error )
...
static int F_85 ( struct V_79 * V_51 , const struct V_153 * V_133 )
{
struct V_154 * V_84 = F_86 ( V_51 ) ;
struct V_1 * V_2 ;
struct V_80 * V_155 ;
int V_156 ;
int V_65 , error ;
if ( V_51 -> V_91 -> V_93 . V_157 != 2 )
return - V_158 ;
for ( V_65 = 0 ; V_159 [ V_65 ] . V_160 ; V_65 ++ ) {
if ( ( F_87 ( V_84 -> V_161 . V_160 ) == V_159 [ V_65 ] . V_160 ) &&
( F_87 ( V_84 -> V_161 . V_162 ) == V_159 [ V_65 ] . V_162 ) )
break;
}
V_2 = F_58 ( sizeof( struct V_1 ) , V_86 ) ;
if ( ! V_2 )
return - V_88 ;
F_88 ( V_84 , V_2 -> V_132 , sizeof( V_2 -> V_132 ) ) ;
F_89 ( V_2 -> V_132 , L_9 , sizeof( V_2 -> V_132 ) ) ;
...
V_2 -> V_84 = V_84 ;
V_2 -> V_51 = V_51 ;
V_2 -> V_7 = V_159 [ V_65 ] . V_7 ;
V_2 -> V_37 = V_159 [ V_65 ] . V_37 ;
V_2 -> V_126 = V_159 [ V_65 ] . V_126 ;
F_90 ( & V_2 -> V_43 , F_7 ) ;
if ( V_2 -> V_37 == V_83 ) {
if ( V_51 -> V_91 -> V_93 . V_165 == V_166 ) {
if ( V_51 -> V_91 -> V_93 . V_167 == 129 )
V_2 -> V_37 = V_38 ;
else if ( V_51 -> V_91 -> V_93 . V_167 == 208 )
V_2 -> V_37 = V_60 ;
else
V_2 -> V_37 = V_58 ;
} else {
...
if ( error )
goto V_172;
V_156 = V_2 -> V_37 == V_60 ? 1 : 0 ;
V_155 = & V_51 -> V_91 -> V_92 [ V_156 ] . V_93 ;
F_37 ( V_2 -> V_129 , V_84 ,
F_91 ( V_84 , V_155 -> V_94 ) ,
V_2 -> V_59 , V_85 , F_22 ,
V_2 , V_155 -> V_95 ) ;
V_2 -> V_129 -> V_96 = V_2 -> V_163 ;
V_2 -> V_129 -> V_97 |= V_98 ;
F_92 ( V_51 , V_2 ) ;
if ( V_2 -> V_37 == V_38 ) {
error = F_69 ( V_2 ) ;
...
F_45 ( V_2 -> V_129 ) ;
V_164:
F_39 ( V_84 , V_85 , V_2 -> V_59 , V_2 -> V_163 ) ;
V_125:
F_62 ( V_2 ) ;
return error ;
}
static void F_93 ( struct V_79 * V_51 )
{
struct V_1 * V_2 = F_94 ( V_51 ) ;
if ( V_2 -> V_37 == V_38 )
F_70 ( V_2 ) ;
F_14 ( V_2 ) ;
F_40 ( V_2 ) ;
...
static int F_95 ( struct V_79 * V_51 , T_2 V_176 )
{
struct V_1 * V_2 = F_94 ( V_51 ) ;
struct V_5 * V_177 = V_2 -> V_6 ;
if ( V_2 -> V_37 == V_38 ) {
F_70 ( V_2 ) ;
if ( V_178 && V_2 -> V_44 )
F_68 ( V_2 ) ;
...
static int F_98 ( struct V_79 * V_51 )
{
struct V_1 * V_2 = F_94 ( V_51 ) ;
struct V_5 * V_177 = V_2 -> V_6 ;
int V_52 = 0 ;
