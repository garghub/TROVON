...
static unsigned short F_35 ( unsigned V_103 , unsigned V_104 )
{
const unsigned int V_105 = 4096 ;
const unsigned int V_106 = V_103 / 1000 ;
const unsigned int V_107 = V_104 / 1000 ;
const unsigned int V_108 = V_107 * V_106 ;
const unsigned int V_109 = V_108 / V_105 ;
F_36 ( V_109 == 0 ) ;
return V_109 ;
}
...
struct V_5 * V_6 = & V_4 -> V_6 ;
T_1 V_96 , V_97 , V_98 , V_116 ;
T_1 V_17 , V_82 , V_83 , V_117 ;
V_96 = ( F_13 ( V_37 ) & V_99 ) ?
0 : V_19 ;
V_97 = ( F_13 ( V_37 ) & V_42 ) ?
V_100 : 0 ;
...
V_17 = F_8 ( V_4 -> V_124 , V_125 ) |
V_96 | V_97 | V_98 |
V_126 | V_116 |
V_127 |
V_84 ;
V_82 = F_8 ( V_37 -> V_85 , V_86 ) ;
V_115 = F_38 ( V_39 -> V_50 ) ;
F_39 (sgl, sg, sg_len, i)
V_114 += V_45 -> V_128 ;
if ( V_114 != V_39 -> V_49 * V_39 -> V_50 )
V_49 = 1 ;
if ( F_40 ( V_6 ) ) {
V_17 |= F_8 ( V_114 , V_129 ) ;
V_82 |= F_8 ( V_115 , V_130 ) |
F_8 ( V_49 - 1 , V_131 ) ;
} else {
F_9 ( V_114 , V_6 -> V_13 + V_132 ) ;
F_9 ( F_8 ( V_115 , V_133 ) |
F_8 ( V_49 - 1 , V_134 ) ,
V_6 -> V_13 + V_135 ) ;
}
...
V_112 = F_35 ( V_6 -> V_137 , V_39 -> V_138 ) ;
V_117 = F_4 ( V_6 -> V_13 + F_10 ( V_6 ) ) ;
V_117 &= ~ ( V_139 ) ;
V_117 |= F_8 ( V_112 , V_29 ) ;
F_9 ( V_117 , V_6 -> V_13 + F_10 ( V_6 ) ) ;
V_6 -> V_76 [ 0 ] = V_17 ;
V_6 -> V_76 [ 1 ] = V_82 ;
V_6 -> V_76 [ 2 ] = V_83 ;
V_6 -> V_47 = V_91 ;
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
if ( V_146 -> V_124 == V_147 )
V_4 -> V_124 = 2 ;
else if ( V_146 -> V_124 == V_148 )
V_4 -> V_124 = 1 ;
else
V_4 -> V_124 = 0 ;
if ( V_146 -> clock )
