...
static int F_52 ( void * V_67 , T_1 V_17 , struct V_18 * V_19 )
{
void * V_68 ;
int V_69 ;
if ( ! V_17 )
...
return F_35 ( V_59 , V_60 , V_17 , V_68 , V_19 ) ;
}
static void F_56 ( struct V_46 * V_47 )
{
if ( V_47 -> V_73 )
F_57 ( ( unsigned long ) V_47 -> V_73 ) ;
V_47 -> V_73 = NULL ;
}
...
V_47 -> V_73 = (struct V_74 * ) F_59 ( V_14 ) ;
if ( ! V_47 -> V_73 ) {
V_69 = - V_15 ;
goto V_75;
}
...
static int F_61 ( struct V_46 * V_47 , void * V_67 ,
struct V_18 * V_19 )
{
int error = 0 ;
T_1 V_17 ;
...
return - V_70 ;
V_47 -> V_73 -> V_81 = V_17 ;
error = F_52 ( V_47 -> V_73 , V_47 -> V_76 , V_19 ) ;
if ( error )
goto V_82;
F_62 ( V_47 -> V_73 ) ;
V_47 -> V_76 = V_17 ;
...
return F_52 ( V_47 -> V_73 , V_47 -> V_76 , NULL ) ;
else
return - V_13 ;
}
...
if ( ! V_69 )
F_25 ( V_83 L_12 ) ;
F_69 ( V_9 , V_90 , V_86 , L_13 ) ;
return V_69 ;
}
static int F_70 ( void * V_91 )
{
struct V_92 * V_93 = V_91 ;
unsigned V_94 ;
while ( 1 ) {
F_44 ( V_93 -> V_95 , F_45 ( & V_93 -> V_96 ) ||
F_71 () ) ;
if ( F_71 () ) {
V_93 -> V_97 = NULL ;
F_22 ( & V_93 -> V_90 , 1 ) ;
...
F_22 ( & V_93 -> V_96 , 0 ) ;
V_93 -> V_69 = F_74 ( V_93 -> V_100 , V_93 -> V_101 ,
...
memset ( & V_91 [ V_97 ] , 0 , F_79 ( struct V_102 , V_95 ) ) ;
V_109 = F_80 ( sizeof( * V_109 ) , V_14 ) ;
if ( ! V_109 ) {
F_25 ( V_43 L_16 ) ;
V_69 = - V_15 ;
goto V_111;
}
memset ( V_109 , 0 , F_79 ( struct V_92 , V_95 ) ) ;
for ( V_97 = 0 ; V_97 < V_108 ; V_97 ++ ) {
F_23 ( & V_91 [ V_97 ] . V_95 ) ;
F_23 ( & V_91 [ V_97 ] . V_98 ) ;
V_91 [ V_97 ] . V_97 = F_81 ( F_73 ,
& V_91 [ V_97 ] ,
L_17 , V_97 ) ;
if ( F_82 ( V_91 [ V_97 ] . V_97 ) ) {
V_91 [ V_97 ] . V_97 = NULL ;
F_25 ( V_43
L_18 ) ;
V_69 = - V_15 ;
...
V_109 -> V_97 = F_81 ( F_70 , V_109 , L_19 ) ;
if ( F_82 ( V_109 -> V_97 ) ) {
V_109 -> V_97 = NULL ;
F_25 ( V_43 L_20 ) ;
V_69 = - V_15 ;
...
F_44 ( V_91 [ V_97 ] . V_98 ,
F_45 ( & V_91 [ V_97 ] . V_90 ) ) ;
F_22 ( & V_91 [ V_97 ] . V_90 , 0 ) ;
V_69 = V_91 [ V_97 ] . V_69 ;
if ( V_69 < 0 ) {
F_25 ( V_43 L_25 ) ;
goto V_113;
}
if ( F_83 ( ! V_91 [ V_97 ] . V_105 ||
V_91 [ V_97 ] . V_105 >
F_84 ( V_91 [ V_97 ] . V_101 ) ) ) {
F_25 ( V_43
L_26 ) ;
V_69 = - 1 ;
goto V_113;
...
V_69 = F_61 ( V_47 , V_24 , & V_19 ) ;
if ( V_69 )
goto V_113;
}
}
F_44 ( V_109 -> V_98 , F_45 ( & V_109 -> V_90 ) ) ;
F_22 ( & V_109 -> V_90 , 0 ) ;
}
V_113:
V_89 = F_43 ( & V_19 ) ;
...
static int F_87 ( unsigned int V_88 , unsigned int V_48 )
{
unsigned int V_114 = F_88 ( V_64 , 1 ) ;
unsigned int V_115 ;
F_89 ( L_27 , V_114 ) ;
V_115 = V_116 + V_88 ;
return V_114 > V_115 ;
...
V_118 = (struct V_117 * ) F_68 ( V_85 ) ;
error = F_61 ( & V_47 , V_118 , NULL ) ;
if ( ! error ) {
error = ( V_48 & V_120 ) ?
F_65 ( & V_47 , & V_85 , V_119 - 1 ) :
F_75 ( & V_47 , & V_85 , V_119 - 1 ) ;
}
V_113:
...
while ( V_47 -> V_123 ) {
if ( V_47 -> V_123 -> V_124 )
F_57 ( ( unsigned long ) V_47 -> V_123 -> V_124 ) ;
V_122 = V_47 -> V_123 ;
...
V_17 = V_51 -> V_55 ;
while ( V_17 ) {
V_122 = F_80 ( sizeof( * V_47 -> V_123 ) , V_14 ) ;
if ( ! V_122 ) {
F_92 ( V_47 ) ;
return - V_15 ;
}
...
error = F_35 ( V_49 , 0 , V_17 , V_122 -> V_124 , NULL ) ;
if ( error ) {
F_92 ( V_47 ) ;
return error ;
}
...
static int F_94 ( struct V_46 * V_47 , void * V_67 ,
struct V_18 * V_19 )
{
T_1 V_17 ;
int error ;
...
if ( ! V_17 )
return - V_44 ;
error = F_35 ( V_49 , 0 , V_17 , V_67 , V_19 ) ;
if ( error )
return error ;
if ( ++ V_47 -> V_78 >= V_80 ) {
V_47 -> V_78 = 0 ;
...
F_69 ( V_9 , V_90 , V_128 , L_33 ) ;
return V_69 ;
}
static int F_100 ( void * V_91 )
{
...
F_22 ( & V_93 -> V_96 , 0 ) ;
V_93 -> V_101 = V_112 ;
V_93 -> V_69 = F_101 ( V_93 -> V_103 + V_104 , V_93 -> V_105 ,
V_93 -> V_100 , & V_93 -> V_101 ) ;
if ( V_132 )
F_30 ( ( unsigned long ) V_93 -> V_100 ,
...
for ( V_97 = 0 ; V_97 < V_108 ; V_97 ++ )
memset ( & V_91 [ V_97 ] , 0 , F_79 ( struct V_131 , V_95 ) ) ;
V_109 = F_80 ( sizeof( * V_109 ) , V_14 ) ;
if ( ! V_109 ) {
F_25 ( V_43 L_16 ) ;
V_69 = - V_15 ;
...
if ( F_1 () > F_91 () )
V_141 = ( F_1 () - F_91 () ) / 2 ;
V_141 = F_77 ( V_141 , V_143 , V_142 ) ;
for ( V_94 = 0 ; V_94 < V_141 ; V_94 ++ ) {
V_24 [ V_94 ] = ( void * ) F_53 ( V_94 < V_144 ?
V_40 | V_41 :
V_40 | V_71 |
V_72 ) ;
if ( ! V_24 [ V_94 ] ) {
...
V_69 = F_94 ( V_47 , V_24 [ V_134 ] , & V_19 ) ;
if ( V_69 ) {
if ( V_47 -> V_73 &&
...
V_139 = F_103 ( V_91 [ V_97 ] . V_105 + V_104 ,
V_35 ) ;
if ( V_139 > V_137 ) {
if ( V_133 > 1 ) {
V_69 = - 1 ;
...
V_118 = (struct V_117 * ) F_68 ( V_85 ) ;
error = F_93 ( & V_47 , V_126 ) ;
if ( error )
goto V_11;
if ( ! error )
error = F_94 ( & V_47 , V_118 , NULL ) ;
if ( ! error ) {
error = ( * V_126 & V_120 ) ?
F_96 ( & V_47 , & V_85 , V_118 -> V_119 - 1 ) :
F_102 ( & V_47 , & V_85 , V_118 -> V_119 - 1 ) ;
}
F_95 ( & V_47 ) ;
V_11:
if ( ! error )
