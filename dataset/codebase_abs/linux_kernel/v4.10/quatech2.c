...
{
struct V_30 * V_31 = V_49 -> V_103 ;
switch ( V_101 ) {
case V_104 :
return F_34 ( V_31 ,
(struct V_87 T_3 * ) V_102 ) ;
default:
break;
}
return - V_105 ;
}
static void F_37 ( struct V_30 * V_31 , unsigned char * V_106 )
{
switch ( * V_106 ) {
case V_107 :
F_38 ( V_31 , V_106 + 1 ) ;
...
static void F_41 ( struct V_30 * V_31 , unsigned char * V_106 )
{
return;
}
static void F_42 ( struct V_110 * V_110 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 ;
struct V_30 * V_31 ;
...
V_2 = V_110 -> V_116 ;
V_4 = F_2 ( V_2 ) ;
V_31 = V_2 -> V_31 [ V_4 -> V_117 ] ;
V_27 = F_22 ( V_31 ) ;
for ( V_42 = 0 ; V_42 < V_110 -> V_114 ; V_42 ++ ) {
V_106 = ( unsigned char * ) V_110 -> V_115 + V_42 ;
if ( ( V_42 <= ( V_113 - 3 ) ) &&
( * V_106 == V_118 ) &&
( * ( V_106 + 1 ) == V_118 ) ) {
V_111 = false ;
...
static void F_51 ( struct V_110 * V_110 )
{
...
if ( ! V_27 -> V_133 )
goto V_130;
V_27 -> V_85 = F_54 ( 0 , V_78 ) ;
if ( ! V_27 -> V_85 )
goto V_135;
V_132 = V_2 -> V_31 [ 0 ] -> V_136 ;
F_55 ( V_27 -> V_85 , V_2 -> V_12 ,
F_62 ( V_2 -> V_12 , V_132 ) ,
V_27 -> V_133 ,
V_134 ,
F_47 , V_31 ) ;
...
static void F_39 ( struct V_30 * V_31 , unsigned char * V_106 )
{
struct V_26 * V_27 ;
T_2 V_152 = ( T_2 ) * V_106 ;
unsigned long V_75 ;
...
static void F_38 ( struct V_30 * V_31 , unsigned char * V_106 )
{
struct V_26 * V_27 ;
struct V_164 * V_155 ;
unsigned long V_75 ;
...
int V_137 ;
V_27 = F_22 ( V_31 ) ;
F_30 ( & V_27 -> V_124 , V_75 ) ;
if ( V_27 -> V_125 )
V_137 = 0 ;
else
V_137 = V_134 - V_175 ;
F_31 ( & V_27 -> V_124 , V_75 ) ;
return V_137 ;
}
...
V_85 -> V_180 = V_177 + V_175 ;
V_33 = F_52 ( V_85 , V_126 ) ;
if ( V_33 == 0 ) {
V_27 -> V_125 = true ;
V_178 += V_177 ;
}
