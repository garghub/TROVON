...
V_11 -> V_51 = L_5 ;
V_11 -> V_52 = V_6 -> V_52 ;
V_11 -> V_7 . V_53 = & V_6 -> V_7 ;
V_11 -> V_54 = F_16 ;
V_11 -> V_55 = F_19 ;
V_11 -> V_39 . V_56 = V_57 ;
V_11 -> V_39 . V_58 = 0x0001 ;
V_11 -> V_39 . V_59 = 0x0001 ;
V_11 -> V_39 . V_60 = 0x0100 ;
if ( V_41 -> V_61 )
F_31 ( V_62 , V_11 -> V_63 ) ;
for ( V_13 = 0 ; V_13 < V_41 -> V_46 ; V_13 ++ ) {
unsigned int type ;
V_2 -> V_20 [ V_13 ] = V_41 -> V_20 [ V_13 ] ;
type = ( V_41 -> V_20 [ V_13 ] . type ) ? : V_21 ;
F_32 ( V_11 , type , V_41 -> V_20 [ V_13 ] . V_24 ) ;
}
F_33 ( V_11 , V_2 ) ;
error = F_22 ( V_2 ) ;
if ( error )
...
if ( ! V_2 -> V_31 ) {
if ( V_41 -> V_64 )
V_2 -> V_32 = F_34 ( V_6 -> V_25 ) ;
else
V_2 -> V_32 = V_6 -> V_25 ;
error = F_35 ( V_2 -> V_32 , NULL ,
F_11 ,
V_65 |
V_66 ,
L_6 , V_2 ) ;
...
static int F_42 ( struct V_37 * V_6 )
{
...
static int F_45 ( struct V_68 * V_7 )
{
struct V_37 * V_6 = F_46 ( V_7 ) ;
struct V_1 * V_2 = F_43 ( V_6 ) ;
if ( F_47 ( V_7 ) )
F_48 ( V_2 -> V_32 ) ;
return 0 ;
}
static int F_49 ( struct V_68 * V_7 )
{
struct V_37 * V_6 = F_46 ( V_7 ) ;
struct V_1 * V_2 = F_43 ( V_6 ) ;
if ( F_47 ( V_7 ) )
