...
{
return ! ! ( F_1 ( F_24 ( V_33 ) , V_35 ) & F_7 ( V_18 ) ) ;
}
...
{
struct V_1 * V_2 ;
struct V_47 * V_48 [ 2 ] , * V_25 [ 2 ] ;
struct V_12 * V_12 ;
struct V_43 * V_43 ;
const char * V_49 = F_41 ( & V_46 -> V_50 ) ;
unsigned int V_51 ;
int V_52 ;
V_2 = F_42 ( & V_46 -> V_50 , sizeof( * V_2 ) , V_53 ) ;
if ( ! V_2 ) {
V_52 = - V_54 ;
goto V_55;
}
...
F_43 ( V_46 , V_2 ) ;
F_44 ( & V_2 -> V_22 ) ;
V_48 [ 0 ] = F_45 ( V_46 , V_56 , 0 ) ;
V_48 [ 1 ] = F_45 ( V_46 , V_56 , 1 ) ;
V_25 [ 0 ] = F_45 ( V_46 , V_57 , 0 ) ;
V_25 [ 1 ] = F_45 ( V_46 , V_57 , 1 ) ;
if ( ! V_48 [ 0 ] || ! V_48 [ 1 ] || ! V_25 [ 0 ] || ! V_25 [ 1 ] ) {
F_12 ( & V_46 -> V_50 , L_4 ) ;
V_52 = - V_14 ;
goto V_55;
}
V_2 -> V_5 = F_46 ( & V_46 -> V_50 , V_48 [ 0 ] -> V_58 ,
F_47 ( V_48 [ 0 ] ) ) ;
if ( ! V_2 -> V_5 ) {
F_12 ( & V_46 -> V_50 , L_5 ) ;
V_52 = - V_59 ;
...
V_2 -> V_6 = F_46 ( & V_46 -> V_50 , V_48 [ 1 ] -> V_58 ,
F_47 ( V_48 [ 1 ] ) ) ;
if ( ! V_2 -> V_6 ) {
F_12 ( & V_46 -> V_50 , L_6 ) ;
V_52 = - V_59 ;
...
if ( F_48 ( V_46 -> V_50 . V_60 , L_7 , & V_51 ) ) {
F_12 ( & V_46 -> V_50 , L_8 ) ;
V_52 = - V_14 ;
goto V_55;
}
V_12 = & V_2 -> V_12 ;
V_12 -> V_60 = V_46 -> V_50 . V_60 ;
V_12 -> V_61 = F_26 ;
V_12 -> V_62 = F_27 ;
V_12 -> V_63 = F_30 ;
V_12 -> V_64 = F_29 ;
...
V_43 -> V_75 = F_13 ;
V_43 -> V_20 = V_76 | V_77 ;
V_2 -> V_30 = F_49 ( V_46 -> V_50 . V_60 , V_51 , 0 ,
& V_78 , V_2 ) ;
if ( ! V_2 -> V_30 ) {
V_52 = - V_59 ;
F_12 ( & V_46 -> V_50 , L_9 ) ;
...
if ( F_50 ( & V_46 -> V_50 , V_25 [ 0 ] -> V_58 ,
F_20 , 0 , V_49 , V_2 ) ) {
F_12 ( & V_46 -> V_50 , L_10 ) ;
V_52 = - V_79 ;
goto V_80;
}
if ( F_50 ( & V_46 -> V_50 , V_25 [ 1 ] -> V_58 ,
F_20 , 0 , V_49 , V_2 ) ) {
F_12 ( & V_46 -> V_50 , L_11 ) ;
V_52 = - V_79 ;
goto V_80;
