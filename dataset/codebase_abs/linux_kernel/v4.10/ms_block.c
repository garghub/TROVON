...
T_8 V_279 = V_280 ;
unsigned long V_281 ;
if ( V_52 -> V_282 . V_283 && * ( V_52 -> V_282 . V_283 ) )
V_279 = * ( V_52 -> V_282 . V_283 ) ;
F_110 ( & V_260 ) ;
...
V_23 -> V_251 -> V_275 = V_44 ;
F_133 ( V_23 -> V_251 , F_118 ) ;
F_134 ( V_23 -> V_251 , V_279 ) ;
F_135 ( V_23 -> V_251 , V_286 ) ;
F_136 ( V_23 -> V_251 , V_287 ) ;
F_137 ( V_23 -> V_251 ,
V_286 * V_23 -> V_102 ) ;
F_138 ( V_23 -> V_251 , V_23 -> V_102 ) ;
sprintf ( V_23 -> V_257 -> V_288 , L_97 , V_23 -> V_263 ) ;
V_23 -> V_257 -> V_289 = & V_290 ;
V_23 -> V_257 -> V_259 = V_23 ;
V_23 -> V_257 -> V_251 = V_23 -> V_251 ;
V_23 -> V_257 -> V_164 |= V_291 ;
V_281 = V_23 -> V_116 * V_23 -> V_172 ;
V_281 *= ( V_23 -> V_102 / 512 ) ;
F_139 ( V_23 -> V_257 , V_281 ) ;
F_40 ( L_98 , V_281 ) ;
V_23 -> V_261 = 1 ;
V_23 -> V_219 = F_140 ( L_99 , V_292 ) ;
F_141 ( & V_23 -> V_220 , F_98 ) ;
F_41 ( V_23 -> V_249 , V_287 + 1 ) ;
if ( V_23 -> V_31 )
F_142 ( V_23 -> V_257 , 1 ) ;
F_127 ( V_44 ) ;
F_143 ( & V_44 -> V_282 , V_23 -> V_257 ) ;
F_40 ( L_100 ) ;
return 0 ;
V_285:
F_115 ( V_23 -> V_257 ) ;
...
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_22 * V_297 = NULL ;
bool V_276 = true ;
#ifndef F_152
V_23 -> V_276 = true ;
return 0 ;
#endif
F_110 ( & V_44 -> V_52 -> V_298 ) ;
V_297 = F_77 ( sizeof( struct V_22 ) , V_201 ) ;
if ( ! V_297 )
goto V_9;
V_297 -> V_44 = V_44 ;
F_145 ( V_44 , V_297 ) ;
...
if ( F_95 ( V_44 ) )
goto V_9;
if ( V_23 -> V_170 != V_297 -> V_170 )
goto V_9;
if ( memcmp ( V_23 -> V_200 , V_297 -> V_200 ,
sizeof( struct V_181 ) ) )
goto V_9;
if ( V_23 -> V_172 != V_297 -> V_172 ||
memcmp ( V_23 -> V_179 , V_297 -> V_179 ,
V_23 -> V_172 ) )
goto V_9;
if ( V_23 -> V_29 != V_297 -> V_29 ||
memcmp ( V_23 -> V_30 , V_297 -> V_30 ,
V_23 -> V_29 / 8 ) )
goto V_9;
V_276 = false ;
V_9:
...
F_127 ( V_44 ) ;
F_111 ( & V_44 -> V_52 -> V_298 ) ;
return 0 ;
}
static int T_10 F_153 ( void )
{
int V_278 = F_154 ( & V_299 ) ;
if ( V_278 )
F_17 ( L_103 , V_278 ) ;
return V_278 ;
}
