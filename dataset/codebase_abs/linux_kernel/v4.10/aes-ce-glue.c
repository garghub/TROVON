...
V_30 = ( V_32 <= 8 ) ? - 1 : 1 ;
F_27 ( V_40 , V_42 , ( T_1 * ) V_2 -> V_9 ,
F_1 ( V_2 ) , V_30 , V_29 . V_38 ) ;
memcpy ( V_41 , V_40 , V_32 ) ;
V_31 = F_19 ( & V_29 , 0 ) ;
}
F_9 () ;
return V_31 ;
...
F_29 ( V_29 . V_34 . V_35 . V_36 , V_29 . V_37 . V_35 . V_36 ,
...
F_3 () ;
for ( V_43 = 1 ; ( V_30 = ( V_29 . V_32 / V_33 ) ) ; V_43 = 0 ) {
F_31 ( V_29 . V_34 . V_35 . V_36 , V_29 . V_37 . V_35 . V_36 ,
...
{
int V_11 ;
for ( V_11 = 0 ; V_11 < F_33 ( V_45 ) && V_45 [ V_11 ] ; V_11 ++ )
F_34 ( V_45 [ V_11 ] ) ;
F_35 ( V_46 , F_33 ( V_46 ) ) ;
}
...
if ( ! ( V_52 & V_53 ) )
return - V_54 ;
V_31 = F_37 ( V_46 , F_33 ( V_46 ) ) ;
if ( V_31 )
return V_31 ;
for ( V_11 = 0 ; V_11 < F_33 ( V_46 ) ; V_11 ++ ) {
V_50 = V_46 [ V_11 ] . V_55 . V_56 + 2 ;
V_51 = V_46 [ V_11 ] . V_55 . V_57 + 2 ;
V_49 = V_46 [ V_11 ] . V_55 . V_57 ;
V_48 = F_38 ( V_50 , V_51 , V_49 ) ;
V_31 = F_39 ( V_48 ) ;
if ( F_40 ( V_48 ) )
goto V_58;
V_45 [ V_11 ] = V_48 ;
