...
} else if ( F_27 ( V_111 , V_117 ) > 0 ) {
F_23 ( & V_2 -> V_44 -> V_45 , L_18 ) ;
V_2 -> V_107 . V_113 = true ;
V_2 -> V_107 . V_115 = V_118 ;
} else if ( F_27 ( V_111 , V_119 ) > 0 ) {
...
struct V_110 * V_111 = V_2 -> V_81 . V_107 ;
int V_128 = F_27 ( V_111 , V_129 ) ;
F_23 ( & V_2 -> V_44 -> V_45 , L_25 ,
V_128 ? L_26 : L_27 ) ;
V_2 -> V_81 . V_82 = V_128 ;
F_29 ( & V_2 -> V_81 . V_106 ) ;
return V_126 ;
...
F_18 ( & V_2 -> V_44 -> V_45 , L_28 ,
V_141 , V_5 ) ;
V_2 -> V_7 = V_2 -> V_143 -> V_7 ;
V_2 -> V_78 = V_2 -> V_143 -> V_78 ;
V_5 = F_5 ( V_2 -> V_10 , V_11 , & V_25 ) ;
if ( V_5 < 0 ) {
V_2 -> V_3 = V_2 -> V_143 -> V_144 ;
V_2 -> V_13 = V_2 -> V_143 -> V_145 ;
} else {
V_13 = ( V_25 & V_23 ) >> V_22 ;
switch ( V_13 ) {
case V_15 :
...
V_3 = ( V_3 * V_8 ) + V_6 ;
V_2 -> V_3 = V_3 ;
V_3 = F_16 ( V_2 -> V_143 -> V_144 , V_2 -> V_7 ) ;
V_13 = F_16 ( V_2 -> V_143 -> V_145 , V_2 -> V_78 ) ;
V_5 = F_1 ( V_2 , V_3 ) ;
if ( V_5 < 0 )
F_18 ( & V_2 -> V_44 -> V_45 ,
L_29 , V_5 ) ;
...
static int F_33 ( struct V_147 * V_44 )
{
int V_5 , V_90 , V_148 ;
struct V_1 * V_2 ;
struct V_149 * V_150 = F_34 ( V_44 -> V_45 . V_151 ) ;
struct V_152 V_153 = {} ;
V_2 = F_35 ( & V_44 -> V_45 , sizeof( * V_2 ) , V_154 ) ;
if ( ! V_2 )
return - V_155 ;
V_2 -> V_44 = V_44 ;
V_2 -> V_10 = V_150 -> V_10 ;
V_2 -> V_156 = V_150 -> V_156 ;
V_2 -> V_143 = V_44 -> V_45 . V_157 ;
if ( ! V_2 -> V_143 ) {
if ( ! F_36 ( & V_44 -> V_45 ,
L_31 ) )
F_7 ( & V_44 -> V_45 , L_32 ) ;
...
V_2 -> V_107 . V_123 . V_161 = F_28 ;
V_5 = F_39 ( V_2 -> V_107 . V_111 , V_114 ,
& V_2 -> V_107 . V_123 ) ;
if ( V_5 ) {
F_7 ( & V_2 -> V_44 -> V_45 ,
L_34 , V_5 ) ;
...
V_5 = F_39 ( V_2 -> V_107 . V_111 , V_117 ,
& V_2 -> V_107 . V_123 ) ;
if ( V_5 ) {
F_7 ( & V_2 -> V_44 -> V_45 ,
L_35 , V_5 ) ;
F_40 ( V_2 -> V_107 . V_111 ,
V_114 , & V_2 -> V_107 . V_123 ) ;
return V_5 ;
}
V_5 = F_39 ( V_2 -> V_107 . V_111 , V_119 ,
& V_2 -> V_107 . V_123 ) ;
if ( V_5 ) {
F_7 ( & V_2 -> V_44 -> V_45 ,
L_36 , V_5 ) ;
...
V_114 , & V_2 -> V_107 . V_123 ) ;
F_40 ( V_2 -> V_107 . V_111 ,
V_117 , & V_2 -> V_107 . V_123 ) ;
return V_5 ;
}
F_41 ( V_44 , V_2 ) ;
F_42 ( & V_2 -> V_74 ) ;
V_153 . V_162 = V_2 ;
V_2 -> V_103 = F_43 ( & V_44 -> V_45 , & V_163 ,
& V_153 ) ;
if ( F_44 ( V_2 -> V_103 ) ) {
F_7 ( & V_44 -> V_45 , L_37 ) ;
V_5 = F_45 ( V_2 -> V_103 ) ;
...
V_2 -> V_81 . V_127 . V_161 = F_31 ;
V_5 = F_39 ( V_2 -> V_81 . V_107 , V_129 ,
& V_2 -> V_81 . V_127 ) ;
if ( V_5 )
F_18 ( & V_44 -> V_45 , L_38 ) ;
if ( V_2 -> V_81 . V_107 )
V_2 -> V_81 . V_82 = F_27 (
V_2 -> V_81 . V_107 , V_129 ) ;
for ( V_90 = 0 ; V_90 < V_91 ; V_90 ++ ) {
V_148 = F_46 ( V_2 -> V_44 , V_90 ) ;
V_2 -> V_89 [ V_90 ] = F_47 ( V_2 -> V_156 , V_148 ) ;
if ( V_2 -> V_89 [ V_90 ] < 0 ) {
F_18 ( & V_2 -> V_44 -> V_45 ,
L_39 , V_148 ) ;
V_5 = V_2 -> V_89 [ V_90 ] ;
...
V_165:
if ( V_2 -> V_81 . V_107 )
F_40 ( V_2 -> V_81 . V_107 , V_129 ,
& V_2 -> V_81 . V_127 ) ;
F_49 ( V_2 -> V_103 ) ;
V_164:
F_40 ( V_2 -> V_107 . V_111 , V_114 ,
& V_2 -> V_107 . V_123 ) ;
F_40 ( V_2 -> V_107 . V_111 , V_117 ,
& V_2 -> V_107 . V_123 ) ;
F_40 ( V_2 -> V_107 . V_111 , V_119 ,
& V_2 -> V_107 . V_123 ) ;
return V_5 ;
}
static int F_50 ( struct V_147 * V_44 )
{
