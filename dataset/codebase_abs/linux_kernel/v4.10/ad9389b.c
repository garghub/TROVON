...
{
F_12 ( 1 , V_20 , V_3 , L_61 , V_14 , ( V_37 ? L_62 : L_63 ) ) ;
...
struct V_1 * V_19 = F_1 ( V_3 ) ;
F_12 ( 1 , V_20 , V_3 , L_2 , V_14 ) ;
if ( ! F_35 ( V_87 , & V_88 , NULL , NULL ) )
return - V_46 ;
F_36 ( V_87 , & V_88 , 0 , NULL , NULL ) ;
V_87 -> V_40 . V_41 &= ~ V_89 ;
V_19 -> V_39 = * V_87 ;
F_19 ( V_3 , V_19 -> V_52 ) ;
if ( V_19 -> V_74 . V_90 == V_91 )
F_20 ( V_3 , ( T_3 ) V_87 -> V_40 . V_47 ) ;
F_18 ( V_3 ) ;
return 0 ;
}
...
static int F_41 ( struct V_2 * V_3 , struct V_96 * V_56 )
{
struct V_1 * V_19 = F_1 ( V_3 ) ;
if ( V_56 -> V_93 != 0 )
return - V_46 ;
...
return - V_46 ;
if ( ! V_19 -> V_56 . V_62 ) {
F_12 ( 1 , V_20 , V_3 , L_64 ) ;
return - V_97 ;
}
if ( V_56 -> V_98 >= V_19 -> V_56 . V_62 * 2 )
return - V_99 ;
if ( V_56 -> V_63 + V_56 -> V_98 >= V_19 -> V_56 . V_62 * 2 )
V_56 -> V_63 = V_19 -> V_56 . V_62 * 2 - V_56 -> V_98 ;
memcpy ( V_56 -> V_56 , & V_19 -> V_56 . V_100 [ V_56 -> V_98 * 128 ] ,
128 * V_56 -> V_63 ) ;
return 0 ;
}
...
static int F_43 ( struct V_2 * V_3 , T_3 V_101 )
{
T_3 V_66 ;
switch ( V_101 ) {
...
static int F_44 ( struct V_2 * V_3 , T_3 V_101 )
{
T_3 V_102 ;
switch ( V_101 ) {
case 32000 : V_102 = 0x30 ; break;
case 44100 : V_102 = 0x00 ; break;
case 48000 : V_102 = 0x20 ; break;
case 88200 : V_102 = 0x80 ; break;
case 96000 : V_102 = 0xa0 ; break;
case 176400 : V_102 = 0xc0 ; break;
case 192000 : V_102 = 0xe0 ; break;
default:
return - V_46 ;
}
F_10 ( V_3 , 0x15 , 0xf , V_102 ) ;
return 0 ;
}
static int F_45 ( struct V_2 * V_3 , T_3 V_103 , T_3 V_104 , T_3 V_105 )
{
...
static void F_46 ( int V_106 , int V_20 , struct V_2 * V_3 ,
int V_107 , T_1 * V_18 )
{
int V_13 , V_108 ;
if ( V_20 < V_106 )
return;
F_12 ( V_106 , V_20 , V_3 , L_65 , V_107 ) ;
for ( V_13 = 0 ; V_13 < 256 ; V_13 += 16 ) {
T_1 V_109 [ 128 ] ;
T_1 * V_110 = V_109 ;
if ( V_13 == 128 )
F_12 ( V_106 , V_20 , V_3 , L_66 ) ;
for ( V_108 = V_13 ; V_108 < V_13 + 16 ; V_108 ++ ) {
sprintf ( V_110 , L_67 , V_18 [ V_108 ] ) ;
V_110 += 6 ;
}
V_110 [ 0 ] = '\0' ;
F_12 ( V_106 , V_20 , V_3 , L_68 , V_109 ) ;
}
}
static void F_47 ( struct V_111 * V_112 )
{
struct V_113 * V_114 = F_48 ( V_112 ) ;
struct V_1 * V_19 =
F_2 ( V_114 , struct V_1 , V_115 ) ;
...
F_27 ( V_3 , false ) ;
F_27 ( V_3 , true ) ;
F_49 ( & V_19 -> V_115 , V_119 ) ;
return;
}
}
V_117 . V_120 = false ;
V_117 . V_107 = F_4 ( V_3 , 0xc4 ) ;
F_50 ( V_3 , V_121 , ( void * ) & V_117 ) ;
...
struct V_122 V_123 ;
struct V_1 * V_19 = F_1 ( V_3 ) ;
V_123 . V_120 = V_19 -> V_124 ;
F_50 ( V_3 , V_125 , ( void * ) & V_123 ) ;
}
...
F_56 ( V_19 -> V_127 , F_13 ( V_3 ) ? 0x1 : 0x0 ) ;
F_56 ( V_19 -> V_128 , F_14 ( V_3 ) ? 0x1 : 0x0 ) ;
F_56 ( V_19 -> V_129 , V_19 -> V_56 . V_62 ? 0x1 : 0x0 ) ;
F_21 ( V_19 -> V_52 ) ;
F_21 ( V_19 -> V_50 ) ;
}
...
F_12 ( 1 , V_20 , V_3 , L_79 , V_14 , V_130 ) ;
F_54 ( V_3 ) ;
F_57 ( & V_19 -> V_115 ) ;
memset ( & V_19 -> V_56 , 0 , sizeof( struct V_55 ) ) ;
F_27 ( V_3 , false ) ;
...
static bool F_59 ( struct V_2 * V_3 , T_3 V_107 )
{
struct V_1 * V_19 = F_1 ( V_3 ) ;
T_3 V_63 = V_19 -> V_56 . V_63 ;
T_1 * V_100 = V_19 -> V_56 . V_100 ;
if ( F_58 ( & V_100 [ V_107 * 256 ] ) ) {
if ( ( V_107 + 1 ) * 2 <= V_63 )
return F_58 ( & V_100 [ V_107 * 256 + 128 ] ) ;
return true ;
}
return false ;
}
static bool F_60 ( struct V_2 * V_3 , T_3 V_107 )
{
...
if ( V_107 )
return true ;
for ( V_13 = 0 ; V_13 < F_61 ( V_133 ) ; V_13 ++ )
if ( V_100 [ V_13 ] != V_133 [ V_13 ] )
return false ;
return true ;
}
...
F_12 ( 1 , V_20 , V_3 , L_82 , V_14 , V_107 ) ;
F_11 ( V_3 , 256 , & V_19 -> V_56 . V_100 [ V_107 * 256 ] ) ;
F_46 ( 2 , V_20 , V_3 , V_107 ,
& V_19 -> V_56 . V_100 [ V_107 * 256 ] ) ;
if ( V_107 == 0 ) {
V_19 -> V_56 . V_63 = V_19 -> V_56 . V_100 [ 0x7e ] + 1 ;
...
V_19 -> V_56 . V_62 = V_107 + 1 ;
if ( ( ( V_19 -> V_56 . V_100 [ 0x7e ] >> 1 ) + 1 ) > V_19 -> V_56 . V_62 ) {
...
static int F_63 ( struct V_9 * V_10 , const struct V_137 * V_49 )
{
const struct V_86 V_138 = V_139 ;
struct V_1 * V_19 ;
struct V_73 * V_74 = V_10 -> V_140 . V_141 ;
struct V_142 * V_7 ;
struct V_2 * V_3 ;
int V_143 = - V_144 ;
if ( ! F_64 ( V_10 -> V_145 , V_146 ) )
return - V_144 ;
F_65 ( 1 , V_20 , V_10 , L_86 ,
V_10 -> V_147 << 1 ) ;
V_19 = F_66 ( & V_10 -> V_140 , sizeof( * V_19 ) , V_148 ) ;
if ( ! V_19 )
return - V_149 ;
if ( V_74 == NULL ) {
F_67 ( V_10 , L_87 ) ;
...
V_7 = & V_19 -> V_7 ;
F_69 ( V_7 , 5 ) ;
V_19 -> V_50 = F_70 ( V_7 , & V_153 ,
V_154 , V_51 ,
0 , V_155 ) ;
V_19 -> V_127 = F_71 ( V_7 , NULL ,
V_156 , 0 , 1 , 0 , 0 ) ;
V_19 -> V_128 = F_71 ( V_7 , NULL ,
V_157 , 0 , 1 , 0 , 0 ) ;
...
V_19 -> V_93 . V_41 = V_162 ;
V_143 = F_72 ( & V_3 -> V_163 , 1 , & V_19 -> V_93 ) ;
if ( V_143 )
goto V_161;
...
V_19 -> V_21 = F_73 ( V_10 -> V_145 , ( 0x7e >> 1 ) ) ;
if ( V_19 -> V_21 == NULL ) {
F_9 ( V_3 , L_90 ) ;
V_143 = - V_149 ;
goto V_164;
}
F_74 ( & V_19 -> V_115 , F_47 ) ;
V_19 -> V_39 = V_138 ;
F_62 ( V_3 ) ;
F_29 ( V_3 , true ) ;
F_25 ( V_3 , L_91 , V_10 -> V_71 ,
V_10 -> V_147 << 1 , V_10 -> V_145 -> V_71 ) ;
return 0 ;
V_164:
F_75 ( & V_3 -> V_163 ) ;
V_161:
...
{
struct V_2 * V_3 = F_78 ( V_10 ) ;
struct V_1 * V_19 = F_1 ( V_3 ) ;
V_19 -> V_60 = - 1 ;
F_12 ( 1 , V_20 , V_3 , L_92 , V_10 -> V_71 ,
V_10 -> V_147 << 1 , V_10 -> V_145 -> V_71 ) ;
F_33 ( V_3 , false ) ;
F_42 ( V_3 , false ) ;
F_62 ( V_3 ) ;
