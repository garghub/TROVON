...
if ( V_12 -> V_21 * 4 > 4096 )
return - V_40 ;
V_10 = F_19 ( sizeof( * V_10 ) , V_43 ) ;
if ( ! V_10 )
return - V_44 ;
V_14 = F_20 ( V_3 -> V_4 , 4096 ) ;
if ( F_21 ( V_14 ) ) {
V_20 = F_22 ( V_14 ) ;
goto V_45;
}
V_10 -> V_15 = F_23 ( V_14 , & V_3 -> V_4 -> V_46 . V_47 , NULL ) ;
if ( F_21 ( V_10 -> V_15 ) ) {
V_20 = F_22 ( V_10 -> V_15 ) ;
goto V_48;
}
...
struct V_9 * V_10 ;
int V_20 ;
F_27 ( & V_51 -> V_4 -> V_52 . V_53 ) ;
V_10 = V_51 -> V_3 -> V_49 ;
if ( ! V_10 )
return 0 ;
if ( ! V_10 -> V_15 -> V_14 -> V_54 . V_55 )
V_10 -> V_29 = - 1 ;
V_20 = F_28 ( V_10 -> V_15 , 0 , 0 , V_56 | V_57 ) ;
if ( V_20 )
return V_20 ;
if ( V_10 -> V_15 -> V_26 . V_27 != V_10 -> V_29 ) {
V_20 = F_3 ( V_10 , V_51 -> V_4 ) ;
if ( V_20 )
goto V_58;
}
V_20 = V_51 -> V_3 -> V_59 ( V_51 ,
V_10 -> V_29 , V_10 -> V_30 ,
V_60 ) ;
if ( V_20 )
goto V_58;
