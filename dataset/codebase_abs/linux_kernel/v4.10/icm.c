...
V_46 -> V_14 [ V_5 ] = F_22 ( V_2 , V_50 >> V_54 ,
( V_46 -> V_55 ? V_48 : V_56 ) |
V_29 , V_46 -> V_15 ) ;
if ( ! V_46 -> V_14 [ V_5 ] ) {
V_27 = - V_22 ;
...
T_3 V_5 ;
T_2 V_57 ;
V_5 = ( V_47 & ( V_46 -> V_49 - 1 ) ) / ( V_50 / V_46 -> V_51 ) ;
F_37 ( & V_46 -> V_52 ) ;
...
return NULL ;
F_37 ( & V_46 -> V_52 ) ;
V_61 = ( T_2 ) ( V_47 & ( V_46 -> V_49 - 1 ) ) * V_46 -> V_51 ;
V_14 = V_46 -> V_14 [ V_61 / V_50 ] ;
V_60 = V_57 = V_61 % V_50 ;
if ( ! V_14 )
goto V_53;
...
T_3 V_62 , T_3 V_63 )
{
int V_64 = V_50 / V_46 -> V_51 ;
int V_65 ;
T_3 V_5 ;
for ( V_5 = V_62 ; V_5 <= V_63 ; V_5 += V_64 ) {
V_65 = F_36 ( V_2 , V_46 , V_5 , V_66 ) ;
if ( V_65 )
goto V_34;
}
return 0 ;
...
{
T_3 V_5 ;
for ( V_5 = V_62 ; V_5 <= V_63 ; V_5 += V_50 / V_46 -> V_51 )
F_39 ( V_2 , V_46 , V_5 ) ;
}
int F_44 ( struct V_1 * V_2 , struct V_45 * V_46 ,
T_2 V_37 , int V_51 , T_3 V_67 , int V_68 ,
int V_69 , int V_70 )
{
int V_71 ;
int V_72 ;
...
V_46 -> V_14 = F_45 ( V_72 , sizeof * V_46 -> V_14 , V_66 ) ;
if ( ! V_46 -> V_14 )
return - V_22 ;
V_46 -> V_37 = V_37 ;
V_46 -> V_72 = V_72 ;
...
F_46 ( & V_46 -> V_52 ) ;
V_74 = ( T_2 ) V_67 * V_51 ;
for ( V_5 = 0 ; V_5 * V_50 < V_68 * V_51 ; ++ V_5 ) {
V_73 = V_50 ;
if ( ( V_5 + 1 ) * V_50 > V_74 )
V_73 = F_47 ( V_74 -
V_5 * V_50 ) ;
V_46 -> V_14 [ V_5 ] = F_22 ( V_2 , V_73 >> V_54 ,
( V_69 ? V_66 : V_56 ) |
V_29 , V_70 ) ;
if ( ! V_46 -> V_14 [ V_5 ] )
goto V_65;
if ( F_30 ( V_2 , V_46 -> V_14 [ V_5 ] , V_37 + V_5 * V_50 ) ) {
F_10 ( V_2 , V_46 -> V_14 [ V_5 ] , V_70 ) ;
V_46 -> V_14 [ V_5 ] = NULL ;
goto V_65;
}
++ V_46 -> V_14 [ V_5 ] -> V_31 ;
...
{
int V_5 ;
for ( V_5 = 0 ; V_5 < V_46 -> V_72 ; ++ V_5 )
if ( V_46 -> V_14 [ V_5 ] ) {
F_32 ( V_2 , V_46 -> V_37 + V_5 * V_50 ,
V_50 / V_58 ) ;
F_10 ( V_2 , V_46 -> V_14 [ V_5 ] , V_46 -> V_15 ) ;
}
F_12 ( V_46 -> V_14 ) ;
