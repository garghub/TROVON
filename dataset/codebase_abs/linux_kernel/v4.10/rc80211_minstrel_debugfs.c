...
V_17 += sprintf ( V_17 , L_4 , V_22 -> V_29 / 2 ,
( V_22 -> V_29 & 1 ? L_5 : L_6 ) ) ;
V_17 += sprintf ( V_17 , L_7 , V_12 ) ;
V_17 += sprintf ( V_17 , L_8 , V_22 -> V_30 ) ;
V_13 = F_7 ( V_22 , F_8 ( 100 , 100 ) ) ;
V_14 = F_7 ( V_22 , V_25 -> V_31 ) ;
V_15 = F_9 ( V_25 -> V_32 * 1000 ) ;
V_16 = F_9 ( V_25 -> V_31 * 1000 ) ;
V_17 += sprintf ( V_17 , L_9
L_10
L_11 ,
V_13 / 10 , V_13 % 10 ,
V_14 / 10 , V_14 % 10 ,
...
struct V_21 * V_22 = & V_10 -> V_23 [ V_12 ] ;
struct V_24 * V_25 = & V_10 -> V_23 [ V_12 ] . V_26 ;
V_17 += sprintf ( V_17 , L_14 , ( ( V_12 == V_10 -> V_27 [ 0 ] ) ? L_15 : L_16 ) ) ;
V_17 += sprintf ( V_17 , L_14 , ( ( V_12 == V_10 -> V_27 [ 1 ] ) ? L_17 : L_16 ) ) ;
V_17 += sprintf ( V_17 , L_14 , ( ( V_12 == V_10 -> V_27 [ 2 ] ) ? L_18 : L_16 ) ) ;
V_17 += sprintf ( V_17 , L_14 , ( ( V_12 == V_10 -> V_27 [ 3 ] ) ? L_19 : L_16 ) ) ;
V_17 += sprintf ( V_17 , L_14 , ( ( V_12 == V_10 -> V_28 ) ? L_20 : L_16 ) ) ;
V_17 += sprintf ( V_17 , L_21 , V_22 -> V_29 / 2 ,
( V_22 -> V_29 & 1 ? L_22 : L_23 ) ) ;
V_17 += sprintf ( V_17 , L_24 , V_12 ) ;
V_17 += sprintf ( V_17 , L_24 , V_22 -> V_30 ) ;
V_13 = F_7 ( V_22 , F_8 ( 100 , 100 ) ) ;
V_14 = F_7 ( V_22 , V_25 -> V_31 ) ;
V_15 = F_9 ( V_25 -> V_32 * 1000 ) ;
V_16 = F_9 ( V_25 -> V_31 * 1000 ) ;
V_17 += sprintf ( V_17 , L_25
L_26 ,
V_13 / 10 , V_13 % 10 ,
V_14 / 10 , V_14 % 10 ,
V_16 / 10 , V_16 % 10 ,
...
V_10 -> V_45 = F_13 ( L_27 , V_46 , V_44 , V_10 ,
& V_47 ) ;
V_10 -> V_48 = F_13 ( L_28 , V_46 , V_44 ,
V_10 , & V_49 ) ;
}
void
