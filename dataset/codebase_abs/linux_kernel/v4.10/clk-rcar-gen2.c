...
static T_1 T_2 F_24 ( void )
{
void T_3 * V_68 = F_25 ( V_69 , 4 ) ;
T_1 V_70 ;
F_26 ( ! V_68 ) ;
V_70 = F_27 ( V_68 ) ;
F_28 ( V_68 ) ;
...
static void T_2 F_29 ( struct V_36 * V_37 )
{
const struct V_54 * V_55 ;
struct V_21 * V_22 ;
struct V_20 * * V_71 ;
...
V_71 = F_11 ( V_72 * sizeof( * V_71 ) , V_26 ) ;
if ( V_22 == NULL || V_71 == NULL ) {
F_33 ( L_17 , V_74 ) ;
return;
}
F_34 ( & V_22 -> V_45 ) ;
V_22 -> V_75 . V_71 = V_71 ;
V_22 -> V_75 . V_76 = V_72 ;
V_22 -> V_8 = F_35 ( V_37 , 0 ) ;
if ( F_36 ( V_22 -> V_8 == NULL ) )
return;
V_55 = & V_77 [ F_37 ( V_63 ) ] ;
...
if ( F_14 ( V_20 ) )
F_33 ( L_18 ,
V_74 , V_37 -> V_28 , V_28 , F_39 ( V_20 ) ) ;
else
V_22 -> V_75 . V_71 [ V_15 ] = V_20 ;
}
F_40 ( V_37 , V_78 , & V_22 -> V_75 ) ;
F_41 ( V_37 ) ;
}
