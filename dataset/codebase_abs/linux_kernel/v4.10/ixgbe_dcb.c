...
void F_6 ( struct V_16 * V_40 , int V_18 ,
T_6 * V_2 )
{
struct V_42 * V_27 = & V_40 -> V_27 [ 0 ] ;
int V_43 ;
...
void F_7 ( struct V_16 * V_40 , T_6 * V_3 )
{
struct V_42 * V_27 = & V_40 -> V_27 [ 0 ] ;
int V_43 ;
for ( V_43 = 0 ; V_43 < V_10 ; V_43 ++ )
...
void F_9 ( struct V_16 * V_40 , int V_18 ,
T_4 * V_47 )
{
struct V_42 * V_27 = & V_40 -> V_27 [ 0 ] ;
int V_43 ;
...
T_4 F_10 ( struct V_16 * V_40 , int V_18 , T_4 V_49 )
{
struct V_42 * V_27 = & V_40 -> V_27 [ 0 ] ;
T_4 V_50 = F_5 ( V_49 ) ;
...
void F_11 ( struct V_16 * V_40 , int V_18 , T_4 * V_54 )
{
T_4 V_49 ;
for ( V_49 = 0 ; V_49 < V_55 ; V_49 ++ )
V_54 [ V_49 ] = F_10 ( V_40 , V_18 , V_49 ) ;
}
T_1 F_12 ( struct V_14 * V_15 ,
struct V_16 * V_17 )
{
T_4 V_41 ;
T_4 V_47 [ V_10 ] ;
...
T_1 F_15 ( struct V_14 * V_15 , T_4 V_41 , T_4 * V_56 )
{
switch ( V_15 -> V_35 . type ) {
case V_36 :
return F_16 ( V_15 , V_41 ) ;
case V_57 :
case V_58 :
case V_59 :
case V_60 :
case V_61 :
return F_17 ( V_15 , V_41 , V_56 ) ;
default:
break;
}
return - V_62 ;
}
T_1 F_18 ( struct V_14 * V_15 , struct V_63 * V_64 , int V_4 )
{
T_3 V_2 [ V_65 ] , V_3 [ V_65 ] ;
T_2 V_48 [ V_65 ] ;
int V_8 ;
T_2 V_30 [ V_65 ] = { 0 , 1 , 2 , 3 , 4 , 5 , 6 , 7 } ;
...
return F_19 ( V_15 , V_2 , V_3 ,
V_30 , V_48 , V_64 -> V_56 ) ;
}
T_1 F_19 ( struct V_14 * V_15 ,
...
static void F_26 ( struct V_14 * V_15 , T_4 * V_54 )
{
T_5 V_70 , V_8 ;
V_70 = F_27 ( V_15 , V_71 ) ;
...
void F_28 ( struct V_14 * V_15 , T_4 * V_54 )
{
switch ( V_15 -> V_35 . type ) {
case V_57 :
case V_58 :
