...
static T_3 F_26 ( struct V_109 * V_110 )
{
struct V_111 * V_112 ;
struct V_2 * V_3 ;
struct V_113 V_114 = {} ;
int V_5 ;
int V_49 ;
V_3 = F_27 ( & V_110 -> V_115 , sizeof( struct V_2 ) ,
V_116 ) ;
if ( ! V_3 )
return - V_117 ;
V_114 . V_118 = V_3 ;
V_3 -> V_9 = F_28 ( V_110 -> V_115 . V_119 ) ;
V_3 -> V_30 = V_35 ;
V_3 -> V_6 = V_120 ;
V_3 -> V_58 = V_60 ;
V_3 -> V_77 . V_121 = F_21 ;
V_112 = V_3 -> V_9 -> V_115 -> V_122 ;
if ( V_112 != NULL && V_112 -> V_123 )
V_124 . V_123 = V_112 -> V_123 ;
else
V_124 . V_123 = 1 ;
for ( V_49 = 0 ; V_49 < F_29 ( V_125 ) ; V_49 ++ ) {
V_5 = F_30 ( V_3 -> V_9 ,
...
V_3 -> V_74 = F_32 ( & V_110 -> V_115 , & V_124 , & V_114 ) ;
if ( F_33 ( V_3 -> V_74 ) ) {
V_5 = F_34 ( V_3 -> V_74 ) ;
goto V_127;
}
...
V_127:
while ( -- V_49 >= 0 )
F_36 ( V_3 -> V_9 , V_126 [ V_49 ] , V_3 ) ;
return V_5 ;
}
static int F_37 ( struct V_109 * V_110 )
{
int V_49 ;
struct V_2 * V_3 = F_38 ( V_110 ) ;
for ( V_49 = 0 ; V_49 < F_29 ( V_125 ) ; V_49 ++ )
F_36 ( V_3 -> V_9 , V_126 [ V_49 ] , V_3 ) ;
F_39 ( V_3 -> V_74 ) ;
return 0 ;
