...
L_4 ,
V_18 , V_31 ,
V_31 -> V_35 ? V_31 -> V_35 -> V_36 : L_5 , V_31 -> V_4 ) ;
F_32 () ;
}
V_10 = V_7 -> V_10 ;
if ( ! F_33 ( V_31 ) && V_10 > 1 ) {
...
int V_40 = V_7 -> V_25 ;
int V_41 = F_35 ( int , V_7 -> V_10 , V_10 + V_40 ) ;
V_4 = F_36 ( V_7 -> V_9 , V_41 , V_40 ) ;
if ( V_4 >= V_41 && V_40 + V_41 > V_7 -> V_10 ) {
V_41 = V_40 + V_41 - V_7 -> V_10 ;
V_4 = F_34 ( V_7 -> V_9 , V_41 ) ;
}
if ( V_4 >= V_41 )
return 1 ;
}
