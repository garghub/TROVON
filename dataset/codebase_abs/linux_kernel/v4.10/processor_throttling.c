...
if ( ! F_47 ( & V_118 , V_16 ) )
return - V_17 ;
F_7 ( V_118 , & V_119 -> V_120 ) ;
if ( F_48 ( V_119 , F_49 ( V_8 -> V_92 ) ) ) {
F_8 ( V_118 ) ;
return - V_58 ;
}
V_105 = V_8 -> V_19 . F_21 ( V_8 ) ;
F_48 ( V_119 , V_118 ) ;
F_8 ( V_118 ) ;
return V_105 ;
}
...
F_11 ( ( V_30 , L_38 ) ) ;
return - V_21 ;
} else if ( ! V_8 -> V_19 . V_122 ) {
F_11 ( ( V_30 , L_39 ) ) ;
return - V_21 ;
}
else if ( ( V_8 -> V_19 . V_99 + V_8 -> V_19 . V_122 ) > 4 ) {
F_13 (KERN_WARNING PREFIX L_40 ) ;
return - V_21 ;
}
V_8 -> V_19 . V_47 = 1 << V_123 . V_122 ;
V_121 = ( 1000 / V_8 -> V_19 . V_47 ) ;
for ( V_4 = 0 ; V_4 < V_8 -> V_19 . V_47 ; V_4 ++ ) {
V_8 -> V_19 . V_100 [ V_4 ] . V_101 = 1000 - V_121 * V_4 ;
V_8 -> V_19 . V_100 [ V_4 ] . V_124 = 1000 - V_121 * V_4 ;
}
return 0 ;
}
...
static long F_54 ( void * V_32 )
{
struct V_127 * V_128 = V_32 ;
struct V_7 * V_8 = V_128 -> V_8 ;
return V_8 -> V_19 . F_19 ( V_8 ,
V_128 -> V_36 , V_128 -> V_125 ) ;
}
...
V_129 . V_36 = V_50 ;
V_39 = & ( V_8 -> V_19 ) ;
F_56 (i, cpu_online_mask, p_throttling->shared_cpu_map) {
V_129 . V_35 = V_4 ;
F_12 ( V_41 ,
& V_129 ) ;
}
...
V_128 . V_36 = V_50 ;
V_128 . V_125 = V_125 ;
V_105 = F_57 ( V_8 -> V_92 , F_54 , & V_128 ) ;
} else {
F_56 (i, cpu_online_mask,
