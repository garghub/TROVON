...
T_2 V_125 ;
T_5 V_126 ;
int V_127 = F_61 ( V_120 ) ;
if ( ! ( V_120 & V_128 ) ) {
T_6 V_63 ;
if ( V_121 >= ( V_122 / V_127 ) )
return false ;
V_63 = F_62 ( V_120 ) + V_121 * V_127 ;
V_126 = V_63 >> V_129 ;
return F_63 ( V_24 -> V_93 -> V_2 , V_126 ) ;
}
V_124 = V_121 / ( V_123 / V_127 ) ;
...
{
struct V_30 * V_32 ;
if ( ! F_59 ( V_24 , V_24 -> V_131 , V_31 ) )
return V_132 ;
V_32 = F_3 ( sizeof( * V_32 ) , V_10 ) ;
V_32 -> V_33 = V_31 ;
V_32 -> V_49 = V_133 ;
F_12 ( & V_32 -> V_134 , & V_24 -> V_135 ) ;
* V_130 = V_32 ;
return 0 ;
}
...
{
T_1 V_25 = F_55 ( V_113 ) ;
bool V_145 = F_75 ( V_113 ) ;
struct V_22 * V_26 ;
if ( ! F_59 ( V_24 , V_24 -> V_146 , V_25 ) )
return V_147 ;
V_26 = F_14 ( V_24 , V_25 ) ;
if ( V_26 )
F_72 ( V_2 , V_26 ) ;
...
{
struct V_4 * V_5 = & V_2 -> V_6 . V_7 ;
T_1 V_154 = F_77 ( V_113 ) ;
T_1 V_155 = F_51 ( V_113 , 3 , 16 , 32 ) ;
struct V_34 * V_156 , * V_157 ;
struct V_1 * V_8 ;
if ( V_154 >= F_78 ( & V_2 -> V_149 ) ||
V_155 >= F_78 ( & V_2 -> V_149 ) )
return V_158 ;
if ( V_154 == V_155 )
return 0 ;
V_156 = F_27 ( V_2 , V_154 ) ;
V_157 = F_27 ( V_2 , V_155 ) ;
F_8 ( & V_5 -> V_18 ) ;
F_9 (irq, &dist->lpi_list_head, lpi_list) {
F_8 ( & V_8 -> V_14 ) ;
if ( V_8 -> V_41 == V_156 )
...
T_2 * V_113 )
{
T_1 V_159 = F_56 ( V_113 ) ;
T_2 V_160 = F_55 ( V_113 ) ;
return F_43 ( V_2 , V_24 , V_160 , V_159 ) ;
}
...
{
V_65 = F_86 ( V_65 , V_172 ,
V_173 ,
V_174 ) ;
V_65 = F_86 ( V_65 , V_175 ,
V_176 ,
V_177 ) ;
V_65 = F_86 ( V_65 , V_178 ,
V_179 ,
V_180 ) ;
V_65 &= ~ F_64 ( 15 , 12 ) ;
V_65 = ( V_65 & ~ V_181 ) | V_182 ;
return V_65 ;
}
static T_2 F_87 ( T_2 V_65 )
{
V_65 = F_86 ( V_65 , V_183 ,
V_184 ,
V_174 ) ;
V_65 = F_86 ( V_65 , V_185 ,
V_186 ,
V_177 ) ;
V_65 = F_86 ( V_65 , V_187 ,
V_188 ,
V_180 ) ;
...
T_4 V_63 , unsigned int V_64 )
{
return F_40 ( V_24 -> V_189 , V_63 & 7 , V_64 ) ;
}
...
return;
F_36 ( & V_24 -> V_66 ) ;
V_24 -> V_189 = F_90 ( V_24 -> V_189 , V_63 & 7 , V_64 , V_71 ) ;
V_24 -> V_189 = F_87 ( V_24 -> V_189 ) ;
V_24 -> V_67 = 0 ;
V_24 -> V_68 = V_24 -> V_67 ;
F_37 ( & V_24 -> V_66 ) ;
}
...
V_65 = F_92 ( V_65 ) ;
if ( V_65 >= F_93 ( V_24 -> V_189 ) ) {
F_37 ( & V_24 -> V_66 ) ;
return;
}
V_24 -> V_68 = V_65 ;
V_189 = F_94 ( V_24 -> V_189 ) ;
while ( V_24 -> V_68 != V_24 -> V_67 ) {
int V_39 = F_19 ( V_2 , V_189 + V_24 -> V_67 ,
V_190 , V_191 ) ;
if ( ! V_39 )
F_84 ( V_2 , V_24 , V_190 ) ;
V_24 -> V_67 += V_191 ;
if ( V_24 -> V_67 == F_93 ( V_24 -> V_189 ) )
V_24 -> V_67 = 0 ;
}
F_37 ( & V_24 -> V_66 ) ;
}
...
V_65 = F_90 ( * V_194 , V_63 & 7 , V_64 , V_71 ) ;
V_65 &= ~ V_198 ;
V_65 &= ~ V_195 ;
V_65 |= ( V_192 - 1 ) << V_199 ;
V_65 |= V_193 << V_200 ;
...
return - V_204 ;
V_94 -> V_205 = V_206 ;
V_94 -> V_207 = F_104 ( V_206 ) ;
F_105 ( & V_94 -> V_93 , & V_96 ) ;
V_94 -> V_208 = V_24 -> V_203 ;
V_94 -> V_97 = V_98 ;
V_94 -> V_24 = V_24 ;
F_36 ( & V_2 -> V_209 ) ;
V_39 = F_106 ( V_2 , V_109 , V_94 -> V_208 ,
V_210 , & V_94 -> V_93 ) ;
F_37 ( & V_2 -> V_209 ) ;
return V_39 ;
}
static int F_107 ( struct V_211 * V_93 , T_1 type )
{
struct V_23 * V_24 ;
if ( type != V_212 )
return - V_103 ;
...
V_24 -> V_131 = V_215 |
( ( T_2 ) V_197 << V_200 ) ;
V_93 -> V_2 -> V_6 . V_7 . V_37 = V_216 ;
V_93 -> V_217 = V_24 ;
return 0 ;
}
static void F_109 ( struct V_211 * V_218 )
{
...
struct V_219 * V_222 , * V_143 ;
if ( ! V_24 -> V_148 . V_223 )
return;
F_36 ( & V_24 -> V_110 ) ;
F_110 (dev_cur, dev_temp, &its->device_list) {
V_93 = F_45 ( V_220 , struct V_22 , V_144 ) ;
F_110 (cur, temp, &dev->itt_head) {
V_29 = ( F_45 ( V_222 , struct V_27 , V_112 ) ) ;
F_49 ( V_2 , V_29 ) ;
}
F_50 ( V_220 ) ;
F_10 ( V_93 ) ;
...
F_50 ( V_222 ) ;
F_10 ( F_45 ( V_222 , struct V_30 , V_134 ) ) ;
}
F_37 ( & V_24 -> V_110 ) ;
F_10 ( V_24 ) ;
}
static int F_111 ( struct V_211 * V_93 ,
struct V_224 * V_225 )
{
switch ( V_225 -> V_226 ) {
case V_227 :
...
static int F_112 ( struct V_211 * V_93 ,
struct V_224 * V_225 )
{
struct V_23 * V_24 = V_93 -> V_217 ;
int V_39 ;
switch ( V_225 -> V_226 ) {
case V_227 : {
...
if ( type != V_228 )
return - V_103 ;
if ( F_113 ( & V_63 , V_231 , sizeof( V_63 ) ) )
return - V_232 ;
V_39 = F_114 ( V_93 -> V_2 , & V_24 -> V_203 ,
V_63 , V_123 ) ;
if ( V_39 )
return V_39 ;
V_24 -> V_203 = V_63 ;
...
static int F_115 ( struct V_211 * V_93 ,
struct V_224 * V_225 )
{
switch ( V_225 -> V_226 ) {
case V_227 : {
...
if ( type != V_228 )
return - V_103 ;
if ( F_116 ( V_231 , & V_63 , sizeof( V_63 ) ) )
return - V_232 ;
break;
default:
return - V_204 ;
