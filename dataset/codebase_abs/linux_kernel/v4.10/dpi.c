...
struct V_70 * V_71 = & V_54 -> V_71 ;
int V_38 = 0 , V_39 = 0 ;
unsigned long V_53 = 0 ;
unsigned long V_32 ;
int V_64 = 0 ;
if ( V_54 -> V_51 )
V_64 = F_22 ( V_54 , V_10 , V_71 -> V_72 , & V_53 ,
& V_38 , & V_39 ) ;
else
V_64 = F_25 ( V_54 , V_71 -> V_72 , & V_53 ,
& V_38 , & V_39 ) ;
if ( V_64 )
return V_64 ;
V_32 = V_53 / V_38 / V_39 ;
...
enum V_9 V_10 = V_68 -> V_69 ;
V_54 -> V_66 . V_73 = V_74 ;
V_54 -> V_66 . V_75 = false ;
V_54 -> V_66 . V_76 = false ;
V_54 -> V_66 . V_77 = V_54 -> V_78 ;
V_54 -> V_66 . V_79 = 0 ;
F_31 ( V_10 , & V_54 -> V_66 ) ;
}
...
return - V_65 ;
if ( V_54 -> V_51 ) {
V_62 = F_14 ( V_54 , V_71 -> V_72 , & V_35 ) ;
if ( ! V_62 )
return - V_65 ;
V_53 = V_35 . V_42 . V_45 [ V_35 . V_44 ] ;
} else {
V_62 = F_19 ( V_71 -> V_72 , & V_35 ) ;
if ( ! V_62 )
return - V_65 ;
V_53 = V_35 . V_53 ;
}
...
static void F_53 ( struct V_2 * V_3 , int V_78 )
{
struct V_1 * V_54 = F_1 ( V_3 ) ;
F_33 ( & V_54 -> V_80 ) ;
V_54 -> V_78 = V_78 ;
...
static int F_54 ( struct V_95 * V_51 )
{
int V_64 ;
V_64 = F_39 ( V_51 ) ;
if ( V_64 )
...
struct V_109 * V_110 )
{
struct V_1 * V_54 = V_110 -> V_33 ;
struct V_2 * V_68 = & V_54 -> V_4 ;
int V_64 ;
T_1 V_89 ;
V_64 = F_74 ( V_110 , L_11 , & V_89 ) ;
if ( V_64 )
V_89 = 0 ;
switch ( V_89 ) {
case 2 :
...
static int F_76 ( struct V_111 * V_7 , struct V_111 * V_112 , void * V_33 )
{
struct V_5 * V_6 = F_77 ( V_7 ) ;
struct V_1 * V_54 ;
V_54 = F_78 ( & V_6 -> V_7 , sizeof( * V_54 ) , V_113 ) ;
if ( ! V_54 )
return - V_114 ;
V_54 -> V_6 = V_6 ;
F_79 ( & V_6 -> V_7 , V_54 ) ;
...
static void F_81 ( struct V_111 * V_7 , struct V_111 * V_112 , void * V_33 )
{
struct V_5 * V_6 = F_77 ( V_7 ) ;
F_71 ( V_6 ) ;
}
...
int F_90 ( struct V_5 * V_6 , struct V_109 * V_110 )
{
struct V_1 * V_54 ;
struct V_109 * V_117 ;
T_1 V_118 ;
...
if ( ! V_54 )
return - V_114 ;
V_117 = F_91 ( V_110 , NULL ) ;
if ( ! V_117 )
return 0 ;
V_64 = F_74 ( V_117 , L_14 , & V_118 ) ;
if ( V_64 ) {
F_35 ( L_15 ) ;
goto V_119;
}
