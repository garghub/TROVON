...
V_150 -> V_151 = V_57 ;
V_150 -> V_160 &= ~ V_264 ;
V_150 -> V_160 |= ( V_161 | V_265 | V_266 | V_267 ) ;
...
* V_325 = 0 ;
* V_326 = 0 ;
if ( V_57 -> V_219 - V_327 <= sizeof( V_273 ) ) {
F_166 ( log , V_57 , * V_269 , * V_324 ) ;
* V_269 = 0 ;
* V_324 = 0 ;
F_12 ( & log -> V_113 ) ;
...
if ( error )
return error ;
ASSERT ( V_327 <= V_57 -> V_219 - 1 ) ;
V_332 = V_57 -> V_222 + V_327 ;
if ( ! * V_329 )
* V_329 = F_156 ( V_57 -> V_209 . V_238 ) ;
while ( V_297 && ( ! V_297 -> V_109 || V_330 < V_297 -> V_109 ) ) {
struct V_101 * V_102 ;
struct V_303 * V_304 ;
int V_333 ;
...
if ( V_57 -> V_219 - V_57 -> V_95 < 2 * sizeof( V_273 ) ) {
...
V_363 = V_57 -> V_95 ;
V_57 -> V_64 = V_67 ;
V_57 -> V_209 . V_364 = F_127 ( log -> V_190 ) ;
log -> V_190 = log -> V_360 ;
log -> V_365 = log -> V_191 ;
log -> V_360 += F_123 ( V_363 ) + F_123 ( log -> V_171 ) ;
if ( F_110 ( & log -> V_149 -> V_77 ) &&
log -> V_149 -> V_77 . V_257 > 1 ) {
T_13 V_366 = F_123 ( log -> V_149 -> V_77 . V_257 ) ;
...
int V_386 = 0 ;
for ( V_185 = 0 ; V_185 < log -> V_165 ; V_185 ++ ) {
if ( V_332 >= log -> V_208 [ V_185 ] &&
V_332 <= log -> V_208 [ V_185 ] + log -> V_168 )
V_386 ++ ;
}
if ( ! V_386 )
F_207 ( log -> V_149 , L_55 , V_112 ) ;
}
STATIC void
F_31 (
struct V_1 * log )
...
T_21 V_395 ;
T_5 V_396 ;
int V_30 , V_185 , V_234 , V_235 , V_397 ;
int V_398 ;
F_12 ( & log -> V_113 ) ;
V_392 = log -> V_94 ;
...
V_393 = V_332 = & V_57 -> V_209 ;
V_394 = & V_57 -> V_209 ;
for ( V_332 += V_175 ; V_332 < V_393 + V_252 ; V_332 += V_175 ) {
if ( * ( T_16 * ) V_332 == F_127 ( V_211 ) )
F_207 ( log -> V_149 , L_62 ,
V_112 ) ;
}
V_30 = F_159 ( V_57 -> V_209 . V_271 ) ;
V_393 = V_332 = V_57 -> V_222 ;
V_391 = V_332 ;
V_240 = V_57 -> V_206 ;
...
V_398 = F_134 ( ( char * ) & V_391 -> V_306 - V_57 -> V_222 ) ;
if ( V_398 >= ( V_170 / V_175 ) ) {
V_234 = V_398 / ( V_170 / V_175 ) ;
V_235 = V_398 % ( V_170 / V_175 ) ;
V_396 = F_209 (
V_240 [ V_234 ] . V_241 . V_242 [ V_235 ] ) ;
} else {
V_396 = F_209 (
V_57 -> V_209 . V_239 [ V_398 ] ) ;
}
}
...
V_234 = V_398 / ( V_170 / V_175 ) ;
V_235 = V_398 % ( V_170 / V_175 ) ;
V_397 = F_159 ( V_240 [ V_234 ] . V_241 . V_242 [ V_235 ] ) ;
} else {
V_397 = F_159 ( V_57 -> V_209 . V_239 [ V_398 ] ) ;
}
}
