...
static void F_95 ( struct V_1 * V_2 , struct V_7 * V_8 )
{
...
{
return F_101 ( ( V_178 T_2 ) V_8 -> V_106 , V_179 ) ;
}
...
T_2 V_181 ;
V_180 = F_103 ( V_2 -> V_180 ) ;
if ( V_180 ) {
V_181 = F_100 ( V_8 ) ;
V_8 -> V_182 = V_180 [ V_181 ] ;
F_104 ( V_180 [ V_181 ] , V_8 ) ;
return;
}
if ( V_2 -> V_183 < 4 )
return;
...
V_181 = F_100 ( V_8 ) ;
V_8 -> V_182 = V_180 [ V_181 ] ;
F_106 ( V_180 [ V_181 ] , V_8 ) ;
}
F_104 ( V_2 -> V_180 , V_180 ) ;
}
static void F_107 ( struct V_1 * V_2 ,
struct V_7 * V_8 )
{
struct V_7 T_3 * * V_180 = F_103 ( V_2 -> V_180 ) ;
struct V_7 * V_184 ;
if ( ! V_180 )
return;
V_180 += F_100 ( V_8 ) ;
while ( ( V_184 = F_103 ( * V_180 ) ) != V_8 )
V_180 = & V_184 -> V_182 ;
* V_180 = V_8 -> V_182 ;
}
void F_108 ( struct V_1 * V_2 , T_1 V_170 )
{
struct V_7 * V_8 ;
#ifdef F_98
struct V_59 * V_59 = F_28 ( V_2 -> V_50 ) ;
...
F_77 ( V_2 ) ;
#endif
while ( ( V_145 = F_103 ( V_2 -> V_188 ) ) != NULL ) {
...
static int F_110 ( struct V_1 * V_2 , T_1 * V_210 , int V_35 ,
int V_38 , T_1 * V_206 , int V_211 )
{
struct V_7 * V_26 ;
int V_220 ;
...
struct V_1 * V_2 )
{
struct V_234 * V_28 = F_103 ( V_225 -> V_233 ) ;
int V_197 ;
if ( ! V_28 ) {
...
F_110 ( V_2 , & V_244 -> V_205 , V_242 , 0 , NULL , 0 ) ;
F_144 ( V_2 , & V_244 -> V_205 , V_26 -> V_35 , 0 ,
NULL , 0 ) ;
V_26 -> V_35 = V_242 ;
}
V_245 = F_103 ( V_26 -> V_233 ) ;
if ( ! V_241 ) {
if ( ! V_245 )
goto V_229;
V_207 = ! 0 ;
...
return;
F_170 () ;
while ( ( V_225 = F_103 ( V_227 -> V_188 ) ) != NULL ) {
struct V_1 * V_2 ;
...
if ( V_180 ) {
T_2 V_181 = F_101 ( ( V_178 T_2 ) V_282 , V_179 ) ;
