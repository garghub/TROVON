...
if ( V_98 -> V_5 )
F_53 ( V_98 -> V_5 ) ;
F_54 ( & V_98 -> V_111 , F_44 ) ;
}
}
static inline void F_55 ( struct V_37 * V_38 , struct V_97 * V_98 )
{
V_98 -> F_38 ( V_38 , V_98 -> V_43 ) ;
V_98 -> V_103 ++ ;
}
static int F_56 ( struct V_71 * V_80 , struct V_37 * V_38 )
{
struct V_97 * V_98 ;
int V_103 = 0 ;
...
static void F_57 ( struct V_37 * V_38 , struct V_72 * V_52 )
{
struct V_71 * V_80 ;
int V_103 ;
V_68 . V_116 ++ ;
V_68 . V_117 ++ ;
while ( ! ( F_58 ( V_38 ) -> V_118 ) )
F_58 ( V_38 ) -> V_118 = F_59 ( & V_119 ) ;
F_6 () ;
V_103 = F_56 ( & V_73 , V_38 ) ;
V_80 = F_33 ( V_52 ) ;
if ( V_80 )
V_103 += F_56 ( V_80 , V_38 ) ;
F_9 () ;
F_60 ( V_38 ) ;
if ( V_103 > 0 ) {
V_68 . V_103 ++ ;
...
{
struct V_41 * V_42 = (struct V_41 * ) V_38 -> V_43 ;
if ( F_23 ( ! F_13 ( F_62 ( V_52 ) , & V_24 ) ) )
goto V_124;
if ( F_63 ( V_52 -> type != V_55 ||
V_38 -> V_44 != V_45 ||
V_42 -> V_44 > V_47 ,
L_8
L_9 ,
...
static int F_64 ( struct V_37 * V_38 , struct V_72 * V_52 ,
struct V_121 * V_122 , struct V_72 * V_123 )
{
struct V_41 * V_42 = (struct V_41 * ) V_38 -> V_43 ;
if ( F_23 ( ! F_13 ( F_62 ( V_52 ) , & V_24 ) ) )
...
F_68 ( V_14 [ V_127 ] , V_13 ) ;
F_69 ( & V_128 ) ;
if ( V_19 < 0 )
F_70 ( V_13 -> V_15 ) ;
return V_19 ;
}
void F_71 ( const struct V_11 * V_13 )
{
int V_127 = V_13 -> V_12 ;
F_67 ( & V_128 ) ;
F_72 ( V_14 [ V_127 ] != V_13 ) ;
F_68 ( V_14 [ V_127 ] , NULL ) ;
F_69 ( & V_128 ) ;
F_73 () ;
F_70 ( V_13 -> V_15 ) ;
}
static int F_74 ( struct V_130 * V_131 , unsigned long V_132 ,
void * V_133 )
{
struct V_72 * V_52 = F_75 ( V_133 ) ;
struct V_71 * V_80 ;
if ( ! F_13 ( F_62 ( V_52 ) , & V_24 ) )
return V_134 ;
if ( V_52 -> type != V_55 )
return V_134 ;
switch ( V_132 ) {
case V_135 :
V_80 = F_76 ( sizeof( * V_80 ) , V_32 ) ;
if ( ! V_80 )
return V_134 ;
F_72 ( V_52 -> V_74 ) ;
V_52 -> V_74 = V_80 ;
...
static T_2 int F_77 ( void )
{
F_78 ( F_79 ( struct V_114 , V_138 ) !=
F_79 ( struct V_41 , V_44 ) ||
F_79 ( struct V_114 , V_43 ) !=
F_79 ( struct V_41 , V_43 ) ) ;
F_80 ( L_15 V_139 L_16 ) ;
memset ( & V_73 , 0 , sizeof( V_73 ) ) ;
V_101 = F_81 ( L_17 , sizeof( struct V_97 ) ,
0 , 0 , NULL ) ;
if ( ! V_101 )
return - V_33 ;
if ( F_82 ( V_140 ) ) {
