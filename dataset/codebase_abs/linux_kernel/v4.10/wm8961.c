...
F_6 ( V_65 , V_10 ,
V_3 | V_167 | V_168 ) ;
F_6 ( V_65 , V_9 , V_3 | V_167 ) ;
V_3 = F_5 ( V_65 , V_36 ) ;
F_6 ( V_65 , V_36 ,
V_3 | V_169 | V_170 ) ;
F_6 ( V_65 , V_35 , V_3 | V_171 ) ;
V_3 = F_5 ( V_65 , V_25 ) ;
F_6 ( V_65 , V_25 , V_3 | V_172 ) ;
V_3 = F_5 ( V_65 , V_8 ) ;
F_6 ( V_65 , V_8 , V_3 | V_173 ) ;
V_3 = F_5 ( V_65 , V_13 ) ;
V_3 |= V_174 ;
F_6 ( V_65 , V_13 , V_3 ) ;
V_3 = F_5 ( V_65 , V_32 ) ;
...
static int F_27 ( struct V_176 * V_177 ,
const struct V_178 * V_179 )
{
struct V_100 * V_101 ;
unsigned int V_111 ;
int V_180 ;
V_101 = F_28 ( & V_177 -> V_2 , sizeof( struct V_100 ) ,
V_181 ) ;
if ( V_101 == NULL )
return - V_182 ;
V_101 -> V_183 = F_29 ( V_177 , & V_184 ) ;
if ( F_30 ( V_101 -> V_183 ) )
return F_31 ( V_101 -> V_183 ) ;
V_180 = F_32 ( V_101 -> V_183 , V_4 , & V_111 ) ;
if ( V_180 != 0 ) {
F_10 ( & V_177 -> V_2 , L_14 , V_180 ) ;
return V_180 ;
}
if ( V_111 != 0x1801 ) {
F_10 ( & V_177 -> V_2 , L_15 , V_111 ) ;
return - V_107 ;
}
F_33 ( V_101 -> V_183 , true ) ;
V_180 = F_32 ( V_101 -> V_183 , V_8 , & V_111 ) ;
F_33 ( V_101 -> V_183 , false ) ;
if ( V_180 != 0 ) {
F_10 ( & V_177 -> V_2 , L_16 , V_180 ) ;
return V_180 ;
}
F_34 ( & V_177 -> V_2 , L_17 ,
( V_111 & V_185 ) >> V_186 ,
( ( V_111 & V_187 ) >> V_188 )
+ 'A' ) ;
V_180 = F_35 ( V_101 -> V_183 , V_4 , 0x1801 ) ;
if ( V_180 != 0 ) {
F_10 ( & V_177 -> V_2 , L_18 , V_180 ) ;
return V_180 ;
}
F_36 ( V_177 , V_101 ) ;
V_180 = F_37 ( & V_177 -> V_2 ,
& V_189 , & V_190 , 1 ) ;
return V_180 ;
}
static int F_38 ( struct V_176 * V_191 )
{
F_39 ( & V_191 -> V_2 ) ;
return 0 ;
}
