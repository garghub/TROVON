...
struct V_15 * V_15 ;
V_2 -> V_126 = 1 ;
if ( ! V_2 -> V_97 || ! F_62 ( V_90 ) )
return;
V_123 = 1 << V_2 -> V_97 ;
V_124 = V_2 -> V_98 & ( V_123 - 1 ) ;
if ( ! V_124 )
return;
if ( V_122 )
V_124 = V_123 - V_124 ;
V_125 = V_124 << V_2 -> V_96 ;
V_15 = F_4 ( 0 ) ;
if ( F_59 ( V_5 , V_2 , V_15 , 0 , V_125 ,
V_2 -> V_127 , V_90 ) )
return;
V_2 -> V_127 += V_124 ;
}
...
const unsigned V_95 = V_96 + V_2 -> V_97 ;
int V_6 = 0 ;
...
F_69 ( V_15 , V_11 , 1 << V_96 ) ;
V_2 -> V_98 ++ ;
V_11 += 1 << V_96 ;
V_5 -> V_25 += 1 << V_96 ;
goto V_135;
}
if ( F_11 ( V_2 -> V_97 && ! V_2 -> V_126 ) )
F_61 ( V_5 , V_2 , 0 , V_90 ) ;
V_124 = V_2 -> V_12 ;
V_128 = ( V_17 - V_11 ) >> V_96 ;
if ( V_124 > V_128 )
V_124 = V_128 ;
V_128 = V_2 -> V_99 - V_2 -> V_98 ;
if ( V_124 > V_128 )
V_124 = V_128 ;
V_125 = V_124 << V_96 ;
F_9 ( V_125 == 0 ) ;
...
static inline T_1
F_72 ( struct V_136 * V_21 , struct V_35 * V_35 ,
struct V_51 * V_52 , struct V_137 * V_7 ,
T_5 V_103 , T_6 V_30 ,
T_7 V_65 , int V_33 )
{
unsigned V_95 = F_73 ( V_35 -> V_95 ) ;
unsigned V_96 = V_95 ;
unsigned V_138 = ( 1 << V_96 ) - 1 ;
T_1 V_139 = - V_140 ;
T_4 V_141 = F_74 ( V_7 ) ;
T_2 V_20 = V_21 -> V_22 ;
T_2 V_122 = V_20 + V_141 ;
struct V_5 * V_5 ;
struct V_1 V_2 = { 0 , } ;
struct V_89 V_90 = { 0 , } ;
struct V_142 V_143 ;
unsigned long V_144 = V_20 | F_75 ( V_7 ) ;
if ( V_144 & V_138 ) {
if ( V_52 )
V_96 = F_76 ( F_77 ( V_52 ) ) ;
V_138 = ( 1 << V_96 ) - 1 ;
...
V_5 -> V_27 = F_52 ( V_35 ) ;
if ( F_78 ( V_7 ) == V_145 && V_20 >= V_5 -> V_27 ) {
if ( V_5 -> V_33 & V_146 )
F_83 ( V_35 ) ;
F_14 ( V_37 , V_5 ) ;
V_139 = 0 ;
...
if ( F_84 ( V_21 ) )
V_5 -> V_19 = false ;
else if ( ! ( V_5 -> V_33 & V_151 ) &&
F_78 ( V_7 ) == V_152 && V_122 > F_52 ( V_35 ) )
V_5 -> V_19 = false ;
else
V_5 -> V_19 = true ;
V_5 -> V_35 = V_35 ;
if ( F_78 ( V_7 ) == V_152 ) {
V_5 -> V_13 = V_14 ;
V_5 -> V_59 = V_153 | V_154 ;
} else {
V_5 -> V_13 = V_26 ;
}
if ( V_5 -> V_19 && F_78 ( V_7 ) == V_152 &&
( ( V_21 -> V_149 -> V_155 & V_156 ) ||
F_85 ( V_21 -> V_149 -> V_150 -> V_157 ) ) ) {
V_139 = F_50 ( V_5 ) ;
if ( V_139 ) {
F_14 ( V_37 , V_5 ) ;
goto V_108;
...
if ( F_11 ( V_2 . V_97 ) )
V_2 . V_109 = 2 ;
V_2 . V_109 += F_88 ( V_7 , V_159 ) ;
F_89 ( & V_143 ) ;
V_139 = F_63 ( V_5 , & V_2 , & V_90 ) ;
if ( V_139 )
F_32 ( V_5 , & V_2 ) ;
if ( V_139 == - V_134 ) {
V_139 = 0 ;
...
F_90 ( & V_143 ) ;
F_32 ( V_5 , & V_2 ) ;
if ( F_78 ( V_7 ) == V_145 && ( V_5 -> V_33 & V_146 ) )
F_83 ( V_5 -> V_35 ) ;
F_9 ( V_139 == - V_24 ) ;
if ( V_5 -> V_19 && V_139 == 0 && V_5 -> V_25 &&
( F_78 ( V_7 ) == V_145 || V_5 -> V_25 == V_141 ) )
V_139 = - V_24 ;
else
F_44 ( V_5 ) ;
if ( F_71 ( V_5 ) == 0 ) {
...
T_1 F_91 ( struct V_136 * V_21 , struct V_35 * V_35 ,
struct V_51 * V_52 , struct V_137 * V_7 ,
T_5 V_103 ,
T_6 V_30 , T_7 V_65 ,
int V_33 )
{
F_92 ( & V_52 -> V_160 -> V_161 ) ;
F_92 ( V_52 -> V_162 ) ;
F_92 ( ( char * ) V_52 -> V_162 + V_163 ) ;
return F_72 ( V_21 , V_35 , V_52 , V_7 , V_103 ,
V_30 , V_65 , V_33 ) ;
}
