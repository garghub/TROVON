...
void F_51 ( struct V_4 * V_5 , int V_81 )
{
...
void F_62 ( struct V_94 * V_95 , T_1 V_96 , T_2 V_97 )
{
struct V_22 * V_23 = F_63 ( & V_95 -> V_98 ) ;
struct V_4 * V_5 ;
while ( V_97 ) {
...
int F_66 ( struct V_94 * V_95 , int V_101 , T_1 V_57 ,
struct V_4 * * V_69 )
{
struct V_22 * V_23 = F_63 ( & V_95 -> V_98 ) ;
...
if ( V_57 == V_95 -> V_106 )
V_68 = V_95 -> V_107 ;
V_102 = F_43 ( V_17 , V_57 , V_73 , V_68 , & V_5 ) ;
if ( V_102 == 0 && F_67 ( V_23 , V_5 , V_103 ) ) {
F_47 ( V_5 ) ;
V_102 = - V_72 ;
}
* V_69 = V_5 ;
...
struct V_4 * F_68 ( struct V_16 * V_17 , T_1 V_108 , T_2 V_109 )
{
struct V_22 * V_23 = V_17 -> V_24 . V_25 ;
struct V_4 * V_110 , * V_5 ;
T_2 V_111 = F_69 ( V_23 , V_112 ) >>
V_23 -> V_31 . V_32 ;
F_3 ( ! V_109 ) ;
if ( V_111 < 1 )
V_111 = 1 ;
...
goto V_113;
if ( ! F_70 ( V_110 ) )
F_71 ( V_75 , V_9 , 1 , & V_110 ) ;
V_108 ++ ;
V_109 -- ;
while ( V_109 ) {
V_5 = F_20 ( V_17 , V_108 , V_42 ) ;
if ( ! F_46 ( V_5 ) && ! F_70 ( V_5 ) )
F_71 ( V_75 , V_114 | V_9 , 1 , & V_5 ) ;
F_47 ( V_5 ) ;
V_108 ++ ;
V_109 -- ;
if ( ! F_70 ( V_110 ) && F_46 ( V_110 ) )
goto V_113;
}
F_48 ( V_110 ) ;
V_113:
