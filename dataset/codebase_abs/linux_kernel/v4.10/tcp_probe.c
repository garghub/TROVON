...
static int F_18 ( char * V_55 , int V_56 )
{
const struct V_25 * V_26
= V_1 . log + V_1 . V_3 ;
struct V_57 V_58
= F_19 ( F_20 ( V_26 -> V_27 , V_1 . V_54 ) ) ;
return F_21 ( V_55 , V_56 ,
L_1 ,
...
static T_1 F_22 ( struct V_53 * V_53 , char T_2 * V_61 ,
T_3 V_11 , T_4 * V_62 )
{
int error = 0 ;
T_3 V_63 = 0 ;
...
V_65 = F_18 ( V_55 , sizeof( V_55 ) ) ;
if ( V_63 + V_65 < V_11 )
V_1 . V_3 = ( V_1 . V_3 + 1 ) & ( V_4 - 1 ) ;
F_14 ( & V_1 . V_24 ) ;
if ( V_63 + V_65 >= V_11 )
break;
if ( F_24 ( V_61 + V_63 , V_55 , V_65 ) )
return - V_66 ;
V_63 += V_65 ;
}
return V_63 == 0 ? error : V_63 ;
}
static T_5 int F_25 ( void )
{
int V_67 = - V_68 ;
F_26 ( F_27 ( V_69 ,
F_3 ) == 0 ) ;
...
return - V_64 ;
V_4 = F_30 ( V_4 ) ;
V_1 . log = F_31 ( V_4 , sizeof( struct V_25 ) , V_70 ) ;
if ( ! V_1 . log )
goto V_71;
if ( ! F_32 ( V_72 , V_73 , V_74 . V_75 , & V_76 ) )
goto V_71;
V_67 = F_33 ( & V_77 ) ;
if ( V_67 )
goto V_78;
