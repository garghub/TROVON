...
error = F_33 ( V_19 -> V_20 ) ;
if ( error ) {
F_7 ( V_2 , L_19 ,
F_34 ( V_19 -> V_20 ) , error ) ;
F_21 ( V_35 ) ;
return error ;
}
} else if ( F_35 ( V_4 -> V_66 ) ) {
unsigned V_67 = V_68 ;
if ( V_4 -> V_69 )
V_67 |= V_70 ;
error = F_36 ( & V_48 -> V_2 , V_4 -> V_66 ,
V_67 , V_4 -> V_41 ? : V_56 ) ;
if ( error ) {
F_7 ( V_2 ,
L_20 ,
...
V_19 -> V_22 = - 1 ;
V_19 -> V_29 = F_38 ( V_4 -> V_44 ,
V_25 -> V_40 ) ;
F_39 ( V_10 , type , V_4 -> V_13 ) ;
if ( type == V_16 )
F_24 ( V_10 , V_25 ,
V_4 -> V_13 ) ;
}
