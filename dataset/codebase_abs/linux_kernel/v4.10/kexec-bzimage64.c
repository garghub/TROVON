...
struct V_1 * V_2 ;
unsigned long V_106 , V_107 , V_3 ;
unsigned long V_108 ;
struct V_109 * V_110 ;
struct V_111 V_112 ;
void * V_113 ;
unsigned int V_114 = F_16 ( struct V_1 , V_5 ) ;
unsigned int V_35 , V_36 , V_44 ;
struct V_115 V_116 = { . V_11 = V_11 , . V_117 = V_118 ,
. V_119 = true } ;
V_89 = (struct V_88 * ) ( V_99 + V_114 ) ;
V_102 = V_89 -> V_102 ;
if ( V_102 == 0 )
V_102 = 4 ;
V_103 = ( V_102 + 1 ) * 512 ;
...
V_122 ;
V_105 = F_22 ( V_105 , 16 ) ;
V_116 . V_124 = V_105 + V_36 +
sizeof( struct V_46 ) +
sizeof( struct V_48 ) ;
V_2 = F_23 ( V_116 . V_124 , V_125 ) ;
if ( ! V_2 )
return F_18 ( - V_126 ) ;
V_35 = V_105 ;
V_44 = V_35 + V_36 ;
V_104 = 0x0202 + V_99 [ 0x0201 ] - V_114 ;
memcpy ( & V_2 -> V_5 , ( V_99 + V_114 ) , V_104 ) ;
V_116 . V_127 = V_2 ;
V_116 . V_128 = V_116 . V_124 ;
V_116 . V_129 = 16 ;
V_116 . V_130 = V_131 ;
V_69 = F_24 ( & V_116 ) ;
if ( V_69 )
...
V_106 = V_116 . V_133 ;
F_3 ( L_18 ,
V_106 , V_116 . V_124 , V_116 . V_124 ) ;
V_116 . V_127 = V_99 + V_103 ;
V_116 . V_124 = V_100 - V_103 ;
V_116 . V_128 = F_25 ( V_89 -> V_134 ) ;
V_116 . V_129 = V_89 -> V_135 ;
V_116 . V_130 = V_136 ;
V_69 = F_24 ( & V_116 ) ;
if ( V_69 )
goto V_132;
V_107 = V_116 . V_133 ;
F_3 ( L_19 ,
V_107 , V_116 . V_124 , V_116 . V_128 ) ;
if ( V_101 ) {
V_116 . V_127 = V_101 ;
V_116 . V_124 = V_116 . V_128 = V_4 ;
V_116 . V_129 = V_137 ;
V_116 . V_130 = V_138 ;
V_69 = F_24 ( & V_116 ) ;
if ( V_69 )
...
V_2 -> V_5 . V_139 = 0x0D << 4 ;
V_2 -> V_5 . V_92 = 0 ;
V_69 = F_26 ( V_11 , L_21 , & V_112 ,
sizeof( V_112 ) , 1 ) ;
if ( V_69 )
goto V_132;
V_112 . V_140 = 0 ;
V_112 . V_141 = V_106 ;
V_112 . V_142 = V_107 + 0x200 ;
V_113 = F_27 ( V_11 , L_22 ) ;
if ( F_28 ( V_113 ) ) {
F_15 ( L_23 ) ;
V_69 = - V_121 ;
goto V_132;
}
V_112 . V_143 = ( unsigned long ) V_113 ;
V_69 = F_26 ( V_11 , L_21 , & V_112 ,
sizeof( V_112 ) , 0 ) ;
if ( V_69 )
goto V_132;
V_69 = F_11 ( V_11 , V_2 , V_106 ,
V_35 , V_36 ,
V_44 ) ;
if ( V_69 )
goto V_132;
V_110 = F_23 ( sizeof( struct V_109 ) , V_125 ) ;
if ( ! V_110 ) {
V_69 = - V_126 ;
goto V_132;
}
...
static int F_30 ( void * V_145 )
{
struct V_109 * V_110 = V_145 ;
if ( ! V_110 )
return 0 ;
F_29 ( V_110 -> V_144 ) ;
V_110 -> V_144 = NULL ;
