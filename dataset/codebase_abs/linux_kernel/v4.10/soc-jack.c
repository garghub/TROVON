...
F_3 ( & V_5 -> V_11 ) ;
F_4 ( & V_5 -> V_12 ) ;
V_9 = F_5 ( V_2 -> V_13 , V_3 , type , & V_5 -> V_5 , false , false ) ;
if ( V_9 )
return V_9 ;
if ( V_8 )
...
F_22 ( V_5 -> V_5 , V_7 [ V_25 ] . V_18 , V_7 [ V_25 ] . V_15 ) ;
}
F_7 ( V_5 , 0 , 0 ) ;
return 0 ;
}
...
static T_1 F_29 ( int V_42 , void * V_41 )
{
struct V_36 * V_37 = V_41 ;
struct V_43 * V_32 = V_37 -> V_5 -> V_2 -> V_32 ;
F_30 ( V_37 -> V_44 ) ;
if ( F_31 ( V_32 ) )
F_32 ( V_32 , V_37 -> V_45 + 50 ) ;
F_33 ( V_46 , & V_37 -> V_47 ,
F_34 ( V_37 -> V_45 ) ) ;
return V_48 ;
}
static void F_35 ( struct V_49 * V_47 )
{
struct V_36 * V_37 ;
V_37 = F_36 ( V_47 , struct V_36 , V_47 . V_47 ) ;
F_27 ( V_37 ) ;
}
...
if ( V_50 [ V_25 ] . V_39 ) {
goto V_52;
} else if ( V_50 [ V_25 ] . V_53 ) {
V_50 [ V_25 ] . V_39 = F_38 ( V_50 [ V_25 ] . V_53 ,
V_50 [ V_25 ] . V_44 ,
V_50 [ V_25 ] . V_54 , V_55 ) ;
if ( F_39 ( V_50 [ V_25 ] . V_39 ) ) {
V_9 = F_40 ( V_50 [ V_25 ] . V_39 ) ;
F_21 ( V_50 [ V_25 ] . V_53 ,
L_5 ,
V_25 , V_9 ) ;
goto V_51;
...
V_9 = F_42 ( V_50 [ V_25 ] . V_37 , V_56 ,
V_50 [ V_25 ] . V_44 ) ;
if ( V_9 )
goto V_51;
V_50 [ V_25 ] . V_39 = F_43 ( V_50 [ V_25 ] . V_37 ) ;
}
V_52:
F_44 ( & V_50 [ V_25 ] . V_47 , F_35 ) ;
V_50 [ V_25 ] . V_5 = V_5 ;
V_9 = F_45 ( F_46 ( V_50 [ V_25 ] . V_39 ) ,
F_29 ,
V_57 |
V_58 ,
V_50 [ V_25 ] . V_44 ,
...
goto V_59;
if ( V_50 [ V_25 ] . V_60 ) {
V_9 = F_47 ( F_46 ( V_50 [ V_25 ] . V_39 ) , 1 ) ;
if ( V_9 != 0 )
F_21 ( V_5 -> V_2 -> V_32 ,
L_7 ,
V_25 , V_9 ) ;
