...
static T_3 F_51 ( int V_157 , void * V_158 )
{
...
struct V_1 * V_2 = F_19 ( V_27 ) ;
int V_166 ;
V_166 = F_55 ( V_27 -> V_157 , F_51 , V_167 ,
V_27 -> V_168 , V_27 ) ;
if ( V_166 ) {
F_34 ( V_27 , L_10 ) ;
return V_166 ;
...
V_166 = F_56 ( V_27 ) ;
if ( V_166 ) {
F_34 ( V_27 , L_11 , V_166 ) ;
F_17 ( V_2 , 0 ) ;
F_57 ( V_27 -> V_157 , V_27 ) ;
return V_166 ;
}
F_42 ( V_27 , V_169 ) ;
F_22 ( V_27 ) ;
...
struct V_1 * V_2 ;
struct V_173 * V_174 ;
struct V_175 * V_176 , * V_157 ;
void T_4 * V_177 ;
int V_166 = - V_178 ;
V_174 = F_64 ( & V_172 -> V_116 ) ;
if ( ! V_174 ) {
F_65 ( & V_172 -> V_116 , L_12 ) ;
goto V_179;
}
V_176 = F_66 ( V_172 , V_180 , 0 ) ;
if ( ! V_176 ) {
F_65 ( & V_172 -> V_116 , L_13 ) ;
goto V_179;
}
V_157 = F_66 ( V_172 , V_181 , 0 ) ;
if ( ! V_157 ) {
F_65 ( & V_172 -> V_116 , L_14 ) ;
goto V_179;
}
if ( ! F_67 ( V_176 -> V_182 , F_68 ( V_176 ) , V_172 -> V_168 ) ) {
F_65 ( & V_172 -> V_116 , L_15 ) ;
V_166 = - V_183 ;
goto V_179;
}
V_177 = F_69 ( V_176 -> V_182 , F_68 ( V_176 ) ) ;
if ( ! V_177 ) {
F_65 ( & V_172 -> V_116 , L_16 ) ;
V_166 = - V_108 ;
goto V_184;
}
V_27 = F_70 ( sizeof( struct V_1 ) , V_120 ) ;
if ( ! V_27 ) {
F_65 ( & V_172 -> V_116 , L_17 ) ;
V_166 = - V_108 ;
goto V_185;
}
V_2 = F_19 ( V_27 ) ;
V_2 -> V_27 = V_27 ;
V_2 -> V_10 = V_177 ;
V_2 -> V_186 = V_174 -> V_186 ;
V_2 -> V_11 = V_174 -> V_11 ;
V_2 -> V_13 = V_174 -> V_13 ;
V_2 -> V_63 = V_174 -> V_63 ;
V_2 -> V_31 = V_174 -> V_31 ;
V_2 -> V_17 . V_187 = & V_188 ;
V_2 -> V_17 . V_189 = F_25 ;
V_2 -> V_17 . V_190 = F_27 ;
V_2 -> V_17 . V_191 = V_24 ;
F_71 ( & V_2 -> V_91 ) ;
V_27 -> V_157 = V_157 -> V_182 ;
V_27 -> V_89 |= V_192 ;
F_72 ( V_172 , V_27 ) ;
F_73 ( V_27 , & V_172 -> V_116 ) ;
V_27 -> V_193 = & V_194 ;
V_2 -> V_195 = F_74 ( & V_172 -> V_116 , L_18 ) ;
if ( F_75 ( V_2 -> V_195 ) ) {
F_65 ( & V_172 -> V_116 , L_19 ) ;
V_166 = F_76 ( V_2 -> V_195 ) ;
V_2 -> V_195 = NULL ;
goto V_196;
}
V_2 -> V_17 . clock . V_197 = F_77 ( V_2 -> V_195 ) ;
F_78 ( V_27 , & V_2 -> V_114 , F_44 ,
V_198 ) ;
V_166 = F_79 ( V_2 -> V_195 ) ;
if ( V_166 ) {
F_65 ( & V_172 -> V_116 , L_20 ) ;
goto V_199;
}
V_166 = F_80 ( V_27 ) ;
if ( V_166 ) {
F_65 ( & V_172 -> V_116 , L_21 ) ;
goto V_199;
}
F_81 ( V_27 ) ;
F_82 ( & V_172 -> V_116 , L_22 ,
V_2 -> V_10 , ( T_1 ) V_27 -> V_157 ) ;
return 0 ;
V_199:
F_83 ( V_2 -> V_195 ) ;
V_196:
...
{
struct V_175 * V_200 ;
struct V_32 * V_27 = F_88 ( V_172 ) ;
struct V_1 * V_2 = F_19 ( V_27 ) ;
F_89 ( V_27 ) ;
F_90 ( V_2 -> V_195 ) ;
F_83 ( V_2 -> V_195 ) ;
V_200 = F_66 ( V_172 , V_180 , 0 ) ;
F_85 ( V_2 -> V_10 ) ;
F_86 ( V_200 -> V_182 , F_68 ( V_200 ) ) ;
F_84 ( V_27 ) ;
return 0 ;
}
static int F_91 ( struct V_171 * V_172 , T_5 V_70 )
{
struct V_32 * V_116 = F_88 ( V_172 ) ;
