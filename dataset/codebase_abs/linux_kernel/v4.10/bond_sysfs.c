...
struct V_72 V_72 ;
if ( ! F_49 ( V_11 , & V_72 ) )
V_19 = sprintf ( V_5 , L_17 , V_72 . V_78 ) ;
}
return V_19 ;
}
...
{
struct V_10 * V_11 = F_14 ( V_29 ) ;
unsigned int V_84 = V_11 -> V_43 . V_84 ;
return sprintf ( V_5 , L_13 , V_84 ) ;
}
...
struct V_10 * V_11 = F_14 ( V_29 ) ;
if ( F_24 ( V_11 ) == V_71 && F_52 ( V_75 ) )
return sprintf ( V_5 , L_19 , V_11 -> V_43 . V_85 ) ;
return 0 ;
}
...
struct V_10 * V_11 = F_14 ( V_29 ) ;
if ( F_24 ( V_11 ) == V_71 && F_52 ( V_75 ) )
return sprintf ( V_5 , L_17 , V_11 -> V_43 . V_86 ) ;
return 0 ;
}
