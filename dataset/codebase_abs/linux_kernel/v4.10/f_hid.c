...
V_121 . V_122 =
F_35 ( V_9 -> V_30 ) ;
V_123 . V_120 = F_35 ( V_9 -> V_30 ) ;
V_115 . V_120 = F_35 ( V_9 -> V_30 ) ;
V_124 . V_120 = F_35 ( V_9 -> V_30 ) ;
V_125 . V_122 =
F_35 ( V_9 -> V_30 ) ;
V_126 . V_120 = F_35 ( V_9 -> V_30 ) ;
...
F_53 ( & V_9 -> V_25 ) ;
F_54 ( & V_9 -> V_38 , & V_131 ) ;
V_106 = F_55 ( V_132 , V_9 -> V_133 ) ;
V_36 = F_56 ( & V_9 -> V_38 , V_106 , 1 ) ;
if ( V_36 )
goto V_134;
V_105 = F_57 ( V_135 , NULL , V_106 , NULL ,
L_19 , L_20 , V_9 -> V_133 ) ;
if ( F_45 ( V_105 ) ) {
V_36 = F_46 ( V_105 ) ;
goto V_136;
...
static inline struct V_139 * F_64 ( struct V_140 * V_141 )
{
return F_2 ( F_65 ( V_141 ) , struct V_139 ,
V_142 . V_143 ) ;
}
static void F_66 ( struct V_140 * V_141 )
{
struct V_139 * V_144 = F_64 ( V_141 ) ;
F_67 ( & V_144 -> V_142 ) ;
}
static T_1 F_68 ( struct V_140 * V_141 , char * V_145 )
{
struct V_139 * V_144 = F_64 ( V_141 ) ;
int V_146 ;
F_18 ( & V_144 -> V_44 ) ;
V_146 = V_144 -> V_89 ;
memcpy ( V_145 , V_144 -> V_90 , V_144 -> V_89 ) ;
F_20 ( & V_144 -> V_44 ) ;
return V_146 ;
}
static T_1 F_69 ( struct V_140 * V_141 ,
const char * V_145 , T_3 V_147 )
{
struct V_139 * V_144 = F_64 ( V_141 ) ;
int V_16 = - V_148 ;
char * V_149 ;
...
static T_1 F_71 ( struct V_140 * V_141 , char * V_145 )
{
struct V_139 * V_144 = F_64 ( V_141 ) ;
return sprintf ( V_145 , L_22 , V_132 , V_144 -> V_133 ) ;
}
static inline void F_72 ( int V_133 )
{
F_63 ( & V_137 , V_133 ) ;
}
static void F_73 ( struct V_155 * V_3 )
{
struct V_139 * V_144 ;
V_144 = F_2 ( V_3 , struct V_139 , V_142 ) ;
F_18 ( & V_156 ) ;
F_72 ( V_144 -> V_133 ) ;
if ( F_74 ( & V_137 ) )
F_75 () ;
...
static struct V_155 * F_76 ( void )
{
struct V_139 * V_144 ;
struct V_155 * V_16 ;
int V_36 = 0 ;
V_144 = F_30 ( sizeof( * V_144 ) , V_32 ) ;
if ( ! V_144 )
return F_77 ( - V_42 ) ;
F_50 ( & V_144 -> V_44 ) ;
V_144 -> V_142 . V_157 = F_73 ;
V_16 = & V_144 -> V_142 ;
F_18 ( & V_156 ) ;
if ( F_74 ( & V_137 ) ) {
V_36 = F_78 ( NULL , V_138 ) ;
if ( V_36 ) {
V_16 = F_77 ( V_36 ) ;
F_13 ( V_144 ) ;
goto V_158;
...
V_144 -> V_133 = F_61 () ;
if ( V_144 -> V_133 < 0 ) {
V_16 = F_77 ( V_144 -> V_133 ) ;
F_13 ( V_144 ) ;
if ( F_74 ( & V_137 ) )
F_75 () ;
goto V_158;
}
F_79 ( & V_144 -> V_142 . V_143 , L_23 , & V_159 ) ;
V_158:
F_20 ( & V_156 ) ;
return V_16 ;
}
...
struct V_139 * V_144 ;
V_9 = F_1 ( V_3 ) ;
V_144 = F_2 ( V_3 -> V_160 , struct V_139 , V_142 ) ;
F_13 ( V_9 -> V_90 ) ;
F_13 ( V_9 ) ;
F_18 ( & V_144 -> V_44 ) ;
-- V_144 -> V_150 ;
...
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
F_82 ( V_135 , F_55 ( V_132 , V_9 -> V_133 ) ) ;
F_58 ( & V_9 -> V_38 ) ;
F_37 ( V_9 -> V_49 ) ;
F_60 ( V_9 -> V_49 , V_9 -> V_14 ) ;
F_59 ( V_3 ) ;
}
static struct V_2 * F_83 ( struct V_155 * V_160 )
{
struct V_1 * V_9 ;
struct V_139 * V_144 ;
...
if ( ! V_9 )
return F_77 ( - V_42 ) ;
V_144 = F_2 ( V_160 , struct V_139 , V_142 ) ;
F_18 ( & V_144 -> V_44 ) ;
++ V_144 -> V_150 ;
V_9 -> V_133 = V_144 -> V_133 ;
V_9 -> V_117 = V_144 -> V_161 ;
V_9 -> V_118 = V_144 -> V_162 ;
V_9 -> V_30 = V_144 -> V_30 ;
V_9 -> V_89 = V_144 -> V_89 ;
if ( V_144 -> V_90 ) {
V_9 -> V_90 = F_70 ( V_144 -> V_90 ,
V_144 -> V_89 ,
V_32 ) ;
if ( ! V_9 -> V_90 ) {
F_13 ( V_9 ) ;
...
int F_78 ( struct V_169 * V_170 , int V_7 )
{
int V_36 ;
T_7 V_106 ;
V_135 = F_84 ( V_171 , L_20 ) ;
if ( F_45 ( V_135 ) ) {
V_36 = F_46 ( V_135 ) ;
V_135 = NULL ;
return V_36 ;
}
V_36 = F_85 ( & V_106 , 0 , V_7 , L_20 ) ;
if ( V_36 ) {
F_86 ( V_135 ) ;
V_135 = NULL ;
return V_36 ;
