...
static int F_77 ( struct V_341 * V_363 , unsigned int V_144 )
{
...
static void F_78 ( struct V_341 * V_363 )
{
unsigned long V_67 ;
struct V_17 * V_18 = F_34 ( V_363 -> V_348 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
...
struct V_373 * F_82 ( void )
{
return & V_374 ;
}
const struct V_375 * F_83 ( void )
{
return & V_376 ;
}
...
V_18 -> V_394 [ V_5 ] = F_87 ( & V_18 -> V_379 ,
& V_378 , NULL ) ;
} else {
