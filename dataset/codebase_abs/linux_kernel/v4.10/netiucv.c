...
static T_5 F_98 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
static int F_99 ( const char * V_14 , T_6 V_162 , char * V_163 ,
char * V_15 )
{
const char * V_9 ;
int V_164 ;
...
static T_5 F_101 ( struct V_151 * V_2 , struct V_160 * V_161 ,
...
struct V_10 * V_166 ;
F_37 ( V_83 , 3 , V_84 ) ;
V_53 = F_99 ( V_14 , V_162 , V_163 , V_15 ) ;
if ( V_53 )
return V_53 ;
...
static T_5 F_105 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_38 , F_106 ( V_4 -> V_46 ) ) ;
}
...
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
return sprintf ( V_14 , L_38 , F_106 ( V_4 -> V_11 -> V_46 ) ) ;
}
...
static T_5 F_110 ( struct V_151 * V_2 , struct V_160 * V_161 ,
char * V_14 )
{
struct V_3 * V_4 = F_90 ( V_2 ) ;
F_37 ( V_83 , 5 , V_84 ) ;
...
F_37 ( V_83 , 3 , V_84 ) ;
if ( V_2 ) {
F_126 ( V_2 , L_49 , V_152 -> V_6 ) ;
V_2 -> V_177 = & V_178 ;
V_2 -> V_179 = V_180 ;
V_2 -> V_181 = V_182 ;
V_2 -> V_183 = ( void ( * ) ( struct V_151 * ) ) F_67 ;
V_2 -> V_184 = & V_185 ;
} else
return - V_33 ;
V_176 = F_127 ( V_2 ) ;
...
goto V_212;
V_67 = F_2 ( V_2 ) ;
V_67 -> V_46 = F_135 ( L_52 , V_213 ,
V_214 , V_215 , V_216 ,
V_217 , V_218 , V_127 ) ;
if ( ! V_67 -> V_46 )
goto V_212;
V_67 -> V_11 = F_132 ( V_2 , V_163 , V_15 ) ;
if ( ! V_67 -> V_11 ) {
F_37 ( V_57 , 2 , L_53 ) ;
goto V_219;
}
...
V_226 -> V_177 = & V_178 ;
V_226 -> V_179 = V_180 ;
V_226 -> V_183 = ( void ( * ) ( struct V_151 * ) ) F_67 ;
V_226 -> V_184 = & V_185 ;
V_53 = F_127 ( V_226 ) ;
if ( V_53 ) {
F_128 ( V_226 ) ;
