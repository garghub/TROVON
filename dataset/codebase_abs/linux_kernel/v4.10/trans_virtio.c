...
static int
F_65 ( struct V_3 * V_4 , const char * V_107 , char * args )
{
struct V_5 * V_6 ;
int V_108 = - V_109 ;
int V_110 = 0 ;
F_4 ( & V_8 ) ;
F_66 (chan, &virtio_chan_list, chan_list) {
...
static void F_67 ( struct V_87 * V_12 )
{
...
V_12 -> V_90 -> V_106 ( V_12 ) ;
F_72 ( & ( V_12 -> V_83 . V_99 ) , & V_100 . V_85 ) ;
F_63 ( & ( V_12 -> V_83 . V_99 ) , V_105 ) ;
F_64 ( V_6 -> V_88 ) ;
F_64 ( V_6 -> V_21 ) ;
F_64 ( V_6 ) ;
