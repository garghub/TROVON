...
static struct V_89 * F_53 ( struct V_4 * V_5 )
{
struct V_89 * V_103 ;
struct V_108 * V_108 ;
V_108 = F_30 ( sizeof( struct V_108 ) , V_90 ) ;
if ( ! V_108 )
return NULL ;
V_103 = & V_108 -> V_91 ;
F_54 ( V_5 , V_103 ,
...
F_58 ( V_7 -> V_5 ) ;
V_7 -> V_48 . V_112 = true ;
V_7 -> V_5 -> V_113 . V_114 = V_115 ;
V_7 -> V_5 -> V_113 . V_116 = V_117 ;
V_7 -> V_5 -> V_113 . V_118 = V_7 -> V_119 . V_120 ;
V_7 -> V_5 -> V_113 . V_121 = 24 ;
V_7 -> V_5 -> V_113 . V_122 = 0 ;
F_29 ( V_7 -> V_5 ) ;
V_96 = F_43 ( V_7 -> V_5 ) ;
if ( ! V_96 ) {
F_18 ( L_2 ) ;
