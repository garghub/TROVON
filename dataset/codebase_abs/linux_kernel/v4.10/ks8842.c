...
static void F_56 ( unsigned long V_101 )
{
...
static void F_67 ( unsigned long V_101 )
{
struct V_15 * V_16 = (struct V_15 * ) V_101 ;
struct V_1 * V_2 = F_36 ( V_16 ) ;
T_1 V_115 ;
...
static T_5 F_69 ( int V_125 , void * V_126 )
{
...
F_75 ( & V_132 -> V_129 ) ;
if ( F_41 ( & V_131 -> V_56 ) )
F_54 ( V_2 -> V_58 , F_41 ( & V_131 -> V_56 ) ,
V_95 , V_59 ) ;
F_41 ( & V_131 -> V_56 ) = 0 ;
F_76 ( V_131 -> V_52 ) ;
V_131 -> V_52 = NULL ;
}
static bool F_77 ( struct V_133 * V_60 , void * V_134 )
{
...
F_80 ( V_138 , V_136 ) ;
F_51 ( & V_131 -> V_56 , 1 ) ;
V_131 -> V_60 = F_81 ( V_136 , F_77 ,
( void * ) ( long ) V_131 -> V_139 ) ;
if ( ! V_131 -> V_60 ) {
V_94 = - V_140 ;
goto V_94;
}
V_131 -> V_52 = F_82 ( V_95 , V_141 ) ;
if ( ! V_131 -> V_52 ) {
V_94 = - V_97 ;
goto V_94;
}
...
if ( F_53 ( V_2 -> V_58 , F_41 ( & V_131 -> V_56 ) ) ) {
V_94 = - V_97 ;
F_41 ( & V_131 -> V_56 ) = 0 ;
goto V_94;
}
V_132 -> V_60 = F_81 ( V_136 , F_77 ,
( void * ) ( long ) V_132 -> V_139 ) ;
if ( ! V_132 -> V_60 ) {
V_94 = - V_140 ;
goto V_94;
}
F_83 ( & V_132 -> V_129 , F_56 ,
( unsigned long ) V_16 ) ;
return 0 ;
V_94:
F_73 ( V_2 ) ;
...
F_31 ( V_2 , V_16 -> V_142 ) ;
F_19 ( V_16 , V_2 ) ;
V_94 = F_85 ( V_2 -> V_125 , F_69 , V_143 , V_144 ,
V_16 ) ;
if ( V_94 ) {
...
static int F_91 ( struct V_15 * V_16 , void * V_147 )
{
struct V_1 * V_2 = F_36 ( V_16 ) ;
...
static void F_93 ( struct V_152 * V_153 )
{
struct V_1 * V_2 =
F_94 ( V_153 , struct V_1 , V_145 ) ;
...
struct V_15 * V_16 ;
struct V_1 * V_2 ;
struct V_158 * V_159 = F_98 ( & V_155 -> V_58 ) ;
T_1 V_160 ;
unsigned V_35 ;
V_157 = F_99 ( V_155 , V_161 , 0 ) ;
if ( ! F_100 ( V_157 -> V_162 , F_101 ( V_157 ) , V_144 ) )
goto V_163;
V_16 = F_102 ( sizeof( struct V_1 ) ) ;
if ( ! V_16 )
goto V_164;
F_103 ( V_16 , & V_155 -> V_58 ) ;
V_2 = F_36 ( V_16 ) ;
V_2 -> V_16 = V_16 ;
F_104 ( & V_2 -> V_145 , F_93 ) ;
V_2 -> V_3 = F_105 ( V_157 -> V_162 , F_101 ( V_157 ) ) ;
V_2 -> V_11 = V_157 -> V_44 ;
if ( ! V_2 -> V_3 )
goto V_165;
V_2 -> V_125 = F_106 ( V_155 , 0 ) ;
if ( V_2 -> V_125 < 0 ) {
V_94 = V_2 -> V_125 ;
goto V_166;
}
...
F_83 ( & V_2 -> V_129 , F_67 , ( unsigned long ) V_16 ) ;
F_107 ( & V_2 -> V_45 ) ;
V_16 -> V_170 = & V_171 ;
V_16 -> V_172 = & V_173 ;
V_35 = V_16 -> V_151 ;
...
F_113 ( V_16 ) ;
V_164:
F_114 ( V_157 -> V_162 , F_101 ( V_157 ) ) ;
V_163:
return V_94 ;
}
static int F_115 ( struct V_154 * V_155 )
{
struct V_15 * V_16 = F_116 ( V_155 ) ;
struct V_1 * V_2 = F_36 ( V_16 ) ;
struct V_156 * V_157 = F_99 ( V_155 , V_161 , 0 ) ;
F_117 ( V_16 ) ;
F_75 ( & V_2 -> V_129 ) ;
F_112 ( V_2 -> V_3 ) ;
F_113 ( V_16 ) ;
