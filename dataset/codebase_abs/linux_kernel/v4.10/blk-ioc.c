...
struct V_6 * F_53 ( struct V_1 * V_2 , struct V_18 * V_12 )
{
struct V_6 * V_7 ;
F_10 ( V_12 -> V_20 ) ;
F_54 () ;
...
struct V_6 * F_58 ( struct V_1 * V_2 , struct V_18 * V_12 ,
T_1 V_52 )
{
struct V_10 * V_11 = V_12 -> V_13 -> type ;
struct V_6 * V_7 ;
V_7 = F_41 ( V_11 -> V_26 , V_52 | V_44 ,
V_12 -> V_42 ) ;
if ( ! V_7 )
return NULL ;
if ( F_59 ( V_52 ) < 0 ) {
...
F_62 ( V_12 -> V_20 ) ;
F_39 ( & V_2 -> V_19 ) ;
if ( F_52 ( ! F_63 ( & V_2 -> V_21 , V_12 -> V_22 , V_7 ) ) ) {
F_64 ( & V_7 -> V_23 , & V_2 -> V_30 ) ;
F_65 ( & V_7 -> V_24 , & V_12 -> V_30 ) ;
if ( V_11 -> V_16 . V_53 )
V_11 -> V_16 . V_53 ( V_7 ) ;
} else {
F_7 ( V_11 -> V_26 , V_7 ) ;
