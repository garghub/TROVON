...
if ( V_29 )
return V_29 ;
V_6 -> V_180 . V_127 = F_49 ( V_6 -> V_180 . V_127 ) ;
V_6 -> V_180 . V_128 = F_49 ( V_6 -> V_180 . V_128 ) ;
V_6 -> V_180 . V_114 = F_49 ( V_6 -> V_180 . V_114 ) ;
V_29 = F_102 ( V_6 , V_181 ,
& V_6 -> V_182 ) ;
if ( V_29 )
return V_29 ;
V_6 -> V_182 = F_49 ( V_6 -> V_182 ) ;
F_5 ( L_41 ) ;
V_6 -> V_177 = V_183 ;
return V_29 ;
}
...
int F_104 ( struct V_5 * V_6 , T_5 V_185 ,
...
L_43 , V_114 , V_185 ) ;
V_187 =
F_105 ( V_6 -> V_180 . V_127 , V_6 -> V_180 . V_128 ) ;
F_5 ( L_44 ,
...
int F_110 ( struct V_5 * V_6 , T_5 V_204 )
{
int V_29 = 0 ;
T_4 V_142 ;
T_4 V_205 ;
...
int F_111 ( struct V_5 * V_6 , T_5 V_185 , void * V_186 , T_5 V_114 )
{
int V_29 = 0 ;
int V_193 ;
T_6 * V_36 = V_186 ;
...
int F_112 ( struct V_5 * V_6 , void * V_186 , unsigned int V_114 )
{
int V_29 = 0 ;
T_4 * V_211 = V_186 ;
int V_212 = 0 ;
...
for ( V_129 = 0 ; V_129 < F_113 ( V_217 ) ; V_129 ++ ) {
V_208 = F_107 ( V_217 [ V_129 ] . V_218 ) ;
V_209 = F_106 ( V_217 [ V_129 ] . V_218 ) ;
...
int F_115 ( struct V_5 * V_6 , T_4 V_100 , void * V_186 , T_4 V_114 )
{
...
F_117 () ;
V_29 =
F_118 ( V_6 -> V_34 , V_227 , V_6 -> V_35 , & V_13 ) ;
if ( V_29 < 0 ) {
...
V_29 =
F_118 ( V_6 -> V_34 , V_227 , V_6 -> V_55 , & V_13 ) ;
if ( V_29 < 0 ) {
...
int F_121 ( struct V_5 * V_6 , struct V_27 * V_28 ,
union V_228 * V_228 ,
struct V_229 * V_230 )
{
...
#endif
V_6 -> V_235 . V_236 . V_237 . V_241 =
F_93 ( V_6 -> V_235 . V_236 . V_237 . V_241 ) ;
...
unsigned long V_149 ;
F_88 ( & V_6 -> V_7 . V_59 , V_149 ) ;
if ( ! F_133 ( & V_6 -> V_7 . V_8 ) ||
F_9 ( V_50 , & V_6 -> V_43 ) || V_6 -> V_38 -> V_41 )
goto V_255;
while ( ! F_133 ( & V_6 -> V_7 . V_60 ) ) {
struct V_4 * V_105 ;
int V_29 ;
...
static void F_145 ( struct V_5 * V_6 , union V_30 * V_262 ,
int V_263 )
{
struct V_4 * V_88 ;
int V_290 = 0 ;
...
const T_9 V_292 = ( V_262 -> type & ~ F_93 ( 0x8000 ) ) ;
...
static void F_140 ( struct V_249 * V_38 ,
union V_30 * V_262 )
{
T_4 V_13 ;
...
static void F_142 ( struct V_249 * V_38 , struct V_27 * V_28 )
{
...
T_4 V_244 ;
T_4 V_298 ;
V_262 -> V_299 . V_237 . V_13 = F_49 ( V_262 -> V_299 . V_237 . V_13 ) ;
V_262 -> V_299 . V_237 . time = F_150 ( V_262 -> V_299 . V_237 . time ) ;
switch ( F_151 ( V_262 -> V_299 . V_237 . V_13 ) ) {
case 0 :
...
V_295 = F_153 ( V_298 ) ;
F_154 ( V_28 , sizeof( struct V_302 ) ) ;
memmove ( F_155 ( V_28 , V_295 ) ,
& V_262 -> V_299 . V_237 . V_243 , V_295 ) ;
V_28 -> V_303 = V_38 -> V_45 ;
V_28 -> V_303 -> V_304 = V_259 ;
F_156 ( V_28 , V_244 + V_295 ) ;
memset ( F_141 ( V_28 , V_305 ) , 0xff , V_305 ) ;
F_157 ( V_28 ) ;
F_158 ( V_38 , V_28 ) ;
V_297 = F_159 ( V_28 ) ;
V_297 -> V_306 = V_262 -> V_299 . V_237 . time ;
V_297 -> V_307 = V_262 -> V_299 . V_237 . V_308 ;
V_297 -> signal = V_262 -> V_299 . V_237 . signal - V_6 -> V_309 ;
V_297 -> V_310 = V_262 -> V_299 . V_237 . V_311 - V_6 -> V_309 ;
F_160 ( V_38 , V_28 ) ;
break;
case 7 :
if ( ! F_161 ( V_262 -> V_299 . V_237 . V_13 ) ) {
F_162 ( V_38 , & V_262 -> V_299 ) ;
F_14 ( V_28 ) ;
} else {
F_5 ( L_89 ) ;
}
...
static void F_162 ( struct V_249 * V_38 ,
struct V_312 * V_299 )
{
struct V_302 * V_313 = & V_299 -> V_237 ;
...
struct V_27 * V_28 ;
struct V_5 * V_6 = V_38 -> V_250 ;
V_298 = F_49 ( V_313 -> V_243 ) ;
V_295 = F_153 ( V_298 ) ;
V_314 = F_49 ( V_313 -> V_244 ) ;
V_315 = sizeof( struct V_317 ) + V_295 + V_314 + V_305 ;
if ( V_315 >
( sizeof( struct V_317 ) +
V_318 + V_319 + V_305 ) ) {
F_5 ( L_91 ,
...
( V_6 -> V_321 != 0 ) ) {
struct V_317 * V_322 ;
V_316 = F_141 ( V_28 , sizeof( struct V_317 ) ) ;
V_322 = (struct V_317 * ) V_316 ;
V_322 -> V_323 = F_163 ( V_324 ) ;
V_322 -> V_325 = F_163 ( sizeof( struct V_317 ) ) ;
V_322 -> V_306 = F_164 ( V_313 -> time ) * 1000 ;
V_322 -> V_326 = F_164 ( V_259 ) ;
V_322 -> V_327 = F_163 ( 4 ) ;
V_322 -> V_328 = F_163 ( V_6 -> V_329 ) ;
V_322 -> V_330 = F_163 ( V_313 -> V_308 ) ;
V_322 -> V_331 = F_163 ( 0 ) ;
V_322 -> V_332 = F_163 ( 0 ) ;
V_322 -> V_333 = F_163 ( 3 ) ;
V_322 -> V_334 = F_163 ( V_313 -> signal ) ;
V_322 -> V_335 = F_163 ( V_313 -> V_311 ) ;
V_322 -> V_336 = F_163 ( 0 ) ;
V_322 -> V_337 = F_163 ( 1 ) ;
}
V_316 = F_141 ( V_28 , V_295 ) ;
memcpy ( V_316 , & V_313 -> V_243 , V_295 ) ;
if ( V_314 > 0 ) {
V_316 = F_141 ( V_28 , V_314 ) ;
memcpy ( V_316 , V_299 -> V_36 , V_314 ) ;
if ( * ( V_316 - V_295 + 1 ) & 0x40 )
if ( ( * ( V_316 ) == 0xaa ) && ( * ( V_316 + 1 ) == 0xaa ) )
* ( V_316 - V_295 + 1 ) &= 0xbf ;
}
if ( V_6 -> V_338 ) {
V_316 = F_141 ( V_28 , V_305 ) ;
memset ( V_316 , 0xff , V_305 ) ;
}
F_160 ( V_38 , V_28 ) ;
}
static void F_144 ( struct V_249 * V_38 ,
union V_30 * V_262 )
{
V_262 -> V_339 . V_340 . V_341 =
F_49 ( V_262 -> V_339 . V_340 . V_341 ) ;
F_165 ( V_38 , & V_262 -> V_339 . V_340 ) ;
}
...
V_88 -> V_79 = V_347 ;
F_168 ( & V_88 -> V_10 , & V_6 -> V_7 . V_60 ) ;
F_89 ( & V_6 -> V_7 . V_59 , V_149 ) ;
F_26 ( V_6 ) ;
return 0 ;
}
static int F_114 ( T_4 V_216 )
{
switch ( V_216 ) {
case V_224 :
case V_348 :
