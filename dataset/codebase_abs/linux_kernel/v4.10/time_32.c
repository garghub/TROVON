...
V_23 -> V_63 = F_28 ( 100 , V_23 ) ;
F_13 ( V_23 ) ;
}
static unsigned char F_29 ( struct V_64 * V_65 , T_4 V_66 )
{
struct V_67 * V_68 = F_30 ( V_65 ) ;
struct V_69 * V_70 = V_68 -> V_65 . V_71 ;
return F_31 ( V_70 -> V_72 + V_66 ) ;
}
static void F_32 ( struct V_64 * V_65 , T_4 V_66 , T_6 V_38 )
{
struct V_67 * V_68 = F_30 ( V_65 ) ;
struct V_69 * V_70 = V_68 -> V_65 . V_71 ;
F_33 ( V_38 , V_70 -> V_72 + V_66 ) ;
}
static int F_34 ( struct V_67 * V_73 )
{
struct V_74 * V_75 = V_73 -> V_65 . V_76 ;
const char * V_77 = F_35 ( V_75 , L_3 , NULL ) ;
if ( ! V_77 )
return - V_78 ;
if ( ! F_36 ( V_75 , L_4 , NULL ) )
return - V_78 ;
V_79 . V_80 = & V_73 -> V_80 [ 0 ] ;
if ( ! strcmp ( V_77 , L_5 ) ) {
V_81 . V_72 = F_37 ( & V_73 -> V_80 [ 0 ] , 0 ,
2048 , L_6 ) ;
V_81 . type = V_82 ;
