...
V_23 = F_16 ( V_12 , V_4 -> V_53 . V_54 ) ;
memcpy ( V_23 , V_4 -> V_53 . V_55 ,
V_4 -> V_53 . V_54 ) ;
V_4 -> V_53 . V_54 = 0 ;
break;
case V_35 :
...
int F_20 ( struct V_1 * V_2 , struct V_11 * V_12 , int * V_61 , int * V_10 , int * V_62 ,
int * V_63 , int * V_64 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned char * V_65 ;
...
void F_23 ( struct V_1 * V_2 , int V_80 , unsigned char V_58 ,
unsigned char V_59 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_1 ( V_2 ) ;
