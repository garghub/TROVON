...
static int F_55 ( struct V_2 * V_3 , T_2 V_106 ,
...
struct V_9 * V_10 = V_5 -> V_11 ;
struct V_110 * V_111 ;
V_111 = F_45 ( sizeof( * V_111 ) , V_14 ) ;
if ( ! V_111 )
return - V_15 ;
V_111 -> V_106 = V_106 ;
V_111 -> V_107 = F_56 ( V_107 ) ;
V_111 -> V_108 = F_46 ( V_108 ) ;
V_111 -> V_109 = F_46 ( V_109 ) ;
V_13 = F_4 ( V_10 , F_5 ( V_10 , 0 ) ,
V_112 ,
V_16 | V_17 |
V_18 , 0 , 0 , V_111 ,
...
V_111 -> V_107 [ V_37 ] = F_56 ( V_107 [ V_37 ] ) ;
V_13 = F_4 ( V_10 , F_5 ( V_10 , 0 ) ,
V_116 ,
V_16 | V_17 |
V_18 , 0 , 0 , V_111 ,
...
static int F_59 ( struct V_2 * V_3 , T_6 * V_107 )
{
int V_13 ;
struct V_1 * V_5 = F_1 ( V_3 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
T_7 * V_117 ;
V_117 = F_45 ( sizeof( * V_117 ) , V_14 ) ;
if ( ! V_117 )
return - V_15 ;
V_13 = F_4 ( V_10 , F_60 ( V_10 , 0 ) ,
V_118 ,
V_119 | V_17 |
V_18 , 0 , 0 , V_117 ,
sizeof( * V_117 ) ,
...
static int F_62 ( struct V_22 * V_22 )
{
...
static void F_69 ( struct V_22 * V_22 )
{
...
static struct V_132 * F_72 ( void * V_133 , T_1 V_7 , T_2 type )
{
struct V_132 * V_134 ;
if ( V_7 + sizeof( * V_134 -> V_6 ) > V_135 )
return NULL ;
V_134 = F_45 ( sizeof( * V_134 ) , V_14 ) ;
if ( ! V_134 )
return NULL ;
F_73 ( & V_134 -> V_136 ) ;
V_134 -> V_6 = F_45 ( sizeof( * V_134 -> V_6 ) + V_7 , V_14 ) ;
if ( ! V_134 -> V_6 )
goto V_137;
V_134 -> V_138 = F_45 ( sizeof( * V_134 -> V_138 ) , V_14 ) ;
if ( ! V_134 -> V_138 )
goto V_139;
V_134 -> V_6 -> type = type ;
V_134 -> V_6 -> V_7 = F_13 ( sizeof( * V_134 -> V_6 ) + V_7 ) ;
...
static void F_75 ( struct V_132 * V_134 )
{
F_7 ( V_134 -> V_6 ) ;
F_7 ( V_134 -> V_138 ) ;
F_7 ( V_134 ) ;
}
static struct V_132 * F_76 ( struct V_1 * V_5 , T_8 V_141 )
{
struct V_132 * V_134 ;
F_77 (rpc, &es2->arpcs, list) {
if ( V_134 -> V_6 -> V_141 == V_141 )
return V_134 ;
}
return NULL ;
}
static void F_78 ( struct V_1 * V_5 , struct V_132 * V_134 )
{
V_134 -> V_142 = true ;
V_134 -> V_6 -> V_141 = F_13 ( V_5 -> V_143 ++ ) ;
F_79 ( & V_134 -> V_136 , & V_5 -> V_144 ) ;
}
static void F_80 ( struct V_1 * V_5 , struct V_132 * V_134 )
{
if ( V_134 -> V_142 ) {
V_134 -> V_142 = false ;
F_81 ( & V_134 -> V_136 ) ;
...
static int F_82 ( struct V_1 * V_5 , struct V_132 * V_134 , int V_94 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
int V_13 ;
V_13 = F_4 ( V_10 , F_5 ( V_10 , 0 ) ,
...
V_18 ,
0 , 0 ,
V_134 -> V_6 , F_83 ( V_134 -> V_6 -> V_7 ) ,
V_19 ) ;
if ( V_13 != F_83 ( V_134 -> V_6 -> V_7 ) ) {
F_6 ( & V_10 -> V_20 ,
L_28 ,
V_134 -> V_6 -> type , V_13 ) ;
if ( V_13 > 0 )
...
static int F_48 ( struct V_1 * V_5 , T_2 type , void * V_133 ,
...
if ( V_96 )
* V_96 = 0 ;
V_134 = F_72 ( V_133 , V_7 , type ) ;
if ( ! V_134 )
return - V_15 ;
F_23 ( & V_5 -> V_146 , V_43 ) ;
F_78 ( V_5 , V_134 ) ;
F_24 ( & V_5 -> V_146 , V_43 ) ;
V_13 = F_82 ( V_5 , V_134 , V_94 ) ;
if ( V_13 )
goto V_147;
V_13 = F_84 (
& V_134 -> V_140 ,
...
static void F_88 ( struct V_1 * V_5 , char * V_26 )
{
int V_13 ;
do {
V_13 = F_4 ( V_5 -> V_11 ,
...
V_19 ) ;
if ( V_13 > 0 )
F_89 ( & V_5 -> V_153 , V_26 , V_13 ) ;
} while ( V_13 > 0 );
}
static int F_90 ( void * V_12 )
{
struct V_1 * V_5 = V_12 ;
char * V_26 ;
V_26 = F_12 ( V_152 , V_14 ) ;
if ( ! V_26 )
return - V_15 ;
while ( ! F_91 () ) {
F_92 ( 1000 ) ;
...
static T_9 F_93 ( struct V_154 * V_155 , char T_10 * V_26 ,
T_4 V_106 , T_11 * V_156 )
{
struct V_1 * V_5 = F_94 ( V_155 ) -> V_157 ;
T_9 V_36 ;
T_4 V_158 ;
char * V_159 ;
if ( V_106 > V_160 )
V_106 = V_160 ;
V_159 = F_12 ( V_106 , V_14 ) ;
if ( ! V_159 )
return - V_15 ;
V_158 = F_95 ( & V_5 -> V_153 , V_159 , V_106 ) ;
V_36 = F_96 ( V_26 , V_106 , V_156 , V_159 , V_158 ) ;
F_7 ( V_159 ) ;
return V_36 ;
}
...
if ( ! F_98 ( V_5 -> V_161 ) )
return;
V_5 -> V_161 = F_99 ( F_90 , V_5 , L_34 ) ;
if ( F_100 ( V_5 -> V_161 ) )
return;
V_5 -> V_162 = F_101 ( L_34 , V_163 ,
F_102 () , V_5 ,
& V_164 ) ;
}
...
static T_9 F_104 ( struct V_154 * V_155 , char T_10 * V_26 ,
T_4 V_106 , T_11 * V_156 )
{
struct V_1 * V_5 = F_94 ( V_155 ) -> V_157 ;
int V_165 = ! F_98 ( V_5 -> V_161 ) ;
char V_159 [ 3 ] ;
sprintf ( V_159 , L_35 , V_165 ) ;
return F_96 ( V_26 , V_106 , V_156 , V_159 , 3 ) ;
}
static T_9 F_105 ( struct V_154 * V_155 , const char T_10 * V_26 ,
T_4 V_106 , T_11 * V_156 )
{
int V_165 ;
T_9 V_13 ;
struct V_1 * V_5 = F_94 ( V_155 ) -> V_157 ;
V_13 = F_106 ( V_26 , V_106 , 10 , & V_165 ) ;
if ( V_13 )
return V_13 ;
if ( V_165 )
F_97 ( V_5 ) ;
...
V_3 = F_112 ( & V_180 , & V_10 -> V_20 , V_181 ,
V_77 ) ;
if ( F_100 ( V_3 ) ) {
F_68 ( V_10 ) ;
return F_113 ( V_3 ) ;
...
goto error;
V_173 = V_170 -> V_183 ;
for ( V_37 = 0 ; V_37 < V_173 -> V_184 . V_185 ; ++ V_37 ) {
V_175 = & V_173 -> V_175 [ V_37 ] . V_184 ;
V_176 = V_175 -> V_186 ;
if ( F_118 ( V_175 ) ) {
if ( ! V_178 ) {
V_5 -> V_35 . V_175 = V_176 ;
V_178 = true ;
} else if ( ! V_179 ) {
V_5 -> V_187 = V_176 ;
V_179 = true ;
...
V_60 = F_12 ( V_181 , V_14 ) ;
if ( ! V_60 ) {
V_13 = - V_15 ;
goto error;
}
F_32 ( V_22 , V_10 ,
F_120 ( V_10 , V_5 -> V_35 . V_175 ) ,
V_60 , V_181 ,
F_69 , V_3 ) ;
