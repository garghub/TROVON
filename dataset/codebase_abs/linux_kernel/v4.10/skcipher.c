...
F_123 ( V_119 , L_9 , V_89 -> V_43 ) ;
}
static int F_124 ( struct V_124 * V_125 , struct V_71 * V_72 )
{
struct V_126 V_127 ;
struct V_112 * V_89 = F_121 ( V_72 , struct V_112 ,
V_66 ) ;
strncpy ( V_127 . type , L_10 , sizeof( V_127 . type ) ) ;
strncpy ( V_127 . V_128 , L_11 , sizeof( V_127 . V_128 ) ) ;
V_127 . V_53 = V_72 -> V_122 ;
V_127 . V_123 = V_89 -> V_123 ;
V_127 . V_103 = V_89 -> V_103 ;
V_127 . V_37 = V_89 -> V_37 ;
if ( F_125 ( V_125 , V_129 ,
sizeof( struct V_126 ) , & V_127 ) )
goto V_130;
return 0 ;
V_130:
return - V_131 ;
...
int F_126 ( struct V_133 * V_134 ,
const char * V_135 , T_3 type , T_3 V_136 )
{
V_134 -> V_66 . V_137 = & V_138 ;
return F_127 ( & V_134 -> V_66 , V_135 , type , V_136 ) ;
}
struct V_63 * F_128 ( const char * V_139 ,
T_3 type , T_3 V_136 )
{
return F_129 ( V_139 , & V_138 , type , V_136 ) ;
}
int F_130 ( const char * V_139 , T_3 type , T_3 V_136 )
{
return F_131 ( V_139 , & V_138 ,
type , V_136 ) ;
}
static int F_132 ( struct V_112 * V_72 )
{
struct V_71 * V_66 = & V_72 -> V_66 ;
if ( V_72 -> V_37 > V_44 / 8 || V_72 -> V_43 > V_44 / 8 )
return - V_33 ;
if ( ! V_72 -> V_43 )
V_72 -> V_43 = V_66 -> V_122 ;
V_66 -> V_73 = & V_138 ;
V_66 -> V_120 &= ~ V_100 ;
V_66 -> V_120 |= V_140 ;
return 0 ;
...
int F_137 ( struct V_112 * V_141 , int V_142 )
{
int V_143 , V_144 ;
for ( V_143 = 0 ; V_143 < V_142 ; V_143 ++ ) {
V_144 = F_133 ( & V_141 [ V_143 ] ) ;
if ( V_144 )
goto V_25;
}
return 0 ;
...
void F_138 ( struct V_112 * V_141 , int V_142 )
{
int V_143 ;
for ( V_143 = V_142 - 1 ; V_143 >= 0 ; -- V_143 )
F_135 ( & V_141 [ V_143 ] ) ;
}
int F_139 ( struct V_145 * V_146 ,
struct V_116 * V_115 )
{
int V_25 ;
...
if ( V_25 )
return V_25 ;
return F_140 ( V_146 , F_141 ( V_115 ) ) ;
}
