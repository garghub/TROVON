...
V_169 -> V_48 . V_49 . type = V_208 ;
V_169 -> V_48 . V_49 . V_209 = sizeof( V_169 -> V_48 ) ;
V_169 -> V_48 . V_210 = V_203 -> V_210 ;
...
if ( V_12 -> V_48 ) {
V_31 -> V_46 [ V_31 -> V_47 ++ ] = V_211 ;
V_31 -> V_46 [ V_31 -> V_47 ++ ] = V_212 | V_213 ;
V_31 -> V_46 [ V_31 -> V_47 ++ ] = V_182 ;
V_31 -> V_46 [ V_31 -> V_47 ++ ] = V_214 ;
} else {
V_31 -> V_46 [ V_31 -> V_47 ++ ] = V_211 ;
V_31 -> V_46 [ V_31 -> V_47 ++ ] = V_212 ;
}
V_69 = V_31 -> V_47 + V_203 -> V_215 * 2 + V_203 -> V_216 * 2 + 2 ;
if ( V_69 > V_217 ) {
F_7 ( V_10 , L_15 ) ;
V_17 = - V_80 ;
goto V_218;
...
( void V_151 * ) V_205 ,
sizeof( * V_205 ) * V_203 -> V_215 ) ) {
V_17 = - V_87 ;
goto V_218;
}
V_31 -> V_47 += V_203 -> V_215 * 2 ;
V_17 = F_82 ( V_10 , V_12 , V_203 -> V_215 , false ) ;
if ( V_17 < 0 )
goto V_218;
V_12 -> V_19 . V_143 = V_203 -> V_216 ;
if ( V_203 -> V_216 ) {
struct V_204 * V_219 ;
V_219 = (struct V_204 * )
...
if ( F_56 ( V_31 -> V_46 + V_31 -> V_47 ,
( void V_151 * ) V_219 ,
sizeof( * V_219 ) * V_203 -> V_216 ) ) {
V_17 = - V_87 ;
goto V_218;
}
V_31 -> V_47 += V_203 -> V_216 * 2 ;
V_17 = F_82 ( V_10 , V_12 , V_203 -> V_216 , true ) ;
if ( V_17 < 0 )
goto V_218;
...
if ( ! V_2 )
return - V_27 ;
V_2 -> V_160 = F_101 ( L_19 ,
sizeof( struct V_153 ) , 0 , 0 , NULL ) ;
if ( ! V_2 -> V_160 )
return - V_27 ;
V_2 -> V_10 = V_10 ;
V_2 -> V_185 = F_102 ( L_20 ) ;
if ( ! V_2 -> V_185 ) {
F_7 ( V_10 , L_21 ) ;
V_17 = - V_80 ;
goto V_233;
