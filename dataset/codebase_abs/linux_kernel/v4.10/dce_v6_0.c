...
V_124 . V_118 = F_40 ( V_135 + 512 ) ;
V_147 . V_118 = F_40 ( V_112 -> V_123 ) ;
V_124 . V_118 = F_41 ( V_124 , V_147 ) ;
V_147 . V_118 = F_40 ( V_146 ) ;
V_124 . V_118 = F_41 ( V_147 , V_124 ) ;
V_41 = F_48 ( F_43 ( V_117 ) , F_43 ( V_124 ) ) ;
V_124 . V_118 = F_40 ( 1000 ) ;
V_147 . V_118 = F_40 ( V_112 -> V_123 ) ;
V_124 . V_118 = F_41 ( V_147 , V_124 ) ;
V_147 . V_118 = F_40 ( V_112 -> V_133 ) ;
V_124 . V_118 = F_42 ( V_124 , V_147 ) ;
V_144 = F_48 ( V_41 , F_43 ( V_124 ) ) ;
...
static bool F_51 ( struct V_111 * V_112 )
{
if ( F_49 ( V_112 ) <=
...
V_159 = 1000000 / ( T_1 ) V_155 -> clock ;
V_129 = F_48 ( ( T_1 ) V_155 -> V_169 * V_159 , ( T_1 ) 65535 ) ;
V_164 = 0 ;
V_166 = 0 ;
V_115 = F_38 ( V_2 ) ;
if ( V_2 -> V_170 . V_171 ) {
...
V_158 . V_114 = V_2 -> V_170 . V_172 * 10 ;
V_158 . V_121 = V_2 -> V_170 . V_173 * 10 ;
}
V_158 . V_123 = V_155 -> clock ;
V_158 . V_130 = V_155 -> V_174 ;
V_158 . V_131 = V_155 -> V_174 * V_159 ;
...
V_157 . V_114 = V_2 -> V_170 . V_172 * 10 ;
V_157 . V_121 = V_2 -> V_170 . V_173 * 10 ;
}
V_157 . V_123 = V_155 -> clock ;
V_157 . V_130 = V_155 -> V_174 ;
V_157 . V_131 = V_155 -> V_174 * V_159 ;
...
V_157 . V_115 = V_115 ;
V_157 . V_141 = V_141 ;
V_160 = F_48 ( F_50 ( & V_158 ) , ( T_1 ) 65535 ) ;
V_161 = F_48 ( F_50 ( & V_157 ) , ( T_1 ) 65535 ) ;
if ( ! F_51 ( & V_158 ) ||
! F_52 ( & V_158 ) ||
! F_53 ( & V_158 ) ||
( V_2 -> V_14 . V_179 == 2 ) ) {
...
( ( V_161 << V_185 ) |
( V_129 << V_186 ) ) ) ;
F_14 ( V_183 + V_23 -> V_26 , V_167 ) ;
F_14 ( V_187 + V_23 -> V_26 , V_164 ) ;
F_14 ( V_188 + V_23 -> V_26 , V_166 ) ;
V_23 -> V_129 = V_129 ;
V_23 -> V_158 = V_160 ;
}
...
V_151 = F_59 ( V_2 , V_2 -> V_14 . V_24 [ V_13 ] , V_196 , V_197 ) ;
F_54 ( V_2 , V_2 -> V_14 . V_24 [ V_13 ] , V_151 , V_141 ) ;
V_151 = F_59 ( V_2 , V_2 -> V_14 . V_24 [ V_13 + 1 ] , V_197 , V_196 ) ;
F_54 ( V_2 , V_2 -> V_14 . V_24 [ V_13 + 1 ] , V_151 , V_141 ) ;
}
}
...
static void F_67 ( struct V_89 * V_90 , bool V_201 )
{
struct V_44 * V_45 = V_90 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
struct V_92 * V_92 = F_34 ( V_90 ) ;
...
F_63 ( V_2 , V_203 -> V_205 -> V_200 , false ) ;
...
int V_13 ;
for ( V_13 = 0 ; V_13 < V_2 -> V_14 . V_208 ; V_13 ++ ) {
F_71 ( V_2 -> V_14 . V_205 [ V_13 ] ) ;
V_2 -> V_14 . V_205 [ V_13 ] = NULL ;
}
}
static void F_74 ( struct V_214 * V_6 , bool V_201 )
{
...
static void F_75 ( struct V_214 * V_6 , bool V_201 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
struct V_44 * V_45 = V_6 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
...
static int F_76 ( struct V_214 * V_6 ,
struct V_218 * V_219 ,
...
V_224 = F_78 ( V_6 -> V_243 -> V_219 ) ;
V_225 = V_6 -> V_243 -> V_219 ;
}
V_227 = V_224 -> V_227 ;
V_229 = F_79 ( V_227 ) ;
V_239 = F_80 ( V_229 , false ) ;
if ( F_81 ( V_239 != 0 ) )
return V_239 ;
if ( V_222 ) {
V_230 = F_82 ( V_229 ) ;
} else {
V_239 = F_83 ( V_229 , V_244 , & V_230 ) ;
if ( F_81 ( V_239 != 0 ) ) {
F_84 ( V_229 ) ;
return - V_32 ;
}
...
default:
F_72 ( L_11 ,
F_89 ( V_225 -> V_245 , & V_242 ) ) ;
return - V_32 ;
}
if ( F_90 ( V_231 , V_273 ) == V_274 ) {
unsigned V_275 , V_276 , V_277 , V_278 , V_279 ;
V_275 = F_90 ( V_231 , V_280 ) ;
V_276 = F_90 ( V_231 , V_281 ) ;
V_277 = F_90 ( V_231 , V_282 ) ;
V_278 = F_90 ( V_231 , V_283 ) ;
V_279 = F_90 ( V_231 , V_284 ) ;
V_232 |= F_91 ( V_279 ) ;
V_232 |= F_92 ( V_285 ) ;
V_232 |= F_93 ( V_278 ) ;
V_232 |= F_94 ( V_275 ) ;
V_232 |= F_95 ( V_276 ) ;
V_232 |= F_96 ( V_277 ) ;
} else if ( F_90 ( V_231 , V_273 ) == V_286 ) {
V_232 |= F_92 ( V_287 ) ;
}
V_234 = F_90 ( V_231 , V_288 ) ;
V_232 |= F_97 ( V_234 ) ;
F_74 ( V_6 , false ) ;
...
V_233 = V_225 -> V_302 [ 0 ] / ( V_225 -> V_303 / 8 ) ;
...
static void F_100 ( struct V_214 * V_6 ,
struct V_154 * V_155 )
{
struct V_44 * V_45 = V_6 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
...
static void F_101 ( struct V_214 * V_6 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
struct V_44 * V_45 = V_6 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
...
static int F_103 ( struct V_89 * V_90 )
{
struct V_92 * V_92 = F_34 ( V_90 ) ;
struct V_202 * V_203 = V_92 -> V_204 ;
switch ( V_92 -> V_207 ) {
...
return 6 ;
default:
F_72 ( L_14 , V_92 -> V_207 ) ;
return 0 ;
}
}
static T_1 F_104 ( struct V_214 * V_6 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
struct V_44 * V_45 = V_6 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
...
static void F_109 ( struct V_214 * V_6 , bool V_361 )
{
...
static void F_110 ( struct V_214 * V_6 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
struct V_1 * V_2 = V_6 -> V_45 -> V_91 ;
F_111 ( V_365 + V_23 -> V_26 ,
( V_366 << V_367 ) |
( V_368 << V_369 ) ) ;
}
...
static int F_114 ( struct V_214 * V_6 ,
int V_220 , int V_221 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
struct V_1 * V_2 = V_6 -> V_45 -> V_91 ;
...
V_220 += V_6 -> V_220 ;
V_221 += V_6 -> V_221 ;
F_68 ( L_16 , V_220 , V_221 , V_6 -> V_220 , V_6 -> V_221 ) ;
if ( V_220 < 0 ) {
...
static int F_115 ( struct V_214 * V_6 ,
int V_220 , int V_221 )
{
int V_386 ;
F_109 ( V_6 , true ) ;
V_386 = F_114 ( V_6 , V_220 , V_221 ) ;
F_109 ( V_6 , false ) ;
return V_386 ;
}
...
if ( ( V_299 > V_23 -> V_380 ) ||
( V_301 > V_23 -> V_381 ) ) {
F_72 ( L_17 , V_299 , V_301 ) ;
return - V_32 ;
}
V_227 = F_117 ( V_388 , V_389 ) ;
if ( ! V_227 ) {
F_72 ( L_18 , V_389 , V_23 -> V_20 ) ;
return - V_394 ;
}
V_392 = F_79 ( V_227 ) ;
V_386 = F_80 ( V_392 , false ) ;
if ( V_386 != 0 ) {
F_118 ( V_227 ) ;
return V_386 ;
}
V_386 = F_83 ( V_392 , V_244 , & V_23 -> V_371 ) ;
F_84 ( V_392 ) ;
if ( V_386 ) {
F_72 ( L_19 , V_386 ) ;
F_118 ( V_227 ) ;
...
V_393:
if ( V_23 -> V_397 ) {
struct V_228 * V_392 = F_79 ( V_23 -> V_397 ) ;
V_386 = F_80 ( V_392 , false ) ;
if ( F_119 ( V_386 == 0 ) ) {
F_99 ( V_392 ) ;
F_84 ( V_392 ) ;
...
static void F_120 ( struct V_214 * V_6 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
if ( V_23 -> V_397 ) {
F_109 ( V_6 , true ) ;
F_114 ( V_6 , V_23 -> V_378 ,
V_23 -> V_379 ) ;
F_112 ( V_6 ) ;
F_109 ( V_6 , false ) ;
}
}
static int F_121 ( struct V_214 * V_6 , T_7 * V_398 , T_7 * V_399 ,
T_7 * V_400 , T_5 V_401 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
int V_13 ;
...
static void F_124 ( struct V_214 * V_6 , int V_155 )
{
struct V_44 * V_45 = V_6 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
struct V_23 * V_23 = F_36 ( V_6 ) ;
...
F_125 ( V_6 , V_403 ) ;
F_126 ( V_6 , V_404 ) ;
type = F_127 ( V_2 , V_23 -> V_20 ) ;
F_128 ( V_2 , & V_2 -> V_405 , type ) ;
F_128 ( V_2 , & V_2 -> V_19 , type ) ;
F_129 ( V_6 ) ;
F_101 ( V_6 ) ;
break;
case V_406 :
...
static void F_132 ( struct V_214 * V_6 )
{
F_133 ( V_6 , V_404 ) ;
F_134 ( V_6 , V_403 ) ;
F_124 ( V_6 , V_408 ) ;
}
static void F_135 ( struct V_214 * V_6 )
{
F_124 ( V_6 , V_402 ) ;
F_134 ( V_6 , V_404 ) ;
}
static void F_136 ( struct V_214 * V_6 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
struct V_44 * V_45 = V_6 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
...
V_13 != V_23 -> V_20 &&
V_23 -> V_411 == V_2 -> V_14 . V_24 [ V_13 ] -> V_411 ) {
goto V_412;
}
}
switch ( V_23 -> V_411 ) {
case V_360 :
case V_359 :
F_137 ( V_6 , V_23 -> V_20 , V_23 -> V_411 ,
0 , 0 , V_404 , 0 , 0 , 0 , 0 , 0 , false , & V_410 ) ;
break;
default:
break;
}
...
static int F_138 ( struct V_214 * V_6 ,
struct V_154 * V_155 ,
struct V_154 * V_414 ,
int V_220 , int V_221 , struct V_218 * V_415 )
{
struct V_23 * V_23 = F_36 ( V_6 ) ;
if ( ! V_23 -> V_413 )
return - V_32 ;
F_139 ( V_6 , V_414 ) ;
F_140 ( V_6 , V_414 ) ;
F_76 ( V_6 , V_415 , V_220 , V_221 , 0 ) ;
F_141 ( V_6 , V_155 , V_414 ) ;
F_142 ( V_6 ) ;
F_120 ( V_6 ) ;
V_23 -> V_416 = * V_414 ;
return 0 ;
}
static bool F_143 ( struct V_214 * V_6 ,
...
if ( ! F_144 ( V_6 , V_155 , V_414 ) )
return false ;
if ( F_145 ( V_6 , V_414 ) )
return false ;
V_23 -> V_411 = F_104 ( V_6 ) ;
if ( ( V_23 -> V_411 == V_357 ) &&
! F_105 ( F_106 ( V_23 -> V_90 ) ) )
return false ;
return true ;
}
static int F_146 ( struct V_214 * V_6 , int V_220 , int V_221 ,
struct V_218 * V_415 )
{
return F_76 ( V_6 , V_415 , V_220 , V_221 , 0 ) ;
}
static int F_147 ( struct V_214 * V_6 ,
struct V_218 * V_219 ,
int V_220 , int V_221 , enum V_417 V_418 )
{
return F_76 ( V_6 , V_219 , V_220 , V_221 , 1 ) ;
}
static int F_148 ( struct V_1 * V_2 , int V_419 )
{
struct V_23 * V_23 ;
int V_13 ;
V_23 = F_70 ( sizeof( struct V_23 ) +
( V_420 * sizeof( struct V_47 * ) ) , V_210 ) ;
if ( V_23 == NULL )
return - V_213 ;
F_149 ( V_2 -> V_46 , & V_23 -> V_156 , & V_421 ) ;
F_150 ( & V_23 -> V_156 , 256 ) ;
V_23 -> V_20 = V_419 ;
V_2 -> V_14 . V_24 [ V_419 ] = V_23 ;
V_23 -> V_380 = V_422 ;
V_23 -> V_381 = V_423 ;
V_2 -> V_46 -> V_424 . V_377 = V_23 -> V_380 ;
V_2 -> V_46 -> V_424 . V_385 = V_23 -> V_381 ;
for ( V_13 = 0 ; V_13 < 256 ; V_13 ++ ) {
...
V_23 -> V_90 = NULL ;
V_23 -> V_48 = NULL ;
F_151 ( & V_23 -> V_156 , & V_425 ) ;
return 0 ;
}
static int F_152 ( void * V_389 )
{
...
static int F_155 ( void * V_389 )
{
int V_239 , V_13 ;
bool V_386 ;
struct V_1 * V_2 = (struct V_1 * ) V_389 ;
for ( V_13 = 0 ; V_13 < V_2 -> V_14 . V_15 ; V_13 ++ ) {
V_239 = F_156 ( V_2 , V_13 + 1 , & V_2 -> V_405 ) ;
if ( V_239 )
return V_239 ;
}
for ( V_13 = 8 ; V_13 < 20 ; V_13 += 2 ) {
V_239 = F_156 ( V_2 , V_13 , & V_2 -> V_19 ) ;
if ( V_239 )
return V_239 ;
}
V_239 = F_156 ( V_2 , 42 , & V_2 -> V_56 ) ;
if ( V_239 )
return V_239 ;
V_2 -> V_14 . V_198 = true ;
V_2 -> V_46 -> V_424 . V_428 = & V_429 ;
V_2 -> V_46 -> V_424 . V_430 = true ;
V_2 -> V_46 -> V_424 . V_431 = 16384 ;
V_2 -> V_46 -> V_424 . V_432 = 16384 ;
V_2 -> V_46 -> V_424 . V_433 = 24 ;
V_2 -> V_46 -> V_424 . V_434 = 1 ;
V_2 -> V_46 -> V_424 . V_435 = V_2 -> V_71 . V_436 ;
V_239 = F_157 ( V_2 ) ;
if ( V_239 )
return V_239 ;
V_2 -> V_46 -> V_424 . V_431 = 16384 ;
...
static int F_164 ( void * V_389 )
{
int V_13 ;
struct V_1 * V_2 = (struct V_1 * ) V_389 ;
F_165 ( V_2 ) ;
F_166 ( V_2 , V_2 -> clock . V_438 ) ;
F_19 ( V_2 ) ;
for ( V_13 = 0 ; V_13 < V_2 -> V_14 . V_439 . V_440 ; V_13 ++ ) {
F_63 ( V_2 , & V_2 -> V_14 . V_439 . V_200 [ V_13 ] , false ) ;
}
F_9 ( V_2 ) ;
return 0 ;
}
static int F_167 ( void * V_389 )
{
int V_13 ;
struct V_1 * V_2 = (struct V_1 * ) V_389 ;
F_22 ( V_2 ) ;
...
T_8 V_442 = F_170 ( V_2 ,
V_2 -> V_14 . V_441 ) ;
F_171 ( V_2 , V_2 -> V_14 . V_441 ,
V_442 ) ;
}
return V_386 ;
}
static bool F_172 ( void * V_389 )
{
return true ;
}
static int F_173 ( void * V_389 )
{
return 0 ;
}
static int F_174 ( void * V_389 )
{
F_2 ( L_21 ) ;
return 0 ;
}
...
switch ( V_418 ) {
case V_452 :
V_445 = F_5 ( V_453 + V_444 ) ;
V_445 &= ~ V_454 ;
F_14 ( V_453 + V_444 , V_445 ) ;
break;
case V_455 :
V_445 = F_5 ( V_453 + V_444 ) ;
V_445 |= V_454 ;
...
switch ( V_418 ) {
case V_452 :
V_458 = F_5 ( V_42 + V_39 [ type ] ) ;
V_458 &= ~ V_459 ;
F_14 ( V_42 + V_39 [ type ] , V_458 ) ;
break;
case V_455 :
V_458 = F_5 ( V_42 + V_39 [ type ] ) ;
V_458 |= V_459 ;
...
struct V_473 * V_474 )
{
unsigned V_6 = V_474 -> V_475 - 1 ;
T_5 V_476 = F_5 ( V_477 [ V_6 ] . V_4 ) ;
unsigned V_478 = F_127 ( V_2 , V_6 ) ;
switch ( V_474 -> V_479 ) {
case 0 :
if ( V_476 & V_477 [ V_6 ] . V_480 )
F_14 ( V_481 + V_8 [ V_6 ] , V_482 ) ;
else
F_68 ( L_24 ) ;
if ( F_180 ( V_2 , V_472 , V_478 ) ) {
F_181 ( V_2 -> V_46 , V_6 ) ;
}
F_68 ( L_25 , V_6 + 1 ) ;
break;
case 1 :
if ( V_476 & V_477 [ V_6 ] . V_483 )
...
break;
default:
F_68 ( L_27 , V_474 -> V_475 , V_474 -> V_479 ) ;
break;
}
return 0 ;
}
...
struct V_23 * V_23 ;
struct V_488 * V_489 ;
V_20 = ( V_474 -> V_475 - 8 ) >> 1 ;
V_23 = V_2 -> V_14 . V_24 [ V_20 ] ;
if ( V_20 >= V_2 -> V_14 . V_15 ) {
F_72 ( L_28 , V_20 ) ;
return - V_32 ;
}
if ( F_5 ( V_490 + V_8 [ V_20 ] ) &
V_491 )
F_14 ( V_490 + V_8 [ V_20 ] ,
V_492 ) ;
if ( V_23 == NULL )
return 0 ;
F_184 ( & V_2 -> V_46 -> V_493 , V_175 ) ;
V_489 = V_23 -> V_494 ;
if ( V_23 -> V_495 != V_496 ) {
F_185 ( L_29
L_30 ,
V_23 -> V_495 ,
V_496 ) ;
F_186 ( & V_2 -> V_46 -> V_493 , V_175 ) ;
return 0 ;
}
V_23 -> V_495 = V_497 ;
V_23 -> V_494 = NULL ;
if ( V_489 -> V_498 )
F_187 ( & V_23 -> V_156 , V_489 -> V_498 ) ;
F_186 ( & V_2 -> V_46 -> V_493 , V_175 ) ;
F_188 ( & V_23 -> V_156 ) ;
F_189 ( & V_489 -> V_499 ) ;
return 0 ;
...
struct V_473 * V_474 )
{
T_5 V_476 , V_500 , V_41 ;
unsigned V_35 ;
if ( V_474 -> V_479 >= V_2 -> V_14 . V_37 ) {
F_68 ( L_27 , V_474 -> V_475 , V_474 -> V_479 ) ;
return 0 ;
}
V_35 = V_474 -> V_479 ;
V_476 = F_5 ( V_477 [ V_35 ] . V_4 ) ;
V_500 = V_477 [ V_35 ] . V_35 ;
if ( V_476 & V_500 ) {
V_41 = F_5 ( V_42 + V_39 [ V_35 ] ) ;
V_41 |= V_501 ;
F_14 ( V_42 + V_39 [ V_35 ] , V_41 ) ;
...
static int F_191 ( void * V_389 ,
enum V_503 V_418 )
{
return 0 ;
}
static int F_192 ( void * V_389 ,
enum V_504 V_418 )
{
return 0 ;
}
...
{
struct V_92 * V_92 = F_34 ( V_90 ) ;
V_92 -> V_505 = V_414 -> clock ;
F_194 ( V_90 , V_408 ) ;
F_100 ( V_90 -> V_6 , V_155 ) ;
if ( F_106 ( V_90 ) == V_506 ) {
F_67 ( V_90 , true ) ;
F_66 ( V_90 , V_414 ) ;
}
...
struct V_202 * V_203 = V_92 -> V_204 ;
if ( V_203 ) {
V_203 -> V_510 = F_103 ( V_90 ) ;
if ( V_92 -> V_507 & V_508 )
V_203 -> V_205 = V_2 -> V_14 . V_205 [ V_203 -> V_510 ] ;
}
}
F_197 ( V_2 , true ) ;
if ( V_48 ) {
...
static void F_201 ( struct V_89 * V_90 )
{
struct V_44 * V_45 = V_90 -> V_45 ;
struct V_1 * V_2 = V_45 -> V_91 ;
F_194 ( V_90 , V_402 ) ;
...
static void F_202 ( struct V_89 * V_90 )
{
struct V_92 * V_92 = F_34 ( V_90 ) ;
struct V_202 * V_203 ;
F_194 ( V_90 , V_408 ) ;
...
static void F_205 ( struct V_89 * V_90 )
{
}
static void
F_206 ( struct V_89 * V_90 ,
struct V_154 * V_155 ,
struct V_154 * V_414 )
{
}
...
static void
F_208 ( struct V_89 * V_90 , int V_155 )
{
}
static bool F_209 ( struct V_89 * V_90 ,
const struct V_154 * V_155 ,
struct V_154 * V_414 )
{
return true ;
...
V_92 = F_70 ( sizeof( struct V_92 ) , V_210 ) ;
if ( ! V_92 )
return;
V_90 = & V_92 -> V_156 ;
...
F_214 ( V_45 , V_90 , & V_525 ,
V_530 , NULL ) ;
V_92 -> V_204 = F_216 ( V_92 ) ;
} else if ( V_92 -> V_97 & ( V_531 ) ) {
F_214 ( V_45 , V_90 , & V_525 ,
V_526 , NULL ) ;
V_92 -> V_204 = F_217 ( V_92 ) ;
} else {
F_214 ( V_45 , V_90 , & V_525 ,
V_532 , NULL ) ;
V_92 -> V_204 = F_217 ( V_92 ) ;
...
{
if ( V_2 -> V_14 . V_428 == NULL )
V_2 -> V_14 . V_428 = & V_544 ;
}
static void F_154 ( struct V_1 * V_2 )
{
V_2 -> V_405 . V_545 = V_546 ;
V_2 -> V_405 . V_428 = & V_547 ;
V_2 -> V_19 . V_545 = V_548 ;
V_2 -> V_19 . V_428 = & V_549 ;
V_2 -> V_56 . V_545 = V_550 ;
V_2 -> V_56 . V_428 = & V_551 ;
}
