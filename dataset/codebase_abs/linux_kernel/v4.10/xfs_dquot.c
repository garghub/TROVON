...
if ( V_140 < * V_49 )
return - V_120 ;
if ( V_140 % V_11 -> V_16 -> V_54 ) {
* V_49 = V_140 ;
return 0 ;
}
V_137 = ( T_12 ) V_140 / V_11 -> V_16 -> V_54 ;
V_80 = F_48 ( V_11 , type ) ;
V_139 = F_49 ( V_80 ) ;
V_138 = F_70 ( F_71 ( V_80 ) , F_72 ( V_11 , V_137 ) ,
V_136 , V_141 ) ;
if ( V_138 < 0 )
error = V_138 ;
F_31 ( V_80 , V_139 ) ;
if ( error )
return ( error == - V_142 ? - V_120 : error ) ;
* V_49 = F_73 ( V_11 , V_138 ) * V_11 -> V_16 -> V_54 ;
return 0 ;
}
int
F_74 (
...
T_1 * * V_123 )
{
struct V_14 * V_144 = V_11 -> V_16 ;
struct V_145 * V_146 = F_75 ( V_144 , type ) ;
struct V_12 * V_1 ;
T_14 V_136 = 0 ;
int error ;
ASSERT ( F_76 ( V_11 ) ) ;
if ( ( ! F_77 ( V_11 ) && type == V_67 ) ||
( ! F_78 ( V_11 ) && type == V_69 ) ||
( ! F_79 ( V_11 ) && type == V_128 ) ) {
return - V_90 ;
}
#ifdef F_12
if ( V_147 ) {
...
type == V_128 ) ;
if ( V_143 ) {
ASSERT ( F_81 ( V_143 , V_88 ) ) ;
ASSERT ( F_82 ( V_143 , type ) == NULL ) ;
}
#endif
if ( V_113 & V_151 ) {
struct V_115 * V_80 ;
...
V_80 = F_48 ( V_11 , type ) ;
V_116 = F_49 ( V_80 ) ;
error = F_83 ( V_80 , & V_152 , V_153 ) ;
F_31 ( V_80 , V_116 ) ;
if ( error )
return error ;
V_136 = F_72 ( V_11 , V_152 ) ;
}
V_154:
F_84 ( & V_144 -> V_155 ) ;
V_1 = F_85 ( V_146 , V_49 ) ;
...
F_87 ( V_1 ) ;
F_88 ( & V_144 -> V_155 ) ;
error = F_69 ( V_11 , type , & V_49 , V_136 ) ;
if ( error )
return error ;
goto V_154;
}
...
V_161:
ASSERT ( ( V_143 == NULL ) || F_81 ( V_143 , V_88 ) ) ;
F_98 ( V_1 ) ;
* V_123 = V_1 ;
return 0 ;
}
...
F_100 ( V_1 ) ;
if ( -- V_1 -> V_157 == 0 ) {
struct V_14 * V_144 = V_1 -> V_7 -> V_16 ;
F_101 ( V_1 ) ;
if ( F_102 ( & V_144 -> V_165 , & V_1 -> V_2 ) )
F_60 ( V_1 -> V_7 , V_166 ) ;
}
F_87 ( V_1 ) ;
}
...
V_1 -> V_89 &= ~ V_181 ;
F_118 ( V_11 -> V_184 , & V_1 -> V_3 . V_178 ,
& V_1 -> V_3 . V_4 . V_177 ) ;
if ( F_20 ( & V_11 -> V_62 ) ) {
...
F_84 ( & V_188 -> V_6 ) ;
F_125 ( & V_187 -> V_6 , V_189 ) ;
} else {
F_84 ( & V_187 -> V_6 ) ;
F_125 ( & V_188 -> V_6 , V_189 ) ;
}
} else if ( V_187 ) {
F_84 ( & V_187 -> V_6 ) ;
} else if ( V_188 ) {
...
{
V_9 =
F_127 ( sizeof( struct V_12 ) , L_4 ) ;
if ( ! V_9 )
goto V_190;
V_191 =
F_127 ( sizeof( struct V_192 ) , L_5 ) ;
if ( ! V_191 )
goto V_193;
return 0 ;
V_193:
