...
T_2 F_214 ( const T_1 V_479 , const T_1 V_369 ,
T_2 * V_488 )
{
T_2 V_491 ;
T_1 V_31 ;
V_491 = F_78 ( V_479 , V_489 , V_369 , 0 , & V_31 ) ;
* V_488 = ( T_2 ) V_31 ;
return V_491 ;
}
...
if ( F_2 ( V_260 , & V_43 . V_2 , & V_43 . V_10 ) )
return V_15 ;
V_43 . V_31 . V_265 . V_266 = V_492 ;
V_43 . V_31 . V_265 . V_269 [ 0 ] = V_362 ;
F_9 ( & V_43 , & V_44 ) ;
return V_44 . error ;
}
T_2 F_216 ( T_1 V_260 , short * V_362 )
{
struct V_40 V_43 ;
struct V_41 V_44 ;
F_11 ( & V_43 , & V_44 , V_243 ,
