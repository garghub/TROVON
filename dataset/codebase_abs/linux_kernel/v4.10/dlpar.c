...
static int F_43 ( char * * V_78 , struct V_55 * V_56 )
{
char * V_79 ;
V_79 = F_44 ( V_78 , L_8 ) ;
if ( ! V_79 )
...
static int F_47 ( char * * V_78 , struct V_55 * V_56 )
{
char * V_79 ;
V_79 = F_44 ( V_78 , L_8 ) ;
if ( ! V_79 )
...
static int F_48 ( char * * V_78 , struct V_55 * V_56 )
{
char * V_79 ;
T_2 V_83 , V_84 ;
V_79 = F_44 ( V_78 , L_8 ) ;
...
V_56 -> V_59 . V_21 = F_50 ( V_84 ) ;
} else if ( F_45 ( V_79 , L_18 ) ) {
V_56 -> V_57 = V_58 ;
V_79 = F_44 ( V_78 , L_8 ) ;
if ( ! V_79 ) {
F_46 ( L_19 ) ;
...
static T_3 F_51 ( struct V_85 * V_85 , struct V_86 * V_87 ,
const char * V_88 , T_4 V_83 )
{
struct V_55 * V_56 ;
struct V_73 V_74 ;
char * V_89 ;
...
if ( V_29 )
F_46 ( L_23 , V_88 ) ;
return V_29 ? V_29 : V_83 ;
}
static int T_5 F_55 ( void )
{
V_76 = F_56 ( L_24 ,
V_91 , 1 ) ;
return F_57 ( V_92 , & V_93 . V_87 ) ;
}
