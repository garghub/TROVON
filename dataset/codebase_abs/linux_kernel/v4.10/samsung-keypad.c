...
static int F_36 ( struct V_56 * V_27 )
{
...
if ( ! V_2 || ! V_14 )
return - V_51 ;
V_58 = F_42 ( V_27 , V_61 , 0 ) ;
if ( ! V_58 )
return - V_62 ;
V_2 -> V_10 = F_43 ( & V_27 -> V_19 , V_58 -> V_63 , F_44 ( V_58 ) ) ;
if ( ! V_2 -> V_10 )
return - V_64 ;
V_2 -> V_32 = F_45 ( & V_27 -> V_19 , L_19 ) ;
if ( F_38 ( V_2 -> V_32 ) ) {
F_27 ( & V_27 -> V_19 , L_20 ) ;
return F_39 ( V_2 -> V_32 ) ;
}
error = F_46 ( V_2 -> V_32 ) ;
if ( error ) {
F_27 ( & V_27 -> V_19 , L_21 ) ;
...
F_47 ( & V_2 -> V_29 ) ;
if ( V_27 -> V_19 . V_46 )
V_2 -> type = F_48 ( V_27 -> V_19 . V_46 ,
L_22 ) ;
else
V_2 -> type = F_49 ( V_27 ) -> V_65 ;
V_14 -> V_66 = V_27 -> V_66 ;
V_14 -> V_67 . V_68 = V_69 ;
V_14 -> V_19 . V_70 = & V_27 -> V_19 ;
V_14 -> V_71 = F_23 ;
V_14 -> V_72 = F_25 ;
error = F_50 ( V_40 , NULL ,
V_38 -> V_13 , V_38 -> V_6 ,
V_2 -> V_23 , V_14 ) ;
if ( error ) {
F_27 ( & V_27 -> V_19 , L_23 ) ;
...
F_52 ( V_74 , V_14 -> V_75 ) ;
F_53 ( V_14 , V_2 ) ;
V_2 -> V_24 = F_54 ( V_27 , 0 ) ;
if ( V_2 -> V_24 < 0 ) {
error = V_2 -> V_24 ;
goto V_73;
}
error = F_55 ( & V_27 -> V_19 , V_2 -> V_24 , NULL ,
F_11 , V_76 ,
F_56 ( & V_27 -> V_19 ) , V_2 ) ;
if ( error ) {
F_27 ( & V_27 -> V_19 , L_24 ) ;
...
goto V_77;
if ( V_27 -> V_19 . V_46 ) {
F_61 ( & V_27 -> V_19 , ( void * ) V_38 -> V_40 -> V_41 ) ;
F_61 ( & V_27 -> V_19 , ( void * ) V_38 -> V_40 ) ;
F_61 ( & V_27 -> V_19 , ( void * ) V_38 ) ;
}
return 0 ;
V_77:
F_62 ( & V_27 -> V_19 ) ;
...
static int F_64 ( struct V_56 * V_27 )
{
struct V_1 * V_2 = F_65 ( V_27 ) ;
F_62 ( & V_27 -> V_19 ) ;
F_57 ( & V_27 -> V_19 , 0 ) ;
F_66 ( V_2 -> V_14 ) ;
F_63 ( V_2 -> V_32 ) ;
...
static int F_67 ( struct V_37 * V_19 )
{
struct V_56 * V_27 = F_68 ( V_19 ) ;
struct V_1 * V_2 = F_65 ( V_27 ) ;
unsigned int V_5 ;
int error ;
if ( V_2 -> V_30 )
...
static int F_70 ( struct V_37 * V_19 )
{
struct V_56 * V_27 = F_68 ( V_19 ) ;
struct V_1 * V_2 = F_65 ( V_27 ) ;
unsigned int V_5 ;
