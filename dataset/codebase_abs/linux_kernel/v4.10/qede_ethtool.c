...
V_2 -> V_188 &= ~ V_189 ;
memset ( & V_2 -> V_190 . V_191 , 0 ,
sizeof( V_2 -> V_190 . V_191 ) ) ;
}
F_42 ( V_2 , NULL , false ) ;
return 0 ;
}
...
static int F_53 ( struct V_1 * V_2 , struct V_202 * V_95 )
{
...
break;
case V_211 :
if ( V_2 -> V_190 . V_212 & V_213 )
V_95 -> V_203 |= V_209 | V_210 ;
break;
case V_214 :
if ( V_2 -> V_190 . V_212 & V_215 )
V_95 -> V_203 |= V_209 | V_210 ;
break;
case V_216 :
case V_217 :
...
static int F_54 ( struct V_27 * V_28 , struct V_202 * V_95 ,
T_2 * T_5 V_218 )
{
struct V_1 * V_2 = F_8 ( V_28 ) ;
switch ( V_95 -> V_49 ) {
...
static int F_56 ( struct V_1 * V_2 , struct V_202 * V_95 )
{
struct V_221 V_222 ;
T_1 V_223 = 0 , V_224 = 0 ;
F_9 ( V_2 , V_37 ,
...
if ( V_2 -> V_190 . V_212 == ( ( V_2 -> V_190 . V_212 &
~ V_224 ) | V_223 ) )
return 0 ;
V_2 -> V_190 . V_212 = ( V_2 -> V_190 . V_212 & ~ V_224 ) |
V_223 ;
V_2 -> V_188 |= V_235 ;
if ( F_35 ( V_2 -> V_93 ) ) {
...
V_222 . V_236 = 1 ;
V_222 . V_237 = 0 ;
memcpy ( & V_222 . V_190 , & V_2 -> V_190 ,
sizeof( V_222 . V_190 ) ) ;
return V_2 -> V_54 -> V_238 ( V_2 -> V_56 ,
& V_222 ) ;
}
return 0 ;
}
static int F_57 ( struct V_27 * V_28 , struct V_202 * V_95 )
{
struct V_1 * V_2 = F_8 ( V_28 ) ;
switch ( V_95 -> V_49 ) {
case V_239 :
...
static T_2 F_58 ( struct V_27 * V_28 )
{
return V_240 ;
}
static T_2 F_59 ( struct V_27 * V_28 )
{
struct V_1 * V_2 = F_8 ( V_28 ) ;
return sizeof( V_2 -> V_190 . V_241 ) ;
}
static int F_60 ( struct V_27 * V_28 , T_2 * V_242 , T_1 * V_243 , T_1 * V_244 )
{
struct V_1 * V_2 = F_8 ( V_28 ) ;
int V_6 ;
if ( V_244 )
...
V_242 [ V_6 ] = V_2 -> V_190 . V_191 [ V_6 ] ;
if ( V_243 )
memcpy ( V_243 , V_2 -> V_190 . V_241 ,
F_59 ( V_28 ) ) ;
return 0 ;
}
static int F_61 ( struct V_27 * V_28 , const T_2 * V_242 ,
const T_1 * V_243 , const T_1 V_244 )
{
struct V_221 V_222 ;
struct V_1 * V_2 = F_8 ( V_28 ) ;
int V_6 ;
...
if ( V_244 != V_246 && V_244 != V_245 )
return - V_74 ;
if ( ! V_242 && ! V_243 )
return 0 ;
if ( V_242 ) {
for ( V_6 = 0 ; V_6 < V_240 ; V_6 ++ )
V_2 -> V_190 . V_191 [ V_6 ] = V_242 [ V_6 ] ;
V_2 -> V_188 |= V_189 ;
}
if ( V_243 ) {
memcpy ( & V_2 -> V_190 . V_241 , V_243 ,
F_59 ( V_28 ) ) ;
V_2 -> V_188 |= V_247 ;
}
if ( F_35 ( V_2 -> V_93 ) ) {
...
return;
F_39 (i) {
F_63 ( V_2 -> V_19 [ V_6 ] . V_134 , V_248 , 1 ) ;
F_64 ( & V_2 -> V_19 [ V_6 ] . V_249 ) ;
}
}
...
int V_6 ;
F_39 (i) {
F_66 ( & V_2 -> V_19 [ V_6 ] . V_249 ) ;
F_63 ( V_2 -> V_19 [ V_6 ] . V_134 , V_250 , 0 ) ;
}
}
...
V_256 = V_4 -> V_258 & V_144 ;
V_4 -> V_259 . V_260 [ V_256 ] . V_252 = V_252 ;
V_254 = F_69 ( & V_4 -> V_261 ) ;
memset ( V_254 , 0 , sizeof( * V_254 ) ) ;
V_257 = 1 << V_262 ;
V_254 -> V_203 . V_263 . V_264 = V_257 ;
V_257 = V_252 -> V_164 & V_265 ;
V_254 -> V_203 . V_264 |= ( V_257 << V_266 ) ;
V_255 = F_70 ( & V_2 -> V_109 -> V_28 , V_252 -> V_203 ,
F_71 ( V_252 ) , V_267 ) ;
if ( F_72 ( F_73 ( & V_2 -> V_109 -> V_28 , V_255 ) ) ) {
F_68 ( V_2 , L_41 ) ;
return - V_268 ;
}
F_74 ( V_254 , V_255 , F_71 ( V_252 ) ) ;
V_254 -> V_203 . V_269 = 1 ;
V_4 -> V_258 ++ ;
V_257 = F_75 ( F_76 ( & V_4 -> V_261 ) ) ;
V_4 -> V_270 . V_203 . V_271 = V_257 ;
F_77 () ;
F_78 () ;
F_79 ( V_4 -> V_270 . V_272 , V_4 -> V_273 ) ;
F_80 () ;
...
V_254 = (struct V_253 * ) F_83 ( & V_4 -> V_261 ) ;
F_84 ( & V_2 -> V_109 -> V_28 , F_85 ( V_254 ) ,
F_86 ( V_254 ) , V_267 ) ;
V_4 -> V_275 ++ ;
V_4 -> V_259 . V_260 [ V_256 ] . V_252 = NULL ;
return 0 ;
}
...
V_276 = F_89 ( * V_13 -> V_285 ) ;
V_277 = F_90 ( & V_13 -> V_286 ) ;
F_91 () ;
V_283 = (union V_282 * ) F_83 ( & V_13 -> V_286 ) ;
V_278 = V_13 -> V_287 & V_140 ;
V_281 = & V_13 -> V_288 [ V_278 ] ;
V_280 = & V_283 -> V_289 ;
V_164 = F_89 ( V_280 -> V_290 ) ;
V_284 = ( T_1 * ) ( F_92 ( V_281 -> V_203 ) +
V_280 -> V_291 +
V_281 -> V_292 ) ;
if ( F_93 ( V_284 , V_2 -> V_93 -> V_293 ) &&
F_93 ( V_284 + V_294 ,
V_2 -> V_93 -> V_293 ) ) {
for ( V_6 = V_295 ; V_6 < V_164 ; V_6 ++ )
if ( V_284 [ V_6 ] != ( unsigned char ) ( V_6 & 0xff ) ) {
V_117 = - 1 ;
break;
}
F_94 ( V_13 , 1 ) ;
...
static int F_97 ( struct V_1 * V_2 , T_2 V_296 )
{
struct V_71 V_124 ;
...
V_2 -> V_54 -> V_45 -> V_92 ( V_2 -> V_56 , & V_124 ) ;
F_98 ( 500 ) ;
V_297 = V_2 -> V_93 -> V_168 + V_295 ;
V_252 = F_99 ( V_2 -> V_93 , V_297 ) ;
if ( ! V_252 ) {
F_24 ( V_2 , L_46 ) ;
V_117 = - V_268 ;
goto V_300;
}
V_298 = F_100 ( V_252 , V_297 ) ;
F_101 ( V_298 , V_2 -> V_93 -> V_293 ) ;
F_101 ( V_298 + V_294 , V_2 -> V_93 -> V_293 ) ;
memset ( V_298 + ( 2 * V_294 ) , 0x77 , ( V_295 - ( 2 * V_294 ) ) ) ;
for ( V_6 = V_295 ; V_6 < V_297 ; V_6 ++ )
V_298 [ V_6 ] = ( unsigned char ) ( V_6 & 0xff ) ;
V_117 = F_67 ( V_2 , V_252 ) ;
if ( V_117 )
goto V_300;
V_117 = F_87 ( V_2 ) ;
if ( V_117 )
...
if ( V_2 -> V_54 -> V_45 -> V_311 -> V_312 ( V_2 -> V_56 ) ) {
V_5 [ V_313 ] = 1 ;
V_304 -> V_305 |= V_310 ;
}
if ( V_2 -> V_54 -> V_45 -> V_311 -> V_314 ( V_2 -> V_56 ) ) {
V_5 [ V_315 ] = 1 ;
V_304 -> V_305 |= V_310 ;
}
if ( V_2 -> V_54 -> V_45 -> V_311 -> V_316 ( V_2 -> V_56 ) ) {
V_5 [ V_317 ] = 1 ;
V_304 -> V_305 |= V_310 ;
}
if ( V_2 -> V_54 -> V_45 -> V_311 -> V_318 ( V_2 -> V_56 ) ) {
V_5 [ V_319 ] = 1 ;
V_304 -> V_305 |= V_310 ;
}
if ( V_2 -> V_54 -> V_45 -> V_311 -> V_320 ( V_2 -> V_56 ) ) {
V_5 [ V_321 ] = 1 ;
V_304 -> V_305 |= V_310 ;
}
}
...
const struct V_322 * V_323 , void * V_203 )
{
struct V_1 * V_2 = F_8 ( V_28 ) ;
switch ( V_323 -> V_324 ) {
case V_325 :
