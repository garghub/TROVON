...
int F_76 ( struct V_1 * V_2 , T_2 V_235 ,
struct V_86 * * V_87 ,
struct V_102 * * V_103 )
{
if ( V_235 >= V_236 ) {
...
void F_82 ( struct V_1 * V_2 , bool V_267 )
{
struct V_12 * V_53 = & V_2 -> V_53 ;
unsigned long V_69 ;
F_27 ( & V_53 -> V_81 , V_69 ) ;
...
int F_84 ( struct V_1 * V_2 , V_9 V_270 )
{
struct V_12 * V_53 ;
struct V_271 V_55 ;
struct V_272 V_273 ;
...
V_193 -> V_391 [ V_408 ] . V_389 =
V_409 | V_410 ;
for ( V_80 = 0 ; V_80 < V_411 ; V_80 ++ ) {
V_397 = V_193 -> V_391 [ V_80 ] . V_389 &
V_193 -> V_412 [ V_80 ] . V_389 ;
if ( V_397 != V_193 -> V_391 [ V_80 ] . V_389 ) {
F_3 ( L_58 ,
V_80 , V_193 -> V_412 [ V_80 ] . V_389 ,
...
if ( F_14 ( V_330 ) )
return V_330 ;
V_412 = V_193 -> V_412 [ V_388 ] . V_389 ;
if ( ( V_413 & V_412 ) != V_413 ) {
F_3 ( L_60 ,
V_388 , V_413 , V_412 ) ;
}
V_193 -> V_391 [ V_388 ] . V_389 = V_413 ;
V_330 = F_116 ( V_2 ) ;
if ( F_14 ( V_330 ) )
F_115 ( V_2 , 0 , NULL ) ;
return 0 ;
...
{
struct V_189 * V_190 = & V_2 -> V_190 ;
if ( F_14 ( V_414 >= ( 1 << V_190 -> V_208 ) ) )
return - V_7 ;
if ( F_14 ( ( V_415 > V_236 ) ) )
return - V_7 ;
V_190 -> V_206 [ V_414 ] = V_415 ;
return 0 ;
}
...
V_55 . V_198 . V_199 . V_416 = 0xFFFFFFFF ;
V_129 = F_1 ( V_2 ,
& V_55 . V_185 . V_186 ,
V_190 -> V_204 ) ;
if ( F_14 ( V_129 ) ) {
...
int F_121 ( struct V_1 * V_2 , V_9 * V_417 )
{
struct V_189 * V_190 = & V_2 -> V_190 ;
struct V_177 V_178 ;
V_9 V_196 ;
...
return V_330 ;
for ( V_80 = 0 ; V_80 < ( 1 << V_190 -> V_208 ) ; V_80 ++ )
V_417 [ V_80 ] = V_190 -> V_206 [ V_80 ] ;
return 0 ;
}
int F_122 ( struct V_1 * V_2 , T_2 V_418 )
{
int V_330 ;
memset ( & V_2 -> V_190 , 0x0 , sizeof( V_2 -> V_190 ) ) ;
V_330 = F_66 ( V_2 , V_418 ) ;
if ( F_14 ( V_330 ) )
goto V_419;
V_330 = F_62 ( V_2 ) ;
if ( F_14 ( V_330 ) )
...
struct V_422 * V_423 = & V_2 -> V_423 ;
if ( V_423 -> V_424 ) {
F_55 ( V_2 -> V_38 , V_425 , V_423 -> V_424 ,
V_423 -> V_426 ) ;
V_423 -> V_424 = NULL ;
}
}
...
V_53 = & V_2 -> V_53 ;
V_55 . V_68 . V_77 = V_276 ;
V_55 . V_188 . V_173 = V_430 ;
V_129 = F_1 ( V_2 ,
& V_55 . V_198 . V_423 . V_431 ,
V_423 -> V_429 ) ;
if ( F_14 ( V_129 ) ) {
F_3 ( L_19 ) ;
return V_129 ;
...
V_129 = F_1 ( V_2 ,
& V_55 . V_198 . V_423 . V_432 ,
V_423 -> V_426 ) ;
if ( F_14 ( V_129 ) ) {
F_3 ( L_19 ) ;
return V_129 ;
}
V_55 . V_198 . V_423 . V_427 = V_423 -> V_427 ;
V_129 = F_53 ( V_53 ,
(struct V_54 * ) & V_55 ,
sizeof( V_55 ) ,
(struct V_57 * ) & V_273 ,
...
if ( V_462 >= V_241 )
return;
V_242 [ V_462 ] . V_244 = V_463 -> V_244 ;
if ( V_2 -> V_243 )
V_242 [ V_462 ] . V_244 /=
V_2 -> V_243 ;
V_242 [ V_462 ] . V_441 = V_463 -> V_441 ;
if ( V_463 -> V_443 != V_464 )
V_242 [ V_462 ] . V_443 = V_463 -> V_443 ;
}
...
if ( V_462 >= V_241 )
return;
V_463 -> V_244 = V_242 [ V_462 ] . V_244 ;
if ( V_2 -> V_243 )
V_463 -> V_244 *= V_2 -> V_243 ;
V_463 -> V_441 =
V_242 [ V_462 ] . V_441 ;
V_463 -> V_443 = V_242 [ V_462 ] . V_443 ;
}
