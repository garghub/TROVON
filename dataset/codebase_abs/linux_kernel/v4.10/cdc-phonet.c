...
static int F_37 ( struct V_95 * V_96 , const struct V_97 * V_98 )
{
static const char V_99 [] = L_4 ;
const struct V_100 * V_101 = NULL ;
const struct V_102 * V_103 ;
struct V_95 * V_59 ;
struct V_104 * V_105 = F_38 ( V_96 ) ;
struct V_3 * V_4 ;
struct V_5 * V_6 ;
T_3 * V_17 ;
int V_106 = 0 ;
...
F_39 ( & V_108 , V_96 , V_17 , V_18 ) ;
V_101 = V_108 . V_100 ;
V_106 = V_108 . V_112 ;
if ( ! V_101 || ! V_106 )
return - V_113 ;
V_59 = F_40 ( V_105 , V_101 -> V_114 ) ;
if ( V_59 == NULL )
return - V_115 ;
if ( V_59 -> V_116 != 2 )
return - V_113 ;
if ( V_59 -> V_109 [ 0 ] . V_61 . V_117 == 0 &&
V_59 -> V_109 [ 1 ] . V_61 . V_117 == 2 )
V_103 = V_59 -> V_109 + 1 ;
else
if ( V_59 -> V_109 [ 0 ] . V_61 . V_117 == 2 &&
V_59 -> V_109 [ 1 ] . V_61 . V_117 == 0 )
V_103 = V_59 -> V_109 ;
else
return - V_113 ;
...
F_43 ( & V_6 -> V_22 ) ;
F_43 ( & V_6 -> V_45 ) ;
if ( F_44 ( V_103 -> V_119 [ 0 ] . V_61 . V_120 ) ) {
V_6 -> V_41 = F_45 ( V_105 ,
V_103 -> V_119 [ 0 ] . V_61 . V_120 ) ;
V_6 -> V_16 = F_46 ( V_105 ,
V_103 -> V_119 [ 1 ] . V_61 . V_120 ) ;
} else {
V_6 -> V_41 = F_45 ( V_105 ,
V_103 -> V_119 [ 1 ] . V_61 . V_120 ) ;
V_6 -> V_16 = F_46 ( V_105 ,
...
V_10 = F_47 ( & V_121 , V_59 , V_6 ) ;
if ( V_10 )
goto V_122;
F_32 ( V_105 , V_101 -> V_114 ,
! V_6 -> V_63 ) ;
F_48 ( V_96 , V_6 ) ;
V_10 = F_49 ( V_4 ) ;
if ( V_10 ) {
