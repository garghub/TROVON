...
! F_176 ( V_16 -> V_86 -> V_34 . V_376 -> V_377 ) ) {
F_177 ( V_34 , L_26 ) ;
return - V_47 ;
}
...
static int F_178 ( struct V_367 * V_36 )
{
...
V_411 = F_179 ( V_36 , V_413 , 0 ) ;
V_123 = F_180 ( V_36 , 0 ) ;
if ( ! V_411 || V_123 < 0 ) {
F_25 ( & V_36 -> V_34 , L_28 ) ;
return - V_414 ;
}
V_29 = F_181 ( sizeof( * V_29 ) , V_399 ) ;
if ( ! V_29 ) {
F_25 ( & V_36 -> V_34 , L_29 ) ;
return - V_302 ;
}
...
for ( V_118 = 0 ; V_118 < F_55 ( V_29 -> V_49 ) ; V_118 ++ )
F_182 ( & V_29 -> V_49 [ V_118 ] . V_335 ) ;
F_183 ( V_36 , V_29 ) ;
error = F_184 ( V_123 , F_58 , 0 ,
