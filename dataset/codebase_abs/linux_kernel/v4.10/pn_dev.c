...
if ( F_41 ( V_5 -> V_45 . V_46 [ V_43 ] ) == V_9 ) {
F_42 ( V_5 -> V_45 . V_46 [ V_43 ] , NULL ) ;
F_43 ( V_43 , V_44 ) ;
}
F_18 ( & V_5 -> V_45 . V_14 ) ;
if ( F_31 ( V_44 , 64 ) )
...
static int F_46 ( struct V_48 * V_49 , unsigned long V_50 ,
void * V_51 )
{
struct V_8 * V_9 = F_47 ( V_51 ) ;
switch ( V_50 ) {
case V_52 :
if ( V_9 -> type == V_53 )
F_38 ( V_9 ) ;
...
static int T_2 F_48 ( struct V_2 * V_2 )
{
struct V_1 * V_5 = F_1 ( V_2 ) ;
if ( ! F_49 ( L_1 , 0 , V_2 -> V_55 , & V_56 ) )
return - V_23 ;
F_50 ( & V_5 -> V_6 . V_15 ) ;
F_51 ( & V_5 -> V_6 . V_14 ) ;
F_51 ( & V_5 -> V_45 . V_14 ) ;
...
static void T_3 F_52 ( struct V_2 * V_2 )
{
F_53 ( L_1 , V_2 -> V_55 ) ;
}
int T_4 F_54 ( void )
...
V_27 = V_27 >> 2 ;
F_16 ( & V_45 -> V_14 ) ;
if ( F_41 ( V_45 -> V_46 [ V_27 ] ) == V_9 )
F_42 ( V_45 -> V_46 [ V_27 ] , NULL ) ;
else
V_9 = NULL ;
F_18 ( & V_45 -> V_14 ) ;
if ( ! V_9 )
