...
{
struct V_49 * V_52 , * V_142 ;
struct V_36 * V_40 , * V_143 ;
F_49 (fde, next_fde, &fde_root, node)
F_50 ( V_52 ) ;
F_49 (cie, next_cie, &cie_root, node)
F_50 ( V_40 ) ;
F_51 ( V_6 ) ;
F_51 ( V_97 ) ;
F_52 ( V_144 ) ;
...
static int F_53 ( char * V_146 , char * V_147 ,
struct V_117 * V_118 )
{
T_1 V_129 ;
void * V_116 , * V_115 ;
...
int F_54 ( const T_3 * V_154 , const T_4 * V_155 ,
struct V_117 * V_156 )
{
...
V_148 = F_53 ( ( char * ) V_130 , ( char * ) V_111 , V_156 ) ;
if ( V_148 ) {
F_3 ( V_8 L_8 ,
V_156 -> V_167 ) ;
return V_148 ;
