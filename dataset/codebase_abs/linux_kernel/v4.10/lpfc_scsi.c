...
static int
F_175 ( struct V_4 * V_5 , struct V_13 * V_14 ,
...
V_128 = F_175 ( V_5 , V_14 , V_633 , V_634 ,
V_623 ) ;
F_39 ( V_5 , V_20 , V_95 ,
L_147
...
V_661 = V_8 -> V_674 ;
V_80 = V_5 -> V_675 + 2 ;
if ( ( V_663 * ( V_5 -> V_675 + 2 ) ) < V_661 )
return 0 ;
if ( V_661 >= V_8 -> V_676 - V_677 ) {
F_39 ( V_5 , V_369 , V_95 ,
L_156
L_157 , V_661 ) ;
return 0 ;
...
struct V_237 * V_665 , T_6 V_410 ,
bool V_679 )
{
struct V_10 * V_680 ;
int V_681 ;
if ( F_86 ( ! V_8 ) || ! V_678 || ! V_665 ||
! ( V_8 -> V_9 ) )
return NULL ;
if ( V_679 )
V_681 = V_682 ;
...
sizeof( struct V_237 ) ) ;
memcpy ( & V_680 -> V_684 . V_665 , V_665 ,
sizeof( struct V_237 ) ) ;
...
struct V_237 * V_665 , T_6 V_410 , V_189 V_698 )
{
struct V_10 * V_680 ;
unsigned long V_43 ;
if ( F_86 ( ! V_8 ) || ! V_678 || ! V_665 ||
...
return false ;
F_20 ( & V_8 -> V_668 , V_43 ) ;
V_680 = F_198 ( V_8 , & V_8 -> V_669 , V_678 ,
V_665 , V_410 ) ;
if ( V_680 ) {
if ( ! V_680 -> V_387 )
V_680 -> V_387 = true ;
...
V_680 = F_199 ( V_8 , V_678 , V_665 , V_410 ,
false ) ;
if ( V_680 ) {
V_680 -> V_387 = true ;
V_680 -> V_390 = V_698 ;
V_680 -> V_673 = false ;
F_65 ( & V_680 -> V_671 , & V_8 -> V_669 ) ;
F_21 ( & V_8 -> V_668 , V_43 ) ;
return true ;
}
F_21 ( & V_8 -> V_668 , V_43 ) ;
