...
static void F_50 ( struct V_102 * V_93 )
{
...
static int F_53 ( struct V_102 * V_93 , void * V_103 )
{
...
static int F_55 ( struct V_102 * V_93 )
{
int V_31 = - V_108 ;
unsigned int V_109 ;
struct V_28 * V_29 ;
struct V_1 * V_2 ;
F_18 ( V_25 ) ;
V_2 = F_56 ( sizeof( struct V_1 ) , V_110 ) ;
if ( ! V_2 )
goto V_49;
V_2 -> V_93 = V_93 ;
V_93 -> V_29 = V_2 ;
V_93 -> V_111 |= V_112 | V_113 ;
if ( F_57 ( V_93 , F_53 , NULL ) ) {
F_41 ( L_32 ) ;
goto V_114;
}
if ( ! V_93 -> V_65 )
goto V_114;
V_2 -> V_5 = F_58 ( V_93 -> V_104 [ 0 ] -> V_115 ,
F_59 ( V_93 -> V_104 [ 0 ] ) ) ;
if ( ! V_2 -> V_5 ) {
F_41 ( L_33 ) ;
V_31 = - V_116 ;
...
V_29 -> V_124 = NULL ;
V_29 -> V_125 = NULL ;
V_31 = F_62 ( V_29 , & V_93 -> V_36 , V_2 -> V_92 , V_126 ,
F_44 ) ;
if ( V_31 ) {
F_41 ( L_26 , V_31 ) ;
goto V_127;
...
static void F_64 ( struct V_102 * V_93 )
{
struct V_1 * V_2 = V_93 -> V_29 ;
F_18 ( V_25 ) ;
F_65 ( V_2 -> V_29 ) ;
