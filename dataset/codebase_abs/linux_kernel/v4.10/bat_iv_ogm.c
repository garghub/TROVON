...
if ( V_299 < V_298 )
goto V_46;
if ( ( F_32 ( & V_28 -> V_290 . V_291 ) > 3 ) &&
( V_299 - V_298 < F_32 ( & V_28 -> V_290 . V_291 ) ) )
goto V_46;
F_42 ( V_94 , V_28 ,
L_38 ,
V_298 , V_299 ) ;
...
static int F_150 ( struct V_84 * V_238 , T_4 V_239 , T_4 V_231 ,
struct V_27 * V_28 ,
struct V_284 * V_285 )
{
struct V_152 * V_154 = NULL ;
...
static void F_152 ( struct V_84 * V_238 , struct V_262 * V_263 ,
struct V_27 * V_28 )
{
int V_239 = F_133 ( V_263 -> V_85 ) . V_239 ;
struct V_284 * V_285 ;
...
if ( V_261 ++ < V_308 )
continue;
if ( F_150 ( V_238 , V_239 , V_263 -> V_265 -> V_266 ,
V_28 , V_285 ) ) {
V_308 = V_261 - 1 ;
goto V_22;
}
