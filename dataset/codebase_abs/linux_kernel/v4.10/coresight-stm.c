...
static T_4 T_5 F_39 ( struct V_40 * V_40 ,
unsigned int V_41 ,
unsigned int V_42 ,
unsigned int V_53 ,
unsigned int V_54 ,
...
static T_4 F_44 ( struct V_66 * V_25 ,
struct V_67 * V_68 , char * V_69 )
{
struct V_1 * V_2 = F_8 ( V_25 -> V_26 ) ;
unsigned long V_24 = V_2 -> V_8 ;
return F_45 ( V_69 , V_70 , L_3 , V_24 ) ;
}
static T_4 F_46 ( struct V_66 * V_25 ,
struct V_67 * V_68 ,
...
static T_4 F_48 ( struct V_66 * V_25 ,
struct V_67 * V_68 , char * V_69 )
{
struct V_1 * V_2 = F_8 ( V_25 -> V_26 ) ;
...
static int F_67 ( struct V_93 * V_94 , const struct V_95 * V_96 )
{
int V_71 ;
void T_7 * V_3 ;
unsigned long * V_51 ;
...
V_2 = F_71 ( V_25 , sizeof( * V_2 ) , V_106 ) ;
if ( ! V_2 )
return - V_107 ;
V_2 -> V_25 = & V_94 -> V_25 ;
V_2 -> V_108 = F_72 ( & V_94 -> V_25 , L_5 ) ;
if ( ! F_69 ( V_2 -> V_108 ) ) {
V_71 = F_73 ( V_2 -> V_108 ) ;
if ( V_71 )
return V_71 ;
...
if ( V_110 ) {
V_2 -> V_49 = V_110 ;
V_100 = F_76 ( ( V_111 ) ( V_110 *
V_47 ) , F_77 ( V_76 ) ) ;
} else {
V_2 -> V_49 = F_62 ( V_2 ) ;
V_100 = F_76 ( ( V_111 ) ( V_2 -> V_49 *
V_47 ) , F_77 ( V_76 ) ) ;
}
V_101 = F_78 ( V_2 -> V_49 ) * sizeof( long ) ;
V_51 = F_71 ( V_25 , V_101 , V_106 ) ;
if ( ! V_51 )
return - V_107 ;
V_2 -> V_45 . V_51 = V_51 ;
F_79 ( & V_2 -> V_31 ) ;
...
static int F_83 ( struct V_66 * V_25 )
{
struct V_1 * V_2 = F_8 ( V_25 ) ;
if ( V_2 && ! F_69 ( V_2 -> V_108 ) )
F_84 ( V_2 -> V_108 ) ;
return 0 ;
}
static int F_85 ( struct V_66 * V_25 )
{
struct V_1 * V_2 = F_8 ( V_25 ) ;
if ( V_2 && ! F_69 ( V_2 -> V_108 ) )
F_73 ( V_2 -> V_108 ) ;
