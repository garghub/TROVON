...
F_5 ( V_13 , 0x100244 + ( V_3 * 0x10 ) , V_9 -> V_10 ) ;
F_5 ( V_13 , 0x100248 + ( V_3 * 0x10 ) , V_9 -> V_6 ) ;
F_5 ( V_13 , 0x100240 + ( V_3 * 0x10 ) , V_9 -> V_4 ) ;
F_6 ( V_13 , 0x100240 + ( V_3 * 0x10 ) ) ;
}
int
F_7 ( struct V_12 * V_13 , int V_15 , struct V_1 * * V_16 )
{
return F_8 ( & V_17 , V_13 , V_15 , V_16 ) ;
}
