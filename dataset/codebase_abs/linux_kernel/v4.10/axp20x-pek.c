...
struct V_29 * V_30 ;
int error ;
V_9 = F_17 ( & V_39 -> V_7 , sizeof( struct V_9 ) ,
V_41 ) ;
if ( ! V_9 )
return - V_42 ;
V_9 -> V_14 = F_4 ( V_39 -> V_7 . V_43 ) ;
V_14 = V_9 -> V_14 ;
V_9 -> V_33 = F_18 ( V_39 , L_2 ) ;
if ( V_9 -> V_33 < 0 ) {
F_19 ( & V_39 -> V_7 , L_3 ,
V_9 -> V_33 ) ;
return V_9 -> V_33 ;
}
V_9 -> V_33 = F_20 ( V_14 -> V_44 ,
V_9 -> V_33 ) ;
V_9 -> V_31 = F_18 ( V_39 , L_4 ) ;
if ( V_9 -> V_31 < 0 ) {
F_19 ( & V_39 -> V_7 , L_5 ,
V_9 -> V_31 ) ;
return V_9 -> V_31 ;
}
V_9 -> V_31 = F_20 ( V_14 -> V_44 ,
V_9 -> V_31 ) ;
V_9 -> V_45 = F_21 ( & V_39 -> V_7 ) ;
if ( ! V_9 -> V_45 )
return - V_42 ;
V_30 = V_9 -> V_45 ;
V_30 -> V_46 = L_6 ;
V_30 -> V_47 = L_7 ;
V_30 -> V_7 . V_43 = & V_39 -> V_7 ;
F_22 ( V_30 , V_48 , V_32 ) ;
F_23 ( V_30 , V_9 ) ;
error = F_24 ( & V_39 -> V_7 , V_9 -> V_33 ,
F_10 , 0 ,
L_8 , V_30 ) ;
if ( error < 0 ) {
F_19 ( V_14 -> V_7 , L_9 ,
