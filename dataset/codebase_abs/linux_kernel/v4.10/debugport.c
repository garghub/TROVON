...
static int T_1
F_14 ( struct V_74 * V_75 , char * V_95 )
{
char * V_96 ;
if ( V_95 ) {
V_80 = & V_97 [ V_75 -> V_6 ] ;
...
static int F_16 ( struct V_98 * V_99 , struct V_100 * V_101 )
{
return 0 ;
}
static void F_17 ( struct V_98 * V_99 , struct V_100 * V_101 )
{
}
