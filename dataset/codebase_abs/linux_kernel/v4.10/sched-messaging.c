...
const char * T_3 V_39 )
{
unsigned int V_17 , V_40 ;
struct V_41 V_42 , V_43 , V_44 ;
unsigned int V_20 = 20 ;
int V_45 [ 2 ] , V_46 [ 2 ] ;
char V_8 ;
T_1 * V_47 ;
V_37 = F_25 ( V_37 , V_38 , V_48 ,
V_49 , 0 ) ;
V_47 = malloc ( V_20 * 2 * V_50 * sizeof( T_1 ) ) ;
if ( ! V_47 )
F_4 ( V_5 , L_12 ) ;
F_1 ( V_45 ) ;
F_1 ( V_46 ) ;
...
V_40 += F_23 ( V_47 + V_40 , V_20 ,
V_45 [ 1 ] , V_46 [ 0 ] ) ;
for ( V_17 = 0 ; V_17 < V_40 ; V_17 ++ )
if ( F_11 ( V_45 [ 0 ] , & V_8 , 1 ) != 1 )
F_4 ( V_5 , L_13 ) ;
F_26 ( & V_42 , NULL ) ;
if ( F_6 ( V_46 [ 1 ] , & V_8 , 1 ) != 1 )
F_4 ( V_5 , L_14 ) ;
for ( V_17 = 0 ; V_17 < V_40 ; V_17 ++ )
F_19 ( V_47 [ V_17 ] ) ;
F_26 ( & V_43 , NULL ) ;
...
printf ( L_19 , L_20 ,
V_44 . V_53 ,
( unsigned long ) ( V_44 . V_54 / V_55 ) ) ;
break;
case V_56 :
printf ( L_21 , V_44 . V_53 ,
( unsigned long ) ( V_44 . V_54 / V_55 ) ) ;
break;
default:
fprintf ( V_57 , L_22 , V_51 ) ;
exit ( 1 ) ;
break;
}
free ( V_47 ) ;
