...
if ( V_95 < 0 )
return - 1 ;
F_45 ( F_46 ( V_78 ) , F_47 ( V_95 ) ) ;
V_60 -> V_76 = F_48 ( V_78 -> V_89 , V_95 ) ;
F_38 ( & V_82 , V_79 ) ;
F_31 ( V_60 , & V_80 , & V_81 ) ;
F_35 ( V_60 , & V_94 , & V_81 ) ;
F_34 ( V_60 , V_80 , V_81 ) ;
...
int F_49 ( void * V_96 , struct V_45 * V_46 )
{
...
if ( V_60 -> V_84 < 0 )
F_56 ( L_29 ) ;
V_60 -> V_76 = F_57 ( V_60 -> V_84 ) ;
V_60 -> V_75 = F_58 ( V_60 -> V_84 ) ;
V_60 -> V_87 = V_34 -> V_6 + V_102 ;
V_60 -> V_90 = F_59 ( V_60 -> V_75 ) ;
F_60 ( V_60 -> V_84 , & V_103 , V_60 ) ;
V_101:
V_46 -> V_89 = V_60 -> V_84 ;
F_24 ( L_30 ,
F_28 ( V_46 -> V_50 ) , F_53 ( V_46 -> V_50 ) ,
V_46 -> V_104 , V_46 -> V_105 , V_97 , V_46 -> V_89 ) ;
return V_46 -> V_89 ;
}
...
int V_37 ;
int V_108 ;
V_108 = ( V_107 -> V_109 >> 24 ) & 15 ;
for ( V_37 = 0 ; V_37 < V_32 ; V_37 ++ ) {
V_67 = & V_17 [ V_37 ] ;
if ( F_25 ( V_67 , V_107 -> V_110 ) &&
V_67 -> V_28 == V_108 )
break;
}
if ( V_37 >= V_32 )
...
V_67 -> V_28 ,
( T_2 ) V_67 -> V_99 ) ;
for ( V_34 = V_111 ; V_34 ; V_34 = V_34 -> V_112 )
if ( V_34 -> V_43 == V_107 -> V_110 )
break;
if ( ! V_34 )
return 0 ;
V_60 = V_34 -> V_100 + V_108 ;
F_24 ( L_32 , V_113 , V_60 ) ;
if ( V_60 -> V_67 )
goto V_101;
V_60 -> V_67 = V_67 ;
V_60 -> V_84 = F_55 ( 8 ) ;
...
{
return F_1 ( V_34 -> V_6 , V_114 ) ;
}
void * F_63 ( unsigned long V_115 )
{
...
V_34 = F_64 ( sizeof( struct V_33 ) , V_11 ) ;
if ( ! V_34 ) {
F_65 () ;
return NULL ;
}
V_34 -> V_6 = F_66 ( V_115 , 4096 ) ;
V_34 -> V_43 = V_115 ;
V_34 -> V_117 = F_62 ( V_34 ) ;
V_34 -> V_118 = F_67 ( V_34 -> V_117 ) + 1 ;
V_116 = V_34 -> V_100 = F_68 ( V_34 -> V_118 ,
sizeof( struct V_59 ) , V_11 ) ;
if ( V_116 == NULL ) {
F_69 ( V_34 ) ;
return NULL ;
}
for ( V_37 = 0 ; V_37 < V_34 -> V_118 ; V_37 ++ , V_116 ++ ) {
V_116 -> V_65 = ( unsigned char ) V_37 ;
V_116 -> V_1 = V_34 ;
}
V_34 -> V_112 = V_111 ;
V_111 = V_34 ;
...
static void
F_70 ( void * V_13 , long V_119 )
{
unsigned int V_19 , * V_120 = ( unsigned int * ) V_13 ;
F_14 (KERN_DEBUG MODULE_NAME L_34 , num_entry) ;
for ( V_19 = 0 ; V_19 < V_119 ; V_19 ++ , V_120 += 4 ) {
F_14 ( V_88 L_35 ,
V_120 , V_19 , V_120 [ 0 ] , V_120 [ 1 ] , V_120 [ 2 ] , V_120 [ 3 ] ) ;
}
}
static void
F_71 ( struct V_59 * V_60 )
{
...
F_14 ( V_88 L_45 , V_34 -> V_121 ) ;
F_14 ( V_88 L_46 , V_34 -> V_117 ) ;
F_14 ( V_88 L_47 , V_34 -> V_100 ) ;
}
