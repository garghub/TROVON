...
struct V_1 * F_6 ( char * V_44 , char * * V_3 ,
char * * V_6 , T_4 V_69 ,
...
int F_70 ( char * V_44 , char * * V_3 , char * * V_6 , int V_5 )
{
struct V_1 * V_2 ;
T_4 V_69 = ( V_5 == V_72 ) ? V_76 : V_7 ;
...
static int F_71 ( struct V_77 * V_78 , int V_79 ,
void V_45 * V_80 , T_5 * V_81 , T_6 * V_82 )
{
struct V_77 V_83 ;
...
if ( V_78 -> V_31 == V_92 )
V_84 [ V_88 ] = V_40 . V_93 [ V_88 ] ;
else if ( V_78 -> V_31 == V_94 )
V_84 [ V_88 ] = V_42 . V_93 [ V_88 ] ;
else
F_73 () ;
}
F_31 ( & V_38 ) ;
V_83 = * V_78 ;
V_83 . V_31 = & V_84 ;
V_87 = F_74 ( & V_83 , V_79 , V_80 , V_81 , V_82 ) ;
if ( V_87 < 0 )
return V_87 ;
for ( V_88 = 0 ; V_88 < V_85 ; V_88 ++ )
V_86 . V_93 [ V_88 ] = V_84 [ V_88 ] ;
F_29 ( & V_38 ) ;
if ( V_79 ) {
if ( V_78 -> V_31 == V_92 )
V_40 = F_30 ( V_40 , V_86 ) ;
