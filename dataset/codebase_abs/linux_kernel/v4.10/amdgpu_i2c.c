...
const char * V_34 )
{
struct V_33 * V_7 = V_6 -> V_64 ;
int V_61 ;
for ( V_61 = 0 ; V_61 < V_62 ; V_61 ++ ) {
if ( ! V_6 -> V_63 [ V_61 ] ) {
V_6 -> V_63 [ V_61 ] = F_12 ( V_7 , V_10 , V_34 ) ;
return;
}
}
}
...
for ( V_61 = 0 ; V_61 < V_62 ; V_61 ++ ) {
if ( V_6 -> V_63 [ V_61 ] &&
( V_6 -> V_63 [ V_61 ] -> V_10 . V_65 == V_63 -> V_65 ) ) {
return V_6 -> V_63 [ V_61 ] ;
}
}
return NULL ;
}
static void F_30 ( struct V_3 * V_63 ,
T_2 V_66 ,
T_2 V_67 ,
T_2 * V_27 )
{
...
static void F_33 ( struct V_3 * V_63 ,
T_2 V_66 ,
T_2 V_67 ,
T_2 V_27 )
{
...
V_68 [ 0 ] = V_67 ;
V_68 [ 1 ] = V_27 ;
if ( F_31 ( & V_63 -> V_39 , & V_76 , 1 ) != 1 )
F_32 ( L_7 ,
V_67 , V_27 ) ;
}
void
F_34 ( const struct V_77 * V_77 )
{
T_2 V_27 ;
if ( ! V_77 -> V_78 . V_79 )
return;
