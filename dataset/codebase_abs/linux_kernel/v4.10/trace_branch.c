...
static enum V_37 F_20 ( struct V_38 * V_39 ,
...
void F_30 ( struct V_1 * V_2 , int V_3 , int V_4 )
{
F_12 ( V_2 , V_3 , V_4 ) ;
if ( V_3 == V_4 )
V_2 -> V_33 ++ ;
...
static int F_31 ( struct V_44 * V_51 )
{
F_25 ( V_51 , L_10
L_11
L_12
...
static inline long F_32 ( struct V_1 * V_21 )
{
long V_52 ;
if ( V_21 -> V_33 ) {
V_52 = V_21 -> V_50 * 100 ;
...
static int F_33 ( struct V_44 * V_51 , void * V_53 )
{
...
V_2 ++ ;
V_52 = F_32 ( V_21 ) ;
F_34 ( V_51 , L_16 , V_21 -> V_33 , V_21 -> V_50 ) ;
if ( V_52 < 0 )
F_25 ( V_51 , L_17 ) ;
else
F_34 ( V_51 , L_18 , V_52 ) ;
F_34 ( V_51 , L_19 , V_21 -> V_30 , V_2 , V_21 -> line ) ;
return 0 ;
}
...
static int F_37 ( void * V_59 , void * V_60 )
{
...
static int F_40 ( struct V_44 * V_51 )
{
F_25 ( V_51 , L_21
L_11
L_12
