...
int V_69 = 0 ;
V_63 = F_23 ( & V_60 -> V_17 , sizeof( * V_63 ) , V_70 ) ;
if ( ! V_63 )
return - V_71 ;
for ( V_62 = 0 ; V_62 < F_15 ( V_64 ) ; V_62 ++ ) {
if ( F_24 ( V_64 [ V_62 ] . V_72 ) ) {
F_25 ( & V_60 -> V_17 ,
L_7 , V_64 [ V_62 ] . V_72 ) ;
V_3 = V_64 [ V_62 ] . V_65 ;
V_63 -> V_40 = & V_64 [ V_62 ] ;
...
V_3 -> V_17 = & V_60 -> V_17 ;
V_67 = V_3 -> V_17 -> V_73 ;
sprintf ( V_63 -> V_74 , L_8 , V_63 -> V_40 -> V_72 ) ;
for ( V_62 = 0 ; V_62 < F_15 ( V_75 ) ; V_62 ++ )
if ( ! strcmp ( V_3 -> V_76 [ V_62 ] . V_74 , L_9 ) ) {
V_3 -> V_76 [ V_62 ] . V_74 = V_63 -> V_74 ;
V_69 = V_62 ;
}
V_68 = F_26 ( V_67 -> V_77 ) ;
if ( V_68 != NULL ) {
