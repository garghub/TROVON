...
F_6 ( V_139 L_71 ) ;
sprintf ( V_74 -> V_138 , L_72 ) ;
}
strcpy ( V_74 -> V_140 , L_49 ) ;
sprintf ( V_74 -> V_141 , L_73 ,
V_74 -> V_138 , V_31 -> V_89 , V_133 -> V_113 -> V_89 ,
V_31 -> V_93 + 4 , V_31 -> V_94 , V_31 -> V_95 , V_31 -> V_96 ) ;
if ( V_97 <= 0 || V_97 == V_142 )
V_135 = NULL ;
else {
error = F_61 ( V_74 , 0 , V_143 ,
V_97 , 0 , V_31 -> V_98 , & V_135 ) ;
if ( error < 0 )
F_6 ( V_144 L_74 ,
V_97 ) ;
}
if ( V_145 > 0 && V_145 != V_142 ) {
struct V_146 * V_147 = NULL ;
struct V_148 * V_149 ;
if ( F_62 ( V_74 , V_145 , V_145 - 8 ,
2 , & V_147 , & V_149 ) < 0 )
F_6 ( V_144 L_75 ,
V_145 ) ;
}
...
static int F_64 ( struct V_150 * V_151 , unsigned int V_152 )
{
#ifdef F_36
if ( V_153 )
return 0 ;
...
static int F_65 ( struct V_150 * V_151 , unsigned int V_152 )
{
static long V_154 [] = { 0x530 , 0xe80 , 0xf40 , 0x604 , - 1 } ;
static long V_155 [] = { 0x330 , 0x300 , 0x310 , 0x320 , - 1 } ;
static int V_156 [] = { 11 , 9 , 10 , 7 , - 1 } ;
static int V_157 [] = { 10 , 5 , 9 , 7 , - 1 } ;
static int V_158 [] = { 3 , 1 , 0 , - 1 } ;
static int V_159 [] [ 2 ] = { { 1 , - 1 } , { 0 , - 1 } , { - 1 , - 1 } ,
{ 0 , - 1 } } ;
int error ;
struct V_30 * V_31 ;
struct V_73 * V_74 ;
error = F_66 ( V_151 , V_23 , V_160 , V_161 ,
...
static int F_72 ( struct V_150 * V_151 ,
unsigned int V_165 )
{
F_67 ( F_73 ( V_151 ) ) ;
return 0 ;
}
static int F_74 ( struct V_30 * V_87 ,
struct V_166 * V_74 ,
...
struct V_169 * V_171 ;
struct V_169 * V_172 ;
V_170 = F_75 ( V_74 , V_168 -> V_173 [ 0 ] . V_160 , NULL ) ;
if ( V_170 == NULL )
return - V_12 ;
V_171 = F_75 ( V_74 , V_168 -> V_173 [ 1 ] . V_160 , NULL ) ;
if ( V_171 == NULL )
return - V_12 ;
V_172 = F_75 ( V_74 , V_168 -> V_173 [ 2 ] . V_160 , NULL ) ;
if ( V_172 == NULL )
return - V_12 ;
V_75 = F_76 ( V_170 ) ;
if ( V_75 < 0 ) {
...
V_136 = F_77 ( V_170 , 1 ) ;
V_145 = F_77 ( V_170 , 2 ) + 8 ;
V_87 -> V_101 = F_77 ( V_172 , 0 ) - 1 ;
V_87 -> V_91 = F_78 ( V_172 , 0 ) + 1 ;
V_94 = F_79 ( V_170 , 0 ) ;
V_95 = F_80 ( V_170 , 0 ) ;
V_96 = F_80 ( V_170 , 1 ) ;
if ( V_97 > 0 ) {
...
static int F_81 ( struct V_166 * V_174 ,
const struct V_167 * V_168 )
{
struct V_73 * V_74 ;
int V_75 ;
...
if ( ! V_100 )
return - V_103 ;
V_75 = F_66 ( & V_174 -> V_74 -> V_165 , V_23 , V_160 , V_161 ,
sizeof( struct V_30 ) , & V_74 ) ;
if ( V_75 < 0 )
return V_75 ;
V_74 -> V_162 = F_55 ;
V_31 = V_74 -> V_110 ;
V_75 = F_74 ( V_31 , V_174 , V_168 ) ;
if ( V_75 ) {
F_67 ( V_74 ) ;
return V_75 ;
}
...
static void F_83 ( struct V_166 * V_174 )
{
F_67 ( F_84 ( V_174 ) ) ;
F_82 ( V_174 , NULL ) ;
V_153 = 0 ;
