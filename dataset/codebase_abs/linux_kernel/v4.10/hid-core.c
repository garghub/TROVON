...
if ( V_27 -> V_30 . V_23 [ V_48 ] == V_148 )
V_27 -> V_132 |= V_149 ;
if ( ( V_27 -> V_49 . V_85 << 16 ) >= V_150 )
V_27 -> V_132 |= V_151 ;
}
...
if ( V_4 == 0 ) {
V_7 = F_39 (
V_62 -> V_6 [ type ] . V_14 . V_156 ,
struct V_1 , V_13 ) ;
} else {
V_7 = V_62 -> V_6 [ type ] . V_9 [ V_4 ] ;
}
if ( ! V_7 ) {
F_5 ( V_62 , L_25 , V_157 [ type ] , V_4 ) ;
return NULL ;
}
if ( V_7 -> V_19 <= V_154 ) {
F_5 ( V_62 , L_26 ,
...
if ( V_7 -> V_18 [ V_154 ] -> V_55 < V_155 ) {
F_5 ( V_62 , L_27 ,
V_157 [ type ] , V_4 , V_154 ) ;
return NULL ;
}
return V_7 ;
}
...
{
switch ( V_41 ) {
case 8 : return ( ( V_159 ) V_24 ) ;
case 16 : return ( ( V_160 ) V_24 ) ;
...
unsigned int V_164 = V_47 % 8 ;
int V_165 = 8 - V_164 ;
T_1 V_24 = 0 ;
T_1 V_166 = V_41 < 32 ? ( 1U << V_41 ) - 1 : ~ 0U ;
while ( V_41 > 0 ) {
V_24 |= ( ( T_1 ) V_7 [ V_162 ] >> V_164 ) << V_163 ;
V_41 -= V_165 ;
V_163 += V_165 ;
V_165 = 8 ;
V_164 = 0 ;
...
int V_169 = 8 - V_164 ;
while ( V_41 - V_169 >= 0 ) {
V_7 [ V_162 ] &= ~ ( 0xff << V_164 ) ;
V_7 [ V_162 ] |= V_24 << V_164 ;
V_24 >>= V_169 ;
V_41 -= V_169 ;
V_169 = 8 ;
V_164 = 0 ;
...
if ( V_41 ) {
V_72 V_170 = ( ( 1U << V_41 ) - 1 ) ;
V_7 [ V_162 ] &= ~ ( V_170 << V_164 ) ;
V_7 [ V_162 ] |= V_24 << V_164 ;
}
}
...
static int F_49 ( T_2 * V_173 , T_2 V_24 , unsigned V_41 )
{
while ( V_41 -- ) {
if ( * V_173 ++ == V_24 )
return 0 ;
...
{
const struct V_174 * V_4 = V_62 -> V_175 -> V_176 ;
if ( ! V_4 )
return 1 ;
for (; V_4 -> V_45 != V_177 ; V_4 ++ )
if ( V_4 -> V_45 == V_178 ||
V_4 -> V_45 == V_7 -> type )
return 1 ;
return 0 ;
...
{
const struct V_179 * V_4 = V_62 -> V_175 -> V_180 ;
if ( ! V_4 )
return 1 ;
for (; V_4 -> V_181 != V_178 - 1 ; V_4 ++ )
if ( ( V_4 -> V_182 == V_178 ||
V_4 -> V_182 == V_23 -> V_62 ) &&
( V_4 -> V_181 == V_178 ||
V_4 -> V_181 == V_23 -> type ) &&
( V_4 -> V_183 == V_178 ||
V_4 -> V_183 == V_23 -> V_184 ) )
return 1 ;
return 0 ;
}
static void F_52 ( struct V_2 * V_62 , struct V_15 * V_18 ,
struct V_21 * V_23 , T_2 V_24 , int V_185 )
{
struct V_186 * V_187 = V_62 -> V_175 ;
int V_104 ;
if ( ! F_53 ( & V_62 -> V_188 ) )
F_54 ( V_62 , V_23 , V_24 ) ;
if ( V_187 && V_187 -> V_189 && F_51 ( V_62 , V_23 ) ) {
V_104 = V_187 -> V_189 ( V_62 , V_18 , V_23 , V_24 ) ;
if ( V_104 != 0 ) {
if ( V_104 < 0 )
F_5 ( V_62 , L_31 ,
V_187 -> V_190 , V_104 ) ;
...
if ( V_62 -> V_191 & V_193 && V_185 && V_62 -> V_194 )
V_62 -> V_194 ( V_62 , V_18 , V_23 , V_24 ) ;
}
...
T_2 V_196 = V_18 -> V_52 ;
T_2 * V_24 ;
V_24 = F_7 ( sizeof( T_2 ) * V_95 , V_197 ) ;
if ( ! V_24 )
return;
...
if ( ! ( V_18 -> V_46 & V_198 ) &&
V_24 [ V_41 ] >= V_195 && V_24 [ V_41 ] <= V_196 &&
V_24 [ V_41 ] - V_195 < V_18 -> V_63 &&
V_18 -> V_23 [ V_24 [ V_41 ] - V_195 ] . V_62 == V_199 + 1 )
goto exit;
}
for ( V_41 = 0 ; V_41 < V_95 ; V_41 ++ ) {
if ( V_198 & V_18 -> V_46 ) {
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_41 ] , V_24 [ V_41 ] , V_185 ) ;
continue;
}
if ( V_18 -> V_24 [ V_41 ] >= V_195 && V_18 -> V_24 [ V_41 ] <= V_196
&& V_18 -> V_24 [ V_41 ] - V_195 < V_18 -> V_63
&& V_18 -> V_23 [ V_18 -> V_24 [ V_41 ] - V_195 ] . V_62
&& F_49 ( V_24 , V_18 -> V_24 [ V_41 ] , V_95 ) )
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_18 -> V_24 [ V_41 ] - V_195 ] , 0 , V_185 ) ;
if ( V_24 [ V_41 ] >= V_195 && V_24 [ V_41 ] <= V_196
&& V_24 [ V_41 ] - V_195 < V_18 -> V_63
&& V_18 -> V_23 [ V_24 [ V_41 ] - V_195 ] . V_62
&& F_49 ( V_18 -> V_24 , V_24 [ V_41 ] , V_95 ) )
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_24 [ V_41 ] - V_195 ] , 1 , V_185 ) ;
}
...
{
int V_200 = F_60 ( V_7 ) + 7 ;
return F_7 ( V_200 , V_46 ) ;
}
...
if ( V_201 == V_202 )
F_58 ( V_7 , V_158 ) ;
V_104 = V_62 -> V_203 -> V_204 ( V_62 , V_7 -> V_4 , V_158 , V_200 ,
V_7 -> type , V_201 ) ;
if ( V_104 < 0 ) {
F_13 ( L_35 , V_104 ) ;
goto V_205;
...
if ( V_201 == V_206 )
F_64 ( V_62 , V_7 -> type , V_158 , V_104 , 0 ) ;
V_205:
F_8 ( V_158 ) ;
}
...
F_13 ( L_36 , V_7 -> V_4 ,
V_207 , V_115 ) ;
memset ( V_208 + V_207 , 0 , V_115 - V_207 ) ;
}
if ( ( V_62 -> V_191 & V_193 ) && V_62 -> V_210 )
V_62 -> V_210 ( V_62 , V_7 ) ;
if ( V_62 -> V_191 & V_211 ) {
...
if ( V_62 -> V_191 != V_211 && V_7 -> V_19 ) {
for ( V_161 = 0 ; V_161 < V_7 -> V_19 ; V_161 ++ )
F_56 ( V_62 , V_7 -> V_18 [ V_161 ] , V_208 , V_185 ) ;
V_187 = V_62 -> V_175 ;
if ( V_187 && V_187 -> V_7 )
V_187 -> V_7 ( V_62 , V_7 ) ;
}
...
int F_64 ( struct V_2 * V_62 , int type , V_72 * V_71 , int V_12 , int V_185 )
{
struct V_5 * V_6 ;
struct V_186 * V_187 ;
struct V_1 * V_7 ;
...
if ( V_187 && V_187 -> V_216 && F_50 ( V_62 , V_7 ) ) {
V_104 = V_187 -> V_216 ( V_62 , V_7 , V_71 , V_12 ) ;
if ( V_104 < 0 )
goto V_215;
}
V_104 = F_65 ( V_62 , type , V_71 , V_12 , V_185 ) ;
V_215:
F_70 ( & V_62 -> V_213 ) ;
return V_104 ;
}
static bool F_71 ( struct V_2 * V_217 ,
const struct V_218 * V_4 )
{
return ( V_4 -> V_219 == V_220 || V_4 -> V_219 == V_217 -> V_219 ) &&
( V_4 -> V_130 == V_221 || V_4 -> V_130 == V_217 -> V_130 ) &&
( V_4 -> V_136 == V_178 || V_4 -> V_136 == V_217 -> V_136 ) &&
( V_4 -> V_138 == V_178 || V_4 -> V_138 == V_217 -> V_138 ) ;
}
const struct V_218 * F_72 ( struct V_2 * V_217 ,
const struct V_218 * V_4 )
{
for (; V_4 -> V_219 ; V_4 ++ )
if ( F_71 ( V_217 , V_4 ) )
...
static bool F_73 ( struct V_2 * V_217 )
{
return ! ! F_72 ( V_217 , V_222 ) ;
}
static T_5
F_74 ( struct V_223 * V_224 , struct V_225 * V_226 ,
struct V_227 * V_228 ,
char * V_158 , T_6 V_229 , T_7 V_95 )
{
struct V_3 * V_103 = F_75 ( V_226 ) ;
struct V_2 * V_217 = F_28 ( V_103 ) ;
if ( V_229 >= V_217 -> V_115 )
return 0 ;
if ( V_229 + V_95 > V_217 -> V_115 )
V_95 = V_217 -> V_115 - V_229 ;
memcpy ( V_158 , V_217 -> V_114 + V_229 , V_95 ) ;
return V_95 ;
}
static T_5
F_76 ( struct V_3 * V_103 , struct V_230 * V_228 ,
char * V_158 )
{
struct V_2 * V_217 = F_28 ( V_103 ) ;
return sprintf ( V_158 , L_38 , V_217 -> V_231 & 0xff ) ;
}
int F_77 ( struct V_2 * V_217 , unsigned int V_232 )
{
static const char * V_233 [] = { L_39 , L_40 , L_41 , L_39 ,
L_42 , L_43 , L_44 , L_45 ,
L_46
} ;
const char * type , * V_219 ;
char V_158 [ 64 ] = L_47 ;
unsigned int V_48 ;
int V_200 ;
int V_104 ;
if ( V_217 -> V_234 & V_235 )
V_232 |= ( V_236 | V_237 ) ;
if ( V_217 -> V_234 & V_238 )
V_232 |= V_239 ;
if ( V_217 -> V_219 != V_240 )
V_232 &= ~ V_237 ;
if ( F_73 ( V_217 ) )
V_232 |= V_236 ;
if ( ( V_232 & V_241 ) && ! F_78 ( V_217 ,
V_232 & V_239 ) )
V_217 -> V_191 |= V_192 ;
if ( ( V_232 & V_237 ) && V_217 -> V_242 &&
! V_217 -> V_242 ( V_217 ,
V_232 & V_236 ) )
V_217 -> V_191 |= V_193 ;
if ( ( V_232 & V_243 ) && ! F_79 ( V_217 ) )
V_217 -> V_191 |= V_211 ;
if ( V_232 & V_244 )
V_217 -> V_191 |= V_245 ;
if ( ! V_217 -> V_191 && ! V_217 -> V_175 -> V_216 ) {
F_5 ( V_217 , L_48 ) ;
return - V_212 ;
}
if ( ( V_217 -> V_191 & V_192 ) &&
( V_232 & V_246 ) && V_217 -> V_247 )
V_217 -> V_247 ( V_217 ) ;
V_200 = 0 ;
if ( V_217 -> V_191 & V_192 )
V_200 += sprintf ( V_158 + V_200 , L_49 ) ;
if ( V_217 -> V_191 & V_193 )
V_200 += sprintf ( V_158 + V_200 , L_50 , V_200 ? L_51 : L_47 ,
V_217 -> V_248 ) ;
if ( V_217 -> V_191 & V_211 )
V_200 += sprintf ( V_158 + V_200 , L_52 , V_200 ? L_51 : L_47 ,
( (struct V_249 * ) V_217 -> V_249 ) -> V_248 ) ;
type = L_39 ;
for ( V_48 = 0 ; V_48 < V_217 -> V_34 ; V_48 ++ ) {
struct V_28 * V_250 = & V_217 -> V_29 [ V_48 ] ;
if ( V_250 -> type == V_39 &&
( V_250 -> V_23 & V_251 ) == V_147 &&
( V_250 -> V_23 & 0xffff ) < F_80 ( V_233 ) ) {
type = V_233 [ V_250 -> V_23 & 0xffff ] ;
break;
}
}
switch ( V_217 -> V_219 ) {
...
V_104 = F_81 ( & V_217 -> V_103 , & V_254 ) ;
if ( V_104 )
F_21 ( V_217 ,
L_57 , V_104 ) ;
F_82 ( V_217 , L_58 ,
V_158 , V_219 , V_217 -> V_255 >> 8 , V_217 -> V_255 & 0xff ,
type , V_217 -> V_190 , V_217 -> V_256 ) ;
return 0 ;
}
void F_83 ( struct V_2 * V_217 )
{
F_84 ( & V_217 -> V_103 , & V_254 ) ;
if ( V_217 -> V_191 & V_192 )
F_85 ( V_217 ) ;
if ( V_217 -> V_191 & V_193 )
V_217 -> V_257 ( V_217 ) ;
...
static T_5 F_87 ( struct V_258 * V_259 , const char * V_158 ,
T_7 V_95 )
{
struct V_186 * V_187 = F_88 ( V_259 ) ;
struct V_260 * V_261 ;
V_53 V_219 , V_136 , V_138 ;
unsigned long V_262 = 0 ;
int V_104 ;
V_104 = sscanf ( V_158 , L_59 ,
& V_219 , & V_136 , & V_138 , & V_262 ) ;
if ( V_104 < 3 )
return - V_33 ;
V_261 = F_2 ( sizeof( * V_261 ) , V_10 ) ;
if ( ! V_261 )
return - V_36 ;
V_261 -> V_4 . V_219 = V_219 ;
V_261 -> V_4 . V_130 = V_221 ;
V_261 -> V_4 . V_136 = V_136 ;
V_261 -> V_4 . V_138 = V_138 ;
V_261 -> V_4 . V_262 = V_262 ;
F_89 ( & V_187 -> V_263 ) ;
F_3 ( & V_261 -> V_13 , & V_187 -> V_264 ) ;
F_90 ( & V_187 -> V_263 ) ;
V_104 = F_91 ( & V_187 -> V_175 ) ;
return V_104 ? : V_95 ;
}
static void F_92 ( struct V_186 * V_187 )
{
struct V_260 * V_261 , * V_41 ;
F_89 ( & V_187 -> V_263 ) ;
...
static const struct V_218 * F_95 ( struct V_2 * V_217 ,
struct V_186 * V_187 )
{
struct V_260 * V_261 ;
F_89 ( & V_187 -> V_263 ) ;
F_96 (dynid, &hdrv->dyn_list, list) {
if ( F_71 ( V_217 , & V_261 -> V_4 ) ) {
F_90 ( & V_187 -> V_263 ) ;
return & V_261 -> V_4 ;
}
}
F_90 ( & V_187 -> V_263 ) ;
return F_72 ( V_217 , V_187 -> V_265 ) ;
}
static int F_97 ( struct V_3 * V_103 , struct V_258 * V_259 )
{
struct V_186 * V_187 = F_88 ( V_259 ) ;
struct V_2 * V_217 = F_28 ( V_103 ) ;
return F_95 ( V_217 , V_187 ) != NULL ;
}
static int F_98 ( struct V_3 * V_103 )
{
struct V_186 * V_187 = F_88 ( V_103 -> V_175 ) ;
struct V_2 * V_217 = F_28 ( V_103 ) ;
const struct V_218 * V_4 ;
int V_104 = 0 ;
if ( F_99 ( & V_217 -> V_266 ) )
...
V_217 -> V_175 = V_187 ;
if ( V_187 -> V_270 ) {
V_104 = V_187 -> V_270 ( V_217 , V_4 ) ;
} else {
V_104 = F_40 ( V_217 ) ;
if ( ! V_104 )
V_104 = F_100 ( V_217 , V_271 ) ;
}
if ( V_104 ) {
F_25 ( V_217 ) ;
V_217 -> V_175 = NULL ;
...
static T_5 F_103 ( struct V_3 * V_103 , struct V_230 * V_161 ,
char * V_158 )
{
struct V_2 * V_217 = F_104 ( V_103 , struct V_2 , V_103 ) ;
return F_105 ( V_158 , V_272 , L_60 ,
V_217 -> V_219 , V_217 -> V_130 , V_217 -> V_136 , V_217 -> V_138 ) ;
}
static int F_106 ( struct V_3 * V_103 , struct V_273 * V_274 )
{
struct V_2 * V_217 = F_28 ( V_103 ) ;
if ( F_107 ( V_274 , L_61 ,
V_217 -> V_219 , V_217 -> V_136 , V_217 -> V_138 ) )
return - V_36 ;
if ( F_107 ( V_274 , L_62 , V_217 -> V_190 ) )
return - V_36 ;
if ( F_107 ( V_274 , L_63 , V_217 -> V_256 ) )
return - V_36 ;
if ( F_107 ( V_274 , L_64 , V_217 -> V_275 ) )
return - V_36 ;
if ( F_107 ( V_274 , L_65 ,
V_217 -> V_219 , V_217 -> V_130 , V_217 -> V_136 , V_217 -> V_138 ) )
return - V_36 ;
...
bool F_108 ( struct V_2 * V_217 )
{
if ( V_217 -> V_234 & V_276 )
return false ;
if ( V_217 -> V_234 & V_277 )
return true ;
switch ( V_217 -> V_136 ) {
case V_278 :
if ( V_217 -> V_138 >= V_279 &&
V_217 -> V_138 <= V_280 )
return true ;
break;
case V_281 :
if ( V_217 -> V_138 >= V_282 &&
V_217 -> V_138 <= V_283 )
return true ;
if ( V_217 -> V_138 == V_284 &&
! strcmp ( V_217 -> V_190 , L_66 ) )
return true ;
break;
case V_285 :
if ( V_217 -> V_138 >= V_286 &&
V_217 -> V_138 <= V_287 )
return true ;
break;
case V_288 :
if ( V_217 -> V_138 >= V_289 &&
V_217 -> V_138 <= V_290 )
return true ;
break;
case V_291 :
if ( V_217 -> V_138 == V_292 &&
V_217 -> type == V_293 )
return true ;
break;
case V_294 :
if ( ( V_217 -> V_138 >= V_295 &&
V_217 -> V_138 <= V_296 ) ||
( V_217 -> V_138 >= V_297 &&
V_217 -> V_138 <= V_298 ) )
return true ;
break;
case V_299 :
if ( V_217 -> V_138 == V_300 &&
V_217 -> V_219 == V_240 &&
strncmp ( V_217 -> V_190 , L_67 , 22 ) == 0 )
return true ;
break;
}
if ( V_217 -> type == V_301 &&
F_72 ( V_217 , V_302 ) )
return true ;
return ! ! F_72 ( V_217 , V_303 ) ;
}
int F_109 ( struct V_2 * V_217 )
{
static T_8 V_4 = F_110 ( 0 ) ;
int V_104 ;
if ( F_48 ( V_217 -> V_116 & V_304 ) )
return - V_214 ;
if ( F_108 ( V_217 ) )
return - V_212 ;
...
V_104 = F_36 ( V_217 ) ;
if ( V_104 )
F_21 ( V_217 , L_69 , V_104 ) ;
}
F_111 ( & V_217 -> V_103 , L_70 , V_217 -> V_219 ,
V_217 -> V_136 , V_217 -> V_138 , F_112 ( & V_4 ) ) ;
F_113 ( V_217 , F_20 ( & V_217 -> V_103 ) ) ;
V_104 = F_114 ( & V_217 -> V_103 ) ;
if ( ! V_104 )
V_217 -> V_116 |= V_304 ;
else
F_115 ( V_217 ) ;
...
struct V_2 * V_217 ;
int V_104 = - V_36 ;
V_217 = F_2 ( sizeof( * V_217 ) , V_10 ) ;
if ( V_217 == NULL )
return F_117 ( V_104 ) ;
F_118 ( & V_217 -> V_103 ) ;
V_217 -> V_103 . V_308 = F_27 ;
V_217 -> V_103 . V_219 = & V_309 ;
F_119 ( & V_217 -> V_103 ) ;
F_25 ( V_217 ) ;
F_120 ( & V_217 -> V_310 ) ;
F_26 ( & V_217 -> V_188 ) ;
...
static void F_123 ( struct V_2 * V_217 )
{
if ( V_217 -> V_116 & V_304 ) {
F_124 ( & V_217 -> V_103 ) ;
F_115 ( V_217 ) ;
V_217 -> V_116 &= ~ V_304 ;
}
...
void F_125 ( struct V_2 * V_217 )
{
F_123 ( V_217 ) ;
F_126 ( & V_217 -> V_103 ) ;
}
int F_127 ( struct V_186 * V_187 , struct V_312 * V_313 ,
const char * V_314 )
{
int V_104 ;
V_187 -> V_175 . V_190 = V_187 -> V_190 ;
V_187 -> V_175 . V_219 = & V_309 ;
V_187 -> V_175 . V_313 = V_313 ;
V_187 -> V_175 . V_314 = V_314 ;
F_26 ( & V_187 -> V_264 ) ;
F_121 ( & V_187 -> V_263 ) ;
V_104 = F_128 ( & V_187 -> V_175 ) ;
if ( V_104 )
return V_104 ;
V_104 = F_129 ( & V_187 -> V_175 , & V_315 ) ;
if ( V_104 )
F_130 ( & V_187 -> V_175 ) ;
return V_104 ;
}
void F_131 ( struct V_186 * V_187 )
{
F_132 ( & V_187 -> V_175 , & V_315 ) ;
F_130 ( & V_187 -> V_175 ) ;
F_92 ( V_187 ) ;
}
...
for ( V_48 = 0 ; V_48 < F_134 ( V_318 ) ; V_48 ++ )
if ( V_317 -> V_319 -> V_320 [ V_48 ] )
return 1 ;
}
return 0 ;
}
