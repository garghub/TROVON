...
V_45 -> V_112 = V_115 ;
if ( V_93 [ V_134 ] )
V_45 -> V_135 = F_74 ( V_93 [ V_134 ] ) ;
if ( V_93 [ V_136 ] )
V_45 -> V_46 = F_75 ( V_93 [ V_136 ] ) ;
if ( V_93 [ V_137 ] )
V_45 -> V_85 = F_75 ( V_93 [ V_137 ] ) ;
if ( V_93 [ V_138 ] )
V_45 -> V_9 . V_17 = F_76 ( V_93 [ V_138 ] ) ;
if ( V_93 [ V_139 ] )
V_45 -> V_9 . V_18 = F_76 ( V_93 [ V_139 ] ) ;
}
static int F_77 ( struct V_10 * V_140 , struct V_28 * V_11 ,
struct V_132 * V_133 [] , struct V_132 * V_93 [] )
{
struct V_59 V_45 ;
F_73 ( V_93 , & V_45 ) ;
return F_78 ( V_11 , V_133 , & V_45 ) ;
}
...
{
struct V_6 * V_141 = F_29 ( V_11 ) ;
struct V_59 * V_104 = & V_141 -> V_45 ;
F_84 ( V_2 , V_134 , V_104 -> V_135 ) ;
F_85 ( V_2 , V_136 , V_104 -> V_46 ) ;
F_85 ( V_2 , V_137 , V_104 -> V_85 ) ;
F_86 ( V_2 , V_138 , V_104 -> V_9 . V_17 ) ;
F_86 ( V_2 , V_139 , V_104 -> V_9 . V_18 ) ;
return 0 ;
}
...
goto V_151;
V_148 = L_4 ;
V_27 = F_95 ( & V_152 , V_94 ) ;
if ( V_27 < 0 )
goto V_153;
V_27 = F_95 ( & V_154 , V_96 ) ;
if ( V_27 < 0 )
goto V_155;
V_27 = F_95 ( & V_156 , V_97 ) ;
if ( V_27 < 0 )
goto V_157;
V_148 = L_5 ;
V_27 = F_96 ( & V_130 ) ;
