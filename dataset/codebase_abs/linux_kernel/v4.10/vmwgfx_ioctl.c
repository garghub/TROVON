...
static T_1 F_8 ( unsigned int V_51 , T_1 V_52 )
{
F_9 ( V_53 + 1 != V_37 ) ;
if ( V_51 >= V_54 &&
V_51 <= V_53 )
...
static int F_10 ( struct V_6 * V_7 , void * V_59 ,
T_2 V_60 )
{
struct V_39 * V_61 =
(struct V_39 * ) V_59 ;
unsigned int V_62 ;
T_2 V_63 = F_11 ( struct V_39 , V_64 ) ;
unsigned int V_65 ;
if ( V_60 < V_63 )
return - V_50 ;
