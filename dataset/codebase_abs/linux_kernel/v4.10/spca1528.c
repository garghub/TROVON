...
if ( V_40 [ 1 ] & 0x02 ) {
V_34 -> V_39 = ! ( V_40 [ 1 ] & 1 ) ;
F_26 ( V_1 , V_40 + 2 , V_4 - 2 ) ;
F_27 ( V_1 , V_43 ,
V_42 , 2 ) ;
return;
}
if ( ( V_40 [ 1 ] & 1 ) != V_34 -> V_39 )
goto V_44;
if ( V_1 -> V_45 == V_43 )
F_27 ( V_1 , V_46 ,
V_34 -> V_35 , V_47 ) ;
...
{
struct V_1 * V_1 =
F_30 ( V_50 -> V_51 , struct V_1 , V_52 ) ;
V_1 -> V_9 = 0 ;
if ( ! V_1 -> V_53 )
return 0 ;
switch ( V_50 -> V_24 ) {
...
return - V_68 ;
return F_35 ( V_64 , V_24 , & V_69 , sizeof( struct V_34 ) ,
V_70 ) ;
}
