...
const void * V_136 , T_1 V_137 , T_1 V_138 )
{
const T_2 * V_139 ;
T_2 V_140 ;
int V_11 ;
...
V_11 = V_142 ;
V_141 = V_137 ;
V_139 = ( const T_2 * ) V_136 ;
for ( V_16 = 0 ; V_16 < V_138 ; V_16 ++ ) {
V_140 = F_28 ( V_2 , V_49 + V_141 + V_16 ) ;
if ( V_140 != V_139 [ V_16 ] ) {
V_11 = V_143 ;
break;
}
...
const void * V_136 , T_1 V_137 , T_1 V_144 )
{
const T_2 * V_139 ;
T_1 V_141 , V_49 , V_16 ;
int V_11 ;
...
V_139 = ( const T_2 * ) V_136 ;
for ( V_16 = 0 ; V_16 < V_144 ; V_16 ++ ) {
switch ( V_2 -> V_29 . V_57 . V_145 ) {
case V_146 :
{
F_31 ( V_2 ,
( V_49 + 0xAAA ) , 0xAA ) ;
...
int F_52 ( struct V_1 * V_2 , T_1 V_159 , T_1 V_5 )
{
T_1 V_49 ;
T_1 V_149 ;
V_49 = V_2 -> V_29 . V_57 . V_58 ;
V_149 = V_159 & V_160 ;
while ( V_149 < V_159 + V_5 ) {
switch ( V_2 -> V_29 . V_57 . V_145 ) {
case V_146 :
...
V_2 -> V_29 . V_57 . V_145 = V_167 ;
V_2 -> V_29 . V_57 . V_168 = V_169 ;
V_2 -> V_29 . V_57 . V_164 = V_170 ;
V_166 = V_2 -> V_29 . V_57 . V_68 ? 2 : 1 ;
F_31 ( V_2 , V_49 + 0xAAA , 0xAA ) ;
F_31 ( V_2 , V_49 + 0x555 , 0x55 ) ;
F_31 ( V_2 , V_49 + 0xAAA , 0x90 ) ;
V_163 = F_28 ( V_2 , V_49 ) ;
V_164 = F_28 ( V_2 , V_49 + V_166 ) ;
V_165 = F_28 ( V_2 , V_49 + V_166 + V_166 ) ;
V_11 = F_30 ( V_2 ) ;
if ( V_11 ) {
F_6 ( L_60 , V_11 ) ;
return V_11 ;
...
if ( V_2 -> V_29 . V_57 . V_145 == V_167 )
return V_188 ;
V_2 -> V_29 . V_57 . V_168 = V_163 ;
V_2 -> V_29 . V_57 . V_164 = V_164 ;
V_2 -> V_29 . V_57 . V_165 = V_165 ;
return 0 ;
}
