...
struct V_1 * V_2 = F_7 ( V_12 ) ;
struct V_11 * V_13 = V_2 -> V_13 ;
return V_13 -> V_15 . V_16 -> V_74 ( V_13 , V_23 ) ;
}
static int F_19 ( struct V_75 * V_76 )
{
struct V_77 * V_78 = V_76 -> V_8 . V_79 ;
struct V_1 * V_2 = F_20 ( & V_76 -> V_8 ) ;
struct V_11 * V_13 ;
V_13 = F_21 ( V_78 ) ;
if ( F_22 ( V_13 ) ) {
F_3 ( & V_76 -> V_8 , L_7 ) ;
...
struct V_11 * V_12 ;
int V_14 ;
F_12 ( & V_76 -> V_8 , L_8 , V_80 ) ;
V_76 -> V_81 = 9 ;
V_76 -> V_82 = V_83 ;
V_14 = F_25 ( V_76 ) ;
if ( V_14 < 0 ) {
F_3 ( & V_76 -> V_8 , L_9 , V_14 ) ;
return V_14 ;
}
V_2 = F_26 ( & V_76 -> V_8 , sizeof( * V_2 ) , V_84 ) ;
if ( V_2 == NULL )
return - V_85 ;
F_27 ( & V_76 -> V_8 , V_2 ) ;
V_2 -> V_7 = V_76 ;
...
V_12 -> type = V_89 ;
V_12 -> V_90 = V_91 ;
V_12 -> V_73 . V_23 = V_2 -> V_23 ;
V_12 -> V_92 . V_16 . V_20 = V_2 -> V_20 ;
V_14 = F_28 ( V_12 ) ;
if ( V_14 ) {
F_3 ( & V_76 -> V_8 , L_10 ) ;
goto V_93;
