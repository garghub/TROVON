...
static int F_35 ( struct V_61 * V_23 , int V_18 ,
struct V_9 * * V_62 )
{
struct V_9 * V_10 ;
struct V_11 * V_12 ;
int V_4 ;
V_4 = F_36 ( V_23 , V_63 [ V_18 ] , V_21 [ V_18 ] , V_64 ,
...
if ( V_12 -> V_17 -> V_69 != V_74 ) {
F_14 (KERN_ERR PFX L_11 ) ;
return V_4 ;
}
F_40 ( V_12 -> V_16 , V_75 , 0x40 ) ;
for ( V_65 = V_76 ; V_65 <= V_77 ; V_65 ++ )
F_40 ( V_12 -> V_16 , V_65 ,
V_78 [ V_65 - V_76 ] ) ;
...
static int F_46 ( struct V_61 * V_23 ,
unsigned int V_18 )
{
...
static int F_48 ( struct V_61 * V_23 ,
unsigned int V_18 )
{
struct V_9 * V_10 ;
int V_4 ;
V_4 = F_35 ( V_23 , V_18 , & V_10 ) ;
if ( V_4 < 0 )
return V_4 ;
...
static int F_51 ( struct V_61 * V_86 ,
unsigned int V_18 )
{
F_49 ( F_52 ( V_86 ) ) ;
return 0 ;
}
static int F_53 ( struct V_61 * V_18 , unsigned int V_87 ,
T_2 V_88 )
{
return F_29 ( F_52 ( V_18 ) ) ;
}
static int F_54 ( struct V_61 * V_18 , unsigned int V_87 )
{
return F_33 ( F_52 ( V_18 ) ) ;
}
static int F_55 ( struct V_19 * V_89 ,
...
if ( V_18 >= V_92 )
return - V_71 ;
V_91 = F_35 ( & V_89 -> V_10 -> V_18 , V_18 , & V_10 ) ;
if ( V_91 < 0 )
return V_91 ;
...
static void F_57 ( struct V_19 * V_89 )
{
F_49 ( F_58 ( V_89 ) ) ;
F_56 ( V_89 , NULL ) ;
}
static int F_59 ( struct V_19 * V_89 , T_2 V_88 )
{
return F_29 ( F_58 ( V_89 ) ) ;
}
static int F_60 ( struct V_19 * V_89 )
{
return F_33 ( F_58 ( V_89 ) ) ;
}
