...
static int F_40 ( struct V_33 * V_34 , int V_74 )
{
struct V_31 * V_32 = V_34 -> V_59 ;
switch ( V_74 ) {
case V_75 :
...
static int F_42 ( struct V_33 * V_34 , int V_74 )
{
struct V_31 * V_32 = V_34 -> V_59 ;
switch ( V_74 ) {
case V_75 :
...
static T_1 F_43 ( struct V_33 * V_77 )
{
struct V_31 * V_32 = V_77 -> V_59 ;
return F_44 ( & V_32 -> V_51 ) ;
}
static T_1 F_45 ( struct V_33 * V_77 )
{
struct V_31 * V_32 = V_77 -> V_59 ;
...
struct V_78 * V_79 ;
int V_39 ;
V_39 = F_47 ( V_32 -> V_80 , V_32 -> V_80 -> V_81 , 0 , 1 , 1 , & V_79 ) ;
if ( V_39 < 0 )
goto V_58;
V_79 -> V_59 = V_32 ;
snprintf ( V_79 -> V_82 , sizeof( V_79 -> V_82 ) , L_1 , V_32 -> V_80 -> V_83 ) ;
F_48 ( V_79 , V_84 , & V_85 ) ;
F_48 ( V_79 , V_48 , & V_86 ) ;
V_58:
return V_39 ;
