...
F_17 ( V_7 , V_140 , V_156 ) ;
F_27 ( V_7 ) ;
F_33 ( V_7 ) ;
V_154 = V_157 | V_158 | V_159 | V_160 | V_161 ;
...
V_115 | V_74 ) ) ;
F_12 ( V_7 , V_162 , ( V_163 | V_164 | V_165 | V_166 |
V_167 | V_168 | V_169 ) ) ;
F_20 ( V_7 , V_170 ) ;
V_7 -> V_155 = true ;
}
...
V_7 -> V_41 = ( V_41 == V_42 ) ;
V_7 -> V_48 = ( V_171 == V_172 ) ;
V_7 -> V_45 = ( V_45 == V_46 ) ;
} else {
F_70 ( V_7 , V_173 , V_10 , L_51 ) ;
V_29 = - V_174 ;
}
} else {
F_70 ( V_7 , V_173 , V_10 , L_52 ) ;
V_29 = - V_175 ;
}
return V_29 ;
}
...
V_28 = F_8 ( V_7 , V_177 ) ;
V_176 [ 0 ] = V_28 & 0x00ff ;
V_176 [ 1 ] = ( V_28 & 0xff00 ) >> 8 ;
V_28 = F_8 ( V_7 , V_178 ) ;
V_176 [ 2 ] = V_28 & 0x00ffU ;
V_176 [ 3 ] = ( V_28 & 0xff00U ) >> 8 ;
V_28 = F_8 ( V_7 , V_179 ) ;
V_176 [ 4 ] = V_28 & 0x00ffU ;
V_176 [ 5 ] = ( V_28 & 0xff00U ) >> 8 ;
}
static int F_72 ( struct V_9 * V_10 )
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
if ( V_7 -> V_155 ) {
F_35 ( V_7 , V_32 , V_10 , L_53 ) ;
return - V_175 ;
}
F_22 ( & V_7 -> V_77 ) ;
F_35 ( V_7 , V_32 , V_10 , L_54 ,
V_10 -> V_180 , V_10 -> V_181 ) ;
F_12 ( V_7 , V_179 , ( V_10 -> V_181 [ 4 ] |
V_10 -> V_181 [ 5 ] << 8 ) ) ;
F_12 ( V_7 , V_178 , ( V_10 -> V_181 [ 2 ] |
V_10 -> V_181 [ 3 ] << 8 ) ) ;
F_12 ( V_7 , V_177 , ( V_10 -> V_181 [ 0 ] |
V_10 -> V_181 [ 1 ] << 8 ) ) ;
F_24 ( & V_7 -> V_77 ) ;
return 0 ;
}
static int F_73 ( struct V_9 * V_10 , void * V_182 )
{
...
if ( ! F_75 ( V_184 -> V_185 ) )
return - V_186 ;
memcpy ( V_10 -> V_181 , V_184 -> V_185 , V_10 -> V_187 ) ;
return F_72 ( V_10 ) ;
}
static int F_76 ( struct V_9 * V_10 )
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
int V_29 = F_77 ( V_7 -> V_30 . V_188 -> V_109 , NULL , F_53 ,
V_189 | V_190 ,
V_4 , V_7 ) ;
if ( F_10 ( V_29 < 0 ) ) {
F_78 ( V_10 , L_55 ,
V_7 -> V_30 . V_188 -> V_109 , V_29 ) ;
return V_29 ;
}
F_67 ( V_7 ) ;
F_64 ( V_7 ) ;
...
struct V_6 * V_7 = F_69 ( V_10 ) ;
F_81 ( V_10 ) ;
F_82 ( V_7 -> V_30 . V_188 -> V_109 , V_7 ) ;
return 0 ;
}
static void F_83 ( struct V_191 * V_192 )
{
struct V_6 * V_7 =
F_84 ( V_192 , struct V_6 , V_193 ) ;
F_22 ( & V_7 -> V_77 ) ;
F_63 ( V_7 ) ;
F_24 ( & V_7 -> V_77 ) ;
}
...
int V_194 = V_7 -> V_144 ;
if ( V_10 -> V_195 & V_196 ) {
F_38 ( V_7 , V_173 , V_10 , L_56 ) ;
V_7 -> V_144 = V_145 ;
} else if ( ( V_10 -> V_195 & V_197 ) || ! F_86 ( V_10 ) ) {
F_38 ( V_7 , V_173 , V_10 , L_57 ,
( V_10 -> V_195 & V_197 ) ? L_58 : L_25 ) ;
V_7 -> V_144 = V_150 ;
} else {
F_38 ( V_7 , V_173 , V_10 , L_59 ) ;
V_7 -> V_144 = V_153 ;
}
if ( V_194 != V_7 -> V_144 )
F_87 ( & V_7 -> V_198 , & V_7 -> V_193 ) ;
}
static void F_88 ( struct V_6 * V_7 )
{
struct V_9 * V_10 = V_7 -> V_11 ;
F_35 ( V_7 , V_199 , V_10 , L_60 ,
V_7 -> V_76 -> V_2 ) ;
if ( F_48 ( V_7 ) )
F_1 ( L_61 , V_7 -> V_76 -> V_2 , V_7 -> V_76 -> V_3 ) ;
if ( F_8 ( V_7 , V_73 ) & V_83 )
F_58 ( V_7 ) ;
F_18 ( V_7 , V_73 , V_82 ) ;
F_12 ( V_7 , V_127 , V_128 ) ;
F_25 ( V_7 , V_200 , ( T_2 * ) V_7 -> V_76 -> V_3 ,
V_7 -> V_76 -> V_2 ) ;
F_12 ( V_7 , V_201 , V_128 ) ;
F_12 ( V_7 , V_202 , V_7 -> V_76 -> V_2 ) ;
F_20 ( V_7 , V_203 ) ;
}
static void F_89 ( struct V_191 * V_192 )
{
struct V_6 * V_7 =
F_84 ( V_192 , struct V_6 , V_204 ) ;
F_22 ( & V_7 -> V_77 ) ;
F_88 ( V_7 ) ;
F_24 ( & V_7 -> V_77 ) ;
}
...
F_91 ( V_10 ) ;
V_7 -> V_76 = V_86 ;
F_87 ( & V_7 -> V_198 , & V_7 -> V_204 ) ;
return V_205 ;
}
static void F_92 ( struct V_9 * V_10 )
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
F_11 ( V_7 , V_206 , V_10 , L_62 ,
V_51 , V_51 - F_93 ( V_10 ) ) ;
V_10 -> V_78 . V_79 ++ ;
F_42 ( V_10 ) ;
}
...
V_209 -> V_212 = 1 ;
F_22 ( & V_7 -> V_77 ) ;
for ( V_27 = 0 ; V_27 < V_207 ; V_27 += 2 ) {
unsigned int V_28 = 0 ;
F_9 ( V_7 -> V_30 . V_31 , V_27 , & V_28 ) ;
V_211 [ V_27 ] = V_28 & 0xffff ;
}
F_24 ( & V_7 -> V_77 ) ;
}
...
struct V_213 * V_214 )
{
F_97 ( V_214 -> V_215 , V_4 , sizeof( V_214 -> V_215 ) ) ;
F_97 ( V_214 -> V_212 , V_216 , sizeof( V_214 -> V_212 ) ) ;
F_97 ( V_214 -> V_217 , F_98 ( V_10 -> V_10 . V_218 ) ,
sizeof( V_214 -> V_217 ) ) ;
}
...
struct V_6 * V_7 = F_69 ( V_10 ) ;
V_36 -> V_220 = V_221 ;
V_36 -> V_222 = V_223 | V_224 |
V_225 | V_226 |
V_227 | V_228 ;
F_100 ( V_36 , V_7 -> V_45 ) ;
V_36 -> V_171 = V_7 -> V_48 ? V_172 : V_229 ;
V_36 -> V_230 = V_231 ;
...
F_102 ( V_36 ) , V_36 -> V_171 ) ;
}
static T_6 F_103 ( struct V_9 * V_10 )
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
return V_7 -> V_232 ;
}
static void F_104 ( struct V_9 * V_10 , T_6 V_28 )
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
V_7 -> V_232 = V_28 ;
}
static int F_105 ( struct V_233 * V_188 )
{
int V_29 ;
struct V_9 * V_11 ;
struct V_6 * V_7 ;
T_1 V_234 ;
V_11 = F_106 ( sizeof( struct V_6 ) ) ;
if ( ! V_11 ) {
V_29 = - V_89 ;
goto V_235;
}
V_7 = F_69 ( V_11 ) ;
F_107 ( V_188 , V_7 ) ;
F_108 ( & V_188 -> V_10 , V_7 ) ;
F_109 ( V_11 , & V_188 -> V_10 ) ;
V_7 -> V_232 = F_110 ( V_236 , V_237 ) ;
V_7 -> V_11 = V_11 ;
V_7 -> V_48 = true ;
V_7 -> V_41 = V_42 ;
V_7 -> V_45 = V_46 ;
V_7 -> V_30 . V_188 = V_188 ;
F_111 ( & V_188 -> V_10 , & V_7 -> V_30 ) ;
V_11 -> V_109 = V_188 -> V_109 ;
V_11 -> V_238 = & V_239 ;
F_112 ( & V_7 -> V_77 ) ;
if ( F_57 ( V_7 ) ) {
F_11 ( V_7 , V_240 , V_11 ,
...
F_113 ( & V_7 -> V_198 ) ;
F_114 ( & V_7 -> V_204 , F_89 ) ;
F_114 ( & V_7 -> V_193 , F_83 ) ;
V_7 -> V_243 = F_115 ( V_244 , & V_7 -> V_198 ,
L_65 ) ;
if ( F_116 ( V_7 -> V_243 ) ) {
V_29 = F_117 ( V_7 -> V_243 ) ;
goto V_242;
}
F_71 ( V_7 , V_11 -> V_181 ) ;
V_11 -> V_245 = & V_246 ;
V_29 = F_118 ( V_11 ) ;
if ( F_10 ( V_29 ) ) {
F_11 ( V_7 , V_240 , V_11 , L_66 ,
V_29 ) ;
goto V_242;
}
V_234 = F_8 ( V_7 , V_136 ) ;
if ( ( ( V_234 & V_247 ) >> V_248 ) != V_249 ) {
V_29 = - V_124 ;
goto V_250;
}
F_35 ( V_7 , V_240 , V_11 , L_67 ,
( V_234 & V_251 ) >> V_252 ) ;
F_35 ( V_7 , V_32 , V_7 -> V_11 , L_68 , V_11 -> V_181 ) ;
return V_29 ;
V_250:
F_119 ( V_7 -> V_11 ) ;
V_242:
...
static int F_121 ( struct V_233 * V_188 )
{
struct V_6 * V_7 = F_122 ( & V_188 -> V_10 ) ;
F_119 ( V_7 -> V_11 ) ;
F_120 ( V_7 -> V_11 ) ;
return 0 ;
}
