...
T_3 V_7 ;
T_1 V_8 [ 3 ] ;
V_7 = ( 0 << 22 ) | ( V_3 << 19 ) | ( V_4 << 16 ) | ( V_5 << V_6 ) ;
V_8 [ 0 ] = V_7 >> 16 ;
V_8 [ 1 ] = V_7 >> 8 ;
V_8 [ 2 ] = V_7 ;
...
const struct V_11 * V_12 , unsigned int V_29 )
{
struct V_15 * V_16 = F_4 ( V_10 ) ;
V_16 -> V_28 = V_29 ;
return 0 ;
...
T_5 V_30 , const struct V_11 * V_12 , char * V_31 )
{
struct V_15 * V_16 = F_4 ( V_10 ) ;
return sprintf ( V_31 , L_1 ,
! ! ( V_16 -> V_32 & ( 1 << V_12 -> V_33 ) ) ) ;
}
static T_4 F_9 ( struct V_9 * V_10 ,
T_5 V_30 , const struct V_11 * V_12 , const char * V_31 ,
T_6 V_34 )
{
bool V_35 ;
int V_36 ;
