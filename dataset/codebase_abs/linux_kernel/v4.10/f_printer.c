...
int V_44 ;
T_10 V_134 ;
V_133 = F_54 ( V_129 , V_3 ) ;
if ( V_133 < 0 )
return V_133 ;
V_135 . V_136 = V_133 ;
V_22 -> V_7 = V_7 ;
V_72 = F_55 ( V_121 -> V_7 , & V_90 ) ;
if ( ! V_72 ) {
V_137:
F_56 ( & V_121 -> V_7 -> V_22 , L_27 ,
V_121 -> V_7 -> V_34 ) ;
return - V_138 ;
}
V_55 = F_55 ( V_121 -> V_7 , & V_93 ) ;
if ( ! V_55 )
goto V_137;
V_91 . V_139 = V_90 . V_139 ;
V_94 . V_139 = V_93 . V_139 ;
V_92 . V_139 = V_90 . V_139 ;
V_95 . V_139 = V_93 . V_139 ;
V_44 = F_57 ( V_3 , V_140 ,
V_141 , V_142 , NULL ) ;
if ( V_44 )
return V_44 ;
...
V_132 = F_58 ( V_148 , V_22 -> V_149 ) ;
V_131 = F_59 ( V_150 , NULL , V_132 ,
...
F_62 ( & V_22 -> V_47 , & V_151 ) ;
V_22 -> V_47 . V_152 = V_153 ;
V_44 = F_63 ( & V_22 -> V_47 , V_132 , 1 ) ;
if ( V_44 ) {
ERROR ( V_22 , L_30 ) ;
goto V_154;
}
...
* F_68 ( struct V_159 * V_160 )
{
return F_2 ( F_69 ( V_160 ) , struct V_158 ,
V_161 . V_162 ) ;
}
static void F_70 ( struct V_159 * V_160 )
{
struct V_158 * V_163 = F_68 ( V_160 ) ;
F_71 ( & V_163 -> V_161 ) ;
}
...
int V_88 ;
F_29 ( & V_163 -> V_26 ) ;
V_88 = F_73 ( V_164 , V_163 -> V_125 + 2 , V_116 - 2 ) ;
F_30 ( & V_163 -> V_26 ) ;
return V_88 ;
}
...
int V_88 , V_165 ;
F_29 ( & V_163 -> V_26 ) ;
V_88 = F_73 ( V_163 -> V_125 + 2 , V_164 , V_116 - 2 ) ;
...
static T_2 F_75 ( struct V_159 * V_160 ,
char * V_164 )
{
struct V_158 * V_163 = F_68 ( V_160 ) ;
int V_88 ;
F_29 ( & V_163 -> V_26 ) ;
V_88 = sprintf ( V_164 , L_31 , V_163 -> V_144 ) ;
F_30 ( & V_163 -> V_26 ) ;
return V_88 ;
}
static T_2 F_76 ( struct V_159 * V_160 ,
const char * V_164 , T_4 V_17 )
{
struct V_158 * V_163 = F_68 ( V_160 ) ;
int V_44 ;
...
static inline void F_81 ( int V_149 )
{
F_80 ( & V_168 , V_149 ) ;
}
static void F_82 ( struct V_170 * V_3 )
{
struct V_158 * V_163 ;
...
static struct V_170 * F_85 ( void )
{
struct V_158 * V_163 ;
struct V_170 * V_44 ;
int V_24 = 0 ;
V_163 = F_86 ( sizeof( * V_163 ) , V_145 ) ;
if ( ! V_163 )
return F_87 ( - V_143 ) ;
F_88 ( & V_163 -> V_26 ) ;
V_163 -> V_161 . V_172 = F_82 ;
V_44 = & V_163 -> V_161 ;
F_29 ( & V_171 ) ;
if ( F_83 ( & V_168 ) ) {
V_24 = F_89 ( V_169 ) ;
...
V_163 -> V_149 = F_78 () ;
if ( V_163 -> V_149 < 0 ) {
V_44 = F_87 ( V_163 -> V_149 ) ;
F_9 ( V_163 ) ;
if ( F_83 ( & V_168 ) )
F_84 () ;
goto V_173;
}
F_90 ( & V_163 -> V_161 . V_162 , L_32 ,
& V_174 ) ;
V_173:
F_30 ( & V_171 ) ;
return V_44 ;
...
struct V_1 * V_22 = F_1 ( V_3 ) ;
struct V_158 * V_163 ;
V_163 = F_2 ( V_3 -> V_175 , struct V_158 , V_161 ) ;
F_9 ( V_22 ) ;
F_29 ( & V_163 -> V_26 ) ;
-- V_163 -> V_167 ;
F_30 ( & V_163 -> V_26 ) ;
}
static void F_92 ( struct V_128 * V_129 ,
struct V_2 * V_3 )
{
struct V_1 * V_22 ;
struct V_14 * V_19 ;
V_22 = F_1 ( V_3 ) ;
F_64 ( V_150 , F_58 ( V_148 , V_22 -> V_149 ) ) ;
F_93 ( & V_22 -> V_47 ) ;
F_94 ( ! F_22 ( & V_22 -> V_39 ) ) ;
F_94 ( ! F_22 ( & V_22 -> V_57 ) ) ;
while ( ! F_22 ( & V_22 -> V_37 ) ) {
...
static struct V_2 * F_96 ( struct V_170 * V_175 )
{
struct V_1 * V_22 ;
struct V_158 * V_163 ;
V_163 = F_2 ( V_175 , struct V_158 , V_161 ) ;
F_29 ( & V_163 -> V_26 ) ;
if ( V_163 -> V_149 >= V_176 ) {
F_30 ( & V_163 -> V_26 ) ;
return F_87 ( - V_177 ) ;
}
V_22 = F_86 ( sizeof( * V_22 ) , V_145 ) ;
if ( ! V_22 ) {
F_30 ( & V_163 -> V_26 ) ;
return F_87 ( - V_143 ) ;
}
