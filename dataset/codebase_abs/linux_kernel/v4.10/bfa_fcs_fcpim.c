...
struct V_124 * V_48 ;
int V_125 ;
V_125 = F_37 ( V_49 -> V_5 -> V_42 , & V_2 , & V_48 ) ;
if ( V_125 ) {
...
if ( V_2 == NULL )
return V_132 ;
V_138 -> V_134 = F_43 ( V_128 , V_2 -> V_129 ) ;
V_138 -> V_113 = V_2 -> V_36 ;
V_138 -> V_114 = V_2 -> V_114 ;
V_138 -> V_116 = V_2 -> V_116 ;
V_138 -> V_115 = V_2 -> V_115 ;
return V_102 ;
}
T_1
...
if ( V_2 == NULL )
return V_132 ;
memcpy ( V_79 , & V_2 -> V_79 , sizeof( struct V_139 ) ) ;
return V_102 ;
}
T_1
...
if ( V_2 == NULL )
return V_132 ;
memset ( & V_2 -> V_79 , 0 , sizeof( struct V_139 ) ) ;
return V_102 ;
}
void
F_55 ( struct V_1 * V_2 ,
