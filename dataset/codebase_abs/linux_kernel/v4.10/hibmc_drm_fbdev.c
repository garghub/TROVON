...
V_19 -> V_42 -> V_42 . V_50 ) ;
F_20 ( V_22 , & V_2 -> V_43 -> V_15 , V_17 -> V_51 ,
V_17 -> V_52 ) ;
V_22 -> V_53 = V_26 -> V_38 . V_54 ;
V_22 -> V_55 = V_10 ;
V_22 -> V_44 . V_56 = V_26 -> V_26 . V_57 . V_58 . V_59 + V_26 -> V_26 . V_57 . V_58 . V_60 ;
V_22 -> V_44 . V_61 = V_10 ;
return 0 ;
V_40:
F_21 ( V_15 ) ;
...
{
struct V_62 * V_63 = V_43 -> V_42 ;
struct V_14 * V_64 = & V_43 -> V_15 ;
F_26 ( V_64 ) ;
F_21 ( V_64 ) ;
F_27 ( V_64 ) ;
if ( V_63 )
...
struct V_67 * V_44 ;
struct V_18 * V_68 ;
V_68 = F_30 ( V_2 -> V_9 -> V_9 , sizeof( * V_68 ) , V_69 ) ;
if ( ! V_68 ) {
F_9 ( L_10 ) ;
return - V_33 ;
}
V_2 -> V_43 = V_68 ;
F_31 ( V_2 -> V_9 , & V_68 -> V_15 ,
& V_70 ) ;
V_11 = F_32 ( V_2 -> V_9 ,
& V_68 -> V_15 , 1 , 1 ) ;
if ( V_11 ) {
...
V_11 = F_34 ( & V_68 -> V_15 , 16 ) ;
if ( V_11 ) {
F_9 ( L_13 , V_11 ) ;
goto V_71;
}
V_66 = & V_68 -> V_15 . V_43 -> V_66 ;
V_44 = & V_68 -> V_15 . V_43 -> V_44 ;
F_5 ( L_14
L_15
L_16
L_17
...
L_20
L_21
L_22 , V_66 -> V_72 , V_66 -> V_73 , V_66 -> V_74 ,
V_66 -> V_75 , V_66 -> V_76 , V_66 -> V_77 ,
V_66 -> V_78 ) ;
F_5 ( L_23
L_24
L_25
...
L_33
L_34
L_22 , V_44 -> V_56 , V_44 -> V_61 , V_44 -> type ,
V_44 -> V_79 , V_44 -> V_80 , V_44 -> V_81 ,
V_44 -> V_82 , V_44 -> V_83 , V_44 -> V_84 ,
V_44 -> V_85 , V_44 -> V_86 ) ;
return 0 ;
V_71:
F_27 ( & V_68 -> V_15 ) ;
