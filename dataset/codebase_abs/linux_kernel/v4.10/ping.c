...
V_31 . V_65 = V_24 -> V_60 ;
V_37 . V_78 . type = V_26 . V_71 ;
V_37 . V_78 . V_10 = V_26 . V_73 ;
V_37 . V_78 . V_79 = 0 ;
V_37 . V_78 . V_80 . V_81 . V_82 = V_22 -> V_83 ;
V_37 . V_78 . V_80 . V_81 . V_84 = V_26 . V_85 ;
V_37 . V_4 = V_4 ;
V_37 . V_86 = 0 ;
V_37 . V_87 = V_43 ;
V_41 . V_88 = F_21 ( V_24 , & V_31 , V_33 ) ;
V_41 . V_89 = V_24 -> V_89 ;
V_41 . V_90 = NULL ;
F_22 ( V_2 ) ;
V_11 = F_23 ( V_2 , V_91 , & V_37 , V_5 ,
0 , & V_41 , & V_31 , V_35 ,
V_92 , & V_39 ) ;
if ( V_11 ) {
F_24 ( F_25 ( V_2 ) , V_35 -> V_93 ,
V_94 ) ;
F_26 ( V_2 ) ;
} else {
V_11 = F_27 ( V_2 , & V_31 ,
(struct V_25 * ) & V_37 . V_78 ,
V_5 ) ;
}
F_28 ( V_2 ) ;
V_77:
...
static void * F_30 ( struct V_95 * V_96 , T_5 * V_97 )
{
return F_31 ( V_96 , V_97 , V_43 ) ;
}
static int F_32 ( struct V_95 * V_96 , void * V_98 )
{
if ( V_98 == V_99 ) {
F_33 ( V_96 , V_100 ) ;
} else {
int V_101 = ( (struct V_102 * ) V_96 -> V_103 ) -> V_101 ;
struct V_21 * V_22 = F_7 ( V_98 ) ;
T_6 V_104 = F_34 ( V_22 -> V_83 ) ;
T_6 V_105 = F_34 ( V_22 -> V_106 ) ;
F_35 ( V_96 , V_98 , V_104 , V_105 , V_101 ) ;
}
return 0 ;
}
static int T_7 F_36 ( struct V_15 * V_15 )
{
return F_37 ( V_15 , & V_107 ) ;
}
static void T_7 F_38 ( struct V_15 * V_15 )
{
return F_39 ( V_15 , & V_107 ) ;
}
int T_8 F_40 ( void )
{
#ifdef F_41
int V_108 = F_42 ( & V_109 ) ;
if ( V_108 )
return V_108 ;
#endif
V_110 . V_111 = V_111 ;
