...
static void F_36 ( struct V_23 * V_24 , T_2 V_67 ,
...
V_14 = V_9 -> V_57 ;
if ( ! V_14 || V_67 < V_14 -> V_19 )
V_14 = V_9 -> V_58 ;
V_51 = ( V_67 - V_14 -> V_19 ) >> V_2 ;
if ( V_51 * V_15 >= V_14 -> V_20 ) {
F_8 ( V_68 L_15
L_16 ,
V_67 , V_14 -> V_19 , V_14 -> V_20 ) ;
return;
F_37 () ;
}
V_50 = F_29 ( V_67 , V_20 , V_15 ) ;
F_19 ( & V_14 -> V_18 , V_35 ) ;
F_21 ( V_14 , V_51 , V_50 ) ;
if ( V_51 >= V_14 -> V_21 )
V_33 . V_34 ( V_9 , V_67 , V_67 + V_20 - 1 ) ;
F_20 ( & V_14 -> V_18 , V_35 ) ;
F_27 ( L_17 ,
V_67 , V_20 , V_50 , F_24 ( 0 ) ) ;
}
...
memset ( V_44 , 0 , V_20 ) ;
* V_69 = F_25 ( V_43 , V_44 , V_20 , 0 ) ;
if ( * V_69 == 0 ) {
F_41 ( ( unsigned long ) V_44 , V_71 ) ;
if ( V_33 . V_34 || ( V_70 & V_72 ) )
return NULL ;
V_70 |= V_72 ;
goto V_73;
}
F_27 ( L_20 ,
V_20 , V_44 , * V_69 , F_24 ( 0 ) ) ;
return V_44 ;
}
...
{
struct V_38 * V_43 = F_30 ( V_24 ) ;
F_43 ( V_43 , V_67 , V_20 , V_75 ) ;
F_41 ( ( unsigned long ) V_44 , F_39 ( V_20 ) ) ;
F_27 ( L_21 ,
V_67 , V_20 , F_24 ( 0 ) ) ;
}
static void
F_44 ( struct V_23 * V_24 , struct V_76 * V_77 , struct V_76 * V_78 ,
int V_79 )
{
unsigned long V_80 ;
struct V_76 * V_81 ;
...
V_83 = V_81 -> V_85 ;
V_80 = F_45 ( V_81 ) + V_83 ;
V_84 = V_24 ? F_46 ( V_24 ) : 0 ;
for ( ++ V_77 ; V_77 < V_78 ; ++ V_77 ) {
...
static int
F_47 ( struct V_23 * V_24 , struct V_76 * V_81 , struct V_76 * V_78 ,
struct V_76 * V_91 , struct V_6 * V_14 ,
T_2 V_48 , int V_45 )
{
unsigned long V_1 = F_45 ( V_81 ) ;
long V_20 = V_81 -> V_90 ;
struct V_76 * V_77 ;
unsigned long * V_17 ;
long V_50 , V_51 , V_27 ;
...
V_91 -> V_90 = V_20 ;
F_23 ( L_22 ,
F_48 ( V_1 ) , V_20 , V_91 -> V_89 ) ;
return 0 ;
}
#endif
if ( V_81 -> V_89 == 0 && V_45 ) {
V_91 -> V_89 = V_1 + V_33 . V_40 ;
V_91 -> V_90 = V_20 ;
F_23 ( L_23 ,
F_48 ( V_1 ) , V_20 , V_91 -> V_89 ) ;
return 0 ;
...
if ( V_81 -> V_89 == 0 )
return - 1 ;
F_44 ( V_24 , V_81 , V_78 , 0 ) ;
return F_47 ( V_24 , V_81 , V_78 , V_91 , V_14 , V_48 , V_45 ) ;
}
V_91 -> V_89 = V_14 -> V_19 + V_51 * V_15 + V_1 ;
V_91 -> V_90 = V_20 ;
F_23 ( L_24 ,
F_48 ( V_1 ) , V_20 , V_91 -> V_89 , V_50 ) ;
V_17 = & V_14 -> V_17 [ V_51 ] ;
V_77 = V_81 ;
do {
#if V_92 > 0
struct V_76 * V_93 = V_77 ;
#endif
V_20 = V_77 -> V_85 ;
V_1 = F_45 ( V_77 ) ;
while ( V_77 + 1 < V_78 && ( int ) V_77 [ 1 ] . V_89 == - 1 ) {
V_20 += V_77 [ 1 ] . V_85 ;
V_77 ++ ;
}
V_50 = F_29 ( V_1 , V_20 , V_15 ) ;
...
#endif
} while ( ++ V_77 < V_78 && ( int ) V_77 -> V_89 < 0 );
return 1 ;
}
static int F_50 ( struct V_23 * V_24 , struct V_76 * V_77 ,
int V_94 , enum V_63 V_64 ,
unsigned long V_65 )
{
struct V_38 * V_43 = F_30 ( V_24 ) ;
struct V_76 * V_95 , * V_78 , * V_91 ;
struct V_8 * V_9 ;
struct V_6 * V_14 ;
T_2 V_48 ;
int V_45 ;
...
V_95 = V_77 ;
V_78 = V_77 + V_94 ;
F_44 ( V_24 , V_77 , V_78 , V_33 . V_34 != 0 ) ;
if ( V_33 . V_34 ) {
...
for ( V_91 = V_77 ; V_77 < V_78 ; ++ V_77 ) {
if ( ( int ) V_77 -> V_89 < 0 )
continue;
if ( F_47 ( V_24 , V_77 , V_78 , V_91 , V_14 , V_48 , V_45 ) < 0 )
goto error;
V_91 ++ ;
}
if ( V_91 < V_78 )
...
L_11 ) ;
if ( V_91 > V_95 )
F_51 ( V_43 , V_95 , V_91 - V_95 , V_64 ) ;
return 0 ;
}
static void F_52 ( struct V_23 * V_24 , struct V_76 * V_77 ,
int V_94 , enum V_63 V_64 ,
unsigned long V_65 )
{
struct V_38 * V_43 = F_30 ( V_24 ) ;
...
V_96 = - 1 , V_97 = 0 ;
F_19 ( & V_14 -> V_18 , V_35 ) ;
for ( V_78 = V_77 + V_94 ; V_77 < V_78 ; ++ V_77 ) {
T_2 V_86 ;
T_4 V_20 ;
long V_50 , V_37 ;
T_2 V_98 ;
...
F_23 ( L_32 ,
V_77 - V_78 + V_94 , V_86 , V_20 ) ;
V_50 = F_29 ( V_86 , V_20 , V_15 ) ;
V_37 = ( V_86 - V_14 -> V_19 ) >> V_2 ;
F_21 ( V_14 , V_37 , V_50 ) ;
V_98 = V_86 + V_20 - 1 ;
if ( V_96 > V_86 ) V_96 = V_86 ;
if ( V_97 < V_98 ) V_97 = V_98 ;
}
if ( ( V_97 - V_14 -> V_19 ) >> V_2 >= V_14 -> V_21 )
V_33 . V_34 ( V_9 , V_96 , V_97 ) ;
F_20 ( & V_14 -> V_18 , V_35 ) ;
F_23 ( L_33 , V_94 - ( V_78 - V_77 ) ) ;
}
...
if ( V_14 && V_14 -> V_19 + V_14 -> V_20 - 1 <= V_26 )
return 1 ;
if ( ! V_54 && V_99 - V_100 - 1 <= V_26 )
return 1 ;
return 0 ;
}
int
F_54 ( struct V_6 * V_14 , long V_101 , long V_102 )
{
unsigned long V_35 ;
unsigned long * V_17 ;
long V_27 , V_28 ;
if ( ! V_14 ) return - V_103 ;
F_19 ( & V_14 -> V_18 , V_35 ) ;
V_17 = V_14 -> V_17 ;
V_28 = F_14 ( NULL , V_14 , V_101 , V_102 ) ;
if ( V_28 < 0 ) {
F_20 ( & V_14 -> V_18 , V_35 ) ;
return - 1 ;
}
for ( V_27 = 0 ; V_27 < V_101 ; ++ V_27 )
V_17 [ V_28 + V_27 ] = V_104 ;
V_14 -> V_21 = V_28 + V_101 ;
F_20 ( & V_14 -> V_18 , V_35 ) ;
return V_28 ;
}
int
F_55 ( struct V_6 * V_14 , long V_105 , long V_101 )
{
unsigned long * V_17 ;
long V_27 ;
if ( ! V_14 ) return - V_103 ;
V_17 = V_14 -> V_17 ;
for( V_27 = V_105 ; V_27 < V_105 + V_101 ; V_27 ++ )
if ( V_17 [ V_27 ] != V_104 )
return - V_106 ;
F_21 ( V_14 , V_105 , V_101 ) ;
return 0 ;
}
int
F_56 ( struct V_6 * V_14 , long V_105 , long V_101 ,
struct V_61 * * V_107 )
{
unsigned long V_35 ;
unsigned long * V_17 ;
...
F_19 ( & V_14 -> V_18 , V_35 ) ;
V_17 = V_14 -> V_17 ;
for( V_108 = V_105 ; V_108 < V_105 + V_101 ; V_108 ++ ) {
if ( V_17 [ V_108 ] != V_104 ) {
F_20 ( & V_14 -> V_18 , V_35 ) ;
return - V_106 ;
}
}
for( V_27 = 0 , V_108 = V_105 ; V_27 < V_101 ; V_27 ++ , V_108 ++ )
V_17 [ V_108 ] = F_1 ( F_57 ( V_107 [ V_27 ] ) ) ;
F_20 ( & V_14 -> V_18 , V_35 ) ;
return 0 ;
}
int
F_58 ( struct V_6 * V_14 , long V_105 , long V_101 )
{
unsigned long * V_28 ;
long V_27 ;
if ( ! V_14 ) return - V_103 ;
V_28 = V_14 -> V_17 + V_105 ;
for( V_27 = 0 ; V_27 < V_101 ; V_27 ++ )
V_28 [ V_27 ] = V_104 ;
return 0 ;
}
static int F_59 ( struct V_23 * V_24 , T_2 V_67 )
{
return V_67 == 0 ;
}
