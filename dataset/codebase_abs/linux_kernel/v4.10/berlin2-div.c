...
void T_4 * V_8 , const char * V_29 , T_2 V_30 ,
const char * * V_31 , int V_32 ,
unsigned long V_33 , T_5 * V_7 )
{
const struct V_34 * V_35 = & V_36 ;
const struct V_34 * V_37 = & V_38 ;
const struct V_34 * V_39 = & V_40 ;
struct V_3 * div ;
div = F_14 ( sizeof( * div ) , V_41 ) ;
if ( ! div )
return F_15 ( - V_42 ) ;
...
if ( ( V_30 & V_44 ) == 0 )
V_35 = NULL ;
return F_16 ( NULL , V_29 , V_31 , V_32 ,
& div -> V_2 , V_35 , & div -> V_2 , V_37 ,
& div -> V_2 , V_39 , V_33 ) ;
}
