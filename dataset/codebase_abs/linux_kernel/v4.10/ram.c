...
static T_3 F_12 ( T_2 * V_14 , enum V_15 * type ,
int * V_48 , struct V_21 * time ,
char * * V_49 , bool * V_22 ,
T_3 * V_50 ,
struct V_1 * V_2 )
{
...
time -> V_27 = 0 ;
* V_22 = false ;
while ( V_4 -> V_6 < V_4 -> V_53 && ! V_18 ) {
V_18 = F_2 ( V_4 -> V_54 , & V_4 -> V_6 ,
V_4 -> V_53 , V_14 , type ,
V_55 , 1 ) ;
if ( ! F_6 ( V_18 ) )
continue;
...
if ( ! F_6 ( V_18 ) )
V_18 = F_2 ( & V_4 -> V_56 , & V_4 -> V_7 ,
1 , V_14 , type , V_57 , 0 ) ;
if ( ! F_6 ( V_18 ) )
V_18 = F_2 ( & V_4 -> V_58 , & V_4 -> V_9 ,
1 , V_14 , type , V_59 , 0 ) ;
if ( ! F_6 ( V_18 ) && V_4 -> V_60 ) {
if ( ! ( V_4 -> V_61 & V_62 ) ) {
V_18 = F_2 ( V_4 -> V_60 ,
& V_4 -> V_8 , 1 , V_14 , type ,
V_63 , 0 ) ;
...
V_64 = F_16 ( sizeof( struct V_10 ) ,
V_45 ) ;
if ( ! V_64 )
return - V_46 ;
V_52 = true ;
while ( V_4 -> V_8 < V_4 -> V_66 ) {
V_65 = F_2 ( V_4 -> V_60 ,
& V_4 -> V_8 ,
V_4 -> V_66 , V_14 ,
type , V_63 , 0 ) ;
...
V_51 = F_4 ( V_18 ) - V_24 ;
* V_50 = F_7 ( V_18 , NULL , 0 ) ;
* V_49 = F_9 ( V_51 + * V_50 + 1 , V_45 ) ;
if ( * V_49 == NULL ) {
V_51 = - V_46 ;
goto V_70;
}
memcpy ( * V_49 , ( char * ) F_13 ( V_18 ) + V_24 , V_51 ) ;
F_7 ( V_18 , * V_49 + V_51 , * V_50 + 1 ) ;
V_70:
if ( V_52 ) {
F_11 ( V_18 -> V_47 ) ;
F_11 ( V_18 ) ;
...
V_71 = F_19 ( V_74 , V_25 L_3 ,
( long ) V_72 . V_26 , ( long ) ( V_72 . V_27 / 1000 ) ,
V_22 ? 'C' : 'D' ) ;
F_20 ( ! V_71 ) ;
V_73 = V_71 ? strlen ( V_71 ) : 0 ;
F_21 ( V_18 , V_71 , V_73 ) ;
F_11 ( V_71 ) ;
return V_73 ;
}
static int T_5 F_22 ( enum V_15 type ,
enum V_75 V_76 ,
T_2 * V_14 , unsigned int V_77 ,
const char * V_49 ,
bool V_22 , T_4 V_51 ,
struct V_1 * V_2 )
{
...
V_76 != V_83 )
return - V_81 ;
if ( V_76 == V_82 && ! V_4 -> V_84 )
return - V_81 ;
if ( V_77 != 1 )
return - V_85 ;
if ( ! V_4 -> V_54 )
return - V_85 ;
V_18 = V_4 -> V_54 [ V_4 -> V_86 ] ;
V_78 = F_17 ( V_18 , V_22 ) ;
if ( V_51 + V_78 > V_18 -> V_87 )
V_51 = V_18 -> V_87 - V_78 ;
F_21 ( V_18 , V_49 , V_51 ) ;
V_4 -> V_86 = ( V_4 -> V_86 + 1 ) % V_4 -> V_53 ;
return 0 ;
}
static int T_5 F_25 ( enum V_15 type ,
enum V_75 V_76 ,
T_2 * V_14 , unsigned int V_77 ,
const char T_6 * V_49 ,
bool V_22 , T_4 V_51 ,
...
if ( ! V_4 -> V_58 )
return - V_46 ;
return F_26 ( V_4 -> V_58 , V_49 , V_51 ) ;
}
return - V_81 ;
}
static int F_27 ( enum V_15 type , T_2 V_14 , int V_48 ,
...
int V_19 ;
if ( V_4 -> V_54 ) {
for ( V_19 = 0 ; V_19 < V_4 -> V_53 ; V_19 ++ )
F_29 ( V_4 -> V_54 [ V_19 ] ) ;
F_11 ( V_4 -> V_54 ) ;
V_4 -> V_53 = 0 ;
}
if ( V_4 -> V_60 ) {
for ( V_19 = 0 ; V_19 < V_4 -> V_66 ; V_19 ++ )
F_29 ( V_4 -> V_60 [ V_19 ] ) ;
F_11 ( V_4 -> V_60 ) ;
V_4 -> V_66 = 0 ;
}
...
T_7 * V_91 , T_4 V_92 ,
T_3 V_43 ,
unsigned int * V_93 , T_8 V_94 , T_8 V_61 )
{
int V_95 = - V_46 ;
int V_19 ;
T_4 V_96 ;
...
if ( * V_91 + V_92 - V_4 -> V_99 > V_4 -> V_51 ) {
F_31 ( V_90 , L_7 ,
V_88 ,
V_92 , ( unsigned long long ) * V_91 ,
V_4 -> V_51 , ( unsigned long long ) V_4 -> V_99 ) ;
goto V_98;
}
V_96 = V_92 / * V_93 ;
if ( ! V_96 ) {
...
if ( ! V_101 )
return 0 ;
if ( * V_91 + V_101 - V_4 -> V_99 > V_4 -> V_51 ) {
F_31 ( V_90 , L_7 ,
V_88 , V_101 , ( unsigned long long ) * V_91 ,
V_4 -> V_51 , ( unsigned long long ) V_4 -> V_99 ) ;
return - V_46 ;
}
* V_18 = F_33 ( * V_91 , V_101 , V_94 , & V_4 -> V_67 ,
V_4 -> V_100 , 0 ) ;
if ( F_34 ( * V_18 ) ) {
int V_95 = F_35 ( * V_18 ) ;
F_31 ( V_90 , L_9 ,
...
F_44 ( L_20 , V_112 -> V_67 . V_124 ) ;
F_44 ( L_21 , V_112 -> V_61 ) ;
#undef F_44
return 0 ;
}
...
V_4 -> V_67 = V_112 -> V_67 ;
V_91 = V_4 -> V_99 ;
V_127 = V_4 -> V_51 - V_4 -> V_121 - V_4 -> V_122
- V_4 -> V_123 ;
V_95 = F_30 ( L_27 , V_90 , V_4 , & V_4 -> V_54 , & V_91 ,
V_127 , V_4 -> V_43 ,
& V_4 -> V_53 , 0 , 0 ) ;
if ( V_95 )
goto V_128;
V_95 = F_36 ( L_28 , V_90 , V_4 , & V_4 -> V_56 , & V_91 ,
V_4 -> V_121 , 0 ) ;
if ( V_95 )
goto V_129;
V_4 -> V_66 = ( V_4 -> V_61 & V_62 )
? V_130
: 1 ;
V_95 = F_30 ( L_29 , V_90 , V_4 , & V_4 -> V_60 , & V_91 ,
V_4 -> V_122 , - 1 ,
& V_4 -> V_66 , V_131 ,
( V_4 -> V_61 & V_62 )
? V_132 : 0 ) ;
if ( V_95 )
goto V_133;
V_95 = F_36 ( L_30 , V_90 , V_4 , & V_4 -> V_58 , & V_91 ,
V_4 -> V_123 , 0 ) ;
if ( V_95 )
goto V_134;
V_4 -> V_135 . V_5 = V_4 ;
...
V_4 -> V_135 . V_49 = F_9 ( V_4 -> V_135 . V_136 , V_45 ) ;
if ( ! V_4 -> V_135 . V_49 ) {
F_48 ( L_31 ) ;
V_95 = - V_46 ;
goto V_137;
...
V_4 -> V_135 . V_61 = V_139 ;
if ( V_4 -> V_121 )
V_4 -> V_135 . V_61 |= V_140 ;
if ( V_4 -> V_122 )
V_4 -> V_135 . V_61 |= V_141 ;
if ( V_4 -> V_123 )
V_4 -> V_135 . V_61 |= V_142 ;
V_95 = F_52 ( & V_4 -> V_135 ) ;
if ( V_95 ) {
F_48 ( L_32 ) ;
goto V_143;
...
V_148 -> V_84 = V_84 ;
V_148 -> V_61 = V_62 ;
V_148 -> V_67 . V_124 = V_149 == 1 ? 16 : V_149 ;
