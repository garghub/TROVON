...
V_13 -> V_241 = F_86 ( V_13 , V_13 -> V_203 . V_246 ) ;
error = F_50 ( V_13 , V_13 -> V_203 . V_246 ,
& V_247 ,
V_169 , V_170 ,
& V_13 -> V_248 ) ;
if ( error ) {
...
error = F_80 ( V_13 -> V_241 ) ;
if ( error ) {
F_43 ( V_13 , L_35 ,
V_13 -> V_241 -> V_225 , error ) ;
goto V_237;
}
F_10 ( & V_13 -> V_242 , V_13 -> V_241 -> V_243 ) ;
F_10 ( & V_13 -> V_244 , 2 * V_13 -> V_241 -> V_243 / 5 ) ;
F_10 ( & V_13 -> V_245 , 4 * V_13 -> V_241 -> V_243 / 5 ) ;
F_87 ( V_13 , V_13 -> V_241 ) ;
}
F_88 ( V_13 , F_89 ( & V_13 -> V_242 ) ) ;
if ( V_13 -> V_203 . V_251 ) {
unsigned int V_123 ;
...
F_64 ( V_13 ) ;
} else if ( ! V_13 -> V_156 . V_240 ) {
error = F_90 ( V_13 -> V_241 , true ) ;
if ( error ) {
...
if ( error )
goto V_172;
V_13 -> V_257 = F_84 ( V_235 , L_38 ) ;
if ( F_56 ( V_13 -> V_257 ) ) {
error = F_57 ( V_13 -> V_257 ) ;
F_43 ( V_13 , L_39 , error ) ;
goto V_258;
}
V_13 -> V_259 = F_84 ( V_235 , L_40 ) ;
if ( F_56 ( V_13 -> V_259 ) ) {
error = F_57 ( V_13 -> V_259 ) ;
F_43 ( V_13 , L_41 , error ) ;
goto V_260;
}
V_13 -> V_261 = 0 ;
V_13 -> V_262 = F_84 ( V_235 , L_42 ) ;
if ( F_56 ( V_13 -> V_262 ) ) {
error = F_57 ( V_13 -> V_262 ) ;
F_43 ( V_13 , L_43 , error ) ;
goto V_263;
}
F_95 ( & V_13 -> V_262 -> V_264 ,
& V_265 ) ;
error = F_96 ( V_13 ) ;
if ( error )
goto V_256;
...
if ( V_165 )
goto V_268;
V_267 = F_84 ( V_235 , L_44 ) ;
if ( F_56 ( V_267 ) ) {
error = F_57 ( V_267 ) ;
F_43 ( V_13 , L_45 , error ) ;
return error ;
}
sprintf ( V_87 , L_46 , V_13 -> V_241 -> V_225 ) ;
V_13 -> V_269 = F_84 ( V_267 , V_87 ) ;
if ( F_56 ( V_13 -> V_269 ) ) {
error = F_57 ( V_13 -> V_269 ) ;
F_43 ( V_13 , L_47 , error ) ;
goto V_172;
}
sprintf ( V_87 , L_48 , V_13 -> V_241 -> V_225 ) ;
V_13 -> V_270 = F_84 ( V_267 , V_87 ) ;
if ( F_56 ( V_13 -> V_270 ) ) {
...
struct V_278 * V_279 = & V_13 -> V_203 ;
struct V_280 * args = & V_13 -> V_156 ;
...
V_279 -> V_204 = V_277 ;
V_279 -> V_251 = 1 ;
for ( V_282 = args -> V_286 ; ( V_281 = F_102 ( & V_282 , L_56 ) ) ; ) {
T_3 V_287 [ V_288 ] ;
int V_289 , V_290 ;
if ( ! V_281 || ! * V_281 )
continue;
V_289 = F_103 ( V_281 , * V_277 -> V_291 , V_287 ) ;
switch ( V_289 ) {
case V_292 :
V_193 = F_104 ( & V_287 [ 0 ] , & V_290 ) ;
if ( V_193 || V_290 < 0 )
goto V_293;
...
{
const struct V_276 * V_277 = V_13 -> V_203 . V_204 ;
if ( F_107 ( ! F_108 ( V_299 , & V_13 -> V_22 ) ) &&
V_277 -> V_300 )
V_277 -> V_300 ( V_13 ) ;
}
static int F_109 ( struct V_10 * V_13 )
{
if ( V_13 -> V_203 . V_204 -> V_298 == NULL )
return 0 ;
return F_110 ( & V_13 -> V_22 , V_21 , V_301 )
? - V_302 : 0 ;
}
...
char V_303 [ 20 ] ;
char V_304 [ 20 ] ;
char * V_202 [] = { V_303 , V_304 , NULL } ;
sprintf ( V_303 , L_60 , ( V_12 -> V_305 & V_306 ) ? 1 : 0 ) ;
sprintf ( V_304 , L_61 , V_13 -> V_156 . V_240 ? 1 : 0 ) ;
F_66 ( & V_13 -> V_206 , V_307 , V_202 ) ;
}
static int F_112 ( struct V_11 * V_12 , struct V_280 * args , int V_71 )
{
struct V_10 * V_13 ;
struct V_163 V_164 ;
int error ;
...
F_113 ( V_12 ) -> V_49 |= V_328 ;
V_12 -> V_329 = 1 ;
V_12 -> V_330 = V_331 ;
V_13 -> V_73 . V_96 = F_114 ( V_12 , V_332 ) ;
V_13 -> V_73 . V_97 = V_12 -> V_333 ;
V_13 -> V_125 = V_13 -> V_73 . V_97 -
V_126 ;
V_13 -> V_127 = F_3 ( V_13 -> V_125 ) ;
V_13 -> V_23 . V_334 = V_13 -> V_156 . V_335 ;
V_13 -> V_23 . V_336 = V_13 -> V_156 . V_337 ;
if ( V_13 -> V_156 . V_338 ) {
V_13 -> V_23 . V_339 = 0 ;
V_13 -> V_23 . V_340 = V_13 -> V_156 . V_338 ;
} else {
V_13 -> V_23 . V_339 = 1 ;
V_13 -> V_23 . V_340 = 30 ;
}
...
snprintf ( V_13 -> V_341 , V_161 , L_63 , V_13 -> V_162 ) ;
error = F_116 ( V_13 ) ;
if ( error )
return error ;
F_117 ( V_13 ) ;
...
if ( error )
goto V_345;
if ( V_13 -> V_203 . V_246 < 0 ) {
error = V_13 -> V_203 . V_246 ;
V_13 -> V_203 . V_246 = 0 ;
goto V_345;
}
if ( V_13 -> V_156 . V_240 )
snprintf ( V_13 -> V_341 , V_161 , L_64 ,
V_13 -> V_162 ) ;
else
snprintf ( V_13 -> V_341 , V_161 , L_65 ,
V_13 -> V_162 , V_13 -> V_203 . V_246 ) ;
error = F_93 ( V_13 , DO ) ;
if ( error )
goto V_345;
error = F_98 ( V_13 , DO ) ;
...
static int F_123 ( struct V_11 * V_88 , void * V_348 )
{
V_88 -> V_47 = V_348 ;
V_88 -> V_349 = V_88 -> V_47 -> V_350 ;
V_88 -> V_351 = & F_124 ( V_88 -> V_47 ) -> V_352 ;
return 0 ;
}
static int F_125 ( struct V_11 * V_88 , void * V_353 )
{
struct V_354 * V_355 = V_353 ;
return ( V_355 == V_88 -> V_47 ) ;
}
static struct V_186 * F_126 ( struct V_356 * V_357 , int V_49 ,
...
V_88 = F_129 ( V_357 , F_125 , F_123 , V_49 , V_355 ) ;
F_78 ( & V_355 -> V_363 ) ;
error = F_57 ( V_88 ) ;
if ( F_56 ( V_88 ) )
goto V_366;
...
if ( V_88 -> V_199 ) {
error = - V_365 ;
if ( ( V_49 ^ V_88 -> V_305 ) & V_306 )
goto V_375;
} else {
snprintf ( V_88 -> V_159 , sizeof( V_88 -> V_159 ) , L_69 , V_355 ) ;
F_61 ( V_88 , F_134 ( V_355 ) ) ;
error = F_112 ( V_88 , & args , V_49 & V_376 ? 1 : 0 ) ;
if ( error )
goto V_375;
V_88 -> V_305 |= V_377 ;
V_355 -> V_378 = V_88 ;
...
static int F_137 ( struct V_11 * V_88 , void * V_353 )
{
return - V_78 ;
}
static struct V_186 * F_138 ( struct V_356 * V_357 ,
...
struct V_379 V_379 ;
int error ;
error = F_139 ( V_358 , V_380 , & V_379 ) ;
if ( error ) {
F_18 ( L_70 ,
V_358 , error ) ;
return F_136 ( error ) ;
}
V_88 = F_129 ( & V_381 , F_125 , F_137 , V_49 ,
V_379 . V_186 -> V_382 -> V_47 ) ;
F_140 ( & V_379 ) ;
if ( F_56 ( V_88 ) ) {
F_18 ( L_71 ) ;
return F_128 ( V_88 ) ;
