...
F_107 ( V_11 , 1 ) ;
F_106 ( V_26 , L_14 ) ;
V_18 = F_108 ( V_11 , V_111 ) ;
if ( V_18 )
return V_18 ;
}
F_106 ( V_26 , L_15 ) ;
F_109 ( & V_26 -> V_33 . V_112 , V_113 ) ;
F_106 ( V_26 , L_16 ) ;
if ( V_26 -> V_32 ) {
V_18 = F_19 ( V_26 -> V_32 ) ;
if ( V_18 )
...
F_110 (cli, &drm->clients, head) {
V_18 = F_111 ( & V_16 -> V_21 ) ;
if ( V_18 )
goto V_116;
}
F_106 ( V_26 , L_18 ) ;
V_18 = F_111 ( & V_26 -> V_94 . V_21 ) ;
if ( V_18 )
goto V_116;
return 0 ;
V_116:
F_112 (cli, &drm->clients, head) {
F_113 ( & V_16 -> V_21 ) ;
}
...
static int
F_115 ( struct V_10 * V_11 , bool V_111 )
{
struct V_25 * V_26 = V_25 ( V_11 ) ;
struct V_15 * V_16 ;
F_106 ( V_26 , L_20 ) ;
F_113 ( & V_26 -> V_94 . V_21 ) ;
F_106 ( V_26 , L_21 ) ;
if ( V_26 -> V_35 && F_24 ( V_26 ) -> V_117 )
F_24 ( V_26 ) -> V_117 ( V_26 ) ;
F_110 (cli, &drm->clients, head) {
...
return V_18 ;
F_57 ( V_2 ) ;
V_18 = F_115 ( V_118 , false ) ;
F_127 ( & V_25 ( V_118 ) -> V_124 ) ;
return V_18 ;
}
static int
F_128 ( struct V_37 * V_11 )
{
struct V_1 * V_2 = F_119 ( V_11 ) ;
struct V_10 * V_118 = F_103 ( V_2 ) ;
...
static int
F_129 ( struct V_37 * V_11 )
{
struct V_1 * V_2 = F_119 ( V_11 ) ;
struct V_10 * V_118 = F_103 ( V_2 ) ;
return F_115 ( V_118 , false ) ;
}
static int
F_130 ( struct V_37 * V_11 )
{
struct V_1 * V_2 = F_119 ( V_11 ) ;
struct V_10 * V_118 = F_103 ( V_2 ) ;
int V_18 ;
...
F_110 (crtc, &drm->dev->mode_config.crtc_list, head) {
if ( V_133 -> V_135 ) {
F_133 ( L_25 ) ;
return - V_125 ;
}
...
int V_18 ;
V_18 = F_92 ( V_11 -> V_11 ) ;
if ( V_18 < 0 && V_18 != - V_140 )
return V_18 ;
F_143 ( V_138 , V_141 ) ;
snprintf ( V_3 , sizeof( V_3 ) , L_26 , V_138 , F_144 ( V_137 -> V_142 ) ) ;
V_18 = F_7 ( V_11 , V_3 , sizeof( * V_16 ) , ( void * * ) & V_16 ) ;
if ( V_18 )
goto V_143;
V_16 -> V_21 . V_144 = false ;
if ( V_26 -> V_37 . V_59 . V_60 >= V_101 ) {
V_18 = F_71 ( F_46 ( & V_26 -> V_37 ) , 0 , ( 1ULL << 40 ) ,
...
V_137 -> V_145 = V_16 ;
F_145 ( & V_26 -> V_94 . V_22 ) ;
F_146 ( & V_16 -> V_146 , & V_26 -> V_96 ) ;
F_147 ( & V_26 -> V_94 . V_22 ) ;
V_143:
F_84 ( V_11 -> V_11 ) ;
F_148 ( V_11 -> V_11 ) ;
return V_18 ;
...
long
F_153 ( struct V_148 * V_148 , unsigned int V_149 , unsigned long V_150 )
{
struct V_136 * V_151 = V_148 -> V_152 ;
struct V_10 * V_11 = V_151 -> V_153 -> V_11 ;
long V_18 ;
V_18 = F_92 ( V_11 -> V_11 ) ;
if ( V_18 < 0 && V_18 != - V_140 )
return V_18 ;
switch ( F_154 ( V_149 ) - V_154 ) {
case V_155 :
V_18 = F_155 ( V_151 , ( void V_156 * ) V_150 , F_156 ( V_149 ) ) ;
break;
default:
V_18 = F_157 ( V_148 , V_149 , V_150 ) ;
break;
}
F_84 ( V_11 -> V_11 ) ;
F_148 ( V_11 -> V_11 ) ;
...
struct V_10 *
F_159 ( const struct V_163 * V_164 ,
struct V_7 * V_2 ,
struct V_77 * * V_165 )
{
struct V_10 * V_26 ;
int V_166 ;
V_166 = F_160 ( V_164 , V_2 , V_19 , V_20 ,
true , true , ~ 0ULL , V_165 ) ;
if ( V_166 )
goto V_167;
V_26 = F_161 ( & V_168 , & V_2 -> V_11 ) ;
if ( F_162 ( V_26 ) ) {
V_166 = F_163 ( V_26 ) ;
goto V_167;
}
