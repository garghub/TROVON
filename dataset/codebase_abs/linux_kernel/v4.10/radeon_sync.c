...
if ( V_18 || ! V_20 || V_23 )
return V_23 ;
for ( V_3 = 0 ; V_3 < V_20 -> V_24 ; ++ V_3 ) {
V_22 = F_9 ( V_20 -> V_18 [ V_3 ] ,
F_10 ( V_17 ) ) ;
V_10 = F_6 ( V_22 ) ;
if ( V_10 && V_10 -> V_15 == V_15 )
F_2 ( V_2 , V_10 ) ;
...
if ( ! F_12 ( V_10 , V_12 ) )
continue;
if ( ! V_15 -> V_12 [ V_3 ] . V_28 ) {
F_13 ( V_15 -> V_29 , L_1 ) ;
return - V_30 ;
}
if ( V_25 >= V_4 ) {
V_23 = F_14 ( V_10 , false ) ;
if ( V_23 )
return V_23 ;
continue;
}
...
return V_23 ;
V_2 -> V_5 [ V_25 ++ ] = V_27 ;
V_23 = F_16 ( V_15 , & V_15 -> V_12 [ V_3 ] , 16 ) ;
if ( V_23 )
return V_23 ;
if ( ! F_17 ( V_15 , V_3 , V_27 ) ) {
F_18 ( & V_15 -> V_12 [ V_3 ] ) ;
V_23 = F_14 ( V_10 , false ) ;
if ( V_23 )
return V_23 ;
