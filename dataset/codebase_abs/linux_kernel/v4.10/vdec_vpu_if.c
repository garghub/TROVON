...
V_4 -> V_21 = 0 ;
V_4 -> V_22 = 0 ;
V_23 = F_7 ( V_4 -> V_7 , V_4 -> V_24 , V_2 , V_11 ) ;
if ( V_23 ) {
F_5 ( V_4 , L_7 ,
V_4 -> V_24 , V_14 , V_23 ) ;
return V_23 ;
...
F_10 ( V_4 ) ;
F_11 ( & V_4 -> V_27 ) ;
V_23 = F_12 ( V_4 -> V_7 , V_4 -> V_24 , V_4 -> V_28 , L_9 , NULL ) ;
if ( V_23 != 0 ) {
F_5 ( V_4 , L_10 , V_23 ) ;
return V_23 ;
}
...
int F_13 ( struct V_3 * V_4 , T_1 * V_10 , unsigned int V_11 )
{
struct V_30 V_2 ;
int V_31 ;
int V_23 = 0 ;
