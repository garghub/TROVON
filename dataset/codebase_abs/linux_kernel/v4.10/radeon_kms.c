...
V_9 = F_51 ( V_4 -> V_175 . V_176 , false ) ;
if ( V_9 ) {
F_52 ( V_4 , V_173 ) ;
F_10 ( V_171 ) ;
goto V_174;
}
V_173 -> V_177 = F_53 ( V_4 , V_173 ,
V_4 -> V_175 . V_176 ) ;
V_9 = F_54 ( V_4 , V_173 -> V_177 ,
V_178 ,
V_179 |
V_180 ) ;
if ( V_9 ) {
...
if ( ! V_9 ) {
if ( V_173 -> V_177 )
F_56 ( V_4 , V_173 -> V_177 ) ;
F_57 ( V_4 -> V_175 . V_176 ) ;
}
F_52 ( V_4 , V_173 ) ;
}
F_10 ( V_171 ) ;
...
T_3 F_61 ( struct V_1 * V_2 , unsigned int V_181 )
{
...
if ( V_4 -> V_33 . V_58 [ V_181 ] ) {
do {
V_185 = F_62 ( V_4 , V_181 ) ;
V_184 = F_63 (
V_2 , V_181 , V_186 ,
& V_182 , & V_183 , NULL , NULL ,
& V_4 -> V_33 . V_58 [ V_181 ] -> V_59 . V_187 ) ;
} while ( V_185 != F_62 ( V_4 , V_181 ) );
...
F_66 ( & V_4 -> V_191 . V_192 , V_190 ) ;
V_4 -> V_191 . V_193 [ V_39 ] = true ;
V_9 = F_67 ( V_4 ) ;
F_68 ( & V_4 -> V_191 . V_192 , V_190 ) ;
return V_9 ;
}
...
struct V_38 * V_197 ;
struct V_3 * V_4 = V_2 -> V_5 ;
if ( V_39 < 0 || V_39 >= V_2 -> V_198 ) {
F_33 ( L_19 , V_39 ) ;
return - V_63 ;
}
V_197 = & V_4 -> V_33 . V_58 [ V_39 ] -> V_59 ;
if ( ! V_197 )
return - V_63 ;
return F_71 ( V_2 , V_39 , V_194 ,
V_196 , V_8 ,
& V_197 -> V_187 ) ;
}
