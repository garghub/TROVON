...
V_108 ) )
goto V_111;
if ( V_85 -> V_117 . V_79 != 0 &&
V_85 -> V_117 . V_81 != 0 ) {
if ( ! F_43 ( V_49 -> V_85 ,
& V_85 -> V_117 ,
V_49 -> V_85 -> V_118 ,
V_49 -> V_85 -> V_119 ,
V_49 -> V_85 -> V_120 -> V_121 ) )
goto V_111;
}
} else if ( ! strcmp ( V_107 -> V_109 , L_14 ) ) {
if ( F_42 ( & V_53 -> V_115 ,
V_107 ,
V_108 ) )
goto V_111;
...
F_44 ( V_49 -> V_2 , V_108 ) ;
} else if ( ! strcmp ( V_107 -> V_109 , L_15 ) ) {
const struct V_122 * V_123
= V_49 -> V_124 ;
V_123 -> V_125 ( V_49 , V_108 ) ;
}
V_116:
return 0 ;
V_111:
...
T_1 V_129 ;
int V_87 ;
V_54 = F_48 ( sizeof( struct V_54 ) , V_130 ) ;
if ( ! V_54 ) {
F_5 ( V_2 -> V_2 , L_16 ) ;
return;
}
V_126 = F_48 ( sizeof( struct V_126 ) , V_130 ) ;
if ( ! V_126 ) {
F_5 ( V_2 -> V_2 , L_17 ) ;
goto V_131;
}
V_56 = F_48 ( sizeof( struct V_55 ) , V_130 ) ;
if ( ! V_56 ) {
F_5 ( V_2 -> V_2 , L_18 ) ;
goto V_132;
}
...
V_4 -> V_149 ,
V_25 ) ;
V_56 -> V_104 = F_55 ( V_2 , V_150 , L_19 ) ;
if ( ! V_56 -> V_104 ) {
F_56 ( V_88 ,
& V_2 -> V_151 -> V_2 , L_20 ) ;
goto V_152;
}
V_56 -> V_104 -> V_20 = 0x2C ;
V_4 -> V_14 = V_56 -> V_104 ;
V_56 -> V_105 = F_55 ( V_2 , V_153 , L_21 ) ;
if ( ! V_56 -> V_105 ) {
F_56 ( V_88 , & V_2 -> V_151 -> V_2 ,
L_22 L_23 ) ;
goto V_154;
}
F_57 ( & V_2 -> V_147 . V_155 ) ;
F_32 ( V_53 , & V_56 -> V_105 -> V_30 ) ;
