...
V_76 = F_19 ( & V_14 -> V_50 , sizeof( * V_76 ) ,
V_59 ) ;
if ( ! V_76 )
return - V_60 ;
...
V_76 -> V_14 = V_14 ;
V_76 -> V_66 = V_2 ;
for ( V_77 = 0 ; V_77 < V_6 -> V_57 / 4 ; V_77 ++ )
F_3 ( V_14 , V_6 -> V_8 + V_77 , 0x00 ) ;
for ( V_77 = 0 ; V_77 < V_6 -> V_57 ; V_77 ++ ) {
V_2 [ V_77 ] . V_9 = V_77 ;
V_2 [ V_77 ] . V_6 = V_76 ;
if ( V_53 && V_77 < V_53 -> V_66 . V_67 ) {
if ( V_53 -> V_66 . V_66 [ V_77 ] . V_64 )
snprintf ( V_2 [ V_77 ] . V_64 ,
sizeof( V_2 [ V_77 ] . V_64 ) , L_9 ,
V_53 -> V_66 . V_66 [ V_77 ] . V_64 ) ;
if ( V_53 -> V_66 . V_66 [ V_77 ] . V_65 )
V_2 [ V_77 ] . V_31 . V_65 =
V_53 -> V_66 . V_66 [ V_77 ] . V_65 ;
}
if ( ! V_53 || V_77 >= V_53 -> V_66 . V_67 ||
! V_53 -> V_66 . V_66 [ V_77 ] . V_64 )
snprintf ( V_2 [ V_77 ] . V_64 , sizeof( V_2 [ V_77 ] . V_64 ) ,
L_10 , V_14 -> V_85 -> V_86 ,
V_14 -> V_87 , V_77 ) ;
V_2 [ V_77 ] . V_31 . V_64 = V_2 [ V_77 ] . V_64 ;
V_2 [ V_77 ] . V_31 . V_88 = F_11 ;
if ( V_53 && V_53 -> V_71 == V_72 )
V_2 [ V_77 ] . V_31 . V_89 = F_15 ;
V_78 = F_32 ( & V_14 -> V_50 , & V_2 [ V_77 ] . V_31 ) ;
if ( V_78 < 0 )
goto exit;
}
...
int V_77 ;
for ( V_77 = 0 ; V_77 < V_2 -> V_7 -> V_57 ; V_77 ++ )
F_33 ( & V_2 -> V_66 [ V_77 ] . V_31 ) ;
return 0 ;
}
