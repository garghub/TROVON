...
static int F_34 ( struct V_12 * V_12 ,
struct V_13 * V_13 )
{
struct V_54 * V_55 = V_13 -> V_15 ;
F_17 ( V_55 ) ;
...
V_55 -> V_73 = V_73 ;
memset ( ( void * ) V_55 -> V_74 , 0 , V_73 ) ;
V_55 -> V_37 = F_36 ( V_55 , V_58 ) ;
V_13 -> V_15 = V_55 ;
return 0 ;
}
static T_1 F_37 ( struct V_13 * V_13 ,
char T_2 * V_17 ,
T_3 V_41 ,
T_4 * V_42 )
{
...
static int F_38 ( struct V_12 * V_12 ,
struct V_13 * V_13 )
{
struct V_54 * V_55 = V_13 -> V_15 ;
F_7 ( V_55 -> V_74 ) ;
...
int F_39 ( struct V_56 * V_56 )
{
int V_1 = - 1 ;
char V_75 [ 16 ] ;
snprintf ( V_75 , sizeof( V_75 ) , L_23 , V_56 -> V_76 -> V_77 -> V_78 ) ;
if ( ! V_4 ) {
F_3 ( V_3 L_24 ) ;
return V_1 ;
}
