...
int V_13 ;
T_1 V_185 ;
V_13 = F_5 ( V_2 , F_6 ( V_186 ) ,
& V_185 ) ;
if ( V_13 )
goto V_29;
V_13 = F_50 ( V_2 , F_6 ( V_186 ) ,
( V_185 | ( 1 << 12 ) ) ) ;
V_29:
return V_13 ;
}
...
| V_193
| V_194 ;
if ( V_22 -> V_181 . V_195 == 0x0001 && V_22 -> V_181 . V_196 == 0x0001 )
V_2 -> V_191 |= V_197 ;
V_2 -> V_191 |= V_198 ;
}
...
static int F_90 ( struct V_1 * V_2 , bool V_207 ,
enum V_49 V_50 )
{
struct V_21 * V_22 = F_19 ( V_2 ) ;
int V_13 ;
...
static int T_5 F_91 ( char * V_208 )
{
F_92 ( V_209 , V_208 , V_210 ) ;
return 1 ;
}
...
struct V_21 * V_22 ;
struct V_211 * V_167 ;
if ( strlen ( V_209 ) && strcmp ( V_209 , F_94 ( V_15 ) ) )
return - V_212 ;
V_22 = F_95 ( V_15 , sizeof( * V_22 ) , V_213 ) ;
if ( ! V_22 ) {
V_13 = - V_214 ;
F_7 ( V_15 , L_44 , V_16 ) ;
goto V_29;
...
V_22 -> V_2 = V_2 ;
F_96 ( V_2 , V_22 ) ;
V_22 -> V_34 = F_97 ( V_15 , L_45 ) ;
if ( V_22 -> V_34 == F_98 ( - V_215 ) ) {
V_13 = - V_215 ;
F_99 ( V_15 , L_46 ,
V_16 , V_13 ) ;
goto V_216;
} else if ( F_10 ( V_22 -> V_34 ) ) {
V_13 = F_11 ( V_22 -> V_34 ) ;
...
if ( V_13 )
goto V_216;
F_100 ( V_2 , & V_22 -> V_181 . V_182 ,
& V_22 -> V_181 . V_195 , & V_22 -> V_181 . V_196 ) ;
if ( V_22 -> V_181 . V_182 >= 0x02 ) {
V_22 -> V_160 = V_2 -> V_10 + V_42 ;
V_22 -> V_163 = F_101 ( 26 ) ;
} else {
V_167 = F_102 ( V_148 , V_217 , 1 ) ;
if ( V_167 ) {
V_22 -> V_160 =
F_103 ( V_15 , V_167 ) ;
if ( F_10 ( V_22 -> V_160 ) ) {
...
F_104 ( V_22 -> V_34 ,
V_22 -> V_181 . V_182 , V_22 -> V_181 . V_195 , V_22 -> V_181 . V_196 ) ;
F_105 ( V_22 -> V_34 ) ;
V_13 = F_56 ( V_22 -> V_34 ) ;
if ( V_13 )
goto V_218;
...
F_88 ( V_2 ) ;
F_90 ( V_2 , true , V_52 ) ;
if ( V_2 -> V_15 -> V_220 < V_221 )
V_222 [ V_2 -> V_15 -> V_220 ] = V_22 ;
V_22 -> V_223 |= V_224 ;
F_106 ( V_22 ) ;
V_13 = F_107 ( V_22 ) ;
if ( V_13 ) {
...
void * V_11 , void (* F_116)( struct V_1 * V_2 ,
int V_3 , int V_231 , char * V_208 , void * V_11 ) )
{
T_1 V_232 ;
struct V_21 * V_22 ;
if ( F_117 ( ! V_2 ) ) {
...
if ( ! ( V_22 -> V_223 & V_233 ) )
return;
V_232 = F_118 ( V_22 , V_234 ) ;
F_116 ( V_2 , V_232 , 44 , L_52 , V_11 ) ;
V_232 = F_40 ( V_2 , V_42 ) ;
V_232 |= F_119 ( 17 ) ;
F_39 ( V_2 , V_232 , V_42 ) ;
V_232 = F_118 ( V_22 , V_235 ) ;
F_116 ( V_2 , V_232 , 32 , L_53 , V_11 ) ;
V_232 = F_118 ( V_22 , V_236 ) ;
F_116 ( V_2 , V_232 , 128 , L_54 , V_11 ) ;
V_232 = F_118 ( V_22 , V_237 ) ;
F_116 ( V_2 , V_232 , 64 , L_55 , V_11 ) ;
F_29 ( V_2 , F_119 ( 17 ) , 0 , V_42 ) ;
V_232 = F_118 ( V_22 , V_238 ) ;
F_116 ( V_2 , V_232 , 4 , L_56 , V_11 ) ;
V_232 = F_118 ( V_22 , V_239 ) ;
F_116 ( V_2 , V_232 , 4 , L_57 , V_11 ) ;
V_232 = F_118 ( V_22 , V_240 ) ;
F_116 ( V_2 , V_232 , 48 , L_58 , V_11 ) ;
V_232 = F_118 ( V_22 , V_241 ) ;
F_116 ( V_2 , V_232 , 27 , L_59 , V_11 ) ;
V_232 = F_118 ( V_22 , V_242 ) ;
F_116 ( V_2 , V_232 , 19 , L_60 , V_11 ) ;
V_232 = F_118 ( V_22 , V_243 ) ;
F_116 ( V_2 , V_232 , 34 , L_61 , V_11 ) ;
V_232 = F_118 ( V_22 , V_244 ) ;
F_116 ( V_2 , V_232 , 9 , L_62 , V_11 ) ;
}
static void F_120 ( struct V_21 * V_22 )
{
if ( V_22 -> V_223 & V_245 )
F_29 ( V_22 -> V_2 , V_246 , V_246 , V_42 ) ;
else
F_29 ( V_22 -> V_2 , V_246 , 0 , V_42 ) ;
}
static void F_106 ( struct V_21 * V_22 )
{
V_22 -> V_247 . V_248 = V_249 ;
V_22 -> V_247 . V_250 = 1 ;
}
static bool F_121 ( struct V_21 * V_22 )
{
if ( V_22 -> V_247 . V_248 >= V_251 ) {
F_7 ( V_22 -> V_2 -> V_15 ,
L_63 ,
V_16 , V_22 -> V_247 . V_248 ) ;
return false ;
}
if ( V_22 -> V_247 . V_250 > 0x1F ) {
F_7 ( V_22 -> V_2 -> V_15 ,
L_64 ,
V_16 , V_22 -> V_247 . V_250 ) ;
return false ;
}
return true ;
}
...
V_252 <<= V_3 ;
F_122 ( V_22 -> V_2 -> V_15 ) ;
F_123 ( V_22 -> V_2 , false ) ;
F_29 ( V_22 -> V_2 , V_270 ,
( T_1 ) V_22 -> V_247 . V_248 << 19 ,
V_42 ) ;
F_29 ( V_22 -> V_2 , V_252 ,
( T_1 ) V_22 -> V_247 . V_250 << V_3 ,
V_232 ) ;
F_120 ( V_22 ) ;
F_124 ( V_22 -> V_2 ) ;
F_125 ( V_22 -> V_2 -> V_15 ) ;
...
static int F_128 ( struct V_147 * V_148 )
{
int V_13 ;
struct V_17 * V_15 = & V_148 -> V_15 ;
V_13 = F_129 ( V_148 , & V_272 ) ;
if ( V_13 )
F_7 ( V_15 , L_67 , V_13 ) ;
return V_13 ;
}
