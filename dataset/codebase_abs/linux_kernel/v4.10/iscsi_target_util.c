...
while ( F_110 ( & V_227 ) ) {
V_224 = F_111 ( V_15 -> V_202 , & V_227 , V_231 ) ;
if ( V_224 <= 0 ) {
F_26 ( L_42 ,
V_224 , V_225 ) ;
return V_224 ;
...
V_206 = V_223 -> V_176 ;
V_196 = V_223 -> V_174 ;
V_49 = F_113 ( V_15 -> V_202 , & V_227 , V_206 , V_196 ,
V_223 -> V_78 ) ;
if ( V_49 != V_223 -> V_78 ) {
F_3 ( L_45 ,
V_49 , V_223 -> V_78 ) ;
...
V_233 . V_78 = V_142 ;
V_233 . type = V_235 ;
return F_112 ( V_15 , & V_233 ) ;
}
static bool F_115 ( struct V_236 * V_237 , struct V_236 * V_238 )
{
switch ( V_237 -> V_239 ) {
case V_240 : {
...
if ( ! F_116 ( & V_242 -> V_249 , & V_243 -> V_249 ) )
return false ;
...
V_254 = & V_151 -> V_255 ;
F_44 ( & V_254 -> V_154 ) ;
if ( F_115 ( & V_15 -> V_256 , & V_254 -> V_257 ) &&
( ( F_88 () - V_254 -> V_258 ) < 10 ) ) {
F_45 ( & V_254 -> V_154 ) ;
return;
}
...
struct V_150 * F_117 ( struct V_21 * V_15 )
{
struct V_148 * V_149 ;
if ( ! V_15 || ! V_15 -> V_25 )
return NULL ;
