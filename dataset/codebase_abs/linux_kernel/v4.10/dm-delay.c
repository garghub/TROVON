...
V_9 -> V_59 = V_3 -> V_43 -> V_60 ;
if ( F_44 ( V_9 ) )
V_9 -> V_61 . V_62 = V_3 -> V_46 +
F_45 ( V_29 , V_9 -> V_61 . V_62 ) ;
return F_35 ( V_3 , V_3 -> V_47 , V_9 ) ;
}
V_9 -> V_59 = V_3 -> V_42 -> V_60 ;
V_9 -> V_61 . V_62 = V_3 -> V_39 +
F_45 ( V_29 , V_9 -> V_61 . V_62 ) ;
return F_35 ( V_3 , V_3 -> V_40 , V_9 ) ;
}
static void F_46 ( struct V_28 * V_29 , T_1 type ,
...
switch ( type ) {
case V_67 :
F_47 ( L_13 , V_3 -> V_25 , V_3 -> V_24 ) ;
break;
case V_68 :
F_47 ( L_14 , V_3 -> V_42 -> V_69 ,
( unsigned long long ) V_3 -> V_39 ,
V_3 -> V_40 ) ;
if ( V_3 -> V_43 )
F_47 ( L_15 , V_3 -> V_43 -> V_69 ,
...
struct V_2 * V_3 = V_29 -> V_55 ;
int V_34 = 0 ;
V_34 = V_70 ( V_29 , V_3 -> V_42 , V_3 -> V_39 , V_29 -> V_71 , V_1 ) ;
if ( V_34 )
goto V_44;
if ( V_3 -> V_43 )
V_34 = V_70 ( V_29 , V_3 -> V_43 , V_3 -> V_46 , V_29 -> V_71 , V_1 ) ;
V_44:
return V_34 ;
}
