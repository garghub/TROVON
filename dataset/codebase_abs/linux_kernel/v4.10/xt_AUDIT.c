...
if ( V_34 == 0 )
goto V_35;
V_2 = F_10 ( NULL , V_36 , V_37 ) ;
if ( V_2 == NULL )
goto V_35;
F_3 ( V_2 , L_7 ,
V_32 -> type , F_11 ( V_30 ) , V_4 -> V_38 ,
F_12 ( V_30 ) ? F_13 ( V_30 ) : L_8 ,
F_14 ( V_30 ) ? F_15 ( V_30 ) : L_8 ) ;
if ( V_4 -> V_39 )
F_3 ( V_2 , L_9 , V_4 -> V_39 ) ;
if ( V_4 -> V_40 && V_4 -> V_40 -> type == V_41 ) {
F_3 ( V_2 , L_10 ,
F_16 ( V_4 ) -> V_42 , F_16 ( V_4 ) -> V_43 ,
F_4 ( F_16 ( V_4 ) -> V_44 ) ) ;
if ( F_17 ( V_30 ) == V_45 ) {
switch ( F_16 ( V_4 ) -> V_44 ) {
case F_18 ( V_46 ) :
F_5 ( V_2 , V_4 ) ;
break;
case F_18 ( V_47 ) :
...
static unsigned int
F_22 ( struct V_3 * V_4 , const struct V_29 * V_30 )
{
F_9 ( V_4 , V_30 ) ;
return V_52 ;
}
static int F_23 ( const struct V_53 * V_30 )
{
const struct V_31 * V_32 = V_30 -> V_33 ;
if ( V_32 -> type > V_54 ) {
F_24 ( L_11 ,
