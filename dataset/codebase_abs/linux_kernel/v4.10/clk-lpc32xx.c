...
{
struct V_23 * V_6 = F_13 ( V_12 ) ;
T_1 V_51 , V_52 = V_31 , V_53 = * V_27 , V_54 = ( T_1 ) V_31 << 6 ;
...
V_51 = F_23 ( V_52 * V_59 * ( 1 << V_58 ) , V_53 ) ;
if ( ! ( V_51 && V_51 <= 256
&& F_1 ( V_53 , V_59 , 1000000 , 27000000 )
&& F_1 ( V_53 * V_51 * ( 1 << V_58 ) , V_59 ,
156000000 , 320000000 ) ) )
continue;
if ( V_52 * V_59 * ( 1 << V_58 ) - V_53 * V_51 <= V_54 ) {
V_55 = V_51 ;
V_56 = V_59 ;
V_57 = V_58 ;
V_54 = V_52 * V_59 * ( 1 << V_58 ) - V_53 * V_51 ;
}
}
}
if ( V_54 == ( T_1 ) V_31 << 6 ) {
...
V_6 -> V_43 = V_48 ;
V_52 = F_23 ( V_53 * V_55 , V_56 * ( 1 << V_57 ) ) ;
if ( ! V_54 )
F_18 ( L_5 ,
F_19 ( V_12 ) , V_31 , V_55 , V_56 , V_57 ) ;
else
F_18 ( L_6 ,
F_19 ( V_12 ) , V_31 , V_55 , V_56 , V_57 , V_52 ) ;
return V_52 ;
}
...
V_55 = F_23 ( 192000000 * V_62 * V_59 , V_52 ) ;
if ( ! ( V_55 && V_55 <= 256
&& V_55 * V_52 == 192000000 * V_62 * V_59
&& F_1 ( V_52 , V_62 , 1000000 , 20000000 )
&& F_1 ( V_52 , V_62 * V_59 , 1000000 , 27000000 ) ) )
continue;
V_6 -> V_39 = V_59 ;
V_6 -> V_37 = V_55 ;
V_6 -> V_41 = 2 ;
...
if ( V_91 -> V_79 ) {
T_2 V_53 ;
for ( V_53 = 0 ; V_53 < V_92 ; V_53 ++ )
if ( V_91 -> V_79 [ V_53 ] == V_9 )
return V_53 ;
return - V_50 ;
}
if ( V_9 >= V_92 )
...
struct V_6 * V_6 ;
unsigned int V_53 ;
for ( V_53 = 0 ; V_53 < V_13 -> V_92 ; V_53 ++ )
V_98 [ V_53 ] = V_96 [ V_13 -> V_98 [ V_53 ] ] . V_100 ;
F_18 ( L_8 , V_13 -> V_100 ,
V_98 [ 0 ] , V_11 -> type ) ;
switch ( V_11 -> type ) {
case V_101 :
...
static void T_4 F_63 ( T_2 V_15 , T_2 F_47 , T_2 V_114 )
{
T_2 V_9 ;
F_8 ( V_14 , V_15 , & V_9 ) ;
if ( ! ( V_9 & F_47 ) ) {
...
F_9 ( V_14 , V_15 , V_114 | F_47 , V_9 ) ;
}
static void T_4 F_65 ( struct V_134 * V_135 )
{
unsigned int V_53 ;
struct V_6 * V_136 , * V_137 ;
void T_5 * V_138 = NULL ;
V_137 = F_66 ( V_135 , V_96 [ V_139 ] . V_100 ) ;
if ( F_67 ( V_137 ) ) {
F_20 ( L_9 ,
F_68 ( V_137 ) ) ;
return;
...
V_136 = F_66 ( V_135 , V_96 [ V_140 ] . V_100 ) ;
if ( F_67 ( V_136 ) ) {
F_20 ( L_11 ,
F_68 ( V_136 ) ) ;
return;
...
F_63 ( V_142 , 0xf0 , F_28 ( 0 ) ) ;
F_63 ( V_142 , 0xf00 , F_28 ( 2 ) ) ;
F_63 ( V_143 , 0xf , F_28 ( 5 ) | F_28 ( 9 ) ) ;
for ( V_53 = 1 ; V_53 < V_144 ; V_53 ++ ) {
V_6 [ V_53 ] = F_58 ( V_53 ) ;
if ( F_67 ( V_6 [ V_53 ] ) ) {
F_20 ( L_14 ,
V_96 [ V_53 ] . V_100 , F_68 ( V_6 [ V_53 ] ) ) ;
V_6 [ V_53 ] = NULL ;
}
}
F_72 ( V_135 , V_145 , & V_146 ) ;
F_73 ( V_6 [ V_147 ] , 48000000 ) ;
F_74 ( V_6 [ V_148 ] ) ;
F_74 ( V_6 [ V_149 ] ) ;
F_74 ( V_6 [ V_150 ] ) ;
F_10 ( & V_97 [ V_151 ] . V_111 . V_6 . V_12 ) ;
F_10 ( & V_97 [ V_152 ] . V_111 . V_6 . V_12 ) ;
}
static void T_4 F_75 ( struct V_134 * V_135 )
{
unsigned int V_53 ;
V_7 = F_69 ( V_135 , 0 ) ;
if ( ! V_7 ) {
...
for ( V_53 = 1 ; V_53 < V_153 ; V_53 ++ ) {
V_113 [ V_53 ] = F_58 ( V_53 + V_154 ) ;
if ( F_67 ( V_113 [ V_53 ] ) ) {
F_20 ( L_14 ,
V_96 [ V_53 ] . V_100 , F_68 ( V_113 [ V_53 ] ) ) ;
V_113 [ V_53 ] = NULL ;
}
}
F_72 ( V_135 , V_145 , & V_155 ) ;
}
