...
unsigned int V_159 , V_256 , V_257 ;
V_1 V_227 ;
int V_258 , V_171 ;
union V_259 * V_215 ;
T_1 T_2 * V_260 ;
...
V_268:
F_24 ( V_269 , 1 , V_218 , 0 ) ;
F_25 ( V_270 ) ;
switch ( F_26 ( V_227 ) ) {
case V_11 :
V_261 = ( T_3 T_2 * ) ( V_218 -> V_162 [ F_27 ( V_227 ) ] +
F_28 ( V_227 ) ) ;
F_25 ( V_271 ) ;
...
F_31 ( V_263 , F_17 ( V_227 ) ) ;
break;
case V_17 :
V_261 = ( T_3 T_2 * ) ( V_218 -> V_162 [ F_27 ( V_227 ) ] +
F_28 ( V_227 ) ) ;
F_25 ( V_276 ) ;
F_32 ( V_263 , F_17 ( V_227 ) ) ;
...
break;
case V_15 :
V_260 = ( T_1 T_2 * ) ( V_218 -> V_162 [ F_27 ( V_227 ) ] +
F_28 ( V_227 ) ) ;
F_25 ( V_271 ) ;
...
F_34 ( V_262 , F_17 ( V_227 ) ) ;
break;
case V_19 :
V_260 = ( T_1 T_2 * ) ( V_218 -> V_162 [ F_27 ( V_227 ) ] +
F_28 ( V_227 ) ) ;
F_25 ( V_276 ) ;
F_35 ( V_262 , F_17 ( V_227 ) ) ;
...
return V_28 ;
V_159 = V_258 = 0 ;
V_215 = & V_212 -> V_213 . V_214 . V_215 [ F_17 ( V_227 ) ] ;
V_257 = F_5 ( V_215 , 0 ) & 0x1 ;
switch ( F_27 ( V_227 ) ) {
case V_210 :
V_159 = V_257 == 0 ;
break;
...
if ( V_164 . V_172 == 2 )
V_227 = ( V_227 & ( ~ 0xffff ) ) | V_294 ;
V_264 = F_39 ( V_218 , V_227 ,
V_293 , V_165 ) ;
if ( V_264 < 0 )
break;
if ( V_264 )
...
V_264 = F_39 ( V_218 , V_227 , V_293 , V_165 ) ;
if ( V_264 < 0 )
break;
if ( V_264 )
V_218 -> V_170 = V_293 ;
...
if ( ! ( F_27 ( V_227 ) & 0x10 ) )
return V_28 ;
if ( ( V_264 = F_41 ( V_218 , V_226 , V_227 ) ) )
return V_264 ;
}
break;
case V_48 :
if ( ! V_296 )
return V_28 ;
V_264 = F_42 ( V_218 , V_226 , V_227 , V_255 ) ;
if ( V_264 )
return V_264 ;
break;
case V_97 :
...
static union V_297 F_43 ( union V_297 V_298 )
{
return F_44 ( F_45 ( 0 ) , V_298 ) ;
}
static union V_297 F_46 ( union V_297 V_298 )
{
return F_44 ( F_45 ( 0 ) , F_47 ( V_298 ) ) ;
}
static union V_299 F_48 ( union V_299 V_300 )
{
return F_49 ( F_50 ( 0 ) , V_300 ) ;
}
static union V_299 F_51 ( union V_299 V_300 )
{
return F_49 ( F_50 ( 0 ) , F_52 ( V_300 ) ) ;
}
...
switch ( F_53 ( V_227 ) ) {
case V_303 : {
union V_299 ( * V_304 ) ( union V_299 , union V_299 , union V_299 ) ;
union V_299 V_53 , V_49 , V_52 , V_51 ;
T_1 T_2 * V_305 ;
T_1 V_306 ;
switch ( F_40 ( V_227 ) ) {
case V_61 :
V_305 = ( void T_2 * ) ( V_218 -> V_162 [ F_54 ( V_227 ) ] +
V_218 -> V_162 [ F_55 ( V_227 ) ] ) ;
F_25 ( V_271 ) ;
if ( ! F_29 ( V_272 , V_305 , sizeof( T_1 ) ) ) {
F_25 ( V_273 ) ;
* V_255 = V_305 ;
return V_274 ;
}
...
F_34 ( V_306 , F_56 ( V_227 ) ) ;
break;
case V_63 :
V_305 = ( void T_2 * ) ( V_218 -> V_162 [ F_54 ( V_227 ) ] +
V_218 -> V_162 [ F_55 ( V_227 ) ] ) ;
F_25 ( V_276 ) ;
F_35 ( V_306 , F_57 ( V_227 ) ) ;
if ( ! F_29 ( V_277 , V_305 , sizeof( T_1 ) ) ) {
F_25 ( V_273 ) ;
* V_255 = V_305 ;
return V_274 ;
}
...
V_226 -> V_166 = ( V_226 -> V_166 & ~ V_238 ) | V_301 ;
if ( ( V_226 -> V_166 >> 5 ) & V_226 -> V_166 & V_235 ) {
return V_284 ;
}
break;
...
case V_329 : {
union V_297 ( * V_304 ) ( union V_297 , union V_297 , union V_297 ) ;
...
V_218 -> V_162 [ F_55 ( V_227 ) ] ) ;
F_25 ( V_271 ) ;
if ( ! F_29 ( V_272 , V_305 , sizeof( T_3 ) ) ) {
F_25 ( V_273 ) ;
* V_255 = V_305 ;
return V_274 ;
}
...
F_31 ( V_306 , F_56 ( V_227 ) ) ;
break;
case V_59 :
V_305 = ( void T_2 * ) ( V_218 -> V_162 [ F_54 ( V_227 ) ] +
V_218 -> V_162 [ F_55 ( V_227 ) ] ) ;
F_25 ( V_276 ) ;
F_32 ( V_306 , F_57 ( V_227 ) ) ;
if ( ! F_29 ( V_277 , V_305 , sizeof( T_3 ) ) ) {
F_25 ( V_273 ) ;
* V_255 = V_305 ;
return V_274 ;
}
...
T_3 V_341 ;
F_25 ( V_342 ) ;
switch ( V_336 = ( F_64 ( V_227 ) & 0xf ) ) {
case V_303 : {
union {
union V_299 ( * V_343 ) ( union V_299 , union V_299 ) ;
union V_299 ( * V_344 ) ( union V_299 ) ;
} V_304 ;
...
if ( ! V_286 )
return V_28 ;
V_159 = V_287 [ F_55 ( V_227 ) >> 2 ] ;
if ( ( ( V_226 -> V_166 & V_159 ) != 0 ) !=
( ( F_55 ( V_227 ) & 1 ) != 0 ) )
return 0 ;
F_59 ( V_340 . V_300 , F_57 ( V_227 ) ) ;
break;
case V_90 :
if ( ! V_286 )
return V_28 ;
...
V_340 . V_300 = F_65 ( V_53 , V_52 , V_51 ) ;
break;
}
case V_353 : {
union V_299 V_51 , V_52 , V_53 ;
...
F_59 ( V_52 , F_57 ( V_227 ) ) ;
F_59 ( V_53 , F_56 ( V_227 ) ) ;
V_340 . V_300 = F_66 ( V_53 , V_52 , V_51 ) ;
break;
}
case V_354 : {
union V_299 V_52 ;
...
return V_28 ;
F_59 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_339 = F_67 ( V_52 ) ;
V_340 . V_300 = F_68 ( V_340 . V_339 ) ;
goto V_312;
}
case V_355 : {
union V_299 V_52 ;
...
F_59 ( V_52 , F_57 ( V_227 ) ) ;
F_59 ( V_51 , F_55 ( V_227 ) ) ;
V_340 . V_300 = (* V_304 . V_343 ) ( V_52 , V_51 ) ;
goto V_312;
V_349:
F_59 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_300 = (* V_304 . V_344 ) ( V_52 ) ;
goto V_312;
V_312:
if ( F_61 ( V_313 ) ) {
F_25 ( V_314 ) ;
...
case V_104 :
F_59 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_298 = F_74 ( V_52 ) ;
V_336 = V_329 ;
goto V_312;
case V_137 :
F_59 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_338 = F_75 ( V_52 ) ;
V_336 = V_356 ;
goto V_312;
case V_135 :
case V_133 :
...
goto V_312;
default:
if ( ! V_174 && F_40 ( V_227 ) >= V_372 ) {
unsigned V_373 = F_40 ( V_227 ) - V_372 ;
union V_299 V_52 , V_51 ;
F_59 ( V_52 , F_57 ( V_227 ) ) ;
F_59 ( V_51 , F_55 ( V_227 ) ) ;
V_340 . V_338 = F_76 ( V_52 , V_51 ,
V_374 [ V_373 & 0x7 ] , V_373 & 0x8 ) ;
V_336 = - 1 ;
if ( ( V_373 & 0x8 ) && F_61
( V_325 ) )
V_301 = V_327 | V_328 ;
...
case V_329 : {
union V_297 V_53 , V_52 , V_51 ;
union {
union V_297 ( * V_343 ) ( union V_297 , union V_297 ) ;
union V_297 ( * V_344 ) ( union V_297 ) ;
} V_304 ;
switch ( F_40 ( V_227 ) ) {
case V_79 :
V_304 . V_343 = V_375 ;
...
V_340 . V_298 = F_77 ( V_53 , V_52 , V_51 ) ;
break;
}
case V_353 : {
union V_297 V_51 , V_52 , V_53 ;
...
F_62 ( V_52 , F_57 ( V_227 ) ) ;
F_62 ( V_53 , F_56 ( V_227 ) ) ;
V_340 . V_298 = F_78 ( V_53 , V_52 , V_51 ) ;
break;
}
case V_354 : {
union V_297 V_52 ;
...
return V_28 ;
F_62 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_339 = F_79 ( V_52 ) ;
V_340 . V_298 = F_80 ( V_340 . V_339 ) ;
goto V_312;
}
case V_355 : {
union V_297 V_52 ;
...
F_62 ( V_52 , F_57 ( V_227 ) ) ;
F_62 ( V_51 , F_55 ( V_227 ) ) ;
V_340 . V_298 = (* V_304 . V_343 ) ( V_52 , V_51 ) ;
goto V_312;
V_379:
F_62 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_298 = (* V_304 . V_344 ) ( V_52 ) ;
goto V_312;
case V_107 :
F_62 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_300 = F_86 ( V_52 ) ;
V_336 = V_303 ;
goto V_312;
case V_104 :
return V_28 ;
...
case V_107 :
F_59 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_300 = F_89 ( V_52 . V_341 ) ;
V_336 = V_303 ;
goto V_312;
case V_104 :
F_59 ( V_52 , F_57 ( V_227 ) ) ;
V_340 . V_298 = F_90 ( V_52 . V_341 ) ;
V_336 = V_329 ;
goto V_312;
default: {
#define F_91 0x7
#define F_92 (0x1 << 3)
#define F_93 (0x1 << 4)
int V_373 = F_40 ( V_227 ) & F_91 ;
int V_264 = F_40 ( V_227 ) & F_92 ;
union V_299 V_52 , V_51 ;
if ( ! V_196 ||
( F_40 ( V_227 ) & 0x20 ) )
return V_28 ;
...
if ( ! V_370 )
return V_28 ;
F_32 ( V_341 , F_57 ( V_227 ) ) ;
switch ( F_40 ( V_227 ) ) {
case V_107 :
V_340 . V_300 = F_68 ( V_341 ) ;
V_336 = V_303 ;
goto V_312;
case V_104 :
V_340 . V_298 = F_80 ( V_341 ) ;
V_336 = V_329 ;
goto V_312;
default: {
int V_373 = F_40 ( V_227 ) & F_91 ;
...
break;
case V_329 :
F_63 ( V_340 . V_298 , F_56 ( V_227 ) ) ;
break;
case V_303 :
F_60 ( V_340 . V_300 , F_56 ( V_227 ) ) ;
break;
case V_356 :
F_34 ( V_340 . V_338 , F_56 ( V_227 ) ) ;
break;
case V_371 :
if ( ! V_370 )
return V_28 ;
F_31 ( V_340 . V_339 , F_56 ( V_227 ) ) ;
break;
default:
return V_28 ;
}
...
V_385 = V_218 -> V_170 ;
if ( F_96 ( V_385 ) && V_265 ) {
if ( ( F_97 ( V_386 [ 0 ] , ( T_5 T_2 * ) F_98 ( V_218 -> V_170 ) ) ) ||
( F_97 ( V_386 [ 1 ] , ( T_5 T_2 * ) F_98 ( V_218 -> V_170 + 2 ) ) ) ||
( F_97 ( V_386 [ 2 ] , ( T_5 T_2 * ) F_98 ( V_218 -> V_170 + 4 ) ) ) ||
( F_97 ( V_386 [ 3 ] , ( T_5 T_2 * ) F_98 ( V_218 -> V_170 + 6 ) ) ) ) {
F_25 ( V_273 ) ;
return V_274 ;
}
V_387 = V_386 ;
...
if ( ( V_164 . V_3 == 0 ) ||
( ( V_164 . V_171 == 2 ) &&
( ( V_164 . V_3 & 0xffff ) == V_294 ) ) )
V_218 -> V_170 += V_164 . V_171 ;
else {
V_264 = F_19 ( V_218 , V_226 , V_164 , V_255 ) ;
}
if ( V_383 )
break;
if ( V_264 )
break;
F_100 () ;
} while ( V_218 -> V_170 > V_385 );
if ( V_264 == V_28 && V_218 -> V_170 != V_384 )
V_264 = 0 ;
return V_264 ;
}
