...
int V_106 = 0 ;
long int V_126 ;
V_106 = V_2 -> V_9 -> V_3 . V_121 -> V_180 ( V_2 , V_146 , V_148 ) ;
if ( V_106 == - V_150 ) {
V_106 = 0 ;
switch ( V_146 ) {
case V_151 :
...
void F_99 ( struct V_1 * V_2 , int V_181 )
{
V_2 -> V_9 -> V_3 . V_121 -> V_182 ( V_2 , V_181 ) ;
}
void F_100 ( struct V_1 * V_2 )
{
V_2 -> V_9 -> V_3 . V_121 -> V_183 ( V_2 ) ;
}
void F_75 ( struct V_1 * V_2 , T_2 V_54 )
{
V_2 -> V_9 -> V_3 . V_121 -> V_184 ( V_2 , V_54 ) ;
}
int F_101 ( struct V_185 * V_185 , struct V_1 * V_2 )
{
return V_2 -> V_9 -> V_3 . V_121 -> V_186 ( V_185 , V_2 ) ;
}
...
{
return V_9 -> V_3 . V_121 -> V_193 ( V_9 , V_146 ) ;
}
void F_107 ( struct V_1 * V_2 )
{
V_2 -> V_9 -> V_3 . V_121 -> V_194 ( V_2 ) ;
}
int F_108 ( struct V_1 * V_2 )
{
return V_2 -> V_9 -> V_3 . V_121 -> V_195 ( V_2 ) ;
}
int F_109 ( struct V_9 * V_9 , struct V_196 * log )
{
return V_9 -> V_3 . V_121 -> V_197 ( V_9 , log ) ;
}
void F_110 ( struct V_9 * V_9 , struct V_198 * free ,
struct V_198 * V_199 )
{
V_9 -> V_3 . V_121 -> V_200 ( free , V_199 ) ;
}
int F_111 ( struct V_9 * V_9 , struct V_198 * V_201 ,
unsigned long V_202 )
{
return V_9 -> V_3 . V_121 -> V_203 ( V_201 , V_202 ) ;
}
void F_112 ( struct V_9 * V_9 , struct V_198 * V_204 )
{
V_9 -> V_3 . V_121 -> V_205 ( V_9 , V_204 ) ;
}
int F_113 ( struct V_9 * V_9 ,
struct V_198 * V_204 ,
const struct V_206 * V_207 )
{
return V_9 -> V_3 . V_121 -> V_208 ( V_9 , V_204 , V_207 ) ;
}
void F_114 ( struct V_9 * V_9 ,
const struct V_206 * V_207 ,
const struct V_198 * V_209 ,
const struct V_198 * V_210 )
{
V_9 -> V_3 . V_121 -> V_211 ( V_9 , V_207 , V_209 , V_210 ) ;
}
int F_115 ( struct V_9 * V_9 , unsigned long V_212 )
{
return V_9 -> V_3 . V_121 -> V_213 ( V_9 , V_212 ) ;
}
int F_116 ( struct V_9 * V_9 , unsigned long V_214 , unsigned long V_215 )
{
return V_9 -> V_3 . V_121 -> V_216 ( V_9 , V_214 , V_215 ) ;
}
int F_117 ( struct V_9 * V_9 , unsigned long V_214 , unsigned long V_215 )
{
return V_9 -> V_3 . V_121 -> V_217 ( V_9 , V_214 , V_215 ) ;
}
int F_118 ( struct V_9 * V_9 , unsigned long V_212 )
{
return V_9 -> V_3 . V_121 -> V_218 ( V_9 , V_212 ) ;
}
void F_119 ( struct V_9 * V_9 , unsigned long V_212 , T_7 V_98 )
{
V_9 -> V_3 . V_121 -> V_219 ( V_9 , V_212 , V_98 ) ;
}
void F_120 ( struct V_1 * V_2 )
{
V_2 -> V_9 -> V_3 . V_121 -> V_220 ( V_2 ) ;
}
...
F_124 ( & V_9 -> V_3 . V_222 ) ;
#endif
return V_9 -> V_3 . V_121 -> V_223 ( V_9 ) ;
}
void F_125 ( struct V_9 * V_9 )
{
V_9 -> V_3 . V_121 -> V_224 ( V_9 ) ;
#ifdef F_122
F_126 ( V_9 ) ;
F_127 ( ! F_128 ( & V_9 -> V_3 . V_221 ) ) ;
#endif
}
int F_129 ( struct V_1 * V_2 )
{
unsigned long V_225 = F_11 ( V_2 , 4 ) ;
unsigned long V_226 = F_11 ( V_2 , 5 ) ;
T_2 V_227 ;
int V_228 ;
int V_229 ;
if ( ! F_130 ( V_225 ) || ( V_225 > sizeof( V_227 ) ) )
return V_230 ;
V_228 = F_131 ( & V_2 -> V_9 -> V_231 ) ;
V_229 = F_132 ( V_2 , V_232 , V_226 , V_225 , & V_227 ) ;
F_133 ( & V_2 -> V_9 -> V_231 , V_228 ) ;
if ( V_229 != 0 )
return V_230 ;
switch ( V_225 ) {
case 1 :
F_84 ( V_2 , 4 , * ( V_233 * ) & V_227 ) ;
break;
case 2 :
F_84 ( V_2 , 4 , F_134 ( * ( V_234 * ) & V_227 ) ) ;
break;
case 4 :
F_84 ( V_2 , 4 , F_135 ( * ( V_235 * ) & V_227 ) ) ;
break;
case 8 :
F_84 ( V_2 , 4 , F_136 ( * ( V_236 * ) & V_227 ) ) ;
break;
default:
F_137 () ;
}
...
break;
case 2 :
* ( V_234 * ) & V_227 = F_139 ( V_148 ) ;
break;
case 4 :
* ( V_235 * ) & V_227 = F_140 ( V_148 ) ;
break;
case 8 :
* ( V_236 * ) & V_227 = F_141 ( V_148 ) ;
break;
default:
return V_230 ;
}
V_228 = F_131 ( & V_2 -> V_9 -> V_231 ) ;
V_229 = F_142 ( V_2 , V_232 , V_226 , V_225 , & V_227 ) ;
F_133 ( & V_2 -> V_9 -> V_231 , V_228 ) ;
if ( V_229 != 0 )
return V_230 ;
return V_237 ;
...
int F_144 ( struct V_9 * V_9 , unsigned long V_238 )
{
return V_9 -> V_3 . V_121 -> V_239 ( V_238 ) ;
}
static int F_145 ( void )
{
int V_106 ;
V_106 = F_146 ( NULL , sizeof( struct V_1 ) , 0 , V_240 ) ;
if ( V_106 )
return V_106 ;
#ifdef F_147
V_106 = F_148 () ;
