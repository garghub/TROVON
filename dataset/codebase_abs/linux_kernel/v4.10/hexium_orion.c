...
if ( 0 == ( V_6 = F_13 ( & V_3 -> V_21 , 0x4e , 0 , V_31 , 0x00 , V_32 , & V_5 ) ) ) {
F_12 ( L_7 ) ;
V_2 -> V_28 = V_3 ;
V_3 -> type = V_33 ;
return 0 ;
...
V_5 . V_36 = V_35 [ V_34 ] ;
if ( 0 != F_13 ( & V_3 -> V_21 , 0x4e , 0 , V_37 , V_34 , V_32 , & V_5 ) ) {
F_4 ( L_9 , V_34 ) ;
}
}
return 0 ;
}
static int F_17 ( struct V_3 * V_3 , int V_38 )
{
union V_4 V_5 ;
int V_34 = 0 ;
F_16 ( L_1 ) ;
...
if ( 0 != F_13 ( & V_3 -> V_21 , 0x4e , 0 , V_37 , V_39 , V_32 , & V_5 ) ) {
return - 1 ;
}
F_18 ( L_10 , V_38 , V_39 , V_5 . V_36 ) ;
}
return 0 ;
}
static int F_19 ( struct V_41 * V_41 , void * V_42 , struct V_43 * V_34 )
{
F_2 ( L_11 , V_34 -> V_44 ) ;
if ( V_34 -> V_44 >= V_45 )
return - V_46 ;
...
static int F_20 ( struct V_41 * V_41 , void * V_42 , unsigned int * V_38 )
{
...
static int F_21 ( struct V_41 * V_41 , void * V_42 , unsigned int V_38 )
{
struct V_1 * V_2 = ( (struct V_48 * ) V_42 ) -> V_2 ;
struct V_3 * V_3 = (struct V_3 * ) V_2 -> V_28 ;
if ( V_38 >= V_45 )
...
static int F_22 ( struct V_1 * V_2 , struct V_50 * V_51 )
{
struct V_3 * V_3 = (struct V_3 * ) V_2 -> V_28 ;
F_2 ( L_1 ) ;
F_23 ( V_2 , & V_52 ) ;
...
V_52 . V_53 . F_20 = F_20 ;
V_52 . V_53 . F_21 = F_21 ;
if ( 0 != F_24 ( & V_3 -> V_54 , V_2 , L_3 , V_55 ) ) {
F_4 ( L_14 ) ;
return - 1 ;
}
F_4 ( L_15 , V_56 ) ;
...
static int F_28 ( struct V_1 * V_2 , struct V_57 * V_58 )
{
return 0 ;
}
