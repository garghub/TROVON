...
struct V_12 * V_13 = V_141 -> V_142 ;
struct V_9 * V_10 = F_13 ( V_13 ) ;
int V_171 = ( ( unsigned char * ) V_141 -> V_35 ) [ 0 ] ;
int V_20 = ( ( unsigned char * ) V_141 -> V_35 ) [ 1 ] ;
int V_172 = ( ( unsigned char * ) V_141 -> V_35 ) [ 2 ] ;
unsigned char * V_39 = ( ( unsigned char * ) V_141 -> V_35 ) + 3 ;
int V_173 , V_174 ;
int V_145 = V_141 -> V_145 ;
if ( V_141 -> V_145 == - V_175 )
return 0 ;
if ( V_141 -> V_176 != V_20 + 2 ) {
F_18 ( & V_13 -> V_26 , L_26
L_27
L_28 , V_38 , V_145 ,
V_10 -> V_27 , V_171 , V_20 , V_141 -> V_176 ,
V_172 ) ;
return - 1 ;
}
F_22 ( & V_10 -> V_15 ) ;
...
int V_76 ;
unsigned int V_187 ;
for ( V_76 = 0 ; V_76 < V_141 -> V_176 - 3 ; ) {
V_171 = ( ( unsigned char * ) V_141 -> V_35 ) [ V_76 ++ ] ;
line = ( ( unsigned char * ) V_141 -> V_35 ) [ V_76 ++ ] ;
V_145 = ( ( unsigned char * ) V_141 -> V_35 ) [ V_76 ++ ] ;
V_135 = ( ( unsigned char * ) V_141 -> V_35 ) [ V_76 ++ ] ;
F_14 ( & V_13 -> V_26 , L_31 ,
