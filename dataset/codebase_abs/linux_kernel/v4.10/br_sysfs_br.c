...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_7 , V_6 -> V_67 ) ;
}
static int F_101 ( struct V_5 * V_6 , unsigned long V_8 )
{
V_6 -> V_67 = V_8 ? true : false ;
return 0 ;
}
static T_1 F_102 (
struct V_1 * V_2 , struct V_15 * V_16 , const char * V_3 ,
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_8 , F_112 ( V_6 -> V_72 ) ) ;
}
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_2 , V_6 -> V_74 ) ;
}
static T_1 F_115 ( struct V_1 * V_2 ,
struct V_15 * V_16 ,
const char * V_3 , T_2 V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_75 ) ;
}
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_7 , V_6 -> V_76 ) ;
}
static T_1 F_117 ( struct V_1 * V_2 ,
struct V_15 * V_16 ,
const char * V_3 , T_2 V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_77 ) ;
}
static T_1 F_118 ( struct V_78 * V_79 , struct V_80 * V_81 ,
struct V_82 * V_83 ,
char * V_3 , T_4 V_84 , T_2 V_85 )
{
struct V_1 * V_10 = F_119 ( V_81 ) ;
struct V_5 * V_6 = F_3 ( V_10 ) ;
int V_86 ;
if ( V_84 % sizeof( struct V_87 ) != 0 )
return - V_14 ;
V_86 = F_120 ( V_6 , V_3 ,
V_85 / sizeof( struct V_87 ) ,
V_84 / sizeof( struct V_87 ) ) ;
if ( V_86 > 0 )
V_86 *= sizeof( struct V_87 ) ;
return V_86 ;
}
int F_121 ( struct V_88 * V_10 )
{
struct V_80 * V_89 = & V_10 -> V_10 . V_81 ;
struct V_5 * V_6 = F_122 ( V_10 ) ;
int V_9 ;
V_9 = F_123 ( V_89 , & V_90 ) ;
if ( V_9 ) {
F_124 ( L_9 ,
V_91 , V_10 -> V_92 , V_90 . V_92 ) ;
goto V_93;
}
V_9 = F_125 ( V_89 , & V_94 ) ;
if ( V_9 ) {
F_124 ( L_10 ,
V_91 , V_10 -> V_92 , V_94 . V_16 . V_92 ) ;
goto V_95;
}
V_6 -> V_96 = F_126 ( V_97 , V_89 ) ;
if ( ! V_6 -> V_96 ) {
F_124 ( L_11 ,
V_91 , V_10 -> V_92 , V_97 ) ;
V_9 = - V_98 ;
...
return 0 ;
V_99:
F_127 ( & V_10 -> V_10 . V_81 , & V_94 ) ;
V_95:
F_128 ( & V_10 -> V_10 . V_81 , & V_90 ) ;
V_93:
return V_9 ;
}
void F_129 ( struct V_88 * V_10 )
{
struct V_80 * V_81 = & V_10 -> V_10 . V_81 ;
struct V_5 * V_6 = F_122 ( V_10 ) ;
F_130 ( V_6 -> V_96 ) ;
F_127 ( V_81 , & V_94 ) ;
F_128 ( V_81 , & V_90 ) ;
