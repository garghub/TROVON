...
F_5 ( V_20 -> V_12 , F_83 ( V_155 ) , sizeof( V_20 -> V_12 ) ) ;
sprintf ( V_20 -> V_14 , L_7 , F_83 ( V_155 ) ) ;
V_20 -> V_17 = ( V_155 -> V_156 << 16 )
| V_155 -> V_157 ;
V_20 -> V_18 = V_158 ;
F_61 ( V_20 ) ;
}
...
sizeof( V_20 -> V_9 ) ) ;
if ( V_161 )
F_5 ( V_20 -> V_12 , V_161 , sizeof( V_20 -> V_12 ) ) ;
else if ( V_160 -> V_162 )
F_5 ( V_20 -> V_12 , V_160 -> V_162 , sizeof( V_20 -> V_12 ) ) ;
else
F_5 ( V_20 -> V_12 , L_8 , sizeof( V_20 -> V_12 ) ) ;
if ( V_160 -> V_13 )
F_5 ( V_20 -> V_13 , V_160 -> V_13 , sizeof( V_20 -> V_13 ) ) ;
F_85 ( V_160 , V_20 -> V_14 , sizeof( V_20 -> V_14 ) ) ;
V_20 -> V_17 = F_86 ( V_160 -> V_163 . V_164 ) ;
V_20 -> V_18 = V_158 ;
F_61 ( V_20 ) ;
}
