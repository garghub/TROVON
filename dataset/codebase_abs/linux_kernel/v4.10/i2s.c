...
static struct V_1 * F_62 ( struct V_168 * V_40 , bool V_169 )
{
struct V_1 * V_2 ;
int V_170 ;
V_2 = F_63 ( & V_40 -> V_41 , sizeof( struct V_1 ) , V_171 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_40 = V_40 ;
V_2 -> V_3 = NULL ;
...
F_64 ( & V_2 -> V_40 -> V_41 , V_2 ) ;
} else {
V_2 -> V_40 = F_65 ( L_15 , - 1 ) ;
if ( ! V_2 -> V_40 )
return NULL ;
...
static int F_70 ( struct V_187 * V_41 )
{
struct V_1 * V_2 = F_71 ( V_41 ) ;
F_34 ( V_2 -> V_188 ) ;
return 0 ;
}
...
F_74 ( V_2 -> V_192 [ V_189 ] ) ;
}
}
static void F_75 ( struct V_168 * V_40 )
{
struct V_1 * V_2 = F_71 ( & V_40 -> V_41 ) ;
F_76 ( V_40 -> V_41 . V_193 ) ;
F_73 ( V_2 ) ;
}
static int F_77 ( struct V_168 * V_40 )
{
...
struct V_188 * V_197 ;
int V_170 , V_189 ;
if ( ! F_78 ( V_41 -> V_193 , L_16 , NULL ) )
return 0 ;
for ( V_189 = 0 ; V_189 < F_79 ( V_195 ) ; V_189 ++ ) {
V_197 = F_37 ( V_41 , V_194 [ V_189 ] ) ;
if ( F_33 ( V_197 ) )
continue;
V_195 [ V_189 ] = F_80 ( V_197 ) ;
F_35 ( V_197 ) ;
}
if ( ! ( V_2 -> V_37 & V_86 ) ) {
T_1 V_63 = F_3 ( V_2 -> V_5 + V_142 ) ;
F_20 ( V_63 | V_141 , V_2 -> V_5 + V_142 ) ;
V_2 -> V_192 [ V_198 ] = F_81 ( NULL ,
L_17 , V_195 , F_79 ( V_195 ) ,
V_199 | V_200 ,
V_2 -> V_5 + V_6 , V_196 -> V_73 ,
1 , 0 , V_2 -> V_76 ) ;
V_2 -> V_192 [ V_201 ] = F_82 ( NULL ,
L_18 , L_17 ,
V_200 ,
...
F_83 ( V_41 -> V_193 ,
L_19 , 0 , & V_194 [ 0 ] ) ;
V_2 -> V_192 [ V_202 ] = F_84 ( NULL , V_194 [ 0 ] ,
V_195 [ 0 ] , V_200 ,
V_2 -> V_5 + V_6 , V_196 -> V_71 ,
V_203 , V_2 -> V_76 ) ;
V_2 -> V_190 . V_191 += 1 ;
V_2 -> V_190 . V_204 = V_2 -> V_192 ;
V_170 = F_85 ( V_41 -> V_193 , V_205 ,
& V_2 -> V_190 ) ;
if ( V_170 < 0 ) {
...
static int F_86 ( struct V_168 * V_40 )
{
...
int V_170 ;
if ( F_87 ( V_219 ) && V_40 -> V_41 . V_193 )
V_218 = F_88 ( & V_40 -> V_41 ) ;
else
V_218 = (struct V_217 * )
F_89 ( V_40 ) -> V_220 ;
...
V_170 = F_90 ( & V_40 -> V_41 ,
V_13 -> V_224 , L_22 , NULL ) ;
if ( V_170 != 0 )
return V_170 ;
return F_91 ( & V_13 -> V_40 -> V_41 ,
& V_225 ,
& V_13 -> V_172 , 1 ) ;
}
V_3 = F_62 ( V_40 , false ) ;
...
V_212 = F_95 ( V_40 , V_230 , 0 ) ;
V_3 -> V_5 = F_96 ( & V_40 -> V_41 , V_212 ) ;
if ( F_33 ( V_3 -> V_5 ) )
return F_39 ( V_3 -> V_5 ) ;
V_213 = V_212 -> V_231 ;
V_3 -> V_188 = F_97 ( & V_40 -> V_41 , L_28 ) ;
if ( F_33 ( V_3 -> V_188 ) ) {
F_23 ( & V_40 -> V_41 , L_29 ) ;
...
V_170 = F_90 ( & V_40 -> V_41 , V_3 -> V_224 ,
NULL , NULL ) ;
if ( V_170 < 0 )
goto V_236;
if ( V_37 & V_237 ) {
...
V_13 -> V_76 = & V_3 -> V_227 ;
V_13 -> V_7 = V_3 -> V_7 ;
V_13 -> V_122 . V_5 = V_213 + V_238 ;
if ( ! V_216 ) {
V_13 -> V_122 . V_228 = V_207 -> V_239 ;
...
if ( V_207 && V_207 -> V_240 && V_207 -> V_240 ( V_40 ) ) {
F_23 ( & V_40 -> V_41 , L_32 ) ;
V_170 = - V_89 ;
goto V_236;
}
V_170 = F_91 ( & V_3 -> V_40 -> V_41 ,
& V_225 ,
& V_3 -> V_172 , 1 ) ;
if ( V_170 < 0 )
goto V_241;
...
static int F_100 ( struct V_168 * V_40 )
{
struct V_1 * V_2 , * V_14 ;
V_2 = F_71 ( & V_40 -> V_41 ) ;
V_14 = F_5 ( V_2 ) ;
