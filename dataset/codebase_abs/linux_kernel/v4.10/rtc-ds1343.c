...
static T_4 F_35 ( int V_53 , void * V_91 )
{
struct V_15 * V_8 = V_91 ;
...
F_36 ( V_8 -> V_92 , 1 , V_89 | V_93 ) ;
}
V_87:
F_32 ( & V_8 -> V_86 ) ;
return V_94 ;
}
static int F_37 ( struct V_95 * V_31 )
{
struct V_15 * V_8 ;
struct V_96 V_97 ;
unsigned int V_17 ;
...
V_97 . V_99 = 8 ;
V_97 . V_100 = 0x80 ;
V_8 = F_38 ( & V_31 -> V_2 , sizeof( struct V_15 ) , V_101 ) ;
if ( ! V_8 )
return - V_102 ;
V_8 -> V_31 = V_31 ;
F_39 ( & V_8 -> V_86 ) ;
V_31 -> V_103 = V_104 | V_105 ;
V_31 -> V_106 = 8 ;
V_59 = F_40 ( V_31 ) ;
if ( V_59 )
return V_59 ;
F_41 ( V_31 , V_8 ) ;
V_8 -> V_9 = F_42 ( V_31 , & V_97 ) ;
if ( F_43 ( V_8 -> V_9 ) ) {
F_12 ( & V_31 -> V_2 , L_21 ) ;
return F_44 ( V_8 -> V_9 ) ;
}
...
F_7 ( V_8 -> V_9 , V_18 , & V_17 ) ;
V_17 |= V_107 ;
V_17 &= ~ ( V_108 | V_109 | V_33 ) ;
F_4 ( V_8 -> V_9 , V_18 , V_17 ) ;
F_7 ( V_8 -> V_9 , V_76 , & V_17 ) ;
V_17 &= ~ ( V_110 | V_111 | V_77 ) ;
F_4 ( V_8 -> V_9 , V_76 , V_17 ) ;
V_8 -> V_92 = F_45 ( & V_31 -> V_2 , L_22 ,
& V_112 , V_113 ) ;
if ( F_43 ( V_8 -> V_92 ) ) {
F_12 ( & V_31 -> V_2 , L_23 ) ;
return F_44 ( V_8 -> V_92 ) ;
}
V_8 -> V_53 = V_31 -> V_53 ;
if ( V_8 -> V_53 >= 0 ) {
...
static int F_49 ( struct V_95 * V_31 )
{
