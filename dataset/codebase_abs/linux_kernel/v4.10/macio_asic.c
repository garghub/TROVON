...
#ifdef F_35
F_24 ( L_19 ,
V_2 , & V_2 -> V_10 , & V_2 -> V_10 . V_2 , & V_2 -> V_10 . V_2 . V_62 ) ;
#endif
if ( V_23 == V_39 -> V_36 ) {
...
{
struct V_22 * V_23 , * V_65 ;
struct V_8 * V_66 , * V_21 , * V_67 = NULL , * V_68 = NULL ;
struct V_1 * V_52 = NULL ;
struct V_24 * V_69 = & V_70 ;
#ifdef F_34
if ( V_39 -> V_56 . V_61 ) {
V_52 = & V_39 -> V_56 . V_61 -> V_2 ;
V_69 = & V_39 -> V_56 . V_61 -> V_24 [ 0 ] ;
}
#endif
V_65 = F_42 ( V_39 -> V_36 ) ;
if ( V_65 == NULL )
return;
V_66 = F_30 ( V_39 , V_52 , V_65 , NULL , V_69 ) ;
if ( V_66 == NULL )
return;
V_69 = & V_66 -> V_24 [ 0 ] ;
for ( V_23 = NULL ; ( V_23 = F_43 ( V_65 , V_23 ) ) != NULL ; ) {
if ( F_40 ( V_23 ) )
continue;
F_42 ( V_23 ) ;
V_21 = F_30 ( V_39 , & V_66 -> V_10 . V_2 , V_23 , NULL ,
V_69 ) ;
if ( V_21 == NULL )
F_44 ( V_23 ) ;
...
if ( V_67 ) {
V_65 = V_67 -> V_10 . V_2 . V_36 ;
for ( V_23 = NULL ; ( V_23 = F_43 ( V_65 , V_23 ) ) != NULL ; ) {
if ( F_40 ( V_23 ) )
continue;
F_42 ( V_23 ) ;
if ( F_30 ( V_39 , & V_67 -> V_10 . V_2 , V_23 ,
V_67 , V_69 ) == NULL )
F_44 ( V_23 ) ;
}
}
if ( V_68 ) {
V_65 = V_68 -> V_10 . V_2 . V_36 ;
for ( V_23 = NULL ; ( V_23 = F_43 ( V_65 , V_23 ) ) != NULL ; ) {
if ( F_40 ( V_23 ) )
continue;
F_42 ( V_23 ) ;
...
static void F_49 ( struct V_1 * V_71 , void * V_25 )
{
struct V_8 * V_2 = F_5 ( V_71 ) ;
struct V_72 * V_73 = V_25 ;
int V_43 , V_74 ;
V_74 = F_50 ( V_2 -> V_50 , 32 ) ;
for ( V_43 = 0 ; V_43 < V_74 ; V_43 ++ ) {
if ( V_73 -> V_75 & ( 1 << V_43 ) )
F_51 ( V_2 , V_43 ) ;
}
}
...
{
struct V_72 * V_73 ;
V_73 = F_53 ( & V_2 -> V_10 . V_2 , F_49 , NULL , NULL ) ;
if ( ! V_73 ) {
V_73 = F_54 ( F_49 , sizeof( * V_73 ) , V_55 ) ;
if ( ! V_73 )
return - V_76 ;
}
return F_55 ( & V_2 -> V_10 . V_2 , V_73 , NULL , NULL ) != NULL ;
}
static struct V_72 * F_56 ( struct V_8 * V_2 )
{
return F_53 ( & V_2 -> V_10 . V_2 , F_49 , NULL , NULL ) ;
}
int F_57 ( struct V_8 * V_2 , int V_77 ,
const char * V_29 )
{
struct V_72 * V_73 = F_56 ( V_2 ) ;
if ( F_58 ( V_2 , V_77 ) == 0 )
return 0 ;
if ( ! F_59 ( F_60 ( V_2 , V_77 ) ,
F_58 ( V_2 , V_77 ) ,
V_29 ) )
goto V_78;
if ( V_73 && V_77 < 32 )
...
void F_51 ( struct V_8 * V_2 , int V_77 )
{
struct V_72 * V_73 = F_56 ( V_2 ) ;
if ( F_58 ( V_2 , V_77 ) == 0 )
return;
...
static int F_64 ( struct V_80 * V_61 , const struct V_81 * V_82 )
{
struct V_22 * V_23 ;
struct V_51 * V_39 ;
if ( V_82 -> V_83 != V_84 )
...
F_24 ( V_41 L_27 ,
V_39 -> V_29 ) ;
if ( V_39 -> type == V_40 || V_39 -> type == V_86 )
if ( V_87 [ 0 ] . V_56 . V_61 == NULL ) {
V_88 = V_39 ;
return 0 ;
}
F_41 ( V_39 ) ;
if ( V_88 && V_87 [ 0 ] . V_56 . V_61 != NULL ) {
F_41 ( V_88 ) ;
V_88 = NULL ;
}
return 0 ;
}
static void F_69 ( struct V_80 * V_61 )
{
F_70 ( L_28 ) ;
}
