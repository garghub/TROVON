...
V_2 -> V_125 = 0 ;
F_66 () ;
V_2 -> V_126 = F_67 ( V_4 -> V_127 ) -> V_128 [ V_18 -> V_115 ] ;
F_68 () ;
...
void F_75 ( struct V_1 * V_2 , unsigned int V_75 , T_2 V_139 ,
struct V_39 * V_40 )
{
F_76 ( & V_40 -> V_43 ) ;
V_40 -> V_144 = V_2 ;
V_40 -> V_145 = V_146 ;
V_40 -> V_147 = F_77 ( F_78 ( V_148 ) ) ;
V_40 -> V_44 = V_75 ;
V_40 -> V_46 = V_139 ;
V_40 -> V_57 = 0 ;
V_40 -> V_52 = 0 ;
...
void F_79 ( unsigned int V_75 , T_2 V_139 , struct V_39 * V_40 )
{
V_40 -> V_44 = V_75 ;
V_40 -> V_46 = V_139 ;
V_40 -> V_52 = 0 ;
...
int F_83 ( struct V_39 * V_40 )
{
unsigned long V_149 = V_72 ;
F_84 () ;
F_85 ( & V_40 -> V_52 , V_51 , V_150 ) ;
if ( F_86 ( V_72 , V_149 + V_151 ) )
V_40 -> V_144 -> V_68 = F_87 ( V_40 -> V_144 -> V_68 +
V_152 ,
V_153 ) ;
return V_40 -> V_57 ;
}
static void F_88 ( struct V_1 * V_2 , unsigned int V_75 ,
...
void F_90 ( struct V_158 * V_159 , const char * V_160 , ... )
{
struct V_161 V_162 ;
T_3 args ;
va_start ( args , V_160 ) ;
if ( V_159 ) {
F_91 ( V_159 , V_160 , args ) ;
} else {
V_162 . V_160 = V_160 ;
V_162 . V_163 = & args ;
F_48 ( L_2 , & V_162 ) ;
...
static inline void F_92 ( struct V_39 * V_40 )
__releases( &gl->gl_lockref.lock
int F_93 ( struct V_39 * V_40 )
{
...
F_13 ( & V_2 -> V_16 . V_31 ) ;
if ( V_40 -> V_46 & V_170 )
F_88 ( V_2 , V_20 , 0 , false ) ;
F_14 ( & V_40 -> V_43 ) ;
F_21 ( V_55 , & V_40 -> V_52 ) ;
if ( F_50 ( V_2 ) == NULL ) {
if ( V_18 -> V_171 ) {
F_7 ( V_2 , F_96 ( V_85 , & V_2 -> V_28 ) ) ;
F_18 ( & V_2 -> V_16 . V_31 ) ;
V_18 -> V_171 ( V_40 ) ;
F_13 ( & V_2 -> V_16 . V_31 ) ;
F_21 ( V_85 , & V_2 -> V_28 ) ;
...
void F_98 ( struct V_39 * V_40 )
{
struct V_1 * V_2 = V_40 -> V_144 ;
F_95 ( V_40 ) ;
F_84 () ;
F_85 ( & V_2 -> V_28 , V_74 , V_150 ) ;
}
...
int F_100 ( struct V_3 * V_4 , T_1 V_107 ,
...
if ( ! error ) {
error = F_101 ( V_2 , V_75 , V_139 , V_40 ) ;
F_22 ( V_2 ) ;
}
return error ;
}
static int F_102 ( const void * V_175 , const void * V_176 )
{
...
if ( V_179 -> V_93 < V_180 -> V_93 )
return - 1 ;
F_103 ( V_177 -> V_144 -> V_7 -> V_115 == V_178 -> V_144 -> V_7 -> V_115 ) ;
return 0 ;
}
static int F_104 ( unsigned int V_181 , struct V_39 * V_182 ,
struct V_39 * * V_183 )
{
unsigned int V_184 ;
int error = 0 ;
...
F_105 ( V_183 , V_181 , sizeof( struct V_39 * ) , F_102 , NULL ) ;
for ( V_184 = 0 ; V_184 < V_181 ; V_184 ++ ) {
V_183 [ V_184 ] -> V_46 &= ~ ( V_59 | V_168 ) ;
error = F_93 ( V_183 [ V_184 ] ) ;
if ( error ) {
while ( V_184 -- )
F_95 ( V_183 [ V_184 ] ) ;
break;
...
int F_106 ( unsigned int V_181 , struct V_39 * V_182 )
{
struct V_39 * V_54 [ 4 ] ;
...
if ( V_181 <= 4 )
break;
V_185 = F_107 ( V_181 * sizeof( struct V_39 * ) , V_120 ) ;
if ( ! V_185 )
return - V_121 ;
}
error = F_104 ( V_181 , V_182 , V_185 ) ;
if ( V_185 != V_54 )
F_3 ( V_185 ) ;
return error ;
}
void F_108 ( unsigned int V_181 , struct V_39 * V_182 )
{
while ( V_181 -- )
F_95 ( & V_182 [ V_181 ] ) ;
}
void F_109 ( struct V_1 * V_2 , unsigned int V_75 )
{
unsigned long V_96 = 0 ;
unsigned long V_102 ;
...
void F_111 ( struct V_1 * V_2 , int V_53 )
{
...
static int F_112 ( void * V_190 , struct V_191 * V_179 , struct V_191 * V_180 )
{
...
static void F_113 ( struct V_191 * V_194 )
__releases( &lru_lock
static long F_114 ( int V_195 )
{
struct V_1 * V_2 ;
F_115 ( V_196 ) ;
F_115 ( V_197 ) ;
...
F_116 ( & V_2 -> V_24 , & V_197 ) ;
F_20 ( & V_25 ) ;
V_198 ++ ;
continue;
}
F_116 ( & V_2 -> V_24 , & V_196 ) ;
}
F_117 ( & V_196 , & V_26 ) ;
if ( ! F_11 ( & V_197 ) )
F_113 ( & V_197 ) ;
...
static unsigned long F_118 ( struct V_199 * V_200 ,
struct V_201 * V_202 )
{
if ( ! ( V_202 -> V_203 & V_204 ) )
return V_205 ;
return F_114 ( V_202 -> V_206 ) ;
}
static unsigned long F_119 ( struct V_199 * V_200 ,
struct V_201 * V_202 )
{
return F_120 ( F_121 ( & V_25 ) ) ;
}
static void F_122 ( T_4 V_207 , const struct V_3 * V_4 )
{
struct V_1 * V_2 ;
struct V_208 * V_209 ;
...
int V_212 ;
F_123 () ;
V_211 = F_124 ( V_32 . V_211 , & V_32 ) ;
for ( V_212 = 0 ; V_212 < V_211 -> V_213 ; V_212 ++ ) {
F_125 (gl, pos, tbl, i, gl_node) {
if ( ( V_2 -> V_5 . V_6 == V_4 ) &&
F_63 ( & V_2 -> V_16 ) )
V_207 ( V_2 ) ;
}
...
static void F_130 ( struct V_158 * V_159 , struct V_1 * V_2 )
{
F_13 ( & V_2 -> V_16 . V_31 ) ;
F_131 ( V_159 , V_2 ) ;
F_18 ( & V_2 -> V_16 . V_31 ) ;
...
void F_136 ( struct V_215 * V_216 )
{
struct V_1 * V_2 = V_216 -> V_217 ;
int V_53 ;
V_53 = F_137 ( V_216 ) ;
F_138 ( V_2 -> V_5 . V_6 , V_53 == 0 ) ;
F_13 ( & V_2 -> V_16 . V_31 ) ;
F_21 ( V_85 , & V_2 -> V_28 ) ;
F_51 ( V_2 , 1 ) ;
F_18 ( & V_2 -> V_16 . V_31 ) ;
}
static const char * F_139 ( unsigned V_75 )
{
switch( V_75 ) {
case V_20 :
return L_3 ;
...
static const char * F_140 ( char * V_218 , T_2 V_139 , unsigned long V_219 )
{
char * V_183 = V_218 ;
if ( V_139 & V_59 )
* V_183 ++ = 't' ;
...
static void F_141 ( struct V_158 * V_159 , const struct V_39 * V_40 )
{
struct V_221 * V_222 = NULL ;
char V_223 [ 32 ] ;
F_123 () ;
if ( V_40 -> V_147 )
V_222 = F_142 ( V_40 -> V_147 , V_224 ) ;
F_90 ( V_159 , L_8 ,
F_139 ( V_40 -> V_44 ) ,
F_140 ( V_223 , V_40 -> V_46 , V_40 -> V_52 ) ,
V_40 -> V_57 ,
V_40 -> V_147 ? ( long ) F_143 ( V_40 -> V_147 ) : - 1 ,
V_222 ? V_222 -> V_225 : L_9 ,
( void * ) V_40 -> V_145 ) ;
F_126 () ;
}
static const char * F_144 ( char * V_218 , const struct V_1 * V_2 )
{
...
void F_131 ( struct V_158 * V_159 , const struct V_1 * V_2 )
{
const struct V_17 * V_18 = V_2 -> V_7 ;
...
static int F_145 ( struct V_158 * V_159 , void * V_236 )
{
...
static int F_147 ( struct V_158 * V_159 , void * V_236 )
{
...
if ( V_244 == 0 && V_245 != 0 )
return 0 ;
F_146 ( V_159 , L_12 , V_246 [ V_244 ] ,
( V_244 == 0 ) ? L_13 : V_247 [ V_245 ] ) ;
F_148 (i) {
const struct V_248 * V_128 = F_149 ( V_4 -> V_127 , V_212 ) ;
if ( V_244 == 0 )
F_146 ( V_159 , L_14 , V_212 ) ;
else
F_146 ( V_159 , L_15 , ( unsigned long long ) V_128 ->
...
{
int V_53 ;
V_53 = F_152 ( & V_32 , & V_34 ) ;
if ( V_53 < 0 )
return V_53 ;
V_106 = F_153 ( L_16 , V_249 |
V_250 | V_251 , 0 ) ;
if ( ! V_106 ) {
F_154 ( & V_32 ) ;
return - V_121 ;
...
static void F_159 ( struct V_254 * V_255 )
{
do {
V_255 -> V_2 = F_160 ( & V_255 -> V_256 ) ;
if ( F_55 ( V_255 -> V_2 ) ) {
if ( F_161 ( V_255 -> V_2 ) == - V_257 )
continue;
V_255 -> V_2 = NULL ;
}
...
static void * F_162 ( struct V_158 * V_159 , T_5 * V_209 )
{
...
static void * F_164 ( struct V_158 * V_159 , void * V_236 ,
T_5 * V_209 )
{
struct V_254 * V_255 = V_159 -> V_243 ;
( * V_209 ) ++ ;
...
static int F_167 ( struct V_158 * V_159 , void * V_236 )
{
F_130 ( V_159 , V_236 ) ;
return 0 ;
}
static void * F_168 ( struct V_158 * V_159 , T_5 * V_209 )
{
F_66 () ;
if ( * V_209 >= V_260 )
return NULL ;
...
static void * F_169 ( struct V_158 * V_159 , void * V_236 ,
T_5 * V_209 )
{
( * V_209 ) ++ ;
if ( * V_209 >= V_260 )
...
static int F_171 ( struct V_91 * V_91 , struct V_261 * V_261 )
{
int V_53 = F_172 ( V_261 , & V_262 ,
sizeof( struct V_254 ) ) ;
if ( V_53 == 0 ) {
...
V_255 -> V_259 = 0 ;
V_159 -> V_218 = F_107 ( V_264 , V_265 | V_266 ) ;
if ( V_159 -> V_218 )
V_159 -> V_213 = V_264 ;
V_255 -> V_2 = NULL ;
V_53 = F_173 ( & V_32 , & V_255 -> V_256 , V_265 ) ;
}
return V_53 ;
}
static int F_174 ( struct V_91 * V_91 , struct V_261 * V_261 )
{
struct V_158 * V_159 = V_261 -> V_140 ;
struct V_254 * V_255 = V_159 -> V_243 ;
V_255 -> V_2 = NULL ;
F_175 ( & V_255 -> V_256 ) ;
return F_176 ( V_91 , V_261 ) ;
}
static int F_177 ( struct V_91 * V_91 , struct V_261 * V_261 )
{
int V_53 = F_172 ( V_261 , & V_267 ,
sizeof( struct V_254 ) ) ;
if ( V_53 == 0 ) {
struct V_158 * V_159 = V_261 -> V_140 ;
struct V_254 * V_255 = V_159 -> V_243 ;
...
V_273:
F_184 ( V_4 ) ;
return V_270 ? F_161 ( V_270 ) : - V_121 ;
}
