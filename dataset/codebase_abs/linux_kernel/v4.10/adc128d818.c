...
static int F_26 ( struct V_5 * V_6 , struct V_35 * V_36 )
{
int V_37 , V_38 ;
if ( ! F_27 ( V_6 -> V_39 ,
V_40 |
...
struct V_1 * V_4 ;
int V_33 , V_29 ;
V_4 = F_31 ( V_3 , sizeof( struct V_1 ) , V_56 ) ;
if ( ! V_4 )
return - V_57 ;
V_52 = F_32 ( V_3 , L_4 ) ;
if ( ! F_14 ( V_52 ) ) {
