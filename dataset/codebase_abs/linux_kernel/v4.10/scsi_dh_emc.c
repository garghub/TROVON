...
static int F_22 ( struct V_1 * V_2 , const char * V_93 )
{
struct V_17 * V_18 = V_2 -> V_81 ;
unsigned int V_94 = 0 , V_95 = 0 , V_96 ;
const char * V_97 = V_93 ;
int V_91 = V_19 ;
if ( ( sscanf ( V_93 , L_32 , & V_96 ) != 1 ) || ( V_96 != 2 ) )
return - V_98 ;
while ( * V_97 ++ )
;
if ( ( sscanf ( V_97 , L_32 , & V_95 ) != 1 ) || ( V_95 > 1 ) )
return - V_98 ;
while ( * V_97 ++ )
;
if ( ( sscanf ( V_97 , L_32 , & V_94 ) != 1 ) || ( V_94 > 1 ) )
return - V_98 ;
if ( V_95 )
V_18 -> V_69 |= V_70 ;
else
