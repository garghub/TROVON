...
struct V_2 * V_2 = F_35 ( V_77 ) ;
struct V_59 * V_60 = F_26 ( V_2 ) ;
struct V_40 V_41 = {} ;
struct V_26 * V_39 , V_81 ;
if ( F_36 ( V_4 , F_37 ( V_77 ) , V_77 -> V_82 , V_18 ) )
return V_83 ;
V_39 = F_38 ( V_4 , V_77 -> V_82 , sizeof( V_81 ) , & V_81 ) ;
if ( V_39 == NULL )
return V_83 ;
if ( ! F_39 ( V_4 , V_77 -> V_82 , V_39 , & V_41 ) )
return V_83 ;
...
static unsigned int F_41 ( void * V_94 ,
struct V_3 * V_4 ,
...
return V_101 ;
V_82 = F_45 ( V_4 ) ;
V_39 = F_38 ( V_4 , V_82 , sizeof( V_81 ) , & V_81 ) ;
if ( V_39 == NULL )
return V_83 ;
V_66 = & V_98 -> V_102 . V_103 ;
switch ( V_66 -> V_66 ) {
case V_104 :
if ( V_39 -> V_87 && ! F_46 ( V_105 , & V_98 -> V_106 ) ) {
F_47 ( V_98 , V_24 , V_100 -> V_107 -
F_22 ( V_39 -> V_47 ) + 1 ) ;
break;
}
...
F_47 ( V_98 , V_24 , 0 ) ;
V_100 -> V_108 = 0 ;
F_32 ( V_60 -> V_71 -> V_109 ) ;
case V_110 :
if ( ! F_39 ( V_4 , V_82 , V_39 , & V_41 ) )
return V_83 ;
if ( ! V_39 -> V_84 && V_39 -> V_85 &&
F_48 ( V_24 ) == V_68 ) {
if ( F_30 ( V_2 , V_4 , V_39 , & V_41 ,
F_22 ( V_39 -> V_47 ) + 1 ) )
F_32 ( V_60 -> V_71 -> V_111 ) ;
return V_83 ;
}
V_100 -> V_107 = F_22 ( V_39 -> V_48 ) ;
if ( V_41 . V_51 & V_75 )
...
V_91 |
V_92 ) ;
F_49 ( V_41 . V_115 , V_41 . V_113 ) ;
F_27 ( V_2 , V_66 , V_4 , V_39 , & V_41 ) ;
F_47 ( V_98 , V_24 , V_100 -> V_107 - F_22 ( V_39 -> V_47 ) ) ;
F_49 ( V_41 . V_115 , V_41 . V_113 ) ;
...
F_51 ( V_4 , V_82 , V_39 , V_98 , V_24 , V_100 ) ;
return V_101 ;
}
static int F_52 ( const struct V_117 * V_77 )
{
const struct V_118 * V_119 = V_77 -> V_120 ;
if ( V_119 -> V_121 . V_102 != V_18 ||
V_119 -> V_121 . V_122 & V_123 )
return - V_124 ;
return F_53 ( V_77 -> V_2 , V_77 -> V_125 ) ;
}
static void F_54 ( const struct V_126 * V_77 )
{
F_55 ( V_77 -> V_2 , V_77 -> V_125 ) ;
}
