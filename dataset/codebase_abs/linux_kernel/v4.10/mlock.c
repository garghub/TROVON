...
F_72 ( V_32 ) || V_32 == F_73 ( V_56 -> V_50 ) )
goto V_17;
V_51 = V_32 -> V_57 + ( ( V_34 - V_32 -> V_58 ) >> V_59 ) ;
* V_47 = F_74 ( V_50 , * V_47 , V_34 , V_35 , V_48 , V_32 -> V_60 ,
V_32 -> V_61 , V_51 , F_75 ( V_32 ) ,
V_32 -> V_62 ) ;
if ( * V_47 ) {
V_32 = * V_47 ;
goto V_63;
...
static int F_77 ( unsigned long V_34 , T_5 V_66 ,
T_3 V_67 )
{
...
if ( V_69 > V_35 )
V_69 = V_35 ;
error = F_71 ( V_32 , & V_47 , V_68 , V_69 , V_48 ) ;
if ( error )
break;
V_68 = V_69 ;
if ( V_68 < V_47 -> V_64 )
...
static T_6 int F_83 ( unsigned long V_34 , T_5 V_66 , T_3 V_67 )
{
unsigned long V_75 ;
unsigned long V_76 ;
int error = - V_20 ;
...
return - V_77 ;
F_84 () ;
V_66 = F_80 ( V_66 + ( F_79 ( V_34 ) ) ) ;
V_34 &= V_78 ;
V_76 = F_2 ( V_1 ) ;
V_76 >>= V_59 ;
V_75 = V_66 >> V_59 ;
if ( F_85 ( & V_56 -> V_50 -> V_79 ) )
return - V_80 ;
V_75 += V_56 -> V_50 -> V_65 ;
...
if ( ( V_75 <= V_76 ) || F_3 ( V_2 ) )
error = F_77 ( V_34 , V_66 , V_67 ) ;
F_86 ( & V_56 -> V_50 -> V_79 ) ;
if ( error )
return error ;
error = F_87 ( V_34 , V_66 , 0 ) ;
if ( error )
return F_39 ( error ) ;
return 0 ;
}
static int F_88 ( int V_67 )
{
...
V_48 = V_32 -> V_40 & V_41 ;
V_48 |= V_81 ;
F_71 ( V_32 , & V_47 , V_32 -> V_58 , V_32 -> V_64 , V_48 ) ;
F_89 () ;
}
V_17:
return 0 ;
}
int F_90 ( T_5 V_87 , struct V_88 * V_89 )
{
...
void F_94 ( T_5 V_87 , struct V_88 * V_89 )
{
F_91 ( & V_92 ) ;
