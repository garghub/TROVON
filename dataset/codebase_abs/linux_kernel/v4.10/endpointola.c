...
V_4 = V_2 -> V_35 . V_4 ;
V_6 = F_2 ( V_4 ) ;
while ( NULL != ( V_88 = F_51 ( V_39 ) ) ) {
V_90 = F_52 ( V_88 -> V_93 -> type ) ;
...
if ( F_56 ( V_90 . V_88 , V_60 ) && ! V_88 -> V_102 )
continue;
if ( V_60 && F_57 ( V_88 ) )
V_60 -> V_104 . V_105 = V_88 -> V_76 ;
else {
F_58 ( F_2 ( V_2 -> V_35 . V_4 ) , V_106 ) ;
if ( V_60 )
V_60 -> V_107 . V_108 ++ ;
}
if ( V_88 -> V_76 )
V_88 -> V_76 -> V_109 = F_59 () ;
error = F_60 ( V_6 , V_110 , V_90 , V_91 ,
V_2 , V_60 , V_88 , V_101 ) ;
if ( error && V_88 )
V_88 -> V_111 = 1 ;
if ( ! F_33 ( V_4 ) -> V_2 )
