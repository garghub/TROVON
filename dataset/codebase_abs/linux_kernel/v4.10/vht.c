...
T_1 V_117 = 0 ;
T_4 V_118 ;
V_42 = V_115 -> V_119 . V_120 -> V_121 [ V_113 ] ;
if ( V_111 & V_122 )
return 0 ;
V_118 = V_111 & V_123 ;
V_118 >>= V_124 ;
V_118 += 1 ;
if ( V_46 -> V_46 . V_108 != V_118 ) {
V_46 -> V_46 . V_108 = V_118 ;
V_117 |= V_125 ;
}
switch ( V_111 & V_126 ) {
case V_127 :
...
V_116 = F_10 ( V_46 ) ;
if ( V_116 != V_46 -> V_46 . V_82 ) {
V_46 -> V_46 . V_82 = V_116 ;
V_117 |= V_131 ;
}
return V_117 ;
}
...
struct V_132 * V_133 )
{
struct V_134 * V_104 = & V_2 -> V_21 . V_104 ;
if ( ! V_2 -> V_21 . V_135 )
return;
if ( ! memcmp ( V_133 -> V_7 . V_136 . V_7 . V_137 . V_138 ,
V_104 -> V_139 . V_138 , V_140 ) &&
! memcmp ( V_133 -> V_7 . V_136 . V_7 . V_137 . V_141 ,
V_104 -> V_139 . V_141 , V_142 ) )
return;
memcpy ( V_104 -> V_139 . V_141 ,
V_133 -> V_7 . V_136 . V_7 . V_137 . V_141 ,
V_142 ) ;
memcpy ( V_104 -> V_139 . V_138 ,
V_133 -> V_7 . V_136 . V_7 . V_137 . V_138 ,
V_140 ) ;
F_21 ( V_2 , V_143 ) ;
}
void F_22 ( struct V_144 * V_21 ,
const T_4 * V_141 , const T_4 * V_138 )
{
struct V_134 * V_104 = & V_21 -> V_104 ;
if ( F_14 ( ! V_21 -> V_135 ) )
return;
memcpy ( V_104 -> V_139 . V_141 , V_141 , V_142 ) ;
memcpy ( V_104 -> V_139 . V_138 , V_138 , V_140 ) ;
}
...
{
struct V_114 * V_115 = V_2 -> V_115 ;
struct V_41 * V_42 = V_115 -> V_119 . V_120 -> V_121 [ V_113 ] ;
T_1 V_117 = F_19 ( V_2 , V_46 , V_111 , V_113 ) ;
if ( V_117 > 0 ) {
F_24 ( V_2 ) ;
F_25 ( V_115 , V_42 , V_46 , V_117 ) ;
}
}
void F_26 ( T_5 V_4 ,
T_3 V_145 [ V_146 ] )
