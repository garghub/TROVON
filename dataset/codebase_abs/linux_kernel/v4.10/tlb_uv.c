...
V_22 . V_312 ( V_62 , 0xffffUL ) ;
memset ( V_308 , 0 , sizeof( struct V_17 ) * V_34 ) ;
}
static void T_1 F_127 ( int V_9 , int V_313 , int V_285 )
{
int V_10 ;
int V_62 ;
unsigned long V_314 ;
...
F_125 ( V_10 , V_62 ) ;
V_314 = F_11 ( V_9 ) | V_315 ;
F_128 ( V_62 , ( ( V_314 << 32 ) | V_313 ) ) ;
}
...
V_316 = V_236 & V_320 ;
V_222 = F_38 ( V_321 ) ;
V_176 = ( V_222 >> V_322 ) & V_323 ;
V_222 = F_38 ( V_324 ) ;
V_317 = ( V_222 >> V_325 ) & V_326 ;
V_319 = V_327 [ V_176 ] ;
V_319 *= ( V_316 * V_317 ) ;
V_250 = V_319 / 1000 ;
} else {
V_222 = F_38 ( V_328 ) ;
V_222 = ( V_222 & V_329 ) >> V_330 ;
if ( V_222 & ( 1L << V_331 ) )
V_318 = 80 ;
else
V_318 = 10 ;
...
V_336 = V_7 -> V_340 & 1 ;
V_337 -> V_343 |= ( 1 << V_336 ) ;
V_339 = & V_337 -> V_336 [ V_336 ] ;
V_339 -> V_344 [ V_339 -> V_342 ] = V_5 ;
V_339 -> V_342 ++ ;
if ( V_339 -> V_342 > V_345 ) {
F_134 ( L_35 ,
V_339 -> V_342 ) ;
return 1 ;
}
...
{
int V_5 ;
T_9 V_346 = sizeof( struct V_63 ) * F_86 () ;
V_47 -> V_65 = F_118 ( V_346 , V_251 , V_47 -> V_340 ) ;
memset ( V_47 -> V_65 , 0 , V_346 ) ;
F_5 (cpu) {
V_47 -> V_65 [ V_5 ] . V_62 = F_133 ( V_5 ) -> V_62 ;
V_47 -> V_65 [ V_5 ] . V_9 = F_133 ( V_5 ) -> V_341 ;
}
}
static void F_137 ( struct V_6 * V_90 )
{
int V_347 = sizeof( T_2 ) ;
V_90 -> V_77 = F_138 ( V_347 , V_251 , V_90 -> V_340 ) ;
}
static int F_139 ( struct V_338 * V_339 , struct V_333 * V_337 ,
struct V_6 * * V_348 ,
struct V_6 * * V_349 )
{
int V_25 ;
int V_5 ;
struct V_6 * V_7 ;
for ( V_25 = 0 ; V_25 < V_339 -> V_342 ; V_25 ++ ) {
V_5 = V_339 -> V_344 [ V_25 ] ;
V_7 = & F_6 ( V_6 , V_5 ) ;
V_7 -> V_5 = V_5 ;
if ( V_25 == 0 ) {
* V_348 = V_7 ;
...
V_7 -> V_61 = V_337 -> V_342 ;
V_7 -> V_58 = V_339 -> V_342 ;
V_7 -> V_48 = * V_348 ;
V_7 -> V_9 = V_337 -> V_9 ;
if ( F_122 () )
V_7 -> V_129 = 1 ;
...
if ( ( V_343 & 1 ) ) {
V_339 = & V_337 -> V_336 [ V_336 ] ;
if ( F_139 ( V_339 , V_337 , & V_47 , & V_90 ) )
return 1 ;
F_136 ( V_47 ) ;
}
V_336 ++ ;
...
static int T_1 F_143 ( int V_233 , int V_351 )
{
unsigned char * V_335 ;
void * V_303 ;
struct V_333 * V_334 ;
if ( F_84 () || F_83 () || F_122 () )
V_106 = F_129 () ;
V_303 = F_144 ( V_233 * sizeof( struct V_333 ) , V_251 ) ;
V_334 = (struct V_333 * ) V_303 ;
memset ( V_334 , 0 , V_233 * sizeof( struct V_333 ) ) ;
V_335 = F_145 ( ( V_233 + 7 ) / 8 , V_251 ) ;
if ( F_132 ( V_351 , V_334 , V_335 ) )
goto V_352;
if ( F_142 ( V_233 , V_334 , V_335 ) )
goto V_352;
F_97 ( V_334 ) ;
F_97 ( V_335 ) ;
F_130 () ;
...
V_22 = V_356 ;
F_147 (cur_cpu) {
V_76 = & F_6 ( V_214 , V_353 ) ;
F_148 ( V_76 , V_251 , F_135 ( V_353 ) ) ;
}
V_233 = F_78 () ;
V_157 = F_34 ( V_252 ) ;
V_357 = 0x7fffffff ;
for ( V_9 = 0 ; V_9 < V_233 ; V_9 ++ ) {
V_354 = F_79 ( V_9 ) ;
if ( V_354 && ( F_80 ( V_9 ) < V_357 ) )
V_357 = F_80 ( V_9 ) ;
}
if ( F_84 () || F_83 () || F_122 () )
F_77 () ;
if ( F_143 ( V_233 , V_357 ) ) {
F_7 () ;
V_8 = 1 ;
return 0 ;
}
