...
if ( V_6 )
goto V_117;
V_6 = F_12 ( V_2 , V_119 , 0 ) ;
if ( V_6 )
goto V_117;
F_44 ( 1000 , 2000 ) ;
V_2 -> V_120 &= ~ V_121 ;
V_6 = F_12 ( V_2 , V_122 , 0 ) ;
if ( V_6 )
goto V_117;
V_2 -> V_123 = 0 ;
V_6 = F_12 ( V_2 , V_124 ,
...
static int F_50 ( struct V_130 * V_50 , bool V_131 )
{
struct V_1 * V_2 = F_51 ( V_50 ) ;
int V_6 = 0 ;
F_3 ( V_2 -> V_7 , L_30 , V_2 -> V_45 , V_131 ) ;
F_38 ( & V_2 -> V_86 ) ;
if ( V_131 ) {
switch ( V_2 -> V_45 ) {
case V_127 :
...
return V_6 ;
V_2 -> V_120 |= V_121 ;
F_44 ( V_2 -> V_135 , V_2 -> V_135 + 1000 ) ;
}
return 0 ;
}
static int F_55 ( struct V_130 * V_50 , int type ,
int V_164 )
{
struct V_1 * V_2 = F_51 ( V_50 ) ;
int V_6 ;
...
static int F_58 ( struct V_130 * V_50 ,
...
static int F_63 ( struct V_130 * V_50 , int type ,
int V_164 )
{
struct V_1 * V_2 = F_51 ( V_50 ) ;
int V_6 ;
...
static int F_64 ( struct V_130 * V_50 , T_4 V_58 ,
...
static int F_68 ( struct V_130 * V_50 , T_4 V_58 ,
T_5 V_49 , void * V_187 )
{
struct V_1 * V_2 = F_51 ( V_50 ) ;
F_3 ( V_2 -> V_7 , L_41 ,
...
static int F_69 ( struct V_130 * V_50 ,
...
static int F_70 ( struct V_130 * V_50 , T_1 * V_29 )
{
struct V_1 * V_2 = F_51 ( V_50 ) ;
F_3 ( V_2 -> V_7 , L_43 ,
V_2 -> V_45 , V_2 -> V_110 ) ;
...
static void F_71 ( struct V_130 * V_50 )
{
struct V_1 * V_2 = F_51 ( V_50 ) ;
F_3 ( V_2 -> V_7 , L_44 ) ;
F_38 ( & V_2 -> V_86 ) ;
