...
static inline int F_123 ( T_1 V_46 )
{
return ( V_46 == V_9 ) ;
}
struct V_139 *
F_124 ( const struct V_42 * V_43 ,
...
unsigned long V_6 ;
F_21 ( & V_115 -> V_72 ) ;
F_128 ( & V_115 -> V_254 . V_108 , & V_115 -> V_72 ) ;
if ( F_84 ( & V_43 -> V_67 ) ) {
V_115 = F_129 ( V_43 ,
V_115 ) ;
if ( ! V_115 ) {
...
static enum V_294 F_131 ( const struct V_1 * V_39 ,
const struct V_89 * V_61 ,
...
F_134 ( ( const struct V_26 * ) V_296 -> V_143 ,
& V_296 -> V_288 , V_122 ,
V_39 -> V_3 ,
F_135 ( V_142 ) ,
V_61 -> V_62 -> V_269 ,
...
static bool F_136 ( const struct V_135 * V_295 ,
struct V_135 * V_296 ,
...
V_265 -> V_155 == V_156 )
return F_139 ( V_39 , V_61 , V_122 , V_4 , V_295 ,
V_296 ) ;
return F_131 ( V_39 , V_61 , V_122 , V_4 , V_295 , V_296 ) ;
}
static void F_144 ( struct V_311 * V_312 , struct V_121 * V_122 )
{
struct V_1 * V_39 = V_312 -> V_313 ;
struct V_104 * V_105 =
...
V_295 -> V_256 . V_255 . V_318 = V_122 -> V_128 - sizeof( struct V_130 ) ;
V_295 -> V_256 . V_255 . V_319 = sizeof( struct V_202 ) ;
} else {
V_295 -> V_256 . V_255 . V_318 = sizeof( struct V_129 ) ;
...
if ( ! F_115 ( ( const struct V_26 * ) V_295 -> V_143 , V_61 , V_154 ) )
goto V_97;
V_137 = V_295 -> V_137 ;
...
V_9 ) {
if ( F_143 ( V_39 , V_61 , V_122 , V_4 , V_295 ,
V_296 , V_154 )
== V_163 )
goto V_97;
}
...
if ( V_103 ) {
F_127 ( V_103 , & V_295 -> V_256 . V_255 ) ;
V_295 = NULL ;
} else if ( ( V_40 & V_171 ) &&
F_136 ( V_295 , V_296 , & V_137 , V_154 ) ) {
F_134 ( ( const struct V_26 * ) V_296 -> V_143 , & V_295 -> V_288 , V_122 ,
V_39 -> V_3 , V_4 ,
...
V_140 = F_150 ( V_43 -> V_70 . V_196 ,
struct V_139 ,
V_85 ) ;
if ( F_151 ( V_43 -> V_242 ,
V_140 -> V_242 ) ) {
V_43 -> V_242 = V_140 -> V_242 ;
V_320 = V_140 -> V_242 - V_321 ;
if ( ( long ) V_320 <= 0 )
V_320 = 1 ;
F_152 ( V_43 -> V_61 -> V_39 -> V_102 ,
& V_43 -> V_73 , V_320 ) ;
}
}
}
...
V_140 -> V_242 += V_321 ;
if ( V_320 ) {
F_154 (list_item, &mad_agent_priv->wait_list) {
V_322 = F_150 ( V_323 ,
struct V_139 ,
V_85 ) ;
if ( F_151 ( V_140 -> V_242 ,
V_322 -> V_242 ) )
break;
}
}
...
V_323 = & V_43 -> V_70 ;
F_128 ( & V_140 -> V_85 , V_323 ) ;
if ( V_43 -> V_70 . V_196 == & V_140 -> V_85 )
F_152 ( V_43 -> V_61 -> V_39 -> V_102 ,
& V_43 -> V_73 , V_320 ) ;
}
void F_155 ( struct V_139 * V_140 ,
int V_239 )
{
V_140 -> V_242 = F_98 ( V_239 ) ;
F_153 ( V_140 ) ;
}
void F_130 ( struct V_139 * V_140 ,
struct V_112 * V_113 )
{
struct V_42 * V_43 ;
unsigned long V_6 ;
...
static void V_209 ( struct V_311 * V_312 , struct V_121 * V_122 )
{
struct V_1 * V_39 = V_312 -> V_313 ;
struct V_104 * V_105 =
F_51 ( V_122 -> V_123 , struct V_104 , V_118 ) ;
struct V_139 * V_140 , * V_326 ;
struct V_89 * V_61 ;
struct V_106 * V_230 ;
struct V_226 * V_227 ;
struct V_112 V_113 ;
...
F_130 ( V_140 , & V_113 ) ;
if ( V_326 ) {
V_40 = F_96 ( V_61 -> V_62 , & V_326 -> V_151 . V_165 ,
& V_227 ) ;
if ( V_40 ) {
F_67 ( & V_39 -> V_3 -> V_52 ,
L_23 , V_40 ) ;
...
static void F_159 ( struct V_89 * V_61 )
{
struct V_139 * V_140 ;
struct V_104 * V_105 ;
unsigned long V_6 ;
...
static bool F_158 ( struct V_1 * V_39 ,
struct V_121 * V_122 )
{
struct V_104 * V_105 =
F_51 ( V_122 -> V_123 , struct V_104 , V_118 ) ;
...
V_67 ) ;
F_4 ( & V_43 -> V_68 , V_6 ) ;
V_140 = F_161 ( V_43 , V_111 ) ;
if ( ! V_140 || V_140 -> V_124 != V_125 ) {
F_5 ( & V_43 -> V_68 , V_6 ) ;
return - V_41 ;
}
V_339 = ( ! V_140 -> V_242 || V_140 -> V_78 > 1 ) ;
if ( ! V_239 ) {
V_140 -> V_124 = V_329 ;
V_140 -> V_78 -= ( V_140 -> V_242 > 0 ) ;
}
...
void F_163 ( struct V_33 * V_103 ,
struct V_110 * V_111 )
{
F_162 ( V_103 , V_111 , 0 ) ;
}
static void V_77 ( struct V_340 * V_341 )
{
struct V_42 * V_43 ;
struct V_145 * V_146 ;
struct V_42 * V_148 ;
...
bool V_154 ;
V_43 =
F_51 ( V_341 , struct V_42 , V_76 ) ;
V_154 = F_63 ( V_43 -> V_61 -> V_39 -> V_3 ,
V_43 -> V_61 -> V_39 -> V_4 ) ;
F_4 ( & V_43 -> V_68 , V_6 ) ;
while ( ! F_149 ( & V_43 -> V_75 ) ) {
V_146 = F_150 ( V_43 -> V_75 . V_196 ,
struct V_145 ,
V_175 ) ;
F_44 ( & V_146 -> V_175 ) ;
F_5 ( & V_43 -> V_68 , V_6 ) ;
...
if ( V_154 && V_166 == V_167 ) {
V_146 -> V_147 -> V_256 . V_255 . V_318 = V_146 -> V_174 ;
V_146 -> V_147 -> V_256 . V_255 . V_319 = sizeof( struct V_202 ) ;
} else {
...
F_128 ( & V_146 -> V_147 -> V_256 . V_255 . V_254 . V_108 ,
...
static void V_74 ( struct V_340 * V_341 )
{
struct V_42 * V_43 ;
struct V_139 * V_140 ;
struct V_112 V_113 ;
unsigned long V_6 , V_320 ;
V_43 = F_51 ( V_341 , struct V_42 ,
V_73 . V_341 ) ;
V_113 . V_293 = 0 ;
F_4 ( & V_43 -> V_68 , V_6 ) ;
while ( ! F_149 ( & V_43 -> V_70 ) ) {
V_140 = F_150 ( V_43 -> V_70 . V_196 ,
struct V_139 ,
V_85 ) ;
if ( F_151 ( V_140 -> V_242 , V_321 ) ) {
V_320 = V_140 -> V_242 - V_321 ;
if ( ( long ) V_320 <= 0 )
V_320 = 1 ;
F_166 ( V_43 -> V_61 ->
...
static int F_147 ( struct V_89 * V_61 ,
struct V_135 * V_143 )
{
unsigned long V_6 ;
int V_347 , V_40 ;
...
V_147 -> V_256 . V_316 = V_203 . V_231 ;
V_147 -> V_256 . V_105 . V_107 = V_351 ;
V_147 -> V_256 . V_105 . V_118 . V_208 = F_144 ;
V_349 . V_123 = & V_147 -> V_256 . V_105 . V_118 ;
F_4 ( & V_351 -> V_68 , V_6 ) ;
V_347 = ( ++ V_351 -> V_109 < V_351 -> V_235 ) ;
F_28 ( & V_147 -> V_256 . V_105 . V_108 , & V_351 -> V_108 ) ;
F_5 ( & V_351 -> V_68 , V_6 ) ;
V_40 = F_167 ( V_61 -> V_62 , & V_349 , & V_350 ) ;
if ( V_40 ) {
F_4 ( & V_351 -> V_68 , V_6 ) ;
...
static void F_168 ( struct V_89 * V_61 )
{
struct V_250 * V_251 ;
struct V_135 * V_295 ;
struct V_104 * V_105 ;
if ( ! V_61 -> V_62 )
return;
while ( ! F_149 ( & V_61 -> V_351 . V_108 ) ) {
V_105 = F_150 ( V_61 -> V_351 . V_108 . V_196 ,
struct V_104 , V_108 ) ;
V_251 = F_51 ( V_105 ,
struct V_250 ,
V_105 ) ;
...
static int F_169 ( struct V_1 * V_39 )
{
int V_40 , V_23 ;
struct V_330 * V_277 ;
struct V_116 * V_62 ;
...
V_277 -> V_331 = V_354 ;
V_277 -> V_120 = V_120 ;
V_277 -> V_355 = ( V_62 -> V_269 == 0 ) ? 0 : V_356 ;
V_40 = F_160 ( V_62 , V_277 , V_335 |
V_357 | V_358 ) ;
if ( V_40 ) {
F_67 ( & V_39 -> V_3 -> V_52 ,
L_27 ,
...
V_277 -> V_331 = V_332 ;
V_277 -> V_360 = V_361 ;
V_40 = F_160 ( V_62 , V_277 , V_335 | V_362 ) ;
if ( V_40 ) {
F_67 ( & V_39 -> V_3 -> V_52 ,
L_29 ,
V_23 , V_40 ) ;
...
continue;
V_40 = F_147 ( & V_39 -> V_61 [ V_23 ] , NULL ) ;
if ( V_40 ) {
F_67 ( & V_39 -> V_3 -> V_52 ,
L_31 ) ;
goto V_97;
...
static void F_172 ( struct V_364 * V_365 , void * V_366 )
{
struct V_89 * V_61 = V_366 ;
F_67 ( & V_61 -> V_39 -> V_3 -> V_52 ,
L_32 ,
V_365 -> V_365 , V_61 -> V_62 -> V_269 ) ;
}
static void F_173 ( struct V_89 * V_61 ,
struct V_106 * V_107 )
{
V_107 -> V_61 = V_61 ;
V_107 -> V_109 = 0 ;
...
static void F_174 ( struct V_1 * V_39 ,
struct V_89 * V_61 )
{
V_61 -> V_39 = V_39 ;
F_173 ( V_61 , & V_61 -> V_230 ) ;
F_173 ( V_61 , & V_61 -> V_351 ) ;
F_21 ( & V_61 -> V_236 ) ;
F_20 ( & V_61 -> V_93 ) ;
V_61 -> V_95 = NULL ;
V_61 -> V_94 = 0 ;
...
static int F_175 ( struct V_89 * V_61 ,
enum V_10 V_11 )
{
struct V_367 V_368 ;
int V_40 ;
memset ( & V_368 , 0 , sizeof V_368 ) ;
V_368 . V_369 = V_61 -> V_39 -> V_312 ;
V_368 . V_370 = V_61 -> V_39 -> V_312 ;
V_368 . V_371 = V_372 ;
V_368 . V_373 . V_374 = V_375 ;
V_368 . V_373 . V_376 = V_377 ;
V_368 . V_373 . V_378 = V_379 ;
V_368 . V_373 . V_380 = V_381 ;
V_368 . V_11 = V_11 ;
V_368 . V_4 = V_61 -> V_39 -> V_4 ;
V_368 . V_366 = V_61 ;
V_368 . V_382 = F_172 ;
V_61 -> V_62 = F_176 ( V_61 -> V_39 -> V_206 , & V_368 ) ;
if ( F_177 ( V_61 -> V_62 ) ) {
F_67 ( & V_61 -> V_39 -> V_3 -> V_52 ,
L_33 ,
F_7 ( V_11 ) ) ;
V_40 = F_178 ( V_61 -> V_62 ) ;
goto error;
}
V_61 -> V_230 . V_235 = V_375 ;
V_61 -> V_351 . V_235 = V_377 ;
return 0 ;
error:
return V_40 ;
}
static void F_179 ( struct V_89 * V_61 )
{
if ( ! V_61 -> V_62 )
return;
F_180 ( V_61 -> V_62 ) ;
...
struct V_1 * V_39 ;
unsigned long V_6 ;
char V_384 [ sizeof "ib_mad123"];
int V_385 ;
if ( F_182 ( F_60 ( V_3 , V_4 ) < V_386 ) )
return - V_387 ;
if ( F_182 ( F_63 ( V_3 , V_4 ) &&
F_60 ( V_3 , V_4 ) < V_388 ) )
return - V_387 ;
...
F_20 ( & V_39 -> V_80 ) ;
F_21 ( & V_39 -> V_85 ) ;
F_174 ( V_39 , & V_39 -> V_61 [ 0 ] ) ;
F_174 ( V_39 , & V_39 -> V_61 [ 1 ] ) ;
V_383 = V_375 + V_377 ;
V_385 = F_183 ( V_3 , V_4 ) ;
if ( V_385 )
V_383 *= 2 ;
V_39 -> V_312 = F_184 ( V_39 -> V_3 , V_39 , V_383 , 0 ,
V_389 ) ;
if ( F_177 ( V_39 -> V_312 ) ) {
F_67 ( & V_3 -> V_52 , L_34 ) ;
V_40 = F_178 ( V_39 -> V_312 ) ;
goto V_66;
}
V_39 -> V_206 = F_185 ( V_3 , 0 ) ;
if ( F_177 ( V_39 -> V_206 ) ) {
F_67 ( & V_3 -> V_52 , L_35 ) ;
V_40 = F_178 ( V_39 -> V_206 ) ;
goto V_84;
}
if ( V_385 ) {
V_40 = F_175 ( & V_39 -> V_61 [ 0 ] , V_12 ) ;
if ( V_40 )
goto V_390;
}
V_40 = F_175 ( & V_39 -> V_61 [ 1 ] , V_13 ) ;
if ( V_40 )
goto V_391;
snprintf ( V_384 , sizeof V_384 , L_36 , V_4 ) ;
V_39 -> V_102 = F_186 ( V_384 , V_392 ) ;
if ( ! V_39 -> V_102 ) {
V_40 = - V_65 ;
goto V_393;
}
F_4 ( & V_7 , V_6 ) ;
F_28 ( & V_39 -> V_315 , & V_394 ) ;
F_5 ( & V_7 , V_6 ) ;
V_40 = F_169 ( V_39 ) ;
if ( V_40 ) {
F_67 ( & V_3 -> V_52 , L_37 ) ;
...
static int F_191 ( struct V_2 * V_3 , int V_4 )
{
struct V_1 * V_39 ;
unsigned long V_6 ;
F_4 ( & V_7 , V_6 ) ;
...
int V_396 , V_23 ;
V_396 = F_193 ( V_3 ) ;
for ( V_23 = V_396 ; V_23 <= F_194 ( V_3 ) ; V_23 ++ ) {
if ( ! F_195 ( V_3 , V_23 ) )
continue;
if ( F_181 ( V_3 , V_23 ) ) {
...
static void F_198 ( struct V_2 * V_3 , void * V_398 )
{
int V_23 ;
for ( V_23 = F_193 ( V_3 ) ; V_23 <= F_194 ( V_3 ) ; V_23 ++ ) {
if ( ! F_195 ( V_3 , V_23 ) )
continue;
if ( F_197 ( V_3 , V_23 ) )
F_67 ( & V_3 -> V_52 ,
...
int F_199 ( void )
{
V_377 = F_200 ( V_377 , V_399 ) ;
V_377 = F_201 ( V_377 , V_400 ) ;
V_375 = F_200 ( V_375 , V_399 ) ;
V_375 = F_201 ( V_375 , V_400 ) ;
F_21 ( & V_394 ) ;
if ( F_202 ( & V_401 ) ) {
F_105 ( L_43 ) ;
return - V_41 ;
