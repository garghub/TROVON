...
int * V_125 ;
int V_34 ;
V_122 = F_40 ( V_119 , V_126 , L_11 ) ;
if ( ! V_122 ) {
F_41 ( & V_119 -> V_2 ,
L_12 ) ;
V_122 = F_42 ( V_119 , V_126 , 0 ) ;
if ( ! V_122 ) {
F_14 ( & V_119 -> V_2 , L_13 ) ;
return - V_74 ;
}
}
V_124 = F_43 ( & V_119 -> V_2 , V_122 ) ;
if ( F_44 ( V_124 ) )
return F_45 ( V_124 ) ;
V_2 = F_46 ( & V_119 -> V_2 , sizeof( struct V_1 ) ,
V_127 ) ;
if ( ! V_2 )
return - V_128 ;
V_2 -> V_5 = V_124 ;
V_116 = & V_2 -> V_116 [ V_20 ] ;
V_116 -> V_129 = ( V_130 ) ( V_122 -> V_131 + V_132 ) ;
V_123 = F_42 ( V_119 , V_133 , 0 ) ;
if ( V_123 ) {
V_125 = & V_2 -> V_134 [ V_20 ] ;
* V_125 = V_123 -> V_131 ;
V_116 -> V_135 = V_125 ;
} else if ( F_47 ( V_136 ) && V_119 -> V_2 . V_137 ) {
V_116 -> V_135 = L_14 ;
} else {
F_14 ( & V_119 -> V_2 , L_15 ) ;
return - V_74 ;
}
V_116 = & V_2 -> V_116 [ V_88 ] ;
V_116 -> V_129 = ( V_130 ) ( V_122 -> V_131 + V_138 ) ;
V_123 = F_42 ( V_119 , V_133 , 1 ) ;
if ( V_123 ) {
V_125 = & V_2 -> V_134 [ V_88 ] ;
* V_125 = V_123 -> V_131 ;
V_116 -> V_135 = V_125 ;
} else if ( F_47 ( V_136 ) && V_119 -> V_2 . V_137 ) {
V_116 -> V_135 = L_16 ;
...
V_2 -> V_91 = F_48 ( & V_119 -> V_2 , NULL ) ;
if ( F_44 ( V_2 -> V_91 ) )
return - V_74 ;
F_49 ( V_2 -> V_91 ) ;
V_2 -> V_2 = & V_119 -> V_2 ;
F_50 ( & V_119 -> V_2 , V_2 ) ;
V_34 = F_51 ( & V_119 -> V_2 , & V_139 ,
& V_140 , 1 ) ;
if ( V_34 != 0 )
goto V_141;
V_34 = F_52 ( & V_119 -> V_2 ) ;
if ( V_34 ) {
F_14 ( & V_119 -> V_2 , L_18 , V_34 ) ;
goto V_142;
}
return 0 ;
V_142:
