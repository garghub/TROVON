...
V_31 = V_13 -> V_34 [ 0 ] ;
V_8 = V_13 -> V_35 ;
V_32 += ( V_2 -> V_4 -> V_36 . V_37 >> 16 ) * F_19 ( V_8 , 0 ) ;
V_32 += ( V_2 -> V_4 -> V_36 . y1 >> 16 ) * V_31 ;
V_4 -> V_7 . V_38 = true ;
V_4 -> V_7 . V_31 = V_31 ;
V_4 -> V_7 . V_8 = V_8 ;
V_4 -> V_7 . V_32 = V_32 ;
V_4 -> V_7 . V_39 = V_2 -> V_4 -> V_40 . V_37 ;
V_4 -> V_7 . V_41 = V_2 -> V_4 -> V_40 . y1 ;
V_4 -> V_7 . V_42 = F_20 ( & V_2 -> V_4 -> V_40 ) ;
V_4 -> V_7 . V_43 = F_21 ( & V_2 -> V_4 -> V_40 ) ;
F_22 () ;
V_4 -> V_7 . V_44 = true ;
}
...
int F_24 ( struct V_45 * V_46 , struct V_1 * V_2 ,
unsigned long V_47 , enum V_48 type )
{
int V_49 ;
V_49 = F_25 ( V_46 , V_2 , V_47 ,
& V_50 , V_51 ,
F_26 ( V_51 ) , type , NULL ) ;
if ( V_49 ) {
F_27 ( L_2 ) ;
