...
static void F_38 ( struct V_41 * V_74 )
{
struct V_44 * V_45 = F_39 ( V_74 ) ;
F_9 ( V_45 -> V_75 ) ;
F_9 ( V_45 ) ;
}
static struct V_76 * F_40 (
const struct V_41 * V_42 )
{
struct V_44 * V_45 = F_39 ( V_42 ) ;
return V_45 -> V_75 ;
}
...
static bool F_44 ( const struct V_41 * V_42 )
{
struct V_44 * V_45 = F_39 ( V_42 ) ;
if ( ! V_45 -> V_40 )
return true ;
...
static struct V_84 * F_45 (
const struct V_41 * V_42 )
{
struct V_44 * V_45 = F_39 ( V_42 ) ;
return & V_45 -> V_52 ;
}
unsigned int F_46 ( const struct V_41 * V_42 )
{
struct V_44 * V_45 = F_39 ( V_42 ) ;
return V_45 -> V_69 ;
}
static bool F_47 ( const struct V_41 * V_42 ,
unsigned int V_69 )
{
struct V_44 * V_45 = F_39 ( V_42 ) ;
if ( V_45 -> V_69 == V_69 )
...
struct V_41 * V_42 )
{
return F_40 ( V_42 ) -> V_80 [ 0 ] ;
}
struct V_1 * F_49 (
struct V_41 * V_42 )
{
return F_40 ( V_42 ) -> V_80 [ 0 ] -> V_2 ;
}
static void F_50 ( struct V_35 * V_3 )
{
struct V_13 * V_14 ;
F_2 ( & V_3 -> V_5 ) ;
...
static int F_52 ( struct V_1 * V_2 , int V_61 ,
unsigned int * V_69 )
{
if ( ! V_2 -> V_88 )
return - V_90 ;
return F_53 ( V_2 -> V_88 , V_61 , V_69 ) ;
}
...
if ( ! V_2 -> V_88 )
return - V_90 ;
return F_57 ( V_2 -> V_88 , V_61 , V_62 , V_69 ) ;
}
...
static struct V_13 *
F_60 ( struct V_91 * V_92 , const char * V_17 )
{
...
static inline void F_62 ( struct V_91 * V_92 ,
struct V_13 * V_14 )
{
V_92 -> V_40 = V_14 ;
}
...
int V_94 ;
if ( V_49 -> V_61 != V_106 ) {
F_52 ( V_2 , V_49 -> V_61 , & V_104 ) ;
V_104 = ( V_104 >> V_49 -> V_72 ) & V_49 -> V_62 ;
V_105 = F_68 ( V_49 , V_104 ) ;
} else {
V_105 = 0 ;
}
...
static void F_69 ( struct V_23 * V_24 , int V_94 ,
int V_110 )
{
...
unsigned int V_104 ;
if ( V_61 != V_106 ) {
F_52 ( V_24 -> V_34 -> V_2 , V_61 , & V_104 ) ;
if ( F_31 ( V_47 ) && V_110 > 0 ) {
if ( V_61 != V_47 -> V_111 )
F_52 ( V_24 -> V_34 -> V_2 , V_47 -> V_111 , & V_104 ) ;
...
V_120 = 0 ;
V_121 = F_71 ( V_2 , V_14 , & V_14 -> V_103 [ V_117 ] ,
& V_42 ) ;
if ( ! V_42 ) {
if ( V_121 ) {
V_122 = false ;
...
V_42 = F_73 ( & V_14 -> V_103 [ V_117 ] , NULL , V_17 ,
V_119 ) ;
if ( ! V_42 ) {
V_50 = - V_51 ;
goto V_128;
...
F_43 ( V_14 -> V_116 [ V_94 ] , V_81 ) ;
V_45 = F_39 ( V_14 -> V_116 [ V_94 ] ) ;
if ( V_45 -> V_40 )
F_37 ( V_45 -> V_40 -> V_2 ,
V_45 -> V_40 ,
V_81 -> V_33 ,
...
F_76 ( V_2 -> V_8 , L_11 , type , V_14 -> V_17 ) ;
return - V_127 ;
}
V_50 = F_72 ( V_14 , 0 ) ;
if ( V_50 < 0 )
...
return 0 ;
for ( V_94 = 0 ; V_94 < V_14 -> V_113 ; V_94 ++ ) {
V_42 = F_73 ( & V_14 -> V_103 [ V_94 ] , V_14 ,
V_14 -> V_17 , NULL ) ;
V_50 = F_75 ( V_3 , V_42 ) ;
if ( V_50 < 0 ) {
F_76 ( V_2 -> V_8 ,
...
static int F_82 ( struct V_13 * V_40 )
{
int V_96 = F_83 ( V_40 -> V_2 -> V_3 -> V_118 ) ;
switch ( V_96 ) {
case V_132 :
case V_133 :
if ( V_40 -> V_134 )
F_84 ( V_40 -> V_2 -> V_8 , L_12 ,
V_40 -> V_17 ) ;
return V_40 -> V_134 ;
default:
return 1 ;
...
static int F_85 ( struct V_76 * * V_25 ,
struct V_84 * V_80 )
{
struct V_13 * V_14 ;
struct V_84 * V_135 ;
...
static T_3 int F_87 ( struct V_13 * V_40 ,
struct V_84 * V_25 , enum V_19 V_20 ,
int (* F_88)( struct V_13 * , struct V_84 * ,
bool (* F_89)( struct V_13 * ,
enum V_19 ) ) ,
bool (* F_89)( struct V_13 * ,
enum V_19 ) )
{
...
if ( V_25 )
F_14 ( & V_40 -> V_27 , V_25 ) ;
if ( F_89 && F_89 ( V_40 , V_20 ) ) {
V_40 -> V_26 [ V_20 ] = 1 ;
return V_40 -> V_26 [ V_20 ] ;
}
if ( ( V_40 -> V_36 & F_91 ( V_20 ) ) && V_40 -> V_139 ) {
V_40 -> V_26 [ V_20 ] = F_82 ( V_40 ) ;
return V_40 -> V_26 [ V_20 ] ;
}
...
if ( V_81 -> V_30 ) {
V_81 -> V_141 = 1 ;
V_137 += F_88 ( V_81 -> V_22 [ V_20 ] , V_25 , F_89 ) ;
V_81 -> V_141 = 0 ;
}
}
...
static int F_93 ( struct V_13 * V_40 ,
struct V_84 * V_25 ,
bool (* F_89)( struct V_13 * V_94 ,
enum V_19 ) )
{
return F_87 ( V_40 , V_25 , V_32 ,
F_93 , F_89 ) ;
}
static int F_94 ( struct V_13 * V_40 ,
struct V_84 * V_25 ,
bool (* F_89)( struct V_13 * V_94 ,
enum V_19 ) )
{
return F_87 ( V_40 , V_25 , V_31 ,
F_94 , F_89 ) ;
}
int F_95 ( struct V_142 * V_143 , int V_144 ,
struct V_76 * * V_25 ,
bool (* F_89)( struct V_13 * ,
enum V_19 ) )
{
...
if ( V_144 == V_146 )
V_52 = F_93 ( V_143 -> V_147 , & V_80 ,
F_89 ) ;
else
V_52 = F_94 ( V_143 -> V_148 , & V_80 ,
F_89 ) ;
F_97 ( V_80 . V_149 ) ;
V_50 = F_85 ( V_25 , & V_80 ) ;
if ( V_50 )
...
if ( F_100 ( V_150 ) ) {
if ( V_14 -> V_67 & V_151 ) {
V_50 = F_101 ( V_14 -> V_152 , false ) ;
if ( V_50 != 0 )
F_32 ( V_14 -> V_2 -> V_8 ,
L_13 ,
V_14 -> V_17 , V_50 ) ;
}
return F_102 ( V_14 -> V_152 ) ;
} else {
if ( V_14 -> V_67 & V_151 ) {
V_50 = F_101 ( V_14 -> V_152 , true ) ;
if ( V_50 != 0 )
F_32 ( V_14 -> V_2 -> V_8 ,
L_14 ,
V_14 -> V_17 , V_50 ) ;
}
return F_103 ( V_14 -> V_152 , V_14 -> V_64 ) ;
}
}
...
int V_156 , V_99 ;
F_90 ( V_14 , V_157 ) ;
V_156 = F_94 ( V_14 , NULL , NULL ) ;
V_99 = F_93 ( V_14 , NULL , NULL ) ;
...
static int F_113 ( struct V_13 * V_158 ,
struct V_13 * V_159 ,
bool V_160 )
{
int * V_161 ;
...
static void F_114 ( struct V_13 * V_165 ,
struct V_84 * V_25 ,
bool V_160 )
{
struct V_13 * V_14 ;
F_18 (w, list, power_list)
if ( F_113 ( V_165 , V_14 , V_160 ) < 0 ) {
F_14 ( & V_165 -> V_166 , & V_14 -> V_166 ) ;
return;
}
F_14 ( & V_165 -> V_166 , V_25 ) ;
}
static void F_115 ( struct V_35 * V_3 ,
...
unsigned int V_69 = 0 ;
unsigned int V_62 = 0 ;
V_14 = F_120 ( V_175 , struct V_13 , V_166 ) ;
V_61 = V_14 -> V_61 ;
V_2 = V_14 -> V_2 ;
F_18 (w, pending, power_list) {
F_121 ( V_61 != V_14 -> V_61 || V_2 != V_14 -> V_2 ) ;
V_14 -> V_83 = V_14 -> V_86 ;
...
F_115 ( V_3 , V_14 , V_168 ) ;
F_115 ( V_3 , V_14 , V_170 ) ;
}
if ( V_61 >= 0 ) {
F_6 ( V_2 -> V_8 , V_3 -> V_6 ,
L_25 ,
...
F_3 ( V_3 -> V_6 ) ;
F_54 ( V_2 , V_61 , V_62 , V_69 ) ;
}
F_18 (w, pending, power_list) {
F_115 ( V_3 , V_14 , V_169 ) ;
F_115 ( V_3 , V_14 , V_171 ) ;
}
}
static void F_122 ( struct V_35 * V_3 ,
...
for ( V_94 = 0 ; V_94 < F_124 ( V_162 ) ; V_94 ++ )
if ( V_161 [ V_94 ] == V_177 )
V_180 -> V_181 ( V_180 ,
V_94 ,
V_178 ) ;
...
static void F_127 ( struct V_35 * V_3 )
{
...
unsigned int V_189 ;
int V_50 ;
if ( ! V_188 || ! F_44 ( V_188 -> V_42 ) )
return;
V_75 = F_40 ( V_188 -> V_42 ) ;
for ( V_189 = 0 ; V_189 < V_75 -> V_79 ; V_189 ++ ) {
V_14 = V_75 -> V_80 [ V_189 ] ;
if ( V_14 -> V_150 && ( V_14 -> V_174 & V_190 ) ) {
V_50 = V_14 -> V_150 ( V_14 , V_188 -> V_42 , V_190 ) ;
if ( V_50 != 0 )
F_76 ( V_14 -> V_2 -> V_8 , L_27 ,
V_14 -> V_17 , V_50 ) ;
}
}
if ( ! V_14 )
return;
V_50 = F_54 ( V_14 -> V_2 , V_188 -> V_61 , V_188 -> V_62 ,
V_188 -> V_104 ) ;
if ( V_50 < 0 )
F_76 ( V_14 -> V_2 -> V_8 , L_28 ,
V_14 -> V_17 , V_50 ) ;
if ( V_188 -> V_191 ) {
V_50 = F_54 ( V_14 -> V_2 , V_188 -> V_192 ,
...
if ( V_50 != 0 )
F_76 ( V_14 -> V_2 -> V_8 , L_29 ,
V_14 -> V_17 , V_50 ) ;
}
}
}
static void F_128 ( void * V_45 , T_5 V_196 )
{
...
if ( V_176 -> V_98 == V_201 &&
V_176 -> V_198 == V_200 ) {
V_50 = F_64 ( V_176 , V_200 ) ;
if ( V_50 != 0 )
F_76 ( V_176 -> V_8 , L_34 ,
V_50 ) ;
}
}
static void F_132 ( struct V_13 * V_202 ,
bool V_83 , bool V_30 )
{
if ( ! V_30 )
return;
...
static void F_133 ( struct V_13 * V_14 , bool V_83 ,
struct V_84 * V_203 ,
struct V_84 * V_204 )
{
struct V_23 * V_81 ;
...
F_134 ( V_14 , V_83 ) ;
F_78 (w, path)
F_132 ( V_81 -> V_33 , V_83 , V_81 -> V_30 ) ;
if ( ! V_14 -> V_28 ) {
F_111 (w, path)
F_132 ( V_81 -> V_34 , V_83 ,
V_81 -> V_30 ) ;
}
if ( V_83 )
F_114 ( V_14 , V_203 , true ) ;
else
F_114 ( V_14 , V_204 , false ) ;
}
...
static int F_137 ( struct V_35 * V_3 , int V_150 )
{
struct V_13 * V_14 ;
struct V_1 * V_176 ;
F_17 ( V_203 ) ;
...
F_115 ( V_3 , V_14 , V_173 ) ;
}
F_18 (w, &up_list, power_list) {
F_115 ( V_3 , V_14 , V_172 ) ;
}
F_122 ( V_3 , & V_204 , V_150 , false ) ;
F_127 ( V_3 ) ;
F_122 ( V_3 , & V_203 , V_150 , true ) ;
F_18 (d, &card->dapm_list, list) {
if ( V_176 != & V_3 -> V_2 )
F_142 ( F_130 , V_176 ,
& V_207 ) ;
...
static T_6 F_145 ( struct V_216 * V_216 ,
char T_7 * V_217 ,
T_4 V_218 , T_8 * V_219 )
{
...
F_25 ( & V_3 -> V_5 ) ;
V_50 = F_147 ( V_217 , V_218 , V_219 , V_10 , V_50 ) ;
F_9 ( V_10 ) ;
return V_50 ;
}
static T_6 F_148 ( struct V_216 * V_216 , char T_7 * V_217 ,
T_4 V_218 , T_8 * V_219 )
{
...
break;
default:
F_116 ( 1 , L_55 , V_2 -> V_98 ) ;
V_96 = L_56 ;
break;
}
return F_147 ( V_217 , V_218 , V_219 , V_96 ,
strlen ( V_96 ) ) ;
}
...
if ( ! V_223 )
return;
V_2 -> V_224 = F_150 ( L_57 , V_223 ) ;
if ( ! V_2 -> V_224 ) {
F_32 ( V_2 -> V_8 ,
L_58 ) ;
return;
}
V_176 = F_151 ( L_59 , 0444 ,
V_2 -> V_224 , V_2 ,
& V_225 ) ;
if ( ! V_176 )
F_32 ( V_2 -> V_8 ,
...
static inline void F_152 ( struct V_13 * V_14 )
{
}
static inline void F_153 ( struct V_1 * V_2 )
{
}
static void F_155 ( struct V_23 * V_81 ,
...
static int F_156 ( struct V_35 * V_3 ,
...
F_96 ( & V_3 -> V_5 , V_145 ) ;
V_3 -> V_188 = V_188 ;
V_50 = F_156 ( V_3 , V_42 , V_227 , V_49 ) ;
V_3 -> V_188 = NULL ;
F_25 ( & V_3 -> V_5 ) ;
if ( V_50 > 0 )
F_159 ( V_3 ) ;
...
static int F_160 ( struct V_35 * V_3 ,
struct V_41 * V_42 ,
int V_30 , int V_230 )
{
struct V_23 * V_81 ;
...
F_157 (path, kcontrol) {
if ( V_228 && V_230 >= 0 )
F_155 ( V_81 , V_230 , L_63 ) ;
else
F_155 ( V_81 , V_30 , L_63 ) ;
V_228 = 1 ;
}
if ( V_228 )
F_137 ( V_3 , V_229 ) ;
...
static T_6 F_162 ( struct V_231 * V_232 ,
char * V_10 )
{
struct V_1 * V_2 = F_163 ( V_232 ) ;
struct V_13 * V_14 ;
int V_218 = 0 ;
char * V_233 = L_64 ;
if ( ! V_232 -> V_3 )
...
static T_6 F_165 ( struct V_7 * V_8 ,
struct V_240 * V_241 , char * V_10 )
{
struct V_242 * V_243 = F_166 ( V_8 ) ;
int V_94 , V_218 = 0 ;
F_24 ( & V_243 -> V_3 -> V_5 ) ;
for ( V_94 = 0 ; V_94 < V_243 -> V_244 ; V_94 ++ ) {
struct V_231 * V_232 = V_243 -> V_245 [ V_94 ] -> V_88 ;
V_218 += F_162 ( V_232 , V_10 + V_218 ) ;
}
F_25 ( & V_243 -> V_3 -> V_5 ) ;
return V_218 ;
}
static void F_167 ( struct V_23 * V_81 )
{
F_97 ( & V_81 -> V_246 [ V_31 ] ) ;
F_97 ( & V_81 -> V_246 [ V_32 ] ) ;
F_97 ( & V_81 -> V_82 ) ;
F_97 ( & V_81 -> V_25 ) ;
F_9 ( V_81 ) ;
}
...
F_123 (w, next_w, &dapm->card->widgets, list) {
if ( V_14 -> V_2 != V_2 )
continue;
F_168 ( V_14 ) ;
}
...
{
struct V_13 * V_14 = F_173 ( V_2 , V_251 , true ) ;
F_1 ( V_2 ) ;
if ( ! V_14 ) {
F_76 ( V_2 -> V_8 , L_69 , V_251 ) ;
return - V_127 ;
}
if ( V_14 -> V_139 != V_254 ) {
F_12 ( V_14 , L_70 ) ;
...
if ( ! V_2 -> V_3 || ! V_2 -> V_3 -> V_4 )
return 0 ;
return F_137 ( V_2 -> V_3 , V_229 ) ;
}
int F_176 ( struct V_1 * V_2 )
{
int V_50 ;
F_96 ( & V_2 -> V_3 -> V_5 , V_145 ) ;
V_50 = F_175 ( V_2 ) ;
F_25 ( & V_2 -> V_3 -> V_5 ) ;
return V_50 ;
}
...
V_50 = F_178 ( V_2 , V_262 , V_263 , V_259 ) ;
if ( V_50 )
return V_50 ;
...
switch ( V_262 -> V_53 ) {
case V_70 :
V_50 = F_67 ( V_2 , V_81 , V_259 , V_262 ) ;
if ( V_50 )
goto V_264;
break;
default:
...
switch ( V_263 -> V_53 ) {
case V_71 :
V_50 = F_67 ( V_2 , V_81 , V_259 , V_263 ) ;
if ( V_50 != 0 )
goto V_264;
break;
case V_54 :
...
F_179 ( & V_81 -> V_25 , & V_2 -> V_3 -> V_52 ) ;
F_146 (dir)
F_179 ( & V_81 -> V_246 [ V_20 ] , & V_80 [ V_20 ] -> V_130 [ V_20 ] ) ;
F_146 (dir) {
F_177 ( V_80 [ V_20 ] ) ;
F_12 ( V_80 [ V_20 ] , L_76 ) ;
}
...
V_262 = F_60 ( & V_2 -> V_249 , V_33 ) ;
V_263 = F_60 ( & V_2 -> V_248 , V_34 ) ;
if ( V_263 && V_262 )
goto V_271;
F_18 (w, &dapm->card->widgets, list) {
...
V_271:
F_62 ( & V_2 -> V_248 , V_263 ) ;
F_62 ( & V_2 -> V_249 , V_262 ) ;
V_50 = F_37 ( V_2 , V_262 , V_263 , V_266 -> V_259 ,
V_266 -> V_139 ) ;
if ( V_50 )
goto V_264;
return 0 ;
...
F_96 ( & V_2 -> V_3 -> V_5 , V_274 ) ;
for ( V_94 = 0 ; V_94 < V_272 ; V_94 ++ ) {
V_273 = F_180 ( V_2 , V_266 ) ;
if ( V_273 < 0 ) {
F_76 ( V_2 -> V_8 , L_83 ,
V_266 -> V_33 ,
...
const struct V_265 * V_266 )
{
struct V_13 * V_33 = F_173 ( V_2 ,
V_266 -> V_33 ,
true ) ;
struct V_13 * V_34 = F_173 ( V_2 ,
V_266 -> V_34 ,
true ) ;
struct V_23 * V_81 ;
int V_218 = 0 ;
...
int V_50 = 0 ;
F_96 ( & V_3 -> V_5 , V_145 ) ;
if ( F_44 ( V_42 ) && V_61 != V_106 ) {
V_50 = F_52 ( V_2 , V_61 , & V_280 ) ;
V_104 = ( V_280 >> V_64 ) & V_62 ;
if ( V_50 == 0 && V_61 != V_47 -> V_111 )
V_50 = F_52 ( V_2 , V_47 -> V_111 , & V_280 ) ;
if ( F_31 ( V_47 ) )
...
L_91 ,
V_42 -> V_53 . V_17 ) ;
V_282 = F_47 ( V_42 , V_104 | ( V_281 << V_279 ) ) ;
if ( V_61 != V_106 ) {
V_104 = V_104 << V_64 ;
V_281 = V_281 << V_47 -> V_112 ;
V_283 = F_56 ( V_2 , V_61 , V_62 << V_64 , V_104 ) ;
if ( F_31 ( V_47 ) )
V_283 |= F_56 ( V_2 , V_47 -> V_111 ,
V_62 << V_47 -> V_112 ,
V_281 ) ;
}
if ( V_282 || V_283 ) {
...
F_96 ( & V_3 -> V_5 , V_145 ) ;
if ( V_49 -> V_61 != V_106 && F_44 ( V_42 ) ) {
int V_50 = F_52 ( V_2 , V_49 -> V_61 , & V_280 ) ;
if ( V_50 ) {
F_25 ( & V_3 -> V_5 ) ;
return V_50 ;
}
...
V_278 -> V_69 . V_284 . V_105 [ 0 ] = F_68 ( V_49 , V_104 ) ;
if ( V_49 -> V_72 != V_49 -> V_285 ) {
V_104 = ( V_280 >> V_49 -> V_285 ) & V_49 -> V_62 ;
V_104 = F_68 ( V_49 , V_104 ) ;
...
return - V_127 ;
V_104 = F_36 ( V_49 , V_105 [ 0 ] ) << V_49 -> V_72 ;
V_62 = V_49 -> V_62 << V_49 -> V_72 ;
if ( V_49 -> V_72 != V_49 -> V_285 ) {
if ( V_105 [ 1 ] > V_49 -> V_107 )
return - V_127 ;
V_104 |= F_36 ( V_49 , V_105 [ 1 ] ) << V_49 -> V_285 ;
V_62 |= V_49 -> V_62 << V_49 -> V_285 ;
}
F_96 ( & V_3 -> V_5 , V_145 ) ;
V_282 = F_47 ( V_42 , V_104 ) ;
if ( V_49 -> V_61 != V_106 )
V_283 = F_56 ( V_2 , V_49 -> V_61 , V_62 , V_104 ) ;
if ( V_282 || V_283 ) {
if ( V_283 ) {
V_188 . V_42 = V_42 ;
...
V_282 |= V_283 ;
V_50 = F_156 ( V_3 , V_42 , V_105 [ 0 ] , V_49 ) ;
V_3 -> V_188 = NULL ;
}
F_25 ( & V_3 -> V_5 ) ;
if ( V_50 > 0 )
...
switch ( V_14 -> V_53 ) {
case V_212 :
V_14 -> V_152 = F_198 ( V_2 -> V_8 , V_14 -> V_17 ) ;
if ( F_199 ( V_14 -> V_152 ) ) {
V_50 = F_200 ( V_14 -> V_152 ) ;
F_76 ( V_2 -> V_8 , L_93 ,
V_14 -> V_17 , V_50 ) ;
return NULL ;
}
...
case V_213 :
#ifdef F_201
V_14 -> V_153 = F_202 ( V_2 -> V_8 , V_14 -> V_17 ) ;
if ( F_199 ( V_14 -> V_153 ) ) {
V_50 = F_200 ( V_14 -> V_153 ) ;
F_76 ( V_2 -> V_8 , L_93 ,
V_14 -> V_17 , V_50 ) ;
return NULL ;
}
...
struct V_41 * V_42 , int V_150 )
{
struct V_23 * V_295 , * V_296 ;
struct V_142 * V_33 , * V_34 ;
const struct V_297 * V_298 = V_14 -> V_299 + V_14 -> V_300 ;
struct V_301 V_302 ;
struct V_303 * V_299 = NULL ;
struct V_304 * V_305 = NULL ;
T_9 V_9 ;
int V_50 ;
if ( F_121 ( ! V_298 ) ||
F_121 ( F_11 ( & V_14 -> V_130 [ V_32 ] ) ||
F_11 ( & V_14 -> V_130 [ V_31 ] ) ) )
return - V_127 ;
V_295 = F_120 ( & V_14 -> V_130 [ V_32 ] ,
struct V_23 ,
V_246 [ V_32 ] ) ;
V_296 = F_120 ( & V_14 -> V_130 [ V_31 ] ,
struct V_23 ,
V_246 [ V_31 ] ) ;
V_33 = V_295 -> V_33 -> V_306 ;
V_34 = V_296 -> V_34 -> V_306 ;
if ( V_298 -> V_307 ) {
V_9 = F_206 ( V_298 -> V_307 ) - 1 ;
} else {
F_32 ( V_14 -> V_2 -> V_8 , L_94 ,
V_298 -> V_307 ) ;
V_9 = 0 ;
}
V_299 = F_29 ( sizeof( * V_299 ) , V_12 ) ;
if ( ! V_299 ) {
V_50 = - V_51 ;
goto V_99;
}
F_207 ( F_208 ( V_299 , V_308 ) , V_9 ) ;
F_209 ( V_299 , V_309 ) -> V_289 =
V_298 -> V_310 ;
F_209 ( V_299 , V_309 ) -> V_63 =
V_298 -> V_311 ;
F_209 ( V_299 , V_312 ) -> V_289
= V_298 -> V_313 ;
F_209 ( V_299 , V_312 ) -> V_63
= V_298 -> V_314 ;
memset ( & V_302 , 0 , sizeof( V_302 ) ) ;
V_305 = F_29 ( sizeof( * V_305 ) , V_12 ) ;
if ( ! V_305 ) {
V_50 = - V_51 ;
goto V_99;
}
...
case V_168 :
V_302 . V_144 = V_315 ;
if ( V_33 -> V_316 -> V_317 && V_33 -> V_316 -> V_317 -> V_318 ) {
V_50 = V_33 -> V_316 -> V_317 -> V_318 ( & V_302 , V_33 ) ;
if ( V_50 < 0 ) {
F_76 ( V_33 -> V_8 ,
L_95 , V_50 ) ;
goto V_99;
...
V_50 = F_210 ( & V_302 , V_299 , V_33 ) ;
if ( V_50 < 0 )
goto V_99;
V_302 . V_144 = V_146 ;
if ( V_34 -> V_316 -> V_317 && V_34 -> V_316 -> V_317 -> V_318 ) {
V_50 = V_34 -> V_316 -> V_317 -> V_318 ( & V_302 , V_34 ) ;
if ( V_50 < 0 ) {
F_76 ( V_34 -> V_8 ,
L_95 , V_50 ) ;
goto V_99;
...
V_50 = F_211 ( V_34 , 0 ,
V_146 ) ;
if ( V_50 != 0 && V_50 != - V_319 )
F_32 ( V_34 -> V_8 , L_96 , V_50 ) ;
V_50 = 0 ;
break;
case V_170 :
V_50 = F_211 ( V_34 , 1 ,
...
V_50 = 0 ;
V_33 -> V_221 -- ;
if ( V_33 -> V_316 -> V_317 && V_33 -> V_316 -> V_317 -> V_320 ) {
V_302 . V_144 = V_315 ;
V_33 -> V_316 -> V_317 -> V_320 ( & V_302 , V_33 ) ;
}
V_34 -> V_221 -- ;
if ( V_34 -> V_316 -> V_317 && V_34 -> V_316 -> V_317 -> V_320 ) {
V_302 . V_144 = V_146 ;
V_34 -> V_316 -> V_317 -> V_320 ( & V_302 , V_34 ) ;
}
break;
default:
F_116 ( 1 , L_21 , V_150 ) ;
...
struct V_277 * V_278 )
{
struct V_13 * V_14 = F_39 ( V_42 ) ;
V_278 -> V_69 . V_284 . V_105 [ 0 ] = V_14 -> V_300 ;
return 0 ;
}
...
if ( V_14 -> V_83 )
return - V_321 ;
if ( V_278 -> V_69 . V_284 . V_105 [ 0 ] == V_14 -> V_300 )
return 0 ;
if ( V_278 -> V_69 . V_284 . V_105 [ 0 ] >= V_14 -> V_131 )
return - V_127 ;
V_14 -> V_300 = V_278 -> V_69 . V_284 . V_105 [ 0 ] ;
return 0 ;
}
...
const struct V_297 * V_298 = V_299 ;
V_323 = F_217 ( V_3 -> V_8 , V_131 ,
sizeof( char * ) , V_12 ) ;
if ( ! V_323 )
return - V_51 ;
V_322 = F_218 ( V_3 -> V_8 , V_12 , L_98 ,
V_33 -> V_17 , V_34 -> V_17 ) ;
if ( ! V_322 ) {
V_50 = - V_51 ;
goto V_326;
...
V_323 [ V_218 ] = F_219 ( V_3 -> V_8 ,
V_298 -> V_327 ,
strlen ( V_298 -> V_327 ) + 1 ,
V_12 ) ;
if ( ! V_323 [ V_218 ] ) {
V_50 = - V_51 ;
goto V_328;
...
V_14 -> V_299 = V_299 ;
V_14 -> V_131 = V_131 ;
V_50 = F_37 ( & V_3 -> V_2 , V_33 , V_14 , NULL , NULL ) ;
if ( V_50 )
goto V_331;
return F_37 ( & V_3 -> V_2 , V_14 , V_34 , NULL , NULL ) ;
V_331:
F_220 ( V_3 -> V_8 , V_14 ) ;
V_330:
...
V_326:
for ( V_218 = 0 ; V_218 < V_131 ; V_218 ++ )
F_220 ( V_3 -> V_8 , ( void * ) V_323 [ V_218 ] ) ;
F_220 ( V_3 -> V_8 , V_323 ) ;
return V_50 ;
}
...
struct V_13 V_59 ;
struct V_13 * V_14 ;
F_121 ( V_2 -> V_8 != V_143 -> V_8 ) ;
memset ( & V_59 , 0 , sizeof( V_59 ) ) ;
V_59 . V_61 = V_106 ;
if ( V_143 -> V_316 -> V_332 . V_327 ) {
V_59 . V_53 = V_294 ;
V_59 . V_17 = V_143 -> V_316 -> V_332 . V_327 ;
V_59 . V_220 = V_143 -> V_316 -> V_332 . V_327 ;
F_84 ( V_143 -> V_8 , L_102 ,
V_59 . V_17 ) ;
V_14 = F_35 ( V_2 , & V_59 ) ;
if ( ! V_14 ) {
F_76 ( V_2 -> V_8 , L_103 ,
V_143 -> V_316 -> V_332 . V_327 ) ;
return - V_51 ;
}
V_14 -> V_306 = V_143 ;
V_143 -> V_147 = V_14 ;
}
if ( V_143 -> V_316 -> V_333 . V_327 ) {
V_59 . V_53 = V_293 ;
V_59 . V_17 = V_143 -> V_316 -> V_333 . V_327 ;
V_59 . V_220 = V_143 -> V_316 -> V_333 . V_327 ;
F_84 ( V_143 -> V_8 , L_102 ,
V_59 . V_17 ) ;
V_14 = F_35 ( V_2 , & V_59 ) ;
if ( ! V_14 ) {
F_76 ( V_2 -> V_8 , L_103 ,
V_143 -> V_316 -> V_333 . V_327 ) ;
return - V_51 ;
}
V_14 -> V_306 = V_143 ;
V_143 -> V_148 = V_14 ;
...
{
struct V_13 * V_334 , * V_14 ;
struct V_13 * V_335 , * V_34 ;
struct V_142 * V_143 ;
...
if ( ! V_14 -> V_220 || ! strstr ( V_14 -> V_220 , V_334 -> V_220 ) )
continue;
if ( V_334 -> V_53 == V_294 ) {
V_335 = V_334 ;
V_34 = V_14 ;
...
F_84 ( V_143 -> V_8 , L_104 , V_335 -> V_17 , V_34 -> V_17 ) ;
F_37 ( V_14 -> V_2 , V_335 , V_34 , NULL , NULL ) ;
}
}
return 0 ;
}
...
struct V_242 * V_243 )
{
struct V_142 * V_336 = V_243 -> V_336 ;
struct V_13 * V_34 , * V_33 ;
int V_94 ;
for ( V_94 = 0 ; V_94 < V_243 -> V_244 ; V_94 ++ ) {
struct V_142 * V_337 = V_243 -> V_245 [ V_94 ] ;
if ( V_337 -> V_147 && V_336 -> V_147 ) {
V_33 = V_336 -> V_147 ;
V_34 = V_337 -> V_147 ;
F_84 ( V_243 -> V_8 , L_105 ,
V_336 -> V_88 -> V_17 , V_33 -> V_17 ,
V_337 -> V_88 -> V_17 , V_34 -> V_17 ) ;
F_37 ( & V_3 -> V_2 , V_33 , V_34 ,
NULL , NULL ) ;
}
if ( V_337 -> V_148 && V_336 -> V_148 ) {
V_33 = V_337 -> V_148 ;
V_34 = V_336 -> V_148 ;
F_84 ( V_243 -> V_8 , L_105 ,
V_337 -> V_88 -> V_17 , V_33 -> V_17 ,
V_336 -> V_88 -> V_17 , V_34 -> V_17 ) ;
F_37 ( & V_3 -> V_2 , V_33 , V_34 ,
NULL , NULL ) ;
}
}
}
static void F_224 ( struct V_142 * V_143 , int V_144 ,
int V_150 )
{
struct V_13 * V_14 ;
unsigned int V_255 ;
...
if ( V_243 -> V_342 -> V_343 || V_243 -> V_342 -> V_299 )
continue;
F_223 ( V_3 , V_243 ) ;
}
}
static void F_226 ( struct V_242 * V_243 , int V_144 ,
int V_150 )
{
int V_94 ;
F_224 ( V_243 -> V_336 , V_144 , V_150 ) ;
for ( V_94 = 0 ; V_94 < V_243 -> V_244 ; V_94 ++ )
F_224 ( V_243 -> V_245 [ V_94 ] , V_144 , V_150 ) ;
F_137 ( V_243 -> V_3 , V_150 ) ;
}
void F_227 ( struct V_242 * V_243 , int V_144 ,
int V_150 )
{
struct V_35 * V_3 = V_243 -> V_3 ;
F_96 ( & V_3 -> V_5 , V_145 ) ;
F_226 ( V_243 , V_144 , V_150 ) ;
F_25 ( & V_3 -> V_5 ) ;
}
int F_228 ( struct V_1 * V_2 ,
const char * V_251 )
{
return F_174 ( V_2 , V_251 , 1 ) ;
}
int F_195 ( struct V_1 * V_2 , const char * V_251 )
{
int V_50 ;
F_96 ( & V_2 -> V_3 -> V_5 , V_145 ) ;
V_50 = F_174 ( V_2 , V_251 , 1 ) ;
F_25 ( & V_2 -> V_3 -> V_5 ) ;
return V_50 ;
}
...
struct V_13 * V_14 = F_173 ( V_2 , V_251 , true ) ;
if ( ! V_14 ) {
F_76 ( V_2 -> V_8 , L_107 , V_251 ) ;
return - V_127 ;
}
F_84 ( V_14 -> V_2 -> V_8 , L_108 , V_251 ) ;
if ( ! V_14 -> V_139 ) {
F_20 ( V_14 ) ;
F_21 ( V_14 ) ;
V_14 -> V_139 = 1 ;
...
int F_233 ( struct V_1 * V_2 , const char * V_251 )
{
int V_50 ;
F_96 ( & V_2 -> V_3 -> V_5 , V_145 ) ;
V_50 = F_174 ( V_2 , V_251 , 0 ) ;
...
const char * V_251 )
{
struct V_13 * V_14 = F_173 ( V_2 , V_251 , false ) ;
if ( ! V_14 ) {
F_76 ( V_2 -> V_8 , L_107 , V_251 ) ;
return - V_127 ;
}
