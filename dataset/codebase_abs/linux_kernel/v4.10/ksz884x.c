...
static int F_298 ( struct V_419 * V_420 , struct V_565 * V_548 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_299 ( & V_259 -> V_566 ) ;
...
V_548 -> V_568 |= V_569 ;
F_301 ( & V_259 -> V_566 ) ;
V_422 -> V_568 = V_548 -> V_568 ;
return 0 ;
}
static int F_302 ( struct V_419 * V_420 , struct V_565 * V_548 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
T_2 V_251 = F_303 ( V_548 ) ;
int V_294 ;
if ( V_548 -> V_570 && V_422 -> V_568 == V_548 -> V_568 ) {
V_548 -> V_568 |= V_571 ;
if ( 10 == V_251 )
V_548 -> V_568 &=
~ ( V_572 |
...
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_310 ( V_26 -> V_577 , V_578 , sizeof( V_26 -> V_577 ) ) ;
F_310 ( V_26 -> V_579 , V_580 , sizeof( V_26 -> V_579 ) ) ;
F_310 ( V_26 -> V_581 , F_311 ( V_259 -> V_261 ) ,
sizeof( V_26 -> V_581 ) ) ;
}
static int F_312 ( struct V_419 * V_420 )
{
struct V_582 * V_583 = V_584 ;
int V_585 = 0x10 * sizeof( T_2 ) ;
while ( V_583 -> V_586 > V_583 -> V_587 ) {
V_585 += ( V_583 -> V_586 - V_583 -> V_587 + 3 ) / 4 * 4 ;
V_583 ++ ;
}
return V_585 ;
}
static void F_313 ( struct V_419 * V_420 , struct V_588 * V_589 ,
void * V_590 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
while ( V_583 -> V_586 > V_583 -> V_587 ) {
for ( V_33 = V_583 -> V_587 ; V_33 < V_583 -> V_586 ; V_33 += 4 ) {
...
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
V_592 -> V_593 = V_259 -> V_594 ;
V_592 -> V_595 = V_259 -> V_282 ;
memset ( & V_592 -> V_596 , 0 , sizeof( V_592 -> V_596 ) ) ;
}
...
if ( V_592 -> V_595 & ~ V_259 -> V_594 )
return - V_597 ;
V_259 -> V_282 = V_592 -> V_595 ;
if ( V_592 -> V_595 )
V_259 -> V_282 |= V_598 ;
...
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
V_609 -> V_570 = ( V_2 -> V_121 & V_218 ) ? 0 : 1 ;
if ( ! V_2 -> V_104 ) {
V_609 -> V_610 =
( V_2 -> V_209 & V_211 ) ? 1 : 0 ;
V_609 -> V_611 =
...
static void F_335 ( unsigned long V_590 )
{
struct V_258 * V_259 = (struct V_258 * ) V_590 ;
F_332 ( & V_259 -> V_495 ) ;
if ( V_259 -> V_630 ) {
...
static void F_337 ( unsigned long V_590 )
{
struct V_419 * V_420 = (struct V_419 * ) V_590 ;
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
...
F_339 ( & V_422 -> V_551 , 1 ) ;
V_422 -> V_567 . V_635 = 0x1 ;
V_422 -> V_567 . V_636 = 0x7 ;
...
snprintf ( V_652 , sizeof( V_652 ) , L_9 , V_579 ) ;
V_652 [ 13 ] = V_67 + '0' ;
