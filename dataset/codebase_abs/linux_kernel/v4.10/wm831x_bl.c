...
struct V_28 * V_28 = F_8 ( V_25 -> V_26 . V_27 ) ;
struct V_29 * V_30 ;
struct V_4 * V_5 ;
struct V_1 * V_2 ;
struct V_31 V_18 ;
...
if ( V_38 [ V_32 ] > V_30 -> V_39 )
break;
}
if ( V_32 == 0 ) {
F_9 ( & V_25 -> V_26 , L_2 , V_30 -> V_39 ) ;
return - V_36 ;
}
V_33 = V_32 - 1 ;
if ( V_30 -> V_39 != V_38 [ V_33 ] )
F_10 ( & V_25 -> V_26 ,
L_3 ,
V_38 [ V_33 ] , V_30 -> V_39 ) ;
switch ( V_30 -> V_40 ) {
...
break;
default:
F_9 ( & V_25 -> V_26 , L_4 , V_30 -> V_40 ) ;
return - V_36 ;
}
V_10 = F_11 ( V_6 ) ;
if ( V_10 < 0 )
return V_10 ;
V_10 = F_3 ( V_6 , V_44 , V_43 ,
V_34 ) ;
F_12 ( V_6 ) ;
if ( V_10 < 0 )
return V_10 ;
V_5 = F_13 ( & V_25 -> V_26 , sizeof( * V_5 ) , V_45 ) ;
if ( V_5 == NULL )
return - V_46 ;
V_5 -> V_6 = V_6 ;
V_5 -> V_8 = 0 ;
...
V_18 . type = V_47 ;
V_18 . V_48 = V_33 ;
V_2 = F_14 ( & V_25 -> V_26 , L_5 , & V_25 -> V_26 ,
V_5 , & V_49 , & V_18 ) ;
if ( F_15 ( V_2 ) ) {
F_9 ( & V_25 -> V_26 , L_6 ) ;
return F_16 ( V_2 ) ;
