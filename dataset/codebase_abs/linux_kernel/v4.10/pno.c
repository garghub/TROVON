...
V_55 = F_3 ( V_2 , V_52 -> V_60 [ 0 ] . V_61 , 0 , 0 ) ;
if ( V_55 < 0 )
return V_55 ;
if ( V_52 -> V_6 & V_62 ) {
...
V_57 = & V_2 -> V_64 -> V_65 -> V_57 ;
for ( V_30 = 0 ; V_30 < V_52 -> V_66 ; V_30 ++ ) {
V_59 = V_52 -> V_67 [ V_30 ] -> V_68 ;
V_58 . V_69 [ V_30 ] = F_11 ( V_59 ) ;
}
if ( V_52 -> V_66 ) {
V_58 . V_70 = F_4 ( V_52 -> V_66 ) ;
F_1 ( V_2 , & V_58 ) ;
}
for ( V_30 = 0 ; V_30 < V_52 -> V_71 ; V_30 ++ ) {
V_37 = & V_52 -> V_72 [ V_30 ] . V_37 ;
if ( ! V_37 -> V_49 ) {
F_8 ( L_16 ) ;
continue;
}
