...
static int F_56 ( struct V_105 * V_23 )
{
unsigned long V_107 ;
struct V_3 * V_3 ;
T_3 V_52 ;
...
struct V_24 * F_57 ( struct V_105 * V_23 , T_7 V_136 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
struct V_1 * V_2 = NULL ;
V_2 = F_58 ( sizeof *V_2 , V_136 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_2 . V_7 = V_14 ;
V_2 -> V_52 = V_4 -> V_36 ;
...
void F_60 ( struct V_105 * V_23 , struct V_24 * V_27 )
{
struct V_1 * V_2 = F_12 ( V_27 ) ;
F_61 ( V_2 ) ;
F_62 ( V_2 ) ;
}
void F_63 ( struct V_3 * V_3 , struct V_1 * V_27 )
{
F_64 ( V_27 ) ;
...
static int F_65 ( struct V_3 * V_3 , void * V_137 )
{
struct V_1 * V_27 = V_137 ;
F_63 ( V_3 , V_27 ) ;
return 0 ;
}
static int F_66 ( struct V_105 * V_23 , struct V_24 * V_27 ,
T_7 V_136 )
{
struct V_4 * V_4 ;
struct V_1 * V_2 ;
...
F_71 ( & V_2 -> V_29 , & V_4 -> V_49 ) ;
if ( ! V_4 -> V_28 && & V_2 -> V_29 == V_4 -> V_49 . V_142 ) {
V_25 = F_72 ( V_3 ,
F_65 ,
V_2 ) ;
if ( V_25 < 0 )
...
static int F_75 ( struct V_105 * V_23 , struct V_24 * V_2 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
...
if ( V_4 -> V_49 . V_142 != & V_27 -> V_29 || V_4 -> V_28 )
F_11 ( V_4 , V_2 , - V_145 ) ;
else if ( F_2 () && V_4 -> V_7 ) {
struct V_6 * V_38 = V_3 -> V_6 ;
...
static int F_78 ( struct V_105 * V_23 , int V_39 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
T_3 V_52 = V_4 -> V_36 ;
struct V_3 * V_3 = V_4 -> V_3 ;
...
V_4 -> V_133 = 0 ;
F_20 ( V_3 , L_42 , V_23 -> V_47 , V_39 ? L_43 : L_44 ) ;
if ( V_4 -> V_40 ) {
V_54 = F_27 ( V_34 , V_41 ) ;
V_54 |= V_67
| V_118 ;
...
static int F_79 ( struct V_105 * V_23 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
if ( ! V_23 )
return - V_109 ;
...
static int F_81 ( struct V_105 * V_23 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
...
F_47 ( & V_3 -> V_26 , V_107 ) ;
F_37 ( V_73 , V_52 ) ;
V_147 = F_27 ( V_34 , V_94 ) ;
F_55 ( & V_3 -> V_26 , V_107 ) ;
}
return V_147 ;
}
static void F_82 ( struct V_105 * V_23 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
struct V_3 * V_3 = V_4 -> V_3 ;
T_3 V_52 = V_4 -> V_36 ;
...
{
struct V_3 * V_3 = F_84 ( V_149 ) ;
return ( int ) F_27 ( V_3 -> V_74 , V_150 ) ;
}
...
int V_153 ;
F_47 ( & V_3 -> V_26 , V_107 ) ;
switch ( V_3 -> V_154 -> V_155 -> V_156 ) {
case V_157 :
if ( V_3 -> V_158 && V_3 -> V_159 )
break;
goto V_144;
case V_160 :
V_152 = F_86 ( V_74 , V_161 ) ;
F_20 ( V_3 , L_46 , V_152 ) ;
V_152 |= V_162 ;
F_87 ( V_74 , V_161 , V_152 ) ;
V_152 = F_86 ( V_74 , V_161 ) ;
V_153 = 100 ;
while ( ! ( V_152 & V_162 ) ) {
V_152 = F_86 ( V_74 , V_161 ) ;
...
default:
F_20 ( V_3 , L_47 ,
F_91 ( V_3 -> V_154 -> V_155 -> V_156 ) ) ;
goto V_144;
}
V_25 = 0 ;
V_151 = F_86 ( V_74 , V_165 ) ;
V_151 |= V_166 ;
F_87 ( V_74 , V_165 , V_151 ) ;
F_20 ( V_3 , L_48 ) ;
F_92 ( 2 ) ;
V_151 = F_86 ( V_74 , V_165 ) ;
V_151 &= ~ V_166 ;
...
static int
F_93 ( struct V_148 * V_149 , int V_167 )
{
V_149 -> V_167 = ! ! V_167 ;
return 0 ;
}
static void F_94 ( struct V_3 * V_3 , int V_168 )
{
T_3 V_151 ;
V_151 = F_86 ( V_3 -> V_74 , V_165 ) ;
if ( V_168 )
V_151 |= V_169 ;
else
V_151 &= ~ V_169 ;
F_20 ( V_3 , L_49 ,
V_168 ? L_50 : L_51 ) ;
F_87 ( V_3 -> V_74 , V_165 , V_151 ) ;
}
static int F_95 ( struct V_148 * V_149 , unsigned V_170 )
{
struct V_3 * V_3 = F_84 ( V_149 ) ;
if ( ! V_3 -> V_154 -> V_171 )
return - V_172 ;
return F_96 ( V_3 -> V_154 , V_170 ) ;
}
static void F_97 ( struct V_173 * V_174 )
{
struct V_3 * V_3 ;
unsigned long V_107 ;
V_3 = F_98 ( V_174 , struct V_3 , V_175 . V_174 ) ;
F_99 ( V_3 -> V_17 ) ;
F_47 ( & V_3 -> V_26 , V_107 ) ;
F_94 ( V_3 , V_3 -> V_176 ) ;
F_55 ( & V_3 -> V_26 , V_107 ) ;
...
static int F_100 ( struct V_148 * V_149 , int V_168 )
{
struct V_3 * V_3 = F_84 ( V_149 ) ;
unsigned long V_107 ;
V_168 = ! ! V_168 ;
...
static struct V_105 * F_101 ( struct V_148 * V_31 ,
struct V_106 * V_56 ,
struct V_177 * V_178 )
{
...
case V_179 :
if ( F_51 ( V_56 ) )
V_23 = F_102 ( V_31 , L_52 ) ;
else
V_23 = F_102 ( V_31 , L_53 ) ;
break;
case V_128 :
if ( F_51 ( V_56 ) )
V_23 = F_102 ( V_31 , L_54 ) ;
else
V_23 = F_102 ( V_31 , L_55 ) ;
break;
default:
break;
}
if ( V_23 && F_103 ( V_31 , V_23 , V_56 , V_178 ) )
return V_23 ;
return NULL ;
}
static void
F_104 ( struct V_3 * V_3 , struct V_4 * V_23 , T_3 V_52 , int V_40 )
{
struct V_82 * V_50 = V_3 -> V_35 + V_52 ;
...
V_23 -> V_40 = V_40 ;
F_105 ( & V_23 -> V_49 ) ;
sprintf ( V_23 -> V_47 , L_56 , V_52 ,
( ! V_52 || V_50 -> V_84 ) ? L_21 : (
V_40 ? L_57 : L_58 ) ) ;
V_23 -> V_33 . V_47 = V_23 -> V_47 ;
F_105 ( & V_23 -> V_33 . V_180 ) ;
if ( ! V_52 ) {
F_106 ( & V_23 -> V_33 , 64 ) ;
V_23 -> V_33 . V_181 . V_182 = true ;
V_23 -> V_33 . V_183 = & V_184 ;
V_3 -> V_31 . V_185 = & V_23 -> V_33 ;
} else {
if ( V_40 )
F_106 ( & V_23 -> V_33 , V_50 -> V_51 ) ;
else
F_106 ( & V_23 -> V_33 , V_50 -> V_122 ) ;
V_23 -> V_33 . V_181 . V_186 = true ;
V_23 -> V_33 . V_181 . V_187 = true ;
V_23 -> V_33 . V_181 . V_188 = true ;
V_23 -> V_33 . V_183 = & V_189 ;
F_71 ( & V_23 -> V_33 . V_180 , & V_3 -> V_31 . V_180 ) ;
}
if ( ! V_52 || V_50 -> V_84 ) {
V_23 -> V_33 . V_181 . V_190 = true ;
V_23 -> V_33 . V_181 . V_191 = true ;
} else if ( V_40 )
V_23 -> V_33 . V_181 . V_190 = true ;
else
V_23 -> V_33 . V_181 . V_191 = true ;
}
static inline void F_107 ( struct V_3 * V_3 )
{
T_3 V_52 ;
struct V_82 * V_50 ;
unsigned V_192 = 0 ;
F_105 ( & ( V_3 -> V_31 . V_180 ) ) ;
for ( V_52 = 0 , V_50 = V_3 -> V_35 ;
V_52 < V_3 -> V_193 ;
V_52 ++ , V_50 ++ ) {
if ( V_50 -> V_84 ) {
F_104 ( V_3 , & V_50 -> V_75 , V_52 , 0 ) ;
V_192 ++ ;
} else {
if ( V_50 -> V_51 ) {
F_104 ( V_3 , & V_50 -> V_75 ,
...
int F_108 ( struct V_3 * V_3 )
{
int V_25 ;
V_3 -> V_31 . V_183 = & V_194 ;
V_3 -> V_31 . V_195 = V_196 ;
V_3 -> V_31 . V_197 = V_198 ;
F_109 ( V_3 ) ;
V_3 -> V_154 -> V_155 -> V_199 = 0 ;
V_3 -> V_154 -> V_155 -> V_156 = V_160 ;
V_3 -> V_31 . V_47 = V_200 ;
#if F_110 ( V_201 )
V_3 -> V_31 . V_202 = 1 ;
#elif F_110 ( V_203 )
V_3 -> V_31 . V_202 = 0 ;
#endif
F_111 ( & V_3 -> V_175 , F_97 ) ;
F_107 ( V_3 ) ;
V_3 -> V_204 = 0 ;
F_89 ( V_3 , 0 ) ;
V_25 = F_112 ( V_3 -> V_17 , & V_3 -> V_31 ) ;
if ( V_25 )
goto V_205;
return 0 ;
V_205:
V_3 -> V_31 . V_32 . V_206 = NULL ;
F_113 ( & V_3 -> V_31 . V_32 ) ;
return V_25 ;
}
...
static int F_117 ( struct V_148 * V_31 ,
struct V_209 * V_210 )
{
struct V_3 * V_3 = F_84 ( V_31 ) ;
struct V_211 * V_155 = V_3 -> V_154 -> V_155 ;
unsigned long V_107 ;
int V_147 = 0 ;
if ( V_210 -> V_195 < V_196 ) {
V_147 = - V_109 ;
goto V_205;
}
F_99 ( V_3 -> V_17 ) ;
...
F_47 ( & V_3 -> V_26 , V_107 ) ;
V_3 -> V_204 = 1 ;
F_118 ( V_155 , & V_3 -> V_31 ) ;
V_3 -> V_154 -> V_155 -> V_156 = V_160 ;
F_55 ( & V_3 -> V_26 , V_107 ) ;
F_119 ( V_3 ) ;
if ( V_3 -> V_154 -> V_213 == V_214 )
F_120 ( V_3 , 1 ) ;
F_73 ( V_3 -> V_17 ) ;
F_74 ( V_3 -> V_17 ) ;
return 0 ;
...
static int F_121 ( struct V_148 * V_31 )
{
struct V_3 * V_3 = F_84 ( V_31 ) ;
unsigned long V_107 ;
F_99 ( V_3 -> V_17 ) ;
F_47 ( & V_3 -> V_26 , V_107 ) ;
F_122 ( V_3 ) ;
( void ) F_95 ( & V_3 -> V_31 , 0 ) ;
V_3 -> V_154 -> V_155 -> V_156 = V_215 ;
F_123 ( V_3 ) ;
F_118 ( V_3 -> V_154 -> V_155 , NULL ) ;
V_3 -> V_204 = 0 ;
V_3 -> V_212 = NULL ;
F_89 ( V_3 , 0 ) ;
F_55 ( & V_3 -> V_26 , V_107 ) ;
...
case V_157 :
V_3 -> V_204 = 1 ;
if ( V_3 -> V_212 && V_3 -> V_212 -> V_217 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_212 -> V_217 ( & V_3 -> V_31 ) ;
F_17 ( & V_3 -> V_26 ) ;
}
break;
default:
...
{
T_3 V_152 ;
V_152 = F_86 ( V_3 -> V_74 , V_161 ) ;
F_20 ( V_3 , L_60 , V_152 ) ;
switch ( V_3 -> V_154 -> V_155 -> V_156 ) {
case V_160 :
if ( ( V_152 & V_218 ) == V_218 )
V_3 -> V_154 -> V_155 -> V_156 = V_157 ;
break;
case V_157 :
V_3 -> V_159 = 1 ;
if ( V_3 -> V_212 && V_3 -> V_212 -> V_219 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_212 -> V_219 ( & V_3 -> V_31 ) ;
F_17 ( & V_3 -> V_26 ) ;
}
break;
default:
...
{
void T_2 * V_74 = V_3 -> V_74 ;
T_3 V_152 = F_86 ( V_74 , V_161 ) ;
F_20 ( V_3 , L_62 , V_152 ) ;
F_87 ( V_74 , V_161 , V_152 & V_162 ) ;
( void ) F_95 ( & V_3 -> V_31 , 0 ) ;
V_3 -> V_31 . V_197 = V_198 ;
if ( V_3 -> V_212 && V_3 -> V_212 -> V_220 ) {
F_14 ( & V_3 -> V_26 ) ;
V_3 -> V_212 -> V_220 ( & V_3 -> V_31 ) ;
F_17 ( & V_3 -> V_26 ) ;
}
switch ( V_3 -> V_154 -> V_155 -> V_156 ) {
default:
F_20 ( V_3 , L_63 ,
F_91 ( V_3 -> V_154 -> V_155 -> V_156 ) ) ;
V_3 -> V_154 -> V_155 -> V_156 = V_221 ;
F_129 ( V_3 ) ;
break;
case V_222 :
V_3 -> V_154 -> V_155 -> V_156 = V_223 ;
F_129 ( V_3 ) ;
break;
case V_216 :
case V_224 :
...
{
void T_2 * V_73 = V_3 -> V_74 ;
T_3 V_152 = F_86 ( V_73 , V_161 ) ;
T_3 V_151 ;
F_20 ( V_3 , L_64 ,
( V_152 & V_226 )
? L_65 : L_66 ,
V_3 -> V_212
? V_3 -> V_212 -> V_210 . V_47
: NULL
) ;
if ( V_3 -> V_212 && V_3 -> V_31 . V_197 != V_198 ) {
F_14 ( & V_3 -> V_26 ) ;
F_131 ( & V_3 -> V_31 , V_3 -> V_212 ) ;
F_17 ( & V_3 -> V_26 ) ;
}
else if ( V_152 & V_227 )
F_87 ( V_73 , V_161 , V_162 ) ;
V_151 = F_86 ( V_73 , V_165 ) ;
V_3 -> V_31 . V_197 = ( V_151 & V_228 )
? V_196 : V_229 ;
V_3 -> V_204 = 1 ;
V_3 -> V_159 = 0 ;
F_109 ( V_3 ) ;
...
V_3 -> V_154 -> V_155 -> V_156 = V_222 ;
V_3 -> V_31 . V_237 = 1 ;
}
( void ) F_95 ( & V_3 -> V_31 , 8 ) ;
}
