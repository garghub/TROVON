...
static void F_89 ( struct V_15 * V_17 )
{
F_90 ( V_17 ) ;
F_91 ( V_17 ) ;
}
...
int V_32 ;
V_19 -> V_219 = F_93 ( V_218 ,
V_35 -> V_97 ) ;
if ( V_19 -> V_219 == 0 )
return - V_220 ;
F_94 ( & V_7 -> V_19 ,
& V_221 ) ;
V_32 = F_95 ( V_218 , & V_7 -> V_19 , & V_222 ,
V_223 , NULL ) ;
if ( V_32 ) {
F_19 ( V_35 , L_19 ) ;
return V_32 ;
...
{
struct V_226 * V_227 = V_7 -> V_35 -> V_97 ;
V_7 -> V_199 = F_100 ( V_227 , L_20 ) ;
if ( F_101 ( V_7 -> V_199 ) ) {
F_19 ( V_7 -> V_35 , L_21 ) ;
return F_102 ( V_7 -> V_199 ) ;
}
return 0 ;
}
static enum V_213 F_103 (
struct V_15 * V_17 ,
struct V_133 * V_10 )
{
if ( V_10 -> V_158 > 0x7ff )
...
static int F_104 ( struct V_89 * V_35 , struct V_89 * V_230 ,
void * V_231 )
{
const struct V_232 * V_233 =
F_105 ( V_234 , V_35 ) ;
const struct V_235 * V_90 = V_233 -> V_231 ;
struct V_236 * V_237 = F_106 ( V_35 ) ;
struct V_217 * V_218 = V_231 ;
struct V_6 * V_7 ;
struct V_238 * V_239 ;
int V_32 ;
V_7 = F_107 ( V_35 , sizeof( * V_7 ) , V_240 ) ;
if ( ! V_7 )
return - V_241 ;
V_7 -> V_35 = V_35 ;
V_7 -> V_90 = V_90 ;
...
if ( V_32 )
return V_32 ;
V_239 = F_108 ( V_237 , V_242 , 0 ) ;
if ( ! V_239 )
return - V_243 ;
V_7 -> V_22 = F_109 ( V_35 , V_239 ) ;
if ( F_101 ( V_7 -> V_22 ) )
return F_102 ( V_7 -> V_22 ) ;
V_7 -> V_86 = F_110 ( V_35 , L_22 ) ;
if ( F_101 ( V_7 -> V_86 ) ) {
V_32 = F_102 ( V_7 -> V_86 ) ;
F_19 ( V_35 , L_23 , V_32 ) ;
return V_32 ;
}
V_7 -> V_194 = F_110 ( V_35 , L_24 ) ;
if ( F_101 ( V_7 -> V_194 ) ) {
V_32 = F_102 ( V_7 -> V_194 ) ;
F_19 ( V_35 , L_25 , V_32 ) ;
return V_32 ;
}
V_32 = F_72 ( V_7 -> V_86 ) ;
...
F_111 ( V_35 , V_7 ) ;
V_7 -> V_14 . V_245 = & V_246 ;
V_7 -> V_14 . V_35 = V_35 ;
return F_112 ( & V_7 -> V_14 ) ;
V_244:
F_74 ( V_7 -> V_86 ) ;
return V_32 ;
}
static void F_113 ( struct V_89 * V_35 , struct V_89 * V_230 ,
void * V_231 )
{
struct V_6 * V_7 = F_114 ( V_35 ) ;
F_115 ( & V_7 -> V_14 ) ;
F_74 ( V_7 -> V_86 ) ;
}
static int F_116 ( struct V_236 * V_237 )
{
return F_117 ( & V_237 -> V_35 , & V_247 ) ;
}
static int F_118 ( struct V_236 * V_237 )
{
F_119 ( & V_237 -> V_35 , & V_247 ) ;
return 0 ;
}
