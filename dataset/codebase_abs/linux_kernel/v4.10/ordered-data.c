...
V_116 = F_107 ( T_1 , V_15 , V_117 ) ;
if ( V_74 && V_74 -> V_120 > V_116 )
V_116 = F_107 ( T_1 , V_74 -> V_120 , V_117 ) ;
F_16 ( V_13 ) -> V_115 = V_116 ;
V_26 = 0 ;
V_68:
if ( V_74 )
F_19 ( V_121 , & V_74 -> V_41 ) ;
F_26 ( & V_25 -> V_51 ) ;
return V_26 ;
}
int F_108 ( struct V_13 * V_13 , T_1 V_15 , T_1 V_122 ,
T_3 * V_61 , int V_4 )
{
struct V_60 * V_123 ;
struct V_1 * V_74 ;
...
unsigned long V_124 ;
unsigned long V_125 ;
T_3 V_126 = F_106 ( V_13 ) ;
int V_76 = 0 ;
V_74 = F_100 ( V_13 , V_15 ) ;
if ( ! V_74 )
return 0 ;
F_25 ( & V_25 -> V_51 ) ;
F_109 (ordered_sum, &ordered->list, list) {
if ( V_122 >= V_123 -> V_127 &&
V_122 < V_123 -> V_127 + V_123 -> V_4 ) {
V_125 = ( V_122 - V_123 -> V_127 ) >>
V_13 -> V_18 -> V_128 ;
V_124 = V_123 -> V_4 >>
V_13 -> V_18 -> V_128 ;
V_124 = F_107 ( int , V_4 - V_76 , V_124 - V_125 ) ;
memcpy ( V_61 + V_76 , V_123 -> V_129 + V_125 ,
V_124 ) ;
V_76 += ( int ) V_124 ;
if ( V_76 == V_4 )
goto V_68;
