...
V_81 = ( V_51 / 4 ) ;
if ( V_81 ) {
F_35 ( & V_84 , V_79 + V_9 -> V_3 , V_81 * 4 ) ;
if ( F_14 ( V_2 , & V_84 ) ) {
F_16 ( V_2 -> V_23 , L_10 ) ;
V_9 -> V_14 |= V_53 ;
V_2 -> V_43 = 0 ;
F_10 ( V_2 , V_79 + V_9 -> V_3 ,
V_81 * 4 , 0 ) ;
V_9 -> V_85 += V_81 * 4 ;
V_81 = 0 ;
} else {
...
if ( V_80 ) {
V_9 -> V_35 = F_36 ( V_9 -> V_86 , V_9 -> V_87 ,
V_9 -> V_30 , V_80 , V_9 -> V_85 ) ;
V_83 = 0 ;
V_9 -> V_36 = F_37 ( V_9 -> V_36 ) ;
while ( V_9 -> V_36 && ( V_9 -> V_35 < 4 ) ) {
V_82 = V_9 -> V_36 -> V_26 ;
if ( F_38 ( V_82 > ( 4 - V_9 -> V_35 ) ) )
V_82 = 4 - V_9 -> V_35 ;
V_83 = F_36 ( V_9 -> V_86 , V_9 -> V_87 ,
V_9 -> V_30 + V_9 -> V_35 , V_82 ,
V_9 -> V_85 + V_9 -> V_35 ) ;
V_9 -> V_35 += V_83 ;
if ( V_83 >= V_9 -> V_36 -> V_26 ) {
V_9 -> V_36 = F_37 ( V_9 -> V_36 ) ;
V_83 = 0 ;
}
}
...
struct V_8 * V_9 = F_8 ( V_2 -> V_10 ) ;
if ( V_9 -> V_14 & V_88 )
F_18 ( V_2 -> V_23 , V_9 -> V_36 , V_9 -> V_41 , V_89 ) ;
return 0 ;
}
...
V_105 -> V_107 . V_64 . V_14 = V_10 -> V_64 . V_14
& V_109 ;
...
static int F_61 ( struct V_54 * V_10 , const void * V_117 )
{
struct V_8 * V_105 = F_8 ( V_10 ) ;
struct V_103 * V_104 = F_43 ( V_10 ) ;
struct V_106 * V_9 = F_44 ( V_104 ) ;
...
static int F_63 ( struct V_54 * V_10 , void * V_118 )
{
struct V_8 * V_105 = F_8 ( V_10 ) ;
struct V_103 * V_104 = F_43 ( V_10 ) ;
struct V_106 * V_9 = F_44 ( V_104 ) ;
...
static int F_65 ( struct V_54 * V_10 )
{
struct V_103 * V_104 = F_43 ( V_10 ) ;
...
{
int V_59 , V_43 ;
for ( V_59 = 0 ; V_59 < F_87 ( V_140 ) ; V_59 ++ ) {
V_43 = F_88 ( & V_140 [ V_59 ] ) ;
if ( V_43 )
goto V_141;
}
return 0 ;
