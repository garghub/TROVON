...
V_11 |= F_7 ( ( unsigned int V_45 * ) F_3 ( V_14 . V_13 ) ,
& V_2 -> V_44 ) ;
V_11 |= F_6 ( V_14 . V_12 , & V_32 -> V_46 ) ;
V_11 |= F_7 ( V_14 . V_12 , & V_2 -> V_46 ) ;
V_11 |= F_6 ( V_14 . V_13 , & V_32 -> V_47 ) ;
V_11 |= F_7 ( F_3 ( V_14 . V_13 ) , & V_2 -> V_47 ) ;
V_11 |= F_6 ( V_14 . V_12 , & V_32 -> V_48 ) ;
V_11 |= F_7 ( V_14 . V_12 , & V_2 -> V_48 ) ;
return V_11 ? - V_17 : 0 ;
}
...
V_11 |= F_6 ( V_14 , & V_2 -> V_46 ) ;
V_11 |= F_7 ( V_14 , & V_32 -> V_46 ) ;
V_11 |= F_6 ( V_14 , & V_2 -> V_48 ) ;
V_11 |= F_7 ( V_14 , & V_32 -> V_48 ) ;
return V_11 ? - V_17 : 0 ;
}
...
if ( V_49 )
return V_49 ;
V_49 = F_1 ( V_1 , V_50 , ( unsigned long ) V_2 ) ;
if ( V_49 == - V_51 ) {
V_11 = F_10 ( V_32 , V_2 ) ;
if ( V_11 )
V_49 = V_11 ;
...
if ( V_49 )
return V_49 ;
V_49 = F_1 ( V_1 , V_52 , ( unsigned long ) V_2 ) ;
if ( V_49 < 0 )
return V_49 ;
V_11 = F_10 ( V_32 , V_2 ) ;
if ( V_11 )
...
static int F_13 ( struct V_53 T_1 * V_54 ,
...
V_11 = 0 ;
if ( ! F_5 ( V_15 , V_56 , sizeof( * V_56 ) ) ||
! F_5 ( V_16 , V_54 , sizeof( * V_54 ) ) )
return - V_17 ;
V_11 |= F_6 ( V_14 . V_12 , & V_56 -> V_54 ) ;
V_11 |= F_7 ( V_14 . V_12 , & V_54 -> V_54 ) ;
V_11 |= F_6 ( V_14 . V_12 , & V_56 -> V_57 ) ;
V_11 |= F_7 ( V_14 . V_12 , & V_54 -> V_57 ) ;
V_11 |= F_6 ( V_14 . V_13 , & V_56 -> V_47 ) ;
V_11 |= F_7 ( F_3 ( V_14 . V_13 ) , & V_54 -> V_47 ) ;
V_11 |= F_6 ( V_14 . V_12 , & V_56 -> V_18 ) ;
V_11 |= F_7 ( V_14 . V_12 , & V_54 -> V_18 ) ;
V_11 |= F_6 ( V_14 . V_12 , & V_56 -> V_58 ) ;
V_11 |= F_7 ( V_14 . V_12 , & V_54 -> V_58 ) ;
return V_11 ? - V_17 : 0 ;
}
...
struct V_55 T_1 * V_56 ;
T_2 V_13 ;
unsigned int V_65 , V_57 ;
int V_11 , V_49 ;
V_64 = F_3 ( V_3 ) ;
if ( ! F_5 ( V_15 , V_64 , sizeof( * V_64 ) ) )
return - V_17 ;
V_11 = 0 ;
V_11 |= F_6 ( V_65 , & V_64 -> V_65 ) ;
V_11 |= F_6 ( V_13 , & V_64 -> V_66 ) ;
V_56 = F_3 ( V_13 ) ;
if ( V_11 )
return - V_17 ;
V_62 = F_4 ( F_15 ( struct V_59 ,
V_54 [ V_65 ] ) ) ;
if ( ! F_5 ( V_16 , & V_62 -> V_61 , sizeof( V_62 -> V_61 ) ) )
return - V_17 ;
V_11 |= F_7 ( V_65 , & V_62 -> V_61 . V_65 ) ;
V_11 |= F_7 ( & V_62 -> V_54 [ 0 ] , & V_62 -> V_61 . V_66 ) ;
if ( V_11 )
return - V_17 ;
for ( V_57 = 0 ; V_57 < V_65 ; V_57 ++ ) {
V_49 = F_13 ( & V_62 -> V_54 [ V_57 ] , & V_56 [ V_57 ] ) ;
if ( V_49 )
return V_49 ;
}
return F_1 ( V_1 , V_67 ,
...
int V_49 ;
V_56 = F_3 ( V_3 ) ;
V_54 = F_4 ( sizeof( * V_54 ) ) ;
V_49 = F_13 ( V_54 , V_56 ) ;
if ( V_49 )
return V_49 ;
return F_1 ( V_1 , V_68 , ( unsigned long ) V_54 ) ;
}
