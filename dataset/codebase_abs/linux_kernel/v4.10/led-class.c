...
static void F_44 ( struct V_1 * V_2 , void * V_40 )
{
F_37 ( * (struct V_6 * * ) V_40 ) ;
}
...
struct V_6 * * V_41 ;
int V_42 ;
V_41 = F_46 ( F_44 , sizeof( * V_41 ) , V_43 ) ;
if ( ! V_41 )
return - V_27 ;
V_42 = F_23 ( V_28 , V_7 ) ;
if ( V_42 ) {
...
static int F_49 ( struct V_1 * V_2 , void * V_40 , void * V_21 )
{
struct V_7 * * V_44 = V_40 ;
if ( F_50 ( ! V_44 || ! * V_44 ) )
return 0 ;
return * V_44 == V_21 ;
}
