...
static int F_51 ( struct V_59 * V_66 )
{
struct V_5 * V_6 ;
struct V_28 * V_29 ;
int V_67 = V_66 -> V_68 ;
...
if ( ! V_76 [ V_67 ] )
return - V_77 ;
V_42 = F_52 ( & V_66 -> V_67 , V_78 [ V_67 ] , V_68 [ V_67 ] , V_79 ,
0 , & V_4 ) ;
if ( V_42 < 0 ) {
F_53 ( L_3 ) ;
return V_42 ;
}
strcpy ( V_4 -> V_80 , V_64 ) ;
strcpy ( V_4 -> V_81 , V_43 ) ;
sprintf ( V_4 -> V_82 , L_4 ,
V_4 -> V_81 , V_29 -> V_83 , V_29 -> V_84 ) ;
V_70 . V_85 = V_4 ;
V_6 = F_54 ( V_29 ,
V_64 ,
& V_70 ,
...
static int F_58 ( struct V_59 * V_66 )
{
struct V_3 * V_4 = F_44 ( V_66 ) ;
if ( V_4 )
F_57 ( V_4 ) ;
return 0 ;
}
