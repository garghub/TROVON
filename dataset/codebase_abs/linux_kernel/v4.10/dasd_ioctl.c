...
static int F_39 ( struct V_18 * V_15 ,
struct V_48 * V_49 )
{
struct V_6 * V_7 ;
int V_36 ;
...
if ( ! V_7 -> V_37 -> V_50 )
return - V_51 ;
V_36 = V_7 -> V_37 -> V_50 ( V_7 , V_49 , 1 ) ;
if ( V_36 == - V_47 )
V_36 = V_7 -> V_37 -> V_50 ( V_7 , V_49 , 0 ) ;
return V_36 ;
}
static int
F_40 ( struct V_4 * V_5 , void T_1 * V_1 )
{
struct V_6 * V_7 ;
struct V_34 V_35 ;
int V_36 ;
...
if ( F_41 ( & V_35 , V_1 , sizeof( struct V_34 ) ) ) {
F_11 ( V_7 ) ;
return - V_57 ;
}
if ( V_5 != V_5 -> V_58 ) {
...
static int F_42 ( struct V_4 * V_5 , void T_1 * V_1 )
{
struct V_48 V_49 ;
struct V_6 * V_7 ;
int V_36 = 0 ;
...
if ( F_41 ( & V_49 , V_1 , sizeof( V_49 ) ) ) {
V_36 = - V_57 ;
goto V_59;
}
V_36 = F_39 ( V_7 -> V_15 , & V_49 ) ;
if ( V_36 )
goto V_59;
if ( F_43 ( V_1 , & V_49 , sizeof( V_49 ) ) )
V_36 = - V_57 ;
V_59:
F_11 ( V_7 ) ;
return V_36 ;
}
static int F_44 ( struct V_18 * V_15 )
{
F_45 ( & V_15 -> V_60 ) ;
return 0 ;
}
static int F_46 ( struct V_18 * V_15 , void T_1 * V_1 )
{
struct V_61 * V_62 ;
int V_36 = 0 ;
...
static int F_51 ( struct V_18 * V_15 ,
...
int V_36 ;
V_7 = V_15 -> V_7 ;
if ( ! V_7 -> V_37 || ! V_7 -> V_37 -> V_86 )
return - V_52 ;
V_80 = F_52 ( sizeof( struct V_79 ) , V_63 ) ;
if ( V_80 == NULL )
return - V_64 ;
V_36 = V_7 -> V_37 -> V_86 ( V_7 , V_80 ) ;
if ( V_36 ) {
F_50 ( V_80 ) ;
return V_36 ;
}
...
V_80 -> V_53 |=
( ( V_7 -> V_53 & V_54 ) != 0 ) ;
memcpy ( V_80 -> type , V_7 -> V_37 -> V_101 , 4 ) ;
if ( V_15 -> V_102 -> V_103 ) {
struct V_104 * V_105 ;
#ifdef F_57
{
struct V_104 * V_105 ;
F_17 ( & V_15 -> V_65 , V_19 ) ;
F_58 (l, &block->request_queue->queue_head)
V_80 -> V_106 ++ ;
F_20 ( & V_15 -> V_65 , V_19 ) ;
}
#endif
F_17 ( F_18 ( V_7 -> V_20 ) , V_19 ) ;
F_58 (l, &base->ccw_queue)
V_80 -> V_107 ++ ;
F_20 ( F_18 ( V_7 -> V_20 ) ,
V_19 ) ;
}
...
static int
F_59 ( struct V_4 * V_5 , void T_1 * V_1 )
{
struct V_6 * V_7 ;
int V_110 , V_36 ;
if ( ! F_4 ( V_8 ) )
...
if ( V_5 != V_5 -> V_58 )
return - V_52 ;
if ( F_60 ( V_110 , ( int T_1 * ) V_1 ) )
return - V_57 ;
V_7 = F_5 ( V_5 -> V_10 ) ;
if ( ! V_7 )
return - V_11 ;
if ( ! V_110 && F_29 ( V_55 , & V_7 -> V_19 ) ) {
F_11 ( V_7 ) ;
return - V_56 ;
}
F_61 ( V_5 -> V_10 , V_110 ) ;
V_36 = F_62 ( V_7 -> V_20 , V_54 , V_110 ) ;
F_11 ( V_7 ) ;
return V_36 ;
}
static int F_63 ( struct V_18 * V_15 , unsigned int V_78 ,
struct V_111 T_1 * V_1 )
{
T_2 V_112 = F_64 ( V_78 ) ;
struct V_111 V_62 ;
int V_113 ;
V_113 = F_65 ( V_15 -> V_7 -> V_20 , & V_62 ) ;
if ( ! V_113 && F_43 ( V_1 , & V_62 , F_66 ( V_112 , sizeof( * V_1 ) ) ) )
return - V_57 ;
return V_113 ;
}
int F_67 ( struct V_4 * V_5 , T_3 V_114 ,
...
break;
case V_132 :
V_36 = F_63 ( V_15 , V_78 , V_1 ) ;
break;
default:
V_36 = - V_51 ;
if ( V_7 -> V_37 -> V_133 )
V_36 = V_7 -> V_37 -> V_133 ( V_15 , V_78 , V_1 ) ;
}
F_11 ( V_7 ) ;
return V_36 ;
}
