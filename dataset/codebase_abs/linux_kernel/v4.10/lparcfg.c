...
static T_2 F_45 ( T_3 * V_13 , T_4 * V_18 )
{
struct V_7 V_8 ;
T_4 V_88 ;
T_3 V_89 ;
...
F_46 ( L_62 ,
V_56 , V_89 , V_88 ) ;
V_90 = F_47 ( V_92 , V_89 , V_88 ) ;
return V_90 ;
}
static T_2 F_48 ( T_3 * V_13 , T_4 * V_18 )
{
struct V_35 V_36 ;
T_3 V_89 ;
T_4 V_88 ;
...
F_46 ( L_62 ,
V_56 , V_89 , V_88 ) ;
V_9 = F_47 ( V_93 , V_89 , V_88 ) ;
return V_9 ;
}
static T_2 F_50 ( struct V_94 * V_94 , const char T_5 * V_95 ,
T_6 V_67 , T_7 * V_96 )
{
int V_97 = 64 ;
char V_98 [ V_97 ] ;
...
if ( ! strcmp ( V_98 , L_64 ) ) {
char * V_103 ;
* V_100 = ( T_3 ) F_52 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_45 ( V_100 , NULL ) ;
} else if ( ! strcmp ( V_98 , L_65 ) ) {
char * V_103 ;
* V_101 = ( T_4 ) F_52 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_45 ( NULL , V_101 ) ;
} else if ( ! strcmp ( V_98 , L_66 ) ) {
char * V_103 ;
* V_100 = ( T_3 ) F_52 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_48 ( V_100 , NULL ) ;
} else if ( ! strcmp ( V_98 , L_67 ) ) {
char * V_103 ;
* V_101 = ( T_4 ) F_52 ( V_99 , & V_103 , 10 ) ;
if ( V_103 == V_99 )
return - V_91 ;
V_90 = F_48 ( NULL , V_101 ) ;
} else
return - V_91 ;
...
static int F_53 ( struct V_29 * V_30 , void * V_79 )
{
struct V_31 * V_110 ;
...
static int F_54 ( struct V_117 * V_117 , struct V_94 * V_94 )
{
return F_55 ( V_94 , F_53 , NULL ) ;
}
