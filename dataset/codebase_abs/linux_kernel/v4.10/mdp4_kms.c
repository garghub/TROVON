...
V_12 = F_48 ( V_71 -> V_84 [ V_77 ] , V_5 , V_75 ) ;
if ( V_12 ) {
F_10 ( V_5 -> V_5 , L_12 ,
V_12 ) ;
return V_12 ;
...
V_40 = F_51 ( V_5 , V_87 , V_71 -> V_98 , V_38 ,
V_92 [ V_38 ] ) ;
if ( F_42 ( V_40 ) ) {
F_10 ( V_5 -> V_5 , L_18 ,
V_93 [ V_38 ] ) ;
...
for ( V_38 = 0 ; V_38 < F_30 ( V_94 ) ; V_38 ++ ) {
V_12 = F_40 ( V_3 , V_94 [ V_38 ] ) ;
if ( V_12 ) {
F_10 ( V_5 -> V_5 , L_19 ,
V_38 , V_12 ) ;
goto V_95;
...
V_2 = & V_3 -> V_108 . V_108 ;
V_3 -> V_5 = V_5 ;
V_3 -> V_110 = F_56 ( V_101 , NULL , L_21 ) ;
if ( F_42 ( V_3 -> V_110 ) ) {
V_12 = F_43 ( V_3 -> V_110 ) ;
goto V_95;
}
...
V_3 -> V_11 = F_60 ( & V_101 -> V_5 , L_25 ) ;
if ( F_42 ( V_3 -> V_11 ) ) {
F_10 ( V_5 -> V_5 , L_26 ) ;
V_12 = F_43 ( V_3 -> V_11 ) ;
goto V_95;
}
V_3 -> V_61 = F_60 ( & V_101 -> V_5 , L_27 ) ;
if ( F_42 ( V_3 -> V_61 ) )
V_3 -> V_61 = NULL ;
V_3 -> V_62 = F_60 ( & V_101 -> V_5 , L_28 ) ;
if ( F_42 ( V_3 -> V_62 ) ) {
F_10 ( V_5 -> V_5 , L_29 ) ;
V_12 = F_43 ( V_3 -> V_62 ) ;
goto V_95;
}
V_3 -> V_63 = F_60 ( & V_101 -> V_5 , L_30 ) ;
if ( F_42 ( V_3 -> V_63 ) ) {
F_10 ( V_5 -> V_5 , L_31 ) ;
V_12 = F_43 ( V_3 -> V_63 ) ;
goto V_95;
}
F_61 ( V_3 -> V_11 , V_104 -> V_112 ) ;
F_61 ( V_3 -> V_62 , V_104 -> V_112 ) ;
F_62 ( V_5 -> V_5 ) ;
V_3 -> V_60 = true ;
F_5 ( V_3 ) ;
F_11 ( V_3 , V_113 , 0 ) ;
...
V_3 -> V_52 = V_52 ;
V_12 = V_52 -> V_56 -> V_57 -> V_117 ( V_52 -> V_56 , V_59 ,
F_30 ( V_59 ) ) ;
if ( V_12 )
goto V_95;
} else {
...
static struct V_103 * F_53 ( struct V_100 * V_5 )
{
static struct V_103 V_104 = {} ;
V_104 . V_112 = 266667000 ;
V_104 . V_116 = F_72 ( & V_125 ) ;
if ( V_104 . V_116 ) {
V_104 . V_116 -> V_126 . V_127 = 0x1000 ;
V_104 . V_116 -> V_126 . V_128 = 0xffffffff ;
}
return & V_104 ;
}
