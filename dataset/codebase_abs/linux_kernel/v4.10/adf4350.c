...
static int F_42 ( struct V_97 * V_13 )
{
struct V_24 * V_25 ;
struct V_16 * V_17 ;
struct V_1 * V_2 ;
...
V_17 = F_47 ( & V_13 -> V_14 , sizeof( * V_2 ) ) ;
if ( V_17 == NULL ) {
V_3 = - V_101 ;
goto V_102;
}
V_2 = F_6 ( V_17 ) ;
V_2 -> V_18 = F_48 ( & V_13 -> V_14 , L_33 ) ;
if ( ! F_45 ( V_2 -> V_18 ) ) {
V_3 = F_49 ( V_2 -> V_18 ) ;
if ( V_3 )
goto V_102;
...
V_2 -> V_39 = F_51 ( V_13 ) -> V_111 == 4351 ?
V_112 : V_113 ;
memset ( V_2 -> V_8 , 0xFF , sizeof( V_2 -> V_8 ) ) ;
if ( F_34 ( V_25 -> V_86 ) ) {
V_3 = F_52 ( & V_13 -> V_14 , V_25 -> V_86 ,
V_17 -> V_93 ) ;
if ( V_3 ) {
F_53 ( & V_13 -> V_14 , L_34 ,
V_25 -> V_86 ) ;
...
static int F_58 ( struct V_97 * V_13 )
{
struct V_16 * V_17 = F_59 ( V_13 ) ;
struct V_1 * V_2 = F_6 ( V_17 ) ;
struct V_115 * V_18 = V_2 -> V_18 ;
V_2 -> V_9 [ V_51 ] |= V_85 ;
F_1 ( V_2 ) ;
F_60 ( V_17 ) ;
if ( V_2 -> V_82 )
