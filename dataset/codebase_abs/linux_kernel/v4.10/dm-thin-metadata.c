...
T_2 V_105 = V_124 ;
struct V_60 V_127 ;
F_80 (td2, &pmd->thin_devices, list)
if ( V_126 -> V_107 == V_124 ) {
if ( V_125 )
return - V_128 ;
V_126 -> V_112 ++ ;
* V_102 = V_126 ;
...
V_106 = 1 ;
V_127 . V_108 = 0 ;
V_127 . V_109 = F_3 ( V_37 -> V_74 ) ;
V_127 . V_110 = F_5 ( V_37 -> time ) ;
V_127 . V_111 = F_5 ( V_37 -> time ) ;
}
* V_102 = F_70 ( sizeof( * * V_102 ) , V_130 ) ;
if ( ! * V_102 )
return - V_85 ;
( * V_102 ) -> V_37 = V_37 ;
( * V_102 ) -> V_107 = V_124 ;
...
( * V_102 ) -> V_106 = V_106 ;
( * V_102 ) -> V_131 = false ;
( * V_102 ) -> V_108 = F_8 ( V_127 . V_108 ) ;
( * V_102 ) -> V_109 = F_8 ( V_127 . V_109 ) ;
( * V_102 ) -> V_110 = F_10 ( V_127 . V_110 ) ;
( * V_102 ) -> V_111 = F_10 ( V_127 . V_111 ) ;
F_82 ( & ( * V_102 ) -> V_113 , & V_37 -> V_119 ) ;
return 0 ;
}
...
if ( V_44 ) {
F_21 ( & V_37 -> V_58 , V_132 ) ;
return V_44 ;
}
V_44 = F_79 ( V_37 , V_124 , 1 , & V_102 ) ;
if ( V_44 ) {
F_85 ( & V_37 -> V_57 , V_37 -> V_34 , & V_105 , & V_37 -> V_34 ) ;
F_21 ( & V_37 -> V_58 , V_132 ) ;
return V_44 ;
}
F_83 ( V_102 ) ;
...
int F_86 ( struct V_36 * V_37 , T_7 V_124 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_84 ( V_37 , V_124 ) ;
F_88 ( & V_37 -> V_118 ) ;
return V_44 ;
}
...
int V_44 ;
struct V_101 * V_102 ;
V_44 = F_79 ( V_37 , V_134 , 0 , & V_102 ) ;
if ( V_44 )
return V_44 ;
V_102 -> V_106 = 1 ;
V_102 -> V_111 = time ;
V_133 -> V_108 = V_102 -> V_108 ;
V_133 -> V_111 = time ;
F_83 ( V_102 ) ;
return 0 ;
}
...
if ( ! V_44 )
return - V_128 ;
V_44 = F_81 ( & V_37 -> V_57 , V_37 -> V_34 , & V_105 , & V_30 ) ;
if ( V_44 )
return V_44 ;
V_135 = F_8 ( V_30 ) ;
F_19 ( V_37 -> V_35 , V_135 ) ;
V_30 = F_3 ( V_135 ) ;
F_63 ( & V_30 ) ;
V_105 = V_124 ;
V_44 = F_64 ( & V_37 -> V_57 , V_37 -> V_34 , & V_105 , & V_30 , & V_37 -> V_34 ) ;
if ( V_44 ) {
F_91 ( V_37 -> V_35 , V_135 ) ;
return V_44 ;
}
V_37 -> time ++ ;
V_44 = F_79 ( V_37 , V_124 , 1 , & V_102 ) ;
if ( V_44 )
goto V_137;
V_44 = F_89 ( V_37 , V_102 , V_134 , V_37 -> time ) ;
F_83 ( V_102 ) ;
if ( V_44 )
goto V_137;
return 0 ;
...
F_87 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_90 ( V_37 , V_124 , V_134 ) ;
F_88 ( & V_37 -> V_118 ) ;
return V_44 ;
}
static int F_93 ( struct V_36 * V_37 , T_7 V_124 )
{
int V_44 ;
T_2 V_105 = V_124 ;
struct V_101 * V_102 ;
V_44 = F_79 ( V_37 , V_124 , 0 , & V_102 ) ;
if ( V_44 )
return V_44 ;
if ( V_102 -> V_112 > 1 ) {
F_83 ( V_102 ) ;
...
F_65 ( & V_102 -> V_113 ) ;
F_66 ( V_102 ) ;
V_44 = F_85 ( & V_37 -> V_59 , V_37 -> V_78 ,
& V_105 , & V_37 -> V_78 ) ;
if ( V_44 )
return V_44 ;
V_44 = F_85 ( & V_37 -> V_57 , V_37 -> V_34 , & V_105 , & V_37 -> V_34 ) ;
if ( V_44 )
return V_44 ;
return 0 ;
}
...
int V_44 , V_52 ;
struct V_6 * V_7 ;
struct V_3 * V_141 , * V_38 ;
T_3 V_75 ;
F_67 ( V_37 ) ;
F_14 ( V_37 -> V_62 , V_40 ) ;
V_44 = F_98 ( V_37 -> V_35 , V_40 ,
& V_41 , & V_141 , & V_52 ) ;
if ( V_44 )
return V_44 ;
F_99 ( ! V_52 ) ;
...
V_44 = F_103 ( V_37 -> V_35 , V_75 , & V_41 , & V_141 ) ;
if ( V_44 )
return V_44 ;
V_7 = F_2 ( V_141 ) ;
F_21 ( & V_37 -> V_32 , F_8 ( V_7 -> V_76 ) ) ;
F_21 ( & V_37 -> V_59 , F_8 ( V_7 -> V_77 ) ) ;
F_16 ( V_37 -> V_62 , V_75 ) ;
F_100 ( V_37 -> V_35 , V_141 ) ;
return 0 ;
}
int F_104 ( struct V_36 * V_37 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
...
int F_106 ( struct V_36 * V_37 ,
T_3 * V_43 )
{
int V_44 = - V_91 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_105 ( V_37 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_107 ( struct V_36 * V_37 , T_7 V_124 ,
struct V_101 * * V_102 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
...
int F_108 ( struct V_101 * V_102 )
{
F_87 ( & V_102 -> V_37 -> V_118 ) ;
F_83 ( V_102 ) ;
F_88 ( & V_102 -> V_37 -> V_118 ) ;
return 0 ;
}
T_7 F_109 ( struct V_101 * V_102 )
{
return V_102 -> V_107 ;
}
static bool F_110 ( struct V_101 * V_102 , T_4 time )
{
return V_102 -> V_111 > time ;
}
static void F_111 ( struct V_101 * V_102 , T_5 V_30 ,
struct V_142 * V_43 )
{
T_2 V_143 = 0 ;
T_3 V_144 ;
T_4 V_145 ;
V_143 = F_8 ( V_30 ) ;
F_12 ( V_143 , & V_144 , & V_145 ) ;
V_43 -> V_146 = V_144 ;
V_43 -> V_147 = F_110 ( V_102 , V_145 ) ;
}
static int F_112 ( struct V_101 * V_102 , T_3 V_146 ,
int V_148 , struct V_142 * V_43 )
{
int V_44 ;
T_5 V_30 ;
struct V_36 * V_37 = V_102 -> V_37 ;
T_3 V_149 [ 2 ] = { V_102 -> V_107 , V_146 } ;
struct V_31 * V_32 ;
if ( V_148 ) {
V_32 = & V_37 -> V_32 ;
} else
V_32 = & V_37 -> V_55 ;
V_44 = F_81 ( V_32 , V_37 -> V_34 , V_149 , & V_30 ) ;
if ( ! V_44 )
F_111 ( V_102 , V_30 , V_43 ) ;
return V_44 ;
}
int F_113 ( struct V_101 * V_102 , T_3 V_146 ,
int V_148 , struct V_142 * V_43 )
{
int V_44 ;
struct V_36 * V_37 = V_102 -> V_37 ;
...
V_44 = F_112 ( V_102 , V_146 , V_148 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
static int F_114 ( struct V_101 * V_102 , T_3 V_146 ,
T_3 * V_150 ,
struct V_142 * V_43 )
{
int V_44 ;
...
struct V_36 * V_37 = V_102 -> V_37 ;
T_3 V_149 [ 2 ] = { V_102 -> V_107 , V_146 } ;
V_44 = F_115 ( & V_37 -> V_32 , V_37 -> V_34 , V_149 , V_150 , & V_30 ) ;
if ( ! V_44 )
F_111 ( V_102 , V_30 , V_43 ) ;
return V_44 ;
}
static int F_116 ( struct V_101 * V_102 ,
T_3 V_151 , T_3 V_152 ,
T_3 * V_153 , T_3 * V_154 ,
T_3 * V_155 , bool * V_156 )
{
int V_44 ;
T_3 V_157 ;
struct V_142 V_158 ;
if ( V_152 < V_151 )
return - V_129 ;
V_44 = F_114 ( V_102 , V_151 , & V_151 , & V_158 ) ;
if ( V_44 )
return V_44 ;
if ( V_151 >= V_152 )
return - V_129 ;
...
V_157 = * V_155 + 1 ;
while ( V_151 != V_152 ) {
V_44 = F_112 ( V_102 , V_151 , true , & V_158 ) ;
if ( V_44 ) {
if ( V_44 == - V_129 )
break;
else
...
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 ) {
V_44 = F_116 ( V_102 , V_151 , V_152 , V_153 , V_154 ,
V_155 , V_156 ) ;
}
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
static int F_118 ( struct V_101 * V_102 , T_3 V_146 ,
T_3 V_159 )
{
int V_44 , V_160 ;
T_5 V_30 ;
struct V_36 * V_37 = V_102 -> V_37 ;
T_3 V_149 [ 2 ] = { V_102 -> V_107 , V_146 } ;
V_30 = F_3 ( F_11 ( V_159 , V_37 -> time ) ) ;
F_63 ( & V_30 ) ;
V_44 = F_119 ( & V_37 -> V_32 , V_37 -> V_34 , V_149 , & V_30 ,
& V_37 -> V_34 , & V_160 ) ;
if ( V_44 )
return V_44 ;
V_102 -> V_106 = 1 ;
...
int F_120 ( struct V_101 * V_102 , T_3 V_146 ,
T_3 V_159 )
{
int V_44 = - V_91 ;
F_87 ( & V_102 -> V_37 -> V_118 ) ;
if ( ! V_102 -> V_37 -> V_120 )
V_44 = F_118 ( V_102 , V_146 , V_159 ) ;
F_88 ( & V_102 -> V_37 -> V_118 ) ;
return V_44 ;
}
static int F_121 ( struct V_101 * V_102 , T_3 V_146 )
{
int V_44 ;
struct V_36 * V_37 = V_102 -> V_37 ;
T_3 V_149 [ 2 ] = { V_102 -> V_107 , V_146 } ;
V_44 = F_85 ( & V_37 -> V_32 , V_37 -> V_34 , V_149 , & V_37 -> V_34 ) ;
if ( V_44 )
return V_44 ;
V_102 -> V_108 -- ;
V_102 -> V_106 = 1 ;
...
static int F_122 ( struct V_101 * V_102 , T_3 V_151 , T_3 V_152 )
{
int V_44 ;
unsigned V_161 , V_162 = 0 ;
struct V_36 * V_37 = V_102 -> V_37 ;
T_3 V_149 [ 1 ] = { V_102 -> V_107 } ;
T_5 V_30 ;
T_3 V_163 ;
V_44 = F_81 ( & V_37 -> V_57 , V_37 -> V_34 , V_149 , & V_30 ) ;
if ( V_44 )
return V_44 ;
V_163 = F_8 ( V_30 ) ;
F_19 ( V_37 -> V_35 , V_163 ) ;
V_44 = F_85 ( & V_37 -> V_57 , V_37 -> V_34 , V_149 , & V_37 -> V_34 ) ;
if ( V_44 )
return V_44 ;
while ( V_151 < V_152 ) {
V_44 = F_115 ( & V_37 -> V_58 , V_163 , & V_151 , & V_151 , & V_30 ) ;
if ( V_44 == - V_129 )
break;
if ( V_44 )
return V_44 ;
if ( V_151 >= V_152 )
break;
V_44 = F_123 ( & V_37 -> V_58 , V_163 , & V_151 , V_152 , & V_163 , & V_161 ) ;
if ( V_44 )
return V_44 ;
V_162 += V_161 ;
}
...
V_30 = F_3 ( V_163 ) ;
F_63 ( & V_30 ) ;
return F_64 ( & V_37 -> V_57 , V_37 -> V_34 , V_149 , & V_30 , & V_37 -> V_34 ) ;
}
int F_124 ( struct V_101 * V_102 , T_3 V_146 )
{
int V_44 = - V_91 ;
F_87 ( & V_102 -> V_37 -> V_118 ) ;
if ( ! V_102 -> V_37 -> V_120 )
V_44 = F_121 ( V_102 , V_146 ) ;
F_88 ( & V_102 -> V_37 -> V_118 ) ;
return V_44 ;
}
int F_125 ( struct V_101 * V_102 ,
T_3 V_151 , T_3 V_152 )
{
int V_44 = - V_91 ;
F_87 ( & V_102 -> V_37 -> V_118 ) ;
if ( ! V_102 -> V_37 -> V_120 )
V_44 = F_122 ( V_102 , V_151 , V_152 ) ;
F_88 ( & V_102 -> V_37 -> V_118 ) ;
return V_44 ;
}
int F_126 ( struct V_36 * V_37 , T_3 V_4 , bool * V_43 )
{
int V_44 ;
T_4 V_164 ;
F_76 ( & V_37 -> V_118 ) ;
V_44 = F_127 ( V_37 -> V_50 , V_4 , & V_164 ) ;
if ( ! V_44 )
* V_43 = ( V_164 != 0 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_128 ( struct V_36 * V_37 , T_3 V_4 , T_3 V_165 )
{
int V_44 = 0 ;
F_87 ( & V_37 -> V_118 ) ;
for (; V_4 != V_165 ; V_4 ++ ) {
V_44 = F_14 ( V_37 -> V_50 , V_4 ) ;
if ( V_44 )
break;
}
F_88 ( & V_37 -> V_118 ) ;
...
int F_129 ( struct V_36 * V_37 , T_3 V_4 , T_3 V_165 )
{
int V_44 = 0 ;
F_87 ( & V_37 -> V_118 ) ;
for (; V_4 != V_165 ; V_4 ++ ) {
V_44 = F_16 ( V_37 -> V_50 , V_4 ) ;
if ( V_44 )
break;
}
F_88 ( & V_37 -> V_118 ) ;
...
int F_133 ( struct V_36 * V_37 , T_3 * V_43 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_134 ( V_37 -> V_50 , V_43 ) ;
F_88 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_135 ( struct V_36 * V_37 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
if ( V_37 -> V_120 )
...
static void F_136 ( struct V_36 * V_37 )
{
struct V_101 * V_102 ;
F_80 (td, &pmd->thin_devices, list)
V_102 -> V_131 = V_102 -> V_106 ;
}
int F_137 ( struct V_36 * V_37 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
if ( V_37 -> V_120 )
...
int F_138 ( struct V_36 * V_37 , T_3 * V_43 )
{
int V_44 = - V_91 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_139 ( V_37 -> V_50 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
...
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_142 ( V_37 -> V_62 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_143 ( struct V_36 * V_37 , T_3 * V_43 )
{
int V_44 = - V_91 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_142 ( V_37 -> V_50 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_144 ( struct V_101 * V_102 , T_3 * V_43 )
{
int V_44 = - V_91 ;
struct V_36 * V_37 = V_102 -> V_37 ;
F_76 ( & V_37 -> V_118 ) ;
...
static int F_145 ( struct V_101 * V_102 , T_3 * V_43 )
{
int V_44 ;
T_5 V_20 ;
T_3 V_166 ;
struct V_36 * V_37 = V_102 -> V_37 ;
V_44 = F_81 ( & V_37 -> V_57 , V_37 -> V_34 , & V_102 -> V_107 , & V_20 ) ;
if ( V_44 )
return V_44 ;
V_166 = F_8 ( V_20 ) ;
return F_146 ( & V_37 -> V_58 , V_166 , V_43 ) ;
}
int F_147 ( struct V_101 * V_102 ,
T_3 * V_43 )
{
int V_44 = - V_91 ;
struct V_36 * V_37 = V_102 -> V_37 ;
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_145 ( V_102 , V_43 ) ;
F_77 ( & V_37 -> V_118 ) ;
return V_44 ;
}
static int F_148 ( struct V_21 * V_22 , T_3 V_167 )
{
int V_44 ;
T_3 V_168 ;
V_44 = F_142 ( V_22 , & V_168 ) ;
if ( V_44 )
return V_44 ;
if ( V_167 == V_168 )
return 0 ;
...
return F_149 ( V_22 , V_167 - V_168 ) ;
}
int F_150 ( struct V_36 * V_37 , T_3 V_167 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_148 ( V_37 -> V_50 , V_167 ) ;
F_88 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_151 ( struct V_36 * V_37 , T_3 V_167 )
{
int V_44 = - V_91 ;
F_87 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
V_44 = F_148 ( V_37 -> V_62 , V_167 ) ;
F_88 ( & V_37 -> V_118 ) ;
return V_44 ;
}
void F_152 ( struct V_36 * V_37 )
{
F_87 ( & V_37 -> V_118 ) ;
F_153 ( V_37 -> V_39 ) ;
F_88 ( & V_37 -> V_118 ) ;
}
void F_154 ( struct V_36 * V_37 )
{
F_87 ( & V_37 -> V_118 ) ;
F_155 ( V_37 -> V_39 ) ;
F_88 ( & V_37 -> V_118 ) ;
}
int F_156 ( struct V_36 * V_37 ,
T_3 V_169 ,
T_8 V_170 ,
void * V_19 )
{
int V_44 ;
F_87 ( & V_37 -> V_118 ) ;
V_44 = F_157 ( V_37 -> V_62 , V_169 , V_170 , V_19 ) ;
F_88 ( & V_37 -> V_118 ) ;
return V_44 ;
}
int F_158 ( struct V_36 * V_37 )
{
int V_44 ;
struct V_3 * V_38 ;
struct V_6 * V_7 ;
...
bool F_159 ( struct V_36 * V_37 )
{
bool V_172 ;
F_76 ( & V_37 -> V_118 ) ;
V_172 = V_37 -> V_10 & V_171 ;
F_77 ( & V_37 -> V_118 ) ;
return V_172 ;
}
void F_160 ( struct V_36 * V_37 )
{
F_76 ( & V_37 -> V_118 ) ;
if ( ! V_37 -> V_120 )
F_161 ( V_37 -> V_35 ) ;
