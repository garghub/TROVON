...
if ( V_2 -> V_88 > V_89 )
return - V_65 ;
if ( F_39 ( V_2 -> V_39 ) != V_19 [ V_24 ] )
F_40 ( & V_27 -> V_27 , L_5 ,
F_39 ( V_2 -> V_39 ) , V_19 [ V_24 ] ) ;
V_31 = ( V_90 | V_91 | V_53 |
V_4 ) ;
switch ( V_24 ) {
case V_92 :
...
if ( V_27 -> V_69 != V_84 ) {
V_2 -> V_98 = F_41 ( V_25 , 1 << F_42 ( V_2 -> V_98 ) ) ;
}
}
return F_43 ( V_2 , V_8 ) ;
}
...
V_106 = F_55 ( V_11 -> V_14 . V_107 , struct V_2 ,
V_6 ) ;
F_11 ( V_106 ) ;
F_56 ( & V_11 -> V_13 ) ;
F_46 ( V_106 ) ;
...
unsigned int V_109 )
{
return F_65 ( V_11 -> V_18 ,
F_19 ( V_11 ) ,
F_66 ( V_109 ) ) ;
}
struct V_2 * F_61 ( struct V_10 * V_11 )
{
struct V_2 * V_106 ;
unsigned long V_12 ;
F_14 ( & V_11 -> V_13 , V_12 ) ;
if ( ! F_21 ( & V_11 -> V_14 ) ) {
V_106 = F_55 ( V_11 -> V_14 . V_110 , struct V_2 ,
V_6 ) ;
F_11 ( V_106 ) ;
F_22 ( V_106 , V_11 ) ;
} else {
