...
if ( ! F_16 ( ( char * ) V_10 , sizeof( struct V_36 ) ,
V_37 ) )
return false ;
if ( ! F_17 ( & V_10 -> V_34 , & V_5 -> V_33 . V_35 ) )
return false ;
}
return true ;
}
...
if ( V_41 == 0 )
V_7 = F_8 ( V_6 -> V_21 ) ;
error = F_4 ( V_5 , V_6 , V_7 + V_41 , 0 , V_45 , V_47 ) ;
if ( error )
return false ;
}
return true ;
...
struct V_38 * V_39 )
{
struct V_4 * V_5 = V_39 -> V_48 -> V_49 ;
if ( ! F_15 ( V_5 , V_39 ) )
F_20 ( V_39 , - V_50 ) ;
else if ( ! F_18 ( V_5 , V_39 , V_14 ) )
F_20 ( V_39 , - V_51 ) ;
if ( V_39 -> V_52 )
F_21 ( V_39 ) ;
}
