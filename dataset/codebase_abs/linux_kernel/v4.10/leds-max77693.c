...
V_11 -> V_142 = F_62 ( V_105 , V_163 , V_9 , NULL ,
& V_164 , & V_145 ) ;
if ( F_63 ( V_11 -> V_142 ) ) {
V_29 = F_64 ( V_11 -> V_142 ) ;
goto V_165;
}
return 0 ;
V_165:
...
static int F_66 ( struct V_166 * V_104 )
{
...
V_20 = F_67 ( V_105 , sizeof( * V_20 ) , V_168 ) ;
if ( ! V_20 )
return - V_169 ;
V_20 -> V_104 = V_104 ;
...
if ( ! V_167 [ V_22 ] )
goto V_171;
F_70 ( V_12 [ V_22 ] . V_142 ) ;
F_65 ( & V_12 [ V_22 ] . V_9 ) ;
V_171:
F_71 ( & V_20 -> V_103 ) ;
return V_29 ;
}
static int F_72 ( struct V_166 * V_104 )
{
struct V_10 * V_20 = F_73 ( V_104 ) ;
struct V_7 * V_12 = V_20 -> V_12 ;
