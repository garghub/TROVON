...
struct V_44 * V_194 =
(struct V_44 * ) V_45 ;
T_2 V_47 = F_2 ( V_194 -> V_47 ) ;
int V_42 ;
V_42 = V_47 >> V_48 ;
F_14 ( V_2 , V_42 , V_194 -> V_51 ,
V_195 , F_15 ( V_47 ) ) ;
}
...
list) {
V_198 -> V_42 = ( T_3 ) V_191 -> V_42 ;
memcpy ( V_198 -> V_193 , V_191 -> V_193 , V_163 ) ;
V_198 -> V_201 = V_191 -> V_201 ;
V_198 -> V_202 = V_191 -> V_202 ;
for ( V_155 = 0 ; V_155 < V_191 -> V_202 ; ++ V_155 ) {
if ( V_191 -> V_203 [ V_155 ] )
V_198 -> V_114 [ V_155 ] = true ;
else
V_198 -> V_114 [ V_155 ] = false ;
}
V_198 ++ ;
V_199 ++ ;
if ( V_199 >= V_204 )
...
{
struct V_34 * V_37 ;
struct V_205 * V_198 = V_197 ;
int V_199 = 0 ;
unsigned long V_38 ;
F_10 ( & V_2 -> V_39 , V_38 ) ;
F_11 (tx_ba_tsr_tbl, &priv->tx_ba_stream_tbl_ptr, list) {
V_198 -> V_42 = ( T_3 ) V_37 -> V_42 ;
F_4 ( V_2 -> V_13 , V_206 , L_10 ,
V_170 , V_198 -> V_42 ) ;
memcpy ( V_198 -> V_54 , V_37 -> V_54 , V_163 ) ;
V_198 -> V_78 = V_37 -> V_78 ;
V_198 ++ ;
V_199 ++ ;
if ( V_199 >= V_207 )
break;
