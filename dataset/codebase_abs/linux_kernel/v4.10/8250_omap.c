...
if ( V_54 -> V_186 )
goto V_201;
V_199 = F_79 ( V_54 -> V_188 , V_54 -> V_202 ,
V_54 -> V_190 , V_203 ,
V_204 | V_205 ) ;
if ( ! V_199 ) {
V_166 = - V_206 ;
...
struct V_53 * V_54 = V_2 -> V_54 ;
struct V_209 * V_210 = & V_2 -> V_5 . V_134 -> V_210 ;
unsigned long V_40 ;
bool V_211 = false ;
struct V_10 * V_11 = V_2 -> V_5 . V_12 ;
F_83 ( V_54 -> V_212 -> V_213 -> V_33 , V_54 -> V_214 ,
V_215 , V_216 ) ;
F_63 ( & V_2 -> V_5 . V_97 , V_40 ) ;
V_54 -> V_55 = 0 ;
V_210 -> V_217 += V_54 -> V_218 ;
V_210 -> V_217 &= V_215 - 1 ;
V_2 -> V_5 . V_193 . V_219 += V_54 -> V_218 ;
if ( V_11 -> V_56 ) {
V_11 -> V_56 = 0 ;
F_16 ( V_2 ) ;
}
...
if ( V_54 -> V_55 )
return 0 ;
if ( F_87 ( & V_2 -> V_5 ) || F_86 ( V_210 ) ) {
if ( V_54 -> V_221 || V_2 -> V_169 & V_170 ) {
V_160 = - V_206 ;
goto V_166;
}
if ( V_2 -> V_68 & V_222 ) {
...
V_54 -> V_218 = F_90 ( V_210 -> V_224 , V_210 -> V_217 , V_215 ) ;
if ( V_11 -> V_51 & V_225 ) {
T_2 V_226 ;
V_226 = F_7 ( V_2 , V_227 ) ;
if ( V_226 == V_2 -> V_228 ) {
...
V_199 = F_79 ( V_54 -> V_212 ,
V_54 -> V_214 + V_210 -> V_217 + V_223 ,
V_54 -> V_218 - V_223 , V_229 ,
V_204 | V_205 ) ;
if ( ! V_199 ) {
V_160 = - V_206 ;
goto V_166;
...
V_199 -> V_207 = F_82 ;
V_199 -> V_208 = V_2 ;
V_54 -> V_230 = F_80 ( V_199 ) ;
F_91 ( V_54 -> V_212 -> V_213 -> V_33 , V_54 -> V_214 ,
V_215 , V_216 ) ;
F_81 ( V_54 -> V_212 ) ;
if ( V_54 -> V_221 )
V_54 -> V_221 = 0 ;
...
if ( V_223 )
F_8 ( V_2 , V_231 , V_210 -> V_232 [ V_210 -> V_217 ] ) ;
return 0 ;
V_166:
V_54 -> V_221 = 1 ;
return V_160 ;
...
F_94 ( V_3 ) ;
if ( V_17 & V_30 && V_3 -> V_54 -> V_221 ) {
if ( F_87 ( & V_3 -> V_5 ) ||
F_86 ( & V_3 -> V_5 . V_134 -> V_210 ) ) {
V_3 -> V_54 -> V_221 = 0 ;
F_95 ( V_3 ) ;
} else {
if ( F_88 ( V_3 ) )
...
static bool F_96 ( struct V_237 * V_238 , void * V_196 )
{
return false ;
}
...
static int F_99 ( struct V_239 * V_240 )
{
struct V_241 * V_242 = F_100 ( V_240 , V_243 , 0 ) ;
struct V_241 * V_157 = F_100 ( V_240 , V_244 , 0 ) ;
struct V_10 * V_11 ;
struct V_1 V_3 ;
int V_160 ;
void T_5 * V_6 ;
if ( ! V_242 || ! V_157 ) {
F_101 ( & V_240 -> V_33 , L_5 ) ;
return - V_200 ;
}
V_11 = F_102 ( & V_240 -> V_33 , sizeof( * V_11 ) , V_245 ) ;
if ( ! V_11 )
return - V_246 ;
V_6 = F_103 ( & V_240 -> V_33 , V_242 -> V_247 ,
F_104 ( V_242 ) ) ;
if ( ! V_6 )
return - V_248 ;
memset ( & V_3 , 0 , sizeof( V_3 ) ) ;
V_3 . V_5 . V_33 = & V_240 -> V_33 ;
V_3 . V_5 . V_249 = V_242 -> V_247 ;
V_3 . V_5 . V_6 = V_6 ;
V_3 . V_5 . V_157 = V_157 -> V_247 ;
V_3 . V_5 . type = V_250 ;
V_3 . V_5 . V_251 = V_252 ;
V_3 . V_5 . V_40 = V_253 | V_254 | V_127 |
V_125 ;
V_3 . V_5 . V_12 = V_11 ;
V_3 . V_5 . V_7 = 2 ;
V_3 . V_5 . V_255 = 64 ;
...
V_160 = F_105 ( V_240 -> V_33 . V_264 , L_6 ) ;
F_106 ( V_240 -> V_33 . V_264 , L_7 ,
& V_3 . V_5 . V_35 ) ;
V_11 -> V_162 = F_107 ( V_240 -> V_33 . V_264 , 1 ) ;
V_266 = F_108 ( F_109 ( V_267 ) , & V_240 -> V_33 ) ;
if ( V_266 && V_266 -> V_268 )
V_11 -> V_51 |= * ( T_2 * ) V_266 -> V_268 ;
} else {
V_160 = V_240 -> V_266 ;
}
if ( V_160 < 0 ) {
F_101 ( & V_240 -> V_33 , L_8 ) ;
return V_160 ;
}
V_3 . V_5 . line = V_160 ;
if ( ! V_3 . V_5 . V_35 ) {
...
V_11 -> V_132 = V_270 ;
V_11 -> V_130 = V_270 ;
F_110 ( & V_11 -> V_156 , V_271 ,
V_11 -> V_132 ) ;
F_111 ( & V_11 -> V_133 , F_39 ) ;
F_112 ( & V_11 -> V_185 ) ;
F_113 ( & V_240 -> V_33 , true ) ;
F_114 ( & V_240 -> V_33 ) ;
F_115 ( & V_240 -> V_33 , - 1 ) ;
F_116 ( & V_240 -> V_33 ) ;
F_117 ( & V_240 -> V_33 ) ;
...
#ifdef F_43
if ( V_240 -> V_33 . V_264 ) {
V_160 = F_118 ( V_240 -> V_33 . V_264 , L_10 ) ;
if ( V_160 == 2 ) {
V_3 . V_54 = & V_11 -> V_273 ;
V_11 -> V_273 . V_274 = F_96 ;
V_11 -> V_273 . V_275 = F_88 ;
V_11 -> V_273 . V_175 = F_75 ;
V_11 -> V_273 . V_190 = V_64 ;
V_11 -> V_273 . V_276 . V_277 = V_64 ;
V_11 -> V_273 . V_278 . V_279 = V_62 ;
if ( F_119 ( L_11 ) )
V_11 -> V_51 |= V_225 ;
V_11 -> V_197 = true ;
}
...
static int F_124 ( struct V_239 * V_240 )
{
struct V_10 * V_11 = F_125 ( V_240 ) ;
F_126 ( & V_240 -> V_33 ) ;
F_123 ( & V_240 -> V_33 ) ;
F_127 ( V_11 -> line ) ;
F_128 ( & V_11 -> V_156 ) ;
F_113 ( & V_240 -> V_33 , false ) ;
return 0 ;
}
static int F_129 ( struct V_213 * V_33 )
{
...
static void F_131 ( struct V_213 * V_33 )
{
struct V_10 * V_11 = F_130 ( V_33 ) ;
if ( ! V_11 )
return;
...
static int F_132 ( struct V_213 * V_33 )
{
struct V_10 * V_11 = F_130 ( V_33 ) ;
F_133 ( V_11 -> line ) ;
F_59 ( & V_11 -> V_133 ) ;
...
static int F_134 ( struct V_213 * V_33 )
{
struct V_10 * V_11 = F_130 ( V_33 ) ;
F_135 ( V_11 -> line ) ;
return 0 ;
...
static int F_137 ( struct V_213 * V_33 )
{
struct V_10 * V_11 = F_130 ( V_33 ) ;
...
static int F_139 ( struct V_213 * V_33 )
{
struct V_10 * V_11 = F_130 ( V_33 ) ;
struct V_1 * V_3 ;
V_3 = F_138 ( V_11 -> line ) ;
...
static int F_141 ( struct V_213 * V_33 )
{
struct V_10 * V_11 = F_130 ( V_33 ) ;
struct V_1 * V_3 ;
if ( ! V_11 )
