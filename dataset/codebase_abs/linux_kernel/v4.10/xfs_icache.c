...
bool V_155 = true ;
int V_156 ;
ASSERT ( ! V_144 || ( V_144 && V_144 -> V_157 != 0 ) ) ;
if ( ! F_119 ( V_5 , false ) ) {
F_120 ( V_5 ) ;
F_121 ( V_5 ) ;
return 0 ;
...
if ( ! ( V_68 & V_131 ) &&
F_122 ( F_4 ( V_5 ) -> V_158 , V_159 ) )
return 0 ;
if ( V_144 ) {
if ( V_144 -> V_145 & V_160 )
V_156 = F_117 ( V_5 , V_144 ) ;
else
V_156 = F_113 ( V_5 , V_144 ) ;
if ( ! V_156 )
return 0 ;
if ( V_144 -> V_145 & V_161 &&
F_123 ( V_5 ) < V_144 -> V_162 )
return 0 ;
if ( V_144 -> V_157 == V_5 -> V_13 )
V_155 = false ;
}
V_154 = F_124 ( V_5 -> V_14 , V_5 , V_155 ) ;
if ( V_154 == - V_71 && ! ( V_68 & V_131 ) )
V_154 = 0 ;
return V_154 ;
}
static int
...
struct V_165 * V_166 ;
ASSERT ( F_127 ( V_5 , V_97 ) ) ;
V_144 . V_157 = V_5 -> V_13 ;
V_144 . V_145 = V_160 | V_163 ;
if ( F_128 ( V_5 -> V_14 ) ) {
V_166 = F_129 ( V_5 , V_167 ) ;
if ( V_166 && F_130 ( V_166 ) ) {
...
void (* F_134)( struct V_2 * V_3 , T_12 V_169 ,
int error , unsigned long V_170 ) ,
int V_108 )
{
struct V_2 * V_3 = V_5 -> V_14 ;
struct V_51 * V_52 ;
...
F_20 ( & V_5 -> V_14 -> V_56 ) ;
F_78 ( V_5 -> V_14 ) ;
F_134 ( V_5 -> V_14 , V_52 -> V_57 , - 1 , V_58 ) ;
}
F_20 ( & V_52 -> V_54 ) ;
F_41 ( V_52 ) ;
}
...
F_137 (
T_10 * V_5 ,
void (* F_138)( struct V_2 * V_3 , T_12 V_169 ,
int error , unsigned long V_170 ) ,
int V_108 )
{
struct V_2 * V_3 = V_5 -> V_14 ;
...
V_108 ) ;
F_20 ( & V_5 -> V_14 -> V_56 ) ;
F_138 ( V_5 -> V_14 , V_52 -> V_57 , - 1 , V_58 ) ;
}
F_20 ( & V_52 -> V_54 ) ;
F_41 ( V_52 ) ;
}
...
bool V_155 = true ;
int V_156 ;
struct V_175 * V_176 = F_141 ( V_5 , V_37 ) ;
ASSERT ( ! V_144 || ( V_144 && V_144 -> V_157 != 0 ) ) ;
if ( ! F_142 ( V_5 ) || ! V_176 -> V_177 ) {
F_143 ( V_5 ) ;
F_144 ( V_5 ) ;
return 0 ;
}
if ( ( F_4 ( V_5 ) -> V_77 & V_178 ) ||
F_122 ( F_4 ( V_5 ) -> V_158 , V_159 ) ||
F_122 ( F_4 ( V_5 ) -> V_158 , V_179 ) ||
F_7 ( & F_4 ( V_5 ) -> V_180 ) )
return 0 ;
if ( V_144 ) {
if ( V_144 -> V_145 & V_160 )
