...
static void F_41 ( struct V_42 * V_35 )
{
struct V_1 * V_2 = V_35 -> V_49 ;
int V_7 ;
F_38 ( & V_65 ) ;
...
static int F_43 ( struct V_42 * V_35 , int V_69 )
{
struct V_1 * V_2 = V_35 -> V_49 ;
switch ( V_69 ) {
case V_70 :
...
V_35 -> V_76 = F_5 ( V_2 -> V_5 . V_77 ) ;
V_35 -> V_78 = V_2 -> V_5 . V_79 ;
V_35 -> V_49 = V_2 ;
V_35 -> V_80 = & V_81 ;
V_35 -> V_27 . V_82 = & V_2 -> V_3 -> V_8 -> V_27 ;
snprintf ( V_35 -> V_83 , sizeof( V_35 -> V_83 ) , L_8 ,
F_45 ( & V_2 -> V_3 -> V_8 -> V_27 ) ,
V_35 -> V_74 , V_35 -> V_76 ) ;
return 0 ;
}
static int F_46 ( struct V_84 * V_8 ,
const struct V_85 * V_46 )
{
struct V_86 * V_87 ;
struct V_29 * V_3 ;
struct V_42 * V_35 ;
...
static void F_58 ( struct V_84 * V_8 )
{
struct V_1 * V_2 = F_59 ( V_8 ) ;
if ( F_4 ( V_8 ) )
F_60 ( V_8 ) ;
F_56 ( V_2 -> V_35 ) ;
F_55 ( V_2 -> V_3 ) ;
