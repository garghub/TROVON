...
{
struct V_3 * V_4 ;
while ( ! F_36 ( & V_2 -> V_7 . V_8 ) &&
F_37 ( V_2 ) ) {
F_18 ( & V_2 -> V_7 . V_10 ) ;
V_4 = F_29 ( & V_2 -> V_7 . V_8 , F_30 ( * V_4 ) ,
V_20 ) ;
F_31 ( & V_4 -> V_20 ) ;
F_20 ( & V_2 -> V_7 . V_10 ) ;
F_38 ( V_2 , V_4 ) ;
...
int F_39 ( struct V_1 * V_2 , T_1 V_16 , unsigned long V_24 ,
struct V_25 * V_26 )
{
struct V_3 * V_4 ;
if ( V_2 -> V_7 . V_23 >= V_27 )
return 0 ;
V_4 = F_40 ( V_5 , V_28 | V_29 ) ;
if ( ! V_4 )
return 0 ;
V_4 -> V_30 = false ;
V_4 -> V_2 = V_2 ;
