...
unsigned int V_297 ;
V_296 = F_154 ( V_14 -> V_30 -> V_298 ,
L_44 , 0 ) ;
V_297 = F_155 ( V_299 , V_296 ) ;
V_14 -> V_251 = 1 << V_297 ;
for ( V_20 = 0 ; V_20 < V_14 -> V_168 ; V_20 ++ ) {
struct V_1 * V_2 = & V_14 -> V_2 [ V_20 ] ;
...
if ( V_14 -> V_251 > 1 ) {
V_230 = F_151 ( V_290 , V_73 -> V_301 , L_46 , L_38 ,
V_297 ) ;
if ( V_230 ) {
V_292 = L_47 ;
goto V_293;
...
if ( V_14 -> V_168 == 1 ) {
V_230 = F_150 ( V_290 , & V_14 -> V_2 [ 0 ] , V_73 -> V_301 ) ;
if ( V_230 )
goto V_300;
} else {
char * V_302 ;
T_8 V_303 ;
V_230 = F_151 ( V_290 , V_73 -> V_301 , L_48 , L_38 ,
V_14 -> V_168 ) ;
if ( V_230 ) {
V_292 = L_49 ;
goto V_293;
}
V_303 = strlen ( V_73 -> V_301 ) + V_304 ;
V_302 = F_157 ( V_303 , V_52 ) ;
if ( ! V_302 ) {
V_230 = - V_28 ;
V_292 = L_50 ;
goto V_293;
...
snprintf ( V_302 , V_303 , L_51 , V_73 -> V_301 , V_20 ) ;
V_230 = F_150 ( V_290 , & V_14 -> V_2 [ V_20 ] , V_302 ) ;
if ( V_230 ) {
F_8 ( V_302 ) ;
goto V_300;
}
...
V_230 = F_151 ( V_290 , V_73 -> V_301 , L_52 , L_43 ,
V_305 ) ;
if ( V_230 ) {
V_292 = L_53 ;
goto V_293;
}
V_230 = F_151 ( V_290 , V_73 -> V_301 ,
L_54 , L_38 , 1 ) ;
if ( V_230 )
F_158 ( & V_73 -> V_73 ,
L_55 ) ;
...
unsigned int V_20 ;
F_2 ( V_14 -> V_168 ) ;
V_308 = F_154 ( V_14 -> V_30 -> V_298 ,
L_57 , 1 ) ;
V_14 -> V_168 = F_155 ( V_308 , V_309 ) ;
if ( ! V_14 -> V_168 )
V_14 -> V_168 = 1 ;
...
const struct V_310 * V_9 )
{
int V_230 , V_199 ;
struct V_13 * V_14 ;
V_230 = F_166 ( V_311 , V_73 -> V_301 ,
L_59 , L_60 , & V_199 ) ;
if ( V_230 != 1 ) {
V_230 = F_166 ( V_311 , V_73 -> V_301 , L_61 ,
L_60 , & V_199 ) ;
if ( V_230 != 1 ) {
...
type = F_168 ( V_311 , V_73 -> V_301 , L_64 , & V_101 ) ;
if ( F_89 ( type ) )
return - V_226 ;
...
V_14 -> V_199 = V_199 ;
V_14 -> V_153 = V_257 ;
V_14 -> V_132 = F_170 ( strrchr ( V_73 -> V_301 , '/' ) + 1 , NULL , 0 ) ;
F_160 ( & V_73 -> V_73 , V_14 ) ;
return 0 ;
}
static void F_171 ( struct V_315 * V_315 )
{
struct V_316 * V_316 = V_315 -> V_317 ;
if ( F_172 ( & V_316 -> V_318 ) ) {
V_316 -> V_315 -> V_319 = 0 ;
...
F_117 ( V_14 -> V_169 , true ) ;
F_180 ( V_14 -> V_169 ) ;
while ( ( V_315 = F_181 ( & V_14 -> V_326 ) ) != NULL ) {
if ( F_182 ( V_315 ) > V_249 ) {
V_318 = ( F_182 ( V_315 ) + V_249 - 1 ) / V_249 ;
V_316 = F_6 ( sizeof( * V_316 ) , V_21 ) ;
F_2 ( V_316 == NULL ) ;
F_183 ( & V_316 -> V_318 , V_318 ) ;
V_316 -> V_315 = V_315 ;
for ( V_20 = 0 ; V_20 < V_318 ; V_20 ++ ) {
V_100 = ( V_20 * V_249 * V_131 ) >> 9 ;
V_323 = F_155 ( ( unsigned int ) ( V_249 * V_131 ) >> 9 ,
( unsigned int ) F_184 ( V_315 ) - V_100 ) ;
V_322 = F_185 ( V_315 , V_21 ) ;
F_2 ( V_322 == NULL ) ;
F_186 ( V_322 , V_100 , V_323 ) ;
V_322 -> V_317 = V_316 ;
V_322 -> V_327 = F_171 ;
F_187 ( V_322 ) ;
}
...
static int F_188 ( struct V_283 * V_73 )
{
struct V_13 * V_14 = F_189 ( & V_73 -> V_73 ) ;
int V_230 = 0 ;
unsigned int V_20 , V_248 ;
F_39 ( & V_73 -> V_73 , L_67 , V_73 -> V_301 ) ;
F_190 ( & V_14 -> V_326 ) ;
F_162 ( & V_14 -> V_328 ) ;
for ( V_20 = 0 ; V_20 < V_14 -> V_168 ; V_20 ++ ) {
struct V_1 * V_2 = & V_14 -> V_2 [ V_20 ] ;
...
F_191 ( & V_14 -> V_326 , & V_329 ) ;
V_5 [ V_248 ] . V_11 -> V_315 = NULL ;
F_192 ( V_5 [ V_248 ] . V_11 , 0 ) ;
}
}
...
if ( ! V_230 )
F_193 ( & V_14 -> V_187 , V_14 -> V_168 ) ;
return V_230 ;
}
static void F_194 ( struct V_13 * V_14 )
{
...
unsigned int V_182 ;
V_14 -> V_178 = 1 ;
V_230 = F_202 ( V_311 , V_14 -> V_30 -> V_298 ,
L_69 , L_38 , & V_181 ,
L_70 , L_38 , & V_182 ,
NULL ) ;
if ( ! V_230 ) {
...
V_14 -> V_97 =
! ! F_154 ( V_14 -> V_30 -> V_298 , L_71 ,
0 ) ;
}
static int F_177 ( struct V_1 * V_2 )
{
unsigned int V_337 , V_27 ;
int V_230 , V_20 ;
struct V_13 * V_14 = V_2 -> V_4 ;
if ( V_14 -> V_144 == 0 ) {
if ( ! V_145 )
...
V_21 ) ;
V_2 -> V_5 [ V_20 ] . V_135 = F_6 ( sizeof( V_2 -> V_5 [ V_20 ] . V_135 [ 0 ] ) * V_337 , V_21 ) ;
if ( V_14 -> V_144 )
...
( V_2 -> V_5 [ V_20 ] . V_116 == NULL ) ) )
goto V_22;
F_204 ( V_2 -> V_5 [ V_20 ] . V_135 , V_337 ) ;
}
return 0 ;
V_22:
for ( V_20 = 0 ; V_20 < F_3 ( V_14 ) ; V_20 ++ ) {
...
V_14 -> V_150 = 0 ;
V_14 -> V_151 = 0 ;
if ( F_154 ( V_14 -> V_30 -> V_298 , L_72 , 0 ) ) {
V_14 -> V_150 = 1 ;
V_14 -> V_151 = 1 ;
}
if ( F_154 ( V_14 -> V_30 -> V_298 , L_73 ,
0 ) ) {
V_14 -> V_150 = 1 ;
V_14 -> V_151 = 0 ;
}
if ( F_154 ( V_14 -> V_30 -> V_298 , L_74 , 0 ) )
F_201 ( V_14 ) ;
V_14 -> V_23 =
! ! F_154 ( V_14 -> V_30 -> V_298 ,
L_54 , 0 ) ;
V_338 = F_154 ( V_14 -> V_30 -> V_298 ,
L_75 , 0 ) ;
if ( V_338 > V_339 )
V_338 = V_339 ;
if ( V_338 <= V_111 )
...
switch ( V_14 -> V_153 ) {
case V_154 :
V_230 = F_166 ( V_311 , V_14 -> V_30 -> V_298 ,
L_76 , L_77 , & V_67 ) ;
if ( F_206 ( V_230 ) )
return;
F_99 ( V_312 L_78 ,
...
V_185 = F_154 ( V_14 -> V_30 -> V_298 ,
L_85 ,
V_184 ) ;
F_176 ( V_14 ) ;
for ( V_20 = 0 ; V_20 < V_14 -> V_168 ; V_20 ++ ) {
V_230 = F_177 ( & V_14 -> V_2 [ V_20 ] ) ;
if ( V_230 ) {
...
V_230 = F_101 ( V_67 , V_14 , V_340 , V_184 ,
V_185 ) ;
if ( V_230 ) {
...
for ( V_20 = 0 ; V_20 < V_14 -> V_168 ; V_20 ++ )
F_118 ( & V_14 -> V_2 [ V_20 ] ) ;
F_208 ( & V_14 -> V_30 -> V_73 , V_14 -> V_80 ) ;
V_14 -> V_341 = 1 ;
return;
V_288:
F_126 ( V_14 , 0 ) ;
...
static void F_209 ( struct V_283 * V_73 ,
enum V_342 V_343 )
{
struct V_13 * V_14 = F_189 ( & V_73 -> V_73 ) ;
F_39 ( & V_73 -> V_73 , L_88 , V_343 ) ;
switch ( V_343 ) {
case V_344 :
if ( V_73 -> V_333 != V_345 )
break;
...
static int F_210 ( struct V_283 * V_30 )
{
struct V_13 * V_14 = F_189 ( & V_30 -> V_73 ) ;
struct V_59 * V_68 = NULL ;
struct V_79 * V_350 ;
F_39 ( & V_30 -> V_73 , L_89 , V_30 -> V_301 ) ;
F_126 ( V_14 , 0 ) ;
F_195 ( & V_14 -> V_314 ) ;
V_350 = V_14 -> V_80 ;
if ( V_350 )
...
static int F_212 ( struct V_283 * V_73 )
{
struct V_13 * V_14 = F_189 ( & V_73 -> V_73 ) ;
return V_14 -> V_341 && V_14 -> V_30 ;
}
static int F_213 ( struct V_59 * V_68 , T_3 V_69 )
{
struct V_79 * V_350 = V_68 -> V_64 ;
struct V_13 * V_14 ;
int V_230 = 0 ;
F_195 ( & V_351 ) ;
V_14 = V_350 -> V_72 ;
...
static void F_214 ( struct V_79 * V_350 , T_3 V_69 )
{
struct V_13 * V_14 = V_350 -> V_72 ;
struct V_59 * V_68 ;
struct V_283 * V_30 ;
F_195 ( & V_351 ) ;
V_68 = F_197 ( V_350 , 0 ) ;
if ( ! V_68 ) {
F_131 ( 1 , L_91 , V_350 -> V_198 ) ;
goto V_353;
}
if ( V_68 -> V_336 )
goto V_235;
