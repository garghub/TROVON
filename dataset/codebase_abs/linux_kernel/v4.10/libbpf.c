...
V_86 = V_90 . V_96 / sizeof( struct V_83 ) ;
if ( V_86 >= V_78 ) {
F_8 ( L_46 ,
( int ) V_86 , ( int ) V_78 - 1 ) ;
return - V_120 ;
...
F_15 ( L_48 , V_39 -> V_77 [ V_19 ] . V_32 , * V_126 ) ;
}
return 0 ;
}
static int
...
return NULL ;
if ( ! V_32 ) {
snprintf ( V_153 , sizeof( V_153 ) , L_70 ,
( unsigned long ) V_45 ,
( unsigned long ) V_46 ) ;
...
V_155 = F_70 ( V_154 , V_51 ) ;
if ( & V_155 -> V_51 == & V_52 )
return NULL ;
return V_155 ;
}
const char * F_71 ( struct V_38 * V_39 )
{
return V_39 ? V_39 -> V_44 : F_17 ( - V_34 ) ;
}
unsigned int F_72 ( struct V_38 * V_39 )
{
return V_39 ? V_39 -> V_76 : 0 ;
}
int F_73 ( struct V_38 * V_39 , void * V_24 ,
T_12 V_23 )
{
...
struct V_17 *
F_75 ( struct V_17 * V_154 , struct V_38 * V_39 )
{
T_3 V_30 ;
if ( ! V_39 -> V_42 )
return NULL ;
...
V_30 = ( V_154 - V_39 -> V_42 ) + 1 ;
if ( V_30 >= V_39 -> V_43 )
return NULL ;
return & V_39 -> V_42 [ V_30 ] ;
}
int F_76 ( struct V_17 * V_18 , void * V_24 ,
T_13 V_23 )
{
...
const char * F_78 ( struct V_17 * V_18 , bool V_156 )
{
const char * V_157 ;
V_157 = V_18 -> V_25 ;
if ( V_156 ) {
...
int F_81 ( struct V_17 * V_18 , int V_158 ,
T_11 V_159 )
{
int * V_160 ;
if ( V_158 <= 0 || ! V_159 )
...
V_160 = malloc ( sizeof( int ) * V_158 ) ;
if ( ! V_160 ) {
F_8 ( L_77 ) ;
return - V_37 ;
}
memset ( V_160 , - 1 , sizeof( int ) * V_158 ) ;
V_18 -> V_20 . V_21 = V_158 ;
V_18 -> V_20 . V_22 = V_160 ;
V_18 -> V_145 = V_159 ;
return 0 ;
}
int F_80 ( struct V_17 * V_18 , int V_111 )
{
int V_48 ;
...
static bool F_85 ( struct V_17 * V_18 ,
enum V_136 type )
{
...
{
return F_85 ( V_18 , V_162 ) ;
}
bool F_87 ( struct V_17 * V_18 )
{
return F_85 ( V_18 , V_36 ) ;
}
int F_88 ( struct V_79 * V_163 )
{
return V_163 ? V_163 -> V_48 : - V_34 ;
}
const struct V_83 * F_89 ( struct V_79 * V_163 )
{
return V_163 ? & V_163 -> V_93 : F_17 ( - V_34 ) ;
}
const char * F_90 ( struct V_79 * V_163 )
{
return V_163 ? V_163 -> V_32 : NULL ;
}
int F_91 ( struct V_79 * V_163 , void * V_24 ,
T_14 V_23 )
{
if ( ! V_163 )
return - V_34 ;
if ( V_163 -> V_24 ) {
if ( V_163 -> V_23 )
V_163 -> V_23 ( V_163 , V_163 -> V_24 ) ;
}
V_163 -> V_24 = V_24 ;
V_163 -> V_23 = V_23 ;
return 0 ;
}
void * F_92 ( struct V_79 * V_163 )
{
return V_163 ? V_163 -> V_24 : F_17 ( - V_34 ) ;
}
struct V_79 *
F_93 ( struct V_79 * V_154 , struct V_38 * V_39 )
{
T_3 V_30 ;
struct V_79 * V_164 , * V_165 ;
if ( ! V_39 || ! V_39 -> V_77 )
return NULL ;
V_164 = V_39 -> V_77 ;
V_165 = V_39 -> V_77 + V_39 -> V_78 ;
if ( V_154 == NULL )
return V_164 ;
if ( ( V_154 < V_164 ) || ( V_154 >= V_165 ) ) {
F_8 ( L_80 ,
V_166 ) ;
return NULL ;
}
V_30 = ( V_154 - V_39 -> V_77 ) + 1 ;
if ( V_30 >= V_39 -> V_78 )
return NULL ;
return & V_39 -> V_77 [ V_30 ] ;
}
struct V_79 *
F_94 ( struct V_38 * V_39 , const char * V_32 )
{
struct V_79 * V_167 ;
F_95 (pos, obj) {
if ( V_167 -> V_32 && ! strcmp ( V_167 -> V_32 , V_32 ) )
return V_167 ;
}
return NULL ;
}
struct V_79 *
F_96 ( struct V_38 * V_39 , T_3 V_82 )
{
int V_19 ;
for ( V_19 = 0 ; V_19 < V_39 -> V_78 ; V_19 ++ ) {
