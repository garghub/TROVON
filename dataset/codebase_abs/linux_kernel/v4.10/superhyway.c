...
if ( ! V_2 -> V_5 ) {
V_2 -> V_5 = F_5 ( sizeof( struct V_5 ) , V_9 ) ;
if ( ! V_2 -> V_5 ) {
F_3 ( V_2 ) ;
return - V_10 ;
}
...
struct V_31 * V_32 = F_15 ( V_2 -> V_33 ) ;
if ( V_32 && V_32 -> V_34 ) {
const struct V_28 * V_19 ;
V_19 = F_13 ( V_32 -> V_35 , V_30 ) ;
if ( V_19 )
...
int F_17 ( struct V_31 * V_37 )
{
V_37 -> V_37 . V_12 = V_37 -> V_12 ;
V_37 -> V_37 . V_8 = & V_17 ;
return F_18 ( & V_37 -> V_37 ) ;
}
void F_19 ( struct V_31 * V_37 )
{
F_20 ( & V_37 -> V_37 ) ;
}
static int F_21 ( struct V_1 * V_2 , struct V_38 * V_37 )
{
struct V_3 * V_30 = F_2 ( V_2 ) ;
struct V_31 * V_32 = F_15 ( V_37 ) ;
