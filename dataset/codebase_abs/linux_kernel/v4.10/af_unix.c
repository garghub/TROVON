...
static int F_244 ( struct V_94 * V_13 , unsigned int V_284 , unsigned long V_285 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
long V_283 = 0 ;
int V_96 ;
...
case V_286 :
V_283 = F_242 ( V_14 ) ;
V_96 = F_245 ( V_283 , ( int V_287 * ) V_285 ) ;
break;
case V_288 :
V_283 = F_240 ( V_14 ) ;
if ( V_283 < 0 )
...
static unsigned int F_246 ( struct V_276 * V_276 , struct V_94 * V_13 , T_9 * V_65 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
unsigned int V_290 ;
F_247 ( V_276 , F_43 ( V_14 ) , V_65 ) ;
V_290 = 0 ;
if ( V_14 -> V_69 )
V_290 |= V_291 ;
if ( V_14 -> V_78 == V_79 )
...
static unsigned int F_248 ( struct V_276 * V_276 , struct V_94 * V_13 ,
T_9 * V_65 )
{
...
static struct V_13 * F_250 ( struct V_302 * V_303 , T_8 * V_304 )
{
unsigned long V_239 = F_251 ( * V_304 ) ;
unsigned long V_305 = F_252 ( * V_304 ) ;
struct V_13 * V_14 ;
unsigned long V_188 = 0 ;
for ( V_14 = F_253 ( & V_5 [ V_305 ] ) ; V_14 ; V_14 = F_254 ( V_14 ) ) {
if ( F_36 ( V_14 ) != F_255 ( V_303 ) )
continue;
if ( ++ V_188 == V_239 )
break;
}
...
static struct V_13 * F_256 ( struct V_302 * V_303 ,
struct V_13 * V_14 ,
T_8 * V_304 )
{
unsigned long V_305 ;
...
do {
V_14 = F_250 ( V_303 , V_304 ) ;
if ( V_14 )
return V_14 ;
V_307:
V_305 = F_252 ( * V_304 ) + 1 ;
* V_304 = F_257 ( V_305 , 1 ) ;
} while ( V_305 < F_258 ( V_5 ) );
return NULL ;
}
static void * F_259 ( struct V_302 * V_303 , T_8 * V_304 )
__acquires( V_31 )
{
F_29 ( & V_31 ) ;
if ( ! * V_304 )
return V_306 ;
if ( F_252 ( * V_304 ) >= F_258 ( V_5 ) )
return NULL ;
return F_256 ( V_303 , NULL , V_304 ) ;
}
static void * F_260 ( struct V_302 * V_303 , void * V_308 , T_8 * V_304 )
{
++ * V_304 ;
return F_256 ( V_303 , V_308 , V_304 ) ;
}
static void F_261 ( struct V_302 * V_303 , void * V_308 )
__releases( V_31 )
{
F_30 ( & V_31 ) ;
}
static int F_262 ( struct V_302 * V_303 , void * V_308 )
{
if ( V_308 == V_306 )
F_263 ( V_303 , L_4
L_5 ) ;
...
for ( ; V_39 < V_24 ; V_39 ++ )
F_266 ( V_303 , V_35 -> V_2 -> V_36 -> V_29 [ V_39 ] ? :
'@' ) ;
}
F_16 ( V_18 ) ;
F_266 ( V_303 , '\n' ) ;
...
static int F_268 ( struct V_38 * V_38 , struct V_276 * V_276 )
{
return F_269 ( V_38 , V_276 , & V_313 ,
sizeof( struct V_314 ) ) ;
}
...
goto V_100;
#ifdef F_272
if ( ! F_273 ( L_7 , 0 , V_32 -> V_315 , & V_316 ) ) {
F_274 ( V_32 ) ;
goto V_100;
}
#endif
...
{
F_274 ( V_32 ) ;
F_276 ( L_7 , V_32 -> V_315 ) ;
}
static int T_12 F_277 ( void )
{
int V_52 = - 1 ;
F_188 ( sizeof( struct V_209 ) > F_278 ( struct V_8 , V_317 ) ) ;
V_52 = F_279 ( & V_109 , 1 ) ;
if ( V_52 != 0 ) {
F_280 ( L_8 , V_318 ) ;
goto V_100;
