...
static int F_57 ( struct V_2 * V_3 , void * V_82 , void * V_69 )
{
...
static void F_59 ( struct V_2 * V_3 , void * V_82 )
{
F_56 ( * (struct V_1 * * ) V_82 ) ;
}
struct V_1 * F_60 ( struct V_2 * V_3 ,
struct V_15 * V_12 ,
const char * V_68 ,
void * V_69 )
{
struct V_1 * * V_84 , * V_1 ;
V_84 = F_61 ( F_59 , sizeof( * V_84 ) , V_20 ) ;
if ( ! V_84 )
return F_4 ( - V_71 ) ;
...
struct V_1 * F_64 ( struct V_2 * V_3 , int V_85 )
{
struct V_86 * V_65 ;
struct V_1 * V_1 ;
if ( ! V_3 )
...
void F_67 ( struct V_2 * V_3 , struct V_1 * V_1 )
{
F_58 ( F_68 ( V_3 , F_59 ,
F_57 , V_1 ) ) ;
}
...
static T_2 F_73 ( struct V_2 * V_3 ,
struct V_93 * V_94 , char * V_95 )
{
if ( ! F_44 ( V_3 ) -> V_45 )
return - V_6 ;
return sprintf ( V_95 , L_21 , F_44 ( V_3 ) -> V_45 -> V_32 ) ;
}
static T_2 F_74 ( struct V_2 * V_3 , struct V_93 * V_94 ,
...
char V_97 [ V_34 + 1 ] ;
struct V_31 * V_45 ;
V_22 = sscanf ( V_95 , L_22 F_75 ( V_34 ) L_23 , V_97 ) ;
if ( V_22 != 1 )
return - V_6 ;
F_25 ( & V_7 ) ;
V_45 = F_18 ( V_97 ) ;
...
V_22 = V_96 -> V_45 -> V_66 ( V_96 , V_81 , NULL ) ;
if ( V_22 )
F_39 ( V_3 , L_25 ,
V_5 , V_96 -> V_45 -> V_32 , V_22 ) ;
V_26:
...
static T_2 F_76 ( struct V_2 * V_98 ,
struct V_93 * V_94 ,
char * V_95 )
{
struct V_31 * V_33 ;
...
F_25 ( & V_7 ) ;
F_7 (tmp_governor, &devfreq_governor_list, node)
V_19 += F_77 ( & V_95 [ V_19 ] , ( V_99 - V_19 - 2 ) ,
L_26 , V_33 -> V_32 ) ;
F_28 ( & V_7 ) ;
if ( V_19 )
V_19 -- ;
V_19 += sprintf ( & V_95 [ V_19 ] , L_27 ) ;
return V_19 ;
}
static T_2 F_78 ( struct V_2 * V_3 , struct V_93 * V_94 ,
char * V_95 )
{
unsigned long V_10 ;
struct V_1 * V_1 = F_44 ( V_3 ) ;
if ( V_1 -> V_12 -> V_50 &&
! V_1 -> V_12 -> V_50 ( V_1 -> V_3 . V_8 , & V_10 ) )
return sprintf ( V_95 , L_28 , V_10 ) ;
return sprintf ( V_95 , L_28 , V_1 -> V_25 ) ;
}
static T_2 F_79 ( struct V_2 * V_3 ,
struct V_93 * V_94 , char * V_95 )
{
return sprintf ( V_95 , L_28 , F_44 ( V_3 ) -> V_25 ) ;
}
static T_2 F_80 ( struct V_2 * V_3 ,
struct V_93 * V_94 , char * V_95 )
{
return sprintf ( V_95 , L_29 , F_44 ( V_3 ) -> V_12 -> V_57 ) ;
}
...
static T_2 F_83 ( struct V_2 * V_3 , struct V_93 * V_94 ,
const char * V_95 , T_3 V_19 )
{
struct V_1 * V_96 = F_44 ( V_3 ) ;
unsigned long V_100 ;
...
static T_2 F_84 ( struct V_2 * V_98 ,
struct V_93 * V_94 ,
char * V_95 )
{
...
return 0 ;
if ( V_13 == 0 )
return sprintf ( V_95 , L_33 ) ;
V_105 = sprintf ( V_95 , L_34 ) ;
...
V_105 += sprintf ( V_95 + V_105 , L_43 ,
V_1 -> V_30 ) ;
return V_105 ;
}
static int T_4 F_87 ( void )
{
V_73 = F_88 ( V_107 , L_13 ) ;
if ( F_14 ( V_73 ) ) {
F_3 ( L_44 , __FILE__ ) ;
return F_54 ( V_73 ) ;
}
...
struct V_16 * F_91 ( struct V_2 * V_3 ,
unsigned long * V_10 ,
T_1 V_43 )
{
struct V_16 * V_17 ;
...
F_16 () ;
if ( ! V_22 )
V_22 = F_95 ( V_112 , & V_1 -> V_63 ) ;
return V_22 ;
}
int F_96 ( struct V_2 * V_3 , struct V_1 * V_1 )
{
struct V_111 * V_112 ;
int V_22 = 0 ;
F_12 () ;
...
F_16 () ;
if ( ! V_22 )
V_22 = F_97 ( V_112 , & V_1 -> V_63 ) ;
return V_22 ;
}
static void F_98 ( struct V_2 * V_3 , void * V_82 )
{
F_96 ( V_3 , * (struct V_1 * * ) V_82 ) ;
}
...
struct V_1 * * V_84 ;
int V_22 ;
V_84 = F_61 ( F_98 , sizeof( * V_84 ) , V_20 ) ;
if ( ! V_84 )
return - V_71 ;
V_22 = F_93 ( V_3 , V_1 ) ;
if ( V_22 ) {
...
static void F_103 ( struct V_2 * V_3 , void * V_82 )
{
struct V_115 * V_116 = V_82 ;
F_102 ( V_116 -> V_1 , V_116 -> V_63 , V_116 -> V_113 ) ;
}
...
struct V_115 * V_84 ;
int V_22 ;
V_84 = F_61 ( F_103 , sizeof( * V_84 ) ,
V_20 ) ;
if ( ! V_84 )
return - V_71 ;
V_22 = F_101 ( V_1 , V_63 , V_113 ) ;
if ( V_22 ) {
F_62 ( V_84 ) ;
return V_22 ;
}
