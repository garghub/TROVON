...
unsigned int V_116 ;
int V_60 ;
V_116 = F_72 ( F_73 ( V_6 -> V_63 ) , V_117 ) ;
F_31 ( V_116 > V_118 ) ;
V_13 -> V_15 = V_116 - 1 ;
F_74 ( V_6 , V_119 , V_6 -> V_69 ,
L_13 ,
F_33 ( V_13 ) , V_6 -> V_63 ,
V_13 -> V_15 ) ;
V_13 -> V_120 = F_75 ( V_116 , sizeof( * V_13 -> V_120 ) ,
V_45 ) ;
if ( ! V_13 -> V_120 )
return - V_46 ;
V_60 = F_76 ( V_13 ) ;
...
F_74 ( V_13 -> V_6 , V_128 , V_13 -> V_6 -> V_69 ,
L_14 , F_33 ( V_13 ) ) ;
V_13 -> V_48 = 0 ;
V_13 -> V_70 = 0 ;
V_13 -> V_62 = 0 ;
...
if ( V_130 != 0 ) {
V_126 = V_67 * F_82 ( V_130 , 100U ) / 100U ;
if ( V_126 > V_127 )
V_126 = V_127 ;
} else {
V_126 = V_127 ;
...
int F_88 ( struct V_133 * V_69 , const struct V_83 * V_84 ,
T_5 V_134 , T_2 V_135 )
{
struct V_5 * V_6 = F_89 ( V_69 ) ;
struct V_52 * V_53 ;
struct V_136 V_137 ;
struct V_138 V_139 ;
int V_60 ;
if ( V_135 == V_140 )
return - V_141 ;
if ( ! F_90 ( V_84 , & V_139 , 0 ) )
return - V_142 ;
if ( V_139 . V_143 . V_144 != F_91 ( V_145 ) && V_139 . V_143 . V_144 != F_91 ( V_146 ) )
return - V_142 ;
...
if ( V_139 . V_143 . V_144 == F_91 ( V_145 ) ) {
...
++ V_53 -> V_173 ;
if ( V_137 . V_158 == F_91 ( V_145 ) )
F_94 ( V_6 , V_68 , V_6 -> V_69 ,
L_17 ,
( V_137 . V_159 == V_174 ) ? L_18 : L_19 ,
V_137 . V_160 , F_95 ( V_137 . V_168 ) , V_137 . V_164 ,
F_95 ( V_137 . V_170 ) , V_134 , V_135 , V_60 ) ;
else
F_94 ( V_6 , V_68 , V_6 -> V_69 ,
L_20 ,
( V_137 . V_159 == V_174 ) ? L_18 : L_19 ,
...
bool F_96 ( struct V_5 * V_6 , unsigned int V_175 )
{
bool (* F_97)( struct V_5 * V_6 , T_2 V_135 , unsigned int V_33 );
...
while ( V_175 -- ) {
struct V_52 * V_53 = F_93 ( V_6 , V_176 ) ;
...
bool F_100 ( const struct V_136 * V_137 )
{
if ( ! ( V_137 -> V_49 & V_184 ) ||
V_137 -> V_185 == V_186 )
return false ;
