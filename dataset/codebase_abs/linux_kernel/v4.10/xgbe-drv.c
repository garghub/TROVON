...
static struct V_392 * F_137 ( struct V_42 * V_30 ,
struct V_392 * V_393 )
{
struct V_1 * V_2 = F_72 ( V_30 ) ;
...
T_6 * V_333 ;
unsigned int V_454 ;
V_331 = F_150 ( V_112 , V_254 -> V_455 . V_456 . V_457 ) ;
if ( ! V_331 )
return NULL ;
F_151 ( V_2 -> V_65 , V_254 -> V_455 . V_456 . V_458 ,
V_254 -> V_455 . V_456 . V_459 ,
V_254 -> V_455 . V_456 . V_457 , V_460 ) ;
V_333 = F_152 ( V_254 -> V_455 . V_456 . V_461 . V_462 ) +
V_254 -> V_455 . V_456 . V_461 . V_463 ;
V_454 = ( V_254 -> V_455 . V_464 ) ? V_254 -> V_455 . V_464 : V_344 ;
V_454 = F_153 ( V_254 -> V_455 . V_456 . V_457 , V_454 ) ;
F_154 ( V_331 , V_333 , V_454 ) ;
F_155 ( V_331 , V_454 ) ;
V_344 -= V_454 ;
if ( V_344 ) {
F_151 ( V_2 -> V_65 ,
V_254 -> V_455 . V_465 . V_458 ,
V_254 -> V_455 . V_465 . V_459 ,
V_254 -> V_455 . V_465 . V_457 ,
V_460 ) ;
F_156 ( V_331 , F_105 ( V_331 ) -> V_360 ,
V_254 -> V_455 . V_465 . V_461 . V_462 ,
V_254 -> V_455 . V_465 . V_461 . V_463 ,
V_344 , V_254 -> V_455 . V_465 . V_457 ) ;
V_254 -> V_455 . V_465 . V_461 . V_462 = NULL ;
}
return V_331 ;
}
...
if ( V_39 -> V_471 ( V_467 ) ) {
V_347 += V_254 -> V_36 . V_472 ;
V_349 += V_254 -> V_36 . V_473 ;
}
V_252 -> V_256 ( V_2 , V_254 ) ;
V_39 -> V_474 ( V_254 ) ;
V_468 ++ ;
...
static int F_164 ( struct V_3 * V_5 , int V_476 )
{
struct V_1 * V_2 = V_5 -> V_2 ;
struct V_51 * V_39 = & V_2 -> V_39 ;
struct V_6 * V_32 = V_5 -> V_8 ;
...
struct V_330 * V_331 ;
struct V_285 * V_286 ;
unsigned int V_477 , error , V_478 , V_479 ;
unsigned int V_344 , V_480 , V_481 ;
...
while ( V_483 < V_476 ) {
F_42 ( L_72 , V_32 -> V_34 ) ;
if ( ! V_482 && V_254 -> V_484 ) {
V_331 = V_254 -> V_485 . V_331 ;
error = V_254 -> V_485 . error ;
V_344 = V_254 -> V_485 . V_344 ;
} else {
memset ( V_333 , 0 , sizeof( * V_333 ) ) ;
V_331 = NULL ;
error = 0 ;
...
V_482 ++ ;
V_32 -> V_34 ++ ;
V_477 = F_32 ( V_333 -> V_334 ,
V_489 ,
V_490 ) ;
V_478 = F_32 ( V_333 -> V_334 ,
V_489 ,
V_491 ) ;
V_479 = F_32 ( V_333 -> V_334 ,
V_489 ,
V_492 ) ;
if ( ( V_477 || V_478 ) && error )
goto V_486;
if ( error || V_333 -> V_493 ) {
if ( V_333 -> V_493 )
F_126 ( V_2 , V_494 , V_30 ,
L_73 ) ;
F_165 ( V_331 ) ;
goto V_495;
}
if ( ! V_479 ) {
V_480 = V_254 -> V_455 . V_344 - V_344 ;
V_344 += V_480 ;
if ( V_480 && ! V_331 ) {
...
if ( ! V_331 )
goto V_495;
V_481 = V_30 -> V_43 + V_45 ;
if ( ! ( V_30 -> V_430 & V_438 ) &&
( V_331 -> V_496 == F_166 ( V_497 ) ) )
V_481 += V_47 ;
if ( V_331 -> V_344 > V_481 ) {
F_126 ( V_2 , V_494 , V_30 ,
L_74 ) ;
F_165 ( V_331 ) ;
goto V_495;
...
if ( F_32 ( V_333 -> V_334 ,
V_489 , V_502 ) )
F_170 ( V_331 , V_333 -> V_503 ,
V_333 -> V_504 ) ;
V_331 -> V_65 = V_30 ;
V_331 -> V_496 = F_171 ( V_331 , V_30 ) ;
F_172 ( V_331 , V_5 -> V_20 ) ;
F_173 ( V_112 , V_331 ) ;
V_495:
V_483 ++ ;
}
if ( V_482 && ( V_477 || V_478 ) ) {
V_254 = F_68 ( V_32 , V_32 -> V_34 ) ;
V_254 -> V_484 = 1 ;
V_254 -> V_485 . V_331 = V_331 ;
V_254 -> V_485 . V_344 = V_344 ;
V_254 -> V_485 . error = error ;
}
F_42 ( L_75 , V_483 ) ;
return V_483 ;
}
static int V_231 ( struct V_148 * V_112 , int V_476 )
{
...
static int V_233 ( struct V_148 * V_112 , int V_476 )
{
...
F_42 ( L_78 , V_476 ) ;
V_468 = 0 ;
V_505 = V_476 / V_2 -> V_17 ;
do {
V_506 = V_468 ;
V_5 = V_2 -> V_5 ;
for ( V_10 = 0 ; V_10 < V_2 -> V_31 ; V_10 ++ , V_5 ++ ) {
F_157 ( V_5 ) ;
if ( V_505 > ( V_476 - V_468 ) )
V_505 = V_476 - V_468 ;
V_468 += F_164 ( V_5 , V_505 ) ;
}
} while ( ( V_468 < V_476 ) && ( V_468 != V_506 ) );
if ( V_468 < V_476 ) {
F_174 ( V_112 , V_468 ) ;
F_16 ( V_2 ) ;
}
...
unsigned int V_507 , unsigned int V_9 , unsigned int V_508 )
{
struct V_253 * V_254 ;
struct V_466 * V_467 ;
while ( V_9 -- ) {
V_254 = F_68 ( V_32 , V_507 ) ;
V_467 = V_254 -> V_467 ;
F_175 ( V_2 -> V_30 ,
L_80 , V_507 ,
( V_508 == 1 ) ? L_81 : L_82 ,
...
void F_177 ( struct V_1 * V_2 , struct V_6 * V_32 ,
unsigned int V_507 )
{
struct V_253 * V_254 ;
struct V_466 * V_467 ;
...
F_175 ( V_2 -> V_30 ,
L_83 ,
V_507 , F_176 ( V_467 -> V_509 ) , F_176 ( V_467 -> V_510 ) ,
F_176 ( V_467 -> V_511 ) , F_176 ( V_467 -> V_512 ) ) ;
}
void F_129 ( struct V_42 * V_30 , struct V_330 * V_331 , bool V_513 )
{
struct V_514 * V_515 = (struct V_514 * ) V_331 -> V_70 ;
unsigned char * V_465 = V_331 -> V_70 ;
unsigned char V_516 [ 128 ] ;
unsigned int V_10 , V_255 ;
F_175 ( V_30 , L_84 ) ;
F_175 ( V_30 , L_85 ,
( V_513 ? L_86 : L_87 ) , V_331 -> V_344 ) ;
F_175 ( V_30 , L_88 , V_515 -> V_517 ) ;
F_175 ( V_30 , L_89 , V_515 -> V_518 ) ;
F_175 ( V_30 , L_90 , F_178 ( V_515 -> V_519 ) ) ;
for ( V_10 = 0 , V_255 = 0 ; V_10 < V_331 -> V_344 ; ) {
V_255 += snprintf ( V_516 + V_255 , sizeof( V_516 ) - V_255 , L_91 ,
V_465 [ V_10 ++ ] ) ;
if ( ( V_10 % 32 ) == 0 ) {
F_175 ( V_30 , L_92 , V_10 - 32 , V_516 ) ;
V_255 = 0 ;
} else if ( ( V_10 % 16 ) == 0 ) {
V_516 [ V_255 ++ ] = ' ' ;
V_516 [ V_255 ++ ] = ' ' ;
...
if ( V_10 % 32 )
F_175 ( V_30 , L_92 , V_10 - ( V_10 % 32 ) , V_516 ) ;
F_175 ( V_30 , L_84 ) ;
}
