...
V_21 -> V_93 [ V_13 ] = F_29 ( V_68 + 1 + V_13 * 4 ) ;
F_7 ( F_1 ( V_3 ) , L_9 ,
V_13 , V_21 -> V_93 [ V_13 ] ) ;
}
} else {
V_21 -> V_93 [ 0 ] = F_29 ( V_68 + 1 ) ;
F_7 ( F_1 ( V_3 ) , L_10 ,
V_21 -> V_93 [ 0 ] ) ;
}
V_73:
...
T_1 V_95 , T_2 * V_96 , int V_97 , int V_67 )
{
struct V_19 * V_6 = V_3 -> V_6 ;
int V_65 ;
T_2 V_98 ;
F_7 ( F_1 ( V_3 ) , L_5 ,
V_72 , V_21 -> V_25 , V_21 -> V_27 ) ;
if ( ! V_96 )
V_97 = 0 ;
if ( V_21 -> V_25 == V_99 )
V_98 = V_100 ;
...
V_85 , V_85 ) ;
F_36 ( V_6 ) ;
V_65 = F_37 ( V_6 , V_14 -> V_57 , V_3 -> V_60 , 1 , 10000 ) ;
if ( V_65 < 0 ) {
F_8 ( V_3 ) ;
F_2 ( V_3 ) ;
return V_65 ;
...
V_85 , V_85 ) ;
F_36 ( V_6 ) ;
V_65 = F_37 ( V_6 , V_14 -> V_57 , V_3 -> V_60 , 0 , 10000 ) ;
if ( V_65 < 0 ) {
F_2 ( V_3 ) ;
return V_65 ;
}
...
int V_65 ;
struct V_20 V_21 = { 0 } ;
V_65 = F_47 ( V_3 , V_137 , true ) ;
if ( V_65 < 0 )
return V_65 ;
V_21 . V_25 = V_25 ;
V_65 = F_30 ( V_3 , & V_21 , 0x40 , NULL , 0 , 100 ) ;
if ( V_65 < 0 ) {
F_51 ( V_3 ) ;
F_2 ( V_3 ) ;
return V_65 ;
...
if ( V_65 < 0 )
return V_65 ;
V_65 = F_3 ( V_6 , V_192 , V_193 , V_193 ) ;
if ( V_65 < 0 )
return V_65 ;
V_3 -> V_188 = V_189 ;
return 0 ;
...
V_3 -> V_188 = V_194 ;
F_26 ( V_6 ) ;
F_12 ( V_6 , V_22 , V_190 , V_191 , 0 ) ;
F_12 ( V_6 , V_22 , V_192 , V_193 , 0 ) ;
V_65 = F_27 ( V_6 , 100 ) ;
if ( V_65 < 0 )
return V_65 ;
V_65 = F_74 ( V_6 , V_167 ) ;
...
static int F_77 ( struct V_2 * V_3 , unsigned char V_197 )
{
struct V_19 * V_6 = V_3 -> V_6 ;
int V_65 = 0 ;
F_26 ( V_6 ) ;
...
F_12 ( V_6 , V_22 , V_139 ,
V_201 , V_201 ) ;
F_12 ( V_6 , V_22 , V_202 , 0xFF ,
V_203 | V_204 | V_205 ) ;
F_12 ( V_6 , V_22 , V_139 , V_201 , 0 ) ;
break;
case V_206 :
case V_207 :
F_12 ( V_6 , V_22 , V_130 ,
...
static void F_78 ( struct V_61 * V_62 , struct V_224 * V_225 )
{
struct V_2 * V_3 = F_22 ( V_62 ) ;
struct V_19 * V_6 = V_3 -> V_6 ;
if ( V_3 -> V_164 )
...
F_62 ( & V_6 -> V_168 ) ;
F_63 ( V_6 ) ;
F_69 ( V_3 , V_225 -> V_180 ) ;
F_76 ( V_3 , V_225 -> V_195 ) ;
F_77 ( V_3 , V_225 -> V_197 ) ;
V_3 -> V_171 = false ;
V_3 -> V_170 = true ;
switch ( V_225 -> V_197 ) {
case V_198 :
...
V_3 -> V_136 = ( V_225 -> clock <= 1000000 ) ? true : false ;
V_3 -> clock = V_225 -> clock ;
F_64 ( V_6 , V_225 -> clock , V_3 -> V_169 ,
V_3 -> V_136 , V_3 -> V_170 , V_3 -> V_171 ) ;
F_65 ( & V_6 -> V_168 ) ;
}
...
struct V_19 * V_6 = V_3 -> V_6 ;
int V_65 ;
T_2 V_233 , V_239 , V_153 ;
F_85 ( 50 ) ;
V_65 = F_3 ( V_6 , V_76 , 0xFF , V_77 ) ;
if ( V_65 < 0 )
return V_65 ;
F_85 ( 20 ) ;
V_65 = F_6 ( V_6 , V_76 , & V_233 ) ;
...
V_237 | V_238 ;
V_153 = V_234 | V_235 | V_236 |
V_237 | V_238 ;
if ( ( V_233 & V_239 ) != V_153 ) {
F_7 ( F_1 ( V_3 ) ,
L_24 , V_72 , V_233 ) ;
F_3 ( V_6 , V_76 ,
V_77 | V_94 , 0 ) ;
F_3 ( V_6 , V_190 , 0xFF , 0 ) ;
return - V_46 ;
}
return 0 ;
}
static int F_86 ( struct V_61 * V_62 , struct V_224 * V_225 )
{
struct V_2 * V_3 = F_22 ( V_62 ) ;
struct V_19 * V_6 = V_3 -> V_6 ;
int V_65 = 0 ;
...
F_62 ( & V_6 -> V_168 ) ;
F_63 ( V_6 ) ;
switch ( V_62 -> V_225 . V_197 ) {
case V_198 :
V_65 = F_47 ( V_3 , F_89 ( V_6 ) , false ) ;
break;
case V_199 :
V_65 = F_47 ( V_3 , F_90 ( V_6 ) , false ) ;
break;
case V_207 :
V_65 = F_47 ( V_3 , F_91 ( V_6 ) , false ) ;
break;
default:
V_65 = 0 ;
}
if ( V_65 )
goto V_73;
if ( ( V_62 -> V_225 . V_197 == V_198 ) ||
( V_62 -> V_225 . V_197 == V_199 ) )
V_65 = F_55 ( V_3 , V_25 ) ;
else if ( V_62 -> V_225 . V_197 == V_207 )
V_65 = F_47 ( V_3 , F_92 ( V_6 ) , true ) ;
V_73:
F_65 ( & V_6 -> V_168 ) ;
return V_65 ;
}
...
struct V_61 * V_62 = V_3 -> V_62 ;
V_62 -> V_257 = 250000 ;
V_62 -> V_258 = 208000000 ;
V_62 -> V_259 = V_260 | V_261 | V_262 ;
V_62 -> V_247 = V_263 | V_264 |
V_265 | V_266 |
V_267 | V_268 | V_269 ;
...
V_3 -> V_56 = - 1 ;
V_3 -> V_188 = V_194 ;
F_100 ( & V_3 -> V_162 , F_59 ) ;
F_101 ( V_4 , V_3 ) ;
V_6 -> V_287 [ V_167 ] . V_288 = V_4 ;
V_6 -> V_287 [ V_167 ] . V_289 = F_95 ;
F_102 ( & V_3 -> V_177 ) ;
F_94 ( V_3 ) ;
F_103 ( V_62 ) ;
return 0 ;
}
static int F_104 ( struct V_282 * V_4 )
{
struct V_2 * V_3 = F_96 ( V_4 ) ;
struct V_19 * V_6 ;
struct V_61 * V_62 ;
...
return 0 ;
V_6 = V_3 -> V_6 ;
V_6 -> V_287 [ V_167 ] . V_288 = NULL ;
V_6 -> V_287 [ V_167 ] . V_289 = NULL ;
V_62 = V_3 -> V_62 ;
F_105 ( & V_3 -> V_162 ) ;
F_62 ( & V_3 -> V_177 ) ;
if ( V_3 -> V_64 ) {
