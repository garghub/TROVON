...
if ( V_194 -> V_316 == V_317 )
error = V_194 -> V_315 ;
else
error = F_149 ( V_194 -> V_315 ) ;
}
F_57 ( V_3 ) ;
F_150 ( V_194 , error ) ;
}
static int
F_151 ( struct V_1 * V_3 )
{
V_204 V_318 ;
int error ;
F_102 ( V_3 , 0 , V_319 ) ;
...
V_3 -> V_260 . V_51 = & V_320 ;
V_3 -> V_260 . V_321 = V_319 ;
V_3 -> V_260 . V_322 = 2 ;
V_3 -> V_260 . V_241 = V_323 ;
V_3 -> V_260 . V_324 = sizeof( struct V_15 ) +
( V_238 *
sizeof( struct V_79 ) ) +
V_3 -> V_64 -> V_51 -> V_325 ;
V_3 -> V_260 . V_252 = V_3 ;
V_3 -> V_260 . V_326 = 1 ;
V_3 -> V_260 . V_142 = V_327 ;
error = F_152 ( & V_3 -> V_260 ) ;
if ( error )
goto V_328;
V_3 -> V_3 . V_259 = F_153 ( & V_3 -> V_260 ) ;
if ( F_154 ( V_3 -> V_3 . V_259 ) ) {
error = F_155 ( V_3 -> V_3 . V_259 ) ;
goto V_329;
}
...
if ( error )
goto V_331;
error = F_157 ( & V_3 -> V_3 , V_332 , & V_3 -> V_333 ) ;
if ( error ) {
F_62 ( V_3 -> V_3 . V_23 ,
L_13 ) ;
goto V_331;
...
V_3 -> V_3 . V_127 =
F_73 ( int , F_158 ( V_3 -> V_333 ) + 1 , V_3 -> V_3 . V_127 ) ;
error = F_159 ( & V_3 -> V_3 , V_3 -> V_333 ) ;
if ( error )
goto V_331;
V_318 = F_73 ( V_204 , V_334 ,
V_3 -> V_64 -> V_51 -> V_35 ) ;
V_3 -> V_3 . V_335 = ( V_318 - 1 ) << ( V_336 - 9 ) ;
error = F_160 ( & V_3 -> V_3 ) ;
if ( error )
goto V_331;
F_161 ( & V_3 -> V_3 ) ;
...
static void
F_162 ( struct V_193 * V_94 , void * V_192 , bool V_274 )
{
...
static void
F_172 ( struct V_338 * V_339 )
{
struct V_1 * V_3 =
F_2 ( V_339 , struct V_1 , V_340 ) ;
F_168 ( V_3 ) ;
}
static int
F_38 ( struct V_1 * V_3 )
{
if ( ! F_173 ( & V_3 -> V_3 , V_341 ) )
return - V_301 ;
if ( ! F_174 ( V_342 , & V_3 -> V_340 ) )
return - V_301 ;
return 0 ;
}
static int
F_175 ( struct V_2 * V_267 )
{
struct V_1 * V_3 = F_1 ( V_267 ) ;
...
static int
F_177 ( struct V_2 * V_267 )
{
return - V_226 ;
}
static int
F_178 ( struct V_1 * V_3 )
{
struct V_343 * V_130 = V_3 -> V_3 . V_130 ;
int V_27 ;
V_27 = F_179 ( & V_3 -> V_3 , & V_130 -> V_344 ) ;
if ( V_27 ) {
F_180 ( V_3 -> V_3 . V_23 ,
L_14 , V_27 ) ;
return V_27 ;
}
V_3 -> V_261 = V_130 -> V_344 + 1 ;
if ( ! V_130 -> V_344 )
return 0 ;
F_180 ( V_3 -> V_3 . V_23 , L_15 ,
V_130 -> V_344 ) ;
F_116 ( V_3 ) ;
memset ( & V_3 -> V_270 , 0 , sizeof( V_3 -> V_270 ) ) ;
V_3 -> V_270 . V_51 = & V_345 ;
V_3 -> V_270 . V_321 = V_3 -> V_3 . V_130 -> V_253 ;
V_3 -> V_270 . V_322 = 1 ;
V_3 -> V_270 . V_241 = V_323 ;
V_3 -> V_270 . V_26 = V_346 ;
V_3 -> V_270 . V_324 = sizeof( struct V_15 ) +
( V_238 *
sizeof( struct V_79 ) ) +
V_3 -> V_64 -> V_51 -> V_325 ;
V_3 -> V_270 . V_252 = V_3 ;
V_3 -> V_270 . V_326 = V_3 -> V_261 - 1 ;
V_3 -> V_270 . V_142 = V_347 ;
V_27 = F_152 ( & V_3 -> V_270 ) ;
if ( V_27 )
return V_27 ;
V_3 -> V_3 . V_268 = & V_3 -> V_270 ;
V_3 -> V_3 . V_269 = F_153 ( & V_3 -> V_270 ) ;
if ( F_154 ( V_3 -> V_3 . V_269 ) ) {
V_27 = F_155 ( V_3 -> V_3 . V_269 ) ;
goto V_348;
}
...
static struct V_2 *
F_181 ( struct V_23 * V_24 , struct V_343 * V_130 ,
...
V_3 -> V_209 = V_264 ;
V_3 -> V_266 = V_28 ;
V_27 = F_182 ( & V_3 -> V_3 , V_24 , & V_354 , 0 ) ;
if ( V_27 )
goto V_355;
F_10 ( V_3 -> V_24 ) ;
F_12 ( & V_3 -> V_50 ) ;
F_183 ( & V_3 -> V_340 , F_172 ) ;
F_32 ( & V_3 -> V_71 ) ;
V_3 -> V_261 = F_73 (unsigned int,
opts->nr_io_queues,
lport->ops->max_hw_queues) ;
V_130 -> V_344 = V_3 -> V_261 ;
V_3 -> V_261 ++ ;
V_3 -> V_3 . V_127 = V_130 -> V_253 - 1 ;
V_3 -> V_3 . V_356 = V_130 -> V_356 ;
V_27 = - V_42 ;
V_3 -> V_242 = F_184 ( V_3 -> V_261 , sizeof( struct V_109 ) ,
V_41 ) ;
if ( ! V_3 -> V_242 )
goto V_357;
V_27 = F_151 ( V_3 ) ;
...
if ( V_3 -> V_3 . V_359 != 1 ) {
F_62 ( V_3 -> V_3 . V_23 , L_17 ,
V_3 -> V_3 . V_359 ) ;
goto V_358;
}
if ( V_3 -> V_3 . V_360 ) {
F_62 ( V_3 -> V_3 . V_23 , L_18 ,
V_3 -> V_3 . V_360 ) ;
goto V_358;
}
if ( V_130 -> V_253 > V_3 -> V_3 . V_361 ) {
F_185 ( V_3 -> V_3 . V_23 ,
L_19
L_20 ,
V_130 -> V_253 , V_3 -> V_3 . V_361 ) ;
V_130 -> V_253 = V_3 -> V_3 . V_361 ;
}
V_27 = F_98 ( V_3 ) ;
if ( V_27 )
...
static int
F_190 ( struct V_364 * V_365 , char * V_366 )
{
T_4 args [ V_367 ] ;
char * V_368 , * V_369 , * V_370 ;
int V_371 , V_27 = 0 ;
V_229 V_372 ;
V_368 = V_369 = F_191 ( V_366 , V_41 ) ;
if ( ! V_368 )
return - V_42 ;
while ( ( V_370 = F_192 ( & V_369 , L_22 ) ) != NULL ) {
if ( ! * V_370 )
continue;
V_371 = F_193 ( V_370 , V_373 , args ) ;
switch ( V_371 ) {
case V_374 :
if ( F_194 ( args , & V_372 ) ) {
V_27 = - V_38 ;
...
static struct V_2 *
F_196 ( struct V_23 * V_24 , struct V_343 * V_130 )
{
struct V_4 * V_64 ;
struct V_8 * V_72 ;
struct V_364 V_379 = { 0L , 0L } ;
struct V_364 V_380 = { 0L , 0L } ;
unsigned long V_26 ;
int V_27 ;
V_27 = F_190 ( & V_380 , V_130 -> V_365 ) ;
if ( V_27 || ! V_380 . V_376 || ! V_380 . V_378 )
return F_189 ( - V_38 ) ;
V_27 = F_190 ( & V_379 , V_130 -> V_381 ) ;
if ( V_27 || ! V_379 . V_376 || ! V_379 . V_378 )
return F_189 ( - V_38 ) ;
F_14 ( & V_61 , V_26 ) ;
F_37 (lport, &nvme_fc_lport_list, port_list) {
if ( V_64 -> V_7 . V_54 != V_379 . V_376 ||
V_64 -> V_7 . V_55 != V_379 . V_378 )
continue;
F_37 (rport, &lport->endp_list, endp_list) {
if ( V_72 -> V_10 . V_54 != V_380 . V_376 ||
V_72 -> V_10 . V_55 != V_380 . V_378 )
continue;
if ( ! F_35 ( V_72 ) )
break;
F_16 ( & V_61 , V_26 ) ;
return F_181 ( V_24 , V_130 , V_64 , V_72 ) ;
}
}
F_16 ( & V_61 , V_26 ) ;
return F_189 ( - V_382 ) ;
}
static int T_5 F_197 ( void )
{
V_342 = F_198 ( L_24 ) ;
if ( ! V_342 )
return - V_42 ;
