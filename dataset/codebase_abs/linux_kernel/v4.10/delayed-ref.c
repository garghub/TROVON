...
F_41 ( V_81 && V_81 -> V_55 ) ;
V_37 = F_53 ( V_95 , V_101 ) ;
if ( ! V_37 )
return - V_102 ;
V_88 = F_53 ( V_103 , V_101 ) ;
if ( ! V_88 )
goto V_104;
if ( F_54 ( V_105 , & V_54 -> V_106 ) &&
F_44 ( V_89 ) ) {
V_100 = F_55 ( sizeof( * V_100 ) , V_101 ) ;
if ( ! V_100 )
goto V_107;
}
V_88 -> V_81 = V_81 ;
...
int F_57 ( struct V_53 * V_54 ,
struct V_25 * V_26 ,
T_1 V_19 , T_1 V_68 ,
T_1 V_6 , T_1 V_89 ,
T_1 V_96 , T_1 V_11 , T_1 V_108 , int V_51 ,
struct V_98 * V_81 )
{
struct V_7 * V_37 ;
struct V_12 * V_88 ;
...
struct V_12 *
F_59 ( struct V_25 * V_26 , T_1 V_19 )
{
struct V_28 * V_29 ;
V_29 = & V_26 -> V_30 -> V_29 ;
