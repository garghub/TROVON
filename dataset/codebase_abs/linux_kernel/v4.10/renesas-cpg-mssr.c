...
int F_34 ( struct V_70 * V_71 , struct V_10 * V_11 )
{
...
while ( ! F_35 ( V_66 , L_18 , L_19 , V_14 ,
& V_21 ) ) {
if ( F_33 ( & V_21 , V_65 ) )
goto V_74;
F_36 ( V_21 . V_66 ) ;
...
error = F_38 ( V_11 ) ;
if ( error ) {
F_12 ( V_11 , L_20 , error ) ;
goto V_75;
}
error = F_39 ( V_11 , V_16 ) ;
if ( error ) {
F_12 ( V_11 , L_21 , V_16 , error ) ;
goto V_76;
}
return 0 ;
V_76:
...
void F_42 ( struct V_70 * V_71 , struct V_10 * V_11 )
{
if ( ! F_43 ( & V_11 -> V_77 . V_78 -> V_79 ) )
F_40 ( V_11 ) ;
}
static int T_2 F_44 ( struct V_10 * V_11 ,
...
V_65 = F_45 ( V_11 , sizeof( * V_65 ) + V_81 , V_54 ) ;
if ( ! V_65 )
return - V_55 ;
V_65 -> V_66 = V_66 ;
V_65 -> V_68 = V_68 ;
...
static int T_2 F_50 ( struct V_86 * V_87 )
{
...
struct V_16 * * V_28 ;
int error ;
V_35 = F_51 ( V_91 , V_66 ) -> V_22 ;
if ( V_35 -> V_53 ) {
error = V_35 -> V_53 ( V_11 ) ;
if ( error )
return error ;
}
V_6 = F_45 ( V_11 , sizeof( * V_6 ) , V_54 ) ;
if ( ! V_6 )
return - V_55 ;
V_6 -> V_11 = V_11 ;
F_52 ( & V_6 -> V_17 ) ;
V_90 = F_53 ( V_87 , V_92 , 0 ) ;
V_6 -> V_18 = F_54 ( V_11 , V_90 ) ;
if ( F_19 ( V_6 -> V_18 ) )
return F_20 ( V_6 -> V_18 ) ;
V_88 = V_35 -> V_93 + V_35 -> V_94 ;
V_28 = F_55 ( V_11 , V_88 , sizeof( * V_28 ) , V_54 ) ;
if ( ! V_28 )
return - V_55 ;
V_6 -> V_28 = V_28 ;
V_6 -> V_31 = V_35 -> V_93 ;
...
F_28 ( & V_35 -> V_96 [ V_14 ] , V_35 , V_6 ) ;
error = F_56 ( V_66 , F_16 , V_6 ) ;
if ( error )
return error ;
error = F_57 ( V_11 ,
F_48 ,
