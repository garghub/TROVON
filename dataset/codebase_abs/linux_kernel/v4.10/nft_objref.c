...
struct V_29 * V_30 ;
int V_41 ;
V_30 = F_19 ( V_11 -> V_20 , V_13 [ V_42 ] , V_14 ) ;
if ( F_8 ( V_30 ) ) {
if ( V_13 [ V_43 ] ) {
V_30 = F_20 ( V_11 -> V_15 ,
V_13 [ V_43 ] ,
...
if ( ! ( V_30 -> V_44 & V_45 ) )
return - V_19 ;
V_28 -> V_37 = F_22 ( V_13 [ V_46 ] ) ;
V_41 = F_23 ( V_28 -> V_37 , V_30 -> V_47 ) ;
if ( V_41 < 0 )
return V_41 ;
V_28 -> V_48 . V_44 = V_30 -> V_44 & V_45 ;
V_41 = F_24 ( V_11 , V_30 , & V_28 -> V_48 ) ;
if ( V_41 < 0 )
return V_41 ;
V_28 -> V_30 = V_30 ;
return 0 ;
}
static int F_25 ( struct V_23 * V_24 , const struct V_1 * V_2 )
{
const struct V_27 * V_28 = F_15 ( V_2 ) ;
if ( F_26 ( V_24 , V_46 , V_28 -> V_37 ) ||
...
{
struct V_27 * V_28 = F_15 ( V_2 ) ;
F_28 ( V_11 , V_28 -> V_30 , & V_28 -> V_48 ) ;
}
static const struct V_49 *
F_29 ( const struct V_10 * V_11 ,
const struct V_12 * const V_13 [] )
{
if ( V_13 [ V_46 ] &&
( V_13 [ V_42 ] ||
