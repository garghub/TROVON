...
if ( F_14 ( V_34 , V_22 , V_8 -> V_10 ) )
goto V_35;
if ( F_14 ( V_34 , V_23 , V_8 -> V_15 ) )
goto V_35;
if ( F_15 ( V_34 , V_24 , F_16 ( V_8 -> V_12 ) ) )
goto V_35;
if ( F_15 ( V_34 , V_25 , F_16 ( V_8 -> V_14 ) ) )
goto V_35;
if ( F_15 ( V_34 , V_31 , F_16 ( V_8 -> V_13 ) ) )
goto V_35;
if ( V_8 -> V_16 != 0 )
if ( F_15 ( V_34 , V_27 , F_16 ( V_8 -> V_16 ) ) )
goto V_35;
return 0 ;
V_35:
return - 1 ;
