...
struct V_35 * V_60 )
{
struct V_51 * V_52 = F_12 ( V_2 , V_3 ) ;
if ( ! F_23 ( V_2 -> V_61 ) )
return F_24 ( V_2 , V_3 , 0 , V_60 ) ;
return F_25 ( V_52 , V_60 ) ;
}
static int
F_26 ( struct V_1 * V_2 , int V_3 , T_3 V_34 ,
struct V_35 * V_36 )
{
F_14 ( V_2 , V_3 , V_34 , V_36 ) ;
return F_27 ( V_2 -> V_22 , V_36 ) ;
}
static void
F_28 ( struct V_1 * V_2 , int V_3 ,
enum V_62 V_63 )
{
}
static void
F_29 ( struct V_1 * V_2 , int V_3 ,
T_3 V_64 [ V_65 ] )
{
}
static void
F_30 ( struct V_1 * V_2 , int V_3 ,
T_3 V_64 [ V_65 ] )
{
}
