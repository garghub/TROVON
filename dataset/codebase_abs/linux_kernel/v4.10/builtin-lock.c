...
V_89 = F_51 ( & V_111 , false , & V_106 ) ;
if ( ! V_89 ) {
F_9 ( L_37 ) ;
return - 1 ;
}
F_52 ( & V_89 -> V_101 . V_117 ) ;
if ( ! F_53 ( V_89 , L_38 ) )
goto V_118;
if ( F_54 ( V_89 , V_119 ) ) {
F_9 ( L_39 ) ;
...
const char * * V_125 ;
for ( V_22 = 0 ; V_22 < F_59 ( V_119 ) ; V_22 ++ ) {
if ( ! F_60 ( V_119 [ V_22 ] . V_24 ) ) {
F_9 ( L_46
L_47 ,
V_119 [ V_22 ] . V_24 ) ;
return 1 ;
...
V_123 = F_59 ( V_122 ) + V_120 - 1 ;
V_123 += 2 * F_59 ( V_119 ) ;
V_125 = calloc ( V_123 + 1 , sizeof( char * ) ) ;
if ( ! V_125 )
return - V_48 ;
for ( V_22 = 0 ; V_22 < F_59 ( V_122 ) ; V_22 ++ )
V_125 [ V_22 ] = F_61 ( V_122 [ V_22 ] ) ;
for ( V_124 = 0 ; V_124 < F_59 ( V_119 ) ; V_124 ++ ) {
V_125 [ V_22 ++ ] = L_48 ;
V_125 [ V_22 ++ ] = F_61 ( V_119 [ V_124 ] . V_24 ) ;
}
for ( V_124 = 1 ; V_124 < ( unsigned int ) V_120 ; V_124 ++ , V_22 ++ )
V_125 [ V_22 ] = V_121 [ V_124 ] ;
F_4 ( V_22 != V_123 ) ;
V_32 = F_62 ( V_22 , V_125 , NULL ) ;
free ( V_125 ) ;
return V_32 ;
}
int F_63 ( int V_120 , const char * * V_121 , const char * T_5 V_95 )
{
...
F_64 ( 'm' , L_51 , & V_93 ,
L_52 ) ,
F_64 ( 'f' , L_53 , & V_116 , L_54 ) ,
F_65 ()
} ;
const struct V_126 V_128 [] = {
F_66 ( 'i' , L_55 , & V_113 , L_56 , L_57 ) ,
F_67 ( 'v' , L_58 , & V_129 , L_59 ) ,
F_64 ( 'D' , L_60 , & V_130 , L_61 ) ,
F_65 ()
} ;
const struct V_126 V_131 [] = {
F_66 ( 'k' , L_62 , & V_25 , L_9 ,
L_63 ) ,
F_64 ( 'f' , L_53 , & V_116 , L_54 ) ,
F_65 ()
} ;
...
for ( V_22 = 0 ; V_22 < V_90 ; V_22 ++ )
F_10 ( V_136 + V_22 ) ;
V_120 = F_68 ( V_120 , V_121 , V_128 , V_133 ,
V_134 , V_137 ) ;
if ( ! V_120 )
F_69 ( V_134 , V_128 ) ;
