...
unsigned long V_7 ;
F_36 (sdev, shost) {
if ( F_33 ( V_21 ) && V_21 -> V_145 && V_21 -> V_242 ) {
F_106 ( V_21 ) ;
V_21 -> V_145 = 0 ;
}
}
...
void F_128 ( struct V_1 * V_2 , int V_122 , int V_255 )
{
struct V_20 * V_21 ;
F_126 (sdev, shost) {
if ( V_122 == F_127 ( V_21 ) &&
...
int
F_131 ( struct V_20 * V_256 , int T_1 * V_257 )
{
struct V_17 * V_18 ;
...
if ( ! F_132 ( V_259 ) || ! F_132 ( V_260 ) )
return - V_261 ;
error = F_133 ( V_258 , V_257 ) ;
if ( error )
return error ;
if ( F_124 ( V_2 ) < 0 )
return - V_262 ;
error = - V_262 ;
V_18 = F_134 ( V_256 , V_236 ) ;
if ( ! V_18 )
goto V_263;
F_135 ( NULL , & V_46 ) ;
V_18 -> V_45 = & V_46 ;
...
int F_138 ( const T_2 * V_92 , int V_272 ,
T_3 * V_273 )
{
int V_274 ;
const T_2 * V_275 ;
