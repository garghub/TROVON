...
if ( ! V_7 -> V_16 )
continue;
V_19 = ( void * V_24 ) V_2 -> V_25 + F_6 ( V_7 -> V_13 ) ;
V_22 = V_7 -> V_14 - V_7 -> V_15 ;
V_21 = V_7 -> V_13 - V_8 ;
F_7 ( V_2 , L_3 ,
V_23 , V_12 [ V_5 ] . V_26 , V_22 , V_21 ) ;
F_8 ( ( void * V_24 ) ( V_17 + V_21 ) ,
( const void V_27 * V_24 ) V_19 , V_22 ) ;
}
return 0 ;
}
...
if ( ! V_28 )
return;
if ( F_4 ( V_2 , V_28 , V_29 ) ) {
F_11 ( V_28 ) ;
return;
}
F_12 ( F_13 ( V_2 ) , V_28 , V_29 , V_30 ) ;
F_14 ( V_2 , L_5 , V_23 ,
V_29 ) ;
}
