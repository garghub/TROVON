...
{
printf ( L_8 ,
V_30 -> V_33 ? ( char * ) V_30 -> V_33 : L_9 ) ;
printf ( L_10 , V_30 -> V_34 ) ;
printf ( L_11 , V_30 -> V_35 ) ;
printf ( L_12 , V_30 -> V_37 ) ;
printf ( L_13 , V_30 -> V_38 ) ;
printf ( L_14 , V_30 -> V_33 -> V_24 ) ;
}
char *
...
V_41 = F_17 ( & V_40 , L_16 , V_6 ,
V_30 -> V_34 , V_30 -> V_35 ,
V_30 -> V_37 , V_30 -> V_38 ) ;
else if ( V_30 -> V_35 != V_30 -> V_38 )
V_41 = F_17 ( & V_40 , L_17 , V_6 ,
V_30 -> V_34 , V_30 -> V_35 ,
V_30 -> V_38 ) ;
else
V_41 = F_17 ( & V_40 , L_18 , V_6 ,
V_30 -> V_34 , V_30 -> V_35 ) ;
if ( V_41 == - 1 )
F_8 ( L_19 ) ;
return V_40 ;
}
void F_18 ( struct V_29 * V_30 , const char * V_42 ,
const char * V_43 , T_2 V_44 )
{
char * V_45 ;
V_45 = F_16 ( V_30 ) ;
fprintf ( V_46 , L_20 , V_42 , V_45 ) ;
vfprintf ( V_46 , V_43 , V_44 ) ;
fprintf ( V_46 , L_21 ) ;
free ( V_45 ) ;
}
void F_19 ( struct V_29 * V_30 , const char * V_42 ,
const char * V_43 , ... )
{
T_2 V_44 ;
va_start ( V_44 , V_43 ) ;
F_18 ( V_30 , V_42 , V_43 , V_44 ) ;
va_end ( V_44 ) ;
}
void F_20 ( char * V_16 , int V_47 )
{
V_12 -> V_24 = V_16 ;
V_12 -> V_26 = V_47 ;
}
