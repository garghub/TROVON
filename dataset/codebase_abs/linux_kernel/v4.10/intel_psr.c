...
static void F_62 ( struct V_126 * V_120 )
{
struct V_7 * V_8 =
F_63 ( V_120 , F_64 ( * V_8 ) , V_54 . V_120 . V_120 ) ;
...
if ( V_103 . V_104 == - 1 )
V_103 . V_104 = 0 ;
if ( F_33 ( V_8 ) || F_72 ( V_8 ) )
V_8 -> V_54 . V_58 = false ;
else if ( F_42 ( V_8 ) || F_43 ( V_8 ) )
V_8 -> V_54 . V_58 = true ;
else
