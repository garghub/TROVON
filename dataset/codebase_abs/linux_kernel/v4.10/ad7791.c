...
struct V_1 * V_7 = F_9 ( V_18 ) ;
int V_48 , V_49 ;
for ( V_48 = 0 ; V_48 < F_15 ( V_46 ) ; V_48 ++ )
if ( F_16 ( V_46 [ V_48 ] , V_42 ) )
break;
if ( V_48 == F_15 ( V_46 ) )
return - V_37 ;
V_49 = F_17 ( V_18 ) ;
...
V_18 = F_22 ( & V_63 -> V_39 , sizeof( * V_7 ) ) ;
if ( ! V_18 )
return - V_67 ;
V_7 = F_9 ( V_18 ) ;
V_7 -> V_35 = F_23 ( & V_63 -> V_39 , L_3 ) ;
if ( F_24 ( V_7 -> V_35 ) )
return F_25 ( V_7 -> V_35 ) ;
V_49 = F_26 ( V_7 -> V_35 ) ;
if ( V_49 )
return V_49 ;
V_7 -> V_23 = & V_68 [ F_27 ( V_63 ) -> V_69 ] ;
F_28 ( & V_7 -> V_3 , V_18 , V_63 , & V_70 ) ;
F_29 ( V_63 , V_18 ) ;
V_18 -> V_39 . V_71 = & V_63 -> V_39 ;
V_18 -> V_39 . V_72 = V_63 -> V_39 . V_72 ;
V_18 -> V_73 = F_27 ( V_63 ) -> V_73 ;
V_18 -> V_74 = V_75 ;
