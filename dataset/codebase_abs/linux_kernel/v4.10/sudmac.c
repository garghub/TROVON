...
V_2 -> V_21 |= V_74 ;
if ( V_57 -> V_53 >= 0 )
snprintf ( V_2 -> V_75 , sizeof( V_2 -> V_75 ) , L_2 ,
V_57 -> V_53 , V_53 ) ;
else
snprintf ( V_2 -> V_75 , sizeof( V_2 -> V_75 ) , L_3 , V_53 ) ;
V_59 = F_27 ( V_23 , V_45 , V_54 , V_2 -> V_75 ) ;
if ( V_59 ) {
F_28 ( V_29 -> V_58 . V_42 ,
L_4 , V_53 , V_59 ) ;
goto V_76;
...
static struct V_11 * F_34 ( void * V_77 , int V_32 )
{
return & ( (struct V_24 * ) V_77 ) [ V_32 ] . V_11 ;
}
...
return V_59 ;
V_58 = & V_52 -> V_55 . V_58 ;
V_80 = F_37 ( V_57 , V_83 , 0 ) ;
V_52 -> V_62 = F_38 ( & V_57 -> V_42 , V_80 ) ;
if ( F_39 ( V_52 -> V_62 ) )
return F_40 ( V_52 -> V_62 ) ;
F_41 ( V_84 , V_58 -> V_85 ) ;
V_52 -> V_55 . V_86 = & V_87 ;
V_52 -> V_55 . V_88 = sizeof( struct V_24 ) ;
V_59 = F_42 ( & V_57 -> V_42 , & V_52 -> V_55 , V_31 -> V_89 ) ;
if ( V_59 < 0 )
return V_59 ;
V_52 -> V_31 = F_36 ( & V_57 -> V_42 ) ;
F_43 ( V_57 , V_52 ) ;
for ( V_32 = 0 ; V_32 < V_31 -> V_89 ; V_32 ++ ) {
V_59 = F_23 ( V_52 , V_32 , V_81 -> V_90 , V_91 ) ;
if ( V_59 )
goto V_92;
}
...
struct V_78 * V_58 = & V_52 -> V_55 . V_58 ;
F_48 ( V_58 ) ;
F_30 ( V_52 ) ;
F_45 ( & V_52 -> V_55 ) ;
return 0 ;
