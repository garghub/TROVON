...
static inline void F_76 ( T_3 V_109 , T_3 V_110 , T_1 V_111 [ 6 ] )
{
T_2 * V_112 = ( T_2 * ) V_111 ;
V_112 [ 1 ] = F_60 ( V_109 ) ;
V_112 [ 2 ] = F_60 ( V_110 ) ;
V_112 [ 0 ] = F_60 ( V_109 + 1 ) ;
return;
}
...
if ( ! ( V_114 & V_97 ) )
V_19 -> V_42 = 1 ;
F_52 ( F_18 ( V_2 , 6 ) , & ( V_19 -> V_118 ) ) ;
V_19 -> V_76 = V_19 -> V_118 . V_44 ;
F_76 ( F_23 ( V_2 , 0 ) ,
F_23 ( V_2 , 2 ) ,
V_19 -> V_43 ) ;
F_34 ( V_2 ) ;
( void ) F_55 ( V_2 , & ( V_19 -> V_118 ) ) ;
return 0 ;
V_27:
F_34 ( V_2 ) ;
return V_20 ;
...
int
F_78 ( struct V_1 * V_2 , struct V_39 * V_69 ,
struct V_119 * V_19 )
{
T_1 V_50 = F_43 ( V_69 ) -> V_44 ;
T_4 V_51 = F_43 ( V_69 ) -> V_45 ;
...
* V_126 = V_2 -> V_127 - 12 ;
F_34 ( V_2 ) ;
V_123 = V_123 + sizeof( struct V_17 ) ;
* V_125 = V_123 + 12 ;
* V_122 = F_21 ( V_123 + 10 ) ;
* V_121 = F_19 ( V_123 + 9 ) ;
memcpy ( V_120 , V_123 , 9 ) ;
return 0 ;
}
static int
F_81 ( struct V_1 * V_2 ,
struct V_39 * V_128 , const char * V_129 , T_2 V_130 ,
struct V_39 * V_131 , const char * V_132 )
{
int V_20 = - V_71 ;
if ( ( V_128 == NULL ) || ( V_129 == NULL ) ||
( V_131 == NULL ) || ( V_132 == NULL ) )
goto V_27;
F_15 ( V_2 ) ;
F_3 ( V_2 , 4 ) ;
F_3 ( V_2 , V_2 -> V_63 [ F_43 ( V_128 ) -> V_44 ] ) ;
F_3 ( V_2 , 1 ) ;
F_4 ( V_2 , V_130 ) ;
F_3 ( V_2 , F_43 ( V_128 ) -> V_44 ) ;
F_8 ( V_2 , F_43 ( V_128 ) -> V_45 ) ;
F_3 ( V_2 , 1 ) ;
F_3 ( V_2 , 1 ) ;
F_3 ( V_2 , F_43 ( V_131 ) -> V_44 ) ;
F_8 ( V_2 , F_43 ( V_131 ) -> V_45 ) ;
F_3 ( V_2 , 1 ) ;
F_3 ( V_2 , 1 ) ;
F_14 ( V_2 , V_129 ) ;
F_14 ( V_2 , V_132 ) ;
...
struct V_39 * V_128 , const char * V_129 ,
struct V_39 * V_131 , const char * V_132 )
{
int V_20 ;
T_2 V_130 = F_60 ( 0x06 ) ;
V_20 = F_81 ( V_2 , V_128 , V_129 , V_130 ,
V_131 , V_132 ) ;
if ( V_20 == 0xFF )
{
V_130 = F_60 ( 0x16 ) ;
...
V_20 = F_75 ( V_2 , V_131 , V_132 ) ;
if ( V_20 != 0 ) return - V_133 ;
V_20 = F_81 ( V_2 , V_128 , V_129 , V_130 ,
V_131 , V_132 ) ;
return V_20 ;
}
...
T_5 V_16 , T_3 V_134 , char * V_19 , int * V_135 )
{
const char * V_9 ;
int V_20 ;
F_15 ( V_2 ) ;
...
memcpy ( V_19 , V_9 , * V_135 ) ;
V_27:
F_34 ( V_2 ) ;
return V_20 ;
}
int
F_84 ( struct V_1 * V_2 , const char * V_38 ,
T_5 V_16 , T_3 V_134 , struct V_136 * V_137 ,
int * V_135 , void * V_138 , T_5 V_124 )
{
int V_20 ;
F_15 ( V_2 ) ;
F_3 ( V_2 , 0 ) ;
...
int
F_88 ( struct V_1 * V_2 , const char * V_38 ,
T_5 V_16 , T_5 V_143 )
{
int V_20 ;
F_15 ( V_2 ) ;
...
int
F_89 ( struct V_1 * V_2 , unsigned char * V_145 , unsigned int * V_146 ,
...
int V_160 ;
T_11 V_161 ;
V_160 = F_91 ( V_147 , V_156 - V_147 , & V_161 ) ;
...
V_145 [ V_168 ] = F_92 ( V_27 , V_145 [ V_168 ] ) ;
}
}
V_145 += V_157 ;
}
...
int
F_93 ( struct V_1 * V_2 , unsigned char * V_147 , unsigned int * V_148 ,
...
if ( V_149 ) {
int V_118 ;
V_170 = F_94 ( V_146 , V_171 ) ;
if ( ! V_170 )
return - V_172 ;
for ( V_118 = 0 ; V_118 < V_146 ; V_118 ++ )
V_170 [ V_118 ] = F_95 ( V_151 , V_145 [ V_118 ] ) ;
V_145 = V_170 ;
}
V_169 = V_147 ;
V_156 = V_147 + * V_148 - 1 ;
...
if ( F_90 ( V_2 , V_159 ) ) {
int V_160 ;
V_160 = F_96 ( V_158 , V_147 , V_156 - V_147 ) ;
if ( V_160 < 0 ) {
V_40 = - V_174 ;
goto V_173;
}
...
int
F_89 ( unsigned char * V_145 , unsigned int * V_146 ,
const unsigned char * V_147 , unsigned int V_148 , int V_149 )
{
int V_118 ;
if ( * V_146 <= V_148 )
...
int
F_93 ( unsigned char * V_147 , unsigned int * V_148 ,
const unsigned char * V_145 , unsigned int V_146 , int V_149 )
{
int V_118 ;
if ( * V_148 <= V_146 )
