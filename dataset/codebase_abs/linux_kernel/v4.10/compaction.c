...
enum V_152 V_153 )
{
int V_157 = V_91 & V_158 ;
struct V_141 * V_142 ;
struct V_24 * V_24 ;
enum V_113 V_159 = V_134 ;
if ( ! V_157 )
return V_134 ;
F_137 ( V_13 , V_91 , V_153 ) ;
F_118 (zone, z, ac->zonelist, ac->high_zoneidx,
ac->nodemask) {
enum V_113 V_160 ;
if ( V_153 > V_156
&& F_28 ( V_24 , V_13 ) ) {
V_159 = F_138 ( enum V_113 , V_161 , V_159 ) ;
continue;
}
V_160 = F_134 ( V_24 , V_13 , V_91 , V_153 ,
V_120 , F_121 ( V_140 ) ) ;
V_159 = F_139 ( V_160 , V_159 ) ;
if ( V_160 == V_127 ) {
F_30 ( V_24 , V_13 , false ) ;
break;
}
if ( V_153 != V_154 && ( V_160 == V_117 ||
V_160 == V_118 ) )
F_26 ( V_24 , V_13 ) ;
if ( ( V_153 == V_154 && F_54 () )
|| F_53 ( V_53 ) )
...
static void F_140 ( int V_162 )
{
T_1 * V_41 = F_141 ( V_162 ) ;
int V_42 ;
struct V_24 * V_24 ;
struct V_31 V_32 = {
. V_13 = - 1 ,
...
int F_145 ( struct V_164 * V_165 , int V_166 ,
void T_6 * V_167 , T_7 * V_168 , T_8 * V_169 )
{
if ( V_166 )
F_142 () ;
return 0 ;
}
int F_146 ( struct V_164 * V_165 , int V_166 ,
void T_6 * V_167 , T_7 * V_168 , T_8 * V_169 )
{
F_147 ( V_165 , V_166 , V_167 , V_168 , V_169 ) ;
return 0 ;
}
static T_9 F_148 ( struct V_170 * V_171 ,
struct V_172 * V_173 ,
const char * V_174 , T_7 V_175 )
{
int V_162 = V_171 -> V_176 ;
if ( V_162 >= 0 && V_162 < V_177 && F_149 ( V_162 ) ) {
F_143 () ;
F_140 ( V_162 ) ;
}
return V_175 ;
}
int F_150 ( struct V_178 * V_178 )
{
return F_151 ( & V_178 -> V_171 , & V_179 ) ;
}
void F_152 ( struct V_178 * V_178 )
{
return F_153 ( & V_178 -> V_171 , & V_179 ) ;
}
static inline bool F_154 ( T_1 * V_41 )
{
return V_41 -> V_180 > 0 || F_155 () ;
}
static bool F_156 ( T_1 * V_41 )
{
int V_42 ;
struct V_24 * V_24 ;
enum V_181 V_122 = V_41 -> V_182 ;
for ( V_42 = 0 ; V_42 <= V_122 ; V_42 ++ ) {
V_24 = & V_41 -> V_44 [ V_42 ] ;
if ( ! F_45 ( V_24 ) )
continue;
if ( F_113 ( V_24 , V_41 -> V_180 , 0 ,
V_122 ) == V_119 )
return true ;
}
return false ;
...
if ( F_155 () )
return;
V_160 = F_122 ( V_24 , & V_32 ) ;
if ( V_160 == V_127 ) {
F_30 ( V_24 , V_32 . V_13 , false ) ;
} else if ( V_160 == V_118 || V_160 == V_117 ) {
F_26 ( V_24 , V_32 . V_13 ) ;
}
F_124 ( ! F_97 ( & V_32 . V_102 ) ) ;
F_124 ( ! F_97 ( & V_32 . V_93 ) ) ;
}
if ( V_41 -> V_180 <= V_32 . V_13 )
V_41 -> V_180 = 0 ;
if ( V_41 -> V_182 >= V_32 . V_122 )
V_41 -> V_182 = V_41 -> V_185 - 1 ;
}
...
if ( ! F_156 ( V_41 ) )
return;
F_161 ( V_41 -> V_183 , V_13 ,
V_122 ) ;
F_162 ( & V_41 -> V_186 ) ;
}
static int F_163 ( void * V_187 )
{
T_1 * V_41 = ( T_1 * ) V_187 ;
struct V_188 * V_189 = V_53 ;
const struct V_190 * V_190 = F_164 ( V_41 -> V_183 ) ;
if ( ! F_165 ( V_190 ) )
F_166 ( V_189 , V_190 ) ;
F_167 () ;
V_41 -> V_180 = 0 ;
...
if ( V_41 -> F_163 )
return 0 ;
V_41 -> F_163 = F_171 ( F_163 , V_41 , L_1 , V_162 ) ;
if ( F_172 ( V_41 -> F_163 ) ) {
F_173 ( L_2 , V_162 ) ;
V_130 = F_174 ( V_41 -> F_163 ) ;
V_41 -> F_163 = NULL ;
}
return V_130 ;
}
void F_175 ( int V_162 )
{
struct V_188 * F_163 = F_141 ( V_162 ) -> F_163 ;
if ( F_163 ) {
F_176 ( F_163 ) ;
F_141 ( V_162 ) -> F_163 = NULL ;
}
}
static int F_177 ( unsigned int V_150 )
{
int V_162 ;
F_178 (nid, N_MEMORY) {
T_1 * V_41 = F_141 ( V_162 ) ;
const struct V_190 * V_191 ;
V_191 = F_164 ( V_41 -> V_183 ) ;
if ( F_179 ( V_192 , V_191 ) < V_193 )
F_166 ( V_41 -> F_163 , V_191 ) ;
}
return 0 ;
}
