...
if ( V_66 -> V_71 [ 0 ] . V_31 != V_72
|| V_66 -> V_71 [ 1 ] . V_31 != V_73 ) {
F_33 ( & V_66 -> V_70 , L_6 ) ;
return - V_53 ;
}
V_5 = F_43 ( & V_66 -> V_70 , L_7 ) ;
if ( F_44 ( V_5 ) )
return F_45 ( V_5 ) ;
if ( ! F_34 () )
V_4 = F_43 ( & V_66 -> V_70 , L_8 ) ;
else
V_4 = F_43 ( & V_66 -> V_70 , L_9 ) ;
if ( F_44 ( V_4 ) ) {
F_46 ( V_5 ) ;
return F_45 ( V_4 ) ;
}
V_27 = F_47 ( & V_74 , & V_66 -> V_70 ,
F_48 ( & V_66 -> V_70 ) ) ;
if ( ! V_27 ) {
V_67 = - V_75 ;
goto V_76;
}
V_27 -> V_77 = V_66 -> V_71 [ 0 ] . V_78 ;
V_27 -> V_79 = V_66 -> V_71 [ 0 ] . V_80 - V_66 -> V_71 [ 0 ] . V_78 + 1 ;
if ( ! F_49 ( V_27 -> V_77 , V_27 -> V_79 , V_81 ) ) {
F_25 ( & V_66 -> V_70 , L_10 ) ;
V_67 = - V_82 ;
goto V_83;
}
V_27 -> V_38 = F_50 ( V_27 -> V_77 , V_27 -> V_79 ) ;
if ( ! V_27 -> V_38 ) {
F_33 ( & V_66 -> V_70 , L_11 ) ;
V_67 = - V_75 ;
goto V_84;
...
static int F_61 ( struct V_65 * V_66 , T_2 V_87 )
{
struct V_26 * V_27 = F_58 ( V_66 ) ;
struct V_24 * V_25 = F_23 ( V_27 ) ;
bool V_88 = F_62 ( & V_66 -> V_70 ) ;
int V_47 ;
if ( F_63 ( V_89 , V_25 -> V_90 ) )
F_64 ( 5 ) ;
V_25 -> V_90 = V_89 ;
V_47 = F_65 ( V_27 , V_88 ) ;
if ( V_47 )
