...
V_243 = V_60 ;
V_244 = 1 ;
F_149 ( & V_60 -> V_249 -> V_181 ) ;
F_200 () ;
F_201 (p, t) {
if ( V_243 -> V_249 == V_60 -> V_249 )
V_244 ++ ;
}
F_202 () ;
if ( V_60 -> V_249 -> V_250 > V_244 )
V_17 -> V_245 |= V_251 ;
else
V_60 -> V_249 -> V_252 = 1 ;
F_151 ( & V_60 -> V_249 -> V_181 ) ;
}
...
T_8 V_236 ;
T_9 V_237 ;
V_17 -> V_235 -> V_254 = F_172 () ;
V_17 -> V_235 -> V_255 = F_175 () ;
if ( ! F_204 ( V_17 -> V_128 -> V_151 . V_10 ) )
return;
if ( F_199 ( V_21 ) )
return;
V_221 = F_81 ( V_17 -> V_128 ) ;
V_253 = F_205 ( V_221 -> V_150 ) ;
...
V_237 = V_221 -> V_259 ;
F_207 ( V_221 ) ;
if ( ! F_208 ( V_17 -> V_235 -> V_225 , V_236 ) ||
! F_209 ( V_17 -> V_235 -> V_225 , V_237 ) )
return;
if ( V_253 & V_256 ) {
V_17 -> V_219 |= V_260 ;
V_17 -> V_235 -> V_254 = V_236 ;
}
if ( ( V_253 & ( V_257 | V_261 ) ) == ( V_257 | V_261 ) ) {
V_17 -> V_219 |= V_260 ;
V_17 -> V_235 -> V_255 = V_237 ;
}
}
...
return V_211 ;
V_17 -> V_262 = 1 ;
memset ( V_17 -> V_157 , 0 , V_263 ) ;
return F_89 ( V_17 -> V_128 , 0 , V_17 -> V_157 , V_263 ) ;
}
...
F_154 ( & V_5 ) ;
if ( V_264 ) {
if ( F_221 ( V_17 -> V_157 [ 0 ] ) && F_221 ( V_17 -> V_157 [ 1 ] ) &&
F_221 ( V_17 -> V_157 [ 2 ] ) && F_221 ( V_17 -> V_157 [ 3 ] ) )
return V_211 ;
if ( F_222 ( L_1 , * ( V_272 * ) ( V_17 -> V_157 + 2 ) ) < 0 )
return V_211 ;
V_264 = false ;
goto V_269;
}
...
V_273 = V_21 -> V_195 ;
F_200 () ;
V_274 = F_224 ( V_21 , F_225 ( V_21 -> V_206 ) ) ;
F_202 () ;
V_28 = F_215 ( V_17 ) ;
if ( V_28 >= 0 ) {
F_226 ( V_17 ) ;
F_227 ( V_21 , V_273 , V_17 ) ;
F_228 ( V_275 , V_274 ) ;
F_229 ( V_21 ) ;
}
return V_28 ;
}
static int F_230 ( int V_129 , struct V_130 * V_130 ,
struct V_67 V_68 ,
struct V_67 V_276 ,
int V_132 )
{
...
if ( V_130 -> V_131 [ 0 ] == '\0' )
V_277 = F_235 ( V_287 , L_2 , V_129 ) ;
else
V_277 = F_235 ( V_287 , L_3 ,
V_129 , V_130 -> V_131 ) ;
if ( ! V_277 ) {
V_211 = - V_46 ;
goto V_286;
}
if ( F_236 ( V_129 , F_237 ( V_21 -> V_220 -> V_288 ) ) )
V_17 -> V_226 |= V_289 ;
V_17 -> V_130 = V_277 ;
}
...
if ( V_211 )
goto V_286;
V_17 -> V_78 = F_49 ( V_68 , V_290 ) ;
if ( ( V_211 = V_17 -> V_78 ) < 0 )
goto V_83;
V_17 -> V_291 = F_49 ( V_276 , V_290 ) ;
if ( ( V_211 = V_17 -> V_291 ) < 0 )
goto V_83;
V_211 = F_210 ( V_17 ) ;
if ( V_211 < 0 )
goto V_83;
...
V_211 = F_53 ( V_17 -> V_291 , V_276 , V_17 ) ;
if ( V_211 < 0 )
goto V_83;
...
int F_242 ( struct V_130 * V_130 ,
const char T_1 * const T_1 * V_87 ,
const char T_1 * const T_1 * V_292 )
{
struct V_67 V_68 = { . V_73 . V_70 = V_87 } ;
struct V_67 V_276 = { . V_73 . V_70 = V_292 } ;
return F_230 ( V_153 , V_130 , V_68 , V_276 , 0 ) ;
}
int F_243 ( int V_129 , struct V_130 * V_130 ,
const char T_1 * const T_1 * V_87 ,
const char T_1 * const T_1 * V_292 ,
int V_132 )
{
struct V_67 V_68 = { . V_73 . V_70 = V_87 } ;
struct V_67 V_276 = { . V_73 . V_70 = V_292 } ;
return F_230 ( V_129 , V_130 , V_68 , V_276 , V_132 ) ;
}
static int F_244 ( struct V_130 * V_130 ,
const T_2 T_1 * V_87 ,
const T_2 T_1 * V_292 )
{
struct V_67 V_68 = {
...
static int F_245 ( int V_129 , struct V_130 * V_130 ,
const T_2 T_1 * V_87 ,
const T_2 T_1 * V_292 ,
int V_132 )
{
...
void F_177 ( struct V_19 * V_20 , int V_295 )
{
unsigned long V_224 , V_293 ;
if ( F_3 ( ( unsigned ) V_295 > V_296 ) )
return;
do {
V_224 = F_19 ( V_20 -> V_132 ) ;
V_293 = ( V_224 & ~ V_297 ) | V_295 ;
} while ( F_248 ( & V_20 -> V_132 , V_224 , V_293 ) != V_224 );
}
