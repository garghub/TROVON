...
{
T_7 T_8 * V_169 = V_49 -> V_52 . V_60 . V_170 ;
...
case V_53 :
if ( F_6 ( V_10 ) -> V_173 != & V_173 )
return - V_63 ;
V_49 -> V_52 . type = V_174 ;
if ( V_49 -> V_52 . V_56 < V_56 ) {
V_49 -> V_52 . V_56 = V_56 ;
return - V_32 ;
}
if ( F_27 ( V_169 , & F_3 ( V_4 ) -> V_42 , V_56 ) )
return - V_62 ;
return 0 ;
case V_174 :
if ( ! F_77 ( V_175 ) )
...
V_171 . V_130 < 1 ||
V_171 . V_120 < 1 ||
V_171 . V_119 < V_171 . V_120 ||
V_171 . V_119 > 32 ||
( V_171 . V_47 != 0 &&
V_171 . V_47 != 1 ) )
return - V_63 ;
V_172 = V_4 -> V_178 ( V_10 , V_179 , V_180 ) ;
if ( V_172 )
return V_172 ;
if ( F_6 ( V_10 ) -> V_173 != & V_173 ) {
V_172 = F_79 ( V_10 , & V_173 ,
sizeof( struct V_3 ) ) ;
if ( V_172 )
return V_172 ;
F_3 ( V_4 ) -> V_7 = NULL ;
...
memcpy ( & F_3 ( V_4 ) -> V_42 , & V_171 , V_56 ) ;
V_10 -> type = V_181 ;
F_80 ( V_182 , V_10 ) ;
return 0 ;
case V_183 :
...
if ( ! F_77 ( V_175 ) )
return - V_176 ;
if ( F_78 ( & V_6 , V_49 -> V_52 . V_60 . V_187 ,
sizeof( T_10 ) ) )
return - V_62 ;
if ( V_6 . V_2 <= 0 || V_6 . V_2 >= 1024 )
return - V_63 ;
if ( V_49 -> V_52 . type == V_185 ||
V_49 -> V_52 . type == V_186 )
V_172 = V_17 ;
else
V_172 = V_147 ;
if ( V_49 -> V_52 . type == V_183 ||
V_49 -> V_52 . type == V_185 )
return F_68 ( V_10 , V_6 . V_2 , V_172 ) ;
else
return F_73 ( V_4 , V_6 . V_2 , V_172 ) ;
}
return - V_63 ;
}
