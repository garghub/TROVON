...
V_13 -> V_32 . V_158 = F_77 ( V_144 ) ;
return 0 ;
}
static int F_80 ( struct V_12 * V_13 , struct V_41 * V_42 )
{
unsigned int V_159 , V_160 , V_161 , V_70 ;
T_3 V_162 ;
V_42 -> V_55 = V_55 ;
...
( unsigned int ) V_164 ) ;
V_159 = V_42 -> V_55 ;
V_161 = V_165 / V_42 -> V_158 ;
for ( V_70 = 0 ; V_70 < F_83 ( V_42 -> V_166 ) ; ++ V_70 ) {
V_160 = F_82 ( V_159 , V_161 ) ;
V_162 = V_160 * V_42 -> V_158 ;
V_42 -> V_166 [ V_70 ] . V_167 =
F_84 ( V_13 -> V_62 , V_162 , V_72 ,
& V_42 -> V_166 [ V_70 ] . V_168 ) ;
if ( ! V_42 -> V_166 [ V_70 ] . V_167 )
return - V_169 ;
V_42 -> V_166 [ V_70 ] . V_162 = V_162 ;
V_159 -= V_160 ;
if ( ! V_159 )
break;
}
...
{
unsigned V_170 = V_42 -> V_158 ;
struct V_22 * V_20 ;
unsigned int V_171 , V_172 = 0 ;
for ( V_171 = 0 ; V_171 < F_83 ( V_42 -> V_166 ) ; ++ V_171 ) {
unsigned int V_162 = V_42 -> V_166 [ V_171 ] . V_162 ;
T_1 * V_167 = V_42 -> V_166 [ V_171 ] . V_167 ;
T_4 V_168 = V_42 -> V_166 [ V_171 ] . V_168 ;
while ( V_162 >= V_170 ) {
if ( V_172 >= V_42 -> V_55 )
goto V_173;
...
V_20 -> V_20 . V_174 = V_42 -> V_157 ;
V_20 -> V_20 . V_175 = V_176 ;
V_20 -> V_20 . V_50 = V_167 ;
V_20 -> V_20 . V_177 = V_168 ;
V_20 -> V_20 . V_178 = V_170 ;
V_20 -> V_20 . V_179 = 1 ;
V_20 -> V_20 . V_180 = 1 ;
V_20 -> V_20 . V_23 = V_13 ;
V_20 -> V_20 . V_39 = F_88 ;
V_20 -> V_20 . V_36 [ 0 ] . V_181 = 0 ;
V_20 -> V_20 . V_36 [ 0 ] . V_37 = V_170 ;
V_42 -> V_71 [ V_172 ++ ] = V_20 ;
V_162 -= V_170 ;
V_167 += V_170 ;
V_168 += V_170 ;
}
...
{
struct V_12 * V_13 = V_184 -> V_111 ;
F_97 ( & V_13 -> V_113 ) ;
}
static int F_98 ( struct V_124 * V_125 ,
const struct V_185 * V_186 )
{
static const struct V_187 V_188 = {
. V_189 = 0x0001 ,
. V_190 = 0x0001
} ;
static const struct V_191 V_192 = {
. type = V_193 ,
. V_56 = & V_188
} ;
static const int V_194 [ 2 ] [ 3 ] = {
{
[ V_83 ] = 0 ,
[ V_82 ] = 1 ,
[ V_195 ] = 2 ,
...
struct V_183 * V_184 ;
struct V_12 * V_13 ;
unsigned int V_196 , V_70 ;
int V_197 ;
const char * V_198 ;
char V_199 [ 32 ] ;
int V_1 ;
V_197 = V_186 -> V_200 == 0x0044 ;
if ( V_125 -> V_130 -> V_78 . V_80 !=
V_194 [ V_197 ] [ 0 ] )
return - V_2 ;
F_52 ( & V_201 ) ;
for ( V_196 = 0 ; V_196 < V_202 ; ++ V_196 )
if ( V_203 [ V_196 ] && ! ( V_204 & ( 1 << V_196 ) ) )
break;
if ( V_196 >= V_202 ) {
F_53 ( & V_201 ) ;
return - V_3 ;
...
if ( V_1 < 0 )
goto V_210;
V_198 = V_186 -> V_200 == 0x0044 ? L_27 : L_28 ;
strcpy ( V_184 -> V_212 , L_28 ) ;
strcpy ( V_184 -> V_213 , V_198 ) ;
F_107 ( V_13 -> V_62 , V_199 , sizeof( V_199 ) ) ;
snprintf ( V_13 -> V_184 -> V_214 , sizeof( V_13 -> V_184 -> V_214 ) ,
L_29 , V_198 ,
V_13 -> V_62 -> V_215 ? V_13 -> V_62 -> V_215 : L_30 , V_13 -> V_98 , V_199 ,
...
if ( V_1 < 0 )
goto V_210;
V_1 = F_108 ( V_184 , V_198 , 0 , 1 , 1 , & V_13 -> V_216 ) ;
if ( V_1 < 0 )
goto V_210;
V_13 -> V_216 -> V_111 = V_13 ;
strcpy ( V_13 -> V_216 -> V_198 , V_198 ) ;
F_109 ( V_13 -> V_216 , V_217 , & V_218 ) ;
F_109 ( V_13 -> V_216 , V_219 , & V_220 ) ;
V_1 = F_110 ( V_184 , V_13 -> V_76 [ V_195 ] ,
& V_13 -> V_209 , & V_192 ) ;
if ( V_1 < 0 )
goto V_210;
V_1 = F_111 ( V_184 ) ;
