...
T_2 V_28 ;
int V_47 , V_48 ;
if ( strncasecmp ( * V_5 , L_7 , strlen ( L_7 ) ) != 0 ) {
...
L_14 , & V_54 , & V_55 ,
& V_56 ) > 0 &&
F_21 ( V_56 ) == V_14 -> V_36 [ V_30 ] . V_37 . V_42 . V_40 . V_41 . V_28 &&
F_21 ( V_56 ) != V_14 -> V_36 [ ! V_30 ] . V_37 . V_38 . V_40 . V_41 . V_28 ) {
...
static unsigned int F_28 ( struct V_1 * V_2 , unsigned int V_3 ,
unsigned int V_4 ,
const char * * V_5 , unsigned int * V_6 ,
struct V_69 * exp ,
unsigned int V_7 ,
...
for (; V_28 != 0 ; V_28 ++ ) {
int V_89 ;
exp -> V_37 . V_42 . V_40 . V_41 . V_28 = F_21 ( V_28 ) ;
V_89 = F_29 ( exp ) ;
if ( V_89 == 0 )
break;
else if ( V_89 != - V_90 ) {
...
static int F_31 ( struct V_1 * V_2 , unsigned int V_3 ,
unsigned int V_4 ,
const char * * V_5 , unsigned int * V_6 )
{
enum V_11 V_12 ;
...
int V_10 , V_92 ;
if ( F_32 ( V_14 , * V_5 , 0 , * V_6 ,
V_93 , V_94 ,
& V_7 , & V_8 ) <= 0 )
return 0 ;
V_92 = * V_6 - V_7 + strlen ( L_22 ) ;
if ( F_33 ( V_14 , * V_5 , 0 , * V_6 , V_95 ,
& V_7 , & V_8 ) <= 0 )
return 0 ;
...
static int F_34 ( struct V_1 * V_2 , unsigned int V_3 ,
unsigned int V_4 ,
const char * * V_5 , unsigned int * V_6 ,
unsigned int V_96 ,
enum V_97 type ,
...
struct V_13 * V_14 = F_2 ( V_2 , & V_12 ) ;
unsigned int V_8 , V_7 ;
if ( F_32 ( V_14 , * V_5 , V_96 , * V_6 , type , V_98 ,
& V_7 , & V_8 ) <= 0 )
return - V_99 ;
return F_1 ( V_2 , V_3 , V_4 , V_5 , V_6 ,
...
if ( F_34 ( V_2 , V_3 , V_4 , V_5 , V_6 ,
V_96 , type , V_98 , V_9 , V_10 ) )
return 0 ;
return F_31 ( V_2 , V_3 , V_4 , V_5 , V_6 ) ;
}
...
unsigned int V_10 ;
V_10 = F_6 ( V_14 , V_9 , V_23 , false ) ;
if ( F_34 ( V_2 , V_3 , V_4 , V_5 , V_6 , V_96 ,
V_101 , V_102 , V_9 , V_10 ) )
return 0 ;
switch ( F_34 ( V_2 , V_3 , V_4 , V_5 , V_6 , V_96 ,
V_103 , V_102 ,
V_9 , V_10 ) ) {
case 0 :
case - V_99 :
...
V_28 != 0 ; V_28 += 2 ) {
int V_89 ;
V_104 -> V_37 . V_42 . V_40 . V_41 . V_28 = F_21 ( V_28 ) ;
V_89 = F_29 ( V_104 ) ;
if ( V_89 == - V_90 )
continue;
else if ( V_89 < 0 ) {
...
V_105 -> V_37 . V_42 . V_40 . V_41 . V_28 = F_21 ( V_28 + 1 ) ;
V_89 = F_29 ( V_105 ) ;
if ( V_89 == 0 )
break;
else if ( V_89 == - V_90 ) {
