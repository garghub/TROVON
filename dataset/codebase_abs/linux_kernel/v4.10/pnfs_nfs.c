...
struct V_98 *
F_98 ( struct V_137 * V_137 , struct V_163 * V_164 , T_1 V_112 )
{
...
goto V_117;
V_168 = F_101 ( V_115 ++ ) ;
V_115 = F_99 ( V_164 , V_168 ) ;
if ( F_100 ( ! V_115 ) )
goto V_117;
V_170 = F_102 ( V_168 + 1 , V_112 ) ;
if ( F_100 ( ! V_170 ) )
goto V_117;
V_170 [ V_168 ] = '\0' ;
memcpy ( V_170 , V_115 , V_168 ) ;
V_115 = F_99 ( V_164 , 4 ) ;
if ( F_100 ( ! V_115 ) )
goto V_175;
V_169 = F_101 ( V_115 ) ;
V_115 = F_99 ( V_164 , V_169 ) ;
if ( F_100 ( ! V_115 ) )
goto V_175;
if ( V_169 > V_176 + V_177 + 8 ) {
F_58 ( L_16 , V_74 ,
V_169 ) ;
goto V_175;
}
V_165 = F_102 ( V_169 + 1 , V_112 ) ;
if ( ! V_165 ) {
F_58 ( L_17 , V_74 ) ;
goto V_175;
}
V_165 [ V_169 ] = '\0' ;
memcpy ( V_165 , V_115 , V_169 ) ;
V_166 = strrchr ( V_165 , '.' ) ;
if ( ! V_166 ) {
F_58 ( L_18 ,
V_74 ) ;
...
goto V_178;
F_70 ( & V_107 -> V_108 ) ;
if ( ! F_103 ( V_137 , V_165 , V_166 - V_165 , (struct V_78 * ) & V_107 -> V_104 ,
sizeof( V_107 -> V_104 ) ) ) {
F_58 ( L_21 , V_74 , V_165 ) ;
goto V_179;
}
V_166 ++ ;
sscanf ( V_166 , L_22 , & V_43 [ 0 ] , & V_43 [ 1 ] ) ;
V_167 = F_104 ( ( V_43 [ 0 ] << 8 ) | ( V_43 [ 1 ] ) ) ;
switch ( V_107 -> V_104 . V_180 ) {
case V_87 :
( (struct V_81 * ) & V_107 -> V_104 ) -> V_90 = V_167 ;
V_107 -> V_141 = sizeof( struct V_81 ) ;
V_171 = L_23 ;
V_172 = 3 ;
break;
case V_91 :
( (struct V_83 * ) & V_107 -> V_104 ) -> V_95 = V_167 ;
...
default:
F_58 ( L_27 ,
V_74 , V_107 -> V_104 . V_180 ) ;
goto V_179;
}
if ( V_168 != V_172 || strncmp ( V_170 , V_171 , V_168 ) ) {
F_58 ( L_28 ,
V_74 , V_170 , V_171 ) ;
goto V_179;
}
V_114 = strlen ( V_173 ) + strlen ( V_165 ) + strlen ( V_174 ) + 7 ;
V_107 -> V_109 = F_68 ( V_114 , V_112 ) ;
if ( V_107 -> V_109 )
snprintf ( V_107 -> V_109 , V_114 , L_29 , V_173 ,
V_165 , V_174 , F_105 ( V_167 ) ) ;
...
F_30 ( & V_26 -> V_46 -> V_47 ) ;
V_56 = V_26 -> V_32 -> V_56 ;
V_62 = & V_56 [ V_181 ] . V_37 ;
if ( F_26 ( V_62 ) ) {
if ( ! F_107 ( V_23 ) ) {
F_29 ( & V_26 -> V_46 -> V_47 ) ;
V_26 -> V_21 -> V_182 ( V_26 , V_24 ) ;
return;
}
F_42 ( V_56 [ V_181 ] . V_38 != NULL ) ;
V_56 [ V_181 ] . V_38 = F_25 ( V_23 ) ;
}
F_108 ( V_29 , & V_24 -> V_30 ) ;
V_26 -> V_32 -> V_33 ++ ;
F_109 ( V_24 , V_62 , V_26 ) ;
F_29 ( & V_26 -> V_46 -> V_47 ) ;
F_110 ( V_24 -> V_183 , V_26 ) ;
}
int
F_111 ( struct V_46 * V_46 , bool V_184 )
{
int V_44 ;
if ( ! F_112 ( V_46 ) )
return 0 ;
V_44 = F_113 ( V_46 , V_185 ) ;
if ( V_44 < 0 )
return V_44 ;
if ( V_184 )
return 0 ;
