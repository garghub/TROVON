...
V_38 V_85 , V_86 ;
V_16 = F_3 ( 2 ) ;
F_13 ( V_15 . V_60 , L_58 , & V_16 , sizeof( V_16 ) ) ;
V_85 = F_5 ( V_16 ) ;
V_16 = F_3 ( 1 ) ;
F_13 ( V_15 . V_60 , L_59 , & V_16 , sizeof( V_86 ) ) ;
V_86 = F_5 ( V_16 ) ;
F_26 ( L_60 , V_85 ) ;
F_26 ( L_61 , V_86 ) ;
F_26 ( L_62 ) ;
...
F_13 ( V_34 , L_25 , type , sizeof( type ) ) ;
if ( type [ 0 ] == 0 ) {
F_13 ( V_34 , L_63 , type , sizeof( type ) ) ;
}
if ( strcmp ( type , L_64 ) )
continue;
V_59 = F_13 ( V_34 , L_65 , V_88 , sizeof( V_88 ) ) ;
if ( V_59 > sizeof( V_88 ) ) {
F_10 ( L_66 ) ;
V_59 = sizeof( V_88 ) ;
}
...
T_8 V_16 ;
T_5 V_95 ;
if ( F_13 ( V_15 . V_54 , L_74 , & V_16 , sizeof( V_16 ) ) > 0 ) {
V_95 = F_5 ( V_16 ) ;
F_2 ( L_38 , 1 , 0 , V_95 ) ;
}
}
...
V_38 V_11 [ 2 ] ;
F_26 ( L_75 ) ;
V_96 = F_2 ( L_76 , 1 , 1 , F_4 ( L_77 ) ) ;
F_26 ( L_78 , V_96 ) ;
if ( ! F_44 ( V_96 ) )
return;
V_98 = 0 ;
F_13 ( V_96 , L_79 , & V_98 , sizeof( V_98 ) ) ;
V_19 = F_45 ( V_98 ) ;
if ( V_19 == 0 )
return;
V_98 = 0 ;
F_13 ( V_96 , L_80 , & V_98 , sizeof( V_98 ) ) ;
V_26 = F_45 ( V_98 ) ;
...
V_38 V_19 = 0 ;
F_26 ( L_93 ) ;
V_101 = F_2 ( L_76 , 1 , 1 , F_4 ( L_94 ) ) ;
F_26 ( L_95 , V_101 ) ;
if ( ! F_44 ( V_101 ) )
return;
V_16 = 0 ;
F_13 ( V_101 , L_96 , & V_16 , sizeof( V_19 ) ) ;
V_19 = F_5 ( V_16 ) ;
if ( V_19 == 0 )
return;
...
F_36 ( V_47 , V_19 ) ;
V_16 = F_3 ( V_47 ) ;
F_17 ( V_101 , L_94 , L_101 ,
& V_16 , sizeof( V_16 ) ) ;
V_16 = F_3 ( V_2 ) ;
F_17 ( V_101 , L_94 , L_102 ,
& V_16 , sizeof( V_16 ) ) ;
if ( F_13 ( V_101 , L_103 ,
...
T_8 V_16 ;
F_26 ( L_108 ) ;
V_104 = F_2 ( L_76 , 1 , 1 , F_4 ( L_109 ) ) ;
F_26 ( L_110 , V_104 ) ;
if ( ! F_44 ( V_104 ) )
return;
V_105 = F_2 ( L_31 , 1 , 1 , F_4 ( L_109 ) ) ;
if ( ! F_46 ( V_105 ) ) {
F_10 ( L_111 , V_105 ) ;
return;
}
...
F_10 ( L_39 ) ;
F_36 ( V_47 , V_19 ) ;
F_17 ( V_104 , L_109 , L_123 ,
& V_47 , sizeof( V_47 ) ) ;
F_17 ( V_104 , L_109 , L_124 ,
& V_19 , sizeof( V_19 ) ) ;
F_26 ( L_125 , V_47 ) ;
F_26 ( L_126 , ( long ) V_19 ) ;
F_26 ( L_127 ) ;
}
...
V_108 , sizeof( V_108 ) ) ;
F_13 ( V_34 , L_25 , type , sizeof( type ) ) ;
F_13 ( V_34 , L_130 , V_109 , sizeof( V_109 ) ) ;
if ( ( type [ 0 ] == 0 ) || ( strstr ( type , L_131 ) == NULL ) )
continue;
if ( V_108 [ 0 ] != 0 ) {
...
if ( ( strstr ( V_109 , L_135 ) == NULL ) &&
( strstr ( V_109 , L_136 ) == NULL ) &&
( strstr ( V_109 , L_137 ) == NULL ) )
continue;
}
if ( F_13 ( V_34 , L_138 , & V_110 ,
sizeof( V_110 ) ) == V_10 )
V_110 = 0 ;
if ( F_13 ( V_34 , L_139 , & V_111 ,
sizeof( V_111 ) ) == V_10 )
V_111 = 4UL << 20 ;
...
V_115 = V_47 ;
memset ( V_84 , 0 , V_89 ) ;
if ( F_2 ( L_67 , 3 , 1 , V_34 ,
V_84 , V_89 - 1 ) == V_10 ) {
F_10 ( L_141 ) ;
}
F_17 ( V_34 , V_84 , L_142 , & V_47 , sizeof( V_47 ) ) ;
F_17 ( V_34 , V_84 , L_143 , & V_111 , sizeof( V_111 ) ) ;
F_26 ( L_144 , V_84 ) ;
F_26 ( L_145 , V_34 ) ;
F_26 ( L_146 , V_47 ) ;
F_26 ( L_147 , V_111 ) ;
...
F_26 ( L_154 ) ;
F_26 ( L_155 , ( unsigned long ) V_121 ) ;
F_26 ( L_156 , * V_121 ) ;
F_26 ( L_157 ,
( unsigned long ) V_123 ) ;
F_26 ( L_158 , * V_123 ) ;
...
continue;
if ( F_13 ( V_34 , L_160 , type , sizeof( type ) ) > 0 )
if ( strcmp ( type , L_161 ) != 0 )
continue;
V_130 = F_3 ( - 1 ) ;
F_13 ( V_34 , L_65 , & V_130 , sizeof( V_130 ) ) ;
V_129 = F_5 ( V_130 ) ;
F_26 ( L_162 , V_129 ) ;
...
{
V_9 = V_132 ;
V_15 . V_54 = F_2 ( L_76 , 1 , 1 , F_4 ( L_169 ) ) ;
if ( ! F_44 ( V_15 . V_54 ) )
F_32 ( L_170 ) ;
V_15 . V_60 = F_2 ( L_76 , 1 , 1 , F_4 ( L_32 ) ) ;
if ( ! F_44 ( V_15 . V_60 ) )
F_32 ( L_171 ) ;
V_15 . V_32 = 0 ;
}
...
T_3 V_133 ;
char V_134 [ 64 ] ;
V_133 = F_2 ( L_76 , 1 , 1 , F_4 ( L_172 ) ) ;
if ( ! F_44 ( V_133 ) )
return;
if ( F_13 ( V_133 , L_130 , V_134 , sizeof( V_134 ) ) <= 0 )
return;
V_134 [ sizeof( V_134 ) - 1 ] = 0 ;
if ( strcmp ( V_134 , L_173 ) == 0 )
V_135 = V_28 ;
else if ( strncmp ( V_134 , L_174 , 12 ) == 0 ) {
V_135 = V_28 | V_44 ;
F_2 ( L_17 , 1 , 1 , L_175 ) ;
} else
return;
V_15 . V_31 = F_2 ( L_31 , 1 , 1 , F_4 ( L_176 ) ) ;
F_13 ( V_15 . V_54 , L_177 , & V_15 . V_32 ,
sizeof( V_15 . V_32 ) ) ;
...
T_3 V_137 ;
T_8 V_16 ;
if ( F_13 ( V_15 . V_54 , L_178 , & V_16 , sizeof( V_16 ) ) <= 0 )
F_32 ( L_179 ) ;
V_15 . stdout = F_5 ( V_16 ) ;
memset ( V_84 , 0 , 256 ) ;
F_2 ( L_180 , 3 , 1 , V_15 . stdout , V_84 , 255 ) ;
F_10 ( L_181 , V_136 ) ;
F_17 ( V_15 . V_54 , L_169 , L_182 ,
V_84 , strlen ( V_84 ) + 1 ) ;
V_137 = F_2 ( L_183 , 1 , 1 , V_15 . stdout ) ;
if ( V_137 != V_10 ) {
V_16 = F_3 ( V_137 ) ;
F_17 ( V_15 . V_54 , L_169 , L_184 ,
& V_16 , sizeof( V_16 ) ) ;
memset ( type , 0 , sizeof( type ) ) ;
F_13 ( V_137 , L_25 , type , sizeof( type ) ) ;
if ( strcmp ( type , L_185 ) == 0 )
F_17 ( V_137 , V_84 , L_186 , NULL , 0 ) ;
}
}
...
#ifdef F_23
if ( F_44 ( F_2 ( L_76 , 1 , 1 , F_4 ( L_77 ) ) ) )
return V_144 ;
V_139 = F_13 ( V_15 . V_60 , L_25 ,
V_138 , sizeof( V_138 ) - 1 ) ;
if ( V_139 <= 0 )
return V_143 ;
if ( strcmp ( V_138 , L_191 ) )
return V_143 ;
V_140 = F_2 ( L_76 , 1 , 1 , F_4 ( L_94 ) ) ;
if ( ! F_44 ( V_140 ) )
return V_143 ;
V_40 = F_14 ( V_140 , L_192 ) ;
if ( V_40 != V_10 ) {
F_26 ( L_193 ) ;
return V_128 ;
}
...
{
return F_2 ( L_4 , 6 , 1 , F_4 ( L_194 ) , V_145 , V_6 , V_147 , V_146 , V_77 ) ;
}
...
#endif
#ifdef F_65
if ( F_13 ( V_34 , L_186 , NULL , 0 ) !=
V_10 ) {
V_38 V_152 , V_153 , V_154 , V_69 ;
F_10 ( L_199 ) ;
F_13 ( V_34 , L_200 , & V_152 , 4 ) ;
F_13 ( V_34 , L_201 , & V_153 , 4 ) ;
F_13 ( V_34 , L_202 , & V_154 , 4 ) ;
F_13 ( V_34 , L_203 , & V_69 , 4 ) ;
F_10 ( L_204 ,
...
if ( F_2 ( L_210 , 3 , 1 , V_34 , V_164 , V_165 ) != 1 ) {
* V_155 = ( unsigned long ) V_165 ;
break;
}
if ( strcmp ( V_165 , L_63 ) == 0 ) {
* V_155 = ( unsigned long ) V_165 ;
V_164 = L_63 ;
continue;
}
...
if ( V_158 > 255 )
V_158 = 255 ;
V_52 = F_2 ( L_67 , 3 , 1 , V_34 , V_165 , V_158 ) ;
if ( V_52 >= 0 ) {
if ( V_52 >= V_158 ) {
if ( V_52 >= * V_156 - * V_155 )
V_165 = F_67 ( V_155 , V_156 , V_52 + 1 , 1 ) ;
F_2 ( L_67 , 3 , 1 , V_34 , V_165 , V_52 ) ;
}
V_165 [ V_52 ] = '\0' ;
...
V_166 = ( char * ) V_162 ;
for (; ; ) {
if ( F_2 ( L_210 , 3 , 1 , V_34 , V_164 ,
V_35 ) != 1 )
break;
if ( strcmp ( V_35 , L_63 ) == 0 ) {
V_164 = L_63 ;
continue;
}
V_167 = F_69 ( V_35 ) ;
...
if ( ! F_44 ( V_194 ) )
return;
if ( F_14 ( V_194 , L_227 ) != 12 )
return;
if ( F_13 ( V_194 , L_227 , V_196 , sizeof( V_196 ) )
== V_10 )
return;
if ( V_196 [ 0 ] != 0x1 ||
V_196 [ 1 ] != 0xf4000000 ||
...
char * V_197 = L_229 ;
V_38 V_200 , V_201 ;
V_198 = F_2 ( L_76 , 1 , 1 , F_4 ( V_197 ) ) ;
if ( ! F_44 ( V_198 ) )
return;
if ( F_14 ( V_198 , L_65 ) != 8 )
return;
F_13 ( V_15 . V_60 , L_58 , & V_200 , sizeof( V_200 ) ) ;
F_13 ( V_15 . V_60 , L_59 , & V_201 , sizeof( V_201 ) ) ;
if ( ( V_200 != 2 ) || ( V_201 != 2 ) )
return;
if ( F_13 ( V_198 , L_65 , V_199 , sizeof( V_199 ) ) == V_10 )
return;
...
V_199 [ 2 ] = 0x0 ;
V_199 [ 3 ] = V_203 ;
F_17 ( V_198 , V_197 , L_65 , V_199 , sizeof( V_199 ) ) ;
}
...
V_205 [ 4 ] = 0x0 ;
V_205 [ 5 ] = 0x00010000 ;
F_17 ( V_204 , V_197 , L_227 , V_205 , sizeof( V_205 ) ) ;
}
}
V_197 = L_234 ;
V_204 = F_2 ( L_76 , 1 , 1 , F_4 ( V_197 ) ) ;
...
V_205 [ 0 ] = 14 ;
V_205 [ 1 ] = 0x0 ;
F_17 ( V_204 , V_197 , L_236 , V_205 , 2 * sizeof( V_38 ) ) ;
F_10 ( L_237 ) ;
V_206 = F_13 ( V_204 , L_238 , V_205 , sizeof( V_38 ) ) ;
if ( V_206 == sizeof( V_38 ) ) {
V_205 [ 0 ] &= ~ 0x5 ;
F_17 ( V_204 , V_197 , L_238 , V_205 , sizeof( V_38 ) ) ;
}
}
}
...
V_38 V_211 [ 2 ] ;
V_38 V_212 ;
V_207 = F_2 ( L_76 , 1 , 1 , F_4 ( L_239 ) ) ;
if ( ! F_44 ( V_207 ) )
return;
V_208 = F_2 ( L_76 , 1 , 1 , F_4 ( L_240 ) ) ;
if ( ! F_44 ( V_208 ) )
return;
V_209 = F_2 ( L_76 , 1 , 1 , F_4 ( L_241 ) ) ;
if ( ! F_44 ( V_209 ) )
return;
if ( F_13 ( V_207 , L_242 , & V_210 , sizeof( V_210 ) )
== V_10 )
return;
if ( V_210 < 0x35 || V_210 > 0x39 )
return;
if ( F_14 ( V_208 , L_236 ) > 0 )
return;
F_10 ( L_243 ) ;
V_211 [ 0 ] = 0 ;
V_211 [ 1 ] = 1 ;
F_17 ( V_208 , L_240 , L_236 ,
& V_211 , sizeof( V_211 ) ) ;
V_212 = ( V_38 ) V_209 ;
F_17 ( V_208 , L_240 , L_244 ,
& V_212 , sizeof( V_212 ) ) ;
}
...
char V_205 [ 64 ] ;
int V_213 ;
V_34 = F_2 ( L_76 , 1 , 1 , F_4 ( L_245 ) ) ;
if ( ! F_44 ( V_34 ) )
return;
V_213 = F_13 ( V_34 , L_246 , V_205 , sizeof( V_205 ) ) ;
if ( ! V_213 )
return;
V_34 = F_2 ( L_76 , 1 , 1 , F_4 ( L_247 ) ) ;
if ( ! F_44 ( V_34 ) ) {
F_10 ( L_248 ) ;
F_2 ( L_17 , 1 , 1 ,
L_249
...
char V_205 [ 64 ] ;
int V_213 , V_139 ;
V_34 = F_2 ( L_76 , 1 , 1 , F_4 ( L_32 ) ) ;
if ( ! F_44 ( V_34 ) )
return;
V_213 = F_13 ( V_34 , L_130 , V_205 , sizeof( V_205 ) ) ;
if ( V_213 == V_10 )
return;
if ( strcmp ( V_205 , L_273 ) )
return;
F_10 ( L_274 ) ;
V_34 = F_2 ( L_76 , 1 , 1 , F_4 ( L_32 ) ) ;
V_213 = F_13 ( V_34 , L_25 , V_205 , sizeof( V_205 ) ) ;
if ( V_213 != V_10 && ( strcmp ( V_205 , L_191 ) == 0 ) )
F_17 ( V_34 , L_32 , L_25 , L_275 , sizeof( L_275 ) ) ;
V_213 = F_13 ( V_34 , L_276 , V_205 , sizeof( V_205 ) ) ;
if ( V_213 != V_10 && ( strstr ( V_205 , L_277 ) ) )
F_17 ( V_34 , L_32 , L_276 ,
L_278 ,
sizeof( L_278 ) ) ;
V_34 = F_2 ( L_76 , 1 , 1 , F_4 ( L_279 ) ) ;
if ( F_44 ( V_34 ) ) {
V_139 = F_14 ( V_34 , L_236 ) ;
if ( V_139 == 12 ) {
F_10 ( L_280 ) ;
F_17 ( V_34 , L_281 , L_236 ,
V_215 , sizeof( V_215 ) ) ;
}
}
V_34 = F_2 ( L_76 , 1 , 1 , F_4 ( L_282 ) ) ;
if ( F_44 ( V_34 ) ) {
V_213 = F_13 ( V_34 , L_236 , V_205 , sizeof( V_205 ) ) ;
if ( V_213 == V_10 ) {
F_10 ( L_283 ) ;
F_17 ( V_34 , L_282 , L_236 ,
V_214 , sizeof( V_214 ) ) ;
}
}
F_78 () ;
...
{
V_38 V_211 [ 2 ] , V_212 , V_216 , V_16 = 0 ;
char * V_197 , * V_217 ;
T_3 V_218 , V_34 ;
V_197 = L_284 ;
V_218 = F_2 ( L_76 , 1 , 1 , F_4 ( V_197 ) ) ;
if ( ! F_44 ( V_218 ) )
return;
if ( F_14 ( V_218 , L_285 ) != V_10 )
return;
F_10 ( L_286 ) ;
F_17 ( V_218 , V_197 , L_285 , & V_16 , 0 ) ;
V_217 = L_287 ;
V_34 = F_2 ( L_76 , 1 , 1 , F_4 ( V_217 ) ) ;
V_212 = F_4 ( V_218 ) ;
for( ; F_12 ( & V_34 ) ; ) {
if ( ! F_44 ( V_34 ) )
continue;
V_216 = F_14 ( V_34 , L_236 ) ;
if ( V_216 == 0 || V_216 == V_10 )
continue;
F_13 ( V_34 , L_236 , & V_211 , sizeof( V_211 ) ) ;
if ( ( V_211 [ 0 ] < 212 ) || ( V_211 [ 0 ] > 222 ) )
continue;
if ( ( V_211 [ 0 ] >= 212 ) && ( V_211 [ 0 ] <= 215 ) )
V_211 [ 0 ] -= 203 ;
if ( ( V_211 [ 0 ] >= 216 ) && ( V_211 [ 0 ] <= 220 ) )
V_211 [ 0 ] -= 213 ;
if ( V_211 [ 0 ] == 221 )
V_211 [ 0 ] = 14 ;
if ( V_211 [ 0 ] == 222 )
V_211 [ 0 ] = 8 ;
F_17 ( V_34 , V_217 , L_236 , V_211 ,
sizeof( V_211 ) ) ;
F_17 ( V_34 , V_217 , L_244 , & V_212 ,
sizeof( V_212 ) ) ;
}
V_197 = L_288 ;
V_218 = F_2 ( L_76 , 1 , 1 , F_4 ( V_197 ) ) ;
...
return;
F_10 ( L_289 ) ;
F_17 ( V_218 , V_197 , L_25 , L_290 , sizeof( L_290 ) ) ;
}
...
return;
V_219 = F_5 ( V_216 ) ;
V_220 = F_2 ( L_183 , 1 , 1 , V_219 ) ;
if ( ! F_44 ( V_220 ) )
return;
F_13 ( V_220 , L_65 , & V_216 , sizeof( V_216 ) ) ;
V_15 . V_131 = F_5 ( V_216 ) ;
F_26 ( L_291 , V_15 . V_131 ) ;
}
static void T_1 F_83 ( unsigned long V_221 , unsigned long V_222 )
{
#ifdef F_84
if ( V_221 && V_222 && V_222 != 0xdeadbeef ) {
T_9 V_16 ;
V_93 = F_85 ( V_221 ) ? F_86 ( V_221 ) : V_221 ;
V_94 = V_93 + V_222 ;
V_16 = F_37 ( V_93 ) ;
F_17 ( V_15 . V_54 , L_169 , L_292 ,
& V_16 , sizeof( V_16 ) ) ;
V_16 = F_37 ( V_94 ) ;
F_17 ( V_15 . V_54 , L_169 , L_293 ,
& V_16 , sizeof( V_16 ) ) ;
F_36 ( V_93 ,
V_94 - V_93 ) ;
F_26 ( L_294 , V_93 ) ;
...
static void F_89 ( unsigned long V_223 , unsigned long V_224 )
{
unsigned long V_6 ;
unsigned long * V_225 ;
...
static void F_87 ( void )
{
unsigned long V_223 = F_90 () ;
unsigned long V_224 =
( V_226 - V_227 ) / sizeof( long ) ;
F_89 ( V_223 , V_224 ) ;
F_55 () ;
}
static void F_88 ( void )
...
unsigned long T_1 F_91 ( unsigned long V_221 , unsigned long V_222 ,
unsigned long V_132 ,
unsigned long V_228 , unsigned long V_229 ,
unsigned long V_230 )
{
unsigned long V_178 ;
#ifdef F_92
...
#endif
F_83 ( V_221 , V_222 ) ;
#if F_95 ( V_235 ) || F_95 ( V_236 )
if ( V_90 == V_127 ||
V_90 == V_128 )
F_27 () ;
#endif
if ( V_90 != V_142 )
F_96 ( 0 , V_230 , 0x100 , 0 ) ;
F_20 () ;
F_38 () ;
F_82 () ;
F_62 () ;
#if F_95 ( F_23 ) && F_95 ( F_29 )
if ( V_90 == V_127 )
F_50 () ;
#endif
if ( V_90 != V_142 &&
...
if ( V_58 ) {
T_9 V_16 = F_37 ( V_58 ) ;
F_17 ( V_15 . V_54 , L_169 , L_299 ,
& V_16 , sizeof( V_16 ) ) ;
}
#ifdef F_23
if ( V_56 )
F_17 ( V_15 . V_54 , L_169 , L_300 ,
NULL , 0 ) ;
if ( V_57 )
F_17 ( V_15 . V_54 , L_169 , L_301 ,
NULL , 0 ) ;
if ( V_119 ) {
F_17 ( V_15 . V_54 , L_169 , L_302 ,
& V_119 ,
sizeof( V_119 ) ) ;
F_17 ( V_15 . V_54 , L_169 , L_303 ,
& V_120 ,
sizeof( V_120 ) ) ;
}
#endif
...
#endif
#ifdef F_47
F_97 ( V_178 , V_230 , 0 , 0 , 0 ,
V_99 , V_100 ) ;
#else
F_97 ( V_178 , V_230 , 0 , 0 , 0 , 0 , 0 ) ;
#endif
return 0 ;
}
