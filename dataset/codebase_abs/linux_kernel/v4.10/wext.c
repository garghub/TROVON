...
if ( V_7 )
memcpy ( ( void * ) V_2 -> V_10 [ V_3 ] . V_6 , V_6 , V_7 ) ;
if ( V_9 )
memcpy ( ( void * ) V_2 -> V_10 [ V_3 ] . V_8 , V_8 , V_9 ) ;
switch ( V_5 ) {
case V_14 :
...
V_2 -> V_57 = 1 ;
memcpy ( V_2 -> V_58 , & V_52 -> V_56 , V_66 ) ;
V_59:
F_14 ( V_2 , & V_30 ) ;
return V_29 ;
}
...
if ( V_70 -> V_30 )
memcpy ( V_2 -> V_65 , V_90 , V_70 -> V_80 ) ;
F_14 ( V_2 , & V_30 ) ;
return - V_54 ;
}
...
if ( F_9 ( V_2 , & V_30 ) != 0 )
return - V_55 ;
memcpy ( V_90 , V_2 -> V_65 , V_91 ) ;
V_70 -> V_80 = strlen ( V_2 -> V_65 ) ;
F_14 ( V_2 , & V_30 ) ;
}
V_70 -> V_30 = 1 ;
return 0 ;
...
if ( F_9 ( V_2 , & V_30 ) != 0 )
return - V_55 ;
F_41 ( V_2 -> V_120 , & V_119 , & V_121 ) ;
if ( F_29 ( V_25 ) ) {
int V_122 ;
int V_123 ;
V_123 = F_42 ( V_2 , & V_122 ) ;
if ( ! V_123 )
V_119 = V_122 ;
}
F_14 ( V_2 , & V_30 ) ;
...
case V_17 :
V_149 -> V_5 = V_156 ;
V_149 -> V_7 = F_48 ( V_2 -> V_10 [ V_150 ] . V_7 , V_163 ) ;
...
return - V_86 ;
if ( V_146 -> V_186 . V_80 ) {
V_185 = F_54 ( V_53 , V_146 -> V_186 . V_80 , V_188 ) ;
if ( V_185 == NULL )
return - V_22 ;
} else
V_185 = NULL ;
...
break;
case V_195 :
V_166 = F_57 ( V_2 , V_192 -> V_196 . V_56 ,
V_192 -> V_197 ) ;
break;
default:
V_166 = - V_62 ;
