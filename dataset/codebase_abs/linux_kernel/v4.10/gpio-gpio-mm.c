...
{
struct V_4 * V_5 ;
const char * const V_25 = F_13 ( V_23 ) ;
int V_26 ;
V_5 = F_14 ( V_23 , sizeof( * V_5 ) , V_27 ) ;
if ( ! V_5 )
return - V_28 ;
if ( ! F_15 ( V_23 , V_12 [ V_24 ] , V_29 , V_25 ) ) {
F_16 ( V_23 , L_1 ,
V_12 [ V_24 ] , V_12 [ V_24 ] + V_29 ) ;
return - V_30 ;
}
V_5 -> V_2 . V_31 = V_25 ;
V_5 -> V_2 . V_32 = V_23 ;
...
F_17 ( & V_5 -> V_15 ) ;
F_18 ( V_23 , V_5 ) ;
V_26 = F_19 ( & V_5 -> V_2 , V_5 ) ;
if ( V_26 ) {
F_16 ( V_23 , L_2 , V_26 ) ;
return V_26 ;
}
F_6 ( 0x80 , V_12 [ V_24 ] + 3 ) ;
F_6 ( 0x00 , V_12 [ V_24 ] ) ;
F_6 ( 0x00 , V_12 [ V_24 ] + 1 ) ;
F_6 ( 0x00 , V_12 [ V_24 ] + 2 ) ;
F_6 ( 0x80 , V_12 [ V_24 ] + 7 ) ;
F_6 ( 0x00 , V_12 [ V_24 ] + 4 ) ;
F_6 ( 0x00 , V_12 [ V_24 ] + 5 ) ;
F_6 ( 0x00 , V_12 [ V_24 ] + 6 ) ;
return 0 ;
}
static int F_20 ( struct V_22 * V_23 , unsigned int V_24 )
{
struct V_4 * const V_5 = F_21 ( V_23 ) ;
F_22 ( & V_5 -> V_2 ) ;
return 0 ;
}
