...
if ( ! F_47 ( V_75 ) )
return 0 ;
V_71 . V_60 . V_76 = F_48 ( V_68 ,
sizeof( * V_71 . V_60 . V_76 ) ,
V_77 ) ;
if ( ! V_71 . V_60 . V_76 )
return - V_46 ;
V_71 . V_60 . V_76 [ 0 ] . V_78 = 25000 ;
V_71 . V_60 . V_76 [ 0 ] . V_79 = 2000000 ;
V_71 . V_60 . V_80 = 1 ;
for ( V_13 = 0 ; V_13 < F_49 ( V_81 ) ; V_13 ++ )
F_50 ( V_81 [ V_13 ] , NULL , false ) ;
V_61 = F_51 ( V_68 -> V_72 ,
& V_82 ) ;
if ( V_61 )
goto V_8;
...
struct V_69 * V_70 ;
int V_61 ;
if ( ! F_54 ( V_84 -> V_68 . V_72 , L_8 ) )
return 0 ;
V_70 = F_55 ( & V_84 -> V_68 , L_9 ) ;
if ( F_56 ( V_70 ) == - V_44 )
V_70 = NULL ;
if ( F_45 ( V_70 ) ) {
V_61 = F_56 ( V_70 ) ;
F_46 ( & V_84 -> V_68 , L_10 , V_61 ) ;
return V_61 ;
}
return F_43 ( & V_84 -> V_68 , V_70 ) ;
}
