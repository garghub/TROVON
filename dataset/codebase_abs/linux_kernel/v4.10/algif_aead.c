...
V_86 -> V_93 = V_17 -> V_21 ;
while ( V_96 > V_97 && F_59 ( & V_50 -> V_102 ) ) {
T_1 V_103 = F_35 ( T_1 , F_59 ( & V_50 -> V_102 ) ,
( V_96 - V_97 ) ) ;
if ( F_60 ( & V_86 -> V_98 ) ) {
V_88 = & V_86 -> V_92 ;
} else {
...
V_38 = F_62 ( & V_88 -> V_17 , & V_50 -> V_102 , V_103 ) ;
if ( V_38 < 0 )
goto free;
V_97 += V_38 ;
if ( V_95 )
...
V_86 -> V_62 ) ;
V_38 = V_6 -> V_15 ? F_66 ( V_84 ) : F_67 ( V_84 ) ;
if ( V_38 ) {
if ( V_38 == - V_105 ) {
F_68 ( V_2 ) ;
V_38 = - V_106 ;
...
static int F_74 ( struct V_48 * V_1 , struct V_49 * V_50 , T_1 V_110 ,
int V_35 )
{
...
static unsigned int F_76 ( struct V_111 * V_111 , struct V_48 * V_1 ,
T_3 * V_29 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
static void * F_78 ( const char * V_115 , V_101 type , V_101 V_112 )
{
return F_79 ( V_115 , type , V_112 ) ;
}
static void F_80 ( void * V_7 )
{
F_81 ( V_7 ) ;
}
static int F_82 ( void * V_7 , unsigned int V_116 )
{
return F_83 ( V_7 , V_116 ) ;
}
static int F_84 ( void * V_7 , const T_4 * V_117 , unsigned int V_118 )
{
return F_85 ( V_7 , V_117 , V_118 ) ;
}
