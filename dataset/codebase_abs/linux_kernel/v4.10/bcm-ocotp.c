...
F_3 ( V_30 -> V_1 , V_33 ++ ) ;
for ( V_19 = 0 ; V_19 < V_30 -> V_39 -> V_40 ; V_19 ++ ) {
F_2 ( * V_31 , V_30 -> V_1 + V_30 -> V_39 -> V_41 [ V_19 ] ) ;
V_31 ++ ;
V_42 += sizeof( * V_31 ) ;
}
F_4 ( V_30 -> V_1 ) ;
...
int V_55 ;
T_2 V_56 ;
V_30 = F_17 ( V_37 , sizeof( * V_30 ) , V_57 ) ;
if ( ! V_30 )
return - V_58 ;
if ( F_18 ( V_37 -> V_50 , L_3 ) )
V_30 -> V_39 = & V_59 ;
else if ( F_18 ( V_37 -> V_50 , L_4 ) )
V_30 -> V_39 = & V_60 ;
else {
F_14 ( & V_46 -> V_37 ,
L_5 , V_61 ) ;
...
V_52 = F_19 ( V_46 , V_62 , 0 ) ;
V_30 -> V_1 = F_20 ( V_37 , V_52 ) ;
if ( F_21 ( V_30 -> V_1 ) ) {
F_14 ( V_37 , L_6 ) ;
return F_22 ( V_30 -> V_1 ) ;
}
F_2 ( F_8 ( V_30 -> V_1 + V_63 ) |
F_23 ( V_64 ) ,
V_30 -> V_1 + V_63 ) ;
F_5 ( V_30 -> V_1 ) ;
V_55 = F_24 ( V_49 , L_7 , & V_56 ) ;
if ( V_55 ) {
F_14 ( V_37 , L_8 ) ;
return - V_43 ;
} else if ( V_56 == 0 ) {
