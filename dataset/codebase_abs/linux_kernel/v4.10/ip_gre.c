...
return 0 ;
if ( V_44 [ V_174 ] )
V_38 -> V_137 = F_99 ( V_44 [ V_174 ] ) ;
if ( V_44 [ V_166 ] )
V_38 -> V_130 = F_66 ( F_92 ( V_44 [ V_166 ] ) ) ;
if ( V_44 [ V_167 ] )
V_38 -> V_66 = F_66 ( F_92 ( V_44 [ V_167 ] ) ) ;
if ( V_44 [ V_175 ] )
V_38 -> V_176 = F_100 ( V_44 [ V_175 ] ) ;
if ( V_44 [ V_177 ] )
V_38 -> V_70 = F_100 ( V_44 [ V_177 ] ) ;
if ( V_44 [ V_178 ] )
V_38 -> V_11 . V_32 = F_101 ( V_44 [ V_178 ] ) ;
if ( V_44 [ V_173 ] )
V_38 -> V_11 . V_31 = F_101 ( V_44 [ V_173 ] ) ;
if ( V_44 [ V_179 ] )
V_38 -> V_11 . V_39 = F_102 ( V_44 [ V_179 ] ) ;
if ( V_44 [ V_180 ] )
V_38 -> V_11 . V_84 = F_102 ( V_44 [ V_180 ] ) ;
if ( ! V_44 [ V_181 ] || F_102 ( V_44 [ V_181 ] ) ) {
if ( V_15 -> V_182 )
return - V_112 ;
...
if ( V_44 [ V_169 ] ) {
V_186 = true ;
V_185 -> type = F_93 ( V_44 [ V_169 ] ) ;
}
if ( V_44 [ V_187 ] ) {
V_186 = true ;
V_185 -> V_30 = F_93 ( V_44 [ V_187 ] ) ;
}
if ( V_44 [ V_188 ] ) {
V_186 = true ;
V_185 -> V_189 = F_92 ( V_44 [ V_188 ] ) ;
}
if ( V_44 [ V_190 ] ) {
V_186 = true ;
V_185 -> V_191 = F_92 ( V_44 [ V_190 ] ) ;
}
return V_186 ;
}
...
static int F_107 ( struct V_6 * V_196 , struct V_64 * V_7 ,
...
if ( F_103 ( V_44 , & V_185 ) ) {
struct V_14 * V_15 = F_31 ( V_7 ) ;
V_95 = F_108 ( V_15 , & V_185 ) ;
if ( V_95 < 0 )
return V_95 ;
}
V_95 = F_98 ( V_7 , V_44 , V_165 , & V_122 ) ;
if ( V_95 < 0 )
return V_95 ;
return F_109 ( V_7 , V_165 , & V_122 ) ;
}
...
if ( V_95 < 0 )
return V_95 ;
return F_111 ( V_7 , V_165 , & V_122 ) ;
}
static T_8 F_112 ( const struct V_64 * V_7 )
{
return
F_113 ( 4 ) +
F_113 ( 2 ) +
...
if ( F_115 ( V_2 , V_174 , V_122 -> V_137 ) ||
F_116 ( V_2 , V_166 ,
F_68 ( V_122 -> V_130 ) ) ||
F_116 ( V_2 , V_167 ,
F_68 ( V_122 -> V_66 ) ) ||
F_117 ( V_2 , V_175 , V_122 -> V_176 ) ||
F_117 ( V_2 , V_177 , V_122 -> V_70 ) ||
F_118 ( V_2 , V_178 , V_122 -> V_11 . V_32 ) ||
F_118 ( V_2 , V_173 , V_122 -> V_11 . V_31 ) ||
F_119 ( V_2 , V_179 , V_122 -> V_11 . V_39 ) ||
F_119 ( V_2 , V_180 , V_122 -> V_11 . V_84 ) ||
F_119 ( V_2 , V_181 ,
...
struct V_64 * F_122 ( struct V_6 * V_6 , const char * V_199 ,
T_9 V_200 )
{
struct V_164 * V_165 [ V_201 + 1 ] ;
struct V_64 * V_7 ;
F_123 ( V_202 ) ;
struct V_14 * V_15 ;
int V_95 ;
memset ( & V_165 , 0 , sizeof( V_165 ) ) ;
V_7 = F_124 ( V_6 , V_199 , V_200 ,
& V_203 , V_165 ) ;
if ( F_46 ( V_7 ) )
return V_7 ;
V_15 = F_31 ( V_7 ) ;
...
{
return F_88 ( V_6 , V_27 , & V_203 , L_1 ) ;
}
