...
static int F_35 ( struct V_51 * V_42 )
{
struct V_1 * V_9 = F_36 ( V_42 ) ;
unsigned int V_52 ;
for ( V_52 = 0 ; V_52 < V_9 -> V_3 . V_46 ; V_52 ++ ) {
struct V_10 * V_4 ;
V_4 = F_11 ( & V_9 -> V_3 . V_53 [ V_52 ] ) ;
if ( ! V_4 )
continue;
V_4 -> V_54 = F_3 ( V_9 , V_52 , V_36 ) ;
V_4 -> V_55 = F_3 ( V_9 , V_52 , V_27 ) ;
V_4 -> V_17 = F_3 ( V_9 , V_52 , V_29 ) ;
V_4 -> V_56 = F_3 ( V_9 , V_52 , V_30 ) ;
}
F_30 ( V_9 -> V_21 ) ;
return 0 ;
}
static int F_37 ( struct V_51 * V_42 )
{
struct V_1 * V_9 = F_36 ( V_42 ) ;
unsigned int V_52 ;
int V_41 ;
...
if ( ! V_4 )
continue;
F_5 ( V_9 , V_52 , V_4 -> V_55 , V_27 ) ;
F_5 ( V_9 , V_52 , V_4 -> V_17 , V_29 ) ;
F_5 ( V_9 , V_52 , V_4 -> V_56 , V_30 ) ;
F_5 ( V_9 , V_52 , V_4 -> V_54 , V_36 ) ;
}
return 0 ;
}
