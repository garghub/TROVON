...
{
int V_162 ;
if ( ! F_116 ( L_12 , 0 , NULL , & V_289 ) )
return - V_139 ;
V_162 = F_117 ( V_273 , L_12 , & V_290 ) ;
if ( V_162 ) {
F_58 ( L_13 , V_273 ) ;
goto V_291;
}
V_271 = F_118 ( V_292 , L_14 ) ;
if ( F_101 ( V_271 ) ) {
V_162 = F_102 ( V_271 ) ;
F_119 ( L_15 , V_162 ) ;
V_271 = NULL ;
...
int F_124 ( struct V_1 * V_10 )
{
struct V_154 V_155 ;
struct V_12 V_13 = V_10 -> V_13 ;
struct V_294 * V_117 , * V_48 ;
struct V_295 * V_168 ;
struct V_164 * V_116 , V_179 ;
int V_132 = 1 ;
F_125 (pos, n, &info->modelist) {
V_168 = F_126 ( V_117 , struct V_295 , V_296 ) ;
V_116 = & V_168 -> V_179 ;
F_127 ( & V_13 , V_116 ) ;
V_13 . V_153 = V_297 ;
