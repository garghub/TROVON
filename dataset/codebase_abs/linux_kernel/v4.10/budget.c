...
if ( F_24 ( V_2 -> V_12 . V_71 ) && ( V_2 -> V_12 . V_72 || ! F_17 ( V_2 ) ) ) {
F_7 ( L_8 ) ;
F_11 ( & V_2 -> V_11 ) ;
return - V_21 ;
}
...
V_53 . V_15 = V_2 -> V_12 . V_60 + F_37 ( V_77 -> V_78 , 8 ) ;
F_34 ( V_2 , & V_53 ) ;
}
long long F_38 ( const struct V_1 * V_2 , long long free )
{
int V_79 , V_80 , V_81 ;
V_81 = V_2 -> V_82 > 3 ? V_2 -> V_82 >> 1 : 2 ;
V_80 = V_83 ;
V_79 = V_84 ;
V_79 += ( V_2 -> V_59 * 3 ) / ( V_81 - 1 ) ;
free *= V_80 ;
return F_15 ( free , V_79 ) ;
}
