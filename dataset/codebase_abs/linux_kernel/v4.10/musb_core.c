...
static int
F_90 ( struct V_1 * V_1 , struct V_40 * V_41 ,
...
F_99 ( L_37 , V_174 , V_167 ) ;
V_166:
V_37 = F_90 ( V_1 , V_41 , & V_175 , 0 ) ;
...
V_37 = F_90 ( V_1 , V_41 + V_176 , V_144 ++ , V_37 ) ;
if ( V_37 < 0 ) {
F_99 ( L_39 ,
V_174 , V_176 ) ;
return V_37 ;
...
V_176 ++ ;
V_1 -> V_180 = F_92 ( V_176 , V_1 -> V_180 ) ;
}
F_99 ( L_40 ,
V_174 ,
...
static int F_102 ( T_4 V_181 , struct V_1 * V_1 )
{
T_3 V_16 ;
char * type ;
char V_182 [ 90 ] ;
...
int V_19 ;
V_16 = F_103 ( V_36 ) ;
strcpy ( V_182 , ( V_16 & V_184 ) ? L_43 : L_44 ) ;
if ( V_16 & V_185 ) {
strcat ( V_182 , L_45 ) ;
V_1 -> V_186 = true ;
}
...
V_1 -> V_198 = F_106 ( V_36 ) ;
F_99 ( L_55 ,
V_174 , type , F_107 ( V_1 -> V_198 ) ,
F_108 ( V_1 -> V_198 ) ,
( V_1 -> V_198 & V_199 ) ? L_56 : L_53 ) ;
F_109 ( V_1 ) ;
V_1 -> V_180 = 1 ;
V_1 -> V_117 = 1 ;
if ( V_1 -> V_186 )
...
void F_121 ( struct V_1 * V_1 , T_3 V_35 , T_3 V_218 )
{
if ( ! V_35 ) {
if ( ! F_122 ( V_1 ) ) {
if ( F_78 ( V_1 ) )
...
static T_6
F_124 ( struct V_2 * V_3 , struct V_222 * V_223 , char * V_224 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_58 ;
int V_22 = - V_179 ;
F_54 ( & V_1 -> V_59 , V_58 ) ;
V_22 = sprintf ( V_224 , L_63 , F_57 ( V_1 -> V_60 -> V_61 -> V_62 ) ) ;
F_59 ( & V_1 -> V_59 , V_58 ) ;
return V_22 ;
}
static T_6
F_125 ( struct V_2 * V_3 , struct V_222 * V_223 ,
...
if ( F_126 ( V_224 , L_12 ) )
V_183 = F_127 ( V_1 , V_8 ) ;
else if ( F_126 ( V_224 , L_13 ) )
V_183 = F_127 ( V_1 , V_10 ) ;
else if ( F_126 ( V_224 , L_64 ) )
V_183 = F_127 ( V_1 , V_13 ) ;
else
V_183 = - V_179 ;
F_59 ( & V_1 -> V_59 , V_58 ) ;
...
static T_6
F_128 ( struct V_2 * V_3 , struct V_222 * V_223 ,
const char * V_224 , T_7 V_163 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_58 ;
unsigned long V_34 ;
if ( sscanf ( V_224 , L_65 , & V_34 ) < 1 ) {
F_77 ( V_3 , L_66 ) ;
return - V_179 ;
}
F_54 ( & V_1 -> V_59 , V_58 ) ;
V_1 -> V_109 = V_34 ? F_129 ( int , V_34 , V_110 ) : 0 ;
...
static T_6
F_130 ( struct V_2 * V_3 , struct V_222 * V_223 , char * V_224 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_58 ;
unsigned long V_34 ;
...
F_59 ( & V_1 -> V_59 , V_58 ) ;
return sprintf ( V_224 , L_67 ,
V_225 ? L_68 : L_69 , V_34 ) ;
}
static T_6
F_132 ( struct V_2 * V_3 , struct V_222 * V_223 ,
const char * V_224 , T_7 V_163 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned short V_226 ;
if ( sscanf ( V_224 , L_70 , & V_226 ) != 1
|| ( V_226 != 1 ) ) {
F_77 ( V_3 , L_71 ) ;
return - V_179 ;
}
...
static void F_137 ( struct V_234 * V_39 )
{
struct V_1 * V_1 = F_138 ( V_39 , struct V_1 , V_129 . V_235 ) ;
int error ;
error = F_6 ( V_1 -> V_45 ) ;
if ( error < 0 ) {
F_77 ( V_1 -> V_45 , L_76 , error ) ;
return;
}
F_134 ( V_1 ) ;
if ( V_1 -> V_60 -> V_61 -> V_62 != V_1 -> V_236 ) {
V_1 -> V_236 = V_1 -> V_60 -> V_61 -> V_62 ;
F_139 ( & V_1 -> V_45 -> V_237 , NULL , L_78 ) ;
}
F_135 ( V_1 -> V_45 ) ;
F_136 ( V_1 -> V_45 ) ;
}
...
static struct V_1 * F_142 ( struct V_2 * V_3 ,
...
int V_35 ;
int V_22 ;
V_1 = F_143 ( V_3 , sizeof( * V_1 ) , V_240 ) ;
if ( ! V_1 )
return NULL ;
F_144 ( & V_1 -> V_241 ) ;
F_144 ( & V_1 -> V_242 ) ;
...
int error = 0 ;
F_54 ( & V_1 -> V_255 , V_58 ) ;
F_155 (w, _w, &musb->pending_list, node) {
if ( V_253 -> V_256 ) {
...
V_253 = F_143 ( V_1 -> V_45 , sizeof( * V_253 ) , V_258 ) ;
if ( ! V_253 )
return - V_259 ;
V_253 -> V_256 = V_256 ;
V_253 -> V_39 = V_39 ;
...
static void F_162 ( struct V_234 * V_235 )
{
struct V_1 * V_1 ;
unsigned long V_58 ;
V_1 = F_138 ( V_235 , struct V_1 , V_262 . V_235 ) ;
F_54 ( & V_1 -> V_59 , V_58 ) ;
if ( V_1 -> V_75 & V_263 )
F_163 ( V_1 , false ) ;
F_59 ( & V_1 -> V_59 , V_58 ) ;
...
static int
F_164 ( struct V_2 * V_3 , int V_247 , void T_2 * V_264 )
{
int V_183 ;
struct V_1 * V_1 ;
struct V_265 * V_266 = F_165 ( V_3 ) ;
if ( ! V_266 ) {
F_77 ( V_3 , L_81 ) ;
V_183 = - V_221 ;
goto V_267;
}
V_1 = F_142 ( V_3 , V_266 -> V_136 , V_264 ) ;
if ( ! V_1 ) {
V_183 = - V_259 ;
goto V_267;
}
...
V_289 ( V_1 , V_1 -> V_53 ) ;
if ( F_173 ( V_1 -> V_297 ) ) {
V_183 = F_174 ( V_1 -> V_297 ) ;
goto V_298;
}
}
F_89 ( V_1 ) ;
F_85 ( V_1 ) ;
F_175 ( & V_1 -> V_129 , F_137 ) ;
F_175 ( & V_1 -> V_262 , F_162 ) ;
F_175 ( & V_1 -> V_90 , V_299 ) ;
V_183 = F_102 ( V_266 -> V_136 -> V_300
? V_196
: V_301 , V_1 ) ;
if ( V_183 < 0 )
goto V_302;
F_176 ( & V_1 -> V_113 , F_53 , ( unsigned long ) V_1 ) ;
if ( F_177 ( V_247 , V_1 -> V_276 , 0 , F_178 ( V_3 ) , V_1 ) ) {
F_77 ( V_3 , L_83 , V_247 ) ;
V_183 = - V_221 ;
goto V_302;
}
...
if ( V_266 -> V_303 ) {
T_3 V_304 = F_181 ( V_1 -> V_53 ) ;
V_304 |= V_305 ;
F_182 ( V_1 -> V_53 , V_304 ) ;
}
...
if ( V_183 < 0 )
goto V_309;
V_183 = F_187 ( & V_1 -> V_45 -> V_237 , & V_250 ) ;
if ( V_183 )
goto V_310;
V_1 -> V_311 = 1 ;
F_135 ( V_1 -> V_45 ) ;
...
int V_316 = F_197 ( V_315 , L_86 ) ;
struct V_317 * V_318 ;
void T_2 * V_319 ;
if ( V_316 <= 0 )
return - V_221 ;
V_318 = F_198 ( V_315 , V_320 , 0 ) ;
V_319 = F_199 ( V_3 , V_318 ) ;
if ( F_173 ( V_319 ) )
return F_174 ( V_319 ) ;
return F_164 ( V_3 , V_316 , V_319 ) ;
}
static int F_200 ( struct V_314 * V_315 )
{
struct V_2 * V_3 = & V_315 -> V_3 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long V_58 ;
...
V_1 -> V_323 . V_304 = F_181 ( V_1 -> V_53 ) ;
...
F_182 ( V_1 -> V_53 , V_1 -> V_323 . V_304 ) ;
V_21 = F_7 ( V_321 , V_24 ) ;
V_21 &= V_25 | V_355 ;
...
F_212 ( V_1 ) ;
V_78 = F_7 ( V_1 -> V_53 , V_98 ) ;
V_356 = V_97 | V_228 | V_126 ;
if ( ( V_78 & V_356 ) != ( V_1 -> V_323 . V_78 & V_356 ) )
V_1 -> V_75 = 0 ;
F_194 ( V_3 ) ;
F_223 ( V_3 ) ;
F_171 ( V_3 ) ;
