...
static void
F_228 ( unsigned long V_217 , unsigned long V_218 , void * * V_219 )
{
struct V_220 * * V_221 = (struct V_220 * * ) V_219 ;
struct V_220 * V_45 = * V_221 ;
if ( ! V_45 )
return;
if ( V_45 -> V_74 )
...
static void
F_229 ( unsigned long V_217 , unsigned long V_218 , void * * V_219 )
{
struct V_220 * * V_221 = (struct V_220 * * ) V_219 ;
struct V_220 * V_45 = * V_221 ;
if ( ! V_45 )
...
if ( ! V_45 -> V_222 )
return;
if ( V_45 -> V_74 == ! ( V_45 -> V_61 -> V_54 & V_82 ) )
return;
if ( V_45 -> V_222 != - 1 )
( V_45 -> V_222 ) -- ;
F_228 ( V_217 , V_218 , V_219 ) ;
}
static int
F_230 ( struct V_126 * V_127 , unsigned long V_217 ,
struct V_223 * V_224 , void * V_219 )
{
struct V_220 * V_45 = V_219 ;
F_121 ( V_127 , L_32 , ( void * ) V_217 ) ;
F_121 ( V_127 , L_33 ,
V_45 -> V_74 ? V_225 : V_226 ,
V_45 -> V_61 -> V_5 -> V_6 -> system ,
F_52 ( V_45 -> V_61 -> V_5 ) ) ;
if ( V_45 -> V_222 == - 1 )
F_140 ( V_127 , L_34 ) ;
else
F_121 ( V_127 , L_35 , V_45 -> V_222 ) ;
return 0 ;
}
static int
F_231 ( struct V_223 * V_224 , unsigned long V_217 ,
void * * V_219 )
{
struct V_220 * * V_221 = (struct V_220 * * ) V_219 ;
struct V_220 * V_45 = * V_221 ;
...
static void
F_232 ( struct V_223 * V_224 , unsigned long V_217 ,
void * * V_219 )
{
struct V_220 * * V_221 = (struct V_220 * * ) V_219 ;
struct V_220 * V_45 = * V_221 ;
if ( F_87 ( V_45 -> V_227 <= 0 ) )
return;
V_45 -> V_227 -- ;
if ( ! V_45 -> V_227 ) {
F_48 ( V_45 -> V_61 , 0 , 1 ) ;
F_233 ( V_45 -> V_61 -> V_5 -> V_189 ) ;
F_88 ( V_45 ) ;
}
* V_221 = NULL ;
}
static int
F_234 ( struct V_228 * V_229 ,
char * V_230 , char * V_231 , char * V_232 , int V_233 )
{
struct V_42 * V_43 = F_107 () ;
struct V_40 * V_61 ;
struct V_223 * V_224 ;
...
if ( ! V_233 || ! V_232 )
return - V_117 ;
system = F_105 ( & V_232 , L_3 ) ;
if ( ! V_232 )
return - V_117 ;
V_38 = F_105 ( & V_232 , L_3 ) ;
F_40 ( & V_75 ) ;
V_25 = - V_117 ;
V_61 = F_227 ( V_43 , system , V_38 ) ;
if ( ! V_61 )
goto V_143;
V_74 = strcmp ( V_231 , V_225 ) == 0 ;
if ( V_74 )
V_224 = V_232 ? & V_235 : & V_236 ;
else
V_224 = V_232 ? & V_237 : & V_238 ;
if ( V_230 [ 0 ] == '!' ) {
F_235 ( V_230 + 1 , V_224 ) ;
V_25 = 0 ;
goto V_143;
...
if ( ! V_232 )
goto V_239;
V_234 = F_105 ( & V_232 , L_3 ) ;
V_25 = - V_117 ;
if ( ! strlen ( V_234 ) )
goto V_170;
V_25 = F_236 ( V_234 , 0 , & V_45 -> V_222 ) ;
if ( V_25 )
goto V_170;
V_239:
V_25 = F_237 ( V_61 -> V_5 -> V_189 ) ;
if ( ! V_25 ) {
V_25 = - V_208 ;
goto V_170;
}
...
F_48 ( V_61 , 0 , 1 ) ;
V_133:
F_233 ( V_61 -> V_5 -> V_189 ) ;
V_170:
F_88 ( V_45 ) ;
goto V_143;
}
static T_6 int F_239 ( void )
{
int V_25 ;
V_25 = F_240 ( & V_242 ) ;
if ( F_13 ( V_25 < 0 ) )
...
static inline int F_239 ( void ) { return 0 ; }
static T_6 void
F_242 ( struct V_42 * V_43 )
{
struct V_40 * V_61 ;
int V_25 ;
F_6 (file, &tr->events, list) {
...
static T_6 int F_245 ( char * V_244 )
{
F_246 ( V_245 , V_244 , V_246 ) ;
V_247 = true ;
V_248 = true ;
return 1 ;
}
static int
F_247 ( struct V_109 * V_172 , struct V_42 * V_43 )
{
struct V_109 * V_177 ;
struct V_109 * V_59 ;
...
int F_248 ( struct V_109 * V_172 , struct V_42 * V_43 )
{
int V_25 ;
F_40 ( & V_75 ) ;
V_25 = F_247 ( V_172 , V_43 ) ;
if ( V_25 )
goto V_255;
F_207 ( & V_203 ) ;
F_226 ( V_43 ) ;
...
static T_6 int
F_249 ( struct V_109 * V_172 , struct V_42 * V_43 )
{
int V_25 ;
F_40 ( & V_75 ) ;
V_25 = F_247 ( V_172 , V_43 ) ;
...
static T_6 int F_252 ( void )
{
V_20 = F_253 ( V_9 , V_256 ) ;
V_113 = F_253 ( V_40 , V_256 ) ;
return 0 ;
}
static T_6 void
F_254 ( struct V_42 * V_43 , bool V_257 )
{
char * V_120 = V_245 ;
char * V_258 ;
int V_25 ;
while ( true ) {
V_258 = F_105 ( & V_120 , L_48 ) ;
if ( ! V_258 )
break;
if ( * V_258 ) {
if ( V_257 )
F_104 ( V_43 , V_258 , 0 ) ;
V_25 = F_104 ( V_43 , V_258 , 1 ) ;
if ( V_25 )
F_192 ( L_49 , V_258 ) ;
}
if ( V_120 )
...
static T_6 int F_255 ( void )
{
struct V_42 * V_43 = F_107 () ;
struct V_4 * * V_259 , * V_13 ;
int V_25 ;
if ( ! V_43 )
return - V_39 ;
...
static T_6 void F_265 ( struct V_263 * V_264 )
{
F_97 ( & V_265 ) ;
F_266 ( & V_266 ) ;
F_267 ( 1 ) ;
...
static T_6 int F_270 ( void * V_268 )
{
void * V_269 ;
V_269 = F_150 ( 1234 , V_156 ) ;
if ( ! V_269 )
F_51 ( L_55 ) ;
F_271 ( F_265 ) ;
F_88 ( V_269 ) ;
...
static T_6 void F_276 ( void )
{
struct V_92 * V_272 ;
V_272 = F_277 ( F_270 , NULL , L_56 ) ;
F_269 ( 1 ) ;
F_278 ( V_272 ) ;
}
static T_6 void F_279 ( void )
{
struct V_105 * V_106 ;
struct V_40 * V_61 ;
struct V_4 * V_13 ;
...
static void T_6
F_282 ( unsigned long V_217 , unsigned long V_218 ,
struct V_273 * V_274 , struct V_275 * V_275 )
{
struct V_276 * V_38 ;
struct V_277 * V_58 ;
struct V_278 * V_59 ;
...
F_283 () ;
V_28 = F_284 () ;
V_279 = F_50 ( & F_285 ( V_280 , V_28 ) ) ;
if ( V_279 != 1 )
goto V_143;
F_30 ( V_54 ) ;
V_38 = F_33 ( & V_58 , & V_281 ,
V_282 , sizeof( * V_59 ) ,
V_54 , V_56 ) ;
if ( ! V_38 )
goto V_143;
...
V_59 -> V_217 = V_217 ;
V_59 -> V_218 = V_218 ;
F_286 ( & V_281 , V_58 , V_38 ,
V_59 , V_54 , V_56 ) ;
V_143:
F_287 ( & F_285 ( V_280 , V_28 ) ) ;
F_288 () ;
}
