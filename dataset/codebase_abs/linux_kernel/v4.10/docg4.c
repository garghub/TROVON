...
V_15 -> V_120 . V_194 = F_43 ;
V_15 -> V_120 . V_195 = F_49 ;
V_15 -> V_120 . V_196 = F_45 ;
V_15 -> V_120 . V_197 = F_51 ;
if ( V_46 ) {
V_15 -> V_182 |= V_198 ;
V_15 -> V_199 = F_56 ;
}
...
int V_12 , V_69 ;
struct V_207 * V_208 ;
struct V_209 * V_24 = & V_153 -> V_24 ;
V_208 = F_66 ( V_153 , V_210 , 0 ) ;
if ( V_208 == NULL ) {
F_16 ( V_24 , L_36 ) ;
return - V_206 ;
}
V_23 = F_67 ( V_208 -> V_211 , F_68 ( V_208 ) ) ;
if ( ! V_23 ) {
F_16 ( V_24 , L_37 , V_208 ) ;
return - V_68 ;
}
...
F_70 ( V_15 , V_20 ) ;
V_2 -> V_24 . V_213 = & V_153 -> V_24 ;
V_20 -> V_23 = V_23 ;
V_20 -> V_24 = V_24 ;
F_60 ( V_2 ) ;
V_20 -> V_52 = F_71 ( V_214 , V_181 , V_215 ) ;
if ( V_20 -> V_52 == NULL ) {
V_69 = - V_216 ;
goto V_217;
}
...
if ( V_69 )
goto V_217;
V_69 = F_74 ( V_2 , V_218 , NULL , NULL , 0 ) ;
if ( V_69 )
goto V_217;
V_20 -> V_2 = V_2 ;
return 0 ;
