...
if ( V_132 && ! F_96 ( V_132 ) ) {
F_97 ( 10 , V_133 , V_115 , V_18 , V_62 -> V_134 ,
L_13
L_14 ) ;
goto V_119;
}
...
F_97 ( 1 , V_133 , V_115 , V_18 , V_62 -> V_134 ,
L_15
L_16 ) ;
goto V_119;
}
...
int
F_100 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
struct V_37 * V_29 ;
int V_81 , V_122 ;
...
struct V_131 * V_132 = F_95 ( V_18 , & V_130 ) ;
if ( V_132 && ! F_96 ( V_132 ) ) {
F_97 ( 10 , V_50 , V_115 , V_18 , V_62 -> V_134 ,
L_18
L_14 ) ;
goto V_119;
}
...
F_97 ( 1 , V_50 , V_115 , V_18 , V_62 -> V_134 ,
L_18
L_19 ) ;
goto V_119;
}
...
F_99 ( 10 , V_50 , V_115 , V_18 , V_62 -> V_134 , L_17 ) ;
V_18 -> V_120 = 1 ;
...
static struct V_17 *
F_101 ( struct V_17 * V_18 , int V_41 ,
...
#endif
F_72 ( V_18 ) ;
if ( F_102 ( V_18 ) < V_137 || F_103 ( V_18 ) ) {
V_142 = F_104 ( V_18 , V_137 ) ;
if ( ! V_142 )
goto error;
if ( V_18 -> V_56 )
F_105 ( V_142 , V_18 -> V_56 ) ;
F_106 ( V_18 ) ;
V_18 = V_142 ;
}
#ifdef F_24
...
static inline int F_110 ( int V_149 , int V_150 )
{
switch ( V_149 ) {
case V_133 :
return V_151 ;
...
int
F_111 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
...
V_29 = F_30 ( V_18 ) ;
V_154 = V_29 -> V_7 . V_38 ;
V_137 = F_112 ( V_154 ) + sizeof( struct V_79 ) ;
V_155 = F_38 ( V_60 ) ? & V_141 : NULL ;
V_18 = F_101 ( V_18 , V_101 -> V_110 , V_137 ,
& V_138 , NULL , & V_140 ,
& V_76 , V_155 ) ;
if ( F_17 ( V_18 ) )
goto V_119;
if ( F_113 ( V_18 , F_110 ( V_133 , V_101 -> V_110 ) ) )
goto V_119;
V_18 -> V_156 = V_18 -> V_157 ;
F_114 ( V_18 , sizeof( struct V_79 ) ) ;
F_115 ( V_18 ) ;
memset ( & ( F_116 ( V_18 ) -> V_158 ) , 0 , sizeof( F_116 ( V_18 ) -> V_158 ) ) ;
V_117 = F_29 ( V_18 ) ;
V_117 -> V_159 = 4 ;
...
V_117 -> V_26 = V_26 ;
V_117 -> V_76 = V_76 ;
F_117 ( V_23 , V_18 , NULL ) ;
V_18 -> V_120 = 1 ;
V_102 = F_68 ( V_18 , V_101 ) ;
if ( V_102 == V_103 )
F_118 ( V_23 , V_18 -> V_56 , V_18 ) ;
else if ( V_102 == V_163 )
F_87 ( V_18 ) ;
F_85 () ;
F_86 ( 10 ) ;
...
int
F_119 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , struct V_61 * V_62 )
{
struct V_37 * V_29 ;
struct V_91 V_26 ;
...
V_29 = (struct V_37 * ) F_27 ( V_18 ) ;
V_154 = V_29 -> V_7 . V_38 ;
V_137 = F_112 ( V_154 ) + sizeof( struct V_75 ) ;
V_18 = F_101 ( V_18 , V_101 -> V_110 , V_137 ,
& V_138 , & V_139 ,
& V_140 , & V_76 , NULL ) ;
if ( F_17 ( V_18 ) )
goto V_119;
if ( F_113 ( V_18 , F_110 ( V_50 , V_101 -> V_110 ) ) )
goto V_119;
V_18 -> V_156 = V_18 -> V_157 ;
F_114 ( V_18 , sizeof( struct V_75 ) ) ;
F_115 ( V_18 ) ;
memset ( & ( F_116 ( V_18 ) -> V_158 ) , 0 , sizeof( F_116 ( V_18 ) -> V_158 ) ) ;
V_117 = F_26 ( V_18 ) ;
V_117 -> V_159 = 6 ;
...
V_102 = F_68 ( V_18 , V_101 ) ;
if ( V_102 == V_103 )
F_121 ( V_101 -> V_60 -> V_23 , V_18 -> V_56 , V_18 ) ;
else if ( V_102 == V_163 )
F_87 ( V_18 ) ;
F_85 () ;
F_86 ( 10 ) ;
...
int
F_124 ( struct V_17 * V_18 , struct V_100 * V_101 ,
...
int
F_128 ( struct V_17 * V_18 , struct V_100 * V_101 ,
struct V_114 * V_115 , int V_166 , unsigned int V_167 ,
struct V_61 * V_62 )
{
struct V_37 * V_29 ;
