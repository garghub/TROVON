...
static unsigned int F_28 ( struct V_7 * V_4 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
unsigned long V_73 ;
unsigned int V_74 ;
F_29 ( & V_2 -> V_4 . V_70 , V_73 ) ;
V_74 = F_1 ( V_2 , V_39 ) & V_75 ? V_76 : 0 ;
F_30 ( & V_2 -> V_4 . V_70 , V_73 ) ;
return V_74 ;
}
static unsigned int F_31 ( struct V_7 * V_4 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
unsigned char V_15 ;
unsigned int V_74 ;
...
static void F_32 ( struct V_7 * V_4 , unsigned int V_83 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
...
static void F_33 ( struct V_7 * V_4 , int V_96 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
unsigned long V_73 ;
F_29 ( & V_2 -> V_4 . V_70 , V_73 ) ;
...
static int F_34 ( struct V_7 * V_4 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
unsigned long V_73 ;
int V_100 ;
...
V_2 -> V_84 = 0 ;
V_2 -> V_4 . V_102 = F_35 ( V_2 -> V_103 ) ;
V_100 = F_36 ( V_2 -> V_4 . V_63 , F_25 , 0 , V_2 -> V_104 , V_2 ) ;
if ( V_100 )
return V_100 ;
F_3 ( V_2 , V_105 , V_106 ) ;
F_3 ( V_2 , V_105 , V_106 |
...
static void
F_39 ( struct V_7 * V_4 , struct V_112 * V_113 ,
struct V_112 * V_114 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
...
V_115 |= V_134 ;
V_117 = F_40 ( V_4 , V_113 , V_114 , 0 , V_4 -> V_102 / 16 ) ;
V_118 = F_41 ( V_4 , V_117 ) ;
...
F_29 ( & V_2 -> V_4 . V_70 , V_73 ) ;
V_2 -> V_8 |= V_111 ;
F_42 ( V_4 , V_113 -> V_120 , V_117 ) ;
V_2 -> V_4 . V_13 = V_27 | V_71 | V_14 ;
if ( V_113 -> V_138 & V_139 )
V_2 -> V_4 . V_13 |= V_26 | V_25 ;
if ( V_113 -> V_138 & ( V_140 | V_141 | V_142 ) )
V_2 -> V_4 . V_13 |= V_24 ;
V_2 -> V_4 . V_143 = 0 ;
if ( V_113 -> V_138 & V_144 )
V_2 -> V_4 . V_143 |= V_25 | V_26 ;
if ( V_113 -> V_138 & V_140 ) {
V_2 -> V_4 . V_143 |= V_24 ;
if ( V_113 -> V_138 & V_144 )
V_2 -> V_4 . V_143 |= V_27 ;
}
...
static void
F_45 ( struct V_7 * V_4 , unsigned int V_40 ,
unsigned int V_150 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
if ( ! V_40 )
...
static void F_48 ( struct V_7 * V_4 )
{
}
static int F_49 ( struct V_7 * V_4 )
{
return 0 ;
}
static void F_50 ( struct V_7 * V_4 , int V_73 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
V_2 -> V_4 . type = V_151 ;
}
static int
F_51 ( struct V_7 * V_4 , struct V_152 * V_153 )
{
return - V_154 ;
}
static const char *
...
static void F_55 ( struct V_7 * V_4 , int V_16 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
F_53 ( V_2 ) ;
F_3 ( V_2 , V_45 , V_16 ) ;
...
static void
F_56 ( struct V_158 * V_159 , const char * V_160 , unsigned int V_43 )
{
...
V_162 = F_59 ( & V_2 -> V_4 . V_70 ) ;
else
F_26 ( & V_2 -> V_4 . V_70 ) ;
V_8 = F_1 ( V_2 , V_10 ) ;
F_3 ( V_2 , V_10 , V_111 ) ;
F_60 ( & V_2 -> V_4 , V_160 , V_43 , F_55 ) ;
F_53 ( V_2 ) ;
F_3 ( V_2 , V_10 , V_8 ) ;
if ( V_162 )
F_27 ( & V_2 -> V_4 . V_70 ) ;
...
if ( F_80 ( V_174 -> V_103 ) ) {
V_74 = F_81 ( V_174 -> V_103 ) ;
goto V_187;
}
V_74 = F_82 ( V_174 -> V_103 ) ;
if ( V_74 ) {
F_83 ( V_174 -> V_103 ) ;
goto V_187;
}
...
V_174 -> V_4 . V_73 = V_194 | V_195 ;
V_174 -> V_4 . V_102 = F_35 ( V_174 -> V_103 ) ;
V_74 = F_73 ( V_173 , V_174 ) ;
if ( V_74 > 0 )
