...
{
void * V_116 = F_57 ( V_115 , V_102 | V_117 ) ;
if ( ! V_116 )
V_116 = F_66 ( V_115 ) ;
return V_116 ;
}
static void F_67 ( void * V_118 )
{
F_68 ( V_118 ) ;
}
...
int V_83 ;
V_3 -> V_91 . V_119 = F_46 ;
V_3 -> V_91 . V_120 = ( unsigned long ) V_13 ;
F_73 ( & V_3 -> V_91 ) ;
...
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
unsigned char * V_125 = F_77 ( V_9 ) ;
struct V_97 V_94 ;
struct V_61 * V_31 = V_3 -> V_61 ;
memset ( & V_94 , 0 , sizeof( V_94 ) ) ;
V_94 . V_126 . V_104 = V_3 -> V_104 ;
V_94 . V_126 . V_90 = V_3 -> V_90 / V_105 ;
V_94 . V_126 . V_79 = V_3 -> V_79 ;
V_94 . V_126 . V_11 = V_3 -> V_11 ;
V_94 . V_126 . V_106 = V_3 -> V_87 ;
V_94 . V_108 = V_3 -> V_74 ;
V_94 . V_44 = V_3 -> V_44 ;
if ( V_31 ) {
...
V_94 . V_50 = V_3 -> V_50 ;
if ( F_78 ( V_9 , V_127 , sizeof( V_94 ) , & V_94 ) )
goto V_128;
return V_9 -> V_42 ;
V_128:
F_79 ( V_9 , V_125 ) ;
...
static unsigned long F_82 ( struct V_12 * V_13 , unsigned long V_129 ,
V_107 V_29 )
{
V_13 -> V_50 &= ~ V_124 ;
return 0 ;
}
static void F_83 ( struct V_12 * V_3 , unsigned long V_130 )
{
}
...
static int F_85 ( struct V_12 * V_13 , unsigned long V_130 ,
struct V_8 * V_9 , struct V_131 * V_132 )
{
V_132 -> V_133 |= F_7 ( V_130 ) ;
return 0 ;
}
static int F_86 ( struct V_12 * V_13 , unsigned long V_130 ,
struct V_134 * V_38 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
T_1 V_135 = V_3 -> V_47 [ V_130 - 1 ] ;
struct V_136 V_137 = { 0 } ;
struct V_138 V_139 = { 0 } ;
if ( V_135 != V_49 ) {
const struct V_33 * V_34 = & V_3 -> V_6 [ V_135 ] ;
V_139 . V_77 = V_34 -> V_77 << V_140 ;
V_137 . V_35 = V_34 -> V_35 ;
V_137 . V_45 = V_34 -> V_45 ;
}
if ( F_87 ( V_38 , NULL , & V_137 , V_137 . V_35 ) < 0 )
return - 1 ;
return F_88 ( V_38 , & V_139 , sizeof( V_139 ) ) ;
}
static void F_89 ( struct V_12 * V_13 , struct V_141 * V_88 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
unsigned int V_83 ;
if ( V_88 -> V_142 )
...
if ( V_88 -> V_145 ( V_13 , V_83 + 1 , V_88 ) < 0 ) {
V_88 -> V_142 = 1 ;
break;
}
V_88 -> V_143 ++ ;
