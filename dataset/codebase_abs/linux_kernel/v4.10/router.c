...
V_137 . V_164 = V_165 ;
V_137 . V_166 = V_167 ;
V_137 . V_168 = V_30 . V_169 ;
F_11 ( ! F_71 ( V_30 . V_169 ) ) ;
V_66 = F_73 ( V_137 , V_170 , & V_121 -> V_140 ) ;
if ( V_66 < 0 ) {
F_36 ( L_14 , V_66 ) ;
goto V_143;
}
...
V_28 -> V_14 , V_28 -> V_13 , V_28 -> V_172 ) ;
if ( V_171 && ! V_28 -> V_144 &&
F_77 ( V_152 , F_78 ( V_28 -> V_172 ,
F_63 ( V_171 ) ) ) ) {
int V_66 ;
T_14 V_173 ;
T_15 V_174 ;
V_173 . V_133 = V_28 -> V_19 ;
V_173 . V_175 = V_176 ;
F_5 ( V_11 , L_16 , F_79 ( V_173 ) ) ;
V_28 -> V_144 = 1 ;
V_28 -> V_172 = V_152 ;
V_174 = V_121 -> V_140 ;
if ( ! V_28 -> V_12 ) {
...
F_8 ( V_28 -> V_23 ) ;
V_66 = F_81 ( V_67 , V_174 , V_173 , V_177 ,
V_178 , 0 ) ;
F_9 ( V_28 -> V_23 ) ;
if ( V_66 )
V_28 -> V_144 = 0 ;
...
F_84 ( & V_30 . V_183 ) ;
V_66 = F_85 ( 0 , F_56 , & V_30 . V_169 ) ;
if ( V_66 ) {
F_36 ( L_18 , V_181 , V_66 ) ;
return - V_71 ;
}
V_30 . V_149 = V_150 ;
V_180 = F_86 ( V_184 , NULL , L_19 ) ;
if ( F_87 ( V_180 ) ) {
V_66 = F_88 ( V_180 ) ;
F_36 ( L_20 , V_66 ) ;
F_89 ( & V_30 . V_183 ) ;
V_66 = F_90 ( V_30 . V_169 ) ;
F_11 ( ! V_66 ) ;
V_30 . V_149 = V_182 ;
return - V_71 ;
}
...
F_94 ( & V_187 , & V_30 . V_188 ) ;
while ( ! F_17 ( & V_30 . V_188 ) ) {
F_95 (rcd, tmp, &the_lnet.ln_rcd_zombie,
rcd_list) {
if ( F_71 ( V_121 -> V_140 ) )
F_96 ( & V_121 -> V_34 , & V_187 ) ;
}
V_186 = V_186 &&
! F_17 ( & V_30 . V_188 ) ;
F_8 ( V_76 ) ;
while ( ! F_17 ( & V_187 ) ) {
V_121 = F_13 ( V_187 . V_189 ,
T_10 , V_34 ) ;
F_97 ( & V_121 -> V_34 ) ;
F_70 ( V_121 ) ;
}
...
void
F_104 ( T_17 * V_196 , int V_197 )
{
int V_198 = F_105 ( T_17 , V_199 [ V_197 ] ) ;
while ( -- V_197 >= 0 )
F_106 ( V_196 -> V_199 [ V_197 ] . V_200 ) ;
F_37 ( V_196 , V_198 ) ;
}
static T_17 *
F_107 ( T_7 * V_99 , int V_83 )
{
int V_197 = V_99 -> V_102 ;
int V_198 = F_105 ( T_17 , V_199 [ V_197 ] ) ;
struct V_201 * V_201 ;
T_17 * V_196 ;
int V_84 ;
F_108 ( V_196 , F_109 () , V_83 , V_198 ) ;
if ( ! V_196 )
return NULL ;
V_196 -> V_202 = V_99 ;
for ( V_84 = 0 ; V_84 < V_197 ; V_84 ++ ) {
V_201 = F_110 (
F_111 ( F_109 () , V_83 ) ,
V_203 | V_204 , 0 ) ;
if ( ! V_201 ) {
while ( -- V_84 >= 0 )
F_106 ( V_196 -> V_199 [ V_84 ] . V_200 ) ;
F_37 ( V_196 , V_198 ) ;
return NULL ;
}
V_196 -> V_199 [ V_84 ] . V_205 = V_206 ;
V_196 -> V_199 [ V_84 ] . V_207 = 0 ;
V_196 -> V_199 [ V_84 ] . V_200 = V_201 ;
}
return V_196 ;
}
static void
...
F_38 ( & V_38 ) ;
F_9 ( V_83 ) ;
F_113 ( & V_99 -> V_209 , V_83 ) ;
F_94 ( & V_99 -> V_210 , & V_38 ) ;
V_99 -> V_211 = 0 ;
V_99 -> V_104 = 0 ;
V_99 -> V_106 = 0 ;
V_99 -> V_108 = 0 ;
...
static int
F_114 ( T_7 * V_99 , int V_213 , int V_83 )
{
struct V_26 V_212 ;
T_17 * V_196 ;
int V_214 ;
...
int V_197 = V_99 -> V_102 ;
F_9 ( V_83 ) ;
V_214 = V_213 - V_99 -> V_104 ;
if ( V_213 <= V_99 -> V_211 || V_214 <= 0 ) {
V_99 -> V_211 = V_213 ;
F_8 ( V_83 ) ;
return 0 ;
}
...
F_14 ( & V_196 -> V_212 , & V_212 ) ;
V_215 ++ ;
}
F_9 ( V_83 ) ;
F_115 ( & V_212 , & V_99 -> V_210 ) ;
V_99 -> V_104 += V_215 ;
V_99 -> V_106 += V_215 ;
V_99 -> V_108 = V_99 -> V_106 ;
while ( ! F_17 ( & V_99 -> V_210 ) &&
! F_17 ( & V_99 -> V_209 ) )
F_116 ( V_99 ) ;
F_8 ( V_83 ) ;
return 0 ;
V_217:
while ( ! F_17 ( & V_212 ) ) {
V_196 = F_13 ( V_212 . V_189 , T_17 , V_212 ) ;
F_18 ( & V_196 -> V_212 ) ;
F_104 ( V_196 , V_197 ) ;
}
return - V_71 ;
...
F_112 ( & V_219 [ V_220 ] , V_84 ) ;
F_112 ( & V_219 [ V_221 ] , V_84 ) ;
F_112 ( & V_219 [ V_222 ] , V_84 ) ;
}
if ( ! V_218 ) {
F_119 ( V_30 . V_97 ) ;
V_30 . V_97 = NULL ;
...
int V_66 ;
int V_84 ;
if ( ! strcmp ( V_238 , L_26 ) ) {
if ( ! V_234 )
return 0 ;
} else if ( ! strcmp ( V_238 , L_27 ) ) {
return 0 ;
} else if ( ! strcmp ( V_238 , L_28 ) ) {
} else {
F_83 ( 0x10b , L_29 ) ;
return - V_69 ;
}
...
F_47 (rtrp, i, the_lnet.ln_rtrpools) {
F_117 ( & V_219 [ V_220 ] , 0 ) ;
V_66 = F_114 ( & V_219 [ V_220 ] ,
V_235 , V_84 ) ;
if ( V_66 )
goto V_217;
F_117 ( & V_219 [ V_221 ] ,
V_239 ) ;
V_66 = F_114 ( & V_219 [ V_221 ] ,
V_236 , V_84 ) ;
if ( V_66 )
goto V_217;
F_117 ( & V_219 [ V_222 ] ,
V_240 ) ;
V_66 = F_114 ( & V_219 [ V_222 ] ,
V_237 , V_84 ) ;
if ( V_66 )
goto V_217;
}
...
static int
F_125 ( int V_241 , int V_242 , int V_243 )
{
int V_244 = 0 ;
int V_66 = 0 ;
int V_84 ;
...
int
F_126 ( int V_241 , int V_242 , int V_243 )
{
if ( ! V_30 . V_110 )
return 0 ;
return F_125 ( V_241 , V_242 , V_243 ) ;
}
int
F_127 ( void )
{
...
V_6 = F_135 ( V_30 . V_248 [ V_83 ] , V_133 ) ;
if ( ! V_6 ) {
F_8 ( V_83 ) ;
F_5 ( V_11 , L_40 , F_6 ( V_133 ) ) ;
return 0 ;
}
if ( V_1 && ! V_8 && V_9 < V_6 -> V_249 )
V_9 = V_6 -> V_249 ;
F_3 ( V_6 , ! V_1 , V_8 , V_9 ) ;
if ( V_1 )
F_7 ( V_1 , V_6 ) ;
