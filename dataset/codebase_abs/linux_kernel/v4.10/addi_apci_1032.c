...
struct V_1 * V_2 = V_52 ;
struct V_13 * V_14 = V_2 -> V_15 ;
struct V_8 * V_9 = V_2 -> V_53 ;
unsigned int V_21 ;
if ( ( F_3 ( V_14 -> V_54 + V_55 ) &
V_56 ) == 0 )
return V_57 ;
...
unsigned int * V_12 )
{
V_12 [ 1 ] = F_3 ( V_2 -> V_3 + V_59 ) ;
return V_11 -> V_29 ;
}
static int F_16 ( struct V_1 * V_2 ,
unsigned long V_60 )
{
struct V_61 * V_62 = F_17 ( V_2 ) ;
struct V_13 * V_14 ;
struct V_8 * V_9 ;
int V_63 ;
V_14 = F_18 ( V_2 , sizeof( * V_14 ) ) ;
if ( ! V_14 )
return - V_64 ;
V_63 = F_19 ( V_2 ) ;
if ( V_63 )
return V_63 ;
V_14 -> V_54 = F_20 ( V_62 , 0 ) ;
V_2 -> V_3 = F_20 ( V_62 , 1 ) ;
F_1 ( V_2 ) ;
if ( V_62 -> V_51 > 0 ) {
V_63 = F_21 ( V_62 -> V_51 , F_12 , V_65 ,
V_2 -> V_66 , V_2 ) ;
if ( V_63 == 0 )
V_2 -> V_51 = V_62 -> V_51 ;
}
...
static int F_25 ( struct V_61 * V_2 ,
const struct V_83 * V_84 )
{
return F_26 ( V_2 , & V_85 , V_84 -> V_86 ) ;
}
