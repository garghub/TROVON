...
V_104 = F_43 ( V_102 ) ;
if ( V_104 ) {
struct V_109 * V_110 = & V_101 -> V_110 [ V_6 ] ;
V_110 -> V_111 = V_104 -> V_112 ;
V_110 -> V_113 = V_104 -> V_114 ;
V_110 -> V_115 = V_104 -> V_116 ;
V_110 -> V_117 = V_104 -> V_118 ;
V_110 -> V_119 = V_104 -> V_120 -> V_121 ;
V_110 -> V_122 = V_104 -> V_123 ;
V_101 -> V_124 [ V_6 ] = true ;
}
if ( V_6 & 1 )
F_44 ( V_102 ) ;
}
}
bool V_52 ( struct V_125 * V_126 ,
const struct V_52 * V_127 )
{
T_3 V_6 ;
unsigned long V_128 [ 2 ] = { 0 , 0 } ;
...
V_101 = V_126 -> V_101 ;
if ( V_126 -> V_18 )
V_20 = V_126 -> V_18 -> V_20 ;
if ( ! V_20 && ( V_3 || V_15 ) )
return false ;
V_78 = (struct V_77 * ) ( V_127 + 1 ) ;
V_80 = ( const struct V_79 * ) ( V_78 + V_56 ) ;
V_81 = ( const struct V_40 * )
( V_80 + V_127 -> V_57 ) ;
V_4 = ( const struct F_1 * ) ( V_81 + V_127 -> V_58 ) ;
...
const T_1 V_1 = V_131 ? V_50 : V_49 ;
unsigned long V_11 = 0 ;
switch ( V_1 ) {
case V_134 :
V_11 = F_45 ( & V_135 , F_46 () ) ;
break;
case V_136 :
V_11 = F_45 ( & V_135 , F_47 () ) ;
break;
case V_137 :
V_11 = F_45 ( & V_135 , F_48 () ) ;
break;
case V_138 :
V_11 = F_45 ( & V_135 , F_49 () ) ;
break;
case V_139 :
V_11 = F_50 ( & V_135 , F_51 () ) ;
break;
case V_140 :
V_11 = F_50 ( & V_135 , F_52 () ) ;
break;
case V_141 :
V_11 = F_50 ( & V_135 , F_53 () ) ;
break;
case V_142 :
V_11 = F_50 ( & V_135 , F_54 () ) ;
break;
case V_143 :
V_11 = F_55 () ;
break;
...
if ( ! V_101 -> V_124 [ V_186 ] )
goto V_33;
V_110 = & V_101 -> V_110 [ V_186 ] ;
switch ( V_1 ) {
case V_187 :
case V_196 :
case V_205 :
case V_210 :
V_11 = F_45 ( & V_135 , V_110 -> V_111 ) ;
break;
case V_188 :
case V_197 :
case V_206 :
case V_211 :
V_11 = F_50 ( & V_135 , V_110 -> V_113 ) ;
break;
case V_189 :
case V_198 :
case V_207 :
...
case V_190 :
case V_199 :
V_11 = F_57 ( V_110 -> V_119 ) ;
break;
case V_191 :
case V_200 :
V_11 = F_58 ( V_110 -> V_119 ) ;
break;
case V_192 :
case V_201 :
V_11 = V_110 -> V_117 & V_215 ;
break;
case V_193 :
case V_202 :
V_11 = F_57 ( V_110 -> V_122 ) ;
break;
case V_194 :
case V_203 :
V_11 = F_58 ( V_110 -> V_122 ) ;
break;
case V_195 :
case V_204 :
case V_208 :
case V_213 :
V_11 = V_110 -> V_117 & V_216 ;
break;
}
}
break;
...
V_128 [ 0 ] = V_41 -> V_217 [ 0 ] ;
V_129 [ 0 ] = V_41 -> V_217 [ 1 ] ;
}
if ( V_50 == V_93 ) {
const struct V_79 * V_41 = V_80 ++ ;
if ( V_41 -> V_218 ) {
...
if ( ( V_128 [ 0 ] <= V_41 -> V_217 [ 1 ] &&
V_129 [ 0 ] >= V_41 -> V_217 [ 0 ] ) == V_42 )
continue;
}
goto V_33;
}
...
if ( ( V_128 [ 0 ] <= V_129 [ 1 ] && V_129 [ 0 ] >= V_128 [ 1 ] ) == V_42 )
continue;
V_33:
return false ;
}
if ( V_126 -> V_18 && ( V_3 || V_15 ) )
return F_5 ( V_126 -> V_18 , V_3 , V_4 , V_15 , V_16 ) ;
return true ;
}
