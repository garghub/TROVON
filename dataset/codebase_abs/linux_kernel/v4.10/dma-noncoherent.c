...
T_5 * V_41 ;
unsigned long V_42 ;
V_41 = F_27 ( F_28 ( F_29 ( F_30 ( V_5 ) ,
V_5 ) ,
V_5 ) ,
V_5 ) ;
if ( ! F_31 ( * V_41 ) && F_32 ( * V_41 ) ) {
V_42 = F_33 ( * V_41 ) ;
F_34 ( & V_43 , V_5 , V_41 ) ;
if ( F_35 ( V_42 ) ) {
struct V_20 * V_20 = F_36 ( V_42 ) ;
F_37 ( V_20 ) ;
}
}
V_5 += V_37 ;
} while ( V_3 -= V_37 );
F_38 ( V_10 -> V_6 , V_10 -> V_8 ) ;
F_39 ( & V_10 -> V_16 ) ;
F_6 ( & V_13 , V_9 ) ;
F_7 ( V_10 ) ;
return;
...
void F_40 ( void * V_35 , T_1 V_3 , int V_44 )
{
...
static inline void F_44 ( struct V_20 * V_20 ,
unsigned long V_51 , T_1 V_3 , int V_44 )
{
T_1 V_52 = F_45 ( ( T_1 ) ( V_37 - V_51 ) , V_3 ) ;
T_1 V_53 = V_52 ;
...
F_46 ( V_9 ) ;
do {
V_45 = ( unsigned long ) F_47 ( V_20 + V_56 ) + V_54 ;
F_40 ( ( void * ) V_45 , V_52 , V_44 ) ;
F_48 ( ( void * ) V_45 ) ;
V_56 ++ ;
V_52 = F_45 ( ( T_1 ) V_37 , V_3 - V_53 ) ;
V_53 += V_52 ;
V_54 = 0 ;
} while ( V_56 < V_55 );
F_49 ( V_9 ) ;
}
void F_50 ( struct V_20 * V_20 , unsigned long V_51 ,
T_1 V_3 , int V_44 )
{
#ifdef F_51
F_44 ( V_20 , V_51 , V_3 , V_44 ) ;
#else
unsigned long V_45 = ( unsigned long ) F_15 ( V_20 ) + V_51 ;
F_40 ( ( void * ) V_45 , V_3 , V_44 ) ;
#endif
}
unsigned long F_52 ( unsigned long V_57 )
{
T_6 * V_58 = F_30 ( V_57 ) ;
T_7 * V_59 = F_29 ( V_58 , V_57 ) ;
T_8 * V_60 = F_28 ( V_59 , V_57 ) ;
T_5 * V_41 = F_27 ( V_60 , V_57 ) ;
if ( F_31 ( * V_41 ) || ! F_32 ( * V_41 ) )
return 0 ;
return F_33 ( * V_41 ) ;
}
