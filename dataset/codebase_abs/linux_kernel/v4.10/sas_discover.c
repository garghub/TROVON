...
struct V_12 * V_13 = V_89 -> V_13 ;
struct V_70 * V_72 = V_13 -> V_72 ;
struct V_1 * V_119 = V_13 -> V_53 ;
F_75 ( & V_72 -> V_120 ) ;
if ( F_60 ( V_121 , & V_72 -> V_82 ) ) {
F_69 ( L_8 ,
V_13 -> V_43 , F_70 ( V_117 ) ) ;
goto V_122;
}
F_36 ( V_123 , & V_13 -> V_59 . V_91 ) ;
F_69 ( L_9 , V_13 -> V_43 ,
F_70 ( V_117 ) ) ;
if ( V_119 && ( V_119 -> V_3 == V_8 ||
V_119 -> V_3 == V_7 ) )
V_69 = F_76 ( V_119 ) ;
F_69 ( L_10 ,
...
static void F_78 ( struct V_70 * V_72 , struct V_124 * V_125 )
{
F_79 ( V_72 -> V_75 . V_74 , & V_125 -> V_86 ) ;
}
static void F_80 ( int V_126 , unsigned long * V_91 ,
struct V_124 * V_125 ,
struct V_70 * V_72 )
{
if ( ! F_62 ( V_126 , V_91 ) ) {
unsigned long V_127 ;
F_81 ( & V_72 -> V_105 , V_127 ) ;
F_78 ( V_72 , V_125 ) ;
F_82 ( & V_72 -> V_105 , V_127 ) ;
}
}
int F_47 ( struct V_12 * V_13 , enum V_128 V_89 )
{
struct V_129 * V_59 ;
if ( ! V_13 )
return 0 ;
V_59 = & V_13 -> V_59 ;
F_83 ( V_89 >= V_130 ) ;
F_80 ( V_89 , & V_59 -> V_91 , & V_59 -> V_131 [ V_89 ] . V_86 , V_13 -> V_72 ) ;
return 0 ;
}
void F_84 ( struct V_129 * V_59 , struct V_12 * V_13 )
{
int V_77 ;
static const T_1 V_132 [ V_130 ] = {
[ V_116 ] = F_68 ,
[ V_123 ] = F_74 ,
[ V_90 ] = F_34 ,
[ V_95 ] = F_42 ,
...
F_85 ( & V_59 -> V_131 [ V_77 ] . V_86 , V_132 [ V_77 ] ) ;
V_59 -> V_131 [ V_77 ] . V_13 = V_13 ;
}
}
