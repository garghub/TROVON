...
static struct V_176 * F_111 ( T_6 * V_177 )
{
int V_178 ;
...
continue;
* V_177 = V_178 + 1 ;
return & F_113 ( V_176 , V_178 ) ;
}
return NULL ;
}
static void * F_114 ( struct V_180 * V_181 , T_6 * V_103 )
{
T_6 V_182 = * V_103 - 1 ;
if ( * V_103 == 0 )
return V_183 ;
...
static void * F_115 ( struct V_180 * V_181 , void * V_184 , T_6 * V_103 )
{
return F_111 ( V_103 ) ;
}
static int F_116 ( struct V_180 * V_181 , void * V_184 )
{
...
struct V_39 * V_39 ;
struct V_147 * V_147 ;
V_147 = F_103 ( V_154 , V_194 [ V_130 ] . V_145 ) ;
if ( ! V_147 )
return - V_26 ;
V_39 = F_89 ( V_154 -> V_161 , V_162 | V_194 [ V_130 ] . V_136 ) ;
if ( ! V_39 )
return - V_26 ;
...
static inline unsigned long F_126 ( T_8 V_203 )
{
return ( V_203 * ( V_204 + 1 ) ) | V_205 ;
}
static inline T_8 F_127 ( unsigned long V_35 )
{
return ( V_35 & V_144 ) / ( V_204 + 1 ) ;
}
static inline unsigned long F_128 ( T_8 V_203 , T_2 V_206 )
{
...
char V_207 [ V_20 ] ;
T_3 V_65 = snprintf ( V_207 , sizeof( V_207 ) , L_1 , F_127 ( V_35 ) ) ;
...
unsigned long V_35 = F_24 ( V_14 ) -> V_36 ;
char V_207 [ V_20 ] ;
T_3 V_65 = snprintf ( V_207 , sizeof( V_207 ) , L_1 , F_129 ( V_35 ) ) ;
return F_10 ( V_16 , V_17 , V_18 , V_207 , V_65 ) ;
}
...
V_208 = F_133 ( V_36 & V_144 ) ;
V_21 = F_9 ( V_19 , V_20 , L_1 , V_208 ) ;
return F_10 ( V_16 , V_17 , V_18 , V_19 , V_21 ) ;
}
static int F_134 ( char * V_209 , int V_210 ,
struct V_147 * V_154 )
{
int V_130 , V_58 , V_211 ;
char * * V_6 ;
V_58 = F_135 ( V_209 , & V_6 , & V_211 ) ;
if ( V_58 )
return V_58 ;
...
static int F_136 ( char * V_213 , int V_143 ,
struct V_147 * V_154 )
{
struct V_147 * V_147 = NULL ;
struct V_39 * V_39 = NULL ;
...
F_105 ( V_147 , V_39 ) ;
V_147 = F_137 ( V_154 , L_22 , & V_215 ) ;
if ( F_13 ( V_147 ) )
return F_14 ( V_147 ) ;
V_58 = F_134 ( V_213 , V_143 , V_147 ) ;
return V_58 ;
}
...
char * * V_217 ;
F_99 ( V_218 ) ;
V_58 = F_138 ( & V_217 , & V_216 ) ;
if ( V_58 )
return V_58 ;
V_215 = F_126 ( V_216 + 2 ) ;
for ( V_130 = 0 ; V_130 < V_216 ; V_130 ++ ) {
struct V_147 * V_219 ;
V_219 = F_137 ( V_218 , V_217 [ V_130 ] ,
& V_215 ) ;
if ( F_13 ( V_219 ) ) {
V_58 = F_14 ( V_219 ) ;
goto V_28;
}
V_58 = F_136 ( V_217 [ V_130 ] , V_130 + 1 ,
V_219 ) ;
if ( V_58 )
goto V_28;
}
...
V_147 = F_103 ( V_221 , L_23 ) ;
if ( V_147 == NULL )
return - V_26 ;
V_39 = F_89 ( V_221 -> V_161 , V_162 | V_163 ) ;
if ( V_39 == NULL )
return - V_26 ;
V_39 -> V_171 = & V_224 ;
...
if ( ! V_147 )
return F_139 ( - V_26 ) ;
V_39 = F_89 ( V_154 -> V_161 , V_226 | V_163 | V_227 ) ;
if ( ! V_39 ) {
F_140 ( V_147 ) ;
return F_139 ( - V_26 ) ;
}
...
static int F_143 ( struct V_134 * V_135 , void * V_64 , int V_231 )
{
int V_66 ;
struct V_147 * V_147 ;
struct V_39 * V_39 ;
...
[ V_233 ] = { L_24 , & V_234 , V_235 | V_164 } ,
[ V_236 ] = { L_25 , & V_237 , V_163 | V_164 } ,
[ V_238 ] = { L_26 , & V_239 , V_163 | V_240 } ,
[ V_241 ] = { L_27 , & V_239 , V_163 | V_240 } ,
[ V_242 ] = { L_28 , & V_239 , V_163 | V_240 } ,
[ V_243 ] = { L_29 , & V_239 , V_163 | V_240 } ,
[ V_244 ] = { L_30 , & V_239 , V_163 | V_240 } ,
[ V_245 ] = { L_31 , & V_246 , V_163 } ,
[ V_247 ] = { L_32 , & V_248 , V_164 } ,
[ V_249 ] = { L_33 , & V_250 , V_163 } ,
[ V_251 ] = { L_34 , & V_252 , V_164 } ,
[ V_253 ] = { L_35 , & V_239 , V_163 | V_240 } ,
[ V_254 ] = { L_36 , & V_255 , V_163 | V_164 } ,
[ V_38 ] = { L_37 , & V_256 , V_163 } ,
[ V_257 ] = { L_38 , & V_256 , V_163 } ,
[ V_258 ] = { L_39 , & V_259 , V_163 } ,
[ V_260 ] = { L_40 , & V_261 , V_163 } ,
[ V_262 ] = { L_41 , & V_263 ,
V_240 } ,
{ L_42 }
} ;
V_66 = F_144 ( V_135 , V_264 , V_232 ) ;
if ( V_66 )
goto V_61;
V_155 = F_137 ( V_135 -> V_265 , V_166 , & V_199 ) ;
if ( F_13 ( V_155 ) ) {
V_66 = F_14 ( V_155 ) ;
V_155 = NULL ;
goto V_61;
...
V_66 = - V_26 ;
V_147 = F_103 ( V_135 -> V_265 , V_266 ) ;
if ( ! V_147 )
goto V_61;
V_66 = - V_26 ;
V_39 = F_89 ( V_135 , V_267 | V_163 | V_240 ) ;
if ( ! V_39 )
goto V_61;
V_39 -> V_36 = ++ V_199 ;
V_157 = (struct V_156 * ) V_39 -> V_167 ;
...
V_157 -> V_269 = V_270 ;
V_157 -> V_169 = V_170 ;
F_145 ( V_39 , V_267 | V_163 | V_240 , F_146 ( V_271 , 3 ) ) ;
F_105 ( V_147 , V_39 ) ;
V_272 . V_147 = V_147 ;
V_147 = F_137 ( V_135 -> V_265 , L_43 , & V_199 ) ;
if ( F_13 ( V_147 ) ) {
V_66 = F_14 ( V_147 ) ;
goto V_61;
}
...
if ( V_66 )
goto V_61;
V_147 = F_137 ( V_135 -> V_265 , L_44 , & V_199 ) ;
if ( F_13 ( V_147 ) ) {
V_66 = F_14 ( V_147 ) ;
goto V_61;
}
...
if ( V_66 )
goto V_61;
V_218 = F_137 ( V_135 -> V_265 , L_45 , & V_199 ) ;
if ( F_13 ( V_218 ) ) {
V_66 = F_14 ( V_218 ) ;
V_218 = NULL ;
goto V_61;
}
V_221 = F_137 ( V_135 -> V_265 , L_46 , & V_199 ) ;
if ( F_13 ( V_221 ) ) {
V_66 = F_14 ( V_221 ) ;
V_221 = NULL ;
goto V_61;
...
static struct V_147 * F_147 ( struct V_273 * V_274 ,
int V_71 , const char * V_275 , void * V_64 )
{
return F_148 ( V_274 , V_71 , V_64 , F_143 ) ;
}
