...
if ( ! F_63 ( V_64 ) )
goto V_205;
V_203 = F_113 ( F_63 ( V_64 ) ,
& F_70 ( V_64 ) -> V_102 ) ;
if ( ! V_203 )
goto V_205;
V_201 = (struct V_1 * ) & V_203 -> V_206 ;
V_204 = F_80 ( V_201 ) ;
if ( V_204 == V_145 )
V_201 = & F_70 ( V_64 ) -> V_102 ;
memcpy ( & V_189 -> V_102 , V_201 , sizeof( V_189 -> V_102 ) ) ;
F_114 ( V_203 ) ;
...
if ( V_196 )
V_131 = F_115 ( & V_25 -> V_47 ) ;
if ( ! F_109 ( V_25 , & V_189 -> V_103 , & V_189 -> V_102 ) )
goto V_205;
if ( ! V_131 ) {
V_200:
V_131 = F_116 ( V_22 , NULL , V_189 ) ;
if ( V_131 -> error )
goto V_205;
V_131 = F_117 ( V_22 , V_131 , F_118 ( V_189 ) , NULL , 0 ) ;
if ( F_59 ( V_131 ) ) {
V_48 = F_119 ( V_131 ) ;
V_131 = NULL ;
goto V_205;
...
V_106 = F_64 ( V_131 ) - V_193 - V_25 -> V_211 ;
if ( V_111 >= 0 ) {
V_195 += 8 ;
V_106 -= 8 ;
}
...
if ( V_64 -> V_100 - V_25 -> V_211 > V_106 && ! F_123 ( V_64 ) ) {
* V_190 = V_106 ;
V_48 = - V_212 ;
goto V_210;
}
...
V_195 += F_126 ( V_192 ) ;
if ( F_127 ( V_64 ) < V_195 || F_128 ( V_64 ) ||
( F_129 ( V_64 ) && ! F_130 ( V_64 , 0 ) ) ) {
struct V_63 * V_217 ;
V_217 = F_131 ( V_64 , V_195 ) ;
if ( ! V_217 )
goto V_210;
if ( V_64 -> V_218 )
F_132 ( V_217 , V_64 -> V_218 ) ;
F_133 ( V_64 ) ;
V_64 = V_217 ;
}
if ( V_25 -> V_30 . V_43 ) {
if ( V_25 -> V_219 . type != V_220 )
goto V_210;
} else {
if ( V_196 && V_191 )
F_134 ( & V_25 -> V_47 , V_191 , & V_189 -> V_103 ) ;
}
F_61 ( V_64 , V_131 ) ;
if ( V_111 >= 0 ) {
F_107 ( & V_88 , V_111 ) ;
F_135 ( V_64 , & V_88 . V_135 , & V_104 , NULL , NULL ) ;
}
V_195 = F_126 ( V_131 -> V_8 ) + sizeof( struct V_66 )
+ V_131 -> V_221 + V_25 -> V_222 ;
if ( V_195 > V_8 -> V_223 )
V_8 -> V_223 = V_195 ;
V_48 = F_136 ( V_64 , V_25 , & V_104 , V_189 ) ;
if ( V_48 )
return V_48 ;
F_137 ( V_64 , sizeof( struct V_66 ) ) ;
F_55 ( V_64 ) ;
V_67 = F_70 ( V_64 ) ;
F_138 ( V_67 , F_139 ( 0 , V_140 ) ,
F_140 ( V_22 , V_64 , V_189 -> V_224 , true , V_189 ) ) ;
V_67 -> V_197 = V_197 ;
V_67 -> V_71 = V_104 ;
...
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
const struct V_116 * V_226 = F_56 ( V_64 ) ;
int V_111 = - 1 ;
struct V_188 V_189 ;
T_4 V_140 ;
T_7 V_106 ;
T_5 V_98 ;
int V_48 ;
memset ( & ( F_144 ( V_64 ) -> V_88 ) , 0 , sizeof( F_144 ( V_64 ) -> V_88 ) ) ;
V_98 = F_46 ( V_25 -> V_30 . V_104 ) ;
...
if ( V_25 -> V_30 . V_43 ) {
struct V_227 * V_228 ;
const struct V_229 * V_198 ;
V_228 = F_112 ( V_64 ) ;
if ( F_92 ( ! V_228 || ! ( V_228 -> V_230 & V_231 ) ||
F_146 ( V_228 ) != V_232 ) )
return - 1 ;
V_198 = & V_228 -> V_198 ;
memset ( & V_189 , 0 , sizeof( V_189 ) ) ;
V_189 . V_233 = V_122 ;
V_189 . V_102 = V_198 -> V_234 . V_235 . V_131 ;
V_189 . V_224 = V_198 -> V_236 ;
} else {
if ( ! ( V_25 -> V_30 . V_33 & V_237 ) )
V_111 = V_25 -> V_30 . V_111 ;
memcpy ( & V_189 , & V_25 -> V_238 . V_234 . V_239 , sizeof( V_189 ) ) ;
V_189 . V_233 = V_122 ;
if ( V_25 -> V_30 . V_33 & V_207 )
V_189 . V_224 |= F_66 ( ( T_7 ) V_226 -> V_130 << V_240 )
& V_241 ;
if ( V_25 -> V_30 . V_33 & V_208 )
V_189 . V_242 = V_64 -> V_243 ;
}
V_189 . V_244 = F_147 ( F_27 ( V_8 ) , NULL ) ;
if ( F_148 ( V_64 , V_245 ) )
return - 1 ;
F_149 ( V_64 , V_122 ) ;
...
static inline int
F_150 ( struct V_63 * V_64 , struct V_7 * V_8 )
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
struct V_66 * V_67 = F_70 ( V_64 ) ;
int V_111 = - 1 ;
...
V_92 = F_40 ( V_64 , F_151 ( V_64 ) ) ;
V_67 = F_70 ( V_64 ) ;
if ( V_92 > 0 ) {
struct V_82 * V_83 ;
V_83 = ( void * ) & F_151 ( V_64 ) [ V_92 ] ;
if ( V_83 -> V_111 == 0 ) {
F_71 ( V_64 , V_109 ,
V_110 , V_92 + 2 ) ;
return - 1 ;
...
V_111 = V_83 -> V_111 - 1 ;
} else if ( ! ( V_25 -> V_30 . V_33 & V_237 ) ) {
V_111 = V_25 -> V_30 . V_111 ;
}
memcpy ( & V_189 , & V_25 -> V_238 . V_234 . V_239 , sizeof( V_189 ) ) ;
V_189 . V_233 = V_138 ;
if ( V_25 -> V_30 . V_33 & V_207 )
V_189 . V_224 |= ( * ( T_8 * ) V_67 & V_241 ) ;
if ( V_25 -> V_30 . V_33 & V_246 )
V_189 . V_224 |= F_152 ( V_67 ) ;
if ( V_25 -> V_30 . V_33 & V_208 )
V_189 . V_242 = V_64 -> V_243 ;
}
V_189 . V_244 = F_147 ( F_27 ( V_8 ) , NULL ) ;
...
static T_9
F_153 ( struct V_63 * V_64 , struct V_7 * V_8 )
{
struct V_21 * V_25 = F_21 ( V_8 ) ;
struct V_6 * V_20 = & V_25 -> V_8 -> V_20 ;
int V_154 ;
switch ( V_64 -> V_172 ) {
case F_154 ( V_247 ) :
V_154 = F_143 ( V_64 , V_8 ) ;
break;
case F_154 ( V_248 ) :
V_154 = F_150 ( V_64 , V_8 ) ;
break;
default:
goto V_249;
}
...
struct V_37 * V_38 = & V_25 -> V_30 ;
struct V_188 * V_189 = & V_25 -> V_238 . V_234 . V_239 ;
int V_253 ;
...
V_189 -> V_224 = 0 ;
if ( ! ( V_38 -> V_33 & V_207 ) )
V_189 -> V_224 |= V_241 & V_38 -> V_257 ;
if ( ! ( V_38 -> V_33 & V_246 ) )
V_189 -> V_224 |= V_258 & V_38 -> V_257 ;
...
V_8 -> V_33 &= ~ V_259 ;
V_25 -> V_211 = 0 ;
V_25 -> V_222 = V_25 -> V_194 + V_25 -> V_211 ;
V_253 = V_25 -> V_222 + sizeof( struct V_66 ) ;
if ( V_38 -> V_33 & V_152 ) {
...
static void
F_161 ( struct V_37 * V_38 , const struct V_262 * V_234 )
{
V_38 -> V_31 = V_234 -> V_31 ;
V_38 -> V_32 = V_234 -> V_32 ;
V_38 -> V_33 = V_234 -> V_33 ;
V_38 -> V_197 = V_234 -> V_197 ;
V_38 -> V_111 = V_234 -> V_111 ;
V_38 -> V_257 = V_234 -> V_257 ;
V_38 -> V_151 = V_234 -> V_151 ;
V_38 -> V_104 = V_234 -> V_104 ;
memcpy ( V_38 -> V_52 , V_234 -> V_52 , sizeof( V_234 -> V_52 ) ) ;
}
static void
F_162 ( struct V_262 * V_234 , const struct V_37 * V_38 )
{
V_234 -> V_31 = V_38 -> V_31 ;
V_234 -> V_32 = V_38 -> V_32 ;
V_234 -> V_33 = V_38 -> V_33 ;
V_234 -> V_197 = V_38 -> V_197 ;
V_234 -> V_111 = V_38 -> V_111 ;
V_234 -> V_257 = V_38 -> V_257 ;
V_234 -> V_151 = V_38 -> V_151 ;
V_234 -> V_104 = V_38 -> V_104 ;
memcpy ( V_234 -> V_52 , V_38 -> V_52 , sizeof( V_234 -> V_52 ) ) ;
}
static int
...
{
int V_222 ;
memset ( & V_25 -> V_219 , 0 , sizeof( V_25 -> V_219 ) ) ;
V_222 = F_174 ( V_287 ) ;
if ( V_222 < 0 )
return V_222 ;
V_25 -> V_219 . type = V_287 -> type ;
V_25 -> V_219 . V_288 = V_287 -> V_288 ;
V_25 -> V_219 . V_289 = V_287 -> V_289 ;
V_25 -> V_219 . V_33 = V_287 -> V_33 ;
V_25 -> V_194 = V_222 ;
V_25 -> V_222 = V_25 -> V_194 + V_25 -> V_211 ;
return 0 ;
}
...
goto V_331;
if ( F_203 ( V_64 , V_322 , V_156 -> V_219 . type ) ||
F_204 ( V_64 , V_324 , V_156 -> V_219 . V_288 ) ||
F_204 ( V_64 , V_325 , V_156 -> V_219 . V_289 ) ||
F_203 ( V_64 , V_323 , V_156 -> V_219 . V_33 ) )
goto V_331;
if ( V_330 -> V_43 )
if ( F_205 ( V_64 , V_321 ) )
goto V_331;
