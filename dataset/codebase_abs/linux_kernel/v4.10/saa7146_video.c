...
F_80 ( & V_13 -> V_83 . V_195 ) ;
V_13 -> V_83 . V_195 . V_212 = V_213 ;
V_13 -> V_83 . V_195 . V_214 = ( unsigned long ) ( & V_13 -> V_83 ) ;
V_13 -> V_83 . V_3 = V_3 ;
...
static void F_85 ( struct V_2 * V_3 , unsigned long V_221 )
{
struct V_12 * V_13 = V_3 -> V_14 ;
struct V_81 * V_82 = & V_13 -> V_83 ;
F_86 ( & V_3 -> V_88 ) ;
...
static T_4 F_89 ( struct V_80 * V_80 , char T_5 * V_214 , T_6 V_208 , T_7 * V_222 )
{
struct V_10 * V_11 = V_80 -> V_201 ;
struct V_2 * V_3 = V_11 -> V_3 ;
struct V_12 * V_13 = V_3 -> V_14 ;
...
V_17 = F_90 ( & V_11 -> V_185 , V_214 , V_208 , V_222 ,
V_80 -> V_189 & V_190 ) ;
if ( V_17 != 0 ) {
F_25 ( V_11 , V_80 ) ;
} else {
