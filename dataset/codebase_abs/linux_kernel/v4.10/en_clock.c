...
return F_21 ( V_24 -> V_31 , & V_28 ,
sizeof( V_28 ) ) ? - V_32 : 0 ;
}
int F_22 ( struct V_21 * V_22 , struct V_23 * V_24 )
{
struct V_25 * V_26 = F_16 ( V_22 ) ;
struct V_27 * V_55 = & V_26 -> V_2 . V_27 ;
if ( ! F_17 ( V_26 -> V_12 , V_29 ) )
return - V_30 ;
return F_21 ( V_24 -> V_31 , V_55 , sizeof( * V_55 ) ) ? - V_32 : 0 ;
}
...
static int F_28 ( struct V_56 * V_57 , T_2 V_62 )
{
struct V_1 * V_2 = F_7 ( V_57 , struct V_1 ,
V_60 ) ;
unsigned long V_19 ;
...
static int F_30 ( struct V_56 * V_57 , T_3 V_62 )
{
T_1 V_63 ;
T_4 V_64 ;
unsigned long V_19 ;
...
V_2 -> V_11 . V_70 = F_6 ;
V_2 -> V_11 . V_71 = V_72 ;
V_2 -> V_11 . V_67 = F_36 ( V_69 ,
V_2 -> V_11 . V_71 ) ;
V_2 -> V_66 = V_2 -> V_11 . V_67 ;
V_2 -> V_11 . V_13 = F_37 ( 41 ) ;
V_2 -> V_12 = V_26 -> V_12 ;
F_25 ( & V_2 -> clock , & V_2 -> V_11 ,
F_38 ( F_39 () ) ) ;
V_61 = F_40 ( & V_2 -> V_11 , V_2 -> V_11 . V_13 ,
V_68 , & V_68 ) ;
F_41 ( V_61 , V_73 / 2 / V_74 ) ;
V_2 -> V_20 = V_61 ;
F_42 ( & V_2 -> V_18 , F_9 ) ;
if ( V_2 -> V_20 )
F_14 ( & V_2 -> V_18 , 0 ) ;
...
F_34 ( V_26 -> V_12 , L_3 ) ;
V_2 -> V_60 = V_75 ;
snprintf ( V_2 -> V_60 . V_76 , 16 , L_4 ) ;
V_2 -> V_57 = F_43 ( & V_2 -> V_60 ,
& V_26 -> V_12 -> V_77 -> V_22 ) ;
if ( F_44 ( V_2 -> V_57 ) ) {
F_34 ( V_26 -> V_12 , L_5 ,
F_45 ( V_2 -> V_57 ) ) ;
