...
void F_46 ( struct V_47 * V_32 )
{
}
struct V_47 * F_47 ( struct V_47 * V_32 )
{
...
V_52 = F_50 ( V_32 -> V_3 * sizeof( * V_52 ) , V_150 ) ;
if ( ! V_52 ) {
V_32 = V_146 ;
goto V_151;
}
...
if ( V_149 > 1 )
F_53 ( V_32 -> V_3 , V_68 , V_148 + 1 , V_53 ) ;
if ( V_53 ) {
F_6 ( V_144 , V_53 + V_68 ) ;
F_54 ( ( unsigned long ) V_144 , V_144 -> V_153 ) ;
V_32 -> V_48 = ( void * ) V_53 ;
V_32 -> V_154 = 1 ;
} else {
V_32 = V_146 ;
...
V_151:
if ( V_147 )
F_56 ( V_32 , V_32 == V_146 ?
V_145 : V_146 ) ;
return V_32 ;
}
void F_57 ( struct V_47 * V_155 )
{
unsigned long V_156 = ( unsigned long ) V_155 -> V_48 & V_157 ;
struct V_143 * V_144 = ( void * ) V_156 ;
if ( ! V_155 -> V_154 )
goto V_158;
F_58 ( V_156 , V_144 -> V_153 ) ;
F_51 ( V_144 ) ;
V_158:
F_59 ( V_155 ) ;
}
