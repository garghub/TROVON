...
static void F_45 ( struct V_71 * V_62 )
{
...
V_72 = F_49 ( V_53 , V_76 ) ;
F_50 ( V_53 ) ;
if ( V_72 != V_77 && V_72 != V_78 && V_72 != V_79 ) {
F_51 ( V_80 L_1 , V_72 ) ;
goto V_4;
}
...
if ( V_52 && V_52 -> V_92 ) {
V_2 -> V_86 . V_93 = F_66 ( & V_2 -> V_62 ) ;
V_2 -> V_86 . V_83 = & V_2 -> V_62 ;
V_2 -> V_86 . V_94 = V_95 ;
V_2 -> V_86 . V_87 = V_52 -> V_92 ;
V_2 -> V_86 . V_96 = 10 ;
V_2 -> V_86 . V_9 = F_8 ;
V_2 -> V_86 . V_97 = F_12 ;
V_2 -> V_86 . V_98 = F_13 ;
...
F_41 ( & V_2 -> V_103 ) ;
F_79 (l, n, &ucb->devs) {
struct V_61 * V_62 = F_80 ( V_107 , struct V_61 , V_67 ) ;
F_40 ( V_62 ) ;
}
F_23 ( & V_102 ) ;
if ( V_2 -> V_86 . V_87 != - 1 )
...
{
struct V_106 * V_108 , * V_107 ;
F_17 ( & V_102 ) ;
F_41 ( & V_60 -> V_103 ) ;
F_79 (l, n, &drv->devs) {
struct V_61 * V_62 = F_80 ( V_107 , struct V_61 , V_69 ) ;
F_40 ( V_62 ) ;
}
F_23 ( & V_102 ) ;
}
static int F_85 ( struct V_71 * V_62 )
{
...
F_89 ( & V_2 -> V_47 , V_5 ) ;
F_90 ( V_2 -> V_46 ) ;
} else if ( V_52 && V_52 -> V_74 )
V_52 -> V_74 ( V_113 ) ;
return 0 ;
}
static int F_91 ( struct V_71 * V_62 )
{
struct V_51 * V_52 = F_86 ( V_62 ) ;
struct V_1 * V_2 = F_87 ( V_62 ) ;
struct V_61 * V_111 ;
if ( ! V_2 -> V_58 && V_52 && V_52 -> V_74 )
V_52 -> V_74 ( V_114 ) ;
F_10 ( V_2 ) ;
F_3 ( V_2 , V_12 , V_2 -> V_11 ) ;
F_3 ( V_2 , V_8 , V_2 -> V_7 ) ;
