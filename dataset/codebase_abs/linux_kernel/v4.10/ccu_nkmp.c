...
return ( V_32 * ( V_23 + 1 ) * ( V_24 + 1 ) >> V_26 ) / ( V_25 + 1 ) ;
}
...
struct V_29 * V_4 = F_3 ( V_28 ) ;
struct V_3 V_37 ;
V_37 . V_16 = V_4 -> V_23 . V_38 ;
V_37 . V_17 = 1 << V_4 -> V_23 . V_36 ;
V_37 . V_14 = V_4 -> V_24 . V_38 ;
V_37 . V_15 = 1 << V_4 -> V_24 . V_36 ;
V_37 . V_18 = 1 ;
V_37 . V_19 = V_4 -> V_25 . V_39 ? : 1 << V_4 -> V_25 . V_36 ;
V_37 . V_20 = 1 ;
V_37 . V_21 = V_4 -> V_26 . V_39 ? : 1 << ( ( 1 << V_4 -> V_26 . V_36 ) - 1 ) ;
F_1 ( * V_32 , V_2 , & V_37 ) ;
return * V_32 * V_37 . V_23 * V_37 . V_24 / ( V_37 . V_25 * V_37 . V_26 ) ;
}
...
V_33 |= ( V_37 . V_23 - 1 ) << V_4 -> V_23 . V_35 ;
V_33 |= ( V_37 . V_24 - 1 ) << V_4 -> V_24 . V_35 ;
V_33 |= ( V_37 . V_25 - 1 ) << V_4 -> V_25 . V_35 ;
V_33 |= F_15 ( V_37 . V_26 ) << V_4 -> V_26 . V_35 ;
F_16 ( V_33 , V_4 -> V_30 . V_34 + V_4 -> V_30 . V_33 ) ;
F_17 ( V_4 -> V_30 . V_41 , V_40 ) ;
F_18 ( & V_4 -> V_30 , V_4 -> V_41 ) ;
return 0 ;
}
