...
{
struct V_5 * V_5 = F_15 ( V_30 -> V_31 . V_14 ) ;
struct V_4 * V_4 ;
int V_7 ;
V_4 = F_16 ( & V_30 -> V_31 , sizeof( * V_4 ) ,
V_32 ) ;
if ( ! V_4 )
return - V_33 ;
V_4 -> V_5 = V_5 ;
V_4 -> V_1 = V_34 ;
V_4 -> V_1 . V_14 = & V_30 -> V_31 ;
#ifdef F_17
V_4 -> V_1 . V_35 = V_30 -> V_31 . V_35 ;
#endif
V_7 = F_18 ( & V_30 -> V_31 , & V_4 -> V_1 ,
V_4 ) ;
if ( V_7 < 0 ) {
F_11 ( & V_30 -> V_31 , L_4 , V_7 ) ;
return V_7 ;
}
F_19 ( V_30 , V_4 ) ;
return V_7 ;
