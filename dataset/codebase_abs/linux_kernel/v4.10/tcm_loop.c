...
static char * F_90 ( struct V_22 * V_23 )
{
switch ( V_23 -> V_141 ) {
case V_142 :
return L_27 ;
...
F_92 ( & V_25 -> V_146 ) ;
F_93 ( V_23 -> V_57 , 0 , V_25 -> V_121 , V_53 -> V_147 ) ;
F_24 ( L_31 ) ;
return 0 ;
}
static void F_94 (
...
V_23 = V_25 -> V_23 ;
V_91 = F_95 ( V_23 -> V_57 , 0 , V_25 -> V_121 ,
V_145 -> V_147 ) ;
if ( ! V_91 ) {
F_26 ( L_32
...
static T_4 F_99 (
struct V_148 * V_149 , char * V_150 )
{
struct V_67 * V_68 = F_100 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 , struct V_24 ,
V_76 ) ;
return sprintf ( V_150 , L_35 , V_25 -> V_122 ) ;
}
static T_4 F_101 (
struct V_148 * V_149 , const char * V_150 , T_5 V_151 )
{
struct V_67 * V_68 = F_100 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 , struct V_24 ,
V_76 ) ;
unsigned long V_152 ;
int V_71 = F_102 ( V_150 , 0 , & V_152 ) ;
if ( V_71 ) {
F_26 ( L_36 , V_71 ) ;
return V_71 ;
}
if ( V_152 != 0 && V_152 != 1 && V_152 != 3 ) {
F_26 ( L_37 , V_152 ) ;
return - V_153 ;
}
V_25 -> V_122 = V_152 ;
...
F_24 ( L_44
L_41 , F_90 ( V_160 -> V_23 ) ,
V_21 -> V_50 -> V_123 -> V_162 ) ;
F_107 ( V_21 -> V_50 ) ;
V_160 -> V_21 = NULL ;
F_38 ( V_21 ) ;
return 0 ;
}
static T_4 F_108 ( struct V_148 * V_149 , char * V_150 )
{
struct V_67 * V_68 = F_109 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
struct V_20 * V_21 ;
T_4 V_71 ;
...
if ( ! V_21 )
return - V_97 ;
V_71 = snprintf ( V_150 , V_163 , L_45 ,
V_21 -> V_50 -> V_123 -> V_162 ) ;
return V_71 ;
}
static T_4 F_110 ( struct V_148 * V_149 ,
const char * V_150 , T_5 V_151 )
{
struct V_67 * V_68 = F_109 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
struct V_22 * V_23 = V_25 -> V_23 ;
unsigned char V_164 [ V_165 ] , * V_166 , * V_167 ;
int V_71 ;
if ( ! strncmp ( V_150 , L_46 , 4 ) ) {
V_71 = F_106 ( V_25 ) ;
return ( ! V_71 ) ? V_151 : V_71 ;
}
if ( strlen ( V_150 ) >= V_165 ) {
F_26 ( L_47
L_48 , V_150 , V_165 ) ;
return - V_153 ;
}
snprintf ( & V_164 [ 0 ] , V_165 , L_49 , V_150 ) ;
V_166 = strstr ( V_164 , L_50 ) ;
if ( V_166 ) {
if ( V_23 -> V_141 != V_142 ) {
F_26 ( L_51
L_52 , V_164 ,
...
V_71 = F_104 ( V_25 , V_167 ) ;
if ( V_71 < 0 )
return V_71 ;
return V_151 ;
}
static T_4 F_111 ( struct V_148 * V_149 ,
char * V_150 )
{
struct V_67 * V_68 = F_109 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
const char * V_169 = NULL ;
T_4 V_71 = - V_153 ;
switch ( V_25 -> V_35 ) {
case V_89 :
V_169 = L_59 ;
...
if ( V_169 )
V_71 = snprintf ( V_150 , V_163 , L_45 , V_169 ) ;
return V_71 ;
}
static T_4 F_112 ( struct V_148 * V_149 ,
const char * V_150 , T_5 V_151 )
{
struct V_67 * V_68 = F_109 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
if ( ! strncmp ( V_150 , L_59 , 6 ) ) {
V_25 -> V_35 = V_89 ;
return V_151 ;
}
if ( ! strncmp ( V_150 , L_60 , 7 ) ) {
V_25 -> V_35 = V_36 ;
if ( V_25 -> V_21 ) {
struct V_66 * V_170 = V_25 -> V_21 -> V_50 ;
F_113 ( V_170 -> V_123 ) ;
}
return V_151 ;
}
...
static T_4 F_114 ( struct V_148 * V_149 ,
char * V_150 )
{
struct V_67 * V_68 = F_109 ( V_149 ) ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
struct V_22 * V_23 = V_25 -> V_23 ;
return snprintf ( V_150 , V_163 , L_61 ,
V_23 -> V_57 -> V_58 , V_25 -> V_121 ) ;
}
...
const char * V_155 )
{
struct V_22 * V_23 = F_4 ( V_172 ,
struct V_22 , V_175 ) ;
struct V_24 * V_25 ;
int V_71 ;
unsigned long V_176 ;
if ( strstr ( V_155 , L_62 ) != V_155 ) {
F_26 ( L_63
L_64 ) ;
return F_116 ( - V_153 ) ;
}
if ( F_102 ( V_155 + 5 , 10 , & V_176 ) )
return F_116 ( - V_153 ) ;
if ( V_176 >= V_177 ) {
F_26 ( L_65
L_66 , V_176 , V_177 ) ;
...
V_25 = & V_23 -> V_31 [ V_176 ] ;
V_25 -> V_23 = V_23 ;
V_25 -> V_121 = V_176 ;
V_71 = F_117 ( V_172 , & V_25 -> V_76 , V_23 -> V_141 ) ;
if ( V_71 < 0 )
return F_116 ( - V_157 ) ;
F_24 ( L_67
L_68 , F_90 ( V_23 ) ,
F_118 ( & V_172 -> V_178 . V_179 ) , V_176 ) ;
return & V_25 -> V_76 ;
}
static void F_119 (
struct V_67 * V_68 )
{
struct V_171 * V_172 = V_68 -> V_180 ;
struct V_24 * V_25 = F_4 ( V_68 ,
struct V_24 , V_76 ) ;
struct V_22 * V_23 ;
...
V_166 = strstr ( V_155 , L_50 ) ;
if ( V_166 ) {
V_23 -> V_141 = V_142 ;
goto V_184;
}
V_166 = strstr ( V_155 , L_53 ) ;
if ( V_166 ) {
V_23 -> V_141 = V_143 ;
V_183 = 3 ;
goto V_184;
}
V_166 = strstr ( V_155 , L_55 ) ;
if ( ! V_166 ) {
F_26 ( L_72
L_73 , V_155 ) ;
V_71 = - V_153 ;
...
V_23 -> V_141 = V_144 ;
V_184:
if ( strlen ( V_155 ) >= V_165 ) {
F_26 ( L_74
L_48 , V_155 , F_90 ( V_23 ) ,
V_165 ) ;
V_71 = - V_153 ;
goto V_185;
}
snprintf ( & V_23 -> V_120 [ 0 ] , V_165 , L_49 , & V_155 [ V_183 ] ) ;
V_71 = F_54 ( V_23 , V_186 ) ;
if ( V_71 )
goto V_185;
V_57 = V_23 -> V_57 ;
V_186 ++ ;
...
F_24 ( L_77
L_76 ,
F_90 ( V_23 ) , V_23 -> V_120 ,
V_23 -> V_57 -> V_58 ) ;
F_123 ( & V_23 -> V_13 ) ;
}
static T_4 F_124 ( struct V_148 * V_149 , char * V_150 )
{
return sprintf ( V_150 , L_78 , V_187 ) ;
}
