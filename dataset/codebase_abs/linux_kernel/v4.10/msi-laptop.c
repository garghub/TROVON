...
static int T_4 F_63 ( struct V_73 * V_74 )
{
T_1 V_51 ;
int V_8 ;
if ( ! V_13 -> V_14 ) {
...
V_101 . V_100 = F_15 ;
V_102 . V_100 = F_19 ;
V_99 . V_35 . V_103 |= V_104 ;
V_101 . V_35 . V_103 |= V_104 ;
V_102 . V_35 . V_103 |= V_104 ;
}
V_8 = F_7 ( V_88 , & V_51 ) ;
if ( V_8 < 0 )
return V_8 ;
...
F_68 () == V_114 ) {
struct V_115 V_30 ;
memset ( & V_30 , 0 , sizeof( struct V_115 ) ) ;
V_30 . type = V_116 ;
V_30 . V_117 = V_3 - 1 ;
V_118 = F_69 ( L_12 , NULL ,
NULL , & V_119 ,
& V_30 ) ;
if ( F_70 ( V_118 ) )
return F_71 ( V_118 ) ;
...
if ( V_36 )
goto V_124;
if ( V_13 -> V_87 && ( F_63 ( V_122 ) < 0 ) ) {
V_36 = - V_4 ;
goto V_125;
}
V_36 = F_75 ( & V_122 -> V_33 . V_126 ,
& V_127 ) ;
if ( V_36 )
goto V_128;
if ( ! V_13 -> V_38 ) {
if ( V_27 )
V_36 = F_76 ( & V_122 -> V_33 ,
& V_102 ) ;
if ( V_36 )
goto V_129;
} else {
...
F_31 ( L_14 V_131 L_15 ) ;
return 0 ;
V_129:
F_77 ( & V_122 -> V_33 . V_126 , & V_127 ) ;
V_128:
if ( V_13 -> V_87 ) {
F_78 ( F_45 ) ;
F_79 ( & V_71 ) ;
