...
if ( V_2 -> V_10 . V_125 && V_2 -> V_10 . V_111 ) {
V_5 = F_25 ( V_2 ) ;
if ( V_5 < 0 )
return V_5 ;
}
...
static int F_27 ( struct V_1 * V_2 , T_3 V_126 ,
T_1 V_4 )
{
int V_5 ;
T_1 V_26 ;
...
V_128 = F_28 ( V_2 -> V_10 . V_101 ,
( T_3 ) ( V_130 / V_2 -> V_10 . V_100 ) ) ;
do {
V_127 = F_28 ( V_129 , V_128 ) ;
F_12 ( V_127 , & V_65 ) ;
V_5 = F_8 ( V_2 -> V_6 -> V_7 ,
V_26 + V_2 -> V_10 . V_11 . V_68 ,
& V_65 , sizeof( V_65 ) ) ;
...
V_78 += ( V_127 * V_2 -> V_10 . V_100 ) ;
V_129 -= V_127 ;
} while ( V_129 );
return 0 ;
}
static int F_29 ( struct V_1 * V_2 ,
const void * V_131 , T_3 V_126 ,
T_1 V_4 )
{
int V_5 ;
T_1 V_26 ;
...
if ( V_2 -> V_10 . V_101 > ( V_130 / V_2 -> V_10 . V_100 ) )
V_128 = V_130 / V_2 -> V_10 . V_100 ;
else
V_128 = V_2 -> V_10 . V_101 ;
do {
V_127 = F_28 ( V_129 , V_128 ) ;
F_12 ( V_127 , & V_65 ) ;
V_5 = F_8 ( V_2 -> V_6 -> V_7 ,
...
{
return F_29 ( V_2 , V_2 -> V_10 . V_132 ,
V_2 -> V_10 . V_133 ,
V_51 ) ;
}
...
{
V_2 -> V_10 . V_58 = V_59 ;
V_2 -> V_10 . V_132 = V_2 -> V_10 . V_122 . V_84 . V_134 ;
V_2 -> V_10 . V_135 = V_2 -> V_10 . V_122 . V_84 . V_123 ;
V_2 -> V_10 . V_133 = V_2 -> V_10 . V_135 / V_2 -> V_10 . V_100 ;
return F_30 ( V_2 ) ;
}
static int F_32 ( struct V_1 * V_2 )
{
V_2 -> V_10 . V_58 = V_60 ;
V_2 -> V_10 . V_132 = V_2 -> V_10 . V_122 . V_85 . V_134 ;
V_2 -> V_10 . V_135 = V_2 -> V_10 . V_122 . V_85 . V_123 ;
V_2 -> V_10 . V_133 = V_2 -> V_10 . V_135 / V_2 -> V_10 . V_100 ;
return F_30 ( V_2 ) ;
}
static int F_33 ( struct V_1 * V_2 )
{
return F_29 ( V_2 , V_2 -> V_10 . V_122 . V_87 . V_134 ,
...
int V_5 ;
V_2 -> V_10 . V_58 = V_64 ;
V_2 -> V_10 . V_132 = V_2 -> V_10 . V_122 . V_86 . V_134 ;
V_2 -> V_10 . V_135 = V_2 -> V_10 . V_122 . V_86 . V_123 ;
V_2 -> V_10 . V_133 = V_2 -> V_10 . V_135 / V_2 -> V_10 . V_100 ;
if ( V_2 -> V_10 . V_133 != V_2 -> V_10 . V_74 . V_86 ) {
...
V_2 -> V_10 . V_58 = V_63 ;
V_2 -> V_10 . V_135 = V_2 -> V_10 . V_100 * V_73 ;
F_36 ( & V_2 -> V_6 -> V_14 , V_2 -> V_10 . V_70 ) ;
V_2 -> V_10 . V_70 = F_17 ( & V_2 -> V_6 -> V_14 ,
V_2 -> V_10 . V_135 , V_119 ) ;
if ( ! V_2 -> V_10 . V_70 ) {
V_2 -> V_10 . V_120 = 0 ;
return - V_121 ;
}
V_2 -> V_10 . V_120 = V_2 -> V_10 . V_135 ;
...
return V_5 ;
V_2 -> V_10 . V_58 = V_63 ;
V_2 -> V_10 . V_132 = V_2 -> V_10 . V_70 ;
V_2 -> V_10 . V_135 = V_2 -> V_10 . V_122 . V_89 . V_123 ;
V_2 -> V_10 . V_133 = V_2 -> V_10 . V_135 / V_2 -> V_10 . V_100 ;
V_5 = F_30 ( V_2 ) ;
if ( V_5 < 0 )
return V_5 ;
...
{
T_3 V_136 ;
V_136 = V_2 -> V_10 . V_122 . V_83 . V_123 / V_2 -> V_10 . V_100 ;
return F_29 ( V_2 , V_2 -> V_10 . V_122 . V_83 . V_134 ,
V_136 , V_50 ) ;
}
...
V_138 = V_2 -> V_10 . V_122 . V_144 . V_123 / 4 - 1 ;
for ( V_77 = 1 ; V_77 <= V_138 ; V_77 ++ ) {
V_139 = F_40 ( V_2 -> V_10 . V_122 . V_144 . V_134 + V_77 * 4 ) ;
V_143 = V_137 + V_139 ;
V_140 = F_14 ( V_143 -> V_140 ) ;
V_141 = V_137 + F_41 ( V_143 -> V_145 ) ;
V_65 = F_41 ( V_143 -> V_146 ) ;
switch ( V_140 ) {
case V_147 :
case V_148 :
V_2 -> V_10 . V_122 . V_89 . V_134 = V_141 ;
V_2 -> V_10 . V_122 . V_89 . V_123 = V_65 ;
break;
case V_149 :
case V_150 :
V_2 -> V_10 . V_122 . V_91 . V_134 = V_141 ;
...
unsigned int V_140 ;
unsigned int V_65 ;
const void * V_137 = V_2 -> V_10 . V_137 ;
const T_1 * V_141 ;
const struct V_142 * V_143 ;
const struct V_151 * V_152 = V_137 ;
V_2 -> V_10 . V_122 . V_153 = F_41 ( V_152 -> V_153 ) ;
F_3 ( V_13 , & V_2 -> V_6 -> V_14 , L_48 ,
V_15 , V_2 -> V_10 . V_122 . V_153 ) ;
V_92 = F_41 ( V_152 -> V_154 ) ;
V_143 = V_137 + V_92 ;
V_92 = F_41 ( V_143 -> V_145 ) ;
V_138 = F_41 ( V_143 -> V_146 ) / 4 ;
for ( V_77 = 0 ; V_77 < V_138 ; V_77 ++ ) {
V_139 = F_40 ( V_137 + V_92 ) ;
V_92 += 4 ;
V_143 = V_137 + V_139 ;
V_140 = F_14 ( V_143 -> V_140 ) ;
V_141 = V_137 + F_41 ( V_143 -> V_145 ) ;
...
case V_155 :
case V_156 :
V_2 -> V_10 . V_122 . V_83 . V_134 = V_141 ;
V_2 -> V_10 . V_122 . V_83 . V_123 = V_65 ;
break;
case V_157 :
case V_158 :
V_2 -> V_10 . V_122 . V_84 . V_134 = V_141 ;
V_2 -> V_10 . V_122 . V_84 . V_123 = V_65 ;
break;
case V_159 :
V_2 -> V_10 . V_122 . V_160 = * V_141 ;
V_2 -> V_10 . V_122 . V_144 . V_134 = V_141 ;
V_2 -> V_10 . V_122 . V_144 . V_123 = V_65 ;
F_39 ( V_2 , V_137 ) ;
break;
case V_161 :
V_2 -> V_10 . V_122 . V_162 = true ;
V_2 -> V_10 . V_122 . V_87 . V_134 = V_141 ;
V_2 -> V_10 . V_122 . V_87 . V_123 = V_65 ;
break;
case V_163 :
V_2 -> V_10 . V_122 . V_164 = true ;
V_2 -> V_10 . V_122 . V_85 . V_134 = V_141 ;
V_2 -> V_10 . V_122 . V_85 . V_123 = V_65 ;
break;
case V_165 :
V_2 -> V_10 . V_122 . V_166 = true ;
V_2 -> V_10 . V_122 . V_86 . V_134 = V_141 ;
V_2 -> V_10 . V_122 . V_86 . V_123 = V_65 ;
break;
case V_167 :
V_2 -> V_10 . V_122 . V_168 = true ;
V_2 -> V_10 . V_122 . V_169 =
F_40 ( V_141 + 4 ) ;
break;
default:
break;
...
{
const struct V_151 * V_152 = V_2 -> V_10 . V_137 ;
...
if ( ! V_2 -> V_10 . V_122 . V_166 ) {
F_4 ( & V_2 -> V_6 -> V_14 , L_52 ,
V_15 ) ;
return - V_56 ;
}
F_13 ( V_2 , V_2 -> V_10 . V_122 . V_86 . V_134 ,
& V_2 -> V_10 . V_122 . V_74 , & V_2 -> V_10 . V_122 . V_76 ) ;
F_38 ( V_2 ) ;
return 0 ;
}
int F_44 ( struct V_1 * V_2 , const struct V_172 * V_173 )
{
int V_5 ;
F_15 ( V_2 ) ;
V_2 -> V_10 . V_137 = V_173 -> V_134 ;
V_5 = F_43 ( V_2 ) ;
if ( V_5 < 0 )
goto V_174;
if ( ! V_2 -> V_10 . V_125 ) {
...
goto V_174;
if ( V_2 -> V_10 . V_108 &&
V_2 -> V_10 . V_122 . V_164 ) {
V_5 = F_20 ( V_2 ) ;
if ( V_5 < 0 )
goto V_174;
}
if ( V_2 -> V_10 . V_111 && V_2 -> V_10 . V_122 . V_162 ) {
V_5 = F_21 ( V_2 ) ;
if ( V_5 < 0 )
goto V_174;
}
...
if ( V_5 < 0 )
goto V_174;
if ( V_2 -> V_10 . V_108 && V_2 -> V_10 . V_122 . V_164 ) {
...
int F_46 ( struct V_1 * V_2 , const struct V_172 * V_173 )
{
int V_5 = 0 ;
V_2 -> V_10 . V_58 = V_59 ;
V_2 -> V_10 . V_137 = V_173 -> V_134 ;
...
if ( V_5 < 0 )
goto exit;
if ( ! V_2 -> V_10 . V_175 && V_2 -> V_10 . V_125 ) {
