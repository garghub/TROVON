...
int V_57 , V_78 = 0 ;
F_4 ( L_12 , V_2 -> V_48 ) ;
V_34 = F_30 ( V_42 , sizeof( * V_34 ) , V_79 ) ;
if ( ! V_34 )
return - V_80 ;
V_68 = F_30 ( V_42 , 32 , V_79 ) ;
if ( ! V_68 )
return - V_80 ;
V_67 = F_30 ( V_42 , 32 , V_79 ) ;
if ( ! V_67 )
return - V_80 ;
V_66 = F_30 ( V_42 , 32 , V_79 ) ;
if ( ! V_66 )
return - V_80 ;
V_2 -> V_34 = V_34 ;
snprintf ( V_68 , 32 , L_13 , V_2 -> V_48 ) ;
V_70 . V_81 = V_68 ;
V_2 -> V_16 . V_10 . V_82 = & V_70 ;
V_64 [ V_78 ++ ] = F_31 ( V_42 , & V_2 -> V_16 . V_10 ) ;
V_34 -> V_11 . V_82 = & V_77 ;
...
V_77 . V_75 = & V_83 ;
V_77 . V_73 = V_84 ;
V_77 . V_71 = ( const char * const * ) & V_67 ;
V_77 . V_72 = 1 ;
V_64 [ V_78 ++ ] = V_61 [ V_62 ] =
F_31 ( V_42 , & V_34 -> V_11 ) ;
...
struct V_14 * F_34 ( struct V_90 * V_43 ,
int V_48 )
{
struct V_1 * V_2 ;
struct V_14 * V_15 ;
...
if ( ! V_43 )
return F_35 ( - V_91 ) ;
V_2 = F_30 ( & V_43 -> V_42 , sizeof( * V_2 ) , V_79 ) ;
if ( ! V_2 )
return F_35 ( - V_80 ) ;
V_2 -> V_43 = V_43 ;
V_2 -> V_48 = V_48 + 1 ;
