...
int F_60 ( struct V_162 * V_163 , struct V_139 * V_15 ,
char * V_151 , T_1 V_152 )
{
...
static void F_61 ( struct V_1 * V_2 , struct V_139 * V_15 ,
...
static void
F_66 ( struct V_1 * V_2 , struct V_139 * V_15 ,
struct V_16 * V_17 )
{
...
static void F_67 ( struct V_1 * V_2 , struct V_139 * V_15 )
{
...
static int F_69 ( struct V_1 * V_2 , struct V_14 * V_169 )
{
struct V_140 V_15 ;
struct V_16 * V_17 ;
if ( ! V_169 && V_2 -> V_130 )
...
int V_54 = 0 ;
if ( V_2 -> V_130 != V_17 ) {
if ( F_71 ( V_2 -> V_163 , (struct V_139 * ) V_141 ,
V_151 , V_167 ) )
V_54 = V_211 ;
} else
F_72 ( & V_2 -> V_212 , V_132 + V_2 -> V_213 ) ;
F_43 ( V_17 , V_126 ) ;
return V_54 ;
}
static int F_73 ( struct V_1 * V_2 , struct V_139 * V_15 ,
...
if ( F_74 ( V_215 -> V_36 ) > V_167 ||
F_74 ( V_215 -> V_36 ) < sizeof( struct V_139 ) ) {
F_25 ( V_154 , V_2 , L_36
L_37
L_38 , F_74 ( V_215 -> V_36 ) ,
V_167 ) ;
return V_217 ;
}
...
F_59 ( & V_5 -> V_125 ) ;
F_58 ( & V_5 -> V_165 ) ;
F_69 ( V_2 , (struct V_14 * ) V_15 ) ;
F_59 ( & V_5 -> V_165 ) ;
F_58 ( & V_5 -> V_125 ) ;
break;
case V_226 :
V_54 = F_73 ( V_2 , V_15 , V_151 , V_167 ) ;
break;
case V_227 :
V_2 -> V_32 = F_7 ( V_15 -> V_170 ) + 1 ;
if ( F_71 ( V_2 -> V_163 , V_15 , V_151 , V_167 ) )
V_54 = V_211 ;
break;
default:
V_54 = V_228 ;
...
switch( V_27 ) {
case V_229 :
F_61 ( V_2 , V_15 , V_17 , V_151 , V_167 ) ;
break;
case V_230 :
F_66 ( V_2 , V_15 , V_17 ) ;
break;
...
V_2 -> V_32 = F_7 ( V_15 -> V_170 ) + 1 ;
V_54 = F_70 ( V_17 , (struct V_14 * ) V_15 ,
V_151 , V_167 ) ;
break;
default:
V_54 = V_228 ;
