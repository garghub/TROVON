...
if ( F_26 ( V_57 , V_2 -> V_45 ) ) {
F_33 ( V_2 ) ;
if ( ! V_2 -> V_58 ) {
error = - V_42 ;
goto V_59;
}
if ( F_26 ( V_60 , V_2 -> V_61 ) ) {
V_53 = F_34 ( V_2 , V_60 ) + 1 ;
error = F_35 ( V_2 , V_53 , 0 ) ;
if ( error )
goto V_59;
} else if ( F_26 ( V_62 , V_2 -> V_61 ) ) {
F_36 ( V_2 , 60 ) ;
}
}
if ( F_26 ( V_29 , V_2 -> V_45 ) && ! V_6 -> V_63 ) {
F_32 ( V_55 L_2 ,
V_56 ) ;
error = - V_42 ;
goto V_59;
...
static int F_40 ( struct V_70 * V_70 , struct V_71 * V_71 )
{
struct V_5 * V_72 ;
V_72 = F_41 ( sizeof( struct V_5 ) , V_73 ) ;
if ( ! V_72 )
return - V_74 ;
F_42 ( & V_72 -> V_21 ) ;
F_43 ( & V_72 -> V_15 ) ;
...
const struct V_76 * abs )
{
int V_77 , V_78 ;
V_77 = abs -> V_79 ;
V_78 = abs -> V_80 ;
if ( ( V_77 != 0 || V_78 != 0 ) && V_78 <= V_77 ) {
F_32 ( V_55
L_3 ,
V_56 , V_3 , V_77 , V_78 ) ;
return - V_42 ;
}
if ( abs -> V_81 > V_78 - V_77 ) {
F_32 ( V_55
L_4 ,
V_56 , V_3 , abs -> V_81 , V_77 , V_78 ) ;
return - V_42 ;
}
return 0 ;
}
...
if ( ! F_26 ( V_57 , V_2 -> V_45 ) )
return 0 ;
F_48 (cnt, dev->absbit, ABS_CNT) {
if ( ! V_2 -> V_58 )
return - V_42 ;
error = F_46 ( V_2 , V_82 , & V_2 -> V_58 [ V_82 ] ) ;
if ( error )
return error ;
}
return 0 ;
...
V_6 -> V_63 = V_86 . V_63 ;
F_30 ( V_2 -> V_48 ) ;
V_2 -> V_48 = F_54 ( V_86 . V_48 , V_88 , V_73 ) ;
if ( ! V_2 -> V_48 )
return - V_74 ;
V_6 -> V_22 = V_54 ;
return 0 ;
...
if ( V_6 -> V_22 == V_23 )
return - V_42 ;
if ( F_53 ( & V_86 , V_85 , V_89 ) )
return - V_87 ;
if ( V_86 . V_3 > V_91 )
return - V_92 ;
V_2 = V_6 -> V_2 ;
error = F_46 ( V_2 , V_86 . V_3 , & V_86 . V_58 ) ;
if ( error )
return error ;
F_33 ( V_2 ) ;
if ( ! V_2 -> V_58 )
return - V_74 ;
F_56 ( V_86 . V_3 , V_2 -> V_61 ) ;
V_2 -> V_58 [ V_86 . V_3 ] = V_86 . V_58 ;
return 0 ;
}
...
static T_4 F_68 ( struct V_71 * V_71 , const char T_2 * V_93 ,
T_3 V_94 , T_5 * V_109 )
{
struct V_5 * V_6 = V_71 -> V_75 ;
int V_20 ;
if ( V_94 == 0 )
return 0 ;
V_20 = F_15 ( & V_6 -> V_21 ) ;
...
static T_4 F_74 ( struct V_71 * V_71 , char T_2 * V_93 ,
T_3 V_94 , T_5 * V_109 )
{
struct V_5 * V_6 = V_71 -> V_75 ;
T_4 V_20 ;
...
static unsigned int F_75 ( struct V_71 * V_71 , T_6 * V_117 )
{
struct V_5 * V_6 = V_71 -> V_75 ;
F_76 ( V_71 , & V_6 -> V_10 , V_117 ) ;
if ( V_6 -> V_8 != V_6 -> V_112 )
return V_118 | V_119 ;
return 0 ;
}
static int F_77 ( struct V_70 * V_70 , struct V_71 * V_71 )
{
struct V_5 * V_6 = V_71 -> V_75 ;
F_27 ( V_6 ) ;
F_30 ( V_6 ) ;
...
struct V_120 * V_121 )
{
if ( F_53 ( V_121 , V_93 , sizeof( struct V_120 ) ) )
return - V_87 ;
return 0 ;
}
...
static long F_84 ( struct V_71 * V_71 , unsigned int V_133 ,
...
goto V_25;
case V_171 :
if ( F_53 ( & V_135 , V_129 , sizeof( V_135 ) ) ) {
V_20 = - V_87 ;
goto V_25;
}
...
static long F_90 ( struct V_71 * V_71 , unsigned int V_133 , unsigned long V_85 )
{
return F_84 ( V_71 , V_133 , V_85 , ( void T_2 * ) V_85 ) ;
}
static long F_91 ( struct V_71 * V_71 ,
unsigned int V_133 , unsigned long V_85 )
{
if ( V_133 == V_176 )
V_133 = V_169 ;
return F_84 ( V_71 , V_133 , V_85 , F_92 ( V_85 ) ) ;
}
