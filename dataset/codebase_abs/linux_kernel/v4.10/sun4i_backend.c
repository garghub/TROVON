...
V_57 = F_21 ( V_40 , 0 ) ;
F_2 ( L_14 , & V_57 -> V_60 ) ;
V_61 = F_22 ( V_40 -> V_54 , 0 ) ;
V_60 = V_57 -> V_60 + V_40 -> V_62 [ 0 ] ;
V_60 += ( V_38 -> V_63 >> 16 ) * V_61 ;
V_60 += ( V_38 -> V_64 >> 16 ) * V_40 -> V_44 [ 0 ] ;
F_2 ( L_15 , & V_60 ) ;
V_58 = V_60 << 3 ;
F_2 ( L_16 , V_58 ) ;
...
static int F_38 ( struct V_66 * V_67 , struct V_66 * V_71 ,
void * V_72 )
{
struct V_73 * V_74 = F_39 ( V_67 ) ;
...
void T_3 * V_4 ;
int V_3 , V_48 ;
V_2 = F_40 ( V_67 , sizeof( * V_2 ) , V_82 ) ;
if ( ! V_2 )
return - V_83 ;
F_41 ( V_67 , V_2 ) ;
V_78 -> V_2 = V_2 ;
V_81 = F_42 ( V_74 , V_84 , 0 ) ;
V_4 = F_43 ( V_67 , V_81 ) ;
if ( F_29 ( V_4 ) )
return F_31 ( V_4 ) ;
V_2 -> V_4 = F_44 ( V_67 , V_4 ,
& V_85 ) ;
if ( F_29 ( V_2 -> V_4 ) ) {
F_30 ( V_67 , L_23 ) ;
return F_31 ( V_2 -> V_4 ) ;
}
V_2 -> V_86 = F_28 ( V_67 , NULL ) ;
if ( F_29 ( V_2 -> V_86 ) ) {
F_30 ( V_67 , L_24 ) ;
return F_31 ( V_2 -> V_86 ) ;
}
V_48 = F_32 ( V_2 -> V_86 ) ;
if ( V_48 ) {
F_30 ( V_67 , L_25 ) ;
...
static void F_46 ( struct V_66 * V_67 , struct V_66 * V_71 ,
void * V_72 )
{
struct V_1 * V_2 = F_27 ( V_67 ) ;
if ( F_45 ( V_67 -> V_92 ,
