...
{
T_1 V_97 , V_98 ;
if ( ! F_52 ( V_4 -> V_5 , V_95 ,
L_8 ,
& V_98 ) )
return - V_99 ;
V_97 = F_53 ( & V_4 -> V_100 . V_101 ) ;
F_54 ( & V_4 -> V_100 . V_101 , V_98 ) ;
if ( V_97 != V_98 )
F_55 ( V_4 ) ;
return V_96 ;
}
static T_2 F_56 ( struct V_3 * V_4 , char * V_95 )
{
T_1 V_98 = F_53 ( & V_4 -> V_100 . V_101 ) ;
return sprintf ( V_95 , L_9 , V_98 / 10 , V_98 % 10 ) ;
}
static int F_57 ( struct V_102 * V_103 , T_1 * V_104 )
{
...
* V_104 = F_58 ( T_1 , * V_104 , V_103 -> V_107 ) ;
V_10 = 0 ;
V_11:
if ( V_106 )
F_42 ( V_106 ) ;
...
bool V_10 = false ;
V_94 = F_53 ( & V_4 -> V_100 . V_101 ) ;
V_108 = F_64 ( V_4 , V_111 ) ;
if ( ! V_108 ) {
V_10 = true ;
goto V_11;
}
if ( F_57 ( V_108 , & V_113 ) < 0 ) {
V_10 = true ;
goto V_11;
}
V_112 = F_64 ( V_4 , V_19 ) ;
...
static int F_70 ( struct V_38 * V_39 , T_1 V_40 , T_1 V_22 ,
struct V_3 * V_4 ,
struct V_102 * V_103 )
{
struct V_25 * V_105 = NULL ;
...
static void F_72 ( struct V_38 * V_39 , struct V_57 * V_58 ,
struct V_3 * V_4 )
{
int V_40 = F_39 ( V_58 -> V_62 ) . V_40 ;
struct V_102 * V_103 ;
...
if ( V_56 ++ < V_123 )
continue;
if ( F_70 ( V_39 , V_40 , V_58 -> V_63 -> V_64 ,
V_4 , V_103 ) ) {
V_123 = V_56 - 1 ;
goto V_124;
}
...
{
F_54 ( & V_2 -> V_14 . V_125 , 0 ) ;
F_54 ( & V_2 -> V_14 . V_126 , 500 ) ;
}
