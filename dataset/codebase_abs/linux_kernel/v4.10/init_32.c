...
{
int V_4 ;
if ( V_43 + V_44 * V_31 >= V_45 ) {
F_28 ( L_9 ) ;
F_28 ( L_10 ,
V_43 ,
( unsigned long ) V_43 + V_44 * V_31 ,
V_45 ) ;
F_28 ( L_11 ) ;
F_29 () ;
}
memset ( ( void * ) & V_46 , 0 , V_31 ) ;
V_4 = V_47 >> ( ( 20 - V_2 ) + 5 ) ;
V_4 += 1 ;
V_42 = ( unsigned long * )
F_30 ( V_4 << 2 , V_48 , 0UL ) ;
...
void F_36 ( unsigned long V_40 , unsigned long V_41 )
{
F_37 ( ( void * ) V_40 , ( void * ) V_41 , V_51 ,
L_13 ) ;
}
void F_38 ( struct V_52 * V_52 )
{
unsigned long V_53 = ( unsigned long ) F_39 ( V_52 ) ;
if ( V_53 )
F_40 ( V_53 ) ;
}
