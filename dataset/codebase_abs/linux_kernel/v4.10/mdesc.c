...
T_2 V_32 ;
F_32 (a, hp, mp, MDESC_ARC_TYPE_FWD) {
T_2 V_108 = F_33 ( V_2 , V_32 ) ;
const char * V_34 ;
const T_2 * V_31 ;
V_34 = F_49 ( V_2 , V_108 ) ;
if ( strcmp ( V_34 , L_36 ) )
continue;
V_31 = F_34 ( V_2 , V_108 , L_4 , NULL ) ;
if ( * V_31 < F_59 () )
F_60 ( * V_31 ) . V_104 = V_105 ;
}
V_105 ++ ;
}
}
...
static void F_68 ( struct V_1 * V_2 , T_2 V_88 , int V_109 )
{
T_2 V_32 ;
...
V_31 = F_34 ( V_2 , V_108 , L_4 , NULL ) ;
if ( * V_31 < V_86 )
F_60 ( * V_31 ) . V_109 = V_109 ;
}
}
static void F_69 ( struct V_1 * V_2 , const char * V_110 )
{
int V_105 ;
T_2 V_88 ;
V_105 = 0 ;
...
static void F_71 ( const T_2 * V_42 , unsigned int * V_111 ,
...
if ( V_64 > V_113 )
V_64 = V_113 ;
* V_111 = ( ( 1U << V_64 ) * 64U ) - 1U ;
return;
V_114:
* V_111 = ( ( 1U << V_112 ) * 64U ) - 1U ;
}
...
F_71 ( V_64 , & V_116 -> V_118 , 7 , F_73 ( V_83 * 2 ) ) ;
V_64 = F_34 ( V_2 , V_88 , L_44 , NULL ) ;
F_71 ( V_64 , & V_116 -> V_119 , 7 , 8 ) ;
V_64 = F_34 ( V_2 , V_88 , L_45 , NULL ) ;
F_71 ( V_64 , & V_116 -> V_120 , 6 , 7 ) ;
V_64 = F_34 ( V_2 , V_88 , L_46 , NULL ) ;
F_71 ( V_64 , & V_116 -> V_121 , 2 , 2 ) ;
if ( ! V_117 ++ ) {
F_74 ( L_47
L_48 ,
V_116 -> V_118 + 1 ,
...
static void * F_75 ( void * (* F_36)( struct V_1 * , T_2 , int , void * ) , void * V_122 , T_4 * V_111 )
{
struct V_1 * V_2 = F_20 () ;
void * V_61 = NULL ;
T_2 V_88 ;
...
continue;
#endif
V_61 = F_36 ( V_2 , V_88 , V_123 , V_122 ) ;
if ( V_61 )
goto V_51;
}
V_51:
...
static void * F_77 ( struct V_1 * V_2 , T_2 V_88 , int V_123 ,
void * V_122 )
{
V_125 ++ ;
#ifdef F_53
...
return;
V_125 = 0 ;
F_75 ( F_77 , NULL , V_111 ) ;
}
static void * T_1 F_80 ( struct V_1 * V_2 , T_2 V_88 , int V_123 , void * V_122 )
{
const T_2 * V_128 = F_34 ( V_2 , V_88 , L_51 , NULL ) ;
unsigned long * V_129 = V_122 ;
T_2 V_64 ;
V_64 = ( V_130 | V_131 |
V_132 | V_133 ) ;
if ( V_128 )
...
void T_1 F_81 ( T_4 * V_111 , unsigned long * V_129 )
{
* V_129 = 0 ;
F_75 ( F_80 , V_129 , V_111 ) ;
}
static void * F_82 ( struct V_1 * V_2 , T_2 V_88 , int V_123 ,
void * V_122 )
{
const T_2 * V_134 = F_34 ( V_2 , V_88 , L_52 , NULL ) ;
struct V_115 * V_116 ;
T_3 * V_87 ;
T_2 V_32 ;
#ifndef F_53
...
F_72 ( V_2 , V_88 , V_116 ) ;
F_32 (a, hp, mp, MDESC_ARC_TYPE_FWD) {
T_2 V_137 , V_108 = F_33 ( V_2 , V_32 ) ;
const char * V_138 ;
V_138 = F_49 ( V_2 , V_108 ) ;
if ( ! strcmp ( V_138 , L_35 ) ) {
F_55 ( V_87 , V_2 , V_108 ) ;
continue;
}
F_32 (j, hp, t, MDESC_ARC_TYPE_FWD) {
T_2 V_101 = F_33 ( V_2 , V_137 ) ;
const char * V_139 ;
V_139 = F_49 ( V_2 , V_101 ) ;
if ( ! strcmp ( V_139 , L_35 ) )
F_55 ( V_87 , V_2 , V_101 ) ;
}
}
V_87 -> V_102 = 0 ;
...
static int F_86 ( struct V_140 * V_140 , struct V_141 * V_141 )
{
struct V_1 * V_2 = F_20 () ;
if ( ! V_2 )
return - V_142 ;
...
static T_5 F_87 ( struct V_141 * V_141 , char T_6 * V_144 ,
T_7 V_46 , T_8 * V_145 )
{
struct V_1 * V_2 = V_141 -> V_143 ;
unsigned char * V_5 ;
int V_146 , V_147 = V_46 ;
if ( * V_145 >= V_2 -> V_3 )
return 0 ;
V_146 = V_2 -> V_3 - * V_145 ;
if ( V_147 > V_146 )
...
static T_8 F_89 ( struct V_141 * V_141 , T_8 V_149 , int V_150 )
{
struct V_1 * V_2 = V_141 -> V_143 ;
return F_90 ( V_141 , V_149 , V_150 , V_2 -> V_3 ) ;
}
static int F_91 ( struct V_140 * V_140 , struct V_141 * V_141 )
{
F_24 ( V_141 -> V_143 ) ;
return 0 ;
}
