...
T_1 V_113 ;
bool V_143 = false ;
V_142 = F_85 ( sizeof( * V_142 ) , V_130 ) ;
if ( F_18 ( ! V_142 ) )
return false ;
V_79 = (struct V_78 * ) V_81 -> V_83 ;
V_142 -> V_74 = F_59 ( V_79 -> V_74 ) ;
V_113 = V_81 -> V_75 - sizeof( struct V_106 ) ;
V_142 -> V_75 = V_113 ;
F_6 ( & V_11 -> V_42 ) ;
if ( F_100 ( & V_11 -> V_132 ) ) {
F_101 ( & V_142 -> V_43 , & V_11 -> V_132 ) ;
goto V_107;
}
...
if ( F_58 ( V_142 -> V_74 , V_40 -> V_74 ) )
continue;
F_103 ( & V_142 -> V_43 , & V_40 -> V_43 ) ;
V_143 = true ;
break;
}
if ( ! V_143 )
...
F_6 ( & V_11 -> V_42 ) ;
F_24 (un, safe, &tp_vars->unacked_list, list) {
if ( F_58 ( V_11 -> V_145 , V_40 -> V_74 ) )
break;
V_144 = V_40 -> V_74 + V_40 -> V_75 - V_11 -> V_145 ;
if ( F_58 ( V_11 -> V_145 , V_40 -> V_74 + V_40 -> V_75 ) )
V_11 -> V_145 += V_144 ;
F_25 ( & V_40 -> V_43 ) ;
F_26 ( V_40 ) ;
}
...
V_11 -> V_137 = V_33 ;
if ( F_58 ( V_74 , V_11 -> V_145 ) )
goto V_149;
if ( F_59 ( V_79 -> V_74 ) != V_11 -> V_145 ) {
if ( ! F_99 ( V_11 , V_81 ) )
goto V_107;
goto V_149;
}
...
F_104 ( V_11 ) ;
V_149:
F_98 ( V_26 , V_79 -> V_87 , V_11 -> V_145 ,
