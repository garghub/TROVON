...
static struct V_1 * F_10 ( const char * type )
{
struct V_1 * V_2 ;
F_2 ( & V_3 ) ;
...
struct V_11 * F_19 ( const char * type , const char * V_12 , T_1 V_13 ,
...
const char * F_25 ( struct V_11 * V_11 )
{
return V_11 -> V_2 -> type ;
}
int F_26 ( struct V_11 * V_11 , T_2 V_21 , T_1 V_13 ,
unsigned long * V_22 )
{
return V_11 -> V_2 -> malloc ( V_11 -> V_16 , V_21 , V_13 , V_22 ) ;
}
void F_27 ( struct V_11 * V_11 , unsigned long V_22 )
{
V_11 -> V_2 -> free ( V_11 -> V_16 , V_22 ) ;
}
int F_28 ( struct V_11 * V_11 , unsigned int V_23 ,
unsigned int * V_24 )
{
...
void F_30 ( struct V_11 * V_11 , unsigned long V_22 )
{
