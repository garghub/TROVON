...
V_4 -> V_9 = & V_9 ;
F_29 ( & V_4 -> V_5 , V_45 ) ;
F_30 ( V_13 . V_14 , V_4 -> V_6 + V_48 ) ;
F_30 ( V_13 . V_16 , V_4 -> V_6 + V_49 ) ;
F_30 ( V_13 . V_18 , V_4 -> V_6 + V_50 ) ;
F_30 ( V_13 . type , V_4 -> V_6 + V_51 ) ;
F_31 ( & V_4 -> V_5 , V_45 ) ;
F_4 ( L_13 ) ;
F_32 ( V_4 -> V_9 ,
V_52 ) ;
