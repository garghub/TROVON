...
F_14 ( V_2 ) ;
V_87 = V_86 / V_85 ;
F_3 ( V_87 , V_2 -> V_10 + V_88 ) ;
F_3 ( V_87 / 2 , V_2 -> V_10 + V_89 ) ;
F_3 ( V_87 / 2 , V_2 -> V_10 + V_90 ) ;
F_3 ( V_87 / 16 , V_2 -> V_10 + V_91 ) ;
F_15 ( V_2 ) ;
}
...
unsigned long V_86 ;
int V_23 , V_69 ;
V_2 = F_33 ( V_8 , sizeof( * V_2 ) , V_97 ) ;
if ( ! V_2 )
return - V_98 ;
V_96 = F_34 ( V_93 , V_99 , 0 ) ;
...
if ( F_39 ( V_8 -> V_100 , L_17 , & V_85 ) )
V_85 = V_101 ;
if ( ! V_85 || V_85 > V_102 ) {
F_22 ( V_8 , L_18 , V_85 ) ;
return - V_103 ;
}
V_2 -> V_104 = F_40 ( V_8 , NULL ) ;
if ( F_36 ( V_2 -> V_104 ) ) {
F_22 ( V_8 , L_19 ) ;
...
V_2 -> V_7 . V_106 = V_107 ;
V_2 -> V_7 . V_108 = & V_109 ;
V_2 -> V_7 . V_8 . V_110 = V_8 ;
V_2 -> V_7 . V_8 . V_100 = V_8 -> V_100 ;
F_44 ( V_2 -> V_7 . V_111 , L_21 , sizeof( V_2 -> V_7 . V_111 ) ) ;
V_2 -> V_7 . V_112 = & V_113 ;
F_45 ( & V_2 -> V_7 , V_2 ) ;
F_46 ( V_93 , V_2 ) ;
F_31 ( V_2 , V_85 , V_86 ) ;
