...
F_49 ( & V_3 -> V_53 ) ;
F_50 ( V_3 , 1 , V_5 , V_61 , V_62 , V_62 ) ;
return V_62 ;
}
int F_51 ( struct V_9 * V_3 , int V_5 , T_2 V_61 )
{
int V_62 ;
F_21 ( F_47 () ) ;
F_52 ( & V_3 -> V_53 ) ;
...
F_49 ( & V_3 -> V_53 ) ;
F_50 ( V_3 , 0 , V_5 , V_61 , V_64 , V_44 ) ;
return V_44 ;
}
int F_54 ( struct V_9 * V_3 , int V_5 , T_2 V_61 , T_3 V_64 )
{
int V_44 ;
F_21 ( F_47 () ) ;
F_52 ( & V_3 -> V_53 ) ;
...
static int F_55 ( struct V_25 * V_26 , struct V_65 * V_66 )
{
struct V_1 * V_12 = F_56 ( V_26 ) ;
if ( F_57 ( V_26 , V_66 ) )
return 1 ;
if ( V_12 -> V_67 )
