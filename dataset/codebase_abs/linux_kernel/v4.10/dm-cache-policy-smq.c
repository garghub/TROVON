...
static unsigned F_114 ( T_2 V_128 )
{
return F_115 ( F_84 ( V_128 ) , 9 ) & ( V_72 - 1 ) ;
}
...
V_11 -> V_65 = V_65 ;
V_11 -> V_79 = false ;
V_11 -> V_31 = V_147 ? F_28 ( V_146 , V_72 - 1 ) : F_114 ( V_128 ) ;
F_76 ( V_74 , V_11 ) ;
return 0 ;
}
static T_4 F_117 ( struct V_138 * V_139 , T_2 V_128 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
...
static void F_118 ( struct V_73 * V_74 , T_1 V_65 )
{
struct V_8 * V_11 ;
V_11 = F_56 ( & V_74 -> V_86 , V_65 ) ;
F_8 ( ! V_11 ) ;
...
static void F_119 ( struct V_138 * V_139 , T_1 V_65 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
unsigned long V_142 ;
F_108 ( & V_74 -> V_143 , V_142 ) ;
...
static int F_120 ( struct V_73 * V_74 , T_2 V_128 )
{
struct V_8 * V_11 = F_65 ( & V_74 -> V_87 , F_84 ( V_128 ) ) ;
if ( ! V_11 || ! V_11 -> V_69 )
return - V_148 ;
...
static int F_121 ( struct V_138 * V_139 , T_2 V_128 )
{
int V_122 ;
unsigned long V_142 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_108 ( & V_74 -> V_143 , V_142 ) ;
V_122 = F_120 ( V_74 , V_128 ) ;
F_109 ( & V_74 -> V_143 , V_142 ) ;
return V_122 ;
}
static bool F_122 ( struct V_73 * V_74 , bool V_149 )
{
if ( V_149 ) {
unsigned V_150 = F_84 ( V_74 -> V_102 ) - F_23 ( & V_74 -> V_79 ) ;
unsigned V_38 = F_84 ( V_74 -> V_102 ) * V_151 / 100u ;
return V_150 >= V_38 ;
} else
return ! F_23 ( & V_74 -> V_79 ) ;
}
static int F_123 ( struct V_73 * V_74 , T_1 * V_65 ,
T_2 * V_128 , bool V_152 )
{
struct V_8 * V_11 = NULL ;
bool V_153 = F_122 ( V_74 , V_152 ) ;
if ( V_152 )
V_11 = F_79 ( V_74 , & V_74 -> V_79 , V_153 ? 1u : V_74 -> V_79 . V_24 ) ;
else
...
static int F_124 ( struct V_138 * V_139 , T_1 * V_65 ,
T_2 * V_128 , bool V_152 )
{
int V_122 ;
unsigned long V_142 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_108 ( & V_74 -> V_143 , V_142 ) ;
V_122 = F_123 ( V_74 , V_65 , V_128 , V_152 ) ;
F_109 ( & V_74 -> V_143 , V_142 ) ;
return V_122 ;
}
static void F_125 ( struct V_73 * V_74 ,
T_1 V_154 , T_1 V_155 )
{
struct V_8 * V_11 = F_56 ( & V_74 -> V_86 , V_154 ) ;
if ( V_11 ) {
F_78 ( V_74 , V_11 ) ;
V_11 -> V_65 = V_155 ;
V_11 -> V_79 = true ;
...
static void F_126 ( struct V_138 * V_139 ,
T_1 V_154 , T_1 V_155 )
{
unsigned long V_142 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
F_108 ( & V_74 -> V_143 , V_142 ) ;
F_125 ( V_74 , V_154 , V_155 ) ;
F_109 ( & V_74 -> V_143 , V_142 ) ;
}
static T_2 F_127 ( struct V_138 * V_139 )
{
T_2 V_122 ;
unsigned long V_142 ;
struct V_73 * V_74 = F_102 ( V_139 ) ;
...
static void F_128 ( struct V_138 * V_139 , bool V_141 )
{
struct V_73 * V_74 = F_102 ( V_139 ) ;
unsigned long V_142 ;
F_108 ( & V_74 -> V_143 , V_142 ) ;
...
static int F_129 ( struct V_138 * V_139 ,
const char * V_157 , const char * V_158 )
{
unsigned long V_159 ;
if ( F_130 ( V_158 , 10 , & V_159 ) )
return - V_160 ;
if ( ! strcasecmp ( V_157 , L_1 ) ||
! strcasecmp ( V_157 , L_2 ) ||
! strcasecmp ( V_157 , L_3 ) ||
! strcasecmp ( V_157 , L_4 ) ||
! strcasecmp ( V_157 , L_5 ) ) {
F_131 ( L_6 , V_157 ) ;
return 0 ;
}
return - V_160 ;
}
static int F_132 ( struct V_138 * V_139 , char * V_120 ,
unsigned V_161 , T_5 * V_162 )
{
T_5 V_163 = * V_162 ;
F_133 ( L_7
L_8
...
static void F_134 ( struct V_73 * V_74 , bool V_164 )
{
V_74 -> V_140 . V_165 = F_104 ;
V_74 -> V_140 . F_101 = F_107 ;
V_74 -> V_140 . V_166 = F_110 ;
V_74 -> V_140 . V_167 = F_112 ;
V_74 -> V_140 . V_168 = F_113 ;
V_74 -> V_140 . V_169 = F_116 ;
V_74 -> V_140 . V_170 = F_117 ;
V_74 -> V_140 . V_171 = F_119 ;
V_74 -> V_140 . V_172 = F_121 ;
V_74 -> V_140 . V_173 = F_124 ;
V_74 -> V_140 . V_174 = F_126 ;
V_74 -> V_140 . V_175 = F_127 ;
V_74 -> V_140 . V_156 = F_128 ;
if ( V_164 ) {
V_74 -> V_140 . V_176 = F_129 ;
V_74 -> V_140 . V_177 = F_132 ;
}
}
static bool F_135 ( T_3 V_178 ,
T_3 V_179 ,
unsigned V_97 )
{
return ( V_179 * V_97 ) > V_178 ;
}
static void F_136 ( T_3 V_178 ,
T_3 V_180 ,
unsigned V_181 ,
T_3 * V_179 ,
unsigned * V_97 )
{
* V_179 = V_180 * 16u ;
* V_97 = F_44 ( V_181 / 4u , 1024u ) ;
while ( ( * V_179 > V_180 ) &&
F_135 ( V_178 , * V_179 , * V_97 ) )
* V_179 /= 2u ;
}
static struct V_138 * F_137 ( T_2 V_102 ,
T_3 V_178 ,
T_3 V_180 ,
bool V_164 )
{
unsigned V_25 ;
unsigned V_182 = 2u * V_72 ;
unsigned V_183 = 2u * V_182 ;
struct V_73 * V_74 = F_138 ( sizeof( * V_74 ) , V_184 ) ;
if ( ! V_74 )
return NULL ;
F_134 ( V_74 , V_164 ) ;
V_74 -> V_102 = V_102 ;
V_74 -> V_180 = V_180 ;
F_136 ( V_178 , V_180 , F_84 ( V_102 ) ,
& V_74 -> V_179 , & V_74 -> V_97 ) ;
V_74 -> V_130 = F_139 ( V_74 -> V_179 , V_74 -> V_180 ) ;
V_74 -> V_95 = 1u ;
if ( F_3 ( & V_74 -> V_4 , V_183 + V_74 -> V_97 + F_84 ( V_102 ) ) ) {
F_140 ( L_12 ) ;
goto V_185;
}
F_58 ( & V_74 -> V_75 , & V_74 -> V_4 , 0 , V_182 ) ;
for ( V_25 = 0 ; V_25 < V_182 ; V_25 ++ )
F_65 ( & V_74 -> V_75 , V_25 ) -> V_20 = true ;
F_58 ( & V_74 -> V_77 , & V_74 -> V_4 , V_182 , V_183 ) ;
for ( V_25 = 0 ; V_25 < V_182 ; V_25 ++ )
F_65 ( & V_74 -> V_77 , V_25 ) -> V_20 = true ;
F_58 ( & V_74 -> V_134 , & V_74 -> V_4 , V_183 ,
V_183 + V_74 -> V_97 ) ;
F_58 ( & V_74 -> V_87 , & V_74 -> V_4 ,
V_183 + V_74 -> V_97 ,
V_183 + V_74 -> V_97 + F_84 ( V_102 ) ) ;
V_74 -> V_96 = F_141 ( V_74 -> V_97 ) ;
if ( ! V_74 -> V_96 ) {
F_140 ( L_13 ) ;
goto V_186;
}
...
T_3 V_180 )
{
return F_137 ( V_102 , V_178 , V_180 , false ) ;
}
static struct V_138 * F_144 ( T_2 V_102 ,
T_3 V_178 ,
T_3 V_180 )
{
return F_137 ( V_102 , V_178 , V_180 , true ) ;
}
