...
void F_48 (
void (* F_49)( int V_16 , struct V_15 * V_14 , T_2 * V_74 ) )
{
V_75 = F_49 ;
}
...
static int F_85 ( struct V_142 * V_109 , T_5 V_51 )
{
int V_4 ;
for ( V_4 = 0 ; V_4 < V_91 ; V_4 ++ ) {
struct V_13 * V_14 = & V_73 [ V_4 ] ;
if ( V_14 -> V_16 . type != V_150 && V_14 -> V_16 . V_109 == & V_109 -> V_109 )
...
return & V_73 [ V_4 ] ;
V_4 = V_16 -> line ;
if ( V_4 < V_90 && V_73 [ V_4 ] . V_16 . type == V_150 &&
V_73 [ V_4 ] . V_16 . V_70 == 0 )
return & V_73 [ V_4 ] ;
for ( V_4 = 0 ; V_4 < V_90 ; V_4 ++ )
if ( V_73 [ V_4 ] . V_16 . type == V_150 &&
V_73 [ V_4 ] . V_16 . V_70 == 0 )
return & V_73 [ V_4 ] ;
for ( V_4 = 0 ; V_4 < V_90 ; V_4 ++ )
if ( V_73 [ V_4 ] . V_16 . type == V_150 )
...
F_110 ( V_97 , & V_177 , & V_97 , 0644 ) ;
F_110 ( V_90 , & V_177 , & V_90 , 0644 ) ;
F_110 ( V_111 , & V_177 , & V_111 , 0644 ) ;
#ifdef F_111
F_112 ( V_176 , V_81 ,
& V_178 , . V_179 = & V_180 ,
0444 , - 1 , 0 ) ;
