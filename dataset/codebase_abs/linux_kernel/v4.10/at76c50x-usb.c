...
F_148 ( & V_409 -> V_38 ) , V_71 -> V_74 ,
V_71 -> V_324 . V_325 , V_71 -> V_324 . V_326 ,
V_71 -> V_324 . V_327 , V_71 -> V_324 . V_328 ) ;
F_47 ( V_71 -> V_79 -> V_80 , L_168 ,
V_71 -> V_76 , V_71 -> V_426 -> V_445 ) ;
exit:
return V_21 ;
}
...
static int F_156 ( struct V_408 * V_409 ,
...
int V_1 = ( int ) V_447 -> V_451 ;
V_10 = F_157 ( F_158 ( V_409 ) ) ;
V_450 = F_15 ( sizeof( * V_450 ) , V_40 ) ;
if ( ! V_450 ) {
V_21 = - V_41 ;
goto exit;
}
...
|| ( V_64 == V_454 ) ) {
V_21 = F_33 ( V_10 , V_455 , V_450 , sizeof( * V_450 ) ) ;
if ( V_21 < 0 || ( V_450 -> V_325 | V_450 -> V_326 ) == 0 )
V_448 = 1 ;
} else
V_448 = 1 ;
if ( V_448 ) {
...
F_159 ( V_409 , V_71 ) ;
memcpy ( & V_71 -> V_324 , V_450 , sizeof( struct V_449 ) ) ;
V_71 -> V_1 = V_1 ;
...
static void F_161 ( struct V_408 * V_409 )
{
struct V_70 * V_71 ;
V_71 = F_162 ( V_409 ) ;
F_159 ( V_409 , NULL ) ;
