...
V_7 -> V_194 = F_92 ( struct V_200 ) ;
if ( ! V_7 -> V_194 )
return - V_201 ;
V_141 = F_93 ( & V_96 -> V_56 , V_202 ) ;
if ( V_141 ) {
F_89 ( V_7 -> V_194 ) ;
V_7 -> V_194 = NULL ;
return V_141 ;
...
V_7 -> V_168 = V_203 + V_148 ;
V_7 -> V_81 = V_204 - V_148 ;
if ( V_7 -> type == V_24 )
V_7 -> V_81 -= V_169 ;
...
static void F_96 ( struct V_12 * V_12 , struct V_206 * V_207 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
...
F_24 ( V_20 -> V_34 , V_12 ) ;
V_20 -> V_34 -> V_54 |= V_212 ;
F_95 ( V_20 -> V_34 ) ;
V_20 -> V_34 -> V_49 = & V_50 ;
V_119 = F_101 ( V_20 -> V_34 ) ;
if ( V_119 )
goto V_213;
F_17 ( V_20 -> V_214 [ 0 ] ,
F_12 ( V_20 -> V_34 ) ) ;
...
static int F_107 ( struct V_216 * V_217 [] , struct V_216 * V_70 [] )
{
T_3 V_32 ;
if ( ! V_70 )
return 0 ;
V_32 = 0 ;
if ( V_70 [ V_218 ] )
V_32 |= F_108 ( V_70 [ V_218 ] ) ;
if ( V_70 [ V_219 ] )
V_32 |= F_108 ( V_70 [ V_219 ] ) ;
if ( V_32 & ( V_71 | V_72 ) )
return - V_187 ;
return 0 ;
}
static int F_109 ( struct V_216 * V_217 [] , struct V_216 * V_70 [] )
{
struct V_1 V_75 ;
if ( V_217 [ V_220 ] ) {
if ( F_110 ( V_217 [ V_220 ] ) != V_221 )
return - V_187 ;
if ( ! F_111 ( F_112 ( V_217 [ V_220 ] ) ) )
return - V_222 ;
}
if ( ! V_70 )
goto V_223;
if ( V_70 [ V_224 ] ) {
V_75 = F_113 ( V_70 [ V_224 ] ) ;
if ( F_14 ( & V_75 ) )
return - V_187 ;
}
V_223:
return F_107 ( V_217 , V_70 ) ;
}
static void F_114 ( struct V_216 * V_70 [] ,
struct V_35 * V_28 )
{
...
F_108 ( V_70 [ V_219 ] ) ) ;
if ( V_70 [ V_226 ] )
V_28 -> V_31 = F_116 ( V_70 [ V_226 ] ) ;
if ( V_70 [ V_227 ] )
V_28 -> V_115 = F_116 ( V_70 [ V_227 ] ) ;
if ( V_70 [ V_228 ] )
V_28 -> V_29 = F_113 ( V_70 [ V_228 ] ) ;
if ( V_70 [ V_224 ] )
V_28 -> V_30 = F_113 ( V_70 [ V_224 ] ) ;
if ( V_70 [ V_229 ] )
V_28 -> V_170 = F_117 ( V_70 [ V_229 ] ) ;
if ( V_70 [ V_230 ] )
V_28 -> V_87 = F_117 ( V_70 [ V_230 ] ) ;
if ( V_70 [ V_231 ] )
V_28 -> V_154 = F_116 ( V_70 [ V_231 ] ) ;
if ( V_70 [ V_232 ] )
V_28 -> V_32 = F_115 ( V_70 [ V_232 ] ) ;
}
...
static bool F_121 ( struct V_216 * V_70 [] ,
struct V_237 * V_238 )
{
bool V_141 = false ;
...
if ( V_70 [ V_239 ] ) {
V_141 = true ;
V_238 -> type = F_122 ( V_70 [ V_239 ] ) ;
}
if ( V_70 [ V_240 ] ) {
V_141 = true ;
V_238 -> V_32 = F_122 ( V_70 [ V_240 ] ) ;
}
if ( V_70 [ V_241 ] ) {
V_141 = true ;
V_238 -> V_242 = F_108 ( V_70 [ V_241 ] ) ;
}
if ( V_70 [ V_243 ] ) {
V_141 = true ;
V_238 -> V_244 = F_108 ( V_70 [ V_243 ] ) ;
}
return V_141 ;
}
static int F_123 ( struct V_12 * V_245 , struct V_6 * V_7 ,
struct V_216 * V_217 [] , struct V_216 * V_70 [] )
{
struct V_5 * V_44 ;
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
...
V_44 = F_12 ( V_7 ) ;
if ( F_121 ( V_70 , & V_238 ) ) {
int V_119 = F_124 ( V_44 , & V_238 ) ;
if ( V_119 < 0 )
return V_119 ;
}
F_114 ( V_70 , & V_44 -> V_28 ) ;
if ( F_20 ( V_12 , & V_44 -> V_28 , V_7 -> type ) )
return - V_188 ;
if ( V_7 -> type == V_24 && ! V_217 [ V_220 ] )
F_125 ( V_7 ) ;
V_44 -> V_7 = V_7 ;
V_44 -> V_12 = F_5 ( V_7 ) ;
F_25 ( V_44 , ! V_217 [ V_246 ] ) ;
V_7 -> V_54 |= V_247 ;
V_7 -> V_248 |= V_247 ;
if ( ! ( V_44 -> V_28 . V_52 & V_53 ) ) {
if ( ! ( V_44 -> V_28 . V_52 & V_133 ) ||
( V_44 -> V_249 . type == V_250 ) ) {
V_7 -> V_54 |= V_251 ;
V_7 -> V_248 |= V_251 ;
}
V_7 -> V_54 |= V_55 ;
...
static int F_126 ( struct V_6 * V_7 , struct V_216 * V_217 [] ,
struct V_216 * V_70 [] )
{
...
F_19 ( V_20 , V_17 ) ;
F_71 ( V_17 , & V_36 , ! V_217 [ V_246 ] ) ;
F_16 ( V_20 , V_17 ) ;
return 0 ;
}
static void F_127 ( struct V_6 * V_7 , struct V_206 * V_207 )
{
struct V_12 * V_12 = F_5 ( V_7 ) ;
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
if ( V_7 != V_20 -> V_34 )
...
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_131 ( V_58 , V_225 , V_36 -> V_13 ) ||
F_132 ( V_58 , V_218 ,
F_75 ( V_36 -> V_171 ) ) ||
F_132 ( V_58 , V_219 ,
F_75 ( V_36 -> V_52 ) ) ||
F_133 ( V_58 , V_226 , V_36 -> V_31 ) ||
F_133 ( V_58 , V_227 , V_36 -> V_115 ) ||
F_134 ( V_58 , V_228 , & V_36 -> V_29 ) ||
F_134 ( V_58 , V_224 , & V_36 -> V_30 ) ||
F_135 ( V_58 , V_229 , V_36 -> V_170 ) ||
F_135 ( V_58 , V_230 , V_36 -> V_87 ) ||
F_133 ( V_58 , V_231 , V_36 -> V_154 ) ||
F_131 ( V_58 , V_232 , V_36 -> V_32 ) )
goto V_252;
if ( F_136 ( V_58 , V_239 ,
V_17 -> V_249 . type ) ||
F_132 ( V_58 , V_241 ,
