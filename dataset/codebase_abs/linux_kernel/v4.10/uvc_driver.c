...
struct V_34 * V_35 ;
int V_116 ;
if ( V_36 -> V_151 && V_36 -> V_231 )
F_16 ( V_187 , L_98
L_99 , V_66 -> V_232 , V_36 -> V_151 ,
V_36 -> V_231 ) ;
else
F_16 ( V_187 , L_100 ,
V_66 -> V_232 ) ;
...
? V_36 -> V_236 : V_235 ;
if ( V_66 -> V_237 != NULL )
F_17 ( V_35 -> V_70 , V_66 -> V_237 , sizeof V_35 -> V_70 ) ;
else
snprintf ( V_35 -> V_70 , sizeof V_35 -> V_70 ,
L_101 ,
F_31 ( V_66 -> V_150 . V_151 ) ,
F_31 ( V_66 -> V_150 . V_231 ) ) ;
if ( F_42 ( V_35 ) < 0 ) {
F_16 ( V_187 , L_102
L_103 ) ;
goto error;
...
V_66 -> V_237 ? V_66 -> V_237 : L_105 ,
F_31 ( V_66 -> V_150 . V_151 ) ,
F_31 ( V_66 -> V_150 . V_231 ) ) ;
if ( V_35 -> V_74 != V_36 -> V_236 ) {
F_18 ( V_72 , L_106
L_107 , V_35 -> V_74 ) ;
F_18 ( V_72 , L_108
L_109 ) ;
...
F_17 ( V_35 -> V_211 . V_238 , V_35 -> V_70 , sizeof( V_35 -> V_211 . V_238 ) ) ;
if ( V_66 -> V_239 )
F_17 ( V_35 -> V_211 . V_239 , V_66 -> V_239 ,
sizeof( V_35 -> V_211 . V_239 ) ) ;
strcpy ( V_35 -> V_211 . V_240 , V_66 -> V_232 ) ;
V_35 -> V_211 . V_241 = F_31 ( V_66 -> V_150 . V_242 ) ;
V_35 -> V_211 . V_243 = V_244 ;
F_93 ( & V_35 -> V_211 ) ;
...
static int F_102 ( struct V_52 * V_53 , T_7 V_246 )
{
struct V_34 * V_35 = F_101 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_247 , L_114 ,
...
static int F_107 ( struct V_52 * V_53 , int V_250 )
{
struct V_34 * V_35 = F_101 ( V_53 ) ;
struct V_42 * V_43 ;
int V_116 = 0 ;
...
F_103 ( & V_35 -> V_234 ) ;
if ( V_35 -> V_249 )
V_116 = F_109 ( V_35 , V_251 ) ;
F_105 ( & V_35 -> V_234 ) ;
return V_116 ;
}
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 ) {
V_116 = F_110 ( V_43 , V_250 ) ;
if ( V_116 < 0 )
F_111 ( & V_43 -> V_215 ,
...
static int F_114 ( char * V_50 , struct V_252 * V_253 )
{
if ( V_254 == V_255 )
...
static int F_115 ( const char * V_256 , struct V_252 * V_253 )
{
if ( strncasecmp ( V_256 , L_121 , strlen ( L_121 ) ) == 0 )
V_256 += strlen ( L_121 ) ;
if ( strcasecmp ( V_256 , L_122 ) == 0 )
V_254 = V_255 ;
else if ( strcasecmp ( V_256 , L_123 ) == 0 )
V_254 = V_257 ;
else
return - V_69 ;
return 0 ;
...
F_45 (KERN_INFO DRIVER_DESC L_124 DRIVER_VERSION L_125 ) ;
return 0 ;
}
