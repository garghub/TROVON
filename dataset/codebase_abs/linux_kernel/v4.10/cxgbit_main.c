...
static void
F_39 ( unsigned int V_42 , struct V_43 * V_44 ,
struct V_45 * V_46 )
{
unsigned int V_47 = F_40 ( V_44 -> V_48 ) ;
V_46 -> V_16 |= V_49 ;
V_46 -> V_50 = F_40 ( V_44 -> V_51 ) ;
V_46 -> V_52 = F_41 ( V_44 -> V_53 ) ;
if ( V_47 & ( 1 << V_54 ) ) {
F_17 ( L_8 , V_42 , V_47 ) ;
V_46 -> V_16 |= V_55 ;
}
...
static void
F_42 ( struct V_27 * V_28 , T_2 V_62 , const T_3 * V_63 )
{
struct V_64 * V_65 = F_43 ( V_28 ) ;
struct V_45 * V_46 = F_44 ( V_28 ,
V_65 -> V_66 ) ;
struct V_67 * V_44 = (struct V_67 * ) ( V_63 + 1 ) ;
F_39 ( V_65 -> V_26 -> V_42 , V_44 , V_46 ) ;
if ( V_46 -> V_16 & V_68 )
V_46 -> V_69 = true ;
V_65 -> V_69 = true ;
V_65 -> V_70 += V_46 -> V_52 ;
...
static void
F_45 ( struct V_27 * V_28 , const struct V_71 * V_72 ,
unsigned int V_73 )
{
T_2 V_74 = F_46 ( V_28 ) -> V_75 ;
T_2 V_76 ;
F_47 ( V_28 , V_74 , V_72 -> V_77 [ 0 ] . V_78 ,
...
V_72 -> V_77 [ V_76 ] . V_73 ,
V_72 -> V_77 [ V_76 ] . V_79 ) ;
F_46 ( V_28 ) -> V_75 += V_72 -> V_80 ;
F_48 ( V_72 -> V_77 [ V_72 -> V_80 - 1 ] . V_78 ) ;
}
static void
F_49 ( struct V_27 * V_28 , T_2 V_62 , const struct V_71 * V_72 )
{
struct V_64 * V_65 = F_43 ( V_28 ) ;
struct V_45 * V_46 = F_44 ( V_28 ,
V_65 -> V_66 ) ;
...
V_46 -> V_16 |= V_68 ;
V_46 -> V_84 = F_40 ( V_44 -> V_84 ) ;
V_53 = F_41 ( V_44 -> V_53 ) ;
V_46 -> V_85 = V_72 -> V_83 + V_73 ;
V_46 -> V_86 = V_53 ;
V_46 -> V_87 = F_46 ( V_28 ) -> V_75 ;
if ( F_50 ( V_72 -> V_80 > 1 ) )
F_51 ( V_28 ) = 0 ;
V_65 -> V_69 = false ;
} else {
...
static struct V_27 *
F_52 ( struct V_25 * V_26 , T_2 V_62 , const struct V_71 * V_72 ,
...
static void F_58 ( struct V_100 * V_101 , struct V_27 * V_28 )
{
struct V_64 * V_65 = F_43 ( V_28 ) ;
struct V_25 * V_26 = V_65 -> V_26 ;
V_26 -> V_102 = NULL ;
F_59 ( V_28 , & V_101 -> V_103 ) ;
F_55 ( V_26 , V_28 ) ;
F_60 ( V_26 ) ;
V_101 -> V_104 ++ ;
V_101 -> V_105 -- ;
...
{
struct V_27 * V_28 ;
while ( ( V_28 = F_62 ( & V_101 -> V_103 ) ) )
F_58 ( V_101 , V_28 ) ;
}
static int
F_63 ( struct V_25 * V_26 , T_2 V_62 , const T_3 * V_63 ,
...
V_28 = F_52 ( V_26 , V_62 , V_72 , V_63 , V_96 ) ;
if ( F_50 ( ! V_28 ) )
goto V_107;
V_26 -> V_102 = V_28 ;
F_29 ( & V_101 -> V_103 , V_28 ) ;
V_101 -> V_105 ++ ;
V_108:
V_28 = V_26 -> V_102 ;
V_65 = F_43 ( V_28 ) ;
if ( ( V_72 && ( ( ( F_46 ( V_28 ) -> V_75 + V_72 -> V_80 ) >
V_8 ) || ( V_65 -> V_70 >= V_111 ) ) ) ||
( V_65 -> V_66 >= V_8 ) ) {
F_58 ( V_101 , V_28 ) ;
goto V_109;
...
static int
F_65 ( void * V_113 , const T_3 * V_63 ,
const struct V_71 * V_72 , struct V_100 * V_101 ,
struct V_95 * V_96 )
{
...
(struct V_114 * ) ( V_63 + 1 ) ;
V_42 = F_66 ( V_115 ) ;
V_26 = F_67 ( V_5 -> V_127 , V_42 ) ;
break;
default:
break;
}
if ( V_26 && V_26 -> V_102 && V_116 )
F_58 ( V_101 , V_26 -> V_102 ) ;
if ( ! V_72 ) {
unsigned int V_53 ;
if ( V_62 == V_118 ) {
if ( ! F_63 ( V_26 , V_62 , V_63 , NULL , V_101 ,
V_96 ) )
return 0 ;
}
...
goto V_129;
F_68 ( V_28 , V_53 ) ;
F_69 ( V_28 , & V_63 [ 1 ] , V_53 ) ;
} else {
if ( F_50 ( V_62 != * ( T_2 * ) V_72 -> V_83 ) ) {
F_17 ( L_12 ,
V_72 -> V_83 , F_70 ( * V_63 ) ,
F_70 ( * ( V_130 * ) V_72 -> V_83 ) ,
V_72 -> V_131 ) ;
return 0 ;
}
if ( V_62 == V_81 || V_62 == V_117 ) {
if ( ! F_63 ( V_26 , V_62 , V_63 , V_72 , V_101 ,
V_96 ) )
return 0 ;
}
#define F_71 128
V_28 = F_72 ( V_72 , F_71 , F_71 ) ;
if ( F_50 ( ! V_28 ) )
goto V_129;
}
...
V_140 = F_41 ( V_146 -> V_147 ) ;
} else {
struct V_148 * V_149 ;
V_149 = (struct V_148 * ) & V_26 -> V_141 . V_142 ;
V_140 = F_41 ( V_149 -> V_150 ) ;
}
if ( V_140 != V_139 )
continue;
if ( V_26 -> V_138 == V_138 )
...
goto V_107;
V_159 = F_78 ( V_158 -> V_163 . V_159 ) - 1 ;
} else {
goto V_107;
}
F_74 ( L_16 ,
V_158 -> V_168 , V_159 ) ;
V_156 = F_79 ( & V_169 , V_158 -> V_168 ) ;
if ( ! V_156 )
goto V_107;
F_22 ( & V_23 ) ;
V_3 = F_80 ( V_156 , & V_137 ) ;
F_81 ( V_156 ) ;
if ( ! V_3 ) {
F_24 ( & V_23 ) ;
goto V_107;
}
F_76 ( V_3 , V_137 , V_159 ,
V_158 -> V_163 . V_170 ) ;
F_24 ( & V_23 ) ;
V_107:
F_5 ( V_154 ) ;
...
static int
F_82 ( struct V_171 * V_172 , unsigned long V_173 ,
void * V_98 )
{
struct V_153 * V_154 ;
...
return V_174 ;
V_154 -> V_160 = * V_160 ;
F_83 ( & V_154 -> V_152 , F_77 ) ;
F_84 ( & V_154 -> V_152 ) ;
return V_175 ;
}
static enum V_176 F_85 ( struct V_177 * V_178 )
{
return V_179 ;
}
...
#endif
F_22 ( & V_23 ) ;
F_95 (cdev, tmp, &cdev_list_head, list) {
F_35 ( & V_3 -> V_22 ) ;
F_36 ( V_3 ) ;
}
F_24 ( & V_23 ) ;
