...
static T_2 F_15 ( int V_26 , void * V_27 )
{
struct V_2 * V_3 = V_27 ;
T_1 V_1 ;
int V_28 = V_29 | V_30 ;
F_16 ( & V_3 -> V_31 -> V_7 , L_1 , V_32 , V_26 ) ;
F_17 ( & V_3 -> V_12 ) ;
V_1 = F_7 ( V_3 -> V_23 + V_24 ) ;
...
F_19 ( V_3 -> V_31 , 1 , V_28 ) ;
return V_39 ;
}
static T_3 int F_20 ( struct V_40 * V_41 )
{
struct V_42 * V_43 ;
struct V_2 * V_3 ;
int V_14 ;
V_3 = F_21 ( & V_41 -> V_7 , sizeof( struct V_2 ) ,
V_44 ) ;
if ( ! V_3 )
return - V_45 ;
F_22 ( & V_3 -> V_12 ) ;
V_43 = F_23 ( V_41 , V_46 , L_2 ) ;
V_3 -> V_5 = F_24 ( & V_41 -> V_7 , V_43 ) ;
if ( F_25 ( V_3 -> V_5 ) )
return F_26 ( V_3 -> V_5 ) ;
V_43 = F_23 ( V_41 , V_46 , L_3 ) ;
V_3 -> V_23 = F_24 ( & V_41 -> V_7 , V_43 ) ;
if ( F_25 ( V_3 -> V_23 ) )
return F_26 ( V_3 -> V_23 ) ;
V_3 -> V_26 = F_27 ( V_41 , 0 ) ;
if ( V_3 -> V_26 < 0 ) {
F_28 ( & V_41 -> V_7 , L_4 ) ;
return V_3 -> V_26 ;
}
if ( F_29 ( & V_41 -> V_7 , V_3 -> V_26 , F_15 ,
0 , V_41 -> V_47 , V_3 ) < 0 ) {
F_30 ( & V_41 -> V_7 , L_5 ) ;
V_3 -> V_26 = - 1 ;
V_48 . V_49 = NULL ;
...
if ( V_3 -> V_26 != - 1 )
F_32 ( & V_41 -> V_7 , 1 ) ;
V_3 -> V_31 = F_33 ( & V_41 -> V_7 , V_41 -> V_47 ,
& V_48 , V_51 ) ;
if ( F_25 ( V_3 -> V_31 ) ) {
V_14 = F_26 ( V_3 -> V_31 ) ;
F_28 ( & V_41 -> V_7 , L_6 , V_14 ) ;
return V_14 ;
}
return 0 ;
}
