...
V_55 = F_47 ( int , V_70 ,
F_48 ( V_56 , ( V_36 >> V_71 ) ) ) ;
V_10 = F_49 ( V_72 , V_55 , V_11 -> V_2 -> V_9 ) ;
V_10 -> V_49 . V_46 = V_54 -> V_73 + ( V_54 -> V_22 - V_56 ) ;
V_10 -> V_74 = V_54 -> V_59 ;
V_10 -> V_75 = F_23 ;
F_50 ( V_10 , V_51 , V_52 ) ;
F_11 ( V_10 , V_11 , V_12 ) ;
if ( V_51 == V_64 ) {
V_61 = F_47 ( V_47 , V_63 , V_56 ) ;
V_10 -> V_49 . V_76 = V_61 << V_71 ;
V_56 -= V_61 ;
} else if ( V_51 == V_67 ) {
V_26 -> V_38 ( V_26 , & V_27 , & V_29 , & V_30 ) ;
F_51 ( V_10 , V_27 , V_60 , V_30 ) ;
V_61 = F_47 ( V_47 , V_63 , V_56 ) ;
V_10 -> V_49 . V_76 = V_61 << V_71 ;
V_30 = 0 ;
V_56 -= V_61 ;
...
V_26 -> V_38 ( V_26 , & V_27 , & V_29 , & V_30 ) ;
V_29 = F_52 ( V_29 , F_53 ( V_56 ) ) ;
if ( ! F_51 ( V_10 , V_27 , V_29 , V_30 ) )
break;
V_30 = 0 ;
V_56 -= F_54 ( V_29 ) ;
V_26 -> V_39 ( V_26 ) ;
...
static void F_57 ( int V_51 , int V_52 , unsigned int V_77 ,
struct V_53 * V_54 , struct V_25 * V_26 ,
struct V_11 * V_11 , int V_78 )
{
int V_79 ;
struct V_25 V_80 = * V_26 ;
F_58 ( V_77 > V_13 ) ;
if ( V_78 )
V_52 |= V_81 ;
for ( V_79 = 0 ; V_79 < V_77 ; V_79 ++ ) {
* V_26 = V_80 ;
if ( V_54 [ V_79 ] . V_22 || ( V_52 & V_82 ) )
F_44 ( V_51 , V_52 , V_79 , V_54 + V_79 , V_26 , V_11 ) ;
}
F_20 ( V_11 , 0 , 0 ) ;
}
static void F_59 ( unsigned long error , void * V_19 )
{
struct V_83 * V_84 = V_19 ;
V_84 -> V_16 = error ;
F_60 ( & V_84 -> V_85 ) ;
}
static int V_83 ( struct V_1 * V_2 , unsigned int V_77 ,
...
V_11 -> V_21 = V_26 -> V_21 ;
V_11 -> V_20 = V_26 -> V_20 ;
F_57 ( V_51 , V_52 , V_77 , V_54 , V_26 , V_11 , 1 ) ;
F_66 ( & V_84 . V_85 ) ;
if ( V_16 )
* V_16 = V_84 . V_16 ;
return V_84 . V_16 ? - V_86 : 0 ;
}
static int F_67 ( struct V_1 * V_2 , unsigned int V_77 ,
struct V_53 * V_54 , int V_51 , int V_52 ,
...
V_11 -> V_21 = V_26 -> V_21 ;
V_11 -> V_20 = V_26 -> V_20 ;
F_57 ( V_51 , V_52 , V_77 , V_54 , V_26 , V_11 , 0 ) ;
return 0 ;
}
static int F_68 ( struct V_87 * V_88 , struct V_25 * V_26 ,
unsigned long V_89 )
{
V_26 -> V_21 = NULL ;
V_26 -> V_20 = 0 ;
...
break;
case V_93 :
F_34 ( V_26 , V_88 -> V_90 . V_92 . V_10 ) ;
break;
case V_94 :
F_69 ( V_88 -> V_90 . V_92 . V_95 , V_89 ) ;
if ( V_88 -> V_96 == V_97 ) {
V_26 -> V_21 = V_88 -> V_90 . V_92 . V_95 ;
V_26 -> V_20 = V_89 ;
}
F_38 ( V_26 , V_88 -> V_90 . V_92 . V_95 ) ;
break;
case V_98 :
F_43 ( V_26 , V_88 -> V_90 . V_92 . V_99 ) ;
break;
default:
return - V_100 ;
}
...
int F_70 ( struct V_87 * V_88 , unsigned V_77 ,
struct V_53 * V_54 , unsigned long * V_101 )
{
int V_102 ;
struct V_25 V_26 ;
V_102 = F_68 ( V_88 , & V_26 , ( unsigned long ) V_54 -> V_22 << V_71 ) ;
if ( V_102 )
return V_102 ;
if ( ! V_88 -> V_103 . V_17 )
return V_83 ( V_88 -> V_2 , V_77 , V_54 ,
V_88 -> V_96 , V_88 -> V_104 , & V_26 ,
V_101 ) ;
return F_67 ( V_88 -> V_2 , V_77 , V_54 , V_88 -> V_96 ,
V_88 -> V_104 , & V_26 , V_88 -> V_103 . V_17 ,
V_88 -> V_103 . V_19 ) ;
}
int T_2 F_71 ( void )
{
