...
static struct V_492 * F_336 ( struct V_51 * V_40 ,
struct V_492 * V_38 )
{
struct V_1 * V_2 = F_30 ( V_40 ) ;
unsigned int V_493 ;
...
int V_60 ;
F_251 ( V_2 ) ;
V_38 -> V_494 = V_2 -> V_38 . V_312 - V_2 -> V_38 . V_313 ;
for ( V_60 = 0 ; V_60 < V_2 -> V_205 ; V_60 ++ ) {
V_37 = V_2 -> V_103 [ V_60 ] ;
do {
V_493 = F_337 ( & V_37 -> V_69 ) ;
V_70 = V_37 -> V_38 . V_70 ;
V_39 = V_37 -> V_38 . V_39 ;
} while ( F_338 ( & V_37 -> V_69 , V_493 ) );
V_38 -> V_495 += V_70 ;
V_38 -> V_496 += V_39 ;
}
for ( V_60 = 0 ; V_60 < V_2 -> V_207 ; V_60 ++ ) {
...
static int F_342 ( struct V_359 * V_13 , const struct V_513 * V_514 )
{
struct V_51 * V_40 ;
struct V_1 * V_2 = NULL ;
...
F_340 ( V_40 ) ;
memcpy ( & V_10 -> V_194 . V_267 , V_516 -> V_530 , sizeof( V_10 -> V_194 . V_267 ) ) ;
V_10 -> V_194 . type = V_516 -> V_194 ;
memcpy ( & V_10 -> V_296 . V_267 , & V_531 ,
sizeof( struct V_532 ) ) ;
V_212 = F_246 ( V_2 ) ;
if ( V_212 )
goto V_533;
...
break;
default:
if ( V_2 -> V_10 . V_194 . type != V_550 )
V_40 -> V_548 = V_549 -
( V_270 + V_271 ) ;
else
V_40 -> V_548 = V_551 + V_271 ;
break;
}
if ( F_14 ( V_10 -> V_12 ) ) {
V_212 = - V_275 ;
