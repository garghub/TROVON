...
if ( V_4 -> V_304 ) {
V_4 -> V_304 -> V_310 = V_4 -> V_310 ;
V_247 = F_116 ( V_4 -> V_310 -> V_57 , V_4 -> V_304 ) ;
if ( V_247 ) {
F_55 ( V_8 -> V_57 ,
L_19 , V_247 ) ;
return V_247 ;
...
struct V_1 * V_8 = F_1 ( V_4 ) ;
F_23 ( V_8 -> V_57 , L_20 ,
V_305 -> V_323 , V_305 -> V_302 ) ;
F_23 ( V_8 -> V_57 , L_21 ,
V_305 -> V_324 , V_305 -> V_325 ,
V_305 -> V_326 ) ;
F_23 ( V_8 -> V_57 , L_22 ,
V_305 -> V_327 , V_305 -> V_91 ) ;
F_23 ( V_8 -> V_57 , L_23 ,
V_305 -> V_328 , V_305 -> V_329 ,
V_305 -> V_330 ) ;
F_23 ( V_8 -> V_57 , L_24 ,
V_305 -> V_331 , V_305 -> V_89 ) ;
...
struct V_333 * V_334 )
{
struct V_312 * V_57 = & V_334 -> V_57 ;
struct V_289 * V_290 = V_57 -> V_335 ;
struct V_289 * V_336 , * V_337 , * V_338 , * V_339 , * V_340 ;
struct V_333 * V_341 ;
struct V_342 * V_342 ;
struct V_343 * V_344 ;
int V_247 ;
...
V_8 -> V_296 = & V_341 -> V_57 ;
V_342 = F_127 ( V_290 , L_31 ) ;
...
V_8 -> V_25 = V_342 ;
V_344 = F_129 ( V_334 , V_348 , 0 ) ;
V_8 -> V_10 = F_130 ( V_57 , V_344 ) ;
if ( F_86 ( V_8 -> V_10 ) )
...
static int F_139 ( struct V_312 * V_57 , void * V_349 ,
struct V_350 * V_351 ,
struct V_352 * V_353 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
struct V_281 V_354 ;
unsigned int V_355 = V_353 -> V_356 . V_279 ;
F_23 ( V_8 -> V_57 , L_42 , V_191 ,
V_353 -> V_190 , V_353 -> V_357 , V_355 ) ;
if ( ! V_8 -> V_4 . V_310 )
return - V_301 ;
switch ( V_355 ) {
case 2 :
...
memcpy ( & V_354 . V_261 , V_353 ,
sizeof( V_354 . V_261 ) ) ;
F_80 ( V_8 , & V_354 ) ;
return 0 ;
}
static int F_140 ( struct V_312 * V_57 , void * V_349 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
...
static void F_141 ( struct V_312 * V_57 , void * V_349 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_46 , V_191 ) ;
F_79 ( V_8 ) ;
...
static int
F_142 ( struct V_312 * V_57 , void * V_349 , bool V_21 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
...
static int F_143 ( struct V_312 * V_57 , void * V_349 , T_5 * V_360 , T_6 V_46 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_46 , V_191 ) ;
memcpy ( V_360 , V_8 -> V_7 . V_361 , F_144 ( sizeof( V_8 -> V_7 . V_361 ) , V_46 ) ) ;
return 0 ;
}
...
static int F_148 ( struct V_333 * V_334 )
{
struct V_1 * V_8 ;
struct V_312 * V_57 = & V_334 -> V_57 ;
int V_247 ;
V_8 = F_149 ( V_57 , sizeof( * V_8 ) , V_370 ) ;
if ( ! V_8 )
return - V_371 ;
V_8 -> V_57 = V_57 ;
V_247 = F_124 ( V_8 , V_334 ) ;
if ( V_247 )
return V_247 ;
...
F_145 ( V_57 ) ;
V_8 -> V_4 . V_372 = & V_373 ;
V_8 -> V_4 . V_335 = V_334 -> V_57 . V_335 ;
V_247 = F_152 ( & V_8 -> V_4 ) ;
if ( V_247 ) {
...
static int F_154 ( struct V_333 * V_334 )
{
struct V_1 * V_8 = F_155 ( V_334 ) ;
F_153 ( & V_8 -> V_4 ) ;
F_91 ( V_8 ) ;
return 0 ;
}
...
int V_247 ;
int V_49 ;
for ( V_49 = 0 ; V_49 < F_46 ( V_375 ) ; V_49 ++ ) {
V_247 = F_159 ( V_375 [ V_49 ] ) ;
if ( V_247 < 0 ) {
F_160 ( L_58 ,
V_375 [ V_49 ] -> V_376 . V_323 , V_247 ) ;
goto V_269;
}
}
return 0 ;
...
{
int V_49 ;
for ( V_49 = F_46 ( V_375 ) - 1 ; V_49 >= 0 ; V_49 -- )
F_161 ( V_375 [ V_49 ] ) ;
}
