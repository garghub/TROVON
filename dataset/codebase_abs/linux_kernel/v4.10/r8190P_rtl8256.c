...
F_9 ( V_2 , V_20 -> V_35 , V_32 << 16 , 0x1 ) ;
F_9 ( V_2 , V_20 -> V_36 , V_32 , 0x1 ) ;
F_9 ( V_2 , V_20 -> V_37 ,
V_38 , 0x0 ) ;
F_9 ( V_2 , V_20 -> V_37 ,
V_39 , 0x0 ) ;
F_5 ( V_2 , (enum V_14 ) V_5 , 0x0 ,
V_15 , 0xbf ) ;
V_18 = F_10 ( V_2 , V_40 ,
(enum V_14 ) V_5 ) ;
if ( ! V_18 ) {
