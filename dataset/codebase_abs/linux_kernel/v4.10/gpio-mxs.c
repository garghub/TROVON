...
V_14 -> V_39 . V_55 = F_21 ;
V_14 -> V_39 . V_56 = V_57 ;
V_14 -> V_58 . V_59 = F_13 ( V_2 ) + V_32 ;
V_14 -> V_58 . V_43 = F_11 ( V_2 ) + V_31 ;
V_14 -> V_58 . V_60 = F_11 ( V_2 ) + V_32 ;
V_14 = & V_12 -> V_48 [ 1 ] ;
V_14 -> type = V_24 | V_25 ;
V_14 -> V_39 . V_40 = V_49 ;
V_14 -> V_39 . V_50 = V_51 ;
...
V_14 -> V_39 . V_56 = V_57 ;
V_14 -> V_58 . V_59 = F_13 ( V_2 ) + V_32 ;
V_14 -> V_58 . V_43 = F_10 ( V_2 ) + V_31 ;
V_14 -> V_58 . V_60 = F_10 ( V_2 ) + V_32 ;
V_14 -> V_61 = V_46 ;
F_26 ( V_12 , F_27 ( 32 ) , V_62 ,
V_63 , 0 ) ;
return 0 ;
}
static int F_28 ( struct V_64 * V_12 , unsigned V_65 )
{
struct V_1 * V_2 = F_29 ( V_12 ) ;
return F_20 ( V_2 -> V_42 , V_65 ) ;
}
static int F_30 ( struct V_64 * V_12 , unsigned V_65 )
{
struct V_1 * V_2 = F_29 ( V_12 ) ;
T_1 V_66 = 1 << V_65 ;
T_1 V_67 ;
V_67 = F_15 ( V_2 -> V_21 + F_31 ( V_2 ) ) ;
return ! ( V_67 & V_66 ) ;
}
...
F_33 ( V_72 , & V_69 -> V_73 ) ;
struct V_74 * V_75 = V_69 -> V_73 . V_76 ;
struct V_74 * V_77 ;
static void T_2 * V_21 ;
struct V_1 * V_2 ;
int V_45 ;
int V_78 ;
V_2 = F_34 ( & V_69 -> V_73 , sizeof( * V_2 ) , V_79 ) ;
if ( ! V_2 )
return - V_47 ;
V_2 -> V_80 = F_35 ( V_75 , L_2 ) ;
if ( V_2 -> V_80 < 0 )
return V_2 -> V_80 ;
V_2 -> V_3 = (enum V_81 ) V_71 -> V_82 ;
V_2 -> V_44 = F_36 ( V_69 , 0 ) ;
if ( V_2 -> V_44 < 0 )
return V_2 -> V_44 ;
if ( ! V_21 ) {
V_77 = F_37 ( V_75 ) ;
...
V_45 = F_40 ( - 1 , 0 , 32 , F_41 () ) ;
if ( V_45 < 0 ) {
V_78 = V_45 ;
goto V_84;
}
V_2 -> V_42 = F_42 ( V_75 , 32 , V_45 , 0 ,
& V_85 , NULL ) ;
if ( ! V_2 -> V_42 ) {
V_78 = - V_86 ;
goto V_87;
...
F_43 ( V_2 -> V_44 , F_16 ,
V_2 ) ;
V_78 = F_44 ( & V_2 -> V_12 , & V_69 -> V_73 , 4 ,
V_2 -> V_21 + F_45 ( V_2 ) ,
...
V_2 -> V_12 . V_89 = F_28 ;
V_2 -> V_12 . V_90 = F_30 ;
V_2 -> V_12 . V_21 = V_2 -> V_80 * 32 ;
V_78 = F_47 ( & V_2 -> V_12 , V_2 ) ;
if ( V_78 )
goto V_88;
return 0 ;
V_88:
