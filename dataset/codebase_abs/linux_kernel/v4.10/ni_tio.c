...
if ( V_77 )
return;
V_77 = F_9 ( V_13 , V_44 , & V_76 ) ;
if ( V_77 )
return;
if ( V_78 || ( V_76 && V_76 < V_74 ) )
V_41 = V_35 ;
...
unsigned int V_87 ;
unsigned int V_88 = 0 ;
static const unsigned int V_89 =
V_90 | V_91 |
V_92 | V_93 |
V_94 | V_95 |
V_96 | V_97 ;
...
if ( F_34 ( V_11 ) ) {
unsigned int V_41 = 0 ;
V_41 |= F_35 ( V_75 >> V_106 ) ;
V_41 |= F_36 ( ( V_75 >> V_107 ) ) ;
if ( V_75 & V_108 )
V_41 |= V_109 ;
F_14 ( V_13 , F_17 ( V_20 ) ,
V_81 | V_110 |
...
int F_39 ( struct V_12 * V_13 , bool V_117 , unsigned int V_118 )
{
struct V_10 * V_11 = V_13 -> V_11 ;
unsigned int V_20 = V_13 -> V_21 ;
...
case V_4 :
default:
V_77 = F_66 ( V_163 , V_139 ) ;
break;
case V_6 :
V_77 = F_63 ( V_163 , V_139 ) ;
break;
}
if ( V_77 )
return V_77 ;
...
case V_4 :
default:
V_77 = F_72 ( V_163 , V_139 ) ;
break;
case V_6 :
V_77 = F_69 ( V_163 , V_139 ) ;
break;
}
if ( V_77 )
return V_77 ;
...
switch ( V_200 [ 0 ] ) {
case V_203 :
V_77 = F_32 ( V_13 , V_200 [ 1 ] ) ;
break;
case V_204 :
V_77 = F_39 ( V_13 , true , V_200 [ 1 ] ) ;
break;
case V_205 :
V_77 = F_39 ( V_13 , false , 0 ) ;
break;
case V_206 :
V_200 [ 1 ] = 0 ;
...
break;
case V_209 :
V_77 = F_45 ( V_13 , V_200 [ 1 ] , V_200 [ 2 ] ) ;
break;
case V_210 :
V_77 = F_47 ( V_13 , & V_200 [ 1 ] , & V_200 [ 2 ] ) ;
break;
case V_211 :
V_77 = F_60 ( V_13 , V_200 [ 1 ] , V_200 [ 2 ] ) ;
break;
case V_212 :
V_77 = F_73 ( V_13 , V_200 [ 1 ] , & V_200 [ 2 ] ) ;
break;
case V_213 :
V_77 = F_61 ( V_13 , V_200 [ 1 ] , V_200 [ 2 ] ) ;
break;
case V_214 :
F_6 ( V_13 ) ;
break;
