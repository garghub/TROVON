...
int V_206 ;
V_240 -> V_241 = 8 ;
V_240 -> V_242 = V_240 -> V_242 ? : V_243 ;
V_240 -> V_244 = V_240 -> V_244 ? : 15000000 ;
V_206 = F_104 ( V_240 ) ;
if ( V_206 )
return V_206 ;
if ( V_240 -> V_8 . V_245 ) {
const struct V_246 * V_247 =
F_105 ( V_248 , & V_240 -> V_8 ) ;
if ( ! V_247 )
return - V_249 ;
V_95 = (struct V_200 * ) V_247 -> V_250 ;
} else {
const struct V_251 * V_252 = F_106 ( V_240 ) ;
V_95 = (struct V_200 * ) V_252 -> V_253 ;
V_103 = V_254 ;
}
V_255 . V_256 = ( 0xf << V_11 ) |
( V_95 -> V_96 - 1 ) ;
V_10 = F_107 ( V_240 , & V_255 ) ;
return F_79 ( & V_240 -> V_8 , V_95 , V_10 , V_240 -> V_97 , V_103 ) ;
}
static int F_108 ( struct V_239 * V_240 )
{
return F_102 ( & V_240 -> V_8 ) ;
}
static int F_109 ( struct V_257 * V_258 ,
...
if ( V_258 -> V_8 . V_245 ) {
const struct V_246 * V_247 =
F_105 ( V_248 , & V_258 -> V_8 ) ;
if ( ! V_247 )
return - V_249 ;
V_95 = (struct V_200 * ) V_247 -> V_250 ;
} else {
V_95 = (struct V_200 * ) V_260 -> V_253 ;
V_103 = V_254 ;
}
V_255 . V_256 = ( 0xf << V_11 ) |
( V_95 -> V_96 - 1 ) ;
V_10 = F_110 ( V_258 , & V_255 ) ;
return F_79 ( & V_258 -> V_8 , V_95 , V_10 , V_258 -> V_97 , V_103 ) ;
}
static int F_111 ( struct V_257 * V_261 )
{
return F_102 ( & V_261 -> V_8 ) ;
}
