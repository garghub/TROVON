...
0UL , ( void * ) V_67 ) ;
return F_42 ( & V_5 . V_6 , V_8 , V_9 , V_37 , 0 ) ;
}
...
int V_68 , V_69 ;
int V_15 , V_27 ;
V_27 = F_47 ( type , V_8 , V_9 , & V_68 , & V_69 ) ;
if ( V_27 )
return V_27 ;
...
( unsigned long long ) V_8 + V_9 - 1 ,
0UL , ( void * ) V_67 ) ;
return F_42 ( & V_5 . V_7 , V_8 , V_9 , V_37 , 0 ) ;
}
...
if ( V_70 )
F_52 ( & type -> V_17 [ V_15 ] , V_71 ) ;
else
F_53 ( & type -> V_17 [ V_15 ] , V_71 ) ;
F_39 ( type ) ;
return 0 ;
}
int T_2 F_54 ( T_3 V_8 , T_3 V_9 )
{
return F_51 ( V_8 , V_9 , 1 , V_72 ) ;
}
int T_2 F_55 ( T_3 V_8 , T_3 V_9 )
{
return F_51 ( V_8 , V_9 , 0 , V_72 ) ;
}
...
{
return F_51 ( V_8 , V_9 , 1 , V_73 ) ;
}
void T_2 F_58 ( T_4 * V_58 ,
T_3 * V_74 ,
T_3 * V_75 )
{
...
void T_2 F_59 ( T_4 * V_58 , int V_21 , T_1 V_22 ,
struct V_4 * V_76 ,
struct V_4 * V_77 ,
T_3 * V_74 ,
T_3 * V_75 , int * V_78 )
...
if ( F_60 () && F_61 ( V_81 ) )
continue;
if ( ( V_22 & V_2 ) && ! F_62 ( V_81 ) )
continue;
if ( ! ( V_22 & V_73 ) && F_63 ( V_81 ) )
continue;
if ( ! V_77 ) {
if ( V_74 )
* V_74 = V_82 ;
...
void T_2 F_64 ( T_4 * V_58 , int V_21 , T_1 V_22 ,
struct V_4 * V_76 ,
struct V_4 * V_77 ,
T_3 * V_74 ,
T_3 * V_75 , int * V_78 )
...
void T_2 F_65 ( int * V_58 , int V_21 ,
unsigned long * V_88 ,
...
V_35 = & type -> V_17 [ * V_58 ] ;
if ( F_66 ( V_35 -> V_8 ) >= F_67 ( V_35 -> V_8 + V_35 -> V_9 ) )
continue;
...
* V_88 = F_66 ( V_35 -> V_8 ) ;
if ( V_89 )
* V_89 = F_67 ( V_35 -> V_8 + V_35 -> V_9 ) ;
if ( V_78 )
* V_78 = V_35 -> V_21 ;
}
int T_2 F_68 ( T_3 V_8 , T_3 V_9 ,
...
T_3 T_5 F_71 ( T_3 V_9 , T_3 V_20 ,
T_3 V_18 , T_3 V_19 ,
T_1 V_22 )
{
return F_69 ( V_9 , V_20 , V_18 , V_19 , V_34 ,
V_22 ) ;
}
static T_3 T_5 F_72 ( T_3 V_9 ,
T_3 V_20 , T_3 V_92 ,
int V_21 , T_1 V_22 )
{
return F_69 ( V_9 , V_20 , 0 , V_92 , V_21 , V_22 ) ;
}
T_3 T_5 F_73 ( T_3 V_9 , T_3 V_20 , int V_21 )
{
T_1 V_22 = F_1 () ;
T_3 V_27 ;
V_33:
V_27 = F_72 ( V_9 , V_20 , V_28 ,
V_21 , V_22 ) ;
if ( ! V_27 && ( V_22 & V_2 ) ) {
V_22 &= ~ V_2 ;
goto V_33;
...
T_3 T_5 F_74 ( T_3 V_9 , T_3 V_20 , T_3 V_92 )
{
return F_72 ( V_9 , V_20 , V_92 , V_34 ,
V_3 ) ;
}
T_3 T_5 F_75 ( T_3 V_9 , T_3 V_20 , T_3 V_92 )
{
T_3 V_93 ;
V_93 = F_74 ( V_9 , V_20 , V_92 ) ;
if ( V_93 == 0 )
F_76 ( L_12 ,
( unsigned long long ) V_9 , ( unsigned long long ) V_92 ) ;
return V_93 ;
}
T_3 T_5 F_77 ( T_3 V_9 , T_3 V_20 )
{
return F_75 ( V_9 , V_20 , V_28 ) ;
}
T_3 T_5 F_78 ( T_3 V_9 , T_3 V_20 , int V_21 )
{
T_3 V_94 = F_73 ( V_9 , V_20 , V_21 ) ;
if ( V_94 )
return V_94 ;
return F_75 ( V_9 , V_20 , V_28 ) ;
}
static void * T_5 F_79 (
T_3 V_9 , T_3 V_20 ,
T_3 V_95 , T_3 V_92 ,
int V_21 )
{
...
static T_3 T_2 F_100 ( T_3 V_106 )
{
T_3 V_92 = ( T_3 ) V_10 ;
struct V_40 * V_35 ;
F_93 (memory, r) {
...
if ( V_92 == ( T_3 ) V_10 )
return;
V_27 = F_47 ( type , V_92 , ( T_3 ) V_10 ,
& V_68 , & V_69 ) ;
if ( V_27 )
return;
for ( V_15 = V_69 - 1 ; V_15 >= V_68 ; V_15 -- ) {
if ( ! F_63 ( & type -> V_17 [ V_15 ] ) )
F_22 ( type , V_15 ) ;
}
F_48 ( & V_5 . V_7 , V_92 ,
( T_3 ) V_10 ) ;
}
static int T_2 F_103 ( struct V_4 * type , T_3 V_38 )
{
...
bool T_5 F_104 ( T_3 V_38 )
{
return F_103 ( & V_5 . V_7 , V_38 ) != - 1 ;
}
bool T_2 F_105 ( T_3 V_38 )
{
return F_103 ( & V_5 . V_6 , V_38 ) != - 1 ;
}
int T_2 F_106 ( T_3 V_38 )
{
int V_15 = F_103 ( & V_5 . V_6 , V_38 ) ;
if ( V_15 == - 1 )
return false ;
return ! F_63 ( & V_5 . V_6 . V_17 [ V_15 ] ) ;
}
int T_2 F_107 ( unsigned long V_110 ,
unsigned long * V_104 , unsigned long * V_105 )
{
struct V_4 * type = & V_5 . V_6 ;
int V_109 = F_103 ( type , F_97 ( V_110 ) ) ;
if ( V_109 == - 1 )
return - 1 ;
* V_104 = F_67 ( type -> V_17 [ V_109 ] . V_8 ) ;
* V_105 = F_67 ( type -> V_17 [ V_109 ] . V_8 + type -> V_17 [ V_109 ] . V_9 ) ;
return type -> V_17 [ V_109 ] . V_21 ;
}
int T_2 F_108 ( T_3 V_8 , T_3 V_9 )
{
int V_58 = F_103 ( & V_5 . V_6 , V_8 ) ;
T_3 V_19 = V_8 + F_3 ( V_8 , & V_9 ) ;
if ( V_58 == - 1 )
return 0 ;
...
bool T_2 F_109 ( T_3 V_8 , T_3 V_9 )
{
F_3 ( V_8 , & V_9 ) ;
return F_6 ( & V_5 . V_7 , V_8 , V_9 ) ;
}
void T_2 F_110 ( T_3 V_20 )
{
...
static void T_2 F_113 ( struct V_4 * type , char * V_113 )
{
unsigned long long V_8 , V_9 ;
unsigned long V_22 ;
int V_58 ;
struct V_40 * V_59 ;
F_114 ( L_16 , V_113 , type -> V_16 ) ;
F_43 (type, rgn) {
char V_114 [ 32 ] = L_17 ;
V_8 = V_59 -> V_8 ;
V_9 = V_59 -> V_9 ;
...
static int T_5 F_117 ( char * V_115 )
{
if ( V_115 && strstr ( V_115 , L_22 ) )
V_116 = 1 ;
return 0 ;
}
static int F_118 ( struct V_117 * V_81 , void * V_118 )
{
...
static int F_120 ( struct V_120 * V_120 , struct V_121 * V_121 )
{
return F_121 ( V_121 , F_118 , V_120 -> V_122 ) ;
}
static int T_5 F_122 ( void )
{
struct V_123 * V_124 = F_123 ( L_26 , NULL ) ;
if ( ! V_124 )
return - V_125 ;
F_124 ( L_1 , V_126 , V_124 , & V_5 . V_6 , & V_127 ) ;
F_124 ( L_2 , V_126 , V_124 , & V_5 . V_7 , & V_127 ) ;
#ifdef F_125
F_124 ( L_27 , V_126 , V_124 , & V_5 . V_128 , & V_127 ) ;
#endif
return 0 ;
}
