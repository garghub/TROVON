...
int V_30 ;
F_9 ( V_2 ) ;
V_30 = F_24 ( V_6 , V_45 , V_46 ) ;
F_11 ( V_2 ) ;
return V_30 ;
}
static int F_25 ( struct V_5 * V_47 ,
T_2 V_48 )
{
...
static int F_34 ( struct V_5 * V_6 , int V_45 )
{
return 0 ;
}
static
T_3 F_35 ( struct V_5 * V_6 )
{
unsigned long V_53 ;
T_3 V_55 ;
struct V_1 * V_2 = F_7 ( V_6 ) ;
...
static struct V_56 * F_36 ( struct V_5 * V_47 ,
unsigned long V_57 )
{
...
V_60 -> V_66 = 0 ;
V_60 -> V_43 = V_2 ;
F_43 ( V_60 -> V_67 , V_25 -> V_68 , sizeof( V_60 -> V_67 ) ) ;
return 0 ;
V_63:
return V_30 ;
}
