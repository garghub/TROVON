...
default:
F_76 ( L_3 ,
F_30 ( & V_2 -> V_38 ) , V_37 , V_224 , V_225 ) ;
}
return 0 ;
}
...
if ( ! V_182 ) {
F_29 ( L_6 ,
V_37 , F_30 ( & V_2 -> V_38 ) , V_224 , V_225 ) ;
if ( V_257 ) {
...
if ( V_2 -> V_36 ) {
* ( V_32 * ) & V_16 [ V_75 ] = F_26 ( V_2 -> V_271 ) ;
* ( V_32 * ) & V_16 [ V_78 ] = F_26 ( V_2 -> V_272 ) ;
}
