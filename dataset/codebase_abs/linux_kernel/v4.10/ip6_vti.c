...
F_83 ( V_45 , V_7 , V_123 , 0 , 0 , F_82 ( V_7 , NULL ) ) ;
F_84 ( V_60 ) ;
return 0 ;
}
...
static void
F_92 ( struct V_22 * V_23 , const struct V_148 * V_149 )
{
...
memcpy ( V_23 -> V_36 , V_149 -> V_36 , sizeof( V_149 -> V_36 ) ) ;
}
static void
F_93 ( struct V_148 * V_149 , const struct V_22 * V_23 )
{
...
memcpy ( V_149 -> V_36 , V_23 -> V_36 , sizeof( V_149 -> V_36 ) ) ;
}
static int
F_94 ( struct V_30 * V_18 , struct V_150 * V_151 , int V_152 )
{
int V_32 = 0 ;
struct V_148 V_23 ;
struct V_22 V_153 ;
...
case V_154 :
if ( V_18 == V_12 -> V_43 ) {
if ( F_95 ( & V_23 , V_151 -> V_155 . V_156 , sizeof( V_23 ) ) ) {
V_32 = - V_157 ;
break;
}
F_92 ( & V_153 , & V_23 ) ;
...
V_10 = F_19 ( V_18 ) ;
F_93 ( & V_23 , & V_10 -> V_15 ) ;
if ( F_96 ( V_151 -> V_155 . V_156 , & V_23 , sizeof( V_23 ) ) )
V_32 = - V_157 ;
break;
case V_158 :
case V_159 :
V_32 = - V_75 ;
if ( ! F_97 ( V_7 -> V_160 , V_161 ) )
break;
V_32 = - V_157 ;
if ( F_95 ( & V_23 , V_151 -> V_155 . V_156 , sizeof( V_23 ) ) )
break;
...
V_18 -> V_168 = F_15 ;
V_18 -> type = V_169 ;
V_18 -> V_170 = V_171 + sizeof( struct V_46 ) ;
V_18 -> V_92 = V_172 ;
V_18 -> V_173 = V_174 ;
V_18 -> V_175 = V_176 ;
V_18 -> V_19 |= V_177 ;
V_18 -> V_178 = sizeof( struct V_1 ) ;
F_99 ( V_18 ) ;
}
...
static int F_104 ( struct V_180 * V_181 [] , struct V_180 * V_132 [] )
{
return 0 ;
}
static void F_105 ( struct V_180 * V_132 [] ,
struct V_22 * V_15 )
{
...
return;
if ( V_132 [ V_182 ] )
V_15 -> V_146 = F_106 ( V_132 [ V_182 ] ) ;
if ( V_132 [ V_183 ] )
V_15 -> V_16 = F_107 ( V_132 [ V_183 ] ) ;
if ( V_132 [ V_184 ] )
V_15 -> V_17 = F_107 ( V_132 [ V_184 ] ) ;
if ( V_132 [ V_185 ] )
V_15 -> V_74 = F_108 ( V_132 [ V_185 ] ) ;
if ( V_132 [ V_186 ] )
V_15 -> V_116 = F_108 ( V_132 [ V_186 ] ) ;
}
static int F_109 ( struct V_7 * V_187 , struct V_30 * V_18 ,
struct V_180 * V_181 [] , struct V_180 * V_132 [] )
{
struct V_7 * V_7 = F_20 ( V_18 ) ;
struct V_6 * V_188 ;
V_188 = F_19 ( V_18 ) ;
F_105 ( V_132 , & V_188 -> V_15 ) ;
V_188 -> V_15 . V_50 = V_51 ;
if ( F_27 ( V_7 , & V_188 -> V_15 , 0 ) )
return - V_162 ;
return F_18 ( V_18 ) ;
}
static void F_110 ( struct V_30 * V_18 , struct V_189 * V_190 )
{
struct V_7 * V_7 = F_20 ( V_18 ) ;
struct V_11 * V_12 = F_5 ( V_7 , V_13 ) ;
if ( V_18 != V_12 -> V_43 )
...
static int F_112 ( struct V_30 * V_18 , struct V_180 * V_181 [] ,
struct V_180 * V_132 [] )
{
struct V_6 * V_10 ;
struct V_22 V_23 ;
...
struct V_22 * V_191 = & V_63 -> V_15 ;
if ( F_116 ( V_45 , V_182 , V_191 -> V_146 ) ||
F_117 ( V_45 , V_183 , & V_191 -> V_16 ) ||
F_117 ( V_45 , V_184 , & V_191 -> V_17 ) ||
F_118 ( V_45 , V_185 , V_191 -> V_74 ) ||
F_118 ( V_45 , V_186 , V_191 -> V_116 ) )
goto V_192;
return 0 ;
V_192:
return - V_105 ;
...
V_10 = F_13 ( V_12 -> V_195 [ V_24 ] ) ;
while ( V_10 ) {
F_111 ( V_10 -> V_18 , & V_193 ) ;
V_10 = F_13 ( V_10 -> V_28 ) ;
}
}
...
{
return V_18 -> V_166 == & V_167 ;
}
static int F_128 ( struct V_198 * V_199 ,
unsigned long V_200 , void * V_201 )
{
struct V_30 * V_18 = F_129 ( V_201 ) ;
struct V_6 * V_10 = F_19 ( V_18 ) ;
if ( ! F_127 ( V_18 ) )
return V_202 ;
switch ( V_200 ) {
...
goto V_207;
V_204 = L_5 ;
V_32 = F_134 ( & V_208 , V_134 ) ;
if ( V_32 < 0 )
goto V_209;
V_32 = F_134 ( & V_210 , V_135 ) ;
if ( V_32 < 0 )
goto V_211;
V_32 = F_134 ( & V_212 , V_136 ) ;
if ( V_32 < 0 )
goto V_213;
V_204 = L_6 ;
V_32 = F_135 ( & V_34 ) ;
