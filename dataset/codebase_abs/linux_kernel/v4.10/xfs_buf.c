...
struct V_1 * V_2 ;
* V_119 = NULL ;
V_2 = F_89 ( V_30 , V_118 , V_33 ) ;
if ( ! V_2 )
return - V_28 ;
ASSERT ( V_2 -> V_24 == 1 ) ;
V_2 -> V_42 = V_111 ;
V_2 -> V_23 [ 0 ] . V_43 = V_117 ;
V_2 -> V_7 |= V_108 ;
V_2 -> V_106 = V_113 ;
F_83 ( V_2 ) ;
if ( V_2 -> V_120 ) {
...
T_4 V_126 ;
int V_52 ;
V_125 = ( unsigned long ) V_122 & V_66 ;
V_61 = ( unsigned long ) V_122 - V_125 ;
V_126 = F_95 ( V_123 + V_61 ) ;
V_52 = V_126 >> V_67 ;
if ( V_2 -> V_53 )
F_33 ( V_2 ) ;
V_2 -> V_53 = NULL ;
...
int error , V_34 ;
struct V_1 * V_2 ;
F_97 ( V_31 , V_111 , V_118 ) ;
V_2 = F_19 ( V_30 , & V_31 , 1 , V_33 & V_8 ) ;
if ( F_21 ( V_2 == NULL ) )
goto V_127;
V_52 = F_95 ( V_118 << V_128 ) >> V_67 ;
error = F_31 ( V_2 , V_52 ) ;
if ( error )
goto V_129;
...
V_131 = F_103 ( & V_2 -> V_21 , & V_87 -> V_88 ) ;
F_9 ( & V_2 -> V_15 ) ;
if ( ! V_131 ) {
...
struct V_1 * V_2 )
{
bool V_138 = V_2 -> V_7 & V_108 ;
F_124 ( V_2 , V_51 ) ;
V_2 -> V_7 &= ~ ( V_108 | V_110 | V_38 ) ;
if ( ! V_2 -> V_120 && V_2 -> V_139 )
F_79 ( V_2 , V_2 -> V_139 ) ;
if ( V_138 && ! V_2 -> V_120 && V_2 -> V_106 ) {
ASSERT ( ! V_2 -> V_105 ) ;
V_2 -> V_106 -> V_140 ( V_2 ) ;
}
if ( ! V_2 -> V_120 )
...
struct V_1 * V_2 )
{
F_129 ( & V_2 -> V_143 , F_126 ) ;
F_130 ( V_2 -> V_144 , & V_2 -> V_143 ) ;
}
void
F_79 (
T_2 * V_2 ,
...
F_63 ( V_2 -> V_11 -> V_49 ,
L_5 ,
( V_146 ) F_133 ( V_2 ) , V_145 , - V_2 -> V_120 , V_2 -> V_44 ) ;
}
int
F_134 (
struct V_1 * V_2 )
...
if ( V_149 -> V_151 )
F_137 ( & V_2 -> V_139 , 0 , V_149 -> V_151 ) ;
if ( ! V_2 -> V_120 && F_1 ( V_2 ) && ( V_2 -> V_7 & V_108 ) )
F_138 ( V_2 -> V_3 , F_2 ( V_2 ) ) ;
if ( F_102 ( & V_2 -> V_152 ) == 1 )
F_128 ( V_2 ) ;
F_139 ( V_149 ) ;
}
static void
...
V_59 = F_47 ( int , F_41 ( V_2 -> V_23 [ V_31 ] . V_45 ) , * V_154 ) ;
* V_154 -= V_59 ;
* V_153 += V_59 ;
V_161:
F_68 ( & V_2 -> V_152 ) ;
V_159 = F_141 ( V_158 , V_162 ) ;
V_149 = F_142 ( V_163 , V_159 ) ;
V_149 -> V_164 = V_2 -> V_11 -> V_165 ;
V_149 -> V_166 . V_167 = V_160 ;
V_149 -> V_168 = F_136 ;
V_149 -> V_150 = V_2 ;
F_143 ( V_149 , V_155 , V_156 ) ;
for (; V_59 && V_159 ; V_159 -- , V_157 ++ ) {
int V_169 , V_60 = V_5 - V_61 ;
if ( V_60 > V_59 )
V_60 = V_59 ;
V_169 = F_144 ( V_149 , V_2 -> V_53 [ V_157 ] , V_60 ,
V_61 ) ;
if ( V_169 < V_60 )
break;
V_61 = 0 ;
...
F_140 ( V_2 , V_34 , & V_61 , & V_59 , V_155 , V_156 ) ;
if ( V_2 -> V_120 )
break;
if ( V_59 <= 0 )
break;
...
V_91 -> V_95 = V_217 ;
V_91 -> V_96 = V_217 - 1 ;
if ( F_186 ( V_91 -> V_165 , V_217 ) ) {
F_77 ( V_91 -> V_49 ,
L_9 ,
V_217 , V_91 -> V_165 ) ;
return - V_218 ;
}
V_91 -> V_219 = F_187 ( V_91 -> V_165 ) ;
V_91 -> V_220 = F_187 ( V_91 -> V_165 ) - 1 ;
return 0 ;
}
STATIC int
F_188 (
...
V_91 -> V_165 = V_222 ;
V_91 -> V_116 = F_190 ( V_222 ) ;
if ( F_188 ( V_91 , V_222 ) )
goto error;
if ( F_191 ( & V_91 -> V_19 ) )
goto error;
if ( F_192 ( & V_91 -> V_12 , 0 , V_226 ) )
goto error;
...
int V_242 = 0 ;
struct V_172 V_173 ;
F_200 ( NULL , V_238 , F_198 ) ;
F_151 ( & V_173 ) ;
F_201 (bp, n, buffer_list, b_list) {
if ( ! V_239 ) {
if ( F_202 ( V_2 ) ) {
V_242 ++ ;
continue;
