...
struct V_57 * V_57 )
{
static T_4 V_110 = F_50 ( - 1 ) ;
V_6 -> V_110 = F_51 ( & V_110 ) ;
V_6 -> V_29 = V_29 ;
V_6 -> V_57 = V_57 ;
V_6 -> V_111 = 0 ;
V_6 -> V_112 = 0 ;
...
static int F_59 ( struct V_5 * V_6 , int V_127 ,
int V_129 , int V_130 )
{
return - V_128 ;
}
...
static void F_61 ( struct V_5 * V_6 , struct V_131 * V_132 )
{
V_132 -> V_133 ( V_132 , V_6 , V_134 ) ;
}
...
static struct V_136 * F_64 ( struct V_5 * V_6 ,
int type , int V_54 , T_3 V_137 )
{
return F_65 ( - V_128 ) ;
}
static int F_66 ( struct V_136 * V_138 ,
T_7 V_139 , T_5 V_140 , T_5 V_141 )
{
return - V_128 ;
}
static int F_67 ( struct V_136 * V_138 , T_6 * V_142 )
{
return - V_128 ;
}
static int F_68 ( struct V_136 * V_138 , struct V_143 * V_144 ,
struct V_145 * V_146 , unsigned long V_147 )
{
return - V_128 ;
}
static void F_69 ( struct V_136 * V_138 )
{
}
static int F_70 ( struct V_136 * V_138 )
{
return - V_128 ;
}
void F_71 ( struct V_121 * V_121 )
{
