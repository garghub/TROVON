...
static bool F_38 ( const struct V_118 * V_119 , int V_128 )
{
T_2 V_138 = F_18 ( V_51 ) ;
return F_39 ( V_138 ,
V_139 ) < 0 ;
}
static void T_4 F_40 ( const struct V_118 * V_140 )
{
switch ( V_140 -> V_141 ) {
case V_142 :
V_143 |= V_140 -> V_144 ;
...
static bool F_42 ( const struct V_118 * V_140 )
{
bool V_149 ;
switch ( V_140 -> V_141 ) {
case V_142 :
...
static void T_4 F_43 ( const struct V_118 * V_150 )
{
for (; V_150 -> V_151 ; V_150 ++ )
if ( V_150 -> V_151 ( V_150 , V_150 -> V_152 ) )
F_40 ( V_150 ) ;
}
void F_44 ( const struct V_118 * V_153 ,
const char * V_30 )
{
for (; V_153 -> V_151 ; V_153 ++ ) {
if ( ! V_153 -> V_151 ( V_153 , V_153 -> V_152 ) )
continue;
if ( ! F_45 ( V_153 -> V_154 ) && V_153 -> V_127 )
F_46 ( L_4 , V_30 , V_153 -> V_127 ) ;
F_47 ( V_153 -> V_154 ) ;
}
}
void T_4 F_48 ( const struct V_118 * V_153 )
{
for (; V_153 -> V_151 ; V_153 ++ )
if ( V_153 -> V_155 && F_45 ( V_153 -> V_154 ) )
F_49 ( V_153 -> V_155 , NULL , V_156 ) ;
}
...
static void
F_54 ( const struct V_118 * V_153 )
{
for (; V_153 -> V_151 ; V_153 ++ )
if ( F_42 ( V_153 ) && ! V_153 -> V_151 ( V_153 , V_124 ) ) {
F_55 ( L_5 ,
F_56 () , V_153 -> V_127 ) ;
F_57 () ;
}
...
static void
F_58 ( const struct V_118 * V_153 )
{
for (; V_153 -> V_151 ; V_153 ++ ) {
if ( ! F_45 ( V_153 -> V_154 ) )
continue;
if ( ! V_153 -> V_151 ( V_153 , V_124 ) ) {
F_55 ( L_6 ,
F_56 () , V_153 -> V_127 ) ;
F_57 () ;
}
...
bool F_65 ( unsigned int V_140 )
{
const struct V_118 * V_153 ;
if ( F_25 ( F_26 () ) )
return false ;
for ( V_153 = V_158 ; V_153 -> V_127 ; V_153 ++ )
if ( V_153 -> V_154 == V_140 && V_153 -> V_151 )
return V_153 -> V_151 ( V_153 , V_124 ) ;
return false ;
}
void T_4 F_66 ( void )
{
...
static bool T_6
F_70 ( const struct V_118 * V_119 , int V_128 )
{
return ( F_71 ( V_164 ) && ! F_71 ( V_165 ) ) ;
}
