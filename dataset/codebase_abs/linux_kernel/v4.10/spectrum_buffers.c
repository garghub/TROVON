...
T_2 V_92 = F_46 ( V_17 ) ;
enum V_15 V_16 ;
if ( V_17 > F_47 ( V_2 -> V_22 , V_93 ) )
return - V_94 ;
V_16 = (enum V_15 ) V_90 ;
return F_4 ( V_2 , V_3 , V_5 , V_16 , V_92 ) ;
}
static T_2 F_48 ( struct V_2 * V_2 , T_1 V_3 ,
...
static int F_49 ( struct V_2 * V_2 , T_1 V_3 ,
enum V_4 V_5 , T_2 V_97 ,
T_2 * V_98 )
{
struct V_1 * V_20 = F_1 ( V_2 , V_3 , V_5 ) ;
if ( V_20 -> V_16 == V_95 ) {
...
V_3 , V_5 ) ;
* V_103 = F_48 ( V_2 , V_3 , V_5 ,
V_33 -> V_25 ) ;
return 0 ;
}
int F_52 ( struct V_102 * V_102 ,
unsigned int V_85 , T_4 V_84 ,
T_2 V_97 )
{
struct V_43 * V_43 =
...
int F_53 ( struct V_102 * V_102 ,
unsigned int V_85 , T_4 V_104 ,
enum V_89 V_88 ,
T_4 * V_105 , T_2 * V_103 )
{
struct V_43 * V_43 =
...
V_10 , V_5 ) ;
* V_103 = F_48 ( V_2 , V_30 -> V_3 , V_5 ,
V_30 -> V_25 ) ;
* V_105 = F_40 ( V_30 -> V_3 , V_5 ) ;
return 0 ;
}
int F_54 ( struct V_102 * V_102 ,
unsigned int V_85 , T_4 V_104 ,
enum V_89 V_88 ,
T_4 V_84 , T_2 V_97 )
{
...
struct V_8 * V_30 ;
int V_46 ;
memcpy ( & V_109 , & V_39 , sizeof( V_109 ) ) ;
V_110 = 0 ;
for ( V_9 = V_109 . V_112 ;
V_9 < V_113 ; V_9 ++ ) {
if ( ! V_2 -> V_11 [ V_9 ] )
...
V_109 . V_110 = V_110 ;
V_109 . V_112 = V_112 ;
memcpy ( & V_39 , & V_109 , sizeof( V_109 ) ) ;
V_21 = F_13 ( V_37 , F_7 ( V_122 ) , V_106 ,
& V_36 , F_55 ,
V_39 ) ;
if ( V_21 )
goto V_119;
...
struct V_13 * V_33 = F_3 ( V_2 , V_9 ,
V_3 , V_5 ) ;
* V_123 = F_44 ( V_33 -> V_40 . V_41 ) ;
* V_124 = F_44 ( V_33 -> V_40 . V_42 ) ;
return 0 ;
}
int F_69 ( struct V_102 * V_102 ,
unsigned int V_85 , T_4 V_104 ,
enum V_89 V_88 ,
T_2 * V_123 , T_2 * V_124 )
{
...
struct V_8 * V_30 = F_2 ( V_2 , V_9 ,
V_10 , V_5 ) ;
* V_123 = F_44 ( V_30 -> V_40 . V_41 ) ;
* V_124 = F_44 ( V_30 -> V_40 . V_42 ) ;
return 0 ;
}
