...
static T_3 T_1 F_83 ( T_5 V_188 , T_2 V_189 ,
void * V_190 , void * * V_191 )
{
* ( T_5 * ) V_191 = V_188 ;
return V_31 ;
}
static int T_1 F_84 ( const char * V_153 , const char * V_192 ,
T_5 * V_188 )
{
T_3 V_23 ;
T_5 V_193 ;
...
V_133 -> V_153 = L_25 ;
V_133 -> V_195 = L_26 ;
V_133 -> V_56 . V_196 = V_197 ;
V_133 -> V_198 [ 0 ] = F_89 ( V_199 ) ;
F_90 ( V_133 , V_134 , - 16384 , 16384 , 0 , 0 ) ;
F_90 ( V_133 , V_137 , - 16384 , 16384 , 0 , 0 ) ;
F_90 ( V_133 , V_138 , - 16384 , 16384 , 0 , 0 ) ;
V_29 = F_91 ( V_133 ) ;
if ( V_29 )
goto V_200;
return 0 ;
...
V_174 -> V_153 = L_27 ;
V_174 -> V_195 = L_28 ;
V_174 -> V_56 . V_196 = V_197 ;
V_29 = F_96 ( V_174 , V_201 , NULL ) ;
if ( V_29 )
goto V_200;
V_23 = F_97 ( V_164 ,
F_75 , NULL ) ;
...
static int F_102 ( struct V_205 * V_76 )
{
int V_29 ;
if ( F_7 ( V_5 ) ) {
...
static int F_103 ( struct V_205 * V_76 )
{
if ( F_7 ( V_5 ) )
F_42 () ;
if ( F_7 ( V_7 ) )
...
static int F_104 ( struct V_76 * V_113 )
{
T_2 V_28 ;
struct V_209 * V_147 = & V_1 -> V_147 ;
if ( ! V_147 )
return - V_156 ;
if ( F_7 ( V_5 ) ) {
F_36 ( & V_28 , V_5 ) ;
...
static int F_105 ( struct V_76 * V_113 )
{
struct V_209 * V_147 = & V_1 -> V_147 ;
if ( ! V_147 )
return - V_156 ;
...
static void F_106 ( struct V_205 * V_76 )
{
struct V_209 * V_147 = & V_1 -> V_147 ;
if ( ! V_147 )
return;
...
V_1 -> V_210 . V_84 = F_111 ( L_30 , V_212 ,
V_1 -> V_210 . V_211 ,
& V_1 -> V_210 . V_213 ) ;
if ( ! V_1 -> V_210 . V_84 )
goto V_214;
