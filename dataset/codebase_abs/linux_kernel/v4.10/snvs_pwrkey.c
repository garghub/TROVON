...
if ( F_20 ( V_29 , L_3 , & V_3 -> V_12 ) ) {
V_3 -> V_12 = V_34 ;
F_21 ( & V_21 -> V_13 , L_4 ) ;
}
V_3 -> V_35 = F_22 ( V_29 , L_5 ) ;
V_3 -> V_18 = F_23 ( V_21 , 0 ) ;
if ( V_3 -> V_18 < 0 ) {
F_18 ( & V_21 -> V_13 , L_6 ) ;
return - V_36 ;
}
F_24 ( V_3 -> V_7 , V_37 , V_38 , V_38 ) ;
F_11 ( V_3 -> V_7 , V_23 , V_24 ) ;
F_25 ( & V_3 -> V_15 ,
...
V_5 -> V_40 = L_8 ;
V_5 -> V_41 . V_42 = V_43 ;
F_27 ( V_5 , V_11 , V_3 -> V_12 ) ;
error = F_28 ( & V_21 -> V_13 , F_12 , V_3 ) ;
if ( error ) {
F_18 ( & V_21 -> V_13 , L_9 ) ;
return error ;
}
error = F_29 ( & V_21 -> V_13 , V_3 -> V_18 ,
F_8 ,
0 , V_21 -> V_39 , V_21 ) ;
if ( error ) {
F_18 ( & V_21 -> V_13 , L_10 ) ;
...
V_3 -> V_5 = V_5 ;
F_31 ( V_21 , V_3 ) ;
F_32 ( & V_21 -> V_13 , V_3 -> V_35 ) ;
return 0 ;
}
static int T_3 F_33 ( struct V_44 * V_13 )
{
struct V_20 * V_21 = F_34 ( V_13 ) ;
struct V_2 * V_3 = F_9 ( V_21 ) ;
if ( F_35 ( & V_21 -> V_13 ) )
F_36 ( V_3 -> V_18 ) ;
return 0 ;
}
static int T_3 F_37 ( struct V_44 * V_13 )
{
struct V_20 * V_21 = F_34 ( V_13 ) ;
struct V_2 * V_3 = F_9 ( V_21 ) ;
if ( F_35 ( & V_21 -> V_13 ) )
