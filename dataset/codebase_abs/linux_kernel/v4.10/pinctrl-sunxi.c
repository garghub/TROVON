...
static int F_103 ( struct V_155 * V_155 , int V_156 , int * V_157 )
{
unsigned long clock = F_104 ( V_155 ) ;
unsigned int V_158 , V_159 ;
int V_5 ;
V_158 = abs ( V_156 - clock ) ;
V_159 = 0 ;
for ( V_5 = 1 ; V_5 < 8 ; V_5 ++ ) {
int V_160 = abs ( V_156 - ( clock >> V_5 ) ) ;
if ( V_160 < V_158 ) {
V_158 = V_160 ;
V_159 = V_5 ;
}
...
return 0 ;
V_166 = F_107 ( V_3 -> V_58 , L_23 ) ;
if ( F_28 ( V_166 ) )
return F_29 ( V_166 ) ;
V_165 = F_107 ( V_3 -> V_58 , L_24 ) ;
if ( F_28 ( V_165 ) )
return F_29 ( V_165 ) ;
...
const struct V_171 * V_17 )
{
struct V_27 * V_28 = V_152 -> V_58 . V_172 ;
struct V_173 * V_174 ;
struct V_175 * V_21 ;
struct V_2 * V_3 ;
struct V_176 * V_177 ;
...
F_112 ( V_152 , V_3 ) ;
F_113 ( & V_3 -> V_81 ) ;
V_177 = F_114 ( V_152 , V_179 , 0 ) ;
V_3 -> V_77 = F_115 ( & V_152 -> V_58 , V_177 ) ;
if ( F_28 ( V_3 -> V_77 ) )
...
V_174 = F_102 ( & V_152 -> V_58 ,
sizeof( * V_174 ) ,
V_44 ) ;
if ( ! V_174 )
return - V_45 ;
V_174 -> V_9 = F_117 ( & V_152 -> V_58 ) ;
V_174 -> V_180 = V_181 ;
V_174 -> V_21 = V_21 ;
V_174 -> V_18 = V_3 -> V_17 -> V_18 ;
V_174 -> V_182 = & V_183 ;
V_174 -> V_184 = & V_185 ;
V_174 -> V_186 = & V_187 ;
V_3 -> V_94 = F_118 ( & V_152 -> V_58 , V_174 , V_3 ) ;
if ( F_28 ( V_3 -> V_94 ) ) {
...
if ( ! V_3 -> V_89 )
return - V_45 ;
V_178 = V_3 -> V_17 -> V_21 [ V_3 -> V_17 -> V_18 - 1 ] . V_20 . V_23 ;
V_3 -> V_89 -> V_180 = V_181 ;
V_3 -> V_89 -> V_188 = V_189 ,
V_3 -> V_89 -> free = V_190 ,
V_3 -> V_89 -> V_191 = F_56 ,
V_3 -> V_89 -> V_192 = F_65 ,
V_3 -> V_89 -> V_193 = F_58 ,
...
V_3 -> V_89 -> V_196 = F_68 ,
V_3 -> V_89 -> V_197 = 3 ,
V_3 -> V_89 -> V_198 = false ,
V_3 -> V_89 -> V_104 = F_119 ( V_178 , V_103 ) -
V_3 -> V_17 -> V_76 ;
