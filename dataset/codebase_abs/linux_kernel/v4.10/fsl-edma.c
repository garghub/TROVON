...
static void F_100 (
struct V_151 * V_152 , struct V_1 * V_124 )
{
if ( V_124 -> V_154 == V_124 -> V_155 ) {
F_101 ( & V_152 -> V_150 , V_124 -> V_154 , V_124 ) ;
} else {
F_101 ( & V_152 -> V_150 , V_124 -> V_154 , V_124 ) ;
F_101 ( & V_152 -> V_150 , V_124 -> V_155 , V_124 ) ;
}
}
static void F_102 ( struct V_1 * V_124 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_28 ; V_43 ++ )
F_103 ( V_124 -> V_156 [ V_43 ] ) ;
}
static int F_104 ( struct V_151 * V_152 )
{
struct V_157 * V_158 = V_152 -> V_150 . V_159 ;
struct V_1 * V_124 ;
struct V_6 * V_14 ;
struct V_160 * V_161 ;
int V_79 , V_130 ;
int V_153 , V_43 ;
V_153 = F_105 ( V_158 , L_12 , & V_130 ) ;
if ( V_153 ) {
F_98 ( & V_152 -> V_150 , L_13 ) ;
return V_153 ;
}
V_79 = sizeof( * V_124 ) + sizeof( * V_14 ) * V_130 ;
V_124 = F_106 ( & V_152 -> V_150 , V_79 , V_162 ) ;
if ( ! V_124 )
return - V_163 ;
V_124 -> V_27 = V_130 ;
F_107 ( & V_124 -> V_145 ) ;
V_161 = F_108 ( V_152 , V_164 , 0 ) ;
V_124 -> V_15 = F_109 ( & V_152 -> V_150 , V_161 ) ;
if ( F_110 ( V_124 -> V_15 ) )
return F_111 ( V_124 -> V_15 ) ;
for ( V_43 = 0 ; V_43 < V_28 ; V_43 ++ ) {
char V_165 [ 32 ] ;
V_161 = F_108 ( V_152 , V_164 , 1 + V_43 ) ;
V_124 -> V_29 [ V_43 ] = F_109 ( & V_152 -> V_150 , V_161 ) ;
if ( F_110 ( V_124 -> V_29 [ V_43 ] ) )
return F_111 ( V_124 -> V_29 [ V_43 ] ) ;
sprintf ( V_165 , L_14 , V_43 ) ;
V_124 -> V_156 [ V_43 ] = F_112 ( & V_152 -> V_150 , V_165 ) ;
if ( F_110 ( V_124 -> V_156 [ V_43 ] ) ) {
F_98 ( & V_152 -> V_150 , L_15 ) ;
return F_111 ( V_124 -> V_156 [ V_43 ] ) ;
}
V_153 = F_113 ( V_124 -> V_156 [ V_43 ] ) ;
if ( V_153 ) {
for (; V_43 >= 0 ; V_43 -- )
F_103 ( V_124 -> V_156 [ V_43 ] ) ;
...
V_124 -> V_4 = F_114 ( V_158 , L_17 ) ;
F_115 ( & V_124 -> V_166 . V_167 ) ;
...
if ( V_153 )
return V_153 ;
F_117 ( V_169 , V_124 -> V_166 . V_170 ) ;
F_117 ( V_171 , V_124 -> V_166 . V_170 ) ;
F_117 ( V_172 , V_124 -> V_166 . V_170 ) ;
...
V_124 -> V_166 . V_186 = F_118 ( V_63 ) | F_118 ( V_70 ) ;
F_119 ( V_152 , V_124 ) ;
V_153 = F_120 ( & V_124 -> V_166 ) ;
if ( V_153 ) {
F_98 ( & V_152 -> V_150 ,
L_18 , V_153 ) ;
F_102 ( V_124 ) ;
...
static void F_123 ( struct V_190 * V_191 )
{
struct V_6 * V_8 , * V_143 ;
F_89 (chan, _chan,
&dmadev->channels, vchan.chan.device_node) {
F_77 ( & V_8 -> V_9 . V_8 . V_157 ) ;
F_124 ( & V_8 -> V_9 . V_192 ) ;
}
}
...
static int F_128 ( struct V_147 * V_150 )
{
struct V_1 * V_124 = F_129 ( V_150 ) ;
struct V_6 * V_14 ;
unsigned long V_50 ;
int V_43 ;
for ( V_43 = 0 ; V_43 < V_124 -> V_27 ; V_43 ++ ) {
...
static int F_131 ( struct V_147 * V_150 )
{
struct V_1 * V_124 = F_129 ( V_150 ) ;
struct V_6 * V_14 ;
int V_43 ;
