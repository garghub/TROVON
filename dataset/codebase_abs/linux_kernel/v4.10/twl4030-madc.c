...
static int F_30 ( struct V_100 * V_101 )
{
struct V_7 * V_8 ;
struct V_102 * V_103 = F_31 ( & V_101 -> V_29 ) ;
struct V_104 * V_105 = V_101 -> V_29 . V_106 ;
int V_56 , V_11 ;
T_1 V_95 ;
struct V_1 * V_1 = NULL ;
if ( ! V_103 && ! V_105 ) {
...
V_1 = F_32 ( & V_101 -> V_29 , sizeof( * V_8 ) ) ;
if ( ! V_1 ) {
F_7 ( & V_101 -> V_29 , L_20 ) ;
return - V_107 ;
}
V_8 = F_2 ( V_1 ) ;
V_8 -> V_29 = & V_101 -> V_29 ;
V_1 -> V_108 = F_33 ( & V_101 -> V_29 ) ;
V_1 -> V_29 . V_109 = & V_101 -> V_29 ;
V_1 -> V_29 . V_106 = V_101 -> V_29 . V_106 ;
V_1 -> V_110 = & V_111 ;
V_1 -> V_112 = V_113 ;
V_1 -> V_16 = V_114 ;
V_1 -> V_115 = F_34 ( V_114 ) ;
if ( V_103 )
V_8 -> V_13 = ( V_103 -> V_116 != 1 ) ;
else
V_8 -> V_13 = F_35 ( V_105 ,
L_21 ) ;
V_8 -> V_55 = V_8 -> V_13 ? V_117 :
V_118 ;
V_8 -> V_64 = V_8 -> V_13 ? V_119 :
V_120 ;
V_11 = F_29 ( V_8 , 1 ) ;
if ( V_11 < 0 )
return V_11 ;
...
if ( ! ( V_95 & V_125 ) ) {
F_36 ( & V_101 -> V_29 , L_25 ) ;
V_95 |= V_125 ;
V_11 = F_14 ( V_123 , V_95 ,
V_124 ) ;
if ( V_11 ) {
F_7 ( & V_101 -> V_29 , L_26 ,
V_124 ) ;
...
F_38 ( & V_8 -> V_63 ) ;
V_56 = F_39 ( V_101 , 0 ) ;
V_11 = F_40 ( & V_101 -> V_29 , V_56 , NULL ,
F_16 ,
V_126 | V_127 ,
L_27 , V_8 ) ;
if ( V_11 ) {
