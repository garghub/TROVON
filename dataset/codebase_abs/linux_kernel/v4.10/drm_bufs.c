...
int F_59 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
struct V_107 * V_108 = V_3 -> V_108 ;
...
int F_62 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
struct V_107 * V_108 = V_3 -> V_108 ;
struct V_106 * V_99 = V_82 ;
...
int F_63 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
struct V_107 * V_108 = V_3 -> V_108 ;
...
if ( F_64 ( & V_92 , & V_99 -> V_36 [ V_93 ] , sizeof( V_92 ) ) )
return - V_156 ;
...
V_73 = F_69 ( V_84 -> V_166 , 0 , V_5 -> V_32 ,
V_167 | V_168 ,
V_169 ,
V_163 ) ;
} else {
V_73 = F_69 ( V_84 -> V_166 , 0 , V_108 -> V_118 ,
V_167 | V_168 ,
V_169 , 0 ) ;
}
if ( V_73 > - 1024UL ) {
...
int F_70 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
if ( ! F_30 ( V_3 , V_89 ) )
return - V_27 ;
...
struct V_4 * F_71 ( struct V_2 * V_3 )
{
struct V_1 * V_6 ;
F_2 (entry, &dev->maplist, head) {
