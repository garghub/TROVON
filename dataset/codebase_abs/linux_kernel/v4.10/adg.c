...
F_19 ( V_43 , V_69 , 0x80FF0000 , V_15 -> V_63 | V_63 ) ;
F_29 ( V_43 , V_70 , V_15 -> V_71 ) ;
F_29 ( V_43 , V_72 , V_15 -> V_73 ) ;
F_26 ( V_17 , L_3 ,
F_30 ( V_6 ) , F_4 ( V_6 ) ,
V_62 , V_41 ) ;
return 0 ;
}
void F_31 ( struct V_9 * V_10 , int V_74 )
{
struct V_14 * V_15 = F_7 ( V_10 ) ;
struct V_16 * V_17 = F_8 ( V_10 ) ;
struct V_26 * V_26 ;
...
V_26 = F_36 ( V_17 , V_76 [ V_1 ] ) ;
V_15 -> V_26 [ V_1 ] = F_37 ( V_26 ) ? NULL : V_26 ;
}
F_27 (clk, adg, i)
...
V_26 = F_42 ( V_17 , V_87 [ V_1 ] ,
V_86 , 0 ,
V_82 ) ;
if ( ! F_37 ( V_26 ) ) {
V_15 -> V_96 . V_97 = V_15 -> V_93 ;
V_15 -> V_96 . V_98 = V_95 ;
V_15 -> V_93 [ V_1 ] = V_26 ;
F_43 ( V_79 , V_99 ,
& V_15 -> V_96 ) ;
...
struct V_16 * V_17 = F_8 ( V_10 ) ;
struct V_78 * V_79 = V_17 -> V_80 ;
V_15 = F_46 ( V_17 , sizeof( * V_15 ) , V_100 ) ;
if ( ! V_15 ) {
F_11 ( V_17 , L_18 ) ;
return - V_101 ;
}
F_47 ( V_10 , & V_15 -> V_102 , & V_103 ,
NULL , NULL , 0 , 0 ) ;
F_35 ( V_10 , V_15 ) ;
F_38 ( V_10 , V_15 ) ;
if ( F_48 ( V_79 , L_19 , NULL ) )
V_15 -> V_104 = V_68 ;
V_10 -> V_15 = V_15 ;
F_49 ( V_10 ) ;
return 0 ;
