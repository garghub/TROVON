...
int T_1 F_147 ( unsigned long V_204 )
{
T_2 V_137 , V_136 ;
if ( V_164 )
return - 1 ;
...
T_5 void F_151 ( struct V_117 * V_118 )
{
F_152 () ;
F_150 ( ~ V_118 -> V_215 ) ;
F_87 () ;
}
T_5 void F_153 ( struct V_117 * V_118 )
{
...
static void F_156 ( struct V_117 * V_118 )
{
T_2 V_25 ;
T_2 V_158 = 0 ;
...
T_5 void F_159 ( struct V_117 * V_118 )
{
F_152 () ;
F_160 ( V_124 ) ;
F_156 ( V_118 ) ;
...
V_152 | V_35 ) ;
V_132 |= V_223 | V_221 ;
V_132 = F_164 ( V_132 , V_225 ) ;
F_25 ( V_127 , V_132 ) ;
}
static int F_165 ( int V_182 )
{
int V_158 ;
...
int F_167 ( int V_182 , int V_229 , bool V_230 )
{
int V_115 , V_231 = V_228 ;
bool V_232 = F_168 ( V_208 ,
V_233 ) ;
if ( V_234 != V_168 &&
V_234 != F_125 () &&
V_234 == V_182 ) {
...
if ( ! V_232 && V_236 >= V_228 - 1 &&
V_182 != V_208 ) {
int V_235 = V_231 + V_237 - 1 ;
F_71 (
L_83
L_84
L_85 , V_231 , V_235 , V_182 ) ;
V_237 ++ ;
return - V_238 ;
}
if ( V_236 >= V_228 ) {
int V_235 = V_231 + V_237 ;
if ( V_230 ) {
F_71 ( L_86
L_87 ,
V_231 , V_235 , V_182 ) ;
...
int F_173 ( int V_182 , int V_229 )
{
return F_167 ( V_182 , V_229 , true ) ;
}
int F_174 ( void )
{
return F_125 () ;
...
V_242 |= F_176 ( 1UL << F_43 () ) ;
F_25 ( V_245 , V_242 ) ;
}
int F_177 ( const struct V_68 * V_68 ,
const struct V_68 * V_247 ,
unsigned int * V_182 )
{
unsigned int V_115 ;
F_178 (cpu, cpumask, andmask) {
if ( F_179 ( V_115 , V_248 ) )
break;
}
if ( F_180 ( V_115 < V_228 ) ) {
* V_182 = F_83 ( V_239 , V_115 ) ;
return 0 ;
}
return - V_57 ;
}
void T_1 F_181 ( void (* F_182)( T_2 V_54 , T_2 V_25 ) )
{
struct V_12 * * V_249 ;
for ( V_249 = V_250 ; V_249 < V_251 ; V_249 ++ ) {
F_109 ( ( * V_249 ) -> F_182 == F_182 ) ;
( * V_249 ) -> V_252 = ( * V_249 ) -> F_182 ;
( * V_249 ) -> F_182 = F_182 ;
}
}
static void T_1 F_183 ( void )
{
#ifdef F_13
F_25 ( V_183 , F_184 ( V_208 ) ) ;
#else
# ifdef F_185
V_208 = F_125 () ;
# endif
...
return 0 ;
V_121 = F_30 () ;
V_257 . V_259 = F_11 ( V_183 ) ;
V_257 . V_260 = F_11 ( V_169 ) ;
V_257 . V_261 = F_11 ( V_245 ) ;
V_257 . V_262 = F_11 ( V_243 ) ;
V_257 . V_263 = F_11 ( V_133 ) ;
V_257 . V_264 = F_11 ( V_36 ) ;
if ( V_121 >= 4 )
V_257 . V_265 = F_11 ( V_128 ) ;
V_257 . V_266 = F_11 ( V_126 ) ;
V_257 . V_267 = F_11 ( V_127 ) ;
V_257 . V_268 = F_11 ( V_125 ) ;
V_257 . V_269 = F_11 ( V_42 ) ;
V_257 . V_270 = F_11 ( V_38 ) ;
#ifdef F_93
if ( V_121 >= 5 )
V_257 . V_271 = F_11 ( V_129 ) ;
#endif
#ifdef F_94
if ( V_121 >= 6 )
V_257 . V_272 = F_11 ( V_130 ) ;
#endif
F_24 ( V_21 ) ;
F_95 () ;
F_196 () ;
...
F_25 ( V_183 , V_257 . V_259 ) ;
F_25 ( V_243 , V_257 . V_262 ) ;
F_25 ( V_245 , V_257 . V_261 ) ;
F_25 ( V_169 , V_257 . V_260 ) ;
F_25 ( V_133 , V_257 . V_263 ) ;
F_25 ( V_126 , V_257 . V_266 ) ;
F_25 ( V_127 , V_257 . V_267 ) ;
#ifdef F_93
if ( V_121 >= 5 )
F_25 ( V_129 , V_257 . V_271 ) ;
#endif
#ifdef F_94
if ( V_121 >= 6 )
F_25 ( V_130 , V_257 . V_272 ) ;
#endif
if ( V_121 >= 4 )
F_25 ( V_128 , V_257 . V_265 ) ;
F_25 ( V_36 , V_257 . V_264 ) ;
F_25 ( V_38 , V_257 . V_270 ) ;
F_25 ( V_42 , V_257 . V_269 ) ;
F_25 ( V_131 , 0 ) ;
F_11 ( V_131 ) ;
F_25 ( V_125 , V_257 . V_268 ) ;
F_25 ( V_131 , 0 ) ;
F_11 ( V_131 ) ;
F_198 ( V_122 ) ;
F_27 ( V_21 ) ;
...
static void F_115 ( void ) { }
static int F_201 ( const struct V_274 * V_275 )
{
if ( V_276 )
return 0 ;
F_17 ( L_93 , V_275 -> V_277 ) ;
V_276 = 1 ;
return 0 ;
}
...
return - 1 ;
V_282 . V_283 = V_123 ;
V_282 . V_284 = V_282 . V_283 + V_285 - 1 ;
F_212 ( & V_286 , & V_282 ) ;
return 0 ;
}
static int T_1 F_213 ( char * V_1 )
{
if ( ! V_1 || ! F_214 ( & V_1 , & V_234 ) )
return - V_57 ;
return 0 ;
}
