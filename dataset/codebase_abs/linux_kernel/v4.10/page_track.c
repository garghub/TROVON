...
void
F_21 ( struct V_20 * V_20 ,
struct V_29 * V_30 )
{
struct V_24 * V_25 ;
V_25 = & V_20 -> V_5 . V_26 ;
F_22 ( & V_20 -> V_31 ) ;
F_23 ( & V_30 -> V_32 , & V_25 -> V_28 ) ;
F_24 ( & V_20 -> V_31 ) ;
}
void
F_25 ( struct V_20 * V_20 ,
struct V_29 * V_30 )
{
struct V_24 * V_25 ;
V_25 = & V_20 -> V_5 . V_26 ;
...
void F_28 ( struct V_22 * V_23 , T_2 V_33 , const T_3 * V_34 ,
int V_35 )
{
struct V_24 * V_25 ;
struct V_29 * V_30 ;
...
return;
V_36 = F_30 ( & V_25 -> V_27 ) ;
F_31 (n, &head->track_notifier_list, node)
if ( V_30 -> V_37 )
V_30 -> V_37 ( V_23 , V_33 , V_34 , V_35 , V_30 ) ;
F_32 ( & V_25 -> V_27 , V_36 ) ;
}
void F_33 ( struct V_20 * V_20 , struct V_1 * V_7 )
{
struct V_24 * V_25 ;
struct V_29 * V_30 ;
int V_36 ;
