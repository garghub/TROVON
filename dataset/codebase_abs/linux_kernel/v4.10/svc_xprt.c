...
V_81 -> V_186 = F_120 ( & V_81 -> V_156 . V_119 [ 0 ] ) ;
if ( V_34 -> V_187 )
V_34 -> V_187 -> V_188 ++ ;
F_121 ( V_81 , V_14 ) ;
return V_14 ;
...
V_81 -> V_96 -> V_30 -> V_123 ( V_81 ) ;
V_190 = & V_81 -> V_118 ;
V_190 -> V_14 = V_190 -> V_119 [ 0 ] . V_120 +
V_190 -> V_125 +
V_190 -> V_158 [ 0 ] . V_120 ;
F_125 ( & V_19 -> V_41 ) ;
...
V_19 = F_92 ( V_197 , struct V_18 , V_37 ) ;
...
void F_131 ( struct V_33 * V_34 , struct V_63 * V_199 )
{
struct V_18 * V_19 ;
struct V_196 * V_197 , * V_198 ;
F_132 ( V_200 ) ;
...
V_34 -> V_136 -- ;
F_41 ( & V_34 -> V_73 ) ;
while ( ( V_206 = F_114 ( V_19 ) ) != NULL )
F_82 ( V_206 ) ;
F_135 ( V_19 ) ;
F_19 ( V_19 ) ;
}
void F_138 ( struct V_18 * V_19 )
{
F_25 ( V_98 , & V_19 -> V_26 ) ;
if ( F_64 ( V_43 , & V_19 -> V_26 ) )
return;
...
static int F_139 ( struct V_33 * V_34 , struct V_196 * V_208 , struct V_32 * V_32 )
{
struct V_18 * V_19 ;
int V_209 = 0 ;
F_4 ( & V_34 -> V_73 ) ;
...
struct V_18 * V_210 ;
int V_144 ;
for ( V_144 = 0 ; V_144 < V_34 -> V_211 ; V_144 ++ ) {
...
static void F_145 ( struct V_213 * V_214 , int V_215 )
{
struct V_205 * V_206 =
...
struct V_205 * V_206 ;
if ( V_81 -> V_156 . V_125 || ! F_13 ( V_220 , & V_81 -> V_95 ) )
return NULL ;
if ( V_81 -> V_124 ) {
V_206 = V_81 -> V_124 ;
V_81 -> V_124 = NULL ;
...
V_206 = F_147 ( V_222 , V_151 ) ;
if ( V_206 == NULL )
return NULL ;
V_206 -> V_216 . V_22 = V_81 -> V_140 ;
...
V_221 = V_81 -> V_156 . V_14 - V_81 -> V_156 . V_119 [ 0 ] . V_120 ;
memcpy ( V_206 -> args , V_81 -> V_156 . V_119 [ 0 ] . V_157 - V_221 ,
V_206 -> V_228 << 2 ) ;
}
F_35 ( V_81 -> V_96 ) ;
V_206 -> V_19 = V_81 -> V_96 ;
F_25 ( V_231 , & V_81 -> V_95 ) ;
V_206 -> V_216 . V_232 = F_145 ;
F_148 ( V_81 ) ;
return & V_206 -> V_216 ;
}
static int F_115 ( struct V_80 * V_81 )
{
struct V_205 * V_206 = V_81 -> V_124 ;
V_81 -> V_156 . V_119 [ 0 ] . V_157 = V_206 -> args + ( V_206 -> V_229 >> 2 ) ;
V_81 -> V_156 . V_119 [ 0 ] . V_120 = ( V_206 -> V_228 << 2 ) - V_206 -> V_229 ;
V_81 -> V_156 . V_125 = 0 ;
...
static struct V_205 * F_114 ( struct V_18 * V_19 )
{
...
{
int V_14 ;
V_14 = snprintf ( V_238 , V_239 , L_31 ,
V_19 -> V_23 -> V_6 ,
F_46 ( V_19 ) ) ;
if ( V_14 >= V_239 )
return - V_240 ;
...
int F_152 ( struct V_33 * V_34 , char * V_11 , const int V_241 )
{
struct V_18 * V_19 ;
int V_14 , V_242 ;
char * V_238 ;
...
V_242 = 0 ;
F_5 (xprt, &serv->sv_permsocks, xpt_list) {
V_14 = F_151 ( V_19 , V_238 , V_241 - V_242 ) ;
if ( V_14 < 0 ) {
* V_11 = '\0' ;
V_242 = V_14 ;
}
...
static void * F_153 ( struct V_243 * V_244 , T_3 * V_238 )
{
...
if ( ! V_245 )
return V_247 ;
return ( V_245 > V_34 -> V_211 ? NULL : & V_34 -> V_128 [ V_245 - 1 ] ) ;
}
static void * F_154 ( struct V_243 * V_244 , void * V_150 , T_3 * V_238 )
{
...
unsigned int V_245 = ( V_103 - & V_34 -> V_128 [ 0 ] ) ;
if ( V_245 < V_34 -> V_211 - 1 )
V_103 = & V_34 -> V_128 [ V_245 + 1 ] ;
else
V_103 = NULL ;
}
++ * V_238 ;
...
static void F_155 ( struct V_243 * V_244 , void * V_150 )
{
}
static int F_156 ( struct V_243 * V_244 , void * V_150 )
{
struct V_102 * V_103 = V_150 ;
if ( V_150 == V_247 ) {
F_157 ( V_244 , L_34 ) ;
...
int F_160 ( struct V_33 * V_34 , struct V_248 * V_248 )
{
int V_78 ;
V_78 = F_161 ( V_248 , & V_249 ) ;
if ( ! V_78 )
