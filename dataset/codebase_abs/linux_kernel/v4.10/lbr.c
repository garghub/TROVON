...
int V_75 = V_7 . V_18 ;
if ( V_3 -> V_9 ) {
V_73 = ! ( V_3 -> V_9 -> V_10 & V_76 ) ;
if ( V_3 -> V_9 -> V_10 & V_15 )
V_75 = V_26 ;
}
for ( V_17 = 0 ; V_17 < V_75 ; V_17 ++ ) {
unsigned long V_41 = ( V_26 - V_17 ) & V_42 ;
T_1 V_63 , V_64 , V_77 = 0 , V_78 = 0 , V_79 = 0 , abort = 0 ;
int V_80 = 0 ;
T_3 V_81 = 0 ;
int V_82 = V_31 [ V_22 ] ;
V_63 = F_17 ( V_41 ) ;
...
V_63 = ( T_1 ) ( ( ( ( V_90 ) V_63 ) << V_80 ) >> V_80 ) ;
if ( abort && V_7 . V_92 && V_74 > 0 )
V_74 -- ;
V_3 -> V_67 [ V_74 ] . V_63 = V_63 ;
V_3 -> V_67 [ V_74 ] . V_64 = V_64 ;
V_3 -> V_67 [ V_74 ] . V_68 = V_77 ;
V_3 -> V_67 [ V_74 ] . V_69 = V_78 ;
V_3 -> V_67 [ V_74 ] . V_79 = V_79 ;
V_3 -> V_67 [ V_74 ] . abort = abort ;
V_3 -> V_67 [ V_74 ] . V_81 = V_81 ;
V_3 -> V_67 [ V_74 ] . V_70 = 0 ;
V_74 ++ ;
}
V_3 -> V_71 . V_72 = V_74 ;
}
...
if ( ! V_161 )
return;
for ( V_17 = 0 ; V_17 < V_3 -> V_71 . V_72 ; ) {
if ( ! V_3 -> V_67 [ V_17 ] . V_63 ) {
V_160 = V_17 ;
while ( ++ V_160 < V_3 -> V_71 . V_72 )
