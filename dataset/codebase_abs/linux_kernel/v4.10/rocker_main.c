...
static void F_238 ( const struct V_11 * V_11 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
...
static void F_239 ( struct V_8 * V_8 )
{
struct V_11 * V_11 ;
int V_26 ;
...
static void F_242 ( struct V_11 * V_11 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
const struct V_13 * V_14 = V_8 -> V_14 ;
int V_30 ;
...
V_11 -> V_18 -> V_282 ) ;
if ( V_30 ) {
F_243 ( & V_14 -> V_18 , L_35 ) ;
F_244 ( V_11 -> V_18 ) ;
}
}
static int F_245 ( struct V_8 * V_8 , unsigned int V_12 )
{
struct V_13 * V_14 = V_8 -> V_14 ;
struct V_11 * V_11 ;
struct V_116 * V_18 ;
int V_30 ;
V_18 = F_246 ( sizeof( struct V_11 ) ) ;
if ( ! V_18 )
return - V_33 ;
F_247 ( V_18 , & V_14 -> V_18 ) ;
V_11 = F_171 ( V_18 ) ;
V_11 -> V_18 = V_18 ;
V_11 -> V_8 = V_8 ;
V_11 -> V_12 = V_12 ;
...
V_18 -> V_360 = & V_361 ;
V_18 -> V_362 = & V_363 ;
F_248 ( V_18 , & V_11 -> V_153 , F_228 ,
V_364 ) ;
F_249 ( V_18 , & V_11 -> V_154 , F_237 ,
V_364 ) ;
F_238 ( V_11 ) ;
...
static int F_251 ( struct V_8 * V_8 )
{
int V_26 ;
T_4 V_375 ;
int V_30 ;
...
static void F_257 ( const struct V_8 * V_8 )
{
F_258 ( V_8 -> V_14 ) ;
F_7 ( V_8 -> V_10 ) ;
}
static int F_259 ( struct V_13 * V_14 , const struct V_380 * V_289 )
{
struct V_8 * V_8 ;
int V_30 ;
...
V_30 = F_261 ( V_14 , V_47 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_41 ) ;
goto V_382;
}
V_30 = F_262 ( V_14 , F_263 ( 64 ) ) ;
if ( ! V_30 ) {
V_30 = F_264 ( V_14 , F_263 ( 64 ) ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_42 ) ;
goto V_383;
}
} else {
V_30 = F_262 ( V_14 , F_263 ( 32 ) ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_43 ) ;
goto V_383;
}
}
if ( F_265 ( V_14 , 0 ) < V_384 ) {
F_21 ( & V_14 -> V_18 , L_44 ) ;
V_30 = - V_66 ;
goto V_385;
}
V_8 -> V_386 = F_266 ( F_267 ( V_14 , 0 ) ,
F_265 ( V_14 , 0 ) ) ;
if ( ! V_8 -> V_386 ) {
F_21 ( & V_14 -> V_18 , L_45 ) ;
V_30 = - V_19 ;
...
static void F_278 ( struct V_13 * V_14 )
{
struct V_8 * V_8 = F_279 ( V_14 ) ;
F_239 ( V_8 ) ;
F_273 ( & V_8 -> V_315 ) ;
F_19 ( V_8 , V_391 , V_392 ) ;
F_274 ( V_8 -> V_318 ) ;
...
static bool F_280 ( const struct V_116 * V_18 )
{
...
static int F_282 ( struct V_116 * V_404 , void * V_405 )
{
struct V_406 * V_91 = V_405 ;
int V_407 = 0 ;
if ( F_281 ( V_404 , V_91 -> V_8 ) ) {
V_91 -> V_183 = F_171 ( V_404 ) ;
V_407 = 1 ;
}
return V_407 ;
}
struct V_11 * F_283 ( struct V_116 * V_18 ,
struct V_8 * V_8 )
{
struct V_406 V_91 ;
if ( F_281 ( V_18 , V_8 ) )
...
V_91 . V_8 = V_8 ;
V_91 . V_183 = NULL ;
F_284 ( V_18 , F_282 , & V_91 ) ;
return V_91 . V_183 ;
}
static int F_285 ( struct V_313 * V_408 ,
unsigned long V_307 , void * V_75 )
{
struct V_116 * V_18 = F_286 ( V_75 ) ;
struct V_409 * V_77 ;
struct V_11 * V_11 ;
int V_30 ;
if ( ! F_280 ( V_18 ) )
...
static int F_287 ( struct V_313 * V_408 ,
unsigned long V_307 , void * V_75 )
{
struct V_11 * V_11 ;
struct V_116 * V_18 ;
