...
int F_51 ( struct V_1 * V_1 , unsigned long V_76 , unsigned long V_77 )
{
unsigned long V_78 ;
int V_73 ;
F_49 ( F_28 ( V_1 ) ) ;
if ( ( V_76 | V_77 ) & ( V_70 - 1 ) )
return - V_79 ;
if ( V_77 == 0 || V_76 + V_77 < V_76 )
return - V_79 ;
V_73 = 0 ;
F_52 ( & V_1 -> V_35 -> V_80 ) ;
for ( V_78 = 0 ; V_78 < V_77 ; V_78 += V_70 )
V_73 |= F_50 ( V_1 , V_76 + V_78 ) ;
F_53 ( & V_1 -> V_35 -> V_80 ) ;
if ( V_73 )
F_19 ( V_1 ) ;
return 0 ;
}
int F_54 ( struct V_1 * V_1 , unsigned long V_81 ,
unsigned long V_76 , unsigned long V_77 )
{
unsigned long V_78 ;
int V_73 ;
F_49 ( F_28 ( V_1 ) ) ;
if ( ( V_81 | V_76 | V_77 ) & ( V_70 - 1 ) )
return - V_79 ;
if ( V_77 == 0 || V_81 + V_77 < V_81 || V_76 + V_77 < V_76 ||
V_81 + V_77 - 1 > V_82 || V_76 + V_77 - 1 > V_1 -> V_33 )
return - V_79 ;
V_73 = 0 ;
F_52 ( & V_1 -> V_35 -> V_80 ) ;
for ( V_78 = 0 ; V_78 < V_77 ; V_78 += V_70 ) {
...
return V_72 ? ( V_72 | ( V_60 & ~ V_83 ) ) : - V_84 ;
}
...
if ( F_81 ( V_96 , V_1 -> V_35 , V_72 , V_92 ,
& V_93 ) ) {
V_85 = - V_84 ;
goto V_95;
}
...
if ( V_72 ) {
V_72 |= V_60 & ~ V_83 ;
V_97 = F_83 ( V_1 -> V_35 , V_72 , & V_86 ) ;
if ( F_84 ( V_97 ) )
F_85 ( V_1 -> V_35 , V_72 , V_97 , 0 ) ;
F_86 ( V_97 , V_86 ) ;
}
}
void F_87 ( struct V_1 * V_1 , unsigned long V_81 , unsigned long V_76 )
{
unsigned long V_60 , V_72 , V_98 ;
struct V_99 * V_100 ;
F_59 ( & V_1 -> V_35 -> V_80 ) ;
for ( V_60 = V_81 ; V_60 < V_76 ;
V_60 = ( V_60 + V_70 ) & V_83 ) {
V_72 = ( unsigned long )
F_57 ( & V_1 -> V_20 ,
V_60 >> V_74 ) ;
...
continue;
V_72 |= V_60 & ~ V_83 ;
V_100 = F_88 ( V_1 -> V_35 , V_72 ) ;
V_98 = F_89 ( V_76 - V_60 , V_70 - ( V_60 & ~ V_83 ) ) ;
F_90 ( V_100 , V_72 , V_98 , NULL ) ;
}
F_60 ( & V_1 -> V_35 -> V_80 ) ;
}
void F_91 ( struct V_101 * V_102 )
{
F_14 ( & V_103 ) ;
...
static void F_93 ( struct V_1 * V_1 , unsigned long V_105 ,
unsigned long V_106 )
{
struct V_101 * V_102 ;
...
return F_98 ( V_1 -> V_35 , ( V_71 * ) V_4 , V_60 , V_86 ) ;
}
...
bool V_93 = false ;
F_49 ( F_28 ( V_1 ) ) ;
V_92 = ( V_110 == V_111 ) ? V_112 : 0 ;
if ( F_81 ( V_96 , V_35 , V_72 , V_92 , & V_93 ) )
return - V_84 ;
if ( V_93 )
return 0 ;
return F_65 ( V_1 , V_60 , V_72 ) ;
}
static void F_100 ( T_1 * V_86 )
{
F_18 ( V_86 ) ;
}
static int F_101 ( struct V_1 * V_1 , unsigned long V_60 ,
unsigned long V_77 , int V_110 , unsigned long V_113 )
{
unsigned long V_72 ;
T_1 * V_86 ;
T_4 * V_97 ;
...
while ( V_77 ) {
V_85 = - V_114 ;
V_97 = F_96 ( V_1 , V_60 , & V_86 ) ;
if ( V_97 ) {
V_85 = F_102 ( V_1 -> V_35 , V_60 , V_97 , V_110 , V_113 ) ;
F_100 ( V_86 ) ;
}
if ( V_85 ) {
V_72 = F_56 ( V_1 , V_60 ) ;
...
unsigned long V_77 , int V_110 )
{
int V_85 ;
if ( ( V_60 & ~ V_116 ) || ( V_77 & ~ V_116 ) || F_28 ( V_1 ) )
return - V_79 ;
if ( ! V_117 && V_110 == V_118 )
return - V_79 ;
F_59 ( & V_1 -> V_35 -> V_80 ) ;
V_85 = F_101 ( V_1 , V_60 , V_77 , V_110 , V_119 ) ;
F_60 ( & V_1 -> V_35 -> V_80 ) ;
return V_85 ;
}
...
unsigned long V_127 , unsigned long V_77 , int V_110 )
{
struct V_1 * V_56 ;
struct V_50 * V_51 ;
unsigned long V_72 ;
...
V_85 = - V_114 ;
V_97 = F_96 ( V_56 , V_127 , & V_86 ) ;
if ( V_97 ) {
F_14 ( & V_57 -> V_24 ) ;
V_85 = F_102 ( V_56 -> V_35 , V_127 , V_97 , V_110 ,
V_128 ) ;
if ( ! V_85 )
...
if ( V_85 ) {
F_12 ( V_51 ) ;
V_85 = F_99 ( V_56 , V_127 , V_72 , V_110 ) ;
if ( V_85 )
return V_85 ;
continue;
}
...
if ( ! ( V_134 [ V_48 ] & V_109 ) )
continue;
V_131 = ( unsigned long * ) ( V_134 [ V_48 ] & V_91 ) ;
V_134 [ V_48 ] = V_8 ;
F_115 ( V_57 , V_126 , V_131 ) ;
V_3 = F_117 ( F_11 ( V_131 ) >> V_125 ) ;
F_38 ( & V_3 -> V_29 ) ;
...
V_134 = ( unsigned long * ) ( * V_136 & V_91 ) ;
* V_136 = V_10 ;
...
if ( ! ( V_137 [ V_48 ] & V_91 ) )
continue;
V_134 = ( unsigned long * ) ( V_137 [ V_48 ] & V_91 ) ;
V_137 [ V_48 ] = V_10 ;
F_118 ( V_57 , V_126 , V_134 ) ;
V_3 = F_117 ( F_11 ( V_134 ) >> V_125 ) ;
F_38 ( & V_3 -> V_29 ) ;
...
V_137 = ( unsigned long * ) ( * V_139 & V_91 ) ;
* V_139 = V_12 ;
...
if ( ! ( V_140 [ V_48 ] & V_91 ) )
continue;
V_137 = ( unsigned long * ) ( V_140 [ V_48 ] & V_91 ) ;
V_140 [ V_48 ] = V_12 ;
F_120 ( V_57 , V_126 , V_137 ) ;
V_3 = F_117 ( F_11 ( V_137 ) >> V_125 ) ;
F_38 ( & V_3 -> V_29 ) ;
...
V_140 = ( unsigned long * ) ( * V_142 & V_91 ) ;
* V_142 = V_14 ;
...
if ( ! ( V_143 [ V_48 ] & V_91 ) )
continue;
V_140 = ( unsigned long * ) ( V_143 [ V_48 ] & V_91 ) ;
F_122 ( V_57 , V_126 , V_140 ) ;
F_112 ( V_30 , V_126 ) ;
V_143 [ V_48 ] = V_14 ;
V_3 = F_117 ( F_11 ( V_140 ) >> V_125 ) ;
...
int V_150 )
{
unsigned long V_126 , V_151 , V_67 , V_77 ;
...
V_77 = ( ( V_140 & V_64 ) + 1 ) * 4096 - V_67 ;
V_85 = F_111 ( V_57 , V_126 , V_151 + V_67 , V_77 , V_118 ) ;
F_14 ( & V_57 -> V_24 ) ;
if ( ! V_85 ) {
V_4 = F_95 ( V_57 , V_149 , 4 ) ;
if ( ! V_4 || ( * V_4 & V_91 ) !=
...
V_151 = V_131 & V_109 & V_116 ;
V_85 = F_111 ( V_57 , V_126 , V_151 , V_115 , V_118 ) ;
F_14 ( & V_57 -> V_24 ) ;
if ( ! V_85 ) {
V_4 = F_95 ( V_57 , V_149 , 1 ) ;
if ( ! V_4 || ( * V_4 & V_109 ) !=
...
V_85 = F_137 ( V_57 -> V_35 , V_149 , V_171 , V_172 , V_122 ) ;
if ( V_85 > 0 ) {
F_107 ( V_57 , V_72 , V_51 ) ;
V_51 = NULL ;
V_85 = 0 ;
...
unsigned long V_67 , T_4 * V_122 )
{
struct V_50 * V_51 , * V_52 , * V_53 ;
unsigned long V_60 , V_105 , V_106 , V_113 , V_126 ;
unsigned long * V_4 ;
F_49 ( ! F_28 ( V_57 ) ) ;
F_14 ( & V_57 -> V_56 -> V_24 ) ;
V_4 = F_57 ( & V_57 -> V_56 -> V_21 ,
V_72 >> V_74 ) ;
V_60 = V_4 ? F_46 ( V_4 ) + V_67 : 0 ;
F_18 ( & V_57 -> V_56 -> V_24 ) ;
if ( ! V_4 )
return;
F_14 ( & V_57 -> V_24 ) ;
...
V_105 = V_57 -> V_146 & V_144 ;
V_106 = V_105 + ( ( V_57 -> V_146 & V_31 ) + 1 ) * 4096 ;
if ( ! ( V_57 -> V_146 & V_148 ) && V_60 >= V_105 &&
V_60 < V_106 ) {
F_125 ( V_57 ) ;
F_18 ( & V_57 -> V_24 ) ;
F_38 ( & V_57 -> V_39 ) ;
...
struct V_99 * V_100 ;
unsigned long V_176 ;
for ( V_100 = V_35 -> V_177 ; V_100 != NULL ; V_100 = V_100 -> V_178 ) {
for ( V_176 = V_100 -> V_179 ;
V_176 < V_100 -> V_180 ;
V_176 += V_115 )
F_142 ( V_100 , V_176 , V_181 ) ;
V_100 -> V_182 &= ~ V_183 ;
V_100 -> V_182 |= V_184 ;
}
V_35 -> V_185 |= V_184 ;
...
goto V_95;
V_35 -> V_37 . V_190 = 1 ;
for ( V_100 = V_35 -> V_177 ; V_100 ; V_100 = V_100 -> V_178 ) {
if ( F_154 ( V_100 , V_100 -> V_179 , V_100 -> V_180 ,
V_191 , & V_100 -> V_182 ) ) {
V_35 -> V_37 . V_190 = 0 ;
V_85 = - V_62 ;
goto V_95;
