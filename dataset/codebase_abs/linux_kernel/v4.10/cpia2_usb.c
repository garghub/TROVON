...
int F_34 ( struct V_1 * V_2 , unsigned int V_117 )
{
int V_82 ;
int V_91 ;
if( V_2 -> V_32 )
...
static int F_51 ( struct V_124 * V_125 , T_4 V_149 )
{
struct V_1 * V_2 = F_44 ( V_125 ) ;
F_45 ( & V_2 -> V_146 ) ;
if ( V_2 -> V_32 ) {
