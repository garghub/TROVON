...
if ( V_9 -> V_17 & V_39 )
V_29 . V_40 = V_7 -> V_20 -> V_41 ;
V_29 . V_42 = V_16 -> V_43 & V_44 ;
if ( V_9 -> V_17 & V_21 ) {
V_29 . V_22 = V_16 -> V_22 ;
...
* V_25 = 0 ;
if ( F_19 ( F_11 ( V_7 ) , & V_29 , & V_27 , V_45 ) )
return;
switch ( V_27 . type ) {
case V_46 :
break;
...
#ifdef F_14
for ( V_36 = 0 ; V_36 < V_27 . V_49 -> V_50 ; V_36 ++ ) {
struct V_51 * V_52 = & V_27 . V_49 -> V_51 [ V_36 ] ;
if ( V_52 -> V_53 == V_34 ) {
V_35 = V_52 -> V_53 ;
goto V_48;
}
