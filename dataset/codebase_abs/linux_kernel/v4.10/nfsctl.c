...
F_89 ( V_108 -> V_27 ) ;
return F_90 ( V_108 , 0x6e667364 , V_111 ) ;
}
static struct V_40 * F_91 ( struct V_141 * V_142 ,
int V_143 , const char * V_144 , void * V_7 )
{
struct V_12 * V_12 = V_23 -> V_24 -> V_25 ;
return F_92 ( V_142 , V_143 , V_7 , V_12 , V_12 -> V_145 , F_86 ) ;
}
...
static T_8 void F_105 ( struct V_12 * V_12 )
{
F_106 ( V_12 ) ;
F_104 ( V_12 ) ;
}
