...
if ( V_4 == 0xFFFF )
return 0 ;
return F_23 ( V_35 -> V_38 , V_4 ) ;
}
static int F_24 ( struct V_39 * V_40 , struct V_41 * V_42 ,
enum V_43 V_44 )
{
struct V_41 * V_45 = F_25 ( V_40 ) ;
return V_45 == NULL || V_45 == V_42 ;
}
static int F_26 ( struct V_39 * V_40 , unsigned int V_46 ,
T_1 V_47 )
{
struct V_48 * V_48 = V_40 -> V_49 ;
struct V_50 * V_51 ;
V_51 = & V_48 -> V_52 ;
if ( V_5 )
if ( V_53 [ V_47 ] & V_54 )
...
static int F_30 ( struct V_39 * V_40 , struct V_41 * V_57 ,
...
void T_3 F_31 ( void )
{
struct V_41 * V_63 , * V_64 ;
struct V_48 * V_48 ;
int V_36 = 1 ;
V_63 = F_32 ( NULL , NULL , L_1 ) ;
if ( ! V_63 ) {
F_33 ( L_2 ) ;
return;
}
if ( ! F_34 ( V_63 , L_3 , NULL ) )
V_36 = 0 ;
V_48 = F_35 ( sizeof( struct V_48 ) , V_65 ) ;
if ( ! V_48 ) {
F_36 ( V_63 ) ;
return;
}
V_48 -> V_38 = F_37 ( V_63 , V_66 ,
& V_67 , V_48 ) ;
if ( ! V_48 -> V_38 ) {
F_36 ( V_63 ) ;
F_38 ( V_48 ) ;
