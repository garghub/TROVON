...
F_25 ( V_21 & V_7 , V_87 -> V_89 ) ;
return V_93 ;
}
if ( ( V_7 & V_58 ) &&
! F_19 ( V_21 & V_7 , V_87 -> V_89 ) )
return - V_95 ;
V_94 = F_26 ( V_86 , 10 , & V_15 ) ;
if ( V_94 )
return V_94 ;
if ( V_15 > V_87 -> V_92 )
V_15 = V_87 -> V_92 ;
...
static T_4 F_28 ( struct V_82 * V_83 ,
struct V_84 * V_85 ,
const char * V_86 , T_6 V_93 , T_5 V_7 )
{
struct V_1 * V_87 = F_18 ( V_83 ) ;
...
static inline void F_32 ( struct V_82 * V_83 ,
unsigned V_96 , unsigned V_97 )
{
F_33 ( & V_83 -> V_98 ,
V_99 [ V_97 ] ) ;
...
struct V_1 * V_87 ;
int V_109 , V_94 = 0 ;
V_87 = F_35 ( sizeof( struct V_1 ) , V_110 ) ;
if ( ! V_87 ) {
V_94 = - V_111 ;
goto exit;
}
