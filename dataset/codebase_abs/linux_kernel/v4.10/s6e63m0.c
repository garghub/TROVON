...
static T_2 F_24 ( struct V_62 * V_23 ,
struct V_63 * V_64 , char * V_5 )
{
struct V_1 * V_2 = F_25 ( V_23 ) ;
char V_65 [ 10 ] ;
switch ( V_2 -> V_66 ) {
case 0 :
sprintf ( V_65 , L_13 ) ;
...
static T_2 F_27 ( struct V_62 * V_23 ,
struct V_63 * V_64 ,
...
static T_2 F_29 ( struct V_62 * V_23 ,
struct V_63 * V_64 , char * V_5 )
{
struct V_1 * V_2 = F_25 ( V_23 ) ;
char V_65 [ 3 ] ;
...
static int F_30 ( struct V_71 * V_12 )
{
int V_15 = 0 ;
struct V_1 * V_2 = NULL ;
...
struct V_43 * V_44 = NULL ;
struct V_72 V_52 ;
V_2 = F_31 ( & V_12 -> V_23 , sizeof( struct V_1 ) , V_73 ) ;
if ( ! V_2 )
return - V_74 ;
V_12 -> V_75 = 9 ;
V_15 = F_32 ( V_12 ) ;
...
V_2 -> V_12 = V_12 ;
V_2 -> V_23 = & V_12 -> V_23 ;
V_2 -> V_45 = F_33 ( & V_12 -> V_23 ) ;
if ( ! V_2 -> V_45 ) {
F_9 ( & V_12 -> V_23 , L_20 ) ;
return - V_47 ;
}
V_48 = F_34 ( & V_12 -> V_23 , L_21 , & V_12 -> V_23 , V_2 ,
& V_76 ) ;
if ( F_35 ( V_48 ) )
return F_36 ( V_48 ) ;
V_2 -> V_48 = V_48 ;
...
V_2 -> V_44 = V_44 ;
V_2 -> V_70 =
sizeof( V_26 ) / ( V_79 * sizeof( int * ) ) ;
V_15 = F_38 ( & ( V_12 -> V_23 ) , & V_80 ) ;
if ( V_15 < 0 )
F_9 ( & ( V_12 -> V_23 ) , L_23 ) ;
V_15 = F_38 ( & ( V_12 -> V_23 ) , & V_81 ) ;
if ( V_15 < 0 )
F_9 ( & ( V_12 -> V_23 ) , L_23 ) ;
if ( ! V_2 -> V_45 -> V_82 ) {
V_2 -> V_39 = V_58 ;
...
static int F_40 ( struct V_71 * V_12 )
{
struct V_1 * V_2 = F_41 ( V_12 ) ;
F_18 ( V_2 , V_58 ) ;
F_42 ( & V_12 -> V_23 , & V_81 ) ;
F_42 ( & V_12 -> V_23 , & V_80 ) ;
return 0 ;
}
static int F_43 ( struct V_62 * V_23 )
{
struct V_1 * V_2 = F_25 ( V_23 ) ;
F_44 ( V_23 , L_25 , V_2 -> V_39 ) ;
return F_18 ( V_2 , V_58 ) ;
}
static int F_45 ( struct V_62 * V_23 )
{
struct V_1 * V_2 = F_25 ( V_23 ) ;
V_2 -> V_39 = V_58 ;
return F_18 ( V_2 , V_57 ) ;
}
static void F_46 ( struct V_71 * V_12 )
{
struct V_1 * V_2 = F_41 ( V_12 ) ;
F_18 ( V_2 , V_58 ) ;
}
