...
F_3 ( L_16 ) ;
F_4 ( L_17 ,
V_49 , V_49 -> V_14 , F_36 ( V_49 ) ) ;
V_6 = F_37 ( sizeof( * V_6 ) , V_51 ) ;
if ( ! V_6 )
goto V_52;
V_6 -> V_13 = V_49 ;
V_6 -> V_19 = F_38 ( V_19 ) ;
...
if ( V_73 ) {
V_31 = F_35 ( V_8 , V_19 , V_11 ) ;
} else if ( F_45 ( V_70 , 0 , 1 ) == 0 ) {
F_28 ( V_19 , V_11 ) ;
F_31 ( V_19 , 1 ) ;
V_31 = - V_34 ;
} else {
...
struct V_69 , V_70 ) ;
F_3 ( L_37 ,
V_8 -> V_20 . V_99 , F_49 ( & V_19 -> V_19 . V_100 ) ,
* V_93 ) ;
if ( ! V_8 -> V_26 )
goto V_101;
V_98 = 1 ;
if ( F_45 ( V_70 , 0 , * V_93 ) < 0 )
V_98 = 0 ;
V_71 = F_13 ( V_8 -> V_26 ) ;
ASSERT ( F_44 ( V_71 -> V_76 ) ) ;
ASSERT ( V_71 -> V_27 -> V_37 -> V_77 ) ;
...
int F_58 ( struct V_103 * V_19 , struct V_11 * V_11 )
{
struct V_7 * V_8 ;
struct V_69 * V_70 ;
struct V_104 * V_104 ;
...
V_104 = F_60 ( & V_105 , V_113 | V_114 , V_70 -> V_115 ) ;
if ( F_61 ( V_104 ) ) {
V_31 = F_62 ( V_104 ) ;
goto V_116;
}
...
V_106 , V_107 ) ;
V_108 = V_107 - V_106 ;
F_63 ( V_106 + V_108 , == , V_107 ) ;
}
}
V_109 = F_64 ( V_11 ) ;
V_31 = F_65 ( V_104 , V_109 , V_108 , & V_106 ) ;
F_66 ( V_11 ) ;
F_67 ( V_104 ) ;
if ( V_31 != V_108 )
goto V_119;
