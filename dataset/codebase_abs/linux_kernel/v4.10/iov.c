...
V_14 -> V_78 |= V_79 | V_80 ;
F_42 ( V_2 ) ;
F_4 ( V_2 , V_14 -> V_15 + V_81 , V_14 -> V_78 ) ;
F_43 ( 100 ) ;
F_44 ( V_2 ) ;
...
void F_70 ( struct V_1 * V_2 , int V_30 )
{
...
if ( ! V_14 )
return;
F_5 ( V_2 , V_14 -> V_15 + V_81 , & V_107 ) ;
if ( ( V_107 & V_79 ) && ( V_107 & V_80 ) ) {
F_71 ( & V_2 -> V_2 , L_9 ,
V_104 , V_42 ) ;
return;
}
...
if ( V_42 -> V_55 & V_92 )
return;
F_72 ( V_2 -> V_6 , & V_106 , V_42 ) ;
V_108 = V_106 . V_56 ;
V_108 |= V_42 -> V_55 & ~ V_111 ;
V_109 = V_14 -> V_15 + V_95 + 4 * V_104 ;
F_51 ( V_2 , V_109 , V_108 ) ;
if ( V_42 -> V_55 & V_93 ) {
V_108 = V_106 . V_56 >> 16 >> 16 ;
F_51 ( V_2 , V_109 + 4 , V_108 ) ;
}
}
T_1 __weak F_73 ( struct V_1 * V_2 ,
int V_30 )
{
return F_15 ( V_2 , V_30 ) ;
}
T_1 F_74 ( struct V_1 * V_2 , int V_30 )
{
return F_73 ( V_2 , V_30 ) ;
}
...
if ( ! V_2 -> V_4 )
continue;
if ( V_2 -> V_9 -> V_24 > V_112 )
V_112 = V_2 -> V_9 -> V_24 ;
}
return V_112 ? V_112 - V_6 -> V_7 : 0 ;
}
int F_77 ( struct V_1 * V_2 , int V_12 )
{
F_78 () ;
if ( ! V_2 -> V_4 )
return - V_75 ;
...
if ( ! V_2 -> V_4 )
return 0 ;
F_5 ( V_2 , V_2 -> V_9 -> V_15 + V_47 , & V_115 ) ;
V_113 = F_82 ( V_2 -> V_46 , V_115 , NULL ) ;
while ( V_113 ) {
if ( V_113 -> V_51 && ( V_113 -> V_50 == V_2 ) &&
F_83 ( V_113 ) )
V_114 ++ ;
V_113 = F_82 ( V_2 -> V_46 , V_115 , V_113 ) ;
}
return V_114 ;
}
int F_84 ( struct V_1 * V_2 , T_3 V_116 )
{
if ( ! V_2 -> V_4 )
return - V_75 ;
if ( V_116 > V_2 -> V_9 -> V_21 )
return - V_5 ;
if ( V_2 -> V_9 -> V_78 & V_79 )
return - V_117 ;
else
V_2 -> V_9 -> V_118 = V_116 ;
return 0 ;
