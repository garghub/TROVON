...
static int F_65 ( struct V_63 * V_64 , struct V_11 * V_12 )
{
int V_138 ;
unsigned long V_107 ;
...
if ( V_64 -> V_139 == 0x00E4 ) {
V_138 = 5 ;
V_107 = F_67 ( V_64 , V_138 ) - 0x2000 ;
} else {
V_138 = 2 ;
V_107 = 0 ;
}
V_12 -> V_92 = F_68 ( V_64 , V_138 , V_107 , V_102 * V_93 ) ;
if ( V_12 -> V_92 == NULL ) {
F_25 ( & V_64 -> V_73 , L_4 ) ;
goto V_140;
}
V_12 -> V_89 = F_66 ( V_64 , 3 , V_102 * V_141 ) ;
if ( V_12 -> V_89 == NULL ) {
F_25 ( & V_64 -> V_73 , L_5 ) ;
goto V_142;
}
...
{
int V_60 , V_143 ;
struct V_11 * V_113 = F_70 ( V_64 ) ;
if ( ! V_113 )
return;
F_40 ( V_113 ) ;
V_143 = F_71 ( V_113 -> V_125 . V_73 ) ;
for ( V_60 = V_143 ; V_60 < V_143 + V_102 ; V_60 ++ )
F_72 ( V_144 , F_73 ( V_145 , V_60 ) ) ;
F_74 ( & V_113 -> V_125 ) ;
F_43 ( V_113 ) ;
F_75 ( V_64 -> V_134 , V_113 ) ;
F_63 ( V_64 , V_113 ) ;
F_76 ( V_64 ) ;
F_56 ( V_113 ) ;
V_146 [ ( V_143 / V_102 ) ] = 0 ;
...
{
int V_149 , V_143 , V_150 , error = 0 ;
struct V_11 * V_113 ;
if ( V_64 -> V_139 == 0x1979 )
return 0 ;
if ( V_102 > V_151 )
V_102 = V_151 ;
else if ( V_102 < V_152 )
...
F_82 ( V_64 , V_113 ) ;
F_40 ( V_113 ) ;
error = F_83 ( V_64 -> V_134 , F_61 , V_157 , L_7 , V_113 ) ;
if ( error )
goto V_158;
F_41 ( V_113 ) ;
F_84 ( & V_113 -> V_125 , & V_159 ) ;
V_113 -> V_125 . V_160 = V_161 ;
V_150 = V_149 * V_102 ;
error = F_85 ( & V_113 -> V_125 , F_73 ( V_145 , V_150 ) , V_102 ) ;
if ( error ) {
F_25 ( & V_64 -> V_73 , L_8 ) ;
goto V_162;
}
for ( V_143 = 0 ; V_143 < V_102 ; V_143 ++ ) {
struct V_163 * V_73 ;
V_73 = F_86 ( V_144 , & V_64 -> V_73 ,
F_73 ( V_145 , V_143 ) , NULL ,
L_9 , V_149 , V_143 ) ;
if ( F_87 ( V_73 ) )
F_25 ( & V_64 -> V_73 , L_10 ) ;
}
...
int error ;
T_11 V_73 ;
V_144 = F_89 ( V_161 , L_11 ) ;
if ( F_87 ( V_144 ) ) {
error = F_90 ( V_144 ) ;
goto V_130;
}
error = F_91 ( & V_73 , 0 , V_164 , V_154 ) ;
if ( error )
goto V_165;
V_145 = F_92 ( V_73 ) ;
error = F_93 ( & V_166 ) ;
...
static void T_12 F_95 ( void )
{
F_96 ( & V_166 ) ;
F_94 ( F_73 ( V_145 , 0 ) , V_164 ) ;
V_165 ( V_144 ) ;
}
