...
static long F_72 ( struct V_16 * V_17 ,
...
if ( ! V_57 )
return - V_108 ;
V_102 = F_77 ( struct V_106 ,
V_109 ) ;
if ( F_78 ( & V_107 , ( void V_110 * ) V_64 , V_102 ) )
return - V_82 ;
...
V_103 = F_77 ( struct V_106 , V_115 ) ;
if ( V_107 . V_111 >= V_103 )
V_102 = V_103 ;
if ( F_79 ( ( void V_110 * ) V_64 , & V_107 , V_102 ) )
return - V_82 ;
return 0 ;
}
case V_119 : {
...
if ( ! V_17 -> V_34 )
return - V_7 ;
V_102 = F_77 ( struct V_120 , V_24 ) ;
if ( F_78 ( & V_121 , ( void V_110 * ) V_64 , V_102 ) )
return - V_82 ;
...
V_4 = F_80 ( V_36 , V_121 . V_124 , V_121 . V_23 ) ;
if ( V_4 )
return V_4 ;
if ( V_17 -> V_68 )
V_4 = F_68 ( V_17 , V_36 ,
...
if ( ! F_31 ( V_17 ) )
return - V_108 ;
V_102 = F_77 ( struct V_136 ,
V_94 ) ;
if ( F_78 ( & V_137 , ( void V_110 * ) V_64 , V_102 ) )
return - V_82 ;
...
& V_137 . V_94 ) ;
F_84 ( & V_17 -> V_67 ) ;
if ( ! V_4 && F_79 ( ( void V_110 * ) V_64 , & V_137 , V_102 ) )
V_4 = - V_82 ;
return V_4 ;
}
case V_138 : {
...
if ( ! F_31 ( V_17 ) )
return - V_108 ;
V_102 = F_77 ( struct V_139 ,
V_94 ) ;
if ( F_78 ( & remove , ( void V_110 * ) V_64 , V_102 ) )
return - V_82 ;
...
static long F_90 ( struct V_16 * V_17 ,
struct V_56 * V_57 )
{
long V_47 , V_4 = 0 ;
