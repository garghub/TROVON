...
F_38 ( V_2 , V_49 -> V_32 [ 0 ] , V_49 -> V_62 ) ;
V_2 -> V_63 = V_64 | V_65 ;
V_2 -> V_66 = & V_67 ;
V_50 = F_39 ( V_22 ) - V_8 -> V_68 . V_69 ;
V_2 -> V_60 . V_70 = V_8 -> V_68 . V_71 + V_50 ;
V_2 -> V_60 . V_72 = F_37 ( V_22 ) ;
V_2 -> V_73 = V_22 -> V_59 ;
V_2 -> V_74 = F_37 ( V_22 ) ;
F_40 ( V_2 , & V_5 -> V_45 , V_47 -> V_75 , V_47 -> V_76 ) ;
V_2 -> V_77 -> V_78 [ 0 ] . V_58 = V_8 -> V_10 -> V_79 . V_80 ;
V_2 -> V_77 -> V_78 [ 0 ] . V_29 = V_8 -> V_68 . V_81 ;
if ( V_2 -> V_73 == NULL ) {
V_9 = - V_82 ;
goto V_57;
}
F_41 ( L_6 , V_2 -> V_60 . V_70 ) ;
...
{
if ( V_8 -> V_84 . V_5 )
F_63 ( & V_8 -> V_84 . V_5 -> V_45 , V_96 ) ;
}
bool F_64 ( struct V_7 * V_8 , struct V_21 * V_97 )
{
if ( ! V_8 -> V_84 . V_5 )
return false ;
if ( V_97 == F_9 ( V_8 -> V_84 . V_5 -> V_56 . V_87 ) )
return true ;
return false ;
}
...
{
if ( V_8 -> V_84 . V_5 )
F_66 ( & V_8 -> V_84 . V_5 -> V_45 , V_99 ) ;
}
void F_67 ( struct V_7 * V_8 , struct V_98 * V_99 )
{
if ( V_8 -> V_84 . V_5 )
F_68 ( & V_8 -> V_84 . V_5 -> V_45 , V_99 ) ;
}
