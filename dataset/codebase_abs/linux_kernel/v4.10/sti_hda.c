...
= F_31 ( V_80 ) ;
struct V_1 * V_2 = V_83 -> V_2 ;
if ( F_18 ( V_2 , V_2 -> V_84 -> V_94 ) ) {
F_26 ( L_24 ) ;
return - V_95 ;
}
return 0 ;
}
static struct V_96 * F_38 ( struct V_97 * V_98 )
{
struct V_96 * V_99 ;
...
static int F_40 ( struct V_102 * V_98 , struct V_102 * V_103 , void * V_19 )
{
...
if ( ! V_99 )
return - V_105 ;
V_80 = F_42 ( V_98 , sizeof( * V_80 ) , V_106 ) ;
if ( ! V_80 )
return - V_105 ;
V_80 -> V_2 = V_2 ;
V_39 = F_42 ( V_98 , sizeof( * V_39 ) , V_106 ) ;
if ( ! V_39 )
return - V_105 ;
V_39 -> V_40 = V_2 ;
V_39 -> V_107 = & V_108 ;
...
static void F_48 ( struct V_102 * V_98 ,
...
struct V_117 * V_118 ;
F_50 ( L_26 , V_119 ) ;
V_2 = F_42 ( V_98 , sizeof( * V_2 ) , V_106 ) ;
if ( ! V_2 )
return - V_105 ;
V_2 -> V_98 = V_116 -> V_98 ;
V_118 = F_51 ( V_116 , V_120 , L_27 ) ;
if ( ! V_118 ) {
F_26 ( L_28 ) ;
return - V_105 ;
}
V_2 -> V_4 = F_52 ( V_98 , V_118 -> V_121 , F_53 ( V_118 ) ) ;
if ( ! V_2 -> V_4 )
return - V_105 ;
V_118 = F_51 ( V_116 , V_120 ,
L_29 ) ;
if ( V_118 ) {
V_2 -> V_12 = F_52 ( V_98 , V_118 -> V_121 ,
F_53 ( V_118 ) ) ;
if ( ! V_2 -> V_12 )
return - V_105 ;
} else {
...
V_2 -> V_43 = F_54 ( V_98 , L_31 ) ;
if ( F_55 ( V_2 -> V_43 ) ) {
F_26 ( L_32 ) ;
return F_56 ( V_2 -> V_43 ) ;
}
V_2 -> V_42 = F_54 ( V_98 , L_33 ) ;
if ( F_55 ( V_2 -> V_42 ) ) {
F_26 ( L_34 ) ;
return F_56 ( V_2 -> V_42 ) ;
}
F_57 ( V_116 , V_2 ) ;
return F_58 ( & V_116 -> V_98 , & V_122 ) ;
}
static int F_59 ( struct V_115 * V_116 )
{
F_60 ( & V_116 -> V_98 , & V_122 ) ;
return 0 ;
}
