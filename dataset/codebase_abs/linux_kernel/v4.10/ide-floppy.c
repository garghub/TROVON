...
T_2 * V_71 , V_19 [ 40 ] ;
int V_72 , V_73 ;
V_25 V_74 , V_75 , V_76 , V_77 ;
T_2 V_78 , V_79 ;
F_13 ( V_7 , V_48 ) ;
if ( F_29 ( V_1 , V_70 , V_7 , V_19 , V_7 -> V_43 ) ) {
...
V_1 -> V_80 &= ~ V_81 ;
F_30 ( V_70 , ! ! ( V_1 -> V_80 & V_81 ) ) ;
V_71 = & V_19 [ 8 ] ;
V_74 = F_31 ( ( V_82 * ) & V_19 [ 8 + 2 ] ) ;
V_75 = F_31 ( ( V_82 * ) & V_19 [ 8 + 6 ] ) ;
V_76 = F_31 ( ( V_82 * ) & V_19 [ 8 + 8 ] ) ;
V_77 = F_31 ( ( V_82 * ) & V_19 [ 8 + 28 ] ) ;
V_78 = V_19 [ 8 + 4 ] ;
V_79 = V_19 [ 8 + 5 ] ;
V_72 = V_76 * V_78 * V_79 * V_75 ;
if ( memcmp ( V_71 , & V_4 -> V_83 , 32 ) )
F_5 (KERN_INFO PFX L_17
L_18 ,
drive->name, capacity / 1024 , cyls, heads,
sectors, transfer_rate / 8 , sector_size, rpm) ;
memcpy ( & V_4 -> V_83 , V_71 , 32 ) ;
V_1 -> V_84 = V_76 ;
V_1 -> V_85 = V_78 ;
V_1 -> V_86 = V_79 ;
V_73 = V_4 -> V_52 * V_4 -> V_87 ;
if ( V_72 < V_73 ) {
...
struct V_6 V_7 ;
T_2 * V_89 ;
T_2 V_90 [ 256 ] , V_91 , V_92 ;
int V_93 , V_94 = 1 , V_52 , V_45 ;
F_2 ( V_11 , L_1 ) ;
V_1 -> V_84 = 0 ;
V_1 -> V_85 = V_1 -> V_86 = 0 ;
V_4 -> V_52 = 0 ;
...
V_1 -> V_88 = 0 ;
F_11 ( & V_7 ) ;
if ( F_29 ( V_1 , V_70 , & V_7 , V_90 , V_7 . V_43 ) ) {
...
unsigned int V_95 = 4 + V_93 * 8 ;
V_52 = F_33 ( ( V_96 * ) & V_90 [ V_95 ] ) ;
V_45 = F_31 ( ( V_82 * ) & V_90 [ V_95 + 6 ] ) ;
F_2 ( V_97 , L_22
L_23 ,
V_93 , V_52 * V_45 / 1024 ,
V_52 , V_45 ) ;
if ( V_93 )
continue;
switch ( V_90 [ V_95 + 4 ] & 0x03 ) {
case V_98 :
if ( ! ( V_1 -> V_99 & V_100 ) )
break;
case V_101 :
if ( memcmp ( V_89 , & V_4 -> V_89 , 8 ) )
F_5 (KERN_INFO PFX L_24
L_25 ,
drive->name, blocks * length / 1024 ,
blocks, length) ;
memcpy ( & V_4 -> V_89 , V_89 , 8 ) ;
if ( ! V_45 || V_45 % 512 ) {
...
{
struct V_3 * V_4 = V_1 -> V_5 ;
V_25 * V_104 = V_1 -> V_104 ;
V_1 -> V_39 = F_1 ;
if ( F_35 ( ( char * ) & V_104 [ V_105 ] , L_35 ) ) {
V_1 -> V_99 |= V_106 ;
V_1 -> V_107 = V_108 ;
F_36 ( V_1 -> V_109 , 64 ) ;
}
if ( F_35 ( ( char * ) & V_104 [ V_105 ] , L_36 ) ) {
F_36 ( V_1 -> V_109 , 64 ) ;
V_1 -> V_99 |= V_100 ;
V_1 -> V_80 &= ~ V_110 ;
}
...
static int F_39 ( T_1 * V_1 , struct V_69 * V_70 )
{
int V_113 = 0 ;
if ( F_40 ( V_1 , V_70 ) )
F_41 ( V_1 , V_70 , 1 ) ;
