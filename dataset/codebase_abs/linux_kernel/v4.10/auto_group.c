...
void F_28 ( struct V_1 * V_13 )
{
F_29 ( V_13 ) ;
}
static void
F_30 ( struct V_1 * V_13 , struct V_8 * V_10 )
{
struct V_8 * V_22 ;
struct V_1 * V_23 ;
unsigned long V_14 ;
...
static int T_1 F_37 ( char * V_27 )
{
V_28 = 0 ;
return 1 ;
}
int F_38 ( struct V_1 * V_13 , int V_29 )
{
static unsigned long V_30 = V_31 ;
struct V_8 * V_10 ;
unsigned long V_32 ;
int V_33 ;
if ( V_29 < V_34 || V_29 > V_35 )
return - V_36 ;
V_33 = F_39 ( V_26 , V_29 ) ;
if ( V_33 )
return V_33 ;
if ( V_29 < 0 && ! F_40 ( V_26 , V_29 ) )
return - V_37 ;
if ( ! F_41 ( V_38 ) && F_42 ( V_39 , V_30 ) )
return - V_40 ;
V_30 = V_41 / 10 + V_39 ;
V_10 = F_15 ( V_13 ) ;
V_32 = F_43 ( V_42 [ V_29 + 20 ] ) ;
F_44 ( & V_10 -> V_7 ) ;
V_33 = F_45 ( V_10 -> V_4 , V_32 ) ;
if ( ! V_33 )
V_10 -> V_29 = V_29 ;
F_46 ( & V_10 -> V_7 ) ;
F_11 ( V_10 ) ;
...
void F_47 ( struct V_1 * V_13 , struct V_43 * V_44 )
{
struct V_8 * V_10 = F_15 ( V_13 ) ;
if ( ! F_48 ( V_10 -> V_4 ) )
goto V_45;
F_49 ( & V_10 -> V_7 ) ;
F_50 ( V_44 , L_4 , V_10 -> V_18 , V_10 -> V_29 ) ;
F_51 ( & V_10 -> V_7 ) ;
V_45:
F_11 ( V_10 ) ;
}
int F_52 ( struct V_9 * V_4 , char * V_46 , int V_47 )
{
if ( ! F_48 ( V_4 ) )
return 0 ;
