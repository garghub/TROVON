...
V_39 -> V_85 = F_24 ( ( sizeof( struct V_1 ) +
V_20 -> V_80 -> V_82 ) / 16 ) ;
V_39 -> V_86 = F_24 ( sizeof( struct V_87 ) / 16 ) ;
V_39 -> V_88 = V_20 -> V_80 -> V_88 ;
V_39 -> V_89 [ 0 ] . V_90 = F_23 ( 0x9c4 ) ;
V_39 -> V_89 [ 0 ] . V_91 = F_24 ( 0x10 ) ;
V_39 -> V_89 [ 0 ] . V_92 = F_24 ( 0x4 ) ;
...
if ( V_13 -> V_21 <= V_110 )
continue;
V_111 [ V_112 ++ ] = F_24 ( V_13 -> V_21 ) ;
if ( V_112 == V_109 / sizeof( T_5 ) )
break;
}
F_13 () ;
V_11 = F_19 ( V_8 , 0 , V_111 , V_109 ) ;
F_20 ( V_111 ) ;
V_23:
F_21 ( V_8 , V_11 ) ;
}
