...
int V_25 ;
T_1 V_33 , V_34 ;
V_13 = F_20 ( & V_9 -> V_29 , sizeof( * V_13 ) , V_35 ) ;
if ( ! V_13 )
return - V_36 ;
...
F_22 ( & V_13 -> V_11 , F_6 ) ;
F_23 ( V_9 , V_13 ) ;
V_25 = F_24 ( & V_9 -> V_29 , V_9 -> V_23 , F_15 , V_38 ,
L_8 , V_13 ) ;
if ( V_25 ) {
...
F_16 ( V_2 , V_13 -> V_19 + V_39 , & V_34 ) ;
F_16 ( V_2 , V_13 -> V_19 + V_40 , & V_33 ) ;
V_33 |= V_41 | V_42 ;
F_14 ( V_2 , V_13 -> V_19 + V_40 , V_33 ) ;
F_17 ( & V_9 -> V_29 , L_10 ,
V_34 & 0xf , F_25 ( V_34 , V_43 ) ,
F_25 ( V_34 , V_44 ) ,
F_25 ( V_34 , V_45 ) , ( V_34 >> 8 ) & 0xf ,
F_25 ( V_34 , V_46 ) ) ;
return V_25 ;
}
static void F_26 ( struct V_32 * V_9 )
{
struct V_12 * V_13 = F_27 ( V_9 ) ;
struct V_1 * V_2 = V_9 -> V_15 ;
T_1 V_33 ;
F_16 ( V_2 , V_13 -> V_19 + V_40 , & V_33 ) ;
V_33 &= ~ ( V_41 | V_42 ) ;
