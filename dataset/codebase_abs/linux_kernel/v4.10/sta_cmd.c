...
V_10 ) ;
V_268 -> V_13 = F_2 ( V_5 ) ;
V_268 -> V_271 = F_15 ( V_266 -> V_271 ) ;
V_268 -> V_44 = F_15 ( V_266 -> V_44 ) ;
return 0 ;
}
...
if ( V_13 != V_28 )
return 0 ;
V_297 -> V_302 = F_15 ( ( T_2 ) ( V_300 -> V_303 ) ) ;
V_297 -> V_304 =
F_15 ( ( T_2 ) ( ( ( V_305 ) V_300 -> V_303 ) >> 32 ) ) ;
V_297 -> V_306 = F_15 ( V_307 ) ;
V_297 -> V_308 = F_15 ( ( T_2 ) ( V_300 -> V_309 ) ) ;
V_297 -> V_310 =
F_15 ( ( T_2 ) ( ( ( V_305 ) V_300 -> V_309 ) >> 32 ) ) ;
V_297 -> V_311 = F_15 ( V_307 ) ;
V_297 -> V_312 = F_15 ( ( T_2 ) ( V_300 -> V_313 ) ) ;
V_297 -> V_314 =
F_15 ( ( T_2 ) ( ( ( V_305 ) V_300 -> V_313 ) >> 32 ) ) ;
V_297 -> V_315 = F_15 ( V_316 ) ;
if ( V_300 -> V_317 ) {
V_297 -> V_318 =
F_15 ( ( T_2 ) ( V_300 -> V_319 ) ) ;
V_297 -> V_320 = F_15 ( ( T_2 ) ( ( ( V_305 )
( V_300 -> V_319 ) ) >> 32 ) ) ;
F_4 ( V_2 -> V_29 , V_183 ,
L_22 ,
V_297 -> V_318 ) ;
...
if ( ! V_347 -> V_351 )
break;
* ( V_352 * ) V_349 = F_15 ( ( T_2 ) V_347 -> V_353 ) ;
V_349 += 4 ;
* V_349 = V_354 ;
V_349 += 1 ;
...
* V_349 = V_357 ;
V_349 += 1 ;
* ( V_352 * ) V_349 = F_15 ( ( T_2 ) V_347 -> V_277 ) ;
V_349 += 4 ;
* V_349 = V_354 ;
V_349 += 1 ;
* V_349 = V_347 -> V_351 ;
...
return 0 ;
if ( * V_391 )
V_395 -> V_78 = F_15 ( V_398 ) ;
else
V_395 -> V_78 = F_15 ( V_399 ) ;
return 0 ;
}
...
V_402 -> V_411 = F_15 ( ( T_2 ) V_403 ) ;
V_402 -> V_412 =
F_15 ( ( T_2 ) ( ( V_305 ) V_403 >> 32 ) ) ;
}
return 0 ;
}
...
F_6 ( & V_4 -> V_8 , F_7 ( V_425 -> V_127 . V_129 ) +
sizeof( struct V_61 ) ) ;
...
V_4 -> V_8 = F_2 ( V_10 ) ;
V_436 -> V_442 = F_2 ( V_5 ) ;
F_6 ( & V_4 -> V_8 , sizeof( V_436 -> V_442 ) ) ;
switch ( V_5 ) {
case V_443 :
V_440 = V_79 ;
V_129 = sizeof( * V_440 ) ;
...
V_4 -> V_6 = F_2 ( V_473 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
F_6 ( & V_4 -> V_8 , sizeof( struct V_451 ) ) ;
V_452 -> V_474 = 0 ;
...
break;
case V_56 :
V_237 = F_9 ( V_2 , V_516 , V_5 ,
V_79 ) ;
break;
case V_77 :
V_237 = F_11 ( V_516 , V_5 ,
V_79 ) ;
break;
case V_81 :
V_237 = F_12 ( V_2 , V_516 , V_5 ,
V_79 ) ;
break;
case V_88 :
...
V_516 -> V_11 . V_531 . V_532 = F_15 ( * ( T_2 * ) V_79 ) ;
V_516 -> V_8 =
