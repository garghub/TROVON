...
struct V_2 * F_72 ( struct V_122 * V_123 )
{
struct V_1 * V_6 ;
F_61 ( & V_120 ) ;
F_73 (dpaux, &dpaux_list, list)
if ( V_123 == V_6 -> V_60 -> V_124 ) {
F_63 ( & V_120 ) ;
return & V_6 -> V_3 ;
}
F_63 ( & V_120 ) ;
...
int F_74 ( struct V_2 * V_3 , struct V_125 * V_58 )
{
struct V_1 * V_6 = F_1 ( V_3 ) ;
unsigned long V_17 ;
int V_95 ;
V_58 -> V_59 . V_126 = V_127 ;
V_6 -> V_58 = V_58 ;
V_95 = F_75 ( V_6 -> V_107 ) ;
if ( V_95 < 0 )
return V_95 ;
V_17 = V_128 + F_15 ( 250 ) ;
while ( F_76 ( V_128 , V_17 ) ) {
enum V_129 V_18 ;
V_18 = F_77 ( V_3 ) ;
if ( V_18 == V_130 ) {
F_78 ( V_6 -> V_61 ) ;
...
enum V_129 F_77 ( struct V_2 * V_3 )
{
struct V_1 * V_6 = F_1 ( V_3 ) ;
T_1 V_9 ;
V_9 = F_4 ( V_6 , V_43 ) ;
...
int F_84 ( struct V_2 * V_3 , T_2 V_133 )
{
int V_95 ;
V_95 = F_85 ( V_3 , V_134 ,
V_133 ) ;
...
int F_86 ( struct V_2 * V_3 , struct V_135 * V_136 ,
T_2 V_137 )
{
T_2 V_138 = V_137 & V_139 ;
T_2 V_18 [ V_140 ] , V_141 [ 4 ] ;
unsigned int V_12 ;
int V_95 ;
V_95 = F_85 ( V_3 , V_142 , V_137 ) ;
if ( V_95 < 0 )
return V_95 ;
if ( V_138 == V_143 )
return 0 ;
for ( V_12 = 0 ; V_12 < V_136 -> V_144 ; V_12 ++ )
V_141 [ V_12 ] = V_145 |
V_146 |
V_147 |
V_148 ;
V_95 = F_87 ( V_3 , V_149 , V_141 ,
V_136 -> V_144 ) ;
if ( V_95 < 0 )
return V_95 ;
F_79 ( 500 , 1000 ) ;
...
switch ( V_138 ) {
case V_150 :
if ( ! F_89 ( V_18 , V_136 -> V_144 ) )
return - V_151 ;
break;
case V_152 :
if ( ! F_90 ( V_18 , V_136 -> V_144 ) )
return - V_151 ;
break;
default:
F_48 ( V_3 -> V_60 , L_14 , V_138 ) ;
return - V_20 ;
}
V_95 = F_85 ( V_3 , V_153 , 0 ) ;
if ( V_95 < 0 )
return V_95 ;
return 0 ;
}
