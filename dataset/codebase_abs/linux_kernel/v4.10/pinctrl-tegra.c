...
V_2 = F_51 ( & V_107 -> V_20 , sizeof( * V_2 ) , V_116 ) ;
if ( ! V_2 ) {
F_14 ( & V_107 -> V_20 , L_18 ) ;
return - V_117 ;
}
V_2 -> V_20 = & V_107 -> V_20 ;
V_2 -> V_9 = V_109 ;
V_2 -> V_112 = F_51 ( & V_107 -> V_20 ,
V_109 -> V_10 * 4 * sizeof( * V_2 -> V_112 ) ,
V_116 ) ;
if ( ! V_2 -> V_112 )
return - V_117 ;
V_112 = V_2 -> V_112 ;
for ( V_113 = 0 ; V_113 < V_109 -> V_42 ; V_113 ++ ) {
struct V_118 * V_119 = & V_109 -> V_43 [ V_113 ] ;
V_119 -> V_12 = V_112 ;
for ( V_114 = 0 ; V_114 < V_109 -> V_10 ; V_114 ++ ) {
const struct V_45 * V_46 = & V_109 -> V_12 [ V_114 ] ;
if ( V_46 -> V_47 == - 1 )
continue;
for ( V_115 = 0 ; V_115 < 4 ; V_115 ++ )
if ( V_46 -> V_48 [ V_115 ] == V_113 )
break;
if ( V_115 == 4 )
continue;
F_52 ( V_112 - V_2 -> V_112 >=
V_109 -> V_10 * 4 ) ;
* V_112 ++ = V_46 -> V_13 ;
V_119 -> V_10 ++ ;
}
}
V_120 . V_16 = V_2 -> V_9 -> V_121 ;
V_122 . V_13 = F_11 ( & V_107 -> V_20 ) ;
V_122 . V_14 = V_2 -> V_9 -> V_14 ;
V_122 . V_16 = V_2 -> V_9 -> V_16 ;
for ( V_29 = 0 ; ; V_29 ++ ) {
V_111 = F_53 ( V_107 , V_123 , V_29 ) ;
if ( ! V_111 )
break;
}
V_2 -> V_124 = V_29 ;
V_2 -> V_5 = F_51 ( & V_107 -> V_20 , V_2 -> V_124 * sizeof( * V_2 -> V_5 ) ,
V_116 ) ;
if ( ! V_2 -> V_5 ) {
F_14 ( & V_107 -> V_20 , L_19 ) ;
return - V_117 ;
}
for ( V_29 = 0 ; V_29 < V_2 -> V_124 ; V_29 ++ ) {
V_111 = F_53 ( V_107 , V_123 , V_29 ) ;
V_2 -> V_5 [ V_29 ] = F_54 ( & V_107 -> V_20 , V_111 ) ;
if ( F_55 ( V_2 -> V_5 [ V_29 ] ) )
return F_56 ( V_2 -> V_5 [ V_29 ] ) ;
}
V_2 -> V_125 = F_57 ( & V_107 -> V_20 , & V_122 , V_2 ) ;
if ( F_55 ( V_2 -> V_125 ) ) {
F_14 ( & V_107 -> V_20 , L_20 ) ;
return F_56 ( V_2 -> V_125 ) ;
}
F_46 ( V_2 ) ;
if ( ! F_47 () )
F_58 ( V_2 -> V_125 , & V_120 ) ;
F_59 ( V_107 , V_2 ) ;
F_60 ( & V_107 -> V_20 , L_21 ) ;
return 0 ;
}
