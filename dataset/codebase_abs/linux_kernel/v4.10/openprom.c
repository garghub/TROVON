...
static char * F_31 ( char T_1 * V_60 , T_4 V_15 )
{
if ( ( V_61 ) V_15 < 0 || ( V_61 ) ( V_15 + 1 ) < 0 )
return F_32 ( - V_7 ) ;
return F_33 ( V_60 , V_15 ) ;
}
...
return - V_5 ;
V_18 = F_30 ( V_19 . V_64 , V_29 ) ;
V_63 = F_31 ( V_19 . V_65 , V_19 . V_66 ) ;
if ( F_35 ( V_63 ) )
return F_36 ( V_63 ) ;
V_20 = F_10 ( V_18 , V_63 , & V_15 ) ;
V_37 = 0 ;
if ( ! V_20 || V_15 > V_19 . V_67 ) {
V_37 = - V_7 ;
} else {
V_19 . V_67 = V_15 ;
if ( F_8 ( V_16 , & V_19 , sizeof( V_19 ) ) ||
F_8 ( V_19 . V_68 , V_20 , V_15 ) )
V_37 = - V_5 ;
}
F_5 ( V_63 ) ;
return V_37 ;
...
return - V_5 ;
if ( V_15 &&
F_8 ( V_19 . V_68 , V_22 -> V_70 , V_15 ) )
return - V_5 ;
return 0 ;
}
static int F_38 ( void T_1 * V_16 , T_2 * V_29 )
{
struct V_62 V_19 ;
struct V_17 * V_18 ;
char * V_63 , * V_71 ;
...
if ( F_35 ( V_63 ) )
return F_36 ( V_63 ) ;
V_71 = F_31 ( V_19 . V_68 , V_19 . V_67 ) ;
if ( F_35 ( V_71 ) ) {
F_5 ( V_63 ) ;
return F_36 ( V_71 ) ;
}
V_37 = F_14 ( V_18 , V_63 , V_71 , V_19 . V_67 ) ;
F_5 ( V_63 ) ;
F_5 ( V_71 ) ;
return V_37 ;
}
static int F_39 ( unsigned int V_28 , void T_1 * V_16 )
{
struct V_17 * V_18 ;
T_3 V_72 ;
F_16 ( sizeof( T_3 ) != sizeof( int ) ) ;
if ( F_4 ( & V_72 , V_16 , sizeof( T_3 ) ) )
return - V_5 ;
if ( V_72 == 0 ) {
if ( V_28 != V_73 )
return - V_7 ;
...
static long F_41 ( struct V_41 * V_41 ,
unsigned int V_28 , unsigned long V_42 )
{
T_2 * V_29 = V_41 -> V_43 ;
switch ( V_28 ) {
...
static long F_42 ( struct V_41 * V_41 , unsigned int V_28 ,
unsigned long V_42 )
{
long V_84 = - V_85 ;
switch ( V_28 ) {
...
case V_52 :
case V_53 :
V_84 = F_41 ( V_41 , V_28 , V_42 ) ;
break;
}
return V_84 ;
}
static int F_43 ( struct V_86 * V_86 , struct V_41 * V_41 )
{
T_2 * V_29 ;
V_29 = F_44 ( sizeof( T_2 ) , V_9 ) ;
if ( ! V_29 )
return - V_10 ;
F_27 ( & V_46 ) ;
V_29 -> V_36 = F_18 ( L_1 ) ;
...
static int F_45 ( struct V_86 * V_86 , struct V_41 * V_41 )
{
F_5 ( V_41 -> V_43 ) ;
return 0 ;
}
