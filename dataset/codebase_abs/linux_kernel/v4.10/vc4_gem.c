...
F_81 (cb, cb_temp, &vc4->seqno_cb_list, work.entry) {
if ( V_162 -> V_93 <= V_4 -> V_98 ) {
F_82 ( & V_162 -> V_84 . V_165 ) ;
F_35 ( & V_162 -> V_84 ) ;
}
}
F_11 ( & V_4 -> V_24 , V_22 ) ;
}
static void F_83 ( struct V_83 * V_84 )
{
...
return F_87 ( V_2 , args -> V_93 ,
& args -> V_94 ) ;
}
int
F_90 ( struct V_1 * V_2 , void * V_14 ,
struct V_15 * V_16 )
{
int V_23 ;
...
if ( args -> V_174 != 0 )
return - V_124 ;
V_173 = F_91 ( V_16 , args -> V_31 ) ;
if ( ! V_173 ) {
F_60 ( L_11 , args -> V_31 ) ;
return - V_124 ;
}
V_13 = F_13 ( V_173 ) ;
V_23 = F_87 ( V_2 , V_13 -> V_93 ,
& args -> V_94 ) ;
F_7 ( V_173 ) ;
return V_23 ;
}
int
F_92 ( struct V_1 * V_2 , void * V_14 ,
struct V_15 * V_16 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
