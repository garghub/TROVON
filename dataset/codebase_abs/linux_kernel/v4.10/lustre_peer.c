...
int V_22 ;
V_17 = 1 ;
for ( V_22 = 0 ; V_22 < V_16 -> V_13 ; V_22 ++ )
if ( V_15 == V_16 -> V_14 [ V_22 ] )
break;
if ( V_22 == V_16 -> V_13 ) {
F_13 ( V_16 -> V_13 < V_23 ) ;
...
F_23 (data, temp, &deathrow, un_list) {
F_24 ( & V_7 -> V_24 ) ;
F_16 ( V_25 , L_4 ,
F_25 ( & V_7 -> V_12 ) ,
F_17 ( V_7 -> V_14 [ 0 ] ) ,
