...
F_11 (
L_51
L_52 , F_12 ( V_31 , V_29 , sizeof( V_29 ) ) ) ;
V_48 = 128 ;
}
return V_48 ;
}
...
V_54 = strrchr ( V_52 , '.' ) ;
if ( ! V_54 || ( strcmp ( V_54 , L_54 ) != 0 ) ) {
F_26 ( L_55 ,
V_52 ) ;
goto V_55;
}
V_54 [ 1 ] = 'o' ;
V_53 = fopen ( V_52 , L_56 ) ;
if ( ! V_53 ) {
F_26 ( L_57 ,
V_52 , strerror ( V_31 ) ) ;
goto V_55;
...
F_23 ( & V_7 , & V_44 ) ;
V_48 = F_28 () ;
snprintf ( V_62 , sizeof( V_62 ) , L_65 ,
V_48 ) ;
if ( F_21 ( & V_59 , NULL , 0 ) )
V_59 = 0 ;
