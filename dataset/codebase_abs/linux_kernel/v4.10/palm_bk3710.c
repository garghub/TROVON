...
void T_1 * V_1 = ( void T_1 * ) V_38 -> V_42 ;
...
static int F_18 ( T_6 * V_38 , const struct V_55 * V_56 )
{
...
static int T_7 F_21 ( struct V_62 * V_63 )
{
struct V_64 * V_64 ;
...
V_66 = F_26 ( V_63 , V_77 , 0 ) ;
if ( V_66 == NULL ) {
F_19 ( V_78 L_2 ) ;
return - V_75 ;
}
V_67 = F_26 ( V_63 , V_79 , 0 ) ;
if ( V_67 == NULL ) {
F_19 ( V_78 L_3 ) ;
return - V_75 ;
}
V_69 = F_27 ( V_66 ) ;
if ( F_28 ( V_66 -> V_80 , V_69 , L_4 ) == NULL ) {
F_19 ( V_78 L_5 ) ;
return - V_81 ;
}
V_1 = F_29 ( V_66 -> V_80 , V_69 ) ;
if ( ! V_1 ) {
F_19 ( V_78 L_6 ) ;
F_30 ( V_66 -> V_80 , V_69 ) ;
return - V_82 ;
...
for ( V_70 = 0 ; V_70 < V_83 - 2 ; V_70 ++ )
V_73 . V_84 [ V_70 ] = ( unsigned long )
( V_1 + V_61 + V_70 ) ;
V_73 . V_59 . V_85 = ( unsigned long )
( V_1 + V_86 ) ;
V_73 . V_67 = V_67 -> V_80 ;
V_73 . V_2 = & V_63 -> V_2 ;
V_87 . V_88 = V_68 < 100000000 ? V_89 :
V_90 ;
V_71 = F_31 ( & V_87 , V_74 , 1 , NULL ) ;
if ( V_71 )
goto V_91;
return 0 ;
V_91:
