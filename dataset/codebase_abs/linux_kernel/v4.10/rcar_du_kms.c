...
V_32 = F_49 ( V_11 , V_61 , V_52 , V_65 , V_64 ) ;
if ( V_32 && V_32 != - V_72 )
F_47 ( V_11 -> V_8 ,
L_11 ,
F_50 ( V_65 ) , V_52 , V_32 ) ;
...
{
V_11 -> V_81 . V_82 =
F_54 ( V_11 -> V_83 , 0 , L_13 , 0 , 255 ) ;
if ( V_11 -> V_81 . V_82 == NULL )
return - V_50 ;
V_11 -> V_81 . V_84 =
F_54 ( V_11 -> V_83 , 0 , L_14 ,
0 , 0x01ffffff ) ;
...
if ( V_32 < 0 )
return V_32 ;
V_32 = F_57 ( V_8 , ( 1 << V_11 -> V_77 -> V_98 ) - 1 ) ;
if ( V_32 < 0 )
return V_32 ;
...
V_100 -> V_103 = V_3 ;
V_100 -> V_98 = F_59 ( V_11 -> V_98 - 2 * V_3 , 2U ) ;
...
F_68 ( V_8 ) ;
if ( V_8 -> V_91 . V_114 ) {
V_29 = F_69 ( V_8 , 32 , V_8 -> V_91 . V_115 ,
V_8 -> V_91 . V_114 ) ;
if ( F_70 ( V_29 ) )
return F_71 ( V_29 ) ;
V_11 -> V_29 = V_29 ;
