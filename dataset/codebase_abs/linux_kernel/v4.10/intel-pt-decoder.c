...
{
const unsigned char * V_209 = V_4 -> V_59 + V_4 -> V_79 ;
T_3 V_2 ;
for ( V_2 = V_210 - 1 ; V_2 ; V_2 -- ) {
if ( V_2 > V_4 -> V_79 )
continue;
if ( ! memcmp ( V_209 - V_2 , V_211 , V_2 ) )
return V_2 ;
}
return 0 ;
}
static int F_60 ( struct V_3 * V_4 , int V_212 )
{
T_3 V_213 = V_210 - V_212 ;
const char * V_214 = V_211 ;
if ( V_213 > V_4 -> V_79 ||
memcmp ( V_4 -> V_59 , V_214 + V_212 , V_213 ) )
return 0 ;
return V_213 ;
}
...
if ( V_78 )
return V_78 ;
V_213 = F_60 ( V_4 , V_212 ) ;
if ( ! V_213 )
return 0 ;
V_4 -> V_35 -= V_212 ;
V_4 -> V_87 = V_4 -> V_59 + V_213 ;
V_4 -> V_88 = V_4 -> V_79 - V_213 ;
memcpy ( V_4 -> V_89 , V_211 , V_210 ) ;
V_4 -> V_59 = V_4 -> V_89 ;
V_4 -> V_79 = V_210 ;
return 0 ;
}
...
V_202 = F_63 ( V_4 -> V_59 , V_4 -> V_79 , V_211 ,
V_210 ) ;
if ( ! V_202 ) {
int V_212 ;
V_212 = F_59 ( V_4 ) ;
...
{
T_1 V_216 = V_4 -> V_141 << 1 ;
if ( ! V_4 -> V_105 || ! V_4 -> V_20 )
goto V_157;
V_216 *= V_4 -> V_20 ;
V_216 /= V_4 -> V_105 ;
V_157:
return V_4 -> V_82 + V_216 ;
}
const struct V_217 * F_66 ( struct V_3 * V_4 )
{
int V_39 ;
do {
V_4 -> V_83 . type = V_188 ;
...
if ( V_79 < V_210 )
return false ;
return F_63 ( V_59 , V_210 , V_211 ,
V_210 ) ;
}
static bool F_68 ( unsigned char * * V_59 , T_3 * V_79 )
{
unsigned char * V_202 ;
V_202 = F_63 ( * V_59 , * V_79 , V_211 , V_210 ) ;
if ( V_202 ) {
* V_79 -= V_202 - * V_59 ;
* V_59 = V_202 ;
return true ;
...
if ( ! * V_79 )
return false ;
V_202 = F_63 ( * V_59 + 1 , * V_79 - 1 , V_211 , V_210 ) ;
if ( V_202 ) {
* V_79 -= V_202 - * V_59 ;
* V_59 = V_202 ;
return true ;
...
V_220 = V_79 - V_210 + 1 ;
while ( 1 ) {
V_219 = F_71 ( V_59 , V_11 [ 0 ] , V_220 ) ;
if ( ! V_219 )
return NULL ;
if ( ! memcmp ( V_219 + 1 , V_11 + 1 , V_210 - 1 ) )
return V_219 ;
V_220 = V_219 - V_59 ;
if ( ! V_220 )
return NULL ;
...
static bool F_72 ( unsigned char * V_59 , T_3 V_79 , T_1 * V_221 )
{
struct V_63 V_64 ;
int V_78 ;
while ( V_79 ) {
...
static int F_73 ( T_1 V_222 , T_1 V_223 )
{
const T_1 V_224 = ( 1ULL << 55 ) ;
if ( V_222 == V_223 )
return 0 ;
if ( V_222 < V_223 ) {
if ( V_223 - V_222 < V_224 )
return - 1 ;
else
return 1 ;
} else {
...
static unsigned char * F_74 ( unsigned char * V_225 ,
T_3 V_226 ,
unsigned char * V_227 ,
T_3 V_228 )
{
...
unsigned char * V_219 ;
T_3 V_79 ;
V_219 = F_70 ( V_225 , V_226 ) ;
if ( ! V_219 )
return V_227 ;
V_79 = V_226 - ( V_219 - V_225 ) ;
if ( ! F_72 ( V_219 , V_79 , & V_229 ) ) {
V_226 -= V_79 ;
V_219 = F_70 ( V_225 , V_226 ) ;
if ( ! V_219 )
return V_227 ;
...
unsigned char * F_75 ( unsigned char * V_225 , T_3 V_226 ,
unsigned char * V_227 , T_3 V_228 ,
bool V_231 )
{
unsigned char * V_232 ;
if ( ! F_68 ( & V_227 , & V_228 ) )
...
return V_227 ;
if ( V_231 ) {
V_232 = F_74 ( V_225 , V_226 , V_227 , V_228 ) ;
if ( V_232 )
return V_232 ;
}
while ( V_228 < V_226 ) {
...
if ( V_228 > V_226 ) {
while ( ! F_67 ( V_227 + V_226 , V_228 - V_226 ) ) {
if ( ! F_69 ( & V_225 , & V_226 ) )
return V_227 ;
}
}
while ( 1 ) {
V_232 = F_63 ( V_225 , V_226 , V_227 , V_226 ) ;
if ( V_232 )
return V_227 + V_226 ;
if ( ! F_69 ( & V_225 , & V_226 ) )
return V_227 ;
