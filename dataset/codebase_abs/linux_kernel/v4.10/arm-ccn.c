...
static int F_96 ( unsigned int V_46 , struct V_156 * V_1 )
{
struct V_147 * V_39 = F_97 ( V_1 , struct V_147 , V_1 ) ;
struct V_15 * V_16 = F_5 ( V_39 , struct V_15 , V_39 ) ;
unsigned int V_157 ;
if ( ! F_98 ( V_46 , & V_39 -> V_46 ) )
return 0 ;
V_157 = F_99 ( V_158 , V_46 ) ;
if ( V_157 >= V_159 )
return 0 ;
F_100 ( & V_39 -> V_61 , V_46 , V_157 ) ;
F_101 ( V_157 , & V_39 -> V_46 ) ;
if ( V_16 -> V_141 )
...
V_16 -> V_39 . V_128 = F_106 ( & V_172 , 0 , 0 , V_173 ) ;
if ( V_16 -> V_39 . V_128 == 0 ) {
V_37 = L_25 ;
} else {
int V_174 = snprintf ( NULL , 0 , L_26 , V_16 -> V_39 . V_128 ) ;
V_37 = F_107 ( V_16 -> V_7 , V_174 + 1 , V_173 ) ;
...
if ( ! V_16 -> V_141 ) {
F_108 ( V_16 -> V_7 , L_27 ) ;
F_109 ( & V_16 -> V_39 . V_142 , V_187 ,
V_188 ) ;
V_16 -> V_39 . V_142 . V_189 = F_92 ;
}
F_101 ( F_110 () , & V_16 -> V_39 . V_46 ) ;
if ( V_16 -> V_141 ) {
...
V_45 = F_112 ( & V_16 -> V_39 . V_61 , V_37 , - 1 ) ;
if ( V_45 )
goto V_191;
F_113 ( V_192 ,
& V_16 -> V_39 . V_1 ) ;
...
F_42 ( 0 , V_16 -> V_72 [ V_38 ] . V_97 + V_167 ) ;
F_42 ( 0 , V_16 -> V_39 . V_97 + V_145 ) ;
F_117 ( & V_16 -> V_39 . V_61 ) ;
F_114 ( & V_172 , V_16 -> V_39 . V_128 ) ;
}
static int F_118 ( struct V_15 * V_16 ,
int (* F_119)( struct V_15 * V_16 , int V_193 ,
...
void T_8 * V_97 ;
int V_45 ;
V_106 = F_43 ( V_16 -> V_97 + V_195 +
4 * ( V_193 / 32 ) ) ;
if ( ! ( V_106 & ( 1 << ( V_193 % 32 ) ) ) )
continue;
V_97 = V_16 -> V_97 + V_193 * V_160 ;
V_106 = F_43 ( V_97 + V_196 ) ;
type = ( V_106 >> V_197 ) &
V_198 ;
V_128 = ( V_106 >> V_199 ) &
V_200 ;
V_45 = F_119 ( V_16 , V_193 , V_97 , type , V_128 ) ;
if ( V_45 )
return V_45 ;
}
return 0 ;
}
static int F_120 ( struct V_15 * V_16 , int V_193 ,
void T_8 * V_97 , T_2 type , T_2 V_128 )
{
...
static int F_121 ( struct V_15 * V_16 , int V_193 ,
void T_8 * V_97 , T_2 type , T_2 V_128 )
{
struct V_65 * V_201 ;
F_28 ( V_16 -> V_7 , L_29 , V_193 , V_128 , type ) ;
switch ( type ) {
case V_25 :
V_16 -> V_26 = V_128 ;
return 0 ;
...
return 0 ;
case V_23 :
V_201 = & V_16 -> V_72 [ V_128 ] ;
break;
case V_34 :
V_16 -> V_35 = 1 ;
V_201 = & V_16 -> V_1 [ V_128 ] ;
break;
case V_32 :
V_16 -> V_33 = 1 ;
default:
...
static T_7 F_122 ( struct V_15 * V_16 ,
const T_2 * V_203 )
{
F_111 ( V_16 -> V_7 , L_30 ,
V_203 [ 5 ] , V_203 [ 4 ] , V_203 [ 3 ] ,
V_203 [ 2 ] , V_203 [ 1 ] , V_203 [ 0 ] ) ;
F_111 ( V_16 -> V_7 , L_31 ) ;
F_42 ( V_204 ,
V_16 -> V_97 + V_205 ) ;
return V_153 ;
}
static T_7 F_123 ( int V_141 , void * V_206 )
{
T_7 V_19 = V_150 ;
struct V_15 * V_16 = V_206 ;
T_2 V_203 [ 6 ] ;
T_2 V_207 ;
int V_38 ;
V_207 = V_203 [ 0 ] = F_43 ( V_16 -> V_97 + V_208 ) ;
if ( V_207 & V_209 ) {
V_207 &= ~ V_209 ;
V_19 = F_89 ( & V_16 -> V_39 ) ;
}
for ( V_38 = 1 ; V_38 < F_35 ( V_203 ) ; V_38 ++ ) {
V_203 [ V_38 ] = F_43 ( V_16 -> V_97 +
V_208 + V_38 * 4 ) ;
V_207 |= V_203 [ V_38 ] ;
}
if ( V_207 )
V_19 |= F_122 ( V_16 , V_203 ) ;
if ( V_19 != V_150 )
F_42 ( V_210 ,
V_16 -> V_97 + V_205 ) ;
return V_19 ;
...
unsigned int V_141 ;
int V_45 ;
V_16 = F_107 ( & V_212 -> V_7 , sizeof( * V_16 ) , V_173 ) ;
if ( ! V_16 )
return - V_214 ;
V_16 -> V_7 = & V_212 -> V_7 ;
F_125 ( V_212 , V_16 ) ;
V_19 = F_126 ( V_212 , V_215 , 0 ) ;
if ( ! V_19 )
return - V_43 ;
if ( ! F_127 ( V_16 -> V_7 , V_19 -> V_182 ,
F_128 ( V_19 ) , V_212 -> V_37 ) )
return - V_216 ;
V_16 -> V_97 = F_129 ( V_16 -> V_7 , V_19 -> V_182 ,
F_128 ( V_19 ) ) ;
if ( ! V_16 -> V_97 )
return - V_217 ;
V_19 = F_126 ( V_212 , V_218 , 0 ) ;
if ( ! V_19 )
return - V_43 ;
V_141 = V_19 -> V_182 ;
F_42 ( V_219 ,
V_16 -> V_97 + V_205 ) ;
if ( F_43 ( V_16 -> V_97 + V_205 ) &
V_220 ) {
F_42 ( V_221 ,
V_16 -> V_97 + V_205 ) ;
V_45 = F_130 ( V_16 -> V_7 , V_141 , F_123 ,
V_222 | V_223 ,
F_131 ( V_16 -> V_7 ) , V_16 ) ;
if ( V_45 )
return V_45 ;
...
V_45 = F_118 ( V_16 , F_120 ) ;
if ( V_45 )
return V_45 ;
V_16 -> V_1 = F_107 ( V_16 -> V_7 , sizeof( * V_16 -> V_1 ) * V_16 -> V_90 ,
V_173 ) ;
V_16 -> V_72 = F_107 ( V_16 -> V_7 , sizeof( * V_16 -> V_1 ) * V_16 -> V_89 ,
V_173 ) ;
if ( ! V_16 -> V_1 || ! V_16 -> V_72 )
return - V_214 ;
V_45 = F_118 ( V_16 , F_121 ) ;
if ( V_45 )
return V_45 ;
return F_103 ( V_16 ) ;
}
