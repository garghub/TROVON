...
struct V_45 V_46 = { 0 } ;
T_1 V_3 , V_6 ;
int V_13 , V_14 , V_12 = F_5 ( V_9 ) ;
V_14 = F_6 ( V_11 -> V_15 . V_16 , V_11 -> V_17 , & V_3 ) ;
if ( V_14 )
return V_14 ;
V_6 = F_1 ( & V_11 -> V_2 , V_3 ) ;
V_46 . V_32 = F_16 ( & V_11 -> V_33 , V_3 ) + 1 ;
for ( V_13 = 0 ; V_13 < V_12 ; V_13 ++ ) {
if ( V_6 == V_11 -> V_2 . V_19 [ V_13 ] . V_20 ) {
V_46 . V_6 = V_11 -> V_2 . V_19 [ V_13 ] . V_6 ;
return F_40 ( V_11 , & V_46 ) ;
}
}
return - V_62 ;
...
for (; V_72 -> V_76 ; V_72 ++ ) {
V_74 = ( V_60 -> V_54 * V_72 -> V_77 ) / V_72 -> V_76 ;
V_75 = F_39 ( V_60 -> V_64 , V_74 ) ;
if ( ( V_75 < ( V_74 - V_70 ) ) ||
( V_75 > ( V_74 + V_70 ) ) )
continue;
V_60 -> V_65 = V_75 ;
V_60 -> V_54 = ( V_75 * V_72 -> V_76 ) / V_72 -> V_77 ;
return 0 ;
}
return - V_62 ;
}
...
unsigned long V_54 , unsigned long V_57 , T_2 V_27 )
{
return F_48 ( V_9 , V_54 , V_57 ) ;
}
static int F_50 ( struct V_8 * V_9 ,
struct V_59 * V_60 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
int V_78 = F_10 ( V_11 -> V_33 . V_35 ) ;
int div ;
unsigned long V_75 ;
if ( V_60 -> V_54 == 0 )
return - V_62 ;
...
static int F_51 ( struct V_8 * V_9 , unsigned long V_54 ,
unsigned long V_57 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_45 V_46 = { 0 } ;
...
unsigned long V_54 , unsigned long V_57 , T_2 V_27 )
{
return F_51 ( V_9 , V_54 , V_57 ) ;
}
static int F_53 ( struct V_8 * V_9 , unsigned long V_54 ,
unsigned long V_57 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
const struct V_45 * V_46 ;
...
if ( ! V_46 )
return - V_62 ;
F_41 ( V_11 -> V_15 . V_16 , V_11 -> V_17 , V_79 , 0 ) ;
V_14 = F_40 ( V_11 , V_46 ) ;
if ( F_24 ( V_9 -> V_52 ) )
F_41 ( V_11 -> V_15 . V_16 , V_11 -> V_17 , V_79 , V_79 ) ;
return V_14 ;
}
...
struct V_10 * V_11 = F_4 ( V_9 ) ;
T_1 V_79 = F_10 ( 10 ) ;
return F_41 ( V_11 -> V_15 . V_16 , V_11 -> V_17 , V_79 , V_79 ) ;
}
...
static int F_56 ( struct V_8 * V_9 , unsigned long V_54 )
{
struct V_22 * V_11 = F_12 ( V_9 ) ;
const struct V_45 * V_46 ;
V_46 = F_32 ( V_11 -> V_45 , V_54 ) ;
...
static int F_57 ( struct V_8 * V_9 , unsigned long V_54 ,
unsigned long V_57 )
{
return F_56 ( V_9 , V_54 ) ;
}
