...
{
struct V_1 * V_66 = F_1 ( V_3 ) ;
T_1 V_6 = V_161 + ( T_1 ) V_160 -> V_160 ;
if ( ( V_6 & 0x3 ) != 0 )
return - V_162 ;
if ( V_6 < V_25 || V_6 > V_163 )
return - V_162 ;
V_160 -> V_164 = 4 ;
V_160 -> V_165 = F_5 ( V_66 -> V_5 , V_6 ) ;
return 0 ;
}
...
struct V_121 V_166 ;
int V_167 ;
V_66 = F_73 ( sizeof( struct V_1 ) , V_168 ) ;
if ( V_66 == NULL )
return - V_169 ;
F_74 ( & V_66 -> V_101 ) ;
if ( F_75 ( & V_66 -> V_100 , V_105 , V_168 ) )
return - V_169 ;
V_66 -> V_5 = V_5 ;
V_3 = & V_66 -> V_3 ;
F_76 ( V_3 , & V_170 ) ;
F_77 ( V_3 , V_66 ) ;
snprintf ( V_3 -> V_171 , sizeof( V_3 -> V_171 ) , L_66 , V_5 -> V_171 ) ;
V_3 -> V_172 = V_173 ;
V_167 = F_78 ( & V_5 -> V_174 , V_3 ) ;
if ( V_167 == 0 ) {
F_3 ( V_5 , V_62 , 0 ) ;
F_79 ( & V_66 -> V_122 ) ;
V_166 = V_175 ;
F_80 ( V_3 , V_176 , V_177 , & V_166 ) ;
F_79 ( & V_66 -> V_141 ) ;
V_166 = V_178 ;
F_80 ( V_3 , V_176 , V_179 , & V_166 ) ;
} else {
F_81 ( & V_66 -> V_100 ) ;
}
return V_167 ;
