...
{
struct V_53 * V_54 = F_21 ( & V_12 -> V_19 ) ;
struct V_6 * V_7 ;
struct V_24 * V_25 ;
struct V_55 * V_56 ;
int V_28 ;
...
V_25 = F_28 ( & V_12 -> V_19 , sizeof( * V_7 ) ) ;
if ( ! V_25 ) {
V_28 = - V_57 ;
goto V_58;
}
...
V_7 -> V_1 = V_54 -> V_1 ;
V_7 -> V_12 = V_12 ;
V_7 -> V_48 = F_30 ( V_12 ) -> V_59 ;
V_7 -> V_56 = V_56 ;
V_25 -> V_19 . V_60 = & V_12 -> V_19 ;
V_25 -> V_61 = F_30 ( V_12 ) -> V_61 ;
switch ( V_7 -> V_48 ) {
case V_49 :
case V_50 :
V_25 -> V_62 = & V_63 ;
...
V_25 -> V_65 = V_66 ;
V_7 -> V_67 . V_68 = & V_7 -> V_16 ;
V_7 -> V_67 . V_23 = 2 ;
F_31 ( & V_7 -> V_17 ) ;
F_32 ( & V_7 -> V_67 , & V_7 -> V_17 ) ;
V_7 -> V_69 [ 0 ] . V_68 = & V_7 -> V_11 [ 0 ] ;
V_7 -> V_69 [ 0 ] . V_23 = 2 ;
V_7 -> V_69 [ 0 ] . V_70 = 1 ;
V_7 -> V_69 [ 1 ] . V_68 = & V_7 -> V_11 [ 1 ] ;
V_7 -> V_69 [ 1 ] . V_23 = 2 ;
F_31 ( & V_7 -> V_13 ) ;
F_32 ( & V_7 -> V_69 [ 0 ] , & V_7 -> V_13 ) ;
F_32 ( & V_7 -> V_69 [ 1 ] , & V_7 -> V_13 ) ;
V_7 -> V_39 = V_71 | V_45 ;
if ( ! V_54 -> V_72 )
V_7 -> V_39 |= V_73 ;
if ( ! V_54 -> V_74 && ( V_7 -> V_48 == V_75 ) )
V_7 -> V_39 |= V_76 ;
V_7 -> V_16 = F_5 ( V_41 | V_7 -> V_39 ) ;
V_28 = F_7 ( V_7 -> V_12 , & V_7 -> V_17 ) ;
if ( V_28 ) {
...
V_28 = F_4 ( V_7 , V_34 , V_54 -> V_77 ) ;
if ( V_28 )
goto V_58;
V_28 = F_4 ( V_7 , V_35 , V_54 -> V_78 ) ;
if ( V_28 )
goto V_58;
V_28 = F_8 ( V_7 , V_36 , V_54 -> V_79 ) ;
if ( V_28 )
goto V_58;
V_28 = F_8 ( V_7 , V_37 , V_54 -> V_80 ) ;
if ( V_28 )
goto V_58;
V_28 = F_33 ( V_25 ) ;
if ( V_28 )
...
static int F_35 ( struct V_52 * V_12 )
{
struct V_24 * V_25 = F_36 ( V_12 ) ;
struct V_6 * V_7 = F_11 ( V_25 ) ;
F_37 ( V_25 ) ;
F_34 ( V_7 -> V_56 ) ;
return 0 ;
