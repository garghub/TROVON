...
static long F_17 ( struct V_38 * V_39 , unsigned long V_44 ,
unsigned long * V_45 )
{
int V_46 ;
for ( V_46 = 0 ; V_46 < F_18 ( V_43 ) ; V_46 ++ )
if ( V_43 [ V_46 ] <= V_44 )
return V_43 [ V_46 ] ;
return 0 ;
}
static int F_19 ( struct V_38 * V_39 , unsigned long V_44 ,
unsigned long V_40 )
{
struct V_7 * V_7 = F_16 ( V_39 ) ;
struct V_5 * V_6 = V_7 -> V_6 ;
...
static int F_20 ( struct V_38 * V_39 , bool V_47 )
{
struct V_7 * V_7 = F_16 ( V_39 ) ;
struct V_5 * V_6 = V_7 -> V_6 ;
int V_9 = F_12 ( V_6 , V_41 ) ;
...
{
struct V_7 * V_7 = (struct V_7 * ) V_64 ;
struct V_5 * V_6 = V_7 -> V_6 ;
struct V_65 * V_66 = & V_7 -> V_67 -> V_68 ;
int V_30 , V_9 ;
F_31 ( V_66 ) ;
V_30 = F_12 ( V_6 , V_31 ) ;
if ( V_30 < 0 ) {
...
struct V_7 * V_7 ;
int V_9 ;
V_7 = F_41 ( & V_6 -> V_2 , sizeof( * V_7 ) , V_78 ) ;
if ( ! V_7 )
return - V_79 ;
V_7 -> V_6 = V_6 ;
F_42 ( V_6 , V_7 ) ;
...
F_45 ( & V_6 -> V_2 , L_9 ,
V_7 -> V_10 ? L_10 : L_11 ) ;
V_7 -> V_67 = F_46 ( & V_6 -> V_2 , V_6 -> V_55 ,
& V_83 , V_84 ) ;
if ( F_28 ( V_7 -> V_67 ) )
return F_47 ( V_7 -> V_67 ) ;
V_7 -> V_67 -> V_85 = 1 ;
#ifdef F_48
F_24 ( V_7 ) ;
#endif
