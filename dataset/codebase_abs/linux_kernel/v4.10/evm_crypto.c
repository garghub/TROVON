...
& V_71 ,
sizeof( V_71 ) , 0 ) ;
} else if ( V_3 == - V_64 && ( V_33 -> V_61 & V_62 ) ) {
V_3 = F_31 ( V_53 , V_72 ) ;
}
return V_3 ;
}
int F_32 ( struct V_33 * V_33 , const struct V_73 * V_74 ,
char * V_75 )
{
struct V_14 * V_18 ;
V_18 = F_6 ( V_19 ) ;
...
struct V_79 * V_80 ;
int V_3 ;
V_78 = F_34 ( & V_81 , V_82 , NULL ) ;
if ( F_10 ( V_78 ) )
return - V_83 ;
F_35 ( & V_78 -> V_84 ) ;
V_80 = V_78 -> V_85 . V_86 [ 0 ] ;
V_3 = F_1 ( V_80 -> V_87 , V_80 -> V_88 ) ;
memset ( V_80 -> V_87 , 0 , V_80 -> V_88 ) ;
F_36 ( & V_78 -> V_84 ) ;
F_37 ( V_78 ) ;
return V_3 ;
}
