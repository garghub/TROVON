...
static void F_129 ( T_8 * V_203 , char * V_204 )
{
char V_205 , * V_206 ;
int V_111 ;
...
{
if ( ! F_144 ( L_9 , V_228 , V_70 -> V_229 , & V_230 ) )
return - V_231 ;
return 0 ;
}
static void T_11 F_145 ( struct V_70 * V_70 )
{
F_146 ( L_9 , V_70 -> V_229 ) ;
}
