...
{
T_3 V_26 = 0 ;
struct V_44 * V_34 = V_2 -> V_34 ;
T_3 V_20 =
F_25 ( V_34 , V_43 , V_23 , V_45 ) ;
if ( ! F_26 ( V_34 , V_20 ) ) {
...
void
F_28 ( struct V_1 * V_2 , T_3 V_26 , T_5 V_23 )
{
struct V_44 * V_34 = V_2 -> V_34 ;
T_3 V_20 = F_17 ( V_2 , V_26 ) ;
F_22 ( V_2 , V_26 , V_23 ) ;
F_27 ( V_34 , V_20 , V_23 , V_45 ) ;
}
...
T_3 V_20 ;
struct V_15 * V_16 ;
V_2 -> V_3 = F_30 ( sizeof( * V_2 -> V_3 ) , V_47 ) ;
if ( ! V_2 -> V_3 )
return - V_48 ;
V_16 = V_2 -> V_3 ;
V_2 -> V_21 -> V_49 ( V_2 ) ;
V_16 -> V_18 = F_20 ( V_16 -> V_4 . V_10 ,
sizeof( * V_16 -> V_18 ) , V_47 ) ;
if ( ! V_16 -> V_18 ) {
V_46 = - V_48 ;
goto V_50;
}
