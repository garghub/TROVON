...
static int F_29 ( struct V_85 * V_86 , unsigned long V_87 ,
void * V_5 )
{
struct V_6 * V_7 =
...
struct V_97 * V_98 = V_7 -> V_71 ;
V_96 -> V_81 = V_98 -> V_81 ;
V_96 -> V_99 = V_98 -> V_99 ;
V_96 -> type = V_100 ;
V_96 -> V_101 = F_26 ;
V_96 -> V_102 = V_103 ;
V_96 -> V_104 = F_34 ( V_103 ) ;
}
static int F_35 ( struct V_6 * V_7 )
{
char V_105 [ 5 ] ;
int V_106 ;
V_105 [ 0 ] = V_105 [ 1 ] = V_7 -> V_41 . V_46 ;
V_105 [ 2 ] = V_7 -> V_41 . V_50 ;
V_105 [ 3 ] = V_7 -> V_41 . V_94 ;
V_105 [ 4 ] = V_7 -> V_41 . V_51 ;
V_106 = F_36 ( V_7 -> V_28 , V_44 , 5 , V_105 ) ;
if ( V_106 )
return V_106 ;
V_106 = F_18 ( V_7 -> V_28 , V_107 ,
V_108 |
V_109 ) ;
if ( V_106 )
return V_106 ;
return F_18 ( V_7 -> V_28 , V_110 ,
V_111 | V_112 |
V_113 | V_114 |
V_115 |
V_116 ) ;
...
struct V_6 * V_7 ;
struct V_119 V_120 = {} ;
struct V_92 * V_93 = V_118 -> V_121 . V_122 ;
int V_106 ;
if ( V_93 == NULL )
return - V_123 ;
if ( V_93 -> V_38 >= 1500 ||
...
V_93 -> V_39 > 4350 )
return - V_123 ;
V_7 = F_38 ( & V_118 -> V_121 , sizeof( * V_7 ) , V_124 ) ;
if ( V_7 == NULL )
return - V_125 ;
V_7 -> V_28 = V_118 -> V_121 . V_126 ;
V_7 -> V_54 = F_39 (
( V_93 -> V_127 ? : 10 ) * 1000 ) ;
V_7 -> V_38 = V_93 -> V_38 ;
V_7 -> V_39 = V_93 -> V_39 ;
...
F_33 ( V_7 ) ;
V_120 . V_131 = V_7 ;
V_7 -> V_40 = F_42 ( & V_118 -> V_121 , & V_7 -> V_96 ,
& V_120 ) ;
if ( F_43 ( V_7 -> V_40 ) ) {
V_106 = F_44 ( V_7 -> V_40 ) ;
goto V_132;
...
static int F_48 ( struct V_117 * V_121 )
{
struct V_6 * V_7 = F_49 ( V_121 ) ;
F_10 ( V_7 ) ;
F_46 ( V_7 -> V_28 , & V_7 -> V_86 ,
V_88 | V_89 |
V_90 | V_91 ) ;
