...
static int F_32 ( struct V_107 * V_6 , T_2 V_110 )
{
struct V_3 * V_3 = V_6 -> V_109 ;
T_3 V_111 = 0 ;
T_3 V_62 = V_6 -> V_112 ;
...
V_39 , 0 ) ;
if ( ( V_46 && V_111 != 0 ) || V_3 -> V_116 )
goto V_59;
V_47 [ 0 ] = V_53 ;
V_47 [ 1 ] = V_110 == V_114 ? 0 : 1 ;
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 0 ) ;
if ( V_46 )
goto V_59;
...
goto V_59;
if ( V_6 -> V_61 . V_106 [ 0 ] ) {
T_5 V_129 = strlen ( V_6 -> V_61 . V_106 ) ;
char * V_130 = V_47 + 1 ;
V_47 [ 0 ] = V_131 ;
strncpy ( V_47 + 1 , V_6 -> V_61 . V_106 , 13 ) ;
if ( V_129 < 4 ) {
memset ( V_130 + V_129 , ' ' , 4 - V_129 ) ;
V_129 = 4 ;
V_130 [ V_129 ] = '\0' ;
strcpy ( V_6 -> V_61 . V_106 , V_130 ) ;
}
V_46 = F_22 ( V_3 , V_47 , 1 + V_129 ,
V_39 , 0 ) ;
if ( V_46 )
goto V_59;
}
...
static int F_33 ( struct V_107 * V_6 , T_2 V_133 ,
T_6 V_134 , struct V_25 * V_26 )
{
struct V_3 * V_3 = V_6 -> V_109 ;
T_2 V_47 [ 2 ] ;
unsigned int V_135 ;
...
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
V_47 [ 0 ] = V_26 -> V_32 == 1 ? V_138 : V_139 ;
V_47 [ 1 ] = V_26 -> V_26 [ 0 ] ;
if ( ! V_46 )
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
if ( ! V_46 && V_26 -> V_32 > 1 ) {
V_47 [ 0 ] = V_26 -> V_32 == 2 ? V_138 :
V_139 ;
V_47 [ 1 ] = V_26 -> V_26 [ 1 ] ;
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
for ( V_135 = 0 ; ! V_46 && V_135 + 2 < V_26 -> V_32 ; V_135 ++ ) {
V_47 [ 0 ] = ( V_135 + 2 == V_26 -> V_32 - 1 ) ?
V_138 : V_139 ;
V_47 [ 1 ] = V_26 -> V_26 [ V_135 + 2 ] ;
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
}
}
...
static int F_35 ( struct V_107 * V_6 , struct V_25 * V_26 )
{
return - V_140 ;
}
static int F_36 ( struct V_16 * V_16 , struct V_141 * V_142 )
{
T_6 V_143 = V_144 | V_145 | V_146 |
V_147 | V_148 | V_149 ;
struct V_3 * V_3 ;
int V_46 = - V_150 ;
struct V_60 V_61 = {} ;
T_3 V_62 = V_67 ;
V_3 = F_37 ( sizeof( * V_3 ) , V_151 ) ;
if ( ! V_3 )
return - V_150 ;
V_3 -> V_16 = V_16 ;
V_3 -> V_6 = F_38 ( & V_152 , V_3 ,
L_17 , V_143 , 1 ) ;
V_46 = F_39 ( V_3 -> V_6 ) ;
if ( V_46 < 0 )
goto V_153;
...
F_41 ( & V_3 -> V_113 ) ;
V_3 -> V_132 = false ;
V_46 = F_42 ( V_16 , V_142 ) ;
if ( V_46 )
goto V_154;
V_46 = F_25 ( V_3 , V_16 , & V_61 , & V_62 ) ;
if ( V_46 )
goto V_155;
V_46 = F_43 ( V_3 -> V_6 , & V_16 -> V_28 ) ;
if ( V_46 < 0 )
goto V_155;
V_3 -> V_28 = & V_3 -> V_6 -> V_156 . V_28 ;
if ( V_157 && V_3 -> V_75 ) {
...
static void V_158 ( struct V_1 * V_2 )
{
struct V_3 * V_3 =
