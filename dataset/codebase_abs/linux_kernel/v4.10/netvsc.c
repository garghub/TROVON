...
V_45 =
F_45 ( & V_1 -> V_45 ) ;
V_139 = F_45 ( & V_1 -> V_139 [ V_138 ] ) ;
if ( V_1 -> V_34 && V_45 == 0 )
F_46 ( & V_1 -> V_33 ) ;
if ( F_47 ( F_48 ( V_2 , V_138 ) ) &&
! V_5 -> V_146 &&
( F_38 ( & V_24 -> V_147 ) > V_148 ||
V_139 < 1 ) )
F_49 ( F_48 ( V_2 , V_138 ) ) ;
}
static void F_50 ( struct V_9 * V_1 ,
struct V_131 * V_132 ,
struct V_6 * V_43 ,
struct V_133 * V_134 )
{
...
static T_1 F_52 ( struct V_9 * V_1 )
{
unsigned long V_130 ;
T_1 V_156 = V_1 -> V_90 ;
...
if ( ! ~ ( V_157 [ V_41 ] ) )
continue;
V_130 = F_53 ( V_157 [ V_41 ] ) ;
V_160 = F_54 ( V_130 , & V_157 [ V_41 ] ) ;
if ( V_160 )
continue;
...
static T_1 F_55 ( struct V_9 * V_1 ,
unsigned int V_161 ,
T_1 V_162 ,
struct V_140 * V_134 ,
struct V_163 * V_164 ,
...
char * V_180 = F_56 ( ( * V_166 ) [ V_41 ] . V_181 << V_182 ) ;
...
static inline void F_62 ( struct V_140 * * V_199 ,
struct V_135 * * V_200 ,
struct V_201 * V_202 )
{
* V_200 = V_202 -> V_136 ;
...
V_209:
if ( V_207 )
V_48 = F_57 ( V_43 , V_207 , V_1 , V_166 , V_136 ) ;
if ( V_48 != 0 && V_161 != V_145 )
F_40 ( V_1 , V_161 ) ;
return V_48 ;
}
static int F_65 ( struct V_131 * V_24 ,
T_3 V_213 , T_1 V_77 )
{
struct V_12 V_214 ;
int V_48 ;
...
static inline void F_66 ( struct V_9 * V_11 , T_2 V_138 ,
T_1 * V_218 , T_1 * V_219 )
{
...
static inline struct V_32 * F_67 ( struct V_9
* V_11 , T_2 V_138 )
{
T_1 V_218 , V_219 ;
if ( ! V_11 -> V_29 [ V_138 ] . V_30 )
return NULL ;
F_66 ( V_11 , V_138 , & V_218 , & V_219 ) ;
if ( ! V_218 )
return NULL ;
return V_11 -> V_29 [ V_138 ] . V_30 + V_11 -> V_29 [ V_138 ] . V_220 *
sizeof( struct V_32 ) ;
}
static inline void F_68 ( struct V_9 * V_11 , T_2 V_138 )
{
int V_222 ;
V_11 -> V_29 [ V_138 ] . V_220 = ( V_11 -> V_29 [ V_138 ] . V_220 + 1 ) %
V_31 ;
V_222 = F_45 ( & V_11 -> V_46 ) ;
if ( V_11 -> V_34 && V_222 == 0 )
F_46 ( & V_11 -> V_33 ) ;
}
static void F_69 ( struct V_9 * V_11 ,
struct V_131 * V_24 , T_2 V_138 )
{
struct V_32 * V_223 ;
int V_48 ;
while ( true ) {
V_223 = F_67 ( V_11 , V_138 ) ;
if ( ! V_223 )
break;
V_48 = F_65 ( V_24 , V_223 -> V_224 ,
V_223 -> V_77 ) ;
if ( V_48 )
break;
F_68 ( V_11 , V_138 ) ;
...
static inline struct V_32 * F_70 (
...
static void F_71 ( struct V_9 * V_1 ,
struct V_131 * V_24 ,
struct V_6 * V_43 ,
struct V_133 * V_134 )
{
...
static void F_73 ( struct V_6 * V_242 ,
struct V_12 * V_184 )
{
struct V_9 * V_243 ;
...
static inline void F_75 ( struct V_6 * V_242 ,
struct V_4 * V_5 ,
struct V_12 * V_184 )
{
...
static void F_76 ( struct V_6 * V_43 ,
struct V_131 * V_24 ,
struct V_9 * V_1 ,
struct V_1 * V_2 ,
T_3 V_255 ,
...
switch ( V_256 -> type ) {
case V_217 :
F_50 ( V_1 , V_24 , V_43 , V_256 ) ;
break;
case V_235 :
F_71 ( V_1 , V_24 , V_43 , V_256 ) ;
break;
case V_25 :
F_75 ( V_43 , V_5 , V_184 ) ;
break;
