...
struct V_31 * V_32 = F_12 ( V_26 ) ;
bool V_61 ;
if ( F_20 ( V_28 ) -> V_62 == V_63 ) {
if ( F_21 ( F_22 ( V_28 ) -> V_64 , V_32 -> V_56 ) ) {
F_23 ( L_2 ) ;
V_32 -> V_56 = F_22 ( V_28 ) -> V_64 ;
F_24 ( V_2 , V_26 ) ;
}
return NULL ;
}
F_22 ( V_28 ) -> V_65 = V_66 ;
if ( F_20 ( V_28 ) -> V_62 != V_67 &&
F_20 ( V_28 ) -> V_62 != V_68 )
goto V_69;
if ( ! F_25 ( F_22 ( V_28 ) -> V_70 ,
V_32 -> V_49 , V_32 -> V_51 ) ) {
F_23 ( L_3
L_4 ,
( unsigned long long )
...
goto V_69;
V_60 = F_3 ( V_2 ) -> V_71 -> V_72 ( V_2 , V_28 , V_26 , NULL ,
V_26 , & V_61 ) ;
if ( ! V_60 )
goto V_73;
return F_27 ( V_2 , V_60 , V_26 , V_61 ) ;
V_73:
F_23 ( L_5 ) ;
F_22 ( V_28 ) -> V_65 = V_74 ;
V_69:
if ( F_20 ( V_28 ) -> V_62 != V_75 )
...
void F_35 ( const struct V_1 * V_2 , struct V_27 * V_28 ,
struct V_25 * V_84 )
{
F_36 ( L_6 ) ;
}
