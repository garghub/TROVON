...
V_14 -> V_40 = V_17 ;
V_2 -> V_41 = & V_10 -> V_41 ;
F_14 ( V_14 , V_10 -> V_41 . V_22 [ 0 ] , V_10 -> V_41 . V_42 ) ;
F_15 ( V_14 , V_2 , V_4 -> V_43 , V_4 -> V_44 ) ;
F_16 ( L_3 ,
V_10 -> V_41 . V_18 , V_10 -> V_41 . V_20 , V_10 -> V_41 . V_45 ,
( unsigned long long ) V_12 -> V_37 ) ;
return 0 ;
V_27:
V_10 -> V_41 . V_46 -> V_47 ( & V_10 -> V_41 ) ;
return V_16 ;
}
...
struct V_1 * V_2 ;
int V_16 ;
V_2 = F_19 ( V_6 -> V_6 , sizeof( * V_2 ) , V_51 ) ;
if ( ! V_2 )
return - V_26 ;
V_49 -> V_52 = V_2 ;
F_20 ( V_6 , V_2 , & V_53 ) ;
V_16 = F_21 ( V_6 , V_2 , 1 , 1 ) ;
if ( V_16 ) {
F_5 ( L_4 ) ;
goto V_54;
}
