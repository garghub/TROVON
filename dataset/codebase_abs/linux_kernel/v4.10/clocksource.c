...
T_5 F_73 ( const char * V_87 , char * V_90 , T_6 V_91 )
{
T_6 V_62 = V_91 ;
if ( ! V_91 || V_91 >= V_92 )
return - V_93 ;
...
static T_5 F_74 ( struct V_83 * V_84 ,
struct V_85 * V_86 ,
const char * V_87 , T_6 V_88 )
{
T_5 V_62 ;
F_44 ( & V_59 ) ;
...
static T_5 F_75 ( struct V_83 * V_84 ,
struct V_85 * V_86 ,
const char * V_87 , T_6 V_88 )
{
struct V_12 * V_13 ;
...
F_77 ( ( T_5 ) V_89 - V_88 , ( T_5 ) 0 ) ,
L_11 , V_95 -> V_42 ) ;
}
F_46 ( & V_59 ) ;
V_88 += snprintf ( V_87 + V_88 ,
F_77 ( ( T_5 ) V_89 - V_88 , ( T_5 ) 0 ) , L_12 ) ;
return V_88 ;
}
...
static int T_4 F_82 ( char * V_101 )
{
F_44 ( & V_59 ) ;
if ( V_101 )
...
static int T_4 F_84 ( char * V_101 )
{
