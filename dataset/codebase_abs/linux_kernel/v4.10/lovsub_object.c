...
static void F_20 ( const struct V_1 * V_2 , struct V_38 * V_4 ,
struct V_46 * V_40 )
{
struct V_21 * V_47 = F_16 ( V_4 ) ;
F_21 ( V_2 , & V_47 -> V_25 -> V_45 , V_40 ) ;
V_40 -> V_48 -> V_49 = V_47 -> V_31 ;
}
struct V_3 * F_22 ( const struct V_1 * V_2 ,
