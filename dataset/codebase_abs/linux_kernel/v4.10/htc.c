...
T_1 V_113 = 0 ;
int V_55 ;
for ( V_55 = 0 ; V_55 < V_38 ; V_55 ++ ) {
if ( V_12 -> V_110 [ V_55 ] . V_104 == V_104 )
V_113 =
V_12 -> V_110 [ V_55 ] . V_111 ;
}
return V_113 ;
}
...
T_3 V_119 ;
T_3 V_120 ;
V_114 = F_42 ( & V_12 -> V_84 ,
V_121 ) ;
if ( ! V_114 ) {
F_13 ( V_2 , L_37 ) ;
for ( V_55 = 0 ; V_55 < V_122 ; V_55 ++ )
F_43 ( V_12 -> V_2 , V_55 , 1 ) ;
V_114 =
F_42 ( & V_12 -> V_84 ,
V_121 ) ;
if ( ! V_114 )
...
if ( V_12 -> V_85 < sizeof( V_80 -> V_23 ) + sizeof( V_80 -> V_124 ) ) {
F_44 ( V_2 , L_39 ,
V_12 -> V_85 ) ;
return - V_37 ;
}
...
V_119 = F_31 ( V_80 -> V_124 . V_119 ) ;
V_120 = F_31 ( V_80 -> V_124 . V_120 ) ;
if ( V_81 != V_82 ) {
F_44 ( V_2 , L_40 , V_81 ) ;
return - V_37 ;
}
...
V_116 . V_21 . V_22 = F_1 ;
V_116 . V_21 . V_91 = F_36 ;
V_116 . V_125 = V_126 ;
V_116 . V_104 = V_94 ;
V_60 = F_45 ( V_12 , & V_116 , & V_118 ) ;
if ( V_60 ) {
F_44 ( V_2 , L_43 ,
V_60 ) ;
return V_60 ;
...
V_58 = sizeof( V_80 -> V_23 ) + sizeof( V_80 -> V_139 ) ;
F_46 ( V_4 , V_58 ) ;
memset ( V_4 -> V_8 , 0 , V_58 ) ;
V_80 = (struct V_79 * ) V_4 -> V_8 ;
V_80 -> V_23 . V_81 =
F_16 ( V_140 ) ;
V_24 |= F_47 ( V_135 , V_141 ) ;
if ( V_116 -> V_104 != V_95 ) {
V_24 |= V_142 ;
V_134 = true ;
}
V_128 = & V_80 -> V_139 ;
V_128 -> V_24 = F_16 ( V_24 ) ;
V_128 -> V_104 = F_16 ( V_116 -> V_104 ) ;
F_48 ( & V_12 -> V_84 ) ;
...
L_48 ,
F_37 ( V_104 ) ,
V_131 -> V_60 , V_131 -> V_20 ) ;
V_118 -> V_146 = V_131 -> V_60 ;
if ( V_131 -> V_60 != V_147 ) {
F_44 ( V_2 , L_49 ,
F_37 ( V_104 ) ,
V_131 -> V_60 ) ;
...
V_132 = (enum V_28 ) V_131 -> V_20 ;
V_133 = F_31 ( V_131 -> V_133 ) ;
V_136:
if ( V_132 >= V_38 )
return - V_145 ;
if ( V_133 == 0 )
return - V_145 ;
V_19 = & V_12 -> V_29 [ V_132 ] ;
V_19 -> V_20 = V_132 ;
if ( V_19 -> V_104 != V_105 )
return - V_145 ;
V_118 -> V_20 = V_132 ;
V_118 -> V_148 = F_31 ( V_131 -> V_133 ) ;
V_19 -> V_104 = V_116 -> V_104 ;
V_19 -> V_107 = V_116 -> V_125 ;
V_19 -> V_106 = F_31 ( V_131 -> V_133 ) ;
V_19 -> V_42 = V_135 ;
V_19 -> V_149 = V_12 -> V_41 ;
V_19 -> V_150 = V_19 -> V_106 /
V_12 -> V_41 ;
if ( V_19 -> V_106 % V_12 -> V_41 )
V_19 -> V_150 ++ ;
V_19 -> V_21 = V_116 -> V_21 ;
V_60 = F_49 ( V_12 -> V_2 ,
V_19 -> V_104 ,
& V_19 -> V_50 ,
& V_19 -> V_151 ) ;
...
V_19 -> V_151 , V_19 -> V_20 ) ;
if ( V_134 && V_19 -> V_40 ) {
V_19 -> V_40 = false ;
F_8 ( V_2 , V_137 ,
L_51 ,
F_37 ( V_19 -> V_104 ) , V_132 ) ;
}
return V_60 ;
}
struct V_3 * F_50 ( struct V_1 * V_2 , int V_152 )
{
struct V_3 * V_4 ;
V_4 = F_4 ( V_152 + sizeof( struct V_17 ) ) ;
if ( ! V_4 )
return NULL ;
F_5 ( V_4 , sizeof( struct V_17 ) ) ;
if ( ! F_51 ( ( unsigned long ) V_4 -> V_8 , 4 ) )
F_13 ( V_2 , L_52 ) ;
return V_4 ;
}
...
if ( ! V_4 )
return - V_138 ;
F_46 ( V_4 , sizeof( V_80 -> V_23 ) + sizeof( V_80 -> V_153 ) ) ;
