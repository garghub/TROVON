...
void F_105 ( struct V_5 * V_6 , struct V_76 * V_77 )
{
V_77 = F_106 ( V_77 , V_227 ) ;
if ( ! V_77 )
return;
F_107 ( & V_6 -> V_32 , V_77 ) ;
F_68 ( & V_6 -> V_30 ) ;
}
static int F_108 ( struct V_5 * V_6 , struct V_76 * V_77 )
{
struct V_81 * V_195 ;
struct V_79 * V_249 ;
enum V_1 V_2 ;
...
static void F_129 ( struct V_131 * V_132 )
{
struct V_283 * V_284 ;
F_130 () ;
F_131 (rdata, &lport->disc.rports, peers) {
if ( F_132 ( & V_284 -> V_318 ) ) {
F_128 ( V_284 ) ;
F_133 ( & V_284 -> V_318 , V_319 ) ;
}
}
F_134 () ;
...
static void F_135 ( struct V_131 * V_132 )
{
struct V_5 * V_6 = V_132 -> V_309 . V_55 ;
F_19 ( & V_6 -> V_22 ) ;
F_129 ( V_132 ) ;
...
V_322 = V_327 ;
F_88 ( & V_6 -> V_26 , V_122 + F_73 ( V_322 ) ) ;
F_3 ( V_6 , V_328 ) ;
}
static void F_56 ( struct V_5 * V_6 )
{
V_6 -> V_323 = 0 ;
F_142 ( & V_6 -> V_324 , V_6 -> V_7 -> V_146 ) ;
F_139 ( V_6 ) ;
}
...
goto V_210;
V_197 = (struct V_83 * ) V_88 ;
V_284 -> V_311 . V_333 = F_83 ( & V_197 -> V_116 ) ;
break;
case V_143 :
...
V_284 -> V_311 . V_335 = F_83 ( & V_138 -> V_147 ) ;
break;
case V_296 :
...
static void F_147 ( struct V_5 * V_6 , struct V_283 * V_33 )
{
struct V_131 * V_132 = V_6 -> V_7 ;
struct V_283 * V_284 ;
struct V_340 * V_311 ;
...
F_4 ( V_6 , L_88 ,
V_33 -> V_311 . V_140 ) ;
F_124 ( V_6 , V_294 , V_310 -> V_332 ,
F_151 ( ( T_2 ) V_310 -> V_336 ,
F_45 ( V_6 ) ) ) ;
F_147 ( V_6 , V_33 ) ;
break;
default:
...
V_284 = F_149 ( V_132 , V_33 -> V_311 . V_140 ) ;
if ( V_284 ) {
...
V_33 -> V_311 . V_140 ) ;
if ( F_76 ( V_122 ,
V_6 -> V_121 + F_73 ( V_347 ) ) )
F_144 ( V_6 ) ;
}
static unsigned long F_155 ( struct V_5 * V_6 )
{
struct V_131 * V_132 = V_6 -> V_7 ;
struct V_283 * V_284 ;
struct V_282 * V_310 ;
...
V_39 = F_143 ( V_6 , V_77 , & V_350 . V_284 ) ;
if ( V_39 ) {
F_4 ( V_6 , L_98 , V_39 ) ;
goto V_172;
}
...
switch ( V_234 ) {
case V_330 :
F_145 ( V_6 , & V_350 . V_284 ) ;
break;
case V_331 :
F_146 ( V_6 , & V_350 . V_284 ) ;
break;
case V_293 :
F_150 ( V_6 , & V_350 . V_284 ) ;
break;
case V_294 :
F_152 ( V_6 , & V_350 . V_284 ) ;
break;
case V_295 :
...
F_159 ( V_6 -> V_7 -> V_352 , & V_289 -> V_352 . V_359 ) ;
F_51 ( V_77 , V_139 ) ;
V_77 -> V_119 = F_48 ( V_97 ) ;
V_77 -> V_50 = V_6 -> V_50 ;
F_52 ( V_77 ) ;
...
V_195 = (struct V_81 * ) V_77 -> V_91 ;
V_234 = V_195 -> V_102 ;
V_39 = F_157 ( V_6 , V_77 , & V_350 . V_284 ) ;
if ( V_39 ) {
F_4 ( V_6 , L_103 , V_39 ) ;
goto V_172;
}
F_19 ( & V_6 -> V_22 ) ;
if ( V_234 == V_354 )
F_160 ( V_6 , & V_350 . V_284 ) ;
F_22 ( & V_6 -> V_22 ) ;
V_172:
F_39 ( V_77 ) ;
return V_39 ;
}
static void F_161 ( struct V_131 * V_132 , struct V_166 * V_167 )
{
struct V_362 V_363 ;
V_363 . V_364 = V_365 ;
V_363 . V_366 = V_367 ;
F_162 ( V_167 , V_161 , & V_363 ) ;
F_163 ( V_167 ) ;
}
static void F_164 ( void (* F_165)( struct V_131 * ,
enum V_368 ) ,
struct V_131 * V_132 )
{
...
struct V_283 * V_284 ;
struct V_282 * V_310 ;
void (* F_165)( struct V_131 * , enum V_368 );
F_19 ( & V_309 -> V_320 ) ;
F_165 = V_309 -> V_370 ? V_309 -> V_321 : NULL ;
V_309 -> V_370 = 0 ;
F_22 ( & V_309 -> V_320 ) ;
F_130 () ;
F_131 (rdata, &disc->rports, peers) {
if ( ! F_132 ( & V_284 -> V_318 ) )
continue;
V_310 = F_123 ( V_284 ) ;
if ( V_310 -> time )
...
F_4 ( V_6 , L_104 ) ;
F_124 ( V_6 , V_330 , V_254 , 0 ) ;
V_348 = V_122 + F_73 ( V_326 ) ;
break;
case V_337 :
F_3 ( V_6 , V_338 ) ;
F_4 ( V_6 , L_105 ) ;
F_124 ( V_6 , V_330 , V_254 , 0 ) ;
V_348 = V_122 + F_73 ( V_347 ) ;
break;
case V_338 :
F_3 ( V_6 , V_259 ) ;
V_372 = V_6 -> V_140 ;
...
if ( F_78 ( V_6 -> V_129 , V_348 ) )
V_348 = V_6 -> V_129 ;
break;
case V_19 :
goto V_66;
default:
F_167 ( 1 , L_108 , V_6 -> V_2 ) ;
goto V_66;
}
F_88 ( & V_6 -> V_26 , V_348 ) ;
V_66:
...
static void F_169 ( struct V_131 * V_132 , struct V_5 * V_6 ,
enum V_374 V_374 )
{
void * V_55 ;
...
V_132 -> V_157 = 1 ;
V_132 -> V_378 . V_379 = F_161 ;
V_132 -> V_378 . V_380 = F_164 ;
V_132 -> V_378 . V_381 = F_135 ;
V_132 -> V_378 . V_382 = F_136 ;
V_55 = V_6 ;
} else {
V_132 -> V_377 = 0 ;
V_132 -> V_157 = 0 ;
...
int F_171 ( struct V_131 * V_132 , struct V_5 * V_6 ,
const struct V_383 * V_378 , int V_384 )
{
memcpy ( & V_132 -> V_378 , V_378 , sizeof( * V_378 ) ) ;
if ( V_384 && F_172 ( V_132 ) )
return - V_40 ;
F_173 ( V_132 ) ;
F_174 ( V_132 ) ;
F_175 ( V_132 ) ;
F_176 ( V_132 ) ;
F_169 ( V_132 , V_6 , V_6 -> V_13 ) ;
return 0 ;
}
void F_177 ( struct V_36 * V_38 )
{
struct V_34 * V_35 = F_178 ( V_38 ) ;
struct V_5 * V_6 = F_179 ( V_35 ) ;
struct V_8 * V_9 ;
F_19 ( & V_6 -> V_22 ) ;
F_19 ( & V_35 -> V_54 ) ;
V_9 = F_180 ( V_38 ) ;
...
void F_181 ( struct V_34 * V_35 )
{
struct V_5 * V_385 = F_179 ( V_35 ) ;
