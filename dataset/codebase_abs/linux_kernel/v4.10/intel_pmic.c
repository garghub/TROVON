...
return - V_35 ;
if ( V_9 == V_26 )
return V_18 -> V_39 ( V_16 , V_5 , V_6 , V_31 ) ;
if ( * V_31 != 0 && * V_31 != 1 )
return - V_37 ;
return V_18 -> V_40 ( V_16 , V_5 , V_6 , * V_31 ) ;
}
...
return V_30 ;
case 1 :
V_15 -> V_43 . V_44 |= ( * V_11 & 0xff ) << 8 ;
return V_30 ;
case 2 :
V_15 -> V_43 . V_44 |= * V_11 & 0xff ;
return V_30 ;
case 3 :
V_15 -> V_43 . V_45 = * V_11 & 0xff ;
return V_30 ;
case 4 :
if ( * V_11 ) {
V_20 = F_16 ( V_15 -> V_16 , V_15 -> V_43 . V_44 ,
V_15 -> V_43 . V_45 ) ;
} else {
V_20 = F_17 ( V_15 -> V_16 , V_15 -> V_43 . V_44 ,
& V_15 -> V_43 . V_45 ) ;
if ( V_20 == 0 )
* V_11 = V_15 -> V_43 . V_45 ;
}
memset ( & V_15 -> V_43 , 0x00 , sizeof( V_15 -> V_43 ) ) ;
}
if ( V_20 < 0 ) {
if ( V_20 == - V_37 )
return V_21 ;
...
int F_18 ( struct V_46 * V_47 , T_5 V_48 ,
struct V_16 * V_16 ,
struct V_17 * V_18 )
{
T_1 V_49 ;
...
if ( ! V_48 )
return - V_51 ;
V_15 = F_19 ( V_47 , sizeof( * V_15 ) , V_52 ) ;
if ( ! V_15 )
return - V_53 ;
F_20 ( & V_15 -> V_25 ) ;
V_15 -> V_16 = V_16 ;
