...
unsigned int V_54 , const char * V_55 )
{
struct {
struct V_44 V_45 ;
const char V_56 [ 16 ] ;
...
int V_57 ;
V_24 . V_45 = V_7 -> V_7 . V_24 ;
V_24 . V_45 . type = V_54 ;
V_24 . V_45 . V_4 = strlen ( V_55 ) + 1 ;
if ( V_24 . V_45 . V_4 > sizeof( V_24 . V_56 ) )
return - V_58 ;
F_2 ( & V_7 -> V_13 ) ;
V_57 = F_11 ( & V_7 -> V_15 , & V_24 , sizeof( V_24 . V_45 ) + V_24 . V_45 . V_4 ) ;
F_23 ( & V_7 -> V_19 ) ;
F_4 ( & V_7 -> V_13 ) ;
return V_57 ;
}
static int F_25 ( unsigned V_54 ,
struct V_6 * V_7 )
{
int V_57 ;
void * V_55 ;
...
F_20 ( V_50 ) ;
if ( V_54 == V_61 ) {
V_60 = F_12 ( sizeof( * V_60 ) , V_32 ) ;
if ( ! V_60 ) {
V_57 = - V_33 ;
goto V_26;
}
} else if ( V_7 -> V_7 . V_24 . V_62 != 0 ) {
F_26 (trans, &u->transactions, list)
if ( V_60 -> V_63 . V_64 == V_7 -> V_7 . V_24 . V_62 )
break;
if ( & V_60 -> V_21 == & V_7 -> V_65 )
return F_24 ( V_7 , V_66 , L_1 ) ;
}
V_55 = F_27 ( & V_7 -> V_7 . V_24 ) ;
if ( F_28 ( V_55 ) ) {
if ( V_54 == V_61 )
F_10 ( V_60 ) ;
V_57 = F_29 ( V_55 ) ;
...
V_60 -> V_63 . V_64 = F_30 ( V_55 , NULL , 0 ) ;
F_31 ( & V_60 -> V_21 , & V_7 -> V_65 ) ;
}
} else if ( V_7 -> V_7 . V_24 . type == V_67 ) {
F_9 ( & V_60 -> V_21 ) ;
F_10 ( V_60 ) ;
}
F_2 ( & V_7 -> V_13 ) ;
V_57 = F_11 ( & V_50 , & V_7 -> V_7 . V_24 , sizeof( V_7 -> V_7 . V_24 ) ) ;
if ( ! V_57 )
V_57 = F_11 ( & V_50 , V_55 , V_7 -> V_7 . V_24 . V_4 ) ;
if ( ! V_57 ) {
F_22 ( & V_50 , & V_7 -> V_15 ) ;
F_23 ( & V_7 -> V_19 ) ;
} else {
...
F_31 ( & V_35 -> V_21 , & V_7 -> V_72 ) ;
} else {
F_26 (watch, &u->watches, list) {
...
static int F_37 ( struct V_75 * V_75 , struct V_1 * V_2 )
{
struct V_6 * V_7 ;
if ( V_76 == 0 )
return - V_77 ;
...
static int F_42 ( struct V_75 * V_75 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
struct V_59 * V_60 , * V_80 ;
struct V_34 * V_35 , * V_81 ;
struct V_9 * V_10 , * V_82 ;
F_43 (trans, tmp, &u->transactions, list) {
F_44 ( V_60 -> V_63 , 1 ) ;
F_9 ( & V_60 -> V_21 ) ;
F_10 ( V_60 ) ;
}
F_43 (watch, tmp_watch, &u->watches, list) {
F_34 ( & V_35 -> V_35 ) ;
F_9 ( & V_35 -> V_21 ) ;
F_15 ( V_35 ) ;
}
F_43 (rb, tmp_rb, &u->read_buffers, list) {
F_9 ( & V_10 -> V_21 ) ;
F_10 ( V_10 ) ;
}
F_10 ( V_7 ) ;
