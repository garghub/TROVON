...
V_399 . V_528 = true ;
if ( V_99 -> V_559 [ V_413 ] )
V_399 . V_412 = F_235 ( V_99 -> V_559 [ V_413 ] ) ;
if ( V_99 -> V_559 [ V_411 ] )
V_399 . V_233 = true ;
else
...
static int F_245 ( struct V_32 * V_570 , struct V_395 * V_99 )
{
struct V_47 * V_30 ;
V_93 V_172 = - 1 ;
...
V_412 = ( void * ) F_235 ( V_99 -> V_559 [ V_413 ] ) ;
else
return - V_41 ;
F_193 ( & V_219 ) ;
F_102 (data, &hwsim_radios, list) {
...
if ( strcmp ( V_412 , F_225 ( V_30 -> V_51 -> V_27 ) ) )
continue;
}
if ( ! F_246 ( F_247 ( V_30 -> V_51 -> V_27 ) , F_196 ( V_99 ) ) )
continue;
F_228 ( & V_30 -> V_539 ) ;
F_194 ( & V_219 ) ;
F_220 ( V_30 , F_225 ( V_30 -> V_51 -> V_27 ) ,
...
static int F_248 ( struct V_32 * V_570 , struct V_395 * V_99 )
{
struct V_47 * V_30 ;
struct V_32 * V_33 ;
...
if ( V_30 -> V_172 < V_172 )
continue;
if ( ! F_246 ( F_247 ( V_30 -> V_51 -> V_27 ) , F_252 ( V_33 -> V_577 ) ) )
continue;
V_141 = F_223 ( V_33 , V_30 ,
F_253 ( V_130 -> V_33 ) . V_26 ,
...
static void F_254 ( struct V_349 * V_350 )
{
struct V_47 * V_30 =
...
F_228 ( & V_582 -> V_539 ) ;
F_257 ( & V_582 -> V_581 , F_254 ) ;
F_258 ( & V_582 -> V_581 ) ;
}
}
F_194 ( & V_219 ) ;
}
static int F_259 ( struct V_583 * V_584 ,
unsigned long V_585 ,
void * V_586 )
{
