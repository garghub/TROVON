...
static bool F_48 ( const struct V_11 * V_11 ,
const struct V_29 * V_30 ,
T_1 V_3 , int V_4 )
{
int V_39 , V_40 = V_11 -> V_41 . V_42 . V_43 + V_22 ;
switch ( V_4 ) {
case sizeof( V_44 ) :
V_39 = V_45 ;
break;
...
if ( ( V_30 -> V_48 & V_39 ) && F_49 ( V_3 , V_4 ) ) {
if ( ! V_30 -> V_49 )
return true ;
return F_5 ( V_3 , V_30 -> V_49 ) < V_40 ;
}
return false ;
}
...
{
struct V_36 * V_50 = F_46 ( V_38 ) ;
const struct V_29 * V_30 ;
unsigned long V_34 = 0 ;
V_30 = F_35 ( V_50 -> V_51 , V_50 -> V_32 ,
V_3 - V_50 -> V_52 ) ;
if ( ! V_30 || ! F_48 ( V_2 -> V_11 , V_30 , V_3 , V_4 ) ) {
memset ( V_5 , 0 , V_4 ) ;
return 0 ;
}
switch ( V_50 -> V_53 ) {
case V_54 :
V_34 = V_30 -> V_55 ( V_2 , V_3 , V_4 ) ;
break;
case V_56 :
V_34 = V_30 -> V_55 ( V_2 , V_3 , V_4 ) ;
break;
case V_57 :
V_34 = V_30 -> V_55 ( V_50 -> V_58 , V_3 , V_4 ) ;
break;
case V_59 :
V_34 = V_30 -> V_60 ( V_2 -> V_11 , V_50 -> V_61 , V_3 , V_4 ) ;
break;
}
F_41 ( V_5 , V_4 , V_34 ) ;
return 0 ;
}
static int F_51 ( struct V_1 * V_2 , struct V_37 * V_38 ,
...
switch ( V_50 -> V_53 ) {
case V_54 :
V_30 -> V_62 ( V_2 , V_3 , V_4 , V_34 ) ;
break;
case V_56 :
V_30 -> V_62 ( V_2 , V_3 , V_4 , V_34 ) ;
break;
case V_57 :
V_30 -> V_62 ( V_50 -> V_58 , V_3 , V_4 , V_34 ) ;
break;
case V_59 :
V_30 -> V_63 ( V_2 -> V_11 , V_50 -> V_61 , V_3 , V_4 , V_34 ) ;
break;
}
return 0 ;
}
int F_52 ( struct V_11 * V_11 , T_1 V_64 ,
enum V_65 type )
{
struct V_36 * V_66 = & V_11 -> V_41 . V_42 . V_67 ;
int V_68 = 0 ;
unsigned int V_4 ;
switch ( type ) {
case V_69 :
