...
unsigned V_88 ;
F_56 ( L_6 ) ;
for ( V_88 = 0 ; V_88 < V_25 -> V_59 ; V_88 ++ ) {
if ( V_88 )
F_56 ( L_7 ) ;
F_56 ( L_8 , V_25 -> V_60 [ V_88 ] ) ;
}
}
F_56 ( L_9 ) ;
}
...
if ( ! V_90 )
return;
V_91 = ( unsigned ) F_22 ( & V_36 -> V_37 [ V_38 ] ) ;
V_92 = ( unsigned ) F_22 ( & V_36 -> V_37 [ V_39 ] ) ;
if ( V_91 )
V_14 -> V_95 [ V_38 ] += V_90 ;
if ( V_92 )
V_14 -> V_95 [ V_39 ] += V_90 ;
...
int V_99 , V_47 V_85 ,
struct V_100 * V_101 , bool V_56 ,
unsigned long V_102 )
{
struct V_35 * V_36 = & V_25 -> V_32 [ V_98 ] ;
struct V_66 * V_14 ;
#if V_103 == 32
unsigned long V_12 ;
F_62 ( V_12 ) ;
...
if ( V_25 -> V_59 ) {
unsigned V_111 = 0 , V_74 = V_25 -> V_59 + 1 ;
while ( V_111 + 1 < V_74 ) {
unsigned V_112 = ( V_111 + V_74 ) / 2 ;
if ( V_25 -> V_60 [ V_112 - 1 ] > V_104 ) {
V_74 = V_112 ;
} else {
V_111 = V_112 ;
}
...
void F_71 ( struct V_40 * V_41 , unsigned long V_113 ,
...
F_53 ( V_43 -> V_49 ) = V_113 ;
}
F_73 () ;
V_121 = false ;
F_74 (s, &stats->list, list_entry) {
if ( V_25 -> V_58 & V_87 && ! V_121 ) {
if ( ! V_56 )
...
F_70 ( V_25 , V_113 , V_114 , V_115 , V_56 , V_102 , V_101 ) ;
}
F_75 () ;
}
...
struct V_66 * V_14 ;
F_77 () ;
V_14 = & V_25 -> V_28 [ F_64 () ] [ V_122 ] ;
F_57 ( V_25 , V_36 , V_14 ) ;
F_78 () ;
V_36 -> V_33 . V_105 [ V_38 ] = 0 ;
V_36 -> V_33 . V_105 [ V_39 ] = 0 ;
V_36 -> V_33 . V_106 [ V_38 ] = 0 ;
V_36 -> V_33 . V_106 [ V_39 ] = 0 ;
V_36 -> V_33 . V_107 [ V_38 ] = 0 ;
V_36 -> V_33 . V_107 [ V_39 ] = 0 ;
V_36 -> V_33 . V_109 [ V_38 ] = 0 ;
V_36 -> V_33 . V_109 [ V_39 ] = 0 ;
V_36 -> V_33 . V_95 [ V_38 ] = 0 ;
V_36 -> V_33 . V_95 [ V_39 ] = 0 ;
V_36 -> V_33 . V_96 = 0 ;
V_36 -> V_33 . V_97 = 0 ;
if ( V_25 -> V_59 )
memset ( V_36 -> V_33 . V_29 , 0 , ( V_25 -> V_59 + 1 ) * sizeof( unsigned long long ) ) ;
F_20 (cpu) {
V_14 = & V_25 -> V_28 [ V_23 ] [ V_122 ] ;
V_36 -> V_33 . V_105 [ V_38 ] += F_53 ( V_14 -> V_105 [ V_38 ] ) ;
V_36 -> V_33 . V_105 [ V_39 ] += F_53 ( V_14 -> V_105 [ V_39 ] ) ;
...
V_36 -> V_33 . V_109 [ V_38 ] += F_53 ( V_14 -> V_109 [ V_38 ] ) ;
V_36 -> V_33 . V_109 [ V_39 ] += F_53 ( V_14 -> V_109 [ V_39 ] ) ;
V_36 -> V_33 . V_95 [ V_38 ] += F_53 ( V_14 -> V_95 [ V_38 ] ) ;
V_36 -> V_33 . V_95 [ V_39 ] += F_53 ( V_14 -> V_95 [ V_39 ] ) ;
V_36 -> V_33 . V_96 += F_53 ( V_14 -> V_96 ) ;
V_36 -> V_33 . V_97 += F_53 ( V_14 -> V_97 ) ;
if ( V_25 -> V_59 ) {
unsigned V_88 ;
for ( V_88 = 0 ; V_88 < V_25 -> V_59 + 1 ; V_88 ++ )
V_36 -> V_33 . V_29 [ V_88 ] += F_53 ( V_14 -> V_29 [ V_88 ] ) ;
}
}
}
...
V_36 = & V_25 -> V_32 [ V_122 ] ;
if ( V_125 )
F_76 ( V_36 , V_25 , V_122 ) ;
F_77 () ;
V_14 = & V_25 -> V_28 [ F_64 () ] [ V_122 ] ;
V_14 -> V_105 [ V_38 ] -= V_36 -> V_33 . V_105 [ V_38 ] ;
V_14 -> V_105 [ V_39 ] -= V_36 -> V_33 . V_105 [ V_39 ] ;
...
V_14 -> V_109 [ V_38 ] -= V_36 -> V_33 . V_109 [ V_38 ] ;
V_14 -> V_109 [ V_39 ] -= V_36 -> V_33 . V_109 [ V_39 ] ;
V_14 -> V_95 [ V_38 ] -= V_36 -> V_33 . V_95 [ V_38 ] ;
V_14 -> V_95 [ V_39 ] -= V_36 -> V_33 . V_95 [ V_39 ] ;
V_14 -> V_96 -= V_36 -> V_33 . V_96 ;
V_14 -> V_97 -= V_36 -> V_33 . V_97 ;
F_78 () ;
if ( V_25 -> V_59 ) {
unsigned V_88 ;
for ( V_88 = 0 ; V_88 < V_25 -> V_59 + 1 ; V_88 ++ ) {
F_77 () ;
V_14 = & V_25 -> V_28 [ F_64 () ] [ V_122 ] ;
V_14 -> V_29 [ V_88 ] -= V_36 -> V_33 . V_29 [ V_88 ] ;
F_78 () ;
}
}
}
...
V_123 = V_124 ;
V_57 = V_25 -> V_57 ;
V_55 = V_25 -> V_55 + ( V_57 * V_123 ) ;
for ( V_122 = V_123 ; V_122 < V_124 ; V_122 ++ , V_55 = V_56 ) {
V_36 = & V_25 -> V_32 [ V_122 ] ;
V_56 = V_55 + V_57 ;
...
V_36 -> V_33 . V_105 [ V_38 ] ,
F_81 ( V_25 , V_36 -> V_33 . V_109 [ V_38 ] ) ,
V_36 -> V_33 . V_106 [ V_39 ] ,
V_36 -> V_33 . V_107 [ V_39 ] ,
V_36 -> V_33 . V_105 [ V_39 ] ,
F_81 ( V_25 , V_36 -> V_33 . V_109 [ V_39 ] ) ,
F_21 ( V_36 ) ,
F_81 ( V_25 , V_36 -> V_33 . V_96 ) ,
F_81 ( V_25 , V_36 -> V_33 . V_97 ) ,
F_81 ( V_25 , V_36 -> V_33 . V_95 [ V_38 ] ) ,
F_81 ( V_25 , V_36 -> V_33 . V_95 [ V_39 ] ) ) ;
if ( V_25 -> V_59 ) {
unsigned V_88 ;
for ( V_88 = 0 ; V_88 < V_25 -> V_59 + 1 ; V_88 ++ ) {
F_56 ( L_12 , ! V_88 ? L_13 : L_14 , V_36 -> V_33 . V_29 [ V_88 ] ) ;
}
}
F_56 ( L_9 ) ;
if ( F_44 ( V_86 + 1 >= V_84 ) )
...
static int F_84 ( const char * V_132 , unsigned * V_59 ,
unsigned long long * * V_60 )
{
const char * V_133 ;
unsigned V_134 ;
...
if ( ! V_85 )
V_85 = 1 ;
} else if ( sscanf ( V_2 , L_17 , & V_55 , & V_85 , & V_138 ) != 2 ||
...
if ( ! V_57 )
V_57 = 1 ;
} else if ( sscanf ( V_2 , L_15 , & V_57 , & V_138 ) != 1 ||
V_57 != ( V_47 ) V_57 || ! V_57 )
goto V_144;
V_142 = V_141 ;
V_2 = F_88 ( & V_141 ) ;
