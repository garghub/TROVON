...
static void F_34 ( struct V_39 * V_39 , struct V_48 * V_17 )
{
#ifdef F_35
...
V_49 = & V_38 -> V_33 ;
V_50 = V_49 -> V_45 ;
V_52 = F_37 ( V_50 , T_2 , V_33 ) ;
V_51 = V_49 -> V_44 ;
V_53 = F_37 ( V_51 , T_2 , V_33 ) ;
F_30 ( L_8 ,
V_38 , V_39 -> V_43 , V_52 , V_53 ) ;
}
#endif
}
static void F_38 ( T_2 * V_31 )
{
struct V_54 * V_55 = F_39 ( V_31 -> V_39 ) ;
struct V_56 * V_57 = F_40 ( V_31 -> V_39 -> V_46 ) ;
struct V_58 * V_59 ;
unsigned long V_23 ;
F_26 ( ! ( V_31 -> V_34 & V_35 ) ) ;
...
{
struct V_54 * V_55 = F_37 ( V_68 , struct V_54 ,
V_64 ) ;
F_45 ( & V_55 -> V_69 , & V_55 -> V_63 ) ;
}
T_2 * F_51 ( struct V_39 * V_39 , T_6 V_23 )
{
T_2 * V_38 = F_52 ( V_1 , V_23 ) ;
if ( V_38 ) {
V_38 -> V_39 = V_39 ;
F_53 ( & V_38 -> V_33 ) ;
F_54 ( & V_38 -> V_70 , 1 ) ;
...
void F_63 ( struct F_63 * V_38 )
{
struct V_10 * V_10 = V_38 -> V_76 ;
if ( V_10 ) {
int V_77 = V_38 -> V_78 -> V_79 == V_80 ?
V_81 : 0 ;
F_64 ( V_38 -> V_76 , V_82 , V_77 ) ;
F_65 ( V_38 -> V_76 ) ;
}
V_38 -> V_76 = NULL ;
}
void F_66 ( struct F_63 * V_38 ,
struct V_83 * V_84 )
{
V_38 -> V_78 = V_84 ;
V_38 -> V_76 = NULL ;
...
static int F_67 ( struct F_63 * V_38 ,
struct V_5 * V_6 )
{
struct V_10 * V_10 ;
V_10 = F_68 ( V_85 , V_86 ) ;
...
V_10 -> V_87 = V_6 -> V_8 ;
V_10 -> V_73 = F_60 ;
V_10 -> V_37 = F_58 ( V_38 -> V_31 ) ;
V_38 -> V_76 = V_10 ;
V_38 -> V_88 = V_6 -> V_9 ;
return 0 ;
}
static int F_70 ( struct F_63 * V_38 ,
struct V_39 * V_39 ,
struct V_14 * V_14 ,
struct V_5 * V_6 )
{
...
V_42 = F_71 ( V_38 -> V_76 , V_14 , V_6 -> V_29 , F_16 ( V_6 ) ) ;
if ( V_42 != V_6 -> V_29 )
goto V_89;
F_72 ( V_38 -> V_78 , V_14 , V_6 -> V_29 ) ;
V_38 -> V_88 ++ ;
return 0 ;
}
int F_73 ( struct F_63 * V_38 ,
struct V_14 * V_14 ,
int V_90 ,
struct V_83 * V_84 ,
bool V_91 )
...
V_6 = V_17 = F_13 ( V_14 ) ;
if ( F_90 ( V_39 ) && F_91 ( V_39 -> V_97 ) &&
V_95 ) {
T_6 V_98 = V_99 ;
V_100:
V_16 = F_92 ( V_39 , V_14 , V_96 , 0 ,
V_14 -> V_101 , V_98 ) ;
if ( F_93 ( V_16 ) ) {
V_42 = F_94 ( V_16 ) ;
