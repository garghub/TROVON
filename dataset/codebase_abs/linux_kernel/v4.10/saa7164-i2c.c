...
V_4 [ V_11 ] . V_15 ,
0 ,
NULL , V_4 [ V_11 ] . V_16 , V_4 [ V_11 ] . V_19 ) ;
} else if ( V_11 + 1 < V_5 && ( V_4 [ V_11 + 1 ] . V_17 & V_18 ) &&
V_4 [ V_11 ] . V_15 == V_4 [ V_11 + 1 ] . V_15 ) {
V_12 = F_3 ( V_7 , V_4 [ V_11 ] . V_15 ,
V_4 [ V_11 ] . V_16 , V_4 [ V_11 ] . V_19 ,
V_4 [ V_11 + 1 ] . V_16 , V_4 [ V_11 + 1 ] . V_19
) ;
V_11 ++ ;
if ( V_12 < 0 )
goto V_20;
...
static T_1 F_5 ( struct V_1 * V_21 )
{
return V_22 ;
}
...
{
struct V_9 * V_10 = V_7 -> V_10 ;
F_2 ( V_13 , L_3 , V_14 , V_7 -> V_23 ) ;
V_7 -> V_2 = V_24 ;
V_7 -> V_25 = V_26 ;
V_7 -> V_2 . V_10 . V_27 = & V_10 -> V_28 -> V_10 ;
F_7 ( V_7 -> V_2 . V_29 , V_7 -> V_10 -> V_29 ,
sizeof( V_7 -> V_2 . V_29 ) ) ;
V_7 -> V_2 . V_8 = V_7 ;
F_8 ( & V_7 -> V_2 , V_7 ) ;
F_9 ( & V_7 -> V_2 ) ;
V_7 -> V_25 . V_30 = & V_7 -> V_2 ;
if ( 0 != V_7 -> V_31 )
F_10 ( V_32 L_4 ,
V_10 -> V_29 , V_7 -> V_23 ) ;
return V_7 -> V_31 ;
