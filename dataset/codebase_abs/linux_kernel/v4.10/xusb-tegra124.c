...
{
return F_115 ( V_15 , V_206 , L_5 ) ;
}
static int
F_116 ( struct V_207 * V_71 )
{
unsigned int V_208 ;
int V_55 ;
T_1 V_5 ;
V_55 = F_117 ( V_209 , & V_5 ) ;
if ( V_55 < 0 )
return V_55 ;
for ( V_208 = 0 ; V_208 < F_118 ( V_71 -> V_86 ) ; V_208 ++ ) {
V_71 -> V_86 [ V_208 ] =
( V_5 >> F_119 ( V_208 ) ) &
V_210 ;
}
...
static struct V_2 *
F_120 ( struct V_217 * V_65 ,
const struct V_218 * V_59 )
{
struct V_1 * V_3 ;
int V_55 ;
