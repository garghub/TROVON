...
F_113 ( V_265 ) ;
F_114 ( V_196 , & V_15 -> V_209 ,
F_115 ( V_264 ) ) ;
F_97 ( V_196 , & V_15 -> V_209 ) ;
F_116 ( V_196 , & V_15 -> V_209 ) ;
return 0 ;
}
if ( F_117 ( V_264 ) && F_117 ( V_265 ) ) {
...
if ( F_112 ( V_196 , & V_15 -> V_209 , V_264 ) )
return - V_173 ;
V_21 -> V_102 . V_103 . V_268 = F_113 ( V_264 ) ;
F_97 ( V_196 , & V_15 -> V_209 ) ;
F_118 ( V_196 , & V_15 -> V_209 ) ;
if ( F_112 ( V_196 , & V_15 -> V_209 , V_265 ) )
return - V_173 ;
V_21 -> V_102 . V_103 . V_269 = F_113 ( V_265 ) ;
F_97 ( V_196 , & V_15 -> V_209 ) ;
return 0 ;
}
...
F_98 ( & V_196 -> V_216 ) ;
if ( ! V_215 )
F_143 ( L_80 , V_276 , V_15 -> V_201 ) ;
return V_215 ;
}
static void F_144 ( struct V_5 * V_15 )
{
struct V_275 * V_276 = V_15 -> V_1 ;
...
F_98 ( & V_196 -> V_216 ) ;
if ( ! V_215 )
F_143 ( L_82 , V_276 , V_15 -> V_201 ) ;
return V_215 ;
}
static void F_146 ( struct V_5 * V_15 )
{
struct V_27 * V_28 = V_15 -> V_1 ;
struct V_251 * V_74 = & V_15 -> V_21 -> V_74 ;
struct V_221 * V_222 ;
...
F_147 (sdev, port->adapter->scsi_host)
...
L_89
L_90 ,
( unsigned long long ) F_150 ( V_222 ) ,
( unsigned long long ) V_224 -> V_28 -> V_188 ) ;
F_102 ( V_222 , V_4 ) ;
case V_317 :
V_15 -> V_18 |= V_19 ;
...
F_97 ( V_196 , & V_15 -> V_209 ) ;
V_15 -> V_21 -> V_74 . V_245 = V_12 -> V_28 -> V_246 ;
V_15 -> V_21 -> V_102 . V_103 . V_319 = F_150 ( V_12 -> V_222 ) ;
V_15 -> V_109 = F_149 ;
V_15 -> V_1 = V_12 -> V_222 ;
V_15 -> V_12 = V_12 ;
V_12 -> V_292 = V_15 -> V_201 ;
...
static void F_152 ( struct V_5 * V_15 )
{
struct V_221 * V_222 = V_15 -> V_1 ;
struct V_223 * V_224 ;
if ( V_15 -> V_18 & V_19 )
...
static void F_154 ( struct V_323 * V_324 , T_1 V_325 )
{
V_324 -> V_326 += V_325 ;
V_324 -> F_66 = F_66 ( V_324 -> F_66 , V_325 ) ;
V_324 -> F_58 = F_58 ( V_324 -> F_58 , V_325 ) ;
}
static void F_155 ( struct V_5 * V_15 , struct V_234 * V_327 )
{
struct V_328 * V_329 ;
...
F_154 ( & V_325 -> V_358 , V_329 -> V_342 ) ;
F_154 ( & V_325 -> V_359 , V_329 -> V_343 ) ;
V_325 -> V_360 ++ ;
F_157 ( & V_224 -> V_349 . V_357 ) ;
}
}
F_158 ( V_327 -> V_361 -> V_362 , V_327 -> V_361 , & V_332 ,
sizeof( V_332 ) ) ;
}
...
static int F_165 ( struct V_234 * V_234 , T_1 * V_380 )
{
switch ( F_166 ( V_234 ) ) {
case V_381 :
switch ( V_234 -> V_382 ) {
...
V_344 -> V_273 = V_274 ;
V_344 -> V_367 = V_398 ;
if ( F_166 ( V_234 ) != V_381 ) {
V_344 -> V_399 = V_234 -> V_236 -> V_400 ;
V_344 -> V_401 = F_169 ( V_234 ) & 0xFFFFFFFF ;
}
if ( F_165 ( V_234 , & V_344 -> V_345 ) )
goto V_402;
...
struct V_5 * F_176 ( struct V_234 * V_235 ,
V_141 V_409 )
{
struct V_5 * V_15 = NULL ;
struct V_391 * V_391 ;
...
void F_177 ( struct V_195 * V_196 , int V_410 )
{
struct V_2 * V_3 = V_196 -> V_3 ;
