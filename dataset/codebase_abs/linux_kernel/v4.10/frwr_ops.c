...
F_52 ( & V_16 -> V_26 ) ;
V_143:
F_53 (mw, tmp, &req->rl_registered, mw_list) {
F_10 ( L_19 ,
V_27 , & V_32 -> V_17 ) ;
F_54 ( & V_32 -> V_29 ) ;
F_20 ( V_2 -> V_5 ,
...
F_49 (mw, &req->rl_registered, mw_list) {
V_16 = & V_32 -> V_17 ;
if ( V_32 -> V_120 == V_90 -> V_141 . V_142 ) {
F_17 ( V_2 , V_32 ) ;
V_90 = V_90 -> V_106 ;
}
}
...
static void
F_56 ( struct V_35 * V_36 , struct V_126 * V_127 ,
bool V_147 )
{
struct V_11 * V_32 ;
while ( ! F_13 ( & V_127 -> V_148 ) ) {
V_32 = F_57 ( & V_127 -> V_148 ,
struct V_11 , V_29 ) ;
F_54 ( & V_32 -> V_29 ) ;
if ( V_147 )
F_19 ( V_32 ) ;
