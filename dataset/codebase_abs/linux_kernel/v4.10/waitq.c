...
static struct V_3 *
F_29 ( struct V_1 * V_2 , const struct V_84 * V_84 )
{
struct V_3 * V_4 ;
...
const struct V_87 * V_87 , enum V_88 V_89 )
{
struct V_70 * V_70 = V_87 -> V_70 ;
struct V_3 * V_4 ;
struct V_90 * V_65 ;
if ( V_2 -> V_7 )
return - V_11 ;
...
if ( F_35 ( V_70 ) &&
F_36 ( V_70 ) ) {
struct V_70 * V_99 = V_70 -> V_81 ;
V_96 = F_37 ( V_99 , & V_70 -> V_82 ) ;
if ( V_96 )
V_70 = V_96 ;
}
}
V_97 . V_100 = V_87 -> V_100 ;
V_97 . V_70 = V_70 ;
if ( F_38 ( & V_97 ) )
V_98 = 0 ;
if ( V_96 )
...
if ( V_2 -> V_7 )
return - V_11 ;
V_68 = F_41 ( V_25 , F_42 ( V_2 -> V_102 ) ) ;
V_69 = F_43 ( V_25 , F_42 ( V_2 -> V_102 ) ) ;
if ( V_68 == 0 || V_69 == 0 )
return - V_11 ;
if ( F_44 ( V_70 ) ) {
if ( F_45 ( V_2 -> type ) )
...
V_84 . V_12 = V_12 ;
V_84 . V_85 = F_47 ( V_70 , V_12 , V_84 . V_43 ) ;
if ( F_33 ( & V_2 -> V_6 ) ) {
F_5 ( V_84 . V_12 ) ;
return - V_94 ;
}
V_101 = F_30 ( & V_4 , V_2 , & V_84 , V_87 , V_89 ) ;
if ( V_101 <= 0 ) {
if ( V_101 != - V_94 )
F_3 ( & V_2 -> V_6 ) ;
F_5 ( V_84 . V_12 ) ;
...
if ( ! V_4 ) {
V_4 = F_46 ( sizeof( struct V_3 ) , V_103 ) ;
if ( ! V_4 ) {
F_5 ( V_84 . V_12 ) ;
F_3 ( & V_2 -> V_6 ) ;
return - V_104 ;
...
unsigned long V_107 ;
T_5 V_108 ;
F_13 ( & V_25 -> V_32 -> V_33 , V_107 ) ;
V_108 = V_25 -> V_109 ;
V_106 = V_110 & ~ V_108 . V_111 [ 0 ] ;
F_52 ( & V_25 -> V_109 , V_106 ) ;
F_15 () ;
F_16 ( & V_25 -> V_32 -> V_33 , V_107 ) ;
F_53 ( V_4 -> V_14 , V_4 -> V_12 . V_12 == NULL ) ;
F_13 ( & V_25 -> V_32 -> V_33 , V_107 ) ;
V_25 -> V_109 = V_108 ;
F_15 () ;
F_16 ( & V_25 -> V_32 -> V_33 , V_107 ) ;
...
if ( ! V_10 ) {
struct V_90 * V_65 ;
struct V_70 * V_112 = NULL ;
V_65 = F_31 ( V_70 ) ;
if ( ! V_65 ) {
V_112 = F_37 ( V_70 -> V_81 , & V_70 -> V_82 ) ;
if ( V_112 )
V_65 = F_31 ( V_112 ) ;
}
if ( V_65 ) {
...
int F_54 ( struct V_1 * V_2 , T_6 V_42 , int V_10 )
{
struct V_3 * V_4 , * * V_113 ;
F_2 ( & V_2 -> V_6 ) ;
for ( V_113 = & V_2 -> V_8 ; ( V_4 = * V_113 ) != NULL ; V_113 = & V_4 -> V_9 ) {
if ( V_4 -> V_42 == V_42 )
break;
}
if ( ! V_4 ) {
