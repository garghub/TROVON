...
V_51 = F_71 () ;
if ( V_51 ) {
F_87 ( V_40 -> V_169 , L_36 ) ;
return V_51 ;
}
V_51 = F_88 ( V_40 , & V_74 . V_208 ) ;
if ( V_51 ) {
F_87 ( V_40 -> V_169 , L_37 ) ;
return V_51 ;
}
...
V_74 . V_52 = F_91 ( V_127 , sizeof( * V_74 . V_52 ) , V_214 ) ;
if ( ! V_74 . V_52 ) {
V_51 = - V_215 ;
goto V_260;
}
...
static int F_95 ( struct V_249 * V_28 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
...
static int F_96 ( struct V_28 * V_73 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
...
static int F_100 ( struct V_28 * V_73 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
