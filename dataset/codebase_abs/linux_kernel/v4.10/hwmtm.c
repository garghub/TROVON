...
F_12 ( L_7 , ( void * ) V_5 -> V_12 . V_13 . V_14 , 0 , 3 ) ;
F_16 ( V_5 ) ;
F_20 ( V_5 ) ;
F_25 ( V_5 ) ;
F_26 ( V_5 ) ;
...
if ( V_20 ) {
V_20 -> V_75 -- ;
F_12 ( L_9 , V_20 -> V_75 , 0 , 3 ) ;
if ( ! V_20 -> V_75 ) {
F_12 ( L_10 , ( void * ) V_20 , 0 , 3 ) ;
#ifndef F_3
...
V_105 = V_51 -> V_57 ;
F_74 ( L_65 , V_183 , V_228 , 2 ) ;
if ( V_228 & V_245 ) {
F_74 ( L_66 , V_105 , V_180 , 3 ) ;
V_105 -> V_254 = V_180 ;
...
F_12 ( L_73 , ( void * ) V_20 , 0 , 4 ) ;
return V_20 ;
}
static void F_80 ( struct V_4 * V_5 , V_19 * V_20 )
{
F_12 ( L_74 , ( void * ) V_20 , 0 , 4 ) ;
V_5 -> V_12 . V_13 . V_86 ++ ;
V_20 -> V_91 = ( V_19 * ) NULL ;
