...
{
struct V_1 * V_2 = V_41 -> V_89 ;
struct V_7 * V_8 = F_2 ( V_2 ) ;
struct V_3 * V_90 = (struct V_3 * ) V_41 -> V_53 ;
int V_91 ;
V_90 -> V_23 = V_41 -> V_92 ;
V_90 -> V_93 = V_94 ;
V_90 -> V_33 = F_34 ( V_8 -> V_34 . V_35 ) ;
V_90 -> V_95 = V_96 ;
V_90 -> V_97 . V_98 [ 0 ] = V_99 ;
V_90 -> V_97 . V_98 [ 1 ] = V_99 ;
V_90 -> V_97 . V_98 [ 2 ] = V_99 ;
#ifdef F_3
...
{
struct V_13 * V_41 = V_78 -> V_79 ;
struct V_102 * V_103 = V_41 -> V_89 -> V_104 ;
struct V_39 * V_40 ;
int V_20 ;
F_11 ( L_10 ,
F_5 ( V_41 -> V_92 ) ) ;
if ( ! F_37 ( & V_103 -> V_105 ) ) {
F_38 ( & V_103 -> V_106 , V_78 , NULL ) ;
if ( ! F_37 ( & V_103 -> V_105 ) )
return - V_26 ;
F_39 ( & V_103 -> V_106 , V_78 ) ;
}
V_20 = - V_101 ;
V_40 = F_40 ( V_103 , struct V_39 , V_107 ) ;
if ( ! F_41 ( V_108 , & V_103 -> V_109 ) )
V_20 = F_33 ( V_40 , V_41 ) ;
F_42 ( & V_103 -> V_105 ) ;
if ( V_20 < 0 )
return V_20 ;
...
V_137:
F_55 ( V_2 ) ;
args -> V_104 -> V_136 = NULL ;
args -> V_104 -> V_138 = NULL ;
F_56 ( V_2 ) ;
F_45 ( V_2 ) ;
return F_48 ( - V_84 ) ;
}
