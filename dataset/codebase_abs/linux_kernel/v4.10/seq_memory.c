...
struct V_1 * F_40 ( int V_62 )
{
struct V_1 * V_2 ;
V_2 = F_41 ( sizeof( * V_2 ) , V_63 ) ;
if ( ! V_2 )
return NULL ;
F_42 ( & V_2 -> V_37 ) ;
V_2 -> V_25 = NULL ;
...
if ( V_2 == NULL )
return;
F_50 ( V_66 , L_2 , V_67 , V_2 -> V_3 ) ;
F_50 ( V_66 , L_3 , V_67 , F_2 ( & V_2 -> V_4 ) ) ;
F_50 ( V_66 , L_4 , V_67 , V_2 -> V_52 ) ;
F_50 ( V_66 , L_5 , V_67 , V_2 -> V_53 ) ;
F_50 ( V_66 , L_6 , V_67 , V_2 -> V_54 ) ;
}
