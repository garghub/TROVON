...
V_4 -> V_130 = V_66 ;
V_4 -> V_132 = V_128 ;
V_83 = (struct V_129 * ) ( V_4 -> V_131 ->
V_133 ) ;
V_83 -> V_130 = F_128 ( V_66 ) ;
V_83 -> V_132 = F_128 ( V_128 ) ;
V_83 -> V_134 = F_128 ( V_4 -> V_134 ) ;
F_129 ( V_4 -> V_131 ) ;
V_107 = F_106 ( V_2 ) ;
if ( F_119 ( V_2 ) )
F_120 ( V_4 -> V_131 ,
...
int V_141 = 0 ;
struct V_8 * V_142 ;
unsigned long V_143 = V_39 -> V_114 ;
struct V_3 * V_4 = F_2 ( V_64 ) ;
int V_144 = 0 ;
int V_107 ;
F_80 ( V_143 <= 0 ) ;
...
V_39 -> V_150 |= V_156 ;
F_133 ( V_64 , V_39 ) ;
if ( V_39 -> V_114 == 0 || F_87 ( & V_39 -> V_148 ) == 0 ) {
return 0 ;
}
V_46 = V_39 -> V_126 ;
while ( V_46 ) {
...
F_70 ( V_157 ) ;
F_137 ( V_157 ) ;
if ( V_46 -> V_9 && F_136 ( V_46 ) && F_96 ( V_157 ) ) {
if ( ! F_135 ( V_157 ) ||
F_140 ( V_157 ) )
F_43 () ;
F_78 ( V_77 , V_157 , NULL , F_76 ) ;
V_80 ++ ;
} else {
F_67 ( V_157 ) ;
}
...
( ! V_161 && V_162 < V_160 ) ) {
if ( V_39 -> V_114 == 0 || ( V_39 -> V_150 & V_156 ) ||
F_87 ( & V_39 -> V_105 )
|| ! ( V_39 -> V_150 & V_151 ) ) {
F_133 ( V_64 , V_39 ) ;
break;
...
V_167 = F_87 ( & V_169 -> V_148 ) ;
if ( V_167 > 0 ) {
V_169 -> V_150 &= ~ V_156 ;
}
V_166 += V_167 ;
V_170 = V_169 ;
if ( V_169 -> V_103 . V_20 == & V_4 -> V_67 )
break;
V_169 = F_55 ( V_169 -> V_103 . V_20 ) ;
}
F_49 ( V_39 ) ;
F_49 ( V_170 ) ;
if ( V_170 != V_39 ) {
V_80 = F_143 ( V_64 , V_39 , & V_169 , & V_66 , V_166 , V_25 ) ;
}
F_132 ( V_64 , V_170 , 1 ) ;
F_50 ( V_64 , V_170 ) ;
F_50 ( V_64 , V_39 ) ;
...
static int F_149 ( struct V_175 * V_176 ,
...
F_156 ( V_2 ) ;
F_157 ( & F_158 ( V_2 ) -> V_183 ) ;
F_157 ( & F_2 ( V_2 ) -> V_184 ) ;
F_146 ( V_2 ) ;
F_159 ( V_2 ) ;
return 0 ;
}
int F_160 ( struct V_175 * V_176 ,
struct V_1 * V_2 )
{
return F_149 ( V_176 , V_2 , 0 ) ;
}
int F_161 ( struct V_175 * V_176 ,
struct V_1 * V_2 )
{
return F_149 ( V_176 , V_2 , 1 ) ;
}
...
if ( ! V_189 )
return 0 ;
V_186 = (struct V_185 * ) V_189 -> V_133 ;
if ( F_166 ( V_186 ) > 0
...
if ( ! V_192 )
return 0 ;
V_188 = (struct V_187 * ) V_192 -> V_133 ;
...
memcpy ( V_201 [ V_25 ] -> V_133 , V_200 [ V_25 ] -> V_133 ,
V_201 [ V_25 ] -> V_208 ) ;
F_65 ( V_201 [ V_25 ] ) ;
F_147 ( V_200 [ V_25 ] ) ;
}
...
V_83 = (struct V_129 * ) ( V_4 -> V_131 -> V_133 ) ;
if ( F_178 ( V_83 -> V_132 ) <
F_111 ( V_2 )
&& F_178 ( V_83 -> V_130 ) > 0 ) {
V_198 =
F_110 ( V_2 ) +
F_178 ( V_83 -> V_132 ) ;
V_199 = F_178 ( V_83 -> V_130 ) + 1 ;
V_191 = F_178 ( V_83 -> V_134 ) ;
F_169 ( V_2 , V_194 ,
L_84
L_85
L_86 , F_178 ( V_83 -> V_132 ) ,
F_178 ( V_83 -> V_130 ) ) ;
V_217 = 1 ;
V_189 =
F_171 ( V_2 ,
...
V_4 -> V_147 = F_178 ( V_83 -> V_255 . V_257 ) ;
...
F_226 ( 1 ) ;
F_108 ( V_2 , V_107 ) ;
V_4 -> V_89 -> V_150 |= V_286 ;
while ( ( F_87 ( & V_4 -> V_145 ) > 0 ||
F_87 ( & V_4 -> V_270 ) ) &&
V_4 -> V_65 == V_66 ) {
F_216 ( V_2 ) ;
}
...
static int F_227 ( struct V_175 * V_176 ,
...
V_112 = F_151 ( & V_177 , V_2 ) ;
if ( V_112 )
goto V_294;
if ( V_289 != V_4 -> V_65 ) {
V_112 = F_150 ( & V_177 , 0 ) ;
} else {
V_112 = F_150 ( & V_177 , V_296 ) ;
}
if ( V_112 )
goto V_294;
F_40 ( V_2 , V_4 . V_297 ) ;
...
return F_227 ( V_176 , V_2 , 1 , V_303 ) ;
}
int F_155 ( struct V_175 * V_176 ,
struct V_1 * V_2 )
{
struct V_175 * V_301 = V_282 -> V_300 ;
V_176 -> V_302 = V_301 ;
F_80 ( V_301 && V_301 -> V_277 > 1 ) ;
return F_227 ( V_176 , V_2 , 1 , V_293 ) ;
}
int F_230 ( struct V_175 * V_176 ,
struct V_1 * V_2 , unsigned long V_287 )
{
struct V_175 * V_301 = V_282 -> V_300 ;
int V_80 ;
...
V_80 = F_227 ( V_176 , V_2 , V_287 , V_304 ) ;
F_80 ( V_282 -> V_300 != V_176 ) ;
if ( V_80 )
...
int F_154 ( struct V_175 * V_176 ,
struct V_8 * V_9 )
{
struct V_1 * V_2 = V_176 -> V_275 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
if ( V_4 -> V_114 >= V_4 -> V_147 ) {
F_51 ( V_176 -> V_275 , L_147 ,
L_148 ,
V_4 -> V_114 ) ;
}
if ( F_135 ( V_9 ) ) {
...
V_172 = V_46 -> V_53 ;
while ( V_172 && F_136 ) {
if ( V_172 -> V_123 && V_172 -> V_123 -> V_114 > 0 &&
F_87 ( & V_172 -> V_123 -> V_105 ) > 0 && V_172 -> V_9 &&
...
return F_150 ( V_176 , V_296 | V_312 ) ;
}
...
1 ) ;
F_154 ( & V_176 , F_153 ( V_2 ) ) ;
F_150 ( & V_176 , V_296 | V_312 ) ;
}
}
}
static int F_243 ( struct V_175 * V_176 , int V_315 )
{
T_3 V_276 ;
int V_316 = V_315 & V_182 ;
...
V_4 -> V_264 -= ( V_176 -> V_278 - V_176 -> V_298 ) ;
if ( F_87 ( & V_4 -> V_145 ) > 0 )
F_88 ( & V_4 -> V_145 ) ;
F_80 ( V_4 -> V_114 == 0 ) ;
if ( F_87 ( & V_4 -> V_145 ) > 0 ) {
...
static int F_150 ( struct V_175 * V_176 , int V_315 )
{
struct V_1 * V_2 = V_176 -> V_275 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
...
F_65 ( V_189 ) ;
V_186 = (struct V_185 * ) ( V_189 ) -> V_133 ;
memset ( V_189 -> V_133 , 0 , V_189 -> V_208 ) ;
...
1 ) % F_111 ( V_2 ) ) ) ;
V_188 = (struct V_187 * ) V_192 -> V_133 ;
memset ( V_192 -> V_133 , 0 , V_192 -> V_208 ) ;
...
void F_269 ( struct V_1 * V_2 , int V_340 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
if ( F_41 ( V_341 , & V_4 -> V_150 ) )
return;
if ( ! V_4 -> V_94 )
V_4 -> V_94 = V_340 ;
V_2 -> V_179 |= V_180 ;
F_19 ( V_341 , & V_4 -> V_150 ) ;
#ifdef F_115
F_270 () ;
#endif
}
