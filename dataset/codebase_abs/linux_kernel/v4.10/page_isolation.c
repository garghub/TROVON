...
if ( F_23 ( V_29 == V_13 ) )
return NULL ;
return F_24 ( V_5 + V_29 ) ;
}
int F_25 ( unsigned long V_12 , unsigned long V_30 ,
...
int F_28 ( unsigned long V_12 , unsigned long V_30 ,
unsigned V_18 )
{
unsigned long V_5 ;
struct V_1 * V_1 ;
...
F_29 ( unsigned long V_5 , unsigned long V_30 ,
bool V_2 )
{
struct V_1 * V_1 ;
while ( V_5 < V_30 ) {
...
int F_31 ( unsigned long V_12 , unsigned long V_30 ,
bool V_2 )
{
unsigned long V_5 , V_4 ;
struct V_1 * V_1 ;
struct V_3 * V_3 ;
for ( V_5 = V_12 ; V_5 < V_30 ; V_5 += V_14 ) {
V_1 = F_22 ( V_5 , V_14 ) ;
if ( V_1 && F_7 ( V_1 ) != V_19 )
break;
}
V_1 = F_22 ( V_12 , V_30 - V_12 ) ;
if ( ( V_5 < V_30 ) || ! V_1 )
return - V_10 ;
V_3 = F_2 ( V_1 ) ;
F_3 ( & V_3 -> V_11 , V_4 ) ;
...
F_11 ( & V_3 -> V_11 , V_4 ) ;
F_32 ( V_12 , V_30 , V_5 ) ;
return V_5 < V_30 ? - V_10 : 0 ;
}
struct V_1 * F_33 ( struct V_1 * V_1 , unsigned long V_33 ,
int * * V_34 )
{
T_1 V_35 = V_36 | V_28 ;
if ( F_34 ( V_1 ) )
