...
if ( ! V_308 )
return - V_60 ;
V_90 = F_143 ( L_73 , 0 , & V_306 ) ;
if ( V_90 == V_309 )
return - V_60 ;
else if ( F_144 ( V_90 ) ) {
const char * V_310 = F_145 ( V_90 ) ;
F_24 ( L_74 , V_310 ) ;
return - V_48 ;
}
V_63 = F_33 ( V_306 ) ;
...
static int T_6 F_157 ( enum V_332 V_333 )
{
int V_63 = 0 ;
while ( V_318 != V_333 ) {
V_63 = F_153 () ;
...
V_308 = true ;
V_336 = 1 ;
V_339 . V_7 . V_340 = F_163 ;
return 1 ;
}
static int T_6 F_165 ( char * V_341 )
{
V_342 = true ;
return 1 ;
}
static int T_6 F_166 ( char * V_341 )
{
for (; * V_341 ; ++ V_341 ) {
...
int F_176 ( T_1 V_1 , T_3 V_348 , T_3 V_349 , T_3 V_350 ,
T_4 * V_174 , bool V_351 )
{
struct V_6 * V_7 = V_111 [ V_1 ] ;
if ( ! V_202 || V_7 == NULL )
