...
static int F_41 ( struct V_52 * V_53 , int V_54 ,
struct V_55 * V_56 )
{
if ( V_54 > 12 )
return - V_57 ;
...
V_56 -> V_58 += ( V_54 / 3 ) * 0x10 ;
return 0 ;
}
static int F_42 ( struct V_52 * V_53 , int V_54 ,
struct V_55 * V_56 )
{
if ( V_54 )
return - V_57 ;
...
{
if ( F_44 () ) {
V_60 [ 1 ] . V_61 = 5 * 1024 * 1024 ;
} else if ( F_3 () ) {
V_60 [ 1 ] . V_61 = 58 * 1024 * 1024 ;
V_62 . V_63 = 1 ;
V_64 . V_65 = & V_66 ;
} else if ( F_45 () ) {
V_60 [ 1 ] . V_61 = 32 * 1024 * 1024 ;
V_62 . V_63 = 1 ;
V_64 . V_65 = & V_66 ;
}
F_2 ( & V_67 ) ;
...
static void F_56 ( enum V_72 V_73 , const char * V_74 )
{
T_5 V_75 = F_57 ( V_76 ) ;
if ( ( V_75 & 0xffff0000 ) == 0x7ff00000 )
F_58 ( ( V_75 & 0xffff ) | 0x7ee00000 , V_76 ) ;
F_54 () ;
}
...
static void T_1 F_66 ( struct V_83 * V_84 , char * * V_85 )
{
F_67 () ;
F_68 ( 0xa0000000 , V_86 ) ;
}
