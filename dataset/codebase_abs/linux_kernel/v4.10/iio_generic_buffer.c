...
struct V_1 * V_2 = NULL ;
F_23 () ;
while ( ( V_51 = F_25 ( V_46 , V_47 , L_36 , V_66 ,
NULL ) ) != - 1 ) {
switch ( V_51 ) {
case 'a' :
V_35 = V_67 ;
...
case 'T' :
V_32 = 0 ;
V_59 = strtoul ( V_68 , & V_64 , 10 ) ;
if ( V_32 )
return - V_32 ;
break;
case 'w' :
V_32 = 0 ;
V_49 = strtoul ( V_68 , & V_64 , 10 ) ;
if ( V_32 ) {
V_26 = - V_32 ;
goto error;
}
...
V_58 = F_27 ( V_56 , L_39 ) ;
if ( V_58 < 0 ) {
fprintf ( V_28 , L_40 , V_56 ) ;
V_26 = V_58 ;
goto error;
}
}
printf ( L_41 , V_58 ) ;
V_26 = F_28 ( & V_20 , L_42 , V_69 , V_58 ) ;
if ( V_26 < 0 )
return - V_70 ;
if ( ! V_56 ) {
V_56 = malloc ( V_71 ) ;
...
V_26 = F_29 ( L_43 , V_20 , V_56 ) ;
if ( V_26 < 0 ) {
fprintf ( V_28 , L_44 , V_58 ) ;
goto error;
}
}
if ( V_63 ) {
...
char * V_72 ;
V_26 = F_28 ( & V_72 , L_46 , V_69 , V_59 ) ;
if ( V_26 < 0 ) {
return - V_70 ;
}
V_55 = malloc ( V_71 ) ;
V_26 = F_29 ( L_43 , V_72 , V_55 ) ;
free ( V_72 ) ;
if ( V_26 < 0 ) {
fprintf ( V_28 , L_47 , V_59 ) ;
return V_26 ;
}
printf ( L_48 , V_59 ) ;
} else {
...
V_26 = F_17 ( L_71 , V_34 , V_50 ) ;
if ( V_26 < 0 )
goto error;
V_26 = F_17 ( L_31 , V_34 , 1 ) ;
if ( V_26 < 0 ) {
fprintf ( V_28 ,
L_72 , strerror ( - V_26 ) ) ;
goto error;
...
V_26 = F_28 ( & V_60 , L_73 , V_58 ) ;
if ( V_26 < 0 ) {
V_26 = - V_70 ;
goto error;
}
V_54 = F_32 ( V_60 , V_73 | V_74 ) ;
if ( V_54 == - 1 ) {
V_26 = - V_32 ;
fprintf ( V_28 , L_74 , V_60 ) ;
goto error;
}
