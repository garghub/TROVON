...
struct V_17 * F_47 ( int V_8 , struct V_1 * V_9 )
{
struct V_7 * V_56 ;
F_48 (pnr,
...
struct V_17 * F_49 ( int V_8 )
{
return F_47 ( V_8 , F_50 ( V_57 ) ) ;
}
void F_51 ( struct V_58 * V_59 , enum V_47 type )
{
struct V_60 * V_61 = & V_59 -> V_62 [ type ] ;
F_44 ( & V_61 -> V_63 , & V_61 -> V_17 -> V_53 [ type ] ) ;
}
static void F_52 ( struct V_58 * V_59 , enum V_47 type ,
struct V_17 * V_64 )
{
struct V_60 * V_61 ;
struct V_17 * V_17 ;
...
if ( ! F_53 ( & V_17 -> V_53 [ V_48 ] ) )
return;
F_28 ( V_17 ) ;
}
void F_54 ( struct V_58 * V_59 , enum V_47 type )
{
F_52 ( V_59 , type , NULL ) ;
}
...
void F_56 ( struct V_58 * V_65 , struct V_58 * V_64 ,
enum V_47 type )
{
V_64 -> V_62 [ type ] . V_17 = V_65 -> V_62 [ type ] . V_17 ;
F_57 ( & V_65 -> V_62 [ type ] . V_63 , & V_64 -> V_62 [ type ] . V_63 ) ;
}
struct V_58 * F_58 ( struct V_17 * V_17 , enum V_47 type )
{
struct V_58 * V_66 = NULL ;
if ( V_17 ) {
struct V_67 * V_68 ;
V_68 = F_59 ( F_60 ( & V_17 -> V_53 [ type ] ) ,
F_61 () ) ;
if ( V_68 )
V_66 = F_62 ( V_68 , struct V_58 , V_62 [ ( type ) ] . V_63 ) ;
}
return V_66 ;
}
struct V_58 * F_63 ( T_1 V_8 , struct V_1 * V_9 )
{
F_64 ( ! F_65 () ,
L_1 ) ;
return F_58 ( F_47 ( V_8 , V_9 ) , V_69 ) ;
}
struct V_58 * F_66 ( T_1 V_70 )
{
return F_63 ( V_70 , F_50 ( V_57 ) ) ;
}
struct V_17 * F_67 ( struct V_58 * V_59 , enum V_47 type )
{
struct V_17 * V_17 ;
F_68 () ;
if ( type != V_69 )
V_59 = V_59 -> V_71 ;
V_17 = F_69 ( F_70 ( V_59 -> V_62 [ type ] . V_17 ) ) ;
F_71 () ;
return V_17 ;
}
...
if ( type != V_69 )
V_59 = V_59 -> V_71 ;
V_8 = F_75 ( F_70 ( V_59 -> V_62 [ type ] . V_17 ) , V_9 ) ;
}
F_71 () ;
return V_8 ;
}
...
struct V_1 * F_50 ( struct V_58 * V_72 )
{
