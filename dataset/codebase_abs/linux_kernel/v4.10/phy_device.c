...
int F_132 ( struct V_11 * V_242 , struct V_116 * V_118 )
{
int V_171 ;
...
V_171 = F_133 ( & V_242 -> V_48 . V_10 ) ;
if ( V_171 ) {
F_62 ( L_19 ,
V_242 -> V_114 , V_171 ) ;
return V_171 ;
}
F_134 ( L_20 , V_242 -> V_114 ) ;
return 0 ;
}
int F_135 ( struct V_11 * V_242 , int V_39 ,
struct V_116 * V_118 )
{
int V_47 , V_20 = 0 ;
for ( V_47 = 0 ; V_47 < V_39 ; V_47 ++ ) {
V_20 = F_132 ( V_242 + V_47 , V_118 ) ;
if ( V_20 ) {
while ( V_47 -- > 0 )
F_136 ( V_242 + V_47 ) ;
break;
