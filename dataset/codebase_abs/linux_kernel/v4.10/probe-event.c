...
{
struct V_14 * V_24 ;
T_3 V_18 = V_110 -> V_59 + V_110 -> V_86 - V_114 ;
V_24 = F_64 ( V_16 , V_18 ) ;
if ( ! V_24 )
return - V_26 ;
...
for ( V_58 = 0 ; V_58 < V_57 ; V_58 ++ ) {
if ( ! V_56 [ V_58 ] . V_91 . V_59 || V_56 [ V_58 ] . V_91 . V_87 )
continue;
...
static int F_76 ( T_10 * V_124 , int V_125 , bool V_126 , bool V_127 )
{
...
F_77 ( stdout , V_130 , V_132 , V_125 ) ;
}
F_77 ( stdout , V_130 , L_40 , V_46 ) ;
} while ( strchr ( V_46 , '\n' ) == NULL );
return 1 ;
error:
if ( ferror ( V_124 ) ) {
...
static int F_78 ( T_10 * V_124 , int V_125 , bool V_126 , bool V_127 )
{
int V_133 = F_76 ( V_124 , V_125 , V_126 , V_127 ) ;
if ( V_133 == 0 ) {
F_7 ( L_42 ) ;
V_133 = - 1 ;
}
...
static int F_79 ( struct V_92 * V_93 , const char * V_29 ,
bool V_40 )
{
int V_125 = 1 ;
struct V_134 * V_135 ;
...
V_90 = V_93 -> V_98 ;
V_4 = F_81 ( V_90 , V_93 -> V_136 , & V_93 -> V_98 ) ;
if ( V_90 != V_93 -> V_98 )
free ( V_90 ) ;
if ( V_4 < 0 ) {
F_7 ( L_45 ) ;
...
V_4 = F_83 ( V_124 , V_125 ++ ) ;
if ( V_4 < 0 )
goto V_95;
}
F_84 (ln, lr->line_list) {
for (; V_135 -> V_58 > V_125 ; V_125 ++ ) {
V_4 = F_85 ( V_124 , V_125 - V_93 -> V_86 ) ;
if ( V_4 < 0 )
goto V_95;
}
...
int F_88 ( struct V_92 * V_93 , const char * V_29 , bool V_40 )
{
int V_4 ;
V_4 = F_2 ( V_40 ) ;
if ( V_4 < 0 )
return V_4 ;
V_4 = F_79 ( V_93 , V_29 , V_40 ) ;
F_8 () ;
return V_4 ;
}
...
int F_94 ( struct V_88 * V_149 , int V_150 ,
struct V_138 * V_139 )
{
int V_58 , V_4 = 0 ;
struct V_81 * V_82 ;
...
V_4 = F_89 ( V_82 , & V_149 [ V_58 ] , V_139 ) ;
F_58 ( V_82 ) ;
V_11:
F_8 () ;
return V_4 ;
...
int F_88 ( struct V_92 * V_93 V_120 ,
...
int F_94 ( struct V_88 * V_149 V_120 ,
int V_150 V_120 ,
...
{
memset ( V_93 , 0 , sizeof( * V_93 ) ) ;
V_93 -> V_152 = F_98 ( NULL ) ;
if ( ! V_93 -> V_152 )
return - V_47 ;
else
return 0 ;
}
static int F_99 ( char * * V_153 , int * V_154 , const char * V_155 )
{
...
static bool F_101 ( const char * V_15 )
{
...
int F_102 ( const char * V_156 , struct V_92 * V_93 )
{
...
if ( V_157 ) {
* V_157 ++ = '\0' ;
V_101 = F_99 ( & V_157 , & V_93 -> V_28 , L_58 ) ;
if ( V_101 )
goto V_101;
if ( * V_157 == '+' || * V_157 == '-' ) {
const char V_158 = * V_157 ++ ;
V_101 = F_99 ( & V_157 , & V_93 -> V_95 , L_59 ) ;
if ( V_101 )
goto V_101;
if ( V_158 == '+' ) {
V_93 -> V_95 += V_93 -> V_28 ;
...
static int F_103 ( char * * V_156 , struct V_88 * V_89 )
{
char * V_153 ;
V_153 = strchr ( * V_156 , ':' ) ;
if ( V_153 ) {
* V_153 = '\0' ;
if ( ! V_89 -> V_159 && ! F_101 ( * V_156 ) )
goto V_160;
...
return - V_48 ;
if ( V_156 [ 0 ] == '%' ||
( ! strncmp ( V_156 , L_67 , 4 ) &&
! ! strchr ( V_156 , ':' ) && ! strchr ( V_156 , '=' ) ) ) {
V_89 -> V_159 = true ;
if ( V_156 [ 0 ] == '%' )
V_156 ++ ;
}
V_153 = strpbrk ( V_156 , L_68 ) ;
if ( V_89 -> V_159 ) {
if ( V_153 ) {
if ( * V_153 != '@' ) {
F_100 ( L_69 ,
...
V_4 = F_103 ( & V_156 , V_89 ) ;
if ( V_4 == 0 ) {
if ( F_107 ( & V_89 -> V_91 . V_53 , L_70 , V_89 -> V_162 ) < 0 )
V_4 = - V_105 ;
}
return V_4 ;
}
...
if ( ! strpbrk ( V_156 , L_71 ) && ( V_153 = strpbrk ( V_156 , L_72 ) ) != NULL ) {
if ( memchr ( V_156 , '.' , V_153 - V_156 ) )
V_164 = true ;
}
V_153 = strpbrk ( V_156 , L_73 ) ;
if ( V_153 ) {
V_163 = * V_153 ;
* V_153 ++ = '\0' ;
}
...
static int F_108 ( char * V_1 , struct V_166 * V_156 )
{
char * V_90 , * V_167 ;
struct V_168 * * V_169 ;
F_4 ( L_95 , V_1 ) ;
...
V_90 = strpbrk ( V_1 , L_98 ) ;
if ( ! F_110 ( V_1 ) || ! V_90 ) {
V_156 -> V_146 = F_26 ( V_1 ) ;
if ( V_156 -> V_146 == NULL )
return - V_47 ;
F_4 ( L_99 , V_156 -> V_146 ) ;
return 0 ;
}
V_156 -> V_146 = F_109 ( V_1 , V_90 - V_1 ) ;
if ( V_156 -> V_146 == NULL )
return - V_47 ;
V_167 = V_156 -> V_146 ;
F_4 ( L_100 , V_156 -> V_146 ) ;
V_169 = & V_156 -> V_170 ;
do {
* V_169 = F_111 ( sizeof( struct V_168 ) ) ;
if ( * V_169 == NULL )
return - V_47 ;
if ( * V_90 == '[' ) {
V_1 = V_90 ;
...
if ( V_90 ) {
( * V_169 ) -> V_15 = F_109 ( V_1 , V_90 - V_1 ) ;
if ( ( * V_169 ) -> V_15 == NULL )
return - V_47 ;
if ( * V_1 != '[' )
V_167 = ( * V_169 ) -> V_15 ;
F_4 ( L_104 , ( * V_169 ) -> V_15 , ( * V_169 ) -> V_172 ) ;
V_169 = & ( * V_169 ) -> V_173 ;
}
} while ( V_90 );
( * V_169 ) -> V_15 = F_26 ( V_1 ) ;
...
if ( * V_1 != '[' )
V_167 = ( * V_169 ) -> V_15 ;
F_4 ( L_105 , ( * V_169 ) -> V_15 , ( * V_169 ) -> V_172 ) ;
if ( ! V_156 -> V_15 ) {
...
int F_112 ( const char * V_174 , struct V_88 * V_89 )
{
char * * V_175 ;
int V_176 , V_58 , V_4 = 0 ;
V_175 = F_113 ( V_174 , & V_176 ) ;
if ( ! V_175 ) {
F_4 ( L_106 ) ;
return - V_47 ;
}
...
V_4 = F_104 ( V_175 [ 0 ] , V_89 ) ;
if ( V_4 < 0 )
goto V_11;
V_89 -> V_179 = V_176 - 1 ;
V_89 -> args = F_111 ( sizeof( struct V_166 ) * V_89 -> V_179 ) ;
if ( V_89 -> args == NULL ) {
V_4 = - V_47 ;
goto V_11;
}
for ( V_58 = 0 ; V_58 < V_89 -> V_179 && V_4 >= 0 ; V_58 ++ ) {
V_4 = F_108 ( V_175 [ V_58 + 1 ] , & V_89 -> args [ V_58 ] ) ;
if ( V_4 >= 0 &&
F_110 ( V_89 -> args [ V_58 ] . V_146 ) && V_89 -> V_91 . V_87 ) {
F_100 ( L_108
L_109 ) ;
V_4 = - V_48 ;
}
...
int F_116 ( const char * V_174 , struct V_55 * V_182 )
{
...
V_187 = strtok_r ( V_185 , L_112 , & V_186 ) ;
V_188 = strtok_r ( NULL , L_113 , & V_186 ) ;
V_189 = strtok_r ( NULL , L_114 , & V_186 ) ;
...
F_4 ( L_116 , V_182 -> V_161 , V_182 -> V_162 , V_183 ) ;
V_110 -> V_87 = ( V_183 == 'r' ) ;
V_184 = strchr ( V_175 [ 1 ] , ':' ) ;
if ( V_184 ) {
V_110 -> V_29 = F_109 ( V_175 [ 1 ] , V_184 - V_175 [ 1 ] ) ;
if ( ! V_110 -> V_29 ) {
V_4 = - V_47 ;
goto V_11;
}
...
V_184 = V_175 [ 1 ] ;
V_187 = strtok_r ( V_184 , L_117 , & V_186 ) ;
if ( V_187 [ 0 ] == '0' ) {
if ( strcmp ( V_187 , L_74 ) == 0 ) {
if ( ! V_175 [ 2 ] || strcmp ( V_175 [ 2 ] , L_118 ) ) {
V_4 = - V_48 ;
goto V_11;
}
V_110 -> V_59 = 0 ;
...
V_182 -> V_179 = V_176 - 2 ;
V_182 -> args = F_111 ( sizeof( struct V_190 ) * V_182 -> V_179 ) ;
if ( V_182 -> args == NULL ) {
V_4 = - V_47 ;
goto V_11;
}
...
V_101 = F_119 ( & V_46 , L_119 , V_192 -> V_15 , V_192 -> V_146 ) ;
else
V_101 = F_120 ( & V_46 , V_192 -> V_15 ? : V_192 -> V_146 ) ;
if ( V_101 )
goto V_11;
while ( V_170 ) {
if ( V_170 -> V_15 [ 0 ] == '[' )
V_101 = F_120 ( & V_46 , V_170 -> V_15 ) ;
else
V_101 = F_119 ( & V_46 , L_120 , V_170 -> V_172 ? L_121 : L_122 ,
V_170 -> V_15 ) ;
V_170 = V_170 -> V_173 ;
if ( V_101 )
goto V_11;
...
if ( V_192 -> type )
if ( F_119 ( & V_46 , L_123 , V_192 -> type ) < 0 )
goto V_11;
V_4 = F_121 ( & V_46 , NULL ) ;
V_11:
F_122 ( & V_46 ) ;
...
return NULL ;
if ( V_51 -> V_53 ) {
if ( F_120 ( & V_46 , V_51 -> V_53 ) < 0 )
goto V_11;
if ( V_51 -> V_86 )
V_101 = F_119 ( & V_46 , L_124 , V_51 -> V_86 ) ;
else if ( V_51 -> line )
V_101 = F_119 ( & V_46 , L_125 , V_51 -> line ) ;
else if ( V_51 -> V_87 )
V_101 = F_120 ( & V_46 , L_126 ) ;
if ( V_101 )
goto V_11;
}
if ( V_51 -> V_52 ) {
...
return NULL ;
if ( V_89 -> V_162 )
if ( F_119 ( & V_46 , L_128 , V_89 -> V_161 ? : V_49 ,
V_89 -> V_162 ) < 0 )
goto V_11;
V_90 = F_75 ( & V_89 -> V_91 ) ;
if ( ! V_90 || F_120 ( & V_46 , V_90 ) < 0 )
goto V_11;
free ( V_90 ) ;
for ( V_58 = 0 ; V_58 < V_89 -> V_179 ; V_58 ++ ) {
V_90 = F_117 ( V_89 -> args + V_58 ) ;
if ( ! V_90 || F_119 ( & V_46 , L_129 , V_90 ) < 0 )
goto V_11;
free ( V_90 ) ;
}
V_4 = F_121 ( & V_46 , NULL ) ;
...
static int F_124 ( struct V_194 * V_172 ,
struct V_193 * V_46 , int V_195 )
{
int V_101 ;
if ( V_172 -> V_173 ) {
V_195 = F_124 ( V_172 -> V_173 , V_46 ,
V_195 + 1 ) ;
if ( V_195 < 0 )
return V_195 ;
}
V_101 = F_119 ( V_46 , L_130 , V_172 -> V_86 ) ;
return ( V_101 < 0 ) ? V_101 : V_195 ;
}
static int F_125 ( struct V_190 * V_156 ,
struct V_193 * V_46 )
{
struct V_194 * V_172 = V_156 -> V_172 ;
int V_195 = 0 , V_101 ;
if ( V_156 -> V_15 )
V_101 = F_119 ( V_46 , L_131 , V_156 -> V_15 ) ;
else
V_101 = F_126 ( V_46 , ' ' ) ;
if ( V_101 )
return V_101 ;
...
V_172 = V_172 -> V_173 ;
if ( V_172 ) {
V_195 = F_124 ( V_172 , V_46 , 1 ) ;
if ( V_195 < 0 )
return V_195 ;
}
if ( V_156 -> V_191 [ 0 ] == '@' && V_156 -> V_172 )
V_101 = F_119 ( V_46 , L_132 , V_156 -> V_191 , V_156 -> V_172 -> V_86 ) ;
else
V_101 = F_120 ( V_46 , V_156 -> V_191 ) ;
while ( ! V_101 && V_195 -- )
V_101 = F_126 ( V_46 , ')' ) ;
if ( ! V_101 && V_156 -> type )
V_101 = F_119 ( V_46 , L_123 , V_156 -> type ) ;
return V_101 ;
}
char * F_127 ( struct V_55 * V_182 )
{
struct V_109 * V_110 = & V_182 -> V_91 ;
struct V_193 V_46 ;
char * V_4 = NULL ;
...
if ( F_118 ( & V_46 , 32 ) < 0 )
return NULL ;
if ( F_119 ( & V_46 , L_133 , V_110 -> V_87 ? 'r' : 'p' ,
V_182 -> V_161 , V_182 -> V_162 ) < 0 )
goto error;
if ( V_182 -> V_83 && ! V_110 -> V_59 ) {
if ( ! V_110 -> V_14 || strcmp ( V_110 -> V_14 , L_134 ) )
goto error;
}
if ( V_182 -> V_83 )
V_101 = F_119 ( & V_46 , L_135 , V_110 -> V_29 , V_110 -> V_59 ) ;
else if ( ! strncmp ( V_110 -> V_14 , L_74 , 2 ) )
V_101 = F_119 ( & V_46 , L_136 , V_110 -> V_29 ? : L_37 ,
V_110 -> V_29 ? L_112 : L_37 , V_110 -> V_59 ) ;
else
V_101 = F_119 ( & V_46 , L_137 , V_110 -> V_29 ? : L_37 ,
V_110 -> V_29 ? L_112 : L_37 , V_110 -> V_14 , V_110 -> V_86 ) ;
if ( V_101 )
goto error;
for ( V_58 = 0 ; V_58 < V_182 -> V_179 ; V_58 ++ )
if ( F_125 ( & V_182 -> args [ V_58 ] , & V_46 ) < 0 )
goto error;
V_4 = F_121 ( & V_46 , NULL ) ;
error:
F_122 ( & V_46 ) ;
...
static int F_128 ( struct V_109 * V_110 ,
struct V_50 * V_51 ,
bool V_111 )
{
...
static int F_129 ( struct V_109 * V_110 ,
struct V_50 * V_51 ,
bool V_111 )
{
char V_46 [ 128 ] ;
...
V_4 = F_1 ( V_46 , 128 , L_139 V_85 , ( T_3 ) V_110 -> V_59 ) ;
if ( V_4 < 0 )
return V_4 ;
V_51 -> V_53 = F_26 ( V_46 ) ;
V_51 -> V_86 = 0 ;
...
static int F_130 ( struct V_55 * V_182 ,
...
return - V_47 ;
V_4 = F_129 ( & V_182 -> V_91 , & V_89 -> V_91 , V_111 ) ;
if ( V_4 < 0 )
return V_4 ;
...
if ( ( V_4 = F_118 ( & V_46 , 32 ) ) < 0 )
goto error;
V_4 = F_125 ( & V_182 -> args [ V_58 ] , & V_46 ) ;
V_89 -> args [ V_58 ] . V_15 = F_121 ( & V_46 , NULL ) ;
}
...
static int F_132 ( struct V_50 * V_197 ,
struct V_50 * V_198 )
{
V_197 -> V_52 = F_133 ( V_198 -> V_52 , V_199 ) ;
V_197 -> V_53 = F_133 ( V_198 -> V_53 , V_199 ) ;
V_197 -> V_54 = F_133 ( V_198 -> V_54 , V_199 ) ;
...
static int F_134 ( struct V_166 * V_197 ,
struct V_166 * V_198 )
{
struct V_168 * V_170 , * * V_200 ;
V_197 -> V_15 = F_133 ( V_198 -> V_15 , V_199 ) ;
V_197 -> V_146 = F_133 ( V_198 -> V_146 , V_199 ) ;
V_197 -> type = F_133 ( V_198 -> type , V_199 ) ;
V_170 = V_198 -> V_170 ;
V_200 = & ( V_197 -> V_170 ) ;
while ( V_170 ) {
* V_200 = F_111 ( sizeof( * V_170 ) ) ;
if ( ! * V_200 )
goto V_199;
( * V_200 ) -> V_15 = F_133 ( V_170 -> V_15 , V_199 ) ;
...
int F_135 ( struct V_88 * V_197 ,
struct V_88 * V_198 )
{
int V_58 ;
V_197 -> V_162 = F_133 ( V_198 -> V_162 , V_199 ) ;
V_197 -> V_161 = F_133 ( V_198 -> V_161 , V_199 ) ;
V_197 -> V_39 = F_133 ( V_198 -> V_39 , V_199 ) ;
V_197 -> V_83 = V_198 -> V_83 ;
if ( F_132 ( & V_197 -> V_91 , & V_198 -> V_91 ) < 0 )
goto V_199;
V_197 -> args = F_111 ( sizeof( struct V_166 ) * V_198 -> V_179 ) ;
if ( ! V_197 -> args )
goto V_199;
V_197 -> V_179 = V_198 -> V_179 ;
for ( V_58 = 0 ; V_58 < V_198 -> V_179 ; V_58 ++ )
if ( F_134 ( & V_197 -> args [ V_58 ] , & V_198 -> args [ V_58 ] ) < 0 )
goto V_199;
return 0 ;
V_199:
F_131 ( V_197 ) ;
...
static void F_136 ( struct V_201 * V_202 )
{
struct V_203 * V_142 ;
while ( ! F_137 ( V_202 ) ) {
V_142 = F_138 ( V_202 ,
...
static int F_140 ( struct V_201 * V_202 )
{
struct V_203 * V_142 ;
const char * V_205 = F_141 () ;
char V_46 [ V_206 ] , * V_184 ;
T_10 * V_124 ;
int V_4 ;
if ( V_205 == NULL )
return - V_84 ;
V_4 = F_1 ( V_46 , V_206 , L_140 , V_205 ) ;
if ( V_4 < 0 )
return V_4 ;
...
V_142 = F_111 ( sizeof( * V_142 ) ) ;
if ( ! V_142 ) {
V_4 = - V_47 ;
break;
}
F_142 ( & V_142 -> V_204 ) ;
F_143 ( & V_142 -> V_204 , V_202 ) ;
if ( sscanf ( V_46 , L_141 , & V_142 -> V_28 , & V_142 -> V_95 ) != 2 ) {
V_4 = - V_48 ;
break;
}
V_184 = strchr ( V_46 , '\t' ) ;
...
static struct V_203 *
F_145 ( struct V_201 * V_202 ,
unsigned long V_59 )
{
struct V_203 * V_142 ;
F_146 (node, blacklist, list) {
...
{
return ! ! F_145 ( & V_207 , V_59 ) ;
}
static int F_149 ( const char * V_161 , const char * V_162 ,
struct V_88 * V_89 ,
const char * V_29 ,
struct V_193 * V_42 )
{
int V_58 , V_4 ;
char * V_46 ;
if ( F_107 ( & V_46 , L_145 , V_161 , V_162 ) < 0 )
return - V_105 ;
V_4 = F_119 ( V_42 , L_146 , V_46 ) ;
free ( V_46 ) ;
if ( V_4 )
return V_4 ;
V_46 = F_75 ( & V_89 -> V_91 ) ;
...
free ( V_46 ) ;
if ( ! V_4 && V_29 )
V_4 = F_119 ( V_42 , L_147 , V_29 ) ;
if ( ! V_4 && V_89 -> V_179 > 0 ) {
V_4 = F_150 ( V_42 , L_148 , 5 ) ;
for ( V_58 = 0 ; ! V_4 && V_58 < V_89 -> V_179 ; V_58 ++ ) {
V_46 = F_117 ( & V_89 -> args [ V_58 ] ) ;
if ( ! V_46 )
return - V_47 ;
V_4 = F_119 ( V_42 , L_129 , V_46 ) ;
free ( V_46 ) ;
}
}
if ( ! V_4 )
...
int F_151 ( const char * V_161 , const char * V_162 ,
struct V_88 * V_89 ,
const char * V_29 , bool V_208 )
{
struct V_193 V_46 = V_196 ;
int V_4 ;
V_4 = F_149 ( V_161 , V_162 , V_89 , V_29 , & V_46 ) ;
if ( V_4 >= 0 ) {
if ( V_208 )
printf ( L_99 , V_46 . V_46 ) ;
else
F_152 ( L_99 , V_46 . V_46 ) ;
}
F_122 ( & V_46 ) ;
return V_4 ;
}
static bool F_153 ( struct V_55 * V_182 ,
struct V_138 * T_11 )
{
char V_90 [ 128 ] ;
if ( F_92 ( T_11 , V_182 -> V_162 ) )
return true ;
if ( F_1 ( V_90 , 128 , L_145 , V_182 -> V_161 , V_182 -> V_162 ) < 0 )
return false ;
return F_92 ( T_11 , V_90 ) ;
}
static int F_154 ( int V_61 , bool V_111 ,
struct V_138 * T_11 )
{
int V_4 = 0 ;
struct V_55 V_182 ;
...
return - V_47 ;
F_91 (ent, rawlist) {
V_4 = F_116 ( V_211 -> V_148 , & V_182 ) ;
if ( V_4 >= 0 ) {
if ( ! F_153 ( & V_182 , T_11 ) )
goto V_173;
V_4 = F_130 ( & V_182 , & V_89 ,
V_111 ) ;
if ( V_4 < 0 )
goto V_173;
V_4 = F_151 ( V_89 . V_161 , V_89 . V_162 ,
...
if ( V_4 < 0 )
return V_4 ;
V_4 = F_158 ( & V_212 , & V_213 , 0 ) ;
if ( V_4 < 0 )
return V_4 ;
if ( V_212 >= 0 )
V_4 = F_154 ( V_212 , true , T_11 ) ;
if ( V_213 >= 0 && V_4 >= 0 )
V_4 = F_154 ( V_213 , false , T_11 ) ;
if ( V_212 > 0 )
F_40 ( V_212 ) ;
if ( V_213 > 0 )
F_40 ( V_213 ) ;
...
static int F_159 ( char * V_46 , T_1 V_94 , const char * V_216 ,
...
V_4 = F_1 ( V_46 , V_94 , L_154 , V_219 , V_58 ) ;
if ( V_4 < 0 ) {
F_4 ( L_149 , V_4 ) ;
goto V_11;
}
...
static void F_161 ( struct V_55 * V_182 )
{
int V_58 ;
char * V_46 = F_127 ( V_182 ) ;
if ( ! V_182 -> V_83 || V_182 -> V_179 == 0 || ! V_46 )
goto V_11;
for ( V_58 = 0 ; V_58 < V_182 -> V_179 ; V_58 ++ )
if ( F_162 ( V_182 -> args [ V_58 ] . V_191 , L_156 ) ) {
F_7 ( L_157
L_158 ,
...
static int F_163 ( struct V_55 * V_182 ,
struct V_88 * V_89 ,
struct V_209 * V_217 ,
bool V_218 )
{
...
if ( V_89 -> V_91 . V_53 &&
( strncmp ( V_89 -> V_91 . V_53 , L_74 , 2 ) != 0 ) &&
! F_164 ( V_89 -> V_91 . V_53 ) )
...
static int F_166 ( bool V_121 ,
struct V_209 * * V_217 )
{
int V_61 ;
V_61 = F_167 ( V_222 | ( V_121 ? V_223 : 0 ) ) ;
if ( V_61 < 0 )
return V_61 ;
* V_217 = F_168 ( V_61 ) ;
if ( ! ( * V_217 ) ) {
...
static int F_169 ( struct V_88 * V_89 ,
struct V_55 * V_56 ,
int V_57 , bool V_218 )
{
...
V_224 = V_89 -> V_83 ? 1 : 0 ;
V_61 [ V_224 ] = F_166 ( V_224 , & V_217 [ V_224 ] ) ;
if ( V_61 [ V_224 ] < 0 )
return V_61 [ V_224 ] ;
V_4 = 0 ;
for ( V_58 = 0 ; V_58 < V_57 ; V_58 ++ ) {
...
continue;
V_4 = F_163 ( V_182 , V_89 , V_217 [ V_224 ] ,
V_218 ) ;
if ( V_4 < 0 )
break;
V_4 = F_170 ( V_61 [ V_224 ] , V_182 ) ;
if ( V_4 < 0 )
break;
V_218 = true ;
}
...
V_215 = F_171 ( V_89 -> V_39 ) ;
if ( ! V_215 ||
F_172 ( V_215 , V_89 , V_56 , V_57 ) < 0 ||
F_173 ( V_215 ) < 0 )
F_7 ( L_160 ) ;
F_174 ( V_215 ) ;
}
...
static int F_175 ( struct V_16 * V_16 , char * V_15 ,
struct V_14 * * V_227 )
{
int V_79 = 0 ;
struct V_14 * V_24 ;
...
void __weak F_177 ( struct V_88 * V_89 V_120 ,
struct V_55 * V_182 V_120 ,
struct V_16 * V_16 V_120 ,
struct V_14 * V_24 V_120 ) { }
static int F_178 ( struct V_88 * V_89 ,
struct V_55 * * V_56 )
{
struct V_16 * V_16 = NULL ;
...
V_230 = F_175 ( V_16 , V_51 -> V_53 , V_227 ) ;
if ( V_230 == 0 ) {
F_54 ( L_161 , V_51 -> V_53 ,
V_89 -> V_39 ? : L_5 ) ;
V_4 = - V_26 ;
goto V_11;
...
if ( ! V_89 -> V_83 && ! V_51 -> V_87 && ! V_89 -> V_39 ) {
V_23 = F_14 () ;
if ( ! V_23 ) {
F_7 ( L_27 ) ;
V_4 = - V_48 ;
...
V_110 -> V_14 = F_133 ( V_23 -> V_15 , V_233 ) ;
V_110 -> V_86 = V_110 -> V_59 - V_23 -> V_18 ;
} else {
V_110 -> V_14 = F_133 ( V_24 -> V_15 , V_233 ) ;
V_110 -> V_86 = V_51 -> V_86 ;
}
V_110 -> V_115 = F_133 ( V_24 -> V_15 , V_233 ) ;
V_110 -> V_87 = V_51 -> V_87 ;
if ( V_89 -> V_39 ) {
if ( V_89 -> V_83 ) {
V_182 -> V_91 . V_29 = F_133 ( V_89 -> V_39 ,
V_233 ) ;
} else {
V_67 = F_33 ( V_89 -> V_39 ) ;
V_182 -> V_91 . V_29 =
...
if ( V_182 -> V_179 ) {
V_182 -> args = F_111 ( sizeof( struct V_190 ) *
V_182 -> V_179 ) ;
if ( V_182 -> args == NULL )
goto V_233;
}
...
F_133 ( V_89 -> args [ V_58 ] . V_15 ,
V_233 ) ;
V_182 -> args [ V_58 ] . V_191 = F_133 ( V_89 -> args [ V_58 ] . V_146 ,
V_233 ) ;
if ( V_89 -> args [ V_58 ] . type )
V_182 -> args [ V_58 ] . type =
F_133 ( V_89 -> args [ V_58 ] . type ,
V_233 ) ;
}
F_177 ( V_89 , V_182 , V_16 , V_24 ) ;
}
if ( V_4 == V_118 ) {
V_4 = - V_26 ;
goto V_232;
...
static int F_179 ( struct V_88 * V_89 ,
struct V_55 * * V_56 )
{
struct V_50 * V_51 = & V_89 -> V_91 ;
struct V_55 * V_182 ;
struct V_109 * V_110 ;
int V_58 , V_101 ;
if ( ! ( V_89 -> V_91 . V_53 && ! strncmp ( V_89 -> V_91 . V_53 , L_74 , 2 ) ) )
return - V_48 ;
if ( F_73 ( V_89 ) )
return - V_48 ;
* V_56 = F_111 ( sizeof( * V_182 ) ) ;
if ( ! * V_56 )
return - V_47 ;
V_182 = * V_56 ;
V_110 = & V_182 -> V_91 ;
...
V_182 -> V_83 = V_89 -> V_83 ;
V_101 = - V_47 ;
if ( F_107 ( & V_110 -> V_14 , L_165 , V_110 -> V_59 ) < 0 )
goto V_234;
if ( ( ! V_182 -> V_83 ) &&
...
if ( F_107 ( & V_110 -> V_115 , L_166 , V_110 -> V_59 ) < 0 )
goto V_234;
if ( V_89 -> V_39 ) {
...
for ( V_58 = 0 ; V_58 < V_182 -> V_179 ; V_58 ++ )
F_180 ( & V_182 -> args [ V_58 ] , & V_89 -> args [ V_58 ] ) ;
return 1 ;
V_234:
if ( * V_56 ) {
F_29 ( * V_56 , 1 ) ;
...
static void * F_181 ( void * V_236 , T_1 V_237 , void * V_238 , T_1 V_239 )
{
void * V_4 ;
...
static int
F_182 ( struct V_55 * * V_56 , int * V_57 ,
...
V_242 = F_181 ( * V_56 , ( * V_57 ) * sizeof( * * V_56 ) ,
...
static int F_183 ( struct V_88 * V_89 ,
struct V_55 * * V_56 ,
const char * V_39 )
{
struct V_225 * V_215 ;
...
continue;
if ( ( ! V_89 -> V_161 || F_162 ( V_244 -> V_89 . V_161 , V_89 -> V_161 ) ) &&
F_162 ( V_244 -> V_89 . V_162 , V_89 -> V_162 ) ) {
V_4 = F_185 ( V_244 , & V_245 ) ;
if ( V_4 > 0 )
V_4 = F_182 ( V_56 , & V_57 ,
& V_245 , V_4 ) ;
if ( V_4 < 0 )
...
static int F_186 ( struct V_88 * V_89 ,
struct V_55 * * V_56 )
{
struct V_55 * V_245 = NULL ;
struct V_209 * V_246 ;
...
V_4 = 0 ;
F_91 (nd, bidlist) {
V_116 = F_106 ( V_247 -> V_148 ) ;
V_4 = F_183 ( V_89 , & V_245 , V_116 ) ;
if ( V_4 > 0 )
V_4 = F_182 ( V_56 , & V_57 ,
& V_245 , V_4 ) ;
free ( V_116 ) ;
...
if ( V_89 -> V_159 ) {
if ( ! V_89 -> V_39 )
return F_186 ( V_89 , V_56 ) ;
else
return F_183 ( V_89 , V_56 , V_89 -> V_39 ) ;
}
V_215 = F_171 ( V_89 -> V_39 ) ;
if ( ! V_215 )
return 0 ;
V_244 = F_189 ( V_215 , V_89 ) ;
if ( ! V_244 ) {
V_4 = V_89 -> V_159 ? - V_26 : 0 ;
goto V_11;
}
V_4 = F_190 ( V_244 -> V_248 ) ;
if ( V_4 > V_214 . V_229 ) {
F_4 ( L_168 ,
V_89 -> V_39 ? : L_5 ) ;
V_4 = - V_6 ;
...
* V_56 = F_111 ( V_4 * sizeof( * V_182 ) ) ;
if ( ! * V_56 ) {
V_4 = - V_47 ;
goto V_11;
}
V_58 = 0 ;
F_91 (node, entry->tevlist) {
V_182 = & ( * V_56 ) [ V_58 ++ ] ;
V_4 = F_116 ( V_142 -> V_148 , V_182 ) ;
if ( V_4 < 0 )
goto V_11;
V_182 -> V_83 = V_89 -> V_83 ;
}
...
static int F_191 ( struct V_88 * V_89 ,
struct V_55 * * V_56 )
{
int V_4 ;
if ( ! V_89 -> V_161 && ! V_89 -> V_159 ) {
...
if ( V_4 != 0 )
return V_4 ;
return F_178 ( V_89 , V_56 ) ;
}
int F_192 ( struct V_88 * V_149 , int V_150 )
{
int V_58 , V_4 ;
for ( V_58 = 0 ; V_58 < V_150 ; V_58 ++ ) {
if ( ! V_149 [ V_58 ] . V_83 )
F_147 () ;
V_4 = F_191 ( & V_149 [ V_58 ] , & V_149 [ V_58 ] . V_56 ) ;
if ( V_4 < 0 )
return V_4 ;
V_149 [ V_58 ] . V_57 = V_4 ;
}
...
static int F_193 ( struct V_55 * V_182 )
{
char * V_46 = F_127 ( V_182 ) ;
if ( ! V_46 ) {
F_4 ( L_170 ) ;
...
{
struct V_209 * V_217 = F_195 ( NULL , NULL ) ;
struct V_55 * V_182 ;
struct V_88 * V_89 ;
...
int V_58 , V_4 = 0 ;
for ( V_58 = 0 ; V_58 < V_150 ; V_58 ++ ) {
V_4 = F_169 ( & V_149 [ V_58 ] , V_149 [ V_58 ] . V_56 ,
V_149 [ V_58 ] . V_57 ,
V_214 . V_249 ) ;
if ( V_4 < 0 )
break;
...
void F_197 ( struct V_88 * V_149 , int V_150 )
{
int V_58 , V_231 ;
for ( V_58 = 0 ; V_58 < V_150 ; V_58 ++ ) {
...
if ( V_4 < 0 )
return V_4 ;
V_4 = F_192 ( V_149 , V_150 ) ;
if ( V_4 == 0 )
V_4 = F_196 ( V_149 , V_150 ) ;
F_197 ( V_149 , V_150 ) ;
F_8 () ;
return V_4 ;
}
int F_199 ( struct V_138 * T_11 )
{
int V_4 , V_250 , V_251 = - 1 , V_252 = - 1 ;
char * V_1 = F_200 ( T_11 ) ;
if ( ! V_1 )
return - V_48 ;
V_4 = F_158 ( & V_252 , & V_251 , V_222 ) ;
if ( V_4 < 0 )
goto V_11;
V_4 = F_201 ( V_252 , T_11 ) ;
if ( V_4 < 0 && V_4 != - V_26 )
goto error;
V_250 = F_201 ( V_251 , T_11 ) ;
...
int F_202 ( const char * V_39 , struct V_138 * V_139 ,
bool V_40 )
{
struct V_228 * V_247 ;
struct V_16 * V_16 ;
...
if ( ! F_203 ( V_16 -> V_36 , V_16 -> type ) )
F_204 ( V_16 -> V_36 , V_16 -> type ) ;
F_82 () ;
for ( V_247 = F_205 ( & V_16 -> V_36 -> V_253 [ V_16 -> type ] ) ; V_247 ; V_247 = F_206 ( V_247 ) ) {
struct V_254 * V_35 = F_207 ( V_247 , struct V_254 , V_228 ) ;
if ( F_92 ( V_139 , V_35 -> V_24 . V_15 ) )
printf ( L_99 , V_35 -> V_24 . V_15 ) ;
}
V_95:
F_48 ( V_16 ) ;
F_8 () ;
