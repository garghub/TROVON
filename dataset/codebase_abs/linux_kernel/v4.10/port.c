...
static int F_35 ( struct V_6 * V_48 , struct V_6 * V_49 )
{
...
V_55 = L_12 ;
F_36 ( L_13 ,
F_37 ( & V_48 -> V_2 ) , F_37 ( & V_49 -> V_2 ) , V_55 ,
F_37 ( & V_48 -> V_2 ) ,
V_53 ? F_37 ( & V_53 -> V_2 ) : L_14 ,
F_37 ( & V_49 -> V_2 ) ,
V_54 ? F_37 ( & V_54 -> V_2 ) : L_14 ) ;
return - V_41 ;
}
V_52 = F_38 ( & V_48 -> V_2 . V_57 , & V_49 -> V_2 . V_57 , L_15 ) ;
if ( V_52 )
return V_52 ;
V_52 = F_38 ( & V_49 -> V_2 . V_57 , & V_48 -> V_2 . V_57 , L_15 ) ;
if ( V_52 ) {
F_39 ( & V_48 -> V_2 . V_57 , L_15 ) ;
return V_52 ;
}
if ( V_48 -> V_38 ) {
V_50 = V_48 ;
...
static void F_41 ( struct V_6 * V_48 , struct V_6 * V_49 )
{
int V_52 ;
V_52 = F_35 ( V_48 , V_49 ) ;
if ( V_52 == 0 ) {
F_25 ( & V_48 -> V_2 , L_16 , F_37 ( & V_49 -> V_2 ) ) ;
} else {
F_25 ( & V_48 -> V_2 , L_17 ,
F_37 ( & V_49 -> V_2 ) , V_52 ) ;
F_42 ( L_18 ) ;
...
static void F_43 ( struct V_6 * V_48 , struct V_6 * V_49 )
{
struct V_6 * V_50 , * V_51 ;
F_44 ( V_49 -> V_32 != V_48 || V_48 -> V_32 != V_49 ,
L_19 ,
F_37 ( & V_48 -> V_2 ) , F_37 ( & V_49 -> V_2 ) ) ;
if ( V_48 -> V_38 ) {
V_50 = V_48 ;
V_51 = V_49 ;
} else {
...
F_39 ( & V_48 -> V_2 . V_57 , L_15 ) ;
V_49 -> V_32 = NULL ;
F_39 ( & V_49 -> V_2 . V_57 , L_15 ) ;
V_48 -> V_32 = NULL ;
F_34 ( & V_50 -> V_2 ) ;
F_34 ( & V_51 -> V_2 ) ;
}
static int F_45 ( struct V_17 * V_58 , void * V_13 )
{
int V_33 ;
...
static void F_46 ( struct V_30 * V_31 , int V_33 )
{
...
int F_48 ( struct V_30 * V_31 , int V_33 )
{
struct V_6 * V_7 ;
struct V_17 * V_26 = V_31 -> V_26 ;
int V_35 ;
V_7 = F_49 ( sizeof( * V_7 ) , V_68 ) ;
if ( ! V_7 )
return - V_69 ;
V_7 -> V_25 = F_49 ( sizeof( * ( V_7 -> V_25 ) ) , V_68 ) ;
if ( ! V_7 -> V_25 ) {
F_13 ( V_7 ) ;
return - V_69 ;
}
...
if ( F_26 ( V_31 -> V_26 ) )
V_7 -> V_38 = 1 ;
F_50 ( & V_7 -> V_2 , L_20 , F_37 ( & V_31 -> V_26 -> V_2 ) ,
V_33 ) ;
F_51 ( & V_7 -> V_77 ) ;
V_35 = F_52 ( & V_7 -> V_2 ) ;
if ( V_35 ) {
...
void F_63 ( struct V_30 * V_31 , int V_33 )
{
