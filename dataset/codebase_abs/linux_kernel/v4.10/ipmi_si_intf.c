...
struct V_9 * V_195 , * V_196 ;
F_127 ( & V_197 ) ;
F_128 (e, tmp_e, &smi_infos, link) {
if ( V_195 -> V_70 . V_190 != V_181 )
continue;
if ( V_195 -> V_83 != V_83 )
continue;
if ( V_195 -> V_70 . V_150 == V_149 )
F_126 ( V_195 ) ;
}
F_129 ( & V_197 ) ;
}
...
int V_169 ;
struct V_9 * V_143 ;
for ( V_169 = 0 ; V_169 < V_199 ; V_169 ++ ) {
if ( ! V_200 [ V_169 ] && ! V_201 [ V_169 ] )
continue;
V_143 = F_118 () ;
if ( ! V_143 )
return - V_184 ;
...
V_143 -> V_70 . V_149 = NULL ;
V_143 -> V_70 . V_151 = V_206 [ V_169 ] ;
if ( ! V_143 -> V_70 . V_151 )
V_143 -> V_70 . V_151 = V_193 ;
V_143 -> V_70 . V_156 = V_207 [ V_169 ] ;
if ( ! V_143 -> V_70 . V_156 )
V_143 -> V_70 . V_156 = V_193 ;
V_143 -> V_70 . V_153 = V_208 [ V_169 ] ;
V_143 -> V_50 = V_209 [ V_169 ] ;
if ( V_143 -> V_50 )
V_143 -> V_135 = F_73 ;
V_143 -> V_194 = V_210 [ V_169 ] ;
if ( ! F_123 ( V_143 ) ) {
if ( F_125 ( V_143 ) )
F_126 ( V_143 ) ;
V_198 = 0 ;
...
static T_4 F_132 ( T_5 V_211 ,
T_4 V_212 , void * V_213 )
{
struct V_9 * V_9 = V_213 ;
unsigned long V_103 ;
F_40 ( & ( V_9 -> V_105 ) , V_103 ) ;
F_25 ( V_9 , V_131 ) ;
F_1 ( L_39 ) ;
...
if ( V_219 -> V_223 & 1 ) {
V_143 -> V_50 = V_219 -> V_224 ;
V_143 -> V_135 = F_135 ;
} else if ( V_219 -> V_223 & 2 ) {
V_143 -> V_50 = V_219 -> V_225 ;
V_143 -> V_135 = F_73 ;
} else {
V_143 -> V_50 = 0 ;
V_143 -> V_135 = NULL ;
}
if ( V_219 -> V_149 . V_226 ) {
V_143 -> V_70 . V_151 = V_219 -> V_149 . V_226 / 8 ;
} else {
V_143 -> V_70 . V_151 = V_193 ;
}
V_143 -> V_70 . V_156 = V_143 -> V_70 . V_151 ;
V_143 -> V_70 . V_153 = V_219 -> V_149 . V_227 ;
if ( V_219 -> V_149 . V_228 == V_229 ) {
V_143 -> V_192 = F_111 ;
V_143 -> V_70 . V_190 = V_191 ;
} else if ( V_219 -> V_149 . V_228 == V_230 ) {
V_143 -> V_192 = F_90 ;
V_143 -> V_70 . V_190 = V_205 ;
} else {
F_124 ( V_143 ) ;
...
V_143 -> V_70 . V_150 = V_219 -> V_149 . V_231 ;
F_131 ( L_47 ,
( V_143 -> V_70 . V_190 == V_205 ) ? L_48 : L_49 ,
...
static int F_141 ( const struct V_236 * V_237 ,
struct V_238 * V_239 )
{
const T_1 * V_16 = ( const T_1 * ) V_237 ;
unsigned long V_240 ;
T_1 V_241 ;
T_1 V_78 = V_237 -> V_242 ;
V_239 -> type = V_16 [ 4 ] ;
memcpy ( & V_240 , V_16 + 8 , sizeof( unsigned long ) ) ;
if ( V_78 >= 0x11 ) {
if ( V_240 & 1 ) {
V_240 &= 0xFFFE ;
V_239 -> V_181 = V_205 ;
...
V_239 -> V_181 = V_191 ;
V_239 -> V_240 = V_240 | ( ( V_16 [ 0x10 ] & 0x10 ) >> 4 ) ;
V_239 -> V_50 = V_16 [ 0x11 ] ;
V_241 = ( V_16 [ 0x10 ] & 0xC0 ) >> 6 ;
switch ( V_241 ) {
case 0x00 :
V_239 -> V_148 = 1 ;
break;
...
static void F_142 ( struct V_238 * V_243 )
{
struct V_9 * V_143 ;
V_143 = F_118 () ;
if ( ! V_143 ) {
...
V_143 -> V_70 . V_150 = V_243 -> V_240 ;
V_143 -> V_70 . V_151 = V_243 -> V_148 ;
if ( ! V_143 -> V_70 . V_151 )
V_143 -> V_70 . V_151 = V_193 ;
V_143 -> V_70 . V_156 = V_193 ;
V_143 -> V_70 . V_153 = 0 ;
V_143 -> V_194 = V_243 -> V_194 ;
V_143 -> V_50 = V_243 -> V_50 ;
if ( V_143 -> V_50 )
V_143 -> V_135 = F_73 ;
F_131 ( L_53 ,
( V_143 -> V_70 . V_190 == V_205 ) ? L_48 : L_49 ,
...
{
const struct V_245 * V_79 = NULL ;
struct V_238 V_16 ;
int V_19 ;
while ( ( V_79 = F_144 ( V_246 , NULL , V_79 ) ) ) {
memset ( & V_16 , 0 , sizeof( V_16 ) ) ;
V_19 = F_141 ( ( const struct V_236 * ) V_79 -> V_247 ,
& V_16 ) ;
if ( ! V_19 )
F_142 ( & V_16 ) ;
}
}
static void F_145 ( struct V_9 * V_143 )
{
struct V_248 * V_249 = V_143 -> V_250 ;
F_146 ( V_249 ) ;
}
static int F_147 ( struct V_9 * V_143 )
{
if ( V_143 -> V_83 == V_203 ) {
unsigned char V_215 ;
int V_151 ;
V_143 -> V_70 . V_156 = V_251 ;
V_143 -> V_70 . V_153 = 0 ;
V_143 -> V_155 = 2 ;
V_143 -> V_26 = & V_252 ;
...
V_215 = V_143 -> V_70 . V_71 ( & V_143 -> V_70 , 1 ) ;
V_143 -> V_158 ( V_143 ) ;
if ( V_215 )
return V_151 ;
V_151 *= 4 ;
...
static int F_149 ( struct V_248 * V_249 ,
const struct V_253 * V_254 )
{
int V_19 ;
int V_255 = V_249 -> V_256 & V_257 ;
struct V_9 * V_143 ;
V_143 = F_118 () ;
if ( ! V_143 )
return - V_184 ;
V_143 -> V_141 = V_258 ;
F_75 ( & V_249 -> V_79 , L_55 ) ;
switch ( V_255 ) {
case V_259 :
V_143 -> V_83 = V_204 ;
break;
...
default:
F_124 ( V_143 ) ;
F_75 ( & V_249 -> V_79 , L_56 , V_255 ) ;
return - V_184 ;
}
V_19 = F_150 ( V_249 ) ;
if ( V_19 ) {
F_148 ( & V_249 -> V_79 , L_57 ) ;
F_124 ( V_143 ) ;
return V_19 ;
}
V_143 -> V_262 = F_145 ;
V_143 -> V_250 = V_249 ;
if ( F_151 ( V_249 , 0 ) & V_263 ) {
V_143 -> V_192 = F_90 ;
V_143 -> V_70 . V_190 = V_205 ;
} else {
V_143 -> V_192 = F_111 ;
...
V_143 -> V_70 . V_150 = F_152 ( V_249 , 0 ) ;
V_143 -> V_70 . V_151 = F_147 ( V_143 ) ;
V_143 -> V_70 . V_156 = V_251 ;
V_143 -> V_70 . V_153 = 0 ;
V_143 -> V_50 = V_249 -> V_50 ;
if ( V_143 -> V_50 )
V_143 -> V_135 = F_73 ;
V_143 -> V_79 = & V_249 -> V_79 ;
F_153 ( V_249 , V_143 ) ;
F_75 ( & V_249 -> V_79 , L_58 ,
& V_249 -> V_264 [ 0 ] , V_143 -> V_70 . V_156 , V_143 -> V_70 . V_151 ,
V_143 -> V_50 ) ;
V_19 = F_123 ( V_143 ) ;
if ( V_19 ) {
F_124 ( V_143 ) ;
...
static void F_154 ( struct V_248 * V_249 )
{
struct V_9 * V_143 = F_155 ( V_249 ) ;
F_126 ( V_143 ) ;
}
static int F_156 ( struct V_265 * V_79 )
{
const struct V_266 * V_267 ;
struct V_9 * V_143 ;
struct V_264 V_264 ;
const T_7 * V_156 , * V_151 , * V_153 ;
struct V_268 * V_269 = V_79 -> V_79 . V_270 ;
int V_198 ;
int V_271 ;
F_75 ( & V_79 -> V_79 , L_59 ) ;
V_267 = F_157 ( V_272 , & V_79 -> V_79 ) ;
if ( ! V_267 )
return - V_157 ;
if ( ! F_158 ( V_269 ) )
return - V_159 ;
V_198 = F_159 ( V_269 , 0 , & V_264 ) ;
if ( V_198 ) {
F_30 ( & V_79 -> V_79 , V_170 L_60 ) ;
return V_198 ;
}
V_156 = F_160 ( V_269 , L_61 , & V_271 ) ;
if ( V_156 && V_271 != 4 ) {
F_30 ( & V_79 -> V_79 , V_170 L_62 ) ;
return - V_159 ;
}
V_151 = F_160 ( V_269 , L_63 , & V_271 ) ;
if ( V_151 && V_271 != 4 ) {
F_30 ( & V_79 -> V_79 , V_170 L_64 ) ;
return - V_159 ;
}
V_153 = F_160 ( V_269 , L_65 , & V_271 ) ;
if ( V_153 && V_271 != 4 ) {
F_30 ( & V_79 -> V_79 , V_170 L_66 ) ;
return - V_159 ;
}
V_143 = F_118 () ;
if ( ! V_143 ) {
...
V_143 -> V_83 = (enum V_83 ) V_267 -> V_16 ;
V_143 -> V_141 = V_273 ;
V_143 -> V_135 = F_73 ;
if ( V_264 . V_103 & V_263 ) {
V_143 -> V_192 = F_90 ;
V_143 -> V_70 . V_190 = V_205 ;
} else {
V_143 -> V_192 = F_111 ;
...
V_143 -> V_70 . V_150 = V_264 . V_274 ;
V_143 -> V_70 . V_156 = V_156 ? F_161 ( V_156 ) : V_251 ;
V_143 -> V_70 . V_151 = V_151 ? F_161 ( V_151 ) : V_193 ;
V_143 -> V_70 . V_153 = V_153 ? F_161 ( V_153 ) : 0 ;
V_143 -> V_50 = F_162 ( V_79 -> V_79 . V_270 , 0 ) ;
V_143 -> V_79 = & V_79 -> V_79 ;
F_163 ( & V_79 -> V_79 , L_68 ,
V_143 -> V_70 . V_150 , V_143 -> V_70 . V_156 , V_143 -> V_70 . V_151 ,
V_143 -> V_50 ) ;
F_164 ( & V_79 -> V_79 , V_143 ) ;
V_198 = F_123 ( V_143 ) ;
if ( V_198 ) {
F_124 ( V_143 ) ;
return V_198 ;
...
static int F_165 ( struct V_265 * V_79 )
{
struct V_9 * V_143 ;
struct V_264 * V_275 , * V_276 ;
T_5 V_277 ;
T_6 V_215 ;
...
return - V_184 ;
V_143 -> V_141 = V_280 ;
F_75 ( & V_79 -> V_79 , V_170 L_69 ) ;
V_143 -> V_142 . V_281 . T_5 = V_277 ;
V_215 = F_167 ( V_277 , L_70 , NULL , & V_278 ) ;
if ( F_168 ( V_215 ) ) {
F_148 ( & V_79 -> V_79 , L_71 ) ;
goto V_282;
}
switch ( V_278 ) {
case 1 :
...
goto V_282;
default:
F_75 ( & V_79 -> V_79 , L_72 , V_278 ) ;
goto V_282;
}
V_275 = F_169 ( V_79 , V_263 , 0 ) ;
if ( V_275 ) {
V_143 -> V_192 = F_90 ;
V_143 -> V_70 . V_190 = V_205 ;
} else {
V_275 = F_169 ( V_79 , V_283 , 0 ) ;
if ( V_275 ) {
V_143 -> V_192 = F_111 ;
V_143 -> V_70 . V_190 = V_191 ;
}
...
V_143 -> V_70 . V_156 = V_193 ;
V_143 -> V_70 . V_153 = 0 ;
V_215 = F_167 ( V_277 , L_74 , NULL , & V_278 ) ;
if ( F_170 ( V_215 ) ) {
V_143 -> V_50 = V_278 ;
V_143 -> V_135 = F_135 ;
} else {
int V_50 = F_171 ( V_79 , 0 ) ;
if ( V_50 > 0 ) {
V_143 -> V_50 = V_50 ;
V_143 -> V_135 = F_73 ;
}
...
static int F_173 ( struct V_265 * V_79 )
{
if ( F_156 ( V_79 ) == 0 )
return 0 ;
return F_165 ( V_79 ) ;
}
static int F_174 ( struct V_265 * V_79 )
{
struct V_9 * V_143 = F_175 ( & V_79 -> V_79 ) ;
F_126 ( V_143 ) ;
return 0 ;
}
...
V_143 -> V_135 = NULL ;
V_143 -> V_79 = & V_79 -> V_79 ;
F_163 ( & V_79 -> V_79 , L_76 , V_143 -> V_70 . V_150 ) ;
F_164 ( & V_79 -> V_79 , V_143 ) ;
V_19 = F_123 ( V_143 ) ;
if ( V_19 ) {
F_124 ( V_143 ) ;
...
static int F_177 ( struct V_284 * V_79 )
{
F_126 ( F_175 ( & V_79 -> V_79 ) ) ;
return 0 ;
}
static int F_178 ( struct V_9 * V_9 )
{
enum V_18 V_108 ;
...
static int F_181 ( struct V_9 * V_9 )
{
unsigned char V_1 [ 2 ] ;
unsigned char * V_287 ;
unsigned long V_288 ;
int V_19 = 0 ;
V_287 = F_182 ( V_76 , V_173 ) ;
if ( ! V_287 )
return - V_184 ;
V_1 [ 0 ] = V_39 << 2 ;
V_1 [ 1 ] = V_289 ;
...
V_287 , V_76 ) ;
V_19 = F_183 ( V_287 , V_288 , & V_9 -> V_290 ) ;
V_25:
F_124 ( V_287 ) ;
return V_19 ;
}
...
static int F_185 ( struct V_9 * V_9 , T_1 V_62 )
{
unsigned char V_1 [ 3 ] ;
unsigned char * V_287 ;
unsigned long V_288 ;
...
static void F_187 ( struct V_9 * V_9 )
{
T_1 V_62 = 0 ;
int V_19 ;
if ( ! V_9 -> V_50 )
...
static int F_188 ( struct V_9 * V_9 )
{
unsigned char V_1 [ 3 ] ;
unsigned char * V_287 ;
unsigned long V_288 ;
...
static int F_189 ( struct V_292 * V_293 , void * V_164 )
{
struct V_9 * V_139 = V_293 -> V_294 ;
F_190 ( V_293 , L_89 , V_295 [ V_139 -> V_83 ] ) ;
return 0 ;
}
static int F_191 ( struct V_296 * V_296 , struct V_297 * V_297 )
{
return F_192 ( V_297 , F_189 , F_193 ( V_296 ) ) ;
}
static int F_194 ( struct V_292 * V_293 , void * V_164 )
{
struct V_9 * V_139 = V_293 -> V_294 ;
F_190 ( V_293 , L_90 ,
...
static int F_196 ( struct V_296 * V_296 , struct V_297 * V_297 )
{
return F_192 ( V_297 , F_194 , F_193 ( V_296 ) ) ;
}
static int F_197 ( struct V_292 * V_293 , void * V_164 )
{
struct V_9 * V_139 = V_293 -> V_294 ;
F_190 ( V_293 ,
L_102 ,
V_295 [ V_139 -> V_83 ] ,
V_299 [ V_139 -> V_70 . V_190 ] ,
V_139 -> V_70 . V_150 ,
V_139 -> V_70 . V_151 ,
V_139 -> V_70 . V_156 ,
V_139 -> V_70 . V_153 ,
...
static int F_198 ( struct V_296 * V_296 , struct V_297 * V_297 )
{
return F_192 ( V_297 , F_197 , F_193 ( V_296 ) ) ;
}
static int F_199 ( struct V_9 * V_9 )
{
V_9 -> V_54 = ( ( V_9 -> V_54 & ~ V_58 ) |
V_56 ) ;
return 1 ;
}
static void F_200 ( struct V_9 * V_9 )
{
...
static int F_204 ( struct V_6 * V_310 ,
unsigned long V_311 ,
void * V_312 )
{
...
static inline void F_209 ( struct V_9 * V_9 )
{
if ( V_9 -> V_37 != NULL )
F_210 ( V_9 -> V_37 ) ;
if ( V_9 -> V_34 )
...
static int F_212 ( struct V_9 * V_143 )
{
struct V_9 * V_195 ;
F_213 (e, &smi_infos, link) {
if ( V_195 -> V_70 . V_190 != V_143 -> V_70 . V_190 )
continue;
if ( V_195 -> V_70 . V_150 == V_143 -> V_70 . V_150 ) {
if ( V_143 -> V_194 && ! V_195 -> V_194 )
V_195 -> V_194 = V_143 -> V_194 ;
return 0 ;
}
}
return 1 ;
...
F_214 ( V_134 -> V_141 ) ,
V_295 [ V_134 -> V_83 ] ,
V_299 [ V_134 -> V_70 . V_190 ] ,
V_134 -> V_70 . V_150 ,
V_134 -> V_194 , V_134 -> V_50 ) ;
switch ( V_134 -> V_83 ) {
case V_203 :
V_134 -> V_26 = & V_252 ;
break;
...
if ( ! V_134 -> V_79 ) {
V_322 = F_216 ( V_173 , L_106 , 0 ) ;
V_134 -> V_249 = F_217 ( L_107 ,
V_134 -> V_111 ) ;
if ( ! V_134 -> V_249 ) {
F_138 ( V_170 L_108 ) ;
goto V_319;
}
V_134 -> V_79 = & V_134 -> V_249 -> V_79 ;
V_134 -> V_79 -> V_325 = & V_326 . V_325 ;
V_134 -> V_79 -> V_322 = V_322 ;
}
V_134 -> V_28 = F_182 ( V_134 -> V_26 -> V_35 () , V_173 ) ;
if ( ! V_134 -> V_28 ) {
F_138 ( V_170 L_109 ) ;
V_19 = - V_184 ;
goto V_319;
...
if ( V_19 ) {
F_148 ( V_134 -> V_79 , L_110 ) ;
goto V_319;
}
if ( V_134 -> V_26 -> V_328 ( V_134 -> V_28 ) ) {
if ( V_134 -> V_141 )
F_148 ( V_134 -> V_79 , L_111 ) ;
V_19 = - V_157 ;
goto V_319;
}
V_19 = F_181 ( V_134 ) ;
...
F_34 ( & V_134 -> V_99 , 0 ) ;
V_134 -> V_104 = false ;
for ( V_169 = 0 ; V_169 < V_329 ; V_169 ++ )
F_34 ( & V_134 -> V_330 [ V_169 ] , 0 ) ;
V_134 -> V_51 = true ;
F_34 ( & V_134 -> V_120 , 0 ) ;
V_134 -> V_111 = V_331 ;
V_331 ++ ;
...
V_134 -> V_194 ) ;
if ( V_19 ) {
F_148 ( V_134 -> V_79 , L_114 ,
V_19 ) ;
goto V_333;
}
V_19 = F_220 ( V_134 -> V_11 , L_115 ,
& V_334 ,
V_134 ) ;
if ( V_19 ) {
F_148 ( V_134 -> V_79 , L_116 , V_19 ) ;
goto V_333;
}
V_19 = F_220 ( V_134 -> V_11 , L_117 ,
& V_335 ,
V_134 ) ;
if ( V_19 ) {
F_148 ( V_134 -> V_79 , L_116 , V_19 ) ;
...
F_75 ( V_134 -> V_79 , L_119 ,
V_295 [ V_134 -> V_83 ] ) ;
F_221 ( V_134 -> V_79 -> V_322 != NULL ) ;
F_124 ( V_322 ) ;
return 0 ;
V_333:
F_209 ( V_134 ) ;
...
V_19 = F_227 ( & V_326 ) ;
if ( V_19 ) {
F_138 ( V_170 L_120 , V_19 ) ;
return V_19 ;
}
}
V_176 = V_342 ;
if ( * V_176 != '\0' ) {
for ( V_169 = 0 ; ( V_169 < V_199 ) && ( * V_176 != '\0' ) ; V_169 ++ ) {
V_83 [ V_169 ] = V_176 ;
V_176 = strchr ( V_176 , ',' ) ;
if ( V_176 ) {
* V_176 = '\0' ;
...
F_127 ( & V_197 ) ;
F_213 (e, &smi_infos, link) {
if ( V_195 -> V_50 && ( ! type || V_195 -> V_141 == type ) ) {
if ( ! F_125 ( V_195 ) ) {
type = V_195 -> V_141 ;
}
}
...
static void F_126 ( struct V_9 * V_350 )
{
int V_19 = 0 ;
if ( ! V_350 )
return;
...
if ( V_350 -> V_79 )
F_164 ( V_350 -> V_79 , NULL ) ;
F_236 ( & V_350 -> V_320 ) ;
if ( V_350 -> V_146 )
V_350 -> V_146 ( V_350 ) ;
F_209 ( V_350 ) ;
while ( V_350 -> V_13 || ( V_350 -> V_41 != V_52 ) ) {
F_56 ( V_350 ) ;
F_179 ( 1 ) ;
}
F_20 ( V_350 , false ) ;
