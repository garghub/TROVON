...
F_28 ( & V_30 -> V_59 ) ;
F_29 ( & V_30 -> V_76 ) ;
V_30 -> V_77 = F_30 ( V_78 , V_62 , V_30 -> V_74 , V_30 ,
L_1 , V_30 -> V_16 ) ;
if ( F_31 ( V_30 -> V_77 ) )
goto V_79;
F_32 ( V_30 -> V_77 , V_30 ) ;
...
V_81 . V_85 = V_86 ;
V_81 . V_87 = V_33 -> V_87 ;
V_30 -> V_88 = F_34 ( & V_81 , V_89 ) ;
if ( ! V_30 -> V_88 ) {
F_35 ( L_2 ) ;
goto V_90;
}
}
V_35 = F_36 ( & V_30 -> clock , V_30 -> V_74 ) ;
if ( V_35 ) {
F_35 ( L_3 ) ;
goto V_91;
}
...
case V_98 :
F_43 ( & V_95 ) ;
F_44 ( V_30 -> V_88 , & V_95 , V_99 , NULL ) ;
break;
case V_100 :
F_44 ( V_30 -> V_88 , & V_93 -> V_101 ,
V_99 , NULL ) ;
break;
}
}
...
int V_107 ;
F_47 ( & V_30 -> V_59 ) ;
for ( V_107 = 0 ; V_107 < V_30 -> V_33 -> V_108 ; V_107 ++ ) {
if ( V_30 -> V_33 -> V_109 [ V_107 ] . V_103 == V_103 &&
V_30 -> V_33 -> V_109 [ V_107 ] . V_104 == V_104 ) {
V_106 = & V_30 -> V_33 -> V_109 [ V_107 ] ;
break;
}
}
F_48 ( & V_30 -> V_59 ) ;
