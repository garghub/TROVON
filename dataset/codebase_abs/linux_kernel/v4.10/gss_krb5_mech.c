...
if ( V_58 )
goto V_73;
V_71 = F_25 ( sizeof( * V_71 ) + F_26 ( V_67 ) , V_14 ) ;
if ( ! V_71 ) {
F_18 ( L_10 ,
V_64 , V_17 -> V_28 -> V_72 ) ;
V_58 = - V_15 ;
...
{
int V_96 ;
V_6 = F_3 ( V_6 , V_7 , & V_17 -> V_75 , sizeof( V_17 -> V_75 ) ) ;
if ( F_7 ( V_6 ) )
goto V_21;
V_17 -> V_34 = V_17 -> V_75 & V_97 ;
V_6 = F_3 ( V_6 , V_7 , & V_17 -> V_39 , sizeof( V_17 -> V_39 ) ) ;
if ( F_7 ( V_6 ) )
goto V_21;
V_6 = F_3 ( V_6 , V_7 , & V_17 -> V_98 , sizeof( V_17 -> V_98 ) ) ;
if ( F_7 ( V_6 ) )
goto V_21;
V_17 -> V_40 = V_17 -> V_98 ;
if ( V_17 -> V_98 != V_17 -> V_40 ) {
F_18 ( L_20 , V_64 ,
( unsigned long ) V_17 -> V_98 , V_17 -> V_40 ) ;
V_6 = F_5 ( - V_27 ) ;
goto V_21;
}
...
V_96 = V_17 -> V_28 -> V_49 ;
V_6 = F_3 ( V_6 , V_7 , V_17 -> V_59 , V_96 ) ;
if ( F_7 ( V_6 ) )
goto V_21;
if ( V_6 != V_7 ) {
V_6 = F_5 ( - V_27 ) ;
...
V_17 -> V_41 . V_13 = F_8 ( V_101 . V_102 . V_13 ,
V_101 . V_102 . V_9 , V_54 ) ;
if ( F_4 ( V_17 -> V_41 . V_13 == NULL ) ) {
V_6 = F_5 ( - V_15 ) ;
goto V_21;
}
V_17 -> V_41 . V_9 = V_101 . V_102 . V_9 ;
switch ( V_17 -> V_35 ) {
case V_100 :
...
return - V_15 ;
if ( V_9 == 85 )
V_106 = F_15 ( V_6 , V_7 , V_17 ) ;
else
V_106 = F_31 ( V_6 , V_7 , V_17 , V_54 ) ;
if ( V_106 == 0 ) {
V_105 -> V_107 = V_17 ;
if ( V_39 )
* V_39 = V_17 -> V_39 ;
...
F_13 ( V_17 ) ;
F_18 ( L_12 , V_64 , V_106 ) ;
return V_106 ;
}
static void
F_34 ( void * V_108 ) {
struct V_16 * V_109 = V_108 ;
F_14 ( V_109 -> V_44 ) ;
F_14 ( V_109 -> V_42 ) ;
F_14 ( V_109 -> V_83 ) ;
F_14 ( V_109 -> V_79 ) ;
