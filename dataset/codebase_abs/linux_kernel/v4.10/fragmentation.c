...
{
struct V_25 * V_67 ;
unsigned int V_68 = sizeof( * V_66 ) ;
unsigned int V_69 = V_62 - V_68 ;
V_67 = F_45 ( NULL , V_62 + V_47 ) ;
if ( ! V_67 )
goto V_34;
V_67 -> V_70 = V_9 -> V_70 ;
F_46 ( V_67 , V_68 + V_47 ) ;
F_47 ( V_9 , V_67 , V_9 -> V_38 - V_69 ) ;
F_48 ( V_67 , V_68 ) ;
memcpy ( V_67 -> V_35 , V_66 , V_68 ) ;
V_34:
return V_67 ;
}
...
if ( F_55 ( V_9 , V_68 ) < 0 ||
F_27 ( V_9 , V_68 + V_47 , 0 , V_36 ) < 0 ) {
V_33 = - V_87 ;
goto V_88;
}
memcpy ( V_9 -> V_35 , & V_72 , V_68 ) ;
F_39 ( V_54 , V_89 ) ;
F_40 ( V_54 , V_90 ,
V_9 -> V_38 + V_47 ) ;
V_33 = F_41 ( V_9 , V_58 ) ;
