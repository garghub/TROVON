...
static void F_93 ( struct V_103 * V_8 )
{
if ( ! F_82 ( V_8 ) )
return;
F_92 ( V_8 ) ;
}
static int F_94 ( struct V_125 * V_7 )
{
struct V_103 * V_8 = & V_7 -> V_8 ;
V_8 -> V_150 = F_71 ( V_8 , sizeof( * V_8 -> V_150 ) , V_129 ) ;
if ( ! V_8 -> V_150 )
return - V_107 ;
F_95 ( V_8 , 0 , F_75 ( 32 ) , NULL , false ) ;
F_96 ( V_8 , F_75 ( 32 ) ) ;
F_97 ( V_8 , F_75 ( 32 ) ) ;
return 0 ;
}
static int F_98 ( struct V_125 * V_7 )
{
struct V_103 * V_8 = & V_7 -> V_8 ;
struct V_36 * V_37 ;
struct V_151 * V_152 ;
...
V_152 = F_100 ( V_7 , V_155 , V_39 ) ;
if ( ! V_152 )
continue;
V_37 -> V_41 [ V_39 ] = F_101 ( & V_7 -> V_8 , V_152 ) ;
...
static int F_103 ( struct V_125 * V_7 )
{
return 0 ;
}
...
struct V_138 * V_139 ;
int V_51 ;
V_139 = F_105 ( NULL , V_157 ) ;
if ( ! V_139 )
return 0 ;
F_87 ( V_139 ) ;
V_51 = F_106 ( & V_158 , & V_159 ) ;
if ( V_51 )
return V_51 ;
V_51 = F_107 ( & V_160 ) ;
if ( V_51 )
