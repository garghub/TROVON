...
if ( F_61 ( F_62 ( V_27 , & V_53 -> V_5 ) ) )
continue;
if ( F_61 ( V_53 -> V_55 -> V_67 ( V_53 -> V_57 ) ||
F_62 ( V_54 , & V_53 -> V_5 ) ) ) {
F_30 ( V_2 , L_26 V_7 ) ;
if ( ! F_64 ( V_14 ) )
goto V_66;
...
void * F_67 ( struct V_1 * V_2 , void * V_71 )
{
...
V_73 -> V_89 [ V_74 ] = F_19 ( V_2 , F_68 ( V_74 ) ) ;
for ( V_74 = 0 ; V_74 < V_73 -> V_77 ; ++ V_74 ) {
V_73 -> V_90 [ V_74 ] = F_19 ( V_2 , F_69 ( V_74 ) ) ;
...
V_2 = F_71 ( sizeof( struct V_1 ) , V_103 ) ;
if ( ! V_2 )
return - V_104 ;
V_2 -> V_11 = V_11 ;
V_2 -> V_93 = V_93 ;
V_2 -> V_75 = F_72 ( V_93 -> V_57 . V_105 , L_30 ) ? 2 : 1 ;
F_3 ( V_2 , L_31 V_7 ) ;
V_98 = F_73 ( V_93 -> V_57 . V_105 , L_32 , NULL ) ;
if ( V_98 == NULL ) {
F_5 ( V_39
L_33 ,
V_11 ) ;
...
V_2 -> V_20 = V_98 [ 0 ] ;
V_98 = F_73 ( V_93 -> V_57 . V_105 , L_34 , NULL ) ;
if ( V_98 == NULL ) {
F_5 ( V_39
L_35 ,
V_11 ) ;
...
V_2 -> V_108 = F_75 ( V_93 -> V_57 . V_105 , V_97 , 0x100 ) ;
if ( ! F_76 ( V_2 -> V_108 ) ) {
F_5 ( V_39
L_37 , V_11 ) ;
V_94 = - V_106 ;
...
V_2 -> V_114 = F_78 ( V_93 -> V_57 . V_105 , 0 ) ;
V_2 -> V_115 = F_78 ( V_93 -> V_57 . V_105 , 1 ) ;
V_2 -> V_116 = F_78 ( V_93 -> V_57 . V_105 , 2 ) ;
if ( F_42 ( V_2 , V_112 ) ) {
V_2 -> V_117 = V_2 -> V_118 = V_2 -> V_116 ;
} else {
V_2 -> V_117 = F_78 ( V_93 -> V_57 . V_105 , 3 ) ;
V_2 -> V_118 = F_78 ( V_93 -> V_57 . V_105 , 4 ) ;
}
if ( ! V_2 -> V_114 || ! V_2 -> V_115 || ! V_2 -> V_116 ||
! V_2 -> V_117 || ! V_2 -> V_118 ) {
F_5 ( V_39
L_40 , V_11 ) ;
V_94 = - V_106 ;
...
F_80 ( & V_2 -> V_6 ) ;
F_81 ( & V_2 -> V_120 ) ;
F_82 ( & V_2 -> V_120 , & V_2 -> V_14 , F_59 ,
V_121 ) ;
F_65 ( V_2 ) ;
V_78 = ( V_2 -> V_75 == 2 ) ? V_122 : V_123 ;
V_78 |= V_124 | V_125 | V_126 ;
if ( F_72 ( V_93 -> V_57 . V_105 , L_41 ) )
V_78 &= ~ ( V_127 | V_128 ) ;
F_14 ( V_2 , V_29 , V_78 ) ;
F_13 ( V_2 -> V_20 <= 0 || V_2 -> V_20 > 32 ) ;
F_13 ( V_2 -> V_17 <= 0 || V_2 -> V_17 > 32 ) ;
V_95 = sizeof( struct V_129 ) *
( V_21 * V_2 -> V_20 +
V_22 * V_2 -> V_17 ) ;
V_2 -> V_130 = F_83 ( & V_93 -> V_57 , V_95 , & V_2 -> V_131 ,
V_103 ) ;
if ( V_2 -> V_130 == NULL ) {
V_94 = - V_104 ;
goto V_119;
...
F_14 ( V_2 , F_68 ( V_74 ) , V_2 -> V_131 +
sizeof( struct V_129 ) *
F_16 ( V_2 , V_74 ) ) ;
for ( V_74 = 0 ; V_74 < V_2 -> V_17 ; ++ V_74 )
F_14 ( V_2 , F_69 ( V_74 ) , V_2 -> V_131 +
sizeof( struct V_129 ) *
F_17 ( V_2 , V_74 ) ) ;
if ( F_42 ( V_2 , V_112 ) ) {
V_99 = V_132 ;
V_100 = V_101 = V_102 = F_50 ;
} else {
V_99 = 0 ;
V_100 = F_32 ;
V_101 = F_46 ;
...
V_94 = F_84 ( V_2 -> V_116 , V_100 , V_99 , L_42 , V_2 ) ;
if ( V_94 )
goto V_133;
V_94 = F_84 ( V_2 -> V_117 , V_101 , V_99 , L_43 , V_2 ) ;
if ( V_94 )
goto V_134;
V_94 = F_84 ( V_2 -> V_114 , F_40 , 0 , L_44 , V_2 ) ;
if ( V_94 )
goto V_135;
V_94 = F_84 ( V_2 -> V_118 , V_102 , V_99 , L_45 , V_2 ) ;
if ( V_94 )
goto V_136;
V_94 = F_84 ( V_2 -> V_115 , F_45 , 0 , L_46 , V_2 ) ;
if ( V_94 )
goto V_137;
F_14 ( V_2 , V_80 , V_138 ) ;
F_29 ( V_2 ) ;
...
F_88 ( V_2 -> V_116 , V_2 ) ;
V_133:
F_89 ( & V_93 -> V_57 , V_95 , V_2 -> V_130 , V_2 -> V_131 ) ;
V_119:
F_90 ( V_2 -> V_108 , 0x100 ) ;
V_107:
F_91 ( V_2 ) ;
return V_94 ;
}
