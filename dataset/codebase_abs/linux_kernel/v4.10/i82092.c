...
unsigned char V_77 ;
F_2 ( L_30 ) ;
F_42 ( V_119 -> V_2 -> V_123 , & V_121 , V_76 -> V_72 ) ;
V_77 = V_76 -> V_77 ;
if ( V_77 > 4 ) {
F_13 ( L_31 ) ;
return - V_101 ;
}
if ( ( V_76 -> V_124 > 0x3ffffff ) || ( V_121 . V_73 > V_121 . V_74 ) ||
( V_76 -> V_125 > 1000 ) ) {
F_13 ( L_32 ) ;
F_5 ( L_33
L_34 ,
...
V_6 = ( ( V_76 -> V_124 - V_121 . V_73 ) >> 12 ) & 0x3fff ;
if ( V_76 -> V_41 & V_131 )
V_6 |= V_132 ;
if ( V_76 -> V_41 & V_133 ) {
V_6 |= V_134 ;
