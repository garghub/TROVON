...
static bool F_99 ( struct V_1 * V_1 , struct V_267 * V_268 )
{
F_36 ( sizeof( * V_268 ) != 8 ) ;
if ( ! F_33 ( V_1 ,
V_269 ,
...
{
return F_104 ( V_1 -> V_268 . V_281 ) > 1 ;
}
static struct V_286 *
F_105 ( struct V_5 * V_6 )
{
struct V_1 * V_287 = F_3 ( V_6 ) ;
return F_106 ( V_6 , & V_287 -> V_288 ) ;
}
static struct V_286 *
...
V_38 = V_296 ;
if ( V_1 -> V_206 ) {
V_1 -> V_202 = F_110 ( V_286 ) ;
V_1 -> V_232 = F_111 ( V_286 ) ;
V_1 -> V_168 =
F_112 ( V_286 ) ;
}
} else
...
static bool
F_113 ( struct V_7 * V_287 ,
struct V_286 * V_286 )
{
bool V_301 = ! ! ( V_286 -> V_294 & V_295 ) ;
bool V_302 = ! ! F_114 ( V_287 ) ;
F_16 ( L_37 ,
V_302 , V_301 ) ;
return V_302 == V_301 ;
}
static enum V_291
F_115 ( struct V_5 * V_6 , bool V_303 )
{
T_4 V_44 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
{
struct V_1 * V_287 = F_3 ( V_6 ) ;
F_142 ( & V_6 -> V_357 -> V_358 ,
V_287 -> V_288 . V_10 . V_358 . V_37 ) ;
F_143 ( V_6 ) ;
}
static void F_144 ( struct V_359 * V_3 )
{
...
V_370 = & V_12 -> V_289 . V_371 [ 1 ] ;
if ( V_370 -> V_372 &&
F_152 ( V_12 , V_370 -> V_375 ) )
V_374 = V_370 -> V_375 ;
else
V_374 = V_376 ;
V_287 -> V_31 = F_108 ( V_12 , V_374 ) ;
F_153 ( V_287 -> V_31 , true ) ;
}
static void
F_154 ( struct V_1 * V_287 )
{
F_153 ( V_287 -> V_31 , false ) ;
}
static bool
F_155 ( struct V_1 * V_1 , int V_377 )
{
return F_54 ( V_1 ) ;
}
static T_2
F_156 ( struct V_9 * V_10 , struct V_1 * V_287 )
{
struct V_11 * V_12 = F_8 ( V_10 ) ;
...
static bool
F_172 ( struct V_1 * V_1 , int V_377 )
{
struct V_359 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_237 * V_237 ;
...
if ( F_127 ( V_7 ) )
return F_181 ( V_1 , V_7 , V_418 . V_310 ) ;
else if ( F_128 ( V_7 ) )
return F_184 ( V_1 , V_7 , V_418 . V_310 ) ;
else
return true ;
}
static int F_185 ( struct V_455 * V_456 ,
struct V_23 * V_24 ,
int V_457 )
{
...
static T_1 F_186 ( struct V_455 * V_456 )
{
struct V_1 * V_287 = V_456 -> V_458 ;
return V_287 -> V_31 -> V_459 -> V_461 ( V_287 -> V_31 ) ;
}
static bool
F_187 ( struct V_1 * V_287 ,
struct V_9 * V_10 )
{
struct V_462 * V_463 = V_10 -> V_463 ;
V_287 -> V_288 . V_464 = V_465 ;
V_287 -> V_288 . V_466 = V_467 ;
snprintf ( V_287 -> V_288 . V_37 , V_468 , L_56 ) ;
V_287 -> V_288 . V_10 . V_469 = & V_463 -> V_10 ;
V_287 -> V_288 . V_458 = V_287 ;
V_287 -> V_288 . V_459 = & V_470 ;
return F_188 ( & V_287 -> V_288 ) == 0 ;
}
...
V_2 -> type = V_473 ;
V_2 -> V_17 = V_17 ;
F_192 ( V_10 , & V_2 -> V_4 , & V_474 , 0 ,
L_57 , F_193 ( V_17 ) ) ;
for ( V_15 = 0 ; V_15 < 0x40 ; V_15 ++ ) {
T_2 V_475 ;
if ( ! F_14 ( V_1 , V_15 , & V_475 ) ) {
F_16 ( L_58 ,
F_22 ( V_1 ) ) ;
goto V_400;
}
