...
struct V_1 * V_22 ;
int V_11 ;
V_22 = F_34 ( V_32 , sizeof( * V_22 ) , V_64 ) ;
if ( ! V_22 )
return - V_65 ;
V_62 = F_35 ( V_32 -> V_66 , NULL ) ;
if ( V_62 ) {
V_63 = F_36 ( V_62 ) ;
if ( V_63 ) {
V_22 -> V_42 = F_37 ( V_63 ) ;
...
V_22 -> V_7 = V_7 ;
V_22 -> V_41 = F_39 ( V_32 , L_10 ) ;
if ( F_40 ( V_22 -> V_41 ) ) {
F_41 ( V_32 , L_11 ) ;
V_22 -> V_41 = NULL ;
}
V_22 -> V_43 = F_42 ( V_32 , L_12 , V_68 ) ;
if ( F_40 ( V_22 -> V_43 ) ) {
V_11 = F_43 ( V_22 -> V_43 ) ;
F_44 ( V_32 , L_13 , V_11 ) ;
return V_11 ;
}
V_22 -> V_40 = F_42 ( V_32 , L_14 , V_68 ) ;
if ( F_40 ( V_22 -> V_40 ) ) {
V_11 = F_43 ( V_22 -> V_40 ) ;
F_44 ( V_32 , L_15 , V_11 ) ;
return V_11 ;
...
V_22 -> V_27 -> V_28 . V_71 = V_72 ;
V_22 -> V_27 -> V_28 . V_29 = V_72 ;
}
V_22 -> V_3 . V_73 = & V_74 ;
V_22 -> V_3 . V_66 = V_32 -> V_66 ;
V_11 = F_48 ( & V_22 -> V_3 ) ;
if ( V_11 ) {
F_13 ( L_22 ) ;
return V_11 ;
