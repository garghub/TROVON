...
if ( V_24 )
return V_24 ;
V_30 = F_2 ( V_2 -> V_9 + V_32 ) ;
V_30 |= ( F_2 ( V_2 -> V_9 + V_26 ) & 0xf ) << 8 ;
if ( V_18 -> V_33 )
V_30 = F_9 ( V_4 , V_30 ) ;
V_16 [ V_25 ] = V_30 ;
}
...
int V_25 ;
for ( V_25 = 0 ; V_25 < V_6 -> V_28 ; V_25 ++ ) {
unsigned int V_30 = V_16 [ V_25 ] ;
V_4 -> V_40 [ V_20 ] = V_30 ;
if ( V_18 -> V_41 [ V_20 ] )
V_30 = F_9 ( V_4 , V_30 ) ;
F_3 ( V_30 & 0xff , V_2 -> V_9 + V_34 ) ;
F_3 ( ( V_30 >> 8 ) & 0xff , V_2 -> V_9 + V_37 ) ;
}
return V_6 -> V_28 ;
}
...
struct V_3 * V_4 ;
int V_24 ;
V_24 = F_15 ( V_2 , V_46 -> V_50 [ 0 ] , 0x10 ) ;
if ( V_24 )
return V_24 ;
F_3 ( 0 , V_2 -> V_9 + V_10 ) ;
F_2 ( V_2 -> V_9 + V_26 ) ;
F_3 ( 0 , V_2 -> V_9 + V_12 ) ;
V_18 = F_16 ( V_2 , sizeof( * V_18 ) ) ;
if ( ! V_18 )
return - V_51 ;
V_18 -> V_33 = ( V_46 -> V_50 [ 4 ] == 0 ) ;
...
V_4 -> V_58 = F_4 ;
V_4 -> V_59 = 0x0fff ;
V_4 -> V_60 = ( V_46 -> V_50 [ 3 ] < F_18 ( V_61 ) )
? V_61 [ V_46 -> V_50 [ 3 ] ]
: & V_62 ;
V_4 = & V_2 -> V_52 [ 1 ] ;
if ( V_48 -> V_63 ) {
...
V_4 -> V_66 = V_18 -> V_67 ;
V_18 -> V_67 [ 0 ] =
( V_46 -> V_50 [ 5 ] < F_18 ( V_68 ) )
? V_68 [ V_46 -> V_50 [ 5 ] ]
: & V_62 ;
V_18 -> V_67 [ 1 ] =
( V_46 -> V_50 [ 7 ] < F_18 ( V_68 ) )
? V_68 [ V_46 -> V_50 [ 7 ] ]
: & V_62 ;
V_4 -> V_69 = F_10 ;
V_24 = F_19 ( V_4 ) ;
