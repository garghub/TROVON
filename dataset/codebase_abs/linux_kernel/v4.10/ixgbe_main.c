...
static int F_382 ( struct V_61 * V_101 , void * V_98 )
{
if ( F_383 ( V_101 ) ) {
struct V_679 * V_680 = F_93 ( V_101 ) ;
struct V_665 * V_666 = V_680 -> V_681 ;
if ( V_680 -> V_681 )
F_377 ( V_101 , V_666 ) ;
}
return 0 ;
...
static int F_392 ( struct V_15 * V_14 )
{
T_1 V_20 ;
bool V_685 , V_357 = false ;
int V_600 = V_686 ;
if ( V_14 -> V_114 . V_355 . V_356 )
V_600 = V_14 -> V_114 . V_355 . V_356 ( V_14 , & V_20 , & V_357 , false ) ;
if ( V_600 )
return V_600 ;
V_20 = V_14 -> V_46 . V_687 ;
if ( ( ! V_20 ) && ( V_14 -> V_114 . V_355 . V_688 ) )
V_600 = V_14 -> V_114 . V_355 . V_688 ( V_14 , & V_20 ,
& V_685 ) ;
if ( V_600 )
return V_600 ;
if ( V_14 -> V_114 . V_355 . V_689 )
V_600 = V_14 -> V_114 . V_355 . V_689 ( V_14 , V_20 , V_357 ) ;
return V_600 ;
}
...
case V_121 :
default:
F_75 ( V_14 , F_394 ( 0 ) , 0xFFFFFFFF ) ;
F_75 ( V_14 , F_394 ( 1 ) , 0xFFFFFFFF ) ;
break;
}
} else {
F_75 ( V_14 , V_695 , V_696 ) ;
...
F_255 ( V_2 ) ;
if ( V_14 -> V_114 . V_355 . V_706 )
V_14 -> V_114 . V_355 . V_706 ( V_14 ) ;
if ( V_14 -> V_46 . V_355 . V_707 )
V_14 -> V_46 . V_355 . V_707 ( V_14 , true ) ;
F_36 () ;
F_37 ( V_34 , & V_2 -> V_35 ) ;
F_338 ( V_2 ) ;
if ( F_218 ( V_14 ) ) {
...
F_227 ( V_2 , true , true ) ;
if ( V_2 -> V_146 & V_361 ) {
T_1 V_708 = F_40 ( V_14 , V_709 ) ;
if ( V_708 & V_710 )
F_214 ( V_162 , L_72 ) ;
}
V_2 -> V_146 |= V_374 ;
V_2 -> V_375 = V_186 ;
F_397 ( & V_2 -> V_711 , V_186 ) ;
...
if ( F_22 ( V_14 -> V_41 ) )
return;
while ( F_15 ( V_714 , & V_2 -> V_35 ) )
F_259 ( 1000 , 2000 ) ;
V_2 -> V_349 &= ~ ( V_684 |
V_370 ) ;
V_2 -> V_146 &= ~ V_372 ;
V_17 = V_14 -> V_114 . V_355 . V_715 ( V_14 ) ;
switch ( V_17 ) {
case 0 :
case V_716 :
case V_717 :
...
F_322 ( V_2 ) ;
if ( V_14 -> V_114 . V_720 )
V_14 -> V_114 . V_355 . V_721 ( V_14 , F_288 ( 0 ) ) ;
if ( F_14 ( V_722 , & V_2 -> V_35 ) )
F_407 ( V_2 ) ;
if ( V_14 -> V_46 . V_355 . V_707 ) {
if ( ! F_61 ( V_2 -> V_62 ) && ! V_2 -> V_723 )
V_14 -> V_46 . V_355 . V_707 ( V_14 , false ) ;
else
V_14 -> V_46 . V_355 . V_707 ( V_14 , true ) ;
}
}
static void F_408 ( struct V_64 * V_65 )
{
struct V_66 * V_84 ;
unsigned long V_294 ;
T_2 V_49 ;
...
static int F_414 ( struct V_61 * V_101 , void * V_98 )
{
if ( F_383 ( V_101 ) ) {
struct V_679 * V_267 = F_93 ( V_101 ) ;
if ( V_267 -> V_681 ) {
F_376 ( V_101 ) ;
F_415 ( V_101 ) ;
F_416 ( V_101 ) ;
...
for ( V_49 = 0 ; V_49 < V_2 -> V_321 ; V_49 ++ )
V_2 -> V_523 [ V_49 ] . V_726 = false ;
F_418 ( V_2 ) ;
F_419 ( V_2 ) ;
}
for ( V_49 = 0 ; V_49 < V_2 -> V_83 ; V_49 ++ ) {
T_4 V_156 = V_2 -> V_65 [ V_49 ] -> V_156 ;
F_75 ( V_14 , F_53 ( V_156 ) , V_727 ) ;
}
switch ( V_14 -> V_114 . type ) {
case V_117 :
case V_118 :
...
if ( ! F_420 ( V_2 -> V_9 ) )
F_405 ( V_2 ) ;
if ( V_14 -> V_114 . V_355 . V_728 )
V_14 -> V_114 . V_355 . V_728 ( V_14 ) ;
F_411 ( V_2 ) ;
F_410 ( V_2 ) ;
}
static void F_421 ( struct V_61 * V_62 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
F_96 ( V_2 ) ;
}
...
case V_115 :
case V_117 :
V_2 -> V_143 . V_730 . V_731 = V_649 ;
V_2 -> V_143 . V_730 . V_732 = V_649 ;
break;
case V_118 :
case V_119 :
V_2 -> V_143 . V_730 . V_731 = V_733 ;
V_2 -> V_143 . V_730 . V_732 = V_733 ;
break;
case V_120 :
case V_121 :
default:
V_2 -> V_143 . V_730 . V_731 = V_734 ;
V_2 -> V_143 . V_730 . V_732 = V_734 ;
break;
}
for ( V_56 = 0 ; V_56 < V_649 ; V_56 ++ ) {
V_141 = & V_2 -> V_143 . V_735 [ V_56 ] ;
V_141 -> V_736 [ V_632 ] . V_737 = 0 ;
V_141 -> V_736 [ V_632 ] . V_738 = 12 + ( V_56 & 1 ) ;
V_141 -> V_736 [ V_633 ] . V_737 = 0 ;
V_141 -> V_736 [ V_633 ] . V_738 = 12 + ( V_56 & 1 ) ;
V_141 -> V_739 = V_740 ;
}
V_141 = & V_2 -> V_143 . V_735 [ 0 ] ;
V_141 -> V_736 [ V_632 ] . V_741 = 0xFF ;
V_141 -> V_736 [ V_633 ] . V_741 = 0xFF ;
V_2 -> V_143 . V_742 [ V_632 ] [ 0 ] = 100 ;
V_2 -> V_143 . V_742 [ V_633 ] [ 0 ] = 100 ;
V_2 -> V_143 . V_144 = false ;
V_2 -> V_743 = 0x00 ;
if ( V_2 -> V_146 & V_744 )
V_2 -> V_630 = V_745 | V_631 ;
memcpy ( & V_2 -> V_746 , & V_2 -> V_143 ,
sizeof( V_2 -> V_746 ) ) ;
}
...
V_748 -> V_759 ( V_14 ) ;
V_223 = F_333 ( int , F_424 ( V_2 ) , F_425 () ) ;
V_2 -> V_438 [ V_453 ] . V_760 = V_223 ;
V_2 -> V_349 |= V_761 ;
V_2 -> V_762 = V_763 ;
V_2 -> V_423 = 20 ;
V_749 = F_333 ( int , V_764 , F_425 () ) ;
V_2 -> V_438 [ V_765 ] . V_760 = V_749 ;
V_2 -> V_652 = V_766 ;
#ifdef F_238
V_2 -> V_146 |= V_210 ;
#endif
...
V_2 -> V_146 &= ~ V_531 ;
#ifdef F_387
V_2 -> V_644 . V_645 = V_768 ;
#endif
#endif
V_2 -> V_769 [ 0 ] = F_426 ( sizeof( * V_2 -> V_769 [ 0 ] ) ,
V_770 ) ;
if ( ! V_2 -> V_769 [ 0 ] )
return - V_584 ;
V_2 -> V_769 [ 0 ] -> V_771 = V_772 ;
for ( V_49 = 1 ; V_49 < V_773 ; V_49 ++ )
V_2 -> V_769 [ V_49 ] = NULL ;
V_2 -> V_586 = F_426 ( sizeof( struct V_585 ) *
V_14 -> V_114 . V_587 ,
V_774 ) ;
if ( ! V_2 -> V_586 )
return - V_584 ;
...
#ifdef F_181
F_428 ( & V_2 -> V_644 . V_778 ) ;
#endif
F_428 ( & V_2 -> V_659 ) ;
#ifdef F_387
F_422 ( V_2 ) ;
#endif
V_14 -> V_132 . V_779 = V_134 ;
V_14 -> V_132 . V_133 = V_134 ;
F_361 ( V_2 ) ;
V_14 -> V_132 . V_780 = V_781 ;
V_14 -> V_132 . V_782 = true ;
V_14 -> V_132 . V_783 = F_429 ( V_14 ) ;
#ifdef F_315
if ( V_784 > 0 )
F_11 ( L_101 ) ;
if ( V_14 -> V_114 . type != V_115 ) {
...
int F_431 ( struct V_64 * V_65 )
{
struct V_208 * V_80 = V_65 -> V_80 ;
int V_794 = F_432 ( V_80 ) ;
int V_795 = - 1 ;
int V_294 ;
V_294 = sizeof( struct V_66 ) * V_65 -> V_94 ;
if ( V_65 -> V_172 )
V_795 = V_65 -> V_172 -> V_796 ;
V_65 -> V_84 = F_433 ( V_294 , V_795 ) ;
if ( ! V_65 -> V_84 )
V_65 -> V_84 = F_434 ( V_294 ) ;
if ( ! V_65 -> V_84 )
goto V_17;
F_435 ( & V_65 -> V_184 ) ;
...
F_436 ( V_80 , V_795 ) ;
V_65 -> V_93 = F_437 ( V_80 ,
V_65 -> V_294 ,
& V_65 -> V_87 ,
V_770 ) ;
F_436 ( V_80 , V_794 ) ;
if ( ! V_65 -> V_93 )
V_65 -> V_93 = F_437 ( V_80 , V_65 -> V_294 ,
& V_65 -> V_87 , V_770 ) ;
if ( ! V_65 -> V_93 )
goto V_17;
V_65 -> V_86 = 0 ;
...
V_294 = sizeof( struct V_77 ) * V_74 -> V_94 ;
if ( V_74 -> V_172 )
V_795 = V_74 -> V_172 -> V_796 ;
V_74 -> V_78 = F_433 ( V_294 , V_795 ) ;
if ( ! V_74 -> V_78 )
V_74 -> V_78 = F_434 ( V_294 ) ;
if ( ! V_74 -> V_78 )
goto V_17;
F_435 ( & V_74 -> V_184 ) ;
...
F_436 ( V_80 , V_795 ) ;
V_74 -> V_93 = F_437 ( V_80 ,
V_74 -> V_294 ,
& V_74 -> V_87 ,
V_770 ) ;
F_436 ( V_80 , V_794 ) ;
if ( ! V_74 -> V_93 )
V_74 -> V_93 = F_437 ( V_80 , V_74 -> V_294 ,
& V_74 -> V_87 , V_770 ) ;
if ( ! V_74 -> V_93 )
goto V_17;
V_74 -> V_85 = 0 ;
...
static int F_450 ( struct V_61 * V_62 , int V_799 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
if ( ( V_2 -> V_146 & V_433 ) &&
...
( V_799 > V_800 ) )
F_27 ( V_187 , L_108 ) ;
F_110 ( V_187 , L_109 , V_62 -> V_309 , V_799 ) ;
V_62 -> V_309 = V_799 ;
if ( F_61 ( V_62 ) )
F_398 ( V_2 ) ;
return 0 ;
}
int F_451 ( struct V_61 * V_62 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
struct V_15 * V_14 = & V_2 -> V_14 ;
int V_17 , V_379 ;
if ( F_14 ( V_801 , & V_2 -> V_35 ) )
return - V_802 ;
F_415 ( V_62 ) ;
V_17 = F_440 ( V_2 ) ;
if ( V_17 )
...
V_803:
F_448 ( V_2 ) ;
if ( V_14 -> V_46 . V_355 . V_707 && ! V_2 -> V_723 )
V_14 -> V_46 . V_355 . V_707 ( & V_2 -> V_14 , false ) ;
V_798:
F_447 ( V_2 ) ;
V_797:
F_405 ( V_2 ) ;
...
{
F_455 ( V_2 ) ;
if ( V_2 -> V_14 . V_46 . V_355 . V_807 ) {
V_2 -> V_14 . V_46 . V_808 = true ;
F_402 ( V_2 ) ;
V_2 -> V_14 . V_46 . V_355 . V_807 ( & V_2 -> V_14 ) ;
V_2 -> V_14 . V_46 . V_808 = false ;
} else {
F_402 ( V_2 ) ;
}
F_252 ( V_2 ) ;
...
static int F_458 ( struct V_5 * V_9 )
{
struct V_1 * V_2 = F_459 ( V_9 ) ;
struct V_61 * V_62 = V_2 -> V_62 ;
T_1 V_17 ;
...
static int F_470 ( struct V_5 * V_9 , bool * V_812 )
{
struct V_1 * V_2 = F_459 ( V_9 ) ;
struct V_61 * V_62 = V_2 -> V_62 ;
struct V_15 * V_14 = & V_2 -> V_14 ;
...
return V_815 ;
#endif
if ( V_14 -> V_114 . V_355 . V_816 )
V_14 -> V_114 . V_355 . V_816 ( V_14 ) ;
if ( V_814 ) {
F_335 ( V_62 ) ;
if ( V_14 -> V_114 . V_355 . V_706 )
V_14 -> V_114 . V_355 . V_706 ( V_14 ) ;
...
V_813 = F_40 ( V_14 , V_818 ) ;
V_813 |= V_819 ;
F_75 ( V_14 , V_818 , V_813 ) ;
F_75 ( V_14 , V_820 , V_814 ) ;
} else {
F_75 ( V_14 , V_821 , 0 ) ;
F_75 ( V_14 , V_820 , 0 ) ;
}
...
* V_812 = ! ! V_814 ;
if ( V_14 -> V_46 . V_355 . V_707 && ! * V_812 )
V_14 -> V_46 . V_355 . V_707 ( V_14 , false ) ;
F_74 ( V_2 ) ;
if ( ! F_15 ( V_810 , & V_2 -> V_35 ) )
F_474 ( V_9 ) ;
return 0 ;
}
static int F_475 ( struct V_5 * V_9 , T_14 V_35 )
{
int V_815 ;
bool V_822 ;
V_815 = F_470 ( V_9 , & V_822 ) ;
if ( V_815 )
return V_815 ;
if ( V_822 ) {
F_476 ( V_9 ) ;
...
static void F_477 ( struct V_5 * V_9 )
{
bool V_822 ;
F_470 ( V_9 , & V_822 ) ;
if ( V_824 == V_825 ) {
...
struct V_129 * V_130 = & V_2 -> V_131 ;
T_6 V_826 = 0 ;
T_1 V_49 , V_827 = 0 , V_828 , V_829 , V_830 , V_831 , V_832 ;
T_6 V_279 = 0 , V_189 = 0 , V_833 = 0 ;
T_6 V_250 = 0 , V_302 = 0 ;
T_6 V_185 = 0 , V_151 = 0 , V_834 = 0 ;
if ( F_14 ( V_34 , & V_2 -> V_35 ) ||
F_14 ( V_713 , & V_2 -> V_35 ) )
return;
if ( V_2 -> V_349 & V_539 ) {
...
V_833 += V_65 -> V_159 . V_833 ;
V_185 += V_65 -> V_131 . V_185 ;
V_151 += V_65 -> V_131 . V_151 ;
}
V_2 -> V_189 = V_189 ;
V_2 -> V_833 = V_833 ;
V_62 -> V_131 . V_839 = V_185 ;
V_62 -> V_131 . V_840 = V_151 ;
V_130 -> V_841 += F_40 ( V_14 , V_842 ) ;
for ( V_49 = 0 ; V_49 < 8 ; V_49 ++ ) {
V_828 = F_40 ( V_14 , F_479 ( V_49 ) ) ;
V_827 += V_828 ;
V_130 -> V_828 [ V_49 ] += V_828 ;
V_826 += V_130 -> V_828 [ V_49 ] ;
V_130 -> V_843 [ V_49 ] += F_40 ( V_14 , F_480 ( V_49 ) ) ;
V_130 -> V_844 [ V_49 ] += F_40 ( V_14 , F_481 ( V_49 ) ) ;
switch ( V_14 -> V_114 . type ) {
case V_115 :
V_130 -> V_845 [ V_49 ] += F_40 ( V_14 , F_482 ( V_49 ) ) ;
V_130 -> V_846 [ V_49 ] += F_40 ( V_14 , F_483 ( V_49 ) ) ;
V_130 -> V_847 [ V_49 ] += F_40 ( V_14 , F_484 ( V_49 ) ) ;
V_130 -> V_848 [ V_49 ] +=
F_40 ( V_14 , F_485 ( V_49 ) ) ;
break;
case V_117 :
case V_118 :
case V_119 :
...
V_130 -> V_849 [ V_49 ] += F_40 ( V_14 , F_487 ( V_49 ) ) ;
V_130 -> V_850 [ V_49 ] += F_40 ( V_14 , F_488 ( V_49 ) ) ;
...
V_130 -> V_847 [ V_49 ] += F_40 ( V_14 , F_491 ( V_49 ) ) ;
F_40 ( V_14 , F_492 ( V_49 ) ) ;
}
}
...
for ( V_49 = 0 ; V_49 < 16 ; V_49 ++ )
V_2 -> V_869 +=
F_40 ( V_14 , F_493 ( V_49 ) ) ;
V_130 -> V_855 += F_40 ( V_14 , V_870 ) ;
F_40 ( V_14 , V_856 ) ;
V_130 -> V_857 += F_40 ( V_14 , V_871 ) ;
F_40 ( V_14 , V_858 ) ;
V_130 -> V_859 += F_40 ( V_14 , V_872 ) ;
F_40 ( V_14 , V_860 ) ;
V_130 -> V_853 += F_40 ( V_14 , V_873 ) ;
...
V_130 -> V_888 += F_40 ( V_14 , V_889 ) ;
if ( V_2 -> V_644 . V_890 ) {
struct V_891 * V_644 = & V_2 -> V_644 ;
struct V_892 * V_890 ;
unsigned int V_190 ;
T_6 V_893 = 0 , V_894 = 0 ;
F_494 (cpu) {
V_890 = F_495 ( V_644 -> V_890 , V_190 ) ;
V_893 += V_890 -> V_893 ;
V_894 += V_890 -> V_894 ;
}
V_130 -> V_895 = V_893 ;
...
V_130 -> V_914 += F_40 ( V_14 , V_915 ) ;
V_830 = F_40 ( V_14 , V_916 ) ;
V_130 -> V_917 += V_830 ;
V_831 = F_40 ( V_14 , V_918 ) ;
V_130 -> V_919 += V_831 ;
...
V_130 -> V_945 += F_40 ( V_14 , V_946 ) ;
V_62 -> V_131 . V_947 = V_130 -> V_898 ;
V_62 -> V_131 . V_948 = V_130 -> V_841 + V_130 -> V_914 ;
V_62 -> V_131 . V_949 = 0 ;
V_62 -> V_131 . V_950 = V_130 -> V_914 ;
V_62 -> V_131 . V_951 = V_130 -> V_841 ;
V_62 -> V_131 . V_952 = V_826 ;
}
...
for ( V_49 = 0 ; V_49 < V_2 -> V_207 ; V_49 ++ ) {
struct V_171 * V_957 = V_2 -> V_172 [ V_49 ] ;
if ( V_957 -> V_313 . V_127 || V_957 -> V_177 . V_127 )
V_954 |= F_242 ( V_49 ) ;
}
}
F_79 ( V_2 , V_954 ) ;
...
return;
if ( V_14 -> V_114 . V_355 . V_356 ) {
V_14 -> V_114 . V_355 . V_356 ( V_14 , & V_958 , & V_357 , false ) ;
} else {
V_958 = V_959 ;
V_357 = true ;
}
...
V_14 -> V_114 . V_355 . V_960 ( V_14 ) ;
F_501 ( V_2 ) ;
}
if ( V_357 ||
F_502 ( V_186 , ( V_2 -> V_375 +
V_961 ) ) ) {
V_2 -> V_146 &= ~ V_374 ;
...
T_4 V_645 = 0 ;
if ( V_2 -> V_630 & V_966 )
V_645 = F_504 ( V_62 , & V_963 ) ;
V_2 -> V_967 = ( V_645 > 1 ) ? ( F_505 ( V_645 ) - 1 ) : 0 ;
#endif
}
static int F_506 ( struct V_61 * V_101 , void * V_98 )
{
if ( F_383 ( V_101 ) ) {
struct V_679 * V_267 = F_93 ( V_101 ) ;
if ( V_267 -> V_681 )
...
static bool F_514 ( struct V_1 * V_2 )
{
struct V_15 * V_14 = & V_2 -> V_14 ;
struct V_986 * V_987 = & V_2 -> V_438 [ V_439 ] ;
T_1 V_988 = F_515 ( 1 , ~ V_987 -> V_124 ) ;
int V_49 , V_56 ;
if ( ! V_2 -> V_321 )
return false ;
if ( V_14 -> V_114 . type >= V_119 )
...
T_1 V_989 , V_990 ;
V_989 = F_40 ( V_14 , F_516 ( V_988 , V_49 , V_56 ) ) ;
V_990 = F_40 ( V_14 , F_517 ( V_988 , V_49 , V_56 ) ) ;
if ( V_989 != V_990 )
return true ;
}
}
...
static inline void F_519 ( struct V_1 * V_2 ,
struct V_5 * V_991 )
{
if ( ! F_520 ( V_991 ) )
F_11 ( L_125 ) ;
F_18 ( L_126 , F_521 ( V_991 ) ) ;
F_522 ( V_991 , V_992 , V_993 ) ;
F_403 ( 100 ) ;
}
...
if ( ! V_9 )
return;
for ( V_994 = 0 ; V_994 < V_2 -> V_321 ; ++ V_994 ) {
struct V_5 * V_991 = V_2 -> V_523 [ V_994 ] . V_991 ;
T_2 V_997 ;
if ( ! V_991 )
continue;
...
if ( ! V_1000 )
return;
F_27 ( V_162 , L_127 , V_1000 ) ;
}
static void F_524 ( struct V_1 T_15 * V_2 )
{
}
static void
F_523 ( struct V_1 T_15 * V_2 )
{
}
...
return;
if ( V_2 -> V_371 &&
F_502 ( V_2 -> V_371 , V_186 ) )
return;
if ( F_15 ( V_714 , & V_2 -> V_35 ) )
return;
V_2 -> V_371 = V_186 + V_1002 - 1 ;
V_17 = V_14 -> V_46 . V_355 . V_1003 ( V_14 ) ;
if ( V_17 == V_717 )
goto V_1004;
if ( V_17 == V_716 ) {
V_2 -> V_349 |= V_370 ;
...
V_2 -> V_349 &= ~ V_370 ;
if ( V_14 -> V_114 . type == V_115 )
V_17 = V_14 -> V_46 . V_355 . V_1005 ( V_14 ) ;
else
V_17 = V_14 -> V_114 . V_355 . V_1006 ( V_14 ) ;
if ( V_17 == V_717 )
goto V_1004;
V_2 -> V_146 |= V_372 ;
F_110 ( V_187 , L_128 , V_14 -> V_46 . V_1007 ) ;
V_1004:
F_37 ( V_714 , & V_2 -> V_35 ) ;
if ( ( V_17 == V_717 ) &&
...
V_20 = V_14 -> V_46 . V_687 ;
if ( ( ! V_20 ) && ( V_14 -> V_114 . V_355 . V_688 ) ) {
V_14 -> V_114 . V_355 . V_688 ( V_14 , & V_20 , & V_685 ) ;
if ( ! V_685 ) {
if ( V_20 & V_959 )
V_20 = V_959 ;
}
...
if ( V_14 -> V_114 . V_355 . V_689 )
V_14 -> V_114 . V_355 . V_689 ( V_14 , V_20 , true ) ;
V_2 -> V_146 |= V_374 ;
V_2 -> V_375 = V_186 ;
F_37 ( V_714 , & V_2 -> V_35 ) ;
}
static void F_529 ( unsigned long V_98 )
{
...
return;
V_2 -> V_349 &= ~ V_392 ;
if ( ! V_14 -> V_46 . V_355 . V_1012 )
return;
V_180 = V_14 -> V_46 . V_355 . V_1012 ( & V_2 -> V_14 ) ;
if ( V_180 != V_359 )
return;
F_214 ( V_162 , L_71 , V_360 ) ;
}
...
return;
F_57 ( V_2 ) ;
F_532 ( V_2 -> V_62 , L_133 ) ;
V_2 -> V_188 ++ ;
F_466 () ;
F_398 ( V_2 ) ;
F_468 () ;
}
static void F_533 ( struct V_1013 * V_1014 )
{
struct V_1 * V_2 = F_201 ( V_1014 ,
struct V_1 ,
V_39 ) ;
...
static int F_536 ( struct V_64 * V_65 ,
struct V_66 * V_1016 ,
T_4 * V_256 )
{
T_1 V_1017 , V_1018 , V_1019 ;
struct V_213 * V_95 = V_1016 -> V_95 ;
union {
...
if ( V_17 < 0 )
return V_17 ;
V_1025 . V_1024 = F_539 ( V_95 ) ;
V_1028 . V_1024 = F_540 ( V_95 ) ;
V_1018 = V_1032 ;
if ( V_1025 . V_1021 -> V_1033 == 4 ) {
unsigned char * V_1034 = F_540 ( V_95 ) ;
unsigned char * V_1035 = V_1025 . V_1024 + ( V_1025 . V_1021 -> V_1036 * 4 ) ;
V_1025 . V_1021 -> V_1037 = F_541 ( F_542 ( V_1035 ,
V_1034 - V_1035 ,
0 ) ) ;
V_1018 |= V_1038 ;
V_1025 . V_1021 -> V_1039 = 0 ;
V_1016 -> V_1040 |= V_1041 |
V_1042 |
V_1043 ;
} else {
V_1025 . V_1023 -> V_1044 = 0 ;
V_1016 -> V_1040 |= V_1041 |
V_1042 ;
}
V_1030 = V_1028 . V_1024 - V_95 -> V_98 ;
* V_256 = ( V_1028 . V_1027 -> V_1045 * 4 ) + V_1030 ;
V_1029 = V_95 -> V_88 - V_1030 ;
F_543 ( & V_1028 . V_1027 -> V_1037 , F_544 ( V_1029 ) ) ;
V_1016 -> V_183 = F_154 ( V_95 ) -> V_183 ;
V_1016 -> V_182 += ( V_1016 -> V_183 - 1 ) * * V_256 ;
V_1019 = ( * V_256 - V_1030 ) << V_1046 ;
V_1019 |= F_154 ( V_95 ) -> V_257 << V_1047 ;
V_1017 = V_1028 . V_1024 - V_1025 . V_1024 ;
V_1017 |= ( V_1025 . V_1024 - V_95 -> V_98 ) << V_1048 ;
V_1017 |= V_1016 -> V_1040 & V_1049 ;
F_545 ( V_65 , V_1017 , 0 , V_1018 ,
V_1019 ) ;
return 1 ;
}
static inline bool F_546 ( struct V_213 * V_95 )
{
unsigned int V_1050 = 0 ;
F_547 ( V_95 , & V_1050 , V_1051 , NULL , NULL ) ;
return V_1050 == F_548 ( V_95 ) ;
}
static void F_549 ( struct V_64 * V_65 ,
struct V_66 * V_1016 )
{
struct V_213 * V_95 = V_1016 -> V_95 ;
T_1 V_1017 = 0 ;
...
if ( V_95 -> V_243 != V_1031 ) {
V_1052:
if ( ! ( V_1016 -> V_1040 & ( V_1053 |
V_1054 ) ) )
return;
goto V_1055;
}
switch ( V_95 -> V_1056 ) {
case F_550 ( struct V_1026 , V_1037 ) :
V_1018 = V_1032 ;
case F_550 ( struct V_1057 , V_1037 ) :
break;
case F_550 ( struct V_1058 , V_1059 ) :
if ( ( ( V_1016 -> V_269 == F_161 ( V_1060 ) ) &&
( F_551 ( V_95 ) -> V_269 == V_1051 ) ) ||
( ( V_1016 -> V_269 == F_161 ( V_1061 ) ) &&
F_546 ( V_95 ) ) ) {
V_1018 = V_1062 ;
break;
}
...
V_1016 -> V_1040 |= V_1042 ;
V_1017 = F_548 ( V_95 ) -
F_553 ( V_95 ) ;
V_1055:
V_1017 |= F_553 ( V_95 ) << V_1048 ;
V_1017 |= V_1016 -> V_1040 & V_1049 ;
F_545 ( V_65 , V_1017 , 0 , V_1018 , 0 ) ;
}
static T_1 F_554 ( struct V_213 * V_95 , T_1 V_1040 )
{
T_1 V_1063 = V_1064 |
V_1065 |
V_1066 ;
V_1063 |= F_555 ( V_1040 , V_1053 ,
V_1067 ) ;
V_1063 |= F_555 ( V_1040 , V_1041 ,
V_1068 ) ;
V_1063 |= F_555 ( V_1040 , V_1069 ,
V_1070 ) ;
V_1063 ^= F_555 ( V_95 -> V_1071 , 1 , V_1066 ) ;
return V_1063 ;
}
static void F_556 ( union V_68 * V_69 ,
T_1 V_1040 , unsigned int V_1029 )
{
T_1 V_1072 = V_1029 << V_1073 ;
V_1072 |= F_555 ( V_1040 ,
V_1042 ,
V_1074 ) ;
V_1072 |= F_555 ( V_1040 ,
...
V_1054 ,
V_1076 ) ;
V_69 -> V_253 . V_1072 = F_102 ( V_1072 ) ;
}
static int F_557 ( struct V_64 * V_65 , T_2 V_294 )
{
F_109 ( V_65 -> V_62 , V_65 -> V_92 ) ;
F_116 () ;
if ( F_25 ( F_115 ( V_65 ) < V_294 ) )
return - V_802 ;
F_558 ( V_65 -> V_62 , V_65 -> V_92 ) ;
++ V_65 -> V_159 . V_189 ;
return 0 ;
}
static inline int F_559 ( struct V_64 * V_65 , T_2 V_294 )
{
if ( F_25 ( F_115 ( V_65 ) >= V_294 ) )
return 0 ;
return F_557 ( V_65 , V_294 ) ;
}
static void F_560 ( struct V_64 * V_65 ,
struct V_66 * V_1016 ,
const T_4 V_256 )
{
struct V_213 * V_95 = V_1016 -> V_95 ;
...
T_1 V_1040 = V_1016 -> V_1040 ;
T_1 V_1063 = F_554 ( V_95 , V_1040 ) ;
T_2 V_49 = V_65 -> V_86 ;
V_69 = F_65 ( V_65 , V_49 ) ;
F_556 ( V_69 , V_1040 , V_95 -> V_88 - V_256 ) ;
V_294 = F_153 ( V_95 ) ;
V_286 = V_95 -> V_286 ;
#ifdef F_181
if ( V_1040 & V_1077 ) {
...
#endif
V_87 = F_561 ( V_65 -> V_80 , V_95 -> V_98 , V_294 , V_128 ) ;
V_67 = V_1016 ;
for ( V_281 = & F_154 ( V_95 ) -> V_282 [ 0 ] ; ; V_281 ++ ) {
if ( F_146 ( V_65 -> V_80 , V_87 ) )
goto V_1078;
F_85 ( V_67 , V_88 , V_294 ) ;
F_562 ( V_67 , V_87 , V_87 ) ;
V_69 -> V_253 . V_1079 = F_149 ( V_87 ) ;
while ( F_23 ( V_294 > V_1080 ) ) {
V_69 -> V_253 . V_1081 =
F_102 ( V_1063 ^ V_1080 ) ;
V_49 ++ ;
V_69 ++ ;
...
if ( F_25 ( ! V_286 ) )
break;
V_69 -> V_253 . V_1081 = F_102 ( V_1063 ^ V_294 ) ;
V_49 ++ ;
V_69 ++ ;
if ( V_49 == V_65 -> V_94 ) {
V_69 = F_65 ( V_65 , 0 ) ;
...
#endif
V_286 -= V_294 ;
V_87 = F_564 ( V_65 -> V_80 , V_281 , 0 , V_294 ,
V_128 ) ;
V_67 = & V_65 -> V_84 [ V_49 ] ;
}
V_1063 |= V_294 | V_1082 ;
V_69 -> V_253 . V_1081 = F_102 ( V_1063 ) ;
F_565 ( F_112 ( V_65 ) , V_1016 -> V_182 ) ;
V_1016 -> V_90 = V_186 ;
F_150 () ;
V_1016 -> V_89 = V_69 ;
V_49 ++ ;
...
V_65 -> V_86 = V_49 ;
F_559 ( V_65 , V_1083 ) ;
if ( F_566 ( F_112 ( V_65 ) ) || ! V_95 -> V_1084 ) {
F_151 ( V_49 , V_65 -> V_153 ) ;
F_567 () ;
}
return;
V_1078:
F_439 ( V_65 -> V_80 , L_134 ) ;
for (; ; ) {
V_67 = & V_65 -> V_84 [ V_49 ] ;
F_81 ( V_65 , V_67 ) ;
if ( V_67 == V_1016 )
...
static void F_568 ( struct V_64 * V_127 ,
struct V_66 * V_1016 )
{
struct V_171 * V_172 = V_127 -> V_172 ;
union V_1085 V_1086 = { . V_1087 = 0 } ;
union V_1085 V_1088 = { . V_1087 = 0 } ;
union {
unsigned char * V_1089 ;
struct V_1020 * V_1090 ;
struct V_1022 * V_1091 ;
} V_1024 ;
struct V_1026 * V_1092 ;
unsigned int V_1093 ;
struct V_213 * V_95 ;
T_12 V_1094 ;
int V_1095 ;
...
return;
V_95 = V_1016 -> V_95 ;
V_1024 . V_1089 = F_539 ( V_95 ) ;
if ( F_23 ( V_1024 . V_1089 <= V_95 -> V_98 ) )
return;
if ( V_95 -> V_234 &&
V_1016 -> V_269 == F_161 ( V_1060 ) &&
V_1024 . V_1090 -> V_269 == V_1096 ) {
struct V_1 * V_2 = V_172 -> V_2 ;
if ( F_23 ( F_569 ( V_95 ) < V_1024 . V_1089 +
V_1097 ) )
return;
if ( V_2 -> V_626 &&
F_570 ( V_95 ) -> V_1098 == V_2 -> V_626 )
V_1024 . V_1089 = F_571 ( V_95 ) ;
if ( V_2 -> V_628 &&
F_570 ( V_95 ) -> V_1098 == V_2 -> V_628 )
V_1024 . V_1089 = F_571 ( V_95 ) ;
}
if ( F_23 ( F_569 ( V_95 ) < V_1024 . V_1089 + 40 ) )
return;
switch ( V_1024 . V_1090 -> V_1033 ) {
case V_1099 :
V_1093 = ( V_1024 . V_1089 [ 0 ] & 0x0F ) << 2 ;
V_1095 = V_1024 . V_1090 -> V_269 ;
break;
case 6 :
V_1093 = V_1024 . V_1089 - V_95 -> V_98 ;
V_1095 = F_547 ( V_95 , & V_1093 , V_1100 , NULL , NULL ) ;
V_1093 -= V_1024 . V_1089 - V_95 -> V_98 ;
break;
default:
return;
...
return;
if ( F_23 ( F_569 ( V_95 ) < V_1024 . V_1089 +
V_1093 + sizeof( struct V_1026 ) ) )
return;
V_1092 = (struct V_1026 * ) ( V_1024 . V_1089 + V_1093 ) ;
if ( V_1092 -> V_1101 )
return;
if ( ! V_1092 -> V_1102 && ( V_127 -> V_424 < V_127 -> V_423 ) )
return;
V_127 -> V_424 = 0 ;
V_1094 = F_161 ( V_1016 -> V_1040 >> V_1103 ) ;
V_1086 . V_1104 . V_1094 = V_1094 ;
if ( V_1016 -> V_1040 & ( V_1105 | V_1053 ) )
V_1088 . V_1106 . V_1107 ^= V_1092 -> V_1098 ^ F_161 ( V_268 ) ;
else
V_1088 . V_1106 . V_1107 ^= V_1092 -> V_1098 ^ V_1016 -> V_269 ;
V_1088 . V_1106 . V_1108 ^= V_1092 -> V_1109 ;
switch ( V_1024 . V_1090 -> V_1033 ) {
case V_1099 :
V_1086 . V_1104 . V_1110 = V_1111 ;
V_1088 . V_1025 ^= V_1024 . V_1090 -> V_1112 ^ V_1024 . V_1090 -> V_1113 ;
break;
case 6 :
V_1086 . V_1104 . V_1110 = V_1114 ;
V_1088 . V_1025 ^= V_1024 . V_1091 -> V_1112 . V_1115 [ 0 ] ^
V_1024 . V_1091 -> V_1112 . V_1115 [ 1 ] ^
V_1024 . V_1091 -> V_1112 . V_1115 [ 2 ] ^
V_1024 . V_1091 -> V_1112 . V_1115 [ 3 ] ^
V_1024 . V_1091 -> V_1113 . V_1115 [ 0 ] ^
V_1024 . V_1091 -> V_1113 . V_1115 [ 1 ] ^
V_1024 . V_1091 -> V_1113 . V_1115 [ 2 ] ^
V_1024 . V_1091 -> V_1113 . V_1115 [ 3 ] ;
break;
default:
break;
}
if ( V_1024 . V_1089 != F_539 ( V_95 ) )
V_1086 . V_1104 . V_1110 |= V_1116 ;
F_572 ( & V_172 -> V_2 -> V_14 ,
V_1086 , V_1088 , V_127 -> V_92 ) ;
}
static T_2 F_573 ( struct V_61 * V_80 , struct V_213 * V_95 ,
void * V_1117 , T_16 V_1118 )
{
struct V_665 * V_1119 = V_1117 ;
#ifdef F_181
struct V_1 * V_2 ;
struct V_986 * V_1120 ;
int V_1121 ;
#endif
if ( V_1119 )
return V_95 -> V_1122 + V_1119 -> V_673 ;
#ifdef F_181
switch ( F_574 ( V_95 ) ) {
case F_161 ( V_1123 ) :
case F_161 ( V_1124 ) :
...
break;
default:
return V_1118 ( V_80 , V_95 ) ;
}
V_1120 = & V_2 -> V_438 [ V_1125 ] ;
V_1121 = F_575 ( V_95 ) ? F_576 ( V_95 ) :
F_577 () ;
while ( V_1121 >= V_1120 -> V_465 )
V_1121 -= V_1120 -> V_465 ;
return V_1121 + V_1120 -> V_1050 ;
#else
return V_1118 ( V_80 , V_95 ) ;
#endif
}
T_17 F_578 ( struct V_213 * V_95 ,
struct V_1 * V_2 ,
struct V_64 * V_65 )
{
struct V_66 * V_1016 ;
int V_1126 ;
T_1 V_1040 = 0 ;
unsigned short V_1120 ;
T_2 V_94 = F_579 ( F_153 ( V_95 ) ) ;
T_12 V_269 = V_95 -> V_269 ;
T_4 V_256 = 0 ;
for ( V_1120 = 0 ; V_1120 < F_154 ( V_95 ) -> V_300 ; V_1120 ++ )
V_94 += F_579 ( F_154 ( V_95 ) -> V_282 [ V_1120 ] . V_294 ) ;
if ( F_559 ( V_65 , V_94 + 3 ) ) {
V_65 -> V_159 . V_833 ++ ;
return V_1127 ;
}
V_1016 = & V_65 -> V_84 [ V_65 -> V_86 ] ;
V_1016 -> V_95 = V_95 ;
V_1016 -> V_182 = V_95 -> V_88 ;
V_1016 -> V_183 = 1 ;
if ( F_580 ( V_95 ) ) {
V_1040 |= F_581 ( V_95 ) << V_1103 ;
V_1040 |= V_1053 ;
} else if ( V_269 == F_161 ( V_268 ) ) {
struct V_1128 * V_1129 , V_1130 ;
V_1129 = F_582 ( V_95 , V_527 , sizeof( V_1130 ) , & V_1130 ) ;
if ( ! V_1129 )
goto V_1131;
V_1040 |= F_583 ( V_1129 -> V_1132 ) <<
V_1103 ;
V_1040 |= V_1105 ;
}
V_269 = F_574 ( V_95 ) ;
if ( F_23 ( F_154 ( V_95 ) -> V_1040 & V_1133 ) &&
V_2 -> V_1134 &&
! F_584 ( V_1135 ,
& V_2 -> V_35 ) ) {
F_154 ( V_95 ) -> V_1040 |= V_1136 ;
V_1040 |= V_1069 ;
V_2 -> V_1137 = F_585 ( V_95 ) ;
V_2 -> V_1138 = V_186 ;
F_586 ( & V_2 -> V_1139 ) ;
}
F_587 ( V_95 ) ;
...
#endif
if ( ( V_2 -> V_146 & V_147 ) &&
( ( V_1040 & ( V_1053 | V_1105 ) ) ||
( V_95 -> V_1140 != V_1141 ) ) ) {
V_1040 &= ~ V_1142 ;
V_1040 |= ( V_95 -> V_1140 & 0x7 ) <<
V_1143 ;
if ( V_1040 & V_1105 ) {
struct V_1144 * V_1129 ;
if ( F_538 ( V_95 , 0 ) )
goto V_1131;
V_1129 = (struct V_1144 * ) V_95 -> V_98 ;
V_1129 -> V_1132 = F_161 ( V_1040 >>
V_1103 ) ;
} else {
V_1040 |= V_1053 ;
}
}
V_1016 -> V_1040 = V_1040 ;
V_1016 -> V_269 = V_269 ;
#ifdef F_181
if ( ( V_269 == F_161 ( V_1123 ) ) &&
( V_65 -> V_62 -> V_215 & ( V_1145 | V_1146 ) ) ) {
V_1126 = F_588 ( V_65 , V_1016 , & V_256 ) ;
if ( V_1126 < 0 )
goto V_1131;
goto V_1147;
}
#endif
V_1126 = F_536 ( V_65 , V_1016 , & V_256 ) ;
if ( V_1126 < 0 )
goto V_1131;
else if ( ! V_1126 )
F_549 ( V_65 , V_1016 ) ;
...
static T_17 F_589 ( struct V_213 * V_95 ,
struct V_61 * V_62 ,
struct V_64 * V_127 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
...
if ( F_590 ( V_95 , 17 ) )
return V_1148 ;
V_65 = V_127 ? V_127 : V_2 -> V_65 [ V_95 -> V_1122 ] ;
return F_578 ( V_95 , V_2 , V_65 ) ;
}
static T_17 F_591 ( struct V_213 * V_95 ,
struct V_61 * V_62 )
{
return F_589 ( V_95 , V_62 , NULL ) ;
}
static int F_592 ( struct V_61 * V_62 , void * V_1149 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
struct V_15 * V_14 = & V_2 -> V_14 ;
struct V_1150 * V_591 = V_1149 ;
if ( ! F_381 ( V_591 -> V_1151 ) )
return - V_1152 ;
memcpy ( V_62 -> V_678 , V_591 -> V_1151 , V_62 -> V_1153 ) ;
memcpy ( V_14 -> V_114 . V_591 , V_591 -> V_1151 , V_62 -> V_1153 ) ;
F_322 ( V_2 ) ;
return 0 ;
}
static int
F_593 ( struct V_61 * V_62 , int V_1154 , int V_1155 , T_2 V_591 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
struct V_15 * V_14 = & V_2 -> V_14 ;
T_2 V_4 ;
int V_1156 ;
if ( V_1154 != V_14 -> V_46 . V_1157 . V_1154 )
return - V_596 ;
V_1156 = V_14 -> V_46 . V_355 . V_1158 ( V_14 , V_591 , V_1155 , & V_4 ) ;
if ( ! V_1156 )
V_1156 = V_4 ;
return V_1156 ;
}
static int F_594 ( struct V_61 * V_62 , int V_1154 , int V_1155 ,
T_2 V_591 , T_2 V_4 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
struct V_15 * V_14 = & V_2 -> V_14 ;
if ( V_1154 != V_14 -> V_46 . V_1157 . V_1154 )
return - V_596 ;
return V_14 -> V_46 . V_355 . V_1159 ( V_14 , V_591 , V_1155 , V_4 ) ;
}
static int F_595 ( struct V_61 * V_62 , struct V_1160 * V_1161 , int V_1162 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
switch ( V_1162 ) {
case V_1163 :
return F_596 ( V_2 , V_1161 ) ;
case V_1164 :
return F_597 ( V_2 , V_1161 ) ;
default:
return F_598 ( & V_2 -> V_14 . V_46 . V_1157 , F_599 ( V_1161 ) , V_1162 ) ;
}
}
...
struct V_15 * V_14 = & V_2 -> V_14 ;
if ( F_381 ( V_14 -> V_114 . V_1165 ) ) {
F_466 () ;
V_17 = F_601 ( V_80 , V_14 -> V_114 . V_1165 , V_1166 ) ;
F_468 () ;
V_14 -> V_114 . V_355 . V_721 ( V_14 , F_288 ( 0 ) ) ;
}
return V_17 ;
...
int V_17 = 0 ;
struct V_1 * V_2 = F_93 ( V_80 ) ;
struct V_1167 * V_114 = & V_2 -> V_14 . V_114 ;
if ( F_381 ( V_114 -> V_1165 ) ) {
F_466 () ;
V_17 = F_603 ( V_80 , V_114 -> V_1165 , V_1166 ) ;
F_468 () ;
}
return V_17 ;
}
static void F_604 ( struct V_61 * V_62 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
int V_49 ;
if ( F_14 ( V_34 , & V_2 -> V_35 ) )
...
static struct V_1168 * F_605 ( struct V_61 * V_62 ,
struct V_1168 * V_131 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
int V_49 ;
...
if ( V_127 ) {
do {
V_1169 = F_607 ( & V_127 -> V_184 ) ;
V_151 = V_127 -> V_131 . V_151 ;
V_185 = V_127 -> V_131 . V_185 ;
} while ( F_608 ( & V_127 -> V_184 , V_1169 ) );
V_131 -> V_838 += V_151 ;
V_131 -> V_837 += V_185 ;
}
}
...
V_131 -> V_952 = V_62 -> V_131 . V_952 ;
return V_131 ;
}
static void F_610 ( struct V_1 * V_2 , T_4 V_141 )
{
struct V_15 * V_14 = & V_2 -> V_14 ;
T_1 V_3 , V_1170 ;
int V_49 ;
if ( V_14 -> V_114 . type == V_115 )
return;
V_3 = F_40 ( V_14 , V_1171 ) ;
V_1170 = V_3 ;
for ( V_49 = 0 ; V_49 < V_649 ; V_49 ++ ) {
T_4 V_1172 = V_3 >> ( V_49 * V_1173 ) ;
if ( V_1172 > V_141 )
V_3 &= ~ ( 0x7 << V_1173 ) ;
}
if ( V_3 != V_1170 )
F_75 ( V_14 , V_1171 , V_3 ) ;
return;
}
static void F_611 ( struct V_1 * V_2 )
{
struct V_61 * V_80 = V_2 -> V_62 ;
struct V_1174 * V_143 = & V_2 -> V_143 ;
struct V_1175 * V_1176 = V_2 -> V_634 ;
T_4 V_1177 ;
for ( V_1177 = 0 ; V_1177 < V_1178 ; V_1177 ++ ) {
T_4 V_141 = 0 ;
if ( V_2 -> V_630 & V_631 )
V_141 = F_612 ( V_143 , 0 , V_1177 ) ;
else if ( V_1176 )
V_141 = V_1176 -> V_635 [ V_1177 ] ;
F_613 ( V_80 , V_1177 , V_141 ) ;
}
}
int F_614 ( struct V_61 * V_80 , T_4 V_141 )
{
struct V_1 * V_2 = F_93 ( V_80 ) ;
struct V_15 * V_14 = & V_2 -> V_14 ;
bool V_1179 ;
if ( V_141 > V_2 -> V_143 . V_730 . V_731 )
return - V_596 ;
if ( V_14 -> V_114 . type == V_115 && V_141 && V_141 < V_649 )
return - V_596 ;
V_1179 = ( F_615 ( & V_2 -> V_675 , 32 ) > 1 ) ;
if ( V_141 && V_1179 && V_2 -> V_676 > V_1180 )
return - V_802 ;
if ( F_61 ( V_80 ) )
F_456 ( V_80 ) ;
else
...
V_2 -> V_146 |= V_147 ;
if ( V_2 -> V_14 . V_114 . type == V_115 ) {
V_2 -> V_1181 = V_2 -> V_14 . V_132 . V_779 ;
V_2 -> V_14 . V_132 . V_779 = V_1182 ;
}
} else {
F_617 ( V_80 ) ;
if ( V_2 -> V_14 . V_114 . type == V_115 )
V_2 -> V_14 . V_132 . V_779 = V_2 -> V_1181 ;
V_2 -> V_146 &= ~ V_147 ;
V_2 -> V_746 . V_144 = false ;
V_2 -> V_143 . V_144 = false ;
}
F_610 ( V_2 , V_141 ) ;
#endif
...
{
T_1 V_1185 = V_1184 -> V_1186 . V_1187 ;
T_1 V_1188 = F_619 ( V_1184 -> V_1186 . V_1187 ) ;
T_1 V_1189 = V_1184 -> V_1186 . V_1187 & 0xfffff ;
int V_17 = 0 , V_49 , V_56 ;
struct V_1190 * V_1191 = NULL ;
if ( V_1189 > V_1192 )
return - V_596 ;
if ( ( V_1188 != 0x800 ) && ( V_1188 >= V_773 ) )
return - V_596 ;
if ( V_1188 != 0x800 ) {
V_1191 = V_2 -> V_769 [ V_1188 ] ;
if ( ! V_1191 )
return - V_596 ;
if ( ! F_14 ( V_1189 - 1 , V_1191 -> V_1193 ) )
return - V_596 ;
F_37 ( V_1189 - 1 , V_1191 -> V_1193 ) ;
}
for ( V_49 = 1 ; V_49 < V_773 ; V_49 ++ ) {
V_1191 = V_2 -> V_769 [ V_49 ] ;
if ( V_1191 && V_1191 -> V_1194 == V_1185 ) {
for ( V_56 = 0 ; V_56 < V_1192 ; V_56 ++ ) {
if ( ! F_14 ( V_56 , V_1191 -> V_1193 ) )
continue;
F_364 ( & V_2 -> V_659 ) ;
V_17 = F_620 ( V_2 ,
NULL ,
...
struct V_1183 * V_1184 )
{
T_1 V_1188 = F_619 ( V_1184 -> V_1195 . V_1187 ) ;
if ( V_1188 >= V_773 )
return - V_596 ;
if ( V_1184 -> V_1195 . V_1196 > 0 )
return - V_596 ;
F_97 ( V_1188 - 1 , & V_2 -> V_1197 ) ;
return 0 ;
}
...
if ( V_1188 >= V_773 )
return - V_596 ;
F_37 ( V_1188 - 1 , & V_2 -> V_1197 ) ;
return 0 ;
}
static int F_623 ( struct V_61 * V_101 , void * V_1198 )
{
if ( F_383 ( V_101 ) ) {
struct V_679 * V_680 = F_93 ( V_101 ) ;
struct V_665 * V_666 = V_680 -> V_681 ;
struct V_1199 * V_98 = V_1198 ;
struct V_1 * V_2 = V_98 -> V_2 ;
int V_1200 = V_98 -> V_1200 ;
if ( V_666 && V_666 -> V_62 -> V_1200 == V_1200 ) {
V_98 -> V_110 = V_2 -> V_74 [ V_666 -> V_668 ] -> V_156 ;
V_98 -> V_663 = V_98 -> V_110 ;
return 1 ;
}
}
return 0 ;
}
static int F_624 ( struct V_1 * V_2 , int V_1200 ,
T_4 * V_110 , T_6 * V_663 )
{
unsigned int V_321 = V_2 -> V_321 , V_994 ;
struct V_1199 V_98 ;
struct V_61 * V_101 ;
for ( V_994 = 0 ; V_994 < V_321 ; ++ V_994 ) {
V_101 = F_459 ( V_2 -> V_523 [ V_994 ] . V_991 ) ;
if ( V_101 -> V_1200 == V_1200 ) {
if ( V_2 -> V_676 > 1 )
* V_110 = V_994 * 2 ;
else
* V_110 = V_994 * V_2 -> V_667 ;
* V_663 = V_994 + 1 ;
* V_663 <<= V_1201 ;
return 0 ;
}
...
struct V_1202 * V_1203 , T_6 * V_663 , T_4 * V_110 )
{
const struct V_1204 * V_71 ;
F_626 ( V_1205 ) ;
int V_17 ;
if ( F_627 ( V_1203 ) )
return - V_596 ;
F_628 ( V_1203 , & V_1205 ) ;
F_629 (a, &actions, list) {
if ( F_630 ( V_71 ) ) {
* V_663 = V_664 ;
* V_110 = V_664 ;
return 0 ;
...
if ( F_631 ( V_71 ) ) {
int V_1200 = F_632 ( V_71 ) ;
V_17 = F_624 ( V_2 , V_1200 , V_110 ,
V_663 ) ;
if ( V_17 == 0 )
return V_17 ;
}
...
static int F_633 ( struct V_657 * V_1086 ,
union V_1206 * V_124 ,
struct V_1183 * V_1184 ,
struct V_1207 * V_1208 ,
struct V_1209 * V_1210 )
{
int V_49 , V_56 , V_1211 ;
T_18 V_1212 , V_1213 ;
bool V_1214 = false , V_1215 = false ;
for ( V_49 = 0 ; V_49 < V_1184 -> V_1186 . V_1216 -> V_1217 ; V_49 ++ ) {
V_1211 = V_1184 -> V_1186 . V_1216 -> V_1218 [ V_49 ] . V_1211 ;
V_1212 = V_1184 -> V_1186 . V_1216 -> V_1218 [ V_49 ] . V_1212 ;
V_1213 = V_1184 -> V_1186 . V_1216 -> V_1218 [ V_49 ] . V_124 ;
for ( V_56 = 0 ; V_1208 [ V_56 ] . V_1212 ; V_56 ++ ) {
if ( V_1208 [ V_56 ] . V_1211 == V_1211 ) {
V_1208 [ V_56 ] . V_1212 ( V_1086 , V_124 , V_1212 , V_1213 ) ;
V_1086 -> V_658 . V_1104 . V_1110 |=
V_1208 [ V_56 ] . type ;
V_1214 = true ;
break;
}
...
if ( V_1210 ) {
if ( V_1210 -> V_1211 == V_1184 -> V_1186 . V_1216 -> V_1218 [ V_49 ] . V_1211 &&
V_1210 -> V_1212 == V_1184 -> V_1186 . V_1216 -> V_1218 [ V_49 ] . V_1212 &&
V_1210 -> V_124 == V_1184 -> V_1186 . V_1216 -> V_1218 [ V_49 ] . V_124 )
V_1215 = true ;
else
continue;
}
...
if ( ! V_1214 )
return 0 ;
V_124 -> V_1104 . V_1110 = V_1219 |
V_1220 ;
if ( V_1086 -> V_658 . V_1104 . V_1110 == V_1221 )
V_124 -> V_1104 . V_1110 &= V_1219 ;
return 0 ;
}
...
struct V_15 * V_14 = & V_2 -> V_14 ;
struct V_1207 * V_1208 ;
struct V_657 * V_1086 = NULL ;
union V_1206 * V_124 = NULL ;
struct V_1190 * V_1191 = NULL ;
int V_49 , V_17 = - V_596 ;
T_4 V_110 ;
T_1 V_1188 , V_1222 ;
V_1188 = F_619 ( V_1184 -> V_1186 . V_1187 ) ;
V_1222 = F_619 ( V_1184 -> V_1186 . V_1223 ) ;
if ( V_269 != F_161 ( V_1060 ) )
return V_17 ;
if ( V_1189 >= ( ( 1024 << V_2 -> V_652 ) - 2 ) ) {
F_108 ( V_162 , L_135 ) ;
return V_17 ;
}
if ( V_1188 == 0x800 ) {
V_1208 = ( V_2 -> V_769 [ 0 ] ) -> V_771 ;
} else {
if ( V_1188 >= V_773 )
return V_17 ;
if ( ! V_2 -> V_769 [ V_1188 ] )
return V_17 ;
V_1208 = ( V_2 -> V_769 [ V_1188 ] ) -> V_771 ;
}
if ( ! V_1208 )
return V_17 ;
if ( V_1222 ) {
struct V_1209 * V_1210 = V_1224 ;
if ( V_1222 >= V_773 )
return V_17 ;
if ( ! F_14 ( V_1222 - 1 , & V_2 -> V_1197 ) )
return V_17 ;
if ( V_2 -> V_769 [ V_1222 ] &&
( V_2 -> V_769 [ V_1222 ] ) -> V_1194 ) {
F_108 ( V_162 , L_136 ,
V_1222 ) ;
return V_17 ;
}
for ( V_49 = 0 ; V_1210 [ V_49 ] . V_1191 ; V_49 ++ ) {
if ( V_1210 [ V_49 ] . V_1225 != V_1184 -> V_1186 . V_1216 -> V_1226 ||
V_1210 [ V_49 ] . V_1227 != V_1184 -> V_1186 . V_1216 -> V_1228 ||
V_1210 [ V_49 ] . V_1213 != V_1184 -> V_1186 . V_1216 -> V_1229 )
return V_17 ;
V_1191 = F_426 ( sizeof( * V_1191 ) , V_770 ) ;
if ( ! V_1191 )
return - V_584 ;
V_1086 = F_426 ( sizeof( * V_1086 ) , V_770 ) ;
if ( ! V_1086 ) {
V_17 = - V_584 ;
goto V_1230;
}
V_124 = F_426 ( sizeof( * V_124 ) , V_770 ) ;
if ( ! V_124 ) {
V_17 = - V_584 ;
goto V_1231;
}
V_1191 -> V_1086 = V_1086 ;
V_1191 -> V_124 = V_124 ;
V_1191 -> V_1194 = V_1184 -> V_1186 . V_1187 ;
V_17 = F_633 ( V_1086 , V_124 , V_1184 ,
V_1208 , & V_1210 [ V_49 ] ) ;
if ( ! V_17 ) {
V_1191 -> V_771 = V_1210 [ V_49 ] . V_1191 ;
V_2 -> V_769 [ V_1222 ] = V_1191 ;
break;
}
}
return 0 ;
...
if ( ( V_1188 != 0x800 ) && ( V_2 -> V_769 [ V_1188 ] ) ) {
if ( ( V_2 -> V_769 [ V_1188 ] ) -> V_1086 )
memcpy ( V_1086 , ( V_2 -> V_769 [ V_1188 ] ) -> V_1086 ,
sizeof( * V_1086 ) ) ;
if ( ( V_2 -> V_769 [ V_1188 ] ) -> V_124 )
memcpy ( V_124 , ( V_2 -> V_769 [ V_1188 ] ) -> V_124 ,
sizeof( * V_124 ) ) ;
for ( V_49 = 1 ; V_49 < V_773 ; V_49 ++ ) {
struct V_1190 * V_394 = V_2 -> V_769 [ V_49 ] ;
if ( V_394 && ( F_14 ( V_1189 - 1 , V_394 -> V_1193 ) ) ) {
F_108 ( V_162 , L_137 ,
V_1189 ) ;
V_17 = - V_596 ;
goto V_1232;
...
V_17 = F_633 ( V_1086 , V_124 , V_1184 , V_1208 , NULL ) ;
if ( V_17 )
goto V_1232;
V_17 = F_625 ( V_2 , V_1184 -> V_1186 . V_1203 , & V_1086 -> V_663 ,
& V_110 ) ;
if ( V_17 < 0 )
goto V_1232;
V_1086 -> V_662 = V_1189 ;
...
F_635 ( & V_1086 -> V_658 , V_124 ) ;
V_17 = F_368 ( V_14 , & V_1086 -> V_658 ,
V_1086 -> V_662 , V_110 ) ;
if ( ! V_17 )
F_620 ( V_2 , V_1086 , V_1086 -> V_662 ) ;
F_369 ( & V_2 -> V_659 ) ;
if ( ( V_1188 != 0x800 ) && ( V_2 -> V_769 [ V_1188 ] ) )
F_97 ( V_1189 - 1 , ( V_2 -> V_769 [ V_1188 ] ) -> V_1193 ) ;
F_249 ( V_124 ) ;
return V_17 ;
V_1233:
F_369 ( & V_2 -> V_659 ) ;
...
static int F_636 ( struct V_61 * V_80 , T_1 V_1187 , T_12 V_560 ,
struct V_1234 * V_141 )
{
struct V_1 * V_2 = F_93 ( V_80 ) ;
if ( F_637 ( V_1187 ) == F_637 ( V_1235 ) &&
V_141 -> type == V_1236 ) {
switch ( V_141 -> V_1237 -> V_1238 ) {
case V_1239 :
case V_1240 :
return F_634 ( V_2 ,
V_560 , V_141 -> V_1237 ) ;
case V_1241 :
return F_618 ( V_2 , V_141 -> V_1237 ) ;
case V_1242 :
case V_1243 :
return F_621 ( V_2 , V_560 ,
V_141 -> V_1237 ) ;
case V_1244 :
return F_622 ( V_2 ,
V_141 -> V_1237 ) ;
...
if ( V_141 -> type != V_1245 )
return - V_596 ;
return F_614 ( V_80 , V_141 -> V_141 ) ;
}
void F_638 ( struct V_1 * V_2 )
{
struct V_61 * V_62 = V_2 -> V_62 ;
F_466 () ;
F_614 ( V_62 , F_262 ( V_62 ) ) ;
F_468 () ;
}
void F_639 ( struct V_61 * V_62 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
if ( F_61 ( V_62 ) )
F_398 ( V_2 ) ;
...
static T_13 F_640 ( struct V_61 * V_62 ,
T_13 V_215 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
if ( ! ( V_215 & V_232 ) )
...
static int F_641 ( struct V_61 * V_62 ,
T_13 V_215 )
{
struct V_1 * V_2 = F_93 ( V_62 ) ;
T_13 V_1247 = V_62 -> V_215 ^ V_215 ;
bool V_1248 = false ;
if ( ! ( V_215 & V_1246 ) ) {
if ( V_2 -> V_349 & V_539 )
V_1248 = true ;
V_2 -> V_349 &= ~ V_539 ;
} else if ( ( V_2 -> V_349 & V_761 ) &&
! ( V_2 -> V_349 & V_539 ) ) {
if ( V_2 -> V_404 == 1 ||
V_2 -> V_404 > V_1249 ) {
V_2 -> V_349 |= V_539 ;
V_1248 = true ;
} else if ( ( V_1247 ^ V_215 ) & V_1246 ) {
F_110 ( V_187 , L_138
L_139 ) ;
}
}
if ( ( V_215 & V_1250 ) || ( V_215 & V_1251 ) ) {
if ( ! ( V_2 -> V_146 & V_651 ) )
V_1248 = true ;
V_2 -> V_146 &= ~ V_387 ;
V_2 -> V_146 |= V_651 ;
...
if ( V_1248 )
F_639 ( V_62 ) ;
else if ( V_1247 & ( V_264 |
V_616 ) )
F_335 ( V_62 ) ;
return 0 ;
}
static void F_642 ( struct V_61 * V_80 ,
struct V_1253 * V_407 )
{
struct V_1 * V_2 = F_93 ( V_80 ) ;
struct V_15 * V_14 = & V_2 -> V_14 ;
T_12 V_1106 = V_407 -> V_1106 ;
T_1 V_1254 = 0 ;
T_1 V_3 ;
if ( V_407 -> V_1255 != V_1256 )
return;
switch ( V_407 -> type ) {
case V_1257 :
if ( ! ( V_2 -> V_146 & V_622 ) )
...
V_3 = F_40 ( V_14 , V_624 ) | F_583 ( V_1106 ) << V_1254 ;
F_75 ( V_14 , V_624 , V_3 ) ;
}
...
static int F_645 ( struct V_1260 * V_1261 , struct V_1262 * V_1263 [] ,
struct V_61 * V_80 ,
const unsigned char * V_591 , T_2 V_266 ,
T_2 V_146 )
{
if ( F_646 ( V_591 ) || F_647 ( V_591 ) ) {
struct V_1 * V_2 = F_93 ( V_80 ) ;
T_2 V_497 = F_288 ( 0 ) ;
if ( F_329 ( V_80 ) >= F_321 ( V_2 , V_497 ) )
return - V_584 ;
}
return F_648 ( V_1261 , V_1263 , V_80 , V_591 , V_266 , V_146 ) ;
}
static int F_649 ( struct V_1 * V_2 ,
T_19 V_1264 )
{
struct V_15 * V_14 = & V_2 -> V_14 ;
unsigned int V_1149 , V_1265 ;
T_1 V_506 ;
switch ( V_1264 ) {
case V_1266 :
F_75 ( & V_2 -> V_14 , V_514 , 0 ) ;
V_506 = F_40 ( V_14 , V_1267 ) ;
V_506 |= V_511 ;
F_75 ( V_14 , V_1267 , V_506 ) ;
V_1265 = V_2 -> V_321 + V_2 -> V_676 ;
for ( V_1149 = 0 ; V_1149 < V_1265 ; V_1149 ++ ) {
if ( V_14 -> V_114 . V_355 . V_1268 )
V_14 -> V_114 . V_355 . V_1268 ( V_14 ,
true ,
V_1149 ) ;
}
break;
...
V_2 -> V_512 = V_1264 ;
F_110 ( V_162 , L_144 ,
V_1264 == V_1266 ? L_145 : L_146 ) ;
return 0 ;
}
static int F_650 ( struct V_61 * V_80 ,
struct V_1269 * V_1270 , T_2 V_146 )
{
struct V_1 * V_2 = F_93 ( V_80 ) ;
struct V_1262 * V_1271 , * V_1272 ;
int V_1273 ;
if ( ! ( V_2 -> V_146 & V_433 ) )
return - V_1274 ;
V_1272 = F_651 ( V_1270 , sizeof( struct V_1275 ) , V_1276 ) ;
if ( ! V_1272 )
return - V_596 ;
F_652 (attr, br_spec, rem) {
int V_180 ;
T_19 V_1264 ;
if ( F_653 ( V_1271 ) != V_1277 )
continue;
if ( F_654 ( V_1271 ) < sizeof( V_1264 ) )
return - V_596 ;
V_1264 = F_655 ( V_1271 ) ;
V_180 = F_649 ( V_2 , V_1264 ) ;
if ( V_180 )
return V_180 ;
break;
}
...
static int F_656 ( struct V_213 * V_95 , T_1 V_1278 , T_1 V_1279 ,
struct V_61 * V_80 ,
T_1 V_1280 , int V_1281 )
{
struct V_1 * V_2 = F_93 ( V_80 ) ;
if ( ! ( V_2 -> V_146 & V_433 ) )
return 0 ;
return F_657 ( V_95 , V_1278 , V_1279 , V_80 ,
V_2 -> V_512 , 0 , 0 , V_1281 ,
V_1280 , NULL ) ;
}
static void * F_658 ( struct V_61 * V_9 , struct V_61 * V_669 )
{
struct V_665 * V_1119 = NULL ;
struct V_1 * V_2 = F_93 ( V_9 ) ;
int V_1282 = V_2 -> V_321 + V_2 -> V_676 ;
unsigned int V_760 ;
int V_497 , V_17 ;
if ( V_1282 >= V_1283 )
return F_659 ( - V_596 ) ;
...
( V_2 -> V_676 > V_1285 ) )
return F_659 ( - V_802 ) ;
V_1119 = F_426 ( sizeof( * V_1119 ) , V_770 ) ;
if ( ! V_1119 )
return F_659 ( - V_584 ) ;
V_497 = F_615 ( & V_2 -> V_675 , 32 ) ;
V_2 -> V_676 ++ ;
F_97 ( V_497 , & V_2 -> V_675 ) ;
V_760 = F_661 ( & V_2 -> V_675 , 32 ) ;
V_2 -> V_146 |= V_573 | V_433 ;
V_2 -> V_438 [ V_439 ] . V_760 = V_760 + 1 ;
V_2 -> V_438 [ V_453 ] . V_760 = V_669 -> V_83 ;
V_17 = F_614 ( V_9 , F_262 ( V_9 ) ) ;
if ( V_17 )
goto V_1286;
V_1119 -> V_497 = V_497 ;
V_1119 -> V_155 = V_2 ;
if ( F_61 ( V_9 ) ) {
V_17 = F_377 ( V_669 , V_1119 ) ;
if ( V_17 )
goto V_1286;
F_662 ( V_669 ) ;
}
...
static void F_663 ( struct V_61 * V_9 , void * V_1287 )
{
struct V_665 * V_1119 = V_1287 ;
struct V_1 * V_2 = V_1119 -> V_155 ;
unsigned int V_760 ;
F_37 ( V_1119 -> V_497 , & V_2 -> V_675 ) ;
V_2 -> V_676 -- ;
V_760 = F_661 ( & V_2 -> V_675 , 32 ) ;
V_2 -> V_438 [ V_439 ] . V_760 = V_760 + 1 ;
F_375 ( V_1119 -> V_62 , V_1119 ) ;
F_614 ( V_9 , F_262 ( V_9 ) ) ;
F_378 ( V_9 , L_91 ,
V_1119 -> V_497 , V_2 -> V_676 ,
V_1119 -> V_668 ,
V_1119 -> V_668 + V_2 -> V_667 ,
V_2 -> V_675 ) ;
F_249 ( V_1119 ) ;
}
static T_13
F_664 ( struct V_213 * V_95 , struct V_61 * V_80 ,
T_13 V_215 )
{
unsigned int V_1288 , V_1289 ;
V_1289 = F_539 ( V_95 ) - V_95 -> V_98 ;
if ( F_23 ( V_1289 > V_1290 ) )
return V_215 & ~ ( V_1291 |
V_1292 |
V_1293 |
V_1294 |
V_1295 ) ;
V_1288 = F_540 ( V_95 ) - F_539 ( V_95 ) ;
if ( F_23 ( V_1288 > V_1296 ) )
return V_215 & ~ ( V_1291 |
V_1292 |
V_1294 |
V_1295 ) ;
if ( V_95 -> V_234 && ! ( V_215 & V_1297 ) )
V_215 &= ~ V_1294 ;
return V_215 ;
}
static inline int F_665 ( struct V_1 * V_2 )
{
struct V_5 * V_409 , * V_9 = V_2 -> V_9 ;
int V_1298 = 0 ;
if ( F_8 ( & V_2 -> V_14 ) )
V_1298 = 4 ;
F_629 (entry, &adapter->pdev->bus->devices, bus_list) {
if ( V_409 -> V_1299 )
continue;
...
bool F_666 ( struct V_1 * V_2 , T_2 V_21 ,
T_2 V_1300 )
{
struct V_15 * V_14 = & V_2 -> V_14 ;
T_2 V_1301 = V_2 -> V_1302 & V_1303 ;
if ( V_14 -> V_114 . type == V_115 )
return false ;
if ( V_14 -> V_114 . type >= V_118 ) {
if ( ( V_1301 == V_1304 ) ||
...
static int F_667 ( struct V_5 * V_9 , const struct V_1324 * V_1325 )
{
struct V_61 * V_62 ;
struct V_1 * V_2 = NULL ;
struct V_15 * V_14 ;
const struct V_747 * V_748 = V_1326 [ V_1325 -> V_1327 ] ;
int V_49 , V_17 , V_1328 , V_24 ;
unsigned int V_465 = V_1329 ;
T_4 V_1330 [ V_1331 ] ;
bool V_1332 = false ;
#ifdef F_181
T_2 V_1333 ;
...
T_1 V_1334 ;
if ( V_9 -> V_1299 ) {
F_668 ( 1 , V_1335 L_150 ,
F_521 ( V_9 ) , V_9 -> V_752 , V_9 -> V_208 ) ;
return - V_596 ;
}
V_17 = F_463 ( V_9 ) ;
if ( V_17 )
return V_17 ;
if ( ! F_669 ( & V_9 -> V_80 , F_257 ( 64 ) ) ) {
V_1328 = 1 ;
} else {
V_17 = F_669 ( & V_9 -> V_80 , F_257 ( 32 ) ) ;
if ( V_17 ) {
F_439 ( & V_9 -> V_80 ,
L_151 ) ;
goto V_1336;
...
V_62 = F_672 ( sizeof( struct V_1 ) , V_465 ) ;
if ( ! V_62 ) {
V_17 = - V_584 ;
goto V_1340;
}
...
V_14 = & V_2 -> V_14 ;
V_14 -> V_40 = V_2 ;
V_2 -> V_1341 = F_674 ( V_1342 , V_1343 ) ;
V_14 -> V_41 = F_675 ( F_676 ( V_9 , 0 ) ,
F_677 ( V_9 , 0 ) ) ;
V_2 -> V_422 = V_14 -> V_41 ;
if ( ! V_14 -> V_41 ) {
V_17 = - V_793 ;
...
V_62 -> V_1345 = & V_1346 ;
F_678 ( V_62 ) ;
V_62 -> V_1347 = 5 * V_1011 ;
F_679 ( V_62 -> V_60 , F_521 ( V_9 ) , sizeof( V_62 -> V_60 ) ) ;
V_14 -> V_114 . V_355 = * V_748 -> V_1348 ;
V_14 -> V_114 . type = V_748 -> V_114 ;
V_14 -> V_1349 = V_748 -> V_1349 ;
if ( V_748 -> V_1350 )
V_14 -> V_394 . V_355 = * V_748 -> V_1350 ;
V_14 -> V_1351 . V_355 = * V_748 -> V_1352 ;
V_1334 = F_40 ( V_14 , F_680 ( V_14 ) ) ;
if ( F_22 ( V_14 -> V_41 ) ) {
V_17 = - V_793 ;
goto V_1344;
}
if ( ! ( V_1334 & F_206 ( 8 ) ) )
V_14 -> V_1351 . V_355 . V_253 = & V_1353 ;
V_14 -> V_46 . V_355 = * V_748 -> V_1354 ;
V_14 -> V_46 . V_1007 = V_1355 ;
V_14 -> V_46 . V_1157 . V_1154 = V_1356 ;
V_14 -> V_46 . V_1157 . V_1357 = 0 ;
V_14 -> V_46 . V_1157 . V_1358 = V_1359 | V_1360 ;
V_14 -> V_46 . V_1157 . V_80 = V_62 ;
V_14 -> V_46 . V_1157 . V_1361 = F_593 ;
V_14 -> V_46 . V_1157 . V_1362 = F_594 ;
V_17 = F_423 ( V_2 , V_748 ) ;
if ( V_17 )
goto V_1363;
if ( V_14 -> V_114 . V_355 . V_1364 )
V_14 -> V_114 . V_355 . V_1364 ( V_14 ) ;
switch ( V_2 -> V_14 . V_114 . type ) {
case V_117 :
case V_118 :
case V_119 :
...
if ( V_1365 )
V_14 -> V_1365 = V_1365 ;
V_14 -> V_46 . V_1366 = true ;
V_17 = V_14 -> V_114 . V_355 . V_1367 ( V_14 ) ;
V_14 -> V_46 . V_1366 = false ;
if ( V_17 == V_716 ) {
V_17 = 0 ;
} else if ( V_17 == V_717 ) {
F_18 ( L_153 ) ;
...
goto V_1368;
F_681 ( V_14 ) ;
V_14 -> V_1369 . V_355 = V_748 -> V_1370 ;
F_682 ( V_9 , V_785 ) ;
F_683 ( V_2 ) ;
V_1368:
#endif
...
if ( V_1328 )
V_62 -> V_215 |= V_1376 ;
V_62 -> V_1377 |= V_62 -> V_215 | V_1297 ;
V_62 -> V_1378 |= V_62 -> V_1377 ;
V_62 -> V_1379 |= V_1291 ;
V_62 -> V_215 |= V_616 |
V_264 |
V_1293 ;
...
V_62 -> V_1380 |= V_1382 ;
V_62 -> V_1383 = V_1384 ;
V_62 -> V_1385 = V_1386 - ( V_527 + V_528 ) ;
#ifdef F_387
if ( V_2 -> V_146 & V_744 )
V_62 -> V_1387 = & V_1387 ;
#endif
...
if ( V_2 -> V_146 & V_767 ) {
unsigned int V_1388 ;
if ( V_14 -> V_114 . V_355 . V_1389 ) {
V_14 -> V_114 . V_355 . V_1389 ( V_14 , & V_1333 ) ;
if ( V_1333 & V_1390 )
V_2 -> V_146 &= ~ V_767 ;
}
V_1388 = F_333 ( int , V_1391 , F_425 () ) ;
V_2 -> V_438 [ V_1125 ] . V_760 = V_1388 ;
V_62 -> V_215 |= V_1145 |
V_1146 ;
V_62 -> V_1377 |= V_1145 |
V_1146 |
...
if ( V_2 -> V_349 & V_539 )
V_62 -> V_215 |= V_1246 ;
if ( V_14 -> V_1351 . V_355 . V_1392 ( V_14 , NULL ) < 0 ) {
F_18 ( L_156 ) ;
V_17 = - V_793 ;
goto V_1363;
}
F_685 ( & V_2 -> V_9 -> V_80 ,
V_2 -> V_14 . V_114 . V_1393 ) ;
memcpy ( V_62 -> V_678 , V_14 -> V_114 . V_1393 , V_62 -> V_1153 ) ;
if ( ! F_381 ( V_62 -> V_678 ) ) {
F_18 ( L_157 ) ;
V_17 = - V_793 ;
goto V_1363;
}
F_325 ( V_14 -> V_114 . V_591 , V_14 -> V_114 . V_1393 ) ;
F_322 ( V_2 ) ;
F_686 ( & V_2 -> V_711 , & F_529 ,
( unsigned long ) V_2 ) ;
if ( F_22 ( V_14 -> V_41 ) ) {
V_17 = - V_793 ;
goto V_1363;
}
F_687 ( & V_2 -> V_39 , F_533 ) ;
F_97 ( V_42 , & V_2 -> V_35 ) ;
F_37 ( V_37 , & V_2 -> V_35 ) ;
V_17 = F_467 ( V_2 ) ;
if ( V_17 )
goto V_1363;
V_2 -> V_723 = 0 ;
V_14 -> V_1351 . V_355 . V_253 ( V_14 , 0x2c , & V_2 -> V_1302 ) ;
V_14 -> V_1394 = F_666 ( V_2 , V_9 -> V_208 ,
V_9 -> V_758 ) ;
if ( V_14 -> V_1394 )
V_2 -> V_723 = V_1395 ;
F_688 ( & V_2 -> V_9 -> V_80 , V_2 -> V_723 ) ;
V_14 -> V_1351 . V_355 . V_253 ( V_14 , 0x2e , & V_2 -> V_1396 ) ;
V_14 -> V_1351 . V_355 . V_253 ( V_14 , 0x2d , & V_2 -> V_1397 ) ;
if ( F_8 ( V_14 ) )
F_5 ( V_2 ) ;
else
V_14 -> V_114 . V_355 . V_1398 ( V_14 ) ;
switch ( V_14 -> V_114 . type ) {
case V_115 :
V_24 = F_243 ( F_665 ( V_2 ) * 10 , 16 ) ;
break;
default:
V_24 = F_665 ( V_2 ) * 10 ;
break;
...
if ( V_24 > 0 )
F_9 ( V_2 , V_24 ) ;
V_17 = F_689 ( V_14 , V_1330 , sizeof( V_1330 ) ) ;
if ( V_17 )
F_679 ( V_1330 , L_7 , sizeof( V_1330 ) ) ;
if ( F_218 ( V_14 ) && V_14 -> V_46 . V_1007 != V_1399 )
F_12 ( L_158 ,
V_14 -> V_114 . type , V_14 -> V_46 . type , V_14 -> V_46 . V_1007 ,
V_1330 ) ;
else
F_12 ( L_159 ,
V_14 -> V_114 . type , V_14 -> V_46 . type , V_1330 ) ;
F_12 ( L_160 , V_62 -> V_678 ) ;
V_17 = V_14 -> V_114 . V_355 . V_1400 ( V_14 ) ;
if ( V_17 == V_719 ) {
F_11 ( L_94
L_161
L_162
...
for ( V_49 = 0 ; V_49 < V_2 -> V_321 ; V_49 ++ )
F_692 ( V_9 , ( V_49 | 0x10000000 ) ) ;
}
if ( V_14 -> V_114 . V_355 . V_1402 )
V_14 -> V_114 . V_355 . V_1402 ( V_14 , 0xFF , 0xFF , 0xFF ,
0xFF ) ;
F_600 ( V_62 ) ;
F_12 ( L_71 , V_1403 ) ;
#ifdef F_693
...
#endif
F_695 ( V_2 ) ;
if ( F_696 ( V_14 ) && F_218 ( V_14 ) && V_14 -> V_114 . V_355 . V_689 )
V_14 -> V_114 . V_355 . V_689 ( V_14 ,
V_959 | V_984 ,
true ) ;
return 0 ;
V_1401:
...
static void F_701 ( struct V_5 * V_9 )
{
struct V_1 * V_2 = F_459 ( V_9 ) ;
struct V_61 * V_62 ;
bool V_1332 ;
...
F_700 ( V_9 ) ;
F_12 ( L_167 ) ;
for ( V_49 = 0 ; V_49 < V_773 ; V_49 ++ ) {
if ( V_2 -> V_769 [ V_49 ] ) {
F_249 ( V_2 -> V_769 [ V_49 ] -> V_1086 ) ;
F_249 ( V_2 -> V_769 [ V_49 ] -> V_124 ) ;
}
F_249 ( V_2 -> V_769 [ V_49 ] ) ;
}
F_249 ( V_2 -> V_586 ) ;
V_1332 = ! F_15 ( V_810 , & V_2 -> V_35 ) ;
F_699 ( V_62 ) ;
...
static T_20 F_707 ( struct V_5 * V_9 ,
T_21 V_35 )
{
struct V_1 * V_2 = F_459 ( V_9 ) ;
struct V_61 * V_62 = V_2 -> V_62 ;
#ifdef F_315
struct V_15 * V_14 = & V_2 -> V_14 ;
struct V_5 * V_1404 , * V_991 ;
T_1 V_1405 , V_1406 , V_1407 , V_1408 ;
int V_994 , V_1409 ;
T_2 V_1410 , V_1411 ;
if ( V_2 -> V_14 . V_114 . type == V_115 ||
V_2 -> V_321 == 0 )
goto V_1412;
V_1404 = V_9 -> V_10 -> V_12 ;
while ( V_1404 && ( F_708 ( V_1404 ) != V_1413 ) )
V_1404 = V_1404 -> V_10 -> V_12 ;
if ( ! V_1404 )
goto V_1412;
V_1409 = F_709 ( V_1404 , V_1414 ) ;
if ( ! V_1409 )
goto V_1412;
V_1405 = F_30 ( V_14 , V_1409 + V_1415 ) ;
V_1406 = F_30 ( V_14 , V_1409 + V_1415 + 4 ) ;
V_1407 = F_30 ( V_14 , V_1409 + V_1415 + 8 ) ;
V_1408 = F_30 ( V_14 , V_1409 + V_1415 + 12 ) ;
if ( F_22 ( V_14 -> V_41 ) )
goto V_1412;
V_1410 = V_1406 >> 16 ;
if ( ! ( V_1410 & 0x0080 ) )
goto V_1412;
V_1411 = V_1410 & 0x01 ;
if ( ( V_1411 & 1 ) == ( V_9 -> V_1416 & 1 ) ) {
unsigned int V_21 ;
V_994 = ( V_1410 & 0x7F ) >> 1 ;
F_18 ( L_168 , V_994 ) ;
F_18 ( L_169
L_170 ,
V_1405 , V_1406 , V_1407 , V_1408 ) ;
switch ( V_2 -> V_14 . V_114 . type ) {
case V_117 :
V_21 = V_1417 ;
break;
...
V_991 = F_710 ( V_1422 , V_21 , NULL ) ;
while ( V_991 ) {
if ( V_991 -> V_1416 == ( V_1410 & 0xFF ) )
break;
V_991 = F_710 ( V_1422 ,
V_21 , V_991 ) ;
}
...
static T_20 F_713 ( struct V_5 * V_9 )
{
struct V_1 * V_2 = F_459 ( V_9 ) ;
T_20 V_1428 ;
int V_17 ;
...
static void F_714 ( struct V_5 * V_9 )
{
struct V_1 * V_2 = F_459 ( V_9 ) ;
struct V_61 * V_62 = V_2 -> V_62 ;
#ifdef F_315
...
static int T_22 F_715 ( void )
{
int V_600 ;
F_54 ( L_175 , V_1429 , V_1430 ) ;
F_54 ( L_71 , V_1431 ) ;
V_38 = F_716 ( V_1337 ) ;
if ( ! V_38 ) {
F_55 ( L_176 , V_1337 ) ;
...
static int F_725 ( struct V_1434 * V_1435 , unsigned long V_209 ,
void * V_1149 )
{
int V_1436 ;
V_1436 = F_726 ( & V_1432 . V_1437 , NULL , & V_209 ,
F_129 ) ;
return V_1436 ? V_1438 : V_1439 ;
}
