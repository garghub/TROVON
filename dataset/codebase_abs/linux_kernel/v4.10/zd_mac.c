...
V_9 -> V_250 = 100 ;
V_9 -> V_251 = 1 ;
V_9 -> V_252 = sizeof( struct V_94 ) ;
V_9 -> V_253 = V_76 ;
V_9 -> V_254 = 18 ;
F_147 ( & V_11 -> V_46 ) ;
V_11 -> V_88 = 0 ;
F_148 ( & V_11 -> V_16 , V_9 , V_157 ) ;
F_149 ( V_11 ) ;
F_150 ( V_11 ) ;
F_151 ( & V_11 -> V_211 , F_130 ) ;
F_152 ( V_9 , & V_157 -> V_241 ) ;
return V_9 ;
}
static void F_153 ( struct V_208 * V_209 )
{
struct V_10 * V_11 =
F_131 ( V_209 , struct V_10 , V_47 . V_255 . V_209 ) ;
struct V_43 * V_47 ;
unsigned long V_256 ;
int V_53 , V_54 ;
if ( ! F_127 ( V_42 , & V_11 -> V_25 ) )
...
V_53 = V_11 -> V_47 . V_53 ;
V_54 = V_11 -> V_47 . V_54 ;
V_256 = V_11 -> V_47 . V_57 +
F_154 ( V_53 * 1024 / 1000 ) * 3 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_53 > 0 && F_155 ( V_256 ) ) {
F_58 ( F_6 ( V_11 ) , L_19
L_20
L_21 ,
V_53 , V_54 ) ;
...
V_257:
F_156 ( V_24 , & V_11 -> V_47 . V_255 ,
V_258 ) ;
}
static void F_150 ( struct V_10 * V_11 )
{
F_157 ( & V_11 -> V_47 . V_255 , F_153 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_158 ( & V_11 -> V_47 . V_255 ) ;
F_87 ( V_11 ) ;
}
static void F_159 ( struct V_208 * V_209 )
{
struct V_10 * V_11 =
F_131 ( V_209 , struct V_10 , V_259 . V_260 . V_209 ) ;
struct V_17 * V_16 = & V_11 -> V_16 ;
int V_261 ;
int V_13 ;
if ( ! F_127 ( V_42 , & V_11 -> V_25 ) )
...
V_262:
F_156 ( V_24 , & V_11 -> V_259 . V_260 ,
V_265 ) ;
}
static void F_149 ( struct V_10 * V_11 )
{
F_157 ( & V_11 -> V_259 . V_260 , F_159 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_158 ( & V_11 -> V_259 . V_260 ) ;
F_160 ( & V_11 -> V_16 , V_266 ) ;
}
