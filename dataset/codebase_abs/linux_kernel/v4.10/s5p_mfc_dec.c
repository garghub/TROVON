...
switch ( V_108 -> type ) {
case V_74 :
return F_38 ( & V_13 -> V_83 , V_108 , V_27 -> V_119 & V_120 ) ;
case V_58 :
V_80 = F_38 ( & V_13 -> V_84 , V_108 , V_27 -> V_119 & V_120 ) ;
if ( V_80 )
return V_80 ;
if ( V_13 -> V_15 == V_121 &&
( V_13 -> V_122 [ V_108 -> V_53 ] . V_123 & V_124 ) )
F_39 ( & V_13 -> V_125 , & V_117 ) ;
return 0 ;
default:
return - V_54 ;
}
...
struct V_12 * V_13 = F_13 ( V_28 ) ;
if ( V_127 -> type == V_74 )
return F_41 ( & V_13 -> V_83 , V_127 ) ;
if ( V_127 -> type == V_58 )
return F_41 ( & V_13 -> V_84 , V_127 ) ;
return - V_54 ;
}
...
F_14 () ;
if ( type == V_74 )
V_80 = F_43 ( & V_13 -> V_83 , type ) ;
else if ( type == V_58 )
V_80 = F_43 ( & V_13 -> V_84 , type ) ;
F_17 () ;
return V_80 ;
}
...
return F_45 ( & V_13 -> V_84 , type ) ;
return - V_54 ;
}
static int F_46 ( struct V_129 * V_130 )
{
struct V_12 * V_13 = F_47 ( V_130 ) ;
switch ( V_130 -> V_131 ) {
case V_132 :
...
F_3 ( 2 , L_31 ,
V_144 , V_146 , V_143 -> V_155 . V_61 , V_143 -> V_155 . V_63 , V_145 , V_147 ,
V_13 -> V_62 , V_13 -> V_64 ) ;
} else {
V_143 -> V_155 . V_144 = 0 ;
V_143 -> V_155 . V_146 = 0 ;
...
F_3 ( 2 , L_32 ,
V_143 -> V_155 . V_61 , V_143 -> V_155 . V_63 , V_13 -> V_62 ,
V_13 -> V_64 ) ;
}
return 0 ;
}
...
if ( ! F_20 ( & V_13 -> V_83 ) )
return - V_54 ;
F_51 ( & V_32 -> V_162 , V_123 ) ;
if ( F_52 ( & V_13 -> V_163 ) ) {
F_16 ( L_33 ) ;
V_13 -> V_15 = V_20 ;
if ( F_2 ( V_13 ) )
F_30 ( V_13 ) ;
F_53 ( & V_32 -> V_162 , V_123 ) ;
F_29 ( V_32 -> V_97 , V_103 , V_32 ) ;
} else {
F_16 ( L_34 ) ;
V_108 = F_54 ( V_13 -> V_163 . V_164 ,
struct V_160 , V_165 ) ;
...
static int F_55 ( struct V_167 * V_125 ,
const struct V_168 * V_169 )
{
switch ( V_169 -> type ) {
case V_118 :
return F_56 ( V_125 , V_169 , 2 , NULL ) ;
case V_170 :
return F_57 ( V_125 , V_169 ) ;
default:
return - V_54 ;
}
}
...
static int F_60 ( struct V_183 * V_184 )
{
struct V_185 * V_186 = F_61 ( V_184 ) ;
...
if ( F_65 ( V_184 , 0 ) < V_13 -> V_72 ||
F_65 ( V_184 , 1 ) < V_13 -> V_73 ) {
F_16 ( L_39 ) ;
return - V_54 ;
}
V_5 = V_184 -> V_53 ;
...
static int F_66 ( struct V_171 * V_194 , unsigned int V_92 )
{
...
static void F_68 ( struct V_171 * V_194 )
{
unsigned long V_123 ;
struct V_12 * V_13 = F_13 ( V_194 -> V_178 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
...
if ( V_194 -> type == V_58 ) {
F_69 ( & V_13 -> V_201 , & V_13 -> V_84 ) ;
F_70 ( & V_13 -> V_201 ) ;
V_13 -> V_18 = 0 ;
V_13 -> V_202 = 1 ;
V_13 -> V_203 = 0 ;
if ( F_59 ( V_32 ) && ( V_13 -> V_15 == V_17 ) ) {
V_13 -> V_15 = V_204 ;
F_30 ( V_13 ) ;
F_29 ( V_32 -> V_97 , V_103 , V_32 ) ;
F_53 ( & V_32 -> V_162 , V_123 ) ;
...
static void F_71 ( struct V_183 * V_184 )
{
struct V_171 * V_172 = V_184 -> V_171 ;
struct V_12 * V_13 = F_13 ( V_172 -> V_178 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
...
V_206 -> V_123 &= ~ V_166 ;
F_51 ( & V_32 -> V_162 , V_123 ) ;
F_73 ( V_184 -> V_53 , & V_13 -> V_203 ) ;
F_72 ( & V_206 -> V_165 , & V_13 -> V_201 ) ;
V_13 -> V_18 ++ ;
F_53 ( & V_32 -> V_162 , V_123 ) ;
} else {
F_16 ( L_44 , V_172 -> type ) ;
}
if ( F_2 ( V_13 ) )
F_30 ( V_13 ) ;
F_29 ( V_32 -> V_97 , V_103 , V_32 ) ;
}
const struct V_207 * F_74 ( void )
{
return & V_208 ;
}
struct V_209 * F_75 ( void )
{
return & V_210 ;
}
const struct V_211 * F_76 ( void )
{
return & V_212 ;
}
int F_77 ( struct V_12 * V_13 )
{
struct V_213 V_214 ;
int V_5 ;
F_78 ( & V_13 -> V_195 , V_215 ) ;
if ( V_13 -> V_195 . error ) {
F_16 ( L_45 ) ;
return V_13 -> V_195 . error ;
}
for ( V_5 = 0 ; V_5 < V_215 ; V_5 ++ ) {
if ( F_79 ( V_216 [ V_5 ] . V_131 ) ) {
...
V_13 -> V_227 [ V_5 ] = F_81 ( & V_13 -> V_195 ,
& V_218 ,
