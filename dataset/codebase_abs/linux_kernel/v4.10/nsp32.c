...
V_27 = V_11 -> V_28 ;
F_59 ( V_208 , L_61 ) ;
F_60 ( V_208 , L_62 , V_214 ) ;
F_60 ( V_208 , L_63 , V_209 ) ;
F_60 ( V_208 , L_64 , V_11 -> V_155 ) ;
F_60 ( V_208 , L_65 , V_11 -> V_28 , V_11 -> V_28 + V_11 -> V_215 - 1 ) ;
F_60 ( V_208 , L_66 , V_11 -> V_27 , V_11 -> V_27 + V_9 -> V_216 - 1 ) ;
F_60 ( V_208 , L_67 , V_11 -> V_217 ) ;
F_60 ( V_208 , L_68 , ( F_23 ( V_27 , V_218 ) >> 8 ) & 0xff ) ;
V_210 = F_61 ( V_27 , V_219 ) ;
V_212 = V_9 -> V_220 -> V_221 ;
#ifdef F_62
F_60 ( V_208 , L_69 , ( V_210 & V_222 ) ? L_70 : L_71 ) ;
#endif
F_60 ( V_208 , L_72 , ( V_210 & ( V_223 | V_224 ) ) , V_225 [ V_212 ] ) ;
F_46 ( & ( V_9 -> V_226 ) , V_163 ) ;
F_60 ( V_208 , L_73 , V_9 -> V_131 ) ;
F_56 ( & ( V_9 -> V_226 ) , V_163 ) ;
F_59 ( V_208 , L_74 ) ;
for ( V_130 = 0 ; V_130 < F_29 ( V_9 -> V_31 ) ; V_130 ++ ) {
F_60 ( V_208 , L_75 , V_130 ) ;
if ( V_130 == V_11 -> V_30 ) {
F_59 ( V_208 , L_76 ) ;
continue;
}
...
static void F_65 ( struct V_7 * V_8 , unsigned int V_232 )
{
T_2 * V_9 = ( T_2 * ) V_8 -> V_10 -> V_11 -> V_12 ;
int V_235 = V_9 -> V_236 ;
int V_237 ;
...
static void F_67 ( struct V_7 * V_8 , unsigned short V_80 )
{
T_2 * V_9 = ( T_2 * ) V_8 -> V_10 -> V_11 -> V_12 ;
unsigned int V_27 = V_9 -> V_157 ;
...
V_274 = F_69 ( V_9 , V_31 , V_272 ) ;
if ( V_274 < 0 ) {
goto V_257;
}
F_70 ( V_9 , V_31 , V_274 , V_273 ) ;
} else {
F_13 ( V_255 , L_101 ) ;
V_31 -> V_146 |= V_148 ;
if ( V_273 > V_276 ) {
...
* V_20 = V_276 ;
V_31 -> V_51 = F_71 ( V_278 , * V_20 ) ;
V_31 -> V_53 = V_53 ;
V_31 -> V_20 = * V_20 ;
V_31 -> V_55 = 0 ;
}
static void F_70 ( T_2 * V_9 ,
T_7 * V_31 ,
int V_274 ,
unsigned char V_20 )
{
...
F_9 ( V_24 , L_108 , V_287 ) ;
}
static void F_66 ( T_2 * V_9 , int V_284 )
{
unsigned int V_27 = V_9 -> V_157 ;
int V_285 = 0 ;
...
static int F_73 ( struct V_298 * V_299 )
{
struct V_165 * V_11 ;
struct V_300 * V_301 ;
T_2 * V_9 ;
...
if ( F_76 ( V_299 , F_77 ( 32 ) ) != 0 ) {
F_9 ( V_45 , L_112 ) ;
goto V_317;
}
V_9 -> V_33 = F_78 ( V_299 , sizeof( T_3 ) , & ( V_9 -> V_76 ) ) ;
if ( V_9 -> V_33 == NULL ) {
F_9 ( V_45 , L_113 ) ;
goto V_317;
}
V_9 -> V_318 = F_78 ( V_299 , V_319 ,
& ( V_9 -> V_320 ) ) ;
if ( V_9 -> V_318 == NULL ) {
F_9 ( V_45 , L_113 ) ;
goto V_321;
...
F_47 ( V_9 ) ;
V_36 = F_81 ( V_11 -> V_155 , F_45 , V_326 , L_115 , V_9 ) ;
if ( V_36 < 0 ) {
F_9 ( V_45 , L_116
L_117 , V_11 -> V_155 ) ;
goto V_327;
}
V_301 = F_82 ( V_11 -> V_28 , V_11 -> V_215 , L_115 ) ;
if ( V_301 == NULL ) {
F_9 ( V_45 ,
L_118 ,
V_9 -> V_157 , V_9 -> V_309 ) ;
...
static int F_89 ( struct V_165 * V_11 )
{
T_2 * V_9 = ( T_2 * ) V_11 -> V_12 ;
if ( V_9 -> V_33 ) {
F_87 ( V_9 -> V_331 , sizeof( T_3 ) ,
V_9 -> V_33 , V_9 -> V_76 ) ;
}
if ( V_9 -> V_318 ) {
F_87 ( V_9 -> V_331 , V_319 ,
V_9 -> V_318 , V_9 -> V_320 ) ;
}
if ( V_11 -> V_155 ) {
V_328 ( V_11 -> V_155 , V_9 ) ;
...
static const char * F_91 ( struct V_165 * V_332 )
{
...
T_2 * V_9 = ( T_2 * ) V_8 -> V_10 -> V_11 -> V_12 ;
unsigned int V_27 = V_8 -> V_10 -> V_11 -> V_28 ;
F_94 ( V_8 -> V_10 -> V_11 -> V_167 ) ;
F_9 ( V_173 , L_123 ) ;
F_13 ( V_333 , L_124 , V_8 ) ;
F_20 ( V_27 , V_82 , V_83 ) ;
F_47 ( V_9 ) ;
F_20 ( V_27 , V_82 , 0 ) ;
F_95 ( V_8 -> V_10 -> V_11 -> V_167 ) ;
return V_336 ;
}
...
static int F_99 ( T_2 * V_9 )
{
int V_36 , V_35 ;
T_7 * V_31 ;
int V_274 , V_341 ;
V_9 -> V_324 = F_98 ( V_9 , 0x11 ) ;
for ( V_35 = 0 ; V_35 < V_349 ; V_35 ++ ) {
V_31 = & V_9 -> V_31 [ V_35 ] ;
V_36 = F_98 ( V_9 , V_35 ) ;
switch ( V_36 ) {
...
static int F_98 ( T_2 * V_9 , int V_350 )
{
int V_35 , V_341 ;
F_101 ( V_9 ) ;
F_102 ( V_9 , 1 ) ;
...
V_341 = 0 ;
for ( V_35 = 7 ; V_35 >= 0 ; V_35 -- ) {
V_341 += ( F_103 ( V_9 ) << V_35 ) ;
}
F_102 ( V_9 , 1 ) ;
F_104 ( V_9 ) ;
return V_341 ;
}
static void F_105 ( T_2 * V_9 , int V_351 , int V_341 )
{
int V_27 = V_9 -> V_157 ;
int V_322 ;
V_322 = F_61 ( V_27 , V_352 ) ;
if ( V_341 == 0 ) {
V_322 &= ~ V_351 ;
} else {
V_322 |= V_351 ;
...
static int F_106 ( T_2 * V_9 , int V_351 )
{
int V_27 = V_9 -> V_157 ;
int V_322 , V_36 ;
if ( V_351 != V_353 ) {
...
static void F_102 ( T_2 * V_9 , int V_341 )
{
F_105 ( V_9 , V_353 , V_341 ) ;
F_105 ( V_9 , V_354 , 1 ) ;
F_105 ( V_9 , V_354 , 0 ) ;
}
static int F_103 ( T_2 * V_9 )
{
int V_341 ;
F_105 ( V_9 , V_355 , 0 ) ;
F_105 ( V_9 , V_354 , 1 ) ;
V_341 = F_106 ( V_9 , V_353 ) ;
F_105 ( V_9 , V_354 , 0 ) ;
F_105 ( V_9 , V_355 , 1 ) ;
return V_341 ;
}
static int F_107 ( struct V_298 * V_299 , T_11 V_284 )
{
struct V_165 * V_11 = F_108 ( V_299 ) ;
F_9 ( V_173 , L_133 , V_299 , V_284 , F_109 ( V_299 ) , V_11 ) ;
F_110 ( V_299 ) ;
F_111 ( V_299 ) ;
F_112 ( V_299 , F_113 ( V_299 , V_284 ) ) ;
return 0 ;
}
static int F_114 ( struct V_298 * V_299 )
{
struct V_165 * V_11 = F_108 ( V_299 ) ;
T_2 * V_9 = ( T_2 * ) V_11 -> V_12 ;
unsigned short V_356 ;
F_9 ( V_173 , L_134 , V_299 , F_109 ( V_299 ) , V_11 ) ;
F_112 ( V_299 , V_357 ) ;
F_115 ( V_299 , V_357 , 0 ) ;
F_116 ( V_299 ) ;
V_356 = F_23 ( V_9 -> V_157 , V_218 ) ;
F_9 ( V_173 , L_135 , V_9 -> V_157 , V_356 ) ;
if ( V_356 == 0xffff ) {
F_9 ( V_173 , L_136 ) ;
return 0 ;
}
...
static int F_117 ( struct V_298 * V_299 , const struct V_358 * V_130 )
{
int V_36 ;
T_2 * V_9 = & V_306 ;
F_13 ( V_303 , L_14 ) ;
...
V_9 -> V_157 = F_119 ( V_299 , 0 ) ;
V_9 -> V_309 = F_120 ( V_299 , 0 ) ;
V_9 -> V_310 = F_121 ( V_299 , 1 ) ;
V_9 -> V_216 = F_120 ( V_299 , 1 ) ;
F_122 ( V_299 ) ;
V_36 = F_73 ( V_299 ) ;
F_9 ( V_173 , L_139 ,
V_299 -> V_155 ,
...
F_109 ( V_299 ) ,
V_225 [ V_130 -> V_221 ] ) ;
F_13 ( V_303 , L_140 , V_36 ) ;
return V_36 ;
}
static void F_123 ( struct V_298 * V_299 )
{
struct V_165 * V_11 = F_108 ( V_299 ) ;
F_13 ( V_303 , L_14 ) ;
F_124 ( V_11 ) ;
