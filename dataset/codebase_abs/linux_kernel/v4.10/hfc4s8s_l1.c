...
{
F_1 ( V_1 , V_2 ) ;
return ( F_12 ( ( volatile V_4 ) V_1 -> V_3 ) ) ;
}
static inline T_3
F_13 ( T_1 * V_1 )
{
return ( F_14 ( ( volatile V_4 ) V_1 -> V_3 ) ) ;
}
static inline void
F_15 ( T_1 * V_1 )
{
...
static T_2
F_16 ( T_1 * V_8 , int V_9 )
{
T_2 V_10 ;
T_2 V_11 ;
V_10 = F_9 ( V_8 , V_9 ) ;
while ( ( ( V_11 = F_9 ( V_8 , V_9 ) ) != V_10 ) ) {
V_10 = V_11 ;
}
return V_11 ;
}
static int
F_17 ( T_1 * V_8 , int V_9 )
{
int V_12 ;
int V_13 ;
V_12 = F_11 ( V_8 , V_9 ) ;
while ( ( ( V_13 = F_11 ( V_8 , V_9 ) ) != V_12 ) ) {
V_12 = V_13 ;
}
return V_13 ;
}
static void
F_18 ( struct V_14 * V_15 , int V_16 , void * V_17 )
{
...
static void
F_27 ( struct V_48 * V_20 , int V_16 , void * V_17 )
{
...
static void
F_30 ( struct V_18 * V_51 , int V_74 )
{
int V_75 , V_76 ;
T_2 V_77 , V_78 , V_79 ;
struct V_22 * V_23 ;
...
F_15 ( V_51 -> V_8 ) ;
V_77 = F_16 ( V_51 -> V_8 , V_81 ) ;
V_78 = F_9 ( V_51 -> V_8 , V_82 ) ;
if ( V_77 < V_78 )
V_79 = V_83 + 1 + V_77 - V_78 ;
else
V_79 = V_77 - V_78 ;
if ( ! V_79 )
return;
V_75 = F_17 ( V_51 -> V_8 , V_84 ) ;
V_76 = F_11 ( V_51 -> V_8 , V_85 ) ;
V_75 = V_75 - V_76 + 1 ;
if ( V_75 < 0 )
V_75 += 384 ;
if ( ! ( V_23 = F_31 ( V_86 ) ) ) {
...
F_1 ( V_51 -> V_8 , V_87 ) ;
while ( V_75 >= 4 ) {
* ( ( unsigned long * ) V_80 ) = F_13 ( V_51 -> V_8 ) ;
V_80 += 4 ;
V_75 -= 4 ;
}
while ( V_75 -- )
...
F_15 ( V_19 -> V_8 ) ;
if ( V_50 -> V_52 == V_57 ) {
V_77 = F_16 ( V_19 -> V_8 , V_81 ) ;
V_78 = F_9 ( V_19 -> V_8 , V_82 ) ;
V_91 = ( ( V_77 ^ V_78 ) & V_83 ) ;
} else
V_91 = 0 ;
V_75 = F_17 ( V_19 -> V_8 , V_84 ) ;
V_76 = F_11 ( V_19 -> V_8 , V_85 ) ;
V_75 = ( V_75 - V_76 ) ;
if ( V_91 )
V_75 ++ ;
if ( V_75 < 0 )
...
F_15 ( V_51 -> V_8 ) ;
V_77 = F_9 ( V_51 -> V_8 , V_81 ) ;
V_78 = F_16 ( V_51 -> V_8 , V_82 ) ;
if ( ( V_77 ^ V_78 ) & V_83 )
return;
if ( V_51 -> V_30 > 0 ) {
V_94 = V_51 -> V_30 ;
...
if ( ( V_23 = F_34 ( & V_51 -> V_29 ) ) ) {
V_80 = V_23 -> V_88 ;
V_94 = V_23 -> V_89 ;
F_1 ( V_51 -> V_8 , V_87 ) ;
while ( V_94 >= 4 ) {
F_1 ( V_51 -> V_8 , V_87 ) ;
F_7 ( V_51 -> V_8 , * ( unsigned long * ) V_80 ) ;
V_80 += 4 ;
V_94 -= 4 ;
}
while ( V_94 -- )
...
do {
if ( V_50 -> V_52 == V_57 ) {
V_98 = F_9 ( V_19 -> V_8 , V_81 ) & V_83 ;
V_98 -=
( F_16 ( V_19 -> V_8 , V_82 ) & V_83 ) ;
if ( V_98 < 0 )
V_98 += 16 ;
if ( V_98 >= 15 )
break;
...
V_19 -> V_8 -> V_31 . V_59 [ V_19 -> V_33 ] &=
~ ( ( V_50 -> V_56 == 1 ) ? 1 : 4 ) ;
V_97 = F_17 ( V_19 -> V_8 , V_85 ) ;
V_97 -= F_11 ( V_19 -> V_8 , V_84 ) ;
if ( V_97 <= 0 )
V_97 += 384 ;
V_97 -- ;
if ( V_97 < 16 )
...
F_1 ( V_19 -> V_8 , V_87 ) ;
while ( V_94 >= 4 ) {
F_7 ( V_19 -> V_8 , * ( unsigned long * ) V_80 ) ;
V_80 += 4 ;
V_94 -= 4 ;
}
while ( V_94 -- )
...
static void
F_36 ( struct V_100 * V_101 )
{
T_1 * V_8 = F_37 ( V_101 , T_1 , V_34 ) ;
T_2 V_2 ;
struct V_18 * V_51 ;
volatile T_2 * V_102 ;
int V_103 ;
...
V_121 = F_3 ( V_8 ) ;
V_8 -> V_31 . V_104 |=
( F_9 ( V_8 , V_125 ) & V_8 -> V_31 . V_126 ) ;
if ( !
( V_2 = ( F_9 ( V_8 , V_6 ) & ( V_127 | V_128 ) ) )
&& ! V_8 -> V_31 . V_104 ) {
F_1 ( V_8 , V_121 ) ;
return V_124 ;
}
if ( F_9 ( V_8 , V_129 ) & V_130 ) {
V_8 -> V_31 . V_113 = 1 ;
V_8 -> V_114 -- ;
}
if ( ( V_119 = F_9 ( V_8 , V_131 ) ) ) {
...
static void
F_43 ( T_1 * V_8 , int V_147 , int V_36 )
{
T_3 V_24 ;
char V_148 [ 40 ] ;
int V_149 ;
...
V_8 -> V_19 [ V_149 ] . V_27 = 0 ;
F_45 ( & V_8 -> V_19 [ V_149 ] . V_43 ) ;
F_38 ( & V_8 -> V_19 [ V_149 ] . V_40 ) ;
F_28 ( & V_8 -> V_19 [ V_149 ] . V_29 ) ;
F_28 ( & V_8 -> V_19 [ V_149 ] . V_115 [ 0 ] . V_54 ) ;
F_28 ( & V_8 -> V_19 [ V_149 ] . V_115 [ 1 ] . V_54 ) ;
}
F_41 ( V_8 ) ;
}
}
...
F_51 ( & V_51 -> V_28 ) ;
V_51 -> V_8 = V_8 ;
V_51 -> V_40 . V_170 = ( void * ) F_29 ;
V_51 -> V_40 . V_88 = ( long ) ( V_51 ) ;
F_52 ( & V_51 -> V_40 ) ;
V_51 -> V_33 = V_149 ;
F_53 ( & V_51 -> V_29 ) ;
V_51 -> V_43 . V_20 . V_21 = V_8 -> V_19 + V_149 ;
V_51 -> V_43 . V_20 . V_171 = ( void * ) F_18 ;
F_51 ( & V_51 -> V_115 [ 0 ] . V_28 ) ;
V_51 -> V_115 [ 0 ] . V_67 . V_20 . V_171 = ( void * ) F_27 ;
V_51 -> V_115 [ 0 ] . V_67 . V_20 . V_21 = ( void * ) & V_51 -> V_115 [ 0 ] ;
V_51 -> V_115 [ 0 ] . V_51 = V_8 -> V_19 + V_149 ;
V_51 -> V_115 [ 0 ] . V_56 = 1 ;
V_51 -> V_163 [ 0 ] = & V_51 -> V_115 [ 0 ] . V_67 ;
F_53 ( & V_51 -> V_115 [ 0 ] . V_54 ) ;
F_51 ( & V_51 -> V_115 [ 1 ] . V_28 ) ;
V_51 -> V_115 [ 1 ] . V_67 . V_20 . V_171 = ( void * ) F_27 ;
V_51 -> V_115 [ 1 ] . V_67 . V_20 . V_21 = ( void * ) & V_51 -> V_115 [ 1 ] ;
V_51 -> V_115 [ 1 ] . V_51 = V_8 -> V_19 + V_149 ;
V_51 -> V_115 [ 1 ] . V_56 = 2 ;
V_51 -> V_163 [ 1 ] = & V_51 -> V_115 [ 1 ] . V_67 ;
F_53 ( & V_51 -> V_115 [ 1 ] . V_54 ) ;
}
F_49 ( V_8 ) ;
F_41 ( V_8 ) ;
V_149 = F_9 ( V_8 , V_172 ) >> V_173 ;
if ( V_149 != V_8 -> V_111 . V_174 ) {
F_26 ( V_46
L_10 ,
V_149 , V_8 -> V_111 . V_174 ) ;
goto V_175;
}
V_149 = F_9 ( V_8 , V_176 ) & 0xf ;
if ( ! V_149 ) {
F_26 ( V_46
L_11 ) ;
goto V_175;
...
F_54 ( & V_8 -> V_34 , F_36 ) ;
if ( F_55
( V_8 -> V_177 , F_40 , V_178 , V_8 -> V_179 , V_8 ) ) {
F_26 ( V_46
L_12 ,
V_8 -> V_177 ) ;
goto V_175;
...
static int
F_57 ( struct V_180 * V_164 , const struct V_181 * V_182 )
{
int V_167 = - V_183 ;
T_6 * V_111 = ( T_6 * ) V_182 -> V_111 ;
T_1 * V_8 ;
if ( ! ( V_8 = F_58 ( sizeof( T_1 ) , V_184 ) ) ) {
F_26 ( V_93 L_14 ) ;
return ( V_167 ) ;
}
V_8 -> V_164 = V_164 ;
...
goto V_175;
V_8 -> V_110 = V_185 ;
sprintf ( V_8 -> V_179 , L_15 , V_8 -> V_110 ) ;
F_26 ( V_46 L_16 ,
V_111 -> V_186 , V_8 -> V_179 , F_60 ( V_164 ) ) ;
F_51 ( & V_8 -> V_28 ) ;
V_8 -> V_111 = * V_111 ;
V_8 -> V_177 = V_164 -> V_177 ;
V_8 -> V_3 = F_61 ( V_164 , 0 ) ;
if ( ! F_62 ( V_8 -> V_3 , 8 , V_8 -> V_179 ) ) {
F_26 ( V_46
L_17 ,
V_8 -> V_3 ) ;
V_167 = - V_187 ;
...
static void
F_64 ( struct V_180 * V_164 )
{
T_1 * V_8 = F_65 ( V_164 ) ;
F_26 ( V_46 L_18 , V_8 -> V_110 ) ;
F_43 ( V_8 , 0 , 0 ) ;
if ( V_8 -> V_177 )
F_66 ( V_8 -> V_177 , V_8 ) ;
V_8 -> V_177 = 0 ;
