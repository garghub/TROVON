...
if ( type == F_3 ( V_9 -> V_21 , V_23 ) ) {
memcpy ( V_2 -> V_15 , V_2 -> V_24 -> V_15 , V_26 ) ;
F_4 ( & V_15 , V_2 -> V_15 , V_26 ) ;
V_17 [ V_18 + V_19 ++ ] = & V_15 ;
...
if ( V_58 )
V_125 = 1 ;
V_31 -> V_47 = F_66 ( V_125 , sizeof( * V_31 -> V_47 ) , V_82 ) ;
if ( ! V_31 -> V_47 )
return - V_71 ;
V_124 = F_66 ( V_125 , sizeof( * V_124 ) , V_82 ) ;
V_123 = F_66 ( V_125 , sizeof( * V_123 ) , V_82 ) ;
V_47 = F_66 ( V_125 , sizeof( * V_47 ) , V_82 ) ;
if ( ! V_124 || ! V_123 || ! V_47 ) {
V_58 = - V_71 ;
goto V_84;
}
...
V_61 = 1 ;
V_61 += 2 ;
V_21 -> V_41 = V_31 = F_84 ( sizeof( * V_31 ) , V_82 ) ;
if ( ! V_31 ) {
V_58 = - V_71 ;
goto V_162;
}
V_31 -> V_21 = V_21 ;
V_31 -> V_61 = V_61 ;
F_85 ( & V_31 -> V_110 , F_52 ) ;
V_58 = F_64 ( V_31 ) ;
if ( V_58 )
goto V_163;
V_31 -> V_49 = F_86 ( 1 << V_100 ) ;
if ( ! V_31 -> V_49 ) {
V_58 = - V_71 ;
goto V_164;
}
...
V_58 = F_87 ( & V_31 -> V_168 ) ;
if ( V_58 )
goto V_177;
V_32 = F_88 ( & V_31 -> V_168 ) ;
if ( F_36 ( V_32 ) ) {
V_58 = - V_71 ;
goto V_178;
}
...
& V_155 ) ;
if ( ! V_58 && V_155 )
F_96 ( V_32 , V_151 * V_155 ) ;
V_58 = F_65 ( V_21 , V_191 ,
struct V_95 , V_153 ,
& V_153 ) ;
if ( ! V_58 && V_153 )
F_97 ( V_32 , V_151 * V_153 ) ;
V_58 = F_65 ( V_21 , V_191 ,
struct V_95 , V_152 ,
& V_152 ) ;
if ( ! V_58 && V_152 )
F_98 ( V_32 , V_151 * V_152 ) ;
F_99 ( V_21 ) ;
F_100 ( & V_21 -> V_103 , V_31 -> V_49 ) ;
V_58 = F_101 ( F_61 ( V_31 -> V_49 ) , & V_192 ) ;
if ( V_58 )
goto V_193;
if ( F_42 ( V_21 , V_141 ) )
V_58 = F_101 ( F_61 ( V_31 -> V_49 ) ,
& V_194 ) ;
else
V_58 = F_101 ( F_61 ( V_31 -> V_49 ) ,
& V_195 ) ;
...
static void F_107 ( struct V_111 * V_21 )
{
struct V_30 * V_31 = V_21 -> V_41 ;
int V_44 = V_31 -> V_44 ;
int V_197 ;
...
V_197 = F_109 ( & F_61 ( V_31 -> V_49 ) -> V_119 . V_199 . V_200 ) ;
F_105 ( V_31 -> V_49 ) ;
V_21 -> V_130 -> V_196 ( V_21 ) ;
F_68 ( V_31 -> V_47 ) ;
F_68 ( V_31 ) ;
...
static int F_110 ( struct V_111 * V_21 )
{
struct V_30 * V_31 = V_21 -> V_41 ;
V_21 -> V_130 -> V_198 ( V_21 ) ;
F_108 ( & V_31 -> V_110 ) ;
F_111 ( V_31 -> V_49 -> V_50 ) ;
V_21 -> V_130 -> V_196 ( V_21 ) ;
return 0 ;
}
static int F_112 ( struct V_111 * V_21 )
{
struct V_30 * V_31 = V_21 -> V_41 ;
int V_201 ;
