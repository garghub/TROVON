...
unsigned long V_26 ;
struct V_15 * V_16 ;
F_65 ( ( unsigned long ) V_200 & ( sizeof( void * ) - 1 ) ) ;
if ( F_236 ( V_200 ) ) {
...
static void T_6 F_316 ( int * V_249 , const int * V_250 )
{
int V_51 ;
if ( V_251 ) {
V_249 [ V_252 - 1 ] = V_253 ;
for ( V_51 = V_252 - 2 ; V_51 >= 0 ; V_51 -- )
V_249 [ V_51 ] = V_254 ;
} else {
int V_255 ;
int V_256 ;
V_256 = V_236 ;
for ( V_51 = V_252 - 1 ; V_51 >= 0 ; V_51 -- ) {
V_255 = V_250 [ V_51 ] ;
V_249 [ V_51 ] = ( V_256 + V_255 - 1 ) / V_255 ;
V_256 = V_255 ;
}
}
}
static void T_6 F_317 ( struct V_4 * V_5 )
{
static const char * const V_257 [] = V_258 ;
static const char * const V_259 [] = V_260 ;
static struct V_261 V_262 [ V_263 ] ;
static struct V_261 V_264 [ V_263 ] ;
static T_7 V_265 = 0x1 ;
int V_250 [ V_263 ] ;
int V_249 [ V_263 ] ;
int V_266 = 1 ;
int V_51 ;
int V_92 ;
struct V_1 * V_2 ;
F_318 ( V_263 > F_110 ( V_257 ) ) ;
if ( V_252 <= 0 || V_252 > V_263 )
F_125 ( L_75 ) ;
for ( V_51 = 0 ; V_51 < V_252 ; V_51 ++ )
V_250 [ V_51 ] = V_267 [ V_51 ] ;
for ( V_51 = 1 ; V_51 < V_252 ; V_51 ++ )
V_5 -> V_117 [ V_51 ] = V_5 -> V_117 [ V_51 - 1 ] + V_250 [ V_51 - 1 ] ;
F_316 ( V_249 , V_250 ) ;
V_5 -> V_22 = V_265 ;
V_265 <<= 1 ;
for ( V_51 = V_252 - 1 ; V_51 >= 0 ; V_51 -- ) {
V_266 *= V_249 [ V_51 ] ;
V_2 = V_5 -> V_117 [ V_51 ] ;
for ( V_92 = 0 ; V_92 < V_250 [ V_51 ] ; V_92 ++ , V_2 ++ ) {
F_319 ( & F_320 ( V_2 , V_162 ) ) ;
F_321 ( & F_320 ( V_2 , V_162 ) ,
& V_262 [ V_51 ] , V_257 [ V_51 ] ) ;
F_319 ( & V_2 -> V_193 ) ;
F_321 ( & V_2 -> V_193 ,
& V_264 [ V_51 ] , V_259 [ V_51 ] ) ;
V_2 -> V_7 = V_5 -> V_7 ;
V_2 -> V_6 = V_5 -> V_6 ;
V_2 -> V_101 = 0 ;
V_2 -> V_135 = 0 ;
V_2 -> V_118 = V_92 * V_266 ;
V_2 -> V_119 = ( V_92 + 1 ) * V_266 - 1 ;
if ( V_2 -> V_119 >= V_236 )
V_2 -> V_119 = V_236 - 1 ;
if ( V_51 == 0 ) {
V_2 -> V_268 = 0 ;
...
V_2 -> V_268 = V_92 % V_249 [ V_51 - 1 ] ;
V_2 -> V_75 = 1UL << V_2 -> V_268 ;
...
V_253 , V_236 ) ;
if ( V_253 < 2 ||
V_253 > sizeof( unsigned long ) * 8 ) {
V_253 = V_279 ;
F_185 ( 1 ) ;
return;
}
V_276 [ 0 ] = V_253 ;
for ( V_51 = 1 ; V_51 < V_263 ; V_51 ++ )
V_276 [ V_51 ] = V_276 [ V_51 - 1 ] * V_254 ;
if ( V_236 > V_276 [ V_263 - 1 ] ) {
V_253 = V_279 ;
F_185 ( 1 ) ;
return;
}
for ( V_51 = 0 ; V_236 > V_276 [ V_51 ] ; V_51 ++ ) {
}
V_252 = V_51 + 1 ;
for ( V_51 = 0 ; V_51 < V_252 ; V_51 ++ ) {
int V_281 = V_276 [ ( V_252 - 1 ) - V_51 ] ;
V_267 [ V_51 ] = F_329 ( V_236 , V_281 ) ;
}
V_131 = 0 ;
for ( V_51 = 0 ; V_51 < V_252 ; V_51 ++ )
V_131 += V_267 [ V_51 ] ;
}
static void T_6 F_330 ( struct V_4 * V_5 )
{
int V_117 = 0 ;
struct V_1 * V_2 ;
F_45 ( L_77 ) ;
...
F_133 ( L_80 , V_2 -> V_118 , V_2 -> V_119 , V_2 -> V_268 ) ;
}
F_133 ( L_79 ) ;
}
void T_6 F_331 ( void )
