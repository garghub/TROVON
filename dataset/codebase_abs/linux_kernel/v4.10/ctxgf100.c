...
int V_63 , V_42 ;
T_3 V_9 ;
V_63 = F_29 ( V_12 , V_64 , 0x80000 + V_13 -> V_3 ,
0x1000 , true , & V_62 ) ;
if ( V_63 ) {
F_30 ( V_16 , L_1 , V_63 ) ;
return V_63 ;
...
V_9 = F_31 ( V_62 ) ;
F_32 ( V_62 ) ;
F_33 ( V_62 , 0x0200 , F_20 ( V_9 + 0x1000 ) ) ;
F_33 ( V_62 , 0x0204 , F_21 ( V_9 + 0x1000 ) ) ;
F_33 ( V_62 , 0x0208 , 0xffffffff ) ;
F_33 ( V_62 , 0x020c , 0x000000ff ) ;
F_33 ( V_62 , 0x1000 , 0x00000000 ) ;
F_33 ( V_62 , 0x1004 , 0x00000001 | ( V_9 + 0x2000 ) >> 8 ) ;
for ( V_42 = 0 ; V_42 < F_34 ( V_62 ) / 4096 ; V_42 ++ ) {
T_3 V_9 = ( ( F_31 ( V_62 ) + ( V_42 * 4096 ) ) >> 8 ) | 1 ;
F_33 ( V_62 , 0x2000 + ( V_42 * 8 ) , F_20 ( V_9 ) ) ;
F_33 ( V_62 , 0x2004 + ( V_42 * 8 ) , F_21 ( V_9 ) ) ;
}
F_33 ( V_62 , 0x0210 , 0x00080004 ) ;
F_33 ( V_62 , 0x0214 , 0x00000000 ) ;
F_35 ( V_62 ) ;
