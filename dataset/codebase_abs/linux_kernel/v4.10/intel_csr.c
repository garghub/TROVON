...
for ( V_17 = 0 ; V_17 < V_29 -> V_45 ; V_17 ++ ) {
if ( V_29 -> V_46 [ V_17 ] . V_47 == '*' &&
V_4 -> V_48 == V_29 -> V_46 [ V_17 ] . V_48 ) {
V_33 = V_29 -> V_46 [ V_17 ] . V_49 ;
break;
} else if ( V_4 -> V_48 == V_29 -> V_46 [ V_17 ] . V_48 &&
V_4 -> V_47 == V_29 -> V_46 [ V_17 ] . V_47 ) {
V_33 = V_29 -> V_46 [ V_17 ] . V_49 ;
break;
} else if ( V_29 -> V_46 [ V_17 ] . V_48 == '*' &&
V_29 -> V_46 [ V_17 ] . V_47 == '*' )
V_33 = V_29 -> V_46 [ V_17 ] . V_49 ;
}
if ( V_33 == V_34 ) {
...
if ( V_31 -> V_21 [ V_17 ] < V_50 ||
V_31 -> V_21 [ V_17 ] > V_51 ) {
F_12 ( L_11 ,
V_31 -> V_21 [ V_17 ] ) ;
return NULL ;
}
V_15 -> V_21 [ V_17 ] = F_20 ( V_31 -> V_21 [ V_17 ] ) ;
...
const struct V_24 * V_25 ;
int V_56 ;
V_3 = F_23 ( V_55 , F_24 ( * V_3 ) , V_15 . V_55 ) ;
V_15 = & V_3 -> V_15 ;
V_56 = F_25 ( & V_25 , V_3 -> V_15 . V_57 ,
& V_3 -> V_58 . V_59 -> V_60 ) ;
if ( V_25 )
