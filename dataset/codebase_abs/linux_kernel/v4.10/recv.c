...
int F_67 ( struct V_1 * V_2 , int V_10 , bool V_210 )
{
struct V_8 * V_9 ;
struct V_17 * V_18 = NULL , * V_211 , * V_212 ;
struct V_160 * V_161 ;
struct V_11 * V_12 = V_2 -> V_4 ;
struct V_13 * V_14 = F_3 ( V_12 ) ;
struct V_169 * V_74 = V_2 -> V_74 ;
...
struct V_149 V_150 ;
enum V_36 V_37 ;
bool V_214 = ! ! ( V_12 -> V_5 . V_6 & V_64 ) ;
int V_215 ;
T_3 V_162 = 0 ;
unsigned long V_216 ;
T_4 V_217 ;
unsigned int V_218 = 512 ;
struct V_143 * V_144 ;
if ( V_214 )
V_215 = V_51 ;
else
V_215 = V_69 ;
V_37 = V_210 ? V_50 : V_49 ;
V_162 = F_113 ( V_12 ) ;
do {
bool V_168 = false ;
...
continue;
if ( V_2 -> V_27 . V_219 )
V_212 = V_2 -> V_27 . V_219 ;
else
V_212 = V_18 ;
V_161 = F_114 ( V_212 ) ;
memset ( V_161 , 0 , sizeof( struct V_160 ) ) ;
V_213 = F_96 ( V_2 , V_212 , & V_150 , V_161 ,
& V_168 , V_162 ) ;
if ( V_213 )
goto V_220;
V_211 = F_41 ( V_14 , V_14 -> V_26 , V_221 ) ;
if ( ! V_211 ) {
F_97 ( V_222 ) ;
goto V_220;
}
V_217 = F_42 ( V_2 -> V_45 , V_211 -> V_25 ,
V_14 -> V_26 , V_215 ) ;
if ( F_43 ( F_44 ( V_2 -> V_45 , V_217 ) ) ) {
F_34 ( V_211 ) ;
goto V_220;
}
F_33 ( V_2 -> V_45 , V_9 -> V_22 ,
...
V_9 -> V_23 = V_211 ;
V_9 -> V_22 = V_217 ;
F_115 ( V_18 , V_150 . V_158 + V_12 -> V_5 . V_44 ) ;
if ( V_12 -> V_5 . V_44 )
F_116 ( V_18 , V_12 -> V_5 . V_44 ) ;
if ( ! V_150 . V_159 )
F_117 ( V_14 , V_212 , & V_150 ,
V_161 , V_168 ) ;
if ( V_150 . V_159 ) {
F_97 ( V_223 ) ;
if ( V_2 -> V_27 . V_219 ) {
...
if ( V_2 -> V_27 . V_219 ) {
int V_226 = V_18 -> V_130 - F_118 ( V_212 ) ;
if ( F_119 ( V_212 , 0 , V_226 , V_221 ) < 0 ) {
F_54 ( V_18 ) ;
F_97 ( V_222 ) ;
goto V_220;
}
V_2 -> V_27 . V_219 = NULL ;
F_120 ( V_18 , F_115 ( V_212 , V_18 -> V_130 ) ,
V_18 -> V_130 ) ;
F_34 ( V_18 ) ;
V_18 = V_212 ;
}
if ( V_161 -> V_192 & V_227 )
F_121 ( V_18 , V_18 -> V_130 - 8 ) ;
F_122 ( & V_2 -> V_228 , V_216 ) ;
if ( ( V_2 -> V_135 & ( V_136 |
V_141 |
V_147 ) ) ||
F_1 ( V_2 ) )
F_78 ( V_2 , V_18 , V_150 . V_182 ) ;
F_123 ( & V_2 -> V_228 , V_216 ) ;
F_110 ( V_2 , & V_150 ) ;
F_112 ( V_2 , & V_150 , V_161 ) ;
F_124 ( V_2 , & V_150 , V_18 ) ;
V_144 = (struct V_143 * ) V_18 -> V_25 ;
if ( F_125 ( V_144 -> V_145 ) )
F_126 ( V_2 -> V_4 , V_18 , V_150 . V_165 ) ;
F_127 ( V_74 , V_18 ) ;
V_220:
if ( V_2 -> V_27 . V_219 ) {
F_34 ( V_2 -> V_27 . V_219 ) ;
