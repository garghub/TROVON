...
void F_30 ( struct V_16 * V_17 , struct V_39 * V_67 )
{
struct V_39 * V_68 ;
F_10 ( V_17 , & V_69 ) ;
F_31 (clients, child)
...
int F_32 ( struct V_1 * V_2 , void * T_4 V_4 )
{
F_33 ( V_2 ) ;
return 0 ;
}
static int F_34 ( struct V_1 * V_2 , void * T_4 V_4 )
{
F_35 ( V_2 , NULL , F_32 ) ;
F_33 ( V_2 ) ;
return 0 ;
...
{
F_35 ( & V_17 -> V_1 , NULL , F_32 ) ;
}
void F_41 ( struct V_32 * V_33 )
{
F_35 ( & V_33 -> V_1 , NULL , F_34 ) ;
F_33 ( & V_33 -> V_1 ) ;
}
...
{
V_73 -> V_9 . V_26 = & V_27 ;
return F_46 ( & V_73 -> V_9 ) ;
}
static inline int F_47 ( struct V_74 * T_5 V_4 )
{
return 0 ;
}
static inline int F_48 ( struct V_11 * V_12 V_4 )
{
return 0 ;
}
...
struct V_32 * F_50 ( unsigned int V_75 , T_6 V_76 )
{
struct V_32 * V_33 ;
struct V_16 * * V_17 ;
unsigned int V_58 ;
...
V_33 -> V_17 [ V_58 ] -> V_1 . V_29 = F_38 ;
F_51 ( & V_33 -> V_17 [ V_58 ] -> V_1 ) ;
}
return V_33 ;
V_71:
F_49 ( V_33 ) ;
...
struct V_74 * F_56 ( unsigned int V_86 , T_6 V_76 )
{
struct V_74 * T_5 ;
int V_22 ;
...
int F_59 ( struct V_11 * V_12 , struct V_74 * T_5 )
{
struct V_16 * V_17 = F_60 ( V_12 ) ;
if ( ! F_61 ( V_12 ) )
return - V_87 ;
F_62 ( ! T_5 -> V_88 || ! T_5 -> V_89 ) ;
T_5 -> V_12 = V_12 ;
return V_17 -> V_78 ( T_5 ) ;
}
int F_63 ( struct V_11 * V_12 , unsigned int V_90 )
{
struct V_16 * V_17 = F_60 ( V_12 ) ;
int V_22 = 0 ;
F_64 ( & V_17 -> V_83 ) ;
...
if ( ! F_65 ( F_37 ( V_17 -> V_1 . V_28 ) -> V_94 ) ) {
V_22 = - V_95 ;
goto V_71;
}
V_17 -> V_91 ++ ;
...
if ( ! V_17 -> V_91 )
V_17 -> V_92 = 0 ;
F_69 ( F_37 ( V_17 -> V_1 . V_28 ) -> V_94 ) ;
F_66 ( & V_17 -> V_83 ) ;
}
static int F_70 ( struct V_97 * V_98 ,
unsigned long V_99 , void * T_4 V_4 )
{
struct V_11 * V_12 = F_71 ( V_98 , struct V_11 , V_98 ) ;
(* V_12 -> V_100 )( V_12 , V_99 ) ;
return 0 ;
}
int F_72 ( struct V_11 * V_12 ,
void (* F_73)( struct V_11 * , unsigned long ) )
{
struct V_16 * V_17 = F_60 ( V_12 ) ;
if ( ! F_73 || V_12 -> V_100 )
return - V_45 ;
...
return - V_87 ;
V_12 -> V_100 = F_73 ;
V_12 -> V_98 . V_101 = F_70 ;
return F_74 ( & V_17 -> V_84 , & V_12 -> V_98 ) ;
}
...
int V_22 ;
F_76 ( ! F_61 ( V_12 ) ) ;
V_22 = F_77 ( & V_17 -> V_84 , & V_12 -> V_98 ) ;
if ( ! V_22 )
V_12 -> V_100 = NULL ;
return V_22 ;
}
int F_78 ( struct V_16 * V_17 , unsigned long V_99 )
{
return F_79 ( & V_17 -> V_84 , V_99 , NULL ) ;
}
int F_80 ( struct V_11 * V_12 , char * V_10 )
{
int V_58 ;
if ( ! V_12 -> V_15 . V_14 )
return - V_102 ;
