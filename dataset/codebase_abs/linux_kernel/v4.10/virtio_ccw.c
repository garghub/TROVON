...
V_7 -> V_81 -> V_85 . V_87 = ( V_98 ) F_57 ( V_5 ) ;
V_7 -> V_81 -> V_85 . V_88 = ( V_98 ) F_58 ( V_5 ) ;
V_44 -> V_56 = sizeof( V_7 -> V_81 -> V_85 ) ;
}
V_44 -> V_54 = V_89 ;
V_44 -> V_9 = 0 ;
...
V_27 [ V_8 ] = F_54 ( V_3 , V_8 , V_107 [ V_8 ] , V_108 [ V_8 ] ,
V_44 ) ;
if ( F_64 ( V_27 [ V_8 ] ) ) {
V_39 = F_65 ( V_27 [ V_8 ] ) ;
V_27 [ V_8 ] = NULL ;
...
V_39 = F_32 ( V_36 , V_44 , V_119 ) ;
if ( V_39 ) {
V_17 = 0 ;
goto V_117;
}
V_17 = F_68 ( V_116 -> V_116 ) ;
if ( V_36 -> V_80 == 0 )
goto V_117;
V_116 -> V_72 = 1 ;
V_44 -> V_54 = V_118 ;
...
F_72 ( V_3 ) ;
V_116 -> V_72 = 0 ;
V_116 -> V_116 = F_73 ( ( V_122 ) V_3 -> V_116 ) ;
V_44 -> V_54 = V_123 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_116 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_116 ;
V_39 = F_32 ( V_36 , V_44 , V_124 ) ;
if ( V_39 )
goto V_117;
if ( V_36 -> V_80 == 0 )
goto V_117;
V_116 -> V_72 = 1 ;
V_116 -> V_116 = F_73 ( V_3 -> V_116 >> 32 ) ;
V_44 -> V_54 = V_123 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_116 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_116 ;
...
V_44 -> V_54 = V_137 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_36 -> V_112 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_36 -> V_112 ;
F_32 ( V_36 , V_44 , V_138 ) ;
F_21 ( V_44 ) ;
return * V_36 -> V_112 ;
}
static void F_77 ( struct V_2 * V_3 , T_9 V_112 )
{
struct V_1 * V_36 = F_1 ( V_3 ) ;
T_9 V_136 = * V_36 -> V_112 ;
struct V_43 * V_44 ;
...
{
struct V_2 * V_63 = F_79 ( V_142 ) ;
struct V_1 * V_36 = F_1 ( V_63 ) ;
F_21 ( V_36 -> V_112 ) ;
F_21 ( V_36 -> V_73 ) ;
F_21 ( V_36 ) ;
}
static int F_80 ( struct V_143 * V_143 )
{
if ( F_81 ( & V_143 -> V_144 ) != 0 )
return 1 ;
if ( F_82 ( & V_143 -> V_144 ) & ~ ( V_145 | V_146 ) )
return 1 ;
if ( F_83 ( & V_143 -> V_144 ) != 0 )
return 1 ;
return 0 ;
}
...
static void F_88 ( struct V_149 * V_40 ,
unsigned long V_45 ,
struct V_143 * V_143 )
{
T_2 V_147 = V_45 & V_46 ;
...
if ( F_94 ( 0 , & V_36 -> V_109 ) ) {
F_95 ( & V_36 -> V_3 ) ;
F_92 ( 0 , & V_36 -> V_109 ) ;
}
}
static int F_96 ( struct V_149 * V_40 )
{
struct V_156 V_157 ;
F_97 ( V_40 , & V_157 ) ;
if ( F_94 ( V_157 . V_158 , V_159 [ V_157 . V_160 ] ) )
return 0 ;
return 1 ;
}
static void F_98 ( void * V_161 , T_10 V_67 )
{
struct V_149 * V_40 = V_161 ;
int V_39 ;
V_39 = F_99 ( V_40 ) ;
if ( V_39 )
F_47 ( & V_40 -> V_63 , L_17 , V_39 ) ;
}
static int F_100 ( struct V_149 * V_40 )
{
V_40 -> V_22 = F_88 ;
if ( F_96 ( V_40 ) )
F_101 ( F_98 , V_40 ) ;
...
static struct V_1 * F_102 ( struct V_149 * V_40 )
{
unsigned long V_9 ;
struct V_1 * V_36 ;
F_29 ( F_30 ( V_40 ) , V_9 ) ;
...
static void F_103 ( struct V_149 * V_40 )
{
unsigned long V_9 ;
...
static int F_107 ( struct V_149 * V_40 )
{
unsigned long V_9 ;
struct V_1 * V_36 = F_102 ( V_40 ) ;
if ( ! V_36 )
...
if ( ! V_44 )
return - V_95 ;
V_166 = F_18 ( sizeof( * V_166 ) , V_53 | V_18 ) ;
if ( ! V_166 ) {
F_21 ( V_44 ) ;
return - V_95 ;
}
V_44 -> V_54 = V_167 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_166 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_166 ;
V_36 -> V_80 = V_168 ;
do {
V_166 -> V_80 = V_36 -> V_80 ;
V_166 -> V_169 = 0 ;
V_39 = F_32 ( V_36 , V_44 ,
V_148 ) ;
if ( V_39 == - V_105 ) {
...
static int F_109 ( struct V_149 * V_40 )
{
int V_39 ;
struct V_1 * V_36 ;
unsigned long V_9 ;
...
V_36 -> V_52 = V_106 ;
V_36 -> V_3 . V_63 . V_170 = & V_40 -> V_63 ;
V_36 -> V_3 . V_63 . V_171 = F_78 ;
V_36 -> V_3 . V_132 = & V_172 ;
V_36 -> V_40 = V_40 ;
F_110 ( & V_36 -> V_48 ) ;
F_111 ( & V_36 -> V_99 ) ;
F_112 ( & V_36 -> V_10 ) ;
...
F_31 ( F_30 ( V_40 ) , V_9 ) ;
V_36 -> V_3 . V_157 . V_173 = V_40 -> V_157 . V_174 ;
V_36 -> V_3 . V_157 . V_141 = V_40 -> V_157 . V_175 ;
V_39 = F_108 ( V_36 ) ;
if ( V_39 )
goto V_117;
V_39 = F_113 ( & V_36 -> V_3 ) ;
...
static int F_115 ( struct V_149 * V_40 , int V_177 )
{
int V_17 ;
struct V_1 * V_36 = F_89 ( & V_40 -> V_63 ) ;
if ( ! V_36 )
...
static int T_11 F_116 ( char * * V_180 , unsigned int * V_181 , int V_182 ,
int V_183 , int V_184 )
{
int V_185 ;
V_185 = 0 ;
* V_181 = 0 ;
while ( V_185 <= V_183 ) {
int V_186 = F_117 ( * * V_180 ) ;
if ( V_186 < 0 )
break;
* V_181 = * V_181 * 16 + V_186 ;
( * V_180 ) ++ ;
V_185 ++ ;
}
if ( ( V_185 < V_182 ) || ( V_185 > V_183 ) || ( * V_181 > V_184 ) )
return 1 ;
return 0 ;
}
static int T_11 F_118 ( char * V_187 , unsigned int * V_188 ,
unsigned int * V_160 , unsigned int * V_158 )
{
char * V_189 ;
int V_17 , V_39 ;
V_17 = 1 ;
...
goto V_100;
V_189 = V_187 ;
V_39 = F_116 ( & V_189 , V_188 , 1 , 2 , V_190 ) ;
if ( V_39 || ( V_189 [ 0 ] != '.' ) )
goto V_100;
V_189 ++ ;
V_39 = F_116 ( & V_189 , V_160 , 1 , 1 , V_191 ) ;
if ( V_39 || ( V_189 [ 0 ] != '.' ) )
goto V_100;
V_189 ++ ;
V_39 = F_116 ( & V_189 , V_158 , 4 , 4 , V_192 ) ;
if ( V_39 || ( V_189 [ 0 ] != '\0' ) )
goto V_100;
V_17 = 0 ;
V_100:
...
{
unsigned int V_193 , V_194 , V_195 , V_196 , V_197 , V_198 ;
char * V_199 , * V_187 ;
int V_17 ;
V_187 = V_200 ;
while ( ( V_199 = F_120 ( & V_187 , L_20 ) ) ) {
V_17 = F_118 ( F_120 ( & V_199 , L_21 ) , & V_193 ,
& V_195 , & V_197 ) ;
if ( V_17 )
continue;
if ( V_199 != NULL ) {
V_17 = F_118 ( V_199 , & V_194 ,
& V_196 , & V_198 ) ;
if ( ( V_195 > V_196 ) ||
