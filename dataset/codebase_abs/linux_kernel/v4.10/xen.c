...
if ( ! V_66 || ( V_66 & V_72 ) )
return - V_73 ;
V_13 . V_74 = F_39 ( V_2 , V_68 ) ;
V_13 . V_64 = V_39 -> V_75 . V_64 ;
}
V_36 = - V_73 ;
if ( V_76 )
V_36 = F_9 ( V_20 ,
...
if ( V_76 ) {
struct V_78 V_79 ;
V_79 . V_80 = F_36 ( V_2 -> V_60 ) ;
V_79 . V_60 = V_2 -> V_60 -> V_61 ;
V_79 . V_62 = V_2 -> V_62 ;
V_36 = F_9 ( V_81 ,
& V_79 ) ;
if ( V_36 == - V_45 )
V_76 = false ;
F_41 ( V_36 && V_36 != - V_45 , L_25 , V_36 ) ;
}
if ( ! V_76 ) {
struct V_82 V_83 ;
V_83 . V_60 = V_2 -> V_60 -> V_61 ;
V_83 . V_62 = V_2 -> V_62 ;
V_36 = F_9 ( V_84 , & V_83 ) ;
F_41 ( V_36 && V_36 != - V_45 , L_26 , V_36 ) ;
}
}
...
static struct V_109 * F_62 ( struct V_1 * V_2 )
{
struct V_109 * V_110 ;
F_63 (owner, &dev_domain_list, list) {
if ( V_110 -> V_2 == V_2 )
return V_110 ;
}
return NULL ;
...
int F_66 ( struct V_1 * V_2 , T_6 V_111 )
{
struct V_109 * V_110 ;
