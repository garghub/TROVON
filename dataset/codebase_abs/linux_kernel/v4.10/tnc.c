...
struct V_16 * V_17 ;
struct V_18 * V_19 ;
union V_64 * V_125 , V_126 ;
F_18 ( F_30 ( V_2 , V_47 ) ) ;
F_92 ( V_2 , & V_126 , F_80 ( V_2 , V_47 ) ) ;
F_75 ( & V_2 -> V_98 ) ;
...
if ( V_24 )
goto V_123;
if ( F_93 ( V_2 , V_47 ) == F_93 ( V_2 , V_125 ) &&
...
int F_94 ( struct V_1 * V_2 , const union V_64 * V_47 ,
void * V_42 , T_1 V_124 )
{
int V_24 ;
const struct V_44 * V_45 = V_42 ;
...
return 0 ;
return F_91 ( V_2 , V_47 , V_42 , V_124 ) ;
}
static void F_95 ( const struct V_1 * V_2 ,
struct V_16 * V_17 )
{
...
static int F_98 ( struct V_1 * V_2 , struct V_16 * V_17 ,
...
int F_100 ( struct V_1 * V_2 , const union V_64 * V_47 , int V_3 ,
int V_4 , int V_22 )
{
...
V_19 . V_4 = V_4 ;
V_19 . V_22 = V_22 ;
F_96 ( V_2 , V_47 , & V_19 . V_47 ) ;
V_24 = F_98 ( V_2 , V_17 , & V_19 , V_25 + 1 ) ;
} else if ( V_94 == 1 ) {
...
int F_102 ( struct V_1 * V_2 , const union V_64 * V_47 ,
...
static int F_105 ( struct V_1 * V_2 , struct V_16 * V_17 , int V_25 )
{
struct V_18 * V_19 ;
struct V_16 * V_76 ;
int V_35 , V_24 ;
...
int F_107 ( struct V_1 * V_2 , const union V_64 * V_47 )
{
int V_94 , V_25 , V_24 = 0 ;
struct V_16 * V_17 ;
F_75 ( & V_2 -> V_98 ) ;
...
static int F_108 ( struct V_1 * V_2 , union V_64 * V_47 ,
union V_64 * V_141 , union V_64 * V_142 )
{
if ( F_48 ( V_2 , V_47 , V_141 ) < 0 )
return 0 ;
if ( F_48 ( V_2 , V_47 , V_142 ) > 0 )
return 0 ;
return 1 ;
}
int F_109 ( struct V_1 * V_2 , union V_64 * V_141 ,
union V_64 * V_142 )
{
int V_35 , V_25 , V_143 , V_24 = 0 ;
struct V_16 * V_17 ;
union V_64 * V_47 ;
F_75 ( & V_2 -> V_98 ) ;
while ( 1 ) {
V_24 = F_67 ( V_2 , V_141 , & V_17 , & V_25 ) ;
if ( V_24 < 0 )
goto V_123;
if ( V_24 )
V_47 = V_141 ;
...
for ( V_35 = V_25 + 1 , V_143 = 0 ; V_35 < V_17 -> V_36 ; V_35 ++ , V_143 ++ ) {
...
if ( V_143 ) {
for ( V_35 = V_25 + 1 + V_143 ; V_35 < V_17 -> V_36 ; V_35 ++ )
V_17 -> V_20 [ V_35 - V_143 ] = V_17 -> V_20 [ V_35 ] ;
V_17 -> V_36 -= V_143 ;
}
V_24 = F_105 ( V_2 , V_17 , V_25 ) ;
if ( V_24 )
...
int F_110 ( struct V_1 * V_2 , T_2 V_144 )
{
union V_64 V_118 , V_145 ;
struct V_44 * V_146 , * V_147 = NULL ;
struct V_67 V_68 = { 0 } ;
F_70 ( L_35 , ( unsigned long ) V_144 ) ;
F_111 ( V_2 , & V_118 , V_144 ) ;
while ( 1 ) {
T_2 V_148 ;
int V_24 ;
V_146 = F_112 ( V_2 , & V_118 , & V_68 ) ;
if ( F_28 ( V_146 ) ) {
V_24 = F_58 ( V_146 ) ;
if ( V_24 == - V_49 )
break;
...
V_148 = F_113 ( V_146 -> V_144 ) ;
F_70 ( L_36 , V_146 -> V_71 ,
( unsigned long ) V_148 ) ;
F_52 ( & V_68 ) = V_146 -> V_71 ;
F_54 ( & V_68 ) = F_51 ( V_146 -> V_69 ) ;
V_24 = F_104 ( V_2 , & V_118 , & V_68 ) ;
if ( V_24 ) {
F_6 ( V_146 ) ;
return V_24 ;
}
F_114 ( V_2 , & V_118 , V_148 ) ;
F_115 ( V_2 , & V_145 , V_148 ) ;
V_24 = F_109 ( V_2 , & V_118 , & V_145 ) ;
if ( V_24 ) {
F_6 ( V_146 ) ;
return V_24 ;
}
F_6 ( V_147 ) ;
V_147 = V_146 ;
F_47 ( V_2 , & V_146 -> V_47 , & V_118 ) ;
}
F_6 ( V_147 ) ;
F_114 ( V_2 , & V_118 , V_144 ) ;
F_115 ( V_2 , & V_145 , V_144 ) ;
return F_109 ( V_2 , & V_118 , & V_145 ) ;
}
struct V_44 * F_112 ( struct V_1 * V_2 ,
union V_64 * V_47 ,
const struct V_67 * V_68 )
{
int V_25 , V_24 , type = F_46 ( V_2 , V_47 ) ;
...
static struct V_16 * F_121 ( struct V_1 * V_2 ,
struct V_16 * V_17 )
{
int V_34 = V_17 -> V_34 ;
while ( 1 ) {
...
static struct V_16 * F_122 ( struct V_1 * V_2 ,
struct V_16 * V_17 )
{
int V_34 = V_17 -> V_34 ;
while ( 1 ) {
...
static struct V_16 * F_123 ( struct V_1 * V_2 ,
...
int F_124 ( struct V_1 * V_2 , union V_64 * V_47 , int V_34 ,
int V_3 , int V_4 )
{
struct V_16 * V_17 ;
V_17 = F_123 ( V_2 , V_47 , V_34 , V_3 , V_4 ) ;
if ( ! V_17 )
return 0 ;
if ( F_28 ( V_17 ) )
return F_58 ( V_17 ) ;
...
static int F_125 ( struct V_1 * V_2 , union V_64 * V_47 ,
int V_3 , int V_4 )
{
struct V_18 * V_19 ;
struct V_16 * V_17 , * V_27 ;
int V_25 , V_94 , V_24 , V_75 ;
const int V_154 = ! F_30 ( V_2 , V_47 ) ;
V_94 = F_67 ( V_2 , V_47 , & V_17 , & V_25 ) ;
if ( V_94 < 0 )
return V_94 ;
if ( ! V_94 )
...
int F_126 ( struct V_1 * V_2 , union V_64 * V_47 , int V_34 ,
int V_3 , int V_4 , int V_155 )
{
int V_24 ;
F_75 ( & V_2 -> V_98 ) ;
if ( V_155 ) {
V_24 = F_124 ( V_2 , V_47 , V_34 , V_3 , V_4 ) ;
if ( V_24 < 0 )
goto V_123;
if ( V_24 == 1 )
V_24 = 0 ;
...
V_24 = F_125 ( V_2 , V_47 , V_3 , V_4 ) ;
V_123:
F_76 ( & V_2 -> V_98 ) ;
return V_24 ;
}
int F_128 ( struct V_1 * V_2 , union V_64 * V_47 , int V_34 ,
int V_3 , int V_4 )
{
struct V_16 * V_17 ;
int V_24 = 0 ;
...
int F_129 ( struct V_1 * V_2 , const struct V_156 * V_156 ,
T_3 V_157 )
{
int V_24 , V_25 ;
union V_64 V_141 , V_142 , * V_47 ;
struct V_16 * V_17 ;
unsigned int V_102 ;
if ( ! F_130 ( V_156 -> V_158 ) )
return 0 ;
if ( ! F_131 ( V_2 ) )
return 0 ;
V_102 = ( V_157 + V_159 - 1 ) >> V_160 ;
F_132 ( V_2 , & V_141 , V_156 -> V_161 , V_102 ) ;
F_133 ( V_2 , & V_142 , V_156 -> V_161 ) ;
F_75 ( & V_2 -> V_98 ) ;
V_24 = F_67 ( V_2 , & V_141 , & V_17 , & V_25 ) ;
if ( V_24 < 0 )
goto V_123;
...
V_102 = F_79 ( V_2 , V_47 ) ;
F_5 ( V_2 , L_37 ,
( unsigned long ) V_156 -> V_161 , V_157 ,
( ( T_3 ) V_102 ) << V_160 ) ;
F_76 ( & V_2 -> V_98 ) ;
F_134 ( V_2 , V_156 ) ;
F_32 () ;
