...
static bool F_30 ( struct V_12 * V_12 , char * V_59 )
{
char F_30 [ 3 ] ;
...
static void F_78 ( struct V_66 * V_79 )
{
...
static void F_149 ( struct V_40 * V_41 ,
const T_1 * V_274 )
{
struct V_315 * V_316 = & V_41 -> V_317 ;
...
static void
F_150 ( struct V_40 * V_41 , const T_1 * V_245 )
{
struct V_315 * V_316 = & V_41 -> V_317 ;
T_1 V_23 = F_126 ( V_245 ) ;
if ( V_23 >= 6 )
V_316 -> V_328 = V_245 [ 6 ] & 1 ;
if ( V_23 >= 7 )
V_316 -> V_329 = V_245 [ 7 ] * 5000 ;
F_14 ( L_40
L_41 ,
V_316 -> V_328 ,
V_316 -> V_329 ) ;
...
static void F_151 ( struct V_40 * V_41 ,
struct V_12 * V_12 )
{
struct V_315 * V_316 = & V_41 -> V_317 ;
const T_1 * V_225 ;
...
{
struct V_315 * V_316 = & V_41 -> V_317 ;
V_316 -> V_170 = V_12 -> V_177 * 10 ;
V_316 -> V_173 = V_12 -> V_178 * 10 ;
V_316 -> V_319 = 0 ;
V_316 -> V_324 = 0 ;
V_316 -> V_330 = 0 ;
V_316 -> V_329 = 0 ;
...
return;
F_151 ( V_41 , V_12 ) ;
if ( ( V_316 -> V_319 == 0 ) && ( V_12 -> V_16 < 4 ) &&
( V_12 -> V_106 & V_334 ) ) {
V_316 -> V_319 = 8 ;
F_7 ( L_42 ,
V_41 -> V_39 , V_316 -> V_319 ) ;
}
if ( V_12 -> V_16 < 4 )
return;
switch ( V_12 -> V_106 & V_335 ) {
case V_336 :
V_316 -> V_319 = 6 ;
break;
case V_337 :
...
static int F_153 ( T_1 * V_345 , int V_8 , int V_346 )
{
int V_2 ;
T_1 V_5 = 0 ;
struct V_347 * V_56 ;
V_56 = (struct V_347 * ) & V_345 [ V_346 ] ;
F_14 ( L_44 ,
V_56 -> V_348 , V_56 -> V_349 , V_56 -> V_350 , V_56 -> V_351 ) ;
if ( V_56 -> V_349 + 5 > V_8 - V_346 )
return - V_352 ;
for ( V_2 = V_346 ; V_2 <= V_56 -> V_349 + 5 ; V_2 ++ ) {
V_5 += V_345 [ V_2 ] ;
}
if ( V_5 ) {
F_8 ( L_45 , V_5 ) ;
...
static struct V_66 * F_154 ( struct V_86 * V_46 ,
struct V_353 * V_210 )
{
struct V_66 * V_79 ;
...
unsigned V_354 = ( V_210 -> V_355 [ 0 ] | V_210 -> V_355 [ 1 ] << 8 ) + 1 ;
...
unsigned V_356 = ( V_210 -> V_357 [ 0 ] | V_210 -> V_357 [ 1 ] << 8 ) + 1 ;
bool V_358 = ( V_210 -> V_180 [ 1 ] >> 7 ) & 0x1 ;
bool V_359 = ( V_210 -> V_183 [ 1 ] >> 7 ) & 0x1 ;
V_79 = F_67 ( V_46 ) ;
if ( ! V_79 )
return NULL ;
V_79 -> clock = V_162 * 10 ;
...
V_79 -> V_82 = V_79 -> V_83 + V_354 ;
V_79 -> V_80 = V_79 -> V_81 + V_145 ;
V_79 -> V_85 = V_142 ;
V_79 -> V_84 = V_79 -> V_85 + V_183 ;
V_79 -> V_134 = V_79 -> V_84 + V_356 ;
V_79 -> V_135 = V_79 -> V_85 + V_147 ;
V_79 -> V_35 = 0 ;
V_79 -> V_35 |= V_358 ? V_166 : V_167 ;
V_79 -> V_35 |= V_359 ? V_168 : V_169 ;
V_79 -> type = V_179 ;
if ( V_210 -> V_35 & 0x80 )
V_79 -> type |= V_77 ;
V_79 -> V_78 = F_39 ( V_79 ) ;
...
struct V_360 * V_9 )
{
struct V_361 * V_362 = (struct V_361 * ) V_9 ;
int V_2 ;
int V_363 ;
struct V_66 * V_189 ;
int V_364 = 0 ;
...
return 0 ;
V_363 = V_9 -> V_365 / 20 ;
for ( V_2 = 0 ; V_2 < V_363 ; V_2 ++ ) {
struct V_353 * V_210 = & V_362 -> V_210 [ V_2 ] ;
V_189 = F_154 ( V_41 -> V_46 , V_210 ) ;
if ( ! V_189 )
continue;
F_77 ( V_41 , V_189 ) ;
V_364 ++ ;
...
if ( ! V_345 )
return 0 ;
V_29 = F_153 ( V_345 , V_8 , V_346 ) ;
if ( V_29 )
return 0 ;
V_346 += sizeof( struct V_347 ) ;
while ( V_9 = (struct V_360 * ) & V_345 [ V_346 ] ,
V_346 + sizeof( struct V_360 ) <= V_8 &&
V_346 + sizeof( struct V_360 ) + V_9 -> V_365 <= V_8 &&
V_9 -> V_365 > 0 ) {
V_346 += V_9 -> V_365 + sizeof( struct V_360 ) ;
switch ( V_9 -> V_366 ) {
case V_367 :
V_364 += F_155 ( V_41 , V_9 ) ;
break;
}
}
return V_364 ;
}
int F_157 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
int V_364 = 0 ;
T_3 V_65 ;
if ( V_12 == NULL ) {
...
V_65 = F_31 ( V_12 ) ;
V_364 += F_94 ( V_41 , V_12 , V_65 ) ;
V_364 += F_91 ( V_41 , V_12 ) ;
V_364 += F_88 ( V_41 , V_12 ) ;
V_364 += F_86 ( V_41 , V_12 ) ;
V_364 += F_131 ( V_41 , V_12 ) ;
V_364 += F_113 ( V_41 , V_12 ) ;
V_364 += F_156 ( V_41 , V_12 ) ;
if ( V_12 -> V_108 & V_109 )
V_364 += F_83 ( V_41 , V_12 ) ;
if ( V_65 & ( V_74 | V_75 ) )
F_34 ( V_41 , V_65 ) ;
F_152 ( V_41 , V_12 ) ;
if ( V_65 & V_368 )
...
int F_158 ( struct V_40 * V_41 ,
int V_81 , int V_85 )
{
int V_2 , V_297 , V_364 = 0 ;
struct V_66 * V_79 ;
struct V_86 * V_46 = V_41 -> V_46 ;
V_297 = F_32 ( V_91 ) ;
if ( V_81 < 0 )
...
if ( V_79 -> V_35 & V_376 )
V_374 -> V_377 = 1 ;
V_374 -> V_235 = F_104 ( V_79 ) ;
V_374 -> V_378 = V_379 ;
if ( V_79 -> V_236 == V_380 ||
V_79 -> V_236 == V_381 )
V_374 -> V_378 = V_79 -> V_236 ;
else if ( V_374 -> V_235 > 0 )
V_374 -> V_378 = F_107 (
V_374 -> V_235 ) ;
V_374 -> V_382 = V_383 ;
V_374 -> V_384 = V_385 ;
...
static enum V_386
F_162 ( const struct V_66 * V_79 )
{
T_3 V_387 = V_79 -> V_35 & V_241 ;
switch ( V_387 ) {
case V_255 :
return V_388 ;
case V_389 :
...
V_374 -> V_404 = F_162 ( V_79 ) ;
return 0 ;
}
static int F_165 ( struct V_40 * V_41 ,
struct V_360 * V_9 )
{
struct V_405 * V_406 = (struct V_405 * ) V_9 ;
T_5 V_129 , V_130 ;
T_1 V_407 , V_408 ;
T_1 V_409 , V_410 ;
struct V_411 * V_412 ;
V_129 = V_406 -> V_413 [ 0 ] | V_406 -> V_413 [ 1 ] << 8 ;
V_130 = V_406 -> V_413 [ 2 ] | V_406 -> V_413 [ 3 ] << 8 ;
V_409 = ( V_406 -> V_414 [ 0 ] & 0xf ) | ( V_406 -> V_414 [ 2 ] & 0x30 ) ;
V_410 = ( V_406 -> V_414 [ 0 ] >> 4 ) | ( ( V_406 -> V_414 [ 2 ] >> 2 ) & 0x30 ) ;
V_407 = ( V_406 -> V_414 [ 1 ] & 0xf ) | ( ( V_406 -> V_414 [ 2 ] & 0x3 ) << 4 ) ;
V_408 = ( V_406 -> V_414 [ 1 ] >> 4 ) | ( ( ( V_406 -> V_414 [ 2 ] >> 2 ) & 0x3 ) << 4 ) ;
V_41 -> V_415 = true ;
if ( V_406 -> V_416 & 0x80 )
V_41 -> V_417 = true ;
V_41 -> V_410 = V_410 + 1 ;
...
V_41 -> V_418 = V_129 + 1 ;
V_41 -> V_419 = V_130 + 1 ;
F_14 ( L_47 , V_406 -> V_416 ) ;
F_14 ( L_48 , V_129 + 1 , V_130 + 1 ) ;
F_14 ( L_49 ,
V_410 + 1 , V_409 + 1 , V_408 , V_407 ) ;
F_14 ( L_50 , V_406 -> V_420 [ 0 ] , V_406 -> V_420 [ 1 ] , V_406 -> V_420 [ 2 ] ) ;
V_412 = F_166 ( V_41 -> V_46 , V_406 -> V_420 ) ;
if ( ! V_412 ) {
V_412 = F_167 ( V_41 -> V_46 , V_406 -> V_420 ) ;
}
if ( ! V_412 )
return - V_301 ;
if ( V_41 -> V_421 != V_412 ) {
if ( V_41 -> V_421 ) {
F_168 ( V_41 -> V_46 , V_41 -> V_421 ) ;
}
V_41 -> V_421 = V_412 ;
} else
F_168 ( V_41 -> V_46 , V_412 ) ;
return 0 ;
}
...
V_29 = F_169 ( V_41 , V_345 , V_6 , true ) ;
if ( V_29 < 0 )
goto V_424;
if ( ! V_41 -> V_415 )
goto V_424;
