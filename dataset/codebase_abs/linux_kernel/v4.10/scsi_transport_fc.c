...
static int F_110 ( struct V_18 * V_19 , T_3 V_207 , T_3 V_208 ,
int V_209 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
return V_3 -> V_121 -> V_210 ( V_19 , V_207 , V_208 , V_209 ) ;
}
static int F_111 ( struct V_18 * V_19 , T_3 V_207 , int V_209 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
return V_3 -> V_121 -> V_211 ( V_19 , V_207 , V_209 ) ;
}
struct V_212 *
F_112 ( struct V_213 * V_214 )
{
int V_123 ;
...
if ( F_114 ( ! V_3 ) )
return NULL ;
V_3 -> V_183 . V_185 . V_181 . V_215 = & V_3 -> V_216 [ 0 ] ;
V_3 -> V_183 . V_185 . V_181 . V_182 = & V_105 . V_182 ;
V_3 -> V_183 . V_185 . V_181 . V_175 = F_94 ;
V_3 -> V_183 . V_217 = sizeof( struct V_218 ) ;
F_115 ( & V_3 -> V_183 . V_185 ) ;
V_3 -> V_183 . V_180 . V_181 . V_215 = & V_3 -> V_180 [ 0 ] ;
V_3 -> V_183 . V_180 . V_181 . V_182 = & V_100 . V_182 ;
V_3 -> V_183 . V_180 . V_181 . V_175 = F_92 ;
V_3 -> V_183 . V_219 = sizeof( struct V_20 ) ;
if ( V_214 -> V_158 )
V_3 -> V_183 . V_180 . V_220 = & V_221 ;
F_115 ( & V_3 -> V_183 . V_180 ) ;
V_3 -> V_187 . V_181 . V_215 = & V_3 -> V_222 [ 0 ] ;
V_3 -> V_187 . V_181 . V_182 = & V_103 . V_182 ;
V_3 -> V_187 . V_181 . V_175 = F_101 ;
F_115 ( & V_3 -> V_187 ) ;
V_3 -> V_188 . V_181 . V_215 = & V_3 -> V_223 [ 0 ] ;
V_3 -> V_188 . V_181 . V_182 = & V_101 . V_182 ;
V_3 -> V_188 . V_181 . V_175 = F_105 ;
F_115 ( & V_3 -> V_188 ) ;
V_3 -> V_121 = V_214 ;
V_3 -> V_183 . V_224 = 1 ;
V_3 -> V_183 . V_225 = F_106 ;
V_3 -> V_183 . V_226 = F_109 ;
V_3 -> V_183 . V_210 = F_110 ;
V_3 -> V_183 . V_211 = F_111 ;
V_123 = 0 ;
F_116 ( V_15 ) ;
F_116 ( V_16 ) ;
F_116 ( V_17 ) ;
F_117 ( V_123 > V_227 ) ;
V_3 -> V_216 [ V_123 ] = NULL ;
V_123 = 0 ;
F_118 ( V_15 ) ;
F_118 ( V_16 ) ;
F_118 ( V_22 ) ;
...
F_128 ( V_146 ) ;
F_117 ( V_123 > V_234 ) ;
V_3 -> V_223 [ V_123 ] = NULL ;
return & V_3 -> V_183 ;
}
void F_129 ( struct V_212 * V_183 )
{
...
static int
F_55 ( struct V_18 * V_19 , struct V_235 * V_236 )
{
if ( F_114 ( ! F_131 ( V_19 ) ) ) {
F_29 ( V_237
L_22
L_23 , V_19 -> V_238 -> V_76 ) ;
F_132 () ;
return - V_111 ;
}
return F_133 ( F_131 ( V_19 ) , V_236 ) ;
}
static void
...
static int
F_136 ( struct V_18 * V_19 , struct V_239 * V_236 ,
unsigned long V_240 )
{
if ( F_114 ( ! F_137 ( V_19 ) ) ) {
F_29 ( V_237
...
return F_138 ( F_137 ( V_19 ) , V_236 , V_240 ) ;
}
static void
...
{
struct V_134 * V_135 = NULL , * V_241 = NULL ;
...
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
if ( V_3 -> V_121 -> V_244 )
V_3 -> V_121 -> V_244 ( V_14 ) ;
F_144 ( & V_14 -> V_9 , V_245 ) ;
}
static void
F_145 ( struct V_235 * V_236 )
{
struct V_13 * V_14 =
F_146 ( V_236 , struct V_13 , V_246 ) ;
F_143 ( V_14 ) ;
F_147 ( & V_14 -> V_9 ) ;
}
static void
F_148 ( struct V_235 * V_236 )
{
struct V_13 * V_14 =
F_146 ( V_236 , struct V_13 , V_152 ) ;
...
static struct V_13 *
F_155 ( struct V_18 * V_19 , int V_176 ,
struct V_255 * V_256 )
{
struct V_20 * V_21 = F_10 ( V_19 ) ;
struct V_113 * V_257 = F_43 ( V_19 -> V_114 ) ;
struct V_13 * V_14 ;
struct V_8 * V_9 ;
unsigned long V_136 ;
int error ;
T_7 V_258 ;
V_258 = ( sizeof( struct V_13 ) + V_257 -> V_121 -> V_259 ) ;
V_14 = F_113 ( V_258 , V_81 ) ;
if ( F_114 ( ! V_14 ) ) {
F_29 ( V_237 L_25 , V_94 ) ;
return NULL ;
}
V_14 -> V_28 = - 1 ;
V_14 -> V_23 = V_24 ;
V_14 -> V_60 = V_21 -> V_60 ;
memcpy ( & V_14 -> V_15 , & V_256 -> V_15 , sizeof( V_14 -> V_15 ) ) ;
memcpy ( & V_14 -> V_16 , & V_256 -> V_16 , sizeof( V_14 -> V_16 ) ) ;
V_14 -> V_17 = V_256 -> V_17 ;
V_14 -> V_132 = V_256 -> V_132 ;
V_14 -> V_40 = V_197 ;
if ( V_257 -> V_121 -> V_259 )
V_14 -> V_260 = & V_14 [ 1 ] ;
V_14 -> V_176 = V_176 ;
V_14 -> V_119 = - 1 ;
F_156 ( & V_14 -> V_251 , V_261 ) ;
F_156 ( & V_14 -> V_250 , V_262 ) ;
F_157 ( & V_14 -> V_252 , V_263 ) ;
F_157 ( & V_14 -> V_246 , F_145 ) ;
F_157 ( & V_14 -> V_152 , F_148 ) ;
F_53 ( V_19 -> V_137 , V_136 ) ;
V_14 -> V_264 = V_21 -> V_52 ++ ;
if ( V_14 -> V_132 & V_265 )
V_14 -> V_196 = V_21 -> V_53 ++ ;
else
V_14 -> V_196 = - 1 ;
F_158 ( & V_14 -> V_151 , & V_21 -> V_49 ) ;
F_159 ( V_19 ) ;
F_54 ( V_19 -> V_137 , V_136 ) ;
V_9 = & V_14 -> V_9 ;
F_160 ( V_9 ) ;
V_9 -> V_184 = F_161 ( & V_19 -> V_172 ) ;
V_9 -> V_186 = F_96 ;
F_162 ( V_9 , L_26 ,
V_19 -> V_57 , V_176 , V_14 -> V_264 ) ;
F_163 ( V_9 ) ;
error = F_164 ( V_9 ) ;
if ( error ) {
F_29 ( V_237 L_27 ) ;
...
struct V_13 *
F_169 ( struct V_18 * V_19 , int V_176 ,
struct V_255 * V_256 )
{
struct V_113 * V_257 = F_43 ( V_19 -> V_114 ) ;
struct V_20 * V_21 = F_10 ( V_19 ) ;
...
case V_48 :
case V_267 :
if ( V_14 -> V_16 == V_256 -> V_16 )
V_175 = 1 ;
break;
case V_268 :
if ( V_14 -> V_15 == V_256 -> V_15 )
V_175 = 1 ;
break;
case V_269 :
if ( V_14 -> V_17 == V_256 -> V_17 )
V_175 = 1 ;
break;
}
if ( V_175 ) {
memcpy ( & V_14 -> V_15 , & V_256 -> V_15 ,
sizeof( V_14 -> V_15 ) ) ;
memcpy ( & V_14 -> V_16 , & V_256 -> V_16 ,
sizeof( V_14 -> V_16 ) ) ;
V_14 -> V_17 = V_256 -> V_17 ;
V_14 -> V_40 = V_197 ;
V_14 -> V_132 = V_256 -> V_132 ;
...
V_257 -> V_121 -> V_259 ) ;
F_54 ( V_19 -> V_137 , V_136 ) ;
if ( V_256 -> V_132 & V_265 ) {
F_144 ( & V_14 -> V_9 , V_271 ) ;
F_53 ( V_19 -> V_137 , V_136 ) ;
V_14 -> V_136 |= V_248 ;
F_168 ( V_19 , & V_14 -> V_252 ) ;
F_54 ( V_19 -> V_137 , V_136 ) ;
...
F_54 ( V_19 -> V_137 , V_136 ) ;
V_14 = F_155 ( V_19 , V_176 , V_256 ) ;
return V_14 ;
}
void
F_172 ( struct V_13 * V_14 )
{
struct V_18 * V_19 = F_42 ( V_14 ) ;
unsigned long V_272 = V_14 -> V_60 ;
unsigned long V_136 ;
F_53 ( V_19 -> V_137 , V_136 ) ;
if ( V_14 -> V_40 != V_197 ) {
F_54 ( V_19 -> V_137 , V_136 ) ;
...
if ( ( V_14 -> V_119 != - 1 ) &&
( V_14 -> V_119 < V_272 ) )
F_136 ( V_19 , & V_14 -> V_250 ,
V_14 -> V_119 * V_273 ) ;
F_136 ( V_19 , & V_14 -> V_251 , V_272 * V_273 ) ;
}
void
F_174 ( struct V_13 * V_14 , T_2 V_132 )
{
struct V_18 * V_19 = F_42 ( V_14 ) ;
struct V_20 * V_21 = F_10 ( V_19 ) ;
unsigned long V_136 ;
...
static void
V_261 ( struct V_235 * V_236 )
{
struct V_13 * V_14 =
F_146 ( V_236 , struct V_13 , V_251 . V_236 ) ;
struct V_18 * V_19 = F_42 ( V_14 ) ;
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_20 * V_21 = F_10 ( V_19 ) ;
unsigned long V_136 ;
...
{
struct V_13 * V_14 =
F_146 ( V_236 , struct V_13 , V_250 . V_236 ) ;
if ( V_14 -> V_40 != V_115 )
return;
V_14 -> V_136 |= V_270 ;
F_143 ( V_14 ) ;
...
static void
V_263 ( struct V_235 * V_236 )
{
struct V_13 * V_14 =
F_146 ( V_236 , struct V_13 , V_252 ) ;
struct V_18 * V_19 = F_42 ( V_14 ) ;
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
unsigned long V_136 ;
if ( ( V_14 -> V_40 == V_197 ) &&
...
int F_176 ( struct V_190 * V_277 )
{
struct V_18 * V_19 = V_277 -> V_8 -> V_278 ;
struct V_13 * V_14 = F_4 ( V_11 ( V_277 -> V_8 ) ) ;
unsigned long V_136 ;
F_53 ( V_19 -> V_137 , V_136 ) ;
...
static int
F_89 ( struct V_18 * V_19 , int V_176 , struct V_8 * V_280 ,
struct V_165 * V_256 , struct V_134 * * V_281 )
{
struct V_20 * V_21 = F_10 ( V_19 ) ;
struct V_113 * V_257 = F_43 ( V_19 -> V_114 ) ;
struct V_134 * V_135 ;
...
int error ;
* V_281 = NULL ;
if ( ! V_257 -> V_121 -> V_228 )
return - V_79 ;
V_258 = ( sizeof( struct V_134 ) + V_257 -> V_121 -> V_282 ) ;
V_135 = F_113 ( V_258 , V_81 ) ;
if ( F_114 ( ! V_135 ) ) {
F_29 ( V_237 L_25 , V_94 ) ;
return - V_59 ;
}
V_135 -> V_143 = V_283 ;
V_135 -> V_233 = V_283 ;
V_135 -> V_15 = V_256 -> V_15 ;
V_135 -> V_16 = V_256 -> V_16 ;
V_135 -> V_132 = V_256 -> V_132 ;
V_135 -> V_169 = V_256 -> V_169 ;
if ( V_257 -> V_121 -> V_282 )
V_135 -> V_260 = & V_135 [ 1 ] ;
V_135 -> V_19 = V_19 ;
V_135 -> V_176 = V_176 ;
V_135 -> V_136 = V_139 ;
F_157 ( & V_135 -> V_141 , V_284 ) ;
F_53 ( V_19 -> V_137 , V_136 ) ;
...
V_21 -> V_55 ++ ;
V_135 -> V_264 = V_21 -> V_54 ++ ;
F_158 ( & V_135 -> V_151 , & V_21 -> V_51 ) ;
F_159 ( V_19 ) ;
F_54 ( V_19 -> V_137 , V_136 ) ;
V_9 = & V_135 -> V_9 ;
F_160 ( V_9 ) ;
V_9 -> V_184 = F_161 ( V_280 ) ;
V_9 -> V_186 = F_102 ;
F_162 ( V_9 , L_38 ,
V_19 -> V_57 , V_176 , V_135 -> V_264 ) ;
F_163 ( V_9 ) ;
error = F_164 ( V_9 ) ;
if ( error ) {
F_29 ( V_237 L_39 ) ;
...
F_165 ( V_9 ) ;
F_166 ( V_9 ) ;
error = V_257 -> V_121 -> V_228 ( V_135 , V_256 -> V_171 ) ;
if ( error ) {
F_29 ( V_237 L_40 ) ;
goto V_287;
}
if ( V_280 != & V_19 -> V_172 ) {
error = F_178 ( & V_19 -> V_172 . V_288 ,
& V_9 -> V_288 , F_179 ( V_9 ) ) ;
if ( error )
F_29 ( V_237
L_41
L_42 ,
V_94 , F_179 ( V_9 ) , error ) ;
}
F_53 ( V_19 -> V_137 , V_136 ) ;
V_135 -> V_136 &= ~ V_139 ;
F_54 ( V_19 -> V_137 , V_136 ) ;
...
struct V_134 *
F_180 ( struct V_18 * V_19 , int V_176 ,
struct V_165 * V_256 )
{
int V_142 ;
struct V_134 * V_135 ;
...
F_181 ( & V_19 -> V_172 . V_288 , F_179 ( V_9 ) ) ;
F_151 ( V_9 ) ;
F_152 ( V_9 ) ;
F_153 ( V_9 ) ;
F_98 ( V_9 ) ;
...
static void
V_284 ( struct V_235 * V_236 )
{
struct V_134 * V_135 =
F_146 ( V_236 , struct V_134 , V_141 ) ;
int V_142 ;
V_142 = F_91 ( V_135 ) ;
if ( V_142 )
F_175 ( V_237 , V_135 -> V_9 . V_184 ,
L_44
L_45 , V_94 ,
F_179 ( & V_135 -> V_9 ) , V_135 -> V_19 -> V_57 ,
V_135 -> V_176 , V_142 ) ;
}
static enum V_189
F_182 ( struct V_291 * V_292 )
{
struct V_293 * V_294 = ( void * ) V_292 -> V_295 ;
struct V_18 * V_19 = F_183 ( V_294 ) ;
struct V_13 * V_14 = F_184 ( V_294 ) ;
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
int V_77 = 0 , V_296 = 0 ;
if ( V_14 && V_14 -> V_40 == V_115 )
return V_192 ;
V_296 = F_185 ( V_294 ) ;
if ( V_296 && V_3 -> V_121 -> V_297 ) {
V_77 = V_3 -> V_121 -> V_297 ( V_294 ) ;
if ( V_77 == - V_298 ) {
F_186 ( V_294 ) ;
return V_192 ;
} else if ( V_77 )
...
static int F_187 ( struct V_18 * V_19 , struct V_293 * V_294 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_300 * V_301 = V_294 -> V_291 ;
struct V_302 * V_303 = V_294 -> V_304 ;
int V_305 = sizeof( V_306 ) ;
int V_153 ;
if ( V_294 -> V_307 < V_305 ) {
V_153 = - V_308 ;
goto V_309;
}
switch ( V_301 -> V_310 ) {
case V_311 :
V_305 += sizeof( struct V_312 ) ;
break;
case V_313 :
V_305 += sizeof( struct V_314 ) ;
break;
case V_315 :
V_305 += sizeof( struct V_316 ) ;
if ( ( ! V_294 -> V_317 . V_318 ) ||
( ! V_294 -> V_319 . V_318 ) ) {
V_153 = - V_111 ;
goto V_309;
}
...
break;
case V_322 :
V_305 += sizeof( struct V_323 ) ;
if ( ( V_19 -> V_238 -> V_89 == 0L ) ||
( V_301 -> V_324 . V_325 . V_89 !=
V_19 -> V_238 -> V_89 ) ) {
V_153 = - V_326 ;
goto V_309;
}
...
V_153 = V_3 -> V_121 -> V_301 ( V_294 ) ;
if ( ! V_153 )
return 0 ;
V_309:
F_117 ( V_294 -> V_328 < sizeof( V_306 ) ) ;
V_303 -> V_329 = 0 ;
V_303 -> V_209 = V_153 ;
V_294 -> V_328 = sizeof( V_306 ) ;
F_188 ( V_294 , V_303 -> V_209 ,
V_303 -> V_329 ) ;
return 0 ;
}
static void
...
{
struct V_330 * V_331 = V_14 -> V_64 ;
unsigned long V_136 ;
if ( ! V_331 )
return;
F_53 ( V_331 -> V_332 , V_136 ) ;
F_189 ( V_331 ) ;
F_54 ( V_331 -> V_332 , V_136 ) ;
}
static int F_190 ( struct V_18 * V_19 , struct V_293 * V_294 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_300 * V_301 = V_294 -> V_291 ;
struct V_302 * V_303 = V_294 -> V_304 ;
...
switch ( V_301 -> V_310 ) {
case V_334 :
V_305 += sizeof( struct V_335 ) ;
goto V_336;
case V_337 :
V_305 += sizeof( struct V_338 ) ;
V_336:
if ( ( ! V_294 -> V_317 . V_318 ) ||
( ! V_294 -> V_319 . V_318 ) ) {
V_153 = - V_111 ;
...
static int F_191 ( struct V_293 * V_294 )
{
struct V_18 * V_19 = F_183 ( V_294 ) ;
if ( F_100 ( V_294 -> V_9 ) )
return F_190 ( V_19 , V_294 ) ;
else
return F_187 ( V_19 , V_294 ) ;
}
static int
...
V_77 = F_194 ( V_9 , V_331 , V_339 , F_191 ,
V_3 -> V_121 -> V_342 ) ;
if ( V_77 ) {
F_193 ( V_9 ,
L_50 ,
...
static int F_198 ( struct V_330 * V_331 , struct V_291 * V_292 )
{
struct V_13 * V_14 = F_97 ( V_331 -> V_344 ) ;
if ( V_14 -> V_40 == V_115 &&
! ( V_14 -> V_136 & V_270 ) )
return V_345 ;
if ( V_14 -> V_40 != V_197 )
...
static int
F_167 ( struct V_18 * V_19 , struct V_13 * V_14 )
{
struct V_8 * V_9 = & V_14 -> V_9 ;
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_330 * V_331 ;
...
V_77 = F_194 ( V_9 , V_331 , NULL , F_191 , V_3 -> V_121 -> V_342 ) ;
if ( V_77 ) {
F_193 ( V_9 , L_52 ) ;
F_195 ( V_331 ) ;
return V_77 ;
