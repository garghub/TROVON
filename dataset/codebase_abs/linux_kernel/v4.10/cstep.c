...
if ( V_15 ) {
V_17 -> V_18 = ( F_6 ( V_2 , V_15 + 0x00 ) & 0x01e0 ) >> 5 ;
V_17 -> V_19 = F_3 ( V_2 , V_15 + 0x03 ) ;
}
return V_15 ;
}
T_1
F_7 ( struct V_1 * V_2 , T_2 V_18 , T_2 * V_3 , T_2 * V_4 ,
struct V_16 * V_17 )
{
T_1 V_15 , V_14 = 0 ;
...
T_1
F_9 ( struct V_1 * V_2 , int V_14 , T_2 * V_3 , T_2 * V_4 ,
struct V_20 * V_17 )
{
T_1 V_15 = F_8 ( V_2 , V_14 , V_3 , V_4 ) ;
memset ( V_17 , 0x00 , sizeof( * V_17 ) ) ;
if ( V_15 ) {
V_17 -> V_21 = F_6 ( V_2 , V_15 + 0x00 ) * 1000 ;
