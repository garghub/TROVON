...
V_2 = V_22 * ( V_16 + 1 ) * ( V_15 + 1 ) ;
if ( V_4 -> V_20 . V_27 & V_28 )
V_2 /= V_4 -> V_29 ;
return V_2 ;
}
...
if ( V_4 -> V_20 . V_27 & V_28 )
V_2 *= V_4 -> V_29 ;
V_30 . V_12 = V_4 -> V_16 . V_31 ;
V_30 . V_13 = 1 << V_4 -> V_16 . V_26 ;
V_30 . V_10 = V_4 -> V_15 . V_31 ;
V_30 . V_11 = 1 << V_4 -> V_15 . V_26 ;
F_1 ( * V_22 , V_2 , & V_30 ) ;
V_2 = * V_22 * V_30 . V_16 * V_30 . V_15 ;
if ( V_4 -> V_20 . V_27 & V_28 )
V_2 = V_2 / V_4 -> V_29 ;
return V_2 ;
}
...
V_30 . V_11 = 1 << V_4 -> V_15 . V_26 ;
F_1 ( V_22 , V_2 , & V_30 ) ;
F_13 ( V_4 -> V_20 . V_33 , V_32 ) ;
V_23 = F_10 ( V_4 -> V_20 . V_24 + V_4 -> V_20 . V_23 ) ;
V_23 &= ~ F_14 ( V_4 -> V_16 . V_26 + V_4 -> V_16 . V_25 - 1 , V_4 -> V_16 . V_25 ) ;
V_23 &= ~ F_14 ( V_4 -> V_15 . V_26 + V_4 -> V_15 . V_25 - 1 , V_4 -> V_15 . V_25 ) ;
F_15 ( V_23 | ( ( V_30 . V_15 - 1 ) << V_4 -> V_15 . V_25 ) | ( ( V_30 . V_16 - 1 ) << V_4 -> V_16 . V_25 ) ,
V_4 -> V_20 . V_24 + V_4 -> V_20 . V_23 ) ;
F_16 ( V_4 -> V_20 . V_33 , V_32 ) ;
F_17 ( & V_4 -> V_20 , V_4 -> V_33 ) ;
return 0 ;
}
