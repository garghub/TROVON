...
static void F_19 ( struct V_42 * V_41 )
{
struct V_34 * V_35 =
F_20 ( V_41 , struct V_34 , V_41 ) ;
struct V_36 * V_37 = F_15 ( V_35 -> V_37 ) ;
int V_10 ;
int type ;
if ( ! V_35 -> V_40 || V_35 -> error )
return;
if ( V_37 == NULL || F_17 ( V_37 ) )
return;
if ( F_21 ( V_35 -> V_39 , F_22 () ) ) {
F_18 ( & V_35 -> V_41 ) ;
return;
}
...
V_10 = V_35 -> V_49 -> V_10 ;
F_3 () ;
F_24 ( V_35 -> V_49 -> V_15 , & V_35 -> V_50 , type ,
V_35 -> V_49 -> V_16 , V_10 ,
...
T_3 V_45 )
{
V_35 -> V_44 = F_26 ( V_44 , 4 ) * 4 ;
V_35 -> V_43 = F_27 ( V_35 -> V_44 , V_52 ) ;
if ( V_35 -> V_43 == NULL )
return - V_53 ;
V_35 -> V_49 = F_2 ( V_2 ) ;
V_35 -> V_51 = V_51 ;
