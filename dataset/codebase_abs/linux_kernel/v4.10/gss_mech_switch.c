...
int
F_35 ( const void * V_41 , T_3 V_42 ,
struct V_1 * V_43 ,
struct V_44 * * V_45 ,
T_4 * V_46 ,
T_5 V_47 )
{
if ( ! ( * V_45 = F_36 ( sizeof( * * V_45 ) , V_47 ) ) )
return - V_14 ;
( * V_45 ) -> V_48 = F_14 ( V_43 ) ;
return V_43 -> V_49 -> F_35 ( V_41 , V_42 ,
* V_45 , V_46 , V_47 ) ;
}
T_1
F_37 ( struct V_44 * V_50 ,
struct V_51 * V_52 ,
struct V_53 * V_54 )
{
return V_50 -> V_48 -> V_49
-> F_37 ( V_50 ,
V_52 ,
V_54 ) ;
}
T_1
F_38 ( struct V_44 * V_50 ,
struct V_51 * V_52 ,
struct V_53 * V_54 )
{
return V_50 -> V_48 -> V_49
...
T_1
F_39 ( struct V_44 * V_45 ,
int V_55 ,
struct V_51 * V_25 ,
struct V_56 * * V_57 )
{
return V_45 -> V_48 -> V_49
-> F_39 ( V_45 , V_55 , V_25 , V_57 ) ;
}
T_1
