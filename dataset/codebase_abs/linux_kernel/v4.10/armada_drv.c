...
static void F_51 ( struct V_17 * V_10 )
{
struct V_9 * V_31 = F_52 ( V_10 ) ;
...
static int F_55 ( struct V_17 * V_10 , void * V_58 )
{
return V_10 -> V_59 == V_58 ;
}
static int F_56 ( struct V_17 * V_10 , void * V_58 )
{
const char * V_52 = V_58 ;
return ! strcmp ( F_43 ( V_10 ) , V_52 ) ;
}
static void F_57 ( struct V_17 * V_10 ,
struct V_60 * * V_61 , struct V_62 * V_63 )
{
struct V_62 * V_64 , * V_65 ;
F_58 (port, ep) {
V_65 = F_59 ( V_64 ) ;
if ( ! V_65 || ! F_60 ( V_65 ) ) {
F_61 ( V_65 ) ;
continue;
} else if ( ! F_60 ( V_65 -> V_66 ) ) {
F_62 ( V_10 , L_5 ,
V_65 -> V_67 ) ;
F_61 ( V_65 ) ;
continue;
}
F_63 ( V_10 , V_61 , F_55 , V_65 ) ;
F_61 ( V_65 ) ;
}
}
...
struct V_17 * V_10 = & V_69 -> V_10 ;
int V_20 ;
V_20 = F_65 ( V_10 , F_56 , & V_70 ) ;
if ( V_20 != - V_25 )
return V_20 ;
if ( V_10 -> V_71 ) {
char * * V_72 = V_10 -> V_71 ;
