...
static int F_34 ( struct V_37 * V_38 , unsigned int V_19 ,
...
if ( F_25 ( V_42 -> V_47 < 2 ) )
return - V_23 ;
if ( V_42 -> args [ 1 ] >= F_35 ( V_43 ) )
return - V_23 ;
V_44 = & V_43 [ V_42 -> args [ 1 ] ] ;
F_36 ( & V_46 , V_48 , V_44 -> V_49 , V_44 -> V_50 ) ;
V_46 . V_51 = F_37 ( F_38 ( V_38 ) ) ;
V_46 . V_52 = V_42 -> args [ 0 ] ;
return F_39 ( V_38 , V_19 , V_39 , & V_46 ) ;
}
static void T_1 F_40 ( struct V_10 * V_27 )
{
struct V_28 V_29 ;
int V_20 ;
struct V_53 V_54 = {
...
if ( ! V_7 )
return;
V_63 = F_47 ( V_65 - ( V_7 & ~ V_66 ) , ( T_2 ) 128 ) ;
V_67 = V_64 = F_48 ( V_7 , V_63 ) ;
V_3 = F_49 () ;
if ( V_63 < V_3 ) {
F_50 ( V_64 , V_63 ) ;
V_67 = V_64 = F_48 ( V_7 , V_3 ) ;
V_63 = V_3 ;
}
F_51 () ;
F_50 ( V_64 , V_63 ) ;
