...
V_89 -> V_97 = V_84 ;
V_89 -> V_41 = V_89 -> V_92 + F_42 ( V_28 , V_90 ) ;
V_89 -> V_41 -> V_98 = F_45 ( V_99 + V_3 -> V_36 + V_23 ) ;
V_87 = F_46 ( & V_4 -> V_5 , V_89 -> V_92 , V_84 ,
V_100 ) ;
if ( F_47 ( & V_4 -> V_5 , V_87 ) ) {
F_48 ( ( unsigned long ) V_89 -> V_92 , F_44 ( V_84 ) ) ;
V_64 = - V_95 ;
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_64 ) ;
goto V_96;
}
V_22 [ V_23 ] . V_101 = F_49 ( V_87 ) ;
F_50 ( & V_89 -> V_89 , V_28 , V_89 -> V_92 , V_90 ) ;
V_64 = F_51 ( & V_30 -> V_12 ,
* ( V_102 * ) F_52 ( V_3 -> V_8 ) ,
...
F_53 ( & V_30 -> V_105 , NULL , 0 ) ;
F_53 ( & V_30 -> V_106 , NULL , 0 ) ;
V_30 -> V_107 = V_108 ;
V_30 -> V_3 = V_3 ;
V_30 -> V_12 . V_109 = F_5 ;
F_4 ( & V_4 -> V_5 ,
...
V_30 -> V_110 = ( void * ) F_43 ( V_93 ,
F_44 ( V_111 ) ) ;
V_30 -> V_112 = F_46 ( & V_4 -> V_5 ,
V_30 -> V_110 , V_111 ,
V_100 ) ;
}
...
F_57 ( & V_4 -> V_5 , F_11 ( V_22 [ V_85 ] . V_101 ) ,
V_30 -> V_31 . V_97 , V_100 ) ;
F_48 ( ( unsigned long ) V_30 -> V_31 . V_92 ,
F_44 ( V_30 -> V_31 . V_97 ) ) ;
}
return V_64 ;
}
static void F_58 ( struct V_46 * V_117 , struct V_82 * V_78 ,
struct V_15 * V_4 )
{
struct V_66 * V_67 = V_4 -> V_19 -> V_68 ( V_4 ) ;
T_1 V_16 ;
...
V_30 -> V_112 , V_111 ,
V_100 ) ;
F_48 ( ( unsigned long ) V_30 -> V_110 ,
F_44 ( V_111 ) ) ;
F_61 ( & V_30 -> V_105 ) ;
F_61 ( & V_30 -> V_106 ) ;
F_57 ( & V_4 -> V_5 , F_11 ( V_22 [ V_23 ] . V_101 ) ,
V_30 -> V_31 . V_97 , V_100 ) ;
F_48 ( ( unsigned long ) V_30 -> V_31 . V_92 ,
F_44 ( V_30 -> V_31 . V_97 ) ) ;
}
...
static int F_62 ( struct V_2 * V_3 , T_5 V_122 , T_5 V_123 ,
T_6 V_97 )
{
int V_96 = 0 ;
struct V_124 * V_125 ;
...
static int F_66 ( struct V_2 * V_3 , void T_8 * V_136 ,
...
bool V_143 = F_67 ( V_47 -> V_130 -> V_1 , 1 , 1 , 1 ) ;
T_6 V_144 , V_145 ;
int V_96 ;
if ( ! V_146 ) {
if ( F_68 ( V_136 , ( void V_33 * ) V_140 , V_97 ) ) {
V_96 = - V_147 ;
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_96 ) ;
goto V_96;
...
V_144 = V_137 - F_69 ( V_137 , V_141 ) ;
V_137 -= V_144 ;
V_97 += V_144 ;
if ( V_143 )
V_137 += V_4 -> V_149 -> V_150 ;
while ( V_97 ) {
V_145 = F_70 ( T_6 , V_97 , V_111 ) ;
V_96 = F_62 ( V_3 , V_30 -> V_112 , V_137 ,
F_71 ( V_145 , V_141 ) ) ;
if ( V_96 ) {
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_96 ) ;
...
if ( F_68 ( V_136 , V_30 -> V_110 + V_144 ,
V_145 - V_144 ) ) {
V_96 = - V_147 ;
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_96 ) ;
...
static int F_72 ( struct V_2 * V_3 , void T_8 * V_136 ,
T_6 V_97 , T_9 V_137 , T_6 V_138 ,
int V_139 )
{
struct V_15 * V_4 = V_3 -> V_4 ;
...
while ( V_97 ) {
V_145 = F_70 ( T_6 , V_97 , V_111 ) ;
if ( F_73 ( V_30 -> V_110 , V_136 , V_145 ) ) {
V_96 = - V_147 ;
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_96 ) ;
goto V_96;
}
V_96 = F_62 ( V_3 , V_137 , V_30 -> V_112 ,
F_71 ( V_145 , V_141 ) ) ;
if ( V_96 ) {
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_96 ) ;
...
memcpy:
if ( F_73 ( ( void V_33 * ) V_140 , V_136 , V_97 ) ) {
V_96 = - V_147 ;
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_96 ) ;
goto V_96;
...
static inline V_102 F_74 ( struct V_158 * V_159 )
{
int V_23 ;
...
static int F_75 ( struct V_2 * V_3 , struct V_158 * V_159 ,
...
V_145 = F_76 ( V_167 -> V_162 , V_97 ) ;
if ( V_163 )
V_64 = F_66 ( V_3 , V_136 , V_145 ,
( T_9 ) V_167 -> V_168 ,
V_167 -> V_162 ,
V_139 ) ;
else
V_64 = F_72 ( V_3 , V_136 , V_145 ,
( T_9 ) V_167 -> V_168 ,
V_167 -> V_162 ,
V_139 ) ;
if ( V_64 ) {
...
static int F_77 ( struct V_2 * V_3 , struct V_169 * V_170 )
{
int V_64 = 0 ;
...
while ( V_171 ) {
if ( ! V_97 ) {
V_64 = F_73 ( & V_159 , V_173 , sizeof( * V_173 ) ) ;
if ( V_64 ) {
V_64 = - V_7 ;
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_64 ) ;
...
V_64 = F_75 ( V_3 , V_105 , V_136 , V_97 ,
...
V_136 += V_164 ;
V_170 -> V_164 += V_164 ;
V_64 = F_75 ( V_3 , V_106 , V_136 , V_97 ,
! V_174 , V_170 -> V_139 , & V_164 ) ;
if ( V_64 ) {
F_3 ( F_1 ( V_3 ) , L_1 ,
V_9 , __LINE__ , V_64 ) ;
...
static int F_85 ( struct V_176 * V_176 , struct V_177 * V_178 )
{
struct V_2 * V_3 ;
struct V_46 * V_47 = F_6 ( V_178 -> V_179 ,
struct V_46 , V_180 ) ;
V_3 = F_86 ( sizeof( * V_3 ) , V_93 ) ;
if ( ! V_3 )
return - V_95 ;
V_3 -> V_47 = V_47 ;
F_41 ( & V_3 -> V_181 ) ;
...
static int F_89 ( struct V_176 * V_176 , struct V_177 * V_178 )
{
...
if ( F_73 ( & V_8 , V_62 , sizeof( V_8 ) ) )
return - V_147 ;
if ( F_35 ( & V_8 ) > V_191 ||
V_8 . V_25 > V_192 )
return - V_7 ;
V_190 = F_86 ( F_33 ( & V_8 ) , V_93 ) ;
if ( ! V_190 )
return - V_95 ;
if ( F_73 ( V_190 , V_62 , F_33 ( & V_8 ) ) ) {
V_64 = - V_147 ;
goto V_193;
}
...
if ( V_64 )
goto V_197;
if ( F_73 ( & V_170 , V_62 , sizeof( V_170 ) ) ) {
V_64 = - V_147 ;
goto V_197;
}
V_64 = F_83 ( V_3 , & V_170 ) ;
...
if ( V_64 )
goto V_199;
V_110 = F_86 ( V_3 -> V_8 -> V_72 , V_93 ) ;
if ( ! V_110 ) {
V_64 = - V_95 ;
goto V_199;
}
if ( F_73 ( V_110 , V_62 , V_3 -> V_8 -> V_72 ) ) {
V_64 = - V_147 ;
goto V_119;
}
V_64 = F_24 ( V_3 , V_110 ) ;
