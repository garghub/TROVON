...
V_72 = F_36 ( V_70 , V_88 , 0 ) ;
if ( ! V_72 ) {
F_25 ( & V_70 -> V_43 , L_13 ) ;
return - V_89 ;
}
V_2 -> V_16 = F_37 ( & V_70 -> V_43 , V_72 ) ;
if ( F_38 ( V_2 -> V_16 ) )
return F_39 ( V_2 -> V_16 ) ;
V_2 -> V_24 = F_40 ( & V_70 -> V_43 , L_14 ) ;
if ( F_38 ( V_2 -> V_24 ) ) {
error = F_39 ( V_2 -> V_24 ) ;
if ( error != - V_90 ) {
if ( error != - V_91 )
...
if ( error < 0 )
V_92 = V_94 ;
V_93 = F_41 ( V_2 -> V_24 , V_92 ) ;
if ( V_93 <= 0 )
return - V_62 ;
error = F_42 ( V_2 -> V_24 , V_93 ) ;
if ( error )
return error ;
error = F_17 ( V_2 -> V_24 ) ;
if ( error )
...
F_18 ( V_2 ) ;
V_2 -> V_18 = F_43 ( V_70 , 0 ) ;
if ( V_2 -> V_18 < 0 ) {
F_25 ( & V_70 -> V_43 , L_18 ) ;
return - V_62 ;
}
error = F_44 ( & V_70 -> V_43 , V_2 -> V_18 ,
NULL , F_14 ,
V_95 , V_70 -> V_78 , V_2 ) ;
if ( error ) {
F_25 ( & V_70 -> V_43 , L_19 ) ;
