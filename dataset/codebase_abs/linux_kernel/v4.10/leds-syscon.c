...
V_6 = F_9 ( V_15 , sizeof( * V_6 ) , V_25 ) ;
if ( ! V_6 )
return - V_26 ;
V_6 -> V_13 = V_13 ;
if ( F_10 ( V_20 , L_4 , & V_6 -> V_14 ) )
return - V_27 ;
if ( F_10 ( V_20 , L_5 , & V_6 -> V_12 ) )
return - V_27 ;
V_6 -> V_7 . V_28 =
F_11 ( V_20 , L_6 , NULL ) ? : V_20 -> V_28 ;
V_6 -> V_7 . V_29 =
F_11 ( V_20 , L_7 , NULL ) ;
V_11 = F_11 ( V_20 , L_8 , NULL ) ;
if ( V_11 ) {
if ( ! strcmp ( V_11 , L_9 ) ) {
T_1 V_8 ;
V_9 = F_12 ( V_13 , V_6 -> V_14 , & V_8 ) ;
if ( V_9 < 0 )
return V_9 ;
...
V_6 -> V_7 . V_30 = F_1 ;
V_9 = F_13 ( V_15 , & V_6 -> V_7 ) ;
if ( V_9 < 0 )
return V_9 ;
F_14 ( V_17 , V_6 ) ;
F_15 ( V_15 , L_11 , V_6 -> V_7 . V_28 ) ;
return 0 ;
}
