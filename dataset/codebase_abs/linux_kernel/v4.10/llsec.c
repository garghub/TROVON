...
T_5 V_123 [ 16 ] ;
struct V_128 V_129 ;
F_74 ( V_130 , V_20 -> V_59 ) ;
int V_131 ;
F_70 ( V_123 , V_2 -> V_3 . V_44 , & V_113 -> V_2 ) ;
F_75 ( & V_129 , V_127 -> V_132 , V_127 -> V_133 ) ;
F_76 ( V_130 , V_20 -> V_59 ) ;
F_77 ( V_130 , 0 , NULL , NULL ) ;
F_78 ( V_130 , & V_129 , & V_129 , V_127 -> V_133 , V_123 ) ;
V_131 = F_79 ( V_130 ) ;
F_80 ( V_130 ) ;
return V_131 ;
}
static struct V_134 *
F_81 ( struct V_28 * V_20 , int V_135 )
{
int V_52 ;
for ( V_52 = 0 ; V_52 < F_22 ( V_20 -> V_55 ) ; V_52 ++ )
if ( F_82 ( V_20 -> V_55 [ V_52 ] ) == V_135 )
return V_20 -> V_55 [ V_52 ] ;
F_83 () ;
}
static int
F_84 ( struct V_126 * V_127 , const struct V_1 * V_2 ,
const struct V_112 * V_113 ,
struct V_28 * V_20 )
{
T_5 V_123 [ 16 ] ;
...
struct V_128 V_139 ;
struct V_140 * V_130 ;
V_135 = F_85 ( & V_113 -> V_2 ) ;
F_70 ( V_123 , V_2 -> V_3 . V_44 , & V_113 -> V_2 ) ;
V_130 = F_86 ( F_81 ( V_20 , V_135 ) , V_141 ) ;
if ( ! V_130 )
return - V_81 ;
V_136 = V_127 -> V_142 ;
V_132 = F_87 ( V_127 ) + V_127 -> V_142 ;
V_137 = F_88 ( V_127 ) - V_132 ;
F_89 ( V_127 , V_135 ) ;
F_75 ( & V_139 , F_87 ( V_127 ) , V_136 + V_137 + V_135 ) ;
if ( ! ( V_113 -> V_2 . V_24 & V_143 ) ) {
V_136 += V_137 ;
V_137 = 0 ;
}
F_90 ( V_130 , 0 , NULL , NULL ) ;
F_91 ( V_130 , & V_139 , & V_139 , V_137 , V_123 ) ;
F_92 ( V_130 , V_136 ) ;
V_138 = F_93 ( V_130 ) ;
F_9 ( V_130 ) ;
return V_138 ;
...
return F_84 ( V_127 , V_2 , V_113 , V_20 ) ;
}
int F_95 ( struct V_1 * V_2 , struct V_126 * V_127 )
{
struct V_112 V_113 ;
int V_138 , V_135 , V_144 ;
struct V_28 * V_20 ;
T_2 V_145 ;
V_144 = F_96 ( V_127 , & V_113 ) ;
if ( V_144 < 0 || V_113 . V_118 . type != V_146 )
return - V_79 ;
if ( ! V_113 . V_118 . V_147 || V_113 . V_2 . V_24 == 0 ) {
F_97 ( V_127 , V_144 ) ;
return 0 ;
}
V_135 = F_85 ( & V_113 . V_2 ) ;
if ( V_127 -> V_133 + V_144 + V_135 + V_148 > V_149 )
return - V_150 ;
F_98 () ;
F_13 ( & V_2 -> V_12 ) ;
if ( ! V_2 -> V_3 . V_33 ) {
...
V_20 = F_68 ( V_2 , & V_113 , & V_113 . V_152 , NULL ) ;
if ( ! V_20 ) {
V_138 = - V_153 ;
goto V_151;
}
F_14 ( & V_2 -> V_12 ) ;
F_16 ( & V_2 -> V_12 ) ;
V_145 = F_99 ( V_2 -> V_3 . V_35 ) ;
V_113 . V_2 . V_35 = F_100 ( V_145 ) ;
if ( V_145 == 0xFFFFFFFF ) {
F_17 ( & V_2 -> V_12 ) ;
F_11 ( V_20 ) ;
V_138 = - V_154 ;
...
V_2 -> V_3 . V_35 = F_101 ( V_145 + 1 ) ;
F_17 ( & V_2 -> V_12 ) ;
F_102 () ;
V_127 -> V_142 = F_103 ( V_127 , & V_113 ) ;
F_104 ( V_127 ) ;
V_138 = F_94 ( V_127 , V_2 , & V_113 , V_20 ) ;
F_11 ( V_20 ) ;
return V_138 ;
V_151:
F_14 ( & V_2 -> V_12 ) ;
...
V_132 = F_87 ( V_127 ) + V_127 -> V_142 ;
V_137 = F_88 ( V_127 ) - V_132 ;
F_75 ( & V_129 , V_132 , V_137 ) ;
F_76 ( V_130 , V_20 -> V_59 ) ;
F_77 ( V_130 , 0 , NULL , NULL ) ;
F_78 ( V_130 , & V_129 , & V_129 , V_137 , V_123 ) ;
V_131 = F_108 ( V_130 ) ;
F_80 ( V_130 ) ;
return V_131 ;
}
static int
F_109 ( struct V_126 * V_127 , const struct V_1 * V_2 ,
const struct V_112 * V_113 ,
struct V_28 * V_20 , T_4 V_100 )
{
T_5 V_123 [ 16 ] ;
unsigned char * V_132 ;
int V_135 , V_137 , V_136 , V_138 ;
struct V_128 V_139 ;
struct V_140 * V_130 ;
V_135 = F_85 ( & V_113 -> V_2 ) ;
F_70 ( V_123 , V_100 , & V_113 -> V_2 ) ;
...
V_132 = F_87 ( V_127 ) + V_127 -> V_142 ;
V_137 = F_88 ( V_127 ) - V_132 ;
F_75 ( & V_139 , F_87 ( V_127 ) , V_136 + V_137 ) ;
if ( ! ( V_113 -> V_2 . V_24 & V_143 ) ) {
V_136 += V_137 - V_135 ;
V_137 = V_135 ;
}
...
V_138 = F_110 ( V_130 ) ;
F_9 ( V_130 ) ;
F_111 ( V_127 , V_127 -> V_133 - V_135 ) ;
return V_138 ;
}
static int
F_112 ( struct V_126 * V_127 , const struct V_1 * V_2 ,
const struct V_112 * V_113 ,
struct V_28 * V_20 , T_4 V_100 )
{
if ( V_113 -> V_2 . V_24 == V_143 )
return F_107 ( V_127 , V_2 , V_113 , V_20 , V_100 ) ;
else
return F_109 ( V_127 , V_2 , V_113 , V_20 , V_100 ) ;
}
static int
F_113 ( struct V_26 * V_17 ,
const struct V_62 * V_156 )
{
struct V_90 * V_91 ;
V_91 = F_59 ( V_17 , V_156 ) ;
if ( ! V_91 ) {
struct V_90 * V_157 ;
V_157 = F_19 ( sizeof( * V_91 ) , V_141 ) ;
if ( ! V_157 )
return - V_81 ;
V_157 -> V_91 . V_99 = * V_156 ;
F_114 ( & V_17 -> V_12 ) ;
V_91 = F_59 ( V_17 , V_156 ) ;
if ( ! V_91 )
F_39 ( & V_157 -> V_91 . V_25 , & V_17 -> V_17 . V_9 ) ;
else
F_9 ( V_157 ) ;
F_115 ( & V_17 -> V_12 ) ;
}
...
static int
F_116 ( struct V_26 * V_17 ,
const struct V_62 * V_156 ,
T_2 V_35 )
{
struct V_90 * V_91 = NULL ;
if ( V_17 -> V_17 . V_158 == V_159 ) {
V_91 = F_59 ( V_17 , V_156 ) ;
if ( ! V_91 )
return - V_83 ;
}
if ( V_17 -> V_17 . V_158 == V_160 ) {
int V_138 = F_113 ( V_17 , V_156 ) ;
if ( V_138 < 0 )
return V_138 ;
}
F_114 ( & V_17 -> V_12 ) ;
...
int F_117 ( struct V_1 * V_2 , struct V_126 * V_127 )
{
struct V_112 V_113 ;
struct V_28 * V_20 ;
struct V_62 V_99 ;
...
T_4 V_100 ;
T_2 V_145 ;
if ( F_118 ( V_127 , & V_113 ) < 0 )
return - V_79 ;
if ( ! V_113 . V_118 . V_147 )
return 0 ;
if ( V_113 . V_118 . V_162 == 0 )
return - V_79 ;
F_13 ( & V_2 -> V_12 ) ;
if ( ! V_2 -> V_3 . V_33 ) {
F_14 ( & V_2 -> V_12 ) ;
...
F_14 ( & V_2 -> V_12 ) ;
F_98 () ;
V_20 = F_68 ( V_2 , & V_113 , & V_113 . V_163 , & V_99 ) ;
if ( ! V_20 ) {
V_131 = - V_153 ;
goto V_82;
}
V_17 = F_105 ( V_2 , & V_113 . V_163 ) ;
if ( ! V_17 ) {
V_131 = - V_79 ;
goto V_164;
}
if ( F_106 ( V_2 , V_113 . V_118 . type , 0 , & V_161 ) < 0 ) {
V_131 = - V_79 ;
goto V_164;
}
if ( ! ( V_161 . V_104 & F_69 ( V_113 . V_2 . V_24 ) ) &&
( V_113 . V_2 . V_24 == 0 && V_161 . V_103 &&
! V_17 -> V_17 . V_165 ) ) {
V_131 = - V_79 ;
goto V_164;
}
V_145 = F_119 ( V_113 . V_2 . V_35 ) ;
if ( V_145 == 0xffffffff ) {
V_131 = - V_154 ;
goto V_164;
}
V_131 = F_116 ( V_17 , & V_99 , V_145 ) ;
if ( V_131 )
goto V_164;
V_100 = V_17 -> V_17 . V_44 ;
F_102 () ;
V_131 = F_112 ( V_127 , V_2 , & V_113 , V_20 , V_100 ) ;
F_11 ( V_20 ) ;
return V_131 ;
V_164:
F_11 ( V_20 ) ;
