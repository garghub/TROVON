...
void F_35 ( struct V_5 * V_6 , int V_57 )
{
unsigned long V_23 ;
if ( ! V_6 -> V_13 -> V_58 )
return;
if ( F_36 ( & V_6 -> V_1 . V_27 [ V_57 ] ) == 1 ) {
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
}
bool F_37 ( struct V_5 * V_6 , int V_57 )
{
return F_36 ( & V_6 -> V_1 . V_27 [ V_57 ] ) == 1 ;
}
...
if ( ! V_6 -> V_13 -> V_58 )
return;
if ( F_36 ( & V_6 -> V_1 . V_33 [ V_59 ] ) == 1 ) {
F_13 ( & V_6 -> V_1 . V_25 , V_23 ) ;
F_15 ( V_6 ) ;
F_16 ( & V_6 -> V_1 . V_25 , V_23 ) ;
}
}
void F_41 ( struct V_5 * V_6 , int V_59 )
{
unsigned long V_23 ;
if ( V_59 < 0 || V_59 >= V_6 -> V_52 )
return;
...
void F_43 ( struct V_5 * V_6 , int V_60 )
{
unsigned long V_23 ;
if ( ! V_6 -> V_13 -> V_58 )
return;
...
void F_45 ( struct V_5 * V_6 , unsigned V_61 )
{
unsigned long V_23 ;
int V_24 ;
if ( ! V_6 -> V_13 -> V_58 )
