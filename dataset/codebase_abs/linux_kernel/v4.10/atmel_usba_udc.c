...
static int F_79 ( struct V_110 * V_111 )
{
struct V_3 * V_4 = F_38 ( V_111 ) ;
struct V_37 * V_13 = V_4 -> V_13 ;
F_80 ( V_152 ) ;
...
static struct V_157 *
F_83 ( struct V_110 * V_111 , T_6 V_158 )
{
struct V_6 * V_7 ;
F_49 ( V_107 , L_23 , V_111 , V_158 ) ;
V_7 = F_84 ( sizeof( * V_7 ) , V_158 ) ;
if ( ! V_7 )
return NULL ;
F_3 ( & V_7 -> V_17 ) ;
return & V_7 -> V_7 ;
...
static void
F_85 ( struct V_110 * V_111 , struct V_157 * V_159 )
{
struct V_6 * V_7 = F_86 ( V_159 ) ;
F_49 ( V_107 , L_24 , V_111 , V_159 ) ;
F_11 ( V_7 ) ;
}
static int F_87 ( struct V_37 * V_13 , struct V_3 * V_4 ,
...
V_40 = F_88 ( & V_13 -> V_65 , & V_7 -> V_7 , V_4 -> V_106 ) ;
if ( V_40 )
return V_40 ;
V_7 -> V_35 = 1 ;
...
static int
F_89 ( struct V_110 * V_111 , struct V_157 * V_159 , T_6 V_158 )
{
struct V_6 * V_7 = F_86 ( V_159 ) ;
struct V_3 * V_4 = F_38 ( V_111 ) ;
struct V_37 * V_13 = V_4 -> V_13 ;
...
V_159 -> V_25 = 0 ;
if ( V_4 -> V_53 )
return F_87 ( V_13 , V_4 , V_7 , V_158 ) ;
V_40 = - V_156 ;
F_77 ( & V_13 -> V_14 , V_114 ) ;
if ( V_4 -> V_4 . V_113 ) {
F_7 ( & V_7 -> V_17 , & V_4 -> V_17 ) ;
...
static void
F_90 ( struct V_3 * V_4 , struct V_6 * V_7 , T_5 V_33 )
{
V_7 -> V_7 . V_25 = V_7 -> V_7 . V_29 - F_60 ( V_161 , V_33 ) ;
}
static int F_91 ( struct V_3 * V_4 , T_5 * V_169 )
{
unsigned int V_170 ;
T_5 V_33 ;
F_53 ( V_4 , V_92 , 0 ) ;
...
static int F_93 ( struct V_110 * V_111 , struct V_157 * V_159 )
{
struct V_3 * V_4 = F_38 ( V_111 ) ;
struct V_37 * V_13 = V_4 -> V_13 ;
struct V_6 * V_7 ;
...
static int F_95 ( struct V_110 * V_111 , int V_174 )
{
struct V_3 * V_4 = F_38 ( V_111 ) ;
struct V_37 * V_13 = V_4 -> V_13 ;
unsigned long V_114 ;
...
static int F_96 ( struct V_110 * V_111 )
{
struct V_3 * V_4 = F_38 ( V_111 ) ;
...
static int F_98 ( struct V_180 * V_65 )
{
struct V_37 * V_13 = F_99 ( V_65 ) ;
return F_60 ( V_181 , F_100 ( V_13 , V_182 ) ) ;
}
static int F_101 ( struct V_180 * V_65 )
{
struct V_37 * V_13 = F_99 ( V_65 ) ;
unsigned long V_114 ;
T_5 V_93 ;
...
static int
F_102 ( struct V_180 * V_65 , int V_187 )
{
struct V_37 * V_13 = F_99 ( V_65 ) ;
unsigned long V_114 ;
V_65 -> V_187 = ( V_187 != 0 ) ;
...
static void F_103 ( struct V_37 * V_13 )
{
struct V_3 * V_4 ;
struct V_6 * V_7 , * V_22 ;
F_42 ( V_13 , V_172 , ~ 0UL ) ;
...
static struct V_3 * F_104 ( struct V_37 * V_13 , T_7 V_189 )
{
struct V_3 * V_4 ;
if ( ( V_189 & V_118 ) == 0 )
...
static inline void F_105 ( struct V_37 * V_13 , struct V_3 * V_4 )
{
F_51 ( V_4 , V_85 , V_178 ) ;
V_4 -> V_58 = V_191 ;
}
static inline int F_106 ( struct V_37 * V_13 , struct V_3 * V_4 )
{
if ( F_59 ( V_4 , V_101 ) & V_178 )
return 1 ;
return 0 ;
}
static inline void F_107 ( struct V_37 * V_13 , unsigned int V_192 )
{
T_5 V_193 ;
F_49 ( V_194 , L_35 , V_192 ) ;
V_193 = F_100 ( V_13 , V_185 ) ;
V_193 = F_108 ( V_195 , V_192 , V_193 ) ;
F_42 ( V_13 , V_185 , V_193 ) ;
}
static int F_109 ( struct V_37 * V_13 )
{
...
{
if ( V_208 -> V_209 == F_112 ( V_184 ) )
return true ;
return false ;
}
static inline bool F_113 ( struct V_207 * V_208 )
{
if ( V_208 -> V_209 == F_112 ( V_210 ) )
return true ;
return false ;
}
static inline bool F_114 ( struct V_207 * V_208 )
{
if ( V_208 -> V_209 == F_112 ( V_211 ) )
return true ;
return false ;
}
static int F_115 ( struct V_37 * V_13 , struct V_3 * V_4 ,
struct V_207 * V_208 )
{
int V_212 = 0 ;
switch ( V_208 -> V_213 ) {
...
== ( V_190 | V_218 ) ) {
struct V_3 * V_219 ;
V_219 = F_104 ( V_13 , F_116 ( V_208 -> V_189 ) ) ;
if ( ! V_219 )
goto V_220;
V_33 = 0 ;
if ( F_106 ( V_13 , V_219 ) )
...
goto V_221;
if ( V_208 -> V_222 != F_112 ( sizeof( V_33 ) ) )
goto V_220;
V_4 -> V_58 = V_168 ;
F_117 ( V_33 , V_4 -> V_84 ) ;
F_51 ( V_4 , V_85 , V_86 ) ;
...
F_116 ( V_208 -> V_209 ) , F_116 ( V_208 -> V_189 ) ,
F_116 ( V_208 -> V_222 ) ) ;
F_105 ( V_13 , V_4 ) ;
return - 1 ;
}
static void F_119 ( struct V_37 * V_13 , struct V_3 * V_4 )
{
struct V_6 * V_7 ;
T_5 V_230 ;
T_5 V_231 ;
...
break;
case V_228 :
F_42 ( V_13 , V_185 , ( F_100 ( V_13 , V_185 )
| V_236 ) ) ;
F_51 ( V_4 , V_89 , V_94 ) ;
V_4 -> V_58 = V_191 ;
break;
...
V_40 = - 1 ;
if ( V_4 -> V_119 == 0 )
V_40 = F_115 ( V_13 , V_4 , & V_208 . V_208 ) ;
else {
F_63 ( & V_13 -> V_14 ) ;
...
F_116 ( V_208 . V_208 . V_222 ) , V_4 -> V_58 , V_40 ) ;
if ( V_40 < 0 ) {
F_105 ( V_13 , V_4 ) ;
}
}
}
static void F_121 ( struct V_37 * V_13 , struct V_3 * V_4 )
{
struct V_6 * V_7 ;
T_5 V_230 ;
T_5 V_231 ;
V_230 = F_59 ( V_4 , V_101 ) ;
V_231 = F_59 ( V_4 , V_233 ) ;
F_49 ( V_234 , L_52 , V_4 -> V_4 . V_46 , V_230 ) ;
while ( ( V_231 & V_86 ) && ! ( V_230 & V_86 ) ) {
F_49 ( V_194 , L_53 , V_4 -> V_4 . V_46 ) ;
if ( F_55 ( & V_4 -> V_17 ) ) {
F_122 ( & V_13 -> V_60 -> V_61 , L_54 ) ;
F_51 ( V_4 , V_89 , V_86 ) ;
return;
}
V_7 = F_56 ( V_4 -> V_17 . V_96 , struct V_6 , V_17 ) ;
...
if ( ( V_230 & V_231 ) & V_95 ) {
F_49 ( V_194 , L_55 , V_4 -> V_4 . V_46 ) ;
F_58 ( V_4 ) ;
}
}
static void F_123 ( struct V_37 * V_13 , struct V_3 * V_4 )
{
struct V_6 * V_7 ;
...
#endif
V_243 = V_33 & V_242 ;
F_49 ( V_234 | V_160 , L_56 , V_33 , V_242 ) ;
if ( V_33 & V_162 ) {
F_31 ( & V_13 -> V_60 -> V_61 ,
L_57 ) ;
F_31 ( & V_13 -> V_60 -> V_61 ,
...
static T_9 F_124 ( int V_246 , void * V_247 )
{
...
F_65 ( & V_13 -> V_14 ) ;
V_248 = F_40 ( V_13 ) ;
V_33 = F_100 ( V_13 , V_251 ) & ( V_248 | V_252 ) ;
F_49 ( V_234 , L_59 , V_33 ) ;
if ( V_33 & V_253 ) {
F_46 ( V_13 , 0 ) ;
...
F_119 ( V_13 , & V_13 -> V_3 [ V_38 ] ) ;
else
F_121 ( V_13 , & V_13 -> V_3 [ V_38 ] ) ;
}
}
if ( V_33 & V_261 ) {
struct V_3 * V_71 ;
...
F_127 ( & V_13 -> V_60 -> V_61 ,
L_64 ) ;
}
F_63 ( & V_13 -> V_14 ) ;
return V_266 ;
}
static int F_128 ( struct V_37 * V_13 )
{
int V_40 ;
if ( V_13 -> V_267 )
return 0 ;
V_40 = F_129 ( V_13 -> V_268 ) ;
if ( V_40 )
return V_40 ;
V_40 = F_129 ( V_13 -> V_269 ) ;
if ( V_40 ) {
F_130 ( V_13 -> V_268 ) ;
return V_40 ;
}
...
static void F_131 ( struct V_37 * V_13 )
{
if ( ! V_13 -> V_267 )
return;
F_130 ( V_13 -> V_269 ) ;
...
static int F_132 ( struct V_37 * V_13 )
{
unsigned long V_114 ;
int V_40 ;
V_40 = F_128 ( V_13 ) ;
...
static void F_133 ( struct V_37 * V_13 )
{
unsigned long V_114 ;
F_77 ( & V_13 -> V_14 , V_114 ) ;
V_13 -> V_65 . V_153 = V_154 ;
...
static T_9 F_134 ( int V_246 , void * V_247 )
{
struct V_37 * V_13 = V_247 ;
int V_272 ;
F_92 ( 10 ) ;
...
static int F_137 ( struct V_180 * V_65 ,
struct V_276 * V_167 )
{
int V_40 ;
struct V_37 * V_13 = F_138 ( V_65 , struct V_37 , V_65 ) ;
unsigned long V_114 ;
F_77 ( & V_13 -> V_14 , V_114 ) ;
V_13 -> V_183 = 1 << V_188 ;
V_13 -> V_167 = V_167 ;
...
static int F_142 ( struct V_180 * V_65 )
{
struct V_37 * V_13 = F_138 ( V_65 , struct V_37 , V_65 ) ;
if ( F_44 ( V_13 -> V_75 ) )
F_141 ( F_140 ( V_13 -> V_75 ) ) ;
...
static void F_143 ( struct V_37 * V_13 , int V_77 )
{
F_144 ( V_13 -> V_278 , V_279 , V_280 ,
V_77 ? V_280 : 0 ) ;
}
static void F_145 ( struct V_37 * V_13 )
{
F_144 ( V_13 -> V_278 , V_279 , V_280 , 0 ) ;
F_144 ( V_13 -> V_278 , V_279 , V_280 ,
V_280 ) ;
}
static struct V_3 * F_146 ( struct V_281 * V_60 ,
struct V_37 * V_13 )
{
T_5 V_73 ;
const char * V_46 ;
...
V_287 = F_147 ( V_290 , V_284 ) ;
if ( ! V_287 )
return F_148 ( - V_124 ) ;
V_13 -> V_78 = V_287 -> V_39 ;
V_13 -> V_278 = F_149 ( L_65 ) ;
if ( F_34 ( V_13 -> V_278 ) )
V_13 -> V_278 = F_149 ( L_66 ) ;
if ( V_13 -> V_78 && F_34 ( V_13 -> V_278 ) )
return F_150 ( V_13 -> V_278 ) ;
V_13 -> V_260 = 0 ;
V_13 -> V_75 = F_151 ( V_284 , L_67 , 0 ,
& V_114 ) ;
V_13 -> V_76 = ( V_114 & V_291 ) ? 1 : 0 ;
V_288 = NULL ;
while ( ( V_288 = F_152 ( V_284 , V_288 ) ) )
V_13 -> V_260 ++ ;
V_289 = F_153 ( & V_60 -> V_61 , sizeof( struct V_3 ) * V_13 -> V_260 ,
V_11 ) ;
if ( ! V_289 )
return F_148 ( - V_12 ) ;
...
while ( ( V_288 = F_152 ( V_284 , V_288 ) ) ) {
V_4 = & V_289 [ V_38 ] ;
V_40 = F_154 ( V_288 , L_68 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_69 , V_40 ) ;
goto V_277;
}
V_4 -> V_119 = V_73 ;
V_40 = F_154 ( V_288 , L_70 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_71 , V_40 ) ;
goto V_277;
}
V_4 -> V_122 = V_73 ;
V_40 = F_154 ( V_288 , L_72 , & V_73 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_73 , V_40 ) ;
goto V_277;
}
V_4 -> V_138 = V_73 ;
V_4 -> V_53 = F_155 ( V_288 , L_74 ) ;
V_4 -> V_136 = F_155 ( V_288 , L_75 ) ;
V_40 = F_156 ( V_288 , L_76 , & V_46 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_77 , V_40 ) ;
goto V_277;
}
sprintf ( V_4 -> V_46 , L_78 , V_4 -> V_119 ) ;
V_4 -> V_4 . V_46 = V_4 -> V_46 ;
V_4 -> V_293 = V_13 -> V_43 + F_157 ( V_38 ) ;
V_4 -> V_294 = V_13 -> V_43 + F_158 ( V_38 ) ;
V_4 -> V_84 = V_13 -> V_84 + F_159 ( V_38 ) ;
V_4 -> V_4 . V_295 = & V_296 ;
F_160 ( & V_4 -> V_4 , V_4 -> V_122 ) ;
V_4 -> V_13 = V_13 ;
F_3 ( & V_4 -> V_17 ) ;
if ( V_4 -> V_119 == 0 ) {
...
static struct V_3 * F_161 ( struct V_281 * V_60 ,
struct V_37 * V_13 )
{
struct V_305 * V_306 = F_162 ( & V_60 -> V_61 ) ;
struct V_3 * V_289 ;
int V_38 ;
if ( ! V_306 )
return F_148 ( - V_307 ) ;
V_289 = F_153 ( & V_60 -> V_61 , sizeof( struct V_3 ) * V_306 -> V_260 ,
V_11 ) ;
if ( ! V_289 )
return F_148 ( - V_12 ) ;
V_13 -> V_65 . V_71 = & V_289 [ 0 ] . V_4 ;
...
static int F_163 ( struct V_281 * V_60 )
{
struct V_63 * V_43 , * V_84 ;
struct V_308 * V_268 , * V_269 ;
struct V_37 * V_13 ;
int V_246 , V_40 , V_38 ;
V_13 = F_153 ( & V_60 -> V_61 , sizeof( * V_13 ) , V_11 ) ;
if ( ! V_13 )
return - V_12 ;
V_13 -> V_65 = V_309 ;
F_3 ( & V_13 -> V_65 . V_292 ) ;
...
if ( V_246 < 0 )
return V_246 ;
V_268 = F_165 ( & V_60 -> V_61 , L_80 ) ;
if ( F_34 ( V_268 ) )
return F_166 ( V_268 ) ;
V_269 = F_165 ( & V_60 -> V_61 , L_81 ) ;
if ( F_34 ( V_269 ) )
return F_166 ( V_269 ) ;
F_167 ( & V_13 -> V_14 ) ;
F_168 ( & V_13 -> V_273 ) ;
...
V_13 -> V_75 = - V_175 ;
V_40 = - V_12 ;
V_13 -> V_43 = F_169 ( & V_60 -> V_61 , V_43 -> V_311 , F_37 ( V_43 ) ) ;
if ( ! V_13 -> V_43 ) {
F_31 ( & V_60 -> V_61 , L_82 ) ;
return V_40 ;
}
F_110 ( & V_60 -> V_61 , L_83 ,
( unsigned long ) V_43 -> V_311 , V_13 -> V_43 ) ;
V_13 -> V_84 = F_169 ( & V_60 -> V_61 , V_84 -> V_311 , F_37 ( V_84 ) ) ;
if ( ! V_13 -> V_84 ) {
F_31 ( & V_60 -> V_61 , L_84 ) ;
return V_40 ;
}
F_110 ( & V_60 -> V_61 , L_85 ,
...
F_130 ( V_268 ) ;
if ( V_60 -> V_61 . V_285 )
V_13 -> V_3 = F_146 ( V_60 , V_13 ) ;
else
V_13 -> V_3 = F_161 ( V_60 , V_13 ) ;
F_46 ( V_13 , 0 ) ;
if ( F_34 ( V_13 -> V_3 ) )
return F_166 ( V_13 -> V_3 ) ;
V_40 = F_171 ( & V_60 -> V_61 , V_246 , F_124 , 0 ,
L_87 , V_13 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_88 ,
V_246 , V_40 ) ;
...
V_13 -> V_246 = V_246 ;
if ( F_44 ( V_13 -> V_75 ) ) {
if ( ! F_172 ( & V_60 -> V_61 , V_13 -> V_75 , L_87 ) ) {
F_173 ( F_140 ( V_13 -> V_75 ) ,
V_312 ) ;
V_40 = F_174 ( & V_60 -> V_61 ,
F_140 ( V_13 -> V_75 ) , NULL ,
F_134 , V_313 ,
L_87 , V_13 ) ;
if ( V_40 ) {
V_13 -> V_75 = - V_175 ;
F_122 ( & V_13 -> V_60 -> V_61 ,
L_89
L_90 ) ;
}
} else {
...
V_40 = F_175 ( & V_60 -> V_61 , & V_13 -> V_65 ) ;
if ( V_40 )
return V_40 ;
F_176 ( & V_60 -> V_61 , 1 ) ;
F_33 ( V_13 ) ;
...
static int F_177 ( struct V_281 * V_60 )
{
struct V_37 * V_13 ;
int V_38 ;
V_13 = F_178 ( V_60 ) ;
...
static int F_180 ( struct V_197 * V_61 )
{
struct V_37 * V_13 = F_181 ( V_61 ) ;
if ( ! V_13 -> V_167 )
return 0 ;
F_135 ( & V_13 -> V_273 ) ;
if ( ! F_182 ( V_61 ) ) {
...
if ( F_44 ( V_13 -> V_75 ) ) {
F_133 ( V_13 ) ;
F_183 ( F_140 ( V_13 -> V_75 ) ) ;
}
V_42:
F_136 ( & V_13 -> V_273 ) ;
return 0 ;
}
static int F_184 ( struct V_197 * V_61 )
{
struct V_37 * V_13 = F_181 ( V_61 ) ;
if ( ! V_13 -> V_167 )
return 0 ;
if ( F_182 ( V_61 ) && F_44 ( V_13 -> V_75 ) )
F_185 ( F_140 ( V_13 -> V_75 ) ) ;
F_135 ( & V_13 -> V_273 ) ;
V_13 -> V_274 = F_43 ( V_13 ) ;
if ( V_13 -> V_274 )
F_132 ( V_13 ) ;
