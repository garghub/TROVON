...
F_274 ( V_25 ) ;
V_6 = F_275 ( V_25 , 0 ) ;
V_6 -> V_18 &= ~ ( V_616 | V_617 ) ;
ASSERT ( ! ( V_6 -> V_18 & V_618 ) ) ;
V_6 -> V_18 |= V_19 ;
V_6 -> V_203 = & V_321 ;
error = F_15 ( V_6 ) ;
if ( error ) {
...
V_615 = & V_25 -> V_27 ;
F_276 ( V_615 , F_277 ( V_6 ) ) ;
F_25 ( V_6 ) ;
F_278 ( V_25 ) ;
error = F_279 ( V_25 , V_615 -> V_507 , & V_25 -> V_619 ) ;
if ( error ) {
F_3 ( V_25 , L_93 , error ) ;
return error ;
}
V_25 -> V_620 = F_280 ( V_25 ) ;
F_281 ( log ) ;
log -> V_621 &= ~ V_622 ;
return 0 ;
}
...
L_98 ,
V_626 . V_627 ) ;
F_287 ( V_626 . V_627 * 1000 ) ;
}
F_286 ( log -> V_7 , L_99 ,
log -> V_7 -> V_628 ? log -> V_7 -> V_628
: L_100 ) ;
...
V_635 = 0LL ;
for ( V_497 = 0 ; V_497 < V_25 -> V_27 . V_507 ; V_497 ++ ) {
error = F_292 ( V_25 , NULL , V_497 , 0 , & V_632 ) ;
if ( error ) {
F_105 ( V_25 , L_104 ,
V_8 , V_497 , error ) ;
} else {
V_631 = F_293 ( V_632 ) ;
V_633 += F_28 ( V_631 -> V_636 ) +
F_28 ( V_631 -> V_637 ) ;
F_25 ( V_632 ) ;
}
error = F_252 ( V_25 , NULL , V_497 , & V_575 ) ;
