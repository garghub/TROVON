...
static int F_77 ( struct V_1 * V_2 , int V_200 )
{
if ( F_58 ( V_2 -> V_201 ) )
return 0 ;
switch ( V_200 ) {
...
static int F_79 ( struct V_130 * V_6 , struct V_116 * V_117 )
{
int V_91 ;
V_91 = F_80 ( V_6 , V_117 ) ;
if ( V_91 < 0 )
return V_91 ;
V_91 = F_77 ( F_63 ( V_6 ) , V_117 -> V_206 ) ;
if ( V_91 )
F_81 ( F_4 ( V_6 ) ,
L_46 , V_91 ) ;
return V_91 ;
...
V_33 -> V_207 [ 0 ] = F_7 ( V_2 , V_208 ) ;
}
static void F_83 ( struct V_1 * V_2 )
{
struct V_156 * V_33 = V_2 -> V_32 -> V_33 ;
T_1 * V_209 = V_33 -> V_207 , V_210 = 0 ;
int V_120 ;
if ( F_69 ( V_33 ) == V_166 )
return;
if ( ! ( V_2 -> V_101 & V_16 ) ) {
...
if ( V_120 )
V_209 [ 3 - V_120 ] = V_210 >> 24 ;
V_210 = F_7 ( V_2 , V_208 + V_120 * 8 ) ;
V_209 [ 3 - V_120 ] |= V_210 << 8 ;
}
else if ( V_33 -> V_34 == V_161 ||
V_33 -> V_34 == V_162 )
V_209 [ 0 ] = F_7 ( V_2 , V_30 ) ;
else
V_209 [ 0 ] = F_7 ( V_2 , V_208 ) ;
F_17 ( F_4 ( V_2 -> V_6 ) , L_48 , V_209 [ 0 ] ) ;
}
...
for ( V_120 = 0 ; V_120 < V_4 -> V_50 / 4 ; V_120 ++ , V_212 ++ )
* V_212 = F_7 ( V_2 , V_110 ) ;
V_213 = V_4 -> V_50 % 4 ;
for ( V_120 = 0 ; V_120 < ( V_213 + 1 ) / 2 ; V_120 ++ ) {
T_2 V_215 = F_9 ( V_2 , V_110 ) ;
( ( V_216 * ) V_212 ) [ 2 * V_120 ] = ( ( V_216 * ) & V_215 ) [ 0 ] ;
if ( V_213 > 1 && ! V_120 )
( ( V_216 * ) V_212 ) [ 2 * V_120 + 1 ] = ( ( V_216 * ) & V_215 ) [ 1 ] ;
}
return 0 ;
error:
F_17 ( F_4 ( V_2 -> V_6 ) , L_49 , V_7 , V_4 -> error ) ;
V_2 -> V_36 = V_155 ;
return V_4 -> error ;
}
...
for ( V_120 = 0 ; V_120 < ( V_213 + 1 ) / 2 ; V_120 ++ ) {
T_2 V_215 ;
( ( V_216 * ) & V_215 ) [ 0 ] = ( ( V_216 * ) V_212 ) [ 2 * V_120 ] ;
if ( V_213 > 1 && ! V_120 )
( ( V_216 * ) & V_215 ) [ 1 ] = ( ( V_216 * ) V_212 ) [ 2 * V_120 + 1 ] ;
else
( ( V_216 * ) & V_215 ) [ 1 ] = 0 ;
F_5 ( V_2 , V_110 , V_215 ) ;
}
...
static T_6 F_92 ( int V_225 , void * V_226 )
{
...
V_32 -> V_4 -> error = V_91 ;
F_18 ( F_4 ( V_2 -> V_6 ) , L_49 , V_7 , V_91 ) ;
break;
}
F_82 ( V_2 ) ;
V_32 -> V_154 -> error = 0 ;
...
F_18 ( F_4 ( V_2 -> V_6 ) , L_49 , V_7 ,
V_32 -> V_4 -> error ) ;
}
break;
default:
V_33 -> error = - V_229 ;
F_54 ( F_4 ( V_2 -> V_6 ) , L_51 , V_2 -> V_36 ) ;
F_66 ( V_2 ) ;
return V_228 ;
}
if ( V_227 ) {
...
F_18 ( F_4 ( V_2 -> V_6 ) , L_52 ,
V_7 , V_4 -> error ) ;
F_28 ( V_2 , true ) ;
}
} else if ( V_33 -> V_34 == V_230 ) {
V_2 -> V_157 = true ;
}
}
F_66 ( V_2 ) ;
...
static T_6 F_93 ( int V_225 , void * V_226 )
{
struct V_1 * V_2 = V_226 ;
T_2 V_188 , V_231 , error ;
V_188 = F_7 ( V_2 , V_99 ) & ~ V_2 -> V_10 &
~ V_232 ;
V_231 = F_7 ( V_2 , V_121 ) & ~ V_2 -> V_12 ;
F_14 ( V_2 ) ;
F_17 ( F_4 ( V_2 -> V_6 ) ,
L_53 , V_188 , V_231 ) ;
if ( ! V_188 && ! V_231 )
...
static T_6 F_94 ( int V_225 , void * V_226 )
{
struct V_1 * V_2 = V_226 ;
T_1 V_188 = F_7 ( V_2 , V_235 ) & ~ V_2 -> V_195 ;
F_17 ( F_4 ( V_2 -> V_6 ) , L_55 , V_7 , V_188 ) ;
if ( ! V_188 )
return V_233 ;
F_1 ( V_2 , V_235 , ~ V_188 ) ;
F_95 ( V_2 -> V_6 ) ;
...
static T_6 F_96 ( int V_225 , void * V_226 )
{
struct V_1 * V_2 = V_226 ;
struct V_130 * V_6 = V_2 -> V_6 ;
T_2 V_188 ;
...
static void F_100 ( struct V_241 * V_237 )
{
struct V_242 * V_215 = F_101 ( V_237 ) ;
struct V_1 * V_2 = F_102 ( V_215 , struct V_1 , V_183 ) ;
struct V_62 * V_32 = V_2 -> V_32 ;
...
if ( ! V_80 -> V_251 )
return - V_98 ;
V_247 = F_104 ( V_244 , L_58 ) ;
V_248 = F_104 ( V_244 , L_27 ) ;
V_249 = F_104 ( V_244 , L_59 ) ;
if ( V_248 < 0 || V_249 < 0 )
return - V_98 ;
V_6 = F_105 ( sizeof( struct V_1 ) , V_80 ) ;
if ( ! V_6 )
return - V_214 ;
V_91 = F_106 ( V_6 ) ;
if ( V_91 == - V_252 )
...
V_2 -> V_36 = V_155 ;
V_2 -> V_184 = F_99 ( 4000 ) ;
V_2 -> V_204 = F_108 ( & V_244 -> V_80 ) ;
if ( F_58 ( V_2 -> V_204 ) ) {
V_91 = F_109 ( V_2 -> V_204 ) ;
goto V_253;
}
V_2 -> V_201 = F_110 ( V_2 -> V_204 , L_60 ) ;
if ( ! F_58 ( V_2 -> V_201 ) ) {
V_2 -> V_205 = F_110 ( V_2 -> V_204 ,
V_254 ) ;
if ( F_58 ( V_2 -> V_205 ) ) {
F_54 ( V_80 ,
L_61 ) ;
V_91 = F_109 ( V_2 -> V_205 ) ;
goto V_253;
}
}
V_246 = F_111 ( V_244 , V_255 , 0 ) ;
V_2 -> V_5 = F_112 ( V_80 , V_246 ) ;
if ( F_58 ( V_2 -> V_5 ) ) {
V_91 = F_109 ( V_2 -> V_5 ) ;
goto V_253;
}
V_2 -> V_256 = F_113 ( V_80 , NULL ) ;
if ( F_58 ( V_2 -> V_256 ) ) {
V_91 = F_109 ( V_2 -> V_256 ) ;
goto V_253;
}
V_2 -> V_126 = F_114 ( V_2 -> V_256 ) ;
V_91 = F_115 ( V_2 -> V_256 ) ;
if ( V_91 < 0 )
goto V_253;
V_250 = F_7 ( V_2 , V_257 ) ;
if ( ( V_250 & 0xfff ) != 0xa0d ) {
F_54 ( V_80 , L_62 , V_250 ) ;
goto V_258;
}
F_116 ( V_80 , L_63 ,
F_7 ( V_2 , V_259 ) >> V_260 ) ;
...
V_91 = F_118 ( V_80 , V_248 , F_93 , F_92 , 0 ,
F_38 ( V_80 ) , V_2 ) ;
if ( V_91 < 0 )
goto V_258;
V_91 = F_117 ( V_80 , V_249 , F_94 , 0 ,
F_38 ( V_80 ) , V_2 ) ;
if ( V_91 < 0 )
goto V_258;
F_119 ( & V_2 -> V_183 , F_100 ) ;
F_49 ( V_2 , V_246 -> V_102 ) ;
V_6 -> V_263 = & V_264 ;
V_6 -> V_261 |= V_265 | V_266 |
V_267 ;
V_6 -> V_268 = 32 ;
V_6 -> V_269 = 512 ;
V_6 -> V_270 = V_61 * V_6 -> V_268 ;
V_6 -> V_271 = V_6 -> V_270 / V_6 -> V_269 ;
V_6 -> V_272 = V_6 -> V_270 ;
if ( ! V_6 -> V_273 )
V_6 -> V_273 = V_2 -> V_126 ;
V_6 -> V_274 = V_2 -> V_126 / 512 ;
F_120 ( V_244 , V_2 ) ;
V_91 = F_121 ( V_6 ) ;
if ( V_91 < 0 )
goto V_258;
...
static int F_124 ( struct V_243 * V_244 )
{
struct V_1 * V_2 = F_125 ( V_244 ) ;
F_126 ( V_2 -> V_6 ) ;
F_15 ( V_2 ) ;
F_73 ( & V_2 -> V_183 ) ;
F_33 ( V_2 ) ;
