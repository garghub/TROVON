...
V_83 = F_36 ( & V_67 -> V_54 , NULL ) ;
if ( F_37 ( V_83 ) )
return F_38 ( V_83 ) ;
V_22 = F_39 ( & V_86 , & V_67 -> V_54 , L_13 ) ;
if ( ! V_22 )
return - V_74 ;
V_82 = F_40 ( V_67 , V_87 , 0 ) ;
V_22 -> V_88 = F_41 ( & V_67 -> V_54 , V_82 ) ;
if ( F_37 ( V_22 -> V_88 ) ) {
V_55 = F_38 ( V_22 -> V_88 ) ;
goto V_89;
}
...
V_2 = F_10 ( V_22 ) ;
V_2 -> V_56 = V_83 ;
V_2 -> V_5 = ( void V_93 * ) V_22 -> V_88 ;
for ( V_84 = 0 ; V_84 < 3 ; ++ V_84 ) {
char V_94 [ 6 ] ;
if ( ! ( V_33 -> V_36 & ( V_37 << V_84 ) ) )
continue;
sprintf ( V_94 , L_14 , V_84 + 1 ) ;
V_2 -> V_18 [ V_84 ] = F_43 ( & V_67 -> V_54 , V_94 ) ;
}
...
struct V_21 * V_22 = F_17 ( V_54 ) ;
struct V_1 * V_2 = F_10 ( V_22 ) ;
struct V_79 * V_80 = F_45 ( V_22 ) ;
bool V_97 = F_53 ( V_54 ) ;
int V_19 ;
if ( F_54 ( V_98 , V_80 -> V_99 ) )
F_55 ( 5 ) ;
V_80 -> V_99 = V_98 ;
V_19 = F_56 ( V_22 , V_97 ) ;
if ( V_19 )
