...
return - V_133 ;
error = F_68 ( V_84 , NULL , V_8 , 0 , & V_74 ) ;
if ( error )
return error ;
V_2 = F_69 ( V_84 , NULL , V_74 , V_8 , NULL ) ;
F_76 ( & V_124 ) ;
memset ( & V_131 , 0 , sizeof( V_131 ) ) ;
memset ( & V_132 , 0 , sizeof( V_132 ) ) ;
V_131 . V_11 . V_12 = V_117 ;
V_132 . V_11 . V_12 = - 1U ;
error = F_98 ( V_2 , & V_131 , & V_132 ,
F_95 , & V_124 ) ;
if ( error )
goto V_134;
F_62 ( V_2 , V_76 ) ;
F_99 ( V_74 ) ;
F_100 (rr, &debris, rr_list) {
error = F_101 ( V_84 , & F_102 ( V_84 ) -> V_135 , 0 , 0 , 0 , & V_71 ) ;
if ( error )
goto V_136;
F_103 ( V_84 , V_8 , & V_126 -> V_127 ) ;
F_104 ( & V_57 , & V_121 ) ;
