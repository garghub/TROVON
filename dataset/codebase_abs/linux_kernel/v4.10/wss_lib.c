...
int F_113 ( struct V_5 * V_6 , int V_226 )
{
struct V_244 * V_217 ;
int V_135 ;
...
{
struct V_5 * V_6 = V_109 -> V_249 ;
V_6 -> V_109 = NULL ;
}
int F_119 ( struct V_5 * V_6 , int V_226 )
{
struct V_108 * V_109 ;
struct V_255 V_256 ;
int V_135 ;
V_256 . V_257 = V_258 ;
V_256 . V_259 = V_260 ;
V_256 . V_224 = V_6 -> V_224 -> V_261 ;
V_256 . V_226 = V_226 ;
V_256 . V_262 = 0 ;
if ( ( V_135 = F_120 ( V_6 -> V_224 , L_38 , & V_256 , & V_109 ) ) < 0 )
return V_135 ;
strcpy ( V_109 -> V_253 , F_102 ( V_6 ) ) ;
V_109 -> V_249 = V_6 ;
V_109 -> V_263 = F_118 ;
V_109 -> V_177 = V_264 ;
V_6 -> V_109 = V_109 ;
...
struct V_267 * V_268 )
{
static const char * const V_269 [ 4 ] = {
L_65 , L_66 , L_67 , L_68
} ;
static const char * const V_270 [ 4 ] = {
L_65 , L_69 , L_67 , L_68
} ;
static const char * const V_271 [ 4 ] = {
L_65 , L_70 , L_67 , L_68
} ;
const char * const * V_272 = V_269 ;
struct V_5 * V_6 = F_122 ( V_266 ) ;
if ( F_123 ( ! V_6 -> V_224 ) )
return - V_52 ;
if ( ! strcmp ( V_6 -> V_224 -> V_273 , L_71 ) )
V_272 = V_271 ;
switch ( V_6 -> V_30 ) {
case V_88 :
V_272 = V_271 ;
...
unsigned long V_22 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_275 -> V_14 . V_276 . V_277 [ 0 ] = ( V_6 -> V_18 [ V_75 ] & V_278 ) >> 6 ;
V_275 -> V_14 . V_276 . V_277 [ 1 ] = ( V_6 -> V_18 [ V_76 ] & V_278 ) >> 6 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
return 0 ;
}
static int F_126 ( struct V_265 * V_266 ,
struct V_274 * V_275 )
{
struct V_5 * V_6 = F_122 ( V_266 ) ;
unsigned long V_22 ;
...
int V_281 ;
if ( V_275 -> V_14 . V_276 . V_277 [ 0 ] > 3 ||
V_275 -> V_14 . V_276 . V_277 [ 1 ] > 3 )
return - V_52 ;
V_279 = V_275 -> V_14 . V_276 . V_277 [ 0 ] << 6 ;
V_280 = V_275 -> V_14 . V_276 . V_277 [ 1 ] << 6 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_279 = ( V_6 -> V_18 [ V_75 ] & ~ V_278 ) | V_279 ;
V_280 = ( V_6 -> V_18 [ V_76 ] & ~ V_278 ) | V_280 ;
V_281 = V_279 != V_6 -> V_18 [ V_75 ] ||
V_280 != V_6 -> V_18 [ V_76 ] ;
F_12 ( V_6 , V_75 , V_279 ) ;
F_12 ( V_6 , V_76 , V_280 ) ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
...
int F_127 ( struct V_265 * V_266 ,
struct V_267 * V_268 )
{
int V_282 = ( V_266 -> V_283 >> 16 ) & 0xff ;
V_268 -> type = V_282 == 1 ? V_284 : V_285 ;
V_268 -> V_137 = 1 ;
V_268 -> V_14 . integer . V_286 = 0 ;
V_268 -> V_14 . integer . V_287 = V_282 ;
return 0 ;
}
int F_128 ( struct V_265 * V_266 ,
struct V_274 * V_275 )
{
struct V_5 * V_6 = F_122 ( V_266 ) ;
unsigned long V_22 ;
int V_13 = V_266 -> V_283 & 0xff ;
int V_288 = ( V_266 -> V_283 >> 8 ) & 0xff ;
int V_282 = ( V_266 -> V_283 >> 16 ) & 0xff ;
int V_289 = ( V_266 -> V_283 >> 24 ) & 0xff ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_275 -> V_14 . integer . V_14 [ 0 ] = ( V_6 -> V_18 [ V_13 ] >> V_288 ) & V_282 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
if ( V_289 )
V_275 -> V_14 . integer . V_14 [ 0 ] = V_282 - V_275 -> V_14 . integer . V_14 [ 0 ] ;
return 0 ;
}
int F_129 ( struct V_265 * V_266 ,
struct V_274 * V_275 )
{
struct V_5 * V_6 = F_122 ( V_266 ) ;
unsigned long V_22 ;
...
int V_281 ;
unsigned short V_8 ;
V_8 = ( V_275 -> V_14 . integer . V_14 [ 0 ] & V_282 ) ;
if ( V_289 )
V_8 = V_282 - V_8 ;
V_8 <<= V_288 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_8 = ( V_6 -> V_18 [ V_13 ] & ~ ( V_282 << V_288 ) ) | V_8 ;
V_281 = V_8 != V_6 -> V_18 [ V_13 ] ;
F_12 ( V_6 , V_13 , V_8 ) ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
return V_281 ;
}
int F_130 ( struct V_265 * V_266 ,
struct V_267 * V_268 )
{
int V_282 = ( V_266 -> V_283 >> 24 ) & 0xff ;
V_268 -> type = V_282 == 1 ? V_284 : V_285 ;
V_268 -> V_137 = 2 ;
V_268 -> V_14 . integer . V_286 = 0 ;
V_268 -> V_14 . integer . V_287 = V_282 ;
...
int F_131 ( struct V_265 * V_266 ,
struct V_274 * V_275 )
{
struct V_5 * V_6 = F_122 ( V_266 ) ;
unsigned long V_22 ;
int V_290 = V_266 -> V_283 & 0xff ;
int V_291 = ( V_266 -> V_283 >> 8 ) & 0xff ;
int V_292 = ( V_266 -> V_283 >> 16 ) & 0x07 ;
int V_293 = ( V_266 -> V_283 >> 19 ) & 0x07 ;
int V_282 = ( V_266 -> V_283 >> 24 ) & 0xff ;
int V_289 = ( V_266 -> V_283 >> 22 ) & 1 ;
F_23 ( & V_6 -> V_23 , V_22 ) ;
V_275 -> V_14 . integer . V_14 [ 0 ] = ( V_6 -> V_18 [ V_290 ] >> V_292 ) & V_282 ;
V_275 -> V_14 . integer . V_14 [ 1 ] = ( V_6 -> V_18 [ V_291 ] >> V_293 ) & V_282 ;
F_24 ( & V_6 -> V_23 , V_22 ) ;
if ( V_289 ) {
V_275 -> V_14 . integer . V_14 [ 0 ] = V_282 - V_275 -> V_14 . integer . V_14 [ 0 ] ;
V_275 -> V_14 . integer . V_14 [ 1 ] = V_282 - V_275 -> V_14 . integer . V_14 [ 1 ] ;
}
return 0 ;
}
...
int V_289 = ( V_266 -> V_283 >> 22 ) & 1 ;
int V_281 ;
unsigned short V_294 , V_295 ;
V_294 = V_275 -> V_14 . integer . V_14 [ 0 ] & V_282 ;
V_295 = V_275 -> V_14 . integer . V_14 [ 1 ] & V_282 ;
if ( V_289 ) {
V_294 = V_282 - V_294 ;
V_295 = V_282 - V_295 ;
}
...
F_23 ( & V_6 -> V_23 , V_22 ) ;
if ( V_290 != V_291 ) {
V_294 = ( V_6 -> V_18 [ V_290 ] & ~ ( V_282 << V_292 ) ) | V_294 ;
V_295 = ( V_6 -> V_18 [ V_291 ] & ~ ( V_282 << V_293 ) ) | V_295 ;
V_281 = V_294 != V_6 -> V_18 [ V_290 ] ||
V_295 != V_6 -> V_18 [ V_291 ] ;
F_12 ( V_6 , V_290 , V_294 ) ;
F_12 ( V_6 , V_291 , V_295 ) ;
} else {
V_282 = ( V_282 << V_292 ) | ( V_282 << V_293 ) ;
V_294 = ( V_6 -> V_18 [ V_290 ] & ~ V_282 ) | V_294 | V_295 ;
V_281 = V_294 != V_6 -> V_18 [ V_290 ] ;
F_12 ( V_6 , V_290 , V_294 ) ;
}
F_24 ( & V_6 -> V_23 , V_22 ) ;
...
unsigned int V_296 ;
int V_135 ;
int V_137 = F_38 ( V_297 ) ;
if ( F_123 ( ! V_6 || ! V_6 -> V_217 ) )
return - V_52 ;
V_224 = V_6 -> V_224 ;
strcpy ( V_224 -> V_298 , V_6 -> V_217 -> V_253 ) ;
if ( V_6 -> V_30 & V_84 )
V_137 = 11 ;
else if ( V_6 -> V_30 == V_192 )
V_137 = 9 ;
for ( V_296 = 0 ; V_296 < V_137 ; V_296 ++ ) {
V_135 = F_134 ( V_224 ,
F_135 ( & V_297 [ V_296 ] ,
V_6 ) ) ;
if ( V_135 < 0 )
...
const struct V_299 * F_136 ( int V_300 )
{
return V_300 == V_245 ?
& V_246 : & V_248 ;
}
