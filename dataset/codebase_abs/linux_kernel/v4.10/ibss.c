...
void F_32 ( struct V_1 * V_2 , bool V_70 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
F_27 ( V_7 ) ;
F_29 ( V_2 , V_70 ) ;
...
V_75 = F_39 ( V_7 -> V_67 . V_86 , sizeof( * V_75 ) , V_23 ) ;
if ( ! V_75 )
return - V_89 ;
...
V_44 = 0 ;
if ( V_7 -> V_15 )
V_44 = F_33 ( V_30 , V_2 , true ) ;
F_28 ( V_7 ) ;
if ( V_44 )
return V_44 ;
if ( V_51 ) {
F_37 ( & V_7 -> V_67 . V_68 . V_50 , V_51 ,
V_84 ) ;
