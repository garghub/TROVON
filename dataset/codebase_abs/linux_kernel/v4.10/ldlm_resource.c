...
struct V_85 * V_86 , void * V_157 )
{
struct V_61 * V_28 = F_106 ( V_66 , V_86 ) ;
T_5 V_141 = * ( T_5 * ) V_157 ;
F_87 ( V_28 , & V_28 -> V_158 , V_141 ) ;
...
static int F_112 ( struct V_25 * V_26 , int V_163 )
{
F_83 ( V_26 , V_163 ? V_143 : 0 ) ;
if ( F_47 ( & V_26 -> V_128 ) > 0 ) {
struct V_164 V_165 = F_113 ( V_166 , NULL ) ;
int V_8 ;
F_21 ( V_6 ,
L_29 ,
...
V_167:
if ( V_163 )
V_165 = F_114 ( F_115 ( V_168 *
V_169 ) / 4 , NULL , NULL ) ;
V_8 = F_116 ( V_26 -> V_129 ,
F_47 ( & V_26 -> V_128 ) == 0 , & V_165 ) ;
if ( V_163 && V_8 == - V_170 ) {
F_117 ( L_30 ,
F_22 ( V_26 ) ,
F_47 ( & V_26 -> V_128 ) , V_8 ) ;
...
struct V_61 * V_28 ;
int V_103 ;
V_28 = F_141 ( V_175 , V_108 ) ;
if ( ! V_28 )
return NULL ;
F_77 ( & V_28 -> V_158 ) ;
F_77 ( & V_28 -> V_159 ) ;
for ( V_103 = 0 ; V_103 < V_176 ; V_103 ++ ) {
V_28 -> V_177 [ V_103 ] . V_178 = 0 ;
V_28 -> V_177 [ V_103 ] . V_179 = 1 << V_103 ;
V_28 -> V_177 [ V_103 ] . V_180 = NULL ;
}
F_79 ( & V_28 -> V_63 , 1 ) ;
F_78 ( & V_28 -> V_181 ) ;
F_142 ( & V_28 -> V_182 ) ;
...
struct V_61 *
F_144 ( struct V_25 * V_26 , struct V_61 * V_184 ,
const struct V_69 * V_73 , enum V_185 type ,
int V_186 )
{
struct V_85 * V_86 ;
...
if ( V_186 == 0 )
return F_149 ( - V_190 ) ;
F_150 ( type >= V_191 && type < V_192 ,
L_33 , type ) ;
V_28 = F_140 () ;
if ( ! V_28 )
return F_149 ( - V_12 ) ;
V_28 -> V_193 = F_75 ( V_26 -> V_109 , & V_30 ) ;
V_28 -> V_88 = * V_73 ;
V_28 -> V_194 = type ;
F_151 ( V_26 -> V_109 , & V_30 , 1 ) ;
V_86 = ( V_187 == F_148 ( & V_30 ) ) ? NULL :
...
V_189:
V_28 = F_55 ( V_86 , struct V_61 , V_87 ) ;
if ( V_26 -> V_195 && V_26 -> V_195 -> V_189 ) {
F_65 ( & V_28 -> V_183 ) ;
F_70 ( & V_28 -> V_183 ) ;
}
if ( F_154 ( V_28 -> V_196 < 0 ) ) {
V_8 = V_28 -> V_196 ;
F_63 ( V_28 ) ;
V_28 = F_149 ( V_8 ) ;
}
...
if ( V_26 -> V_195 && V_26 -> V_195 -> V_189 ) {
F_156 ( V_197 , 2 ) ;
V_8 = V_26 -> V_195 -> V_189 ( V_28 ) ;
if ( V_8 < 0 ) {
F_6 ( L_34 ,
V_26 -> V_123 -> V_198 , V_73 -> V_73 [ 0 ] ,
V_73 -> V_73 [ 1 ] , V_8 ) ;
V_28 -> V_196 = V_8 ;
F_70 ( & V_28 -> V_183 ) ;
F_63 ( V_28 ) ;
...
F_157 ( & V_30 , V_28 ) ;
F_147 ( V_26 -> V_109 , & V_30 , 1 ) ;
if ( V_26 -> V_195 && V_26 -> V_195 -> V_200 )
V_26 -> V_195 -> V_200 ( V_28 ) ;
F_153 ( V_175 , V_28 ) ;
return 1 ;
}
return 0 ;
...
void F_164 ( struct V_61 * V_28 , struct V_139 * V_201 ,
struct V_144 * V_145 )
{
F_165 ( V_28 ) ;
F_98 ( V_145 , L_36 ) ;
...
F_167 ( & V_145 -> V_148 , V_201 ) ;
}
void F_168 ( struct V_144 * V_145 )
{
int type = V_145 -> V_203 -> V_194 ;
F_165 ( V_145 -> V_203 ) ;
...
void F_171 ( struct V_61 * V_28 , struct V_207 * V_208 )
{
V_208 -> V_194 = V_28 -> V_194 ;
V_208 -> V_88 = V_28 -> V_88 ;
}
void F_2 ( enum V_89 V_90 , int V_209 )
{
struct V_139 * V_39 ;
if ( ! ( ( V_210 | V_161 ) & V_209 ) )
return;
F_65 ( F_66 ( V_90 ) ) ;
...
{
struct V_61 * V_28 = F_106 ( V_66 , V_86 ) ;
int V_209 = ( int ) ( unsigned long ) V_157 ;
F_88 ( V_28 ) ;
F_110 ( V_209 , V_28 ) ;
F_94 ( V_28 ) ;
return 0 ;
}
void F_172 ( int V_209 , struct V_25 * V_26 )
{
if ( ! ( ( V_210 | V_161 ) & V_209 ) )
return;
F_21 ( V_209 , L_38 ,
F_22 ( V_26 ) , F_47 ( & V_26 -> V_128 ) ) ;
if ( F_174 ( F_175 () , V_26 -> V_211 ) )
return;
F_111 ( V_26 -> V_109 ,
F_173 ,
( void * ) ( unsigned long ) V_209 , 0 ) ;
F_119 ( & V_26 -> V_127 ) ;
V_26 -> V_211 = F_176 ( 10 ) ;
F_120 ( & V_26 -> V_127 ) ;
}
void F_110 ( int V_209 , struct V_61 * V_28 )
{
struct V_144 * V_145 ;
