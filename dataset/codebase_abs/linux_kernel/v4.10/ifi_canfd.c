...
( V_154 << V_164 ) ,
V_5 -> V_17 + V_166 ) ;
V_157 = ( V_151 -> V_153 * ( V_151 -> V_159 + 1 ) ) & V_167 ;
F_3 ( V_168 | V_169 | V_157 ,
V_5 -> V_17 + V_170 ) ;
}
static void F_30 ( struct V_1 * V_2 , const T_1 V_31 ,
const T_1 V_171 , const T_1 V_172 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_3 ( V_171 , V_5 -> V_17 + F_31 ( V_31 ) ) ;
F_3 ( V_172 , V_5 -> V_17 + F_32 ( V_31 ) ) ;
}
...
struct V_4 * V_5 = F_2 ( V_2 ) ;
T_1 V_122 ;
F_3 ( V_179 , V_5 -> V_17 + V_132 ) ;
F_3 ( V_180 ,
V_5 -> V_17 + V_132 ) ;
F_29 ( V_2 ) ;
F_33 ( V_2 ) ;
F_3 ( V_181 , V_5 -> V_17 + V_59 ) ;
F_3 ( 0 , V_5 -> V_17 + V_59 ) ;
F_3 ( V_182 , V_5 -> V_17 + V_183 ) ;
F_3 ( 0 , V_5 -> V_17 + V_183 ) ;
F_3 ( 0 , V_5 -> V_17 + V_184 ) ;
F_3 ( 0 , V_5 -> V_17 + V_185 ) ;
F_3 ( ( T_1 ) ( ~ V_142 ) ,
V_5 -> V_17 + V_60 ) ;
V_122 = V_186 | V_187 |
V_180 ;
if ( V_5 -> V_9 . V_10 & V_188 )
V_122 |= V_189 ;
if ( V_5 -> V_9 . V_10 & V_190 )
V_122 |= V_191 ;
if ( ( V_5 -> V_9 . V_10 & V_192 ) &&
! ( V_5 -> V_9 . V_10 & V_193 ) )
V_122 |= V_194 ;
if ( ! ( V_5 -> V_9 . V_10 & V_192 ) )
V_122 |= V_195 ;
...
static int F_36 ( struct V_1 * V_2 , enum V_198 V_199 )
{
switch ( V_199 ) {
case V_200 :
F_34 ( V_2 ) ;
...
V_202 = F_39 ( V_2 -> V_136 , F_25 , V_203 ,
V_2 -> V_204 , V_2 ) ;
if ( V_202 < 0 ) {
F_15 ( V_2 , L_8 ) ;
goto V_205;
...
F_44 ( V_2 ) ;
if ( V_22 -> V_48 & V_47 ) {
V_209 = V_22 -> V_48 & V_214 ;
V_209 = ( V_209 >> V_215 ) |
( ( V_209 & V_216 ) <<
V_217 ) ;
V_209 |= V_218 ;
} else {
V_209 = V_22 -> V_48 & V_219 ;
}
V_210 = F_49 ( V_22 -> V_39 ) ;
if ( ( V_5 -> V_9 . V_10 & V_192 ) && F_50 ( V_24 ) ) {
V_210 |= V_220 ;
if ( V_22 -> V_50 & V_55 )
V_210 |= V_221 ;
}
...
F_3 ( V_210 , V_5 -> V_17 + V_224 ) ;
for ( V_32 = 0 ; V_32 < V_22 -> V_39 ; V_32 += 4 ) {
F_3 ( * ( T_1 * ) ( V_22 -> V_56 + V_32 ) ,
V_5 -> V_17 + V_225 + V_32 ) ;
}
F_3 ( 0 , V_5 -> V_17 + V_226 ) ;
F_3 ( 0 , V_5 -> V_17 + V_227 ) ;
F_51 ( V_24 , V_2 , 0 ) ;
F_3 ( V_228 , V_5 -> V_17 + V_183 ) ;
return V_211 ;
}
static int F_52 ( struct V_229 * V_230 )
{
struct V_231 * V_130 = & V_230 -> V_130 ;
struct V_1 * V_2 ;
struct V_4 * V_5 ;
struct V_232 * V_233 ;
void T_5 * V_234 ;
int V_136 , V_202 ;
T_1 V_31 ;
V_233 = F_53 ( V_230 , V_235 , 0 ) ;
V_234 = F_54 ( V_130 , V_233 ) ;
V_136 = F_55 ( V_230 , 0 ) ;
if ( F_56 ( V_234 ) || V_136 < 0 )
return - V_236 ;
V_31 = F_5 ( V_234 + V_237 ) ;
if ( V_31 != V_238 ) {
...
V_5 -> V_9 . V_111 = V_197 ;
V_5 -> V_9 . clock . V_243 = F_5 ( V_234 + V_244 ) ;
V_5 -> V_9 . V_245 = & V_246 ;
V_5 -> V_9 . V_247 = & V_246 ;
V_5 -> V_9 . V_248 = F_36 ;
V_5 -> V_9 . V_249 = F_19 ;
...
V_202 = F_62 ( V_2 ) ;
if ( V_202 ) {
F_57 ( V_130 , L_11 , V_202 ) ;
goto V_251;
}
F_63 ( V_2 ) ;
F_64 ( V_130 , L_12 ,
V_5 -> V_17 , V_2 -> V_136 , V_5 -> V_9 . clock . V_243 ) ;
return 0 ;
V_251:
F_65 ( V_2 ) ;
return V_202 ;
}
static int F_66 ( struct V_229 * V_230 )
{
struct V_1 * V_2 = F_67 ( V_230 ) ;
F_68 ( V_2 ) ;
F_60 ( V_230 , NULL ) ;
F_65 ( V_2 ) ;
return 0 ;
