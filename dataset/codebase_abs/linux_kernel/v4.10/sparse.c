...
int T_1 F_74 ( struct V_86 * V_86 , unsigned long V_16 )
{
unsigned long V_3 = F_16 ( V_16 ) ;
struct V_40 * V_41 = V_86 -> V_87 ;
struct V_6 * V_10 ;
struct V_1 * V_72 ;
unsigned long * V_49 ;
unsigned long V_88 ;
...
static void F_79 ( struct V_1 * V_72 , int V_28 )
{
int V_80 ;
if ( ! V_72 )
return;
...
static inline void F_79 ( struct V_1 * V_72 , int V_28 )
{
}
static void F_83 ( struct V_1 * V_72 , unsigned long * V_49 )
{
struct V_1 * V_91 ;
if ( ! V_49 )
return;
V_91 = F_71 ( V_49 ) ;
if ( F_84 ( V_91 ) || F_85 ( V_91 ) ) {
F_78 ( V_49 ) ;
if ( V_72 )
F_59 ( V_72 ) ;
return;
...
void F_86 ( struct V_86 * V_86 , struct V_6 * V_10 ,
unsigned long V_92 )
{
struct V_1 * V_72 = NULL ;
unsigned long * V_49 = NULL , V_88 ;
struct V_40 * V_41 = V_86 -> V_87 ;
F_75 ( V_41 , & V_88 ) ;
if ( V_10 -> V_15 ) {
V_49 = V_10 -> V_36 ;
