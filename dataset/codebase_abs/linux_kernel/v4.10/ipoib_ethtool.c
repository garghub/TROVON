...
F_3 ( V_6 -> V_7 , V_4 -> V_8 ,
sizeof( V_4 -> V_8 ) ) ;
F_4 ( V_4 -> V_9 , F_5 ( V_6 -> V_7 -> V_10 ) ,
sizeof( V_4 -> V_9 ) ) ;
F_4 ( V_4 -> V_11 , V_12 ,
sizeof( V_4 -> V_11 ) ) ;
F_4 ( V_4 -> V_13 , L_1 , sizeof( V_4 -> V_13 ) ) ;
}
...
{
int V_29 ;
struct V_30 * V_31 = & V_14 -> V_27 ;
T_3 * V_32 = ( T_3 * ) V_31 ;
for ( V_29 = 0 ; V_29 < V_33 ; V_29 ++ )
V_28 [ V_29 ] = * ( T_2 * ) ( V_32 + V_34 [ V_29 ] . V_35 ) ;
}
static void F_11 ( struct V_1 T_1 * V_14 ,
T_4 V_36 , T_3 * V_28 )
{
T_3 * V_32 = V_28 ;
int V_29 ;
...
static int F_12 ( struct V_1 T_1 * V_14 ,
int V_41 )
{
switch ( V_41 ) {
case V_37 :
