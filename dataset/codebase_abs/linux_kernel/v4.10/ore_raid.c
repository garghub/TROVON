...
static void F_13 ( struct V_7 * V_9 )
{
unsigned V_26 ;
if ( ! V_9 )
return;
...
static unsigned F_16 ( struct V_7 * V_9 )
{
int V_3 ;
for ( V_3 = V_9 -> V_4 - 1 ; V_3 >= 0 ; -- V_3 ) {
struct V_13 * V_35 = & V_9 -> V_14 [ V_3 ] ;
...
static void F_17 ( struct V_7 * V_9 )
{
unsigned V_3 ;
unsigned V_39 = V_40 ;
if ( V_9 -> V_6 == 1 )
...
if ( V_9 -> V_6 == 1 )
V_35 -> V_38 = F_19 ( V_35 -> V_17 [ V_9 -> V_10 ] ,
V_35 -> V_17 , 0 , V_9 -> V_10 ,
V_27 , & V_35 -> V_42 ) ;
else
V_35 -> V_38 = F_20 ( V_35 -> V_17 , 0 ,
V_9 -> V_10 + V_9 -> V_6 ,
V_27 , & V_35 -> V_42 ) ;
}
for ( V_3 = 0 ; V_3 < V_9 -> V_4 ; V_3 ++ ) {
...
void F_23 ( struct V_48 * V_49 , unsigned V_50 ,
bool V_51 )
{
struct V_52 * V_53 ;
F_9 ( L_3
...
V_66 = F_26 ( V_65 , V_63 -> V_68 ,
V_65 -> V_5 * V_65 -> V_69 ,
V_67 , 0 , & V_63 -> V_70 ) ;
return V_66 ;
}
static int F_27 ( struct V_62 * V_63 , struct V_44 * V_45 ,
...
V_73 = F_29 ( F_30 ( V_74 -> V_68 , V_49 -> V_54 ) ) ;
V_77 = F_31 ( V_73 , V_49 -> V_79 , V_1 , V_71 ,
V_45 -> V_80 % V_27 ) ;
if ( F_8 ( V_77 != V_71 ) ) {
F_9 ( L_6 ,
V_49 -> V_79 -> V_82 ) ;
...
static int F_32 ( struct V_62 * V_63 , struct V_1 * V_1 )
{
struct V_44 V_45 ;
unsigned V_71 ;
F_33 ( V_63 -> V_65 , V_63 -> V_56 , 0 , & V_45 ) ;
V_71 = V_45 . V_80 % V_27 ;
V_45 . V_80 -= V_71 ;
F_9 ( L_7 ,
F_24 ( V_45 . V_80 ) , V_71 , V_1 -> V_83 , V_45 . V_54 ) ;
return F_27 ( V_63 , & V_45 , V_1 , V_71 ) ;
}
static int F_34 ( struct V_62 * V_63 , T_1 * V_56 )
{
struct V_44 V_45 ;
struct V_1 * V_1 ;
unsigned V_71 , V_3 , V_33 ;
F_33 ( V_63 -> V_65 , * V_56 , 0 , & V_45 ) ;
V_3 = V_45 . V_46 ;
V_33 = V_45 . V_47 ;
...
* V_56 += V_71 ;
F_9 ( L_8 ,
V_3 , V_33 , F_24 ( * V_56 ) , V_71 , V_45 . V_54 , V_45 . V_85 ) ;
F_6 ( ! V_1 ) ;
return F_27 ( V_63 , & V_45 , V_1 , V_71 ) ;
}
static void F_35 ( struct V_62 * V_63 , int V_66 )
{
struct V_86 * V_87 ;
unsigned V_26 , V_88 ;
...
V_66 = F_48 ( V_63 , & V_108 , 0 , V_17 ,
V_49 , V_107 * V_27 ) ;
if ( F_8 ( V_66 ) )
return V_66 ;
if ( V_103 ) {
F_17 ( V_9 ) ;
F_12 ( V_9 , V_63 -> V_31 , V_63 -> V_98 ) ;
}
}
return 0 ;
}
...
if ( V_63 -> V_110 )
F_14 ( V_63 -> V_105 ) ;
F_12 ( V_63 -> V_9 , V_63 -> V_31 , V_63 -> V_98 ) ;
F_13 ( V_63 -> V_9 ) ;
} else {
if ( V_63 -> V_110 )
F_14 ( V_63 -> V_49 [ 0 ] . V_59 ) ;
}
if ( V_63 -> V_70 )
F_46 ( V_63 -> V_70 ) ;
}
