...
static T_1 F_66 ( struct V_35 * V_19 , T_5 V_104 ,
T_3 V_34 , int V_51 )
{
T_1 V_62 ;
struct V_2 * V_3 = F_51 ( V_19 ) ;
...
T_1 F_70 ( struct V_35 * V_19 , struct V_64 * V_64 ,
unsigned long V_31 , T_3 V_34 , int V_51 )
{
return F_66 ( V_19 , F_59 ( V_64 ) + V_31 , V_34 , V_51 ) ;
}
void F_71 ( struct V_35 * V_19 , T_1 V_77 , T_3 V_34 ,
enum V_48 V_49 , unsigned long V_80 )
{
F_33 ( F_51 ( V_19 ) , V_77 ) ;
}
static int F_72 ( struct V_35 * V_19 , struct V_107 * V_108 , int V_109 ,
T_1 V_62 )
{
struct V_107 * V_110 , * V_111 = V_108 ;
unsigned long V_112 = F_73 ( V_19 ) ;
unsigned int V_113 = 0 , V_114 = F_74 ( V_19 ) ;
int V_69 , V_66 = 0 ;
F_75 (sg, s, nents, i) {
unsigned int V_115 = F_76 ( V_110 ) ;
unsigned int V_116 = F_77 ( V_110 ) ;
...
static void F_79 ( struct V_107 * V_108 , int V_109 )
{
struct V_107 * V_110 ;
int V_69 ;
F_75 (sg, s, nents, i) {
if ( F_76 ( V_110 ) != V_79 )
V_110 -> V_31 += F_76 ( V_110 ) ;
if ( F_77 ( V_110 ) )
V_110 -> V_61 = F_77 ( V_110 ) ;
F_76 ( V_110 ) = V_79 ;
F_77 ( V_110 ) = 0 ;
}
}
int F_80 ( struct V_35 * V_19 , struct V_107 * V_108 ,
int V_109 , int V_51 )
{
struct V_2 * V_3 = F_51 ( V_19 ) ;
struct V_1 * V_6 = F_1 ( V_3 ) ;
...
goto V_88;
return F_72 ( V_19 , V_108 , V_109 , V_62 ) ;
V_88:
F_38 ( V_6 , V_58 ) ;
V_122:
F_79 ( V_108 , V_109 ) ;
...
void F_81 ( struct V_35 * V_19 , struct V_107 * V_108 , int V_109 ,
enum V_48 V_49 , unsigned long V_80 )
{
F_33 ( F_51 ( V_19 ) , F_76 ( V_108 ) ) ;
}
T_1 F_82 ( struct V_35 * V_19 , T_5 V_104 ,
T_3 V_34 , enum V_48 V_49 , unsigned long V_80 )
{
return F_66 ( V_19 , V_104 , V_34 ,
F_27 ( V_49 , false ) | V_123 ) ;
}
void F_83 ( struct V_35 * V_19 , T_1 V_77 ,
T_3 V_34 , enum V_48 V_49 , unsigned long V_80 )
{
F_33 ( F_51 ( V_19 ) , V_77 ) ;
}
int F_84 ( struct V_35 * V_19 , T_2 V_120 )
{
return 1 ;
}
int F_85 ( struct V_35 * V_19 , T_1 V_62 )
{
return V_62 == V_79 ;
}
static struct V_13 * F_86 ( struct V_35 * V_19 ,
T_5 V_124 , struct V_2 * V_3 )
{
struct V_4 * V_7 = V_3 -> V_5 ;
struct V_13 * V_125 ;
struct V_1 * V_6 = & V_7 -> V_6 ;
struct V_58 * V_58 ;
int V_51 = V_55 | V_126 | V_123 ;
V_124 &= ~ ( T_5 ) F_87 ( V_6 ) ;
F_88 (msi_page, &cookie->msi_page_list, list)
if ( V_125 -> V_104 == V_124 )
return V_125 ;
V_125 = F_5 ( sizeof( * V_125 ) , V_127 ) ;
if ( ! V_125 )
return NULL ;
...
goto V_128;
V_125 -> V_104 = V_124 ;
V_125 -> V_58 = F_61 ( V_6 , V_58 ) ;
if ( F_69 ( V_3 , V_125 -> V_58 , V_124 , V_6 -> V_16 , V_51 ) )
goto V_88;
F_7 ( & V_125 -> V_17 ) ;
F_89 ( & V_125 -> V_17 , & V_7 -> V_12 ) ;
return V_125 ;
V_88:
F_38 ( V_6 , V_58 ) ;
V_128:
...
void F_90 ( int V_129 , struct V_130 * V_131 )
{
struct V_35 * V_19 = F_91 ( F_92 ( V_129 ) ) ;
struct V_2 * V_3 = F_51 ( V_19 ) ;
struct V_4 * V_7 ;
struct V_13 * V_125 ;
T_5 V_124 = ( T_2 ) V_131 -> V_132 << 32 | V_131 -> V_133 ;
unsigned long V_134 ;
if ( ! V_3 || ! V_3 -> V_5 )
return;
V_7 = V_3 -> V_5 ;
F_93 ( & V_7 -> V_11 , V_134 ) ;
V_125 = F_86 ( V_19 , V_124 , V_3 ) ;
F_94 ( & V_7 -> V_11 , V_134 ) ;
if ( F_35 ( ! V_125 ) ) {
V_131 -> V_132 = ~ 0U ;
V_131 -> V_133 = ~ 0U ;
...
V_131 -> V_132 = F_95 ( V_125 -> V_58 ) ;
V_131 -> V_133 &= F_87 ( & V_7 -> V_6 ) ;
V_131 -> V_133 += F_96 ( V_125 -> V_58 ) ;
}
}
