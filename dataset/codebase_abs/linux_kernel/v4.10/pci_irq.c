...
V_63 = F_30 ( & V_18 -> V_18 , V_56 , V_57 , V_58 ) ;
if ( V_63 < 0 ) {
F_21 ( & V_18 -> V_18 , L_16 ,
F_1 ( V_1 ) ) ;
F_17 ( V_3 ) ;
...
V_18 -> V_64 = 1 ;
if ( V_28 )
snprintf ( V_62 , sizeof( V_62 ) , L_17 , V_28 ) ;
else
V_62 [ 0 ] = '\0' ;
F_35 ( & V_18 -> V_18 , L_18 ,
F_1 ( V_1 ) , V_62 , V_56 ,
...
T_3 V_1 ;
V_1 = V_18 -> V_1 ;
if ( ! V_1 || ! V_18 -> V_64 || V_18 -> V_51 <= 0 )
return;
if ( V_18 -> V_18 . V_66 . V_67 )
return;
#ifdef F_37
if ( V_18 -> V_18 . V_66 . V_68 == V_69 )
return;
#endif
V_3 = F_22 ( V_18 , V_1 ) ;
if ( ! V_3 )
