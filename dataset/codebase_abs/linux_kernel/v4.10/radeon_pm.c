...
static T_2 F_40 ( struct V_96 * V_97 ,
struct V_98 * V_99 ,
const char * V_100 ,
T_3 V_106 )
{
...
static T_2 F_58 ( struct V_96 * V_97 ,
struct V_98 * V_99 ,
char * V_100 )
{
struct V_1 * V_2 = F_37 ( V_97 ) ;
int V_141 = F_59 ( V_99 ) -> V_142 ;
int V_139 ;
if ( V_141 )
...
static T_4 F_60 ( struct V_146 * V_147 ,
struct V_148 * V_99 , int V_142 )
{
struct V_96 * V_97 = F_61 ( V_147 ) ;
struct V_1 * V_2 = F_37 ( V_97 ) ;
...
return V_133 ;
V_2 -> V_8 . V_170 = F_63 ( V_2 -> V_97 ,
L_28 , V_2 ,
V_171 ) ;
if ( F_64 ( V_2 -> V_8 . V_170 ) ) {
V_133 = F_65 ( V_2 -> V_8 . V_170 ) ;
F_66 ( V_2 -> V_97 ,
L_29 , V_133 ) ;
}
break;
...
static void F_69 ( struct V_172 * V_173 )
{
struct V_1 * V_2 =
F_70 ( V_173 , struct V_1 ,
...
if ( V_178 && ( F_73 ( V_2 ) >= 120 ) )
V_178 = false ;
return V_178 ;
}
static struct V_181 * F_74 ( struct V_1 * V_2 ,
enum V_3 V_174 )
{
int V_6 ;
struct V_181 * V_182 ;
...
if ( V_221 == 1 ) {
F_77 ( L_30 ) ;
F_78 ( V_2 , V_2 -> V_8 . V_16 . V_215 ) ;
F_77 ( L_31 ) ;
F_78 ( V_2 , V_2 -> V_8 . V_16 . V_214 ) ;
}
F_27 ( & V_2 -> V_8 . V_75 ) ;
F_3 ( & V_2 -> V_76 ) ;
...
void F_82 ( struct V_1 * V_2 , bool V_223 )
{
enum V_3 V_174 ;
...
void F_84 ( struct V_1 * V_2 , bool V_223 )
{
if ( V_223 ) {
F_3 ( & V_2 -> V_8 . V_15 ) ;
...
V_2 -> V_232 ) {
if ( V_2 -> V_8 . V_233 )
F_90 ( V_2 , V_2 -> V_8 . V_233 ,
V_234 ) ;
if ( V_2 -> V_8 . V_235 )
F_90 ( V_2 , V_2 -> V_8 . V_235 ,
V_236 ) ;
if ( V_2 -> V_8 . V_65 )
F_23 ( V_2 , V_2 -> V_8 . V_65 ) ;
if ( V_2 -> V_8 . V_67 )
F_25 ( V_2 , V_2 -> V_8 . V_67 ) ;
}
F_3 ( & V_2 -> V_8 . V_15 ) ;
...
for ( V_6 = 0 ; V_6 < V_2 -> V_8 . V_16 . V_186 ; V_6 ++ ) {
F_77 ( L_35 , V_6 ) ;
F_78 ( V_2 , & V_2 -> V_8 . V_16 . V_182 [ V_6 ] ) ;
}
}
...
if ( V_126 )
return V_126 ;
F_106 ( & V_2 -> V_8 . V_16 . V_143 . V_173 , F_69 ) ;
F_3 ( & V_2 -> V_8 . V_15 ) ;
F_107 ( V_2 ) ;
V_2 -> V_8 . V_16 . V_215 = V_2 -> V_8 . V_16 . V_214 = V_2 -> V_8 . V_16 . V_206 ;
if ( V_221 == 1 )
...
if ( V_2 -> V_8 . V_14 ) {
if ( ! V_2 -> V_8 . V_294 ) {
V_126 = F_110 ( V_2 -> V_97 , & V_295 ) ;
if ( V_126 )
F_95 ( L_39 ) ;
V_126 = F_110 ( V_2 -> V_97 , & V_296 ) ;
if ( V_126 )
F_95 ( L_39 ) ;
V_126 = F_110 ( V_2 -> V_97 , & V_297 ) ;
if ( V_126 )
F_95 ( L_40 ) ;
V_126 = F_110 ( V_2 -> V_97 , & V_298 ) ;
if ( V_126 )
F_95 ( L_41 ) ;
V_2 -> V_8 . V_294 = true ;
}
...
F_6 ( & V_2 -> V_8 . V_15 ) ;
F_41 ( & V_2 -> V_8 . V_116 ) ;
F_113 ( V_2 -> V_97 , & V_297 ) ;
F_113 ( V_2 -> V_97 , & V_298 ) ;
}
F_67 ( V_2 ) ;
F_114 ( V_2 -> V_8 . V_10 ) ;
}
...
F_87 ( V_2 ) ;
F_6 ( & V_2 -> V_8 . V_15 ) ;
F_113 ( V_2 -> V_97 , & V_295 ) ;
F_113 ( V_2 -> V_97 , & V_296 ) ;
F_113 ( V_2 -> V_97 , & V_297 ) ;
F_113 ( V_2 -> V_97 , & V_298 ) ;
}
F_116 ( V_2 ) ;
...
static bool F_22 ( struct V_1 * V_2 , bool V_318 )
{
T_1 V_319 = 0 ;
bool V_311 = F_19 ( V_2 ) ;
if ( V_311 == false )
