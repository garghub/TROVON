...
V_319 = F_59 ( V_2 -> V_342 -> V_314 ) ;
V_320 = V_2 -> V_342 -> V_314 ;
}
V_322 = V_319 -> V_322 ;
V_324 = F_60 ( V_322 ) ;
...
unsigned V_12 , V_375 ;
if ( V_9 -> V_69 >= V_376 ) {
unsigned V_377 , V_378 ;
V_378 = 64 << V_332 ;
V_377 = 8 * 8 * V_320 -> V_379 / 8 ;
V_377 = F_72 ( V_378 , V_377 ) ;
for ( V_12 = 0 ; V_377 > 64 ; V_12 ++ )
V_377 >>= 1 ;
if ( V_12 >= 16 ) {
F_44 ( L_4 ,
V_320 -> V_379 , V_332 ) ;
...
V_375 = ( V_9 -> V_380 . V_381 . V_382 [ V_12 ] >> 6 ) & 0x3 ;
} else {
switch ( V_320 -> V_379 ) {
case 8 :
V_12 = 10 ;
...
V_375 = ( V_9 -> V_380 . V_385 . V_386 [ V_12 ] >> 20 ) & 0x3 ;
}
V_326 |= F_73 ( V_375 ) ;
} else {
if ( V_9 -> V_69 >= V_387 )
V_335 = V_9 -> V_380 . V_388 . V_389 ;
else
V_335 = V_9 -> V_380 . V_390 . V_389 ;
switch ( ( V_335 & 0xf0 ) >> 4 ) {
case 0 :
V_326 |= F_73 ( V_391 ) ;
break;
...
V_326 |= F_74 ( V_397 ) ;
if ( V_9 -> V_69 >= V_376 ) {
T_5 V_398 = ( V_9 -> V_380 . V_381 . V_386 [ 10 ] >> 6 ) & 0x1f ;
V_326 |= F_80 ( V_398 ) ;
} else if ( ( V_9 -> V_69 == V_374 ) ||
( V_9 -> V_69 == V_399 ) )
V_326 |= F_81 ( V_400 ) ;
else if ( ( V_9 -> V_69 == V_401 ) ||
( V_9 -> V_69 == V_402 ) ||
( V_9 -> V_69 == V_403 ) )
V_326 |= F_81 ( V_404 ) ;
switch ( V_11 -> V_18 ) {
...
F_16 ( V_411 + V_11 -> V_412 , 0 ) ;
F_16 ( V_413 + V_11 -> V_412 ,
F_82 ( V_325 ) ) ;
F_16 ( V_414 + V_11 -> V_412 ,
F_82 ( V_325 ) ) ;
F_16 ( V_415 + V_11 -> V_412 ,
( T_5 ) V_325 & V_416 ) ;
F_16 ( V_417 + V_11 -> V_412 ,
( T_5 ) V_325 & V_416 ) ;
F_16 ( V_418 + V_11 -> V_412 , V_326 ) ;
F_16 ( V_419 + V_11 -> V_412 , V_333 ) ;
F_83 ( V_420 + V_11 -> V_412 ,
( V_339 ? V_421 : 0 ) ,
~ V_421 ) ;
if ( V_339 )
F_58 ( L_5 ) ;
F_16 ( V_422 + V_11 -> V_412 , 0 ) ;
F_16 ( V_423 + V_11 -> V_412 , 0 ) ;
F_16 ( V_424 + V_11 -> V_412 , 0 ) ;
F_16 ( V_425 + V_11 -> V_412 , 0 ) ;
F_16 ( V_426 + V_11 -> V_412 , V_320 -> V_427 ) ;
F_16 ( V_428 + V_11 -> V_412 , V_320 -> V_429 ) ;
V_327 = V_320 -> V_430 [ 0 ] / ( V_320 -> V_379 / 8 ) ;
F_16 ( V_431 + V_11 -> V_412 , V_327 ) ;
F_16 ( V_432 + V_11 -> V_412 , 1 ) ;
if ( V_9 -> V_69 >= V_376 )
F_16 ( V_433 + V_11 -> V_412 ,
V_320 -> V_429 ) ;
else
F_16 ( V_434 + V_11 -> V_412 ,
V_320 -> V_429 ) ;
V_315 &= ~ 3 ;
V_316 &= ~ 1 ;
F_16 ( V_435 + V_11 -> V_412 ,
( V_315 << 16 ) | V_316 ) ;
V_336 = V_2 -> V_4 . V_436 ;
V_337 = ( V_2 -> V_4 . V_437 + 1 ) & ~ 1 ;
if ( ( V_9 -> V_69 >= V_376 ) &&
( V_2 -> V_4 . V_109 & V_116 ) )
V_337 *= 2 ;
F_16 ( V_438 + V_11 -> V_412 ,
( V_336 << 16 ) | V_337 ) ;
F_16 ( V_439 + V_11 -> V_412 , 0 ) ;
if ( ! V_317 && V_314 && V_314 != V_2 -> V_342 -> V_314 ) {
V_319 = F_59 ( V_314 ) ;
...
F_16 ( V_406 , 0 ) ;
F_16 ( V_457 + V_11 -> V_412 , 0 ) ;
if ( V_9 -> V_69 >= V_200 ) {
if ( V_11 -> V_18 ) {
F_16 ( V_458 , F_82 ( V_325 ) ) ;
F_16 ( V_459 , F_82 ( V_325 ) ) ;
} else {
F_16 ( V_460 , F_82 ( V_325 ) ) ;
F_16 ( V_461 , F_82 ( V_325 ) ) ;
}
}
F_16 ( V_462 + V_11 -> V_412 ,
( T_5 ) V_325 ) ;
F_16 ( V_463 +
V_11 -> V_412 , ( T_5 ) V_325 ) ;
F_16 ( V_464 + V_11 -> V_412 , V_326 ) ;
if ( V_9 -> V_69 >= V_452 )
F_16 ( V_465 + V_11 -> V_412 , V_333 ) ;
F_83 ( V_466 + V_11 -> V_412 ,
( V_339 ? V_467 : 0 ) , ~ V_467 ) ;
if ( V_339 )
F_58 ( L_5 ) ;
F_16 ( V_468 + V_11 -> V_412 , 0 ) ;
F_16 ( V_469 + V_11 -> V_412 , 0 ) ;
F_16 ( V_470 + V_11 -> V_412 , 0 ) ;
F_16 ( V_471 + V_11 -> V_412 , 0 ) ;
F_16 ( V_472 + V_11 -> V_412 , V_320 -> V_427 ) ;
F_16 ( V_473 + V_11 -> V_412 , V_320 -> V_429 ) ;
V_327 = V_320 -> V_430 [ 0 ] / ( V_320 -> V_379 / 8 ) ;
F_16 ( V_474 + V_11 -> V_412 , V_327 ) ;
F_16 ( V_475 + V_11 -> V_412 , 1 ) ;
F_16 ( V_476 + V_11 -> V_412 ,
V_320 -> V_429 ) ;
V_315 &= ~ 3 ;
V_316 &= ~ 1 ;
F_16 ( V_477 + V_11 -> V_412 ,
( V_315 << 16 ) | V_316 ) ;
V_336 = V_2 -> V_4 . V_436 ;
V_337 = ( V_2 -> V_4 . V_437 + 1 ) & ~ 1 ;
F_16 ( V_478 + V_11 -> V_412 ,
( V_336 << 16 ) | V_337 ) ;
F_16 ( V_479 + V_11 -> V_412 , 3 ) ;
if ( ! V_317 && V_314 && V_314 != V_2 -> V_342 -> V_314 ) {
V_319 = F_59 ( V_314 ) ;
V_324 = F_60 ( V_319 -> V_322 ) ;
V_338 = F_61 ( V_324 , false ) ;
...
if ( F_28 ( V_9 ) )
F_16 ( V_432 + V_11 -> V_412 , 0 ) ;
else if ( F_8 ( V_9 ) )
F_16 ( V_475 + V_11 -> V_412 , 0 ) ;
if ( F_20 ( V_9 ) )
F_17 ( V_2 , V_85 ) ;
for ( V_152 = 0 ; V_152 < V_9 -> V_157 ; V_152 ++ ) {
if ( V_9 -> V_31 . V_158 [ V_152 ] &&
