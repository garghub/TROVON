...
static int
F_29 ( struct V_54 * V_54 , struct V_17 * V_18 , struct V_36 * V_37 [] ,
T_3 V_11 )
{
struct V_1 * V_7 ;
T_1 V_4 , V_16 ;
...
V_55 = V_16 - V_4 + 1 ;
V_18 -> V_8 = F_30 ( V_18 , V_37 , 0 , 0 ) ;
V_7 = F_28 ( sizeof( * V_7 ) + V_55 * V_18 -> V_8 ) ;
if ( ! V_7 )
return - V_59 ;
V_7 -> V_55 = V_55 ;
V_7 -> V_51 = F_31 ( 0 , V_7 -> V_55 ) ;
V_18 -> V_27 = & V_1 ;
