...
static struct V_32 *
F_38 ( struct V_6 * V_7 , T_2 V_34 , T_2 V_74 ,
T_3 V_39 , struct V_63 * V_64 )
{
struct V_32 * V_54 ;
int V_56 ;
...
F_45 (promise, tmp, &contract->demands, list)
F_37 ( V_54 ) ;
F_45 (promise, tmp, &contract->completed_demands, list)
F_37 ( V_54 ) ;
F_37 ( V_55 ) ;
}
static struct V_82 *
F_46 ( struct V_6 * V_7 , T_2 V_74 ,
...
V_64 -> V_70 = 8 ;
if ( V_18 -> V_26 )
V_54 = F_38 ( V_7 , V_34 , V_74 , V_39 , V_64 ) ;
else
...
F_49 ( & V_54 -> V_61 , & V_55 -> V_59 ) ;
return F_50 ( & V_18 -> V_8 , & V_55 -> V_11 , V_23 ) ;
}
static struct V_82 *
F_51 ( struct V_6 * V_7 , T_2 V_86 , T_3 V_39 ,
...
V_90 = F_56 ( V_39 / V_87 , 2 ) ;
for ( V_24 = 0 ; V_24 < V_90 ; V_24 ++ ) {
V_91 = V_24 * V_87 * 2 ;
V_92 = F_57 ( ( V_39 - V_91 ) , ( V_87 * 2 ) ) ;
if ( V_88 == V_67 )
V_34 = V_86 + V_91 ;
else
V_74 = V_86 + V_91 ;
...
static struct V_82 *
F_58 ( struct V_6 * V_7 , struct V_97 * V_98 ,
...
if ( V_21 ) {
if ( V_21 -> V_26 )
F_65 ( 0 , V_21 -> V_35 + V_44 ) ;
else
F_65 ( 0 , V_21 -> V_35 + V_48 ) ;
F_19 ( V_20 , V_21 , 0 , 0 ) ;
F_15 ( V_20 , V_21 ) ;
}
F_11 ( & V_18 -> V_8 . V_29 , V_23 ) ;
...
static struct V_6 * F_68 ( struct V_113 * V_114 ,
struct V_115 * V_116 )
{
...
static enum V_120 F_70 ( struct V_6 * V_7 ,
T_5 V_121 ,
struct V_122 * V_123 )
{
struct V_5 * V_18 = F_3 ( V_7 ) ;
...
enum V_120 V_56 ;
T_3 V_124 = 0 ;
V_56 = F_71 ( V_7 , V_121 , V_123 ) ;
if ( ! V_123 || ( V_56 == V_125 ) )
return V_56 ;
F_11 ( & V_18 -> V_8 . V_29 , V_23 ) ;
V_11 = F_72 ( & V_18 -> V_8 , V_121 ) ;
if ( ! V_11 )
goto exit;
V_55 = F_4 ( V_11 ) ;
F_73 (promise, &contract->demands, list)
V_124 += V_54 -> V_39 ;
V_54 = F_42 ( & V_55 -> V_59 ,
struct V_32 , V_61 ) ;
if ( V_54 && V_21 ) {
V_124 -= V_54 -> V_39 ;
if ( V_21 -> V_26 )
V_124 += F_74 ( V_21 -> V_35 + V_40 ) ;
else
V_124 += F_74 ( V_21 -> V_35 + V_47 ) ;
}
exit:
F_75 ( V_123 , V_124 ) ;
F_14 ( & V_18 -> V_8 . V_29 , V_23 ) ;
...
static T_6 F_78 ( int V_126 , void * V_127 )
{
...
static int F_83 ( struct V_139 * V_140 )
{
struct V_1 * V_20 ;
struct V_141 * V_142 ;
int V_24 , V_143 , V_56 ;
V_20 = F_84 ( & V_140 -> V_3 , sizeof( * V_20 ) , V_144 ) ;
if ( ! V_20 )
return - V_145 ;
V_142 = F_85 ( V_140 , V_146 , 0 ) ;
V_20 -> V_35 = F_86 ( & V_140 -> V_3 , V_142 ) ;
if ( F_87 ( V_20 -> V_35 ) )
return F_88 ( V_20 -> V_35 ) ;
V_20 -> V_126 = F_89 ( V_140 , 0 ) ;
if ( V_20 -> V_126 < 0 ) {
F_53 ( & V_140 -> V_3 , L_7 ) ;
return V_20 -> V_126 ;
}
V_20 -> V_147 = F_90 ( & V_140 -> V_3 , NULL ) ;
if ( F_87 ( V_20 -> V_147 ) ) {
F_53 ( & V_140 -> V_3 , L_8 ) ;
return F_88 ( V_20 -> V_147 ) ;
}
F_91 ( V_140 , V_20 ) ;
F_92 ( & V_20 -> V_29 ) ;
F_93 ( V_20 -> V_4 . V_148 ) ;
F_94 ( V_149 , V_20 -> V_4 . V_148 ) ;
F_94 ( V_150 , V_20 -> V_4 . V_148 ) ;
F_94 ( V_151 , V_20 -> V_4 . V_148 ) ;
F_94 ( V_152 , V_20 -> V_4 . V_148 ) ;
F_40 ( & V_20 -> V_4 . V_153 ) ;
V_20 -> V_4 . V_154 = F_8 ;
V_20 -> V_4 . V_155 = F_70 ;
V_20 -> V_4 . V_156 = F_76 ;
...
V_20 -> V_22 = F_95 ( & V_140 -> V_3 , V_28 ,
sizeof( struct V_19 ) , V_144 ) ;
V_20 -> V_137 = F_95 ( & V_140 -> V_3 , V_136 ,
...
F_92 ( & V_18 -> V_8 . V_29 ) ;
V_18 -> V_8 . V_170 = F_44 ;
F_98 ( & V_18 -> V_8 , & V_20 -> V_4 ) ;
}
V_56 = F_99 ( V_20 -> V_147 ) ;
if ( V_56 ) {
F_53 ( & V_140 -> V_3 , L_9 ) ;
return V_56 ;
}
F_65 ( 0 , V_20 -> V_35 + V_53 ) ;
F_65 ( 0xFFFFFFFF , V_20 -> V_35 + V_134 ) ;
V_56 = F_100 ( & V_140 -> V_3 , V_20 -> V_126 , F_78 ,
0 , F_101 ( & V_140 -> V_3 ) , V_20 ) ;
if ( V_56 ) {
F_53 ( & V_140 -> V_3 , L_10 ) ;
goto V_171;
}
V_56 = F_102 ( & V_20 -> V_4 ) ;
if ( V_56 ) {
F_103 ( & V_140 -> V_3 , L_11 ) ;
goto V_171;
}
V_56 = F_104 ( V_140 -> V_3 . V_172 , F_68 ,
V_20 ) ;
if ( V_56 ) {
F_53 ( & V_140 -> V_3 , L_12 ) ;
goto V_173;
...
{
struct V_1 * V_20 = F_108 ( V_140 ) ;
F_109 ( V_20 -> V_126 ) ;
F_110 ( V_140 -> V_3 . V_172 ) ;
F_105 ( & V_20 -> V_4 ) ;
F_106 ( V_20 -> V_147 ) ;
return 0 ;
}
