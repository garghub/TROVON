...
char * V_12 = V_5 ;
struct V_13 * V_14 = F_2 ( V_2 ) ;
V_11 = F_6 ( V_14 , V_28 , & V_23 ,
L_12 ) ;
if ( V_11 )
return 0 ;
V_27 = F_4 ( V_23 . V_27 ) ;
for ( V_10 = 0 ; V_10 < V_27 ; V_10 ++ ) {
V_11 = F_7 ( V_14 , V_10 , V_24 ) ;
if ( V_11 )
break;
V_12 += sprintf ( V_12 , L_13 , V_10 ) ;
for ( V_26 = 0 ; V_26 < V_25 ; V_26 ++ )
V_12 += sprintf ( V_12 , L_10 , V_24 [ V_26 ] ) ;
V_12 += sprintf ( V_12 , L_11 ) ;
}
return V_12 - V_5 ;
}
...
T_3 V_23 ;
T_1 V_11 ;
V_11 = F_6 ( F_2 ( V_2 ) , V_29 , & V_23 ,
L_14 ) ;
if ( V_11 )
return 0 ;
V_11 = sprintf ( V_5 , L_15 , ! V_23 . V_30 . V_31 ) ;
return V_11 ;
}
...
if ( V_11 )
return 0 ;
V_11 = sprintf ( V_5 , L_15 , ! V_23 . V_30 . V_32 ) ;
return V_11 ;
}
...
T_3 V_23 ;
T_1 V_11 ;
V_11 = F_6 ( F_2 ( V_2 ) , V_33 , & V_23 ,
L_17 ) ;
if ( V_11 )
return 0 ;
V_11 = sprintf ( V_5 , L_15 , V_23 . V_34 ) ;
return V_11 ;
}
...
T_3 V_23 ;
T_1 V_11 ;
V_11 = F_6 ( F_2 ( V_2 ) , V_35 , & V_23 ,
L_18 ) ;
if ( V_11 )
return 0 ;
V_11 = sprintf ( V_5 , L_15 , V_23 . V_36 . V_32 ) ;
return V_11 ;
}
...
T_1 V_11 ;
char * V_12 = V_5 ;
V_11 = F_6 ( V_14 , V_37 , & V_23 ,
L_19 ) ;
if ( V_11 )
return 0 ;
V_12 += sprintf ( V_12 , L_20 ,
F_4 ( V_23 . V_38 ) ) ;
V_11 = F_6 ( V_14 , V_39 , & V_23 ,
L_21 ) ;
if ( ! V_11 ) {
V_12 += sprintf ( V_12 ,
L_22 ,
