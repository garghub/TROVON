...
struct V_40 * V_197 ;
int V_198 ;
const T_2 V_199 = F_138 ( struct V_40 , V_94 ) ;
...
unsigned V_207 ;
V_207 = F_139 () ;
V_197 = F_140 ( V_196 -> V_54 , V_203 | V_208 | V_209 , V_210 ) ;
F_141 ( V_207 ) ;
}
if ( ! V_197 ) {
if ( V_198 && F_142 ( V_188 , V_196 -> V_54 ) )
return - V_189 ;
return - V_23 ;
}
* V_193 |= V_195 ;
...
static int F_143 ( T_7 V_167 , struct V_40 * V_41 )
{
V_41 -> V_45 &= ~ V_65 ;
V_41 -> V_45 &= ~ V_51 ;
V_41 -> V_45 &= ~ V_200 ;
...
static int F_144 ( T_7 V_211 , struct V_40 T_6 * V_188 )
{
int V_88 = 0 ;
int V_168 ;
int V_193 ;
...
{
return ( long ) F_144 ( V_211 , (struct V_40 T_6 * ) V_219 ) ;
}
static long F_149 ( struct V_218 * V_218 , T_7 V_211 , T_8 V_219 )
{
return ( long ) F_148 ( V_218 , V_211 , ( T_8 ) F_150 ( V_219 ) ) ;
}
int T_9 F_151 ( void )
{
int V_88 ;
...
int F_156 ( struct V_17 * V_14 , char * V_13 , char * V_15 )
{
int V_88 = 0 ;
struct V_11 * V_12 ;
if ( ! V_14 )
