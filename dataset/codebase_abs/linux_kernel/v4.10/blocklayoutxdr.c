...
switch ( V_6 -> type ) {
case V_18 :
V_8 = 4 + 4 + 8 + 4 + ( F_7 ( V_6 -> V_19 . V_20 ) << 2 ) ;
V_10 = F_2 ( V_2 , V_8 ) ;
if ( ! V_10 )
return - V_21 ;
* V_10 ++ = F_3 ( V_6 -> type ) ;
...
V_10 = F_8 ( V_10 , V_6 -> V_19 . V_23 , V_6 -> V_19 . V_20 ) ;
break;
case V_24 :
V_8 = 4 + 4 + 4 + 4 + ( F_7 ( V_6 -> V_25 . V_26 ) << 2 ) + 8 ;
V_10 = F_2 ( V_2 , V_8 ) ;
if ( ! V_10 )
return - V_21 ;
* V_10 ++ = F_3 ( V_6 -> type ) ;
...
V_10 = F_8 ( V_10 , V_6 -> V_25 . V_29 , V_6 -> V_25 . V_26 ) ;
...
int
F_11 ( T_1 * V_10 , T_2 V_8 , struct V_42 * * V_43 ,
T_2 V_44 )
{
struct V_42 * V_45 ;
T_2 V_46 , V_38 ;
...
V_45 = F_14 ( V_46 , sizeof( * V_45 ) , V_50 ) ;
if ( ! V_45 ) {
F_12 ( L_4 , V_47 ) ;
return - V_51 ;
}
