...
static inline int F_40 ( struct V_1 * V_7 , int V_59 )
{
return F_41 ( V_7 ) > V_59 ;
}
int F_42 ( struct V_1 * V_7 , int V_60 )
{
struct V_1 * V_12 , * V_30 ;
struct V_1 * V_38 = V_7 -> V_40 ;
int V_55 = 0 ;
if ( V_7 == V_38 )
return F_40 ( V_7 , V_60 ) ;
if ( ! F_9 ( & V_7 -> V_61 ) || F_40 ( V_7 , V_60 ) )
return 1 ;
for ( V_12 = F_21 ( V_38 , V_38 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_38 ) ) {
V_30 = F_43 ( & V_12 -> V_7 , V_7 -> V_62 ) ;
if ( V_30 && F_9 ( & V_30 -> V_61 ) &&
( V_55 = F_40 ( V_30 , 1 ) ) )
break;
}
return V_55 ;
...
for ( V_12 = F_21 ( V_38 , V_38 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_38 ) ) {
struct V_1 * V_30 = F_43 ( & V_12 -> V_7 ,
V_7 -> V_62 ) ;
if ( V_30 && ( ! F_47 ( V_30 ) || F_27 ( V_12 ) ) ) {
F_33 ( V_30 ) ;
}
}
}
...
F_14 ( & V_30 -> V_63 ) ;
V_30 -> V_7 . V_25 |= V_64 ;
F_49 ( & V_30 -> V_65 , & V_7 -> V_65 ) ;
}
}
}
int F_50 ( struct V_20 * V_48 )
{
struct V_1 * V_7 ;
