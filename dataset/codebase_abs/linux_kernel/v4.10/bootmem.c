...
V_13 = F_21 ( V_24 + V_25 ) ;
for (; V_26 < V_13 ; V_26 ++ ) {
F_22 ( F_23 ( V_26 ) , V_26 , 0 ) ;
V_27 ++ ;
}
}
static unsigned long T_1 F_24 ( T_2 * V_6 )
{
struct V_28 * V_28 ;
...
if ( F_25 ( V_12 , V_35 ) && V_33 == ~ 0UL ) {
int V_36 = F_26 ( V_35 ) ;
F_22 ( F_23 ( V_12 ) , V_12 , V_36 ) ;
V_31 += V_35 ;
V_12 += V_35 ;
} else {
V_30 = V_12 ;
...
V_45 + V_6 -> V_8 ,
V_46 + V_6 -> V_8 ) ;
if ( F_33 ( V_6 -> V_15 == NULL ) )
return;
if ( V_6 -> V_47 > V_45 )
V_6 -> V_47 = V_45 ;
for ( V_32 = V_45 ; V_32 < V_46 ; V_32 ++ )
if ( ! F_34 ( V_32 , V_6 -> V_15 ) )
F_35 () ;
}
...
F_8 (bdata, &bdata_list, list) {
if ( V_62 && V_6 -> V_16 <= F_21 ( V_62 ) )
continue;
if ( V_63 && V_6 -> V_8 >= F_21 ( V_63 ) )
break;
...
void * V_75 ;
if ( F_53 ( F_54 () ) )
return F_63 ( V_25 , V_74 , V_18 -> V_78 ) ;
V_79:
...
unsigned long V_62 )
{
return F_58 ( V_25 , V_61 , V_62 , V_82 ) ;
}
