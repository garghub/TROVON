...
long V_9 = 0 ;
if ( F_12 ( & V_21 [ V_17 ] ) )
V_9 = F_13 ( & V_21 [ V_17 ] , 0 ) ;
return V_9 ;
}
static unsigned long
F_14 ( unsigned long V_23 , unsigned int V_24 , unsigned int V_25 )
{
...
static unsigned long
F_15 ( unsigned long V_13 , unsigned long exp ,
unsigned long V_14 , unsigned int V_25 )
{
return F_3 ( V_13 , F_14 ( exp , V_27 , V_25 ) , V_14 ) ;
}
...
V_4 [ 0 ] = F_15 ( V_4 [ 0 ] , V_29 , V_14 , V_25 ) ;
V_4 [ 1 ] = F_15 ( V_4 [ 1 ] , V_30 , V_14 , V_25 ) ;
V_4 [ 2 ] = F_15 ( V_4 [ 2 ] , V_31 , V_14 , V_25 ) ;
V_20 += V_25 * V_22 ;
}
F_17 () ;
V_18 ++ ;
...
V_14 = F_12 ( & V_28 ) ;
V_14 = V_14 > 0 ? V_14 * V_16 : 0 ;
V_4 [ 0 ] = F_3 ( V_4 [ 0 ] , V_29 , V_14 ) ;
V_4 [ 1 ] = F_3 ( V_4 [ 1 ] , V_30 , V_14 ) ;
V_4 [ 2 ] = F_3 ( V_4 [ 2 ] , V_31 , V_14 ) ;
V_20 += V_22 ;
F_16 () ;
}
