...
static void F_60 ( struct V_1 * V_51 )
{
struct V_45 * V_46 = V_51 -> V_46 ;
struct V_84 * V_22 ;
V_22 = V_46 -> V_61 . V_23 ;
F_45 ( V_46 , V_51 , false ) ;
F_61 ( V_51 ) ;
if ( V_22 && V_22 -> V_85 )
V_22 -> V_85 ( V_51 ) ;
else
...
static int F_73 ( struct V_33 * V_9 , bool V_88 )
{
...
if ( ! V_8 -> V_104 ) {
V_75 -> V_104 = F_82 ( sizeof( * V_75 -> V_104 ) ,
V_98 ) ;
if ( ! V_75 -> V_104 )
return - V_99 ;
...
static struct V_90 * F_87 ( struct V_33 * V_9 )
{
struct V_90 * V_75 ;
int V_19 = 0 ;
F_75 (commit, &crtc->commit_list, commit_entry) {
...
int V_19 ;
long V_20 ;
F_21 (old_state, crtc, crtc_state, i) {
F_74 ( & V_9 -> V_93 ) ;
V_75 = F_87 ( V_9 ) ;
if ( V_75 )
F_78 ( V_75 ) ;
...
static bool F_90 ( const struct V_3 * V_2 )
{
...
F_5 (state, connector, conn_state, i) {
V_15 -> V_2 -> V_2 = V_2 ;
F_97 ( V_2 -> V_126 [ V_19 ] . V_2 , V_15 -> V_2 ) ;
V_15 -> V_2 -> V_2 = NULL ;
}
F_21 (state, crtc, crtc_state, i) {
V_9 -> V_2 -> V_2 = V_2 ;
F_97 ( V_2 -> V_103 [ V_19 ] . V_2 , V_9 -> V_2 ) ;
V_9 -> V_2 -> V_2 = NULL ;
if ( V_2 -> V_103 [ V_19 ] . V_75 ) {
F_74 ( & V_9 -> V_93 ) ;
F_98 ( & V_2 -> V_103 [ V_19 ] . V_75 -> V_101 ,
& V_9 -> V_125 ) ;
F_77 ( & V_9 -> V_93 ) ;
...
F_30 (state, plane, plane_state, i) {
V_6 -> V_2 -> V_2 = V_2 ;
F_97 ( V_2 -> V_127 [ V_19 ] . V_2 , V_6 -> V_2 ) ;
V_6 -> V_2 -> V_2 = NULL ;
}
}
...
F_3 ( ! V_142 -> V_78 ) ;
F_3 ( ! V_142 -> V_144 ) ;
V_20 = F_115 ( V_8 , V_142 -> V_39 ) ;
if ( V_20 != 0 )
return V_20 ;
V_8 -> V_32 = true ;
V_20 = F_103 ( V_145 , V_9 ) ;
if ( V_20 != 0 )
return V_20 ;
F_116 ( V_142 -> V_39 , & V_146 , & V_147 ) ;
F_104 ( V_145 , V_142 -> V_78 ) ;
V_145 -> V_129 = 0 ;
V_145 -> V_130 = 0 ;
V_145 -> V_131 = V_146 ;
V_145 -> V_132 = V_147 ;
...
V_2 -> V_135 = V_150 ;
F_9 (conn, dev) {
struct V_33 * V_9 = V_151 -> V_2 -> V_9 ;
struct V_7 * V_8 ;
if ( ! V_9 || V_151 -> V_56 != V_63 )
continue;
V_8 = F_114 ( V_2 , V_9 ) ;
if ( F_12 ( V_8 ) ) {
V_152 = F_13 ( V_8 ) ;
...
F_120 ( & V_150 , 0 ) ;
V_136:
V_152 = F_121 ( V_46 , & V_150 ) ;
if ( V_152 < 0 ) {
V_2 = F_122 ( V_152 ) ;
goto V_153;
}
V_2 = F_123 ( V_46 , & V_150 ) ;
if ( F_12 ( V_2 ) )
goto V_153;
V_152 = F_118 ( V_46 , & V_150 ) ;
if ( V_152 < 0 ) {
F_63 ( V_2 ) ;
V_2 = F_122 ( V_152 ) ;
goto V_153;
...
struct V_1 * V_2 )
{
struct V_154 * V_155 = & V_46 -> V_61 ;
int V_152 ;
F_128 ( V_46 ) ;
F_129 ( V_46 ) ;
V_2 -> V_135 = V_155 -> V_135 ;
V_152 = F_105 ( V_2 ) ;
F_130 ( V_46 ) ;
return V_152 ;
}
...
int V_39 )
{
struct V_154 * V_155 = & V_15 -> V_46 -> V_61 ;
struct V_1 * V_2 ;
struct V_7 * V_8 ;
struct V_33 * V_9 ;
struct V_14 * V_161 ;
...
F_3 ( ! F_140 ( & V_155 -> V_143 ) ) ;
F_9 (tmp_connector, connector->dev) {
if ( V_161 -> V_2 -> V_9 != V_9 )
continue;
if ( V_161 -> V_56 == V_63 ) {
V_32 = true ;
break;
...
{
F_3 ( V_15 -> V_163 [ 1 ] ) ;
return F_141 ( V_15 -> V_46 , V_15 -> V_163 [ 0 ] ) ;
}
...
F_143 ( V_9 -> V_2 ) ;
F_144 ( V_9 -> V_2 ) ;
V_9 -> V_2 = F_82 ( sizeof( * V_9 -> V_2 ) , V_98 ) ;
if ( V_9 -> V_2 )
V_9 -> V_2 -> V_9 = V_9 ;
}
...
F_152 ( V_6 -> V_2 ) ;
F_144 ( V_6 -> V_2 ) ;
V_6 -> V_2 = F_82 ( sizeof( * V_6 -> V_2 ) , V_98 ) ;
if ( V_6 -> V_2 ) {
V_6 -> V_2 -> V_6 = V_6 ;
V_6 -> V_2 -> V_148 = V_170 ;
}
...
void F_167 ( struct V_14 * V_15 ,
struct V_12 * V_2 )
{
F_160 ( V_2 ) ;
F_144 ( V_2 ) ;
}
int F_168 ( struct V_33 * V_9 ,
T_3 * V_171 , T_3 * V_172 , T_3 * V_173 ,
T_1 V_174 )
{
...
V_178 [ V_19 ] . V_171 = V_171 [ V_19 ] ;
V_178 [ V_19 ] . V_172 = V_172 [ V_19 ] ;
V_178 [ V_19 ] . V_173 = V_173 [ V_19 ] ;
}
V_2 -> V_135 = V_9 -> V_46 -> V_61 . V_135 ;
V_136:
V_8 = F_114 ( V_2 , V_9 ) ;
