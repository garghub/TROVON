...
static int F_10 ( struct V_22 * V_22 , struct V_23 * V_23 )
{
return F_11 ( V_23 , F_1 , V_22 -> V_24 ) ;
}
static inline struct V_25 * F_12 ( const struct V_7 * V_3 )
{
return F_13 ( V_3 , struct V_25 , V_3 ) ;
}
static const struct V_7 * F_14 ( struct V_4 * V_26 ,
unsigned int * V_27 )
{
const struct V_9 * V_10 ;
struct V_28 args ;
int V_29 ;
V_29 = F_15 ( V_26 , L_7 , 1 , 0 ,
& args ) ;
if ( V_29 )
return F_16 ( V_29 ) ;
if ( ! F_17 ( args . V_30 ) ) {
