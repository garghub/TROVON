...
void F_55 ( struct V_25 * V_25 )
{
struct V_79 * V_80 , * V_81 ;
F_56 ( & V_25 -> V_82 ) ;
F_57 (label_ent, e, &nd_mapping->labels, list) {
F_58 ( & V_80 -> V_83 ) ;
F_22 ( V_80 ) ;
}
}
static void F_59 ( struct V_84 * V_84 ,
struct V_1 * V_2 , bool V_85 )
{
struct V_22 * V_22 ;
if ( ! V_85 && ( F_24 ( V_2 ) || F_21 ( V_2 ) ) ) {
int V_7 ;
V_22 = F_17 ( V_2 ) ;
for ( V_7 = 0 ; V_7 < V_22 -> V_24 ; V_7 ++ ) {
struct V_25 * V_25 = & V_22 -> V_26 [ V_7 ] ;
...
if ( V_2 -> V_87 && ( F_21 ( V_2 -> V_87 ) || F_24 ( V_2 -> V_87 ) )
&& V_85 ) {
V_22 = F_17 ( V_2 -> V_87 ) ;
F_10 ( V_2 ) ;
if ( V_22 -> V_63 == V_2 )
...
if ( F_65 ( V_2 ) && V_85 ) {
struct V_88 * V_88 = F_66 ( V_2 ) ;
V_22 = F_17 ( V_2 -> V_87 ) ;
F_10 ( V_2 ) ;
if ( V_22 -> V_64 == V_2 )
F_67 ( V_22 ) ;
if ( V_22 -> V_63 == & V_88 -> V_89 -> V_2 )
F_64 ( V_22 ) ;
F_12 ( V_2 ) ;
}
if ( F_68 ( V_2 ) && V_85 ) {
struct V_90 * V_90 = F_69 ( V_2 ) ;
V_22 = F_17 ( V_2 -> V_87 ) ;
F_10 ( V_2 ) ;
if ( V_22 -> V_65 == V_2 )
F_70 ( V_22 ) ;
if ( V_22 -> V_63 == & V_90 -> V_89 -> V_2 )
F_64 ( V_22 ) ;
F_12 ( V_2 ) ;
}
if ( F_71 ( V_2 ) && V_85 ) {
struct V_91 * V_91 = F_72 ( V_2 ) ;
V_22 = F_17 ( V_2 -> V_87 ) ;
F_10 ( V_2 ) ;
if ( V_22 -> V_66 == V_2 )
F_73 ( V_22 ) ;
if ( V_22 -> V_63 == & V_91 -> V_90 . V_89 -> V_2 )
F_64 ( V_22 ) ;
F_12 ( V_2 ) ;
}
}
void F_74 ( struct V_84 * V_84 , struct V_1 * V_2 )
{
F_59 ( V_84 , V_2 , true ) ;
}
void F_75 ( struct V_84 * V_84 , struct V_1 * V_2 )
{
F_59 ( V_84 , V_2 , false ) ;
}
static T_4 F_76 ( struct V_1 * V_2 , char * V_49 , int V_73 )
{
struct V_22 * V_22 = F_17 ( V_2 ) ;
struct V_25 * V_25 ;
struct V_3 * V_3 ;
...
static T_6 F_77 ( struct V_69 * V_70 , struct V_71 * V_72 , int V_73 )
{
...
int F_78 ( struct V_22 * V_22 )
{
struct V_1 * V_2 = & V_22 -> V_2 ;
struct V_84 * V_84 = F_79 ( V_2 ) ;
if ( ! F_21 ( V_2 ) )
return 0 ;
if ( V_22 -> V_24 < 1 ) {
F_80 ( V_2 , L_11 ) ;
...
return F_23 ( V_2 ) -> F_81 ( V_84 , V_2 ) ;
}
unsigned int F_82 ( struct V_22 * V_22 )
{
unsigned int V_92 , V_30 ;
V_92 = F_83 () ;
if ( V_22 -> V_93 < V_94 ) {
struct V_95 * V_96 , * V_97 ;
V_30 = V_92 % V_22 -> V_93 ;
V_97 = F_84 ( V_22 -> V_30 , V_92 ) ;
V_96 = F_84 ( V_22 -> V_30 , V_30 ) ;
if ( V_97 -> V_98 ++ == 0 )
F_85 ( & V_96 -> V_82 ) ;
} else
V_30 = V_92 ;
...
void F_86 ( struct V_22 * V_22 , unsigned int V_30 )
{
if ( V_22 -> V_93 < V_94 ) {
unsigned int V_92 = F_83 () ;
struct V_95 * V_96 , * V_97 ;
V_97 = F_84 ( V_22 -> V_30 , V_92 ) ;
V_96 = F_84 ( V_22 -> V_30 , V_30 ) ;
if ( -- V_97 -> V_98 == 0 )
...
static struct V_22 * F_89 ( struct V_84 * V_84 ,
...
struct V_106 * V_26 = & V_100 -> V_26 [ V_7 ] ;
struct V_3 * V_3 = V_26 -> V_3 ;
if ( ( V_26 -> V_15 | V_26 -> V_50 ) % V_107 ) {
F_80 ( & V_84 -> V_2 , L_12 ,
V_103 , F_45 ( & V_3 -> V_2 ) , V_7 ) ;
return NULL ;
}
if ( V_3 -> V_42 & V_108 )
V_67 = 1 ;
...
struct V_36 * V_38 ;
V_110 = F_90 ( V_100 ) ;
V_38 = F_91 ( sizeof( * V_38 ) + sizeof( struct V_25 )
* V_100 -> V_105 ,
V_27 ) ;
if ( V_38 ) {
V_22 = & V_38 -> V_22 ;
V_38 -> F_81 = V_110 -> F_81 ;
V_38 -> V_111 = V_110 -> V_111 ;
}
V_104 = V_38 ;
} else {
V_22 = F_91 ( sizeof( struct V_22 )
+ sizeof( struct V_25 )
* V_100 -> V_105 ,
V_27 ) ;
V_104 = V_22 ;
...
if ( ! V_104 )
return NULL ;
V_22 -> V_32 = F_92 ( & V_31 , 0 , 0 , V_27 ) ;
if ( V_22 -> V_32 < 0 )
goto V_112;
V_22 -> V_30 = F_93 ( struct V_95 ) ;
if ( ! V_22 -> V_30 )
goto V_113;
for ( V_7 = 0 ; V_7 < V_94 ; V_7 ++ ) {
struct V_95 * V_114 ;
V_114 = F_84 ( V_22 -> V_30 , V_7 ) ;
F_94 ( & V_114 -> V_82 ) ;
V_114 -> V_98 = 0 ;
}
for ( V_7 = 0 ; V_7 < V_100 -> V_105 ; V_7 ++ ) {
...
F_95 ( & V_22 -> V_26 [ V_7 ] . V_115 ) ;
F_96 ( & V_22 -> V_26 [ V_7 ] . V_82 ) ;
F_97 ( & V_3 -> V_2 ) ;
}
V_22 -> V_24 = V_100 -> V_105 ;
V_22 -> V_37 = V_100 -> V_37 ;
V_22 -> V_53 = V_100 -> V_53 ;
V_22 -> V_93 = V_100 -> V_93 ;
V_22 -> V_42 = V_100 -> V_42 ;
V_22 -> V_67 = V_67 ;
V_22 -> V_116 = V_100 -> V_116 ;
F_98 ( & V_22 -> V_117 ) ;
F_98 ( & V_22 -> V_118 ) ;
F_98 ( & V_22 -> V_119 ) ;
F_98 ( & V_22 -> V_120 ) ;
V_2 = & V_22 -> V_2 ;
F_99 ( V_2 , L_13 , V_22 -> V_32 ) ;
V_2 -> V_87 = & V_84 -> V_2 ;
V_2 -> type = V_102 ;
V_2 -> V_121 = V_100 -> V_122 ;
V_22 -> V_51 = F_100 ( V_100 -> V_12 ) ;
V_22 -> V_123 = V_100 -> V_12 -> V_15 ;
F_101 ( V_2 ) ;
return V_22 ;
V_113:
F_20 ( & V_31 , V_22 -> V_32 ) ;
...
struct V_22 * F_102 ( struct V_84 * V_84 ,
struct V_99 * V_100 )
{
V_100 -> V_93 = V_124 ;
return F_89 ( V_84 , V_100 , & V_33 ,
V_125 ) ;
}
struct V_22 * F_103 ( struct V_84 * V_84 ,
struct V_99 * V_100 )
{
if ( V_100 -> V_105 > 1 )
return NULL ;
V_100 -> V_93 = F_104 ( V_100 -> V_93 , V_124 ) ;
return F_89 ( V_84 , V_100 , & V_34 ,
V_125 ) ;
}
struct V_22 * F_105 ( struct V_84 * V_84 ,
struct V_99 * V_100 )
{
V_100 -> V_93 = V_124 ;
return F_89 ( V_84 , V_100 , & V_126 ,
V_125 ) ;
}
void F_106 ( struct V_22 * V_22 )
{
struct V_5 * V_6 = F_43 ( & V_22 -> V_2 ) ;
int V_7 , V_127 ;
V_127 = F_107 ( V_128 ) ;
V_127 = F_108 ( V_128 , F_109 ( V_129 -> V_130 + V_127 , 8 ) ) ;
F_110 () ;
for ( V_7 = 0 ; V_7 < V_22 -> V_24 ; V_7 ++ )
if ( F_5 ( V_6 , V_7 , 0 ) )
F_111 ( 1 , F_5 ( V_6 , V_7 , V_127 ) ) ;
F_110 () ;
}
int F_112 ( struct V_22 * V_22 )
{
struct V_5 * V_6 = F_43 ( & V_22 -> V_2 ) ;
int V_7 ;
if ( V_22 -> V_24 == 0 )
