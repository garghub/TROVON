...
static enum V_60
F_62 ( struct V_1 * V_2 , bool V_142 )
{
struct V_8 * V_8 = F_2 ( V_2 ) ;
struct V_22 * V_23 ;
...
static enum V_60
F_66 ( struct V_1 * V_2 , bool V_142 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_8 * V_8 = F_2 ( V_2 ) ;
...
struct V_1 * V_158 ;
struct V_8 * V_159 ;
F_67 (list_connector, &dev->mode_config.connector_list, head) {
if ( V_2 == V_158 )
continue;
V_159 = F_2 ( V_158 ) ;
if ( V_159 -> V_154 &&
...
static enum V_60
F_76 ( struct V_1 * V_2 , bool V_142 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_5 * V_6 = V_4 -> V_7 ;
struct V_8 * V_8 = F_2 ( V_2 ) ;
...
if ( V_13 == V_193 )
return;
F_67 (connector, &dev->mode_config.connector_list, head) {
V_8 = F_2 ( V_2 ) ;
if ( V_8 -> V_183 == V_183 ) {
V_8 -> V_101 |= V_184 ;
return;
...
F_67 (encoder, &dev->mode_config.encoder_list, head) {
V_48 = F_14 ( V_23 ) ;
if ( V_48 -> V_101 & V_184 ) {
switch ( V_48 -> V_176 ) {
case V_177 :
...
V_8 = F_80 ( sizeof( struct V_8 ) , V_74 ) ;
if ( ! V_8 )
return;
V_2 = & V_8 -> V_111 ;
V_8 -> V_183 = V_183 ;
...
V_8 -> V_195 = F_81 ( V_6 , & V_78 -> V_198 ) ;
if ( ! V_8 -> V_195 )
F_64 ( L_15 ) ;
}
if ( V_192 ) {
V_172 = F_80 ( sizeof( struct V_15 ) , V_74 ) ;
if ( ! V_172 )
goto V_199;
V_8 -> V_17 = V_172 ;
if ( V_186 -> V_194 ) {
V_8 -> V_81 = F_81 ( V_6 , V_186 ) ;
if ( V_8 -> V_81 )
V_82 = true ;
else
F_64 ( L_16 ) ;
...
switch ( V_13 ) {
case V_162 :
F_82 ( V_4 , & V_8 -> V_111 , & V_211 , V_13 ) ;
F_83 ( & V_8 -> V_111 , & V_212 ) ;
if ( V_186 -> V_194 ) {
V_8 -> V_81 = F_81 ( V_6 , V_186 ) ;
if ( ! V_8 -> V_81 )
F_64 ( L_17 ) ;
...
goto V_199;
V_8 -> V_17 = V_172 ;
F_82 ( V_4 , & V_8 -> V_111 , & V_213 , V_13 ) ;
F_83 ( & V_8 -> V_111 , & V_214 ) ;
if ( V_186 -> V_194 ) {
V_8 -> V_81 = F_81 ( V_6 , V_186 ) ;
if ( ! V_8 -> V_81 )
F_64 ( L_19 ) ;
...
goto V_199;
V_8 -> V_17 = V_172 ;
F_82 ( V_4 , & V_8 -> V_111 , & V_201 , V_13 ) ;
F_83 ( & V_8 -> V_111 , & V_202 ) ;
if ( V_186 -> V_194 ) {
V_8 -> V_81 = F_81 ( V_6 , V_186 ) ;
if ( V_8 -> V_81 )
V_82 = true ;
...
goto V_199;
V_8 -> V_17 = V_172 ;
F_82 ( V_4 , & V_8 -> V_111 , & V_215 , V_13 ) ;
F_83 ( & V_8 -> V_111 , & V_216 ) ;
if ( V_186 -> V_194 ) {
V_8 -> V_81 = F_81 ( V_6 , V_186 ) ;
if ( ! V_8 -> V_81 )
F_64 ( L_21 ) ;
