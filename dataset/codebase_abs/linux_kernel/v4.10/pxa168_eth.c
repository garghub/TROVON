...
static int F_92 ( struct V_219 * V_39 , int V_130 )
{
struct V_1 * V_2 =
...
static int F_103 ( struct V_236 * V_237 , int V_185 , int V_238 )
{
...
static int F_105 ( struct V_236 * V_237 , int V_185 , int V_238 ,
T_5 V_243 )
{
struct V_1 * V_2 = V_237 -> V_239 ;
if ( F_101 ( V_2 ) ) {
...
static int F_106 ( struct V_13 * V_11 , struct V_245 * V_246 ,
int V_182 )
{
if ( V_11 -> V_95 != NULL )
return F_107 ( V_11 -> V_95 , V_246 , V_182 ) ;
return - V_247 ;
}
...
struct V_248 * V_249 )
{
F_111 ( V_249 -> V_250 , V_251 , sizeof( V_249 -> V_250 ) ) ;
F_111 ( V_249 -> V_252 , V_253 , sizeof( V_249 -> V_252 ) ) ;
F_111 ( V_249 -> V_254 , L_12 , sizeof( V_249 -> V_254 ) ) ;
F_111 ( V_249 -> V_255 , L_12 , sizeof( V_249 -> V_255 ) ) ;
}
static int F_112 ( struct V_256 * V_257 )
{
struct V_1 * V_2 = NULL ;
...
int V_183 ;
F_113 ( V_263 L_13 ) ;
V_260 = F_114 ( & V_257 -> V_11 , NULL ) ;
if ( F_66 ( V_260 ) ) {
F_83 ( & V_257 -> V_11 , L_14 ) ;
return - V_242 ;
}
F_115 ( V_260 ) ;
...
V_2 -> V_11 = V_11 ;
V_2 -> V_260 = V_260 ;
V_259 = F_118 ( V_257 , V_265 , 0 ) ;
V_2 -> V_4 = F_119 ( & V_257 -> V_11 , V_259 ) ;
if ( F_66 ( V_2 -> V_4 ) ) {
V_183 = - V_74 ;
goto V_266;
}
V_259 = F_118 ( V_257 , V_267 , 0 ) ;
F_81 ( ! V_259 ) ;
...
if ( V_257 -> V_11 . V_277 )
V_41 = F_121 ( V_257 -> V_11 . V_277 ) ;
if ( V_41 && F_33 ( V_41 ) ) {
F_122 ( V_11 -> V_83 , V_41 ) ;
} else {
F_31 ( V_11 , V_11 -> V_83 ) ;
if ( ! F_33 ( V_11 -> V_83 ) ) {
F_123 ( & V_257 -> V_11 , L_15 ) ;
F_124 ( V_11 ) ;
}
}
V_2 -> V_20 = V_278 ;
V_2 -> V_120 = V_279 ;
V_2 -> V_280 = F_125 ( & V_257 -> V_11 ) ;
if ( V_2 -> V_280 ) {
if ( V_2 -> V_280 -> V_281 )
...
F_126 ( V_257 -> V_11 . V_277 , L_16 ,
& V_2 -> V_283 ) ;
V_262 = F_127 ( V_257 -> V_11 . V_277 , L_17 , 0 ) ;
if ( ! V_262 ) {
F_83 ( & V_257 -> V_11 , L_18 ) ;
V_183 = - V_287 ;
goto V_266;
}
F_126 ( V_262 , L_19 , & V_2 -> V_185 ) ;
V_2 -> V_186 = F_128 ( V_257 -> V_11 . V_277 ) ;
F_129 ( V_262 ) ;
}
F_81 ( V_2 -> V_283 > 2 ) ;
...
V_2 -> V_184 -> V_290 = F_103 ;
V_2 -> V_184 -> V_291 = F_105 ;
...
static void F_145 ( struct V_256 * V_257 )
{
struct V_13 * V_11 = F_141 ( V_257 ) ;
F_38 ( V_11 ) ;
}
static int F_146 ( struct V_256 * V_257 )
{
return - V_297 ;
}
static int F_147 ( struct V_256 * V_257 , T_6 V_298 )
{
return - V_297 ;
}
