...
bool F_207 ( struct V_25 * V_26 , T_2 * V_238 , T_2 * V_309 ,
unsigned short V_9 )
{
struct V_24 * V_28 ;
struct V_31 * V_32 ;
...
V_314 = F_209 ( V_230 ,
& V_47 -> V_231 ) ;
if ( ( ! V_314 && V_132 == 1 ) || V_132 - V_272 == 1 ) {
if ( ! V_278 ) {
V_262 = false ;
goto V_315;
}
...
struct V_81 * V_126 ;
T_3 V_45 , V_76 ;
if ( V_318 < sizeof( * V_126 ) )
return;
V_126 = (struct V_81 * ) V_317 ;
V_318 -= sizeof( * V_126 ) ;
V_76 = F_171 ( V_126 -> V_76 ) ;
if ( V_318 < sizeof( * V_130 ) * V_76 )
return;
V_130 = (struct V_82 * ) ( V_126 + 1 ) ;
V_127 = (struct V_74 * ) ( V_130 + V_76 ) ;
V_318 -= sizeof( * V_130 ) * V_76 ;
V_45 = F_55 ( V_318 ) ;
...
V_126 = (struct V_81 * ) V_317 ;
V_318 -= sizeof( * V_126 ) ;
V_319 = sizeof( struct V_82 ) ;
V_319 *= F_171 ( V_126 -> V_76 ) ;
if ( V_318 < V_319 )
return V_321 ;
V_318 -= V_319 ;
V_258 = F_55 ( V_318 ) ;
switch ( V_126 -> V_59 & V_322 ) {
case V_265 :
F_176 ( V_26 , V_323 ) ;
V_100 = F_181 ( V_26 , V_126 , V_238 , V_309 ) ;
if ( ! V_100 ) {
if ( V_126 -> V_59 & V_266 )
V_320 = 'F' ;
else
...
if ( ! F_182 ( V_26 , V_309 ) )
return V_324 ;
if ( V_318 < sizeof( * V_326 ) )
goto V_112;
V_47 = F_179 ( V_26 , V_238 ) ;
if ( ! V_47 )
goto V_112;
F_176 ( V_26 , V_327 ) ;
V_326 = (struct V_293 * ) V_317 ;
F_61 ( V_87 , V_26 ,
L_41 ,
V_238 , V_326 -> V_288 ) ;
F_124 ( V_26 , V_47 , V_326 -> V_288 ,
F_171 ( V_326 -> V_9 ) , V_109 ,
F_26 ( & V_47 -> V_133 ) + 1 ) ;
V_112:
if ( V_47 )
F_44 ( V_47 ) ;
...
int T_7 F_222 ( void )
{
T_8 V_328 = sizeof( struct V_24 ) ;
T_8 V_329 = sizeof( struct V_31 ) ;
T_8 V_330 = sizeof( struct V_51 ) ;
T_8 V_331 = sizeof( struct V_55 ) ;
T_8 V_332 = sizeof( struct V_242 ) ;
T_8 V_333 = sizeof( struct V_283 ) ;
V_36 = F_223 ( L_42 , V_328 , 0 ,
V_334 , NULL ) ;
if ( ! V_36 )
return - V_83 ;
V_40 = F_223 ( L_43 , V_329 , 0 ,
V_334 , NULL ) ;
if ( ! V_40 )
goto V_335;
V_53 = F_223 ( L_44 ,
