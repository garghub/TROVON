...
{
struct V_128 * V_129 ;
V_129 = & F_152 ( V_142 , V_141 ) ;
return F_139 ( V_129 ) ;
}
static int F_153 ( unsigned int V_141 )
{
struct V_128 * V_129 ;
V_129 = & F_152 ( V_142 , V_141 ) ;
F_141 ( V_129 ) ;
...
static bool F_155 ( struct V_49 * V_144 , int V_79 ,
int V_60 )
{
if ( V_144 -> V_79 == V_79 &&
V_144 -> V_60 == V_60 )
...
static bool F_156 ( struct V_49 * V_44 , struct V_4 * V_4 )
{
return F_47 ( V_4 ) == V_44 -> V_60 ;
}
unsigned long F_43 ( struct V_2 * V_3 )
{
return F_157 ( & V_3 -> V_120 ) ;
}
...
static unsigned long F_163 ( struct V_49 * V_44 ,
...
static void F_165 ( struct V_49 * V_44 , unsigned long V_13 )
{
struct V_123 * V_124 ;
struct V_4 * V_4 ;
struct V_1 * V_151 ;
...
static void F_166 ( struct V_49 * V_44 , unsigned long V_154 ,
unsigned long V_155 )
{
...
static unsigned long F_167 ( struct V_49 * V_44 ,
...
static int F_168 ( struct V_2 * V_3 , struct V_49 * V_44 ,
struct V_167 * V_168 )
{
...
if ( F_156 ( V_44 , F_93 ( V_157 ) ) ) {
F_108 ( V_11 ) ;
V_145 = - V_131 ;
break;
}
V_169 = F_100 ( V_11 ) ;
V_170 = F_163 ( V_44 , F_93 ( V_157 ) , V_11 ) ;
F_166 ( V_44 , V_170 , V_169 ) ;
V_110 ++ ;
V_170 |= F_169 ( V_114 ) ;
F_27 ( V_11 , V_170 ) ;
F_108 ( V_11 ) ;
...
static struct V_4 * F_170 ( struct V_49 * V_44 , bool V_171 )
{
int V_58 ;
struct V_4 * V_4 ;
...
static enum V_40 F_171 ( struct V_49 * V_44 ,
struct V_4 * V_4 )
{
enum V_40 V_41 ;
F_88 ( F_44 ( V_4 ) ) ;
...
static struct V_83 * F_172 ( struct V_172 * V_173 ,
int V_12 , const char * V_174 , void * V_175 )
{
static const struct V_176 V_177 = {
. V_178 = V_179 ,
} ;
return F_173 ( V_173 , L_26 , NULL , & V_177 , V_180 ) ;
}
static int F_7 ( void )
{
int V_145 = 0 ;
...
static void F_185 ( struct V_4 * V_4 )
{
V_4 -> V_32 ++ ;
}
...
static void F_187 ( struct V_49 * V_44 , struct V_4 * V_4 ,
...
F_188 ( V_183 , F_189 ( V_184 ) ) ;
}
bool F_190 ( struct V_1 * V_1 , T_6 V_185 )
{
struct V_2 * V_3 ;
struct V_49 * V_44 ;
int V_39 ;
...
int F_193 ( struct V_186 * V_187 , struct V_1 * V_183 ,
...
static void F_201 ( struct V_204 * V_205 )
{
int V_58 ;
struct V_49 * V_44 ;
unsigned int V_39 ;
...
F_202 ( V_207 ) ;
struct V_2 * V_3 = F_203 ( V_205 , struct V_2 ,
V_199 ) ;
for ( V_58 = 0 ; V_58 < V_48 ; V_58 ++ ) {
V_44 = V_3 -> V_49 [ V_58 ] ;
if ( V_44 -> V_73 != V_58 )
continue;
F_74 ( & V_44 -> V_74 ) ;
F_204 ( & V_44 -> V_96 [ V_90 ] , & V_207 ) ;
F_76 ( & V_44 -> V_74 ) ;
}
F_205 (zspage, tmp, &free_pages, list) {
F_206 ( & V_4 -> V_97 ) ;
F_116 ( V_4 ) ;
F_56 ( V_4 , & V_39 , & V_41 ) ;
F_88 ( V_41 != V_90 ) ;
...
static void F_209 ( struct V_2 * V_3 , struct V_49 * V_44 )
{
struct V_167 V_168 ;
struct V_4 * V_209 ;
struct V_4 * V_210 = NULL ;
F_74 ( & V_44 -> V_74 ) ;
while ( ( V_209 = F_170 ( V_44 , true ) ) ) {
if ( ! F_75 ( V_44 ) )
break;
V_168 . V_110 = 0 ;
V_168 . V_156 = F_50 ( V_209 ) ;
while ( ( V_210 = F_170 ( V_44 , false ) ) ) {
V_168 . V_157 = F_50 ( V_210 ) ;
if ( ! F_168 ( V_3 , V_44 , & V_168 ) )
break;
F_171 ( V_44 , V_210 ) ;
}
if ( V_210 == NULL )
break;
F_171 ( V_44 , V_210 ) ;
if ( F_171 ( V_44 , V_209 ) == V_90 ) {
F_127 ( V_3 , V_44 , V_209 ) ;
...
unsigned long F_211 ( struct V_2 * V_3 )
{
int V_58 ;
struct V_49 * V_44 ;
...
void F_212 ( struct V_2 * V_3 , struct F_212 * V_52 )
{
memcpy ( V_52 , & V_3 -> V_52 , sizeof( struct F_212 ) ) ;
}
static unsigned long F_213 ( struct V_212 * V_212 ,
struct V_213 * V_214 )
{
unsigned long V_215 ;
struct V_2 * V_3 = F_203 ( V_212 , struct V_2 ,
V_212 ) ;
V_215 = V_3 -> V_52 . V_211 ;
V_215 = F_211 ( V_3 ) - V_215 ;
return V_215 ? V_215 : V_216 ;
}
static unsigned long F_214 ( struct V_212 * V_212 ,
struct V_213 * V_214 )
{
int V_58 ;
struct V_49 * V_44 ;
...
{
V_3 -> V_212 . V_219 = F_213 ;
V_3 -> V_212 . V_220 = F_214 ;
V_3 -> V_212 . V_221 = 0 ;
V_3 -> V_212 . V_222 = V_223 ;
return F_218 ( & V_3 -> V_212 ) ;
}
...
V_3 = F_219 ( sizeof( * V_3 ) , V_137 ) ;
if ( ! V_3 )
return NULL ;
F_15 ( V_3 ) ;
V_3 -> V_49 = F_220 ( V_48 , sizeof( struct V_49 * ) ,
V_137 ) ;
if ( ! V_3 -> V_49 ) {
F_148 ( V_3 ) ;
return NULL ;
}
V_3 -> V_14 = F_221 ( V_14 , V_137 ) ;
if ( ! V_3 -> V_14 )
goto V_225;
if ( F_17 ( V_3 ) )
goto V_225;
...
if ( V_224 ) {
if ( F_155 ( V_224 , V_79 , V_60 ) ) {
V_3 -> V_49 [ V_58 ] = V_224 ;
continue;
}
}
V_44 = F_219 ( sizeof( struct V_49 ) , V_137 ) ;
if ( ! V_44 )
goto V_225;
V_44 -> V_17 = V_17 ;
V_44 -> V_73 = V_58 ;
