...
if ( V_13 -> V_153 ) {
V_13 -> V_15 . V_154 =
F_65 ( V_13 -> V_29 , 0 , L_32 , 0 , 1 ) ;
if ( ! V_13 -> V_15 . V_154 )
return - V_61 ;
}
V_13 -> V_15 . V_155 =
F_65 ( V_13 -> V_29 , 0 , L_33 , 0 , 1 ) ;
if ( ! V_13 -> V_15 . V_155 )
return - V_61 ;
F_66 ( V_13 -> V_29 ) ;
V_152 = F_67 ( V_156 ) ;
...
V_172 = V_14 -> V_179 . V_168 ;
V_173 = V_19 -> V_167 . V_169 ;
V_174 = V_14 -> V_179 . V_169 ;
if ( ( ! ( V_167 -> V_21 & V_180 ) ) &&
( ( V_86 -> V_181 == V_182 ) ||
( ( V_86 -> V_181 == V_183 ) &&
F_73 ( F_74 ( V_82 ) ) &&
F_70 ( V_167 ) ) ) ) {
if ( V_86 -> V_184 != 0 )
V_14 -> V_175 = V_86 -> V_184 ;
else
V_14 -> V_175 = ( V_167 -> V_169 >> 5 ) + 16 ;
if ( V_86 -> V_185 != 0 )
V_14 -> V_176 = V_86 -> V_185 ;
else
V_14 -> V_176 = ( V_167 -> V_168 >> 5 ) + 16 ;
V_14 -> V_177 = V_186 ;
V_171 = V_19 -> V_167 . V_168 ;
V_172 = V_19 -> V_167 . V_168 - ( V_14 -> V_176 * 2 ) ;
V_173 = V_19 -> V_167 . V_169 ;
V_174 = V_19 -> V_167 . V_169 - ( V_14 -> V_175 * 2 ) ;
}
}
if ( V_14 -> V_177 != V_178 ) {
T_5 V_187 , V_188 ;
...
V_14 -> V_190 . V_189 = F_76 ( V_187 , V_188 ) ;
V_187 . V_189 = F_75 ( V_173 ) ;
V_188 . V_189 = F_75 ( V_174 ) ;
V_14 -> V_191 . V_189 = F_76 ( V_187 , V_188 ) ;
} else {
V_14 -> V_190 . V_189 = F_75 ( 1 ) ;
V_14 -> V_191 . V_189 = F_75 ( 1 ) ;
}
return true ;
}
...
if ( V_193 )
* V_193 = F_77 () ;
if ( F_78 ( V_13 , V_192 , & V_195 , & V_196 ) == 0 )
V_79 |= V_31 ;
if ( V_194 )
* V_194 = F_77 () ;
* V_23 = V_196 & 0x1fff ;
...
if ( ! ( V_21 & V_204 ) )
V_197 -= V_13 -> V_15 . V_16 [ V_192 ] -> V_205 ;
...
int F_79 ( struct V_12 * V_13 , int V_19 )
{
if ( V_19 < 0 || V_19 >= V_13 -> V_15 . V_207 )
return V_208 ;
switch ( V_19 ) {
case 0 :
return V_209 ;
