...
V_10 -> V_62 . V_90 = F_45 ;
F_67 ( & V_7 -> V_17 , V_10 ) ;
if ( F_68 ( & V_7 -> V_17 . V_91 ,
& V_92 ) )
goto V_77;
V_10 -> V_93 . V_94 = V_95 ;
V_10 -> V_7 -> V_17 . V_93 = & V_10 -> V_93 ;
V_10 -> V_56 = V_48 ;
if ( ! F_69 ( V_10 ) )
return V_10 ;
V_77:
...
F_73 ( V_10 -> V_96 ) ;
F_74 ( V_10 ) ;
F_75 ( & V_8 -> V_17 . V_91 , & V_92 ) ;
F_76 ( V_10 ) ;
F_77 ( V_10 ) ;
F_78 ( V_10 -> V_55 ) ;
F_12 ( V_10 ) ;
}
void F_79 ( struct V_97 * V_69 )
{
struct V_9 * V_10 = F_44 ( V_69 , struct V_9 ,
V_69 ) ;
struct V_7 * V_8 = V_10 -> V_7 ;
...
static void F_81 ( struct V_100 * V_17 )
{
...
F_63 ( & V_12 -> V_105 ) ;
F_84 ( & V_12 -> V_106 , 0 ) ;
F_56 ( & V_12 -> V_107 , V_108 ) ;
F_56 ( & V_12 -> V_109 , V_110 ) ;
F_56 ( & V_12 -> V_16 , V_111 ) ;
V_12 -> V_10 = V_10 ;
V_12 -> V_102 = V_102 ;
V_12 -> V_5 = V_5 ;
V_12 -> V_112 = V_113 ;
V_12 -> V_17 . V_114 = & V_10 -> V_7 -> V_17 ;
V_12 -> V_17 . V_115 = V_116 ;
V_12 -> V_17 . V_117 = F_81 ;
...
F_87 ( & V_10 -> V_40 ) ;
F_88 ( & V_12 -> V_81 , & V_10 -> V_79 ) ;
F_89 ( & V_10 -> V_40 ) ;
F_90 ( V_101 | V_119 , & V_12 -> V_101 ) ;
return V_12 ;
V_24:
F_12 ( V_10 ) ;
return F_53 ( V_25 ) ;
}
void F_91 ( struct V_120 * V_121 , int V_122 )
{
int V_123 ;
for ( V_123 = 0 ; V_123 < V_122 ; V_123 ++ , V_121 ++ )
if ( V_121 )
F_92 ( ( unsigned long ) F_93 ( V_121 ) ) ;
else
break;
}
int F_94 ( struct V_120 * V_121 , int V_122 )
{
void * V_124 ;
int V_123 ;
F_95 ( V_121 , V_122 ) ;
for ( V_123 = 0 ; V_123 < V_122 ; V_123 ++ , V_121 ++ ) {
V_124 = ( void * ) F_96 ( V_23 ) ;
if ( ! V_124 ) {
F_91 ( V_121 , V_123 ) ;
return - V_26 ;
}
F_97 ( V_121 , V_124 , V_51 ) ;
}
return 0 ;
}
