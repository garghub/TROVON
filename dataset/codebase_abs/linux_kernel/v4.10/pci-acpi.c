...
struct V_1 * V_2 ;
struct V_91 * V_92 ;
V_2 = F_32 ( V_96 , struct V_1 , V_97 . V_19 . V_96 ) ;
V_92 = F_33 ( V_2 ) ;
F_34 ( V_92 -> V_88 ) ;
}
...
struct V_98 * V_19 ;
struct V_83 * V_83 ;
V_19 = F_32 ( V_96 , struct V_98 , V_96 ) ;
V_83 = F_36 ( V_19 -> V_6 ) ;
if ( V_83 -> V_99 )
V_83 -> V_99 = false ;
if ( V_83 -> V_100 == V_101 ) {
...
V_105 = V_108 ;
V_104 = F_44 ( & V_90 -> V_6 , NULL , V_105 ) ;
if ( V_104 < 0 )
return V_109 ;
switch ( V_104 ) {
case V_110 :
...
static int F_48 ( struct V_83 * V_6 , T_6 V_117 )
{
struct V_1 * V_2 = F_46 ( & V_6 -> V_6 ) ;
static const T_7 V_118 [] = {
[ V_111 ] = V_110 ,
[ V_113 ] = V_112 ,
[ V_115 ] = V_114 ,
[ V_116 ] = V_107 ,
...
if ( ! V_2 || ! F_47 ( V_2 ) )
return V_122 ;
if ( F_55 ( V_2 , & V_117 ) || V_117 == V_123 )
return V_122 ;
return V_118 [ V_117 ] ;
}
static bool F_56 ( struct V_83 * V_6 )
{
struct V_1 * V_2 = F_46 ( & V_6 -> V_6 ) ;
return V_2 ? F_57 ( V_2 ) : false ;
}
static void F_58 ( struct V_85 * V_88 , bool V_124 )
{
while ( V_88 -> V_89 ) {
if ( ! F_59 ( & V_88 -> V_125 -> V_6 , V_124 ) )
return;
V_88 = V_88 -> V_89 ;
}
if ( V_88 -> V_126 )
F_59 ( V_88 -> V_126 , V_124 ) ;
}
static int F_60 ( struct V_83 * V_6 , bool V_124 )
{
if ( F_56 ( V_6 ) )
return F_59 ( & V_6 -> V_6 , V_124 ) ;
F_58 ( V_6 -> V_88 , V_124 ) ;
return 0 ;
}
static void F_61 ( struct V_85 * V_88 , bool V_124 )
{
while ( V_88 -> V_89 ) {
struct V_83 * V_126 = V_88 -> V_125 ;
if ( V_126 -> V_127 )
return;
if ( ! F_62 ( & V_126 -> V_6 , V_124 ) )
return;
V_88 = V_88 -> V_89 ;
}
if ( V_88 -> V_126 )
F_62 ( V_88 -> V_126 , V_124 ) ;
}
static int F_63 ( struct V_83 * V_6 , bool V_124 )
{
if ( V_6 -> V_127 && ! V_6 -> V_128 )
return 0 ;
if ( ! F_62 ( & V_6 -> V_6 , V_124 ) )
return 0 ;
F_61 ( V_6 -> V_88 , V_124 ) ;
return 0 ;
}
static bool F_64 ( struct V_83 * V_6 )
{
struct V_1 * V_2 = F_46 ( & V_6 -> V_6 ) ;
if ( ! V_2 || ! F_47 ( V_2 ) )
return false ;
if ( F_65 ( & V_6 -> V_6 ) != ! ! V_2 -> V_97 . V_129 )
return true ;
if ( F_66 () == V_130 )
return false ;
return ! ! V_2 -> V_131 . V_11 . V_132 ;
}
void F_67 ( struct V_85 * V_88 )
{
union V_31 * V_133 ;
struct V_134 * V_126 ;
if ( V_87 || ! V_88 -> V_126 )
...
if ( ! F_70 ( V_88 ) )
return;
V_133 = F_71 ( F_72 ( V_88 -> V_126 ) , V_135 , 3 ,
V_136 , NULL ) ;
if ( ! V_133 )
return;
if ( V_133 -> type == V_43 && V_133 -> integer . V_40 == 1 ) {
V_126 = F_73 ( V_88 ) ;
V_126 -> V_137 = 1 ;
}
F_74 ( V_133 ) ;
}
void F_75 ( struct V_85 * V_88 )
{
if ( V_87 || ! V_88 -> V_126 )
return;
F_76 ( V_88 ) ;
...
static struct V_1 * F_78 ( struct V_5 * V_6 )
{
struct V_83 * V_83 = F_36 ( V_6 ) ;
bool V_138 ;
T_8 V_139 ;
V_138 = F_79 ( V_83 ) ;
V_139 = ( F_80 ( V_83 -> V_140 ) << 16 ) | F_81 ( V_83 -> V_140 ) ;
return F_82 ( F_46 ( V_6 -> V_89 ) , V_139 ,
V_138 ) ;
}
static void F_83 ( struct V_83 * V_90 ,
T_2 V_17 )
{
struct V_134 * V_126 = F_73 ( V_90 -> V_88 ) ;
int V_40 ;
union V_31 * V_133 , * V_38 ;
if ( V_126 -> V_137 )
V_90 -> V_141 = 0 ;
V_133 = F_71 ( V_17 , V_135 , 3 ,
V_142 , NULL ) ;
if ( ! V_133 )
return;
if ( V_133 -> type == V_80 && V_133 -> V_37 . V_41 == 5 ) {
V_38 = V_133 -> V_37 . V_38 ;
if ( V_38 [ 0 ] . type == V_43 ) {
...
F_83 ( V_83 , V_2 -> V_17 ) ;
F_42 ( V_2 , V_83 ) ;
if ( ! V_2 -> V_97 . V_11 . V_146 )
return;
F_85 ( V_6 , true ) ;
F_60 ( V_83 , false ) ;
if ( V_2 -> V_97 . V_11 . V_147 )
F_86 ( V_6 , true ) ;
}
...
struct V_148 * F_91 ( struct V_85 * V_88 )
{
struct V_149 * V_150 ;
if ( ! V_151 )
return NULL ;
V_150 = V_151 ( & V_88 -> V_6 ) ;
if ( ! V_150 )
return NULL ;
return F_92 ( V_150 , V_152 ) ;
}
