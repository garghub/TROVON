...
static void F_100 ( void * V_240 , int V_241 , int V_242 )
{
struct V_7 * V_81 = V_240 ;
struct V_2 * V_3 = V_81 -> V_55 ;
struct V_56 * V_57 ;
struct V_243 * V_23 = V_81 -> V_244 ;
T_3 V_41 = V_241 + 0x04 ;
F_14 ( & V_81 -> V_11 . V_9 , L_29 , V_213 , V_41 ) ;
if ( F_101 ( V_23 -> V_193 . V_203 -> V_245 ) !=
V_246 )
return;
if ( F_102 ( & V_81 -> V_11 . V_247 ) )
return;
F_2 (pin, &hdmi->pin_list, head) {
if ( V_57 -> V_24 == V_41 )
F_82 ( V_57 , 1 ) ;
...
static struct V_248 * F_103 ( struct V_249 * V_203 ,
int V_8 )
{
struct V_250 * V_251 ;
F_2 (rtd, &card->rtd_list, list) {
if ( V_251 -> V_5 && ( V_251 -> V_5 -> V_8 == V_8 ) )
return V_251 -> V_5 ;
}
return NULL ;
}
...
V_248 = F_103 ( V_90 -> V_193 -> V_203 , V_8 ) ;
if ( V_248 ) {
V_121 = F_107 ( V_248 , V_8 , & V_3 -> V_65 ) ;
if ( V_121 < 0 ) {
F_17 ( & V_81 -> V_11 . V_9 ,
L_30 ,
V_121 , V_8 ) ;
...
F_80 ( & V_5 -> V_206 , & V_3 -> V_253 ) ;
sprintf ( V_252 , L_31 , V_8 ) ;
return F_108 ( V_158 -> V_203 -> V_245 , V_252 ,
V_166 , & V_5 -> V_165 , true , false ) ;
}
static int F_109 ( struct V_243 * V_23 )
{
struct V_7 * V_81 = F_105 ( V_23 ) ;
struct V_2 * V_3 = V_81 -> V_55 ;
struct V_157 * V_158 =
...
int V_33 ;
V_81 -> V_244 = V_23 ;
V_255 = F_110 ( V_81 -> V_256 , F_111 ( & V_81 -> V_11 . V_9 ) ) ;
if ( ! V_255 ) {
F_17 ( & V_81 -> V_11 . V_9 , L_32 ) ;
return - V_76 ;
}
F_112 ( V_81 -> V_256 , V_255 ) ;
V_33 = F_72 ( V_158 ) ;
if ( V_33 < 0 )
return V_33 ;
V_257 . V_258 = V_81 ;
...
F_2 (pin, &hdmi->pin_list, head)
F_82 ( V_57 , 1 ) ;
V_81 -> V_203 = V_158 -> V_203 -> V_245 ;
F_114 ( & V_81 -> V_11 . V_9 ) ;
F_115 ( & V_81 -> V_11 . V_9 ) ;
F_116 ( & V_81 -> V_11 . V_9 ) ;
return 0 ;
}
static int F_117 ( struct V_243 * V_23 )
{
struct V_7 * V_81 = F_105 ( V_23 ) ;
F_118 ( & V_81 -> V_11 . V_9 ) ;
return 0 ;
...
F_112 ( V_81 -> V_256 , V_255 ) ;
V_260 = F_68 ( & V_23 -> V_9 , sizeof( * V_260 ) , V_100 ) ;
if ( V_260 == NULL )
return - V_101 ;
V_81 -> V_55 = V_260 ;
F_127 ( V_23 , & V_260 -> V_65 ) ;
V_260 -> V_65 . V_66 . V_261 = F_121 ;
V_260 -> V_65 . V_66 . V_262 = F_123 ;
V_260 -> V_65 . V_66 . V_263 = F_124 ;
V_260 -> V_65 . V_66 . V_264 = F_125 ;
F_128 ( & V_23 -> V_9 , V_81 ) ;
F_129 ( & V_260 -> V_196 ) ;
F_129 ( & V_260 -> V_195 ) ;
F_129 ( & V_260 -> V_253 ) ;
F_92 ( & V_260 -> V_164 ) ;
V_33 = F_130 ( V_81 -> V_11 . V_265 , true ) ;
if ( V_33 < 0 ) {
F_17 ( & V_81 -> V_11 . V_9 ,
L_34 ,
V_33 ) ;
...
V_33 = F_131 ( & V_23 -> V_9 , & V_266 ,
V_226 , V_225 ) ;
F_132 ( V_81 -> V_256 , V_255 ) ;
return V_33 ;
}
static int F_133 ( struct V_7 * V_81 )
{
struct V_2 * V_3 = V_81 -> V_55 ;
struct V_56 * V_57 , * V_267 ;
struct V_115 * V_86 , * V_268 ;
struct V_1 * V_5 , * V_269 ;
F_134 ( & V_81 -> V_11 . V_9 ) ;
...
struct V_7 * V_81 = F_3 ( V_9 ) ;
struct V_10 * V_11 = & V_81 -> V_11 ;
struct V_270 * V_265 = V_11 -> V_265 ;
struct V_271 * V_256 = F_138 ( V_265 ) ;
struct V_254 * V_255 = NULL ;
int V_121 ;
F_14 ( V_9 , L_36 , V_213 ) ;
if ( ! V_265 )
...
F_13 ( V_11 , V_11 -> V_233 , 0 , V_85 ,
V_118 ) ;
V_121 = F_130 ( V_265 , false ) ;
if ( V_121 < 0 ) {
F_17 ( V_265 -> V_9 , L_37 ) ;
return V_121 ;
}
V_255 = F_110 ( V_256 , F_111 ( V_9 ) ) ;
if ( ! V_255 ) {
F_17 ( V_9 , L_32 ) ;
return - V_76 ;
}
