...
static void F_16 ( struct V_4 * type )
{
int V_3 , V_25 ;
...
if ( ! V_26 )
continue;
V_26 -> V_17 = F_8 ( sizeof( struct V_6 ) , V_26 -> V_18 ) +
V_26 -> V_16 ;
...
( V_27 -> V_30 & V_31 ) == 0 )
continue;
V_26 -> V_17 = F_8 ( V_26 -> V_17 , V_27 -> V_18 )
+ V_27 -> V_16 ;
}
}
}
int F_19 ( struct V_4 * type )
{
int V_33 = 0 ;
F_20 ( & V_32 ) ;
if ( V_9 [ type -> V_12 ] ) {
