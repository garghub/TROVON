...
V_6 = F_3 ( V_2 ) ;
V_90 = F_60 ( & V_88 -> V_81 ) ;
V_6 -> V_58 = F_61 ( V_90 -> V_92 , & V_88 -> V_81 ) ;
if ( ! V_6 -> V_58 ) {
F_62 ( & V_88 -> V_81 , L_5 ) ;
V_70 = - V_86 ;
goto V_93;
...
static int F_72 ( struct V_87 * V_88 , T_2 V_97 )
{
F_62 ( & V_88 -> V_81 , L_7 ) ;
return 0 ;
}
