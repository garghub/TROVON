...
struct V_72 V_73 ;
F_17 ( & V_15 -> V_23 ) ;
V_15 -> V_31 -> V_74 -> V_75 ( V_15 -> V_31 , & V_73 ) ;
F_25 ( & V_15 -> V_23 ) ;
snprintf ( V_70 , V_71 , L_36 , V_73 . V_76 ) ;
}
static void * F_36 ( struct V_77 * V_60 )
{
struct V_14 * V_15 ;
union V_78 V_79 ;
struct V_55 * V_80 ;
...
V_15 -> V_7 . V_90 = V_91 ;
V_15 -> V_7 . V_92 = V_93 ;
V_15 -> V_7 . V_94 = & V_60 -> V_60 ;
V_15 -> V_7 . V_95 = V_96 ;
F_45 ( V_15 -> V_7 . V_8 , L_40 , V_97 ) ;
V_15 -> V_7 . V_98 =
( 1ull << V_99 ) |
( 1ull << V_100 ) |
( 1ull << V_101 ) |
...
if ( F_20 ( V_15 -> V_31 ) )
F_21 ( V_15 -> V_41 ) ;
V_80 = ( (struct V_168 * ) ( V_31 -> V_169 ) ) -> V_170 ;
if ( V_80 != NULL )
F_30 ( V_15 -> V_41 , V_80 -> V_57 ) ;
F_47 ( V_15 -> V_31 -> V_171 ,
V_15 -> V_41 -> V_58 , & V_79 . V_172 [ 0 ] ) ;
memcpy ( & V_15 -> V_7 . V_173 , & V_79 . V_174 . V_175 ,
sizeof( V_79 . V_174 . V_175 ) ) ;
F_48 ( & V_15 -> V_176 ) ;
F_18 ( L_41 ,
...
static void F_54 ( struct V_177 * V_177 )
{
struct V_14 * V_15 , * V_178 ;
struct V_77 * V_60 ;
bool V_179 = false ;
V_60 = F_35 ( V_177 , struct V_14 , V_176 ) -> V_85 ;
F_17 ( & V_53 ) ;
F_55 (us_ibdev, tmp,
...
F_57 ( ! V_179 , L_44 , F_42 ( V_60 ) ) ;
F_25 ( & V_53 ) ;
}
static struct V_14 * F_58 ( struct V_181 * V_9 )
{
struct V_14 * V_15 ;
struct V_77 * V_182 , * V_183 ;
int V_67 ;
V_183 = F_59 ( V_9 ) ;
V_182 = F_60 ( V_183 ) ;
F_10 ( ! V_182 ) ;
...
F_64 ( & V_15 -> V_180 , & V_185 ) ;
V_184:
F_25 ( & V_53 ) ;
return V_15 ;
}
static int F_65 ( struct V_77 * V_85 ,
...
V_5 -> V_9 = F_71 ( V_85 ) ;
if ( F_62 ( V_5 -> V_9 ) ) {
V_67 = V_5 -> V_9 ? F_72 ( V_5 -> V_9 ) : - V_191 ;
F_14 ( L_47 ,
F_42 ( V_85 ) , V_67 ) ;
goto V_195;
}
...
F_14 ( L_48 ,
F_42 ( V_85 ) , F_72 ( V_6 ) ) ;
V_67 = V_6 ? F_72 ( V_6 ) : - V_81 ;
goto V_196;
}
V_5 -> V_6 = V_6 ;
F_73 ( & V_5 -> V_197 ) ;
F_17 ( & V_6 -> V_23 ) ;
F_74 ( & V_5 -> V_198 , & V_6 -> V_83 ) ;
for ( V_189 = V_199 + 1 ;
V_189 < V_200 ;
V_189 ++ ) {
V_6 -> V_201 [ V_189 ] = F_75 ( V_5 -> V_9 ,
V_189 ) ;
}
F_25 ( & V_6 -> V_23 ) ;
F_18 ( L_49 , F_42 ( V_85 ) ,
...
static void F_81 ( struct V_77 * V_85 )
{
struct V_4 * V_5 = F_37 ( V_85 ) ;
