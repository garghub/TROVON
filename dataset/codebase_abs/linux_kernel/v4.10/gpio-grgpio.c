...
V_6 -> V_72 = V_54 -> V_73 ;
V_6 -> V_74 = - 1 ;
V_58 = F_33 ( V_54 , L_5 , & V_59 ) ;
if ( V_58 || V_59 <= 0 || V_59 > V_75 ) {
V_6 -> V_13 = V_75 ;
F_16 ( & V_52 -> V_36 ,
L_6 , V_6 -> V_13 ) ;
} else {
...
F_40 ( & V_52 -> V_36 , L_12 ,
V_2 -> V_11 , V_6 -> V_74 , V_6 -> V_13 , V_2 -> V_17 ? L_13 : L_14 ) ;
return 0 ;
}
static int F_41 ( struct V_51 * V_52 )
{
struct V_1 * V_2 = F_42 ( V_52 ) ;
unsigned long V_20 ;
int V_37 ;
int V_47 = 0 ;
F_8 ( & V_2 -> V_6 . V_31 , V_20 ) ;
