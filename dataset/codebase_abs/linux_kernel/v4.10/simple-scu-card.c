...
if ( ! V_66 )
return - V_68 ;
V_38 = F_25 ( & V_7 -> V_51 , V_53 L_7 ) ;
if ( V_38 < 0 )
return V_38 ;
F_26 ( V_66 , V_53 L_8 , & V_7 -> V_27 ) ;
F_26 ( V_66 , V_53 L_9 , & V_7 -> V_30 ) ;
V_32 = F_27 ( V_66 , V_53 L_10 ) ;
if ( ! V_32 )
return - V_69 ;
V_38 = F_28 ( V_37 , V_66 , V_32 , V_53 , & V_33 ) ;
if ( V_38 < 0 )
return V_38 ;
V_67 = 0 ;
F_29 (node, np) {
...
struct V_31 * V_32 = V_71 -> V_37 . V_72 ;
int V_11 , V_38 ;
V_7 = F_32 ( V_37 , sizeof( * V_7 ) , V_73 ) ;
if ( ! V_7 )
return - V_74 ;
V_11 = F_33 ( V_32 ) ;
V_10 = F_32 ( V_37 , sizeof( * V_10 ) * V_11 , V_73 ) ;
V_16 = F_32 ( V_37 , sizeof( * V_16 ) * V_11 , V_73 ) ;
if ( ! V_10 || ! V_16 )
return - V_74 ;
V_7 -> V_10 = V_10 ;
V_7 -> V_16 = V_16 ;
