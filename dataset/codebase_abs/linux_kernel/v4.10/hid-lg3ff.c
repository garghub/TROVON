...
int V_16 , V_17 ;
memset ( V_13 -> V_18 [ 0 ] -> V_19 , 0 ,
sizeof( V_20 ) * V_13 -> V_18 [ 0 ] -> V_21 ) ;
switch ( V_5 -> type ) {
case V_22 :
...
const signed short * V_33 = V_34 ;
int error ;
int V_35 ;
if ( ! F_7 ( V_7 , V_11 , 0 , 0 , 35 ) )
return - V_36 ;
for ( V_35 = 0 ; V_33 [ V_35 ] >= 0 ; V_35 ++ )
F_8 ( V_33 [ V_35 ] , V_2 -> V_37 ) ;
error = F_9 ( V_2 , NULL , F_1 ) ;
if ( error )
return error ;
if ( F_10 ( V_38 , V_2 -> V_37 ) )
V_2 -> V_39 -> V_40 = F_5 ;
F_11 ( V_7 , L_1 ) ;
return 0 ;
}
