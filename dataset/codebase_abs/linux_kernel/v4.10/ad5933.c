...
{
int V_6 , V_101 = 0 ;
struct V_102 * V_103 = F_53 ( & V_2 -> V_7 ) ;
struct V_8 * V_9 ;
struct V_46 * V_47 ;
V_47 = F_54 ( & V_2 -> V_7 , sizeof( * V_9 ) ) ;
if ( ! V_47 )
return - V_84 ;
V_9 = F_19 ( V_47 ) ;
F_55 ( V_2 , V_47 ) ;
...
V_47 -> V_111 = & V_112 ;
V_47 -> V_113 = V_100 -> V_113 ;
V_47 -> V_87 = V_114 ;
V_47 -> V_115 = V_116 ;
V_47 -> V_117 = F_62 ( V_116 ) ;
V_6 = F_43 ( V_47 ) ;
if ( V_6 )
goto V_118;
V_6 = F_14 ( V_9 ) ;
