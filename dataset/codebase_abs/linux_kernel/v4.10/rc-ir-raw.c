...
static int F_34 ( struct V_18 * V_12 , T_3 * V_43 )
{
return 0 ;
}
static void F_35 ( struct V_18 * V_12 , T_3 V_15 )
{
F_10 ( & V_12 -> V_8 ) ;
V_12 -> V_14 &= ~ V_15 ;
V_12 -> V_44 &= ~ V_15 ;
...
int F_36 ( struct V_18 * V_12 )
{
int V_26 ;
struct V_4 * V_5 ;
if ( ! V_12 )
return - V_19 ;
V_12 -> V_7 = F_37 ( sizeof( * V_12 -> V_7 ) , V_45 ) ;
if ( ! V_12 -> V_7 )
return - V_46 ;
V_12 -> V_7 -> V_12 = V_12 ;
V_12 -> F_34 = F_34 ;
F_38 ( V_12 -> V_7 -> V_9 ) ;
F_39 ( & V_12 -> V_7 -> V_8 ) ;
V_12 -> V_7 -> V_41 = F_40 ( F_1 , V_12 -> V_7 ,
L_7 , V_12 -> V_47 ) ;
if ( F_41 ( V_12 -> V_7 -> V_41 ) ) {
V_26 = F_42 ( V_12 -> V_7 -> V_41 ) ;
goto V_48;
}
F_10 ( & V_13 ) ;
F_43 ( & V_12 -> V_7 -> V_49 , & V_50 ) ;
F_11 (handler, &ir_raw_handler_list, list)
if ( V_5 -> V_51 )
V_5 -> V_51 ( V_12 ) ;
F_12 ( & V_13 ) ;
