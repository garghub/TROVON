...
static void F_76 ( struct V_101 * V_9 )
{
struct V_16 * V_102 = F_77 ( V_9 ) ;
...
static int F_80 ( struct V_101 * V_9 , void * V_13 )
{
struct V_112 * V_113 = V_13 ;
return V_9 -> V_114 == V_113 ;
}
...
struct V_112 * V_52 = V_9 -> V_114 ;
struct V_115 * V_116 = NULL ;
F_83 ( & V_2 -> V_9 , F_84 ( 32 ) ) ;
if ( V_52 ) {
struct V_112 * V_117 ;
int V_20 ;
for ( V_20 = 0 ; ; V_20 ++ ) {
V_117 = F_85 ( V_52 , L_14 , V_20 ) ;
if ( ! V_117 )
break;
F_86 ( & V_2 -> V_9 , & V_116 ,
F_80 , V_117 ) ;
...
char * * V_119 = V_9 -> V_118 ;
unsigned V_20 ;
for ( V_20 = 0 ; V_119 [ V_20 ] ; V_20 ++ )
F_88 ( V_9 , & V_116 , F_81 , V_119 [ V_20 ] ) ;
}
return F_89 ( V_9 , & V_120 , V_116 ) ;
}
