...
V_77 = F_34 ( V_6 , V_83 , 0 ) ;
if ( ! V_77 ) {
V_77 = F_34 ( V_6 , V_84 , 0 ) ;
if ( ! V_77 )
return - V_36 ;
}
if ( V_77 -> V_14 & V_84 ) {
...
V_8 = F_35 ( & V_6 -> V_2 , sizeof( * V_8 ) , V_87 ) ;
if ( ! V_8 )
return - V_79 ;
V_8 -> V_9 = V_13 -> V_9 ;
if ( ! V_8 -> V_9 ) {
V_8 -> V_9 = F_36 ( & V_6 -> V_2 , V_77 -> V_89 ,
F_37 ( V_77 ) ) ;
if ( ! V_8 -> V_9 )
return V_78 ;
}
...
F_41 ( & V_8 -> V_15 ) ;
F_42 ( V_6 , V_8 ) ;
V_8 -> V_61 = F_43 ( & V_6 -> V_2 , V_80 , V_82 ,
V_97 ) ;
if ( F_44 ( V_8 -> V_61 ) )
return F_45 ( V_8 -> V_61 ) ;
V_98 . V_74 = V_13 -> V_92 ;
V_78 = F_46 ( & V_6 -> V_2 . V_69 , & V_98 ) ;
if ( V_78 )
return V_78 ;
return 0 ;
}
