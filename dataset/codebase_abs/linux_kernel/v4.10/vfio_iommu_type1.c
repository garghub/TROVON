...
static int F_97 ( void * V_72 ,
struct V_133 * V_133 )
{
struct V_2 * V_3 = V_72 ;
struct V_132 * V_135 ;
struct V_88 * V_89 , * V_90 ;
struct V_125 * V_126 = NULL , * V_136 ;
int V_24 ;
F_61 ( & V_3 -> V_80 ) ;
F_74 (d, &iommu->domain_list, next) {
if ( F_96 ( V_90 , V_133 ) ) {
...
V_135 -> V_133 = V_133 ;
V_24 = F_98 ( V_133 , & V_126 , F_87 ) ;
if ( V_24 )
goto V_137;
V_136 = F_99 ( V_138 ) ;
if ( V_136 ) {
if ( ( V_126 == V_136 ) && ! F_100 ( V_126 ) ) {
F_101 ( V_138 ) ;
if ( ! V_3 -> V_81 ) {
F_102 ( & V_89 -> V_139 ) ;
V_3 -> V_81 = V_89 ;
...
if ( V_3 -> V_141 ) {
int V_142 = 1 ;
V_24 = F_105 ( V_89 -> V_89 , V_143 ,
& V_142 ) ;
if ( V_24 )
goto V_144;
}
V_24 = F_106 ( V_89 -> V_89 , V_133 ) ;
if ( V_24 )
goto V_144;
F_102 ( & V_89 -> V_139 ) ;
F_103 ( & V_135 -> V_92 , & V_89 -> V_139 ) ;
if ( ! V_145 &&
! F_107 ( V_126 , V_146 ) ) {
F_52 ( L_3 ,
V_62 ) ;
...
if ( F_107 ( V_126 , V_148 ) )
V_89 -> V_25 |= V_149 ;
F_74 (d, &iommu->domain_list, next) {
if ( V_90 -> V_89 -> V_150 == V_89 -> V_89 -> V_150 &&
V_90 -> V_25 == V_89 -> V_25 ) {
F_108 ( V_89 -> V_89 , V_133 ) ;
if ( ! F_106 ( V_90 -> V_89 , V_133 ) ) {
F_103 ( & V_135 -> V_92 , & V_90 -> V_139 ) ;
F_109 ( V_89 -> V_89 ) ;
F_15 ( V_89 ) ;
F_63 ( & V_3 -> V_80 ) ;
return 0 ;
...
static void * F_117 ( unsigned long V_152 )
{
struct V_2 * V_3 ;
...
static void F_121 ( struct V_88 * V_89 , bool V_156 )
{
struct V_132 * V_135 , * V_157 ;
F_122 (group, group_tmp,
&domain->group_list, next) {
if ( ! V_156 )
F_108 ( V_89 -> V_89 , V_135 -> V_133 ) ;
F_114 ( & V_135 -> V_92 ) ;
F_15 ( V_135 ) ;
}
if ( ! V_156 )
...
static void F_123 ( void * V_72 )
{
struct V_2 * V_3 = V_72 ;
struct V_88 * V_89 , * V_158 ;
if ( V_3 -> V_81 ) {
F_121 ( V_3 -> V_81 , true ) ;
F_112 ( V_3 ) ;
F_15 ( V_3 -> V_81 ) ;
...
static long F_125 ( void * V_72 ,
unsigned int V_159 , unsigned long V_152 )
{
struct V_2 * V_3 = V_72 ;
unsigned long V_160 ;
if ( V_159 == V_161 ) {
...
struct V_164 V_165 ;
V_160 = F_126 ( struct V_164 , V_166 ) ;
if ( F_127 ( & V_165 , ( void V_167 * ) V_152 , V_160 ) )
return - V_168 ;
if ( V_165 . V_169 < V_160 )
return - V_77 ;
V_165 . V_46 = V_170 ;
V_165 . V_166 = F_73 ( V_3 ) ;
return F_128 ( ( void V_167 * ) V_152 , & V_165 , V_160 ) ?
- V_168 : 0 ;
} else if ( V_159 == V_171 ) {
struct V_114 V_115 ;
T_5 V_104 = V_117 |
V_116 ;
V_160 = F_126 ( struct V_114 , V_5 ) ;
if ( F_127 ( & V_115 , ( void V_167 * ) V_152 , V_160 ) )
return - V_168 ;
if ( V_115 . V_169 < V_160 || V_115 . V_46 & ~ V_104 )
return - V_77 ;
return F_85 ( V_3 , & V_115 ) ;
} else if ( V_159 == V_172 ) {
struct V_102 V_103 ;
long V_24 ;
V_160 = F_126 ( struct V_102 , V_5 ) ;
if ( F_127 ( & V_103 , ( void V_167 * ) V_152 , V_160 ) )
return - V_168 ;
if ( V_103 . V_169 < V_160 || V_103 . V_46 )
return - V_77 ;
V_24 = F_75 ( V_3 , & V_103 ) ;
if ( V_24 )
return V_24 ;
return F_128 ( ( void V_167 * ) V_152 , & V_103 , V_160 ) ?
- V_168 : 0 ;
}
return - V_173 ;
}
static int F_129 ( void * V_72 ,
unsigned long * V_174 ,
struct V_175 * V_176 )
{
struct V_2 * V_3 = V_72 ;
...
if ( * V_174 )
return - V_77 ;
return F_130 ( & V_3 -> V_82 , V_176 ) ;
}
static int F_131 ( void * V_72 ,
struct V_175 * V_176 )
{
struct V_2 * V_3 = V_72 ;
return F_132 ( & V_3 -> V_82 , V_176 ) ;
}
