...
F_2 (self->magic == IRCOMM_TTY_MAGIC, return;) ;
F_10 ( & V_2 -> V_10 ) ;
if ( V_2 -> V_11 ) {
F_11 ( V_2 -> V_11 ) ;
V_2 -> V_11 = NULL ;
...
return;
if ( V_2 -> V_25 & V_26 ) {
V_2 -> V_14 = F_18 ( L_2 , V_29 ) ;
F_19 ( V_2 -> V_14 , L_3 ,
V_2 -> V_19 , V_30 ) ;
} else {
V_2 -> V_14 = F_18 ( L_4 , V_31 ) ;
F_19 ( V_2 -> V_14 , L_5 ,
V_2 -> V_19 , V_30 ) ;
F_20 ( V_22 , L_6 ,
V_32 , 1 , V_2 -> V_25 ,
V_33 , 1 , V_34 ) ;
F_21 ( V_2 -> V_14 , L_7 , V_22 , 6 ,
V_30 ) ;
}
F_22 ( V_2 -> V_14 ) ;
}
