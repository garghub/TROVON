...
static int F_54 ( struct V_16 * V_30 , void * V_231 )
{
return V_30 -> V_231 == V_231 ;
}
static struct
V_232 * F_55 ( struct V_233 * V_231 )
{
struct V_16 * V_30 ;
V_30 = F_56 ( & V_234 , NULL ,
V_231 , F_54 ) ;
return V_30 ? F_57 ( V_30 ) : NULL ;
}
...
} else if ( F_61 ( V_30 -> V_231 ) ) {
const struct V_247 * V_248 ;
V_248 = F_62 ( V_249 , V_30 ) ;
if ( ! V_248 ) {
F_9 ( V_30 , L_8 ) ;
return - V_244 ;
}
...
V_239 = F_63 ( V_2 -> V_31 , V_251 , 0 ) ;
if ( ! V_239 ) {
F_9 ( V_30 , L_12 ) ;
return - V_25 ;
}
V_2 -> V_252 = F_64 ( V_30 , V_239 ) ;
if ( F_65 ( V_2 -> V_252 ) )
return F_66 ( V_2 -> V_252 ) ;
V_45 = F_67 ( V_30 , L_13 ,
( T_1 * ) & V_2 -> V_50 . V_253 ,
V_254 ) ;
if ( V_45 ) {
...
struct V_256 args ;
struct V_233 * V_231 ;
V_45 = F_70 ( V_30 -> V_231 ,
L_15 ,
V_9 , & args ) ;
if ( V_45 )
continue;
V_231 = F_71 ( args . V_257 ) ;
V_31 = F_55 ( V_231 ) ;
} else {
F_9 ( V_30 , L_16 ) ;
return - V_244 ;
...
V_2 -> V_262 [ V_9 ] = F_74 ( V_2 -> V_31 , V_9 ) ;
if ( V_2 -> V_262 [ V_9 ] <= 0 ) {
F_9 ( V_30 , L_21 , V_9 ) ;
return - V_25 ;
}
...
return 0 ;
V_284:
F_77 ( V_2 , & V_2 -> V_272 . V_276 ) ;
V_279:
F_77 ( V_2 , & V_2 -> V_272 . V_272 ) ;
V_275:
F_77 ( V_2 , & V_2 -> V_263 . V_268 ) ;
V_271:
F_77 ( V_2 , & V_2 -> V_263 . V_264 ) ;
return V_45 ;
}
...
static int F_88 ( struct V_232 * V_31 )
{
int V_45 ;
struct V_1 * V_2 ;
struct V_16 * V_30 = & V_31 -> V_30 ;
V_2 = (struct V_1 * ) F_89 ( sizeof( * V_2 ) ) ;
if ( ! V_2 )
return - V_132 ;
V_2 -> V_31 = V_31 ;
F_90 ( V_31 , V_2 ) ;
if ( F_91 ( V_30 , F_92 ( 64ULL ) ) &&
F_91 ( V_30 , F_92 ( 32ULL ) ) ) {
F_9 ( V_30 , L_33 ) ;
V_45 = - V_292 ;
goto V_293;
}
...
static int F_102 ( struct V_232 * V_31 )
{
