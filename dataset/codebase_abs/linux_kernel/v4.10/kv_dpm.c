...
for ( V_12 = 0 ; V_12 < V_2 -> V_8 . V_9 . V_437 ; V_12 ++ ) {
T_1 V_94 ;
...
V_38 -> V_127 = false ;
V_38 -> V_210 = false ;
V_38 -> V_247 = ( V_2 -> V_446 & V_447 ) ? true : false ;
V_38 -> V_229 = true ;
V_38 -> V_253 = ( V_2 -> V_446 & V_448 ) ? true : false ;
V_38 -> V_256 = ( V_2 -> V_446 & V_449 ) ? true : false ;
V_38 -> V_259 = ( V_2 -> V_446 & V_450 ) ? true : false ;
V_38 -> V_230 = false ;
V_65 = F_118 ( V_2 ) ;
if ( V_65 )
return V_65 ;
...
T_3 V_284 ;
if ( V_453 >= V_457 ) {
F_134 ( V_452 , L_22 , V_453 ) ;
} else {
V_94 = F_117 ( V_38 -> V_98 [ V_453 ] . V_101 ) ;
V_76 = ( F_9 ( V_458 ) &
V_459 ) >>
V_460 ;
V_284 = F_31 ( V_2 , ( T_3 ) V_76 ) ;
F_134 ( V_452 , L_23 , V_38 -> V_215 ? L_24 : L_25 ) ;
F_134 ( V_452 , L_26 , V_38 -> V_216 ? L_24 : L_25 ) ;
F_134 ( V_452 , L_27 ,
V_453 , V_94 , V_284 ) ;
}
}
...
static T_1 F_143 ( struct V_1 * V_2 , bool V_461 )
{
struct V_37 * V_38 = F_7 ( V_2 ) ;
struct V_32 * V_462 = F_6 ( & V_38 -> V_197 ) ;
if ( V_461 )
return V_462 -> V_263 [ 0 ] . V_94 ;
else
return V_462 -> V_263 [ V_462 -> V_265 - 1 ] . V_94 ;
}
static T_1 F_144 ( struct V_1 * V_2 , bool V_461 )
{
struct V_37 * V_38 = F_7 ( V_2 ) ;
...
if ( V_65 )
return V_65 ;
V_2 -> V_8 . V_9 . V_466 = V_467 ;
V_2 -> V_8 . V_9 . V_468 = V_467 ;
V_2 -> V_8 . V_9 . V_278 = V_277 ;
V_2 -> V_8 . V_469 = V_2 -> clock . V_469 ;
V_2 -> V_8 . V_470 = V_2 -> clock . V_470 ;
V_2 -> V_8 . V_471 = V_2 -> clock . V_469 ;
V_2 -> V_8 . V_472 = V_2 -> clock . V_470 ;
V_2 -> V_8 . V_204 = V_473 ;
if ( V_465 == 0 )
return 0 ;
F_153 ( & V_2 -> V_8 . V_9 . V_207 . V_474 , V_475 ) ;
F_154 ( & V_2 -> V_8 . V_476 ) ;
V_65 = F_130 ( V_2 ) ;
if ( V_65 )
goto V_477;
...
static int F_158 ( void * V_464 )
{
struct V_1 * V_2 = (struct V_1 * ) V_464 ;
F_159 ( & V_2 -> V_8 . V_9 . V_207 . V_474 ) ;
F_154 ( & V_2 -> V_8 . V_476 ) ;
F_160 ( V_2 ) ;
F_140 ( V_2 ) ;
F_156 ( & V_2 -> V_8 . V_476 ) ;
...
static bool F_166 ( void * V_464 )
{
return true ;
}
static int F_167 ( void * V_464 )
{
return 0 ;
}
static int F_168 ( void * V_464 )
{
return 0 ;
}
...
case 230 :
F_171 ( L_32 ) ;
V_2 -> V_8 . V_9 . V_207 . V_492 = false ;
V_490 = true ;
break;
case 231 :
F_171 ( L_33 ) ;
V_2 -> V_8 . V_9 . V_207 . V_492 = true ;
V_490 = true ;
break;
default:
break;
...
if ( V_490 )
F_172 ( & V_2 -> V_8 . V_9 . V_207 . V_474 ) ;
return 0 ;
}
static int F_173 ( void * V_464 ,
enum V_493 V_466 )
{
return 0 ;
}
static int F_174 ( void * V_464 ,
enum V_494 V_466 )
{
return 0 ;
}
...
{
V_2 -> V_8 . V_9 . V_207 . V_202 . V_498 = V_499 ;
V_2 -> V_8 . V_9 . V_207 . V_202 . V_68 = & V_500 ;
}
