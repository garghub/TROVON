...
static bool F_46 ( struct V_29 * V_30 )
{
struct V_29 * V_210 ;
F_47 (a, &reset_list, list) {
if ( F_33 ( V_30 -> V_152 ) &&
...
V_156 = F_50 ( V_30 -> V_157 [ V_211 ] . V_214 ,
...
static int F_56 ( struct V_227 * V_228 ,
...
int V_156 , V_211 ;
T_3 V_25 ;
V_30 = F_57 ( & V_228 -> V_2 , sizeof( struct V_29 ) , V_239 ) ;
if ( ! V_30 )
return - V_240 ;
V_30 -> V_153 = F_58 ( V_228 , & V_241 ) ;
if ( F_59 ( V_30 -> V_153 ) ) {
V_156 = F_60 ( V_30 -> V_153 ) ;
return V_156 ;
}
F_39 ( V_30 -> V_153 , true ) ;
F_61 ( V_228 , V_30 ) ;
...
V_235 = F_57 ( & V_228 -> V_2 , sizeof( * V_235 ) ,
V_239 ) ;
if ( ! V_235 )
return - V_240 ;
V_156 = F_62 ( V_237 , L_8 , 0 ) ;
if ( V_156 >= 0 )
V_30 -> V_152 = V_156 ;
else
V_30 -> V_152 = - 1 ;
...
V_156 = F_67 ( & V_228 -> V_2 , F_14 ( V_30 -> V_157 ) ,
V_30 -> V_157 ) ;
if ( V_156 != 0 ) {
...
if ( V_30 -> V_37 == V_44 ) {
V_156 = F_68 ( V_30 -> V_153 , V_247 ,
F_14 ( V_247 ) ) ;
if ( V_156 != 0 )
F_27 ( & V_228 -> V_2 , L_15 ,
V_156 ) ;
}
V_156 = F_69 ( & V_228 -> V_2 ,
& V_248 , & V_249 , 1 ) ;
if ( V_156 != 0 )
goto V_246;
F_70 ( & V_30 -> V_212 , & V_250 ) ;
return 0 ;
V_246:
if ( F_33 ( V_30 -> V_152 ) &&
! F_46 ( V_30 ) )
...
static int F_72 ( struct V_227 * V_251 )
{
struct V_29 * V_30 = F_73 ( V_251 ) ;
F_74 ( & V_251 -> V_2 ) ;
if ( F_33 ( V_30 -> V_152 ) &&
! F_46 ( V_30 ) ) {
F_34 ( V_30 -> V_152 , 0 ) ;
