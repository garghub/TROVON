...
if ( V_4 -> V_552 )
F_217 ( V_4 -> V_552 ) ;
V_8 = F_218 ( V_168 , V_168 , V_553 , NULL ) ;
break;
}
case V_554 : {
struct V_555 * V_556 = V_168 -> V_557 ;
F_219 ( V_556 , V_558 ) ;
break;
}
case V_559 :
V_8 = F_218 ( V_168 , V_168 , V_560 , NULL ) ;
if ( V_8 == 0 )
V_8 = F_220 ( V_510 ,
F_208 ,
( void * ) V_150 ) ;
break;
case V_561 :
V_8 = F_218 ( V_168 , V_168 , V_562 , NULL ) ;
break;
case V_563 :
case V_564 :
break;
...
F_236 ( V_168 ) ;
F_237 ( V_168 ) ;
F_238 ( V_168 -> V_557 , F_223 ) ;
V_168 -> V_557 -> V_590 = & V_591 ;
V_8 = F_225 ( V_168 ) ;
if ( V_8 ) {
F_239 ( V_168 ) ;
F_48 ( L_74 ) ;
