...
static int F_26 ( struct V_72 * V_73 , const struct V_74 * V_75 )
{
struct V_1 * V_2 = & V_8 ;
const struct V_34 * V_36 = (struct V_34 * ) V_75 -> V_76 ;
int V_77 ;
F_27 ( V_73 , V_78 , & V_13 ) ;
V_13 &= V_79 ;
if ( V_13 != 0 && V_80 == NULL )
V_80 = F_7 ;
F_27 ( V_73 , V_81 , & V_2 -> V_82 ) ;
V_2 -> V_82 &= V_83 ;
V_2 -> V_4 = F_28 ( V_2 -> V_82 , V_84 ) ;
if ( ! V_2 -> V_4 ) {
F_29 ( & V_73 -> V_85 , L_19 ) ;
return - V_65 ;
}
