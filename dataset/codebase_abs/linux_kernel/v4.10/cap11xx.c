...
V_12 -> V_18 -> V_82 [ 0 ] = F_42 ( V_83 ) ;
if ( F_38 ( V_38 , L_14 ) )
F_43 ( V_84 , V_12 -> V_18 -> V_82 ) ;
for ( V_15 = 0 ; V_15 < V_61 -> V_69 ; V_15 ++ )
F_43 ( V_12 -> V_20 [ V_15 ] , V_12 -> V_18 -> V_85 ) ;
F_44 ( V_86 , V_12 -> V_18 -> V_85 ) ;
