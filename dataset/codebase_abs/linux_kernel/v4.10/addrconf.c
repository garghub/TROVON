...
V_503 = 0 ;
if ( V_9 -> V_43 . V_504 ||
F_38 ( V_9 -> V_11 ) -> V_22 . V_126 -> V_504 ) {
do
F_165 ( & V_503 , 6 ) ;
while ( V_503 == 0 );
}
V_14 -> V_505 = V_503 ;
V_14 -> V_506 = V_9 -> V_43 . V_230 ;
F_20 ( V_14 , V_502 ) ;
}
...
static void V_188 ( struct V_510 * V_511 )
{
struct V_13 * V_14 = F_330 ( F_331 ( V_511 ) ,
struct V_13 ,
V_15 ) ;
struct V_8 * V_9 = V_14 -> V_9 ;
bool V_507 , V_183 = false ;
struct V_167 V_512 ;
enum {
V_513 ,
V_514 ,
...
F_133 ( & V_14 -> V_40 ) ;
F_156 ( & V_9 -> V_40 ) ;
F_210 ( & V_14 -> V_165 , & V_512 ) ;
F_332 ( V_14 -> V_9 -> V_11 , & V_14 -> V_165 , & V_512 , & V_75 ,
V_14 -> V_505 ) ;
V_187:
F_154 ( V_14 ) ;
F_100 () ;
...
if ( V_516 -> V_171 > V_286 )
break;
if ( V_14 != V_516 && V_516 -> V_171 == V_286 &&
( V_516 -> V_58 & ( V_200 | V_149 |
V_236 | V_294 ) ) ==
V_200 )
return false ;
}
...
static void F_329 ( struct V_13 * V_14 , bool V_507 )
{
...
F_157 ( V_432 , V_14 ) ;
F_181 ( & V_14 -> V_9 -> V_40 ) ;
V_518 = V_14 -> V_171 == V_286 && F_333 ( V_14 ) ;
V_517 = V_518 &&
F_324 ( V_14 -> V_9 ) &&
...
static struct V_13 * F_335 ( struct V_520 * V_100 , T_10 V_521 )
{
struct V_13 * V_146 = NULL ;
struct V_522 * V_160 = V_100 -> V_523 ;
...
static struct V_13 * F_337 ( struct V_520 * V_100 ,
struct V_13 * V_146 )
{
struct V_522 * V_160 = V_100 -> V_523 ;
struct V_113 * V_113 = F_336 ( V_100 ) ;
...
static void * F_339 ( struct V_520 * V_100 , T_10 * V_521 )
__acquires( T_11 )
{
F_123 () ;
return F_335 ( V_100 , * V_521 ) ;
}
static void * F_340 ( struct V_520 * V_100 , void * V_526 , T_10 * V_521 )
{
struct V_13 * V_146 ;
V_146 = F_337 ( V_100 , V_526 ) ;
++ * V_521 ;
return V_146 ;
}
static void F_341 ( struct V_520 * V_100 , void * V_526 )
__releases( T_11 )
{
F_137 () ;
}
static int F_342 ( struct V_520 * V_100 , void * V_526 )
{
struct V_13 * V_14 = (struct V_13 * ) V_526 ;
F_343 ( V_100 , L_26 ,
& V_14 -> V_165 ,
V_14 -> V_9 -> V_11 -> V_96 ,
V_14 -> V_189 ,
...
static int F_344 ( struct V_527 * V_527 , struct V_528 * V_528 )
{
return F_345 ( V_527 , V_528 , & V_529 ,
sizeof( struct V_522 ) ) ;
}
static int T_12 F_346 ( struct V_113 * V_113 )
{
if ( ! F_347 ( L_27 , V_530 , V_113 -> V_531 , & V_532 ) )
return - V_34 ;
return 0 ;
}
static void T_13 F_348 ( struct V_113 * V_113 )
{
F_349 ( L_27 , V_113 -> V_531 ) ;
}
int T_14 F_350 ( void )
{
return F_351 ( & V_533 ) ;
...
{
unsigned long V_222 , V_534 , V_535 , V_536 ;
struct V_13 * V_14 ;
int V_20 ;
F_33 () ;
F_123 () ;
V_222 = V_17 ;
V_534 = F_355 ( V_222 + V_537 ) ;
F_14 ( & V_538 ) ;
for ( V_20 = 0 ; V_20 < V_492 ; V_20 ++ ) {
V_493:
...
if ( ( V_14 -> V_172 != V_431 ) &&
( F_143 ( V_14 -> V_78 + V_14 -> V_172 * V_3 , V_534 ) ) )
V_534 = V_14 -> V_78 + V_14 -> V_172 * V_3 ;
F_133 ( & V_14 -> V_40 ) ;
if ( V_539 ) {
F_22 ( V_14 ) ;
F_157 ( 0 , V_14 ) ;
...
if ( F_143 ( V_14 -> V_78 + V_14 -> V_173 * V_3 , V_534 ) )
V_534 = V_14 -> V_78 + V_14 -> V_173 * V_3 ;
if ( ! V_14 -> V_227 && V_209 ) {
V_14 -> V_227 ++ ;
F_22 ( V_14 ) ;
F_22 ( V_209 ) ;
...
} else if ( F_143 ( V_14 -> V_78 + V_14 -> V_173 * V_3 - V_218 * V_3 , V_534 ) )
V_534 = V_14 -> V_78 + V_14 -> V_173 * V_3 - V_218 * V_3 ;
F_133 ( & V_14 -> V_40 ) ;
} else {
if ( F_143 ( V_14 -> V_78 + V_14 -> V_173 * V_3 , V_534 ) )
V_534 = V_14 -> V_78 + V_14 -> V_173 * V_3 ;
...
V_535 = F_355 ( V_534 ) ;
V_536 = V_534 ;
if ( F_143 ( V_535 , V_534 + V_540 ) )
V_536 = V_535 ;
if ( F_143 ( V_536 , V_17 + V_541 ) )
V_536 = V_17 + V_541 ;
F_42 ( V_542 L_28 ,
V_222 , V_534 , V_535 , V_536 ) ;
F_23 ( V_19 , & V_538 , V_536 - V_222 ) ;
F_137 () ;
}
static void F_356 ( struct V_510 * V_511 )
{
F_267 () ;
F_279 () ;
F_100 () ;
...
static struct V_167 * F_357 ( struct V_120 * V_165 , struct V_120 * V_543 ,
struct V_167 * * V_421 )
{
...
V_333 = F_358 ( V_165 ) ;
if ( V_543 ) {
if ( V_333 && F_359 ( V_543 , V_333 , sizeof( * V_333 ) ) )
* V_421 = V_333 ;
V_333 = F_358 ( V_543 ) ;
}
return V_333 ;
...
struct V_113 * V_113 = F_77 ( V_95 -> V_119 ) ;
struct V_544 * V_545 ;
struct V_120 * V_121 [ V_546 + 1 ] ;
struct V_167 * V_333 , * V_421 ;
T_1 V_422 ;
int V_36 ;
V_36 = F_78 ( V_103 , sizeof( * V_545 ) , V_121 , V_546 , V_547 ) ;
if ( V_36 < 0 )
return V_36 ;
V_545 = F_66 ( V_103 ) ;
V_333 = F_357 ( V_121 [ V_548 ] , V_121 [ V_549 ] , & V_421 ) ;
if ( ! V_333 )
return - V_39 ;
V_422 = V_121 [ V_550 ] ? F_361 ( V_121 [ V_550 ] ) : V_545 -> V_422 ;
V_422 &= V_373 ;
return F_280 ( V_113 , V_545 -> V_551 , V_422 , V_333 ,
V_545 -> V_552 ) ;
}
...
F_149 ( & V_14 -> V_40 ) ;
V_553 = V_14 -> V_58 & V_373 ;
V_554 = V_14 -> V_58 & V_200 &&
! ( V_14 -> V_58 & V_201 ) ;
...
if ( ! V_146 ) {
return F_278 ( V_113 , V_545 -> V_551 , V_333 , V_421 ,
V_545 -> V_552 , V_422 ,
V_301 , V_172 ) ;
}
if ( V_103 -> V_560 & V_561 ||
! ( V_103 -> V_560 & V_562 ) )
V_36 = - V_186 ;
else
...
static void F_364 ( struct V_102 * V_103 , T_5 V_563 , T_1 V_58 ,
T_5 V_171 , int V_96 )
{
struct V_544 * V_545 ;
V_545 = F_66 ( V_103 ) ;
...
unsigned long V_78 , T_1 V_565 , T_1 V_380 )
{
struct V_556 V_557 ;
V_557 . V_1 = F_1 ( V_1 ) ;
V_557 . V_78 = F_1 ( V_78 ) ;
V_557 . V_559 = V_565 ;
V_557 . V_558 = V_380 ;
return F_366 ( V_95 , V_555 , sizeof( V_557 ) , & V_557 ) ;
}
...
{
return F_61 ( sizeof( struct V_544 ) )
+ F_62 ( 16 )
+ F_62 ( 16 )
+ F_62 ( sizeof( struct V_556 ) )
+ F_62 ( 4 ) ;
}
...
struct V_102 * V_103 ;
T_1 V_565 , V_380 ;
V_103 = F_65 ( V_95 , V_99 , V_100 , V_101 , sizeof( struct V_544 ) , V_58 ) ;
if ( ! V_103 )
return - V_105 ;
...
V_380 = V_146 -> V_172 ;
if ( V_565 != V_431 ) {
long V_569 = ( V_17 - V_146 -> V_78 ) / V_3 ;
if ( V_565 > V_569 )
V_565 -= V_569 ;
else
V_565 = 0 ;
...
if ( F_370 ( V_95 , V_549 , & V_146 -> V_165 ) < 0 ||
F_370 ( V_95 , V_548 , & V_146 -> V_169 ) < 0 )
goto error;
} else
if ( F_370 ( V_95 , V_548 , & V_146 -> V_165 ) < 0 )
goto error;
if ( F_365 ( V_95 , V_146 -> V_1 , V_146 -> V_78 , V_565 , V_380 ) < 0 )
goto error;
if ( F_371 ( V_95 , V_550 , V_146 -> V_58 ) < 0 )
goto error;
F_68 ( V_95 , V_103 ) ;
return 0 ;
error:
...
static int F_372 ( struct V_94 * V_95 , struct V_570 * V_571 ,
T_1 V_99 , T_1 V_100 , int V_101 , T_15 V_58 )
{
struct V_102 * V_103 ;
T_5 V_171 = V_568 ;
int V_96 = V_571 -> V_9 -> V_11 -> V_96 ;
if ( F_166 ( & V_571 -> V_572 ) & V_566 )
V_171 = V_567 ;
V_103 = F_65 ( V_95 , V_99 , V_100 , V_101 , sizeof( struct V_544 ) , V_58 ) ;
if ( ! V_103 )
return - V_105 ;
F_364 ( V_103 , 128 , V_200 , V_171 , V_96 ) ;
if ( F_370 ( V_95 , V_573 , & V_571 -> V_572 ) < 0 ||
F_365 ( V_95 , V_571 -> V_574 , V_571 -> V_575 ,
V_431 , V_431 ) < 0 ) {
F_69 ( V_95 , V_103 ) ;
return - V_105 ;
}
...
static int F_373 ( struct V_94 * V_95 , struct V_576 * V_577 ,
T_1 V_99 , T_1 V_100 , int V_101 , unsigned int V_58 )
{
struct V_102 * V_103 ;
T_5 V_171 = V_568 ;
int V_96 = V_577 -> V_578 -> V_11 -> V_96 ;
if ( F_166 ( & V_577 -> V_579 ) & V_566 )
V_171 = V_567 ;
V_103 = F_65 ( V_95 , V_99 , V_100 , V_101 , sizeof( struct V_544 ) , V_58 ) ;
if ( ! V_103 )
return - V_105 ;
F_364 ( V_103 , 128 , V_200 , V_171 , V_96 ) ;
if ( F_370 ( V_95 , V_580 , & V_577 -> V_579 ) < 0 ||
F_365 ( V_95 , V_577 -> V_581 , V_577 -> V_582 ,
V_431 , V_431 ) < 0 ) {
F_69 ( V_95 , V_103 ) ;
return - V_105 ;
}
...
struct V_130 * V_131 , enum V_583 type ,
int V_584 , int * V_585 )
{
struct V_570 * V_571 ;
struct V_576 * V_577 ;
...
case V_588 :
for ( V_571 = V_9 -> V_589 ; V_571 ;
V_571 = V_571 -> V_534 , V_586 ++ ) {
if ( V_586 < V_584 )
continue;
V_36 = F_372 ( V_95 , V_571 ,
F_81 ( V_131 -> V_95 ) . V_99 ,
V_131 -> V_103 -> V_129 ,
V_590 ,
V_143 ) ;
...
break;
case V_591 :
for ( V_577 = V_9 -> V_592 ; V_577 ;
V_577 = V_577 -> V_593 , V_586 ++ ) {
if ( V_586 < V_584 )
continue;
V_36 = F_373 ( V_95 , V_577 ,
F_81 ( V_131 -> V_95 ) . V_99 ,
V_131 -> V_103 -> V_129 ,
V_594 ,
V_143 ) ;
...
if ( V_36 < 0 )
goto V_115;
V_165 = F_357 ( V_121 [ V_548 ] , V_121 [ V_549 ] , & V_595 ) ;
if ( ! V_165 ) {
V_36 = - V_39 ;
goto V_115;
}
...
F_74 ( V_95 , V_113 , 0 , V_597 , NULL , V_128 ) ;
return;
V_115:
if ( V_36 < 0 )
F_75 ( V_113 , V_597 , V_36 ) ;
}
static inline void F_381 ( struct V_97 * V_43 ,
T_4 * V_598 , int V_599 )
{
F_382 ( V_599 < ( V_600 * 4 ) ) ;
memset ( V_598 , 0 , V_599 ) ;
V_598 [ V_601 ] = V_43 -> V_53 ;
V_598 [ V_602 ] = V_43 -> V_603 ;
V_598 [ V_604 ] = V_43 -> V_50 ;
V_598 [ V_605 ] = V_43 -> V_606 ;
V_598 [ V_607 ] = V_43 -> V_608 ;
V_598 [ V_609 ] = V_43 -> V_386 ;
V_598 [ V_610 ] = V_43 -> V_230 ;
V_598 [ V_611 ] = V_43 -> V_66 ;
V_598 [ V_612 ] =
F_383 ( V_43 -> V_519 ) ;
V_598 [ V_613 ] =
F_383 ( V_43 -> V_500 ) ;
V_598 [ V_614 ] =
F_383 ( V_43 -> V_501 ) ;
V_598 [ V_615 ] = V_43 -> V_616 ;
V_598 [ V_617 ] =
F_383 ( V_43 -> V_618 ) ;
V_598 [ V_619 ] =
F_383 ( V_43 -> V_620 ) ;
V_598 [ V_621 ] = V_43 -> V_73 ;
V_598 [ V_622 ] = V_43 -> V_234 ;
V_598 [ V_623 ] = V_43 -> V_232 ;
V_598 [ V_624 ] = V_43 -> V_228 ;
V_598 [ V_625 ] = V_43 -> V_223 ;
V_598 [ V_626 ] = V_43 -> V_307 ;
V_598 [ V_627 ] = V_43 -> V_628 ;
V_598 [ V_629 ] = V_43 -> V_630 ;
V_598 [ V_631 ] = V_43 -> V_632 ;
#ifdef F_384
V_598 [ V_633 ] = V_43 -> V_634 ;
V_598 [ V_635 ] =
F_383 ( V_43 -> V_636 ) ;
#ifdef F_385
V_598 [ V_637 ] = V_43 -> V_638 ;
#endif
#endif
V_598 [ V_639 ] = V_43 -> V_111 ;
V_598 [ V_640 ] = V_43 -> V_641 ;
#ifdef F_170
V_598 [ V_642 ] = V_43 -> V_239 ;
V_598 [ V_643 ] = V_43 -> V_240 ;
#endif
#ifdef F_63
V_598 [ V_644 ] = V_43 -> V_110 ;
#endif
V_598 [ V_645 ] = V_43 -> V_183 ;
V_598 [ V_646 ] = V_43 -> V_61 ;
V_598 [ V_647 ] = V_43 -> V_648 ;
V_598 [ V_649 ] = V_43 -> V_650 ;
V_598 [ V_651 ] = V_43 -> V_652 ;
V_598 [ V_653 ] = V_43 -> V_654 ;
V_598 [ V_655 ] = V_43 -> V_656 ;
V_598 [ V_657 ] = V_43 -> V_112 ;
V_598 [ V_658 ] = V_43 -> V_283 ;
V_598 [ V_659 ] = V_43 -> V_660 ;
V_598 [ V_661 ] = V_43 -> V_662 ;
V_598 [ V_663 ] = V_43 -> V_491 ;
V_598 [ V_664 ] = V_43 -> V_665 ;
#ifdef F_386
V_598 [ V_666 ] = V_43 -> V_667 ;
#endif
V_598 [ V_668 ] = V_43 -> V_504 ;
}
static inline T_16 F_387 ( void )
{
return F_62 ( 4 )
+ F_62 ( sizeof( struct V_669 ) )
+ F_62 ( V_600 * 4 )
+ F_62 ( V_670 * 8 )
+ F_62 ( V_671 * 8 )
...
{
return F_61 ( sizeof( struct V_672 ) )
+ F_62 ( V_673 )
+ F_62 ( V_459 )
+ F_62 ( 4 )
+ F_62 ( 4 )
...
static inline void F_389 ( T_3 * V_21 , T_17 * V_674 ,
int V_599 )
{
int V_20 ;
int V_675 = V_599 - sizeof( T_3 ) * V_671 ;
F_382 ( V_675 < 0 ) ;
F_390 ( V_671 , & V_21 [ 0 ] ) ;
for ( V_20 = 1 ; V_20 < V_671 ; V_20 ++ )
F_390 ( F_391 ( & V_674 [ V_20 ] ) , & V_21 [ V_20 ] ) ;
memset ( & V_21 [ V_671 ] , 0 , V_675 ) ;
}
static inline void F_392 ( T_3 * V_21 , void T_18 * V_674 ,
int V_599 , T_16 V_676 )
{
int V_20 , V_677 ;
T_3 V_678 [ V_670 ] ;
int V_675 = V_599 - sizeof( T_3 ) * V_670 ;
F_382 ( V_675 < 0 ) ;
memset ( V_678 , 0 , sizeof( V_678 ) ) ;
V_678 [ 0 ] = V_670 ;
F_26 (c) {
for ( V_20 = 1 ; V_20 < V_670 ; V_20 ++ )
V_678 [ V_20 ] += F_393 ( V_674 , V_677 , V_20 , V_676 ) ;
}
memcpy ( V_21 , V_678 , V_670 * sizeof( T_3 ) ) ;
memset ( & V_21 [ V_670 ] , 0 , V_675 ) ;
}
static void F_394 ( T_3 * V_21 , struct V_8 * V_9 , int V_679 ,
int V_599 )
{
switch ( V_679 ) {
case V_680 :
F_392 ( V_21 , V_9 -> V_21 . V_22 , V_599 ,
F_395 ( struct V_23 , V_26 ) ) ;
break;
case V_681 :
F_389 ( V_21 , V_9 -> V_21 . V_27 -> V_682 , V_599 ) ;
break;
}
}
...
struct V_120 * V_684 ;
struct V_669 V_557 ;
if ( F_371 ( V_95 , V_685 , V_9 -> V_76 ) )
goto V_109;
V_557 . V_686 = V_687 ;
V_557 . V_78 = F_1 ( V_9 -> V_78 ) ;
V_557 . V_688 = F_383 ( V_9 -> V_51 -> V_688 ) ;
V_557 . V_689 = F_383 ( F_161 ( V_9 -> V_51 , V_231 ) ) ;
if ( F_366 ( V_95 , V_690 , sizeof( V_557 ) , & V_557 ) )
goto V_109;
V_684 = F_397 ( V_95 , V_691 , V_600 * sizeof( T_2 ) ) ;
if ( ! V_684 )
goto V_109;
F_381 ( & V_9 -> V_43 , F_358 ( V_684 ) , F_398 ( V_684 ) ) ;
if ( V_683 & V_692 )
return 0 ;
V_684 = F_397 ( V_95 , V_680 , V_670 * sizeof( T_3 ) ) ;
if ( ! V_684 )
goto V_109;
F_394 ( F_358 ( V_684 ) , V_9 , V_680 , F_398 ( V_684 ) ) ;
V_684 = F_397 ( V_95 , V_681 , V_671 * sizeof( T_3 ) ) ;
if ( ! V_684 )
goto V_109;
F_394 ( F_358 ( V_684 ) , V_9 , V_681 , F_398 ( V_684 ) ) ;
V_684 = F_397 ( V_95 , V_693 , sizeof( struct V_167 ) ) ;
if ( ! V_684 )
goto V_109;
if ( F_399 ( V_95 , V_694 , V_9 -> V_47 ) )
goto V_109;
F_181 ( & V_9 -> V_40 ) ;
memcpy ( F_358 ( V_684 ) , V_9 -> V_74 . V_225 , F_398 ( V_684 ) ) ;
F_186 ( & V_9 -> V_40 ) ;
return 0 ;
V_109:
return - V_105 ;
...
goto V_371;
if ( ! V_9 -> V_84 && ( V_9 -> V_76 & V_77 ) &&
! F_194 ( V_11 , & V_698 , V_149 |
V_236 ) ) {
F_325 ( V_11 , & V_698 , & V_83 ) ;
V_697 = true ;
}
V_371:
F_152 ( & V_9 -> V_40 ) ;
...
const struct V_120 * V_684 )
{
struct V_120 * V_121 [ V_699 + 1 ] ;
if ( V_11 && ! F_57 ( V_11 ) )
return - V_700 ;
return F_404 ( V_121 , V_699 , V_684 , V_701 ) ;
}
static int F_405 ( struct V_10 * V_11 , const struct V_120 * V_684 )
{
int V_36 = - V_39 ;
struct V_8 * V_9 = F_57 ( V_11 ) ;
struct V_120 * V_121 [ V_699 + 1 ] ;
if ( ! V_9 )
return - V_700 ;
if ( F_404 ( V_121 , V_699 , V_684 , NULL ) < 0 )
F_406 () ;
if ( V_121 [ V_693 ] ) {
V_36 = F_402 ( V_9 , F_358 ( V_121 [ V_693 ] ) ) ;
if ( V_36 )
return V_36 ;
}
if ( V_121 [ V_694 ] ) {
T_5 V_702 = F_407 ( V_121 [ V_694 ] ) ;
if ( V_702 != V_49 &&
V_702 != V_466 &&
V_702 != V_48 &&
V_702 != V_367 )
...
static int F_408 ( struct V_94 * V_95 , struct V_8 * V_9 ,
T_1 V_99 , T_1 V_100 , int V_101 , unsigned int V_58 )
{
struct V_10 * V_11 = V_9 -> V_11 ;
struct V_672 * V_703 ;
struct V_102 * V_103 ;
void * V_704 ;
V_103 = F_65 ( V_95 , V_99 , V_100 , V_101 , sizeof( * V_703 ) , V_58 ) ;
if ( ! V_103 )
return - V_105 ;
V_703 = F_66 ( V_103 ) ;
V_703 -> V_705 = V_107 ;
V_703 -> V_706 = 0 ;
V_703 -> V_707 = V_11 -> type ;
V_703 -> V_708 = V_11 -> V_96 ;
V_703 -> V_709 = F_409 ( V_11 ) ;
V_703 -> V_710 = 0 ;
if ( F_410 ( V_95 , V_711 , V_11 -> V_56 ) ||
( V_11 -> V_314 &&
F_366 ( V_95 , V_712 , V_11 -> V_314 , V_11 -> V_316 ) ) ||
F_371 ( V_95 , V_713 , V_11 -> V_37 ) ||
( V_11 -> V_96 != F_411 ( V_11 ) &&
F_371 ( V_95 , V_714 , F_411 ( V_11 ) ) ) ||
F_399 ( V_95 , V_715 ,
F_49 ( V_11 ) ? V_11 -> V_716 : V_717 ) )
goto V_109;
V_704 = F_412 ( V_95 , V_718 ) ;
if ( ! V_704 )
goto V_109;
...
static int F_414 ( struct V_94 * V_95 , struct V_130 * V_131 )
{
struct V_113 * V_113 = F_77 ( V_95 -> V_119 ) ;
int V_132 , V_133 ;
int V_134 = 0 , V_135 ;
...
if ( ! V_95 )
goto V_115;
V_36 = F_408 ( V_95 , V_9 , 0 , 0 , V_101 , 0 ) ;
if ( V_36 < 0 ) {
F_72 ( V_36 == - V_105 ) ;
F_73 ( V_95 ) ;
goto V_115;
}
F_74 ( V_95 , V_113 , 0 , V_719 , NULL , V_128 ) ;
return;
V_115:
if ( V_36 < 0 )
F_75 ( V_113 , V_719 , V_36 ) ;
}
static inline T_16 F_415 ( void )
{
return F_61 ( sizeof( struct V_720 ) )
+ F_62 ( sizeof( struct V_167 ) )
+ F_62 ( sizeof( struct V_721 ) ) ;
}
static int F_416 ( struct V_94 * V_95 , struct V_8 * V_9 ,
...
struct V_102 * V_103 ;
struct V_721 V_557 ;
V_103 = F_65 ( V_95 , V_99 , V_100 , V_101 , sizeof( * V_722 ) , V_58 ) ;
if ( ! V_103 )
return - V_105 ;
V_722 = F_66 ( V_103 ) ;
V_722 -> V_723 = V_107 ;
V_722 -> V_724 = 0 ;
V_722 -> V_725 = 0 ;
V_722 -> V_726 = V_9 -> V_11 -> V_96 ;
V_722 -> V_189 = V_369 -> V_189 ;
V_722 -> V_727 = V_369 -> type ;
V_722 -> V_728 = 0 ;
V_722 -> V_729 = 0 ;
if ( V_369 -> V_291 )
V_722 -> V_729 |= V_730 ;
if ( V_369 -> V_386 )
V_722 -> V_729 |= V_731 ;
if ( F_366 ( V_95 , V_732 , sizeof( V_369 -> V_378 ) , & V_369 -> V_378 ) )
goto V_109;
V_557 . V_733 = F_258 ( V_369 -> V_381 ) ;
V_557 . V_734 = F_258 ( V_369 -> V_380 ) ;
if ( F_366 ( V_95 , V_735 , sizeof( V_557 ) , & V_557 ) )
goto V_109;
F_68 ( V_95 , V_103 ) ;
return 0 ;
V_109:
...
struct V_113 * V_113 = F_38 ( V_9 -> V_11 ) ;
int V_36 = - V_114 ;
V_95 = F_71 ( F_415 () , V_128 ) ;
if ( ! V_95 )
goto V_115;
V_36 = F_416 ( V_95 , V_9 , V_369 , 0 , 0 , V_101 , 0 ) ;
if ( V_36 < 0 ) {
F_72 ( V_36 == - V_105 ) ;
F_73 ( V_95 ) ;
goto V_115;
}
F_74 ( V_95 , V_113 , 0 , V_736 , NULL , V_128 ) ;
return;
V_115:
if ( V_36 < 0 )
F_75 ( V_113 , V_736 , V_36 ) ;
}
...
static
int F_418 ( struct V_152 * V_738 , int V_739 ,
void T_8 * V_740 , T_16 * V_741 , T_10 * V_742 )
{
int * V_743 = V_738 -> V_461 ;
int V_744 = * V_743 ;
T_10 V_521 = * V_742 ;
struct V_152 V_745 ;
int V_220 ;
V_745 = * V_738 ;
V_745 . V_461 = & V_744 ;
V_220 = F_419 ( & V_745 , V_739 , V_740 , V_741 , V_742 ) ;
if ( V_739 )
V_220 = F_97 ( V_738 , V_743 , V_744 ) ;
if ( V_220 )
* V_742 = V_521 ;
return V_220 ;
}
static
int F_420 ( struct V_152 * V_738 , int V_739 ,
void T_8 * V_740 , T_16 * V_741 , T_10 * V_742 )
{
struct V_8 * V_9 = V_738 -> V_158 ;
int V_746 = V_38 ;
struct V_152 V_745 ;
V_745 = * V_738 ;
V_745 . V_158 = & V_746 ;
V_745 . V_156 = V_9 ? & V_9 -> V_11 -> V_37 : NULL ;
return F_421 ( & V_745 , V_739 , V_740 , V_741 , V_742 ) ;
}
...
if ( ! V_9 || ! V_9 -> V_11 )
return;
F_423 ( & V_471 , V_9 -> V_11 ) ;
if ( V_9 -> V_43 . V_183 )
F_305 ( NULL , V_211 , & V_471 ) ;
else
F_305 ( NULL , V_194 , & V_471 ) ;
}
static void F_424 ( struct V_113 * V_113 , T_4 V_150 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
F_96 (net, dev) {
...
static int F_425 ( struct V_152 * V_153 , int * V_154 , int V_150 )
{
struct V_113 * V_113 ;
int V_155 ;
if ( ! F_98 () )
...
F_422 ( (struct V_8 * ) V_153 -> V_158 ) ;
F_100 () ;
return 0 ;
}
static
int F_426 ( struct V_152 * V_738 , int V_739 ,
void T_8 * V_740 , T_16 * V_741 , T_10 * V_742 )
{
int * V_743 = V_738 -> V_461 ;
int V_744 = * V_743 ;
...
V_220 = F_419 ( & V_745 , V_739 , V_740 , V_741 , V_742 ) ;
if ( V_739 )
V_220 = F_425 ( V_738 , V_743 , V_744 ) ;
if ( V_220 )
* V_742 = V_521 ;
return V_220 ;
}
static
int F_427 ( struct V_152 * V_738 , int V_739 ,
void T_8 * V_740 , T_16 * V_741 , T_10 * V_742 )
{
int * V_743 = V_738 -> V_461 ;
int V_220 ;
int V_155 , V_748 ;
V_155 = * V_743 ;
V_220 = F_419 ( V_738 , V_739 , V_740 , V_741 , V_742 ) ;
V_748 = * V_743 ;
if ( V_739 && V_155 != V_748 ) {
struct V_113 * V_113 = V_738 -> V_156 ;
if ( ! F_98 () )
return F_99 () ;
if ( V_743 == & V_113 -> V_22 . V_44 -> V_111 )
F_70 ( V_113 , V_92 ,
V_127 ,
V_113 -> V_22 . V_44 ) ;
else if ( V_743 == & V_113 -> V_22 . V_126 -> V_111 )
F_70 ( V_113 , V_92 ,
V_125 ,
V_113 -> V_22 . V_126 ) ;
else {
...
static int F_428 ( struct V_152 * V_738 , int V_739 ,
void T_8 * V_740 , T_16 * V_741 ,
T_10 * V_742 )
{
int V_36 ;
struct V_167 V_165 ;
char V_749 [ V_750 ] ;
struct V_152 V_745 = * V_738 ;
struct V_113 * V_113 = V_738 -> V_156 ;
struct V_463 * V_457 = V_738 -> V_461 ;
if ( & V_113 -> V_22 . V_126 -> V_45 == V_738 -> V_461 )
return - V_751 ;
V_745 . V_752 = V_750 ;
V_745 . V_461 = V_749 ;
if ( ! F_98 () )
...
V_36 = snprintf ( V_749 , sizeof( V_749 ) , L_29 , & V_457 -> V_457 ) ;
if ( V_36 >= sizeof( V_749 ) ) {
V_36 = - V_751 ;
goto V_187;
}
V_36 = F_429 ( & V_745 , V_739 , V_740 , V_741 , V_742 ) ;
if ( V_36 || ! V_739 )
goto V_187;
if ( F_430 ( V_749 , - 1 , V_165 . V_753 . V_754 , - 1 , NULL ) != 1 ) {
V_36 = - V_751 ;
goto V_187;
}
V_457 -> V_46 = true ;
V_457 -> V_457 = V_165 ;
if ( & V_113 -> V_22 . V_44 -> V_45 == V_738 -> V_461 ) {
struct V_10 * V_11 ;
F_96 (net, dev) {
struct V_8 * V_9 = F_57 ( V_11 ) ;
if ( V_9 ) {
...
V_220 = F_419 ( & V_745 , V_739 , V_740 , V_741 , V_742 ) ;
if ( V_739 )
V_220 = F_103 ( V_738 , V_743 , V_744 ) ;
if ( V_220 )
* V_742 = V_521 ;
return V_220 ;
}
static int F_432 ( struct V_113 * V_113 , char * V_755 ,
struct V_8 * V_9 , struct V_97 * V_154 )
{
int V_20 , V_96 ;
struct V_152 * V_153 ;
char V_756 [ sizeof( L_30 ) + V_673 ] ;
V_153 = F_433 ( V_757 , sizeof( V_757 ) , V_29 ) ;
if ( ! V_153 )
goto V_187;
...
snprintf ( V_756 , sizeof( V_756 ) , L_31 , V_755 ) ;
V_154 -> V_758 = F_434 ( V_113 , V_756 , V_153 ) ;
if ( ! V_154 -> V_758 )
goto free;
if ( ! strcmp ( V_755 , L_32 ) )
V_96 = V_125 ;
else if ( ! strcmp ( V_755 , L_33 ) )
V_96 = V_127 ;
else
V_96 = V_9 -> V_11 -> V_96 ;
...
static void F_435 ( struct V_97 * V_154 )
{
struct V_152 * V_153 ;
if ( ! V_154 -> V_758 )
return;
V_153 = V_154 -> V_758 -> V_759 ;
F_436 ( V_154 -> V_758 ) ;
V_154 -> V_758 = NULL ;
F_30 ( V_153 ) ;
}
...
{
int V_36 ;
if ( ! F_437 ( V_9 -> V_11 -> V_56 ) )
return - V_39 ;
V_36 = F_438 ( V_9 -> V_11 , V_9 -> V_51 ,
& V_760 ) ;
if ( V_36 )
return V_36 ;
V_36 = F_432 ( F_38 ( V_9 -> V_11 ) , V_9 -> V_11 -> V_56 ,
V_9 , & V_9 -> V_43 ) ;
if ( V_36 )
F_439 ( V_9 -> V_51 ) ;
return V_36 ;
...
static int T_12 F_440 ( struct V_113 * V_113 )
{
int V_36 = - V_34 ;
struct V_97 * V_88 , * V_761 ;
V_88 = F_433 ( & V_97 , sizeof( V_97 ) , V_29 ) ;
if ( ! V_88 )
goto V_762;
V_761 = F_433 ( & V_763 , sizeof( V_763 ) , V_29 ) ;
if ( ! V_761 )
goto V_764;
V_761 -> V_386 = V_765 . V_386 ;
V_761 -> V_183 = V_765 . V_183 ;
V_761 -> V_45 . V_46 = false ;
V_88 -> V_45 . V_46 = false ;
V_113 -> V_22 . V_126 = V_88 ;
V_113 -> V_22 . V_44 = V_761 ;
#ifdef F_441
V_36 = F_432 ( V_113 , L_32 , NULL , V_88 ) ;
if ( V_36 < 0 )
goto V_766;
V_36 = F_432 ( V_113 , L_33 , NULL , V_761 ) ;
if ( V_36 < 0 )
goto V_767;
#endif
return 0 ;
...
static void T_13 F_442 ( struct V_113 * V_113 )
{
#ifdef F_441
F_435 ( V_113 -> V_22 . V_44 ) ;
F_435 ( V_113 -> V_22 . V_126 ) ;
#endif
...
F_256 () ;
F_449 ( & V_775 ) ;
V_36 = F_450 ( V_776 , V_777 , NULL , F_414 ,
NULL ) ;
if ( V_36 < 0 )
goto V_115;
F_450 ( V_776 , V_432 , F_363 , NULL , NULL ) ;
F_450 ( V_776 , V_210 , F_360 , NULL , NULL ) ;
F_450 ( V_776 , V_778 , F_379 ,
F_376 , NULL ) ;
F_450 ( V_776 , V_590 , NULL ,
F_377 , NULL ) ;
F_450 ( V_776 , V_594 , NULL ,
F_378 , NULL ) ;
F_450 ( V_776 , V_779 , F_76 ,
F_83 , NULL ) ;
F_451 () ;
return 0 ;
V_115:
