...
{
F_8 (attrib != NULL, return;) ;
F_8 (attrib->magic == IAS_ATTRIB_MAGIC, return;) ;
F_5 ( V_13 -> V_2 ) ;
F_9 ( V_13 -> V_14 ) ;
V_13 -> V_7 = ~ V_15 ;
F_5 ( V_13 ) ;
...
{
F_8 (obj != NULL, return;) ;
F_8 (obj->magic == IAS_OBJECT_MAGIC, return;) ;
F_5 ( V_4 -> V_2 ) ;
F_11 ( V_4 -> V_10 , ( V_16 ) F_7 ) ;
V_4 -> V_7 = ~ V_8 ;
F_5 ( V_4 ) ;
}
...
{
struct V_1 * V_17 ;
F_8 (obj != NULL, return -1;) ;
F_8 (obj->magic == IAS_OBJECT_MAGIC, return -1;) ;
V_17 = F_13 ( V_18 , ( V_19 * ) V_4 ) ;
if ( ! V_17 )
F_14 ( L_4 ,
V_6 ) ;
F_10 ( V_4 ) ;
...
F_8 (obj != NULL, return -1;) ;
F_8 (obj->magic == IAS_OBJECT_MAGIC, return -1;) ;
F_8 (attrib != NULL, return -1;) ;
V_17 = F_13 ( V_4 -> V_10 , ( V_19 * ) V_13 ) ;
if ( ! V_17 )
return 0 ;
F_7 ( V_17 ) ;
...
{
F_8 (name != NULL, return NULL;) ;
return F_20 ( V_18 , 0 , V_2 ) ;
}
struct V_12 * F_21 ( struct V_1 * V_4 , char * V_2 )
{
struct V_12 * V_13 ;
F_8 (obj != NULL, return NULL;) ;
F_8 (obj->magic == IAS_OBJECT_MAGIC, return NULL;) ;
F_8 (name != NULL, return NULL;) ;
...
F_8 (obj != NULL, return;) ;
F_8 (obj->magic == IAS_OBJECT_MAGIC, return;) ;
F_8 (name != NULL, return;) ;
V_13 = F_2 ( sizeof( struct V_12 ) , V_5 ) ;
if ( V_13 == NULL ) {
F_3 ( L_8 ,
V_6 ) ;
return;
...
{
struct V_24 * V_14 ;
V_14 = F_2 ( sizeof( struct V_24 ) , V_5 ) ;
if ( V_14 == NULL )
return NULL ;
V_14 -> type = V_31 ;
V_14 -> V_30 = 4 ;
...
V_14 -> type = V_33 ;
V_14 -> V_34 = V_35 ;
V_14 -> V_32 . string = F_4 ( string , V_36 , V_5 ) ;
if ( ! V_14 -> V_32 . string ) {
F_3 ( L_9 , V_6 ) ;
F_5 ( V_14 ) ;
return NULL ;
...
V_30 = V_39 ;
V_14 -> V_30 = V_30 ;
V_14 -> V_32 . V_40 = F_33 ( V_37 , V_30 , V_5 ) ;
