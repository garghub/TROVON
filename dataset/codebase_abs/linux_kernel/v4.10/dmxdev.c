...
V_119 = V_91 -> V_102 ;
V_119 -> V_29 = V_86 ;
V_12 = V_119 -> V_128 ( V_119 , V_91 -> V_105 , V_116 , V_118 , V_76 ) ;
if ( V_12 < 0 ) {
...
V_12 = ( * V_131 ) -> V_128 ( * V_131 , V_72 -> V_105 ,
( V_72 -> V_87 & V_133 ) ? 1 : 0 ) ;
if ( V_12 < 0 ) {
F_54 ( L_5 ,
V_31 ) ;
...
static inline void F_59 ( T_9 * V_86 )
{
int V_104 ;
...
return - V_53 ;
V_91 = F_61 ( sizeof( struct V_97 ) , V_143 ) ;
if ( V_91 == NULL )
return - V_46 ;
V_91 -> V_105 = V_105 ;
...
static T_3 F_67 ( struct V_63 * V_145 ,
...
if ( F_68 ( V_145 -> V_149 - V_145 -> V_10 , V_2 , V_146 ) )
return - V_150 ;
V_2 += V_146 ;
V_148 = V_146 ;
V_8 -= V_146 ;
...
static long F_71 ( struct V_24 * V_24 , unsigned int V_151 ,
unsigned long V_153 )
{
return F_72 ( V_24 , V_151 , V_153 , F_70 ) ;
}
static unsigned int F_73 ( struct V_24 * V_24 , T_10 * V_169 )
{
struct V_63 * V_64 = V_24 -> V_27 ;
unsigned int V_138 = 0 ;
if ( ( ! V_64 ) || V_64 -> V_66 -> exit )
return V_170 ;
F_74 ( V_24 , & V_64 -> V_67 . V_14 , V_169 ) ;
if ( V_64 -> V_65 != V_68 &&
V_64 -> V_65 != V_89 &&
V_64 -> V_65 != V_70 )
return 0 ;
...
{
return F_72 ( V_24 , V_151 , V_153 , F_76 ) ;
}
static unsigned int F_78 ( struct V_24 * V_24 , T_10 * V_169 )
{
struct V_25 * V_26 = V_24 -> V_27 ;
struct V_28 * V_28 = V_26 -> V_29 ;
unsigned int V_138 = 0 ;
...
if ( V_28 -> exit )
return V_170 ;
F_74 ( V_24 , & V_28 -> V_47 . V_14 , V_169 ) ;
if ( ( V_24 -> V_35 & V_36 ) == V_41 ) {
if ( V_28 -> V_47 . error )
V_138 |= ( V_171 | V_172 | V_173 | V_170 ) ;
if ( ! F_7 ( & V_28 -> V_47 ) )
...
int F_79 ( struct V_28 * V_28 , struct V_176 * V_176 )
{
int V_104 ;
...
F_81 ( V_176 , & V_28 -> V_26 , & V_179 , V_28 ,
V_180 , V_28 -> V_106 ) ;
F_81 ( V_176 , & V_28 -> V_181 , & V_182 ,
