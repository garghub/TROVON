...
{
struct V_8 * V_9 = F_60 ( V_101 , struct V_8 ,
V_102 ) ;
...
static void F_81 ( struct V_110 * V_99 )
{
struct V_8 * V_9 = F_60 ( V_99 , struct V_8 ,
V_99 ) ;
F_82 ( & V_9 -> V_102 ) ;
}
...
{
F_84 ( & V_94 ) ;
F_56 ( ! F_85 ( & V_9 -> V_6 -> V_111 , V_9 -> V_104 -> V_112 ) ) ;
F_86 ( & V_9 -> V_113 ) ;
F_86 ( & V_9 -> V_114 ) ;
F_87 ( & V_9 -> V_99 ) ;
}
...
int V_41 = 0 ;
V_117 = F_89 ( V_104 ) ;
V_105 = F_90 ( V_104 -> V_122 , & V_123 ) ;
V_118 = F_91 ( V_105 ) ;
V_120 = F_92 ( V_117 ) ;
V_121 = & V_118 -> V_124 ;
F_59 ( & V_94 , V_92 ) ;
V_9 = F_93 ( & V_6 -> V_111 , V_104 -> V_112 ) ;
...
if ( V_41 )
goto V_126;
V_41 = F_95 ( & V_9 -> V_99 , F_81 , 0 , V_65 ) ;
if ( V_41 )
goto V_127;
...
V_41 = F_98 ( & V_6 -> V_111 , V_104 -> V_112 , V_9 ) ;
if ( ! V_41 ) {
F_66 ( & V_6 -> V_108 ) ;
F_99 ( & V_9 -> V_103 , & V_6 -> V_131 ) ;
F_100 ( & V_9 -> V_113 , V_120 ) ;
F_100 ( & V_9 -> V_114 , V_121 ) ;
F_101 ( V_104 ) ;
F_101 ( V_105 ) ;
}
}
...
if ( V_9 ) {
struct V_115 * V_105 ;
V_105 = F_90 ( V_104 -> V_122 ,
& V_123 ) ;
if ( F_106 ( V_9 -> V_105 != V_105 ||
! F_107 ( V_9 ) ) )
V_9 = NULL ;
F_76 ( V_105 ) ;
}
F_108 () ;
} while ( ! V_9 && ! F_88 ( V_6 , V_104 , V_65 ) );
return V_9 ;
}
static int F_109 ( struct V_5 * V_6 )
{
int V_41 ;
F_110 ( & V_6 -> V_111 , V_134 ) ;
V_6 -> V_95 = V_135 ;
F_65 ( & V_6 -> V_108 , 1 ) ;
...
F_83 ( * V_143 ) ;
while ( ( V_142 = F_113 ( & V_6 -> V_95 ) ) ) {
struct V_87 * V_81 =
F_114 ( V_142 , struct V_87 , V_89 ) ;
F_71 ( V_142 , & V_6 -> V_95 ) ;
V_81 -> V_6 = NULL ;
}
F_75 ( & V_94 ) ;
F_115 ( & V_6 -> V_108 ) ;
F_116 ( V_109 , ! F_117 ( & V_6 -> V_108 ) ) ;
}
void F_118 ( struct V_116 * V_117 )
{
F_119 ( V_144 ) ;
struct V_119 * V_120 = F_92 ( V_117 ) ;
...
F_122 ( & V_6 -> V_150 ) ;
V_41 = F_109 ( V_6 ) ;
F_99 ( & V_6 -> V_9 . V_103 , & V_6 -> V_131 ) ;
return V_41 ;
}
int F_123 ( struct V_5 * V_6 , struct V_34 * V_91 ,
const char * V_151 , ... )
{
T_6 args ;
struct V_34 * V_35 ;
...
return 0 ;
va_start ( args , V_151 ) ;
V_35 = F_124 ( V_47 , V_91 , F_125 ( 0 , 0 ) , V_6 , V_151 , args ) ;
va_end ( args ) ;
if ( F_31 ( V_35 ) )
return F_32 ( V_35 ) ;
V_6 -> V_35 = V_35 ;
...
int F_131 ( struct V_5 * V_6 , struct V_34 * V_153 )
{
int V_154 ;
V_154 = F_123 ( V_6 , NULL , L_19 , F_129 ( V_153 -> V_155 ) ,
F_130 ( V_153 -> V_155 ) ) ;
if ( V_154 )
return V_154 ;
V_6 -> V_153 = V_153 ;
...
int F_141 ( struct V_5 * V_6 , char * V_30 )
{
int V_51 ;
V_6 -> V_30 = V_30 ;
V_6 -> V_156 = 0 ;
...
void F_143 ( struct V_87 * V_81 , int V_158 )
{
T_8 * V_159 = & V_160 [ V_158 ] ;
enum V_161 V_162 ;
V_162 = V_158 ? V_163 : V_164 ;
if ( F_53 ( V_162 , & V_81 -> V_27 ) )
F_115 ( & V_165 [ V_158 ] ) ;
F_144 () ;
if ( F_145 ( V_159 ) )
F_146 ( V_159 ) ;
}
void F_147 ( struct V_87 * V_81 , int V_158 )
{
enum V_161 V_162 ;
V_162 = V_158 ? V_163 : V_164 ;
if ( ! F_148 ( V_162 , & V_81 -> V_27 ) )
F_66 ( & V_165 [ V_158 ] ) ;
}
long F_149 ( int V_158 , long V_59 )
{
long V_41 ;
unsigned long V_166 = V_68 ;
F_150 ( V_167 ) ;
T_8 * V_159 = & V_160 [ V_158 ] ;
F_151 ( V_159 , & V_167 , V_168 ) ;
V_41 = F_152 ( V_59 ) ;
F_153 ( V_159 , & V_167 ) ;
F_154 ( F_155 ( V_59 ) ,
F_155 ( V_68 - V_166 ) ) ;
...
long F_156 ( struct V_169 * V_170 , int V_158 , long V_59 )
{
long V_41 ;
unsigned long V_166 = V_68 ;
F_150 ( V_167 ) ;
T_8 * V_159 = & V_160 [ V_158 ] ;
if ( F_117 ( & V_165 [ V_158 ] ) == 0 ||
! F_39 ( V_171 , & V_170 -> V_92 ) ) {
F_157 () ;
V_41 = V_59 - ( V_68 - V_166 ) ;
if ( V_41 < 0 )
V_41 = 0 ;
goto V_172;
}
...
int F_159 ( struct V_173 * V_174 , int V_175 ,
void T_9 * V_176 , T_3 * V_177 , T_10 * V_178 )
{
char V_179 [] = L_21 ;
if ( * V_178 || * V_177 < sizeof( V_179 ) ) {
* V_177 = 0 ;
return 0 ;
}
if ( F_160 ( V_176 , V_179 , sizeof( V_179 ) ) )
return - V_180 ;
F_161 ( L_22 ,
V_174 -> V_181 ) ;
* V_177 = 2 ;
