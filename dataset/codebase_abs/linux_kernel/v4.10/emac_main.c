...
V_127 = F_63 ( * ( V_129 * ) & V_7 -> V_128 [ 4 ] ) ;
F_5 ( V_2 , V_130 , V_126 ) ;
F_5 ( V_2 , V_131 , V_127 ) ;
}
static int F_64 ( struct V_6 * V_7 , void * V_132 )
{
...
int F_67 ( struct V_6 * V_7 , int V_138 )
{
...
int V_148 ;
V_144 = F_68 ( V_50 -> V_149 , L_4 , 0 ) ;
if ( ! V_144 ) {
F_69 ( V_50 , L_5 ) ;
return - V_150 ;
}
V_148 = F_70 ( V_50 -> V_149 , 0 , & V_142 ) ;
if ( V_148 ) {
F_69 ( V_50 , L_6 ) ;
V_148 = - V_150 ;
goto V_151;
}
V_75 = F_71 ( V_50 -> V_149 , 0 ) ;
if ( ! V_75 ) {
F_69 ( V_50 , L_7 ) ;
V_148 = - V_150 ;
goto V_151;
...
V_2 = F_3 ( V_7 ) ;
V_2 -> V_50 = V_50 ;
V_2 -> V_158 = F_72 ( V_50 , & V_142 ) ;
if ( F_73 ( V_2 -> V_158 ) ) {
V_148 = F_74 ( V_2 -> V_158 ) ;
goto V_151;
}
F_75 ( V_50 , L_8 , V_2 -> V_158 ) ;
if ( V_2 -> V_159 ) {
V_148 = F_76 ( V_2 -> V_159 ) ;
if ( V_148 ) {
F_69 ( V_50 , L_9 ) ;
goto V_151;
}
V_147 = F_77 ( V_2 -> V_159 ) ;
} else {
if ( F_78 ( V_50 -> V_149 , L_10 ,
& V_147 ) ) {
F_69 ( V_50 , L_11 ) ;
V_148 = - V_160 ;
goto V_151;
...
F_69 ( V_50 , L_12 , V_146 ) ;
V_148 = - V_150 ;
goto V_162;
}
F_79 ( V_50 , L_13 , V_146 ) ;
F_5 ( V_2 , V_163 , V_147 / 1000000 ) ;
V_7 -> V_75 = V_75 ;
F_79 ( V_50 , L_14 , V_7 -> V_75 ) ;
V_148 = F_80 ( V_50 , V_7 -> V_75 , F_37 , 0 ,
V_7 -> V_164 , V_7 ) ;
if ( V_148 ) {
F_69 ( V_50 , L_15 ) ;
goto V_162;
}
V_145 = F_81 ( V_50 -> V_149 ) ;
if ( V_145 )
memcpy ( V_7 -> V_128 , V_145 , V_114 ) ;
else
F_82 ( V_7 ) ;
F_62 ( V_7 ) ;
F_79 ( V_50 , L_16 , V_7 -> V_128 ) ;
V_2 -> V_57 = F_83 ( V_50 , V_165 + V_95 ,
& V_2 -> V_99 , V_166 ) ;
if ( ! V_2 -> V_57 ) {
F_69 ( V_50 , L_17 ) ;
V_148 = - V_94 ;
