...
{
int V_36 ;
if ( V_1 -> V_14 == V_34 ) return F_16 ( V_1 ) ;
F_3 ( 1 , V_37 ) ;
F_17 ( 10 ) ;
F_3 ( 0 , V_37 ) ;
F_17 ( 30 ) ;
...
F_21 ( & V_1 -> V_39 , V_38 ) ;
F_18 ( F_4 ( L_4 , V_1 -> V_40 , V_1 -> V_41 ) ) ;
}
...
static void F_24 ( T_1 * V_1 , struct V_47 * V_48 )
{
unsigned char V_42 = F_7 ( V_1 , 0x84 ) & ~ 0x06 ;
switch ( V_48 -> V_49 )
{
case 0x300 :
F_23 ( V_1 , 0x84 , V_42 | 0x04 ) ;
break;
case 0x330 :
F_23 ( V_1 , 0x84 , V_42 | 0x00 ) ;
break;
default:
F_23 ( V_1 , 0x84 , V_42 | 0x02 ) ;
F_4 ( V_44 L_6 , V_48 -> V_49 ) ;
}
}
static int F_25 ( T_1 * V_1 , int V_50 )
{
int V_51 ;
switch ( V_50 )
{
...
static void F_26 ( T_1 * V_1 , struct V_47 * V_48 )
{
...
static int F_27 ( T_1 * V_1 , struct V_47 * V_48 )
{
char V_56 [ 100 ] ;
if ( ! F_1 ( V_1 , 0xfa ) )
return 0 ;
...
{
F_4 ( V_44 L_8 , V_48 -> V_18 ) ;
return 0 ;
}
if ( V_48 -> V_58 < 0 || V_48 -> V_58 > 3 || V_59 [ V_48 -> V_58 ] == 0 )
{
F_4 ( V_44 L_9 , V_48 -> V_58 ) ;
return 0 ;
}
if ( V_48 -> V_60 < 0 )
{
...
int F_29 ( struct V_47 * V_48 , int V_65 , int V_66 , struct V_67 * V_68 )
{
T_1 V_69 ;
T_1 * V_1 = & V_69 ;
...
V_83 = F_32 ( V_1 , sizeof( T_1 ) , V_84 ) ;
if ( V_83 == NULL )
{
F_4 ( V_44 L_19 ) ;
return 0 ;
}
F_33 ( F_4 ( V_80 L_20 , V_1 -> V_40 , V_1 -> V_41 , V_48 -> V_49 ) ) ;
return 1 ;
}
int F_34 ( struct V_47 * V_48 , struct V_85 * V_86 )
{
T_1 * V_1 ;
char V_56 [ 100 ] ;
extern int V_87 ;
int V_88 , V_89 ;
F_18 ( F_4 ( L_21 , V_48 -> V_49 ) ) ;
V_56 [ 0 ] = 0 ;
if ( V_83 == NULL )
{
F_33 ( F_4 ( L_22 ) ) ;
...
if ( F_36 ( V_48 -> V_18 , F_13 , V_3 , L_24 , V_1 ) < 0 )
{
F_4 ( V_44 L_25 , V_48 -> V_18 ) ;
F_35 ( V_1 -> V_64 , 16 ) ;
return 0 ;
}
V_1 -> V_32 = 0 ;
if ( V_1 -> V_40 == 4 )
if ( ! F_25 ( V_1 , V_1 -> V_18 ) )
{
F_37 ( V_1 -> V_18 , V_1 ) ;
F_35 ( V_1 -> V_64 , 16 ) ;
return 0 ;
...
if ( ! V_1 -> V_32 )
F_4 ( V_9 L_27 , V_1 -> V_18 ) ;
else
{
F_18 ( F_4 ( L_28 , V_1 -> V_18 ) ) ;
}
}
}
V_92 = V_1 ;
...
{
V_89 = F_7 ( V_1 , 0x30 ) ;
F_23 ( V_1 , 0x22 , ( V_88 = F_7 ( V_1 , 0x22 ) ) & 0x0f ) ;
F_23 ( V_1 , 0x30 , 0xff ) ;
...
if ( V_48 -> V_56 == NULL )
V_48 -> V_56 = L_34 ;
sprintf ( V_56 , L_35 , V_48 -> V_56 , V_1 -> V_40 , V_1 -> V_41 ) ;
F_42 ( V_56 , V_48 ) ;
if ( V_1 -> V_14 <= V_96 )
{
if ( V_1 -> V_40 == 3 && V_1 -> V_41 != 1 )
...
{
F_4 ( V_80 L_40 , V_1 -> V_40 , V_1 -> V_41 ) ;
F_4 ( V_80 L_41 ) ;
F_4 ( V_80 L_42 ) ;
}
}
...
{
if ( F_43 ( V_1 -> V_43 , L_43 ) )
{
F_4 ( V_9 L_44 , V_1 -> V_43 ) ;
}
if ( V_1 -> V_45 >= 0 && V_1 -> V_45 != V_1 -> V_43 )
{
if ( F_43 ( V_1 -> V_45 , L_45 ) )
F_4 ( V_9 L_46 , V_1 -> V_45 ) ;
}
F_44 ( V_1 , V_56 , V_86 ) ;
V_48 -> V_101 [ 0 ] = V_1 -> V_23 ;
}
...
void F_45 ( struct V_47 * V_48 , int V_103 )
{
T_1 * V_1 ;
...
void F_23 ( T_1 * V_1 , unsigned int V_105 , unsigned int V_106 )
{
unsigned long V_38 ;
if ( V_1 -> V_14 == V_34 ) {
F_51 ( V_1 , V_105 , V_106 ) ;
return;
}
F_20 ( & V_1 -> V_39 , V_38 ) ;
...
unsigned int V_2 ;
unsigned long V_38 ;
if ( V_1 -> V_14 == V_34 ) return F_52 ( V_1 , V_105 ) ;
F_20 ( & V_1 -> V_39 , V_38 ) ;
F_3 ( ( ( unsigned char ) ( V_105 & 0xff ) ) , V_107 ) ;
F_17 ( 20 ) ;
V_2 = F_2 ( V_108 ) ;
...
F_23 ( V_1 , V_109 , V_106 ) ;
}
static void F_54 ( T_1 * V_1 , int V_64 , int V_111 , unsigned char V_2 )
{
unsigned long V_38 ;
F_20 ( & V_55 , V_38 ) ;
...
static unsigned char F_55 ( T_1 * V_1 , int V_64 , int V_111 )
{
unsigned long V_38 ;
unsigned char V_2 ;
F_20 ( & V_55 , V_38 ) ;
...
static int F_56 ( T_1 * V_1 , struct V_47 * V_48 )
{
int V_112 = V_48 -> V_49 ;
int V_113 = V_112 + 4 ;
int V_3 ;
...
F_54 ( V_1 , V_113 , 0 , 0x00 ) ;
F_54 ( V_1 , V_113 , 1 , 0xff ) ;
F_17 ( 10 ) ;
if ( F_55 ( V_1 , V_113 , 0 ) != 0x00 || F_55 ( V_1 , V_113 , 1 ) != 0xff )
{
F_18 ( F_4 ( L_48 , F_55 ( V_1 , V_113 , 0 ) , F_55 ( V_1 , V_113 , 1 ) ) ) ;
return 0 ;
}
V_1 -> V_14 = V_79 ;
F_58 ( V_1 ) ;
...
F_54 ( V_1 , V_113 , V_3 , V_115 [ V_3 ] ) ;
for ( V_3 = 0 ; V_3 < 8192 ; V_3 ++ )
if ( F_55 ( V_1 , V_113 , V_3 ) != V_115 [ V_3 ] )
{
F_4 ( V_44 L_51 ) ;
return 0 ;
}
...
static int F_62 ( T_1 * V_1 , struct V_47 * V_48 )
{
int V_112 = V_48 -> V_49 ;
int V_119 = V_1 -> V_64 ;
int V_18 = V_48 -> V_18 ;
...
int F_63 ( struct V_47 * V_48 , struct V_85 * V_86 )
{
T_1 * V_1 = V_102 ;
int V_120 ;
if ( V_102 == NULL )
...
{
struct V_122 * V_123 ;
V_123 = F_65 ( V_48 -> V_49 , 2 , L_55 ) ;
if ( ! V_123 ) {
F_4 ( V_44 L_56 , V_48 -> V_49 ) ;
return 0 ;
}
if ( ! F_66 ( V_1 , V_48 ) ) {
F_35 ( V_48 -> V_49 , 2 ) ;
...
V_120 = F_69 ( V_48 , V_86 ) ;
if ( V_120 )
V_92 -> V_17 = V_124 [ V_48 -> V_101 [ 4 ] ] -> V_1 ;
return V_120 ;
}
void F_70 ( struct V_47 * V_48 )
{
#if F_64 ( V_121 )
if ( ! strcmp ( V_48 -> V_56 , L_57 ) ) {
F_71 ( V_48 ) ;
return;
}
#endif
