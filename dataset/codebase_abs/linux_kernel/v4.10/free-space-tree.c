...
V_53 = V_19 -> V_10 . V_31 ;
V_54 = V_19 -> V_10 . V_31 + V_19 -> V_10 . V_11 ;
V_10 . V_31 = V_54 - 1 ;
V_10 . type = ( T_4 ) - 1 ;
V_10 . V_11 = ( T_3 ) - 1 ;
while ( ! V_59 ) {
...
if ( V_50 . type == V_32 ) {
ASSERT ( V_50 . V_31 == V_19 -> V_10 . V_31 ) ;
ASSERT ( V_50 . V_11 == V_19 -> V_10 . V_11 ) ;
V_59 = 1 ;
break;
...
ASSERT ( V_50 . V_31 + V_50 . V_11 <= V_54 ) ;
V_63 = F_2 ( V_50 . V_31 - V_53 ,
V_7 -> V_8 ) ;
V_64 = F_2 ( V_50 . V_31 + V_50 . V_11 - V_53 ,
V_7 -> V_8 ) ;
...
V_30 = F_23 ( V_17 , V_23 , V_21 , V_21 -> V_35 [ 0 ] , V_60 ) ;
if ( V_30 )
goto V_33;
F_9 ( V_21 ) ;
}
...
ASSERT ( V_10 . type == V_69 ) ;
V_76 = V_10 . V_31 ;
V_77 = V_10 . V_31 + V_10 . V_11 ;
ASSERT ( V_11 >= V_76 && V_11 < V_77 ) ;
V_66 = F_30 ( V_29 , V_21 -> V_35 [ 0 ] ) ;
V_55 = F_2 ( V_11 - V_76 ,
V_19 -> V_7 -> V_8 ) ;
...
V_54 = V_77 ;
V_66 = F_30 ( V_29 , V_21 -> V_35 [ 0 ] ) ;
V_63 = F_2 ( * V_53 - V_76 , V_7 -> V_8 ) ;
V_64 = F_2 ( V_54 - V_76 , V_7 -> V_8 ) ;
if ( V_72 )
...
int V_75 ;
int V_30 ;
if ( V_53 > V_19 -> V_10 . V_31 ) {
T_3 V_81 = V_53 - V_19 -> V_7 -> V_8 ;
V_10 . V_31 = V_81 ;
V_10 . type = ( T_4 ) - 1 ;
V_10 . V_11 = ( T_3 ) - 1 ;
...
if ( V_54 < V_19 -> V_10 . V_31 + V_19 -> V_10 . V_11 ) {
F_21 ( V_21 -> V_34 [ 0 ] , & V_10 , V_21 -> V_35 [ 0 ] ) ;
if ( V_54 >= V_10 . V_31 + V_10 . V_11 ) {
V_30 = F_43 ( V_17 , V_23 , V_21 ) ;
if ( V_30 )
goto V_33;
}
...
F_9 ( V_21 ) ;
V_87:
V_30 = F_4 ( V_17 , V_23 , V_21 , & V_85 , 0 ) ;
if ( V_30 )
goto V_33;
F_9 ( V_21 ) ;
V_30 = F_37 ( V_17 , V_7 , V_19 , V_21 ,
...
F_54 ( & V_19 -> V_84 ) ;
V_30 = F_59 ( V_17 , V_7 , V_19 , V_21 , V_53 ,
V_41 ) ;
F_55 ( & V_19 -> V_84 ) ;
F_56 ( V_19 ) ;
V_33:
...
break;
V_21 -> V_35 [ 0 ] = 0 ;
V_30 = F_23 ( V_17 , V_23 , V_21 , 0 , V_60 ) ;
if ( V_30 )
goto V_33;
F_9 ( V_21 ) ;
}
...
if ( V_30 )
goto abort;
V_30 = F_78 ( V_17 , V_96 , & V_24 -> V_105 ) ;
if ( V_30 )
goto abort;
F_79 ( & V_24 -> V_106 ) ;
F_80 ( V_24 -> V_98 ) ;
F_81 ( V_17 , V_7 , V_24 -> V_98 ) ;
F_82 ( V_24 -> V_98 ) ;
F_83 ( V_17 , V_24 , V_24 -> V_98 ,
0 , 1 ) ;
F_84 ( V_24 -> V_98 ) ;
F_84 ( V_24 -> V_107 ) ;
F_85 ( V_24 ) ;
...
break;
ASSERT ( V_10 . type == V_69 ) ;
ASSERT ( V_10 . V_31 < V_54 && V_10 . V_31 + V_10 . V_11 <= V_54 ) ;
V_109 -> V_111 = V_10 . V_31 ;
V_11 = V_10 . V_31 ;
while ( V_11 < V_10 . V_31 + V_10 . V_11 ) {
V_72 = F_38 ( V_19 , V_21 , V_11 ) ;
if ( V_71 == 0 && V_72 == 1 ) {
V_70 = V_11 ;
} else if ( V_71 == 1 && V_72 == 0 ) {
V_110 += F_89 ( V_19 ,
