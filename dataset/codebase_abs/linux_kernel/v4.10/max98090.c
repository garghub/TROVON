...
V_224 = V_243 ;
F_27 ( V_15 -> V_2 , L_39 ) ;
} else if ( V_224 < V_244 || V_224 > V_243 ) {
...
static int F_76 ( struct V_249 * V_250 ,
...
int V_12 ;
F_77 ( L_41 ) ;
V_11 = F_78 ( & V_250 -> V_2 , sizeof( struct V_10 ) ,
V_256 ) ;
if ( V_11 == NULL )
return - V_257 ;
if ( F_79 ( & V_250 -> V_2 ) ) {
V_254 = F_80 ( V_250 -> V_2 . V_258 -> V_259 ,
& V_250 -> V_2 ) ;
if ( ! V_254 ) {
F_5 ( & V_250 -> V_2 , L_42 ) ;
return - V_34 ;
...
V_11 -> V_51 = V_255 ;
F_81 ( V_250 , V_11 ) ;
V_11 -> V_260 = V_250 -> V_2 . V_261 ;
V_12 = F_82 ( V_250 -> V_2 . V_262 , L_43 ,
& V_11 -> V_147 ) ;
if ( V_12 < 0 )
V_11 -> V_147 = V_263 ;
V_11 -> V_13 = F_83 ( V_250 , & V_264 ) ;
if ( F_31 ( V_11 -> V_13 ) ) {
V_12 = F_68 ( V_11 -> V_13 ) ;
F_5 ( & V_250 -> V_2 , L_44 , V_12 ) ;
goto V_265;
}
V_12 = F_84 ( & V_250 -> V_2 , V_250 -> V_210 , NULL ,
F_63 , V_266 | V_267 ,
L_45 , V_11 ) ;
if ( V_12 < 0 ) {
F_5 ( & V_250 -> V_2 , L_46 ,
...
{
struct V_10 * V_11 = F_87 ( & V_250 -> V_2 ) ;
F_4 ( V_11 -> V_13 ,
V_270 , V_271 ) ;
F_4 ( V_11 -> V_13 ,
V_198 , 0x00 ) ;
...
static int F_88 ( struct V_249 * V_272 )
{
F_86 ( V_272 ) ;
F_89 ( & V_272 -> V_2 ) ;
return 0 ;
