...
V_131 -> V_144 = NULL ;
V_131 -> V_21 = NULL ;
V_131 -> V_145 = F_15 ( V_2 ) ;
V_131 -> V_146 = F_8 ( V_2 ) -> V_147 ;
...
V_136 -> V_150 = V_49 -> V_33 -> V_151 & ~ ( V_152 |
V_153 ) ;
V_135 = (struct V_134 * ) V_136 ;
V_133 = F_86 ( V_136 ) ;
V_133 -> V_137 = & V_135 -> V_138 ;
...
V_133 -> V_154 = NULL ;
V_131 -> V_113 . V_155 = V_12 -> V_113 . V_155 ;
V_131 -> V_144 = NULL ;
V_131 -> V_21 = NULL ;
V_131 -> V_145 = F_15 ( V_2 ) ;
V_131 -> V_146 = F_8 ( V_2 ) -> V_147 ;
...
F_31 ( V_136 ) -> V_156 = 0 ;
if ( V_21 )
F_31 ( V_136 ) -> V_156 = V_21 -> V_157 +
V_21 -> V_158 ;
F_33 ( V_136 , F_32 ( V_49 ) ) ;
V_133 -> V_159 = V_133 -> V_160 = V_161 ;
V_133 -> V_162 = V_161 ;
...
if ( * V_130 && V_66 -> V_87 ) {
V_131 -> V_144 = F_96 ( V_66 -> V_87 , V_163 ) ;
F_97 ( V_66 -> V_87 ) ;
V_66 -> V_87 = NULL ;
if ( V_131 -> V_144 )
...
return V_136 ;
V_148:
F_24 ( F_99 ( V_10 ) , V_164 ) ;
V_149:
F_54 ( V_49 ) ;
V_41:
F_24 ( F_99 ( V_10 ) , V_165 ) ;
return NULL ;
}
...
F_69 ( V_2 ) -> V_173 = V_14 -> V_93 ;
if ( F_108 ( V_2 ) )
F_69 ( V_2 ) -> V_174 = V_175 ;
else
F_69 ( V_2 ) -> V_174 = F_109 ( V_2 ) ;
V_176:
...
struct V_9 * V_178 ;
V_10 = V_64 -> V_179 ;
if ( F_114 ( V_10 -> V_36 != V_180 ) ) {
F_115 ( V_10 , V_64 ) ;
goto V_176;
}
F_116 ( V_10 ) ;
V_170 = true ;
V_178 = F_117 ( V_10 , V_2 , V_64 ) ;
if ( ! V_178 ) {
F_118 ( V_64 ) ;
goto V_181;
}
...
V_171 = F_25 ( V_10 ) -> V_182 ;
if ( V_14 -> V_183 && ( V_171 == 0 || V_14 -> V_183 < V_171 ) ) {
F_112 ( L_5 ,
V_14 -> V_183 , V_171 ) ;
goto V_181;
}
if ( ! F_120 ( V_10 , V_184 , V_2 ) )
goto V_181;
return F_121 ( V_10 , V_2 , 1 , V_14 -> V_185 * 4 ,
V_170 ) ? - 1 : 0 ;
V_177:
if ( ! F_120 ( NULL , V_184 , V_2 ) )
goto V_172;
if ( V_14 -> V_93 != V_94 ) {
F_69 ( V_2 ) -> V_105 =
V_186 ;
...
static int F_122 ( struct V_9 * V_10 , struct V_187 * V_188 ,
int V_189 )
{
struct V_190 * V_191 = (struct V_190 * ) V_188 ;
struct V_192 * V_193 = F_31 ( V_10 ) ;
struct V_132 * V_194 = F_86 ( V_10 ) ;
struct V_11 * V_12 = F_4 ( V_10 ) ;
...
if ( V_189 < V_198 )
return - V_199 ;
if ( V_191 -> V_200 != V_112 )
return - V_201 ;
memset ( & V_70 , 0 , sizeof( V_70 ) ) ;
if ( V_12 -> V_202 ) {
V_70 . V_74 = V_191 -> V_203 & V_204 ;
F_123 ( V_70 . V_74 ) ;
if ( V_70 . V_74 & V_205 ) {
struct V_206 * V_74 ;
...
if ( F_126 ( & V_191 -> V_207 ) )
V_191 -> V_207 . V_208 [ 15 ] = 1 ;
V_195 = F_81 ( & V_191 -> V_207 ) ;
if ( V_195 & V_209 )
return - V_210 ;
if ( V_195 & V_121 ) {
if ( V_189 >= sizeof( struct V_190 ) &&
V_191 -> V_211 ) {
if ( V_10 -> V_120 &&
V_10 -> V_120 != V_191 -> V_211 )
return - V_199 ;
V_10 -> V_120 = V_191 -> V_211 ;
}
if ( ! V_10 -> V_120 )
...
V_10 -> V_16 = V_191 -> V_207 ;
V_12 -> V_212 = V_70 . V_74 ;
if ( V_195 == V_213 ) {
T_5 V_214 = V_193 -> V_156 ;
struct V_215 sin ;
F_127 ( V_10 , L_6 ) ;
if ( F_128 ( V_10 ) )
return - V_210 ;
sin . V_216 = V_217 ;
sin . V_218 = V_191 -> V_219 ;
sin . V_220 . V_221 = V_191 -> V_207 . V_17 [ 3 ] ;
V_193 -> V_140 = & V_141 ;
V_10 -> V_142 = V_143 ;
V_30 = F_129 ( V_10 , (struct V_187 * ) & sin , sizeof( sin ) ) ;
if ( V_30 ) {
V_193 -> V_156 = V_214 ;
V_193 -> V_140 = & V_222 ;
V_10 -> V_142 = F_100 ;
...
V_70 . V_77 = V_191 -> V_219 ;
V_70 . V_79 = V_194 -> V_224 ;
...
V_193 -> V_156 = 0 ;
if ( V_21 )
V_193 -> V_156 = V_21 -> V_158 + V_21 -> V_157 ;
V_194 -> V_225 = V_191 -> V_219 ;
F_133 ( V_10 , V_56 ) ;
V_30 = F_134 ( & V_226 , V_10 ) ;
if ( V_30 )
goto V_227;
V_29 -> V_228 = F_7 ( V_12 -> V_4 . V_17 ,
V_10 -> V_16 . V_17 ,
V_194 -> V_224 ,
V_194 -> V_225 ) ;
V_30 = F_135 ( V_10 ) ;
...
{
static T_6 V_229 ;
int V_30 = F_138 ( V_10 , V_229 ) ;
if ( V_30 == 0 ) {
if ( F_114 ( ! V_229 ) )
V_229 = 1 ;
F_31 ( V_10 ) -> V_140 = & V_222 ;
}
return V_30 ;
}
...
if ( V_34 . V_230 == NULL )
return - V_231 ;
return F_143 ( & V_32 -> V_91 . V_92 , V_232 ,
V_233 , V_7 , V_32 ) ;
}
...
{
int V_30 = F_147 ( & V_234 , 1 ) ;
if ( V_30 != 0 )
goto V_41;
V_30 = F_148 ( & V_235 , V_7 ) ;
if ( V_30 != 0 )
goto V_236;
F_149 ( & V_237 ) ;
V_30 = F_150 ( & V_238 ) ;
