...
{
struct V_34 V_94 = F_10 () ;
V_94 . V_95 = F_59 ( V_96 ) - 10 ;
F_60 ( V_50 , & V_94 ) ;
F_15 ( _ ( F_28 ( V_50 ) ) , F_14 ( & V_94 ) ) ;
F_16 ( & V_94 ) ;
}
...
F_73 ( V_122 ) ;
signal ( V_124 , F_71 ) ;
if ( V_118 > 1 && strcmp ( V_119 [ 1 ] , L_47 ) == 0 ) {
V_93 = 1 ;
F_74 ( NULL ) ;
V_119 ++ ;
}
...
V_120 = getenv ( L_48 ) ;
if ( V_120 ) {
if ( ! strcasecmp ( V_120 , L_49 ) )
V_66 = 1 ;
}
if ( F_76 ( NULL ) ) {
fprintf ( V_116 , F_77 ( L_50 ) ) ;
fprintf ( V_116 , F_77 ( L_51 ) ) ;
return 1 ;
}
F_1 ( F_78 () ) ;
F_74 ( F_58 ) ;
