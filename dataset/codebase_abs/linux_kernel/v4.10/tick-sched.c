...
static void F_139 ( struct V_1 * V_15 )
{
#ifndef F_140
unsigned long V_5 ;
if ( F_141 () )
...
static void F_144 ( struct V_66 * V_67 )
{
struct V_1 * V_15 = F_35 ( & V_3 ) ;
struct V_16 * V_17 = F_145 () ;
T_1 V_4 = F_96 () ;
V_67 -> V_85 = V_83 ;
F_15 ( V_4 ) ;
F_19 ( V_15 , V_17 ) ;
...
static inline void F_146 ( struct V_1 * V_15 , int V_99 )
{
if ( ! V_51 )
return;
V_15 -> V_63 = V_99 ;
...
static enum V_104 F_156 ( struct V_105 * V_106 )
{
struct V_1 * V_15 =
F_157 ( V_106 , struct V_1 , V_61 ) ;
struct V_16 * V_17 = F_145 () ;
T_1 V_4 = F_96 () ;
F_15 ( V_4 ) ;
if ( V_17 )
...
static int T_4 F_158 ( char * V_42 )
{
F_159 ( & V_42 , & V_109 ) ;
return 0 ;
}
...
T_1 V_4 = F_96 () ;
F_151 ( & V_15 -> V_61 , V_101 , V_102 ) ;
V_15 -> V_61 . V_110 = F_156 ;
F_102 ( & V_15 -> V_61 , F_14 () ) ;
if ( V_109 ) {
T_5 V_111 = F_8 ( V_8 ) >> 1 ;
F_161 ( V_111 , F_162 () ) ;
V_111 *= F_16 () ;
F_163 ( & V_15 -> V_61 , V_111 ) ;
}
F_103 ( & V_15 -> V_61 , V_4 , V_8 ) ;
F_104 ( & V_15 -> V_61 , V_65 ) ;
F_146 ( V_15 , V_64 ) ;
