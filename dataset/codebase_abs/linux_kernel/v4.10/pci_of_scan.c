...
V_39 -> V_75 = V_22 -> V_39 -> V_52 ;
F_26 ( V_39 , F_3 ( V_70 , 1 ) ,
F_3 ( V_70 + 1 , 1 ) ) ;
V_39 -> V_76 = 0 ;
V_28 = & V_22 -> V_27 [ V_77 ] ;
for ( V_30 = 0 ; V_30 < V_78 - V_77 ; ++ V_30 ) {
V_28 -> V_9 = 0 ;
V_39 -> V_27 [ V_30 ] = V_28 ;
++ V_28 ;
}
...
int V_85 , V_41 ;
#ifdef F_31
struct V_86 * V_87 = F_32 ( F_33 ( V_83 ) ) ;
#endif
F_6 ( L_33 , V_83 -> V_73 ) ;
if ( ! F_34 ( V_83 ) )
return NULL ;
V_84 = F_2 ( V_83 , L_34 , & V_85 ) ;
if ( V_84 == NULL || V_85 < 20 )
return NULL ;
V_41 = ( F_3 ( V_84 , 1 ) >> 8 ) & 0xff ;
V_22 = F_35 ( V_39 , V_41 ) ;
if ( V_22 ) {
F_36 ( V_22 ) ;
return V_22 ;
...
#ifdef F_31
if ( V_87 && ( V_87 -> V_72 & V_88 ) )
return NULL ;
#endif
V_22 = F_10 ( V_83 , V_39 , V_41 ) ;
if ( ! V_22 )
return NULL ;
F_6 ( L_35 , V_22 -> V_61 ) ;
return V_22 ;
