...
F_3 ( L_5 ,
F_16 ( & V_15 -> V_40 ) , F_17 ( & V_15 -> V_40 ) ) ;
V_19 = F_8 ( sizeof( * V_19 ) , V_16 ) ;
if ( ! V_19 ) {
F_3 ( L_6 , V_6 , V_7 ) ;
goto V_32;
}
F_18 ( & V_19 -> V_5 , V_13 , & V_15 -> V_40 ) ;
F_19 ( V_18 ) ;
V_19 -> V_7 . V_7 = V_7 ;
return & V_19 -> V_5 ;
V_32:
...
static void F_20 ( struct V_41 * V_42 , unsigned V_43 ,
struct V_44 * V_45 )
{
struct V_46 * V_47 = & V_42 -> V_48 [ V_43 ] ;
F_21 ( V_45 -> V_49 . V_50 > 0 ) ;
F_21 ( V_45 -> V_51 . V_50 > sizeof( V_47 -> V_52 ) ) ;
V_47 -> V_53 . V_54 = V_45 -> V_55 . V_56 ;
V_47 -> V_53 . V_57 = V_45 -> V_55 . V_58 ;
memcpy ( V_47 -> V_52 , V_45 -> V_51 . V_52 , sizeof( V_47 -> V_52 ) ) ;
}
static int F_22 ( unsigned V_59 , T_1 V_16 ,
struct V_9 * * V_60 )
{
struct V_9 * V_11 ;
...
static void F_57 ( void * V_159 , struct V_102 * V_102 )
{
F_3 ( L_13 , V_6 ,
...
int F_59 ( struct V_152 * V_153 , int V_167 )
{
struct V_107 * V_112 ;
int V_110 ;
...
static T_3 F_61 ( struct V_171 * V_172 ,
struct V_173 * V_174 , struct V_173 * V_175 )
{
struct V_176 * V_177 = F_62 ( V_172 ) ;
unsigned int V_178 ;
V_178 = F_63 ( V_172 , V_174 , V_175 ) ;
if ( ! V_178 || V_177 -> V_179 + V_175 -> V_180 >
( unsigned long ) V_172 -> V_181 )
return 0 ;
return F_64 ( V_178 , V_175 -> V_180 ) ;
}
static void F_65 ( struct V_171 * V_172 , struct V_173 * V_175 )
{
F_66 ( V_172 , V_175 ) ;
if ( F_23 ( V_172 -> V_182 == NULL ) )
return;
V_172 -> V_181 = ( void * )
F_6 ( V_172 -> V_182 ) -> V_78 . V_183 ;
}
static bool F_67 ( T_5 V_104 , struct V_184 * V_78 ,
unsigned long * V_185 )
{
T_8 V_186 ;
unsigned V_187 ;
...
F_68 ( V_104 , V_187 , & V_186 ) ;
if ( ! V_186 )
return true ;
* V_185 = V_187 - V_186 ;
return false ;
}
static void F_69 ( struct V_171 * V_172 , struct V_173 * V_175 )
{
unsigned long V_185 = 0 ;
T_5 V_190 ;
if ( V_172 -> V_191 == NULL )
V_190 = F_51 ( V_172 -> V_192 ) - F_70 ( V_175 ) ;
else
V_190 = F_71 ( V_172 -> V_191 ) ;
F_72 ( V_172 , V_175 , V_190 ) ;
if ( F_23 ( V_172 -> V_182 == NULL ) )
return;
if ( V_175 -> V_193 ||
! F_67 ( V_175 -> V_194 * V_119 ,
