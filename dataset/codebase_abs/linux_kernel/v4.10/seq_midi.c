...
static int
F_30 ( struct V_43 * V_61 )
{
struct V_62 * V_63 = F_31 ( V_61 ) ;
struct V_64 * V_21 ;
struct V_5 * V_6 , * V_65 ;
struct V_66 * V_18 ;
struct V_67 * V_47 ;
...
if ( F_6 ( ! V_42 || V_43 < 0 || V_43 >= V_77 ) )
return - V_25 ;
V_47 = F_32 ( sizeof( * V_47 ) , V_78 ) ;
if ( ! V_47 )
return - V_26 ;
V_47 -> V_43 = V_43 ;
V_47 -> V_79 = V_80 ;
...
V_21 -> V_23 =
F_38 (
V_42 , 0 , L_5 , V_42 -> V_86 [ 0 ] ?
( const char * ) V_42 -> V_86 : L_6 ) ;
if ( V_21 -> V_23 < 0 ) {
F_34 ( V_21 ) ;
F_37 ( & V_83 ) ;
F_34 ( V_47 ) ;
...
V_6 = F_39 ( V_72 , sizeof( struct V_5 ) , V_78 ) ;
V_18 = F_32 ( sizeof( * V_18 ) , V_78 ) ;
if ( V_6 == NULL || V_18 == NULL )
goto V_87;
for ( V_71 = 0 ; V_71 < V_72 ; V_71 ++ ) {
V_65 = & V_6 [ V_71 ] ;
if ( F_15 ( V_65 , V_42 , V_43 , V_71 ) < 0 )
goto V_87;
memset ( V_18 , 0 , sizeof( * V_18 ) ) ;
V_18 -> V_88 . V_21 = V_21 -> V_23 ;
V_18 -> V_88 . V_18 = V_43 * ( 256 / V_77 ) + V_71 ;
V_18 -> V_36 = V_89 ;
...
V_47 -> V_44 = V_71 ;
if ( F_33 ( V_42 , V_47 ) >= 0 )
strcpy ( V_18 -> V_90 , V_47 -> V_91 ) ;
if ( ! V_18 -> V_90 [ 0 ] ) {
if ( V_47 -> V_90 [ 0 ] ) {
if ( V_72 > 1 )
snprintf ( V_18 -> V_90 , sizeof( V_18 -> V_90 ) , L_7 , V_47 -> V_90 , V_71 ) ;
else
snprintf ( V_18 -> V_90 , sizeof( V_18 -> V_90 ) , L_5 , V_47 -> V_90 ) ;
} else {
if ( V_72 > 1 )
sprintf ( V_18 -> V_90 , L_8 , V_42 -> V_85 , V_43 , V_71 ) ;
else
sprintf ( V_18 -> V_90 , L_9 , V_42 -> V_85 , V_43 ) ;
}
}
if ( ( V_47 -> V_36 & V_92 ) && V_71 < V_76 )
V_18 -> V_93 |= V_94 | V_95 | V_96 ;
if ( ( V_47 -> V_36 & V_97 ) && V_71 < V_75 )
...
if ( F_40 ( V_21 -> V_23 , V_117 , V_18 ) < 0 )
goto V_87;
V_65 -> V_23 = V_21 -> V_23 ;
V_65 -> V_19 = V_18 -> V_88 . V_18 ;
}
V_21 -> V_118 [ V_43 ] = V_72 ;
V_21 -> V_72 [ V_43 ] = V_6 ;
V_21 -> V_119 ++ ;
if ( V_70 )
V_84 [ V_42 -> V_85 ] = V_21 ;
...
static int
F_42 ( struct V_43 * V_61 )
{
struct V_62 * V_63 = F_31 ( V_61 ) ;
struct V_64 * V_21 ;
struct V_5 * V_6 ;
struct V_41 * V_42 = V_63 -> V_42 ;
int V_43 = V_63 -> V_43 , V_71 , V_72 ;
F_35 ( & V_83 ) ;
V_21 = V_84 [ V_42 -> V_85 ] ;
if ( V_21 == NULL || V_21 -> V_72 [ V_43 ] == NULL ) {
F_37 ( & V_83 ) ;
return - V_34 ;
}
V_72 = V_21 -> V_118 [ V_43 ] ;
V_21 -> V_118 [ V_43 ] = 0 ;
V_6 = V_21 -> V_72 [ V_43 ] ;
V_21 -> V_72 [ V_43 ] = NULL ;
for ( V_71 = 0 ; V_71 < V_72 ; V_71 ++ )
