...
int V_42 ;
T_5 * V_43 = V_23 ;
for ( V_42 = sizeof( V_10 -> V_32 ) ; V_42 < V_12 -> V_7 ; V_42 ++ ) {
if ( V_43 [ V_42 ] == V_37 )
continue;
if ( V_12 -> V_2 )
F_33 ( V_12 -> V_2 ,
...
if ( V_12 -> V_2 )
F_33 ( V_12 -> V_2 , L_8 ,
V_12 -> V_19 , ( unsigned long long ) V_36 ) ;
else
F_34 ( L_8 ,
V_12 -> V_19 , ( unsigned long long ) V_36 ) ;
return;
...
static void F_43 ( struct V_1 * V_2 , void * V_48 )
{
struct V_11 * V_12 = * (struct V_11 * * ) V_48 ;
F_30 ( V_12 ) ;
}
static int F_44 ( struct V_1 * V_2 , void * V_48 , void * V_49 )
{
...
V_50 = F_46 ( F_43 , sizeof( * V_50 ) , V_25 ) ;
if ( ! V_50 )
return NULL ;
