...
V_70 = V_8 -> V_73 ;
if ( ! V_70 ) {
V_8 -> V_73 = V_70 = F_4 ( sizeof( * V_70 ) , V_13 ) ;
if ( ! V_70 ) {
V_56 = - V_14 ;
goto error;
}
...
if ( V_71 > V_70 -> V_74 ) {
char * V_75 = F_22 ( V_70 -> V_34 , F_23 ( V_71 ) ,
V_13 | V_76 ) ;
if ( ! V_75 ) {
V_56 = - V_14 ;
goto error;
...
static int F_25 ( struct V_66 * V_77 , void * V_9 )
{
struct V_6 * V_8 = V_77 -> V_68 ;
struct V_4 * V_5 = V_8 -> V_5 ;
if ( ! V_5 -> V_25 . V_72 . V_36 ) {
return - V_35 ;
} else {
V_8 -> V_78 -> V_34 = ( char * ) V_77 ;
V_5 -> V_25 . V_72 . V_36 ( V_5 , V_8 -> V_78 ) ;
}
return 0 ;
}
...
struct V_6 * V_8 = V_67 -> V_68 ;
struct V_4 * V_5 = V_8 -> V_5 ;
if ( V_8 -> V_73 && V_5 -> V_25 . V_72 . V_38 )
V_5 -> V_25 . V_72 . V_38 ( V_5 , V_8 -> V_73 ) ;
F_30 ( V_52 , V_18 ) ;
F_19 ( V_8 -> V_78 ) ;
if ( V_8 -> V_73 ) {
F_19 ( V_8 -> V_73 -> V_34 ) ;
...
int F_57 ( struct V_69 * V_34 , char * line , int V_74 )
{
int V_25 = - 1 ;
if ( F_47 ( ! V_34 || ! V_34 -> V_34 ) )
return 1 ;
if ( V_74 <= 0 || V_34 -> V_96 || V_34 -> error )
return 1 ;
while ( ! V_34 -> V_96 ) {
...
const char * F_58 ( char * V_98 , const char * V_99 , int V_74 )
{
int V_25 ;
while ( * V_99 == ' ' || * V_99 == '\t' )
V_99 ++ ;
if ( * V_99 == '"' || * V_99 == '\'' ) {
V_25 = * V_99 ++ ;
while ( -- V_74 > 0 && * V_99 && * V_99 != V_25 ) {
* V_98 ++ = * V_99 ++ ;
}
if ( * V_99 == V_25 )
V_99 ++ ;
} else {
while ( -- V_74 > 0 && * V_99 && * V_99 != ' ' && * V_99 != '\t' ) {
* V_98 ++ = * V_99 ++ ;
}
}
* V_98 = 0 ;
