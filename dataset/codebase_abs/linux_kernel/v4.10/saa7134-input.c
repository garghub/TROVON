...
V_4 -> V_14 = V_14 ;
V_4 -> V_44 = V_44 ;
snprintf ( V_4 -> V_168 , sizeof( V_4 -> V_168 ) , L_11 ,
V_169 [ V_2 -> V_8 ] . V_168 ) ;
snprintf ( V_4 -> V_170 , sizeof( V_4 -> V_170 ) , L_12 ,
F_45 ( V_2 -> V_171 ) ) ;
V_71 -> V_47 = V_2 ;
V_71 -> V_172 = F_39 ;
V_71 -> V_173 = F_40 ;
...
F_52 ( V_192 . type , L_14 , V_199 ) ;
switch ( V_2 -> V_8 ) {
case V_200 :
case V_201 :
V_2 -> V_198 . V_168 = L_15 ;
if ( V_202 == 0 ) {
