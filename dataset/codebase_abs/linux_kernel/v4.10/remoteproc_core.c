...
{
struct V_10 * V_10 = F_26 ( V_114 , struct V_10 , V_115 ) ;
struct V_5 * V_6 = & V_10 -> V_6 ;
F_7 ( V_6 , L_45 , V_116 ) ;
F_73 ( & V_10 -> V_117 ) ;
if ( V_10 -> V_104 == V_118 || V_10 -> V_104 == V_119 ) {
F_74 ( & V_10 -> V_117 ) ;
return;
}
V_10 -> V_104 = V_118 ;
F_4 ( V_6 , L_46 , ++ V_10 -> V_120 ,
V_10 -> V_67 ) ;
F_74 ( & V_10 -> V_117 ) ;
if ( ! V_10 -> V_121 )
F_69 ( V_10 ) ;
...
V_6 = & V_10 -> V_6 ;
V_14 = F_77 ( & V_10 -> V_117 ) ;
if ( V_14 ) {
F_4 ( V_6 , L_48 , V_10 -> V_67 , V_14 ) ;
return V_14 ;
}
if ( F_78 ( & V_10 -> V_123 ) > 1 ) {
V_14 = 0 ;
goto V_124;
}
F_56 ( V_6 , L_49 , V_10 -> V_67 ) ;
V_14 = F_79 ( & V_122 , V_10 -> V_91 , V_6 ) ;
if ( V_14 < 0 ) {
F_4 ( V_6 , L_50 , V_14 ) ;
goto V_125;
}
V_14 = F_54 ( V_10 , V_122 ) ;
F_64 ( V_122 ) ;
V_125:
if ( V_14 )
F_80 ( & V_10 -> V_123 ) ;
...
if ( V_14 < 0 )
return V_14 ;
F_56 ( V_6 , L_54 , V_10 -> V_67 ) ;
F_90 ( V_10 ) ;
V_14 = F_66 ( V_10 ) ;
if ( V_14 < 0 )
return V_14 ;
F_73 ( & V_129 ) ;
F_91 ( & V_10 -> V_61 , & V_133 ) ;
F_74 ( & V_129 ) ;
return 0 ;
}
...
F_56 ( & V_10 -> V_6 , L_55 , V_10 -> V_67 ) ;
F_93 ( V_10 ) ;
F_94 ( & V_10 -> V_43 ) ;
if ( V_10 -> V_134 >= 0 )
F_95 ( & V_135 , V_10 -> V_134 ) ;
F_35 ( V_10 -> V_91 ) ;
F_35 ( V_10 ) ;
}
struct V_10 * F_96 ( struct V_5 * V_6 , const char * V_67 ,
const struct V_136 * V_24 ,
const char * V_91 , int V_20 )
{
struct V_10 * V_10 ;
char * V_137 , * V_138 = L_56 ;
int V_139 ;
if ( ! V_6 || ! V_67 || ! V_24 )
return NULL ;
if ( ! V_91 ) {
V_139 = strlen ( V_67 ) + strlen ( V_138 ) - 2 + 1 ;
V_137 = F_97 ( V_139 , V_41 ) ;
if ( ! V_137 )
return NULL ;
snprintf ( V_137 , V_139 , V_138 , V_67 ) ;
} else {
V_137 = F_98 ( V_91 , V_41 ) ;
if ( ! V_137 )
return NULL ;
}
...
V_10 -> V_134 = F_100 ( & V_135 , 0 , 0 , V_41 ) ;
if ( V_10 -> V_134 < 0 ) {
F_4 ( V_6 , L_57 , V_10 -> V_134 ) ;
F_101 ( & V_10 -> V_6 ) ;
return NULL ;
}
F_102 ( & V_10 -> V_6 , L_58 , V_10 -> V_134 ) ;
F_103 ( & V_10 -> V_123 , 0 ) ;
V_10 -> V_143 = & V_144 ;
F_104 ( & V_10 -> V_117 ) ;
F_105 ( & V_10 -> V_43 ) ;
...
{
F_110 ( V_10 -> V_6 . V_13 -> V_131 -> V_132 ) ;
F_101 ( & V_10 -> V_6 ) ;
}
int F_111 ( struct V_10 * V_10 )
{
if ( ! V_10 )
return - V_42 ;
F_71 ( & V_10 -> V_109 ) ;
