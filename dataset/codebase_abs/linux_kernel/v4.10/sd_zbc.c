...
unsigned int V_68 = V_67 >> V_2 -> V_66 ;
if ( ! F_16 ( V_2 ) )
return V_40 ;
if ( V_2 -> V_8 -> V_69 )
return V_40 ;
...
int F_32 ( struct V_33 * V_24 )
{
struct V_34 * V_35 = V_24 -> V_34 ;
struct V_1 * V_2 = V_1 ( V_35 -> V_36 ) ;
T_2 V_37 = F_13 ( V_35 ) ;
T_2 V_76 = F_28 ( V_2 ) ;
unsigned int V_68 = F_29 ( V_2 , V_37 ) ;
if ( F_33 ( V_2 -> V_77 -> V_78 ) == V_79 &&
( V_37 & ( V_76 - 1 ) ) + F_34 ( V_35 ) > V_76 )
return V_40 ;
if ( V_2 -> V_70 &&
F_31 ( V_68 , V_2 -> V_70 ) )
return V_71 ;
...
struct V_1 * V_2 = V_1 ( V_35 -> V_36 ) ;
if ( V_2 -> V_70 ) {
unsigned int V_68 = F_29 ( V_2 , F_13 ( V_35 ) ) ;
F_36 ( ! F_37 ( V_68 , V_2 -> V_70 ) ) ;
F_38 ( V_68 , V_2 -> V_70 ) ;
F_39 () ;
}
}
...
unsigned char * V_3 )
{
if ( F_44 ( V_2 -> V_8 , 0xb6 , V_3 , 64 ) ) {
F_8 ( V_89 , V_2 ,
L_3 ) ;
return - V_90 ;
}
if ( V_2 -> V_8 -> type != V_91 ) {
V_2 -> V_92 = 1 ;
V_2 -> V_93 = F_3 ( & V_3 [ 8 ] ) ;
V_2 -> V_94 = F_3 ( & V_3 [ 12 ] ) ;
V_2 -> V_95 = 0 ;
...
T_1 V_104 ;
V_2 -> V_65 = 0 ;
V_3 = F_47 ( V_105 , V_106 ) ;
if ( ! V_3 )
return - V_107 ;
V_39 = F_4 ( V_2 , V_3 , V_105 , 0 ) ;
if ( V_39 ) {
V_65 = 0 ;
goto V_108;
}
...
V_2 -> V_66 = F_52 ( V_2 -> V_65 ) ;
V_2 -> V_64 = V_2 -> V_98 >> V_2 -> V_66 ;
if ( V_2 -> V_98 & ( V_2 -> V_65 - 1 ) )
V_2 -> V_64 ++ ;
if ( ! V_2 -> V_70 ) {
V_2 -> V_70 = F_53 ( F_54 ( V_2 -> V_64 ) ,
