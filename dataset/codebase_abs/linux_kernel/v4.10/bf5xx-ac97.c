...
return 0 ;
#if F_2 ( V_14 )
V_63 = F_31 ( V_28 , 16 , 0x3FF , 0x3FF , 1 ) ;
#else
V_63 = F_31 ( V_28 , 16 , 0x1F , 0x1F , 1 ) ;
#endif
if ( V_63 ) {
F_10 ( L_12 ) ;
return - V_64 ;
...
#endif
V_45 = F_37 ( V_68 , 2 , sizeof( struct V_1 ) ,
V_71 ) ;
if ( ! V_45 ) {
V_63 = - V_72 ;
goto V_73;
...
#if F_2 ( V_14 )
V_63 = F_31 ( V_45 , 16 , 0x3FF , 0x3FF , 1 ) ;
#else
V_63 = F_31 ( V_45 , 16 , 0x1F , 0x1F , 1 ) ;
#endif
if ( V_63 ) {
F_10 ( L_12 ) ;
V_63 = - V_64 ;
...
V_63 = F_38 ( & V_75 ) ;
if ( V_63 != 0 ) {
F_36 ( & V_68 -> V_69 , L_15 , V_63 ) ;
goto V_74;
}
V_63 = F_39 ( & V_68 -> V_69 , & V_76 ,
& V_77 , 1 ) ;
if ( V_63 ) {
F_10 ( L_16 , V_63 ) ;
goto V_74;
