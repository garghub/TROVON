...
static int F_76 ( struct V_1 * V_41 )
{
unsigned int V_29 ;
for ( V_29 = 0 ; V_29 < F_77 ( V_41 -> V_125 ) ; V_29 ++ )
if ( V_41 -> V_126 == V_41 -> V_125 [ V_29 ] )
return V_29 ;
return - 1 ;
}
static void F_78 ( struct V_1 * V_41 , bool V_127 )
{
...
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_79 ( V_129 ) ;
F_80 ( V_129 -> V_131 -> V_30 , V_41 -> V_132 * 2 , V_41 -> V_133 [ 0 ] ,
F_81 ( & V_41 -> V_134 [ 0 ] ) ) ;
F_82 ( V_129 ) ;
if ( V_127 )
F_30 ( V_4 ) ;
}
static void F_83 ( void * V_119 )
{
struct V_1 * V_41 = V_119 ;
struct V_128 * V_129 = V_41 -> V_130 ;
struct V_2 * V_4 = & V_41 -> V_4 ;
...
unsigned long V_120 ;
int V_137 , V_92 = 0 ;
F_58 ( V_4 -> V_30 , L_9 , V_121 , V_4 -> line ,
V_41 -> V_126 ) ;
F_72 ( & V_4 -> V_122 , V_120 ) ;
V_137 = F_76 ( V_41 ) ;
if ( V_137 >= 0 )
...
if ( V_92 )
F_62 ( & V_4 -> V_48 -> V_4 ) ;
V_136 = F_84 ( V_41 -> V_130 , & V_41 -> V_134 [ V_137 ] , 1 ,
V_140 ,
V_141 | V_142 ) ;
if ( ! V_136 )
goto V_143;
...
static void F_88 ( struct V_1 * V_41 , bool V_127 )
{
...
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_79 ( V_129 ) ;
F_89 ( V_129 -> V_131 -> V_30 , V_41 -> V_146 , V_96 ,
V_147 ) ;
F_82 ( V_129 ) ;
if ( V_127 )
F_22 ( V_4 ) ;
}
static void F_90 ( struct V_1 * V_41 )
{
struct V_128 * V_129 = V_41 -> V_130 ;
int V_29 ;
...
V_41 -> V_123 = F_93 (unsigned int,
CIRC_CNT(xmit->head, xmit->tail, UART_XMIT_SIZE),
CIRC_CNT_TO_END(xmit->head, xmit->tail, UART_XMIT_SIZE)) ;
F_94 ( & V_4 -> V_122 ) ;
V_136 = F_95 ( V_129 , V_94 , V_41 -> V_123 ,
V_152 ,
V_141 | V_142 ) ;
if ( ! V_136 ) {
F_87 ( V_4 -> V_30 , L_12 ) ;
...
F_96 ( V_129 -> V_131 -> V_30 , V_94 , V_41 -> V_123 ,
V_147 ) ;
F_92 ( & V_4 -> V_122 ) ;
V_136 -> V_144 = F_71 ;
V_136 -> V_145 = V_41 ;
F_94 ( & V_4 -> V_122 ) ;
V_41 -> V_50 = F_85 ( V_136 ) ;
if ( F_27 ( V_41 -> V_50 ) ) {
F_87 ( V_4 -> V_30 , L_13 ) ;
F_88 ( V_41 , true ) ;
return;
...
static void F_97 ( unsigned long V_119 )
{
...
V_60 = F_98 ( V_41 -> V_130 , V_41 -> V_126 , & V_48 ) ;
if ( V_60 == V_157 ) {
F_73 ( & V_4 -> V_122 , V_120 ) ;
F_58 ( V_4 -> V_30 , L_16 ,
V_41 -> V_126 , V_137 ) ;
...
F_79 ( V_41 -> V_130 ) ;
V_156 = F_100 ( & V_41 -> V_134 [ V_137 ] ) - V_48 . V_158 ;
if ( V_156 ) {
...
if ( V_4 -> type == V_20 || V_4 -> type == V_22 ) {
V_44 &= ~ V_53 ;
F_101 ( V_41 -> V_159 [ V_160 ] ) ;
}
F_25 ( V_4 , V_45 , V_44 | V_38 ) ;
F_73 ( & V_4 -> V_122 , V_120 ) ;
}
static struct V_128 * F_102 ( struct V_2 * V_4 ,
enum V_161 V_162 ,
unsigned int V_163 )
{
T_4 V_54 ;
...
F_103 ( V_54 ) ;
F_104 ( V_166 , V_54 ) ;
V_129 = F_105 ( V_54 , V_167 ,
( void * ) ( unsigned long ) V_163 , V_4 -> V_30 ,
V_162 == V_152 ? L_18 : L_19 ) ;
if ( ! V_129 ) {
F_87 ( V_4 -> V_30 ,
L_20 ) ;
return NULL ;
...
V_165 = F_106 ( V_129 , & V_14 ) ;
if ( V_165 ) {
F_87 ( V_4 -> V_30 , L_21 , V_165 ) ;
F_82 ( V_129 ) ;
return NULL ;
}
return V_129 ;
...
struct V_1 * V_41 = F_1 ( V_4 ) ;
struct V_128 * V_129 ;
F_58 ( V_4 -> V_30 , L_22 , V_121 , V_4 -> line ) ;
if ( ! V_4 -> V_30 -> V_175 &&
( V_41 -> V_14 -> V_176 <= 0 || V_41 -> V_14 -> V_177 <= 0 ) )
return;
V_41 -> V_50 = - V_28 ;
V_129 = F_102 ( V_4 , V_152 , V_41 -> V_14 -> V_176 ) ;
F_58 ( V_4 -> V_30 , L_23 , V_121 , V_129 ) ;
if ( V_129 ) {
V_41 -> V_46 = V_129 ;
V_41 -> V_146 = F_108 ( V_129 -> V_131 -> V_30 ,
V_4 -> V_48 -> V_49 . V_94 ,
V_96 ,
V_147 ) ;
if ( F_109 ( V_129 -> V_131 -> V_30 , V_41 -> V_146 ) ) {
F_87 ( V_4 -> V_30 , L_24 ) ;
F_82 ( V_129 ) ;
V_41 -> V_46 = NULL ;
} else {
...
F_110 ( & V_41 -> V_51 , F_91 ) ;
}
V_129 = F_102 ( V_4 , V_140 , V_41 -> V_14 -> V_177 ) ;
F_58 ( V_4 -> V_30 , L_26 , V_121 , V_129 ) ;
if ( V_129 ) {
unsigned int V_29 ;
T_3 V_178 ;
void * V_94 ;
V_41 -> V_130 = V_129 ;
V_41 -> V_132 = 2 * F_111 ( T_2 , 16 , V_4 -> V_83 ) ;
V_94 = F_112 ( V_129 -> V_131 -> V_30 , V_41 -> V_132 * 2 ,
& V_178 , V_179 ) ;
if ( ! V_94 ) {
F_87 ( V_4 -> V_30 ,
L_27 ) ;
...
F_81 ( V_149 ) = V_178 ;
F_100 ( V_149 ) = V_41 -> V_132 ;
V_94 += V_41 -> V_132 ;
V_178 += V_41 -> V_132 ;
}
F_114 ( & V_41 -> V_138 , F_97 , ( unsigned long ) V_41 ) ;
if ( V_4 -> type == V_20 || V_4 -> type == V_22 )
F_90 ( V_41 ) ;
}
}
...
static inline void F_107 ( struct V_2 * V_4 )
{
}
static inline void F_115 ( struct V_2 * V_4 )
{
}
static T_5 F_116 ( int V_180 , void * V_181 )
{
#ifdef F_23
...
static T_5 F_118 ( int V_180 , void * V_181 )
{
struct V_2 * V_4 = V_181 ;
unsigned long V_120 ;
F_72 ( & V_4 -> V_122 , V_120 ) ;
...
static T_5 F_122 ( int V_180 , void * V_181 )
{
...
! V_41 -> V_46 )
V_165 = F_118 ( V_180 , V_181 ) ;
if ( ( ( V_185 & F_36 ( V_4 ) ) || V_41 -> V_130 ) &&
( V_186 & V_38 ) )
V_165 = F_116 ( V_180 , V_181 ) ;
...
V_136 = V_193 + V_29 ;
V_4 -> V_195 [ V_191 ] = F_126 ( V_179 , L_29 ,
F_127 ( V_190 -> V_30 ) , V_136 -> V_136 ) ;
if ( ! V_4 -> V_195 [ V_191 ] )
goto V_196;
V_165 = F_128 ( V_180 , V_136 -> V_197 , V_190 -> V_198 ,
V_4 -> V_195 [ V_191 ] , V_4 ) ;
if ( F_125 ( V_165 ) ) {
F_129 ( V_190 -> V_30 , L_30 , V_136 -> V_136 ) ;
goto V_199;
}
}
return 0 ;
...
F_58 ( V_41 -> V_4 . V_30 , L_32 , V_226 , V_231 ,
* V_227 + 1 ) ;
return V_231 ;
}
...
( V_291 | V_292 | V_293 ) ;
F_58 ( V_4 -> V_30 , L_37 , V_254 , V_252 ) ;
F_25 ( V_4 , V_45 , V_254 ) ;
F_25 ( V_4 , V_287 , V_252 ) ;
}
...
V_317 = F_177 ( V_30 , L_53 ) ;
if ( F_178 ( V_317 ) == - V_318 )
return - V_318 ;
if ( ! F_179 ( V_317 ) )
goto V_242;
V_317 = F_177 ( V_30 , L_54 ) ;
if ( ! F_179 ( V_317 ) )
goto V_242;
F_129 ( V_30 , L_55 , V_316 [ V_29 ] ,
F_178 ( V_317 ) ) ;
return F_178 ( V_317 ) ;
}
V_242:
if ( F_179 ( V_317 ) )
F_58 ( V_30 , L_55 , V_316 [ V_29 ] ,
F_178 ( V_317 ) ) ;
else
F_58 ( V_30 , L_56 , V_316 [ V_29 ] ,
V_317 , V_317 ) ;
...
for ( V_29 = 0 ; V_29 < F_77 ( V_1 -> V_159 ) ; ++ V_29 )
...
if ( ! V_5 )
return NULL ;
V_163 = F_212 ( V_365 , L_59 ) ;
if ( V_163 < 0 ) {
F_129 ( & V_357 -> V_30 , L_60 , V_163 ) ;
return NULL ;
}
* V_363 = V_163 ;
