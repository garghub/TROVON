...
F_61 ( V_62 ,
L_12 ) ) {
V_60 -> V_54 = F_62 ( F_49 ( V_62 ) , 0 ) ;
if ( ! V_60 -> V_54 )
F_63 ( V_39 , L_13 , V_60 -> V_97 ) ;
}
if ( F_64 ( V_39 ) && V_60 -> V_97 == 0 )
V_60 -> V_54 = F_65 ( F_66 ( V_39 ) , 0 ) ;
V_60 -> V_91 = false ;
V_60 -> V_108 = - 1 ;
}
return V_115 ;
...
if ( ! V_2 -> V_6 )
return - V_100 ;
V_123 = F_71 ( V_121 , V_124 , 0 ) ;
V_2 -> V_8 = F_72 ( & V_121 -> V_39 , V_123 ) ;
if ( F_69 ( V_2 -> V_8 ) )
return F_70 ( V_2 -> V_8 ) ;
...
{
struct V_1 * V_2 = F_75 ( V_121 ) ;
F_52 ( V_2 ) ;
F_42 ( V_2 ) ;
return 0 ;
}
static int F_76 ( struct V_114 * V_39 )
{
struct V_120 * V_121 = F_66 ( V_39 ) ;
struct V_1 * V_2 = F_75 ( V_121 ) ;
struct V_4 * V_5 = & V_2 -> V_6 [ 0 ] . V_5 ;
unsigned long V_36 ;
int V_68 ;
...
static int F_78 ( struct V_114 * V_39 )
{
struct V_120 * V_121 = F_66 ( V_39 ) ;
struct V_1 * V_2 = F_75 ( V_121 ) ;
struct V_4 * V_5 = & V_2 -> V_6 [ 0 ] . V_5 ;
