...
long V_151 ;
V_8 -> V_70 = 1 + ( ( V_147 [ 0 ] << 24 ) | ( V_147 [ 1 ] << 16 ) |
( V_147 [ 2 ] << 8 ) | V_147 [ 3 ] ) ;
if ( ! F_78 ( & V_8 -> V_39 , & V_151 ) )
V_8 -> V_70 = F_79 ( long , V_8 -> V_70 , V_151 ) ;
V_69 = ( V_147 [ 4 ] << 24 ) |
( V_147 [ 5 ] << 16 ) | ( V_147 [ 6 ] << 8 ) | V_147 [ 7 ] ;
switch ( V_69 ) {
case 0 :
case 2340 :
case 2352 :
...
V_147 = F_81 ( 512 , V_119 | V_157 ) ;
if ( ! V_147 ) {
F_19 ( V_78 , V_8 , L_23 ) ;
return;
}
F_17 ( V_8 -> V_6 , V_28 , V_29 , & V_25 ) ;
V_154 = F_82 ( V_8 -> V_6 , 0 , 0x2a , V_147 , 128 ,
V_28 , 3 , & V_153 , NULL ) ;
if ( ! F_18 ( V_154 ) ) {
V_8 -> V_39 . V_158 = 1 ;
V_8 -> V_39 . V_141 |= ( V_159 | V_160 | V_161 |
V_162 | V_163 |
V_164 | V_165 |
V_166 | V_167 | V_168 ) ;
F_77 ( V_147 ) ;
...
V_155 = V_153 . V_169 + V_153 . V_170 ;
V_8 -> V_39 . V_158 = ( ( V_147 [ V_155 + 8 ] << 8 ) + V_147 [ V_155 + 9 ] ) / 176 ;
V_8 -> V_137 = 1 ;
V_8 -> V_138 = V_147 [ V_155 + 5 ] & 0x01 ;
F_19 ( V_63 , V_8 ,
L_25 ,
( ( V_147 [ V_155 + 14 ] << 8 ) + V_147 [ V_155 + 15 ] ) / 176 ,
V_8 -> V_39 . V_158 ,
V_147 [ V_155 + 3 ] & 0x01 ? L_26 : L_20 ,
V_147 [ V_155 + 3 ] & 0x20 ? L_27 : L_20 ,
V_147 [ V_155 + 2 ] & 0x02 ? L_28 : L_20 ,
V_147 [ V_155 + 4 ] & 0x20 ? L_29 : L_20 ,
V_147 [ V_155 + 5 ] & 0x01 ? L_30 : L_20 ,
V_156 [ V_147 [ V_155 + 6 ] >> 5 ] ) ;
if ( ( V_147 [ V_155 + 6 ] >> 5 ) == 0 )
V_8 -> V_39 . V_141 |= V_171 ;
if ( ( V_147 [ V_155 + 2 ] & 0x8 ) == 0 )
V_8 -> V_39 . V_141 |= V_162 ;
if ( ( V_147 [ V_155 + 3 ] & 0x20 ) == 0 )
V_8 -> V_39 . V_141 |= V_163 ;
if ( ( V_147 [ V_155 + 3 ] & 0x10 ) == 0 )
V_8 -> V_39 . V_141 |= V_161 ;
if ( ( V_147 [ V_155 + 3 ] & 0x2 ) == 0 )
V_8 -> V_39 . V_141 |= V_160 ;
if ( ( V_147 [ V_155 + 3 ] & 0x1 ) == 0 )
V_8 -> V_39 . V_141 |= V_159 ;
if ( ( V_147 [ V_155 + 6 ] & 0x8 ) == 0 )
V_8 -> V_39 . V_141 |= V_172 ;
if ( ( V_147 [ V_155 + 6 ] >> 5 ) == V_173 ||
( V_147 [ V_155 + 6 ] >> 5 ) == V_174 )
V_8 -> V_39 . V_70 =
F_83 ( & V_8 -> V_39 ) ;
if ( V_8 -> V_39 . V_70 <= 1 )
V_8 -> V_39 . V_141 |= V_164 ;
if ( ( V_8 -> V_39 . V_141 & ( V_163 | V_167 | V_168 | V_160 ) ) !=
( V_163 | V_167 | V_168 | V_160 ) ) {
V_8 -> V_80 = 1 ;
}
F_77 ( V_147 ) ;
}
...
struct V_1 * V_8 = V_39 -> V_42 ;
struct V_15 * V_16 = V_8 -> V_6 ;
if ( V_176 -> V_18 [ 0 ] == V_177 && V_16 -> V_178 )
return - V_179 ;
if ( V_176 -> V_180 <= 0 )
V_176 -> V_180 = V_181 ;
F_85 ( V_8 , V_176 ) ;
...
{
int V_154 ;
V_154 = F_93 ( V_126 , L_31 ) ;
if ( V_154 )
return V_154 ;
V_154 = F_94 ( & V_135 . V_183 ) ;
if ( V_154 )
F_95 ( V_126 , L_31 ) ;
return V_154 ;
}
