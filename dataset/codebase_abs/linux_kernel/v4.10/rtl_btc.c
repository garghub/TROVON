...
{
T_1 V_33 ;
if ( V_2 -> V_34 . V_35 . V_3 == V_36 )
V_33 = 2 ;
else
V_33 = 1 ;
return V_33 ;
}
enum V_17 F_39 ( struct V_37 * V_38 )
{
struct V_1 * V_2 = V_1 ( V_38 ) ;
struct V_39 * V_40 = V_39 ( V_1 ( V_38 ) ) ;
enum V_17 V_41 = V_42 ;
T_1 V_43 = ( V_40 -> V_44 == V_45 ) ? 1 : 0 ;
if ( V_43 || V_2 -> V_46 . V_47 >= V_48 )
V_41 = V_49 ;
return V_41 ;
}
T_1 F_6 ( struct V_1 * V_2 )
{
return V_2 -> V_34 . V_35 . V_34 ;
}
T_1 F_8 ( struct V_1 * V_2 )
{
return V_2 -> V_34 . V_35 . V_5 ;
}
