...
if ( V_25 -> string [ V_25 -> V_27 - 4 ] != V_20 )
return;
...
return;
F_44 ( & V_2 -> V_53 -> V_33 , & V_2 -> V_76 ) ;
V_2 -> V_34 ++ ;
F_10 ( V_2 ) ;
}
static inline void
F_45 ( struct V_1 * V_2 , unsigned char V_77 )
{
V_2 -> V_53 -> string [ V_2 -> V_53 -> V_27 ++ ] =
V_2 -> V_9 . V_10 [ ( V_77 < ' ' ) ? ' ' : V_77 ] ;
...
if ( V_2 -> V_53 -> V_27 < V_2 -> V_9 . V_23 - 5 ) {
...
static void
F_47 ( struct V_78 * V_79 , const char * V_6 , unsigned int V_74 )
{
struct V_1 * V_2 ;
unsigned long V_42 ;
unsigned char V_77 ;
...
static struct V_82 *
F_49 ( struct V_78 * V_77 , int * V_83 )
{
* V_83 = V_77 -> V_83 ;
return V_84 ;
}
...
if ( F_59 ( V_90 ) )
return F_60 ( V_90 ) ;
V_80 = F_61 ( sizeof( struct V_1 ) , V_96 | V_97 ) ;
if ( ! V_80 )
return - V_98 ;
V_80 -> V_9 . V_22 = V_90 ;
V_80 -> V_61 = F_62 ( 0 ) ;
...
F_63 ( & V_80 -> V_76 ) ;
F_63 ( & V_80 -> V_29 ) ;
F_64 ( & V_80 -> V_4 , ( void (*) ( unsigned long ) ) F_23 ,
( unsigned long ) V_80 ) ;
F_65 ( & V_80 -> V_62 ,
( void (*) ( unsigned long ) ) F_31 ,
( unsigned long ) V_80 -> V_61 ) ;
F_66 ( & V_80 -> V_9 , & V_100 , 1 ) ;
F_63 ( & V_80 -> V_21 ) ;
for ( V_92 = 0 ; V_92 < V_101 ; V_92 ++ ) {
V_91 = ( void * ) F_67 ( V_96 | V_97 ) ;
F_68 ( & V_80 -> V_21 , V_91 , V_102 ) ;
}
V_80 -> V_53 = F_7 ( & V_80 -> V_21 , V_80 -> V_9 . V_23 ) ;
V_80 -> V_53 -> V_27 = 0 ;
F_6 ( V_80 ) ;
V_80 -> V_59 = F_7 ( & V_80 -> V_21 , 80 ) ;
F_69 ( & V_103 , & V_104 ) ;
F_70 ( & V_105 ) ;
F_71 ( & V_1 ) ;
return 0 ;
