...
V_65 -> V_106 = & V_107 ;
if ( V_9 -> V_81 > 0 ) {
V_2 -> V_89 = F_49 ( L_15 , V_65 -> V_103 ,
V_65 -> V_94 ) ;
if ( ! V_2 -> V_89 ) {
V_5 = - V_95 ;
goto V_99;
}
V_5 = F_50 ( & V_9 -> V_11 , V_9 -> V_81 ,
V_108 , V_109 ,
L_16 , V_2 -> V_89 ) ;
if ( V_5 ) {
F_3 ( & V_9 -> V_11 , L_17 ) ;
...
static int F_59 ( struct V_92 * V_9 )
{
struct V_64 * V_65 = F_60 ( V_9 ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
F_61 ( V_65 ) ;
F_56 ( V_65 ) ;
if ( V_2 -> V_89 ) {
...
static int F_62 ( struct V_61 * V_11 )
{
struct V_64 * V_65 = F_60 ( F_63 ( V_11 ) ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
int V_5 ;
F_30 ( & V_2 -> V_69 ) ;
V_5 = F_10 ( V_2 , true ) ;
...
static int F_64 ( struct V_61 * V_11 )
{
struct V_64 * V_65 = F_60 ( F_63 ( V_11 ) ) ;
struct V_1 * V_2 = F_25 ( V_65 ) ;
int V_5 ;
