...
static int F_34 ( struct V_205 * V_206 , int V_259 , int V_142 ,
...
struct V_262 V_263 ;
int V_185 ;
if ( V_142 == V_134 -> V_264 && V_260 == V_134 -> V_265 &&
V_261 == V_134 -> V_266 )
return 0 ;
if ( ! V_260 || ! V_261 ) {
F_30 ( V_2 -> V_5 , L_9 ) ;
...
V_185 = F_35 ( V_260 , V_261 , & V_263 ) ;
if ( V_185 < 0 ) {
F_11 ( V_2 -> V_5 , L_11 , V_260 ) ;
return V_185 ;
}
F_30 ( V_2 -> V_5 , L_12 ,
V_263 . V_274 , ( V_263 . V_274 ? 0 : V_263 . V_275 ) ,
V_263 . V_276 , V_263 . V_277 ) ;
F_2 ( V_2 , V_80 ,
V_263 . V_276 << V_278 | V_263 . V_277 ) ;
F_2 ( V_2 , V_81 ,
( V_263 . V_274 ? 0 : V_263 . V_275 ) << V_279 |
V_263 . V_274 << V_280 ) ;
V_134 -> V_265 = V_260 ;
V_134 -> V_266 = V_261 ;
V_134 -> V_264 = V_142 ;
...
{
struct V_328 * V_132 = F_44 ( V_2 ) ;
struct V_133 * V_134 = F_8 ( V_2 ) ;
V_134 -> V_285 = F_45 ( V_2 -> V_5 , L_13 ) ;
if ( F_46 ( V_134 -> V_285 ) == - V_329 )
return - V_329 ;
V_134 -> V_2 = V_2 ;
F_47 ( V_2 , V_287 ) ;
...
if ( V_134 -> V_340 . V_341 )
F_41 ( V_2 , V_134 -> V_340 . V_292 ,
V_134 -> V_340 . V_293 ) ;
return 0 ;
}
...
F_54 ( V_134 -> V_138 ) ;
if ( F_55 ( V_134 -> V_340 . V_342 ) )
F_56 ( V_134 -> V_340 . V_342 , 0 ) ;
return 0 ;
}
...
static int F_60 ( struct V_133 * V_134 , struct V_343 * V_344 )
{
V_134 -> V_340 . V_345 = F_61 ( V_344 ,
L_15 ) ;
V_134 -> V_340 . V_346 = F_61 ( V_344 ,
L_16 ) ;
V_134 -> V_340 . V_342 = F_62 ( V_344 ,
L_17 , 0 ) ;
if ( ! F_55 ( V_134 -> V_340 . V_342 ) &&
( V_134 -> V_340 . V_342 != - V_347 ) )
return V_134 -> V_340 . V_342 ;
return 0 ;
}
static int F_63 ( struct V_348 * V_349 ,
const struct V_350 * V_215 )
{
struct V_351 * V_340 = F_64 ( & V_349 -> V_5 ) ;
struct V_133 * V_134 ;
int V_185 ;
unsigned int V_144 ;
V_134 = F_65 ( & V_349 -> V_5 ,
sizeof( struct V_133 ) ,
V_352 ) ;
if ( NULL == V_134 )
return - V_353 ;
...
if ( V_340 ) {
V_134 -> V_340 = * V_340 ;
if ( ! V_134 -> V_340 . V_342 )
V_134 -> V_340 . V_342 = - V_186 ;
} else if ( V_349 -> V_5 . V_354 ) {
V_185 = F_60 ( V_134 , V_349 -> V_5 . V_354 ) ;
if ( V_185 )
return V_185 ;
} else
V_134 -> V_340 . V_342 = - V_186 ;
V_134 -> V_138 = F_67 ( V_349 , & V_355 ) ;
if ( F_37 ( V_134 -> V_138 ) ) {
...
if ( F_55 ( V_134 -> V_340 . V_342 ) ) {
V_185 = F_68 ( & V_349 -> V_5 , V_134 -> V_340 . V_342 ,
V_356 ,
L_19 ) ;
if ( V_185 < 0 ) {
F_11 ( & V_349 -> V_5 , L_20 ,
V_134 -> V_340 . V_342 , V_185 ) ;
return V_185 ;
}
F_58 ( 400 ) ;
}
...
V_185 = F_70 ( V_134 -> V_138 , V_358 ,
F_4 ( V_358 ) ) ;
if ( V_185 != 0 )
F_71 ( & V_349 -> V_5 , L_22 , V_185 ) ;
F_17 ( V_134 -> V_138 , V_124 ,
V_359 , V_359 ) ;
if ( V_134 -> V_340 . V_345 )
F_17 ( V_134 -> V_138 , V_32 ,
V_360 , V_360 ) ;
if ( V_134 -> V_340 . V_346 )
F_17 ( V_134 -> V_138 , V_33 ,
V_361 , V_361 ) ;
if ( V_134 -> V_340 . V_362 )
F_17 ( V_134 -> V_138 , V_32 ,
V_361 , V_361 ) ;
V_134 -> V_179 = 1 ;
return F_72 ( & V_349 -> V_5 , & V_363 ,
V_364 , F_4 ( V_364 ) ) ;
}
static int F_73 ( struct V_348 * V_349 )
{
F_74 ( & V_349 -> V_5 ) ;
return 0 ;
}
