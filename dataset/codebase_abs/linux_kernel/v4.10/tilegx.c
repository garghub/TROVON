...
F_83 ( & V_15 -> V_164 ) ;
V_15 -> V_163 = V_171 ;
V_15 -> V_172 = F_84 ( & V_15 -> V_163 , NULL ) ;
if ( F_85 ( V_15 -> V_172 ) )
F_86 ( V_2 , L_7 ,
F_87 ( V_15 -> V_172 ) ) ;
}
...
if ( ! V_174 )
F_100 ( F_91 ,
( void * ) ( long ) ( V_15 -> V_179 ) , 1 ) ;
F_101 (cpu) {
struct V_30 * V_31 = & F_63 ( V_32 , V_175 ) ;
if ( ! V_31 -> V_34 [ V_5 ] . V_35 )
continue;
if ( V_174 ) {
if ( ! V_31 -> V_34 [ V_5 ] . V_180 ) {
F_102 ( V_2 , & V_31 -> V_34 [ V_5 ] . V_92 ,
F_52 , V_181 ) ;
V_31 -> V_34 [ V_5 ] . V_180 = true ;
}
if ( ! V_31 -> V_34 [ V_5 ] . V_182 ) {
F_103 ( & V_31 -> V_34 [ V_5 ] . V_92 ) ;
V_31 -> V_34 [ V_5 ] . V_182 = true ;
}
} else {
if ( V_31 -> V_34 [ V_5 ] . V_182 ) {
F_104 ( & V_31 -> V_34 [ V_5 ] . V_92 ) ;
V_31 -> V_34 [ V_5 ] . V_182 = false ;
}
}
}
if ( V_174 )
...
int V_186 = V_15 -> V_25 + V_13 ;
void * V_26 ;
int V_115 , V_6 ;
V_15 -> V_187 [ V_13 ] =
F_109 ( V_185 , 64 * 1024 ) ;
V_26 = F_110 ( V_15 -> V_187 [ V_13 ] , V_188 ) ;
if ( V_26 == NULL ) {
F_86 ( V_2 ,
L_9 ,
V_15 -> V_187 [ V_13 ] , V_13 ) ;
return - V_189 ;
}
V_6 = F_111 ( & V_15 -> V_24 , V_186 ,
V_17 [ V_13 ] , V_26 ,
V_15 -> V_187 [ V_13 ] , 0 ) ;
if ( V_6 != 0 ) {
F_86 ( V_2 , L_10 ,
V_5 , V_6 ) ;
F_112 ( V_26 , V_15 -> V_187 [ V_13 ] ) ;
return V_6 ;
}
V_15 -> V_190 [ V_13 ] = V_26 ;
V_6 = F_113 ( & V_15 -> V_24 , V_186 ,
V_184 , 0 ) ;
if ( V_6 != 0 ) {
F_86 ( V_2 ,
L_11 ,
...
int V_191 )
{
int V_192 = V_36 - ( V_193 == 0 ) ;
T_2 V_183 ;
int V_6 ;
int V_5 = F_1 ( V_2 ) ;
struct V_14 * V_15 = & V_14 [ V_5 ] ;
V_6 = F_115 ( & V_15 -> V_24 , V_192 , 0 , 0 ) ;
if ( V_6 < 0 ) {
F_86 ( V_2 ,
L_13 ,
V_5 , V_6 ) ;
...
V_191 * ( V_194 + V_119 ) ;
if ( V_6 >= 0 )
V_6 = F_106 ( V_2 , 0 , V_183 ) ;
if ( V_6 >= 0 )
V_6 = F_106 ( V_2 , 1 , V_183 ) ;
if ( V_6 >= 0 && V_193 != 0 )
V_6 = F_106 ( V_2 , 2 , V_193 ) ;
return V_6 ;
}
...
V_15 -> V_177 = 16 ;
V_6 = F_125 ( & V_15 -> V_24 , V_15 -> V_177 , 0 , 0 ) ;
if ( V_6 < 0 ) {
F_86 ( V_2 , L_18 ,
V_5 , V_6 ) ;
return V_6 ;
...
F_137 ( ( unsigned long ) ( V_31 -> V_34 [ V_5 ] . V_111 . V_203 ) ,
F_117 ( V_198 ) ) ;
V_31 -> V_34 [ V_5 ] . V_111 . V_203 = NULL ;
}
for ( V_13 = 0 ; V_13 < V_36 ; V_13 ++ ) {
if ( V_15 -> V_190 [ V_13 ] != NULL ) {
F_112 ( V_15 -> V_190 [ V_13 ] ,
V_15 -> V_187 [ V_13 ] ) ;
V_15 -> V_190 [ V_13 ] = NULL ;
}
}
V_15 -> V_25 = - 1 ;
V_15 -> V_176 = - 1 ;
...
V_120 = V_204 ;
F_101 (cpu) {
V_6 = F_116 ( V_2 , V_175 , V_120 ) ;
if ( V_6 < 0 )
goto V_206;
V_120 = V_6 ;
}
V_6 = F_123 ( V_2 , V_204 , V_191 ) ;
if ( V_6 != 0 )
goto V_206;
V_6 = F_127 ( V_2 ) ;
if ( V_6 != 0 )
...
V_6 = F_145 ( V_125 , & V_15 -> V_24 , V_207 , V_141 ,
V_211 , V_216 , 0 ) ;
if ( V_6 != 0 ) {
F_86 ( V_2 , L_31 ,
V_5 , V_6 ) ;
...
int V_5 = F_1 ( V_2 ) ;
struct V_14 * V_15 = & V_14 [ V_5 ] ;
int V_6 = F_149 ( V_223 , & V_15 -> V_24 , V_224 , 0 ) ;
if ( V_6 < 0 ) {
F_86 ( V_2 , L_34 ,
V_224 , V_5 , V_6 ) ;
return V_6 ;
...
V_6 = F_148 ( V_2 , & V_4 -> V_223 , L_37 ) ;
if ( V_6 < 0 )
goto V_206;
V_4 -> V_98 = V_6 ;
V_6 = F_148 ( V_2 , & V_4 -> V_231 , L_38 ) ;
if ( V_6 < 0 )
goto V_206;
V_4 -> V_232 = V_6 ;
V_4 -> V_141 = V_6 ;
} else {
V_6 = F_148 ( V_2 , & V_4 -> V_223 , V_2 -> V_228 ) ;
if ( V_6 < 0 )
goto V_206;
V_4 -> V_98 = V_6 ;
V_4 -> V_141 = V_6 ;
...
{
struct V_48 * V_241 = F_34 ( V_21 ) ;
unsigned int V_242 = F_166 ( V_21 ) + F_167 ( V_21 ) ;
unsigned int V_243 = V_21 -> V_22 - V_242 ;
unsigned int V_244 = V_241 -> V_245 ;
long V_246 = - 1 ;
long V_247 = F_168 ( V_21 ) - V_242 ;
long V_248 = 0 ;
long V_116 ;
int V_239 = 0 ;
int V_249 ;
...
static void F_170 ( struct V_20 * V_21 , unsigned char * V_212 ,
T_9 V_240 )
{
struct V_48 * V_241 = F_34 ( V_21 ) ;
struct V_253 * V_254 ;
...
V_260 = F_166 ( V_21 ) ;
V_244 = V_241 -> V_245 ;
V_262 = V_258 -> V_266 + ( 0xFFFF ^ F_177 ( V_21 -> V_22 ) ) ;
V_263 = F_178 ( V_258 -> V_263 ) ;
for ( V_249 = 0 ; V_249 < V_241 -> V_250 ; V_249 ++ ) {
unsigned char * V_83 ;
unsigned int V_251 = 0 ;
V_83 = V_212 + ( V_240 % V_217 ) * V_218 +
V_109 ;
memcpy ( V_83 , V_23 , V_242 ) ;
if ( V_265 ) {
V_256 = (struct V_255 * ) ( V_83 + V_259 ) ;
V_256 -> V_268 = F_177 ( V_242 + V_244 - V_259 -
sizeof( * V_256 ) ) ;
} else {
V_254 = (struct V_253 * ) ( V_83 + V_259 ) ;
V_254 -> V_267 = F_177 ( V_242 + V_244 - V_259 ) ;
V_254 -> V_122 = F_177 ( V_122 ++ ) ;
V_254 -> V_266 = F_179 ( V_261 + V_254 -> V_267 +
V_254 -> V_122 ) ^ 0xffff ;
}
V_258 = (struct V_257 * ) ( V_83 + V_260 ) ;
...
struct V_20 * V_21 , unsigned char * V_212 , T_9 V_240 )
{
struct V_48 * V_241 = F_34 ( V_21 ) ;
int V_5 = F_1 ( V_2 ) ;
struct V_14 * V_15 = & V_14 [ V_5 ] ;
...
V_271 . V_277 = 1 ;
V_271 . V_276 = V_276 ;
V_271 . V_278 = V_276 + V_21 -> V_279 ;
V_271 . V_280 = V_242 ;
V_271 . V_186 = V_15 -> V_25 ;
V_272 . V_186 = V_15 -> V_25 ;
for ( V_249 = 0 ; V_249 < V_241 -> V_250 ; V_249 ++ ) {
unsigned char * V_83 ;
unsigned int V_251 = 0 ;
V_83 = V_212 + ( V_240 % V_217 ) * V_218 +
V_109 ;
V_271 . V_26 = F_19 ( V_83 ) ;
...
V_239 = F_165 ( V_21 ) ;
F_69 ( V_152 ) ;
V_240 = F_163 ( V_2 , V_21 -> V_282 , V_127 ,
V_125 , V_239 ) ;
if ( V_240 < 0 ) {
F_70 ( V_152 ) ;
return V_283 ;
}
F_170 ( V_21 , V_156 -> V_212 , V_240 ) ;
F_181 ( V_2 , V_125 , V_21 , V_156 -> V_212 , V_240 ) ;
F_61 ( V_125 , V_127 , V_240 + V_239 - 1 , V_21 ) ;
F_70 ( V_152 ) ;
F_67 () ;
return V_284 ;
}
...
V_239 = F_185 ( V_252 , V_21 , V_23 , F_168 ( V_21 ) ) ;
V_291 . V_186 = V_15 -> V_25 ;
for ( V_115 = 0 ; V_115 < V_239 ; V_115 ++ ) {
V_291 . V_280 = V_252 [ V_115 ] . V_288 ;
V_291 . V_26 = F_19 ( V_252 [ V_115 ] . V_83 ) ;
V_211 [ V_115 ] = V_291 ;
}
V_211 [ V_239 - 1 ] . V_281 = 1 ;
if ( V_21 -> V_90 == V_292 ) {
unsigned int V_276 = F_182 ( V_21 ) ;
V_211 [ 0 ] . V_277 = 1 ;
V_211 [ 0 ] . V_276 = V_276 ;
V_211 [ 0 ] . V_278 = V_276 + V_21 -> V_279 ;
}
F_69 ( V_152 ) ;
V_240 = F_163 ( V_2 , V_21 -> V_282 , V_127 ,
V_125 , V_239 ) ;
...
static int F_192 ( struct V_1 * V_2 , struct V_57 * V_58 , int V_295 )
{
if ( V_295 == V_296 )
...
static int F_193 ( struct V_1 * V_2 , void * V_298 )
{
struct V_299 * V_29 = V_298 ;
if ( ! F_194 ( V_29 -> V_300 ) )
return - V_64 ;
memcpy ( V_2 -> V_86 , V_29 -> V_300 , V_2 -> V_301 ) ;
return 0 ;
}
...
static void F_198 ( const char * V_228 , const T_5 * V_319 )
{
int V_162 ;
struct V_1 * V_2 ;
struct V_3 * V_4 ;
...
return;
V_2 = F_199 ( sizeof( * V_4 ) , V_228 , V_320 ,
F_196 , V_321 , 1 ) ;
if ( ! V_2 ) {
F_200 ( L_42 , V_228 ) ;
return;
...
V_31 -> V_38 = V_38 ;
F_155 ( & V_31 -> V_150 , V_233 , V_234 ) ;
V_31 -> V_150 . V_235 = F_68 ;
}
...
F_83 ( & V_227 ) ;
F_100 ( F_206 , NULL , 1 ) ;
for ( V_115 = 0 ; F_208 ( V_115 , V_228 , V_319 ) >= 0 ; V_115 ++ )
F_198 ( V_228 , V_319 ) ;
if ( ! F_3 () )
F_6 ( & V_8 , F_209 () ,
V_324 ) ;
