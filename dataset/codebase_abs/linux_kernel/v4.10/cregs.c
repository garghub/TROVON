...
V_18 = V_72 ? V_55 : V_19 ;
do {
V_73 = F_49 (unsigned int, size8, MAX_CREG_DATA8) ;
V_14 = F_44 ( V_2 , V_18 , V_15 , V_73 ,
V_7 , V_5 , & V_67 ) ;
if ( V_14 )
return V_14 ;
V_7 = ( char * ) V_7 + V_73 ;
...
int V_74 )
{
return F_48 ( V_2 , V_15 , V_71 , V_7 , V_74 , 0 ) ;
}
...
int V_74 )
{
return F_48 ( V_2 , V_15 , V_71 , V_7 , V_74 , 1 ) ;
}
int F_52 ( struct V_1 * V_2 , unsigned int * V_75 )
{
return F_51 ( V_2 , V_76 ,
sizeof( * V_75 ) , V_75 , 0 ) ;
}
int F_53 ( struct V_1 * V_2 , T_3 * V_71 )
{
unsigned int V_77 ;
int V_14 ;
V_14 = F_51 ( V_2 , V_78 ,
...
unsigned int * V_80 )
{
return F_51 ( V_2 , V_81 ,
sizeof( * V_80 ) , V_80 , 0 ) ;
}
int F_55 ( struct V_1 * V_2 ,
T_1 * V_82 )
{
return F_51 ( V_2 , V_83 ,
sizeof( * V_82 ) , V_82 , 0 ) ;
}
int F_56 ( struct V_1 * V_2 , T_1 V_13 )
{
return F_50 ( V_2 , V_84 ,
sizeof( V_13 ) , & V_13 , 0 ) ;
}
static void F_57 ( struct V_1 * V_2 , const char * V_85 , int V_86 )
{
static char V_87 ;
if ( ( V_86 > 3 ) && ( V_85 [ 0 ] == '<' ) && ( V_85 [ 2 ] == '>' ) ) {
V_87 = V_85 [ 1 ] ;
V_85 += 3 ;
V_86 -= 3 ;
}
switch ( V_87 ) {
case '0' :
F_58 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
case '1' :
F_59 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
case '2' :
F_47 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
case '3' :
F_31 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
case '4' :
F_25 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
case '5' :
F_60 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
case '6' :
F_61 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
case '7' :
F_62 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
default:
F_61 ( F_26 ( V_2 ) , L_9 , V_86 , V_85 ) ;
break;
...
static int F_63 ( char * V_88 , const char * V_89 , int V_90 )
{
int V_91 = V_90 ;
while ( V_90 ) {
V_90 -- ;
...
return;
while ( V_94 < V_13 -> V_3 ) {
V_92 = & V_2 -> log . V_4 [ V_2 -> log . V_95 ] ;
V_93 = F_65 ( V_13 -> V_3 - V_94 , V_96 - V_2 -> log . V_95 ) ;
V_86 = F_63 ( V_92 , & V_4 [ V_94 ] , V_93 ) ;
V_94 += V_86 ;
V_2 -> log . V_95 += V_86 ;
if ( ( V_92 [ V_86 - 1 ] == '\0' ) ||
( V_2 -> log . V_95 == V_96 ) ) {
...
int V_72 )
{
unsigned int V_18 = V_72 ? V_55 : V_19 ;
return F_44 ( V_2 , V_18 , V_13 -> V_15 , V_13 -> V_93 , V_13 -> V_7 ,
V_13 -> V_5 , & V_13 -> V_50 ) ;
}
...
struct V_99 V_13 ;
int V_14 ;
V_14 = F_68 ( & V_13 , V_100 , sizeof( V_13 ) ) ;
if ( V_14 )
return - V_101 ;
if ( V_13 . V_93 > V_102 )
return - V_101 ;
V_14 = F_67 ( V_2 , & V_13 , V_72 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_69 ( V_13 . V_50 , & V_100 -> V_50 ) ;
if ( V_14 )
return - V_101 ;
if ( V_72 ) {
V_14 = F_70 ( V_100 -> V_7 , V_13 . V_7 , V_13 . V_93 ) ;
if ( V_14 )
return - V_101 ;
}
return 0 ;
...
if ( ! V_2 -> V_21 . V_103 )
return - V_39 ;
F_76 ( & V_2 -> V_21 . V_48 , F_28 ) ;
F_77 ( & V_2 -> V_21 . V_58 ) ;
F_18 ( & V_2 -> V_21 . V_23 ) ;
F_78 ( & V_2 -> V_21 . V_42 ) ;
F_79 ( & V_2 -> V_21 . V_27 , F_22 ,
( unsigned long ) V_2 ) ;
return 0 ;
}
