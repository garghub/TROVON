...
static void F_45 ( struct V_48 * V_24 )
{
if ( ! V_24 -> V_54 || V_24 -> V_54 -> V_103 != & V_70 )
return;
F_46 ( V_24 ) ;
...
static struct V_101 * F_48 ( struct V_48 * V_24 )
{
struct V_6 * V_7 = V_24 -> V_54 -> V_90 ;
if ( ! V_7 )
return F_49 ( - V_91 ) ;
...
static int F_52 ( struct V_48 * V_24 , struct V_105 * args )
{
struct V_106 * V_107 ;
if ( args -> V_108 != 1 ) {
F_24 ( V_24 , L_11 ,
...
if ( ! V_24 -> V_54 -> V_90 ) {
V_107 = F_53 ( args -> V_109 ) ;
if ( F_54 ( ! V_107 ) )
return - V_80 ;
V_24 -> V_54 -> V_90 = F_55 ( V_107 ) ;
}
return F_56 ( V_24 , args -> args , 1 ) ;
}
...
V_124 |
V_125 ;
F_4 ( V_29 , V_7 -> V_10 + V_126 ) ;
F_4 ( F_60 ( V_7 -> V_127 , V_7 -> V_76 ) ,
V_7 -> V_10 + V_128 ) ;
F_4 ( 0 , V_7 -> V_10 + V_129 ) ;
F_4 ( 0 , V_7 -> V_10 + V_130 ) ;
if ( F_61 ( V_7 -> V_24 , V_7 -> V_25 , F_10 , 0 ,
F_62 ( V_7 -> V_24 ) , ( void * ) V_7 ) ) {
F_4 ( 0 , V_7 -> V_10 + V_83 ) ;
F_63 ( V_7 -> V_110 ) ;
...
static int F_64 ( struct V_106 * V_131 )
{
struct V_6 * V_7 ;
struct V_48 * V_24 = & V_131 -> V_24 ;
struct V_132 * V_133 ;
struct V_134 * V_135 = NULL ;
void * V_136 ;
int V_56 , V_137 , V_21 ;
V_7 = F_65 ( V_24 , sizeof( * V_7 ) , V_85 ) ;
if ( ! V_7 )
return - V_138 ;
V_7 -> V_24 = V_24 ;
V_136 = F_65 ( V_24 , V_139 * 2 , V_85 ) ;
if ( ! V_136 )
return - V_138 ;
V_7 -> V_127 = F_66 ( F_67 ( V_136 ) , V_139 ) ;
V_7 -> V_76 = ! ! ( V_140 > ( 0xffffffffUL >> V_141 ) ) ;
V_133 = F_68 ( V_131 , V_142 , 0 ) ;
V_7 -> V_10 = F_69 ( V_24 , V_133 ) ;
if ( F_42 ( V_7 -> V_10 ) )
return F_43 ( V_7 -> V_10 ) ;
V_7 -> V_25 = F_70 ( V_131 , 0 ) ;
if ( V_7 -> V_25 < 0 )
return V_7 -> V_25 ;
V_7 -> V_110 = F_71 ( V_24 , L_14 ) ;
if ( F_42 ( V_7 -> V_110 ) )
return F_43 ( V_7 -> V_110 ) ;
V_137 = F_72 ( V_24 -> V_143 ,
L_15 , NULL ) ;
if ( V_137 < 0 )
return V_137 ;
V_7 -> V_59 . V_137 = V_137 ;
for ( V_56 = 0 ; V_56 < V_137 ; V_56 ++ ) {
struct V_144 * V_145 ;
struct V_106 * V_146 ;
V_145 = F_73 ( V_24 -> V_143 , L_15 , V_56 ) ;
if ( ! V_145 )
return - V_80 ;
if ( ! F_74 ( V_145 ) )
continue;
...
V_7 -> V_59 . V_60 [ V_56 ] . V_24 = & V_146 -> V_24 ;
F_77 ( V_24 , & V_135 , V_150 ,
V_151 , V_145 ) ;
}
F_78 ( V_131 , V_7 ) ;
V_21 = F_57 ( V_7 ) ;
...
if ( ! F_79 ( & V_147 ) )
F_80 ( & V_147 , & V_70 ) ;
return F_81 ( V_24 , & V_152 , V_135 ) ;
}
static int F_82 ( struct V_106 * V_131 )
{
struct V_6 * V_7 = F_55 ( V_131 ) ;
if ( F_79 ( & V_147 ) )
F_80 ( & V_147 , NULL ) ;
F_83 ( V_7 -> V_27 -> V_78 ) ;
F_63 ( V_7 -> V_110 ) ;
F_84 ( & V_131 -> V_24 , V_7 -> V_25 , V_7 ) ;
F_85 ( & V_131 -> V_24 , & V_152 ) ;
return 0 ;
}
static int T_6 F_86 ( struct V_48 * V_24 )
{
struct V_6 * V_7 = F_87 ( V_24 ) ;
struct V_153 * V_154 = & V_7 -> V_154 ;
void T_7 * V_10 = V_7 -> V_10 ;
V_154 -> V_155 = F_11 ( V_10 +
V_130 ) ;
V_154 -> V_156 = F_11 ( V_10 + V_129 ) ;
V_154 -> V_157 = F_11 ( V_10 + V_112 ) ;
V_154 -> V_158 = F_11 ( V_10 + V_45 ) ;
V_154 -> V_159 = F_11 ( V_10 + V_126 ) ;
return 0 ;
}
...
F_4 ( V_154 -> V_155 ,
V_10 + V_130 ) ;
F_4 ( V_154 -> V_156 , V_10 + V_129 ) ;
F_4 ( V_154 -> V_157 , V_10 + V_112 ) ;
F_4 ( V_154 -> V_158 , V_10 + V_45 ) ;
F_4 ( V_154 -> V_159 , V_10 + V_126 ) ;
F_4 ( F_60 ( V_7 -> V_127 , V_7 -> V_76 ) ,
V_10 + V_128 ) ;
return 0 ;
}
static int F_89 ( struct V_144 * V_109 )
{
int V_21 ;
struct V_106 * V_131 ;
V_131 = F_75 ( V_109 , NULL , V_147 . V_148 ) ;
if ( ! V_131 )
return - V_138 ;
V_21 = F_90 ( & V_160 ) ;
if ( V_21 ) {
