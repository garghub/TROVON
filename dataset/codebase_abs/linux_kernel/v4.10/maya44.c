...
struct V_12 * V_13 )
{
static const char * const V_42 [] = { L_1 , L_2 } ;
return F_25 ( V_13 , 1 , F_26 ( V_42 ) , V_42 ) ;
}
...
struct V_26 * V_27 = F_6 ( V_11 ) ;
int V_43 ;
if ( F_17 ( V_27 -> V_2 ) & ( 1 << V_44 ) )
V_43 = 1 ;
else
V_43 = 0 ;
V_25 -> V_20 . V_45 . V_46 [ 0 ] = V_43 ;
return 0 ;
}
...
{
struct V_26 * V_27 = F_6 ( V_11 ) ;
int V_43 = V_25 -> V_20 . V_45 . V_46 [ 0 ] ;
int V_33 ;
F_8 ( & V_27 -> V_29 ) ;
V_33 = F_16 ( V_27 -> V_2 , 1 << V_44 ,
V_43 ? ( 1 << V_44 ) : 0 ) ;
F_23 ( V_27 , 0 , V_43 ? V_47 : V_48 ) ;
F_9 ( & V_27 -> V_29 ) ;
return V_33 ;
}
...
{
struct V_26 * V_27 = F_6 ( V_11 ) ;
int V_14 = F_32 ( V_11 , & V_25 -> V_28 ) ;
V_25 -> V_20 . V_45 . V_46 [ 0 ] =
F_33 ( V_27 -> V_2 , F_30 ( V_14 ) ) ;
return 0 ;
}
...
{
int V_49 , V_50 ;
for ( V_50 = 0 ; V_50 < F_26 ( V_51 ) ; V_50 ++ ) {
V_49 = F_37 ( V_2 -> V_52 , F_38 ( & V_51 [ V_50 ] ,
V_2 -> V_53 ) ) ;
if ( V_49 < 0 )
return V_49 ;
}
...
{
static const unsigned short V_54 [] = {
0x02 , 0x100 ,
0x05 , 0x100 ,
0x06 , 0x000 ,
0x07 , 0x091 ,
...
static void F_40 ( struct V_1 * V_2 , unsigned int V_57 )
{
struct V_26 * V_27 = V_2 -> V_53 ;
unsigned int V_58 , V_59 , V_6 ;
int V_50 ;
switch ( V_57 ) {
case 192000 :
V_58 = V_60 ;
...
V_2 -> V_70 = 0 ;
for ( V_50 = 0 ; V_50 < 2 ; V_50 ++ ) {
F_39 ( V_2 , & V_27 -> V_4 [ V_50 ] , V_71 [ V_50 ] ) ;
F_23 ( V_27 , V_50 , V_48 ) ;
}
V_2 -> V_72 = & V_73 ;
V_2 -> V_74 . V_75 = F_40 ;
