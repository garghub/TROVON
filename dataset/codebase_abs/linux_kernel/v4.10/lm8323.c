...
static T_5 F_44 ( struct V_93 * V_10 ,
struct V_94 * V_95 , char * V_13 )
{
struct V_1 * V_2 = F_36 ( V_10 ) ;
return sprintf ( V_13 , L_20 , ! V_2 -> V_25 ) ;
}
static T_5 F_45 ( struct V_93 * V_10 ,
struct V_94 * V_95 ,
...
static int F_47 ( struct V_103 * V_9 ,
const struct V_104 * V_74 )
{
struct V_105 * V_106 = F_48 ( & V_9 -> V_10 ) ;
struct V_107 * V_26 ;
struct V_1 * V_2 ;
int V_51 ;
int V_5 , V_108 ;
...
V_2 -> V_25 = true ;
V_108 = F_54 ( & V_9 -> V_10 , & V_118 ) ;
if ( V_108 < 0 )
goto V_117;
V_26 -> V_96 = V_106 -> V_96 ? : L_27 ;
...
F_57 ( V_106 -> V_24 [ V_5 ] , V_26 -> V_124 ) ;
...
V_129 | V_130 , L_30 , V_2 ) ;
if ( V_108 ) {
F_3 ( & V_9 -> V_10 , L_31 , V_9 -> V_57 ) ;
goto V_131;
}
F_62 ( V_9 , V_2 ) ;
F_63 ( & V_9 -> V_10 , 1 ) ;
...
F_67 ( & V_2 -> V_51 [ V_51 ] . V_98 ) ;
V_113:
F_68 ( V_26 ) ;
F_69 ( V_2 ) ;
return V_108 ;
}
static int F_70 ( struct V_103 * V_9 )
{
...
F_67 ( & V_2 -> V_51 [ V_5 ] . V_98 ) ;
F_69 ( V_2 ) ;
return 0 ;
}
static int F_74 ( struct V_93 * V_10 )
{
struct V_103 * V_9 = F_75 ( V_10 ) ;
struct V_1 * V_2 = F_71 ( V_9 ) ;
int V_5 ;
F_76 ( V_9 -> V_57 , 0 ) ;
F_77 ( V_9 -> V_57 ) ;
...
for ( V_5 = 0 ; V_5 < 3 ; V_5 ++ )
if ( V_2 -> V_51 [ V_5 ] . V_97 )
F_78 ( & V_2 -> V_51 [ V_5 ] . V_98 ) ;
return 0 ;
}
static int F_79 ( struct V_93 * V_10 )
{
struct V_103 * V_9 = F_75 ( V_10 ) ;
struct V_1 * V_2 = F_71 ( V_9 ) ;
int V_5 ;
