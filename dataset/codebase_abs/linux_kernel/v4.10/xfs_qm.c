...
if ( F_44 ( V_2 ) ) {
V_234 = F_1 ( V_2 , V_45 , F_141 ,
& V_183 ) ;
if ( ! error )
error = V_234 ;
}
if ( F_45 ( V_2 ) ) {
V_234 = F_1 ( V_2 , V_47 , F_141 ,
& V_183 ) ;
if ( ! error )
error = V_234 ;
}
...
ASSERT ( V_265 ) ;
ASSERT ( V_265 != V_264 ) ;
F_155 ( V_154 , V_265 , V_266 , - ( V_55 -> V_66 . V_195 ) ) ;
F_155 ( V_154 , V_265 , V_269 , - 1 ) ;
F_155 ( V_154 , V_264 , V_266 , V_55 -> V_66 . V_195 ) ;
F_155 ( V_154 , V_264 , V_269 , 1 ) ;
* V_263 = F_152 ( V_264 ) ;
return V_265 ;
}
int
...
V_55 -> V_65 = F_152 ( V_271 ) ;
F_155 ( V_154 , V_271 , V_269 , 1 ) ;
}
if ( V_272 && F_44 ( V_2 ) ) {
ASSERT ( V_55 -> V_70 == NULL ) ;
ASSERT ( V_55 -> V_66 . V_71 == F_7 ( V_272 -> V_20 . V_21 ) ) ;
V_55 -> V_70 = F_152 ( V_272 ) ;
F_155 ( V_154 , V_272 , V_269 , 1 ) ;
}
if ( V_273 && F_45 ( V_2 ) ) {
ASSERT ( V_55 -> V_72 == NULL ) ;
ASSERT ( F_46 ( V_55 ) == F_7 ( V_273 -> V_20 . V_21 ) ) ;
V_55 -> V_72 = F_152 ( V_273 ) ;
F_155 ( V_154 , V_273 , V_269 , 1 ) ;
}
}
