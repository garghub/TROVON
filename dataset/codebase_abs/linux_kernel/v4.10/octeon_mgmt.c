...
default:
if ( V_17 -> V_208 )
return F_71 ( V_17 -> V_208 , V_165 , V_166 ) ;
return - V_176 ;
}
}
...
F_103 ( V_319 -> V_324 , L_11 , sizeof( V_319 -> V_324 ) ) ;
F_103 ( V_319 -> V_325 , L_11 , sizeof( V_319 -> V_325 ) ) ;
}
...
V_2 -> V_31 = & V_330 -> V_31 ;
V_2 -> V_90 = false ;
V_32 = F_111 ( V_330 -> V_31 . V_338 , L_12 , & V_29 ) ;
if ( V_32 && V_29 == sizeof( * V_32 ) ) {
V_2 -> V_55 = F_112 ( V_32 ) ;
} else {
F_84 ( & V_330 -> V_31 , L_13 ) ;
V_336 = - V_339 ;
goto V_340;
}
snprintf ( V_17 -> V_234 , V_341 , L_14 , V_2 -> V_55 ) ;
V_336 = F_113 ( V_330 , 0 ) ;
if ( V_336 < 0 )
goto V_340;
V_2 -> V_294 = V_336 ;
