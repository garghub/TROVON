...
F_188 ( & V_34 -> V_23 -> V_179 ) ;
F_180 ( & V_34 -> V_23 -> V_179 ) ;
return true ;
V_189:
F_81 ( & V_14 -> V_68 ) ;
return false ;
...
static int F_190 ( T_2 * V_173 , unsigned V_191 , int V_192 , void * V_193 )
{
struct V_194 * V_195 = F_168 ( V_173 , struct V_194 , V_173 ) ;
if ( V_195 -> V_4 != V_193 )
return 0 ;
return F_191 ( V_173 , V_191 , V_192 , V_193 ) ;
}
...
struct V_194 V_195 ;
F_194 ( & V_195 . V_173 ) ;
V_195 . V_173 . V_3 = F_190 ;
V_195 . V_4 = V_4 ;
F_195 ( & V_196 , & V_195 . V_173 ,
V_197 ) ;
if ( F_47 ( V_4 ) )
F_161 () ;
F_196 ( & V_196 , & V_195 . V_173 ) ;
}
} while ( F_24 ( V_15 < 0 ) );
F_46 ( V_4 ) ;
F_96 ( V_33 ) ;
...
F_208 (cpu)
F_189 ( F_112 ( V_199 , V_56 ) ) ;
F_211 () ;
F_212 ( V_199 ) ;
return 0 ;
}
int F_213 ( T_1 V_201 , struct V_202 * V_203 )
{
if ( ! F_214 () ) {
V_201 ( & V_203 -> V_4 ) ;
return 0 ;
}
F_209 ( & V_203 -> V_4 , V_201 ) ;
F_78 ( & V_203 -> V_4 ) ;
return 1 ;
}
void F_215 ( struct V_204 * V_125 )
{
if ( V_125 ) {
F_216 ( V_125 -> V_126 ) ;
F_146 ( V_125 ) ;
...
struct V_204 * F_217 ( T_4 V_205 )
{
struct V_204 * V_125 ;
V_125 = F_218 ( sizeof( * V_125 ) , V_205 ) ;
if ( ! V_125 )
goto V_88;
if ( ! F_219 ( & V_125 -> V_126 , V_205 ) )
goto V_88;
F_220 ( V_125 -> V_126 , V_206 ) ;
return V_125 ;
V_88:
F_215 ( V_125 ) ;
return NULL ;
}
static void F_221 ( struct V_204 * V_207 ,
const struct V_204 * V_208 )
{
V_207 -> V_134 = V_208 -> V_134 ;
F_220 ( V_207 -> V_126 , V_208 -> V_126 ) ;
V_207 -> V_209 = V_208 -> V_209 ;
}
static T_5 F_222 ( const struct V_204 * V_125 )
{
T_5 V_210 = 0 ;
V_210 = F_223 ( V_125 -> V_134 , V_210 ) ;
V_210 = F_224 ( F_225 ( V_125 -> V_126 ) ,
F_226 ( V_211 ) * sizeof( long ) , V_210 ) ;
return V_210 ;
}
static bool F_227 ( const struct V_204 * V_212 ,
const struct V_204 * V_213 )
{
if ( V_212 -> V_134 != V_213 -> V_134 )
return false ;
if ( ! F_228 ( V_212 -> V_126 , V_213 -> V_126 ) )
return false ;
return true ;
}
...
static void F_238 ( struct V_216 * V_217 )
{
struct V_13 * V_14 = F_168 ( V_217 , struct V_13 , V_217 ) ;
F_239 ( & V_14 -> V_133 ) ;
F_215 ( V_14 -> V_125 ) ;
F_146 ( V_14 ) ;
}
...
F_200 ( & V_14 -> V_119 ) ;
F_200 ( & V_14 -> V_143 ) ;
F_244 ( & V_14 -> V_217 , F_238 ) ;
}
static struct V_13 * F_245 ( const struct V_204 * V_125 )
{
T_5 V_210 = F_222 ( V_125 ) ;
struct V_13 * V_14 ;
int V_24 ;
int V_219 = V_25 ;
F_20 ( & V_16 ) ;
...
V_14 = F_131 ( sizeof( * V_14 ) , V_19 , V_219 ) ;
...
static void F_250 ( struct V_216 * V_217 )
{
F_251 ( V_223 ,
F_168 ( V_217 , struct V_21 , V_217 ) ) ;
}
...
F_240 ( V_14 ) ;
F_136 ( & V_16 ) ;
F_244 ( & V_34 -> V_217 , F_250 ) ;
if ( V_224 )
F_244 ( & V_23 -> V_217 , F_237 ) ;
}
...
F_256 ( & V_34 -> V_14 -> V_68 , V_33 ) ;
}
static void F_257 ( struct V_21 * V_34 , struct V_22 * V_23 ,
struct V_13 * V_14 )
{
F_258 ( ( unsigned long ) V_34 & V_230 ) ;
...
static void F_259 ( struct V_21 * V_34 )
{
struct V_22 * V_23 = V_34 -> V_23 ;
F_20 ( & V_23 -> V_180 ) ;
if ( ! F_51 ( & V_34 -> V_225 ) )
...
F_254 ( V_34 ) ;
F_260 ( & V_34 -> V_225 , & V_23 -> V_226 ) ;
}
static struct V_21 * F_261 ( struct V_22 * V_23 ,
...
if ( ! V_14 )
return NULL ;
V_34 = F_262 ( V_223 , V_19 , V_14 -> V_24 ) ;
if ( ! V_34 ) {
F_240 ( V_14 ) ;
return NULL ;
}
F_257 ( V_34 , V_23 , V_14 ) ;
return V_34 ;
}
static bool F_263 ( const struct V_204 * V_125 , int V_24 ,
int V_231 , T_6 * V_126 )
{
if ( ! V_220 || V_125 -> V_209 )
goto V_232;
F_264 ( V_126 , F_265 ( V_24 ) , V_125 -> V_126 ) ;
if ( V_231 >= 0 )
F_266 ( V_231 , V_126 ) ;
if ( F_105 ( V_126 ) )
goto V_232;
F_264 ( V_126 , V_125 -> V_126 , V_221 [ V_24 ] ) ;
...
int V_24 ;
F_20 ( & V_16 ) ;
V_235 = F_218 ( sizeof( * V_235 ) + V_239 * sizeof( V_235 -> V_236 [ 0 ] ) ,
V_19 ) ;
V_237 = F_217 ( V_19 ) ;
V_238 = F_217 ( V_19 ) ;
...
goto V_240;
F_221 ( V_237 , V_125 ) ;
F_264 ( V_237 -> V_126 , V_237 -> V_126 , V_96 ) ;
if ( F_24 ( F_105 ( V_237 -> V_126 ) ) )
F_220 ( V_237 -> V_126 , V_96 ) ;
F_221 ( V_238 , V_237 ) ;
V_235 -> V_26 = F_261 ( V_23 , V_237 ) ;
if ( ! V_235 -> V_26 )
goto V_240;
F_246 (node) {
if ( F_263 ( V_237 , V_24 , - 1 , V_238 -> V_126 ) ) {
V_235 -> V_236 [ V_24 ] = F_261 ( V_23 , V_238 ) ;
if ( ! V_235 -> V_236 [ V_24 ] )
goto V_240;
} else {
V_235 -> V_26 -> V_69 ++ ;
...
F_221 ( V_237 , V_125 ) ;
F_264 ( V_237 -> V_126 , V_237 -> V_126 , V_206 ) ;
V_235 -> V_125 = V_237 ;
V_235 -> V_23 = V_23 ;
F_215 ( V_238 ) ;
return V_235 ;
...
{
int V_24 ;
F_134 ( & V_235 -> V_23 -> V_180 ) ;
F_221 ( V_235 -> V_23 -> V_218 , V_235 -> V_125 ) ;
F_246 (node)
V_235 -> V_236 [ V_24 ] = F_267 ( V_235 -> V_23 , V_24 ,
V_235 -> V_236 [ V_24 ] ) ;
F_259 ( V_235 -> V_26 ) ;
F_273 ( V_235 -> V_23 -> V_26 , V_235 -> V_26 ) ;
F_136 ( & V_235 -> V_23 -> V_180 ) ;
}
...
V_245 = V_246 ;
V_126 = V_245 -> V_126 ;
F_221 ( V_245 , V_23 -> V_218 ) ;
V_34 = F_22 ( V_23 , V_24 ) ;
if ( F_263 ( V_23 -> V_26 -> V_14 -> V_125 , V_24 , V_244 , V_126 ) ) {
if ( F_228 ( V_126 , V_34 -> V_14 -> V_125 -> V_126 ) )
return;
} else {
goto V_247;
}
V_34 = F_261 ( V_23 , V_245 ) ;
if ( ! V_34 ) {
F_104 ( L_12 ,
V_23 -> V_107 ) ;
goto V_247;
...
F_104 ( L_14 ,
V_80 , V_107 , 1 , V_254 ) ;
return F_284 ( V_80 , 1 , V_254 ) ;
}
struct V_22 * F_285 ( const char * V_257 ,
unsigned int V_33 ,
int V_80 ,
struct V_258 * V_193 ,
const char * V_259 , ... )
...
V_23 = F_218 ( sizeof( * V_23 ) + V_260 , V_19 ) ;
if ( ! V_23 )
return NULL ;
if ( V_33 & V_70 ) {
V_23 -> V_218 = F_217 ( V_19 ) ;
if ( ! V_23 -> V_218 )
goto V_263;
}
va_start ( args , V_259 ) ;
...
F_132 ( & V_23 -> V_181 ) ;
F_132 ( & V_23 -> V_142 ) ;
F_286 ( & V_23 -> V_179 , V_259 , V_193 , 0 ) ;
F_132 ( & V_23 -> V_176 ) ;
if ( F_279 ( V_23 ) < 0 )
goto V_263;
if ( V_33 & V_162 ) {
...
goto V_265;
V_140 -> V_153 = V_23 ;
V_140 -> V_54 = F_287 ( F_162 , V_140 , L_15 ,
V_23 -> V_107 ) ;
if ( F_142 ( V_140 -> V_54 ) ) {
F_146 ( V_140 ) ;
goto V_265;
...
V_23 -> V_140 = V_140 ;
F_144 ( V_140 -> V_54 , V_206 ) ;
F_61 ( V_140 -> V_54 ) ;
}
if ( ( V_23 -> V_33 & V_266 ) && F_288 ( V_23 ) )
goto V_265;
F_134 ( & V_16 ) ;
F_134 ( & V_23 -> V_180 ) ;
F_175 (pwq, wq)
...
void F_303 ( const char * V_273 , struct V_55 * V_54 )
{
T_1 * V_201 = NULL ;
char V_107 [ V_274 ] = { } ;
char V_271 [ V_275 ] = { } ;
...
F_305 ( & V_272 , & V_51 -> V_272 , sizeof( V_272 ) ) ;
if ( V_272 )
F_305 ( V_271 , V_51 -> V_271 , sizeof( V_271 ) - 1 ) ;
if ( V_201 || V_107 [ 0 ] || V_271 [ 0 ] ) {
F_306 ( L_16 , V_273 , V_107 , V_201 ) ;
if ( V_271 [ 0 ] )
F_307 ( L_17 , V_271 ) ;
F_307 ( L_18 ) ;
}
...
{
F_307 ( L_19 , V_211 , V_14 -> V_125 -> V_126 ) ;
if ( V_14 -> V_24 != V_25 )
F_307 ( L_20 , V_14 -> V_24 ) ;
F_307 ( L_21 , V_14 -> V_33 , V_14 -> V_125 -> V_134 ) ;
}
static void F_309 ( bool V_276 , struct V_2 * V_4 )
{
if ( V_4 -> V_3 == F_167 ) {
struct V_167 * V_168 ;
V_168 = F_168 ( V_4 , struct V_167 , V_4 ) ;
F_307 ( L_22 , V_276 ? L_23 : L_5 ,
F_310 ( V_168 -> V_54 ) ) ;
} else {
F_307 ( L_24 , V_276 ? L_23 : L_5 , V_4 -> V_3 ) ;
}
}
...
int V_279 ;
F_312 ( L_25 , V_14 -> V_20 ) ;
F_308 ( V_14 ) ;
F_307 ( L_26 , V_34 -> V_75 , V_34 -> V_80 ,
...
if ( V_281 )
continue;
F_312 ( L_34 , V_23 -> V_107 , V_23 -> V_33 ) ;
F_175 (pwq, wq) {
F_255 ( & V_34 -> V_14 -> V_68 , V_33 ) ;
if ( V_34 -> V_75 || ! F_51 ( & V_34 -> V_76 ) )
F_311 ( V_34 ) ;
...
F_307 ( L_38 , V_157 ? L_39 : L_5 ,
F_310 ( V_51 -> V_54 ) ) ;
V_157 = false ;
}
F_307 ( L_18 ) ;
V_282:
F_256 ( & V_14 -> V_68 , V_33 ) ;
}
F_300 () ;
}
...
return;
F_264 ( & V_126 , V_14 -> V_125 -> V_126 , V_98 ) ;
F_319 (worker, pool)
...
{
struct V_286 * V_287 = F_168 ( V_4 , struct V_286 , V_4 ) ;
...
F_170 ( & V_287 . V_4 , F_326 ) ;
F_210 ( V_56 , & V_287 . V_4 ) ;
F_189 ( & V_287 . V_4 ) ;
F_16 ( & V_287 . V_4 ) ;
return V_287 . V_15 ;
}
...
static struct V_22 * F_335 ( struct V_292 * V_293 )
{
struct V_294 * V_295 = F_168 ( V_293 , struct V_294 , V_293 ) ;
return V_295 -> V_23 ;
}
static T_10 F_336 ( struct V_292 * V_293 , struct V_296 * V_297 ,
char * V_298 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
return F_337 ( V_298 , V_299 , L_40 , ( bool ) ! ( V_23 -> V_33 & V_70 ) ) ;
}
static T_10 F_338 ( struct V_292 * V_293 ,
struct V_296 * V_297 , char * V_298 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
return F_337 ( V_298 , V_299 , L_40 , V_23 -> V_190 ) ;
}
static T_10 F_339 ( struct V_292 * V_293 ,
struct V_296 * V_297 , const char * V_298 ,
T_7 V_300 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
int V_301 ;
if ( sscanf ( V_298 , L_41 , & V_301 ) != 1 || V_301 <= 0 )
return - V_241 ;
F_295 ( V_23 , V_301 ) ;
return V_300 ;
}
static T_10 F_340 ( struct V_292 * V_293 ,
struct V_296 * V_297 , char * V_298 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
const char * V_302 = L_5 ;
int V_24 , V_303 = 0 ;
F_298 () ;
F_246 (node) {
V_303 += F_337 ( V_298 + V_303 , V_299 - V_303 ,
L_42 , V_302 , V_24 ,
F_22 ( V_23 , V_24 ) -> V_14 -> V_20 ) ;
V_302 = L_43 ;
}
V_303 += F_337 ( V_298 + V_303 , V_299 - V_303 , L_18 ) ;
F_300 () ;
return V_303 ;
}
static T_10 F_341 ( struct V_292 * V_293 , struct V_296 * V_297 ,
char * V_298 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
int V_303 ;
F_134 ( & V_23 -> V_180 ) ;
V_303 = F_337 ( V_298 , V_299 , L_40 , V_23 -> V_218 -> V_134 ) ;
F_136 ( & V_23 -> V_180 ) ;
return V_303 ;
}
static struct V_204 * F_342 ( struct V_22 * V_23 )
{
struct V_204 * V_125 ;
F_20 ( & V_16 ) ;
V_125 = F_217 ( V_19 ) ;
if ( ! V_125 )
return NULL ;
F_221 ( V_125 , V_23 -> V_218 ) ;
return V_125 ;
}
static T_10 F_343 ( struct V_292 * V_293 , struct V_296 * V_297 ,
const char * V_298 , T_7 V_300 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
struct V_204 * V_125 ;
int V_15 = - V_200 ;
...
if ( ! V_125 )
goto V_182;
if ( sscanf ( V_298 , L_41 , & V_125 -> V_134 ) == 1 &&
V_125 -> V_134 >= V_304 && V_125 -> V_134 <= V_305 )
V_15 = F_276 ( V_23 , V_125 ) ;
else
V_15 = - V_241 ;
V_182:
...
static T_10 F_344 ( struct V_292 * V_293 ,
struct V_296 * V_297 , char * V_298 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
int V_303 ;
F_134 ( & V_23 -> V_180 ) ;
V_303 = F_337 ( V_298 , V_299 , L_44 ,
F_345 ( V_23 -> V_218 -> V_126 ) ) ;
F_136 ( & V_23 -> V_180 ) ;
return V_303 ;
}
static T_10 F_346 ( struct V_292 * V_293 ,
struct V_296 * V_297 ,
const char * V_298 , T_7 V_300 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
...
static T_10 F_348 ( struct V_292 * V_293 , struct V_296 * V_297 ,
char * V_298 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
int V_303 ;
F_134 ( & V_23 -> V_180 ) ;
V_303 = F_337 ( V_298 , V_299 , L_40 ,
! V_23 -> V_218 -> V_209 ) ;
F_136 ( & V_23 -> V_180 ) ;
return V_303 ;
}
static T_10 F_349 ( struct V_292 * V_293 , struct V_296 * V_297 ,
const char * V_298 , T_7 V_300 )
{
struct V_22 * V_23 = F_335 ( V_293 ) ;
struct V_204 * V_125 ;
int V_306 , V_15 = - V_200 ;
F_274 () ;
V_125 = F_342 ( V_23 ) ;
if ( ! V_125 )
goto V_182;
V_15 = - V_241 ;
if ( sscanf ( V_298 , L_41 , & V_306 ) == 1 ) {
V_125 -> V_209 = ! V_306 ;
V_15 = F_276 ( V_23 , V_125 ) ;
}
V_182:
...
static T_10 F_350 ( struct V_292 * V_293 ,
struct V_296 * V_297 , char * V_298 )
{
int V_303 ;
F_134 ( & V_16 ) ;
...
static T_10 F_351 ( struct V_292 * V_293 ,
struct V_296 * V_297 , const char * V_298 , T_7 V_300 )
{
T_9 V_126 ;
int V_15 ;
if ( ! F_334 ( & V_126 , V_19 ) )
return - V_200 ;
V_15 = F_347 ( V_298 , V_126 ) ;
if ( ! V_15 )
V_15 = F_333 ( V_126 ) ;
F_216 ( V_126 ) ;
return V_15 ? V_15 : V_300 ;
}
static int T_11 F_352 ( void )
{
int V_307 ;
V_307 = F_353 ( & V_308 , NULL ) ;
if ( V_307 )
return V_307 ;
return F_354 ( V_308 . V_309 , & V_310 ) ;
}
static void F_355 ( struct V_292 * V_293 )
{
struct V_294 * V_295 = F_168 ( V_293 , struct V_294 , V_293 ) ;
F_146 ( V_295 ) ;
}
...
if ( F_116 ( V_23 -> V_33 & V_242 ) )
return - V_241 ;
V_23 -> V_295 = V_295 = F_218 ( sizeof( * V_295 ) , V_19 ) ;
if ( ! V_295 )
return - V_200 ;
V_295 -> V_23 = V_23 ;
V_295 -> V_293 . V_311 = & V_308 ;
V_295 -> V_293 . V_312 = F_355 ;
F_356 ( & V_295 -> V_293 , L_15 , V_23 -> V_107 ) ;
F_357 ( & V_295 -> V_293 , true ) ;
V_15 = F_358 ( & V_295 -> V_293 ) ;
if ( V_15 ) {
F_146 ( V_295 ) ;
V_23 -> V_295 = NULL ;
return V_15 ;
...
if ( V_23 -> V_33 & V_70 ) {
struct V_296 * V_297 ;
for ( V_297 = V_313 ; V_297 -> V_297 . V_107 ; V_297 ++ ) {
V_15 = F_354 ( & V_295 -> V_293 , V_297 ) ;
if ( V_15 ) {
F_359 ( & V_295 -> V_293 ) ;
V_23 -> V_295 = NULL ;
return V_15 ;
...
F_357 ( & V_295 -> V_293 , false ) ;
F_360 ( & V_295 -> V_293 . V_314 , V_315 ) ;
return 0 ;
}
static void F_292 ( struct V_22 * V_23 )
{
struct V_294 * V_295 = V_23 -> V_295 ;
if ( ! V_23 -> V_295 )
return;
V_23 -> V_295 = NULL ;
F_359 ( & V_295 -> V_293 ) ;
...
V_316 = V_73 ;
F_280 (cpu)
F_281 ( V_317 , V_56 ) = V_73 ;
}
static void F_362 ( unsigned long V_32 )
{
unsigned long V_318 = F_363 ( V_319 ) * V_320 ;
bool V_321 = false ;
struct V_13 * V_14 ;
int V_280 ;
if ( ! V_318 )
...
if ( F_51 ( & V_14 -> V_44 ) )
continue;
V_322 = F_363 ( V_14 -> V_72 ) ;
V_323 = F_363 ( V_316 ) ;
if ( F_365 ( V_322 , V_323 ) )
V_324 = V_322 ;
else
V_324 = V_323 ;
if ( V_14 -> V_56 >= 0 ) {
...
F_363 ( F_281 ( V_317 ,
V_14 -> V_56 ) ) ;
if ( F_365 ( V_325 , V_324 ) )
V_324 = V_325 ;
}
if ( F_365 ( V_73 , V_324 + V_318 ) ) {
V_321 = true ;
F_366 ( L_45 ) ;
F_308 ( V_14 ) ;
F_307 ( L_46 ,
F_316 ( V_73 - V_322 ) / 1000 ) ;
}
}
F_367 () ;
if ( V_321 )
...
static void F_369 ( unsigned long V_318 )
{
V_319 = 0 ;
F_200 ( & V_326 ) ;
if ( V_318 ) {
V_319 = V_318 ;
F_361 () ;
F_128 ( & V_326 , V_73 + V_318 * V_320 ) ;
}
}
static int F_370 ( const char * V_301 ,
const struct V_327 * V_328 )
{
unsigned long V_318 ;
int V_15 ;
V_15 = F_371 ( V_301 , 0 , & V_318 ) ;
if ( V_15 )
return V_15 ;
if ( V_329 )
F_369 ( V_318 ) ;
...
V_246 = F_217 ( V_19 ) ;
F_258 ( ! V_246 ) ;
V_330 = F_218 ( V_239 * sizeof( V_330 [ 0 ] ) , V_19 ) ;
F_258 ( ! V_330 ) ;
F_246 (node)
F_258 ( ! F_375 ( & V_330 [ V_24 ] , V_19 ,
...
int T_11 F_378 ( void )
{
int V_332 [ V_333 ] = { 0 , V_334 } ;
int V_268 , V_56 ;
F_116 ( F_379 ( struct V_21 ) < F_379 (long long) ) ;
F_258 ( ! F_219 ( & V_96 , V_19 ) ) ;
F_220 ( V_96 , V_206 ) ;
V_223 = F_380 ( V_21 , V_335 ) ;
F_280 (cpu) {
struct V_13 * V_14 ;
V_268 = 0 ;
F_318 (pool, cpu) {
...
for ( V_268 = 0 ; V_268 < V_333 ; V_268 ++ ) {
struct V_204 * V_125 ;
F_258 ( ! ( V_125 = F_217 ( V_19 ) ) ) ;
V_125 -> V_134 = V_332 [ V_268 ] ;
V_253 [ V_268 ] = V_125 ;
F_258 ( ! ( V_125 = F_217 ( V_19 ) ) ) ;
V_125 -> V_134 = V_332 [ V_268 ] ;
V_125 -> V_209 = true ;
...
V_329 = F_382 ( L_49 , 0 , 0 ) ;
V_285 = F_382 ( L_50 , V_249 , 0 ) ;
V_336 = F_382 ( L_51 , 0 , 0 ) ;
V_337 = F_382 ( L_52 , V_70 ,
V_255 ) ;
V_338 = F_382 ( L_53 ,
V_228 , 0 ) ;
V_339 = F_382 ( L_54 ,
