...
const T_3 * V_76 ;
int V_3 ;
V_76 = F_25 ( V_60 , L_2 , & V_3 ) ;
if ( V_76 && V_3 >= sizeof( T_3 ) )
V_2 -> V_36 = F_26 ( V_76 ) ;
}
if ( ! V_2 -> V_36 )
V_2 -> V_36 = V_73 ;
...
V_44 -> V_77 = V_60 ? - 1 : V_9 -> V_64 -> V_78 ;
V_44 -> V_79 = V_30 | V_32 | V_34 ;
V_44 -> V_80 = F_27 ( 8 ) ;
V_44 -> V_81 = F_15 ;
V_44 -> V_82 = F_9 ;
V_44 -> V_58 . V_61 = V_60 ;
V_44 -> V_83 = V_2 -> V_36 / 128 ;
V_44 -> V_84 = V_2 -> V_36 / 4 ;
error = F_28 ( V_58 , V_44 ) ;
if ( error )
goto V_85;
return 0 ;
V_85:
