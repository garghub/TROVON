...
V_75 = F_46 ( & V_90 , V_91 ) ;
V_76 = F_47 ( & V_90 , V_92 ) ;
if ( ! F_48 ( V_75 ) || ! F_49 ( V_76 ) ) {
F_33 ( V_21 ) ;
V_45 = - V_78 ;
goto V_62;
}
V_74 = F_50 ( V_21 -> V_35 , V_93 , V_1 -> V_94 ,
& V_95 , V_21 ) ;
if ( V_74 == NULL ) {
F_33 ( V_21 ) ;
V_45 = - V_89 ;
...
memset ( V_99 . V_58 . V_101 , 0xFF , sizeof( V_99 . V_58 . V_101 ) ) ;
return F_35 ( V_40 , & V_99 ) ;
}
static int F_54 ( const struct V_72 * V_40 )
{
return F_35 ( V_40 , V_40 -> V_43 ) ;
}
static void F_55 ( const struct V_102 * V_40 )
{
struct V_1 * V_1 = F_1 ( V_40 -> V_2 ) ;
const struct V_41 * V_42 = V_40 -> V_43 ;
struct V_13 * V_21 ;
...
static void * F_57 ( struct V_103 * V_104 , T_6 * V_105 )
__acquires( V_57 )
{
...
static void * F_58 ( struct V_103 * V_104 , void * V_111 , T_6 * V_105 )
{
struct V_106 * V_107 = V_104 -> V_108 ;
const struct V_13 * V_21 = V_107 -> V_14 ;
...
static void F_59 ( struct V_103 * V_114 , void * V_111 )
__releases( V_57 )
{
F_32 ( & V_57 ) ;
}
static int F_60 ( struct V_103 * V_104 , void * V_111 )
{
const struct V_12 * V_18 = V_111 ;
struct V_106 * V_107 = V_104 -> V_108 ;
const struct V_13 * V_21 = V_107 -> V_14 ;
...
for ( V_36 = 0 ; V_36 < V_18 -> V_33 ; V_36 ++ )
F_61 ( V_104 , L_5 , V_36 ? L_6 : L_7 , V_18 -> V_26 [ V_36 ] ) ;
F_61 ( V_104 , L_8 ) ;
return 0 ;
}
static int F_62 ( struct V_115 * V_115 , struct V_116 * V_116 )
{
struct V_106 * V_107 ;
V_107 = F_63 ( V_116 , & V_117 , sizeof( * V_107 ) ) ;
if ( V_107 == NULL )
return - V_89 ;
V_107 -> V_14 = F_64 ( V_115 ) ;
return 0 ;
}
static T_7
F_65 ( struct V_116 * V_116 , const char T_8 * V_118 ,
T_5 V_119 , T_6 * V_120 )
{
struct V_13 * V_21 = F_64 ( F_66 ( V_116 ) ) ;
struct V_12 * V_18 ;
...
++ V_122 ;
-- V_119 ;
if ( F_68 ( V_122 , V_119 , ':' ) != NULL ) {
V_16 = V_127 ;
V_124 = F_69 ( V_122 , V_119 , ( void * ) & V_5 , '\n' , NULL ) ;
} else {
V_16 = V_20 ;
V_124 = F_70 ( V_122 , V_119 , ( void * ) & V_5 , '\n' , NULL ) ;
}
if ( ! V_124 ) {
F_38 ( L_11 ) ;
return - V_78 ;
