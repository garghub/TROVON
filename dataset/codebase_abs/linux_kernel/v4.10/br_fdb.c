...
return 0 ;
F_70 ( V_7 , L_2 ,
V_85 ? V_85 -> V_27 -> V_89 : V_7 -> V_27 -> V_89 , V_23 , V_16 ) ;
F_26 ( V_7 , V_11 ) ;
}
...
goto V_60;
if ( ! V_134 ) {
V_24 = F_95 ( V_98 , V_133 , V_27 , NULL , V_135 ) ;
if ( V_24 < 0 )
goto V_60;
}
for ( V_54 = 0 ; V_54 < V_18 ; V_54 ++ ) {
