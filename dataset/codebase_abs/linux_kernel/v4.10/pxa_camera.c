...
int V_18 = 0 , V_59 = 0 ;
V_77 -> V_307 [ V_18 ++ ] = F_36 ( V_77 -> V_104 + V_106 ) ;
V_77 -> V_307 [ V_18 ++ ] = F_36 ( V_77 -> V_104 + V_196 ) ;
V_77 -> V_307 [ V_18 ++ ] = F_36 ( V_77 -> V_104 + V_197 ) ;
V_77 -> V_307 [ V_18 ++ ] = F_36 ( V_77 -> V_104 + V_198 ) ;
V_77 -> V_307 [ V_18 ++ ] = F_36 ( V_77 -> V_104 + V_162 ) ;
if ( V_77 -> V_183 ) {
V_59 = F_64 ( V_77 , V_292 , V_293 , 0 ) ;
if ( V_59 == - V_240 )
V_59 = 0 ;
...
struct V_76 * V_77 = F_136 ( V_78 ) ;
int V_18 = 0 , V_59 = 0 ;
F_35 ( V_77 -> V_307 [ V_18 ++ ] & ~ V_107 , V_77 -> V_104 + V_106 ) ;
F_35 ( V_77 -> V_307 [ V_18 ++ ] , V_77 -> V_104 + V_196 ) ;
F_35 ( V_77 -> V_307 [ V_18 ++ ] , V_77 -> V_104 + V_197 ) ;
F_35 ( V_77 -> V_307 [ V_18 ++ ] , V_77 -> V_104 + V_198 ) ;
F_35 ( V_77 -> V_307 [ V_18 ++ ] , V_77 -> V_104 + V_162 ) ;
if ( V_77 -> V_183 ) {
V_59 = F_64 ( V_77 , V_292 , V_293 , 1 ) ;
if ( V_59 == - V_240 )
V_59 = 0 ;
...
{
T_2 V_308 ;
struct V_309 * V_310 , * V_311 = V_78 -> V_312 ;
struct V_313 V_314 ;
int V_298 = F_139 ( V_311 , L_43 ,
& V_308 ) ;
if ( ! V_298 ) {
V_77 -> V_147 |= V_148 ;
V_77 -> V_143 = V_308 ;
}
V_311 = F_140 ( V_311 , NULL ) ;
if ( ! V_311 ) {
F_25 ( V_78 , L_44 ) ;
return - V_11 ;
}
V_298 = F_141 ( V_311 , & V_314 ) ;
if ( V_298 ) {
F_25 ( V_78 , L_45 ) ;
goto V_137;
}
switch ( V_314 . V_315 . V_316 . V_317 ) {
case 4 :
V_77 -> V_147 |= V_318 ;
break;
case 5 :
...
if ( V_314 . V_315 . V_316 . V_23 & V_42 )
V_77 -> V_147 |= V_174 ;
if ( V_314 . V_315 . V_316 . V_23 & V_33 )
V_77 -> V_147 |= V_157 ;
if ( V_314 . V_315 . V_316 . V_23 & V_35 )
V_77 -> V_147 |= V_159 ;
if ( V_314 . V_315 . V_316 . V_23 & V_38 )
V_77 -> V_147 |= V_152 | V_155 ;
if ( V_314 . V_315 . V_316 . V_23 & V_39 )
V_77 -> V_147 |= V_152 ;
V_297 -> V_323 = V_324 ;
V_310 = F_142 ( V_311 ) ;
if ( V_310 ) {
V_297 -> V_325 . V_326 . V_327 = V_310 ;
F_143 ( V_310 ) ;
} else {
F_144 ( V_78 , L_46 , F_145 ( V_311 ) ) ;
}
V_137:
F_143 ( V_311 ) ;
return V_298 ;
...
if ( & V_142 -> V_78 . V_312 && ! V_77 -> V_342 ) {
V_298 = F_138 ( & V_142 -> V_78 , V_77 , & V_77 -> V_297 ) ;
} else {
V_77 -> V_147 = V_77 -> V_342 -> V_23 ;
V_77 -> V_143 = V_77 -> V_342 -> V_344 * 10000 ;
V_77 -> V_297 . V_323 = V_345 ;
V_77 -> V_297 . V_325 . V_346 . V_347 =
V_77 -> V_342 -> V_348 ;
V_77 -> V_297 . V_325 . V_346 . V_349 = V_77 -> V_342 -> V_350 ;
}
if ( V_298 < 0 )
return V_298 ;
if ( ! ( V_77 -> V_147 & ( V_320 |
...
if ( ! V_77 -> V_88 [ 2 ] ) {
F_25 ( & V_142 -> V_78 , L_54 ) ;
V_298 = - V_341 ;
goto V_357;
}
for ( V_18 = 0 ; V_18 < 3 ; V_18 ++ ) {
V_331 . V_358 = V_77 -> V_329 -> V_359 + V_360 + V_18 * 8 ;
V_298 = F_157 ( V_77 -> V_88 [ V_18 ] , & V_331 ) ;
if ( V_298 < 0 ) {
F_25 ( & V_142 -> V_78 , L_55 ,
V_298 ) ;
goto V_361;
}
}
...
goto V_367;
if ( V_77 -> V_143 ) {
F_163 ( V_338 , sizeof( V_338 ) ,
V_77 -> V_297 . V_325 . V_346 . V_347 ,
V_77 -> V_297 . V_325 . V_346 . V_349 ) ;
V_77 -> V_368 = F_164 ( & V_369 ,
V_338 , NULL ) ;
if ( F_100 ( V_77 -> V_368 ) ) {
V_298 = F_101 ( V_77 -> V_368 ) ;
goto V_367;
}
}
