...
static void F_76 ( struct V_17 * V_13 , struct V_9 * V_34 ,
int V_59 )
{
F_77 ( & V_13 -> V_30 ) ;
V_13 -> V_39 = V_59 ;
...
static unsigned int F_81 ( const struct V_61 * V_62 )
{
unsigned int V_145 ;
V_145 = F_82 ( V_62 ) << 1 ;
if ( F_83 ( V_62 ) )
...
static int F_84 ( struct V_9 * V_34 , struct V_146 * V_146 )
{
...
static int F_85 ( struct V_9 * V_34 ,
unsigned int V_148 )
{
int V_131 ;
V_131 = V_34 -> V_149 [ F_86 ( V_148 ) ] ;
if ( F_87 ( V_148 ) )
V_131 >>= 4 ;
else
V_131 &= 0xf ;
...
static void F_88 ( struct V_9 * V_34 ,
...
V_131 |= V_150 ;
V_34 -> V_149 [ F_86 ( V_148 ) ] = V_131 ;
}
static int F_89 ( struct V_9 * V_34 , struct V_146 * V_146 )
{
unsigned int V_131 ;
int V_151 ;
V_151 = F_84 ( V_34 , V_146 ) ;
if ( ! V_146 -> V_152 ) {
if ( V_151 )
return - V_69 ;
return 0 ;
...
F_94 ( V_34 -> V_156 ) ;
} else if ( F_95 ( V_34 -> V_156 != V_146 -> V_19 ) )
F_28 ( F_6 ( V_34 ) , L_21 ) ;
...
V_81 |= V_177 ;
F_102 ( V_168 , V_146 -> V_178 , V_146 -> V_172 , V_81 ) ;
V_153 -> V_155 = 1 ;
}
V_171 = F_103 ( V_168 ) ;
if ( V_171 == false ) {
...
static int F_106 ( struct V_9 * V_34 , struct V_146 * V_146 ,
...
static struct V_1 * F_110 ( struct V_17 * V_13 , V_116 V_32 )
{
int V_31 ;
...
static int F_112 ( struct V_9 * V_34 , struct V_146 * V_146 ,
struct V_194 * V_195 ,
int * V_28 )
{
struct V_1 * V_196 ;
...
unsigned V_198 ;
unsigned V_199 ;
V_198 = F_113 ( V_195 -> V_200 ) ;
V_199 = F_113 ( V_195 -> V_201 ) ;
switch ( V_195 -> V_202 ) {
case V_203 :
...
static void F_114 ( unsigned long V_225 )
{
...
case V_236 :
V_181 = V_63 ( V_181 , F_108 ( V_13 , V_4 ) ) ;
V_28 = - V_237 ;
break;
case V_238 :
V_181 = V_63 ( V_181 , F_108 ( V_13 , V_4 ) ) ;
...
V_235:
V_4 -> V_132 = V_108 ;
V_226 -= F_106 ( V_34 , V_146 , V_4 , V_181 , & V_28 ) ;
break;
}
if ( V_28 == - V_84 )
continue;
...
F_117 ( F_5 ( V_34 ) , V_146 ) ;
F_15 ( & V_13 -> V_30 ) ;
F_118 ( F_5 ( V_34 ) , V_146 , V_28 ) ;
F_17 ( & V_13 -> V_30 ) ;
goto V_228;
}
if ( F_12 ( & V_34 -> V_157 ) ) {
...
static int F_120 ( struct V_10 * V_11 , char * V_91 )
{
struct V_9 * V_34 ;
unsigned long V_81 ;
int V_64 = 0 ;
...
if ( ! F_121 ( V_11 ) )
goto V_71;
if ( V_34 -> V_53 && F_122 ( V_108 , V_34 -> V_107 ) ) {
V_34 -> V_36 |= ( V_239 << 16 ) ;
V_34 -> V_36 &= ~ V_52 ;
F_20 ( V_34 ) ;
}
...
static inline void F_126 ( struct V_241 * V_62 )
{
memset ( V_62 , 0 , sizeof *V_62 ) ;
V_62 -> V_67 = V_252 ;
V_62 -> V_243 = 9 ;
...
if ( V_11 -> V_22 == V_35 )
F_124 ( (struct V_241 * ) V_91 ) ;
else
F_126 ( (struct V_241 * ) V_91 ) ;
break;
case V_263 | V_264 :
if ( V_11 -> V_22 != V_35 )
goto error;
...
F_20 ( V_34 ) ;
( ( V_271 * ) V_91 ) [ 0 ] = F_125 ( V_34 -> V_36 ) ;
( ( V_271 * ) V_91 ) [ 1 ] = F_125 ( V_34 -> V_36 >> 16 ) ;
break;
case V_272 :
V_64 = - V_233 ;
break;
...
static inline T_2 F_131 ( char * V_91 , T_6 V_284 , struct V_146 * V_146 )
{
...
static T_2 F_132 ( struct V_14 * V_19 , struct V_117 * V_118 ,
char * V_91 )
{
...
T_6 V_285 ;
V_285 = F_131 ( V_91 , V_120 - V_284 , V_153 -> V_146 ) ;
V_91 += V_285 ;
V_284 += V_285 ;
}
F_32 ( & V_34 -> V_13 -> V_30 , V_81 ) ;
...
static int F_134 ( struct V_9 * V_34 )
{
F_135 ( & V_34 -> V_161 ) ;
V_34 -> V_161 . V_119 = F_114 ;
...
struct V_10 * V_24 ;
int V_64 ;
F_140 ( & V_136 -> V_19 , L_54 V_304 L_55 , V_305 ) ;
V_13 = * ( ( void * * ) F_68 ( & V_136 -> V_19 ) ) ;
if ( ! V_112 . V_113 )
V_9 . V_81 = V_293 ;
V_25 = F_146 ( & V_9 , & V_136 -> V_19 , F_147 ( & V_136 -> V_19 ) ) ;
if ( ! V_25 )
return - V_154 ;
V_25 -> V_306 = 1 ;
V_64 = F_148 ( V_25 , 0 , 0 ) ;
...
goto V_307;
if ( V_112 . V_113 ) {
V_24 = F_149 ( & V_9 , & V_136 -> V_19 ,
F_147 ( & V_136 -> V_19 ) , V_25 ) ;
if ( ! V_24 ) {
V_64 = - V_154 ;
goto V_308;
}
...
static int F_152 ( struct V_135 * V_136 )
{
struct V_17 * V_13 ;
...
static int F_153 ( struct V_135 * V_136 , T_3 V_143 )
{
struct V_10 * V_11 ;
struct V_9 * V_34 ;
int V_137 = 0 ;
...
V_34 = F_4 ( V_11 ) ;
if ( V_34 -> V_46 == V_162 ) {
F_154 ( & V_136 -> V_19 , L_56 ) ;
V_137 = - V_310 ;
} else
F_155 ( V_311 , & V_11 -> V_81 ) ;
return V_137 ;
}
...
V_64 = F_163 ( V_315 [ V_31 ] , & V_13 [ V_31 ] ,
sizeof( void * ) ) ;
if ( V_64 )
goto V_320;
V_64 = F_163 ( V_317 [ V_31 ] , & V_13 [ V_31 ] ,
sizeof( void * ) ) ;
if ( V_64 )
goto V_320;
}
