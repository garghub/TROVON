...
static void F_17 ( struct V_27 * V_4 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
F_12 ( & V_2 -> V_24 , V_25 ) ;
...
if ( F_21 ( & V_2 -> V_4 ) )
goto V_45;
} else if ( V_7 & F_19 ( V_41 ) )
V_2 -> V_4 . V_13 . V_46 ++ ;
else if ( V_7 & F_19 ( V_40 ) )
V_2 -> V_4 . V_13 . V_47 ++ ;
if ( V_7 & F_20 ( V_43 ) )
V_2 -> V_4 . V_13 . V_48 ++ ;
V_7 &= V_2 -> V_4 . V_49 ;
...
static T_2 F_33 ( int V_64 , void * V_65 )
{
struct V_1 * V_2 = V_65 ;
unsigned int V_7 ;
F_27 ( & V_2 -> V_4 . V_23 ) ;
...
static unsigned int F_35 ( struct V_27 * V_4 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
...
static void F_36 ( struct V_27 * V_4 , unsigned int V_72 )
{
#if 0
...
static void F_37 ( struct V_27 * V_4 , int V_77 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
unsigned long V_22 ;
...
static int F_38 ( struct V_27 * V_4 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
int V_80 ;
V_80 = F_39 ( V_2 -> V_4 . V_64 , F_33 , 0 ,
L_1 , V_2 ) ;
if ( V_80 )
return V_80 ;
F_3 ( V_2 , V_31 , V_32 |
...
static void F_42 ( struct V_27 * V_4 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
int V_78 ;
...
F_3 ( V_2 , V_31 , V_32 |
V_30 ) ;
F_44 ( V_2 -> V_4 . V_64 , V_2 ) ;
}
static void
F_45 ( struct V_27 * V_4 , struct V_83 * V_84 ,
struct V_83 * V_85 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
...
V_88 = F_46 ( V_4 , V_84 , V_85 , 0 , V_4 -> V_102 / 16 ) ;
V_89 = F_47 ( V_4 , V_88 ) ;
F_10 ( & V_2 -> V_4 . V_23 , V_22 ) ;
V_2 -> V_4 . V_49 = F_20 ( V_43 ) |
F_20 ( V_103 ) |
F_20 ( V_66 ) ;
if ( V_84 -> V_104 & V_105 )
V_2 -> V_4 . V_49 |=
...
F_3 ( V_2 , V_31 , - 1 ) ;
F_3 ( V_2 , V_29 , V_87 ) ;
if ( F_50 ( & V_2 -> V_4 , V_84 -> V_91 ) )
F_17 ( & V_2 -> V_4 ) ;
F_11 ( & V_2 -> V_4 . V_23 , V_22 ) ;
}
static const char * F_51 ( struct V_27 * V_4 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
return V_2 -> V_4 . type == V_113 ? L_2 : NULL ;
}
static void F_52 ( struct V_27 * V_4 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
F_53 ( V_2 -> V_4 . V_114 , V_115 ) ;
}
static int F_54 ( struct V_27 * V_4 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
return F_55 ( V_2 -> V_4 . V_114 , V_115 ,
L_1 ) != NULL ? 0 : - V_116 ;
}
static void F_56 ( struct V_27 * V_4 , int V_22 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
if ( V_22 & V_117 &&
...
static int
F_57 ( struct V_27 * V_4 , struct V_118 * V_119 )
{
struct V_1 * V_2 =
F_14 ( V_4 , struct V_1 , V_4 ) ;
int V_120 = 0 ;
...
static void
F_61 ( struct V_135 * V_136 , const char * V_137 , unsigned int V_138 )
{
...
static int T_3
F_63 ( struct V_135 * V_136 , char * V_140 )
{
struct V_1 * V_2 ;
int V_88 = 38400 ;
int V_141 = 8 ;
...
if ( V_140 )
F_64 ( V_140 , & V_88 , & V_46 , & V_141 , & V_142 ) ;
return F_65 ( & V_2 -> V_4 , V_136 , V_88 , V_46 , V_141 , V_142 ) ;
}
...
static int F_68 ( struct V_144 * V_145 , T_4 V_19 )
{
struct V_1 * V_2 = F_69 ( V_145 ) ;
return F_70 ( & V_146 , & V_2 -> V_4 ) ;
}
static int F_71 ( struct V_144 * V_145 )
{
struct V_1 * V_2 = F_69 ( V_145 ) ;
return F_72 ( & V_146 , & V_2 -> V_4 ) ;
}
...
F_74 ( & V_146 , & V_132 [ V_130 ] . V_4 ) ;
F_75 ( V_145 , & V_132 [ V_130 ] ) ;
break;
}
}
return 0 ;
}
static int F_76 ( struct V_144 * V_145 )
{
struct V_1 * V_2 = F_69 ( V_145 ) ;
if ( V_2 )
F_77 ( & V_146 , & V_2 -> V_4 ) ;
