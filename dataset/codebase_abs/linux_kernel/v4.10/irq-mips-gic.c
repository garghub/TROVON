...
if ( V_158 -> type == V_160 ) {
if ( ( V_158 -> V_65 >= V_150 ) &&
F_94 ( F_40 ( V_158 -> V_65 ) , V_161 ) )
return - V_162 ;
return F_89 ( V_64 , V_82 , V_158 -> V_65 ) ;
} else {
V_159 = F_95 ( V_161 , V_93 ) ;
if ( V_159 == V_93 ) {
return - V_163 ;
}
...
F_96 ( V_161 , V_159 , V_155 ) ;
V_81 = 0 ;
F_97 (cpu, spec->ipimask) {
V_65 = F_57 ( V_159 + V_81 ) ;
V_134 = F_90 ( V_64 , V_82 + V_81 , V_65 ,
& V_111 ,
NULL ) ;
if ( V_134 )
goto error;
F_91 ( V_82 + V_81 , V_112 ) ;
...
return 0 ;
error:
F_98 ( V_161 , V_159 , V_155 ) ;
return V_134 ;
}
void F_99 ( struct V_132 * V_64 , unsigned int V_82 ,
unsigned int V_155 )
{
T_3 V_159 ;
struct V_63 * V_164 ;
...
int F_101 ( struct V_132 * V_64 , struct V_165 * V_166 ,
enum V_167 V_168 )
{
return 0 ;
}
static int F_102 ( struct V_132 * V_64 , struct V_165 * V_169 ,
...
static int F_103 ( struct V_132 * V_64 , unsigned int V_82 ,
unsigned int V_155 , void * V_156 )
{
...
V_134 = F_104 ( V_64 , V_82 , V_155 , & V_158 ) ;
if ( V_134 )
return V_134 ;
for ( V_81 = 0 ; V_81 < V_155 ; V_81 ++ ) {
V_134 = F_89 ( V_64 , V_82 + V_81 , V_158 . V_65 + V_81 ) ;
if ( V_134 )
goto error;
}
return 0 ;
error:
F_105 ( V_64 , V_82 , V_155 ) ;
return V_134 ;
}
void F_106 ( struct V_132 * V_64 , unsigned int V_82 ,
unsigned int V_155 )
{
return;
}
static void F_107 ( struct V_132 * V_179 ,
struct V_63 * V_64 )
{
if ( F_79 ( V_64 -> V_65 ) < V_125 )
F_86 ( V_179 , V_64 -> V_59 , V_64 -> V_65 ) ;
else
F_88 ( V_179 , V_64 -> V_59 , V_64 -> V_65 , 0 ) ;
}
static int F_108 ( struct V_132 * V_64 , struct V_165 * V_169 ,
const T_1 * V_170 , unsigned int V_171 ,
T_3 * V_172 ,
unsigned int * V_173 )
{
...
static int F_109 ( struct V_132 * V_64 , unsigned int V_82 ,
unsigned int V_155 , void * V_156 )
{
...
return V_134 ;
for ( V_81 = 0 ; V_81 < V_155 ; V_81 ++ ) {
V_134 = F_90 ( V_64 , V_82 + V_81 ,
F_57 ( V_158 . V_65 + V_81 ) ,
& V_109 ,
NULL ) ;
if ( V_134 )
goto error;
V_134 = F_110 ( V_82 + V_81 , V_102 ) ;
if ( V_134 )
goto error;
}
return 0 ;
...
void F_111 ( struct V_132 * V_64 , unsigned int V_82 ,
unsigned int V_155 )
{
F_105 ( V_64 , V_82 , V_155 ) ;
}
int F_112 ( struct V_132 * V_64 , struct V_165 * V_166 ,
enum V_167 V_168 )
{
bool V_182 ;
switch ( V_168 ) {
...
return ( ! V_166 || F_113 ( V_64 -> V_184 ) == V_166 ) && V_182 ;
break;
default:
return 0 ;
}
}
static void T_5 F_114 ( unsigned long V_185 ,
unsigned long V_186 ,
...
V_202 -> V_168 = V_183 ;
if ( V_166 &&
! F_122 ( V_166 , L_8 , V_189 , 2 ) ) {
F_98 ( V_161 , V_189 [ 0 ] , V_189 [ 1 ] ) ;
} else {
F_98 ( V_161 ,
V_93 - 2 * V_119 ,
2 * V_119 ) ;
...
void T_5 F_123 ( unsigned long V_185 ,
unsigned long V_186 ,
unsigned int V_187 , unsigned int V_188 )
{
F_114 ( V_185 , V_186 , V_187 , V_188 , NULL ) ;
}
static int T_5 F_124 ( struct V_165 * V_166 ,
struct V_165 * V_205 )
{
struct V_72 V_206 ;
...
T_6 V_2 ;
T_7 V_208 ;
while ( ! F_125 ( V_166 , L_9 ,
V_81 ++ , & V_187 ) )
V_207 |= F_126 ( V_187 ) ;
for ( V_187 = 2 ; V_187 < 8 ; V_187 ++ ) {
if ( ! ( V_207 & F_126 ( V_187 ) ) )
break;
}
if ( V_187 == 8 ) {
F_87 ( L_10 ) ;
