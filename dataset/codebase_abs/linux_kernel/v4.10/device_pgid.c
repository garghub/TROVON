...
static void F_38 ( struct V_1 * V_2 , void * V_40 ,
void * V_102 , void * V_103 )
{
struct V_4 * V_5 = F_2 ( V_2 -> V_6 . V_7 ) ;
struct V_21 * V_22 = & V_2 -> V_10 -> V_22 ;
F_29 ( 4 , L_11 ) ;
...
int V_3 ;
if ( V_2 -> V_111 ) {
if ( ! V_2 -> V_10 -> V_100 . V_112 )
return - V_113 ;
}
V_110 = F_40 ( 64 , V_114 | V_115 ) ;
if ( ! V_110 )
return - V_116 ;
F_41 ( & V_40 . V_109 ) ;
V_40 . V_3 = - V_117 ;
F_42 ( V_5 -> V_118 ) ;
V_3 = F_43 ( V_5 , ( V_57 ) ( V_58 ) V_5 ) ;
if ( V_3 )
goto V_119;
V_2 -> V_10 -> V_120 = V_121 ;
F_38 ( V_2 , & V_40 , & V_110 [ 0 ] , & V_110 [ 32 ] ) ;
F_44 ( V_5 -> V_118 ) ;
if ( F_45 ( & V_40 . V_109 ) ) {
F_42 ( V_5 -> V_118 ) ;
F_46 ( V_2 ) ;
