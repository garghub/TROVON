...
void T_3 * V_112 = F_69 ( V_113 ) ;
unsigned int V_20 ;
F_68 (cpu) {
void * V_114 = F_95 ( V_112 , V_20 ) ;
...
return F_99 ( F_56 ( V_3 ) ) +
F_101 ( V_3 ) ;
}
struct V_120 * T_6 F_102 ( int V_121 ,
int V_122 )
{
struct V_120 * V_123 ;
T_2 V_124 , V_125 ;
...
F_103 ( V_123 -> V_127 [ 0 ] . V_128 [ 0 ] ) ) ;
V_125 = V_124 + V_122 * sizeof( V_123 -> V_127 [ 0 ] . V_128 [ 0 ] ) ;
V_32 = F_104 ( F_105 ( V_125 ) , 0 ) ;
if ( ! V_32 )
return NULL ;
V_123 = V_32 ;
V_32 += V_124 ;
...
V_123 -> V_121 = V_121 ;
V_123 -> V_130 = F_105 ( V_125 ) ;
return V_123 ;
}
void T_6 F_106 ( struct V_120 * V_123 )
{
F_107 ( F_98 ( V_123 ) , V_123 -> V_130 ) ;
}
static void F_108 ( const char * V_131 ,
...
while ( V_139 /= 10 )
V_133 ++ ;
V_135 [ F_110 ( int , V_133 , sizeof( V_135 ) - 1 ) ] = '\0' ;
V_140 = V_123 -> V_142 / V_123 -> V_143 ;
V_134 = V_140 * ( V_133 + 1 ) + V_132 + 3 ;
V_141 = F_111 ( F_7 ( 60 / V_134 , 1 ) ) ;
F_112 ( L_10 ,
...
int T_6 F_114 ( const struct V_120 * V_123 ,
void * V_6 )
{
...
F_115 ( ! V_6 ) ;
F_115 ( F_101 ( V_6 ) ) ;
F_115 ( V_123 -> V_143 < V_154 ) ;
F_115 ( F_101 ( V_123 -> V_143 ) ) ;
F_115 ( V_123 -> V_143 < V_92 ) ;
F_115 ( V_123 -> V_145 < V_161 ) ;
F_115 ( F_116 ( V_123 ) < 0 ) ;
V_157 = F_117 ( V_123 -> V_121 *
sizeof( V_157 [ 0 ] ) , 0 ) ;
V_158 = F_117 ( V_123 -> V_121 *
sizeof( V_158 [ 0 ] ) , 0 ) ;
V_160 = F_117 ( V_162 * sizeof( V_160 [ 0 ] ) , 0 ) ;
V_159 = F_117 ( V_162 * sizeof( V_159 [ 0 ] ) , 0 ) ;
...
V_155 -> V_6 = V_6 ;
V_155 -> V_35 = V_150 ;
V_155 -> V_49 = F_120 ( V_150 ) ;
V_155 -> V_97 = true ;
F_121 ( V_155 -> V_29 , V_23 ) ;
V_155 -> V_83 = V_23 ;
if ( V_123 -> V_144 ) {
...
static int T_6 F_122 ( char * V_171 )
{
if ( ! V_171 )
return - V_172 ;
if ( 0 )
...
V_154 = F_105 ( V_109 + V_144 +
F_29 ( T_2 , V_145 , V_161 ) ) ;
V_145 = V_154 - V_109 - V_144 ;
V_179 = F_29 ( T_2 , V_154 , V_92 ) ;
V_142 = F_126 ( V_179 , V_146 ) ;
V_140 = V_142 / V_179 ;
while ( V_142 % V_140 || ( F_101 ( V_142 / V_140 ) ) )
V_140 -- ;
V_180 = V_140 ;
F_68 (cpu) {
V_138 = 0 ;
...
int V_188 = 0 , V_189 = 0 ;
if ( V_142 % V_140 || ( F_101 ( V_142 / V_140 ) ) )
continue;
for ( V_138 = 0 ; V_138 < V_121 ; V_138 ++ ) {
int V_190 = F_127 ( V_178 [ V_138 ] , V_140 ) ;
V_188 += V_190 ;
...
V_140 = V_182 ;
for ( V_138 = 0 ; V_138 < V_121 ; V_138 ++ )
V_122 += F_126 ( V_178 [ V_138 ] , V_140 ) ;
V_123 = F_102 ( V_121 , V_122 ) ;
if ( ! V_123 )
return F_128 ( - V_61 ) ;
V_128 = V_123 -> V_127 [ 0 ] . V_128 ;
for ( V_138 = 0 ; V_138 < V_121 ; V_138 ++ ) {
V_123 -> V_127 [ V_138 ] . V_128 = V_128 ;
V_128 += F_126 ( V_178 [ V_138 ] , V_140 ) ;
}
V_123 -> V_109 = V_109 ;
V_123 -> V_144 = V_144 ;
V_123 -> V_145 = V_145 ;
...
V_148 -> V_122 = F_126 ( V_148 -> V_122 , V_140 ) ;
V_126 += V_148 -> V_122 ;
}
F_46 ( V_126 != V_122 ) ;
return V_123 ;
}
int T_6 F_129 ( T_2 V_144 , T_2 V_145 ,
T_2 V_146 ,
T_8 V_176 ,
T_9 V_191 ,
T_10 V_192 )
...
V_123 = F_125 ( V_144 , V_145 , V_146 ,
V_176 ) ;
if ( F_130 ( V_123 ) )
return F_131 ( V_123 ) ;
V_154 = V_123 -> V_109 + V_123 -> V_144 + V_123 -> V_145 ;
V_195 = F_105 ( V_123 -> V_121 * sizeof( void * ) ) ;
V_194 = F_104 ( V_195 , 0 ) ;
if ( ! V_194 ) {
V_198 = - V_61 ;
goto V_199;
...
V_123 = F_125 ( V_144 , 0 , V_30 , NULL ) ;
if ( F_130 ( V_123 ) )
return F_131 ( V_123 ) ;
F_46 ( V_123 -> V_121 != 1 ) ;
V_140 = V_123 -> V_142 / V_123 -> V_143 ;
V_210 = F_126 ( F_109 () , V_140 ) ;
if ( F_58 ( F_65 ( V_123 -> V_127 [ 0 ] . V_122 != V_210 ) ) ) {
F_106 ( V_123 ) ;
return - V_172 ;
}
...
F_132 ( V_32 ) ;
V_209 [ V_78 ++ ] = F_134 ( V_32 ) ;
}
}
V_205 . V_59 = V_212 ;
V_205 . V_9 = F_109 () * V_123 -> V_143 ;
F_135 ( & V_205 , V_30 ) ;
for ( V_126 = 0 ; V_126 < F_109 () ; V_126 ++ ) {
unsigned long V_213 =
( unsigned long ) V_205 . V_3 + V_126 * V_123 -> V_143 ;
for ( V_33 = 0 ; V_33 < V_207 ; V_33 ++ )
V_203 ( V_213 + ( V_33 << V_25 ) ) ;
V_198 = F_136 ( V_213 , & V_209 [ V_126 * V_207 ] ,
V_207 ) ;
if ( V_198 < 0 )
F_137 ( L_23 , V_198 ) ;
memcpy ( ( void * ) V_213 , V_202 , V_123 -> V_109 ) ;
}
F_73 ( L_24 ,
V_207 , V_206 , V_205 . V_3 , V_123 -> V_109 ,
V_123 -> V_144 , V_123 -> V_145 ) ;
V_198 = F_114 ( V_123 , V_205 . V_3 ) ;
goto V_214;
V_211:
while ( -- V_78 >= 0 )
V_192 ( F_138 ( V_209 [ V_78 ] ) , V_30 ) ;
V_198 = - V_61 ;
V_214:
...
if ( V_198 < 0 )
F_137 ( L_25 ) ;
V_216 = ( unsigned long ) V_113 - ( unsigned long ) V_111 ;
F_68 (cpu)
V_219 [ V_20 ] = V_216 + V_24 [ V_20 ] ;
}
void T_6 F_142 ( void )
{
const T_2 V_143 =
...
unsigned long V_59 ;
int V_33 ;
for ( V_33 = 0 ; ( V_14 = V_221 [ V_33 ] ) ; V_33 ++ ) {
int * V_35 ;
