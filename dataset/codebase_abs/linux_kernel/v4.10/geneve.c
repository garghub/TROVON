...
F_151 ( V_60 , & V_213 ) ;
V_60 -> V_214 |= V_215 ;
V_60 -> V_214 |= V_216 | V_217 ;
V_60 -> V_214 |= V_218 ;
V_60 -> V_214 |= V_219 ;
V_60 -> V_220 |= V_216 | V_217 | V_218 ;
V_60 -> V_220 |= V_219 ;
V_60 -> V_221 = V_222 ;
V_60 -> V_199 = V_223 - V_80 - V_60 -> V_224 ;
F_152 ( V_60 ) ;
V_60 -> V_225 &= ~ V_226 ;
V_60 -> V_225 |= V_227 | V_228 ;
F_153 ( V_60 ) ;
}
static int F_154 ( struct V_229 * V_230 [] , struct V_229 * V_112 [] )
{
if ( V_230 [ V_231 ] ) {
if ( F_155 ( V_230 [ V_231 ] ) != V_232 )
return - V_192 ;
if ( ! F_156 ( F_157 ( V_230 [ V_231 ] ) ) )
return - V_233 ;
}
if ( ! V_112 )
return - V_192 ;
if ( V_112 [ V_234 ] ) {
T_1 V_1 = F_158 ( V_112 [ V_234 ] ) ;
if ( V_1 >= V_235 )
return - V_236 ;
}
return 0 ;
...
static bool F_160 ( const T_2 * V_240 , T_9 V_241 )
{
int V_242 ;
...
{
struct V_119 * V_120 = F_76 ( V_85 , V_121 ) ;
struct V_12 * V_239 , * V_16 = F_40 ( V_60 ) ;
bool V_238 , V_237 ;
int V_46 , V_243 ;
if ( V_145 && ! F_161 ( V_19 ) )
return - V_192 ;
V_16 -> V_85 = V_85 ;
V_16 -> V_60 = V_60 ;
V_239 = F_159 ( V_120 , V_19 , & V_237 , & V_238 ) ;
if ( V_239 )
return - V_244 ;
V_243 = V_80 + V_61 ;
if ( F_143 ( V_19 ) == V_31 ) {
V_243 += sizeof( struct V_32 ) ;
V_60 -> V_199 -= sizeof( struct V_32 ) ;
} else {
V_243 += sizeof( struct V_39 ) ;
V_60 -> V_199 -= sizeof( struct V_39 ) ;
}
V_60 -> V_245 = V_243 + V_61 ;
if ( V_145 ) {
if ( V_237 )
return - V_246 ;
} else {
...
struct V_229 * V_230 [] , struct V_229 * V_112 [] )
{
bool V_93 = false ;
struct V_147 V_19 ;
bool V_145 = false ;
F_165 ( & V_19 , V_248 ) ;
if ( V_112 [ V_249 ] && V_112 [ V_250 ] )
return - V_192 ;
if ( V_112 [ V_249 ] ) {
...
T_1 V_1 ;
T_4 V_253 [ 3 ] ;
V_1 = F_158 ( V_112 [ V_234 ] ) ;
V_253 [ 0 ] = ( V_1 & 0x00ff0000 ) >> 16 ;
V_253 [ 1 ] = ( V_1 & 0x0000ff00 ) >> 8 ;
V_253 [ 2 ] = V_1 & 0x000000ff ;
V_19 . V_20 . V_6 = F_3 ( V_253 ) ;
}
if ( V_112 [ V_254 ] )
V_19 . V_20 . V_185 = F_173 ( V_112 [ V_254 ] ) ;
if ( V_112 [ V_255 ] )
V_19 . V_20 . V_65 = F_173 ( V_112 [ V_255 ] ) ;
if ( V_112 [ V_256 ] ) {
V_19 . V_20 . V_181 = F_174 ( V_112 [ V_256 ] ) &
V_257 ;
if ( V_19 . V_20 . V_181 && ( ! ( V_19 . V_143 & V_144 ) ) )
return - V_192 ;
}
if ( V_112 [ V_258 ] )
V_19 . V_20 . V_141 = F_175 ( V_112 [ V_258 ] ) ;
if ( V_112 [ V_259 ] )
V_145 = true ;
if ( V_112 [ V_260 ] &&
! F_173 ( V_112 [ V_260 ] ) )
...
static void F_176 ( struct V_74 * V_60 , struct V_263 * V_99 )
{
struct V_12 * V_16 = F_40 ( V_60 ) ;
F_86 ( & V_16 -> V_110 ) ;
F_177 ( V_60 , V_99 ) ;
...
T_4 V_264 [ 3 ] ;
T_1 V_1 ;
F_5 ( V_19 -> V_20 . V_6 , V_264 ) ;
V_1 = ( V_264 [ 0 ] << 16 ) | ( V_264 [ 1 ] << 8 ) | V_264 [ 2 ] ;
if ( F_181 ( V_29 , V_234 , V_1 ) )
goto V_265;
if ( F_143 ( V_19 ) == V_31 ) {
if ( F_182 ( V_29 , V_249 ,
V_19 -> V_20 . V_21 . V_22 . V_23 ) )
...
if ( F_183 ( V_29 , V_254 , V_19 -> V_20 . V_185 ) ||
F_183 ( V_29 , V_255 , V_19 -> V_20 . V_65 ) ||
F_185 ( V_29 , V_256 , V_19 -> V_20 . V_181 ) )
goto V_265;
if ( F_186 ( V_29 , V_258 , V_19 -> V_20 . V_141 ) )
goto V_265;
if ( V_16 -> V_34 ) {
if ( F_187 ( V_29 , V_259 ) )
goto V_265;
...
struct V_74 * F_188 ( struct V_85 * V_85 , const char * V_267 ,
T_2 V_268 , T_11 V_139 )
{
struct V_229 * V_230 [ V_269 + 1 ] ;
struct V_147 V_19 ;
struct V_74 * V_60 ;
F_189 ( V_270 ) ;
int V_46 ;
memset ( V_230 , 0 , sizeof( V_230 ) ) ;
V_60 = F_190 ( V_85 , V_267 , V_268 ,
& V_271 , V_230 ) ;
if ( F_78 ( V_60 ) )
return V_60 ;
F_165 ( & V_19 , V_139 ) ;
...
V_46 = F_141 ( V_60 , V_223 ) ;
if ( V_46 )
goto V_46;
V_46 = F_191 ( V_60 , NULL ) ;
if ( V_46 < 0 )
goto V_46;
return V_60 ;
V_46:
...
unsigned long V_274 , void * V_275 )
{
struct V_74 * V_60 = F_194 ( V_275 ) ;
if ( V_274 == V_276 )
F_146 ( V_60 ) ;
return V_277 ;
}
static T_12 int F_195 ( struct V_85 * V_85 )
{
struct V_119 * V_120 = F_76 ( V_85 , V_121 ) ;
F_196 ( & V_120 -> V_247 ) ;
F_196 ( & V_120 -> V_133 ) ;
...
static void T_13 F_197 ( struct V_85 * V_85 )
{
struct V_119 * V_120 = F_76 ( V_85 , V_121 ) ;
struct V_12 * V_16 , * V_110 ;
struct V_74 * V_60 , * V_278 ;
F_189 ( V_132 ) ;
F_198 () ;
F_199 (net, dev, aux)
if ( V_60 -> V_279 == & V_271 )
