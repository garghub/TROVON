...
static void F_75 ( T_4 V_161 , int V_162 , struct V_163 * V_164 )
{
struct V_165 * V_166 ;
struct V_18 * V_167 ;
int V_17 ;
...
V_166 = F_76 ( V_161 , V_162 , V_169 , 1 , 1 , NULL , 0 ) ;
if ( V_166 )
F_77 ( V_164 , V_166 ) ;
}
static void F_78 ( char * V_66 , struct V_18 * V_20 , int V_170 )
{
struct V_171 * V_172 ;
T_5 V_173 = F_79 ( & V_174 , F_80 ( V_175 ) ) ;
unsigned int V_176 = F_81 ( V_175 ) ;
if ( ! V_177 )
return;
V_172 = F_82 ( NULL , V_29 , V_178 ) ;
if ( ! V_172 )
return;
F_83 ( V_172 , L_3 , V_173 , V_176 ) ;
F_84 ( V_172 ) ;
F_83 ( V_172 , L_4 , V_66 ) ;
F_85 ( V_172 , V_20 -> V_24 ) ;
F_83 ( V_172 , L_5 , V_20 -> V_39 , V_170 ) ;
F_86 ( V_172 ) ;
}
int F_87 ( int type , T_4 V_161 , int V_162 , void * V_116 ,
T_2 V_117 )
{
int V_61 = 0 ;
struct V_15 * V_28 ;
...
int F_89 ( struct V_165 * V_181 , int V_162 )
{
T_1 V_161 = F_90 ( V_181 ) . V_161 ;
struct V_182 * V_182 = F_91 ( F_90 ( V_181 ) . V_183 ) ;
struct V_184 * V_185 ;
struct V_186 * V_187 ;
int V_61 = 0 ;
...
break;
case V_83 :
V_205 = F_98 ( F_80 ( V_175 ) ,
V_2 -> V_43 , V_2 -> V_128 ) ;
break;
case V_108 :
V_205 = F_96 ( F_117 ( V_175 ) ,
V_2 -> V_43 , V_2 -> V_59 ) ;
break;
case V_78 :
...
static int F_121 ( struct V_18 * V_167 )
{
struct V_15 * V_28 = F_7 ( V_167 , struct V_15 , V_20 ) ;
struct V_15 * V_208 ;
int V_61 = 0 ;
if ( ! F_122 ( V_167 ) )
return 0 ;
...
if ( V_167 -> V_21 || V_167 -> V_42 )
F_124 ( & V_167 -> V_209 , & V_208 -> V_20 . V_209 ) ;
F_125 ( & V_28 -> V_47 , & V_208 -> V_47 ) ;
F_126 ( & V_167 -> V_47 , & V_208 -> V_20 . V_47 ) ;
}
F_74 ( & V_28 -> V_27 , F_6 ) ;
return V_61 ;
}
int F_127 ( void )
{
struct V_18 * V_167 , * V_50 ;
int V_17 , V_61 = 0 ;
F_60 ( & V_153 ) ;
for ( V_17 = 0 ; V_17 < V_168 ; V_17 ++ ) {
F_128 (r, n, &audit_rules_list[i], list) {
int V_170 = F_121 ( V_167 ) ;
if ( ! V_61 )
V_61 = V_170 ;
}
}
