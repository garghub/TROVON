...
break;
default:
return F_61 ( V_74 , V_132 , V_133 , V_134 ) ;
}
return 0 ;
}
static void
F_62 ( struct V_70 * V_74 , struct V_142 * V_143 )
{
struct V_1 * V_2 = V_74 -> V_17 ;
...
static struct V_79 *
F_65 ( struct V_85 * V_86 , struct V_170 * V_168 ,
int V_171 )
{
int V_172 ;
struct V_23 * V_23 ;
...
V_23 -> V_80 = V_80 ;
F_69 ( V_23 ) ;
V_172 = F_70 ( V_23 , NULL , V_168 , V_171 ) ;
if ( V_172 )
goto V_174;
return V_80 ;
V_174:
...
static int
F_72 ( struct V_79 * V_80 , int V_175 )
{
struct V_23 * V_23 = V_80 -> V_17 ;
int V_7 ;
V_7 = F_73 ( & V_23 -> V_176 ,
...
F_44 ( V_23 ) ;
if ( V_23 -> V_1 ) {
F_76 ( & V_23 -> V_179 , V_180 ) ;
F_77 ( V_181 , & V_23 -> V_179 ) ;
F_14 ( & V_23 -> V_31 ) ;
} else {
V_23 -> V_32 = V_178 ;
F_14 ( & V_23 -> V_31 ) ;
...
static T_10 F_79 ( int V_182 , int V_132 )
{
switch ( V_182 ) {
case V_183 :
switch ( V_132 ) {
...
static int F_80 ( struct V_215 * V_216 )
{
struct V_101 * V_82 ;
struct V_23 * V_23 ;
struct V_36 * V_217 ;
V_82 = F_81 ( F_82 ( V_216 ) ) -> V_17 ;
V_23 = V_82 -> V_218 -> V_17 ;
V_217 = V_23 -> V_26 . V_25 -> V_36 ;
if ( ! ( V_217 -> V_118 . V_219 & V_220 ) )
F_83 ( V_216 -> V_221 , ~ V_222 ) ;
return 0 ;
}
