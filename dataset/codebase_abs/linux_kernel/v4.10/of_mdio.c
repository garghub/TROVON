...
struct V_14 * F_38 ( struct V_39 * V_20 ,
struct V_1 * V_34 ,
void (* F_39)( struct V_39 * ) , T_1 V_37 ,
T_2 V_40 )
{
...
if ( ! V_34 )
return NULL ;
V_15 = F_38 ( V_20 , V_34 , F_39 , 0 , V_40 ) ;
F_13 ( V_34 ) ;
return V_15 ;
}
