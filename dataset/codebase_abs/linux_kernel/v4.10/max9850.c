...
{
F_9 ( V_13 , V_55 , 1 , 1 ) ;
F_9 ( V_13 , V_56 , 0x40 , 0x40 ) ;
F_9 ( V_13 , V_57 , 0xff , 0xc0 ) ;
return 0 ;
}
...
struct V_14 * V_15 ;
int V_49 ;
V_15 = F_18 ( & V_59 -> V_2 , sizeof( struct V_14 ) ,
V_62 ) ;
if ( V_15 == NULL )
return - V_63 ;
V_15 -> V_54 = F_19 ( V_59 , & V_64 ) ;
if ( F_20 ( V_15 -> V_54 ) )
return F_21 ( V_15 -> V_54 ) ;
F_22 ( V_59 , V_15 ) ;
V_49 = F_23 ( & V_59 -> V_2 ,
& V_65 , & V_66 , 1 ) ;
return V_49 ;
}
static int F_24 ( struct V_58 * V_67 )
{
F_25 ( & V_67 -> V_2 ) ;
return 0 ;
}
