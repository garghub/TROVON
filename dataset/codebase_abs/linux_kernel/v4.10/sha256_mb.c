...
static struct V_2 * F_14 ( struct V_28 * V_29 ,
struct V_2 * V_7 ,
const void * V_34 ,
T_1 V_36 ,
int V_46 )
...
V_56 [ V_25 ] = F_21 ( V_55 -> V_39 . V_52 [ V_25 ] ) ;
return 0 ;
}
static int F_22 ( struct V_1 * * V_58 ,
...
{
unsigned long V_76 ;
unsigned long V_77 = F_35 ( V_78 ) ;
V_8 -> V_79 . V_80 = V_81 ;
V_8 -> V_79 . V_82 = V_60 -> V_83 ++ ;
V_76 = V_8 -> V_79 . V_80 + V_77 ;
V_8 -> V_79 . V_84 = V_76 ;
F_28 ( & V_60 -> V_72 ) ;
F_36 ( & V_8 -> V_73 , & V_60 -> V_85 ) ;
F_30 ( & V_60 -> V_72 ) ;
F_37 ( V_60 , V_77 ) ;
}
...
struct V_2 * V_64 ;
int V_71 = 0 , V_62 ;
if ( V_8 -> V_79 . V_88 != F_40 () ) {
F_41 ( L_1 ) ;
goto V_89;
}
F_4 ( V_8 , V_5 ) ;
V_62 = F_42 ( V_69 , & V_8 -> V_66 ) ;
if ( V_62 < 0 ) {
V_71 = V_62 ;
goto V_89;
}
...
static int F_45 ( struct V_4 * V_5 , void * V_57 )
{
struct V_2 * V_55 = F_18 ( V_5 ) ;
memcpy ( V_57 , V_55 , sizeof( * V_55 ) ) ;
return 0 ;
}
static int F_46 ( struct V_4 * V_5 , const void * V_91 )
{
struct V_2 * V_55 = F_18 ( V_5 ) ;
...
static int F_60 ( struct V_4 * V_69 )
{
struct V_101 * V_93 = F_61 ( V_69 ) ;
struct V_96 * V_7 = F_52 ( V_93 ) ;
struct V_4 * V_102 = F_18 ( V_69 ) ;
struct V_94 * V_95 = V_7 -> V_95 ;
memcpy ( V_102 , V_69 , sizeof( * V_69 ) ) ;
F_62 ( V_102 , & V_95 -> V_75 ) ;
return F_63 ( V_102 ) ;
}
static int F_64 ( struct V_4 * V_69 )
{
struct V_4 * V_102 = F_18 ( V_69 ) ;
struct V_101 * V_93 = F_61 ( V_69 ) ;
struct V_96 * V_7 = F_52 ( V_93 ) ;
...
static int F_66 ( struct V_4 * V_69 )
{
struct V_4 * V_102 = F_18 ( V_69 ) ;
struct V_101 * V_93 = F_61 ( V_69 ) ;
struct V_96 * V_7 = F_52 ( V_93 ) ;
...
static int F_68 ( struct V_4 * V_69 )
{
struct V_4 * V_102 = F_18 ( V_69 ) ;
struct V_101 * V_93 = F_61 ( V_69 ) ;
struct V_96 * V_7 = F_52 ( V_93 ) ;
...
static int F_70 ( struct V_4 * V_69 )
{
struct V_101 * V_93 = F_61 ( V_69 ) ;
struct V_96 * V_7 = F_52 ( V_93 ) ;
struct V_4 * V_102 = F_18 ( V_69 ) ;
...
static int F_72 ( struct V_4 * V_69 , void * V_57 )
{
struct V_4 * V_102 = F_18 ( V_69 ) ;
struct V_101 * V_93 = F_61 ( V_69 ) ;
struct V_96 * V_7 = F_52 ( V_93 ) ;
...
memcpy ( V_102 , V_69 , sizeof( * V_69 ) ) ;
F_62 ( V_102 , & V_95 -> V_75 ) ;
return F_73 ( V_102 , V_57 ) ;
}
static int F_74 ( struct V_4 * V_69 , const void * V_91 )
{
struct V_4 * V_102 = F_18 ( V_69 ) ;
struct V_101 * V_93 = F_61 ( V_69 ) ;
struct V_96 * V_7 = F_52 ( V_93 ) ;
struct V_94 * V_95 = V_7 -> V_95 ;
struct V_101 * V_103 = F_75 ( V_95 ) ;
struct V_1 * V_8 ;
struct V_4 * V_5 ;
memcpy ( V_102 , V_69 , sizeof( * V_69 ) ) ;
F_62 ( V_102 , & V_95 -> V_75 ) ;
...
F_76 ( V_5 , V_104 ,
V_8 -> V_74 , V_69 ) ;
return F_77 ( V_102 , V_91 ) ;
}
static unsigned long F_78 ( struct V_59 * V_60 )
{
struct V_1 * V_8 ;
unsigned long V_105 ;
...
struct V_2 * V_64 ;
V_105 = V_81 ;
while ( ! F_79 ( & V_60 -> V_85 ) ) {
V_8 = F_80 ( V_60 -> V_85 . V_106 ,
struct V_1 , V_73 ) ;
if ( F_81 ( V_105 , V_8 -> V_79 . V_84 ) )
break;
F_25 () ;
V_64 = (struct V_2 * )
F_15 ( V_60 -> V_29 ) ;
...
return - V_115 ;
F_86 (cpu) {
V_107 = F_87 ( V_86 . V_87 , V_88 ) ;
V_107 -> V_76 = 0 ;
V_107 -> V_83 = 0 ;
V_107 -> V_116 = false ;
F_88 ( & V_107 -> V_61 , V_117 ) ;
V_107 -> V_88 = V_88 ;
V_107 -> V_100 = & V_86 ;
V_107 -> V_29 = F_89 ( sizeof( struct V_28 ) ,
V_118 ) ;
if ( ! V_107 -> V_29 )
goto V_119;
F_12 ( V_107 -> V_29 ) ;
