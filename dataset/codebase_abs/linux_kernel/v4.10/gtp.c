...
V_37 = ! F_28 ( F_29 ( V_50 ) , F_30 ( V_8 -> V_44 ) ) ;
...
static int F_37 ( struct V_63 * V_44 )
{
struct V_7 * V_8 = F_38 ( V_44 ) ;
V_8 -> V_44 = V_44 ;
V_44 -> V_58 = F_39 ( struct V_54 ) ;
if ( ! V_44 -> V_58 )
return - V_64 ;
return 0 ;
}
static void F_40 ( struct V_63 * V_44 )
{
struct V_7 * V_8 = F_38 ( V_44 ) ;
F_22 ( V_8 ) ;
F_41 ( V_44 -> V_58 ) ;
}
static struct V_65 * F_42 ( struct V_66 * V_66 , struct V_67 * V_68 ,
const struct V_53 * V_50 , T_3 V_69 )
{
memset ( V_68 , 0 , sizeof( * V_68 ) ) ;
V_68 -> V_70 = V_50 -> V_71 ;
V_68 -> V_69 = V_69 ;
V_68 -> V_34 = F_43 ( V_50 ) -> V_72 ;
V_68 -> V_73 = F_44 ( V_50 ) ;
V_68 -> V_74 = V_50 -> V_75 ;
return F_45 ( V_66 , V_68 ) ;
}
static inline void F_46 ( struct V_27 * V_28 , struct V_6 * V_29 )
{
int V_76 = V_28 -> V_62 ;
struct V_39 * V_40 ;
V_40 = (struct V_39 * ) F_47 ( V_28 , sizeof( * V_40 ) ) ;
V_40 -> V_42 = 0x1e ;
V_40 -> type = V_43 ;
V_40 -> V_77 = F_48 ( V_76 ) ;
V_40 -> V_78 = F_48 ( ( F_49 ( & V_29 -> V_79 ) - 1 ) % 0xffff ) ;
V_40 -> V_80 = F_48 ( V_29 -> V_16 . V_17 . V_80 ) ;
V_40 -> V_81 = 0xff ;
V_40 -> V_82 [ 0 ] = V_40 -> V_82 [ 1 ] = V_40 -> V_82 [ 2 ] = 0xff ;
V_40 -> V_1 = F_50 ( V_29 -> V_16 . V_17 . V_1 ) ;
}
static inline void F_51 ( struct V_27 * V_28 , struct V_6 * V_29 )
{
int V_76 = V_28 -> V_62 ;
struct V_46 * V_47 ;
V_47 = (struct V_46 * ) F_47 ( V_28 , sizeof( * V_47 ) ) ;
V_47 -> V_42 = 0x30 ;
V_47 -> type = V_43 ;
V_47 -> V_77 = F_48 ( V_76 ) ;
V_47 -> V_1 = F_52 ( V_29 -> V_16 . V_19 . V_83 ) ;
}
static void F_53 ( struct V_27 * V_28 , struct V_84 * V_85 )
{
...
struct V_6 * V_29 , struct V_65 * V_89 ,
struct V_67 * V_68 ,
struct V_63 * V_44 )
{
V_85 -> V_50 = V_50 ;
...
static int F_55 ( struct V_27 * V_28 , struct V_63 * V_44 ,
struct V_84 * V_85 )
{
struct V_7 * V_8 = F_38 ( V_44 ) ;
struct V_6 * V_29 ;
...
V_89 = F_42 ( F_29 ( V_50 ) , & V_68 , V_8 -> V_49 -> V_50 ,
V_29 -> V_93 . V_26 ) ;
if ( F_57 ( V_89 ) ) {
F_17 ( V_44 , L_12 ,
& V_29 -> V_93 . V_26 ) ;
...
if ( ! F_60 ( V_28 ) && ( V_32 -> V_99 & F_48 ( V_103 ) ) &&
...
F_54 ( V_85 , V_50 , V_32 , V_29 , V_89 , & V_68 , V_44 ) ;
F_53 ( V_28 , V_85 ) ;
return 0 ;
V_98:
F_63 ( V_89 ) ;
...
static T_5 F_64 ( struct V_27 * V_28 , struct V_63 * V_44 )
{
...
static void F_70 ( struct V_63 * V_44 )
{
V_44 -> V_115 = & V_116 ;
V_44 -> V_117 = V_118 ;
V_44 -> V_100 = 0 ;
...
static int F_72 ( struct V_66 * V_129 , struct V_63 * V_44 ,
...
V_95 = F_74 ( V_44 , V_8 , V_133 , V_134 ) ;
if ( V_95 < 0 )
goto V_140;
if ( ! V_33 [ V_141 ] )
V_132 = 1024 ;
...
static void F_80 ( struct V_63 * V_44 , struct V_147 * V_10 )
{
struct V_7 * V_8 = F_38 ( V_44 ) ;
F_22 ( V_8 ) ;
F_79 ( V_8 ) ;
...
static T_6 F_84 ( const struct V_63 * V_44 )
{
return F_85 ( sizeof( V_148 ) ) ;
}
static int F_86 ( struct V_27 * V_28 , const struct V_63 * V_44 )
{
struct V_7 * V_8 = F_38 ( V_44 ) ;
...
static struct V_66 * F_88 ( struct V_66 * V_129 , struct V_130 * V_131 [] )
{
struct V_66 * V_66 ;
if ( V_131 [ V_151 ] )
V_66 = F_89 ( F_73 ( V_131 [ V_151 ] ) ) ;
else
V_66 = F_90 ( V_129 ) ;
return V_66 ;
}
...
static int F_74 ( struct V_63 * V_44 , struct V_7 * V_8 ,
int V_159 , int V_160 )
{
...
V_162 . V_168 = F_25 ;
V_162 . V_51 = V_56 ;
F_98 ( F_29 ( V_8 -> V_49 -> V_50 ) , V_8 -> V_49 , & V_162 ) ;
V_162 . V_51 = V_57 ;
F_98 ( F_29 ( V_8 -> V_52 -> V_50 ) , V_8 -> V_52 , & V_162 ) ;
V_95 = 0 ;
V_165:
F_99 ( V_52 ) ;
V_155:
...
static struct V_63 * F_100 ( struct V_66 * V_66 , int V_169 )
{
struct V_135 * V_136 = F_77 ( V_66 , V_144 ) ;
struct V_7 * V_8 ;
...
static int F_106 ( struct V_63 * V_44 , struct V_170 * V_171 )
{
struct V_7 * V_8 = F_38 ( V_44 ) ;
T_1 V_180 , V_181 = 0 ;
struct V_6 * V_29 ;
...
V_66 = F_88 ( F_29 ( V_28 -> V_50 ) , V_171 -> V_172 ) ;
if ( F_57 ( V_66 ) )
return F_110 ( V_66 ) ;
V_44 = F_100 ( V_66 , F_73 ( V_171 -> V_172 [ V_188 ] ) ) ;
if ( V_44 == NULL ) {
F_111 ( V_66 ) ;
return - V_189 ;
}
...
struct V_66 * V_66 = F_29 ( V_28 -> V_50 ) ;
struct V_135 * V_136 = F_77 ( V_66 , V_144 ) ;
...
static int T_7 F_126 ( struct V_66 * V_66 )
{
struct V_135 * V_136 = F_77 ( V_66 , V_144 ) ;
F_127 ( & V_136 -> V_146 ) ;
return 0 ;
}
static void T_8 F_128 ( struct V_66 * V_66 )
{
struct V_135 * V_136 = F_77 ( V_66 , V_144 ) ;
struct V_7 * V_8 ;
F_129 ( V_145 ) ;
