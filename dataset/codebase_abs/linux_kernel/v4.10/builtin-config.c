...
int F_11 ( int V_17 , const char * * V_18 , const char * T_2 V_19 )
{
int V_20 , V_21 = 0 ;
struct V_1 * V_2 ;
char * V_22 = F_12 ( L_13 , getenv ( L_14 ) ) ;
...
default:
if ( V_17 ) {
for ( V_20 = 0 ; V_18 [ V_20 ] ; V_20 ++ ) {
char * V_4 , * V_5 ;
char * V_15 = F_17 ( V_18 [ V_20 ] ) ;
if ( ! V_15 ) {
F_9 ( L_22 , V_32 ) ;
V_21 = - 1 ;
break;
