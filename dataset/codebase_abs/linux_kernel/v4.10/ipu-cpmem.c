...
int F_28 ( struct V_2 * V_3 , T_2 V_108 )
{
switch ( V_108 ) {
case V_38 :
case V_42 :
...
int F_29 ( struct V_2 * V_3 , struct V_137 * V_138 )
{
struct V_139 * V_140 = & V_138 -> V_140 ;
int V_88 , V_105 , V_106 ;
F_3 ( L_2 ,
V_19 , V_140 -> V_102 , V_140 -> V_141 ,
V_140 -> V_142 ) ;
F_9 ( V_3 , V_138 -> V_143 . V_102 , V_138 -> V_143 . V_141 ) ;
F_10 ( V_3 , V_140 -> V_142 ) ;
F_28 ( V_3 , F_7 ( V_140 -> V_22 ) ) ;
switch ( V_140 -> V_22 ) {
case V_37 :
V_88 = F_30 ( V_140 , V_138 -> V_143 . V_144 , V_138 -> V_143 . V_145 ) ;
V_105 = F_31 ( V_140 , V_138 -> V_143 . V_144 ,
V_138 -> V_143 . V_145 ) - V_88 ;
V_106 = F_32 ( V_140 , V_138 -> V_143 . V_144 ,
V_138 -> V_143 . V_145 ) - V_88 ;
F_27 ( V_3 , V_140 -> V_142 / 2 ,
V_105 , V_106 ) ;
break;
case V_41 :
V_88 = F_30 ( V_140 , V_138 -> V_143 . V_144 , V_138 -> V_143 . V_145 ) ;
...
case V_39 :
V_88 = F_30 ( V_140 , V_138 -> V_143 . V_144 , V_138 -> V_143 . V_145 ) ;
V_105 = F_33 ( V_140 , V_138 -> V_143 . V_144 ,
V_138 -> V_143 . V_145 ) - V_88 ;
V_106 = F_34 ( V_140 , V_138 -> V_143 . V_144 ,
V_138 -> V_143 . V_145 ) - V_88 ;
F_27 ( V_3 , V_140 -> V_142 / 2 ,
V_105 , V_106 ) ;
break;
case V_43 :
V_88 = F_30 ( V_140 , V_138 -> V_143 . V_144 , V_138 -> V_143 . V_145 ) ;
V_105 = F_35 ( V_140 , V_138 -> V_143 . V_144 ,
V_138 -> V_143 . V_145 ) - V_88 ;
V_106 = 0 ;
F_27 ( V_3 , V_140 -> V_142 ,
V_105 , V_106 ) ;
break;
case V_45 :
V_88 = F_30 ( V_140 , V_138 -> V_143 . V_144 , V_138 -> V_143 . V_145 ) ;
V_105 = F_36 ( V_140 , V_138 -> V_143 . V_144 ,
V_138 -> V_143 . V_145 ) - V_88 ;
V_106 = 0 ;
F_27 ( V_3 , V_140 -> V_142 ,
V_105 , V_106 ) ;
...
case V_35 :
case V_23 :
V_88 = V_138 -> V_143 . V_144 * 2 +
V_138 -> V_143 . V_145 * V_140 -> V_142 ;
break;
case V_31 :
case V_29 :
V_88 = V_138 -> V_143 . V_144 * 4 +
V_138 -> V_143 . V_145 * V_140 -> V_142 ;
break;
case V_27 :
case V_25 :
V_88 = V_138 -> V_143 . V_144 * 3 +
V_138 -> V_143 . V_145 * V_140 -> V_142 ;
break;
default:
return - V_47 ;
}
F_15 ( V_3 , 0 , V_138 -> V_146 + V_88 ) ;
F_15 ( V_3 , 1 , V_138 -> V_147 + V_88 ) ;
return 0 ;
}
...
int F_39 ( struct V_55 * V_6 , struct V_151 * V_149 , unsigned long V_8 )
{
struct V_4 * V_5 ;
V_5 = F_40 ( V_149 , sizeof( * V_5 ) , V_152 ) ;
if ( ! V_5 )
return - V_153 ;
V_6 -> V_7 = V_5 ;
F_41 ( & V_5 -> V_154 ) ;
V_5 -> V_8 = F_42 ( V_149 , V_8 , V_155 ) ;
if ( ! V_5 -> V_8 )
return - V_153 ;
F_38 ( V_149 , L_25 ,
V_8 , V_5 -> V_8 ) ;
