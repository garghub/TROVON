...
static bool F_235 ( const struct V_185 * V_186 ,
bool V_187 )
{
struct V_188 * V_188 = V_186 -> V_188 ;
unsigned long V_34 ;
struct V_189 * V_190 ;
struct V_40 * V_40 ;
struct V_1 * V_1 ;
...
int V_196 , V_197 ;
F_161 ( V_34 ) ;
V_197 = F_29 ( V_105 -> V_197 ) ;
V_196 = F_177 ( V_105 -> V_103 , V_197 ) ;
if ( V_196 > 0 ) {
F_136 ( V_40 , V_196 , V_105 ) ;
V_105 -> V_103 -= V_196 ;
}
F_163 ( V_34 ) ;
}
static void F_245 ( unsigned int V_198 , struct V_40 * V_40 )
{
unsigned long V_34 ;
struct V_199 * V_200 ;
struct V_104 * V_105 ;
F_161 ( V_34 ) ;
V_200 = F_246 ( V_40 -> V_201 , V_198 ) ;
V_105 = & V_200 -> V_105 ;
if ( V_105 -> V_103 ) {
...
static void F_247 ( unsigned int V_198 )
{
struct V_40 * V_40 ;
F_199 (zone) {
F_245 ( V_198 , V_40 ) ;
...
bool V_203 = false ;
if ( V_40 ) {
V_105 = F_246 ( V_40 -> V_201 , V_198 ) ;
if ( V_105 -> V_105 . V_103 )
V_203 = true ;
} else {
F_199 (z) {
V_105 = F_246 ( V_190 -> V_201 , V_198 ) ;
if ( V_105 -> V_105 . V_103 ) {
V_203 = true ;
break;
}
...
F_254 ( & V_202 , ( V_204 ) F_248 ,
V_40 , 1 ) ;
}
void F_255 ( struct V_40 * V_40 )
{
unsigned long V_12 , V_205 ;
unsigned long V_34 ;
unsigned int V_59 , V_206 ;
struct V_1 * V_1 ;
if ( F_256 ( V_40 ) )
return;
F_232 ( & V_40 -> V_109 , V_34 ) ;
V_205 = F_155 ( V_40 ) ;
for ( V_12 = V_40 -> V_23 ; V_12 < V_205 ; V_12 ++ )
if ( F_159 ( V_12 ) ) {
V_1 = F_153 ( V_12 ) ;
if ( F_19 ( V_1 ) != V_40 )
continue;
...
unsigned long V_197 = F_29 ( V_105 -> V_197 ) ;
F_136 ( V_40 , V_197 , V_105 ) ;
V_105 -> V_103 -= V_197 ;
}
V_53:
F_163 ( V_34 ) ;
...
V_115 = F_100 ( V_1 ) ;
if ( ! F_81 ( V_115 ) ) {
V_209 = F_274 ( V_40 ) + ( 1UL << V_59 ) ;
if ( ! F_275 ( V_40 , 0 , V_209 , 0 , V_210 ) )
return 0 ;
...
F_84 ( V_1 ) ;
if ( V_59 >= V_21 - 1 ) {
struct V_1 * V_211 = V_1 + ( 1 << V_59 ) - 1 ;
for (; V_1 < V_211 ; V_1 += V_24 ) {
int V_115 = F_100 ( V_1 ) ;
...
static inline void F_276 ( struct V_40 * V_212 , struct V_40 * V_190 )
{
#ifdef F_277
enum V_213 V_214 = V_215 ;
if ( V_190 -> V_128 != F_278 () )
V_214 = V_216 ;
if ( V_190 -> V_128 == V_212 -> V_128 )
F_279 ( V_190 , V_217 ) ;
else {
F_279 ( V_190 , V_218 ) ;
F_279 ( V_212 , V_219 ) ;
...
static inline
struct V_1 * F_280 ( struct V_40 * V_212 ,
struct V_40 * V_40 , unsigned int V_59 ,
...
#ifdef F_296
if ( ! ( V_162 & V_210 ) )
V_244 -= F_297 ( V_190 , V_194 ) ;
#endif
if ( V_244 <= F_177 + V_190 -> V_248 [ V_243 ] )
return false ;
if ( ! V_59 )
return true ;
...
int V_243 , unsigned int V_162 )
{
return F_295 ( V_190 , V_59 , V_242 , V_243 , V_162 ,
F_297 ( V_190 , V_195 ) ) ;
}
static inline bool F_298 ( struct V_40 * V_190 , unsigned int V_59 ,
unsigned long V_242 , int V_243 , unsigned int V_162 )
{
long V_244 = F_297 ( V_190 , V_195 ) ;
long V_249 = 0 ;
#ifdef F_296
if ( ! ( V_162 & V_210 ) )
V_249 = F_297 ( V_190 , V_194 ) ;
#endif
if ( ! V_59 && ( V_244 - V_249 ) > V_242 + V_190 -> V_248 [ V_243 ] )
return true ;
return F_295 ( V_190 , V_59 , V_242 , V_243 , V_162 ,
V_244 ) ;
}
...
{
long V_244 = F_297 ( V_190 , V_195 ) ;
if ( V_190 -> V_250 && V_244 < V_190 -> V_250 )
V_244 = F_300 ( V_190 , V_195 ) ;
...
{
struct V_189 * V_190 = V_186 -> V_253 ;
struct V_40 * V_40 ;
...
V_306 . V_308 = 0 ;
V_55 -> V_306 = & V_306 ;
V_307 = F_335 ( V_186 -> V_188 , V_59 , V_228 ,
V_186 -> V_280 ) ;
V_55 -> V_306 = NULL ;
F_336 () ;
V_55 -> V_34 &= ~ V_274 ;
...
int V_298 ;
int V_317 ;
unsigned long V_326 = V_52 ;
unsigned int V_327 = 10 * V_54 ;
unsigned int V_328 ;
if ( V_59 >= V_71 ) {
F_281 ( ! ( V_228 & V_270 ) ) ;
return NULL ;
...
if ( V_228 & V_335 )
goto V_331;
if ( V_59 > V_286 && ! ( V_228 & V_337 ) )
goto V_331;
if ( F_353 ( V_52 , V_326 + V_327 ) ) {
F_312 ( V_228 ,
L_28 ,
F_191 ( V_52 - V_326 ) , V_59 ) ;
V_327 += 10 * V_54 ;
}
...
struct V_1 *
F_355 ( T_6 V_228 , unsigned int V_59 ,
struct V_188 * V_188 , T_10 * V_280 )
{
struct V_1 * V_1 ;
unsigned int V_162 = V_338 ;
T_6 V_339 = V_228 ;
struct V_185 V_186 = {
. V_287 = F_356 ( V_228 ) ,
. V_188 = V_188 ,
...
V_1 = F_303 ( V_339 , V_59 , V_162 , & V_186 ) ;
if ( F_96 ( V_1 ) )
goto V_53;
V_343:
V_339 = F_359 ( V_228 ) ;
V_186 . V_257 = false ;
if ( F_32 ( V_186 . V_280 != V_280 ) )
V_186 . V_280 = V_280 ;
V_1 = F_349 ( V_339 , V_59 , & V_186 ) ;
V_53:
...
F_362 ( V_1 , V_59 , V_339 , V_186 . V_3 ) ;
return V_1 ;
}
...
void F_370 ( struct V_1 * V_1 , unsigned int V_103 )
{
...
void F_375 ( void * V_346 )
{
struct V_1 * V_1 = F_376 ( V_346 ) ;
if ( F_32 ( F_366 ( V_1 ) ) )
F_53 ( V_1 , F_54 ( V_1 ) ) ;
}
static void * F_377 ( unsigned long V_346 , unsigned int V_59 ,
T_11 V_157 )
{
if ( V_346 ) {
unsigned long V_358 = V_346 + ( V_102 << V_59 ) ;
unsigned long V_359 = V_346 + F_378 ( V_157 ) ;
...
void * F_380 ( T_11 V_157 , T_6 V_228 )
{
unsigned int V_59 = F_381 ( V_157 ) ;
unsigned long V_346 ;
V_346 = F_363 ( V_228 , V_59 ) ;
return F_377 ( V_346 , V_59 , V_157 ) ;
}
void * T_2 F_382 ( int V_13 , T_11 V_157 , T_6 V_228 )
{
unsigned int V_59 = F_381 ( V_157 ) ;
struct V_1 * V_63 = F_369 ( V_13 , V_228 , V_59 ) ;
if ( ! V_63 )
return NULL ;
return F_377 ( ( unsigned long ) F_128 ( V_63 ) , V_59 , V_157 ) ;
}
void F_383 ( void * V_360 , T_11 V_157 )
{
unsigned long V_346 = ( unsigned long ) V_360 ;
unsigned long V_120 = V_346 + F_378 ( V_157 ) ;
while ( V_346 < V_120 ) {
F_379 ( V_346 ) ;
V_346 += V_102 ;
}
}
static unsigned long F_384 ( int V_354 )
{
struct V_189 * V_190 ;
struct V_40 * V_40 ;
unsigned long V_361 = 0 ;
struct V_188 * V_188 = F_352 ( F_278 () , V_362 ) ;
F_385 (zone, z, zonelist, offset) {
unsigned long V_157 = V_40 -> V_124 ;
unsigned long V_155 = F_386 ( V_40 ) ;
if ( V_157 > V_155 )
V_361 += V_157 - V_155 ;
}
return V_361 ;
...
{
return F_384 ( F_356 ( V_363 ) ) ;
}
unsigned long F_388 ( void )
{
return F_384 ( F_356 ( V_364 ) ) ;
}
static inline void F_389 ( struct V_40 * V_40 )
{
if ( F_110 ( F_277 ) )
F_390 ( L_30 , F_39 ( V_40 ) ) ;
}
long F_391 ( void )
{
long V_319 ;
...
V_174 [ V_75 ] = F_392 ( V_369 + V_75 ) ;
F_393 (zone)
V_366 += V_40 -> V_209 [ V_370 ] ;
V_319 = F_394 ( V_195 ) - V_371 ;
V_365 = V_174 [ V_372 ] + V_174 [ V_373 ] ;
V_365 -= F_177 ( V_365 / 2 , V_366 ) ;
V_319 += V_365 ;
V_319 += F_394 ( V_374 ) -
F_177 ( F_394 ( V_374 ) / 2 , V_366 ) ;
if ( V_319 < 0 )
V_319 = 0 ;
return V_319 ;
}
void F_395 ( struct V_375 * V_376 )
{
V_376 -> V_377 = V_378 ;
V_376 -> V_379 = F_392 ( V_380 ) ;
V_376 -> V_381 = F_394 ( V_195 ) ;
V_376 -> V_382 = F_396 () ;
V_376 -> V_383 = V_384 ;
V_376 -> V_385 = F_397 () ;
V_376 -> V_386 = V_102 ;
}
void F_398 ( struct V_375 * V_376 , int V_13 )
{
int V_387 ;
...
V_376 -> V_381 = F_399 ( V_13 , V_195 ) ;
#ifdef F_400
for ( V_387 = 0 ; V_387 < V_117 ; V_387 ++ ) {
struct V_40 * V_40 = & V_9 -> V_118 [ V_387 ] ;
if ( F_401 ( V_40 ) ) {
V_388 += V_40 -> V_124 ;
V_389 += F_297 ( V_40 , V_195 ) ;
}
}
V_376 -> V_383 = V_388 ;
V_376 -> V_385 = V_389 ;
...
bool F_402 ( unsigned int V_34 , int V_13 )
{
bool V_41 = false ;
unsigned int V_328 ;
if ( ! ( V_34 & V_267 ) )
...
do {
V_328 = F_350 () ;
V_41 = ! F_403 ( V_13 , V_340 ) ;
} while ( F_354 ( V_328 ) );
V_53:
return V_41 ;
}
static void F_404 ( unsigned char type )
{
...
* V_63 = '\0' ;
F_390 ( V_393 L_31 , V_392 ) ;
}
void F_406 ( unsigned int V_266 )
{
...
T_1 * V_9 ;
F_199 (zone) {
if ( F_402 ( V_266 , F_39 ( V_40 ) ) )
continue;
F_251 (cpu)
V_394 += F_246 ( V_40 -> V_201 , V_198 ) -> V_105 . V_103 ;
}
F_390 ( L_32
L_33
L_34
...
L_57 ,
V_9 -> V_140 ,
F_409 ( F_138 ( V_9 , V_395 ) ) ,
F_409 ( F_138 ( V_9 , V_396 ) ) ,
F_409 ( F_138 ( V_9 , V_398 ) ) ,
F_409 ( F_138 ( V_9 , V_399 ) ) ,
F_409 ( F_138 ( V_9 , V_401 ) ) ,
F_409 ( F_138 ( V_9 , V_397 ) ) ,
F_409 ( F_138 ( V_9 , V_400 ) ) ,
F_409 ( F_138 ( V_9 , V_406 ) ) ,
F_409 ( F_138 ( V_9 , V_402 ) ) ,
F_409 ( F_138 ( V_9 , V_403 ) ) ,
#ifdef F_408
F_409 ( F_138 ( V_9 , V_409 ) * V_410 ) ,
F_409 ( F_138 ( V_9 , V_411 )
* V_410 ) ,
F_409 ( F_138 ( V_9 , V_412 ) * V_410 ) ,
#endif
F_409 ( F_138 ( V_9 , V_380 ) ) ,
F_409 ( F_138 ( V_9 , V_413 ) ) ,
F_409 ( F_138 ( V_9 , V_404 ) ) ,
F_138 ( V_9 , V_111 ) ,
! F_410 ( V_9 ) ? L_58 : L_59 ) ;
}
F_199 (zone) {
...
L_57 ,
V_40 -> V_46 ,
F_409 ( F_297 ( V_40 , V_195 ) ) ,
F_409 ( F_274 ( V_40 ) ) ,
F_409 ( F_411 ( V_40 ) ) ,
F_409 ( F_386 ( V_40 ) ) ,
F_409 ( F_297 ( V_40 , V_414 ) ) ,
F_409 ( F_297 ( V_40 , V_415 ) ) ,
F_409 ( F_297 ( V_40 , V_416 ) ) ,
F_409 ( F_297 ( V_40 , V_417 ) ) ,
F_409 ( F_297 ( V_40 , V_418 ) ) ,
F_409 ( F_297 ( V_40 , V_322 ) ) ,
F_409 ( V_40 -> V_419 ) ,
F_409 ( V_40 -> V_124 ) ,
F_409 ( F_297 ( V_40 , V_420 ) ) ,
F_409 ( F_297 ( V_40 , V_374 ) ) ,
F_409 ( F_297 ( V_40 , V_405 ) ) ,
F_297 ( V_40 , V_421 ) ,
F_409 ( F_297 ( V_40 , V_407 ) ) ,
F_409 ( F_297 ( V_40 , V_408 ) ) ,
F_409 ( V_394 ) ,
F_409 ( F_412 ( V_40 -> V_201 -> V_105 . V_103 ) ) ,
F_409 ( F_297 ( V_40 , V_194 ) ) ) ;
F_390 ( L_77 ) ;
for ( V_60 = 0 ; V_60 < V_117 ; V_60 ++ )
F_390 ( V_393 L_78 , V_40 -> V_248 [ V_60 ] ) ;
F_390 ( V_393 L_57 ) ;
}
F_199 (zone) {
unsigned int V_59 ;
...
for ( V_59 = 0 ; V_59 < V_71 ; V_59 ++ ) {
F_390 ( V_393 L_79 ,
V_422 [ V_59 ] , F_409 ( 1UL ) << V_59 ) ;
if ( V_422 [ V_59 ] )
F_404 ( V_390 [ V_59 ] ) ;
}
F_390 ( V_393 L_80 , F_409 ( V_423 ) ) ;
}
F_413 () ;
F_390 ( L_81 , F_392 ( V_424 ) ) ;
F_414 () ;
}
static void F_415 ( struct V_40 * V_40 , struct V_189 * V_189 )
{
V_189 -> V_40 = V_40 ;
V_189 -> V_425 = V_425 ( V_40 ) ;
}
static int F_416 ( T_1 * V_9 , struct V_188 * V_188 ,
int V_426 )
{
struct V_40 * V_40 ;
...
static T_4 int F_420 ( char * V_427 )
{
int V_41 ;
if ( ! V_427 )
return 0 ;
V_41 = F_419 ( V_427 ) ;
if ( V_41 == 0 )
F_421 ( V_432 , V_427 , V_433 ) ;
return V_41 ;
}
int F_422 ( struct V_434 * V_435 , int V_436 ,
...
V_41 = F_425 ( V_435 , V_436 , V_437 , V_438 , V_439 ) ;
if ( V_41 )
goto V_53;
if ( V_436 ) {
int V_442 = V_428 ;
V_41 = F_419 ( ( char * ) V_435 -> V_139 ) ;
if ( V_41 ) {
...
static int F_427 ( int V_128 , T_10 * V_444 )
{
int V_445 , V_376 ;
int V_446 = V_447 ;
int V_448 = V_351 ;
const struct V_145 * V_392 = F_184 ( 0 ) ;
if ( ! F_403 ( V_128 , * V_444 ) ) {
F_428 ( V_128 , * V_444 ) ;
return V_128 ;
}
F_195 (n, N_MEMORY) {
if ( F_403 ( V_445 , * V_444 ) )
continue;
...
static void F_429 ( T_1 * V_9 , int V_128 )
{
int V_453 ;
struct V_188 * V_188 ;
V_188 = & V_9 -> V_454 [ V_455 ] ;
for ( V_453 = 0 ; V_188 -> V_341 [ V_453 ] . V_40 != NULL ; V_453 ++ )
;
V_453 = F_416 ( F_12 ( V_128 ) , V_188 , V_453 ) ;
V_188 -> V_341 [ V_453 ] . V_40 = NULL ;
V_188 -> V_341 [ V_453 ] . V_425 = 0 ;
}
static void F_430 ( T_1 * V_9 )
{
int V_453 ;
struct V_188 * V_188 ;
V_188 = & V_9 -> V_454 [ V_456 ] ;
V_453 = F_416 ( V_9 , V_188 , 0 ) ;
V_188 -> V_341 [ V_453 ] . V_40 = NULL ;
V_188 -> V_341 [ V_453 ] . V_425 = 0 ;
}
static void F_431 ( T_1 * V_9 , int V_457 )
{
...
V_188 -> V_341 [ V_458 ] . V_40 = NULL ;
V_188 -> V_341 [ V_458 ] . V_425 = 0 ;
}
...
V_188 = V_9 -> V_454 + V_60 ;
V_188 -> V_341 [ 0 ] . V_40 = NULL ;
V_188 -> V_341 [ 0 ] . V_425 = 0 ;
}
V_463 = V_9 -> V_140 ;
V_461 = V_466 ;
V_464 = V_463 ;
...
V_60 = 0 ;
while ( ( V_128 = F_427 ( V_463 , & V_462 ) ) >= 0 ) {
...
F_439 (cpu) {
F_440 ( & F_441 ( V_468 , V_198 ) , 0 ) ;
#ifdef F_442
if ( F_443 ( V_198 ) )
F_444 ( V_198 , F_436 ( F_445 ( V_198 ) ) ) ;
#endif
}
return 0 ;
}
...
void T_15 F_426 ( T_1 * V_9 , struct V_40 * V_40 )
{
F_433 () ;
if ( V_469 == V_470 ) {
F_446 () ;
...
void T_2 F_452 ( unsigned long V_157 , int V_13 , unsigned long V_40 ,
unsigned long V_44 , enum V_475 V_476 )
{
struct V_477 * V_478 = F_453 ( F_454 ( V_44 ) ) ;
...
static void T_2 F_461 ( struct V_40 * V_40 )
{
unsigned int V_59 , V_206 ;
F_259 (order, t) {
F_76 ( & V_40 -> V_85 [ V_59 ] . V_90 [ V_206 ] ) ;
V_40 -> V_85 [ V_59 ] . V_86 = 0 ;
}
}
static int F_462 ( struct V_40 * V_40 )
{
#ifdef F_463
int V_197 ;
V_197 = V_40 -> V_124 / 1024 ;
if ( V_197 * V_102 > 512 * 1024 )
V_197 = ( 512 * 1024 ) / V_102 ;
V_197 /= 4 ;
if ( V_197 < 1 )
V_197 = 1 ;
V_197 = F_464 ( V_197 + V_197 / 2 ) - 1 ;
return V_197 ;
#else
return 0 ;
#endif
}
static void F_465 ( struct V_104 * V_105 , unsigned long V_155 ,
unsigned long V_197 )
{
V_105 -> V_197 = 1 ;
F_466 () ;
...
static void F_467 ( struct V_199 * V_63 , unsigned long V_197 )
{
F_465 ( & V_63 -> V_105 , 6 * V_197 , F_15 ( 1UL , 1 * V_197 ) ) ;
}
static void F_468 ( struct V_199 * V_63 )
{
struct V_104 * V_105 ;
int V_3 ;
...
static void F_440 ( struct V_199 * V_63 , unsigned long V_197 )
{
F_468 ( V_63 ) ;
F_467 ( V_63 , V_197 ) ;
}
static void F_469 ( struct V_199 * V_63 ,
unsigned long V_155 )
{
unsigned long V_197 = F_15 ( 1UL , V_155 / 4 ) ;
if ( ( V_155 / 4 ) > ( V_17 * 8 ) )
V_197 = V_17 * 8 ;
F_465 ( & V_63 -> V_105 , V_155 , V_197 ) ;
}
static void F_470 ( struct V_40 * V_40 ,
struct V_199 * V_105 )
{
if ( V_488 )
F_469 ( V_105 ,
...
F_467 ( V_105 , F_462 ( V_40 ) ) ;
}
static void T_2 F_471 ( struct V_40 * V_40 , int V_198 )
{
struct V_199 * V_105 = F_246 ( V_40 -> V_201 , V_198 ) ;
F_468 ( V_105 ) ;
F_470 ( V_40 , V_105 ) ;
}
static void T_2 F_450 ( struct V_40 * V_40 )
{
int V_198 ;
V_40 -> V_201 = F_472 ( struct V_199 ) ;
F_439 (cpu)
F_471 ( V_40 , V_198 ) ;
}
void T_4 F_473 ( void )
...
static T_2 void F_474 ( struct V_40 * V_40 )
{
V_40 -> V_201 = & V_468 ;
if ( F_190 ( V_40 ) )
F_390 ( V_491 L_87 ,
...
int T_2 F_475 ( struct V_40 * V_40 ,
unsigned long V_23 ,
unsigned long V_157 )
{
...
void T_4 F_478 ( int V_13 , unsigned long V_497 )
{
unsigned long V_44 , V_121 ;
int V_60 , V_498 ;
...
void T_4 F_481 ( int V_13 )
{
unsigned long V_44 , V_121 ;
int V_60 , V_498 ;
F_188 (i, nid, &start_pfn, &end_pfn, &this_nid)
F_482 ( V_498 , V_44 , V_121 ) ;
}
void T_2 F_483 ( unsigned int V_13 ,
...
static void T_2 F_485 ( int V_13 ,
unsigned long V_387 ,
unsigned long V_146 ,
unsigned long V_505 ,
unsigned long * V_23 ,
...
static unsigned long T_2 F_486 ( int V_13 ,
unsigned long V_387 ,
unsigned long V_146 ,
unsigned long V_505 ,
unsigned long * V_23 ,
...
unsigned long T_2 F_487 ( int V_13 ,
unsigned long V_508 ,
unsigned long V_509 )
{
...
V_44 = F_488 ( V_44 , V_508 , V_509 ) ;
V_121 = F_488 ( V_121 , V_508 , V_509 ) ;
V_510 -= V_121 - V_44 ;
}
return V_510 ;
}
unsigned long T_4 F_489 ( unsigned long V_44 ,
unsigned long V_121 )
{
return F_487 ( V_451 , V_44 , V_121 ) ;
}
static unsigned long T_2 F_490 ( int V_13 ,
unsigned long V_387 ,
unsigned long V_146 ,
unsigned long V_505 ,
unsigned long * V_507 )
...
if ( ! V_146 && ! V_505 )
return 0 ;
V_23 = F_488 ( V_146 , V_511 , V_512 ) ;
F_155 = F_488 ( V_505 , V_511 , V_512 ) ;
F_485 ( V_13 , V_387 ,
V_146 , V_505 ,
& V_23 , & F_155 ) ;
V_510 = F_487 ( V_13 , V_23 , F_155 ) ;
if ( V_486 && V_506 [ V_13 ] ) {
unsigned long V_44 , V_121 ;
struct V_479 * V_480 ;
F_458 (memory, r) {
V_44 = F_488 ( F_459 ( V_480 ) ,
V_23 , F_155 ) ;
V_121 = F_488 ( F_457 ( V_480 ) ,
V_23 , F_155 ) ;
if ( V_387 == V_487 &&
F_460 ( V_480 ) )
V_510 += V_121 - V_44 ;
...
static inline unsigned long T_2 F_486 ( int V_13 ,
unsigned long V_387 ,
unsigned long V_146 ,
unsigned long V_505 ,
unsigned long * V_23 ,
...
static inline unsigned long T_2 F_490 ( int V_13 ,
unsigned long V_387 ,
unsigned long V_146 ,
unsigned long V_505 ,
unsigned long * V_514 )
...
static void T_2 F_491 ( struct V_254 * V_9 ,
unsigned long V_146 ,
unsigned long V_505 ,
unsigned long * V_513 ,
unsigned long * V_514 )
...
V_157 = F_486 ( V_9 -> V_140 , V_60 ,
V_146 ,
V_505 ,
& V_23 ,
& F_155 ,
V_513 ) ;
V_517 = V_157 - F_490 ( V_9 -> V_140 , V_60 ,
V_146 , V_505 ,
V_514 ) ;
if ( V_157 )
V_40 -> V_23 = V_23 ;
...
V_9 -> V_18 = V_516 ;
V_9 -> V_518 = V_515 ;
F_390 ( V_491 L_90 , V_9 -> V_140 ,
V_515 ) ;
}
static unsigned long T_4 F_492 ( unsigned long V_23 , unsigned long V_519 )
{
unsigned long V_520 ;
V_519 += V_23 & ( V_24 - 1 ) ;
V_520 = F_493 ( V_519 , V_24 ) ;
V_520 = V_520 >> V_21 ;
V_520 *= V_22 ;
V_520 = F_493 ( V_520 , 8 * sizeof( unsigned long ) ) ;
return V_520 / 8 ;
}
static void T_4 F_494 ( struct V_254 * V_9 ,
struct V_40 * V_40 ,
unsigned long V_23 ,
unsigned long V_519 )
{
unsigned long V_520 = F_492 ( V_23 , V_519 ) ;
V_40 -> V_20 = NULL ;
if ( V_520 )
V_40 -> V_20 =
F_495 ( V_520 ,
...
static inline void F_494 ( struct V_254 * V_9 , struct V_40 * V_40 ,
unsigned long V_23 , unsigned long V_519 ) {}
void T_16 F_496 ( void )
{
unsigned int V_59 ;
if ( V_21 )
return;
...
static unsigned long T_16 F_497 ( unsigned long V_45 ,
unsigned long V_419 )
{
...
F_110 ( F_17 ) )
V_174 = V_419 ;
return F_378 ( V_174 * sizeof( struct V_1 ) ) >> V_17 ;
}
static void T_16 F_498 ( struct V_254 * V_9 )
{
enum V_387 V_453 ;
int V_13 = V_9 -> V_140 ;
int V_41 ;
...
continue;
F_496 () ;
F_494 ( V_9 , V_40 , V_23 , V_157 ) ;
V_41 = F_475 ( V_40 , V_23 , V_157 ) ;
F_187 ( V_41 ) ;
F_508 ( V_157 , V_13 , V_453 , V_23 ) ;
}
}
static void T_15 F_509 ( struct V_254 * V_9 )
{
...
void T_16 F_514 ( int V_13 , unsigned long * V_513 ,
...
unsigned long V_516 = F_521 () ;
int V_556 = F_524 ( V_555 [ V_151 ] ) ;
struct V_479 * V_480 ;
F_484 () ;
if ( F_525 () ) {
F_458 (memory, r) {
...
void T_4 F_528 ( unsigned long * V_205 )
{
unsigned long V_44 , V_121 ;
int V_60 , V_13 ;
memset ( V_503 , 0 ,
...
static int T_4 F_530 ( char * V_63 , unsigned long * V_568 )
{
unsigned long long V_569 ;
if ( ! V_63 )
return - V_67 ;
V_569 = F_531 ( V_63 , & V_63 ) ;
* V_568 = V_569 >> V_17 ;
F_4 ( ( V_569 >> V_17 ) > V_11 ) ;
return 0 ;
}
static int T_4 F_532 ( char * V_63 )
{
if ( F_533 ( V_63 , L_106 ) ) {
V_486 = true ;
return 0 ;
}
return F_530 ( V_63 , & V_562 ) ;
}
static int T_4 F_534 ( char * V_63 )
{
return F_530 ( V_63 , & V_560 ) ;
}
...
unsigned long F_535 ( void * V_119 , void * V_120 , int V_571 , char * V_427 )
{
void * V_458 ;
unsigned long V_174 = 0 ;
V_119 = ( void * ) F_378 ( ( unsigned long ) V_119 ) ;
...
void T_4 F_539 ( const char * V_225 )
{
...
V_579 = V_588 - V_589 ;
V_578 = V_590 - V_591 ;
#define F_541 ( V_119 , V_120 , V_157 , V_458 , T_18 ) \
do { \
if (start <= pos && pos < end && size > adj) \
size -= adj; \
} while (0)
F_541 ( V_589 , V_588 , V_579 ,
V_591 , V_578 ) ;
F_541 ( V_581 , V_580 , V_574 , V_591 , V_578 ) ;
F_541 ( V_583 , V_582 , V_575 , V_589 , V_579 ) ;
F_541 ( V_581 , V_580 , V_574 , V_585 , V_576 ) ;
F_541 ( V_583 , V_582 , V_575 , V_585 , V_576 ) ;
#undef F_541
F_71 ( L_108
#ifdef F_400
L_109
...
void T_4 F_543 ( unsigned long V_593 )
{
V_536 = V_593 ;
}
void T_4 F_544 ( unsigned long * V_513 )
{
F_514 ( 0 , V_513 ,
F_545 ( V_594 ) >> V_17 , NULL ) ;
}
static int F_546 ( unsigned int V_198 )
{
F_547 ( V_198 ) ;
F_247 ( V_198 ) ;
F_548 ( V_198 ) ;
...
if ( V_599 [ V_597 ] < 1 )
V_599 [ V_597 ] = 1 ;
V_598 = V_9 -> V_118 + V_597 ;
V_598 -> V_248 [ V_453 ] = V_124 /
V_599 [ V_597 ] ;
V_124 += V_598 -> V_124 ;
}
}
...
{
unsigned long V_600 = V_601 >> ( V_17 - 10 ) ;
...
V_544 V_392 ;
F_232 ( & V_40 -> V_109 , V_34 ) ;
V_392 = ( V_544 ) V_600 * V_40 -> V_124 ;
F_555 ( V_392 , V_602 ) ;
if ( F_401 ( V_40 ) ) {
unsigned long V_603 ;
V_603 = V_40 -> V_124 / 1024 ;
V_603 = F_488 ( V_603 , V_604 , 128UL ) ;
V_40 -> V_209 [ V_605 ] = V_603 ;
} else {
V_40 -> V_209 [ V_605 ] = V_392 ;
}
V_392 = F_556 ( V_544 , V_392 >> 2 ,
F_557 ( V_40 -> V_124 ,
V_606 , 10000 ) ) ;
V_40 -> V_209 [ V_370 ] = F_274 ( V_40 ) + V_392 ;
V_40 -> V_209 [ V_607 ] = F_274 ( V_40 ) + V_392 * 2 ;
F_234 ( & V_40 -> V_109 , V_34 ) ;
}
F_552 () ;
}
...
unsigned long V_608 ;
int V_609 ;
V_608 = F_387 () * ( V_102 >> 10 ) ;
V_609 = F_560 ( V_608 * 16 ) ;
if ( V_609 > V_610 ) {
V_601 = V_609 ;
if ( V_601 < 128 )
V_601 = 128 ;
...
int F_564 ( struct V_434 * V_435 , int V_436 ,
void T_12 * V_437 , T_11 * V_438 , T_13 * V_439 )
{
int V_611 ;
V_611 = F_565 ( V_435 , V_436 , V_437 , V_438 , V_439 ) ;
if ( V_611 )
return V_611 ;
if ( V_436 ) {
V_610 = V_601 ;
...
void T_12 * V_437 , T_11 * V_438 , T_13 * V_439 )
{
F_565 ( V_435 , V_436 , V_437 , V_438 , V_439 ) ;
F_553 () ;
return 0 ;
}
int F_570 ( struct V_434 * V_435 , int V_436 ,
void T_12 * V_437 , T_11 * V_438 , T_13 * V_439 )
{
struct V_40 * V_40 ;
int V_616 ;
...
F_424 ( & V_617 ) ;
V_616 = V_488 ;
V_41 = F_565 ( V_435 , V_436 , V_437 , V_438 , V_439 ) ;
if ( ! V_436 || V_41 < 0 )
goto V_53;
if ( V_488 &&
V_488 < V_618 ) {
...
F_439 (cpu)
F_470 ( V_40 ,
F_246 ( V_40 -> V_201 , V_198 ) ) ;
}
V_53:
F_322 ( & V_617 ) ;
return V_41 ;
}
static int T_4 F_571 ( char * V_225 )
{
if ( ! V_225 )
return 0 ;
V_619 = F_572 ( V_225 , & V_225 , 0 ) ;
return 1 ;
}
static unsigned long T_4 F_573 ( void )
{
return 0 ;
}
void * T_4 F_574 ( const char * V_620 ,
unsigned long V_621 ,
unsigned long V_622 ,
int V_623 ,
int V_34 ,
...
unsigned long V_627 )
{
unsigned long long F_15 = V_627 ;
unsigned long V_628 , V_157 ;
void * V_435 = NULL ;
if ( ! V_622 ) {
V_622 = V_537 ;
V_622 -= F_573 () ;
if ( V_17 < 20 )
V_622 = F_575 ( V_622 , ( 1 << 20 ) / V_102 ) ;
if ( V_623 > V_17 )
V_622 >>= ( V_623 - V_17 ) ;
else
V_622 <<= ( V_17 - V_623 ) ;
...
} else if ( F_32 ( ( V_622 * V_621 ) < V_102 ) )
V_622 = V_102 / V_621 ;
}
V_622 = F_576 ( V_622 ) ;
if ( F_15 == 0 ) {
...
V_435 = F_579 ( V_157 , V_631 , V_632 ) ;
else {
if ( F_381 ( V_157 ) < V_71 ) {
V_435 = F_380 ( V_157 , V_631 ) ;
F_580 ( V_435 , V_157 , 1 , V_631 ) ;
}
}
} while ( ! V_435 && V_157 > V_102 && -- V_628 );
if ( ! V_435 )
F_581 ( L_115 , V_620 ) ;
F_71 ( L_116 ,
V_620 , 1UL << V_628 , F_577 ( V_157 ) - V_17 , V_157 ) ;
if ( V_624 )
* V_624 = V_628 ;
if ( V_625 )
* V_625 = ( 1 << V_628 ) - 1 ;
...
bool V_633 )
{
unsigned long V_12 , V_634 , V_635 ;
int V_115 ;
if ( V_425 ( V_40 ) == V_487 )
return false ;
V_115 = F_100 ( V_1 ) ;
...
return false ;
V_12 = F_35 ( V_1 ) ;
for ( V_635 = 0 , V_634 = 0 ; V_634 < V_24 ; V_634 ++ ) {
unsigned long V_636 = V_12 + V_634 ;
if ( ! F_41 ( V_636 ) )
continue;
V_1 = F_153 ( V_636 ) ;
if ( F_583 ( V_1 ) ) {
V_634 = F_575 ( V_634 + 1 , 1 << F_54 ( V_1 ) ) - 1 ;
continue;
}
if ( ! F_105 ( V_1 ) ) {
if ( F_91 ( V_1 ) )
...
{
return V_12 & ~ ( F_556 (unsigned long, MAX_ORDER_NR_PAGES,
pageblock_nr_pages) - 1 ) ;
}
static unsigned long F_588 ( unsigned long V_12 )
{
return F_176 ( V_12 , F_556 (unsigned long, MAX_ORDER_NR_PAGES,
pageblock_nr_pages) ) ;
}
static int F_589 ( struct V_637 * V_638 ,
unsigned long V_119 , unsigned long V_120 )
{
unsigned long V_639 ;
unsigned long V_12 = V_119 ;
unsigned int V_640 = 0 ;
int V_41 = 0 ;
F_590 () ;
while ( V_12 < V_120 || ! F_140 ( & V_638 -> V_641 ) ) {
if ( F_591 ( V_55 ) ) {
V_41 = - V_642 ;
break;
}
if ( F_140 ( & V_638 -> V_641 ) ) {
V_638 -> V_643 = 0 ;
V_12 = F_592 ( V_638 , V_12 , V_120 ) ;
if ( ! V_12 ) {
V_41 = - V_642 ;
break;
}
...
V_41 = V_41 < 0 ? V_41 : - V_644 ;
break;
}
V_639 = F_593 ( V_638 -> V_40 ,
& V_638 -> V_641 ) ;
V_638 -> V_643 -= V_639 ;
V_41 = F_594 ( & V_638 -> V_641 , V_645 ,
NULL , 0 , V_638 -> V_234 , V_646 ) ;
}
if ( V_41 < 0 ) {
F_595 ( & V_638 -> V_641 ) ;
return V_41 ;
...
if ( V_647 != V_119 ) {
V_59 = F_88 ( F_153 ( V_647 ) ) ;
if ( V_647 + ( 1UL << V_59 ) <= V_119 )
V_647 = V_119 ;
}
if ( F_599 ( V_647 , V_120 , false ) ) {
F_71 ( L_117 ,
V_652 , V_647 , V_120 ) ;
V_41 = - V_644 ;
goto V_651;
}
V_648 = F_600 ( & V_638 , V_647 , V_120 ) ;
if ( ! V_648 ) {
V_41 = - V_644 ;
goto V_651;
}
if ( V_119 != V_647 )
F_601 ( V_647 , V_119 - V_647 ) ;
if ( V_120 != V_648 )
F_601 ( V_120 , V_648 - V_120 ) ;
V_651:
F_602 ( F_587 ( V_119 ) ,
F_588 ( V_120 ) , V_3 ) ;
return V_41 ;
...
F_232 ( & V_40 -> V_109 , V_34 ) ;
for ( V_59 = 0 ; V_59 < V_71 ; V_59 ++ ) {
struct V_1 * V_653 = V_1 - ( V_12 & ( ( 1 << V_59 ) - 1 ) ) ;
if ( F_91 ( V_653 ) && F_88 ( V_653 ) >= V_59 )
break;
}
F_234 ( & V_40 -> V_109 , V_34 ) ;
return V_59 < V_71 ;
