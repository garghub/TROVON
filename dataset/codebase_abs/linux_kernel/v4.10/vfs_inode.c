...
F_14 ( & V_46 ) ;
V_46 . V_57 = V_2 -> V_173 ;
V_46 . V_54 = ( char * ) V_162 -> V_138 . V_54 ;
...
static int
F_105 ( struct V_174 * V_175 , struct V_134 * V_134 ,
struct V_176 * V_17 )
{
struct V_1 * V_2 ;
struct V_127 * V_128 ;
...
if ( F_57 ( V_120 ) )
return F_65 ( V_120 ) ;
F_51 ( V_120 , F_63 ( V_134 ) , V_134 -> V_177 ) ;
F_107 ( F_63 ( V_134 ) , V_17 ) ;
F_59 ( V_120 ) ;
F_60 ( V_120 ) ;
return 0 ;
}
static int F_108 ( struct V_134 * V_134 , struct V_178 * V_178 )
{
int V_123 ;
struct V_1 * V_2 ;
struct V_127 * V_128 ;
...
return V_123 ;
if ( ( V_178 -> V_180 & V_188 ) &&
V_178 -> V_189 != F_112 ( F_63 ( V_134 ) ) )
F_113 ( F_63 ( V_134 ) , V_178 -> V_189 ) ;
F_71 ( F_63 ( V_134 ) ) ;
F_114 ( F_63 ( V_134 ) , V_178 ) ;
F_115 ( F_63 ( V_134 ) ) ;
return 0 ;
}
void
...
static int
F_122 ( struct V_63 * V_133 , struct V_134 * V_134 , const char * V_206 )
{
F_11 ( V_113 , L_22 ,
V_133 -> V_124 , V_134 , V_206 ) ;
return F_121 ( V_133 , V_134 , V_21 , V_206 ) ;
}
static int
