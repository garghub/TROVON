...
V_6 -> V_148 = F_46 ( & V_6 -> V_138 , & V_127 -> V_42 , V_6 ) ;
if ( F_43 ( V_6 -> V_148 ) ) {
...
static int F_51 ( struct V_149 * V_42 )
{
struct V_5 * V_6 = F_52 ( V_42 ) ;
struct V_150 * V_151 ;
struct V_28 * V_29 ;
const struct V_87 * V_88 ;
const struct V_78 * V_79 ;
...
static int F_53 ( struct V_149 * V_42 )
{
struct V_5 * V_6 = F_52 ( V_42 ) ;
struct V_150 * V_151 ;
struct V_28 * V_29 ;
...
V_167 * F_56 ( struct V_168 * V_169 , T_1 V_170 )
{
return & V_169 -> V_130 [ F_57 ( V_170 ) ] ;
}
static int F_58 ( struct V_168 * V_169 , T_1 V_170 )
{
struct V_167 * V_30 ;
T_1 V_171 ;
V_30 = F_56 ( V_169 , V_170 ) ;
V_171 = V_170 - V_30 -> V_172 ;
if ( V_171 >= V_30 -> V_173 )
return - V_174 ;
return V_30 -> V_175 [ V_171 ] ;
}
static void F_59 ( struct V_176 * V_177 )
{
struct V_178 * V_179 = F_60 ( V_177 ) ;
struct V_168 * V_169 = F_61 ( V_179 ) ;
struct V_167 * V_30 ;
void T_2 * V_180 ;
T_1 V_181 , V_182 ;
unsigned long V_183 ;
V_30 = F_56 ( V_169 , V_177 -> V_184 ) ;
V_182 = V_177 -> V_184 - V_30 -> V_172 ;
V_180 = F_62 ( V_30 , V_182 ) ;
F_63 ( & V_169 -> V_185 , V_183 ) ;
V_181 = F_11 ( V_180 ) ;
F_7 ( V_181 , V_180 ) ;
F_64 ( & V_169 -> V_185 , V_183 ) ;
}
static void F_65 ( struct V_168 * V_169 , int V_48 )
{
struct V_167 * V_30 ;
void T_2 * V_180 ;
T_1 V_181 , V_182 ;
V_30 = F_56 ( V_169 , V_48 ) ;
...
unsigned long V_183 ;
F_63 ( & V_169 -> V_185 , V_183 ) ;
F_65 ( V_169 , V_177 -> V_184 ) ;
F_64 ( & V_169 -> V_185 , V_183 ) ;
}
static void F_67 ( struct V_176 * V_177 )
{
struct V_178 * V_179 = F_60 ( V_177 ) ;
struct V_168 * V_169 = F_61 ( V_179 ) ;
struct V_167 * V_30 ;
...
static int F_68 ( struct V_176 * V_177 ,
unsigned int type )
{
struct V_178 * V_179 = F_60 ( V_177 ) ;
struct V_168 * V_169 = F_61 ( V_179 ) ;
...
static void F_69 ( struct V_197 * V_198 )
{
struct V_178 * V_179 = F_70 ( V_198 ) ;
struct V_168 * V_169 = F_61 ( V_179 ) ;
struct V_167 * V_30 = NULL ;
T_1 V_151 , V_199 ;
int V_182 = 0 , V_48 ;
struct V_200 * V_201 = F_71 ( V_198 ) ;
unsigned int V_202 = F_72 ( V_198 ) ;
...
static void F_80 ( struct V_168 * V_169 ,
unsigned int V_170 )
{
struct V_167 * V_30 ;
void T_2 * V_180 ;
...
static int F_81 ( struct V_178 * V_201 ,
unsigned int V_170 )
{
struct V_168 * V_169 = F_61 ( V_201 ) ;
int V_39 ;
unsigned long V_183 ;
V_39 = F_58 ( V_169 , V_170 ) ;
if ( V_39 < 0 )
return V_39 ;
if ( F_82 ( V_201 -> V_208 + V_170 ) )
return - V_174 ;
F_63 ( & V_169 -> V_185 , V_183 ) ;
F_80 ( V_169 , V_170 ) ;
F_65 ( V_169 , V_170 ) ;
...
static void F_83 ( struct V_178 * V_201 ,
unsigned int V_170 )
{
struct V_168 * V_169 = F_61 ( V_201 ) ;
unsigned long V_183 ;
...
F_80 ( V_169 , V_170 ) ;
F_64 ( & V_169 -> V_185 , V_183 ) ;
F_84 ( V_201 -> V_208 + V_170 ) ;
}
static int F_85 ( struct V_178 * V_201 ,
unsigned int V_170 )
{
struct V_168 * V_169 = F_61 ( V_201 ) ;
unsigned long V_183 ;
...
static void F_86 ( struct V_168 * V_169 ,
...
unsigned long V_183 ;
F_63 ( & V_169 -> V_185 , V_183 ) ;
F_86 ( V_169 , V_170 , V_209 ) ;
F_64 ( & V_169 -> V_185 , V_183 ) ;
return 0 ;
}
static int F_88 ( struct V_178 * V_201 ,
unsigned int V_170 )
{
struct V_168 * V_169 = F_61 ( V_201 ) ;
struct V_167 * V_30 ;
...
V_182 = V_170 - V_30 -> V_172 ;
F_63 ( & V_169 -> V_185 , V_183 ) ;
V_181 = F_11 ( F_62 ( V_30 , V_182 ) ) ;
F_64 ( & V_169 -> V_185 , V_183 ) ;
return ! ! ( V_181 & V_212 ) ;
}
static void F_89 ( struct V_178 * V_201 ,
unsigned int V_170 , int V_209 )
{
struct V_168 * V_169 = F_61 ( V_201 ) ;
struct V_167 * V_30 ;
...
if ( ! V_169 )
return - V_136 ;
V_169 -> V_213 = F_92 ( V_128 , 0 ) ;
if ( ! F_43 ( V_169 -> V_213 ) ) {
V_39 = F_93 ( V_169 -> V_213 ) ;
if ( V_39 ) {
F_16 ( & V_127 -> V_42 ,
L_28 ) ;
return V_39 ;
...
V_201 -> V_205 = F_95 ( V_128 -> V_11 , V_135 ) ;
V_201 -> V_129 = V_128 ;
V_201 -> V_221 = 2 ;
V_201 -> V_222 = & V_127 -> V_42 ;
V_39 = F_96 ( V_201 , V_169 ) ;
if ( V_39 ) {
F_16 ( & V_127 -> V_42 ,
L_30 ,
V_128 -> V_11 , V_39 ) ;
...
struct V_167 * V_30 ;
V_30 = & V_169 -> V_130 [ V_48 ] ;
V_30 -> V_208 = F_98 ( V_169 , V_48 ) ;
V_39 = F_99 ( V_128 , V_48 ) ;
if ( V_39 == - V_226 ) {
F_16 ( & V_127 -> V_42 ,
L_32 , V_39 ) ;
goto V_223;
