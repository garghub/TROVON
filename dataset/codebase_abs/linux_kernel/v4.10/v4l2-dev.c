...
if ( V_91 -> V_197 || V_91 -> V_198 )
F_9 ( F_64 ( V_199 ) , V_88 ) ;
if ( V_91 -> V_200 || V_91 -> V_201 )
F_9 ( F_64 ( V_202 ) , V_88 ) ;
F_63 ( V_91 , V_203 , V_198 ) ;
F_63 ( V_91 , V_204 , V_201 ) ;
if ( V_91 -> V_205 || V_91 -> V_198 )
F_9 ( F_64 ( V_206 ) , V_88 ) ;
} else if ( V_95 ) {
if ( ( V_102 && ( V_91 -> V_207 ||
V_91 -> V_208 ) ) ||
...
if ( V_105 && ( V_97 || V_98 ) ) {
F_63 ( V_91 , V_296 , V_144 ) ;
F_63 ( V_91 , V_297 , V_298 ) ;
}
if ( V_102 ) {
F_63 ( V_91 , V_299 , V_143 ) ;
F_63 ( V_91 , V_300 , V_301 ) ;
F_63 ( V_91 , V_302 , V_303 ) ;
}
...
V_7 -> V_32 . V_317 . V_23 . V_318 = V_319 ;
V_7 -> V_32 . V_317 . V_23 . V_27 = V_7 -> V_27 ;
...
int F_71 ( struct V_6 * V_7 , int type , int V_327 ,
...
#endif
F_24 ( & V_26 ) ;
V_327 = F_12 ( V_7 , V_327 == - 1 ? 0 : V_327 , V_332 ) ;
if ( V_327 == V_332 )
V_327 = F_12 ( V_7 , 0 , V_332 ) ;
if ( V_327 == V_332 ) {
F_47 ( V_336 L_18 ) ;
F_26 ( & V_26 ) ;
return - V_338 ;
...
V_7 -> V_28 -> V_91 = & V_340 ;
V_7 -> V_28 -> V_330 = V_330 ;
V_54 = F_76 ( V_7 -> V_28 , F_77 ( V_319 , V_7 -> V_27 ) , 1 ) ;
if ( V_54 < 0 ) {
F_47 ( V_336 L_20 , V_321 ) ;
F_17 ( V_7 -> V_28 ) ;
V_7 -> V_28 = NULL ;
goto V_339;
}
V_7 -> V_23 . V_341 = & V_342 ;
V_7 -> V_23 . V_343 = F_77 ( V_319 , V_7 -> V_27 ) ;
V_7 -> V_23 . V_344 = V_7 -> V_337 ;
F_78 ( & V_7 -> V_23 , L_21 , V_333 , V_7 -> V_19 ) ;
V_54 = F_79 ( & V_7 -> V_23 ) ;
if ( V_54 < 0 ) {
F_47 ( V_336 L_22 , V_321 ) ;
goto V_339;
}
V_7 -> V_23 . V_35 = F_23 ;
if ( V_327 != - 1 && V_327 != V_7 -> V_19 && V_328 )
F_47 ( V_320 L_23 , V_321 ,
V_333 , V_327 , F_48 ( V_7 ) ) ;
F_80 ( V_7 -> V_25 ) ;
V_54 = F_67 ( V_7 , type ) ;
F_9 ( V_345 , & V_7 -> V_77 ) ;
return 0 ;
...
{
T_8 V_23 = F_77 ( V_319 , 0 ) ;
int V_54 ;
F_47 ( V_346 L_24 ) ;
V_54 = F_84 ( V_23 , V_86 , V_347 ) ;
if ( V_54 < 0 ) {
F_47 ( V_320 L_25 ,
V_319 ) ;
return V_54 ;
