...
V_60 = F_21 ( V_57 , V_66 , 0 ) ;
V_2 -> V_5 = F_22 ( & V_57 -> V_7 , V_60 ) ;
if ( F_23 ( V_2 -> V_5 ) )
return F_24 ( V_2 -> V_5 ) ;
V_58 = F_25 ( & V_57 -> V_7 , V_61 -> V_67 , F_17 , 0 ,
V_57 -> V_68 , V_2 ) ;
if ( V_58 ) {
F_7 ( & V_57 -> V_7 , L_6 , V_61 ) ;
return V_58 ;
}
F_26 ( & V_57 -> V_7 ) ;
if ( F_27 ( & V_57 -> V_7 ) < 0 ) {
...
T_1 V_3 = 0 , V_26 ;
V_72 -> V_74 = F_3 ( V_2 , V_49 ) ;
V_72 -> V_75 = F_3 ( V_2 , V_76 ) ;
V_72 -> V_77 = F_3 ( V_2 , V_19 ) ;
V_72 -> V_78 = F_3 ( V_2 , V_22 ) ;
for ( V_26 = 0 ; V_26 < V_17 ; V_26 ++ ) {
V_3 = V_26 * V_29 ;
switch ( V_9 ) {
case V_32 :
V_72 -> V_79 [ V_26 ] = F_3 ( V_2 ,
V_33 + V_3 ) ;
V_72 -> V_80 [ V_26 ] = F_3 ( V_2 ,
V_81 + V_3 ) ;
V_72 -> V_82 [ V_26 ] = F_3 ( V_2 ,
V_83 + V_3 ) ;
case V_30 :
V_72 -> V_84 [ V_26 ] = F_3 ( V_2 ,
V_85 + V_3 ) ;
V_72 -> V_86 [ V_26 ] = F_3 ( V_2 ,
V_87 + V_3 ) ;
case V_31 :
V_72 -> V_88 [ V_26 ] = F_3 ( V_2 ,
V_89 + V_3 ) ;
V_72 -> V_90 [ V_26 ] = F_3 ( V_2 ,
V_28 + V_3 ) ;
break;
default:
return - V_16 ;
...
enum V_8 V_9 = V_2 -> V_9 ;
T_1 V_3 = 0 , V_26 ;
F_1 ( V_2 , V_49 , V_72 -> V_74 ) ;
F_1 ( V_2 , V_76 , V_72 -> V_75 ) ;
F_1 ( V_2 , V_19 , V_72 -> V_77 ) ;
F_1 ( V_2 , V_22 , V_72 -> V_78 ) ;
for ( V_26 = 0 ; V_26 < V_17 ; V_26 ++ ) {
V_3 = V_26 * V_29 ;
switch ( V_9 ) {
case V_32 :
