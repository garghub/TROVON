...
{
F_14 ( L_9 ,
V_32 , args -> V_96 , args -> V_97 , V_94 -> V_98 ) ;
if ( args -> V_96 > V_92 -> V_99 )
return F_2 ( V_100 ) ;
if ( args -> V_97 == V_94 -> V_98 ) {
F_14 ( L_10 ,
V_32 , args -> V_97 ) ;
...
if ( F_57 ( V_94 -> V_98 == 0xFFFFFFFFU ) ) {
if ( args -> V_97 == 1 )
return F_2 ( V_72 ) ;
} else if ( F_58 ( args -> V_97 == V_94 -> V_98 + 1 ) )
return F_2 ( V_72 ) ;
return F_2 ( V_105 ) ;
}
...
F_14 ( L_11
L_12 , V_32 ,
( ( T_3 * ) & V_112 -> V_119 . V_118 ) [ 0 ] ,
( ( T_3 * ) & V_112 -> V_119 . V_118 ) [ 1 ] ,
( ( T_3 * ) & V_112 -> V_119 . V_118 ) [ 2 ] ,
( ( T_3 * ) & V_112 -> V_119 . V_118 ) [ 3 ] ,
V_114 -> V_123 , V_114 -> V_124 ) ;
V_11 = F_60 ( V_92 , V_114 -> V_124 ,
V_114 -> V_123 , V_125 >> 1 ) < 0 ;
if ( V_11 )
goto V_14;
}
}
