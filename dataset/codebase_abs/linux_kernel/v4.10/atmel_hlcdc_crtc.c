...
{
struct V_99 * V_10 = V_56 -> V_100 ;
struct V_101 * V_102 = V_10 -> V_102 ;
struct V_5 * V_7 ;
int V_92 ;
int V_72 ;
V_7 = F_52 ( sizeof( * V_7 ) , V_97 ) ;
if ( ! V_7 )
return - V_103 ;
V_7 -> V_10 = V_10 ;
V_92 = F_58 ( V_56 , & V_7 -> V_4 ,
& V_102 -> V_104 -> V_4 ,
V_102 -> V_105 ? & V_102 -> V_105 -> V_4 : NULL ,
& V_106 , NULL ) ;
if ( V_92 < 0 )
goto V_107;
V_7 -> V_108 = F_36 ( & V_7 -> V_4 ) ;
if ( V_102 -> V_105 )
V_102 -> V_105 -> V_4 . V_109 = 1 << V_7 -> V_108 ;
for ( V_72 = 0 ; V_72 < V_102 -> V_110 ; V_72 ++ )
V_102 -> V_111 [ V_72 ] -> V_4 . V_109 = 1 << V_7 -> V_108 ;
F_59 ( & V_7 -> V_4 , & V_112 ) ;
F_60 ( & V_7 -> V_4 ) ;
V_10 -> V_7 = & V_7 -> V_4 ;
return 0 ;
