...
V_26 -> V_2 = V_2 ;
F_28 ( V_2 , V_26 ) ;
V_26 -> V_61 = F_29 ( & V_2 -> V_15 ,
L_6 , V_67 ) ;
if ( F_30 ( V_26 -> V_61 ) ) {
error = F_31 ( V_26 -> V_61 ) ;
if ( error != - V_68 )
F_4 ( & V_2 -> V_15 ,
L_7 , error ) ;
return error ;
}
V_26 -> V_63 = F_29 ( & V_2 -> V_15 ,
L_8 , V_69 ) ;
if ( F_30 ( V_26 -> V_63 ) ) {
error = F_31 ( V_26 -> V_63 ) ;
if ( error != - V_68 )
F_4 ( & V_2 -> V_15 ,
L_9 , error ) ;
return error ;
...
V_30 -> V_70 = L_11 ;
V_30 -> V_28 . V_71 = V_72 ;
F_33 ( V_30 , V_52 , 0 , V_73 , 0 , 0 ) ;
F_33 ( V_30 , V_53 , 0 , V_74 , 0 , 0 ) ;
F_33 ( V_30 , V_51 , 0 , V_75 , 0 , 0 ) ;
F_33 ( V_30 , V_48 ,
0 , V_76 , 0 , 0 ) ;
F_33 ( V_30 , V_50 ,
0 , V_77 , 0 , 0 ) ;
error = F_34 ( V_30 , V_78 , V_79 ) ;
if ( error ) {
F_4 ( & V_2 -> V_15 ,
L_12 , error ) ;
return error ;
}
error = F_35 ( & V_2 -> V_15 , V_2 -> V_59 ,
NULL , F_20 ,
V_80 ,
V_2 -> V_70 , V_26 ) ;
if ( error ) {
