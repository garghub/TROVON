...
int F_72 ( struct V_1 * V_2 , struct V_81 * V_82 ,
T_1 V_8 , int V_133 )
{
...
T_3 F_100 ( int V_168 , void * V_169 )
{
return F_101 ( V_168 , V_169 , F_99 ) ;
}
void F_102 ( struct V_1 * V_2 )
{
T_1 V_8 ;
struct V_81 * V_82 ;
V_82 = F_69 ( V_2 , V_2 -> V_19 . V_159 ) ;
...
unsigned int F_110 ( struct V_68 * V_69 , int V_177 ,
T_1 * V_178 )
{
struct V_1 * V_2 = V_69 -> V_19 -> V_2 ;
struct V_39 V_40 ;
...
;
else if ( ( V_69 -> V_148 == 0 ) && ( V_179 == 0x81 ) )
;
else
return V_180 ;
V_32 = F_111 ( & V_40 ) ;
if ( V_32 == V_181 ) {
if ( V_177 && ( V_69 -> V_144 & V_146 ) )
V_32 = V_182 ;
else
V_32 = V_180 ;
} else if ( ( V_32 == V_182 ) &&
...
int F_112 ( struct V_18 * V_19 , unsigned int V_183 ,
unsigned long V_20 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
struct V_34 * V_3 = & V_2 -> V_3 ;
...
static int F_113 ( struct V_1 * V_2 , unsigned int V_183 ,
unsigned long V_20 )
{
struct V_34 * V_3 = & V_2 -> V_3 ;
F_36 ( L_33 , V_2 -> V_64 ) ;
...
return F_112 ( & V_2 -> V_19 , V_183 , V_20 ) ;
}
int F_115 ( struct V_18 * V_19 , unsigned int * V_189 ,
unsigned long V_20 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
...
if ( F_109 ( V_2 , 0 ) )
V_183 |= ( 1 << 0 ) ;
if ( V_190 && F_109 ( V_2 , 1 ) )
V_183 |= ( 1 << 1 ) ;
V_2 -> V_5 -> V_31 ( V_2 , 0 ) ;
F_36 ( L_34 , V_183 ) ;
V_173 = F_113 ( V_2 , V_183 , V_20 ) ;
if ( V_173 && ( V_173 != - V_16 || F_116 ( V_19 ) ) ) {
F_117 ( V_19 , L_35 , V_173 ) ;
return V_173 ;
}
V_189 [ 0 ] = F_110 ( & V_19 -> V_24 [ 0 ] ,
V_183 & ( 1 << 0 ) , & V_179 ) ;
if ( V_190 && V_179 != 0x81 )
V_189 [ 1 ] = F_110 ( & V_19 -> V_24 [ 1 ] ,
V_183 & ( 1 << 1 ) , & V_179 ) ;
...
{
struct V_170 * V_171 = & V_19 -> V_172 ;
const unsigned long * V_192 = F_119 ( V_171 ) ;
bool V_193 ;
int V_173 ;
V_173 = F_120 ( V_19 , V_192 , V_20 , & V_193 ,
F_18 ) ;
if ( V_193 )
...
void F_121 ( struct V_18 * V_19 , unsigned int * V_189 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
F_122 ( V_19 , V_189 ) ;
if ( V_189 [ 0 ] != V_180 )
...
V_82 = NULL ;
F_127 ( V_2 -> V_137 , V_42 ) ;
if ( V_2 -> V_5 -> V_199 )
V_2 -> V_5 -> V_199 ( V_82 ) ;
F_128 ( V_2 -> V_137 , V_42 ) ;
if ( ( V_197 == V_200 ||
V_197 == F_118 ) && ! F_116 ( & V_2 -> V_19 ) )
V_197 = NULL ;
F_129 ( V_2 , V_2 -> V_5 -> V_201 , V_196 , V_197 ,
V_2 -> V_5 -> V_202 ) ;
}
void F_130 ( struct V_34 * V_3 )
{
...
static int F_131 ( struct V_214 * V_215 , int V_216 )
{
int V_174 ;
V_216 = V_216 * 2 ;
for ( V_174 = 0 ; V_174 < 2 ; V_174 ++ ) {
if ( F_132 ( V_215 , V_216 + V_174 ) == 0 ||
F_133 ( V_215 , V_216 + V_174 ) == 0 )
return 0 ;
}
return 1 ;
}
int F_134 ( struct V_217 * V_218 )
{
struct V_24 * V_219 = V_218 -> V_69 ;
struct V_214 * V_215 = F_135 ( V_219 ) ;
...
if ( F_136 ( V_2 ) )
continue;
if ( ! F_131 ( V_215 , V_174 ) ) {
V_2 -> V_5 = & V_224 ;
continue;
}
V_173 = F_137 ( V_215 , 0x3 << V_222 ,
F_138 ( V_219 ) ) ;
if ( V_173 ) {
F_139 ( V_219 ,
L_40 ,
...
F_130 ( & V_2 -> V_3 ) ;
F_142 ( V_2 , L_41 ,
( unsigned long long ) F_132 ( V_215 , V_222 ) ,
( unsigned long long ) F_132 ( V_215 , V_222 + 1 ) ) ;
V_220 |= 1 << V_174 ;
}
if ( ! V_220 ) {
F_143 ( V_219 , L_42 ) ;
...
int F_144 ( struct V_214 * V_215 ,
const struct F_27 * const * V_226 ,
struct V_217 * * V_227 )
{
struct V_217 * V_218 ;
int V_173 ;
if ( ! F_145 ( & V_215 -> V_69 , NULL , V_228 ) )
return - V_229 ;
V_218 = F_146 ( & V_215 -> V_69 , V_226 , 2 ) ;
if ( ! V_218 ) {
F_143 ( & V_215 -> V_69 , L_43 ) ;
V_173 = - V_229 ;
goto V_125;
}
V_173 = F_134 ( V_218 ) ;
if ( V_173 )
goto V_125;
F_147 ( & V_215 -> V_69 , NULL ) ;
* V_227 = V_218 ;
return 0 ;
V_125:
F_148 ( & V_215 -> V_69 , NULL ) ;
return V_173 ;
}
int F_149 ( struct V_217 * V_218 ,
T_5 V_230 ,
struct V_231 * V_232 )
{
struct V_24 * V_69 = V_218 -> V_69 ;
struct V_214 * V_215 = F_135 ( V_69 ) ;
const char * V_233 = F_138 ( V_218 -> V_69 ) ;
int V_234 = 0 , V_173 ;
V_173 = F_150 ( V_218 ) ;
if ( V_173 )
return V_173 ;
...
T_1 V_236 , V_220 ;
F_151 ( V_215 , V_237 , & V_236 ) ;
V_220 = ( 1 << 2 ) | ( 1 << 0 ) ;
if ( ( V_236 & V_220 ) != V_220 )
V_234 = 1 ;
}
if ( ! F_145 ( V_69 , NULL , V_228 ) )
return - V_229 ;
if ( ! V_234 && V_215 -> V_168 ) {
int V_174 ;
V_173 = F_152 ( V_69 , V_215 -> V_168 , V_230 ,
V_238 , V_233 , V_218 ) ;
if ( V_173 )
goto V_239;
for ( V_174 = 0 ; V_174 < 2 ; V_174 ++ ) {
if ( F_136 ( V_218 -> V_221 [ V_174 ] ) )
continue;
F_142 ( V_218 -> V_221 [ V_174 ] , L_44 , V_215 -> V_168 ) ;
}
} else if ( V_234 ) {
if ( ! F_136 ( V_218 -> V_221 [ 0 ] ) ) {
V_173 = F_152 ( V_69 , F_153 ( V_215 ) ,
V_230 , V_238 ,
V_233 , V_218 ) ;
if ( V_173 )
goto V_239;
F_142 ( V_218 -> V_221 [ 0 ] , L_44 ,
F_153 ( V_215 ) ) ;
}
if ( ! F_136 ( V_218 -> V_221 [ 1 ] ) ) {
V_173 = F_152 ( V_69 , F_154 ( V_215 ) ,
V_230 , V_238 ,
V_233 , V_218 ) ;
if ( V_173 )
goto V_239;
F_142 ( V_218 -> V_221 [ 1 ] , L_44 ,
F_154 ( V_215 ) ) ;
}
}
V_173 = F_155 ( V_218 , V_232 ) ;
V_239:
if ( V_173 == 0 )
F_147 ( V_69 , NULL ) ;
else
...
static const struct F_27 * F_156 (
const struct F_27 * const * V_226 )
{
int V_174 ;
...
#ifdef F_62
if ( V_243 )
V_173 = F_159 ( V_215 , V_226 , & V_218 ) ;
else
#endif
V_173 = F_144 ( V_215 , V_226 , & V_218 ) ;
if ( V_173 )
goto V_239;
V_218 -> V_246 = V_241 ;
V_218 -> V_42 |= V_242 ;
...
if ( V_243 ) {
F_160 ( V_215 ) ;
V_173 = F_149 ( V_218 , V_247 , V_232 ) ;
} else
#endif
V_173 = F_149 ( V_218 , F_100 , V_232 ) ;
V_239:
if ( V_173 == 0 )
F_147 ( & V_215 -> V_69 , NULL ) ;
else
...
int F_161 ( struct V_214 * V_215 ,
const struct F_27 * const * V_226 ,
struct V_231 * V_232 , void * V_241 , int V_248 )
{
return F_157 ( V_215 , V_226 , V_232 , V_241 , V_248 , 0 ) ;
}
...
V_244 = 0 ;
F_163 (qc->sg, sg, qc->n_elem, si) {
T_6 V_253 , V_86 ;
T_6 V_254 , V_255 ;
V_253 = ( T_6 ) F_164 ( V_113 ) ;
V_254 = F_165 ( V_113 ) ;
while ( V_254 ) {
V_86 = V_253 & 0xffff ;
V_255 = V_254 ;
...
V_255 = 0x10000 - V_86 ;
V_250 [ V_244 ] . V_253 = F_166 ( V_253 ) ;
V_250 [ V_244 ] . V_256 = F_166 ( V_255 & 0xffff ) ;
...
V_250 [ V_244 - 1 ] . V_256 |= F_166 ( V_257 ) ;
}
static void F_167 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = V_82 -> V_2 ;
struct V_249 * V_250 = V_2 -> V_251 ;
struct V_112 * V_113 ;
...
V_250 [ V_244 ] . V_253 = F_166 ( V_253 ) ;
if ( V_258 == 0 ) {
V_250 [ V_244 ] . V_256 = F_166 ( 0x8000 ) ;
V_258 = 0x8000 ;
V_250 [ ++ V_244 ] . V_253 = F_166 ( V_253 + 0x8000 ) ;
}
V_250 [ V_244 ] . V_256 = F_166 ( V_258 ) ;
F_32 ( L_46 , V_244 , V_253 , V_255 ) ;
V_244 ++ ;
V_254 -= V_255 ;
V_253 += V_255 ;
...
void F_168 ( struct V_81 * V_82 )
{
if ( ! ( V_82 -> V_42 & V_259 ) )
return;
F_162 ( V_82 ) ;
}
void F_169 ( struct V_81 * V_82 )
{
if ( ! ( V_82 -> V_42 & V_259 ) )
return;
F_167 ( V_82 ) ;
}
unsigned int F_170 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = V_82 -> V_2 ;
struct V_18 * V_19 = V_82 -> V_69 -> V_19 ;
if ( ! F_171 ( V_82 -> V_40 . V_101 ) )
return F_93 ( V_82 ) ;
F_25 ( V_2 , V_82 -> V_69 -> V_148 , 1 , 0 ) ;
switch ( V_82 -> V_40 . V_101 ) {
case V_260 :
...
unsigned int F_172 ( struct V_1 * V_2 , struct V_81 * V_82 )
{
struct V_109 * V_110 = & V_2 -> V_19 . V_111 ;
T_1 V_262 = 0 ;
bool V_263 = false ;
unsigned int V_264 ;
if ( V_2 -> V_90 == V_91 && F_171 ( V_82 -> V_40 . V_101 ) ) {
...
V_264 = F_98 ( V_2 , V_82 , V_263 ) ;
if ( F_41 ( V_82 -> V_126 ) && F_171 ( V_82 -> V_40 . V_101 ) )
F_64 ( V_110 , L_48 , V_262 ) ;
return V_264 ;
}
T_3 V_247 ( int V_168 , void * V_169 )
{
return F_101 ( V_168 , V_169 , F_172 ) ;
}
...
V_82 = NULL ;
F_127 ( V_2 -> V_137 , V_42 ) ;
if ( V_82 && F_171 ( V_82 -> V_40 . V_101 ) ) {
T_1 V_262 ;
V_262 = V_2 -> V_5 -> V_265 ( V_2 ) ;
if ( V_82 -> V_126 == V_271 && ( V_262 & V_268 ) ) {
V_82 -> V_126 = V_269 ;
V_270 = true ;
}
V_2 -> V_5 -> V_267 ( V_82 ) ;
...
T_1 V_275 ;
F_178 () ;
F_179 ( V_2 -> V_276 , V_2 -> V_3 . V_273 + V_277 ) ;
...
int F_186 ( struct V_214 * V_215 )
{
unsigned long V_243 = F_132 ( V_215 , 4 ) ;
T_1 V_285 ;
if ( V_243 == 0 )
return - V_286 ;
V_285 = F_187 ( V_243 + 0x02 ) ;
F_188 ( V_285 & 0x60 , V_243 + 0x02 ) ;
V_285 = F_187 ( V_243 + 0x02 ) ;
if ( V_285 & 0x80 )
return - V_287 ;
return 0 ;
}
static void F_189 ( struct V_217 * V_218 , const char * V_288 )
{
int V_174 ;
F_143 ( V_218 -> V_69 , L_49 , V_288 ) ;
for ( V_174 = 0 ; V_174 < 2 ; V_174 ++ ) {
V_218 -> V_221 [ V_174 ] -> V_281 = 0 ;
V_218 -> V_221 [ V_174 ] -> V_282 = 0 ;
}
}
void F_190 ( struct V_217 * V_218 )
{
struct V_24 * V_219 = V_218 -> V_69 ;
struct V_214 * V_215 = F_135 ( V_219 ) ;
int V_174 , V_173 ;
...
V_173 = F_191 ( & V_215 -> V_69 , V_289 ) ;
if ( V_173 )
F_189 ( V_218 , L_51 ) ;
if ( ! V_173 ) {
V_173 = F_192 ( & V_215 -> V_69 , V_289 ) ;
if ( V_173 )
F_189 ( V_218 ,
L_52 ) ;
}
V_173 = F_137 ( V_215 , 1 << 4 , F_138 ( V_219 ) ) ;
if ( V_173 ) {
F_189 ( V_218 , L_53 ) ;
return;
}
V_218 -> V_223 = F_141 ( V_215 ) ;
for ( V_174 = 0 ; V_174 < 2 ; V_174 ++ ) {
struct V_1 * V_2 = V_218 -> V_221 [ V_174 ] ;
...
V_218 -> V_42 |= V_291 ;
F_142 ( V_2 , L_54 ,
( unsigned long long ) F_132 ( V_215 , 4 ) + 8 * V_174 ) ;
}
}
...
{
int V_173 ;
V_173 = F_144 ( V_215 , V_226 , V_227 ) ;
if ( V_173 )
return V_173 ;
F_190 ( * V_227 ) ;
return 0 ;
}
int F_193 ( struct V_214 * V_215 ,
const struct F_27 * const * V_226 ,
struct V_231 * V_232 , void * V_241 ,
int V_242 )
{
return F_157 ( V_215 , V_226 , V_232 , V_241 , V_242 , 1 ) ;
}
void F_194 ( struct V_1 * V_2 )
{
F_195 ( & V_2 -> V_157 , F_90 ) ;
V_2 -> V_21 = V_292 ;
V_2 -> V_37 = 0xFF ;
}
int T_7 F_196 ( void )
{
V_152 = F_197 ( L_55 , V_293 , V_294 ) ;
if ( ! V_152 )
return - V_229 ;
return 0 ;
}
