...
static T_4 F_24 ( int V_72 , void * V_73 )
{
struct V_1 * V_2 = V_73 ;
V_42 ( & V_2 -> V_42 ) ;
return V_74 ;
...
static int F_27 ( struct V_1 * V_2 , struct V_86 * V_87 )
{
int V_6 , V_88 , V_89 ;
T_2 V_90 ;
V_6 = F_28 ( V_87 , L_9 ,
...
int V_6 , V_99 ;
T_5 V_100 ;
V_55 = F_30 ( V_27 , sizeof( * V_2 ) ) ;
if ( ! V_55 )
return - V_101 ;
V_2 = F_20 ( V_55 ) ;
V_2 -> V_27 = V_27 ;
V_2 -> V_7 = F_31 ( V_27 -> V_102 , NULL ) ;
if ( ! V_2 -> V_7 )
return - V_103 ;
F_32 ( & V_2 -> V_42 ) ;
F_33 ( & V_2 -> V_64 ) ;
V_6 = F_28 ( V_87 , L_11 , & V_100 ) ;
if ( V_6 < 0 )
return - V_103 ;
V_2 -> V_8 = V_100 ;
V_6 = F_26 ( V_2 ) ;
...
V_55 -> V_108 = & V_109 ;
V_55 -> V_110 = V_111 ;
V_55 -> V_112 = F_38 ( V_111 ) ;
return F_39 ( V_27 , V_55 ) ;
}
