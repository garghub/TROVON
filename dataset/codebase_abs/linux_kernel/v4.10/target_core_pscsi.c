...
static T_5
F_69 ( struct V_111 * V_112 )
{
if ( V_112 -> V_136 & V_179 )
return V_180 ;
return F_70 ( V_112 , V_181 ) ;
}
static T_5
...
struct V_160 * V_161 ;
T_5 V_32 ;
V_119 = F_4 ( sizeof( * V_119 ) + F_71 ( V_112 -> V_184 ) , V_9 ) ;
if ( ! V_119 ) {
return V_178 ;
}
V_112 -> V_120 = V_119 ;
...
V_161 -> V_192 = V_194 ;
V_161 -> V_195 = V_196 ;
F_74 ( V_64 -> V_67 -> V_65 , NULL , V_161 ,
( V_112 -> V_197 == V_198 ) ,
V_187 ) ;
return 0 ;
V_185:
...
static T_6 F_77 ( struct V_2 * V_3 )
{
struct V_1 * V_64 = F_1 ( V_3 ) ;
...
switch ( F_79 ( V_119 -> V_122 ) ) {
case V_207 :
F_80 ( V_112 , V_112 -> V_206 ) ;
break;
default:
F_6 ( L_81
L_80 , V_112 , V_119 -> V_121 [ 0 ] ,
