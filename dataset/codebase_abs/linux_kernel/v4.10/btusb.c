...
static int F_141 ( struct V_115 * V_84 ,
...
unsigned V_244 ;
int V_62 , V_12 ;
F_23 ( L_85 , V_84 , V_243 ) ;
if ( V_84 -> V_120 -> V_121 . V_245 != 0 ) {
if ( ! ( V_243 -> V_246 & V_247 ) )
return - V_47 ;
if ( V_84 -> V_120 -> V_121 . V_245 != 2 )
return - V_47 ;
}
V_244 = V_84 -> V_120 -> V_121 . V_245 ;
if ( ! V_243 -> V_246 ) {
const struct V_242 * V_248 ;
V_248 = F_142 ( V_84 , V_249 ) ;
if ( V_248 )
V_243 = V_248 ;
}
...
struct V_211 * V_44 = F_143 ( V_84 ) ;
if ( F_32 ( V_44 -> V_252 . V_253 ) <= 0x0001 )
return - V_47 ;
}
V_2 = F_144 ( & V_84 -> V_76 , sizeof( * V_2 ) , V_87 ) ;
if ( ! V_2 )
return - V_16 ;
for ( V_62 = 0 ; V_62 < V_84 -> V_120 -> V_121 . V_122 ; V_62 ++ ) {
V_118 = & V_84 -> V_120 -> V_123 [ V_62 ] . V_121 ;
...
F_55 ( V_139 , & V_23 -> V_138 ) ;
if ( V_243 -> V_246 & V_269 )
V_23 -> V_270 = F_88 ;
#ifdef F_152
if ( V_243 -> V_246 & V_271 ) {
V_23 -> V_135 = 15 ;
V_23 -> V_270 = V_272 ;
V_23 -> V_273 = F_140 ;
V_23 -> V_274 = V_275 ;
...
V_23 -> V_274 = F_124 ;
if ( V_243 -> V_246 & V_289 ) {
F_55 ( V_290 , & V_23 -> V_138 ) ;
F_55 ( V_291 , & V_23 -> V_138 ) ;
}
if ( V_243 -> V_246 & V_292 ) {
V_23 -> V_135 = 2 ;
F_55 ( V_293 , & V_23 -> V_138 ) ;
}
if ( V_243 -> V_246 & V_251 ) {
V_23 -> V_274 = F_125 ;
F_55 ( V_283 , & V_23 -> V_138 ) ;
...
static void F_159 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_160 ( V_84 ) ;
struct V_32 * V_23 ;
F_23 ( L_87 , V_84 ) ;
if ( ! V_2 )
return;
...
if ( V_84 == V_2 -> V_84 ) {
if ( V_2 -> V_116 )
F_162 ( & V_307 , V_2 -> V_116 ) ;
if ( V_2 -> V_89 )
F_162 ( & V_307 , V_2 -> V_89 ) ;
} else if ( V_84 == V_2 -> V_116 ) {
if ( V_2 -> V_89 )
F_162 ( & V_307 , V_2 -> V_89 ) ;
F_162 ( & V_307 , V_2 -> V_84 ) ;
...
static int F_163 ( struct V_115 * V_84 , T_10 V_308 )
{
struct V_1 * V_2 = F_160 ( V_84 ) ;
F_23 ( L_87 , V_84 ) ;
if ( V_2 -> V_309 ++ )
...
static int F_170 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_160 ( V_84 ) ;
struct V_32 * V_23 = V_2 -> V_23 ;
int V_12 = 0 ;
