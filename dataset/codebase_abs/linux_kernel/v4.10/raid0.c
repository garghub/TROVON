...
F_29 ( V_1 -> V_45 , V_1 -> V_43 << 9 ) ;
F_30 ( V_1 -> V_45 ,
( V_1 -> V_43 << 9 ) * V_1 -> V_8 ) ;
F_11 (rdev, mddev) {
F_31 ( V_1 -> V_61 , V_35 -> V_15 ,
V_35 -> V_62 << 9 ) ;
if ( F_32 ( F_2 ( V_35 -> V_15 ) ) )
V_60 = true ;
}
if ( ! V_60 )
F_33 ( V_63 , V_1 -> V_45 ) ;
...
int V_64 = V_1 -> V_8 *
( V_1 -> V_43 << 9 ) / V_65 ;
if ( V_1 -> V_45 -> V_16 . V_66 < 2 * V_64 )
V_1 -> V_45 -> V_16 . V_66 = 2 * V_64 ;
}
F_4 ( V_1 ) ;
V_12 = F_36 ( V_1 ) ;
return V_12 ;
}
static void F_37 ( struct V_1 * V_1 , void * V_67 )
{
struct V_3 * V_4 = V_67 ;
F_16 ( V_4 -> V_9 ) ;
F_16 ( V_4 -> V_7 ) ;
...
unsigned int V_56 , struct V_68 * V_68 )
{
if ( F_39 ( F_20 ( V_56 ) ) ) {
return V_56 >=
( ( V_68 -> V_69 . V_70 & ( V_56 - 1 ) )
+ F_40 ( V_68 ) ) ;
} else{
T_1 V_52 = V_68 -> V_69 . V_70 ;
return V_56 >= ( F_12 ( V_52 , V_56 )
+ F_40 ( V_68 ) ) ;
}
}
static void F_41 ( struct V_1 * V_1 , struct V_68 * V_68 )
{
struct V_9 * V_37 ;
struct V_6 * V_71 ;
struct V_68 * V_72 ;
if ( F_42 ( V_68 -> V_73 & V_74 ) ) {
F_43 ( V_1 , V_68 ) ;
return;
}
do {
T_1 V_75 = V_68 -> V_69 . V_70 ;
T_1 V_52 = V_75 ;
unsigned V_56 = V_1 -> V_43 ;
unsigned V_31 = V_56 -
( F_39 ( F_20 ( V_56 ) )
? ( V_52 & ( V_56 - 1 ) )
: F_12 ( V_52 , V_56 ) ) ;
V_52 = V_75 ;
if ( V_31 < F_40 ( V_68 ) ) {
V_72 = F_44 ( V_68 , V_31 , V_76 , V_77 ) ;
F_45 ( V_72 , V_68 ) ;
} else {
V_72 = V_68 ;
}
V_37 = F_17 ( V_1 -> V_5 , & V_52 ) ;
V_71 = F_19 ( V_1 , V_37 , V_52 , & V_52 ) ;
V_72 -> V_78 = V_71 -> V_15 ;
V_72 -> V_69 . V_70 = V_52 + V_37 -> V_26 +
V_71 -> V_62 ;
if ( F_42 ( ( F_46 ( V_72 ) == V_79 ) &&
! F_32 ( F_2 ( V_72 -> V_78 ) ) ) ) {
F_47 ( V_72 ) ;
} else {
if ( V_1 -> V_61 )
...
static void F_51 ( struct V_80 * V_81 , struct V_1 * V_1 )
{
F_52 ( V_81 , L_33 , V_1 -> V_43 / 2 ) ;
return;
}
...
struct V_3 * V_82 ;
int V_93 ;
if ( ( V_1 -> V_8 - 1 ) != V_1 -> V_83 ) {
F_57 ( L_39 ,
F_6 ( V_1 ) ) ;
return F_10 ( - V_46 ) ;
}
V_93 = 64 * 2 ;
while ( V_93 && ( V_1 -> V_58 & ( V_93 - 1 ) ) )
V_93 >>= 1 ;
if ( ( V_93 << 9 ) < V_65 )
return F_10 ( - V_46 ) ;
V_1 -> V_85 = 0 ;
...
static void F_59 ( struct V_1 * V_1 , int V_97 )
{
}
