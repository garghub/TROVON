...
struct V_59 * V_59 ;
unsigned long V_60 ;
V_48 = F_21 ( V_32 , 1 , & V_59 ,
V_43 ? 0 : V_61 ) ;
if ( V_48 < 0 )
break;
if ( V_7 -> V_62 ) {
V_60 = F_22 ( V_59 ) | ( V_32 & ~ V_55 ) ;
} else {
V_60 = V_32 ;
}
F_2 ( & V_7 -> V_8 , V_44 ) ;
...
static T_4 F_29 ( struct V_39 * V_40 , char T_5 * V_41 ,
T_6 V_42 , T_7 * V_75 )
{
return F_16 ( V_40 , V_41 , V_42 , 0 ) ;
}
static T_4 F_30 ( struct V_39 * V_40 ,
...
static unsigned int F_31 ( struct V_39 * V_40 , T_8 * V_76 )
{
struct V_1 * V_2 = V_40 -> V_45 ;
unsigned int V_77 = 0 ;
int V_5 ;
F_32 ( & V_2 -> V_8 ) ;
F_33 ( V_40 , & V_2 -> V_74 , V_76 ) ;
V_5 = F_1 ( V_2 , V_78 ) ;
F_27 ( & V_2 -> V_8 ) ;
if ( V_5 & V_79 )
V_77 |= V_80 | V_81 ;
...
static T_9 F_34 ( int V_88 , void * V_89 )
{
struct V_6 * V_7 = V_89 ;
unsigned long V_44 ;
int V_47 = 0 ;
...
if ( V_36 == 0 )
break;
V_90 = F_5 ( V_7 -> V_9 + V_91 ) ;
V_2 = (struct V_1 * ) ( V_92 ) V_36 ;
if ( V_90 & V_93 ) {
F_26 ( V_49 , & V_2 -> V_4 ) ;
V_90 |= V_94 | V_95 ;
}
...
F_6 ( & V_7 -> V_8 , V_44 ) ;
return ( V_47 == 0 ) ? V_96 : V_97 ;
}
static int F_38 ( struct V_98 * V_98 , struct V_39 * V_39 )
{
struct V_1 * V_2 ;
struct V_6 * V_7 = V_99 ;
T_10 V_5 ;
V_2 = F_39 ( sizeof( * V_2 ) , V_31 ) ;
if ( V_2 == NULL )
return - V_17 ;
V_2 -> V_7 = V_7 ;
F_40 ( & V_2 -> V_8 ) ;
...
static int F_43 ( struct V_98 * V_98 , struct V_39 * V_40 )
{
struct V_1 * V_2 = V_40 -> V_45 ;
F_7 ( V_2 , V_101 ) ;
F_42 ( V_2 ) ;
...
F_45 ( V_7 -> V_9 != NULL ) ;
F_46 ( & V_7 -> V_8 ) ;
V_104 = F_47 ( V_29 , V_105 , 0 ) ;
if ( V_104 == NULL || F_48 ( V_104 ) < V_56 ) {
F_49 ( & V_29 -> V_7 , L_4 ) ;
return - V_20 ;
}
V_7 -> V_9 = F_50 ( & V_29 -> V_7 , V_104 -> V_106 , V_56 ) ;
if ( V_7 -> V_9 == NULL ) {
F_49 ( & V_29 -> V_7 , L_5 ) ;
return - V_20 ;
}
V_104 = F_47 ( V_29 , V_107 , 0 ) ;
if ( V_104 == NULL ) {
V_102 = - V_20 ;
goto error;
}
V_7 -> V_88 = V_104 -> V_106 ;
V_102 = F_51 ( & V_29 -> V_7 , V_7 -> V_88 , F_34 ,
V_108 , L_6 , V_7 ) ;
if ( V_102 ) {
F_49 ( & V_29 -> V_7 , L_7 ) ;
goto error;
