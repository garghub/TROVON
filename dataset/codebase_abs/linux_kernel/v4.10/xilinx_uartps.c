...
V_173 = ( unsigned char ) F_2 ( V_4 -> V_16 + V_20 ) ;
F_22 ( & V_4 -> V_41 , V_84 ) ;
return V_173 ;
}
static void F_52 ( struct V_3 * V_4 , unsigned char V_173 )
{
unsigned long V_84 ;
F_21 ( & V_4 -> V_41 , V_84 ) ;
while ( ! ( F_2 ( V_4 -> V_16 + V_17 ) & V_106 ) )
F_23 () ;
F_11 ( V_173 , V_4 -> V_16 + V_20 ) ;
while ( ! ( F_2 ( V_4 -> V_16 + V_17 ) & V_106 ) )
F_23 () ;
F_22 ( & V_4 -> V_41 , V_84 ) ;
return;
...
static struct V_3 * F_56 ( int V_178 )
{
struct V_3 * V_4 ;
if ( V_179 [ V_178 ] . V_159 != 0 ) {
...
static void F_60 ( struct V_3 * V_4 , int V_187 )
{
F_58 ( V_4 ) ;
F_11 ( V_187 , V_4 -> V_16 + V_20 ) ;
}
static void T_3 F_61 ( struct V_188 * V_189 , const char * V_190 ,
unsigned V_191 )
{
struct V_192 * V_89 = V_189 -> V_7 ;
F_62 ( & V_89 -> V_4 , V_190 , V_191 , F_60 ) ;
}
static int T_3 F_63 ( struct V_192 * V_193 ,
const char * V_194 )
{
struct V_3 * V_4 = & V_193 -> V_4 ;
if ( ! V_4 -> V_16 )
return - V_195 ;
...
T_2 V_196 ;
int V_61 ;
F_15 ( V_4 -> V_72 , V_193 -> V_58 ,
& V_63 , & V_62 , & V_61 ) ;
V_196 = V_142 ;
if ( V_61 )
V_196 |= V_74 ;
F_11 ( V_196 , V_4 -> V_16 + V_73 ) ;
F_11 ( V_62 , V_4 -> V_16 + V_75 ) ;
F_11 ( V_63 , V_4 -> V_16 + V_76 ) ;
}
V_193 -> V_189 -> V_197 = F_61 ;
return 0 ;
}
static void F_64 ( struct V_188 * V_198 , const char * V_190 ,
unsigned int V_199 )
{
struct V_3 * V_4 = & V_179 [ V_198 -> V_200 ] ;
unsigned long V_84 ;
...
F_21 ( & V_4 -> V_41 , V_84 ) ;
V_201 = F_2 ( V_4 -> V_16 + V_149 ) ;
F_11 ( V_201 , V_4 -> V_16 + V_45 ) ;
V_202 = F_2 ( V_4 -> V_16 + V_91 ) ;
V_202 &= ~ V_92 ;
V_202 |= V_100 ;
F_11 ( V_202 , V_4 -> V_16 + V_91 ) ;
F_62 ( V_4 , V_190 , V_199 , F_60 ) ;
F_58 ( V_4 ) ;
F_11 ( V_202 , V_4 -> V_16 + V_91 ) ;
F_11 ( V_201 , V_4 -> V_16 + V_103 ) ;
if ( V_81 )
F_22 ( & V_4 -> V_41 , V_84 ) ;
}
static int T_3 F_66 ( struct V_188 * V_198 , char * V_205 )
{
struct V_3 * V_4 = & V_179 [ V_198 -> V_200 ] ;
int V_58 = 9600 ;
int V_206 = 8 ;
int V_32 = 'n' ;
int V_207 = 'n' ;
if ( V_198 -> V_200 < 0 || V_198 -> V_200 >= V_180 )
return - V_154 ;
if ( ! V_4 -> V_16 ) {
F_67 ( L_4 V_208 L_5 ,
V_198 -> V_200 ) ;
...
if ( V_205 )
F_68 ( V_205 , & V_58 , & V_32 , & V_206 , & V_207 ) ;
return F_69 ( V_4 , V_198 , V_58 , V_32 , V_206 , V_207 ) ;
}
...
static int F_72 ( struct V_193 * V_193 )
{
struct V_3 * V_4 = F_73 ( V_193 ) ;
struct V_210 * V_211 ;
struct V_193 * V_212 ;
int V_213 = 0 ;
V_211 = F_74 ( & V_4 -> V_39 -> V_4 ) ;
if ( V_211 ) {
V_212 = V_211 -> V_89 ;
V_213 = F_75 ( V_212 ) ;
F_76 ( V_211 ) ;
...
static int F_78 ( struct V_193 * V_193 )
{
struct V_3 * V_4 = F_73 ( V_193 ) ;
unsigned long V_84 = 0 ;
T_2 V_80 ;
...
return F_79 ( & V_214 , V_4 ) ;
}
static int F_80 ( struct V_216 * V_217 )
{
int V_218 , V_178 , V_53 ;
struct V_3 * V_4 ;
struct V_219 * V_220 ;
struct V_5 * V_221 ;
const struct V_222 * V_223 ;
V_221 = F_81 ( & V_217 -> V_89 , sizeof( * V_221 ) ,
V_224 ) ;
if ( ! V_221 )
return - V_161 ;
V_223 = F_82 ( V_225 , V_217 -> V_89 . V_226 ) ;
if ( V_223 && V_223 -> V_7 ) {
const struct V_227 * V_7 = V_223 -> V_7 ;
V_221 -> V_14 = V_7 -> V_14 ;
}
V_221 -> V_177 = F_83 ( & V_217 -> V_89 , L_6 ) ;
if ( F_84 ( V_221 -> V_177 ) ) {
V_221 -> V_177 = F_83 ( & V_217 -> V_89 , L_7 ) ;
if ( ! F_84 ( V_221 -> V_177 ) )
F_37 ( & V_217 -> V_89 , L_8 ) ;
}
if ( F_84 ( V_221 -> V_177 ) ) {
F_37 ( & V_217 -> V_89 , L_9 ) ;
return F_85 ( V_221 -> V_177 ) ;
}
V_221 -> V_72 = F_83 ( & V_217 -> V_89 , L_10 ) ;
if ( F_84 ( V_221 -> V_72 ) ) {
V_221 -> V_72 = F_83 ( & V_217 -> V_89 , L_11 ) ;
if ( ! F_84 ( V_221 -> V_72 ) )
F_37 ( & V_217 -> V_89 , L_12 ) ;
}
if ( F_84 ( V_221 -> V_72 ) ) {
F_37 ( & V_217 -> V_89 , L_13 ) ;
return F_85 ( V_221 -> V_72 ) ;
}
V_218 = F_86 ( V_221 -> V_177 ) ;
if ( V_218 ) {
F_37 ( & V_217 -> V_89 , L_14 ) ;
return V_218 ;
}
V_218 = F_86 ( V_221 -> V_72 ) ;
if ( V_218 ) {
F_37 ( & V_217 -> V_89 , L_15 ) ;
goto V_228;
}
V_220 = F_87 ( V_217 , V_229 , 0 ) ;
if ( ! V_220 ) {
V_218 = - V_195 ;
goto V_230;
}
...
if ( F_90 ( V_221 -> V_72 ,
& V_221 -> V_232 ) )
F_20 ( & V_217 -> V_89 , L_16 ) ;
#endif
V_178 = F_91 ( V_217 -> V_89 . V_226 , L_17 ) ;
if ( V_178 < 0 )
V_178 = 0 ;
V_4 = F_56 ( V_178 ) ;
if ( ! V_4 ) {
F_37 ( & V_217 -> V_89 , L_18 ) ;
V_218 = - V_195 ;
goto V_234;
}
V_4 -> V_159 = V_220 -> V_235 ;
V_4 -> V_53 = V_53 ;
V_4 -> V_89 = & V_217 -> V_89 ;
V_4 -> V_72 = F_92 ( V_221 -> V_72 ) ;
V_4 -> V_6 = V_221 ;
V_221 -> V_4 = V_4 ;
F_93 ( V_217 , V_4 ) ;
V_218 = F_94 ( & V_214 , V_4 ) ;
if ( V_218 ) {
F_37 ( & V_217 -> V_89 ,
L_19 , V_218 ) ;
goto V_234;
...
{
struct V_3 * V_4 = F_98 ( V_217 ) ;
struct V_5 * V_221 = V_4 -> V_6 ;
int V_218 ;
#ifdef F_89
F_95 ( V_221 -> V_72 ,
& V_221 -> V_232 ) ;
#endif
V_218 = F_99 ( & V_214 , V_4 ) ;
V_4 -> V_159 = 0 ;
F_96 ( V_221 -> V_72 ) ;
F_96 ( V_221 -> V_177 ) ;
return V_218 ;
