...
V_5 = F_6 ( V_2 , V_67 ) ;
F_7 ((result == 0), L_2 , return result) ;
} else if ( ( V_2 -> V_64 == V_68 ) || ( V_2 -> V_64 == V_69 ) ) {
V_5 = F_6 ( V_2 , V_70 ) ;
F_7 ((result == 0), L_2 , return result) ;
V_5 = F_6 ( V_2 , V_71 ) ;
F_7 ((result == 0), L_2 , return result) ;
...
{
struct V_72 * V_6 = (struct V_72 * ) ( V_2 -> V_73 ) ;
int V_5 = 0 ;
if ( F_2 ( V_2 -> V_7 . V_8 ,
V_74 ) ) {
int V_75 ;
...
int F_16 ( struct V_1 * V_2 , T_1 V_80 )
{
struct V_72 * V_6 = (struct V_72 * ) ( V_2 -> V_73 ) ;
if ( V_6 -> V_81 &
V_82 )
