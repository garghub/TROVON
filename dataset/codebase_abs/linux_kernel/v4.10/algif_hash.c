...
struct V_17 * V_18 = F_8 ( V_2 ) ;
struct V_3 * V_4 = V_18 -> V_19 ;
struct V_39 * V_7 = & V_4 -> V_7 ;
char V_40 [ F_28 ( F_3 ( V_7 ) ) ] ;
struct V_1 * V_41 ;
struct V_17 * V_42 ;
struct V_3 * V_43 ;
bool V_23 ;
...
F_9 ( V_2 ) ;
V_23 = V_4 -> V_23 ;
V_21 = V_23 ? F_29 ( V_7 , V_40 ) : 0 ;
F_19 ( V_2 ) ;
if ( V_21 )
return V_21 ;
V_21 = F_30 ( V_18 -> V_44 , V_38 ) ;
if ( V_21 )
return V_21 ;
V_41 = V_38 -> V_2 ;
V_42 = F_8 ( V_41 ) ;
...
if ( V_21 )
return V_21 ;
return F_27 ( V_1 , V_38 , V_35 ) ;
}
static void * F_41 ( const char * V_54 , T_3 type , T_3 V_55 )
{
struct V_47 * V_48 ;
struct V_56 * V_57 ;
V_48 = F_42 ( sizeof( * V_48 ) , V_8 ) ;
if ( ! V_48 )
return F_43 ( - V_9 ) ;
V_57 = F_44 ( V_54 , type , V_55 ) ;
if ( F_45 ( V_57 ) ) {
F_46 ( V_48 ) ;
return F_47 ( V_57 ) ;
}
...
{
struct V_47 * V_48 = V_19 ;
F_49 ( V_48 -> V_57 ) ;
F_46 ( V_48 ) ;
}
static int F_50 ( void * V_19 , const T_4 * V_58 , unsigned int V_59 )
{
struct V_47 * V_48 = V_19 ;
int V_21 ;
V_21 = F_51 ( V_48 -> V_57 , V_58 , V_59 ) ;
V_48 -> V_53 = ! V_21 ;
return V_21 ;
}
...
unsigned V_28 = sizeof( * V_4 ) + F_56 ( V_57 ) ;
