...
{
struct V_76 * V_53 = & V_52 -> V_53 ;
struct V_147 * V_51 ;
struct V_183 * V_184 = V_53 -> V_203 ;
struct V_183 * V_207 ;
int V_223 , V_17 , V_49 ;
V_51 = F_98 ( V_53 , sizeof( * V_51 ) , V_212 ) ;
if ( ! V_51 )
return - V_213 ;
V_51 -> V_52 = V_52 ;
F_99 ( V_52 , V_51 ) ;
...
V_223 = F_104 ( V_184 ) ;
V_51 -> V_152 = F_105 ( V_53 , V_223 , sizeof( * V_51 -> V_152 ) , V_212 ) ;
if ( ! V_51 -> V_152 )
return - V_213 ;
V_17 = 0 ;
F_106 (np, child) {
