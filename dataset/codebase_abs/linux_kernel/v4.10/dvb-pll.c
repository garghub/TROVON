...
{
T_1 V_52 [] = { 0 } ;
struct V_14 V_15 = { . V_16 = V_49 , . V_18 = V_53 ,
. V_3 = V_52 , . V_19 = 1 } ;
...
V_10 = F_23 ( sizeof( struct V_9 ) , V_59 ) ;
if ( V_10 == NULL )
return NULL ;
V_10 -> V_17 = V_49 ;
V_10 -> V_24 = V_24 ;
...
V_2 -> V_11 = V_10 ;
if ( ( V_37 ) || ( V_55 [ V_10 -> V_60 ] == V_51 ) ) {
F_11 ( L_4 , V_10 -> V_60 ) ;
if ( V_24 != NULL )
F_24 ( L_5 , F_25 ( V_24 ) , V_49 ) ;
F_24 ( L_6 , V_51 , V_28 -> V_38 ,
V_55 [ V_10 -> V_60 ] == V_51 ?
L_7 : L_8 ) ;
}
return V_2 ;
