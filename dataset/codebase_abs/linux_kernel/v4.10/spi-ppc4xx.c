...
int V_88 ;
enum V_89 V_90 ;
V_88 = F_32 ( V_80 , V_72 , & V_90 ) ;
V_6 -> V_57 [ V_72 ] = V_88 ;
if ( F_25 ( V_88 ) ) {
V_84 = F_33 ( V_88 , V_80 -> V_91 ) ;
if ( V_84 < 0 ) {
F_8 ( V_8 , L_8
L_9 , V_72 , V_84 ) ;
goto F_24;
...
V_77 -> V_12 -> V_96 = F_12 ;
V_77 -> V_12 -> V_97 = F_20 ;
V_77 -> V_12 -> V_98 = F_35 ( 8 ) ;
V_77 -> V_12 -> V_99 =
V_41 | V_42 | V_59 | V_51 ;
V_77 -> V_12 -> V_56 = V_85 > 0 ? V_85 : 0 ;
V_83 = F_36 ( NULL , NULL , L_11 ) ;
if ( V_83 == NULL ) {
F_8 ( V_8 , L_12 ) ;
V_84 = - V_100 ;
goto F_24;
}
V_86 = F_37 ( V_83 , L_13 , NULL ) ;
if ( V_86 == NULL ) {
F_8 ( V_8 , L_14 ) ;
F_38 ( V_83 ) ;
V_84 = - V_100 ;
...
if ( ! F_43 ( V_6 -> V_101 , V_6 -> V_103 , V_106 ) ) {
F_8 ( V_8 , L_19 ) ;
V_84 = - V_107 ;
goto V_108;
}
