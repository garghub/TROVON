...
static int F_169 ( struct V_1 * V_2 , int V_371 )
{
int V_20 ;
if ( ! V_2 -> V_19 [ V_371 ] )
return - V_372 ;
V_2 -> V_22 [ V_371 ] =
F_170 ( V_2 -> V_19 [ V_371 ] ,
& V_373 [ V_371 ] ) ;
if ( F_171 ( V_2 -> V_22 [ V_371 ] ) ) {
V_20 = F_172 ( V_2 -> V_22 [ V_371 ] ) ;
F_12 ( V_2 -> V_19 [ V_371 ] ,
L_157 ,
V_371 , V_20 ) ;
return - V_56 ;
...
int V_20 ;
if ( ! F_177 ( V_18 -> V_350 , V_381 ) )
return - V_270 ;
F_178 ( 1 , V_37 , V_18 , L_158 ,
V_18 -> V_23 << 1 ) ;
V_2 = F_179 ( & V_18 -> V_311 , sizeof( * V_2 ) , V_382 ) ;
if ( ! V_2 ) {
F_12 ( V_18 , L_159 ) ;
return - V_383 ;
}
...
V_2 -> V_173 = true ;
V_2 -> V_64 = ~ 0 ;
if ( F_130 ( V_384 ) && V_18 -> V_311 . V_357 ) {
const struct V_385 * V_386 ;
V_386 = F_180 ( V_387 , V_18 -> V_311 . V_357 ) ;
V_2 -> V_3 = V_386 -> V_286 ;
V_20 = F_164 ( V_2 ) ;
if ( V_20 < 0 ) {
F_12 ( V_18 , L_160 ) ;
...
struct V_329 * V_228 = V_18 -> V_311 . V_388 ;
...
V_2 -> V_375 = F_183 ( & V_18 -> V_311 , L_164 ,
V_391 ) ;
if ( F_171 ( V_2 -> V_375 ) )
return F_172 ( V_2 -> V_375 ) ;
F_174 ( V_2 ) ;
V_2 -> V_86 = V_377 ;
V_2 -> V_214 = V_60 ( V_2 , V_248 ) ;
V_13 = & V_2 -> V_13 ;
F_184 ( V_13 , V_18 , & V_392 ) ;
...
if ( F_1 ( V_2 ) )
V_2 -> V_403 =
F_189 ( V_7 , & V_404 , NULL ) ;
V_2 -> V_405 =
F_189 ( V_7 , & V_406 , NULL ) ;
V_2 -> V_407 =
F_189 ( V_7 , & V_408 , NULL ) ;
V_13 -> V_348 = V_7 ;
if ( V_7 -> error ) {
V_20 = V_7 -> error ;
goto V_409;
...
V_20 = F_191 ( & V_13 -> V_414 , V_2 -> V_167 + 1 ,
V_2 -> V_411 ) ;
if ( V_20 )
goto V_415;
V_20 = F_173 ( V_2 ) ;
