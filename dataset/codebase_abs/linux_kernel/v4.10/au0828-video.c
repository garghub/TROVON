...
F_63 ( 1 , L_54 , V_125 ,
V_2 -> V_168 , V_2 -> V_20 ) ;
F_95 ( V_204 -> V_205 , L_57 , sizeof( V_204 -> V_205 ) ) ;
...
F_63 ( 1 , L_58 , V_125 ) ;
if ( V_250 -> V_220 == 0 )
strcpy ( V_250 -> V_208 , L_65 ) ;
else
strcpy ( V_250 -> V_208 , L_69 ) ;
V_250 -> V_251 = V_252 ;
return 0 ;
}
