...
F_51 ( struct V_3 * V_4 )
{
int V_49 , V_58 , V_53 , V_79 , V_80 , V_56 ;
struct V_50 * V_51 ;
struct V_81 * V_82 ;
int V_83 = V_54 ;
struct V_59 * V_60 ;
...
V_56 = F_55 ( V_4 -> V_8 , V_82 , V_80 , V_56 ) ;
if ( V_56 < 0 ) {
F_56 ( V_82 ) ;
return V_56 ;
}
...
V_53 = 0 ;
F_57 ( V_4 , V_82 [ V_53 ] . V_88 ) ;
F_58 ( F_59 ( V_4 ) , V_82 [ V_53 ++ ] . V_88 ) ;
F_60 ( V_4 , V_82 [ V_53 ++ ] . V_88 ) ;
for ( V_49 = 0 ; V_49 < V_4 -> V_69 ; V_49 ++ ) {
V_60 = & V_4 -> V_70 [ V_49 ] ;
...
F_18 ( V_4 , L_12 ,
( V_4 -> V_45 == V_61 ) ? L_13 :
( ( V_4 -> V_45 == V_62 ) ? L_14 : L_15 ) ) ;
}
void
F_63 ( struct V_3 * V_4 , bool free )
{
F_64 ( V_4 ) ;
switch ( V_4 -> V_45 ) {
case V_61 :
