...
F_3 ( V_13 , V_2 ) ;
F_3 ( V_7 , V_2 ) ;
V_33 = V_12 -> V_14 ( V_13 , V_11 ) ;
if ( V_33 > V_23 ) {
V_12 -> V_32 ( V_13 , V_23 , V_11 ) ;
V_6 -> V_10 ( V_7 , V_9 ) ;
} else {
V_6 -> V_10 ( V_7 , V_9 ) ;
V_12 -> V_32 ( V_13 , V_23 , V_11 ) ;
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
const struct V_5 * V_34 = V_4 -> V_34 ;
...
if ( V_7 && V_6 && V_13 && V_12 ) {
if ( V_6 -> V_10 && V_12 -> V_32 )
V_47 -> V_55 =
F_15 ;
}
if ( V_35 && V_34 ) {
...
if ( V_4 -> V_7 )
V_4 -> V_7 -> V_56 = V_2 -> V_56 ;
if ( V_4 -> V_13 )
V_4 -> V_13 -> V_56 = V_2 -> V_56 ;
if ( V_4 -> V_35 )
V_4 -> V_35 -> V_56 = V_2 -> V_56 ;
return V_2 ;
V_53:
F_24 ( V_4 ) ;
return V_2 ;
}
struct V_56 * F_25 ( struct V_39 * V_40 , const char * V_41 ,
const char * const * V_42 , int V_43 ,
struct V_1 * V_7 , const struct V_5 * V_6 ,
struct V_1 * V_13 , const struct V_5 * V_12 ,
struct V_1 * V_35 , const struct V_5 * V_34 ,
...
{
struct V_1 * V_2 ;
V_2 = F_19 ( V_40 , V_41 , V_42 , V_43 ,
V_7 , V_6 , V_13 , V_12 , V_35 , V_34 ,
V_44 ) ;
if ( F_26 ( V_2 ) )
return F_27 ( V_2 ) ;
return V_2 -> V_56 ;
