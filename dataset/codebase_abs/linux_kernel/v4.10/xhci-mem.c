...
void F_74 ( struct V_2 * V_3 , int V_126 )
{
struct V_58 * V_161 ;
struct V_127 * V_128 ;
struct V_129 * V_130 , * V_18 ;
...
F_66 (tt_info, next, tt_list_head, tt_list) {
if ( V_130 -> V_126 == V_126 ) {
for ( V_9 = 1 ; V_9 < F_75 ( V_3 -> V_133 ) ; V_9 ++ ) {
V_161 = V_3 -> V_154 [ V_9 ] ;
...
int F_76 ( struct V_2 * V_3 , int V_126 ,
...
V_166 = V_166 -> V_173 )
;
return F_80 ( V_168 , V_166 -> V_174 ) ;
}
int F_81 ( struct V_2 * V_3 , struct V_137 * V_148 )
{
struct V_58 * V_85 ;
struct V_80 * V_164 ;
struct V_79 * V_175 ;
...
V_175 -> V_179 |= F_6 ( F_82 ( 1 ) | V_148 -> V_180 ) ;
switch ( V_148 -> V_169 ) {
case V_181 :
...
V_176 = F_79 ( V_3 , V_148 ) ;
if ( ! V_176 )
return - V_178 ;
V_175 -> V_191 |= F_6 ( F_84 ( V_176 ) ) ;
for ( V_166 = V_148 ; V_166 -> V_173 && V_166 -> V_173 -> V_173 ;
V_166 = V_166 -> V_173 )
;
...
V_164 -> V_197 = F_6 ( F_86 ( V_198 ) ) ;
V_164 -> V_197 |= F_6 ( F_87 ( 0 ) | F_88 ( 3 ) |
V_177 ) ;
V_164 -> V_123 = F_10 ( V_85 -> V_65 [ 0 ] . V_32 -> V_45 -> V_8 |
V_85 -> V_65 [ 0 ] . V_32 -> V_4 ) ;
return 0 ;
}
static unsigned int F_89 ( struct V_137 * V_148 ,
struct V_199 * V_93 )
{
unsigned int V_200 ;
V_200 = F_90 ( V_93 -> V_201 . V_202 , 1 , 16 ) - 1 ;
...
static unsigned int F_96 ( struct V_137 * V_148 ,
struct V_199 * V_93 )
{
...
static T_3 F_103 ( struct V_137 * V_148 ,
struct V_199 * V_93 )
{
if ( V_148 -> V_169 >= V_170 )
...
( F_100 ( & V_93 -> V_201 ) ||
F_99 ( & V_93 -> V_201 ) ) )
return F_104 ( & V_93 -> V_201 ) - 1 ;
return 0 ;
}
static T_3 F_105 ( struct V_199 * V_93 )
{
int V_210 ;
V_210 = F_106 ( & V_93 -> V_201 ) ;
if ( F_97 ( & V_93 -> V_201 ) )
return V_198 ;
if ( F_98 ( & V_93 -> V_201 ) )
...
static T_3 F_107 ( struct V_137 * V_148 ,
struct V_199 * V_93 )
{
int V_217 ;
int V_5 ;
...
F_108 ( V_93 -> V_207 . V_208 ) )
return F_11 ( V_93 -> V_218 . V_219 ) ;
else if ( V_148 -> V_169 >= V_170 )
return F_109 ( V_93 -> V_207 . V_220 ) ;
V_5 = F_110 ( & V_93 -> V_201 ) ;
V_217 = F_104 ( & V_93 -> V_201 ) ;
return V_5 * V_217 ;
}
...
V_60 = F_112 ( & V_93 -> V_201 ) ;
V_117 = F_42 ( V_3 , V_59 -> V_159 , V_60 ) ;
V_223 = F_105 ( V_93 ) ;
if ( ! V_223 )
return - V_178 ;
V_221 = F_113 ( & V_93 -> V_201 ) ;
V_222 = F_107 ( V_148 , V_93 ) ;
V_200 = F_96 ( V_148 , V_93 ) ;
V_224 = F_102 ( V_148 , V_93 ) ;
V_5 = F_110 ( & V_93 -> V_201 ) ;
V_217 = F_103 ( V_148 , V_93 ) ;
V_225 = V_222 ;
if ( ! F_100 ( & V_93 -> V_201 ) )
V_226 = 3 ;
if ( F_98 ( & V_93 -> V_201 ) && V_148 -> V_169 == V_184 )
V_5 = 512 ;
if ( F_97 ( & V_93 -> V_201 ) && V_3 -> V_227 >= 0x100 )
V_225 = 8 ;
if ( ( V_3 -> V_227 > 0x100 ) && F_114 ( V_3 -> V_228 ) )
V_224 = 0 ;
...
V_117 -> V_120 = F_6 ( F_115 ( V_222 ) |
F_116 ( V_200 ) |
F_117 ( V_224 ) ) ;
V_117 -> V_197 = F_6 ( F_86 ( V_223 ) |
F_83 ( V_5 ) |
F_87 ( V_217 ) |
F_88 ( V_226 ) ) ;
V_117 -> V_123 = F_10 ( V_165 -> V_45 -> V_8 |
V_165 -> V_4 ) ;
V_117 -> V_231 = F_6 ( F_118 ( V_222 ) |
F_119 ( V_225 ) ) ;
return 0 ;
}
...
if ( ! F_123 ( V_237 , V_9 ) && F_124 ( V_237 , V_9 ) ) {
F_121 ( V_233 ) ;
continue;
}
if ( F_123 ( V_237 , V_9 ) ) {
V_117 = F_42 ( V_3 , V_159 , V_9 ) ;
V_238 = F_125 ( F_11 ( V_117 -> V_197 ) ) ;
...
static int F_133 ( struct V_2 * V_3 , T_1 V_6 )
{
int V_9 ;
struct V_84 * V_85 = F_44 ( V_3 ) -> V_86 . V_87 ;
int V_244 = F_134 ( V_3 -> V_245 ) ;
F_35 ( V_3 , V_246 ,
L_30 , V_244 ) ;
if ( ! V_244 )
return 0 ;
...
for ( V_9 = F_75 ( V_3 -> V_133 ) ; V_9 > 0 ; V_9 -- )
F_74 ( V_3 , V_9 ) ;
F_142 ( V_3 -> V_11 ) ;
V_3 -> V_11 = NULL ;
F_35 ( V_3 , V_246 , L_34 ) ;
...
T_2 V_293 ,
struct V_1 * V_294 ,
char * V_295 , int V_296 )
{
unsigned long long V_297 ;
unsigned long long V_298 ;
struct V_1 * V_7 ;
V_297 = F_60 ( V_290 , V_291 ) ;
V_298 = F_60 ( V_290 , V_292 ) ;
V_7 = F_144 ( V_3 , V_290 , V_291 , V_292 , V_293 , false ) ;
if ( V_7 != V_294 ) {
F_72 ( V_3 , L_38 ,
V_295 , V_296 ) ;
F_72 ( V_3 , L_39
...
F_72 ( V_3 , L_43 ,
V_294 , V_7 ) ;
F_144 ( V_3 , V_290 , V_291 , V_292 , V_293 ,
true ) ;
return - 1 ;
}
return 0 ;
...
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = V_3 -> V_274 -> V_45 -> V_10 ,
. V_292 = & V_3 -> V_274 -> V_45 -> V_10 [ V_14 - 1 ] ,
. V_293 = V_3 -> V_276 -> V_45 -> V_8 ,
. V_294 = NULL ,
} ,
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = V_3 -> V_274 -> V_45 -> V_10 ,
. V_292 = & V_3 -> V_276 -> V_45 -> V_10 [ V_14 - 1 ] ,
. V_293 = V_3 -> V_276 -> V_45 -> V_8 ,
. V_294 = NULL ,
} ,
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = V_3 -> V_276 -> V_45 -> V_10 ,
. V_292 = & V_3 -> V_276 -> V_45 -> V_10 [ V_14 - 1 ] ,
. V_293 = V_3 -> V_276 -> V_45 -> V_8 ,
. V_294 = NULL ,
} ,
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = & V_3 -> V_274 -> V_45 -> V_10 [ 0 ] ,
. V_292 = & V_3 -> V_274 -> V_45 -> V_10 [ 3 ] ,
. V_293 = V_3 -> V_274 -> V_45 -> V_8 + 4 * 16 ,
. V_294 = NULL ,
} ,
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = & V_3 -> V_274 -> V_45 -> V_10 [ 3 ] ,
. V_292 = & V_3 -> V_274 -> V_45 -> V_10 [ 6 ] ,
. V_293 = V_3 -> V_274 -> V_45 -> V_8 + 2 * 16 ,
. V_294 = NULL ,
} ,
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = & V_3 -> V_274 -> V_45 -> V_10 [ V_14 - 3 ] ,
. V_292 = & V_3 -> V_274 -> V_45 -> V_10 [ 1 ] ,
. V_293 = V_3 -> V_274 -> V_45 -> V_8 + 2 * 16 ,
. V_294 = NULL ,
} ,
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = & V_3 -> V_274 -> V_45 -> V_10 [ V_14 - 3 ] ,
. V_292 = & V_3 -> V_274 -> V_45 -> V_10 [ 1 ] ,
. V_293 = V_3 -> V_274 -> V_45 -> V_8 + ( V_14 - 4 ) * 16 ,
. V_294 = NULL ,
} ,
{ . V_290 = V_3 -> V_274 -> V_45 ,
. V_291 = & V_3 -> V_274 -> V_45 -> V_10 [ V_14 - 3 ] ,
. V_292 = & V_3 -> V_274 -> V_45 -> V_10 [ 1 ] ,
. V_293 = V_3 -> V_276 -> V_45 -> V_8 + 2 * 16 ,
. V_294 = NULL ,
} ,
} ;
unsigned int V_301 ;
...
F_72 ( V_3 , L_47
L_48 ) ;
V_302 = F_149 ( V_3 , & V_3 -> V_303 -> V_304 ) ;
V_302 &= V_305 ;
V_302 &= ~ V_306 ;
F_35 ( V_3 , V_246 ,
L_49
L_50 ) ;
F_150 ( V_3 , ( ( T_5 ) V_123 & ( T_5 ) ~ V_305 ) | V_302 ,
& V_3 -> V_303 -> V_304 ) ;
}
static void F_151 ( struct V_2 * V_3 , unsigned int V_141 ,
T_6 T_7 * V_104 , int V_307 )
{
T_3 V_302 , V_308 , V_309 ;
int V_9 ;
T_8 V_310 ;
struct V_311 * V_312 ;
V_302 = F_152 ( V_104 ) ;
...
V_312 -> V_315 = F_153 ( V_302 ) ;
V_312 -> V_316 = F_154 ( V_302 ) ;
V_302 = F_152 ( V_104 + 2 ) ;
V_308 = F_155 ( V_302 ) ;
V_309 = F_156 ( V_302 ) ;
F_35 ( V_3 , V_246 ,
L_53
L_54 ,
V_104 , V_308 , V_309 , V_310 ) ;
if ( V_308 == 0 || ( V_308 + V_309 - 1 ) > V_141 )
return;
V_312 -> V_317 = F_157 ( V_302 ) ;
if ( V_312 -> V_317 ) {
V_312 -> V_318 = F_158 ( V_312 -> V_317 , sizeof( * V_312 -> V_318 ) ,
V_319 ) ;
if ( ! V_312 -> V_318 )
V_312 -> V_317 = 0 ;
V_312 -> V_320 ++ ;
for ( V_9 = 0 ; V_9 < V_312 -> V_317 ; V_9 ++ ) {
V_312 -> V_318 [ V_9 ] = F_152 ( V_104 + 4 + V_9 ) ;
if ( V_9 && ( F_159 ( V_312 -> V_318 [ V_9 ] ) !=
F_159 ( V_312 -> V_318 [ V_9 - 1 ] ) ) )
V_312 -> V_320 ++ ;
F_32 ( V_3 , L_55 ,
F_159 ( V_312 -> V_318 [ V_9 ] ) ,
F_160 ( V_312 -> V_318 [ V_9 ] ) ,
F_161 ( V_312 -> V_318 [ V_9 ] ) ,
F_162 ( V_312 -> V_318 [ V_9 ] ) ,
F_163 ( V_312 -> V_318 [ V_9 ] ) ,
F_164 ( V_312 -> V_318 [ V_9 ] ) ) ;
}
}
if ( V_310 < 0x03 && V_3 -> V_321 < V_307 )
V_3 -> V_286 [ V_3 -> V_321 ++ ] = V_302 ;
if ( ( V_3 -> V_227 == 0x96 ) && ( V_310 != 0x03 ) &&
( V_302 & V_322 ) ) {
F_35 ( V_3 , V_246 ,
L_56 ) ;
V_3 -> V_323 = 1 ;
}
if ( ( V_3 -> V_227 >= 0x100 ) && ( V_310 != 0x03 ) ) {
F_35 ( V_3 , V_246 ,
L_57 ) ;
V_3 -> V_323 = 1 ;
if ( V_302 & V_324 ) {
...
V_308 -- ;
for ( V_9 = V_308 ; V_9 < ( V_308 + V_309 ) ; V_9 ++ ) {
if ( V_3 -> V_285 [ V_9 ] != 0 ) {
F_72 ( V_3 , L_59
L_60 , V_104 , V_9 ) ;
F_72 ( V_3 , L_61
L_62 ,
V_3 -> V_285 [ V_9 ] , V_310 ) ;
if ( V_3 -> V_285 [ V_9 ] != V_310 &&
V_3 -> V_285 [ V_9 ] != V_326 ) {
if ( V_3 -> V_285 [ V_9 ] == 0x03 )
V_3 -> V_281 -- ;
else
V_3 -> V_280 -- ;
V_3 -> V_285 [ V_9 ] = V_326 ;
...
static int F_165 ( struct V_2 * V_3 , T_1 V_6 )
{
void T_7 * V_327 ;
T_3 V_328 ;
unsigned int V_141 ;
...
T_3 V_331 ;
V_141 = F_65 ( V_3 -> V_133 ) ;
V_3 -> V_285 = F_2 ( sizeof( * V_3 -> V_285 ) * V_141 , V_6 ) ;
if ( ! V_3 -> V_285 )
return - V_54 ;
...
while ( V_328 ) {
V_330 ++ ;
V_328 = F_166 ( V_327 , V_328 ,
V_334 ) ;
}
V_3 -> V_286 = F_2 ( sizeof( * V_3 -> V_286 ) * V_330 , V_6 ) ;
if ( ! V_3 -> V_286 )
return - V_54 ;
V_328 = V_331 ;
while ( V_328 ) {
F_151 ( V_3 , V_141 , V_327 + V_328 , V_330 ) ;
if ( V_3 -> V_280 + V_3 -> V_281 == V_141 )
break;
V_328 = F_166 ( V_327 , V_328 ,
V_334 ) ;
}
if ( V_3 -> V_280 == 0 && V_3 -> V_281 == 0 ) {
F_72 ( V_3 , L_64 ) ;
return - V_335 ;
}
F_35 ( V_3 , V_246 ,
...
if ( V_3 -> V_280 ) {
V_3 -> V_283 = F_168 ( sizeof( * V_3 -> V_283 ) *
V_3 -> V_280 , V_6 ) ;
if ( ! V_3 -> V_283 )
return - V_54 ;
V_329 = 0 ;
...
if ( V_3 -> V_281 ) {
V_3 -> V_284 = F_168 ( sizeof( * V_3 -> V_284 ) *
V_3 -> V_281 , V_6 ) ;
if ( ! V_3 -> V_284 )
return - V_54 ;
V_329 = 0 ;
...
int F_169 ( struct V_2 * V_3 , T_1 V_6 )
{
T_2 V_8 ;
struct V_84 * V_85 = F_44 ( V_3 ) -> V_86 . V_87 ;
unsigned int V_22 , V_340 ;
T_5 V_341 ;
struct V_1 * V_7 ;
T_3 V_257 , V_302 ;
int V_9 ;
F_30 ( & V_3 -> V_265 ) ;
F_170 ( & V_3 -> V_268 , V_342 ) ;
F_136 ( & V_3 -> V_343 ) ;
V_257 = F_152 ( & V_3 -> V_337 -> V_257 ) ;
F_35 ( V_3 , V_246 ,
L_71 , V_257 ) ;
...
F_72 ( V_3 , L_73 ) ;
V_3 -> V_287 = 12 ;
V_3 -> V_257 = 1 << V_3 -> V_287 ;
F_35 ( V_3 , V_246 ,
L_74 , V_3 -> V_257 / 1024 ) ;
V_22 = F_75 ( F_152 ( & V_3 -> V_332 -> V_133 ) ) ;
F_35 ( V_3 , V_246 ,
L_75 , V_22 ) ;
V_340 = F_152 ( & V_3 -> V_337 -> V_344 ) ;
V_22 |= ( V_340 & ~ V_345 ) ;
F_35 ( V_3 , V_246 ,
L_76 , V_22 ) ;
F_171 ( V_22 , & V_3 -> V_337 -> V_344 ) ;
...
F_150 ( V_3 , V_8 , & V_3 -> V_337 -> V_346 ) ;
V_3 -> V_11 = F_172 ( L_78 , V_85 ,
V_347 , V_347 , V_3 -> V_257 ) ;
V_3 -> V_77 = F_172 ( L_79 , V_85 ,
2112 , 64 , V_3 -> V_257 ) ;
...
V_341 = F_149 ( V_3 , & V_3 -> V_337 -> V_276 ) ;
V_341 = ( V_341 & ( T_5 ) V_349 ) |
( V_3 -> V_276 -> V_45 -> V_8 & ( T_5 ) ~ V_349 ) |
V_3 -> V_276 -> V_4 ;
F_35 ( V_3 , V_246 ,
L_84 , V_22 ) ;
F_150 ( V_3 , V_341 , & V_3 -> V_337 -> V_276 ) ;
F_173 ( V_3 ) ;
V_3 -> V_275 = F_52 ( V_3 , true , true , V_6 ) ;
if ( ! V_3 -> V_275 )
goto V_57;
V_3 -> V_105 ++ ;
V_22 = F_152 ( & V_3 -> V_332 -> V_350 ) ;
V_22 &= V_351 ;
F_35 ( V_3 , V_246 ,
L_85
L_86 , V_22 ) ;
V_3 -> V_352 = ( void T_7 * ) V_3 -> V_332 + V_22 ;
F_174 ( V_3 ) ;
F_175 ( V_3 ) ;
V_3 -> V_303 = & V_3 -> V_353 -> V_303 [ 0 ] ;
F_35 ( V_3 , V_246 , L_87 ) ;
...
V_22 = F_152 ( & V_3 -> V_303 -> V_359 ) ;
V_22 &= V_360 ;
V_22 |= V_354 ;
F_35 ( V_3 , V_246 ,
L_90 ,
V_22 ) ;
F_171 ( V_22 , & V_3 -> V_303 -> V_359 ) ;
F_35 ( V_3 , V_246 ,
L_91 ) ;
F_35 ( V_3 , V_246 ,
L_92 ,
( unsigned long long ) V_3 -> V_270 . V_273 ) ;
V_341 = F_149 ( V_3 , & V_3 -> V_303 -> V_361 ) ;
V_341 &= V_305 ;
V_341 |= ( V_3 -> V_270 . V_273 & ( T_5 ) ~ V_305 ) ;
F_150 ( V_3 , V_341 , & V_3 -> V_303 -> V_361 ) ;
F_147 ( V_3 ) ;
F_35 ( V_3 , V_246 ,
L_93 ) ;
F_176 ( V_3 , 0 ) ;
...
V_3 -> V_288 [ 0 ] . V_363 [ V_9 ] = 0 ;
V_3 -> V_288 [ 1 ] . V_363 [ V_9 ] = 0 ;
F_136 ( & V_3 -> V_288 [ 1 ] . V_364 [ V_9 ] ) ;
}
if ( F_133 ( V_3 , V_6 ) )
goto V_57;
if ( F_165 ( V_3 , V_6 ) )
goto V_57;
V_302 = F_152 ( & V_3 -> V_337 -> V_365 ) ;
V_302 &= ~ V_366 ;
V_302 |= V_367 ;
F_171 ( V_302 , & V_3 -> V_337 -> V_365 ) ;
return 0 ;
V_57:
F_72 ( V_3 , L_94 ) ;
F_177 ( V_3 ) ;
