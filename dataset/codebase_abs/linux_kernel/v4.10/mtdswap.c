...
V_190 [ V_24 ] = F_6 ( F_11 ( V_11 ) , struct V_3 ,
V_14 ) -> V_20 ;
V_149 [ V_24 ] = F_6 ( F_80 ( V_11 ) , struct V_3 ,
V_14 ) -> V_20 ;
} else
V_13 [ V_24 ] = 0 ;
}
...
if ( V_194 )
F_82 ( V_186 , L_32 , V_194 ) ;
if ( V_191 )
F_82 ( V_186 , L_33
L_34 ,
V_192 , V_2 -> V_81 - V_192 , V_193 ) ;
F_82 ( V_186 , L_35 , V_188 ) ;
F_83 ( V_186 , L_36 ) ;
F_82 ( V_186 , L_37 , V_2 -> V_179 ) ;
F_82 ( V_186 , L_38 , V_2 -> V_166 ) ;
F_82 ( V_186 , L_39 , V_2 -> V_183 ) ;
F_82 ( V_186 , L_40 , V_2 -> V_180 ) ;
F_82 ( V_186 , L_41 , V_2 -> V_170 ) ;
F_82 ( V_186 , L_42 , V_2 -> V_184 ) ;
F_83 ( V_186 , L_36 ) ;
F_82 ( V_186 , L_43 , V_195 ) ;
F_82 ( V_186 , L_44 , V_165 ) ;
return 0 ;
}
static int F_84 ( struct V_198 * V_198 , struct V_199 * V_199 )
{
return F_85 ( V_199 , F_78 , V_198 -> V_200 ) ;
}
static int F_86 ( struct V_1 * V_2 )
{
struct V_201 * V_202 = V_2 -> V_176 -> V_203 ;
struct V_204 * V_30 = F_87 ( V_202 ) ;
struct V_205 * V_11 ;
struct V_205 * V_206 ;
V_11 = F_88 ( V_202 -> V_207 , NULL ) ;
if ( F_89 ( V_11 ) )
return 0 ;
if ( ! V_11 ) {
F_40 ( V_30 , L_45 ) ;
...
V_2 -> V_208 = V_11 ;
V_206 = F_90 ( L_46 , V_209 , V_11 , V_2 ,
& V_210 ) ;
if ( ! V_206 ) {
F_40 ( V_2 -> V_30 , L_47 ) ;
F_91 ( V_11 ) ;
...
static int F_92 ( struct V_1 * V_2 , unsigned int V_211 ,
unsigned int V_212 )
{
...
V_2 -> V_130 = F_93 ( sizeof( int ) * V_195 ) ;
if ( ! V_2 -> V_130 )
goto V_216;
V_2 -> V_113 = F_93 ( sizeof( int ) * V_214 ) ;
if ( ! V_2 -> V_113 )
goto V_217;
...
V_2 -> V_127 = F_95 ( V_121 , V_219 ) ;
if ( ! V_2 -> V_127 )
goto V_220;
V_2 -> V_48 = F_95 ( 2 * V_6 -> V_46 , V_219 ) ;
if ( ! V_2 -> V_48 )
goto V_221;
F_32 ( V_2 ) ;
return 0 ;
...
F_67 ( V_2 -> V_130 ) ;
V_216:
F_96 ( V_222 L_48 , V_223 , V_25 ) ;
return V_25 ;
}
static void F_97 ( struct V_224 * V_225 , struct V_91 * V_6 )
{
struct V_1 * V_2 ;
struct V_162 * V_176 ;
char * V_226 ;
...
if ( ! * V_226 )
return;
while ( ( V_227 = F_98 ( & V_226 , L_49 ) ) != NULL ) {
if ( F_99 ( V_227 , 0 , & V_228 ) < 0 )
return;
if ( V_6 -> V_234 == V_228 )
break;
}
...
V_212 = F_101 ( ( T_5 ) V_229 * V_236 , 100 ) ;
if ( V_212 < V_134 )
V_212 = V_134 ;
if ( V_212 > V_229 - 1 )
V_212 = V_229 - 1 ;
...
V_2 = F_102 ( sizeof( struct V_1 ) , V_219 ) ;
if ( ! V_2 )
return;
V_176 = F_102 ( sizeof( struct V_162 ) , V_219 ) ;
if ( ! V_176 ) {
F_68 ( V_2 ) ;
return;
}
...
if ( ! ( V_6 -> V_28 & V_241 ) )
V_176 -> V_242 = 1 ;
if ( F_92 ( V_2 , V_211 , V_212 ) < 0 )
goto V_243;
if ( F_103 ( V_176 ) < 0 )
goto V_244;
V_2 -> V_30 = F_87 ( V_176 -> V_203 ) ;
V_25 = F_86 ( V_2 ) ;
if ( V_25 < 0 )
goto V_245;
return;
...
static void F_105 ( struct V_162 * V_30 )
{
struct V_1 * V_2 = F_64 ( V_30 ) ;
F_91 ( V_2 -> V_208 ) ;
F_104 ( V_30 ) ;
