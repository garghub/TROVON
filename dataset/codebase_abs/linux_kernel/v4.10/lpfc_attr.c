...
int V_292 ;
T_2 V_293 , V_37 ;
V_37 = F_44 ( V_159 , & V_18 -> V_42 . V_160 ) ;
if ( V_37 == V_161 &&
V_18 -> V_19 & V_334 )
return - V_99 ;
if ( ! strncmp ( V_9 , L_85 , strlen ( L_85 ) ) ) {
...
if ( ( ( V_215 == V_335 ) && ! ( V_18 -> V_336 & V_337 ) ) ||
( ( V_215 == V_338 ) && ! ( V_18 -> V_336 & V_339 ) ) ||
( ( V_215 == V_340 ) && ! ( V_18 -> V_336 & V_341 ) ) ||
( ( V_215 == V_342 ) && ! ( V_18 -> V_336 & V_343 ) ) ||
( ( V_215 == V_344 ) && ! ( V_18 -> V_336 & V_345 ) ) ||
( ( V_215 == V_294 ) && ! ( V_18 -> V_336 & V_346 ) ) ||
( ( V_215 == V_347 ) && ! ( V_18 -> V_336 & V_348 ) ) ) {
F_31 ( V_18 , V_117 , V_135 ,
L_109
L_110 ,
V_215 ) ;
...
static int
F_141 ( struct V_17 * V_18 , int V_215 )
{
if ( V_215 >= 0 && V_215 <= 1 ) {
V_18 -> V_357 = V_215 ;
return 0 ;
...
if ( sscanf ( V_9 , L_53 , & V_215 ) != 1 )
return - V_88 ;
if ( V_215 < V_358 || V_215 > V_359 )
return - V_88 ;
V_18 -> V_360 = ( T_2 ) V_215 ;
for ( V_3 = 0 ; V_3 < V_18 -> V_361 ; V_3 += V_362 )
F_143 ( V_18 , V_3 ) ;
return strlen ( V_9 ) ;
}
static int
F_144 ( struct V_17 * V_18 , int V_215 )
{
if ( V_18 -> V_44 != V_45 ) {
V_18 -> V_360 = 0 ;
return 0 ;
...
while ( V_18 -> V_42 . V_370 < V_18 -> V_42 . V_371 ) {
V_365 = & V_18 -> V_42 . V_372 [ V_18 -> V_42 . V_370 ] ;
if ( V_365 -> V_373 == V_374 )
V_41 += snprintf ( V_9 + V_41 , V_10 - V_41 ,
L_130
L_131 ,
V_18 -> V_42 . V_370 ,
V_365 -> V_375 , V_365 -> V_376 ,
V_365 -> V_377 ) ;
else
V_41 += snprintf ( V_9 + V_41 , V_10 - V_41 ,
L_130
...
V_18 -> V_42 . V_370 ,
V_365 -> V_375 , V_365 -> V_376 ,
V_365 -> V_377 , V_365 -> V_373 ) ;
V_18 -> V_42 . V_370 ++ ;
if ( V_18 -> V_42 . V_370 <
V_18 -> V_42 . V_371 &&
( V_41 >= ( V_10 - 64 ) ) ) {
V_41 += snprintf ( V_9 + V_41 , V_10 - V_41 , L_133 ) ;
break;
}
}
if ( V_18 -> V_42 . V_370 == V_18 -> V_42 . V_371 )
V_18 -> V_42 . V_370 = 0 ;
return V_41 ;
}
static T_1
...
static int
F_147 ( struct V_17 * V_18 , int V_215 )
{
if ( V_18 -> V_44 != V_45 ) {
V_18 -> V_368 = 0 ;
return 0 ;
}
if ( V_215 >= V_378 && V_215 <= V_379 ) {
V_18 -> V_368 = V_215 ;
return 0 ;
}
F_31 ( V_18 , V_117 , V_135 ,
...
static int
F_148 ( struct V_14 * V_15 , int V_215 )
{
struct V_12 * V_13 = F_109 ( V_15 ) ;
struct V_282 * V_283 , * V_381 ;
if ( V_215 == V_15 -> V_382 )
return 0 ;
...
V_15 -> V_382 = V_215 ;
F_64 ( V_13 -> V_284 ) ;
F_149 (ndlp, next_ndlp, &vport->fc_nodes, nlp_listp) {
if ( ! F_111 ( V_283 ) )
continue;
if ( V_283 -> V_383 == V_384 )
continue;
V_283 -> V_385 = V_15 -> V_386 ;
}
F_65 ( V_13 -> V_284 ) ;
return 0 ;
}
static T_1
F_150 ( struct V_321 * V_322 , struct V_323 * V_324 ,
struct V_325 * V_326 ,
char * V_9 , T_12 V_327 , T_5 V_86 )
{
T_5 V_387 ;
...
return - V_88 ;
if ( memcmp ( V_9 , V_391 , V_390 ) )
return - V_88 ;
if ( ! ( V_15 -> V_76 & V_97 ) )
return - V_99 ;
F_64 ( & V_18 -> V_216 ) ;
for ( V_387 = 0 ; V_387 < V_86 - V_390 ;
V_387 += sizeof( T_2 ) )
F_48 ( * ( ( T_2 * ) ( V_9 + V_387 + V_390 ) ) ,
V_18 -> V_392 + V_327 + V_387 ) ;
F_65 ( & V_18 -> V_216 ) ;
return V_86 ;
}
static T_1
F_151 ( struct V_321 * V_322 , struct V_323 * V_324 ,
struct V_325 * V_326 ,
char * V_9 , T_12 V_327 , T_5 V_86 )
{
T_5 V_387 ;
...
return - V_88 ;
F_64 ( & V_18 -> V_216 ) ;
for ( V_387 = 0 ; V_387 < V_86 ; V_387 += sizeof( T_2 ) ) {
V_393 = ( T_2 * ) ( V_9 + V_387 ) ;
* V_393 = F_47 ( V_18 -> V_392 + V_327 + V_387 ) ;
}
F_65 ( & V_18 -> V_216 ) ;
return V_86 ;
}
...
struct V_12 * V_13 = F_109 ( V_15 ) ;
int error ;
error = F_155 ( & V_13 -> V_394 . V_324 ,
& V_395 ) ;
if ( error || V_15 -> V_209 == V_396 )
goto V_172;
error = F_155 ( & V_13 -> V_394 . V_324 ,
& V_397 ) ;
if ( error )
...
return 0 ;
V_400:
F_156 ( & V_13 -> V_394 . V_324 , & V_397 ) ;
V_398:
F_156 ( & V_13 -> V_394 . V_324 ,
& V_395 ) ;
V_172:
return error ;
}
void
F_157 ( struct V_14 * V_15 )
{
struct V_12 * V_13 = F_109 ( V_15 ) ;
F_156 ( & V_13 -> V_394 . V_324 ,
& V_395 ) ;
...
( ( V_18 -> V_74 == V_75 ) &&
( V_15 -> V_76 & V_77 ) ) ) )
V_431 = F_78 ( V_18 -> V_432 . V_433 . V_103 . V_230 ) ;
else
V_431 = 0 ;
F_65 ( V_13 -> V_284 ) ;
F_168 ( V_13 ) = V_431 ;
...
struct V_437 * V_438 = & V_127 -> V_439 ;
T_6 * V_94 ;
T_7 * V_187 ;
unsigned long V_440 ;
int V_129 = 0 ;
...
V_435 -> V_443 = V_187 -> V_194 . V_444 . V_445 ;
V_435 -> V_446 = ( T_11 )
( ( T_11 ) V_187 -> V_194 . V_444 . V_447
* ( T_11 ) 256 ) ;
V_435 -> V_448 = V_187 -> V_194 . V_444 . V_449 ;
V_435 -> V_450 = ( T_11 )
( ( T_11 ) V_187 -> V_194 . V_444 . V_451
* ( T_11 ) 256 ) ;
memset ( V_94 , 0 , sizeof ( T_6 ) ) ;
V_187 -> V_105 = V_452 ;
V_187 -> V_107 = V_108 ;
...
V_435 -> V_453 = V_187 -> V_194 . V_454 . V_455 ;
V_435 -> V_456 = V_187 -> V_194 . V_454 . V_457 ;
V_435 -> V_458 = V_187 -> V_194 . V_454 . V_459 ;
V_435 -> V_460 = V_187 -> V_194 . V_454 . V_461 ;
V_435 -> V_462 = V_187 -> V_194 . V_454 . V_463 ;
V_435 -> V_464 = V_187 -> V_194 . V_454 . V_465 ;
V_435 -> V_466 = V_187 -> V_194 . V_454 . V_465 ;
V_435 -> V_453 -= V_438 -> V_453 ;
V_435 -> V_456 -= V_438 -> V_456 ;
V_435 -> V_458 -= V_438 -> V_458 ;
V_435 -> V_460 -= V_438 -> V_460 ;
V_435 -> V_462 -= V_438 -> V_462 ;
V_435 -> V_464 -= V_438 -> V_464 ;
V_435 -> V_466 -= V_438 -> V_466 ;
if ( V_18 -> V_19 & V_414 ) {
V_435 -> V_467 = - 1 ;
V_435 -> V_468 = ( V_18 -> V_469 >> 1 ) ;
V_435 -> V_468 -= V_438 -> V_469 ;
} else if ( V_18 -> V_74 == V_75 ) {
V_435 -> V_467 = ( V_18 -> V_470 >> 1 ) ;
V_435 -> V_467 -= V_438 -> V_469 ;
V_435 -> V_468 = - 1 ;
} else {
V_435 -> V_467 = - 1 ;
V_435 -> V_468 = ( V_18 -> V_470 >> 1 ) ;
V_435 -> V_468 -= V_438 -> V_469 ;
}
V_435 -> V_471 = - 1 ;
V_440 = F_171 () ;
if ( V_440 < V_127 -> V_472 )
V_435 -> V_473 = V_440 +
( ( unsigned long ) - 1 - V_127 -> V_472 ) ;
else
V_435 -> V_473 = V_440 - V_127 -> V_472 ;
F_33 ( V_94 , V_18 -> V_100 ) ;
return V_435 ;
}
static void
...
V_438 -> V_453 = V_187 -> V_194 . V_454 . V_455 ;
V_438 -> V_456 = V_187 -> V_194 . V_454 . V_457 ;
V_438 -> V_458 = V_187 -> V_194 . V_454 . V_459 ;
V_438 -> V_460 = V_187 -> V_194 . V_454 . V_461 ;
V_438 -> V_462 = V_187 -> V_194 . V_454 . V_463 ;
V_438 -> V_464 = V_187 -> V_194 . V_454 . V_465 ;
V_438 -> V_466 = V_187 -> V_194 . V_454 . V_465 ;
if ( V_18 -> V_19 & V_414 )
V_438 -> V_469 = ( V_18 -> V_469 >> 1 ) ;
else
V_438 -> V_469 = ( V_18 -> V_470 >> 1 ) ;
V_127 -> V_472 = F_171 () ;
F_33 ( V_94 , V_18 -> V_100 ) ;
return;
}
static struct V_282 *
F_173 ( struct V_475 * V_476 )
{
struct V_12 * V_13 = F_174 ( V_476 -> V_6 . V_477 ) ;
struct V_14 * V_15 = (struct V_14 * ) V_13 -> V_16 ;
struct V_282 * V_283 ;
F_64 ( V_13 -> V_284 ) ;
F_110 (ndlp, &vport->fc_nodes, nlp_listp) {
...
static void
F_175 ( struct V_475 * V_476 )
{
struct V_282 * V_283 = F_173 ( V_476 ) ;
F_176 ( V_476 ) = V_283 ? V_283 -> V_481 : - 1 ;
}
static void
F_177 ( struct V_475 * V_476 )
{
struct V_282 * V_283 = F_173 ( V_476 ) ;
F_178 ( V_476 ) =
V_283 ? F_78 ( V_283 -> V_482 . V_103 . V_230 ) : 0 ;
}
static void
F_179 ( struct V_475 * V_476 )
{
struct V_282 * V_283 = F_173 ( V_476 ) ;
F_180 ( V_476 ) =
...
static void
F_181 ( struct V_483 * V_285 , T_2 V_484 )
{
if ( V_484 )
V_285 -> V_286 = V_484 ;
else
...
static void
F_182 ( struct V_485 * V_485 )
{
struct V_14 * V_15 = * (struct V_14 * * ) V_485 -> V_486 ;
if ( V_15 -> V_62 == V_71 )
F_183 ( V_15 , V_487 , 0 , 0 ) ;
}
static void
F_184 ( struct V_17 * V_18 , T_2 V_488 )
{
V_18 -> V_489 = V_488 ;
}
void
F_185 ( struct V_17 * V_18 )
{
F_186 ( V_18 , V_490 ) ;
F_187 ( V_18 , V_491 ) ;
F_188 ( V_18 , V_492 ) ;
