...
V_18 . V_19 = V_20 ;
V_18 . V_21 = V_22 ;
V_18 . V_23 = V_2 -> V_11 -> V_23 -> V_24 ;
V_18 . V_25 = V_2 -> V_11 -> V_25 ;
V_18 . V_26 = ( V_2 -> V_24 << 1 ) | ( V_2 -> V_27 & 1 ) ;
if ( F_11 ( V_2 -> V_11 -> V_23 , L_2 , & V_18 , & V_14 ) < 0 )
return;
sprintf ( V_14 -> V_28 , L_3 ,
V_2 -> V_27 == V_29 ?
L_4 : L_5 ,
V_18 . V_23 , V_18 . V_25 , V_18 . V_26 ) ;
V_14 -> V_30 = V_31 ;
