...
int F_73 ( const char * V_31 , const char * V_68 ,
bool V_56 , bool V_57 )
{
const T_4 V_39 = V_33 ;
...
if ( F_77 ( L_23 , V_119 ) )
goto V_114;
} else if ( F_78 ( V_118 , V_119 ) && V_110 != V_127 &&
F_77 ( V_68 , V_119 ) )
goto V_114;
}
...
V_47 = strrchr ( V_48 , '/' ) ;
* V_47 = '\0' ;
if ( F_18 ( V_48 , V_128 ) && F_76 ( V_48 , 0755 ) )
goto V_114;
* V_47 = '/' ;
...
static int F_80 ( const T_3 * V_24 , T_4 V_129 ,
const char * V_68 , bool V_56 ,
bool V_57 )
{
char V_31 [ V_54 ] ;
F_9 ( V_24 , V_129 , V_31 ) ;
return F_73 ( V_31 , V_68 , V_56 , V_57 ) ;
}
bool F_81 ( const char * V_31 )
{
bool V_35 = false ;
...
int F_82 ( const char * V_31 )
{
const T_4 V_39 = V_33 ;
char * V_119 = F_74 ( V_39 ) ,
* V_48 = F_74 ( V_39 ) , * V_47 ;
int V_64 = - 1 ;
...
static int F_84 ( struct V_19 * V_19 , struct V_8 * V_8 )
{
bool V_56 = F_26 ( V_19 ) ;
bool V_57 = F_27 ( V_19 ) ;
...
return F_80 ( V_19 -> V_24 , sizeof( V_19 -> V_24 ) , V_68 ,
V_56 , V_57 ) ;
}
...
static int F_86 ( struct V_8 * V_8 )
{
return F_85 ( & V_8 -> V_97 . V_96 , V_8 ) ;
}
int F_87 ( struct V_88 * V_89 )
{
struct V_90 * V_91 ;
int V_35 ;
if ( V_98 )
return 0 ;
if ( F_88 ( V_43 , 0755 ) != 0 && V_110 != V_127 )
return - 1 ;
V_35 = F_86 ( & V_89 -> V_92 . V_93 ) ;
for ( V_91 = F_42 ( & V_89 -> V_92 . V_94 ) ; V_91 ; V_91 = F_43 ( V_91 ) ) {
struct V_8 * V_76 = F_44 ( V_91 , struct V_8 , V_90 ) ;
V_35 |= F_86 ( V_76 ) ;
}
...
static bool F_89 ( struct V_8 * V_8 , bool V_130 )
{
return F_90 ( & V_8 -> V_97 . V_96 , V_130 ) ;
}
bool F_91 ( struct V_88 * V_89 , bool V_130 )
{
struct V_90 * V_91 ;
bool V_35 = F_89 ( & V_89 -> V_92 . V_93 , V_130 ) ;
for ( V_91 = F_42 ( & V_89 -> V_92 . V_94 ) ; V_91 ; V_91 = F_43 ( V_91 ) ) {
struct V_8 * V_76 = F_44 ( V_91 , struct V_8 , V_90 ) ;
V_35 |= F_89 ( V_76 , V_130 ) ;
}
return V_35 ;
}
