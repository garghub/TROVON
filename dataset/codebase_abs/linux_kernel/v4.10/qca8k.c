...
static int
F_65 ( struct V_77 * V_78 , int V_46 ,
struct V_127 * V_145 )
{
struct V_17 * V_18 = (struct V_17 * ) V_78 -> V_18 ;
int V_36 = F_43 ( V_86 ) ;
int V_29 ;
V_18 -> V_89 [ V_46 ] . V_146 = V_145 ;
for ( V_29 = 1 ; V_29 < V_94 ; V_29 ++ ) {
if ( V_18 -> V_89 [ V_29 ] . V_146 != V_145 )
continue;
F_11 ( V_18 ,
F_42 ( V_29 ) ,
F_43 ( V_46 ) ) ;
...
int V_29 ;
for ( V_29 = 1 ; V_29 < V_94 ; V_29 ++ ) {
if ( V_18 -> V_89 [ V_29 ] . V_146 !=
V_18 -> V_89 [ V_46 ] . V_146 )
continue;
F_12 ( V_18 ,
F_42 ( V_29 ) ,
F_43 ( V_46 ) ) ;
}
V_18 -> V_89 [ V_46 ] . V_146 = NULL ;
F_10 ( V_18 , F_42 ( V_46 ) ,
V_95 , F_43 ( V_86 ) ) ;
}
static int
...
if ( V_164 != V_170 )
return - V_171 ;
V_18 -> V_78 = F_78 ( & V_163 -> V_12 , sizeof( * V_18 -> V_78 ) , V_165 ) ;
if ( ! V_18 -> V_78 )
return - V_166 ;
V_18 -> V_78 -> V_18 = V_18 ;
V_18 -> V_78 -> V_12 = & V_163 -> V_12 ;
V_18 -> V_78 -> V_172 = & V_173 ;
F_36 ( & V_18 -> V_55 ) ;
F_79 ( & V_163 -> V_12 , V_18 ) ;
return F_80 ( V_18 -> V_78 , V_18 -> V_78 -> V_12 -> V_174 ) ;
}
static void
...
static int F_85 ( struct V_175 * V_12 )
{
struct V_176 * V_177 = F_86 ( V_12 ) ;
struct V_17 * V_18 = F_87 ( V_177 ) ;
F_84 ( V_18 , 0 ) ;
return F_88 ( V_18 -> V_78 ) ;
}
static int F_89 ( struct V_175 * V_12 )
{
struct V_176 * V_177 = F_86 ( V_12 ) ;
struct V_17 * V_18 = F_87 ( V_177 ) ;
F_84 ( V_18 , 1 ) ;
