...
static int F_24 ( struct V_79 * V_80 )
{
...
V_2 = F_21 ( & V_80 -> V_9 , sizeof( struct V_1 ) ,
V_87 ) ;
if ( ! V_2 )
return - V_90 ;
V_2 -> V_5 = V_5 ;
...
V_89 . V_92 = V_85 -> V_92 ;
V_89 . V_93 = V_85 -> V_93 ;
V_2 -> V_94 = F_26 ( & V_80 -> V_9 , & V_95 , & V_89 ) ;
if ( F_27 ( V_2 -> V_94 ) ) {
V_29 = F_28 ( V_2 -> V_94 ) ;
goto V_54;
}
V_2 -> V_94 -> V_9 . V_50 = & V_80 -> V_9 ;
V_2 -> V_96 = F_26 ( & V_80 -> V_9 , & V_97 , & V_89 ) ;
if ( F_27 ( V_2 -> V_96 ) ) {
V_29 = F_28 ( V_2 -> V_96 ) ;
goto V_98;
}
V_2 -> V_96 -> V_9 . V_50 = & V_80 -> V_9 ;
V_2 -> V_99 = F_26 ( & V_80 -> V_9 , & V_100 , NULL ) ;
if ( F_27 ( V_2 -> V_99 ) ) {
V_29 = F_28 ( V_2 -> V_99 ) ;
goto V_101;
}
