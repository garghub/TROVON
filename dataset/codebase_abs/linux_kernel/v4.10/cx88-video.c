...
switch ( V_112 -> V_120 ) {
case V_134 :
V_118 = ( V_112 -> V_122 < 0x40 ) ?
( 0x7f - V_112 -> V_122 ) : ( V_112 -> V_122 - 0x40 ) ;
break;
case V_133 :
...
F_85 ( & V_34 -> V_101 ) ;
V_53 = F_71 ( V_212 ) ;
F_86 ( V_6 , & V_34 -> V_213 , V_53 ) ;
F_87 ( & V_34 -> V_101 ) ;
}
}
static T_3 F_88 ( int V_214 , void * V_215 )
{
struct V_33 * V_34 = V_215 ;
struct V_5 * V_6 = V_34 -> V_6 ;
T_1 V_207 ;
int V_216 , V_217 = 0 ;
for ( V_216 = 0 ; V_216 < 10 ; V_216 ++ ) {
V_207 = F_71 ( V_218 ) &
( V_6 -> V_55 | V_56 ) ;
if ( V_207 == 0 )
goto V_219;
...
static int F_93 ( struct V_223 * V_223 ,
...
V_34 -> V_6 = V_6 ;
V_34 -> V_230 = V_223 -> V_231 ;
F_97 ( V_223 , V_232 , & V_34 -> V_233 ) ;
F_98 ( L_24 ,
F_58 ( V_223 ) , V_34 -> V_230 , V_223 -> V_214 ,
V_34 -> V_233 ,
( unsigned long long ) F_99 ( V_223 , 0 ) ) ;
F_100 ( V_223 ) ;
V_146 = F_101 ( V_223 , F_102 ( 32 ) ) ;
if ( V_146 ) {
F_103 ( L_25 ) ;
goto V_234;
}
F_104 ( & V_34 -> V_101 ) ;
F_105 ( & V_34 -> V_94 . V_61 ) ;
F_105 ( & V_34 -> V_213 . V_61 ) ;
V_146 = F_106 ( V_223 -> V_214 , F_88 ,
V_235 , V_6 -> V_89 , V_34 ) ;
if ( V_146 < 0 ) {
F_103 ( L_26 , V_223 -> V_214 ) ;
goto V_234;
}
F_8 ( V_54 , V_6 -> V_55 ) ;
for ( V_3 = 0 ; V_3 < V_236 ; V_3 ++ ) {
const struct V_115 * V_116 = & V_237 [ V_3 ] ;
struct V_111 * V_238 ;
V_238 = F_107 ( & V_6 -> V_131 , & V_239 ,
V_116 -> V_120 , V_116 -> V_240 , V_116 -> V_241 ,
V_116 -> V_242 , V_116 -> V_243 ) ;
if ( ! V_238 ) {
V_146 = V_6 -> V_131 . error ;
goto V_234;
}
V_238 -> V_117 = ( void * ) V_116 ;
}
for ( V_3 = 0 ; V_3 < V_244 ; V_3 ++ ) {
const struct V_115 * V_116 = & V_245 [ V_3 ] ;
struct V_111 * V_238 ;
V_238 = F_107 ( & V_6 -> V_114 , & V_246 ,
V_116 -> V_120 , V_116 -> V_240 , V_116 -> V_241 ,
V_116 -> V_242 , V_116 -> V_243 ) ;
if ( ! V_238 ) {
...
V_238 -> V_117 = ( void * ) V_116 ;
if ( V_238 -> V_120 == V_128 )
V_6 -> V_247 = V_238 ;
}
F_108 ( & V_6 -> V_114 , & V_6 -> V_131 , NULL ) ;
if ( V_6 -> V_105 . V_248 == V_249 ) {
struct V_250 V_251 = {
. type = L_27 ,
. V_252 = 0x36 >> 1 ,
. V_253 = & V_6 -> V_254 ,
...
struct V_255 * V_256 ;
if ( V_6 -> V_257 == V_258 )
V_6 -> V_254 . V_259 = true ;
else
V_6 -> V_254 . V_259 = false ;
V_256 = F_109 ( & V_6 -> V_260 , & V_6 -> V_261 ,
& V_251 , NULL ) ;
if ( V_256 ) {
V_6 -> V_23 = V_256 ;
V_256 -> V_262 = V_263 ;
...
if ( V_6 -> V_105 . V_248 == V_264 ) {
F_110 ( & V_6 -> V_260 , & V_6 -> V_261 ,
L_28 , 0 , F_111 ( 0xb0 >> 1 ) ) ;
}
switch ( V_6 -> V_257 ) {
case V_265 :
case V_266 : {
static const struct V_250 V_267 = {
F_112 ( L_29 , 0x6f )
} ;
F_113 ( L_30 ) ;
V_6 -> V_268 = F_114 ( & V_6 -> V_261 , & V_267 ) ;
}
case V_269 :
F_113 ( L_31 ) ;
}
...
V_36 = & V_34 -> V_147 ;
V_36 -> type = V_273 ;
V_36 -> V_274 = V_275 | V_276 | V_277 | V_278 ;
V_36 -> V_279 = V_280 ;
V_36 -> V_281 = 2 ;
V_36 -> V_73 = V_34 ;
V_36 -> V_282 = sizeof( struct V_37 ) ;
V_36 -> V_283 = & V_284 ;
V_36 -> V_285 = & V_286 ;
V_36 -> V_287 = V_288 ;
V_36 -> V_272 = & V_6 -> V_272 ;
...
if ( V_146 < 0 )
goto V_289;
F_119 ( V_6 , V_34 -> V_82 , & V_34 -> V_222 ,
& V_292 , L_32 ) ;
F_120 ( & V_34 -> V_222 , V_34 ) ;
V_34 -> V_222 . V_293 = & V_6 -> V_114 ;
V_34 -> V_222 . V_294 = & V_34 -> V_147 ;
V_146 = F_121 ( & V_34 -> V_222 , V_165 ,
V_295 [ V_6 -> V_296 ] ) ;
if ( V_146 < 0 ) {
F_103 ( L_33 ) ;
goto V_289;
...
F_98 ( L_34 ,
F_122 ( & V_34 -> V_222 ) ) ;
F_119 ( V_6 , V_34 -> V_82 , & V_34 -> V_221 ,
& V_297 , L_35 ) ;
F_120 ( & V_34 -> V_221 , V_34 ) ;
V_34 -> V_221 . V_294 = & V_34 -> V_148 ;
V_146 = F_121 ( & V_34 -> V_221 , V_167 ,
V_298 [ V_6 -> V_296 ] ) ;
if ( V_146 < 0 ) {
F_103 ( L_36 ) ;
goto V_289;
...
F_122 ( & V_34 -> V_221 ) ) ;
if ( V_6 -> V_105 . V_106 . type == V_171 ) {
F_119 ( V_6 , V_34 -> V_82 , & V_34 -> V_220 ,
& V_299 , L_38 ) ;
F_120 ( & V_34 -> V_220 , V_34 ) ;
V_34 -> V_220 . V_293 = & V_6 -> V_131 ;
V_146 = F_121 ( & V_34 -> V_220 , V_163 ,
V_300 [ V_6 -> V_296 ] ) ;
if ( V_146 < 0 ) {
F_103 ( L_39 ) ;
goto V_289;
...
if ( V_6 -> V_105 . V_160 != V_84 ) {
V_6 -> V_301 = F_123 ( V_302 ,
V_6 , L_40 ) ;
if ( F_124 ( V_6 -> V_301 ) ) {
V_146 = F_125 ( V_6 -> V_301 ) ;
F_103 ( L_41 ,
V_146 ) ;
}
}
...
static void F_130 ( struct V_223 * V_223 )
{
struct V_33 * V_34 = F_131 ( V_223 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
if ( V_6 -> V_301 ) {
F_132 ( V_6 -> V_301 ) ;
V_6 -> V_301 = NULL ;
...
static int F_136 ( struct V_223 * V_223 , T_4 V_304 )
{
struct V_33 * V_34 = F_131 ( V_223 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
unsigned long V_100 ;
...
static int F_141 ( struct V_223 * V_223 )
{
struct V_33 * V_34 = F_131 ( V_223 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
unsigned long V_100 ;
