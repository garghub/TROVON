...
static inline void F_113 ( T_2 * V_121 , const T_2 * V_123 , unsigned int V_122 )
{
for (; V_122 ; V_122 -- )
* V_121 ++ ^= * V_123 ++ ;
}
void F_114 ( T_2 * V_125 , const T_2 * V_126 , unsigned int V_122 )
{
T_1 * V_121 = ( T_1 * ) V_125 ;
T_1 * V_123 = ( T_1 * ) V_126 ;
for (; V_122 >= 4 ; V_122 -= 4 )
* V_121 ++ ^= * V_123 ++ ;
F_113 ( ( T_2 * ) V_121 , ( T_2 * ) V_123 , V_122 ) ;
}
unsigned int F_115 ( struct V_1 * V_2 )
{
return V_2 -> V_127 +
( V_2 -> V_14 & ~ ( F_116 () - 1 ) ) ;
}
int F_117 ( const char * V_57 , const struct V_79 * V_80 ,
T_1 type , T_1 V_43 )
{
int V_47 = 0 ;
