...
static int F_18 ( struct V_2 * V_2 , int V_47 ,
void V_13 * * V_48 , unsigned long * V_49 )
{
struct V_1 * V_15 = V_2 -> V_3 ;
struct V_50 V_50 = { } ;
unsigned long V_34 ;
int V_37 ;
V_37 = F_19 ( V_15 , V_47 , & V_50 ) ;
if ( V_37 )
return V_37 ;
if ( V_49 )
* V_49 = V_50 . V_51 ;
V_34 = F_20 ( & V_50 ) ;
* V_48 = F_11 ( V_50 . V_51 , V_34 ) ;
if ( ! * V_48 )
return - V_29 ;
return 0 ;
}
...
static int T_2 F_22 ( int (* F_23)( void * V_52 ) )
{
int V_37 ;
struct V_1 * V_23 ;
unsigned int V_30 = 0 ;
...
static int T_2 F_25 ( struct V_2 * V_2 , void * V_52 )
{
int V_37 ;
struct V_1 * V_4 = (struct V_1 * ) V_52 ;
static int V_53 = 0 , V_54 = 0 ;
V_2 -> V_3 = F_26 ( V_4 ) ;
V_2 -> V_55 = F_2 ( V_4 ) ;
V_2 -> V_23 = F_27 ( V_4 ) ;
if ( V_2 -> V_23 >= V_56 ) {
F_8 ( V_21 L_28
L_29 , V_4 -> V_46 , V_2 -> V_23 ) ;
F_8 ( V_21 L_30 ) ;
V_37 = - V_19 ;
goto V_38;
}
...
static struct V_2 * F_32 ( int V_23 , T_3 V_64 )
{
struct V_2 * V_2 ;
const T_3 * V_65 ;
F_33 (spu, &cbe_spu_info[node].spus, cbe_list) {
V_65 = F_3 ( F_1 ( V_2 ) , L_3 , NULL ) ;
if ( * V_65 == V_64 )
return V_2 ;
}
return NULL ;
...
static struct V_2 * F_39 ( int V_73 , struct V_1 * V_72 )
{
struct V_2 * V_2 ;
...
static struct V_2 *
F_40 ( int V_73 , struct V_1 * V_74 , struct V_1 * V_75 )
{
struct V_2 * V_2 ;
struct V_1 * V_76 ;
const T_4 * V_77 ;
...
if ( V_76 == V_75 )
continue;
V_77 = F_3 ( V_76 , L_37 , & V_78 ) ;
for ( V_44 = 0 ; V_44 < ( V_78 / sizeof( T_4 ) ) ; V_44 ++ ) {
if ( V_77 [ V_44 ] == V_74 -> T_4 )
return V_2 ;
}
}
return NULL ;
}
static void F_41 ( int V_73 )
{
struct V_2 * V_2 , * V_66 ;
...
const char * V_31 ;
int V_78 , V_44 , V_82 ;
V_66 = F_42 ( & V_83 [ V_73 ] . V_84 , struct V_2 ,
V_85 ) ;
V_81 = 0 ;
for ( V_82 = 1 ; V_82 < V_83 [ V_73 ] . V_86 ; V_82 ++ ) {
V_80 = F_1 ( V_66 ) ;
V_77 = F_3 ( V_80 , L_37 , & V_78 ) ;
for ( V_44 = 0 ; V_44 < ( V_78 / sizeof( T_4 ) ) ; V_44 ++ ) {
if ( V_77 [ V_44 ] == V_81 )
continue;
V_79 = F_43 ( V_77 [ V_44 ] ) ;
