T_1 T_2 unsigned long F_1 ( void )
{
...
T_1 T_2 void F_5 ( void )
{
unsigned long V_1 = F_2 () ;
F_4 ( ( V_1 & ~ V_2 ) | V_3 ) ;
}
T_1 T_2 void F_6 ( void )
{
unsigned long V_1 = F_2 () ;
F_4 ( ( V_1 | V_2 ) & ( ~ V_3 ) ) ;
}
...
{
#if ! F_28 ( V_27 ) && F_28 ( F_16 )
void T_6 * V_13 ;
unsigned int V_16 , V_28 , V_29 , V_30 ;
if ( V_31 != V_32 )
return;
V_16 = F_12 ( 0 , 0x1f , 0 , V_17 ) ;
V_13 = F_13 ( V_16 + V_33 , 4 ) ;
if ( F_29 ( ! V_13 ) )
return;
V_28 = F_14 ( V_13 ) ;
V_29 = ( V_28 >> 16 ) & 0x7 ;
...
static int F_30 ( int V_34 , int V_35 )
{
return F_31 () >> V_35 ;
}
static void F_32 ( int V_36 , struct V_37 * V_38 ,
