...
break;
default:
F_7 ( V_2 -> V_31 , L_17 , V_6 -> V_78 . type ) ;
continue;
}
V_66 [ V_61 ] . V_62 = V_60 ;
V_64 [ V_61 ] . V_61 = V_67 [ V_6 -> V_78 . type ] ;
V_64 [ V_61 ] . V_86 = & V_66 [ V_61 ] ;
V_64 [ V_61 ] . V_87 =
sizeof( struct V_65 ) ;
V_67 [ V_6 -> V_78 . type ] ++ ;
V_61 ++ ;
...
{
int V_91 = - V_12 ;
struct V_58 * V_31 = & V_90 -> V_31 ;
struct V_92 * V_93 = F_29 ( V_31 ) ;
T_5 V_94 = F_30 ( V_95 , V_90 -> V_61 ) ;
struct V_1 * V_2 = F_25 ( sizeof( * V_2 ) , V_11 ) ;
if ( ! V_2 )
return V_91 ;
F_31 ( V_31 , V_2 ) ;
V_2 -> V_19 = F_32 ( V_31 -> V_96 ) ;
V_2 -> V_31 = V_31 ;
V_2 -> V_16 = V_93 -> V_16 ;
V_2 -> V_29 [ 0 ] = - 1U ;
V_2 -> V_29 [ 1 ] = - 1U ;
F_33 ( & V_2 -> V_59 ) ;
F_34 ( & V_2 -> V_36 , & V_97 ) ;
V_2 -> V_36 . V_98 . V_96 = & V_2 -> V_59 . V_98 ;
V_91 = F_35 ( & V_2 -> V_36 , V_94 , 1 ) ;
if ( V_91 ) {
F_27 ( V_31 , L_21 ) ;
goto V_99;
}
V_2 -> V_59 . V_100 = V_2 -> V_36 . V_31 ;
V_2 -> V_59 . V_101 = & V_102 ;
V_2 -> V_59 . V_96 = V_31 ;
V_2 -> V_59 . V_103 = F_23 ;
V_91 = F_36 ( & V_2 -> V_59 , L_22 , V_93 -> V_104 ) ;
if ( V_91 ) {
F_27 ( V_31 , L_23 , V_91 ) ;
goto V_105;
}
...
V_10 = F_46 ( & V_111 ) ;
if ( V_10 < 0 ) {
F_47 ( V_108 L_27 , V_10 ) ;
goto V_112;
}
return 0 ;
V_112:
F_48 ( F_30 ( V_95 , 0 ) , V_109 ) ;
V_110:
F_49 ( & V_102 ) ;
return V_10 ;
}
