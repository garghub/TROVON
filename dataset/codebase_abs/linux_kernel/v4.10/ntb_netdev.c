...
static int F_44 ( struct V_3 * V_6 , struct V_59 * V_60 )
{
V_60 -> V_61 = V_62 ;
V_60 -> V_63 = V_64 ;
F_45 ( V_60 , V_65 ) ;
...
V_4 -> V_89 = F_29 ( V_90 ) ;
F_49 ( V_4 -> V_91 ) ;
memcpy ( V_4 -> V_92 , V_4 -> V_91 , V_4 -> V_93 ) ;
V_4 -> V_94 = & V_95 ;
V_4 -> V_96 = & V_97 ;
V_4 -> V_98 = 0 ;
V_4 -> V_99 = V_100 ;
V_6 -> V_7 = F_50 ( V_4 , V_78 ,
& V_101 ) ;
if ( ! V_6 -> V_7 ) {
V_13 = - V_102 ;
goto V_42;
...
if ( V_13 )
goto V_103;
F_52 ( & V_6 -> V_104 , & V_105 ) ;
F_53 ( & V_58 -> V_6 , L_4 , V_4 -> V_106 ) ;
return 0 ;
V_103:
F_54 ( V_6 -> V_7 ) ;
V_42:
