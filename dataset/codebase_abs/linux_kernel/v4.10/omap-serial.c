...
{}
static int
F_88 ( struct V_19 * V_4 , struct V_260 * V_31 )
{
struct V_1 * V_2 = F_13 ( V_4 ) ;
unsigned int V_21 ;
int V_261 ;
...
V_2 -> V_27 = 0 ;
F_3 ( V_2 , V_29 , 0 ) ;
V_31 -> V_62 = F_89 ( V_31 -> V_62 , 100U ) ;
V_31 -> V_39 = F_89 ( V_31 -> V_39 , 100U ) ;
V_4 -> V_31 = * V_31 ;
if ( F_90 ( V_2 -> V_38 ) ) {
V_261 = ( V_4 -> V_31 . V_32 & V_33 ) ?
V_37 : V_61 ;
V_261 = ( V_4 -> V_31 . V_32 & V_261 ) ? 1 : 0 ;
F_21 ( V_2 -> V_38 , V_261 ) ;
} else
V_4 -> V_31 . V_32 &= ~ V_33 ;
V_2 -> V_27 = V_21 ;
...
static int F_91 ( struct V_262 * V_14 )
{
struct V_1 * V_2 = F_92 ( V_14 ) ;
V_2 -> V_263 = true ;
return 0 ;
}
static void F_93 ( struct V_262 * V_14 )
{
struct V_1 * V_2 = F_92 ( V_14 ) ;
V_2 -> V_263 = false ;
}
static int F_94 ( struct V_262 * V_14 )
{
struct V_1 * V_2 = F_92 ( V_14 ) ;
F_95 ( & V_264 , & V_2 -> V_4 ) ;
F_96 ( & V_2 -> V_159 ) ;
...
static int F_98 ( struct V_262 * V_14 )
{
struct V_1 * V_2 = F_92 ( V_14 ) ;
if ( F_97 ( V_14 ) )
F_8 ( V_2 , false ) ;
...
{
T_4 V_265 , V_266 ;
T_5 V_267 , V_268 , V_269 ;
V_265 = F_101 ( V_2 -> V_4 . V_6 + ( V_270 << V_2 -> V_4 . V_5 ) ) ;
V_266 = V_265 >> V_271 ;
switch ( V_266 ) {
case 0 :
V_268 = ( V_265 & V_272 ) >>
...
static struct V_12 * F_104 ( struct V_262 * V_14 )
{
struct V_12 * V_282 ;
V_282 = F_105 ( V_14 , sizeof( * V_282 ) , V_283 ) ;
if ( ! V_282 )
return NULL ;
F_106 ( V_14 -> V_284 , L_16 ,
& V_282 -> V_23 ) ;
return V_282 ;
}
...
struct V_285 * V_286 )
{
struct V_260 * V_287 = & V_2 -> V_4 . V_31 ;
T_4 V_288 [ 2 ] ;
enum V_289 V_32 ;
int V_99 ;
V_287 -> V_32 = 0 ;
...
V_287 -> V_32 |= V_37 ;
V_2 -> V_38 = F_109 ( V_286 , L_18 , 0 , & V_32 ) ;
if ( F_90 ( V_2 -> V_38 ) ) {
V_99 = F_110 ( V_2 -> V_14 , V_2 -> V_38 , L_19 ) ;
if ( V_99 < 0 )
return V_99 ;
V_99 = F_111 ( V_2 -> V_38 ,
V_32 & V_37 ) ;
...
static int F_113 ( struct V_291 * V_292 )
{
struct V_12 * V_282 = F_7 ( & V_292 -> V_14 ) ;
struct V_1 * V_2 ;
struct V_293 * V_294 ;
void T_6 * V_295 ;
int V_296 = 0 ;
...
int V_99 ;
if ( V_292 -> V_14 . V_284 ) {
V_296 = F_114 ( V_292 -> V_14 . V_284 , 0 ) ;
if ( ! V_296 )
return - V_290 ;
V_149 = F_114 ( V_292 -> V_14 . V_284 , 1 ) ;
V_282 = F_104 ( & V_292 -> V_14 ) ;
V_292 -> V_14 . V_297 = V_282 ;
} else {
V_296 = F_115 ( V_292 , 0 ) ;
if ( V_296 < 0 )
return - V_290 ;
}
V_2 = F_105 ( & V_292 -> V_14 , sizeof( * V_2 ) , V_283 ) ;
if ( ! V_2 )
return - V_298 ;
V_294 = F_116 ( V_292 , V_299 , 0 ) ;
V_295 = F_117 ( & V_292 -> V_14 , V_294 ) ;
if ( F_118 ( V_295 ) )
return F_119 ( V_295 ) ;
V_2 -> V_14 = & V_292 -> V_14 ;
...
V_2 -> V_4 . V_302 = & V_303 ;
if ( V_292 -> V_14 . V_284 )
V_99 = F_120 ( V_292 -> V_14 . V_284 , L_23 ) ;
else
V_99 = V_292 -> V_304 ;
if ( V_99 < 0 ) {
F_121 ( & V_292 -> V_14 , L_24 ,
V_99 ) ;
goto V_305;
}
V_2 -> V_4 . line = V_99 ;
if ( V_2 -> V_4 . line >= V_306 ) {
F_121 ( & V_292 -> V_14 , L_25 , V_2 -> V_4 . line ,
V_306 ) ;
V_99 = - V_307 ;
goto V_305;
}
V_2 -> V_149 = V_149 ;
if ( ! V_2 -> V_149 )
F_122 ( V_2 -> V_4 . V_14 , L_26 ,
V_2 -> V_4 . line ) ;
V_99 = F_107 ( V_2 , V_292 -> V_14 . V_284 ) ;
if ( V_99 < 0 )
goto V_308;
sprintf ( V_2 -> V_148 , L_27 , V_2 -> V_4 . line ) ;
V_2 -> V_4 . V_309 = V_294 -> V_310 ;
V_2 -> V_4 . V_6 = V_295 ;
V_2 -> V_4 . V_32 = V_282 -> V_32 ;
V_2 -> V_4 . V_23 = V_282 -> V_23 ;
V_2 -> V_4 . V_311 = F_88 ;
if ( ! V_2 -> V_4 . V_23 ) {
V_2 -> V_4 . V_23 = V_312 ;
F_102 ( & V_292 -> V_14 ,
...
F_133 ( & V_292 -> V_14 ) ;
F_134 ( & V_2 -> V_160 ) ;
F_126 ( V_2 -> V_14 , false ) ;
V_308:
V_305:
return V_99 ;
}
static int F_135 ( struct V_291 * V_14 )
{
struct V_1 * V_2 = F_136 ( V_14 ) ;
F_137 ( V_2 -> V_14 ) ;
F_133 ( V_2 -> V_14 ) ;
F_138 ( & V_264 , & V_2 -> V_4 ) ;
F_134 ( & V_2 -> V_160 ) ;
F_126 ( & V_14 -> V_14 , false ) ;
return 0 ;
}
...
static int F_141 ( struct V_262 * V_14 )
{
struct V_1 * V_2 = F_92 ( V_14 ) ;
if ( ! V_2 )
return - V_16 ;
...
static int F_143 ( struct V_262 * V_14 )
{
struct V_1 * V_2 = F_92 ( V_14 ) ;
int V_322 = F_6 ( V_2 ) ;
F_8 ( V_2 , false ) ;
