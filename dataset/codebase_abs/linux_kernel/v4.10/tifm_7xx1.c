...
for ( V_46 = 0 ; V_46 < V_2 -> V_19 ; V_46 ++ ) {
if ( V_2 -> V_20 [ V_46 ] ) {
if ( V_2 -> V_20 [ V_46 ] -> type == V_50 [ V_46 ] )
V_48 |= 1 << V_46 ;
else
V_49 |= 1 << V_46 ;
}
...
V_46 = F_52 ( V_40 -> V_10 , F_6 , V_66 , V_56 , V_2 ) ;
if ( V_46 )
goto V_67;
V_46 = F_53 ( V_2 ) ;
if ( V_46 )
