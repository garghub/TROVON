...
static int F_27 ( struct V_46 * V_47 , unsigned int V_48 )
{
struct V_3 * V_4 = F_28 ( V_47 ) ;
return ( F_12 ( & V_4 -> V_7 -> V_10 ) >> 8 ) & 1 ;
}
static void
F_29 ( struct V_46 * V_47 , unsigned int V_48 , int V_49 )
{
struct V_3 * V_4 = F_28 ( V_47 ) ;
unsigned long V_5 ;
T_1 V_50 ;
...
V_50 = V_49 ? V_51 : V_52 ;
F_3 ( & V_4 -> V_6 , V_5 ) ;
F_30 ( & V_4 -> V_7 -> V_8 , V_53 , V_50 ) ;
F_5 ( & V_4 -> V_6 , V_5 ) ;
}
static int F_31 ( struct V_46 * V_47 , unsigned int V_48 )
{
struct V_3 * V_4 = F_28 ( V_47 ) ;
unsigned long V_5 ;
...
static int
F_32 ( struct V_46 * V_47 , unsigned int V_48 , int V_54 )
{
F_29 ( V_47 , V_48 , V_54 ) ;
return 0 ;
}
static void
F_33 ( struct V_3 * V_4 , struct V_33 * V_41 )
{
int V_55 ;
if ( ! F_34 ( V_41 , L_9 , NULL ) )
return;
V_4 -> V_47 . V_56 = F_35 ( V_41 -> V_39 , V_57 ) ;
if ( ! V_4 -> V_47 . V_56 ) {
F_21 ( V_4 -> V_14 , L_10 ) ;
return;
}
...
V_4 -> V_47 . V_63 = - 1 ;
V_4 -> V_47 . V_64 = V_41 ;
F_30 ( & V_4 -> V_7 -> V_8 , V_44 ,
V_65 ) ;
V_55 = F_36 ( & V_4 -> V_47 , V_4 ) ;
if ( V_55 )
F_21 ( V_4 -> V_14 , L_11 , V_55 ) ;
F_11 ( V_4 -> V_14 , L_12 , V_15 ) ;
}
static void
F_33 ( struct V_3 * V_66 , struct V_33 * V_67 ) { }
...
{
struct V_3 * V_4 ;
V_4 = F_68 ( & V_117 -> V_14 , sizeof *V_4 , V_57 ) ;
if ( ! V_4 )
return - V_118 ;
F_69 ( & V_4 -> V_6 ) ;
V_4 -> V_14 = & V_117 -> V_14 ;
...
return - V_118 ;
F_72 ( & V_117 -> V_14 , V_4 ) ;
F_33 ( V_4 , V_117 -> V_14 . V_64 ) ;
F_22 ( V_4 , V_117 -> V_14 . V_64 ) ;
F_38 ( & V_70 ) ;
F_73 ( & V_4 -> V_71 , & V_119 ) ;
F_41 ( & V_70 ) ;
if ( F_74 ( V_117 -> V_14 . V_64 , L_18 , NULL ) ||
F_74 ( V_117 -> V_14 . V_64 , L_19 , NULL ) ) {
const T_1 * V_120 ;
V_4 -> V_82 = V_121 ;
V_120 = F_74 ( V_117 -> V_14 . V_64 ,
L_20 , NULL ) ;
if ( V_120 ) {
F_66 ( V_4 -> V_14 , L_21 ) ;
V_4 -> V_82 |= V_83 ;
