...
V_27 ) ;
if ( ! V_13 -> V_21 [ V_23 ] ) {
V_13 -> V_21 [ V_23 ] = F_19 ( V_24 * sizeof( long ) ) ;
if ( ! V_13 -> V_21 [ V_23 ] )
goto V_28;
}
}
...
static int F_23 ( struct V_3 * V_4 , int V_14 ,
unsigned long * V_15 )
{
...
int F_25 ( struct V_3 * V_4 , int V_35 , int V_36 ,
struct V_37 * V_38 )
{
int V_32 = 0 ;
int V_23 ;
...
V_23 <<= 1 )
++ V_38 -> V_14 ;
V_32 = F_23 ( V_4 , V_38 -> V_14 , & V_38 -> V_41 ) ;
if ( V_32 == - 1 )
return - V_29 ;
return 0 ;
}
void F_26 ( struct V_3 * V_4 , struct V_37 * V_38 )
{
struct V_30 * V_31 = & V_4 -> V_31 ;
if ( V_38 -> V_14 < 0 )
return;
F_12 ( & V_31 -> V_33 , V_38 -> V_41 , V_38 -> V_14 ) ;
F_27 ( V_4 , & V_31 -> V_34 , V_38 -> V_41 ,
V_38 -> V_41 + ( 1 << V_38 -> V_14 ) - 1 ) ;
}
static int F_28 ( struct V_3 * V_4 , T_1 V_42 , T_2 V_43 ,
...
if ( V_47 -> V_44 != ~ 0ULL ) {
V_35 = F_33 ( V_47 -> V_60 ) ;
F_34 ( V_50 , ( unsigned int ) ( V_35 * 8 ) , V_47 -> V_55 ,
V_47 -> V_56 ) ;
}
F_35 ( & V_4 -> V_31 . V_52 ,
F_2 ( V_47 -> V_2 ) , V_61 ) ;
...
return - V_74 ;
while ( V_35 > 0 ) {
V_77 = F_48 ( int , V_73 / sizeof( T_2 ) , V_35 ) ;
V_32 = F_44 ( V_4 , V_38 , V_69 , V_77 ,
V_70 ) ;
if ( V_32 )
return V_32 ;
V_35 -= V_77 ;
...
int V_32 = 0 ;
T_2 * V_70 = NULL ;
V_70 = F_50 ( V_67 -> V_35 , sizeof( * V_70 ) , V_25 ) ;
if ( ! V_70 )
return - V_29 ;
...
V_32 = F_47 ( V_4 , V_38 , 0 , V_67 -> V_35 , V_70 ) ;
F_21 ( V_70 ) ;
return V_32 ;
}
...
struct V_85 * F_56 ( struct V_86 * V_42 , int V_87 )
{
int V_32 = 0 ;
struct V_46 * V_47 = NULL ;
V_47 = F_57 ( sizeof( * V_47 ) , V_25 ) ;
if ( V_47 == NULL )
return F_58 ( - V_29 ) ;
V_32 = F_28 ( F_59 ( V_42 -> V_49 ) , F_60 ( V_42 ) -> V_88 , 0 ,
~ 0ULL , V_87 , 0 , V_47 ) ;
if ( V_32 )
goto V_89;
V_32 = F_36 ( F_59 ( V_42 -> V_49 ) , V_47 ) ;
if ( V_32 )
goto V_90;
...
return - V_29 ;
V_23 = V_100 = 0 ;
F_63 (umem->sg_head.sgl, sg, umem->nmap, entry) {
V_101 = F_64 ( V_96 ) >> V_38 -> V_36 ;
for ( V_97 = 0 ; V_97 < V_101 ; ++ V_97 ) {
V_99 [ V_23 ++ ] = F_65 ( V_96 ) + V_60 -> V_102 * V_97 ;
if ( V_23 == V_73 / sizeof( T_2 ) ) {
V_32 = F_47 ( V_4 , V_38 , V_100 , V_23 ,
V_99 ) ;
if ( V_32 )
goto V_103;
V_100 += V_23 ;
...
if ( V_23 )
V_32 = F_47 ( V_4 , V_38 , V_100 , V_23 , V_99 ) ;
V_103:
...
struct V_95 * V_96 ;
F_63 (umem->sg_head.sgl, sg, umem->nmap, entry) {
V_47 -> V_55 [ V_23 ] = ( ( T_2 ) F_65 ( V_96 ) ) >> 12 ;
V_23 ++ ;
}
F_68 () ;
return 0 ;
}
struct V_85 * F_69 ( struct V_86 * V_42 , T_2 V_104 , T_2 V_105 ,
T_2 V_106 , int V_107 ,
struct V_108 * V_109 )
{
struct V_3 * V_4 = F_59 ( V_42 -> V_49 ) ;
struct V_49 * V_50 = & V_4 -> V_51 -> V_50 ;
struct V_46 * V_47 = NULL ;
int V_32 = 0 ;
int V_100 = 0 ;
...
if ( ! V_47 )
return F_58 ( - V_29 ) ;
V_47 -> V_60 = F_70 ( V_42 -> V_110 -> V_111 , V_104 , V_105 ,
V_107 , 0 ) ;
if ( F_39 ( V_47 -> V_60 ) ) {
V_32 = F_40 ( V_47 -> V_60 ) ;
goto V_89;
}
V_100 = F_33 ( V_47 -> V_60 ) ;
if ( V_47 -> V_60 -> V_102 != V_112 ) {
F_41 ( V_50 , L_4 ,
V_47 -> V_60 -> V_102 ) ;
V_32 = - V_74 ;
goto V_113;
...
V_32 = F_28 ( V_4 , F_60 ( V_42 ) -> V_88 , V_106 , V_105 ,
V_107 , V_100 , V_47 ) ;
if ( V_32 )
goto V_113;
V_32 = F_67 ( V_47 , V_47 -> V_60 ) ;
if ( V_32 )
goto V_90;
V_32 = F_36 ( V_4 , V_47 ) ;
if ( V_32 )
...
{
struct V_3 * V_4 = F_59 ( V_91 -> V_49 ) ;
struct V_46 * V_47 = F_73 ( V_91 ) ;
int V_32 = 0 ;
if ( V_4 -> V_65 -> V_115 ) {
V_32 = V_4 -> V_65 -> V_115 ( V_4 , V_47 ) ;
} else {
F_31 ( V_4 , V_47 ) ;
if ( V_47 -> V_60 )
F_71 ( V_47 -> V_60 ) ;
