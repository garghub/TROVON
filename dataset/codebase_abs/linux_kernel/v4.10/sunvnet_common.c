...
int F_95 ( struct V_178 * V_113 , int V_148 )
{
...
F_97 ( V_113 ) ;
V_5 -> V_171 &= ~ V_175 ;
F_98 ( V_12 -> V_180 -> V_181 , V_182 ) ;
}
return V_179 ;
}
void F_99 ( void * V_6 , int V_170 )
{
struct V_4 * V_5 = V_6 ;
struct V_15 * V_12 = & V_5 -> V_12 ;
V_5 -> V_171 |= V_170 ;
F_98 ( V_12 -> V_180 -> V_181 , V_183 ) ;
F_100 ( & V_5 -> V_113 ) ;
}
...
void F_108 ( unsigned long V_190 )
{
struct V_4 * V_5 = (struct V_4 * ) V_190 ;
struct V_60 * V_191 ;
unsigned V_184 ;
F_69 ( F_8 ( V_5 ) ) ;
V_191 = F_103 ( V_5 , & V_184 ) ;
F_70 ( F_8 ( V_5 ) ) ;
F_106 ( V_191 ) ;
if ( V_184 )
( void ) F_109 ( & V_5 -> V_192 ,
V_193 + V_194 ) ;
else
F_110 ( & V_5 -> V_192 ) ;
}
static inline int F_111 ( struct V_195 * V_13 , struct V_60 * V_62 ,
...
V_199 += V_64 ;
V_199 += 8 - ( V_199 & 7 ) ;
V_22 = F_113 ( V_13 , V_62 -> V_65 - V_64 , V_199 , V_97 ,
V_98 , V_197 ) ;
if ( V_22 < 0 )
return V_22 ;
V_198 = V_22 ;
for ( V_21 = 0 ; V_21 < F_114 ( V_62 ) -> V_200 ; V_21 ++ ) {
T_3 * V_201 = & F_114 ( V_62 ) -> V_202 [ V_21 ] ;
T_2 * V_203 ;
if ( V_198 < V_98 ) {
V_203 = F_115 ( F_116 ( V_201 ) ) ;
V_199 = F_117 ( V_201 ) ;
V_199 += 8 - ( V_199 & 7 ) ;
V_22 = F_113 ( V_13 , V_203 + V_201 -> V_204 ,
...
if ( F_128 ( V_62 , 0 , V_205 -> V_65 , V_115 ) ) {
F_107 ( V_205 ) ;
F_107 ( V_62 ) ;
return NULL ;
}
...
V_205 -> V_73 = V_74 ;
} else if ( F_128 ( V_62 , 0 , V_205 -> V_65 , V_62 -> V_61 ) ) {
F_107 ( V_205 ) ;
F_107 ( V_62 ) ;
return NULL ;
}
...
if ( F_130 ( V_62 ) ) {
F_114 ( V_205 ) -> V_210 = F_114 ( V_62 ) -> V_210 ;
F_114 ( V_205 ) -> V_211 = F_114 ( V_62 ) -> V_211 ;
}
...
static struct V_213 * F_138 ( struct V_166 * V_214 , T_2 * V_33 )
{
struct V_213 * V_215 ;
for ( V_215 = V_214 -> V_216 ; V_215 ; V_215 = V_215 -> V_188 ) {
if ( F_139 ( V_215 -> V_33 , V_33 ) )
return V_215 ;
}
return NULL ;
}
static void F_140 ( struct V_166 * V_214 , struct V_16 * V_17 )
{
struct V_217 * V_218 ;
F_141 (ha, dev) {
struct V_213 * V_215 ;
V_215 = F_138 ( V_214 , V_218 -> V_33 ) ;
if ( V_215 ) {
V_215 -> V_219 = 1 ;
continue;
}
if ( ! V_215 ) {
V_215 = F_142 ( sizeof( * V_215 ) , V_220 ) ;
if ( ! V_215 )
continue;
...
static void F_143 ( struct V_166 * V_214 , struct V_4 * V_5 )
{
struct V_164 V_222 ;
...
void F_145 ( struct V_16 * V_17 , struct V_166 * V_214 )
{
struct V_4 * V_5 ;
F_146 () ;
...
int F_149 ( struct V_16 * V_17 , void * V_230 )
{
return - V_231 ;
}
...
struct V_4 * V_5 ;
unsigned long V_103 ;
F_154 ( & V_214 -> V_241 , V_103 ) ;
if ( ! F_155 ( & V_214 -> V_242 ) ) {
V_5 = F_156 ( V_214 -> V_242 . V_188 , struct V_4 , V_243 ) ;
F_100 ( & V_5 -> V_113 ) ;
}
F_157 ( & V_214 -> V_241 , V_103 ) ;
}
