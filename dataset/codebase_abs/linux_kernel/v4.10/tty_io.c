...
int F_156 ( struct V_17 * V_17 , struct V_6 * V_63 )
{
...
if ( F_158 ( & V_185 -> V_190 ) ) {
F_159 ( & V_185 -> V_190 , V_65 ) ;
V_186 ++ ;
}
if ( F_158 ( & V_185 -> V_86 ) ) {
F_159 ( & V_185 -> V_86 , V_66 ) ;
V_186 ++ ;
}
}
if ( ! V_186 )
...
static struct V_1 * F_163 ( T_1 V_28 , struct V_6 * V_63 )
{
struct V_1 * V_2 ;
int V_168 ;
...
static struct V_27 * F_164 ( T_1 V_28 , struct V_6 * V_63 ,
int * V_29 )
{
struct V_27 * V_16 ;
switch ( V_28 ) {
...
static struct V_1 * F_167 ( T_1 V_28 , struct V_17 * V_17 ,
struct V_6 * V_63 )
{
struct V_1 * V_2 ;
...
static int F_170 ( struct V_17 * V_17 , struct V_6 * V_63 )
{
struct V_1 * V_2 ;
int V_200 , V_168 ;
T_1 V_28 = V_17 -> V_201 ;
...
static unsigned int F_175 ( struct V_6 * V_63 , T_6 * V_64 )
{
struct V_1 * V_2 = F_5 ( V_63 ) ;
struct V_82 * V_83 ;
int V_54 = 0 ;
...
goto V_137;
V_168 = F_176 ( V_75 , V_63 , V_76 , & V_2 -> V_210 ) ;
if ( V_168 <= 0 )
goto V_137;
if ( V_76 ) {
enum V_211 type ;
...
static int F_179 ( int V_75 , struct V_6 * V_63 , int V_76 )
{
struct V_1 * V_2 = F_5 ( V_63 ) ;
int V_168 = - V_74 ;
F_77 ( V_2 ) ;
...
static int F_180 ( struct V_1 * V_2 , char T_3 * V_21 )
{
char V_144 , V_214 = 0 ;
struct V_82 * V_83 ;
...
static int F_183 ( struct V_1 * V_2 , struct V_217 T_3 * V_72 )
{
int V_218 ;
F_32 ( & V_2 -> V_219 ) ;
V_218 = F_184 ( V_72 , & V_2 -> V_217 , sizeof( * V_72 ) ) ;
F_33 ( & V_2 -> V_219 ) ;
return V_218 ? - V_139 : 0 ;
}
int F_185 ( struct V_1 * V_2 , struct V_217 * V_220 )
{
struct V_51 * V_52 ;
F_32 ( & V_2 -> V_219 ) ;
...
static int F_186 ( struct V_1 * V_2 , struct V_217 T_3 * V_72 )
{
struct V_217 V_223 ;
...
static int F_188 ( struct V_6 * V_6 , int T_3 * V_21 )
{
int V_225 ;
if ( F_181 ( V_225 , V_21 ) )
return - V_139 ;
...
static int F_189 ( struct V_1 * V_2 , struct V_6 * V_6 , int V_72 )
{
int V_54 = 0 ;
F_77 ( V_2 ) ;
F_73 ( & V_89 ) ;
...
static struct V_51 * F_190 ( struct V_51 * V_52 )
{
struct V_77 * V_21 ;
struct V_51 * V_228 = NULL ;
V_21 = F_191 ( V_52 , V_212 ) ;
if ( V_21 == NULL )
V_21 = F_191 ( V_52 , V_213 ) ;
if ( V_21 != NULL )
V_228 = F_57 ( V_21 ) ;
return V_228 ;
}
static int F_192 ( struct V_1 * V_2 , struct V_1 * V_229 , T_7 T_3 * V_21 )
{
struct V_51 * V_51 ;
int V_54 ;
...
return - V_74 ;
V_51 = F_94 ( V_229 ) ;
V_54 = F_193 ( F_194 ( V_51 ) , V_21 ) ;
F_55 ( V_51 ) ;
return V_54 ;
}
static int F_195 ( struct V_1 * V_2 , struct V_1 * V_229 , T_7 T_3 * V_21 )
{
struct V_51 * V_52 ;
T_7 V_230 ;
...
static int F_197 ( struct V_1 * V_2 , struct V_1 * V_229 , T_7 T_3 * V_21 )
{
if ( V_2 == V_229 && V_43 -> signal -> V_2 != V_229 )
return - V_74 ;
if ( ! V_229 -> V_79 )
return - V_74 ;
return F_193 ( F_194 ( V_229 -> V_79 ) , V_21 ) ;
}
static int F_198 ( struct V_1 * V_2 , int T_3 * V_21 )
{
int V_234 ;
int V_54 ;
if ( F_181 ( V_234 , V_21 ) )
return - V_139 ;
V_54 = F_199 ( V_2 , V_234 ) ;
return V_54 ;
}
static int F_200 ( struct V_1 * V_2 , int T_3 * V_21 )
{
struct V_82 * V_83 ;
int V_54 ;
V_83 = F_105 ( V_2 ) ;
if ( ! V_83 )
return - V_57 ;
V_54 = F_193 ( V_83 -> V_40 -> V_33 , V_21 ) ;
F_70 ( V_83 ) ;
return V_54 ;
}
static int F_201 ( struct V_1 * V_2 , unsigned int V_235 )
{
int V_168 ;
...
static int F_203 ( struct V_1 * V_2 , int T_3 * V_21 )
{
int V_168 = - V_231 ;
if ( V_2 -> V_40 -> V_238 ) {
V_168 = V_2 -> V_40 -> V_238 ( V_2 ) ;
if ( V_168 >= 0 )
V_168 = F_193 ( V_168 , V_21 ) ;
}
return V_168 ;
}
static int F_204 ( struct V_1 * V_2 , unsigned int V_71 ,
unsigned T_3 * V_21 )
{
int V_168 ;
...
static int F_205 ( struct V_1 * V_2 , void T_3 * V_72 )
{
int V_168 = - V_231 ;
struct V_251 V_252 ;
...
if ( V_168 != 0 )
return V_168 ;
if ( F_184 ( V_72 , & V_252 , sizeof( V_252 ) ) )
return - V_139 ;
return 0 ;
}
static void F_206 ( struct V_254 T_3 * V_255 )
{
static F_207 ( V_256 ,
V_257 ,
V_258 ) ;
char V_259 [ V_260 ] ;
int V_50 ;
if ( F_181 ( V_50 , & V_255 -> V_50 ) )
return;
V_50 &= V_261 ;
if ( V_50 && F_208 ( & V_256 ) )
F_209 ( L_36 ,
V_175 , F_210 ( V_259 , V_43 ) , V_50 ) ;
}
static struct V_1 * F_211 ( struct V_1 * V_2 )
{
if ( V_2 -> V_16 -> type == V_23 &&
V_2 -> V_16 -> V_24 == V_163 )
V_2 = V_2 -> V_26 ;
...
long F_212 ( struct V_6 * V_6 , unsigned int V_71 , unsigned long V_72 )
{
struct V_1 * V_2 = F_5 ( V_6 ) ;
struct V_1 * V_229 ;
...
case V_268 :
return F_183 ( V_229 , V_21 ) ;
case V_269 :
return F_186 ( V_229 , V_21 ) ;
case V_270 :
return V_229 != V_2 ? - V_231 : F_187 ( V_6 ) ;
case V_271 :
return F_188 ( V_6 , V_21 ) ;
case V_272 :
F_82 ( V_164 , & V_2 -> V_50 ) ;
return 0 ;
case V_273 :
...
return F_193 ( V_275 , ( int T_3 * ) V_21 ) ;
}
case V_276 :
if ( V_43 -> signal -> V_2 != V_2 )
return - V_74 ;
...
return 0 ;
case V_277 :
return F_189 ( V_229 , V_6 , V_72 ) ;
case V_278 :
return F_192 ( V_2 , V_229 , V_21 ) ;
case V_73 :
return F_195 ( V_2 , V_229 , V_21 ) ;
case V_279 :
return F_197 ( V_2 , V_229 , V_21 ) ;
case V_280 :
return F_200 ( V_2 , V_21 ) ;
case V_262 :
return F_198 ( V_2 , V_21 ) ;
case V_281 :
if ( ! F_132 ( V_165 ) )
return - V_215 ;
F_89 ( V_2 ) ;
...
case V_282 :
{
unsigned int V_54 = F_214 ( F_215 ( V_229 ) ) ;
return F_193 ( V_54 , ( unsigned int T_3 * ) V_21 ) ;
}
case V_263 :
if ( V_2 -> V_40 -> V_236 )
...
case V_265 :
if ( ! V_72 )
return F_201 ( V_2 , 250 ) ;
return 0 ;
case V_266 :
return F_201 ( V_2 , V_72 ? V_72 * 100 : 250 ) ;
case V_283 :
return F_203 ( V_2 , V_21 ) ;
case V_245 :
case V_244 :
case V_243 :
return F_204 ( V_2 , V_71 , V_21 ) ;
case V_284 :
V_168 = F_205 ( V_2 , V_21 ) ;
if ( V_168 != - V_231 )
return V_168 ;
break;
case V_285 :
...
static long F_217 ( struct V_6 * V_6 , unsigned int V_71 ,
unsigned long V_72 )
{
struct V_1 * V_2 = F_5 ( V_6 ) ;
struct V_82 * V_83 ;
...
V_168 = F_218 ( V_2 , V_6 , V_71 , V_72 ) ;
F_70 ( V_83 ) ;
return V_168 ;
}
static int F_219 ( const void * V_292 , struct V_6 * V_6 , unsigned V_75 )
{
if ( F_220 ( V_6 -> V_101 -> V_125 != F_102 ) )
return 0 ;
...
F_229 ( V_21 ) ;
V_124 = F_230 ( V_21 -> V_295 , 0 , F_219 , V_2 ) ;
if ( V_124 != 0 ) {
F_225 ( V_2 , L_40 ,
F_226 ( V_21 ) , V_21 -> V_259 , V_124 - 1 ) ;
F_231 ( V_294 , V_21 ) ;
}
F_232 ( V_21 ) ;
} F_233 ( V_293 , V_21 ) ;
...
static void F_234 ( struct V_110 * V_111 )
{
struct V_1 * V_2 =
...
static int F_236 ( struct V_28 * V_3 , const void * V_296 )
{
const T_1 * V_297 = V_296 ;
return V_3 -> V_297 == * V_297 ;
}
static struct V_28 * F_237 ( struct V_1 * V_2 )
{
T_1 V_297 = F_215 ( V_2 ) ;
return F_238 ( V_298 , NULL , & V_297 , F_236 ) ;
}
struct V_1 * F_137 ( struct V_27 * V_16 , int V_151 )
{
struct V_1 * V_2 ;
V_2 = F_239 ( sizeof( * V_2 ) , V_10 ) ;
if ( ! V_2 )
return NULL ;
F_240 ( & V_2 -> V_181 ) ;
V_2 -> V_5 = V_19 ;
...
int F_248 ( struct V_1 * V_2 , unsigned char V_144 )
{
if ( V_2 -> V_40 -> V_302 )
return V_2 -> V_40 -> V_302 ( V_2 , V_144 ) ;
return V_2 -> V_40 -> V_102 ( V_2 , & V_144 , 1 ) ;
}
static int F_249 ( struct V_27 * V_16 , T_1 V_3 ,
unsigned int V_29 , unsigned int V_22 )
{
int V_218 ;
V_16 -> V_303 [ V_29 ] = F_250 () ;
if ( ! V_16 -> V_303 [ V_29 ] )
return - V_11 ;
V_16 -> V_303 [ V_29 ] -> V_40 = & V_205 ;
V_16 -> V_303 [ V_29 ] -> V_169 = V_16 -> V_169 ;
V_218 = F_251 ( V_16 -> V_303 [ V_29 ] , V_3 , V_22 ) ;
if ( V_218 )
F_252 ( & V_16 -> V_303 [ V_29 ] -> V_304 ) ;
return V_218 ;
}
struct V_28 * F_253 ( struct V_27 * V_16 , unsigned V_29 ,
struct V_28 * V_28 )
{
return F_254 ( V_16 , V_29 , V_28 , NULL , NULL ) ;
}
static void F_255 ( struct V_28 * V_3 )
{
F_256 ( V_3 , L_41 ) ;
F_4 ( V_3 ) ;
}
struct V_28 * F_254 ( struct V_27 * V_16 ,
...
if ( ! ( V_16 -> V_50 & V_309 ) ) {
V_168 = F_249 ( V_16 , V_297 , V_29 , 1 ) ;
if ( V_168 )
goto error;
V_308 = true ;
}
V_3 = F_239 ( sizeof( * V_3 ) , V_10 ) ;
if ( ! V_3 ) {
V_168 = - V_11 ;
goto error;
}
...
F_3 ( V_3 ) ;
if ( V_308 ) {
F_261 ( V_16 -> V_303 [ V_29 ] ) ;
V_16 -> V_303 [ V_29 ] = NULL ;
}
return F_136 ( V_168 ) ;
}
void F_262 ( struct V_27 * V_16 , unsigned V_29 )
{
F_263 ( V_298 ,
...
struct V_27 * F_264 ( unsigned int V_314 , struct V_179 * V_169 ,
unsigned long V_50 )
{
struct V_27 * V_16 ;
...
return F_136 ( - V_231 ) ;
V_16 = F_239 ( sizeof( struct V_27 ) , V_10 ) ;
if ( ! V_16 )
return F_136 ( - V_11 ) ;
F_240 ( & V_16 -> V_181 ) ;
V_16 -> V_5 = V_315 ;
...
V_16 -> V_50 = V_50 ;
if ( ! ( V_50 & V_183 ) ) {
V_16 -> V_153 = F_265 ( V_314 , sizeof( * V_16 -> V_153 ) ,
V_10 ) ;
V_16 -> V_157 = F_265 ( V_314 , sizeof( * V_16 -> V_157 ) ,
V_10 ) ;
...
if ( ! ( V_50 & V_309 ) ) {
V_16 -> V_174 = F_265 ( V_314 , sizeof( * V_16 -> V_174 ) ,
V_10 ) ;
if ( ! V_16 -> V_174 ) {
V_218 = - V_11 ;
goto V_316;
...
V_16 -> V_303 = F_265 ( V_303 , sizeof( * V_16 -> V_303 ) , V_10 ) ;
if ( ! V_16 -> V_303 ) {
V_218 = - V_11 ;
goto V_316;
}
...
static void F_266 ( struct V_181 * V_181 )
{
...
{
F_151 ( & V_16 -> V_181 , F_266 ) ;
}
void F_268 ( struct V_27 * V_16 ,
const struct V_319 * V_320 )
{
V_16 -> V_40 = V_320 ;
}
void F_269 ( struct V_27 * V_321 )
{
F_147 ( V_321 ) ;
}
int F_270 ( struct V_27 * V_16 )
{
int error ;
int V_124 ;
T_1 V_3 ;
...
error = F_274 ( V_3 , V_16 -> V_33 , V_16 -> V_15 ) ;
}
if ( error < 0 )
goto V_218;
if ( V_16 -> V_50 & V_309 ) {
error = F_249 ( V_16 , V_3 , 0 , V_16 -> V_33 ) ;
if ( error )
goto V_322;
}
F_32 ( & V_39 ) ;
...
int F_277 ( struct V_27 * V_16 )
{
#if 0
if (driver->refcount)
return -EBUSY;
#endif
F_276 ( F_28 ( V_16 -> V_31 , V_16 -> V_32 ) ,
V_16 -> V_33 ) ;
F_32 ( & V_39 ) ;
F_14 ( & V_16 -> V_323 ) ;
F_33 ( & V_39 ) ;
...
static char * F_281 ( struct V_28 * V_3 , T_10 * V_330 )
{
if ( ! V_330 )
return NULL ;
...
static int T_8 F_282 ( void )
{
V_298 = F_283 ( V_331 , L_17 ) ;
if ( F_124 ( V_298 ) )
return F_172 ( V_298 ) ;
V_298 -> V_332 = F_281 ;
return 0 ;
}
static T_2 F_284 ( struct V_28 * V_3 ,
...
{
if ( V_340 )
F_290 ( & V_340 -> V_304 , NULL , L_44 ) ;
}
int T_8 F_291 ( void )
{
F_292 ( & V_341 , & V_205 ) ;
if ( F_251 ( & V_341 , F_28 ( V_193 , 0 ) , 1 ) ||
F_274 ( F_28 ( V_193 , 0 ) , 1 , L_45 ) < 0 )
F_293 ( L_46 ) ;
F_294 ( V_298 , NULL , F_28 ( V_193 , 0 ) , NULL , L_17 ) ;
F_292 ( & V_342 , & V_343 ) ;
if ( F_251 ( & V_342 , F_28 ( V_193 , 1 ) , 1 ) ||
F_274 ( F_28 ( V_193 , 1 ) , 1 , L_47 ) < 0 )
F_293 ( L_48 ) ;
V_340 = F_295 ( V_298 , NULL ,
F_28 ( V_193 , 1 ) , NULL ,
V_344 , L_49 ) ;
if ( F_124 ( V_340 ) )
V_340 = NULL ;
