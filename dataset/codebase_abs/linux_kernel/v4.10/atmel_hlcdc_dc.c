...
{
struct V_86 * V_87 = F_42 ( V_31 -> V_31 ) ;
const struct V_88 * V_89 ;
struct V_1 * V_2 ;
int V_69 ;
V_89 = F_43 ( V_90 , V_31 -> V_31 -> V_91 -> V_92 ) ;
if ( ! V_89 ) {
F_37 ( & V_87 -> V_31 , L_4 ) ;
return - V_93 ;
}
...
V_2 = F_44 ( V_31 -> V_31 , sizeof( * V_2 ) , V_70 ) ;
if ( ! V_2 )
return - V_71 ;
V_2 -> V_72 = F_45 ( L_6 , 0 ) ;
if ( ! V_2 -> V_72 )
...
F_46 ( & V_2 -> V_59 . V_63 ) ;
V_2 -> V_19 = V_89 -> V_29 ;
V_2 -> V_37 = F_47 ( V_31 -> V_31 -> V_91 ) ;
V_31 -> V_32 = V_2 ;
V_69 = F_48 ( V_2 -> V_37 -> V_95 ) ;
if ( V_69 ) {
F_37 ( V_31 -> V_31 , L_7 ) ;
goto V_96;
}
...
struct V_1 * V_2 = V_31 -> V_32 ;
unsigned int V_35 ;
F_71 ( V_2 -> V_37 -> V_38 , V_100 , 0xffffffff ) ;
F_3 ( V_2 -> V_37 -> V_38 , V_40 , & V_35 ) ;
}
...
{
struct V_1 * V_2 = V_31 -> V_32 ;
F_71 ( V_2 -> V_37 -> V_38 , V_100 , V_42 ) ;
}
static int F_75 ( struct V_86 * V_87 )
{
struct V_30 * V_102 ;
int V_69 ;
V_102 = F_76 ( & V_103 , & V_87 -> V_31 ) ;
if ( F_12 ( V_102 ) )
return F_39 ( V_102 ) ;
V_69 = F_41 ( V_102 ) ;
if ( V_69 )
...
{
struct V_30 * V_102 = F_80 ( V_87 ) ;
F_81 ( V_102 ) ;
F_61 ( V_102 ) ;
F_78 ( V_102 ) ;
return 0 ;
}
static int F_82 ( struct V_106 * V_31 )
{
struct V_30 * V_107 = F_47 ( V_31 ) ;
struct V_108 * V_43 ;
if ( F_83 ( V_31 ) )
return 0 ;
F_84 ( V_107 ) ;
F_85 (crtc, &drm_dev->mode_config.crtc_list, head)
F_86 ( V_43 ) ;
F_87 ( V_107 ) ;
return 0 ;
}
static int F_88 ( struct V_106 * V_31 )
{
struct V_30 * V_107 = F_47 ( V_31 ) ;
struct V_108 * V_43 ;
if ( F_83 ( V_31 ) )
