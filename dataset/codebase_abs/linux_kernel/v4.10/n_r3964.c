...
for ( V_30 = V_14 -> V_28 ; V_30 ; V_30 = V_30 -> V_18 ) {
if ( V_30 -> V_18 == V_16 ) {
V_30 -> V_18 = V_16 -> V_18 ;
V_14 -> V_29 -- ;
if ( V_30 -> V_18 == NULL ) {
...
static void F_21 ( struct V_13 * V_14 , unsigned char V_31 )
{
struct V_32 * V_25 = V_14 -> V_25 ;
F_22 ( V_25 , V_31 ) ;
V_14 -> V_33 ^= V_31 ;
}
...
{
struct V_32 * V_25 = V_14 -> V_25 ;
if ( V_25 == NULL || V_25 -> V_34 -> V_35 == NULL )
return;
V_25 -> V_34 -> V_35 ( V_25 ) ;
}
...
static int F_47 ( struct V_32 * V_25 )
{
struct V_13 * V_14 ;
F_7 ( L_65 ) ;
F_7 ( L_66 ,
V_25 , V_118 -> V_97 , V_25 -> V_119 ) ;
...
static void F_50 ( struct V_32 * V_25 )
{
struct V_13 * V_14 = V_25 -> V_119 ;
...
static T_4 F_51 ( struct V_32 * V_25 , struct V_128 * V_128 ,
unsigned char T_3 * V_109 , T_5 V_129 )
{
struct V_13 * V_14 = V_25 -> V_119 ;
struct V_56 * V_57 ;
struct V_100 * V_101 ;
...
V_131 . V_111 = V_101 -> V_111 ;
V_131 . V_98 = V_101 -> V_98 ;
V_131 . V_21 = V_101 -> V_21 ;
V_132 = sizeof( struct V_130 ) ;
F_18 ( V_101 ) ;
F_4 ( L_82 , V_101 ) ;
if ( F_44 ( V_109 , & V_131 , V_132 ) ) {
V_132 = - V_110 ;
goto V_137;
}
F_2 ( L_83 , V_132 ) ;
...
static T_4 F_57 ( struct V_32 * V_25 , struct V_128 * V_128 ,
const unsigned char * V_51 , T_5 V_140 )
{
struct V_13 * V_14 = V_25 -> V_119 ;
struct V_15 * V_16 ;
struct V_56 * V_57 ;
...
V_141 = F_32 ( V_140 + sizeof( struct V_15 ) ,
V_63 ) ;
F_4 ( L_87 , V_141 ) ;
if ( V_141 == NULL ) {
if ( V_14 -> V_10 & V_124 ) {
...
V_16 -> V_51 = V_141 + sizeof( struct V_15 ) ;
V_16 -> V_2 = V_140 ;
V_16 -> V_64 = 0 ;
V_16 -> V_23 = NULL ;
V_57 = F_36 ( V_14 , F_54 ( V_118 ) ) ;
...
static int F_58 ( struct V_32 * V_25 , struct V_128 * V_128 ,
unsigned int V_146 , unsigned long V_98 )
{
struct V_13 * V_14 = V_25 -> V_119 ;
if ( V_14 == NULL )
return - V_104 ;
switch ( V_146 ) {
case V_147 :
return F_37 ( V_14 , F_54 ( V_118 ) , V_98 ) ;
case V_148 :
if ( V_98 < V_123 || V_98 > V_74 )
return - V_104 ;
V_14 -> V_73 = V_98 & 0xff ;
return 0 ;
case V_149 :
...
return 0 ;
case V_150 :
return F_43 ( V_14 , F_54 ( V_118 ) ,
( unsigned char T_3 * ) V_98 ) ;
default:
return - V_151 ;
}
}
static void F_59 ( struct V_32 * V_25 , struct V_152 * V_153 )
{
F_7 ( L_89 ) ;
}
static unsigned int F_60 ( struct V_32 * V_25 , struct V_128 * V_128 ,
struct V_154 * V_155 )
{
struct V_13 * V_14 = V_25 -> V_119 ;
struct V_56 * V_57 ;
...
static void F_62 ( struct V_32 * V_25 , const unsigned char * V_160 ,
char * V_161 , int V_140 )
{
struct V_13 * V_14 = V_25 -> V_119 ;
const unsigned char * V_162 ;
char * V_163 , V_10 = V_86 ;
int V_3 ;
for ( V_3 = V_140 , V_162 = V_160 , V_163 = V_161 ; V_3 ; V_3 -- , V_162 ++ ) {
if ( V_163 )
V_10 = * V_163 ++ ;
if ( V_10 == V_86 ) {
F_33 ( V_14 , * V_162 ) ;
