...
if ( V_53 -> V_51 [ V_47 ] )
V_53 -> V_51 [ V_47 ] -> F_40 -> V_54 = F_43 ( V_53 -> V_51 [ V_47 ] -> F_40 ) ;
V_52 -> V_51 [ V_47 ] = NULL ;
}
}
static struct V_55 * F_44 ( struct V_55 * V_56 , const char * V_1 ,
struct V_40 * V_41 ,
const struct V_57 * V_58 )
{
struct V_37 * V_38 = F_22 ( V_41 -> V_59 ) ;
struct V_55 * V_60 ;
V_60 = F_45 ( V_1 , V_61 | 0444 , V_56 , V_38 , V_58 ) ;
if ( F_11 ( V_60 ) )
F_23 ( V_38 ) ;
return V_60 ;
}
int F_46 ( struct V_40 * V_41 , struct V_55 * V_62 )
{
struct V_40 * V_49 ;
...
V_41 -> V_65 = F_51 ( V_4 + V_66 + 1 , V_69 ) ;
if ( ! V_41 -> V_65 )
goto V_64;
F_1 ( V_41 -> V_42 . V_1 , V_41 -> V_65 ) ;
sprintf ( V_41 -> V_65 + V_4 , L_11 , V_41 -> V_67 -> V_68 ++ ) ;
}
V_60 = F_49 ( V_41 -> V_65 , V_62 ) ;
if ( F_11 ( V_60 ) )
goto V_64;
F_48 ( V_41 ) = V_56 = V_60 ;
V_60 = F_44 ( V_56 , L_12 , V_41 , & V_70 ) ;
if ( F_11 ( V_60 ) )
goto V_64;
V_41 -> V_51 [ V_71 ] = V_60 ;
V_60 = F_44 ( V_56 , L_13 , V_41 , & V_72 ) ;
if ( F_11 ( V_60 ) )
goto V_64;
V_41 -> V_51 [ V_73 ] = V_60 ;
V_60 = F_44 ( V_56 , L_14 , V_41 ,
& V_74 ) ;
if ( F_11 ( V_60 ) )
goto V_64;
V_41 -> V_51 [ V_75 ] = V_60 ;
if ( V_41 -> V_48 ) {
V_60 = F_44 ( V_56 , L_15 , V_41 ,
& V_76 ) ;
if ( F_11 ( V_60 ) )
goto V_64;
V_41 -> V_51 [ V_77 ] = V_60 ;
...
int F_55 ( struct V_79 * V_67 , struct V_55 * V_62 ,
const char * V_1 )
{
struct V_79 * V_80 ;
struct V_40 * V_49 ;
...
F_58 ( V_67 ) = V_60 ;
F_39 (child, &ns->base.profiles, base.list) {
error = F_46 ( V_49 , F_57 ( V_67 ) ) ;
if ( error )
goto V_78;
}
F_39 (sub, &ns->sub_ns, base.list) {
F_53 ( & V_80 -> V_81 ) ;
error = F_55 ( V_80 , F_58 ( V_67 ) , NULL ) ;
F_54 ( & V_80 -> V_81 ) ;
if ( error )
goto V_78;
}
...
static struct V_79 * F_59 ( struct V_79 * V_83 ,
struct V_79 * V_67 )
{
struct V_79 * V_62 , * V_84 ;
if ( ! F_60 ( & V_67 -> V_85 ) ) {
V_84 = F_61 ( & V_67 -> V_85 , F_62 ( * V_67 ) , V_42 . V_86 ) ;
F_53 ( & V_84 -> V_81 ) ;
return V_84 ;
}
V_62 = V_67 -> V_62 ;
while ( V_67 != V_83 ) {
F_54 ( & V_67 -> V_81 ) ;
V_84 = F_63 ( V_67 , V_42 . V_86 ) ;
if ( ! F_64 ( V_84 , & V_62 -> V_85 , V_42 . V_86 ) ) {
F_53 ( & V_84 -> V_81 ) ;
return V_84 ;
}
V_67 = V_62 ;
...
static struct V_40 * F_65 ( struct V_79 * V_83 ,
struct V_79 * V_67 )
{
for (; V_67 ; V_67 = F_59 ( V_83 , V_67 ) ) {
if ( ! F_60 ( & V_67 -> V_42 . V_87 ) )
return F_61 ( & V_67 -> V_42 . V_87 ,
struct V_40 , V_42 . V_86 ) ;
}
return NULL ;
}
static struct V_40 * F_66 ( struct V_40 * V_63 )
{
struct V_40 * V_62 ;
struct V_79 * V_67 = V_63 -> V_67 ;
if ( ! F_60 ( & V_63 -> V_42 . V_87 ) )
return F_61 ( & V_63 -> V_42 . V_87 , F_62 ( * V_63 ) ,
V_42 . V_86 ) ;
V_62 = F_67 ( V_63 -> V_62 ,
F_68 ( & V_63 -> V_67 -> V_81 ) ) ;
while ( V_62 ) {
V_63 = F_63 ( V_63 , V_42 . V_86 ) ;
if ( ! F_64 ( V_63 , & V_62 -> V_42 . V_87 , V_42 . V_86 ) )
return V_63 ;
V_63 = V_62 ;
V_62 = F_67 ( V_62 -> V_62 ,
F_68 ( & V_62 -> V_67 -> V_81 ) ) ;
...
V_63 = F_63 ( V_63 , V_42 . V_86 ) ;
if ( ! F_64 ( V_63 , & V_67 -> V_42 . V_87 , V_42 . V_86 ) )
return V_63 ;
return NULL ;
}
static struct V_40 * F_69 ( struct V_79 * V_83 ,
struct V_40 * V_41 )
{
struct V_40 * V_84 = F_66 ( V_41 ) ;
if ( V_84 )
return V_84 ;
return F_65 ( V_83 , F_59 ( V_83 , V_41 -> V_67 ) ) ;
}
static void * F_70 ( struct V_24 * V_16 , T_3 * V_9 )
{
struct V_40 * V_41 = NULL ;
struct V_79 * V_83 = F_71 () -> V_67 ;
T_3 V_88 = * V_9 ;
V_16 -> V_29 = F_72 ( V_83 ) ;
F_53 ( & V_83 -> V_81 ) ;
V_41 = F_65 ( V_83 , V_83 ) ;
...
static void * F_73 ( struct V_24 * V_16 , void * V_63 , T_3 * V_9 )
{
struct V_40 * V_41 = V_63 ;
struct V_79 * V_67 = V_16 -> V_29 ;
( * V_9 ) ++ ;
return F_69 ( V_67 , V_41 ) ;
}
static void F_74 ( struct V_24 * V_16 , void * V_63 )
{
struct V_40 * V_41 = V_63 ;
...
static int F_76 ( struct V_24 * V_16 , void * V_63 )
{
struct V_40 * V_41 = (struct V_40 * ) V_63 ;
struct V_79 * V_83 = V_16 -> V_29 ;
if ( V_41 -> V_67 != V_83 )
F_17 ( V_16 , L_17 , F_77 ( V_83 , V_41 -> V_67 ) ) ;
...
{
return F_79 ( V_15 , & V_90 ) ;
}
static int F_80 ( struct V_35 * V_35 , struct V_15 * V_15 )
{
return F_81 ( V_35 , V_15 ) ;
}
static int T_5 F_82 ( struct V_27 * V_28 ,
struct V_55 * V_62 )
{
int error = 0 ;
V_28 -> V_55 = F_45 ( V_28 -> V_1 ,
V_61 | V_28 -> V_44 ,
V_62 , V_28 ,
V_28 -> V_91 ) ;
if ( F_11 ( V_28 -> V_55 ) ) {
...
static int T_5 F_83 ( struct V_27 * V_92 ,
struct V_55 * V_62 )
{
struct V_27 * V_28 ;
struct V_55 * V_56 ;
int error ;
V_56 = F_49 ( V_92 -> V_1 , V_62 ) ;
if ( F_11 ( V_56 ) )
return F_10 ( V_56 ) ;
V_92 -> V_55 = V_56 ;
for ( V_28 = V_92 -> V_26 . V_93 ; V_28 && V_28 -> V_1 ; ++ V_28 ) {
if ( V_28 -> V_30 == V_94 )
error = F_83 ( V_28 , V_92 -> V_55 ) ;
else
error = F_82 ( V_28 , V_92 -> V_55 ) ;
if ( error )
goto V_95;
}
return 0 ;
...
static void T_5 F_85 ( struct V_27 * V_28 )
{
if ( ! V_28 -> V_55 )
return;
F_41 ( V_28 -> V_55 ) ;
...
static void T_5 F_84 ( struct V_27 * V_92 )
{
struct V_27 * V_28 ;
for ( V_28 = V_92 -> V_26 . V_93 ; V_28 && V_28 -> V_1 ; ++ V_28 ) {
if ( V_28 -> V_30 == V_94 )
...
error = F_83 ( & V_27 , NULL ) ;
if ( error )
goto error;
error = F_55 ( V_99 , V_27 . V_55 ,
L_20 ) ;
if ( error )
goto error;
F_89 ( L_21 ) ;
