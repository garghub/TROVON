...
if ( V_2 -> V_83 -> V_158 && ! F_63 ( V_4 -> V_50 ) ) {
V_2 -> V_159 = true ;
...
if ( V_193 )
F_194 ( V_200 , & V_4 -> V_154 ) ;
else
F_195 ( V_200 , & V_4 -> V_154 ) ;
F_98 ( V_4 ) ;
}
static void
...
V_124 -> V_399 . V_171 = 0 ;
if ( V_13 -> V_20 . V_166 . V_400 )
V_124 -> V_399 . V_171 |= V_401 ;
if ( V_13 -> V_20 . V_166 . V_402 )
V_124 -> V_399 . V_171 |= V_403 ;
if ( V_13 -> V_20 . V_166 . V_404 )
V_124 -> V_399 . V_171 |= V_405 ;
V_124 -> V_399 . V_406 = V_13 -> V_20 . V_166 . V_406 ;
V_124 -> V_399 . V_407 = V_13 -> V_20 . V_166 . V_167 ;
V_124 -> V_408 . V_409 = 0 ;
