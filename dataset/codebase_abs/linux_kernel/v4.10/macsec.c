...
if ( V_64 [ V_353 ] ) {
struct V_20 * V_71 ;
V_28 -> V_60 = F_144 ( V_64 [ V_353 ] ) ;
V_71 = F_6 ( V_28 -> V_8 [ V_28 -> V_60 ] ) ;
V_26 -> V_75 = V_71 && V_71 -> V_9 ;
}
if ( V_64 [ V_354 ] )
V_26 -> V_127 = F_136 ( V_64 [ V_354 ] ) ;
if ( V_64 [ V_355 ] )
V_28 -> V_55 = ! ! F_144 ( V_64 [ V_355 ] ) ;
if ( V_64 [ V_356 ] )
V_26 -> V_74 = ! ! F_144 ( V_64 [ V_356 ] ) ;
if ( V_64 [ V_357 ] )
V_28 -> F_25 = ! ! F_144 ( V_64 [ V_357 ] ) ;
if ( V_64 [ V_358 ] )
V_28 -> V_30 = ! ! F_144 ( V_64 [ V_358 ] ) ;
if ( V_64 [ V_359 ] )
V_28 -> V_31 = ! ! F_144 ( V_64 [ V_359 ] ) ;
if ( V_64 [ V_360 ] )
V_26 -> V_128 = ! ! F_144 ( V_64 [ V_360 ] ) ;
if ( V_64 [ V_361 ] )
V_26 -> V_130 = F_144 ( V_64 [ V_361 ] ) ;
}
static int F_233 ( struct V_2 * V_3 , struct V_188 * V_362 [] ,
struct V_188 * V_64 [] )
{
if ( ! V_64 )
return 0 ;
...
static void F_235 ( struct V_2 * V_3 , struct V_367 * V_12 )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
struct V_2 * V_77 = V_76 -> V_77 ;
F_236 ( V_3 , V_12 ) ;
...
static void F_239 ( struct V_2 * V_3 , struct V_367 * V_12 )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
struct V_2 * V_77 = V_76 -> V_77 ;
struct V_4 * V_155 = F_5 ( V_77 ) ;
F_235 ( V_3 , V_12 ) ;
if ( F_240 ( & V_155 -> V_368 ) ) {
F_241 ( V_77 ) ;
F_12 ( V_155 ) ;
}
}
...
V_26 -> V_34 = V_34 ;
V_26 -> V_28 . V_9 = true ;
V_26 -> V_28 . V_60 = V_371 ;
V_26 -> V_28 . V_55 = V_372 ;
V_26 -> V_28 . F_25 = V_373 ;
V_26 -> V_28 . V_30 = false ;
V_26 -> V_28 . V_31 = false ;
return 0 ;
}
static int F_249 ( struct V_187 * V_187 , struct V_2 * V_3 ,
struct V_188 * V_362 [] , struct V_188 * V_64 [] )
{
struct V_1 * V_76 = F_1 ( V_3 ) ;
struct V_2 * V_77 ;
int V_96 ;
...
if ( ! V_362 [ V_375 ] )
return - V_112 ;
V_77 = F_137 ( V_187 , F_136 ( V_362 [ V_375 ] ) ) ;
if ( ! V_77 )
return - V_192 ;
V_3 -> V_347 |= V_376 ;
V_76 -> V_77 = V_77 ;
if ( V_64 && V_64 [ V_364 ] )
V_57 = F_144 ( V_64 [ V_364 ] ) ;
V_3 -> V_118 = V_77 -> V_118 - V_57 - F_30 ( true ) ;
V_374 = F_6 ( V_77 -> V_374 ) ;
if ( V_374 && V_374 != F_112 )
return - V_219 ;
V_96 = F_250 ( V_3 ) ;
if ( V_96 < 0 )
return V_96 ;
...
goto V_379;
if ( V_64 && V_64 [ V_365 ] )
V_34 = F_139 ( V_64 [ V_365 ] ) ;
else if ( V_64 && V_64 [ V_366 ] )
V_34 = F_247 ( V_3 , F_255 ( V_64 [ V_366 ] ) ) ;
else
V_34 = F_247 ( V_3 , V_42 ) ;
if ( V_374 && F_246 ( V_77 , V_34 ) ) {
V_96 = - V_219 ;
goto V_380;
}
...
static int F_257 ( struct V_188 * V_362 [] , struct V_188 * V_64 [] )
{
V_198 V_382 = V_271 ;
T_3 V_57 = V_58 ;
int V_383 ;
bool V_384 , V_31 , V_34 ;
if ( ! V_64 )
return 0 ;
if ( V_64 [ V_363 ] )
V_382 = F_140 ( V_64 [ V_363 ] ) ;
if ( V_64 [ V_364 ] ) {
V_57 = F_144 ( V_64 [ V_364 ] ) ;
if ( V_57 != V_58 ) {
char V_385 [ V_369 ] = { 0 } ;
...
V_383 ++ ) {
if ( V_64 [ V_383 ] ) {
if ( F_144 ( V_64 [ V_383 ] ) > 1 )
return - V_112 ;
}
}
V_384 = V_64 [ V_358 ] ? F_144 ( V_64 [ V_358 ] ) : false ;
V_34 = V_64 [ V_357 ] ? F_144 ( V_64 [ V_357 ] ) : false ;
V_31 = V_64 [ V_359 ] ? F_144 ( V_64 [ V_359 ] ) : false ;
if ( ( V_34 && ( V_31 || V_384 ) ) || ( V_31 && V_384 ) )
return - V_112 ;
if ( V_64 [ V_361 ] &&
F_144 ( V_64 [ V_361 ] ) > V_390 )
return - V_112 ;
if ( ( V_64 [ V_360 ] &&
F_144 ( V_64 [ V_360 ] ) ) &&
! V_64 [ V_354 ] )
...
struct V_27 * V_28 = & V_26 -> V_28 ;
if ( F_141 ( V_23 , V_365 , V_26 -> V_34 ,
V_391 ) ||
F_183 ( V_23 , V_364 , V_26 -> V_57 ) ||
F_142 ( V_23 , V_363 ,
V_271 , V_391 ) ||
F_183 ( V_23 , V_353 , V_28 -> V_60 ) ||
F_183 ( V_23 , V_355 , V_28 -> V_55 ) ||
F_183 ( V_23 , V_356 , V_26 -> V_74 ) ||
F_183 ( V_23 , V_357 , V_28 -> F_25 ) ||
F_183 ( V_23 , V_358 , V_28 -> V_30 ) ||
F_183 ( V_23 , V_359 , V_28 -> V_31 ) ||
F_183 ( V_23 , V_360 , V_26 -> V_128 ) ||
F_183 ( V_23 , V_361 , V_26 -> V_130 ) ||
0 )
goto V_295;
if ( V_26 -> V_128 ) {
if ( F_174 ( V_23 , V_354 , V_26 -> V_127 ) )
goto V_295;
}
return 0 ;
V_295:
...
{
return F_265 ( V_3 -> V_374 ) == F_112 ;
}
static int F_266 ( struct V_392 * V_393 , unsigned long V_394 ,
void * V_7 )
{
...
switch ( V_394 ) {
case V_396 : {
struct V_1 * V_397 , * V_398 ;
struct V_4 * V_155 ;
V_155 = F_5 ( V_77 ) ;
F_269 (m, n, &rxd->secys, secys) {
F_235 ( V_397 -> V_26 . V_150 , & V_12 ) ;
}
F_241 ( V_77 ) ;
F_12 ( V_155 ) ;
F_270 ( & V_12 ) ;
...
struct V_2 * V_3 = V_397 -> V_26 . V_150 ;
unsigned int V_118 = V_77 -> V_118 - ( V_397 -> V_26 . V_57 +
F_30 ( true ) ) ;
if ( V_3 -> V_118 > V_118 )
F_271 ( V_3 , V_118 ) ;
}
