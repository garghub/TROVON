...
if ( V_71 == NULL )
return - V_78 ;
V_79 . V_80 = F_31 ( ( 1 << V_73 ) * sizeof( struct V_74 * ) , V_77 ) ;
if ( V_79 . V_80 == NULL )
goto V_81;
V_72 = V_71 + ( ( V_82 * ( 1 << V_73 ) ) - 1 ) ;
...
V_48 -> V_42 = F_34 ( V_79 . V_80 , ( 1 << V_73 ) , 0 , V_84 ) ;
if ( V_48 -> V_42 == NULL )
goto V_81;
V_48 -> V_29 = F_35 ( V_71 ) ;
if ( V_20 )
...
F_40 ( V_74 ) ;
F_37 ( ( unsigned long ) V_48 -> V_83 , V_73 ) ;
return 0 ;
}
void F_41 ( void )
{
...
if ( V_92 == 0 )
return - V_67 ;
for ( V_93 = 0 ; V_88 [ V_93 ] . V_94 != NULL ; ++ V_93 ) {
if ( V_63 -> V_66 == V_88 [ V_93 ] . V_95 ) {
F_10 ( & V_63 -> V_11 , L_9 ,
V_88 [ V_93 ] . V_94 ) ;
goto V_96;
}
