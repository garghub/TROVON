...
V_2 -> V_68 = 0 ;
V_2 -> V_213 = F_92 ( & V_182 -> V_52 , L_18 ) ;
if ( F_15 ( V_2 -> V_213 ) ) {
V_162 = F_86 ( V_2 -> V_213 ) ;
goto V_193;
}
V_2 -> V_146 = F_92 ( & V_182 -> V_52 , L_19 ) ;
if ( F_15 ( V_2 -> V_146 ) ) {
...
V_11 -> V_218 = F_65 ( V_2 -> V_146 ) >> 16 ;
V_11 -> V_219 = F_65 ( V_2 -> V_146 ) >> 1 ;
F_12 ( V_2 , 0x2db4 , V_220 ) ;
F_7 ( V_2 , V_2 -> V_68 , V_84 ) ;
if ( ! V_2 -> V_17 ) {
V_2 -> V_50 = F_94 ( & V_182 -> V_52 , L_21 ) ;
} else {
V_184 = F_82 ( V_182 , V_221 , 0 ) ;
if ( V_184 ) {
V_2 -> V_222 = V_184 -> V_194 ;
V_2 -> V_180 . V_223 = V_224 ;
V_2 -> V_180 . V_225 = V_226 ;
V_2 -> V_180 . V_227 = V_2 -> V_222 ;
F_95 ( V_111 ) ;
F_96 ( V_228 , V_111 ) ;
...
goto V_229;
F_103 ( V_182 , V_11 ) ;
if ( V_2 -> V_17 && V_2 -> V_17 -> V_230 ) {
V_162 = V_2 -> V_17 -> V_230 ( & V_182 -> V_52 , F_70 ,
V_2 -> V_11 ) ;
if ( V_162 )
goto V_229;
}
