...
static void F_85 ( struct V_4 * V_6 )
{
F_86 ( V_6 -> V_93 ) ;
}
static int F_87 ( struct V_4 * V_6 )
{
F_6 ( V_6 , V_247 , 0 ) ;
F_6 ( V_6 , V_18 , V_122 ) ;
...
struct V_2 * V_3 = & V_43 -> V_3 ;
struct V_146 * V_147 = F_52 ( V_3 ) ;
struct V_250 * V_82 = V_6 -> V_82 ;
int V_74 ;
V_74 = F_89 ( V_249 , L_22 , & V_43 -> V_251 ) ;
if ( V_74 ) {
F_18 ( V_82 , L_23 ) ;
return - V_252 ;
}
F_90 ( V_3 , V_249 ) ;
V_147 -> V_253 = F_91 ( V_82 , V_75 , L_24 , V_43 -> V_251 ) ;
V_147 -> V_254 = V_255 ;
V_147 -> V_82 . V_256 = V_82 ;
V_3 -> V_198 = F_46 ;
V_3 -> V_257 = F_72 ;
V_3 -> V_258 = F_68 ;
V_3 -> V_259 = F_69 ;
...
V_3 -> V_262 = F_67 ;
V_3 -> V_5 = & V_6 -> V_5 ;
V_3 -> V_46 |= V_263 | V_264 |
V_265 ;
V_43 -> V_139 = V_205 | V_140 ;
V_74 = F_92 ( V_147 , 1 , NULL ) ;
if ( V_74 )
return V_74 ;
V_74 = F_75 ( V_43 ) ;
if ( V_74 )
...
if ( V_74 )
return V_74 ;
return F_94 ( V_147 , NULL , 0 ) ;
}
static int F_95 ( struct V_266 * V_267 )
{
struct V_4 * V_6 = F_96 ( V_267 ) ;
struct V_248 * V_268 = V_6 -> V_82 -> V_269 ;
int V_74 ;
V_74 = F_89 ( V_268 , L_25 , & V_6 -> V_92 ) ;
if ( V_74 ) {
F_18 ( V_6 -> V_82 , L_26 ) ;
return V_74 ;
}
V_74 = F_89 ( V_268 , L_27 , & V_6 -> V_89 ) ;
if ( V_74 ) {
F_18 ( V_6 -> V_82 , L_28 ) ;
return V_74 ;
}
...
static int F_97 ( struct V_266 * V_267 )
{
struct V_4 * V_6 ;
struct V_1 * V_43 ;
const void * V_270 ;
struct V_250 * V_82 = & V_267 -> V_82 ;
struct V_248 * V_249 = V_82 -> V_269 , * V_271 ;
struct V_272 * V_273 ;
int V_74 ;
V_6 = F_81 ( & V_267 -> V_82 , sizeof( * V_6 ) , V_75 ) ;
if ( ! V_6 )
return - V_76 ;
F_98 ( V_267 , V_6 ) ;
V_6 -> V_82 = V_82 ;
V_270 = F_99 ( V_82 ) ;
if ( ! V_270 ) {
F_18 ( & V_267 -> V_82 , L_29 ) ;
return - V_245 ;
}
V_6 -> V_221 = ( unsigned long ) V_270 ;
V_273 = F_100 ( V_267 , V_274 , 0 ) ;
V_6 -> V_8 = F_101 ( V_82 , V_273 ) ;
if ( F_102 ( V_6 -> V_8 ) )
return F_103 ( V_6 -> V_8 ) ;
V_6 -> V_87 = F_104 ( V_82 , ( V_275 ) V_273 -> V_276 ) ;
V_6 -> V_277 = F_105 ( V_82 , L_30 ) ;
if ( F_102 ( V_6 -> V_277 ) )
return F_103 ( V_6 -> V_277 ) ;
V_6 -> V_278 = F_105 ( V_82 , L_31 ) ;
if ( F_102 ( V_6 -> V_278 ) )
return F_103 ( V_6 -> V_278 ) ;
V_74 = F_95 ( V_267 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_78 ( V_6 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_106 ( V_6 -> V_277 ) ;
if ( V_74 )
goto V_279;
V_74 = F_106 ( V_6 -> V_278 ) ;
if ( V_74 )
goto V_280;
V_74 = F_87 ( V_6 ) ;
if ( V_74 )
...
static int F_114 ( struct V_266 * V_267 )
{
struct V_4 * V_6 = F_96 ( V_267 ) ;
struct V_1 * V_43 ;
F_34 (host, &nandc->host_list, node)
