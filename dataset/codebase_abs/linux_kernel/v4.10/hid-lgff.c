...
const signed short * V_37 = V_38 ;
int error ;
int V_39 ;
if ( ! F_9 ( V_7 , V_11 , 0 , 0 , 7 ) )
return - V_40 ;
for ( V_39 = 0 ; V_39 < F_10 ( V_41 ) ; V_39 ++ ) {
if ( V_2 -> V_42 . V_43 == V_41 [ V_39 ] . V_44 &&
V_2 -> V_42 . V_45 == V_41 [ V_39 ] . V_46 ) {
V_37 = V_41 [ V_39 ] . V_47 ;
break;
}
}
for ( V_39 = 0 ; V_37 [ V_39 ] >= 0 ; V_39 ++ )
F_11 ( V_37 [ V_39 ] , V_2 -> V_48 ) ;
error = F_12 ( V_2 , NULL , F_1 ) ;
if ( error )
return error ;
if ( F_13 ( V_49 , V_2 -> V_48 ) )
V_2 -> V_47 -> V_50 = F_7 ;
F_14 ( L_3 ) ;
return 0 ;
}
