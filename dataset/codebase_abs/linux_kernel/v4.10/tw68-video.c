...
V_3 -> V_130 = V_129 ;
V_3 -> type = V_132 ;
snprintf ( V_3 -> V_133 , sizeof( V_3 -> V_133 ) , L_10 , V_129 ) ;
if ( V_129 == V_7 -> V_134 ) {
...
{
struct V_6 * V_7 = F_43 ( V_116 ) ;
strcpy ( V_149 -> V_150 , L_11 ) ;
F_52 ( V_149 -> V_151 , L_12 ,
sizeof( V_149 -> V_151 ) ) ;
sprintf ( V_149 -> V_152 , L_13 , F_53 ( V_7 -> V_87 ) ) ;
V_149 -> V_153 =
V_154 |
V_155 |
V_156 ;
...
V_166 = line ;
V_166 += sprintf ( V_166 , L_15 , V_3 ) ;
for ( V_164 = V_3 ; V_164 < V_3 + 16 ; V_164 += 4 )
V_166 += sprintf ( V_166 , L_16 , F_60 ( V_164 ) ) ;
* V_166 ++ = ' ' ;
...
while ( V_3 < 0x400 ) {
V_166 = line ;
V_166 += sprintf ( V_166 , L_18 , V_3 ) ;
for ( V_164 = 0 ; V_164 < 4 ; V_164 ++ ) {
for ( V_165 = 0 ; V_165 < 4 ; V_165 ++ ) {
V_166 += sprintf ( V_166 , L_19 ,
F_47 ( V_3 ) ) ;
V_3 += 4 ;
}
* V_166 ++ = ' ' ;
...
F_79 ( & V_7 -> V_87 -> V_7 , L_20 ) ;
if ( V_139 & V_207 )
F_80 ( & V_7 -> V_87 -> V_7 , L_21 ) ;
if ( V_139 & V_208 )
F_80 ( & V_7 -> V_87 -> V_7 , L_22 ) ;
if ( V_139 & V_209 )
F_79 ( & V_7 -> V_87 -> V_7 , L_23 ) ;
if ( V_139 & V_210 ) {
