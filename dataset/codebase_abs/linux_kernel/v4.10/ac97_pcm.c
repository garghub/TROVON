...
static int F_27 ( struct V_134 * V_135 ,
struct V_136 * V_137 )
{
struct V_138 * V_139 = F_28 ( V_135 , V_140 ) ;
if ( V_139 -> V_141 > 2 ) {
static const struct V_138 V_142 = {
. V_141 = 1 ,
. V_143 = 48000 ,
} ;
struct V_138 * V_16 = F_28 ( V_135 , V_144 ) ;
return F_29 ( V_16 , & V_142 ) ;
}
return 0 ;
}
static int F_30 ( struct V_134 * V_135 ,
struct V_136 * V_137 )
{
struct V_138 * V_16 = F_28 ( V_135 , V_144 ) ;
if ( V_16 -> V_141 > 48000 ) {
static const struct V_138 V_145 = {
. V_141 = 2 ,
. V_143 = 2 ,
} ;
struct V_138 * V_139 = F_28 ( V_135 , V_140 ) ;
return F_29 ( V_139 , & V_145 ) ;
}
return 0 ;
}
int F_31 ( struct V_146 * V_147 )
{
int V_124 ;
V_124 = F_32 ( V_147 , 0 , V_144 ,
F_27 , NULL ,
V_140 , - 1 ) ;
if ( V_124 < 0 )
return V_124 ;
V_124 = F_32 ( V_147 , 0 , V_140 ,
F_30 , NULL ,
V_144 , - 1 ) ;
return V_124 ;
}
