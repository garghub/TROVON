...
int V_155 = F_15 ( V_33 -> V_35 , V_36 + V_37 . V_38 ,
V_154 , V_37 . V_39 , V_40 ) ;
if ( V_155 )
return 0 ;
if ( V_154 [ V_25 ] )
...
if ( F_30 ( V_47 , V_10 , V_208 -> V_19 ) )
goto V_107;
V_299 = F_26 ( V_47 , V_300 ) ;
if ( ! V_299 )
goto V_107;
if ( F_30 ( V_47 , V_301 ,
V_298 -> V_205 ) ||
F_53 ( V_47 , V_302 , V_298 -> V_178 ) ||
F_53 ( V_47 , V_303 ,
V_298 -> V_182 ) ||
F_54 ( V_47 , V_304 ,
V_298 -> V_305 , V_306 ) ||
...
struct V_297 * V_208 )
{
struct V_4 * V_5 [ V_312 + 1 ] ;
if ( ! V_260 || F_107 ( V_5 , V_312 , V_260 ,
V_313 ) )
return - V_16 ;
...
! V_5 [ V_309 ] )
return - V_16 ;
V_208 -> V_205 = F_4 ( V_5 [ V_301 ] ) ;
V_208 -> V_178 = F_84 ( V_5 [ V_302 ] ) ;
V_208 -> V_182 = F_84 ( V_5 [ V_303 ] ) ;
V_208 -> V_305 = F_67 ( V_5 [ V_304 ] ) ;
V_208 -> V_308 = F_73 ( V_5 [ V_307 ] ) ;
V_208 -> V_310 = F_4 ( V_5 [ V_309 ] ) ;
if ( V_208 -> V_310 > V_314 ||
( V_208 -> V_308 != 0 && V_208 -> V_308 != 1 ) )
return - V_16 ;
return 0 ;
}
...
struct V_1 * V_1 = V_208 -> V_27 ;
struct V_297 V_298 ;
if ( F_126 ( V_29 -> V_5 [ V_300 ] ,
& V_298 ) < 0 )
return - V_16 ;
return F_128 ( V_7 , V_1 , & V_298 ) ;
}
...
{
void * V_103 ;
struct V_4 * V_317 , * V_197 ;
V_103 = F_23 ( V_47 , V_43 , V_44 , V_45 , V_46 ) ;
if ( ! V_103 )
return - 1 ;
if ( F_30 ( V_47 , V_10 , V_208 -> V_19 ) )
goto V_107;
V_317 = F_26 ( V_47 , V_318 ) ;
if ( ! V_317 )
goto V_107;
if ( F_54 ( V_47 , V_319 ,
V_185 , V_320 ) ||
...
V_316 -> V_205 ) )
goto V_107;
V_197 = F_26 ( V_47 , V_322 ) ;
if ( ! V_197 )
goto V_107;
if ( F_52 ( V_47 , & V_316 -> V_323 ) < 0 )
goto V_107;
F_28 ( V_47 , V_197 ) ;
F_28 ( V_47 , V_317 ) ;
F_39 ( V_47 , V_103 ) ;
...
& V_274 . V_323 ) < 0 )
return - V_52 ;
V_274 . V_205 = F_4 ( V_5 [ V_321 ] ) ;
V_185 = F_67 ( V_5 [ V_319 ] ) ;
...
if ( F_30 ( V_47 , V_10 , V_208 -> V_19 ) )
goto V_107;
V_330 = F_26 ( V_47 , V_331 ) ;
if ( ! V_330 )
goto V_107;
if ( F_30 ( V_47 , V_332 , V_329 -> V_333 ) ||
F_30 ( V_47 , V_334 , V_329 -> V_335 ) ||
F_33 ( V_47 , V_336 ,
V_329 -> V_337 ) )
goto V_107;
if ( V_329 -> V_333 == V_282 ) {
if ( F_30 ( V_47 , V_338 ,
V_329 -> V_339 ) )
goto V_107;
}
...
static int
F_139 ( struct V_4 * V_260 , struct V_328 * V_329 )
{
struct V_4 * V_5 [ V_340 + 1 ] ;
if ( ! V_260 || F_107 ( V_5 , V_340 , V_260 ,
V_341 ) )
return - V_16 ;
...
! V_5 [ V_336 ] )
return - V_16 ;
V_329 -> V_335 = F_73 ( V_5 [ V_334 ] ) ;
V_329 -> V_333 = F_4 ( V_5 [ V_332 ] ) ;
V_329 -> V_337 = F_73 ( V_5 [ V_336 ] ) ;
if ( V_329 -> V_333 > V_295 ||
( V_329 -> V_337 != 0 && V_329 -> V_337 != 1 ) )
return - V_16 ;
if ( V_329 -> V_333 == V_282 ) {
if ( ! V_5 [ V_338 ] )
return - V_16 ;
V_329 -> V_339 = F_4 ( V_5 [ V_338 ] ) ;
if ( V_329 -> V_339 > V_296 )
return - V_16 ;
}
return 0 ;
}
...
struct V_1 * V_1 = V_208 -> V_27 ;
struct V_328 V_329 ;
if ( F_139 ( V_29 -> V_5 [ V_331 ] ,
& V_329 ) < 0 )
return - V_16 ;
return F_141 ( V_7 , V_1 , & V_329 ) ;
}
...
struct V_328 V_329 ;
if ( ! V_29 -> V_5 [ V_331 ] ||
F_139 ( V_29 -> V_5 [ V_331 ] ,
& V_329 ) < 0 )
return - V_16 ;
return F_143 ( V_7 , V_1 , & V_329 ) ;
}
static int F_144 ( const struct V_342 * V_239 , struct V_30 * V_31 ,
struct V_28 * V_29 )
{
struct V_6 * V_7 ;
struct V_1 * V_1 ;
struct V_24 * V_208 ;
bool V_343 = V_239 -> V_344 & V_345 ;
if ( V_343 )
F_14 () ;
if ( V_239 -> V_344 & V_346 ) {
...
static void F_147 ( const struct V_342 * V_239 , struct V_30 * V_31 ,
struct V_28 * V_29 )
{
if ( V_29 -> V_166 [ 1 ] ) {
if ( V_239 -> V_344 & V_348 ) {
struct V_1 * V_1 = V_29 -> V_166 [ 1 ] ;
if ( V_1 -> V_18 )
F_148 ( V_1 -> V_18 ) ;
} else {
