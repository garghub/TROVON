...
int F_170 ( const char * V_282 , const char * V_283 )
{
if ( ! strcmp ( V_282 , L_6 ) )
return F_169 ( NULL , V_283 , 0 ) ;
return 0 ;
}
int F_171 ( struct V_1 * V_1 , struct V_218 * V_197 )
{
...
V_1 -> V_108 = V_123 ;
V_1 -> V_68 = V_123 ;
F_172 ( & V_1 -> V_223 , NULL ) ;
V_1 -> V_260 = - 1 ;
V_1 -> V_197 = V_197 ;
F_33 ( & V_1 -> V_284 ) ;
return 0 ;
}
static void F_173 ( struct V_102 * V_217 )
{
struct V_66 * V_100 ;
struct V_14 * V_87 ;
while ( ! F_174 ( V_217 ) ) {
...
int F_181 ( void )
{
int V_130 = F_182 ( sizeof( struct V_286 ) ,
F_180 ,
F_176 ) ;
if ( V_130 )
fputs ( L_7 , V_287 ) ;
