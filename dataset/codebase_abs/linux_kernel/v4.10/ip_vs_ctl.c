...
static int T_12 F_256 ( struct V_14 * V_15 )
{
...
F_99 ( & V_15 -> V_33 ) ;
if ( ! F_257 ( V_2 , & V_462 ) ) {
V_461 = F_258 ( V_463 , sizeof( V_463 ) , V_147 ) ;
if ( V_461 == NULL )
return - V_148 ;
if ( V_2 -> V_267 != & V_464 )
V_461 [ 0 ] . V_465 = NULL ;
...
V_461 = V_463 ;
for ( V_193 = 0 ; V_193 < F_259 ( V_463 ) ; V_193 ++ ) {
if ( V_461 [ V_193 ] . V_466 == F_143 )
V_461 [ V_193 ] . V_213 = V_15 ;
}
V_193 = 0 ;
V_15 -> V_24 = 1024 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_24 ;
V_15 -> V_32 = 10 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_32 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_26 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_29 ;
#ifdef F_260
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_467 ;
#endif
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_34 ;
V_15 -> V_468 = 1 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_468 ;
V_15 -> V_469 = 1 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_469 ;
V_15 -> V_470 = 1 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_470 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_471 ;
V_15 -> V_472 = F_261 () / 32 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_472 ;
V_15 -> V_473 = 0 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_473 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_474 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_475 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_476 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_477 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_478 ;
V_15 -> V_479 [ 0 ] = V_480 ;
V_15 -> V_479 [ 1 ] = V_481 ;
V_461 [ V_193 ] . V_167 = & V_15 -> V_479 ;
V_461 [ V_193 ++ ] . V_482 = sizeof( V_15 -> V_479 ) ;
V_15 -> V_483 = V_484 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_483 ;
V_15 -> V_485 = F_262 ( int , V_486 , 0 , 3 ) ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_485 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_487 ;
V_15 -> V_488 = 1 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_488 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_489 ;
V_15 -> V_490 = 1 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_490 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_491 ;
V_461 [ V_193 ++ ] . V_167 = & V_15 -> V_492 ;
V_15 -> V_493 = F_263 ( V_2 , L_61 , V_461 ) ;
if ( V_15 -> V_493 == NULL ) {
if ( ! F_257 ( V_2 , & V_462 ) )
F_47 ( V_461 ) ;
return - V_148 ;
...
V_15 -> V_494 = V_461 ;
F_264 ( & V_15 -> V_37 , F_13 ) ;
F_17 ( & V_15 -> V_37 , V_38 ) ;
return 0 ;
}
static void T_13 F_265 ( struct V_14 * V_15 )
{
struct V_2 * V_2 = V_15 -> V_2 ;
F_266 ( & V_15 -> V_37 ) ;
F_267 ( & V_15 -> V_37 . V_36 ) ;
F_268 ( V_15 -> V_493 ) ;
F_105 ( V_15 , & V_15 -> V_206 ) ;
if ( ! F_257 ( V_2 , & V_462 ) )
F_47 ( V_15 -> V_494 ) ;
}
static int T_12 F_256 ( struct V_14 * V_15 ) { return 0 ; }
static void T_13 F_265 ( struct V_14 * V_15 ) { }
int T_12 F_269 ( struct V_14 * V_15 )
{
int V_17 , V_193 ;
for ( V_193 = 0 ; V_193 < V_495 ; V_193 ++ )
F_270 ( & V_15 -> V_85 [ V_193 ] ) ;
F_120 ( & V_15 -> V_161 ) ;
F_99 ( & V_15 -> V_96 ) ;
F_271 ( & V_15 -> V_99 , F_113 ,
( unsigned long ) V_15 ) ;
F_9 ( & V_15 -> V_69 , 0 ) ;
F_9 ( & V_15 -> V_73 , 0 ) ;
F_9 ( & V_15 -> V_185 , 0 ) ;
...
F_94 (i) {
struct V_149 * V_496 ;
V_496 = F_95 ( V_15 -> V_206 . V_77 , V_17 ) ;
F_96 ( & V_496 -> V_152 ) ;
}
F_99 ( & V_15 -> V_206 . V_103 ) ;
F_272 ( L_62 , 0 , V_15 -> V_2 -> V_497 , & V_498 ) ;
F_272 ( L_63 , 0 , V_15 -> V_2 -> V_497 , & V_499 ) ;
F_272 ( L_64 , 0 , V_15 -> V_2 -> V_497 ,
& V_500 ) ;
if ( F_256 ( V_15 ) )
goto V_501;
return 0 ;
...
void T_13 F_273 ( struct V_14 * V_15 )
{
F_74 ( V_15 ) ;
F_265 ( V_15 ) ;
F_274 ( L_64 , V_15 -> V_2 -> V_497 ) ;
F_274 ( L_63 , V_15 -> V_2 -> V_497 ) ;
F_274 ( L_62 , V_15 -> V_2 -> V_497 ) ;
F_46 ( V_15 -> V_206 . V_77 ) ;
}
int T_11 F_275 ( void )
{
