...
F_68 ( V_17 , V_80 , V_79 , 0 , 0 , F_67 ( V_80 , NULL ) ) ;
F_69 ( V_26 ) ;
return 0 ;
}
...
goto error;
V_26 -> V_18 = V_2 ;
V_15 = F_76 ( V_2 , V_26 -> V_2 -> V_95 ,
( V_26 -> V_2 -> V_96 + 7 ) / 8 ) ;
if ( V_15 )
goto error;
V_15 = F_77 ( V_2 , V_26 -> V_2 -> V_97 / 8 ) ;
if ( V_15 )
goto error;
error:
return V_15 ;
...
( V_26 -> V_106 -> V_96 + 7 ) / 8 + F_79 ( sizeof( * V_99 ) ) ;
V_15 = - V_46 ;
...
V_99 -> V_119 = F_85 ( ( V_26 -> V_106 -> V_96 + 7 ) / 8 ) ;
memcpy ( V_103 , V_26 -> V_106 -> V_95 , ( V_26 -> V_106 -> V_96 + 7 ) / 8 ) ;
V_15 = F_76 ( V_2 , V_102 , V_105 ) ;
V_117:
F_16 ( V_102 ) ;
error:
return V_15 ;
...
static int F_87 ( struct V_16 * V_17 , int V_15 )
{
return 0 ;
}
static int T_5 F_88 ( void )
{
if ( F_89 ( & V_129 , V_88 ) < 0 ) {
F_84 ( L_10 , V_130 ) ;
return - V_131 ;
}
if ( F_90 ( & V_132 , V_48 ) < 0 ) {
F_84 ( L_11 , V_130 ) ;
F_91 ( & V_129 , V_88 ) ;
return - V_131 ;
}
...
{
if ( F_93 ( & V_132 , V_48 ) < 0 )
F_84 ( L_12 , V_130 ) ;
if ( F_91 ( & V_129 , V_88 ) < 0 )
F_84 ( L_13 , V_130 ) ;
}
