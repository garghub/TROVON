...
if ( ! ( V_90 -> V_151 & V_152 ) )
return;
F_109 ( & V_15 -> V_49 . V_50 . V_153 ) ;
if ( ! ( V_90 -> V_151 & V_152 ) )
goto V_154;
V_150 = V_90 -> V_151 >> V_155 ;
if ( F_110 ( F_111 ( V_15 , F_112 ( V_150 ) ,
& V_149 , sizeof( V_149 ) ) ) )
goto V_154;
V_90 -> V_92 . V_93 = 0 ;
if ( F_113 ( V_15 , F_112 ( V_150 ) ,
& V_90 -> V_92 , sizeof( V_90 -> V_92 . V_93 ) ) )
goto V_154;
if ( ! F_103 ( V_141 , & V_90 -> V_92 ) )
goto V_154;
F_114 () ;
if ( F_113 ( V_15 , F_112 ( V_150 ) , & V_90 -> V_92 , sizeof( V_90 -> V_92 ) ) )
goto V_154;
V_149 ++ ;
...
F_113 ( V_15 , F_112 ( V_150 ) ,
& V_90 -> V_92 , sizeof( V_90 -> V_92 . V_93 ) ) ;
V_154:
F_115 ( & V_15 -> V_49 . V_50 . V_153 ) ;
}
static int F_116 ( struct V_17 * V_18 , T_2 V_48 , T_1 V_10 ,
bool V_11 )
{
struct V_15 * V_15 = V_18 -> V_15 ;
struct V_89 * V_90 = & V_15 -> V_49 . V_50 ;
...
V_150 = V_10 >> V_161 ;
V_159 = F_117 ( V_15 , V_150 ) ;
if ( F_118 ( V_159 ) )
return 1 ;
V_162 -> V_163 ( V_18 , V_160 ) ;
( ( unsigned char * ) V_160 ) [ 3 ] = 0xc3 ;
if ( F_119 ( ( void V_164 * ) V_159 , V_160 , 4 ) )
return 1 ;
V_90 -> V_157 = V_10 ;
F_120 ( V_15 , V_150 ) ;
break;
...
static T_1 F_122 ( void )
{
T_7 V_167 , V_168 ;
F_123 ( V_169 , & V_167 , & V_168 ) ;
return F_53 ( F_124 ( V_167 + V_168 ) , 100 ) ;
}
static int F_125 ( struct V_17 * V_18 , T_2 V_48 , T_1 V_10 , bool V_11 )
{
...
V_150 = V_10 >> V_173 ;
V_159 = F_127 ( V_18 , V_150 ) ;
if ( F_118 ( V_159 ) )
return 1 ;
if ( F_128 ( ( void V_164 * ) V_159 , V_62 ) )
return 1 ;
V_90 -> V_172 = V_10 ;
F_24 ( V_18 , V_150 ) ;
if ( F_126 ( V_18 ,
...
case V_175 :
return F_129 ( V_18 , V_176 , V_10 ) ;
case V_177 :
return F_129 ( V_18 , V_178 , V_10 ) ;
case V_179 :
return F_129 ( V_18 , V_180 , V_10 ) ;
case V_181 :
if ( ! V_11 )
return 1 ;
V_90 -> V_182 = V_10 - F_122 () ;
break;
case V_57 :
case V_58 :
case V_60 :
...
case V_185 :
case V_186 : {
int V_124 = ( V_48 - V_183 ) / 2 ;
return F_75 ( F_130 ( V_18 , V_124 ) ,
V_10 , V_11 ) ;
}
case V_187 :
case V_188 :
case V_189 :
case V_190 : {
int V_124 = ( V_48 - V_187 ) / 2 ;
return F_77 ( F_130 ( V_18 , V_124 ) ,
V_10 , V_11 ) ;
}
default:
F_121 ( V_18 , L_4 ,
...
static int F_131 ( struct V_17 * V_18 , T_2 V_48 , T_1 * V_67 )
{
T_1 V_10 = 0 ;
struct V_15 * V_15 = V_18 -> V_15 ;
struct V_89 * V_90 = & V_15 -> V_49 . V_50 ;
...
static int F_132 ( struct V_17 * V_18 , T_2 V_48 , T_1 * V_67 )
{
T_1 V_10 = 0 ;
struct V_33 * V_90 = & V_18 -> V_49 . V_50 ;
switch ( V_48 ) {
...
case V_175 :
return F_134 ( V_18 , V_176 , V_67 ) ;
case V_177 :
return F_134 ( V_18 , V_178 , V_67 ) ;
case V_179 :
return F_134 ( V_18 , V_180 , V_67 ) ;
case V_170 :
V_10 = V_90 -> V_172 ;
break;
case V_181 :
V_10 = F_122 () + V_90 -> V_182 ;
break;
case V_57 :
case V_58 :
case V_60 :
...
int F_135 ( struct V_17 * V_18 , T_2 V_48 , T_1 V_10 , bool V_11 )
{
if ( F_96 ( V_48 ) ) {
int V_113 ;
F_109 ( & V_18 -> V_15 -> V_49 . V_50 . V_153 ) ;
V_113 = F_116 ( V_18 , V_48 , V_10 , V_11 ) ;
F_115 ( & V_18 -> V_15 -> V_49 . V_50 . V_153 ) ;
return V_113 ;
} else
return F_125 ( V_18 , V_48 , V_10 , V_11 ) ;
}
...
int V_113 ;
F_109 ( & V_18 -> V_15 -> V_49 . V_50 . V_153 ) ;
V_113 = F_131 ( V_18 , V_48 , V_67 ) ;
F_115 ( & V_18 -> V_15 -> V_49 . V_50 . V_153 ) ;
return V_113 ;
} else
return F_132 ( V_18 , V_48 , V_67 ) ;
}
bool F_137 ( struct V_15 * V_15 )
{
return F_138 ( V_15 -> V_49 . V_50 . V_157 ) & V_158 ;
}
static void F_139 ( struct V_17 * V_18 , T_1 V_193 )
{
bool V_194 ;
V_194 = F_140 ( V_18 ) ;
if ( V_194 )
F_141 ( V_18 , V_195 , V_193 ) ;
else {
F_141 ( V_18 , V_196 , V_193 >> 32 ) ;
F_141 ( V_18 , V_195 , V_193 & 0xffffffff ) ;
}
}
static int F_142 ( struct V_17 * V_18 )
{
struct V_197 * V_198 = V_18 -> V_198 ;
F_139 ( V_18 , V_198 -> V_50 . V_52 . V_199 . V_193 ) ;
return 1 ;
}
int F_143 ( struct V_17 * V_18 )
{
T_1 V_200 , V_201 , V_202 , V_56 ;
T_8 V_203 , V_204 , V_205 , V_206 = V_207 , V_208 = 0 ;
bool V_209 , V_194 ;
if ( V_162 -> V_210 ( V_18 ) != 0 || ! F_144 ( V_18 ) ) {
F_145 ( V_18 , V_211 ) ;
return 1 ;
}
V_194 = F_140 ( V_18 ) ;
if ( ! V_194 ) {
V_200 = ( ( T_1 ) F_146 ( V_18 , V_196 ) << 32 ) |
( F_146 ( V_18 , V_195 ) & 0xffffffff ) ;
V_201 = ( ( T_1 ) F_146 ( V_18 , V_212 ) << 32 ) |
( F_146 ( V_18 , V_213 ) & 0xffffffff ) ;
V_202 = ( ( T_1 ) F_146 ( V_18 , V_214 ) << 32 ) |
( F_146 ( V_18 , V_215 ) & 0xffffffff ) ;
}
#ifdef F_147
else {
V_200 = F_146 ( V_18 , V_213 ) ;
V_201 = F_146 ( V_18 , V_196 ) ;
V_202 = F_146 ( V_18 , V_216 ) ;
}
#endif
V_203 = V_200 & 0xffff ;
V_209 = ( V_200 >> 16 ) & 0x1 ;
V_205 = ( V_200 >> 32 ) & 0xfff ;
V_204 = ( V_200 >> 48 ) & 0xfff ;
F_148 ( V_203 , V_209 , V_205 , V_204 , V_201 , V_202 ) ;
if ( V_205 || V_204 ) {
V_206 = V_217 ;
goto V_218;
}
...
V_18 -> V_198 -> V_222 = V_223 ;
V_18 -> V_198 -> V_50 . type = V_224 ;
V_18 -> V_198 -> V_50 . V_52 . V_199 . V_225 = V_200 ;
V_18 -> V_198 -> V_50 . V_52 . V_199 . V_226 [ 0 ] = V_201 ;
V_18 -> V_198 -> V_50 . V_52 . V_199 . V_226 [ 1 ] = V_202 ;
V_18 -> V_49 . V_227 =
F_142 ;
return 0 ;
default:
