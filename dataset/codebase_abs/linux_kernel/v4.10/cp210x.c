...
struct V_1 * V_2 = F_47 ( V_134 ) ;
struct V_136 * V_137 = F_48 ( V_2 ) ;
if ( ( V_151 == V_152 ) && ( V_137 -> V_153 & F_50 ( V_143 ) ) )
return 0 ;
if ( ( V_151 == V_154 ) && ! ( V_137 -> V_153 & F_50 ( V_143 ) ) )
return 0 ;
return - V_149 ;
}
...
return 0 ;
V_137 -> V_138 = V_138 . V_163 ;
V_137 -> V_153 = ( T_1 ) ( ( F_12 ( V_138 . V_153 ) &
V_164 ) >>
V_165 ) ;
V_137 -> V_134 . V_166 = 2 ;
} else if ( V_157 == 1 ) {
if ( V_151 . V_167 == V_162 )
return 0 ;
V_137 -> V_138 = V_138 . V_168 ;
V_137 -> V_153 = ( T_1 ) ( ( F_12 ( V_138 . V_153 ) &
V_169 ) >>
V_170 ) ;
V_137 -> V_134 . V_166 = 3 ;
...
V_137 -> V_134 . V_171 = L_39 ;
V_137 -> V_134 . V_172 = F_46 ;
V_137 -> V_134 . V_173 = F_52 ;
V_137 -> V_134 . V_174 = F_53 ;
V_137 -> V_134 . V_175 = F_54 ;
V_137 -> V_134 . V_176 = F_49 ;
V_137 -> V_134 . V_107 = F_51 ;
V_137 -> V_134 . V_177 = F_55 ;
V_137 -> V_134 . V_178 = V_179 ;
V_137 -> V_134 . V_180 = & V_2 -> V_5 -> V_19 ;
V_137 -> V_134 . V_181 = - 1 ;
V_137 -> V_134 . V_182 = true ;
V_16 = F_57 ( & V_137 -> V_134 , V_2 ) ;
if ( ! V_16 )
V_137 -> V_183 = true ;
return V_16 ;
}
