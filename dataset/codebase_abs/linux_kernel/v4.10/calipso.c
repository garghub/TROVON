...
struct V_136 * V_137 ;
struct V_103 * V_142 ;
T_1 V_143 , V_90 = 0 , V_115 = 0 , V_124 , V_13 , V_92 ;
if ( ! F_89 ( V_70 ) )
return 0 ;
...
return V_33 ;
V_137 = F_90 ( V_70 ) ;
V_142 = (struct V_103 * ) ( V_137 + 1 ) ;
V_143 = F_67 ( V_142 ) ;
V_33 = F_74 ( V_142 , & V_90 , & V_115 ) ;
if ( V_33 )
return V_33 ;
if ( V_90 == sizeof( * V_142 ) && V_115 == V_143 ) {
V_124 = V_143 ;
V_13 = sizeof( * V_137 ) ;
V_137 -> V_122 = V_142 -> V_122 ;
} else {
V_124 = ( V_115 - V_90 ) & ~ 7 ;
if ( V_124 )
V_142 -> V_123 -= V_124 / 8 ;
...
F_59 ( ( unsigned char * ) V_142 , V_90 , V_92 ) ;
}
if ( V_124 ) {
F_96 ( V_70 , V_124 ) ;
