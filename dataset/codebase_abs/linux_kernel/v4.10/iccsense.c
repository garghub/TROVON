...
switch( V_3 ) {
case 0x10 :
V_21 -> V_29 = F_3 ( V_2 , V_18 + 0x1 ) ;
V_21 -> V_30 = F_3 ( V_2 , V_18 + 0x2 ) ;
V_27 = 0x3 ;
break;
case 0x20 :
V_21 -> V_29 = F_3 ( V_2 , V_18 ) ;
V_21 -> V_30 = F_3 ( V_2 , V_18 + 0x1 ) ;
V_27 = 0x5 ;
break;
} ;
if ( F_7 ( V_2 , V_21 -> V_30 , & V_26 ) )
continue;
switch ( V_26 . type ) {
case V_31 :
case V_32 :
...
V_21 -> V_35 [ V_28 ] . V_36 = F_3 ( V_2 , V_18 + V_27 + V_28 * 2 ) ;
V_21 -> V_35 [ V_28 ] . V_37 = ! ( F_3 ( V_2 , V_18 + V_27 + V_28 * 2 + 1 ) & 0x40 ) ;
}
V_21 -> V_38 = F_8 ( V_2 , V_18 + V_27 + V_21 -> V_33 * 2 ) ;
}
return 0 ;
}
