...
if ( ! V_41 -> V_48 )
continue;
if ( V_41 -> V_49 . V_50 != V_24 )
continue;
V_38 = V_41 -> V_49 . V_51 ;
if ( V_38 == V_25 || V_38 == V_52 )
continue;
V_44 = F_29 ( V_41 ) ;
if ( ! V_44 || ! V_44 -> V_53 )
continue;
...
int F_36 ( unsigned int V_39 , const struct V_60 * V_60 ,
unsigned int V_61 )
{
if ( ! V_62 )
return V_9 ;
if ( ! F_37 ( V_63 , V_60 ) ) {
int V_45 = F_38 ( V_64 , V_60 ) ;
if ( V_45 < V_65 )
return F_4 ( V_45 ) ;
if ( V_61 )
return - 1 ;
...
static int F_40 ( struct V_67 * V_68 , struct V_3 * V_69 ,
enum V_70 V_71 )
{
struct V_21 * V_21 ;
F_17 (ics, &ics_list, link)
...
static void F_41 ( struct V_49 * V_73 ) { }
static void F_42 ( struct V_49 * V_73 ) { }
static int F_43 ( struct V_67 * V_68 , unsigned int V_39 ,
T_4 V_74 )
{
struct V_21 * V_21 ;
F_5 ( L_9 , V_39 , V_74 ) ;
...
static int F_46 ( struct V_67 * V_68 , struct V_3 * V_80 ,
...
int F_47 ( struct V_49 * V_73 , unsigned int V_87 )
{
