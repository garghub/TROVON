...
static long F_44 ( struct V_61 * V_62 )
{
struct V_19 * V_20 , * V_33 ;
struct V_18 * V_21 , * V_37 ;
struct V_63 V_64 ;
...
static void F_61 ( int V_108 [ V_101 ] )
{
struct V_19 * V_20 ;
struct V_18 * V_21 ;
...
static long F_65 ( struct V_10 * V_11 , unsigned long V_110 )
{
struct V_111 * V_112 ;
int V_113 ;
V_112 = F_66 ( sizeof( * V_112 ) , V_84 ) ;
if ( ! V_112 )
return - V_85 ;
V_112 -> V_114 = V_115 ;
V_112 -> V_116 = F_64 ( V_117 ) ;
V_112 -> V_118 = F_64 ( V_119 ) ;
V_112 -> V_120 = F_63 () ;
V_112 -> V_121 = F_62 () ;
...
F_60 ( V_112 -> V_104 ) ;
V_113 = 0 ;
if ( F_67 ( ( void T_2 * ) V_110 , V_112 , sizeof( * V_112 ) ) )
V_113 = - V_87 ;
F_55 ( V_112 ) ;
return V_113 ;
}
static long F_68 ( struct V_10 * V_11 , unsigned int V_124 ,
unsigned long V_110 )
{
int V_42 ;
switch ( V_124 ) {
...
if ( V_42 )
return V_42 ;
return F_69 ( V_39 . V_45 , & V_126 -> V_45 ) ;
}
case V_128 : {
...
if ( V_42 )
return V_42 ;
return F_69 ( V_58 . V_45 , & V_129 -> V_45 ) ;
}
case V_130 : {
...
if ( F_67 ( V_131 , & V_62 , sizeof( V_62 ) ) )
return - V_87 ;
return V_42 ;
}
case V_132 : {
...
if ( F_67 ( V_133 , & V_80 , sizeof( V_80 ) ) )
return - V_87 ;
return V_42 ;
}
case V_134 : {
struct V_93 * V_135 ;
V_135 = F_66 ( sizeof( struct V_93 ) ,
V_84 ) ;
if ( ! V_135 )
return - V_85 ;
F_58 ( V_135 ) ;
if ( F_67 ( ( char T_2 * ) V_110 , V_135 ,
sizeof( struct V_93 ) ) ) {
F_55 ( V_135 ) ;
return - V_87 ;
}
...
int V_108 [ V_101 ] ;
F_61 ( V_108 ) ;
if ( F_67 ( ( int T_2 * ) V_110 , V_108 ,
sizeof( int ) * V_101 ) )
return - V_87 ;
return 0 ;
}
case V_139 :
return F_69 ( F_63 () , ( int T_2 * ) V_110 ) ;
case V_140 :
return F_69 ( F_62 () , ( int T_2 * ) V_110 ) ;
case V_141 :
return F_69 ( F_2 ( & V_17 ) ,
( int T_2 * ) V_110 ) ;
case V_142 :
return F_69 ( V_102 , ( int T_2 * ) V_110 ) ;
case V_143 :
return F_65 ( V_11 , V_110 ) ;
case V_144 :
return F_69 ( V_115 , ( int T_2 * ) V_110 ) ;
case V_145 :
return F_69 ( F_64 ( V_117 ) ,
( int T_2 * ) V_110 ) ;
case V_146 :
return F_69 ( F_64 ( V_119 ) ,
( int T_2 * ) V_110 ) ;
case V_147 :
return F_69 ( F_64 ( V_148 ) ,
( int T_2 * ) V_110 ) ;
case V_149 :
return F_69 ( F_64 ( V_150 ) ,
( int T_2 * ) V_110 ) ;
case V_151 :
return F_69 ( F_64 ( V_148 ) +
F_64 ( V_150 ) ,
( int T_2 * ) V_110 ) ;
case V_152 :
return F_69 ( F_64 ( V_153 ) ,
( int T_2 * ) V_110 ) ;
case V_154 :
return F_69 ( F_64 ( V_155 ) ,
( int T_2 * ) V_110 ) ;
default:
return - V_156 ;
}
...
unsigned long V_110 )
{
struct V_157 T_2 * V_158 = F_71 ( V_110 ) ;
struct V_157 V_159 ;
struct V_38 V_160 ;
long V_42 ;
if ( F_52 ( & V_159 , V_158 , sizeof( V_159 ) ) )
return - V_87 ;
V_160 . V_161 = F_71 ( V_159 . V_161 ) ;
V_160 . V_46 = V_159 . V_46 ;
V_160 . V_162 = F_71 ( V_159 . V_162 ) ;
V_160 . V_45 = V_159 . V_45 ;
V_160 . V_163 = F_71 ( V_159 . V_163 ) ;
V_160 . V_164 = F_71 ( V_159 . V_164 ) ;
do {
V_42 = F_32 ( & V_160 ) ;
} while ( V_42 == - V_127 );
if ( ( V_42 == - V_43 ) && ( F_1 () ) )
...
if ( V_42 )
return V_42 ;
return F_69 ( V_160 . V_45 ,
& V_158 -> V_45 ) ;
}
static long F_72 ( struct V_10 * V_11 , unsigned int V_124 ,
unsigned long V_110 )
{
struct V_165 T_2 * V_166 = F_71 ( V_110 ) ;
struct V_165 V_167 ;
struct V_57 V_168 ;
long V_42 ;
if ( F_52 ( & V_167 , V_166 , sizeof( V_167 ) ) )
return - V_87 ;
V_168 . V_161 = F_71 ( V_167 . V_161 ) ;
V_168 . V_46 = V_167 . V_46 ;
V_168 . V_162 = F_71 ( V_167 . V_162 ) ;
V_168 . V_45 = V_167 . V_45 ;
V_168 . V_169 = F_71 ( V_167 . V_169 ) ;
V_168 . V_170 = F_71 ( V_167 . V_170 ) ;
V_168 . V_171 = F_71 ( V_167 . V_171 ) ;
V_168 . V_172 = F_71 ( V_167 . V_172 ) ;
V_168 . V_173 = F_71 ( V_167 . V_173 ) ;
do {
V_42 = F_42 ( & V_168 ) ;
} while ( V_42 == - V_127 );
if ( ( V_42 == - V_43 ) && ( F_1 () ) )
...
if ( V_42 )
return V_42 ;
return F_69 ( V_168 . V_45 ,
& V_166 -> V_45 ) ;
}
static long F_73 ( struct V_10 * V_11 , unsigned int V_124 ,
unsigned long V_110 )
{
struct V_174 T_2 * V_175 = F_71 ( V_110 ) ;
struct V_174 V_176 ;
struct V_61 V_177 ;
long V_42 ;
...
if ( F_67 ( V_175 , & V_176 , sizeof( V_176 ) ) )
return - V_87 ;
return V_42 ;
}
...
if ( V_124 == V_130 )
return F_73 ( V_11 , V_124 , V_110 ) ;
return F_68 ( V_11 , V_124 , V_110 ) ;
}
static void F_75 ( struct V_189 * V_190 , unsigned char * V_191 , unsigned int V_192 )
{
int V_193 ;
for ( V_193 = 0 ; V_193 < V_192 ; V_193 ++ )
F_76 ( V_190 , L_2 , ( unsigned int ) V_191 [ V_193 ] ) ;
F_77 ( V_190 , ' ' ) ;
}
static void F_78 ( struct V_189 * V_190 , unsigned char * V_191 , unsigned int V_192 )
{
int V_194 , V_195 , V_196 ;
F_76 ( V_190 , L_3 ) ;
V_194 = 0 ;
for ( V_195 = 0 ; V_195 < ( V_192 / 16 ) ; V_195 ++ ) {
F_75 ( V_190 , V_191 + V_194 , 16 ) ;
V_194 += 16 ;
}
V_196 = V_192 % 16 ;
if ( V_196 ) {
F_75 ( V_190 , V_191 + V_194 , V_196 ) ;
V_194 += V_196 ;
}
F_77 ( V_190 , '\n' ) ;
}
static void F_79 ( unsigned char * V_197 , struct V_189 * V_190 ,
unsigned char * V_191 , unsigned int V_192 )
{
int V_194 , V_198 , V_199 ;
F_76 ( V_190 , L_4 , V_197 ) ;
V_194 = 0 ;
for ( V_198 = 0 ; V_198 < ( V_192 / 64 ) ; V_198 ++ ) {
F_78 ( V_190 , V_191 + V_194 , 64 ) ;
V_194 += 64 ;
}
V_199 = V_192 % 64 ;
if ( V_199 ) {
F_78 ( V_190 , V_191 + V_194 , V_199 ) ;
V_194 += V_199 ;
}
F_77 ( V_190 , '\n' ) ;
}
static void F_80 ( unsigned char * V_197 , struct V_189 * V_190 ,
unsigned int * V_200 , unsigned int V_192 )
{
F_76 ( V_190 , L_4 , V_197 ) ;
F_81 ( V_190 , L_5 , V_201 , 32 , 4 , V_200 , V_192 , false ) ;
F_77 ( V_190 , '\n' ) ;
}
static int F_82 ( struct V_189 * V_190 , void * V_202 )
{
char V_203 [ sizeof( int ) * V_101 ] ;
F_76 ( V_190 , L_6 ,
V_204 , V_205 , V_206 ) ;
F_76 ( V_190 , L_7 , V_102 ) ;
F_76 ( V_190 , L_8 , V_115 ) ;
F_76 ( V_190 , L_9 , F_64 ( V_117 ) ) ;
F_76 ( V_190 , L_10 , F_64 ( V_119 ) ) ;
F_76 ( V_190 , L_11 ,
F_64 ( V_148 ) ) ;
F_76 ( V_190 , L_12 ,
F_64 ( V_150 ) ) ;
F_76 ( V_190 , L_13 , F_64 ( V_153 ) ) ;
F_76 ( V_190 , L_14 , F_64 ( V_155 ) ) ;
F_76 ( V_190 , L_15 , F_64 ( V_207 ) ) ;
F_76 ( V_190 , L_16 , F_64 ( V_208 ) ) ;
F_76 ( V_190 , L_17 , F_63 () ) ;
F_76 ( V_190 , L_18 , F_62 () ) ;
F_76 ( V_190 , L_19 ,
F_2 ( & V_17 ) ) ;
F_59 ( V_203 ) ;
F_79 ( L_20
...
V_190 , V_203 , V_101 ) ;
F_60 ( V_203 ) ;
F_79 ( L_22 , V_190 , V_203 , V_101 ) ;
F_61 ( ( int * ) V_203 ) ;
F_80 ( L_23 ,
V_190 , ( unsigned int * ) V_203 , V_101 ) ;
return 0 ;
}
static int F_83 ( struct V_16 * V_16 , struct V_10 * V_10 )
{
return F_84 ( V_10 , F_82 , NULL ) ;
}
static void F_85 ( int V_209 )
{
struct V_19 * V_20 ;
struct V_18 * V_21 ;
F_35 ( & V_49 ) ;
...
static T_1 F_88 ( struct V_10 * V_10 , const char T_2 * V_90 ,
T_3 V_13 , T_4 * V_210 )
{
...
return 0 ;
#define F_89 1200UL
V_211 = F_90 ( F_89 , V_84 ) ;
if ( ! V_211 )
return 0 ;
V_213 = F_91 ( F_89 - 1 , V_13 ) ;
...
static int F_92 ( struct V_215 * V_92 , T_5 * V_216 )
{
int V_42 ;
if ( V_217 == 0 ) {
...
int T_6 F_101 ( void )
{
V_225 = F_102 ( L_26 , NULL ) ;
V_226 = F_103 ( L_26 , 1 , 1 ,
V_227 * sizeof( long ) ) ;
F_104 ( V_226 , & V_228 ) ;
F_105 ( V_226 , V_229 ) ;
return 0 ;
