...
V_6 -> V_558 = V_681 ;
V_6 -> V_560 = V_682 ;
V_6 -> V_555 = V_683 | V_553 ;
V_6 -> V_684 = V_685 | V_686 ;
V_6 -> V_585 = V_586 ;
V_6 -> V_541 = V_687 ;
strcpy ( V_6 -> V_688 , L_249 ) ;
F_281 ( & V_6 -> V_68 ) ;
F_282 ( & V_6 -> V_265 ) ;
F_282 ( & V_6 -> V_179 ) ;
F_283 ( & V_6 -> V_55 ) ;
...
V_63 = F_300 ( & V_260 -> V_2 . V_696 , & V_697 ) ;
if ( V_63 )
goto V_71;
if ( ! ( V_6 -> V_49 & V_484 ) ) {
if ( F_83 ( V_6 ) ) {
...
snprintf ( V_218 -> V_51 , V_709 , L_270 ) ;
...
if ( V_711 -> V_392 > 0 || V_711 -> V_712 > 1000 ) {
V_63 = - V_639 ;
goto V_620;
} else {
F_327 ( L_272 , V_711 -> V_712 ) ;
V_63 = F_234 ( V_6 , V_711 -> V_712 , 0 ) ;
}
V_620:
F_85 ( & V_6 -> V_265 ) ;
return V_63 ;
...
V_717 -> V_723 . V_43 = 20 + V_353 ;
V_717 -> V_723 . V_721 = 0 ;
V_717 -> V_723 . V_722 = 7 ;
V_717 -> V_724 = V_255 ;
for ( V_19 = 0 ; V_19 < V_255 && V_19 < V_725 ; V_19 ++ ) {
V_717 -> V_726 [ V_19 ] = V_253 [ V_19 ] . V_726 * 100 * 1000 ;
}
V_717 -> V_727 = V_728 ;
V_717 -> V_729 = V_554 ;
V_717 -> V_730 = V_731 ;
...
V_6 -> V_187 |= V_625 ;
memcpy ( V_6 -> V_770 , V_218 -> V_219 . V_628 , V_230 ) ;
...
V_6 -> V_187 |= V_282 ;
if ( V_6 -> V_267 == V_285 && ! memcmp ( V_6 -> V_268 , V_708 , V_285 ) ) {
F_327 ( L_281 ) ;
V_63 = 0 ;
goto V_620;
}
...
F_327 ( L_283 ,
V_6 -> V_267 , V_6 -> V_268 ) ;
memcpy ( V_708 , V_6 -> V_268 , V_6 -> V_267 ) ;
...
return - V_771 ;
V_218 -> V_37 . V_285 = F_147 ( T_4 , V_218 -> V_37 . V_285 , sizeof( V_6 -> V_688 ) ) ;
memset ( V_6 -> V_688 , 0 , sizeof( V_6 -> V_688 ) ) ;
memcpy ( V_6 -> V_688 , V_708 , V_218 -> V_37 . V_285 ) ;
F_327 ( L_285 , V_6 -> V_688 ) ;
return 0 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_37 . V_285 = strlen ( V_6 -> V_688 ) ;
memcpy ( V_708 , V_6 -> V_688 , V_218 -> V_37 . V_285 ) ;
V_218 -> V_37 . V_62 = 1 ;
F_327 ( L_286 , V_708 ) ;
return 0 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_774 . V_147 = V_6 -> V_555 & ~ V_553 ;
V_218 -> V_774 . V_773 = 1 ;
V_218 -> V_774 . V_775 = ( V_6 -> V_555 & V_553 ) ? 1 : 0 ;
F_327 ( L_291 , V_218 -> V_774 . V_147 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_63 = 0 , V_147 ;
if ( F_212 ( V_6 , V_218 -> V_754 . V_775 ) )
return - V_776 ;
if ( V_6 -> V_150 -> V_198 != V_431 )
return 0 ;
...
if ( V_218 -> V_754 . V_147 < V_587 ||
V_218 -> V_754 . V_147 > V_588 )
return - V_31 ;
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_754 . V_775 = ( V_6 -> V_49 & V_484 ) ? 1 : 0 ;
if ( V_6 -> V_585 == V_586 ) {
V_218 -> V_754 . V_773 = 0 ;
V_218 -> V_754 . V_147 = V_588 ;
} else {
V_218 -> V_754 . V_773 = 1 ;
V_218 -> V_754 . V_147 = V_6 -> V_585 ;
}
V_218 -> V_754 . V_62 = V_751 ;
F_327 ( L_293 , V_218 -> V_754 . V_147 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_63 = 0 ;
if ( V_218 -> V_556 . V_62 & V_780 || V_218 -> V_556 . V_775 )
return - V_31 ;
if ( ! ( V_218 -> V_556 . V_62 & V_781 ) )
return 0 ;
F_84 ( & V_6 -> V_265 ) ;
if ( ! ( V_6 -> V_49 & V_619 ) ) {
V_63 = - V_70 ;
...
if ( V_218 -> V_556 . V_62 & V_782 ) {
V_63 = F_242 ( V_6 , V_218 -> V_556 . V_147 ) ;
F_327 ( L_296 ,
V_218 -> V_556 . V_147 ) ;
goto V_620;
}
if ( V_218 -> V_556 . V_62 & V_783 ) {
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_556 . V_775 = 0 ;
if ( ( V_218 -> V_556 . V_62 & V_784 ) == V_780 )
return - V_31 ;
if ( V_218 -> V_556 . V_62 & V_783 ) {
V_218 -> V_556 . V_62 = V_781 | V_783 ;
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_354 ( V_6 -> V_150 , V_81 , V_218 , V_708 ) ;
}
...
if ( ! V_150 -> V_631 )
return - V_639 ;
if ( V_218 -> V_37 . V_285 > V_789 ||
( V_218 -> V_37 . V_285 && V_708 == NULL ) )
return - V_31 ;
if ( V_218 -> V_37 . V_285 ) {
V_15 = F_362 ( V_708 , V_218 -> V_37 . V_285 , V_239 ) ;
if ( V_15 == NULL )
return - V_240 ;
F_130 ( V_150 -> V_640 ) ;
V_150 -> V_640 = V_15 ;
...
memcpy ( V_708 , V_150 -> V_640 , V_150 -> V_641 ) ;
return 0 ;
}
...
if ( ! V_491 || ! V_491 -> V_799 -> V_800 || ! V_491 -> V_799 -> V_801 )
break;
V_62 = V_491 -> V_799 -> V_801 ( V_491 -> V_6 ) ;
if ( V_791 -> V_147 )
V_62 |= V_802 ;
else
V_62 &= ~ V_802 ;
V_491 -> V_799 -> V_800 ( V_62 , V_491 -> V_6 ) ;
break;
case V_803 : {
struct V_617 V_190 = {
. V_62 = V_191 ,
...
case V_804 :
V_266 = F_269 ( V_6 , V_791 -> V_147 ) ;
break;
case V_805 :
V_266 = F_268 ( V_6 , V_791 -> V_147 ) ;
break;
case V_806 :
...
case V_798 :
V_491 = V_6 -> V_150 -> V_490 . V_491 [ V_6 -> V_150 -> V_490 . V_492 ] ;
if ( ! V_491 || ! V_491 -> V_799 -> V_801 ) {
F_153 ( L_306
L_307 ) ;
break;
}
V_791 -> V_147 = ( V_491 -> V_799 -> V_801 ( V_491 -> V_6 ) &
V_802 ) ? 1 : 0 ;
break;
case V_803 :
...
break;
case V_804 :
V_791 -> V_147 = V_6 -> V_150 -> V_190 . V_566 ;
break;
case V_805 :
V_791 -> V_147 = V_150 -> V_631 ;
break;
case V_806 :
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_369 ( V_6 -> V_150 , V_81 , V_218 , V_708 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_63 = 0 , V_313 = * ( int * ) V_708 ;
F_84 ( & V_6 -> V_265 ) ;
if ( ! ( V_6 -> V_49 & V_619 ) ) {
V_63 = - V_70 ;
goto V_620;
}
if ( ( V_313 < 0 ) || ( V_313 > V_737 ) )
V_313 = V_673 ;
...
V_218 -> V_37 . V_285 = strlen ( V_708 ) + 1 ;
return 0 ;
}
...
static struct V_820 * F_379 ( struct V_1 * V_2 )
{
enum {
V_821 = 30 ,
V_822 = 60 ,
...
& V_352 , & V_204 ) )
goto V_841;
V_302 -> V_720 . V_43 = V_352 + V_353 ;
if ( V_352 < 10 )
V_827 = V_352 * V_821 / 10 ;
else if ( V_352 < 15 )
V_827 = ( V_352 - 10 ) * ( V_822 - V_821 ) / 5 + V_821 ;
else if ( V_352 < 20 )
V_827 = ( V_352 - 15 ) * ( V_823 - V_822 ) / 5 + V_822 ;
else if ( V_352 < 30 )
V_827 = ( V_352 - 20 ) * ( V_824 - V_823 ) /
10 + V_823 ;
else
V_827 = ( V_352 - 30 ) * ( V_826 - V_824 ) /
10 + V_824 ;
if ( F_26 ( V_6 , V_843 ,
& V_831 , & V_204 ) )
goto V_841;
...
F_327 ( L_320 ) ;
#endif
V_302 -> V_720 . V_720 = V_830 ;
V_302 -> V_720 . V_43 = V_352 + V_353 ;
}
V_302 -> V_720 . V_721 = 0 ;
V_302 -> V_720 . V_722 = 7 ;
V_302 -> V_720 . V_722 |= V_837 ;
V_302 -> V_834 . V_835 = V_832 ;
if ( F_26 ( V_6 , V_844 ,
& V_833 , & V_204 ) )
goto V_841;
V_302 -> V_332 . V_836 = V_833 ;
return V_302 ;
V_841:
F_327 ( L_288 ) ;
return (struct V_820 * ) NULL ;
}
static void V_689 ( struct V_261 * V_262 )
{
struct V_5 * V_6 =
...
static int F_380 ( struct V_119 * V_845 )
{
struct V_846 * V_847 =
(struct V_846 * ) V_845 -> V_848 -> V_37 ;
if ( F_381 ( V_847 -> V_121 ) != V_849 ) {
...
V_845 -> V_845 . V_478 = V_847 -> V_850 ;
V_845 -> V_851 . V_37 = V_845 -> V_845 . V_37 + V_847 -> V_850 ;
V_845 -> V_851 . V_478 = V_847 -> V_852 ;
return 0 ;
}
...
V_202 = F_383 ( & V_845 -> V_848 , V_853 , & V_6 -> V_260 -> V_2 ) ;
if ( V_202 < 0 ) {
F_27 (KERN_ERR DRV_NAME L_67
L_328 ,
...
unsigned int V_860 = V_845 -> V_845 . V_478 ;
while ( V_860 > 0 ) {
V_8 = * ( T_1 * ) ( V_859 ) ;
V_859 += 4 ;
V_860 -= 4 ;
...
unsigned int V_862 = V_845 -> V_851 . V_478 ;
