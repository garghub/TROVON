...
int F_107 ( struct V_97 * V_98 , int V_24 , T_1 V_211 ,
T_4 V_212 , T_5 V_215 )
{
int V_58 = 0 ;
struct V_1 * V_2 = F_103 ( V_98 ) ;
...
V_224 = F_70 ( 1 , ~ V_153 -> V_130 ) ;
for ( V_223 = 0 ; V_223 < V_224 ; V_223 ++ ) {
unsigned int V_233 = ( V_24 * V_224 ) + V_223 ;
F_6 ( V_4 , V_234 , V_233 ) ;
F_6 ( V_4 , V_235 , V_222 ) ;
}
}
...
for ( V_6 = 0 ; V_6 < V_2 -> V_12 ; V_6 ++ ) {
if ( ! V_2 -> V_226 )
V_2 -> V_29 [ V_6 ] . V_225 = 0 ;
F_110 ( V_2 , V_6 ) ;
}
}
int F_112 ( struct V_97 * V_98 , int V_24 , int V_236 ,
int V_237 )
{
struct V_1 * V_2 = F_103 ( V_98 ) ;
int V_218 ;
...
if ( V_236 )
return - V_113 ;
if ( V_237 && ( ( V_237 <= 10 ) || ( V_237 > V_218 ) ) )
return - V_113 ;
V_2 -> V_226 = V_218 ;
V_2 -> V_29 [ V_24 ] . V_225 = V_237 ;
F_110 ( V_2 , V_24 ) ;
return 0 ;
}
int F_113 ( struct V_97 * V_98 , int V_24 , bool V_239 )
{
struct V_1 * V_2 = F_103 ( V_98 ) ;
struct V_3 * V_4 = & V_2 -> V_4 ;
if ( V_24 >= V_2 -> V_12 )
return - V_113 ;
V_2 -> V_29 [ V_24 ] . V_40 = V_239 ;
V_4 -> V_18 . V_92 . V_172 ( V_4 , V_239 , V_24 ) ;
V_4 -> V_18 . V_92 . V_137 ( V_4 , V_239 , V_24 ) ;
if ( V_4 -> V_18 . V_92 . V_240 ) {
F_6 ( V_4 , F_114 ( V_241 ) ,
( V_242 |
V_243 |
V_244 ) ) ;
...
V_243 |
V_246 ) ) ;
V_4 -> V_18 . V_92 . V_240 ( V_4 , V_239 , V_24 ) ;
}
return 0 ;
}
...
if ( V_24 >= V_2 -> V_12 )
return - V_113 ;
V_2 -> V_29 [ V_24 ] . V_41 = V_239 ;
return 0 ;
}
int F_116 ( struct V_97 * V_98 , int V_24 , bool V_239 )
{
struct V_1 * V_2 = F_103 ( V_98 ) ;
if ( V_24 >= V_2 -> V_12 )
return - V_113 ;
if ( V_2 -> V_29 [ V_24 ] . V_42 == V_239 )
return 0 ;
V_2 -> V_29 [ V_24 ] . V_42 = V_239 ;
V_2 -> V_29 [ V_24 ] . V_162 = false ;
F_100 ( V_2 , V_24 ) ;
F_2 ( V_114 , L_31 , V_24 , V_239 ? L_32 : L_33 ) ;
return 0 ;
}
int F_117 ( struct V_97 * V_98 ,
int V_24 , struct V_247 * V_248 )
{
struct V_1 * V_2 = F_103 ( V_98 ) ;
if ( V_24 >= V_2 -> V_12 )
return - V_113 ;
V_248 -> V_24 = V_24 ;
memcpy ( & V_248 -> V_18 , V_2 -> V_29 [ V_24 ] . V_138 , V_141 ) ;
V_248 -> V_237 = V_2 -> V_29 [ V_24 ] . V_225 ;
V_248 -> V_236 = 0 ;
V_248 -> V_211 = V_2 -> V_29 [ V_24 ] . V_134 ;
V_248 -> V_212 = V_2 -> V_29 [ V_24 ] . V_135 ;
V_248 -> V_249 = V_2 -> V_29 [ V_24 ] . V_40 ;
V_248 -> V_250 = V_2 -> V_29 [ V_24 ] . V_41 ;
V_248 -> V_42 = V_2 -> V_29 [ V_24 ] . V_42 ;
return 0 ;
}
