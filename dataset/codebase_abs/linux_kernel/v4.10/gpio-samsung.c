...
int F_65 ( unsigned int V_63 , unsigned int V_53 )
{
...
F_25 ( V_2 , V_28 ) ;
V_42 = F_67 ( V_2 , V_26 , V_53 ) ;
F_26 ( V_2 , V_28 ) ;
return V_42 ;
}
int F_68 ( unsigned int V_71 , unsigned int V_72 ,
unsigned int V_15 )
{
int V_42 ;
for (; V_72 > 0 ; V_72 -- , V_71 ++ ) {
V_42 = F_65 ( V_71 , V_15 ) ;
if ( V_42 != 0 )
return V_42 ;
}
...
int F_69 ( unsigned int V_71 , unsigned int V_72 ,
...
unsigned F_71 ( unsigned int V_63 )
{
struct V_1 * V_2 = F_66 ( V_63 ) ;
unsigned long V_28 ;
unsigned V_42 = 0 ;
...
int F_70 ( unsigned int V_63 , T_1 V_4 )
{
struct V_1 * V_2 = F_66 ( V_63 ) ;
unsigned long V_28 ;
int V_26 , V_42 ;
...
V_26 = V_63 - V_2 -> V_2 . V_6 ;
F_25 ( V_2 , V_28 ) ;
V_42 = F_73 ( V_2 , V_26 , V_4 ) ;
F_26 ( V_2 , V_28 ) ;
return V_42 ;
}
T_1 F_74 ( unsigned int V_63 )
{
struct V_1 * V_2 = F_66 ( V_63 ) ;
unsigned long V_28 ;
int V_26 ;
...
unsigned int F_76 ( unsigned int V_73 , unsigned int V_74 )
{
unsigned long V_28 ;
unsigned long V_75 ;
F_37 ( V_28 ) ;
