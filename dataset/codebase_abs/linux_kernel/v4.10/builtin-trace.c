...
{
if ( ( V_164 || V_229 ) && V_182 -> V_231 )
fprintf ( V_207 , L_79 , V_182 -> V_231 -> V_232 -> V_233 ) ;
if ( ( V_164 || V_230 ) && V_182 -> V_234 )
...
int F_193 ( int V_252 , const char * * V_253 , const char * T_10 V_171 )
{
const char * V_365 [] = {
L_151 ,
L_152 ,
...
F_194 ( 0 , L_155 , & V_84 . V_121 , L_155 ,
L_156 ,
V_377 ) ,
F_195 ( 0 , L_73 , & V_84 . V_103 ,
L_157 ) ,
F_195 ( 0 , L_158 , & V_84 . V_316 , L_159 ) ,
F_196 ( 'e' , L_160 , & V_375 , L_160 , L_161 ) ,
F_196 ( 'o' , L_162 , & V_374 , L_163 , L_164 ) ,
F_196 ( 'i' , L_165 , & V_322 , L_163 , L_166 ) ,
F_196 ( 'p' , L_74 , & V_84 . V_125 . V_126 . V_173 , L_74 ,
L_167 ) ,
F_196 ( 't' , L_168 , & V_84 . V_125 . V_126 . V_81 , L_168 ,
L_169 ) ,
F_194 ( 0 , L_170 , & V_84 , L_171 ,
L_172 , F_185 ) ,
F_195 ( 'a' , L_173 , & V_84 . V_125 . V_126 . V_378 ,
L_174 ) ,
F_196 ( 'C' , L_175 , & V_84 . V_125 . V_126 . V_379 , L_175 ,
L_176 ) ,
F_195 ( 0 , L_177 , & V_84 . V_125 . V_380 ,
L_178 ) ,
F_194 ( 'm' , L_179 , & V_84 . V_125 . V_306 , L_180 ,
L_181 ,
V_381 ) ,
F_196 ( 'u' , L_182 , & V_84 . V_125 . V_126 . V_382 , L_183 ,
L_184 ) ,
F_194 ( 0 , L_185 , & V_84 , L_186 ,
L_187 ,
F_184 ) ,
F_195 ( 0 , L_109 , & V_84 . V_293 , L_188 ) ,
F_197 ( 'v' , L_189 , & V_164 , L_190 ) ,
F_195 ( 'T' , L_191 , & V_84 . V_249 ,
L_192 ) ,
F_195 ( 's' , L_193 , & V_84 . V_176 ,
L_194 ) ,
F_195 ( 'S' , L_195 , & V_84 . V_189 ,
L_196 ) ,
F_198 ( 'F' , L_197 , & V_84 . V_264 , L_198 ,
L_199 , F_191 , L_83 ) ,
F_195 ( 0 , L_2 , & V_84 . V_227 , L_200 ) ,
F_195 ( 'f' , L_201 , & V_84 . V_324 , L_202 ) ,
F_194 ( 0 , L_203 , & V_84 . V_125 ,
L_204 , V_383 ,
& V_384 ) ,
F_195 ( 0 , L_205 , & V_84 . V_279 ,
L_206 ) ,
F_199 ( 0 , L_207 , & V_84 . V_177 ,
L_208
L_209 ) ,
F_199 ( 0 , L_210 , & V_84 . V_183 ,
L_211
L_212
L_213 F_200 ( V_385 ) ) ,
F_199 ( 0 , L_214 , & V_84 . V_125 . V_128 ,
L_215 ) ,
F_199 ( 'D' , L_216 , & V_84 . V_125 . V_308 ,
L_217
L_218 ) ,
F_201 ()
} ;
...
bool V_387 = true ;
const char * const V_388 [] = { L_87 , NULL } ;
int V_122 ;
char V_29 [ V_302 ] ;
signal ( V_389 , V_390 ) ;
signal ( V_391 , V_390 ) ;
...
V_252 = F_204 ( V_252 , V_253 , V_376 , V_388 ,
V_365 , V_392 ) ;
V_122 = F_205 ( V_84 . V_121 ) ;
if ( V_122 ) {
F_206 ( V_84 . V_121 , V_122 , V_29 , sizeof( V_29 ) ) ;
F_98 ( L_219 , V_29 ) ;
goto V_158;
}
V_122 = - 1 ;
...
if ( V_84 . V_125 . V_306 == V_367 )
V_387 = false ;
if ( V_84 . V_183 == V_367 ) {
V_84 . V_183 = V_322 ? V_385 : V_395 ;
V_386 = false ;
}
#ifdef F_207
if ( ( V_84 . V_177 || V_386 ) && ! V_277 . V_278 && V_84 . V_227 )
F_208 ( & V_84 . V_125 , & V_277 , L_220 , false ) ;
#endif
if ( V_277 . V_278 ) {
if ( ! V_387 && F_209 () == 0 )
V_84 . V_125 . V_306 = F_210 () * 4 ;
V_118 . V_396 = true ;
}
...
V_122 = F_213 ( & V_84 . V_125 . V_126 ) ;
if ( V_122 ) {
F_214 ( & V_84 . V_125 . V_126 , V_122 , V_29 , sizeof( V_29 ) ) ;
fprintf ( V_84 . V_109 , L_3 , V_29 ) ;
goto V_401;
}
V_122 = F_215 ( & V_84 . V_125 . V_126 ) ;
if ( V_122 ) {
F_214 ( & V_84 . V_125 . V_126 , V_122 , V_29 , sizeof( V_29 ) ) ;
fprintf ( V_84 . V_109 , L_3 , V_29 ) ;
goto V_401;
