...
F_26 ( V_7 , L_46 ) ;
V_5 -> V_129 . V_172 = L_47 ;
V_5 -> V_129 . V_173 = F_1 ;
V_5 -> V_129 . V_174 = F_10 ;
V_5 -> V_129 . V_175 = F_7 ;
V_5 -> V_129 . V_176 = F_9 ;
V_5 -> V_129 . V_177 = - 1 ;
V_5 -> V_129 . V_178 = 8 ;
...
for ( V_186 = 0 ; V_186 < F_45 ( V_5 -> V_149 ) ; V_186 ++ ) {
F_75 ( & V_5 -> V_129 , V_186 ) ;
F_76 ( V_5 -> V_149 [ V_186 ] ) ;
}
F_93 ( & V_5 -> V_129 ) ;
F_95 ( V_7 ) ;
F_96 ( V_7 ) ;
}
static int F_99 ( struct V_6 * V_7 , struct V_187 * V_42 ,
T_1 * V_26 , int V_40 )
{
struct V_4 * V_5 = F_98 ( V_7 ) ;
struct V_188 * V_189 = ( void * ) V_26 ;
switch ( V_26 [ 0 ] ) {
case V_190 :
F_26 ( V_7 , L_51 ,
V_189 -> V_191 , V_189 -> V_192 ,
F_100 ( V_189 -> V_69 ) , F_100 ( V_189 -> V_45 ) ) ;
switch ( V_189 -> V_191 ) {
case V_193 :
V_5 -> V_39 = - V_194 ;
break;
