...
struct V_19 * V_4 = F_3 ( V_18 ) ;
struct V_3 V_28 ;
V_28 . V_10 = V_4 -> V_15 . V_29 ;
V_28 . V_11 = 1 << V_4 -> V_15 . V_27 ;
V_28 . V_12 = 1 ;
V_28 . V_13 = V_4 -> V_16 . V_30 ? : 1 << V_4 -> V_16 . V_27 ;
F_1 ( * V_22 , V_2 , & V_28 ) ;
return * V_22 * V_28 . V_15 / V_28 . V_16 ;
}
...
V_28 . V_13 = V_4 -> V_16 . V_30 ? : 1 << V_4 -> V_16 . V_27 ;
F_1 ( V_22 , V_2 , & V_28 ) ;
F_18 ( V_4 -> V_20 . V_32 , V_31 ) ;
V_23 = F_12 ( V_4 -> V_20 . V_25 + V_4 -> V_20 . V_23 ) ;
V_23 &= ~ F_19 ( V_4 -> V_15 . V_27 + V_4 -> V_15 . V_26 - 1 , V_4 -> V_15 . V_26 ) ;
V_23 &= ~ F_19 ( V_4 -> V_16 . V_27 + V_4 -> V_16 . V_26 - 1 , V_4 -> V_16 . V_26 ) ;
F_20 ( V_23 | ( ( V_28 . V_16 - 1 ) << V_4 -> V_16 . V_26 ) | ( ( V_28 . V_15 - 1 ) << V_4 -> V_15 . V_26 ) ,
V_4 -> V_20 . V_25 + V_4 -> V_20 . V_23 ) ;
F_21 ( V_4 -> V_20 . V_32 , V_31 ) ;
F_22 ( & V_4 -> V_20 , V_4 -> V_32 ) ;
return 0 ;
}
