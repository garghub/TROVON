...
void F_38 ( struct V_2 * V_2 , struct V_22 * V_23 ,
struct V_28 * V_29 )
{
struct V_14 * V_24 = & V_1 ( V_2 ) -> V_24 ;
T_1 V_31 = F_39 ( V_29 ) ;
...
int F_42 ( struct V_2 * V_2 , struct V_22 * V_23 ,
struct V_28 * V_29 )
{
struct V_14 * V_24 = & V_1 ( V_2 ) -> V_24 ;
struct V_14 V_15 ;
...
F_41 ( V_23 , F_39 ( V_29 ) , & V_15 ) ;
V_26 = F_45 ( V_23 , V_29 , & V_15 ) ;
}
F_12 ( V_2 ) ;
F_14 ( V_2 , & V_15 ) ;
if ( ! F_15 ( V_24 ) )
...
void F_46 ( struct V_2 * V_2 , struct V_22 * V_33 ,
struct V_14 * V_15 )
{
...
void F_48 ( struct V_2 * V_2 , struct V_22 * V_35 )
{
struct V_22 * V_34 = F_4 ( V_2 ) ;
struct V_14 * V_24 = & V_1 ( V_2 ) -> V_24 ;
struct V_14 V_15 ;
...
static int F_52 ( struct V_2 * V_2 , T_2 V_37 )
{
struct V_22 * V_23 = F_4 ( V_2 ) ;
if ( ! V_23 )
return - V_36 ;
...
int F_54 ( struct V_2 * V_2 , struct V_41 * V_42 [] )
{
int V_43 ;
T_2 V_44 ;
...
if ( ! V_42 [ V_47 ] )
return - V_40 ;
V_43 = F_55 ( V_42 [ V_47 ] , V_45 ) ;
if ( V_43 )
return V_43 ;
if ( ! V_45 [ V_48 ] )
return - V_49 ;
V_44 = F_56 ( V_45 [ V_48 ] ) ;
return F_52 ( V_2 , V_44 ) ;
}
int F_57 ( struct V_2 * V_2 )
{
struct F_1 * V_50 = F_1 ( V_2 ) ;
struct V_1 * V_4 = NULL ;
struct V_22 * V_23 = NULL ;
V_4 = F_58 ( sizeof( * V_4 ) , V_20 ) ;
if ( ! V_4 )
goto V_51;
V_50 -> V_3 = V_4 ;
F_59 ( & F_1 ( V_2 ) -> V_52 ) ;
...
void F_62 ( struct V_2 * V_2 )
{
struct F_1 * V_50 = F_63 ( V_2 , V_57 ) ;
F_64 () ;
F_61 ( V_50 -> V_3 ) ;
F_61 ( V_50 -> V_55 ) ;
}
