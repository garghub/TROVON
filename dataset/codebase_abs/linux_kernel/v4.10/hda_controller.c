...
if ( V_189 -> V_204 && ! V_189 -> V_205 && ! V_189 -> V_206 ) {
V_189 -> V_205 = 1 ;
return - V_207 ;
}
F_33 ( V_3 -> V_47 -> V_48 ,
...
int V_94 = 50 ;
while ( V_94 -- ) {
if ( F_113 ( V_3 , V_209 ) & V_210 ) {
F_3 ( V_3 ) -> V_195 . V_188 [ V_186 ] = F_114 ( V_3 , V_211 ) ;
return 0 ;
}
F_62 ( 1 ) ;
}
...
static int F_116 ( struct V_54 * V_55 , T_3 V_212 )
{
struct V_2 * V_3 = F_91 ( V_55 ) ;
unsigned int V_186 = F_99 ( V_212 ) ;
int V_94 = 50 ;
V_55 -> V_200 [ F_99 ( V_212 ) ] = V_212 ;
while ( V_94 -- ) {
if ( ! ( ( F_113 ( V_3 , V_209 ) & V_213 ) ) ) {
F_117 ( V_3 , V_209 , F_113 ( V_3 , V_209 ) |
V_210 ) ;
F_118 ( V_3 , V_214 , V_212 ) ;
F_117 ( V_3 , V_209 , F_113 ( V_3 , V_209 ) |
V_213 ) ;
...
static int F_120 ( struct V_54 * V_55 , unsigned int V_212 )
{
struct V_2 * V_3 = F_91 ( V_55 ) ;
if ( V_3 -> V_215 )
return 0 ;
if ( V_3 -> V_208 )
return F_116 ( V_55 , V_212 ) ;
else
return F_121 ( V_55 , V_212 ) ;
}
...
static int F_123 ( struct V_54 * V_55 , bool V_216 )
{
struct V_2 * V_3 = F_91 ( V_55 ) ;
if ( V_3 -> V_17 -> V_217 )
return V_3 -> V_17 -> V_217 ( V_3 , V_216 ) ;
else
return - V_49 ;
}
static struct V_1 *
...
F_105 ( & V_55 -> V_72 ) ;
V_35 = F_126 ( V_56 , V_45 , V_219 , V_221 ) ;
if ( V_35 < 0 ) {
F_103 ( & V_55 -> V_72 ) ;
if ( V_222 )
* V_1 = V_3 -> V_224 ;
...
void F_131 ( struct V_2 * V_3 , bool V_227 )
{
if ( F_132 ( F_3 ( V_3 ) , V_227 ) ) {
if ( V_3 -> V_50 & V_51 )
F_117 ( V_3 , V_228 , 0xc0 ) ;
}
}
...
if ( ! V_3 -> V_17 -> V_229 ||
V_3 -> V_17 -> V_229 ( V_3 , V_1 ) ) {
F_45 ( & V_55 -> V_72 ) ;
F_137 ( F_7 ( V_1 ) -> V_5 ) ;
F_41 ( & V_55 -> V_72 ) ;
}
}
T_5 F_138 ( int V_230 , void * V_231 )
{
struct V_2 * V_3 = V_231 ;
struct V_54 * V_55 = F_3 ( V_3 ) ;
T_3 V_232 ;
bool V_233 , V_234 = false ;
int V_235 = 0 ;
#ifdef F_139
if ( F_140 ( V_3 ) )
...
goto V_29;
do {
V_232 = F_114 ( V_3 , V_237 ) ;
if ( V_232 == 0 || V_232 == 0xffffffff )
break;
V_234 = true ;
V_233 = false ;
if ( F_142 ( V_55 , V_232 , F_136 ) )
V_233 = true ;
V_232 = F_143 ( V_3 , V_238 ) ;
if ( V_232 & V_239 ) {
V_233 = true ;
if ( V_232 & V_240 ) {
if ( V_3 -> V_50 & V_51 )
...
F_144 ( V_3 , V_238 , V_239 ) ;
}
} while ( V_233 && ++ V_235 < 10 );
V_29:
F_45 ( & V_55 -> V_72 ) ;
return F_145 ( V_234 ) ;
}
...
{
unsigned int V_53 = ( V_186 << 28 ) | ( V_241 << 20 ) |
( V_242 << 8 ) | V_243 ;
struct V_54 * V_55 = F_3 ( V_3 ) ;
int V_35 ;
...
if ( ! V_3 -> V_248 )
return 0 ;
V_246 = V_3 -> V_248 [ V_3 -> V_249 ] ;
if ( V_246 == 0 )
return 0 ;
if ( V_246 < 50 || V_246 > 60000 )
V_247 = 0 ;
else
V_247 = F_102 ( V_246 ) ;
if ( V_247 == 0 )
...
int F_150 ( struct V_2 * V_3 , const char * V_250 ,
const struct V_251 * V_252 )
{
struct V_165 * V_55 = & V_3 -> V_55 ;
int V_35 ;
V_35 = F_151 ( & V_55 -> V_30 , V_3 -> V_47 -> V_48 , & V_253 ,
V_252 ) ;
if ( V_35 < 0 )
return V_35 ;
V_55 -> V_47 = V_3 -> V_47 ;
F_152 ( & V_55 -> V_254 ) ;
V_55 -> V_255 = V_3 -> V_255 ;
V_55 -> V_256 = V_250 ;
V_55 -> V_257 = - 1 ;
V_55 -> V_30 . V_258 = F_153 ( V_3 ) ;
if ( V_3 -> V_76 [ 0 ] != F_48 ||
V_3 -> V_76 [ 1 ] != F_48 )
V_55 -> V_30 . V_259 = true ;
V_55 -> V_30 . V_260 = V_3 -> V_260 ;
if ( V_3 -> V_50 & V_261 )
V_55 -> V_30 . V_262 = true ;
if ( V_3 -> V_50 & V_263 )
V_55 -> V_30 . V_264 = true ;
if ( V_3 -> V_50 & V_265 ) {
...
int F_154 ( struct V_2 * V_3 , unsigned int V_267 )
{
struct V_54 * V_55 = F_3 ( V_3 ) ;
int V_268 , V_269 , V_35 ;
V_269 = 0 ;
if ( ! V_267 )
V_267 = V_270 ;
for ( V_268 = 0 ; V_268 < V_267 ; V_268 ++ ) {
if ( ( V_55 -> V_271 & ( 1 << V_268 ) ) & V_3 -> V_272 ) {
if ( F_146 ( V_3 , V_268 ) < 0 ) {
F_110 ( V_3 -> V_47 -> V_48 ,
L_14 , V_268 ) ;
V_55 -> V_271 &= ~ ( 1 << V_268 ) ;
F_134 ( V_3 ) ;
...
if ( ( V_55 -> V_271 & ( 1 << V_268 ) ) & V_3 -> V_272 ) {
struct V_167 * V_19 ;
V_35 = F_155 ( & V_3 -> V_55 , V_3 -> V_47 , V_268 , & V_19 ) ;
if ( V_35 < 0 )
continue;
V_19 -> V_273 = F_149 ( V_3 ) ;
V_19 -> V_274 = V_3 -> V_274 ;
V_269 ++ ;
}
}
if ( ! V_269 ) {
...
int V_246 ;
int V_276 [ 2 ] = { 0 , 0 } ;
for ( V_246 = 0 ; V_246 < V_3 -> V_277 ; V_246 ++ ) {
struct V_1 * V_1 = F_95 ( sizeof( * V_1 ) , V_174 ) ;
int V_278 , V_279 ;
if ( ! V_1 )
return - V_175 ;
V_278 = F_159 ( V_3 , V_246 ) ;
if ( V_3 -> V_50 & V_280 )
V_279 = ++ V_276 [ V_278 ] ;
else
V_279 = V_246 + 1 ;
...
struct V_54 * V_55 = F_3 ( V_3 ) ;
struct V_6 * V_7 ;
while ( ! F_163 ( & V_55 -> V_281 ) ) {
V_7 = F_164 ( & V_55 -> V_281 , struct V_6 , V_164 ) ;
F_88 ( & V_7 -> V_164 ) ;
F_89 ( F_4 ( V_7 ) ) ;
}
}
