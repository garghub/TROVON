...
F_75 ( struct V_2 * V_2 , T_6 V_93 )
{
struct V_52 * V_53 ;
struct V_1 * V_94 = F_1 ( V_2 ) ;
F_16 () ;
V_53 = F_76 ( V_94 -> V_95 ) [ V_93 ] ;
F_18 () ;
return V_53 ;
}
int
F_77 ( T_6 V_93 , const struct V_85 * V_86 ,
const struct V_96 * V_97 , struct V_98 * V_99 )
{
struct V_52 * V_53 = F_75 ( F_78 ( V_97 ) , V_93 ) ;
int V_22 = 0 ;
F_72 ( ! V_53 ) ;
...
int
F_84 ( T_6 V_93 , const struct V_85 * V_86 ,
const struct V_96 * V_97 , struct V_98 * V_99 )
{
struct V_52 * V_53 = F_75 ( F_78 ( V_97 ) , V_93 ) ;
int V_22 = 0 ;
...
T_6
F_85 ( struct V_2 * V_2 , const char * V_6 , struct V_52 * * V_53 )
{
...
{
const struct V_52 * V_53 = F_75 ( V_2 , V_93 ) ;
F_72 ( ! V_53 ) ;
F_72 ( V_53 -> V_91 == 0 ) ;
return V_53 -> V_6 ;
}
...
static inline bool
F_91 ( const struct V_33 * const V_38 [] )
{
return ! V_38 [ V_120 ] ||
F_92 ( V_38 [ V_120 ] ) != V_24 ;
}
static inline T_4
F_93 ( const struct V_121 * V_122 )
{
return V_122 -> V_123 & V_124 ? 0 : V_125 ;
}
static struct V_121 *
F_94 ( struct V_85 * V_86 , T_4 V_126 , T_4 V_127 , unsigned int V_48 ,
enum V_128 V_129 )
{
struct V_121 * V_122 ;
struct V_130 * V_131 ;
V_122 = F_95 ( V_86 , V_126 , V_127 , V_129 | ( V_12 << 8 ) ,
sizeof( * V_131 ) , V_48 ) ;
if ( ! V_122 )
return NULL ;
V_131 = F_96 ( V_122 ) ;
...
V_7 = F_92 ( V_141 [ V_149 ] ) ;
V_8 = F_92 ( V_141 [ V_148 ] ) ;
F_11 ( L_16 ,
...
F_70 ( & V_90 ) ;
V_122 = F_94 ( V_86 , F_129 ( V_177 -> V_86 ) . V_126 ,
...
if ( ! V_224 )
return - V_151 ;
V_241 = F_94 ( V_224 , F_129 ( V_86 ) . V_126 , V_122 -> V_201 , 0 ,
V_243 ) ;
if ( ! V_241 )
goto V_244;
