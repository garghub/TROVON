...
V_69 = & V_3 -> V_28 -> V_70 ;
F_11 ( L_5 ,
V_3 -> V_15 , V_69 -> V_11 . V_34 , V_69 -> V_15 ,
...
return;
if ( V_10 -> V_81 )
F_49 ( & V_1 -> V_11 , & V_10 -> V_82 ) ;
F_49 ( & V_1 -> V_11 , & V_10 -> V_83 ) ;
F_50 ( V_1 ) ;
V_10 -> V_80 = false ;
}
...
static int F_53 ( const void * V_84 , const void * V_85 )
{
...
V_39 [ V_97 ] . V_18 = V_18 ;
V_39 [ V_97 ] . V_28 = F_34 ( V_38 ) ;
V_97 ++ ;
}
F_57 ( V_39 , V_97 , sizeof( V_39 [ 0 ] ) , F_53 , NULL ) ;
if ( ( V_97 > 0 ) && ! F_54 ( V_28 , & V_39 [ 0 ] . V_28 -> V_11 ) )
V_11 ++ ;
V_36 = F_33 ( V_1 -> V_50 ) ;
if ( ( V_97 + V_11 ) >= V_36 -> V_19 . V_98 ) {
F_58 ( V_6 -> V_6 , L_8 , V_97 , V_11 ) ;
return - V_99 ;
}
...
static void F_62 ( struct V_2 * V_3 , T_1 * V_103 , T_1 * V_104 )
{
struct V_10 * V_10 = F_5 ( V_3 ) ;
T_1 V_105 = V_3 -> V_69 . V_72 ;
T_1 V_106 = V_3 -> V_69 . V_76 ;
* V_103 = F_63 ( V_10 -> V_107 . V_108 , V_105 -
V_10 -> V_107 . V_109 ) ;
* V_104 = F_63 ( V_10 -> V_107 . V_110 , V_106 -
V_10 -> V_107 . V_111 ) ;
}
...
V_114 = F_66 ( V_21 , V_112 ) ;
if ( ! V_114 )
return - V_127 ;
V_119 = F_67 ( V_114 , V_1 -> V_34 , & V_118 ) ;
if ( V_119 )
return - V_99 ;
V_19 = V_10 -> V_19 ;
V_117 = V_108 * F_68 ( V_128 , 0 ) ;
F_19 ( & V_10 -> V_107 . V_129 , V_25 ) ;
V_115 = V_10 -> V_107 . V_130 ;
V_10 -> V_107 . V_130 = V_114 ;
V_10 -> V_107 . V_108 = V_108 ;
V_10 -> V_107 . V_110 = V_110 ;
F_62 ( V_3 , & V_103 , & V_104 ) ;
F_40 ( V_1 , F_69 ( V_19 ) , V_117 ) ;
F_40 ( V_1 , F_70 ( V_19 ) ,
F_71 ( V_131 ) ) ;
F_40 ( V_1 , F_72 ( V_19 ) ,
F_73 ( V_110 ) |
...
F_76 ( V_104 ) |
F_77 ( V_103 ) ) ;
F_40 ( V_1 , F_78 ( V_19 ) , V_118 ) ;
V_116 = V_132 ;
V_116 |= F_79 ( V_121 ) ;
F_40 ( V_1 , F_80 ( V_19 ) , V_116 ) ;
F_21 ( & V_10 -> V_107 . V_129 , V_25 ) ;
V_126:
V_119 = F_81 ( V_10 -> V_16 , 0 , V_123 ) ;
if ( V_119 ) {
F_58 ( V_6 -> V_6 , L_14 ,
...
V_133:
if ( V_115 ) {
F_82 ( & V_10 -> V_33 , V_115 ) ;
F_4 ( V_3 , V_134 ) ;
}
return V_119 ;
}
static int F_83 ( struct V_2 * V_3 , int V_109 , int V_111 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
struct V_10 * V_10 = F_5 ( V_3 ) ;
T_1 V_14 = F_65 ( 0 ) ;
...
T_1 V_104 ;
unsigned long V_25 ;
if ( F_61 ( ! V_3 -> V_28 -> V_29 ) )
return 0 ;
V_10 -> V_107 . V_109 = V_109 = F_84 ( V_109 , 0 ) ;
V_10 -> V_107 . V_111 = V_111 = F_84 ( V_111 , 0 ) ;
F_62 ( V_3 , & V_103 , & V_104 ) ;
F_19 ( & V_10 -> V_107 . V_129 , V_25 ) ;
F_40 ( V_1 , F_75 ( V_10 -> V_19 ) ,
F_76 ( V_104 ) |
F_77 ( V_103 ) ) ;
F_40 ( V_1 , F_85 ( V_10 -> V_19 ) ,
F_86 ( V_111 ) |
F_87 ( V_109 ) ) ;
F_21 ( & V_10 -> V_107 . V_129 , V_25 ) ;
F_10 ( V_3 , V_14 ) ;
...
static void F_88 ( struct V_135 * V_136 , T_1 V_137 )
{
struct V_10 * V_10 = F_24 ( V_136 , struct V_10 , V_12 ) ;
struct V_2 * V_3 = & V_10 -> V_11 ;
struct V_4 * V_5 = V_3 -> V_6 -> V_7 ;
unsigned V_9 ;
F_49 ( & F_1 ( V_3 ) -> V_11 , & V_10 -> V_12 ) ;
V_9 = F_89 ( & V_10 -> V_9 , 0 ) ;
if ( V_9 & V_102 ) {
F_18 ( V_3 , NULL ) ;
}
if ( V_9 & V_134 )
F_90 ( & V_10 -> V_33 , V_5 -> V_138 ) ;
}
static void F_91 ( struct V_135 * V_136 , T_1 V_137 )
{
struct V_10 * V_10 = F_24 ( V_136 , struct V_10 , V_83 ) ;
F_11 ( L_17 , V_10 -> V_11 . V_15 , V_137 ) ;
}
static void F_92 ( struct V_135 * V_136 , T_1 V_137 )
{
struct V_10 * V_10 = F_24 ( V_136 , struct V_10 ,
V_82 ) ;
F_93 ( & V_10 -> V_13 ) ;
}
...
struct V_10 * V_10 = F_5 ( V_3 ) ;
int V_119 ;
V_119 = F_95 ( & V_10 -> V_13 ,
F_96 ( 50 ) ) ;
if ( V_119 == 0 )
F_97 ( V_6 -> V_6 , L_18 , V_10 -> V_19 ) ;
}
...
if ( V_119 )
return;
V_119 = F_100 ( V_6 -> V_12 [ F_101 ( V_3 ) ] . V_139 ,
( ( F_102 ( V_10 -> V_16 ) &
V_10 -> V_101 ) == 0 ) ,
F_96 ( 50 ) ) ;
if ( V_119 <= 0 )
F_97 ( V_6 -> V_6 , L_19 , V_10 -> V_34 ) ;
V_10 -> V_101 = 0 ;
F_103 ( V_3 ) ;
}
...
struct V_1 * V_1 = F_1 ( V_3 ) ;
int V_19 = F_106 ( V_3 ) ;
V_10 -> V_83 . V_140 = F_107 ( V_142 -> V_144 ) ;
V_10 -> V_12 . V_140 = F_108 ( V_19 , V_142 ) ;
if ( ( V_142 -> type == V_145 ) &&
( V_142 -> V_69 == V_146 ) ) {
V_10 -> V_82 . V_140 = F_109 ( V_19 ) ;
V_10 -> V_82 . V_136 = F_92 ;
V_10 -> V_81 = true ;
} else {
V_10 -> V_82 . V_140 = 0 ;
...
struct V_2 * F_113 ( struct V_22 * V_6 ,
struct V_17 * V_18 , int V_34 )
{
struct V_2 * V_3 = NULL ;
struct V_10 * V_10 ;
V_10 = F_114 ( sizeof( * V_10 ) , V_147 ) ;
if ( ! V_10 )
return F_115 ( - V_148 ) ;
V_3 = & V_10 -> V_11 ;
V_10 -> V_34 = V_34 ;
V_10 -> V_19 = F_116 ( V_34 ) ;
F_117 ( & V_10 -> V_51 ) ;
F_117 ( & V_10 -> V_107 . V_129 ) ;
F_118 ( & V_10 -> V_13 ) ;
V_10 -> V_12 . V_136 = F_88 ;
V_10 -> V_83 . V_136 = F_91 ;
F_119 ( V_6 , V_3 , V_18 , NULL , & V_149 ,
NULL ) ;
F_120 ( & V_10 -> V_33 ,
L_20 , F_23 ) ;
F_121 ( V_3 , & V_150 ) ;
