...
{
int V_24 ;
V_24 = F_6 ( V_4 -> V_25 , V_4 -> V_26 ) ;
if ( V_24 < 0 )
F_7 ( L_1 ,
V_4 -> V_26 ) ;
return V_24 ;
}
static void F_8 ( const struct V_27 * V_4 )
{
F_9 ( V_4 -> V_25 , V_4 -> V_26 ) ;
}
static bool
...
static int F_11 ( const struct V_32 * V_4 )
{
int V_24 ;
V_24 = F_6 ( V_4 -> V_25 , V_4 -> V_26 ) ;
if ( V_24 < 0 )
...
static void F_12 ( const struct V_33 * V_4 )
{
F_9 ( V_4 -> V_25 , V_4 -> V_26 ) ;
}
