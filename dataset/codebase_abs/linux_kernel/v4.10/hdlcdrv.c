...
static int F_37 ( struct V_14 * V_15 , void * V_67 )
{
...
static int F_41 ( struct V_14 * V_15 , struct V_81 * V_82 , int V_83 )
{
struct V_6 * V_7 = F_32 ( V_15 ) ;
struct F_41 V_84 ;
if ( V_83 != V_85 ) {
...
if ( F_42 ( & V_84 , V_82 -> V_88 , sizeof( V_84 ) ) )
return - V_89 ;
switch ( V_84 . V_83 ) {
default:
if ( V_7 -> V_73 && V_7 -> V_73 -> V_86 )
...
if( ! F_43 ( V_106 ) )
return - V_114 ;
if ( V_84 . V_41 . V_79 > V_115 / V_7 -> V_116 . V_117 )
return - V_118 ;
V_7 -> V_53 . V_79 = V_84 . V_41 . V_79 * V_7 -> V_116 . V_117 / 16 ;
return 0 ;
case V_119 :
#ifndef F_15
return - V_114 ;
#else
if ( V_7 -> V_120 . V_77 == V_7 -> V_120 . V_78 )
return - V_121 ;
V_84 . V_41 . V_8 =
V_7 -> V_120 . V_1 [ V_7 -> V_120 . V_77 ] ;
V_7 -> V_120 . V_77 = ( V_7 -> V_120 . V_77 + 1 ) %
sizeof( V_7 -> V_120 . V_1 ) ;
break;
#endif
case V_122 :
#ifndef F_15
...
#endif
case V_123 :
if ( V_7 -> V_73 && V_7 -> V_73 -> V_124 ) {
strncpy ( V_84 . V_41 . V_125 , V_7 -> V_73 -> V_124 ,
sizeof( V_84 . V_41 . V_125 ) ) ;
break;
}
V_84 . V_41 . V_125 [ 0 ] = '\0' ;
break;
}
if ( F_46 ( V_82 -> V_88 , & V_84 , sizeof( V_84 ) ) )
return - V_89 ;
return 0 ;
}
static void F_47 ( struct V_14 * V_15 )
{
static const struct V_126 V_127 = {
20 , 2 , 10 , 40 , 0
} ;
struct V_6 * V_7 = F_32 ( V_15 ) ;
V_7 -> V_43 = V_127 ;
V_7 -> V_61 = 0 ;
F_48 ( & V_7 -> V_11 . V_36 . V_128 ) ;
V_7 -> V_11 . V_36 . V_77 = V_7 -> V_11 . V_36 . V_78 = 0 ;
V_7 -> V_11 . V_35 = 0 ;
V_7 -> V_11 . V_12 = 0 ;
F_48 ( & V_7 -> V_53 . V_36 . V_128 ) ;
V_7 -> V_53 . V_36 . V_77 = V_7 -> V_53 . V_36 . V_78 = 0 ;
V_7 -> V_53 . V_54 = 0 ;
V_7 -> V_53 . V_55 = 1 ;
V_7 -> V_53 . V_56 = 0 ;
...
V_7 -> V_53 . V_79 = 0 ;
#ifdef F_15
V_7 -> V_120 . V_77 = V_7 -> V_120 . V_78 = 0 ;
V_7 -> V_120 . V_129 = 0x80 ;
...
V_15 -> V_132 = & V_133 ;
V_15 -> type = V_134 ;
V_15 -> V_135 = V_136 + V_137 ;
V_15 -> V_138 = V_139 ;
V_15 -> V_72 = V_140 ;
memcpy ( V_15 -> V_141 , & V_142 , V_140 ) ;
memcpy ( V_15 -> V_70 , & V_143 , V_140 ) ;
V_15 -> V_144 = 16 ;
}
struct V_14 * F_49 ( const struct V_145 * V_73 ,
unsigned int V_146 , const char * V_147 ,
unsigned int V_148 , unsigned int V_98 ,
unsigned int V_99 )
{
struct V_14 * V_15 ;
struct V_6 * V_7 ;
int V_149 ;
F_50 ( V_73 == NULL ) ;
if ( V_146 < sizeof( struct V_6 ) )
V_146 = sizeof( struct V_6 ) ;
V_15 = F_51 ( V_146 , V_147 , V_150 , F_47 ) ;
if ( ! V_15 )
return F_52 ( - V_151 ) ;
V_7 = F_32 ( V_15 ) ;
V_7 -> V_33 = V_34 ;
