...
if ( ! V_216 )
V_216 = V_251 ;
V_248 -> V_15 = F_184 ( V_210 -> V_252 , V_247 , V_210 -> V_253 ,
( void * ) ( long ) V_8 ) ;
if ( ! V_248 -> V_15 )
return - V_62 ;
...
unsigned int F_196 ( unsigned int V_260 )
{
return V_125 ? V_254 : V_261 ;
}
static int F_197 ( int V_8 , int V_262 )
{
union V_153 V_154 ;
...
static T_7 F_199 ( int V_33 , T_7 V_265 )
{
if ( ( V_195 . V_196 == V_197 ) &&
! F_136 ( V_198 ) )
return F_197 ( V_33 , V_265 ) ;
else
return V_265 ;
}
static T_7 F_199 ( int V_33 , T_7 V_265 )
...
V_267 = F_203 ( V_266 , 256 ) ;
V_154 . V_162 . V_164 = V_267 ;
F_32 ( & V_54 , V_53 ) ;
F_28 ( V_33 , 0 , V_154 . V_161 ) ;
V_154 . V_161 = F_30 ( V_33 , 0 ) ;
F_33 ( & V_54 , V_53 ) ;
F_188 ( V_154 . V_162 . V_164 != V_267 ) ;
return V_267 ;
}
...
static struct V_274 * T_2 F_214 ( void )
{
unsigned long V_275 ;
struct V_274 * V_276 ;
char * V_277 ;
...
V_288:
#endif
V_284 = ( unsigned long ) F_217 ( V_289 ) ;
V_284 = F_218 ( V_284 ) ;
}
F_219 ( V_33 , V_284 ) ;
F_14 ( V_23 , L_102 ,
F_220 ( V_33 ) + ( V_284 & ~ V_290 ) ,
V_284 ) ;
V_33 ++ ;
V_286 -> V_291 = V_284 ;
...
int F_226 ( int V_265 , T_1 V_297 , T_1 V_11 ,
struct V_249 * V_210 )
{
bool V_298 = ! ! V_125 ;
struct V_6 * V_9 ;
...
F_219 ( V_285 + V_33 , V_297 ) ;
if ( F_224 ( V_33 ) ) {
F_227 ( V_285 + V_33 ) ;
return - V_304 ;
}
V_2 [ V_33 ] . V_3 . V_4 = F_199 ( V_33 , V_265 ) ;
...
static void F_233 ( struct V_209 * V_210 , struct V_58 * V_46 ,
struct V_36 * V_52 )
{
memset ( V_52 , 0 , sizeof( * V_52 ) ) ;
...
V_217 = F_236 ( V_121 , V_308 , V_309 , V_102 ) ;
if ( V_217 < 0 ) {
F_20 ( V_46 ) ;
return V_217 ;
}
