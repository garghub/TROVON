...
static void F_77 ( const char * V_111 )
{
struct V_105 * V_112 ;
F_78 (np, NULL, compatible)
F_79 ( V_112 , NULL , NULL ) ;
}
static int F_80 ( void * V_113 )
{
unsigned long V_114 = F_81 ( V_115 ) + 1 ;
T_7 V_116 ;
F_82 () ;
do {
F_83 () ;
...
struct V_123 * F_109 ( void * V_124 ,
unsigned long V_125 )
{
struct V_123 * V_126 , * V_127 = NULL ;
unsigned long V_21 = 0 ;
V_126 = F_110 ( V_128 , V_129 ) ;
if ( ! V_126 )
goto V_130;
V_127 = V_126 ;
while ( V_125 > 0 ) {
T_8 V_8 = F_111 ( V_124 ) << V_131 ;
T_8 V_132 = F_112 ( V_125 , V_128 ) ;
V_126 -> V_17 [ V_21 ] . V_8 = F_40 ( V_8 ) ;
V_126 -> V_17 [ V_21 ] . V_132 = F_40 ( V_132 ) ;
V_21 ++ ;
if ( V_21 >= V_133 ) {
struct V_123 * V_134 ;
V_134 = F_110 ( V_128 , V_129 ) ;
if ( ! V_134 )
goto V_130;
V_126 -> V_132 = F_40 (
