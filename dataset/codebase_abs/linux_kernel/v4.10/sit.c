...
V_4 -> V_228 = F_25 ;
V_4 -> type = V_229 ;
V_4 -> V_202 = V_230 + V_173 ;
V_4 -> V_171 = V_231 - V_173 ;
V_4 -> V_232 = V_189 ;
V_4 -> V_233 = 0xFFF8 - V_173 ;
V_4 -> V_19 = V_234 ;
F_137 ( V_4 ) ;
V_4 -> V_235 = 4 ;
V_4 -> V_236 |= V_237 ;
...
static void T_8 F_141 ( struct V_3 * V_4 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
...
static int F_142 ( struct V_240 * V_241 [] , struct V_240 * V_101 [] )
{
T_5 V_152 ;
if ( ! V_101 || ! V_101 [ V_242 ] )
return 0 ;
V_152 = F_143 ( V_101 [ V_242 ] ) ;
if ( ! F_130 ( V_152 ) )
return - V_78 ;
return 0 ;
}
static void F_144 ( struct V_240 * V_101 [] ,
struct V_22 * V_13 )
{
...
return;
if ( V_101 [ V_243 ] )
V_13 -> V_17 = F_145 ( V_101 [ V_243 ] ) ;
if ( V_101 [ V_244 ] )
V_13 -> V_14 . V_15 = F_146 ( V_101 [ V_244 ] ) ;
if ( V_101 [ V_245 ] )
V_13 -> V_14 . V_16 = F_146 ( V_101 [ V_245 ] ) ;
if ( V_101 [ V_246 ] ) {
V_13 -> V_14 . V_116 = F_143 ( V_101 [ V_246 ] ) ;
if ( V_13 -> V_14 . V_116 )
V_13 -> V_14 . V_164 = F_73 ( V_217 ) ;
}
if ( V_101 [ V_247 ] )
V_13 -> V_14 . V_138 = F_143 ( V_101 [ V_247 ] ) ;
if ( ! V_101 [ V_248 ] || F_143 ( V_101 [ V_248 ] ) )
V_13 -> V_14 . V_164 = F_73 ( V_217 ) ;
if ( V_101 [ V_249 ] )
V_13 -> V_41 = F_147 ( V_101 [ V_249 ] ) ;
if ( V_101 [ V_242 ] )
V_13 -> V_14 . V_114 = F_143 ( V_101 [ V_242 ] ) ;
}
static bool F_148 ( struct V_240 * V_101 [] ,
struct F_116 * V_250 )
{
bool V_67 = false ;
...
if ( V_101 [ V_251 ] ) {
V_67 = true ;
V_250 -> type = F_149 ( V_101 [ V_251 ] ) ;
}
if ( V_101 [ V_252 ] ) {
V_67 = true ;
V_250 -> V_19 = F_149 ( V_101 [ V_252 ] ) ;
}
if ( V_101 [ V_253 ] ) {
V_67 = true ;
V_250 -> V_254 = F_147 ( V_101 [ V_253 ] ) ;
}
if ( V_101 [ V_255 ] ) {
V_67 = true ;
V_250 -> V_256 = F_147 ( V_101 [ V_255 ] ) ;
}
return V_67 ;
}
static bool F_150 ( struct V_240 * V_101 [] ,
struct V_203 * V_30 )
{
bool V_67 = false ;
...
static int F_152 ( struct V_2 * V_261 , struct V_3 * V_4 ,
struct V_240 * V_241 [] , struct V_240 * V_101 [] )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_1 * V_49 ;
struct F_116 V_250 ;
...
int V_36 ;
V_49 = F_14 ( V_4 ) ;
if ( F_148 ( V_101 , & V_250 ) ) {
V_36 = F_153 ( V_49 , & V_250 ) ;
if ( V_36 < 0 )
return V_36 ;
}
F_144 ( V_101 , & V_49 -> V_13 ) ;
...
static int F_154 ( struct V_3 * V_4 , struct V_240 * V_241 [] ,
struct V_240 * V_101 [] )
{
struct V_1 * V_9 = F_14 ( V_4 ) ;
struct V_22 V_77 ;
...
static int F_157 ( struct V_86 * V_87 , const struct V_3 * V_4 )
{
struct V_1 * V_98 = F_14 ( V_4 ) ;
struct V_22 * V_262 = & V_98 -> V_13 ;
if ( F_158 ( V_87 , V_243 , V_262 -> V_17 ) ||
F_159 ( V_87 , V_244 , V_262 -> V_14 . V_15 ) ||
F_159 ( V_87 , V_245 , V_262 -> V_14 . V_16 ) ||
F_160 ( V_87 , V_246 , V_262 -> V_14 . V_116 ) ||
F_160 ( V_87 , V_247 , V_262 -> V_14 . V_138 ) ||
F_160 ( V_87 , V_248 ,
! ! ( V_262 -> V_14 . V_164 & F_73 ( V_217 ) ) ) ||
F_160 ( V_87 , V_242 , V_262 -> V_14 . V_114 ) ||
F_161 ( V_87 , V_249 , V_262 -> V_41 ) )
goto V_263;
#ifdef F_13
if ( F_162 ( V_87 , V_257 ,
& V_98 -> V_30 . V_31 ) ||
...
static void F_164 ( struct V_3 * V_4 , struct V_266 * V_83 )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
if ( V_4 != V_11 -> V_29 )
...
V_11 -> V_25 [ 1 ] = V_11 -> V_269 ;
V_11 -> V_25 [ 2 ] = V_11 -> V_270 ;
V_11 -> V_25 [ 3 ] = V_11 -> V_271 ;
...
F_24 ( V_11 -> V_29 , V_2 ) ;
V_11 -> V_29 -> V_45 = & V_46 ;
V_11 -> V_29 -> V_236 |= V_273 ;
V_36 = F_169 ( V_11 -> V_29 ) ;
if ( V_36 )
goto V_274;
F_12 ( V_11 -> V_29 , V_11 ) ;
F_141 ( V_11 -> V_29 ) ;
...
if ( V_36 < 0 )
return V_36 ;
V_36 = F_183 ( & V_276 , V_277 ) ;
if ( V_36 < 0 ) {
F_181 ( L_8 , V_283 ) ;
goto V_284;
}
V_36 = F_183 ( & V_278 , V_279 ) ;
if ( V_36 < 0 ) {
F_181 ( L_9 , V_283 ) ;
goto V_285;
}
#if F_84 ( V_148 )
V_36 = F_183 ( & V_280 , V_281 ) ;
if ( V_36 < 0 ) {
F_181 ( L_10 , V_283 ) ;
goto V_286;
}
