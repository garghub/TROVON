...
V_5 -> V_143 = V_5 -> V_59 + ( V_5 -> V_59 >> 1 ) ;
V_127 = ( ( ( V_5 -> V_143 << V_5 -> V_33 ) + 0xffff ) >> 16 ) *
( V_135 >> 3 ) ;
if ( V_44 )
V_127 += sizeof( T_1 ) ;
if ( V_5 -> V_144 && V_5 -> V_144 < V_127 ) {
unsigned int V_145 = V_127 = V_5 -> V_144 ;
if ( V_44 )
V_145 -= sizeof( T_1 ) ;
V_5 -> V_143 = ( V_145 / ( V_135 >> 3 ) )
<< ( 16 - V_5 -> V_33 ) ;
}
if ( V_5 -> V_28 )
V_5 -> V_60 = V_5 -> V_144 ;
...
F_57 ( V_5 , 0 ) ;
V_5 -> V_33 = V_125 -> V_33 ;
V_5 -> V_144 = V_125 -> V_144 ;
V_5 -> V_28 = ! ! ( V_125 -> V_163 & V_164 ) ;
if ( F_20 ( V_5 -> V_6 -> V_7 ) == V_103 )
V_5 -> V_59 = F_1 ( V_1 ) ;
else
V_5 -> V_59 = F_2 ( V_1 ) ;
...
struct V_63 * V_173 ;
V_172 = V_8 -> V_75 ;
for ( V_43 = 0 ; V_43 < V_172 -> V_45 ; V_43 ++ )
if ( V_8 -> V_51 [ V_43 ] . V_78 == 0 )
V_171 += V_8 -> V_51 [ V_43 ] . V_174 ;
if ( V_171 == 0 )
return;
F_10 ( & V_5 -> V_30 , V_26 ) ;
V_173 = V_5 -> V_68 + V_5 -> V_67 ;
V_173 -> V_45 = V_172 -> V_45 ;
for ( V_43 = 0 ; V_43 < V_172 -> V_45 ; V_43 ++ ) {
if ( V_8 -> V_51 [ V_43 ] . V_78 == 0 )
V_173 -> V_49 [ V_43 ] =
V_8 -> V_51 [ V_43 ] . V_174 / V_168 -> V_50 ;
else
V_173 -> V_49 [ V_43 ] = 0 ;
}
V_5 -> V_67 ++ ;
...
return;
if ( F_15 ( V_168 -> V_175 ) ) {
if ( V_170 < V_5 -> V_59 - 0x8000 )
V_170 += 0xf000 ;
else if ( V_170 > V_5 -> V_59 + 0x8000 )
V_170 -= 0xf000 ;
} else if ( F_15 ( V_5 -> V_165 == V_166 ) ) {
V_169 = 0 ;
while ( V_170 < V_5 -> V_59 - V_5 -> V_59 / 4 ) {
V_170 <<= 1 ;
V_169 ++ ;
}
while ( V_170 > V_5 -> V_59 + V_5 -> V_59 / 2 ) {
V_170 >>= 1 ;
V_169 -- ;
}
V_5 -> V_165 = V_169 ;
...
V_170 >>= - V_5 -> V_165 ;
if ( F_77 ( V_170 >= V_5 -> V_59 - V_5 -> V_59 / 8 && V_170 <= V_5 -> V_143 ) ) {
F_10 ( & V_5 -> V_30 , V_26 ) ;
V_5 -> V_32 = V_170 ;
F_12 ( & V_5 -> V_30 , V_26 ) ;
} else {
