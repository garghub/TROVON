...
int F_75 ( struct V_36 * V_37 , struct V_123 * V_124 ,
struct V_36 * * V_142 )
{
#ifdef F_54
const struct V_131 * V_112 ;
F_55 ( V_125 ) ;
if ( F_76 ( V_124 ) )
return - V_66 ;
F_56 ( V_124 , & V_125 ) ;
F_3 (a, &actions, list) {
if ( V_112 -> V_8 -> V_143 ) {
V_112 -> V_8 -> V_143 ( V_112 , F_77 ( V_37 ) , V_142 ) ;
break;
}
}
if ( * V_142 )
...
{
F_79 ( V_144 , V_59 , F_19 , NULL , NULL ) ;
F_79 ( V_144 , V_56 , F_19 , NULL , NULL ) ;
F_79 ( V_144 , V_49 , F_19 ,
F_52 , NULL ) ;
return 0 ;
}
