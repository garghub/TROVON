...
static int F_57 ( const char * V_64 , void * V_9 ,
char * V_20 )
{
F_6 ( V_9 , V_276 , V_68 ) ;
F_13 ( V_9 , V_276 , V_277 ) ;
sprintf ( V_20 , L_130 , V_68 , * V_277 ) ;
return 1 ;
}
static bool F_58 ( const char * V_59 , unsigned V_278 , const char * V_279 )
{
if ( V_278 != strlen ( V_279 ) )
return false ;
return memcmp ( V_59 , V_279 , V_278 ) == 0 ;
}
static void F_59 ( void * V_9 , unsigned long V_7 ,
unsigned long V_8 ,
const char * V_6 ,
void * V_135 ,
struct V_18 * V_19 )
...
unsigned int V_10 ;
char V_20 [ 500 ] ;
int (* F_60)( const char * , void * V_280 , char * V_20 ) = V_135 ;
F_3 ( V_19 -> V_59 , V_6 , V_7 , V_8 , V_9 ) ;
V_7 -= V_8 ;
for ( V_10 = 0 ; V_10 < V_7 ; V_10 += V_8 ) {
if ( F_60 ( V_19 -> V_59 , V_9 + V_10 , V_20 ) ) {
F_8 ( & V_19 -> V_42 ,
L_32 , V_20 ) ;
}
}
}
void F_61 ( struct V_18 * V_19 , struct V_281 * V_282 ,
T_4 * V_283 , const char * V_284 )
{
void * V_9 ;
char * V_285 = NULL ;
const char * V_59 , * V_286 ;
unsigned int V_278 ;
if ( ! V_283 -> V_287 || F_62 ( V_282 , V_283 ) >= V_282 -> V_288 )
return;
if ( F_63 ( V_283 -> V_289 ) != V_290 )
return;
V_59 = strstr ( V_284 , L_131 ) ;
if ( ! V_59 )
return;
V_59 += strlen ( L_131 ) ;
V_278 = strlen ( V_59 ) ;
if ( V_278 < strlen ( L_132 ) )
return;
if ( strcmp ( V_59 + V_278 - strlen ( L_132 ) , L_132 ) )
return;
V_286 = strstr ( V_59 , L_133 ) ;
if ( ! V_286 )
return;
V_278 = V_286 - V_59 ;
if ( V_282 -> V_291 [ F_62 ( V_282 , V_283 ) ] . V_292 & V_293 ) {
V_285 = calloc ( 1 , V_283 -> V_294 ) ;
V_9 = V_285 ;
} else {
V_9 = ( void * ) V_282 -> V_295
+ V_282 -> V_291 [ F_62 ( V_282 , V_283 ) ] . V_296
+ V_283 -> V_297 ;
}
if ( F_58 ( V_59 , V_278 , L_33 ) )
F_11 ( V_9 , V_283 -> V_294 , V_19 ) ;
if ( F_58 ( V_59 , V_278 , L_38 ) )
F_14 ( V_9 , V_283 -> V_294 , V_19 ) ;
else if ( F_58 ( V_59 , V_278 , L_71 ) )
F_24 ( V_9 , V_283 -> V_294 , V_19 ) ;
else if ( F_58 ( V_59 , V_278 , L_134 ) )
F_25 ( V_9 , V_283 -> V_294 , V_19 ) ;
else {
struct V_298 * * V_250 ;
F_64 ( V_299 ) ;
for ( V_250 = V_300 ; V_250 < V_301 ; V_250 ++ ) {
if ( F_58 ( V_59 , V_278 , ( * V_250 ) -> V_6 ) ) {
F_59 ( V_9 , V_283 -> V_294 , ( * V_250 ) -> V_8 ,
...
void F_65 ( struct V_302 * V_303 , struct V_18 * V_19 )
{
F_8 ( V_303 , L_11 ) ;
F_66 ( V_303 , V_19 -> V_42 . V_250 , V_19 -> V_42 . V_304 ) ;
