...
int F_22 ( struct V_38 * V_39 , unsigned short V_40 , T_1 V_41 )
{
struct V_1 * V_2 ;
struct V_12 * V_13 ;
unsigned long V_42 ;
...
struct V_59 * V_47 , struct V_60 * V_61 ,
unsigned int V_62 , enum V_63 V_6 ,
unsigned long V_42 , void * V_64 )
{
...
static void F_35 ( struct V_59 * V_47 )
{
struct V_1 * V_2 = F_30 ( V_47 ) ;
unsigned long V_42 ;
F_18 ( & V_2 -> V_36 . V_48 , V_42 ) ;
...
static enum V_68 F_38 ( struct V_59 * V_47 ,
T_3 V_69 , struct V_70 * V_71 )
{
struct V_1 * V_2 = F_30 ( V_47 ) ;
struct V_34 * V_35 ;
enum V_68 V_41 ;
...
static int F_42 ( struct V_59 * V_47 ,
struct V_10 * V_11 )
{
struct V_1 * V_2 = F_30 ( V_47 ) ;
if ( ! F_43 ( V_11 -> V_6 ) )
...
static int F_44 ( struct V_59 * V_47 )
{
struct V_1 * V_2 = F_30 ( V_47 ) ;
unsigned long V_42 ;
F_18 ( & V_2 -> V_36 . V_48 , V_42 ) ;
if ( V_2 -> V_13 && V_2 -> V_13 -> V_41 == V_66 ) {
F_1 ( V_2 ) ;
V_2 -> V_13 -> V_41 = V_73 ;
}
F_20 ( & V_2 -> V_36 . V_48 , V_42 ) ;
...
static int F_45 ( struct V_59 * V_47 )
{
struct V_1 * V_2 = F_30 ( V_47 ) ;
unsigned long V_42 ;
F_18 ( & V_2 -> V_36 . V_48 , V_42 ) ;
if ( V_2 -> V_13 && V_2 -> V_13 -> V_41 == V_73 ) {
V_2 -> V_13 -> V_41 = V_66 ;
F_3 ( V_2 ) ;
}
F_20 ( & V_2 -> V_36 . V_48 , V_42 ) ;
...
static int F_46 ( struct V_59 * V_47 )
{
struct V_1 * V_2 = F_30 ( V_47 ) ;
unsigned long V_42 ;
F_47 ( V_74 ) ;
...
static void F_50 ( struct V_59 * V_47 )
{
F_51 ( F_52 ( V_47 ) ) ;
}
...
{
struct V_75 * V_44 ;
void T_4 * V_32 = V_39 -> V_76 + V_39 -> V_77 ;
unsigned short V_19 ;
int V_78 ;
V_44 = F_54 ( V_39 -> V_79 , sizeof( * V_44 ) , V_80 ) ;
if ( ! V_44 )
return - V_81 ;
V_39 -> V_44 = V_44 ;
V_44 -> V_45 = ( V_39 -> V_65 - V_39 -> V_77 ) / V_82 ;
V_44 -> V_47 = F_55 ( V_39 -> V_79 , V_44 -> V_45 ,
sizeof( * V_44 -> V_47 ) , V_80 ) ;
if ( ! V_44 -> V_47 )
return - V_81 ;
F_56 ( & V_44 -> V_83 . V_84 ) ;
...
V_2 -> V_36 . V_85 = F_28 ;
F_57 ( & V_2 -> V_36 , & V_44 -> V_83 ) ;
V_2 -> V_6 = ( V_19 & 0x1 ) ? V_9 : V_7 ;
V_2 -> V_86 = V_32 + V_19 * V_82 ;
}
F_58 ( V_87 , V_44 -> V_83 . V_88 ) ;
F_58 ( V_89 , V_44 -> V_83 . V_88 ) ;
V_44 -> V_83 . V_90 = F_50 ;
V_44 -> V_83 . V_91 = F_29 ;
V_44 -> V_83 . V_92 = F_35 ;
V_44 -> V_83 . V_93 = F_38 ;
...
V_44 -> V_83 . V_97 = F_46 ;
V_44 -> V_83 . V_98 = V_99 ;
V_44 -> V_83 . V_100 = V_99 ;
V_44 -> V_83 . V_101 = F_59 ( V_9 ) | F_59 ( V_7 ) ;
V_44 -> V_83 . V_102 = V_103 ;
V_44 -> V_83 . V_79 = V_39 -> V_79 ;
F_60 ( V_44 -> V_83 . V_79 , V_104 ) ;
V_78 = F_61 ( & V_44 -> V_83 ) ;
if ( V_78 )
return V_78 ;
F_62 ( V_39 -> V_79 , L_1 , V_44 -> V_45 ) ;
return 0 ;
}
int F_63 ( struct V_38 * V_39 )
{
struct V_75 * V_44 = V_39 -> V_44 ;
unsigned short V_19 ;
F_64 ( & V_44 -> V_83 ) ;
for ( V_19 = 0 ; V_19 < V_44 -> V_45 ; V_19 ++ ) {
struct V_1 * V_2 = & V_44 -> V_47 [ V_19 ] ;
