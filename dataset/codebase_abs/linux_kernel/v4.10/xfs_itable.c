...
V_137 = * V_131 ;
V_138 . V_123 = & V_92 ;
V_138 . V_126 = V_137 * V_118 ; ;
V_138 . V_129 = 0 ;
* V_131 = 0 ;
* V_132 = 0 ;
V_135 = F_33 ( & V_134 , V_140 , V_140 * 4 ) ;
if ( ! V_135 )
return - V_23 ;
V_136 = V_134 / sizeof( * V_135 ) ;
while ( V_94 < V_1 -> V_3 . V_139 ) {
struct V_95 * V_117 = V_135 ;
struct V_95 * V_141 = V_135 + V_136 ;
bool V_142 = false ;
int V_111 = 0 ;
int V_11 ;
...
if ( V_110 > 0 ) {
struct V_95 V_144 ;
error = F_23 ( V_109 , V_110 , & V_111 , & V_144 ) ;
if ( error )
goto V_145;
if ( V_111 ) {
V_117 -> V_103 = V_144 . V_103 ;
V_117 -> V_146 = V_144 . V_146 ;
V_117 -> V_116 = V_144 . V_116 ;
V_117 -> V_115 = V_144 . V_115 ;
V_117 -> V_106 = V_144 . V_106 ;
V_117 ++ ;
}
error = F_36 ( V_109 , 0 , & V_11 ) ;
} else {
error = F_24 ( V_109 , 0 , V_147 , & V_11 ) ;
}
if ( error || V_11 == 0 ) {
V_142 = true ;
goto V_145;
}
while ( V_117 < V_141 && V_111 < V_137 ) {
struct V_95 V_144 ;
error = F_25 ( V_109 , & V_144 , & V_11 ) ;
if ( error || V_11 == 0 ) {
V_142 = true ;
goto V_145;
}
if ( V_144 . V_115 < V_144 . V_116 ) {
F_16 ( V_1 , V_94 , & V_144 ) ;
V_117 -> V_103 = V_144 . V_103 ;
V_117 -> V_146 = V_144 . V_146 ;
V_117 -> V_116 = V_144 . V_116 ;
...
F_40 (
void T_3 * V_92 ,
const struct V_150 * V_7 ,
long V_151 ,
long * V_152 )
{
if ( F_14 ( V_92 , V_7 , V_151 * sizeof( * V_7 ) ) )
return - V_93 ;
* V_152 = V_151 * sizeof( * V_7 ) ;
return 0 ;
}
int
F_41 (
...
T_14 V_9 )
{
T_6 V_94 = F_31 ( V_1 , * V_153 ) ;
T_8 V_110 = F_32 ( V_1 , * V_153 ) ;
struct V_108 * V_109 = NULL ;
struct V_154 * V_133 = NULL ;
struct V_150 * V_7 ;
int V_155 ;
int V_156 = * V_151 ;
int V_157 = 0 ;
...
* V_151 = 0 ;
if ( V_94 >= V_1 -> V_3 . V_139 ||
* V_153 != F_29 ( V_1 , V_94 , V_110 ) )
return error ;
V_155 = F_42 ( V_156 , ( int ) ( V_140 / sizeof( * V_7 ) ) ) ;
V_7 = F_43 ( V_155 * sizeof( * V_7 ) , V_21 ) ;
do {
struct V_95 V_144 ;
int V_11 ;
if ( ! V_133 ) {
...
if ( ! V_11 )
goto V_158;
V_110 = V_144 . V_103 + V_105 - 1 ;
V_7 [ V_157 ] . V_159 =
F_29 ( V_1 , V_94 , V_144 . V_103 ) ;
V_7 [ V_157 ] . V_160 = V_144 . V_116 - V_144 . V_115 ;
V_7 [ V_157 ] . V_161 = ~ V_144 . V_106 ;
if ( ++ V_157 == V_155 ) {
long V_152 ;
error = V_9 ( V_92 , V_7 , V_157 , & V_152 ) ;
if ( error )
break;
V_92 += V_152 ;
* V_151 += V_157 ;
