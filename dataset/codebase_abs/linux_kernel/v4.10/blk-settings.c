...
void F_12 ( struct V_1 * V_2 , T_7 V_52 )
{
unsigned long V_53 = V_52 >> V_36 ;
int V_54 = 0 ;
V_2 -> V_55 = V_56 ;
#if V_57 == 64
if ( V_53 < ( F_13 ( T_7 , 0xffffffffUL , V_51 ) >> V_36 ) )
V_54 = 1 ;
V_2 -> V_50 . V_34 = F_14 ( V_58 , V_53 ) ;
#else
if ( V_53 < V_59 )
V_54 = 1 ;
V_2 -> V_50 . V_34 = V_53 ;
...
void F_26 ( struct V_1 * V_2 , unsigned int V_66 )
{
if ( V_66 < V_61 ) {
V_66 = V_61 ;
F_17 ( V_62 L_1 ,
...
void F_27 ( struct V_1 * V_2 , unsigned short V_67 )
{
V_2 -> V_50 . V_31 = V_67 ;
...
void F_30 ( struct V_8 * V_50 , unsigned int V_69 )
{
V_50 -> V_33 = V_69 ;
...
void F_32 ( struct V_8 * V_50 , unsigned int V_70 )
{
V_50 -> V_38 = V_70 ;
}
...
void F_34 ( struct V_1 * V_71 , struct V_1 * V_72 )
{
F_35 ( & V_71 -> V_50 , & V_72 -> V_50 , 0 ) ;
}
int F_35 ( struct V_8 * V_71 , struct V_8 * V_72 ,
T_8 V_73 )
{
unsigned int V_74 , V_75 , V_76 , V_77 = 0 ;
V_71 -> V_18 = F_18 ( V_71 -> V_18 , V_72 -> V_18 ) ;
V_71 -> V_19 = F_18 ( V_71 -> V_19 , V_72 -> V_19 ) ;
V_71 -> V_21 = F_18 ( V_71 -> V_21 , V_72 -> V_21 ) ;
V_71 -> V_23 = V_69 ( V_71 -> V_23 ,
V_72 -> V_23 ) ;
...
V_71 -> V_38 = F_37 ( V_71 -> V_38 , V_72 -> V_38 ) ;
V_71 -> V_40 &= V_72 -> V_40 ;
V_71 -> V_30 &= V_72 -> V_30 ;
...
if ( V_71 -> V_27 != 0 &&
V_71 -> V_28 != V_76 ) {
V_74 = V_71 -> V_27 + V_71 -> V_28 ;
V_75 = V_72 -> V_27 + V_76 ;
if ( ( F_14 ( V_74 , V_75 ) % V_69 ( V_74 , V_75 ) ) != 0 )
V_71 -> V_29 = 1 ;
}
V_71 -> V_25 = F_18 ( V_71 -> V_25 ,
V_72 -> V_25 ) ;
V_71 -> V_26 = F_18 ( V_71 -> V_26 ,
V_72 -> V_26 ) ;
V_71 -> V_27 = F_14 ( V_71 -> V_27 ,
V_72 -> V_27 ) ;
V_71 -> V_28 = F_37 ( V_71 -> V_28 , V_76 ) %
V_71 -> V_27 ;
}
if ( V_72 -> V_22 )
V_71 -> V_22 = F_18 ( V_71 -> V_22 ,
V_72 -> V_22 ) ;
return V_77 ;
}
int F_39 ( struct V_8 * V_71 , struct V_79 * V_80 ,
T_8 V_73 )
{
struct V_1 * V_81 = F_40 ( V_80 ) ;
V_73 += F_41 ( V_80 ) ;
return F_35 ( V_71 , & V_81 -> V_50 , V_73 ) ;
}
void F_42 ( struct V_82 * V_83 , struct V_79 * V_80 ,
T_8 V_68 )
{
struct V_1 * V_71 = V_83 -> V_84 ;
if ( F_39 ( & V_71 -> V_50 , V_80 , V_68 >> 9 ) < 0 ) {
...
void F_45 ( struct V_1 * V_2 , unsigned int V_87 )
{
V_2 -> V_88 = V_87 ;
}
...
void F_49 ( struct V_1 * V_2 , unsigned long V_87 )
{
if ( V_87 < V_61 - 1 ) {
V_87 = V_61 - 1 ;
F_17 ( V_62 L_3 ,
...
void F_51 ( struct V_1 * V_2 , int V_87 )
{
F_20 ( V_87 > V_61 ) ;
if ( V_87 > V_2 -> V_94 )
V_2 -> V_94 = V_87 ;
}
void F_52 ( struct V_1 * V_2 , bool V_95 )
{
F_53 ( V_2 -> V_96 ) ;
if ( V_95 )
F_54 ( V_97 , & V_2 -> V_98 ) ;
...
void F_57 ( struct V_1 * V_2 , unsigned int V_99 )
{
V_2 -> V_100 = V_99 ;
F_58 ( V_2 -> V_101 , V_99 ) ;
}
void F_59 ( struct V_1 * V_2 , bool V_102 , bool V_103 )
{
F_53 ( V_2 -> V_96 ) ;
if ( V_102 )
F_60 ( V_104 , V_2 ) ;
...
F_61 ( V_105 , V_2 ) ;
F_56 ( V_2 -> V_96 ) ;
F_62 ( V_2 -> V_101 , F_63 ( V_104 , & V_2 -> V_98 ) ) ;
}
