...
F_24 ( & V_2 -> V_35 ) ;
F_5 ( V_2 , V_37 ) ;
F_32 (req, tmp, &xprt->bc_pa_list, rq_bc_pa_list) {
F_8 ( L_10 , V_7 ) ;
F_29 ( & V_7 -> V_34 ) ;
F_7 ( V_7 ) ;
if ( -- V_37 == 0 )
...
static struct V_6 * F_33 ( struct V_1 * V_2 , T_2 V_41 )
{
struct V_6 * V_7 = NULL ;
F_8 ( L_14 ) ;
if ( F_2 ( & V_2 -> V_4 ) <= 0 )
...
struct V_6 * F_40 ( struct V_1 * V_2 , T_2 V_41 )
{
struct V_6 * V_7 ;
F_41 ( & V_2 -> V_35 ) ;
F_42 (req, &xprt->bc_pa_list, rq_bc_pa_list) {
