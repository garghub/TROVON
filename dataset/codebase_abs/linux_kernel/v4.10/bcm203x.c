...
return - V_39 ;
V_3 = F_16 ( & V_31 -> V_7 , sizeof( * V_3 ) , V_29 ) ;
if ( ! V_3 )
return - V_40 ;
V_3 -> V_6 = V_6 ;
V_3 -> V_10 = V_12 ;
...
if ( ! V_3 -> V_1 )
return - V_40 ;
if ( F_18 ( & V_34 , L_8 , & V_6 -> V_7 ) < 0 ) {
F_3 ( L_9 ) ;
F_19 ( V_3 -> V_1 ) ;
return - V_41 ;
}
F_2 ( L_10 , V_34 -> V_3 , V_34 -> V_35 ) ;
V_35 = F_20 ( V_24 , V_34 -> V_35 , 4096 ) ;
V_3 -> V_13 = F_21 ( V_35 , V_29 ) ;
if ( ! V_3 -> V_13 ) {
F_3 ( L_11 ) ;
F_22 ( V_34 ) ;
F_19 ( V_3 -> V_1 ) ;
...
F_22 ( V_34 ) ;
if ( F_18 ( & V_34 , L_12 , & V_6 -> V_7 ) < 0 ) {
F_3 ( L_13 ) ;
F_19 ( V_3 -> V_1 ) ;
F_23 ( V_3 -> V_13 ) ;
return - V_41 ;
}
F_2 ( L_14 , V_34 -> V_3 , V_34 -> V_35 ) ;
