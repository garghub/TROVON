...
F_33 ( V_19 , V_92 ,
0 , V_93 , 0 , 0 ) ;
F_34 ( V_19 , V_25 , V_23 . V_33 ) ;
F_34 ( V_19 , V_26 , V_23 . V_33 ) ;
F_35 ( V_76 , L_5 , V_77 ) ;
if ( V_13 -> V_14 && V_13 -> V_16 )
V_13 -> V_88 = 0xE3 ;
else
...
static void F_39 ( struct V_18 * V_19 , struct V_13 * V_13 ,
struct V_44 * V_44 )
{
V_19 -> V_94 = V_13 -> V_94 ;
V_19 -> V_88 . V_95 = V_96 ;
...
static void F_41 ( struct V_44 * V_44 )
{
struct V_13 * V_13 = F_15 ( V_44 ) ;
F_42 ( V_44 ) ;
if ( V_13 -> V_37 )
...
static int F_46 ( struct V_44 * V_44 , struct V_103 * V_104 )
{
struct V_13 * V_13 ;
struct V_18 * V_105 ;
struct V_18 * V_106 ;
...
V_13 = F_47 ( sizeof( struct V_13 ) , V_109 ) ;
V_105 = F_48 () ;
V_106 = F_48 () ;
if ( ! V_13 || ! V_105 || ! V_106 ) {
V_71 = - V_110 ;
...
F_49 ( & V_13 -> V_72 ) ;
F_20 ( & V_13 -> V_63 ) ;
snprintf ( V_13 -> V_94 , sizeof( V_13 -> V_94 ) , L_7 , V_44 -> V_94 ) ;
F_45 ( V_44 , V_13 ) ;
V_71 = F_50 ( V_44 , V_104 ) ;
if ( V_71 )
goto V_112;
V_71 = F_29 ( V_13 ) ;
if ( V_71 )
goto V_113;
F_51 ( V_76 , L_8 , sizeof( V_76 ) ) ;
...
if ( ! V_107 ) {
F_51 ( V_13 -> V_114 , V_76 , sizeof( V_13 -> V_114 ) ) ;
F_35 ( V_13 -> V_114 , L_9 , sizeof( V_13 -> V_114 ) ) ;
V_105 -> V_115 = V_13 -> V_114 ;
F_39 ( V_105 , V_13 , V_44 ) ;
V_71 = F_52 ( V_13 -> V_37 ) ;
if ( V_71 )
goto V_113;
} else {
...
if ( ! V_108 ) {
F_51 ( V_13 -> V_116 , V_76 , sizeof( V_13 -> V_116 ) ) ;
F_35 ( V_13 -> V_116 , L_10 ,
sizeof( V_13 -> V_116 ) ) ;
V_106 -> V_115 = V_13 -> V_116 ;
F_39 ( V_106 , V_13 , V_44 ) ;
V_71 = F_52 ( V_13 -> V_20 ) ;
if ( V_71 )
goto V_117;
} else {
