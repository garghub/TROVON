...
V_104 = F_12 ( V_78 ) ;
if ( F_60 ( V_173 + V_174 + V_78 -> V_118
+ F_61 ( struct V_76 ,
V_108 . V_128 . V_99 ) ,
V_104 -> V_108 . V_109 . V_110 -> V_99 ,
strlen ( V_104 -> V_108 . V_109 . V_110 -> V_99 ) + 1 ) != 0 ) {
V_10 = - V_177 ;
goto V_178;
}
}
...
static void F_63 ( void * V_179 , const void * V_55 )
{
int V_111 = * ( V_180 * ) V_55 ;
if ( V_111 > 0 )
V_111 += F_64 ( V_140 , V_111 ) ;
memcpy ( V_179 , & V_111 , sizeof( V_111 ) ) ;
}
static int F_65 ( void T_5 * V_179 , const void * V_55 )
{
V_180 V_181 = * ( int * ) V_55 ;
if ( V_181 > 0 )
V_181 -= F_64 ( V_140 , V_181 ) ;
return F_60 ( V_179 , & V_181 , sizeof( V_181 ) ) ? - V_177 : 0 ;
}
static int F_66 ( const struct V_77 * V_78 ,
...
V_104 = F_12 ( V_78 ) ;
V_174 += F_67 ( V_104 -> V_108 . V_109 . V_110 ) ;
V_119 -> V_131 -= V_174 ;
V_10 = F_68 ( V_140 , V_182 , V_174 ) ;
if ( V_10 )
return V_10 ;
for ( V_9 = 0 ; V_9 < V_123 ; V_9 ++ ) {
if ( V_2 -> V_102 [ V_9 ] &&
...
static int F_69 ( const struct V_94 * V_2 ,
struct V_94 * V_119 )
{
struct V_77 * V_160 ;
const void * V_176 ;
...
V_119 -> V_184 = 0 ;
V_176 = V_2 -> V_101 ;
F_70 ( V_140 , V_2 -> V_135 ) ;
F_48 (iter, loc_cpu_entry, info->size) {
V_10 = F_66 ( V_160 , V_2 , V_176 , V_119 ) ;
if ( V_10 != 0 )
return V_10 ;
}
return 0 ;
}
static int F_71 ( struct V_185 * V_185 , void T_5 * V_128 ,
...
return - V_154 ;
if ( F_72 ( V_99 , V_128 , sizeof( V_99 ) ) != 0 )
return - V_177 ;
V_99 [ V_187 - 1 ] = '\0' ;
#ifdef F_73
if ( V_186 )
F_74 ( V_140 ) ;
#endif
V_104 = F_75 ( F_76 ( V_185 , V_140 , V_99 ) ,
L_2 , V_99 ) ;
if ( V_104 ) {
struct V_188 V_2 ;
...
static int F_80 ( struct V_185 * V_185 , struct V_190 T_5 * V_191 ,
const int * V_8 )
{
int V_10 ;
struct V_190 V_192 ;
...
static int F_81 ( struct V_185 * V_185 , const char * V_99 ,
unsigned int V_120 ,
struct V_94 * V_119 ,
unsigned int V_195 ,
void T_5 * V_196 )
...
V_197 = F_82 ( V_104 , V_195 , V_119 , & V_10 ) ;
if ( ! V_197 )
goto V_200;
...
static int F_85 ( struct V_185 * V_185 , const void T_5 * V_128 ,
unsigned int V_8 )
{
int V_10 ;
struct V_158 V_168 ;
...
void * V_176 ;
struct V_77 * V_160 ;
if ( F_72 ( & V_168 , V_128 , sizeof( V_168 ) ) != 0 )
return - V_177 ;
...
V_119 = F_86 ( V_168 . V_131 ) ;
if ( ! V_119 )
return - V_145 ;
V_176 = V_119 -> V_101 ;
if ( F_72 ( V_176 , V_128 + sizeof( V_168 ) ,
V_168 . V_131 ) != 0 ) {
V_10 = - V_177 ;
goto V_202;
}
...
if ( V_10 != 0 )
goto V_202;
V_10 = F_81 ( V_185 , V_168 . V_99 , V_168 . V_120 , V_119 ,
...
struct V_77 * V_160 ;
unsigned int V_97 ;
V_205 = F_88 ( V_128 , V_8 , & V_168 , V_186 ) ;
if ( F_37 ( V_205 ) )
return F_38 ( V_205 ) ;
V_104 = F_76 ( V_185 , V_140 , V_168 . V_99 ) ;
if ( ! V_104 ) {
V_10 = - V_189 ;
goto free;
}
...
static inline void F_89 ( struct V_183 * V_78 )
{
struct V_76 * V_104 ;
V_104 = F_90 ( V_78 ) ;
F_39 ( V_104 -> V_108 . V_109 . V_110 -> V_148 ) ;
...
if ( ! F_9 ( & V_78 -> V_65 ) )
return - V_154 ;
V_10 = F_92 ( V_78 , V_78 -> V_155 , V_78 -> V_118 ,
V_78 -> V_82 ) ;
if ( V_10 )
return V_10 ;
V_174 = sizeof( struct V_77 ) - sizeof( struct V_183 ) ;
...
static void
F_93 ( struct V_183 * V_78 , void * * V_209 ,
unsigned int * V_131 ,
...
static int F_95 ( struct V_94 * * V_212 ,
void * * V_213 ,
...
V_216 = 0 ;
F_74 ( V_140 ) ;
F_70 ( V_140 , V_215 -> V_161 ) ;
F_48 (iter0, entry0, compatr->size) {
V_10 = F_91 ( V_218 , V_2 , & V_131 ,
V_121 ,
V_121 + V_215 -> V_131 ) ;
if ( V_10 != 0 )
goto V_219;
...
static int F_96 ( struct V_185 * V_185 , void T_5 * V_128 ,
unsigned int V_8 )
{
int V_10 ;
struct V_214 V_168 ;
...
return - V_145 ;
V_176 = V_119 -> V_101 ;
if ( F_72 ( V_176 , V_128 + sizeof( V_168 ) , V_168 . V_131 ) != 0 ) {
V_10 = - V_177 ;
goto V_202;
}
V_10 = F_95 ( & V_119 , & V_176 , & V_168 ) ;
if ( V_10 != 0 )
goto V_202;
V_10 = F_81 ( V_185 , V_168 . V_99 , V_168 . V_120 , V_119 ,
V_168 . V_195 , F_97 ( V_168 . V_107 ) ) ;
if ( V_10 )
goto V_203;
return 0 ;
V_203:
...
static int F_98 ( struct V_220 * V_221 , int V_222 , void T_5 * V_128 ,
unsigned int V_8 )
{
int V_10 ;
if ( ! F_99 ( F_100 ( V_221 ) -> V_223 , V_224 ) )
return - V_225 ;
switch ( V_222 ) {
case V_226 :
V_10 = F_96 ( F_100 ( V_221 ) , V_128 , V_8 ) ;
break;
case V_227 :
V_10 = F_87 ( F_100 ( V_221 ) , V_128 , V_8 , 1 ) ;
break;
default:
V_10 = - V_154 ;
}
...
static int F_101 ( struct V_77 * V_78 , void T_5 * * V_209 ,
T_6 * V_131 ,
struct V_105 * V_107 ,
unsigned int V_9 )
{
...
V_104 = F_13 ( V_78 ) ;
V_10 = F_102 ( V_104 , V_209 , V_131 ) ;
if ( V_10 )
return V_10 ;
V_82 = V_78 -> V_82 - ( V_211 - * V_131 ) ;
if ( F_103 ( V_118 , & V_228 -> V_118 ) != 0 ||
F_103 ( V_82 , & V_228 -> V_82 ) != 0 )
return - V_177 ;
return 0 ;
}
static int F_104 ( unsigned int V_172 ,
struct V_1 * V_85 ,
void T_5 * V_173 )
{
struct V_105 * V_107 ;
...
static int F_105 ( struct V_185 * V_185 ,
...
static int F_106 ( struct V_220 * V_221 , int V_222 , void T_5 * V_128 ,
int * V_8 )
{
int V_10 ;
if ( ! F_99 ( F_100 ( V_221 ) -> V_223 , V_224 ) )
...
switch ( V_222 ) {
case V_230 :
V_10 = F_71 ( F_100 ( V_221 ) , V_128 , V_8 , 1 ) ;
break;
case V_231 :
V_10 = F_105 ( F_100 ( V_221 ) , V_128 , V_8 ) ;
break;
default:
V_10 = F_107 ( V_221 , V_222 , V_128 , V_8 ) ;
}
return V_10 ;
}
static int F_108 ( struct V_220 * V_221 , int V_222 , void T_5 * V_128 , unsigned int V_8 )
{
int V_10 ;
if ( ! F_99 ( F_100 ( V_221 ) -> V_223 , V_224 ) )
return - V_225 ;
switch ( V_222 ) {
case V_226 :
V_10 = F_85 ( F_100 ( V_221 ) , V_128 , V_8 ) ;
break;
case V_227 :
V_10 = F_87 ( F_100 ( V_221 ) , V_128 , V_8 , 0 ) ;
break;
default:
V_10 = - V_154 ;
}
...
static int F_107 ( struct V_220 * V_221 , int V_222 , void T_5 * V_128 , int * V_8 )
{
int V_10 ;
if ( ! F_99 ( F_100 ( V_221 ) -> V_223 , V_224 ) )
return - V_225 ;
switch ( V_222 ) {
case V_230 :
V_10 = F_71 ( F_100 ( V_221 ) , V_128 , V_8 , 0 ) ;
break;
case V_231 :
V_10 = F_80 ( F_100 ( V_221 ) , V_128 , V_8 ) ;
break;
case V_232 : {
struct V_233 V_234 ;
if ( * V_8 != sizeof( V_234 ) ) {
...
if ( F_72 ( & V_234 , V_128 , sizeof( V_234 ) ) != 0 ) {
V_10 = - V_177 ;
break;
}
V_234 . V_99 [ sizeof( V_234 . V_99 ) - 1 ] = 0 ;
F_75 ( F_109 ( V_140 , V_234 . V_99 ,
V_234 . V_146 , 1 , & V_10 ) ,
L_4 , V_234 . V_99 ) ;
break;
}
...
if ( V_10 != 0 )
goto V_162;
V_241 = F_113 ( V_185 , V_85 , & V_240 , V_119 ) ;
if ( F_37 ( V_241 ) ) {
V_10 = F_38 ( V_241 ) ;
goto V_162;
}
F_114 ( * V_239 , V_241 ) ;
V_10 = F_115 ( V_185 , V_238 , F_116 ( V_85 -> V_120 ) ) ;
if ( V_10 != 0 ) {
F_110 ( V_241 ) ;
* V_239 = NULL ;
}
...
void F_117 ( struct V_185 * V_185 , struct V_1 * V_85 ,
const struct V_237 * V_238 )
{
F_118 ( V_185 , V_238 , F_116 ( V_85 -> V_120 ) ) ;
F_110 ( V_85 ) ;
}
static int T_8 F_119 ( struct V_185 * V_185 )
{
return F_120 ( V_185 , V_140 ) ;
}
static void T_9 F_121 ( struct V_185 * V_185 )
{
F_122 ( V_185 , V_140 ) ;
}
