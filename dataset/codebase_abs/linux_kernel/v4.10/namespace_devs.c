...
struct V_151 * V_170 ;
V_58 = & V_7 -> V_59 [ V_68 ] ;
V_153 = F_129 ( & V_58 -> V_128 ,
F_130 ( * V_153 ) , V_167 ) ;
V_170 = V_153 ? V_153 -> V_156 : 0 ;
if ( ! V_170 ) {
F_67 ( 1 ) ;
continue;
}
V_64 += F_121 ( V_170 -> V_166 ) ;
if ( F_122 ( V_170 -> V_157 ) != 0 )
continue;
F_67 ( V_6 -> V_11 || V_6 -> V_12 ) ;
V_6 -> V_11 = F_38 ( ( void V_171 * ) V_170 -> V_37 ,
V_54 , V_52 ) ;
V_6 -> V_12 = F_38 ( ( void V_171 * ) V_170 -> V_12 ,
V_24 , V_52 ) ;
}
...
static int F_148 ( const void * V_136 , const void * V_179 )
{
const struct V_1 * V_180 = * ( const struct V_1 * * ) V_136 ;
const struct V_1 * V_181 = * ( const struct V_1 * * ) V_179 ;
struct V_13 * V_182 , * V_183 ;
struct V_5 * V_184 , * V_185 ;
if ( F_12 ( V_180 ) )
return 0 ;
if ( F_11 ( V_180 ) ) {
V_182 = F_9 ( V_180 ) ;
V_183 = F_9 ( V_181 ) ;
return memcmp ( & V_182 -> V_15 [ 0 ] -> V_30 , & V_183 -> V_15 [ 0 ] -> V_30 ,
sizeof( T_4 ) ) ;
}
V_184 = F_5 ( V_180 ) ;
V_185 = F_5 ( V_181 ) ;
return memcmp ( & V_184 -> V_4 . V_15 . V_30 , & V_185 -> V_4 . V_15 . V_30 ,
sizeof( T_4 ) ) ;
}
...
struct V_152 * V_153 , * V_186 ;
struct V_58 * V_58 = & V_7 -> V_59 [ 0 ] ;
T_4 V_187 = V_58 -> V_30 + V_58 -> V_64 - 1 ;
...
if ( ! V_155 )
continue;
V_29 = F_151 ( V_155 -> V_29 ) ;
if ( F_20 ( & V_7 -> V_2 )
== ! ! ( V_29 & V_66 ) )
;
else
continue;
if ( V_155 -> V_106 < V_58 -> V_30 || V_155 -> V_106 > V_187 )
continue;
V_68 = F_145 ( V_7 , V_155 , V_147 , V_67 ) ;
if ( V_68 < 0 )
goto V_169;
if ( V_68 < V_67 )
continue;
V_188 = F_118 ( V_67 + 2 , sizeof( V_2 ) , V_52 ) ;
if ( ! V_188 )
goto V_169;
memcpy ( V_188 , V_147 , sizeof( V_2 ) * V_67 ) ;
F_3 ( V_147 ) ;
V_147 = V_188 ;
if ( F_20 ( & V_7 -> V_2 ) ) {
V_2 = F_147 ( V_7 , V_155 , V_67 ) ;
if ( F_94 ( V_2 ) )
goto V_169;
V_147 [ V_67 ++ ] = V_2 ;
} else {
...
F_152 ( V_58 ) ;
F_156 ( & V_167 , & V_58 -> V_128 ) ;
}
}
if ( V_67 > 1 )
F_157 ( V_147 , V_67 , sizeof( struct V_1 * ) , F_148 , NULL ) ;
return V_147 ;
V_169:
if ( V_147 ) {
...
for ( V_68 = 0 ; V_68 < V_7 -> V_78 ; V_68 ++ ) {
V_58 = & V_7 -> V_59 [ V_68 ] ;
F_159 ( & V_58 -> V_165 , V_68 ) ;
}
V_147 = F_149 ( V_7 ) ;
for ( V_68 = 0 ; V_68 < V_7 -> V_78 ; V_68 ++ ) {
int V_191 = V_7 -> V_78 - 1 - V_68 ;
V_58 = & V_7 -> V_59 [ V_191 ] ;
F_160 ( & V_58 -> V_165 ) ;
}
return V_147 ;
...
if ( ! V_153 )
break;
V_156 = F_165 ( V_61 , V_111 ) ;
V_153 -> V_156 = V_156 ;
F_166 ( & V_58 -> V_165 ) ;
F_167 ( & V_153 -> V_167 , & V_58 -> V_128 ) ;
F_160 ( & V_58 -> V_165 ) ;
}
if ( V_111 >= V_67 )
continue;
...
int F_168 ( struct V_7 * V_7 , int * V_169 )
{
