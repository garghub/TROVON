...
static
struct V_5 * F_105 ( struct V_258 * V_39 )
{
...
V_6 = F_105 ( V_221 -> V_260 ) ;
} else {
return - V_34 ;
}
V_144 = - V_167 ;
for ( V_7 = 0 ; V_7 < V_221 -> V_261 ; V_7 ++ ) {
T_1 V_227 = V_221 -> V_228 [ V_7 ] ;
T_1 V_203 = V_221 -> V_228 [ V_7 ] >> V_204 ;
if ( V_227 & ~ V_6 -> V_262 ) {
F_64 ( V_8 , L_15 ,
...
V_144 = - V_42 ;
V_57 = F_70 ( F_109 ( struct V_222 , V_232 [ V_7 ] ) ,
V_41 ) ;
if ( ! V_57 )
goto V_259;
V_57 -> V_6 = V_6 ;
...
static void F_111 ( struct V_15 * V_8 )
{
struct V_220 * V_221 = V_8 -> V_220 ;
if ( ! V_221 || V_221 -> V_237 != & V_40 )
return;
...
static struct V_224 * F_113 ( struct V_15 * V_8 )
{
struct V_220 * V_221 = V_8 -> V_220 ;
struct V_5 * V_6 = F_91 ( V_221 ) ;
...
static int F_119 ( struct V_15 * V_8 , struct V_268 * args )
{
T_2 V_269 = 0 ;
if ( args -> V_270 > 0 )
V_269 |= ( T_1 ) args -> args [ 0 ] ;
if ( args -> V_270 > 1 )
V_269 |= ( T_1 ) args -> args [ 1 ] << V_204 ;
return F_24 ( V_8 , & V_269 , 1 ) ;
}
...
F_80 ( V_6 , V_7 ) ;
if ( V_6 -> V_272 == V_273 ) {
V_69 = F_34 ( V_49 + V_274 ) ;
V_271 = ( V_69 >> V_275 ) & V_276 ;
V_69 = F_34 ( V_49 + V_277 ) ;
if ( V_271 >= 2 )
V_69 &= ~ V_278 ;
V_69 |= V_279 ;
F_33 ( V_69 , V_49 + V_277 ) ;
}
...
F_33 ( V_84 , V_82 + V_83 ) ;
if ( V_6 -> V_272 == V_273 ) {
V_69 = F_34 ( V_82 + V_280 ) ;
V_69 &= ~ V_281 ;
F_33 ( V_69 , V_82 + V_280 ) ;
}
}
F_33 ( 0 , V_49 + V_282 ) ;
F_33 ( 0 , V_49 + V_283 ) ;
V_69 = F_34 ( F_51 ( V_6 ) + V_284 ) ;
V_69 |= ( V_285 | V_286 | V_287 | V_288 ) ;
V_69 |= ( V_289 | V_290 ) ;
V_69 &= ~ V_291 ;
if ( V_292 )
V_69 |= V_293 ;
...
void T_3 * V_49 = F_32 ( V_6 ) ;
T_2 V_201 ;
bool V_298 , V_299 = V_6 -> V_105 & V_300 ;
int V_7 ;
F_5 ( V_6 -> V_8 , L_17 ) ;
F_5 ( V_6 -> V_8 , L_18 ,
V_6 -> V_75 == V_76 ? 2 : 1 ) ;
V_201 = F_34 ( V_49 + V_301 ) ;
if ( V_302 == 1 )
V_201 &= ~ ( V_303 | V_304 ) ;
else if ( V_302 == 2 )
V_201 &= ~ ( V_305 | V_304 ) ;
...
F_5 ( V_6 -> V_8 ,
L_27 ) ;
V_66 = 1 << ( ( V_201 >> V_309 ) & V_310 ) ;
V_6 -> V_262 = V_66 - 1 ;
if ( V_201 & V_311 ) {
T_2 V_199 ;
V_6 -> V_105 |= V_312 ;
V_66 = ( V_201 >> V_313 ) & V_314 ;
if ( V_66 == 0 ) {
F_64 ( V_6 -> V_8 ,
L_28 ) ;
return - V_34 ;
}
V_199 = V_6 -> V_262 << V_202 ;
F_33 ( V_199 , V_49 + F_77 ( 0 ) ) ;
V_199 = F_34 ( V_49 + F_77 ( 0 ) ) ;
V_6 -> V_262 = V_199 >> V_202 ;
V_199 = V_6 -> V_262 << V_204 ;
F_33 ( V_199 , V_49 + F_77 ( 0 ) ) ;
V_199 = F_34 ( V_49 + F_77 ( 0 ) ) ;
V_6 -> V_263 = V_199 >> V_204 ;
V_6 -> V_200 = F_123 ( V_6 -> V_8 , V_66 , sizeof( * V_6 -> V_200 ) ,
V_41 ) ;
if ( ! V_6 -> V_200 )
return - V_42 ;
F_5 ( V_6 -> V_8 ,
...
V_6 -> V_209 = F_124 ( V_6 -> V_8 , V_66 , sizeof( * V_6 -> V_209 ) ,
V_41 ) ;
if ( ! V_6 -> V_209 )
return - V_42 ;
...
V_6 -> V_218 = V_66 ;
F_72 ( & V_6 -> V_226 ) ;
if ( V_6 -> V_75 < V_76 || ! ( V_201 & V_315 ) ) {
V_6 -> V_105 |= V_157 ;
if ( ! ( V_201 & V_316 ) )
V_6 -> V_105 |= V_162 ;
}
V_201 = F_34 ( V_49 + V_317 ) ;
V_6 -> V_318 = ( V_201 & V_319 ) ? 16 : 12 ;
V_66 = 1 << ( ( ( V_201 >> V_320 ) & V_321 ) + 1 ) ;
V_66 *= 2 << V_6 -> V_318 ;
if ( V_6 -> V_66 != V_66 )
F_125 ( V_6 -> V_8 ,
L_30 ,
V_66 , V_6 -> V_66 ) ;
V_6 -> V_169 = ( V_201 >> V_322 ) & V_323 ;
V_6 -> V_180 = ( V_201 >> V_324 ) & V_325 ;
...
V_201 = F_34 ( V_49 + V_329 ) ;
V_66 = F_121 ( ( V_201 >> V_330 ) & V_331 ) ;
V_6 -> V_171 = V_66 ;
V_66 = F_121 ( ( V_201 >> V_332 ) & V_333 ) ;
V_6 -> V_176 = V_66 ;
if ( V_201 & V_334 )
V_6 -> V_105 |= V_106 ;
if ( F_127 ( V_6 -> V_8 , F_128 ( V_66 ) ) )
F_125 ( V_6 -> V_8 ,
L_33 ) ;
if ( V_6 -> V_75 < V_76 ) {
V_6 -> V_170 = V_6 -> V_171 ;
...
if ( V_6 -> V_105 & V_162 )
V_6 -> V_182 |= V_341 | V_342 | V_343 | V_344 ;
if ( V_6 -> V_105 &
( V_157 | V_166 ) )
V_6 -> V_182 |= V_341 | V_345 | V_346 ;
if ( V_6 -> V_105 & V_165 )
V_6 -> V_182 |= V_347 | V_348 ;
if ( V_6 -> V_105 & V_164 )
V_6 -> V_182 |= V_342 | V_349 ;
if ( V_40 . V_182 == - 1UL )
...
static int F_129 ( T_2 V_272 , struct V_5 * V_6 )
{
int V_144 = 0 ;
switch ( V_272 ) {
case V_350 :
...
static int F_130 ( struct V_355 * V_21 ,
struct V_5 * V_6 )
{
struct V_15 * V_8 = V_6 -> V_8 ;
struct V_356 * V_28 =
* (struct V_356 * * ) F_131 ( V_8 ) ;
struct V_357 * V_358 ;
int V_144 ;
V_358 = (struct V_357 * ) V_28 -> V_359 ;
V_144 = F_129 ( V_358 -> V_272 , V_6 ) ;
if ( V_144 < 0 )
return V_144 ;
V_6 -> V_191 = 1 ;
if ( V_358 -> V_241 & V_360 )
V_6 -> V_105 |= V_300 ;
return 0 ;
}
static inline int F_130 ( struct V_355 * V_21 ,
struct V_5 * V_6 )
{
return - V_34 ;
}
static int F_132 ( struct V_355 * V_21 ,
struct V_5 * V_6 )
{
const struct V_361 * V_23 ;
struct V_15 * V_8 = & V_21 -> V_8 ;
bool V_362 ;
if ( F_133 ( V_8 -> V_9 , L_37 ,
& V_6 -> V_191 ) ) {
F_64 ( V_8 , L_38 ) ;
return - V_34 ;
}
V_23 = F_134 ( V_8 ) ;
V_6 -> V_75 = V_23 -> V_75 ;
V_6 -> V_272 = V_23 -> V_272 ;
F_3 ( V_6 ) ;
V_362 = F_16 ( V_8 -> V_9 , L_2 , NULL ) ;
if ( V_362 && ! V_363 ) {
if ( ! V_196 )
F_135 ( L_39 ) ;
V_196 = true ;
...
static int F_137 ( struct V_355 * V_21 )
{
struct V_364 * V_365 ;
struct V_5 * V_6 ;
struct V_15 * V_8 = & V_21 -> V_8 ;
int V_366 , V_7 , V_29 ;
V_6 = F_138 ( V_8 , sizeof( * V_6 ) , V_41 ) ;
if ( ! V_6 ) {
F_64 ( V_8 , L_41 ) ;
return - V_42 ;
}
...
if ( V_29 )
return V_29 ;
V_365 = F_139 ( V_21 , V_367 , 0 ) ;
V_6 -> V_61 = F_140 ( V_8 , V_365 ) ;
if ( F_87 ( V_6 -> V_61 ) )
return F_88 ( V_6 -> V_61 ) ;
V_6 -> V_66 = F_141 ( V_365 ) ;
V_366 = 0 ;
while ( ( V_365 = F_139 ( V_21 , V_368 , V_366 ) ) ) {
V_366 ++ ;
if ( V_366 > V_6 -> V_191 )
V_6 -> V_181 ++ ;
}
...
V_6 -> V_190 = F_138 ( V_8 , sizeof( * V_6 -> V_190 ) * V_366 ,
V_41 ) ;
if ( ! V_6 -> V_190 ) {
F_64 ( V_8 , L_43 , V_366 ) ;
return - V_42 ;
}
for ( V_7 = 0 ; V_7 < V_366 ; ++ V_7 ) {
int V_79 = F_142 ( V_21 , V_7 ) ;
if ( V_79 < 0 ) {
F_64 ( V_8 , L_44 , V_7 ) ;
return - V_34 ;
}
...
static int F_150 ( struct V_355 * V_21 )
{
struct V_5 * V_6 = F_151 ( V_21 ) ;
if ( ! V_6 )
return - V_34 ;
if ( ! F_152 ( V_6 -> V_179 , V_372 ) )
F_64 ( & V_21 -> V_8 , L_48 ) ;
F_49 ( V_291 , F_51 ( V_6 ) + V_284 ) ;
return 0 ;
}
...
static int T_9 F_157 ( struct V_14 * V_27 )
{
int V_144 = F_153 () ;
if ( V_144 )
return V_144 ;
if ( ! F_158 ( V_27 , NULL , V_369 . V_374 ) )
return - V_34 ;
return 0 ;
}
static int T_9 F_159 ( struct V_375 * V_376 )
{
if ( F_160 ( V_377 ) )
return F_153 () ;
return 0 ;
