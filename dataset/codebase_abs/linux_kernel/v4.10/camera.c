...
struct V_23 * V_24 = F_61 ( V_148 ) -> V_152 ;
struct V_135 * V_136 ;
T_5 V_15 ;
if ( ! ( V_115 -> V_153 & V_154 ) ) {
V_15 = V_115 -> V_155 ( V_24 , NULL , 0 ) ;
if ( V_15 < 0 )
return V_15 ;
}
V_136 = & V_24 -> V_137 . V_138 [ V_115 -> V_136 ] ;
return F_62 ( V_134 , V_125 , V_149 , V_136 -> V_124 ,
V_136 -> V_141 ) ;
}
static T_5 F_63 ( struct V_148 * V_148 ,
...
if ( V_125 > 1024 )
return - V_81 ;
V_156 = F_34 ( V_125 + 1 , V_16 ) ;
if ( ! V_156 )
return - V_17 ;
if ( F_64 ( V_156 , V_134 , V_125 ) ) {
V_15 = - V_157 ;
goto V_82;
}
V_156 [ V_125 ] = '\0' ;
V_15 = V_115 -> V_155 ( V_24 , V_156 , V_125 ) ;
V_82:
F_35 ( V_156 ) ;
return V_15 ;
}
static int F_65 ( struct V_158 * V_158 , struct V_148 * V_148 )
{
unsigned int V_3 ;
for ( V_3 = 0 ; V_3 < F_2 ( V_159 ) ; ++ V_3 ) {
const struct V_150 * V_160 =
& V_159 [ V_3 ] ;
if ( ! strcmp ( V_148 -> V_161 . V_162 -> V_163 , V_160 -> V_21 ) ) {
V_148 -> V_151 = ( void * ) V_160 ;
break;
}
}
return 0 ;
...
char V_164 [ 27 ] ;
unsigned int V_3 ;
snprintf ( V_164 , 27 , L_23 , V_7 -> V_52 -> V_53 ,
V_24 -> V_61 -> V_165 ) ;
V_24 -> V_137 . V_166 = F_67 ( V_164 , F_68 () ) ;
if ( F_19 ( V_24 -> V_137 . V_166 ) ) {
F_9 ( V_24 , L_24 ,
F_20 ( V_24 -> V_137 . V_166 ) ) ;
return F_20 ( V_24 -> V_137 . V_166 ) ;
}
V_24 -> V_137 . V_138 = F_69 ( sizeof( * V_24 -> V_137 . V_138 ) *
V_167 ) ;
if ( ! V_24 -> V_137 . V_138 )
return - V_17 ;
for ( V_3 = 0 ; V_3 < F_2 ( V_159 ) ; ++ V_3 ) {
...
V_162 = F_70 ( V_160 -> V_21 , V_160 -> V_153 ,
V_24 -> V_137 . V_166 , V_24 ,
& V_168 ) ;
if ( F_19 ( V_162 ) ) {
F_9 ( V_24 ,
L_25 ,
V_160 -> V_21 , F_20 ( V_162 ) ) ;
return F_20 ( V_162 ) ;
}
}
return 0 ;
...
{
F_72 ( V_24 -> V_137 . V_166 ) ;
F_73 ( V_24 -> V_137 . V_138 ) ;
}
...
{
struct V_171 * V_172 =
F_76 ( V_170 , struct V_171 , V_173 ) ;
F_35 ( V_172 -> V_123 ) ;
}
static int F_77 ( struct V_174 * V_61 ,
const struct V_175 * V_165 )
{
struct V_6 * V_59 ;
struct V_23 * V_24 ;
T_1 V_176 = 0 ;
...
if ( V_61 -> V_177 != 2 )
return - V_178 ;
for ( V_3 = 0 ; V_3 < V_61 -> V_177 ; ++ V_3 ) {
struct V_179 * V_180 = & V_61 -> V_181 [ V_3 ] ;
switch ( V_180 -> V_182 ) {
case V_183 :
V_176 = F_11 ( V_180 -> V_165 ) ;
break;
case V_184 :
V_62 = F_11 ( V_180 -> V_165 ) ;
break;
default:
return - V_178 ;
}
...
if ( V_15 < 0 )
goto error;
V_24 -> V_185 . V_123 = V_24 ;
V_24 -> V_185 . V_186 = & V_187 ;
V_24 -> V_185 . V_53 = V_24 -> V_7 -> V_52 -> V_53 ;
V_24 -> V_185 . V_188 = F_75 ;
V_15 = F_81 ( & V_24 -> V_185 ) ;
if ( V_15 < 0 )
goto error;
F_82 ( V_61 , V_24 ) ;
F_32 ( V_24 -> V_61 ) ;
...
static void F_83 ( struct V_174 * V_61 )
{
struct V_23 * V_24 = F_84 ( V_61 ) ;
int V_15 ;
V_15 = F_29 ( V_61 ) ;
if ( V_15 )
F_38 ( V_61 ) ;
...
static int F_86 ( struct V_189 * V_20 )
{
struct V_174 * V_61 = F_87 ( V_20 ) ;
struct V_23 * V_24 = F_84 ( V_61 ) ;
if ( V_24 -> V_65 )
F_25 ( V_24 -> V_65 ) ;
F_25 ( V_24 -> V_7 ) ;
...
static int F_88 ( struct V_189 * V_20 )
{
struct V_174 * V_61 = F_87 ( V_20 ) ;
struct V_23 * V_24 = F_84 ( V_61 ) ;
int V_15 ;
