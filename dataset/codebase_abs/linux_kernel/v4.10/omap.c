...
V_4 -> V_250 = F_113 ( & V_239 -> V_42 , L_35 ) ;
if ( F_107 ( V_4 -> V_250 ) )
return F_108 ( V_4 -> V_250 ) ;
F_6 ( V_4 -> V_250 ) ;
V_4 -> V_12 = F_113 ( & V_239 -> V_42 , L_36 ) ;
if ( F_107 ( V_4 -> V_12 ) ) {
V_243 = F_108 ( V_4 -> V_12 ) ;
goto V_251;
}
V_4 -> V_181 = - 1 ;
V_4 -> V_182 = - 1 ;
V_4 -> V_96 = F_114 ( & V_239 -> V_42 , L_37 ) ;
if ( F_107 ( V_4 -> V_96 ) ) {
V_243 = F_108 ( V_4 -> V_96 ) ;
if ( V_243 == - V_245 ) {
F_115 ( V_4 -> V_12 ) ;
goto V_251;
}
...
V_4 -> V_98 = F_114 ( & V_239 -> V_42 , L_39 ) ;
if ( F_107 ( V_4 -> V_98 ) ) {
V_243 = F_108 ( V_4 -> V_98 ) ;
if ( V_243 == - V_245 ) {
if ( V_4 -> V_96 )
F_117 ( V_4 -> V_96 ) ;
F_115 ( V_4 -> V_12 ) ;
...
V_243 = F_118 ( V_4 -> V_131 , F_58 , 0 , V_252 , V_4 ) ;
if ( V_243 )
goto V_253;
if ( V_22 -> V_254 != NULL ) {
...
static int F_123 ( struct V_238 * V_239 )
{
struct V_8 * V_4 = F_124 ( V_239 ) ;
int V_33 ;
F_19 ( V_4 == NULL ) ;
for ( V_33 = 0 ; V_33 < V_4 -> V_36 ; V_33 ++ )
F_98 ( V_4 -> V_38 [ V_33 ] ) ;
