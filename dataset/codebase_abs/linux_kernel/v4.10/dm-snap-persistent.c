...
F_20 ( V_2 , V_2 -> V_47 + 1 ) )
V_2 -> V_62 = 0 ;
if ( V_2 -> V_62 && F_18 ( V_2 , V_48 , V_103 | V_104 ) )
V_2 -> V_62 = 0 ;
if ( V_2 -> V_77 == V_2 -> V_44 ) {
V_2 -> V_77 = 0 ;
V_2 -> V_47 ++ ;
...
* V_105 = V_99 . V_69 ;
* V_106 = V_99 . V_70 ;
for ( V_107 = 1 ; V_107 < V_2 -> V_77 ;
V_107 ++ ) {
F_36 ( V_2 , V_2 -> V_9 ,
V_2 -> V_77 - 1 - V_107 , & V_99 ) ;
if ( V_99 . V_69 != * V_105 - V_107 ||
V_99 . V_70 != * V_106 - V_107 )
break;
}
return V_107 ;
}
...
static int F_69 ( struct V_85 * V_6 , char * V_109 )
{
struct V_1 * V_2 ;
int V_3 ;
V_2 = F_70 ( sizeof( * V_2 ) , V_110 ) ;
if ( ! V_2 )
return - V_4 ;
V_2 -> V_6 = V_6 ;
V_2 -> V_62 = 1 ;
