...
struct V_142 * F_47 ( struct V_31 * V_32 )
{
return & V_32 -> V_50 . V_143 . V_144 ;
}
T_4 F_48 ( struct V_31 * V_32 )
{
return V_32 -> V_58 . V_145 -> V_146 ;
}
struct V_31 * F_49 ( struct V_38 * V_73 , void * V_90 ,
T_4 V_147 ,
T_4 V_148 )
{
struct V_31 * V_32 ;
struct V_142 * V_149 = NULL ;
int V_70 = - V_91 ;
...
V_148 ;
if ( F_52 ( V_32 , V_158 ) )
V_149 = & V_32 -> V_42 -> V_111 ;
F_53 ( & V_32 -> V_50 , V_149 ) ;
V_70 = F_54 ( & V_32 -> V_58 , V_32 ) ;
if ( V_70 < 0 )
goto V_159;
V_70 = F_55 ( & V_32 -> V_160 , V_32 ) ;
if ( V_70 < 0 )
goto V_161;
return V_32 ;
V_161:
...
int F_63 ( struct V_31 * V_32 , unsigned long V_165 )
{
...
return V_70 ;
while ( ! F_62 ( V_32 ) ) {
if ( V_166 && F_65 ( V_167 , V_165 + V_166 ) )
return - V_168 ;
F_17 ( L_63 ) ;
V_70 = F_66 ( V_32 -> V_151 ,
F_62 ( V_32 ) || ( V_32 -> V_152 < 0 ) ,
F_67 ( V_166 ) ) ;
if ( V_70 < 0 )
return V_70 ;
if ( V_32 -> V_152 < 0 )
