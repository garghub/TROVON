...
struct V_391 V_392 ;
const struct V_391 * V_479 ;
int V_480 ;
T_2 V_481 = 0 ;
T_2 V_482 = 0 ;
if ( V_1 ) {
F_280 ( & V_392 , V_1 ) ;
V_479 = F_337 ( F_338 ( V_483 ) , & V_392 ) ;
if ( ! V_479 ) {
F_306 ( L_117 , V_1 ) ;
return - V_221 ;
}
...
for ( V_504 = 0 , V_212 = 0 ;
( V_504 < V_240 ) && V_505 [ V_212 ] ; V_212 ++ ) {
T_7 V_272 ;
if ( ! F_344 ( V_505 [ V_212 ] , - 1 , ( T_4 * ) & V_272 , - 1 , NULL ) ||
! F_345 ( V_272 ) ) {
F_340 ( L_142 ,
V_505 [ V_212 ] ) ;
V_239 = 0 ;
} else {
if ( F_216 ( V_506 , V_272 ) == - 1 )
V_506 [ V_504 ++ ] = V_272 ;
else
F_340 ( L_143 ,
& V_272 ) ;
...
V_476 ) ;
F_339 ( L_149 ,
V_239 , V_479 -> string , V_504 ) ;
for ( V_212 = 0 ; V_212 < V_504 ; V_212 ++ )
F_347 ( L_150 , V_505 [ V_212 ] ) ;
F_347 ( L_151 ) ;
} else if ( V_494 ) {
F_307 ( L_152 ) ;
}
...
memcpy ( V_52 -> V_290 , V_506 , sizeof( V_506 ) ) ;
return 0 ;
}
static int F_350 ( struct V_14 * V_19 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_519 * V_520 = F_351 ( F_212 ( V_19 ) , V_521 ) ;
F_54 ( V_19 , L_161 ) ;
V_11 -> V_73 = F_352 ( V_19 -> V_59 , V_522 ) ;
if ( ! V_11 -> V_73 )
return - V_128 ;
F_353 ( V_19 ) ;
F_354 ( & V_11 -> V_474 , & V_520 -> V_523 ) ;
F_355 ( V_11 ) ;
F_356 ( V_11 ) ;
if ( F_357 ( V_19 -> V_86 ) &&
V_19 -> V_87 == V_524 )
...
{
struct V_519 * V_520 = F_351 ( V_393 , V_521 ) ;
V_520 -> V_393 = V_393 ;
F_365 ( & V_520 -> V_523 ) ;
F_366 ( V_520 ) ;
F_367 ( V_520 ) ;
