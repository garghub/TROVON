...
static int F_8 ( T_1 * V_30 , unsigned int V_31 , int V_32 )
{
T_2 V_33 ;
memset ( V_30 , 0 , V_32 ) ;
V_30 += V_32 ;
...
static inline int F_10 ( const T_1 * V_35 )
{
if ( 1 > V_35 [ 0 ] || V_35 [ 0 ] > 7 )
return - V_17 ;
return 0 ;
}
static int F_11 ( T_1 * V_35 , unsigned int V_36 , unsigned int V_29 ,
...
if ( V_36 )
* V_38 |= 64 ;
V_42 = F_8 ( V_38 + 16 - V_39 , V_37 , V_39 ) ;
return V_42 ;
}
static int F_12 ( T_1 * V_35 ,
struct V_43 * V_44 ,
struct V_5 * V_6 ,
unsigned int V_29 ,
unsigned int V_45 ,
...
V_42 = F_11 ( V_35 , V_36 , V_29 , V_45 , V_38 ) ;
if ( V_42 )
return V_42 ;
if ( V_54 ) {
memset ( V_54 , 0 , 16 ) ;
if ( V_36 <= 65280 ) {
* ( V_59 * ) V_54 = V_36 ;
F_13 ( V_54 + 2 , V_44 -> V_60 , 0 ,
V_52 , V_61 ) ;
} else {
* ( V_59 * ) V_54 = ( V_59 ) ( 0xfffe ) ;
* ( V_62 * ) & V_54 [ 2 ] = V_36 ;
F_13 ( V_54 + 6 , V_44 -> V_60 , 0 ,
V_52 , V_61 ) ;
}
}
if ( ! V_36 ) {
...
V_48 = F_14 ( V_48 , V_54 , & V_63 , V_6 -> V_14 -> V_64 ) ;
if ( V_63 != 16 )
return - V_17 ;
V_50 = F_14 ( V_50 , V_53 , & V_63 ,
V_6 -> V_14 -> V_64 ) ;
if ( V_63 != 16 )
return - V_17 ;
...
V_42 = F_16 ( V_6 , & V_6 -> V_65 ,
V_44 -> V_7 . V_71 & V_72 ) ;
if ( V_42 )
return V_42 ;
F_17 ( & ( V_6 -> V_73 -> V_74 ) ) ;
F_18 ( V_36 , & V_6 -> V_73 -> V_75 ) ;
} else {
unsigned int V_76 = 0 , V_77 ;
V_76 += V_52 ;
V_56 = F_19 ( V_78 , V_6 -> V_14 -> V_64 ,
V_79 . V_80 . V_56 / sizeof( struct V_47 ) ) ;
V_56 = F_19 ( V_78 , V_56 ,
V_6 -> V_14 -> V_81 / V_82 ) ;
do {
V_77 = F_19 ( V_62 , V_36 - V_76 ,
V_6 -> V_14 -> V_81 ) ;
V_48 = F_20 ( V_6 -> V_49 ,
V_6 -> V_14 -> V_64 ,
V_44 -> V_60 , V_76 ,
...
unsigned int V_29 = F_22 ( F_23 ( V_44 ) ) ;
...
V_45 -= V_29 ;
F_13 ( V_26 -> V_92 ,
V_44 -> V_60 , V_45 + V_44 -> V_36 , V_29 ,
V_61 ) ;
V_42 = F_12 ( V_88 -> V_93 , V_44 , V_6 , V_29 , V_45 , V_36 ,
V_9 -> V_18 . V_22 . V_57 ) ;
if ( V_42 )
goto V_46;
do {
...
F_15 ( V_9 ) &= ~ V_69 ;
F_15 ( V_6 -> V_9 ) &= ~ V_68 ;
V_42 = F_25 ( V_6 , V_88 , V_44 -> V_94 , V_44 -> V_60 ,
& V_77 , V_76 + V_44 -> V_36 ,
V_9 -> V_18 . V_22 . V_95 ) ;
if ( V_42 )
goto V_46;
...
V_42 = F_26 ( V_9 -> V_18 . V_22 . V_70 , V_26 -> V_92 ,
V_29 ) ? - V_101 : 0 ;
V_46:
F_27 ( & V_6 -> V_91 , V_90 ) ;
return V_42 ;
...
F_13 ( V_9 -> V_18 . V_22 . V_70 ,
V_44 -> V_94 , V_45 + V_44 -> V_36 , V_29 ,
V_102 ) ;
V_46:
F_27 ( & V_6 -> V_91 , V_90 ) ;
return V_42 ;
...
V_88 . V_93 = V_35 ;
return F_28 ( V_44 , & V_88 , V_44 -> V_36 - 8 ) ;
}
...
if ( V_42 )
return V_42 ;
return F_28 ( V_44 , & V_88 , V_44 -> V_36 ) ;
}
...
memcpy ( V_35 + 4 , V_44 -> V_35 , 8 ) ;
V_88 . V_93 = V_35 ;
return F_21 ( V_44 , & V_88 , V_44 -> V_36 - 8 ) ;
}
...
if ( V_42 )
return V_42 ;
return F_21 ( V_44 , & V_88 , V_44 -> V_36 ) ;
}
