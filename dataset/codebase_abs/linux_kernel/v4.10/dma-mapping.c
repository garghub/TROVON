...
static void F_91 ( struct V_16 * V_17 , const void * V_80 , T_5 V_14 )
{
F_33 ( V_80 , V_81 ) ;
}
...
V_87 = F_94 ( V_17 , V_85 , V_82 , V_1 , V_83 ,
V_61 , F_91 ) ;
if ( ! V_87 )
return NULL ;
V_22 = F_95 ( V_87 , V_7 , V_30 , V_2 ,
F_96 ( 0 ) ) ;
if ( ! V_22 )
F_97 ( V_17 , V_87 , V_85 , V_61 ) ;
} else {
struct V_8 * V_8 ;
if ( V_3 ) {
V_8 = F_68 ( V_82 , F_21 ( V_7 ) ) ;
V_22 = V_8 ? F_24 ( V_8 ) : NULL ;
} else {
V_22 = F_5 ( V_7 , & V_8 , V_82 ) ;
}
if ( ! V_22 )
return NULL ;
* V_61 = F_98 ( V_17 , V_8 , 0 , V_85 , V_83 ) ;
if ( F_99 ( V_17 , * V_61 ) ) {
if ( V_3 )
F_75 ( V_8 , F_21 ( V_7 ) ) ;
else
...
V_7 = F_32 ( V_7 ) ;
if ( F_10 ( V_48 , V_7 ) ) {
F_101 ( V_17 , V_61 , V_85 , 0 , 0 ) ;
F_12 ( V_48 , V_7 ) ;
} else if ( F_102 ( V_48 ) ) {
struct V_88 * V_89 = F_103 ( V_48 ) ;
if ( F_104 ( ! V_89 || ! V_89 -> V_87 ) )
return;
F_97 ( V_17 , V_89 -> V_87 , V_85 , & V_61 ) ;
F_73 ( V_48 , V_7 , V_30 ) ;
} else {
F_101 ( V_17 , V_61 , V_85 , 0 , 0 ) ;
...
if ( F_104 ( ! V_89 || ! V_89 -> V_87 ) )
return - V_50 ;
return F_106 ( V_89 -> V_87 , V_7 , V_47 ) ;
}
static int F_107 ( struct V_16 * V_17 , struct V_59 * V_60 ,
void * V_48 , T_6 V_49 ,
T_3 V_7 , unsigned long V_1 )
{
unsigned int V_90 = F_32 ( V_7 ) >> V_23 ;
struct V_88 * V_89 = F_103 ( V_48 ) ;
if ( F_104 ( ! V_89 || ! V_89 -> V_87 ) )
return - V_50 ;
return F_108 ( V_60 , V_89 -> V_87 , V_90 , 0 , V_7 ,
V_62 ) ;
}
...
static bool F_122 ( struct V_16 * V_17 , const struct V_92 * V_93 ,
T_7 V_94 , T_7 V_7 )
{
struct V_95 * V_96 = F_111 ( V_17 ) ;
if ( ! V_96 || F_123 ( V_96 , V_94 , V_7 , V_17 ) ) {
F_124 ( L_6 ,
F_125 ( V_17 ) ) ;
return false ;
}
...
static void F_126 ( struct V_16 * V_17 , const struct V_92 * V_93 ,
T_7 V_94 , T_7 V_7 )
{
struct V_100 * V_101 ;
V_101 = F_127 ( sizeof( * V_101 ) , V_62 ) ;
if ( ! V_101 )
return;
V_101 -> V_17 = V_17 ;
V_101 -> V_93 = V_93 ;
...
V_101 -> V_7 = V_7 ;
F_128 ( & V_102 ) ;
F_129 ( & V_101 -> V_103 , & V_104 ) ;
F_130 ( & V_102 ) ;
}
static int F_131 ( struct V_105 * V_106 ,
unsigned long V_107 , void * V_108 )
{
struct V_100 * V_109 , * V_110 ;
if ( V_107 != V_111 )
return 0 ;
F_128 ( & V_102 ) ;
F_132 (master, tmp, &iommu_dma_masters, list) {
if ( V_108 == V_109 -> V_17 && F_122 ( V_109 -> V_17 ,
V_109 -> V_93 , V_109 -> V_94 , V_109 -> V_7 ) ) {
F_133 ( & V_109 -> V_103 ) ;
F_134 ( V_109 ) ;
break;
}
...
static int T_2 F_135 ( struct V_112 * V_113 )
{
struct V_105 * V_106 = F_127 ( sizeof( * V_106 ) , V_62 ) ;
int V_43 ;
if ( ! V_106 )
return - V_74 ;
V_106 -> V_114 = F_131 ;
V_43 = F_136 ( V_113 , V_106 ) ;
if ( V_43 ) {
F_124 ( L_7 ,
V_113 -> V_115 ) ;
F_134 ( V_106 ) ;
...
static void F_140 ( struct V_16 * V_17 , T_7 V_94 , T_7 V_7 ,
...
V_120 = F_141 ( V_17 ) ;
if ( V_120 ) {
F_122 ( V_17 , V_93 , V_94 , V_7 ) ;
F_142 ( V_120 ) ;
} else {
F_126 ( V_17 , V_93 , V_94 , V_7 ) ;
}
}
...
static void F_140 ( struct V_16 * V_17 , T_7 V_94 , T_7 V_7 ,
const struct V_92 * V_121 )
{ }
void F_144 ( struct V_16 * V_17 , T_7 V_94 , T_7 V_7 ,
const struct V_92 * V_121 , bool V_3 )
{
if ( ! V_17 -> V_97 . V_98 )
V_17 -> V_97 . V_98 = & V_122 ;
V_17 -> V_97 . V_123 = V_3 ;
F_140 ( V_17 , V_94 , V_7 , V_121 ) ;
}
