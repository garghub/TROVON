...
F_44 ( V_120 ) ;
type = F_48 ( & V_120 ) ;
} while ( type == V_61 && strcmp ( V_120 , L_83 ) == 0 );
* V_107 = V_120 ;
return type ;
V_175:
F_34 ( V_71 ) ;
...
memset ( V_66 , 0 , sizeof( * V_66 ) ) ;
V_66 -> type = V_79 ;
if ( F_76 ( V_53 , L_83 , & V_66 -> V_80 . V_71 ) )
goto V_115;
if ( F_76 ( V_53 , L_70 , & V_66 -> V_80 . V_2 ) )
goto V_176;
return F_48 ( V_107 ) ;
V_176:
F_35 ( V_66 -> V_80 . V_71 ) ;
...
memset ( V_66 , 0 , sizeof( * V_66 ) ) ;
V_66 -> type = V_81 ;
if ( F_76 ( V_53 , L_83 , & V_66 -> V_82 . V_71 ) )
goto V_115;
if ( F_76 ( V_53 , L_83 , & V_66 -> V_82 . V_83 ) )
goto V_176;
if ( F_76 ( V_53 , L_70 , & V_66 -> V_82 . V_84 ) )
goto V_177;
return F_48 ( V_107 ) ;
V_177:
F_35 ( V_66 -> V_82 . V_83 ) ;
...
if ( type != V_61 || strcmp ( V_120 , L_83 ) != 0 ) {
F_64 ( V_53 ,
L_87 ,
...
if ( type != V_61 || strcmp ( V_120 , L_70 ) != 0 ) {
F_64 ( V_53 ,
L_88 ,
...
V_69 = V_120 ;
type = F_48 ( & V_120 ) ;
if ( type == V_61 && strcmp ( V_120 , L_85 ) == 0 ) {
F_44 ( V_120 ) ;
V_120 = NULL ;
...
char * V_120 ;
int V_124 ;
if ( F_56 ( V_58 , L_100 ) < 0 )
return - 1 ;
if ( F_55 ( V_58 , L_101 ) < 0 )
return - 1 ;
if ( F_55 ( V_106 , L_19 ) < 0 )
return - 1 ;
...
if ( type == V_104 ) {
char * V_187 ;
if ( F_42 ( & V_187 , L_102 , V_53 -> V_186 . V_150 , V_120 ) < 0 )
goto V_125;
F_44 ( V_120 ) ;
...
return V_170 ;
V_211:
F_64 ( V_53 , L_110 , V_135 , V_66 -> V_96 . V_96 ) ;
return 0 ;
V_207:
F_64 ( V_53 , L_111 ,
...
V_94 = V_140 ;
snprintf ( V_1 , 3 , L_112 , * ( ( unsigned char * ) V_189 + V_94 ) ) ;
...
F_126 ( V_209 , ' ' ) ;
if ( V_84 == 1 ) {
F_122 ( V_209 , L_114 , * ( V_220 * ) V_219 ) ;
} else if ( V_84 == 2 ) {
F_122 ( V_209 , L_114 , * ( V_221 * ) V_219 ) ;
} else if ( V_84 == 4 ) {
F_122 ( V_209 , L_114 , * ( V_222 * ) V_219 ) ;
} else if ( V_84 == 8 ) {
F_122 ( V_209 , L_67 V_223 , * ( V_224 * ) V_219 ) ;
} else {
F_122 ( V_209 , L_115 ,
V_84 , * ( V_220 * ) V_219 ) ;
V_84 = 1 ;
...
V_22 = & V_66 -> V_22 ;
V_66 -> type = V_68 ;
if ( F_42 ( & V_66 -> V_69 . V_69 , L_81 , V_243 ) < 0 )
goto V_41;
...
V_66 -> V_22 = NULL ;
V_66 -> type = V_68 ;
if ( F_42 ( & V_66 -> V_69 . V_69 , L_81 , V_170 ) < 0 ) {
free ( V_66 ) ;
goto V_41;
}
* V_22 = V_66 ;
...
int F_151 ( struct V_14 * V_14 , struct V_292 * V_309 )
{
return F_109 ( V_14 , V_309 -> V_189 ) ;
}
int F_152 ( struct V_14 * V_14 , struct V_292 * V_309 )
{
return F_110 ( V_14 , V_309 -> V_189 ) ;
}
const char * F_153 ( struct V_14 * V_14 , int V_13 )
{
const char * V_21 ;
V_21 = F_9 ( V_14 , V_13 ) ;
return V_21 ;
...
static struct V_10 *
F_154 ( struct V_14 * V_14 , const char * V_21 , struct V_10 * V_22 )
{
...
struct V_10 * F_155 ( struct V_14 * V_14 , const char * V_21 ,
struct V_10 * V_22 )
{
struct V_10 * V_10 ;
if ( ! V_14 -> V_18 )
return F_154 ( V_14 , V_21 , V_22 ) ;
if ( V_22 ) {
if ( V_22 < V_14 -> V_18 ||
...
int F_156 ( struct V_14 * V_14 , struct V_10 * V_10 )
{
...
void F_157 ( struct V_208 * V_209 , struct V_52 * V_53 ,
struct V_292 * V_293 )
{
int V_310 = 1 ;
...
static bool F_158 ( char * V_27 , bool V_316 )
{
if ( ! V_316 )
return true ;
...
struct V_52 *
F_159 ( struct V_14 * V_14 , struct V_292 * V_293 )
{
int type ;
if ( V_293 -> V_2 < 0 ) {
F_50 ( L_163 , V_293 -> V_2 ) ;
return NULL ;
}
type = F_107 ( V_14 , V_293 -> V_189 ) ;
return F_113 ( V_14 , type ) ;
}
void F_160 ( struct V_14 * V_14 , struct V_208 * V_209 ,
struct V_52 * V_53 ,
struct V_292 * V_293 )
{
void * V_189 = V_293 -> V_189 ;
...
if ( V_14 -> V_317 ) {
F_122 ( V_209 , L_164 ,
V_21 , V_13 , V_293 -> V_318 ) ;
} else
F_122 ( V_209 , L_165 , V_21 , V_13 , V_293 -> V_318 ) ;
}
void F_161 ( struct V_14 * V_14 , struct V_208 * V_209 ,
struct V_52 * V_53 ,
struct V_292 * V_293 ,
bool V_316 )
{
...
int V_51 ;
bool V_322 ;
V_322 = F_158 ( V_14 -> V_27 ,
V_316 ) ;
if ( V_322 ) {
V_319 = V_293 -> V_323 / V_324 ;
V_321 = V_293 -> V_323 - V_319 * V_324 ;
}
if ( V_14 -> V_317 ) {
...
F_122 ( V_209 , L_166 , V_319 , V_51 , V_320 ) ;
} else
F_122 ( V_209 , L_167 , V_293 -> V_323 ) ;
}
void F_162 ( struct V_14 * V_14 , struct V_208 * V_209 ,
struct V_52 * V_53 ,
struct V_292 * V_293 )
{
static const char * V_328 = L_168 ;
int V_140 ;
F_122 ( V_209 , L_169 , V_53 -> V_72 ) ;
V_140 = strlen ( V_53 -> V_72 ) ;
if ( V_140 < 20 )
F_122 ( V_209 , L_170 , 20 - V_140 , V_328 ) ;
F_157 ( V_209 , V_53 , V_293 ) ;
}
void F_163 ( struct V_14 * V_14 , struct V_208 * V_209 ,
struct V_292 * V_293 , bool V_316 )
{
struct V_52 * V_53 ;
V_53 = F_159 ( V_14 , V_293 ) ;
if ( ! V_53 ) {
F_50 ( L_171 ,
F_107 ( V_14 , V_293 -> V_189 ) ) ;
return;
}
F_160 ( V_14 , V_209 , V_53 , V_293 ) ;
F_161 ( V_14 , V_209 , V_53 , V_293 , V_316 ) ;
F_162 ( V_14 , V_209 , V_53 , V_293 ) ;
}
static int V_202 ( const void * V_8 , const void * V_9 )
{
struct V_52 * const * V_329 = V_8 ;
struct V_52 * const * V_330 = V_9 ;
if ( ( * V_329 ) -> V_56 < ( * V_330 ) -> V_56 )
return - 1 ;
if ( ( * V_329 ) -> V_56 > ( * V_330 ) -> V_56 )
return 1 ;
return 0 ;
}
static int F_164 ( const void * V_8 , const void * V_9 )
{
struct V_52 * const * V_329 = V_8 ;
struct V_52 * const * V_330 = V_9 ;
int V_331 ;
V_331 = strcmp ( ( * V_329 ) -> V_72 , ( * V_330 ) -> V_72 ) ;
if ( V_331 )
return V_331 ;
V_331 = strcmp ( ( * V_329 ) -> system , ( * V_330 ) -> system ) ;
if ( V_331 )
return V_331 ;
return V_202 ( V_8 , V_9 ) ;
}
static int F_165 ( const void * V_8 , const void * V_9 )
{
struct V_52 * const * V_329 = V_8 ;
struct V_52 * const * V_330 = V_9 ;
int V_331 ;
...
struct V_52 * * F_166 ( struct V_14 * V_14 , enum V_332 V_333 )
{
struct V_52 * * V_54 ;
int (* F_167)( const void * V_8 , const void * V_9 );
V_54 = V_14 -> V_334 ;
if ( V_54 && V_14 -> V_137 == V_333 )
return V_54 ;
if ( ! V_54 ) {
...
qsort ( V_54 , V_14 -> V_55 , sizeof( * V_54 ) , F_167 ) ;
V_14 -> V_137 = V_333 ;
return V_54 ;
}
static struct V_126 * *
F_168 ( const char * type , const char * V_72 ,
...
struct V_126 * * F_169 ( struct V_52 * V_53 )
{
return F_168 ( L_174 , V_53 -> V_72 ,
V_53 -> V_150 . V_152 ,
V_53 -> V_150 . V_151 ) ;
}
struct V_126 * * F_170 ( struct V_52 * V_53 )
{
return F_168 ( L_175 , V_53 -> V_72 ,
V_53 -> V_150 . V_153 ,
V_53 -> V_150 . V_129 ) ;
}
static void F_171 ( struct V_208 * V_209 , struct V_62 * V_71 )
{
F_122 ( V_209 , L_176 , V_71 -> V_64 , V_71 -> V_65 ) ;
if ( V_71 -> V_22 ) {
F_125 ( V_209 , L_142 ) ;
F_171 ( V_209 , V_71 -> V_22 ) ;
}
}
static void F_172 ( struct V_7 * args )
{
int V_338 = 1 ;
struct V_208 V_209 ;
switch ( args -> type ) {
...
case V_73 :
printf ( L_179 ) ;
F_172 ( args -> V_74 . V_71 ) ;
printf ( L_180 , args -> V_74 . V_75 ) ;
F_117 ( & V_209 ) ;
F_171 ( & V_209 , args -> V_74 . V_74 ) ;
F_173 ( & V_209 ) ;
F_119 ( & V_209 ) ;
printf ( L_70 ) ;
break;
case V_76 :
printf ( L_181 ) ;
F_172 ( args -> V_77 . V_71 ) ;
printf ( L_142 ) ;
F_117 ( & V_209 ) ;
F_171 ( & V_209 , args -> V_77 . V_78 ) ;
F_173 ( & V_209 ) ;
F_119 ( & V_209 ) ;
printf ( L_70 ) ;
break;
...
case V_81 :
printf ( L_183 ) ;
F_172 ( args -> V_82 . V_71 ) ;
printf ( L_142 ) ;
F_172 ( args -> V_82 . V_83 ) ;
printf ( L_142 ) ;
F_172 ( args -> V_82 . V_84 ) ;
printf ( L_70 ) ;
break;
case V_87 :
case V_88 :
printf ( L_184 , args -> string . string ) ;
break;
case V_89 :
printf ( L_185 , args -> V_90 . V_90 ) ;
break;
case V_85 :
printf ( L_186 , args -> V_86 . type ) ;
F_172 ( args -> V_86 . V_17 ) ;
break;
case V_95 :
...
if ( V_338 )
printf ( L_85 ) ;
F_172 ( args -> V_96 . V_97 ) ;
printf ( L_187 , args -> V_96 . V_96 ) ;
F_172 ( args -> V_96 . V_98 ) ;
if ( V_338 )
printf ( L_70 ) ;
break;
default:
...
static void F_174 ( const char * V_71 ,
int * V_146 , int * V_2 , int V_339 )
{
unsigned long long V_117 ;
unsigned long long V_119 ;
char * V_120 ;
...
int F_175 ( struct V_14 * V_14 , char * V_1 , unsigned long V_2 ,
int V_149 )
{
int V_341 ;
if ( ! V_2 ) {
V_14 -> V_342 = sizeof( long long ) ;
V_14 -> V_343 = V_149 ;
V_14 -> V_344 = sizeof( long long ) + V_149 ;
V_14 -> V_345 = 1 ;
return - 1 ;
}
F_1 ( V_1 , V_2 ) ;
F_174 ( L_188 , & V_14 -> V_346 ,
& V_14 -> V_342 , 1 ) ;
F_174 ( L_189 , & V_14 -> V_347 ,
& V_14 -> V_343 , 1 ) ;
F_174 ( L_190 , & V_14 -> V_348 ,
& V_341 , 0 ) ;
F_174 ( L_191 , & V_14 -> V_344 ,
& V_14 -> V_349 , 1 ) ;
return 0 ;
}
static int F_176 ( struct V_52 * V_53 ,
int V_56 , const char * V_350 ,
const char * V_351 )
{
if ( V_56 >= 0 && V_56 != V_53 -> V_56 )
return 0 ;
if ( V_351 && ( strcmp ( V_351 , V_53 -> V_72 ) != 0 ) )
return 0 ;
if ( V_350 && ( strcmp ( V_350 , V_53 -> system ) != 0 ) )
return 0 ;
return 1 ;
}
static void F_177 ( struct V_352 * V_353 )
{
free ( ( void * ) V_353 -> V_350 ) ;
free ( ( void * ) V_353 -> V_351 ) ;
free ( V_353 ) ;
}
static int F_178 ( struct V_14 * V_14 , struct V_52 * V_53 )
{
struct V_352 * V_353 , * * V_22 ;
for ( V_22 = & V_14 -> V_354 ; * V_22 ;
V_22 = & ( * V_22 ) -> V_22 ) {
V_353 = * V_22 ;
if ( F_176 ( V_53 , V_353 -> V_56 ,
V_353 -> V_350 ,
V_353 -> V_351 ) )
break;
}
...
V_53 -> V_313 = V_353 -> V_35 ;
V_53 -> V_315 = V_353 -> V_315 ;
* V_22 = V_353 -> V_22 ;
F_177 ( V_353 ) ;
return 1 ;
}
enum V_355 F_180 ( struct V_52 * * V_356 ,
...
if ( strcmp ( V_203 , L_193 ) == 0 ) {
V_53 -> V_74 |= V_132 ;
if ( strcmp ( V_53 -> V_72 , L_194 ) == 0 )
V_53 -> V_74 |= V_288 ;
}
V_53 -> V_56 = F_58 () ;
if ( V_53 -> V_56 < 0 ) {
...
static enum V_355
F_181 ( struct V_14 * V_14 ,
struct V_52 * * V_356 ,
const char * V_1 , unsigned long V_2 ,
const char * V_203 )
{
int V_124 = F_180 ( V_356 , V_14 , V_1 , V_2 , V_203 ) ;
struct V_52 * V_53 = * V_356 ;
if ( V_53 == NULL )
return V_124 ;
...
#define F_182 0
if ( F_182 && V_53 -> V_186 . args )
F_172 ( V_53 -> V_186 . args ) ;
return 0 ;
V_365:
F_183 ( V_53 ) ;
return V_124 ;
}
enum V_355 F_184 ( struct V_14 * V_14 ,
struct V_52 * * V_356 ,
const char * V_1 ,
unsigned long V_2 , const char * V_203 )
{
return F_181 ( V_14 , V_356 , V_1 , V_2 , V_203 ) ;
}
enum V_355 F_185 ( struct V_14 * V_14 , const char * V_1 ,
unsigned long V_2 , const char * V_203 )
{
struct V_52 * V_53 = NULL ;
return F_181 ( V_14 , & V_53 , V_1 , V_2 , V_203 ) ;
}
int F_186 ( struct V_14 * V_14 V_161 ,
enum V_355 V_366 , char * V_1 , T_2 V_367 )
{
int V_368 ;
const char * V_369 ;
if ( V_366 >= 0 ) {
F_187 ( V_366 , V_1 , V_367 ) ;
return 0 ;
}
if ( V_366 <= V_370 ||
V_366 >= V_371 )
...
V_368 = V_366 - V_370 - 1 ;
V_369 = V_372 [ V_368 ] ;
snprintf ( V_1 , V_367 , L_116 , V_369 ) ;
return 0 ;
}
int F_188 ( struct V_208 * V_209 , struct V_126 * V_71 ,
...
void * F_189 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
int * V_140 , int V_185 )
{
struct V_126 * V_71 ;
...
int F_190 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
unsigned long long * V_170 , int V_185 )
{
struct V_126 * V_71 ;
...
return - 1 ;
V_71 = F_87 ( V_53 , V_72 ) ;
return F_188 ( V_209 , V_71 , V_72 , V_293 , V_170 , V_185 ) ;
}
int F_191 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
unsigned long long * V_170 , int V_185 )
{
struct V_126 * V_71 ;
...
int F_192 ( struct V_208 * V_209 , struct V_52 * V_53 ,
const char * V_72 , struct V_292 * V_293 ,
unsigned long long * V_170 , int V_185 )
{
struct V_126 * V_71 ;
...
int F_193 ( struct V_208 * V_209 , const char * V_50 ,
...
V_374:
if ( V_185 )
F_122 ( V_209 , L_197 , V_72 ) ;
return - 1 ;
}
int F_194 ( struct V_208 * V_209 , const char * V_50 ,
struct V_52 * V_53 , const char * V_72 ,
struct V_292 * V_293 , int V_185 )
{
struct V_126 * V_71 = F_87 ( V_53 , V_72 ) ;
...
V_35 = F_21 ( V_14 , V_170 ) ;
if ( V_35 )
snprintf ( V_160 , 128 , L_198 , V_35 -> V_35 , V_35 -> V_31 - V_170 ) ;
else
sprintf ( V_160 , L_199 , V_170 ) ;
...
static struct V_52 * F_197 ( struct V_14 * V_14 , int V_56 ,
const char * V_350 ,
const char * V_351 )
{
struct V_52 * V_53 ;
...
V_53 = F_114 ( V_14 , V_350 , V_351 ) ;
if ( ! V_53 )
return NULL ;
}
return V_53 ;
}
int F_198 ( struct V_14 * V_14 , int V_56 ,
const char * V_350 , const char * V_351 ,
T_5 V_35 , void * V_315 )
{
struct V_52 * V_53 ;
struct V_352 * V_353 ;
V_53 = F_197 ( V_14 , V_56 , V_350 , V_351 ) ;
if ( V_53 == NULL )
goto V_382;
F_179 ( L_192 ,
V_53 -> V_56 , V_53 -> system , V_53 -> V_72 ) ;
...
V_353 -> V_56 = V_56 ;
if ( V_351 )
V_353 -> V_351 = F_12 ( V_351 ) ;
if ( V_350 )
V_353 -> V_350 = F_12 ( V_350 ) ;
if ( ( V_351 && ! V_353 -> V_351 ) ||
( V_350 && ! V_353 -> V_350 ) ) {
F_50 ( L_206 ) ;
free ( ( void * ) V_353 -> V_351 ) ;
free ( ( void * ) V_353 -> V_350 ) ;
...
V_353 -> V_35 = V_35 ;
V_353 -> V_22 = V_14 -> V_354 ;
V_14 -> V_354 = V_353 ;
V_353 -> V_315 = V_315 ;
return - 1 ;
}
static int F_199 ( struct V_352 * V_313 , int V_56 ,
const char * V_350 , const char * V_351 ,
T_5 V_35 , void * V_315 )
{
if ( V_56 >= 0 && V_56 != V_313 -> V_56 )
return 0 ;
if ( V_351 && ( strcmp ( V_351 , V_313 -> V_351 ) != 0 ) )
return 0 ;
...
V_382:
for ( V_22 = & V_14 -> V_354 ; * V_22 ; V_22 = & ( * V_22 ) -> V_22 ) {
V_353 = * V_22 ;
if ( F_199 ( V_353 , V_56 , V_350 , V_351 ,
V_35 , V_315 ) )
break;
}
if ( ! ( * V_22 ) )
...
static void F_204 ( struct V_126 * V_71 )
{
struct V_126 * V_22 ;
while ( V_71 ) {
V_22 = V_71 -> V_22 ;
...
static void F_205 ( struct V_150 * V_150 )
{
F_204 ( V_150 -> V_151 ) ;
F_204 ( V_150 -> V_129 ) ;
}
...
void F_206 ( struct V_14 * V_14 )
{
struct V_15 * V_16 , * V_384 ;
struct V_32 * V_33 , * V_385 ;
struct V_46 * V_47 , * V_386 ;
struct V_180 * V_387 ;
struct V_352 * V_353 ;
int V_19 ;
if ( ! V_14 )
...
for ( V_19 = 0 ; V_19 < V_14 -> V_55 ; V_19 ++ )
F_183 ( V_14 -> V_54 [ V_19 ] ) ;
while ( V_14 -> V_354 ) {
V_353 = V_14 -> V_354 ;
V_14 -> V_354 = V_353 -> V_22 ;
F_177 ( V_353 ) ;
}
free ( V_14 -> V_27 ) ;
free ( V_14 -> V_54 ) ;
