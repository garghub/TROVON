...
const unsigned char * V_44 , char * V_45 , int V_46 )
{
struct V_1 * V_2 = V_32 -> V_37 ;
struct V_18 * V_19 ;
if ( ! V_2 )
...
{
struct V_18 * V_19 ;
V_19 = F_21 ( sizeof( struct V_18 ) , V_53 ) ;
if ( V_19 == NULL )
return - V_28 ;
V_19 -> V_52 = F_22 ( V_2 -> V_29 , L_5 ) ;
if ( F_16 ( V_19 -> V_52 ) )
F_23 ( V_2 -> V_29 , L_6 ) ;
V_19 -> V_26 = NULL ;
F_24 ( V_2 , V_19 ) ;
