...
static bool F_20 ( struct V_77 * V_39 , unsigned int V_24 )
{
if ( V_24 < V_5 )
return false ;
switch ( V_24 ) {
...
int F_21 ( struct V_77 * V_39 , struct V_4 * V_4 )
{
struct V_1 * V_2 ;
int V_3 , V_64 ;
V_2 = F_22 ( V_39 , sizeof( * V_2 ) , V_80 ) ;
if ( V_2 == NULL )
return - V_81 ;
F_23 ( V_39 , V_2 ) ;
V_2 -> V_20 = F_24 ( V_39 , L_7 ) ;
if ( F_25 ( V_2 -> V_20 ) ) {
V_3 = F_26 ( V_2 -> V_20 ) ;
if ( V_3 != - V_82 )
F_10 ( V_39 , L_8 , V_3 ) ;
...
V_2 -> V_6 = F_28 ( V_2 -> V_20 ) ;
for ( V_64 = 0 ; V_64 < F_29 ( V_2 -> V_83 ) ; V_64 ++ )
V_2 -> V_83 [ V_64 ] . V_84 = V_85 [ V_64 ] ;
V_3 = F_30 ( V_39 ,
F_29 ( V_2 -> V_83 ) , V_2 -> V_83 ) ;
if ( V_3 ) {
if ( V_3 != - V_82 )
F_10 ( V_39 , L_10 , V_3 ) ;
goto V_86;
}
V_3 = F_31 ( F_29 ( V_2 -> V_83 ) ,
V_2 -> V_83 ) ;
if ( V_3 ) {
F_10 ( V_39 , L_11 , V_3 ) ;
goto V_86;
...
void F_38 ( struct V_77 * V_39 )
{
struct V_1 * V_2 = F_39 ( V_39 ) ;
F_40 ( V_39 ) ;
F_41 ( V_39 ) ;
F_36 ( F_29 ( V_2 -> V_83 ) ,
V_2 -> V_83 ) ;
...
static int F_42 ( struct V_77 * V_39 )
{
struct V_1 * V_2 = F_39 ( V_39 ) ;
int V_3 ;
V_3 = F_27 ( V_2 -> V_20 ) ;
...
static int F_46 ( struct V_77 * V_39 )
{
struct V_1 * V_2 = F_39 ( V_39 ) ;
F_43 ( V_2 -> V_4 , true ) ;
F_36 ( F_29 ( V_2 -> V_83 ) ,
