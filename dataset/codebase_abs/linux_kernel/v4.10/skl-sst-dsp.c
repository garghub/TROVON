...
struct V_1 * F_35 ( struct V_48 * V_24 ,
struct V_49 * V_50 , int V_33 )
{
int V_25 ;
struct V_1 * V_51 ;
V_51 = F_36 ( V_24 , sizeof( * V_51 ) , V_52 ) ;
if ( V_51 == NULL )
return NULL ;
F_37 ( & V_51 -> V_37 ) ;
F_38 ( & V_51 -> V_4 ) ;
...
V_51 -> V_8 = V_50 -> V_8 ;
if ( V_51 -> V_53 -> V_54 ) {
V_25 = V_51 -> V_53 -> V_54 ( V_51 , NULL ) ;
if ( V_25 < 0 )
return NULL ;
}
V_25 = F_39 ( V_51 -> V_33 , V_51 -> V_53 -> V_55 ,
