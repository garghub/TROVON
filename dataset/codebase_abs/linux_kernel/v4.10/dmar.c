...
F_108 ( & V_76 -> V_175 ) ;
if ( V_176 ) {
V_76 -> V_177 = F_109 ( NULL , V_76 ,
V_178 ,
L_40 , V_76 -> V_152 ) ;
if ( F_110 ( V_76 -> V_177 ) ) {
V_151 = F_111 ( V_76 -> V_177 ) ;
goto V_165;
}
}
V_2 -> V_76 = V_76 ;
...
if ( V_76 -> V_179 ) {
if ( V_76 -> V_180 ) {
F_113 ( V_76 -> V_180 , V_76 ) ;
F_114 ( V_76 -> V_180 ) ;
V_76 -> V_180 = 0 ;
}
F_113 ( V_76 -> V_179 , V_76 ) ;
F_114 ( V_76 -> V_179 ) ;
V_76 -> V_179 = 0 ;
}
if ( V_76 -> V_181 ) {
F_115 ( ( unsigned long ) V_76 -> V_181 -> V_182 ) ;
...
static inline void F_116 ( struct V_184 * V_181 )
{
...
static int F_117 ( struct V_145 * V_76 , int V_55 )
{
T_10 V_191 ;
int V_192 , V_193 ;
...
if ( V_191 & V_206 )
F_118 ( V_206 , V_76 -> V_146 + V_196 ) ;
return 0 ;
}
int F_119 ( struct V_202 * V_182 , struct V_145 * V_76 )
{
int V_207 ;
struct V_184 * V_181 = V_76 -> V_181 ;
...
V_208 [ V_55 ] = * V_182 ;
V_209 . V_200 = F_123 ( V_186 ) |
V_213 | V_214 ;
V_209 . V_201 = F_124 ( & V_181 -> V_183 [ V_194 ] ) ;
V_208 [ V_194 ] = V_209 ;
V_181 -> V_212 = ( V_181 -> V_212 + 2 ) % V_189 ;
V_181 -> V_190 -= 2 ;
F_118 ( V_181 -> V_212 << V_199 , V_76 -> V_146 + V_204 ) ;
while ( V_181 -> V_183 [ V_194 ] != V_186 ) {
V_207 = F_117 ( V_76 , V_55 ) ;
if ( V_207 )
break;
F_125 ( & V_181 -> V_211 ) ;
F_122 () ;
...
void F_128 ( struct V_145 * V_76 , T_2 V_216 , T_2 V_217 , T_5 V_218 ,
T_7 type )
{
struct V_202 V_182 ;
V_182 . V_200 = F_129 ( V_218 ) | F_130 ( V_217 ) | F_131 ( V_216 )
| F_132 ( type ) | V_219 ;
V_182 . V_201 = 0 ;
F_119 ( & V_182 , V_76 ) ;
}
void F_133 ( struct V_145 * V_76 , T_2 V_216 , T_7 V_129 ,
...
if ( F_135 ( V_76 -> V_132 ) )
V_222 = 1 ;
V_182 . V_200 = F_136 ( V_216 ) | F_137 ( V_222 ) | F_138 ( V_221 )
| F_139 ( type ) | V_224 ;
V_182 . V_201 = F_140 ( V_129 ) | F_141 ( V_223 )
| F_142 ( V_220 ) ;
F_119 ( & V_182 , V_76 ) ;
}
void F_143 ( struct V_145 * V_76 , T_2 V_217 , T_2 V_225 ,
...
V_182 . V_201 = F_144 ( V_129 ) | V_228 ;
} else
V_182 . V_201 = F_144 ( V_129 ) ;
if ( V_225 >= V_229 )
V_225 = 0 ;
V_182 . V_200 = F_145 ( V_217 ) | F_146 ( V_225 ) |
V_230 ;
F_119 ( & V_182 , V_76 ) ;
}
void F_147 ( struct V_145 * V_76 )
{
unsigned long V_75 ;
T_10 V_160 ;
T_11 V_231 = F_148 () ;
...
F_122 () ;
V_76 -> V_169 &= ~ V_174 ;
F_118 ( V_76 -> V_169 , V_76 -> V_146 + V_233 ) ;
F_150 ( V_76 , V_167 , F_105 ,
! ( V_160 & V_173 ) , V_160 ) ;
V_7:
F_121 ( & V_76 -> V_175 , V_75 ) ;
}
static void F_151 ( struct V_145 * V_76 )
{
T_10 V_160 ;
unsigned long V_75 ;
struct V_184 * V_181 = V_76 -> V_181 ;
...
V_181 -> V_190 = V_189 ;
F_120 ( & V_76 -> V_175 , V_75 ) ;
F_118 ( 0 , V_76 -> V_146 + V_204 ) ;
F_152 ( V_76 -> V_146 + V_234 , F_124 ( V_181 -> V_182 ) ) ;
V_76 -> V_169 |= V_174 ;
F_118 ( V_76 -> V_169 , V_76 -> V_146 + V_233 ) ;
F_150 ( V_76 , V_167 , F_105 , ( V_160 & V_173 ) , V_160 ) ;
F_121 ( & V_76 -> V_175 , V_75 ) ;
}
int F_153 ( struct V_145 * V_76 )
{
struct V_184 * V_181 ;
struct V_235 * V_236 ;
if ( ! F_149 ( V_76 -> V_133 ) )
...
if ( V_76 -> V_181 )
return 0 ;
V_76 -> V_181 = F_154 ( sizeof( * V_181 ) , V_238 ) ;
if ( ! V_76 -> V_181 )
return - V_39 ;
V_181 = V_76 -> V_181 ;
V_236 = F_155 ( V_76 -> V_88 , V_238 | V_239 , 0 ) ;
if ( ! V_236 ) {
F_10 ( V_181 ) ;
V_76 -> V_181 = NULL ;
return - V_39 ;
}
V_181 -> V_182 = F_156 ( V_236 ) ;
V_181 -> V_183 = F_13 ( V_189 * sizeof( int ) , V_238 ) ;
if ( ! V_181 -> V_183 ) {
F_115 ( ( unsigned long ) V_181 -> V_182 ) ;
F_10 ( V_181 ) ;
V_76 -> V_181 = NULL ;
return - V_39 ;
}
...
static const char * F_157 ( T_5 V_240 , int * V_241 )
{
if ( V_240 >= 0x20 && ( V_240 - 0x20 <
F_158 ( V_242 ) ) ) {
* V_241 = V_243 ;
return V_242 [ V_240 - 0x20 ] ;
} else if ( V_240 < F_158 ( V_244 ) ) {
* V_241 = V_245 ;
return V_244 [ V_240 ] ;
} else {
* V_241 = V_246 ;
...
static inline int F_159 ( struct V_145 * V_76 , int V_179 )
{
if ( V_76 -> V_179 == V_179 )
return V_247 ;
...
void F_161 ( struct V_249 * V_64 )
{
struct V_145 * V_76 = F_162 ( V_64 ) ;
int V_146 = F_159 ( V_76 , V_64 -> V_179 ) ;
unsigned long V_250 ;
F_120 ( & V_76 -> V_175 , V_250 ) ;
F_118 ( 0 , V_76 -> V_146 + V_146 ) ;
F_105 ( V_76 -> V_146 + V_146 ) ;
F_121 ( & V_76 -> V_175 , V_250 ) ;
}
void F_163 ( struct V_249 * V_64 )
{
struct V_145 * V_76 = F_162 ( V_64 ) ;
int V_146 = F_159 ( V_76 , V_64 -> V_179 ) ;
unsigned long V_250 ;
F_120 ( & V_76 -> V_175 , V_250 ) ;
F_118 ( V_251 , V_76 -> V_146 + V_146 ) ;
F_105 ( V_76 -> V_146 + V_146 ) ;
F_121 ( & V_76 -> V_175 , V_250 ) ;
}
void F_164 ( int V_179 , struct V_252 * V_253 )
{
struct V_145 * V_76 = F_165 ( V_179 ) ;
int V_146 = F_159 ( V_76 , V_179 ) ;
unsigned long V_250 ;
F_120 ( & V_76 -> V_175 , V_250 ) ;
F_118 ( V_253 -> V_64 , V_76 -> V_146 + V_146 + 4 ) ;
F_118 ( V_253 -> V_254 , V_76 -> V_146 + V_146 + 8 ) ;
F_118 ( V_253 -> V_255 , V_76 -> V_146 + V_146 + 12 ) ;
F_121 ( & V_76 -> V_175 , V_250 ) ;
}
void F_166 ( int V_179 , struct V_252 * V_253 )
{
struct V_145 * V_76 = F_165 ( V_179 ) ;
int V_146 = F_159 ( V_76 , V_179 ) ;
unsigned long V_250 ;
...
static int F_167 ( struct V_145 * V_76 , int type ,
T_5 V_240 , T_2 V_256 , unsigned long long V_129 )
{
const char * V_257 ;
int V_241 ;
V_257 = F_157 ( V_240 , & V_241 ) ;
if ( V_241 == V_243 )
F_71 ( L_44 ,
...
T_12 F_168 ( int V_179 , void * V_258 )
{
...
F_118 ( V_269 , V_76 -> V_146 + V_146 +
V_259 * V_268 + 12 ) ;
F_121 ( & V_76 -> V_175 , V_250 ) ;
if ( ! V_261 )
F_167 ( V_76 , type , V_240 ,
V_256 , V_267 ) ;
V_259 ++ ;
if ( V_259 >= F_177 ( V_76 -> V_132 ) )
V_259 = 0 ;
F_120 ( & V_76 -> V_175 , V_250 ) ;
}
F_118 ( V_270 | V_265 , V_76 -> V_146 + V_196 ) ;
V_266:
F_121 ( & V_76 -> V_175 , V_250 ) ;
return V_271 ;
}
int F_178 ( struct V_145 * V_76 )
{
int V_179 , V_56 ;
if ( V_76 -> V_179 )
return 0 ;
V_179 = F_179 ( V_76 -> V_156 , V_76 -> V_88 , V_76 ) ;
if ( V_179 > 0 ) {
V_76 -> V_179 = V_179 ;
} else {
F_71 ( L_49 ) ;
...
V_56 = F_180 ( V_179 , F_168 , V_272 , V_76 -> V_152 , V_76 ) ;
if ( V_56 )
F_71 ( L_50 ) ;
return V_56 ;
}
...
F_168 ( V_76 -> V_179 , V_76 ) ;
V_260 = F_105 ( V_76 -> V_146 + V_196 ) ;
F_118 ( V_260 , V_76 -> V_146 + V_196 ) ;
}
return 0 ;
}
int F_183 ( struct V_145 * V_76 )
{
if ( ! F_149 ( V_76 -> V_133 ) )
return - V_237 ;
if ( ! V_76 -> V_181 )
...
static inline bool F_190 ( T_6 V_275 , int V_276 )
{
return F_191 ( V_275 , V_277 , V_278 , 1 << V_276 ) ;
}
static int F_192 ( T_6 V_275 , int V_276 ,
...
if ( ! F_190 ( V_275 , V_276 ) )
return 0 ;
V_281 = F_193 ( V_275 , V_277 , V_278 ,
V_276 , NULL , V_287 ) ;
if ( ! V_281 )
return - V_118 ;
...
static int F_201 ( T_6 V_275 )
{
int V_56 ;
int V_115 = 0 ;
V_56 = F_192 ( V_275 , V_284 ,
& F_80 , ( void * ) 1 ) ;
if ( V_56 )
goto V_74;
V_56 = F_192 ( V_275 , V_284 ,
...
V_56 = F_192 ( V_275 , V_286 ,
& F_48 , NULL ) ;
if ( V_56 )
goto V_290;
V_56 = F_192 ( V_275 , V_285 ,
& V_117 , NULL ) ;
if ( V_56 )
goto V_291;
V_56 = F_192 ( V_275 , V_284 ,
...
& F_198 , NULL ) ;
if ( V_56 == 0 ) {
F_203 ( F_192 ( V_275 , V_285 ,
& V_292 , NULL ) ) ;
F_203 ( F_192 ( V_275 , V_284 ,
& F_199 , NULL ) ) ;
} else {
F_192 ( V_275 , V_284 ,
& F_195 , NULL ) ;
...
static T_4 F_204 ( T_6 V_275 , T_10 V_294 ,
void * V_295 , void * * V_296 )
{
T_6 * V_297 = V_296 ;
if ( F_190 ( V_275 , V_284 ) ) {
* V_297 = V_275 ;
return V_298 ;
}
return V_101 ;
}
static int F_205 ( T_6 V_275 , bool V_299 )
{
int V_56 ;
T_6 V_30 = NULL ;
T_4 V_100 ;
...
int F_208 ( T_6 V_275 )
{
return F_205 ( V_275 , true ) ;
}
int F_209 ( T_6 V_275 )
{
return F_205 ( V_275 , false ) ;
}
