...
V_114 >>= 6 ;
if ( V_114 > 0 &&
V_108 >= F_56 ( ( V_116 ) V_110 , V_114 ) )
return F_51 ( V_38 ) ;
}
return 0 ;
}
int F_57 ( const struct V_10 * V_11 , void * V_117 )
{
struct V_37 * V_38 = V_117 ;
int V_118 ;
F_26 ( V_119 , L_10 , F_58 ( V_38 ) ) ;
V_118 = F_53 ( V_38 ) ;
if ( V_118 > 0 ) {
int V_73 = F_59 ( V_11 , V_38 , V_118 , false ) ;
F_26 ( V_119 , L_11 ,
F_58 ( V_38 ) , V_73 , V_118 ) ;
if ( V_73 >= V_118 ) {
F_26 ( V_119 , L_12 , F_58 ( V_38 ) ) ;
F_60 ( V_38 -> V_120 ) ;
}
}
return 0 ;
}
void F_61 ( struct V_37 * V_38 , struct V_29 * V_121 )
{
F_62 ( V_122 ) ;
struct V_34 * V_35 ;
long V_123 = 0 ;
F_63 (oap, plist, oap_pending_item) {
struct V_1 * V_2 = F_64 ( V_35 ) ;
if ( ! V_2 -> V_124 )
continue;
++ V_123 ;
F_2 ( F_18 ( & V_2 -> V_95 ) ) ;
...
if ( V_123 > 0 ) {
F_30 ( & V_38 -> V_125 ) ;
F_66 ( & V_122 , & V_38 -> V_126 ) ;
F_67 ( V_123 , & V_38 -> V_127 ) ;
F_68 ( V_123 , & V_38 -> V_109 ) ;
V_38 -> V_115 = F_55 () ;
F_32 ( & V_38 -> V_125 ) ;
if ( F_69 ( & V_128 ) )
( void ) F_60 ( V_38 -> V_120 ) ;
}
}
static void F_70 ( struct V_37 * V_38 , struct V_1 * V_2 )
{
...
static void F_75 ( const struct V_10 * V_11 , struct V_19 * V_20 ,
...
static inline bool F_80 ( struct V_37 * V_38 , struct V_4 * V_5 )
{
if ( F_81 ( V_5 ) )
return true ;
if ( V_38 -> V_107 -> V_132 ) {
struct V_5 * V_133 = F_82 ( V_5 ) ;
if ( F_83 ( V_133 ) - F_84 ( V_133 ) > 2 )
return true ;
}
return false ;
}
long F_59 ( const struct V_10 * V_11 , struct V_37 * V_38 ,
...
return 0 ;
F_26 ( V_119 , L_14 ,
F_58 ( V_38 ) , F_24 ( & V_38 -> V_138 ) , V_135 ) ;
if ( ! V_135 ) {
if ( F_24 ( & V_38 -> V_138 ) > 0 )
return - V_139 ;
if ( F_85 ( & V_38 -> V_138 ) > 1 ) {
F_86 ( & V_38 -> V_138 ) ;
return - V_139 ;
}
} else {
...
V_129 = (struct V_4 * * ) F_88 ( V_11 ) -> V_140 ;
V_20 = & F_88 ( V_11 ) -> V_141 ;
F_30 ( & V_38 -> V_125 ) ;
if ( V_135 )
V_38 -> V_142 ++ ;
V_137 = F_89 ( V_134 << 1 , F_54 ( & V_38 -> V_109 ) ) ;
...
if ( -- V_137 < 0 )
break;
V_2 = F_90 ( V_38 -> V_126 . V_144 , struct V_1 ,
V_95 ) ;
V_5 = V_2 -> V_6 . V_7 ;
if ( F_80 ( V_38 , V_5 ) ) {
F_91 ( & V_2 -> V_95 , & V_38 -> V_126 ) ;
continue;
}
F_2 ( V_5 -> V_145 ) ;
if ( V_136 != V_5 -> V_145 ) {
...
V_20 -> V_147 = V_136 ;
V_20 -> V_148 = 1 ;
V_73 = F_95 ( V_11 , V_20 , V_149 , V_136 ) ;
F_30 ( & V_38 -> V_125 ) ;
if ( V_73 != 0 )
break;
++ V_137 ;
...
F_86 ( & V_38 -> V_138 ) ;
if ( V_118 > 0 ) {
F_68 ( V_118 , V_38 -> V_113 ) ;
F_98 ( & V_128 ) ;
}
return V_118 > 0 ? V_118 : V_73 ;
}
long F_99 ( struct V_37 * V_38 , unsigned long V_123 )
{
struct V_10 * V_11 ;
struct V_105 * V_106 = V_38 -> V_107 ;
int V_151 ;
...
if ( F_101 ( V_11 ) )
return 0 ;
V_123 = F_102 ( int , V_123 , V_38 -> V_104 ) ;
F_26 ( V_119 , L_15 ,
F_58 ( V_38 ) , V_123 ) ;
V_73 = F_59 ( V_11 , V_38 , V_123 , true ) ;
if ( V_73 >= V_123 ) {
F_26 ( V_119 , L_16 ,
F_58 ( V_38 ) , V_73 , V_123 ) ;
if ( F_53 ( V_38 ) > 0 )
F_60 ( V_38 -> V_120 ) ;
goto V_153;
} else if ( V_73 > 0 ) {
...
F_26 ( V_119 , L_17 ,
F_58 ( V_38 ) , V_38 , F_54 ( & V_38 -> V_109 ) ,
F_54 ( & V_38 -> V_127 ) , V_123 ) ;
F_30 ( & V_106 -> V_154 ) ;
F_2 ( ! F_18 ( & V_106 -> V_155 ) ) ;
V_106 -> V_156 ++ ;
F_91 ( & V_38 -> V_157 , & V_106 -> V_155 ) ;
V_151 = F_24 ( & V_106 -> V_112 ) - 2 ;
while ( -- V_151 > 0 && ! F_18 ( & V_106 -> V_155 ) ) {
V_38 = F_90 ( V_106 -> V_155 . V_144 , struct V_37 ,
V_157 ) ;
F_26 ( V_119 , L_18 ,
F_58 ( V_38 ) , V_38 ,
F_54 ( & V_38 -> V_109 ) ,
...
struct V_1 * V_2 )
{
struct V_158 V_159 = F_104 ( V_160 , NULL ) ;
struct V_92 * V_93 = F_42 ( V_11 ) ;
...
static inline void F_108 ( struct V_162 * V_163 ,
int V_164 )
{
int F_83 = V_163 -> V_165 ;
T_4 * V_166 = NULL ;
int V_118 = 0 ;
int V_131 ;
F_2 ( F_109 ( V_163 -> V_167 ) ) ;
for ( V_131 = 0 ; V_131 < F_83 ; V_131 ++ ) {
T_4 * V_168 = F_110 ( F_111 ( V_163 , V_131 ) . V_169 ) ;
if ( F_112 ( V_168 == V_166 ) ) {
++ V_118 ;
continue;
}
if ( V_118 > 0 ) {
...
if ( V_118 > 0 )
F_113 ( V_166 , V_170 , V_164 * V_118 ) ;
}
static inline void F_114 ( struct V_162 * V_163 )
{
F_108 ( V_163 , 1 ) ;
}
static inline void F_115 ( struct V_162 * V_163 )
{
F_108 ( V_163 , - 1 ) ;
}
void F_116 ( struct V_171 * V_172 )
{
...
F_2 ( V_176 >= 0 ) ;
if ( ! V_176 )
F_98 ( & V_38 -> V_107 -> V_179 ) ;
if ( F_69 ( & V_128 ) )
( void ) F_60 ( V_38 -> V_120 ) ;
}
void F_118 ( struct V_171 * V_172 )
{
struct V_37 * V_38 = & V_172 -> V_173 -> V_174 -> V_40 . V_38 ;
struct V_162 * V_163 = V_172 -> V_175 ;
long F_83 = V_163 -> V_165 ;
if ( ! V_38 -> V_107 || ! V_38 -> V_107 -> V_132 )
return;
F_114 ( V_163 ) ;
F_68 ( F_83 , & V_38 -> V_177 ) ;
F_68 ( F_83 , & V_38 -> V_107 -> V_178 ) ;
F_30 ( & V_172 -> V_180 ) ;
if ( F_97 ( V_172 -> V_181 ) ) {
F_32 ( & V_172 -> V_180 ) ;
F_116 ( V_172 ) ;
