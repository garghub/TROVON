...
struct V_66 * V_13 ;
struct V_1 * V_1 ;
V_13 = V_6 -> V_16 . type -> V_67 ( & V_6 -> V_16 , V_65 ) ;
if ( ! V_13 )
return F_53 ( - V_68 ) ;
V_1 = F_54 ( V_13 ) ;
...
static struct V_1 * F_57 ( struct V_18 * V_19 , T_1 V_65 )
{
unsigned long V_23 ;
struct V_5 * V_6 ;
struct V_1 * V_1 ;
...
int V_76 = V_82 ;
T_1 V_65 = V_78 ? F_64 ( V_78 ) : F_64 ( V_80 ) ;
struct V_1 * V_1 ;
struct V_83 * V_84 ;
struct V_47 * V_51 ;
V_1 = F_56 ( V_19 -> V_69 ) ;
...
V_76 = F_94 ( V_118 , V_113 , & V_116 , & V_10 -> error ) ;
if ( V_76 ) {
F_13 ( V_115 ) ;
return - V_119 ;
}
V_76 = V_115 -> V_120 ( & V_6 -> V_16 , V_116 , V_113 -> V_121 ) ;
if ( V_76 ) {
F_13 ( V_115 ) ;
V_10 -> error = L_3 ;
return V_76 ;
...
if ( ! V_122 )
return F_53 ( - V_41 ) ;
V_76 = F_97 ( V_10 , F_93 ( V_113 ) , F_98 ( V_10 -> V_36 ) ,
& V_122 -> V_13 . V_14 ) ;
if ( V_76 ) {
V_10 -> error = L_5 ;
goto V_126;
...
V_124 = F_99 ( V_87 , V_2 ) ;
if ( V_124 ) {
if ( V_19 -> V_45 && strcmp ( V_124 , V_19 -> V_45 ) ) {
F_5 ( V_19 -> V_46 ) ;
V_19 -> V_46 = NULL ;
}
F_5 ( V_19 -> V_45 ) ;
...
V_76 = V_16 -> type -> V_132 ( V_16 , & V_122 -> V_13 , V_113 -> V_125 , V_113 -> V_121 , & V_10 -> error ) ;
if ( V_76 ) {
F_11 ( V_10 , V_122 -> V_13 . V_14 ) ;
goto V_126;
}
...
V_6 -> V_19 = V_19 ;
V_76 = F_91 ( V_113 , V_6 , V_10 ) ;
if ( V_76 )
goto V_126;
V_76 = F_105 ( V_118 , V_113 , & V_6 -> V_136 , & V_10 -> error ) ;
if ( V_76 )
goto V_126;
V_76 = F_105 ( V_118 + 1 , V_113 , & V_134 , & V_10 -> error ) ;
if ( V_76 )
goto V_126;
V_135 = 1 + V_134 ;
...
V_76 = F_94 ( V_118 , V_113 , & V_125 , & V_10 -> error ) ;
if ( V_76 )
return - V_119 ;
if ( ! V_125 )
return 0 ;
...
( V_125 >= 1 ) ) {
V_76 = F_105 ( V_118 + 1 , V_113 , & V_19 -> V_144 , & V_10 -> error ) ;
V_125 -- ;
continue;
}
if ( ! strcasecmp ( V_143 , L_26 ) &&
( V_125 >= 1 ) ) {
V_76 = F_105 ( V_118 + 2 , V_113 , & V_19 -> V_27 , & V_10 -> error ) ;
V_125 -- ;
continue;
}
...
V_76 = F_111 ( & V_113 , V_19 ) ;
if ( V_76 )
goto V_126;
V_76 = F_21 ( V_10 , V_19 ) ;
if ( V_76 )
goto V_126;
V_76 = F_108 ( & V_113 , V_19 ) ;
if ( V_76 )
goto V_126;
V_76 = F_105 ( V_118 , & V_113 , & V_19 -> V_148 , & V_10 -> error ) ;
if ( V_76 )
goto V_126;
V_76 = F_105 ( V_118 + 1 , & V_113 , & V_147 , & V_10 -> error ) ;
if ( V_76 )
goto V_126;
if ( ( ! V_19 -> V_148 && V_147 ) ||
( V_19 -> V_148 && ! V_147 ) ) {
...
V_76 = V_1 -> V_6 -> V_16 . type -> F_128 ( & V_1 -> V_6 -> V_16 , & V_1 -> V_13 ) ;
if ( V_76 )
goto V_156;
V_1 -> V_3 = true ;
...
static int F_133 ( struct V_18 * V_19 , const char * V_164 , bool V_70 )
{
struct V_5 * V_6 ;
unsigned V_165 ;
char V_166 ;
...
int V_76 ;
F_143 ( ! V_51 ) ;
V_76 = F_141 ( V_19 , V_78 , error , V_51 ) ;
V_1 = V_51 -> V_1 ;
if ( V_1 ) {
V_16 = & V_1 -> V_6 -> V_16 ;
if ( V_16 -> type -> V_185 )
V_16 -> type -> V_185 ( V_16 , & V_1 -> V_13 , V_51 -> V_65 ) ;
}
F_32 ( V_19 , V_79 ) ;
return V_76 ;
}
...
int V_76 ;
F_143 ( ! V_51 ) ;
V_76 = F_144 ( V_19 , V_78 , error , V_51 ) ;
V_1 = V_51 -> V_1 ;
if ( V_1 ) {
V_16 = & V_1 -> V_6 -> V_16 ;
if ( V_16 -> type -> V_185 )
...
F_153 ( L_47 , F_42 ( V_74 , & V_19 -> V_23 ) +
( V_19 -> V_144 > 0 ) * 2 +
( V_19 -> V_27 != V_28 ) * 2 +
F_42 ( V_44 , & V_19 -> V_23 ) +
( V_19 -> V_33 != V_38 ) * 2 ) ;
...
V_76 = F_133 ( V_19 , V_121 [ 1 ] , true ) ;
goto V_156;
} else if ( ! strcasecmp ( V_121 [ 0 ] , L_65 ) ) {
V_76 = F_133 ( V_19 , V_121 [ 1 ] , false ) ;
goto V_156;
} else if ( ! strcasecmp ( V_121 [ 0 ] , L_66 ) ) {
V_76 = F_132 ( V_19 , V_121 [ 1 ] ) ;
goto V_156;
...
V_76 = F_97 ( V_10 , V_121 [ 1 ] , F_98 ( V_10 -> V_36 ) , & V_14 ) ;
if ( V_76 ) {
F_124 ( L_70 ,
V_121 [ 1 ] ) ;
goto V_156;
}
V_76 = F_130 ( V_19 , V_14 , V_163 ) ;
F_11 ( V_10 , V_14 ) ;
V_156:
F_150 ( & V_19 -> V_31 ) ;
return V_76 ;
...
if ( V_69 ) {
if ( ! F_42 ( V_22 , & V_19 -> V_23 ) ) {
* V_84 = V_69 -> V_13 . V_14 -> V_84 ;
* V_197 = V_69 -> V_13 . V_14 -> V_197 ;
V_76 = 0 ;
} else {
V_76 = - V_198 ;
}
...
if ( ! V_76 && V_10 -> V_141 != F_157 ( ( * V_84 ) -> V_199 ) >> V_200 )
return 1 ;
return V_76 ;
}
...
if ( F_41 ( & V_19 -> V_25 ) )
return true ;
if ( ! F_41 ( & V_19 -> V_24 ) && F_42 ( V_74 , & V_19 -> V_23 ) )
return ( V_19 -> V_33 != V_37 ) ;
V_6 = F_56 ( V_19 -> V_61 ) ;
V_72 = F_56 ( V_19 -> V_72 ) ;
if ( F_55 ( ! F_56 ( V_19 -> V_69 ) && V_72 ) )
V_6 = V_72 ;
if ( ! V_6 ) {
return V_203 ;
}
