...
case V_245 :
case V_246 :
F_160 ( V_67 , V_239 , V_247 ) ;
break;
case V_248 :
case V_249 :
case V_250 :
F_160 ( V_67 , V_239 , V_251 ) ;
break;
}
}
if ( ( V_13 -> V_242 & V_252 ) && V_225 &&
V_228 )
V_67 -> V_94 = V_253 ;
if ( V_219 )
F_161 ( V_67 , F_162 ( V_254 ) , V_237 ) ;
...
struct V_214 * V_215 = & V_1 -> V_215 [ F_154 ( V_1 , V_43 -> V_216 ) ] ;
T_3 V_260 = V_215 -> V_261 ;
if ( V_215 -> V_261 != V_215 -> V_262 ) {
F_171 ( & V_1 -> V_59 [ V_59 ] , V_260 ) ;
V_215 -> V_262 = V_215 -> V_261 ;
}
}
static void F_172 ( struct V_1 * V_1 , struct V_199 * V_43 )
{
struct V_263 * V_264 = & V_1 -> V_256 ;
struct V_214 * V_215 = & V_1 -> V_215 [ F_154 ( V_1 , V_43 -> V_216 ) ] ;
struct V_204 * V_258 = & V_215 -> V_258 ;
int V_216 ;
T_3 V_260 ;
T_3 V_265 ;
T_3 V_266 ;
...
V_258 -> V_209 ;
V_266 <<= 3 ;
V_266 = V_267 > V_271 ? 0 : V_266 / ( T_3 ) V_267 ;
for ( V_216 = 0 ; V_216 < V_272 ; V_216 ++ )
if ( V_266 < V_273 [ V_216 ] . V_274 )
break;
V_265 = ( V_258 -> V_209 >
V_258 -> V_208 << 1 ) ?
V_264 -> V_275 :
V_264 -> V_276 ;
V_260 = V_265 + ( ( V_264 -> V_277 - V_265 ) *
V_273 [ V_216 ] . V_278 / 100 ) ;
V_215 -> V_261 = ( V_260 + V_215 -> V_261 ) >> 1 ;
V_258 -> V_208 = 0 ;
V_258 -> V_209 = 0 ;
}
static int F_175 ( struct V_65 * V_64 , int V_279 )
{
struct V_46 * V_13 = V_64 -> V_4 ;
struct V_1 * V_1 = F_55 ( V_13 ) ;
unsigned int V_280 = F_154 ( V_1 , 0 ) ;
unsigned int V_281 = F_176 ( V_1 , 0 ) ;
unsigned int V_59 = F_56 () ;
unsigned int V_282 = V_279 ;
unsigned int V_283 = - 1 ;
unsigned int V_284 , V_285 = 0 , V_286 ;
int V_10 ;
V_286 = F_177 ( & V_1 -> V_215 [ V_281 ] , V_283 ,
F_28 , NULL ) ;
if ( ! F_178 ( & V_1 -> V_43 [ V_280 ] ) ) {
if ( V_286 > 0 )
F_179 ( & V_1 -> V_59 [ V_59 ] ,
V_286 ,
0 ,
...
{
F_184 ( V_1 -> V_13 -> V_287 ) ;
V_1 -> V_13 -> V_287 = NULL ;
}
static void F_185 ( struct V_1 * V_1 )
{
int V_5 , V_288 ;
if ( F_186 ( V_1 -> V_27 ) == V_289 ) {
V_1 -> V_13 -> V_287 = F_187 ( V_1 -> V_42 ) ;
if ( F_75 ( ! V_1 -> V_13 -> V_287 ) )
return;
for ( V_5 = 0 ; V_5 < V_1 -> V_42 ; V_5 ++ ) {
V_288 = F_188 ( V_1 -> V_13 -> V_287 ,
V_1 -> V_11 [ V_5 ] . V_12 ) ;
if ( F_75 ( V_288 ) ) {
F_183 ( V_1 ) ;
return;
...
return V_291 ;
V_284 = F_177 ( & V_1 -> V_215 [ V_215 ] , V_290 ,
F_167 , NULL ) ;
if ( V_284 > 0 )
F_179 ( & V_1 -> V_59 [ V_59 ] ,
V_284 , 0 , 0 ) ;
...
static int F_192 ( struct V_65 * V_64 , int V_279 )
{
struct V_46 * V_13 = V_64 -> V_4 ;
struct V_1 * V_1 = F_55 ( V_13 ) ;
unsigned int V_292 = ( V_64 - & V_1 -> V_64 [ 0 ] ) - V_1 -> V_42 ;
struct V_23 * V_24 = & V_1 -> V_24 [ V_292 ] ;
unsigned int V_215 ;
unsigned int V_59 ;
unsigned int V_283 = - 1 ;
unsigned int V_286 ;
unsigned int V_293 ;
V_293 = V_24 -> V_216 ;
V_215 = F_176 ( V_1 , V_293 ) ;
V_59 = F_14 ( V_1 , V_293 ) ;
V_286 = F_177 ( & V_1 -> V_215 [ V_215 ] , V_283 ,
F_28 , NULL ) ;
F_179 ( & V_1 -> V_59 [ V_59 ] , V_286 ,
0 ,
1 ) ;
if ( ! V_286 ) {
F_182 ( V_64 ) ;
...
static int F_193 ( struct V_65 * V_64 , int V_279 )
{
struct V_46 * V_13 = V_64 -> V_4 ;
struct V_1 * V_1 = F_55 ( V_13 ) ;
unsigned int V_43 = ( V_64 - & V_1 -> V_64 [ 0 ] ) ;
unsigned int V_215 = F_154 ( V_1 , V_43 ) ;
unsigned int V_59 = F_170 ( V_1 , V_43 ) ;
unsigned int V_290 = V_279 ;
unsigned int V_284 = 0 ;
int V_10 ;
if ( ! F_178 ( & V_1 -> V_43 [ V_43 ] ) )
return V_279 ;
if ( V_279 > 0 )
V_284 = F_177 ( & V_1 -> V_215 [ V_215 ] ,
V_290 , F_167 , NULL ) ;
if ( V_284 > 0 )
F_179 ( & V_1 -> V_59 [ V_59 ] ,
V_284 ,
...
for ( V_5 = 0 ; V_5 < V_1 -> V_42 ; V_5 ++ ) {
V_59 = F_170 ( V_1 , V_5 ) ;
snprintf ( V_1 -> V_7 [ V_59 ] . V_302 ,
sizeof( V_1 -> V_7 [ V_59 ] . V_302 ) ,
L_13 , V_13 -> V_180 , V_5 ) ;
V_1 -> V_7 [ V_59 ] . V_303 = F_66 ;
V_1 -> V_7 [ V_59 ] . V_300 = & V_1 -> V_64 [ V_5 ] ;
}
for ( V_5 = 0 ; V_5 < V_1 -> V_14 ; V_5 ++ ) {
...
L_14 , V_13 -> V_180 , V_5 ) ;
V_1 -> V_7 [ V_59 ] . V_303 = F_66 ;
V_1 -> V_7 [ V_59 ] . V_300 = & V_1 -> V_64 [ V_24 ] ;
}
V_59 = F_68 ( V_1 ) ;
snprintf ( V_1 -> V_7 [ V_59 ] . V_302 ,
sizeof( V_1 -> V_7 [ V_59 ] . V_302 ) ,
L_15 , V_13 -> V_180 ) ;
V_1 -> V_7 [ V_59 ] . V_303 = F_67 ;
V_1 -> V_7 [ V_59 ] . V_300 = V_1 ;
V_59 = F_70 ( V_1 ) ;
snprintf ( V_1 -> V_7 [ V_59 ] . V_302 ,
sizeof( V_1 -> V_7 [ V_59 ] . V_302 ) ,
L_16 , V_13 -> V_180 ) ;
V_1 -> V_7 [ V_59 ] . V_303 = F_69 ;
V_1 -> V_7 [ V_59 ] . V_300 = V_1 ;
for ( V_5 = 0 ; V_5 < F_199 ( V_1 -> V_7 ) ; V_5 ++ )
V_1 -> V_7 [ V_5 ] . V_299 = 0 ;
for ( V_5 = 0 ; V_5 < V_1 -> V_6 ; V_5 ++ ) {
...
V_216 = V_309 ;
V_264 -> V_275 = V_310 [ V_216 ] . V_275 ;
V_264 -> V_276 = V_310 [ V_216 ] . V_276 ;
V_264 -> V_277 = V_311 ;
for ( V_216 = 0 ; V_216 < V_1 -> V_42 ; V_216 ++ )
V_1 -> V_215 [ V_216 ] . V_262 =
V_1 -> V_312 . V_313 ;
V_264 -> V_257 = 1 ;
}
...
for ( V_5 = 0 ; V_5 < V_1 -> V_42 ; V_5 ++ )
F_220 ( & V_1 -> V_43 [ V_5 ] , F_146 ) ;
for ( V_5 = 0 ; V_5 < V_1 -> V_317 ; V_5 ++ )
F_235 ( & V_1 -> V_215 [ V_5 ] ) ;
for ( V_5 = 0 ; V_5 < V_1 -> V_6 ; V_5 ++ )
F_236 ( & V_1 -> V_59 [ V_5 ] ) ;
return 0 ;
}
static int F_237 ( struct V_46 * V_13 , int V_318 )
{
struct V_1 * V_1 = F_55 ( V_13 ) ;
int V_319 = F_123 ( V_13 ) ;
if ( F_17 ( V_1 ) || F_19 ( V_1 ) )
return - V_174 ;
if ( V_319 )
F_222 ( V_13 ) ;
...
static void F_238 ( struct V_320 * V_321 )
{
struct V_1 * V_1 = F_239 ( V_321 , struct V_1 , V_50 ) ;
struct V_46 * V_13 = V_1 -> V_13 ;
int V_318 = F_44 ( V_1 -> V_27 ) ;
int V_10 ;
unsigned int V_5 ;
V_318 = F_45 ( int , V_48 , F_46 ( int , V_49 , V_318 ) ) ;
F_240 () ;
F_224 ( & V_1 -> V_294 ) ;
for ( V_5 = 0 ; V_5 < V_1 -> V_42 ; V_5 ++ )
F_227 ( & V_1 -> V_64 [ V_5 ] ) ;
...
int V_10 ;
F_246 ( F_247 () ) ;
V_10 = F_244 ( V_27 , V_322 ) ;
if ( V_10 )
return V_10 ;
time = V_295 + ( V_324 * 2 ) ;
do {
V_10 = F_245 ( V_27 , & V_323 ) ;
if ( V_10 )
return V_10 ;
if ( V_323 )
return 0 ;
F_248 ( V_324 / 10 ) ;
} while ( F_249 ( time , V_295 ) );
return - V_325 ;
}
static int F_250 ( struct V_1 * V_1 )
{
int V_10 ;
V_10 = F_243 ( V_1 -> V_27 , V_326 ,
V_327 , 0 ) ;
if ( V_10 )
...
union V_332 * V_333 ;
T_6 V_334 ;
int V_5 , V_335 , V_336 , V_10 ;
V_333 = F_256 ( V_1 -> V_3 ,
sizeof( union V_332 ) ,
& V_334 ) ;
if ( ! V_333 )
return - V_73 ;
for ( V_5 = 0 ; V_5 < V_337 ; V_5 ++ ) {
V_335 = V_5 / V_338 ;
V_336 = V_5 % V_338 ;
V_333 -> V_339 [ V_335 ] . V_340 [ V_336 ] = V_1 -> V_341 [ V_5 ] ;
}
F_207 ( & V_1 -> V_314 ) ;
V_10 = F_257 ( V_1 ,
V_334 ,
sizeof( union V_332 ) ) ;
F_209 ( & V_1 -> V_314 ) ;
F_258 ( V_1 -> V_3 , sizeof( union V_332 ) ,
V_333 , V_334 ) ;
return V_10 ;
}
static int F_259 ( struct V_1 * V_1 )
{
F_260 ( V_1 -> V_341 , V_337 ) ;
return F_255 ( V_1 ) ;
}
static int F_261 ( struct V_1 * V_1 , T_1 V_342 )
{
T_6 V_343 ;
union V_344 * V_345 = NULL ;
unsigned int V_5 ;
int V_10 ;
V_345 = F_262 ( V_1 -> V_3 ,
sizeof( union V_344 ) , & V_343 ) ;
if ( ! V_345 )
return - V_73 ;
for ( V_5 = 0 ; V_5 < ( 1 << V_342 ) ; V_5 ++ )
( * V_345 ) . V_346 [ V_5 / 4 ] . V_340 [ V_5 % 4 ] = V_5 % V_1 -> V_42 ;
F_207 ( & V_1 -> V_314 ) ;
V_10 = F_263 ( V_1 ,
V_343 ,
sizeof( union V_344 ) ) ;
F_209 ( & V_1 -> V_314 ) ;
F_258 ( V_1 -> V_3 , sizeof( union V_344 ) ,
V_345 , V_343 ) ;
return V_10 ;
}
static int F_264 ( struct V_1 * V_1 , T_1 V_347 ,
T_1 V_348 , T_1 V_342 , T_1 V_349 , T_1 V_350 )
{
const T_1 V_351 = 0 ;
const T_1 V_352 = 1 ;
int V_10 ;
...
const T_1 V_347 = 0 ;
const T_1 V_348 = V_353 |
V_354 |
V_355 |
V_356 ;
const T_1 V_342 = 7 ;
const T_1 V_349 = 0 ;
T_1 V_350 = F_267 ( V_1 , V_357 ) && ( V_1 -> V_42 > 1 ) ;
if ( V_350 ) {
if ( ! F_259 ( V_1 ) ) {
if ( F_261 ( V_1 , V_342 ) ) {
V_350 = 0 ;
...
return F_264 ( V_1 , V_347 , V_348 ,
V_342 , V_349 , V_350 ) ;
}
static void F_269 ( struct V_320 * V_321 )
{
struct V_1 * V_1 = F_239 ( V_321 , struct V_1 , V_62 ) ;
if ( ! F_123 ( V_1 -> V_13 ) )
return;
F_240 () ;
F_29 ( & V_1 -> V_358 ) ;
...
F_211 ( V_1 -> V_13 ) ;
F_35 ( & V_1 -> V_358 ) ;
F_272 ( V_359 , V_1 -> V_13 ) ;
F_241 () ;
}
static void F_273 ( struct V_320 * V_321 )
{
struct V_1 * V_1 = F_239 ( V_321 , struct V_1 , V_160 ) ;
F_240 () ;
F_29 ( & V_1 -> V_358 ) ;
F_274 ( V_1 ) ;
F_222 ( V_1 -> V_13 ) ;
...
{
unsigned int V_360 = F_46 (unsigned int, enic->rq_count, ENIC_RQ_MAX) ;
unsigned int V_361 = F_46 (unsigned int, enic->wq_count, ENIC_WQ_MAX) ;
unsigned int V_5 ;
F_246 ( F_199 ( V_1 -> V_11 ) < V_360 + V_361 + 2 ) ;
for ( V_5 = 0 ; V_5 < V_360 + V_361 + 2 ; V_5 ++ )
V_1 -> V_11 [ V_5 ] . V_362 = V_5 ;
if ( F_267 ( V_1 , V_357 ) &&
V_1 -> V_312 . V_363 < 1 &&
V_1 -> V_42 >= V_360 &&
V_1 -> V_14 >= V_361 &&
V_1 -> V_317 >= V_360 + V_361 &&
V_1 -> V_6 >= V_360 + V_361 + 2 ) {
if ( F_276 ( V_1 -> V_3 , V_1 -> V_11 ,
V_360 + V_361 + 2 , V_360 + V_361 + 2 ) > 0 ) {
V_1 -> V_42 = V_360 ;
V_1 -> V_14 = V_361 ;
V_1 -> V_317 = V_360 + V_361 ;
V_1 -> V_6 = V_360 + V_361 + 2 ;
...
if ( V_1 -> V_312 . V_363 < 1 &&
V_1 -> V_42 >= 1 &&
V_1 -> V_14 >= V_361 &&
V_1 -> V_317 >= 1 + V_361 &&
V_1 -> V_6 >= 1 + V_361 + 2 ) {
if ( F_276 ( V_1 -> V_3 , V_1 -> V_11 ,
1 + V_361 + 2 , 1 + V_361 + 2 ) > 0 ) {
V_1 -> V_42 = 1 ;
V_1 -> V_14 = V_361 ;
V_1 -> V_317 = 1 + V_361 ;
V_1 -> V_6 = 1 + V_361 + 2 ;
...
V_1 -> V_317 = 2 ;
V_1 -> V_6 = 1 ;
F_277 ( V_1 -> V_27 , V_298 ) ;
return 0 ;
}
if ( V_1 -> V_312 . V_363 < 3 &&
V_1 -> V_42 >= 1 &&
V_1 -> V_14 >= 1 &&
V_1 -> V_317 >= 2 &&
V_1 -> V_6 >= 3 ) {
...
V_1 -> V_317 = 2 ;
V_1 -> V_6 = 3 ;
F_277 ( V_1 -> V_27 , V_297 ) ;
return 0 ;
}
F_277 ( V_1 -> V_27 , V_364 ) ;
return - V_168 ;
}
...
V_1 -> V_42 = 1 ;
V_1 -> V_14 = 1 ;
V_1 -> V_312 . V_365 = V_366 ;
V_1 -> V_312 . V_367 = V_368 ;
V_1 -> V_312 . V_45 = F_46 ( T_2 , 1500 , V_1 -> V_312 . V_45 ) ;
}
}
...
{
unsigned int V_5 ;
for ( V_5 = 0 ; V_5 < F_199 ( V_1 -> V_371 ) ; V_5 ++ )
if ( V_1 -> V_371 [ V_5 ] . V_372 )
F_297 ( V_1 -> V_371 [ V_5 ] . V_372 ) ;
}
static int F_298 ( struct V_373 * V_3 , const struct V_374 * V_375 )
{
...
for ( V_5 = 0 ; V_5 < F_199 ( V_1 -> V_371 ) ; V_5 ++ ) {
if ( ! ( F_308 ( V_3 , V_5 ) & V_385 ) )
continue;
V_1 -> V_371 [ V_5 ] . V_30 = F_309 ( V_3 , V_5 ) ;
V_1 -> V_371 [ V_5 ] . V_372 = F_310 ( V_3 , V_5 , V_1 -> V_371 [ V_5 ] . V_30 ) ;
if ( ! V_1 -> V_371 [ V_5 ] . V_372 ) {
F_251 ( V_4 , L_43 , V_5 ) ;
V_10 = - V_386 ;
goto V_387;
}
V_1 -> V_371 [ V_5 ] . V_388 = F_311 ( V_3 , V_5 ) ;
}
V_1 -> V_27 = F_312 ( NULL , V_1 , V_3 , V_1 -> V_371 ,
F_199 ( V_1 -> V_371 ) ) ;
if ( ! V_1 -> V_27 ) {
F_251 ( V_4 , L_44 ) ;
V_10 = - V_386 ;
...
goto V_389;
#ifdef F_21
V_377 = F_314 ( V_3 , V_390 ) ;
if ( V_377 ) {
F_315 ( V_3 , V_377 + V_391 ,
& V_1 -> V_22 ) ;
if ( V_1 -> V_22 ) {
...
#endif
V_1 -> V_163 = F_317 ( V_378 , sizeof( * V_1 -> V_163 ) , V_9 ) ;
if ( ! V_1 -> V_163 ) {
V_10 = - V_73 ;
goto V_392;
}
...
F_321 ( V_13 , V_1 -> V_42 ) ;
F_322 ( & V_1 -> V_294 ) ;
V_1 -> V_294 . V_395 = F_194 ;
V_1 -> V_294 . V_54 = ( unsigned long ) V_1 ;
F_204 ( V_1 ) ;
...
V_13 -> V_402 = 2 * V_324 ;
F_324 ( V_13 ) ;
V_13 -> V_242 |= V_403 | V_404 ;
if ( F_267 ( V_1 , V_405 ) ) {
V_13 -> V_242 &= ~ V_403 ;
V_1 -> V_92 = 1 ;
V_1 -> V_93 = V_1 -> V_312 . V_93 ;
F_288 ( V_4 , L_52 , V_1 -> V_93 ) ;
}
if ( F_267 ( V_1 , V_406 ) )
V_13 -> V_407 |= V_408 | V_409 ;
if ( F_267 ( V_1 , V_410 ) )
V_13 -> V_407 |= V_411 |
V_412 | V_413 ;
if ( F_267 ( V_1 , V_357 ) )
...
if ( F_267 ( V_1 , V_414 ) )
V_13 -> V_407 |= V_252 ;
V_13 -> V_242 |= V_13 -> V_407 ;
V_13 -> V_415 |= V_13 -> V_242 ;
#ifdef F_325
V_13 -> V_407 |= V_416 ;
#endif
if ( V_376 )
...
static void F_334 ( struct V_373 * V_3 )
{
