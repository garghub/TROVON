...
if ( F_175 ( & V_5 . V_50 , L_124 , V_252 ) < 0 )
return - V_43 ;
if ( F_173 ( V_5 . V_50 , V_242 ) )
return - 1 ;
if ( F_175 ( & V_5 . V_160 , L_124 ,
V_5 . V_107 == V_110 ?
L_125 :
V_5 . V_107 == V_108 ?
L_126 :
...
return - V_43 ;
F_17 ( L_128 , V_5 . V_50 ) ;
F_17 ( L_129 , V_5 . V_160 ) ;
F_17 ( L_130 , V_5 . V_159 ) ;
return 0 ;
}
...
F_178 ( 'k' , L_131 , & V_225 . V_264 ,
L_132 , L_133 ) ,
F_178 ( 'i' , L_134 , & V_265 , L_132 ,
L_135 ) ,
F_179 ( 'N' , L_136 , & V_5 . V_122 ,
L_137 ) ,
#ifdef F_56
F_180 ( 0 , L_138 , & V_5 . V_212 , L_139 ) ,
#endif
F_180 ( 0 , L_140 , & V_5 . V_200 ,
L_139 ) ,
F_180 ( 0 , L_141 , & V_5 . V_55 ,
L_142 ) ,
F_180 ( 0 , L_143 , & V_242 ,
L_144 ) ,
F_180 ( 0 , L_145 , & V_5 . V_152 ,
L_146 ) ,
F_181 ( 'g' , L_147 , & V_221 ,
L_148 ,
V_266 , & F_165 ,
V_261 ) ,
F_178 ( 'd' , L_149 , & V_107 , L_150 , L_151 ) ,
F_178 ( 'c' , L_152 , & V_251 , L_153 ,
L_154 ) ,
F_180 ( 'f' , L_155 , & V_225 . V_267 , L_156 ) ,
F_182 ( V_268 ) ,
F_183 ()
} ;
int V_269 = 0 ;
...
L_172
L_173 ,
V_5 . V_107 == V_110 ? L_125 :
V_5 . V_107 == V_109 ? L_174 : L_175
) ;
F_191 ( & V_257 , V_5 . V_14 . V_14 . V_33 , L_176 ) ;
...
bool V_274 = false ;
struct V_217 V_263 [] = {
F_197 ( 'e' , L_177 , & V_274 , L_177 ,
L_178 ,
F_194 ) ,
F_180 ( 'u' , L_179 , & V_278 , L_180 ) ,
F_180 ( 'k' , L_181 , & V_279 , L_182 ) ,
F_198 ( 'l' , L_183 , & V_280 , L_184 ) ,
F_182 ( V_268 ) ,
F_183 ()
} ;
if ( F_199 () ) {
...
V_276 = 0 ;
while ( V_277 [ V_276 ] ) {
F_17 ( L_195 , V_277 [ V_276 ] ) ;
V_276 ++ ;
}
F_17 ( L_66 ) ;
}
V_19 = F_201 ( V_132 , V_277 , NULL ) ;
free ( V_277 ) ;
return V_19 ;
}
int F_202 ( int V_254 , const char * * V_255 , const char * T_11 V_27 )
{
V_254 = F_184 ( V_254 , V_255 , V_268 , V_290 ,
V_271 ) ;
if ( ! V_254 )
F_185 ( V_290 , V_268 ) ;
if ( ! strncmp ( V_255 [ 0 ] , L_196 , 3 ) ) {
return F_196 ( V_254 , V_255 ) ;
} else if ( ! strncmp ( V_255 [ 0 ] , L_197 , 3 ) ) {
