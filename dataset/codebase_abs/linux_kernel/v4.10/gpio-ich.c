...
static int F_17 ( struct V_52 * V_40 ,
struct V_53 * V_54 , const char * V_55 , T_2 V_22 )
{
int V_56 ;
if ( ! V_54 || ! V_54 -> V_57 || ! V_54 -> V_58 )
return - V_34 ;
for ( V_56 = 0 ; V_56 < F_18 ( V_11 . V_14 -> V_17 [ 0 ] ) ; V_56 ++ ) {
if ( ! ( V_22 & ( 1 << V_56 ) ) )
continue;
if ( ! F_19 ( V_40 ,
V_54 -> V_57 + V_11 . V_14 -> V_17 [ 0 ] [ V_56 ] ,
V_11 . V_14 -> V_59 [ V_56 ] , V_55 ) )
return - V_60 ;
}
return 0 ;
}
...
{
struct V_53 * V_54 , * V_63 ;
int V_64 ;
struct V_65 * V_66 = F_21 ( & V_62 -> V_40 ) ;
if ( ! V_66 )
return - V_34 ;
V_11 . V_40 = V_62 ;
switch ( V_66 -> V_67 ) {
...
F_22 ( & V_11 . V_12 ) ;
V_54 = F_23 ( V_62 , V_84 , V_85 ) ;
V_11 . V_22 = V_66 -> V_22 ;
V_64 = F_17 ( & V_62 -> V_40 , V_54 , V_62 -> V_55 ,
V_11 . V_22 ) ;
if ( V_64 )
return V_64 ;
V_11 . V_18 = V_54 ;
if ( ! V_11 . V_14 -> V_86 )
goto V_87;
V_63 = F_23 ( V_62 , V_84 , V_88 ) ;
if ( ! V_63 ) {
F_24 ( L_1 ) ;
goto V_87;
}
if ( ! F_19 ( & V_62 -> V_40 , V_63 -> V_57 ,
F_25 ( V_63 ) , V_62 -> V_55 ) ) {
F_24 ( L_2 ) ;
goto V_87;
}
...
V_87:
F_16 ( & V_11 . V_29 ) ;
V_64 = F_26 ( & V_11 . V_29 , NULL ) ;
if ( V_64 ) {
F_27 ( L_3 ) ;
return V_64 ;
}
F_28 ( L_4 , V_11 . V_29 . V_47 ,
