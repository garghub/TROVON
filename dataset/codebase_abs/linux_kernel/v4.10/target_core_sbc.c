...
V_42 = V_39 -> V_69 ( V_2 , V_2 -> V_88 , V_2 -> V_105 ,
V_106 ) ;
if ( V_42 ) {
V_2 -> V_98 = NULL ;
F_40 ( & V_4 -> V_79 ) ;
...
static int
F_52 ( T_5 V_107 , bool V_108 , enum V_109 V_110 ,
bool V_111 , struct V_1 * V_2 )
{
if ( V_111 ) {
V_2 -> V_112 = V_108 ? V_113 :
V_107 ? V_25 :
V_114 ;
switch ( V_107 ) {
case 0x0 :
...
if ( F_52 ( V_107 , V_108 , V_22 , V_111 , V_2 ) )
return V_14 ;
V_2 -> V_110 = V_22 ;
V_2 -> V_130 = V_4 -> V_130 * V_44 ;
if ( V_107 )
V_2 -> V_17 = V_44 * V_4 -> V_15 . V_16 ;
F_54 ( L_22
L_23 ,
V_131 , V_2 -> V_110 , V_2 -> V_17 , V_2 -> V_130 ,
V_2 -> V_112 , V_2 -> V_115 ) ;
return V_60 ;
}
static int
...
if ( F_55 ( V_4 , V_2 , V_6 ) )
return V_14 ;
V_133 = 2 * F_14 ( V_2 , V_44 ) ;
V_2 -> V_37 = F_58 ( & V_6 [ 2 ] ) ;
V_2 -> V_85 = V_44 ;
V_2 -> V_74 |= V_135 | V_152 ;
V_2 -> V_52 = F_50 ;
V_2 -> V_98 = F_41 ;
break;
case V_153 :
...
V_133 = V_175 ;
if ( V_133 / 16 > V_4 -> V_15 . V_177 ) {
V_42 = V_178 ;
goto V_179;
}
V_171 = & V_12 [ 8 ] ;
F_54 ( L_42
L_43 , V_4 -> V_9 -> V_103 , V_174 , V_175 , V_133 , V_171 ) ;
while ( V_133 >= 16 ) {
V_172 = F_58 ( & V_171 [ 0 ] ) ;
V_173 = F_11 ( & V_171 [ 8 ] ) ;
F_54 ( L_44 ,
