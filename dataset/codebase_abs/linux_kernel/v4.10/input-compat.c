...
if ( F_3 ( V_3 , V_1 , sizeof( struct V_2 ) ) )
return - V_7 ;
}
return 0 ;
}
int F_4 ( char T_1 * V_1 ,
...
if ( F_5 ( V_1 , V_3 , sizeof( struct V_2 ) ) )
return - V_7 ;
}
return 0 ;
}
int F_6 ( const char T_1 * V_1 , T_2 V_12 ,
struct V_13 * V_14 )
{
if ( F_2 () ) {
struct V_15 * V_16 ;
...
V_14 -> V_19 . V_20 . V_23 =
F_7 ( V_16 -> V_19 . V_20 . V_23 ) ;
} else {
if ( V_12 != sizeof( struct V_13 ) )
return - V_17 ;
if ( F_3 ( V_14 , V_1 , sizeof( struct V_13 ) ) )
return - V_7 ;
}
return 0 ;
}
