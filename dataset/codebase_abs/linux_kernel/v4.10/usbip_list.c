...
V_48 = ( const struct V_47 * ) V_49 ;
V_19 = F_37 ( V_48 -> V_19 ) ;
sprintf ( V_50 , L_32 , V_19 ) ;
V_20 = F_37 ( V_48 -> V_20 ) ;
sprintf ( V_51 , L_32 , V_19 ) ;
V_24 = F_31 ( V_40 ) ;
F_10 ( V_4 , sizeof( V_4 ) ,
F_37 ( V_19 ) ,
F_37 ( V_20 ) ) ;
F_18 ( V_24 , V_50 , V_51 , V_33 ) ;
F_19 ( V_4 , V_33 ) ;
printf ( L_15 ) ;
F_32 ( V_40 ) ;
}
...
F_12 ( L_37 , V_61 ) ;
for (; ; ) {
V_60 = F_40 ( V_54 , V_55 , L_38 , V_57 , NULL ) ;
if ( V_60 == - 1 )
break;
switch ( V_60 ) {
case 'p' :
