...
V_83 -> V_91 = V_68 ;
V_83 -> V_92 = V_93 ;
V_83 -> V_94 = F_56 ( V_9 -> V_4 ) ;
memset ( & V_82 , 0 , sizeof( V_82 ) ) ;
V_82 . V_95 = V_42 -> V_96 ;
V_82 . V_97 = V_69 ;
if ( F_57 ( V_9 -> V_42 , V_98 , sizeof( V_82 ) , & V_82 ) )
goto V_99;
if ( V_73 &&
F_57 ( V_9 -> V_42 , V_100 , V_74 , V_73 ) )
goto V_99;
if ( V_71 ) {
#if ! F_58 ( V_101 )
...
#else
if ( V_68 == V_104 ) {
if ( F_59 ( V_9 -> V_42 , V_105 ,
F_60 ( V_71 -> V_103 ) ) ||
F_59 ( V_9 -> V_42 , V_102 ,
F_60 ( F_61 ( V_71 ) -> V_106 -> V_107 -> V_103 ) ) )
goto V_99;
} else {
struct V_70 * V_108 ;
if ( F_59 ( V_9 -> V_42 , V_102 ,
...
#else
if ( V_68 == V_104 ) {
if ( F_59 ( V_9 -> V_42 , V_110 ,
F_60 ( V_72 -> V_103 ) ) ||
F_59 ( V_9 -> V_42 , V_109 ,
F_60 ( F_61 ( V_72 ) -> V_106 -> V_107 -> V_103 ) ) )
goto V_99;
} else {
struct V_70 * V_111 ;
if ( F_59 ( V_9 -> V_42 , V_109 ,
...
if ( V_42 -> V_112 &&
F_59 ( V_9 -> V_42 , V_113 , F_60 ( V_42 -> V_112 ) ) )
goto V_99;
if ( V_71 && V_42 -> V_107 &&
...
V_63 = F_64 ( V_42 , V_117 . V_118 ) ;
if ( V_63 > 0 ) {
V_117 . V_119 = F_56 ( V_63 ) ;
if ( F_57 ( V_9 -> V_42 , V_120 , sizeof( V_117 ) , & V_117 ) )
goto V_99;
}
}
if ( V_71 && F_65 ( V_42 ) ) {
if ( F_66 ( V_9 -> V_42 , V_121 , F_56 ( V_42 -> V_107 -> type ) ) ||
F_66 ( V_9 -> V_42 , V_122 ,
F_56 ( V_42 -> V_107 -> V_123 ) ) )
goto V_99;
V_88 = F_67 ( V_42 ) ;
...
if ( V_42 -> V_127 ) {
struct V_128 V_129 ;
struct V_130 V_131 = F_68 ( V_42 -> V_127 ) ;
...
struct V_158 * V_159 ;
int V_160 = F_76 ( V_67 ) ;
if ( F_50 ( V_9 -> V_42 ) < F_77 ( V_67 ) )
goto V_99;
V_159 = (struct V_158 * ) F_78 ( V_9 -> V_42 , F_77 ( V_67 ) ) ;
V_159 -> V_161 = V_162 ;
V_159 -> V_163 = V_160 ;
if ( F_79 ( V_42 , 0 , F_80 ( V_159 ) , V_67 ) )
F_81 () ;
}
...
if ( V_73 )
V_74 = strlen ( V_73 ) + 1 ;
V_160 = F_84 ( sizeof( struct V_62 ) )
+ F_77 ( sizeof( struct V_81 ) )
+ F_77 ( sizeof( T_4 ) )
+ F_77 ( sizeof( T_4 ) )
#if F_58 ( V_101 )
+ F_77 ( sizeof( T_4 ) )
...
+ F_77 ( sizeof( T_4 ) )
+ F_77 ( V_74 )
+ F_77 ( sizeof( struct V_116 ) )
+ F_77 ( sizeof( struct V_128 ) )
+ F_77 ( sizeof( struct V_62 ) ) ;
if ( V_166 && F_65 ( V_42 ) ) {
V_160 += F_77 ( V_42 -> V_107 -> V_123 )
+ F_77 ( sizeof( T_2 ) )
+ F_77 ( sizeof( T_2 ) ) ;
}
F_21 ( & V_9 -> V_26 ) ;
...
static int F_90 ( struct V_2 * V_2 , struct V_86 * V_197 ,
...
{
struct V_62 * V_83 = F_55 ( V_60 ) ;
T_2 V_4 = F_92 ( V_83 -> V_94 ) ;
struct V_6 * V_9 ;
