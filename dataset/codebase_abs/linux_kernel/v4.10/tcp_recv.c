...
V_45 = F_23 ( V_11 , V_34 , V_14 , V_36 -> V_47 ) ;
if ( ! V_45 ) {
V_33 -> error = - V_48 ;
goto V_13;
}
...
if ( V_42 -> V_51 == 0 && V_42 -> V_53 == 0 ) {
struct V_19 * V_20 = V_39 -> V_49 ;
if ( V_4 -> V_5 . V_25 . V_54 == V_55 )
F_13 ( V_20 , V_4 ) ;
else
F_25 ( V_20 , V_20 -> V_50 ,
V_20 -> V_56 , & V_4 -> V_5 ,
V_36 -> V_47 ) ;
V_42 -> V_51 = sizeof( struct V_52 ) ;
V_42 -> V_53 = 0 ;
V_42 -> V_44 = NULL ;
F_26 ( & V_4 -> V_5 ) ;
V_4 = NULL ;
...
F_3 ( L_8 ,
V_16 , V_46 , V_11 -> V_16 ,
F_27 ( & V_42 -> V_57 -> V_58 -> V_59 ) ) ;
return V_16 - V_46 ;
}
static int F_28 ( struct V_38 * V_39 , T_3 V_47 )
{
struct V_41 * V_42 = V_39 -> V_43 ;
struct V_60 * V_61 = V_42 -> V_57 ;
T_1 V_33 ;
struct V_35 V_36 ;
V_36 . V_40 = V_39 ;
V_36 . V_47 = V_47 ;
...
void F_33 ( struct V_61 * V_58 )
{
void (* F_34)( struct V_61 * V_58 );
struct V_38 * V_39 ;
struct V_41 * V_42 ;
F_3 ( L_11 , V_58 ) ;
F_35 ( & V_58 -> V_65 ) ;
...
F_34 = V_42 -> V_68 ;
F_36 ( V_69 ) ;
if ( F_28 ( V_39 , V_70 ) == - V_48 )
F_37 ( V_71 , & V_39 -> V_72 , 0 ) ;
V_13:
F_38 ( & V_58 -> V_65 ) ;
F_34 ( V_58 ) ;
}
