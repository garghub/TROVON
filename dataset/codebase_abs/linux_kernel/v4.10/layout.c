...
const struct V_12 * V_13 ,
enum V_26 V_34 , T_2 V_63 )
{
F_3 ( V_34 == V_23 || V_34 == V_22 ) ;
if ( ( V_63 != ( T_2 ) V_13 -> V_17 ) &&
( V_13 -> V_17 != - 1 ) &&
! ( V_13 -> V_15 & V_62 ) &&
( V_63 > 0 ) ) {
...
V_20 -> V_21 [ V_34 ] [ F_16 ( V_20 , V_13 , V_34 ) ] = V_63 ;
}
...
T_1 V_1 = 0 ;
T_2 V_63 ;
V_63 = F_42 ( V_66 , V_32 -> V_9 [ V_34 ] . V_10 ) ;
if ( ! V_63 )
return V_63 ;
for (; V_1 < V_32 -> V_9 [ V_34 ] . V_10 ; ++ V_1 )
if ( V_32 -> V_9 [ V_34 ] . V_14 [ V_1 ] -> V_17 != - 1 )
V_63 += F_43 ( V_32 -> V_9 [ V_34 ] . V_14 [ V_1 ] ->
V_17 ) ;
return V_63 ;
}
