...
V_82 = V_2 -> V_44 ;
F_35 ( & V_2 -> V_72 ) ;
return snprintf ( V_78 , V_81 , L_2 , V_82 ) ;
}
...
static void F_42 ( struct V_71 * V_75 )
{
F_43 ( F_33 ( V_75 ) ) ;
}
struct V_1 * F_44 ( T_1 V_6 , int V_85 )
{
struct V_1 * V_2 ;
V_2 = F_45 ( sizeof( * V_2 ) , V_86 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_70 . V_71 . V_87 = F_42 ;
V_2 -> V_70 . V_71 . type = & V_88 ;
V_2 -> V_70 . V_85 = V_85 ;
if ( V_85 == V_89 )
V_2 -> V_70 . V_85 = V_90 ;
V_2 -> V_6 = V_6 ;
...
F_47 ( & V_2 -> V_42 ) ;
F_47 ( & V_2 -> V_43 ) ;
F_48 ( & V_2 -> V_36 , V_91 , ( unsigned long ) V_2 ) ;
return V_2 ;
}
void F_49 ( struct V_1 * V_2 , struct V_31 * V_33 )
{
V_2 -> V_33 = V_33 ;
F_34 ( & V_2 -> V_72 ) ;
V_29 ( F_30 ( V_2 , V_74 ) ) ;
...
void F_50 ( struct V_1 * V_2 , struct V_31 * V_32 )
{
F_51 ( ! V_32 -> V_41 ) ;
F_34 ( & V_2 -> V_72 ) ;
F_52 ( & V_32 -> V_39 , & V_2 -> V_43 ) ;
V_2 -> V_44 ++ ;
V_2 -> V_80 ++ ;
F_53 ( & V_2 -> V_52 -> V_80 ) ;
V_29 ( F_31 ( V_2 , V_74 ) ) ;
...
void F_54 ( struct V_1 * V_2 , struct V_31 * V_32 )
{
struct V_31 * V_92 ;
F_34 ( & V_2 -> V_72 ) ;
if ( ! F_55 ( & V_32 -> V_39 ) ) {
F_14 (tmp, &aq->pendingq, list)
if ( V_92 -> V_18 == V_32 -> V_18 ) {
V_2 -> V_40 -- ;
goto V_93;
}
V_2 -> V_44 -- ;
...
F_57 (ap_msg, next, &aq->pendingq, list) {
F_15 ( & V_32 -> V_39 ) ;
V_2 -> V_40 -- ;
V_32 -> V_58 = - V_94 ;
V_32 -> V_41 ( V_2 , V_32 , NULL ) ;
}
F_57 (ap_msg, next, &aq->requestq, list) {
F_15 ( & V_32 -> V_39 ) ;
V_2 -> V_44 -- ;
V_32 -> V_58 = - V_94 ;
V_32 -> V_41 ( V_2 , V_32 , NULL ) ;
