...
struct V_7 * V_4 ;
struct V_1 * V_2 ;
struct V_99 * V_100 = F_43 ( & V_121 -> V_64 ) ;
struct V_124 * V_125 = V_121 -> V_64 . V_126 ;
if ( ! V_100 ) {
if ( V_125 ) {
V_100 = F_44 ( & V_121 -> V_64 , V_125 ) ;
if ( F_45 ( V_100 ) )
return F_46 ( V_100 ) ;
} else {
F_18 ( & V_121 -> V_64 , L_18 ) ;
return - V_72 ;
}
}
V_4 = F_47 ( & V_121 -> V_64 , sizeof( * V_4 ) , V_127 ) ;
if ( ! V_4 )
return - V_128 ;
V_2 = F_47 ( & V_121 -> V_64 ,
sizeof( * V_2 ) * V_100 -> V_129 , V_127 ) ;
if ( ! V_2 )
return - V_128 ;
V_4 -> V_63 = V_121 ;
V_4 -> V_100 = V_100 ;
...
if ( V_8 )
goto V_132;
F_51 ( & V_121 -> V_64 , L_19 , V_123 -> V_133 ) ;
V_8 = F_52 ( V_2 , V_4 ) ;
if ( V_8 )
goto V_134;
V_8 = F_53 ( V_4 ) ;
if ( V_8 ) {
F_18 ( & V_121 -> V_64 , L_20 ) ;
goto V_135;
}
return 0 ;
V_135:
