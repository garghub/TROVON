...
static int F_36 ( struct V_1 * V_95 ,
struct V_96 * V_97 )
{
struct V_3 * V_4 = F_2 ( V_95 -> V_38 ) ;
struct V_3 * V_98 ;
...
while ( ( V_31 = F_38 ( & V_4 -> V_102 -> V_103 , V_101 ) ) != NULL ) {
F_32 ( V_31 , V_4 ) ;
V_101 = V_31 ;
}
return - V_6 ;
...
V_100 = V_16 [ 1 ] + 1 ;
V_42 = V_16 + 8 ;
for ( V_33 = 0 ; V_33 < V_100 && V_42 < V_16 + V_80 ; V_33 ++ ) {
V_81 += V_42 [ 2 ] ;
V_42 += V_42 [ 3 ] + 4 ;
}
V_40 -> V_43 = V_42 ;
...
if ( ! V_67 )
goto V_106;
V_31 = F_39 ( V_95 -> V_38 , F_40 ( & V_4 -> V_94 ) ,
V_74 , & V_108 ) ;
if ( F_30 ( V_31 ) ) {
V_5 = F_41 ( V_31 ) ;
goto V_106;
...
{
struct V_30 * V_31 , * V_101 = NULL ;
while ( ( V_31 = F_38 ( & V_4 -> V_102 -> V_103 , V_101 ) ) != NULL ) {
V_101 = V_31 ;
if ( ! F_45 ( V_31 , & V_4 -> V_94 ) )
break;
}
if ( V_31 )
F_46 ( & V_31 -> V_31 ) ;
