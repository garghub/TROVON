...
static int F_36 ( struct V_47 * V_48 , unsigned int V_49 ,
T_1 V_1 )
{
unsigned int V_18 = 1 << F_1 ( V_1 ) ;
void T_2 * V_26 = F_4 ( V_1 ) ;
...
static void T_4 F_47 ( struct V_20 * V_21 , int V_44 )
{
...
T_3 V_70 ;
bool V_71 = false ;
V_68 = F_53 ( NULL , NULL , L_1 ) ;
if ( ! V_68 )
return - V_72 ;
V_69 = F_54 ( V_68 , L_2 , & V_70 ) ;
if ( V_69 ) {
F_55 ( L_3 ) ;
return V_69 ;
}
...
V_21 -> V_39 = V_70 ;
if ( F_56 ( V_68 , L_5 , NULL ) )
V_71 = true ;
if ( V_71 )
F_51 () ;
V_21 -> V_41 = F_57 ( V_68 , V_21 -> V_39 * 32 ,
& V_74 , V_21 ) ;
if ( F_58 ( ! V_21 -> V_41 ) ) {
F_55 ( L_6 ) ;
return - V_56 ;
