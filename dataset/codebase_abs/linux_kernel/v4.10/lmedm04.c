...
{
int V_6 ;
return F_2 ( V_2 , F_3 ( V_2 , V_5 ) ,
V_3 , V_4 , & V_6 , 100 ) ;
}
static int F_4 ( struct V_1 * V_2 ,
T_1 * V_7 , int V_4 , T_1 V_5 )
{
int V_6 ;
return F_2 ( V_2 , F_5 ( V_2 , V_5 ) ,
V_7 , V_4 , & V_6 , 200 ) ;
}
static int F_6 ( struct V_8 * V_9 ,
T_1 * V_10 , int V_11 , T_1 * V_12 , int V_13 )
{
struct V_14 * V_15 = V_9 -> V_16 ;
T_1 * V_17 ;
int V_18 = 0 ;
if ( V_15 -> V_19 == NULL ) {
V_15 -> V_19 = F_7 ( 64 , V_20 ) ;
if ( V_15 -> V_19 == NULL ) {
F_8 ( L_1 ) ;
return - V_21 ;
}
...
if ( V_18 < 0 )
return - V_23 ;
memcpy ( V_17 , V_10 , ( V_11 < 64 ) ? V_11 : 64 ) ;
V_18 |= F_1 ( V_9 -> V_24 , V_17 , V_11 , 0x01 ) ;
V_18 |= F_4 ( V_9 -> V_24 , V_17 , ( V_13 < 64 ) ?
V_13 : 64 , 0x01 ) ;
if ( V_13 > 0 )
memcpy ( V_12 , V_17 , V_13 ) ;
F_10 ( & V_9 -> V_22 ) ;
return ( V_18 < 0 ) ? - V_25 : 0 ;
}
...
T_1 V_30 [ 1 ] ;
if ( V_15 -> V_31 )
V_18 = F_6 ( V_9 , V_26 , sizeof( V_26 ) ,
V_30 , sizeof( V_30 ) ) ;
V_18 = F_6 ( V_9 , V_28 , sizeof( V_28 ) ,
V_30 , sizeof( V_30 ) ) ;
return V_18 ;
}
static int F_12 ( struct V_8 * V_9 , T_1 V_32 , T_2 V_33 )
{
struct V_14 * V_15 = V_9 -> V_16 ;
...
if ( V_37 > V_15 -> V_38 )
V_15 -> V_38 = V_37 ;
V_34 [ 7 ] = 0x80 + V_15 -> V_38 ;
V_18 |= F_6 ( V_9 , V_34 ,
sizeof( V_34 ) , V_12 , sizeof( V_12 ) ) ;
if ( V_15 -> V_28 )
V_18 |= F_11 ( V_9 ) ;
return V_18 ;
}
...
switch ( V_15 -> V_58 ) {
case V_59 :
V_45 = F_16 ( 0xff - V_15 -> V_60 ) ;
V_46 = F_16 ( 0xff - V_15 -> V_61 ) ;
break;
case V_62 :
case V_63 :
V_45 = 0xffff - ( ( ( V_15 -> V_60 * 2 ) << 8 ) * 5 / 4 ) ;
V_46 = F_16 ( ( 0xff - V_15 -> V_61 - 0xa1 ) * 3 ) ;
break;
case V_64 :
V_45 = F_16 ( V_15 -> V_60 ) ;
V_46 = F_16 ( V_15 -> V_61 ) ;
...
F_23 ( V_69 , V_88 ) ;
V_15 -> V_89 = V_90 + F_24 ( 200 ) ;
}
static int F_25 ( struct V_39 * V_40 )
{
struct V_8 * V_9 = F_19 ( V_40 ) ;
struct V_14 * V_91 = F_15 ( V_40 ) ;
struct V_92 * V_93 ;
V_91 -> V_69 = F_26 ( 0 , V_88 ) ;
if ( V_91 -> V_69 == NULL )
return - V_21 ;
V_91 -> V_94 = F_27 ( V_9 -> V_24 , 128 , V_88 ,
& V_91 -> V_69 -> V_95 ) ;
if ( V_91 -> V_94 == NULL )
return - V_21 ;
F_28 ( V_91 -> V_69 ,
...
V_40 ,
8 ) ;
V_93 = F_30 ( V_9 -> V_24 , V_91 -> V_69 -> V_5 ) ;
if ( F_31 ( & V_93 -> V_96 ) == V_97 )
V_91 -> V_69 -> V_5 = F_5 ( V_9 -> V_24 , 0xa ) ,
V_91 -> V_69 -> V_98 |= V_99 ;
F_23 ( V_91 -> V_69 , V_88 ) ;
F_8 ( L_10 ) ;
return 0 ;
...
if ( ! V_105 )
return - V_21 ;
V_18 |= F_37 ( V_9 -> V_24 , F_38 ( V_9 -> V_24 , 0 ) ,
0x06 , 0x80 , 0x0302 , 0x00 , V_105 , 0x0006 , 200 ) ;
F_8 ( L_13 , V_18 , V_105 [ 2 ] ) ;
V_18 = ( V_18 < 0 ) ? - V_25 : V_105 [ 2 ] ;
F_39 ( V_105 ) ;
return V_18 ;
}
...
V_111 |= V_112 ;
V_113 = ( V_108 [ V_72 ] . V_117 == V_15 -> V_118 )
? ( V_111 ) ? V_15 -> V_119
: V_15 -> V_120
: V_15 -> V_114 ;
...
if ( F_40 ( V_9 , V_110 , V_4 , V_71 , 64 ) < 0 ) {
F_13 ( 1 , L_14 ) ;
F_10 ( & V_9 -> V_102 ) ;
return - V_23 ;
}
...
int V_18 = 0 ;
T_1 * V_105 ;
T_2 V_129 , V_11 , V_130 , V_131 , V_132 ;
...
V_11 = ( T_1 ) V_134 + 4 ;
V_105 [ V_11 - 1 ] = F_46 ( V_135 , V_134 + 1 ) ;
F_13 ( 1 , L_20 , V_105 [ 3 ] ,
V_105 [ V_134 + 2 ] , V_105 [ V_134 + 3 ] ) ;
F_6 ( V_9 , V_105 , V_11 , V_105 , V_130 ) ;
V_18 |= ( V_105 [ 0 ] == 0x88 ) ? 0 : - 1 ;
}
}
V_105 [ 0 ] = 0x8a ;
V_130 = 1 ;
F_48 ( 2000 ) ;
F_6 ( V_9 , V_105 , V_130 , V_105 , V_130 ) ;
F_48 ( 400 ) ;
if ( V_18 < 0 )
F_8 ( L_21 , V_18 ) ;
else
...
V_105 [ 0 ] = 0x0a ;
F_8 ( L_23 ) ;
F_6 ( V_9 , V_105 , sizeof( V_105 ) , V_105 , sizeof( V_105 ) ) ;
return;
}
static const char * F_50 ( struct V_8 * V_9 , int V_138 )
{
struct V_14 * V_15 = V_9 -> V_16 ;
struct V_1 * V_24 = V_9 -> V_24 ;
...
case V_63 :
V_139 = V_143 ;
V_18 = F_52 ( & V_128 , V_139 , & V_24 -> V_2 ) ;
if ( V_18 == 0 ) {
V_15 -> V_142 = V_63 ;
V_138 = 0 ;
break;
...
enum V_154 V_155 )
{
struct V_8 * V_9 = F_57 ( V_42 ) ;
struct V_14 * V_15 = F_58 ( V_42 ) ;
static T_1 V_156 [] = V_157 ;
static T_1 V_158 [] = V_159 ;
static T_1 V_12 [ 1 ] ;
int V_18 = 0 , V_4 = 3 , V_13 = 1 ;
F_33 ( & V_9 -> V_102 ) ;
switch ( V_155 ) {
case V_160 :
V_18 |= F_6 ( V_9 ,
...
if ( V_15 -> V_55 ) {
if ( V_15 -> V_165 ) {
V_18 = V_15 -> V_165 ( V_42 , V_76 ) ;
if ( V_18 < 0 )
return V_18 ;
}
V_15 -> V_86 = * V_76 ;
if ( * V_76 & V_87 && V_15 -> V_28 ) {
F_33 ( & V_9 -> V_102 ) ;
V_15 -> V_55 = 0 ;
V_18 = F_11 ( V_9 ) ;
F_10 ( & V_9 -> V_102 ) ;
...
struct V_14 * V_15 = F_58 ( V_42 ) ;
if ( V_15 -> V_166 && ! V_15 -> V_28 )
return V_15 -> V_166 ( V_42 , V_56 ) ;
...
struct V_43 * V_44 = & V_42 -> V_47 ;
struct V_14 * V_15 = F_58 ( V_42 ) ;
if ( V_15 -> V_168 && ! V_15 -> V_28 )
return V_15 -> V_168 ( V_42 , V_167 ) ;
...
{
struct V_14 * V_15 = F_58 ( V_42 ) ;
if ( V_15 -> V_170 && ! V_15 -> V_28 )
return V_15 -> V_170 ( V_42 , V_169 ) ;
* V_169 = 0 ;
return 0 ;
}
...
{
struct V_14 * V_15 = F_58 ( V_42 ) ;
if ( V_15 -> V_172 && ! V_15 -> V_28 )
return V_15 -> V_172 ( V_42 , V_171 ) ;
* V_171 = 0 ;
return 0 ;
}
...
int V_18 = 0 ;
V_15 -> V_55 = 1 ;
switch ( F_51 ( V_9 -> V_24 -> V_140 . V_141 ) ) {
case 0x1122 :
case 0x1120 :
V_15 -> V_114 = 4 ;
...
V_15 -> V_165 = V_40 -> V_42 [ 0 ] -> V_175 . V_189 ;
V_15 -> V_166 = V_40 -> V_42 [ 0 ] -> V_175 . V_190 ;
V_15 -> V_168 = V_40 -> V_42 [ 0 ] -> V_175 . V_191 ;
V_15 -> V_170 = V_40 -> V_42 [ 0 ] -> V_175 . V_192 ;
V_15 -> V_172 = V_40 -> V_42 [ 0 ] -> V_175 . V_193 ;
...
static int F_72 ( struct V_8 * V_9 , int V_100 )
{
struct V_14 * V_15 = V_9 -> V_16 ;
...
F_33 ( & V_9 -> V_102 ) ;
if ( V_100 )
V_18 = F_6 ( V_9 , V_200 , V_4 , V_12 , V_13 ) ;
else
V_18 = F_6 ( V_9 , V_202 , V_4 , V_12 , V_13 ) ;
V_15 -> V_55 = 1 ;
F_10 ( & V_9 -> V_102 ) ;
return V_18 ;
}
...
static int F_74 ( struct V_8 * V_9 , const char * * V_173 )
{
struct V_14 * V_15 = V_9 -> V_16 ;
F_75 ( V_9 -> V_24 ) ;
F_76 ( V_9 -> V_24 ,
