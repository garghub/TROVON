...
struct V_28 * V_29 ;
int V_15 ;
if ( V_30 * V_31 > V_27 - V_7 )
return - V_32 ;
for ( V_15 = 0 ; V_15 < V_30 ; V_15 ++ ) {
V_29 = F_7 ( V_26 -> V_33 , V_15 ) ;
if ( F_1 ( & V_7 , V_29 ) )
goto V_21;
}
return V_30 * V_31 ;
...
struct V_34 * V_35 ;
int V_15 ;
if ( V_36 * V_31 > V_27 - V_7 )
return - V_32 ;
for ( V_15 = 0 ; V_15 < V_36 ; V_15 ++ ) {
V_35 = F_9 ( V_26 -> V_33 , V_15 ) ;
if ( F_1 ( & V_7 , V_35 ) )
goto V_21;
}
return V_36 * V_31 ;
...
void T_1 * V_7 , void T_1 * V_27 , char V_37 ,
char V_38 , char V_10 )
{
struct V_39 V_40 ;
struct V_39 T_1 * V_41 = V_7 ;
struct V_5 * V_6 , * V_42 ;
struct V_43 * V_44 ;
int V_45 , V_46 , V_47 = 0 , V_9 = 0 , V_48 = 0 , V_49 = 0 ;
void * V_4 ;
...
if ( V_46 )
V_42 -> V_51 = 0 ;
V_48 = sizeof( V_40 ) + V_31 ;
if ( V_46 || ! V_38 ) {
V_44 = V_26 -> V_52 [ V_8 ] ;
if ( V_44 && V_44 -> V_53 ) {
V_40 . V_54 = V_44 -> V_55 ;
V_40 . V_56 = V_44 -> V_53 -> V_57 ;
}
if ( V_6 -> V_58 != V_59 ) {
V_47 = F_15 ( V_6 -> V_60 ) *
V_61 ;
V_9 = V_37 ? F_16 ( V_6 -> V_62 ) *
V_63 : 0 ;
}
V_48 += ( 3 * V_47 + V_9 ) * V_31 ;
if ( V_48 > V_27 - V_7 )
V_49 = - V_32 ;
else
V_49 = F_3 ( V_4 , V_6 , V_7 , V_8 ,
V_9 , V_10 ) ;
}
if ( V_46 )
F_14 ( V_6 ) ;
...
V_49 = F_6 ( V_26 , V_7 , V_27 ) ;
if ( V_49 < 0 )
goto V_21;
V_7 += V_49 ;
V_49 = F_8 ( V_26 , V_7 , V_27 ) ;
if ( V_49 < 0 )
goto V_21;
V_7 += V_49 ;
for ( V_8 = 0 ; V_8 < V_76 ; V_8 ++ ) {
if ( V_70 . V_8 == V_8 || V_70 . V_8 < 0 ) {
V_49 = F_10 ( V_26 , V_8 , V_7 , V_27 ,
V_70 . V_37 , V_70 . V_38 ,
V_70 . V_10 ) ;
if ( V_49 < 0 )
goto V_21;
