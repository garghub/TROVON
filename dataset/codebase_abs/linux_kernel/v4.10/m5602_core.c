...
T_2 * V_9 = V_1 -> V_5 . V_10 ;
int V_4 ;
const T_1 V_40 [ 4 ] = { 0x13 , 0xf9 , 0x0f , 0x01 } ;
if ( V_1 -> V_19 -> V_41 )
V_1 -> V_19 -> V_41 ( V_1 ) ;
memcpy ( V_9 , V_40 , sizeof( V_40 ) ) ;
V_4 = F_2 ( V_5 -> V_8 ,
F_6 ( V_5 -> V_8 , 0 ) ,
...
const struct V_54 * V_55 )
{
return F_22 ( V_62 , V_55 , & V_63 , sizeof( struct V_1 ) ,
V_64 ) ;
}
static void F_23 ( struct V_61 * V_62 )
{
struct V_5 * V_5 = F_24 ( V_62 ) ;
struct V_1 * V_1 = (struct V_1 * ) V_5 ;
if ( V_1 -> V_19 -> V_65 )
V_1 -> V_19 -> V_65 ( V_1 ) ;
F_25 ( V_62 ) ;
