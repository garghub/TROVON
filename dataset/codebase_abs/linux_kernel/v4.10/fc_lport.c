...
struct V_3 * V_4 )
{
void (* F_73)( struct V_1 * , struct V_3 * );
F_5 ( & V_2 -> V_11 ) ;
if ( ! V_2 -> V_40 )
F_2 ( V_4 ) ;
else {
...
static int F_75 ( struct V_5 * V_6 , T_1 V_213 ,
...
struct V_218 * V_97 = F_77 ( V_4 ) ;
struct V_219 * V_220 ;
F_78 () ;
if ( V_194 -> V_221 >= V_222 )
goto V_223;
V_220 = F_79 ( V_224 [ V_194 -> V_221 ] ) ;
if ( ! V_220 || ! F_80 ( V_220 -> V_225 ) )
goto V_223;
F_81 () ;
V_220 -> F_73 ( V_2 , V_4 ) ;
F_82 ( V_220 -> V_225 ) ;
...
V_2 -> V_138 . V_178 ( V_2 , 0 , 0 ) ;
F_86 ( V_2 -> V_172 ) = 0 ;
if ( V_2 -> V_10 && ( ! V_2 -> V_205 || ! V_2 -> V_40 ) )
F_63 ( V_2 , 0 , NULL ) ;
}
...
static void F_94 ( struct V_218 * V_97 , struct V_3 * V_4 ,
void * V_234 )
{
...
if ( V_194 && V_236 && V_194 -> V_221 == V_239 &&
V_236 -> V_240 == V_241 &&
V_236 -> V_242 == V_243 &&
...
static void F_100 ( struct V_218 * V_97 , struct V_3 * V_4 ,
void * V_234 )
{
struct V_1 * V_2 = V_234 ;
struct V_136 * V_194 ;
...
static void F_101 ( struct V_218 * V_97 , struct V_3 * V_4 ,
void * V_234 )
{
struct V_1 * V_2 = V_234 ;
V_100 V_95 ;
...
void F_107 ( struct V_218 * V_97 , struct V_3 * V_4 ,
void * V_234 )
{
struct V_1 * V_2 = V_234 ;
V_100 V_95 ;
...
if ( ! V_2 -> V_138 . V_259 ( V_2 , V_207 , V_4 , V_206 ,
F_107 , V_2 ,
2 * V_2 -> V_262 ) )
F_71 ( V_2 , NULL ) ;
}
void F_108 ( struct V_218 * V_97 , struct V_3 * V_4 ,
void * V_234 )
{
struct V_1 * V_2 = V_234 ;
struct V_136 * V_194 ;
...
if ( ! V_4 )
return F_71 ( V_2 , V_4 ) ;
if ( ! V_2 -> V_138 . V_259 ( V_2 , V_207 , V_4 ,
...
static void F_124 ( struct V_218 * V_97 , struct V_3 * V_4 ,
void * V_328 )
{
