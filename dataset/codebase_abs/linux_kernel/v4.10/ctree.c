...
F_72 ( & V_66 -> V_20 , V_71 , V_70 ) ;
F_73 ( & V_66 -> V_20 , V_61 ) ;
return 0 ;
}
static inline int F_74 ( struct V_22 * V_23 ,
struct V_13 * V_19 ) {
F_75 () ;
if ( F_76 ( & ( V_23 ) -> V_59 ) )
return 1 ;
...
static inline int F_77 ( const struct V_22 * V_23 ,
struct V_13 * V_19 )
{
F_75 () ;
if ( F_76 ( & ( V_23 ) -> V_59 ) )
...
static struct V_65 *
F_78 ( struct V_13 * V_19 , int V_77 ,
...
V_66 -> V_83 = F_80 ( V_19 , V_77 ) ;
}
V_66 -> V_79 = V_79 ;
V_66 -> V_77 = V_77 ;
V_66 -> V_84 = F_81 ( V_19 , V_77 ) ;
F_82 ( & V_66 -> V_20 ) ;
return V_66 ;
}
static T_1 int
...
if ( ! F_77 ( V_23 , V_19 ) )
return 0 ;
V_89 = F_85 ( V_88 , sizeof( struct V_65 * ) , V_80 ) ;
if ( ! V_89 )
return - V_85 ;
V_66 = F_79 ( sizeof( * V_66 ) , V_80 ) ;
if ( ! V_66 ) {
...
if ( V_89 [ V_5 ] && ! F_86 ( & V_89 [ V_5 ] -> V_20 ) )
...
static T_1 int
F_88 ( struct V_22 * V_23 ,
struct V_13 * V_97 ,
struct V_13 * V_98 , T_3 V_80 ,
int V_99 )
{
struct V_65 * V_66 = NULL ;
struct V_65 * * V_89 = NULL ;
...
if ( V_99 && F_33 ( V_97 ) > 0 ) {
V_95 = F_89 ( V_97 ) ;
V_89 = F_85 ( V_95 , sizeof( struct V_65 * ) ,
V_80 ) ;
if ( ! V_89 ) {
V_38 = - V_85 ;
goto V_91;
...
static struct V_65 *
F_90 ( struct V_22 * V_23 , T_2 V_46 , T_2 V_67 ,
int V_102 )
{
struct V_60 * V_61 ;
struct V_62 * V_20 ;
...
T_2 V_67 )
{
return F_90 ( V_23 , V_46 , V_67 , 1 ) ;
}
static struct V_65 *
F_92 ( struct V_22 * V_23 , T_2 V_46 , T_2 V_67 )
{
return F_90 ( V_23 , V_46 , V_67 , 0 ) ;
}
static T_1 int
...
return 0 ;
V_89 = F_85 ( V_88 * 2 , sizeof( struct V_65 * ) ,
V_3 ) ;
if ( ! V_89 )
return - V_85 ;
V_108 = V_89 ;
V_109 = V_89 + V_88 ;
for ( V_5 = 0 ; V_5 < V_88 ; V_5 ++ ) {
V_109 [ V_5 ] = F_78 ( V_105 , V_5 + V_107 ,
V_110 , V_3 ) ;
if ( ! V_109 [ V_5 ] ) {
V_38 = - V_85 ;
goto V_91;
}
V_108 [ V_5 ] = F_78 ( V_104 , V_5 + V_106 ,
V_81 , V_3 ) ;
if ( ! V_108 [ V_5 ] ) {
V_38 = - V_85 ;
goto V_91;
...
{
int V_38 ;
V_38 = F_84 ( V_23 , V_104 , V_106 , V_107 ,
V_88 , V_3 ) ;
F_71 ( V_38 < 0 ) ;
}
static T_1 void
...
return 0 ;
V_95 = F_89 ( V_19 ) ;
V_89 = F_85 ( V_95 , sizeof( struct V_65 * ) , V_3 ) ;
if ( ! V_89 )
return - V_85 ;
for ( V_5 = 0 ; V_5 < V_95 ; V_5 ++ ) {
V_89 [ V_5 ] = F_78 ( V_19 , V_5 ,
V_100 , V_3 ) ;
if ( ! V_89 [ V_5 ] ) {
V_38 = - V_85 ;
goto V_91;
...
static int F_145 ( struct V_40 * V_152 , struct V_153 * V_154 )
{
struct V_153 V_155 ;
F_146 ( & V_155 , V_152 ) ;
return F_147 ( & V_155 , V_154 ) ;
}
int F_147 ( struct V_153 * V_155 , struct V_153 * V_154 )
{
...
static int F_157 ( struct V_13 * V_19 , struct V_153 * V_82 ,
int V_39 , int * V_77 )
{
if ( V_39 == 0 )
return F_153 ( V_19 ,
...
int F_159 ( struct V_13 * V_19 , struct V_153 * V_82 ,
int V_39 , int * V_77 )
{
...
if ( V_195 !=
F_80 ( V_139 -> V_7 [ V_39 ] , V_139 -> V_16 [ V_39 ] ) )
F_169 () ;
V_197:
if ( V_190 ) {
F_20 ( V_190 ) ;
...
struct V_13 * V_176 ;
int V_38 ;
V_149 = F_80 ( V_221 , V_77 ) ;
V_160 = F_81 ( V_221 , V_77 ) ;
...
struct V_22 * V_23 = V_18 -> V_23 ;
int V_38 ;
if ( ( V_4 -> V_225 || V_224 > 0 ) && F_89 ( V_221 ) >=
F_131 ( V_23 ) - 3 ) {
int V_226 ;
if ( * V_215 < V_39 + 1 ) {
* V_215 = V_39 + 1 ;
...
static int F_184 ( struct V_13 * V_221 , struct V_153 * V_82 ,
...
return V_38 ;
V_19 = V_139 -> V_7 [ 0 ] ;
if ( V_38 && V_139 -> V_16 [ 0 ] >= F_89 ( V_19 ) ) {
...
int F_186 ( struct V_32 * V_33 , struct V_17
* V_18 , struct V_153 * V_82 , struct V_1 * V_4 , int
V_224 , int V_37 )
{
struct V_22 * V_23 = V_18 -> V_23 ;
struct V_13 * V_221 ;
...
V_164 = F_177 ( V_33 , V_18 , V_4 ,
& V_221 , V_39 , V_77 , V_82 , 0 ) ;
if ( V_164 == - V_223 )
goto V_227;
if ( V_164 ) {
V_38 = V_164 ;
...
int F_195 ( struct V_17 * V_18 , struct V_153 * V_82 ,
...
V_164 = F_177 ( NULL , V_18 , V_4 , & V_221 , V_39 ,
V_77 , V_82 , V_130 ) ;
if ( V_164 == - V_223 )
goto V_227;
if ( V_164 ) {
...
struct V_153 * V_82 , struct V_1 * V_4 ,
int V_246 , int V_247 )
{
int V_38 ;
struct V_13 * V_248 ;
...
struct V_40 V_259 ;
F_71 ( V_139 -> V_7 [ V_39 ] ) ;
F_71 ( V_139 -> V_7 [ V_39 - 1 ] != V_18 -> V_20 ) ;
...
static T_1 int F_213 ( struct V_32 * V_33 ,
struct V_22 * V_23 ,
struct V_1 * V_139 ,
int V_272 , int V_251 ,
struct V_13 * V_190 ,
...
F_124 ( V_190 ,
F_218 ( V_190 ) + V_280 - V_277 ,
F_218 ( V_190 ) + V_280 ,
F_211 ( V_23 ) - V_280 ) ;
F_201 ( V_190 , V_191 , F_218 ( V_190 ) +
F_211 ( V_23 ) - V_277 ,
F_218 ( V_191 ) + F_217 ( V_23 , V_191 ) ,
V_277 ) ;
F_124 ( V_190 , F_219 ( V_252 ) ,
F_219 ( 0 ) ,
V_279 * sizeof( struct V_185 ) ) ;
F_201 ( V_190 , V_191 , F_219 ( 0 ) ,
F_219 ( V_274 - V_252 ) ,
...
if ( V_139 -> V_16 [ 0 ] >= V_274 ) {
V_139 -> V_16 [ 0 ] -= V_274 ;
if ( F_89 ( V_139 -> V_7 [ 0 ] ) == 0 )
F_109 ( V_33 , V_23 , V_139 -> V_7 [ 0 ] ) ;
F_20 ( V_139 -> V_7 [ 0 ] ) ;
F_11 ( V_139 -> V_7 [ 0 ] ) ;
V_139 -> V_7 [ 0 ] = V_190 ;
V_139 -> V_16 [ 1 ] += 1 ;
...
static int F_221 ( struct V_32 * V_33 , struct V_17
...
return F_213 ( V_33 , V_23 , V_139 , V_284 , V_251 ,
...
F_207 ( & V_269 ) ;
if ( V_251 )
V_206 = F_152 ( V_279 , V_285 ) ;
else
V_206 = F_152 ( V_279 - 1 , V_285 ) ;
...
V_286 = F_89 ( V_191 ) ;
F_71 ( V_286 <= 0 ) ;
V_287 = F_223 ( V_191 , V_286 - 1 ) ;
for ( V_5 = V_286 ; V_5 < V_286 + V_252 ; V_5 ++ ) {
T_4 V_232 ;
V_278 = F_208 ( V_5 ) ;
V_232 = F_209 ( V_191 , V_278 , & V_269 ) ;
F_220 ( V_191 , V_278 ,
V_232 - ( F_211 ( V_23 ) - V_287 ) ,
& V_269 ) ;
}
F_125 ( V_191 , V_286 + V_252 ) ;
if ( V_252 > V_279 )
F_141 ( 1 , V_146 L_5 , V_252 ,
V_279 ) ;
if ( V_252 < V_279 ) {
V_277 = F_223 ( V_190 , V_252 - 1 ) -
F_217 ( V_23 , V_190 ) ;
F_124 ( V_190 , F_218 ( V_190 ) +
F_211 ( V_23 ) - V_277 ,
F_218 ( V_190 ) +
...
static int F_224 ( struct V_32 * V_33 , struct V_17
* V_18 , struct V_1 * V_139 , int V_284 ,
int V_272 , int V_251 , T_4 V_285 )
{
struct V_22 * V_23 = V_18 -> V_23 ;
struct V_13 * V_190 = V_139 -> V_7 [ 0 ] ;
struct V_13 * V_191 ;
...
return F_222 ( V_33 , V_23 , V_139 , V_284 ,
...
V_95 = V_95 - V_175 ;
F_125 ( V_190 , V_95 ) ;
V_289 = F_216 ( V_265 , V_175 ) - F_217 ( V_23 , V_265 ) ;
F_201 ( V_190 , V_265 , F_219 ( 0 ) ,
F_219 ( V_175 ) ,
V_95 * sizeof( struct V_185 ) ) ;
F_201 ( V_190 , V_265 ,
F_218 ( V_190 ) + F_211 ( V_23 ) -
V_289 , F_218 ( V_265 ) +
F_217 ( V_23 , V_265 ) , V_289 ) ;
V_290 = F_211 ( V_23 ) - F_216 ( V_265 , V_175 ) ;
for ( V_5 = 0 ; V_5 < V_95 ; V_5 ++ ) {
...
int V_291 = V_272 ;
V_77 = V_139 -> V_16 [ 0 ] ;
if ( V_77 < F_89 ( V_139 -> V_7 [ 0 ] ) )
V_291 -= F_193 ( V_23 , V_139 -> V_7 [ 0 ] ) ;
V_38 = F_221 ( V_33 , V_18 , V_139 , 1 , V_291 , 0 , V_77 ) ;
if ( V_38 < 0 )
return V_38 ;
if ( V_38 == 0 )
V_159 ++ ;
V_95 = F_89 ( V_139 -> V_7 [ 0 ] ) ;
if ( V_139 -> V_16 [ 0 ] == 0 || V_139 -> V_16 [ 0 ] == V_95 )
return 0 ;
if ( F_193 ( V_23 , V_139 -> V_7 [ 0 ] ) >= V_272 )
return 0 ;
V_77 = V_139 -> V_16 [ 0 ] ;
V_38 = F_224 ( V_33 , V_18 , V_139 , 1 , V_291 , 0 , V_77 ) ;
if ( V_38 < 0 )
return V_38 ;
if ( V_38 == 0 )
V_159 ++ ;
...
V_265 = V_139 -> V_7 [ 0 ] ;
V_77 = V_139 -> V_16 [ 0 ] ;
if ( V_293 && V_272 + F_227 ( V_265 , V_77 ) +
sizeof( struct V_185 ) > F_211 ( V_23 ) )
return - V_296 ;
if ( V_272 && V_139 -> V_7 [ 1 ] ) {
int V_291 = V_272 ;
if ( V_77 < F_89 ( V_265 ) )
V_291 -= F_193 ( V_23 , V_265 ) ;
V_192 = F_221 ( V_33 , V_18 , V_139 , V_291 ,
V_291 , 0 , 0 ) ;
if ( V_192 < 0 )
return V_192 ;
if ( V_192 ) {
V_192 = F_224 ( V_33 , V_18 , V_139 , V_291 ,
V_291 , 0 , ( T_4 ) - 1 ) ;
if ( V_192 < 0 )
return V_192 ;
}
...
F_211 ( V_23 ) ) {
if ( ! V_293 && V_272 && V_77 == 0 ) {
V_263 = 0 ;
} else if ( ( V_293 || ! V_272 ) && V_77 == 0 ) {
V_175 = 1 ;
} else {
V_175 = V_77 ;
if ( V_175 != V_95 &&
...
F_225 ( V_33 , V_23 , V_139 , V_265 , V_190 , V_77 , V_175 , V_95 ) ;
if ( V_263 == 2 ) {
F_71 ( V_294 != 0 ) ;
V_294 ++ ;
goto V_227;
...
F_71 ( V_82 . type != V_301 &&
V_82 . type != V_302 ) ;
if ( F_193 ( V_23 , V_248 ) >= V_224 )
return 0 ;
V_171 = F_227 ( V_248 , V_139 -> V_16 [ 0 ] ) ;
if ( V_82 . type == V_301 ) {
V_299 = F_229 ( V_248 , V_139 -> V_16 [ 0 ] ,
struct V_298 ) ;
V_300 = F_230 ( V_248 , V_299 ) ;
}
F_8 ( V_139 ) ;
V_139 -> V_219 = 1 ;
V_139 -> V_225 = 1 ;
...
V_38 = - V_223 ;
V_248 = V_139 -> V_7 [ 0 ] ;
if ( V_171 != F_227 ( V_248 , V_139 -> V_16 [ 0 ] ) )
goto V_164;
...
struct V_40 V_41 ;
V_248 = V_139 -> V_7 [ 0 ] ;
F_71 ( F_193 ( V_23 , V_248 ) < sizeof( struct V_185 ) ) ;
F_3 ( V_139 ) ;
V_278 = F_208 ( V_139 -> V_16 [ 0 ] ) ;
V_305 = F_232 ( V_248 , V_278 ) ;
V_171 = F_215 ( V_248 , V_278 ) ;
V_34 = F_233 ( V_171 , V_3 ) ;
if ( ! V_34 )
return - V_85 ;
F_156 ( V_248 , V_34 , F_234 ( V_248 ,
V_139 -> V_16 [ 0 ] ) , V_171 ) ;
V_77 = V_139 -> V_16 [ 0 ] + 1 ;
V_95 = F_89 ( V_248 ) ;
if ( V_77 != V_95 ) {
F_124 ( V_248 , F_219 ( V_77 + 1 ) ,
F_219 ( V_77 ) ,
...
V_304 = F_208 ( V_77 ) ;
F_235 ( V_248 , V_304 , V_305 ) ;
F_236 ( V_248 , V_304 , V_171 - V_303 ) ;
F_235 ( V_248 , V_278 ,
V_305 + V_171 - V_303 ) ;
F_236 ( V_248 , V_278 , V_303 ) ;
F_125 ( V_248 , V_95 + 1 ) ;
F_237 ( V_248 , V_34 ,
F_234 ( V_248 , V_139 -> V_16 [ 0 ] ) ,
V_303 ) ;
F_237 ( V_248 , V_34 + V_303 ,
F_234 ( V_248 , V_77 ) ,
V_171 - V_303 ) ;
F_49 ( V_248 ) ;
F_71 ( F_193 ( V_23 , V_248 ) < 0 ) ;
F_69 ( V_34 ) ;
return 0 ;
}
...
{
int V_38 ;
V_38 = F_228 ( V_33 , V_18 , V_139 ,
sizeof( struct V_185 ) ) ;
if ( V_38 )
return V_38 ;
V_38 = F_231 ( V_33 , V_18 -> V_23 , V_139 , V_250 , V_303 ) ;
return V_38 ;
}
int F_239 ( struct V_32 * V_33 ,
struct V_17 * V_18 ,
struct V_1 * V_139 ,
struct V_153 * V_250 )
{
...
return V_38 ;
V_139 -> V_16 [ 0 ] ++ ;
F_240 ( V_18 , V_139 , V_250 , & V_171 ,
V_171 , V_171 +
sizeof( struct V_185 ) , 1 ) ;
V_248 = V_139 -> V_7 [ 0 ] ;
F_241 ( V_248 ,
F_234 ( V_248 , V_139 -> V_16 [ 0 ] ) ,
F_234 ( V_248 , V_139 -> V_16 [ 0 ] - 1 ) ,
V_171 ) ;
return 0 ;
}
void F_242 ( struct V_22 * V_23 ,
struct V_1 * V_139 , T_4 V_306 , int V_307 )
{
int V_77 ;
struct V_13 * V_248 ;
struct V_185 * V_278 ;
...
V_248 = V_139 -> V_7 [ 0 ] ;
V_77 = V_139 -> V_16 [ 0 ] ;
V_309 = F_227 ( V_248 , V_77 ) ;
if ( V_309 == V_306 )
return;
V_95 = F_89 ( V_248 ) ;
V_280 = F_217 ( V_23 , V_248 ) ;
V_308 = F_223 ( V_248 , V_77 ) ;
V_310 = V_309 - V_306 ;
F_71 ( V_77 < 0 ) ;
F_71 ( V_77 >= V_95 ) ;
...
if ( V_307 ) {
F_124 ( V_248 , F_218 ( V_248 ) +
V_280 + V_310 , F_218 ( V_248 ) +
...
unsigned long V_311 ;
struct V_298 * V_299 ;
V_299 = F_229 ( V_248 , V_77 ,
struct V_298 ) ;
V_299 = (struct V_298 * ) (
( unsigned long ) V_299 - V_310 ) ;
if ( F_244 ( V_248 , V_299 ) ==
V_312 ) {
V_311 = F_234 ( V_248 , V_77 ) ;
F_124 ( V_248 , V_311 ,
( unsigned long ) V_299 ,
V_313 ) ;
}
...
V_280 , V_308 - V_280 ) ;
V_156 = F_245 ( & V_41 ) ;
F_246 ( & V_41 , V_156 + V_310 ) ;
F_200 ( V_248 , & V_41 , V_77 ) ;
if ( V_77 == 0 )
F_198 ( V_23 , V_139 , & V_41 , 1 ) ;
}
V_278 = F_208 ( V_77 ) ;
F_236 ( V_248 , V_278 , V_306 ) ;
F_49 ( V_248 ) ;
...
void F_248 ( struct V_22 * V_23 , struct V_1 * V_139 ,
T_4 V_272 )
{
int V_77 ;
struct V_13 * V_248 ;
...
F_124 ( V_248 , F_218 ( V_248 ) +
V_280 - V_272 , F_218 ( V_248 ) +
V_280 , V_314 - V_280 ) ;
V_280 = V_314 ;
V_309 = F_227 ( V_248 , V_77 ) ;
V_278 = F_208 ( V_77 ) ;
F_236 ( V_248 , V_278 , V_309 + V_272 ) ;
F_49 ( V_248 ) ;
if ( F_193 ( V_23 , V_248 ) < 0 ) {
F_247 ( V_23 , V_248 ) ;
F_169 () ;
...
void F_240 ( struct V_17 * V_18 , struct V_1 * V_139 ,
struct V_153 * V_315 , T_4 * V_272 ,
T_4 V_316 , T_4 V_317 , int V_206 )
{
struct V_22 * V_23 = V_18 -> V_23 ;
struct V_185 * V_278 ;
int V_5 ;
...
V_95 = F_89 ( V_248 ) ;
V_280 = F_217 ( V_23 , V_248 ) ;
if ( F_193 ( V_23 , V_248 ) < V_317 ) {
F_247 ( V_23 , V_248 ) ;
F_212 ( V_23 , L_7 ,
V_317 , F_193 ( V_23 , V_248 ) ) ;
F_169 () ;
}
if ( V_77 != V_95 ) {
unsigned int V_314 = F_216 ( V_248 , V_77 ) ;
if ( V_314 < V_280 ) {
F_247 ( V_23 , V_248 ) ;
F_212 ( V_23 , L_8 ,
V_77 , V_314 , V_280 ) ;
...
F_124 ( V_248 , F_219 ( V_77 + V_206 ) ,
F_219 ( V_77 ) ,
( V_95 - V_77 ) * sizeof( struct V_185 ) ) ;
F_124 ( V_248 , F_218 ( V_248 ) +
V_280 - V_316 , F_218 ( V_248 ) +
V_280 , V_314 - V_280 ) ;
V_280 = V_314 ;
}
for ( V_5 = 0 ; V_5 < V_206 ; V_5 ++ ) {
F_182 ( & V_41 , V_315 + V_5 ) ;
F_200 ( V_248 , & V_41 , V_77 + V_5 ) ;
V_278 = F_208 ( V_77 + V_5 ) ;
F_220 ( V_248 , V_278 ,
V_280 - V_272 [ V_5 ] , & V_269 ) ;
V_280 -= V_272 [ V_5 ] ;
F_249 ( V_248 , V_278 , V_272 [ V_5 ] , & V_269 ) ;
}
...
for ( V_5 = 0 ; V_5 < V_206 ; V_5 ++ )
V_316 += V_272 [ V_5 ] ;
V_317 = V_316 + ( V_206 * sizeof( struct V_185 ) ) ;
V_38 = F_186 ( V_33 , V_18 , V_315 , V_139 , V_317 , 1 ) ;
if ( V_38 == 0 )
return - V_76 ;
if ( V_38 < 0 )
return V_38 ;
V_77 = V_139 -> V_16 [ 0 ] ;
F_71 ( V_77 < 0 ) ;
F_240 ( V_18 , V_139 , V_315 , V_272 ,
V_316 , V_317 , V_206 ) ;
return 0 ;
}
int F_251 ( struct V_32 * V_33 , struct V_17
* V_18 , struct V_153 * V_315 , void * V_318 , T_4
V_272 )
{
int V_38 = 0 ;
struct V_1 * V_139 ;
...
if ( ! V_139 )
return - V_85 ;
V_38 = F_252 ( V_33 , V_18 , V_139 , V_315 , V_272 ) ;
if ( ! V_38 ) {
V_248 = V_139 -> V_7 [ 0 ] ;
V_311 = F_234 ( V_248 , V_139 -> V_16 [ 0 ] ) ;
F_237 ( V_248 , V_318 , V_311 , V_272 ) ;
F_49 ( V_248 ) ;
}
F_7 ( V_139 ) ;
return V_38 ;
...
static T_1 void F_253 ( struct V_32 * V_33 ,
struct V_17 * V_18 ,
struct V_1 * V_139 ,
struct V_13 * V_248 )
{
...
int F_254 ( struct V_32 * V_33 , struct V_17 * V_18 ,
...
F_207 ( & V_269 ) ;
V_248 = V_139 -> V_7 [ 0 ] ;
V_319 = F_223 ( V_248 , V_77 + V_206 - 1 ) ;
for ( V_5 = 0 ; V_5 < V_206 ; V_5 ++ )
V_320 += F_227 ( V_248 , V_77 + V_5 ) ;
V_95 = F_89 ( V_248 ) ;
if ( V_77 + V_206 != V_95 ) {
...
F_3 ( V_139 ) ;
F_109 ( V_33 , V_23 , V_248 ) ;
F_253 ( V_33 , V_18 , V_139 , V_248 ) ;
}
} else {
int V_321 = F_206 ( V_248 , 0 , V_95 ) ;
if ( V_77 == 0 ) {
struct V_40 V_41 ;
F_34 ( V_248 , & V_41 , 0 ) ;
F_198 ( V_23 , V_139 , & V_41 , 1 ) ;
}
if ( V_321 < F_211 ( V_23 ) / 3 ) {
V_77 = V_139 -> V_16 [ 1 ] ;
F_114 ( V_248 ) ;
F_3 ( V_139 ) ;
V_192 = F_224 ( V_33 , V_18 , V_139 , 1 , 1 ,
1 , ( T_4 ) - 1 ) ;
if ( V_192 < 0 && V_192 != - V_198 )
V_38 = V_192 ;
if ( V_139 -> V_7 [ 0 ] == V_248 &&
F_89 ( V_248 ) ) {
V_192 = F_221 ( V_33 , V_18 , V_139 , 1 ,
1 , 1 , 0 ) ;
if ( V_192 < 0 && V_192 != - V_198 )
V_38 = V_192 ;
}
...
int F_255 ( struct V_17 * V_18 , struct V_153 * V_322 ,
struct V_1 * V_139 ,
T_2 V_323 )
{
struct V_22 * V_23 = V_18 -> V_23 ;
...
V_95 = F_89 ( V_72 ) ;
V_39 = F_33 ( V_72 ) ;
V_226 = F_157 ( V_72 , V_322 , V_39 , & V_77 ) ;
if ( V_39 == V_139 -> V_236 ) {
if ( V_77 >= V_95 )
goto V_324;
V_38 = 0 ;
...
V_139 -> V_16 [ V_39 ] = V_77 ;
F_3 ( V_139 ) ;
V_226 = F_256 ( V_18 , V_139 , V_322 , V_39 ,
V_323 ) ;
if ( V_226 == 0 ) {
F_8 ( V_139 ) ;
goto V_227;
...
static int F_258 ( struct V_22 * V_23 ,
struct V_1 * V_139 ,
int * V_39 , int V_325 )
{
struct V_13 * V_19 ;
...
static int F_260 ( struct V_22 * V_23 ,
struct V_1 * V_139 ,
int * V_39 , int V_325 ,
int V_326 ,
struct V_153 * V_82 )
...
int V_38 ;
if ( * V_39 == 0 || ! V_326 ) {
V_38 = F_259 ( V_23 , V_139 , V_39 ,
V_325 ) ;
} else {
V_38 = F_258 ( V_23 , V_139 , V_39 , V_325 ) ;
}
if ( V_38 >= 0 ) {
if ( * V_39 == 0 )
...
F_257 ( V_139 -> V_7 [ * V_39 ] , V_82 ,
V_139 -> V_16 [ * V_39 ] ) ;
}
return V_38 ;
}
static int F_261 ( struct V_1 * V_327 ,
struct V_1 * V_328 ,
char * V_329 )
{
int V_330 ;
...
V_331 = F_227 ( V_327 -> V_7 [ 0 ] , V_327 -> V_16 [ 0 ] ) ;
V_332 = F_227 ( V_328 -> V_7 [ 0 ] , V_328 -> V_16 [ 0 ] ) ;
if ( V_331 != V_332 )
return 1 ;
V_333 = F_234 ( V_327 -> V_7 [ 0 ] , V_327 -> V_16 [ 0 ] ) ;
V_334 = F_234 ( V_328 -> V_7 [ 0 ] ,
V_328 -> V_16 [ 0 ] ) ;
F_156 ( V_327 -> V_7 [ 0 ] , V_329 , V_333 , V_331 ) ;
V_330 = F_183 ( V_328 -> V_7 [ 0 ] , V_329 , V_334 , V_331 ) ;
if ( V_330 )
return 1 ;
return 0 ;
}
int F_262 ( struct V_17 * V_335 ,
struct V_17 * V_336 ,
T_6 V_337 , void * V_338 )
{
struct V_22 * V_23 = V_335 -> V_23 ;
int V_38 ;
int V_330 ;
...
V_329 = F_233 ( V_23 -> V_168 , V_352 | V_353 ) ;
if ( ! V_329 ) {
V_329 = F_263 ( V_23 -> V_168 ) ;
if ( ! V_329 ) {
V_38 = - V_85 ;
goto V_288;
}
...
V_328 -> V_240 = 1 ;
F_189 ( & V_23 -> V_239 ) ;
V_342 = F_33 ( V_335 -> V_115 ) ;
V_340 = V_342 ;
V_327 -> V_7 [ V_342 ] = V_335 -> V_115 ;
F_114 ( V_327 -> V_7 [ V_342 ] ) ;
...
F_190 ( & V_23 -> V_239 ) ;
if ( V_342 == 0 )
F_188 ( V_327 -> V_7 [ V_342 ] ,
& V_339 , V_327 -> V_16 [ V_342 ] ) ;
else
F_257 ( V_327 -> V_7 [ V_342 ] ,
& V_339 , V_327 -> V_16 [ V_342 ] ) ;
if ( V_343 == 0 )
F_188 ( V_328 -> V_7 [ V_343 ] ,
& V_199 , V_328 -> V_16 [ V_343 ] ) ;
else
F_257 ( V_328 -> V_7 [ V_343 ] ,
& V_199 , V_328 -> V_16 [ V_343 ] ) ;
V_344 = V_345 = 0 ;
V_346 = V_347 = 0 ;
while ( 1 ) {
if ( V_346 && ! V_344 ) {
V_38 = F_260 ( V_23 , V_327 , & V_342 ,
V_340 ,
V_346 != V_354 ,
& V_339 ) ;
if ( V_38 == - 1 )
...
enum V_358 V_359 ;
F_32 ( ! F_134 ( V_327 -> V_7 [ 0 ] ) ) ;
V_38 = F_261 ( V_327 , V_328 ,
V_329 ) ;
if ( V_38 )
V_359 = V_360 ;
else
...
int F_256 ( struct V_17 * V_18 , struct V_1 * V_139 ,
struct V_153 * V_82 , int V_39 , T_2 V_323 )
{
int V_77 ;
struct V_13 * V_258 ;
F_32 ( ! V_139 -> V_219 ) ;
...
T_2 V_160 = F_81 ( V_258 , V_77 ) ;
if ( V_160 < V_323 ) {
V_77 ++ ;
goto V_63;
}
F_257 ( V_258 , V_82 , V_77 ) ;
}
return 0 ;
}
return 1 ;
...
{
return F_265 ( V_18 , V_139 , 0 ) ;
}
int F_265 ( struct V_17 * V_18 , struct V_1 * V_139 ,
T_2 V_130 )
{
int V_77 ;
int V_39 ;
...
V_38 = F_177 ( NULL , V_18 , V_139 , & V_63 , V_39 ,
V_77 , & V_82 , 0 ) ;
if ( V_38 == - V_223 )
goto V_227;
if ( V_38 < 0 ) {
