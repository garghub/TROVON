...
static int F_27 ( struct V_1 * V_2 , T_1 V_46 [ 6 ] )
{
T_1 V_17 , * V_26 ;
struct V_23 * V_24 = V_2 -> V_25 ;
F_8 ( & V_24 -> V_28 ) ;
...
F_7 ( V_2 , V_47 , V_17 , 1 , & V_26 [ V_17 - 6 ] , 1 ) ;
memcpy ( V_46 , V_26 , 6 ) ;
F_9 ( & V_24 -> V_28 ) ;
return 0 ;
}
...
{
T_1 V_26 [ 10 ] = { 0 } ;
F_12 ( V_33 -> V_35 , V_48 , 0 , 7 , NULL , 0 ) ;
if ( F_16 ( V_33 -> V_35 , V_49 , NULL , 0 ,
V_26 , 10 , 10 ) )
return - V_12 ;
V_26 [ 9 ] = '\0' ;
F_19 ( L_6 , & V_26 [ 1 ] ) ;
F_24 ( V_33 ) ;
V_33 -> V_50 [ 0 ] . V_51 = F_29 ( V_33 -> V_35 ) ;
F_12 ( V_33 -> V_35 , V_48 , 1 , 7 , NULL , 0 ) ;
return 0 ;
}
static int F_30 ( struct V_52 * V_53 ,
const struct V_54 * V_38 )
{
struct V_1 * V_2 ;
struct V_23 * V_24 ;
int V_8 ;
