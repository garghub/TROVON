...
{
T_3 V_51 , V_52 ;
V_51 = V_50 -> V_17 + V_50 -> V_53 / 2 ;
V_51 = F_30 ( V_51 , V_50 -> V_54 , V_50 -> V_18 ) ;
V_52 = V_51 - V_50 -> V_54 ;
V_52 = V_50 -> V_53 * ( V_52 / V_50 -> V_53 ) ;
V_50 -> V_17 = V_50 -> V_54 + V_52 ;
}
int F_17 ( struct V_9 * V_10 , T_3 V_21 )
{
struct V_7 * V_8 = & V_10 -> V_8 ;
struct V_49 * V_50 = & V_10 -> V_21 ;
V_50 -> V_17 = V_21 ;
F_29 ( V_50 ) ;
if ( ! ( V_8 -> V_44 & V_55 ) )
return F_23 ( V_10 , V_30 , V_50 -> V_17 ) ;
return 0 ;
}
...
{
struct V_7 * V_8 = & V_10 -> V_8 ;
struct V_49 * V_50 = & V_10 -> V_16 ;
V_50 -> V_17 = V_16 ;
F_29 ( V_50 ) ;
if ( ! ( V_8 -> V_44 & V_55 ) )
return F_23 ( V_10 , V_29 , V_50 -> V_17 ) ;
return 0 ;
}
