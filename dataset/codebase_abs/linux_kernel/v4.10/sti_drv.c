...
static int F_34 ( struct V_3 * V_17 ,
struct V_45 * V_46 )
{
int V_37 ;
V_37 = F_35 ( V_17 , V_46 ) ;
...
static int F_38 ( struct V_3 * V_49 ,
...
static void F_43 ( struct V_3 * V_54 )
{
...
V_16 -> V_57 = F_45 ( V_54 , 32 ,
V_54 -> V_55 . V_58 ,
V_54 -> V_55 . V_56 ) ;
if ( F_9 ( V_16 -> V_57 ) )
V_16 -> V_57 = NULL ;
}
static void F_46 ( struct V_3 * V_17 )
{
V_17 -> V_55 . V_59 = 0 ;
V_17 -> V_55 . V_60 = 0 ;
V_17 -> V_55 . V_61 = V_62 ;
...
static int F_47 ( struct V_67 * V_17 , void * V_1 )
{
return V_17 -> V_68 == V_1 ;
}
static int F_48 ( struct V_3 * V_54 )
{
struct V_44 * V_16 ;
V_16 = F_49 ( sizeof( * V_16 ) , V_30 ) ;
if ( ! V_16 )
return - V_31 ;
V_54 -> V_52 = ( void * ) V_16 ;
F_50 ( V_54 -> V_17 , V_54 ) ;
V_16 -> V_4 = V_54 ;
F_51 ( & V_16 -> V_47 . V_53 ) ;
F_52 ( & V_16 -> V_47 . V_48 , F_32 ) ;
F_53 ( V_54 ) ;
F_46 ( V_54 ) ;
F_54 ( V_54 ) ;
return 0 ;
}
static void F_55 ( struct V_3 * V_54 )
{
struct V_44 * V_16 = V_54 -> V_52 ;
if ( V_16 -> V_57 ) {
F_56 ( V_16 -> V_57 ) ;
...
static int F_60 ( struct V_67 * V_17 )
{
struct V_3 * V_54 ;
int V_37 ;
V_54 = F_61 ( & V_69 , V_17 ) ;
...
static void F_68 ( struct V_67 * V_17 )
{
struct V_3 * V_54 = F_69 ( V_17 ) ;
F_70 ( V_54 ) ;
F_55 ( V_54 ) ;
F_67 ( V_54 ) ;
}
static int F_71 ( struct V_74 * V_75 )
{
