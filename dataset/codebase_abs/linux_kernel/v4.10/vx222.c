...
if ( F_13 ( V_7 -> V_5 , V_29 ,
V_30 , V_31 ,
V_32 , V_2 ) ) {
F_14 ( V_12 -> V_33 , L_1 , V_7 -> V_5 ) ;
F_1 ( V_2 ) ;
return - V_34 ;
}
V_2 -> V_5 = V_7 -> V_5 ;
if ( ( V_18 = F_15 ( V_12 , V_35 , V_2 , & V_20 ) ) < 0 ) {
F_1 ( V_2 ) ;
return V_18 ;
}
* V_16 = V_4 ;
...
V_18 = F_17 ( & V_7 -> V_33 , V_42 [ V_33 ] , V_43 [ V_33 ] , V_44 ,
0 , & V_12 ) ;
if ( V_18 < 0 )
return V_18 ;
...
static int F_26 ( struct V_9 * V_33 )
{
struct V_11 * V_12 = F_27 ( V_33 ) ;
struct V_3 * V_4 = V_12 -> V_52 ;
return F_28 ( & V_4 -> V_53 ) ;
}
static int F_29 ( struct V_9 * V_33 )
{
struct V_11 * V_12 = F_27 ( V_33 ) ;
struct V_3 * V_4 = V_12 -> V_52 ;
return F_30 ( & V_4 -> V_53 ) ;
}
