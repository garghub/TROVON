...
if ( F_93 ( V_9 ) ) {
F_94 ( V_9 ) ;
V_98 = ( unsigned long ) V_9 -> V_101 . V_102 ;
...
static void T_9 F_98 ( T_7 * V_105 , T_6 * V_24 )
{
T_7 * V_25 ;
int V_55 ;
...
static void T_9 F_100 ( T_6 * V_106 , T_5 * V_21 )
{
T_6 * V_24 ;
int V_55 ;
...
static void T_9
F_102 ( T_7 * V_105 , unsigned long V_107 , unsigned long V_5 ,
bool V_108 )
{
unsigned long V_102 , V_52 = 0 ;
T_7 * V_25 ;
void * V_109 ;
V_76 V_110 ;
V_25 = V_105 + F_55 ( V_107 ) ;
for (; V_107 < V_5 ; V_107 = V_102 , V_25 ++ ) {
V_102 = ( V_107 + V_18 ) & V_19 ;
if ( V_102 > V_5 )
V_102 = V_5 ;
if ( ! F_103 ( * V_25 ) )
continue;
V_110 = F_104 ( * V_25 ) + ( V_107 & V_19 ) ;
if ( V_110 < ( V_76 ) 0x40000000 )
return;
if ( F_105 ( V_107 ) && F_105 ( V_102 ) ) {
if ( ! V_108 )
F_90 ( V_49 ( * V_25 ) , 0 ) ;
F_5 ( & V_22 . V_13 ) ;
F_106 ( & V_22 , V_107 , V_25 ) ;
F_13 ( & V_22 . V_13 ) ;
V_52 ++ ;
} else {
memset ( ( void * ) V_107 , V_111 , V_102 - V_107 ) ;
V_109 = F_7 ( V_49 ( * V_25 ) ) ;
...
static void T_9
F_109 ( T_6 * V_106 , unsigned long V_107 , unsigned long V_5 ,
bool V_108 )
{
unsigned long V_102 , V_52 = 0 ;
T_7 * V_112 ;
T_6 * V_24 ;
void * V_109 ;
V_24 = V_106 + F_63 ( V_107 ) ;
for (; V_107 < V_5 ; V_107 = V_102 , V_24 ++ ) {
V_102 = F_110 ( V_107 , V_5 ) ;
if ( ! F_111 ( * V_24 ) )
continue;
if ( F_64 ( * V_24 ) ) {
if ( F_112 ( V_107 , V_36 ) &&
...
static void T_9
F_114 ( T_5 * V_113 , unsigned long V_107 , unsigned long V_5 ,
bool V_108 )
{
unsigned long V_102 , V_52 = 0 ;
T_6 * V_114 ;
T_5 * V_21 ;
void * V_109 ;
V_21 = V_113 + F_32 ( V_107 ) ;
for (; V_107 < V_5 ; V_107 = V_102 , V_21 ++ ) {
V_102 = F_115 ( V_107 , V_5 ) ;
if ( ! F_116 ( * V_21 ) )
continue;
if ( F_71 ( * V_21 ) ) {
if ( F_112 ( V_107 , V_69 ) &&
...
static void T_9
F_118 ( unsigned long V_4 , unsigned long V_5 , bool V_108 )
{
unsigned long V_102 ;
unsigned long V_107 ;
T_2 * V_11 ;
T_5 * V_21 ;
for ( V_107 = V_4 ; V_107 < V_5 ; V_107 = V_102 ) {
V_102 = F_119 ( V_107 , V_5 ) ;
V_11 = F_3 ( V_107 ) ;
if ( ! F_120 ( * V_11 ) )
continue;
V_21 = ( T_5 * ) F_11 ( * V_11 ) ;
F_114 ( V_21 , V_107 , V_102 , V_108 ) ;
}
F_108 () ;
}
...
#endif
F_146 ( L_18 ,
( unsigned long ) F_43 ( F_147 ( V_123 ) ) ,
( unsigned long ) F_43 ( F_147 ( V_120 ) ) ) ;
F_146 ( L_18 ,
( unsigned long ) F_43 ( F_147 ( V_124 ) ) ,
( unsigned long ) F_43 ( F_147 ( V_128 ) ) ) ;
F_148 () ;
}
int F_149 ( unsigned long V_107 )
{
unsigned long V_129 = ( ( long ) V_107 ) >> V_130 ;
T_2 * V_11 ;
T_5 * V_21 ;
T_6 * V_24 ;
T_7 * V_25 ;
...
if ( F_4 ( * V_11 ) )
return 0 ;
V_21 = F_21 ( V_11 , V_107 ) ;
if ( F_24 ( * V_21 ) )
return 0 ;
if ( F_71 ( * V_21 ) )
return F_150 ( F_151 ( * V_21 ) ) ;
V_24 = F_26 ( V_21 , V_107 ) ;
if ( F_28 ( * V_24 ) )
return 0 ;
if ( F_64 ( * V_24 ) )
return F_150 ( F_152 ( * V_24 ) ) ;
V_25 = F_30 ( V_24 , V_107 ) ;
if ( F_58 ( * V_25 ) )
return 0 ;
return F_150 ( F_153 ( * V_25 ) ) ;
}
static unsigned long F_154 ( void )
{
unsigned long V_131 = V_132 ;
if ( F_155 () || ( ( V_84 << V_47 ) >= ( 64UL << 30 ) ) )
V_131 = 2UL << 30 ;
F_59 ( L_19 , V_131 >> 20 ) ;
return V_131 ;
}
unsigned long F_156 ( void )
{
if ( ! V_133 )
V_133 = F_154 () ;
return V_133 ;
}
static int T_9 F_157 ( unsigned long V_4 ,
...
for ( V_107 = V_4 ; V_107 < V_5 ; V_107 = V_102 ) {
V_102 = F_110 ( V_107 , V_5 ) ;
V_11 = F_158 ( V_107 , V_134 ) ;
if ( ! V_11 )
return - V_135 ;
V_21 = F_159 ( V_11 , V_107 , V_134 ) ;
if ( ! V_21 )
return - V_135 ;
V_24 = F_26 ( V_21 , V_107 ) ;
if ( F_28 ( * V_24 ) ) {
void * V_136 ;
V_136 = F_160 ( V_36 , V_134 , V_100 ) ;
if ( V_136 ) {
T_7 V_137 ;
...
F_161 ( ( T_7 * ) V_24 , V_134 , V_107 , V_102 ) ;
continue;
}
F_162 ( L_21 ) ;
if ( F_163 ( V_107 , V_102 , V_134 ) )
return - V_135 ;
}
return 0 ;
}
int T_9 F_164 ( unsigned long V_4 , unsigned long V_5 , int V_134 )
{
struct V_99 * V_100 = F_91 ( V_4 ) ;
int V_143 ;
if ( F_165 ( V_144 ) )
V_143 = F_157 ( V_4 , V_5 , V_134 , V_100 ) ;
else if ( V_100 ) {
F_166 ( L_22 ,
V_145 ) ;
V_143 = - V_135 ;
} else
V_143 = F_163 ( V_4 , V_5 , V_134 ) ;
if ( ! V_143 )
F_2 ( V_4 , V_5 - 1 ) ;
return V_143 ;
}
void F_167 ( unsigned long V_146 ,
struct V_9 * V_147 , unsigned long V_30 )
{
unsigned long V_107 = ( unsigned long ) V_147 ;
...
F_168 ( V_146 , F_169 ( * V_11 ) , V_104 ) ;
V_21 = F_21 ( V_11 , V_107 ) ;
if ( F_24 ( * V_21 ) ) {
V_102 = ( V_107 + V_18 ) & V_19 ;
continue;
}
F_168 ( V_146 , V_26 ( * V_21 ) , V_104 ) ;
if ( ! F_165 ( V_144 ) ) {
V_102 = ( V_107 + V_18 ) & V_19 ;
V_24 = F_26 ( V_21 , V_107 ) ;
if ( F_28 ( * V_24 ) )
continue;
F_168 ( V_146 , V_61 ( * V_24 ) ,
V_104 ) ;
V_25 = F_30 ( V_24 , V_107 ) ;
if ( F_58 ( * V_25 ) )
continue;
F_168 ( V_146 , V_49 ( * V_25 ) ,
V_103 ) ;
} else {
V_102 = F_110 ( V_107 , V_5 ) ;
V_24 = F_26 ( V_21 , V_107 ) ;
