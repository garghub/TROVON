...
int V_64 = F_56 ( ( T_2 ) V_15 ) ;
F_16 ( V_57 -> V_61 . V_10 ) ;
F_14 ( V_52 ) ;
V_57 -> V_61 . V_10 = V_52 ;
F_57 ( & V_57 -> V_61 . V_62 , & V_52 -> V_12 ) ;
F_58 ( & V_57 -> V_63 , & V_65 [ V_64 ] ) ;
F_59 ( & V_56 -> V_61 . V_63 ,
& V_57 -> V_61 . V_63 ) ;
}
if ( V_56 -> V_61 . V_66 )
...
{
struct V_18 * V_71 = F_65 ( V_10 -> V_13 , V_2 ) ;
if ( F_33 ( V_71 ) )
return F_34 ( V_71 ) ;
F_66 ( F_23 ( V_2 -> V_18 ) ) ;
if ( F_67 ( V_71 ) ) {
...
F_57 ( & V_26 -> V_62 , & V_10 -> V_12 ) ;
}
int F_73 ( struct V_25 * V_26 , struct V_76 * * V_63 )
{
...
struct V_4 * V_81 ,
struct V_4 * V_82 ,
T_2 V_22 , const void * V_83 , int V_84 ,
...
switch ( V_84 ) {
case ( V_86 ) :
V_7 = F_23 ( ( ( const struct V_13 * ) V_83 ) -> V_18 ) ;
break;
case ( V_87 ) :
V_7 = ( const struct V_7 * ) V_83 ;
break;
default:
F_77 () ;
V_7 = NULL ;
...
F_46 ( V_2 , V_49 , V_7 -> V_90 -> V_73 , V_7 -> V_74 , 0 ) ;
else if ( V_22 & ( V_91 | V_92 ) )
F_46 ( V_2 , V_49 , V_24 , V_17 , 1 ) ;
...
int F_80 ( struct V_25 * V_37 , struct V_25 * V_36 )
{
struct V_97 * V_98 ;
char * V_99 ;
V_99 = F_36 ( F_81 ( V_36 -> V_66 ) , V_20 ) ;
if ( ! V_99 )
return - V_21 ;
V_98 = F_82 ( V_37 , V_99 , strlen ( V_99 ) ) ;
if ( F_33 ( V_98 ) ) {
F_4 ( V_99 ) ;
return F_34 ( V_98 ) ;
}
...
int F_83 ( struct V_100 * V_101 , struct V_97 * V_6 )
{
struct V_102 * V_103 ;
unsigned long V_15 ;
T_1 V_16 ;
...
if ( ! V_103 )
return 0 ;
V_15 = F_85 ( V_103 ) -> V_74 ;
V_16 = F_85 ( V_103 ) -> V_90 -> V_73 ;
F_86 ( V_103 ) ;
return F_87 ( V_6 , V_15 , V_16 ) ;
}
