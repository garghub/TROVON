...
struct V_52 * * V_391 ;
int V_381 = 0 ;
if ( ! F_189 ( F_113 ( V_56 , V_390 ) , V_390 , & V_389 -> V_392 ) )
return - V_393 ;
V_381 += V_390 ;
V_194 -= V_390 ;
...
void F_302 ( struct V_11 * V_23 , int V_607 )
{
T_1 V_419 ;
if ( V_23 -> V_148 != V_151 )
return;
...
if ( V_419 == V_618 )
return - V_507 ;
return F_307 ( V_23 , V_212 , NULL , V_419 ) ;
}
...
V_24 = F_301 ( V_23 ) ;
if ( ! V_24 )
V_24 = F_307 ( V_23 , V_212 , V_56 , V_419 ) ;
return V_24 ;
}
static bool F_313 ( struct V_11 * V_23 , T_2 V_213 )
{
T_2 V_625 ;
...
if ( F_313 ( V_23 , V_212 -> V_213 ) ) {
switch ( V_23 -> V_292 ) {
case V_387 :
V_24 = F_307 ( V_23 , V_212 , V_56 , V_419 ) ;
break;
case V_421 :
V_24 = F_309 ( V_23 , V_212 , V_56 ,
V_419 ) ;
break;
case V_301 :
...
break;
case V_299 :
V_24 = F_312 ( V_23 , V_212 , V_56 , V_419 ) ;
break;
default:
break;
}
...
static int F_315 ( struct V_11 * V_23 , struct V_211 * V_212 ,
struct V_52 * V_56 )
{
F_23 ( L_96 , V_23 , V_212 , V_56 ,
V_23 -> V_292 ) ;
if ( F_306 ( V_23 , V_212 -> V_58 ) ==
V_614 ) {
F_213 ( V_23 , V_212 ) ;
...
if ( ( V_23 -> V_148 == V_151 ||
V_23 -> V_148 == V_155 ) && F_317 ( V_23 -> V_195 , V_56 ) )
goto V_599;
if ( ! V_212 -> V_220 ) {
int V_24 ;
F_23 ( L_98 ,
...
if ( V_23 -> V_148 != V_155 ) {
V_419 = V_618 ;
V_24 = F_314 ( V_23 , V_212 , V_56 , V_419 ) ;
} else {
V_24 = F_315 ( V_23 , V_212 , V_56 ) ;
}
if ( V_24 )
F_86 ( V_23 , V_327 ) ;
} else {
...
if ( F_314 ( V_23 , V_212 , V_56 , V_419 ) )
F_86 ( V_23 , V_327 ) ;
}
return 0 ;
V_599:
...
if ( V_8 -> type == V_2 &&
F_324 ( & V_8 -> V_196 -> V_633 , & V_8 -> V_157 ,
F_3 ( V_8 ) ) ) {
F_97 ( V_56 ) ;
return;
}
...
F_67 ( & V_13 -> V_366 ) ;
F_332 ( & V_13 -> V_354 , F_326 ) ;
F_332 ( & V_13 -> V_156 , F_80 ) ;
V_13 -> V_121 = V_122 ;
return V_13 ;
}
...
V_10 , F_69 ( V_20 ) ) ;
V_196 = F_336 ( V_157 , & V_23 -> V_21 , V_23 -> V_9 ) ;
if ( ! V_196 )
return - V_641 ;
F_149 ( V_196 ) ;
...
V_8 = F_337 ( V_196 , V_157 , V_10 ,
V_23 -> V_79 ,
V_646 ,
V_341 ) ;
else
V_8 = F_338 ( V_196 , V_157 , V_10 ,
V_23 -> V_79 ,
V_646 ) ;
} else {
T_1 V_189 = F_87 ( V_23 ) ;
V_8 = F_339 ( V_196 , V_157 , V_23 -> V_79 , V_189 ) ;
}
if ( F_118 ( V_8 ) ) {
V_24 = F_191 ( V_8 ) ;
goto V_27;
...
int F_340 ( struct V_268 * V_196 , T_4 * V_632 )
{
...
V_15 = F_343 ( V_88 . V_399 , F_344 ( * V_15 ) , V_87 ) ;
...
static void F_346 ( struct V_7 * V_8 , T_1 V_170 )
{
struct V_268 * V_196 = V_8 -> V_196 ;
struct V_12 * V_13 ;
struct V_11 * V_509 ;
...
return;
V_10 = F_3 ( V_8 ) ;
if ( F_324 ( & V_196 -> V_633 , & V_8 -> V_157 , V_10 ) )
return;
V_509 = F_341 ( NULL , V_8 ) ;
while ( V_509 ) {
...
static inline void F_350 ( struct V_11 * V_23 , T_1 V_655 )
{
if ( V_23 -> V_39 != V_123 )
return;
if ( V_655 == 0x00 ) {
...
static void F_351 ( struct V_7 * V_8 , T_1 V_170 , T_1 V_655 )
{
struct V_12 * V_13 = V_8 -> V_363 ;
struct V_11 * V_23 ;
if ( ! V_13 )
...
void F_352 ( struct V_7 * V_8 , struct V_52 * V_56 , T_2 V_110 )
{
struct V_12 * V_13 = V_8 -> V_363 ;
struct V_253 * V_660 ;
int V_194 ;
...
if ( ! V_13 -> V_365 )
goto V_599;
F_353 ( V_56 , F_113 ( V_13 -> V_365 , V_56 -> V_194 ) ,
V_56 -> V_194 ) ;
...
static int F_354 ( struct V_665 * V_666 , void * V_28 )
{
struct V_11 * V_15 ;
F_122 ( & V_25 ) ;
F_5 (c, &chan_list, global_l) {
...
static int F_356 ( struct V_667 * V_667 , struct V_668 * V_668 )
{
return F_357 ( V_668 , F_354 , V_667 -> V_669 ) ;
}
int T_11 F_358 ( void )
{
int V_24 ;
...
if ( F_361 ( V_671 ) )
return 0 ;
V_672 = F_362 ( L_133 , 0444 , V_671 ,
NULL , & V_673 ) ;
F_363 ( L_134 , 0644 , V_671 ,
& V_116 ) ;
F_363 ( L_135 , 0644 , V_671 ,
& V_119 ) ;
return 0 ;
}
void F_364 ( void )
