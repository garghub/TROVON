...
static int F_243 ( struct V_36 * V_39 ,
struct V_3 * V_4 ,
struct V_328 * V_329 )
{
unsigned long V_152 ;
...
static int F_253 ( struct V_345 * V_346 ,
struct V_3 * V_4 ,
int V_138 )
{
int V_347 = F_254 ( V_346 ) ;
F_11 ( V_138 != V_139 && V_138 != V_137 ) ;
F_11 ( V_4 -> V_74 != V_136 && ! V_347 ) ;
if ( V_347 )
return 1 ;
F_255 ( F_46 ( F_256 ( V_346 ) ) ) ;
return 0 ;
}
...
{
struct V_27 * V_27 = F_10 ( V_4 ) ;
return F_253 ( F_160 ( V_27 ) , V_4 , V_138 ) ;
}
...
static void F_259 ( struct V_36 * V_39 ,
struct V_3 * V_4 )
{
...
F_21 ( & V_350 ) ;
while ( 1 ) {
V_279 = F_262 ( V_108 -> V_109 ,
V_108 -> V_352 , 1 ) ;
if ( ! V_279 )
break;
F_23 ( & V_350 ) ;
if ( F_245 ( V_108 -> V_109 -> V_234 ) )
F_263 ( V_279 ) ;
F_3 ( 0 , L_103 , V_279 ) ;
F_264 ( V_279 ) ;
F_265 ( V_279 ) ;
...
struct V_33 * V_354 =
F_14 ( V_4 ) ;
return F_253 ( & V_354 -> V_355 , V_4 , V_138 ) ;
}
...
struct V_358 * V_98 = F_269 ( V_357 -> V_99 . V_100 ,
V_357 -> V_99 . V_129 ) ;
V_6 = F_2 ( & V_4 -> V_7 ) ;
V_6 -> V_9 = V_359 ;
...
void F_270 ( struct V_31 * V_357 , int V_208 )
{
...
static int F_271 ( struct V_31 * V_357 )
{
struct V_358 * V_98 = F_269 ( V_357 -> V_99 . V_100 ,
V_357 -> V_99 . V_129 ) ;
struct V_3 * V_4 = & V_357 -> V_372 ;
...
int F_273 ( struct V_31 * V_357 , int V_208 )
{
struct V_3 * V_4 = & V_357 -> V_372 ;
struct V_36 * V_39 = F_46 ( V_357 -> V_99 . V_100 ) ;
int V_1 = V_208 ? V_136 : V_137 ;
...
int F_274 ( struct V_33 * V_378 , int V_208 )
{
int V_162 ;
int V_1 = V_208 ? V_136 : V_137 ;
...
void F_275 ( struct V_33 * V_378 , int V_208 )
{
int V_1 = V_208 ? V_136 : V_137 ;
struct V_3 * V_4 = & V_378 -> V_35 ;
struct V_36 * V_39 = V_4 -> V_28 ;
...
static void F_276 ( struct V_36 * V_39 )
{
unsigned long V_381 ;
unsigned long V_152 ;
struct V_3 * V_4 ;
...
static int F_279 ( struct V_36 * V_39 )
{
int V_386 = 0 ;
unsigned long V_152 ;
F_80 ( & V_39 -> V_323 , V_152 ) ;
