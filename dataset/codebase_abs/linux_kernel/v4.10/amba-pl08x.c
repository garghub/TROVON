...
static bool F_94 ( struct V_2 * V_3 , void * V_214 )
{
struct V_1 * V_9 = F_1 ( V_3 ) ;
...
V_3 -> V_81 = F_101 ( V_232 , L_50 , V_75 ) ;
if ( ! V_3 -> V_81 ) {
F_53 ( V_3 ) ;
return - V_201 ;
}
...
static struct V_2 * F_113 ( struct V_23 * V_24 ,
T_1 V_31 )
{
struct V_1 * V_3 ;
F_34 (chan, &pl08x->slave.channels, vc.chan.device_node) {
...
static struct V_2 * F_114 ( struct V_247 * V_248 ,
struct V_249 * V_250 )
{
...
static int F_116 ( struct V_253 * V_29 ,
struct V_23 * V_24 ,
struct V_235 * V_254 )
{
struct V_10 * V_11 ;
...
int V_13 ;
int V_75 ;
V_11 = F_117 ( & V_29 -> V_30 , sizeof( * V_11 ) , V_232 ) ;
if ( ! V_11 )
return - V_201 ;
if ( F_118 ( V_254 , L_74 ) )
V_11 -> V_124 |= V_154 ;
...
V_11 -> V_178 |= V_125 ;
if ( ! V_11 -> V_178 ) {
F_103 ( & V_29 -> V_30 , L_79 ) ;
V_11 -> V_178 |= V_154 | V_125 ;
}
V_13 = F_119 ( V_254 , L_80 , & V_20 ) ;
if ( V_13 ) {
F_103 ( & V_29 -> V_30 , L_81 ) ;
V_20 = 1 ;
}
switch ( V_20 ) {
default:
...
V_13 = F_119 ( V_254 , L_83 , & V_20 ) ;
if ( V_13 ) {
F_103 ( & V_29 -> V_30 , L_84 ) ;
V_20 = 8 ;
}
switch ( V_20 ) {
default:
...
V_256 -> V_229 = F_101 ( V_232 , L_86 , V_75 ) ;
V_256 ++ ;
}
V_11 -> V_266 = V_24 -> V_8 -> V_265 ;
V_24 -> V_11 = V_11 ;
return F_121 ( V_29 -> V_30 . V_267 , F_114 ,
V_24 ) ;
}
static inline int F_116 ( struct V_253 * V_29 ,
struct V_23 * V_24 ,
struct V_235 * V_254 )
{
return - V_212 ;
}
static int F_122 ( struct V_253 * V_29 , const struct V_268 * V_31 )
{
struct V_23 * V_24 ;
...
int V_13 = 0 ;
int V_75 ;
V_13 = F_123 ( V_29 , NULL ) ;
if ( V_13 )
return V_13 ;
V_13 = F_124 ( & V_29 -> V_30 , F_125 ( 32 ) ) ;
if ( V_13 )
goto V_271;
...
V_24 -> memcpy . V_286 = F_127 ( V_287 ) ;
V_24 -> memcpy . V_288 = V_289 ;
F_126 ( V_290 , V_24 -> V_211 . V_273 ) ;
F_126 ( V_291 , V_24 -> V_211 . V_273 ) ;
...
V_24 -> V_211 . V_286 = F_127 ( V_190 ) | F_127 ( V_185 ) ;
V_24 -> V_211 . V_288 = V_289 ;
V_24 -> V_11 = F_128 ( & V_29 -> V_30 ) ;
if ( ! V_24 -> V_11 ) {
if ( V_254 ) {
V_13 = F_116 ( V_29 , V_24 , V_254 ) ;
if ( V_13 )
goto V_294;
} else {
F_46 ( & V_29 -> V_30 , L_87 ) ;
...
V_13 = F_132 ( V_29 -> V_221 [ 0 ] , F_96 , 0 , V_303 , V_24 ) ;
if ( V_13 ) {
F_46 ( & V_29 -> V_30 , L_88 ,
V_123 , V_29 -> V_221 [ 0 ] ) ;
goto V_309;
