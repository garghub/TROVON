...
static void F_116 ( struct V_113 * V_114 )
{
struct V_22 * V_23 =
F_117 ( V_114 , struct V_22 , V_114 ) ;
struct V_57 * V_27 = V_23 -> V_27 ;
F_75 ( V_27 ) ;
}
static int F_118 ( struct V_7 * V_8 , struct V_78 * V_79 )
{
struct V_57 * V_27 = F_109 ( V_79 -> V_79 . V_61 ) ;
struct V_22 * V_23 = F_18 ( V_27 ) ;
struct V_1 * V_2 ;
...
( V_8 -> V_77 < V_82 ) )
goto V_115;
if ( ( V_8 -> V_77 & 3 ) && F_119 ( V_8 , 4 - ( V_8 -> V_77 & 3 ) ) )
goto V_115;
if ( F_120 ( V_8 , 0 ) )
goto V_115;
...
V_23 -> V_69 ++ ;
if ( V_79 -> V_117 < V_23 -> V_69 ) {
F_121 ( & V_27 -> V_28 , L_56 , V_23 -> V_69 ) ;
F_122 ( V_79 ) ;
}
if ( V_23 -> V_43 == V_44 ) {
F_38 ( V_23 , V_54 ) ;
...
static int F_126 ( struct V_28 * V_79 )
{
static const char V_137 [] = L_60 ;
struct V_57 * V_27 = F_109 ( V_79 ) ;
struct V_22 * V_23 ;
int V_112 ;
V_23 = F_127 ( sizeof( * V_23 ) , V_35 ) ;
if ( ! V_23 ) {
F_59 ( V_79 , L_61 ) ;
return - V_38 ;
}
...
V_23 -> V_42 . V_138 = F_66 ;
V_23 -> V_53 . V_4 = ( unsigned long ) V_27 ;
V_23 -> V_53 . V_138 = F_66 ;
V_23 -> V_45 . V_4 = ( unsigned long ) V_27 ;
V_23 -> V_45 . V_138 = F_63 ;
F_131 ( & V_23 -> V_76 ) ;
F_131 ( & V_23 -> V_31 ) ;
F_132 ( & V_23 -> V_47 , 0 ) ;
F_133 ( V_27 , V_23 ) ;
V_23 -> V_27 = V_27 ;
F_134 ( & V_23 -> V_114 , F_116 ) ;
V_23 -> V_37 = F_135 ( V_27 , L_62 ) ;
if ( V_23 -> V_37 < 0 ) {
V_112 = V_23 -> V_37 ;
F_59 ( V_79 , L_63 , V_112 ) ;
goto V_36;
}
V_23 -> V_26 = F_135 ( V_27 , L_64 ) ;
if ( V_23 -> V_26 < 0 ) {
V_112 = V_23 -> V_26 ;
...
V_23 -> V_62 = F_136 ( 0 , V_137 , V_139 , F_125 ) ;
if ( ! V_23 -> V_62 ) {
F_59 ( V_79 , L_67 ) ;
V_112 = - V_38 ;
goto V_97;
}
V_23 -> V_62 -> V_140 = V_141 ;
V_23 -> V_62 -> V_142 = V_143 ;
F_137 ( V_23 -> V_62 , V_79 ) ;
F_52 ( V_23 -> V_62 ) ;
V_112 = F_138 ( V_23 -> V_62 ) ;
if ( V_112 < 0 ) {
F_59 ( V_79 , L_68 , V_112 ) ;
goto V_99;
}
F_139 ( & V_23 -> V_30 , & V_144 ) ;
F_19 ( V_79 , L_69 ,
V_23 -> V_37 , V_23 -> V_26 ) ;
return 0 ;
V_99:
...
static int F_140 ( struct V_28 * V_79 )
{
struct V_57 * V_27 = F_109 ( V_79 ) ;
struct V_22 * V_23 = F_18 ( V_27 ) ;
F_26 ( & V_23 -> V_30 ) ;
