...
return - V_8 ;
case V_34 :
if ( ! F_14 ( V_2 -> V_35 ) || V_2 -> V_36 == NULL )
return 0 ;
while ( F_15 ( V_2 -> V_36 ) )
;
if ( F_16 ( V_37 ) )
...
if ( F_17 ( V_20 , V_22 ) )
return - V_6 ;
return F_18 ( V_2 , V_20 , V_2 -> V_35 ) ;
case V_41 :
if ( V_2 -> V_42 == NULL || ! F_19 ( V_2 -> V_35 ) )
return 0 ;
return F_20 ( V_2 -> V_42 -> V_43 , V_22 ) ? - V_6 : 0 ;
case V_44 :
if ( ! F_14 ( V_2 -> V_35 ) || V_2 -> V_36 == NULL )
return 0 ;
return F_20 ( F_21 ( V_2 -> V_36 ) , V_22 ) ? - V_6 : 0 ;
case V_45 :
return F_20 ( F_22 ( V_2 -> V_32 ) , V_22 ) ? - V_6 : 0 ;
case V_46 :
if ( F_17 ( V_20 , V_22 ) )
return - V_6 ;
return F_23 ( V_2 , V_20 , V_18 , V_19 ) ;
case V_47 :
return F_20 ( V_2 -> V_48 , V_22 ) ? - V_6 : 0 ;
case V_49 :
return F_20 ( V_2 -> V_50 , V_22 ) ? - V_6 : 0 ;
case V_51 :
if ( F_17 ( V_20 , V_22 ) )
return - V_6 ;
V_21 = F_23 ( V_2 , V_20 , V_18 , V_19 ) ;
return F_20 ( V_21 , V_22 ) ? - V_6 : 0 ;
case V_52 :
if ( F_17 ( V_20 , V_22 ) )
return - V_6 ;
F_23 ( V_2 , V_20 , V_18 , V_19 ) ;
return 0 ;
case V_53 :
case V_54 :
return F_1 ( V_2 , V_3 ) ;
