...
V_139 = F_69 ( V_149 , V_140 ) ;
V_143 = (struct V_136 * ) V_139 -> V_26 + V_129 ;
V_137 -> V_150 = V_143 -> V_150 ;
V_137 -> V_151 = V_143 -> V_151 ;
V_137 -> V_126 = V_143 -> V_126 ;
V_137 -> V_60 = F_70 ( & V_112 -> V_12 , V_137 -> V_126 ,
sizeof( * V_137 -> V_60 ) , V_21 ) ;
if ( ! V_137 -> V_60 )
return F_52 ( - V_22 ) ;
if ( V_143 -> V_152 + 1 > V_147 )
return F_52 ( - V_46 ) ;
for ( V_35 = 0 ; V_35 < V_143 -> V_152 + 1 ; V_35 ++ ) {
V_145 = F_71 ( V_112 , V_153 , V_35 ) ;
V_146 [ V_35 ] = F_72 ( & V_112 -> V_12 , V_145 -> V_154 ,
F_73 ( V_145 ) ) ;
if ( F_58 ( V_146 [ V_35 ] ) )
return F_52 ( - V_155 ) ;
}
...
V_58 -> V_156 = V_142 -> V_156 ;
V_58 -> V_157 = V_142 -> V_157 ;
V_58 -> V_158 = V_142 -> V_158 ;
V_58 -> V_159 = V_142 -> V_159 ;
V_58 -> V_8 = V_142 -> V_8 ;
F_74 ( & V_58 -> V_77 ) ;
V_58 -> V_36 = V_137 ;
...
V_36 -> V_12 = V_12 ;
V_145 = F_71 ( V_112 , V_162 , 0 ) ;
if ( V_145 )
V_36 -> V_163 = V_145 -> V_154 ;
...
const T_3 * V_167 = V_58 -> type -> V_78 ;
const T_3 * V_168 = V_58 -> type -> V_75 ;
enum V_81 type ;
if ( ! V_168 [ V_169 ] )
continue;
for ( type = 0 ; type < V_86 ; type ++ )
if ( V_168 [ type ] )
V_58 -> V_170 [ type ] = F_30 ( V_55 + V_167 [ type ] ) ;
if ( V_168 [ V_76 ] * V_58 -> V_62 > 32 ) {
V_58 -> V_170 [ V_86 ] =
F_30 ( V_55 + V_167 [ V_76 ] + 4 ) ;
F_79 ( L_23 ,
V_58 -> V_8 , V_55 ,
V_58 -> V_170 [ V_76 ] ,
V_58 -> V_170 [ V_86 ] ) ;
...
F_79 ( L_24 , V_58 -> V_8 ,
V_55 , V_58 -> V_170 [ V_76 ] ) ;
}
}
if ( V_36 -> V_150 )
V_36 -> V_150 ( V_36 ) ;
}
static void F_80 ( struct V_3 * V_36 )
{
int V_35 ;
if ( V_36 -> V_151 )
V_36 -> V_151 ( V_36 ) ;
...
F_79 ( L_25 ,
V_58 -> V_8 , V_55 ,
F_30 ( V_55 + V_167 [ V_76 ] ) ,
F_30 ( V_55 + V_167 [ V_76 ] + 4 ) ,
V_58 -> V_170 [ V_76 ] ,
V_58 -> V_170 [ V_86 ] ) ;
F_31 ( V_58 -> V_170 [ V_86 ] ,
V_55 + V_167 [ V_76 ] + 4 ) ;
} else {
F_79 ( L_26 , V_58 -> V_8 ,
V_55 , F_30 ( V_55 + V_167 [ V_76 ] ) ,
V_58 -> V_170 [ V_76 ] ) ;
}
for ( type = 0 ; type < V_86 ; type ++ )
if ( V_168 [ type ] )
F_31 ( V_58 -> V_170 [ type ] , V_55 + V_167 [ type ] ) ;
}
}
static int F_81 ( void )
{
struct V_3 * V_36 ;
F_82 (drvdata, &drvdata_list, node) {
F_78 ( V_36 ) ;
}
return 0 ;
}
