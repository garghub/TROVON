...
static void F_66 ( struct V_5 * V_6 , void * V_58 )
{
void T_6 * V_40 ;
V_40 = * ( void T_6 * * ) V_58 ;
F_67 ( V_40 ) ;
}
static int F_68 ( struct V_5 * V_6 , void * V_19 , void * V_40 )
{
struct V_16 * V_59 = F_8 ( V_19 , struct V_16 , V_19 ) ;
return * ( void * * ) V_59 -> V_19 == V_40 ;
}
void T_6 * F_69 ( struct V_5 * V_6 , T_1 V_4 ,
T_1 V_60 )
{
void * V_40 ;
void T_6 * V_61 ;
...
if ( ! V_61 )
return NULL ;
V_40 = F_48 ( F_66 , sizeof( void * ) , V_44 ) ;
if ( ! V_40 ) {
F_67 ( V_61 ) ;
return NULL ;
}
...
void F_71 ( struct V_5 * V_6 , void T_6 * V_58 )
{
F_37 ( F_30 ( V_6 , F_66 , F_68 ,
( void * ) V_58 ) ) ;
}
