...
T_2 V_42 ;
struct V_67 * V_68 ;
V_2 = F_34 ( & V_8 -> V_22 , sizeof( * V_2 ) , V_69 ) ;
if ( V_2 == NULL )
return - V_70 ;
F_35 ( V_8 , V_2 ) ;
V_68 = F_36 ( V_8 -> V_22 . V_71 ) ;
V_2 -> V_12 = V_64 -> V_72 ;
V_2 -> V_73 . V_74 = V_68 -> V_74 ;
V_13 = F_37 ( V_68 , L_6 , & V_42 ) ;
if ( V_13 < 0 ) {
F_5 ( & V_8 -> V_22 ,
L_7 ) ;
return V_13 ;
...
V_2 -> V_73 . V_81 =
F_39 ( V_79 ) ;
else if ( V_2 -> V_12 >= V_82 )
V_2 -> V_73 . V_81 =
F_39 ( V_79 ) - 1 ;
else if ( V_2 -> V_12 >= V_83 )
V_2 -> V_73 . V_81 =
F_39 ( V_79 ) - 2 ;
else
V_2 -> V_73 . V_81 =
...
V_2 -> V_58 = F_41 ( & V_8 -> V_22 , & V_2 -> V_73 ,
& V_66 ) ;
if ( F_42 ( V_2 -> V_58 ) ) {
F_5 ( & V_8 -> V_22 , L_11 ) ;
return F_43 ( V_2 -> V_58 ) ;
} else {
F_28 ( & V_2 -> V_60 , V_61 * V_62 ) ;
}
return 0 ;
}
static int F_44 ( struct V_89 * V_22 )
{
struct V_7 * V_8 = F_45 ( V_22 ) ;
struct V_1 * V_2 = F_30 ( V_8 ) ;
F_31 ( & V_2 -> V_60 ) ;
return 0 ;
}
static int F_46 ( struct V_89 * V_22 )
{
struct V_7 * V_8 = F_45 ( V_22 ) ;
struct V_1 * V_2 = F_30 ( V_8 ) ;
F_28 ( & V_2 -> V_60 , V_61 * V_62 ) ;
