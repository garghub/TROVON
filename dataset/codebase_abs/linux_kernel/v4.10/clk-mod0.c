...
V_4 = 3 ;
V_3 = F_2 ( div , 1 << V_4 ) ;
V_2 -> V_5 = ( V_2 -> V_6 >> V_4 ) / V_3 ;
V_2 -> V_7 = V_3 - 1 ;
V_2 -> V_8 = V_4 ;
}
static void T_2 F_3 ( struct V_9 * V_10 )
{
void T_3 * V_11 ;
V_11 = F_4 ( V_10 , 0 ) ;
if ( ! V_11 ) {
...
static void T_2 F_11 ( struct V_9 * V_10 )
{
void T_3 * V_11 ;
...
static void T_2 F_15 ( struct V_9 * V_10 )
{
struct V_25 * V_26 ;
void T_3 * V_11 ;
V_11 = F_4 ( V_10 , 0 ) ;
...
static void T_2 F_29 ( struct V_9 * V_10 ,
...
static void T_2 F_37 ( struct V_9 * V_10 )
{
F_29 ( V_10 , & V_12 , & V_63 ) ;
}
static void T_2 F_38 ( struct V_9 * V_10 )
{
F_29 ( V_10 , & V_24 , & V_64 ) ;
}
