...
{
struct V_234 * V_222 = F_134 ( & V_208 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_222 , struct V_7 , V_222 ) ;
struct V_235 * V_236 = F_9 ( V_222 -> V_237 . V_25 ,
struct V_235 , V_238 ) ;
struct V_239 * V_240 = F_135 ( V_236 ) ;
