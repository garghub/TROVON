...
V_60 = F_115 ( V_5 -> V_19 , (struct V_105 * ) & V_25 -> V_106 ,
V_195 , V_25 ) ;
if ( V_60 )
goto V_100;
V_51 . V_2 = V_25 -> V_2 ;
...
return 0 ;
V_201:
F_116 ( V_5 -> V_19 , (struct V_105 * ) & V_25 -> V_106 ) ;
F_51 ( V_25 ) ;
V_100:
F_5 ( & V_9 ) ;
F_48 ( & V_26 , V_25 -> V_2 ) ;
...
if ( F_39 ( & V_75 , V_71 , sizeof( V_75 ) ) )
return - V_77 ;
V_203 . V_85 = V_75 . V_85 ;
V_203 . V_52 = V_75 . V_52 ;
V_203 . V_2 = V_75 . V_2 ;
V_203 . V_109 = F_60 ( (struct V_105 * ) & V_75 . V_106 ) ;
V_203 . V_196 = V_197 ;
memcpy ( & V_203 . V_106 , & V_75 . V_106 , V_203 . V_109 ) ;
return F_113 ( V_4 , & V_203 , V_73 ) ;
}
...
static T_1 F_119 ( struct V_3 * V_4 ,
const char T_2 * V_71 ,
int V_72 , int V_73 )
{
struct V_102 V_75 ;
...
F_116 ( V_25 -> V_5 -> V_19 , (struct V_105 * ) & V_25 -> V_106 ) ;
...
static void F_121 ( struct V_3 * V_205 , struct V_3 * V_206 )
{
if ( V_205 < V_206 ) {
F_5 ( & V_205 -> V_9 ) ;
F_122 ( & V_206 -> V_9 , V_207 ) ;
} else {
F_5 ( & V_206 -> V_9 ) ;
F_122 ( & V_205 -> V_9 , V_207 ) ;
}
}
static void F_123 ( struct V_3 * V_205 , struct V_3 * V_206 )
{
if ( V_205 < V_206 ) {
F_8 ( & V_206 -> V_9 ) ;
F_8 ( & V_205 -> V_9 ) ;
...
static void F_124 ( struct V_1 * V_5 , struct V_3 * V_4 )
{
struct V_16 * V_46 , * V_101 ;
F_50 (uevent, tmp, &ctx->file->event_list, list)
if ( V_46 -> V_5 == V_5 )
...
static T_1 F_125 ( struct V_3 * V_208 ,
const char T_2 * V_71 ,
int V_72 , int V_73 )
{
struct V_209 V_75 ;
...
if ( F_39 ( & V_75 , V_71 , sizeof( V_75 ) ) )
return - V_77 ;
V_212 = F_126 ( V_75 . V_211 ) ;
if ( ! V_212 . V_4 )
return - V_7 ;
V_5 = F_4 ( V_212 . V_4 -> V_32 , V_75 . V_2 ) ;
if ( F_6 ( V_5 ) ) {
V_60 = F_47 ( V_5 ) ;
goto V_214;
}
...
static T_1 F_128 ( struct V_4 * V_78 , const char T_2 * V_215 ,
T_3 V_216 , T_4 * V_217 )
{
...
if ( ! F_129 ( V_78 ) ) {
F_130 ( L_2 ,
F_131 ( V_96 ) , V_96 -> V_220 ) ;
return - V_221 ;
}
if ( V_216 < sizeof( V_219 ) )
return - V_8 ;
if ( F_39 ( & V_219 , V_215 , sizeof( V_219 ) ) )
return - V_77 ;
if ( V_219 . V_75 >= F_132 ( V_222 ) )
return - V_8 ;
if ( V_219 . V_223 + sizeof( V_219 ) > V_216 )
return - V_8 ;
if ( ! V_222 [ V_219 . V_75 ] )
return - V_162 ;
V_60 = V_222 [ V_219 . V_75 ] ( V_4 , V_215 + sizeof( V_219 ) , V_219 . V_223 , V_219 . V_67 ) ;
if ( ! V_60 )
V_60 = V_216 ;
return V_60 ;
}
static unsigned int F_133 ( struct V_4 * V_78 , struct V_224 * V_225 )
{
struct V_3 * V_4 = V_78 -> V_32 ;
unsigned int V_226 = 0 ;
V_70 ( V_78 , & V_4 -> V_70 , V_225 ) ;
if ( ! F_40 ( & V_4 -> V_69 ) )
V_226 = V_227 | V_228 ;
return V_226 ;
}
static int F_134 ( struct V_229 * V_229 , struct V_4 * V_78 )
{
struct V_3 * V_4 ;
V_4 = F_135 ( sizeof *V_4 , V_20 ) ;
if ( ! V_4 )
return - V_66 ;
V_4 -> V_58 = F_136 ( L_3 ,
V_230 ) ;
...
V_78 -> V_32 = V_4 ;
V_4 -> V_78 = V_78 ;
return F_139 ( V_229 , V_78 ) ;
}
static int F_140 ( struct V_229 * V_229 , struct V_4 * V_78 )
{
struct V_3 * V_4 = V_78 -> V_32 ;
...
static T_1 F_142 ( struct V_135 * V_231 ,
struct V_232 * V_233 ,
char * V_215 )
{
return sprintf ( V_215 , L_4 , V_234 ) ;
}
...
if ( V_60 )
return V_60 ;
V_60 = F_145 ( V_235 . V_236 , & V_237 ) ;
if ( V_60 ) {
F_35 ( L_5 ) ;
goto V_99;
}
V_238 = F_146 ( & V_239 , L_6 , V_240 ) ;
if ( ! V_238 ) {
F_35 ( L_7 ) ;
V_60 = - V_66 ;
goto V_100;
