...
V_26 = F_12 ( V_35 , V_21 -> V_37 , V_21 -> V_36 ) ;
if ( ! V_26 )
...
if ( strlen ( V_42 ) + 1 > V_21 -> V_43 ) {
F_6 ( L_11 ) ;
V_26 = - V_14 ;
goto V_15;
}
memcpy ( V_21 -> V_44 , V_42 ,
strlen ( V_42 ) + 1 ) ;
V_26 = F_16 ( ( void V_32 * ) V_18 , V_21 , V_10 ) ;
if ( V_26 )
V_26 = - V_45 ;
goto V_15;
case V_46 : {
...
int V_13 ;
struct V_49 V_50 ;
if ( ! V_21 -> V_43 || ! V_21 -> V_41 ) {
F_6 ( L_12 ) ;
V_26 = - V_14 ;
goto V_15;
}
if ( V_21 -> V_41 [ V_21 -> V_43 - 1 ] != 0 ) {
F_6 ( L_13 ) ;
V_26 = - V_14 ;
goto V_15;
}
F_7 ( V_16 , L_4 , V_21 -> V_41 ) ;
F_17 ( & V_50 , V_21 -> V_41 ) ;
V_13 = F_18 ( & V_50 ) ;
V_21 -> V_47 = V_13 ;
if ( V_13 == - 1 ) {
