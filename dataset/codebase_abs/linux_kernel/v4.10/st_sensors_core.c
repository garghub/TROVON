...
break;
V_119 += F_42 ( V_118 + V_119 , V_120 - V_119 , L_21 ,
...
T_3 F_43 ( struct V_67 * V_15 ,
struct V_116 * V_117 , char * V_118 )
{
int V_27 , V_119 = 0 , V_121 , V_122 ;
struct V_3 * V_4 = F_41 ( V_15 ) ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
F_36 ( & V_4 -> V_102 ) ;
for ( V_27 = 0 ; V_27 < V_40 ; V_27 ++ ) {
...
break;
V_121 = V_11 -> V_23 -> V_38 . V_41 [ V_27 ] . V_86 / 1000000 ;
V_122 = V_11 -> V_23 -> V_38 . V_41 [ V_27 ] . V_86 % 1000000 ;
V_119 += F_42 ( V_118 + V_119 , V_120 - V_119 , L_22 , V_121 , V_122 ) ;
}
F_38 ( & V_4 -> V_102 ) ;
V_118 [ V_119 - 1 ] = '\n' ;
return V_119 ;
