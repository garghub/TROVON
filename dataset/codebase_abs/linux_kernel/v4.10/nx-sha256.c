...
int V_37 ;
T_3 V_38 ;
T_2 V_39 = ( V_15 -> V_25 % V_40 ) ;
F_10 ( & V_4 -> V_41 , V_35 ) ;
V_34 = ( V_15 -> V_25 % V_40 ) + V_27 ;
if ( V_34 < V_40 ) {
...
V_4 -> V_7 -> V_53 / V_54 ) ;
if ( V_15 -> V_25 >= V_40 ) {
memcpy ( V_10 -> V_44 . V_45 . V_61 , V_15 -> V_16 , V_47 ) ;
F_11 ( V_10 ) &= ~ V_48 ;
F_11 ( V_10 ) |= V_49 ;
} else {
F_11 ( V_10 ) &= ~ V_48 ;
...
V_10 -> V_44 . V_45 . V_66 = ( T_2 ) ( V_15 -> V_25 * 8 ) ;
V_27 = V_15 -> V_25 & ( V_40 - 1 ) ;
V_59 = F_13 ( V_4 -> V_59 , ( T_1 * ) V_15 -> V_42 ,
& V_27 , V_38 ) ;
if ( V_27 != ( V_15 -> V_25 & ( V_40 - 1 ) ) ) {
V_36 = - V_57 ;
goto V_43;
}
V_27 = V_47 ;
V_31 = F_13 ( V_4 -> V_31 , V_43 , & V_27 , V_38 ) ;
if ( V_27 != V_47 ) {
V_36 = - V_57 ;
goto V_43;
}
...
static int F_20 ( struct V_12 * V_13 , const void * V_68 )
{
struct V_14 * V_15 = F_7 ( V_13 ) ;
memcpy ( V_15 , V_68 , sizeof( * V_15 ) ) ;
return 0 ;
}
