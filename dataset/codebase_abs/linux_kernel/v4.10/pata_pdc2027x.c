...
static int F_31 ( struct V_69 * V_4 , unsigned int V_79 )
{
long V_78 ;
V_78 = F_28 ( V_4 ) ;
F_32 ( V_4 -> V_53 , L_30 , V_78 / 1000 ) ;
F_22 ( V_4 , V_78 , V_79 ) ;
return 0 ;
}
static void F_33 ( struct V_96 * V_97 , void T_1 * V_98 )
{
V_97 -> V_99 =
V_97 -> V_100 = V_98 ;
V_97 -> V_101 =
V_97 -> V_102 = V_98 + 0x05 ;
V_97 -> V_103 = V_98 + 0x0a ;
V_97 -> V_104 = V_98 + 0x0f ;
V_97 -> V_105 = V_98 + 0x10 ;
V_97 -> V_106 = V_98 + 0x15 ;
V_97 -> V_107 = V_98 + 0x1a ;
V_97 -> V_108 =
V_97 -> V_109 = V_98 + 0x1f ;
V_97 -> V_110 =
V_97 -> V_111 = V_98 + 0x81a ;
}
static int F_34 ( struct V_112 * V_113 ,
const struct V_114 * V_115 )
{
static const unsigned long V_116 [] = { 0x17c0 , 0x15c0 } ;
static const unsigned long V_117 [] = { 0x1000 , 0x1008 } ;
unsigned int V_79 = ( unsigned int ) V_115 -> V_118 ;
const struct V_119 * V_120 [] =
{ & V_121 [ V_79 ] , NULL } ;
struct V_69 * V_4 ;
void T_1 * V_70 ;
int V_122 , V_54 ;
F_35 ( & V_113 -> V_53 , V_123 ) ;
V_4 = F_36 ( & V_113 -> V_53 , V_120 , 2 ) ;
if ( ! V_4 )
return - V_124 ;
V_54 = F_37 ( V_113 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_38 ( V_113 , 1 << V_6 , V_125 ) ;
if ( V_54 )
return V_54 ;
V_4 -> V_5 = F_39 ( V_113 ) ;
V_54 = F_40 ( & V_113 -> V_53 , V_126 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_41 ( & V_113 -> V_53 , V_126 ) ;
if ( V_54 )
return V_54 ;
V_70 = V_4 -> V_5 [ V_6 ] ;
for ( V_122 = 0 ; V_122 < 2 ; V_122 ++ ) {
struct V_1 * V_2 = V_4 -> V_127 [ V_122 ] ;
F_33 ( & V_2 -> V_128 , V_70 + V_116 [ V_122 ] ) ;
V_2 -> V_128 . V_129 = V_70 + V_117 [ V_122 ] ;
F_42 ( V_2 , V_6 , - 1 , L_31 ) ;
F_42 ( V_2 , V_6 , V_116 [ V_122 ] , L_32 ) ;
}
if ( F_31 ( V_4 , V_79 ) != 0 )
return - V_130 ;
F_43 ( V_113 ) ;
return F_44 ( V_4 , V_113 -> V_131 , V_132 ,
V_133 , & V_134 ) ;
}
static int F_45 ( struct V_112 * V_113 )
{
struct V_69 * V_4 = F_46 ( V_113 ) ;
unsigned int V_79 ;
int V_54 ;
V_54 = F_47 ( V_113 ) ;
if ( V_54 )
