...
{
struct V_189 * V_189 = V_168 -> V_190 ;
struct V_96 * V_16 = F_112 ( V_189 ) ;
struct V_8 * V_9 = NULL ;
int V_191 ;
int * V_192 ;
if ( ! F_113 ( V_16 ) )
return;
if ( F_114 ( V_189 ) )
V_9 = F_115 ( V_16 , V_193 ) ;
if ( ! V_9 )
V_9 = & V_16 -> V_9 ;
V_191 = V_58 -> V_158 ;
if ( V_9 -> V_175 )
V_191 = V_18 ( V_191 , 32 >> ( V_194 - 10 ) ) ;
F_116 () ;
V_192 = F_117 ( & V_195 ) ;
if ( F_38 ( V_58 -> V_185 >= V_191 ) )
* V_192 = 0 ;
else if ( F_38 ( * V_192 >= V_196 ) ) {
* V_192 = 0 ;
V_191 = 0 ;
}
V_192 = F_117 ( & V_197 ) ;
if ( * V_192 > 0 && V_58 -> V_185 < V_191 ) {
unsigned long V_198 ;
V_198 = V_18 ( * V_192 , V_191 - V_58 -> V_185 ) ;
* V_192 -= V_198 ;
V_58 -> V_185 += V_198 ;
}
F_118 () ;
...
void T_1 * V_74 , T_2 * V_199 , T_3 * V_76 )
{
F_122 ( V_72 , V_73 , V_74 , V_199 , V_76 ) ;
return 0 ;
}
void F_123 ( unsigned long V_94 )
{
struct V_200 * V_201 = (struct V_200 * ) V_94 ;
int V_25 = F_20 ( V_68 ) +
F_20 ( V_69 ) ;
struct V_8 * V_9 ;
if ( ! F_124 ( & V_201 -> V_96 ) )
...
void F_129 ( struct V_96 * V_203 )
{
F_39 ( & V_203 -> V_204 , V_85 + V_188 ) ;
}
void F_130 ( void )
{
struct V_96 * V_16 ;
...
F_25 ( & V_205 , & V_206 ) ;
V_3 -> V_61 = V_206 ;
V_196 = V_206 / ( F_132 () * 32 ) ;
if ( V_196 < 16 )
V_196 = 16 ;
}
static int F_133 ( unsigned int V_207 )
{
F_33 () ;
return 0 ;
}
void T_6 F_134 ( void )
{
F_135 ( F_48 ( & V_22 , V_193 ) ) ;
F_136 ( V_208 , L_1 ,
F_133 , NULL ) ;
F_136 ( V_209 , L_2 , NULL ,
F_133 ) ;
}
...
PAGECACHE_TAG_DIRTY) {
if ( V_214 . V_217 > V_211 )
break;
F_141 ( & V_168 -> V_218 , & V_214 ,
V_219 ) ;
V_212 ++ ;
if ( ( V_212 % F_138 ) != 0 )
continue;
V_215 = F_142 ( V_215 , & V_214 ) ;
F_143 ( & V_168 -> V_216 ) ;
F_144 () ;
F_139 ( & V_168 -> V_216 ) ;
}
...
V_217 = V_221 -> V_233 >> V_194 ;
V_211 = V_221 -> V_234 >> V_194 ;
if ( V_221 -> V_233 == 0 && V_221 -> V_234 == V_235 )
V_230 = 1 ;
V_229 = 1 ;
}
if ( V_221 -> V_236 == V_237 || V_221 -> V_238 )
V_231 = V_219 ;
else
V_231 = V_239 ;
V_240:
if ( V_221 -> V_236 == V_237 || V_221 -> V_238 )
F_137 ( V_168 , V_217 , V_211 ) ;
V_228 = V_217 ;
while ( ! V_223 && ( V_217 <= V_211 ) ) {
int V_37 ;
V_25 = F_147 ( & V_225 , V_168 , & V_217 , V_231 ,
V_18 ( V_211 - V_217 , ( T_7 ) V_241 - 1 ) + 1 ) ;
if ( V_25 == 0 )
break;
for ( V_37 = 0 ; V_37 < V_25 ; V_37 ++ ) {
struct V_242 * V_242 = V_225 . V_162 [ V_37 ] ;
if ( V_242 -> V_217 > V_211 ) {
V_223 = 1 ;
break;
}
V_228 = V_242 -> V_217 ;
F_148 ( V_242 ) ;
if ( F_38 ( V_242 -> V_168 != V_168 ) ) {
V_243:
F_149 ( V_242 ) ;
continue;
}
...
if ( ! F_153 ( V_242 ) )
goto V_243;
F_154 ( V_221 , F_112 ( V_168 -> V_190 ) ) ;
V_77 = (* V_222)( V_242 , V_221 , V_94 ) ;
if ( F_38 ( V_77 ) ) {
if ( V_77 == V_245 ) {
F_149 ( V_242 ) ;
V_77 = 0 ;
...
if ( V_221 -> V_232 || ( V_230 && V_221 -> V_246 > 0 ) )
V_168 -> V_227 = V_228 ;
return V_77 ;
}
static int F_156 ( struct V_242 * V_242 , struct V_220 * V_221 ,
void * V_94 )
{
struct V_167 * V_168 = V_94 ;
int V_77 = V_168 -> V_247 -> V_222 ( V_242 , V_221 ) ;
F_157 ( V_168 , V_77 ) ;
return V_77 ;
}
...
struct V_248 V_249 ;
int V_77 ;
if ( ! V_168 -> V_247 -> V_222 )
return 0 ;
F_159 ( & V_249 ) ;
V_77 = F_145 ( V_168 , V_221 , F_156 , V_168 ) ;
F_160 ( & V_249 ) ;
return V_77 ;
}
int F_161 ( struct V_167 * V_168 , struct V_220 * V_221 )
{
int V_77 ;
if ( V_221 -> V_246 <= 0 )
return 0 ;
if ( V_168 -> V_247 -> V_250 )
V_77 = V_168 -> V_247 -> V_250 ( V_168 , V_221 ) ;
else
V_77 = F_158 ( V_168 , V_221 ) ;
return V_77 ;
}
int F_162 ( struct V_242 * V_242 , int V_251 )
{
struct V_167 * V_168 = V_242 -> V_168 ;
int V_77 = 0 ;
struct V_220 V_221 = {
. V_236 = V_237 ,
. V_246 = 1 ,
...
if ( F_153 ( V_242 ) ) {
F_164 ( V_242 ) ;
V_77 = V_168 -> V_247 -> V_222 ( V_242 , & V_221 ) ;
if ( V_77 == 0 && V_251 ) {
F_152 ( V_242 ) ;
if ( F_165 ( V_242 ) )
V_77 = - V_252 ;
...
int F_167 ( struct V_242 * V_242 )
{
if ( ! F_150 ( V_242 ) )
return ! F_168 ( V_242 ) ;
return 0 ;
}
void F_169 ( struct V_242 * V_242 , struct V_167 * V_168 )
{
struct V_189 * V_189 = V_168 -> V_190 ;
F_170 ( V_242 , V_168 ) ;
if ( F_171 ( V_168 ) ) {
...
void F_179 ( struct V_242 * V_242 , struct V_167 * V_168 ,
struct V_8 * V_9 )
{
if ( F_171 ( V_168 ) ) {
F_180 ( V_242 , V_253 ) ;
...
int F_185 ( struct V_242 * V_242 )
{
F_186 ( V_242 ) ;
if ( ! F_168 ( V_242 ) ) {
struct V_167 * V_168 = F_187 ( V_242 ) ;
unsigned long V_59 ;
if ( ! V_168 ) {
F_188 ( V_242 ) ;
return 1 ;
}
F_189 ( & V_168 -> V_216 , V_59 ) ;
F_135 ( F_187 ( V_242 ) != V_168 ) ;
F_77 ( ! F_190 ( V_242 ) && ! F_191 ( V_242 ) ) ;
F_169 ( V_242 , V_168 ) ;
F_192 ( & V_168 -> V_218 , F_193 ( V_242 ) ,
V_239 ) ;
F_194 ( & V_168 -> V_216 , V_59 ) ;
F_188 ( V_242 ) ;
if ( V_168 -> V_190 ) {
F_195 ( V_168 -> V_190 , V_256 ) ;
}
return 1 ;
}
F_188 ( V_242 ) ;
...
int F_199 ( struct V_220 * V_221 , struct V_242 * V_242 )
{
int V_77 ;
V_221 -> V_258 ++ ;
V_77 = F_185 ( V_242 ) ;
...
int F_200 ( struct V_242 * V_242 )
{
struct V_167 * V_168 = F_187 ( V_242 ) ;
V_242 = F_201 ( V_242 ) ;
if ( F_202 ( V_168 ) ) {
int (* F_203)( struct V_242 * ) = V_168 -> V_247 -> F_200 ;
if ( F_204 ( V_242 ) )
F_205 ( V_242 ) ;
#ifdef F_206
if ( ! F_203 )
...
int F_212 ( struct V_242 * V_242 )
{
struct V_167 * V_168 = F_187 ( V_242 ) ;
int V_77 ;
F_186 ( V_242 ) ;
if ( V_168 && F_213 ( V_168 ) ) {
struct V_189 * V_189 = V_168 -> V_190 ;
struct V_96 * V_16 = F_112 ( V_189 ) ;
unsigned long V_59 ;
F_189 ( & V_168 -> V_216 , V_59 ) ;
...
V_260 ) ;
if ( F_216 ( V_16 ) ) {
struct V_8 * V_9 = F_173 ( V_189 ) ;
F_217 ( V_9 , V_166 ) ;
F_40 ( V_9 ) ;
}
}
if ( V_168 -> V_190 && ! F_218 ( V_168 ,
V_260 ) )
F_219 ( V_168 -> V_190 ) ;
F_194 ( & V_168 -> V_216 , V_59 ) ;
} else {
...
int F_221 ( struct V_242 * V_242 , bool V_263 )
{
struct V_167 * V_168 = F_187 ( V_242 ) ;
int V_77 ;
F_186 ( V_242 ) ;
...
V_260 ) ;
if ( F_216 ( V_16 ) )
F_41 ( F_173 ( V_189 ) , V_166 ) ;
if ( V_168 -> V_190 && ! V_264 )
F_223 ( V_168 -> V_190 ) ;
}
if ( ! F_150 ( V_242 ) )
F_215 ( & V_168 -> V_218 ,
...
int F_218 ( struct V_167 * V_168 , int V_231 )
{
return F_225 ( & V_168 -> V_218 , V_231 ) ;
}
void F_226 ( struct V_242 * V_242 )
{
if ( F_227 ( F_112 ( V_242 -> V_168 -> V_190 ) ) )
F_152 ( V_242 ) ;
}
