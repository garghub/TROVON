...
static T_6 void F_155 ( struct V_117 * V_118 )
{
struct V_40 * V_41 = F_87 ( & V_6 [ V_7 ] ) ;
F_154 ( V_41 ) ;
if ( F_34 ( V_45 ) && V_41 -> V_11 )
...
static void F_158 ( unsigned long V_120 )
{
F_159 ( (struct V_114 * ) V_120 ) ;
}
signed long T_7 F_160 ( signed long V_121 )
{
struct V_26 V_27 ;
unsigned long V_122 ;
switch ( V_121 )
...
F_98 ( & V_27 , V_122 , false ) ;
F_161 () ;
F_165 ( & V_27 ) ;
F_67 ( & V_27 ) ;
V_121 = V_122 - V_25 ;
V_124:
return V_121 < 0 ? 0 : V_121 ;
}
signed long T_7 F_166 ( signed long V_121 )
{
F_167 ( V_127 ) ;
return F_160 ( V_121 ) ;
}
signed long T_7 F_168 ( signed long V_121 )
{
F_167 ( V_128 ) ;
return F_160 ( V_121 ) ;
}
signed long T_7 F_169 ( signed long V_121 )
{
F_167 ( V_129 ) ;
return F_160 ( V_121 ) ;
}
signed long T_7 F_170 ( signed long V_121 )
{
F_167 ( V_130 ) ;
return F_160 ( V_121 ) ;
}
...
V_131 = F_85 ( & V_6 [ V_132 ] , V_5 ) ;
V_83 = F_174 ( & V_6 [ V_132 ] ) ;
F_129 ( & V_83 -> V_79 ) ;
F_175 ( & V_131 -> V_79 , V_134 ) ;
F_99 ( V_131 -> V_86 ) ;
for ( V_95 = 0 ; V_95 < V_135 ; V_95 ++ )
F_171 ( V_83 , V_131 -> V_43 + V_95 ) ;
F_101 ( & V_131 -> V_79 ) ;
F_128 ( & V_83 -> V_79 ) ;
F_176 ( & V_6 ) ;
}
...
void F_183 ( unsigned int V_136 )
{
unsigned long V_121 = F_184 ( V_136 ) + 1 ;
while ( V_121 )
V_121 = F_169 ( V_121 ) ;
}
unsigned long F_185 ( unsigned int V_136 )
{
unsigned long V_121 = F_184 ( V_136 ) + 1 ;
while ( V_121 && ! F_186 ( V_52 ) )
V_121 = F_166 ( V_121 ) ;
return F_187 ( V_121 ) ;
}
void T_7 F_188 ( unsigned long V_137 , unsigned long V_138 )
{
T_9 exp = F_189 ( F_190 () , V_137 ) ;
T_5 V_36 = ( T_5 ) ( V_138 - V_137 ) * V_139 ;
for (; ; ) {
F_167 ( V_129 ) ;
if ( ! F_191 ( & exp , V_36 , V_140 ) )
break;
}
}
