...
V_213 -> V_212 . V_234 = V_143 -> V_235 ;
V_213 -> V_212 . V_236 = V_213 -> V_211 . V_212 ;
V_213 -> V_212 . V_237 = F_88 ;
F_102 ( & V_213 -> V_212 , L_5 , V_213 -> V_214 ) ;
if ( F_103 ( & V_213 -> V_212 ) )
goto V_238;
if ( F_104 ( & V_213 -> V_212 , & V_239 ) )
goto V_240;
F_105 ( V_143 , & V_241 , V_213 ) ;
return;
V_240:
F_106 ( & V_213 -> V_212 ) ;
V_238:
...
static void F_107 ( struct V_223 * V_143 , void * V_242 )
{
struct V_210 * V_213 = V_242 ;
if ( ! V_213 )
return;
F_106 ( & V_213 -> V_212 ) ;
}
