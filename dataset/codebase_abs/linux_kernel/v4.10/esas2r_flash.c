...
{
V_10 -> V_17 = V_25 ;
if ( F_10 ( V_36 , & V_8 -> V_37 ) )
;
else
F_4 ( V_8 , V_10 ) ;
return V_10 -> V_17 == V_25 ;
}
static void F_11 ( struct V_7 * V_8 , struct V_38 * V_39 )
{
...
F_12 ( V_45 -> V_49 ) ) ;
V_47 -> V_50 = F_13 ( V_8 -> V_51 -> V_52 ) ;
if ( V_45 -> V_53 ) {
T_1 * V_54 =
( ( T_1 * ) V_45 + F_12 ( V_45 -> V_53 ) ) ;
* ( ( T_2 * ) & V_54 [ 10 ] ) =
F_14 ( F_15 ( V_8 -> V_51 -> V_55 ,
V_8 -> V_51 -> V_56 ) ) ;
V_54 [ 9 ] -= F_2 ( V_54 ,
32 , 0 ) ;
}
...
static void F_16 ( struct V_7 * V_8 , struct V_38 * V_39 )
{
...
static T_2 F_24 ( T_1 * V_111 , T_2 V_30 , T_2 * V_95 )
{
...
static T_1 F_26 ( T_1 * V_118 , T_2 V_30 )
{
struct V_119 * V_120 = (struct V_119 * ) V_118 ;
T_3 V_121 = F_12 ( V_120 -> V_49 ) ;
struct V_46 * V_47 ;
...
static T_3 F_27 ( struct V_14 * V_15 )
{
struct V_38 * V_39 = V_15 -> V_39 ;
T_3 V_4 ;
T_2 V_2 ;
...
if ( V_41 -> V_30 == 0 )
break;
if ( F_26 ( ( T_1 * ) V_39 + V_41 -> V_48 , V_41 -> V_30 )
!= type )
V_135 = true ;
break;
case V_90 :
...
if ( ! F_24 ( ( T_1 * ) V_39 + V_41 -> V_48 + V_41 -> V_30 ,
V_41 -> V_30 , NULL ) )
V_135 = true ;
break;
default:
...
bool F_30 ( struct V_7 * V_8 ,
struct V_144 * V_145 ,
struct V_9 * V_10 ,
struct V_28 * V_21 )
{
T_1 V_148 = ( T_1 ) F_31 ( V_149 ) ;
...
static bool F_34 ( struct V_7 * V_8 , T_2 V_170 )
{
T_2 V_171 ;
T_2 V_172 ;
T_2 V_173 ;
...
if ( V_170 == V_175 )
F_35 ( V_8 ) ;
F_36 ( V_8 , V_176 , V_170 ) ;
V_171 = F_37 ( V_177 ) ;
if ( F_10 ( V_178 , & V_8 -> V_37 ) ||
F_10 ( V_179 , & V_8 -> V_37 ) )
V_172 = 40000 ;
else
V_172 = 5000 ;
while ( true ) {
V_173 = F_38 ( V_8 , V_180 ) ;
if ( V_173 & V_181 ) {
V_174 =
F_38 ( V_8 , V_182 ) ;
F_36 ( V_8 , V_182 ,
...
V_194 = ( T_3 * ) V_193 + 2 ;
if ( ! F_43 ( V_8 , V_193 , V_93 - V_113 , V_113 ) )
goto V_195;
while ( V_112 >= V_194 ) {
V_112 -- ;
type = F_12 ( * V_112 ) ;
...
continue;
if ( type == V_117 )
V_8 -> V_95 = F_25 ( * ( T_2 * ) V_112 ) ;
break;
}
V_195:
return F_22 ( V_8 ) ;
}
bool F_22 ( struct V_7 * V_8 )
{
T_3 V_196 = F_47 ( V_8 -> V_95 ) ;
T_1 V_197 = F_48 ( F_49 ( V_8 -> V_95 ) ) ;
T_1 V_198 = F_50 ( F_49 ( V_8 -> V_95 ) ) ;
if ( V_197 == 0
|| V_198 == 0
|| V_197 > 31
|| V_198 > 12
...
bool F_52 ( struct V_7 * V_8 )
{
bool V_208 ;
if ( F_53 ( & V_8 -> V_209 ) )
return false ;
if ( ! F_43 ( V_8 , V_8 -> V_210 , V_211 ,
sizeof( struct V_212 ) ) ) {
F_41 ( L_12 ) ;
return false ;
}
...
bool F_58 ( struct V_7 * V_8 , struct V_9 * V_10 ,
struct V_212 * V_210 )
{
...
V_214 -> V_219 = V_220 ;
V_214 -> V_96 = V_217 ;
V_214 -> V_57 = V_214 -> V_57 - F_59 ( V_214 ) ;
...
V_211 ,
sizeof( struct V_212 ) ) ;
if ( F_10 ( V_221 , & V_8 -> V_37 ) ) {
V_12 -> V_33 . V_34 [ 0 ] . V_30 =
F_14 ( V_222 |
sizeof( struct V_212 ) ) ;
V_12 -> V_33 . V_34 [ 0 ] . V_223 = F_61 (
V_8 -> V_224 + ( V_225 ) ( ( T_1 * ) V_214 - V_8 -> V_226 ) ) ;
} else {
V_12 -> V_33 . V_227 [ 0 ] . V_228 =
F_14 ( sizeof( struct V_212 ) ) ;
V_12 -> V_33 . V_227 [ 0 ] . V_223 = F_61 (
V_8 -> V_224
...
* V_214 = V_230 ;
V_214 -> V_218 [ 3 ] |= 0x0F ;
V_214 -> V_218 [ 4 ] = F_50 ( F_47 ( time ) ) ;
V_214 -> V_218 [ 5 ] = F_48 ( F_47 ( time ) ) ;
...
bool F_64 ( struct V_7 * V_8 , struct V_38 * V_39 ,
struct V_9 * V_10 , struct V_28 * V_21 )
{
struct V_14 * V_15 = & V_8 -> V_234 ;
T_1 V_235 ;
struct V_40 * V_41 ;
if ( F_65 ( V_70 , & V_8 -> V_37 ) ) {
V_39 -> V_65 = V_236 ;
return false ;
}
...
break;
default:
return F_17 ( V_8 , V_10 , V_67 ) ;
}
if ( F_10 ( V_36 , & V_8 -> V_37 ) )
return F_17 ( V_8 , V_10 , V_241 ) ;
switch ( V_39 -> V_242 ) {
case V_243 :
if ( ! F_28 ( V_8 , V_15 ) )
return F_17 ( V_8 , V_10 , V_39 -> V_65 ) ;
V_41 = & V_39 -> V_42 [ V_43 ] ;
if ( V_41 -> V_30 )
F_11 ( V_8 , V_39 ) ;
V_41 = & V_39 -> V_42 [ V_58 ] ;
...
V_39 -> V_42 [ V_90 ] . V_65 =
V_82 ;
return F_17 ( V_8 , V_10 , V_99 ) ;
}
case V_246 :
default:
return F_17 ( V_8 , V_10 , V_247 ) ;
}
if ( ! F_9 ( V_8 , V_10 ) )
return F_17 ( V_8 , V_10 , V_102 ) ;
F_33 ( V_8 , V_10 ) ;
return true ;
}
