...
static int F_273 ( struct V_18 * V_19 , struct V_259 * V_260 )
{
F_175 () ;
return 0 ;
}
...
F_309 ( V_74 , true ) ;
V_302 = F_274 ( V_19 , V_74 , ( ( V_19 -> V_62 & V_309 )
&& ( V_19 -> V_62 & V_276 ) ) ) ;
...
T_12 F_360 ( struct V_7 * V_8 , struct V_250 * V_251 ,
struct V_18 * V_19 ,
struct V_64 * V_65 ,
...
V_310 [ 0 ] = ( unsigned long ) V_251 ;
V_310 [ 1 ] = V_50 >> F_35 ( V_8 ) ;
}
V_311 = F_361 ( ( T_12 * ) & V_310 , sizeof( V_310 ) / sizeof( T_12 ) , 0 ) ;
return V_311 & ( V_226 - 1 ) ;
}
T_12 F_360 ( struct V_7 * V_8 , struct V_250 * V_251 ,
struct V_18 * V_19 ,
struct V_64 * V_65 ,
...
int F_362 ( struct V_250 * V_251 , struct V_18 * V_19 ,
...
V_65 = V_19 -> V_20 -> V_66 ;
V_164 = F_34 ( V_8 , V_19 , V_50 ) ;
V_311 = F_360 ( V_8 , V_251 , V_19 , V_65 , V_164 , V_50 ) ;
F_364 ( & V_227 [ V_311 ] ) ;
V_262 = F_283 ( V_264 ) ;
if ( F_287 ( V_262 ) ) {
...
long F_369 ( struct V_250 * V_251 , struct V_18 * V_19 ,
struct V_74 * * V_317 , struct V_18 * * V_318 ,
unsigned long * V_319 , unsigned long * V_102 ,
long V_101 , unsigned int V_70 )
{
unsigned long V_320 ;
unsigned long V_321 = * V_319 ;
unsigned long V_322 = * V_102 ;
struct V_7 * V_8 = F_38 ( V_19 ) ;
while ( V_321 < V_19 -> V_258 && V_322 ) {
T_9 * V_265 ;
T_11 * V_286 = NULL ;
int V_323 ;
struct V_74 * V_74 ;
...
V_265 = F_296 ( V_251 , V_321 & F_313 ( V_8 ) ) ;
if ( V_265 )
V_286 = F_298 ( V_8 , V_251 , V_265 ) ;
V_323 = ! V_265 || F_287 ( F_283 ( V_265 ) ) ;
if ( V_323 && ( V_70 & V_324 ) &&
! F_347 ( V_8 , V_19 , V_321 ) ) {
if ( V_265 )
F_2 ( V_286 ) ;
V_322 = 0 ;
break;
}
if ( V_323 || F_371 ( F_283 ( V_265 ) ) ||
( ( V_70 & V_325 ) &&
! F_365 ( F_283 ( V_265 ) ) ) ) {
int V_13 ;
if ( V_265 )
F_2 ( V_286 ) ;
V_13 = F_362 ( V_251 , V_19 , V_321 ,
( V_70 & V_325 ) ? V_307 : 0 ) ;
if ( ! ( V_13 & V_326 ) )
continue;
V_322 = 0 ;
...
V_320 = ( V_321 & ~ F_313 ( V_8 ) ) >> V_184 ;
V_74 = F_307 ( F_283 ( V_265 ) ) ;
V_327:
if ( V_317 ) {
V_317 [ V_101 ] = F_372 ( V_74 , V_320 ) ;
F_308 ( V_317 [ V_101 ] ) ;
}
if ( V_318 )
V_318 [ V_101 ] = V_19 ;
...
* V_102 = V_322 ;
* V_319 = V_321 ;
return V_101 ? V_101 : - V_328 ;
}
unsigned long F_373 ( struct V_18 * V_19 ,
unsigned long V_50 , unsigned long V_256 , T_13 V_329 )
{
struct V_250 * V_251 = V_19 -> V_285 ;
...
F_376 ( V_19 , V_255 , V_256 ) ;
F_306 ( V_251 , V_255 , V_256 ) ;
F_333 ( V_19 -> V_20 -> V_66 ) ;
F_311 ( V_251 , V_255 , V_256 ) ;
return V_317 << V_8 -> V_100 ;
}
int F_377 ( struct V_16 * V_16 ,
long V_35 , long V_33 ,
struct V_18 * V_19 ,
T_14 V_62 )
{
...
long F_378 ( struct V_16 * V_16 , long V_255 , long V_256 ,
long V_332 )
{
struct V_7 * V_8 = F_30 ( V_16 ) ;
...
F_9 ( & V_16 -> V_299 ) ;
V_16 -> V_300 -= ( F_351 ( V_8 ) * V_332 ) ;
F_2 ( & V_16 -> V_299 ) ;
V_257 = F_12 ( V_2 , ( V_41 - V_332 ) ) ;
F_3 ( V_8 , - V_257 ) ;
return 0 ;
}
static unsigned long F_379 ( struct V_18 * V_333 ,
struct V_18 * V_19 ,
unsigned long V_147 , T_1 V_164 )
{
unsigned long V_334 = ( ( V_164 - V_333 -> V_52 ) << V_184 ) +
V_333 -> V_51 ;
unsigned long V_335 = V_334 & V_336 ;
unsigned long V_337 = V_335 + V_338 ;
unsigned long V_62 = V_19 -> V_62 & V_339 ;
unsigned long V_340 = V_333 -> V_62 & V_339 ;
if ( F_380 ( V_147 ) != F_380 ( V_334 ) ||
V_62 != V_340 ||
V_335 < V_333 -> V_51 || V_333 -> V_258 < V_337 )
return 0 ;
return V_334 ;
}
static bool F_381 ( struct V_18 * V_19 , unsigned long V_147 )
{
unsigned long V_341 = V_147 & V_336 ;
unsigned long V_256 = V_341 + V_338 ;
if ( V_19 -> V_62 & V_63 &&
V_19 -> V_51 <= V_341 && V_256 <= V_19 -> V_258 )
return true ;
return false ;
}
T_9 * F_382 ( struct V_250 * V_251 , unsigned long V_147 , T_15 * V_342 )
{
struct V_18 * V_19 = F_383 ( V_251 , V_147 ) ;
struct V_64 * V_65 = V_19 -> V_20 -> V_66 ;
...
T_11 * V_286 ;
if ( ! F_381 ( V_19 , V_147 ) )
return ( T_9 * ) F_384 ( V_251 , V_342 , V_147 ) ;
F_331 ( V_65 ) ;
F_332 (svma, &mapping->i_mmap, idx, idx) {
if ( V_333 == V_19 )
continue;
V_334 = F_379 ( V_333 , V_19 , V_147 , V_164 ) ;
if ( V_334 ) {
V_343 = F_296 ( V_333 -> V_285 , V_334 ) ;
if ( V_343 ) {
F_308 ( F_198 ( V_343 ) ) ;
break;
}
...
if ( ! V_343 )
goto V_45;
V_286 = F_298 ( F_38 ( V_19 ) , V_251 , V_343 ) ;
if ( F_385 ( * V_342 ) ) {
F_386 ( V_251 , V_342 ,
...
F_2 ( V_286 ) ;
V_45:
V_265 = ( T_9 * ) F_384 ( V_251 , V_342 , V_147 ) ;
F_333 ( V_65 ) ;
return V_265 ;
}
int F_316 ( struct V_250 * V_251 , unsigned long * V_147 , T_9 * V_264 )
{
T_16 * V_346 = F_388 ( V_251 , * V_147 ) ;
T_15 * V_342 = F_389 ( V_346 , * V_147 ) ;
...
F_138 ( F_198 ( V_264 ) ) ;
F_391 ( V_251 ) ;
* V_147 = F_104 ( * V_147 , V_221 * V_347 ) - V_221 ;
return 1 ;
}
T_9 * F_382 ( struct V_250 * V_251 , unsigned long V_147 , T_15 * V_342 )
{
...
T_15 * V_342 ;
T_9 * V_265 = NULL ;
V_346 = F_388 ( V_251 , V_147 ) ;
V_342 = F_392 ( V_251 , V_346 , V_147 ) ;
if ( V_342 ) {
if ( V_273 == V_338 ) {
V_265 = ( T_9 * ) V_342 ;
} else {
F_10 ( V_273 != V_348 ) ;
if ( F_393 () && F_385 ( * V_342 ) )
V_265 = F_382 ( V_251 , V_147 , V_342 ) ;
else
V_265 = ( T_9 * ) F_384 ( V_251 , V_342 , V_147 ) ;
}
}
F_10 ( V_265 && F_288 ( * V_265 ) && ! F_394 ( * V_265 ) ) ;
return V_265 ;
}
...
V_346 = F_388 ( V_251 , V_147 ) ;
if ( F_395 ( * V_346 ) ) {
V_342 = F_389 ( V_346 , V_147 ) ;
if ( F_396 ( * V_342 ) ) {
if ( F_397 ( * V_342 ) )
return ( T_9 * ) V_342 ;
V_349 = F_398 ( V_342 , V_147 ) ;
}
}
return ( T_9 * ) V_349 ;
}
struct V_74 * __weak
F_399 ( struct V_250 * V_251 , unsigned long V_50 ,
int V_242 )
{
return F_182 ( - V_202 ) ;
}
struct V_74 * __weak
F_400 ( struct V_250 * V_251 , unsigned long V_50 ,
V_344 * V_349 , int V_70 )
{
struct V_74 * V_74 = NULL ;
T_11 * V_286 ;
V_42:
V_286 = F_401 ( V_251 , V_349 ) ;
F_9 ( V_286 ) ;
if ( ! F_402 ( * V_349 ) )
goto V_45;
if ( F_403 ( * V_349 ) ) {
V_74 = F_404 ( * V_349 ) + ( ( V_50 & ~ V_350 ) >> V_184 ) ;
if ( V_70 & V_351 )
F_308 ( V_74 ) ;
} else {
if ( F_286 ( F_283 ( ( T_9 * ) V_349 ) ) ) {
F_2 ( V_286 ) ;
F_405 ( V_251 , ( T_9 * ) V_349 , V_286 ) ;
goto V_42;
}
}
V_45:
...
if ( V_70 & V_351 )
return NULL ;
return F_307 ( * ( T_9 * ) V_342 ) + ( ( V_50 & ~ V_336 ) >> V_184 ) ;
}
int F_407 ( struct V_74 * V_352 )
{
...
bool F_409 ( struct V_74 * V_74 , struct V_25 * V_181 )
{
bool V_13 = true ;
F_115 ( ! F_123 ( V_74 ) , V_74 ) ;
F_9 ( & V_126 ) ;
if ( ! F_122 ( V_74 ) || ! F_410 ( V_74 ) ) {
V_13 = false ;
goto V_353;
}
F_127 ( V_74 ) ;
F_411 ( & V_74 -> V_76 , V_181 ) ;
V_353:
F_2 ( & V_126 ) ;
return V_13 ;
}
void F_412 ( struct V_74 * V_74 )
{
F_115 ( ! F_123 ( V_74 ) , V_74 ) ;
F_9 ( & V_126 ) ;
F_125 ( V_74 ) ;
F_411 ( & V_74 -> V_76 , & ( F_130 ( V_74 ) ) -> V_80 ) ;
F_2 ( & V_126 ) ;
F_138 ( V_74 ) ;
}
