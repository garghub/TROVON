...
static int F_252 ( struct V_135 * V_56 , T_9 V_559 )
{
struct V_1 * V_2 = F_245 ( V_56 ) ;
int V_7 ;
F_36 ( & V_2 -> V_57 ) ;
...
if ( ! F_10 ( V_271 , & V_2 -> V_18 ) ) {
V_2 -> V_474 . V_560 ( V_2 ) ;
F_255 ( V_561 , & V_2 -> V_478 , 0 ) ;
F_256 ( V_2 -> V_45 ) ;
}
if ( F_229 ( V_2 -> V_45 ) && V_2 -> V_45 -> V_18 & V_562 ) {
if ( F_10 ( V_271 , & V_2 -> V_18 ) ) {
V_2 -> V_474 . V_558 ( V_2 , false ) ;
F_224 ( & V_2 -> V_97 ) ;
F_11 ( V_91 , & V_2 -> V_18 ) ;
if ( F_50 ( V_2 -> V_45 ) )
F_170 ( V_2 ) ;
...
static int F_257 ( struct V_135 * V_56 )
{
struct V_1 * V_2 = F_245 ( V_56 ) ;
F_141 ( V_271 , & V_2 -> V_18 ) ;
return F_254 ( V_56 ) ;
}
static void F_258 ( struct V_44 * V_83 , struct V_563 * V_564 )
{
struct V_1 * V_2 = F_31 ( V_83 ) ;
if ( F_35 ( V_2 -> V_56 ) < 0 )
return;
...
F_36 ( & V_2 -> V_57 ) ;
V_564 -> V_565 = V_320 ;
V_564 -> V_306 = F_183 ( V_2 ) ;
F_37 ( & V_2 -> V_57 ) ;
}
F_38 ( V_2 -> V_56 ) ;
}
static int F_259 ( struct V_44 * V_83 , struct V_563 * V_564 )
{
struct V_1 * V_2 = F_31 ( V_83 ) ;
int V_7 ;
if ( ! F_189 ( V_2 ) )
...
goto V_567;
F_36 ( & V_2 -> V_57 ) ;
F_184 ( V_2 , V_564 -> V_306 ) ;
V_2 -> V_336 = V_564 -> V_306 & V_320 ;
F_37 ( & V_2 -> V_57 ) ;
F_38 ( V_2 -> V_56 ) ;
V_567:
return V_7 ;
}
static V_21 F_260 ( struct V_44 * V_83 )
{
struct V_1 * V_2 = F_31 ( V_83 ) ;
return V_2 -> V_568 ;
}
static void F_261 ( struct V_44 * V_83 , V_21 V_3 )
{
struct V_1 * V_2 = F_31 ( V_83 ) ;
V_2 -> V_568 = V_3 ;
}
static void F_262 ( struct V_44 * V_45 ,
struct V_569 * V_570 )
{
struct V_1 * V_2 = F_31 ( V_45 ) ;
F_263 ( V_570 -> V_571 , V_572 , sizeof( V_570 -> V_571 ) ) ;
F_263 ( V_570 -> V_84 , V_573 , sizeof( V_570 -> V_84 ) ) ;
F_264 ( V_2 -> V_11 , V_570 -> V_574 , sizeof( V_570 -> V_574 ) ) ;
}
static
int F_265 ( struct V_44 * V_45 , struct V_575 * V_576 )
{
struct V_1 * V_2 = F_31 ( V_45 ) ;
int V_7 ;
if ( ! V_2 -> V_451 . V_577 )
...
goto V_304;
F_36 ( & V_2 -> V_57 ) ;
V_7 = F_266 ( & V_2 -> V_451 , V_576 ) ;
F_37 ( & V_2 -> V_57 ) ;
F_38 ( V_2 -> V_56 ) ;
V_304:
return V_7 ;
}
static int F_267 ( struct V_44 * V_83 , struct V_575 * V_576 )
{
struct V_1 * V_2 = F_31 ( V_83 ) ;
int V_7 ;
V_7 = F_35 ( V_2 -> V_56 ) ;
...
goto V_304;
F_36 ( & V_2 -> V_57 ) ;
V_7 = F_215 ( V_2 , V_576 -> V_443 , V_576 -> V_281 , V_576 -> V_444 ) ;
if ( ! V_7 ) {
V_2 -> V_443 = V_576 -> V_443 ;
V_2 -> V_281 = V_576 -> V_281 ;
V_2 -> V_444 = V_576 -> V_444 ;
}
F_37 ( & V_2 -> V_57 ) ;
F_38 ( V_2 -> V_56 ) ;
V_304:
...
static int F_268 ( struct V_44 * V_83 , int V_578 )
{
switch ( V_578 ) {
case V_579 :
return F_269 ( V_580 ) ;
...
static void F_270 ( struct V_44 * V_83 ,
...
F_38 ( V_2 -> V_56 ) ;
V_6 [ 0 ] = F_271 ( V_583 . V_107 ) ;
V_6 [ 1 ] = F_271 ( V_583 . V_238 ) ;
V_6 [ 2 ] = F_271 ( V_583 . V_105 ) ;
V_6 [ 3 ] = F_108 ( V_583 . V_585 ) ;
V_6 [ 4 ] = F_272 ( V_583 . V_586 ) ;
V_6 [ 5 ] = F_272 ( V_583 . V_587 ) ;
V_6 [ 6 ] = F_108 ( V_583 . V_588 ) ;
V_6 [ 7 ] = F_108 ( V_583 . V_589 ) ;
V_6 [ 8 ] = F_271 ( V_583 . V_590 ) ;
V_6 [ 9 ] = F_271 ( V_583 . V_591 ) ;
V_6 [ 10 ] = F_108 ( V_583 . V_592 ) ;
V_6 [ 11 ] = F_272 ( V_583 . V_593 ) ;
V_6 [ 12 ] = F_272 ( V_583 . V_594 ) ;
}
static void F_273 ( struct V_44 * V_83 , V_21 V_595 , T_3 * V_6 )
{
switch ( V_595 ) {
case V_579 :
...
static int F_274 ( struct V_1 * V_2 , struct V_596 * V_597 )
{
V_21 V_72 , V_598 , V_599 , V_565 = 0 ;
T_1 V_50 ;
V_50 = F_197 ( V_2 , V_600 , V_601 ) ;
V_565 = F_275 ( V_50 ) ;
V_50 = F_197 ( V_2 , V_374 , V_375 ) ;
V_599 = F_276 ( V_50 ) ;
V_50 = F_197 ( V_2 , V_374 , V_602 ) ;
V_598 = F_276 ( V_50 ) ;
V_72 = F_21 ( V_2 , V_30 , V_360 ) ;
V_72 &= V_366 | V_367 ;
V_597 -> V_603 = ! ! V_72 ;
V_597 -> V_604 = ! ! ( V_565 & V_599 & V_598 ) ;
V_597 -> V_565 = V_565 ;
V_597 -> V_605 = V_599 ;
V_597 -> V_606 = V_598 ;
return 0 ;
}
static int F_277 ( struct V_1 * V_2 , struct V_596 * V_597 )
{
T_1 V_50 = F_278 ( V_597 -> V_605 ) ;
F_199 ( V_2 , V_597 -> V_603 ) ;
if ( ! V_597 -> V_603 )
V_50 = 0 ;
F_198 ( V_2 , V_374 , V_375 , V_50 ) ;
return 0 ;
}
static int F_279 ( struct V_1 * V_2 , struct V_596 * V_597 )
{
V_21 V_72 , V_598 , V_599 , V_565 = 0 ;
T_1 V_50 ;
V_50 = F_25 ( V_2 , V_607 ) ;
...
static int
F_281 ( struct V_44 * V_609 , struct V_596 * V_610 )
{
...
static int F_284 ( struct V_44 * V_83 )
{
struct V_1 * V_2 = F_31 ( V_83 ) ;
int V_7 ;
V_7 = F_35 ( V_2 -> V_56 ) ;
...
static int F_287 ( struct V_44 * V_45 , struct V_617 * V_618 , int V_576 )
{
struct V_1 * V_2 = F_31 ( V_45 ) ;
struct V_619 * V_6 = F_288 ( V_618 ) ;
int V_114 ;
if ( F_10 ( V_17 , & V_2 -> V_18 ) )
return - V_19 ;
V_114 = F_35 ( V_2 -> V_56 ) ;
...
static int F_290 ( struct V_44 * V_83 , int V_627 )
{
struct V_1 * V_2 = F_31 ( V_83 ) ;
int V_7 ;
switch ( V_2 -> V_84 ) {
...
static int F_295 ( struct V_135 * V_56 ,
...
F_298 ( V_11 ) ;
V_45 = F_299 ( sizeof( struct V_1 ) ) ;
if ( ! V_45 ) {
F_300 ( & V_56 -> V_83 , L_29 ) ;
return - V_10 ;
}
F_301 ( V_45 , & V_56 -> V_83 ) ;
V_2 = F_31 ( V_45 ) ;
V_2 -> V_568 = 0x7FFF ;
V_2 -> V_11 = V_11 ;
V_2 -> V_45 = V_45 ;
...
goto V_304;
F_302 ( & V_2 -> V_57 ) ;
F_303 ( & V_2 -> V_123 , F_228 ) ;
F_303 ( & V_2 -> V_478 , F_231 ) ;
V_45 -> V_635 = & V_636 ;
V_45 -> V_637 = V_638 ;
...
V_2 -> V_451 . V_83 = V_45 ;
V_2 -> V_451 . V_577 = F_30 ;
V_2 -> V_451 . V_653 = F_32 ;
V_2 -> V_451 . V_654 = 0x3f ;
V_2 -> V_451 . V_655 = 0x1f ;
V_2 -> V_451 . V_46 = V_48 ;
switch ( V_11 -> V_281 ) {
case V_540 :
case V_656 :
...
F_46 ( V_2 ) ;
F_305 ( V_56 , V_2 ) ;
F_306 ( V_45 , & V_2 -> V_97 , F_142 , V_662 ) ;
V_7 = F_307 ( V_45 ) ;
if ( V_7 != 0 ) {
...
static void F_310 ( struct V_135 * V_56 )
{
struct V_1 * V_2 = F_245 ( V_56 ) ;
F_305 ( V_56 , NULL ) ;
if ( V_2 ) {
