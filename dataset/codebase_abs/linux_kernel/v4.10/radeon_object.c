...
int F_89 ( struct V_1 * V_2 , T_2 * V_3 , bool V_169 )
{
int V_64 ;
V_64 = F_90 ( & V_2 -> V_8 , true , V_169 , NULL ) ;
if ( F_22 ( V_64 != 0 ) )
return V_64 ;
if ( V_3 )
* V_3 = V_2 -> V_8 . V_16 . V_3 ;
V_64 = F_91 ( & V_2 -> V_8 , true , V_169 ) ;
F_92 ( & V_2 -> V_8 ) ;
return V_64 ;
}
void F_93 ( struct V_1 * V_2 , struct V_170 * V_171 ,
bool V_172 )
{
struct V_57 * V_58 = V_2 -> V_8 . V_58 ;
if ( V_172 )
F_94 ( V_58 , & V_171 -> V_140 ) ;
else
F_95 ( V_58 , & V_171 -> V_140 ) ;
}
