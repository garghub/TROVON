...
F_35 ( V_3 -> V_69 , V_3 ) ;
F_69 ( V_5 -> V_7 ) ;
V_7 = F_70 ( V_88 , V_169 , 0 ) ;
F_71 ( V_7 -> V_170 , F_72 ( V_7 ) ) ;
if ( V_53 -> V_171 ) {
F_69 ( V_53 -> V_171 ) ;
V_7 = F_70 ( V_88 , V_169 , 1 ) ;
F_71 ( V_7 -> V_170 , F_72 ( V_7 ) ) ;
}
F_73 ( V_3 ) ;
return 0 ;
...
struct V_4 * V_5 ;
struct V_1 * V_53 ;
struct V_168 * V_69 , * V_7 , * V_172 ;
unsigned long V_173 , V_174 = 0 ;
int V_61 = 0 ;
V_3 = F_75 ( sizeof( struct V_1 ) ) ;
if ( V_3 == NULL )
return - V_124 ;
F_76 ( V_3 , & V_88 -> V_3 ) ;
V_5 = F_2 ( V_3 ) ;
V_53 = F_1 ( V_3 ) ;
V_53 -> V_72 = F_77 ( & V_88 -> V_3 ) ;
F_78 ( V_88 , V_3 ) ;
V_5 -> V_175 = V_53 -> V_72 -> V_176 ;
V_69 = F_70 ( V_88 , V_177 , 0 ) ;
if ( ! V_69 ) {
F_79 ( & V_88 -> V_3 , L_17 ) ;
V_61 = - V_178 ;
goto V_179;
...
V_173 = F_72 ( V_7 ) ;
if ( V_53 -> V_72 -> V_181 )
V_5 -> V_182 = V_53 -> V_72 -> V_181 ;
else {
V_5 -> V_182 = V_53 -> V_181 ;
for ( V_61 = 0 ; V_61 < 0x18 ; V_61 ++ )
V_53 -> V_181 [ V_61 ] = ( V_173 / 0x18 ) * V_61 ;
}
if ( ! F_80 ( V_7 -> V_170 , V_173 , V_88 -> V_68 ) ) {
F_79 ( & V_88 -> V_3 , L_19 ) ;
V_61 = - V_178 ;
goto V_179;
}
V_5 -> V_7 = F_81 ( V_7 -> V_170 , V_173 ) ;
V_3 -> V_20 = ( unsigned long ) V_5 -> V_7 ;
if ( V_5 -> V_7 == NULL ) {
F_79 ( & V_88 -> V_3 , L_20 , V_7 ) ;
V_61 = - V_178 ;
goto V_183;
}
V_172 = F_70 ( V_88 , V_169 , 1 ) ;
if ( ! V_172 ) {
if ( ! V_53 -> V_72 -> V_181 ) {
for ( V_61 = 0 ; V_61 < 0x20 ; V_61 ++ )
V_53 -> V_181 [ V_61 ] = ( V_173 / 0x20 ) * V_61 ;
}
} else {
V_174 = F_72 ( V_172 ) ;
if ( ! F_80 ( V_172 -> V_170 , V_174 , V_88 -> V_68 ) ) {
F_79 ( & V_88 -> V_3 , L_19 ) ;
V_61 = - V_178 ;
goto V_184;
}
V_53 -> V_171 = F_81 ( V_172 -> V_170 , V_174 ) ;
if ( ! V_53 -> V_171 ) {
F_79 ( & V_88 -> V_3 , L_21 ) ;
V_61 = - V_178 ;
goto V_185;
...
V_185:
if ( V_172 )
F_71 ( V_172 -> V_170 , V_174 ) ;
V_184:
F_69 ( V_5 -> V_7 ) ;
V_183:
F_71 ( V_7 -> V_170 , V_173 ) ;
V_179:
F_73 ( V_3 ) ;
return V_61 ;
}
static int F_82 ( struct V_87 * V_3 , T_4 V_186 )
{
struct V_2 * V_187 = F_67 ( V_3 ) ;
struct V_1 * V_53 = F_1 ( V_187 ) ;
V_53 -> V_188 = V_53 -> V_80 ;
F_83 ( V_187 ) ;
F_36 ( V_187 ) ;
return 0 ;
}
...
{
struct V_2 * V_187 = F_67 ( V_88 ) ;
struct V_1 * V_53 = F_1 ( V_187 ) ;
F_59 ( V_187 , F_2 ( V_187 ) ) ;
