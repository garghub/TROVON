...
static void F_23 ( struct V_1 * V_2 , struct V_105 * V_106 )
{
F_24 ( V_107 ,
F_25 ( V_107 ) ,
V_106 ) ;
}
static int F_26 ( struct V_1 * V_2 , struct V_105 * V_106 )
{
unsigned int V_35 ;
...
static void F_28 ( struct V_109 * V_110 , int V_34 )
{
}
...
{
struct V_112 * V_113 = F_31 ( V_110 ) ;
F_32 ( V_110 ) ;
F_33 ( V_113 ) ;
}
static int F_34 ( struct V_109 * V_110 )
{
struct V_1 * V_2 = F_35 ( V_110 ) ;
int V_114 ;
if ( V_2 -> V_115 )
return 0 ;
V_114 = F_26 ( V_2 , V_110 -> V_45 -> V_116 ) ;
if ( V_114 )
return V_114 ;
V_2 -> V_115 = true ;
return 0 ;
...
static void F_38 ( struct V_109 * V_110 )
{
struct V_1 * V_2 = F_35 ( V_110 ) ;
F_3 ( V_2 , 0x0 , V_55 ) ;
}
static struct V_109 *
F_39 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
struct V_112 * V_110 ;
struct V_109 * V_109 ;
V_110 = F_40 ( V_2 -> V_45 , sizeof( * V_110 ) , V_118 ) ;
if ( ! V_110 )
return NULL ;
V_110 -> V_2 = V_2 ;
...
static struct V_109 * F_45 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
struct V_112 * V_110 ;
struct V_109 * V_109 ;
...
static struct V_109 * F_48 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
struct V_112 * V_110 ;
struct V_109 * V_109 ;
...
static void F_49 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
V_2 -> V_88 = F_48 ( V_45 , V_2 ) ;
V_2 -> V_91 = F_45 ( V_45 , V_2 ) ;
V_2 -> V_89 = F_39 ( V_45 , V_2 ) ;
}
...
static int F_51 ( struct V_129 * V_45 , struct V_129 * V_130 , void * V_81 )
{
struct V_1 * V_2 = F_52 ( V_45 ) ;
struct V_117 * V_131 = V_81 ;
V_2 -> V_131 = V_131 ;
F_49 ( V_131 , V_2 ) ;
return 0 ;
}
static void F_53 ( struct V_129 * V_45 , struct V_129 * V_130 ,
void * V_81 )
{
struct V_1 * V_2 = F_52 ( V_45 ) ;
F_50 ( V_2 ) ;
...
if ( ! V_83 )
return - V_138 ;
V_2 = F_40 ( V_45 , sizeof( * V_2 ) , V_118 ) ;
if ( ! V_2 )
return - V_139 ;
V_2 -> V_45 = V_45 ;
V_137 = F_56 ( V_133 , V_140 , L_49 ) ;
if ( ! V_137 ) {
F_57 ( L_50 ) ;
return - V_139 ;
}
V_2 -> V_4 = F_58 ( V_45 , V_137 -> V_141 , F_59 ( V_137 ) ) ;
if ( ! V_2 -> V_4 )
return - V_139 ;
V_2 -> V_142 = F_60 ( V_45 , L_51 ) ;
if ( ! F_61 ( V_2 -> V_142 ) )
F_62 ( V_2 -> V_142 ) ;
F_63 ( V_133 , V_2 ) ;
return F_64 ( V_45 , & V_143 ) ;
}
static int F_65 ( struct V_132 * V_133 )
{
F_66 ( & V_133 -> V_45 , & V_143 ) ;
return 0 ;
}
