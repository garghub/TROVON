...
if ( V_40 -> V_161 ) {
int V_160 ;
for ( V_160 = 0 ; V_160 < ( V_40 -> V_162 -> V_62 + V_83 ) ; V_160 ++ ) {
struct V_84 * V_84 = & V_40 -> V_85 [ V_160 ] ;
if ( ! ( V_84 -> V_86 -> V_87 . V_88 & F_26 ( V_98 | V_97 ) ) &&
( V_84 -> V_86 -> V_87 . V_88 & F_26 ( V_163 ) ) )
F_65 ( & V_84 -> V_164 ) ;
}
F_66 ( V_40 -> V_165 ) ;
}
F_67 ( V_40 ) ;
if ( V_40 -> V_166 -> V_63 == V_167 ||
V_40 -> V_166 -> V_63 == V_168 ||
V_40 -> V_166 -> V_63 == V_169 ||
V_40 -> V_166 -> V_63 == V_170 ) {
if ( V_40 -> V_171 > 1 ) {
for ( V_160 = 0 ; V_160 < V_40 -> V_171 ; V_160 ++ ) {
F_68 ( F_69 ( V_40 -> V_166 , V_160 ) ,
& ( V_40 -> V_172 [ V_160 ] ) ) ;
}
} else {
F_68 ( V_40 -> V_166 -> V_173 ,
& ( V_40 -> V_172 [ 0 ] ) ) ;
}
} else {
F_68 ( V_40 -> V_166 -> V_173 , V_40 ) ;
}
if ( V_40 -> V_142 )
F_70 ( V_40 -> V_166 ) ;
else if ( V_40 -> V_171 > 1 )
F_71 ( V_40 -> V_166 ) ;
}
static void F_72 ( void )
{
V_174 = F_73 ( 0 , L_23 , & V_175 ) ;
if ( V_174 < 0 ) {
F_74 ( L_24 ) ;
}
}
static int F_75 ( struct V_176 * V_166 , const struct V_177 * V_115 )
{
unsigned V_178 = V_115 -> V_179 ;
struct V_1 * V_2 ;
struct V_10 * V_40 ;
...
F_76 ( V_166 , V_187 | V_188 |
V_189 ) ;
error = F_77 ( V_166 ) ;
if ( error )
goto V_190;
error = - V_113 ;
if ( V_13 [ V_178 ] . V_191 & V_192 )
V_184 = F_78 ( 31 ) ;
else
V_184 = F_78 ( 32 ) ;
if ( F_79 ( V_166 , V_184 ) ||
...
goto V_193;
F_81 ( V_166 ) ;
V_2 = F_82 ( & V_194 , sizeof( struct V_10 ) ) ;
if ( ! V_2 )
goto V_193;
V_2 -> V_173 = V_166 -> V_173 ;
V_2 -> V_183 = V_183 ;
V_2 -> V_195 = 16 ;
V_2 -> V_196 = 1 ;
if ( V_174 == V_197 )
...
V_40 -> V_198 = F_83 ( V_166 , 0 ) ;
V_40 -> V_162 = V_2 ;
V_40 -> V_166 = V_166 ;
V_40 -> V_15 = V_194 . V_15 ;
V_40 -> V_115 = V_2 -> V_183 ;
V_40 -> V_14 = V_178 ;
F_84 ( & V_40 -> V_34 ) ;
V_40 -> V_85 = F_85 ( sizeof( struct V_84 ) * ( V_2 -> V_62 + V_83 ) , V_199 ) ;
if ( ! V_40 -> V_85 )
goto V_200;
F_86 ( & V_40 -> V_201 ) ;
F_87 ( & V_40 -> V_202 ) ;
V_40 -> V_203 = V_204 ;
if ( ( * V_13 [ V_178 ] . V_205 ) ( V_40 ) )
goto V_206;
if ( V_40 -> V_207 ) {
if ( V_185 )
F_25 ( V_208 L_25
...
V_40 -> V_165 = F_88 ( V_209 , V_40 , V_73 ) ;
if ( F_89 ( V_40 -> V_165 ) ) {
F_25 ( V_72 L_31 ) ;
error = F_90 ( V_40 -> V_165 ) ;
V_40 -> V_165 = NULL ;
goto V_210;
}
if ( V_13 [ V_178 ] . V_191 & V_192 )
if ( F_79 ( V_166 , F_78 ( 32 ) ) )
goto V_210;
V_40 -> V_211 = V_13 [ V_178 ] . V_212 ;
error = F_91 ( V_40 ) ;
if ( error < 0 )
goto V_210;
if ( ( V_13 [ V_178 ] . V_191 & V_213 ) &&
( V_2 -> V_214 > 34 ) ) {
V_2 -> V_214 = 34 ;
V_2 -> V_215 = ( V_2 -> V_214 * 8 ) + 112 ;
}
if ( ( V_13 [ V_178 ] . V_191 & V_216 ) &&
( V_2 -> V_214 > 17 ) ) {
V_2 -> V_214 = 17 ;
V_2 -> V_215 = ( V_2 -> V_214 * 8 ) + 112 ;
}
error = F_92 ( V_166 ,
( V_40 -> V_144 . V_217 & V_218 ) ?
( V_2 -> V_215 << 9 ) : 65536 ) ;
if ( error )
goto V_210;
if ( V_13 [ V_178 ] . V_191 & V_213 )
...
V_2 -> V_153 = V_40 -> V_211 ;
else
V_2 -> V_153 = 0 ;
F_93 ( V_40 , 0 ) ;
F_94 ( V_40 ) ;
F_95 ( & V_40 -> V_34 , V_181 ) ;
V_2 -> V_154 = V_40 -> V_59 ;
if ( V_2 -> V_154 < V_40 -> V_221 )
V_2 -> V_154 = V_40 -> V_221 ;
if ( V_2 -> V_154 < V_222 )
V_2 -> V_154 = V_222 ;
else
V_2 -> V_223 = V_2 -> V_154 ;
if ( V_13 [ V_178 ] . V_191 & V_224 )
F_96 ( V_40 , 0 , 2 , 0 , NULL ) ;
V_2 -> V_225 = V_226 ;
F_97 ( V_166 , V_2 ) ;
error = F_98 ( V_2 , & V_166 -> V_11 ) ;
if ( error )
goto V_210;
F_99 ( V_2 ) ;
F_100 ( V_166 ) ;
...
F_102 ( V_40 ) ;
if ( V_40 -> V_227 )
F_103 ( V_40 -> V_166 , V_40 -> V_228 , V_40 -> V_227 ,
V_40 -> V_229 ) ;
F_10 ( V_40 -> V_230 ) ;
F_104 ( V_40 , 0 ) ;
F_10 ( V_40 -> V_85 ) ;
...
static void F_107 ( struct V_10 * V_40 )
{
int V_160 ;
F_67 ( V_40 ) ;
if ( V_40 -> V_166 -> V_63 == V_167 ||
...
F_68 ( V_40 -> V_166 -> V_173 , & ( V_40 -> V_172 [ 0 ] ) ) ;
}
} else {
F_68 ( V_40 -> V_166 -> V_173 , V_40 ) ;
}
...
{
int V_160 , V_231 ;
int V_232 = V_11 -> V_115 ;
const char * V_15 = V_11 -> V_15 ;
unsigned long V_233 ;
while ( ! ( ( V_233 = F_109 ( V_11 , V_234 . V_235 ) ) & V_236 )
|| V_233 == 0xffffffff )
F_110 ( 20 ) ;
F_67 ( V_11 ) ;
F_111 ( V_11 ) ;
if ( ( V_11 -> V_166 -> V_63 == V_168 ||
V_11 -> V_166 -> V_63 == V_169 ||
V_11 -> V_166 -> V_63 == V_170 ) )
F_112 ( V_11 ) ;
if ( V_11 -> V_237 )
F_113 ( V_11 , V_238 ) ;
if ( ! V_11 -> V_207 && V_11 -> V_237 && V_11 -> V_171 > 1 ) {
for ( V_160 = 0 ; V_160 < V_11 -> V_171 ; V_160 ++ ) {
V_11 -> V_172 [ V_160 ] . V_239 = V_160 ;
V_11 -> V_172 [ V_160 ] . V_11 = V_11 ;
if ( F_114 ( F_69 ( V_11 -> V_166 , V_160 ) ,
V_11 -> V_240 . V_241 ,
0 , L_32 , & ( V_11 -> V_172 [ V_160 ] ) ) ) {
F_25 ( V_72 L_33 ,
V_15 , V_232 , V_160 ) ;
for ( V_231 = 0 ; V_231 < V_160 ; V_231 ++ )
F_68 ( F_69 ( V_11 -> V_166 , V_231 ) ,
& ( V_11 -> V_172 [ V_231 ] ) ) ;
F_71 ( V_11 -> V_166 ) ;
goto V_242;
}
...
V_11 -> V_172 [ 0 ] . V_239 = 0 ;
V_11 -> V_172 [ 0 ] . V_11 = V_11 ;
if ( F_114 ( V_11 -> V_166 -> V_173 , V_11 -> V_240 . V_241 ,
V_243 , L_32 ,
& ( V_11 -> V_172 [ 0 ] ) ) < 0 ) {
if ( V_11 -> V_142 )
F_70 ( V_11 -> V_166 ) ;
...
F_115 ( V_11 ) ;
if ( ! V_11 -> V_207 ) {
V_11 -> V_205 -> V_244 = F_26 ( V_11 -> V_171 ) ;
F_116 ( V_11 ) ;
}
return 0 ;
V_242:
...
static int F_117 ( struct V_176 * V_166 , T_6 V_245 )
{
struct V_1 * V_2 = F_118 ( V_166 ) ;
...
F_101 ( V_166 ) ;
F_106 ( V_166 ) ;
F_120 ( V_166 , F_121 ( V_166 , V_245 ) ) ;
return 0 ;
}
static int F_122 ( struct V_176 * V_166 )
{
struct V_1 * V_2 = F_118 ( V_166 ) ;
struct V_10 * V_40 = (struct V_10 * ) V_2 -> V_12 ;
int V_5 ;
...
return 0 ;
V_247:
F_25 ( V_208 L_35 , V_40 -> V_15 , V_40 -> V_115 ) ;
F_105 ( V_2 ) ;
F_106 ( V_166 ) ;
return - V_113 ;
}
static void F_126 ( struct V_176 * V_11 )
{
struct V_1 * V_2 = F_118 ( V_11 ) ;
F_119 ( V_2 ) ;
F_63 ( (struct V_10 * ) V_2 -> V_12 ) ;
}
static void F_127 ( struct V_176 * V_166 )
{
struct V_1 * V_2 = F_118 ( V_166 ) ;
struct V_10 * V_40 = (struct V_10 * ) V_2 -> V_12 ;
F_128 ( V_2 ) ;
...
static void F_132 ( struct V_10 * V_40 )
{
int V_160 ;
struct V_3 * V_4 ;
for ( V_160 = 0 ; V_160 < V_40 -> V_162 -> V_62 ; V_160 ++ ) {
...
static T_7 F_134 ( struct V_176 * V_166 ,
enum V_254 error )
{
struct V_1 * V_2 = F_118 ( V_166 ) ;
struct V_10 * V_40 = F_135 ( V_2 ) ;
F_136 ( & V_166 -> V_11 , L_36 , error ) ;
switch ( error ) {
case V_255 :
return V_256 ;
case V_257 :
...
static T_7 F_138 ( struct V_176 * V_166 )
{
F_136 ( & V_166 -> V_11 , L_37 ) ;
return V_258 ;
}
static T_7 F_139 ( struct V_176 * V_166 )
{
F_136 ( & V_166 -> V_11 , L_38 ) ;
F_124 ( V_166 ) ;
if ( F_77 ( V_166 ) ) {
F_140 ( & V_166 -> V_11 ,
L_39 ) ;
...
F_81 ( V_166 ) ;
if ( F_141 ( V_166 ) ) {
F_136 ( & V_166 -> V_11 , L_40 ) ;
goto V_247;
}
return V_261 ;
V_247:
F_136 ( & V_166 -> V_11 , L_41 ) ;
return V_260 ;
}
static void F_142 ( struct V_176 * V_166 )
{
struct V_1 * V_2 = F_118 ( V_166 ) ;
struct V_18 * V_19 = NULL ;
struct V_10 * V_40 = (struct V_10 * ) F_135 ( V_2 ) ;
F_143 ( V_166 ) ;
if ( F_104 ( V_40 , V_40 -> V_203 ) ) {
F_136 ( & V_166 -> V_11 , L_42 ) ;
V_40 -> V_262 = V_263 ;
if ( F_104 ( V_40 , V_204 ) ) {
F_140 ( & V_166 -> V_11 ,
L_43 ) ;
