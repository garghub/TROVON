...
V_166 = F_71 ( V_21 , sizeof( * V_166 ) , V_170 ) ;
if ( ! V_166 )
return F_70 ( - V_171 ) ;
...
static int F_73 ( struct V_173 * V_20 )
{
struct V_174 * V_130 ;
struct V_2 * V_3 ;
struct V_175 * V_69 ;
...
if ( F_22 () ) {
V_177 = F_77 ( & V_20 -> V_21 , L_22 ) ;
} else {
V_177 = F_77 ( & V_20 -> V_21 , L_23 ) ;
}
if ( F_8 ( V_177 ) ) {
F_5 ( & V_20 -> V_21 , L_24 ) ;
return F_9 ( V_177 ) ;
...
V_3 -> V_104 = V_104 ;
F_81 ( & V_3 -> V_187 ) ;
strcpy ( V_130 -> V_188 , L_28 ) ;
strcpy ( V_130 -> V_131 , L_28 ) ;
sprintf ( V_130 -> V_189 , L_29 ) ;
V_3 -> V_130 = V_130 ;
V_3 -> V_177 = V_177 ;
V_3 -> V_20 = V_20 ;
V_3 -> V_69 = F_82 ( V_69 -> V_190 , F_83 ( V_69 ) ) ;
if ( ! V_3 -> V_69 ) {
F_5 ( & V_20 -> V_21 , L_30 ) ;
V_44 = - V_171 ;
goto V_191;
...
V_44 = F_86 ( V_130 , 0 , & V_179 , V_3 , & V_3 -> V_128 ) ;
if ( V_44 ) {
F_5 ( & V_20 -> V_21 , L_33 ) ;
goto V_193;
}
...
if ( F_22 () ) {
if ( V_166 -> V_194 . V_158 ) {
T_4 V_195 ;
F_87 ( V_195 ) ;
F_88 ( V_196 , V_195 ) ;
V_3 -> V_24 . V_26 = F_89 ( V_195 , F_65 ,
& V_166 -> V_194 ) ;
if ( V_3 -> V_24 . V_26 ) {
struct V_197 V_198 = {
. V_199 = V_69 -> V_190 + V_200 +
2 ,
. V_201 =
V_202 ,
. V_203 = 1 ,
...
if ( V_166 -> V_206 . V_158 ) {
T_4 V_195 ;
F_87 ( V_195 ) ;
F_88 ( V_196 , V_195 ) ;
V_3 -> V_24 . V_25 = F_89 ( V_195 , F_65 ,
& V_166 -> V_206 ) ;
if ( V_3 -> V_24 . V_25 ) {
struct V_197 V_198 = {
. V_207 = V_69 -> V_190 + V_208 +
2 ,
. V_209 =
V_202 ,
. V_203 = 1 ,
...
static int F_105 ( struct V_173 * V_20 )
{
struct V_174 * V_130 = F_106 ( V_20 ) ;
