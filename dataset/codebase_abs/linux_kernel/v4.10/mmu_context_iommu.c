...
unsigned long V_32 , unsigned long * V_56 )
{
const long V_57 = ( V_32 - V_36 -> V_32 ) >> V_11 ;
T_2 * V_58 = & V_36 -> V_45 [ V_57 ] ;
if ( V_57 >= V_36 -> V_33 )
return - V_46 ;
* V_56 = * V_58 | ( V_32 & ~ V_59 ) ;
return 0 ;
