...
static int F_4 ( struct V_1 * V_2 , unsigned V_13 , T_2 V_14 )
{
struct V_4 * V_5 = F_2 ( V_2 -> V_6 , struct V_4 , V_6 ) ;
V_2 -> V_15 = F_5 ( F_6 ( 15 ) | ( V_13 << 12 ) | V_14 ) ;
return F_7 ( V_5 , & V_2 -> V_15 , sizeof( V_2 -> V_15 ) ) ;
}
static int F_8 ( struct V_1 * V_2 , unsigned V_13 , T_2 * V_14 )
{
struct V_4 * V_5 = F_2 ( V_2 -> V_6 , struct V_4 , V_6 ) ;
int V_16 ;
...
static int F_10 ( struct V_1 * V_2 , T_3 V_18 , T_2 V_14 )
{
struct V_4 * V_5 = F_2 ( V_2 -> V_6 , struct V_4 , V_6 ) ;
V_2 -> V_15 = F_5 ( ( V_18 << 11 ) | V_14 ) ;
return F_7 ( V_5 , & V_2 -> V_15 , sizeof( V_2 -> V_15 ) ) ;
}
static int F_11 ( struct V_1 * V_2 , T_3 V_18 , T_2 * V_14 )
{
struct V_4 * V_5 = F_2 ( V_2 -> V_6 , struct V_4 , V_6 ) ;
int V_16 ;
...
static int F_12 ( struct V_1 * V_2 , T_3 * V_14 )
{
int V_16 ;
V_16 = F_10 ( V_2 , V_21 ,
V_22 | V_2 -> V_23 ) ;
