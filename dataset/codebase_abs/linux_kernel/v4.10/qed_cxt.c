...
static void F_10 ( struct V_25 * V_26 , T_1 V_40 )
{
...
for ( V_15 = 0 ; V_15 < V_5 -> V_119 ; V_15 ++ ) {
T_1 V_124 = F_37 ( T_1 , V_68 , V_128 ) ;
void * * V_120 = & V_5 -> V_118 [ V_15 ] . V_120 ;
* V_120 = F_38 ( & V_26 -> V_121 -> V_122 -> V_123 ,
V_124 ,
...
static T_1 F_40 ( struct V_63 * V_73 )
{
T_1 V_124 = 0 ;
T_1 V_15 ;
F_41 (i, ilt_clients)
...
void * V_120 ;
T_1 V_124 ;
V_124 = F_37 ( T_1 , V_147 , V_66 -> V_71 ) ;
V_120 = F_38 ( & V_26 -> V_121 -> V_122 -> V_123 ,
V_124 , & V_125 , V_133 ) ;
if ( ! V_120 )
return - V_134 ;
...
int V_132 ;
V_124 = F_40 ( V_47 ) ;
V_5 -> V_143 = F_36 ( V_124 , sizeof( struct V_130 ) ,
V_133 ) ;
if ( ! V_5 -> V_143 ) {
V_132 = - V_134 ;
goto V_152;
...
V_132 = F_43 ( V_26 , V_66 , V_15 , V_146 ) ;
if ( V_132 )
goto V_152;
}
}
...
V_5 -> V_54 [ type ] . V_155 = F_47 ( V_124 , V_133 ) ;
...
struct V_4 * V_5 ;
T_1 V_15 ;
V_5 = F_47 ( sizeof( * V_5 ) , V_133 ) ;
if ( ! V_5 )
return - V_134 ;
V_47 = V_5 -> V_47 ;
V_47 [ V_48 ] . V_76 . V_162 = F_49 ( V_163 , V_164 ) ;
V_47 [ V_48 ] . V_77 . V_162 = F_49 ( V_163 , V_165 ) ;
V_47 [ V_48 ] . V_49 . V_162 = F_49 ( V_163 , V_166 ) ;
V_47 [ V_102 ] . V_76 . V_162 = F_49 ( V_167 , V_164 ) ;
V_47 [ V_102 ] . V_77 . V_162 = F_49 ( V_167 , V_165 ) ;
V_47 [ V_102 ] . V_49 . V_162 = F_49 ( V_167 , V_166 ) ;
V_47 [ V_112 ] . V_76 . V_162 = F_49 ( V_168 , V_164 ) ;
V_47 [ V_112 ] . V_77 . V_162 = F_49 ( V_168 , V_165 ) ;
V_47 [ V_112 ] . V_49 . V_162 = F_49 ( V_168 , V_166 ) ;
V_47 [ V_108 ] . V_76 . V_162 = F_49 ( V_169 , V_164 ) ;
V_47 [ V_108 ] . V_77 . V_162 = F_49 ( V_169 , V_165 ) ;
V_47 [ V_108 ] . V_49 . V_162 = F_49 ( V_169 , V_166 ) ;
V_47 [ V_97 ] . V_76 . V_162 = F_49 ( V_170 , V_164 ) ;
V_47 [ V_97 ] . V_77 . V_162 = F_49 ( V_170 , V_165 ) ;
V_47 [ V_97 ] . V_49 . V_162 = F_49 ( V_170 , V_166 ) ;
V_47 [ V_114 ] . V_76 . V_162 = F_49 ( V_171 , V_164 ) ;
V_47 [ V_114 ] . V_77 . V_162 = F_49 ( V_171 , V_165 ) ;
V_47 [ V_114 ] . V_49 . V_162 = F_49 ( V_171 , V_166 ) ;
for ( V_15 = 0 ; V_15 < V_172 ; V_15 ++ )
V_5 -> V_47 [ V_15 ] . V_49 . V_50 = V_173 ;
V_5 -> V_98 [ 0 ] = F_50 ( V_26 ) ;
V_5 -> V_98 [ 1 ] = F_51 ( V_26 ) ;
if ( V_26 -> V_121 -> V_174 )
...
F_57 ( V_179 , V_180 , V_51 ) ;
F_57 ( V_179 , V_181 , V_178 ) ;
F_57 ( V_179 , V_182 , V_52 ) ;
F_58 ( V_26 , V_183 , V_179 ) ;
V_46 = V_26 -> V_28 -> V_47 [ V_97 ] . V_49 . V_50 ;
V_51 = V_26 -> V_28 -> V_98 [ 0 ] ;
V_52 = F_14 ( V_46 ) / V_51 ;
V_178 = F_14 ( V_46 ) - V_52 * V_51 ;
V_179 = 0 ;
F_57 ( V_179 , V_184 , ( V_51 >> 3 ) ) ;
F_57 ( V_179 , V_185 , ( V_178 >> 3 ) ) ;
F_57 ( V_179 , V_186 , V_52 ) ;
F_58 ( V_26 , V_187 , V_179 ) ;
V_51 = V_26 -> V_28 -> V_98 [ 1 ] ;
V_52 = F_14 ( V_46 ) / V_51 ;
V_178 = F_14 ( V_46 ) - V_52 * V_51 ;
V_179 = 0 ;
F_57 ( V_179 , V_188 , ( V_51 >> 3 ) ) ;
F_57 ( V_179 , V_189 , ( V_178 >> 3 ) ) ;
F_57 ( V_179 , V_190 , V_52 ) ;
F_58 ( V_26 , V_191 , V_179 ) ;
}
...
V_192 = 0 ;
F_57 ( V_192 , V_205 , V_61 -> type ) ;
F_57 ( V_192 , V_206 , V_193 ) ;
F_58 ( V_26 , V_194 [ V_15 ] , V_192 ) ;
V_193 = ( F_14 ( V_64 -> V_49 . V_50 ) *
...
F_57 ( V_192 , V_205 , V_61 -> type ) ;
F_57 ( V_192 , V_206 , V_193 ) ;
F_58 ( V_26 , V_199 [ V_15 ] , V_192 ) ;
}
}
void F_60 ( struct V_25 * V_26 )
{
struct V_207 V_208 ;
...
V_229 = F_63 ( V_26 , V_233 , & V_223 ) ;
F_58 ( V_26 , V_234 , V_229 ) ;
return 0 ;
}
...
F_58 ( V_26 , V_238 , V_235 ) ;
V_236 += ( V_5 -> V_10 [ 0 ] . V_13 >> V_237 ) ;
F_58 ( V_26 , V_239 , V_236 ) ;
V_235 += ( V_5 -> V_10 [ 1 ] . V_11 >> V_237 ) ;
F_58 ( V_26 , V_240 , V_235 ) ;
V_236 += ( V_5 -> V_10 [ 1 ] . V_13 >> V_237 ) ;
F_58 ( V_26 , V_241 , V_236 ) ;
V_235 += ( V_5 -> V_10 [ 2 ] . V_11 >> V_237 ) ;
F_58 ( V_26 , V_242 , V_235 ) ;
V_236 += ( V_5 -> V_10 [ 2 ] . V_13 >> V_237 ) ;
F_58 ( V_26 , V_243 , V_236 ) ;
V_235 += ( V_5 -> V_10 [ 3 ] . V_11 >> V_237 ) ;
F_58 ( V_26 , V_244 , V_235 ) ;
V_236 += ( V_5 -> V_10 [ 3 ] . V_13 >> V_237 ) ;
F_58 ( V_26 , V_245 , V_236 ) ;
V_235 += ( V_5 -> V_10 [ 4 ] . V_11 >> V_237 ) ;
F_58 ( V_26 , V_246 , V_235 ) ;
V_236 += ( V_5 -> V_10 [ 4 ] . V_13 >> V_237 ) ;
F_58 ( V_26 , V_247 , V_236 ) ;
V_235 += ( V_5 -> V_10 [ 5 ] . V_11 >> V_237 ) ;
F_58 ( V_26 , V_248 , V_235 ) ;
V_236 += ( V_5 -> V_10 [ 5 ] . V_13 >> V_237 ) ;
F_58 ( V_26 , V_249 , V_236 ) ;
F_58 ( V_26 , V_250 , V_235 ) ;
F_58 ( V_26 , V_251 , V_236 ) ;
F_58 ( V_26 , V_252 , V_235 ) ;
F_58 ( V_26 , V_253 , V_236 ) ;
}
...
V_64 = & V_26 -> V_28 -> V_47 [ V_48 ] ;
V_254 = F_67 ( F_14 ( V_64 -> V_49 . V_50 ) >> 10 ) ;
if ( V_64 -> V_75 ) {
F_58 ( V_26 ,
V_260 ,
V_254 ) ;
...
V_285 = 0 ;
F_57 ( V_285 , V_286 , V_87 . V_12 ) ;
F_57 ( V_285 , V_287 , 0 ) ;
F_57 ( V_285 , V_288 , V_26 -> V_103 ) ;
F_57 ( V_285 , V_289 , 0 ) ;
V_284 = V_290 +
( sizeof( V_285 ) / sizeof( T_1 ) ) *
( V_26 -> V_121 -> V_174 -> V_258 + V_15 ) ;
F_69 ( V_26 , V_284 , V_285 ) ;
}
V_285 = 0 ;
F_57 ( V_285 , V_286 , V_87 . V_9 ) ;
F_57 ( V_285 , V_287 , 0 ) ;
F_57 ( V_285 , V_288 , 0 ) ;
F_57 ( V_285 , V_289 , 0 ) ;
V_284 = V_290 +
( sizeof( V_285 ) / sizeof( T_1 ) ) *
( F_72 ( V_26 -> V_121 ) + V_26 -> V_103 ) ;
F_69 ( V_26 , V_284 , V_285 ) ;
F_58 ( V_26 , V_291 ,
V_87 . V_9 ? 0x1 : 0x0 ) ;
V_283 = V_87 . V_12 ;
for ( V_15 = 0 ; V_15 < V_5 -> V_37 ; V_15 ++ ) {
V_285 = 0 ;
F_57 ( V_285 , V_286 , V_87 . V_21 ) ;
F_57 ( V_285 , V_287 , 0 ) ;
F_57 ( V_285 , V_288 , V_26 -> V_103 ) ;
F_57 ( V_285 , V_292 , V_283 ) ;
F_57 ( V_285 , V_293 , ( V_137 ) 0 ) ;
V_284 = V_294 +
( sizeof( V_285 ) / sizeof( T_1 ) ) *
( V_26 -> V_121 -> V_174 -> V_258 + V_15 ) ;
F_69 ( V_26 , V_284 , V_285 ) ;
...
for ( V_15 = 0 ; V_15 < V_23 ; V_15 ++ ) {
V_285 = 0 ;
F_57 ( V_285 , V_286 , V_87 . V_24 [ V_15 ] ) ;
F_57 ( V_285 , V_287 , 0 ) ;
F_57 ( V_285 , V_288 , 0 ) ;
F_57 ( V_285 , V_292 , V_283 ) ;
F_57 ( V_285 , V_293 , ( V_137 ) 0 ) ;
...
F_69 ( V_26 , V_284 , V_285 ) ;
V_282 |= ( V_87 . V_24 [ V_15 ] ? F_73 ( V_15 ) : 0 ) ;
V_283 += V_87 . V_24 [ V_15 ] ;
}
if ( V_26 -> V_148 . V_149 == V_150 )
V_282 = 0 ;
F_58 ( V_26 , V_295 , V_282 ) ;
}
...
V_297 = F_78 ( V_5 -> V_54 [ type ] . V_155 ,
V_5 -> V_54 [ type ] . V_156 ) ;
if ( V_297 >= V_5 -> V_54 [ type ] . V_156 ) {
F_77 ( V_26 , L_11 , type ) ;
return - V_117 ;
}
F_79 ( V_297 , V_5 -> V_54 [ type ] . V_155 ) ;
* V_296 = V_297 + V_5 -> V_54 [ type ] . V_55 ;
return 0 ;
}
static bool F_80 ( struct V_25 * V_26 ,
T_1 V_298 , enum V_1 * V_299 )
{
struct V_4 * V_5 = V_26 -> V_28 ;
struct V_300 * V_301 ;
enum V_1 V_302 ;
...
* V_299 = V_302 ;
if ( V_302 == V_8 ) {
F_77 ( V_26 , L_12 , V_298 ) ;
return false ;
}
V_297 = V_298 - V_301 -> V_55 ;
if ( ! F_81 ( V_297 , V_301 -> V_155 ) ) {
F_77 ( V_26 , L_13 , V_298 ) ;
return false ;
}
return true ;
}
void F_82 ( struct V_25 * V_26 , T_1 V_298 )
{
struct V_4 * V_5 = V_26 -> V_28 ;
enum V_1 type ;
bool V_303 ;
T_1 V_297 ;
V_303 = F_80 ( V_26 , V_298 , & type ) ;
if ( ! V_303 )
return;
V_297 = V_298 - V_5 -> V_54 [ type ] . V_55 ;
F_83 ( V_297 , V_5 -> V_54 [ type ] . V_155 ) ;
}
int F_84 ( struct V_25 * V_26 , struct V_304 * V_305 )
{
struct V_4 * V_5 = V_26 -> V_28 ;
T_1 V_306 , V_307 , V_80 , line ;
enum V_1 type ;
bool V_303 ;
V_303 = F_80 ( V_26 , V_305 -> V_308 , & type ) ;
if ( ! V_303 )
return - V_117 ;
V_305 -> type = type ;
...
enum V_1 V_58 ;
V_315 = F_37 ( T_1 , V_316 , V_311 -> V_315 ) ;
V_313 = V_315 ;
V_40 = F_37 ( T_1 , 32 * 1024 , V_311 -> V_40 ) ;
switch ( V_26 -> V_148 . V_149 ) {
case V_150 :
V_314 = F_37 ( T_1 , V_317 , V_311 -> V_314 ) ;
V_312 = V_314 * 2 ;
V_58 = V_3 ;
break;
default:
...
{
struct V_4 * V_5 = V_26 -> V_28 ;
T_1 V_58 , V_39 , V_332 , V_15 , V_333 ;
struct V_63 * V_64 ;
struct V_65 * V_334 ;
struct V_29 * V_335 ;
switch ( V_26 -> V_148 . V_149 ) {
...
if ( ! V_64 -> V_75 )
return - V_117 ;
V_335 = & V_5 -> V_10 [ V_58 ] . V_34 [ V_39 ] ;
if ( ! V_335 -> V_62 )
return - V_117 ;
V_334 = & V_64 -> V_92 [ F_26 ( V_39 , V_99 ) ] ;
V_332 = F_21 ( V_334 -> V_68 ,
V_334 -> V_71 ) ;
for ( V_15 = 0 ; V_15 < V_332 ; V_15 ++ ) {
V_333 = V_15 + V_334 -> V_67 -
V_26 -> V_28 -> V_88 ;
V_305 -> V_336 [ V_15 ] = V_5 -> V_143 [ V_333 ] . V_120 ;
}
V_305 -> V_337 = F_14 ( V_64 -> V_49 . V_50 ) -
V_334 -> V_71 ;
V_305 -> V_338 = V_5 -> V_98 [ V_335 -> type ] ;
V_305 -> V_339 = V_334 -> V_71 /
V_305 -> V_338 ;
return 0 ;
}
int
F_89 ( struct V_25 * V_26 ,
enum V_340 V_341 , T_1 V_308 )
{
T_1 V_342 , V_333 , V_69 , V_307 , V_343 , line ;
struct V_63 * V_64 ;
struct V_65 * V_66 ;
struct V_344 * V_345 ;
T_3 V_125 ;
...
break;
default:
F_77 ( V_26 , L_17 , V_341 ) ;
return - V_117 ;
}
V_307 = V_64 -> V_49 . V_50 ;
V_343 = F_14 ( V_307 ) / V_69 ;
line = V_66 -> V_67 + ( V_308 / V_343 ) ;
V_333 = line - V_26 -> V_28 -> V_88 ;
F_90 ( & V_26 -> V_28 -> V_176 ) ;
if ( V_26 -> V_28 -> V_143 [ V_333 ] . V_120 )
goto V_349;
V_345 = F_91 ( V_26 ) ;
if ( ! V_345 ) {
F_77 ( V_26 ,
...
T_2 * V_353 = ( T_2 * ) V_120 ;
union V_354 * V_355 ;
for ( V_352 = 0 ; V_352 < V_343 ; V_352 ++ ) {
V_355 = (union V_354 * ) V_353 ;
F_57 ( V_355 -> V_356 . V_357 . V_358 ,
V_359 , 0xf ) ;
V_353 += F_51 ( V_26 ) ;
}
}
V_26 -> V_28 -> V_143 [ V_333 ] . V_120 = V_120 ;
V_26 -> V_28 -> V_143 [ V_333 ] . V_125 = V_125 ;
V_26 -> V_28 -> V_143 [ V_333 ] . V_124 =
V_66 -> V_71 ;
V_342 = V_360 +
( line * V_361 * V_272 ) ;
V_273 = 0 ;
...
F_57 ( V_273 ,
V_275 ,
( V_26 -> V_28 -> V_143 [ V_333 ] . V_125 >> 12 ) ) ;
F_92 ( V_26 , V_345 , ( V_137 ) ( V_362 ) & V_273 ,
V_342 , sizeof( V_273 ) / sizeof( T_1 ) , 0 ) ;
if ( V_341 == V_346 ) {
T_1 V_363 = ( 1 + ( V_308 / V_343 ) ) *
V_343 ;
F_93 ( V_26 , V_345 , V_364 ,
V_363 - 1 ) ;
if ( ! V_26 -> V_365 ) {
F_93 ( V_26 , V_345 , V_26 -> V_366 , 1 ) ;
V_26 -> V_365 = true ;
}
}
V_351:
F_94 ( V_26 , V_345 ) ;
V_349:
F_95 ( & V_26 -> V_28 -> V_176 ) ;
return V_132 ;
}
static int
F_96 ( struct V_25 * V_26 ,
enum V_340 V_341 ,
T_1 V_367 , T_1 V_36 )
{
T_1 V_67 , V_368 , V_369 , V_370 ;
T_1 V_342 , V_69 , V_307 , V_343 ;
struct V_63 * V_64 ;
struct V_65 * V_66 ;
T_1 V_371 = V_367 + V_36 ;
struct V_344 * V_345 ;
V_137 V_273 = 0 ;
T_1 V_15 ;
switch ( V_341 ) {
...
V_307 = V_64 -> V_49 . V_50 ;
V_343 = F_14 ( V_307 ) / V_69 ;
V_67 = V_66 -> V_67 + ( V_367 / V_343 ) ;
V_368 = V_66 -> V_67 + ( V_371 / V_343 ) ;
if ( ( ( V_371 + 1 ) / V_343 ) != ( V_371 / V_343 ) )
V_368 -- ;
V_369 = V_67 - V_26 -> V_28 -> V_88 ;
V_370 = V_368 - V_26 -> V_28 -> V_88 ;
V_345 = F_91 ( V_26 ) ;
if ( ! V_345 ) {
F_77 ( V_26 ,
L_18 ) ;
...
for ( V_15 = V_369 ; V_15 < V_370 ; V_15 ++ ) {
...
int F_97 ( struct V_25 * V_26 , enum V_1 V_58 )
{
int V_132 ;
T_1 V_298 ;
V_132 = F_96 ( V_26 , V_346 ,
F_16 ( V_26 ,
V_58 ) ,
F_15 ( V_26 ,
V_58 , & V_298 ) ) ;
if ( V_132 )
return V_132 ;
V_132 = F_96 ( V_26 , V_348 , 0 ,
F_17 ( V_26 , V_58 ) ) ;
if ( V_132 )
return V_132 ;
V_132 = F_96 ( V_26 , V_347 , 0 ,
F_11 ( V_26 ) ) ;
return V_132 ;
}
int F_98 ( struct V_25 * V_26 ,
T_1 V_372 , T_2 V_373 , void * * V_374 )
{
struct V_4 * V_5 = V_26 -> V_28 ;
struct V_63 * V_64 ;
struct V_65 * V_61 ;
...
V_332 = F_21 ( V_61 -> V_68 , V_61 -> V_71 ) ;
V_338 = V_5 -> V_98 [ V_335 -> type ] ;
V_339 = V_61 -> V_71 / V_338 ;
if ( V_332 < V_372 / V_339 )
return - V_117 ;
V_375 = V_372 / V_339 + V_61 -> V_67 -
V_5 -> V_88 ;
* V_374 = ( T_2 * ) V_5 -> V_143 [ V_375 ] . V_120 +
( V_372 % V_339 ) * V_338 ;
return 0 ;
}
