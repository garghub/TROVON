...
struct V_11 * V_100 = & V_99 -> V_15 [ 0 ] ;
struct V_1 * V_12 ;
unsigned V_14 ;
unsigned V_101 ;
for ( V_14 = 0 , V_101 = 0 ; ; V_100 ++ ) {
if ( ! V_100 -> V_10 )
break;
V_14 ++ ;
...
continue;
V_101 ++ ;
if ( strcmp ( V_100 -> V_10 , L_26 ) == 0 )
V_100 -> V_18 = V_20 |
V_19 ;
else if ( strcmp ( V_100 -> V_10 , L_27 ) == 0 )
V_100 -> V_18 = V_19 ;
...
V_3 -> V_25 = F_37 ( & V_71 -> V_42 , & V_3 -> V_73 , V_3 ) ;
if ( F_38 ( V_3 -> V_25 ) ) {
F_16 ( & V_71 -> V_42 , L_31 ) ;
return F_39 ( V_3 -> V_25 ) ;
}
F_40 ( & V_71 -> V_42 , L_32 ) ;
for ( V_5 = 0 ; V_5 < V_76 -> V_102 ; V_5 ++ )
F_41 ( V_3 -> V_25 , & V_76 -> V_103 [ V_5 ] ) ;
return 0 ;
}
