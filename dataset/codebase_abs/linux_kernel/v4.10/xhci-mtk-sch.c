...
if ( F_34 ( & V_10 -> V_17 )
|| F_35 ( & V_10 -> V_17 ) )
V_21 -> V_83 [ 0 ] |= F_36 ( F_37 ( 1 ) ) ;
return 0 ;
}
V_13 = F_2 ( V_6 , V_8 , V_10 ) ;
V_47 = & V_66 [ V_13 ] ;
V_23 = F_38 ( sizeof( struct V_22 ) , V_84 ) ;
if ( ! V_23 )
return - V_71 ;
F_4 ( V_8 , V_21 , V_23 ) ;
...
F_40 ( & V_23 -> V_86 , & V_47 -> V_72 ) ;
V_23 -> V_10 = V_10 ;
V_21 -> V_83 [ 0 ] |= F_36 ( F_37 ( V_23 -> V_39 )
| F_41 ( V_23 -> V_36 ) | F_42 ( V_23 -> V_34 ) ) ;
V_21 -> V_83 [ 1 ] |= F_36 ( F_43 ( V_23 -> V_33 )
| F_44 ( V_23 -> V_38 ) ) ;
F_30 ( V_6 , L_3 ,
...
void F_45 ( struct V_73 * V_74 , struct V_7 * V_8 ,
struct V_9 * V_10 )
{
struct V_64 * V_65 = F_25 ( V_74 ) ;
struct V_5 * V_6 ;
...
V_13 = F_2 ( V_6 , V_8 , V_10 ) ;
V_47 = & V_66 [ V_13 ] ;
F_46 (sch_ep, &sch_bw->bw_ep_list, endpoint) {
if ( V_23 -> V_10 == V_10 ) {
F_14 ( V_47 , V_23 ,
- V_23 -> V_40 ) ;
F_47 ( & V_23 -> V_86 ) ;
