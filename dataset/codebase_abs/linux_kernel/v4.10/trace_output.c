...
static enum V_1 F_101 ( struct V_2 * V_3 ,
int V_19 , struct V_41 * V_43 )
{
struct V_16 * V_11 ;
struct V_4 * V_5 = & V_3 -> V_6 ;
...
static enum V_1 F_102 ( struct V_2 * V_3 , int V_19 ,
struct V_41 * V_43 )
{
struct V_16 * V_11 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
F_10 ( & V_3 -> V_6 , L_47 , V_11 -> V_53 , V_11 -> V_15 ) ;
return F_4 ( & V_3 -> V_6 ) ;
}
...
int V_24 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
F_10 ( & V_3 -> V_6 , L_48 , V_11 -> V_174 ) ;
for ( V_24 = 0 ; V_24 < V_3 -> V_114 - F_104 ( struct V_173 , V_15 ) ; V_24 ++ )
F_10 ( & V_3 -> V_6 , L_49 ,
( unsigned char ) V_11 -> V_15 [ V_24 ] ) ;
F_11 ( & V_3 -> V_6 , '\n' ) ;
return F_4 ( & V_3 -> V_6 ) ;
}
T_3 static int F_105 ( void )
{
struct V_41 * V_43 ;
int V_24 , V_23 ;
for ( V_24 = 0 ; V_175 [ V_24 ] ; V_24 ++ ) {
V_43 = V_175 [ V_24 ] ;
V_23 = F_59 ( V_43 ) ;
if ( ! V_23 ) {
F_64 ( V_132 L_50 ,
