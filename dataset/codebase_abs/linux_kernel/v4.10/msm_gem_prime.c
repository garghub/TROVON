...
int F_9 ( struct V_2 * V_3 , struct V_11 * V_12 )
{
int V_13 ;
V_13 = F_10 ( V_3 , V_3 -> V_7 , V_12 ) ;
if ( V_13 < 0 )
return V_13 ;
return F_11 ( V_12 -> V_14 , V_12 ) ;
}
struct V_2 * F_12 ( struct V_15 * V_16 ,
struct V_17 * V_18 , struct V_1 * V_19 )
{
return F_13 ( V_16 , V_18 -> V_20 , V_19 ) ;
}
