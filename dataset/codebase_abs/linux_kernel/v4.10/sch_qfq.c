...
static int F_113 ( struct V_85 * V_86 , struct V_2 * V_3 ,
struct V_85 * * V_168 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_1 * V_11 ;
...
if ( V_56 ) {
V_11 -> V_16 . V_169 ++ ;
return F_116 ( V_86 , V_3 , V_168 ) ;
}
}
V_56 = F_117 ( V_86 , V_11 -> V_13 , V_168 ) ;
if ( F_88 ( V_56 != V_113 ) ) {
F_10 ( L_12 , V_56 ) ;
if ( F_118 ( V_56 ) ) {
V_11 -> V_16 . V_169 ++ ;
...
static void F_121 ( struct V_5 * V_6 , struct V_125 * V_38 ,
struct V_25 * V_26 )
{
...
F_95 ( V_38 -> V_22 , & V_6 -> V_132 [ V_140 ] ) ;
if ( F_122 ( V_38 -> V_22 , & V_6 -> V_132 [ V_133 ] ) &&
...
static int F_124 ( struct V_2 * V_3 , struct V_50 * V_172 )
{
struct V_5 * V_6 = F_2 ( V_3 ) ;
struct V_125 * V_38 ;
int V_39 , V_173 , V_56 ;
