...
V_123 -> V_133 =
F_24 ( F_4 ( V_2 , V_163 ) & 7 ) ;
V_123 -> V_139 =
F_24 ( ( F_4 ( V_2 , V_163 ) >> 3 ) & 7 ) ;
switch ( F_4 ( V_2 , V_164 ) & 3 ) {
case 0 :
V_123 -> V_140 = V_144 ;
break;
case 1 :
...
V_123 -> V_137 = V_159 ;
if ( F_4 ( V_2 , V_164 ) & 0x10 )
V_123 -> V_137 = V_160 ;
switch ( ( F_4 ( V_2 , V_164 ) & 0x0c ) >> 2 ) {
case 0 :
V_123 -> V_135 = V_155 ;
break;
case 1 :
