...
if ( F_6 ( V_2 ) ) {
V_2 -> V_154 = F_104 ( & V_274 -> V_273 , L_93 ) ;
V_221 = F_105 ( V_2 -> V_154 ) ;
if ( V_221 ) {
F_84 ( & V_274 -> V_273 , L_94 ) ;
goto V_301;
}
}
V_2 -> V_253 = F_106 ( & V_274 -> V_273 , L_95 ) ;
if ( F_83 ( V_2 -> V_253 ) ) {
F_84 ( & V_274 -> V_273 , L_96 ) ;
V_221 = F_107 ( V_2 -> V_253 ) ;
V_2 -> V_253 = NULL ;
goto V_302;
}
...
V_62 -> V_309 = V_310 ;
#endif
V_62 -> V_312 = V_2 -> V_231 / ( V_2 -> V_232 * 256 ) ;
V_62 -> V_313 = V_2 -> V_231 / V_2 -> V_232 ;
if ( V_2 -> V_220 -> V_306 )
V_62 -> V_306 = V_2 -> V_220 -> V_306 ;
V_62 -> V_314 = 4095 ;
V_62 -> V_315 = 4095 ;
V_62 -> V_316 = 4095 * 512 ;
V_62 -> V_317 = V_62 -> V_316 ;
V_62 -> V_318 = 128 ;
F_3 ( V_2 , V_37 ,
L_98 ,
( V_2 -> V_139 ? L_99 : L_9 ) ,
...
F_80 ( V_2 ) ;
F_111 ( V_274 , V_62 ) ;
F_112 ( & V_274 -> V_273 , L_102 , F_113 ( V_62 ) ,
F_6 ( V_2 ) ? L_103 : L_104 ,
V_62 -> V_309 & V_311 ? L_105 : L_106 ) ;
return 0 ;
V_320:
F_72 ( V_2 ) ;
V_319:
...
F_118 ( V_2 -> V_20 ) ;
V_293:
F_119 ( V_2 -> V_201 -> V_202 , F_97 ( V_2 -> V_201 ) ) ;
V_292:
for ( V_280 = F_14 ( 5 ) ; V_280 <= F_14 ( 10 ) ; V_280 ++ )
F_92 ( V_280 ) ;
V_283:
...
static void F_121 ( struct V_279 * V_274 )
{
struct V_218 * V_62 = F_122 ( V_274 ) ;
struct V_1 * V_2 = F_56 ( V_62 ) ;
if ( V_2 -> V_263 >= 0 )
F_117 ( V_2 -> V_263 , V_2 ) ;
F_86 ( V_2 ) ;
...
static int F_124 ( struct V_279 * V_274 )
{
struct V_218 * V_62 = F_122 ( V_274 ) ;
struct V_1 * V_2 = F_56 ( V_62 ) ;
struct V_219 * V_321 = V_2 -> V_220 ;
int V_280 ;
F_121 ( V_274 ) ;
F_115 ( V_2 -> V_253 ) ;
F_125 ( & V_2 -> F_29 ) ;
