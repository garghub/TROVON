...
static void F_60 ( struct V_80 * V_81 ) {}
static int F_61 ( struct V_82 * V_51 )
{
struct V_3 * V_4 ;
struct V_83 * V_84 ;
unsigned long V_85 ;
int V_86 ;
V_84 = F_62 ( V_51 , V_87 , 0 ) ;
if ( ! V_84 )
return - V_12 ;
if ( ! F_63 ( & V_51 -> V_11 , V_84 -> V_88 ,
F_64 ( V_84 ) , V_51 -> V_52 ) )
return - V_89 ;
V_4 = F_65 ( & V_51 -> V_11 , sizeof( * V_4 ) , V_57 ) ;
if ( ! V_4 )
return - V_58 ;
V_4 -> V_2 . V_11 . V_90 = & V_51 -> V_11 ;
V_4 -> V_2 . V_11 . V_91 = F_60 ;
V_4 -> V_2 . V_92 = & V_93 ;
V_4 -> V_51 = V_51 ;
F_66 ( & V_4 -> V_74 ) ;
F_67 ( & V_4 -> V_44 ) ;
V_4 -> V_6 = F_68 ( & V_51 -> V_11 , V_84 -> V_88 , F_64 ( V_84 ) ) ;
if ( V_4 -> V_6 == NULL )
return - V_94 ;
V_85 = F_4 ( V_4 -> V_6 + V_95 ) ;
if ( V_85 != ( 'v' | 'i' << 8 | 'r' << 16 | 't' << 24 ) ) {
F_69 ( & V_51 -> V_11 , L_2 , V_85 ) ;
return - V_96 ;
}
...
V_4 -> V_2 . V_99 . V_80 = F_4 ( V_4 -> V_6 + V_100 ) ;
if ( V_4 -> V_2 . V_99 . V_80 == 0 ) {
return - V_96 ;
}
V_4 -> V_2 . V_99 . V_101 = F_4 ( V_4 -> V_6 + V_102 ) ;
if ( V_4 -> V_9 == 1 ) {
F_3 ( V_64 , V_4 -> V_6 + V_103 ) ;
V_86 = F_70 ( & V_51 -> V_11 , F_71 ( 64 ) ) ;
if ( ! V_86 )
F_72 ( & V_51 -> V_11 ,
F_71 ( 32 + V_66 ) ) ;
} else {
V_86 = F_73 ( & V_51 -> V_11 , F_71 ( 64 ) ) ;
}
if ( V_86 )
V_86 = F_73 ( & V_51 -> V_11 , F_71 ( 32 ) ) ;
if ( V_86 )
F_69 ( & V_51 -> V_11 , L_4 ) ;
F_74 ( V_51 , V_4 ) ;
return F_75 ( & V_4 -> V_2 ) ;
}
static int F_76 ( struct V_82 * V_51 )
{
struct V_3 * V_4 = F_77 ( V_51 ) ;
F_78 ( & V_4 -> V_2 ) ;
return 0 ;
}
static int F_79 ( const char * V_80 ,
const struct V_104 * V_105 )
{
int V_54 ;
struct V_83 V_106 [ 2 ] = {} ;
char * V_107 ;
long long int V_6 , V_108 ;
unsigned int V_32 ;
int V_109 , V_110 = 0 ;
struct V_82 * V_51 ;
V_108 = F_80 ( V_80 , & V_107 ) ;
V_109 = sscanf ( V_107 , L_5 ,
& V_6 , & V_32 , & V_110 ,
& V_111 , & V_110 ) ;
if ( V_109 < 2 || V_107 [ V_110 ] )
return - V_12 ;
V_106 [ 0 ] . V_36 = V_87 ;
V_106 [ 0 ] . V_88 = V_6 ;
V_106 [ 0 ] . V_112 = V_6 + V_108 - 1 ;
V_106 [ 1 ] . V_36 = V_113 ;
V_106 [ 1 ] . V_88 = V_106 [ 1 ] . V_112 = V_32 ;
if ( ! V_114 ) {
V_54 = F_81 ( & V_115 ) ;
if ( V_54 ) {
F_82 ( L_6 ) ;
...
F_83 ( L_7 ,
V_111 ,
( unsigned long long ) V_106 [ 0 ] . V_88 ,
( unsigned long long ) V_106 [ 0 ] . V_112 ,
( int ) V_106 [ 1 ] . V_88 ) ;
V_51 = F_84 ( & V_115 ,
L_8 , V_111 ++ ,
V_106 , F_85 ( V_106 ) , NULL , 0 ) ;
if ( F_57 ( V_51 ) )
return F_58 ( V_51 ) ;
return 0 ;
}
static int F_86 ( struct V_80 * V_11 , void * V_116 )
{
char * V_117 = V_116 ;
unsigned int V_18 = strlen ( V_117 ) ;
struct V_82 * V_51 = F_87 ( V_11 ) ;
snprintf ( V_117 + V_18 , V_64 - V_18 , L_9 ,
V_51 -> V_83 [ 0 ] . V_112 - V_51 -> V_83 [ 0 ] . V_88 + 1ULL ,
( unsigned long long ) V_51 -> V_83 [ 0 ] . V_88 ,
( unsigned long long ) V_51 -> V_83 [ 1 ] . V_88 ,
V_51 -> V_99 ) ;
return 0 ;
}
static int F_88 ( char * V_117 , const struct V_104 * V_105 )
{
V_117 [ 0 ] = '\0' ;
F_89 ( & V_115 , V_117 ,
F_86 ) ;
...
static int F_90 ( struct V_80 * V_11 ,
void * V_116 )
{
F_91 ( F_87 ( V_11 ) ) ;
return 0 ;
