...
V_63 = F_17 ( V_63 , 9 ) ;
V_64 = F_17 ( V_64 , 9 ) ;
F_18 ( V_11 -> V_66 , V_67 , V_62 ) ;
F_18 ( V_11 -> V_66 , V_68 , V_63 ) ;
F_18 ( V_11 -> V_66 , V_69 , V_64 ) ;
F_19 ( V_11 -> V_66 ) ;
}
static T_4 F_20 ( int V_6 , void * V_70 )
{
F_15 ( V_70 ) ;
return V_71 ;
}
static void F_21 ( struct V_72 * V_70 )
{
F_15 ( V_70 -> V_73 ) ;
}
...
static int F_26 ( struct V_76 * V_66 )
{
struct V_10 * V_11 = F_27 ( V_66 ) ;
return F_22 ( V_11 ) ;
}
static void F_28 ( struct V_76 * V_66 )
{
struct V_10 * V_11 = F_27 ( V_66 ) ;
F_24 ( V_11 ) ;
}
...
static void F_30 ( struct V_72 * V_77 )
{
struct V_10 * V_11 = V_77 -> V_73 ;
F_24 ( V_11 ) ;
}
...
V_92 -> V_100 [ 0 ] = F_33 ( V_101 ) ;
F_34 ( V_92 , V_67 , V_102 , V_103 , 0 , 0 ) ;
F_34 ( V_92 , V_68 , V_102 , V_103 , 0 , 0 ) ;
F_34 ( V_92 , V_69 , V_102 , V_103 , 0 , 0 ) ;
}
...
int V_118 ;
int error ;
if ( ! F_46 ( V_2 -> V_119 , V_120 ) ) {
F_47 ( & V_2 -> V_70 , L_2 ) ;
return - V_121 ;
}
V_118 = F_6 ( V_2 , V_122 ) ;
if ( V_118 != V_123 &&
( F_48 ( V_124 ) || V_118 != V_125 ) ) {
F_47 ( & V_2 -> V_70 , L_3 , V_118 ) ;
return - V_126 ;
}
V_11 = F_49 ( sizeof( struct V_10 ) , V_127 ) ;
if ( ! V_11 )
return - V_104 ;
V_11 -> V_2 = V_2 ;
if ( V_117 ) {
...
static int F_60 ( struct V_133 * V_70 )
{
struct V_1 * V_2 = F_61 ( V_70 ) ;
struct V_10 * V_11 = F_56 ( V_2 ) ;
return F_7 ( V_11 , V_75 ) ;
}
static int F_62 ( struct V_133 * V_70 )
{
struct V_1 * V_2 = F_61 ( V_70 ) ;
struct V_10 * V_11 = F_56 ( V_2 ) ;
