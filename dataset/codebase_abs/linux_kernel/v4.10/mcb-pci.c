...
F_7 ( V_10 ) ;
V_16 -> V_22 = F_8 ( V_10 , 0 ) ;
if ( ! V_16 -> V_22 ) {
F_6 ( & V_10 -> V_7 , L_2 ) ;
V_17 = - V_21 ;
goto V_23;
}
V_15 = F_9 ( & V_10 -> V_7 , V_16 -> V_22 ,
V_24 ,
V_25 ) ;
if ( ! V_15 ) {
F_6 ( & V_10 -> V_7 , L_3 ) ;
...
V_16 -> V_27 = F_10 ( & V_10 -> V_7 , V_16 -> V_22 , V_24 ) ;
if ( ! V_16 -> V_27 ) {
F_6 ( & V_10 -> V_7 , L_4 ) ;
V_17 = - V_20 ;
goto V_23;
...
F_12 ( V_10 , V_16 ) ;
V_16 -> V_5 = F_13 ( & V_10 -> V_7 ) ;
if ( F_14 ( V_16 -> V_5 ) ) {
V_17 = F_15 ( V_16 -> V_5 ) ;
goto V_23;
}
V_16 -> V_5 -> V_30 = F_1 ;
V_17 = F_16 ( V_16 -> V_5 , V_16 -> V_22 , V_16 -> V_27 ) ;
if ( V_17 < 0 )
goto V_31;
F_17 ( & V_10 -> V_7 , L_6 , V_17 ) ;
F_18 ( V_16 -> V_5 ) ;
return 0 ;
V_31:
F_19 ( V_16 -> V_5 ) ;
