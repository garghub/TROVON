...
{
unsigned char * V_13 = V_10 -> V_14 + ( V_15 << 4 ) ;
...
unsigned char * V_16 = V_10 -> V_14 + ( V_33 << 4 ) ;
int V_17 = V_12 ;
int V_18 ;
while ( ! F_6 ( V_10 , V_19 ,
V_20 | V_21 ,
...
V_10 = F_22 ( V_45 ) ;
V_10 -> V_63 = V_49 -> V_54 ;
V_10 -> V_64 = ( void * ) V_49 -> V_54 ;
if ( V_50 && V_7 )
V_10 -> V_14 = ( void * ) V_50 -> V_54 ;
else
V_46 |= V_39 ;
V_46 |= V_8 > 0 ? V_65 : 0 ;
...
static int T_2 F_32 ( struct V_42 * V_43 )
{
