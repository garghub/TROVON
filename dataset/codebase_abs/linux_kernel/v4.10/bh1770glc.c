...
T_5 V_119 ;
F_34 ( & V_2 -> V_95 ) ;
V_119 = sprintf ( V_111 , L_6 , V_2 -> V_11 ) ;
F_35 ( & V_2 -> V_95 ) ;
return V_119 ;
}
...
int V_120 ;
int V_121 = 0 ;
for ( V_120 = 0 ; V_120 < F_16 ( V_122 ) ; V_120 ++ )
V_121 += sprintf ( V_111 + V_121 , L_7 , V_122 [ V_120 ] ) ;
sprintf ( V_111 + V_121 - 1 , L_8 ) ;
return V_121 ;
}
...
{
struct V_1 * V_2 = F_43 ( V_10 ) ;
return sprintf ( V_111 , L_6 , V_122 [ V_2 -> V_16 ] ) ;
}
static T_5 F_57 ( struct V_108 * V_10 ,
struct V_109 * V_110 , char * V_111 )
{
struct V_1 * V_2 = F_43 ( V_10 ) ;
return sprintf ( V_111 , L_6 , V_122 [ V_2 -> V_17 ] ) ;
}
static int F_58 ( int V_14 )
{
int V_120 ;
for ( V_120 = 0 ; V_120 < F_16 ( V_122 ) - 1 ; V_120 ++ )
if ( V_14 >= V_122 [ V_120 ] )
break;
return V_120 ;
}
...
T_5 V_119 ;
F_34 ( & V_2 -> V_95 ) ;
V_119 = sprintf ( V_111 , L_9 , V_2 -> V_52 ) ;
F_35 ( & V_2 -> V_95 ) ;
return V_119 ;
}
...
int V_120 ;
int V_121 = 0 ;
for ( V_120 = 0 ; V_120 < F_16 ( V_127 ) ; V_120 ++ )
V_121 += sprintf ( V_111 + V_121 , L_7 , V_127 [ V_120 ] ) ;
sprintf ( V_111 + V_121 - 1 , L_8 ) ;
return V_121 ;
}
...
unsigned long V_128 ;
int V_41 , V_120 ;
V_41 = F_44 ( V_111 , 0 , & V_128 ) ;
if ( V_41 )
return V_41 ;
for ( V_120 = 0 ; V_120 < F_16 ( V_127 ) - 1 ; V_120 ++ )
if ( V_128 >= V_127 [ V_120 ] )
break;
F_34 ( & V_2 -> V_95 ) ;
V_2 -> V_65 = V_120 ;
V_41 = F_4 ( V_2 , V_120 ) ;
...
static int F_79 ( struct V_77 * V_5 ,
const struct V_131 * V_132 )
{
struct V_1 * V_2 ;
int V_133 ;
V_2 = F_80 ( & V_5 -> V_10 , sizeof *V_2 , V_134 ) ;
if ( ! V_2 )
return - V_135 ;
F_81 ( V_5 , V_2 ) ;
V_2 -> V_5 = V_5 ;
...
V_2 -> V_137 = V_5 -> V_10 . V_136 ;
V_2 -> V_52 = V_138 ;
V_2 -> V_65 = V_139 ;
V_2 -> V_103 = V_115 ;
V_2 -> V_102 = V_115 ;
if ( V_2 -> V_137 -> V_140 == 0 )
V_2 -> V_48 = V_141 ;
else
V_2 -> V_48 = V_2 -> V_137 -> V_140 ;
V_2 -> V_32 = V_142 ;
V_2 -> V_22 = V_2 -> V_137 -> V_143 ;
V_2 -> V_72 = V_144 ;
V_2 -> V_74 = V_145 ;
V_2 -> V_16 = V_146 ;
V_2 -> V_17 = V_147 ;
V_2 -> V_59 = 0 ;
V_2 -> V_54 [ 0 ] . V_148 = V_149 ;
V_2 -> V_54 [ 1 ] . V_148 = V_150 ;
V_133 = F_86 ( & V_5 -> V_10 ,
...
static int F_92 ( struct V_77 * V_5 )
{
struct V_1 * V_2 = F_93 ( V_5 ) ;
F_94 ( V_5 -> V_96 , V_2 ) ;
F_91 ( & V_2 -> V_5 -> V_10 . V_76 ,
& V_153 ) ;
if ( V_2 -> V_137 -> V_159 )
...
static int F_97 ( struct V_108 * V_10 )
{
struct V_77 * V_5 = F_98 ( V_10 ) ;
struct V_1 * V_2 = F_93 ( V_5 ) ;
F_24 ( V_2 ) ;
return 0 ;
}
