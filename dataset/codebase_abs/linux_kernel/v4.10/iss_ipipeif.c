...
V_2 -> V_89 . V_177 = F_56 ( 4096 * 4096 ) * 3 ;
V_2 -> V_89 . V_178 = 32 ;
V_2 -> V_89 . V_179 = 1 ;
V_2 -> V_89 . V_180 = 0x1ffe0 ;
return F_57 ( & V_2 -> V_89 , L_4 ) ;
}
...
{
int V_108 ;
V_108 = F_62 ( V_182 , & V_2 -> V_122 ) ;
if ( V_108 < 0 )
goto error;
V_108 = F_63 ( & V_2 -> V_89 , V_182 ) ;
if ( V_108 < 0 )
goto error;
return 0 ;
error:
