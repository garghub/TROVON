...
const struct V_55 * V_56 , unsigned int V_57 , int * V_28 )
{
struct V_1 * V_1 = F_14 ( V_33 ) ;
unsigned int V_58 ;
int V_7 ;
F_2 ( & V_33 -> V_59 ) ;
V_7 = F_9 ( V_1 , V_56 -> V_60 , & V_58 ,
V_56 -> V_61 . V_62 / 8 ) ;
if ( V_7 )
goto V_63;
if ( V_58 & V_57 ) {
...
if ( V_56 -> V_61 . V_64 == 's' )
* V_28 = F_26 ( V_58 , V_56 -> V_61 . V_65 - 1 ) ;
else
* V_28 = V_58 & ( ( 1 << V_56 -> V_61 . V_65 ) - 1 ) ;
V_7 = V_66 ;
V_63:
F_8 ( & V_33 -> V_59 ) ;
return V_7 ;
...
struct V_67 * V_26 , const struct V_68 * V_19 )
{
F_28 ( & V_1 -> V_21 ) ;
V_1 -> V_26 = V_26 ;
V_1 -> V_19 = V_19 ;
