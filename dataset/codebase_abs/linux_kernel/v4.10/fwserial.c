...
V_43 -> V_87 = F_163 ( V_251 -> V_253 , V_251 -> V_254 ) ;
V_43 -> V_138 = F_163 ( V_251 -> V_255 , V_251 -> V_256 ) ;
V_43 -> V_252 = F_164 ( V_251 -> V_252 ) ;
F_165 ( V_43 , V_257 ) ;
F_2 ( & V_2 -> V_6 ) ;
...
static void F_174 ( struct V_1 * V_2 , bool V_264 )
{
if ( V_264 )
F_27 ( V_2 , 0 ) ;
F_2 ( & V_2 -> V_6 ) ;
V_2 -> V_181 = F_175 ( V_265 ) ;
F_166 ( & V_2 -> V_7 , V_2 -> V_181 ) ;
F_176 ( V_2 -> V_43 , NULL ) ;
F_4 ( & V_2 -> V_6 ) ;
if ( V_2 -> V_2 . V_158 && V_2 -> V_226 -> V_258 )
...
struct V_240 * V_241 ;
int V_84 , V_23 ;
V_241 = F_180 ( sizeof( * V_241 ) , V_183 ) ;
if ( ! V_241 )
return - V_48 ;
V_2 = F_173 ( V_43 ) ;
if ( ! V_2 ) {
F_181 ( & V_43 -> V_231 , L_49 ) ;
V_84 = - V_151 ;
goto V_268;
}
F_2 ( & V_43 -> V_6 ) ;
...
F_182 ( & V_43 -> V_271 , F_177 , ( unsigned long ) V_43 ) ;
F_183 ( & V_43 -> V_271 , V_75 + V_272 ) ;
F_4 ( & V_43 -> V_6 ) ;
V_23 = F_168 ( V_43 , V_241 ) ;
F_2 ( & V_43 -> V_6 ) ;
...
{
struct V_42 * V_43 = F_193 ( F_48 ( V_90 ) , V_277 ) ;
int V_84 ;
V_84 = F_179 ( V_43 ) ;
...
static int F_195 ( struct V_150 * V_49 , struct V_282 * V_231 )
{
struct V_232 * V_283 = & V_231 -> V_232 ;
struct V_21 * V_284 = F_196 ( V_231 ) ;
struct V_42 * V_43 ;
struct V_285 V_286 ;
int V_287 , V_288 ;
int V_46 ;
...
F_199 () ;
V_43 -> V_46 = V_46 ;
F_200 ( & V_286 , V_231 -> V_291 ) ;
while ( F_201 ( & V_286 , & V_287 , & V_288 ) ) {
...
F_204 ( & V_43 -> V_277 , F_192 ) ;
V_43 -> V_49 = V_49 ;
F_205 ( & V_43 -> V_296 , & V_49 -> V_297 ) ;
F_167 ( & V_43 -> V_231 , L_52 ,
( unsigned long long ) V_43 -> V_233 ) ;
if ( V_284 -> V_298 ) {
V_49 -> V_299 = V_43 ;
if ( V_300 ) {
struct V_1 * V_2 ;
V_2 = F_170 ( V_43 , V_263 ) ;
if ( ! F_206 ( V_2 ) ) {
struct V_250 V_251 ;
F_2 ( & V_43 -> V_6 ) ;
V_43 -> V_2 = V_2 ;
...
static int F_210 ( struct V_282 * V_231 )
{
struct V_21 * V_284 = F_196 ( V_231 ) ;
...
V_303 = F_218 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_311 ,
...
if ( V_300 ) {
struct V_232 * V_313 ;
V_313 = F_218 ( & V_49 -> V_155 [ V_14 ] -> V_2 ,
V_274 ,
...
if ( ! F_220 ( V_314 ) ) {
V_49 -> V_315 = F_221 ( F_142 ( & V_231 -> V_232 ) ,
V_314 ) ;
if ( ! F_220 ( V_49 -> V_315 ) ) {
F_222 ( L_57 , 0444 , V_49 -> V_315 ,
V_49 , & V_316 ) ;
F_222 ( L_58 , 0444 , V_49 -> V_315 ,
V_49 , & V_317 ) ;
}
}
F_205 ( & V_49 -> V_296 , & V_318 ) ;
F_223 ( & V_231 , L_59 ,
F_142 ( V_35 -> V_232 ) , ( unsigned long long ) V_35 -> V_233 ) ;
V_84 = F_195 ( V_49 , V_231 ) ;
if ( ! V_84 )
return 0 ;
F_181 ( & V_231 , L_60 , V_84 ) ;
F_224 ( V_49 -> V_315 ) ;
F_209 ( & V_49 -> V_296 ) ;
if ( V_300 )
F_186 ( V_274 ,
...
F_186 ( V_311 , V_49 -> V_155 [ V_14 ] -> V_145 ) ;
...
static int F_225 ( struct V_282 * V_231 ,
const struct V_319 * V_275 )
{
struct V_150 * V_49 ;
int V_84 ;
F_71 ( & V_320 ) ;
V_49 = F_188 ( F_196 ( V_231 ) -> V_35 ) ;
if ( ! V_49 )
V_84 = F_210 ( V_231 ) ;
else
V_84 = F_195 ( V_49 , V_231 ) ;
...
static void F_226 ( struct V_282 * V_231 )
{
struct V_42 * V_43 = F_227 ( & V_231 -> V_232 ) ;
...
F_224 ( V_49 -> V_315 ) ;
for ( V_152 = 0 ; V_152 < V_263 ; ++ V_152 )
F_185 ( V_311 , V_49 -> V_155 [ V_152 ] ) ;
if ( V_300 )
F_185 ( V_274 , V_49 -> V_155 [ V_152 ] ) ;
F_83 ( & V_49 -> V_149 , F_75 ) ;
}
F_73 ( & V_320 ) ;
}
static void F_229 ( struct V_282 * V_231 )
{
struct V_21 * V_284 = F_196 ( V_231 ) ;
struct V_42 * V_43 = F_227 ( & V_231 -> V_232 ) ;
int V_46 ;
...
case V_242 :
if ( F_233 ( & V_43 -> V_90 ) ) {
F_181 ( & V_43 -> V_231 , L_66 ) ;
V_23 = V_123 ;
} else {
V_43 -> V_321 . V_244 = V_241 -> V_244 ;
V_43 -> V_281 = F_230 ;
F_234 ( V_328 , & V_43 -> V_90 ) ;
}
break;
case V_245 :
if ( V_43 -> V_218 != V_267 ) {
...
F_223 ( & V_43 -> V_231 , L_67 ) ;
V_2 = F_178 ( V_43 ) ;
} else {
struct V_1 * V_196 = V_43 -> V_2 ;
F_162 ( V_43 , & V_241 -> V_246 ) ;
F_4 ( & V_43 -> V_6 ) ;
F_40 ( V_196 ) ;
F_2 ( & V_43 -> V_6 ) ;
}
...
F_223 ( & V_43 -> V_231 , L_69 ) ;
V_2 = F_178 ( V_43 ) ;
V_264 = true ;
}
break;
default:
F_181 ( & V_43 -> V_231 , L_70 ,
...
switch ( V_44 ) {
case V_121 :
V_23 = F_232 ( V_43 , V_241 , V_45 , V_37 ) ;
break;
default:
V_23 = V_124 ;
}
...
V_314 = F_221 ( V_330 , NULL ) ;
if ( V_263 + V_329 > V_331 )
V_263 = V_331 - V_329 ;
V_154 = V_263 + V_329 ;
V_311 = F_237 ( V_146 , V_332
| V_333 ) ;
if ( F_206 ( V_311 ) ) {
V_84 = F_219 ( V_311 ) ;
goto V_334;
