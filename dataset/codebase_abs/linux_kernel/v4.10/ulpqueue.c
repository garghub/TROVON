...
struct V_15 * V_54 , T_5 V_90 )
{
T_5 V_91 = 0 ;
T_2 V_46 , V_92 ;
struct V_8 * V_9 , * V_93 , * V_53 ;
struct V_10 * V_11 ;
struct V_94 * V_95 ;
...
V_11 = F_5 ( V_9 ) ;
V_46 = V_11 -> V_46 ;
if ( F_48 ( V_46 , F_47 ( V_95 ) ) )
break;
V_91 += F_61 ( V_9 ) ;
V_93 = F_38 ( V_9 ) -> V_55 ;
for ( V_53 = V_93 ; V_93 ; V_93 = V_93 -> V_56 ) {
V_53 = V_93 ;
V_91 += F_61 ( V_53 ) ;
}
if ( V_53 )
...
V_14 ) ;
if ( V_100 )
F_11 ( & V_22 -> V_26 , F_12 ( V_100 ) ) ;
if ( ( F_24 ( V_2 ) || V_100 ) && ! V_24 -> V_42 ) {
V_24 -> V_42 = 1 ;
V_22 -> V_43 ( V_22 ) ;
}
}
