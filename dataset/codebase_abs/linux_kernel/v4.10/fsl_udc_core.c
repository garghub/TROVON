...
static void F_89 ( struct V_21 * V_19 )
{
T_1 V_40 ;
...
static int F_90 ( struct V_21 * V_19 , int V_230 )
{
...
static void F_91 ( struct V_21 * V_19 , T_5 V_238 )
{
struct V_14 * V_15 = F_92 ( V_19 , V_238 ) ;
if ( V_15 -> V_36 )
F_25 ( V_15 , - V_35 ) ;
}
static void F_93 ( struct V_21 * V_19 , T_6 V_115 , T_6 V_239 , T_6 V_38 )
{
...
static void F_94 ( struct V_21 * V_19 , T_5 V_243 , T_6 V_115 ,
T_6 V_239 , T_6 V_38 )
{
T_6 V_40 = 0 ;
struct V_16 * V_17 ;
...
static void F_97 ( struct V_21 * V_19 ,
struct V_254 * V_255 )
__releases( V_19 -> V_20 )
__acquires( V_19 -> V_20 )
{
T_6 V_256 = F_98 ( V_255 -> V_256 ) ;
T_6 V_257 = F_98 ( V_255 -> V_257 ) ;
T_6 V_258 = F_98 ( V_255 -> V_258 ) ;
F_91 ( V_19 , 0 ) ;
switch ( V_255 -> V_259 ) {
case V_260 :
...
!= ( V_154 | V_263 ) )
break;
F_94 ( V_19 , V_255 -> V_261 , V_256 , V_257 , V_258 ) ;
return;
case V_264 :
if ( V_255 -> V_261 != ( V_233 | V_263
| V_245 ) )
break;
F_93 ( V_19 , V_256 , V_257 , V_258 ) ;
return;
case V_265 :
case V_266 :
{
...
== ( V_249 | V_263 ) ) {
int V_238 = F_95 ( V_257 ) ;
struct V_14 * V_15 ;
if ( V_256 != 0 || V_258 != 0 || V_238 >= V_19 -> V_269 )
break;
V_15 = F_92 ( V_19 , V_238 ) ;
F_22 ( & V_19 -> V_20 ) ;
...
static void F_101 ( struct V_21 * V_19 , struct V_14 * V_280 ,
struct V_16 * V_17 )
{
if ( V_19 -> V_241 == V_242 ) {
...
static void F_102 ( struct V_21 * V_19 , T_5 V_42 , T_5 * V_284 )
{
T_1 V_96 ;
struct V_122 * V_162 ;
...
static int F_103 ( struct V_21 * V_19 , int V_238 ,
struct V_16 * V_290 )
{
struct V_23 * V_24 ;
...
static void F_104 ( struct V_21 * V_19 )
{
T_1 V_303 ;
...
static inline enum V_309 F_107 ( T_1 V_310 )
{
switch ( V_310 & V_311 ) {
case V_312 :
return V_313 ;
...
static int F_111 ( struct V_21 * V_19 , bool V_318 )
{
T_5 V_238 ;
...
F_22 ( & V_19 -> V_20 ) ;
if ( V_318 )
F_112 ( & V_19 -> V_34 , V_19 -> V_147 ) ;
else
V_19 -> V_147 -> V_326 ( & V_19 -> V_34 ) ;
F_24 ( & V_19 -> V_20 ) ;
return 0 ;
}
static void F_113 ( struct V_21 * V_19 )
{
T_1 V_96 ;
unsigned long V_45 ;
...
static T_7 F_114 ( int V_329 , void * V_330 )
{
...
static int F_117 ( struct V_216 * V_342 )
{
struct V_14 * V_346 ;
unsigned long V_144 ;
if ( ! F_86 ( V_9 -> V_228 ) )
F_116 ( V_9 -> V_228 -> V_345 , NULL ) ;
F_42 ( V_9 ) ;
V_9 -> V_241 = V_328 ;
V_9 -> V_208 = V_209 ;
V_9 -> V_210 = 0 ;
...
static int F_118 ( struct V_347 * V_348 , void * V_2 )
{
unsigned long V_144 ;
int V_304 ;
T_1 V_349 ;
...
F_119 ( V_348 , L_100 , V_304 , V_349 ) ;
}
V_349 = F_31 ( & V_46 -> V_166 ) ;
F_119 ( V_348 , L_101 , V_349 ) ;
#ifndef F_39
if ( V_19 -> V_4 -> V_52 ) {
V_349 = V_54 -> V_94 ;
F_119 ( V_348 , L_102 , V_349 ) ;
V_349 = V_54 -> V_55 ;
F_119 ( V_348 , L_103 , V_349 ) ;
}
#endif
V_15 = & V_19 -> V_234 [ 0 ] ;
F_119 ( V_348 , L_104 ,
V_15 -> V_15 . V_36 , F_120 ( V_15 ) , F_54 ( V_15 ) ) ;
if ( F_27 ( & V_15 -> V_27 ) ) {
F_121 ( V_348 , L_105 ) ;
} else {
F_77 (req, &ep->queue, queue) {
...
static int F_122 ( struct V_355 * V_355 , struct V_356 * V_356 )
{
return F_123 ( V_356 , F_118 , NULL ) ;
}
static void F_124 ( struct V_357 * V_358 )
{
V_198 ( V_9 -> F_16 ) ;
F_125 ( V_358 -> V_359 , V_9 -> V_360 ,
V_9 -> V_82 , V_9 -> V_79 ) ;
F_61 ( V_9 ) ;
}
static int F_126 ( struct V_21 * V_19 ,
struct V_361 * V_362 )
{
struct V_3 * V_4 ;
T_8 V_211 ;
V_4 = F_127 ( & V_362 -> V_358 ) ;
V_19 -> V_50 = V_4 -> V_50 ;
...
V_19 -> V_82 = F_128 ( & V_362 -> V_358 , V_211 ,
& V_19 -> V_79 , V_363 ) ;
if ( ! V_19 -> V_82 ) {
F_37 ( L_111 ) ;
F_61 ( V_19 -> V_234 ) ;
...
struct V_16 , V_17 ) ;
V_19 -> V_231 -> V_17 . V_199 = F_129 ( 8 , V_363 ) ;
V_19 -> V_320 = V_365 ;
V_19 -> V_241 = V_366 ;
V_19 -> V_210 = 0 ;
V_19 -> V_220 = 0 ;
...
static int F_130 ( struct V_21 * V_19 , unsigned char V_239 ,
char * V_36 , int V_367 )
{
...
F_131 ( & V_15 -> V_15 , ( unsigned short ) ~ 0 ) ;
F_59 ( & V_15 -> V_27 ) ;
if ( V_367 )
...
static int F_132 ( struct V_361 * V_362 )
{
struct V_3 * V_4 ;
struct V_378 * V_379 ;
int V_197 = - V_212 ;
...
#endif
V_379 = F_136 ( V_362 , V_384 , 0 ) ;
if ( ! V_379 ) {
V_197 = - V_385 ;
goto V_383;
}
if ( V_4 -> V_380 == V_386 ) {
if ( ! F_137 ( V_379 -> V_387 , F_138 ( V_379 ) ,
V_351 ) ) {
...
V_46 = F_139 ( V_379 -> V_387 , F_138 ( V_379 ) ) ;
if ( ! V_46 ) {
V_197 = - V_195 ;
goto V_389;
}
...
V_9 -> V_329 = F_141 ( V_362 , 0 ) ;
if ( ! V_9 -> V_329 ) {
V_197 = - V_212 ;
goto V_395;
}
V_197 = F_142 ( V_9 -> V_329 , F_114 , V_397 ,
V_351 , V_9 ) ;
if ( V_197 != 0 ) {
F_37 ( L_115 ,
V_9 -> V_329 , V_197 ) ;
...
F_131 ( & V_9 -> V_234 [ 0 ] . V_15 ,
V_136 ) ;
for ( V_304 = 1 ; V_304 < ( int ) ( V_9 -> V_269 / 2 ) ; V_304 ++ ) {
char V_36 [ 14 ] ;
sprintf ( V_36 , L_119 , V_304 ) ;
F_130 ( V_9 , V_304 * 2 , V_36 , 1 ) ;
sprintf ( V_36 , L_120 , V_304 ) ;
F_130 ( V_9 , V_304 * 2 + 1 , V_36 , 1 ) ;
}
V_9 -> V_32 = F_145 ( L_121 , & V_362 -> V_358 ,
sizeof( struct V_23 ) ,
V_403 , V_404 ) ;
if ( V_9 -> V_32 == NULL ) {
V_197 = - V_195 ;
...
V_197 = F_146 ( & V_362 -> V_358 , & V_9 -> V_34 ,
F_124 ) ;
if ( V_197 )
goto V_405;
F_147 () ;
...
V_389:
if ( V_4 -> V_380 == V_386 )
F_152 ( V_379 -> V_387 , F_138 ( V_379 ) ) ;
V_383:
F_61 ( V_9 ) ;
V_9 = NULL ;
return V_197 ;
}
static int F_153 ( struct V_361 * V_362 )
{
struct V_378 * V_379 = F_136 ( V_362 , V_384 , 0 ) ;
struct V_3 * V_4 = F_127 ( & V_362 -> V_358 ) ;
F_154 ( F_16 ) ;
if ( ! V_9 )
return - V_212 ;
V_9 -> F_16 = & F_16 ;
...
static int F_158 ( struct V_361 * V_362 , T_9 V_406 )
{
F_42 ( V_9 ) ;
return 0 ;
}
static int F_159 ( struct V_361 * V_362 )
{
if ( V_9 -> V_22 ) {
F_29 ( V_9 ) ;
F_41 ( V_9 ) ;
...
static int F_160 ( struct V_357 * V_358 , T_9 V_406 )
{
struct V_21 * V_19 = V_9 ;
T_1 V_407 , V_67 ;
...
static int F_162 ( struct V_357 * V_358 )
{
F_43 ( L_126 , V_104 ,
V_9 -> V_22 , V_9 -> V_408 ) ;
if ( V_9 -> V_408 ) {
