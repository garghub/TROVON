...
if ( ! V_15 )
return - V_48 ;
if ( F_81 ( V_143 , & V_134 -> V_128 ) )
V_15 -> V_16 = true ;
V_94 = F_82 ( V_141 , L_3 , L_4 ) ;
if ( V_94 < 0 ) {
F_83 ( V_128 , L_5 , V_141 -> V_144 ) ;
return - V_145 ;
}
V_6 = F_84 ( V_128 , V_94 , sizeof( * V_6 ) , V_93 ) ;
if ( ! V_6 )
return - V_48 ;
...
struct V_140 * V_147 = F_85 ( V_141 , L_6 , V_39 ) ;
V_40 = F_86 ( V_147 , 0 , & V_139 ) ;
F_87 ( V_147 ) ;
if ( V_40 ) {
F_83 ( V_128 , L_7 ) ;
goto V_148;
...
V_146 = F_88 ( & V_139 ) ;
V_131 -> V_22 = F_89 ( V_128 , V_139 . V_149 , V_146 ) ;
if ( ! V_131 -> V_22 ) {
F_83 ( V_128 , L_8 ) ;
V_40 = - V_150 ;
goto V_148;
...
if ( ! V_40 ) {
V_131 -> V_41 = F_93 ( V_31 , V_39 ) ;
if ( ! F_94 ( V_131 -> V_41 ) )
continue;
V_40 = F_95 ( V_131 -> V_41 ) ;
if ( V_40 != - V_156 )
F_83 ( V_128 , L_9 ,
V_39 , V_40 ) ;
}
...
V_120 . V_158 = F_41 ;
V_15 -> V_42 = V_159 ;
for ( V_39 = 0 ; V_39 < F_96 ( V_160 ) ; V_39 ++ )
F_97 ( V_160 [ V_39 ] ,
V_15 -> V_44 ) ;
}
V_40 = F_60 ( V_15 ) ;
...
F_68 ( V_15 -> V_125 ) ) ;
V_15 -> V_120 = & V_120 ;
V_40 = F_99 ( & V_128 -> V_135 , V_136 ) ;
if ( V_40 )
F_83 ( V_128 , L_12 ) ;
return F_100 ( V_128 -> V_142 , NULL , NULL , V_128 ) ;
}
