...
struct V_10 * F_79 ( struct V_22 * V_12 ,
struct V_144 * V_145 , struct V_73 * V_74 )
{
struct V_10 * V_11 ;
int V_35 ;
F_4 ( V_12 , L_40 , V_74 -> V_112 ) ;
V_11 = F_17 ( V_12 , sizeof( * V_11 ) , V_51 ) ;
if ( V_11 == NULL )
return NULL ;
F_80 ( & V_11 -> V_146 ) ;
F_81 ( & V_11 -> V_100 ) ;
V_11 -> V_12 = V_12 ;
V_11 -> V_57 = V_74 -> V_57 ;
V_11 -> V_147 = V_145 -> V_147 ;
V_11 -> V_145 = V_145 ;
V_11 -> V_112 = V_74 -> V_112 ;
V_11 -> V_49 = V_74 -> V_49 ;
V_11 -> V_36 = V_145 -> V_36 ;
V_11 -> V_74 = V_74 ;
F_52 ( & V_11 -> V_123 ) ;
F_52 ( & V_11 -> V_41 ) ;
F_52 ( & V_11 -> V_39 ) ;
...
F_52 ( & V_11 -> V_108 ) ;
if ( V_11 -> V_36 -> V_148 ) {
V_35 = V_11 -> V_36 -> V_148 ( V_11 , V_74 ) ;
if ( V_35 < 0 )
return NULL ;
}
V_35 = F_82 ( V_11 -> V_49 , V_11 -> V_36 -> V_149 ,
V_145 -> V_150 , V_151 , L_41 , V_11 ) ;
if ( V_35 )
goto V_152;
V_35 = F_35 ( V_11 ) ;
if ( V_35 )
