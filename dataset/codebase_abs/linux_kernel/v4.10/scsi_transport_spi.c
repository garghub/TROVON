...
int F_105 ( unsigned char * V_143 , struct V_149 * V_8 )
{
if ( V_8 -> V_150 & V_151 ) {
* V_143 ++ = V_152 ;
...
static void F_106 ( const unsigned char * V_143 , int V_155 , int V_156 , int V_114 )
{
if ( V_155 ) {
char V_56 [ 20 ] ;
F_59 ( V_56 , V_143 [ V_155 ] ) ;
F_107 ( L_37 , V_56 ) ;
}
if ( V_156 )
F_107 ( L_38 , V_143 [ V_156 ] ) ;
if ( V_114 )
F_107 ( L_39 , 8 << V_143 [ V_114 ] ) ;
}
static void F_108 ( const unsigned char * V_143 , int V_157 , const char * V_158 )
{
int V_82 = ( V_143 [ V_157 ] << 24 ) | ( V_143 [ V_157 + 1 ] << 16 ) | ( V_143 [ V_157 + 2 ] << 8 ) |
V_143 [ V_157 + 3 ] ;
F_107 ( L_40 , V_158 , V_82 ) ;
}
int F_109 ( const unsigned char * V_143 )
{
int V_30 = 1 , V_15 ;
if ( V_143 [ 0 ] == V_144 ) {
V_30 = 2 + V_143 [ 1 ] ;
if ( V_30 == 2 )
V_30 += 256 ;
if ( V_143 [ 2 ] < F_7 ( V_159 ) )
F_107 ( L_41 , V_159 [ V_143 [ 2 ] ] ) ;
else
F_107 ( L_42 ,
( int ) V_143 [ 2 ] ) ;
switch ( V_143 [ 2 ] ) {
...
if ( V_143 [ 0 ] < F_7 ( V_162 ) && V_162 [ V_143 [ 0 ] ] )
F_107 ( L_41 , V_162 [ V_143 [ 0 ] ] ) ;
else
F_107 ( L_51 , V_143 [ 0 ] ) ;
} else if ( V_143 [ 0 ] == 0x55 ) {
F_107 ( L_52 ) ;
} else if ( V_143 [ 0 ] <= 0x2f ) {
if ( ( V_143 [ 0 ] - 0x20 ) < F_7 ( V_163 ) )
F_107 ( L_53 , V_163 [ V_143 [ 0 ] - 0x20 ] ,
V_143 [ 1 ] ) ;
else
F_107 ( L_54 ,
V_143 [ 0 ] , V_143 [ 1 ] ) ;
...
static int F_111 ( struct V_39 * V_40 ,
struct V_34 * V_35 )
{
struct V_37 * V_38 ;
struct V_46 * V_47 ;
...
static int F_113 ( struct V_32 * V_33 ,
struct V_34 * V_35 ,
struct V_34 * V_36 )
{
struct V_167 * V_168 = & V_36 -> V_168 ;
struct V_37 * V_38 = F_69 ( V_36 ) ;
struct V_67 * V_169 = F_64 ( V_38 -> V_41 ) ;
struct V_170 * V_55 = & V_171 . V_55 ;
int V_172 = 0 ;
if ( V_169 -> V_71 -> V_78 )
V_172 = F_114 ( V_168 , V_55 , V_55 -> V_173 | V_174 ) ;
return V_172 ;
}
static T_6 F_115 ( struct V_167 * V_168 ,
struct V_170 * V_55 , int V_15 )
{
struct V_34 * V_36 = F_96 ( V_168 , struct V_34 , V_168 ) ;
struct V_46 * V_47 = F_57 ( V_36 ) ;
struct V_37 * V_38 = F_69 ( V_36 ) ;
struct V_67 * V_169 = F_64 ( V_38 -> V_41 ) ;
if ( V_55 == & V_175 . V_55 &&
...
V_15 -> V_165 . V_166 . V_43 . V_198 = F_111 ;
F_120 ( & V_15 -> V_165 . V_166 ) ;
V_15 -> V_165 . V_199 = sizeof( struct V_68 ) ;
V_15 -> V_165 . V_42 . V_43 . V_44 = & V_45 . V_44 ;
V_15 -> V_165 . V_42 . V_43 . V_197 = & V_200 ;
V_15 -> V_165 . V_42 . V_43 . V_198 = F_12 ;
F_120 ( & V_15 -> V_165 . V_42 ) ;
V_15 -> V_165 . V_201 = sizeof( struct V_202 ) ;
V_15 -> V_71 = V_195 ;
return & V_15 -> V_165 ;
}
void F_121 ( struct V_193 * V_165 )
{
struct V_67 * V_15 = F_64 ( V_165 ) ;
F_122 ( & V_15 -> V_165 . V_166 ) ;
F_122 ( & V_15 -> V_165 . V_42 ) ;
F_93 ( V_15 ) ;
}
static T_7 int F_123 ( void )
{
int error = F_124 ( V_51 ,
L_57 ) ;
if ( ! error ) {
int V_15 ;
