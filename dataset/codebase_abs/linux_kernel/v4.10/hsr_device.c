...
F_40 ( V_39 ) ;
if ( V_41 > 0 ) {
V_44 = ( F_41 ( V_44 ) ) F_42 ( V_39 , sizeof( struct V_44 ) ) ;
V_44 -> V_60 = F_38 ( V_53 ) ;
F_43 ( V_44 , V_61 ) ;
}
V_46 = ( F_41 ( V_46 ) ) F_42 ( V_39 , sizeof( struct V_45 ) ) ;
F_44 ( V_46 , ( V_41 ? 0x0 : 0xf ) ) ;
F_45 ( V_46 , V_41 ) ;
...
F_47 ( & V_9 -> V_19 -> V_62 , V_49 ) ;
V_46 -> V_65 = type ;
V_46 -> V_66 = V_41 ? sizeof( struct V_47 ) : 12 ;
V_48 = ( F_41 ( V_48 ) ) F_42 ( V_39 , sizeof( struct V_47 ) ) ;
F_48 ( V_48 -> V_67 , V_9 -> V_2 -> V_57 ) ;
F_49 ( V_39 , V_68 + V_28 ) ;
F_33 ( V_39 , V_9 ) ;
return;
V_59:
...
static void F_52 ( unsigned long V_69 )
{
struct V_18 * V_19 ;
struct V_8 * V_9 ;
...
static void F_53 ( struct V_1 * V_16 )
{
struct V_18 * V_19 ;
struct V_8 * V_14 ;
V_19 = F_16 ( V_16 ) ;
...
inline bool F_64 ( struct V_1 * V_2 )
{
return ( V_2 -> V_78 -> V_94 == F_32 ) ;
}
int F_65 ( struct V_1 * V_16 , struct V_1 * V_95 [ 2 ] ,
unsigned char V_96 , T_2 V_97 )
{
struct V_18 * V_19 ;
struct V_8 * V_14 ;
int V_98 ;
...
F_66 ( & V_19 -> V_100 ) ;
F_66 ( & V_19 -> V_101 ) ;
F_48 ( V_16 -> V_57 , V_95 [ 0 ] -> V_57 ) ;
V_98 = F_67 ( & V_19 -> V_101 , V_16 -> V_57 ,
V_95 [ 1 ] -> V_57 ) ;
if ( V_98 < 0 )
return V_98 ;
F_68 ( & V_19 -> V_62 ) ;
V_19 -> V_63 = V_102 ;
V_19 -> V_64 = V_103 ;
F_69 ( & V_19 -> V_21 , F_52 , ( unsigned long ) V_19 ) ;
F_69 ( & V_19 -> V_74 , V_104 , ( unsigned long ) V_19 ) ;
F_48 ( V_19 -> V_56 , V_105 ) ;
V_19 -> V_56 [ V_106 - 1 ] = V_96 ;
V_19 -> V_70 = V_97 ;
F_14 ( V_16 ) ;
V_98 = F_70 ( V_19 , V_16 , V_15 ) ;
if ( V_98 )
return V_98 ;
V_98 = F_71 ( V_16 ) ;
if ( V_98 )
goto V_107;
V_98 = F_70 ( V_19 , V_95 [ 0 ] , V_32 ) ;
if ( V_98 )
goto V_107;
V_98 = F_70 ( V_19 , V_95 [ 1 ] , V_33 ) ;
if ( V_98 )
goto V_107;
F_72 ( & V_19 -> V_74 , V_23 + F_17 ( V_108 ) ) ;
return 0 ;
V_107:
F_11 (hsr, port)
F_55 ( V_14 ) ;
