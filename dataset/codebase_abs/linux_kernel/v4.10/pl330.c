...
{
int V_213 , V_193 ;
if ( ( V_136 -> V_7 . V_10 & 0xfffff ) != V_259 ) {
...
F_85 ( struct V_263 * V_264 )
{
if ( ! V_264 )
return NULL ;
return F_86 ( V_264 , struct V_206 , V_72 ) ;
}
static inline struct V_119 *
F_87 ( struct V_265 * V_266 )
{
return F_86 ( V_266 , struct V_119 , V_267 ) ;
}
...
V_126 , __LINE__ , V_4 -> V_267 . V_270 ) ;
F_58 ( & V_207 -> V_211 ) ;
}
}
}
...
if ( ! V_207 -> V_273 )
F_91 ( & V_4 -> V_267 ) ;
F_92 ( & V_4 -> V_274 , & V_207 -> V_275 ) ;
}
F_88 ( V_207 ) ;
if ( F_93 ( & V_207 -> V_276 ) ) {
F_94 ( & V_207 -> V_269 -> V_5 -> V_200 ) ;
F_36 ( V_207 -> V_269 ) ;
F_95 ( & V_207 -> V_269 -> V_5 -> V_200 ) ;
V_272 = true ;
V_207 -> V_228 = false ;
} else {
F_94 ( & V_207 -> V_269 -> V_5 -> V_200 ) ;
...
while ( ! F_93 ( & V_207 -> V_275 ) ) {
struct V_277 V_278 ;
V_4 = F_96 ( & V_207 -> V_275 ,
struct V_119 , V_274 ) ;
F_97 ( & V_4 -> V_267 , & V_278 ) ;
if ( V_207 -> V_273 ) {
V_4 -> V_209 = V_279 ;
F_92 ( & V_4 -> V_274 , & V_207 -> V_276 ) ;
if ( V_272 ) {
V_207 -> V_228 = true ;
F_94 ( & V_207 -> V_269 -> V_5 -> V_200 ) ;
F_40 ( V_207 -> V_269 ) ;
...
V_4 -> V_209 = FREE ;
F_92 ( & V_4 -> V_274 , & V_207 -> V_5 -> V_280 ) ;
}
F_98 ( & V_4 -> V_267 ) ;
if ( F_99 ( & V_278 ) ) {
F_56 ( & V_207 -> V_200 , V_192 ) ;
...
bool F_103 ( struct V_263 * V_72 , void * V_281 )
{
T_2 * V_282 ;
if ( V_72 -> V_283 -> V_89 -> V_284 != & V_285 . V_286 )
return false ;
V_282 = V_72 -> V_287 ;
return * V_282 == ( unsigned long ) V_281 ;
}
static struct V_263 * F_104 ( struct V_288 * V_289 ,
struct V_290 * V_291 )
{
int V_292 = V_289 -> V_293 ;
struct V_135 * V_136 = V_291 -> V_294 ;
unsigned int V_295 ;
if ( ! V_136 )
return NULL ;
if ( V_292 != 1 )
return NULL ;
V_295 = V_289 -> args [ 0 ] ;
if ( V_295 >= V_136 -> V_296 )
return NULL ;
return F_105 ( & V_136 -> V_297 [ V_295 ] . V_72 ) ;
}
static int F_106 ( struct V_263 * V_72 )
{
...
static int V_132 ( struct V_263 * V_72 ,
struct V_298 * V_299 )
{
struct V_206 * V_207 = F_85 ( V_72 ) ;
if ( V_299 -> V_300 == V_140 ) {
if ( V_299 -> V_160 )
V_207 -> V_301 = V_299 -> V_160 ;
if ( V_299 -> V_302 )
V_207 -> V_303 = F_108 ( V_299 -> V_302 ) ;
if ( V_299 -> V_304 )
V_207 -> V_305 = V_299 -> V_304 ;
} else if ( V_299 -> V_300 == V_141 ) {
if ( V_299 -> V_159 )
V_207 -> V_301 = V_299 -> V_159 ;
if ( V_299 -> V_306 )
V_207 -> V_303 = F_108 ( V_299 -> V_306 ) ;
if ( V_299 -> V_307 )
V_207 -> V_305 = V_299 -> V_307 ;
}
return 0 ;
}
static int F_109 ( struct V_263 * V_72 )
{
struct V_206 * V_207 = F_85 ( V_72 ) ;
struct V_119 * V_4 ;
unsigned long V_192 ;
...
F_36 ( V_207 -> V_269 ) ;
F_95 ( & V_136 -> V_200 ) ;
V_207 -> V_269 -> V_3 [ 0 ] . V_4 = NULL ;
V_207 -> V_269 -> V_3 [ 1 ] . V_4 = NULL ;
V_207 -> V_269 -> V_123 = - 1 ;
V_272 = V_207 -> V_228 ;
V_207 -> V_228 = false ;
...
F_112 ( & V_207 -> V_309 , & V_136 -> V_280 ) ;
F_112 ( & V_207 -> V_276 , & V_136 -> V_280 ) ;
F_112 ( & V_207 -> V_275 , & V_136 -> V_280 ) ;
F_56 ( & V_207 -> V_200 , V_192 ) ;
...
static int F_113 ( struct V_263 * V_72 )
{
struct V_206 * V_207 = F_85 ( V_72 ) ;
struct V_135 * V_136 = V_207 -> V_5 ;
unsigned long V_192 ;
...
static void F_114 ( struct V_263 * V_72 )
{
struct V_206 * V_207 = F_85 ( V_72 ) ;
struct V_135 * V_136 = V_207 -> V_5 ;
unsigned long V_192 ;
...
V_207 -> V_269 = NULL ;
if ( V_207 -> V_273 )
F_112 ( & V_207 -> V_276 , & V_207 -> V_5 -> V_280 ) ;
F_56 ( & V_136 -> V_200 , V_192 ) ;
F_101 ( V_207 -> V_5 -> V_88 . V_89 ) ;
F_102 ( V_207 -> V_5 -> V_88 . V_89 ) ;
}
...
static enum V_310
F_118 ( struct V_263 * V_72 , T_5 V_270 ,
struct V_311 * V_312 )
{
enum V_310 V_193 ;
unsigned long V_192 ;
struct V_119 * V_4 , * V_313 = NULL , * V_314 = NULL ;
struct V_206 * V_207 = F_85 ( V_72 ) ;
unsigned int V_315 , V_316 = 0 ;
V_193 = F_119 ( V_72 , V_270 , V_312 ) ;
if ( ! V_312 )
return V_193 ;
if ( V_193 == V_317 )
goto V_318;
F_55 ( & V_207 -> V_200 , V_192 ) ;
F_94 ( & V_207 -> V_269 -> V_5 -> V_200 ) ;
if ( V_207 -> V_269 -> V_123 != - 1 )
V_313 = V_207 -> V_269 -> V_3 [ V_207 -> V_269 -> V_123 ] . V_4 ;
V_314 = V_207 -> V_269 -> V_3 [ V_207 -> V_269 -> V_122 ] . V_4 ;
F_89 (desc, &pch->work_list, node) {
if ( V_4 -> V_209 == V_210 )
V_315 = V_4 -> V_319 ;
else if ( V_313 && V_4 == V_313 )
V_315 =
F_115 ( V_207 , V_4 ) ;
else if ( V_4 -> V_209 == V_268 )
if ( V_4 == V_314 )
V_315 = 0 ;
else
V_315 = V_4 -> V_319 ;
...
static void F_122 ( struct V_263 * V_72 )
{
struct V_206 * V_207 = F_85 ( V_72 ) ;
unsigned long V_192 ;
F_55 ( & V_207 -> V_200 , V_192 ) ;
if ( F_93 ( & V_207 -> V_276 ) ) {
F_120 ( F_93 ( & V_207 -> V_309 ) ) ;
V_207 -> V_228 = true ;
F_111 ( V_207 -> V_5 -> V_88 . V_89 ) ;
}
F_112 ( & V_207 -> V_309 , & V_207 -> V_276 ) ;
F_56 ( & V_207 -> V_200 , V_192 ) ;
F_90 ( ( unsigned long ) V_207 ) ;
}
static T_5 F_123 ( struct V_265 * V_266 )
{
struct V_119 * V_4 , * V_321 = F_87 ( V_266 ) ;
struct V_206 * V_207 = F_85 ( V_266 -> V_72 ) ;
T_5 V_270 ;
unsigned long V_192 ;
F_55 ( & V_207 -> V_200 , V_192 ) ;
while ( ! F_93 ( & V_321 -> V_274 ) ) {
V_4 = F_124 ( V_321 -> V_274 . V_322 , struct V_119 , V_274 ) ;
if ( V_207 -> V_273 ) {
V_4 -> V_267 . V_323 = V_321 -> V_267 . V_323 ;
V_4 -> V_267 . V_324 = V_321 -> V_267 . V_324 ;
}
V_4 -> V_321 = false ;
F_125 ( & V_4 -> V_267 ) ;
F_92 ( & V_4 -> V_274 , & V_207 -> V_309 ) ;
}
V_321 -> V_321 = true ;
V_270 = F_125 ( & V_321 -> V_267 ) ;
F_62 ( & V_321 -> V_274 , & V_207 -> V_309 ) ;
F_56 ( & V_207 -> V_200 , V_192 ) ;
return V_270 ;
}
static inline void F_126 ( struct V_119 * V_4 )
{
V_4 -> V_124 . V_189 = V_325 ;
V_4 -> V_124 . V_185 = V_326 ;
V_4 -> V_124 . V_187 = V_326 ;
V_4 -> V_267 . V_327 = F_123 ;
F_79 ( & V_4 -> V_274 ) ;
}
static int F_127 ( struct V_135 * V_136 , T_6 V_328 , int V_292 )
{
struct V_119 * V_4 ;
unsigned long V_192 ;
int V_213 ;
V_4 = F_128 ( V_292 , sizeof( * V_4 ) , V_328 ) ;
if ( ! V_4 )
return 0 ;
F_55 ( & V_136 -> V_329 , V_192 ) ;
for ( V_213 = 0 ; V_213 < V_292 ; V_213 ++ ) {
F_126 ( & V_4 [ V_213 ] ) ;
F_62 ( & V_4 [ V_213 ] . V_274 , & V_136 -> V_280 ) ;
}
F_56 ( & V_136 -> V_329 , V_192 ) ;
return V_292 ;
}
...
F_55 ( & V_136 -> V_329 , V_192 ) ;
if ( ! F_93 ( & V_136 -> V_280 ) ) {
V_4 = F_124 ( V_136 -> V_280 . V_322 ,
struct V_119 , V_274 ) ;
F_130 ( & V_4 -> V_274 ) ;
V_4 -> V_209 = V_279 ;
V_4 -> V_267 . V_323 = NULL ;
}
F_56 ( & V_136 -> V_329 , V_192 ) ;
return V_4 ;
}
...
{
struct V_135 * V_136 = V_207 -> V_5 ;
T_2 * V_282 = V_207 -> V_72 . V_287 ;
struct V_119 * V_4 ;
V_4 = F_129 ( V_136 ) ;
if ( ! V_4 ) {
if ( ! F_127 ( V_136 , V_330 , 1 ) )
return NULL ;
V_4 = F_129 ( V_136 ) ;
if ( ! V_4 ) {
...
V_4 -> V_267 . V_270 = 0 ;
F_132 ( & V_4 -> V_267 ) ;
V_4 -> V_22 = V_282 ? V_207 -> V_72 . V_295 : 0 ;
V_4 -> V_124 . V_7 = & V_207 -> V_5 -> V_7 ;
F_133 ( & V_4 -> V_267 , & V_207 -> V_72 ) ;
return V_4 ;
}
static inline void F_134 ( struct V_153 * V_155 ,
T_7 V_46 , T_7 V_331 , T_8 V_332 )
{
V_155 -> V_158 = V_332 ;
V_155 -> V_160 = V_46 ;
V_155 -> V_159 = V_331 ;
...
F_134 ( & V_4 -> V_155 , V_46 , V_331 , V_332 ) ;
return V_4 ;
}
static inline int F_136 ( struct V_119 * V_4 , T_8 V_332 )
{
struct V_206 * V_207 = V_4 -> V_208 ;
struct V_135 * V_136 = V_207 -> V_5 ;
int V_305 ;
V_305 = V_136 -> V_7 . V_240 / 8 ;
V_305 *= V_136 -> V_7 . V_243 / V_136 -> V_7 . V_216 ;
V_305 >>= V_4 -> V_124 . V_182 ;
if ( V_305 > 16 )
V_305 = 16 ;
while ( V_305 > 1 ) {
if ( ! ( V_332 % ( V_305 << V_4 -> V_124 . V_182 ) ) )
break;
V_305 -- ;
}
return V_305 ;
}
static struct V_265 * F_137 (
struct V_263 * V_72 , T_7 V_333 , T_8 V_332 ,
T_8 V_334 , enum V_335 V_300 ,
unsigned long V_192 )
{
struct V_119 * V_4 = NULL , * V_336 = NULL ;
struct V_206 * V_207 = F_85 ( V_72 ) ;
struct V_135 * V_136 = V_207 -> V_5 ;
unsigned int V_213 ;
T_7 V_46 ;
...
for ( V_213 = 0 ; V_213 < V_332 / V_334 ; V_213 ++ ) {
V_4 = F_131 ( V_207 ) ;
if ( ! V_4 ) {
F_33 ( V_207 -> V_5 -> V_88 . V_89 , L_41 ,
V_126 , __LINE__ ) ;
...
return NULL ;
F_55 ( & V_136 -> V_329 , V_192 ) ;
while ( ! F_93 ( & V_336 -> V_274 ) ) {
V_4 = F_124 ( V_336 -> V_274 . V_322 ,
struct V_119 , V_274 ) ;
F_92 ( & V_4 -> V_274 , & V_136 -> V_280 ) ;
}
F_92 ( & V_336 -> V_274 , & V_136 -> V_280 ) ;
F_56 ( & V_136 -> V_329 , V_192 ) ;
return NULL ;
}
switch ( V_300 ) {
...
V_4 -> V_139 = V_300 ;
V_4 -> V_124 . V_182 = V_207 -> V_303 ;
V_4 -> V_124 . V_179 = 1 ;
V_4 -> V_319 = V_334 ;
F_134 ( & V_4 -> V_155 , V_46 , V_331 , V_334 ) ;
if ( ! V_336 )
V_336 = V_4 ;
else
F_62 ( & V_4 -> V_274 , & V_336 -> V_274 ) ;
V_333 += V_334 ;
}
if ( ! V_4 )
return NULL ;
V_207 -> V_273 = true ;
V_4 -> V_267 . V_192 = V_192 ;
return & V_4 -> V_267 ;
}
static struct V_265 *
F_139 ( struct V_263 * V_72 , T_7 V_46 ,
T_7 V_331 , T_8 V_332 , unsigned long V_192 )
{
struct V_119 * V_4 ;
struct V_206 * V_207 = F_85 ( V_72 ) ;
struct V_135 * V_136 ;
int V_337 ;
if ( F_140 ( ! V_207 || ! V_332 ) )
return NULL ;
V_136 = V_207 -> V_5 ;
V_4 = F_135 ( V_207 , V_46 , V_331 , V_332 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_124 . V_167 = 1 ;
V_4 -> V_124 . V_169 = 1 ;
V_4 -> V_139 = V_142 ;
V_337 = V_136 -> V_7 . V_240 / 8 ;
while ( ( V_331 | V_46 | V_332 ) & ( V_337 - 1 ) )
V_337 /= 2 ;
V_4 -> V_124 . V_182 = 0 ;
while ( V_337 != ( 1 << V_4 -> V_124 . V_182 ) )
V_4 -> V_124 . V_182 ++ ;
if ( V_4 -> V_124 . V_182 * 8 < V_136 -> V_7 . V_240 )
V_4 -> V_124 . V_179 = 1 ;
V_4 -> V_124 . V_179 = F_136 ( V_4 , V_332 ) ;
V_4 -> V_319 = V_332 ;
V_4 -> V_267 . V_192 = V_192 ;
return & V_4 -> V_267 ;
}
...
static struct V_265 *
F_142 ( struct V_263 * V_72 , struct V_338 * V_339 ,
unsigned int V_340 , enum V_335 V_300 ,
unsigned long V_328 , void * V_341 )
{
struct V_119 * V_336 , * V_4 = NULL ;
struct V_206 * V_207 = F_85 ( V_72 ) ;
struct V_338 * V_342 ;
int V_213 ;
T_7 V_73 ;
if ( F_140 ( ! V_207 || ! V_339 || ! V_340 ) )
return NULL ;
V_73 = V_207 -> V_301 ;
V_336 = NULL ;
...
V_4 -> V_124 . V_169 = 0 ;
F_134 ( & V_4 -> V_155 ,
V_73 , F_144 ( V_342 ) , F_145 ( V_342 ) ) ;
} else {
V_4 -> V_124 . V_167 = 0 ;
V_4 -> V_124 . V_169 = 1 ;
F_134 ( & V_4 -> V_155 ,
F_144 ( V_342 ) , V_73 , F_145 ( V_342 ) ) ;
}
V_4 -> V_124 . V_182 = V_207 -> V_303 ;
V_4 -> V_124 . V_179 = 1 ;
V_4 -> V_139 = V_300 ;
V_4 -> V_319 = F_145 ( V_342 ) ;
}
V_4 -> V_267 . V_192 = V_328 ;
return & V_4 -> V_267 ;
}
static T_9 F_146 ( int V_343 , void * V_212 )
{
if ( F_60 ( V_212 ) )
return V_344 ;
else
...
static int T_10 F_147 ( struct V_283 * V_89 )
{
struct V_346 * V_347 = F_148 ( V_89 ) ;
F_149 ( V_89 ) ;
if ( ! F_150 ( V_89 ) ) {
F_151 ( V_347 ) ;
}
...
static int T_10 F_153 ( struct V_283 * V_89 )
{
struct V_346 * V_347 = F_148 ( V_89 ) ;
int V_193 ;
V_193 = F_154 ( V_347 ) ;
...
static int
F_157 ( struct V_346 * V_348 , const struct V_349 * V_84 )
{
struct V_350 * V_351 ;
struct V_132 * V_7 ;
struct V_135 * V_136 ;
struct V_206 * V_207 , * V_352 ;
struct V_353 * V_354 ;
struct V_355 * V_356 ;
int V_213 , V_193 , V_343 ;
int V_216 ;
struct V_357 * V_358 = V_348 -> V_89 . V_359 ;
V_351 = F_158 ( & V_348 -> V_89 ) ;
V_193 = F_159 ( & V_348 -> V_89 , F_160 ( 32 ) ) ;
if ( V_193 )
return V_193 ;
V_136 = F_161 ( & V_348 -> V_89 , sizeof( * V_136 ) , V_258 ) ;
if ( ! V_136 )
return - V_203 ;
V_354 = & V_136 -> V_88 ;
V_354 -> V_89 = & V_348 -> V_89 ;
V_136 -> V_202 = V_351 ? V_351 -> V_360 : 0 ;
for ( V_213 = 0 ; V_213 < F_162 ( V_361 ) ; V_213 ++ )
if ( F_163 ( V_358 , V_361 [ V_213 ] . V_362 ) )
V_136 -> V_137 |= V_361 [ V_213 ] . V_84 ;
V_356 = & V_348 -> V_356 ;
V_136 -> V_78 = F_164 ( & V_348 -> V_89 , V_356 ) ;
if ( F_165 ( V_136 -> V_78 ) )
return F_166 ( V_136 -> V_78 ) ;
F_167 ( V_348 , V_136 ) ;
for ( V_213 = 0 ; V_213 < V_363 ; V_213 ++ ) {
V_343 = V_348 -> V_343 [ V_213 ] ;
if ( V_343 ) {
V_193 = F_168 ( & V_348 -> V_89 , V_343 ,
F_146 , 0 ,
F_169 ( & V_348 -> V_89 ) , V_136 ) ;
if ( V_193 )
return V_193 ;
} else {
break;
...
V_7 = & V_136 -> V_7 ;
V_7 -> V_10 = V_348 -> V_364 ;
V_193 = F_77 ( V_136 ) ;
if ( V_193 )
return V_193 ;
F_79 ( & V_136 -> V_280 ) ;
F_78 ( & V_136 -> V_329 ) ;
if ( ! F_127 ( V_136 , V_258 , V_365 ) )
F_170 ( & V_348 -> V_89 , L_43 ) ;
F_79 ( & V_354 -> V_217 ) ;
if ( V_351 )
V_216 = F_171 ( int , V_351 -> V_366 , V_7 -> V_216 ) ;
else
V_216 = F_171 ( int , V_7 -> V_199 , V_7 -> V_216 ) ;
V_136 -> V_296 = V_216 ;
V_136 -> V_297 = F_73 ( V_216 * sizeof( * V_207 ) , V_258 ) ;
if ( ! V_136 -> V_297 ) {
V_193 = - V_203 ;
goto V_367;
}
for ( V_213 = 0 ; V_213 < V_216 ; V_213 ++ ) {
V_207 = & V_136 -> V_297 [ V_213 ] ;
if ( ! V_348 -> V_89 . V_359 )
V_207 -> V_72 . V_287 = V_351 ? & V_351 -> V_282 [ V_213 ] : NULL ;
else
V_207 -> V_72 . V_287 = V_348 -> V_89 . V_359 ;
F_79 ( & V_207 -> V_309 ) ;
F_79 ( & V_207 -> V_276 ) ;
F_79 ( & V_207 -> V_275 ) ;
F_78 ( & V_207 -> V_200 ) ;
V_207 -> V_269 = NULL ;
V_207 -> V_72 . V_283 = V_354 ;
V_207 -> V_5 = V_136 ;
F_62 ( & V_207 -> V_72 . V_357 , & V_354 -> V_217 ) ;
}
if ( V_351 ) {
V_354 -> V_368 = V_351 -> V_368 ;
} else {
F_172 ( V_369 , V_354 -> V_368 ) ;
if ( V_7 -> V_199 ) {
F_172 ( V_370 , V_354 -> V_368 ) ;
F_172 ( V_371 , V_354 -> V_368 ) ;
F_172 ( V_372 , V_354 -> V_368 ) ;
}
}
V_354 -> V_373 = F_106 ;
V_354 -> V_374 = F_114 ;
...
V_354 -> V_383 = V_384 ;
V_354 -> V_385 = V_384 ;
V_354 -> V_386 = F_173 ( V_141 ) | F_173 ( V_140 ) ;
V_354 -> V_387 = V_388 ;
V_354 -> V_389 = ( ( V_136 -> V_137 & V_138 ) ?
1 : V_390 ) ;
V_193 = F_174 ( V_354 ) ;
if ( V_193 ) {
F_33 ( & V_348 -> V_89 , L_44 ) ;
goto V_391;
}
if ( V_348 -> V_89 . V_359 ) {
V_193 = F_175 ( V_348 -> V_89 . V_359 ,
F_104 , V_136 ) ;
if ( V_193 ) {
F_33 ( & V_348 -> V_89 ,
L_45 ) ;
...
V_348 -> V_89 . V_392 = & V_136 -> V_392 ;
V_193 = F_176 ( & V_348 -> V_89 , 1900800 ) ;
if ( V_193 )
F_33 ( & V_348 -> V_89 , L_46 ) ;
F_39 ( & V_348 -> V_89 ,
L_47 , V_348 -> V_364 ) ;
F_39 ( & V_348 -> V_89 ,
L_48 ,
...
static int F_180 ( struct V_346 * V_348 )
{
struct V_135 * V_136 = F_181 ( V_348 ) ;
struct V_206 * V_207 , * V_352 ;
int V_213 , V_343 ;
F_182 ( V_136 -> V_88 . V_89 ) ;
if ( V_348 -> V_89 . V_359 )
F_183 ( V_348 -> V_89 . V_359 ) ;
for ( V_213 = 0 ; V_213 < V_363 ; V_213 ++ ) {
V_343 = V_348 -> V_343 [ V_213 ] ;
F_184 ( & V_348 -> V_89 , V_343 , V_136 ) ;
}
F_185 ( & V_136 -> V_88 ) ;
F_63 (pch, _p, &pl330->ddma.channels,
chan.device_node) {
