...
int F_46 ( struct V_7 * V_8 , T_1 V_165 ,
T_3 V_104 , T_2 V_60 , T_2 * V_99 )
{
T_3 V_166 ;
int V_167 = 0 ;
if ( V_8 -> V_16 < V_30 ) {
V_167 = F_47 ( V_8 , V_60 , V_99 ) ;
} else if ( V_8 -> V_16 < V_33 ) {
V_167 = F_48 ( V_8 , V_165 , V_104 , V_60 , V_99 ) ;
if ( * V_99 >= 2000 || * V_99 == 0 )
* V_99 = 1150 ;
} else {
V_167 = F_49 ( V_8 , V_165 , V_104 , V_60 , & V_166 ) ;
* V_99 = ( T_2 ) ( V_166 / 100 ) ;
}
return V_167 ;
}
...
F_44 ( V_8 -> V_69 . V_70 ,
V_174 ) ;
if ( ( V_8 -> V_16 == V_32 ) || ( V_8 -> V_16 == V_34 ) )
F_44 ( V_8 -> V_69 . V_70 ,
V_175 ) ;
return 0 ;
}
