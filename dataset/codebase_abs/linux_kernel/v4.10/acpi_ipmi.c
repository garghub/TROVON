...
static void F_44 ( int V_2 , struct V_3 * V_4 )
{
struct V_1 * V_6 , * V_53 ;
int V_7 ;
struct V_64 V_65 ;
...
F_17 ( & V_15 . V_21 ) ;
F_46 (temp, &driver_data.ipmi_devices, head) {
if ( V_53 -> V_5 == V_5 )
goto V_71;
}
if ( ! V_15 . V_19 )
V_15 . V_19 = V_6 ;
F_47 ( & V_6 -> V_11 , & V_15 . V_72 ) ;
F_19 ( & V_15 . V_21 ) ;
F_8 ( V_65 . V_4 ) ;
return;
V_71:
