...
int F_65 ( struct V_91 * V_92 , struct V_1 * V_2 , int V_89 )
{
struct V_100 * V_101 ;
int V_96 ;
V_96 = F_66 ( V_92 , L_20 , V_89 , 1 , 1 , & V_101 ) ;
if ( V_96 < 0 )
return V_96 ;
...
return F_71 ( V_114 , 1 , 8 , V_115 ) ;
}
static int F_72 ( struct V_111 * V_112 , struct V_116 * V_117 )
{
struct V_1 * V_2 = F_73 ( V_112 ) ;
V_117 -> V_59 . V_118 . V_119 [ 0 ] = F_13 ( V_2 , V_120 ) & 7 ;
return 0 ;
}
static int F_74 ( struct V_111 * V_112 , struct V_116 * V_117 )
{
struct V_1 * V_2 = F_73 ( V_112 ) ;
unsigned long V_18 ;
unsigned char V_121 , V_122 ;
int V_123 ;
if ( V_117 -> V_59 . V_118 . V_119 [ 0 ] > 8 )
return - V_44 ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_121 = F_13 ( V_2 , V_120 ) ;
V_122 = ( V_117 -> V_59 . V_118 . V_119 [ 0 ] & 7 ) | ( V_121 & ~ 15 ) ;
V_123 = V_122 != V_121 ;
if ( V_123 )
...
static int F_75 ( struct V_111 * V_112 , struct V_113 * V_114 )
{
int V_124 = ( V_112 -> V_125 >> 16 ) & 0xff ;
V_114 -> type = V_124 == 1 ? V_126 : V_127 ;
V_114 -> V_66 = 1 ;
V_114 -> V_59 . integer . V_128 = 0 ;
V_114 -> V_59 . integer . V_129 = V_124 ;
return 0 ;
}
static int F_76 ( struct V_111 * V_112 , struct V_116 * V_117 )
{
struct V_1 * V_2 = F_73 ( V_112 ) ;
unsigned long V_18 ;
int V_11 = V_112 -> V_125 & 0xff ;
int V_130 = ( V_112 -> V_125 >> 8 ) & 0xff ;
int V_124 = ( V_112 -> V_125 >> 16 ) & 0xff ;
int V_131 = ( V_112 -> V_125 >> 24 ) & 0xff ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_117 -> V_59 . integer . V_59 [ 0 ] = ( F_13 ( V_2 , V_11 ) >> V_130 ) & V_124 ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
if ( V_131 )
V_117 -> V_59 . integer . V_59 [ 0 ] = V_124 - V_117 -> V_59 . integer . V_59 [ 0 ] ;
return 0 ;
}
static int F_77 ( struct V_111 * V_112 , struct V_116 * V_117 )
{
struct V_1 * V_2 = F_73 ( V_112 ) ;
unsigned long V_18 ;
int V_11 = V_112 -> V_125 & 0xff ;
...
int V_123 ;
unsigned char V_121 , V_122 ;
V_122 = ( V_117 -> V_59 . integer . V_59 [ 0 ] & V_124 ) ;
if ( V_131 )
V_122 = V_124 - V_122 ;
V_122 <<= V_130 ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
V_121 = F_13 ( V_2 , V_11 ) ;
V_122 = ( V_121 & ~ ( V_124 << V_130 ) ) | V_122 ;
V_123 = V_122 != V_121 ;
if ( V_123 )
F_11 ( V_2 , V_11 , V_122 ) ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
...
static int F_79 ( struct V_111 * V_112 , struct V_116 * V_117 )
{
struct V_1 * V_2 = F_73 ( V_112 ) ;
unsigned long V_18 ;
int V_132 = V_112 -> V_125 & 0xff ;
int V_133 = ( V_112 -> V_125 >> 8 ) & 0xff ;
int V_134 = ( V_112 -> V_125 >> 16 ) & 0x07 ;
int V_135 = ( V_112 -> V_125 >> 19 ) & 0x07 ;
int V_124 = ( V_112 -> V_125 >> 24 ) & 0xff ;
int V_131 = ( V_112 -> V_125 >> 22 ) & 1 ;
unsigned char V_136 , V_137 ;
F_16 ( & V_2 -> V_22 , V_18 ) ;
if ( V_132 < 0xa0 )
V_136 = F_13 ( V_2 , V_132 ) ;
else
V_136 = F_10 ( V_2 , V_132 ) ;
if ( V_132 != V_133 ) {
if ( V_133 < 0xa0 )
...
V_137 = V_136 ;
F_18 ( & V_2 -> V_22 , V_18 ) ;
V_117 -> V_59 . integer . V_59 [ 0 ] = ( V_136 >> V_134 ) & V_124 ;
V_117 -> V_59 . integer . V_59 [ 1 ] = ( V_137 >> V_135 ) & V_124 ;
if ( V_131 ) {
V_117 -> V_59 . integer . V_59 [ 0 ] = V_124 - V_117 -> V_59 . integer . V_59 [ 0 ] ;
V_117 -> V_59 . integer . V_59 [ 1 ] = V_124 - V_117 -> V_59 . integer . V_59 [ 1 ] ;
}
return 0 ;
}
static int F_80 ( struct V_111 * V_112 , struct V_116 * V_117 )
{
struct V_1 * V_2 = F_73 ( V_112 ) ;
unsigned long V_18 ;
int V_132 = V_112 -> V_125 & 0xff ;
...
int V_131 = ( V_112 -> V_125 >> 22 ) & 1 ;
int V_123 ;
unsigned char V_138 , V_139 , V_140 , V_141 ;
V_138 = V_117 -> V_59 . integer . V_59 [ 0 ] & V_124 ;
V_139 = V_117 -> V_59 . integer . V_59 [ 1 ] & V_124 ;
if ( V_131 ) {
V_138 = V_124 - V_138 ;
V_139 = V_124 - V_139 ;
}
...
if ( V_132 != V_133 ) {
if ( V_132 < 0xa0 )
V_140 = F_13 ( V_2 , V_132 ) ;
else
V_140 = F_10 ( V_2 , V_132 ) ;
if ( V_133 < 0xa0 )
V_141 = F_13 ( V_2 , V_133 ) ;
else
V_141 = F_10 ( V_2 , V_133 ) ;
V_138 = ( V_140 & ~ ( V_124 << V_134 ) ) | V_138 ;
V_139 = ( V_141 & ~ ( V_124 << V_135 ) ) | V_139 ;
V_123 = V_138 != V_140 || V_139 != V_141 ;
if ( V_123 ) {
if ( V_132 < 0xa0 )
...
V_140 = F_10 ( V_2 , V_132 ) ;
V_138 = ( V_140 & ~ ( ( V_124 << V_134 ) | ( V_124 << V_135 ) ) ) | V_138 | V_139 ;
V_123 = V_138 != V_140 ;
if ( V_123 ) {
if ( V_132 < 0xa0 )
F_11 ( V_2 , V_132 , V_138 ) ;
...
if ( F_82 ( ! V_2 || ! V_92 ) )
return - V_44 ;
strcpy ( V_92 -> V_143 , F_58 ( V_2 ) ) ;
for ( V_142 = 0 ; V_142 < F_83 ( V_144 ) ; V_142 ++ ) {
if ( ( V_96 = F_84 ( V_92 , F_85 ( & V_144 [ V_142 ] , V_2 ) ) ) < 0 )
return V_96 ;
}
