...
int F_84 ( struct V_98 * V_99 , void * V_100 ,
struct V_83 * V_84 )
{
struct V_101 * V_102 =
(struct V_101 * ) V_100 ;
...
struct V_86 * V_87 = F_74 ( V_84 ) -> V_87 ;
int V_27 ;
T_3 V_103 = ( ( T_3 ) V_102 -> V_104 * V_105 ) ;
V_103 = ( V_103 >> 20 ) + ( V_103 >> 24 ) -
( V_103 >> 26 ) ;
if ( ! V_102 -> V_106 ) {
V_102 -> V_106 = 1 ;
V_102 -> V_107 = V_108 + V_103 ;
}
V_4 = F_85 ( V_87 , V_102 -> V_109 ) ;
if ( F_38 ( V_4 == NULL ) ) {
F_86 ( V_110 L_3
L_4 ,
...
V_26 = V_108 ;
if ( F_87 ( V_26 , ( unsigned long ) V_102 -> V_107 ) ) {
V_27 = ( ( F_16 ( V_3 ) ) ?
0 : - V_63 ) ;
goto V_30;
}
V_26 = ( unsigned long ) V_102 -> V_107 - V_26 ;
V_27 = F_61 ( V_3 , V_102 -> V_75 , true , V_26 ) ;
V_30:
F_88 ( & V_4 ) ;
if ( V_27 == 0 && ( V_102 -> V_112 & V_113 ) )
return F_89 ( V_87 , V_102 -> V_109 ,
V_114 ) ;
return V_27 ;
}
int F_90 ( struct V_98 * V_99 , void * V_100 ,
struct V_83 * V_84 )
{
struct V_115 * V_102 =
(struct V_115 * ) V_100 ;
...
V_3 = & ( F_2 ( V_4 , struct V_55 , V_4 ) -> V_3 ) ;
V_8 = F_1 ( V_3 ) ;
V_102 -> V_116 = F_16 ( V_3 ) ;
V_102 -> V_117 = V_102 -> V_35 ;
F_30 ( & V_8 -> V_5 ) ;
V_102 -> V_67 = V_14 -> V_118 ;
F_32 ( & V_8 -> V_5 ) ;
F_88 ( & V_4 ) ;
return 0 ;
}
int F_92 ( struct V_98 * V_99 , void * V_100 ,
struct V_83 * V_84 )
{
struct V_119 * V_102 =
(struct V_119 * ) V_100 ;
return F_89 ( F_74 ( V_84 ) -> V_87 ,
V_102 -> V_109 ,
V_114 ) ;
}
...
F_95 ( V_99 , V_120 -> V_122 ) ;
V_120 -> V_122 = NULL ;
F_6 ( & V_99 -> V_123 , V_9 ) ;
}
static void F_96 ( struct V_43 * V_44 )
{
struct V_58 * V_120 =
F_2 ( V_44 , struct V_58 , V_44 ) ;
F_72 ( & V_120 -> V_3 ) ;
...
return - V_78 ;
V_120 -> V_122 = V_122 ;
V_120 -> V_44 . V_66 = F_93 ;
V_120 -> V_44 . V_50 = F_96 ;
V_120 -> V_44 . type = V_129 ;
V_120 -> V_3 = F_76 ( V_3 ) ;
V_120 -> V_99 = V_8 -> V_14 -> V_99 ;
V_120 -> V_124 = V_124 ;
V_120 -> V_127 = V_127 ;
F_97 ( V_3 , & V_120 -> V_44 ) ;
return 0 ;
}
static int F_100 ( struct V_83 * V_84 ,
struct V_2 * V_3 ,
T_2 V_35 ,
T_3 V_130 ,
bool V_76 )
...
struct V_131 * V_122 ;
struct V_1 * V_8 = F_1 ( V_3 ) ;
struct V_98 * V_99 = V_8 -> V_14 -> V_99 ;
int V_27 ;
...
V_27 = F_102 ( V_99 , V_84 , & V_122 -> V_4 , & V_122 -> V_122 . V_4 ) ;
if ( F_38 ( V_27 != 0 ) ) {
F_101 ( L_7 ) ;
F_47 ( V_122 ) ;
goto V_132;
...
return 0 ;
V_136:
F_103 ( V_99 , & V_122 -> V_4 ) ;
V_132:
return V_27 ;
}
int F_104 ( struct V_98 * V_99 , void * V_100 ,
struct V_83 * V_84 )
{
struct V_13 * V_14 = F_91 ( V_99 ) ;
struct V_137 * V_102 =
