...
{
return ( int ) ( ( V_26 + V_7 - 1 ) / V_7 ) ;
}
static unsigned long F_18 ( struct V_41 * * * V_42 , int V_43 )
{
...
const char * F_39 ( T_1 V_59 )
{
return F_40 ( V_60 [ V_59 ] ) ;
}
T_1 F_41 ( const char * V_61 )
{
return F_42 ( V_61 ) ;
}
int F_43 ( struct V_62 * V_63 , int V_64 , int V_65 )
{
struct V_66 * V_67 ;
int V_68 = V_63 -> V_69 [ V_64 ] ;
V_67 = F_44 ( V_63 , V_64 , sizeof( * V_67 ) ) ;
if ( ! V_67 ) {
F_45 ( L_22 , V_68 ) ;
return - V_70 ;
}
...
int F_47 ( struct V_49 * V_50 , T_1 V_80 ,
void * V_81 , int V_82 )
{
struct V_83 * V_84 ;
int V_85 ;
...
F_54 ( V_86 >= V_85 , L_27 ,
V_86 , V_85 ) ;
V_87 = F_55 ( V_84 , V_93 , & V_86 ) ;
memcpy ( V_81 , V_93 , V_82 ) ;
} else {
V_86 = V_82 ;
V_87 = F_55 ( V_84 , V_81 , & V_86 ) ;
}
return V_87 ;
}
