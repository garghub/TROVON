...
V_6 -> V_57 = 0 ;
if ( V_118 -> V_43 . V_309 )
F_133 ( V_118 -> V_43 . V_309 , L_48
, & V_28 ) ;
#ifdef F_134
V_280 [ V_291 -> V_306 ] = V_6 ;
#endif
V_10 = F_135 ( & V_310 , & V_6 -> V_14 ) ;
if ( V_10 < 0 )
goto V_298;
#ifdef F_126
snprintf ( V_292 , sizeof( V_292 ) , L_49 , V_291 -> V_306 ) ;
V_6 -> V_311 = F_136 ( V_292 , V_312 | V_313 ,
NULL , V_6 , & V_314 ) ;
#endif
return V_6 ;
V_298:
...
F_139 ( V_6 -> V_311 ) ;
#endif
F_140 ( & V_310 , & V_6 -> V_14 ) ;
F_137 ( ( unsigned long ) V_6 -> V_152 . V_8 ) ;
}
static void F_141 ( struct V_116 * V_118 )
{
struct V_5 * V_6 = F_142 ( V_118 ) ;
F_143 ( V_118 ) ;
#ifdef F_134
...
static int F_145 ( struct V_116 * V_118 , T_11 V_96 )
{
struct V_5 * V_6 = F_142 ( V_118 ) ;
F_146 ( & V_310 , & V_6 -> V_14 ) ;
F_147 ( V_118 ) ;
F_148 ( V_118 , F_149 ( V_118 , V_96 ) ) ;
return 0 ;
}
static int F_150 ( struct V_116 * V_118 )
{
struct V_5 * V_6 = F_142 ( V_118 ) ;
int V_10 ;
F_148 ( V_118 , V_315 ) ;
...
F_153 ( & V_310 , & V_6 -> V_14 ) ;
return 0 ;
}
static int F_154 ( struct V_116 * V_118 ,
const struct V_288 * V_289 )
{
int V_10 ;
struct V_5 * V_6 ;
