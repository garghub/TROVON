...
{
struct V_17 * V_18 = F_44 ( V_2 ) ;
unsigned int V_8 = F_3 ( & F_11 ( V_18 ) -> V_8 ) ;
unsigned int V_19 = V_8 & V_9 ? 1 : 0 ;
return sprintf ( V_5 , L_4 , V_19 ) ;
}
...
if ( ! ( V_14 -> V_41 & V_42 ) )
return - V_43 ;
V_39 = F_50 ( sizeof( struct V_38 ) , V_44 ) ;
if ( ! V_39 )
return - V_45 ;
V_25 = F_51 ( V_14 -> V_46 , V_39 ) ;
if ( ! V_25 )
V_25 = sprintf ( V_5 , L_10 , V_39 -> V_47 ,
V_39 -> V_48 , V_39 -> V_49 ) ;
F_52 ( V_39 ) ;
return V_25 ;
}
...
if ( ! ( V_14 -> V_41 & V_42 ) )
return - V_43 ;
V_53 = F_50 ( sizeof( struct V_52 ) ,
V_44 ) ;
if ( ! V_53 )
return - V_45 ;
V_25 = F_54 ( V_14 -> V_46 , V_53 ) ;
if ( ! V_25 )
* V_51 = V_53 -> V_54 ;
F_52 ( V_53 ) ;
return V_25 ;
...
V_56 = V_46 -> V_58 ;
F_58 ( & V_46 -> V_57 ) ;
return sprintf ( V_5 , L_11 , F_3 ( & V_46 -> V_59 ) ,
