...
( V_2 -> V_47 ||
( V_2 -> V_75 == V_76 ) ) &&
V_2 -> V_45 && V_21 -> V_203 . V_204 ) {
V_21 -> V_90 = true ;
F_6 ( V_21 , V_111 ,
L_38 ) ;
}
V_21 -> V_89 = false ;
if ( V_21 -> V_90 && V_21 -> V_205 ) {
if ( F_46 ( V_2 ) ) {
if ( V_21 -> V_206 ||
( V_21 -> V_207 . V_208 &&
! V_21 -> V_207 . V_208 ( V_2 ) ) ) {
V_21 -> V_200 = V_209 ;
V_21 -> V_210 = false ;
V_21 -> V_211 = false ;
F_47 ( & V_21 -> V_212 ) ;
...
case V_219 :
F_6 ( V_21 , V_111 , L_40 ) ;
V_101 = F_20 ( V_2 , V_220 ,
0 , 0 , NULL , false ) ;
break;
case V_221 :
F_6 ( V_21 , V_111 , L_41 ) ;
F_49 ( V_2 -> V_96 , V_2 -> V_93 ,
V_222 ,
- 1 , NULL , V_97 ) ;
break;
case V_223 :
...
case V_228 :
F_6 ( V_21 , V_111 , L_44 ) ;
V_101 = F_20 ( V_2 , V_229 ,
V_230 , 0 , NULL , false ) ;
break;
case V_231 :
F_41 ( V_21 -> V_182 , L_45 ) ;
F_50 ( V_2 -> V_232 . V_233 ) ;
if ( V_2 -> V_234 )
V_2 -> V_234 = false ;
break;
case V_235 :
...
V_4 -> V_263 [ V_145 ] =
V_2 -> V_264 [ V_145 ] . V_265 ;
else
for ( V_145 = 0 ; V_145 < V_262 ; V_145 ++ )
V_4 -> V_263 [ V_145 ] =
V_266 ;
memset ( V_4 -> V_267 , 0xff , sizeof( V_4 -> V_267 ) ) ;
}
break;
case V_268 :
F_54 ( V_185 , V_21 -> V_194 + 2 ) ;
...
break;
case V_275 :
V_184 = F_5 ( * ( V_193 * ) V_21 -> V_194 ) ;
F_6 ( V_21 , V_111 ,
L_66 , V_184 ) ;
V_21 -> V_276 =
F_62 ( T_2 , V_21 -> V_277 , V_184 ) ;
F_6 ( V_21 , V_111 , L_67 ,
V_21 -> V_276 ) ;
break;
case V_278 :
...
& V_2 -> V_282 . V_284 ,
V_285 ) ;
memset ( & V_2 -> V_282 , 0x00 , sizeof( struct V_286 ) ) ;
break;
case V_287 :
F_6 ( V_21 , V_111 , L_72 ) ;
V_2 -> V_288 =
V_289 + F_64 ( V_290 ) ;
V_2 -> V_291 = V_2 -> V_83 . V_84 . V_292 ;
V_101 = F_20 ( V_2 , V_293 ,
V_271 , 0 ,
V_2 -> V_83 . V_84 . V_87 ,
false ) ;
break;
