...
unsigned V_52 = ( V_50 -> V_53 -> V_54 * V_50 -> V_55 * V_50 -> V_56 ) >> 3 ;
if ( * V_45 )
return V_46 [ 0 ] < V_52 ? - V_57 : 0 ;
* V_45 = 1 ;
V_46 [ 0 ] = V_52 ;
return 0 ;
}
...
struct V_49 * V_50 = V_37 -> V_43 -> V_51 ;
...
int V_66 ;
if ( V_50 -> V_67 == V_68 )
V_10 -> V_14 = ( V_50 -> V_53 -> V_54 * V_50 -> V_55 ) >> 3 ;
else
V_10 -> V_14 = ( V_50 -> V_53 -> V_54 >> 3 ) * V_50 -> V_55 ;
if ( F_24 ( V_37 , 0 ) < V_50 -> V_56 * V_10 -> V_14 )
return - V_57 ;
F_25 ( V_37 , 0 , V_50 -> V_56 * V_10 -> V_14 ) ;
V_10 -> V_37 . V_69 = V_50 -> V_69 ;
if ( V_50 -> V_67 == V_68 ) {
V_64 = V_10 -> V_14 ;
} else {
V_64 = V_10 -> V_14 ;
...
V_66 = F_26 ( V_6 -> V_75 , & V_10 -> V_15 ,
V_62 -> V_76 ,
0 , V_10 -> V_14 * ( V_50 -> V_56 >> 1 ) ,
V_10 -> V_14 , 0 , V_50 -> V_56 >> 1 ) ;
break;
case V_81 :
V_66 = F_26 ( V_6 -> V_75 , & V_10 -> V_15 ,
V_62 -> V_76 ,
V_10 -> V_14 * ( V_50 -> V_56 >> 1 ) , 0 ,
V_10 -> V_14 , 0 , V_50 -> V_56 >> 1 ) ;
break;
default:
F_28 ( 1 ) ;
...
F_27 ( 2 , L_3 ,
V_10 , V_10 -> V_37 . V_38 . V_82 , V_50 -> V_55 , V_50 -> V_56 ,
V_50 -> V_53 -> V_54 , V_50 -> V_53 -> V_29 ,
...
struct V_5 * V_6 = V_50 -> V_6 ;
struct V_9 * V_83 ;
struct V_7 * V_8 = & V_6 -> V_26 [ V_50 -> V_84 ] . V_32 ;
...
struct V_49 * V_50 = V_8 -> V_51 ;
struct V_5 * V_6 = V_50 -> V_6 ;
struct V_7 * V_31 = & V_6 -> V_26 [ V_50 -> V_84 ] . V_32 ;
struct V_9 * V_10 = F_14 ( V_31 -> V_34 . V_35 ,
struct V_9 , V_36 ) ;
V_31 -> V_41 = 0 ;
F_3 ( V_6 , V_31 , V_10 , V_50 -> V_27 ) ;
return 0 ;
}
...
struct V_98 * V_95 )
{
struct V_49 * V_50 = F_42 ( V_92 ) ;
V_95 -> V_53 . V_99 . V_55 = V_50 -> V_55 ;
V_95 -> V_53 . V_99 . V_56 = V_50 -> V_56 ;
V_95 -> V_53 . V_99 . V_69 = V_50 -> V_69 ;
V_95 -> V_53 . V_99 . V_97 = V_50 -> V_53 -> V_2 ;
V_95 -> V_53 . V_99 . V_100 = ( V_50 -> V_55 * V_50 -> V_53 -> V_54 ) >> 3 ;
V_95 -> V_53 . V_99 . V_101 = V_50 -> V_56 * V_95 -> V_53 . V_99 . V_100 ;
V_95 -> V_53 . V_99 . V_102 = V_103 ;
return 0 ;
}
...
struct V_49 * V_50 = F_42 ( V_92 ) ;
struct V_5 * V_6 = V_50 -> V_6 ;
const struct V_1 * V_53 ;
enum V_104 V_69 = V_95 -> V_53 . V_99 . V_69 ;
unsigned int V_105 ;
unsigned V_106 ;
V_53 = F_1 ( V_95 -> V_53 . V_99 . V_97 ) ;
if ( NULL == V_53 )
return - V_57 ;
V_105 = ( V_6 -> V_71 & V_72 ) ? 576 : 480 ;
V_106 = V_95 -> V_53 . V_99 . V_55 ;
if ( V_69 != V_78 )
V_69 = V_74 ;
if ( V_106 < 352 ) {
V_106 = 176 ;
V_95 -> V_53 . V_99 . V_56 = V_105 / 4 ;
} else if ( V_106 < 720 ) {
V_106 = 352 ;
V_95 -> V_53 . V_99 . V_56 = V_105 / 2 ;
} else {
V_106 = 720 ;
V_95 -> V_53 . V_99 . V_56 = V_105 ;
V_69 = V_79 ;
}
V_95 -> V_53 . V_99 . V_69 = V_69 ;
V_95 -> V_53 . V_99 . V_55 = V_106 ;
V_95 -> V_53 . V_99 . V_100 = ( V_95 -> V_53 . V_99 . V_55 * V_53 -> V_54 ) >> 3 ;
V_95 -> V_53 . V_99 . V_101 = V_95 -> V_53 . V_99 . V_56 * V_95 -> V_53 . V_99 . V_100 ;
V_95 -> V_53 . V_99 . V_102 = V_103 ;
return 0 ;
}
...
if ( 0 != V_109 )
return V_109 ;
V_50 -> V_53 = F_1 ( V_95 -> V_53 . V_99 . V_97 ) ;
V_50 -> V_69 = V_95 -> V_53 . V_99 . V_69 ;
V_50 -> V_55 = V_95 -> V_53 . V_99 . V_55 ;
V_50 -> V_56 = V_95 -> V_53 . V_99 . V_56 ;
if ( V_95 -> V_53 . V_99 . V_97 == V_110 )
V_107 = V_68 ;
else
V_107 = V_108 ;
F_45 ( V_6 , V_111 , V_107 ) ;
if ( V_50 -> V_55 == 320 || V_50 -> V_55 == 352 )
V_50 -> V_70 = 1 ;
else
V_50 -> V_70 = 0 ;
V_50 -> V_73 = V_50 -> V_55 ;
F_46 ( V_6 , V_50 -> V_55 , V_111 ) ;
return 0 ;
}
...
struct V_49 * V_50 = F_42 ( V_92 ) ;
struct V_5 * V_6 = V_50 -> V_6 ;
const struct V_11 * V_112 = V_50 -> V_27 ;
T_1 V_13 = 0 ;
V_13 = F_7 ( V_112 -> V_20 ) ;
F_48 ( L_4 ,
( V_13 & 0x11 ) ? L_5 : L_6 ) ;
...
V_6 -> V_71 = V_130 ;
V_50 -> V_55 = 720 ;
V_50 -> V_56 = ( V_6 -> V_71 & V_72 ) ? 576 : 480 ;
F_53 ( V_6 ) ;
return 0 ;
}
...
{
struct V_49 * V_50 =
F_22 ( V_136 -> V_137 , struct V_49 , V_138 ) ;
struct V_5 * V_6 = V_50 -> V_6 ;
switch ( V_136 -> V_84 ) {
case V_139 :
F_58 ( V_6 , V_136 -> V_140 , V_50 -> V_84 ) ;
break;
case V_141 :
F_59 ( V_6 , V_136 -> V_140 , V_50 -> V_84 ) ;
break;
case V_142 :
F_60 ( V_6 , V_136 -> V_140 , V_50 -> V_84 ) ;
break;
case V_143 :
F_61 ( V_6 , V_136 -> V_140 , V_50 -> V_84 ) ;
break;
default:
return - V_57 ;
}
...
if ( NULL == V_53 )
return - V_57 ;
V_95 -> V_53 . V_99 . V_55 = 720 ;
V_95 -> V_53 . V_99 . V_56 = ( V_6 -> V_71 & V_72 ) ? 576 : 480 ;
V_95 -> V_53 . V_99 . V_69 = V_79 ;
V_95 -> V_53 . V_99 . V_100 = ( V_95 -> V_53 . V_99 . V_55 * V_53 -> V_54 ) >> 3 ;
V_95 -> V_53 . V_99 . V_101 = V_95 -> V_53 . V_99 . V_56 * V_95 -> V_53 . V_99 . V_100 ;
V_95 -> V_53 . V_99 . V_102 = V_103 ;
return 0 ;
...
struct V_49 * V_50 = & V_6 -> V_26 [ V_3 ] ;
struct V_149 * V_146 = & V_50 -> V_146 ;
struct V_150 * V_138 = & V_50 -> V_138 ;
struct V_43 * V_8 ;
...
V_50 -> V_155 = & V_6 -> V_156 [ V_3 - V_157 ] ;
V_50 -> V_155 -> V_50 = V_50 ;
}
V_50 -> V_27 = & V_158 [ V_3 ] ;
V_50 -> V_55 = 720 ;
V_50 -> V_69 = V_79 ;
