...
if ( V_36 -> V_53 . error )
goto V_77;
if ( V_36 -> V_51 & ( V_52 | V_78 | V_55 ) )
goto V_77;
if ( V_73 && V_73 != V_36 -> V_79 -> V_2 ) {
if ( ( V_13 & V_19 ) == 0 ) {
V_13 |= V_19 ;
V_5 . V_20 = V_73 -> V_3 ;
F_21 ( V_36 ) ;
...
switch ( V_7 -> V_75 ) {
case V_80 :
* V_70 = V_36 -> V_79 -> V_2 -> V_3 ;
break;
case V_81 :
strncpy ( ( char * ) V_70 , V_36 -> V_79 -> V_2 -> V_82 , V_83 ) ;
break;
default:
F_22 ( 1 ) ;
break;
