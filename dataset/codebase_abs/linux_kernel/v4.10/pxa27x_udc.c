...
static int F_114 ( struct V_209 * V_210 , unsigned long V_211 ,
void * V_212 )
{
struct V_200 * V_75 = V_212 ;
switch ( V_211 ) {
case V_213 :
F_115 ( V_75 ) ;
return V_214 ;
...
static void F_118 ( struct V_4 * V_87 )
{
int V_45 ;
struct V_41 * V_42 ;
F_54 ( & V_87 -> V_75 . V_218 ) ;
F_54 ( & V_87 -> V_75 . V_219 -> V_218 ) ;
...
for ( V_45 = 1 ; V_45 < V_101 ; V_45 ++ ) {
F_62 ( & V_87 -> V_88 [ V_45 ] . V_136 . V_218 ,
& V_87 -> V_75 . V_218 ) ;
F_120 ( & V_87 -> V_88 [ V_45 ] . V_136 ,
V_87 -> V_88 [ V_45 ] . V_136 . V_221 ) ;
}
}
...
static int F_124 ( struct V_200 * V_227 ,
struct V_228 * V_8 )
{
struct V_4 * V_5 = F_125 ( V_227 ) ;
int V_229 ;
V_5 -> V_8 = V_8 ;
if ( ! F_106 ( V_5 -> V_205 ) ) {
V_229 = F_126 ( V_5 -> V_205 -> V_230 ,
& V_5 -> V_75 ) ;
if ( V_229 ) {
F_20 ( V_5 -> V_87 , L_68 ) ;
goto V_231;
...
static int F_128 ( struct V_200 * V_227 )
{
struct V_4 * V_5 = F_125 ( V_227 ) ;
F_127 ( V_5 ) ;
F_110 ( V_5 ) ;
V_5 -> V_8 = NULL ;
if ( ! F_106 ( V_5 -> V_205 ) )
return F_126 ( V_5 -> V_205 -> V_230 , NULL ) ;
return 0 ;
}
...
if ( F_60 ( F_38 ( V_42 ) ) )
goto V_238;
V_235 . V_234 [ V_45 ] = F_10 ( V_42 , V_153 ) ;
}
V_236 = ! F_38 ( V_42 ) ;
while ( ! F_38 ( V_42 ) ) {
...
F_130 ( V_235 . V_233 . V_241 ) , F_130 ( V_235 . V_233 . V_242 ) ,
F_130 ( V_235 . V_233 . V_243 ) ) ;
if ( F_60 ( V_236 ) )
goto V_238;
if ( V_235 . V_233 . V_239 & V_147 )
F_41 ( V_5 , V_179 ) ;
else
F_41 ( V_5 , V_180 ) ;
F_34 ( V_42 , V_54 | V_60 ) ;
F_67 ( & V_42 -> V_146 , V_143 ) ;
V_45 = V_5 -> V_8 -> V_244 ( & V_5 -> V_75 , & V_235 . V_233 ) ;
F_71 ( & V_42 -> V_146 , V_143 ) ;
if ( V_45 < 0 )
goto V_238;
V_181:
...
F_43 ( V_42 , L_71 ,
F_10 ( V_42 , V_53 ) , V_45 ) ;
F_34 ( V_42 , V_56 | V_245 ) ;
F_41 ( V_5 , V_188 ) ;
goto V_181;
}
static void F_131 ( struct V_4 * V_5 , int V_246 , int V_247 )
{
T_1 V_248 ;
struct V_41 * V_42 = & V_5 -> V_41 [ 0 ] ;
...
if ( ! F_6 ( & V_42 -> V_49 ) )
V_44 = F_77 ( V_42 -> V_49 . V_150 , struct V_43 , V_49 ) ;
V_248 = F_10 ( V_42 , V_53 ) ;
F_43 ( V_42 , L_72 ,
F_42 ( V_5 ) , V_44 , V_248 , F_10 ( V_42 , V_66 ) ,
( V_246 << 1 | V_247 ) ) ;
if ( V_248 & V_57 ) {
F_43 ( V_42 , L_73 ) ;
F_76 ( V_42 , - V_249 ) ;
...
static void F_132 ( struct V_4 * V_5 , int V_89 )
{
struct V_232 V_44 ;
...
V_44 . V_243 = 0 ;
F_41 ( V_5 , V_177 ) ;
V_5 -> V_8 -> V_244 ( & V_5 -> V_75 , & V_44 ) ;
F_34 ( & V_5 -> V_41 [ 0 ] , V_254 ) ;
}
static void F_133 ( struct V_4 * V_5 , int V_97 , int V_99 )
{
struct V_232 V_44 ;
...
static void F_134 ( int V_257 , struct V_4 * V_5 )
{
int V_45 ;
struct V_41 * V_42 ;
T_1 V_258 = F_3 ( V_5 , V_33 ) & V_259 ;
T_1 V_260 = F_3 ( V_5 , V_34 ) & V_261 ;
if ( V_258 & V_262 ) {
V_5 -> V_41 [ 0 ] . V_36 . V_65 ++ ;
F_30 ( V_5 , V_33 , F_135 ( 0 , V_262 ) ) ;
F_131 ( V_5 , ! ! ( V_258 & V_263 ) ,
! ! ( V_258 & V_264 ) ) ;
}
V_258 >>= 2 ;
for ( V_45 = 1 ; V_258 != 0 && V_45 < 16 ; V_258 >>= 2 , V_45 ++ ) {
if ( ! ( V_258 & V_262 ) )
continue;
F_30 ( V_5 , V_33 , F_135 ( V_45 , V_262 ) ) ;
F_57 ( V_45 >= F_136 ( V_5 -> V_41 ) ) ;
if ( V_45 < F_136 ( V_5 -> V_41 ) ) {
V_42 = & V_5 -> V_41 [ V_45 ] ;
V_42 -> V_36 . V_65 ++ ;
F_91 ( V_42 ) ;
}
}
for ( V_45 = 16 ; V_260 != 0 && V_45 < 24 ; V_260 >>= 2 , V_45 ++ ) {
F_30 ( V_5 , V_34 , F_135 ( V_45 - 16 , V_262 ) ) ;
if ( ! ( V_260 & V_262 ) )
continue;
F_57 ( V_45 >= F_136 ( V_5 -> V_41 ) ) ;
if ( V_45 < F_136 ( V_5 -> V_41 ) ) {
...
&& V_5 -> V_8 && V_5 -> V_8 -> V_266 )
V_5 -> V_8 -> V_266 ( & V_5 -> V_75 ) ;
F_44 ( V_5 ) ;
}
...
V_5 -> V_36 . V_39 ++ ;
if ( V_5 -> V_75 . V_171 != V_172
&& V_5 -> V_8 && V_5 -> V_8 -> V_268 )
V_5 -> V_8 -> V_268 ( & V_5 -> V_75 ) ;
}
static void F_139 ( struct V_4 * V_5 )
{
unsigned V_89 , V_90 , V_95 , V_269 ;
T_1 V_106 = F_3 ( V_5 , V_14 ) ;
F_30 ( V_5 , V_34 , V_270 ) ;
V_5 -> V_36 . V_40 ++ ;
...
memset ( & V_5 -> V_36 , 0 , sizeof V_5 -> V_36 ) ;
F_76 ( V_42 , - V_237 ) ;
F_34 ( V_42 , V_245 | V_60 ) ;
F_44 ( V_5 ) ;
}
static T_4 F_142 ( int V_257 , void * V_272 )
{
struct V_4 * V_5 = V_272 ;
T_1 V_258 = F_3 ( V_5 , V_33 ) ;
T_1 V_260 = F_3 ( V_5 , V_34 ) ;
T_1 V_106 = F_3 ( V_5 , V_14 ) ;
T_1 V_273 ;
F_143 ( V_5 -> V_87 , L_80
L_81 , V_258 , V_260 , V_106 ) ;
V_273 = V_260 & 0xf8000000 ;
if ( F_60 ( V_273 & V_265 ) )
F_137 ( V_5 ) ;
if ( F_60 ( V_273 & V_267 ) )
F_138 ( V_5 ) ;
...
if ( F_60 ( V_273 & V_271 ) )
F_140 ( V_5 ) ;
if ( ( V_258 & V_259 ) | ( V_260 & V_261 ) )
F_134 ( V_257 , V_5 ) ;
return V_274 ;
}
static int F_144 ( struct V_275 * V_276 )
{
struct V_277 * V_278 ;
struct V_4 * V_5 = & V_279 ;
int V_229 = 0 , V_280 ;
struct V_281 * V_282 = F_145 ( & V_276 -> V_87 ) ;
unsigned long V_283 ;
if ( V_282 ) {
V_283 = V_282 -> V_284 ? V_285 : 0 ;
V_280 = V_282 -> V_286 ;
if ( F_146 ( V_280 ) ) {
V_229 = F_147 ( & V_276 -> V_87 , V_280 ,
V_283 ,
L_82 ) ;
if ( V_229 )
return V_229 ;
V_5 -> V_195 = F_148 ( V_282 -> V_286 ) ;
}
V_5 -> V_196 = V_282 -> V_196 ;
} else {
V_5 -> V_195 = F_149 ( & V_276 -> V_87 , NULL , V_287 ) ;
}
V_278 = F_150 ( V_276 , V_288 , 0 ) ;
V_5 -> V_278 = F_151 ( & V_276 -> V_87 , V_278 ) ;
if ( F_17 ( V_5 -> V_278 ) )
return F_152 ( V_5 -> V_278 ) ;
V_5 -> V_257 = F_153 ( V_276 , 0 ) ;
if ( V_5 -> V_257 < 0 )
return V_5 -> V_257 ;
V_5 -> V_87 = & V_276 -> V_87 ;
if ( F_154 () ) {
V_5 -> V_205 =
F_155 ( V_5 -> V_87 , L_83 , 0 ) ;
if ( F_17 ( V_5 -> V_205 ) )
return F_152 ( V_5 -> V_205 ) ;
} else {
V_5 -> V_205 = F_156 ( V_289 ) ;
}
if ( F_17 ( V_5 -> V_195 ) ) {
F_20 ( & V_276 -> V_87 , L_84 ,
F_152 ( V_5 -> V_195 ) ) ;
return F_152 ( V_5 -> V_195 ) ;
}
if ( V_5 -> V_195 )
F_157 ( V_5 -> V_195 , 0 ) ;
V_5 -> V_217 = F_158 ( & V_276 -> V_87 , NULL ) ;
if ( F_17 ( V_5 -> V_217 ) )
return F_152 ( V_5 -> V_217 ) ;
V_229 = F_159 ( V_5 -> V_217 ) ;
if ( V_229 )
return V_229 ;
V_5 -> V_204 = 0 ;
V_290 = V_5 ;
F_160 ( V_276 , V_5 ) ;
F_118 ( V_5 ) ;
V_229 = F_161 ( & V_276 -> V_87 , V_5 -> V_257 , F_142 ,
V_291 , V_11 , V_5 ) ;
if ( V_229 != 0 ) {
F_20 ( V_5 -> V_87 , L_85 ,
V_11 , V_5 -> V_257 , V_229 ) ;
goto V_292;
}
if ( ! F_106 ( V_5 -> V_205 ) )
F_162 ( V_5 -> V_205 , & V_293 ) ;
V_229 = F_163 ( & V_276 -> V_87 , & V_5 -> V_75 ) ;
if ( V_229 )
goto V_294;
F_15 ( V_5 ) ;
if ( F_105 ( V_5 ) )
...
V_294:
if ( ! F_106 ( V_5 -> V_205 ) )
F_164 ( V_5 -> V_205 , & V_293 ) ;
V_292:
F_165 ( V_5 -> V_217 ) ;
return V_229 ;
}
static int F_166 ( struct V_275 * V_272 )
{
struct V_4 * V_5 = F_167 ( V_272 ) ;
F_168 ( & V_5 -> V_75 ) ;
F_21 ( V_5 ) ;
if ( ! F_106 ( V_5 -> V_205 ) )
F_164 ( V_5 -> V_205 , & V_293 ) ;
...
static void F_170 ( struct V_275 * V_272 )
{
struct V_4 * V_5 = F_167 ( V_272 ) ;
if ( F_3 ( V_5 , V_14 ) & V_24 )
F_110 ( V_5 ) ;
}
static int F_171 ( struct V_275 * V_272 , T_5 V_72 )
{
struct V_4 * V_5 = F_167 ( V_272 ) ;
struct V_41 * V_42 ;
V_42 = & V_5 -> V_41 [ 0 ] ;
V_5 -> V_248 = F_10 ( V_42 , V_53 ) ;
F_110 ( V_5 ) ;
V_5 -> V_295 = V_5 -> V_199 ;
F_100 ( V_5 , 0 ) ;
if ( V_5 -> V_8 )
V_5 -> V_8 -> V_296 ( & V_5 -> V_75 ) ;
return 0 ;
}
static int F_172 ( struct V_275 * V_272 )
{
struct V_4 * V_5 = F_167 ( V_272 ) ;
struct V_41 * V_42 ;
V_42 = & V_5 -> V_41 [ 0 ] ;
F_36 ( V_42 , V_53 , V_5 -> V_248 & ( V_56 | V_58 ) ) ;
F_100 ( V_5 , V_5 -> V_295 ) ;
if ( F_105 ( V_5 ) )
F_109 ( V_5 ) ;
F_173 () ;
