...
V_51 = F_72 () ;
if ( V_51 ) {
F_86 ( V_39 -> V_120 , L_20 ) ;
return V_51 ;
}
V_51 = F_87 ( V_39 , & V_72 . V_146 ) ;
if ( V_51 ) {
F_86 ( V_39 -> V_120 , L_21 ) ;
return V_51 ;
}
...
V_72 . V_160 = F_90 ( V_156 , sizeof( * V_72 . V_160 ) , V_207 ) ;
if ( ! V_72 . V_160 ) {
V_51 = - V_208 ;
goto V_256;
}
...
static int F_95 ( struct V_245 * V_27 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
...
static int F_96 ( struct V_27 * V_71 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
...
static int F_100 ( struct V_27 * V_71 )
{
struct V_9 * V_10 ;
struct V_6 * V_7 ;
int V_73 ;
