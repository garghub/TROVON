...
if ( V_26 -> type != V_79 )
V_45 = - 1 ;
if ( V_41 && V_41 -> V_80 && V_41 -> V_80 -> V_81 )
V_41 -> V_80 -> V_81 ( V_41 -> V_80 -> V_82 ,
( int ) V_39 , ( int ) V_45 ) ;
}
void F_51 ( struct V_26 * V_26 )
{
struct V_72 * V_27 = & V_26 -> V_28 ;
struct V_21 * V_22 = F_7 ( V_27 -> V_23 ) ;
struct V_40 * V_41 = V_22 -> V_42 ;
...
V_22 -> V_75 . V_76 = F_42 ;
V_22 -> V_75 . V_83 = F_32 ;
} else if ( F_54 ( V_22 ) || F_55 ( V_22 ) -> V_84 >= 8 ) {
V_22 -> V_75 . V_76 = F_29 ;
V_22 -> V_75 . V_83 = F_22 ;
} else if ( F_56 ( V_22 ) ) {
V_22 -> V_75 . V_76 = F_42 ;
...
bool V_88 )
{
struct V_21 * V_22 = F_59 ( V_86 ) ;
T_1 V_25 ;
if ( ! F_63 ( V_22 ) && ! F_64 ( V_22 ) )
return;
F_57 ( V_86 ) ;
V_25 = F_8 ( V_89 ) ;
V_25 &= ~ V_90 ;
...
static int F_71 ( struct V_85 * V_86 , int V_39 ,
int V_45 , int V_3 )
{
struct V_21 * V_22 = F_59 ( V_86 ) ;
struct V_26 * V_26 ;
...
static int F_72 ( struct V_85 * V_86 , int V_39 ,
int V_45 , bool * V_98 ,
...
static int F_73 ( struct V_85 * V_103 ,
struct V_85 * V_104 , void * V_105 )
{
struct V_40 * V_41 = V_105 ;
struct V_21 * V_22 = F_59 ( V_103 ) ;
int V_4 ;
...
static void F_77 ( struct V_85 * V_103 ,
struct V_85 * V_104 , void * V_105 )
{
struct V_40 * V_41 = V_105 ;
struct V_21 * V_22 = F_59 ( V_103 ) ;
...
{
int V_101 ;
V_101 = F_79 ( V_22 -> V_108 . V_23 , & V_112 ) ;
if ( V_101 < 0 ) {
F_80 ( L_16 , V_101 ) ;
return;
}
