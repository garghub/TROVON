...
V_117 . V_62 [ 0 ] = ( ( V_16 -> V_14 + 7 ) / 8 ) * V_117 . V_55 ;
V_117 . V_121 =
F_43 ( V_16 -> V_14 , V_13 ) ;
V_45 = V_9 -> V_12 ;
if ( V_45 && V_45 -> V_55 == V_117 . V_55 &&
V_45 -> V_57 == V_117 . V_57 &&
V_45 -> V_121 == V_117 . V_121 &&
V_45 -> V_62 [ 0 ] == V_117 . V_62 [ 0 ] )
return 0 ;
V_120 = ( T_4 ) V_117 . V_62 [ 0 ] * ( T_4 ) V_117 . V_57 ;
V_94 = F_35 ( V_9 ,
V_9 -> V_122 < V_120 ||
V_9 -> V_122 > 2 * V_120 ,
true ) ;
...
V_119 = F_44 ( V_9 -> V_18 , V_9 -> V_93 , NULL ,
true , & V_117 ) ;
if ( F_45 ( V_119 ) )
return F_46 ( V_119 ) ;
V_9 -> V_12 = & V_119 -> V_123 ;
return 0 ;
}
...
int V_94 ;
V_126 = V_9 -> V_103 ;
V_109 = F_49 ( V_18 -> V_114 , & V_125 ) ;
if ( ! V_109 ) {
F_2 ( L_11 ) ;
return - V_97 ;
}
V_109 -> V_127 = V_16 -> V_23 ;
V_109 -> V_128 = V_16 -> V_26 ;
F_50 ( V_109 ) ;
if ( V_126 && F_51 ( V_126 , V_109 ) ) {
...
goto V_50;
if ( ! V_9 -> V_61 ) {
struct V_118 * V_119 = F_54 ( V_105 . V_110 ) ;
V_94 = V_119 -> V_129 ( V_119 ) ;
if ( V_94 ) {
F_2 ( L_12 ) ;
goto V_50;
}
V_94 = F_55 ( & V_9 -> V_93 -> V_123 , 0 ,
V_9 -> V_93 -> V_123 . V_130 , & V_9 -> V_115 ) ;
if ( V_94 ) {
V_119 -> V_131 ( V_119 ) ;
F_2 ( L_13 ) ;
goto V_50;
}
V_9 -> V_61 = F_56 ( & V_9 -> V_115 , & V_9 -> V_132 ) ;
}
...
{
struct V_133 * V_133 = & V_18 -> V_114 -> V_134 -> V_114 ;
struct V_8 * V_9 ;
struct V_6 * V_7 ;
unsigned V_135 , V_136 ;
unsigned V_137 , V_138 , V_139 , V_140 , V_141 ;
struct V_124 * V_142 ;
int V_94 ;
V_137 = 32 ;
V_138 = 24 ;
V_135 = V_75 ( V_18 -> V_143 , ( unsigned ) 2048 ) ;
V_136 = V_75 ( V_18 -> V_144 , ( unsigned ) 2048 ) ;
V_140 = V_135 * V_137 / 8 ;
V_141 = V_140 * V_136 ;
V_139 = F_59 ( V_18 , V_145 ) ;
V_7 = F_60 ( sizeof( * V_9 ) , V_133 ) ;
if ( ! V_7 )
return - V_97 ;
V_18 -> V_6 = V_7 ;
V_9 = V_7 -> V_9 ;
...
V_7 -> V_16 . V_23 = V_142 -> V_127 ;
V_7 -> V_16 . V_26 = V_142 -> V_128 ;
F_57 ( V_18 -> V_114 ) ;
V_9 -> V_63 = F_63 ( V_141 ) ;
...
strcpy ( V_7 -> V_64 . V_148 , L_14 ) ;
V_7 -> V_64 . type = V_149 ;
V_7 -> V_64 . V_150 = V_151 ;
V_7 -> V_64 . V_152 = 0 ;
V_7 -> V_64 . V_153 = 1 ;
V_7 -> V_64 . V_154 = 1 ;
V_7 -> V_64 . V_155 = 0 ;
V_7 -> V_64 . V_156 = V_157 ;
V_7 -> V_64 . V_65 = V_140 ;
V_7 -> V_64 . V_158 = 0 ;
V_7 -> V_64 . V_159 = V_141 ;
V_7 -> V_11 = V_9 -> V_11 ;
V_7 -> V_160 = ( char V_161 * ) V_9 -> V_63 ;
V_7 -> V_162 = V_141 ;
V_7 -> V_67 = V_163 ;
V_7 -> V_164 = & V_165 ;
...
V_7 -> V_168 -> V_170 [ 0 ] . V_123 = V_18 -> V_171 ;
V_7 -> V_168 -> V_170 [ 0 ] . V_90 = V_18 -> V_172 ;
V_9 -> V_51 . V_58 = V_9 -> V_51 . V_59 = 0 ;
V_9 -> V_51 . y1 = V_9 -> V_51 . V_60 = 0 ;
V_9 -> V_51 . V_53 = true ;
F_65 ( & V_9 -> V_51 . V_52 ) ;
