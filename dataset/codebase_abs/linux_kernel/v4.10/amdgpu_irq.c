...
int F_48 ( struct V_3 * V_4 , struct V_23 * V_24 ,
unsigned type )
{
if ( ! V_4 -> V_8 -> V_57 )
return - V_58 ;
...
unsigned F_59 ( struct V_3 * V_4 , unsigned V_43 )
{
V_4 -> V_20 . V_51 [ V_43 ] = F_60 ( V_4 -> V_20 . V_52 , V_43 ) ;
