...
F_63 ( V_10 -> V_83 , V_14 -> V_83 , V_123 ) ;
...
static int F_69 ( union V_59 * V_72 , T_5 * V_69 )
{
if ( V_72 -> type != V_79 )
return - V_113 ;
...
V_144 = F_72 ( V_139 , sizeof( * V_144 ) , V_146 ) ;
if ( ! V_144 ) {
V_55 = - V_147 ;
goto V_67;
}
...
V_72 = V_150 + 9 ;
if ( V_72 -> type == V_152 )
F_63 ( V_144 -> V_83 , V_72 -> string . V_63 ,
V_84 ) ;
V_144 -> V_80 = V_140 ;
if ( F_69 ( V_150 + 0 , & V_144 -> V_153 ) ) {
F_71 ( L_28 ) ;
V_144 -> V_153 = 10 ;
}
if ( F_69 ( V_150 + 1 , & V_144 -> V_154 ) ) {
F_71 ( L_29 ) ;
V_144 -> V_154 = 10 ;
}
if ( F_69 ( V_150 + 2 , & V_144 -> V_38 ) )
V_144 -> V_38 = 0 ;
if ( F_69 ( V_150 + 3 , & V_144 -> V_155 ) )
V_144 -> V_155 = 0 ;
if ( F_69 ( V_150 + 4 , & V_144 -> V_156 ) )
V_144 -> V_156 = 1 ;
if ( F_69 ( V_150 + 5 , & V_144 -> V_157 ) )
V_144 -> V_157 = 0 ;
}
F_73 ( V_62 , L_15 , V_140 ) ;
V_67:
F_34 ( V_57 . V_63 ) ;
return V_55 ;
}
static bool F_74 ( struct V_143 * V_158 ,
struct V_143 * V_159 ,
struct V_143 * V_96 )
{
if ( V_159 -> V_48 == V_151 ) {
...
V_96 -> V_153 = F_75 ( V_158 -> V_153 , V_159 -> V_153 ) ;
...
F_63 ( V_96 -> V_83 , V_158 -> V_83 , V_84 ) ;
F_76 ( V_96 -> V_83 , L_30 , V_84 ) ;
F_76 ( V_96 -> V_83 , V_159 -> V_83 , V_84 ) ;
return true ;
}
static void F_77 ( struct V_137 * V_160 ,
struct V_143 * V_161 )
{
...
V_176 = & V_138 [ 1 ] ;
V_62 = V_12 -> V_62 ;
V_55 = F_70 ( V_62 , V_175 ) ;
if ( V_55 )
return V_55 ;
F_78 ( V_12 , V_175 , NULL ) ;
V_51 = F_81 ( V_62 , & V_171 ) ;
while ( F_82 ( V_51 ) ) {
F_83 ( V_171 , & V_173 ) ;
V_62 = V_171 ;
if ( strcmp ( F_84 ( V_173 ) , V_179 ) )
break;
if ( ! F_80 ( V_62 , L_24 ) )
break;
V_55 = F_70 ( V_62 , V_176 ) ;
if ( V_55 )
break;
F_78 ( V_12 , V_176 , V_175 ) ;
...
int __weak F_85 ( unsigned int V_105 )
{
return - V_36 ;
}
int __weak F_86 ( struct V_143 * V_181 )
{
return - V_36 ;
}
static int F_87 ( struct V_102 * V_103 ,
struct V_110 * V_111 , int V_80 )
{
struct V_11 * V_12 ;
struct V_143 * V_181 ;
...
F_63 ( V_10 -> V_83 , V_181 -> V_83 , V_123 ) ;
...
if ( ! V_12 -> V_38 . V_183 )
return - V_36 ;
if ( V_12 -> V_5 == 0 && F_98 () == & V_120 ) {
F_99 () ;
F_93 () ;
F_100 (cpu) {
V_185 = F_48 ( V_112 , V_105 ) ;
if ( ! V_185 || ! V_185 -> V_38 . V_183 )
continue;
V_103 = F_48 ( V_184 , V_105 ) ;
F_94 ( V_103 ) ;
}
F_91 ( V_12 ) ;
F_89 ( V_12 ) ;
...
V_103 = F_104 ( sizeof( * V_103 ) , V_146 ) ;
if ( ! V_103 )
return - V_147 ;
F_48 ( V_184 , V_12 -> V_5 ) = V_103 ;
F_90 ( V_12 , V_103 ) ;
V_186 = F_105 ( V_103 ) ;
if ( V_186 ) {
if ( V_187 == 0 )
...
{
struct V_102 * V_103 = F_48 ( V_184 , V_12 -> V_5 ) ;
if ( F_1 () )
return 0 ;
if ( V_12 -> V_38 . V_17 ) {
F_108 ( V_103 ) ;
