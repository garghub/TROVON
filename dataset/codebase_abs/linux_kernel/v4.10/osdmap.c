...
F_84 ( ! F_85 ( V_174 ) ) ;
F_84 ( V_174 -> V_176 ) ;
V_174 -> V_86 = V_175 -> V_86 ;
if ( V_175 -> V_176 )
V_174 -> V_176 = F_86 ( V_175 -> V_176 ) ;
}
void F_87 ( struct V_173 * V_177 )
{
F_88 ( V_177 -> V_176 ) ;
}
void F_89 ( struct V_178 * V_174 ,
const struct V_178 * V_175 )
{
F_84 ( ! F_90 ( V_174 ) ) ;
if ( V_175 -> V_108 != V_175 -> V_179 ) {
V_174 -> V_108 = F_23 ( V_175 -> V_180 + 1 ,
V_121 | V_181 ) ;
}
memcpy ( V_174 -> V_108 , V_175 -> V_108 , V_175 -> V_180 + 1 ) ;
V_174 -> V_180 = V_175 -> V_180 ;
}
void F_91 ( struct V_178 * V_182 )
{
if ( V_182 -> V_108 != V_182 -> V_179 )
F_34 ( V_182 -> V_108 ) ;
}
static bool F_92 ( const struct V_183 * V_84 ,
const struct V_183 * V_85 )
{
...
static bool F_93 ( const struct V_183 * V_84 ,
const struct V_183 * V_85 )
{
if ( F_92 ( V_84 , V_85 ) &&
V_84 -> V_184 == V_85 -> V_184 )
return true ;
return false ;
}
static bool F_94 ( const struct V_183 * V_185 )
{
if ( V_185 -> V_18 > 0 && V_185 -> V_184 >= 0 )
return true ;
if ( ! V_185 -> V_18 && V_185 -> V_184 == - 1 )
return true ;
if ( V_185 -> V_18 > 0 && V_185 -> V_184 == - 1 ) {
int V_39 ;
for ( V_39 = 0 ; V_39 < V_185 -> V_18 ; V_39 ++ ) {
if ( V_185 -> V_150 [ V_39 ] != V_186 )
break;
}
if ( V_39 == V_185 -> V_18 )
return true ;
...
void F_95 ( struct V_183 * V_174 , const struct V_183 * V_175 )
{
memcpy ( V_174 -> V_150 , V_175 -> V_150 , V_175 -> V_18 * sizeof( V_175 -> V_150 [ 0 ] ) ) ;
V_174 -> V_18 = V_175 -> V_18 ;
V_174 -> V_184 = V_175 -> V_184 ;
}
static bool F_96 ( const struct V_83 * V_96 ,
V_19 V_187 ,
V_19 V_188 )
{
int V_189 = F_2 ( V_187 ) ;
int V_190 = ( 1 << V_189 ) - 1 ;
int V_101 ;
F_84 ( V_96 -> V_87 >= V_187 ) ;
if ( V_188 <= V_187 )
return false ;
for ( V_101 = 1 ; ; V_101 ++ ) {
int V_191 = V_101 << ( V_189 - 1 ) ;
V_19 V_192 = V_191 | V_96 -> V_87 ;
if ( V_192 < V_187 || V_192 == V_96 -> V_87 )
continue;
if ( V_192 >= V_188 )
break;
V_192 = F_97 ( V_192 , V_187 , V_190 ) ;
if ( V_192 == V_96 -> V_87 )
return true ;
}
return false ;
}
bool F_98 ( const struct V_183 * V_193 ,
const struct V_183 * V_194 ,
const struct V_183 * V_195 ,
const struct V_183 * V_196 ,
int V_197 ,
int V_198 ,
int V_199 ,
int V_200 ,
...
{
return ! F_93 ( V_193 , V_194 ) ||
! F_93 ( V_195 , V_196 ) ||
V_197 != V_198 ||
V_199 != V_200 ||
F_96 ( V_96 , V_187 , V_188 ) ||
V_201 != V_202 ;
}
static int F_99 ( int V_151 , const struct V_183 * V_203 )
{
int V_39 ;
for ( V_39 = 0 ; V_39 < V_203 -> V_18 ; V_39 ++ ) {
if ( V_203 -> V_150 [ V_39 ] == V_151 )
return V_39 ;
}
return - 1 ;
}
static bool F_100 ( const struct V_183 * V_193 ,
const struct V_183 * V_194 )
{
if ( ! V_193 -> V_18 && ! V_194 -> V_18 )
return false ;
if ( ! V_193 -> V_18 ^ ! V_194 -> V_18 )
return true ;
if ( V_193 -> V_184 != V_194 -> V_184 )
return true ;
if ( F_99 ( V_193 -> V_184 , V_193 ) !=
F_99 ( V_194 -> V_184 , V_194 ) )
return true ;
return false ;
}
bool F_101 ( const struct V_183 * V_193 ,
const struct V_183 * V_194 ,
bool V_204 )
{
if ( F_100 ( V_193 , V_194 ) )
return true ;
if ( V_204 && ! F_92 ( V_193 , V_194 ) )
return true ;
return false ;
}
int F_102 ( struct V_205 * V_206 ,
V_95 V_207 , V_95 V_2 ,
V_95 * V_208 ,
V_95 * V_209 , V_95 * V_210 )
{
V_19 V_211 = V_206 -> V_212 ;
V_19 V_213 = V_206 -> V_214 ;
V_19 V_215 = V_206 -> V_216 ;
V_19 V_217 , V_218 , V_219 , V_220 ;
V_19 V_221 ;
V_95 V_6 , V_222 ;
F_5 ( L_56 , V_207 , V_2 ,
V_211 , V_213 ) ;
...
F_103 ( V_6 , V_213 ) ;
V_217 = V_6 ;
F_5 ( L_58 , V_207 , V_213 , V_217 ) ;
V_218 = V_217 / V_215 ;
V_219 = V_217 % V_215 ;
V_220 = V_218 / V_221 ;
* V_208 = V_220 * V_215 + V_219 ;
F_5 ( L_59 , V_220 , V_215 , ( unsigned int ) * V_208 ) ;
V_6 = V_207 ;
V_222 = F_103 ( V_6 , V_213 ) ;
* V_209 = V_222 + ( V_218 % V_221 ) * V_213 ;
* V_210 = F_104 ( V_95 , V_2 , V_213 - V_222 ) ;
F_5 ( L_60 , * V_209 , * V_210 ) ;
return 0 ;
V_223:
F_5 ( L_61 ) ;
* V_208 = 0 ;
...
int F_105 ( struct V_103 * V_225 ,
struct V_178 * V_182 ,
struct V_173 * V_177 ,
struct V_83 * V_226 )
{
struct V_8 * V_9 ;
V_9 = F_37 ( V_225 , V_177 -> V_86 ) ;
if ( ! V_9 )
return - V_102 ;
if ( ! V_177 -> V_176 ) {
V_226 -> V_86 = V_177 -> V_86 ;
V_226 -> V_87 = F_106 ( V_9 -> V_115 , V_182 -> V_108 ,
V_182 -> V_180 ) ;
F_5 ( L_62 , V_154 , V_182 -> V_108 ,
V_226 -> V_86 , V_226 -> V_87 ) ;
} else {
char V_227 [ 256 ] ;
char * V_228 = V_227 ;
int V_229 = V_177 -> V_176 -> V_2 ;
T_4 V_230 = V_229 + 1 + V_182 -> V_180 ;
if ( V_230 > sizeof( V_227 ) ) {
V_228 = F_23 ( V_230 , V_121 ) ;
if ( ! V_228 )
return - V_27 ;
}
memcpy ( V_228 , V_177 -> V_176 -> V_1 , V_229 ) ;
V_228 [ V_229 ] = '\037' ;
memcpy ( V_228 + V_229 + 1 , V_182 -> V_108 , V_182 -> V_180 ) ;
V_226 -> V_86 = V_177 -> V_86 ;
V_226 -> V_87 = F_106 ( V_9 -> V_115 , V_228 , V_230 ) ;
if ( V_228 != V_227 )
F_34 ( V_228 ) ;
F_5 ( L_63 , V_154 ,
V_182 -> V_108 , V_229 , V_177 -> V_176 -> V_1 ,
V_226 -> V_86 , V_226 -> V_87 ) ;
}
return 0 ;
}
static void F_107 ( struct V_8 * V_9 ,
const struct V_83 * V_226 ,
struct V_83 * V_96 )
{
V_96 -> V_86 = V_226 -> V_86 ;
V_96 -> V_87 = F_97 ( V_226 -> V_87 , V_9 -> V_11 ,
V_9 -> V_10 ) ;
}
static V_19 F_108 ( struct V_8 * V_9 ,
const struct V_83 * V_226 )
{
if ( V_9 -> V_116 & V_231 ) {
return F_109 ( V_232 ,
...
return F_97 ( V_226 -> V_87 , V_9 -> V_13 ,
V_9 -> V_12 ) +
( unsigned ) V_226 -> V_86 ;
}
}
static int F_110 ( struct V_103 * V_104 , int V_233 , int V_234 ,
int * V_235 , int V_236 ,
const T_5 * V_63 , int V_237 )
{
int V_70 ;
F_20 ( V_236 > V_238 ) ;
F_111 ( & V_104 -> V_126 ) ;
V_70 = F_112 ( V_104 -> V_127 , V_233 , V_234 , V_235 , V_236 ,
V_63 , V_237 , V_104 -> V_239 ) ;
F_113 ( & V_104 -> V_126 ) ;
return V_70 ;
}
static void F_114 ( struct V_103 * V_225 ,
struct V_8 * V_9 ,
const struct V_83 * V_226 ,
struct V_183 * V_240 ,
V_19 * V_241 )
{
V_19 V_242 = F_108 ( V_9 , V_226 ) ;
int V_233 ;
int V_2 ;
F_115 ( V_240 ) ;
if ( V_241 )
* V_241 = V_242 ;
V_233 = F_116 ( V_225 -> V_127 , V_9 -> V_114 , V_9 -> type ,
V_9 -> V_18 ) ;
if ( V_233 < 0 ) {
F_19 ( L_64 ,
...
V_2 = F_110 ( V_225 , V_233 , V_242 , V_240 -> V_150 ,
F_104 ( int , V_9 -> V_18 , F_117 ( V_240 -> V_150 ) ) ,
V_225 -> V_129 , V_225 -> V_135 ) ;
if ( V_2 < 0 ) {
F_19 ( L_65 ,
V_2 , V_233 , V_9 -> V_61 , V_9 -> V_114 , V_9 -> type ,
V_9 -> V_18 ) ;
return;
}
V_240 -> V_18 = V_2 ;
}
static void F_118 ( struct V_103 * V_225 ,
struct V_8 * V_9 ,
struct V_183 * V_185 )
{
int V_39 ;
...
int V_243 = 0 ;
for ( V_39 = 0 ; V_39 < V_185 -> V_18 ; V_39 ++ ) {
if ( F_120 ( V_225 , V_185 -> V_150 [ V_39 ] ) ) {
V_243 ++ ;
continue;
}
if ( V_243 )
V_185 -> V_150 [ V_39 - V_243 ] = V_185 -> V_150 [ V_39 ] ;
}
V_185 -> V_18 -= V_243 ;
if ( V_185 -> V_18 > 0 )
V_185 -> V_184 = V_185 -> V_150 [ 0 ] ;
} else {
for ( V_39 = V_185 -> V_18 - 1 ; V_39 >= 0 ; V_39 -- ) {
if ( F_120 ( V_225 , V_185 -> V_150 [ V_39 ] ) )
V_185 -> V_150 [ V_39 ] = V_186 ;
else
V_185 -> V_184 = V_185 -> V_150 [ V_39 ] ;
}
}
}
static void F_121 ( struct V_103 * V_225 ,
struct V_8 * V_9 ,
V_19 V_242 ,
struct V_183 * V_244 )
{
...
if ( ! V_225 -> V_131 )
return;
for ( V_39 = 0 ; V_39 < V_244 -> V_18 ; V_39 ++ ) {
int V_151 = V_244 -> V_150 [ V_39 ] ;
if ( V_151 != V_186 &&
V_225 -> V_131 [ V_151 ] !=
V_138 ) {
break;
...
if ( V_151 == V_186 )
continue;
V_152 = V_225 -> V_131 [ V_151 ] ;
if ( V_152 < V_246 &&
( F_109 ( V_232 ,
V_242 , V_151 ) >> 16 ) >= V_152 ) {
if ( V_245 < 0 )
V_245 = V_39 ;
} else {
V_245 = V_39 ;
...
if ( V_245 < 0 )
return;
V_244 -> V_184 = V_244 -> V_150 [ V_245 ] ;
if ( F_119 ( V_9 ) && V_245 > 0 ) {
for ( V_39 = V_245 ; V_39 > 0 ; V_39 -- )
V_244 -> V_150 [ V_39 ] = V_244 -> V_150 [ V_39 - 1 ] ;
V_244 -> V_150 [ 0 ] = V_244 -> V_184 ;
}
}
static void F_122 ( struct V_103 * V_225 ,
struct V_8 * V_9 ,
const struct V_83 * V_226 ,
struct V_183 * V_247 )
{
...
struct V_88 * V_94 ;
int V_39 ;
F_107 ( V_9 , V_226 , & V_96 ) ;
F_115 ( V_247 ) ;
V_94 = F_31 ( & V_225 -> V_124 , V_96 ) ;
if ( V_94 ) {
for ( V_39 = 0 ; V_39 < V_94 -> V_124 . V_2 ; V_39 ++ ) {
if ( F_120 ( V_225 , V_94 -> V_124 . V_150 [ V_39 ] ) ) {
if ( F_119 ( V_9 ) )
continue;
V_247 -> V_150 [ V_247 -> V_18 ++ ] = V_186 ;
} else {
V_247 -> V_150 [ V_247 -> V_18 ++ ] = V_94 -> V_124 . V_150 [ V_39 ] ;
}
}
for ( V_39 = 0 ; V_39 < V_247 -> V_18 ; V_39 ++ ) {
if ( V_247 -> V_150 [ V_39 ] != V_186 ) {
V_247 -> V_184 = V_247 -> V_150 [ V_39 ] ;
break;
}
}
}
V_94 = F_31 ( & V_225 -> V_125 , V_96 ) ;
if ( V_94 )
V_247 -> V_184 = V_94 -> V_125 . V_151 ;
}
void F_123 ( struct V_103 * V_225 ,
const struct V_83 * V_226 ,
struct V_183 * V_244 ,
struct V_183 * V_203 )
{
struct V_8 * V_9 ;
V_19 V_242 ;
V_9 = F_37 ( V_225 , V_226 -> V_86 ) ;
if ( ! V_9 ) {
F_115 ( V_244 ) ;
F_115 ( V_203 ) ;
goto V_248;
}
F_114 ( V_225 , V_9 , V_226 , V_244 , & V_242 ) ;
F_118 ( V_225 , V_9 , V_244 ) ;
F_121 ( V_225 , V_9 , V_242 , V_244 ) ;
F_122 ( V_225 , V_9 , V_226 , V_203 ) ;
if ( ! V_203 -> V_18 ) {
memcpy ( V_203 -> V_150 , V_244 -> V_150 , V_244 -> V_18 * sizeof( V_244 -> V_150 [ 0 ] ) ) ;
V_203 -> V_18 = V_244 -> V_18 ;
if ( V_203 -> V_184 == - 1 )
V_203 -> V_184 = V_244 -> V_184 ;
}
V_248:
F_84 ( ! F_94 ( V_244 ) || ! F_94 ( V_203 ) ) ;
}
int F_124 ( struct V_103 * V_225 ,
const struct V_83 * V_226 )
{
struct V_183 V_244 , V_203 ;
F_123 ( V_225 , V_226 , & V_244 , & V_203 ) ;
return V_203 . V_184 ;
}
