...
static int F_19 ( const struct V_26 * V_4 )
{
const struct V_5 * V_6 = (struct V_5 * ) V_4 -> V_20 ;
int V_27 ;
V_27 = F_14 ( V_4 -> V_22 , V_4 -> V_23 ) ;
if ( V_27 )
return V_27 ;
if ( V_6 -> V_12 & ~ V_28 ) {
F_20 ( L_2 , V_6 -> V_12 & ~ V_28 ) ;
return - V_29 ;
}
return 0 ;
}
static int F_21 ( const struct V_26 * V_4 )
{
const struct V_30 * V_6 = (struct V_30 * ) V_4 -> V_20 ;
int V_27 ;
V_27 = F_14 ( V_4 -> V_22 , V_4 -> V_23 ) ;
if ( V_27 )
return V_27 ;
if ( V_6 -> V_12 & ~ V_31 ) {
F_20 ( L_2 , V_6 -> V_12 & ~ V_31 ) ;
return - V_29 ;
}
return 0 ;
}
static int F_22 ( const struct V_26 * V_4 )
{
const struct V_32 * V_6 =
(struct V_32 * ) V_4 -> V_20 ;
int V_27 ;
V_27 = F_14 ( V_4 -> V_22 , V_4 -> V_23 ) ;
if ( V_27 )
return V_27 ;
