...
V_6 -> V_42 . V_44 = NULL ;
F_14 ( & V_6 -> V_28 ) ;
for ( V_38 = 0 ; V_38 < F_40 ( V_6 -> V_42 . V_45 ) ; V_38 ++ ) {
...
static void F_42 ( struct V_21 * V_6 ,
struct V_2 * V_3 )
{
int V_37 ;
if ( ! V_6 -> V_49 )
...
static void F_45 ( struct V_21 * V_6 ,
struct V_2 * V_3 )
{
if ( V_3 -> V_4 == V_5 ) {
F_10 ( V_3 ) ;
...
int F_48 ( struct V_22 * V_11 , T_1 V_55 ,
char T_2 * V_56 )
{
struct V_21 * V_6 = F_24 ( V_11 ) ;
struct V_2 * V_3 ;
...
V_55 = F_49 ( V_55 , V_11 -> V_39 ) ;
if ( V_55 > V_3 -> V_34 - V_6 -> V_42 . V_58 )
V_55 = V_3 -> V_34 - V_6 -> V_42 . V_58 ;
if ( F_50 ( V_56 , V_3 -> V_9 + V_6 -> V_42 . V_58 , V_55 ) ) {
V_37 = - V_59 ;
goto V_48;
}
V_6 -> V_42 . V_58 += V_55 ;
...
F_14 ( & V_6 -> V_28 ) ;
F_52 (block, &queue->outgoing, head)
V_60 += V_3 -> V_8 ;
F_16 ( & V_6 -> V_28 ) ;
F_41 ( & V_6 -> V_41 ) ;
return V_60 ;
}
int F_53 ( struct V_22 * V_11 , T_1 V_61 )
{
V_11 -> V_39 = V_61 ;
return 0 ;
}
int F_54 ( struct V_22 * V_11 , int V_40 )
{
if ( V_40 < 2 )
V_40 = 2 ;
V_11 -> V_40 = V_40 ;
