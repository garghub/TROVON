...
if ( F_14 ( V_122 ) ) {
F_19 ( & V_2 -> V_25 -> V_26 , L_12 ,
V_18 , V_120 ) ;
return F_35 ( V_122 ) ;
}
V_123 = F_28 ( V_2 , V_122 -> V_124 ) ;
if ( ! V_123 ) {
F_19 ( & V_2 -> V_25 -> V_26 , L_13 ,
V_18 , V_120 ) ;
return - V_20 ;
}
...
static int F_45 ( void * V_22 , T_4 * V_134 )
{
struct V_1 * V_17 = V_22 ;
if ( ! V_17 ) {
F_30 ( L_18 , V_18 ) ;
...
static int T_5 F_47 ( struct V_135 * V_25 )
{
struct V_1 * V_17 ;
...
struct V_138 * V_139 ;
int V_80 , V_47 = 0 ;
V_17 = F_48 ( & V_25 -> V_26 , sizeof( struct V_1 ) , V_140 ) ;
if ( ! V_17 )
return - V_141 ;
V_17 -> V_49 = F_48 ( & V_25 -> V_26 ,
V_142 , V_140 ) ;
if ( ! V_17 -> V_49 )
return - V_141 ;
F_49 ( V_25 , V_17 ) ;
if ( ! V_45 ) {
F_11 ( & V_25 -> V_26 , L_20 , V_18 ) ;
return - V_19 ;
}
V_137 = F_50 ( V_25 , V_143 , 0 ) ;
V_17 -> V_5 = F_51 ( & V_25 -> V_26 , V_137 ) ;
if ( F_14 ( V_17 -> V_5 ) ) {
F_11 ( & V_25 -> V_26 , L_21 , V_18 ) ;
return F_35 ( V_17 -> V_5 ) ;
}
V_21 = F_50 ( V_25 , V_144 , 0 ) ;
F_52 ( & V_25 -> V_26 ) ;
F_53 ( & V_25 -> V_26 ) ;
snprintf ( V_17 -> V_49 , V_142 , L_22 , V_45 -> V_49 ) ;
V_17 -> V_25 = V_25 ;
...
F_55 ( & V_25 -> V_26 , L_24 , V_18 ) ;
if ( ! V_150 ) {
V_150 = F_56 ( L_25 , NULL ) ;
if ( F_57 ( V_150 ) ) {
V_47 = F_35 ( V_150 ) ;
F_7 ( L_26 ,
V_18 , V_47 ) ;
...
V_17 -> V_151 = F_56 ( V_17 -> V_49 , V_150 ) ;
if ( F_57 ( V_17 -> V_151 ) ) {
F_11 ( & V_25 -> V_26 , L_27 ,
V_18 ) ;
...
( void ) F_58 ( L_28 , V_153 | V_154 ,
V_17 -> V_151 , ( void * ) V_17 , & V_155 ) ;
( void ) F_59 ( L_29 , V_153 , V_17 -> V_151 ,
& V_17 -> V_103 ) ;
( void ) F_59 ( L_30 , V_153 , V_17 -> V_151 ,
& V_17 -> V_105 ) ;
V_139 = F_56 ( L_31 , V_17 -> V_151 ) ;
if ( F_57 ( V_139 ) ) {
F_11 ( & V_25 -> V_26 , L_32 ,
V_18 ) ;
V_47 = F_35 ( V_139 ) ;
...
char V_49 [ V_156 + 1 ] ;
snprintf ( V_49 , sizeof( V_49 ) , L_34 ,
V_17 -> V_81 [ V_80 ] . V_157 ) ;
( void ) F_59 ( V_49 , V_153 | V_154 , V_139 ,
& ( V_17 -> V_81 [ V_80 ] . V_127 ) ) ;
snprintf ( V_49 , sizeof( V_49 ) , L_35 ,
V_17 -> V_81 [ V_80 ] . V_157 ) ;
( void ) F_59 ( V_49 , V_153 | V_154 , V_139 ,
...
static int F_61 ( struct V_135 * V_25 )
{
struct V_44 * V_45 = V_25 -> V_26 . V_46 ;
struct V_1 * V_17 ;
if ( ! V_45 ) {
...
static void F_63 ( struct V_135 * V_25 )
{
struct V_44 * V_45 = V_25 -> V_26 . V_46 ;
struct V_1 * V_17 ;
if ( ! V_45 ) {
