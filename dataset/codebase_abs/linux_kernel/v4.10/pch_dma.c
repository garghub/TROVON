...
F_38 ( & V_14 -> V_67 ) ;
if ( F_21 ( & V_14 -> V_15 ) ) {
F_39 ( & V_45 -> V_16 , & V_14 -> V_15 ) ;
F_19 ( V_14 , V_45 ) ;
} else {
F_39 ( & V_45 -> V_16 , & V_14 -> V_17 ) ;
}
F_40 ( & V_14 -> V_67 ) ;
return 0 ;
}
static struct V_1 * F_41 ( struct V_5 * V_6 , T_3 V_68 )
{
struct V_1 * V_45 = NULL ;
struct V_7 * V_19 = F_4 ( V_6 -> V_11 ) ;
T_4 V_69 ;
V_45 = F_42 ( V_19 -> V_70 , V_68 , & V_69 ) ;
if ( V_45 ) {
F_43 ( & V_45 -> V_51 ) ;
F_44 ( & V_45 -> V_3 , V_6 ) ;
V_45 -> V_3 . V_71 = F_37 ;
...
static struct V_1 * F_45 ( struct V_4 * V_14 )
{
struct V_1 * V_45 , * V_62 ;
...
static void F_47 ( struct V_4 * V_14 ,
struct V_1 * V_45 )
{
if ( V_45 ) {
F_38 ( & V_14 -> V_67 ) ;
F_25 ( & V_45 -> V_51 , & V_14 -> V_61 ) ;
F_48 ( & V_45 -> V_16 , & V_14 -> V_61 ) ;
F_40 ( & V_14 -> V_67 ) ;
}
}
...
F_56 ( V_19 -> V_70 , V_45 , V_45 -> V_3 . V_57 ) ;
F_10 ( V_6 , 0 ) ;
}
static enum V_81 F_57 ( struct V_5 * V_6 , T_2 V_66 ,
struct V_82 * V_83 )
{
return F_58 ( V_6 , V_66 , V_83 ) ;
}
...
goto V_99;
V_45 -> V_46 . V_47 = V_95 ;
V_45 -> V_46 . V_48 = F_64 ( V_94 ) ;
V_45 -> V_46 . V_49 = F_65 ( V_94 ) ;
...
static void F_67 ( unsigned long V_116 )
{
...
F_68 ( & V_14 -> V_67 , V_68 ) ;
if ( F_69 ( 0 , & V_14 -> V_117 ) )
F_32 ( V_14 ) ;
else
F_35 ( V_14 ) ;
F_70 ( & V_14 -> V_67 , V_68 ) ;
}
static T_5 F_71 ( int V_118 , void * V_119 )
{
...
static void F_77 ( struct V_7 * V_19 )
{
struct V_4 * V_14 ;
...
V_14 = F_3 ( V_6 ) ;
V_19 -> V_135 [ V_74 ] . V_47 = F_78 ( V_14 , V_52 ) ;
V_19 -> V_135 [ V_74 ] . V_48 = F_78 ( V_14 , V_53 ) ;
V_19 -> V_135 [ V_74 ] . V_49 = F_78 ( V_14 , V_54 ) ;
V_19 -> V_135 [ V_74 ] . V_50 = F_78 ( V_14 , V_55 ) ;
V_74 ++ ;
}
}
static void F_79 ( struct V_7 * V_19 )
{
struct V_4 * V_14 ;
struct V_5 * V_6 , * V_129 ;
int V_74 = 0 ;
...
static int F_80 ( struct V_136 * V_137 , T_6 V_138 )
{
struct V_7 * V_19 = F_81 ( V_137 ) ;
if ( V_19 )
F_77 ( V_19 ) ;
F_82 ( V_137 ) ;
F_83 ( V_137 ) ;
F_84 ( V_137 , F_85 ( V_137 , V_138 ) ) ;
return 0 ;
}
static int F_86 ( struct V_136 * V_137 )
{
struct V_7 * V_19 = F_81 ( V_137 ) ;
int V_139 ;
F_84 ( V_137 , V_140 ) ;
...
static int F_89 ( struct V_136 * V_137 ,
...
if ( ! ( F_92 ( V_137 , 1 ) & V_148 ) ) {
F_20 ( & V_137 -> V_12 , L_22 ) ;
V_139 = - V_149 ;
goto V_150;
}
V_139 = F_93 ( V_137 , V_151 ) ;
if ( V_139 ) {
F_20 ( & V_137 -> V_12 , L_23 ) ;
goto V_150;
}
V_139 = F_94 ( V_137 , F_95 ( 32 ) ) ;
if ( V_139 ) {
F_20 ( & V_137 -> V_12 , L_24 ) ;
goto V_152;
}
V_46 = V_19 -> V_153 = F_96 ( V_137 , 1 , 0 ) ;
if ( ! V_19 -> V_153 ) {
...
F_97 ( V_137 ) ;
V_139 = F_98 ( V_137 -> V_118 , F_71 , V_154 , V_151 , V_19 ) ;
if ( V_139 ) {
F_20 ( & V_137 -> V_12 , L_26 ) ;
goto V_155;
}
V_19 -> V_70 = F_99 ( L_27 , V_137 ,
...
F_43 ( & V_14 -> V_17 ) ;
F_43 ( & V_14 -> V_61 ) ;
F_101 ( & V_14 -> V_127 , F_67 ,
( unsigned long ) V_14 ) ;
F_39 ( & V_14 -> V_6 . V_157 , & V_19 -> V_10 . V_126 ) ;
}
F_102 ( V_19 -> V_10 . V_158 ) ;
F_103 ( V_159 , V_19 -> V_10 . V_158 ) ;
F_103 ( V_160 , V_19 -> V_10 . V_158 ) ;
V_19 -> V_10 . V_161 = F_49 ;
V_19 -> V_10 . V_162 = F_55 ;
V_19 -> V_10 . V_163 = F_57 ;
V_19 -> V_10 . V_164 = F_59 ;
V_19 -> V_10 . V_165 = F_60 ;
V_19 -> V_10 . V_166 = F_66 ;
V_139 = F_104 ( & V_19 -> V_10 ) ;
if ( V_139 ) {
...
F_105 ( V_19 -> V_70 ) ;
V_156:
F_106 ( V_137 -> V_118 , V_19 ) ;
V_155:
F_107 ( V_137 , V_19 -> V_153 ) ;
V_152:
F_108 ( V_137 ) ;
V_150:
F_83 ( V_137 ) ;
...
static void F_110 ( struct V_136 * V_137 )
{
struct V_7 * V_19 = F_81 ( V_137 ) ;
struct V_4 * V_14 ;
struct V_5 * V_6 , * V_129 ;
