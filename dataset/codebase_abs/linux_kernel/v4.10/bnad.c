...
T_10 V_503 = V_121 ^ V_19 -> V_121 ;
if ( ( V_503 & V_130 ) && F_132 ( V_19 ) ) {
unsigned long V_34 ;
F_81 ( & V_1 -> V_138 , V_34 ) ;
if ( V_121 & V_130 )
...
int V_6 , V_142 ;
if ( ! ( V_1 -> V_226 & V_227 ) ) {
F_307 ( & V_1 -> V_141 , V_504 ) ;
F_86 ( V_1 -> V_18 -> V_48 , V_42 ) ;
F_308 ( & V_1 -> V_141 , V_504 ) ;
} else {
for ( V_6 = 0 ; V_6 < V_1 -> V_149 ; V_6 ++ ) {
V_144 = & V_1 -> V_144 [ V_6 ] ;
if ( ! V_144 -> V_150 )
...
static void
F_309 ( struct V_1 * V_1 , bool V_505 )
{
struct V_41 * V_42 = V_1 -> V_42 ;
V_42 -> V_506 = V_507 | V_122 |
V_508 | F_274 |
V_509 | V_510 | V_511 |
V_130 ;
V_42 -> V_512 = V_507 | V_513 |
V_508 | F_274 |
V_509 | V_510 ;
V_42 -> V_121 |= V_42 -> V_506 | V_514 ;
if ( V_505 )
V_42 -> V_121 |= V_513 ;
V_42 -> V_515 = V_1 -> V_516 ;
V_42 -> V_517 = V_1 -> V_516 + V_1 -> V_518 - 1 ;
V_42 -> V_519 = V_520 - V_454 ;
V_42 -> V_521 = V_522 ;
V_42 -> V_523 = & V_524 ;
F_310 ( V_42 ) ;
}
...
struct V_525 * V_526 , struct V_41 * V_42 )
{
unsigned long V_34 ;
F_312 ( V_42 , & V_526 -> V_19 ) ;
F_313 ( V_526 , V_42 ) ;
V_1 -> V_42 = V_42 ;
V_1 -> V_18 = V_526 ;
V_1 -> V_516 = F_314 ( V_526 , 0 ) ;
V_1 -> V_518 = F_315 ( V_526 , 0 ) ;
V_1 -> V_527 = F_316 ( V_1 -> V_516 , V_1 -> V_518 ) ;
if ( ! V_1 -> V_527 ) {
F_317 ( & V_526 -> V_19 , L_9 ) ;
return - V_221 ;
}
F_318 ( & V_526 -> V_19 , L_10 , V_1 -> V_527 ,
( unsigned long long ) V_1 -> V_518 ) ;
F_81 ( & V_1 -> V_138 , V_34 ) ;
if ( ! V_528 )
V_1 -> V_226 = V_227 ;
V_1 -> V_226 |= V_268 ;
...
V_1 -> V_297 = V_531 ;
V_1 -> V_306 = V_532 ;
sprintf ( V_1 -> V_533 , L_11 , V_232 , V_1 -> V_62 ) ;
V_1 -> V_186 = F_319 ( V_1 -> V_533 ) ;
if ( ! V_1 -> V_186 ) {
F_320 ( V_1 -> V_527 ) ;
return - V_221 ;
}
...
struct V_525 * V_526 , bool * V_505 )
{
int V_223 ;
V_223 = F_330 ( V_526 ) ;
if ( V_223 )
return V_223 ;
V_223 = F_331 ( V_526 , V_232 ) ;
if ( V_223 )
goto V_534;
if ( ! F_332 ( & V_526 -> V_19 , F_333 ( 64 ) ) ) {
* V_505 = true ;
} else {
V_223 = F_332 ( & V_526 -> V_19 , F_333 ( 32 ) ) ;
if ( V_223 )
goto V_535;
* V_505 = false ;
}
...
static void
F_337 ( struct V_525 * V_526 )
{
F_335 ( V_526 ) ;
F_336 ( V_526 ) ;
}
static int
F_338 ( struct V_525 * V_526 ,
...
V_1 = F_260 ( V_42 ) ;
F_324 ( V_1 ) ;
V_1 -> V_62 = F_341 ( & V_541 ) - 1 ;
F_261 ( & V_1 -> V_413 ) ;
V_505 = false ;
V_223 = F_329 ( V_1 , V_526 , & V_505 ) ;
if ( V_223 )
goto V_542;
V_223 = F_311 ( V_1 , V_526 , V_42 ) ;
if ( V_223 )
goto V_543;
F_309 ( V_1 , V_505 ) ;
F_101 ( V_42 ) ;
...
F_343 ( & V_1 -> V_256 [ 0 ] ) ;
F_82 ( & V_1 -> V_138 , V_34 ) ;
V_223 = F_252 ( V_1 , & V_1 -> V_256 [ 0 ] , V_545 ) ;
if ( V_223 )
goto V_546;
V_141 = & V_1 -> V_141 ;
V_539 . V_547 = F_344 ( V_1 -> V_18 -> V_548 ) ;
V_539 . V_549 = F_345 ( V_1 -> V_18 -> V_548 ) ;
V_539 . V_550 = V_1 -> V_18 -> V_551 ;
V_539 . V_552 = V_1 -> V_527 ;
F_81 ( & V_1 -> V_138 , V_34 ) ;
F_346 ( V_141 , V_1 , & V_539 , & V_1 -> V_256 [ 0 ] ) ;
F_82 ( & V_1 -> V_138 , V_34 ) ;
...
if ( V_223 )
goto V_553;
F_173 ( & V_1 -> V_141 . V_263 . V_264 . V_554 , F_160 ,
( unsigned long ) V_1 ) ;
F_173 ( & V_1 -> V_141 . V_263 . V_264 . V_555 , F_162 ,
( unsigned long ) V_1 ) ;
F_173 ( & V_1 -> V_141 . V_263 . V_264 . V_556 , F_164 ,
( unsigned long ) V_1 ) ;
F_173 ( & V_1 -> V_141 . V_263 . V_264 . V_557 , F_166 ,
( unsigned long ) V_1 ) ;
V_223 = F_249 ( V_1 ) ;
if ( V_223 ) {
F_317 ( & V_526 -> V_19 , L_13 , V_223 ) ;
goto V_558;
}
F_81 ( & V_1 -> V_138 , V_34 ) ;
...
goto V_561;
F_81 ( & V_1 -> V_138 , V_34 ) ;
F_349 ( & V_1 -> V_141 , & V_1 -> V_562 [ 0 ] ) ;
F_82 ( & V_1 -> V_138 , V_34 ) ;
V_223 = F_252 ( V_1 , & V_1 -> V_562 [ 0 ] , V_563 ) ;
if ( V_223 ) {
V_223 = - V_560 ;
goto V_561;
}
F_81 ( & V_1 -> V_138 , V_34 ) ;
F_350 ( & V_1 -> V_141 , & V_1 -> V_562 [ 0 ] ) ;
F_82 ( & V_1 -> V_138 , V_34 ) ;
F_81 ( & V_1 -> V_138 , V_34 ) ;
...
V_223 = F_351 ( V_42 ) ;
if ( V_223 ) {
F_317 ( & V_526 -> V_19 , L_14 ) ;
goto V_564;
}
F_90 ( V_565 , & V_1 -> V_140 ) ;
return 0 ;
V_558:
F_264 ( & V_1 -> V_413 ) ;
return 0 ;
V_564:
F_261 ( & V_1 -> V_413 ) ;
F_251 ( V_1 , & V_1 -> V_562 [ 0 ] , V_563 ) ;
V_561:
F_246 ( V_1 ) ;
F_177 ( & V_1 -> V_141 . V_263 . V_264 . V_554 ) ;
F_177 ( & V_1 -> V_141 . V_263 . V_264 . V_557 ) ;
...
static void
F_355 ( struct V_525 * V_526 )
{
struct V_41 * V_42 = F_356 ( V_526 ) ;
struct V_1 * V_1 ;
struct V_141 * V_141 ;
unsigned long V_34 ;
if ( ! V_42 )
