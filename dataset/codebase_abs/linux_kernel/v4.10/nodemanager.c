...
struct V_65 * V_79 = NULL , * V_23 = NULL ;
if ( V_5 )
return F_56 ( - V_80 ) ;
V_13 = F_57 ( sizeof( struct V_12 ) , V_70 ) ;
V_78 = F_57 ( sizeof( struct V_77 ) , V_70 ) ;
V_79 = F_67 () ;
if ( V_13 == NULL || V_78 == NULL || V_79 == NULL )
goto V_6;
F_68 ( & V_13 -> V_34 , V_67 ,
& V_81 ) ;
F_69 ( & V_78 -> V_82 , & V_13 -> V_34 ) ;
F_68 ( & V_78 -> V_82 , L_18 ,
& V_83 ) ;
F_69 ( V_79 , & V_13 -> V_34 ) ;
F_70 ( & V_13 -> V_7 ) ;
...
{
return F_75 ( & V_89 . V_90 , V_33 ) ;
}
void F_76 ( struct V_32 * V_33 )
{
F_77 ( V_33 ) ;
}
int F_78 ( void )
