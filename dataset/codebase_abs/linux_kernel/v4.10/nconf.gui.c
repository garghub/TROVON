...
T_3 * V_83 ;
T_8 * V_84 ;
int V_41 , V_36 , V_37 , V_44 , V_85 , V_86 , V_87 ;
int V_45 = - 1 ;
int V_88 = strlen ( V_77 ) ;
int V_89 ;
char * V_90 = * V_78 ;
F_20 ( V_39 , V_44 , V_85 ) ;
if ( strlen ( V_77 ) + 1 > * V_79 ) {
* V_79 = strlen ( V_77 ) + 1 ;
* V_78 = V_90 = realloc ( V_90 , * V_79 ) ;
}
V_80 = F_16 ( V_76 ) ;
...
V_86 = F_21 ( V_80 + 6 , V_44 - 2 ) ;
V_87 = F_21 ( V_81 + 7 , V_85 - 2 ) ;
V_80 = F_24 ( V_86 - 6 , 0 ) ;
V_81 = F_24 ( V_87 - 7 , 0 ) ;
V_37 = ( V_44 - V_86 ) / 2 ;
V_36 = ( V_85 - V_87 ) / 2 ;
strncpy ( V_90 , V_77 , * V_79 ) ;
V_30 = F_27 ( V_86 , V_87 , V_37 , V_36 ) ;
...
const char * line = F_17 ( V_40 , V_41 ) ;
int V_48 = F_18 ( line ) ;
V_102 = F_24 ( V_102 , V_48 + 2 ) ;
}
V_103 = F_61 ( V_46 + 10 , V_102 + 10 ) ;
( void ) F_13 ( V_103 , V_63 [ V_11 ] ) ;
F_19 ( V_103 , V_40 ) ;
V_86 = F_21 ( V_46 + 4 , V_44 - 2 ) ;
V_87 = F_21 ( V_102 + 2 , V_85 - 2 ) ;
V_100 = F_24 ( V_86 - 4 , 0 ) ;
V_101 = F_24 ( V_87 - 2 , 0 ) ;
V_37 = ( V_44 - V_86 ) / 2 ;
V_36 = ( V_85 - V_87 ) / 2 ;
...
V_84 = F_53 ( V_30 ) ;
do {
F_62 ( V_103 , V_30 , V_99 , V_98 , 2 , 2 , V_100 ,
V_101 , 0 ) ;
F_11 ( V_30 ,
V_100 + 2 ,
0 ,
