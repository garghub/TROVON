...
V_144 = F_76 ( V_3 -> V_43 , V_152 , 0 ) ;
if ( V_144 && V_144 -> V_153 ) {
F_66 ( V_3 ) ;
V_51 = F_77 ( V_123 , & V_154 , 0 ,
V_155 , V_156 ) ;
if ( V_51 ) {
...
V_159 = F_76 ( V_3 -> V_43 , V_161 , 0 ) ;
V_5 -> V_18 = F_81 ( & V_3 -> V_43 -> V_44 , V_159 ) ;
if ( F_82 ( V_5 -> V_18 ) )
return F_83 ( V_5 -> V_18 ) ;
}
return 0 ;
}
static int F_84 ( struct V_162 * V_43 )
{
...
struct V_2 * V_3 ;
int V_6 , V_51 ;
V_167 = F_85 ( & V_43 -> V_44 ) ;
if ( ! V_167 )
return - V_168 ;
V_165 = F_86 ( V_169 , & V_43 -> V_44 ) ;
if ( ! V_165 )
return - V_168 ;
...
if ( ! V_7 )
return - V_168 ;
V_3 = F_87 ( & V_43 -> V_44 , sizeof( * V_3 ) , V_150 ) ;
if ( ! V_3 )
return - V_158 ;
V_3 -> V_43 = V_43 ;
V_51 = F_80 ( V_3 , V_7 ) ;
...
V_3 -> V_173 = V_174 ;
V_3 -> V_173 . V_24 = F_71 ( & V_43 -> V_44 ) ;
V_3 -> V_173 . V_25 = V_3 -> V_7 -> V_25 ;
V_3 -> V_173 . V_11 = V_3 -> V_7 -> V_11 ;
V_3 -> V_60 = F_88 ( & V_3 -> V_173 , & V_43 -> V_44 , V_3 ) ;
if ( F_82 ( V_3 -> V_60 ) ) {
F_69 ( & V_43 -> V_44 , L_42 ) ;
return F_83 ( V_3 -> V_60 ) ;
}
F_89 ( & V_3 -> V_39 ) ;
V_51 = F_70 ( V_3 ) ;
if ( V_51 ) {
...
static int F_93 ( struct V_141 * V_44 )
{
struct V_162 * V_43 = F_94 ( V_44 ) ;
struct V_2 * V_3 = F_95 ( V_43 ) ;
int V_6 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 -> V_11 ; V_6 ++ ) {
void T_1 * V_13 ;
T_2 V_41 ;
...
static int F_98 ( struct V_141 * V_44 )
{
return 0 ;
}
static int F_99 ( struct V_141 * V_44 )
{
return 0 ;
}
