...
static void F_20 ( unsigned long V_9 , void * V_5 )
{
struct V_53 * V_11 = V_5 ;
V_11 -> V_54 [ V_11 -> V_55 ++ ] = V_9 ;
}
int T_7 F_21 ( T_5 * * V_56 , void * * V_57 ,
unsigned long V_58 )
{
struct V_1 * * V_2 ;
T_5 * V_54 ;
...
F_11 ( V_58 == 0 ) ;
V_60 = F_16 ( V_58 , V_8 ) ;
V_2 = F_22 ( V_60 , sizeof( V_2 [ 0 ] ) , V_61 ) ;
if ( ! V_2 )
return - V_62 ;
V_54 = F_22 ( V_58 , sizeof( V_54 [ 0 ] ) , V_61 ) ;
if ( ! V_54 ) {
F_23 ( V_2 ) ;
return - V_62 ;
}
...
V_5 . V_54 = V_54 ;
V_5 . V_55 = 0 ;
F_1 ( V_2 , V_58 , F_20 , & V_5 ) ;
V_59 = F_26 ( V_2 , V_60 , 0 , V_64 ) ;
if ( ! V_59 ) {
F_25 ( L_2 , V_63 ,
V_60 , V_23 ) ;
F_27 ( V_60 , V_2 ) ;
