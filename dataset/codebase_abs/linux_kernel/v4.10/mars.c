...
V_44 [ 1 ] = 0x0c | 0x01 ;
V_44 [ 2 ] = 0x01 ;
V_44 [ 3 ] = V_1 -> V_47 . V_49 / 8 ;
V_44 [ 4 ] = V_1 -> V_47 . V_48 / 8 ;
V_44 [ 5 ] = 0x30 ;
V_44 [ 6 ] = 0x02 ;
...
F_29 ( V_1 , V_56 , V_44 , V_2 ) ;
}
static int F_30 ( struct V_57 * V_58 ,
const struct V_39 * V_18 )
{
return F_31 ( V_58 , V_18 , & V_59 , sizeof( struct V_17 ) ,
V_60 ) ;
}
