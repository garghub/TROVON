...
V_46 -> V_50 = V_48 [ 0 ] & 0xff ;
V_46 -> V_51 = V_48 [ 1 ] & 0xfffffff ;
V_46 -> V_52 = V_48 [ 2 ] & 0xff ;
V_46 -> V_53 = ( V_48 [ 2 ] >> 8 ) & 0xff ;
V_46 -> V_54 = ( V_48 [ 2 ] >> 16 ) & 0xffff ;
...
static int F_20 ( void * V_55 )
{
int V_57 ;
struct V_1 * V_2 = (struct V_1 * ) V_55 ;
V_57 = F_21 ( V_2 , 64 * 1024 , false ) ;
if ( V_57 )
return V_57 ;
V_57 = F_22 ( V_2 ) ;
return V_57 ;
