...
V_198 [ V_144 ] [ V_180 ] ,
& V_4 ) ;
V_185 = F_94 ( V_27 -> V_36 . type , V_4 ) << 6 ;
V_186 = F_83 ( V_185 , 1024 , & V_187 ) ;
F_6 ( 0 , L_52 ,
V_70 , V_144 , V_180 ,
V_186 , ( V_187 * 1000 ) / 1024 ,
( ( T_3 ) V_185 ) << 20L ,
( T_1 ) F_95 ( V_27 -> V_36 . type , V_4 ) ,
V_4 ) ;
}
}
}
...
! V_27 -> V_31 || ! V_27 -> V_161 || ! V_27 -> V_44 )
goto V_250;
if ( V_237 != 0x0f &&
V_237 != 0x33 &&
V_237 != 0xff )
...
char V_332 = * ( L_102 ) ;
V_101 = F_66 ( V_313 -> V_331 == 16 , V_101 ) ;
V_201 = 1 << V_101 ;
...
static int F_118 ( struct V_337 * V_338 , unsigned long V_339 ,
void * V_340 )
{
struct V_312 * V_312 = (struct V_312 * ) V_340 ;
struct V_139 * V_140 ;
struct V_26 * V_27 ;
char * type ;
if ( F_119 () == V_341 )
return V_342 ;
V_140 = F_96 ( V_312 -> V_343 ) ;
if ( ! V_140 )
return V_342 ;
V_27 = V_140 -> V_141 ;
if ( ( V_312 -> V_320 & 0xefff ) >> 7 != 1 )
return V_342 ;
if ( V_312 -> V_318 & V_344 )
type = L_108 ;
else
type = L_109 ;
F_120 ( V_140 , V_231 , L_110 ) ;
F_120 ( V_140 , V_231 , L_111
L_112 , V_312 -> V_345 , type ,
V_312 -> V_318 , V_312 -> V_331 , V_312 -> V_320 ) ;
F_120 ( V_140 , V_231 , L_113 , V_312 -> V_346 ) ;
F_120 ( V_140 , V_231 , L_114 , V_312 -> V_69 ) ;
F_120 ( V_140 , V_231 , L_115 , V_312 -> V_347 ) ;
F_120 ( V_140 , V_231 , L_116
L_117 , V_312 -> V_348 , V_312 -> V_349 ,
V_312 -> time , V_312 -> V_343 , V_312 -> V_350 ) ;
F_115 ( V_140 , V_312 ) ;
return V_351 ;
}
static void F_121 ( struct V_17 * V_17 )
{
struct V_139 * V_140 = V_17 -> V_140 ;
struct V_26 * V_27 ;
if ( F_106 ( ! V_140 || ! V_140 -> V_141 ) ) {
F_6 ( 0 , L_118 , & V_17 -> V_24 [ 0 ] -> V_303 ) ;
F_59 ( V_84 , L_119 ) ;
return;
}
V_27 = V_140 -> V_141 ;
...
F_122 ( V_140 -> V_24 ) ;
F_6 ( 1 , L_121 , V_140 -> V_352 ) ;
F_16 ( V_140 -> V_352 ) ;
F_123 ( V_140 ) ;
V_17 -> V_140 = NULL ;
}
static int F_124 ( struct V_17 * V_17 , enum type type )
{
struct V_139 * V_140 ;
struct V_353 V_170 [ 2 ] ;
struct V_26 * V_27 ;
...
V_170 [ 0 ] . V_355 = false ;
V_170 [ 1 ] . type = V_356 ;
V_170 [ 1 ] . V_147 = type == V_13 ? 1 : V_357 ;
V_170 [ 1 ] . V_355 = true ;
V_140 = F_125 ( V_17 -> V_87 , F_62 ( V_170 ) , V_170 ,
sizeof( * V_27 ) ) ;
if ( F_106 ( ! V_140 ) )
return - V_235 ;
F_6 ( 0 , L_120 ,
...
V_27 -> V_17 = V_17 ;
V_17 -> V_140 = V_140 ;
V_140 -> V_358 = type == V_13 ?
V_359 : V_360 ;
V_140 -> V_361 = V_362 ;
V_140 -> V_363 = V_362 ;
V_140 -> V_364 = L_122 ;
V_140 -> V_365 = V_366 ;
V_140 -> V_367 = F_126 ( V_24 ) ;
V_140 -> V_368 = NULL ;
V_27 -> V_36 . type = type ;
switch ( type ) {
case V_76 :
V_27 -> V_36 . V_37 = V_369 ;
V_27 -> V_36 . V_190 = F_25 ;
V_27 -> V_36 . V_192 = F_26 ;
V_27 -> V_36 . V_119 = V_370 ;
V_27 -> V_36 . F_37 = F_37 ;
V_27 -> V_36 . F_45 = F_45 ;
V_27 -> V_36 . F_27 = F_27 ;
V_27 -> V_36 . F_28 = F_28 ;
...
V_27 -> V_36 . F_30 = F_30 ;
V_27 -> V_36 . F_31 = F_31 ;
V_27 -> V_36 . V_134 = F_62 ( V_370 ) ;
V_27 -> V_36 . V_136 = V_371 ;
V_27 -> V_36 . V_213 = F_62 ( V_371 ) ;
V_27 -> V_36 . V_2 = V_372 ;
V_27 -> V_36 . V_177 = F_42 ;
V_140 -> V_352 = F_127 ( V_23 , L_123 , V_140 -> V_373 ) ;
V_57 = F_111 ( V_140 , V_17 ) ;
if ( F_106 ( V_57 < 0 ) )
goto V_374;
break;
case V_79 :
V_27 -> V_36 . V_37 = V_375 ;
V_27 -> V_36 . V_190 = F_20 ;
V_27 -> V_36 . V_192 = F_23 ;
V_27 -> V_36 . V_119 = V_376 ;
V_27 -> V_36 . F_37 = F_37 ;
V_27 -> V_36 . F_45 = F_45 ;
V_27 -> V_36 . F_27 = F_27 ;
V_27 -> V_36 . F_28 = F_28 ;
...
V_27 -> V_36 . F_30 = F_30 ;
V_27 -> V_36 . F_31 = F_31 ;
V_27 -> V_36 . V_134 = F_62 ( V_376 ) ;
V_27 -> V_36 . V_136 = V_377 ;
V_27 -> V_36 . V_213 = F_62 ( V_377 ) ;
V_27 -> V_36 . V_2 = V_378 ;
V_27 -> V_36 . V_177 = F_40 ;
V_140 -> V_352 = F_127 ( V_23 , L_124 , V_140 -> V_373 ) ;
...
V_27 -> V_36 . V_2 = V_372 ;
V_27 -> V_36 . V_177 = F_42 ;
V_140 -> V_352 = F_127 ( V_23 , L_125 , V_140 -> V_373 ) ;
...
V_140 -> V_352 = F_127 ( V_23 , L_126 , V_140 -> V_373 ) ;
...
static int F_129 ( const struct V_381 * V_72 )
{
int V_57 = - V_83 ;
T_2 V_87 , V_226 = 0 ;
struct V_17 * V_17 ;
struct V_22 * V_382 = (struct V_22 * ) V_72 -> V_383 ;
V_57 = F_109 ( & V_226 , V_382 ) ;
if ( F_106 ( V_57 < 0 ) ) {
F_6 ( 0 , L_129 ) ;
goto V_374;
}
...
V_87 , V_87 + 1 , V_226 ) ;
V_17 -> V_87 = V_87 ++ ;
V_57 = F_124 ( V_17 , V_382 -> type ) ;
if ( F_106 ( V_57 < 0 ) )
goto V_384;
}
F_59 ( V_234 , L_107 , V_366 ) ;
return 0 ;
V_384:
F_13 (sbridge_dev, &sbridge_edac_list, list)
F_121 ( V_17 ) ;
