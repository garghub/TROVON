...
static inline void F_64 ( struct V_29 * V_84 )
{
#ifdef F_65
if ( V_84 ) {
V_84 -> V_85 . V_86 = V_84 -> V_30 -> F_64 ( V_84 ) ;
F_66 ( V_84 ) ;
}
#endif
}
static long F_67 ( struct V_87 * V_88 , unsigned int V_89 ,
unsigned long V_90 )
{
...
return F_69 ( V_88 , V_89 , V_90 ) ;
}
static int F_70 ( struct V_98 * V_52 , const struct V_99 * V_100 )
{
return F_71 ( V_52 , V_100 , & V_79 ) ;
}
static void F_72 ( struct V_98 * V_52 )
{
struct V_1 * V_2 = F_73 ( V_52 ) ;
F_74 ( V_2 ) ;
}
static int T_2 F_75 ( void )
{
return F_76 ( & V_79 , & V_101 ) ;
}
