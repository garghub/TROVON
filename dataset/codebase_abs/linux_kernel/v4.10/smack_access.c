...
V_61 -> V_10 = V_71 ;
V_61 -> V_93 = V_94 ++ ;
V_61 -> V_95 . V_96 = V_61 -> V_10 ;
V_61 -> V_95 . V_84 =
V_97 | V_98 ;
V_90 = strlen ( V_71 ) ;
if ( V_90 < V_99 )
V_22 = F_27 ( V_100 , V_61 -> V_10 ,
& V_61 -> V_95 , V_90 ) ;
else
V_22 = F_27 ( V_101 , ( char * ) & V_61 -> V_93 ,
& V_61 -> V_95 , sizeof( V_61 -> V_93 ) ) ;
if ( V_22 >= 0 ) {
F_34 ( & V_61 -> V_30 ) ;
F_35 ( & V_61 -> V_102 ) ;
F_18 ( V_61 ) ;
...
struct V_15 * F_38 ( const T_1 V_104 )
{
struct V_15 * V_61 ;
F_3 () ;
