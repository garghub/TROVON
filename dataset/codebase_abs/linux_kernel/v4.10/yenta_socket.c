...
{
int V_190 = 0 ;
V_190 += F_56 ( V_2 , 0 , V_169 ,
V_191 , V_192 ) ;
V_190 += F_56 ( V_2 , 1 , V_169 ,
V_193 , V_194 ) ;
V_190 += F_56 ( V_2 , 2 , V_175 | V_176 ,
V_195 , V_196 ) ;
V_190 += F_56 ( V_2 , 3 , V_175 ,
V_197 , V_198 ) ;
if ( V_190 )
F_61 ( V_2 -> V_7 -> V_184 ) ;
}
...
static unsigned int F_74 ( struct V_1 * V_2 , T_1 V_200 )
{
int V_14 ;
unsigned long V_4 ;
T_1 V_180 ;
...
F_4 ( V_2 , V_105 , 0 ) ;
F_21 ( V_2 , V_93 , V_3 ) ;
V_180 = F_77 ( V_4 ) & 0xffff ;
return V_180 ;
}
static T_6 F_78 ( int V_82 , void * V_143 )
{
struct V_1 * V_2 = (struct V_1 * ) V_143 ;
T_2 V_145 ;
T_1 V_146 ;
...
return - 1 ;
V_2 -> V_203 = 0 ;
if ( F_80 ( V_2 -> V_83 , F_78 , V_204 , L_12 , V_2 ) ) {
F_81 ( & V_2 -> V_7 -> V_7 ,
L_13 ) ;
return - 1 ;
}
...
static void F_83 ( struct V_1 * V_2 , T_1 V_200 )
{
V_2 -> V_2 . V_205 = V_2 -> V_83 ;
if ( V_206 )
V_2 -> V_2 . V_207 = F_74 ( V_2 , V_200 ) ;
else
V_2 -> V_2 . V_207 = 0 ;
F_59 ( & V_2 -> V_7 -> V_7 , L_14 ,
...
F_16 ( V_2 , V_208 , 0 ) ;
F_16 ( V_2 , V_209 , V_127 . V_116 ) ;
F_14 ( V_2 , V_210 ,
V_211 |
V_212 |
V_213 |
V_214 ) ;
F_12 ( V_2 , V_215 , V_216 / 4 ) ;
F_12 ( V_2 , V_217 , 168 ) ;
F_16 ( V_2 , V_218 ,
( 176 << 24 ) |
( ( unsigned int ) V_7 -> V_184 -> V_219 . V_132 << 16 ) |
( ( unsigned int ) V_7 -> V_184 -> V_219 . V_116 << 8 ) |
V_7 -> V_184 -> V_220 ) ;
V_75 = F_8 ( V_2 , V_77 ) ;
V_75 &= ~ ( V_78 | V_221 | V_222 | V_223 ) ;
V_75 |= V_224 | V_225 ;
F_14 ( V_2 , V_77 , V_75 ) ;
}
static void F_85 ( struct V_226 * V_227 )
{
struct V_226 * V_228 ;
unsigned char V_229 ;
struct V_226 * V_230 = V_227 -> V_182 ;
if ( V_230 -> V_219 . V_132 >= V_227 -> V_219 . V_132 )
return;
if ( ! V_230 -> V_182 )
return;
V_229 = V_230 -> V_182 -> V_219 . V_132 ;
F_86 (sibling, &bridge_to_fix->parent->children,
node) {
if ( V_228 -> V_219 . V_116 > V_230 -> V_219 . V_132
&& V_228 -> V_219 . V_116 <= V_229 )
V_229 = V_228 -> V_219 . V_116 - 1 ;
}
if ( V_227 -> V_219 . V_132 > V_229 )
F_81 ( & V_227 -> V_7 ,
L_15 ,
V_229 ) ;
if ( V_230 -> V_219 . V_132 < V_229 ) {
unsigned char V_231 =
F_87 ( int , V_227 -> V_219 . V_132 , V_229 ) ;
F_59 ( & V_230 -> V_7 ,
L_16 ,
V_230 -> V_232 ,
( int ) V_230 -> V_219 . V_132 ,
V_231 ) ;
V_230 -> V_219 . V_132 = V_231 ;
F_13 ( V_230 -> V_233 ,
V_234 , V_230 -> V_219 . V_132 ) ;
}
}
static int F_88 ( struct V_13 * V_7 , const struct V_235 * V_236 )
{
struct V_1 * V_2 ;
int V_237 ;
if ( ! V_7 -> V_184 ) {
...
V_2 = F_90 ( sizeof( struct V_1 ) , V_239 ) ;
if ( ! V_2 )
return - V_240 ;
V_2 -> V_2 . V_241 = & V_242 ;
V_2 -> V_2 . V_243 = & V_244 ;
...
V_2 -> V_2 . V_245 = V_2 ;
V_2 -> V_2 . V_246 = V_247 ;
V_2 -> V_2 . V_248 = V_249 | V_250 ;
V_2 -> V_2 . V_251 = 0x1000 ;
V_2 -> V_2 . V_252 = V_7 ;
V_2 -> V_7 = V_7 ;
F_72 ( V_7 , V_2 ) ;
if ( F_91 ( V_7 ) ) {
...
V_2 -> V_5 = F_94 ( F_93 ( V_7 , 0 ) , 0x1000 ) ;
if ( ! V_2 -> V_5 ) {
V_237 = - V_240 ;
goto V_255;
}
...
F_60 ( V_2 ) ;
V_2 -> V_83 = V_7 -> V_82 ;
if ( V_236 -> V_245 != V_258 &&
V_236 -> V_245 < F_95 ( V_259 ) ) {
V_2 -> type = & V_259 [ V_236 -> V_245 ] ;
V_237 = V_2 -> type -> V_260 ( V_2 ) ;
if ( V_237 < 0 )
goto V_261;
}
if ( ! V_2 -> V_83 || F_80 ( V_2 -> V_83 , F_44 , V_204 , L_12 , V_2 ) ) {
V_2 -> V_83 = 0 ;
F_96 ( & V_2 -> V_152 , F_46 ,
( unsigned long ) V_2 ) ;
F_97 ( & V_2 -> V_152 , V_154 + V_155 ) ;
F_59 ( & V_7 -> V_7 ,
L_21 ) ;
F_59 ( & V_7 -> V_7 ,
L_22 ) ;
...
{
struct V_13 * V_265 = F_25 ( V_7 ) ;
struct V_1 * V_2 = F_26 ( V_265 ) ;
if ( ! V_2 )
return 0 ;
if ( V_2 -> type && V_2 -> type -> V_266 )
V_2 -> type -> V_266 ( V_2 ) ;
F_101 ( V_265 ) ;
F_11 ( V_265 , 16 * 4 , & V_2 -> V_267 [ 0 ] ) ;
F_11 ( V_265 , 17 * 4 , & V_2 -> V_267 [ 1 ] ) ;
F_71 ( V_265 ) ;
return 0 ;
}
static int F_102 ( struct V_8 * V_7 )
{
struct V_13 * V_265 = F_25 ( V_7 ) ;
struct V_1 * V_2 = F_26 ( V_265 ) ;
int V_237 ;
if ( ! V_2 )
return 0 ;
F_17 ( V_265 , 16 * 4 , V_2 -> V_267 [ 0 ] ) ;
F_17 ( V_265 , 17 * 4 , V_2 -> V_267 [ 1 ] ) ;
V_237 = F_91 ( V_265 ) ;
if ( V_237 )
return V_237 ;
F_103 ( V_265 ) ;
if ( V_2 -> type && V_2 -> type -> V_268 )
V_2 -> type -> V_268 ( V_2 ) ;
return 0 ;
}
