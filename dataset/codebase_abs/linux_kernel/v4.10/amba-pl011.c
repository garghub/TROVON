...
static void F_97 ( struct V_3 * V_4 , bool V_184 )
{
struct V_104 * V_99 = & V_4 -> V_8 . V_98 -> V_99 ;
...
result |= tiocmbit
F_112 ( V_188 , V_211 ) ;
F_112 ( V_4 -> V_167 -> V_189 , V_212 ) ;
F_112 ( V_4 -> V_167 -> V_191 , V_213 ) ;
F_112 ( V_4 -> V_167 -> V_214 , V_215 ) ;
#undef F_112
return V_210 ;
}
static void F_113 ( struct V_127 * V_8 , unsigned int V_216 )
{
struct V_3 * V_4 =
F_96 ( V_8 , struct V_3 , V_8 ) ;
unsigned int V_217 ;
...
static void F_114 ( struct V_127 * V_8 , int V_231 )
{
struct V_3 * V_4 =
F_96 ( V_8 , struct V_3 , V_8 ) ;
unsigned long V_91 ;
...
int V_237 ;
F_119 ( V_8 -> V_2 ) ;
V_237 = F_120 ( V_4 -> V_238 ) ;
if ( V_237 )
return V_237 ;
V_4 -> V_8 . V_239 = F_121 ( V_4 -> V_238 ) ;
F_9 ( V_146 | V_147 | V_148 |
V_149 | V_203 | V_204 ,
V_4 , V_150 ) ;
...
{
return F_5 ( V_4 , V_241 ) !=
F_5 ( V_4 , V_233 ) ;
}
static void F_123 ( struct V_3 * V_4 , unsigned int V_232 )
{
F_9 ( V_232 , V_4 , V_241 ) ;
if ( F_122 ( V_4 ) ) {
int V_242 ;
...
static void
F_138 ( struct V_127 * V_8 , struct V_254 * V_255 ,
struct V_254 * V_265 )
{
struct V_3 * V_4 =
F_96 ( V_8 , struct V_3 , V_8 ) ;
...
V_268 = 16 ;
V_266 = F_139 ( V_8 , V_255 , V_265 , 0 ,
V_8 -> V_239 / V_268 ) ;
#ifdef F_140
if ( V_4 -> V_80 . V_81 )
V_4 -> V_80 . V_84 = F_141 ( 10000000 , V_266 ) ;
#endif
if ( V_266 > V_8 -> V_239 / 16 )
V_267 = F_142 ( V_8 -> V_239 * 8 , V_266 ) ;
else
V_267 = F_142 ( V_8 -> V_239 * 4 , V_266 ) ;
...
V_232 |= V_251 ;
F_46 ( & V_8 -> V_93 , V_91 ) ;
F_143 ( V_8 , V_255 -> V_263 , V_266 ) ;
F_137 ( V_8 , V_255 ) ;
if ( F_144 ( V_8 , V_255 -> V_263 ) )
F_100 ( V_8 ) ;
V_246 = F_6 ( V_4 , V_218 ) ;
F_9 ( 0 , V_4 , V_218 ) ;
if ( V_255 -> V_263 & V_286 ) {
if ( V_246 & V_220 )
V_246 |= V_230 ;
V_246 |= V_287 ;
V_4 -> V_229 = true ;
...
F_9 ( V_267 & 0x3f , V_4 , V_289 ) ;
F_9 ( V_267 >> 6 , V_4 , V_290 ) ;
F_123 ( V_4 , V_232 ) ;
F_9 ( V_246 , V_4 , V_218 ) ;
F_50 ( & V_8 -> V_93 , V_91 ) ;
}
static void
F_145 ( struct V_127 * V_8 , struct V_254 * V_255 ,
struct V_254 * V_265 )
{
struct V_3 * V_4 =
F_96 ( V_8 , struct V_3 , V_8 ) ;
unsigned long V_91 ;
F_146 ( V_255 , V_4 -> V_291 , V_4 -> V_291 ) ;
V_255 -> V_263 &= ~ ( V_270 | V_278 | V_280 | V_282 ) ;
V_255 -> V_263 &= ~ ( V_284 | V_286 ) ;
V_255 -> V_263 |= V_292 | V_293 ;
F_46 ( & V_8 -> V_93 , V_91 ) ;
F_143 ( V_8 , V_292 , V_4 -> V_291 ) ;
F_137 ( V_8 , V_255 ) ;
F_50 ( & V_8 -> V_93 , V_91 ) ;
}
...
struct V_3 * V_4 =
F_96 ( V_8 , struct V_3 , V_8 ) ;
return V_4 -> V_8 . type == V_294 ? V_4 -> type : NULL ;
}
static void F_148 ( struct V_127 * V_8 )
{
F_149 ( V_8 -> V_55 , V_295 ) ;
}
static int F_150 ( struct V_127 * V_8 )
{
return F_151 ( V_8 -> V_55 , V_295 , L_25 )
!= NULL ? 0 : - V_112 ;
}
...
static int F_153 ( struct V_127 * V_8 , struct V_297 * V_298 )
{
int V_125 = 0 ;
if ( V_298 -> type != V_299 && V_298 -> type != V_294 )
V_125 = - V_300 ;
if ( V_298 -> V_195 < 0 || V_298 -> V_195 >= V_301 )
V_125 = - V_300 ;
if ( V_298 -> V_302 < 9600 )
V_125 = - V_300 ;
return V_125 ;
}
static void F_154 ( struct V_127 * V_8 , unsigned int V_216 )
{
}
...
static void
F_157 ( struct V_303 * V_304 , const char * V_305 , unsigned int V_105 )
{
struct V_3 * V_4 = V_306 [ V_304 -> V_307 ] ;
unsigned int V_246 = 0 , V_308 ;
unsigned long V_91 ;
int V_309 = 1 ;
F_158 ( V_4 -> V_238 ) ;
F_159 ( V_91 ) ;
...
F_161 ( & V_4 -> V_8 , V_305 , V_105 , F_156 ) ;
while ( F_6 ( V_4 , V_18 ) & V_4 -> V_167 -> V_173 )
F_90 () ;
if ( ! V_4 -> V_167 -> V_312 )
F_9 ( V_246 , V_4 , V_218 ) ;
...
static void T_10
F_164 ( struct V_3 * V_4 , int * V_266 ,
int * V_30 , int * V_313 )
{
if ( F_6 ( V_4 , V_218 ) & V_247 ) {
unsigned int V_232 , V_314 , V_315 ;
V_232 = F_6 ( V_4 , V_233 ) ;
* V_30 = 'n' ;
if ( V_232 & V_281 ) {
if ( V_232 & V_283 )
...
V_314 = F_6 ( V_4 , V_290 ) ;
V_315 = F_6 ( V_4 , V_289 ) ;
* V_266 = V_4 -> V_8 . V_239 * 4 / ( 64 * V_314 + V_315 ) ;
if ( V_4 -> V_167 -> V_269 ) {
if ( F_6 ( V_4 , V_218 )
& V_288 )
* V_266 *= 2 ;
...
static int T_10 F_165 ( struct V_303 * V_304 , char * V_316 )
{
struct V_3 * V_4 ;
int V_266 = 38400 ;
int V_313 = 8 ;
...
int V_317 = 'n' ;
int V_125 ;
if ( V_304 -> V_307 >= V_318 )
V_304 -> V_307 = 0 ;
V_4 = V_306 [ V_304 -> V_307 ] ;
if ( ! V_4 )
return - V_319 ;
F_119 ( V_4 -> V_8 . V_2 ) ;
V_125 = F_166 ( V_4 -> V_238 ) ;
if ( V_125 )
return V_125 ;
if ( F_28 ( V_4 -> V_8 . V_2 ) ) {
struct V_50 * V_51 ;
...
if ( V_316 )
F_167 ( V_316 ,
& V_266 , & V_30 , & V_313 , & V_317 ) ;
else
F_164 ( V_4 , & V_266 , & V_30 , & V_313 ) ;
}
return F_168 ( & V_4 -> V_8 , V_304 , V_266 , V_30 , V_313 , V_317 ) ;
}
static int T_10 F_169 ( struct V_303 * V_304 , char * V_321 , int V_322 ,
char * V_316 )
{
unsigned char V_10 ;
T_11 V_7 ;
int V_242 ;
if ( strcmp ( V_321 , L_26 ) != 0 )
return - V_319 ;
if ( F_170 ( V_316 , & V_10 , & V_7 , & V_316 ) )
return - V_319 ;
if ( V_10 != V_323 && V_10 != V_11 )
return - V_319 ;
for ( V_242 = 0 ; V_242 < F_171 ( V_306 ) ; V_242 ++ ) {
struct V_127 * V_8 ;
if ( ! V_306 [ V_242 ] )
continue;
V_8 = & V_306 [ V_242 ] -> V_8 ;
...
V_304 -> V_307 = V_242 ;
V_8 -> V_324 = V_304 ;
return F_165 ( V_304 , V_316 ) ;
}
return - V_319 ;
}
static void F_172 ( struct V_127 * V_8 , int V_183 )
{
while ( F_173 ( V_8 -> V_9 + V_325 ) & V_126 )
F_90 () ;
if ( V_8 -> V_10 == V_11 )
F_174 ( V_183 , V_8 -> V_9 + V_326 ) ;
else
F_175 ( V_183 , V_8 -> V_9 + V_326 ) ;
while ( F_173 ( V_8 -> V_9 + V_325 ) & V_327 )
F_90 () ;
}
static void F_176 ( struct V_303 * V_328 , const char * V_305 , unsigned V_329 )
{
struct V_330 * V_2 = V_328 -> V_89 ;
F_161 ( & V_2 -> V_8 , V_305 , V_329 , F_172 ) ;
}
static int T_10 F_177 ( struct V_330 * V_46 ,
const char * V_331 )
{
if ( ! V_46 -> V_8 . V_9 )
return - V_319 ;
V_46 -> V_328 -> V_332 = F_176 ;
return 0 ;
}
static int F_178 ( int V_307 , struct V_46 * V_2 )
{
struct V_333 * V_334 ;
static bool V_335 = false ;
static bool V_336 = false ;
int V_125 = V_307 ;
if ( ! F_179 ( V_337 ) )
return V_125 ;
V_334 = V_2 -> V_87 ;
if ( ! V_334 )
return V_125 ;
V_125 = F_180 ( V_334 , L_27 ) ;
if ( V_125 < 0 ) {
V_336 = true ;
V_125 = V_307 ;
} else {
V_335 = true ;
if ( V_125 >= F_171 ( V_306 ) || V_306 [ V_125 ] != NULL ) {
F_68 ( V_2 , L_28 , V_125 ) ;
V_125 = V_307 ;
}
}
...
static int F_184 ( struct V_46 * V_2 , struct V_3 * V_4 ,
struct V_340 * V_341 , int V_307 )
{
void T_1 * V_342 ;
V_342 = F_185 ( V_2 , V_341 ) ;
if ( F_30 ( V_342 ) )
return F_31 ( V_342 ) ;
V_307 = F_178 ( V_307 , V_2 ) ;
V_4 -> V_246 = 0 ;
V_4 -> V_8 . V_2 = V_2 ;
V_4 -> V_8 . V_55 = V_341 -> V_343 ;
V_4 -> V_8 . V_9 = V_342 ;
V_4 -> V_8 . V_61 = V_4 -> V_61 ;
V_4 -> V_8 . V_91 = V_344 ;
V_4 -> V_8 . line = V_307 ;
...
V_125 = F_188 ( & V_339 , & V_4 -> V_8 ) ;
if ( V_125 )
F_181 ( V_4 ) ;
return V_125 ;
}
static int F_189 ( struct V_1 * V_2 , const struct V_345 * V_346 )
{
struct V_3 * V_4 ;
struct V_347 * V_167 = V_346 -> V_89 ;
int V_348 , V_125 ;
V_348 = F_183 () ;
if ( V_348 < 0 )
return V_348 ;
V_4 = F_190 ( & V_2 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_4 -> V_238 = F_191 ( & V_2 -> V_2 , NULL ) ;
if ( F_30 ( V_4 -> V_238 ) )
return F_31 ( V_4 -> V_238 ) ;
V_4 -> V_6 = V_167 -> V_6 ;
V_4 -> V_167 = V_167 ;
V_4 -> V_61 = V_167 -> V_349 ( V_2 ) ;
V_4 -> V_8 . V_10 = V_167 -> V_350 ? V_11 : V_323 ;
V_4 -> V_8 . V_195 = V_2 -> V_195 [ 0 ] ;
V_4 -> V_8 . V_252 = & V_351 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_31 , F_2 ( V_2 ) ) ;
V_125 = F_184 ( & V_2 -> V_2 , V_4 , & V_2 -> V_352 , V_348 ) ;
if ( V_125 )
return V_125 ;
F_192 ( V_2 , V_4 ) ;
return F_186 ( V_4 ) ;
...
{
struct V_3 * V_4 = F_194 ( V_2 ) ;
F_195 ( & V_339 , & V_4 -> V_8 ) ;
F_181 ( V_4 ) ;
return 0 ;
}
static int F_196 ( struct V_46 * V_2 )
{
struct V_3 * V_4 = F_197 ( V_2 ) ;
if ( ! V_4 )
return - V_300 ;
return F_198 ( & V_339 , & V_4 -> V_8 ) ;
}
static int F_199 ( struct V_46 * V_2 )
{
struct V_3 * V_4 = F_197 ( V_2 ) ;
if ( ! V_4 )
return - V_300 ;
return F_200 ( & V_339 , & V_4 -> V_8 ) ;
}
static int F_201 ( struct V_353 * V_354 )
{
struct V_3 * V_4 ;
struct V_340 * V_355 ;
int V_348 , V_125 ;
int V_356 ;
if ( V_354 -> V_2 . V_87 ) {
struct V_333 * V_334 = V_354 -> V_2 . V_87 ;
V_125 = F_43 ( V_334 , L_32 , & V_356 ) ;
if ( V_125 )
return V_125 ;
} else {
V_356 = 115200 ;
...
if ( V_348 < 0 )
return V_348 ;
V_4 = F_190 ( & V_354 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_125 = F_202 ( V_354 , 0 ) ;
...
V_4 -> V_167 = & V_357 ;
V_4 -> V_61 = 32 ;
V_4 -> V_8 . V_10 = V_357 . V_350 ? V_11 : V_323 ;
V_4 -> V_8 . V_252 = & V_358 ;
V_4 -> V_291 = V_356 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_34 ) ;
V_355 = F_203 ( V_354 , V_359 , 0 ) ;
V_125 = F_184 ( & V_354 -> V_2 , V_4 , V_355 , V_348 ) ;
if ( V_125 )
return V_125 ;
F_204 ( V_354 , V_4 ) ;
return F_186 ( V_4 ) ;
}
static int F_205 ( struct V_353 * V_354 )
{
struct V_3 * V_4 = F_206 ( V_354 ) ;
F_195 ( & V_339 , & V_4 -> V_8 ) ;
F_181 ( V_4 ) ;
return 0 ;
}
