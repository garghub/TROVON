...
V_2 -> V_245 . V_228 = F_72 ( V_2 -> V_245 . V_231 , V_2 -> V_245 . V_235 ) ;
if ( ! V_2 -> V_245 . V_228 ) {
F_32 ( L_23 ) ;
return - V_237 ;
} else
...
{
unsigned char V_250 , V_74 , V_182 , V_75 , V_76 , V_207 , V_251 , V_88 = 0 , V_5 ;
static unsigned char V_252 [] = { 8 , 4 , 4 , 2 } ;
static unsigned char V_253 [] = { 2 , 4 , 8 , 12 , 16 , 32 , 64 , 32 } ;
static unsigned char V_254 [] = { 2 , 8 , 4 , 16 , 8 , 16 , 4 , 16 } ;
static unsigned char V_255 [] = { 0 , 2 , 4 , 8 , 16 , 32 , 2 , 2 } ;
...
F_36 ( 0x3d4 , 0x4838 , V_2 ) ;
F_24 ( 0x3d4 , 0x36 , V_2 ) ;
V_250 = F_25 ( 0x3d5 , V_2 ) ;
switch ( V_2 -> V_38 ) {
case V_39 :
V_256 = V_252 [ ( V_250 & 0xC0 ) >> 6 ] * 1024 ;
break;
case V_43 :
F_24 ( 0x3d4 , 0x68 , V_2 ) ;
...
V_253 [ 1 ] = 8 ;
case V_48 :
V_256 = V_253 [ ( V_250 & 0xE0 ) >> 5 ] * 1024 ;
break;
case V_40 :
case V_47 :
V_256 = V_254 [ ( V_250 & 0x0E ) >> 1 ] * 1024 ;
break;
case V_45 :
case V_46 :
case V_44 :
V_256 = V_255 [ ( V_250 & 0xE0 ) >> 5 ] * 1024 ;
break;
default:
V_256 = 0 ;
break;
...
V_258 = 0 ;
if ( V_2 -> V_38 == V_43 ) {
unsigned char V_260 = 0x00 ;
F_24 ( 0x3c4 , 0x30 , V_2 ) ;
F_24 ( 0x3c5 , F_25 ( 0x3c5 , V_2 ) & ~ 0x02 , V_2 ) ;
V_260 = F_25 ( 0x3c5 , V_2 ) ;
if ( V_260 & 0x02 ) {
V_258 = 1 ;
F_32 ( L_30 ) ;
}
...
if ( ( F_45 ( V_2 -> V_38 ) ||
F_78 ( V_2 -> V_38 ) ) && ! V_2 -> V_261 )
V_2 -> V_209 = V_216 ;
else if ( V_258 || ( V_2 -> V_38 == V_43 && V_2 -> V_258 ) )
V_2 -> V_209 = V_217 ;
else
V_2 -> V_209 = V_210 ;
if ( V_2 -> V_209 == V_216 ) {
unsigned char V_262 = F_79 ( 0x6b , V_2 ) ;
int V_263 = ( F_4 ( 0x61 , V_2 ) +
( ( F_4 ( 0x66 , V_2 ) & 0x02 ) << 7 ) + 1 ) * 8 ;
int V_264 = ( F_4 ( 0x69 , V_2 ) +
...
V_2 -> V_41 = V_257 - V_2 -> V_247 ;
}
return V_257 ;
}
static int F_81 ( struct V_56 * V_57 , struct V_272 * V_273 ,
const struct V_274 * V_275 )
{
struct V_1 * V_2 = V_57 -> V_2 ;
int V_200 = 0 ;
V_2 -> V_232 = V_273 ;
V_57 -> V_177 . type = V_276 ;
V_57 -> V_177 . V_277 = 0 ;
V_57 -> V_177 . V_278 = 1 ;
V_57 -> V_177 . V_279 = 0 ;
V_57 -> V_177 . V_280 = V_275 -> V_281 ;
switch ( V_57 -> V_177 . V_280 ) {
case V_282 :
V_2 -> V_38 = V_47 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_40 ) ;
break;
case V_283 :
V_2 -> V_38 = V_43 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_41 ) ;
break;
case V_284 :
V_2 -> V_38 = V_39 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_42 ) ;
break;
case V_285 :
V_2 -> V_38 = V_39 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_43 ) ;
break;
case V_286 :
V_2 -> V_38 = V_48 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_44 ) ;
break;
case V_287 :
V_2 -> V_38 = V_40 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_45 ) ;
break;
case V_288 :
V_2 -> V_38 = V_40 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_46 ) ;
break;
case V_289 :
V_2 -> V_38 = V_40 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_47 ) ;
break;
case V_290 :
V_2 -> V_38 = V_40 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_48 ) ;
break;
case V_291 :
V_2 -> V_38 = V_45 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_49 ) ;
break;
case V_292 :
V_2 -> V_38 = V_45 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_50 ) ;
break;
case V_293 :
V_2 -> V_38 = V_44 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_51 ) ;
break;
case V_294 :
V_2 -> V_38 = V_44 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_52 ) ;
break;
case V_295 :
V_2 -> V_38 = V_46 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_53 ) ;
break;
case V_296 :
V_2 -> V_38 = V_46 ;
snprintf ( V_57 -> V_177 . V_275 , 16 , L_54 ) ;
break;
}
if ( F_66 ( V_2 -> V_38 ) ) {
V_2 -> V_193 = F_17 ;
...
#if F_82 ( V_307 )
V_57 -> V_308 . V_309 = F_83 ( 8 , 1024 , V_310 ) ;
V_200 = - V_237 ;
if ( V_57 -> V_308 . V_309 ) {
V_57 -> V_308 . V_311 = 8 * 1024 ;
V_57 -> V_308 . V_312 = 4 ;
V_57 -> V_308 . V_313 = 4 ;
V_57 -> V_308 . V_314 = 32 ;
...
static int F_85 ( struct V_272 * V_273 , const struct V_274 * V_275 )
{
struct V_56 * V_57 ;
struct V_1 * V_2 ;
T_3 V_318 , V_319 ;
...
int V_243 ;
F_40 ( L_55 ) ;
V_57 = F_86 ( sizeof( struct V_1 ) , & V_273 -> V_273 ) ;
if ( ! V_57 )
return - V_237 ;
V_2 = V_57 -> V_2 ;
F_87 ( & V_2 -> V_219 ) ;
...
if ( V_200 )
goto V_321;
if ( ( V_200 = F_89 ( V_273 , L_56 ) ) ) {
F_32 ( V_80 L_57 ) ;
goto V_321;
}
V_200 = - V_237 ;
if ( ( V_200 = F_81 ( V_57 , V_273 , V_275 ) ) )
goto V_322;
V_200 = F_65 ( V_57 ) ;
if ( V_200 )
goto V_323;
...
V_328 . V_141 = V_2 -> V_174 ;
V_328 . V_142 = V_2 -> V_175 ;
V_328 . V_329 = 60 ;
if ( F_96 ( & V_328 , 0 , 0 ) )
F_32 ( V_330 L_58 ) ;
...
V_320 = V_57 -> V_15 . V_30 * ( ( V_57 -> V_15 . V_160 + 7 ) >> 3 ) ;
V_57 -> V_15 . V_143 = V_57 -> V_177 . V_178 / V_320 ;
...
F_39 ( & V_57 -> V_15 , V_57 ) ;
F_52 ( V_57 ) ;
V_318 = 1953125000 / V_57 -> V_15 . V_146 ;
V_318 = V_318 * 512 / ( V_57 -> V_15 . V_141 + V_57 -> V_15 . V_147 +
V_57 -> V_15 . V_148 +
V_57 -> V_15 . V_151 ) ;
V_319 = V_318 / ( V_57 -> V_15 . V_142 + V_57 -> V_15 . V_149 +
V_57 -> V_15 . V_150 + V_57 -> V_15 . V_152 ) ;
F_32 ( V_176 L_59 V_333 L_60
L_61 ,
V_57 -> V_177 . V_178 >> 10 ,
V_57 -> V_15 . V_141 , V_57 -> V_15 . V_142 ,
V_318 / 1000 , V_318 % 1000 , V_319 ) ;
...
static void F_105 ( struct V_272 * V_273 )
{
struct V_56 * V_57 = F_106 ( V_273 ) ;
F_40 ( L_63 ) ;
if ( V_57 ) {
if ( F_107 ( V_57 ) )
F_32 ( V_330 L_64
...
static int F_108 ( struct V_272 * V_273 , T_4 V_334 )
{
struct V_56 * V_57 = F_106 ( V_273 ) ;
struct V_1 * V_2 = V_57 -> V_2 ;
F_40 ( L_66 ) ;
...
V_334 . V_335 = V_337 ;
V_2 -> V_338 = V_334 . V_335 ;
V_273 -> V_273 . V_339 . V_340 = V_334 ;
if ( V_334 . V_335 == V_337 )
return 0 ;
F_109 () ;
F_110 ( V_57 , 1 ) ;
if ( V_57 -> V_302 -> V_341 )
V_57 -> V_302 -> V_341 ( V_57 ) ;
F_56 ( V_215 , V_57 ) ;
F_37 ( V_2 , & V_2 -> V_271 ) ;
F_64 ( V_2 ) ;
F_111 ( V_273 ) ;
F_112 ( V_273 ) ;
F_113 ( V_273 , F_114 ( V_273 , V_334 ) ) ;
F_115 () ;
return 0 ;
}
static int F_116 ( struct V_272 * V_273 )
{
struct V_56 * V_57 = F_106 ( V_273 ) ;
struct V_1 * V_2 = V_57 -> V_2 ;
int V_342 = V_2 -> V_338 ;
...
static int T_6 F_121 ( char * V_346 )
{
#ifndef F_122
char * V_347 ;
if ( ! V_346 || ! * V_346 )
return 0 ;
while ( ( V_347 = F_123 ( & V_346 , L_70 ) ) != NULL ) {
V_331 = V_347 ;
}
#endif
return 0 ;
