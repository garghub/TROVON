...
enum V_37 V_38 )
{
F_21 ( V_19 -> V_3 , V_19 -> V_22 . V_21 . V_27 ) ;
F_21 ( V_19 -> V_3 , V_38 ) ;
switch ( V_38 ) {
case V_39 :
F_22 ( V_19 , V_40 ) ;
F_23 ( V_19 ) ;
F_24 ( & V_19 -> V_22 , & V_19 -> V_22 . V_21 ) ;
break;
case V_41 :
case V_42 :
break;
...
V_45 ) {
V_19 -> V_46 = V_47 ;
V_19 -> V_22 . V_48 = F_28 ( V_8 ) ;
V_19 -> V_22 . V_48 = F_29 ( V_19 -> V_22 . V_48 ) ;
F_22 ( V_19 ,
V_49 ) ;
F_30 ( V_19 ) ;
F_31 ( & V_19 -> V_22 ) ;
...
F_21 ( V_19 -> V_3 , V_19 -> V_22 . V_48 ) ;
F_21 ( V_19 -> V_3 , V_19 -> V_134 ) ;
F_21 ( V_19 -> V_3 , V_19 -> V_61 ) ;
}
static void
...
T_3 V_142 = 0 ;
F_47 ( V_19 -> V_68 , V_19 , V_142 , F_48 ( V_8 ) ,
...
F_21 ( V_19 -> V_3 , V_19 -> V_130 ) ;
F_30 ( V_19 ) ;
V_19 -> V_116 . V_149 ++ ;
F_31 ( & V_19 -> V_22 ) ;
F_49 (qe, qen, &fabric->vport_q) {
...
F_58 ( & V_19 -> V_155 ) ;
F_58 ( & V_19 -> V_156 ) ;
V_19 -> V_68 = F_59 ( V_3 -> V_8 ) ;
F_60 ( ! V_19 -> V_68 ) ;
F_9 ( & V_19 -> V_28 , F_56 , V_19 ) ;
F_10 ( & V_19 -> V_28 ) ;
F_22 ( V_19 , F_20 ) ;
F_61 ( & V_19 -> V_22 , V_19 -> V_3 , V_157 , NULL ) ;
}
void
F_62 ( struct V_2 * V_3 )
{
...
void
F_68 ( struct V_18 * V_19 ,
struct V_144 * V_145 )
{
F_21 ( V_19 -> V_3 , V_19 -> V_158 ) ;
F_69 ( & V_145 -> V_147 , & V_19 -> V_155 ) ;
V_19 -> V_159 ++ ;
F_10 ( & V_19 -> V_28 ) ;
}
void
F_70 ( struct V_18 * V_19 ,
struct V_144 * V_145 )
{
F_71 ( & V_145 -> V_147 ) ;
V_19 -> V_159 -- ;
...
struct V_144 *
F_72 ( struct V_18 * V_19 , T_4 V_27 )
{
struct V_144 * V_145 ;
struct V_146 * V_147 ;
F_73 (qe, &fabric->vport_q) {
V_145 = (struct V_144 * ) V_147 ;
if ( F_74 ( & V_145 -> V_160 ) == V_27 )
return V_145 ;
}
return NULL ;
}
...
void
F_76 ( struct V_18 * V_19 , struct V_164 * V_165 ,
T_5 V_166 )
{
...
if ( ( V_48 == F_77 ( V_172 ) ) &&
( V_169 -> V_173 == V_174 ) &&
( V_171 -> V_175 == F_74 ( & V_19 -> V_22 ) ) ) {
F_38 ( V_19 , V_54 ) ;
return;
}
if ( V_165 -> V_167 == F_29 ( V_172 ) ) {
F_21 ( V_19 -> V_3 , V_48 ) ;
F_78 ( V_19 , V_165 , V_166 ) ;
return;
}
if ( V_19 -> V_22 . V_48 == V_48 ) {
F_21 ( V_19 -> V_3 , V_169 -> V_173 ) ;
if ( V_169 -> V_173 == V_176 ) {
F_21 ( V_19 -> V_3 , V_169 -> V_173 ) ;
return;
}
F_21 ( V_19 -> V_3 , * ( T_3 * ) ( ( T_3 * ) V_165 ) ) ;
F_79 ( & V_19 -> V_22 , V_165 , V_166 ) ;
return;
}
F_73 (qe, &fabric->vport_q) {
V_145 = (struct V_144 * ) V_147 ;
if ( V_145 -> V_160 . V_48 == V_48 ) {
F_79 ( & V_145 -> V_160 , V_165 , V_166 ) ;
return;
}
}
if ( ! F_80 ( V_19 ) )
F_79 ( & V_19 -> V_22 , V_165 , V_166 ) ;
F_21 ( V_19 -> V_3 , V_165 -> type ) ;
}
static void
F_78 ( struct V_18 * V_19 , struct V_164 * V_165 ,
T_5 V_166 )
{
struct V_168 * V_169 = (struct V_168 * ) ( V_165 + 1 ) ;
F_21 ( V_19 -> V_3 , V_169 -> V_173 ) ;
...
F_21 ( V_19 -> V_3 , V_165 -> V_178 ) ;
V_19 -> V_116 . V_179 ++ ;
if ( V_171 -> V_180 . V_181 ) {
F_21 ( V_19 -> V_3 , V_171 -> V_175 ) ;
V_19 -> V_116 . V_182 ++ ;
return;
}
V_19 -> V_58 = F_82 ( V_171 -> V_180 . V_183 ) ;
...
T_5 V_190 ;
struct V_164 V_165 ;
V_189 = F_84 ( V_19 -> V_3 , V_191 ) ;
if ( ! V_189 )
return;
V_190 = F_85 ( & V_165 , F_86 ( V_189 ) ,
F_29 ( V_172 ) ,
V_187 -> V_184 , V_141 -> V_27 ,
V_141 -> V_25 ,
F_48 ( V_8 ) ,
F_87 ( V_8 ) , 0 ) ;
F_88 ( V_189 , NULL , V_19 -> V_158 , V_19 -> V_68 -> V_192 ,
V_191 , V_193 ,
...
if ( ! V_203 )
return;
V_203 -> V_204 . V_200 . V_27 = F_74 ( V_200 ) ;
V_203 -> V_204 . V_200 . V_205 = F_91 ( V_200 ) ;
F_92 ( V_203 , V_5 , ++ V_200 -> V_3 -> V_206 ,
V_207 , V_38 ) ;
}
void
...
void
F_94 ( void * V_5 , void * V_113 )
{
struct V_18 * V_19 = V_113 ;
F_38 ( V_19 , V_93 ) ;
}
T_7 *
F_95 ( struct V_2 * V_3 , T_5 V_158 )
{
F_21 ( V_3 , V_158 ) ;
if ( V_158 == V_157 )
return & V_3 -> V_19 ;
...
void
F_96 ( T_7 * V_211 , T_4 V_212 [] , int * V_213 )
{
struct V_146 * V_147 ;
struct V_144 * V_145 ;
int V_10 = 0 ;
...
return;
V_3 = V_211 -> V_3 ;
F_21 ( V_3 , V_211 -> V_158 ) ;
F_21 ( V_3 , ( V_214 ) * V_213 ) ;
...
static void
F_97 ( void * V_152 , enum V_215 V_38 )
{
...
F_98 ( struct V_2 * V_3 )
{
F_99 ( V_3 -> V_8 , F_97 , V_3 ) ;
}
static void
F_100 ( void * V_152 , struct V_218 * V_219 )
{
struct V_2 * V_3 = (struct V_2 * ) V_152 ;
struct V_164 * V_165 = F_101 ( V_219 ) ;
T_5 V_166 = F_102 ( V_219 ) ;
struct V_220 * V_221 ;
struct V_18 * V_19 ;
if ( V_165 -> V_222 == V_223 &&
V_165 -> V_224 == V_225 ) {
F_103 ( V_3 , V_219 . V_226 ) ;
V_221 = F_101 ( V_219 ) ;
if ( V_3 -> V_87 == V_221 -> V_158 )
V_19 = & V_3 -> V_19 ;
else
V_19 = F_95 ( V_3 , ( T_5 ) V_221 -> V_158 ) ;
if ( ! V_19 ) {
F_60 ( 1 ) ;
F_103 ( V_3 , V_219 . V_227 ) ;
F_104 ( V_219 ) ;
return;
}
V_165 = (struct V_164 * ) ( V_221 + 1 ) ;
V_166 -= sizeof( struct V_220 ) ;
F_21 ( V_3 , V_221 -> V_158 ) ;
} else {
F_103 ( V_3 , V_219 . V_228 ) ;
V_19 = & V_3 -> V_19 ;
}
F_21 ( V_3 , ( ( T_6 * ) V_165 ) [ 0 ] ) ;
F_21 ( V_3 , ( ( T_6 * ) V_165 ) [ 1 ] ) ;
F_21 ( V_3 , ( ( T_6 * ) V_165 ) [ 2 ] ) ;
F_21 ( V_3 , ( ( T_6 * ) V_165 ) [ 3 ] ) ;
F_21 ( V_3 , ( ( T_6 * ) V_165 ) [ 4 ] ) ;
F_21 ( V_3 , ( ( T_6 * ) V_165 ) [ 5 ] ) ;
F_21 ( V_3 , V_166 ) ;
F_76 ( V_19 , V_165 , V_166 ) ;
F_104 ( V_219 ) ;
}
void
F_105 ( struct V_2 * V_3 )
{
F_106 ( V_3 -> V_8 , F_100 , V_3 ) ;
}
