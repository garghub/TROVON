...
static int F_48 ( struct V_28 * V_29 , const struct V_72 * V_73 )
{
struct V_64 * V_19 ;
struct V_13 * V_21 ;
unsigned long V_74 ;
struct V_9 * V_10 ;
const T_4 * V_75 ;
int V_76 , V_31 , V_30 , V_23 ;
F_46 () ;
V_19 = F_49 () ;
V_10 = F_42 ( V_19 , V_29 -> V_77 , V_29 ) ;
if ( F_50 ( V_10 ) ) {
F_28 ( L_6 ) ;
V_30 = F_51 ( V_10 ) ;
goto V_78;
}
V_75 = F_45 ( V_19 , V_29 -> V_77 , V_79 , & V_76 ) ;
V_30 = - V_70 ;
if ( ! V_75 ) {
F_28 ( L_7 , V_79 ) ;
goto V_78;
}
V_21 = F_52 ( sizeof( * V_21 ) , V_80 ) ;
V_30 = - V_33 ;
if ( ! V_21 )
goto V_78;
for ( V_31 = 0 ; V_31 < V_37 ; V_31 ++ )
V_21 -> V_22 [ V_31 ] = ( * V_75 >> ( 5 - V_31 ) * 8 ) & 0xff ;
V_21 -> V_10 = V_10 ;
V_30 = F_53 ( & V_21 -> V_81 , V_29 , V_82 ,
V_83 , F_54 ( V_83 ) ,
& V_84 , V_10 -> V_2 -> V_68 ) ;
if ( V_30 )
goto V_85;
V_30 = F_55 ( & V_21 -> V_81 , & V_86 , V_21 ) ;
if ( V_30 )
goto V_85;
F_56 ( V_21 -> V_10 -> V_2 , & V_21 -> V_87 , V_88 ,
V_89 ) ;
F_57 ( & V_21 -> V_16 ) ;
F_24 ( & V_21 -> V_42 ) ;
V_23 = 0 ;
if ( F_45 ( V_19 , V_29 -> V_77 , L_8 , NULL ) )
V_23 = 1 ;
V_21 -> V_23 = V_23 ;
V_21 -> V_90 = true ;
V_21 -> V_91 = 0 ;
...
F_64 ( & V_29 -> V_2 , V_21 ) ;
F_65 ( L_9 ,
V_10 -> V_2 -> V_68 , V_21 -> V_22 , V_23 ? L_10 : L_11 ) ;
F_66 ( & V_21 -> V_92 , V_93 ,
( unsigned long ) V_21 ) ;
F_67 ( & V_21 -> V_87 ) ;
F_68 ( & V_21 -> V_81 ) ;
