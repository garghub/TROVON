...
static int F_3 ( int V_4 , T_1 V_1 , int * V_5 )
{
int V_6 ;
if ( V_4 ) {
if ( F_2 ( V_1 , V_7 , V_8 ) ) {
...
static int F_4 ( struct V_16 * V_17 , int * V_6 )
{
...
static int F_18 ( struct V_16 * V_17 , int * V_6 )
{
F_19 ( V_17 == NULL ) ;
return F_4 ( V_17 , V_6 ) ;
}
...
int V_38 ;
struct V_55 * V_56 ;
V_56 = F_21 ( & V_52 -> V_45 , sizeof( struct V_55 ) ,
V_49 ) ;
if ( ! V_56 )
return - V_57 ;
V_23 = F_11 ( & V_52 -> V_45 ) ;
