...
return V_6 ;
if ( V_108 -> V_30 & V_122 &&
! F_94 ( & V_119 . V_121 , & V_108 -> V_114 ) )
return - V_123 ;
if ( V_108 -> V_30 & V_124 &&
! F_94 ( & V_108 -> V_114 , & V_119 . V_121 ) )
return - V_123 ;
...
if ( V_108 -> type == V_93 ) {
V_6 = F_98 ( V_94 , V_119 . V_121 . V_83 ,
...
static int F_99 ( void * V_32 , struct V_16 * V_129 ,
struct V_16 * V_130 )
{
struct V_1 * V_2 = V_32 ;
int V_6 ;
...
struct V_1 * V_2 = NULL ;
int V_6 ;
F_30 ( L_11 , F_103 ( V_144 ) , V_5 -> V_13 ) ;
if ( F_104 ( & V_5 -> V_143 ) )
return - V_145 ;
V_2 = F_105 ( sizeof( * V_2 ) , V_146 ) ;
if ( ! V_2 ) {
V_6 = - V_147 ;
goto V_148;
}
F_106 ( & V_2 -> V_58 , V_5 -> V_7 . V_149 ) ;
V_6 = F_107 ( V_2 ) ;
if ( V_6 )
goto V_150;
...
{
struct V_1 * V_2 = F_66 ( V_57 -> V_152 ) ;
struct V_4 * V_5 = V_2 -> V_4 ;
F_30 ( L_14 ,
F_103 ( V_144 ) , V_5 -> V_13 , V_5 -> V_7 . V_157 ) ;
F_117 ( & V_5 -> V_143 ) ;
F_118 ( V_2 -> V_25 ) ;
F_112 ( V_2 ) ;
F_113 ( & V_2 -> V_58 ) ;
...
if ( F_104 ( & V_5 -> V_143 ) )
return - V_145 ;
V_6 = F_121 ( V_57 , V_2 -> V_25 , V_160 ) ;
F_111 ( & V_5 -> V_143 ) ;
return V_6 ;
}
static int F_122 ( struct V_57 * V_57 , struct V_161 * V_162 )
{
struct V_1 * V_2 = F_66 ( V_57 -> V_152 ) ;
struct V_4 * V_5 = V_2 -> V_4 ;
int V_6 ;
...
V_5 -> V_7 . V_8 = F_126 ( & V_177 ) ;
if ( F_57 ( V_5 -> V_7 . V_8 ) ) {
F_127 ( & V_20 -> V_21 , L_16 ) ;
return F_58 ( V_5 -> V_7 . V_8 ) ;
}
V_6 = F_128 ( & V_5 -> V_165 , V_178 , - 1 ) ;
if ( V_6 ) {
F_127 ( & V_20 -> V_21 ,
L_17 , V_179 ) ;
goto V_180;
}
F_30 ( L_18 , V_5 -> V_165 . V_181 ) ;
return 0 ;
V_180:
F_129 ( V_5 -> V_7 . V_8 ) ;
return V_6 ;
