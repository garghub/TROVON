...
F_121 ( V_79 , V_209 ) ;
V_211 . V_214 = F_122 ( ( void * ) V_198 -> V_215 ) ;
V_211 . V_216 = 0 ;
V_211 . V_203 = V_212 ;
F_123 ( V_79 , & V_211 ) ;
return 0 ;
...
{
struct V_1 * V_198 = F_1 ( V_3 ) ;
struct V_217 * V_218 = F_125 ( V_79 ) ;
T_8 V_212 = F_126 ( V_218 ) ;
F_127 ( V_79 ) ;
F_111 ( V_198 , V_212 ) ;
}
static int F_128 ( struct V_219 * V_207 , unsigned int V_79 ,
T_8 V_212 )
{
F_129 ( V_79 , & V_220 , V_221 ) ;
F_130 ( V_79 , V_207 -> V_222 ) ;
F_53 () ;
return 0 ;
}
...
F_132 ( & V_198 -> V_199 ) ;
V_198 -> V_3 . V_15 = V_15 ;
V_198 -> V_3 . V_223 = F_119 ;
V_198 -> V_3 . V_224 = F_124 ;
V_198 -> V_207 = F_133 ( V_15 -> V_190 , V_201 ,
& V_225 , & V_198 -> V_3 ) ;
if ( ! V_198 -> V_207 ) {
F_19 ( V_15 , L_61 ) ;
return - V_24 ;
...
V_198 -> V_79 = V_22 ;
V_22 = F_102 ( V_198 -> V_79 , F_114 , V_226 ,
V_220 . V_188 , V_5 ) ;
if ( V_22 < 0 ) {
F_19 ( V_15 , L_63 , V_22 ) ;
goto V_22;
}
V_198 -> V_215 = F_134 ( V_23 , 0 ) ;
V_48 = F_122 ( ( void * ) V_198 -> V_215 ) ;
F_3 ( V_5 , V_48 >> V_56 -> V_227 , V_121 ) ;
F_3 ( V_5 , V_48 , V_123 ) ;
F_3 ( V_5 , 1 , V_122 ) ;
...
static int F_138 ( struct V_4 * V_5 , T_1 V_139 ,
T_1 * V_237 )
{
struct V_14 * V_15 = V_5 -> V_15 ;
...
static bool F_140 ( struct V_185 * V_186 ,
struct V_245 * V_179 ,
unsigned int V_178 )
{
char V_246 [ 32 ] ;
...
return F_142 ( V_15 , V_5 -> V_178 , V_5 -> V_179 ) ;
}
static int F_143 ( struct V_4 * V_5 , T_1 V_249 )
{
struct V_14 * V_15 = V_5 -> V_15 ;
struct V_185 * V_186 = V_15 -> V_190 ;
unsigned int V_21 = 0 ;
...
if ( F_140 ( V_15 -> V_190 , V_5 -> V_179 ,
V_5 -> V_178 ) )
return F_142 ( V_15 , V_5 -> V_178 ,
V_5 -> V_179 ) ;
F_118 ( V_15 , L_98 ) ;
F_42 ( V_15 , V_5 -> V_179 ) ;
V_5 -> V_178 = 0 ;
...
struct V_192 V_193 ;
int V_22 ;
if ( F_145 ( & V_253 , V_186 ) ) {
F_19 ( V_15 , L_99 ) ;
return - V_213 ;
}
F_146 (&parser, &range) {
V_22 = F_147 ( & V_255 , V_186 , & V_193 ) ;
if ( V_22 < 0 )
return V_22 ;
switch ( V_193 . V_258 & V_259 ) {
case V_260 :
V_5 -> V_7 . V_73 = V_193 . V_19 - V_255 . V_261 ;
memcpy ( & V_5 -> V_72 , & V_193 , sizeof( V_193 ) ) ;
V_5 -> V_72 . V_188 = V_186 -> V_248 ;
V_5 -> V_73 . V_19 = V_255 . V_262 ;
V_5 -> V_73 . V_263 = V_255 . V_262 + V_255 . V_97 - 1 ;
V_5 -> V_73 . V_258 = V_194 ;
V_5 -> V_73 . V_188 = L_100 ;
memcpy ( & V_193 , & V_5 -> V_73 , sizeof( V_193 ) ) ;
break;
case V_194 :
V_5 -> V_7 . V_74 = V_193 . V_19 - V_255 . V_261 ;
if ( V_193 . V_258 & V_264 ) {
...
V_256 |= ( ( 1 << V_6 ) - 1 ) << V_257 ;
V_257 += V_6 ;
V_266 = F_153 ( V_15 , sizeof( * V_266 ) , V_23 ) ;
if ( ! V_266 )
return - V_24 ;
V_22 = F_154 ( V_46 , 0 , & V_266 -> V_64 ) ;
if ( V_22 < 0 ) {
F_19 ( V_15 , L_104 , V_22 ) ;
return V_22 ;
}
...
V_266 -> V_5 = V_5 ;
V_266 -> V_186 = V_46 ;
V_266 -> V_48 = F_99 ( V_15 , & V_266 -> V_64 ) ;
if ( F_25 ( V_266 -> V_48 ) )
return F_26 ( V_266 -> V_48 ) ;
F_27 ( & V_266 -> V_25 , & V_5 -> V_267 ) ;
}
V_22 = F_138 ( V_5 , V_139 , & V_5 -> V_155 ) ;
if ( V_22 < 0 ) {
F_19 ( V_15 , L_109 ) ;
return V_22 ;
}
V_22 = F_143 ( V_5 , V_256 ) ;
if ( V_22 < 0 )
return V_22 ;
return 0 ;
}
...
static void * F_157 ( struct V_278 * V_279 , T_9 * V_280 )
{
struct V_4 * V_5 = V_279 -> V_281 ;
if ( F_158 ( & V_5 -> V_267 ) )
return NULL ;
F_159 ( V_279 , L_113 ) ;
return F_160 ( & V_5 -> V_267 , * V_280 ) ;
}
static void * F_161 ( struct V_278 * V_279 , void * V_282 , T_9 * V_280 )
{
struct V_4 * V_5 = V_279 -> V_281 ;
return F_162 ( V_282 , & V_5 -> V_267 , V_280 ) ;
}
static void F_163 ( struct V_278 * V_279 , void * V_282 )
{
}
static int F_164 ( struct V_278 * V_279 , void * V_282 )
{
bool V_283 = false , V_284 = false ;
struct V_45 * V_46 ;
unsigned int V_6 ;
V_46 = F_165 ( V_282 , struct V_45 , V_25 ) ;
V_6 = F_6 ( V_46 -> V_48 + V_273 ) ;
if ( V_6 & V_274 )
V_283 = true ;
V_6 = F_6 ( V_46 -> V_48 + V_276 ) ;
...
static int F_166 ( struct V_285 * V_285 , struct V_286 * V_286 )
{
struct V_4 * V_5 = V_285 -> V_287 ;
struct V_278 * V_279 ;
int V_22 ;
V_22 = F_167 ( V_286 , & V_288 ) ;
if ( V_22 )
return V_22 ;
V_279 = V_286 -> V_289 ;
V_279 -> V_281 = V_5 ;
...
{
struct V_290 * V_286 ;
V_5 -> V_291 = F_169 ( L_40 , NULL ) ;
if ( ! V_5 -> V_291 )
return - V_24 ;
V_286 = F_170 ( L_119 , V_292 | V_293 , V_5 -> V_291 ,
V_5 , & V_294 ) ;
if ( ! V_286 )
goto remove;
return 0 ;
