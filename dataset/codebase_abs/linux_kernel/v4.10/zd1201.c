...
static int F_65 ( struct V_145 * V_2 , void * V_157 )
{
...
static struct V_159 * F_66 ( struct V_145 * V_2 )
{
struct V_21 * V_22 = F_53 ( V_2 ) ;
return & V_22 -> V_160 ;
}
static void F_67 ( struct V_145 * V_2 )
{
struct V_21 * V_22 = F_53 ( V_2 ) ;
struct V_161 * V_162 ;
...
V_222 = F_82 ( V_167 , V_222 , V_223 , & V_221 , NULL ) ;
V_221 . V_35 = V_245 ;
...
static int F_85 ( struct V_145 * V_2 , struct V_166 * V_167 ,
...
static int F_88 ( struct V_145 * V_2 , struct V_166 * V_167 ,
...
return - V_107 ;
V_98 = V_267 + V_55 ;
V_8 = F_40 ( V_22 , V_98 , V_263 , V_262 -> V_103 , 1 ) ;
if ( V_8 )
return V_8 ;
...
int V_8 ;
V_8 = F_41 ( V_22 , V_284 , & V_277 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_41 ( V_22 , V_283 , & V_199 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_41 ( V_22 , V_280 , & V_278 ) ;
if ( V_8 )
return V_8 ;
...
if ( ! V_22 -> V_139 )
return - V_225 ;
return F_42 ( V_22 , V_289 , V_249 -> V_240 ) ;
}
...
* ( short * ) ( V_120 + 6 ) = 0 ;
* ( short * ) ( V_120 + 8 ) = 0 ;
return F_40 ( V_22 , V_292 , V_120 , 10 , 1 ) ;
}
...
if ( ! V_22 -> V_139 )
return - V_225 ;
V_8 = F_42 ( V_22 , V_293 , V_249 -> V_240 ) ;
if ( V_8 )
return V_8 ;
return 0 ;
}
...
static int F_103 ( struct V_295 * V_296 ,
...
static void F_114 ( struct V_295 * V_296 )
{
struct V_21 * V_22 = F_115 ( V_296 ) ;
struct V_309 * V_310 ;
struct V_90 * V_91 ;
if ( ! V_22 )
return;
F_112 ( V_296 , NULL ) ;
F_116 (frag, node2, &zd->fraglist, fnode) {
F_36 ( & V_91 -> V_95 ) ;
F_58 ( V_91 -> V_45 ) ;
F_8 ( V_91 ) ;
}
...
static int F_118 ( struct V_295 * V_296 ,
T_4 V_311 )
{
struct V_21 * V_22 = F_115 ( V_296 ) ;
F_119 ( V_22 -> V_2 ) ;
...
static int F_120 ( struct V_295 * V_296 )
{
struct V_21 * V_22 = F_115 ( V_296 ) ;
if ( ! V_22 || ! V_22 -> V_2 )
return - V_26 ;
