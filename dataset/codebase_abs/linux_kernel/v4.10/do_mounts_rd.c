...
int T_1 F_25 ( int V_19 )
{
if ( V_2 )
F_21 ( L_24 ) ;
F_26 ( L_25 , V_58 ) ;
F_26 ( L_9 , F_27 ( V_59 , V_19 ) ) ;
return F_15 ( L_25 ) ;
}
static long T_1 F_28 ( void * V_17 , unsigned long V_60 )
{
long V_61 = F_7 ( V_62 , V_17 , V_60 ) ;
if ( V_61 < 0 )
F_9 ( V_57 L_26 ) ;
else if ( V_61 == 0 )
F_9 ( V_57 L_27 ) ;
...
static long T_1 F_29 ( void * V_63 , unsigned long V_64 )
{
long V_65 = F_22 ( V_66 , V_63 , V_64 ) ;
if ( V_65 != V_64 ) {
if ( V_67 == 0 )
F_9 ( V_57
L_28 ,
...
V_71 = V_70 ( NULL , 0 , F_28 , F_29 , NULL , NULL , error ) ;
if ( V_67 )
V_71 = 1 ;
return V_71 ;
}
