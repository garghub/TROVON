...
if ( V_27 )
return V_27 ;
V_50 = F_15 ( V_20 -> V_52 , V_48 , V_46 ) ;
if ( ! V_50 )
return - V_53 ;
if ( V_50 -> V_54 - V_50 -> V_55 != 0xfff )
return - V_38 ;
switch ( V_50 -> V_56 ) {
case V_57 :
V_17 -> V_46 = 0x00000001 | V_50 -> V_55 >> 8 ;
break;
case V_58 :
V_17 -> V_46 = 0x00000003 | V_50 -> V_55 >> 8 ;
break;
default:
return - V_38 ;
}
...
{
return F_17 ( V_17 -> V_2 . V_6 -> V_7 , V_4 ,
V_17 -> V_2 . V_44 . V_59 , - 10 , V_34 ,
V_17 -> V_2 . V_44 . V_59 << 28 |
V_17 -> V_2 . V_44 . V_59 ) ;
}
static void
...
{
struct V_36 * V_21 = V_17 -> V_2 . V_6 -> V_21 ;
struct V_60 * V_23 = & V_21 -> V_2 . V_22 . V_23 ;
struct V_19 * V_20 = V_23 -> V_20 ;
int V_61 = V_17 -> V_2 . V_44 . V_61 ;
int V_59 = V_17 -> V_2 . V_44 . V_59 ;
F_19 ( V_20 , 0x610200 + ( V_61 * 0x0010 ) , 0x00001010 , 0x00001000 ) ;
F_19 ( V_20 , 0x610200 + ( V_61 * 0x0010 ) , 0x00000003 , 0x00000000 ) ;
if ( F_20 (device, 2000 ,
if (!(nvkm_rd32(device, 0x610200 + (ctrl * 0x10)) & 0x001e0000))
break;
) < 0 ) {
F_21 ( V_23 , L_1 , V_59 ,
F_22 ( V_20 , 0x610200 + ( V_61 * 0x10 ) ) ) ;
}
F_19 ( V_20 , 0x610028 , 0x00010001 << V_59 , 0x00000000 << V_59 ) ;
}
static int
...
int V_61 = V_17 -> V_2 . V_44 . V_61 ;
int V_59 = V_17 -> V_2 . V_44 . V_59 ;
F_19 ( V_20 , 0x610028 , 0x00010000 << V_59 , 0x00010000 << V_59 ) ;
F_24 ( V_20 , 0x610204 + ( V_61 * 0x0010 ) , V_17 -> V_46 ) ;
F_24 ( V_20 , 0x610208 + ( V_61 * 0x0010 ) , 0x00010000 ) ;
F_24 ( V_20 , 0x61020c + ( V_61 * 0x0010 ) , V_61 ) ;
F_19 ( V_20 , 0x610200 + ( V_61 * 0x0010 ) , 0x00000010 , 0x00000010 ) ;
F_24 ( V_20 , 0x640000 + ( V_61 * 0x1000 ) , 0x00000000 ) ;
F_24 ( V_20 , 0x610200 + ( V_61 * 0x0010 ) , 0x00000013 ) ;
if ( F_20 (device, 2000 ,
