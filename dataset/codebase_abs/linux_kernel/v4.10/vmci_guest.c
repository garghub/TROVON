...
V_50 -> V_69 [ V_67 ] . V_70 = V_67 ;
V_50 -> V_69 [ V_67 ] . V_71 = V_67 ;
}
V_14 = F_30 ( V_32 ,
V_50 -> V_69 , V_68 ) ;
if ( V_14 == 0 )
...
V_14 = F_30 ( V_32 , V_50 -> V_69 , 1 ) ;
return V_14 ;
}
static T_4 F_31 ( int V_74 , void * V_75 )
{
struct V_49 * V_40 = V_75 ;
if ( V_40 -> V_76 == V_77 && V_40 -> V_72 ) {
F_32 ( & V_40 -> V_78 ) ;
} else {
unsigned int V_79 ;
V_79 = F_9 ( V_40 -> V_18 + V_80 ) ;
if ( V_79 == 0 || V_79 == ~ 0 )
return V_81 ;
if ( V_79 & V_82 ) {
F_32 ( & V_40 -> V_78 ) ;
...
static T_4 F_34 ( int V_74 , void * V_75 )
{
struct V_49 * V_40 = V_75 ;
F_32 ( & V_40 -> V_84 ) ;
return V_85 ;
...
V_18 = F_38 ( V_32 ) [ 0 ] ;
F_39 ( & V_32 -> V_40 , L_15 ,
( unsigned long ) V_18 , V_32 -> V_74 ) ;
V_50 = F_40 ( & V_32 -> V_40 , sizeof( * V_50 ) , V_39 ) ;
if ( ! V_50 ) {
F_16 ( & V_32 -> V_40 ,
L_16 ) ;
return - V_42 ;
...
F_39 ( & V_32 -> V_40 , L_20 , V_88 ) ;
F_45 ( V_88 , V_50 -> V_18 + V_93 ) ;
F_46 ( & V_16 ) ;
V_17 = V_50 ;
V_98 = V_32 ;
F_47 ( & V_16 ) ;
...
L_22 ,
V_103 , V_90 ) ;
if ( ! V_104 && ! F_29 ( V_32 , V_50 ) ) {
V_50 -> V_76 = V_77 ;
V_50 -> V_74 = V_50 -> V_69 [ 0 ] . V_71 ;
} else if ( ! V_105 && ! F_50 ( V_32 ) ) {
V_50 -> V_76 = V_106 ;
V_50 -> V_74 = V_32 -> V_74 ;
} else {
V_50 -> V_76 = V_92 ;
...
error = F_51 ( V_50 -> V_74 , F_31 , V_107 ,
V_91 , V_50 ) ;
if ( error ) {
F_16 ( & V_32 -> V_40 , L_23 ,
V_50 -> V_74 , error ) ;
...
if ( V_50 -> V_72 ) {
error = F_51 ( V_50 -> V_69 [ 1 ] . V_71 ,
F_34 , 0 , V_91 ,
V_50 ) ;
if ( error ) {
F_16 ( & V_32 -> V_40 ,
L_24 ,
V_50 -> V_69 [ 1 ] . V_71 , error ) ;
goto V_109;
}
}
F_19 ( & V_32 -> V_40 , L_25 ) ;
...
F_47 ( & V_16 ) ;
F_19 ( & V_32 -> V_40 , L_28 ) ;
F_45 ( V_115 , V_50 -> V_18 + V_114 ) ;
F_54 ( V_50 -> V_74 , V_50 ) ;
if ( V_50 -> V_76 == V_77 ) {
if ( V_50 -> V_72 )
F_54 ( V_50 -> V_69 [ 1 ] . V_71 , V_50 ) ;
F_56 ( V_32 ) ;
} else if ( V_50 -> V_76 == V_106 ) {
F_57 ( V_32 ) ;
}
