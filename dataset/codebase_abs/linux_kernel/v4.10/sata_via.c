...
static int F_59 ( struct V_12 * V_13 , const struct V_117 * V_118 )
{
unsigned int V_47 ;
int V_85 ;
struct V_81 * V_14 = NULL ;
int V_107 = ( int ) V_118 -> V_119 ;
const unsigned * V_120 ;
struct V_102 * V_103 ;
F_60 ( & V_13 -> V_15 , V_121 ) ;
V_85 = F_61 ( V_13 ) ;
if ( V_85 )
return V_85 ;
if ( V_107 == V_122 )
