...
{
F_52 () ;
F_53 ( V_146 -> V_147 , 1 , V_148 | V_149 ) ;
F_54 () ;
}
static int F_55 ( struct V_122 * V_65 , unsigned V_150 , unsigned long V_151 )
{
int V_120 ;
if ( V_4 -> V_5 -> V_7 <= 0 )
return - V_152 ;
...
static void F_56 ( struct V_14 * V_146 )
{
F_52 () ;
F_53 ( V_146 -> V_147 , 1 , V_148 | V_159 ) ;
F_54 () ;
V_4 -> V_111 &= ~ V_142 ;
F_1 ( V_145 , V_4 -> V_111 ) ;
}
static inline void F_57 ( struct V_14 * V_146 )
{
...
V_146 -> V_147 = F_60 ( V_6 ,
& V_146 -> V_5 -> V_65 ,
& V_165 , V_166 ) ;
if ( F_61 ( V_146 -> V_147 ) ) {
if ( V_160 ) {
F_13 ( V_162 ) ;
F_58 ( & V_146 -> V_5 -> V_65 , 0 ) ;
}
F_45 ( & V_146 -> V_5 -> V_65 , L_17 ,
( int ) F_62 ( V_146 -> V_147 ) ) ;
V_4 -> V_147 = NULL ;
}
}
static inline void F_57 ( struct V_14 * V_146 )
...
static int F_63 ( struct V_60 * V_5 ,
...
V_101 = F_65 ( & V_5 -> V_65 , sizeof( * V_101 ) , V_173 ) ;
if ( ! V_101 )
return - V_174 ;
F_66 ( V_5 , V_101 ) ;
V_4 = V_101 ;
...
F_68 ( & V_101 -> V_16 ) ;
F_69 ( & V_101 -> V_102 , F_34 ) ;
F_70 ( L_21 , V_169 >> 4 , V_169 & 0x0f ) ;
V_170 = F_4 ( V_80 ) ;
if ( V_170 < 0 )
goto V_121;
if ( V_170 & V_81 )
...
static int F_73 ( struct V_60 * V_5 )
{
struct V_14 * V_101 = F_74 ( V_5 ) ;
F_71 ( V_5 -> V_7 , V_101 ) ;
F_72 ( & V_101 -> V_102 ) ;
V_4 = NULL ;
return 0 ;
