...
if ( ! F_18 ( V_4 ) )
return - V_19 ;
V_4 -> V_6 = F_34 ( V_36 , sizeof( struct V_21 ) , V_22 ) ;
if ( ! V_4 -> V_6 )
return - V_23 ;
V_15 = F_35 ( V_9 , 1 , V_36 , V_38 ) ;
if ( V_15 < V_36 ) {
if ( V_15 > 0 )
F_36 ( V_9 ) ;
F_22 ( V_4 -> V_6 ) ;
...
{
int V_53 , V_54 , V_15 = 0 ;
if ( V_50 >= V_4 -> V_24 || V_50 + V_51 > V_4 -> V_24 )
return - V_19 ;
for ( V_53 = 0 , V_54 = V_50 ; V_53 < V_51 && ! V_15 ; V_53 ++ , V_54 ++ ) {
int V_27 = V_52 ? V_52 [ V_53 ] : - 1 ;
V_15 = F_38 ( V_4 , V_54 , V_27 , V_37 ) ;
}
if ( V_15 ) {
for ( -- V_54 ; V_54 >= ( int ) V_50 ; V_54 -- )
F_38 ( V_4 , V_54 , - 1 , V_37 ) ;
}
return V_15 ;
}
...
struct V_8 * V_9 = V_4 -> V_9 ;
int V_53 ;
for ( V_53 = 0 ; V_53 < V_4 -> V_24 ; V_53 ++ ) {
F_31 ( & V_4 -> V_6 [ V_53 ] . V_32 ) ;
F_31 ( & V_4 -> V_6 [ V_53 ] . V_33 ) ;
}
...
unsigned V_56 , unsigned V_50 ,
unsigned V_51 , T_3 V_10 , void * V_57 )
{
...
{
int V_53 ;
bool V_37 = ( V_56 == V_41 ) ? true : false ;
if ( F_52 ( V_4 , V_56 ) && ! V_51 && ( V_10 & V_58 ) ) {
F_46 ( V_4 , V_37 ) ;
return 0 ;
}
if ( ! ( F_52 ( V_4 , V_56 ) || F_18 ( V_4 ) ) )
return - V_19 ;
if ( V_10 & V_60 ) {
T_2 * V_52 = V_57 ;
int V_15 ;
...
if ( ! F_52 ( V_4 , V_56 ) || V_50 + V_51 > V_4 -> V_24 )
return - V_19 ;
for ( V_53 = V_50 ; V_53 < V_50 + V_51 ; V_53 ++ ) {
if ( ! V_4 -> V_6 [ V_53 ] . V_7 )
continue;
if ( V_10 & V_58 ) {
F_4 ( V_4 -> V_6 [ V_53 ] . V_7 , 1 ) ;
} else if ( V_10 & V_59 ) {
T_4 * V_62 = V_57 ;
if ( V_62 [ V_53 - V_50 ] )
F_4 ( V_4 -> V_6 [ V_53 ] . V_7 , 1 ) ;
...
unsigned V_51 , T_3 V_10 , void * V_57 )
{
if ( V_56 != V_66 || V_50 != 0 || V_51 > 1 )
return - V_19 ;
return F_53 ( & V_4 -> V_67 ,
V_51 , V_10 , V_57 ) ;
}
int F_56 ( struct V_3 * V_4 , T_3 V_10 ,
unsigned V_56 , unsigned V_50 , unsigned V_51 ,
void * V_57 )
{
int (* F_57)( struct V_3 * V_4 , unsigned V_56 ,
...
if ( ! F_57 )
return - V_61 ;
return F_57 ( V_4 , V_56 , V_50 , V_51 , V_10 , V_57 ) ;
}
