...
V_189 = V_98 -> V_191 ;
if ( V_188 && V_189 ) {
V_14 = F_119 ( V_50 , V_71 -> V_192 ,
V_71 -> V_193 ,
V_189 , V_188 ) ;
if ( V_14 != 0 ) {
F_78 ( V_50 -> V_23 , L_55 ,
V_188 -> V_53 , V_189 -> V_53 , V_14 ) ;
return V_14 ;
}
}
V_188 = V_98 -> V_190 ;
...
#endif
if ( V_98 -> V_10 -> V_196 ) {
V_14 = V_98 -> V_10 -> V_196 ( V_27 , V_27 -> V_82 ) ;
if ( V_14 < 0 ) {
F_78 ( V_50 -> V_23 , L_58 ,
V_71 -> V_130 ) ;
return V_14 ;
...
{
struct V_197 * V_198 = & V_50 -> V_198 [ V_82 ] ;
struct V_48 * V_49 ;
const char * V_53 ;
struct V_122 * V_155 ;
if ( V_198 -> V_155 || V_198 -> V_154 ) {
V_53 = V_198 -> V_154 ;
V_155 = V_198 -> V_155 ;
...
V_49 -> V_172 = V_198 -> V_172 ;
V_49 -> V_200 = 1 ;
F_106 ( & V_49 -> V_201 , & V_50 -> V_202 ) ;
return 0 ;
V_199:
F_78 ( V_50 -> V_23 , L_61 , V_53 ) ;
return - V_141 ;
}
static int F_128 ( struct V_63 * V_50 )
{
struct V_48 * V_203 , * V_204 ;
int V_144 ;
int V_14 ;
for ( V_144 = V_149 ; V_144 <= V_150 ;
V_144 ++ ) {
F_56 (comp, tmp, &card->aux_comp_list,
card_aux_list) {
if ( V_203 -> V_10 -> V_186 == V_144 ) {
V_14 = F_99 ( V_50 , V_203 ) ;
if ( V_14 < 0 ) {
F_78 ( V_50 -> V_23 ,
L_62 ,
V_203 -> V_53 , V_14 ) ;
...
V_14 = F_132 ( V_121 , V_194 ) ;
if ( V_14 != 0 && V_14 != - V_207 ) {
F_26 ( V_121 -> V_23 ,
L_64 , V_14 ) ;
return V_14 ;
}
...
int V_14 , V_3 , V_144 ;
F_35 ( & V_58 ) ;
F_134 ( & V_50 -> V_214 , V_215 ) ;
for ( V_3 = 0 ; V_3 < V_50 -> V_216 ; V_3 ++ ) {
V_14 = F_84 ( V_50 , & V_50 -> V_71 [ V_3 ] ) ;
if ( V_14 != 0 )
goto V_217;
}
for ( V_3 = 0 ; V_3 < V_50 -> V_218 ; V_3 ++ ) {
V_14 = F_126 ( V_50 , V_3 ) ;
if ( V_14 != 0 )
goto V_217;
}
...
V_14 = F_135 ( V_50 -> V_23 , V_219 , V_220 ,
...
#endif
#ifdef F_136
F_137 ( & V_50 -> V_113 , F_73 ) ;
#endif
if ( V_50 -> V_167 )
F_101 ( & V_50 -> V_105 , V_50 -> V_167 ,
V_50 -> V_168 ) ;
if ( V_50 -> V_221 )
F_101 ( & V_50 -> V_105 , V_50 -> V_221 ,
V_50 -> V_222 ) ;
if ( V_50 -> V_170 ) {
...
F_139 ( V_50 ) ;
if ( V_50 -> V_173 )
F_140 ( V_50 , V_50 -> V_173 , V_50 -> V_174 ) ;
if ( V_50 -> V_175 )
F_105 ( & V_50 -> V_105 , V_50 -> V_175 ,
V_50 -> V_176 ) ;
if ( V_50 -> V_225 )
F_105 ( & V_50 -> V_105 , V_50 -> V_225 ,
V_50 -> V_226 ) ;
snprintf ( V_50 -> V_88 -> V_227 , sizeof( V_50 -> V_88 -> V_227 ) ,
L_51 , V_50 -> V_53 ) ;
snprintf ( V_50 -> V_88 -> V_228 , sizeof( V_50 -> V_88 -> V_228 ) ,
L_51 , V_50 -> V_229 ? V_50 -> V_229 : V_50 -> V_53 ) ;
snprintf ( V_50 -> V_88 -> V_10 , sizeof( V_50 -> V_88 -> V_10 ) ,
L_51 , V_50 -> V_230 ? V_50 -> V_230 : V_50 -> V_53 ) ;
...
{
struct V_63 * V_50 = F_146 ( V_234 ) ;
if ( ! V_50 )
return - V_15 ;
F_26 ( & V_234 -> V_23 ,
L_69 ,
V_50 -> V_53 ) ;
V_50 -> V_23 = & V_234 -> V_23 ;
return F_147 ( V_50 ) ;
}
...
struct V_235 * F_153 ( const struct V_236 * V_237 ,
void * V_238 , const char * V_229 ,
const char * V_239 )
{
struct V_236 V_240 ;
struct V_235 * V_241 ;
char * V_53 = NULL ;
memcpy ( & V_240 , V_237 , sizeof( V_240 ) ) ;
V_240 . V_242 = 0 ;
if ( ! V_229 )
V_229 = V_240 . V_53 ;
if ( V_239 ) {
V_53 = F_24 ( V_40 , L_70 , V_239 , V_229 ) ;
if ( ! V_53 )
return NULL ;
V_240 . V_53 = V_53 ;
} else {
...
V_241 = F_154 ( & V_240 , V_238 ) ;
F_16 ( V_53 ) ;
return V_241 ;
}
static int F_155 ( struct V_88 * V_50 , struct V_22 * V_23 ,
const struct V_236 * V_173 , int V_174 ,
const char * V_239 , void * V_238 )
{
int V_145 , V_3 ;
for ( V_3 = 0 ; V_3 < V_174 ; V_3 ++ ) {
const struct V_236 * V_243 = & V_173 [ V_3 ] ;
V_145 = F_156 ( V_50 , F_153 ( V_243 , V_238 ,
V_243 -> V_53 , V_239 ) ) ;
if ( V_145 < 0 ) {
F_78 ( V_23 , L_71 ,
V_243 -> V_53 , V_145 ) ;
...
struct V_235 * F_157 ( struct V_63 * V_244 ,
const char * V_53 )
{
struct V_88 * V_50 = V_244 -> V_88 ;
struct V_235 * V_245 ;
if ( F_158 ( ! V_53 ) )
return NULL ;
F_36 (kctl, &card->controls, list)
if ( ! strncmp ( V_245 -> V_129 . V_53 , V_53 , sizeof( V_245 -> V_129 . V_53 ) ) )
return V_245 ;
return NULL ;
}
int F_104 ( struct V_48 * V_49 ,
const struct V_236 * V_173 , unsigned int V_174 )
{
struct V_88 * V_50 = V_49 -> V_50 -> V_88 ;
return F_155 ( V_50 , V_49 -> V_23 , V_173 ,
...
int F_140 ( struct V_63 * V_244 ,
const struct V_236 * V_173 , int V_174 )
{
struct V_88 * V_50 = V_244 -> V_88 ;
return F_155 ( V_50 , V_244 -> V_23 , V_173 , V_174 ,
NULL , V_244 ) ;
}
...
return F_155 ( V_50 , V_60 -> V_23 , V_173 , V_174 ,
NULL , V_60 ) ;
}
int F_162 ( struct V_59 * V_60 , int V_246 ,
unsigned int V_247 , int V_248 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_249 )
return V_60 -> V_10 -> V_94 -> V_249 ( V_60 , V_246 , V_247 , V_248 ) ;
else if ( V_60 -> V_5 && V_60 -> V_5 -> V_10 -> V_249 )
return V_60 -> V_5 -> V_10 -> V_249 ( V_60 -> V_5 , V_246 , 0 ,
V_247 , V_248 ) ;
else
return - V_207 ;
}
int F_163 ( struct V_4 * V_5 , int V_246 ,
int V_189 , unsigned int V_247 , int V_248 )
{
if ( V_5 -> V_10 -> V_249 )
return V_5 -> V_10 -> V_249 ( V_5 , V_246 , V_189 ,
V_247 , V_248 ) ;
else
return - V_207 ;
}
...
int V_250 , int div )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_251 )
return V_60 -> V_10 -> V_94 -> V_251 ( V_60 , V_250 , div ) ;
else
return - V_15 ;
}
int F_165 ( struct V_59 * V_60 , int V_252 , int V_189 ,
unsigned int V_253 , unsigned int V_254 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_255 )
return V_60 -> V_10 -> V_94 -> V_255 ( V_60 , V_252 , V_189 ,
V_253 , V_254 ) ;
else if ( V_60 -> V_5 && V_60 -> V_5 -> V_10 -> V_255 )
return V_60 -> V_5 -> V_10 -> V_255 ( V_60 -> V_5 , V_252 , V_189 ,
V_253 , V_254 ) ;
else
return - V_15 ;
}
int F_166 ( struct V_4 * V_5 , int V_252 , int V_189 ,
unsigned int V_253 , unsigned int V_254 )
{
if ( V_5 -> V_10 -> V_255 )
return V_5 -> V_10 -> V_255 ( V_5 , V_252 , V_189 ,
V_253 , V_254 ) ;
else
return - V_15 ;
}
int F_167 ( struct V_59 * V_60 , unsigned int V_256 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_257 )
return V_60 -> V_10 -> V_94 -> V_257 ( V_60 , V_256 ) ;
else
return - V_15 ;
}
int F_132 ( struct V_59 * V_60 , unsigned int V_258 )
{
if ( V_60 -> V_10 == NULL )
return - V_15 ;
if ( V_60 -> V_10 -> V_94 -> V_259 == NULL )
return - V_207 ;
return V_60 -> V_10 -> V_94 -> V_259 ( V_60 , V_258 ) ;
}
static int F_168 ( unsigned int V_260 ,
unsigned int * V_261 ,
unsigned int * V_262 )
{
if ( * V_261 || * V_262 )
...
unsigned int V_261 , unsigned int V_262 , int V_260 , int V_263 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_264 )
V_60 -> V_10 -> V_94 -> V_264 ( V_260 ,
& V_261 , & V_262 ) ;
else
F_168 ( V_260 , & V_261 , & V_262 ) ;
V_60 -> V_261 = V_261 ;
V_60 -> V_262 = V_262 ;
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_265 )
return V_60 -> V_10 -> V_94 -> V_265 ( V_60 , V_261 , V_262 ,
V_260 , V_263 ) ;
else
return - V_207 ;
}
...
return V_60 -> V_10 -> V_94 -> V_270 ( V_60 , V_266 , V_267 ,
V_268 , V_269 ) ;
else
return - V_15 ;
}
int F_171 ( struct V_59 * V_60 , int V_271 )
{
if ( V_60 -> V_10 && V_60 -> V_10 -> V_94 -> V_272 )
return V_60 -> V_10 -> V_94 -> V_272 ( V_60 , V_271 ) ;
else
return - V_15 ;
}
int F_172 ( struct V_59 * V_60 , int V_273 ,
int V_274 )
{
if ( ! V_60 -> V_10 )
return - V_207 ;
if ( V_60 -> V_10 -> V_94 -> V_275 )
return V_60 -> V_10 -> V_94 -> V_275 ( V_60 , V_273 , V_274 ) ;
else if ( V_274 == V_102 &&
V_60 -> V_10 -> V_94 -> V_95 )
return V_60 -> V_10 -> V_94 -> V_95 ( V_60 , V_273 ) ;
else
return - V_207 ;
}
...
static char * F_174 ( struct V_22 * V_23 , int * V_129 )
{
char * V_279 , V_53 [ V_280 ] ;
int V_281 , V_282 ;
if ( V_164 ( V_23 ) == NULL )
return NULL ;
F_175 ( V_53 , V_164 ( V_23 ) , V_280 ) ;
V_279 = strstr ( V_53 , V_23 -> V_10 -> V_53 ) ;
if ( V_279 ) {
if ( sscanf ( & V_279 [ strlen ( V_23 -> V_10 -> V_53 ) ] , L_74 , V_129 ) == 1 ) {
if ( * V_129 == - 1 )
V_279 [ strlen ( V_23 -> V_10 -> V_53 ) ] = '\0' ;
}
} else {
if ( sscanf ( V_53 , L_75 , & V_281 , & V_282 ) == 2 ) {
char V_204 [ V_280 ] ;
* V_129 = ( ( V_281 & 0xffff ) << 16 ) + V_282 ;
snprintf ( V_204 , V_280 , L_76 , V_23 -> V_10 -> V_53 , V_53 ) ;
F_175 ( V_53 , V_204 , V_280 ) ;
} else
* V_129 = 0 ;
}
...
return F_176 ( V_283 -> V_53 , V_40 ) ;
}
static void F_178 ( struct V_48 * V_49 )
{
struct V_59 * V_60 , * V_284 ;
...
struct V_59 * V_60 ;
F_49 ( V_23 , L_79 , V_164 ( V_23 ) ) ;
V_60 = F_51 ( sizeof( struct V_59 ) , V_40 ) ;
if ( V_60 == NULL )
return NULL ;
if ( V_285 &&
( V_283 -> V_129 == 0 || V_283 -> V_53 == NULL ) ) {
V_60 -> V_53 = F_174 ( V_23 , & V_60 -> V_129 ) ;
} else {
V_60 -> V_53 = F_177 ( V_23 , V_283 ) ;
if ( V_283 -> V_129 )
V_60 -> V_129 = V_283 -> V_129 ;
else
V_60 -> V_129 = V_49 -> V_286 ;
}
if ( V_60 -> V_53 == NULL ) {
F_16 ( V_60 ) ;
return NULL ;
...
V_60 -> V_10 = V_283 ;
if ( ! V_60 -> V_10 -> V_94 )
V_60 -> V_10 -> V_94 = & V_287 ;
F_106 ( & V_60 -> V_80 , & V_49 -> V_288 ) ;
V_49 -> V_286 ++ ;
F_49 ( V_23 , L_80 , V_60 -> V_53 ) ;
return V_60 ;
}
static int F_180 ( struct V_48 * V_49 ,
struct V_92 * V_283 , T_1 V_16 ,
bool V_285 )
{
struct V_22 * V_23 = V_49 -> V_23 ;
struct V_59 * V_60 ;
unsigned int V_3 ;
int V_14 ;
F_49 ( V_23 , L_81 , V_164 ( V_23 ) , V_16 ) ;
V_49 -> V_283 = V_283 ;
for ( V_3 = 0 ; V_3 < V_16 ; V_3 ++ ) {
V_60 = F_179 ( V_49 , V_283 + V_3 ,
V_16 == 1 && V_285 ) ;
if ( V_60 == NULL ) {
V_14 = - V_41 ;
goto V_145;
...
struct V_59 * V_60 ;
int V_14 ;
if ( V_283 -> V_151 . type != V_289 ) {
F_78 ( V_49 -> V_23 , L_82 ,
V_283 -> V_151 . type ) ;
return - V_15 ;
}
F_80 ( & V_58 ) ;
V_60 = F_179 ( V_49 , V_283 , false ) ;
if ( ! V_60 )
return - V_41 ;
V_14 = F_102 ( V_105 , V_60 ) ;
if ( V_14 != 0 ) {
...
enum V_290 type , int V_291 )
{
struct V_48 * V_49 = V_105 -> V_49 ;
V_49 -> V_10 -> V_292 ( V_49 , type , V_291 ) ;
}
static int F_183 ( struct V_106 * V_105 ,
int V_293 )
{
struct V_48 * V_49 = V_105 -> V_49 ;
return V_49 -> V_10 -> V_294 ( V_49 , V_293 ) ;
}
static int F_184 ( struct V_48 * V_49 ,
const struct V_295 * V_10 , struct V_22 * V_23 )
{
struct V_106 * V_105 ;
V_49 -> V_53 = F_174 ( V_23 , & V_49 -> V_129 ) ;
if ( ! V_49 -> V_53 ) {
F_78 ( V_23 , L_83 ) ;
return - V_41 ;
}
...
{
if ( ! V_49 -> V_298 && ! V_49 -> V_299 ) {
if ( ! V_49 -> V_111 )
V_49 -> V_111 = F_191 ( V_49 -> V_23 , NULL ) ;
if ( V_49 -> V_111 )
F_185 ( V_49 ) ;
}
F_106 ( & V_49 -> V_80 , & V_300 ) ;
F_113 ( & V_49 -> V_277 ) ;
}
...
const struct V_295 * V_301 ,
struct V_92 * V_283 ,
int V_286 )
{
struct V_48 * V_302 ;
int V_14 ;
V_302 = F_51 ( sizeof( * V_302 ) , V_40 ) ;
if ( ! V_302 ) {
F_78 ( V_23 , L_84 ) ;
return - V_41 ;
}
V_14 = F_184 ( V_302 , V_301 , V_23 ) ;
if ( V_14 )
goto V_303;
V_302 -> V_304 = true ;
V_302 -> V_305 = true ;
V_14 = F_180 ( V_302 , V_283 , V_286 , true ) ;
if ( V_14 < 0 ) {
F_78 ( V_23 , L_85 , V_14 ) ;
goto V_306;
}
...
if ( V_23 == V_302 -> V_23 && V_302 -> V_305 )
goto V_279;
}
F_37 ( & V_58 ) ;
return;
...
struct V_61 * V_62 ;
int V_14 ;
F_49 ( V_23 , L_88 , V_164 ( V_23 ) ) ;
V_62 = F_51 ( sizeof( struct V_61 ) , V_40 ) ;
if ( V_62 == NULL )
return - V_41 ;
V_14 = F_201 ( V_23 , V_62 , V_309 ) ;
if ( V_14 )
F_16 ( V_62 ) ;
return V_14 ;
}
...
static void F_206 ( struct V_312 * V_72 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_141 ( V_313 ) ; V_3 ++ )
if ( V_72 -> V_314 & V_313 [ V_3 ] )
V_72 -> V_314 |= V_313 [ V_3 ] ;
}
...
static int F_211 ( struct V_48 * V_49 ,
unsigned int V_6 , unsigned int V_1 )
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
return V_5 -> V_10 -> V_298 ( V_5 , V_6 , V_1 ) ;
}
static int F_212 ( struct V_48 * V_49 ,
unsigned int V_6 , unsigned int * V_1 )
{
struct V_4 * V_5 = F_32 ( V_49 ) ;
* V_1 = V_5 -> V_10 -> V_299 ( V_5 , V_6 ) ;
return 0 ;
}
static int F_213 ( struct V_106 * V_105 ,
enum V_315 V_316 )
{
struct V_4 * V_5 = F_214 ( V_105 ) ;
return V_5 -> V_10 -> V_317 ( V_5 , V_316 ) ;
}
int F_215 ( struct V_22 * V_23 ,
...
goto V_303;
if ( V_319 -> V_170 )
V_5 -> V_49 . V_170 = F_207 ;
if ( V_319 -> remove )
V_5 -> V_49 . remove = F_208 ;
if ( V_319 -> V_99 )
V_5 -> V_49 . V_99 = F_209 ;
if ( V_319 -> V_116 )
V_5 -> V_49 . V_116 = F_210 ;
if ( V_319 -> V_298 )
V_5 -> V_49 . V_298 = F_211 ;
if ( V_319 -> V_299 )
V_5 -> V_49 . V_299 = F_212 ;
V_5 -> V_49 . V_304 = V_319 -> V_304 ;
V_105 = F_216 ( V_5 ) ;
V_105 -> V_109 = V_319 -> V_109 ;
V_105 -> V_320 = V_319 -> V_320 ;
if ( V_319 -> V_292 )
V_105 -> V_292 = V_319 -> V_292 ;
if ( V_319 -> V_317 )
V_105 -> V_317 = F_213 ;
V_5 -> V_23 = V_23 ;
V_5 -> V_10 = V_319 ;
V_5 -> V_49 . V_297 = V_319 -> V_13 ;
#ifdef F_122
V_5 -> V_49 . V_55 = F_31 ;
V_5 -> V_49 . V_52 = L_91 ;
#endif
if ( V_319 -> V_321 )
V_5 -> V_49 . V_111 = V_319 -> V_321 ( V_23 ) ;
for ( V_3 = 0 ; V_3 < V_286 ; V_3 ++ ) {
F_206 ( & V_283 [ V_3 ] . V_322 ) ;
F_206 ( & V_283 [ V_3 ] . V_323 ) ;
}
V_14 = F_180 ( & V_5 -> V_49 , V_283 , V_286 , false ) ;
if ( V_14 < 0 ) {
F_78 ( V_23 , L_85 , V_14 ) ;
goto V_306;
}
...
V_14 = F_221 ( V_325 , V_326 , 0 , & V_50 -> V_53 ) ;
if ( V_14 < 0 && V_14 != - V_15 ) {
F_78 ( V_50 -> V_23 ,
L_95 ,
V_326 , V_14 ) ;
...
int F_222 ( struct V_63 * V_50 ,
struct V_122 * V_325 ,
const char * V_326 )
{
struct V_187 * V_328 ;
const char * V_240 , * V_329 ;
int V_3 , V_119 , V_330 , V_14 ;
if ( ! V_325 )
V_325 = V_50 -> V_23 -> V_123 ;
V_330 = F_223 ( V_325 , V_326 ) ;
if ( V_330 < 0 ) {
F_78 ( V_50 -> V_23 ,
L_96 , V_326 ) ;
return - V_15 ;
...
V_328 = F_224 ( V_50 -> V_23 , V_330 , sizeof( * V_328 ) ,
V_40 ) ;
if ( ! V_328 ) {
F_78 ( V_50 -> V_23 ,
L_99 ) ;
...
for ( V_3 = 0 ; V_3 < V_330 ; V_3 ++ ) {
V_14 = F_221 ( V_325 , V_326 ,
2 * V_3 , & V_240 ) ;
if ( V_14 ) {
F_78 ( V_50 -> V_23 ,
L_100 ,
...
for ( V_119 = 0 ; V_119 < F_141 ( V_331 ) ; V_119 ++ ) {
if ( ! strncmp ( V_240 , V_331 [ V_119 ] . V_53 ,
strlen ( V_331 [ V_119 ] . V_53 ) ) ) {
V_328 [ V_3 ] = V_331 [ V_119 ] ;
break;
}
}
if ( V_119 >= F_141 ( V_331 ) ) {
F_78 ( V_50 -> V_23 ,
L_101 ,
V_240 ) ;
return - V_15 ;
...
V_328 [ V_3 ] . V_53 = V_329 ;
}
V_50 -> V_221 = V_328 ;
V_50 -> V_222 = V_330 ;
return 0 ;
}
static int F_225 ( struct V_122 * V_325 ,
const char * V_332 ,
unsigned int * V_333 )
{
T_6 V_1 ;
const T_7 * V_334 = F_226 ( V_325 , V_332 , & V_1 ) ;
int V_3 ;
if ( ! V_334 )
return 0 ;
V_1 /= sizeof( T_6 ) ;
...
int V_14 ;
if ( V_261 )
F_225 ( V_325 , L_102 , V_261 ) ;
if ( V_262 )
F_225 ( V_325 , L_103 , V_262 ) ;
if ( F_229 ( V_325 , L_104 ) ) {
V_14 = F_230 ( V_325 , L_104 , & V_1 ) ;
if ( V_14 )
return V_14 ;
if ( V_260 )
* V_260 = V_1 ;
}
if ( F_229 ( V_325 , L_105 ) ) {
V_14 = F_230 ( V_325 , L_105 , & V_1 ) ;
if ( V_14 )
return V_14 ;
if ( V_263 )
* V_263 = V_1 ;
...
V_338 = F_94 ( V_50 -> V_23 , V_336 * sizeof( * V_338 ) ,
V_40 ) ;
if ( ! V_338 ) {
F_78 ( V_50 -> V_23 ,
L_107 ) ;
...
unsigned int F_234 ( struct V_122 * V_325 ,
const char * V_239 ,
struct V_122 * * V_339 ,
struct V_122 * * V_340 )
{
...
if ( ! V_239 )
V_239 = L_118 ;
snprintf ( V_341 , sizeof( V_341 ) , L_119 , V_239 ) ;
V_14 = F_232 ( V_325 , V_341 , & V_335 ) ;
if ( V_14 == 0 ) {
for ( V_3 = 0 ; V_3 < F_141 ( V_345 ) ; V_3 ++ ) {
if ( strcmp ( V_335 , V_345 [ V_3 ] . V_53 ) == 0 ) {
V_342 |= V_345 [ V_3 ] . V_1 ;
break;
}
}
}
snprintf ( V_341 , sizeof( V_341 ) , L_120 , V_239 ) ;
if ( F_229 ( V_325 , V_341 ) )
V_342 |= V_355 ;
else
V_342 |= V_356 ;
snprintf ( V_341 , sizeof( V_341 ) , L_121 , V_239 ) ;
V_343 = ! ! F_226 ( V_325 , V_341 , NULL ) ;
snprintf ( V_341 , sizeof( V_341 ) , L_122 , V_239 ) ;
V_344 = ! ! F_226 ( V_325 , V_341 , NULL ) ;
switch ( ( V_343 << 4 ) + V_344 ) {
case 0x11 :
V_342 |= V_357 ;
break;
case 0x10 :
...
snprintf ( V_341 , sizeof( V_341 ) , L_123 , V_239 ) ;
V_343 = ! ! F_226 ( V_325 , V_341 , NULL ) ;
if ( V_343 && V_339 )
* V_339 = F_235 ( V_325 , V_341 , 0 ) ;
snprintf ( V_341 , sizeof( V_341 ) , L_124 , V_239 ) ;
V_344 = ! ! F_226 ( V_325 , V_341 , NULL ) ;
if ( V_344 && V_340 )
* V_340 = F_235 ( V_325 , V_341 , 0 ) ;
switch ( ( V_343 << 4 ) + V_344 ) {
case 0x11 :
V_342 |= V_210 ;
break;
...
if ( V_129 < 0 || V_129 >= V_17 -> V_286 ) {
V_14 = - V_15 ;
continue;
}
V_14 = 0 ;
* V_128 = V_17 -> V_283 [ V_129 ] . V_53 ;
if ( ! * V_128 )
* V_128 = V_17 -> V_53 ;
}
break;
...
int F_237 ( struct V_122 * V_123 ,
const char * * V_128 )
{
struct V_360 args ;
int V_14 ;
V_14 = F_238 ( V_123 , L_125 ,
L_126 , 0 , & args ) ;
if ( V_14 )
return V_14 ;
V_14 = F_236 ( & args , V_128 ) ;
F_239 ( args . V_325 ) ;
return V_14 ;
}
int F_240 ( struct V_22 * V_23 ,
struct V_122 * V_123 ,
struct V_77 * V_71 )
{
struct V_360 args ;
...
V_71 -> V_133 = V_49 ;
V_71 -> V_79 = V_79 ;
for ( V_242 = 0 , V_49 = V_71 -> V_133 ;
V_242 < V_71 -> V_79 ;
V_242 ++ , V_49 ++ ) {
V_14 = F_238 ( V_123 , V_53 ,
L_126 ,
V_242 , & args ) ;
if ( V_14 )
goto V_145;
V_49 -> V_123 = args . V_325 ;
V_14 = F_236 ( & args , & V_49 -> V_128 ) ;
if ( V_14 < 0 )
goto V_145;
}
return 0 ;
