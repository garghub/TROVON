...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
int V_56 = V_11 -> V_40 . V_57 ;
return sprintf ( V_5 , L_16 , V_58 [ V_56 ] . V_42 ,
V_56 ) ;
}
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_50 ) ;
}
...
static T_1 F_46 ( struct V_33 * V_34 ,
struct V_35 * V_4 ,
char * V_5 )
{
int V_36 , V_9 = 0 ;
...
T_3 V_68 , * V_69 ;
unsigned long * V_70 ;
int V_71 , V_36 , V_72 , V_31 = - V_47 ;
V_69 = V_11 -> V_40 . V_63 ;
V_68 = F_48 ( V_5 + 1 ) ;
if ( V_5 [ 0 ] == '+' ) {
if ( ( V_68 == 0 ) || ( V_68 == F_49 ( V_73 ) ) ) {
F_12 ( L_41 ,
V_11 -> V_14 -> V_15 , & V_68 ) ;
goto V_38;
}
...
if ( V_71 == 0 && ! V_69 [ 1 ] && V_11 -> V_40 . V_50 )
F_53 ( L_47 ,
V_11 -> V_14 -> V_15 ) ;
...
V_70 = V_29 -> V_74 ;
V_72 = V_71 ;
for (; ( V_72 < V_67 - 1 ) && V_69 [ V_72 + 1 ] ; V_72 ++ )
V_70 [ V_72 ] = V_70 [ V_72 + 1 ] ;
V_70 [ V_72 ] = 0 ;
}
for ( V_36 = V_71 ; ( V_36 < V_67 - 1 ) && V_69 [ V_36 + 1 ] ; V_36 ++ )
V_69 [ V_36 ] = V_69 [ V_36 + 1 ] ;
V_69 [ V_36 ] = 0 ;
F_52 ( & V_11 -> V_37 ) ;
} else {
F_12 ( L_49 ,
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_76 * V_11 -> V_40 . V_62 ) ;
}
...
if ( V_43 < 0 ) {
F_12 ( L_52 ,
V_11 -> V_14 -> V_15 , V_43 , 0 , V_61 ) ;
V_31 = - V_47 ;
goto V_38;
} else {
if ( ( V_43 % V_11 -> V_40 . V_62 ) != 0 ) {
F_56 ( L_53 ,
V_11 -> V_14 -> V_15 , V_43 ,
V_11 -> V_40 . V_62 ,
( V_43 / V_11 -> V_40 . V_62 ) *
...
V_11 -> V_40 . V_76 = V_43 / V_11 -> V_40 . V_62 ;
F_9 ( L_54 ,
V_11 -> V_14 -> V_15 ,
V_11 -> V_40 . V_76 * V_11 -> V_40 . V_62 ) ;
}
V_38:
return V_31 ;
}
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_77 * V_11 -> V_40 . V_62 ) ;
}
...
V_11 -> V_40 . V_77 = V_43 / V_11 -> V_40 . V_62 ;
F_9 ( L_59 ,
V_11 -> V_14 -> V_15 ,
V_11 -> V_40 . V_77 * V_11 -> V_40 . V_62 ) ;
}
V_38:
return V_31 ;
}
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_81 ) ;
}
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_84 ) ;
}
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
int V_85 = F_69 ( V_5 , 10 , & V_11 -> V_40 . V_84 ) ;
return V_85 ? V_85 : V_19 ;
}
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_62 ) ;
}
...
struct V_10 * V_11 = F_19 ( V_34 ) ;
if ( V_11 -> V_87 )
V_19 = sprintf ( V_5 , L_75 , V_11 -> V_87 -> V_14 -> V_15 ) ;
return V_19 ;
}
...
V_11 -> V_14 -> V_15 ) ;
V_11 -> V_87 = NULL ;
memset ( V_11 -> V_40 . V_89 , 0 , sizeof( V_11 -> V_40 . V_89 ) ) ;
F_76 ( V_11 ) ;
goto V_38;
}
F_21 (bond, slave, i) {
...
V_11 -> V_87 = V_29 ;
strcpy ( V_11 -> V_40 . V_89 , V_29 -> V_14 -> V_15 ) ;
F_76 ( V_11 ) ;
goto V_38;
}
}
strncpy ( V_11 -> V_40 . V_89 , V_17 , V_13 ) ;
V_11 -> V_40 . V_89 [ V_13 - 1 ] = 0 ;
F_9 ( L_80
L_81 ,
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_92 ) ;
}
...
V_93 = V_11 -> V_94 ;
F_22 ( & V_11 -> V_88 ) ;
if ( F_75 ( V_11 -> V_40 . V_41 ) && V_93 )
V_19 = sprintf ( V_5 , L_75 , V_93 -> V_14 -> V_15 ) ;
return V_19 ;
}
...
V_93 = V_11 -> V_94 ;
F_22 ( & V_11 -> V_88 ) ;
return sprintf ( V_5 , L_75 , V_93 ? L_97 : L_98 ) ;
}
...
struct V_99 V_99 ;
if ( ! F_88 ( V_11 , & V_99 ) )
V_19 = sprintf ( V_5 , L_99 , V_99 . V_104 ) ;
}
return V_19 ;
}
...
const char * V_18 , T_2 V_19 )
{
struct V_29 * V_29 , * V_106 ;
struct V_10 * V_11 = F_19 ( V_34 ) ;
T_4 V_107 ;
int V_36 , V_31 = V_19 ;
char * V_108 ;
struct V_16 * V_109 = NULL ;
if ( ! F_24 () )
return F_25 () ;
V_108 = strchr ( V_18 , ':' ) ;
if ( ! V_108 )
goto V_22;
* V_108 = '\0' ;
if ( sscanf ( ++ V_108 , L_101 , & V_107 ) != 1 )
goto V_22;
if ( strlen ( V_18 ) > V_13 ||
! F_8 ( V_18 ) ||
V_107 > V_11 -> V_14 -> V_110 )
goto V_22;
V_109 = F_26 ( F_27 ( V_11 -> V_14 ) , V_18 ) ;
if ( ! V_109 )
goto V_22;
F_20 ( & V_11 -> V_37 ) ;
V_106 = NULL ;
...
if ( V_109 == V_29 -> V_14 )
V_106 = V_29 ;
else if ( V_107 && V_107 == V_29 -> V_105 ) {
goto V_111;
}
}
if ( ! V_106 )
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_112 ) ;
}
...
if ( V_43 == V_11 -> V_40 . V_112 )
goto V_38;
if ( ( V_43 == 0 ) || ( V_43 == 1 ) ) {
V_11 -> V_40 . V_112 = V_43 ;
} else {
F_9 ( L_104 ,
V_11 -> V_14 -> V_15 , V_43 ) ;
V_31 = - V_47 ;
...
{
struct V_10 * V_11 = F_19 ( V_34 ) ;
return sprintf ( V_5 , L_32 , V_11 -> V_40 . V_114 ) ;
}
