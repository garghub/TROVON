...
unsigned int V_4 = V_36 -> V_4 , V_5 = V_36 -> V_5 , V_39 , V_40 ;
struct V_13 V_14 ;
bool V_41 ;
int V_15 ;
V_15 = F_13 ( V_9 -> V_28 ,
...
if ( V_15 < 0 )
return V_15 ;
F_8 ( V_27 , L_5 , V_36 -> V_4 , V_36 -> V_5 ) ;
if ( V_4 == V_36 -> V_4 && V_5 == V_36 -> V_5 ) {
V_41 = true ;
goto V_43;
}
V_41 = false ;
...
V_39 = V_36 -> V_4 ;
V_40 = V_36 -> V_5 ;
while ( ( V_4 > V_39 || V_5 > V_40 ) &&
V_39 < V_33 && V_40 < V_34 ) {
V_39 = F_15 ( 2 * V_39 , V_33 ) ;
V_40 = F_15 ( 2 * V_40 , V_34 ) ;
V_36 -> V_4 = V_39 ;
V_36 -> V_5 = V_40 ;
V_15 = F_13 ( V_9 -> V_28 ,
F_14 ( V_32 ) , V_17 ,
...
bool V_37 , unsigned int V_44 )
{
struct V_26 * V_27 = V_32 -> V_38 ;
struct V_35 V_45 = * V_36 ;
...
F_8 ( V_27 , L_8 ,
V_45 . V_4 , V_45 . V_5 ) ;
V_46 = F_18 ( V_10 -> V_4 , V_44 , V_45 . V_4 ) ;
V_47 = F_18 ( V_10 -> V_5 , V_44 , V_45 . V_5 ) ;
V_36 -> V_4 = V_45 . V_4 ;
V_36 -> V_5 = V_45 . V_5 ;
V_36 -> V_48 = V_45 . V_48 ;
* V_4 = F_19 ( V_22 -> V_4 , V_44 , V_46 ) ;
* V_5 = F_19 ( V_22 -> V_5 , V_44 , V_47 ) ;
F_8 ( V_27 , L_9 , * V_4 , * V_5 ) ;
return 0 ;
}
void F_20 ( struct V_31 * V_32 ,
struct V_1 * V_10 , struct V_1 * V_22 ,
const struct V_49 * V_50 , struct V_35 * V_36 ,
unsigned int V_44 )
{
struct V_26 * V_27 = V_32 -> V_38 ;
...
V_22 -> V_4 , V_22 -> V_5 ,
V_22 -> V_6 , V_22 -> V_7 ) ;
V_46 = F_18 ( V_22 -> V_4 , V_44 , V_50 -> V_4 ) ;
V_47 = F_18 ( V_22 -> V_5 , V_44 , V_50 -> V_5 ) ;
F_8 ( V_27 , L_11 , V_46 , V_47 ) ;
V_36 -> V_4 = F_19 ( V_10 -> V_4 , V_44 , V_46 ) ;
V_36 -> V_5 = F_19 ( V_10 -> V_5 , V_44 , V_47 ) ;
}
