...
V_4 -> V_15 = F_63 ( V_4 -> V_14 -> V_148 ,
V_4 -> V_142 ) ;
V_4 -> V_149 = F_64 ( V_4 -> V_15 ,
& V_147 ) ;
if ( F_59 ( V_4 -> V_149 ) ) {
V_46 = F_60 ( V_4 -> V_149 ) ;
F_9 ( & V_4 -> V_15 -> V_29 ,
...
static int F_68 ( struct V_141 * V_29 )
{
struct V_7 * V_14 = F_69 ( V_29 , struct V_7 , V_29 ) ;
struct V_3 * V_4 = F_35 ( V_14 ) ;
if ( F_70 ( V_29 ) && V_4 -> V_150 )
F_71 ( V_4 -> V_61 ) ;
return 0 ;
}
static int F_72 ( struct V_141 * V_29 )
{
struct V_7 * V_14 = F_69 ( V_29 , struct V_7 , V_29 ) ;
struct V_3 * V_4 = F_35 ( V_14 ) ;
if ( F_70 ( V_29 ) && V_4 -> V_150 )
