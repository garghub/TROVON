...
V_12 = F_69 ( & V_10 -> V_140 , sizeof( * V_12 ) , V_166 ) ;
if ( ! V_12 )
return - V_167 ;
V_12 -> V_137 = V_137 ;
...
V_165 = V_137 -> V_143
? V_168 : V_169 ;
V_20 = F_70 ( & V_10 -> V_140 , V_137 -> V_142 , V_165 ,
L_17 ) ;
if ( V_20 ) {
F_67 ( & V_10 -> V_140 , L_18 , V_20 ) ;
return V_20 ;
}
V_20 = F_71 ( & V_10 -> V_140 , F_33 ( V_141 ) ,
V_141 ) ;
if ( V_20 ) {
...
V_5 = & V_12 -> V_5 ;
F_72 ( V_5 , V_10 , & V_170 ) ;
F_73 ( V_5 -> V_159 , V_171 , sizeof( V_5 -> V_159 ) ) ;
V_5 -> V_24 |= V_172 ;
V_5 -> V_173 = & V_174 ;
V_12 -> V_116 . V_24 = V_175 ;
V_20 = F_74 ( & V_5 -> V_176 , 1 , & V_12 -> V_116 , 0 ) ;
if ( V_20 < 0 )
return V_20 ;
V_5 -> V_176 . type = V_177 ;
F_75 ( & V_12 -> V_49 ) ;
F_76 ( & V_12 -> V_108 ) ;
V_20 = F_77 ( & V_10 -> V_140 , V_10 -> V_160 , F_64 ,
V_178 , V_171 , V_5 ) ;
if ( V_20 ) {
