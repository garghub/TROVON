...
return - V_197 ;
V_15 = (struct V_14 * ) V_189 -> V_190 ;
V_77 = V_15 -> V_17 -> V_73 -> V_77 ;
if ( F_101 ( V_77 ) == V_204 ) {
if ( V_92 -> V_84 == 0 ) {
V_92 -> V_205 |= V_206 |
V_207 ;
...
F_114 ( V_31 ) [ 2 ] = 1 ;
F_114 ( V_31 ) [ 7 ] = 1 ;
F_115 ( V_226 , V_13 -> V_234 . V_235 . V_236 . V_237 . V_238 . V_226 ,
V_227 ) ;
sprintf ( F_116 ( V_31 ) , L_15 , V_226 ) ;
F_117 ( V_31 ) = F_102 ( & V_13 -> V_77 ) ;
