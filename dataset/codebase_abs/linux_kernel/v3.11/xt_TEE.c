...
void * V_58 )
{
struct V_59 * V_6 = F_31 ( V_58 ) ;
struct V_60 * V_16 ;
V_16 = F_32 ( V_56 , struct V_60 , V_61 ) ;
switch ( V_57 ) {
case V_62 :
if ( ! strcmp ( V_6 -> V_63 , V_16 -> V_64 -> V_17 ) )
V_16 -> V_17 = V_6 -> V_65 ;
break;
case V_66 :
if ( V_6 -> V_65 == V_16 -> V_17 )
V_16 -> V_17 = - 1 ;
break;
case V_67 :
if ( ! strcmp ( V_6 -> V_63 , V_16 -> V_64 -> V_17 ) )
V_16 -> V_17 = V_6 -> V_65 ;
else if ( V_6 -> V_65 == V_16 -> V_17 )
V_16 -> V_17 = - 1 ;
break;
}
return V_68 ;
}
static int F_33 ( const struct V_69 * V_31 )
{
struct V_8 * V_9 = V_31 -> V_32 ;
struct V_60 * V_16 ;
if ( memcmp ( & V_9 -> V_20 , & V_70 ,
sizeof( V_70 ) ) == 0 )
return - V_71 ;
if ( V_9 -> V_17 [ 0 ] ) {
if ( V_9 -> V_17 [ sizeof( V_9 -> V_17 ) - 1 ] != '\0' )
return - V_71 ;
V_16 = F_34 ( sizeof( * V_16 ) , V_72 ) ;
if ( V_16 == NULL )
return - V_73 ;
V_16 -> V_64 = V_9 ;
V_16 -> V_17 = - 1 ;
...
static void F_36 ( const struct V_75 * V_31 )
{
struct V_8 * V_9 = V_31 -> V_32 ;
if ( V_9 -> V_16 ) {
F_37 ( & V_9 -> V_16 -> V_61 ) ;
