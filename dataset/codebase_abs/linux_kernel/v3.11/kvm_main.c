...
if ( V_374 -> V_375 - V_374 -> V_389 > V_390 - 1 )
return - V_391 ;
...
static int F_357 ( void * V_392 , T_4 * V_368 )
{
unsigned V_191 = ( long ) V_392 ;
struct V_19 * V_19 ;
* V_368 = 0 ;
F_92 ( & V_84 ) ;
...
static int F_359 ( void * V_392 , T_4 * V_368 )
{
unsigned V_191 = ( long ) V_392 ;
struct V_19 * V_19 ;
struct V_6 * V_7 ;
...
int V_37 = - V_151 ;
struct V_393 * V_275 ;
V_394 = F_361 ( L_8 , NULL ) ;
if ( V_394 == NULL )
goto V_128;
for ( V_275 = V_395 ; V_275 -> V_303 ; ++ V_275 ) {
V_275 -> V_396 = F_362 ( V_275 -> V_303 , 0444 , V_394 ,
...
static inline
struct V_6 * F_369 ( struct V_17 * V_400 )
{
return F_54 ( V_400 , struct V_6 , V_17 ) ;
}
static void F_370 ( struct V_17 * V_400 , int V_8 )
{
struct V_6 * V_7 = F_369 ( V_400 ) ;
if ( V_7 -> V_45 )
V_7 -> V_45 = false ;
F_17 ( V_7 , V_8 ) ;
}
static void F_371 ( struct V_17 * V_400 ,
struct V_164 * V_401 )
{
struct V_6 * V_7 = F_369 ( V_400 ) ;
if ( V_12 -> V_402 == V_403 )
...
int F_372 ( void * V_404 , unsigned V_405 , unsigned V_406 ,
struct V_407 * V_407 )
{
int V_37 ;
int V_8 ;
...
F_379 ( & V_416 ) ;
if ( ! V_406 )
V_406 = F_380 ( struct V_6 ) ;
V_417 = F_381 ( L_9 , V_405 , V_406 ,
0 , NULL ) ;
if ( ! V_417 ) {
V_37 = - V_42 ;
goto V_418;
