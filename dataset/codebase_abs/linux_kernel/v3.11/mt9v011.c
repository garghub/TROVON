...
V_99 | V_100 ) )
return - V_101 ;
V_16 = F_31 ( & V_6 -> V_102 , sizeof( struct V_1 ) , V_103 ) ;
if ( ! V_16 )
return - V_104 ;
V_3 = & V_16 -> V_3 ;
F_32 ( V_3 , V_6 , & V_105 ) ;
...
F_34 ( & V_16 -> V_88 , 5 ) ;
F_35 ( & V_16 -> V_88 , & V_109 ,
V_90 , 0 , ( 1 << 12 ) - 1 - 0x20 , 1 , 0x20 ) ;
F_35 ( & V_16 -> V_88 , & V_109 ,
V_91 , 0 , 2047 , 1 , 0x01fc ) ;
F_35 ( & V_16 -> V_88 , & V_109 ,
V_92 , - ( 1 << 9 ) , ( 1 << 9 ) - 1 , 1 , 0 ) ;
F_35 ( & V_16 -> V_88 , & V_109 ,
V_93 , - ( 1 << 9 ) , ( 1 << 9 ) - 1 , 1 , 0 ) ;
...
V_95 , 0 , 1 , 1 , 0 ) ;
if ( V_16 -> V_88 . error ) {
int V_110 = V_16 -> V_88 . error ;
F_36 ( V_3 , L_9 , V_110 ) ;
F_37 ( & V_16 -> V_88 ) ;
return V_110 ;
}
V_16 -> V_3 . V_111 = & V_16 -> V_88 ;
V_16 -> V_22 = 0x0024 ;
V_16 -> V_20 = 0x01fc ;
V_16 -> V_33 = 640 ;
V_16 -> V_32 = 480 ;
V_16 -> V_46 = 27000000 ;
if ( V_6 -> V_102 . V_112 ) {
struct V_113 * V_114 = V_6 -> V_102 . V_112 ;
V_16 -> V_46 = V_114 -> V_46 ;
F_6 ( 1 , V_10 , V_3 , L_10 ,
V_16 -> V_46 / 1000000 , ( V_16 -> V_46 / 1000 ) % 1000 ) ;
}
F_38 ( V_6 , L_11 ,
V_6 -> V_4 << 1 , V_6 -> V_98 -> V_115 , V_97 ) ;
return 0 ;
}
