...
static struct V_7 * F_9 ( struct V_34 * V_9 )
{
struct V_7 * V_8 ;
struct V_35 * V_36 = V_9 -> V_37 ;
T_3 V_38 ;
T_3 V_18 ;
V_8 = F_10 ( V_9 , sizeof( * V_8 ) , V_39 ) ;
if ( ! V_8 )
return NULL ;
if ( F_11 ( V_36 , L_1 , NULL ) )
V_8 -> V_21 |= V_40 ;
F_12 ( V_36 , L_2 , & V_38 ) ;
if ( V_38 == 8 )
V_8 -> V_21 |= V_41 ;
...
static inline struct V_7 * F_9 ( struct V_34 * V_9 )
{
return NULL ;
}
...
int V_48 ;
struct V_49 * V_49 ;
V_45 = F_14 ( sizeof( struct V_44 ) , V_39 ) ;
if ( ! V_45 )
return - V_50 ;
V_2 = F_15 ( V_5 , NULL , 0 ) ;
if ( F_16 ( V_2 ) ) {
