...
{
struct V_29 * V_30 = V_48 -> V_104 ;
switch ( V_102 ) {
case V_105 :
return F_34 ( V_30 ,
(struct V_88 T_3 * ) V_103 ) ;
default:
break;
}
return - V_106 ;
}
static void F_37 ( struct V_29 * V_30 , unsigned char * V_107 )
{
switch ( * V_107 ) {
case V_108 :
F_38 ( V_30 , V_107 + 1 ) ;
...
{
int V_110 ;
V_110 = ( int ) ( * V_107 ) + ( int ) ( * ( V_107 + 1 ) << 4 ) ;
}
static void F_41 ( struct V_29 * V_30 , unsigned char * V_107 )
{
return;
}
static void F_42 ( struct V_111 * V_111 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 ;
struct V_29 * V_30 ;
...
V_2 = V_111 -> V_117 ;
V_4 = F_2 ( V_2 ) ;
V_30 = V_2 -> V_30 [ V_4 -> V_118 ] ;
V_26 = F_21 ( V_30 ) ;
for ( V_41 = 0 ; V_41 < V_111 -> V_115 ; V_41 ++ ) {
V_107 = ( unsigned char * ) V_111 -> V_116 + V_41 ;
if ( ( V_41 <= ( V_114 - 3 ) ) &&
( * V_107 == V_119 ) &&
( * ( V_107 + 1 ) == V_119 ) ) {
V_112 = false ;
...
F_45 ( & V_30 -> V_30 , 1 ) ;
F_46 ( & V_30 -> V_30 , V_107 , 1 ) ;
}
F_44 ( & V_30 -> V_30 ) ;
}
static void F_47 ( struct V_111 * V_111 )
{
struct V_29 * V_30 ;
struct V_25 * V_26 ;
V_30 = V_111 -> V_117 ;
...
struct V_25 * V_26 ;
T_2 V_130 ;
V_26 = F_28 ( sizeof( * V_26 ) , V_77 ) ;
if ( ! V_26 )
return - V_78 ;
F_60 ( & V_26 -> V_80 ) ;
F_60 ( & V_26 -> V_84 ) ;
V_26 -> V_30 = V_30 ;
V_26 -> V_85 = F_54 ( 0 , V_77 ) ;
if ( ! V_26 -> V_85 ) {
F_4 ( V_26 ) ;
return - V_78 ;
}
V_130 = V_2 -> V_30 [ 0 ] -> V_131 ;
F_55 ( V_26 -> V_85 , V_2 -> V_11 ,
F_61 ( V_2 -> V_11 , V_130 ) ,
V_26 -> V_132 ,
sizeof( V_26 -> V_132 ) ,
F_47 , V_30 ) ;
...
if ( ! V_40 )
return - V_78 ;
V_133 = F_13 ( V_11 , V_26 -> V_37 , V_38 , V_40 ) ;
if ( V_133 < 0 )
goto V_134;
V_133 = F_13 ( V_11 , V_26 -> V_37 , V_135 , V_40 + 1 ) ;
if ( V_133 < 0 )
goto V_134;
V_133 = ( V_40 [ 0 ] & V_35 ? V_33 : 0 ) |
( V_40 [ 0 ] & V_36 ? V_34 : 0 ) |
( V_40 [ 1 ] & V_136 ? V_137 : 0 ) |
( V_40 [ 1 ] & V_138 ? V_139 : 0 ) |
( V_40 [ 1 ] & V_140 ? V_141 : 0 ) |
( V_40 [ 1 ] & V_142 ? V_143 : 0 ) ;
V_134:
F_4 ( V_40 ) ;
return V_133 ;
}
...
{
struct V_25 * V_26 ;
V_26 = F_21 ( V_48 -> V_104 ) ;
return F_15 ( V_26 , V_27 , V_28 ) ;
}
static void F_66 ( struct V_47 * V_48 , int V_144 )
{
struct V_29 * V_30 = V_48 -> V_104 ;
struct V_25 * V_26 ;
int V_32 ;
...
static void F_67 ( struct V_29 * V_30 , int V_147 )
{
struct V_10 * V_11 = V_30 -> V_2 -> V_11 ;
struct V_25 * V_26 = F_21 ( V_30 ) ;
if ( ! V_147 ) {
...
static void F_39 ( struct V_29 * V_30 , unsigned char * V_107 )
{
struct V_25 * V_26 ;
T_2 V_148 = ( T_2 ) * V_107 ;
unsigned long V_74 ;
...
if ( V_148 & V_157 )
V_30 -> V_151 . V_158 ++ ;
F_68 ( & V_30 -> V_30 . V_159 ) ;
}
}
static void F_38 ( struct V_29 * V_30 , unsigned char * V_107 )
{
struct V_25 * V_26 ;
struct V_160 * V_151 ;
unsigned long V_74 ;
...
struct V_29 * V_30 ,
const unsigned char * V_173 , int V_174 )
{
struct V_25 * V_26 ;
struct V_111 * V_85 ;
unsigned char * V_18 ;
...
F_72 ( V_174 , V_18 ) ;
V_18 += 2 ;
memcpy ( V_18 , V_173 , V_174 ) ;
V_85 -> V_177 = V_174 + V_172 ;
V_32 = F_52 ( V_85 , V_125 ) ;
if ( V_32 == 0 ) {
V_26 -> V_86 = true ;
V_175 += V_174 ;
}
