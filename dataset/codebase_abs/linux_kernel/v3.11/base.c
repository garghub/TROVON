...
void
F_5 ( struct V_1 * V_2 , T_1 V_3 , T_1 V_25 ,
struct V_4 * V_31 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_9 ;
...
void
F_9 ( struct V_1 * V_2 , T_1 V_3 , T_1 V_25 ,
struct V_4 * V_31 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_9 ;
...
static void
F_12 ( struct V_6 * V_7 , int V_12 , T_2 V_18 , T_2 V_44 )
{
struct V_8 * V_9 = V_7 -> V_9 ;
struct V_45 * V_46 ;
struct V_47 * V_48 ;
struct V_26 * V_27 ;
T_2 V_16 ;
for ( V_16 = V_18 ; V_16 <= V_44 ; V_16 ++ ) {
V_48 = & V_7 -> V_27 [ V_16 - V_7 -> V_18 ] ;
if ( -- V_48 -> V_49 [ V_12 ] )
continue;
V_27 = V_48 -> V_28 [ V_12 ] ;
V_48 -> V_28 [ V_12 ] = NULL ;
F_2 (vpgd, &vm->pgd_list, head) {
V_9 -> V_50 ( V_46 -> V_28 , V_16 , V_48 -> V_28 ) ;
}
F_13 ( & F_14 ( V_9 ) -> V_51 ) ;
F_15 ( NULL , & V_27 ) ;
F_16 ( & F_14 ( V_9 ) -> V_51 ) ;
...
{
struct V_8 * V_9 = V_7 -> V_9 ;
struct V_47 * V_48 = & V_7 -> V_27 [ V_16 - V_7 -> V_18 ] ;
struct V_45 * V_46 ;
struct V_26 * V_27 ;
int V_12 = ( type != V_9 -> V_13 ) ;
T_2 V_52 ;
int V_53 ;
V_52 = ( 1 << ( V_9 -> V_17 + 12 ) ) >> type ;
V_52 *= 8 ;
F_13 ( & F_14 ( V_9 ) -> V_51 ) ;
V_53 = F_18 ( F_19 ( V_7 -> V_9 ) , NULL , V_52 , 0x1000 ,
V_54 , & V_27 ) ;
F_16 ( & F_14 ( V_9 ) -> V_51 ) ;
if ( F_3 ( V_53 ) )
return V_53 ;
if ( F_3 ( V_48 -> V_49 [ V_12 ] ++ ) ) {
F_13 ( & F_14 ( V_9 ) -> V_51 ) ;
F_15 ( NULL , & V_27 ) ;
F_16 ( & F_14 ( V_9 ) -> V_51 ) ;
return 0 ;
...
int
F_20 ( struct V_6 * V_7 , T_1 V_55 , T_2 V_56 ,
...
int V_53 ;
F_16 ( & F_14 ( V_9 ) -> V_51 ) ;
V_53 = F_21 ( & V_7 -> V_60 , V_56 , V_59 , V_59 , V_58 ,
& V_2 -> V_5 ) ;
if ( F_3 ( V_53 != 0 ) ) {
F_13 ( & F_14 ( V_9 ) -> V_51 ) ;
return V_53 ;
...
V_44 = ( V_2 -> V_5 -> V_14 + V_2 -> V_5 -> V_25 - 1 ) >> V_9 -> V_17 ;
for ( V_16 = V_18 ; V_16 <= V_44 ; V_16 ++ ) {
struct V_47 * V_48 = & V_7 -> V_27 [ V_16 - V_7 -> V_18 ] ;
int V_12 = ( V_2 -> V_5 -> type != V_9 -> V_13 ) ;
if ( F_22 ( V_48 -> V_49 [ V_12 ] ) ) {
V_48 -> V_49 [ V_12 ] ++ ;
continue;
}
V_53 = F_17 ( V_7 , V_16 , V_2 -> V_5 -> type ) ;
if ( V_53 ) {
if ( V_16 != V_18 )
...
V_44 = ( V_2 -> V_5 -> V_14 + V_2 -> V_5 -> V_25 - 1 ) >> V_9 -> V_17 ;
F_16 ( & F_14 ( V_9 ) -> V_51 ) ;
F_12 ( V_7 , V_2 -> V_5 -> type != V_9 -> V_13 , V_18 , V_44 ) ;
F_23 ( & V_7 -> V_60 , & V_2 -> V_5 ) ;
F_13 ( & F_14 ( V_9 ) -> V_51 ) ;
...
V_7 -> V_44 = ( V_14 + V_25 - 1 ) >> ( V_9 -> V_17 + 12 ) ;
V_7 -> V_27 = F_30 ( ( V_7 -> V_44 - V_7 -> V_18 + 1 ) * sizeof( * V_7 -> V_27 ) ) ;
if ( ! V_7 -> V_27 ) {
F_31 ( V_7 ) ;
return - V_66 ;
}
V_53 = F_32 ( & V_7 -> V_60 , V_61 >> 12 , V_64 >> 12 ,
V_62 >> 12 ) ;
if ( V_53 ) {
F_33 ( V_7 -> V_27 ) ;
F_31 ( V_7 ) ;
...
if ( ! V_71 )
return 0 ;
V_46 = F_27 ( sizeof( * V_46 ) , V_65 ) ;
if ( ! V_46 )
return - V_66 ;
F_15 ( V_71 , & V_46 -> V_28 ) ;
F_16 ( & F_14 ( V_9 ) -> V_51 ) ;
for ( V_34 = V_7 -> V_18 ; V_34 <= V_7 -> V_44 ; V_34 ++ )
V_9 -> V_50 ( V_71 , V_34 , V_7 -> V_27 [ V_34 - V_7 -> V_18 ] . V_28 ) ;
F_36 ( & V_46 -> V_72 , & V_7 -> V_67 ) ;
F_13 ( & F_14 ( V_9 ) -> V_51 ) ;
return 0 ;
}
static void
...
{
struct V_6 * V_7 = F_41 ( V_75 , F_42 ( * V_7 ) , V_49 ) ;
struct V_45 * V_46 , * V_74 ;
F_38 (vpgd, tmp, &vm->pgd_list, head) {
F_37 ( V_7 , V_46 -> V_28 ) ;
}
