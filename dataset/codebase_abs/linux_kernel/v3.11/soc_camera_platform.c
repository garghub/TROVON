...
{
struct V_8 * V_9 = F_5 ( V_6 ) ;
return F_8 ( V_9 -> V_20 -> V_21 , & V_9 -> V_20 -> V_22 -> V_23 , NULL , V_19 ) ;
}
...
V_46 = F_15 ( & V_3 -> V_47 , sizeof( * V_46 ) , V_50 ) ;
if ( ! V_46 )
return - V_51 ;
V_20 = V_9 -> V_20 ;
F_16 ( V_3 , & V_46 -> V_5 ) ;
...
F_18 ( & V_46 -> V_5 , & V_53 ) ;
F_19 ( & V_46 -> V_5 , V_9 ) ;
strncpy ( V_46 -> V_5 . V_54 , F_20 ( & V_3 -> V_47 ) , V_55 ) ;
return F_21 ( & V_45 -> V_56 , & V_46 -> V_5 ) ;
}
