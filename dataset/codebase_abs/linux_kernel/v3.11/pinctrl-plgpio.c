...
struct V_67 * V_68 ;
int V_28 , V_39 , V_54 ;
V_9 = F_44 ( & V_61 -> V_64 , sizeof( * V_9 ) , V_69 ) ;
if ( ! V_9 ) {
F_42 ( & V_61 -> V_64 , L_16 ) ;
return - V_70 ;
}
V_68 = F_45 ( V_61 , V_71 , 0 ) ;
...
F_63 ( V_54 + V_9 -> V_35 , & V_86 ,
V_87 ) ;
F_64 ( V_54 + V_9 -> V_35 , V_88 ) ;
...
static int F_69 ( struct V_89 * V_64 )
{
struct V_9 * V_9 = F_70 ( V_64 ) ;
int V_54 , V_90 = F_32 ( V_9 -> V_8 . V_24 , V_56 ) ;
void T_2 * V_91 ;
for ( V_54 = 0 ; V_54 < V_90 ; V_54 ++ ) {
V_91 = V_9 -> V_1 + V_54 * sizeof( int * ) ;
if ( V_9 -> V_16 . V_31 != - 1 )
V_9 -> V_72 [ V_54 ] . V_31 =
F_4 ( V_9 -> V_16 . V_31 + V_91 ) ;
if ( V_9 -> V_16 . V_44 != - 1 )
V_9 -> V_72 [ V_54 ] . V_44 =
F_4 ( V_9 -> V_16 . V_44 + V_91 ) ;
V_9 -> V_72 [ V_54 ] . V_23 = F_4 ( V_9 -> V_16 . V_23 +
V_91 ) ;
V_9 -> V_72 [ V_54 ] . V_17 = F_4 ( V_9 -> V_16 . V_17 +
V_91 ) ;
V_9 -> V_72 [ V_54 ] . V_41 = F_4 ( V_9 -> V_16 . V_41 + V_91 ) ;
}
return 0 ;
}
static int F_71 ( struct V_89 * V_64 )
{
struct V_9 * V_9 = F_70 ( V_64 ) ;
int V_54 , V_90 = F_32 ( V_9 -> V_8 . V_24 , V_56 ) ;
void T_2 * V_91 ;
...
V_91 = V_9 -> V_1 + V_54 * sizeof( int * ) ;
if ( V_54 == V_90 - 1 ) {
V_92 = ( 1 << ( V_9 -> V_8 . V_24 - V_54 *
V_56 ) ) - 1 ;
if ( V_9 -> V_16 . V_31 != - 1 )
F_72 ( V_31 , V_91 , V_92 , V_21 ) ;
if ( V_9 -> V_16 . V_44 != - 1 )
F_72 ( V_44 , V_91 , V_92 , V_21 ) ;
F_72 ( V_23 , V_91 , V_92 , V_21 ) ;
F_72 ( V_17 , V_91 , V_92 , V_21 ) ;
F_72 ( V_41 , V_91 , V_92 , V_21 ) ;
}
F_6 ( V_9 -> V_72 [ V_54 ] . V_23 , V_9 -> V_16 . V_23 +
V_91 ) ;
F_6 ( V_9 -> V_72 [ V_54 ] . V_17 , V_9 -> V_16 . V_17 +
V_91 ) ;
if ( V_9 -> V_16 . V_44 != - 1 )
F_6 ( V_9 -> V_72 [ V_54 ] . V_44 ,
V_9 -> V_16 . V_44 + V_91 ) ;
F_6 ( V_9 -> V_72 [ V_54 ] . V_41 , V_9 -> V_16 . V_41 + V_91 ) ;
if ( V_9 -> V_16 . V_31 != - 1 )
F_6 ( V_9 -> V_72 [ V_54 ] . V_31 ,
V_9 -> V_16 . V_31 + V_91 ) ;
}
return 0 ;
}
