...
V_33 -> V_35 = F_9 ( sizeof( * V_33 -> V_35 ) , V_21 ) ;
if ( ! V_33 -> V_35 ) {
F_15 ( V_33 -> V_34 ) ;
F_10 ( V_33 ) ;
return - V_22 ;
...
V_33 -> V_35 -> V_56 = F_2 ( V_2 , V_28 ) ;
V_33 -> V_35 -> V_57 = F_1 ( V_2 ) ;
V_33 -> V_35 -> V_58 = 0 ;
F_37 ( V_33 -> V_34 , V_11 ,
F_4 ( V_11 , 0 ) ,
...
static inline void F_45 ( struct V_60 * V_61 )
{
...
static void F_46 ( struct V_60 * V_61 , unsigned char V_66 )
{
struct V_23 * V_24 = V_61 -> V_63 ;
if ( F_41 ( V_61 ) < 0 )
return;
...
static unsigned char F_47 ( struct V_60 * V_61 )
{
struct V_23 * V_24 = V_61 -> V_63 ;
unsigned char V_66 ;
if ( F_41 ( V_61 ) < 0 )
...
static void F_48 ( struct V_60 * V_61 , unsigned char V_66 )
{
struct V_23 * V_24 = V_61 -> V_63 ;
T_2 V_9 ;
if ( F_41 ( V_61 ) < 0 )
...
static unsigned char F_49 ( struct V_60 * V_61 )
{
struct V_23 * V_24 = V_61 -> V_63 ;
T_2 V_70 ;
F_32 ( & V_62 ) ;
...
static void F_57 ( struct V_75 * V_12 ,
struct V_76 * V_77 )
{
...
static T_4 F_60 ( struct V_60 * V_61 ,
const void * V_84 ,
T_4 V_85 , int V_38 )
{
int V_86 ;
...
V_9 = V_34 -> V_106 ;
if ( V_34 -> V_105 ) {
F_76 ( & V_112 -> V_112 , V_9 , V_34 -> V_105 ) ;
F_77 ( & V_112 -> V_112 ) ;
}
...
{
T_5 V_125 = F_82 ( V_8 -> V_12 -> V_126 . V_121 ) ;
if ( V_125 == V_122 )
return 1 ;
return 2 ;
}
static int F_83 ( struct V_127 * V_128 , struct V_111 * V_112 )
{
struct V_7 * V_8 ;
struct V_34 * V_34 ;
struct V_116 * V_117 ;
...
if ( V_117 == NULL )
return - V_59 ;
F_85 ( V_8 -> V_12 , V_112 -> V_133 -> V_13 ) ;
...
static int F_86 ( struct V_127 * V_128 )
{
...
static void F_89 ( struct V_127 * V_128 , int V_151 )
{
struct V_111 * V_112 = V_128 -> V_148 ;
unsigned char V_9 ;
struct V_7 * V_8 ;
...
static int F_90 ( struct V_127 * V_128 )
{
struct V_111 * V_112 = V_128 -> V_148 ;
struct V_116 * V_117 ;
int V_153 = 0 ;
...
static int F_91 ( struct V_127 * V_128 , struct V_111 * V_112 ,
...
if ( F_97 ( V_128 ) ) {
unsigned char V_159 = F_98 ( V_128 ) ;
V_18 = F_91 ( V_128 , V_112 , & V_159 , 1 ) ;
if ( V_18 <= 0 )
return;
}
...
static void F_99 ( struct V_127 * V_128 )
{
struct V_111 * V_112 = V_128 -> V_148 ;
...
if ( F_97 ( V_128 ) ) {
unsigned char V_164 = F_100 ( V_128 ) ;
V_18 = F_91 ( V_128 , V_112 , & V_164 , 1 ) ;
if ( V_18 <= 0 )
return;
}
if ( V_128 -> V_160 . V_161 & V_162 ) {
...
static int F_102 ( struct V_111 * V_112 , int V_171 , int * V_172 )
{
int V_149 ;
T_1 V_173 ;
T_1 V_174 ;
...
for ( V_149 = 0 ; V_149 < F_103 ( V_176 ) ; V_149 ++ ) {
...
V_18 = F_104 ( V_117 , V_165 ) ;
if ( V_180 & V_202 )
F_110 ( V_128 , V_165 , V_165 ) ;
F_3 ( V_8 , V_130 , V_139 , 0x0c ) ;
if ( V_112 -> V_114 -> V_18 != - V_115 ) {
...
V_128 -> V_160 . V_161 , F_112 ( V_128 -> V_160 . V_186 ) ) ;
F_20 ( & V_112 -> V_12 , L_56 , V_45 ,
V_179 -> V_161 , F_112 ( V_179 -> V_186 ) ) ;
F_105 ( V_128 , V_117 , V_179 ) ;
if ( V_112 -> V_114 -> V_18 != - V_115 ) {
V_18 = F_29 ( V_112 -> V_114 , V_51 ) ;
if ( V_18 )
F_20 ( & V_112 -> V_12 , L_53 , V_18 ) ;
...
static int F_113 ( struct V_127 * V_128 ,
...
static int F_117 ( struct V_116 * V_117 , unsigned int V_226 ,
...
V_209 = V_117 -> V_143 ;
if ( F_118 ( & V_227 , V_17 , sizeof( int ) ) )
return - V_208 ;
switch ( V_226 ) {
case V_228 :
if ( V_227 & V_213 )
...
static int F_119 ( struct V_116 * V_117 ,
...
V_39 . V_239 = 5 * V_240 ;
V_39 . V_241 = 30 * V_240 ;
if ( F_114 ( V_231 , & V_39 , sizeof( * V_231 ) ) )
return - V_208 ;
return 0 ;
}
...
return F_113 ( V_128 , V_117 ,
( unsigned int T_6 * ) V_227 ) ;
case V_228 :
case V_229 :
F_20 ( & V_112 -> V_12 , L_60 , V_45 ) ;
return F_117 ( V_117 , V_226 ,
( unsigned int T_6 * ) V_227 ) ;
case V_243 :
...
T_5 V_125 ;
int V_37 ;
V_125 = F_82 ( V_8 -> V_12 -> V_126 . V_121 ) ;
V_12 = V_8 -> V_12 ;
if ( V_125 == V_122 ) {
...
static int F_130 ( struct V_111 * V_112 )
{
struct V_116 * V_117 ;
V_117 = F_64 ( sizeof( * V_117 ) , V_21 ) ;
if ( ! V_117 )
return - V_22 ;
V_112 -> V_247 =
