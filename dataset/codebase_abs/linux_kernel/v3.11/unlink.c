...
static void F_58 ( struct V_17 * V_18 , void * V_19 )
{
struct V_60 * V_2 = V_19 ;
F_14 ( V_2 -> V_61 ) -> F_59 ( V_18 , V_2 ) ;
}
static struct V_17 *
F_60 ( struct V_12 * V_61 , struct V_12 * V_62 ,
struct V_6 * V_63 , struct V_6 * V_65 )
{
struct V_60 * V_2 ;
struct V_24 V_25 = { } ;
struct V_30 V_31 = {
...
F_27 ( V_61 -> V_22 ) ;
F_14 ( V_2 -> V_61 ) -> F_65 ( & V_25 , V_61 ) ;
return F_32 ( & V_31 ) ;
}
int
F_66 ( struct V_12 * V_3 , struct V_6 * V_6 )
{
static unsigned int V_71 ;
const int V_72 = sizeof( F_67 ( V_6 -> V_43 ) ) * 2 ;
...
sprintf ( V_75 , L_3 ,
V_72 , V_72 ,
( unsigned long long ) F_67 ( V_6 -> V_43 ) ) ;
F_14 ( V_6 -> V_43 ) -> F_71 ( V_6 -> V_43 ) ;
V_76 = NULL ;
do {
char * V_81 = V_75 + V_74 - V_73 ;
F_25 ( V_76 ) ;
V_71 ++ ;
sprintf ( V_81 , L_4 , V_73 , V_73 , V_71 ) ;
F_68 ( V_78 , L_5 ,
V_6 -> V_9 . V_5 , V_75 ) ;
V_76 = F_72 ( V_75 , V_6 -> V_79 , V_74 ) ;
if ( F_33 ( V_76 ) )
goto V_57;
