...
struct V_46 * V_47 ;
int V_6 ;
F_23 ( V_7 -> V_111 . V_62 , V_34 , sizeof( V_7 -> V_111 . V_62 ) ) ;
V_6 = F_52 ( NULL , & V_7 -> V_111 ) ;
if ( V_6 < 0 )
return V_6 ;
F_53 ( & V_7 -> V_10 ) ;
V_112 = F_54 () ;
...
memcpy ( V_112 , & V_114 , sizeof( V_114 ) ) ;
F_55 ( V_112 , V_7 ) ;
V_112 -> V_115 = & V_7 -> V_10 ;
V_112 -> V_111 = & V_7 -> V_111 ;
if ( F_56 ( V_112 , V_116 , V_110 ) ) {
F_57 ( V_112 ) ;
F_3 ( L_25 ) ;
return - V_113 ;
}
V_7 -> V_117 = V_112 ;
V_7 -> V_117 -> V_49 = & V_7 -> V_49 ;
V_6 = F_58 ( & V_7 -> V_49 , 5 ) ;
if ( V_6 < 0 ) {
F_3 ( L_26 ) ;
F_59 ( & V_7 -> V_49 ) ;
