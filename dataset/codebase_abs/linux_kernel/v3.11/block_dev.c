...
static inline int F_105 ( struct V_28 * V_29 )
{
return V_29 == V_107 ;
}
...
{
struct V_28 * V_211 = F_1 ( V_56 -> V_19 -> V_50 ) -> V_5 . V_113 ;
if ( V_211 && V_211 -> V_212 -> V_213 )
return V_211 -> V_212 -> V_213 ( V_211 , V_56 , V_51 ) ;
return F_182 ( V_56 ) ;
}
...
struct V_4 * F_164 ( const char * V_216 )
{
struct V_4 * V_5 ;
struct V_2 * V_2 ;
struct V_191 V_191 ;
...
if ( ! V_216 || ! * V_216 )
return F_44 ( - V_25 ) ;
error = F_186 ( V_216 , V_217 , & V_191 ) ;
if ( error )
return F_44 ( error ) ;
V_2 = V_191 . V_92 -> V_218 ;
error = - V_219 ;
if ( ! F_187 ( V_2 -> V_116 ) )
goto V_220;
error = - V_192 ;
if ( V_191 . V_221 -> V_222 & V_223 )
goto V_220;
error = - V_139 ;
V_5 = F_104 ( V_2 ) ;
if ( ! V_5 )
