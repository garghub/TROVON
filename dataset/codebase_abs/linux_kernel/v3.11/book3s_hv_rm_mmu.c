...
long F_41 ( struct V_7 * V_7 , unsigned long V_8 ,
...
if ( V_102 & V_70 ) {
V_54 [ 0 ] &= ~ V_70 ;
V_104 = F_42 ( V_102 , V_54 [ 1 ] , V_22 ) ;
if ( F_6 ( V_7 , V_8 ) ) {
while ( ! F_40 ( & V_7 -> V_10 . V_108 ) )
F_35 () ;
asm volatile("ptesync" : : : "memory");
...
long F_43 ( struct V_92 * V_93 , unsigned long V_8 ,
unsigned long V_22 , unsigned long V_100 )
{
return F_41 ( V_93 -> V_7 , V_8 , V_22 , V_100 ,
& V_93 -> V_10 . V_94 [ 4 ] ) ;
}
long F_44 ( struct V_92 * V_93 )
{
...
V_109 [ 0 ] &= ~ V_70 ;
V_111 [ V_114 ] = F_42 ( V_109 [ 0 ] , V_109 [ 1 ] , V_22 ) ;
V_116 [ V_114 ] = V_112 ;
V_110 [ V_114 ] = V_109 ;
V_120 [ V_114 ] = V_20 ;
++ V_114 ;
...
void F_48 ( struct V_7 * V_7 , unsigned long * V_128 ,
unsigned long V_22 )
{
unsigned long V_104 ;
V_128 [ 0 ] &= ~ V_70 ;
V_104 = F_42 ( V_128 [ 0 ] , V_128 [ 1 ] , V_22 ) ;
while ( ! F_40 ( & V_7 -> V_10 . V_108 ) )
F_35 () ;
asm volatile("ptesync" : : : "memory");
asm volatile(PPC_TLBIE(%1,%0)"; eieio; tlbsync"
...
long F_50 ( struct V_7 * V_7 , T_3 V_130 , unsigned long V_131 ,
unsigned long V_132 )
{
unsigned int V_26 ;
unsigned int V_133 ;
...
long F_51 ( struct V_92 * V_93 , unsigned long V_2 ,
...
if ( V_149 & V_155 )
V_132 |= V_69 ;
V_151 = F_50 ( V_7 , V_2 , V_131 , V_132 ) ;
if ( V_151 < 0 ) {
if ( V_149 & V_155 )
return V_149 ;
return 0 ;
...
unsigned int V_166 = F_54 ( V_152 , V_93 -> V_10 . V_167 ) ;
if ( V_149 & V_163 )
V_166 >>= 1 ;
if ( V_166 & 1 )
return V_149 | V_168 ;
