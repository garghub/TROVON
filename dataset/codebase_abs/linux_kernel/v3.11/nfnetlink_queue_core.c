...
return - V_213 ;
F_101 () ;
if ( V_200 [ V_214 ] && ( V_35 -> V_63 & V_106 ) )
V_86 = F_120 ( V_37 -> V_72 , V_200 [ V_214 ] , & V_89 ) ;
if ( V_200 [ V_149 ] ) {
T_7 V_215 = V_150 ( V_200 [ V_149 ] ) ;
int V_178 = V_215 - V_37 -> V_72 -> V_49 ;
if ( F_91 ( F_65 ( V_200 [ V_149 ] ) ,
V_215 , V_37 , V_178 ) < 0 )
V_202 = V_45 ;
if ( V_86 )
F_121 ( V_72 , V_86 , V_89 , V_178 ) ;
}
F_102 () ;
if ( V_200 [ V_132 ] )
V_37 -> V_72 -> V_131 = F_109 ( F_118 ( V_200 [ V_132 ] ) ) ;
...
static int
F_122 ( struct V_208 * V_209 , struct V_46 * V_72 ,
const struct V_77 * V_78 ,
const struct V_73 * const V_200 [] )
{
return - V_216 ;
...
static int
F_123 ( struct V_208 * V_209 , struct V_46 * V_72 ,
const struct V_77 * V_78 ,
const struct V_73 * const V_200 [] )
{
struct V_79 * V_80 = F_62 ( V_78 ) ;
...
V_63 = F_109 ( F_118 ( V_200 [ V_230 ] ) ) ;
V_231 = F_109 ( F_118 ( V_200 [ V_232 ] ) ) ;
if ( V_63 >= V_233 ) {
V_165 = - V_234 ;
goto V_162;
}
...
static struct V_194 * F_124 ( struct V_235 * V_236 )
{
...
if ( ! F_126 ( & V_7 -> V_11 [ V_238 -> V_240 ] ) )
return V_7 -> V_11 [ V_238 -> V_240 ] . V_241 ;
}
return NULL ;
}
static struct V_194 * F_127 ( struct V_235 * V_236 , struct V_194 * V_13 )
{
struct V_237 * V_238 = V_236 -> V_239 ;
struct V_2 * V_2 = F_125 ( V_236 ) ;
V_13 = V_13 -> V_44 ;
while ( ! V_13 ) {
struct V_1 * V_7 ;
if ( ++ V_238 -> V_240 >= V_5 )
...
static struct V_194 * F_128 ( struct V_235 * V_236 , T_8 V_242 )
{
struct V_194 * V_9 ;
V_9 = F_124 ( V_236 ) ;
if ( V_9 )
while ( V_242 && ( V_9 = F_127 ( V_236 , V_9 ) ) )
V_242 -- ;
return V_242 ? NULL : V_9 ;
}
static void * F_129 ( struct V_235 * V_243 , T_8 * V_242 )
__acquires( nfnl_queue_pernet( seq_file_net( V_243 )
static void * F_130 ( struct V_235 * V_243 , void * V_244 , T_8 * V_242 )
{
( * V_242 ) ++ ;
return F_127 ( V_243 , V_244 ) ;
}
static void F_131 ( struct V_235 * V_243 , void * V_244 )
__releases( nfnl_queue_pernet( seq_file_net( V_243 )
static int F_132 ( struct V_235 * V_243 , void * V_244 )
{
const struct V_6 * V_10 = V_244 ;
return F_133 ( V_243 , L_5 ,
V_10 -> V_4 ,
V_10 -> V_20 , V_10 -> V_39 ,
V_10 -> V_25 , V_10 -> V_23 ,
...
static int F_134 ( struct V_245 * V_245 , struct V_246 * V_246 )
{
return F_135 ( V_245 , V_246 , & V_247 ,
sizeof( struct V_237 ) ) ;
}
