...
V_2 -> V_203 = V_216 ;
V_4 = F_2 ( V_2 -> V_5 , V_219 ) ;
V_4 &= ~ ( V_220 ) ;
if ( V_2 -> V_17 < V_221 )
V_4 |= V_222 ;
else
V_4 |= V_2 -> V_223 ;
F_3 ( V_2 -> V_5 , V_219 , V_4 ) ;
V_2 -> V_95 = false ;
V_224 . V_128 = F_115 ( 512 ) ;
V_35 = V_2 -> V_36 [ 0 ] ;
V_113 = F_51 ( V_35 , & V_224 , NULL , false ) ;
if ( V_113 ) {
...
V_2 -> V_226 = V_227 ;
F_116 ( V_2 ) ;
V_217 = F_117 ( F_118 ( V_2 -> V_23 ) , 0 ) ;
V_113 = F_119 ( V_217 , V_228 , V_229 ,
V_230 | V_231 , L_56 , V_2 ) ;
if ( V_113 ) {
F_34 ( V_2 -> V_23 , L_57 ,
V_217 , V_113 ) ;
goto V_225;
...
static int F_120 ( struct V_184 * V_185 ,
struct V_215 * V_216 )
{
struct V_1 * V_2 = F_104 ( V_185 ) ;
unsigned long V_41 ;
...
V_35 -> V_43 . V_45 = 512 ;
V_35 -> V_43 . V_103 = 1 ;
V_35 -> V_43 . V_232 = & V_233 ;
if ( ! V_135 )
V_2 -> V_61 . V_234 = & V_35 -> V_43 ;
} else {
int V_113 ;
V_35 -> V_43 . V_45 = 1024 ;
V_35 -> V_43 . V_235 = 15 ;
V_35 -> V_43 . V_232 = & V_236 ;
F_95 ( & V_35 -> V_43 . V_237 ,
& V_2 -> V_61 . V_237 ) ;
V_113 = F_32 ( V_35 ) ;
if ( V_113 )
return V_113 ;
...
{
int V_113 ;
F_123 ( & V_2 -> V_61 . V_237 ) ;
V_113 = F_122 ( V_2 , V_2 -> V_238 , 0 ) ;
if ( V_113 < 0 ) {
F_8 ( V_2 -> V_23 , L_59 ) ;
return V_113 ;
}
V_113 = F_122 ( V_2 , V_2 -> V_239 , 1 ) ;
if ( V_113 < 0 ) {
F_8 ( V_2 -> V_23 , L_60 ) ;
return V_113 ;
}
...
F_34 ( V_2 -> V_23 , L_61 ,
V_35 -> V_46 , V_58 ) ;
V_240 = V_58 -> V_143 & V_243 ;
if ( V_35 -> V_62 ) {
if ( V_240 ) {
V_242 = F_127 ( V_58 -> V_143 ) ;
if ( V_242 == V_244 ) {
F_19 ( V_2 -> V_23 , L_62 ,
V_35 -> V_46 ) ;
V_35 -> V_41 |= V_175 ;
...
if ( V_240 && ( V_172 -> V_49 & V_245 ) )
V_241 = 1 ;
}
V_48 -> V_55 . V_63 += V_48 -> V_55 . V_64 - V_240 ;
if ( V_241 )
return 1 ;
if ( ( V_172 -> V_49 & V_246 ) &&
( V_58 -> V_119 & ( V_152 |
...
V_50 = 0 ;
do {
V_248 = V_48 -> V_142 + V_50 ;
if ( ( V_248 == V_54 - 1 ) &&
F_13 ( V_35 -> V_43 . V_44 ) )
V_248 ++ ;
V_248 %= V_54 ;
V_58 = & V_35 -> V_91 [ V_248 ] ;
...
if ( V_172 -> V_49 & V_250 )
V_49 = - V_179 ;
V_249 = F_128 ( V_2 , V_35 , V_172 , V_49 ) ;
if ( V_249 )
V_35 -> V_41 &= ~ V_165 ;
if ( V_2 -> V_17 < V_251 ) {
T_1 V_4 ;
...
{
struct V_34 * V_35 ;
T_2 V_135 = V_172 -> V_253 ;
V_35 = V_2 -> V_36 [ V_135 ] ;
if ( ! ( V_35 -> V_41 & V_42 ) )
return;
F_8 ( V_2 -> V_23 , L_63 , V_35 -> V_46 ,
F_131 ( V_172 -> V_254 ) ) ;
if ( V_135 == 0 || V_135 == 1 ) {
F_132 ( V_2 , V_172 ) ;
return;
...
{
if ( V_2 -> V_203 && V_2 -> V_203 -> V_264 ) {
F_20 ( & V_2 -> V_65 ) ;
V_2 -> V_203 -> V_264 ( & V_2 -> V_61 ) ;
F_21 ( & V_2 -> V_65 ) ;
}
}
...
F_133 ( V_2 ) ;
V_2 -> V_95 = false ;
V_2 -> V_61 . V_100 = V_270 ;
V_2 -> V_271 = false ;
}
static void F_137 ( struct V_1 * V_2 , int V_272 )
{
T_1 V_4 ;
V_4 = F_2 ( V_2 -> V_5 , F_138 ( 0 ) ) ;
if ( V_272 )
V_4 |= V_273 ;
else
V_4 &= ~ V_273 ;
F_3 ( V_2 -> V_5 , F_138 ( 0 ) , V_4 ) ;
}
static void F_139 ( struct V_1 * V_2 , int V_272 )
{
T_1 V_4 ;
V_4 = F_2 ( V_2 -> V_5 , F_140 ( 0 ) ) ;
if ( V_272 )
V_4 |= V_274 ;
else
V_4 &= ~ V_274 ;
F_3 ( V_2 -> V_5 , F_140 ( 0 ) , V_4 ) ;
}
...
F_142 ( & V_2 -> V_61 , V_276 ) ;
if ( V_2 -> V_17 < V_18 ) {
F_139 ( V_2 , false ) ;
F_137 ( V_2 , false ) ;
}
if ( V_2 -> V_61 . V_100 != V_270 )
F_133 ( V_2 ) ;
V_4 = F_2 ( V_2 -> V_5 , V_6 ) ;
V_4 &= ~ V_7 ;
F_3 ( V_2 -> V_5 , V_6 , V_4 ) ;
...
if ( ! V_279 )
return;
V_4 = F_2 ( V_2 -> V_5 , V_281 ) ;
V_4 |= F_144 ( V_279 ) ;
F_3 ( V_2 -> V_5 , V_281 , V_4 ) ;
}
static void F_145 ( struct V_1 * V_2 , T_2 V_100 )
{
switch ( V_100 ) {
case V_101 :
F_139 ( V_2 , true ) ;
...
F_141 ( V_2 ) ;
V_224 . V_128 = F_115 ( 512 ) ;
V_2 -> V_61 . V_234 -> V_45 = 512 ;
V_2 -> V_61 . V_100 = V_101 ;
break;
case V_286 :
V_224 . V_128 = F_115 ( 64 ) ;
V_2 -> V_61 . V_234 -> V_45 = 64 ;
V_2 -> V_61 . V_100 = V_282 ;
break;
case V_287 :
case V_288 :
V_224 . V_128 = F_115 ( 64 ) ;
V_2 -> V_61 . V_234 -> V_45 = 64 ;
V_2 -> V_61 . V_100 = V_283 ;
break;
case V_289 :
V_224 . V_128 = F_115 ( 8 ) ;
V_2 -> V_61 . V_234 -> V_45 = 8 ;
V_2 -> V_61 . V_100 = V_284 ;
break;
}
if ( ( V_2 -> V_17 > V_18 )
&& ( V_100 != V_222 ) ) {
...
if ( V_2 -> V_17 < V_18 ) {
F_145 ( V_2 , V_2 -> V_61 . V_100 ) ;
}
V_35 = V_2 -> V_36 [ 0 ] ;
V_113 = F_51 ( V_35 , & V_224 , NULL , true ) ;
if ( V_113 ) {
F_34 ( V_2 -> V_23 , L_55 , V_35 -> V_46 ) ;
return;
}
...
{
F_8 ( V_2 -> V_23 , L_74 , V_267 ) ;
V_2 -> V_203 -> V_293 ( & V_2 -> V_61 ) ;
}
static void F_149 ( struct V_1 * V_2 ,
unsigned int V_294 )
{
enum V_14 V_295 = V_294 & V_296 ;
unsigned int V_297 ;
V_297 = F_150 ( V_2 -> V_30 . V_298 ) ;
if ( ( V_2 -> V_17 < V_299 ) &&
( V_297 != V_300 ) ) {
if ( ( V_2 -> V_186 == V_190 ) &&
( V_295 == V_301 ) ) {
...
V_2 -> V_186 = V_295 ;
F_8 ( V_2 -> V_23 , L_76 , V_267 , V_2 -> V_186 ) ;
}
static void F_151 ( struct V_1 * V_2 ,
const struct V_306 * V_172 )
{
switch ( V_172 -> type ) {
case V_307 :
F_136 ( V_2 ) ;
...
break;
default:
F_19 ( V_2 -> V_23 , L_82 , V_172 -> type ) ;
}
}
static void F_152 ( struct V_1 * V_2 ,
const union V_318 * V_172 )
{
if ( V_172 -> type . V_319 == 0 ) {
return F_130 ( V_2 , & V_172 -> V_320 ) ;
}
switch ( V_172 -> type . type ) {
case V_321 :
F_151 ( V_2 , & V_172 -> V_322 ) ;
break;
default:
F_34 ( V_2 -> V_23 , L_83 , V_172 -> V_323 ) ;
}
}
static T_6 V_229 ( int V_217 , void * V_324 )
{
...
int V_50 ;
F_67 ( & V_2 -> V_65 , V_41 ) ;
for ( V_50 = 0 ; V_50 < V_2 -> V_326 ; V_50 ++ ) {
struct V_327 * V_328 ;
int V_329 ;
V_328 = V_2 -> V_330 [ V_50 ] ;
V_329 = V_328 -> V_240 ;
if ( ! ( V_328 -> V_41 & V_331 ) )
continue;
while ( V_329 > 0 ) {
union V_318 V_172 ;
V_172 . V_323 = * ( T_1 * ) ( V_328 -> V_332 + V_328 -> V_333 ) ;
F_152 ( V_2 , & V_172 ) ;
V_328 -> V_333 = ( V_328 -> V_333 + 4 ) % V_334 ;
V_329 -= 4 ;
F_3 ( V_2 -> V_5 , F_153 ( V_50 ) , 4 ) ;
}
V_328 -> V_240 = 0 ;
V_328 -> V_41 &= ~ V_331 ;
V_113 = V_335 ;
...
struct V_327 * V_328 ;
T_1 V_240 ;
V_328 = V_2 -> V_330 [ V_332 ] ;
V_240 = F_2 ( V_2 -> V_5 , F_153 ( V_332 ) ) ;
V_240 &= V_336 ;
if ( ! V_240 )
return V_325 ;
V_328 -> V_240 = V_240 ;
...
static T_6 V_228 ( int V_217 , void * V_324 )
{
struct V_1 * V_2 = V_324 ;
int V_50 ;
T_6 V_113 = V_325 ;
...
T_1 V_4 ;
int V_113 ;
V_2 -> V_338 = F_33 ( V_2 -> V_23 , sizeof( * V_2 -> V_338 ) ,
& V_2 -> V_339 , V_93 ) ;
if ( ! V_2 -> V_338 ) {
F_34 ( V_2 -> V_23 , L_84 ) ;
V_113 = - V_94 ;
...
V_2 -> V_342 = F_71 ( V_343 , V_93 ) ;
if ( ! V_2 -> V_342 ) {
F_34 ( V_2 -> V_23 , L_86 ) ;
V_113 = - V_94 ;
goto V_344;
}
V_2 -> V_345 = F_33 ( V_2 -> V_23 ,
V_343 , & V_2 -> V_346 ,
V_93 ) ;
if ( ! V_2 -> V_345 ) {
F_34 ( V_2 -> V_23 , L_87 ) ;
...
V_2 -> V_340 , V_2 -> V_341 ) ;
V_225:
F_36 ( V_2 -> V_23 , sizeof( * V_2 -> V_338 ) ,
V_2 -> V_338 , V_2 -> V_339 ) ;
V_218:
return V_113 ;
}
