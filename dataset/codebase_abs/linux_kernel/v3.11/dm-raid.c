...
F_74 ( L_98 ,
( strcmp ( V_14 -> V_20 . V_173 , L_88 ) ) ? 0 :
( unsigned long long )
F_75 ( & V_14 -> V_20 . V_174 ) ) ;
break;
case V_175 :
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ ) {
if ( ( V_14 -> V_71 & V_75 ) &&
...
V_14 -> V_20 . V_54 . V_79 ) ;
if ( V_14 -> V_71 & V_83 ) {
struct V_176 * V_177 = V_14 -> V_20 . V_141 ;
F_74 ( L_108 ,
V_177 ? V_177 -> V_178 * 2 : 0 ) ;
}
if ( V_14 -> V_71 & V_89 )
F_74 ( L_109 ,
...
if ( ! V_37 -> V_150 || ! V_37 -> V_150 -> V_179 )
return - V_16 ;
...
static void F_81 ( struct V_11 * V_12 , struct V_187 * V_188 )
{
struct V_10 * V_14 = V_12 -> V_141 ;
unsigned V_189 = V_14 -> V_20 . V_53 << 9 ;
struct V_176 * V_177 = V_14 -> V_20 . V_141 ;
F_82 ( V_188 , V_189 ) ;
F_83 ( V_188 , V_189 * ( V_177 -> V_21 - V_177 -> V_190 ) ) ;
}
...
static void F_87 ( struct V_10 * V_14 )
{
int V_8 ;
T_2 V_103 , V_191 = 0 ;
unsigned long V_41 ;
...
struct V_99 * V_127 ;
for ( V_8 = 0 ; V_8 < V_14 -> V_20 . V_21 ; V_8 ++ ) {
V_127 = & V_14 -> V_17 [ V_8 ] . V_28 ;
if ( F_19 ( V_106 , & V_127 -> V_41 ) && V_127 -> V_39 &&
F_43 ( V_127 , 0 , V_127 -> V_121 , V_127 -> V_39 , V_102 , 1 ) ) {
F_24 ( L_115
L_116 ,
V_14 -> V_6 -> V_7 , V_8 ) ;
if ( ( V_127 -> V_35 >= 0 ) &&
( V_127 -> V_37 -> V_150 -> V_192 ( V_127 -> V_37 , V_127 ) != 0 ) )
continue;
V_127 -> V_35 = V_8 ;
V_127 -> V_132 = V_8 ;
V_41 = V_127 -> V_41 ;
F_30 ( V_106 , & V_127 -> V_41 ) ;
F_30 ( V_193 , & V_127 -> V_41 ) ;
F_30 ( V_40 , & V_127 -> V_41 ) ;
if ( V_127 -> V_37 -> V_150 -> V_194 ( V_127 -> V_37 , V_127 ) ) {
V_127 -> V_35 = - 1 ;
V_127 -> V_132 = - 1 ;
V_127 -> V_41 = V_41 ;
} else {
