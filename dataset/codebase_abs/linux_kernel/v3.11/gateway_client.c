...
static bool F_48 ( struct V_75 * V_76 , int V_77 )
{
int V_61 = false ;
unsigned char * V_78 ;
int V_79 ;
...
bool F_51 ( struct V_75 * V_76 , unsigned int * V_77 )
{
struct V_83 * V_83 ;
struct V_84 * V_84 ;
struct V_85 * V_85 ;
struct V_86 * V_86 ;
if ( ! F_52 ( V_76 , * V_77 + V_87 ) )
return false ;
V_83 = (struct V_83 * ) V_76 -> V_81 ;
* V_77 += V_87 ;
if ( F_53 ( V_83 -> V_88 ) == V_89 ) {
if ( ! F_52 ( V_76 , * V_77 + V_90 ) )
return false ;
V_83 = (struct V_83 * ) ( V_76 -> V_81 + V_90 ) ;
* V_77 += V_90 ;
}
switch ( F_53 ( V_83 -> V_88 ) ) {
case V_91 :
if ( ! F_52 ( V_76 , * V_77 + sizeof( * V_84 ) ) )
return false ;
...
* V_77 += sizeof( * V_86 ) ;
if ( ( F_53 ( V_83 -> V_88 ) == V_91 ) &&
( F_53 ( V_86 -> V_97 ) != 67 ) )
return false ;
if ( ( F_53 ( V_83 -> V_88 ) == V_95 ) &&
( F_53 ( V_86 -> V_97 ) != 547 ) )
return false ;
return true ;
}
bool F_54 ( struct V_5 * V_6 ,
struct V_75 * V_76 )
{
