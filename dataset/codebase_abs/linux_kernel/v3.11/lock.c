...
static struct V_18 * F_281 ( struct V_29 * V_30 , int V_55 )
{
struct V_75 * V_140 ;
struct V_18 * V_19 ;
F_38 ( & V_30 -> V_57 [ V_55 ] . V_58 ) ;
...
static struct V_4 * F_283 ( struct V_164 * V_166 , int V_187 ,
T_1 V_391 )
{
struct V_4 * V_5 ;
F_7 (lkb, head, lkb_statequeue) {
...
static struct V_4 * F_284 ( struct V_18 * V_19 , int V_187 ,
T_1 V_391 )
{
struct V_4 * V_5 ;
V_5 = F_283 ( & V_19 -> V_79 , V_187 , V_391 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_283 ( & V_19 -> V_80 , V_187 , V_391 ) ;
if ( V_5 )
return V_5 ;
V_5 = F_283 ( & V_19 -> V_81 , V_187 , V_391 ) ;
if ( V_5 )
return V_5 ;
return NULL ;
}
static int F_285 ( struct V_29 * V_30 , struct V_4 * V_5 ,
struct V_18 * V_19 , struct V_392 * V_88 )
{
struct V_393 * V_394 = (struct V_393 * ) V_88 -> V_395 ;
V_5 -> V_7 = V_88 -> V_396 . V_210 ;
V_5 -> V_307 = F_286 ( V_394 -> V_397 ) ;
V_5 -> V_9 = F_286 ( V_394 -> V_398 ) ;
V_5 -> V_10 = F_286 ( V_394 -> V_399 ) ;
V_5 -> V_11 = F_286 ( V_394 -> V_400 ) & 0x0000FFFF ;
V_5 -> V_11 |= V_38 ;
V_5 -> V_245 = F_286 ( V_394 -> V_401 ) ;
...
int F_288 ( struct V_29 * V_30 , struct V_392 * V_88 )
{
struct V_393 * V_394 = (struct V_393 * ) V_88 -> V_395 ;
struct V_18 * V_19 ;
struct V_4 * V_5 ;
...
V_391 = F_286 ( V_394 -> V_398 ) ;
error = F_67 ( V_30 , V_394 -> V_411 , F_289 ( V_394 -> V_412 ) ,
V_101 , V_122 , & V_19 ) ;
if ( error )
goto V_111;
F_73 ( V_19 ) ;
...
if ( error )
goto V_114;
error = F_285 ( V_30 , V_5 , V_19 , V_88 ) ;
if ( error ) {
F_97 ( V_30 , V_5 ) ;
goto V_114;
}
...
F_46 ( V_30 , L_126 ,
V_101 , V_391 , error ) ;
V_394 -> V_416 = F_290 ( error ) ;
return error ;
}
int F_291 ( struct V_29 * V_30 , struct V_392 * V_88 )
{
struct V_393 * V_394 = (struct V_393 * ) V_88 -> V_395 ;
struct V_18 * V_19 ;
struct V_4 * V_5 ;
T_1 V_161 , V_391 ;
int error , V_126 ;
V_161 = F_286 ( V_394 -> V_398 ) ;
V_391 = F_286 ( V_394 -> V_415 ) ;
V_126 = F_286 ( V_394 -> V_416 ) ;
error = F_94 ( V_30 , V_161 , & V_5 ) ;
if ( error ) {
F_60 ( V_30 , L_127 ,
...
int F_294 ( struct V_29 * V_30 , struct V_417 * V_418 ,
...
int F_295 ( struct V_29 * V_30 , struct V_417 * V_424 ,
...
F_38 ( & V_418 -> V_421 -> V_422 ) ;
if ( ! F_6 ( & V_5 -> V_150 ) )
F_297 ( & V_5 -> V_150 , & V_418 -> V_421 -> V_433 ) ;
F_40 ( & V_418 -> V_421 -> V_422 ) ;
V_315:
F_100 ( V_5 ) ;
V_111:
...
void F_303 ( struct V_29 * V_30 , struct V_437 * V_421 )
{
struct V_4 * V_5 , * V_286 ;
F_8 ( V_30 ) ;
while ( 1 ) {
V_5 = F_302 ( V_30 , V_421 ) ;
if ( ! V_5 )
break;
F_29 ( V_5 ) ;
if ( V_5 -> V_10 & V_439 )
...
static void F_304 ( struct V_29 * V_30 , struct V_437 * V_421 )
{
struct V_4 * V_5 , * V_286 ;
while ( 1 ) {
V_5 = NULL ;
...
static int F_305 ( struct V_29 * V_30 , int V_187 , int V_309 )
{
struct V_204 * V_205 ;
struct V_318 * V_320 ;
int error ;
...
int F_306 ( struct V_29 * V_30 , struct V_437 * V_421 ,
int V_187 , int V_309 )
{
int error = 0 ;
if ( V_187 != F_59 () ) {
error = F_305 ( V_30 , V_187 , V_309 ) ;
} else {
F_8 ( V_30 ) ;
