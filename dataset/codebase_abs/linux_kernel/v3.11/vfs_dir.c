...
int V_31 = 0 ;
struct V_17 * V_24 ;
F_6 ( V_32 , L_1 , V_18 -> V_33 . V_34 -> V_35 . V_12 ) ;
V_22 = V_18 -> V_23 ;
...
F_6 ( V_32 , L_1 , V_18 -> V_33 . V_34 -> V_35 . V_12 ) ;
V_22 = V_18 -> V_23 ;
V_20 = V_22 -> V_36 -> V_37 - V_49 ;
V_24 = F_3 ( V_18 , V_20 ) ;
if ( ! V_24 )
return - V_39 ;
while ( 1 ) {
if ( V_24 -> V_40 == V_24 -> V_41 ) {
V_30 = F_13 ( V_22 , V_24 -> V_42 , V_20 ,
V_27 -> V_43 ) ;
if ( V_30 <= 0 )
return V_30 ;
V_24 -> V_41 = 0 ;
...
while ( V_24 -> V_41 < V_24 -> V_40 ) {
V_30 = F_14 ( V_22 -> V_36 , V_24 -> V_42 + V_24 -> V_41 ,
V_24 -> V_40 - V_24 -> V_41 ,
& V_48 ) ;
if ( V_30 < 0 ) {
F_6 ( V_32 , L_2 , V_30 ) ;
...
int F_15 ( struct V_52 * V_52 , struct V_18 * V_19 )
{
struct V_21 * V_22 ;
V_22 = V_19 -> V_23 ;
F_6 ( V_32 , L_3 ,
V_52 , V_19 , V_22 ? V_22 -> V_22 : - 1 ) ;
if ( V_22 )
F_16 ( V_22 ) ;
return 0 ;
}
