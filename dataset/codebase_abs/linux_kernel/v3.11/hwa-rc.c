...
struct V_118 * V_93 = F_30 ( V_117 ) ;
struct V_13 * V_14 = & V_117 -> V_14 ;
int V_64 ;
struct V_119 * V_120 ;
V_120 = & V_117 -> V_99 -> V_121 [ 0 ] . V_100 ;
V_91 -> V_122 = ( void * ) F_31 ( V_62 ) ;
if ( V_91 -> V_122 == NULL ) {
F_3 ( V_14 , L_26 ) ;
goto V_123;
}
V_91 -> V_124 = F_32 ( 0 , V_62 ) ;
if ( V_91 -> V_124 == NULL ) {
F_3 ( V_14 , L_27 ) ;
goto V_125;
}
F_33 ( V_91 -> V_124 , V_93 ,
F_34 ( V_93 , V_120 -> V_126 ) ,
V_91 -> V_122 , V_127 ,
F_21 , V_91 , V_120 -> V_128 ) ;
V_64 = F_24 ( V_91 -> V_124 , V_19 ) ;
if ( V_64 < 0 ) {
F_3 ( V_14 , L_28 , V_64 ) ;
goto V_129;
}
...
static int F_42 ( struct V_104 * V_117 ,
...
F_27 ( V_91 ) ;
V_91 -> V_93 = F_44 ( F_30 ( V_117 ) ) ;
V_91 -> V_98 = F_45 ( V_117 ) ;
V_91 -> V_1 = V_1 ;
V_1 -> V_150 = V_151 ;
V_1 -> V_152 = F_29 ;
V_1 -> V_153 = F_37 ;
...
static void F_52 ( struct V_104 * V_117 )
{
struct V_91 * V_91 = F_53 ( V_117 ) ;
...
static int F_55 ( struct V_104 * V_117 )
{
struct V_91 * V_91 = F_53 ( V_117 ) ;
struct V_1 * V_1 = V_91 -> V_1 ;
F_56 ( V_1 ) ;
