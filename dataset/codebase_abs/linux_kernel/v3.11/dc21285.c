...
V_44 -> V_53 = V_54 ;
F_24 ( & V_44 -> V_55 , & V_46 [ 0 ] , V_44 -> V_53 ) ;
F_24 ( & V_44 -> V_55 , & V_46 [ 1 ] , V_44 -> V_53 ) ;
return 1 ;
}
void T_3 F_25 ( void )
{
...
V_59 = 0x81000000 ;
V_60 = V_61 ;
V_56 = ( unsigned int ) V_62 - V_63 ;
for ( V_57 = 0x00100000 ; V_57 < 0x10000000 ; V_57 <<= 1 )
if ( V_57 >= V_56 )
break;
* V_64 = ( V_57 - 1 ) & 0x0ffc0000 ;
* V_65 = 0 ;
* V_66 = 0x80000000 ;
* V_67 = 0 ;
* V_68 = 0 ;
