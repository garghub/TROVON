...
V_63:
F_4 ( L_19 ) ;
V_32 = F_42 ( V_51 , V_19 -> V_34 , V_51 -> V_14 ,
V_53 ) ;
if ( V_32 < 0 ) {
if ( V_32 == - V_59 ) {
F_30 ( V_51 ) ;
...
struct V_71 , V_72 ) ;
F_3 ( L_37 ,
V_8 -> V_20 . V_102 , F_51 ( & V_19 -> V_19 . V_103 ) ,
* V_97 ) ;
if ( ! V_8 -> V_26 )
goto V_104;
V_101 = 1 ;
if ( F_47 ( V_72 , 0 , * V_97 ) < 0 )
V_101 = 0 ;
V_73 = V_8 -> V_26 -> V_27 ;
ASSERT ( F_46 ( V_73 -> V_78 ) ) ;
ASSERT ( V_73 -> V_28 -> V_38 -> V_79 ) ;
...
( * V_97 ) -- ;
V_99 ++ ;
} else if ( V_101 && F_53 ( & V_44 , V_11 ) == 0 ) {
F_54 ( V_19 , & V_44 ) ;
F_32 ( V_19 , 1 ) ;
V_32 = - V_35 ;
} else {
...
int F_59 ( struct V_106 * V_19 , struct V_11 * V_11 )
{
struct V_7 * V_8 ;
struct V_71 * V_72 ;
T_4 V_107 ;
...
ASSERT ( F_46 ( V_8 -> V_26 -> V_27 -> V_78 ) ) ;
V_72 = F_2 ( V_8 -> V_20 . V_72 ,
struct V_71 , V_72 ) ;
V_109 . V_114 = V_72 -> V_114 ;
V_109 . V_115 = V_8 -> V_26 ;
V_108 = F_60 ( & V_109 , V_116 | V_117 , V_72 -> V_118 ) ;
if ( F_61 ( V_108 ) ) {
V_32 = F_62 ( V_108 ) ;
} else {
V_32 = - V_36 ;
...
void F_71 ( struct V_125 * V_126 , struct V_11 * V_11 )
{
struct V_7 * V_8 ;
struct V_71 * V_72 ;
