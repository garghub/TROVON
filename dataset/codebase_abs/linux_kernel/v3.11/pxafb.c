...
static void F_66 ( struct V_1 * V_2 , struct V_118 * V_119 ,
int V_169 )
{
...
static int F_71 ( struct V_1 * V_187 ,
struct V_118 * V_119 )
{
...
static T_5 F_127 ( int V_295 , void * V_296 )
{
...
static struct V_1 * F_140 ( struct V_200 * V_91 )
{
struct V_1 * V_2 ;
void * V_341 ;
...
static int F_147 ( struct V_200 * V_91 , const char * V_352 )
{
struct V_58 * V_90 = V_91 -> V_92 ;
...
static int F_150 ( struct V_200 * V_91 , char * V_352 )
{
struct V_58 * V_90 = V_91 -> V_92 ;
struct V_57 * V_60 = & V_90 -> V_62 [ 0 ] ;
char V_359 [ 64 ] ;
...
static int F_152 ( struct V_200 * V_91 , char * V_372 )
{
char * V_352 ;
int V_37 ;
if ( ! V_372 || ! * V_372 )
...
static void F_158 ( struct V_200 * V_91 , struct V_58 * V_90 )
{
if ( V_90 -> V_321 )
return;
if ( V_90 -> V_81 & V_374 )
...
static int F_160 ( struct V_376 * V_91 )
{
struct V_1 * V_2 ;
struct V_58 * V_90 ;
struct V_377 * V_378 ;
...
static int F_175 ( struct V_376 * V_91 )
{
