...
V_66 = F_67 ( ( T_2 ) ( V_68 ) V_30 * ( T_2 ) ( V_68 ) V_64 , ( V_68 ) V_65 ) ;
return ( V_26 T_3 ) V_66 ;
}
static void F_68 ( struct V_46 * V_3 ,
struct V_20 * V_61 ,
T_3 * V_62 , T_3 * V_42 )
{
...
V_61 -> V_30 = F_70 ( V_61 -> V_30 , V_30 ) ;
V_61 -> V_22 = F_70 ( V_61 -> V_22 , V_22 ) ;
V_53:
* V_62 = V_61 -> V_22 ;
* V_42 = V_61 -> V_30 ;
}
...
F_68 ( & V_20 , & V_16 -> V_70 , V_62 , V_42 ) ;
}
void F_60 ( struct V_2 * V_16 , T_3 * V_62 , T_3 * V_42 )
{
struct V_46 V_20 ;
F_40 ( V_16 , & V_20 ) ;
F_68 ( & V_20 , & V_16 -> signal -> V_70 , V_62 , V_42 ) ;
}
static unsigned long long F_71 ( struct V_2 * V_45 )
{
...
static T_3 F_73 ( struct V_2 * V_45 )
{
unsigned long long V_5 = F_71 ( V_45 ) ;
F_74 ( V_45 -> V_72 == V_73 ) ;
V_45 -> V_71 += V_5 ;
return F_69 ( V_5 ) ;
}
static void F_75 ( struct V_2 * V_45 )
{
T_3 V_74 = F_73 ( V_45 ) ;
...
void F_83 ( struct V_2 * V_50 , int V_6 )
{
unsigned long V_4 ;
F_84 ( & V_50 -> V_75 , V_4 ) ;
V_50 -> V_72 = V_77 ;
...
if ( V_50 -> V_4 & V_33 )
V_27 += F_71 ( V_50 ) ;
} while ( F_88 ( & V_50 -> V_75 , V_78 ) );
return V_27 ;
}
static void
F_89 ( struct V_2 * V_50 ,
T_3 * V_79 , T_3 * V_80 ,
T_3 * V_81 , T_3 * V_82 ,
T_3 * V_83 , T_3 * V_84 )
{
