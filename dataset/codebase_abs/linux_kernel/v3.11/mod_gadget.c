...
static int F_101 ( struct V_102 * V_30 , int V_106 )
{
struct V_6 * V_7 = F_97 ( V_30 ) ;
struct V_15 * V_16 = F_61 ( V_7 ) ;
F_102 ( V_16 , V_106 ) ;
...
static int F_103 ( struct V_102 * V_30 , int V_107 )
{
struct V_6 * V_7 = F_97 ( V_30 ) ;
if ( V_107 )
F_81 ( V_7 , V_43 ) ;
...
int F_106 ( struct V_15 * V_16 )
{
struct V_6 * V_7 ;
struct V_1 * V_2 ;
struct V_10 * V_11 = F_88 ( V_16 ) ;
int V_109 = F_107 ( V_16 , V_109 ) ;
int V_110 ;
int V_28 ;
V_7 = F_71 ( sizeof( struct V_6 ) , V_111 ) ;
if ( ! V_7 ) {
F_40 ( V_11 , L_16 ) ;
return - V_112 ;
}
V_2 = F_71 ( sizeof( struct V_1 ) * V_109 , V_111 ) ;
if ( ! V_2 ) {
F_40 ( V_11 , L_17 ) ;
V_28 = - V_112 ;
goto V_113;
}
F_108 ( V_16 , & V_7 -> V_96 , V_114 ) ;
V_7 -> V_96 . V_59 = L_18 ;
V_7 -> V_96 . V_115 = F_104 ;
V_7 -> V_96 . V_116 = F_105 ;
V_7 -> V_2 = V_2 ;
V_7 -> V_117 = V_109 ;
F_109 ( V_7 ) ;
...
V_2 -> V_14 . V_127 = 512 ;
F_113 ( & V_2 -> V_14 . V_122 , & V_7 -> V_30 . V_122 ) ;
}
}
V_28 = F_114 ( V_11 , & V_7 -> V_30 ) ;
if ( V_28 )
goto V_128;
F_115 ( V_11 , L_21 ) ;
return 0 ;
