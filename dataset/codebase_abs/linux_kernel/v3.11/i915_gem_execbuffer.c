...
if ( args -> V_170 > V_171 / sizeof( * V_142 ) ) {
F_12 ( L_18 ,
args -> V_170 ) ;
return - V_29 ;
}
V_142 = F_2 ( args -> V_170 * sizeof( * V_142 ) ,
V_172 ) ;
if ( V_142 == NULL ) {
V_51 = - V_115 ;
goto V_173;
...
V_145 = args -> V_123 ;
if ( V_142 ) {
for ( V_22 = 0 ; V_22 < args -> V_170 ; V_22 ++ ) {
V_51 = F_107 ( V_46 , & V_142 [ V_22 ] ,
args -> V_181 , args -> V_182 ) ;
if ( V_51 )
goto V_110;
V_51 = V_85 -> V_183 ( V_85 ,
V_144 , V_145 ,
V_4 ) ;
if ( V_51 )
goto V_110;
...
struct V_20 * V_21 )
{
struct V_184 * args = V_139 ;
struct V_2 V_185 ;
struct V_186 * V_28 = NULL ;
struct V_18 * V_187 = NULL ;
int V_51 , V_22 ;
if ( args -> V_7 < 1 ) {
F_12 ( L_15 , args -> V_7 ) ;
return - V_29 ;
...
V_187 = F_69 ( sizeof( * V_187 ) , args -> V_7 ) ;
if ( V_28 == NULL || V_187 == NULL ) {
F_12 ( L_20 ,
args -> V_7 ) ;
F_70 ( V_28 ) ;
F_70 ( V_187 ) ;
...
for ( V_22 = 0 ; V_22 < args -> V_7 ; V_22 ++ ) {
V_187 [ V_22 ] . V_26 = V_28 [ V_22 ] . V_26 ;
V_187 [ V_22 ] . V_81 = V_28 [ V_22 ] . V_81 ;
V_187 [ V_22 ] . V_80 = V_28 [ V_22 ] . V_80 ;
V_187 [ V_22 ] . V_94 = V_28 [ V_22 ] . V_94 ;
V_187 [ V_22 ] . V_56 = V_28 [ V_22 ] . V_56 ;
if ( F_53 ( V_46 ) -> V_88 < 4 )
V_187 [ V_22 ] . V_4 = V_91 ;
else
V_187 [ V_22 ] . V_4 = 0 ;
}
V_185 . V_188 = args -> V_188 ;
V_185 . V_7 = args -> V_7 ;
V_185 . V_122 = args -> V_122 ;
V_185 . V_123 = args -> V_123 ;
V_185 . V_181 = args -> V_181 ;
V_185 . V_182 = args -> V_182 ;
V_185 . V_170 = args -> V_170 ;
V_185 . V_174 = args -> V_174 ;
V_185 . V_4 = V_157 ;
F_110 ( V_185 , 0 ) ;
V_51 = F_99 ( V_46 , V_139 , V_21 , & V_185 , V_187 ) ;
if ( ! V_51 ) {
for ( V_22 = 0 ; V_22 < args -> V_7 ; V_22 ++ )
V_28 [ V_22 ] . V_56 = V_187 [ V_22 ] . V_56 ;
V_51 = F_73 ( F_42 ( args -> V_188 ) ,
V_28 ,
sizeof( * V_28 ) * args -> V_7 ) ;
if ( V_51 ) {
V_51 = - V_63 ;
...
int V_51 ;
if ( args -> V_7 < 1 ||
args -> V_7 > V_171 / sizeof( * V_187 ) ) {
F_12 ( L_24 , args -> V_7 ) ;
return - V_29 ;
}
V_187 = F_2 ( sizeof( * V_187 ) * args -> V_7 ,
V_9 | V_10 | V_11 ) ;
if ( V_187 == NULL )
V_187 = F_69 ( sizeof( * V_187 ) ,
args -> V_7 ) ;
if ( V_187 == NULL ) {
F_12 ( L_20 ,
args -> V_7 ) ;
...
V_51 = F_99 ( V_46 , V_139 , V_21 , args , V_187 ) ;
if ( ! V_51 ) {
V_51 = F_73 ( F_42 ( args -> V_188 ) ,
V_187 ,
sizeof( * V_187 ) * args -> V_7 ) ;
