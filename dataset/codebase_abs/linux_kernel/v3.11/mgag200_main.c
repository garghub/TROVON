...
int F_48 ( struct V_15 * V_72 ,
struct V_6 * V_7 ,
T_2 V_75 )
{
return F_49 ( V_72 , V_75 ) ;
}
...
{
struct V_67 * V_67 = F_55 ( V_5 ) ;
if ( ! V_67 )
return;
F_52 ( & V_67 ) ;
}
static inline T_4 F_56 ( struct V_67 * V_80 )
{
return V_80 -> V_80 . V_83 ;
}
int
F_57 ( struct V_15 * V_72 ,
struct V_6 * V_7 ,
T_2 V_75 ,
T_5 * V_24 )
{
