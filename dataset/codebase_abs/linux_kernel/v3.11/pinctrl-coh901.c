...
static int T_2 F_41 ( struct V_72 * V_73 )
{
struct V_1 * V_5 ;
struct V_74 * V_75 ;
int V_76 = 0 ;
...
T_1 V_77 ;
int V_67 ;
V_5 = F_42 ( & V_73 -> V_25 , sizeof( struct V_1 ) , V_78 ) ;
if ( V_5 == NULL )
return - V_79 ;
V_5 -> V_3 = V_80 ;
...
V_5 -> V_3 . V_6 = 0 ;
V_5 -> V_25 = & V_73 -> V_25 ;
V_75 = F_43 ( V_73 , V_83 , 0 ) ;
V_5 -> V_6 = F_44 ( & V_73 -> V_25 , V_75 ) ;
if ( F_45 ( V_5 -> V_6 ) )
return F_46 ( V_5 -> V_6 ) ;
V_5 -> V_84 = F_47 ( V_5 -> V_25 , NULL ) ;
if ( F_45 ( V_5 -> V_84 ) ) {
V_76 = F_46 ( V_5 -> V_84 ) ;
F_20 ( V_5 -> V_25 , L_13 ) ;
return V_76 ;
...
V_18 -> V_24 = V_16 ;
V_18 -> V_5 = V_5 ;
V_18 -> V_53 = F_52 ( V_73 , V_16 ) ;
F_22 ( V_5 -> V_25 , L_20 , V_18 -> V_53 ,
V_18 -> V_51 ) ;
V_18 -> V_27 = F_53 ( V_73 -> V_25 . V_99 ,
V_82 ,
& V_100 ,
V_18 ) ;
if ( ! V_18 -> V_27 ) {
...
V_76 = F_62 ( & V_5 -> V_3 ) ;
if ( V_76 ) {
F_20 ( V_5 -> V_25 , L_23 , V_76 ) ;
goto V_106;
}
for ( V_67 = 0 ; V_67 < F_63 ( V_107 ) ; V_67 ++ ) {
struct V_108 * V_20 = & V_107 [ V_67 ] ;
V_76 = F_64 ( & V_5 -> V_3 , L_24 ,
...
F_36 ( V_5 ) ;
F_67 ( V_5 -> V_84 ) ;
F_20 ( & V_73 -> V_25 , L_26 , V_76 ) ;
return V_76 ;
}
static int T_3 F_68 ( struct V_72 * V_73 )
{
struct V_1 * V_5 = F_69 ( V_73 ) ;
int V_76 ;
F_13 ( 0x00000000U , V_5 -> V_6 + V_95 ) ;
V_76 = F_66 ( & V_5 -> V_3 ) ;
if ( V_76 < 0 ) {
F_20 ( V_5 -> V_25 , L_27 , V_76 ) ;
return V_76 ;
}
F_36 ( V_5 ) ;
F_67 ( V_5 -> V_84 ) ;
