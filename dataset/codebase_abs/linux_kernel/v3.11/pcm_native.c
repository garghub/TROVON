...
return F_258 ( V_3 -> V_410 . V_411 . V_411 ,
V_389 ,
V_3 -> V_6 -> V_407 ,
V_3 -> V_6 -> V_416 ,
...
if ( V_3 -> V_410 . V_411 . type == V_412 &&
! F_259 ( V_3 -> V_410 . V_411 . V_411 ) )
V_389 -> V_420 = F_260 ( V_389 -> V_420 ) ;
#endif
V_389 -> V_400 = & V_421 ;
return 0 ;
}
...
struct V_5 * V_6 = V_3 -> V_6 ; ;
V_389 -> V_420 = F_260 ( V_389 -> V_420 ) ;
return F_262 ( V_389 , V_6 -> V_416 , V_6 -> V_294 ) ;
}
...
static int F_265 ( struct V_218 * V_218 , struct V_388 * V_389 )
{
struct V_244 * V_245 ;
struct V_2 * V_3 ;
unsigned long V_373 ;
...
default:
return F_263 ( V_3 , V_218 , V_389 ) ;
}
return 0 ;
}
static int F_266 ( int V_243 , struct V_218 * V_218 , int V_429 )
{
struct V_244 * V_245 ;
struct V_2 * V_3 ;
struct V_5 * V_6 ;
...
return - V_95 ;
V_6 = V_3 -> V_6 ;
return F_267 ( V_243 , V_218 , V_429 , & V_6 -> V_430 ) ;
}
...
for ( V_40 = 0 ; V_40 < F_269 ( V_432 -> V_433 ) ; V_40 ++ )
V_35 -> V_433 [ V_40 ] . V_65 [ 0 ] = V_432 -> V_433 [ V_40 ] ;
memcpy ( V_35 -> V_434 , V_432 -> V_434 , sizeof( V_432 -> V_434 ) ) ;
V_35 -> V_54 = F_270 ( V_432 -> V_54 ) ;
V_35 -> V_66 = F_270 ( V_432 -> V_66 ) ;
V_35 -> V_4 = V_432 -> V_4 ;
...
static void F_271 ( struct V_431 * V_432 ,
struct V_34 * V_35 )
{
unsigned int V_40 ;
...
V_432 -> V_54 = F_272 ( V_35 -> V_54 ) ;
V_432 -> V_66 = F_272 ( V_35 -> V_66 ) ;
V_432 -> V_4 = V_35 -> V_4 ;
