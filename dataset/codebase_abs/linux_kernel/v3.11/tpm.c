...
F_5 ( & V_3 -> V_31 ) ;
if ( ( V_24 = V_3 -> V_20 . V_32 ( V_3 , ( T_2 * ) V_22 , V_25 ) ) < 0 ) {
F_11 ( V_3 -> V_29 ,
L_2 , V_24 ) ;
goto V_33;
}
...
V_146 += sprintf ( V_146 ,
L_40 ,
V_57 . V_154 . V_155 , V_57 . V_154 . V_156 ,
V_57 . V_154 . V_157 , V_57 . V_154 . V_158 ) ;
return V_146 - V_22 ;
}
T_3 F_44 ( struct V_55 * V_29 ,
struct V_107 * V_108 , char * V_22 )
{
T_5 V_57 ;
T_3 V_24 ;
...
V_146 += sprintf ( V_146 ,
L_40 ,
V_57 . V_159 . V_155 , V_57 . V_159 . V_156 ,
V_57 . V_159 . V_157 ,
V_57 . V_159 . V_158 ) ;
return V_146 - V_22 ;
}
T_3 F_45 ( struct V_55 * V_29 , struct V_107 * V_108 ,
char * V_22 )
{
struct V_2 * V_3 = F_17 ( V_29 ) ;
...
F_46 ( V_3 -> V_20 . V_13 [ V_98 ] ) ,
F_46 ( V_3 -> V_20 . V_13 [ V_100 ] ) ,
F_46 ( V_3 -> V_20 . V_13 [ V_102 ] ) ,
V_3 -> V_20 . V_104
? L_43 : L_44 ) ;
}
...
T_3 F_48 ( struct V_55 * V_29 , struct V_107 * V_108 ,
...
static bool F_49 ( struct V_2 * V_3 , T_2 V_160 , bool V_161 ,
bool * V_162 )
{
T_2 V_37 = V_3 -> V_20 . V_37 ( V_3 ) ;
* V_162 = false ;
...
int F_50 ( struct V_2 * V_3 , T_2 V_160 , unsigned long V_83 ,
...
int F_54 ( struct V_168 * V_168 , struct V_169 * V_169 )
{
int V_170 = F_55 ( V_168 ) ;
struct V_2 * V_3 = NULL , * V_116 ;
F_30 () ;
F_31 (pos, &tpm_chip_list, list) {
if ( V_116 -> V_20 . V_171 . V_170 == V_170 ) {
V_3 = V_116 ;
F_56 ( V_3 -> V_29 ) ;
break;
}
...
int F_62 ( struct V_168 * V_168 , struct V_169 * V_169 )
{
struct V_2 * V_3 = V_169 -> V_176 ;
F_63 ( & V_3 -> V_177 ) ;
F_64 ( & V_3 -> V_4 ) ;
V_169 -> V_176 = NULL ;
F_6 ( & V_3 -> V_7 , 0 ) ;
...
T_3 F_66 ( struct V_169 * V_169 , const char T_8 * V_22 ,
T_4 V_178 , T_9 * V_179 )
{
struct V_2 * V_3 = V_169 -> V_176 ;
T_4 V_180 = V_178 ;
...
F_5 ( & V_3 -> V_6 ) ;
if ( F_68
( V_3 -> V_8 , ( void T_8 * ) V_22 , V_180 ) ) {
F_7 ( & V_3 -> V_6 ) ;
return - V_52 ;
}
V_181 = F_9 ( V_3 , V_3 -> V_8 , V_9 ) ;
if ( V_181 < 0 ) {
F_7 ( & V_3 -> V_6 ) ;
return V_181 ;
}
F_6 ( & V_3 -> V_7 , V_181 ) ;
F_7 ( & V_3 -> V_6 ) ;
F_69 ( & V_3 -> V_177 , V_36 + ( 60 * V_21 ) ) ;
return V_180 ;
}
T_3 F_70 ( struct V_169 * V_169 , char T_8 * V_22 ,
T_4 V_178 , T_9 * V_179 )
{
struct V_2 * V_3 = V_169 -> V_176 ;
T_3 V_182 ;
...
V_182 = V_178 ;
F_5 ( & V_3 -> V_6 ) ;
V_24 = F_71 ( V_22 , V_3 -> V_8 , V_182 ) ;
memset ( V_3 -> V_8 , 0 , V_183 ) ;
if ( V_24 )
V_182 = - V_52 ;
F_7 ( & V_3 -> V_6 ) ;
}
...
F_76 () ;
F_77 ( & V_3 -> V_20 . V_171 ) ;
F_78 ( & V_29 -> V_186 , V_3 -> V_20 . V_187 ) ;
F_79 ( & V_29 -> V_186 ) ;
F_80 ( V_3 -> V_188 ) ;
F_59 ( V_3 -> V_29 ) ;
}
...
if ( V_191 ) {
V_47 . V_53 . V_59 = V_131 ;
V_47 . V_63 . V_132 . V_121 = F_18 ( V_191 ) ;
memcpy ( V_47 . V_63 . V_132 . V_130 , V_190 ,
V_128 ) ;
V_24 = F_15 ( V_3 , & V_47 , V_133 ,
L_48 ) ;
}
for ( V_189 = 0 ; V_189 < V_192 ; V_189 ++ ) {
V_47 . V_53 . V_59 = V_193 ;
V_24 = F_15 ( V_3 , & V_47 , V_194 , NULL ) ;
if ( V_24 != V_195 )
break;
F_12 ( V_196 ) ;
}
...
int F_84 ( T_1 V_115 , T_2 * V_33 , T_4 V_197 )
{
struct V_2 * V_3 ;
struct V_46 V_58 ;
T_1 V_198 , V_199 = F_85 ( T_1 , V_197 , V_200 ) ;
int V_50 , V_201 = 0 , V_202 = 5 ;
T_2 * V_203 = V_33 ;
V_3 = F_29 ( V_115 ) ;
if ( V_3 == NULL )
return - V_129 ;
if ( ! V_33 || ! V_199 || V_197 > V_200 )
return - V_87 ;
do {
V_58 . V_53 . V_59 = V_204 ;
V_58 . V_63 . V_205 . V_199 = F_18 ( V_199 ) ;
V_50 = F_15 ( V_3 , & V_58 ,
V_206 + V_199 ,
L_51 ) ;
if ( V_50 )
break;
V_198 = F_10 ( V_58 . V_63 . V_207 . V_208 ) ;
memcpy ( V_203 , V_58 . V_63 . V_207 . V_209 , V_198 ) ;
V_203 += V_198 ;
V_201 += V_198 ;
V_199 -= V_198 ;
} while ( V_202 -- && V_201 < V_197 );
return V_201 ? V_201 : - V_210 ;
}
...
return;
if ( V_3 -> V_20 . V_211 )
V_3 -> V_20 . V_211 ( V_3 -> V_29 ) ;
F_61 ( V_3 -> V_118 , V_212 ) ;
F_87 ( V_3 -> V_20 . V_171 . V_213 ) ;
}
void F_88 ( struct V_55 * V_29 )
{
struct V_2 * V_3 = F_17 ( V_29 ) ;
if ( ! V_3 )
return;
...
struct V_2 * F_89 ( struct V_55 * V_29 ,
const struct V_214 * V_215 )
{
#define F_90 7
char * V_216 ;
struct V_2 * V_3 ;
V_3 = F_60 ( sizeof( * V_3 ) , V_174 ) ;
V_216 = F_91 ( F_90 , V_174 ) ;
if ( V_3 == NULL || V_216 == NULL )
goto V_217;
F_92 ( & V_3 -> V_6 ) ;
F_92 ( & V_3 -> V_31 ) ;
F_93 ( & V_3 -> V_185 ) ;
...
V_3 -> V_118 = F_96 ( V_212 , V_218 ) ;
if ( V_3 -> V_118 >= V_218 ) {
F_11 ( V_29 , L_52 ) ;
goto V_217;
} else if ( V_3 -> V_118 == 0 )
V_3 -> V_20 . V_171 . V_170 = V_219 ;
else
V_3 -> V_20 . V_171 . V_170 = V_220 ;
F_97 ( V_3 -> V_118 , V_212 ) ;
F_98 ( V_216 , F_90 , L_53 , L_54 , V_3 -> V_118 ) ;
V_3 -> V_20 . V_171 . V_213 = V_216 ;
V_3 -> V_20 . V_171 . V_221 = V_29 ;
V_3 -> V_29 = F_56 ( V_29 ) ;
V_3 -> V_211 = V_29 -> V_211 ;
V_29 -> V_211 = F_88 ;
F_99 ( V_29 , V_3 ) ;
if ( F_100 ( & V_3 -> V_20 . V_171 ) ) {
F_11 ( V_3 -> V_29 ,
L_55 ,
V_3 -> V_20 . V_171 . V_213 ,
V_3 -> V_20 . V_171 . V_170 ) ;
goto F_59;
}
if ( F_101 ( & V_29 -> V_186 , V_3 -> V_20 . V_187 ) ) {
F_77 ( & V_3 -> V_20 . V_171 ) ;
goto F_59;
}
if ( F_102 ( & V_29 -> V_186 ) ) {
...
V_3 -> V_188 = F_103 ( V_216 ) ;
F_73 ( & V_184 ) ;
F_104 ( & V_3 -> V_185 , & V_222 ) ;
F_75 ( & V_184 ) ;
return V_3 ;
F_59:
F_59 ( V_3 -> V_29 ) ;
