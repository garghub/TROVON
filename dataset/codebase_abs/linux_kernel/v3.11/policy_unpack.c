...
if ( ! F_12 ( V_17 , V_69 , NULL ) )
goto V_33;
if ( F_13 ( V_17 , & V_18 -> V_85 , L_9 ) )
V_18 -> V_85 |= V_18 -> V_46 & V_86 ;
else
V_18 -> V_85 = V_86 ;
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_88 . V_89 [ 0 ] ) , NULL ) )
goto V_33;
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_83 . V_89 [ 0 ] ) , NULL ) )
goto V_33;
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_90 . V_89 [ 0 ] ) , NULL ) )
goto V_33;
if ( ! F_13 ( V_17 , & V_77 . V_89 [ 0 ] , NULL ) )
goto V_33;
if ( F_12 ( V_17 , V_60 , L_10 ) ) {
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_88 . V_89 [ 1 ] ) , NULL ) )
goto V_33;
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_83 . V_89 [ 1 ] ) , NULL ) )
goto V_33;
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_90 . V_89 [ 1 ] ) , NULL ) )
goto V_33;
if ( ! F_13 ( V_17 , & ( V_77 . V_89 [ 1 ] ) , NULL ) )
goto V_33;
if ( ! F_12 ( V_17 , V_69 , NULL ) )
goto V_33;
}
if ( F_12 ( V_17 , V_60 , L_11 ) ) {
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_91 . V_89 [ 0 ] ) , NULL ) )
goto V_33;
if ( ! F_13 ( V_17 , & ( V_18 -> V_87 . V_91 . V_89 [ 1 ] ) , NULL ) )
goto V_33;
if ( ! F_12 ( V_17 , V_69 , NULL ) )
goto V_33;
}
...
V_18 -> V_92 . V_45 = F_25 ( V_17 ) ;
if ( F_30 ( V_18 -> V_92 . V_45 ) ) {
error = F_40 ( V_18 -> V_92 . V_45 ) ;
V_18 -> V_92 . V_45 = NULL ;
goto V_33;
}
if ( ! F_13 ( V_17 , & V_18 -> V_92 . V_21 [ 0 ] , L_13 ) )
...
if ( ! F_13 ( V_17 , & V_18 -> V_61 . V_21 , L_14 ) )
V_18 -> V_61 . V_21 = V_93 ;
if ( ! F_33 ( V_17 , V_18 ) )
goto V_33;
if ( ! F_12 ( V_17 , V_69 , NULL ) )
...
static int F_43 ( struct V_16 * V_17 , const char * * V_96 )
{
int error = - V_97 ;
if ( ! F_13 ( V_17 , & V_17 -> V_98 , L_17 ) ) {
...
if ( ! F_19 ( V_17 , V_96 , L_20 ) )
* V_96 = NULL ;
return 0 ;
}
static bool F_44 ( int V_99 , int V_100 )
{
int V_101 , V_102 ;
V_102 = V_99 & V_103 ;
V_101 = V_99 & V_104 ;
...
static bool F_45 ( struct V_44 * V_45 , int V_100 )
{
int V_47 ;
for ( V_47 = 0 ; V_47 < V_45 -> V_48 [ V_49 ] -> V_50 ; V_47 ++ ) {
if ( ! F_44 ( F_46 ( V_45 , V_47 ) , V_100 ) )
return 0 ;
if ( ! F_44 ( F_47 ( V_45 , V_47 ) , V_100 ) )
return 0 ;
}
return 1 ;
}
...
struct V_9 * F_49 ( void * V_106 , T_1 V_24 , const char * * V_96 )
{
struct V_9 * V_18 = NULL ;
int error ;
struct V_16 V_17 = {
