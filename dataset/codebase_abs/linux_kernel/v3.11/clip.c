...
void * V_129 )
{
struct V_66 * V_29 = F_82 ( V_129 ) ;
if ( ! F_83 ( F_84 ( V_29 ) , & V_111 ) )
return V_130 ;
if ( V_128 == V_131 )
return V_130 ;
...
static int F_85 ( struct V_126 * V_127 , unsigned long V_128 ,
void * V_139 )
{
struct V_140 * V_141 ;
struct V_142 V_143 ;
V_141 = ( (struct V_144 * ) V_139 ) -> V_145 ;
if ( V_128 != V_132 )
return V_130 ;
F_86 ( & V_143 , V_141 -> V_29 ) ;
return F_81 ( V_127 , V_136 , & V_143 ) ;
}
static void F_87 ( struct V_51 * V_41 )
{
F_2 ( L_9 ) ;
F_88 () ;
V_10 = NULL ;
...
static int F_92 ( struct V_51 * V_41 )
{
F_88 () ;
if ( V_10 ) {
F_90 () ;
...
F_26 ( & V_48 , V_27 + V_49 * V_50 ) ;
V_10 = V_41 ;
F_67 ( V_148 , & V_41 -> V_68 ) ;
F_67 ( V_149 , & V_41 -> V_68 ) ;
V_41 -> V_29 = & V_150 ;
F_93 ( F_6 ( V_41 ) ) ;
V_41 -> V_104 = NULL ;
V_41 -> V_109 = NULL ;
...
static int F_94 ( struct V_152 * V_4 , unsigned int V_153 , unsigned long V_154 )
{
struct V_51 * V_41 = F_95 ( V_4 ) ;
int V_155 = 0 ;
switch ( V_153 ) {
case V_156 :
case V_157 :
...
break;
case V_158 :
V_155 = F_65 ( V_41 , V_154 ) ;
break;
case V_159 :
V_155 = F_69 ( V_41 , ( V_166 T_1 ) V_154 ) ;
break;
case V_160 :
V_155 = F_52 ( V_41 , V_154 ) ;
break;
}
return V_155 ;
}
static void F_98 ( struct V_167 * V_168 , struct V_169 * V_170 )
{
static int V_171 [] = { 1 , 2 , 10 , 6 , 1 , 0 } ;
static int V_172 [] = { 1 , 8 , 4 , 6 , 1 , 0 } ;
if ( * V_170 -> V_173 . V_174 ) {
F_99 ( V_168 , L_35 , V_170 -> V_173 . V_174 ) ;
if ( * V_170 -> V_173 . V_175 )
F_100 ( V_168 , '+' ) ;
} else if ( ! * V_170 -> V_173 . V_175 ) {
F_99 ( V_168 , L_35 , L_36 ) ;
return;
}
if ( * V_170 -> V_173 . V_175 ) {
...
F_99 ( V_168 , L_37 , * V_175 ++ ) ;
if ( V_176 [ V_177 + 1 ] )
F_100 ( V_168 , '.' ) ;
}
}
}
static void F_101 ( struct V_167 * V_168 , struct V_34 * V_35 ,
...
V_181 = ( ( V_19 == V_184 ) ||
( F_6 ( V_19 -> V_41 ) -> V_185 == V_186 ) ) ;
V_182 = ( ( V_19 == V_184 ) || V_19 -> V_54 ) ;
if ( V_19 == V_184 )
exp = V_21 -> V_22 -> V_26 ;
else
exp = V_19 -> V_39 ;
exp = ( V_27 - exp ) / V_50 ;
F_99 ( V_168 , L_38 ,
V_29 -> V_125 , V_181 ? L_39 : L_40 , V_182 ? L_41 : L_42 , exp ) ;
V_183 = F_102 ( V_180 , sizeof( V_180 ) - 1 , L_43 , V_35 -> V_71 ) ;
while ( V_183 < 16 )
V_180 [ V_183 ++ ] = ' ' ;
V_180 [ V_183 ] = '\0' ;
F_99 ( V_168 , L_35 , V_180 ) ;
if ( V_19 == V_184 ) {
...
F_99 ( V_168 , L_46 ,
V_19 -> V_41 -> V_29 -> V_73 ,
V_19 -> V_41 -> V_187 , V_19 -> V_41 -> V_188 ) ;
} else {
F_98 ( V_168 , & V_19 -> V_41 -> V_189 ) ;
F_100 ( V_168 , '\n' ) ;
}
}
static struct V_19 * F_103 ( struct V_20 * V_190 ,
struct V_19 * V_191 )
{
if ( ! V_191 ) {
V_191 = V_190 -> V_25 ;
...
static void * F_104 ( struct V_192 * V_164 ,
struct V_20 * V_190 , T_3 * V_193 )
{
struct V_19 * V_41 = V_164 -> V_41 ;
V_41 = F_103 ( V_190 , V_41 ) ;
if ( V_41 && V_193 != NULL ) {
while ( * V_193 ) {
V_41 = F_103 ( V_190 , V_41 ) ;
if ( ! V_41 )
...
static void * F_105 ( struct V_194 * V_195 ,
struct V_34 * V_35 , T_3 * V_193 )
{
struct V_192 * V_164 = (struct V_192 * ) V_195 ;
if ( V_35 -> V_29 -> type != V_116 )
return NULL ;
return F_104 ( V_164 , F_16 ( V_35 ) , V_193 ) ;
}
static void * F_106 ( struct V_167 * V_168 , T_3 * V_193 )
{
struct V_192 * V_164 = V_168 -> V_196 ;
V_164 -> V_197 . V_198 = F_105 ;
return F_107 ( V_168 , V_193 , & V_46 , V_199 ) ;
}
static int F_108 ( struct V_167 * V_168 , void * V_200 )
{
static char V_201 [] =
L_47 ;
if ( V_200 == V_202 ) {
...
F_101 ( V_168 , V_35 , F_16 ( V_35 ) , V_41 ) ;
}
return 0 ;
}
static int F_110 ( struct V_203 * V_203 , struct V_204 * V_204 )
{
return F_111 ( V_203 , V_204 , & V_205 ,
sizeof( struct V_192 ) ) ;
}
...
{
struct V_209 * V_210 ;
V_210 = F_118 ( L_48 , V_211 , V_212 , & V_213 ) ;
if ( ! V_210 ) {
F_55 ( L_49 ) ;
F_119 () ;
return - V_13 ;
