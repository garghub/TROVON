...
V_137 = F_67 ( V_45 , V_141 , 0 ) ;
V_11 -> V_104 = F_68 ( V_44 , V_137 ) ;
if ( F_16 ( V_11 -> V_104 ) )
return F_22 ( V_11 -> V_104 ) ;
V_11 -> V_94 = F_69 ( V_45 , 0 ) ;
if ( V_11 -> V_94 < 0 ) {
F_24 ( V_44 , L_23 ) ;
return V_11 -> V_94 ;
}
for ( V_8 = 0 ; V_8 < V_142 ; V_8 ++ )
V_11 -> V_143 [ V_8 ] . V_144 = V_145 [ V_8 ] ;
V_46 = F_70 ( V_44 , V_142 ,
V_11 -> V_143 ) ;
if ( V_46 )
return V_46 ;
V_46 = F_20 ( V_11 ) ;
...
return V_46 ;
if ( V_11 -> V_111 )
V_46 = F_71 ( V_11 -> clock [ V_146 ] ,
V_11 -> V_111 ) ;
else
F_72 ( V_44 , L_24 ) ;
if ( V_46 < 0 )
goto V_147;
V_46 = F_73 ( V_11 -> clock [ V_146 ] ) ;
if ( V_46 < 0 )
goto V_147;
V_46 = F_74 ( V_44 , V_11 -> V_94 , F_51 ,
0 , F_75 ( V_44 ) , V_11 ) ;
if ( V_46 ) {
F_24 ( V_44 , L_25 ) ;
goto V_148;
...
V_11 -> V_23 . V_25 = V_90 ;
V_11 -> V_23 . V_26 = V_91 ;
V_11 -> V_154 [ V_155 ] . V_54 = V_156 ;
V_11 -> V_154 [ V_80 ] . V_54 = V_157 ;
V_46 = F_77 ( & V_11 -> V_4 . V_158 ,
V_159 , V_11 -> V_154 , 0 ) ;
if ( V_46 < 0 )
goto V_148;
F_78 ( & V_11 -> V_4 , V_45 ) ;
F_79 ( V_45 , & V_11 -> V_4 ) ;
memcpy ( V_11 -> V_57 , V_160 , sizeof( V_11 -> V_57 ) ) ;
F_80 ( V_44 ) ;
F_81 ( & V_45 -> V_44 , L_27 ,
...
return 0 ;
V_148:
F_82 ( V_11 -> clock [ V_146 ] ) ;
V_147:
F_15 ( V_11 ) ;
return V_46 ;
}
static int F_83 ( struct V_43 * V_44 , bool V_161 )
{
struct V_107 * V_45 = F_84 ( V_44 ) ;
struct V_2 * V_4 = F_85 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
int V_46 = 0 ;
...
static int F_88 ( struct V_43 * V_44 , bool V_161 )
{
struct V_107 * V_45 = F_84 ( V_44 ) ;
struct V_2 * V_4 = F_85 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
...
{
return F_88 ( V_44 , true ) ;
}
static int F_94 ( struct V_107 * V_45 )
{
struct V_2 * V_4 = F_85 ( V_45 ) ;
struct V_1 * V_11 = F_1 ( V_4 ) ;
F_95 ( & V_45 -> V_44 ) ;
F_83 ( & V_45 -> V_44 , false ) ;
F_82 ( V_11 -> clock [ V_146 ] ) ;
F_96 ( & V_45 -> V_44 ) ;
F_15 ( V_11 ) ;
F_97 ( & V_11 -> V_4 . V_158 ) ;
