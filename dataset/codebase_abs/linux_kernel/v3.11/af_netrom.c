...
if ( ( V_44 = F_101 ( V_11 , V_199 , V_195 -> V_200 & V_201 , & V_144 ) ) == NULL )
goto V_204;
F_102 ( V_44 , V_199 - V_76 ) ;
F_90 ( V_44 ) ;
V_198 = F_103 ( V_44 , V_180 ) ;
* V_198 ++ = V_32 -> V_36 ;
* V_198 ++ = V_32 -> V_37 ;
* V_198 ++ = 0 ;
* V_198 ++ = 0 ;
* V_198 ++ = V_209 ;
F_104 ( V_44 , V_76 ) ;
if ( F_105 ( F_106 ( V_44 ) , V_195 -> V_210 , V_76 ) ) {
F_40 ( V_44 ) ;
V_144 = - V_63 ;
goto V_204;
}
...
static int F_108 ( struct V_192 * V_193 , struct V_54 * V_10 ,
...
if ( ( V_44 = F_109 ( V_11 , V_143 & ~ V_201 , V_143 & V_201 , & V_212 ) ) == NULL ) {
F_51 ( V_11 ) ;
return V_212 ;
}
F_90 ( V_44 ) ;
...
V_212 = F_110 ( V_44 , 0 , V_195 -> V_210 , V_211 ) ;
if ( V_212 < 0 ) {
F_111 ( V_11 , V_44 ) ;
F_51 ( V_11 ) ;
return V_212 ;
...
V_165 -> V_134 = V_135 ;
F_112 ( V_44 , 7 , V_165 -> V_136 . V_214 ,
V_79 ) ;
}
...
static int F_113 ( struct V_54 * V_10 , unsigned int V_215 , unsigned long V_216 )
{
struct V_10 * V_11 = V_10 -> V_11 ;
...
if ( ! F_68 ( V_152 ) )
return - V_139 ;
return F_118 ( V_215 , V_217 ) ;
default:
return - V_236 ;
}
return 0 ;
}
static void * F_119 ( struct V_237 * V_238 , T_5 * V_239 )
{
F_6 ( & V_12 ) ;
return F_120 ( & V_23 , * V_239 ) ;
}
static void * F_121 ( struct V_237 * V_238 , void * V_240 , T_5 * V_239 )
{
return F_122 ( V_240 , & V_23 , V_239 ) ;
}
static void F_123 ( struct V_237 * V_238 , void * V_240 )
{
F_8 ( & V_12 ) ;
}
static int F_124 ( struct V_237 * V_238 , void * V_240 )
{
struct V_10 * V_13 = F_125 ( V_240 ) ;
struct V_1 * V_2 ;
struct V_31 * V_32 ;
const char * V_241 ;
char V_242 [ 11 ] ;
...
V_241 = V_2 -> V_244 ;
F_127 ( V_238 , L_3 , F_128 ( V_242 , & V_32 -> V_78 ) ) ;
F_127 ( V_238 , L_3 , F_128 ( V_242 , & V_32 -> V_38 ) ) ;
F_127 ( V_238 ,
L_4 ,
F_128 ( V_242 , & V_32 -> V_25 ) ,
V_241 ,
V_32 -> V_33 ,
V_32 -> V_34 ,
V_32 -> V_36 ,
...
V_32 -> V_189 ,
V_32 -> V_188 ,
F_129 ( & V_32 -> V_245 ) / V_53 ,
V_32 -> V_66 / V_53 ,
F_129 ( & V_32 -> V_246 ) / V_53 ,
V_32 -> V_68 / V_53 ,
F_129 ( & V_32 -> V_247 ) / V_53 ,
V_32 -> V_72 / V_53 ,
F_129 ( & V_32 -> V_248 ) / ( 60 * V_53 ) ,
V_32 -> V_74 / ( 60 * V_53 ) ,
V_32 -> V_117 ,
V_32 -> V_70 ,
V_32 -> V_103 ,
F_114 ( V_13 ) ,
F_130 ( V_13 ) ,
V_13 -> V_249 ? F_131 ( V_13 -> V_249 ) -> V_250 : 0L ) ;
F_26 ( V_13 ) ;
}
return 0 ;
}
static int F_132 ( struct V_251 * V_251 , struct V_252 * V_252 )
{
return F_133 ( V_252 , & V_253 ) ;
}
static int T_6 F_134 ( void )
{
int V_40 ;
int V_254 = F_135 ( & V_90 , 0 ) ;
if ( V_254 != 0 )
goto V_204;
...
V_257 = F_137 ( V_255 * sizeof( struct V_1 * ) , V_258 ) ;
if ( V_257 == NULL ) {
F_136 ( V_256 L_6 ) ;
return - 1 ;
}
...
#endif
F_147 () ;
F_148 ( L_11 , V_267 , V_20 . V_268 , & V_269 ) ;
F_148 ( L_12 , V_267 , V_20 . V_268 , & V_270 ) ;
F_148 ( L_13 , V_267 , V_20 . V_268 , & V_271 ) ;
V_204:
return V_254 ;
V_261:
while ( -- V_40 >= 0 ) {
...
{
int V_40 ;
F_153 ( L_11 , V_20 . V_268 ) ;
F_153 ( L_12 , V_20 . V_268 ) ;
F_153 ( L_13 , V_20 . V_268 ) ;
F_154 () ;
F_155 () ;
#ifdef F_145
F_156 () ;
