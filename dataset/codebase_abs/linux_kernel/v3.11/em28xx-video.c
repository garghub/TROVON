...
struct V_196 * V_197 = V_168 ;
struct V_1 * V_2 = V_197 -> V_2 ;
if ( V_253 -> V_254 . V_255 > 1 )
return - V_105 ;
if ( V_253 -> V_254 . V_255 == 1 )
F_80 ( V_253 -> V_226 , L_35 , sizeof( V_253 -> V_226 ) ) ;
else
F_80 ( V_253 -> V_226 , V_2 -> V_125 . V_226 , sizeof( V_253 -> V_226 ) ) ;
return 0 ;
}
static int F_81 ( int V_256 )
{
switch ( V_256 ) {
case V_257 :
case V_258 :
...
static int F_82 ( struct V_195 * V_195 , void * V_168 ,
struct V_260 * V_256 )
{
struct V_196 * V_197 = V_168 ;
struct V_1 * V_2 = V_197 -> V_2 ;
int V_177 ;
if ( V_256 -> V_254 . V_255 > 1 )
return - V_105 ;
if ( V_256 -> V_254 . V_255 ) {
V_177 = F_83 ( V_2 , V_256 -> V_256 ) ;
if ( V_177 < 0 )
return V_177 ;
V_256 -> V_172 = V_177 ;
V_256 -> V_99 = 1 ;
...
V_256 -> V_99 = F_81 ( V_256 -> V_256 ) ;
if ( V_256 -> V_99 == 1 ) {
V_177 = F_84 ( V_2 , V_256 -> V_256 ) ;
if ( V_177 < 0 )
return V_177 ;
V_256 -> V_172 = V_177 ;
} else {
T_2 V_172 = 0 ;
V_177 = F_85 ( V_2 , V_261 ,
V_256 -> V_256 , ( char * ) & V_172 , 2 ) ;
if ( V_177 < 0 )
return V_177 ;
V_256 -> V_172 = F_86 ( V_172 ) ;
}
return 0 ;
}
static int F_87 ( struct V_195 * V_195 , void * V_168 ,
const struct V_260 * V_256 )
{
struct V_196 * V_197 = V_168 ;
struct V_1 * V_2 = V_197 -> V_2 ;
T_2 V_4 ;
...
return - V_105 ;
if ( V_256 -> V_254 . V_255 )
return F_88 ( V_2 , V_256 -> V_256 , V_256 -> V_172 ) ;
V_4 = F_89 ( V_256 -> V_172 ) ;
return F_90 ( V_2 , V_256 -> V_256 , ( char * ) & V_4 ,
F_81 ( V_256 -> V_256 ) ) ;
}
static int F_91 ( struct V_195 * V_195 , void * V_168 ,
struct V_262 * V_263 )
{
struct V_264 * V_120 = F_92 ( V_195 ) ;
struct V_196 * V_197 = V_168 ;
struct V_1 * V_2 = V_197 -> V_2 ;
F_80 ( V_263 -> V_265 , L_36 , sizeof( V_263 -> V_265 ) ) ;
F_80 ( V_263 -> V_266 , V_267 [ V_2 -> V_268 ] . V_226 , sizeof( V_263 -> V_266 ) ) ;
F_93 ( V_2 -> V_269 , V_263 -> V_270 , sizeof( V_263 -> V_270 ) ) ;
if ( V_120 -> V_121 == V_271 )
V_263 -> V_272 = V_273 |
V_274 | V_275 ;
else if ( V_120 -> V_121 == V_122 )
V_263 -> V_272 = V_276 ;
else
V_263 -> V_272 = V_273 | V_277 ;
if ( V_2 -> V_278 . V_279 )
V_263 -> V_272 |= V_280 ;
if ( V_2 -> V_281 != V_282 )
V_263 -> V_272 |= V_283 ;
V_263 -> V_233 = V_263 -> V_272 | V_284 |
V_273 | V_274 | V_275 ;
if ( V_2 -> V_285 )
V_263 -> V_233 |= V_277 ;
if ( V_2 -> V_286 )
...
static int F_94 ( struct V_195 * V_195 , void * V_168 ,
struct V_287 * V_110 )
{
if ( F_95 ( V_110 -> V_148 >= F_56 ( V_103 ) ) )
return - V_105 ;
F_80 ( V_110 -> V_288 , V_103 [ V_110 -> V_148 ] . V_226 , sizeof( V_110 -> V_288 ) ) ;
V_110 -> V_198 = V_103 [ V_110 -> V_148 ] . V_199 ;
return 0 ;
}
static int F_96 ( struct V_195 * V_195 , void * V_168 ,
struct V_289 * V_290 )
{
struct V_196 * V_197 = V_168 ;
struct V_1 * V_2 = V_197 -> V_2 ;
...
return - V_105 ;
V_290 -> type = V_292 ;
V_290 -> V_293 . V_25 = V_192 / ( 1 + V_290 -> V_148 ) ;
V_290 -> V_293 . V_102 = V_193 / ( 1 + V_290 -> V_148 ) ;
return 0 ;
}
if ( V_290 -> V_148 != 0 )
return - V_105 ;
...
& V_290 -> V_295 . V_296 , & V_290 -> V_295 . V_297 ) ;
if ( V_290 -> V_295 . V_296 < 48 )
V_290 -> V_295 . V_296 = 48 ;
if ( V_290 -> V_295 . V_297 < 38 )
V_290 -> V_295 . V_297 = 38 ;
V_290 -> V_295 . V_298 = V_192 ;
V_290 -> V_295 . V_299 = V_193 ;
V_290 -> V_295 . V_300 = 1 ;
V_290 -> V_295 . V_301 = 1 ;
return 0 ;
}
...
struct V_196 * V_197 = V_168 ;
struct V_1 * V_2 = V_197 -> V_2 ;
V_103 -> V_94 . V_302 . V_303 = V_2 -> V_30 ;
V_103 -> V_94 . V_302 . V_304 = V_305 ;
V_103 -> V_94 . V_302 . V_21 = 0 ;
V_103 -> V_94 . V_302 . V_128 = 0 ;
V_103 -> V_94 . V_302 . V_306 = 6750000 * 4 / 2 ;
V_103 -> V_94 . V_302 . V_108 [ 0 ] = V_2 -> V_31 ;
V_103 -> V_94 . V_302 . V_108 [ 1 ] = V_2 -> V_31 ;
memset ( V_103 -> V_94 . V_302 . V_307 , 0 , sizeof( V_103 -> V_94 . V_302 . V_307 ) ) ;
if ( V_2 -> V_207 & V_209 ) {
V_103 -> V_94 . V_302 . V_308 [ 0 ] = 10 ;
V_103 -> V_94 . V_302 . V_308 [ 1 ] = 273 ;
} else if ( V_2 -> V_207 & V_309 ) {
V_103 -> V_94 . V_302 . V_308 [ 0 ] = 6 ;
V_103 -> V_94 . V_302 . V_308 [ 1 ] = 318 ;
}
return 0 ;
}
...
static int F_100 ( struct V_195 * V_310 )
{
struct V_264 * V_120 = F_92 ( V_310 ) ;
struct V_1 * V_2 = F_62 ( V_310 ) ;
enum V_82 V_311 = 0 ;
struct V_196 * V_197 ;
switch ( V_120 -> V_121 ) {
case V_271 :
...
F_20 ( L_38 ,
F_101 ( V_120 ) , V_313 [ V_311 ] ,
V_2 -> V_314 ) ;
if ( F_102 ( & V_2 -> V_315 ) )
return - V_316 ;
V_197 = F_103 ( sizeof( struct V_196 ) , V_317 ) ;
if ( ! V_197 ) {
F_104 ( L_39 ) ;
F_105 ( & V_2 -> V_315 ) ;
return - V_318 ;
}
F_106 ( & V_197 -> V_197 , V_120 ) ;
V_197 -> V_2 = V_2 ;
V_197 -> type = V_311 ;
V_310 -> V_319 = V_197 ;
if ( V_197 -> type == V_84 && V_2 -> V_314 == 0 ) {
F_107 ( V_2 , V_113 ) ;
F_60 ( V_2 ) ;
F_30 ( V_2 ) ;
}
...
static int F_114 ( struct V_195 * V_310 )
{
struct V_196 * V_197 = V_310 -> V_319 ;
struct V_1 * V_2 = V_197 -> V_2 ;
int V_321 ;
F_20 ( L_42 , V_2 -> V_314 ) ;
F_115 ( & V_2 -> V_315 ) ;
...
F_32 ( & V_2 -> V_125 , 0 , V_210 , V_323 , 0 ) ;
F_107 ( V_2 , V_324 ) ;
V_2 -> V_325 = 0 ;
F_20 ( L_43 ) ;
V_321 = F_119 ( V_2 -> V_269 , 0 , 0 ) ;
if ( V_321 < 0 ) {
F_104 ( L_44
L_45 , V_321 ) ;
}
...
static struct V_264 * F_120 ( struct V_1 * V_2 ,
const struct V_264 * V_326 ,
const char * V_327 )
{
struct V_264 * V_328 ;
V_328 = F_121 () ;
...
return NULL ;
* V_328 = * V_326 ;
V_328 -> V_125 = & V_2 -> V_125 ;
V_328 -> V_329 = V_330 ;
V_328 -> V_315 = & V_2 -> V_315 ;
F_122 ( V_331 , & V_328 -> V_128 ) ;
if ( V_2 -> V_158 . V_218 )
V_328 -> V_232 = 0 ;
snprintf ( V_328 -> V_226 , sizeof( V_328 -> V_226 ) , L_46 ,
V_2 -> V_226 , V_327 ) ;
F_123 ( V_328 , V_2 ) ;
return V_328 ;
}
...
V_2 -> V_171 = 1 ;
V_2 -> V_174 = 0x1f ;
V_172 = ( T_3 ) F_84 ( V_2 , V_336 ) ;
F_49 ( V_2 , V_336 ,
( V_337 | V_172 ) ) ;
F_126 ( V_2 ) ;
F_127 ( V_2 ) ;
if ( NULL == F_128 ( & V_2 -> V_176 , V_178 ) )
F_129 ( & V_2 -> V_176 , & V_338 ,
V_178 ,
0 , 0x1f , 1 , V_339 ) ;
if ( NULL == F_128 ( & V_2 -> V_176 , V_180 ) )
F_129 ( & V_2 -> V_176 , & V_338 ,
V_180 ,
- 0x80 , 0x7f , 1 , V_340 ) ;
if ( NULL == F_128 ( & V_2 -> V_176 , V_182 ) )
F_129 ( & V_2 -> V_176 , & V_338 ,
V_182 ,
0 , 0x1f , 1 , V_341 ) ;
if ( NULL == F_128 ( & V_2 -> V_176 , V_184 ) )
F_129 ( & V_2 -> V_176 , & V_338 ,
V_184 ,
- 0x30 , 0x30 , 1 , V_342 ) ;
if ( NULL == F_128 ( & V_2 -> V_176 , V_186 ) )
F_129 ( & V_2 -> V_176 , & V_338 ,
V_186 ,
- 0x30 , 0x30 , 1 , V_343 ) ;
if ( NULL == F_128 ( & V_2 -> V_176 , V_188 ) )
F_129 ( & V_2 -> V_176 , & V_338 ,
V_188 ,
0 , 0x0f , 1 , V_344 ) ;
F_130 ( V_2 ) ;
...
V_2 -> V_120 = F_120 ( V_2 , & V_345 , L_48 ) ;
if ( ! V_2 -> V_120 ) {
F_104 ( L_49 ) ;
return - V_346 ;
}
V_2 -> V_120 -> V_347 = & V_2 -> V_132 ;
V_2 -> V_120 -> V_347 -> V_315 = & V_2 -> V_348 ;
if ( V_2 -> V_158 . V_218 ) {
F_132 ( V_2 -> V_120 , V_349 ) ;
F_132 ( V_2 -> V_120 , V_350 ) ;
F_132 ( V_2 -> V_120 , V_351 ) ;
} else {
F_132 ( V_2 -> V_120 , V_352 ) ;
}
if ( V_2 -> V_281 == V_282 ) {
F_132 ( V_2 -> V_120 , V_353 ) ;
F_132 ( V_2 -> V_120 , V_354 ) ;
F_132 ( V_2 -> V_120 , V_355 ) ;
F_132 ( V_2 -> V_120 , V_356 ) ;
}
if ( ! V_2 -> V_278 . V_279 ) {
F_132 ( V_2 -> V_120 , V_357 ) ;
F_132 ( V_2 -> V_120 , V_358 ) ;
}
V_177 = F_133 ( V_2 -> V_120 , V_271 ,
V_359 [ V_2 -> V_360 ] ) ;
if ( V_177 ) {
F_104 ( L_50 ,
V_177 ) ;
...
if ( F_134 ( V_2 ) == 1 ) {
V_2 -> V_285 = F_120 ( V_2 , & V_345 ,
L_51 ) ;
V_2 -> V_285 -> V_347 = & V_2 -> V_146 ;
V_2 -> V_285 -> V_347 -> V_315 = & V_2 -> V_361 ;
F_132 ( V_2 -> V_120 , V_352 ) ;
if ( V_2 -> V_281 == V_282 ) {
F_132 ( V_2 -> V_285 , V_353 ) ;
F_132 ( V_2 -> V_285 , V_354 ) ;
F_132 ( V_2 -> V_285 , V_355 ) ;
F_132 ( V_2 -> V_285 , V_356 ) ;
}
if ( ! V_2 -> V_278 . V_279 ) {
F_132 ( V_2 -> V_285 , V_357 ) ;
F_132 ( V_2 -> V_285 , V_358 ) ;
}
V_177 = F_133 ( V_2 -> V_285 , V_312 ,
V_362 [ V_2 -> V_360 ] ) ;
if ( V_177 < 0 ) {
F_104 ( L_52 ) ;
return V_177 ;
...
if ( V_267 [ V_2 -> V_268 ] . V_363 . type == V_364 ) {
V_2 -> V_286 = F_120 ( V_2 , & V_365 ,
L_53 ) ;
if ( ! V_2 -> V_286 ) {
F_104 ( L_49 ) ;
return - V_346 ;
}
V_177 = F_133 ( V_2 -> V_286 , V_122 ,
V_366 [ V_2 -> V_360 ] ) ;
if ( V_177 < 0 ) {
F_104 ( L_54 ) ;
return V_177 ;
