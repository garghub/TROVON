...
if ( F_80 ( V_255 , 3 ) >= 32 ) {
unsigned short V_278 = 0 ;
V_6 -> V_75 = F_3 ( V_2 -> V_9 + V_279 ) ;
...
F_93 ( V_2 -> V_87 , L_30 , V_255 -> V_244 ) ;
}
V_275 = F_96 ( V_2 , 3 ) ;
if ( V_275 )
return V_275 ;
...
static int F_107 ( struct V_255 * V_2 ,
const struct V_311 * V_256 )
{
return F_108 ( V_2 , & V_312 ,
V_256 -> V_313 ) ;
}
