...
V_27 -> V_34 = V_34 ;
V_27 -> V_82 = V_34 -> V_82 ;
V_27 -> V_34 -> V_35 = F_34 ( V_27 -> V_34 -> V_82 ,
& V_83 ) ;
if ( F_35 ( V_27 -> V_34 -> V_35 ) ) {
V_30 = F_36 ( V_27 -> V_34 -> V_35 ) ;
F_7 ( V_27 -> V_34 -> V_37 , L_21 ,
V_30 ) ;
return V_30 ;
}
F_37 ( V_76 , V_27 ) ;
...
#endif
F_39 ( & V_76 -> V_37 , 1 ) ;
V_27 -> V_57 = F_40 ( & V_76 -> V_37 , L_23 ,
& V_85 , V_86 ) ;
if ( F_35 ( V_27 -> V_57 ) ) {
F_26 ( & V_76 -> V_37 , L_24 , V_24 ) ;
V_30 = F_36 ( V_27 -> V_57 ) ;
F_7 ( & V_76 -> V_37 , L_25 , V_30 ) ;
if ( V_30 == 0 )
V_30 = - V_25 ;
goto V_84;
}
V_79 = F_41 ( V_34 -> V_87 , V_88 ) ;
if ( ! V_79 ) {
V_30 = - V_89 ;
goto V_84;
}
V_27 -> V_79 = V_79 ;
V_30 = F_42 ( & V_76 -> V_37 , V_79 , NULL ,
F_25 , 0 , L_26 , V_27 ) ;
if ( V_30 < 0 )
F_7 ( & V_76 -> V_37 , L_27 ,
V_27 -> V_79 , V_30 ) ;
...
{
#ifdef F_38
struct V_26 * V_27 = F_44 ( V_76 ) ;
int V_48 ;
T_1 V_47 = 0 ;
for ( V_48 = 0 ; V_48 < 3 ; V_48 ++ ) {
F_28 ( V_27 , false ) ;
F_18 ( V_27 -> V_34 -> V_35 , V_67 , & V_47 ) ;
F_26 ( V_27 -> V_37 , L_28 , V_24 ,
V_47 ) ;
if ( V_47 & V_65 ) {
F_45 ( V_27 -> V_37 , L_29 ,
V_24 ) ;
