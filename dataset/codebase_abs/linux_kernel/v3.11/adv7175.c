...
static int F_20 ( struct V_2 * V_3 , int V_50 )
{
if ( V_50 )
F_3 ( V_3 , 0x01 , 0x00 ) ;
else
...
struct V_1 * V_21 ;
struct V_2 * V_3 ;
if ( ! F_9 ( V_7 -> V_11 , V_54 ) )
return - V_55 ;
F_22 ( V_7 , L_6 ,
V_7 -> V_56 << 1 , V_7 -> V_11 -> V_57 ) ;
V_21 = F_23 ( & V_7 -> V_58 , sizeof( * V_21 ) , V_59 ) ;
if ( V_21 == NULL )
return - V_60 ;
V_3 = & V_21 -> V_3 ;
F_24 ( V_3 , V_7 , & V_61 ) ;
V_21 -> V_30 = V_22 ;
V_21 -> V_24 = 0 ;
V_53 = F_8 ( V_3 , V_17 , sizeof( V_17 ) ) ;
if ( V_53 >= 0 ) {
V_53 = F_3 ( V_3 , 0x07 , V_18 | V_19 ) ;
V_53 = F_3 ( V_3 , 0x07 , V_18 ) ;
V_53 = F_6 ( V_3 , 0x12 ) ;
F_14 ( 1 , V_28 , V_3 , L_7 , V_53 & 1 ) ;
}
if ( V_53 < 0 )
F_14 ( 1 , V_28 , V_3 , L_8 , V_53 ) ;
return 0 ;
}
