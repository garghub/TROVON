...
F_11 ( 0 , V_28 -> V_37 ) , NULL , L_11 , V_35 ) ;
...
( V_45 -> V_50 & V_51 ) ? L_16 : L_17 ,
( V_45 -> V_50 & V_52 ) ? L_18 : L_17 ,
( V_45 -> V_50 & V_53 ) ? L_19 : L_17 ,
( V_45 -> V_50 & V_54 ) ? L_20 : L_17 ,
( V_45 -> V_50 & V_55 ) ? L_21 : L_17 ,
( V_45 -> V_50 & V_56 ) ? L_22 : L_17 ) ;
}
return 0 ;
}
...
if ( ! V_45 )
return 0 ;
return snprintf ( V_4 , V_5 , L_23 , V_45 -> V_57 ) ;
}
...
if ( ! V_45 )
return 0 ;
return snprintf ( V_4 , V_5 , L_23 , V_45 -> V_58 ) ;
}
...
if ( ! V_45 )
return 0 ;
return snprintf ( V_4 , V_5 , L_23 , V_45 -> V_59 ) ;
}
...
if ( ! V_45 )
return 0 ;
return snprintf ( V_4 , V_5 , L_23 , V_45 -> V_60 . V_61 ) ;
}
