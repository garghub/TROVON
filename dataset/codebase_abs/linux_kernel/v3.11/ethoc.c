...
{
struct V_1 * V_60 = F_17 ( V_2 ) ;
unsigned char * V_94 = V_2 -> V_139 ;
F_3 ( V_60 , V_96 , ( V_94 [ 2 ] << 24 ) | ( V_94 [ 3 ] << 16 ) |
( V_94 [ 4 ] << 8 ) | ( V_94 [ 5 ] << 0 ) ) ;
F_3 ( V_60 , V_97 , ( V_94 [ 0 ] << 8 ) | ( V_94 [ 1 ] << 0 ) ) ;
}
static int F_65 ( struct V_42 * V_2 , void * V_140 )
{
const struct V_141 * V_11 = V_140 ;
if ( ! F_66 ( V_11 -> V_142 ) )
return - V_143 ;
memcpy ( V_2 -> V_139 , V_11 -> V_142 , V_144 ) ;
F_64 ( V_2 ) ;
return 0 ;
}
...
F_68 (ha, dev) {
T_1 V_156 = F_69 ( V_144 , V_146 -> V_11 ) ;
int V_157 = ( V_156 >> 26 ) & 0x3f ;
V_147 [ V_157 >> 5 ] |= 1 << ( V_157 & 0x1f ) ;
}
}
F_3 ( V_60 , V_158 , V_147 [ 0 ] ) ;
F_3 ( V_60 , V_159 , V_147 [ 1 ] ) ;
}
static int F_70 ( struct V_42 * V_2 , int V_160 )
{
return - V_138 ;
}
...
V_60 -> V_23 ++ ;
F_5 ( V_60 , V_62 , & V_8 ) ;
if ( F_30 ( V_66 -> V_162 < V_165 ) )
V_8 . V_10 |= V_166 ;
else
V_8 . V_10 &= ~ V_166 ;
V_161 = V_60 -> V_22 [ V_62 ] ;
F_74 ( V_161 , V_66 -> V_5 , V_66 -> V_162 ) ;
V_8 . V_10 &= ~ ( V_81 | V_167 ) ;
V_8 . V_10 |= F_75 ( V_66 -> V_162 ) ;
F_6 ( V_60 , V_62 , & V_8 ) ;
V_8 . V_10 |= V_85 ;
F_6 ( V_60 , V_62 , & V_8 ) ;
...
F_81 ( V_43 , & V_170 -> V_2 ) ;
F_82 ( V_170 , V_43 ) ;
V_172 = F_83 ( V_170 , V_178 , 0 ) ;
if ( ! V_172 ) {
F_15 ( & V_170 -> V_2 , L_19 ) ;
V_44 = - V_121 ;
goto free;
}
V_173 = F_84 ( & V_170 -> V_2 , V_172 -> V_179 ,
F_85 ( V_172 ) , V_172 -> V_124 ) ;
if ( ! V_173 ) {
F_15 ( & V_170 -> V_2 , L_20 ) ;
V_44 = - V_121 ;
goto free;
}
V_43 -> V_125 = V_173 -> V_179 ;
V_172 = F_83 ( V_170 , V_178 , 1 ) ;
if ( V_172 ) {
V_174 = F_84 ( & V_170 -> V_2 , V_172 -> V_179 ,
F_85 ( V_172 ) , V_172 -> V_124 ) ;
if ( ! V_174 ) {
F_15 ( & V_170 -> V_2 , L_21 ) ;
V_44 = - V_121 ;
...
V_43 -> V_20 = V_174 -> V_179 ;
V_43 -> V_126 = V_174 -> V_180 ;
}
V_172 = F_83 ( V_170 , V_181 , 0 ) ;
if ( ! V_172 ) {
F_15 ( & V_170 -> V_2 , L_22 ) ;
V_44 = - V_121 ;
goto free;
}
V_43 -> V_87 = V_172 -> V_179 ;
V_60 = F_17 ( V_43 ) ;
V_60 -> V_43 = V_43 ;
V_60 -> V_182 = 0 ;
V_60 -> V_183 = F_85 ( V_173 ) ;
V_60 -> V_4 = F_86 ( & V_170 -> V_2 , V_43 -> V_125 ,
F_85 ( V_173 ) ) ;
if ( ! V_60 -> V_4 ) {
F_15 ( & V_170 -> V_2 , L_23 ) ;
V_44 = - V_121 ;
...
if ( V_43 -> V_126 ) {
V_60 -> V_30 = F_86 ( & V_170 -> V_2 ,
V_43 -> V_20 , F_85 ( V_174 ) ) ;
if ( ! V_60 -> V_30 ) {
F_15 ( & V_170 -> V_2 , L_24 ) ;
V_44 = - V_121 ;
goto error;
...
V_60 -> V_30 = F_87 ( & V_170 -> V_2 ,
V_184 , ( void * ) & V_43 -> V_20 ,
V_185 ) ;
if ( ! V_60 -> V_30 ) {
F_15 ( & V_170 -> V_2 , L_25 ,
V_184 ) ;
...
V_43 -> V_126 = V_43 -> V_20 + V_184 ;
V_60 -> V_182 = V_184 ;
}
V_175 = F_88 (unsigned int,
128 , (netdev->mem_end - netdev->mem_start + 1) / ETHOC_BUFSIZ) ;
if ( V_175 < 4 ) {
V_44 = - V_135 ;
goto error;
}
V_60 -> V_27 = F_89 ( V_175 >> 1 ) ;
V_60 -> V_35 = V_175 - V_60 -> V_27 ;
F_48 ( & V_170 -> V_2 , L_26 ,
V_60 -> V_27 , V_60 -> V_35 ) ;
V_60 -> V_22 = F_90 ( & V_170 -> V_2 , V_175 * sizeof( void * ) , V_185 ) ;
if ( ! V_60 -> V_22 ) {
V_44 = - V_177 ;
goto error;
}
if ( V_170 -> V_2 . V_186 ) {
struct V_187 * V_188 = V_170 -> V_2 . V_186 ;
memcpy ( V_43 -> V_139 , V_188 -> V_189 , V_190 ) ;
V_60 -> V_118 = V_188 -> V_118 ;
} else {
V_60 -> V_118 = - 1 ;
#ifdef F_91
{
const T_7 * V_94 ;
V_94 = F_92 ( V_170 -> V_2 . V_191 ,
L_27 ,
NULL ) ;
if ( V_94 )
memcpy ( V_43 -> V_139 , V_94 , V_190 ) ;
}
#endif
}
if ( ! F_66 ( V_43 -> V_139 ) )
F_32 ( V_43 , V_43 -> V_139 ) ;
if ( ! F_66 ( V_43 -> V_139 ) ) {
F_93 ( V_43 -> V_139 ) ;
V_176 = true ;
}
...
V_60 -> V_119 -> V_124 = L_28 ;
snprintf ( V_60 -> V_119 -> V_194 , V_195 , L_29 ,
V_60 -> V_119 -> V_124 , V_170 -> V_194 ) ;
V_60 -> V_119 -> V_196 = F_36 ;
V_60 -> V_119 -> V_197 = F_39 ;
V_60 -> V_119 -> V_198 = F_40 ;
V_60 -> V_119 -> V_60 = V_60 ;
V_60 -> V_119 -> V_87 = F_95 ( sizeof( int ) * V_133 , V_185 ) ;
if ( ! V_60 -> V_119 -> V_87 ) {
V_44 = - V_177 ;
goto V_199;
}
for ( V_104 = 0 ; V_104 < V_133 ; V_104 ++ )
V_60 -> V_119 -> V_87 [ V_104 ] = V_200 ;
V_44 = F_96 ( V_60 -> V_119 ) ;
if ( V_44 ) {
F_15 ( & V_43 -> V_2 , L_30 ) ;
goto V_199;
}
...
static int F_110 ( struct V_169 * V_170 , T_8 V_207 )
{
return - V_138 ;
}
