...
static T_5 int F_36 ( struct V_41 * V_41 )
{
struct V_1 * V_42 ;
V_41 -> V_43 . V_44 = V_45 ;
V_42 = V_46 ;
if ( ! F_37 ( V_41 , & V_47 ) ) {
V_42 = F_38 ( V_42 , sizeof( V_46 ) , V_30 ) ;
if ( V_42 == NULL )
goto V_48;
V_42 [ 0 ] . V_12 = & V_41 -> V_43 . V_44 ;
if ( V_41 -> V_49 != & V_50 ) {
V_42 [ 0 ] . V_51 = NULL ;
}
}
V_41 -> V_43 . V_52 = F_39 ( V_41 , L_1 , V_42 ) ;
if ( V_41 -> V_43 . V_52 == NULL )
goto V_53;
return 0 ;
V_53:
if ( V_42 != V_46 )
...
static T_6 void F_40 ( struct V_41 * V_41 )
{
struct V_1 * V_42 ;
V_42 = V_41 -> V_43 . V_52 -> V_54 ;
F_41 ( V_41 -> V_43 . V_52 ) ;
F_42 ( V_42 == V_46 ) ;
F_23 ( V_42 ) ;
}
