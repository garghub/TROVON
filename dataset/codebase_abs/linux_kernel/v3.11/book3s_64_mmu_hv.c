...
if ( V_81 )
return - V_193 ;
V_133 = ( V_133 & ~ ( V_200 | V_201 | V_165 ) ) | V_59 ;
}
...
F_82 ( V_185 ) ;
V_144 [ 0 ] |= V_113 ;
F_83 ( V_1 , V_144 , V_145 ) ;
V_133 |= V_144 [ 1 ] & ( V_57 | V_58 ) ;
} else {
F_84 ( V_1 , V_5 , V_185 , V_145 , 0 ) ;
}
V_144 [ 1 ] = V_133 ;
F_85 () ;
V_144 [ 0 ] = V_181 [ 0 ] ;
...
T_5 V_73 , V_214 ;
V_212 = F_92 ( V_74 , V_41 -> V_101 ) ;
V_213 = F_93 ( V_209 , V_41 -> V_101 +
( V_41 -> V_44 << V_15 ) ) ;
if ( V_212 >= V_213 )
continue;
V_73 = F_94 ( V_212 , V_41 ) ;
V_214 = F_94 ( V_213 + V_99 - 1 , V_41 ) ;
for (; V_73 < V_214 ; ++ V_73 ) {
T_5 V_215 = V_73 - V_41 -> V_88 ;
V_53 = F_91 ( V_1 , & V_41 -> V_18 . V_185 [ V_215 ] , V_73 ) ;
V_211 |= V_53 ;
}
}
return V_211 ;
}
static int F_95 ( struct V_1 * V_1 , unsigned long V_184 ,
int (* F_91)( struct V_1 * V_1 , unsigned long * V_210 ,
unsigned long V_73 ) )
{
return F_90 ( V_1 , V_184 , V_184 + 1 , F_91 ) ;
}
static int F_96 ( struct V_1 * V_1 , unsigned long * V_210 ,
unsigned long V_73 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_216 , V_43 , V_217 ;
unsigned long * V_144 ;
...
V_217 = V_5 [ V_43 ] . V_220 ;
if ( V_217 == V_43 ) {
* V_210 &= ~ ( V_218 | V_219 ) ;
} else {
V_216 = V_5 [ V_43 ] . V_221 ;
V_5 [ V_216 ] . V_220 = V_217 ;
V_5 [ V_217 ] . V_221 = V_216 ;
V_5 [ V_43 ] . V_220 = V_5 [ V_43 ] . V_221 = V_43 ;
* V_210 = ( * V_210 & ~ V_219 ) | V_217 ;
}
V_106 = V_5 [ V_43 ] . V_153 ;
V_49 = F_50 ( V_144 [ 0 ] , V_106 ) ;
if ( ( V_144 [ 0 ] & V_114 ) &&
F_97 ( V_106 , V_49 ) == V_73 ) {
if ( V_1 -> V_18 . V_109 )
V_144 [ 0 ] |= V_113 ;
F_83 ( V_1 , V_144 , V_43 ) ;
...
int F_99 ( struct V_1 * V_1 , unsigned long V_184 )
{
if ( V_1 -> V_18 . V_109 )
F_95 ( V_1 , V_184 , F_96 ) ;
return 0 ;
}
int F_100 ( struct V_1 * V_1 , unsigned long V_74 , unsigned long V_209 )
{
if ( V_1 -> V_18 . V_109 )
F_90 ( V_1 , V_74 , V_209 , F_96 ) ;
return 0 ;
}
void F_101 ( struct V_1 * V_1 , struct V_40 * V_41 )
{
unsigned long * V_210 ;
unsigned long V_73 ;
unsigned long V_222 ;
V_210 = V_41 -> V_18 . V_185 ;
V_73 = V_41 -> V_88 ;
for ( V_222 = V_41 -> V_44 ; V_222 ; -- V_222 ) {
if ( * V_210 & V_218 )
F_96 ( V_1 , V_210 , V_73 ) ;
++ V_210 ;
++ V_73 ;
...
static int F_102 ( struct V_1 * V_1 , unsigned long * V_210 ,
unsigned long V_73 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_223 , V_43 , V_217 ;
unsigned long * V_144 ;
int V_53 = 0 ;
V_224:
F_80 ( V_210 ) ;
...
V_144 [ 0 ] &= ~ V_112 ;
} while ( ( V_43 = V_217 ) != V_223 );
F_82 ( V_210 ) ;
return V_53 ;
}
int F_104 ( struct V_1 * V_1 , unsigned long V_184 )
{
if ( ! V_1 -> V_18 . V_109 )
return 0 ;
return F_95 ( V_1 , V_184 , F_102 ) ;
}
static int F_105 ( struct V_1 * V_1 , unsigned long * V_210 ,
unsigned long V_73 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_223 , V_43 , V_217 ;
...
V_43 = V_223 = * V_210 & V_219 ;
do {
V_226 = ( unsigned long * ) ( V_1 -> V_18 . V_21 + ( V_43 << 4 ) ) ;
V_217 = V_5 [ V_43 ] . V_220 ;
if ( V_226 [ 1 ] & V_57 )
goto V_34;
} while ( ( V_43 = V_217 ) != V_223 );
...
int F_106 ( struct V_1 * V_1 , unsigned long V_184 )
{
if ( ! V_1 -> V_18 . V_109 )
return 0 ;
return F_95 ( V_1 , V_184 , F_105 ) ;
}
void F_107 ( struct V_1 * V_1 , unsigned long V_184 , T_4 V_198 )
{
if ( ! V_1 -> V_18 . V_109 )
return;
F_95 ( V_1 , V_184 , F_96 ) ;
}
static int F_108 ( struct V_1 * V_1 , unsigned long * V_210 )
{
struct V_4 * V_5 = V_1 -> V_18 . V_26 ;
unsigned long V_223 , V_43 , V_217 ;
unsigned long * V_144 ;
...
static void F_109 ( struct V_228 * V_229 ,
struct V_40 * V_41 ,
unsigned long * V_230 )
{
unsigned long V_73 ;
if ( ! V_229 -> V_231 || ! V_229 -> V_232 )
return;
V_73 = V_229 -> V_108 >> V_15 ;
if ( V_73 < V_41 -> V_88 ||
V_73 >= V_41 -> V_88 + V_41 -> V_44 )
return;
V_229 -> V_231 = false ;
if ( V_230 )
F_110 ( V_73 - V_41 -> V_88 , V_230 ) ;
}
long F_111 ( struct V_1 * V_1 , struct V_40 * V_41 ,
unsigned long * V_230 )
{
unsigned long V_43 ;
unsigned long * V_210 ;
...
if ( F_108 ( V_1 , V_210 ) && V_230 )
F_110 ( V_43 , V_230 ) ;
++ V_210 ;
}
F_112 (i, vcpu, kvm) {
F_48 ( & V_39 -> V_18 . V_233 ) ;
F_109 ( & V_39 -> V_18 . V_229 , V_41 , V_230 ) ;
F_109 ( & V_39 -> V_18 . V_234 , V_41 , V_230 ) ;
F_49 ( & V_39 -> V_18 . V_233 ) ;
}
F_72 () ;
return 0 ;
}
void * F_113 ( struct V_1 * V_1 , unsigned long V_108 ,
unsigned long * V_235 )
{
struct V_40 * V_41 ;
...
if ( V_235 )
* V_235 = V_99 - V_236 ;
return F_115 ( V_76 ) + V_236 ;
V_29:
F_89 ( & V_1 -> V_207 , V_206 ) ;
return NULL ;
}
void F_116 ( struct V_1 * V_1 , void * V_238 , unsigned long V_108 ,
bool V_231 )
{
struct V_76 * V_76 = F_117 ( V_238 ) ;
struct V_40 * V_41 ;
unsigned long V_73 ;
unsigned long * V_185 ;
int V_206 ;
F_45 ( V_76 ) ;
if ( ! V_231 || ! V_1 -> V_18 . V_109 )
return;
V_73 = V_108 >> V_15 ;
V_206 = F_87 ( & V_1 -> V_207 ) ;
V_41 = F_51 ( V_1 , V_73 ) ;
...
static int F_118 ( struct V_4 * V_239 , unsigned long * V_240 )
{
unsigned long V_241 ;
if ( V_239 -> V_153 & V_242 )
return 1 ;
V_241 = ~ V_239 -> V_153 & ( V_57 | V_58 ) ;
if ( ( V_240 [ 0 ] & V_114 ) && ( V_240 [ 1 ] & V_241 ) )
return 1 ;
return 0 ;
}
static long F_119 ( unsigned long V_103 , unsigned long * V_240 ,
unsigned long * V_181 , struct V_4 * V_239 ,
int V_243 , int V_244 )
{
...
int V_245 = 1 ;
int V_246 , V_231 ;
V_231 = F_118 ( V_239 , V_240 ) ;
if ( ! V_244 && ! V_231 )
return 0 ;
V_246 = 0 ;
if ( V_240 [ 0 ] & ( V_114 | V_113 ) ) {
V_246 = 1 ;
if ( ( V_103 & V_247 ) &&
! ( V_240 [ 0 ] & V_56 ) )
V_246 = 0 ;
...
if ( V_246 || V_231 ) {
F_69 () ;
while ( ! F_70 ( V_240 , V_112 ) )
F_71 () ;
V_132 = V_240 [ 0 ] ;
V_246 = ! ! ( V_132 & V_114 ) ;
V_231 = ! ! ( V_239 -> V_153 & V_242 ) ;
V_241 = ~ V_239 -> V_153 & ( V_57 | V_58 ) ;
if ( V_246 && ( V_241 & V_240 [ 1 ] ) ) {
V_239 -> V_153 |= ( V_240 [ 1 ] & ( V_57 | V_58 ) ) |
V_242 ;
V_231 = 1 ;
}
if ( V_132 & V_113 ) {
...
if ( ( V_103 & V_247 ) && ! ( V_132 & V_56 ) )
V_246 = 0 ;
V_133 = V_239 -> V_153 ;
if ( V_246 == V_243 && V_231 ) {
V_133 &= ~ V_242 ;
V_239 -> V_153 = V_133 ;
}
...
static T_6 F_120 ( struct V_248 * V_248 , char T_7 * V_249 ,
T_8 V_250 , T_9 * V_251 )
{
struct V_252 * V_253 = V_248 -> V_254 ;
struct V_1 * V_1 = V_253 -> V_1 ;
struct V_255 V_256 ;
unsigned long * V_240 ;
struct V_4 * V_239 ;
unsigned long V_43 , V_257 , V_258 ;
unsigned long T_7 * V_259 ;
struct V_255 T_7 * V_260 ;
unsigned long V_103 ;
int V_244 ;
unsigned long V_181 [ 2 ] ;
if ( ! F_121 ( V_261 , V_249 , V_250 ) )
return - V_193 ;
V_244 = V_253 -> V_244 ;
V_103 = V_253 -> V_103 ;
V_43 = V_253 -> V_145 ;
V_240 = ( unsigned long * ) ( V_1 -> V_18 . V_21 + ( V_43 * V_262 ) ) ;
V_239 = V_1 -> V_18 . V_26 + V_43 ;
V_259 = ( unsigned long T_7 * ) V_249 ;
V_257 = 0 ;
while ( V_257 + sizeof( V_256 ) + V_262 < V_250 ) {
V_260 = (struct V_255 T_7 * ) V_249 ;
V_256 . V_263 = 0 ;
V_256 . V_264 = 0 ;
V_258 = V_257 ;
V_257 += sizeof( V_256 ) ;
V_259 = ( unsigned long T_7 * ) ( V_249 + sizeof( V_256 ) ) ;
if ( ! V_244 ) {
...
V_256 . V_263 < 0xffff &&
V_257 + V_262 < V_250 &&
F_119 ( V_103 , V_240 , V_181 , V_239 , 1 , V_244 ) ) {
++ V_256 . V_263 ;
if ( F_122 ( V_181 [ 0 ] , V_259 ) ||
F_122 ( V_181 [ 1 ] , V_259 + 1 ) )
return - V_193 ;
V_257 += V_262 ;
V_259 += 2 ;
++ V_43 ;
...
while ( V_43 < V_1 -> V_18 . V_23 &&
V_256 . V_264 < 0xffff &&
F_119 ( V_103 , V_240 , V_181 , V_239 , 0 , V_244 ) ) {
++ V_256 . V_264 ;
++ V_43 ;
V_240 += 2 ;
++ V_239 ;
}
if ( V_256 . V_263 || V_256 . V_264 ) {
if ( F_123 ( V_260 , & V_256 , sizeof( V_256 ) ) )
return - V_193 ;
V_258 = V_257 ;
V_249 = ( char T_7 * ) V_259 ;
} else {
V_257 = V_258 ;
}
...
static T_6 F_124 ( struct V_248 * V_248 , const char T_7 * V_249 ,
T_8 V_250 , T_9 * V_251 )
{
struct V_252 * V_253 = V_248 -> V_254 ;
struct V_1 * V_1 = V_253 -> V_1 ;
struct V_255 V_256 ;
unsigned long V_43 , V_217 ;
unsigned long V_132 , V_133 ;
unsigned long T_7 * V_259 ;
unsigned long * V_240 ;
unsigned long V_265 [ 2 ] ;
T_6 V_257 ;
long int V_29 , V_53 ;
int V_266 ;
if ( ! F_121 ( V_267 , V_249 , V_250 ) )
return - V_193 ;
F_11 ( & V_1 -> V_31 ) ;
V_266 = V_1 -> V_18 . V_32 ;
if ( V_266 ) {
...
V_29 = 0 ;
for ( V_257 = 0 ; V_257 + sizeof( V_256 ) <= V_250 ; ) {
V_29 = - V_193 ;
if ( F_125 ( & V_256 , V_249 , sizeof( V_256 ) ) )
break;
V_29 = 0 ;
if ( V_257 + V_256 . V_263 * V_262 > V_250 )
break;
V_257 += sizeof( V_256 ) ;
V_249 += sizeof( V_256 ) ;
V_29 = - V_66 ;
V_43 = V_256 . V_145 ;
if ( V_43 >= V_1 -> V_18 . V_23 ||
V_43 + V_256 . V_263 + V_256 . V_264 > V_1 -> V_18 . V_23 )
break;
V_240 = ( unsigned long * ) ( V_1 -> V_18 . V_21 + ( V_43 * V_262 ) ) ;
V_259 = ( unsigned long T_7 * ) V_249 ;
for ( V_217 = 0 ; V_217 < V_256 . V_263 ; ++ V_217 ) {
V_29 = - V_193 ;
if ( F_126 ( V_132 , V_259 ) || F_126 ( V_133 , V_259 + 1 ) )
goto V_34;
V_29 = - V_66 ;
if ( ! ( V_132 & V_114 ) )
goto V_34;
...
if ( ! V_266 && F_128 ( V_132 ) ) {
unsigned long V_49 = F_50 ( V_132 , V_133 ) ;
unsigned long V_269 = F_129 ( V_49 ) ;
unsigned long V_270 ;
V_1 -> V_18 . V_151 = V_269 | V_129 |
( V_55 << V_271 ) ;
V_270 = V_1 -> V_18 . V_270 & ~ V_272 ;
V_270 |= V_269 << ( V_273 - 4 ) ;
V_1 -> V_18 . V_270 = V_270 ;
V_266 = 1 ;
}
++ V_43 ;
V_240 += 2 ;
}
for ( V_217 = 0 ; V_217 < V_256 . V_264 ; ++ V_217 ) {
if ( V_240 [ 0 ] & ( V_114 | V_113 ) )
F_127 ( V_1 , 0 , V_43 , 0 , V_265 ) ;
++ V_43 ;
V_240 += 2 ;
...
static int F_131 ( struct V_274 * V_274 , struct V_248 * V_275 )
{
struct V_252 * V_253 = V_275 -> V_254 ;
V_275 -> V_254 = NULL ;
if ( ! ( V_253 -> V_103 & V_276 ) )
F_132 ( & V_253 -> V_1 -> V_18 . V_277 ) ;
F_133 ( V_253 -> V_1 ) ;
F_134 ( V_253 ) ;
return 0 ;
}
int F_135 ( struct V_1 * V_1 , struct V_278 * V_279 )
{
int V_53 ;
struct V_252 * V_253 ;
int V_280 ;
if ( V_279 -> V_103 & ~ ( V_247 | V_276 ) )
return - V_66 ;
V_253 = F_136 ( sizeof( * V_253 ) , V_11 ) ;
if ( ! V_253 )
return - V_20 ;
F_137 ( V_1 ) ;
V_253 -> V_1 = V_1 ;
V_253 -> V_145 = V_279 -> V_281 ;
V_253 -> V_103 = V_279 -> V_103 ;
V_253 -> V_244 = 1 ;
V_280 = ( V_279 -> V_103 & V_276 ) ? V_282 : V_283 ;
V_53 = F_138 ( L_7 , & V_284 , V_253 , V_280 ) ;
if ( V_53 < 0 ) {
F_133 ( V_1 ) ;
return V_53 ;
}
if ( V_280 == V_283 ) {
F_11 ( & V_1 -> V_285 ) ;
F_139 ( & V_1 -> V_18 . V_277 ) ;
F_140 ( & V_1 -> V_207 ) ;
F_16 ( & V_1 -> V_285 ) ;
}
return V_53 ;
}
void F_141 ( struct V_38 * V_39 )
{
struct V_286 * V_287 = & V_39 -> V_18 . V_287 ;
if ( F_25 ( V_67 ) )
V_39 -> V_18 . V_124 = 32 ;
else
V_39 -> V_18 . V_124 = 64 ;
