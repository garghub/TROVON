...
static void F_151 ( struct V_160 * V_160 )
{
}
...
struct V_16 * V_17 = F_72 ( V_22 , struct V_16 , V_22 ) ;
struct V_57 * V_58 = V_17 -> V_58 ;
return sprintf ( V_263 , L_71 , V_58 -> V_199 ) ;
}
static T_7 F_185 (
struct V_34 * V_22 ,
const char * V_263 ,
...
struct V_261 * V_267 ;
int V_4 ;
V_267 = F_193 ( V_268 , L_57 ) ;
if ( F_19 ( V_267 ) ) {
F_17 ( L_74 ) ;
return F_20 ( V_267 ) ;
}
V_267 -> V_258 = V_269 ;
F_194 ( V_267 ) -> V_270 . V_271 = V_272 ;
F_194 ( V_267 ) -> V_273 . V_271 = V_274 ;
F_194 ( V_267 ) -> V_275 . V_271 = V_276 ;
F_194 ( V_267 ) -> V_277 . V_271 = NULL ;
F_194 ( V_267 ) -> V_278 . V_271 = NULL ;
F_194 ( V_267 ) -> V_279 . V_271 = NULL ;
F_194 ( V_267 ) -> V_280 . V_271 = NULL ;
F_194 ( V_267 ) -> V_281 . V_271 = NULL ;
F_194 ( V_267 ) -> V_282 . V_271 = NULL ;
V_4 = F_195 ( V_267 ) ;
if ( V_4 < 0 ) {
F_17 ( L_75 ) ;
return V_4 ;
