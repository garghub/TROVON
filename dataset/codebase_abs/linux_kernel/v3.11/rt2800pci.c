...
T_5 * V_168 = V_73 -> V_76 ;
T_2 V_75 ;
const unsigned int V_169 = V_53 -> V_40 -> V_170 ;
V_75 = 0 ;
F_15 ( & V_75 , V_171 , V_80 -> V_83 ) ;
F_36 ( V_168 , 0 , V_75 ) ;
V_75 = 0 ;
F_15 ( & V_75 , V_172 , V_53 -> V_81 -> V_66 ) ;
F_15 ( & V_75 , V_173 ,
! F_55 ( V_174 , & V_167 -> V_120 ) ) ;
F_15 ( & V_75 , V_175 ,
F_55 ( V_176 , & V_167 -> V_120 ) ) ;
F_15 ( & V_75 , V_177 , V_169 ) ;
F_15 ( & V_75 , V_178 , 0 ) ;
F_15 ( & V_75 , V_78 , 0 ) ;
F_36 ( V_168 , 1 , V_75 ) ;
V_75 = 0 ;
...
{
struct V_204 V_205 = { . V_120 = 0 } ;
struct V_206 V_207 = { . V_205 = & V_205 } ;
F_59 ( V_2 , & V_207 , V_208 ) ;
}
static bool F_60 ( struct V_52 * V_53 , T_2 V_209 )
{
T_5 * V_210 ;
T_2 V_75 ;
int V_211 , V_212 ;
V_211 = F_5 ( V_209 , V_213 ) ;
V_210 = F_61 ( V_53 ) ;
F_33 ( V_210 , 1 , & V_75 ) ;
V_212 = F_5 ( V_75 , V_214 ) ;
return ( V_212 == V_211 ) ;
}
...
T_2 V_209 = * ( T_2 * ) V_19 ;
if ( F_60 ( V_53 , V_209 ) &&
! F_55 ( V_215 , & V_53 -> V_120 ) ) {
V_53 -> V_209 = V_209 ;
F_63 ( V_215 , & V_53 -> V_120 ) ;
return true ;
}
return false ;
}
...
T_1 V_41 ;
int V_216 = 16 ;
while ( F_68 ( & V_2 -> V_217 , & V_209 ) ) {
V_41 = F_5 ( V_209 , V_218 ) ;
if ( F_46 ( V_41 >= V_42 ) ) {
F_69 ( V_2 , L_3 ,
V_41 ) ;
break;
...
F_81 ( V_2 ) ;
if ( V_2 -> V_225 ) {
if ( V_224 -> V_226 == ( V_227 - 2 ) ) {
F_4 ( V_2 , V_46 , & V_6 ) ;
F_15 ( & V_6 , V_228 ,
( V_2 -> V_229 * 16 ) - 1 ) ;
F_8 ( V_2 , V_46 , V_6 ) ;
} else if ( V_224 -> V_226 == ( V_227 - 1 ) ) {
F_4 ( V_2 , V_46 , & V_6 ) ;
F_15 ( & V_6 , V_228 ,
( V_2 -> V_229 * 16 ) ) ;
F_8 ( V_2 , V_46 , V_6 ) ;
...
static T_6 F_87 ( int V_232 , void * V_233 )
{
...
{
return F_95 ( V_251 , & V_252 ) ;
}
static int F_96 ( struct V_253 * V_253 ,
const struct V_254 * V_255 )
{
return F_97 ( V_253 , & V_252 ) ;
}
static int T_7 F_98 ( void )
{
int V_256 = 0 ;
#if F_99 ( V_257 ) || F_99 ( V_258 )
V_256 = F_100 ( & V_259 ) ;
if ( V_256 )
return V_256 ;
#endif
