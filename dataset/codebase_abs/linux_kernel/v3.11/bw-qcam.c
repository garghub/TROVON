...
static int F_38 ( struct V_90 * V_90 , void * V_91 ,
struct V_92 * V_93 )
{
struct V_1 * V_1 = F_39 ( V_90 ) ;
F_40 ( V_93 -> V_94 , V_1 -> V_95 . V_19 , sizeof( V_93 -> V_94 ) ) ;
F_40 ( V_93 -> V_96 , L_3 , sizeof( V_93 -> V_96 ) ) ;
F_40 ( V_93 -> V_97 , V_1 -> V_3 -> V_19 , sizeof( V_93 -> V_97 ) ) ;
V_93 -> V_98 = V_99 | V_100 |
V_101 ;
V_93 -> V_102 = V_93 -> V_98 | V_103 ;
return 0 ;
}
static int F_41 ( struct V_90 * V_90 , void * V_104 , struct V_105 * V_106 )
{
if ( V_106 -> V_107 > 0 )
return - V_108 ;
F_40 ( V_106 -> V_19 , L_4 , sizeof( V_106 -> V_19 ) ) ;
V_106 -> type = V_109 ;
V_106 -> V_110 = 0 ;
V_106 -> V_111 = 0 ;
V_106 -> V_112 = 0 ;
...
static int F_42 ( struct V_90 * V_90 , void * V_104 , unsigned int * V_113 )
{
* V_113 = 0 ;
return 0 ;
}
...
static int F_44 ( struct V_90 * V_90 , void * V_104 , struct V_71 * V_72 )
{
struct V_1 * V_1 = F_39 ( V_90 ) ;
...
static int F_48 ( struct V_90 * V_90 , void * V_104 , struct V_126 * V_72 )
{
...
static int F_49 ( struct V_90 * V_90 , void * V_104 ,
struct V_129 * V_130 )
{
...
{
struct V_1 * V_1 =
F_51 ( V_136 -> V_137 , struct V_1 , V_138 ) ;
int V_44 = 0 ;
switch ( V_136 -> V_139 ) {
case V_140 :
V_1 -> V_36 = V_136 -> V_5 ;
...
static struct V_1 * F_52 ( struct V_143 * V_144 )
{
struct V_1 * V_1 ;
struct V_145 * V_95 ;
struct V_69 * V_2 ;
int V_146 ;
V_1 = F_53 ( sizeof( struct V_1 ) , V_147 ) ;
if ( V_1 == NULL )
return NULL ;
V_95 = & V_1 -> V_95 ;
snprintf ( V_95 -> V_19 , sizeof( V_95 -> V_19 ) , L_7 , V_148 ) ;
if ( F_54 ( V_144 -> V_77 , V_95 ) < 0 ) {
F_55 ( V_95 , L_8 ) ;
F_56 ( V_1 ) ;
return NULL ;
}
F_57 ( & V_1 -> V_138 , 3 ) ;
F_58 ( & V_1 -> V_138 , & V_149 ,
V_140 , 0 , 255 , 1 , 180 ) ;
F_58 ( & V_1 -> V_138 , & V_149 ,
V_141 , 0 , 255 , 1 , 192 ) ;
F_58 ( & V_1 -> V_138 , & V_149 ,
...
V_146 = F_60 ( V_2 ) ;
if ( V_146 < 0 ) {
F_55 ( V_95 , L_10 , V_144 -> V_19 ) ;
goto exit;
}
V_1 -> V_163 . V_164 = V_2 ;
V_1 -> V_163 . V_164 -> V_78 = & V_1 -> V_150 ;
V_1 -> V_3 = V_144 ;
V_1 -> V_86 = F_61 ( V_144 , V_95 -> V_19 , NULL , NULL ,
NULL , 0 , NULL ) ;
if ( V_1 -> V_86 == NULL ) {
F_55 ( V_95 , L_11 , V_144 -> V_19 ) ;
goto exit;
}
F_40 ( V_1 -> V_163 . V_19 , L_12 , sizeof( V_1 -> V_163 . V_19 ) ) ;
V_1 -> V_163 . V_95 = V_95 ;
V_1 -> V_163 . V_165 = & V_1 -> V_138 ;
V_1 -> V_163 . V_166 = & V_167 ;
V_1 -> V_163 . V_78 = & V_1 -> V_78 ;
V_1 -> V_163 . V_168 = & V_169 ;
F_62 ( V_170 , & V_1 -> V_163 . V_171 ) ;
...
F_69 ( & V_1 -> V_138 ) ;
F_35 ( V_1 -> V_86 ) ;
F_70 ( & V_1 -> V_95 , L_14 , V_1 -> V_3 -> V_19 ) ;
if ( F_71 ( & V_1 -> V_163 , V_178 , V_179 ) < 0 ) {
F_68 ( V_1 -> V_86 ) ;
F_56 ( V_1 ) ;
return - V_177 ;
}
...
char * V_182 ;
unsigned long V_183 ;
V_183 = F_76 ( V_143 [ V_181 ] , & V_182 , 0 ) ;
...
static void F_77 ( struct V_143 * V_144 )
{
if ( F_74 ( V_144 ) )
F_67 ( V_144 ) ;
}
