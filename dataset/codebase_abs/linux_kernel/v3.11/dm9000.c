...
static struct V_224 * F_123 ( struct V_225 * V_2 )
{
struct V_224 * V_226 ;
struct V_227 * V_228 = V_2 -> V_229 ;
const void * V_230 ;
if ( ! F_124 ( V_231 ) || ! V_228 )
return NULL ;
V_226 = F_125 ( V_2 , sizeof( * V_226 ) , V_232 ) ;
if ( ! V_226 )
return F_126 ( - V_233 ) ;
if ( F_127 ( V_228 , L_30 , NULL ) )
V_226 -> V_17 |= V_67 ;
if ( F_127 ( V_228 , L_31 , NULL ) )
V_226 -> V_17 |= V_50 ;
V_230 = F_128 ( V_228 ) ;
if ( V_230 )
memcpy ( V_226 -> V_121 , V_230 , sizeof( V_226 -> V_121 ) ) ;
return V_226 ;
}
static int
F_129 ( struct V_103 * V_104 )
{
struct V_224 * V_226 = V_104 -> V_2 . V_234 ;
struct V_31 * V_3 ;
struct V_1 * V_93 ;
const unsigned char * V_235 ;
int V_19 = 0 ;
int V_236 ;
int V_12 ;
T_4 V_237 ;
if ( ! V_226 ) {
V_226 = F_123 ( & V_104 -> V_2 ) ;
if ( F_130 ( V_226 ) )
return F_131 ( V_226 ) ;
}
V_93 = F_132 ( sizeof( struct V_31 ) ) ;
if ( ! V_93 )
return - V_233 ;
F_133 ( V_93 , & V_104 -> V_2 ) ;
F_4 ( & V_104 -> V_2 , L_32 ) ;
V_3 = F_2 ( V_93 ) ;
V_3 -> V_2 = & V_104 -> V_2 ;
V_3 -> V_93 = V_93 ;
...
F_135 ( & V_3 -> V_20 ) ;
F_136 ( & V_3 -> V_37 , F_70 ) ;
V_3 -> V_238 = F_137 ( V_104 , V_239 , 0 ) ;
V_3 -> V_240 = F_137 ( V_104 , V_239 , 1 ) ;
V_3 -> V_217 = F_137 ( V_104 , V_241 , 0 ) ;
if ( V_3 -> V_238 == NULL || V_3 -> V_240 == NULL ||
V_3 -> V_217 == NULL ) {
F_110 ( V_3 -> V_2 , L_33 ) ;
V_19 = - V_73 ;
goto V_242;
}
V_3 -> V_90 = F_138 ( V_104 , 1 ) ;
if ( V_3 -> V_90 >= 0 ) {
F_4 ( V_3 -> V_2 , L_34 , V_3 -> V_90 ) ;
V_19 = F_116 ( V_3 -> V_90 , F_109 ,
V_220 , F_139 ( V_3 -> V_2 ) , V_93 ) ;
if ( V_19 ) {
F_110 ( V_3 -> V_2 , L_35 , V_19 ) ;
} else {
...
V_236 = F_140 ( V_3 -> V_238 ) ;
V_3 -> V_106 = F_141 ( V_3 -> V_238 -> V_243 , V_236 ,
V_104 -> V_59 ) ;
if ( V_3 -> V_106 == NULL ) {
F_110 ( V_3 -> V_2 , L_37 ) ;
V_19 = - V_244 ;
...
V_3 -> V_5 = F_142 ( V_3 -> V_238 -> V_243 , V_236 ) ;
if ( V_3 -> V_5 == NULL ) {
F_110 ( V_3 -> V_2 , L_38 ) ;
V_19 = - V_43 ;
goto V_242;
}
V_236 = F_140 ( V_3 -> V_240 ) ;
V_3 -> V_105 = F_141 ( V_3 -> V_240 -> V_243 , V_236 ,
V_104 -> V_59 ) ;
if ( V_3 -> V_105 == NULL ) {
F_110 ( V_3 -> V_2 , L_39 ) ;
V_19 = - V_244 ;
...
V_3 -> V_7 = F_142 ( V_3 -> V_240 -> V_243 , V_236 ) ;
if ( V_3 -> V_7 == NULL ) {
F_110 ( V_3 -> V_2 , L_40 ) ;
V_19 = - V_43 ;
goto V_242;
}
V_93 -> V_245 = ( unsigned long ) V_3 -> V_5 ;
V_93 -> V_205 = V_3 -> V_217 -> V_243 ;
F_37 ( V_3 , V_236 ) ;
if ( V_226 != NULL ) {
if ( V_226 -> V_17 & V_246 )
F_37 ( V_3 , 1 ) ;
...
V_3 -> V_17 |= V_100 ;
#endif
F_9 ( V_3 , V_4 , V_249 | V_6 ) ;
for ( V_12 = 0 ; V_12 < 8 ; V_12 ++ ) {
V_237 = F_7 ( V_3 , V_250 ) ;
V_237 |= ( T_4 ) F_7 ( V_3 , V_251 ) << 8 ;
V_237 |= ( T_4 ) F_7 ( V_3 , V_252 ) << 16 ;
V_237 |= ( T_4 ) F_7 ( V_3 , V_253 ) << 24 ;
if ( V_237 == V_254 )
break;
F_110 ( V_3 -> V_2 , L_41 , V_237 ) ;
}
if ( V_237 != V_254 ) {
F_110 ( V_3 -> V_2 , L_42 , V_237 ) ;
V_19 = - V_255 ;
goto V_242;
}
V_237 = F_7 ( V_3 , V_256 ) ;
F_4 ( V_3 -> V_2 , L_43 , V_237 ) ;
switch ( V_237 ) {
case V_257 :
V_3 -> type = V_108 ;
break;
...
break;
default:
F_4 ( V_3 -> V_2 , L_44 , V_237 ) ;
V_3 -> type = V_36 ;
}
if ( V_3 -> type == V_108 || V_3 -> type == V_109 ) {
V_93 -> V_132 = V_64 | V_259 ;
V_93 -> V_62 |= V_93 -> V_132 ;
}
F_144 ( V_93 ) ;
V_93 -> V_260 = & V_261 ;
V_93 -> V_262 = F_145 ( V_263 ) ;
V_93 -> V_264 = & V_265 ;
V_3 -> V_60 = V_266 ;
V_3 -> V_44 . V_267 = 0x1f ;
V_3 -> V_44 . V_268 = 0x1f ;
...
if ( ! F_146 ( V_93 -> V_121 ) && V_226 != NULL ) {
V_235 = L_46 ;
memcpy ( V_93 -> V_121 , V_226 -> V_121 , 6 ) ;
}
if ( ! F_146 ( V_93 -> V_121 ) ) {
V_235 = L_47 ;
...
return 0 ;
V_242:
F_110 ( V_3 -> V_2 , L_52 , V_19 ) ;
F_78 ( V_104 , V_3 ) ;
F_151 ( V_93 ) ;
return V_19 ;
}
static int
F_152 ( struct V_225 * V_2 )
{
struct V_103 * V_104 = F_50 ( V_2 ) ;
struct V_1 * V_93 = F_153 ( V_104 ) ;
T_1 * V_3 ;
if ( V_93 ) {
V_3 = F_2 ( V_93 ) ;
V_3 -> V_15 = 1 ;
