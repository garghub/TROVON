...
int F_42 ( struct V_79 * V_65 , int V_15 , int V_95 ,
T_1 V_34 , struct V_27 * * V_96 )
{
struct V_1 * V_9 = V_65 -> V_97 ;
struct V_27 * V_49 ;
T_3 V_98 ;
int V_78 ;
...
V_49 -> V_28 . V_5 -> V_101 = V_65 -> V_101 ;
F_18 ( V_49 , V_92 | V_50 ) ;
V_98 = F_44 ( & V_9 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_78 = F_45 ( & V_9 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_102 , & V_49 -> V_51 ,
V_95 >> V_61 , false , NULL , V_98 ,
NULL , F_12 ) ;
if ( V_78 )
return V_78 ;
* V_96 = V_49 ;
...
struct V_112 * V_113 ;
struct V_1 * V_9 ;
if ( F_53 ( V_111 -> V_114 < V_81 ) )
return F_54 ( V_53 , V_111 ) ;
V_113 = V_53 -> V_115 ;
V_9 = V_113 -> V_116 -> V_65 -> V_97 ;
