...
if ( ! V_10 -> V_116 . V_117 )
return 0 ;
V_6 = F_62 ( sizeof( struct V_5 ) , V_118 ) ;
if ( ! V_6 )
return - V_88 ;
V_6 -> V_10 = V_10 ;
V_9 -> V_6 = V_6 ;
...
F_65 ( & V_6 -> V_44 ) ;
if ( V_114 -> V_121 -> V_70 <= 32 * 1024 * 1024 )
V_115 = 8 ;
else
if ( V_114 -> V_121 -> V_70 <= 64 * 1024 * 1024 )
V_115 = 16 ;
else
V_115 = 32 ;
F_66 ( V_10 ) ;
...
{
struct V_8 * V_9 = V_8 ( V_10 ) ;
V_9 -> V_6 -> V_122 = V_9 -> V_6 -> V_44 . V_45 -> V_17 ;
V_9 -> V_6 -> V_44 . V_45 -> V_17 |= V_18 ;
}
void F_70 ( struct V_43 * V_10 )
{
struct V_8 * V_9 = V_8 ( V_10 ) ;
V_9 -> V_6 -> V_44 . V_45 -> V_17 = V_9 -> V_6 -> V_122 ;
}
