...
void T_3 F_43 ( struct V_76 * V_77 )
{
struct V_78 * V_78 = (struct V_78 * ) & V_77 -> V_79 ;
struct V_7 * V_8 ;
struct V_67 * V_67 ;
struct V_76 * V_80 ;
V_80 = F_44 ( V_77 ) ;
...
static int F_58 ( struct V_68 V_21 , void * V_93 )
{
struct V_26 V_26 ;
if ( F_30 ( V_21 , & V_26 ) != 0 )
return - V_71 ;
...
struct V_78 V_100 ;
if ( F_76 ( & V_100 ) ) {
F_36 ( V_100 . V_21 , (struct V_67 * ) & V_83 . V_67 ) ;
if ( F_71 ( & V_100 . V_21 , & V_21 ) )
return 0 ;
}
F_77 ( 100 ) ;
}
...
static int F_80 ( struct V_68 V_21 , struct V_26 * V_102 )
{
int V_103 ;
V_101 = 0 ;
V_104 = F_79 ;
...
static int F_82 ( struct V_68 V_21 , void * V_93 )
{
struct V_26 V_26 ;
if ( F_80 ( V_21 , & V_26 ) )
return - V_71 ;
...
static int F_100 ( struct V_68 V_21 , void * V_93 )
{
struct V_26 V_26 ;
...
static int F_101 ( struct V_127 * V_125 ,
struct V_68 * V_21 )
{
struct V_123 V_124 ;
V_124 . V_125 = * V_125 ;
...
void F_102 ( struct V_127 * V_125 )
{
struct V_68 V_128 ( V_21 ) ;
F_103 ( NULL , NULL ) ;
if ( F_101 ( V_125 , & V_21 ) != 0 )
F_104 ( L_19 ) ;
F_105 ( * ( ( V_43 * ) & V_21 ) ) ;
}
int T_1 F_106 ( struct V_129 * V_130 )
{
struct V_68 V_21 ;
struct V_26 V_26 ;
V_21 = * (struct V_68 * ) & V_83 . V_68 ;
if ( ! V_21 . V_131 )
return - V_24 ;
if ( F_30 ( V_21 , & V_26 ) )
return - V_24 ;
...
int F_107 ( struct V_7 * V_8 , struct V_134 * V_134 , T_4 V_19 , T_4 V_30 )
{
int V_99 ;
