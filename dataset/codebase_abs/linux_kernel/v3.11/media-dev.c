...
return - V_53 ;
if ( V_172 -> V_42 ++ == 0 ) {
F_109 ( V_172 -> clock , V_67 -> V_103 ) ;
V_172 -> V_178 = V_67 -> V_103 ;
V_43 = F_74 ( V_2 -> V_119 ) ;
if ( V_43 < 0 )
return V_43 ;
V_43 = F_110 ( V_172 -> clock ) ;
F_108 ( L_37 , V_67 -> V_102 ,
F_111 ( V_172 -> clock ) ) ;
}
return V_43 ;
}
...
static int F_113 ( struct V_15 * V_27 , bool V_179 )
{
struct V_180 * V_148 ;
struct V_13 * V_14 ;
struct V_181 * V_159 ;
...
static int F_116 ( struct V_15 * V_27 , bool V_179 )
{
struct V_15 * V_182 = V_27 ;
struct V_183 V_184 ;
int V_43 ;
F_117 ( & V_184 , V_27 ) ;
while ( ( V_27 = F_118 ( & V_184 ) ) ) {
if ( F_11 ( V_27 ) != V_185 )
continue;
V_43 = F_113 ( V_27 , V_179 ) ;
if ( V_43 < 0 )
goto V_186;
}
return 0 ;
...
static int F_119 ( struct V_187 * V_188 , unsigned int V_10 ,
unsigned int V_189 )
{
...
if ( V_189 == V_190 ) {
if ( ! ( V_10 & V_155 ) )
V_43 = F_116 ( V_152 , false ) ;
else
;
} else if ( V_189 == V_191 &&
( V_188 -> V_10 & V_155 ) ) {
V_43 = F_116 ( V_152 , true ) ;
}
return V_43 ? - V_192 : 0 ;
}
static T_3 F_120 ( struct V_139 * V_79 ,
struct V_193 * V_194 , char * V_195 )
{
struct V_131 * V_112 = F_89 ( V_79 ) ;
struct V_1 * V_2 = F_121 ( V_112 ) ;
if ( V_2 -> V_130 )
return F_122 ( V_195 , L_39 , V_196 ) ;
return F_122 ( V_195 , L_40 , V_196 ) ;
}
static T_3 F_123 ( struct V_139 * V_79 ,
struct V_193 * V_194 ,
...
V_200 -> V_202 = F_125 ( V_79 ) ;
if ( F_18 ( V_200 -> V_202 ) )
return F_76 ( V_200 -> V_202 ) ;
V_200 -> V_203 = F_126 ( V_200 -> V_202 ,
V_204 ) ;
if ( F_18 ( V_200 -> V_203 ) )
return F_76 ( V_200 -> V_203 ) ;
V_200 -> V_205 = F_126 ( V_200 -> V_202 ,
V_206 ) ;
return 0 ;
}
static int F_127 ( struct V_131 * V_112 )
{
struct V_139 * V_79 = & V_112 -> V_79 ;
struct V_207 * V_73 ;
struct V_1 * V_2 ;
int V_43 ;
V_2 = F_128 ( V_79 , sizeof( * V_2 ) , V_61 ) ;
if ( ! V_2 )
return - V_124 ;
F_129 ( & V_2 -> V_11 ) ;
V_2 -> V_112 = V_112 ;
F_130 ( & V_2 -> V_63 ) ;
F_122 ( V_2 -> V_208 . V_209 , L_43 ,
sizeof( V_2 -> V_208 . V_209 ) ) ;
V_2 -> V_208 . V_210 = F_119 ;
V_2 -> V_208 . V_79 = V_79 ;
V_73 = & V_2 -> V_73 ;
V_73 -> V_211 = & V_2 -> V_208 ;
V_73 -> V_212 = V_213 ;
F_122 ( V_73 -> V_76 , L_44 , sizeof( V_73 -> V_76 ) ) ;
V_2 -> V_170 = F_131 ( V_79 -> V_80 ) ;
V_43 = F_132 ( V_79 , & V_2 -> V_73 ) ;
if ( V_43 < 0 ) {
F_63 ( V_73 , L_45 , V_43 ) ;
return V_43 ;
}
V_43 = F_133 ( & V_2 -> V_208 ) ;
if ( V_43 < 0 ) {
F_63 ( V_73 , L_46 , V_43 ) ;
goto V_214;
}
...
if ( V_43 )
goto V_217;
V_43 = F_137 ( & V_112 -> V_79 , & V_219 ) ;
if ( V_43 )
goto V_217;
F_138 ( V_112 , V_2 ) ;
F_139 ( & V_2 -> V_208 . V_216 ) ;
return 0 ;
V_217:
F_139 ( & V_2 -> V_208 . V_216 ) ;
V_215:
...
static int F_142 ( struct V_131 * V_112 )
{
struct V_1 * V_2 = F_121 ( V_112 ) ;
if ( ! V_2 )
return 0 ;
F_143 ( & V_112 -> V_79 , & V_219 ) ;
F_94 ( V_2 ) ;
F_28 ( V_2 ) ;
F_140 ( & V_2 -> V_208 ) ;
F_102 ( V_2 ) ;
