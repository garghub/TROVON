...
V_312 = V_34 -> V_63 -> V_42 -> V_313 << V_34 -> V_69 ;
}
F_224 ( V_34 -> V_286 ,
V_34 -> V_73 ) ;
F_225 ( V_34 -> V_286 , V_312 ) ;
F_226 ( V_34 -> V_286 , - 1L ) ;
...
static int F_229 ( struct V_314 * V_85 , T_7 V_177 )
{
struct V_1 * V_63 ;
int V_40 ;
...
static int F_236 ( struct V_314 * V_85 , struct V_319 * V_320 )
{
struct V_1 * V_63 ;
V_63 = F_230 ( V_85 -> V_86 ) ;
if ( ! V_63 )
...
V_63 -> V_42 -> V_321 ( V_63 -> V_34 , V_320 ) ;
V_320 -> V_322 = F_237 ( V_85 ) >> V_63 -> V_34 -> V_69 ;
F_23 ( V_63 ) ;
return 0 ;
}
static void
...
if ( ! V_329 )
return 0 ;
F_246 ( V_2 -> V_56 , & V_326 ) ;
memset ( & V_328 , 0 , sizeof( V_328 ) ) ;
V_328 . V_330 = V_326 . V_331 ;
V_328 . V_332 = sizeof( V_328 ) ;
V_40 = V_327 ( & V_328 ) ;
if ( V_40 == 0 || V_40 == 2 ) {
return V_328 . V_333 & 0x80 ;
} else {
F_119 ( V_60 , L_98 ,
V_326 . V_331 , V_40 ) ;
return 0 ;
...
static void F_247 ( void * V_19 , T_8 V_334 )
{
...
V_56 -> V_337 = & F_156 ;
if ( ( F_252 ( V_56 , V_338 ) > 0 ) ||
( V_339 && F_253 ( F_35 ( & V_56 -> V_57 ) ) != 0 ) )
F_254 ( F_247 , V_56 ) ;
return 0 ;
}
...
F_266 ( V_343 , & V_2 -> V_192 ) ;
} else
if ( F_141 ( V_249 , & V_2 -> V_192 ) ) {
F_23 ( V_2 ) ;
return - V_208 ;
}
if ( F_267 ( V_343 , & V_2 -> V_192 ) &&
...
int F_271 ( struct V_226 * V_56 , int V_346 )
{
struct V_1 * V_2 ;
int V_335 ;
V_2 = F_153 ( V_56 ) ;
...
void F_272 ( struct V_226 * V_56 , int * V_351 )
{
int V_352 ;
T_9 V_353 , V_354 ;
struct V_1 * V_2 ;
...
V_354 = 0x80 >> V_352 ;
if ( V_351 [ V_352 ] & V_355 ) {
V_353 = V_2 -> V_216 . V_217 ;
V_2 -> V_216 . V_217 &= ~ V_354 ;
V_2 -> V_216 . V_220 &= ~ V_354 ;
V_2 -> V_216 . V_221 &= ~ V_354 ;
if ( V_353 && ! V_2 -> V_216 . V_217 ) {
F_269 ( & V_2 -> V_56 -> V_57 ,
L_118
L_113 ) ;
F_39 ( V_60 , V_2 ,
...
if ( V_351 [ V_352 ] & V_356 ) {
V_2 -> V_216 . V_217 &= ~ V_354 ;
V_2 -> V_216 . V_220 &= ~ V_354 ;
V_2 -> V_216 . V_221 &= ~ V_354 ;
V_2 -> V_216 . V_222 |= V_354 ;
F_75 ( V_2 ) ;
}
if ( V_351 [ V_352 ] & V_357 ) {
if ( ! ( V_2 -> V_216 . V_217 & V_354 ) &&
! ( V_2 -> V_216 . V_222 & V_354 ) ) {
V_2 -> V_216 . V_222 |= V_354 ;
F_75 ( V_2 ) ;
}
...
if ( F_30 ( V_2 ) )
return F_104 ( V_2 ) ;
F_124 ( V_359 , & V_2 -> V_192 ) ;
if ( V_2 -> V_42 -> V_360 )
V_40 = V_2 -> V_42 -> V_360 ( V_2 ) ;
F_179 ( V_2 , V_361 ) ;
F_12 ( & V_358 ) ;
F_173 ( F_146 ( V_56 ) ) ;
V_40 = 0 ;
...
V_194 = V_99 -> V_190 ;
V_194 -> V_366 = V_367 ;
if ( F_280 ( V_363 , V_364 ) ) {
V_365 = ( unsigned long * ) ( V_99 -> V_19 ) ;
V_194 -> V_368 = ( V_369 ) ( V_370 ) V_365 ;
V_194 -> V_192 = V_371 ;
V_365 = F_281 ( V_365 , V_363 , V_364 ) ;
} else {
V_194 -> V_368 = ( V_369 ) ( V_370 ) V_363 ;
V_194 -> V_192 = 0 ;
}
V_194 -> V_372 = V_364 ;
V_99 -> V_109 = V_2 ;
...
void * V_363 , int V_364 )
{
int V_335 ;
struct V_98 * V_99 ;
V_99 = F_279 ( V_2 , V_363 , V_364 ,
V_186 ) ;
if ( F_30 ( V_99 ) )
return F_104 ( V_99 ) ;
V_335 = F_198 ( V_99 ) ;
F_132 ( V_99 , V_99 -> V_362 ) ;
return V_335 ;
}
...
char * V_374 = NULL ;
if ( F_284 ( & V_229 -> V_233 ) && ( V_229 -> V_233 . V_375 . V_376 == 0x01 ) ) {
if ( V_229 -> V_233 . V_375 . V_377 )
V_373 = F_285 ( (struct V_377 * ) ( unsigned long )
V_229 -> V_233 . V_375 . V_377 ) ;
if ( V_373 && V_373 -> V_378 == 64 && V_373 -> V_192 )
switch ( V_373 -> V_192 & 0x07 ) {
case 1 :
V_374 = V_373 -> V_379 . V_380 . V_374 ;
break;
case 2 :
V_374 = V_373 -> V_379 . V_381 . V_374 ;
break;
default:
break;
}
} else if ( V_229 -> V_382 . V_383 . V_384 . V_385 ) {
V_374 = V_229 -> V_386 ;
}
return V_374 ;
}
...
F_288 ( & V_268 ) ;
F_288 ( & V_266 ) ;
V_324 = F_36 ( L_33 , 1 , 1 , 8 * sizeof( long ) ) ;
if ( V_324 == NULL ) {
V_40 = - V_4 ;
goto V_387;
}
