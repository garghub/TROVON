...
static inline struct V_96 * F_30 ( struct V_97 * V_98 )
{
return V_98 -> V_99 ;
}
static struct V_1 *
F_31 ( struct V_96 * V_48 , struct V_30 * V_31 ,
int V_32 )
{
int V_13 ;
...
static int F_32 ( struct V_30 * V_31 , T_1 V_32 ,
int V_33 , int V_12 , T_1 V_34 )
{
struct V_96 * V_48 = F_30 ( V_31 -> V_102 ) ;
struct V_1 * V_2 ;
unsigned long V_103 ;
int V_39 ;
V_2 = F_31 ( V_48 , V_31 , V_32 ) ;
if ( ! V_2 )
return V_104 ;
if ( V_31 -> V_35 == 0 )
...
F_33 ( V_32 ) != 0 )
return V_104 ;
F_34 ( & V_2 -> V_106 , V_103 ) ;
V_39 = F_20 ( V_2 , V_31 , V_32 ,
V_33 , V_12 , V_34 ) ;
F_35 ( & V_2 -> V_106 , V_103 ) ;
return V_39 ;
}
static int F_36 ( struct V_30 * V_31 , T_1 V_32 , int V_33 ,
int V_12 , T_1 * V_34 )
{
struct V_96 * V_48 = F_30 ( V_31 -> V_102 ) ;
struct V_1 * V_2 ;
...
if ( V_31 -> V_35 == 0 )
return F_28 ( V_2 , V_33 , V_12 , V_34 ) ;
if ( ! V_2 -> V_105 ) {
* V_34 = 0xffffffff ;
return V_104 ;
}
...
static int T_2 F_37 ( int V_6 , struct V_97 * V_98 )
{
struct V_96 * V_48 = F_30 ( V_98 ) ;
int V_13 ;
F_38 ( & V_98 -> V_107 , & V_48 -> V_108 , V_98 -> V_109 ) ;
F_38 ( & V_98 -> V_107 , & V_48 -> V_110 , V_98 -> V_111 ) ;
F_39 ( & V_98 -> V_107 , & V_48 -> V_112 ) ;
for ( V_13 = 0 ; V_13 < V_48 -> V_100 ; V_13 ++ ) {
struct V_1 * V_2 = & V_48 -> V_101 [ V_13 ] ;
F_15 ( V_2 ) ;
}
...
static int T_2 F_40 ( const struct V_113 * V_114 , T_5 V_115 , T_5 V_116 )
{
struct V_117 V_118 ;
int V_39 ;
V_39 = F_41 ( V_114 , & V_118 ) ;
if ( V_39 )
return V_39 ;
return F_42 ( V_118 . V_119 , V_118 . V_120 ,
V_118 . V_12 ) ;
}
static struct V_30 * F_43 ( int V_6 , struct V_97 * V_98 )
{
struct V_96 * V_48 = F_30 ( V_98 ) ;
struct V_30 * V_31 ;
V_31 = F_44 ( & V_48 -> V_121 -> V_114 , V_98 -> V_122 ,
...
return F_47 ( V_50 , F_48 ( ( T_6 ) V_128 , V_12 ) ) ;
else if ( V_125 -> V_103 & V_129 )
return F_47 ( V_50 , F_48 ( ( T_6 ) V_130 , V_12 ) ) ;
else
return V_50 ;
}
static void T_2 F_49 ( struct V_96 * V_48 )
{
struct V_131 V_132 ;
...
static void T_7 * T_2
F_51 ( struct V_139 * V_121 ,
struct V_140 * V_141 ,
struct V_1 * V_2 )
{
struct V_124 V_142 ;
int V_39 = 0 ;
V_39 = F_52 ( V_141 , 0 , & V_142 ) ;
if ( V_39 )
return NULL ;
return F_53 ( & V_121 -> V_114 , & V_142 ) ;
}
static int T_2 F_54 ( struct V_139 * V_121 )
{
struct V_96 * V_48 ;
struct V_140 * V_141 = V_121 -> V_114 . V_143 ;
struct V_144 V_145 ;
struct V_146 V_147 ;
struct V_140 * V_148 ;
int V_13 , V_39 ;
V_48 = F_55 ( & V_121 -> V_114 , sizeof( struct V_96 ) ,
V_149 ) ;
if ( ! V_48 )
return - V_150 ;
V_48 -> V_121 = V_121 ;
...
return - V_151 ;
F_57 (&parser, &range) {
unsigned long V_152 = V_145 . V_103 & V_153 ;
if ( V_152 == V_127 ) {
F_58 ( & V_145 , V_141 , & V_48 -> V_49 ) ;
F_58 ( & V_145 , V_141 , & V_48 -> V_108 ) ;
V_48 -> V_49 . V_51 = L_1 ;
V_48 -> V_108 . V_50 = F_59 ( T_6 ,
V_154 ,
V_145 . V_155 ) ;
V_48 -> V_108 . V_156 = F_60 ( T_6 ,
V_157 ,
V_145 . V_155 + V_145 . V_12 ) ;
}
if ( V_152 == V_129 ) {
F_58 ( & V_145 , V_141 , & V_48 -> V_110 ) ;
V_48 -> V_110 . V_51 = L_2 ;
}
}
V_39 = F_61 ( V_141 , & V_48 -> V_112 ) ;
if ( V_39 ) {
F_62 ( & V_121 -> V_114 , L_3 ,
V_39 ) ;
return V_39 ;
}
F_63 (pdev->dev.of_node, child) {
if ( ! F_64 ( V_148 ) )
continue;
V_48 -> V_100 ++ ;
}
V_48 -> V_101 = F_55 ( & V_121 -> V_114 , V_48 -> V_100 *
sizeof( struct V_1 ) ,
V_149 ) ;
if ( ! V_48 -> V_101 )
return - V_150 ;
...
& V_2 -> V_158 ) )
V_2 -> V_158 = 0 ;
V_2 -> V_51 = F_67 ( V_149 , L_7 ,
V_2 -> V_2 , V_2 -> V_158 ) ;
V_2 -> V_32 = F_68 ( V_148 ) ;
if ( V_2 -> V_32 < 0 )
continue;
V_2 -> V_3 = F_51 ( V_121 , V_148 , V_2 ) ;
if ( ! V_2 -> V_3 ) {
F_62 ( & V_121 -> V_114 , L_8 ,
V_2 -> V_2 , V_2 -> V_158 ) ;
continue;
}
F_5 ( V_2 , 1 ) ;
if ( F_1 ( V_2 ) ) {
V_2 -> V_105 = 1 ;
F_69 ( & V_121 -> V_114 , L_9 ,
V_2 -> V_2 , V_2 -> V_158 ) ;
} else {
V_2 -> V_105 = 0 ;
F_69 ( & V_121 -> V_114 , L_10 ,
V_2 -> V_2 , V_2 -> V_158 ) ;
}
V_2 -> V_159 = F_70 ( V_148 , NULL ) ;
if ( F_71 ( V_2 -> V_159 ) ) {
F_62 ( & V_121 -> V_114 , L_11 ,
V_2 -> V_2 , V_2 -> V_158 ) ;
F_72 ( V_2 -> V_3 ) ;
V_2 -> V_105 = 0 ;
continue;
