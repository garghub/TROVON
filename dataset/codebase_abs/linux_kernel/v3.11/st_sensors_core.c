...
goto V_51;
V_8 = F_2 ( V_4 ,
V_11 -> V_19 -> V_52 . V_31 , V_11 -> V_19 -> V_52 . V_6 , true ) ;
if ( V_8 < 0 )
goto V_51;
V_8 = F_11 ( V_4 , V_53 ) ;
V_51:
...
int V_8 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
if ( V_11 -> V_19 -> V_54 . V_55 . V_56 > 0 ) {
V_8 = F_2 ( V_4 ,
V_11 -> V_19 -> V_54 . V_55 . V_56 ,
V_11 -> V_19 -> V_54 . V_55 . V_57 , ( int ) V_42 ) ;
if ( V_8 < 0 )
goto V_58;
}
V_8 = F_2 ( V_4 ,
V_11 -> V_19 -> V_54 . V_31 ,
V_11 -> V_19 -> V_54 . V_6 , ( int ) V_42 ) ;
V_58:
return V_8 ;
}
int F_15 ( struct V_3 * V_4 , int V_59 )
{
int V_8 = - V_25 , V_23 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
for ( V_23 = 0 ; V_23 < V_36 ; V_23 ++ ) {
if ( ( V_11 -> V_19 -> V_34 . V_37 [ V_23 ] . V_60 == V_59 ) &&
( V_11 -> V_19 -> V_34 . V_37 [ V_23 ] . V_60 != 0 ) ) {
V_8 = 0 ;
break;
}
}
...
struct V_62 const * V_63 , int * V_7 )
{
int V_8 ;
T_2 * V_64 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
unsigned int V_65 = V_63 -> V_66 . V_67 >> 3 ;
V_64 = F_17 ( V_65 , V_68 ) ;
if ( ! V_64 ) {
V_8 = - V_25 ;
goto V_69;
}
V_8 = V_11 -> V_12 -> V_70 ( & V_11 -> V_14 , V_11 -> V_15 ,
V_63 -> V_71 , V_65 ,
V_64 , V_11 -> V_72 ) ;
if ( V_8 < 0 )
goto V_73;
...
struct V_62 const * V_63 , int * V_75 )
{
int V_8 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
F_21 ( & V_4 -> V_76 ) ;
...
if ( V_8 < 0 )
goto V_80;
F_22 ( ( V_11 -> V_19 -> V_81 * 1000 ) / V_11 -> V_20 ) ;
V_8 = F_16 ( V_4 , V_63 , V_75 ) ;
if ( V_8 < 0 )
goto V_80;
* V_75 = * V_75 >> V_63 -> V_66 . V_82 ;
V_8 = F_10 ( V_4 , false ) ;
}
F_23 ( & V_4 -> V_76 ) ;
return V_8 ;
...
int V_83 , const struct V_18 * V_84 )
{
T_2 V_85 ;
int V_23 , V_86 , V_8 ;
struct V_10 * V_11 = F_3 ( V_4 ) ;
...
if ( V_84 [ V_23 ] . V_85 == V_85 )
break;
}
if ( V_23 == V_83 )
goto V_89;
for ( V_86 = 0 ; V_86 < F_25 ( V_84 [ V_23 ] . V_90 ) ; V_86 ++ ) {
if ( strcmp ( V_4 -> V_91 ,
& V_84 [ V_23 ] . V_90 [ V_86 ] [ 0 ] ) == 0 )
break;
}
if ( V_86 == F_25 ( V_84 [ V_23 ] . V_90 ) ) {
F_9 ( & V_4 -> V_15 , L_3 ) ;
goto V_92;
}
V_11 -> V_19 = (struct V_18 * ) & V_84 [ V_23 ] ;
return V_23 ;
V_89:
F_9 ( & V_4 -> V_15 , L_4 , V_85 ) ;
V_92:
V_8 = - V_93 ;
V_88:
return V_8 ;
}
T_3 F_26 ( struct V_94 * V_15 ,
struct V_95 * V_96 , char * V_97 )
{
struct V_10 * V_98 = F_3 ( F_27 ( V_15 ) ) ;
return sprintf ( V_97 , L_5 , V_98 -> V_20 ) ;
}
T_3 F_28 ( struct V_94 * V_15 ,
struct V_95 * V_96 , const char * V_97 , T_4 V_99 )
{
int V_8 ;
unsigned int V_20 ;
struct V_3 * V_4 = F_27 ( V_15 ) ;
V_8 = F_29 ( V_97 , 10 , & V_20 ) ;
if ( V_8 < 0 )
goto V_100;
F_21 ( & V_4 -> V_76 ) ;
V_8 = F_6 ( V_4 , V_20 ) ;
F_23 ( & V_4 -> V_76 ) ;
V_100:
return V_8 < 0 ? V_8 : V_99 ;
}
T_3 F_30 ( struct V_94 * V_15 ,
struct V_95 * V_96 , char * V_97 )
{
int V_23 , V_101 = 0 ;
struct V_3 * V_4 = F_27 ( V_15 ) ;
...
break;
V_101 += F_31 ( V_97 + V_101 , V_102 - V_101 , L_6 ,
...
break;
V_101 += F_31 ( V_97 + V_101 , V_102 - V_101 , L_7 ,
V_11 -> V_19 -> V_34 . V_37 [ V_23 ] . V_60 ) ;
}
F_23 ( & V_4 -> V_76 ) ;
V_97 [ V_101 - 1 ] = '\n' ;
return V_101 ;
