...
unsigned long * V_14 )
{
return F_22 ( V_13 , V_46 - 1 , V_14 ) ;
}
static struct V_3
* F_27 ( struct V_17 * V_18 , int V_33 )
{
struct V_3 * V_4 ;
V_4 = F_28 ( V_18 -> V_30 , sizeof( * V_4 ) , V_55 ) ;
if ( ! V_4 ) {
F_10 ( V_18 -> V_30 , L_5 ) ;
return NULL ;
}
...
int F_31 ( struct V_17 * V_18 , int V_33 ,
char * V_56 )
{
struct V_3 * V_4 ;
V_4 = F_32 ( V_18 , V_33 ) ;
...
int F_36 ( struct V_17 * V_18 , int V_33 )
{
struct V_3 * V_4 ;
V_4 = F_32 ( V_18 , V_33 ) ;
F_37 ( V_4 -> V_6 ) ;
...
int F_38 ( struct V_17 * V_18 , int V_33 )
{
struct V_3 * V_4 ;
V_4 = F_32 ( V_18 , V_33 ) ;
F_39 ( & V_4 -> V_5 ) ;
...
int F_40 ( struct V_17 * V_18 , int V_33 )
{
struct V_3 * V_4 ;
V_4 = F_32 ( V_18 , V_33 ) ;
if ( ! V_4 || F_8 ( V_4 ) )
...
F_10 ( V_18 -> V_30 ,
L_9 ) ;
return F_34 ( V_4 -> V_35 ) ;
}
F_35 ( V_18 , V_33 , V_4 ) ;
return 0 ;
}
int F_43 ( struct V_17 * V_18 , int V_33 )
{
struct V_3 * V_4 ;
V_4 = F_32 ( V_18 , V_33 ) ;
F_44 ( V_4 -> V_35 ) ;
