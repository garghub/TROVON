...
V_34 -> V_54 + V_34 -> V_55 ;
V_51 = V_34 -> V_56 + V_34 -> V_57 +
V_34 -> V_58 + V_34 -> V_59 ;
F_17 ( V_3 ,
L_9 ,
V_34 -> V_52 , V_34 -> V_56 , V_34 -> V_60 ? L_10 : L_11 ,
( V_51 * V_50 ) > 0 ?
( int ) V_34 -> V_35 /
( V_51 * V_50 ) : 0 ,
V_50 , V_51 ,
( int ) V_34 -> V_35 , V_34 -> V_61 ) ;
} else {
F_17 ( V_3 , L_12 ) ;
}
F_16 ( V_3 , V_24 ) ;
...
{
struct V_13 * V_14 = V_6 -> V_64 . V_65 ;
struct V_1 * V_12 ;
struct V_2 * V_3 ;
if ( V_14 == NULL ) {
F_20 ( & V_6 -> V_64 , L_13 ) ;
...
if ( ! F_21 ( V_6 -> V_66 , V_67 ) )
return - V_68 ;
F_22 ( V_6 , L_14 ,
V_6 -> V_69 << 1 , V_6 -> V_66 -> V_70 ) ;
V_12 = F_23 ( & V_6 -> V_64 , sizeof( struct V_1 ) ,
V_71 ) ;
if ( ! V_12 )
return - V_72 ;
V_12 -> V_14 = V_14 ;
