...
F_10 ( V_4 , V_3 -> V_12 ) ) || F_11 ( V_13 ) ) &&
( ( F_12 ( V_6 , V_3 -> V_6 ) || F_12 ( V_6 , V_3 -> V_14 ) ||
F_12 ( V_6 , V_3 -> V_15 ) ) || F_11 ( V_16 ) ) ) {
return 0 ;
}
return - V_17 ;
}
static int F_13 ( struct V_18 * V_19 , struct V_20 * * V_21 )
{
int * V_22 = ( int * ) F_14 ( V_19 ) ;
struct V_20 * V_23 = * V_21 ;
struct V_24 * * V_25 ;
int V_26 , V_27 ;
V_27 = ( V_19 -> V_28 - F_15 ( sizeof( struct V_18 ) ) ) / sizeof( int ) ;
if ( V_27 <= 0 )
return 0 ;
if ( V_27 > V_29 )
return - V_7 ;
if ( ! V_23 )
{
V_23 = F_16 ( sizeof( struct V_20 ) , V_30 ) ;
if ( ! V_23 )
return - V_31 ;
* V_21 = V_23 ;
V_23 -> V_32 = 0 ;
...
int F_21 ( struct V_39 * V_40 , struct V_41 * V_42 , struct V_37 * V_43 )
{
struct V_18 * V_19 ;
int V_44 ;
for ( V_19 = F_22 ( V_42 ) ; V_19 ; V_19 = F_23 ( V_42 , V_19 ) )
{
V_44 = - V_7 ;
if ( ! F_24 ( V_42 , V_19 ) )
goto error;
...
goto error;
memcpy ( & V_2 , F_14 ( V_19 ) , sizeof( struct V_1 ) ) ;
V_44 = F_1 ( & V_2 ) ;
if ( V_44 )
goto error;
V_43 -> V_2 . V_8 = V_2 . V_8 ;
if ( ! V_43 -> V_8 || F_26 ( V_43 -> V_8 ) != V_2 . V_8 ) {
struct V_8 * V_8 ;
V_44 = - V_53 ;
V_8 = F_27 ( V_2 . V_8 ) ;
if ( ! V_8 )
...
goto V_67;
if ( F_33 ( F_14 ( V_57 ) , V_56 , V_61 - sizeof( struct V_18 ) ) )
goto V_67;
V_61 = F_34 ( V_55 ) ;
if ( V_42 -> V_64 < V_61 )
V_61 = V_42 -> V_64 ;
...
if ( V_69 < V_68 )
V_68 = V_69 ;
for ( V_26 = 0 , V_70 = ( V_58 int T_4 * ) F_14 ( V_57 ) ; V_26 < V_68 ;
V_26 ++ , V_70 ++ )
{
struct V_39 * V_40 ;
int V_71 ;
...
F_44 ( V_71 , F_45 ( V_34 [ V_26 ] ) ) ;
}
if ( V_26 > 0 )
{
int V_61 = F_25 ( V_26 * sizeof( int ) ) ;
...
if ( ! V_23 )
return NULL ;
V_75 = F_47 ( V_23 , F_48 ( struct V_20 , V_34 [ V_23 -> V_32 ] ) ,
V_30 ) ;
if ( V_75 ) {
