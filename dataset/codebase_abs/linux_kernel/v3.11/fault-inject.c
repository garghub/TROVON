...
struct V_36 * F_22 ( const char * V_37 ,
struct V_36 * V_39 , struct V_1 * V_2 )
{
T_3 V_38 = V_43 | V_44 | V_45 ;
struct V_36 * V_46 ;
V_46 = F_23 ( V_37 , V_39 ) ;
if ( ! V_46 )
return F_24 ( - V_47 ) ;
if ( ! F_17 ( L_4 , V_38 , V_46 , & V_2 -> V_4 ) )
goto V_48;
if ( ! F_17 ( L_5 , V_38 , V_46 , & V_2 -> V_5 ) )
goto V_48;
if ( ! F_25 ( L_6 , V_38 , V_46 , & V_2 -> V_6 ) )
goto V_48;
if ( ! F_25 ( L_7 , V_38 , V_46 , & V_2 -> V_7 ) )
goto V_48;
if ( ! F_17 ( L_8 , V_38 , V_46 , & V_2 -> V_9 ) )
goto V_48;
if ( ! F_26 ( L_9 , V_38 , V_46 , & V_2 -> V_31 ) )
goto V_48;
#ifdef F_27
if ( ! F_21 ( L_10 , V_38 , V_46 ,
& V_2 -> V_17 ) )
goto V_48;
if ( ! F_17 ( L_11 , V_38 , V_46 ,
& V_2 -> V_22 ) )
goto V_48;
if ( ! F_17 ( L_12 , V_38 , V_46 , & V_2 -> V_23 ) )
goto V_48;
if ( ! F_17 ( L_13 , V_38 , V_46 , & V_2 -> V_28 ) )
goto V_48;
if ( ! F_17 ( L_14 , V_38 , V_46 , & V_2 -> V_29 ) )
goto V_48;
#endif
return V_46 ;
V_48:
