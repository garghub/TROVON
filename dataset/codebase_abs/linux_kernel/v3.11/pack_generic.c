...
int F_69 ( struct V_7 * V_8 , int V_74 )
{
switch ( V_8 -> V_33 -> V_16 ) {
case V_5 :
...
static inline int F_71 ( struct V_2 * V_71 , int V_72 )
{
if ( V_72 >= V_71 -> V_26 )
return 0 ;
return V_71 -> V_3 [ V_72 ] ;
}
int F_72 ( struct V_15 * V_71 , int V_72 )
{
switch ( V_71 -> V_16 ) {
case V_5 :
return F_71 ( V_71 , V_72 ) ;
default:
F_17 ( L_1 , V_71 -> V_16 ) ;
return - V_6 ;
}
...
static inline void
F_73 ( struct V_2 * V_71 , int V_72 , int V_90 )
{
if ( V_72 >= V_71 -> V_26 )
F_74 () ;
V_71 -> V_3 [ V_72 ] = V_90 ;
}
void F_75 ( struct V_15 * V_71 , int V_72 , int V_90 )
{
switch ( V_71 -> V_16 ) {
case V_5 :
F_73 ( V_71 , V_72 , V_90 ) ;
...
char * F_77 ( struct V_15 * V_71 , int V_10 , int V_104 )
{
char * V_105 ;
int V_106 , V_107 ;
switch ( V_71 -> V_16 ) {
case V_5 :
V_105 = F_49 ( V_71 , V_10 , 0 ) ;
V_107 = F_71 ( V_71 , V_10 ) ;
break;
default:
F_5 ( 0 , L_1 , V_71 -> V_16 ) ;
}
...
V_106 = F_78 ( V_105 , V_107 ) ;
if ( V_106 == V_107 ) {
F_17 ( L_18
L_19 , V_71 , V_10 , V_107 ) ;
return NULL ;
}
if ( V_104 == 0 ) {
if ( V_106 != V_107 - 1 ) {
F_17 ( L_20
L_21 ,
V_71 , V_10 , V_107 , V_106 ) ;
return NULL ;
}
} else if ( V_106 > V_104 ) {
F_17 ( L_22
L_23 ,
V_71 , V_10 , V_107 , V_106 , V_104 ) ;
return NULL ;
}
return V_105 ;
}
static inline void * F_79 ( struct V_15 * V_11 , int V_10 ,
int V_73 , void * V_108 )
{
void * V_28 = NULL ;
F_21 ( V_11 != NULL ) ;
...
static inline struct V_24 * F_80 ( struct V_15 * V_11 )
{
return F_49 ( V_11 , V_25 ,
sizeof( struct V_20 ) ) ;
}
T_1 F_81 ( struct V_15 * V_11 )
{
switch ( V_11 -> V_16 ) {
case V_17 :
case V_109 :
...
void F_82 ( struct V_15 * V_11 , T_1 V_51 )
{
switch ( V_11 -> V_16 ) {
case V_17 :
return;
...
T_1 F_83 ( struct V_15 * V_11 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
if ( ! V_101 ) {
F_17 ( L_24 , V_11 ) ;
return 0 ;
}
...
void F_84 ( struct V_15 * V_11 , int V_51 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_88 ( struct V_15 * V_11 , int V_51 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
struct V_113 * F_90 ( struct V_15 * V_11 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_98 ( struct V_15 * V_11 , T_2 V_124 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_100 ( struct V_15 * V_11 , T_2 V_126 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_108 ( struct V_15 * V_11 , struct V_113 * V_131 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_109 ( struct V_15 * V_11 , T_1 type )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_110 ( struct V_15 * V_11 , T_1 V_132 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_111 ( struct V_15 * V_11 , T_2 V_133 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_112 ( struct V_15 * V_11 , T_2 V_134 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_113 ( struct V_15 * V_11 , T_2 * V_135 )
{
switch ( V_11 -> V_16 ) {
case V_17 :
return;
...
struct V_24 * V_101 = F_80 ( V_11 ) ;
F_5 ( V_101 , L_24 , V_11 ) ;
V_101 -> V_120 [ 0 ] = V_135 [ 0 ] ;
V_101 -> V_120 [ 1 ] = V_135 [ 1 ] ;
V_101 -> V_120 [ 2 ] = V_135 [ 2 ] ;
V_101 -> V_120 [ 3 ] = V_135 [ 3 ] ;
return;
}
default:
F_5 ( 0 , L_1 , V_11 -> V_16 ) ;
...
void F_115 ( struct V_15 * V_11 , T_1 V_137 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_116 ( struct V_15 * V_11 , T_1 V_138 )
{
switch ( V_11 -> V_16 ) {
case V_5 : {
struct V_24 * V_101 = F_80 ( V_11 ) ;
...
void F_117 ( struct V_15 * V_11 , T_1 V_139 )
{
switch ( V_11 -> V_16 ) {
case V_17 :
return;
...
void F_119 ( struct V_15 * V_11 , char * V_141 )
{
switch ( V_11 -> V_16 ) {
case V_17 :
return;
...
void F_121 ( struct V_15 * V_11 , T_1 V_146 )
{
switch ( V_11 -> V_16 ) {
case V_17 :
return;
...
int V_31 ;
V_53 ;
V_8 = F_126 ( V_151 , & V_159 ) ;
if ( V_8 == NULL )
RETURN ( - V_160 ) ;
F_127 ( & V_8 -> V_147 , & V_161 ,
V_162 , V_153 ) ;
F_127 ( & V_8 -> V_147 , & V_163 ,
V_162 , V_155 ) ;
V_31 = F_128 ( V_8 , V_12 , V_152 ) ;
if ( V_31 ) {
F_129 ( V_8 ) ;
RETURN ( V_31 ) ;
}
V_29 = F_130 ( & V_8 -> V_147 , & V_161 ) ;
memcpy ( V_29 , V_154 , V_153 ) ;
V_29 = F_130 ( & V_8 -> V_147 , & V_163 ) ;
...
void F_141 ( struct V_249 * V_250 )
{
F_139 ( & V_250 -> V_251 ) ;
F_61 ( & V_250 -> V_252 ) ;
F_61 ( & V_250 -> V_253 ) ;
}
void F_142 ( struct V_254 * V_255 )
{
F_135 ( & V_255 -> V_74 ) ;
F_61 ( & V_255 -> V_90 ) ;
F_61 ( & V_255 -> V_51 ) ;
}
void F_143 ( struct V_256 * V_164 )
{
F_138 ( & V_164 -> V_257 ) ;
}
void F_144 ( T_4 * V_258 )
{
F_135 ( V_258 ) ;
}
void F_145 ( T_1 * V_156 )
{
F_61 ( V_156 ) ;
}
void F_146 ( union V_259 * V_260 )
{
F_147 ( & V_260 -> V_261 . V_262 . V_263 ) ;
F_135 ( & V_260 -> V_261 . V_264 ) ;
F_135 ( & V_260 -> V_261 . V_265 ) ;
F_135 ( & V_260 -> V_261 . V_266 ) ;
F_135 ( & V_260 -> V_261 . V_267 ) ;
F_135 ( & V_260 -> V_261 . V_268 ) ;
F_62 ( F_3 ( F_63 ( V_260 -> V_261 ) , V_269 ) != 0 ) ;
}
void F_148 ( struct V_270 * V_271 )
{
F_135 ( & V_271 -> V_272 ) ;
F_135 ( & V_271 -> V_273 ) ;
F_135 ( & V_271 -> V_274 ) ;
...
void F_152 ( struct V_314 * V_164 )
{
F_135 ( & V_164 -> V_295 ) ;
F_61 ( & V_164 -> V_51 ) ;
F_62 ( F_3 ( F_63 ( * V_164 ) , V_315 ) != 0 ) ;
}
void F_153 ( struct V_316 * V_317 )
{
int V_22 ;
F_61 ( & V_317 -> V_318 ) ;
F_61 ( & V_317 -> V_319 ) ;
...
F_135 ( & V_317 -> V_326 [ V_22 ] ) ;
}
void F_154 ( struct V_327 * V_328 )
{
int V_22 ;
F_135 ( & V_328 -> V_329 ) ;
F_61 ( & V_328 -> V_330 ) ;
...
F_62 ( sizeof( V_324 ) == sizeof( T_2 ) ) ;
F_135 ( & V_328 -> V_336 . V_337 [ V_22 ] ) ;
}
}
void F_155 ( struct V_338 * V_339 )
{
F_135 ( & V_339 -> V_340 ) ;
F_61 ( & V_339 -> V_341 ) ;
F_137 ( & V_339 -> V_342 ) ;
}
void F_156 ( struct V_343 * V_339 )
{
F_135 ( & V_339 -> V_344 ) ;
F_135 ( & V_339 -> V_345 ) ;
}
static void F_157 ( struct V_346 * V_22 )
{
F_135 ( & V_22 -> V_347 ) ;
F_135 ( & V_22 -> V_348 ) ;
F_61 ( & V_22 -> V_349 ) ;
...
static void F_158 ( struct V_351 * V_164 )
{
F_135 ( & V_164 -> V_352 ) ;
F_135 ( & V_164 -> V_353 ) ;
F_135 ( & V_164 -> V_354 ) ;
...
F_162 ( & V_394 -> V_401 [ V_22 ] ) ;
}
void F_164 ( struct V_402 * V_403 )
{
F_61 ( & V_403 -> V_404 ) ;
F_61 ( & V_403 -> V_405 ) ;
F_137 ( & V_403 -> V_406 ) ;
...
void F_165 ( struct V_414 * V_415 )
{
F_61 ( & V_415 -> V_416 ) ;
F_137 ( & V_415 -> V_417 ) ;
F_137 ( & V_415 -> V_418 ) ;
}
void F_166 ( struct V_419 * V_420 )
{
F_61 ( & V_420 -> V_421 ) ;
F_61 ( & V_420 -> V_422 ) ;
F_61 ( & V_420 -> V_423 ) ;
...
F_147 ( & V_458 -> V_467 [ V_22 ] . V_469 ) ;
}
}
static void F_171 ( struct V_470 * V_458 )
{
F_51 ( V_471 , L_27 , V_458 ) ;
F_51 ( V_471 , L_28 , V_458 -> V_472 ) ;
F_51 ( V_471 , L_29 , V_458 -> V_473 ) ;
F_51 ( V_471 , L_30 V_474 L_31 , F_172 ( & V_458 -> V_475 ) ) ;
F_51 ( V_471 , L_32 V_474 L_31 , F_173 ( & V_458 -> V_475 ) ) ;
F_51 ( V_471 , L_33 , V_458 -> V_476 ) ;
F_51 ( V_471 , L_34 , V_458 -> V_477 ) ;
F_51 ( V_471 , L_35 ,
V_458 -> V_478 ) ;
}
static void F_174 ( struct V_479 * V_480 )
{
F_135 ( & V_480 -> V_480 . V_481 ) ;
F_135 ( & V_480 -> V_480 . V_482 ) ;
}
static void F_175 ( struct V_483 * V_458 )
{
V_53 ;
F_61 ( & V_458 -> V_472 ) ;
F_61 ( & V_458 -> V_473 ) ;
...
void F_177 ( struct V_485 * V_458 )
{
V_53 ;
F_51 ( V_484 , L_37 ) ;
F_175 ( (struct V_483 * ) V_458 ) ;
EXIT ;
}
void F_178 ( struct V_486 * V_487 )
{
V_53 ;
F_51 ( V_484 , L_38 ) ;
F_61 ( & V_487 -> V_472 ) ;
...
void F_179 ( struct V_489 * V_490 ,
int V_491 )
{
int V_22 ;
V_53 ;
for ( V_22 = 0 ; V_22 < V_491 ; V_22 ++ ) {
F_139 ( & ( V_490 [ V_22 ] . V_492 ) ) ;
F_61 ( & ( V_490 [ V_22 ] . V_493 ) ) ;
F_61 ( & ( V_490 [ V_22 ] . V_494 ) ) ;
}
EXIT ;
}
void F_180 ( struct V_495 * V_258 )
{
int V_22 ;
for ( V_22 = 0 ; V_22 < V_496 ; V_22 ++ )
F_135 ( & V_258 -> V_497 [ V_22 ] ) ;
}
void F_181 ( T_5 * V_498 )
{
F_135 ( & V_498 -> V_499 . V_500 ) ;
F_135 ( & V_498 -> V_499 . V_501 ) ;
F_135 ( & V_498 -> V_499 . V_302 ) ;
F_135 ( & V_498 -> V_502 . V_503 ) ;
F_61 ( & V_498 -> V_502 . V_504 ) ;
}
void F_182 ( struct V_505 * V_22 )
{
F_135 ( & V_22 -> V_132 ) ;
}
void F_183 ( struct V_506 * V_507 )
{
F_61 ( & V_507 -> V_508 ) ;
F_62 ( F_3 ( F_63 ( * V_507 ) , V_509 ) != 0 ) ;
F_180 ( & V_507 -> V_510 ) ;
}
void F_184 ( struct V_511 * V_512 )
{
F_183 ( & V_512 -> V_513 ) ;
F_61 ( & V_512 -> V_514 ) ;
F_61 ( & V_512 -> V_515 ) ;
...
void F_185 ( struct V_517 * V_518 )
{
F_61 ( & V_518 -> V_519 ) ;
F_184 ( & V_518 -> V_520 ) ;
F_61 ( & V_518 -> V_521 ) ;
}
void F_186 ( struct V_522 * V_507 )
{
F_61 ( & V_507 -> V_519 ) ;
...
void F_187 ( struct V_526 * V_164 )
{
F_147 ( & V_164 -> V_527 ) ;
F_147 ( (struct V_528 * ) & V_164 -> V_529 ) ;
F_61 ( & V_164 -> V_530 ) ;
F_135 ( & V_164 -> V_531 ) ;
F_135 ( & V_164 -> V_532 ) ;
F_135 ( & V_164 -> V_533 ) ;
}
void F_188 ( struct V_249 * V_250 )
{
F_51 ( V_534 ,
L_39 V_535 L_40
L_41 , F_189 ( & V_250 -> V_251 ) , V_250 -> V_252 ,
V_250 -> V_253 ) ;
}
void F_190 ( struct V_254 * V_536 )
{
F_51 ( V_534 , L_42 V_474 L_43 ,
V_536 -> V_74 , V_536 -> V_90 , V_536 -> V_51 ) ;
}
void F_191 ( struct V_200 * V_257 )
{
T_1 V_291 = V_257 -> V_202 ;
F_51 ( V_534 , L_44 , V_291 ) ;
if ( V_291 & V_537 )
F_51 ( V_534 , L_45 V_535 L_31 , F_189 ( & V_257 -> V_203 ) ) ;
if ( V_291 & V_538 )
...
static inline int F_194 ( struct V_7 * V_8 )
{
F_21 ( V_8 -> V_33 ) ;
switch ( V_8 -> V_33 -> V_16 ) {
case V_5 :
...
T_6 args ;
if ( F_10 ( V_8 ) ) {
V_566 = V_566 && F_194 ( V_8 ) ;
V_567 = V_567 && F_195 ( V_8 ) ;
}
...
F_58 ( & V_8 -> V_588 ) ,
F_199 ( V_8 ) ,
V_566 ? F_83 ( V_8 -> V_33 ) : - 1 ,
V_567 ? F_83 ( V_8 -> V_69 ) : - 1 ,
V_8 -> V_589 ,
V_567 ? F_96 ( V_8 -> V_69 ) : - 1 ) ;
}
void F_200 ( struct V_590 * V_591 )
{
F_147 ( & V_591 -> V_592 ) ;
F_135 ( & V_591 -> V_593 ) ;
F_135 ( & V_591 -> V_594 ) ;
...
void F_201 ( struct V_600 * V_601 )
{
F_135 ( & V_601 -> V_602 ) ;
F_61 ( & V_601 -> V_603 ) ;
F_62 ( F_3 ( F_63 ( * V_601 ) , V_604 ) != 0 ) ;
}
void F_202 ( struct V_605 * V_606 )
{
F_61 ( & V_606 -> V_607 ) ;
F_61 ( & V_606 -> V_608 ) ;
}
void F_203 ( struct V_609 * V_610 )
{
F_61 ( & V_610 -> V_611 ) ;
F_135 ( & V_610 -> V_612 ) ;
F_135 ( & V_610 -> V_613 ) ;
...
void F_204 ( struct V_615 * V_616 )
{
F_135 ( & V_616 -> V_74 ) ;
F_135 ( & V_616 -> V_617 ) ;
}
void F_205 ( struct V_618 * V_619 )
{
F_61 ( & V_619 -> V_620 ) ;
F_61 ( & V_619 -> V_621 ) ;
F_204 ( & V_619 -> V_622 ) ;
}
void F_206 ( struct V_623 * V_624 )
{
F_147 ( & V_624 -> V_625 ) ;
F_204 ( & V_624 -> V_626 ) ;
}
void F_207 ( struct V_627 * V_628 )
{
F_61 ( & V_628 -> V_629 ) ;
F_61 ( & V_628 -> V_630 ) ;
F_135 ( & V_628 -> V_631 ) ;
...
void F_208 ( struct V_633 * V_634 )
{
F_147 ( & V_634 -> V_635 ) ;
F_135 ( & V_634 -> V_636 ) ;
F_135 ( & V_634 -> V_637 . V_74 ) ;
F_135 ( & V_634 -> V_637 . V_617 ) ;
F_137 ( & V_634 -> V_638 ) ;
F_137 ( & V_634 -> V_639 ) ;
}
void F_209 ( struct V_640 * V_641 )
{
F_61 ( & V_641 -> V_642 ) ;
F_61 ( & V_641 -> V_643 ) ;
F_135 ( & V_641 -> V_644 ) ;
...
void F_210 ( struct V_647 * V_648 )
{
F_61 ( & V_648 -> V_649 ) ;
F_61 ( & V_648 -> V_650 ) ;
}
void F_211 ( struct V_651 * V_652 )
{
int V_22 ;
F_61 ( & V_652 -> V_653 ) ;
F_61 ( & V_652 -> V_654 ) ;
