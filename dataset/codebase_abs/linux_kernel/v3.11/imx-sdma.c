...
static bool F_60 ( struct V_155 * V_156 , void * V_244 )
{
struct V_161 * V_66 = V_244 ;
if ( ! F_61 ( V_156 ) )
return false ;
V_156 -> V_162 = V_66 ;
return true ;
}
static struct V_155 * F_62 ( struct V_245 * V_246 ,
struct V_247 * V_248 )
{
...
if ( V_246 -> V_253 != 3 )
return NULL ;
V_66 . V_167 = V_246 -> args [ 0 ] ;
V_66 . V_75 = V_246 -> args [ 1 ] ;
V_66 . V_143 = V_246 -> args [ 2 ] ;
return F_63 ( V_250 , F_60 , & V_66 ) ;
}
static int T_7 F_64 ( struct V_254 * V_255 )
{
const struct V_256 * V_257 =
F_65 ( V_258 , & V_255 -> V_27 ) ;
struct V_259 * V_260 = V_255 -> V_27 . V_261 ;
const char * V_231 ;
int V_24 ;
int V_69 ;
struct V_262 * V_263 ;
struct V_264 * V_265 = V_255 -> V_27 . V_266 ;
int V_62 ;
struct V_1 * V_2 ;
T_6 * V_215 ;
V_2 = F_66 ( sizeof( * V_2 ) , V_38 ) ;
if ( ! V_2 )
return - V_39 ;
F_67 ( & V_2 -> V_40 ) ;
V_2 -> V_27 = & V_255 -> V_27 ;
V_263 = F_68 ( V_255 , V_267 , 0 ) ;
V_69 = F_69 ( V_255 , 0 ) ;
if ( ! V_263 || V_69 < 0 ) {
V_24 = - V_18 ;
goto V_268;
}
if ( ! F_70 ( V_263 -> V_269 , F_71 ( V_263 ) , V_255 -> V_270 ) ) {
V_24 = - V_147 ;
goto V_271;
}
V_2 -> V_168 = F_72 ( & V_255 -> V_27 , L_21 ) ;
if ( F_73 ( V_2 -> V_168 ) ) {
V_24 = F_74 ( V_2 -> V_168 ) ;
goto V_272;
}
V_2 -> V_169 = F_72 ( & V_255 -> V_27 , L_22 ) ;
if ( F_73 ( V_2 -> V_169 ) ) {
V_24 = F_74 ( V_2 -> V_169 ) ;
goto V_272;
}
F_75 ( V_2 -> V_168 ) ;
F_75 ( V_2 -> V_169 ) ;
V_2 -> V_19 = F_76 ( V_263 -> V_269 , F_71 ( V_263 ) ) ;
if ( ! V_2 -> V_19 ) {
V_24 = - V_39 ;
goto V_273;
}
V_24 = F_77 ( V_69 , F_25 , 0 , L_23 , V_2 ) ;
if ( V_24 )
goto V_274;
V_2 -> V_83 = F_66 ( sizeof( * V_2 -> V_83 ) , V_38 ) ;
if ( ! V_2 -> V_83 ) {
V_24 = - V_39 ;
goto V_275;
}
...
V_215 [ V_62 ] = - V_18 ;
if ( V_257 )
V_255 -> V_276 = V_257 -> V_66 ;
V_2 -> V_5 = V_255 -> V_276 -> V_277 ;
F_78 ( V_278 , V_2 -> V_251 . V_252 ) ;
F_78 ( V_279 , V_2 -> V_251 . V_252 ) ;
F_79 ( & V_2 -> V_251 . V_280 ) ;
for ( V_62 = 0 ; V_62 < V_238 ; V_62 ++ ) {
struct V_9 * V_10 = & V_2 -> V_14 [ V_62 ] ;
V_10 -> V_2 = V_2 ;
F_67 ( & V_10 -> V_160 ) ;
V_10 -> V_156 . V_281 = & V_2 -> V_251 ;
F_80 ( & V_10 -> V_156 ) ;
V_10 -> V_14 = V_62 ;
F_81 ( & V_10 -> V_72 , F_23 ,
( unsigned long ) V_10 ) ;
if ( V_62 )
F_82 ( & V_10 -> V_156 . V_259 ,
& V_2 -> V_251 . V_280 ) ;
}
V_24 = F_59 ( V_2 ) ;
if ( V_24 )
...
F_53 ( V_2 , V_265 -> V_83 ) ;
if ( V_265 ) {
V_24 = F_57 ( V_2 , V_265 -> V_231 ) ;
if ( V_24 )
F_83 ( & V_255 -> V_27 , L_24 ) ;
} else {
V_24 = F_84 ( V_260 , L_25 ,
& V_231 ) ;
if ( V_24 )
F_83 ( & V_255 -> V_27 , L_26 ) ;
else {
V_24 = F_57 ( V_2 , V_231 ) ;
if ( V_24 )
F_83 ( & V_255 -> V_27 , L_27 ) ;
}
}
V_2 -> V_251 . V_27 = & V_255 -> V_27 ;
V_2 -> V_251 . V_283 = F_40 ;
V_2 -> V_251 . V_284 = F_43 ;
V_2 -> V_251 . V_285 = F_50 ;
V_2 -> V_251 . V_286 = F_45 ;
V_2 -> V_251 . V_287 = F_48 ;
V_2 -> V_251 . V_288 = F_49 ;
V_2 -> V_251 . V_289 = F_52 ;
V_2 -> V_251 . V_27 -> V_290 = & V_2 -> V_290 ;
F_85 ( V_2 -> V_251 . V_27 , 65535 ) ;
V_24 = F_86 ( & V_2 -> V_251 ) ;
if ( V_24 ) {
F_12 ( & V_255 -> V_27 , L_28 ) ;
goto V_282;
}
if ( V_260 ) {
V_24 = F_87 ( V_260 , F_62 , V_2 ) ;
if ( V_24 ) {
F_12 ( & V_255 -> V_27 , L_29 ) ;
goto V_291;
}
}
F_55 ( V_2 -> V_27 , L_30 ) ;
...
V_273:
V_272:
F_92 ( V_263 -> V_269 , F_71 ( V_263 ) ) ;
V_271:
V_268:
F_89 ( V_2 ) ;
return V_24 ;
}
static int F_93 ( struct V_254 * V_255 )
{
return - V_147 ;
}
static int T_7 F_94 ( void )
{
return F_95 ( & V_292 , F_64 ) ;
}
