...
V_13 = F_50 ( V_88 , NULL , V_22 . V_82 , NULL , L_9 ) ;
if ( F_48 ( V_13 ) ) {
F_7 ( L_14 ) ;
V_80 = F_49 ( V_13 ) ;
goto V_30;
...
int F_59 ( struct V_2 * V_3 , int V_89 )
{
struct V_1 * V_4 ;
struct V_1 * V_90 ;
if ( V_89 ) {
...
V_4 = F_60 ( sizeof( struct V_1 ) , V_91 ) ;
if ( V_4 == NULL )
return - V_92 ;
F_61 ( & V_4 -> V_8 , 1 ) ;
V_4 -> V_47 = 1 ;
...
F_21 ( & V_22 . V_23 ) ;
if ( ( V_22 . V_24 == NULL ) &&
( memcmp ( V_3 -> V_93 , V_22 . V_51 , V_52 ) == 0 ) ) {
F_15 ( V_3 ) ;
V_22 . V_24 = V_3 ;
F_7 ( L_16 ) ;
}
...
void F_62 ( struct V_2 * V_3 , int V_94 )
{
struct V_1 * V_4 ;
if ( V_94 ) {
F_7 ( L_18 ) ;
...
V_4 -> V_98 = V_38 -> V_46 ;
V_95 = V_36 -> V_42 - sizeof( struct V_37 ) ;
V_41 = ( ( T_5 * ) ( V_36 + 1 ) ) + sizeof( struct V_37 ) ;
if ( V_95 <= 0 )
goto V_40;
V_96 = V_4 -> V_27 - V_4 -> V_26 - 1 ;
if ( V_96 < 0 )
V_96 += V_28 ;
if ( V_95 > V_96 ) {
F_7 ( L_23 , V_95 , V_96 ) ;
...
if ( V_97 > V_95 )
V_97 = V_95 ;
memcpy ( & V_4 -> V_29 [ V_21 ] , V_41 , V_97 ) ;
V_95 -= V_97 ;
V_21 += V_97 ;
if ( V_21 == V_28 )
V_21 = 0 ;
if ( V_95 ) {
memcpy ( V_4 -> V_29 , V_41 + V_97 , V_95 ) ;
V_21 = V_95 ;
}
V_4 -> V_26 = V_21 ;
F_64 ( & V_22 . V_79 ) ;
