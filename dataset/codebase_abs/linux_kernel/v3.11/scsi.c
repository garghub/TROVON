...
unsigned int V_126 , unsigned char V_135 )
{
unsigned char V_6 [ 16 ] ;
struct V_136 V_137 ;
int V_58 ;
if ( V_32 -> V_138 || V_32 -> V_77 < V_139 )
return - V_134 ;
memset ( V_6 , 0 , 16 ) ;
V_6 [ 0 ] = V_140 ;
V_6 [ 1 ] = V_141 ;
...
& V_137 , 30 * V_86 , 3 , NULL ) ;
if ( V_58 && F_80 ( & V_137 ) &&
V_137 . V_142 == V_143 &&
( V_137 . V_144 == 0x20 || V_137 . V_144 == 0x24 ) && V_137 . V_145 == 0x00 )
return - V_134 ;
if ( ( V_124 [ 1 ] & 3 ) == 3 )
return 1 ;
return 0 ;
...
if ( ! F_19 ( & V_32 -> V_25 ) )
return - V_146 ;
F_82 ( V_32 -> V_26 -> V_53 -> V_147 ) ;
return 0 ;
}
void F_83 ( struct V_23 * V_32 )
{
#ifdef F_84
struct V_147 * V_147 = V_32 -> V_26 -> V_53 -> V_147 ;
if ( V_147 && F_85 ( V_147 ) != 0 )
F_86 ( V_147 ) ;
#endif
F_22 ( & V_32 -> V_25 ) ;
}
...
struct V_23 * V_148 )
{
struct V_149 * V_20 = ( V_148 ? & V_148 -> V_150 : & V_13 -> V_151 ) ;
struct V_23 * V_19 = NULL ;
unsigned long V_16 ;
F_12 ( V_13 -> V_152 , V_16 ) ;
while ( V_20 -> V_19 != & V_13 -> V_151 ) {
V_19 = F_15 ( V_20 -> V_19 , struct V_23 , V_150 ) ;
if ( ! F_81 ( V_19 ) )
break;
V_19 = NULL ;
V_20 = V_20 -> V_19 ;
}
F_17 ( V_13 -> V_152 , V_16 ) ;
if ( V_148 )
F_83 ( V_148 ) ;
return V_19 ;
}
void F_88 ( struct V_95 * V_96 , void * V_153 ,
void (* F_89)( struct V_23 * , void * ) )
{
struct V_12 * V_13 = F_90 ( V_96 -> V_24 . V_154 ) ;
struct V_23 * V_32 ;
F_91 (sdev, shost) {
if ( ( V_32 -> V_155 == V_96 -> V_155 ) &&
( V_32 -> V_156 == V_96 -> V_156 ) )
F_89 ( V_32 , V_153 ) ;
}
}
void F_92 ( struct V_95 * V_96 , void * V_153 ,
void (* F_89)( struct V_23 * , void * ) )
{
struct V_12 * V_13 = F_90 ( V_96 -> V_24 . V_154 ) ;
struct V_23 * V_32 ;
...
T_3 V_155 , T_3 V_156 , T_3 V_81 )
{
struct V_23 * V_32 ;
F_95 (sdev, &shost->__devices, siblings) {
if ( V_32 -> V_155 == V_155 && V_32 -> V_156 == V_156 &&
V_32 -> V_81 == V_81 )
return V_32 ;
}
return NULL ;
...
unsigned long V_16 ;
F_12 ( V_13 -> V_152 , V_16 ) ;
V_32 = F_97 ( V_13 , V_155 , V_156 , V_81 ) ;
if ( V_32 && F_81 ( V_32 ) )
V_32 = NULL ;
F_17 ( V_13 -> V_152 , V_16 ) ;
return V_32 ;
