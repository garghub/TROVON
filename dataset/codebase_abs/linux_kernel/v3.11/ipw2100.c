...
int V_63 ;
F_111 ( V_275 ) ;
F_42 ( L_97 , F_112 ( V_275 , V_269 , V_289 ) ) ;
if ( V_289 )
...
{
struct V_5 * V_6 = F_108 ( V_263 , struct V_5 ,
V_297 . V_263 ) ;
union V_217 V_218 ;
V_218 . V_37 . V_287 = 0 ;
V_218 . V_37 . V_62 = 0 ;
F_100 ( V_6 -> V_33 , V_298 , & V_218 , NULL ) ;
}
...
struct V_306 * V_61 )
{
V_61 -> V_307 = F_126 ( sizeof( struct V_308 ) ) ;
if ( ! V_61 -> V_307 )
return - V_240 ;
V_61 -> V_309 = (struct V_308 * ) V_61 -> V_307 -> V_37 ;
V_61 -> V_310 = F_127 ( V_6 -> V_261 , V_61 -> V_307 -> V_37 ,
sizeof( struct V_308 ) ,
V_311 ) ;
return 0 ;
}
...
return 1 ;
for ( V_19 = 0 ; V_19 < 0x30 ; V_19 ++ ) {
V_6 -> V_312 [ V_19 ] = F_131 ( 0x1000 , V_313 ) ;
if ( ! V_6 -> V_312 [ V_19 ] ) {
F_31 ( L_108
...
static T_1 F_132 ( struct V_5 * V_6 , T_3 * V_314 ,
T_4 V_14 , int V_315 )
{
T_1 V_19 , V_40 ;
T_1 V_316 ;
...
F_137 ( L_115 ) ;
if ( F_138 ( V_49 -> V_333 > F_139 ( V_61 -> V_307 ) ) ) {
F_31 ( L_116
L_117 ,
V_2 -> V_51 ,
V_49 -> V_333 , F_139 ( V_61 -> V_307 ) ) ;
V_2 -> V_329 . V_330 ++ ;
return;
}
if ( F_138 ( ! F_140 ( V_2 ) ) ) {
...
F_143 ( V_61 -> V_307 , V_49 -> V_333 ) ;
#ifdef F_144
F_145 ( V_61 -> V_307 , V_336 ,
F_146 ( T_1 , V_49 -> V_333 ,
V_337 ) ) ;
#endif
if ( ! F_147 ( V_6 -> V_150 , V_61 -> V_307 , V_329 ) ) {
#ifdef F_144
F_141 ( L_120 ,
V_2 -> V_51 ) ;
...
if ( F_138 ( V_6 -> V_187 & V_346 &&
V_49 -> V_62 & V_347 ) ) {
F_137 ( L_124 ) ;
V_2 -> V_329 . V_330 ++ ;
return;
}
F_142 ( V_6 -> V_261 , V_61 -> V_310 ,
sizeof( struct V_308 ) , V_311 ) ;
...
V_345 -> V_343 . V_350 = 0 ;
V_345 -> V_343 . V_351 = F_150 ( sizeof( struct V_341 ) ) ;
V_345 -> V_343 . V_352 = F_151 ( 1 << V_353 ) ;
V_345 -> V_344 = V_49 -> V_354 + V_355 ;
F_143 ( V_61 -> V_307 , V_49 -> V_333 + sizeof( struct V_341 ) ) ;
if ( ! F_147 ( V_6 -> V_150 , V_61 -> V_307 , V_329 ) ) {
V_2 -> V_329 . V_330 ++ ;
F_148 ( V_61 -> V_307 ) ;
V_61 -> V_307 = NULL ;
...
return 0 ;
#else
switch ( F_155 ( F_156 ( V_356 -> V_361 . V_368 . V_369 ) ) ) {
case V_370 :
case V_371 :
return 0 ;
case V_372 :
...
switch ( V_357 ) {
case V_360 :
F_123 ( V_6 , & V_356 -> V_361 . V_362 ) ;
break;
case V_363 :
F_121 ( V_6 , V_356 -> V_361 . V_49 ) ;
break;
case V_366 :
case V_367 :
#ifdef F_154
if ( V_6 -> V_150 -> V_198 == V_199 ) {
F_149 ( V_6 , V_19 , & V_329 ) ;
break;
}
#endif
...
V_59 = V_6 -> V_424 . V_77 ;
V_61 = F_45 ( V_59 , struct V_60 , V_78 ) ;
if ( F_138 ( 1 + V_61 -> V_81 . V_410 . V_411 -> V_425 >
V_426 ) ) {
F_31 ( L_141
L_142 ,
V_6 -> V_33 -> V_51 ) ;
...
static T_6 F_172 ( int V_457 , void * V_37 )
{
struct V_5 * V_6 = V_37 ;
T_1 V_157 , V_158 ;
if ( ! V_37 )
...
static T_7 F_176 ( struct V_462 * V_411 ,
...
F_161 ( L_160 , V_411 -> V_428 [ 0 ] -> V_14 ) ;
...
T_8 V_469 ;
V_6 -> V_470 =
F_131 ( V_471 * sizeof( struct V_60 ) ,
V_239 ) ;
if ( ! V_6 -> V_470 )
return - V_240 ;
for ( V_19 = 0 ; V_19 < V_471 ; V_19 ++ ) {
V_468 = F_178 ( V_6 -> V_261 ,
...
static T_9 F_183 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
...
static T_9 F_185 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
struct V_5 * V_469 = F_186 ( V_318 ) ;
return sprintf ( V_15 , L_166 , ( int ) V_469 -> V_187 ) ;
}
static T_9 F_187 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
struct V_5 * V_469 = F_186 ( V_318 ) ;
return sprintf ( V_15 , L_166 , ( int ) V_469 -> V_49 ) ;
}
static T_9 F_188 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
struct V_5 * V_469 = F_186 ( V_318 ) ;
return sprintf ( V_15 , L_166 , ( int ) V_469 -> V_475 ) ;
}
static T_9 F_189 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
int V_19 ;
struct V_5 * V_6 = F_186 ( V_318 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
char * V_39 = V_15 ;
T_1 V_4 = 0 ;
...
V_6 -> V_446 , V_6 -> V_452 ,
V_6 -> V_450 , V_6 -> V_447 ) ;
V_39 += sprintf ( V_39 , L_182 , V_6 -> V_264 ) ;
V_39 += sprintf ( V_39 , L_183 , V_6 -> V_490 ) ;
#ifdef F_124
V_39 += sprintf ( V_39 , L_184 ,
V_6 -> V_312 [ 0 ] ? L_185 : L_186 ) ;
#endif
return V_39 - V_15 ;
}
static int F_195 ( struct V_5 * V_6 , T_1 V_315 )
{
int V_63 ;
...
F_197 ( V_150 -> V_493 . V_494 [ V_6 -> V_150 -> V_493 . V_495 ] , L_191 ) ;
F_197 ( V_49 , L_192 ) ;
F_197 ( V_187 , L_192 ) ;
F_197 ( V_475 , L_192 ) ;
V_14 +=
...
F_197 ( V_215 , L_194 ) ;
F_197 ( V_76 , L_194 ) ;
F_197 ( V_427 . V_147 , L_194 ) ;
F_197 ( V_427 . V_497 , L_194 ) ;
F_197 ( V_413 . V_147 , L_194 ) ;
F_197 ( V_413 . V_498 , L_194 ) ;
F_197 ( V_90 . V_147 , L_194 ) ;
F_197 ( V_90 . V_498 , L_194 ) ;
F_197 ( V_92 . V_147 , L_194 ) ;
F_197 ( V_92 . V_497 , L_194 ) ;
F_197 ( V_404 . V_147 , L_194 ) ;
F_197 ( V_404 . V_497 , L_194 ) ;
F_197 ( V_417 . V_147 , L_194 ) ;
F_197 ( V_417 . V_498 , L_194 ) ;
F_197 ( V_150 -> V_299 , L_194 ) ;
F_197 ( V_47 , L_194 ) ;
return V_14 ;
}
static T_9 F_198 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
struct V_5 * V_6 = F_186 ( V_318 ) ;
char V_269 [ V_270 + 1 ] ;
...
F_31 ( L_46 ,
__LINE__ ) ;
V_39 += sprintf ( V_39 , L_195 , V_269 ) ;
V_39 += sprintf ( V_39 , L_196 , V_274 ) ;
V_39 += sprintf ( V_39 , L_197 , V_272 ) ;
return V_39 - V_15 ;
}
static T_9 F_199 ( struct V_499 * V_318 , char * V_15 )
{
return sprintf ( V_15 , L_198 , V_44 ) ;
}
static T_9 F_200 ( struct V_499 * V_318 ,
const char * V_15 , T_4 V_36 )
{
T_1 V_4 ;
int V_267 ;
V_267 = F_201 ( V_15 , 0 , & V_4 ) ;
if ( V_267 )
F_31 ( L_199 , V_15 ) ;
else
V_44 = V_4 ;
...
static T_9 F_203 ( struct V_472 * V_318 ,
...
static T_9 F_204 ( struct V_472 * V_318 ,
...
static T_9 F_205 ( struct V_472 * V_318 , struct V_473 * V_474 ,
char * V_15 )
{
struct V_5 * V_6 = F_186 ( V_318 ) ;
return sprintf ( V_15 , L_202 , V_6 -> V_150 -> V_500 ) ;
}
static T_9 F_206 ( struct V_472 * V_318 , struct V_473 * V_474 ,
const char * V_15 , T_4 V_36 )
{
struct V_5 * V_6 = F_186 ( V_318 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
...
( void ) V_2 ;
F_31 ( L_42 ) ;
V_267 = F_207 ( V_15 , 0 , & V_4 ) ;
if ( V_267 ) {
F_31 ( L_203 , V_2 -> V_51 ) ;
} else {
V_6 -> V_150 -> V_500 = V_4 ;
F_31 ( L_204 , V_6 -> V_150 -> V_500 ) ;
}
F_31 ( L_45 ) ;
return F_202 ( V_15 , V_36 ) ;
}
...
static int F_209 ( struct V_5 * V_6 , int V_501 )
{
if ( ( V_501 ? 1 : 0 ) ==
( V_6 -> V_49 & V_206 ? 1 : 0 ) )
return 0 ;
...
static T_9 F_211 ( struct V_472 * V_318 , struct V_473 * V_474 ,
const char * V_15 , T_4 V_36 )
{
struct V_5 * V_6 = F_186 ( V_318 ) ;
F_209 ( V_6 , V_15 [ 0 ] == '1' ) ;
...
static int F_212 ( struct V_5 * V_6 , int V_382 )
{
struct V_376 * V_502 = & V_6 -> V_323 ;
F_31 ( L_42 ) ;
V_502 -> V_481 = V_382 * sizeof( struct V_322 ) ;
V_502 -> V_324 =
(struct V_322 * ) F_178 ( V_6 -> V_261 ,
...
F_31 ( L_42 ) ;
if ( V_6 -> V_323 . V_324 ) {
F_179 ( V_6 -> V_261 , V_6 -> V_323 . V_481 ,
V_6 -> V_323 . V_324 ,
V_6 -> V_323 . V_405 ) ;
...
V_502 -> V_324 = F_178 ( V_6 -> V_261 , V_502 -> V_481 , & V_502 -> V_405 ) ;
if ( ! V_502 -> V_324 ) {
F_31
( L_212 ) ;
return - V_240 ;
...
static void F_215 ( struct V_5 * V_6 , struct V_374 * V_502 )
{
F_31 ( L_42 ) ;
if ( ! V_502 )
return;
if ( V_502 -> V_324 ) {
F_179 ( V_6 -> V_261 , V_502 -> V_481 , V_502 -> V_324 , V_502 -> V_405 ) ;
V_502 -> V_324 = NULL ;
}
F_31 ( L_45 ) ;
}
...
T_8 V_469 ;
F_31 ( L_42 ) ;
V_63 = F_214 ( V_6 , & V_6 -> V_390 , V_504 ) ;
if ( V_63 ) {
F_62 ( L_214 ,
V_6 -> V_33 -> V_51 ) ;
return V_63 ;
}
V_6 -> V_505 = F_220 ( V_506 ,
sizeof( struct V_60 ) ,
V_313 ) ;
if ( ! V_6 -> V_505 ) {
F_215 ( V_6 , & V_6 -> V_390 ) ;
...
F_162 ( V_6 -> V_505 [ V_19 ] . V_81 . V_410 .
V_411 ) ;
V_6 -> V_505 [ V_19 ] . V_81 . V_410 . V_411 = NULL ;
}
F_48 ( & V_6 -> V_505 [ V_19 ] . V_78 , & V_6 -> V_412 ) ;
}
F_164 ( & V_6 -> V_413 , V_19 ) ;
V_6 -> V_390 . V_399 = 0 ;
V_6 -> V_390 . V_416 = V_6 -> V_390 . V_382 ;
V_6 -> V_390 . V_77 = 0 ;
F_222 ( & V_6 -> V_417 ) ;
F_164 ( & V_6 -> V_417 , V_6 -> V_390 . V_416 ) ;
F_216 ( V_6 , & V_6 -> V_390 ,
V_507 ,
V_508 ,
V_402 ,
...
int V_19 , V_40 , V_63 = - V_31 ;
F_31 ( L_42 ) ;
V_63 = F_214 ( V_6 , & V_6 -> V_339 , V_327 ) ;
if ( V_63 ) {
F_31 ( L_216 ) ;
return V_63 ;
}
V_63 = F_212 ( V_6 , V_327 ) ;
if ( V_63 ) {
F_31 ( L_217 ) ;
F_215 ( V_6 , & V_6 -> V_339 ) ;
return V_63 ;
}
V_6 -> V_332 = F_131 ( V_327 *
sizeof( struct V_306 ) ,
V_239 ) ;
if ( ! V_6 -> V_332 ) {
F_31 ( L_218 ) ;
...
return 0 ;
for ( V_40 = 0 ; V_40 < V_19 ; V_40 ++ ) {
F_142 ( V_6 -> V_261 , V_6 -> V_332 [ V_40 ] . V_310 ,
sizeof( struct V_306 ) ,
V_311 ) ;
F_225 ( V_6 -> V_332 [ V_40 ] . V_307 ) ;
}
F_129 ( V_6 -> V_332 ) ;
V_6 -> V_332 = NULL ;
F_215 ( V_6 , & V_6 -> V_339 ) ;
...
F_222 ( & V_6 -> V_509 ) ;
F_164 ( & V_6 -> V_509 , V_6 -> V_339 . V_416 ) ;
F_216 ( V_6 , & V_6 -> V_339 ,
V_510 ,
V_511 ,
V_380 ,
...
F_31 ( L_220 , V_6 -> V_33 -> V_514 ) ;
return 0 ;
}
static int F_229 ( struct V_5 * V_6 , int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_515 ,
. V_88 = 0 ,
...
static int F_230 ( struct V_5 * V_6 , T_1 V_517 ,
int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_518 ,
...
static int F_234 ( struct V_5 * V_6 , T_1 V_539 ,
int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_540 ,
...
static int F_235 ( struct V_5 * V_6 , int V_545 )
{
struct V_56 V_57 = {
. V_56 = V_546 ,
. V_88 = 0 ,
...
static int F_238 ( struct V_5 * V_6 , T_1 V_554 )
{
struct V_56 V_57 = {
. V_56 = V_555 ,
. V_88 = 0 ,
...
static int F_239 ( struct V_5 * V_6 , T_1 V_559 )
{
struct V_56 V_57 = {
. V_56 = V_560 ,
. V_88 = 0 ,
...
static int F_240 ( struct V_5 * V_6 , T_1 V_559 )
{
struct V_56 V_57 = {
. V_56 = V_562 ,
. V_88 = 0 ,
...
static int F_241 ( struct V_5 * V_6 , T_3 * V_274 ,
int V_288 )
{
struct V_56 V_57 = {
. V_56 = V_564 ,
...
static int F_245 ( struct V_5 * V_6 , T_1 V_588 )
{
struct V_56 V_57 = {
. V_56 = V_553 ,
. V_88 = 0 ,
...
static int F_255 ( struct V_5 * V_6 , int V_288 )
{
...
F_254 ( V_6 , V_6 -> V_150 -> V_493 . V_495 , 1 ) ;
}
V_63 =
F_249 ( V_6 ,
V_6 -> V_150 -> V_190 .
...
static void F_256 ( struct V_262 * V_263 )
{
struct V_5 * V_6 =
...
#ifdef F_154
if ( V_6 -> V_150 -> V_198 == V_199 ) {
V_63 = F_231 ( V_6 , V_6 -> V_245 , V_288 ) ;
if ( V_63 )
return V_63 ;
F_31 ( L_45 ) ;
return 0 ;
...
if ( V_63 )
return - V_70 ;
V_63 = F_229 ( V_6 , V_288 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_230 ( V_6 , V_6 -> V_150 -> V_198 , V_288 ) ;
if ( V_63 )
return V_63 ;
if ( V_6 -> V_150 -> V_198 == V_434 ) {
V_63 = F_231 ( V_6 , V_6 -> V_245 , V_288 ) ;
...
if ( V_63 )
return V_63 ;
V_63 = F_234 ( V_6 , V_6 -> V_544 , V_288 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_235 ( V_6 , V_547 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_238 ( V_6 , V_6 -> V_558 ) ;
if ( V_63 )
return V_63 ;
if ( V_6 -> V_187 & V_628 )
V_274 = V_6 -> V_274 ;
...
static int F_258 ( struct V_1 * V_2 , void * V_469 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
...
F_268 ( V_81 -> V_652 , V_653 , sizeof( V_81 -> V_652 ) ) ;
F_268 ( V_81 -> V_121 , V_654 , sizeof( V_81 -> V_121 ) ) ;
F_269 ( V_6 , V_650 , sizeof( V_650 ) ) ;
F_270 ( V_6 , V_651 , sizeof( V_651 ) ) ;
snprintf ( V_81 -> V_655 , sizeof( V_81 -> V_655 ) , L_240 ,
V_650 , V_6 -> V_156 , V_651 ) ;
F_268 ( V_81 -> V_656 , F_271 ( V_6 -> V_261 ) ,
sizeof( V_81 -> V_656 ) ) ;
}
...
static void F_273 ( struct V_262 * V_263 )
{
struct V_5 * V_6 =
...
static void F_274 ( struct V_262 * V_263 )
{
struct V_5 * V_6 =
...
static struct V_1 * F_275 ( struct V_261 * V_261 ,
void T_12 * V_7 )
{
struct V_5 * V_6 ;
struct V_1 * V_2 ;
...
V_6 -> V_33 = V_2 ;
V_6 -> V_7 = V_7 ;
V_6 -> V_150 -> V_661 = F_176 ;
V_6 -> V_150 -> V_641 = F_257 ;
V_6 -> V_150 -> V_662 = - 20 ;
V_6 -> V_150 -> V_663 = - 85 ;
V_2 -> V_664 = & V_665 ;
V_2 -> V_666 = & V_667 ;
...
F_281 ( & V_6 -> V_295 , F_256 ) ;
F_281 ( & V_6 -> V_286 , V_689 ) ;
F_281 ( & V_6 -> V_182 , F_273 ) ;
F_281 ( & V_6 -> V_216 , F_274 ) ;
F_281 ( & V_6 -> V_297 , F_118 ) ;
F_282 ( & V_6 -> V_460 , ( void (*) ( unsigned long ) )
F_169 , ( unsigned long ) V_6 ) ;
V_6 -> V_215 = 1 ;
V_6 -> V_181 = 1 ;
return V_2 ;
}
static int F_283 ( struct V_261 * V_261 ,
...
F_184 ( V_261 , 0x40 , & V_4 ) ;
if ( ( V_4 & 0x0000ff00 ) != 0 )
F_293 ( V_261 , 0x40 , V_4 & 0xffff00ff ) ;
if ( ! F_25 ( V_2 ) ) {
F_27 (KERN_WARNING DRV_NAME
L_255 ) ;
V_63 = - V_694 ;
...
F_77 ( V_6 ) ;
V_63 = F_295 ( V_261 -> V_457 ,
F_172 , V_695 , V_2 -> V_51 , V_6 ) ;
if ( V_63 ) {
F_27 (KERN_WARNING DRV_NAME
L_257 , pci_dev->irq) ;
goto V_123;
...
V_692 = 2 ;
F_84 ( & V_6 -> V_266 ) ;
F_31 ( L_261 , V_2 -> V_51 , F_271 ( V_261 ) ) ;
V_63 = F_297 ( & V_261 -> V_2 . V_696 , & V_697 ) ;
if ( V_63 )
goto V_71;
if ( ! ( V_6 -> V_49 & V_487 ) ) {
if ( F_83 ( V_6 ) ) {
...
static void F_305 ( struct V_261 * V_261 )
{
struct V_5 * V_6 = F_306 ( V_261 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
F_84 ( & V_6 -> V_266 ) ;
V_6 -> V_49 &= ~ V_622 ;
F_301 ( & V_261 -> V_2 . V_696 , & V_697 ) ;
#ifdef F_61
if ( V_120 . V_121 )
F_66 ( V_6 , & V_120 ) ;
#endif
...
static int F_307 ( struct V_261 * V_261 , T_13 V_102 )
{
struct V_5 * V_6 = F_306 ( V_261 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
F_31 ( L_263 , V_2 -> V_51 ) ;
...
static int F_311 ( struct V_261 * V_261 )
{
struct V_5 * V_6 = F_306 ( V_261 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
int V_63 ;
...
F_293 ( V_261 , 0x40 , V_4 & 0xffff00ff ) ;
F_313 ( V_2 ) ;
V_6 -> V_205 = F_36 () - V_6 -> V_699 ;
if ( ! ( V_6 -> V_49 & V_206 ) )
F_93 ( V_6 , 0 ) ;
F_85 ( & V_6 -> V_266 ) ;
return 0 ;
}
static void F_314 ( struct V_261 * V_261 )
{
struct V_5 * V_6 = F_306 ( V_261 ) ;
F_99 ( V_6 ) ;
F_291 ( V_261 ) ;
...
snprintf ( V_218 -> V_51 , V_709 , L_269 ) ;
...
F_324 ( L_271 , V_711 -> V_712 ) ;
V_63 = F_231 ( V_6 , V_711 -> V_712 , 0 ) ;
}
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
...
#endif
case V_434 :
V_63 = F_195 ( V_6 , V_434 ) ;
break;
case V_429 :
case V_715 :
default:
V_63 = F_195 ( V_6 , V_429 ) ;
break;
}
V_623:
F_85 ( & V_6 -> V_266 ) ;
...
if ( F_332 ( V_218 -> V_219 . V_631 ) ||
F_333 ( V_218 -> V_219 . V_631 ) ) {
F_324 ( L_276 ) ;
V_6 -> V_187 &= ~ V_628 ;
...
V_6 -> V_187 |= V_628 ;
memcpy ( V_6 -> V_770 , V_218 -> V_219 . V_631 , V_230 ) ;
V_63 = F_241 ( V_6 , V_218 -> V_219 . V_631 , 0 ) ;
F_324 ( L_277 , V_218 -> V_219 . V_631 ) ;
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
}
...
V_539 = 0 ;
if ( V_772 == 1000000 ||
( ! V_218 -> V_726 . V_773 && V_772 > 1000000 ) )
V_539 |= V_280 ;
if ( V_772 == 2000000 ||
( ! V_218 -> V_726 . V_773 && V_772 > 2000000 ) )
V_539 |= V_281 ;
if ( V_772 == 5500000 ||
( ! V_218 -> V_726 . V_773 && V_772 > 5500000 ) )
V_539 |= V_282 ;
if ( V_772 == 11000000 ||
( ! V_218 -> V_726 . V_773 && V_772 > 11000000 ) )
V_539 |= V_283 ;
if ( V_539 == 0 )
V_539 = V_687 ;
V_63 = F_234 ( V_6 , V_539 , 0 ) ;
F_324 ( L_286 , V_539 ) ;
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
...
if ( V_218 -> V_774 . V_775 )
V_147 = V_6 -> V_558 | V_556 ;
else {
if ( V_218 -> V_774 . V_147 < 1 || V_218 -> V_774 . V_147 > 2304 ) {
V_63 = - V_31 ;
goto V_623;
}
V_147 = V_218 -> V_774 . V_147 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_774 . V_147 = V_6 -> V_558 & ~ V_556 ;
V_218 -> V_774 . V_773 = 1 ;
V_218 -> V_774 . V_775 = ( V_6 -> V_558 & V_556 ) ? 1 : 0 ;
F_324 ( L_290 , V_218 -> V_774 . V_147 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_63 = 0 , V_147 ;
if ( F_209 ( V_6 , V_218 -> V_754 . V_775 ) )
return - V_776 ;
if ( V_6 -> V_150 -> V_198 != V_434 )
return 0 ;
if ( ( V_218 -> V_754 . V_62 & V_777 ) != V_751 )
return - V_31 ;
if ( V_218 -> V_754 . V_773 == 0 )
V_147 = V_589 ;
else {
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_754 . V_775 = ( V_6 -> V_49 & V_487 ) ? 1 : 0 ;
if ( V_6 -> V_588 == V_589 ) {
V_218 -> V_754 . V_773 = 0 ;
V_218 -> V_754 . V_147 = V_591 ;
} else {
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! V_218 -> V_778 . V_773 )
return - V_31 ;
if ( V_218 -> V_778 . V_775 ) {
V_6 -> V_684 |= V_686 ;
V_6 -> V_150 -> V_779 = V_685 ;
} else {
if ( V_218 -> V_778 . V_147 < V_731 ||
V_218 -> V_778 . V_147 > V_733 )
return - V_31 ;
V_6 -> V_150 -> V_779 = V_218 -> V_778 . V_147 & ~ 0x1 ;
V_6 -> V_684 = V_6 -> V_150 -> V_779 ;
}
F_324 ( L_293 , V_6 -> V_150 -> V_779 ) ;
return 0 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_778 . V_147 = V_6 -> V_684 & ~ V_686 ;
V_218 -> V_778 . V_773 = 0 ;
V_218 -> V_778 . V_775 = ( V_6 -> V_684 & V_686 ) ? 1 : 0 ;
F_324 ( L_294 , V_218 -> V_778 . V_147 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_63 = 0 ;
if ( V_218 -> V_559 . V_62 & V_780 || V_218 -> V_559 . V_775 )
return - V_31 ;
if ( ! ( V_218 -> V_559 . V_62 & V_781 ) )
return 0 ;
F_84 ( & V_6 -> V_266 ) ;
if ( ! ( V_6 -> V_49 & V_622 ) ) {
V_63 = - V_70 ;
...
if ( V_218 -> V_559 . V_62 & V_782 ) {
V_63 = F_239 ( V_6 , V_218 -> V_559 . V_147 ) ;
F_324 ( L_295 ,
V_218 -> V_559 . V_147 ) ;
goto V_623;
}
if ( V_218 -> V_559 . V_62 & V_783 ) {
V_63 = F_240 ( V_6 , V_218 -> V_559 . V_147 ) ;
F_324 ( L_296 ,
V_218 -> V_559 . V_147 ) ;
goto V_623;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
V_218 -> V_559 . V_775 = 0 ;
if ( ( V_218 -> V_559 . V_62 & V_784 ) == V_780 )
return - V_31 ;
if ( V_218 -> V_559 . V_62 & V_783 ) {
V_218 -> V_559 . V_62 = V_781 | V_783 ;
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_351 ( V_6 -> V_150 , V_81 , V_218 , V_708 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_353 ( V_6 -> V_150 , V_81 , V_218 , V_596 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_355 ( V_6 -> V_150 , V_81 , V_218 , V_596 ) ;
}
...
if ( V_218 -> V_785 . V_775 ) {
V_6 -> V_548 = F_236 ( V_6 -> V_548 ) ;
V_63 = F_235 ( V_6 , V_547 ) ;
F_324 ( L_301 ) ;
goto V_623;
}
switch ( V_218 -> V_785 . V_62 & V_786 ) {
case V_787 :
case V_786 :
case V_788 :
break;
...
V_63 = F_235 ( V_6 , F_236 ( V_6 -> V_548 ) ) ;
F_324 ( L_303 , V_6 -> V_548 ) ;
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
}
...
if ( ! V_150 -> V_634 )
return - V_642 ;
if ( V_218 -> V_37 . V_287 > V_789 ||
( V_218 -> V_37 . V_287 && V_708 == NULL ) )
return - V_31 ;
if ( V_218 -> V_37 . V_287 ) {
V_15 = F_359 ( V_708 , V_218 -> V_37 . V_287 , V_239 ) ;
if ( V_15 == NULL )
return - V_240 ;
F_129 ( V_150 -> V_643 ) ;
V_150 -> V_643 = V_15 ;
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_635 * V_150 = V_6 -> V_150 ;
struct V_790 * V_791 = & V_218 -> V_791 ;
struct V_792 * V_494 ;
unsigned long V_62 ;
int V_267 = 0 ;
switch ( V_791 -> V_62 & V_793 ) {
case V_794 :
case V_795 :
case V_796 :
case V_797 :
...
if ( ! V_494 || ! V_494 -> V_799 -> V_800 || ! V_494 -> V_799 -> V_801 )
break;
V_62 = V_494 -> V_799 -> V_801 ( V_494 -> V_6 ) ;
if ( V_791 -> V_147 )
V_62 |= V_802 ;
else
V_62 &= ~ V_802 ;
V_494 -> V_799 -> V_800 ( V_62 , V_494 -> V_6 ) ;
break;
case V_803 : {
struct V_620 V_190 = {
. V_62 = V_191 ,
...
case V_804 :
V_267 = F_266 ( V_6 , V_791 -> V_147 ) ;
break;
case V_805 :
V_267 = F_265 ( V_6 , V_791 -> V_147 ) ;
break;
case V_806 :
V_150 -> V_676 = V_791 -> V_147 ;
break;
case V_807 :
V_150 -> V_675 = V_791 -> V_147 ;
break;
default:
return - V_642 ;
}
...
case V_798 :
V_494 = V_6 -> V_150 -> V_493 . V_494 [ V_6 -> V_150 -> V_493 . V_495 ] ;
if ( ! V_494 || ! V_494 -> V_799 -> V_801 ) {
F_152 ( L_305
L_306 ) ;
break;
}
V_791 -> V_147 = ( V_494 -> V_799 -> V_801 ( V_494 -> V_6 ) &
V_802 ) ? 1 : 0 ;
break;
case V_803 :
V_791 -> V_147 = V_150 -> V_674 ;
break;
case V_804 :
V_791 -> V_147 = V_6 -> V_150 -> V_190 . V_569 ;
break;
case V_805 :
V_791 -> V_147 = V_150 -> V_634 ;
break;
case V_806 :
V_791 -> V_147 = V_150 -> V_676 ;
break;
case V_808 :
case V_807 :
V_791 -> V_147 = V_150 -> V_675 ;
break;
default:
return - V_642 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_364 ( V_6 -> V_150 , V_81 , V_218 , V_708 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_366 ( V_6 -> V_150 , V_81 , V_218 , V_708 ) ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_809 * V_810 = (struct V_809 * ) V_708 ;
T_16 V_811 ;
V_811 = F_150 ( V_810 -> V_812 ) ;
switch ( V_810 -> V_57 ) {
case V_813 :
break;
case V_814 :
...
V_315 = V_673 ;
if ( F_236 ( V_6 -> V_548 ) != V_315 )
V_63 = F_235 ( V_6 , V_315 ) ;
V_623:
F_85 ( & V_6 -> V_266 ) ;
return V_63 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_43 = F_236 ( V_6 -> V_548 ) ;
T_17 V_817 , V_818 ;
if ( ! ( V_6 -> V_548 & V_549 ) ) {
snprintf ( V_708 , V_819 ,
L_307 , V_43 ) ;
} else {
switch ( V_43 ) {
case V_547 :
...
break;
default:
V_817 = V_739 [ V_43 - 1 ] / 1000 ;
V_818 = V_735 [ V_43 - 1 ] / 1000 ;
snprintf ( V_708 , V_819 ,
L_310
L_311 ,
V_43 , V_817 , V_818 ) ;
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 -> V_187 & V_531 )
snprintf ( V_218 -> V_51 , V_709 , L_312 ) ;
else
snprintf ( V_218 -> V_51 , V_709 , L_313 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 -> V_187 & V_346 )
snprintf ( V_218 -> V_51 , V_709 , L_314 ) ;
else
snprintf ( V_218 -> V_51 , V_709 , L_315 ) ;
return 0 ;
}
static struct V_820 * F_376 ( struct V_1 * V_2 )
{
enum {
V_821 = 30 ,
V_822 = 60 ,
...
struct V_5 * V_6 = F_2 ( V_2 ) ;
struct V_820 * V_304 ;
T_1 V_354 , V_831 , V_832 , V_833 ;
T_1 V_204 = sizeof( T_1 ) ;
if ( ! V_6 )
return (struct V_820 * ) NULL ;
V_304 = & V_6 -> V_304 ;
if ( ! ( V_6 -> V_49 & V_166 ) ) {
V_304 -> V_834 . V_835 = 0 ;
V_304 -> V_334 . V_836 = 0 ;
...
if ( V_354 < 10 )
V_827 = V_354 * V_821 / 10 ;
else if ( V_354 < 15 )
V_827 = ( V_354 - 10 ) * ( V_822 - V_821 ) / 5 + V_821 ;
else if ( V_354 < 20 )
V_827 = ( V_354 - 15 ) * ( V_823 - V_822 ) / 5 + V_822 ;
else if ( V_354 < 30 )
V_827 = ( V_354 - 20 ) * ( V_824 - V_823 ) /
10 + V_823 ;
else
V_827 = ( V_354 - 30 ) * ( V_826 - V_824 ) /
10 + V_824 ;
if ( F_26 ( V_6 , V_843 ,
& V_831 , & V_204 ) )
goto V_841;
if ( V_831 > 75 )
V_828 = ( 90 - V_831 ) * V_821 / 15 ;
else if ( V_831 > 70 )
V_828 = ( 75 - V_831 ) * ( V_822 - V_821 ) / 5 + V_821 ;
else if ( V_831 > 65 )
V_828 = ( 70 - V_831 ) * ( V_823 - V_822 ) / 5 + V_822 ;
else if ( V_831 > 50 )
V_828 = ( 65 - V_831 ) * ( V_824 - V_823 ) /
15 + V_823 ;
else
V_828 = ( 50 - V_831 ) *
( V_826 - V_824 ) / 50 + V_824 ;
if ( V_832 > 50 )
V_829 = ( 60 - V_832 ) * V_821 / 10 ;
else if ( V_832 > 40 )
V_829 = ( 50 - V_832 ) * ( V_822 - V_821 ) /
10 + V_821 ;
else if ( V_832 > 32 )
V_829 = ( 40 - V_832 ) * ( V_823 - V_822 ) /
18 + V_822 ;
else if ( V_832 > 20 )
V_829 = ( 32 - V_832 ) *
( V_824 - V_823 ) / 20 + V_823 ;
else
V_829 = ( 20 - V_832 ) *
( V_826 - V_824 ) / 20 + V_824 ;
V_830 = F_34 ( V_828 , V_827 ) ;
V_830 = F_34 ( V_829 , V_830 ) ;
#ifdef F_124
if ( V_829 == V_830 )
F_324 ( L_316 ) ;
else if ( V_828 == V_830 )
...
F_324 ( L_319 ) ;
#endif
V_304 -> V_720 . V_720 = V_830 ;
V_304 -> V_720 . V_43 = V_354 + V_355 ;
}
V_304 -> V_720 . V_721 = 0 ;
V_304 -> V_720 . V_722 = 7 ;
V_304 -> V_720 . V_722 |= V_837 ;
V_304 -> V_834 . V_835 = V_832 ;
if ( F_26 ( V_6 , V_844 ,
& V_833 , & V_204 ) )
goto V_841;
V_304 -> V_334 . V_836 = V_833 ;
return V_304 ;
V_841:
F_324 ( L_287 ) ;
return (struct V_820 * ) NULL ;
...
static int F_377 ( struct V_119 * V_845 )
{
struct V_846 * V_847 =
(struct V_846 * ) V_845 -> V_848 -> V_37 ;
if ( F_378 ( V_847 -> V_121 ) != V_849 ) {
...
V_845 -> V_121 = V_847 -> V_121 ;
V_845 -> V_845 . V_37 = V_845 -> V_848 -> V_37 + sizeof( struct V_846 ) ;
V_845 -> V_845 . V_481 = V_847 -> V_850 ;
V_845 -> V_851 . V_37 = V_845 -> V_845 . V_37 + V_847 -> V_850 ;
V_845 -> V_851 . V_481 = V_847 -> V_852 ;
return 0 ;
}
...
V_202 = F_380 ( & V_845 -> V_848 , V_853 , & V_6 -> V_261 -> V_2 ) ;
if ( V_202 < 0 ) {
F_27 (KERN_ERR DRV_NAME L_67
L_327 ,
...
static int F_65 ( struct V_5 * V_6 , struct V_119 * V_845 )
{
unsigned int V_8 ;
unsigned short V_14 ;
const unsigned char * V_859 = V_845 -> V_845 . V_37 ;
unsigned int V_860 = V_845 -> V_845 . V_481 ;
while ( V_860 > 0 ) {
V_8 = * ( T_1 * ) ( V_859 ) ;
V_859 += 4 ;
V_860 -= 4 ;
...
{
struct V_1 * V_2 = V_6 -> V_33 ;
const unsigned char * V_861 = V_845 -> V_851 . V_37 ;
unsigned int V_862 = V_845 -> V_851 . V_481 ;
