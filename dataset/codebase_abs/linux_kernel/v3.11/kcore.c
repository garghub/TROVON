...
F_35 ( V_63 . V_117 , V_118 , sizeof( V_63 . V_117 ) ) ;
...
static T_4
F_36 ( struct V_121 * V_121 , char T_5 * V_122 , T_1 V_123 , T_6 * V_124 )
{
T_4 V_125 = 0 ;
T_1 V_4 , V_126 ;
T_1 V_9 ;
...
F_34 ( V_127 , V_8 , V_9 ) ;
F_38 ( & V_5 ) ;
if ( F_40 ( V_122 , V_127 + * V_124 , V_126 ) ) {
F_13 ( V_127 ) ;
return - V_129 ;
}
F_13 ( V_127 ) ;
...
char * V_127 ;
V_127 = F_39 ( V_126 , V_30 ) ;
if ( ! V_127 )
return - V_31 ;
F_44 ( V_127 , ( char * ) V_36 , V_126 ) ;
if ( F_40 ( V_122 , V_127 , V_126 ) ) {
F_13 ( V_127 ) ;
return - V_129 ;
}
F_13 ( V_127 ) ;
...
if ( F_45 ( V_36 ) ) {
unsigned long V_130 ;
V_130 = F_40 ( V_122 , ( char * ) V_36 , V_126 ) ;
if ( V_130 ) {
if ( F_42 ( V_122 + V_126 - V_130 ,
V_130 ) )
return - V_129 ;
}
} else {
...
V_125 += V_126 ;
V_36 += V_126 ;
V_126 = ( V_123 > V_40 ? V_40 : V_123 ) ;
}
return V_125 ;
}
static int F_46 ( struct V_131 * V_131 , struct V_121 * V_132 )
{
if ( ! F_47 ( V_133 ) )
return - V_134 ;
if ( V_24 )
F_19 () ;
if ( F_48 ( V_131 ) != V_27 -> V_4 ) {
F_49 ( & V_131 -> V_135 ) ;
F_50 ( V_131 , V_27 -> V_4 ) ;
F_51 ( & V_131 -> V_135 ) ;
}
...
static int T_7 F_52 ( struct V_136 * V_137 ,
unsigned long V_138 , void * V_41 )
{
switch ( V_138 ) {
case V_139 :
case V_140 :
...
{
F_1 ( & V_142 , V_143 , V_144 - V_143 , V_145 ) ;
}
static void T_8 F_53 ( void )
{
}
