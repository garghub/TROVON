...
if ( V_18 )
return V_18 ;
V_17 = ( F_9 ( V_10 , V_12 -> V_28 ) &
V_29 ) != 0 ;
if ( V_17 ) {
V_14 -> V_5 = F_10 ( V_10 , V_12 -> V_28 ) ;
if ( ! V_14 -> V_5 )
return - V_26 ;
} else {
V_7 -> V_4 = F_11 ( V_10 , V_12 -> V_28 ) ;
}
V_18 = F_12 ( V_7 , V_12 -> V_30 ) ;
if ( V_18 )
return V_18 ;
for ( V_19 = 0 ; V_19 < V_12 -> V_30 ; V_19 ++ ) {
unsigned long V_4 ;
V_16 = & V_7 -> V_31 [ V_19 ] ;
if ( V_17 ) {
...
F_14 ( V_7 -> V_32 , L_1 ,
V_7 -> V_23 , V_12 -> V_30 * 24 ) ;
return 0 ;
}
static void F_15 ( struct V_6 * V_7 )
{
struct V_13 * V_14 = V_7 -> V_27 ;
if ( V_14 && V_14 -> V_5 )
F_16 ( V_14 -> V_5 ) ;
F_17 ( V_7 ) ;
}
...
{
return F_19 ( V_7 , & V_35 , V_34 -> V_36 ) ;
}
