...
V_15 = V_5 -> V_16 . V_24 ;
* V_9 -> V_27 = F_8 ( V_5 -> V_16 . V_26 , V_15 , V_28 ) ;
if ( * V_9 -> V_27 == NULL )
return - V_29 ;
return V_15 ;
}
...
unsigned int V_14 , int V_20 , T_4 V_34 , T_4 V_15 ,
struct V_1 * V_2 )
{
char V_10 [ V_11 ] ;
T_5 V_35 [ V_11 ] ;
...
T_5 V_41 [ V_11 ] ;
T_5 * V_35 = V_40 -> V_10 ;
unsigned long V_42 = F_17 ( V_40 -> V_10 ) ;
char V_43 [ V_11 ] ;
int V_12 ;
if ( F_6 ( V_5 -> V_16 . V_17 , V_6 ) )
return 0 ;
...
V_35 , ( T_4 ) V_42 ) ) {
sprintf ( V_43 , L_2 , V_40 -> type ,
( unsigned int ) V_40 -> V_19 , V_40 -> time . V_22 ) ;
for ( V_12 = 0 ; V_12 < V_11 ; V_12 ++ )
V_41 [ V_12 ] = V_43 [ V_12 ] ;
if ( F_18 ( V_5 -> V_16 . V_18 , V_41 ,
F_17 ( V_41 ) ) )
return 0 ;
}
F_19 ( V_5 ) ;
