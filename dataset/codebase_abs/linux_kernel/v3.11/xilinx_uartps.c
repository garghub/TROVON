...
struct V_150 * V_151 ;
V_151 = F_57 ( sizeof( * V_151 ) , V_152 ) ;
if ( ! V_151 )
return - V_112 ;
V_151 -> V_153 = F_58 ( & V_145 -> V_114 , L_3 ) ;
if ( F_59 ( V_151 -> V_153 ) ) {
F_34 ( & V_145 -> V_114 , L_4 ) ;
V_146 = F_60 ( V_151 -> V_153 ) ;
goto V_154;
}
V_151 -> V_155 = F_58 ( & V_145 -> V_114 , L_5 ) ;
if ( F_59 ( V_151 -> V_155 ) ) {
F_34 ( & V_145 -> V_114 , L_6 ) ;
V_146 = F_60 ( V_151 -> V_155 ) ;
goto V_156;
}
V_146 = F_61 ( V_151 -> V_153 ) ;
if ( V_146 ) {
F_34 ( & V_145 -> V_114 , L_7 ) ;
goto V_157;
}
V_146 = F_61 ( V_151 -> V_155 ) ;
if ( V_146 ) {
F_34 ( & V_145 -> V_114 , L_8 ) ;
goto V_158;
}
V_148 = F_62 ( V_145 , V_159 , 0 ) ;
if ( ! V_148 ) {
V_146 = - V_142 ;
goto V_160;
}
V_149 = F_62 ( V_145 , V_161 , 0 ) ;
if ( ! V_149 ) {
V_146 = - V_142 ;
goto V_160;
}
V_4 = F_42 () ;
if ( ! V_4 ) {
F_34 ( & V_145 -> V_114 , L_9 ) ;
V_146 = - V_142 ;
goto V_160;
} else {
V_4 -> V_110 = V_148 -> V_162 ;
V_4 -> V_1 = V_149 -> V_162 ;
V_4 -> V_114 = & V_145 -> V_114 ;
V_4 -> V_47 = F_63 ( V_151 -> V_155 ) ;
V_4 -> V_163 = V_151 ;
F_64 ( V_145 , V_4 ) ;
V_146 = F_65 ( & V_164 , V_4 ) ;
if ( V_146 ) {
F_34 ( & V_145 -> V_114 ,
L_10 , V_146 ) ;
goto V_160;
...
{
struct V_3 * V_4 = F_70 ( V_145 ) ;
struct V_150 * V_151 = V_4 -> V_163 ;
int V_146 ;
V_146 = F_71 ( & V_164 , V_4 ) ;
V_4 -> V_110 = 0 ;
F_66 ( V_151 -> V_155 ) ;
F_66 ( V_151 -> V_153 ) ;
F_67 ( V_151 -> V_155 ) ;
