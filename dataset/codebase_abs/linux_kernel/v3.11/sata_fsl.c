...
#ifdef F_41
F_32 ( & V_68 -> V_79 , V_105 , & V_31 ) ;
V_31 &= ~ ( 0xF << 4 ) ;
V_31 |= ( 0x1 << 4 ) ;
F_31 ( & V_68 -> V_79 , V_105 , V_31 ) ;
F_32 ( & V_68 -> V_79 , V_105 , & V_31 ) ;
F_42 ( V_20 , L_35 , V_31 ) ;
#endif
return 0 ;
}
static void F_43 ( struct V_72 * V_68 )
{
struct V_19 * V_20 = V_68 -> V_2 -> V_20 ;
struct V_35 * V_36 = V_68 -> V_7 ;
struct V_5 * V_6 = V_68 -> V_2 -> V_7 ;
...
V_31 |= V_120 ;
F_3 ( V_31 , V_8 + V_107 ) ;
F_44 ( V_68 , V_8 + V_108 , V_121 , V_121 , 1 , 1 ) ;
V_68 -> V_7 = NULL ;
F_45 ( V_20 , V_115 ,
V_36 -> V_44 , V_36 -> V_116 ) ;
F_40 ( V_36 ) ;
}
static unsigned int F_46 ( struct V_72 * V_68 )
{
struct V_5 * V_6 = V_68 -> V_2 -> V_7 ;
void T_1 * V_8 = V_6 -> V_8 ;
struct V_122 V_78 ;
...
static int F_48 ( struct V_98 * V_79 , unsigned int * V_128 ,
unsigned long V_129 )
{
...
V_31 &= ~ V_119 ;
F_3 ( V_31 , V_8 + V_107 ) ;
V_31 = F_44 ( V_68 , V_8 + V_108 , V_121 , V_121 ,
1 , 500 ) ;
if ( V_31 & V_121 ) {
F_23 ( V_68 , L_38 , V_130 ) ;
V_130 ++ ;
if ( V_130 == 2 )
goto V_133;
else
...
V_31 |= V_110 ;
F_3 ( V_31 , V_8 + V_107 ) ;
V_31 = F_44 ( V_68 , V_8 + V_108 , V_121 , 0 , 1 , 500 ) ;
if ( ! ( V_31 & V_121 ) ) {
F_23 ( V_68 , L_40 ) ;
goto V_133;
}
...
F_18 ( L_32 , F_6 ( V_8 + V_108 ) ) ;
F_18 ( L_33 , F_6 ( V_8 + V_107 ) ) ;
V_31 = F_44 ( V_68 , V_8 + V_108 , 0xFF , 0 , 1 , 500 ) ;
if ( ( ! ( V_31 & 0x10 ) ) || F_50 ( V_79 ) ) {
F_51 ( V_68 , L_42 ,
F_6 ( V_8 + V_108 ) ) ;
* V_128 = V_135 ;
return 0 ;
...
V_131 = V_136 ;
V_31 = F_44 ( V_68 , V_8 + V_108 , 0xFF , 0x10 ,
500 , F_52 ( V_129 - V_131 ) ) ;
if ( ( V_31 & 0xFF ) != 0x18 ) {
F_51 ( V_68 , L_43 ) ;
* V_128 = V_135 ;
goto V_137;
...
static int F_54 ( struct V_98 * V_79 , unsigned int * V_128 ,
unsigned long V_129 )
{
struct V_72 * V_68 = V_79 -> V_68 ;
struct V_35 * V_36 = V_68 -> V_7 ;
...
F_3 ( V_80 , V_93 + V_8 ) ;
F_3 ( 1 , V_34 + V_8 ) ;
V_31 = F_44 ( V_68 , V_34 + V_8 , 0x1 , 0x1 , 1 , 5000 ) ;
if ( V_31 & 0x1 ) {
F_51 ( V_68 , L_50 ) ;
F_5 ( L_51 ,
F_6 ( V_34 + V_8 ) ,
...
* V_128 = F_46 ( V_68 ) ;
F_5 ( L_54 , * V_128 ) ;
F_18 ( L_55 , F_6 ( V_8 + V_92 ) ) ;
F_18 ( L_56 , F_6 ( V_8 + V_91 ) ) ;
}
return 0 ;
V_133:
return - V_139 ;
}
static void F_58 ( struct V_72 * V_68 )
{
F_5 ( L_57 ) ;
F_59 ( V_68 ) ;
}
...
static void F_61 ( struct V_72 * V_68 )
{
struct V_5 * V_6 = V_68 -> V_2 -> V_7 ;
void T_1 * V_8 = V_6 -> V_8 ;
...
static void F_71 ( struct V_72 * V_68 )
{
struct V_5 * V_6 = V_68 -> V_2 -> V_7 ;
void T_1 * V_8 = V_6 -> V_8 ;
T_4 V_148 , V_169 = 0 ;
...
F_72 ( V_68 , V_68 -> V_178 ^ V_169 ) ;
return;
} else if ( ( V_68 -> V_178 & ( 1 << V_179 ) ) ) {
F_3 ( 1 , V_8 + V_92 ) ;
V_49 = F_67 ( V_68 , V_179 ) ;
F_5 ( L_69 ,
F_6 ( V_8 + V_92 ) ) ;
if ( V_49 ) {
F_73 ( V_49 ) ;
...
static T_7 F_74 ( int V_180 , void * V_181 )
{
...
struct V_1 * V_2 = NULL ;
T_4 V_31 ;
struct F_53 V_191 = V_192 [ 0 ] ;
const struct F_53 * V_193 [] = { & V_191 , NULL } ;
F_80 ( & V_188 -> V_20 , L_74 ) ;
V_8 = F_81 ( V_188 -> V_20 . V_194 , 0 ) ;
if ( ! V_8 )
goto V_195;
V_101 = V_8 + 0x100 ;
V_29 = V_8 + 0x140 ;
if ( ! F_82 ( V_188 -> V_20 . V_194 , L_75 ) ) {
V_31 = F_6 ( V_29 + V_30 ) ;
...
if ( V_180 < 0 ) {
F_84 ( & V_188 -> V_20 , L_79 ) ;
goto V_195;
}
V_6 -> V_180 = V_180 ;
if ( F_82 ( V_188 -> V_20 . V_194 , L_80 ) )
V_6 -> V_52 = V_197 ;
else
V_6 -> V_52 = V_198 ;
...
V_2 -> V_7 = V_6 ;
F_78 ( V_2 ) ;
F_86 ( V_2 , V_180 , F_74 , V_200 ,
& V_201 ) ;
F_87 ( V_188 , V_2 ) ;
V_6 -> V_202 . V_203 = F_7 ;
V_6 -> V_202 . V_204 = F_8 ;
F_88 ( & V_6 -> V_202 . V_22 ) ;
V_6 -> V_202 . V_22 . V_205 = L_81 ;
V_6 -> V_202 . V_22 . V_206 = V_207 | V_208 ;
V_189 = F_89 ( V_2 -> V_20 , & V_6 -> V_202 ) ;
if ( V_189 )
goto V_195;
V_6 -> V_28 . V_203 = F_11 ;
V_6 -> V_28 . V_204 = F_12 ;
F_88 ( & V_6 -> V_28 . V_22 ) ;
V_6 -> V_28 . V_22 . V_205 = L_82 ;
V_6 -> V_28 . V_22 . V_206 = V_207 | V_208 ;
V_189 = F_89 ( V_2 -> V_20 , & V_6 -> V_28 ) ;
if ( V_189 ) {
F_90 ( & V_188 -> V_20 , & V_6 -> V_202 ) ;
goto V_195;
}
return 0 ;
V_195:
...
{
struct V_1 * V_2 = F_94 ( V_188 ) ;
struct V_5 * V_6 = V_2 -> V_7 ;
F_90 ( & V_188 -> V_20 , & V_6 -> V_202 ) ;
F_90 ( & V_188 -> V_20 , & V_6 -> V_28 ) ;
F_91 ( V_2 ) ;
F_95 ( V_6 -> V_180 ) ;
F_92 ( V_6 -> V_8 ) ;
F_40 ( V_6 ) ;
...
static int F_96 ( struct V_187 * V_209 , T_8 V_210 )
{
struct V_1 * V_2 = F_94 ( V_209 ) ;
return F_97 ( V_2 , V_210 ) ;
}
static int F_98 ( struct V_187 * V_209 )
{
struct V_1 * V_2 = F_94 ( V_209 ) ;
struct V_5 * V_6 = V_2 -> V_7 ;
int V_211 ;
