...
if ( ! V_9 -> V_23 )
return - V_46 ;
ASSERT ( F_52 ( V_9 -> V_23 -> V_66 -> V_67 ) ) ;
F_53 ( & V_9 -> V_27 , V_62 ) ;
V_63 = F_54 ( V_9 -> V_23 -> V_66 ) ;
if ( V_63 == V_62 )
return 0 ;
F_18 ( V_11 , & V_41 ) ;
F_55 ( & V_9 -> V_23 -> V_66 -> V_68 ) ;
if ( V_63 & ~ V_69 && V_62 > V_63 ) {
F_34 ( L_19 , V_63 ) ;
V_61 . V_70 = V_71 ;
V_61 . V_72 = V_63 & V_69 ;
V_42 = F_56 ( V_9 -> V_23 , & V_61 ) ;
if ( V_42 < 0 )
goto V_73;
}
V_61 . V_70 = V_71 ;
...
T_1 V_62 ;
int V_42 ;
V_9 = F_2 ( V_75 -> V_9 , struct V_8 , V_27 ) ;
V_11 = F_2 ( V_9 -> V_27 . V_11 ,
struct V_10 , V_11 ) ;
V_75 -> V_9 -> V_5 -> V_28 -> V_64 ( V_75 -> V_9 -> V_5 -> V_31 ,
& V_62 ) ;
F_3 ( L_18 ,
V_75 -> V_9 -> V_43 , ( unsigned long long ) V_62 ) ;
if ( V_9 -> V_23 ) {
ASSERT ( F_52 ( V_9 -> V_23 -> V_66 -> V_67 ) ) ;
F_53 ( & V_9 -> V_27 , V_62 ) ;
V_76 . V_50 = V_9 -> V_23 ;
...
static void F_62 ( struct V_2 * V_11 )
{
F_3 ( L_12 ) ;
}
