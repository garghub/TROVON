...
static T_6 F_67 ( int V_33 , void * V_24 )
{
struct V_1 * V_4 = V_24 ;
F_4 ( V_4 ) ;
return V_117 ;
...
static int F_97 ( struct V_1 * V_4 )
{
int V_28 = - V_134 ;
...
static int F_103 ( struct V_1 * V_4 )
{
int V_28 = - V_134 ;
int V_61 , V_135 , V_136 ;
unsigned int V_5 , V_6 ;
...
static void T_7 F_107 ( struct V_121 * V_23 ,
enum V_142 V_152 )
{
struct V_1 * V_4 = F_108 ( & V_23 -> V_24 ) ;
switch ( V_152 ) {
case V_151 :
case V_153 :
case V_154 :
...
static int F_110 ( struct V_121 * V_23 )
{
struct V_1 * V_4 = F_108 ( & V_23 -> V_24 ) ;
if ( V_4 )
F_81 ( V_4 ) ;
