...
static T_1 F_39 ( struct V_8 * V_9 , const T_2 * V_21 , T_1 * * V_110 )
{
T_1 V_111 [ 2 ] ;
T_1 * V_6 ;
...
static T_1 F_40 ( struct V_8 * V_9 , const T_2 * V_21 , V_54 V_114 )
{
T_1 * V_6 ;
if ( ! ( V_21 [ 0 ] & V_115 ) )
return 0 ;
...
static T_1 F_42 ( struct V_8 * V_9 , const T_2 * V_21 , V_54 V_17 )
{
T_1 * V_6 ;
if ( ! ( V_21 [ 0 ] & V_116 ) )
return 0 ;
...
static T_1 F_43 ( struct V_8 * V_9 , const struct V_117 * time )
{
T_1 * V_6 ;
V_6 = F_37 ( V_9 , 12 ) ;
if ( F_9 ( ! V_6 ) )
return F_2 ( V_14 ) ;
V_6 = F_41 ( V_6 , time -> V_118 ) ;
* V_6 = F_2 ( time -> V_119 ) ;
return 0 ;
}
...
static T_1 F_45 ( struct V_8 * V_9 , const T_2 * V_21 , const struct V_117 * time )
{
if ( ! ( V_21 [ 1 ] & V_121 ) )
return 0 ;
return F_43 ( V_9 , time ) ;
}
static T_1 F_46 ( struct V_8 * V_9 , struct V_122 * V_26 )
{
T_1 V_27 ;
...
if ( F_9 ( V_27 != 0 ) )
return V_27 ;
V_26 -> V_36 = F_37 ( V_9 , 4 ) ;
if ( F_9 ( V_26 -> V_36 == NULL ) )
return F_2 ( V_14 ) ;
return 0 ;
}
static T_1 F_47 ( struct V_8 * V_9 , T_2 V_37 , T_1 V_123 )
{
T_1 * V_6 ;
V_6 = F_37 ( V_9 , 8 ) ;
if ( F_9 ( V_6 == NULL ) )
...
static T_1 F_48 ( struct V_1 * V_2 , struct V_8 * V_9 , const struct V_124 * V_123 )
{
T_1 * V_110 = NULL ;
T_1 V_27 = V_123 -> V_27 ;
if ( F_9 ( V_27 != 0 ) )
goto V_40;
V_27 = F_39 ( V_9 , V_123 -> V_21 , & V_110 ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_40;
V_27 = F_40 ( V_9 , V_123 -> V_21 , V_123 -> V_125 ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_40;
V_27 = F_42 ( V_9 , V_123 -> V_21 , V_123 -> V_17 ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_40;
V_27 = F_44 ( V_9 , V_123 -> V_21 , & V_123 -> ctime ) ;
if ( F_9 ( V_27 != 0 ) )
goto V_40;
V_27 = F_45 ( V_9 , V_123 -> V_21 , & V_123 -> V_126 ) ;
...
static T_1
F_51 ( int V_134 , unsigned int V_135 , struct V_136 * * V_37 )
{
if ( V_135 == V_137 ) {
if ( V_134 != 0 )
return F_2 ( V_138 ) ;
...
static T_1
F_57 ( int V_134 , unsigned int V_135 , struct V_136 * * V_37 )
{
T_1 V_27 = F_51 ( V_134 , V_135 , V_37 ) ;
if ( V_27 != F_2 ( V_153 ) )
return V_27 ;
if ( V_135 == V_168 )
return F_2 ( V_152 ) ;
...
static T_1
F_58 ( unsigned int V_135 , struct V_136 * * V_37 )
{
switch ( V_135 ) {
case V_140 :
case V_141 :
...
static T_1 F_59 ( int V_134 , struct V_1 * V_2 ,
...
switch ( V_164 -> V_32 ) {
case 0 :
V_27 = F_58 ( V_135 , & V_37 ) ;
break;
case 1 :
V_27 = F_51 ( V_134 , V_135 , & V_37 ) ;
break;
case 2 :
V_27 = F_57 ( V_134 , V_135 , & V_37 ) ;
break;
default:
V_27 = F_2 ( V_35 ) ;
}
...
if ( F_15 ( V_27 == 0 ) )
V_27 = V_37 -> F_59 ( V_3 , V_4 , V_164 ) ;
} else
V_27 = F_2 ( V_14 ) ;
V_173:
V_123 = F_47 ( V_170 , V_135 , V_27 ) ;
if ( F_9 ( V_123 ) )
return V_123 ;
...
unsigned int V_36 = 0 ;
F_19 ( L_12 , V_31 ) ;
F_62 ( & V_169 , & V_2 -> V_182 , V_2 -> V_182 . V_183 [ 0 ] . V_184 ) ;
V_6 = ( T_1 * ) ( ( char * ) V_2 -> V_185 . V_183 [ 0 ] . V_184 + V_2 -> V_185 . V_183 [ 0 ] . V_186 ) ;
F_63 ( & V_170 , & V_2 -> V_185 , V_6 ) ;
V_27 = F_17 ( & V_169 , & V_179 ) ;
if ( V_27 == F_64 ( V_14 ) )
return V_187 ;
if ( V_179 . V_32 == 0 ) {
V_164 . V_166 = F_65 ( F_61 ( V_2 ) , V_179 . V_34 ) ;
if ( ! V_164 . V_166 || ! F_66 ( V_164 . V_166 , V_2 ) )
return V_188 ;
}
V_164 . V_32 = V_179 . V_32 ;
V_180 . V_28 = V_179 . V_28 ;
V_180 . V_29 = V_179 . V_29 ;
if ( F_46 ( & V_170 , & V_180 ) != 0 )
return V_189 ;
while ( V_27 == 0 && V_36 != V_179 . V_36 ) {
V_27 = F_59 ( V_36 , V_2 , & V_169 ,
V_3 , & V_170 , V_4 , & V_164 ) ;
V_36 ++ ;
}
