...
int V_44 ;
V_3 = F_18 ( V_40 , sizeof( * V_3 ) ) ;
if ( ! V_3 )
return - V_45 ;
V_44 = F_19 ( V_28 , V_41 , V_46 ) ;
if ( V_44 )
return V_44 ;
V_3 -> V_10 = V_41 ;
...
V_28 -> V_41 = V_41 ;
V_41 += V_67 ;
for ( V_24 = V_62 = 0 , V_65 = V_41 ; V_24 < 4 ; V_24 ++ , V_65 += V_68 ) {
V_63 = F_6 ( V_65 + 0xE ) ;
V_64 = F_6 ( V_65 + 0xF ) ;
if ( V_63 != 'g' || V_64 != 1 )
continue;
...
if ( V_44 )
return V_44 ;
for ( V_24 = 0 ; V_24 < V_62 ; V_24 ++ , V_41 += V_68 ) {
V_40 = & V_28 -> V_69 [ V_24 ] ;
