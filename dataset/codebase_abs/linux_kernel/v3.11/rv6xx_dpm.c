...
static T_3 F_128 ( struct V_7 * V_8 )
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
T_3 V_195 = 0 ;
int V_14 ;
...
F_174 ( V_8 , V_101 , true ) ;
if ( V_8 -> V_271 . V_272 &&
F_195 ( V_8 -> V_10 . V_273 ) ) {
V_36 = F_196 ( V_8 , V_274 , V_275 ) ;
if ( V_36 )
return V_36 ;
V_8 -> V_271 . V_276 = true ;
F_197 ( V_8 ) ;
}
...
{
struct V_6 * V_9 = F_2 ( V_8 ) ;
struct V_2 * V_198 = V_8 -> V_10 . V_11 . V_279 ;
struct V_2 * V_232 = V_8 -> V_10 . V_11 . V_280 ;
int V_36 ;
V_9 -> V_243 = 0 ;
...
F_206 ( V_8 ) ;
if ( V_284 != 0 ) {
if ( V_8 -> V_10 . V_11 . V_267 & V_285 )
F_10 ( V_8 ) ;
if ( V_8 -> V_10 . V_11 . V_267 & V_286 )
F_12 ( V_8 ) ;
if ( V_8 -> V_10 . V_11 . V_267 & V_287 )
F_14 ( V_8 ) ;
}
}
...
struct V_288 * V_289 )
{
V_3 -> V_290 = F_209 ( V_289 -> V_291 ) ;
V_3 -> V_292 = F_210 ( V_289 -> V_293 ) ;
V_3 -> V_294 = F_210 ( V_289 -> V_295 ) ;
if ( F_211 ( V_3 -> V_292 , V_3 -> V_294 ) ) {
V_3 -> V_264 = V_296 ;
V_3 -> V_265 = V_297 ;
} else {
V_3 -> V_264 = 0 ;
...
V_98 = F_210 ( V_302 -> V_305 . V_306 ) ;
V_98 |= V_302 -> V_305 . V_307 << 16 ;
V_107 = F_210 ( V_302 -> V_305 . V_308 ) ;
V_107 |= V_302 -> V_305 . V_309 << 16 ;
V_304 -> V_107 = V_107 ;
V_304 -> V_98 = V_98 ;
V_304 -> V_111 = F_210 ( V_302 -> V_305 . V_310 ) ;
V_304 -> V_113 = F_209 ( V_302 -> V_305 . V_311 ) ;
if ( V_304 -> V_111 == 0xff01 ) {
if ( F_213 ( V_8 , 0 , 0 , & V_111 ) == 0 )
V_304 -> V_111 = V_111 ;
}
if ( V_304 -> V_113 & V_116 ) {
if ( ( V_8 -> V_312 == V_313 ) || ( V_8 -> V_312 == V_314 ) ) {
if ( V_304 -> V_111 < 1100 )
V_304 -> V_113 &= ~ V_116 ;
}
}
if ( V_3 -> V_292 & V_298 ) {
T_4 V_111 , V_315 , V_316 ;
F_214 ( V_8 , & V_111 , & V_315 , & V_316 ) ;
V_304 -> V_107 = V_8 -> clock . V_317 ;
V_304 -> V_98 = V_8 -> clock . V_318 ;
V_304 -> V_111 = V_111 ;
}
}
static int F_215 ( struct V_7 * V_8 )
{
struct V_319 * V_320 = & V_8 -> V_320 ;
struct V_288 * V_289 ;
union V_321 * V_322 ;
int V_14 , V_323 ;
union V_301 * V_302 ;
union V_324 * V_324 ;
int V_69 = F_216 ( V_325 , V_326 ) ;
T_4 V_327 ;
T_2 V_328 , V_329 ;
struct V_1 * V_4 ;
if ( ! F_217 ( V_320 -> V_330 , V_69 , NULL ,
& V_328 , & V_329 , & V_327 ) )
return - V_138 ;
V_324 = (union V_324 * ) ( V_320 -> V_330 -> V_331 + V_327 ) ;
V_8 -> V_10 . V_11 . V_4 = F_218 ( sizeof( struct V_2 ) *
V_324 -> V_332 . V_333 , V_334 ) ;
if ( ! V_8 -> V_10 . V_11 . V_4 )
return - V_335 ;
V_8 -> V_10 . V_11 . V_267 = F_209 ( V_324 -> V_332 . V_336 ) ;
V_8 -> V_10 . V_11 . V_194 = F_210 ( V_324 -> V_332 . V_337 ) ;
V_8 -> V_10 . V_11 . V_193 = F_210 ( V_324 -> V_332 . V_338 ) ;
for ( V_14 = 0 ; V_14 < V_324 -> V_332 . V_333 ; V_14 ++ ) {
V_322 = (union V_321 * )
( V_320 -> V_330 -> V_331 + V_327 +
F_210 ( V_324 -> V_332 . V_339 ) +
V_14 * V_324 -> V_332 . V_340 ) ;
V_289 = (struct V_288 * )
( V_320 -> V_330 -> V_331 + V_327 +
F_210 ( V_324 -> V_332 . V_341 ) +
( V_322 -> V_342 . V_343 *
V_324 -> V_332 . V_344 ) ) ;
if ( V_324 -> V_332 . V_340 - 1 ) {
V_4 = F_218 ( sizeof( struct V_1 ) , V_334 ) ;
if ( V_4 == NULL ) {
F_219 ( V_8 -> V_10 . V_11 . V_4 ) ;
return - V_335 ;
}
V_8 -> V_10 . V_11 . V_4 [ V_14 ] . V_5 = V_4 ;
F_208 ( V_8 , & V_8 -> V_10 . V_11 . V_4 [ V_14 ] ,
V_289 ) ;
for ( V_323 = 0 ; V_323 < ( V_324 -> V_332 . V_340 - 1 ) ; V_323 ++ ) {
V_302 = (union V_301 * )
( V_320 -> V_330 -> V_331 + V_327 +
F_210 ( V_324 -> V_332 . V_345 ) +
( V_322 -> V_342 . V_346 [ V_323 ] *
V_324 -> V_332 . V_347 ) ) ;
F_212 ( V_8 ,
& V_8 -> V_10 . V_11 . V_4 [ V_14 ] , V_323 ,
V_302 ) ;
}
}
}
V_8 -> V_10 . V_11 . V_348 = V_324 -> V_332 . V_333 ;
return 0 ;
}
...
struct V_6 * V_9 ;
int V_36 ;
V_9 = F_218 ( sizeof( struct V_6 ) , V_334 ) ;
if ( V_9 == NULL )
return - V_335 ;
...
V_8 -> V_10 . V_11 . V_193 = V_349 ;
if ( V_8 -> V_10 . V_11 . V_194 == 0 )
V_8 -> V_10 . V_11 . V_194 = V_350 ;
V_36 = F_18 ( V_8 , V_39 ,
0 , false , & V_38 ) ;
if ( V_36 )
...
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_303 * V_304 ;
F_223 ( V_3 -> V_292 , V_3 -> V_294 ) ;
F_224 ( V_3 -> V_290 ) ;
F_225 ( L_1 , V_3 -> V_264 , V_3 -> V_265 ) ;
V_304 = & V_4 -> V_61 ;
F_225 ( L_2 ,
V_304 -> V_98 , V_304 -> V_107 , V_304 -> V_111 ) ;
V_304 = & V_4 -> V_100 ;
F_225 ( L_3 ,
V_304 -> V_98 , V_304 -> V_107 , V_304 -> V_111 ) ;
V_304 = & V_4 -> V_62 ;
...
struct V_354 * V_355 )
{
struct V_2 * V_3 = V_8 -> V_10 . V_11 . V_280 ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
struct V_303 * V_304 ;
T_1 V_356 =
( F_80 ( V_357 ) & V_358 ) >>
...
V_304 = & V_4 -> V_62 ;
F_228 ( V_355 , L_6 , V_3 -> V_264 , V_3 -> V_265 ) ;
F_228 ( V_355 , L_7 ,
V_356 , V_304 -> V_98 , V_304 -> V_107 , V_304 -> V_111 ) ;
}
}
void F_229 ( struct V_7 * V_8 )
{
int V_14 ;
for ( V_14 = 0 ; V_14 < V_8 -> V_10 . V_11 . V_348 ; V_14 ++ ) {
F_219 ( V_8 -> V_10 . V_11 . V_4 [ V_14 ] . V_5 ) ;
}
F_219 ( V_8 -> V_10 . V_11 . V_4 ) ;
F_219 ( V_8 -> V_10 . V_11 . V_12 ) ;
}
T_1 F_230 ( struct V_7 * V_8 , bool V_61 )
{
struct V_1 * V_360 = F_1 ( V_8 -> V_10 . V_11 . V_279 ) ;
if ( V_61 )
return V_360 -> V_61 . V_98 ;
else
return V_360 -> V_62 . V_98 ;
}
T_1 F_231 ( struct V_7 * V_8 , bool V_61 )
{
struct V_1 * V_360 = F_1 ( V_8 -> V_10 . V_11 . V_279 ) ;
if ( V_61 )
return V_360 -> V_61 . V_107 ;
else
return V_360 -> V_62 . V_107 ;
}
