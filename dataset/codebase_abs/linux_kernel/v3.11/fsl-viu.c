...
memcpy ( V_135 , & V_232 , sizeof( V_232 ) ) ;
...
F_116 ( V_7 -> V_135 , V_7 ) ;
F_93 ( & V_7 -> V_187 ) ;
V_94 = F_117 ( V_7 -> V_135 , V_233 , - 1 ) ;
if ( V_94 < 0 ) {
F_118 ( V_7 -> V_135 ) ;
goto V_231;
}
V_7 -> V_234 = F_119 ( & V_213 -> V_8 , L_56 ) ;
if ( F_120 ( V_7 -> V_234 ) ) {
...
{
struct V_237 * V_226 = F_131 ( & V_213 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_226 , struct V_7 , V_226 ) ;
struct V_238 * V_239 = F_9 ( V_226 -> V_240 . V_25 ,
struct V_238 , V_241 ) ;
