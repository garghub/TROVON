...
if ( V_68 == - V_171 && ! F_116 ( V_127 ) )
F_42 ( V_74 , & V_13 -> V_29 ) ;
return V_68 ? : F_117 ( V_19 , V_170 , V_168 , V_169 ) ;
}
static int F_118 ( struct V_9 * V_10 ,
T_5 V_174 , void * V_143 )
{
struct V_12 * V_13 = V_10 -> V_14 ;
struct V_5 * V_6 ;
struct V_1 * V_99 ;
...
F_30 (pg, &m->priority_groups, list) {
F_30 (p, &pg->pgpaths, list) {
V_113 = V_174 ( V_10 , V_99 -> V_17 . V_18 , V_10 -> V_175 , V_10 -> V_116 , V_143 ) ;
if ( V_113 )
goto V_132;
}
}
