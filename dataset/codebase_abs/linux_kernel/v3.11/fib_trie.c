...
V_261 , 0 , V_253 , 0 , 0 , 0 ,
V_97 , 0 , 0 , 0 , & V_199 ) ;
F_129 ( V_219 , L_54 , 127 - V_199 , L_55 ) ;
}
}
return 0 ;
}
static int F_157 ( struct V_67 * V_67 , struct V_234 * V_234 )
{
return F_149 ( V_67 , V_234 , & V_269 ,
sizeof( struct V_250 ) ) ;
}
int T_9 F_158 ( struct V_228 * V_228 )
{
if ( ! F_159 ( L_56 , V_270 , V_228 -> V_271 , & V_272 ) )
goto V_273;
if ( ! F_159 ( L_57 , V_270 , V_228 -> V_271 ,
& V_274 ) )
goto V_275;
if ( ! F_159 ( L_58 , V_270 , V_228 -> V_271 , & V_276 ) )
goto V_277;
return 0 ;
V_277:
F_160 ( L_57 , V_228 -> V_271 ) ;
V_275:
F_160 ( L_56 , V_228 -> V_271 ) ;
V_273:
return - V_66 ;
}
void T_10 F_161 ( struct V_228 * V_228 )
{
F_160 ( L_56 , V_228 -> V_271 ) ;
F_160 ( L_57 , V_228 -> V_271 ) ;
F_160 ( L_58 , V_228 -> V_271 ) ;
}
