...
{
int V_34 ;
F_2 ( V_8 -> V_35 == NULL || V_8 -> V_36 == NULL ) ;
V_34 = V_8 -> V_28 == V_37 ;
while ( V_8 -> V_35 != NULL ) {
struct V_1 * V_35 ;
V_35 = V_8 -> V_35 ;
...
void
F_22 ( struct V_1 * V_8 , struct V_39 * V_39 )
{
struct V_5 * V_6 ;
V_6 = V_8 -> V_21 ;
if ( V_8 -> V_40 == - V_41 ) {
F_23 ( & V_6 -> V_30 -> V_31 , L_3 , V_8 ) ;
return;
}
if ( V_8 -> V_40 == - V_42 ) {
F_23 ( & V_6 -> V_30 -> V_31 , L_4 , V_8 ) ;
return;
}
if ( V_6 -> V_43 && V_6 -> V_43 -> V_44 )
V_6 -> V_43 -> V_44 ( V_6 , V_8 , V_39 ) ;
}
void
F_24 ( struct V_1 * V_8 , struct V_39 * V_39 )
{
struct V_5 * V_6 ;
V_6 = V_8 -> V_21 ;
if ( V_6 -> V_43 && V_6 -> V_43 -> V_45 )
V_6 -> V_43 -> V_45 ( V_6 , V_39 , L_5 ) ;
}
