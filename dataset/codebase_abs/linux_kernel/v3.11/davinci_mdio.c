...
V_2 -> V_20 = V_20 ;
F_33 ( & V_2 -> V_39 ) ;
V_58 = F_34 ( V_50 , V_73 , 0 ) ;
if ( ! V_58 ) {
F_13 ( V_20 , L_14 ) ;
V_35 = - V_74 ;
goto V_64;
}
V_58 = F_35 ( V_20 , V_58 -> V_75 , F_36 ( V_58 ) ,
F_25 ( V_20 ) ) ;
if ( ! V_58 ) {
F_13 ( V_20 , L_15 ) ;
V_35 = - V_76 ;
...
V_2 -> V_11 = F_37 ( V_20 , V_58 -> V_75 , F_36 ( V_58 ) ) ;
if ( ! V_2 -> V_11 ) {
F_13 ( V_20 , L_16 ) ;
V_35 = - V_63 ;
goto V_64;
...
static int F_49 ( struct V_56 * V_20 )
{
struct V_1 * V_2 = F_45 ( V_20 ) ;
F_26 ( V_20 ) ;
F_28 ( V_2 -> V_20 ) ;
