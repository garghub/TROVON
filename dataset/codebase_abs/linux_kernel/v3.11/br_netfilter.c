...
static
int F_105 ( struct V_142 * V_143 , int V_144 ,
void T_5 * V_145 , T_6 * V_146 , T_7 * V_147 )
{
int V_76 ;
V_76 = F_106 ( V_143 , V_144 , V_145 , V_146 , V_147 ) ;
...
if ( V_76 < 0 )
return V_76 ;
V_76 = F_109 ( V_148 , F_110 ( V_148 ) ) ;
if ( V_76 < 0 ) {
F_111 ( & V_30 ) ;
return V_76 ;
}
#ifdef F_112
V_149 = F_113 ( & V_150 , L_1 , V_151 ) ;
if ( V_149 == NULL ) {
F_114 ( V_152
L_2 ) ;
F_115 ( V_148 , F_110 ( V_148 ) ) ;
F_111 ( & V_30 ) ;
return - V_153 ;
}
#endif
