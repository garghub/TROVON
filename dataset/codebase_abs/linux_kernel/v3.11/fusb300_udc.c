...
int V_81 = 0 ;
int V_59 ;
V_203 = F_126 ( V_201 , V_206 , 0 ) ;
if ( ! V_203 ) {
V_81 = - V_207 ;
F_12 ( L_30 ) ;
goto V_208;
}
V_204 = F_126 ( V_201 , V_209 , 0 ) ;
if ( ! V_204 ) {
V_81 = - V_207 ;
F_127 ( & V_201 -> V_210 ,
L_31 ) ;
...
V_4 = F_128 ( V_203 -> V_211 , F_129 ( V_203 ) ) ;
if ( V_4 == NULL ) {
V_81 = - V_212 ;
F_12 ( L_33 ) ;
goto V_208;
...
V_1 -> V_4 = V_4 ;
V_81 = F_132 ( V_204 -> V_211 , F_108 , V_218 ,
V_217 , V_1 ) ;
if ( V_81 < 0 ) {
F_12 ( L_36 , V_81 ) ;
goto V_208;
}
V_81 = F_132 ( V_205 -> V_211 , F_108 ,
V_218 , V_217 , V_1 ) ;
if ( V_81 < 0 ) {
F_12 ( L_37 , V_81 ) ;
goto V_208;
...
F_114 ( V_1 ) ;
V_81 = F_133 ( & V_201 -> V_210 , & V_1 -> V_74 ) ;
if ( V_81 )
goto V_225;
F_134 ( & V_201 -> V_210 , L_38 , V_226 ) ;
return 0 ;
V_225:
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_102 ) ;
V_224:
F_123 ( V_204 -> V_211 , V_1 ) ;
V_208:
if ( V_1 ) {
if ( V_1 -> V_102 )
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 ,
