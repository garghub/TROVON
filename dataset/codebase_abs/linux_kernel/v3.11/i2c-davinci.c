...
V_8 -> V_11 = V_8 -> V_8 -> V_113 ;
F_43 ( V_104 , V_8 ) ;
if ( ! V_8 -> V_11 && V_104 -> V_8 . V_114 ) {
T_2 V_115 ;
V_8 -> V_11 = F_41 ( & V_104 -> V_8 ,
sizeof( struct V_10 ) , V_110 ) ;
if ( ! V_8 -> V_11 )
return - V_111 ;
memcpy ( V_8 -> V_11 , & V_116 ,
sizeof( struct V_10 ) ) ;
if ( ! F_44 ( V_104 -> V_8 . V_114 , L_20 ,
& V_115 ) )
V_8 -> V_11 -> V_23 = V_115 / 1000 ;
} else if ( ! V_8 -> V_11 ) {
V_8 -> V_11 = & V_116 ;
}
V_8 -> V_18 = F_45 ( & V_104 -> V_8 , NULL ) ;
if ( F_46 ( V_8 -> V_18 ) )
return - V_109 ;
F_47 ( V_8 -> V_18 ) ;
V_106 = F_40 ( V_104 , V_117 , 0 ) ;
V_8 -> V_5 = F_48 ( & V_104 -> V_8 , V_106 ) ;
if ( F_46 ( V_8 -> V_5 ) ) {
V_45 = F_49 ( V_8 -> V_5 ) ;
goto V_118;
}
F_14 ( V_8 ) ;
V_45 = F_50 ( & V_104 -> V_8 , V_8 -> V_107 , F_31 , 0 ,
V_104 -> V_119 , V_8 ) ;
if ( V_45 ) {
...
V_41 -> V_120 = V_121 ;
V_41 -> V_122 = V_123 ;
F_52 ( V_41 -> V_119 , L_23 , sizeof( V_41 -> V_119 ) ) ;
V_41 -> V_124 = & V_125 ;
V_41 -> V_8 . V_126 = & V_104 -> V_8 ;
V_41 -> V_32 = V_127 ;
V_41 -> V_8 . V_114 = V_104 -> V_8 . V_114 ;
