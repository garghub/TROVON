...
static int F_23 ( struct V_4 * V_51 ,
...
static int F_27 ( struct V_57 * V_57 , struct V_58 * V_59 )
{
struct V_13 * V_14 = F_14 ( F_28 ( V_57 ) ) ;
const struct V_6 * * V_60 , * * V_61 ;
if ( ! V_14 )
return - V_21 ;
if ( ! F_29 ( V_57 , V_59 ) )
goto V_45;
if ( V_59 -> V_62 >= 2 + F_30 ( V_63 ) )
goto V_45;
V_60 = V_63 + ( V_59 -> V_62 - 2 ) ;
V_61 = & V_63 [ F_30 ( V_63 ) - 1 ] ;
while ( V_60 <= V_61 ) {
const struct V_6 * V_64 = * V_60 ;
if ( ! F_31 ( V_57 , V_59 , V_64 -> V_9 , strlen ( V_64 -> V_9 ) ,
F_23 , V_14 , V_64 ) )
break;
V_59 -> V_62 ++ ;
V_60 ++ ;
...
if ( V_60 == V_61 )
goto V_45;
error = F_23 ( V_51 , V_1 , V_14 , * V_60 ) ;
V_45:
F_20 ( V_14 ) ;
V_67:
return F_6 ( error ) ;
}
struct V_57 * F_33 ( int V_68 )
{
struct V_57 * V_57 ;
V_57 = F_34 ( V_68 ) ;
if ( ! V_57 )
...
struct V_73 * F_36 ( struct V_4 * V_4 )
{
return & F_3 ( V_4 ) -> V_8 ;
}
