...
static void F_34 ( struct V_4 * V_5 , T_1 V_96 )
{
struct V_97 V_98 = {
. V_99 = V_100 ,
. V_101 = { sizeof( T_1 ) , } ,
...
{
const struct V_104 * V_59 = V_5 -> V_58 . V_59 ;
struct V_65 * V_66 = & V_5 -> V_58 ;
T_6 V_105 = V_5 -> V_105 ;
bool V_106 = false ;
int V_88 ;
T_1 V_103 ;
F_24 ( V_5 , L_4 , V_5 -> V_105 ) ;
if ( V_59 -> V_107 && V_105 >= V_59 -> V_108 ) {
F_14 ( V_5 ) ;
return;
}
if ( V_59 -> V_109 ) {
...
F_29 ( V_5 , true ) ;
V_106 = true ;
} else if ( V_105 <= V_59 -> V_116 ) {
F_29 ( V_5 , false ) ;
}
}
if ( V_59 -> V_117 ) {
V_103 = 0 ;
for ( V_88 = 0 ; V_88 < V_118 ; V_88 ++ ) {
if ( V_105 < V_59 -> V_103 [ V_88 ] . V_105 )
break;
V_103 = V_59 -> V_103 [ V_88 ] . V_96 ;
}
if ( V_103 != 0 )
V_106 = true ;
if ( V_66 -> V_103 != V_103 )
...
L_15 ) ;
V_66 -> V_119 = true ;
} else if ( V_66 -> V_119 && ! V_66 -> V_78 && V_66 -> V_103 == 0 &&
V_105 <= V_59 -> V_116 ) {
F_38 ( V_5 ,
L_16 ) ;
V_66 -> V_119 = false ;
