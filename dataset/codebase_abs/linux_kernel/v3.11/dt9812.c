...
unsigned int * V_81 )
{
unsigned int V_83 = V_81 [ 0 ] ;
unsigned int V_37 = V_81 [ 1 ] ;
if ( V_83 ) {
V_78 -> V_84 &= ~ V_83 ;
V_78 -> V_84 |= ( V_37 & V_83 ) ;
F_14 ( V_2 , V_78 -> V_84 ) ;
...
unsigned int * V_81 )
{
unsigned int V_85 = F_22 ( V_80 -> V_86 ) ;
T_3 V_64 = 0 ;
int V_14 ;
int V_27 ;
for ( V_27 = 0 ; V_27 < V_80 -> V_82 ; V_27 ++ ) {
V_14 = F_17 ( V_2 , V_85 , & V_64 , V_56 ) ;
if ( V_14 )
return V_14 ;
V_81 [ V_27 ] = V_64 ;
}
...
for ( V_27 = 0 ; V_27 < V_90 -> V_94 . V_95 ; ++ V_27 ) {
int V_98 = - 1 ;
V_93 = & V_90 -> V_99 [ V_27 ] . V_94 ;
switch ( V_27 ) {
case 0 :
V_98 = V_100 ;
break;
case 1 :
V_98 = V_101 ;
V_9 -> V_21 . V_22 = V_93 -> V_102 ;
V_9 -> V_21 . V_103 = F_28 ( V_93 -> V_104 ) ;
break;
case 2 :
V_98 = V_100 ;
V_9 -> V_24 . V_22 = V_93 -> V_102 ;
V_9 -> V_24 . V_103 = F_28 ( V_93 -> V_104 ) ;
break;
case 3 :
V_98 = V_101 ;
break;
...
int V_14 ;
int V_27 ;
V_14 = F_1 ( V_2 , 0 , & V_109 , sizeof( V_109 ) ) ;
if ( V_14 ) {
F_30 ( V_7 ) ;
for ( V_27 = 0 ; V_27 < 10 ; V_27 ++ ) {
V_14 = F_1 ( V_2 , 1 , & V_109 , sizeof( V_109 ) ) ;
if ( V_14 == 0 )
break;
}
if ( V_14 ) {
...
V_9 -> V_44 = F_28 ( V_108 ) ;
V_14 = F_1 ( V_2 , 7 , & V_105 , sizeof( V_105 ) ) ;
if ( V_14 ) {
F_27 ( V_2 -> V_96 , L_7 ) ;
return V_14 ;
}
...
V_78 = & V_2 -> V_115 [ 2 ] ;
V_78 -> type = V_126 ;
V_78 -> V_117 = V_118 | V_127 ;
V_78 -> V_119 = 8 ;
V_78 -> V_120 = 0x0fff ;
V_78 -> V_121 = V_112 ? & V_128 : & V_129 ;
V_78 -> V_130 = F_21 ;
V_78 = & V_2 -> V_115 [ 3 ] ;
V_78 -> type = V_131 ;
V_78 -> V_117 = V_125 ;
...
{
return F_40 ( V_88 , & V_135 , V_134 -> V_136 ) ;
}
