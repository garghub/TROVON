...
T_2 V_80 ;
const char * V_81 ;
V_76 = F_32 ( V_9 , V_82 , 0 ) ;
if ( ! V_76 )
return - V_83 ;
V_2 = F_33 ( sizeof( struct V_3 ) ) ;
if ( ! V_2 )
return - V_14 ;
V_4 = F_2 ( V_2 ) ;
V_4 -> V_9 = V_9 ;
...
F_34 ( & V_4 -> V_84 ) ;
V_2 -> V_85 = V_76 -> V_86 ;
V_4 -> V_76 = F_35 ( & V_9 -> V_2 , V_76 -> V_86 , F_36 ( V_76 ) ) ;
if ( ! V_4 -> V_76 ) {
V_79 = - V_14 ;
goto V_87;
}
V_4 -> V_88 = F_37 ( & V_9 -> V_2 , L_3 ) ;
if ( F_38 ( V_4 -> V_88 ) ) {
V_79 = F_39 ( V_4 -> V_88 ) ;
goto V_87;
}
F_40 ( V_4 -> V_88 ) ;
V_2 -> V_62 = F_41 ( V_9 , 0 ) ;
V_79 = F_42 ( & V_9 -> V_2 , V_2 -> V_62 , F_24 , 0 , V_2 -> V_89 , V_2 ) ;
if ( V_79 )
goto V_90;
F_43 ( V_2 ) ;
V_2 -> V_91 = & V_92 ;
...
F_44 ( V_9 , V_2 ) ;
F_45 ( V_2 , & V_9 -> V_2 ) ;
V_81 = F_46 ( V_9 -> V_2 . V_95 ) ;
if ( V_81 )
memcpy ( V_4 -> V_2 -> V_96 , V_81 , V_97 ) ;
else
F_47 ( V_4 ) ;
V_79 = F_48 ( V_9 -> V_2 . V_95 ) ;
if ( V_79 < 0 ) {
if ( V_73 && V_73 -> V_98 )
V_4 -> V_99 = V_100 ;
else
...
F_6 ( V_4 , V_22 , 0 ) ;
V_80 = F_18 ( V_102 , V_103 ) | F_5 ( V_104 ) ;
if ( V_4 -> V_99 == V_100 )
V_80 |= F_5 ( V_105 ) ;
F_6 ( V_4 , V_106 , V_80 ) ;
V_79 = F_49 ( V_2 ) ;
...
V_78 = V_4 -> V_35 ;
F_52 ( V_2 , L_4 ,
V_78 -> V_108 -> V_89 , F_53 ( & V_78 -> V_2 ) ,
V_78 -> V_62 ) ;
F_52 ( V_2 , L_5 ,
V_2 -> V_85 , V_2 -> V_62 , V_2 -> V_96 ) ;
return 0 ;
V_107:
F_54 ( V_2 ) ;
V_90:
...
static int F_57 ( struct V_71 * V_9 )
{
struct V_1 * V_2 = F_58 ( V_9 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
if ( V_4 -> V_35 )
F_59 ( V_4 -> V_35 ) ;
F_60 ( V_4 -> V_109 ) ;
...
static int F_63 ( struct V_71 * V_9 , T_5 V_110 )
{
struct V_1 * V_111 = F_58 ( V_9 ) ;
struct V_3 * V_4 = F_2 ( V_111 ) ;
if ( F_64 ( V_111 ) ) {
F_13 ( V_111 ) ;
F_65 ( V_111 ) ;
F_55 ( V_4 -> V_88 ) ;
...
static int F_66 ( struct V_71 * V_9 )
{
struct V_1 * V_111 = F_58 ( V_9 ) ;
struct V_3 * V_4 = F_2 ( V_111 ) ;
if ( F_64 ( V_111 ) ) {
