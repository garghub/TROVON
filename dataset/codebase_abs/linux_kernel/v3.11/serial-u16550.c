...
V_2 -> V_18 = 0 ;
V_2 -> V_22 = 0 ;
memset ( V_2 -> V_96 , 0x80 , sizeof( unsigned char ) * V_116 ) ;
F_46 ( & V_2 -> V_4 ) ;
V_2 -> V_4 . V_117 = F_14 ;
V_2 -> V_4 . V_45 = ( unsigned long ) V_2 ;
V_2 -> V_3 = 0 ;
if ( ( V_111 = F_47 ( V_103 , V_118 , V_2 , & V_109 ) ) < 0 ) {
F_36 ( V_2 ) ;
return V_111 ;
}
switch ( V_2 -> V_23 ) {
...
static void F_48 ( struct V_119 * V_120 )
{
struct V_81 * V_17 ;
...
static int F_50 ( struct V_1 * V_2 , int V_100 ,
int V_121 , int V_122 ,
struct V_123 * * V_31 )
{
struct V_123 * V_124 ;
...
F_52 ( V_124 , V_127 ,
& V_128 ) ;
strcpy ( V_124 -> V_32 , L_2 ) ;
F_48 ( & V_124 -> V_129 [ V_127 ] ) ;
F_48 ( & V_124 -> V_129 [ V_125 ] ) ;
V_124 -> V_130 = V_131 |
V_132 |
V_133 ;
V_124 -> V_82 = V_2 ;
...
if ( V_121 [ V_136 ] < 1 || V_121 [ V_136 ] > V_116 ) {
F_10 ( V_52
L_10 ,
V_116 , V_121 [ V_136 ] ) ;
return - V_50 ;
}
if ( V_122 [ V_136 ] < 1 || V_122 [ V_136 ] > V_25 ) {
F_10 ( V_52
L_11 ,
V_25 , V_122 [ V_136 ] ) ;
return - V_50 ;
}
V_111 = F_54 ( V_139 [ V_136 ] , V_137 [ V_136 ] , V_140 , 0 , & V_103 ) ;
if ( V_111 < 0 )
return V_111 ;
strcpy ( V_103 -> V_141 , L_12 ) ;
strcpy ( V_103 -> V_142 , L_13 ) ;
if ( ( V_111 = F_41 ( V_103 ,
V_143 [ V_136 ] ,
V_38 [ V_136 ] ,
V_105 [ V_136 ] ,
...
& V_2 ) ) < 0 )
goto V_144;
V_111 = F_50 ( V_2 , 0 , V_121 [ V_136 ] , V_122 [ V_136 ] , & V_2 -> V_31 ) ;
if ( V_111 < 0 )
goto V_144;
sprintf ( V_103 -> V_145 , L_14 ,
V_103 -> V_142 ,
V_146 [ V_2 -> V_23 ] ,
V_2 -> V_11 ,
V_2 -> V_38 ) ;
F_55 ( V_103 , & V_135 -> V_136 ) ;
...
{
int V_147 ;
for ( V_147 = 0 ; V_147 < F_62 ( V_148 ) ; ++ V_147 )
F_63 ( V_148 [ V_147 ] ) ;
F_64 ( & V_149 ) ;
}
static int T_2 F_65 ( void )
{
int V_147 , V_150 , V_111 ;
if ( ( V_111 = F_66 ( & V_149 ) ) < 0 )
return V_111 ;
V_150 = 0 ;
