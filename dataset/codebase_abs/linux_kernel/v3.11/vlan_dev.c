...
F_77 ( V_24 -> V_46 ) ;
V_24 -> V_46 = NULL ;
for ( V_159 = 0 ; V_159 < F_78 ( V_24 -> V_17 ) ; V_159 ++ ) {
...
return F_82 ( V_24 -> V_39 , V_88 ) ;
}
static void F_83 ( struct V_3 * V_4 ,
struct V_164 * V_165 )
{
F_84 ( V_165 -> V_166 , V_167 , sizeof( V_165 -> V_166 ) ) ;
F_84 ( V_165 -> V_168 , V_169 , sizeof( V_165 -> V_168 ) ) ;
F_84 ( V_165 -> V_170 , L_2 , sizeof( V_165 -> V_170 ) ) ;
}
static struct V_171 * F_85 ( struct V_3 * V_4 , struct V_171 * V_47 )
{
if ( F_9 ( V_4 ) -> V_46 ) {
struct V_46 * V_81 ;
T_3 V_172 = 0 , V_51 = 0 ;
...
unsigned int V_178 ;
V_81 = F_87 ( F_9 ( V_4 ) -> V_46 , V_159 ) ;
do {
V_178 = F_88 ( & V_81 -> V_48 ) ;
V_173 = V_81 -> V_179 ;
V_174 = V_81 -> V_180 ;
V_175 = V_81 -> V_181 ;
V_176 = V_81 -> V_49 ;
V_177 = V_81 -> V_50 ;
} while ( F_89 ( & V_81 -> V_48 , V_178 ) );
V_47 -> V_179 += V_173 ;
V_47 -> V_180 += V_174 ;
V_47 -> V_182 += V_175 ;
V_47 -> V_49 += V_176 ;
...
static int F_91 ( struct V_3 * V_4 , struct V_183 * V_184 ,
T_6 V_185 )
{
struct F_9 * V_24 = F_9 ( V_4 ) ;
struct V_3 * V_39 = V_24 -> V_39 ;
struct V_40 * V_40 ;
int V_72 = 0 ;
V_40 = F_92 ( sizeof( * V_40 ) , V_185 ) ;
V_72 = - V_157 ;
if ( ! V_40 )
goto V_75;
V_72 = F_93 ( V_40 , V_39 , V_185 ) ;
if ( V_72 ) {
F_79 ( V_40 ) ;
goto V_75;
}
