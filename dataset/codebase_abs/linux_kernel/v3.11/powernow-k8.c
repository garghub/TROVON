...
V_137 = F_48 ( F_14 () ) ;
F_49 ( V_137 ) ;
F_50 ( V_137 , & V_140 , V_143 ) ;
V_138 = F_20 ( V_10 , V_3 , V_19 ) ;
if ( V_138 )
V_140 . V_142 = V_140 . V_141 ;
else
V_140 . V_142 = F_4 ( V_10 -> V_14 ) ;
F_50 ( V_137 , & V_140 , V_144 ) ;
return V_138 ;
}
static long F_51 ( void * V_145 )
{
struct V_146 * V_147 = V_145 ;
struct V_136 * V_148 = V_147 -> V_148 ;
unsigned V_149 = V_147 -> V_149 ;
unsigned V_150 = V_147 -> V_150 ;
struct V_9 * V_10 = F_52 ( V_151 , V_148 -> V_2 ) ;
T_1 V_152 ;
T_1 V_153 ;
unsigned int V_154 ;
int V_155 ;
...
F_9 ( L_97 ,
V_148 -> V_2 , V_149 , V_148 -> V_156 , V_148 -> V_157 , V_150 ) ;
if ( F_8 ( V_10 ) )
return - V_80 ;
F_9 ( L_98 ,
V_10 -> V_14 , V_10 -> V_12 ) ;
...
if ( F_54 ( V_148 , V_10 -> V_70 ,
V_149 , V_150 , & V_154 ) )
return - V_80 ;
F_55 ( & V_159 ) ;
F_36 ( V_10 , V_154 ) ;
V_155 = F_47 ( V_10 , V_154 ) ;
if ( V_155 ) {
...
F_56 ( & V_159 ) ;
V_148 -> V_160 = F_4 ( V_10 -> V_14 ) ;
return 0 ;
}
static int F_57 ( struct V_136 * V_148 ,
unsigned V_149 , unsigned V_150 )
{
struct V_146 V_147 = { . V_148 = V_148 , . V_149 = V_149 ,
. V_150 = V_150 } ;
return F_58 ( V_148 -> V_2 , F_51 , & V_147 ) ;
}
static int F_59 ( struct V_136 * V_148 )
{
struct V_9 * V_10 = F_52 ( V_151 , V_148 -> V_2 ) ;
if ( ! V_10 )
return - V_67 ;
return F_60 ( V_148 , V_10 -> V_70 ) ;
}
static void F_61 ( void * V_161 )
{
struct V_162 * V_162 = V_161 ;
if ( F_6 () ) {
...
static int F_62 ( struct V_136 * V_148 )
{
struct V_9 * V_10 ;
struct V_162 V_162 ;
int V_50 ;
F_63 ( V_148 -> V_2 , F_24 , & V_50 , 1 ) ;
if ( V_50 )
return - V_51 ;
...
if ( V_50 != 0 )
goto V_165;
F_67 ( V_148 -> V_166 , F_1 ( V_148 -> V_2 ) ) ;
V_10 -> V_167 = V_148 -> V_166 ;
V_148 -> V_160 = F_4 ( V_10 -> V_14 ) ;
F_9 ( L_106 , V_148 -> V_160 ) ;
if ( F_68 ( V_148 , V_10 -> V_70 ) ) {
...
F_69 ( V_10 -> V_70 , V_148 -> V_2 ) ;
F_9 ( L_108 ,
V_10 -> V_14 , V_10 -> V_12 ) ;
F_52 ( V_151 , V_148 -> V_2 ) = V_10 ;
return 0 ;
V_165:
F_43 ( V_10 ) ;
V_115:
...
static int F_70 ( struct V_136 * V_148 )
{
struct V_9 * V_10 = F_52 ( V_151 , V_148 -> V_2 ) ;
if ( ! V_10 )
return - V_67 ;
...
F_32 ( V_10 -> V_70 ) ;
F_32 ( V_10 ) ;
F_52 ( V_151 , V_148 -> V_2 ) = NULL ;
return 0 ;
}
static void F_72 ( void * V_168 )
{
int * V_169 = V_168 ;
struct V_9 * V_10 = F_73 ( V_151 ) ;
* V_169 = F_8 ( V_10 ) ;
}
static unsigned int F_74 ( unsigned int V_2 )
{
struct V_9 * V_10 = F_52 ( V_151 , V_2 ) ;
unsigned int V_170 = 0 ;
int V_169 ;
if ( ! V_10 )
return 0 ;
F_63 ( V_2 , F_72 , & V_169 , true ) ;
if ( V_169 )
goto V_171;
V_170 = F_4 ( V_10 -> V_14 ) ;
V_171:
...
{
const char * V_172 , * V_173 = L_109 ;
V_172 = F_76 () ;
if ( ! V_172 )
goto V_174;
if ( strncmp ( V_172 , V_173 , F_77 ( V_175 , strlen ( V_172 ) , strlen ( V_173 ) ) ) )
F_78 ( V_158 L_110 , V_172 ) ;
return;
V_174:
F_78 ( V_158 L_111 ) ;
F_79 ( V_173 ) ;
...
if ( V_155 )
return V_155 ;
F_53 ( V_158 L_112 V_180 L_113 ,
F_87 () , V_181 . V_182 , V_176 ) ;
return V_155 ;
}
