...
static void
F_153 ( struct V_231 * V_232 , struct V_4 * V_4 ,
struct V_207 * V_208 )
{
int V_61 ;
...
F_149 ( & V_232 -> V_233 [ V_61 ] . V_229 ) ;
F_150 ( & V_232 -> V_233 [ V_61 ] . V_229 , & V_232 -> V_228 ) ;
}
...
F_150 ( & V_232 -> V_235 [ V_61 ] . V_229 ,
& V_232 -> V_238 ) ;
}
V_232 -> V_4 = V_4 ;
}
static void
F_154 ( struct V_231 * V_232 )
{
struct V_230 * V_229 ;
int V_61 ;
V_61 = 0 ;
...
V_53 -> V_240 = F_38 ( V_241 ) ;
V_53 -> V_58 = F_156 ( V_4 -> V_119 . V_242 ) ;
V_53 -> V_59 = F_156 ( V_4 -> V_243 . V_242 ) ;
V_53 -> V_244 . V_245 . V_246 = V_4 -> V_68 . V_247 . V_248 ;
V_53 -> V_244 . V_245 . V_249 = V_4 -> V_68 . V_247 . V_250 ;
F_40 ( & V_4 -> V_54 . V_251 , NULL , NULL ,
sizeof( struct V_52 ) , & V_53 -> V_121 ) ;
F_41 ( & V_4 -> V_126 , & V_4 -> V_54 . V_251 ) ;
}
void
...
V_208 [ V_219 ] . V_215 . V_216 . V_257 = F_158 (
( F_134 () +
F_137 () +
F_141 () ) , V_258 ) ;
...
F_165 ( & V_4 -> V_243 , V_4 , V_208 ) ;
F_147 ( & V_4 -> V_224 , V_4 , V_208 ) ;
F_153 ( & V_4 -> V_232 , V_4 , V_208 ) ;
V_4 -> V_273 = V_274 ;
V_4 -> V_275 = V_274 ;
V_4 -> V_276 |= V_277 ;
}
...
struct V_226 *
F_172 ( struct V_223 * V_224 )
{
struct V_230 * V_229 ;
if ( F_173 ( & V_224 -> V_228 ) )
return NULL ;
F_174 ( & V_224 -> V_228 , & V_229 ) ;
return (struct V_226 * ) V_229 ;
}
void
F_175 ( struct V_223 * V_224 , struct V_226 * V_62 )
{
F_150 ( & V_62 -> V_229 , & V_224 -> V_228 ) ;
}
struct V_226 *
F_176 ( struct V_231 * V_232 )
{
struct V_230 * V_229 ;
if ( F_173 ( & V_232 -> V_228 ) )
return NULL ;
F_174 ( & V_232 -> V_228 , & V_229 ) ;
return (struct V_226 * ) V_229 ;
}
void
F_177 ( struct V_231 * V_232 , struct V_226 * V_62 )
{
F_150 ( & V_62 -> V_229 , & V_232 -> V_228 ) ;
}
struct V_236 *
F_178 ( struct V_231 * V_232 )
{
struct V_230 * V_229 ;
if ( F_173 ( & V_232 -> V_238 ) )
return NULL ;
F_174 ( & V_232 -> V_238 , & V_229 ) ;
return (struct V_236 * ) V_229 ;
}
void
F_179 ( struct V_231 * V_232 ,
struct V_236 * V_278 )
{
F_150 ( & V_278 -> V_229 , & V_232 -> V_238 ) ;
}
void
F_180 ( struct V_4 * V_4 )
{
if ( ! V_4 -> V_54 . V_279 ) {
