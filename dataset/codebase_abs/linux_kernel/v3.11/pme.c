...
static int F_40 ( struct V_37 * V_27 )
{
struct V_3 * V_18 ;
struct V_25 * V_26 ;
int V_10 ;
V_26 = F_41 ( sizeof( * V_26 ) , V_44 ) ;
if ( ! V_26 )
return - V_45 ;
F_42 ( & V_26 -> V_29 ) ;
F_43 ( & V_26 -> V_24 , F_23 ) ;
...
F_2 ( V_18 , false ) ;
F_27 ( V_18 ) ;
V_10 = F_45 ( V_27 -> V_34 , F_30 , V_46 , L_6 , V_27 ) ;
if ( V_10 ) {
F_46 ( V_26 ) ;
} else {
F_38 ( V_18 ) ;
...
static int F_47 ( struct V_37 * V_27 )
{
...
static void F_50 ( struct V_37 * V_27 )
{
F_47 ( V_27 ) ;
F_51 ( V_27 -> V_34 , V_27 ) ;
F_46 ( F_31 ( V_27 ) ) ;
