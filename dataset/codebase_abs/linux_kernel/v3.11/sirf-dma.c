...
bool F_50 ( struct V_2 * V_4 , void * V_8 )
{
...
{
struct V_119 * V_120 = V_118 -> V_79 . V_121 ;
struct V_114 * V_79 = & V_118 -> V_79 ;
struct V_122 * V_50 ;
struct V_5 * V_9 ;
struct V_1 * V_6 ;
struct V_123 V_124 ;
...
if ( F_54 ( V_120 , L_5 ) )
V_9 -> V_64 = true ;
if ( F_55 ( V_120 , L_6 , & V_127 ) ) {
F_53 ( V_79 , L_7 ) ;
return - V_128 ;
}
V_9 -> V_35 = F_56 ( V_120 , 0 ) ;
if ( V_9 -> V_35 == V_129 ) {
F_53 ( V_79 , L_8 ) ;
return - V_62 ;
}
V_9 -> V_130 = F_57 ( V_79 , NULL ) ;
if ( F_58 ( V_9 -> V_130 ) ) {
F_53 ( V_79 , L_9 ) ;
return F_59 ( V_9 -> V_130 ) ;
}
V_88 = F_60 ( V_120 , 0 , & V_124 ) ;
if ( V_88 ) {
F_53 ( V_79 , L_10 ) ;
goto V_131;
}
V_125 = V_124 . V_132 ;
V_126 = F_61 ( & V_124 ) ;
V_9 -> V_17 = F_62 ( V_79 , V_125 , V_126 ) ;
if ( ! V_9 -> V_17 ) {
F_53 ( V_79 , L_11 ) ;
V_88 = - V_82 ;
goto V_131;
}
V_88 = F_63 ( V_9 -> V_35 , & F_10 , 0 , V_133 , V_9 ) ;
if ( V_88 ) {
F_53 ( V_79 , L_12 ) ;
V_88 = - V_62 ;
goto V_131;
...
V_50 -> V_140 = F_49 ;
F_64 ( & V_50 -> V_7 ) ;
F_65 ( V_141 , V_50 -> V_142 ) ;
F_65 ( V_143 , V_50 -> V_142 ) ;
F_65 ( V_144 , V_50 -> V_142 ) ;
F_65 ( V_145 , V_50 -> V_142 ) ;
...
F_64 ( & V_6 -> V_41 ) ;
F_67 ( & V_6 -> V_40 ) ;
F_36 ( & V_6 -> V_4 . V_119 , & V_50 -> V_7 ) ;
}
F_68 ( & V_9 -> V_42 , F_24 , ( unsigned long ) V_9 ) ;
F_69 ( V_9 -> V_130 ) ;
F_70 ( V_79 , V_9 ) ;
V_88 = F_71 ( V_50 ) ;
if ( V_88 )
