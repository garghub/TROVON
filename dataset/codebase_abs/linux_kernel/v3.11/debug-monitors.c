...
static int F_33 ( unsigned long V_29 , unsigned int V_30 ,
struct V_24 * V_25 )
{
T_4 V_31 ;
if ( ! F_28 ( V_25 ) )
...
unsigned int V_42 ;
bool V_43 = false ;
void V_38 * V_44 = ( void V_38 * ) F_29 ( V_25 ) ;
if ( ! F_35 ( V_25 ) )
return - V_40 ;
if ( F_36 ( V_25 ) ) {
F_37 ( V_42 , ( V_45 V_38 * ) V_44 ) ;
if ( V_42 == V_46 ) {
F_37 ( V_42 , ( V_45 V_38 * ) ( V_44 + 2 ) ) ;
V_43 = V_42 == V_47 ;
} else {
V_43 = V_42 == V_48 ;
}
} else {
F_37 ( V_42 , ( T_2 V_38 * ) V_44 ) ;
V_43 = ( V_42 & ~ 0xf0000000 ) == V_49 ;
}
if ( ! V_43 )
return - V_40 ;
V_31 = ( T_4 ) {
