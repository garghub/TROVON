...
static int
F_112 ( struct V_110 * V_34 , struct V_140 * V_70 )
{
...
V_70 -> V_189 . V_5 = NULL ;
V_70 -> V_189 . V_149 = 0 ;
V_70 -> V_189 . V_6 = V_70 -> V_71 << V_72 ;
V_70 -> V_189 . V_57 = 0 ;
V_70 -> V_189 . V_105 = false ;
if ( ! ( V_120 -> V_8 & V_122 ) )
return - V_61 ;
switch ( V_70 -> V_95 ) {
case V_121 :
...
#if V_114
if ( V_10 -> V_115 . V_116 == V_117 ) {
V_70 -> V_189 . V_149 = V_70 -> V_162 << V_72 ;
V_70 -> V_189 . V_57 = V_10 -> V_115 . V_57 ;
V_70 -> V_189 . V_105 = ! V_2 -> V_115 -> V_190 ;
}
#endif
break;
case V_96 :
V_70 -> V_189 . V_149 = V_70 -> V_162 << V_72 ;
V_70 -> V_189 . V_57 = F_113 ( V_2 -> V_191 , 1 ) ;
V_70 -> V_189 . V_105 = true ;
if ( F_17 ( V_10 -> V_15 ) -> V_41 >= V_42 ) {
struct V_192 * V_193 = V_192 ( V_10 -> V_15 ) ;
struct V_145 * V_146 = V_70 -> V_147 ;
V_52 = V_193 -> V_194 ( V_193 , V_146 , V_167 ,
& V_146 -> V_195 ) ;
if ( V_52 )
return V_52 ;
V_70 -> V_189 . V_149 = V_146 -> V_195 . V_149 ;
}
break;
default:
return - V_61 ;
...
static void
F_114 ( struct V_110 * V_34 , struct V_140 * V_70 )
{
struct V_9 * V_10 = F_11 ( V_34 ) ;
struct V_192 * V_193 = V_192 ( V_10 -> V_15 ) ;
struct V_145 * V_146 = V_70 -> V_147 ;
if ( ! V_146 -> V_195 . V_146 )
return;
V_193 -> V_196 ( V_193 , & V_146 -> V_195 ) ;
}
static int
...
struct V_35 * V_36 = V_35 ( V_33 ) ;
struct V_40 * V_15 = F_17 ( V_10 -> V_15 ) ;
T_1 V_197 = F_116 ( V_15 -> V_191 , 1 ) >> V_72 ;
if ( V_33 -> V_70 . V_95 != V_96 ) {
if ( F_17 ( V_10 -> V_15 ) -> V_41 < V_42 ||
! F_78 ( V_36 ) )
return 0 ;
}
if ( V_33 -> V_70 . V_162 + V_33 -> V_70 . V_71 < V_197 )
return 0 ;
V_36 -> V_73 . V_82 = 0 ;
V_36 -> V_73 . V_83 = V_197 ;
F_24 ( V_36 , V_76 , 0 ) ;
return F_32 ( V_36 , false , false ) ;
}
static int
F_117 ( struct V_109 * V_68 )
{
struct V_198 * V_199 = ( void * ) V_68 ;
struct V_9 * V_10 ;
struct V_1 * V_2 ;
unsigned V_11 ;
int V_200 ;
bool V_201 = ! ! ( V_68 -> V_111 & V_202 ) ;
if ( V_68 -> V_203 != V_204 )
return 0 ;
if ( V_201 && V_68 -> V_49 ) {
F_118 ( V_68 -> V_49 , V_68 -> V_205 ,
V_199 -> V_206 , V_68 -> V_71 ) ;
V_68 -> V_203 = V_207 ;
return 0 ;
}
V_10 = F_11 ( V_68 -> V_34 ) ;
...
#ifdef F_120
if ( F_121 () ) {
return F_122 ( ( void * ) V_68 , V_2 -> V_2 ) ;
}
#endif
V_200 = F_123 ( V_68 ) ;
if ( V_200 ) {
...
V_199 -> V_206 [ V_11 ] = F_124 ( V_2 -> V_191 , V_68 -> V_205 [ V_11 ] ,
0 , V_46 ,
V_208 ) ;
if ( F_125 ( V_2 -> V_191 , V_199 -> V_206 [ V_11 ] ) ) {
while ( -- V_11 ) {
F_126 ( V_2 -> V_191 , V_199 -> V_206 [ V_11 ] ,
V_46 , V_208 ) ;
V_199 -> V_206 [ V_11 ] = 0 ;
}
F_127 ( V_68 ) ;
...
void
F_131 ( struct V_35 * V_36 , struct V_29 * V_20 )
{
struct V_29 * V_210 = NULL ;
if ( F_132 ( V_20 ) )
F_8 ( V_20 ) ;
F_4 ( & V_36 -> V_33 . V_34 -> V_211 ) ;
V_210 = V_36 -> V_33 . V_186 ;
V_36 -> V_33 . V_186 = V_20 ;
F_6 ( & V_36 -> V_33 . V_34 -> V_211 ) ;
F_2 ( & V_210 ) ;
}
static void
F_133 ( void * * V_186 )
...
static int
F_136 ( void * V_186 , bool V_212 , bool V_168 )
{
return F_137 ( V_186 , V_212 , V_168 ) ;
}
static int
F_138 ( void * V_186 )
{
...
struct V_165 *
F_139 ( struct V_35 * V_36 , struct V_213 * V_58 )
{
struct V_165 * V_148 ;
F_103 (vma, &nvbo->vma_list, head) {
if ( V_148 -> V_58 == V_58 )
...
int
F_140 ( struct V_35 * V_36 , struct V_213 * V_58 ,
struct V_165 * V_148 )
{
...
F_141 ( & V_148 -> V_65 , & V_36 -> V_67 ) ;
V_148 -> V_214 = 1 ;
return 0 ;
}
void
F_142 ( struct V_35 * V_36 , struct V_165 * V_148 )
{
if ( V_148 -> V_146 ) {
