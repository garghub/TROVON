...
F_13 ( V_2 -> V_26 ) ;
if ( F_18 ( F_19 ( V_2 ) ) )
return F_31 ( F_34 ( V_2 ) ? - V_30 : - V_42 ) ;
V_8 = F_10 ( V_13 , V_2 , true ) ;
if ( V_8 )
return V_8 ;
while ( true ) {
struct V_13 * V_43 = V_13 ;
struct V_13 * V_35 = F_22 ( V_13 ) ;
while ( V_35 && ! F_10 ( V_35 , V_2 , false ) ) {
V_43 = V_35 ;
V_35 = F_22 ( V_35 ) ;
}
V_8 = F_20 ( V_43 , V_2 , NULL ) ;
if ( V_43 == V_13 || F_35 ( V_8 ) )
return V_8 ;
}
}
...
V_80 = F_66 ( ( void * ) V_11 + V_77 ) ;
F_59 () ;
F_70 (pos_blkg, pos_cgrp, pd_to_blkg(pd)) {
...
static void F_81 ( struct V_54 * V_54 )
{
struct V_13 * V_13 = F_51 ( V_54 ) ;
F_47 ( & V_13 -> V_37 ) ;
...
static void F_86 ( struct V_54 * V_54 )
{
struct V_13 * V_13 = F_51 ( V_54 ) ;
if ( V_13 != & V_18 )
F_4 ( V_13 ) ;
}
static struct V_95 * F_87 ( struct V_54 * V_54 )
{
static T_4 V_96 = F_88 ( 0 ) ;
struct V_13 * V_13 ;
struct V_54 * V_35 = V_54 -> V_35 ;
if ( ! V_35 ) {
V_13 = & V_18 ;
goto V_97;
}
...
static int F_101 ( struct V_54 * V_102 , struct V_103 * V_104 )
{
struct V_105 * V_106 ;
struct V_107 * V_108 ;
int V_28 = 0 ;
F_102 (task, cgrp, tset) {
F_103 ( V_106 ) ;
V_108 = V_106 -> V_107 ;
if ( V_108 && F_104 ( & V_108 -> V_109 ) > 1 )
V_28 = - V_30 ;
F_105 ( V_106 ) ;
if ( V_28 )
break;
...
V_11 = F_114 ( & V_110 , struct V_20 , V_114 ) ;
F_40 ( & V_11 -> V_114 ) ;
F_24 ( & V_8 -> V_13 -> V_37 ) ;
