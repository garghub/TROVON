...
static int F_29 ( struct V_12 * V_24 ,
struct V_7 * V_1 )
{
struct V_43 * V_44 =
...
if ( V_1 -> V_46 [ V_14 ] . V_36 == V_47 )
F_21 ( V_24 ) ;
if ( F_30 ( V_1 -> V_46 [ V_14 ] . V_36 ) ) {
V_1 -> V_46 [ V_14 ] . V_36 = V_48 ;
F_31 ( V_1 -> V_49 , V_1 ,
V_1 -> V_46 [ V_14 ] . V_50 , 0 ) ;
++ V_45 ;
} else
break;
}
...
if ( V_8 )
F_29 ( V_24 , V_1 ) ;
V_62 = F_37 ( & V_24 -> V_49 , V_1 , V_1 -> V_70 ,
F_38 ( V_1 -> V_70 ) ,
& V_59 , & V_60 ,
NULL , NULL ) ;
if ( F_24 ( V_62 < 0 ) )
...
if ( V_62 == V_1 -> V_79 ) {
int V_80 ;
V_80 = F_39 ( V_44 -> V_21 >= V_44 -> V_20 ) ?
( V_44 -> V_21 - V_44 -> V_20 ) :
( V_44 -> V_21 + V_18 -
V_44 -> V_20 ) ;
if ( F_24 ( V_80 > V_81 ) )
break;
if ( F_24 ( F_40 ( & V_24 -> V_49 , V_1 ) ) ) {
F_36 ( & V_24 -> V_49 , V_1 ) ;
continue;
}
break;
...
V_61 = F_26 ( V_1 -> V_70 , V_44 -> V_82 , V_74 , V_59 ) ;
V_64 . V_83 = V_59 ;
V_36 = F_42 ( V_1 -> V_70 , V_59 ) ;
if ( ! V_36 ) {
F_41 ( V_1 , L_3
L_4 ,
F_42 ( V_44 -> V_82 , V_61 ) , V_74 ) ;
break;
}
V_76 = V_8 && ( V_36 >= V_84 ||
V_44 -> V_21 != V_44 -> V_20 ) ;
if ( V_76 ) {
V_1 -> V_46 [ V_44 -> V_21 ] . V_50 = V_62 ;
if ( ! F_22 ( V_24 ) ||
V_36 < V_84 ) {
V_1 -> V_46 [ V_44 -> V_21 ] . V_36 =
V_57 ;
V_64 . V_67 = NULL ;
V_64 . V_68 = 0 ;
V_5 = NULL ;
...
static int F_52 ( struct V_7 * V_1 ,
struct V_95 * V_46 ,
int V_96 ,
unsigned * V_42 ,
struct V_97 * log ,
...
V_101 = F_37 ( V_1 -> V_49 , V_1 , V_1 -> V_70 + V_38 ,
...
V_46 [ V_100 ] . V_50 = V_101 ;
V_46 [ V_100 ] . V_36 = F_42 ( V_1 -> V_70 + V_38 , V_60 ) ;
V_96 -= V_46 [ V_100 ] . V_36 ;
++ V_100 ;
V_38 += V_60 ;
}
V_46 [ V_100 - 1 ] . V_36 += V_96 ;
* V_42 = V_38 ;
if ( F_24 ( log ) )
* V_98 = V_103 ;
return V_100 ;
...
V_22 = V_44 -> V_22 ;
V_23 = V_44 -> V_23 ;
V_107 = F_24 ( F_54 ( & V_24 -> V_49 , V_114 ) ) ?
V_1 -> log : NULL ;
V_111 = F_54 ( & V_24 -> V_49 , V_115 ) ;
while ( ( V_113 = F_47 ( V_29 -> V_31 ) ) ) {
V_113 += V_23 ;
V_112 = V_113 + V_22 ;
V_100 = F_52 ( V_1 , V_1 -> V_46 , V_112 ,
& V_60 , V_107 , & log ,
F_39 ( V_111 ) ? V_18 : 1 ) ;
if ( F_24 ( V_100 < 0 ) )
break;
...
if ( F_24 ( ( V_22 ) ) )
F_26 ( V_1 -> V_70 , V_44 -> V_82 , V_22 , V_60 ) ;
else
F_28 ( V_1 -> V_70 , V_44 -> V_82 , V_23 , V_60 ) ;
V_64 . V_83 = V_60 ;
...
if ( F_24 ( V_22 ) &&
F_55 ( V_44 -> V_82 , ( unsigned char * ) & V_82 , 0 ,
V_22 ) ) {
F_41 ( V_1 , L_11 ,
V_1 -> V_70 -> V_41 ) ;
break;
...
if ( F_39 ( V_111 ) &&
F_55 ( V_44 -> V_82 , ( unsigned char * ) & V_100 ,
F_56 ( F_57 ( V_82 ) , V_118 ) ,
sizeof V_82 . V_118 ) ) {
F_41 ( V_1 , L_12 ) ;
F_44 ( V_1 , V_100 ) ;
break;
}
F_58 ( & V_24 -> V_49 , V_1 , V_1 -> V_46 ,
V_100 ) ;
if ( F_24 ( V_107 ) )
...
V_55 . V_120 ) ;
struct V_12 * V_24 = F_3 ( V_1 -> V_49 , struct V_12 , V_49 ) ;
F_34 ( V_24 ) ;
}
...
V_102 = F_65 ( V_49 , V_16 , V_15 ) ;
if ( V_102 < 0 ) {
F_16 ( V_13 ) ;
F_16 ( V_16 ) ;
return V_102 ;
}
F_66 ( V_13 -> V_55 + V_58 , F_62 , V_126 , V_49 ) ;
F_66 ( V_13 -> V_55 + V_106 , F_63 , V_127 , V_49 ) ;
V_123 -> V_78 = V_13 ;
return 0 ;
}
...
struct V_43 * V_44 =
F_3 ( V_1 , struct V_43 , V_1 ) ;
struct V_128 * V_55 = V_13 -> V_55 + ( V_44 - V_13 -> V_16 ) ;
if ( ! V_1 -> V_78 )
return;
F_68 ( V_55 ) ;
}
...
{
F_74 ( V_13 -> V_55 + V_131 ) ;
F_74 ( & V_13 -> V_16 [ V_131 ] . V_1 . V_55 ) ;
}
...
default:
F_35 ( & V_13 -> V_49 . V_77 ) ;
V_102 = F_105 ( & V_13 -> V_49 , V_164 , V_166 ) ;
if ( V_102 == - V_177 )
V_102 = F_106 ( & V_13 -> V_49 , V_164 , V_166 ) ;
else
F_75 ( V_13 ) ;
F_46 ( & V_13 -> V_49 . V_77 ) ;
return V_102 ;
