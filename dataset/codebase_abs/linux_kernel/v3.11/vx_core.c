...
int F_22 ( struct V_1 * V_2 , const struct V_61 * V_62 )
{
unsigned int V_31 ;
int V_63 = F_6 ( V_2 ) ;
if ( V_62 -> V_33 <= 0 )
...
static void F_30 ( unsigned long V_71 )
{
...
static void F_36 ( struct V_1 * V_2 , int V_82 )
{
if ( F_15 ( ! V_2 -> V_83 -> V_84 ) )
return;
V_2 -> V_85 = V_86 ;
if ( V_82 ) {
V_2 -> V_87 = V_2 -> V_85 ;
...
static void F_42 ( struct V_97 * V_98 , struct V_99 * V_100 )
{
...
F_43 ( V_100 , L_51 , V_2 -> V_105 -> V_106 ) ;
F_43 ( V_100 , L_52 ,
...
F_43 ( V_100 , L_64 ) ;
F_43 ( V_100 , L_65 ) ;
F_43 ( V_100 , L_66 , F_39 ( V_2 ) ?
V_101 [ V_2 -> V_85 ] :
V_102 [ V_2 -> V_85 ] ) ;
F_43 ( V_100 , L_67 , V_90 [ V_2 -> V_90 ] ) ;
F_43 ( V_100 , L_68 , V_103 [ V_2 -> V_88 ] ) ;
F_43 ( V_100 , L_69 , V_2 -> V_92 ) ;
F_43 ( V_100 , L_70 , V_2 -> V_117 ) ;
F_43 ( V_100 , L_71 , V_104 [ V_2 -> V_93 ] ) ;
F_43 ( V_100 , L_72 ,
...
{
struct V_97 * V_98 ;
if ( ! F_45 ( V_2 -> V_105 , L_73 , & V_98 ) )
F_46 ( V_98 , V_2 , F_42 ) ;
}
int F_47 ( struct V_1 * V_2 , const struct V_61 * V_62 )
{
int V_22 ;
int V_82 = ! ( V_2 -> V_44 & V_108 ) ;
F_36 ( V_2 , V_82 ) ;
F_40 ( V_2 , 0 ) ;
if ( ( V_22 = F_22 ( V_2 , V_62 ) ) < 0 )
return V_22 ;
F_48 ( 10 ) ;
return 0 ;
}
int F_49 ( struct V_1 * V_2 , const struct V_61 * V_122 )
{
unsigned int V_31 ;
int V_22 ;
...
V_2 -> V_44 |= V_78 ;
V_2 -> V_44 &= ~ V_126 ;
F_54 ( V_2 -> V_105 , V_131 ) ;
return 0 ;
}
struct V_1 * F_57 ( struct V_132 * V_105 , struct V_133 * V_127 ,
struct V_134 * V_83 ,
int V_135 )
{
struct V_1 * V_2 ;
if ( F_15 ( ! V_105 || ! V_127 || ! V_83 ) )
return NULL ;
V_2 = F_58 ( sizeof( * V_2 ) + V_135 , V_136 ) ;
if ( ! V_2 ) {
F_25 ( V_65 L_77 ) ;
return NULL ;
}
...
V_2 -> type = V_127 -> type ;
V_2 -> V_83 = V_83 ;
F_60 ( & V_2 -> V_80 , F_30 , ( unsigned long ) V_2 ) ;
F_61 ( & V_2 -> V_138 ) ;
V_2 -> V_105 = V_105 ;
V_105 -> V_71 = V_2 ;
