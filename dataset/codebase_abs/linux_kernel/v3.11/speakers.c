...
static int F_68 ( struct V_132 * V_61 ,
const struct V_137 * V_138 )
{
struct V_139 * V_140 = F_69 ( V_61 ) ;
struct V_136 * V_92 ;
struct V_49 * V_49 ;
T_4 V_141 ;
int V_21 ;
V_21 = F_70 ( - 1 , NULL , V_142 , sizeof( * V_49 ) , & V_92 ) ;
if ( V_21 < 0 )
return V_21 ;
F_71 ( V_92 , & V_61 -> V_62 ) ;
V_49 = V_92 -> V_50 ;
...
F_72 ( & V_49 -> V_65 ) ;
V_49 -> V_61 = F_73 ( V_61 ) ;
V_49 -> V_51 = ( const struct V_51 * ) V_138 -> V_143 ;
V_21 = F_74 ( & V_49 -> V_56 , V_61 , 0 ) ;
if ( V_21 < 0 )
goto V_144;
V_21 = F_75 ( & V_49 -> V_55 , V_61 , V_145 ) ;
if ( V_21 < 0 )
goto V_71;
V_92 -> V_146 = F_63 ;
strcpy ( V_92 -> V_147 , V_49 -> V_51 -> V_148 ) ;
strcpy ( V_92 -> V_149 , V_49 -> V_51 -> V_94 ) ;
V_141 = F_60 ( V_61 ) ;
snprintf ( V_92 -> V_150 , sizeof( V_92 -> V_150 ) ,
L_8 ,
V_49 -> V_51 -> V_151 ,
V_141 >> 20 , V_141 & 0xffff ,
V_140 -> V_152 [ 3 ] , V_140 -> V_152 [ 4 ] ,
F_76 ( & V_61 -> V_62 ) , 100 << V_140 -> V_153 ) ;
strcpy ( V_92 -> V_154 , L_2 ) ;
V_21 = F_47 ( V_49 ) ;
if ( V_21 < 0 )
goto error;
V_21 = F_56 ( V_49 ) ;
...
static void F_80 ( struct V_132 * V_61 )
{
struct V_49 * V_49 = F_81 ( & V_61 -> V_62 ) ;
F_82 ( V_49 -> V_61 ) ;
if ( F_83 ( & V_49 -> V_56 ) < 0 ) {
F_84 ( & V_49 -> V_55 ) ;
F_25 ( & V_49 -> V_65 ) ;
...
static void F_86 ( struct V_132 * V_61 )
{
struct V_49 * V_49 = F_81 ( & V_61 -> V_62 ) ;
F_84 ( & V_49 -> V_55 ) ;
F_87 ( V_49 -> V_92 ) ;
