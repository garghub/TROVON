...
V_101 -> V_140 = F_64 ( 8 ) | F_64 ( 16 ) ;
V_101 -> V_141 = V_128 -> V_142 ;
V_101 -> V_143 = V_131 -> V_143 ;
V_101 -> V_144 = F_48 ;
V_101 -> V_145 = F_43 ;
V_101 -> V_69 = F_40 ;
V_134 = F_65 ( V_128 , V_146 , 0 ) ;
if ( V_134 == NULL ) {
F_31 ( V_31 , L_25 ) ;
V_60 = - V_147 ;
goto V_148;
}
V_2 -> V_3 = F_66 ( V_134 -> V_149 , F_67 ( V_134 ) ) ;
if ( V_2 -> V_3 == NULL ) {
F_31 ( V_31 , L_26 ) ;
V_60 = - V_150 ;
goto V_151;
}
V_135 = F_65 ( V_128 , V_152 , 0 ) ;
if ( ! V_135 ) {
F_31 ( V_31 , L_27 ) ;
V_60 = - V_153 ;
goto V_154;
}
V_2 -> V_155 = V_135 -> V_149 ;
V_60 = F_50 ( V_2 ) ;
if ( V_60 ) {
F_31 ( V_31 , L_28 ) ;
goto V_156;
...
V_60 = F_68 ( V_2 -> V_155 , F_30 ,
0 , L_30 , V_2 ) ;
if ( V_60 ) {
F_31 ( V_31 , L_31 ) ;
goto V_157;
}
V_60 = F_69 ( V_2 -> V_137 , V_158 ) ;
if ( V_60 ) {
F_31 ( V_31 , L_32 ) ;
goto V_159;
}
...
static int F_77 ( struct V_127 * V_128 )
{
struct V_1 * V_2 = F_78 ( V_128 ) ;
int V_60 = 0 ;
if ( ! V_2 )
return 0 ;
V_60 = F_60 ( V_2 ) ;
...
static int
F_80 ( struct V_127 * V_128 , T_6 V_51 )
{
struct V_1 * V_2 = F_78 ( V_128 ) ;
int V_60 ;
V_60 = F_58 ( V_2 ) ;
