...
int V_99 ;
F_55 ( V_100 ) ;
F_31 ( V_101 L_23 , F_56 () ) ;
while ( V_62 == V_98 && ! F_57 ( & V_94 -> V_102 ) &&
! F_57 ( & V_94 -> error ) )
V_62 = F_17 ( V_94 -> V_8 , 0 , 1 , NULL ) ;
if ( V_62 || F_57 ( & V_94 -> error ) ) {
F_31 ( V_101 L_24 , V_62 ) ;
F_55 ( V_96 ) ;
}
if ( F_57 ( & V_94 -> error ) )
V_62 = F_57 ( & V_94 -> error ) ;
F_58 ( & V_94 -> error , V_62 ) ;
F_59 () ;
if ( V_95 ) {
F_58 ( & V_94 -> V_102 , 1 ) ;
F_60 (cpu)
F_61 ( V_103 , F_62 ( V_99 ) ) ;
}
if ( F_63 ( & V_94 -> V_104 ) == 0 )
F_64 ( V_94 -> F_64 ) ;
return V_62 ;
}
int F_65 ( struct V_93 * V_94 )
{
F_66 ( & V_94 -> V_104 ) ;
return F_54 ( V_94 , 0 ) ;
}
static int F_67 ( struct V_93 * V_94 , int V_95 )
{
long V_62 = V_105 ;
unsigned long V_106 ;
int V_99 ;
...
V_106 = F_68 () ;
F_69 ( V_106 & ~ ( V_107 ) ) ;
while ( V_62 == V_105 && ! F_57 ( & V_94 -> V_102 ) && ! F_57 ( & V_94 -> error ) )
V_62 = F_61 ( V_108 ) ;
F_69 ( V_106 ) ;
if ( V_62 == V_105 ) {
goto V_109;
...
static void F_71 ( void * V_111 )
{
F_67 ( (struct V_93 * ) V_111 , 1 ) ;
}
static int F_72 ( enum V_112 V_77 ,
T_5 V_113 )
{
if ( ! F_73 ( V_113 ) ) {
F_74 ( V_113 ) ;
...
V_54 = V_114 ;
if ( V_77 == V_116 ) {
F_79 ( V_113 , V_113 , V_99 ) ;
F_80 ( V_113 , V_113 , V_99 ) ;
break;
} else {
F_81 ( V_99 , V_113 ) ;
}
...
int F_85 ( T_5 V_113 )
{
return F_72 ( V_115 , V_113 ) ;
}
int F_87 ( struct V_5 * args )
{
long V_77 ;
long V_62 ;
...
V_94 . V_8 = F_26 ( L_29 ) ;
V_94 . F_64 = & V_102 ;
F_90 ( V_121 , V_129 , V_130 ) ;
V_114 = F_82 ( V_121 ) ;
if ( V_114 ) {
F_91 ( L_32 , V_69 ) ;
F_58 ( & V_94 . error , V_114 ) ;
goto V_109;
}
F_92 () ;
if ( F_93 ( F_71 , & V_94 , 0 ) )
F_58 ( & V_94 . error , - V_64 ) ;
F_94 ( & V_102 ) ;
if ( F_57 ( & V_94 . error ) != 0 )
F_31 ( V_68 L_33 ) ;
F_95 () ;
V_114 = F_85 ( V_121 ) ;
if ( V_114 )
...
V_109:
F_86 ( V_121 ) ;
return F_57 ( & V_94 . error ) ;
}
int F_87 ( struct V_5 * args )
{
return - V_122 ;
}
struct V_131 * F_97 ( struct V_132 * log ,
T_6 V_133 )
{
struct V_134 * V_135 =
(struct V_134 * ) log -> V_136 ;
struct V_131 * V_137 ;
unsigned char * V_24 , * V_138 ;
if ( log -> V_139 < sizeof( struct V_134 ) ||
V_135 -> V_140 != V_141 ||
V_135 -> V_142 != V_143 )
return NULL ;
V_138 = log -> V_136 + log -> V_139 ;
V_24 = V_135 -> V_144 ;
while ( V_24 < V_138 ) {
V_137 = (struct V_131 * ) V_24 ;
if ( V_137 -> V_145 == V_133 )
return V_137 ;
V_24 += V_137 -> V_146 ;
}
return NULL ;
}
T_7 int F_98 ( struct V_5 T_8 * V_147 )
{
struct V_5 args ;
unsigned long V_1 ;
char * V_53 , * V_148 = NULL ;
int V_9 ;
int V_62 ;
if ( ! F_99 ( V_149 ) )
return - V_150 ;
if ( F_100 ( & args , V_147 , 3 * sizeof( T_2 ) ) != 0 )
return - V_65 ;
V_9 = args . V_9 ;
if ( V_9 > F_101 ( args . args )
|| args . V_10 > F_101 ( args . args )
|| V_9 + args . V_10 > F_101 ( args . args ) )
return - V_64 ;
if ( F_100 ( args . args , V_147 -> args ,
V_9 * sizeof( V_12 ) ) != 0 )
return - V_65 ;
if ( args . V_8 == V_34 )
return - V_64 ;
...
V_2 . V_37 = F_105 ( NULL , L_35 ) ;
if ( V_2 . V_37 ) {
const T_2 * V_155 , * V_156 , * V_157 ;
V_155 = F_24 ( V_2 . V_37 , L_36 , NULL ) ;
V_157 = F_24 ( V_2 . V_37 , L_37 , NULL ) ;
if ( V_155 != NULL && V_157 != NULL ) {
V_2 . V_7 = * V_155 ;
V_2 . V_158 = * V_157 ;
V_156 = F_24 ( V_2 . V_37 ,
L_38 , NULL ) ;
...
return;
#ifdef F_106
if ( F_107 ( V_159 ) && F_108 ( V_160 ) ) {
V_153 = F_109 ( V_161 , V_154 ) ;
V_151 = F_26 ( L_29 ) ;
}
#endif
V_162 = F_110 ( V_163 , V_164 , V_153 ) ;
#ifdef F_111
V_46 = F_26 ( L_39 ) ;
#endif
}
int T_1 F_112 ( unsigned long V_165 ,
const char * V_166 , int V_167 , void * V_94 )
{
T_2 * V_155 , * V_156 , * V_157 ;
if ( V_167 != 1 || strcmp ( V_166 , L_35 ) != 0 )
return 0 ;
V_155 = F_113 ( V_165 , L_36 , NULL ) ;
V_156 = F_113 ( V_165 , L_38 , NULL ) ;
V_157 = F_113 ( V_165 , L_37 , NULL ) ;
...
#ifdef F_114
V_155 = F_113 ( V_165 , L_40 , NULL ) ;
if ( V_155 )
V_17 = * V_155 ;
V_155 = F_113 ( V_165 , L_41 , NULL ) ;
if ( V_155 )
V_18 = * V_155 ;
if ( V_17 != V_34 &&
V_18 != V_34 )
...
F_116 () ;
F_117 ( & V_168 ) ;
F_17 ( F_26 ( L_42 ) , 0 , 1 , NULL ) ;
V_169 = F_118 () ;
F_6 ( & V_168 ) ;
while ( V_169 )
F_119 () ;
F_17 ( F_26 ( L_43 ) , 0 , 1 , NULL ) ;
F_7 ( V_1 ) ;
}
void F_120 ( void )
{
...
F_119 () ;
F_117 ( & V_168 ) ;
F_121 ( V_169 >> 32 , V_169 & 0xffffffff ) ;
V_169 = 0 ;
F_6 ( & V_168 ) ;
}
