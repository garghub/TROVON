...
{
int V_128 ;
F_16 ( V_21 , L_64 , V_83 -> V_129 -> V_130 ) ;
...
break;
default:
F_16 ( V_21 , L_65 , V_83 -> V_129 -> V_130 ) ;
V_128 = V_131 ;
break;
}
return V_128 ;
...
( ( V_144 * ) V_89 ) [ 0 ] = F_52 ( V_76 ) ;
( ( V_144 * ) V_89 ) [ 1 ] = F_52 ( V_62 -> V_78 ) ;
F_50 ( V_89 , 8 , V_83 ) ;
return V_139 ;
}
...
( ( V_147 * ) V_89 ) [ 0 ] = F_53 ( sizeof( V_136 ) - 2 ) ;
V_89 [ 3 ] = ( V_62 -> V_103 & V_104 ) ? 0x80 : 0 ;
F_50 ( V_89 , sizeof( V_136 ) , V_83 ) ;
return V_139 ;
}
V_132 = 0x05 ;
V_133 = 0x24 ;
...
V_68 = F_41 ( V_83 -> V_137 [ 3 ] , V_83 -> V_137 [ 2 ] ) ;
V_68 <<= 16 ;
V_68 |= F_41 ( V_83 -> V_137 [ 5 ] , V_83 -> V_137 [ 4 ] ) ;
V_69 = F_41 ( V_83 -> V_137 [ 8 ] , V_83 -> V_137 [ 7 ] ) ;
F_16 ( V_21 , L_67 ,
V_68 , V_69 ) ;
...
sprintf ( V_89 + strlen ( V_89 ) , L_69 , V_83 -> V_137 [ V_8 ] ) ;
F_16 ( V_21 , L_70 , V_89 ) ;
...
static int F_57 ( struct V_156 * V_157 ,
const struct V_158 * V_7 )
{
struct V_20 * V_21 ;
int V_42 ;
V_42 = F_58 ( & V_21 , V_157 , V_7 ,
( V_7 - V_159 ) + V_160 ) ;
if ( V_42 )
return V_42 ;
if ( V_21 -> V_161 == V_162 ) {
