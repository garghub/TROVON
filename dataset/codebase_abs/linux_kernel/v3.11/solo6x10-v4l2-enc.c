...
V_205 -> V_210 . V_200 = V_2 -> V_3 -> V_20 ;
V_205 -> V_211 = 0 ;
V_205 -> V_212 = 2 ;
return 0 ;
}
static inline int F_106 ( T_3 V_20 , T_1 V_213 , T_1 V_214 )
{
if ( ! V_213 || ! V_214 )
return 1 ;
if ( V_214 == V_20 )
return V_213 ;
V_213 *= V_20 ;
return F_34 ( 15U , V_213 / V_214 + ( V_213 % V_214 >= ( V_20 >> 1 ) ) ) ;
}
static int F_107 ( struct V_145 * V_145 , void * V_146 ,
struct V_202 * V_203 )
{
struct V_1 * V_2 = F_88 ( V_145 ) ;
struct V_215 * V_216 = & V_203 -> V_206 . V_207 . V_210 ;
T_3 V_20 = V_2 -> V_3 -> V_20 ;
if ( F_108 ( & V_2 -> V_186 ) )
return - V_45 ;
V_2 -> V_21 = F_106 ( V_20 , V_216 -> V_199 , V_216 -> V_200 ) ;
F_10 ( V_2 ) ;
return F_105 ( V_145 , V_146 , V_203 ) ;
}
static long F_109 ( struct V_145 * V_145 , void * V_217 ,
bool V_218 , unsigned int V_219 , void * V_220 )
{
struct V_1 * V_2 = F_88 ( V_145 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
...
return - V_45 ;
V_2 -> V_224 = * V_222 ;
if ( V_2 -> V_226 && ! V_2 -> V_227 )
return F_110 ( V_3 , V_2 -> V_5 ,
& V_2 -> V_224 ) ;
return 0 ;
default:
return - V_228 ;
...
{
struct V_1 * V_2 =
F_74 ( V_230 -> V_231 , struct V_1 , V_232 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
int V_143 ;
switch ( V_230 -> V_233 ) {
case V_234 :
...
case V_237 :
case V_238 :
return F_112 ( V_3 , V_230 -> V_233 , V_2 -> V_5 ,
V_230 -> V_239 ) ;
case V_240 :
V_2 -> V_48 = V_230 -> V_239 ;
return 0 ;
case V_241 :
V_2 -> V_242 = V_230 -> V_239 ;
if ( ! V_2 -> V_227 || ! V_2 -> V_226 )
return 0 ;
return F_113 ( V_3 , V_2 -> V_5 , V_230 -> V_239 ) ;
case V_243 :
V_2 -> V_227 = V_230 -> V_239 == 1 ;
V_2 -> V_226 = V_230 -> V_239 > 0 ;
if ( V_230 -> V_239 ) {
if ( V_2 -> V_227 )
F_113 ( V_3 , V_2 -> V_5 ,
V_2 -> V_242 ) ;
...
static struct V_1 * F_115 ( struct V_3 * V_3 ,
T_3 V_5 , unsigned V_246 )
{
struct V_1 * V_2 ;
struct V_247 * V_232 ;
int V_8 ;
int V_248 , V_249 ;
V_2 = F_116 ( sizeof( * V_2 ) , V_250 ) ;
if ( ! V_2 )
return F_117 ( - V_251 ) ;
V_232 = & V_2 -> V_232 ;
F_118 ( V_232 , 10 ) ;
...
V_238 , 0 , 15 , 1 , 0 ) ;
F_119 ( V_232 , & V_252 ,
V_240 , 1 , 255 , 1 , V_3 -> V_20 ) ;
F_121 ( V_232 , & V_253 , NULL ) ;
F_121 ( V_232 , & V_254 , NULL ) ;
F_121 ( V_232 , & V_255 , NULL ) ;
if ( V_232 -> error ) {
V_8 = V_232 -> error ;
goto V_256;
}
...
V_2 -> V_227 = true ;
V_2 -> V_242 = V_258 ;
for ( V_249 = 0 ; V_249 < V_259 ; V_249 ++ )
for ( V_248 = 0 ; V_248 < V_259 ; V_248 ++ )
V_2 -> V_224 . V_222 [ V_249 ] [ V_248 ] =
V_258 ;
V_2 -> V_186 . type = V_260 ;
V_2 -> V_186 . V_261 = V_262 | V_263 | V_264 ;
V_2 -> V_186 . V_265 = & V_266 ;
V_2 -> V_186 . V_267 = & V_268 ;
V_2 -> V_186 . V_269 = V_2 ;
V_2 -> V_186 . V_270 = V_271 ;
V_2 -> V_186 . V_272 = V_273 ;
V_2 -> V_186 . V_274 = sizeof( struct V_108 ) ;
...
goto V_275;
* V_2 -> V_164 = V_276 ;
V_2 -> V_164 -> V_277 = & V_3 -> V_277 ;
V_2 -> V_164 -> V_278 = V_232 ;
V_2 -> V_164 -> V_279 = & V_2 -> V_186 ;
V_2 -> V_164 -> V_109 = & V_2 -> V_109 ;
F_127 ( V_280 , & V_2 -> V_164 -> V_6 ) ;
F_128 ( V_2 -> V_164 , V_2 ) ;
V_8 = F_129 ( V_2 -> V_164 , V_281 , V_246 ) ;
if ( V_8 < 0 )
goto V_282;
snprintf ( V_2 -> V_164 -> V_161 , sizeof( V_2 -> V_164 -> V_161 ) ,
L_9 , V_142 , V_3 -> V_164 -> V_283 ,
V_2 -> V_164 -> V_283 ) ;
return V_2 ;
V_282:
F_130 ( V_2 -> V_164 ) ;
...
int F_136 ( struct V_3 * V_3 , unsigned V_246 )
{
int V_61 ;
F_137 ( & V_3 -> V_114 ) ;
V_3 -> V_284 = sizeof( struct V_73 ) ;
V_3 -> V_123 = F_125 ( V_3 -> V_84 ,
V_3 -> V_284 ,
& V_3 -> V_122 ) ;
if ( V_3 -> V_123 == NULL )
return - V_251 ;
for ( V_61 = 0 ; V_61 < V_3 -> V_285 ; V_61 ++ ) {
V_3 -> V_121 [ V_61 ] = F_115 ( V_3 , V_61 , V_246 ) ;
...
while ( V_61 -- )
F_134 ( V_3 -> V_121 [ V_61 ] ) ;
F_131 ( V_3 -> V_84 , V_3 -> V_284 ,
V_3 -> V_123 , V_3 -> V_122 ) ;
V_3 -> V_123 = NULL ;
return V_8 ;
}
...
F_138 ( & V_3 -> V_84 -> V_85 , L_10 ,
V_3 -> V_121 [ 0 ] -> V_164 -> V_283 ,
V_3 -> V_121 [ V_3 -> V_285 - 1 ] -> V_164 -> V_283 ) ;
return 0 ;
}
