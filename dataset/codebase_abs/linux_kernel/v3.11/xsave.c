...
static int T_4 F_56 ( char * V_91 )
{
if ( ! strcmp ( V_91 , L_1 ) )
V_92 = V_93 ;
else if ( ! strcmp ( V_91 , L_2 ) )
V_92 = V_94 ;
else if ( ! strcmp ( V_91 , L_3 ) )
V_92 = AUTO ;
return 1 ;
}
...
void F_63 ( void )
{
static T_5 void (* F_64)( void ) = F_57 ;
void (* F_65)( void );
if ( ! V_90 )
return;
F_65 = F_64 ;
...
static inline void T_4 F_66 ( void )
{
V_62 -> V_5 . V_6 . V_7 =
F_52 ( V_39 , F_53 ( struct V_43 ) ) ;
if ( ! V_28 )
F_51 () ;
}
void F_67 ( void )
{
static T_5 void (* F_68)( void ) = F_66 ;
F_69 () ;
F_70 () -> V_49 = 0 ;
if ( V_92 == V_93 )
F_71 ( V_100 ) ;
