...
static int T_6 F_107 ( struct V_124 * V_125 )
{
...
V_134 -> V_217 = F_108 ( V_125 -> V_128 ) ;
V_134 -> V_218 = V_134 -> V_217 + F_108 ( V_125 -> V_129 ) ;
...
static int T_6 F_109 ( struct V_53 * V_54 )
{
T_3 * V_46 = ( T_3 * ) V_54 , * V_35 = ( T_3 * ) V_54 ;
struct V_124 * V_125 ;
V_35 += V_54 -> V_48 ;
...
if ( ! V_255 )
return - V_57 ;
V_254 = F_133 ( L_57 , 0 , & V_252 , & V_253 ) ;
if ( V_254 == V_256 )
return - V_57 ;
else if ( F_134 ( V_254 ) ) {
const char * V_257 = F_135 ( V_254 ) ;
F_24 ( L_58 , V_257 ) ;
return - V_117 ;
}
V_119 = F_40 ( V_252 ) ;
...
static int T_6 F_148 ( enum V_281 V_282 )
{
int V_119 = 0 ;
while ( V_267 != V_282 ) {
V_119 = F_145 () ;
...
static int T_6 F_160 ( char * V_290 )
{
unsigned int V_39 , V_11 , V_40 ;
int V_119 , V_108 , V_55 ;
T_1 V_1 ;
