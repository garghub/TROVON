...
static void T_6 F_12 ( void * V_43 )
{
struct V_44 V_24 ;
struct V_45 * V_46 ;
int V_14 ;
...
F_14 ( L_3 , V_47 ) ;
V_46 = F_15 ( V_48 , V_47 ) ;
V_24 . V_35 = F_16 ( V_46 ) >> V_38 ;
V_24 . V_49 = F_17 ( V_46 ) ;
V_14 = F_18 ( V_50 , V_47 , & V_24 ) ;
F_19 ( V_14 ) ;
F_20 ( V_51 , V_47 ) = V_46 ;
F_21 ( V_52 , 0 ) ;
F_22 () ;
}
static void F_23 ( enum V_53 V_53 , const char * V_54 )
{
...
const char * V_69 = L_4 ;
struct V_70 V_71 ;
V_65 = F_28 ( NULL , NULL , L_5 ) ;
if ( ! V_65 ) {
F_29 ( L_6 ) ;
return 0 ;
}
V_67 = F_30 ( V_65 , L_7 , & V_66 ) ;
...
V_6 . V_12 = 0 ;
V_6 . V_10 = V_84 ;
V_6 . V_13 = F_16 ( V_63 ) >> V_38 ;
if ( F_3 ( V_85 , & V_6 ) )
F_25 () ;
V_86 = (struct V_62 * ) V_63 ;
V_48 = F_37 ( sizeof( struct V_45 ) ,
sizeof( struct V_45 ) ) ;
if ( V_48 == NULL )
return - V_83 ;
F_38 () ;
...
static T_7 F_42 ( int V_89 , void * V_90 )
{
F_43 () ;
return V_91 ;
}
