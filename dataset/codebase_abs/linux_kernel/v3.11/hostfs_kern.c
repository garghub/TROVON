...
int F_47 ( struct V_53 * V_53 , T_4 V_67 , T_4 V_22 , int V_68 )
{
...
int F_58 ( struct V_53 * V_53 , struct V_74 * V_74 )
{
char * V_79 ;
long long V_67 ;
int V_31 = 0 ;
...
V_79 = F_51 ( V_74 ) ;
V_31 = F_59 ( F_60 ( V_53 ) -> V_43 , & V_67 , V_79 ,
V_82 ) ;
if ( V_31 < 0 )
goto V_25;
...
int F_63 ( struct V_53 * V_53 , struct V_77 * V_78 ,
T_4 V_59 , unsigned V_14 , unsigned V_87 ,
struct V_74 * * V_88 , void * * V_89 )
{
T_5 V_86 = V_59 >> V_85 ;
* V_88 = F_64 ( V_78 , V_86 , V_87 ) ;
if ( ! * V_88 )
return - V_23 ;
return 0 ;
}
...
int V_31 ;
V_79 = F_51 ( V_74 ) ;
V_31 = F_52 ( F_60 ( V_53 ) -> V_43 , & V_59 , V_79 + V_91 , V_90 ) ;
F_56 ( V_74 ) ;
...
T_6 V_92 ;
struct V_93 V_94 ;
int V_31 = F_69 ( V_10 , & V_94 , - 1 ) ;
if ( V_31 )
return V_31 ;
V_92 = F_70 ( V_94 . V_95 , V_94 . V_96 ) ;
...
case V_107 :
case V_108 :
F_71 ( V_18 , V_94 . V_44 & V_97 , V_92 ) ;
V_18 -> V_99 = & V_109 ;
break;
default:
V_18 -> V_99 = & V_109 ;
V_18 -> V_103 = & V_110 ;
V_18 -> V_72 -> V_111 = & V_112 ;
}
V_18 -> V_113 = V_94 . V_18 ;
V_18 -> V_114 = V_94 . V_44 ;
F_72 ( V_18 , V_94 . V_115 ) ;
F_73 ( V_18 , V_94 . V_116 ) ;
F_74 ( V_18 , V_94 . V_117 ) ;
...
int F_75 ( struct V_2 * V_56 , struct V_4 * V_4 , T_7 V_44 ,
bool V_126 )
{
struct V_2 * V_2 ;
char * V_10 ;
...
int F_82 ( struct V_4 * V_139 , struct V_2 * V_18 , struct V_4 * V_91 )
{
char * V_140 , * V_141 ;
int V_31 ;
...
int F_86 ( struct V_2 * V_18 , struct V_4 * V_4 , const char * V_139 )
{
char * V_53 ;
int V_31 ;
if ( ( V_53 = F_10 ( V_4 ) ) == NULL )
return - V_23 ;
V_31 = F_87 ( V_53 , V_139 ) ;
F_8 ( V_53 ) ;
return V_31 ;
}
int F_88 ( struct V_2 * V_18 , struct V_4 * V_4 , T_7 V_44 )
{
char * V_53 ;
int V_31 ;
if ( ( V_53 = F_10 ( V_4 ) ) == NULL )
...
static int F_92 ( struct V_2 * V_56 , struct V_4 * V_4 , T_7 V_44 , T_6 V_143 )
{
struct V_2 * V_2 ;
char * V_10 ;
int V_31 ;
...
goto V_128;
F_71 ( V_2 , V_44 , V_143 ) ;
V_31 = F_93 ( V_10 , V_44 , F_94 ( V_143 ) , F_95 ( V_143 ) ) ;
if ( ! V_31 )
goto V_26;
V_31 = F_68 ( V_2 , V_10 ) ;
F_8 ( V_10 ) ;
...
int F_96 ( struct V_2 * V_144 , struct V_4 * V_91 ,
...
V_31 = F_97 ( V_140 , V_141 ) ;
F_8 ( V_140 ) ;
F_8 ( V_141 ) ;
return V_31 ;
}
int F_98 ( struct V_2 * V_18 , int V_146 )
{
char * V_10 ;
...
if ( V_10 == NULL )
return - V_23 ;
if ( F_99 ( V_18 -> V_114 ) || F_100 ( V_18 -> V_114 ) ||
F_101 ( V_18 -> V_114 ) || F_102 ( V_18 -> V_114 ) )
V_31 = 0 ;
else
V_31 = F_103 ( V_10 , V_61 , V_62 , V_147 ) ;
F_8 ( V_10 ) ;
if ( ! V_31 )
V_31 = F_104 ( V_18 , V_146 ) ;
return V_31 ;
}
int F_105 ( struct V_4 * V_4 , struct V_153 * V_154 )
{
...
V_157 . V_158 |= V_164 ;
V_157 . V_165 = F_107 ( & V_166 , V_154 -> V_165 ) ;
}
if ( V_154 -> V_158 & V_167 ) {
V_157 . V_158 |= V_168 ;
V_157 . V_169 = F_108 ( & V_166 , V_154 -> V_169 ) ;
}
...
if ( V_10 == NULL )
return - V_23 ;
V_31 = F_109 ( V_10 , & V_157 , V_43 ) ;
F_8 ( V_10 ) ;
if ( V_31 )
return V_31 ;
if ( ( V_154 -> V_158 & V_159 ) &&
V_154 -> V_171 != F_110 ( V_2 ) )
F_111 ( V_2 , V_154 -> V_171 ) ;
F_112 ( V_2 , V_154 ) ;
F_113 ( V_2 ) ;
return 0 ;
}
static void * F_114 ( struct V_4 * V_4 , struct V_185 * V_186 )
{
char * V_19 = F_11 () ;
if ( V_19 ) {
char * V_187 = F_10 ( V_4 ) ;
...
static void F_116 ( struct V_4 * V_4 , struct V_185 * V_186 , void * V_189 )
{
char * V_17 = F_117 ( V_186 ) ;
if ( ! F_7 ( V_17 ) )
F_8 ( V_17 ) ;
}
static int F_118 ( struct V_27 * V_28 , void * V_190 , int V_191 )
{
struct V_2 * V_192 ;
...
if ( ! V_192 )
goto V_25;
V_31 = F_68 ( V_192 , V_193 ) ;
if ( V_31 )
goto V_128;
if ( F_119 ( V_192 -> V_114 ) ) {
char * V_10 = F_15 ( V_193 ) ;
if ( F_7 ( V_10 ) )
V_31 = F_76 ( V_10 ) ;
else
V_31 = F_68 ( V_192 , V_10 ) ;
F_18 ( V_10 ) ;
if ( V_31 )
goto V_128;
}
V_31 = - V_23 ;
V_28 -> V_204 = F_120 ( V_192 ) ;
if ( V_28 -> V_204 == NULL )
goto V_25;
return 0 ;
V_128:
...
static struct V_4 * F_121 ( struct V_205 * type ,
int V_87 , const char * V_206 ,
void * V_207 )
{
return F_122 ( type , V_87 , V_207 , F_118 ) ;
}
