...
static void F_24 ( struct V_20 * V_21 , struct V_44 * V_45 ,
...
F_26 ( sizeof( V_37 -> V_56 ) < sizeof( struct V_48 ) ) ;
...
static void F_33 ( unsigned long V_3 )
{
...
static enum V_70 F_34 ( struct V_71 * V_71 )
{
struct V_20 * V_21 = F_35 ( V_71 , struct V_20 , V_62 ) ;
F_36 ( & V_21 -> V_72 ) ;
return V_73 ;
}
static void F_37 ( struct V_20 * V_21 , struct V_1 * V_3 )
{
struct V_44 V_45 ;
V_21 -> V_33 ++ ;
...
if ( ! V_21 -> V_81 . V_31 )
goto V_82;
if ( F_40 ( F_32 () , V_21 -> V_81 ) <
F_10 ( V_21 -> V_32 ) ) {
F_30 ( & V_21 -> V_80 ,
F_31 ( V_21 -> V_81 , V_21 -> V_32 ) ,
V_63 ) ;
return;
}
V_82:
...
static void F_41 ( struct V_20 * V_21 , unsigned int V_83 ,
const struct V_1 * V_78 )
{
if ( ! ( V_21 -> V_84 [ V_83 ] . V_52 & V_75 ) ) {
F_38 ( V_21 , & V_21 -> V_84 [ V_83 ] , V_78 ) ;
return;
}
...
return;
if ( V_21 -> V_30 . V_31 )
F_30 ( & V_21 -> V_62 , V_21 -> V_30 , V_86 ) ;
}
static void F_43 ( unsigned long V_3 )
{
struct V_20 * V_21 = (struct V_20 * ) V_3 ;
struct V_44 V_64 ;
V_64 . V_66 = V_87 ;
...
static enum V_70 F_44 ( struct V_71 * V_71 )
{
struct V_20 * V_21 = F_35 ( V_71 , struct V_20 , V_62 ) ;
F_45 ( & V_21 -> V_72 ) ;
...
static inline int F_46 ( struct V_20 * V_21 , int V_89 ,
unsigned int V_83 )
{
if ( ( V_21 -> V_84 ) && ( V_21 -> V_84 [ V_83 ] . V_52 & V_79 ) ) {
if ( V_89 )
F_37 ( V_21 , & V_21 -> V_84 [ V_83 ] ) ;
return 1 ;
}
return 0 ;
}
static int F_47 ( struct V_20 * V_21 , int V_89 )
{
int V_90 = 0 ;
if ( V_21 -> V_27 > 1 ) {
unsigned int V_91 ;
for ( V_91 = 1 ; V_91 < V_21 -> V_27 ; V_91 ++ )
V_90 += F_46 ( V_21 , V_89 , V_91 ) ;
} else {
V_90 += F_46 ( V_21 , V_89 , 0 ) ;
}
return V_90 ;
}
...
static enum V_70 F_49 ( struct V_71 * V_71 )
{
struct V_20 * V_21 = F_35 ( V_71 , struct V_20 , V_80 ) ;
F_36 ( & V_21 -> V_92 ) ;
if ( F_47 ( V_21 , 0 ) ) {
F_50 ( V_71 , F_32 () , V_21 -> V_32 ) ;
return V_93 ;
} else {
V_21 -> V_81 = F_51 ( 0 , 0 ) ;
return V_73 ;
...
static void F_52 ( struct V_36 * V_37 , void * V_3 )
{
struct V_20 * V_21 = (struct V_20 * ) V_3 ;
...
static struct V_20 * F_54 ( struct V_98 * V_99 , T_2 V_26 ,
int V_8 )
{
struct V_20 * V_21 ;
F_9 (op, ops, list) {
...
static void F_58 ( struct V_9 * V_10 , struct V_20 * V_21 )
{
if ( V_21 -> V_103 == V_10 ) {
F_59 ( V_10 , V_21 -> V_26 , F_60 ( V_21 -> V_26 ) ,
F_52 , V_21 ) ;
V_21 -> V_103 = NULL ;
} else
F_61 ( V_104 L_21
...
static int F_62 ( struct V_98 * V_99 , T_2 V_26 , int V_8 )
{
...
static int F_65 ( struct V_98 * V_99 , T_2 V_26 , int V_8 )
{
struct V_20 * V_21 , * V_105 ;
F_63 (op, n, ops, list) {
if ( ( V_21 -> V_26 == V_26 ) && ( V_21 -> V_8 == V_8 ) ) {
...
static int F_66 ( struct V_98 * V_99 , struct V_44 * V_64 ,
int V_8 )
{
struct V_20 * V_21 = F_54 ( V_99 , V_64 -> V_26 , V_8 ) ;
if ( ! V_21 )
return - V_107 ;
V_64 -> V_28 = V_21 -> V_28 ;
V_64 -> V_61 = V_21 -> V_61 ;
...
V_64 -> V_69 = V_21 -> V_69 ;
V_64 -> V_27 = V_21 -> V_27 ;
F_24 ( V_21 , V_64 , V_21 -> V_39 , 0 ) ;
return V_108 ;
}
static int F_67 ( struct V_44 * V_64 , struct V_109 * V_110 ,
...
return - V_107 ;
V_21 = F_54 ( & V_19 -> V_113 , V_64 -> V_26 , V_8 ) ;
if ( V_21 ) {
if ( V_64 -> V_27 > V_21 -> V_27 )
return - V_114 ;
for ( V_91 = 0 ; V_91 < V_64 -> V_27 ; V_91 ++ ) {
V_51 = F_68 ( ( V_115 * ) & V_21 -> V_39 [ V_91 ] ,
V_110 -> V_116 , V_41 ) ;
...
V_21 = F_69 ( V_118 , V_119 ) ;
if ( ! V_21 )
return - V_120 ;
V_21 -> V_26 = V_64 -> V_26 ;
if ( V_64 -> V_27 > 1 ) {
V_21 -> V_39 = F_70 ( V_64 -> V_27 * V_41 ,
V_119 ) ;
if ( ! V_21 -> V_39 ) {
F_57 ( V_21 ) ;
return - V_120 ;
...
V_21 -> V_6 = V_6 ;
V_21 -> V_8 = V_8 ;
F_71 ( & V_21 -> V_62 , V_121 , V_86 ) ;
V_21 -> V_62 . V_122 = F_34 ;
F_72 ( & V_21 -> V_72 , F_33 ,
( unsigned long ) V_21 ) ;
F_71 ( & V_21 -> V_80 , V_121 , V_86 ) ;
F_73 ( & V_21 -> V_106 , & V_19 -> V_113 ) ;
}
...
V_21 -> V_68 = V_64 -> V_68 ;
V_21 -> V_69 = V_64 -> V_69 ;
V_21 -> V_30 = F_74 ( V_64 -> V_68 ) ;
V_21 -> V_32 = F_74 ( V_64 -> V_69 ) ;
...
static int F_75 ( struct V_44 * V_64 , struct V_109 * V_110 ,
int V_8 , struct V_5 * V_6 )
{
struct V_4 * V_19 = F_2 ( V_6 ) ;
struct V_20 * V_21 ;
...
( ! ( V_64 -> V_26 & V_128 ) ) ) )
return - V_107 ;
V_21 = F_54 ( & V_19 -> V_129 , V_64 -> V_26 , V_8 ) ;
if ( V_21 ) {
if ( V_64 -> V_27 > V_21 -> V_27 )
return - V_114 ;
if ( V_64 -> V_27 ) {
V_51 = F_68 ( ( V_115 * ) V_21 -> V_39 ,
V_110 -> V_116 ,
V_64 -> V_27 * V_41 ) ;
if ( V_51 < 0 )
return V_51 ;
...
if ( V_64 -> V_27 ) {
V_51 = F_68 ( ( V_115 * ) V_21 -> V_39 , V_110 -> V_116 ,
V_64 -> V_27 * V_41 ) ;
if ( V_51 < 0 ) {
if ( V_21 -> V_39 != & V_21 -> V_101 )
F_57 ( V_21 -> V_39 ) ;
...
V_21 -> V_60 = V_8 ;
F_71 ( & V_21 -> V_62 , V_121 , V_86 ) ;
V_21 -> V_62 . V_122 = F_44 ;
F_72 ( & V_21 -> V_72 , F_43 ,
( unsigned long ) V_21 ) ;
F_71 ( & V_21 -> V_80 , V_121 , V_86 ) ;
V_21 -> V_80 . V_122 = F_49 ;
F_72 ( & V_21 -> V_92 , F_48 ,
( unsigned long ) V_21 ) ;
F_73 ( & V_21 -> V_106 , & V_19 -> V_129 ) ;
V_127 = 1 ;
}
V_21 -> V_28 = V_64 -> V_28 ;
if ( V_21 -> V_28 & V_95 ) {
...
static int F_77 ( struct V_109 * V_110 , int V_8 , struct V_5 * V_6 )
{
struct V_36 * V_37 ;
struct V_9 * V_10 ;
int V_51 ;
...
return - V_120 ;
F_19 ( V_37 ) ;
V_51 = F_68 ( F_21 ( V_37 , V_41 ) , V_110 -> V_116 , V_41 ) ;
if ( V_51 < 0 ) {
F_28 ( V_37 ) ;
return V_51 ;
}
...
static int F_78 ( struct V_130 * V_131 , struct V_132 * V_5 ,
...
V_134 = F_68 ( ( V_115 * ) & V_64 , V_110 -> V_116 , V_108 ) ;
if ( V_134 < 0 )
return V_134 ;
F_79 ( V_6 ) ;
switch ( V_64 . V_66 ) {
case V_140 :
V_134 = F_67 ( & V_64 , V_110 , V_8 , V_6 ) ;
break;
case V_141 :
V_134 = F_75 ( & V_64 , V_110 , V_8 , V_6 ) ;
break;
case V_142 :
if ( F_65 ( & V_19 -> V_113 , V_64 . V_26 , V_8 ) )
V_134 = V_108 ;
else
V_134 = - V_107 ;
break;
case V_143 :
if ( F_62 ( & V_19 -> V_129 , V_64 . V_26 , V_8 ) )
V_134 = V_108 ;
else
V_134 = - V_107 ;
break;
case V_144 :
V_64 . V_66 = V_145 ;
V_134 = F_66 ( & V_19 -> V_113 , & V_64 , V_8 ) ;
break;
case V_146 :
V_64 . V_66 = V_147 ;
V_134 = F_66 ( & V_19 -> V_129 , & V_64 , V_8 ) ;
break;
case V_148 :
if ( ( V_64 . V_27 != 1 ) || ( V_133 != V_41 + V_108 ) )
V_134 = - V_107 ;
else
V_134 = F_77 ( V_110 , V_8 , V_6 ) ;
break;
default:
V_134 = - V_107 ;
break;
...
static int F_81 ( struct V_149 * V_150 , unsigned long V_110 ,
void * V_151 )
{
struct V_9 * V_10 = F_82 ( V_151 ) ;
struct V_4 * V_19 = F_35 ( V_150 , struct V_4 , V_152 ) ;
struct V_5 * V_6 = & V_19 -> V_6 ;
struct V_20 * V_21 ;
int V_153 = 0 ;
if ( ! F_83 ( F_84 ( V_10 ) , & V_11 ) )
return V_154 ;
if ( V_10 -> type != V_139 )
return V_154 ;
switch ( V_110 ) {
...
F_87 ( & V_19 -> V_113 ) ;
F_87 ( & V_19 -> V_129 ) ;
V_19 -> V_152 . V_162 = F_81 ;
F_88 ( & V_19 -> V_152 ) ;
return 0 ;
}
static int F_89 ( struct V_132 * V_5 )
{
struct V_5 * V_6 = V_5 -> V_6 ;
struct V_4 * V_19 ;
...
F_90 ( & V_19 -> V_152 ) ;
F_79 ( V_6 ) ;
F_63 (op, next, &bo->tx_ops, list)
F_55 ( V_21 ) ;
F_63 (op, next, &bo->rx_ops, list) {
if ( V_21 -> V_8 ) {
if ( V_21 -> V_103 ) {
struct V_9 * V_10 ;
V_10 = F_16 ( & V_11 , V_21 -> V_8 ) ;
...
static int F_94 ( struct V_132 * V_5 , struct V_166 * V_167 , int V_168 ,
int V_28 )
{
...
V_19 -> V_135 = 1 ;
if ( V_164 ) {
sprintf ( V_19 -> V_165 , L_24 , F_95 ( V_6 ) ) ;
V_19 -> V_161 = F_96 ( V_19 -> V_165 , 0644 ,
V_164 ,
& V_170 , V_6 ) ;
}
return 0 ;
}
static int F_97 ( struct V_130 * V_131 , struct V_132 * V_5 ,
...
V_171 = V_28 & V_172 ;
V_28 &= ~ V_172 ;
V_37 = F_98 ( V_6 , V_28 , V_171 , & error ) ;
if ( ! V_37 )
return error ;
if ( V_37 -> V_168 < V_133 )
V_133 = V_37 -> V_168 ;
V_51 = F_99 ( V_110 -> V_116 , V_37 -> V_3 , V_133 ) ;
if ( V_51 < 0 ) {
F_100 ( V_6 , V_37 ) ;
return V_51 ;
}
F_101 ( V_110 , V_6 , V_37 ) ;
if ( V_110 -> V_137 ) {
