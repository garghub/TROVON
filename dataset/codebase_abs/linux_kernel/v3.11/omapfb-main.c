...
V_27 -> V_202 = V_202 ;
V_27 -> V_103 = V_57 ;
V_27 -> V_30 = & V_202 -> V_273 [ V_57 ] ;
V_27 -> V_30 -> V_103 = V_57 ;
F_110 ( & V_27 -> V_30 -> V_274 ) ;
V_27 -> V_39 = V_275 ? V_40 :
V_276 ;
V_27 -> V_153 = V_277 ;
V_202 -> V_224 ++ ;
}
...
static int F_113 ( const char * V_278 ,
struct V_101 * V_102 ,
struct V_115 * V_116 , T_3 * V_279 )
{
struct V_1 * V_2 ;
struct V_6 * V_7 ;
struct V_280 * V_263 ;
int V_16 ;
#ifdef F_114
if ( strcmp ( V_278 , L_58 ) == 0 ) {
* V_116 = V_281 ;
* V_279 = 24 ;
return 0 ;
} else if ( strcmp ( V_278 , L_59 ) == 0 ) {
* V_116 = V_282 ;
* V_279 = 24 ;
return 0 ;
}
...
V_2 -> V_263 = V_263 ;
V_16 = F_116 ( V_7 , V_2 , V_278 , NULL , 0 , NULL , 24 ) ;
if ( V_16 == 0 ) {
V_16 = - V_60 ;
goto V_154;
}
...
struct V_101 * V_102 , char * V_278 )
{
int V_16 ;
T_3 V_279 ;
struct V_115 V_116 , V_291 ;
struct V_203 * V_204 ;
V_16 = F_113 ( V_278 , V_102 , & V_116 , & V_279 ) ;
if ( V_16 )
return V_16 ;
V_204 = F_63 ( V_202 , V_102 ) ;
V_204 -> V_292 = V_279 ;
...
{
struct V_203 * V_204 ;
F_120 ( V_252 -> V_109 -> V_295 == NULL ) ;
V_204 = F_63 ( V_202 , V_252 ) ;
if ( V_204 -> V_292 != 0 )
return V_204 -> V_292 ;
return V_252 -> V_109 -> V_295 ( V_252 ) ;
}
static int F_121 ( struct V_201 * V_202 )
{
char * V_296 , * V_297 , * V_298 ;
int V_16 = 0 ;
V_296 = F_122 ( V_299 , V_229 ) ;
if ( ! V_296 )
return - V_230 ;
V_297 = V_296 ;
while ( ! V_16 && ( V_298 = F_123 ( & V_297 , L_60 ) ) != NULL ) {
char * V_19 , * V_300 , * V_278 ;
struct V_101 * V_102 ;
int V_57 ;
V_19 = strchr ( V_298 , ':' ) ;
if ( ! V_19 ) {
...
V_102 = NULL ;
for ( V_57 = 0 ; V_57 < V_202 -> V_268 ; ++ V_57 ) {
if ( strcmp ( V_202 -> V_269 [ V_57 ] . V_252 -> V_301 ,
V_300 ) == 0 ) {
...
static void F_124 ( struct V_302 * V_59 ,
struct V_101 * V_102 ,
struct V_115 * V_24 )
{
if ( V_102 -> V_109 -> V_114 ) {
...
struct V_303 * V_304 ;
T_3 * V_305 ;
int V_16 , V_57 , V_306 , V_175 ;
if ( ! V_102 -> V_109 -> V_307 )
return - V_308 ;
V_175 = 0x80 * 2 ;
V_305 = F_126 ( V_175 , V_229 ) ;
if ( V_305 == NULL )
return - V_230 ;
V_16 = V_102 -> V_109 -> V_307 ( V_102 , V_305 , V_175 ) ;
if ( V_16 < 0 )
goto V_309;
V_304 = F_115 ( sizeof( * V_304 ) , V_229 ) ;
if ( V_304 == NULL ) {
V_16 = - V_230 ;
goto V_309;
}
F_127 ( V_305 , V_304 ) ;
V_306 = - 1 ;
for ( V_57 = 0 ; V_57 < V_304 -> V_310 ; ++ V_57 ) {
struct V_302 * V_59 ;
struct V_115 V_24 ;
V_59 = & V_304 -> V_311 [ V_57 ] ;
if ( V_59 -> V_117 == 0 )
continue;
...
if ( V_145 -> V_164 )
V_145 -> V_321 ( V_145 ) ;
V_16 = V_145 -> V_322 ( V_145 , V_319 ) ;
if ( V_16 )
F_130 ( V_202 -> V_219 ,
L_66 ,
V_145 -> V_301 , V_319 -> V_301 ) ;
}
return 0 ;
}
static int F_133 ( struct V_323 * V_324 )
{
...
return - V_326 ;
if ( V_324 -> V_327 != 0 ) {
F_78 ( & V_324 -> V_219 , L_68 ) ;
V_16 = - V_308 ;
goto V_328;
}
V_202 = F_135 ( & V_324 -> V_219 , sizeof( struct V_201 ) ,
V_229 ) ;
if ( V_202 == NULL ) {
V_16 = - V_230 ;
goto V_328;
...
V_202 -> V_331 = F_144 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_331 ; V_57 ++ )
V_202 -> V_332 [ V_57 ] = F_145 ( V_57 ) ;
V_325 = NULL ;
for ( V_57 = 0 ; V_57 < V_202 -> V_268 ; ++ V_57 ) {
struct V_101 * V_252 ;
const char * V_333 ;
...
if ( V_333 == NULL ||
( V_252 -> V_301 && strcmp ( V_333 , V_252 -> V_301 ) == 0 ) ) {
V_325 = V_252 ;
break;
}
}
...
if ( F_121 ( V_202 ) )
F_130 ( & V_324 -> V_219 , L_75 ) ;
} else if ( V_325 && V_325 -> V_109 -> V_294 &&
V_325 -> V_109 -> V_293 ) {
struct V_115 V_24 ;
V_16 = F_125 ( V_325 , & V_24 ) ;
if ( V_16 == 0 )
V_325 -> V_109 -> V_294 ( V_325 , & V_24 ) ;
}
V_16 = F_108 ( V_202 ) ;
if ( V_16 )
goto V_330;
for ( V_57 = 0 ; V_57 < V_202 -> V_331 ; V_57 ++ ) {
struct V_318 * V_319 ;
V_319 = V_202 -> V_332 [ V_57 ] ;
V_16 = V_319 -> V_165 ( V_319 ) ;
if ( V_16 )
F_130 ( V_202 -> V_219 , L_76 ) ;
}
F_6 ( L_77 ) ;
if ( V_325 ) {
V_16 = F_129 ( V_202 , V_325 ) ;
if ( V_16 ) {
F_78 ( V_202 -> V_219 ,
L_78
L_79 ) ;
...
F_148 () ;
V_328:
F_78 ( & V_324 -> V_219 , L_82 ) ;
return V_16 ;
}
static int T_7 F_149 ( struct V_323 * V_324 )
{
struct V_201 * V_202 = F_150 ( V_324 ) ;
F_151 ( V_202 ) ;
F_101 ( V_202 ) ;
F_148 () ;
return 0 ;
