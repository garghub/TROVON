...
static T_6 F_66 ( struct V_161 * V_42 )
{
struct V_162 V_96 ;
int V_163 , V_48 ;
F_67 ( & V_96 , V_42 -> V_164 ) ;
while ( F_68 ( & V_96 , & V_163 , & V_48 ) )
if ( V_163 == V_165 )
return V_166 + V_48 * 4 ;
return 0 ;
}
static int F_69 ( struct V_161 * V_42 ,
const struct V_167 * V_168 )
{
struct V_169 * V_170 = F_70 ( V_42 ) ;
struct V_160 * V_53 ;
struct V_1 * V_1 ;
int V_31 ;
V_31 = F_71 ( - 1 , NULL , V_171 , sizeof( * V_1 ) , & V_53 ) ;
if ( V_31 < 0 )
return V_31 ;
F_72 ( V_53 , & V_42 -> V_43 ) ;
V_1 = V_53 -> V_88 ;
...
F_75 ( & V_1 -> V_50 , V_42 ) ;
V_53 -> V_174 = F_62 ;
strcpy ( V_53 -> V_175 , L_2 ) ;
strcpy ( V_53 -> V_176 , L_6 ) ;
snprintf ( V_53 -> V_177 , sizeof( V_53 -> V_177 ) ,
L_7 ,
V_170 -> V_178 [ 3 ] , V_170 -> V_178 [ 4 ] ,
F_76 ( & V_42 -> V_43 ) , 100 << V_170 -> V_51 ) ;
strcpy ( V_53 -> V_179 , L_2 ) ;
V_31 = F_52 ( V_1 ) ;
if ( V_31 < 0 )
goto error;
V_31 = F_59 ( V_1 ) ;
...
static void F_80 ( struct V_161 * V_42 )
{
struct V_1 * V_1 = F_81 ( & V_42 -> V_43 ) ;
if ( F_82 ( & V_1 -> V_50 ) < 0 ) {
F_6 ( V_1 ) ;
F_41 ( & V_1 -> V_95 ) ;
F_37 ( V_1 ) ;
...
static void F_83 ( struct V_161 * V_42 )
{
struct V_1 * V_1 = F_81 ( & V_42 -> V_43 ) ;
F_6 ( V_1 ) ;
F_84 ( V_1 -> V_53 ) ;
