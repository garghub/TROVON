...
if ( ! V_235 )
goto V_241;
V_2 -> V_25 . V_26 = ( void * ) ( V_235 + V_242 - 4096 ) ;
#ifdef F_2
...
V_266 -> V_175 = V_267 ;
V_266 -> V_268 = 64 ;
V_266 -> V_269 [ 0 ] . V_270 = 12 ;
V_266 -> V_269 [ 0 ] . V_271 = 0 ;
V_266 -> V_269 [ 0 ] . V_272 [ 0 ] . V_270 = 12 ;
V_266 -> V_269 [ 0 ] . V_272 [ 0 ] . V_273 = 0 ;
V_266 -> V_269 [ 1 ] . V_270 = 24 ;
V_266 -> V_269 [ 1 ] . V_271 = V_274 ;
V_266 -> V_269 [ 1 ] . V_272 [ 0 ] . V_270 = 24 ;
V_266 -> V_269 [ 1 ] . V_272 [ 0 ] . V_273 = 0 ;
return 0 ;
}
