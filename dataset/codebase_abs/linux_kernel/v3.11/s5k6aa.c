...
V_159 = & V_255 -> V_257 ;
if ( F_53 ( V_159 -> V_159 ) ) {
V_34 = ( V_159 -> V_160 ? V_258 : V_259 )
| V_260 ;
V_33 = F_102 ( & V_26 -> V_261 , V_159 -> V_159 , V_34 ,
L_14 ) ;
if ( V_33 < 0 )
return V_33 ;
...
const struct V_263 * V_113 )
{
const struct V_254 * V_255 = V_26 -> V_261 . V_264 ;
struct V_1 * V_7 ;
struct V_5 * V_5 ;
int V_11 , V_33 ;
if ( V_255 == NULL ) {
F_104 ( & V_26 -> V_261 , L_16 ) ;
return - V_57 ;
}
if ( V_255 -> V_53 == 0 ) {
F_104 ( & V_26 -> V_261 , L_17 ) ;
return - V_57 ;
}
V_5 = F_105 ( & V_26 -> V_261 , sizeof( * V_5 ) , V_265 ) ;
if ( ! V_5 )
return - V_266 ;
F_106 ( & V_5 -> V_168 ) ;
V_5 -> V_53 = V_255 -> V_53 ;
V_5 -> V_133 = V_255 -> V_133 ;
V_5 -> V_156 = V_255 -> V_134 ;
V_5 -> V_164 = V_255 -> V_267 ;
V_5 -> V_73 = V_255 -> V_69 ;
V_5 -> V_71 = V_255 -> V_268 ;
V_7 = & V_5 -> V_7 ;
F_107 ( V_7 , V_26 , & V_269 ) ;
F_108 ( V_7 -> V_236 , V_270 , sizeof( V_7 -> V_236 ) ) ;
V_7 -> V_271 = & V_272 ;
V_7 -> V_34 |= V_273 ;
V_5 -> V_214 . V_34 = V_274 ;
V_7 -> V_275 . type = V_276 ;
V_33 = F_109 ( & V_7 -> V_275 , 1 , & V_5 -> V_214 , 0 ) ;
if ( V_33 )
return V_33 ;
V_33 = F_101 ( V_5 , V_255 ) ;
if ( V_33 )
goto V_277;
for ( V_11 = 0 ; V_11 < V_161 ; V_11 ++ )
V_5 -> V_162 [ V_11 ] . V_278 = V_279 [ V_11 ] ;
V_33 = F_110 ( & V_26 -> V_261 , V_161 ,
V_5 -> V_162 ) ;
if ( V_33 ) {
F_104 ( & V_26 -> V_261 , L_18 ) ;
goto V_277;
}
V_33 = F_88 ( V_5 ) ;
if ( V_33 )
