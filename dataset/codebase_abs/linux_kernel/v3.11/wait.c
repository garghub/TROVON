...
static inline T_1 * F_44 ( T_4 * V_30 )
{
if ( V_25 == 64 ) {
unsigned long V_1 = ( unsigned long ) V_30 ;
return F_32 ( ( void * ) ( V_1 & ~ 1 ) , V_1 & 1 ) ;
}
return F_32 ( V_30 , 0 ) ;
}
static int F_45 ( T_2 * V_7 , unsigned V_12 , int V_13 ,
void * V_15 )
{
struct V_16 * V_4 = V_15 ;
struct V_17 * V_18
...
static T_3
int F_47 ( T_1 * V_20 , struct V_17 * V_1 ,
int (* F_30)( T_4 * ) , unsigned V_12 )
{
T_4 * V_27 ;
int V_14 = 0 ;
do {
...
break;
V_14 = (* F_30)( V_27 ) ;
} while ( ! V_14 && F_46 ( V_27 ) != 0 );
F_17 ( V_20 , & V_1 -> V_7 ) ;
return V_14 ;
}
T_3 int F_48 ( T_4 * V_30 , int (* F_30)( T_4 * ) ,
unsigned V_12 )
{
T_1 * V_20 = F_44 ( V_30 ) ;
F_49 ( V_7 , V_30 ) ;
return F_47 ( V_20 , & V_7 , F_30 , V_12 ) ;
}
void F_50 ( T_4 * V_30 )
{
F_37 ( F_44 ( V_30 ) , V_30 , V_31 ) ;
}
