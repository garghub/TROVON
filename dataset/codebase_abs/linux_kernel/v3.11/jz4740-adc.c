...
int V_36 ;
int V_10 ;
V_12 = F_23 ( & V_23 -> V_24 , sizeof( * V_12 ) , V_37 ) ;
if ( ! V_12 ) {
F_24 ( & V_23 -> V_24 , L_1 ) ;
return - V_38 ;
}
...
V_10 = F_25 ( V_23 , 1 ) ;
if ( V_10 < 0 ) {
F_24 ( & V_23 -> V_24 , L_3 , V_10 ) ;
return V_10 ;
}
V_35 = F_26 ( V_23 , V_39 , 0 ) ;
if ( ! V_35 ) {
F_24 ( & V_23 -> V_24 , L_4 ) ;
return - V_40 ;
}
V_12 -> V_41 = F_27 ( V_35 -> V_42 , V_9 ,
V_23 -> V_43 ) ;
if ( ! V_12 -> V_41 ) {
F_24 ( & V_23 -> V_24 , L_5 ) ;
return - V_44 ;
}
V_12 -> V_20 = F_28 ( V_12 -> V_41 -> V_42 , F_29 ( V_12 -> V_41 ) ) ;
if ( ! V_12 -> V_20 ) {
V_36 = - V_44 ;
F_24 ( & V_23 -> V_24 , L_6 ) ;
goto V_45;
...
V_33 -> V_52 . V_55 = V_56 ;
V_33 -> V_52 . V_57 = V_58 ;
F_37 ( V_5 , F_38 ( 5 ) , 0 , 0 , V_59 | V_60 ) ;
V_12 -> V_5 = V_5 ;
F_39 ( V_12 -> V_1 , V_5 ) ;
F_40 ( V_12 -> V_1 , F_1 ) ;
F_14 ( 0x00 , V_12 -> V_20 + V_21 ) ;
F_14 ( 0xff , V_12 -> V_20 + V_50 ) ;
V_36 = F_41 ( & V_23 -> V_24 , 0 , V_61 ,
F_42 ( V_61 ) , V_35 ,
V_10 , NULL ) ;
if ( V_36 < 0 )
goto V_62;
...
F_44 ( V_12 -> V_20 ) ;
V_45:
F_45 ( V_12 -> V_41 -> V_42 , F_29 ( V_12 -> V_41 ) ) ;
return V_36 ;
}
static int F_46 ( struct V_22 * V_23 )
{
struct V_11 * V_12 = F_47 ( V_23 ) ;
F_48 ( & V_23 -> V_24 ) ;
F_49 ( V_12 -> V_5 , F_38 ( 5 ) , V_59 | V_60 , 0 ) ;
F_50 ( V_12 -> V_5 ) ;
F_39 ( V_12 -> V_1 , NULL ) ;
F_40 ( V_12 -> V_1 , NULL ) ;
F_44 ( V_12 -> V_20 ) ;
