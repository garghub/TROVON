...
static int F_139 ( struct V_406 * V_407 , int V_408 )
{
int V_1 ;
if ( V_407 )
V_408 = 0 ;
...
static void F_142 ( struct V_411 * V_412 ,
T_1 V_413 )
{
struct V_414 * V_415 ;
void T_3 * V_416 ;
T_1 V_40 ;
V_415 = F_143 ( V_412 , V_417 ,
L_24 ) ;
if ( ! V_415 ) {
F_144 ( & V_412 -> V_418 ,
L_25 ) ;
...
void T_7 F_149 ( T_1 V_425 , T_1 V_330 )
{
V_26 = F_145 ( V_425 , V_330 ) ;
if ( ! V_26 )
F_40 ( L_28 , V_135 ) ;
F_150 ( & V_79 . V_80 ) ;
F_150 ( & V_79 . V_379 ) ;
...
static int F_156 ( struct V_430 * V_431 ,
struct V_432 * V_433 ,
int V_369 )
{
struct V_414 V_434 = F_157 ( V_369 ) ;
struct V_435 V_436 = {
. V_437 = L_29 ,
. V_438 = L_30 ,
. V_322 = V_439 ,
. V_440 = V_433 ,
. V_441 = sizeof( struct V_432 ) ,
. V_442 = & V_434 ,
. V_443 = 1 ,
} ;
return F_158 ( V_431 , 0 , & V_436 , 1 , NULL , 0 , NULL ) ;
}
static int F_159 ( struct V_411 * V_412 )
{
struct V_406 * V_407 = V_412 -> V_418 . V_444 ;
struct V_445 * V_433 = F_160 ( & V_412 -> V_418 ) ;
int V_369 = 0 , V_446 = 0 ;
struct V_414 * V_415 ;
V_415 = F_143 ( V_412 , V_417 , L_31 ) ;
if ( ! V_415 ) {
F_144 ( & V_412 -> V_418 , L_32 ) ;
return - V_447 ;
}
V_26 = F_161 ( & V_412 -> V_418 , V_415 -> V_419 , F_146 ( V_415 ) ) ;
if ( ! V_26 ) {
F_144 ( & V_412 -> V_418 ,
L_33 ) ;
return - V_447 ;
...
F_154 () ;
F_142 ( V_412 , V_433 -> V_413 ) ;
V_415 = F_143 ( V_412 , V_417 , L_34 ) ;
if ( ! V_415 ) {
F_144 ( & V_412 -> V_418 , L_35 ) ;
return - V_447 ;
}
V_41 = F_161 ( & V_412 -> V_418 , V_415 -> V_419 ,
F_146 ( V_415 ) ) ;
F_2 ( V_372 , V_363 ) ;
V_369 = F_162 ( V_412 , 0 ) ;
if ( V_369 <= 0 ) {
F_144 ( & V_412 -> V_418 , L_36 ) ;
return - V_447 ;
}
V_446 = F_163 ( V_369 , F_127 ,
F_129 , V_448 , L_31 , NULL ) ;
if ( V_446 < 0 ) {
F_40 ( L_37 ) ;
V_446 = - V_72 ;
goto V_449;
}
F_139 ( V_407 , V_433 -> V_408 ) ;
F_164 ( V_284 ) ;
F_155 () ;
V_446 = F_158 ( & V_412 -> V_418 , 0 , V_450 ,
...
if ( ! F_165 ( L_39 ) ) {
V_446 = F_158 ( & V_412 -> V_418 , 0 , V_451 ,
F_39 ( V_451 ) , NULL , 0 ,
V_362 ) ;
if ( V_446 ) {
F_166 ( & V_412 -> V_418 ) ;
...
V_446 = F_156 ( & V_412 -> V_418 , V_433 -> V_452 ,
V_433 -> V_453 ) ;
if ( V_446 ) {
F_166 ( & V_412 -> V_418 ) ;
F_40 ( L_40 ) ;
