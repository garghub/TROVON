...
break;
case V_49 :
if ( V_30 ( & V_26 -> V_50 ) != sizeof( T_6 )
|| V_30 ( & V_26 -> V_51 ) != sizeof( V_52 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
break;
case V_53 : {
T_7 * const V_54 = ( T_7 * ) V_26 ;
if ( V_30 ( & V_54 -> V_50 ) != sizeof( T_7 )
|| V_30 ( & V_54 -> V_51 ) != sizeof( V_55 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
for ( V_23 = 1 ; V_23 < V_56 ; V_23 ++ ) {
char * V_59 = V_57 [ V_23 ] ;
int const V_60 = setjmp ( V_61 ) ;
switch ( V_60 ) {
default:
fprintf ( V_10 , L_9 , V_59 ) ;
exit ( 1 ) ;
break;
case V_62 :
V_5 = - 1 ;
