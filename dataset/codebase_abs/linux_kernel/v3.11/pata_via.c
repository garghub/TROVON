...
static void F_32 ( struct V_1 * V_2 , const struct V_8 * V_9 )
{
T_1 V_113 ;
F_31 ( V_2 , V_9 -> V_15 ) ;
if ( V_9 -> V_19 == V_20 ) {
...
static int F_34 ( struct V_1 * V_2 , const struct V_115 * V_65 )
{
...
static const struct V_116 V_125 = {
. V_15 = V_118 ,
. V_119 = V_120 ,
. V_121 = V_122 ,
. V_123 = & V_126 ,
} ;
static const struct V_116 V_127 = {
. V_15 = V_118 ,
. V_119 = V_120 ,
. V_121 = V_122 ,
. V_19 = V_56 ,
...
static const struct V_116 V_128 = {
. V_15 = V_118 ,
. V_119 = V_120 ,
. V_121 = V_122 ,
. V_19 = V_20 ,
...
static const struct V_116 V_129 = {
. V_15 = V_118 ,
. V_119 = V_120 ,
. V_121 = V_122 ,
. V_19 = V_22 ,
...
static const struct V_116 V_130 = {
. V_15 = V_118 ,
. V_119 = V_120 ,
. V_121 = V_122 ,
. V_19 = V_47 ,
...
const struct V_116 * V_131 [] = { NULL , NULL } ;
struct V_1 * V_132 ;
const struct V_8 * V_9 ;
T_2 V_108 ;
unsigned long V_15 = V_65 -> V_133 ;
int V_134 ;
F_35 ( & V_2 -> V_12 , V_135 ) ;
V_134 = F_36 ( V_2 ) ;
if ( V_134 )
...
if ( V_15 & V_136 )
V_131 [ 1 ] = & V_137 ;
for ( V_9 = V_138 ; V_9 -> V_65 != V_139 ;
V_9 ++ )
if ( ( V_132 = F_37 ( V_140 +
! ! ( V_9 -> V_15 & V_141 ) ,
V_9 -> V_65 , NULL ) ) ) {
T_2 V_142 = V_132 -> V_143 ;
F_38 ( V_132 ) ;
if ( ( V_65 -> V_86 == 0x0415 || V_65 -> V_86 == 0x3164 ) &&
( V_9 -> V_65 != V_65 -> V_86 ) )
continue;
if ( V_142 >= V_9 -> V_144 && V_142 <= V_9 -> V_145 )
break;
}
if ( ! ( V_9 -> V_15 & V_28 ) ) {
F_15 ( V_2 , 0x40 , & V_108 ) ;
...
F_32 ( V_2 , V_9 ) ;
return F_40 ( V_2 , V_131 , & V_148 , ( void * ) V_9 , 0 ) ;
}
static int F_41 ( struct V_1 * V_2 )
{
struct V_62 * V_10 = F_42 ( V_2 ) ;
int V_134 ;
V_134 = F_43 ( V_2 ) ;
if ( V_134 )
return V_134 ;
