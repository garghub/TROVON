...
F_52 ( V_32 , V_81 , V_80 , 0 , 0 , V_53 , 0 ) ;
else
F_53 ( V_32 , V_81 , 0 , 0 , V_53 , 0 ) ;
F_54 ( V_35 ) ;
}
...
if ( V_35 -> V_93 )
goto error;
V_38 = F_56 ( sizeof( * V_38 ) , V_94 ) ;
if ( ! V_38 )
return - V_50 ;
V_2 = F_57 ( V_35 -> V_92 -> V_95 , 0 , 0 ) ;
if ( F_58 ( V_2 ) )
goto error;
V_38 -> V_2 = V_2 ;
if ( F_59 ( V_2 , V_35 -> V_92 -> V_96 ,
( V_35 -> V_92 -> V_97 + 7 ) / 8 ) )
goto error;
V_91 = F_60 ( V_35 -> V_92 -> V_95 , 0 ) ;
F_61 ( ! V_91 ) ;
if ( V_91 -> V_98 . V_99 . V_100 / 8 !=
F_2 ( V_2 ) ) {
F_62 ( L_1 ,
V_101 , V_35 -> V_92 -> V_95 ,
F_2 ( V_2 ) ,
V_91 -> V_98 . V_99 . V_100 / 8 ) ;
goto error;
}
V_38 -> V_76 = V_91 -> V_98 . V_99 . V_100 / 8 ;
V_38 -> V_43 = V_35 -> V_92 -> V_102 / 8 ;
F_61 ( V_38 -> V_43 > V_103 ) ;
if ( V_35 -> V_56 . V_57 & V_58 )
V_35 -> V_56 . V_104 = F_29 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
else
V_35 -> V_56 . V_104 = F_30 ( sizeof( struct V_40 ) +
V_38 -> V_43 ) ;
if ( V_35 -> V_56 . V_74 == V_75 )
V_35 -> V_56 . V_104 += sizeof( struct V_13 ) ;
V_35 -> V_33 = V_38 ;
return 0 ;
error:
if ( V_38 ) {
