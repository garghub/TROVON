...
V_5 -> V_22 . V_133 != V_130 -> V_134 )
return 0 ;
if ( V_130 -> V_131 & V_135 &&
V_5 -> V_22 . V_136 != V_130 -> V_137 )
return 0 ;
...
if ( ! ( V_42 & V_116 ) &&
F_114 ( F_4 ( V_5 ) -> V_141 , V_142 ) )
return 0 ;
if ( V_130 ) {
if ( ! F_108 ( V_5 , V_130 ) )
return 0 ;
if ( V_130 -> V_131 & V_143 &&
F_115 ( V_5 ) < V_130 -> V_144 )
return 0 ;
}
V_140 = F_116 ( V_5 -> V_14 , V_5 , true ) ;
