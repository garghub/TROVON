...
int error ;
error = V_2 -> V_61 -> V_74 ( V_34 ) ;
F_52 ( V_2 -> V_61 -> V_74 , error ) ;
if ( error )
return error ;
}
if ( ! V_33 -> V_54 )
...
if ( V_61 -> V_78 ) {
int error ;
error = V_61 -> V_78 ( V_34 ) ;
F_52 ( V_61 -> V_78 , error ) ;
if ( error )
return error ;
}
V_67:
...
struct V_22 * V_2 = V_34 -> V_20 ;
if ( F_63 ( F_30 ( V_34 ) ) )
return F_54 ( V_34 , V_77 ) ;
if ( ! V_2 || ! V_2 -> V_61 )
return 0 ;
if ( V_2 -> V_61 -> V_79 ) {
int error ;
error = V_2 -> V_61 -> V_79 ( V_34 ) ;
F_52 ( V_2 -> V_61 -> V_79 , error ) ;
if ( error )
return error ;
}
...
int F_86 ( struct V_1 * V_2 , struct V_89 * V_90 ,
const char * V_91 )
{
...
static int F_96 ( struct V_4 * V_34 , struct V_102 * V_103 )
{
struct V_33 * V_104 ;
if ( ! V_34 )
return - V_32 ;
...
if ( ! V_104 )
return - V_32 ;
if ( F_97 ( V_103 , L_6 , V_104 -> V_7 ) )
return - V_14 ;
if ( F_97 ( V_103 , L_7 , V_104 -> V_3 , V_104 -> V_4 ) )
return - V_14 ;
if ( F_97 ( V_103 , L_8 , V_104 -> V_105 ,
V_104 -> V_106 ) )
return - V_14 ;
if ( F_97 ( V_103 , L_9 , F_98 ( V_104 ) ) )
return - V_14 ;
if ( F_97 ( V_103 , L_10 ,
V_104 -> V_3 , V_104 -> V_4 ,
V_104 -> V_105 , V_104 -> V_106 ,
( V_107 ) ( V_104 -> V_7 >> 16 ) , ( V_107 ) ( V_104 -> V_7 >> 8 ) ,
( V_107 ) ( V_104 -> V_7 ) ) )
return - V_14 ;
return 0 ;
}
