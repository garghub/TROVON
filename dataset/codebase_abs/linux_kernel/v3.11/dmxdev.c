...
V_12 = V_28 -> V_17 -> V_131 ( V_28 -> V_17 , & V_94 -> V_105 ,
F_40 ) ;
if ( V_12 < 0 )
return V_12 ;
V_123 = V_94 -> V_105 ;
V_123 -> V_29 = V_87 ;
V_12 = V_123 -> V_132 ( V_123 , V_94 -> V_108 , V_120 , V_122 , 32768 , V_77 ) ;
if ( V_12 < 0 ) {
V_28 -> V_17 -> V_112 ( V_28 -> V_17 , V_123 ) ;
return V_12 ;
}
V_12 = V_123 -> V_106 ( V_123 ) ;
if ( V_12 < 0 ) {
V_28 -> V_17 -> V_112 ( V_28 -> V_17 , V_123 ) ;
return V_12 ;
}
...
struct V_86 * * V_133 = & V_87 -> V_87 . V_75 ;
struct V_134 * * V_135 = & V_87 -> V_94 . V_75 ;
* V_133 = NULL ;
* V_135 = NULL ;
for ( V_107 = 0 ; V_107 < V_28 -> V_109 ; V_107 ++ ) {
if ( V_28 -> V_87 [ V_107 ] . V_66 >= V_69 &&
...
* V_135 = V_28 -> V_87 [ V_107 ] . V_94 . V_75 ;
break;
}
}
if ( ! * V_135 ) {
V_12 = V_28 -> V_17 -> V_136 ( V_28 -> V_17 ,
V_135 ,
F_37 ) ;
if ( V_12 < 0 ) {
F_55 ( L_4 ,
...
V_12 = ( * V_135 ) -> V_132 ( * V_135 , V_73 -> V_108 , 32768 ,
( V_73 -> V_90 & V_137 ) ? 1 : 0 ) ;
if ( V_12 < 0 ) {
F_55 ( L_5 ,
V_31 ) ;
...
V_12 = ( * V_135 ) -> V_138 ( * V_135 , V_133 ) ;
if ( V_12 < 0 ) {
F_44 ( V_87 ) ;
V_87 -> V_94 . V_75 -> V_106 ( * V_135 ) ;
F_3 ( L_6 ) ;
return V_12 ;
}
( * V_133 ) -> V_29 = V_87 ;
memcpy ( & ( ( * V_133 ) -> V_139 [ 3 ] ) ,
& ( V_73 -> V_87 . V_87 [ 1 ] ) , V_140 - 1 ) ;
memcpy ( & ( * V_133 ) -> V_141 [ 3 ] ,
& V_73 -> V_87 . V_142 [ 1 ] , V_140 - 1 ) ;
memcpy ( & ( * V_133 ) -> V_143 [ 3 ] ,
& V_73 -> V_87 . V_144 [ 1 ] , V_140 - 1 ) ;
( * V_133 ) -> V_139 [ 0 ] = V_73 -> V_87 . V_87 [ 0 ] ;
( * V_133 ) -> V_141 [ 0 ] = V_73 -> V_87 . V_142 [ 0 ] ;
( * V_133 ) -> V_143 [ 0 ] = V_73 -> V_87 . V_144 [ 0 ] ;
( * V_133 ) -> V_141 [ 1 ] = 0 ;
( * V_133 ) -> V_141 [ 2 ] = 0 ;
V_87 -> V_10 = 0 ;
...
static inline void F_60 ( T_8 * V_87 )
{
int V_107 ;
for ( V_107 = 0 ; V_107 < V_140 ; V_107 ++ )
V_87 -> V_144 [ V_107 ] ^= 0xff ;
}
...
return - V_53 ;
V_94 = F_62 ( sizeof( struct V_100 ) , V_147 ) ;
if ( V_94 == NULL )
return - V_46 ;
V_94 -> V_108 = V_108 ;
...
{
F_3 ( L_7 ,
V_31 , V_74 -> V_108 , V_74 -> V_90 , V_74 -> V_77 ) ;
F_45 ( V_65 ) ;
V_65 -> type = V_102 ;
...
static T_3 F_68 ( struct V_64 * V_149 ,
...
if ( F_69 ( V_149 -> V_153 - V_149 -> V_10 , V_2 , V_150 ) )
return - V_154 ;
V_2 += V_150 ;
V_152 = V_150 ;
V_8 -= V_150 ;
...
if ( V_149 -> V_10 > - 3 )
return V_152 ;
V_149 -> V_10 = ( ( V_149 -> V_153 [ 1 ] << 8 ) | V_149 -> V_153 [ 2 ] ) & 0xfff ;
if ( ! V_8 )
return V_152 ;
}
if ( V_8 > V_149 -> V_10 )
...
unsigned long V_157 = ( unsigned long ) V_156 ;
int V_12 = 0 ;
if ( F_15 ( & V_28 -> V_32 ) )
return - V_33 ;
switch ( V_155 ) {
...
V_28 -> V_17 -> V_164 ( V_28 -> V_17 , V_156 ) ;
break;
case V_165 :
if ( ! V_28 -> V_17 -> V_166 ) {
V_12 = - V_53 ;
...
V_12 = V_28 -> V_17 -> V_166 ( V_28 -> V_17 , V_156 ) ;
break;
case V_167 :
if ( ! V_28 -> V_17 -> V_168 ) {
V_12 = - V_53 ;
...
V_12 = V_28 -> V_17 -> V_168 ( V_28 -> V_17 , V_156 ) ;
break;
case V_169 :
if ( ! V_28 -> V_17 -> V_170 ) {
V_12 = - V_53 ;
...
V_12 = V_28 -> V_17 -> V_170 ( V_28 -> V_17 ,
( (struct V_171 * ) V_156 ) -> V_172 ,
& ( (struct V_171 * ) V_156 ) -> V_173 ,
& ( (struct V_171 * ) V_156 ) -> V_174 ) ;
break;
case V_175 :
if ( F_15 ( & V_65 -> V_32 ) ) {
V_12 = - V_33 ;
...
static long F_72 ( struct V_24 * V_24 , unsigned int V_155 ,
unsigned long V_157 )
{
return F_73 ( V_24 , V_155 , V_157 , F_71 ) ;
}
static unsigned int F_74 ( struct V_24 * V_24 , T_9 * V_177 )
{
struct V_64 * V_65 = V_24 -> V_27 ;
unsigned int V_142 = 0 ;
if ( ! V_65 )
return - V_53 ;
F_75 ( V_24 , & V_65 -> V_68 . V_14 , V_177 ) ;
if ( V_65 -> V_66 != V_69 &&
V_65 -> V_66 != V_92 &&
V_65 -> V_66 != V_71 )
return 0 ;
if ( V_65 -> V_68 . error )
V_142 |= ( V_178 | V_179 | V_180 | V_181 ) ;
if ( ! F_7 ( & V_65 -> V_68 ) )
V_142 |= ( V_178 | V_179 | V_180 ) ;
return V_142 ;
}
...
unsigned int V_155 , unsigned long V_157 )
{
return F_73 ( V_24 , V_155 , V_157 , F_77 ) ;
}
static unsigned int F_79 ( struct V_24 * V_24 , T_9 * V_177 )
{
struct V_25 * V_26 = V_24 -> V_27 ;
struct V_28 * V_28 = V_26 -> V_29 ;
unsigned int V_142 = 0 ;
F_3 ( L_2 , V_31 ) ;
F_75 ( V_24 , & V_28 -> V_47 . V_14 , V_177 ) ;
if ( ( V_24 -> V_35 & V_36 ) == V_41 ) {
if ( V_28 -> V_47 . error )
V_142 |= ( V_178 | V_179 | V_180 | V_181 ) ;
if ( ! F_7 ( & V_28 -> V_47 ) )
...
V_142 |= ( V_182 | V_183 | V_180 ) ;
return V_142 ;
}
int F_80 ( struct V_28 * V_28 , struct V_184 * V_184 )
{
int V_107 ;
if ( V_28 -> V_17 -> V_185 ( V_28 -> V_17 ) < 0 )
return - V_186 ;
...
F_82 ( V_184 , & V_28 -> V_26 , & V_187 , V_28 ,
V_188 ) ;
F_82 ( V_184 , & V_28 -> V_189 , & V_190 ,
V_28 , V_191 ) ;
...
if ( V_28 -> V_189 -> V_56 > 1 ) {
F_84 ( V_28 -> V_189 -> V_59 ,
V_28 -> V_189 -> V_56 == 1 ) ;
}
F_85 ( V_28 -> V_26 ) ;
F_85 ( V_28 -> V_189 ) ;
