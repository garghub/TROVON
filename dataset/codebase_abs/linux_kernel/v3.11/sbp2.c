...
static int F_90 ( struct V_148 * V_9 , const struct V_149 * V_150 )
{
...
if ( V_10 -> V_151 )
return - V_152 ;
if ( F_91 ( V_10 -> V_15 -> V_10 ) > V_153 )
F_92 ( F_93 ( V_10 -> V_15 -> V_10 ,
V_153 ) ) ;
V_88 = F_94 ( & V_154 , sizeof( * V_8 ) ) ;
if ( V_88 == NULL )
return - V_61 ;
...
V_8 -> V_9 = V_9 ;
F_30 ( & V_8 -> V_121 ) ;
V_8 -> V_123 = ( T_2 ) V_10 -> V_155 [ 3 ] << 32 | V_10 -> V_155 [ 4 ] ;
if ( F_96 ( V_10 ) < 0 )
goto V_156;
V_88 -> V_157 = V_158 ;
...
V_10 -> V_15 -> V_10 ) < 0 )
goto V_156;
V_8 -> V_135 = ( ( V_9 -> V_124 - V_10 -> V_155 ) * 4
+ V_159 ) & 0xffffff ;
V_131 = V_160 ;
V_130 = V_160 ;
...
V_8 -> V_162 = F_98 ( V_10 -> V_46 + 7 , 10U ,
V_10 -> V_15 -> V_163 - 1 ) ;
...
static void F_101 ( struct V_148 * V_9 )
{
...
static void F_99 ( struct V_148 * V_9 )
{
struct V_6 * V_10 = F_4 ( V_9 ) ;
struct V_7 * V_8 = F_102 ( & V_9 -> V_10 ) ;
struct V_1 * V_2 , * V_47 ;
...
F_106 ( V_88 ) ;
F_14 ( & V_9 -> V_10 , L_15 , V_88 -> V_164 ) ;
F_100 ( V_88 ) ;
}
static void F_107 ( struct V_10 * V_165 ,
struct V_166 * V_13 )
{
F_108 ( V_13 -> V_167 ) ;
if ( V_13 -> V_17 . V_67 & F_25 ( V_168 ) )
F_52 ( V_165 , V_13 -> V_169 ,
sizeof( V_13 -> V_170 ) , V_75 ) ;
}
static unsigned int F_109 ( T_6 * V_26 , T_6 * V_171 )
{
int V_172 ;
...
if ( V_182 == V_181 << 16 && F_112 ( * V_27 ) > 1 )
V_182 = F_109 ( F_113 ( * V_27 ) ,
V_13 -> V_167 -> V_188 ) ;
} else {
V_182 = V_185 << 16 ;
F_59 ( V_13 -> V_2 ) ;
...
V_13 -> V_167 -> V_182 = V_182 ;
V_13 -> V_167 -> V_189 ( V_13 -> V_167 ) ;
}
static int F_114 ( struct V_166 * V_13 ,
struct V_6 * V_10 , struct V_1 * V_2 )
{
struct V_190 * V_191 = F_115 ( V_13 -> V_167 ) ;
int V_142 , V_192 ;
V_192 = F_116 ( V_13 -> V_167 ) ;
if ( V_192 <= 0 )
goto V_193;
if ( V_192 == 1 ) {
...
F_25 ( F_117 ( V_191 ) ) ;
V_13 -> V_17 . V_67 |=
F_25 ( F_118 ( F_119 ( V_191 ) ) ) ;
return 0 ;
}
F_120 (sg, sg, n, i) {
V_13 -> V_170 [ V_142 ] . V_43 = F_25 ( F_119 ( V_191 ) << 16 ) ;
V_13 -> V_170 [ V_142 ] . V_44 = F_25 ( F_117 ( V_191 ) ) ;
}
V_13 -> V_169 =
...
struct V_196 * V_167 )
{
struct V_1 * V_2 = V_167 -> V_10 -> V_89 ;
struct V_6 * V_10 = F_3 ( V_2 -> V_8 ) ;
struct V_166 * V_13 ;
int V_21 , V_50 = V_197 ;
if ( V_167 -> V_198 == V_199 ) {
F_22 ( F_6 ( V_2 ) , L_16 ) ;
V_167 -> V_182 = V_174 << 16 ;
V_167 -> V_189 ( V_167 ) ;
return 0 ;
}
...
V_13 -> V_2 = V_2 ;
V_13 -> V_167 = V_167 ;
V_13 -> V_17 . V_47 . V_43 = F_25 ( V_200 ) ;
V_13 -> V_17 . V_67 = F_25 (
F_122 ( V_2 -> V_8 -> V_162 ) |
F_123 ( V_10 -> V_46 ) |
V_201 ) ;
...
V_21 = V_10 -> V_21 ;
F_68 () ;
if ( F_124 ( V_167 ) && F_114 ( V_13 , V_10 , V_2 ) < 0 )
goto V_79;
memcpy ( V_13 -> V_17 . V_203 , V_167 -> V_204 , V_167 -> V_205 ) ;
...
return - V_207 ;
V_101 -> V_208 = 1 ;
F_126 ( V_101 -> V_209 , 4 - 1 ) ;
if ( V_2 -> V_8 -> V_111 & V_210 )
V_101 -> V_211 = 36 ;
return 0 ;
}
...
V_2 -> V_8 -> V_111 & V_217 )
V_101 -> V_218 = 1 ;
if ( V_2 -> V_8 -> V_111 & V_219 )
V_101 -> V_220 = 1 ;
if ( V_2 -> V_8 -> V_111 & V_221 )
V_101 -> V_222 = 1 ;
if ( V_2 -> V_8 -> V_111 & V_223 )
F_128 ( V_101 -> V_209 , 128 * 1024 / 512 ) ;
return 0 ;
}
static int F_129 ( struct V_196 * V_167 )
{
struct V_1 * V_2 = V_167 -> V_10 -> V_89 ;
F_14 ( F_6 ( V_2 ) , L_17 ) ;
F_53 ( V_2 ) ;
...
static T_7 F_130 ( struct V_10 * V_225 ,
struct V_226 * V_227 , char * V_228 )
{
struct V_100 * V_101 = F_131 ( V_225 ) ;
struct V_1 * V_2 ;
if ( ! V_101 )
return 0 ;
V_2 = V_101 -> V_89 ;
return sprintf ( V_228 , L_18 ,
