...
if ( ! F_184 ( V_178 , error ) )
return - V_182 ;
if ( F_192 ( F_187 ( V_178 ) , 10 , & V_121 ) || ! V_121 ||
V_121 < V_190 ||
V_121 & ( V_190 - 1 ) ) {
* error = L_14 ;
return - V_182 ;
}
if ( V_121 > V_176 -> V_187 ) {
* error = L_15 ;
return - V_182 ;
}
V_176 -> V_191 = V_121 ;
...
static void F_193 ( struct V_192 * V_193 )
{
V_193 -> V_194 = V_195 ;
V_193 -> V_62 = false ;
}
...
unsigned V_179 ;
const char * V_198 ;
struct V_192 * V_193 = & V_176 -> V_61 ;
F_193 ( V_193 ) ;
V_21 = F_195 ( V_197 , V_178 , & V_179 , error ) ;
if ( V_21 )
return - V_182 ;
while ( V_179 -- ) {
V_198 = F_187 ( V_178 ) ;
if ( ! strcasecmp ( V_198 , L_17 ) )
V_193 -> V_62 = false ;
else if ( ! strcasecmp ( V_198 , L_18 ) )
V_193 -> V_62 = true ;
else {
* error = L_19 ;
return - V_182 ;
...
if ( ! F_184 ( V_178 , error ) )
return - V_182 ;
V_176 -> V_199 = F_187 ( V_178 ) ;
V_21 = F_195 ( V_197 , V_178 , & V_176 -> V_200 , error ) ;
if ( V_21 )
return - V_182 ;
V_176 -> V_201 = ( const char * * ) V_178 -> V_202 ;
F_197 ( V_178 , V_176 -> V_200 ) ;
return 0 ;
}
static int F_198 ( struct V_175 * V_176 , int V_179 , char * * V_202 ,
char * * error )
{
int V_21 ;
struct V_177 V_178 ;
...
static int F_199 ( struct V_6 * V_6 , const char * V_24 , const char * V_203 )
{
unsigned long V_121 ;
if ( ! strcasecmp ( V_24 , L_21 ) ) {
if ( F_192 ( V_203 , 10 , & V_121 ) )
return - V_182 ;
V_6 -> V_130 = V_121 ;
return 0 ;
}
...
static int F_200 ( struct V_6 * V_6 , const char * V_24 , const char * V_203 )
{
int V_21 = F_199 ( V_6 , V_24 , V_203 ) ;
if ( V_21 == V_204 )
V_21 = F_201 ( V_6 -> V_38 , V_24 , V_203 ) ;
if ( V_21 )
F_102 ( L_22 , V_24 , V_203 ) ;
return V_21 ;
}
static int F_202 ( struct V_6 * V_6 , int V_179 , const char * * V_202 )
{
int V_21 = 0 ;
if ( V_179 & 1 ) {
F_102 ( L_23 ) ;
...
while ( V_179 ) {
V_21 = F_200 ( V_6 , V_202 [ 0 ] , V_202 [ 1 ] ) ;
if ( V_21 )
break;
V_179 -= 2 ;
V_202 += 2 ;
...
T_9 V_206 )
{
( void ) F_68 ( V_206 , V_44 ) ;
return V_206 > V_207 ;
}
static T_9 F_206 ( T_9 V_208 ,
T_9 V_206 )
{
T_9 V_44 ;
V_44 = F_207 ( V_208 ) ;
if ( V_206 )
while ( F_205 ( V_44 , V_206 ) )
V_44 *= 2 ;
return V_44 ;
}
static int F_208 ( struct V_175 * V_176 , struct V_6 * * V_209 )
{
int V_21 = 0 ;
...
T_6 V_210 ;
struct V_211 * V_52 ;
bool V_212 = V_176 -> V_61 . V_194 == V_195 ;
V_6 = F_209 ( sizeof( * V_6 ) , V_213 ) ;
if ( ! V_6 )
return - V_17 ;
V_6 -> V_39 = V_176 -> V_39 ;
V_39 -> V_172 = V_6 ;
...
V_6 -> V_61 = V_176 -> V_61 ;
V_39 -> V_219 = F_61 ( V_6 ) ;
V_6 -> V_165 . V_220 = F_169 ;
F_210 ( V_39 -> V_40 , & V_6 -> V_165 ) ;
V_6 -> V_168 = V_176 -> V_168 ;
V_6 -> V_72 = V_176 -> V_72 ;
V_6 -> V_75 = V_176 -> V_75 ;
V_176 -> V_168 = V_176 -> V_72 = V_176 -> V_75 = NULL ;
V_210 = V_6 -> V_188 = V_176 -> V_188 ;
V_210 = F_41 ( V_210 , V_176 -> V_191 ) ;
V_6 -> V_210 = F_74 ( V_210 ) ;
V_6 -> V_45 = V_176 -> V_191 ;
if ( F_211 ( V_39 , V_6 -> V_45 ) ) {
V_21 = - V_182 ;
goto V_221;
}
if ( V_176 -> V_191 & ( V_176 -> V_191 - 1 ) ) {
T_6 V_205 = V_176 -> V_187 ;
V_6 -> V_41 = - 1 ;
V_205 = F_41 ( V_205 , V_176 -> V_191 ) ;
V_6 -> V_205 = F_34 ( V_205 ) ;
} else {
V_6 -> V_41 = F_212 ( V_176 -> V_191 ) ;
V_6 -> V_205 = F_34 ( V_176 -> V_187 >> V_6 -> V_41 ) ;
}
V_21 = F_203 ( V_6 , V_176 , error ) ;
if ( V_21 )
goto V_221;
V_6 -> V_222 = V_176 -> V_200 ;
V_6 -> V_130 = V_223 ;
V_21 = F_202 ( V_6 , V_176 -> V_200 , V_176 -> V_201 ) ;
if ( V_21 ) {
* error = L_25 ;
goto V_221;
}
...
V_21 = - V_17 ;
V_6 -> V_37 = 0 ;
V_6 -> V_35 = F_3 ( F_31 ( V_6 -> V_205 ) ) ;
if ( ! V_6 -> V_35 ) {
* error = L_27 ;
goto V_221;
}
F_5 ( V_6 -> V_35 , F_31 ( V_6 -> V_205 ) ) ;
V_6 -> V_44 =
F_206 ( V_6 -> V_45 ,
V_6 -> V_188 ) ;
V_6 -> V_224 = F_43 ( V_6 , V_6 -> V_210 ) ;
V_6 -> V_50 = F_3 ( F_49 ( V_6 -> V_224 ) ) ;
if ( ! V_6 -> V_50 ) {
* error = L_28 ;
goto V_221;
}
F_5 ( V_6 -> V_50 , F_49 ( V_6 -> V_224 ) ) ;
V_6 -> V_116 = F_219 ( & V_225 ) ;
if ( F_215 ( V_6 -> V_116 ) ) {
* error = L_29 ;
V_21 = F_216 ( V_6 -> V_116 ) ;
goto V_221;
}
V_6 -> V_7 = F_220 ( L_30 V_226 , V_227 ) ;
if ( ! V_6 -> V_7 ) {
* error = L_31 ;
goto V_221;
}
...
static int F_226 ( struct V_6 * V_6 , int V_179 , const char * * V_202 )
{
unsigned V_166 ;
const char * * V_234 ;
V_234 = F_227 ( V_179 , sizeof( * V_234 ) , V_213 ) ;
if ( ! V_234 )
return - V_17 ;
for ( V_166 = 0 ; V_166 < V_179 ; V_166 ++ ) {
V_234 [ V_166 ] = F_228 ( V_202 [ V_166 ] , V_213 ) ;
if ( ! V_234 [ V_166 ] ) {
while ( V_166 -- )
F_179 ( V_234 [ V_166 ] ) ;
F_179 ( V_234 ) ;
...
static int F_229 ( struct V_171 * V_39 , unsigned V_179 , char * * V_202 )
{
int V_21 = - V_182 ;
struct V_175 * V_176 ;
struct V_6 * V_6 = NULL ;
V_176 = F_209 ( sizeof( * V_176 ) , V_213 ) ;
if ( ! V_176 ) {
V_39 -> error = L_35 ;
return - V_17 ;
}
V_176 -> V_39 = V_39 ;
V_21 = F_198 ( V_176 , V_179 , V_202 , & V_39 -> error ) ;
if ( V_21 )
goto V_235;
V_21 = F_208 ( V_176 , & V_6 ) ;
if ( V_21 )
goto V_235;
V_21 = F_226 ( V_6 , V_179 - 3 , ( const char * * ) V_202 + 3 ) ;
if ( V_21 ) {
F_170 ( V_6 ) ;
goto V_235;
}
...
{
unsigned V_166 , V_21 ;
for ( V_166 = 0 ; V_166 < F_31 ( V_6 -> V_205 ) ; V_166 ++ ) {
...
for ( V_166 = 0 ; V_166 < F_49 ( V_6 -> V_224 ) ; V_166 ++ ) {
...
return F_239 ( V_6 -> V_52 , V_36 , V_238 ) ;
}
...
if ( V_241 )
F_236 ( L_43 ) ;
V_242 = F_140 ( V_6 -> V_52 , ! V_239 && ! V_240 && ! V_241 ) ;
if ( V_242 )
F_236 ( L_44 ) ;
return ! V_239 && ! V_240 && ! V_241 && ! V_242 ;
}
...
bool V_243 , T_7 V_238 , bool V_244 )
{
int V_21 ;
struct V_6 * V_6 = V_109 ;
V_21 = F_246 ( V_6 -> V_38 , V_22 , V_36 , V_238 , V_244 ) ;
if ( V_21 )
return V_21 ;
if ( V_243 )
F_32 ( V_6 , V_22 , V_36 ) ;
...
int V_21 = 0 ;
struct V_6 * V_6 = V_39 -> V_172 ;
T_9 V_247 = F_181 ( V_6 -> V_75 ) ;
( void ) F_68 ( V_247 , V_6 -> V_45 ) ;
if ( F_31 ( V_6 -> V_205 ) != V_247 || ! V_6 -> V_231 ) {
V_6 -> V_205 = F_34 ( V_247 ) ;
V_21 = F_249 ( V_6 -> V_52 , V_6 -> V_205 ) ;
if ( V_21 ) {
F_236 ( L_45 ) ;
return V_21 ;
}
...
unsigned V_248 , char * V_209 , unsigned V_249 )
{
int V_21 = 0 ;
unsigned V_166 ;
T_11 V_250 = 0 ;
...
V_21 = F_256 ( V_6 -> V_52 , & V_252 ) ;
if ( V_21 ) {
F_236 ( L_50 ) ;
goto V_87;
}
V_254 = F_257 ( V_6 -> V_38 ) ;
F_258 ( L_51 ,
( unsigned long long ) ( V_252 - V_251 ) ,
...
if ( V_250 < V_249 ) {
V_21 = F_259 ( V_6 -> V_38 , V_209 + V_250 , V_249 - V_250 ) ;
if ( V_21 )
F_236 ( L_55 , V_21 ) ;
}
break;
case V_257 :
F_260 ( V_253 , V_6 -> V_168 -> V_73 -> V_258 ) ;
F_258 ( L_56 , V_253 ) ;
F_260 ( V_253 , V_6 -> V_75 -> V_73 -> V_258 ) ;
F_258 ( L_56 , V_253 ) ;
F_260 ( V_253 , V_6 -> V_72 -> V_73 -> V_258 ) ;
F_258 ( L_57 , V_253 ) ;
...
static int F_261 ( struct V_171 * V_39 , unsigned V_179 , char * * V_202 )
{
struct V_6 * V_6 = V_39 -> V_172 ;
if ( V_179 != 2 )
return - V_182 ;
return F_200 ( V_6 , V_202 [ 0 ] , V_202 [ 1 ] ) ;
}
static int F_262 ( struct V_171 * V_39 ,
T_12 F_110 , void * V_259 )
{
int V_21 = 0 ;
struct V_6 * V_6 = V_39 -> V_172 ;
V_21 = F_110 ( V_39 , V_6 -> V_75 , 0 , F_181 ( V_6 -> V_75 ) , V_259 ) ;
if ( ! V_21 )
V_21 = F_110 ( V_39 , V_6 -> V_72 , 0 , V_39 -> V_189 , V_259 ) ;
return V_21 ;
}
...
if ( ! V_161 -> V_265 )
return V_264 ;
V_261 -> V_71 = V_6 -> V_72 -> V_73 ;
return F_264 ( V_264 , V_161 -> V_265 ( V_161 , V_261 , V_263 ) ) ;
}
static void F_265 ( struct V_6 * V_6 , struct V_266 * V_267 )
{
V_267 -> V_268 = V_6 -> V_44 * 1024 ;
V_267 -> V_269 = V_6 -> V_44 << V_174 ;
}
static void F_266 ( struct V_171 * V_39 , struct V_266 * V_267 )
{
struct V_6 * V_6 = V_39 -> V_172 ;
F_267 ( V_267 , 0 ) ;
F_268 ( V_267 , V_6 -> V_45 << V_174 ) ;
F_265 ( V_6 , V_267 ) ;
}
static int T_13 F_269 ( void )
{
int V_21 ;
V_21 = F_270 ( & V_270 ) ;
if ( V_21 ) {
