...
static int F_37 ( struct V_75 * V_8 )
{
struct V_1 * V_1 = F_23 ( V_8 ) ;
F_24 ( V_1 -> V_8 , L_54 ) ;
F_35 ( V_1 -> V_13 ) ;
...
int F_38 ( struct V_75 * V_8 )
{
const struct V_81 * V_82 = F_39 ( V_83 , V_8 ) ;
if ( V_82 )
...
{
int V_2 , V_54 ;
V_1 -> V_5 . V_84 = F_41 ( V_1 -> V_8 -> V_85 ,
L_55 , 0 ) ;
if ( V_1 -> V_5 . V_84 < 0 )
V_1 -> V_5 . V_84 = 0 ;
V_1 -> V_5 . V_86 = F_41 ( V_1 -> V_8 -> V_85 ,
L_56 , 0 ) ;
if ( V_1 -> V_5 . V_86 < 0 )
V_1 -> V_5 . V_86 = 0 ;
V_2 = F_42 ( V_1 -> V_8 -> V_85 ,
L_57 ,
V_1 -> V_5 . V_87 ,
F_43 ( V_1 -> V_5 . V_87 ) ) ;
if ( V_2 >= 0 ) {
for ( V_54 = 0 ; V_54 < F_43 ( V_1 -> V_5 . V_87 ) ; V_54 ++ ) {
if ( V_1 -> V_5 . V_87 [ V_54 ] > 0xffff )
V_1 -> V_5 . V_87 [ V_54 ] = 0 ;
if ( V_1 -> V_5 . V_87 [ V_54 ] == 0 )
...
case V_89 :
case V_90 :
for ( V_54 = 0 ; V_54 < F_43 ( V_91 ) ; V_54 ++ )
V_1 -> V_92 [ V_54 ] . V_93
= V_91 [ V_54 ] ;
V_1 -> V_94 = F_43 ( V_91 ) ;
break;
...
V_2 = F_49 ( V_1 -> V_8 , - 1 , V_96 ,
F_43 ( V_96 ) , NULL , 0 , NULL ) ;
if ( V_2 != 0 ) {
F_10 ( V_8 , L_60 , V_2 ) ;
return V_2 ;
}
V_2 = F_50 ( V_8 , V_1 -> V_94 ,
V_1 -> V_92 ) ;
if ( V_2 != 0 ) {
F_10 ( V_8 , L_61 ,
V_2 ) ;
...
F_60 ( V_8 , L_81 , V_88 , V_1 -> V_104 + 'A' ) ;
if ( F_45 ) {
V_2 = F_45 ( V_1 ) ;
if ( V_2 != 0 ) {
F_10 ( V_1 -> V_8 , L_46 ,
...
switch ( V_1 -> type ) {
case V_77 :
V_2 = F_49 ( V_1 -> V_8 , - 1 , V_151 ,
F_43 ( V_151 ) , NULL , 0 , NULL ) ;
break;
case V_89 :
