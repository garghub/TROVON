...
void F_22 ( const char * V_29 , unsigned int line ,
const char * V_30 , struct V_31 * V_32 ,
T_1 * V_1 , int V_18 )
{
char V_33 [ 16 ] ;
...
if ( V_38 && F_48 ( V_38 ) ) {
F_49 ( V_32 ) ;
if ( F_50 ( V_32 ) && ! F_51 ( V_32 ) ) {
struct V_44 * V_45 ;
V_45 = F_7 ( V_38 -> V_41 ) -> V_46 ;
V_45 -> V_47 =
F_52 ( V_32 -> V_48 ) ;
F_53 ( V_38 , V_21 , line ,
V_32 -> V_48 ,
...
int F_54 ( const char * V_21 , unsigned int line ,
T_1 * V_1 , struct V_6 * V_7 )
{
struct V_31 * V_32 = F_7 ( V_7 ) -> V_50 ;
int V_18 = 0 ;
F_55 ( V_7 ) ;
if ( F_15 ( V_1 ) ) {
V_18 = F_44 ( V_1 , V_32 ) ;
