...
static int F_49 ( struct V_60 * V_21 , T_3 V_80 )
{
struct V_18 * V_19 = F_48 ( V_21 ) ;
struct V_25 * V_26 = F_10 ( V_19 ) ;
if ( F_50 ( V_81 , V_26 -> V_82 ) )
F_51 ( 5 ) ;
V_26 -> V_82 = V_81 ;
F_1 ( 0 ) ;
V_19 -> V_83 = V_84 ;
V_21 -> V_21 . V_85 . V_86 = V_87 ;
return 0 ;
}
