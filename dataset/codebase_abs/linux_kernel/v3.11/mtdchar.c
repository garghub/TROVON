...
switch ( V_5 -> V_48 ) {
case V_49 :
V_12 = F_67 ( V_7 , V_42 , 4096 ) ;
break;
case V_50 :
V_12 = F_68 ( V_7 , V_42 , 4096 ) ;
break;
default:
V_12 = - V_70 ;
break;
...
if ( V_12 >= 0 ) {
if ( V_114 == V_177 ) {
int V_180 = V_12 / sizeof( struct V_179 ) ;
V_12 = F_29 ( V_109 , & V_180 , sizeof( int ) ) ;
} else
V_12 = F_29 ( V_109 , V_42 , V_12 ) ;
if ( V_12 )
V_12 = - V_57 ;
}
F_20 ( V_42 ) ;
...
return - V_197 ;
#else
return V_199 -> V_207 & V_208 ? 0 : - V_197 ;
#endif
}
