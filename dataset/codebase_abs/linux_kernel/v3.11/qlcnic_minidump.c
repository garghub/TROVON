...
T_1 V_184 ;
char V_185 [ 64 ] ;
char * V_186 [] = { V_185 , NULL } ;
int V_6 , V_14 , V_187 , V_188 , V_189 = 0 ;
T_1 V_190 , V_191 , V_192 , V_193 = 0 ;
struct V_3 * V_4 ;
struct V_112 * V_22 = & V_2 -> V_21 -> V_22 ;
...
F_61 ( V_2 -> V_21 , V_197 , V_2 -> V_198 , L_18 ) ;
for ( V_6 = 2 , V_14 = 1 ; ( V_6 & V_199 ) ; V_6 <<= 1 , V_14 ++ )
if ( V_6 & V_23 -> V_181 )
V_189 += V_23 -> V_200 [ V_14 ] ;
if ( ! V_189 )
return - V_97 ;
V_22 -> V_8 = F_58 ( V_189 ) ;
if ( ! V_22 -> V_8 )
...
V_187 = F_62 ( V_207 ) ;
V_195 = V_207 ;
V_184 = V_23 -> V_208 [ V_2 -> V_21 -> V_71 ] ;
V_23 -> V_38 [ V_209 ] = V_184 ;
V_23 -> V_38 [ V_210 ] = V_21 -> V_71 ;
}
for ( V_6 = 0 ; V_6 < V_192 ; V_6 ++ ) {
V_4 = ( void * ) V_23 + V_190 ;
if ( ! ( V_4 -> V_133 . V_134 & V_23 -> V_181 ) ) {
V_4 -> V_133 . V_135 |= V_136 ;
V_190 += V_4 -> V_133 . V_202 ;
continue;
}
V_188 = 0 ;
while ( V_188 < V_187 ) {
if ( V_4 -> V_133 . type == V_195 [ V_188 ] . V_24 )
break;
V_188 ++ ;
}
if ( V_188 == V_187 ) {
...
V_191 = V_195 [ V_188 ] . F_63 ( V_2 , V_4 , V_5 ) ;
if ( ! F_37 ( & V_2 -> V_33 -> V_34 , V_4 , V_191 ) )
V_4 -> V_133 . V_135 |= V_136 ;
V_193 += V_4 -> V_133 . V_137 ;
V_190 += V_4 -> V_133 . V_202 ;
V_5 = V_22 -> V_8 + V_193 ;
}
if ( V_189 != V_193 ) {
...
V_22 -> V_196 = 1 ;
snprintf ( V_185 , sizeof( V_185 ) , L_21 ,
V_2 -> V_198 -> V_211 ) ;
F_7 ( & V_2 -> V_33 -> V_34 , L_22 ,
V_2 -> V_198 -> V_211 , V_22 -> V_62 ) ;
F_64 ( & V_2 -> V_33 -> V_34 . V_212 , V_213 , V_186 ) ;
return 0 ;
}
error:
if ( V_22 -> V_132 )
...
struct V_216 * V_33 = V_2 -> V_33 ;
V_214 = V_2 -> V_205 ;
V_215 = F_66 ( V_2 ) ;
if ( V_22 -> V_23 == NULL || V_215 > V_214 ) {
if ( V_22 -> V_23 )
F_59 ( V_22 -> V_23 ) ;
if ( ! F_57 ( V_2 ) )
F_7 ( & V_33 -> V_34 , L_23 ) ;
