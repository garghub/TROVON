...
static void F_38 ( struct V_29 * V_29 , struct V_3 * V_4 , int V_39 )
{
struct V_40 * V_32 = F_39 ( V_29 ) ;
if ( V_39 == 0 ) {
F_40 ( V_4 ) ;
V_32 -> V_41 = 0 ;
} else {
F_41 ( V_4 ) ;
if ( V_39 == - V_42 )
F_42 ( V_43 , & V_29 -> V_44 -> V_45 ) ;
else
F_42 ( V_46 , & V_29 -> V_44 -> V_45 ) ;
...
struct V_29 * V_29 = F_24 ( V_3 -> V_49 ) ;
V_37 ;
F_2 ( F_15 ( V_4 ) ) ;
F_46 ( V_50 , V_7 , V_3 , L_1 , V_39 ) ;
if ( V_2 -> V_22 )
F_47 ( F_48 ( V_29 ) , 1 ) ;
if ( V_39 == 0 ) {
if ( ! V_2 -> V_22 )
...
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
struct V_10 * V_52 = V_9 -> V_12 ;
struct V_3 * V_4 = V_2 -> V_5 ;
V_37 ;
F_2 ( F_51 ( V_52 -> V_51 != NULL , F_15 ( V_4 ) ) ) ;
F_2 ( F_9 ( V_4 ) ) ;
F_46 ( V_50 , V_7 , V_52 , L_2 , V_39 ) ;
V_2 -> V_53 = 0 ;
F_25 ( F_26 ( V_9 -> V_33 ) , V_2 ) ;
if ( V_52 -> V_51 == NULL )
F_38 ( F_24 ( V_52 -> V_49 ) , V_4 , V_39 ) ;
F_52 ( V_4 ) ;
EXIT ;
}
...
F_37 ( F_26 ( V_9 -> V_33 ) ,
F_5 ( V_9 ) ) ;
F_46 ( V_50 , V_7 , V_52 , L_3 ) ;
} else if ( V_52 -> V_55 == V_57 ) {
V_54 = - V_38 ;
} else {
F_55 ( V_58 , V_7 , V_52 , L_4 ,
V_52 -> V_55 ) ;
F_56 () ;
}
F_10 ( V_4 ) ;
...
void * V_59 , T_2 V_60 )
{
struct V_1 * V_61 = F_5 ( V_9 ) ;
struct V_3 * V_4 = V_61 -> V_5 ;
(* V_60)( V_7 , V_59 , V_62 L_5
L_6 ,
V_61 , V_61 -> V_22 , V_61 -> V_23 ,
V_61 -> V_53 , V_4 ) ;
if ( V_4 != NULL ) {
(* V_60)( V_7 , V_59 , L_7 ,
( long ) V_4 -> V_45 , F_58 ( V_4 ) ,
F_59 ( V_4 ) , V_4 -> V_11 ,
F_60 ( V_4 ) ,
F_61 ( & V_4 -> V_63 ) ? L_8 : L_9 ) ;
}
(* V_60)( V_7 , V_59 , L_10 ) ;
return 0 ;
}
...
{
struct V_1 * V_2 = F_5 ( V_9 ) ;
struct V_10 * V_66 = V_9 -> V_12 ;
struct V_40 * V_67 = F_26 ( V_66 -> V_49 ) ;
F_1 ( V_2 ) ;
F_2 ( ! F_63 ( & V_67 -> V_68 -> V_64 ) ) ;
V_67 -> V_69 -- ;
}
...
F_81 ( V_3 , & V_21 -> V_73 , V_32 ,
& V_74 ) ;
} else {
struct V_40 * V_67 = F_26 ( V_32 ) ;
F_2 ( ! F_63 ( & V_67 -> V_68 -> V_64 ) ) ;
F_81 ( V_3 , & V_21 -> V_73 , V_32 ,
& V_75 ) ;
V_67 -> V_69 ++ ;
