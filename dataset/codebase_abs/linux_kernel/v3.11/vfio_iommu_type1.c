...
V_10 = V_74 -> V_10 ;
V_5 = V_74 -> V_5 ;
while ( ( V_63 = F_1 ( V_3 , V_10 , V_5 ) ) ) {
int V_83 = F_46 ( V_3 , V_10 ,
& V_5 , V_63 ) ;
if ( F_44 ( V_83 || ! V_5 ) )
break;
}
...
static int F_56 ( void * V_84 ,
struct V_85 * V_85 )
{
struct V_2 * V_3 = V_84 ;
struct V_86 * V_87 , * V_63 ;
int V_37 ;
V_87 = F_48 ( sizeof( * V_87 ) , V_26 ) ;
if ( ! V_87 )
return - V_52 ;
F_51 ( & V_3 -> V_72 ) ;
...
V_87 -> V_85 = V_85 ;
F_59 ( & V_87 -> V_88 , & V_3 -> V_89 ) ;
F_52 ( & V_3 -> V_72 ) ;
return 0 ;
}
static void F_60 ( void * V_84 ,
struct V_85 * V_85 )
{
struct V_2 * V_3 = V_84 ;
struct V_86 * V_87 ;
...
static void * F_63 ( unsigned long V_90 )
{
struct V_2 * V_3 ;
if ( V_90 != V_91 )
return F_64 ( - V_70 ) ;
...
{
struct V_2 * V_3 = V_84 ;
struct V_86 * V_87 , * V_98 ;
struct V_6 * V_7 ;
F_71 (group, group_tmp, &iommu->group_list, next) {
F_61 ( V_3 -> V_60 , V_87 -> V_85 ) ;
F_62 ( & V_87 -> V_88 ) ;
F_13 ( V_87 ) ;
}
...
static long F_73 ( void * V_84 ,
unsigned int V_99 , unsigned long V_90 )
{
struct V_2 * V_3 = V_84 ;
unsigned long V_100 ;
if ( V_99 == V_101 ) {
...
struct V_103 V_104 ;
V_100 = F_74 ( struct V_103 , V_105 ) ;
if ( F_75 ( & V_104 , ( void V_106 * ) V_90 , V_100 ) )
return - V_38 ;
if ( V_104 . V_107 < V_100 )
return - V_70 ;
V_104 . V_75 = 0 ;
V_104 . V_105 = V_3 -> V_60 -> V_68 -> V_69 ;
return F_76 ( ( void V_106 * ) V_90 , & V_104 , V_100 ) ;
} else if ( V_99 == V_108 ) {
struct V_73 V_74 ;
T_5 V_67 = V_77 |
V_76 ;
V_100 = F_74 ( struct V_73 , V_5 ) ;
if ( F_75 ( & V_74 , ( void V_106 * ) V_90 , V_100 ) )
return - V_38 ;
if ( V_74 . V_107 < V_100 || V_74 . V_75 & ~ V_67 )
return - V_70 ;
return F_55 ( V_3 , & V_74 ) ;
} else if ( V_99 == V_109 ) {
struct V_65 V_66 ;
long V_37 ;
V_100 = F_74 ( struct V_65 , V_5 ) ;
if ( F_75 ( & V_66 , ( void V_106 * ) V_90 , V_100 ) )
return - V_38 ;
if ( V_66 . V_107 < V_100 || V_66 . V_75 )
return - V_70 ;
V_37 = F_49 ( V_3 , & V_66 ) ;
if ( V_37 )
return V_37 ;
return F_76 ( ( void V_106 * ) V_90 , & V_66 , V_100 ) ;
}
return - V_110 ;
}
