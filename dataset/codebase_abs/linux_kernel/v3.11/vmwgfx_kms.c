...
if ( V_65 ) {
struct V_71 * V_72 = F_30 ( V_64 ) -> V_72 ;
V_47 = F_31 ( V_25 , V_72 ,
V_65 , & V_68 , & V_40 ) ;
if ( V_47 ) {
F_13 ( L_3 , V_47 ) ;
