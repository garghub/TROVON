...
F_12 ( V_2 ) ;
for ( V_48 = 0 ; V_48 < V_46 -> V_55 ; V_48 ++ ) {
for ( V_49 = 0 ; V_49 < F_37 ( V_56 ) ; V_49 ++ ) {
if ( ( V_46 -> V_57 [ V_48 ] . V_44 == V_56 [ V_49 ] . V_44 ) &&
! strcmp ( V_46 -> V_57 [ V_48 ] . V_58 ,
V_56 [ V_49 ] . V_58 ) ) {
V_56 [ V_49 ] . V_47 =
V_46 -> V_57 [ V_48 ] . V_47 ;
break;
...
V_5 = F_38 ( V_2 -> V_7 , 0 , V_56 ,
F_37 ( V_56 ) , NULL , 0 , NULL ) ;
if ( V_5 != 0 ) {
