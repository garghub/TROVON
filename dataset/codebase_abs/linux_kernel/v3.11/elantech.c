...
unsigned int * V_107 , unsigned int * V_36 ,
unsigned int * V_57 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
unsigned char V_3 [ 3 ] ;
...
if ( V_10 -> V_117 ( V_1 , V_118 , V_3 ) )
return - 1 ;
V_116 = V_3 [ 1 ] & 0x10 ;
if ( ( ( V_10 -> V_30 >> 16 ) == 0x14 ) && V_116 ) {
if ( V_10 -> V_117 ( V_1 , V_119 , V_3 ) )
return - 1 ;
* V_107 = ( V_10 -> V_42 [ 1 ] - V_23 ) * V_3 [ 1 ] / 2 ;
...
{
unsigned char V_3 [ 3 ] ;
if ( F_5 ( V_1 , V_122 , V_3 ) )
return - 1 ;
* V_120 = F_38 ( V_3 [ 1 ] & 0x0f ) ;
* V_121 = F_38 ( ( V_3 [ 1 ] & 0xf0 ) >> 4 ) ;
return 0 ;
}
...
struct V_27 * V_28 = V_1 -> V_28 ;
struct V_9 * V_10 = V_1 -> V_11 ;
unsigned int V_105 = 0 , V_106 = 0 , V_107 = 0 , V_36 = 0 , V_57 = 0 ;
unsigned int V_120 = 0 , V_121 = 0 ;
if ( F_37 ( V_1 , & V_105 , & V_106 , & V_107 , & V_36 , & V_57 ) )
return - 1 ;
F_41 ( V_123 , V_28 -> V_124 ) ;
F_41 ( V_125 , V_28 -> V_126 ) ;
F_41 ( V_127 , V_28 -> V_126 ) ;
F_42 ( V_128 , V_28 -> V_126 ) ;
F_41 ( V_40 , V_28 -> V_129 ) ;
F_41 ( V_41 , V_28 -> V_129 ) ;
F_41 ( V_33 , V_28 -> V_129 ) ;
F_41 ( V_37 , V_28 -> V_129 ) ;
F_41 ( V_38 , V_28 -> V_129 ) ;
F_41 ( V_39 , V_28 -> V_129 ) ;
switch ( V_10 -> V_18 ) {
case 1 :
if ( V_10 -> V_30 < 0x020000 &&
( V_10 -> V_42 [ 0 ] & V_43 ) ) {
F_41 ( V_44 , V_28 -> V_129 ) ;
F_41 ( V_45 , V_28 -> V_129 ) ;
}
F_43 ( V_28 , V_34 , V_105 , V_107 , 0 , 0 ) ;
F_43 ( V_28 , V_35 , V_106 , V_36 , 0 , 0 ) ;
break;
case 2 :
F_41 ( V_59 , V_28 -> V_129 ) ;
F_41 ( V_130 , V_28 -> V_124 ) ;
case 3 :
F_43 ( V_28 , V_34 , V_105 , V_107 , 0 , 0 ) ;
F_43 ( V_28 , V_35 , V_106 , V_36 , 0 , 0 ) ;
if ( V_10 -> V_60 ) {
F_43 ( V_28 , V_61 , V_131 ,
V_132 , 0 , 0 ) ;
F_43 ( V_28 , V_62 , V_133 ,
V_134 , 0 , 0 ) ;
}
F_44 ( V_28 , 2 , 0 ) ;
F_43 ( V_28 , V_51 , V_105 , V_107 , 0 , 0 ) ;
F_43 ( V_28 , V_52 , V_106 , V_36 , 0 , 0 ) ;
break;
case 4 :
if ( F_39 ( V_1 , & V_120 , & V_121 ) ) {
F_45 ( V_1 , L_16 ) ;
}
F_41 ( V_135 , V_28 -> V_124 ) ;
F_42 ( V_41 , V_28 -> V_129 ) ;
F_41 ( V_59 , V_28 -> V_129 ) ;
F_43 ( V_28 , V_34 , V_105 , V_107 , 0 , 0 ) ;
F_43 ( V_28 , V_35 , V_106 , V_36 , 0 , 0 ) ;
F_46 ( V_28 , V_34 , V_120 ) ;
F_46 ( V_28 , V_35 , V_121 ) ;
F_43 ( V_28 , V_61 , V_131 ,
V_132 , 0 , 0 ) ;
F_43 ( V_28 , V_62 , V_133 ,
V_134 , 0 , 0 ) ;
...
F_43 ( V_28 , V_51 , V_105 , V_107 , 0 , 0 ) ;
F_43 ( V_28 , V_52 , V_106 , V_36 , 0 , 0 ) ;
F_46 ( V_28 , V_51 , V_120 ) ;
F_46 ( V_28 , V_52 , V_121 ) ;
F_43 ( V_28 , V_69 , V_131 ,
V_132 , 0 , 0 ) ;
F_43 ( V_28 , V_70 , 0 ,
V_134 * V_57 , 0 , 0 ) ;
break;
...
static T_3 F_47 ( struct V_1 * V_1 , void * V_136 ,
char * V_137 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_138 * V_139 = V_136 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_139 -> V_140 ;
int V_12 = 0 ;
if ( V_139 -> V_16 )
V_12 = F_9 ( V_1 , V_139 -> V_16 , V_16 ) ;
return sprintf ( V_137 , L_17 , ( V_139 -> V_16 && V_12 ) ? - 1 : * V_16 ) ;
}
static T_3 F_48 ( struct V_1 * V_1 ,
void * V_136 , const char * V_137 , T_4 V_141 )
{
struct V_9 * V_10 = V_1 -> V_11 ;
struct V_138 * V_139 = V_136 ;
unsigned char * V_16 = ( unsigned char * ) V_10 + V_139 -> V_140 ;
unsigned char V_142 ;
int V_143 ;
V_143 = F_49 ( V_137 , 16 , & V_142 ) ;
if ( V_143 )
return V_143 ;
if ( V_10 -> V_18 == 1 ) {
if ( V_139 -> V_16 == 0x10 )
V_142 |= V_104 ;
else if ( V_139 -> V_16 == 0x11 )
V_142 |= V_144 ;
}
if ( ! V_139 -> V_16 || F_10 ( V_1 , V_139 -> V_16 , V_142 ) == 0 )
* V_16 = V_142 ;
return V_141 ;
}
static bool F_50 ( const unsigned char * V_3 )
{
static const unsigned char V_145 [] = { 200 , 100 , 80 , 60 , 40 , 20 , 10 } ;
int V_23 ;
if ( V_3 [ 0 ] == 0 )
return false ;
if ( V_3 [ 1 ] == 0 )
return true ;
for ( V_23 = 0 ; V_23 < F_51 ( V_145 ) ; V_23 ++ )
if ( V_3 [ 2 ] == V_145 [ V_23 ] )
return false ;
return true ;
}
int F_52 ( struct V_1 * V_1 , bool V_146 )
{
struct V_4 * V_4 = & V_1 -> V_4 ;
unsigned char V_3 [ 3 ] ;
F_3 ( & V_1 -> V_4 , NULL , V_147 ) ;
if ( F_3 ( V_4 , NULL , V_148 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , NULL , V_22 ) ||
F_3 ( V_4 , V_3 , V_5 ) ) {
...
{
int V_155 = ( V_10 -> V_30 & 0x0f0000 ) >> 16 ;
...
int V_23 , error ;
unsigned char V_3 [ 3 ] ;
V_1 -> V_11 = V_10 = F_61 ( sizeof( struct V_9 ) , V_156 ) ;
if ( ! V_10 )
return - V_157 ;
F_58 ( V_1 ) ;
V_10 -> V_85 [ 0 ] = 1 ;
...
error = F_63 ( & V_1 -> V_4 . V_152 -> V_28 . V_153 ,
& V_154 ) ;
if ( error ) {
F_4 ( V_1 ,
L_32 ,
