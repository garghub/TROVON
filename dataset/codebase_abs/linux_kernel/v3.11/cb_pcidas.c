...
return - V_198 ;
V_4 -> V_199 = V_83 ;
V_4 -> V_200 = V_83 -> V_201 ;
V_6 = F_71 ( sizeof( * V_6 ) , V_202 ) ;
if ( ! V_6 )
return - V_203 ;
V_4 -> V_7 = V_6 ;
V_196 = F_72 ( V_4 ) ;
if ( V_196 )
return V_196 ;
V_6 -> V_57 = F_73 ( V_195 , 0 ) ;
V_6 -> V_22 = F_73 ( V_195 , 1 ) ;
V_6 -> V_29 = F_73 ( V_195 , 2 ) ;
V_6 -> V_124 = F_73 ( V_195 , 3 ) ;
if ( V_83 -> V_204 )
V_6 -> V_46 = F_73 ( V_195 , 4 ) ;
F_64 ( V_186 ,
V_6 -> V_57 + V_182 ) ;
if ( F_74 ( V_195 -> V_175 , F_61 ,
V_205 , V_4 -> V_206 -> V_207 , V_4 ) ) {
F_75 ( V_4 -> V_37 , L_12 ,
V_195 -> V_175 ) ;
return - V_38 ;
}
V_4 -> V_175 = V_195 -> V_175 ;
V_196 = F_76 ( V_4 , 7 ) ;
if ( V_196 )
return V_196 ;
V_11 = & V_4 -> V_208 [ 0 ] ;
...
V_11 -> V_121 = V_83 -> V_215 ;
V_11 -> V_216 = V_83 -> V_215 ;
V_11 -> V_217 = ( 1 << V_83 -> V_218 ) - 1 ;
V_11 -> V_219 = V_83 -> V_220 ;
V_11 -> V_221 = F_7 ;
V_11 -> V_222 = F_16 ;
V_11 -> V_223 = F_51 ;
V_11 -> V_224 = F_43 ;
...
static int F_84 ( struct V_194 * V_4 ,
const struct V_243 * V_34 )
{
return F_85 ( V_4 , & V_244 ,
V_34 -> V_245 ) ;
}
