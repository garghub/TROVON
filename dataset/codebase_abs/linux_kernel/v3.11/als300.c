...
static void F_20 ( struct V_43 * V_18 )
{
F_7 () ;
F_21 ( F_22 ( V_18 ) ) ;
F_8 () ;
}
static unsigned short F_23 ( struct V_44 * V_45 ,
unsigned short V_2 )
{
int V_46 ;
...
V_45 . V_32 = V_7 ;
F_8 () ;
return F_28 ( V_53 , & V_45 , & V_7 -> V_45 ) ;
}
static int F_29 ( struct V_61 * V_62 )
{
struct V_6 * V_7 = F_30 ( V_62 ) ;
struct V_63 * V_31 = V_62 -> V_31 ;
struct V_24 * V_25 = F_31 ( sizeof( * V_25 ) ,
V_64 ) ;
if ( ! V_25 )
return - V_65 ;
F_7 () ;
...
struct V_6 * V_7 = F_30 ( V_62 ) ;
struct V_63 * V_31 = V_62 -> V_31 ;
unsigned short V_77 = F_41 ( V_62 ) ;
unsigned short V_78 = F_42 ( V_62 ) ;
F_7 () ;
F_43 ( & V_7 -> V_79 ) ;
...
static int F_46 ( struct V_61 * V_62 , int V_8 )
{
struct V_6 * V_7 = F_30 ( V_62 ) ;
T_1 V_9 ;
struct V_24 * V_25 ;
...
static T_4 F_49 ( struct V_61 * V_62 )
{
T_5 V_95 ;
struct V_6 * V_7 = F_30 ( V_62 ) ;
struct V_24 * V_25 ;
...
int V_55 ;
F_7 () ;
V_55 = F_52 ( V_7 -> V_60 , L_10 , 0 , 1 , 1 , & V_29 ) ;
if ( V_55 < 0 )
return V_55 ;
V_29 -> V_32 = V_7 ;
...
static int F_59 ( struct V_110 * V_60 ,
...
V_112 = F_15 ;
if ( F_69 ( V_18 -> V_17 , V_112 , V_117 ,
V_118 , V_7 ) ) {
F_70 ( V_115 L_12 , V_18 -> V_17 ) ;
F_9 ( V_7 ) ;
return - V_119 ;
}
V_7 -> V_17 = V_18 -> V_17 ;
...
if ( ( V_55 = F_71 ( V_60 , V_121 ,
V_7 , & V_57 ) ) < 0 ) {
F_9 ( V_7 ) ;
return V_55 ;
}
F_72 ( V_60 , & V_18 -> V_122 ) ;
* V_111 = V_7 ;
F_8 () ;
return 0 ;
}
static int F_73 ( struct V_20 * V_122 )
{
struct V_43 * V_18 = F_74 ( V_122 ) ;
struct V_110 * V_60 = F_75 ( V_122 ) ;
...
static int F_81 ( struct V_20 * V_122 )
{
struct V_43 * V_18 = F_74 ( V_122 ) ;
struct V_110 * V_60 = F_75 ( V_122 ) ;
struct V_6 * V_7 = V_60 -> V_32 ;
...
static int F_85 ( struct V_43 * V_18 ,
...
V_55 = F_86 ( V_134 [ V_122 ] , V_135 [ V_122 ] , V_136 , 0 , & V_60 ) ;
if ( V_55 < 0 )
return V_55 ;
V_12 = V_129 -> V_137 ;
if ( ( V_55 = F_59 ( V_60 , V_18 , V_12 , & V_7 ) ) < 0 ) {
F_21 ( V_60 ) ;
return V_55 ;
}
V_60 -> V_32 = V_7 ;
