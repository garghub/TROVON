...
if ( F_110 ( V_70 -> V_72 ) &&
! F_111 ( V_29 -> V_269 ) &&
F_112 ( V_70 -> V_270 , V_29 -> V_269 ) ) {
T_5 V_271 = V_245 -> V_248 . V_266 ;
if ( F_113 ( V_221 != V_222 ) )
V_271 = F_114 ( V_221 , V_272 ) ;
if ( V_271 < 0 )
V_271 = 0 ;
V_8 -> V_30 -> V_273 . V_274 = V_271 ;
}
V_246 -> V_275 = F_115 ( V_245 -> V_248 . V_276 ) ;
V_246 -> V_158 = V_15 -> V_123 . V_156 . V_157 -> V_158 ;
V_246 -> V_277 = V_15 -> V_123 . V_156 . V_157 -> V_278 ;
V_246 -> signal = V_245 -> V_248 . V_266 + V_279 ;
V_246 -> V_280 = V_245 -> V_248 . V_281 ;
V_246 -> V_231 |= V_282 ;
return true ;
V_250:
return false ;
...
{
struct V_7 * V_8 = (struct V_7 * ) V_46 ;
struct V_244 * V_245 = NULL , * V_283 = NULL ;
struct V_224 V_246 ;
struct V_40 * V_41 ;
unsigned long V_13 ;
struct V_69 * V_70 ;
do {
F_65 ( & V_8 -> V_220 . V_284 , V_13 ) ;
...
memcpy ( F_118 ( V_245 -> V_41 ) , & V_246 ,
sizeof( struct V_224 ) ) ;
V_41 = V_245 -> V_41 ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( F_110 ( V_70 -> V_72 ) && V_8 -> V_287 )
F_119 ( V_8 -> V_15 , & V_8 -> V_288 ) ;
F_68 ( & V_8 -> V_220 . V_284 , V_13 ) ;
F_120 ( V_8 -> V_15 , V_41 ) ;
F_65 ( & V_8 -> V_220 . V_284 , V_13 ) ;
V_286:
V_245 -> V_285 = false ;
V_245 -> V_41 = NULL ;
F_121 ( & V_245 -> V_169 , & V_8 -> V_220 . V_245 ) ;
V_245 = NULL ;
F_68 ( & V_8 -> V_220 . V_284 , V_13 ) ;
} while ( 1 );
}
...
F_73 ( & V_8 -> V_220 . V_284 ) ;
if ( V_245 == NULL ) {
F_37 ( V_29 , V_289 , L_11 ) ;
goto V_290;
}
F_71 ( & V_8 -> V_220 . V_284 ) ;
V_245 -> V_41 = V_41 ;
...
{
int V_177 = 0 ;
F_125 ( & V_8 -> V_220 . V_245 ) ;
F_126 ( & V_8 -> V_220 . V_284 ) ;
for ( V_177 = 0 ; V_177 < V_293 ; V_177 ++ ) {
struct V_244 * V_245 =
F_70 ( sizeof( struct V_244 ) , V_294 ) ;
if ( V_245 == NULL )
goto V_290;
