...
F_15 ( & V_1 -> V_3 [ V_29 ] . V_12 , & V_1 -> V_7 ) ;
if ( V_1 -> V_5 > V_6 )
V_28 = V_1 -> V_3 ;
V_27 = F_16 ( V_28 , sizeof( * V_27 ) * V_26 ,
V_9 ) ;
if ( ! V_27 )
return - V_30 ;
if ( ! V_28 )
...
struct V_10 * F_18 ( struct V_1 * V_1 , struct V_31 * V_32 )
{
if ( V_1 -> V_2 == 0 )
return NULL ;
if ( V_32 -> V_29 < 0 || V_32 -> V_29 >= V_1 -> V_2 )
return NULL ;
return & V_1 -> V_3 [ V_32 -> V_29 ++ ] ;
}
