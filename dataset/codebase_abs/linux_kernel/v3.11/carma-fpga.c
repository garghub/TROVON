...
static int F_77 ( struct V_116 * V_116 , struct V_117 * V_127 )
{
struct V_3 * V_4 = F_2 ( V_127 -> V_128 ,
struct V_3 , V_129 ) ;
struct V_130 * V_131 ;
int V_11 ;
V_131 = F_9 ( sizeof( * V_131 ) , V_13 ) ;
if ( ! V_131 )
return - V_27 ;
V_131 -> V_4 = V_4 ;
V_131 -> V_7 = NULL ;
V_127 -> V_128 = V_131 ;
V_11 = F_78 ( V_116 , V_127 ) ;
if ( V_11 ) {
F_21 ( V_4 -> V_21 , L_35 ) ;
F_4 ( V_131 ) ;
return V_11 ;
...
static int F_80 ( struct V_116 * V_116 , struct V_117 * V_127 )
{
struct V_130 * V_131 = V_127 -> V_128 ;
...
static T_6 F_82 ( struct V_117 * V_127 , char T_7 * V_132 , T_1 V_124 ,
T_8 * V_133 )
{
struct V_130 * V_131 = V_127 -> V_128 ;
struct V_3 * V_4 = V_131 -> V_4 ;
...
V_135 = F_48 ( V_68 , struct V_6 , V_15 ) ;
F_16 ( & V_135 -> V_15 ) ;
F_53 ( & V_4 -> V_67 ) ;
F_17 ( V_4 -> V_21 , & V_135 -> V_8 ) ;
V_131 -> V_7 = V_135 ;
V_131 -> V_141 = 0 ;
V_137:
V_136 = V_135 -> V_16 - V_131 -> V_141 ;
V_65 = V_135 -> V_8 . V_142 + V_131 -> V_141 ;
V_124 = F_84 ( V_124 , V_136 ) ;
if ( F_85 ( V_132 , V_65 , V_124 ) )
return - V_143 ;
V_136 -= V_124 ;
if ( V_136 > 0 ) {
V_131 -> V_141 += V_124 ;
...
F_52 ( & V_4 -> V_67 ) ;
V_131 -> V_7 = NULL ;
if ( ! V_4 -> V_69 || V_135 -> V_16 != V_4 -> V_23 ) {
V_134 = true ;
goto V_126;
}
F_20 ( & V_135 -> V_15 , & V_4 -> free ) ;
V_126:
F_53 ( & V_4 -> V_67 ) ;
if ( V_134 ) {
F_17 ( V_4 -> V_21 , & V_135 -> V_8 ) ;
...
static unsigned int F_86 ( struct V_117 * V_127 , struct V_144 * V_145 )
{
struct V_130 * V_131 = V_127 -> V_128 ;
struct V_3 * V_4 = V_131 -> V_4 ;
unsigned int V_146 = 0 ;
F_87 ( V_127 , & V_4 -> V_70 , V_145 ) ;
if ( ! F_47 ( & V_4 -> V_68 ) )
V_146 |= V_147 | V_148 ;
return V_146 ;
}
static int F_88 ( struct V_117 * V_127 , struct V_149 * V_150 )
{
struct V_130 * V_131 = V_127 -> V_128 ;
struct V_3 * V_4 = V_131 -> V_4 ;
unsigned long V_114 , V_151 , V_152 , V_153 ;
V_114 = V_150 -> V_154 << V_155 ;
V_151 = V_150 -> V_156 - V_150 -> V_157 ;
V_152 = V_4 -> V_158 - V_114 ;
V_153 = ( V_4 -> V_29 + V_114 ) >> V_155 ;
if ( V_151 > V_152 ) {
F_21 ( V_4 -> V_21 , L_37 ) ;
return - V_159 ;
}
V_150 -> V_160 = F_89 ( V_150 -> V_160 ) ;
return F_90 ( V_150 , V_150 -> V_157 , V_153 , V_151 ,
V_150 -> V_160 ) ;
}
...
F_10 ( & V_4 -> V_68 ) ;
F_98 ( & V_4 -> V_70 ) ;
V_4 -> V_129 . V_169 = V_170 ;
V_4 -> V_129 . V_171 = V_109 ;
V_4 -> V_129 . V_172 = & V_173 ;
V_11 = F_99 ( V_165 , 0 , & V_168 ) ;
if ( V_11 ) {
...
V_4 -> V_158 = F_100 ( & V_168 ) ;
V_4 -> V_51 = F_101 ( V_165 , 0 ) ;
if ( ! V_4 -> V_51 ) {
...
F_103 ( V_179 , V_146 ) ;
F_103 ( V_180 , V_146 ) ;
V_4 -> V_76 = F_104 ( V_146 , F_91 , NULL ) ;
if ( ! V_4 -> V_76 ) {
F_21 ( & V_163 -> V_21 , L_41 ) ;
V_11 = - V_174 ;
goto V_181;
}
V_4 -> V_93 = F_105 ( V_165 , 0 ) ;
if ( V_4 -> V_93 == V_182 ) {
...
V_166 = V_4 -> V_129 . V_166 ;
F_96 ( V_166 , V_4 ) ;
V_11 = F_107 ( & V_166 -> V_187 , & V_188 ) ;
if ( V_11 ) {
F_21 ( & V_163 -> V_21 , L_45 ) ;
goto V_189;
}
F_108 ( & V_163 -> V_21 , L_46 ) ;
return 0 ;
V_189:
F_69 ( V_4 ) ;
V_186:
...
static int F_113 ( struct V_162 * V_163 )
{
struct V_3 * V_4 = F_114 ( V_163 ) ;
struct V_87 * V_166 = V_4 -> V_129 . V_166 ;
F_115 ( & V_166 -> V_187 , & V_188 ) ;
F_69 ( V_4 ) ;
F_56 ( V_4 ) ;
F_109 ( & V_4 -> V_129 ) ;
F_110 ( V_4 -> V_93 ) ;
