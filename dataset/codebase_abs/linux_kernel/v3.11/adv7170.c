...
struct V_2 * V_3 ;
int V_49 ;
if ( ! F_9 ( V_7 -> V_12 , V_50 ) )
return - V_51 ;
F_19 ( V_7 , L_10 ,
V_7 -> V_52 << 1 , V_7 -> V_12 -> V_53 ) ;
V_8 = F_20 ( & V_7 -> V_54 , sizeof( * V_8 ) , V_55 ) ;
if ( V_8 == NULL )
return - V_56 ;
V_3 = & V_8 -> V_3 ;
F_21 ( V_3 , V_7 , & V_57 ) ;
V_8 -> V_26 = V_18 ;
V_8 -> V_20 = 0 ;
V_49 = F_8 ( V_3 , V_19 , sizeof( V_19 ) ) ;
if ( V_49 >= 0 ) {
V_49 = F_3 ( V_3 , 0x07 , V_21 | V_22 ) ;
V_49 = F_3 ( V_3 , 0x07 , V_21 ) ;
V_49 = F_6 ( V_3 , 0x12 ) ;
F_12 ( 1 , V_17 , V_3 , L_11 , V_49 & 1 ) ;
}
if ( V_49 < 0 )
F_12 ( 1 , V_17 , V_3 , L_12 , V_49 ) ;
return 0 ;
}
