...
T_1 * V_61 , unsigned int V_137 , int V_51 , T_3 V_138 ,
...
V_114 -> V_119 . V_140 = V_141 ;
V_114 -> V_119 . V_142 = V_143 ;
V_114 -> V_119 . V_144 = 1 ;
V_114 -> V_119 . V_145 = V_146 ;
V_114 -> V_119 . V_130 = V_131 ;
V_114 -> V_119 . V_133 = F_76 () ;
V_114 -> V_119 . V_95 = sizeof( * V_114 ) + V_47 ;
V_114 -> V_119 . V_120 = V_121 ;
V_114 -> V_119 . V_147 = V_148 ;
V_114 -> V_119 . V_55 = F_77 () ;
V_114 -> V_119 . V_52 = V_149 ;
V_114 -> V_123 . V_150 = sizeof( * V_114 ) ;
V_114 -> V_123 . V_151 = V_47 ;
V_114 -> V_123 . V_140 = V_152 ;
V_114 -> V_123 . V_130 = 0 ;
V_114 -> V_123 . V_52 = V_153 ;
switch ( type ) {
case V_126 :
...
V_114 -> V_123 . V_154 = V_146 ;
V_139 = F_63 ( & V_114 -> V_119 ) ;
...
F_85 ( & V_157 ) ;
F_27 ( & V_15 ) ;
V_20 = F_86 ( & V_15 , & V_157 ) ;
if ( V_20 )
goto V_166;
V_20 = F_87 ( & V_157 , L_11 ) ;
if ( V_20 )
goto V_166;
V_20 = F_88 ( & V_15 ) ;
if ( V_20 )
...
V_159 = F_89 ( V_42 . V_45 , V_42 . V_47 , L_11 ) ;
if ( ! V_159 ) {
F_84 ( V_36
L_15 ,
