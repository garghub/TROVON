...
static int F_67 ( struct V_160 * V_161 , T_1 V_18 ,
unsigned int V_162 )
{
struct V_144 * V_163 = V_161 -> V_163 -> V_108 ;
struct V_144 * V_164 = V_161 -> V_164 -> V_108 ;
int V_165 = F_55 ( V_163 ) ;
int V_166 = F_55 ( V_164 ) ;
int V_152 ;
if ( V_162 == V_167 &&
! ( V_161 -> V_18 & V_168 ) ) {
F_63 ( V_163 , - V_166 ) ;
...
if ( V_162 == V_167 &&
( V_18 & V_168 ) ) {
V_152 = F_63 ( V_163 , V_166 ) ;
if ( V_152 < 0 )
return V_152 ;
V_152 = F_63 ( V_164 , V_165 ) ;
if ( V_152 < 0 )
F_63 ( V_163 , - V_166 ) ;
return V_152 ;
}
...
unsigned long V_18 ;
int V_152 ;
if ( ( V_100 -> V_173 & V_2 -> V_174 ) &
( 1U << V_2 -> V_113 . V_107 . V_108 . V_8 ) )
return - V_175 ;
F_12 ( & V_100 -> V_19 , V_18 ) ;
V_100 -> V_176 &= ~ ( V_177 | V_178 ) ;
F_13 ( & V_100 -> V_19 , V_18 ) ;
V_100 -> V_179 = false ;
V_108 = & V_100 -> V_132 -> V_180 . V_108 ;
while ( 1 ) {
V_172 = & V_108 -> V_181 [ 0 ] ;
if ( ! ( V_172 -> V_18 & V_182 ) )
break;
V_172 = F_69 ( V_172 ) ;
if ( V_172 == NULL ||
F_58 ( V_172 -> V_108 ) != V_153 )
break;
V_108 = V_172 -> V_108 ;
V_107 = F_60 ( V_108 ) ;
V_152 = F_61 ( V_107 , V_180 , V_183 , V_170 ) ;
if ( V_152 < 0 && V_152 != - V_156 )
return V_152 ;
if ( V_107 == & V_2 -> V_93 . V_107 ) {
F_61 ( & V_2 -> V_122 . V_107 , V_180 ,
V_183 , V_170 ) ;
F_61 ( & V_2 -> V_120 . V_107 , V_180 ,
V_183 , V_170 ) ;
F_61 ( & V_2 -> V_94 . V_107 , V_180 ,
V_183 , V_170 ) ;
V_100 -> V_179 = true ;
}
}
...
V_152 = F_68 ( V_100 , V_176 ) ;
if ( V_152 == 0 || V_176 == V_189 )
V_100 -> V_190 = V_176 ;
return V_152 ;
}
static void F_82 ( struct V_99 * V_100 )
{
int V_191 = V_100 -> V_190 == V_192 ;
F_83 ( V_100 -> V_132 , ! V_191 ) ;
if ( V_191 )
F_83 ( V_100 -> V_72 , 0 ) ;
F_68 ( V_100 , V_100 -> V_190 ) ;
}
static void F_84 ( struct V_99 * V_100 )
{
F_79 ( V_100 ) ;
}
static int F_85 ( struct V_144 * V_193 )
{
struct V_99 * V_100 ;
struct V_171 * V_172 ;
if ( ! V_193 -> V_100 )
return 0 ;
V_100 = F_42 ( V_193 ) ;
if ( V_100 -> V_190 == V_189 )
return 0 ;
V_172 = F_69 ( & V_100 -> V_132 -> V_172 ) ;
return V_172 -> V_108 == V_193 ;
}
static void F_86 ( struct V_144 * V_193 )
{
if ( F_85 ( V_193 ) )
F_84 ( F_42 ( V_193 ) ) ;
}
static void F_87 ( struct V_144 * V_193 )
{
if ( F_85 ( V_193 ) )
F_82 ( F_42 ( V_193 ) ) ;
}
...
static void
F_96 ( struct V_1 * V_2 , struct V_196 * V_197 )
{
struct V_196 * V_198 = V_197 ;
for (; V_198 -> V_199 != V_200 ; V_198 ++ )
V_198 -> V_201 = F_3 ( V_2 , V_198 -> V_202 , V_198 -> V_199 ) ;
}
static void
F_97 ( struct V_1 * V_2 , struct V_196 * V_197 )
{
struct V_196 * V_198 = V_197 ;
for (; V_198 -> V_199 != V_200 ; V_198 ++ )
F_2 ( V_2 , V_198 -> V_201 , V_198 -> V_202 , V_198 -> V_199 ) ;
}
...
void F_104 ( struct V_1 * V_2 , enum V_204 V_205 )
{
T_1 V_206 = 0 ;
V_2 -> V_207 |= V_205 ;
if ( V_2 -> V_207 & V_208 )
...
if ( V_2 -> V_207 & V_218 )
V_206 |= V_219 ;
F_105 ( V_2 , V_3 , V_70 , V_206 ) ;
}
void F_106 ( struct V_1 * V_2 , enum V_204 V_205 )
{
T_1 V_206 = 0 ;
V_2 -> V_207 &= ~ V_205 ;
if ( ! ( V_2 -> V_207 & V_208 ) )
...
if ( ! ( V_2 -> V_207 & V_218 ) )
V_206 |= V_219 ;
F_107 ( V_2 , V_3 , V_70 , V_206 ) ;
}
int F_108 ( struct V_144 * V_193 , T_3 * V_220 ,
T_4 * V_221 )
{
struct V_99 * V_100 = F_42 ( V_193 ) ;
if ( V_100 -> V_190 == V_189 ||
( V_100 -> V_190 == V_192 &&
! F_109 ( V_100 ) ) )
return 0 ;
...
F_110 () ;
if ( F_85 ( V_193 ) ) {
struct V_222 * V_180 = V_100 -> V_132 ;
unsigned long V_18 ;
F_12 ( & V_180 -> V_223 -> V_224 , V_18 ) ;
if ( V_180 -> V_225 & V_226 ) {
F_13 ( & V_180 -> V_223 -> V_224 , V_18 ) ;
F_38 ( V_221 , 0 ) ;
F_110 () ;
return 0 ;
}
F_13 ( & V_180 -> V_223 -> V_224 , V_18 ) ;
if ( ! F_111 ( * V_220 , ! F_112 ( V_221 ) ,
F_113 ( 1000 ) ) ) {
F_38 ( V_221 , 0 ) ;
F_110 () ;
return - V_188 ;
...
int V_243 ;
unsigned long V_22 ;
V_243 = F_121 ( V_2 -> clock [ V_244 ] ) ;
if ( V_243 ) {
F_122 ( V_2 -> V_24 , L_45 ) ;
goto V_245;
}
V_243 = F_123 ( V_2 -> clock [ V_246 ] , V_247 ) ;
if ( V_243 ) {
F_122 ( V_2 -> V_24 , L_46 ) ;
goto V_248;
}
V_243 = F_121 ( V_2 -> clock [ V_246 ] ) ;
if ( V_243 ) {
F_122 ( V_2 -> V_24 , L_47 ) ;
goto V_248;
}
V_22 = F_124 ( V_2 -> clock [ V_246 ] ) ;
if ( V_22 != V_247 )
F_125 ( V_2 -> V_24 , L_48
L_49
L_50 , V_247 , V_22 ) ;
V_243 = F_121 ( V_2 -> clock [ V_249 ] ) ;
if ( V_243 ) {
F_122 ( V_2 -> V_24 , L_51 ) ;
goto V_250;
}
return 0 ;
V_250:
F_126 ( V_2 -> clock [ V_246 ] ) ;
V_248:
F_126 ( V_2 -> clock [ V_244 ] ) ;
V_245:
return V_243 ;
}
...
F_126 ( V_2 -> clock [ V_244 ] ) ;
F_126 ( V_2 -> clock [ V_246 ] ) ;
F_126 ( V_2 -> clock [ V_249 ] ) ;
}
static int F_128 ( struct V_1 * V_2 )
{
struct V_32 * V_32 ;
unsigned int V_30 ;
for ( V_30 = 0 ; V_30 < F_22 ( V_251 ) ; ++ V_30 ) {
V_32 = F_129 ( V_2 -> V_24 , V_251 [ V_30 ] ) ;
if ( F_25 ( V_32 ) ) {
F_122 ( V_2 -> V_24 , L_52 , V_251 [ V_30 ] ) ;
return F_26 ( V_32 ) ;
}
V_2 -> clock [ V_30 ] = V_32 ;
}
...
struct V_278 * V_279 )
{
struct V_151 * V_280 = NULL ;
unsigned int V_157 ;
if ( V_279 -> V_279 == NULL )
return NULL ;
for ( V_157 = 1 ; V_279 -> V_279 ; ++ V_279 , V_157 = 0 ) {
struct V_151 * V_107 ;
struct V_281 * V_282 ;
V_282 = F_151 ( V_279 -> V_283 ) ;
if ( V_282 == NULL ) {
F_122 ( V_2 -> V_24 , L_55
L_56 , V_25 ,
V_279 -> V_283 ,
...
V_107 = F_152 ( & V_2 -> V_276 , V_282 ,
V_279 -> V_279 , NULL ) ;
if ( V_107 == NULL ) {
F_122 ( V_2 -> V_24 , L_57 ,
V_25 , V_279 -> V_279 -> type ) ;
continue;
}
if ( V_157 )
V_280 = V_107 ;
...
struct V_284 * V_285 ;
int V_152 ;
V_2 -> V_277 . V_24 = V_2 -> V_24 ;
F_154 ( V_2 -> V_277 . V_286 , L_58 ,
sizeof( V_2 -> V_277 . V_286 ) ) ;
V_2 -> V_277 . V_287 = V_2 -> V_63 ;
V_2 -> V_277 . V_288 = F_67 ;
V_152 = F_155 ( & V_2 -> V_277 ) ;
if ( V_152 < 0 ) {
F_122 ( V_2 -> V_24 , L_59 ,
V_25 , V_152 ) ;
return V_152 ;
}
V_2 -> V_276 . V_289 = & V_2 -> V_277 ;
V_152 = F_156 ( V_2 -> V_24 , & V_2 -> V_276 ) ;
if ( V_152 < 0 ) {
F_122 ( V_2 -> V_24 , L_60 ,
V_25 , V_152 ) ;
goto V_290;
}
V_152 = F_157 ( & V_2 -> V_106 , & V_2 -> V_276 ) ;
if ( V_152 < 0 )
goto V_290;
V_152 = F_158 ( & V_2 -> V_110 , & V_2 -> V_276 ) ;
if ( V_152 < 0 )
goto V_290;
V_152 = F_159 ( & V_2 -> V_93 , & V_2 -> V_276 ) ;
if ( V_152 < 0 )
goto V_290;
...
if ( V_152 < 0 )
goto V_290;
V_152 = F_161 ( & V_2 -> V_118 , & V_2 -> V_276 ) ;
if ( V_152 < 0 )
goto V_290;
V_152 = F_162 ( & V_2 -> V_122 , & V_2 -> V_276 ) ;
if ( V_152 < 0 )
goto V_290;
V_152 = F_162 ( & V_2 -> V_120 , & V_2 -> V_276 ) ;
if ( V_152 < 0 )
goto V_290;
V_152 = F_162 ( & V_2 -> V_94 , & V_2 -> V_276 ) ;
if ( V_152 < 0 )
goto V_290;
for ( V_285 = V_27 -> V_285 ; V_285 && V_285 -> V_285 ; ++ V_285 ) {
struct V_151 * V_280 ;
struct V_144 * V_72 ;
unsigned int V_18 ;
unsigned int V_172 ;
unsigned int V_30 ;
V_280 = F_150 ( V_2 , V_285 -> V_285 ) ;
if ( V_280 == NULL )
continue;
V_280 -> V_291 = V_285 ;
switch ( V_285 -> V_292 ) {
...
for ( V_30 = 0 ; V_30 < V_280 -> V_108 . V_304 ; V_30 ++ ) {
if ( V_280 -> V_108 . V_181 [ V_30 ] . V_18 & V_305 )
break;
}
if ( V_30 == V_280 -> V_108 . V_304 ) {
F_122 ( V_2 -> V_24 ,
L_62 ,
V_25 ) ;
V_152 = - V_303 ;
...
V_152 = F_163 ( & V_280 -> V_108 , V_30 , V_72 , V_172 ,
V_18 ) ;
if ( V_152 < 0 )
goto V_290;
}
V_152 = F_164 ( & V_2 -> V_276 ) ;
V_290:
if ( V_152 < 0 )
F_141 ( V_2 ) ;
return V_152 ;
...
V_152 = F_163 (
& V_2 -> V_110 . V_107 . V_108 , V_315 ,
& V_2 -> V_93 . V_107 . V_108 , V_294 , 0 ) ;
if ( V_152 < 0 )
goto V_316;
V_152 = F_163 (
& V_2 -> V_106 . V_107 . V_108 , V_317 ,
& V_2 -> V_93 . V_107 . V_108 , V_294 , 0 ) ;
if ( V_152 < 0 )
goto V_316;
V_152 = F_163 (
& V_2 -> V_93 . V_107 . V_108 , V_318 ,
& V_2 -> V_113 . V_107 . V_108 , V_319 , 0 ) ;
if ( V_152 < 0 )
goto V_316;
V_152 = F_163 (
& V_2 -> V_93 . V_107 . V_108 , V_320 ,
& V_2 -> V_118 . V_107 . V_108 , V_321 , 0 ) ;
if ( V_152 < 0 )
goto V_316;
V_152 = F_163 (
& V_2 -> V_113 . V_107 . V_108 , V_322 ,
& V_2 -> V_118 . V_107 . V_108 , V_321 , 0 ) ;
if ( V_152 < 0 )
goto V_316;
V_152 = F_163 (
...
static int F_184 ( struct V_323 * V_324 )
{
struct V_1 * V_2 = F_185 ( V_324 ) ;
F_141 ( V_2 ) ;
F_165 ( V_2 ) ;
F_29 ( V_2 ) ;
F_130 ( V_2 , false ) ;
F_186 ( V_2 -> V_257 , & V_324 -> V_24 ) ;
F_187 ( V_2 -> V_257 ) ;
V_2 -> V_257 = NULL ;
F_10 ( V_2 ) ;
return 0 ;
}
static int F_188 ( struct V_323 * V_324 ,
struct V_1 * V_2 ,
enum V_325 V_205 )
{
struct V_326 * V_327 ;
V_327 = F_189 ( V_324 , V_328 , V_205 ) ;
if ( ! V_327 ) {
F_122 ( V_2 -> V_24 , L_72 ) ;
return - V_329 ;
}
if ( ! F_190 ( V_2 -> V_24 , V_327 -> V_330 , F_191 ( V_327 ) ,
V_324 -> V_33 ) ) {
F_122 ( V_2 -> V_24 ,
L_73 ) ;
return - V_329 ;
}
V_2 -> V_331 [ V_205 ] = V_327 -> V_330 ;
V_2 -> V_332 [ V_205 ] = F_191 ( V_327 ) ;
V_2 -> V_333 [ V_205 ] = F_192 ( V_2 -> V_24 ,
V_2 -> V_331 [ V_205 ] ,
V_2 -> V_332 [ V_205 ] ) ;
if ( ! V_2 -> V_333 [ V_205 ] ) {
F_122 ( V_2 -> V_24 , L_74 ) ;
...
static int F_193 ( struct V_323 * V_324 )
{
struct V_26 * V_27 = V_324 -> V_24 . V_334 ;
struct V_1 * V_2 ;
int V_152 ;
int V_30 , V_335 ;
if ( V_27 == NULL )
return - V_303 ;
V_2 = F_194 ( & V_324 -> V_24 , sizeof( * V_2 ) , V_42 ) ;
if ( ! V_2 ) {
F_122 ( & V_324 -> V_24 , L_75 ) ;
return - V_43 ;
}
V_2 -> V_67 = V_67 ;
F_195 ( & V_2 -> V_253 ) ;
...
V_2 -> V_254 = 0 ;
V_2 -> V_337 = F_196 ( 32 ) ;
V_2 -> V_24 -> V_338 = & V_2 -> V_337 ;
V_2 -> V_24 -> V_339 = F_196 ( 32 ) ;
F_197 ( V_324 , V_2 ) ;
V_2 -> V_340 . V_341 = F_198 ( & V_324 -> V_24 , L_76 ) ;
V_2 -> V_342 . V_341 = F_198 ( & V_324 -> V_24 , L_77 ) ;
V_152 = F_188 ( V_324 , V_2 , V_3 ) ;
if ( V_152 < 0 )
goto error;
V_152 = F_128 ( V_2 ) ;
if ( V_152 < 0 )
goto error;
V_152 = F_199 ( V_2 -> clock [ V_244 ] ) ;
if ( V_152 < 0 )
goto error;
V_2 -> V_63 = F_3 ( V_2 , V_3 , V_4 ) ;
F_80 ( V_2 -> V_24 , L_78 ,
( V_2 -> V_63 & 0xf0 ) >> 4 , V_2 -> V_63 & 0x0f ) ;
F_200 ( V_2 -> clock [ V_244 ] ) ;
...
if ( V_152 < 0 )
goto V_343;
for ( V_335 = 0 ; V_335 < F_22 ( V_344 ) ; V_335 ++ )
if ( V_2 -> V_63 == V_344 [ V_335 ] . V_345 )
break;
if ( V_335 == F_22 ( V_344 ) ) {
F_122 ( V_2 -> V_24 , L_79 ,
...
for ( V_30 = 1 ; V_30 < V_346 ; V_30 ++ ) {
if ( V_344 [ V_335 ] . V_347 & 1 << V_30 ) {
V_152 = F_188 ( V_324 , V_2 , V_30 ) ;
if ( V_152 )
goto V_343;
}
}
V_2 -> V_257 = F_201 ( V_324 -> V_24 . V_348 ) ;
if ( ! V_2 -> V_257 ) {
F_122 ( V_2 -> V_24 , L_80 ) ;
V_152 = - V_43 ;
goto V_343;
}
V_152 = F_202 ( V_2 -> V_257 , & V_324 -> V_24 ) ;
if ( V_152 ) {
F_122 ( & V_324 -> V_24 , L_81 , V_152 ) ;
V_152 = - V_349 ;
goto V_350;
}
V_2 -> V_351 = F_203 ( V_324 , 0 ) ;
if ( V_2 -> V_351 <= 0 ) {
F_122 ( V_2 -> V_24 , L_82 ) ;
V_152 = - V_329 ;
goto V_352;
}
if ( F_204 ( V_2 -> V_24 , V_2 -> V_351 , F_44 , V_353 ,
L_83 , V_2 ) ) {
F_122 ( V_2 -> V_24 , L_84 ) ;
V_152 = - V_303 ;
goto V_352;
