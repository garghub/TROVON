...
if ( ! V_147 ) {
V_80 = F_43 ( V_32 , V_32 -> V_23 , & V_23 ) ;
if ( V_80 )
goto V_80;
}
if ( F_38 ( V_32 ) ) {
V_80 = F_44 ( V_32 , V_151 ) ;
if ( V_80 )
goto V_80;
}
V_5 = F_45 ( V_32 , NULL ) ;
...
if ( ( V_23 & V_152 ) &&
F_46 ( V_32 , V_32 -> V_23 & V_23 , V_5 -> V_153 , NULL ) == 0 ) {
V_5 -> type = V_89 ;
...
V_80 = F_48 ( V_32 , V_156 ) ;
if ( V_80 == - V_157 ) {
F_49 ( V_32 ) ;
F_50 ( V_32 ) ;
F_51 ( V_32 , V_32 -> V_158 ) ;
F_47 ( V_5 ) ;
V_148 -- ;
goto V_150;
} else if ( V_80 ) {
...
if ( V_2 && F_74 ( V_2 ) && V_2 -> V_163 . V_168 ) {
...
if ( F_84 ( V_32 ) || ! F_76 ( V_32 ) ) {
F_49 ( V_32 ) ;
F_50 ( V_32 ) ;
V_80 = F_41 ( V_32 , V_32 -> V_23 , V_32 -> V_5 ,
F_76 ( V_32 ) ) ;
...
static int F_86 ( struct V_145 * V_32 )
{
int V_3 ;
T_1 V_23 ;
F_6 ( ! V_32 ) ;
...
F_50 ( V_32 ) ;
F_51 ( V_32 , V_32 -> V_158 ) ;
V_3 = F_43 ( V_32 , 0 , & V_23 ) ;
if ( V_3 )
goto V_10;
if ( V_32 -> V_179 )
V_32 -> V_158 = V_32 -> V_179 ;
V_32 -> V_23 = F_80 ( V_32 , V_23 & ~ 0x7F ) ;
if ( ! V_32 -> V_23 ) {
V_3 = - V_33 ;
goto V_10;
}
if ( F_15 ( V_32 ) )
V_32 -> V_23 |= V_26 ;
V_3 = F_41 ( V_32 , V_32 -> V_23 , V_32 -> V_5 ,
F_76 ( V_32 ) ) ;
if ( ! V_3 && V_32 -> V_175 )
F_87 ( V_32 ) ;
V_10:
...
static int F_89 ( struct V_145 * V_32 )
{
F_79 ( V_32 ) ;
return F_86 ( V_32 ) ;
}
int F_90 ( struct V_145 * V_32 )
{
int V_80 , V_165 , V_180 ;
T_1 V_23 ;
struct V_12 * V_5 ;
F_6 ( ! V_32 ) ;
F_42 ( ! V_32 -> V_149 ) ;
...
if ( F_15 ( V_32 ) )
V_32 -> V_23 |= V_26 ;
V_80 = F_41 ( V_32 , V_32 -> V_23 , NULL , 0 ) ;
if ( V_80 ) {
if ( V_80 == - V_157 ) {
V_32 -> V_23 &= ~ V_26 ;
V_80 = F_41 ( V_32 , V_32 -> V_23 , NULL , 0 ) ;
...
V_5 -> V_166 = 0 ;
for ( V_165 = 0 ; V_165 < V_180 ; V_165 ++ , V_5 -> V_166 ++ ) {
...
if ( V_80 )
goto V_182;
for ( V_165 = 0 ; V_165 < V_180 ; V_165 ++ ) {
V_80 = F_93 ( V_32 -> V_5 -> V_1 [ V_165 ] ) ;
if ( V_80 )
goto V_182;
}
F_67 ( V_32 ) ;
