...
return;
V_248 = F_183 ( V_9 -> V_11 . V_2 -> V_250 ) ;
V_82 = * ( T_1 * ) ( V_248 + F_184 ( V_9 -> V_11 . V_2 -> V_251 ) ) ;
F_185 ( V_248 ) ;
...
V_248 = F_183 ( V_9 -> V_11 . V_2 -> V_250 ) ;
* ( T_1 * ) ( V_248 + F_184 ( V_9 -> V_11 . V_2 -> V_251 ) ) = V_82 ;
F_185 ( V_248 ) ;
}
void F_188 ( struct V_8 * V_9 , T_7 V_251 )
{
...
int F_189 ( struct V_8 * V_9 , T_1 V_254 , T_6 V_82 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
T_1 V_62 = ( V_254 - V_255 ) << 4 ;
if ( ! F_190 ( V_9 -> V_19 ) || ! F_32 ( V_2 ) )
return 1 ;
if ( V_254 == 0x830 )
F_139 ( V_2 , V_144 , ( T_1 ) ( V_82 >> 32 ) ) ;
return F_139 ( V_2 , V_62 , ( T_1 ) V_82 ) ;
}
int F_191 ( struct V_8 * V_9 , T_1 V_254 , T_6 * V_82 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
...
int F_192 ( struct V_8 * V_9 , T_1 V_62 , T_6 V_82 )
{
struct V_1 * V_2 = V_9 -> V_11 . V_2 ;
if ( ! F_51 ( V_9 ) )
return 1 ;
...
int F_194 ( struct V_8 * V_9 , T_6 V_82 )
{
T_6 V_174 = V_82 & ~ V_84 ;
if ( ! F_195 ( V_174 , 4 ) )
return 1 ;
...
if ( ! F_73 ( V_9 ) )
return 0 ;
return F_196 ( V_9 -> V_19 , & V_9 -> V_11 . V_81 . V_82 ,
V_174 , sizeof( T_3 ) ) ;
}
