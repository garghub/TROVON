...
V_275 = F_154 ( V_225 , V_273 ,
V_274 ) ;
V_277 = V_273 [ V_238 -> V_235 . V_254 . V_256 [ 0 ] ] ;
F_52 ( F_160 ( V_52 , V_277 ) ) ;
return 1 ;
}
static int F_161 ( struct V_224 * V_225 ,
struct V_226 * V_227 )
{
T_2 V_52 = V_225 -> V_211 ;
T_1 V_33 ;
...
static int F_163 ( struct V_224 * V_225 ,
struct V_237 * V_238 )
{
T_2 V_52 = V_225 -> V_211 ;
T_2 V_282 ;
F_52 ( F_164 ( V_52 , & V_282 ) ) ;
...
F_52 ( F_166 ( V_52 , V_282 ) ) ;
return 1 ;
}
static int F_167 ( struct V_48 * V_49 ,
struct V_208 * V_209 )
{
struct V_203 * V_85 = V_49 -> V_85 ;
struct V_204 V_207 ;
...
static int F_171 ( struct V_48 * V_49 ,
...
static int F_172 ( struct V_224 * V_207 )
{
T_2 V_52 = V_207 -> V_211 ;
struct V_208 V_209 ;
int V_103 , V_33 ;
for ( V_103 = 0 ; V_103 < 32 ; V_103 ++ ) {
V_33 = F_173 ( V_52 , V_103 ,
& V_209 .
V_214 ,
& V_209 .
V_221 ) ;
...
static int F_174 ( struct V_224 * V_225 ,
struct V_226 * V_227 )
{
int V_33 ;
T_1 V_214 , V_221 ;
...
static int F_177 ( struct V_224 * V_225 ,
struct V_237 * V_238 )
{
int V_240 ;
T_2 V_52 = V_225 -> V_211 ;
...
static int F_180 ( struct V_224 * V_225 ,
struct V_226 * V_227 )
{
...
static int F_182 ( struct V_224 * V_225 ,
struct V_237 * V_238 )
{
T_2 V_52 = V_225 -> V_211 ;
T_1 V_289 ;
...
static int F_184 ( struct V_224 * V_225 ,
struct V_237 * V_238 )
{
int V_240 ;
T_2 V_52 = V_225 -> V_211 ;
...
static int F_187 ( struct V_224 * V_225 ,
struct V_226 * V_227 )
{
struct V_48 * V_49 =
...
static int F_191 ( struct V_224 * V_225 ,
struct V_237 * V_238 )
{
struct V_48 * V_49 =
(struct V_48 * ) ( V_225 -> V_84 ) ;
...
static int F_194 ( struct V_224 * V_225 ,
struct V_226 * V_227 )
{
V_227 -> type = V_234 ;
V_227 -> V_228 = 1 ;
...
static int F_197 ( struct V_224 * V_225 ,
struct V_237 * V_238 )
{
int V_240 ;
T_2 V_52 = V_225 -> V_211 ;
...
static int F_199 ( struct V_224 * V_225 ,
struct V_226 * V_227 )
{
V_227 -> type = V_234 ;
V_227 -> V_228 = 1 ;
...
static int F_204 ( struct V_48 * V_49 )
{
struct V_203 * V_85 ;
unsigned int V_54 = 0 ;
...
break;
case V_312 :
V_33 = F_179 ( V_49 , & V_209 ) ;
break;
case V_313 :
V_33 = F_186 ( V_49 , & V_209 ) ;
break;
case V_314 :
V_33 = F_171 ( V_49 , & V_209 , V_305 ) ;
break;
case V_63 :
V_33 = F_201 (
V_49 , & V_209 ) ;
...
V_33 += F_189 ( V_52 , & V_258 ) ;
if ( ! V_33 )
F_209 ( V_17 , L_87 ,
V_297 , V_303 [ V_258 ] ) ;
}
}
static void F_210 ( struct V_48 * V_49 )
{
struct V_324 * V_325 ;
if ( ! F_211 ( V_49 -> V_85 , L_88 , & V_325 ) )
F_212 ( V_325 , V_49 , F_208 ) ;
}
static int F_213 ( struct V_329 * V_184 , struct V_330 * V_330 )
{
if ( V_331 )
return 0 ;
else
...
static int F_216 ( struct V_329 * V_184 , struct V_330 * V_330 ,
unsigned int V_102 , unsigned long V_149 )
{
if ( V_331 )
return F_217 ( V_330 , V_102 , V_149 ) ;
else
return - V_332 ;
}
...
if ( V_333 )
* V_333 = NULL ;
V_33 = F_219 ( V_49 -> V_85 , L_89 , V_191 , & V_184 ) ;
if ( V_33 < 0 )
return V_33 ;
strcpy ( V_184 -> V_40 , L_90 ) ;
V_184 -> V_212 = V_334 ;
V_184 -> V_335 . V_336 = F_213 ;
V_184 -> V_335 . V_337 = F_216 ;
V_184 -> V_335 . V_338 = F_214 ;
V_184 -> V_84 = V_49 ;
if ( V_333 )
* V_333 = V_184 ;
return 0 ;
}
static int F_220 ( struct V_339 * V_339 ,
...
{
struct V_342 * V_156 = F_222 ( V_339 ) ;
F_228 ( V_156 -> V_203 ) ;
V_156 -> V_203 = NULL ;
F_230 ( V_339 ) ;
}
