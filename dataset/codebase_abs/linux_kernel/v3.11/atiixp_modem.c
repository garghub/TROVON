...
if ( ! V_2 -> V_52 [ V_16 ] )
continue;
F_59 ( V_2 -> V_52 [ V_16 ] , V_107 , F_60 ( V_105 ) ) ;
F_59 ( V_2 -> V_52 [ V_16 ] , V_108 , 0 ) ;
}
return V_89 ;
}
...
V_89 = F_74 ( V_2 -> V_129 , L_7 , V_130 , 1 , 1 , & V_126 ) ;
if ( V_89 < 0 )
return V_89 ;
F_75 ( V_126 , V_131 , & V_132 ) ;
F_75 ( V_126 , V_133 , & V_134 ) ;
V_126 -> V_135 = V_136 ;
V_126 -> V_53 = V_2 ;
...
static T_4 F_77 ( int V_139 , void * V_140 )
{
...
if ( ( V_89 = F_79 ( V_149 , & V_52 , & V_2 -> V_52 [ V_16 ] ) ) < 0 ) {
V_2 -> V_52 [ V_16 ] = NULL ;
F_33 ( L_8 , V_16 ) ;
continue;
}
...
{
struct V_166 * V_24 = F_81 ( V_165 ) ;
struct V_167 * V_129 = F_82 ( V_165 ) ;
...
static int F_89 ( struct V_164 * V_165 )
{
struct V_166 * V_24 = F_81 ( V_165 ) ;
struct V_167 * V_129 = F_82 ( V_165 ) ;
struct V_1 * V_2 = V_129 -> V_53 ;
...
static void F_96 ( struct V_174 * V_175 ,
struct V_176 * V_177 )
{
struct V_1 * V_2 = V_175 -> V_53 ;
int V_16 ;
for ( V_16 = 0 ; V_16 < 256 ; V_16 += 4 )
F_97 ( V_177 , L_12 , V_16 , F_2 ( V_2 -> V_7 + V_16 ) ) ;
}
static void F_98 ( struct V_1 * V_2 )
{
struct V_174 * V_175 ;
if ( ! F_99 ( V_2 -> V_129 , L_13 , & V_175 ) )
F_100 ( V_175 , V_2 , F_96 ) ;
}
...
static int F_106 ( struct V_179 * V_164 )
{
struct V_1 * V_2 = V_164 -> V_180 ;
return F_101 ( V_2 ) ;
}
static int F_107 ( struct V_167 * V_129 ,
struct V_166 * V_24 ,
struct V_1 * * V_181 )
{
static struct V_182 V_27 = {
. V_183 = F_106 ,
} ;
struct V_1 * V_2 ;
int V_89 ;
...
V_2 -> V_24 = V_24 ;
V_2 -> V_139 = - 1 ;
if ( ( V_89 = F_111 ( V_24 , L_7 ) ) < 0 ) {
F_105 ( V_2 ) ;
F_86 ( V_24 ) ;
return V_89 ;
}
V_2 -> V_6 = F_112 ( V_24 , 0 ) ;
V_2 -> V_7 = F_113 ( V_24 , 0 ) ;
if ( V_2 -> V_7 == NULL ) {
F_14 ( V_65 L_14 ) ;
F_101 ( V_2 ) ;
return - V_172 ;
}
if ( F_114 ( V_24 -> V_139 , F_77 , V_185 ,
V_186 , V_2 ) ) {
...
F_94 ( V_24 ) ;
F_115 ( V_2 -> V_139 ) ;
if ( ( V_89 = F_116 ( V_129 , V_187 , V_2 , & V_27 ) ) < 0 ) {
F_101 ( V_2 ) ;
return V_89 ;
}
F_117 ( V_129 , & V_24 -> V_165 ) ;
* V_181 = V_2 ;
return 0 ;
}
static int F_118 ( struct V_166 * V_24 ,
const struct V_188 * V_189 )
{
struct V_167 * V_129 ;
struct V_1 * V_2 ;
int V_89 ;
V_89 = F_119 ( V_190 , V_191 , V_192 , 0 , & V_129 ) ;
if ( V_89 < 0 )
return V_89 ;
strcpy ( V_129 -> V_193 , L_16 ) ;
strcpy ( V_129 -> V_194 , L_17 ) ;
if ( ( V_89 = F_107 ( V_129 , V_24 , & V_2 ) ) < 0 )
goto V_195;
V_129 -> V_53 = V_2 ;
if ( ( V_89 = F_21 ( V_2 ) ) < 0 )
goto V_195;
if ( ( V_89 = F_78 ( V_2 , V_196 ) ) < 0 )
goto V_195;
if ( ( V_89 = F_73 ( V_2 ) ) < 0 )
goto V_195;
F_98 ( V_2 ) ;
...
static void F_123 ( struct V_166 * V_24 )
{
F_122 ( F_124 ( V_24 ) ) ;
}
