...
int V_109 , V_62 ;
struct V_83 * V_84 ;
int V_186 , V_167 , V_155 , V_159 ;
V_186 = V_2 -> V_187 & V_188 ;
V_155 = V_186 ? V_189 : 1 ;
V_167 = V_186 ? V_190 : V_180 ;
V_159 = V_186 ? V_191 : V_116 ;
if ( F_108 ( V_2 -> V_16 ) != V_192 &&
F_108 ( V_2 -> V_16 ) != V_193 )
return;
...
char V_194 [] = L_14 ;
struct V_85 * V_86 = & V_84 -> V_86 ;
struct V_195 * V_196 = & V_84 -> V_89 . V_197 . V_71 ;
struct V_198 * V_199 = & V_84 -> V_89 . V_197 . V_91 ;
int V_109 ;
F_60 ( & V_196 -> V_92 , V_200 ,
V_201 ) ;
F_85 ( V_196 -> V_197 . V_95 , F_86 ( V_2 -> V_16 ) ) ;
F_63 ( & V_84 -> V_112 , V_196 , sizeof( * V_196 ) ) ;
F_63 ( & V_84 -> V_114 , V_199 , sizeof( * V_199 ) ) ;
V_86 -> V_110 = F_58 ;
V_86 -> V_111 = & V_106 ;
V_86 -> V_71 = & V_84 -> V_112 ;
V_86 -> V_113 = & V_84 -> V_114 ;
...
struct V_145 * V_146 = V_2 -> V_16 ;
struct V_85 * V_86 = & V_84 -> V_86 ;
struct V_204 * V_205 = & V_84 -> V_89 . V_206 . V_71 ;
struct V_96 * V_207 = & V_84 -> V_89 . V_206 . V_91 ;
int V_109 , V_208 ;
F_60 ( & V_205 -> V_92 , V_209 ,
V_201 ) ;
F_85 ( V_205 -> V_206 . V_210 . V_95 , F_86 ( V_146 ) ) ;
V_208 = F_115 ( V_205 -> V_206 . V_211 , F_112 ( V_146 ) ,
V_201 ) ;
V_205 -> V_206 . V_212 = V_208 ;
F_63 ( & V_84 -> V_112 , V_205 , sizeof( * V_205 ) ) ;
F_63 ( & V_84 -> V_114 , V_207 , sizeof( * V_207 ) ) ;
V_86 -> V_110 = F_58 ;
V_86 -> V_111 = & V_106 ;
V_86 -> V_71 = & V_84 -> V_112 ;
V_86 -> V_113 = & V_84 -> V_114 ;
...
{
struct V_216 * V_217 = V_18 ;
struct V_85 * V_218 = V_217 -> V_219 ;
struct V_220 * V_221 = V_217 -> V_222 ;
V_221 -> V_223 = V_217 -> V_224 . V_225 ;
V_221 -> V_226 . V_227 . V_27 = V_228 ;
V_221 -> V_229 = V_218 -> V_27 ? - V_34 : 0 ;
V_217 -> V_230 ( V_217 ) ;
}
static struct V_23 * F_119 ( struct V_216 * V_217 )
{
T_1 V_231 ;
T_4 V_232 ;
struct V_1 * V_2 ;
...
V_2 = (struct V_1 * ) V_217 -> V_146 -> V_236 [ 0 ] ;
switch ( V_232 ) {
case V_237 :
...
struct V_1 * V_2 )
{
struct V_85 * V_240 = V_217 -> V_219 ;
struct V_241 * V_242 = V_217 -> V_242 ;
struct V_53 * V_54 ;
T_1 V_39 ;
if ( V_242 ) {
V_54 = F_122 ( V_2 , V_242 -> V_243 ) ;
if ( ! V_54 )
return - V_244 ;
V_39 = V_54 -> V_39 ;
F_72 ( & V_54 -> V_122 ) ;
} else
V_39 = F_46 ( V_217 -> V_233 -> V_234 . V_245 . V_246 ) ;
V_240 -> V_110 = F_118 ;
return F_87 ( V_2 , V_39 , V_240 , V_217 -> V_71 -> V_247 / V_38 ) ;
}
static int F_123 ( struct V_216 * V_217 ,
struct V_1 * V_2 )
{
int V_109 ;
struct V_85 * V_248 = V_217 -> V_219 ;
struct V_23 * V_24 ;
V_24 = F_119 ( V_217 ) ;
if ( ! V_24 )
return - V_244 ;
...
return V_109 ;
V_248 -> V_110 = F_120 ;
V_109 = F_64 ( V_24 , V_248 , NULL , V_217 -> V_71 -> V_247 / V_38 ) ;
if ( V_109 )
F_32 ( V_24 ) ;
return V_109 ;
}
...
struct V_145 * V_146 ;
struct V_1 * V_2 ;
struct V_85 * V_86 = V_217 -> V_219 ;
V_146 = V_217 -> V_242 ? F_125 ( V_217 -> V_242 ) : V_217 -> V_146 ;
V_2 = (struct V_1 * ) V_146 -> V_236 [ 0 ] ;
if ( ! ( F_29 ( & V_2 -> V_27 ) & V_142 ) )
return - V_244 ;
V_86 -> V_71 = V_217 -> V_249 . V_250 ;
V_86 -> V_113 = V_217 -> V_224 . V_250 ;
V_86 -> V_111 = V_217 ;
switch ( V_217 -> V_233 -> V_251 ) {
case V_252 :
case V_253 :
return F_121 ( V_217 , V_2 ) ;
case V_254 :
case V_255 :
return F_123 ( V_217 , V_2 ) ;
default:
return - V_244 ;
}
}
int F_126 ( struct V_216 * V_217 )
{
return - V_178 ;
}
...
{
struct V_41 * V_256 ;
V_256 = F_128 ( sizeof( struct V_41 ) , V_156 ) ;
if ( ! V_256 )
return - V_120 ;
V_2 -> V_42 = V_256 ;
F_35 ( & V_256 -> V_43 , V_257 , V_2 ) ;
F_35 ( & V_256 -> V_44 , V_258 , V_2 ) ;
F_35 ( & V_256 -> V_45 , V_259 , V_2 ) ;
F_35 ( & V_256 -> V_46 , V_260 , V_2 ) ;
return 0 ;
}
