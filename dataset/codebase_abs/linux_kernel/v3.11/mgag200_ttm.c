...
int F_42 ( struct V_80 * V_66 , int V_15 , int V_95 ,
T_1 V_34 , struct V_27 * * V_96 )
{
struct V_1 * V_57 = V_66 -> V_97 ;
struct V_27 * V_49 ;
T_3 V_98 ;
int V_79 ;
...
if ( ! V_49 )
return - V_99 ;
V_79 = F_43 ( V_66 , & V_49 -> V_29 , V_15 ) ;
if ( V_79 ) {
F_14 ( V_49 ) ;
return V_79 ;
}
V_49 -> V_29 . V_100 = NULL ;
V_49 -> V_28 . V_5 = & V_57 -> V_4 . V_5 ;
V_49 -> V_28 . V_5 -> V_101 = V_66 -> V_101 ;
F_18 ( V_49 , V_92 | V_50 ) ;
V_98 = F_44 ( & V_57 -> V_4 . V_5 , V_15 ,
sizeof( struct V_27 ) ) ;
V_79 = F_45 ( & V_57 -> V_4 . V_5 , & V_49 -> V_28 , V_15 ,
V_102 , & V_49 -> V_51 ,
...
static inline T_4 F_46 ( struct V_27 * V_28 )
{
return V_28 -> V_28 . V_60 ;
}
int F_47 ( struct V_27 * V_28 , T_2 V_103 , T_4 * V_104 )
{
int V_105 , V_79 ;
if ( V_28 -> V_106 ) {
V_28 -> V_106 ++ ;
...
F_18 ( V_28 , V_103 ) ;
for ( V_105 = 0 ; V_105 < V_28 -> V_51 . V_93 ; V_105 ++ )
V_28 -> V_90 [ V_105 ] |= V_107 ;
V_79 = F_48 ( & V_28 -> V_28 , & V_28 -> V_51 , false , false ) ;
if ( V_79 )
return V_79 ;
V_28 -> V_106 = 1 ;
if ( V_104 )
...
V_113 = V_53 -> V_115 ;
V_57 = V_113 -> V_116 -> V_66 -> V_97 ;
return F_55 ( V_53 , V_111 , & V_57 -> V_4 . V_5 ) ;
}
