...
T_1 V_61 , T_5 V_70 , int V_71 , int V_44 )
{
struct V_66 * V_31 ;
struct V_3 * V_4 ;
int V_72 ;
...
V_4 -> V_11 = F_3 ;
V_4 -> V_5 = F_1 ;
V_4 -> V_5 ( V_86 , V_4 -> V_7 + V_27 ) ;
V_73 = V_4 -> V_11 ( V_4 -> V_7 + V_27 ) ;
V_73 &= V_86 ;
if ( V_73 != V_86 ) {
V_4 -> V_11 = F_7 ;
V_4 -> V_5 = F_5 ;
...
goto V_87;
F_15 ( V_4 ) ;
V_72 = F_35 ( V_4 -> V_61 , F_25 , 0 , V_81 , V_4 ) ;
if ( V_72 )
goto V_87;
V_72 = F_36 ( & V_4 -> V_75 ) ;
if ( V_72 ) {
...
static int F_43 ( struct V_89 * V_45 )
{
struct V_90 * V_91 ;
struct V_68 * V_92 ;
int V_61 , V_71 = 0 , V_44 = 8 ;
struct V_66 * V_31 ;
T_3 V_93 ;
V_91 = V_45 -> V_45 . V_94 ;
if ( V_91 ) {
...
const T_6 * V_95 ;
int V_56 ;
V_95 = F_45 ( V_45 -> V_45 . V_85 , L_5 ,
& V_56 ) ;
if ( V_95 && V_56 >= sizeof( * V_95 ) )
V_71 = F_46 ( V_95 ) ;
}
#endif
if ( ! V_71 ) {
...
V_92 = F_47 ( V_45 , V_96 , 0 ) ;
if ( ! V_92 )
return - V_97 ;
V_61 = F_48 ( V_45 , 0 ) ;
if ( V_61 < 0 )
return - V_98 ;
V_31 = F_27 ( & V_45 -> V_45 , V_92 , V_61 , V_45 -> V_99 , V_71 ,
V_44 ) ;
if ( ! V_31 )
return - V_97 ;
if ( V_91 ) {
for ( V_93 = 0 ; V_93 < V_91 -> V_100 ; V_93 ++ )
F_49 ( V_31 , V_91 -> V_101 + V_93 ) ;
}
F_50 ( V_45 , V_31 ) ;
return 0 ;
}
static int F_51 ( struct V_89 * V_45 )
{
F_41 ( F_52 ( V_45 ) ) ;
return 0 ;
}
