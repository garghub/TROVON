...
void T_3 (F_32)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_45 ,
int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_48 ) ( V_43 , V_45 , 0 ) ;
}
void T_3 (F_33)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_45 ,
int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_49 ) ( V_43 , V_45 , 0 ) ;
}
void T_3 (F_34)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_50 ,
unsigned int V_51 , int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_52 ) ( V_43 , V_50 , V_51 , 0 ) ;
}
void T_3 (F_35)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_45 ,
int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_53 ) ( V_43 , V_45 , 0 ) ;
}
void T_3 (F_36)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_45 ,
int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_54 ) ( V_43 , V_45 , 0 ) ;
}
void T_3 (F_37)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_45 ,
int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_55 ) ( V_43 , V_45 , 0 ) ;
}
void T_3 (F_38)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_45 ,
unsigned int V_56 , int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_57 ) ( V_43 , V_45 , V_56 , 0 ) ;
}
void T_3 (F_39)( T_1 * * V_43 , struct V_33 * * V_44 , unsigned int V_45 ,
unsigned int V_56 , int V_25 )
{
F_23 ( V_44 , * V_43 , V_25 ) ;
T_3 ( V_58 ) ( V_43 , V_45 , V_56 , 0 ) ;
}
