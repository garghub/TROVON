...
F_75 ( V_1 ) ;
V_1 -> V_136 = F_11 ( V_125 -> V_31 ) ;
V_1 -> V_137 = F_11 ( V_125 -> V_35 ) ;
V_1 -> V_138 = F_11 ( V_125 -> V_39 ) ;
F_8 ( V_1 ) ;
F_76 ( V_44 , V_139 ) ;
ASSERT ( F_15 ( V_44 ) ) ;
F_56 ( V_42 , V_44 ) ;
if ( V_42 ) {
error = F_77 ( V_42 , V_134 ) ;
if ( error )
goto V_98;
}
* V_124 = V_1 ;
...
T_1 * * V_124 )
{
struct V_10 * V_141 = V_7 -> V_12 ;
struct V_142 * V_143 = F_80 ( V_141 , type ) ;
struct V_8 * V_1 ;
int error ;
ASSERT ( F_81 ( V_7 ) ) ;
...
type == V_144 ) ;
if ( V_140 ) {
ASSERT ( F_86 ( V_140 , V_92 ) ) ;
ASSERT ( F_87 ( V_140 , type ) == NULL ) ;
}
#endif
V_149:
F_88 ( & V_141 -> V_150 ) ;
...
F_92 ( & V_141 -> V_150 ) ;
V_156:
ASSERT ( ( V_140 == NULL ) || F_86 ( V_140 , V_92 ) ) ;
F_100 ( V_1 ) ;
* V_124 = V_1 ;
return ( 0 ) ;
}
...
struct V_8 * V_1 )
{
struct V_10 * V_141 = V_1 -> V_93 -> V_12 ;
struct V_8 * V_160 ;
struct V_8 * V_161 ;
F_102 ( V_1 ) ;
F_88 ( & V_141 -> V_162 ) ;
if ( F_2 ( & V_1 -> V_2 ) ) {
F_103 ( & V_1 -> V_2 , & V_141 -> V_163 ) ;
V_141 -> V_164 ++ ;
F_69 ( V_165 ) ;
}
F_92 ( & V_141 -> V_162 ) ;
...
struct V_168 * V_169 )
{
T_15 * V_170 = (struct V_171 * ) V_169 ;
T_1 * V_1 = V_170 -> V_172 ;
struct V_173 * V_174 = V_169 -> V_175 ;
if ( ( V_169 -> V_176 & V_177 ) &&
V_169 -> V_178 == V_170 -> V_179 ) {
F_110 ( & V_174 -> V_180 ) ;
if ( V_169 -> V_178 == V_170 -> V_179 )
F_111 ( V_174 , V_169 , V_181 ) ;
else
F_112 ( & V_174 -> V_180 ) ;
}
F_113 ( V_1 ) ;
...
F_117 ( V_1 ) ;
if ( F_118 ( V_7 ) ) {
struct V_168 * V_169 = & V_1 -> V_182 . V_183 ;
V_1 -> V_94 &= ~ V_184 ;
F_110 ( & V_7 -> V_185 -> V_180 ) ;
if ( V_169 -> V_176 & V_177 )
F_111 ( V_7 -> V_185 , V_169 ,
V_181 ) ;
else
F_112 ( & V_7 -> V_185 -> V_180 ) ;
error = F_55 ( V_113 ) ;
goto V_186;
}
...
V_1 -> V_94 &= ~ V_184 ;
F_121 ( V_7 -> V_185 , & V_1 -> V_182 . V_179 ,
& V_1 -> V_182 . V_183 . V_178 ) ;
if ( F_18 ( & V_7 -> V_56 ) ) {
struct V_59 * V_187 = (struct V_59 * ) V_125 ;
V_187 -> V_188 = F_7 ( V_1 -> V_182 . V_183 . V_178 ) ;
F_20 ( ( char * ) V_187 , sizeof( struct V_59 ) ,
V_60 ) ;
}
F_122 ( V_44 , F_109 ,
& V_1 -> V_182 . V_183 ) ;
...
if ( V_189 && V_190 ) {
ASSERT ( V_189 != V_190 ) ;
if ( F_30 ( V_189 -> V_15 . V_17 ) >
F_30 ( V_190 -> V_15 . V_17 ) ) {
F_88 ( & V_190 -> V_3 ) ;
F_128 ( & V_189 -> V_3 , V_191 ) ;
} else {
F_88 ( & V_189 -> V_3 ) ;
F_128 ( & V_190 -> V_3 , V_191 ) ;
}
} else if ( V_189 ) {
F_88 ( & V_189 -> V_3 ) ;
} else if ( V_190 ) {
