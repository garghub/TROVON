...
int
F_32 ( T_2 V_45 , V_12 * V_46 )
{
int V_47 ;
return F_33 ( & V_45 , 1 , 0 ,
V_46 , & V_47 ) ;
}
int
F_34 ( T_2 V_45 , V_12 * V_46 )
{
int V_47 ;
return F_33 ( & V_45 , 1 , V_48 ,
V_46 , & V_47 ) ;
}
static int
F_35 ( int * V_49 )
...
F_41 ( & V_52 , V_54 ,
F_42 ( V_50 ) / 1000 ) ;
F_43 ( F_44 ( F_40 () , V_53 ) , & V_56 ) ;
V_50 -= ( int ) ( V_56 . V_57 * 1000 + V_56 . V_58 / 1000 ) ;
if ( V_50 < 0 )
V_50 = 0 ;
}
V_51 = V_50 != 0 ;
...
int
F_33 ( T_2 * V_59 , int V_60 , int V_49 ,
V_12 * V_46 , int * V_47 )
{
int V_51 = 1 ;
int V_29 ;
