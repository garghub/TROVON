...
if ( V_50 == 0x1095 && ( V_51 == 0x3726 || V_51 == 0x3826 ) ) {
T_1 V_3 ;
...
static int F_40 ( struct V_7 * V_33 , const T_1 * V_90 )
{
...
static int F_41 ( struct V_7 * V_33 , unsigned int V_98 )
{
struct V_1 * V_2 = V_33 -> V_2 ;
struct V_5 * V_6 = V_2 -> V_6 ;
...
struct V_1 * V_83 ;
V_54 = F_49 ( V_2 , 0 , V_106 , V_107 , V_108 ,
V_109 ) ;
if ( V_54 ) {
F_50 ( V_2 , L_31 ) ;
goto V_56;
...
static int F_58 ( struct V_1 * V_2 , int * V_123 )
{
struct V_5 * V_6 = V_2 -> V_6 ;
unsigned long V_17 ;
...
V_115:
if ( ! F_60 ( V_6 ) ) {
V_54 = F_61 ( V_6 , V_87 -> V_106 , V_87 -> V_107 ,
V_87 -> V_108 , V_87 -> V_109 , NULL ) ;
if ( V_54 ) {
F_62 (dev, &ap->link, ALL)
F_53 ( V_33 ) ;
return V_54 ;
}
if ( V_8 -> V_131 != V_102 )
...
V_54 = F_48 ( V_6 , V_87 -> V_106 , V_87 -> V_107 ,
...
if ( V_54 )
goto V_132;
V_54 = F_61 ( V_6 , V_87 -> V_133 , V_87 -> V_134 ,
V_87 -> V_135 , V_87 -> V_136 , & V_2 ) ;
if ( V_54 )
goto V_137;
V_54 = F_63 ( & V_6 -> V_2 , V_138 , & V_129 ) ;
if ( V_54 == 0 )
F_57 ( & V_6 -> V_2 , V_138 , V_129 ) ;
F_30 (link, ap, EDGE)
if ( V_2 -> V_139 > V_140 )
return 0 ;
if ( V_8 -> V_17 & V_60 ) {
