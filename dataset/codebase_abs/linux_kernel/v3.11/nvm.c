...
V_55 = 2 * F_18 ( F_6 ( V_60 -> V_58 ) ) ;
V_54 = F_19 ( F_6 ( V_60 -> V_59 ) ) ;
if ( V_55 > V_67 ) {
F_5 ( V_2 , L_12 ,
V_55 ) ;
V_27 = - V_38 ;
...
V_27 = F_8 ( V_2 , V_54 , V_60 -> V_6 ,
V_55 ) ;
if ( V_27 < 0 ) {
F_5 ( V_2 , L_15 , V_27 ) ;
break;
}
V_60 = ( void * ) ( V_60 -> V_6 + V_55 ) ;
}
V_65:
F_22 ( V_57 ) ;
return V_27 ;
...
F_11 ( V_2 -> V_41 -> V_42 , L_16 ) ;
V_69 = F_24 ( V_2 -> V_36 -> V_71 -> V_72 ,
V_73 ) ;
if ( ! V_69 )
return - V_74 ;
for ( V_68 = 0 ; V_68 < F_25 ( V_75 ) ; V_68 ++ ) {
V_3 = V_75 [ V_68 ] ;
V_27 = F_10 ( V_2 , V_3 , V_69 ) ;
if ( V_27 < 0 )
break;
V_70 = F_26 ( V_69 , V_27 , V_73 ) ;
if ( ! V_70 ) {
V_27 = - V_74 ;
break;
}
