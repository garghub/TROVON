...
{
struct V_95 V_96 [ 2 ] ;
struct V_97 * V_98 = V_94 -> V_99 . V_100 ;
struct V_93 * V_10 ;
struct V_101 * V_102 ;
struct V_103 * V_103 ;
int V_59 = - V_104 ;
V_102 = F_48 ( sizeof( * V_102 ) , V_105 ) ;
if ( ! V_102 ) {
F_49 ( & V_94 -> V_99 , L_17 ) ;
goto V_106;
}
V_10 = F_50 ( L_18 , V_107 ) ;
if ( ! V_10 ) {
F_49 ( & V_94 -> V_99 , L_19 ) ;
goto V_108;
}
V_103 = F_51 ( & V_94 -> V_99 , L_20 ) ;
if ( F_52 ( V_103 ) ) {
F_49 ( & V_94 -> V_99 , L_21 ) ;
V_59 = F_53 ( V_103 ) ;
goto V_109;
...
V_10 -> V_99 . V_111 = & V_94 -> V_99 ;
V_10 -> V_99 . V_112 = & V_113 ;
V_10 -> V_99 . V_114 = V_113 ;
V_102 -> V_99 = & V_94 -> V_99 ;
V_102 -> V_10 = V_10 ;
V_102 -> V_103 = V_103 ;
V_98 -> V_115 = & V_116 ;
F_55 ( V_94 , V_102 ) ;
...
V_59 = F_58 ( V_10 , V_98 , sizeof( * V_98 ) ) ;
if ( V_59 ) {
F_49 ( & V_94 -> V_99 , L_24 ) ;
goto V_120;
}
