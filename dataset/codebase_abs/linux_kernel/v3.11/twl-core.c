...
if ( F_33 ( V_215 ) && V_38 -> V_216 ) {
V_71 = F_29 ( V_29 , L_32 ,
V_38 -> V_216 , sizeof( * V_38 -> V_216 ) , false ,
0 , 0 ) ;
if ( F_34 ( V_71 ) )
return F_35 ( V_71 ) ;
}
...
{
int V_217 = 0 ;
V_217 |= F_12 ( V_29 , V_219 ,
V_218 ) ;
V_217 |= F_12 ( V_29 , V_220 ,
V_218 ) ;
return V_217 ;
}
...
V_27 |= V_225 ;
if ( clock && clock -> V_226 )
V_27 |= V_227 ;
V_217 |= F_38 () ;
V_217 |= F_12 ( V_29 , V_27 , V_30 ) ;
V_217 |= F_37 () ;
if ( V_217 < 0 )
F_7 ( L_36 , V_14 , V_217 ) ;
}
static int F_44 ( struct V_228 * V_46 )
{
...
struct V_11 * V_12 = & V_3 -> V_17 [ V_229 ] ;
...
static int
F_48 ( struct V_228 * V_46 , const struct V_231 * V_232 )
{
struct V_69 * V_38 = V_46 -> V_47 . V_233 ;
struct V_234 * V_235 = V_46 -> V_47 . V_236 ;
struct V_43 * V_44 ;
struct V_237 * V_238 ;
int V_70 = 0 ;
int V_45 ;
...
if ( F_49 ( V_46 -> V_240 , V_241 ) == 0 ) {
F_22 ( & V_46 -> V_47 , L_40 ) ;
V_45 = - V_242 ;
goto free;
}
V_3 = F_50 ( & V_46 -> V_47 , sizeof( struct V_243 ) ,
V_244 ) ;
if ( ! V_3 ) {
V_45 = - V_48 ;
goto free;
...
if ( F_2 () ) {
F_54 ( V_232 -> V_36 ) ;
V_70 = F_55 ( & V_46 -> V_47 , V_46 -> V_254 ) ;
} else {
...
if ( V_235 )
V_45 = F_57 ( V_235 , NULL , NULL , & V_46 -> V_47 ) ;
else
V_45 = F_32 ( V_38 , V_70 , V_232 -> V_64 ) ;
V_24:
if ( V_45 < 0 )
F_44 ( V_46 ) ;
free:
