...
F_12 ( & V_55 -> V_60 ) ;
F_13 ( V_61 , L_4 ,
V_43 -> V_62 , V_44 , V_48 , V_55 ) ;
V_51 = & V_43 -> V_63 [ V_56 ] . V_64 ;
F_14 ( & V_2 -> V_65 -> V_66 , F_15 ( V_51 ) ,
F_16 ( V_51 ) , V_67 ) ;
V_59 = F_17 ( V_51 -> V_59 ) - 1 ;
#ifdef F_18
if ( ( V_59 - 1 ) > ( V_68 + 2 ) ) {
F_19 ( L_5 ) ;
F_20 () ;
...
while ( V_59 > 0 ) {
V_53 = & V_43 -> V_63 [ V_56 ] . V_71 ;
F_22 ( & V_2 -> V_65 -> V_66 , F_15 ( V_53 ) ,
F_16 ( V_53 ) , V_67 ) ;
if ( -- V_59 )
V_56 = F_11 ( F_21 ( V_56 ) ) ;
}
...
{
struct V_73 * V_74 ;
T_3 V_75 , V_76 , V_77 = V_43 -> V_78 ;
unsigned int V_45 = 0 , V_46 = 0 ;
#ifdef F_18
if ( F_27 ( V_2 -> V_79 ) )
return - 1 ;
#endif
V_74 = F_28 ( V_2 -> V_66 , V_43 -> V_62 ) ;
V_75 = F_17 ( * V_43 -> V_80 ) ;
V_76 = V_43 -> V_81 ;
while ( V_76 != V_75 ) {
T_3 V_82 ;
...
F_13 ( V_61 ,
L_6 ,
V_43 -> V_62 , V_75 , V_76 , V_82 ) ;
V_77 = F_10 ( V_2 , V_43 , V_82 ,
& V_45 , & V_46 ) ;
V_76 ++ ;
}
F_29 ( V_74 , V_45 , V_46 ) ;
...
F_40 ( V_7 -> V_93 ,
F_41 ( F_17 ( V_90 -> V_94 . V_95 [ V_40 ] ) ) ) ;
F_13 ( V_96 , L_7 ,
V_88 - 1 , F_17 ( V_90 -> V_94 . V_95 [ V_88 - 1 ] ) ) ;
F_12 ( ( void * ) ( V_7 -> V_93 ) ) ;
F_37 ( V_7 ,
F_17 ( V_90 -> V_94 . V_95 [ V_88 - 1 ] ) ) ;
V_86 = F_41 ( V_7 -> V_87 ) ;
V_91 = V_86 >> V_97 ;
V_92 = F_41 ( V_7 -> V_98 ) >> V_97 ;
if ( V_91 + 1 != V_92 )
V_91 ++ ;
for ( V_40 = V_92 ; V_40 != V_91 ; V_40 = F_42 ( V_40 ) ) {
if ( F_24 ( V_7 -> V_93 [ V_40 ] ) )
break;
V_7 -> V_93 [ V_40 ] = V_99 ;
V_39 += V_100 ;
}
...
const struct V_101 * V_90 ,
bool * V_102 )
{
if ( ( V_2 -> V_66 -> V_103 & V_104 ) &&
( V_90 -> V_105 & V_106 ) ) {
enum V_107 V_108 ;
V_108 = V_90 -> V_105 & V_109 ;
* V_102 = ( V_108 == V_110 ) ||
( V_108 == V_111 ) ;
return F_45 ( V_90 -> V_112 ) ;
}
* V_102 = false ;
return 0 ;
}
static void F_46 ( struct V_5 * V_7 , T_3 V_113 ,
T_3 V_114 , T_3 V_115 ,
struct V_101 * V_90 )
{
struct V_1 * V_2 = V_7 -> V_2 ;
struct V_116 * V_117 = & V_7 -> V_118 [ V_114 ] ;
struct V_116 * V_119 = & V_7 -> V_118 [ V_115 ] ;
struct V_120 * V_121 = & V_7 -> V_122 [ V_115 ] ;
T_5 V_123 ;
struct V_21 * V_23 = & V_7 -> V_23 [ V_113 ] ;
struct V_116 * V_124 = & V_23 -> V_124 ;
if ( V_23 -> V_125 != V_126 )
F_19 ( L_9 , V_113 ) ;
V_123 = F_47 ( & V_2 -> V_65 -> V_66 ,
V_124 -> V_127 + V_128 ,
V_7 -> V_129 , V_130 ) ;
if ( F_27 ( F_48 ( & V_2 -> V_65 -> V_66 , V_123 ) ) ) {
F_49 ( V_7 , V_114 , V_115 ) ;
V_23 -> V_125 = V_131 ;
return;
}
V_119 -> V_127 = V_124 -> V_127 ;
F_50 ( V_119 , V_123 , V_123 ) ;
V_121 -> V_132 = F_51 ( F_52 ( V_123 ) ) ;
V_121 -> V_133 = F_51 ( F_53 ( V_123 ) ) ;
* V_124 = * V_117 ;
V_23 -> V_134 =
F_17 ( V_90 -> V_135 . V_69 ) ;
V_23 -> V_136 = F_17 ( V_90 -> V_136 ) ;
V_23 -> V_125 = V_137 ;
V_23 -> V_138 = F_17 ( V_90 -> V_138 ) ;
V_23 -> V_139 = V_90 -> V_139 ;
V_23 -> V_140 = F_44 ( V_2 , V_90 , & V_23 -> V_102 ) ;
if ( V_7 -> V_141 == V_142 ) {
T_3 V_143 = F_17 ( V_90 -> V_144 ) ;
V_23 -> V_145 = V_146 / V_143 * V_143 ;
V_23 -> V_143 = V_143 ;
}
#ifdef F_18
V_7 -> V_147 |= ( 1 << V_113 ) ;
