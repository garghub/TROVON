...
F_41 ( L_45 ) ;
F_49 ( V_1 , & V_108 ) ;
V_117 = F_44 ( V_108 . V_15 . V_123 . V_124 ) ;
if ( V_1 -> V_29 . V_85 . V_125 != V_117 )
V_1 -> V_29 . V_85 . V_125 = V_117 ;
F_41 ( L_46 , V_117 ) ;
...
V_114 [ 0 ] = V_112 [ 0 ] ;
V_114 [ 1 ] = V_112 [ 1 ] ;
memcpy ( & V_110 -> V_106 [ V_110 -> V_130 ] , & V_114 , V_115 ) ;
V_110 -> V_130 = ( V_110 -> V_130 + V_115 ) % V_110 -> V_131 ;
...
memcpy ( V_114 , & V_1 -> V_29 . V_110 . V_106 [ V_1 -> V_29 . V_110 . V_132 ] ,
V_115 ) ;
V_1 -> V_29 . V_110 . V_132 += V_115 ;
if ( V_1 -> V_29 . V_110 . V_132 >= V_1 -> V_29 . V_110 . V_131 )
V_1 -> V_29 . V_110 . V_132 = 0 ;
F_18 ( & V_1 -> V_129 , V_34 ) ;
if ( F_78 ( V_179 , V_114 , V_115 ) )
break;
V_181 ++ ;
V_179 += V_115 ;
V_60 += V_115 ;
...
V_1 -> V_2 . V_75 = V_74 ;
V_1 -> V_29 . V_30 = V_31 [ V_254 ] ;
V_1 -> V_29 . V_255 = V_256 ;
V_1 -> V_29 . V_257 = V_258 ;
V_1 -> V_29 . V_110 . V_38 = V_259 ;
V_1 -> V_29 . V_88 = V_145 ;
V_1 -> V_29 . V_260 = V_261 ;
V_1 -> V_29 . V_142 = V_262 ;
V_1 -> V_2 . V_67 = 0 ;
F_70 ( V_1 ) ;
...
int V_60 = - V_56 ;
F_41 ( L_92 , V_263 ) ;
V_1 = F_123 ( sizeof( struct V_1 ) , V_264 ) ;
if ( NULL == V_1 ) {
F_13 ( L_93 ) ;
return V_60 ;
}
V_1 -> V_29 . V_110 . V_131 = V_265 * V_115 ;
V_1 -> V_29 . V_110 . V_106 = F_123 ( V_1 -> V_29 . V_110 . V_131 , V_264 ) ;
if ( NULL == V_1 -> V_29 . V_110 . V_106 ) {
F_13 ( L_94 ) ;
goto V_266;
}
V_60 = F_124 ( V_1 , V_267 ) ;
if ( V_60 < 0 )
goto V_268;
V_1 -> V_2 . V_3 = V_269 ;
V_1 -> V_187 = V_196 ;
V_1 -> V_270 . V_271 = V_272 ;
V_1 -> V_270 . V_273 = V_274 ;
return V_60 ;
V_268:
