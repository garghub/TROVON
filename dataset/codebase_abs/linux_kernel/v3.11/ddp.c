...
goto V_42;
V_162 = - V_129 ;
V_2 = F_72 ( V_64 , V_167 , V_41 , & V_168 ) ;
if ( ! V_2 )
goto V_42;
V_162 = 0 ;
V_1 -> V_169 = & V_170 ;
...
if ( ! ( V_147 = F_103 ( V_147 , V_90 ) ) )
return 0 ;
V_205 = (struct V_204 * ) F_110 ( V_147 , sizeof( * V_205 ) - 4 ) ;
...
static int F_111 ( struct V_228 * V_229 , struct V_159 * V_1 , struct V_230 * V_231 ,
T_7 V_144 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_10 * V_11 = F_10 ( V_2 ) ;
struct V_5 * V_232 = (struct V_5 * ) V_231 -> V_233 ;
int V_59 = V_231 -> V_234 ;
int V_235 = 0 ;
struct V_5 V_236 , V_237 ;
struct V_146 * V_147 ;
struct V_31 * V_32 ;
struct V_204 * V_205 ;
int V_238 ;
...
goto V_42;
V_180 = - V_84 ;
if ( V_231 -> V_243 < sizeof( * V_232 ) ||
V_232 -> V_85 != V_86 )
goto V_42;
V_180 = - V_119 ;
if ( V_232 -> V_14 . V_17 == V_18 &&
! F_84 ( V_2 , V_186 ) ) {
goto V_42;
}
} else {
...
V_232 = & V_236 ;
V_232 -> V_85 = V_86 ;
V_232 -> V_12 = V_11 -> V_190 ;
V_232 -> V_14 . V_17 = V_11 -> V_192 ;
V_232 -> V_14 . V_15 = V_11 -> V_191 ;
}
F_112 ( V_2 , L_12 , V_2 ) ;
V_238 = sizeof( struct V_204 ) + V_144 + V_244 -> V_245 ;
if ( V_232 -> V_14 . V_15 || V_232 -> V_14 . V_17 == V_22 ) {
V_82 = F_36 ( & V_232 -> V_14 ) ;
} else {
struct V_39 V_246 ;
V_246 . V_17 = 0 ;
V_246 . V_15 = V_11 -> V_20 ;
V_82 = F_36 ( & V_246 ) ;
}
V_180 = V_88 ;
if ( ! V_82 )
...
V_32 = V_82 -> V_32 ;
F_112 ( V_2 , L_13 ,
V_2 , V_238 , V_32 -> V_142 ) ;
V_238 += V_32 -> V_247 ;
F_79 ( V_2 ) ;
V_147 = F_113 ( V_2 , V_238 , ( V_59 & V_239 ) , & V_180 ) ;
F_77 ( V_2 ) ;
if ( ! V_147 )
goto V_42;
V_147 -> V_2 = V_2 ;
F_114 ( V_147 , V_244 -> V_245 ) ;
F_114 ( V_147 , V_32 -> V_247 ) ;
V_147 -> V_32 = V_32 ;
F_112 ( V_2 , L_14 , V_2 ) ;
V_205 = (struct V_204 * ) F_115 ( V_147 , sizeof( struct V_204 ) ) ;
V_205 -> V_213 = F_28 ( V_144 + sizeof( * V_205 ) ) ;
V_205 -> V_210 = V_232 -> V_14 . V_15 ;
V_205 -> V_226 = V_11 -> V_20 ;
V_205 -> V_212 = V_232 -> V_14 . V_17 ;
V_205 -> V_225 = V_11 -> V_21 ;
V_205 -> V_223 = V_232 -> V_12 ;
V_205 -> V_248 = V_11 -> V_13 ;
F_112 ( V_2 , L_15 , V_2 , V_144 ) ;
V_180 = F_116 ( F_115 ( V_147 , V_144 ) , V_231 -> V_249 , V_144 ) ;
if ( V_180 ) {
F_90 ( V_147 ) ;
V_180 = - V_113 ;
goto V_42;
...
struct V_146 * V_251 = F_117 ( V_147 , V_41 ) ;
if ( V_251 ) {
V_235 = 1 ;
F_112 ( V_2 , L_16 , V_2 ) ;
F_101 ( V_32 , V_251 , & V_232 -> V_14 , NULL ) ;
}
}
if ( V_32 -> V_59 & V_60 || V_235 ) {
F_112 ( V_2 , L_17 , V_2 ) ;
F_118 ( V_147 ) ;
if ( V_205 -> V_212 == V_18 ) {
struct V_39 V_252 ;
...
V_244 -> V_253 ( V_244 , V_147 , V_32 -> V_254 ) ;
} else {
F_112 ( V_2 , L_18 , V_2 ) ;
if ( V_82 -> V_59 & V_93 ) {
V_237 . V_14 = V_82 -> V_75 ;
V_232 = & V_237 ;
}
F_101 ( V_32 , V_147 , & V_232 -> V_14 , NULL ) ;
}
F_112 ( V_2 , L_19 , V_2 , V_144 ) ;
V_42:
F_79 ( V_2 ) ;
return V_180 ? : V_144 ;
}
static int F_119 ( struct V_228 * V_229 , struct V_159 * V_1 , struct V_230 * V_231 ,
T_7 V_238 , int V_59 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_5 * V_24 = (struct V_5 * ) V_231 -> V_233 ;
struct V_204 * V_205 ;
int V_255 = 0 ;
int V_148 = 0 ;
int V_180 = 0 ;
struct V_146 * V_147 ;
V_147 = F_120 ( V_2 , V_59 & ~ V_239 ,
V_59 & V_239 , & V_180 ) ;
F_77 ( V_2 ) ;
if ( ! V_147 )
goto V_42;
V_205 = F_105 ( V_147 ) ;
V_255 = F_27 ( V_205 -> V_213 ) & 1023 ;
if ( V_2 -> V_256 != V_165 ) {
V_148 = sizeof( * V_205 ) ;
V_255 -= V_148 ;
}
...
V_180 = F_121 ( V_147 , V_148 , V_231 -> V_249 , V_255 ) ;
if ( ! V_180 ) {
if ( V_24 ) {
V_24 -> V_85 = V_86 ;
V_24 -> V_12 = V_205 -> V_248 ;
V_24 -> V_14 . V_17 = V_205 -> V_225 ;
V_24 -> V_14 . V_15 = V_205 -> V_226 ;
}
V_231 -> V_243 = sizeof( * V_24 ) ;
}
F_122 ( V_2 , V_147 ) ;
V_42:
F_79 ( V_2 ) ;
...
static int F_123 ( struct V_159 * V_1 , unsigned int V_102 , unsigned long V_103 )
{
int V_162 = - V_258 ;
struct V_1 * V_2 = V_1 -> V_2 ;
void T_2 * V_259 = ( void T_2 * ) V_103 ;
switch ( V_102 ) {
case V_260 : {
long V_261 = V_2 -> V_262 - F_124 ( V_2 ) ;
if ( V_261 < 0 )
V_261 = 0 ;
V_162 = F_125 ( V_261 , ( int T_2 * ) V_259 ) ;
break;
}
case V_263 : {
struct V_146 * V_147 = F_126 ( & V_2 -> V_30 ) ;
long V_261 = 0 ;
if ( V_147 )
V_261 = V_147 -> V_144 - sizeof( struct V_204 ) ;
V_162 = F_125 ( V_261 , ( int T_2 * ) V_259 ) ;
break;
}
case V_264 :
V_162 = F_127 ( V_2 , V_259 ) ;
break;
case V_265 :
V_162 = F_128 ( V_2 , V_259 ) ;
break;
case V_140 :
case V_138 :
V_162 = - V_119 ;
if ( F_52 ( V_118 ) )
V_162 = F_57 ( V_102 , V_259 ) ;
break;
case V_131 :
case V_117 :
case V_133 :
...
case V_137 :
F_129 () ;
V_162 = F_48 ( V_102 , V_259 ) ;
F_130 () ;
break;
}
return V_162 ;
}
static int F_131 ( struct V_159 * V_1 , unsigned int V_102 , unsigned long V_103 )
{
if ( V_102 == V_134 )
return F_123 ( V_1 , V_102 , ( unsigned long ) F_132 ( V_103 ) ) ;
return - V_258 ;
}
static int T_8 F_133 ( void )
{
int V_162 = F_134 ( & V_168 , 0 ) ;
if ( V_162 != 0 )
goto V_42;
( void ) F_135 ( & V_266 ) ;
V_244 = F_136 ( V_267 , F_102 ) ;
if ( ! V_244 )
F_53 ( V_268 ) ;
F_137 ( & V_269 ) ;
F_137 ( & V_270 ) ;
