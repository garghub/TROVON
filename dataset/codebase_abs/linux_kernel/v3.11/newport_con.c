...
static int F_44 ( struct V_97 * V_98 , unsigned char * V_148 )
{
return - V_141 ;
}
...
{
short V_163 , V_164 , V_165 , V_166 , V_167 , V_168 , V_64 ;
V_163 = V_107 << 3 ;
...
static int F_49 ( struct V_97 * V_104 )
{
return 0 ;
}
static int F_50 ( struct V_171 * V_172 ,
...
if ( ! F_51 ( V_175 , 0x10000 , L_4 ) )
return - V_180 ;
V_6 = (struct V_181 * )
F_52 ( V_175 , sizeof( struct V_181 ) ) ;
F_53 () ;
V_176 = F_54 ( & V_105 , 0 , V_86 - 1 , 1 ) ;
F_55 () ;
return V_176 ;
}
static void F_56 ( struct V_171 * V_172 )
{
F_57 ( & V_105 ) ;
F_58 ( ( void * ) V_6 ) ;
}
