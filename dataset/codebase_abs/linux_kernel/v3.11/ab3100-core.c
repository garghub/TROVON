...
int V_9 ;
int V_57 ;
V_3 = F_43 ( & V_82 -> V_2 , sizeof( struct V_3 ) , V_88 ) ;
if ( ! V_3 ) {
F_6 ( & V_82 -> V_2 , L_33 ) ;
return - V_68 ;
}
...
for ( V_57 = 0 ; V_91 [ V_57 ] . V_84 != 0x0 ; V_57 ++ ) {
if ( V_91 [ V_57 ] . V_84 == V_3 -> V_5 ) {
if ( V_91 [ V_57 ] . V_92 != NULL ) {
snprintf ( & V_3 -> V_93 [ 0 ] ,
sizeof( V_3 -> V_93 ) - 1 ,
L_36 ,
V_91 [ V_57 ] . V_92 ) ;
...
if ( V_9 )
goto V_98;
V_9 = F_49 ( & V_82 -> V_2 , & V_99 ) ;
if ( V_9 )
goto V_100;
for ( V_57 = 0 ; V_57 < F_40 ( V_101 ) ; V_57 ++ ) {
V_101 [ V_57 ] . V_87 = V_86 ;
V_101 [ V_57 ] . V_102 = sizeof( struct V_85 ) ;
}
V_9 = F_50 ( & V_82 -> V_2 , 0 , V_101 ,
F_40 ( V_101 ) , NULL , 0 , NULL ) ;
F_34 ( V_3 ) ;
return 0 ;
V_100:
V_98:
...
static int F_52 ( struct V_11 * V_82 )
{
struct V_3 * V_3 = F_53 ( V_82 ) ;
F_54 ( & V_82 -> V_2 ) ;
F_38 () ;
F_51 ( V_3 -> V_15 ) ;
return 0 ;
