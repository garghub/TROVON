...
{
struct V_81 V_82 ;
F_5 ( & V_12 -> V_2 , L_29 , V_8 , V_12 -> V_9 , V_12 ) ;
F_81 ( & V_12 -> V_49 ) ;
...
struct V_11 * F_85 ( struct V_50 * V_52 )
{
struct V_6 * V_2 ;
struct V_11 * V_12 = NULL ;
int V_96 = 0 ;
...
void F_86 ( struct V_79 * V_80 , int V_98 )
{
...
F_49 (dev, &w1_masters, w1_master_entry) {
F_5 ( & V_2 -> V_2 , L_30
L_31 , V_2 -> V_9 , V_80 -> V_100 ) ;
F_18 ( & V_2 -> V_32 ) ;
F_87 (sl, sln, &dev->slist, w1_slave_entry) {
...
void F_88 ( struct V_6 * V_2 , T_4 V_51 )
{
struct V_11 * V_12 ;
struct V_50 * V_35 ;
T_4 V_102 = F_46 ( V_51 ) ;
...
void F_90 ( struct V_6 * V_2 , V_24 V_103 , T_6 V_104 )
{
...
void F_95 ( struct V_6 * V_2 , V_24 V_103 ,
T_6 V_104 )
{
struct V_11 * V_12 , * V_99 ;
F_49 (sl, &dev->slist, w1_slave_entry)
F_96 ( V_87 , ( long * ) & V_12 -> V_88 ) ;
F_97 ( V_2 , V_103 , V_104 ) ;
F_87 (sl, sln, &dev->slist, w1_slave_entry) {
if ( ! F_98 ( V_87 , ( unsigned long * ) & V_12 -> V_88 ) && ! -- V_12 -> V_91 )
F_55 ( V_12 ) ;
else if ( F_98 ( V_87 , ( unsigned long * ) & V_12 -> V_88 ) )
V_12 -> V_91 = V_2 -> V_92 ;
}
if ( V_2 -> V_37 > 0 )
V_2 -> V_37 -- ;
}
static void F_99 ( struct V_6 * V_2 , V_24 V_103 )
{
F_95 ( V_2 , V_103 , F_88 ) ;
}
int F_100 ( void * V_116 )
{
struct V_6 * V_2 = (struct V_6 * ) V_116 ;
const unsigned long V_117 = F_101 ( V_41 * 1000 ) ;
while ( ! F_94 () ) {
if ( V_2 -> V_37 ) {
F_18 ( & V_2 -> V_32 ) ;
F_99 ( V_2 , V_118 ) ;
