...
static void F_125 ( struct V_3 * V_4 , T_1 V_205 ,
unsigned int V_206 )
{
...
V_207 ) ;
F_126 ( V_4 , V_205 , V_206 ) ;
}
static int F_127 ( struct V_3 * V_4 )
{
struct V_8 * V_9 ;
V_9 = F_128 ( sizeof( * V_9 ) , V_209 ) ;
if ( ! V_9 )
return - V_123 ;
F_129 ( & V_9 -> V_15 ) ;
V_4 -> V_9 = V_9 ;
...
V_9 -> V_43 = 0x01 ;
V_9 -> V_64 = 1 ;
V_9 -> V_68 = F_135 ( V_230 ) ;
V_9 -> V_69 = V_230 ;
V_9 -> V_15 . V_211 = 1 ;
V_9 -> V_15 . V_231 = 1 ;
V_4 -> V_212 = V_213 ;
F_100 ( V_4 , V_232 , V_233 ,
V_234 ) ;
F_101 ( V_4 , V_149 ) ;
if ( ! V_9 -> V_154 )
F_75 ( V_4 , V_235 ) ;
...
V_9 -> V_14 = 1 ;
V_9 -> V_15 . V_194 = 0x26 ;
V_9 -> V_68 = F_135 ( V_254 ) ;
V_9 -> V_69 = V_254 ;
F_100 ( V_4 , V_255 , V_256 ,
V_257 ) ;
F_101 ( V_4 , V_149 ) ;
F_136 ( V_4 ) ;
V_183 = F_110 ( V_4 ) ;
