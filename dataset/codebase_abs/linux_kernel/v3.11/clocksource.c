...
static T_1 F_56 ( struct V_25 * V_26 )
{
T_1 V_71 , V_72 ;
V_72 = 1ULL << ( 63 - ( F_57 ( V_26 -> V_14 + V_26 -> V_73 ) + 1 ) ) ;
V_72 = F_58 ( T_1 , V_72 , ( T_1 ) V_26 -> V_12 ) ;
V_71 = F_25 ( V_72 , V_26 -> V_14 - V_26 -> V_73 ,
V_26 -> V_15 ) ;
return V_71 - ( V_71 >> 3 ) ;
}
static struct V_25 * F_59 ( bool V_74 , bool V_75 )
{
struct V_25 * V_26 ;
if ( ! V_31 || F_16 ( & V_76 ) )
return NULL ;
...
void F_68 ( struct V_25 * V_26 , T_3 V_82 , T_3 V_83 )
{
T_1 V_84 ;
...
V_86 / V_82 , V_84 * V_82 ) ;
V_26 -> V_73 = F_55 ( V_26 ) ;
while ( ( V_26 -> V_14 + V_26 -> V_73 < V_26 -> V_14 )
|| ( V_26 -> V_14 - V_26 -> V_73 > V_26 -> V_14 ) ) {
V_26 -> V_14 >>= 1 ;
V_26 -> V_15 -- ;
V_26 -> V_73 = F_55 ( V_26 ) ;
}
...
int F_69 ( struct V_25 * V_26 , T_3 V_82 , T_3 V_83 )
{
F_68 ( V_26 , V_82 , V_83 ) ;
F_47 ( & V_67 ) ;
F_67 ( V_26 ) ;
...
int F_70 ( struct V_25 * V_26 )
{
V_26 -> V_73 = F_55 ( V_26 ) ;
F_71 ( V_26 -> V_14 + V_26 -> V_73 < V_26 -> V_14 ,
L_7 ,
V_26 -> V_35 ) ;
V_26 -> V_87 = F_56 ( V_26 ) ;
F_47 ( & V_67 ) ;
...
void F_73 ( struct V_25 * V_26 , int V_64 )
{
F_47 ( & V_67 ) ;
F_46 ( V_26 , V_64 ) ;
F_48 () ;
...
T_7 F_77 ( const char * V_93 , char * V_96 , T_7 V_97 )
{
T_7 V_70 = V_97 ;
if ( ! V_97 || V_97 >= V_98 )
return - V_99 ;
...
static T_6 F_78 ( struct V_89 * V_90 ,
struct V_91 * V_92 ,
const char * V_93 , T_7 V_94 )
{
T_7 V_70 ;
F_47 ( & V_67 ) ;
V_70 = F_77 ( V_93 , V_78 , V_94 ) ;
if ( V_70 >= 0 )
F_48 () ;
F_49 ( & V_67 ) ;
return V_70 ;
...
F_81 ( ( T_6 ) V_95 - V_94 , ( T_6 ) 0 ) ,
L_9 , V_101 -> V_35 ) ;
}
F_49 ( & V_67 ) ;
V_94 += snprintf ( V_93 + V_94 ,
F_81 ( ( T_6 ) V_95 - V_94 , ( T_6 ) 0 ) , L_10 ) ;
return V_94 ;
}
static int T_5 F_82 ( void )
{
int error = F_83 ( & V_102 , NULL ) ;
if ( ! error )
error = F_84 ( & V_103 ) ;
if ( ! error )
error = F_85 (
...
static int T_5 F_86 ( char * V_107 )
{
F_47 ( & V_67 ) ;
if ( V_107 )
F_87 ( V_78 , V_107 , sizeof( V_78 ) ) ;
F_49 ( & V_67 ) ;
return 1 ;
}
