...
V_205 -> V_214 -> V_215 = & V_125 -> V_126 ;
snprintf ( V_210 , sizeof( V_210 ) , L_29 ,
V_205 -> V_213 , V_205 -> V_214 -> V_216 ) ;
V_15 -> V_6 = F_124 ( & V_217 , V_210 , L_30 , V_15 ) ;
if ( F_125 ( V_15 -> V_6 ) ) {
V_7 = F_126 ( V_15 -> V_6 ) ;
goto V_218;
}
V_209 = F_127 ( & V_43 -> V_189 , V_208 ,
V_205 -> V_214 , NULL ) ;
if ( ! V_209 ) {
V_7 = - V_21 ;
goto V_219;
...
struct V_224 * V_225 )
{
struct V_190 * V_191 = F_137 ( V_223 ,
struct V_190 , V_223 ) ;
struct V_14 * V_15 = F_116 ( V_191 -> V_49 ) ;
if ( V_225 == V_191 -> V_226 && ! F_24 ( V_15 -> V_220 ) ) {
struct V_202 * V_203 = F_128 ( V_17 ) ;
if ( V_203 ) {
struct V_124 * V_125 = F_64 ( V_15 ) ;
struct V_3 * V_4 =
F_138 ( V_203 ) ;
...
static void F_139 ( struct V_222 * V_223 ,
struct V_16 * V_17 ,
struct V_224 * V_225 )
{
struct V_190 * V_191 = F_137 ( V_223 ,
...
static int F_141 ( struct V_42 * V_43 ,
struct V_224 * * V_225 , unsigned int V_227 )
{
struct V_228 * V_229 ;
struct V_190 * V_191 ;
struct V_14 * V_15 ;
struct V_124 V_125 = { . V_206 . V_230 = V_43 -> V_188 ,} ;
char V_210 [ V_211 ] ;
int V_7 , V_24 ;
for ( V_24 = 0 ; V_24 < V_227 ; V_24 ++ ) {
V_229 = F_137 ( V_225 [ V_24 ] , struct V_228 , V_225 ) ;
if ( V_229 -> V_231 == V_232 )
break;
}
if ( V_24 == V_227 || V_225 [ V_24 ] -> V_233 != V_234 ) {
F_3 ( V_43 -> V_189 . V_2 , L_31 ) ;
return - V_21 ;
}
V_191 = F_142 ( V_43 -> V_189 . V_2 , sizeof( * V_191 ) , V_235 ) ;
if ( ! V_191 )
return - V_100 ;
V_125 . V_206 . V_214 = F_143 ( - V_236 ) ;
V_7 = F_108 ( & V_125 , V_191 ) ;
if ( V_7 < 0 )
return V_7 ;
V_191 -> V_226 = & V_229 -> V_225 ;
V_15 = F_114 ( V_191 ) ;
if ( ! V_15 ) {
F_113 ( V_191 -> V_49 ) ;
return - V_100 ;
}
V_191 -> V_223 . V_209 = V_225 ;
V_191 -> V_223 . V_237 = V_227 ;
V_191 -> V_223 . V_238 = F_136 ;
V_191 -> V_223 . V_239 = F_139 ;
V_191 -> V_223 . V_240 = F_140 ;
V_15 -> V_191 = V_191 ;
V_15 -> V_44 = V_43 -> V_189 . V_2 ;
snprintf ( V_210 , sizeof( V_210 ) , L_29 ,
V_229 -> V_225 . V_241 . V_242 . V_243 , V_229 -> V_225 . V_241 . V_242 . V_244 ) ;
V_15 -> V_6 = F_124 ( & V_217 , V_210 , L_30 , V_15 ) ;
if ( F_125 ( V_15 -> V_6 ) ) {
V_7 = F_126 ( V_15 -> V_6 ) ;
goto V_218;
}
V_7 = F_144 ( & V_43 -> V_189 , & V_191 -> V_223 ) ;
if ( ! V_7 )
return 0 ;
F_129 ( V_15 -> V_6 ) ;
V_218:
...
struct V_224 * * V_225 ;
int V_245 ;
for ( V_245 = 0 , V_225 = V_43 -> V_225 ; V_43 -> V_246 [ V_245 ] ; V_245 ++ ) {
F_141 ( V_43 , V_225 , V_43 -> V_246 [ V_245 ] ) ;
V_225 += V_43 -> V_246 [ V_245 ] ;
}
}
...
struct V_124 * V_125 = F_64 ( V_15 ) ;
struct V_204 * V_205 = & V_125 -> V_206 ;
struct V_1 * V_220 = NULL ;
int V_7 ;
F_147 ( V_15 -> V_49 , L_33 , F_148 ( V_15 -> V_49 ) ) ;
V_7 = F_149 ( & V_15 -> V_135 , 16 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_150 ( V_15 ) ;
if ( V_7 < 0 )
...
if ( V_7 < 0 && V_7 != - V_212 )
goto V_113;
} else if ( ! V_205 -> V_248 || ! V_205 -> V_249 ) {
V_7 = - V_60 ;
goto V_113;
} else {
F_54 ( & V_43 -> V_110 ) ;
...
goto V_113;
if ( V_205 -> V_250 )
V_7 = F_151 ( V_205 -> V_250 ) ;
V_7 = V_205 -> V_248 ( V_15 ) ;
if ( V_7 < 0 )
goto V_251;
V_220 = F_63 ( V_15 ) ;
if ( ! V_220 || ! V_220 -> V_158 || ! F_152 ( V_220 ) ||
! F_62 ( V_220 -> V_158 -> V_119 ) ) {
V_205 -> V_249 ( V_15 ) ;
V_7 = - V_21 ;
goto V_252;
}
...
if ( V_125 -> V_206 . V_214 ) {
F_131 ( V_15 ) ;
} else {
struct V_1 * V_2 = F_63 ( V_15 ) ;
struct V_254 * V_255 = V_2 ? V_2 -> V_158 : NULL ;
if ( V_255 ) {
V_125 -> V_206 . V_249 ( V_15 ) ;
F_69 ( V_255 -> V_119 ) ;
}
}
if ( V_15 -> V_25 )
...
static int F_158 ( struct V_14 * V_15 , struct V_165 * V_71 )
{
struct V_16 * V_17 = F_11 ( V_15 ) ;
return F_12 ( V_17 , V_96 , V_256 , V_71 ) ;
}
static int F_159 ( struct V_14 * V_15 , const struct V_165 * V_71 )
{
struct V_16 * V_17 = F_11 ( V_15 ) ;
return F_12 ( V_17 , V_96 , V_257 , V_71 ) ;
}
static int F_160 ( struct V_14 * V_15 ,
struct V_184 * V_258 )
{
struct V_16 * V_17 = F_11 ( V_15 ) ;
return F_12 ( V_17 , V_96 , V_259 , V_258 ) ;
}
static int F_161 ( struct V_14 * V_15 ,
struct V_184 * V_258 )
{
struct V_16 * V_17 = F_11 ( V_15 ) ;
return F_12 ( V_17 , V_96 , V_260 , V_258 ) ;
}
...
struct V_16 * V_17 = F_11 ( V_15 ) ;
const struct V_22 * V_45 ;
T_7 V_261 = V_76 -> V_262 ;
struct V_75 V_263 = * V_76 ;
V_45 = F_14 ( V_15 , V_261 ) ;
if ( ! V_45 )
return - V_60 ;
V_263 . V_262 = V_45 -> V_95 ;
V_7 = F_12 ( V_17 , V_96 , V_77 , & V_263 ) ;
if ( V_7 < 0 )
return V_7 ;
* V_76 = V_263 ;
V_76 -> V_262 = V_261 ;
...
return - V_60 ;
if ( ! V_43 -> V_58 -> V_173 )
V_43 -> V_58 -> V_173 = F_159 ;
if ( ! V_43 -> V_58 -> V_166 )
V_43 -> V_58 -> V_166 = F_158 ;
if ( ! V_43 -> V_58 -> V_164 )
V_43 -> V_58 -> V_164 = F_157 ;
if ( ! V_43 -> V_58 -> V_186 )
V_43 -> V_58 -> V_186 = F_161 ;
if ( ! V_43 -> V_58 -> V_185 )
V_43 -> V_58 -> V_185 = F_160 ;
if ( ! V_43 -> V_58 -> V_77 )
V_43 -> V_58 -> V_77 = F_162 ;
F_54 ( & V_117 ) ;
F_104 (ix, &hosts, list) {
if ( V_264 -> V_188 == V_43 -> V_188 ) {
V_7 = - V_81 ;
goto V_265;
}
}
V_7 = F_164 ( V_43 -> V_189 . V_2 , & V_43 -> V_189 ) ;
if ( V_7 < 0 )
goto V_265;
F_165 ( & V_43 -> V_266 , & V_267 ) ;
F_55 ( & V_117 ) ;
F_166 ( & V_43 -> V_121 ) ;
F_166 ( & V_43 -> V_110 ) ;
if ( V_43 -> V_246 )
...
void F_167 ( struct V_42 * V_43 )
{
struct V_14 * V_15 , * V_268 ;
struct V_190 * V_191 ;
F_168 ( V_269 ) ;
F_54 ( & V_117 ) ;
F_169 ( & V_43 -> V_266 ) ;
...
F_170 ( V_15 -> V_49 ) ;
F_171 ( & V_15 -> V_191 -> V_266 , & V_269 ) ;
}
F_55 ( & V_117 ) ;
F_104 (sasc, &notifiers, list) {
F_172 ( & V_191 -> V_223 ) ;
F_173 ( & V_191 -> V_49 -> V_2 ) ;
}
F_54 ( & V_117 ) ;
F_174 (icd, tmp, &devices, list)
if ( V_15 -> V_187 == V_43 -> V_188 )
F_155 ( V_15 ) ;
F_55 ( & V_117 ) ;
F_175 ( & V_43 -> V_189 ) ;
...
int V_270 = - 1 , V_24 ;
F_54 ( & V_117 ) ;
for ( V_24 = 0 ; V_24 < 256 && V_270 < 0 ; V_24 ++ ) {
V_270 = V_24 ;
F_104 (ix, &devices, list) {
if ( V_264 -> V_187 == V_15 -> V_187 && V_264 -> V_271 == V_24 ) {
V_270 = - 1 ;
break;
}
}
...
V_116 -> V_280 = & V_43 -> V_121 ;
V_15 -> V_116 = V_116 ;
return 0 ;
}
static int F_121 ( struct V_14 * V_15 )
{
const struct V_281 * type = V_15 -> V_116 -> V_2 . type ;
int V_7 ;
if ( ! V_15 -> V_44 )
return - V_21 ;
F_179 ( V_15 -> V_116 , V_15 ) ;
V_7 = F_180 ( V_15 -> V_116 , V_282 , - 1 ) ;
if ( V_7 < 0 ) {
...
static int F_181 ( struct V_192 * V_49 )
{
struct V_124 * V_125 = V_49 -> V_2 . V_215 ;
struct V_3 * V_4 = & V_125 -> V_126 ;
struct V_14 * V_15 ;
int V_7 ;
if ( ! V_125 )
return - V_60 ;
V_15 = F_142 ( & V_49 -> V_2 , sizeof( * V_15 ) , V_235 ) ;
if ( ! V_15 )
return - V_100 ;
