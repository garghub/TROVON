...
V_30 = 0 ;
F_8 ( & V_2 -> V_32 ) ;
F_15 (pt, &dev->filelist, lhead) {
if ( V_30 ++ >= V_29 ) {
V_40 -> V_42 = V_41 -> V_43 ;
V_40 -> V_44 = F_16 ( V_41 -> V_44 ) ;
V_40 -> V_45 = F_17 ( F_18 () , V_41 -> V_45 ) ;
V_40 -> V_46 = V_41 -> V_46 ;
V_40 -> V_47 = V_41 -> V_48 ;
F_11 ( & V_2 -> V_32 ) ;
return 0 ;
...
V_50 -> V_3 [ V_30 ] . V_54 = F_20 ( & V_2 -> V_57 [ V_30 ] ) ;
...
int F_25 ( struct V_1 * V_2 , void * V_3 ,
struct V_4 * V_5 )
{
F_26 ( L_1 ) ;
return 0 ;
