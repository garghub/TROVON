...
static void F_89 ( struct V_55 * V_42 , int V_56 )
{
struct V_94 * V_57 = V_42 -> V_57 ;
T_6 V_86 ;
int V_90 ;
...
int F_91 ( struct V_42 * V_43 , void * V_154 )
{
if ( F_76 ( V_43 ) )
F_89 ( V_55 ( V_43 ) , ( long ) V_154 ) ;
return 0 ;
}
static void F_92 ( struct V_124 * V_123 )
{
struct V_55 * V_42 =
F_12 ( V_123 , struct V_55 , V_123 . V_123 ) ;
struct V_94 * V_57 = V_42 -> V_57 ;
...
V_42 -> V_59 ,
F_94 ( V_65 ) ) ;
if ( V_42 -> V_105 == V_57 -> V_143 )
F_87 ( V_57 , 0 ) ;
F_71 ( & V_42 -> V_42 ) ;
}
return;
}
V_155 = F_95 ( V_57 -> V_42 ,
V_42 , F_82 ) ;
if ( V_155 ) {
F_96 ( V_155 ) ;
F_71 ( & V_42 -> V_42 ) ;
...
F_55 ( V_42 ) ;
F_44 ( & V_66 ) ;
V_125 = F_98 ( & V_120 , V_42 , 0 , 1 << V_160 ,
V_101 ) ;
F_45 ( & V_66 ) ;
if ( V_125 < 0 )
goto error;
...
V_42 -> V_42 . V_119 = F_99 ( V_161 , V_125 ) ;
...
static int F_102 ( struct V_55 * V_42 , int V_56 ,
bool * V_164 )
{
T_1 V_165 ;
int V_16 , V_90 ;
for ( V_16 = 0 ; V_16 < 6 ; V_16 ++ ) {
V_90 = F_35 ( V_42 , V_56 , V_16 , & V_165 ) ;
if ( V_90 != V_103 )
return V_90 ;
if ( V_16 == 0 && V_165 == 0 )
return V_93 ;
if ( V_165 != V_42 -> V_29 [ V_16 ] ) {
* V_164 = true ;
return V_103 ;
}
}
...
static void F_103 ( struct V_124 * V_123 )
{
struct V_55 * V_42 =
F_12 ( V_123 , struct V_55 , V_123 . V_123 ) ;
struct V_94 * V_57 = V_42 -> V_57 ;
...
bool V_164 ;
V_65 = F_102 ( V_42 , V_42 -> V_56 , & V_164 ) ;
if ( V_65 != V_103 )
goto V_166;
if ( ! V_164 ) {
if ( F_67 ( & V_42 -> V_129 ,
...
F_85 ( V_57 , L_18 ,
F_52 ( & V_42 -> V_42 ) , F_94 ( V_65 ) ) ;
V_167:
F_105 ( & V_42 -> V_129 , V_130 ) ;
F_86 ( & V_42 -> V_123 , F_63 ) ;
F_61 ( V_42 , V_127 ) ;
V_104:
if ( V_59 == V_57 -> V_143 -> V_59 )
F_87 ( V_57 , 0 ) ;
}
void F_106 ( struct V_94 * V_57 , struct V_139 * V_105 , int V_170 )
{
struct V_55 * V_42 ;
switch ( V_170 ) {
case V_171 :
V_172:
V_42 = F_50 ( sizeof( * V_42 ) , V_173 ) ;
if ( V_42 == NULL )
break;
F_105 ( & V_42 -> V_129 , V_157 ) ;
V_42 -> V_57 = F_107 ( V_57 ) ;
V_42 -> V_105 = F_108 ( V_105 ) ;
V_42 -> V_59 = V_105 -> V_59 ;
V_42 -> V_56 = V_57 -> V_56 ;
V_42 -> V_82 = V_105 == V_57 -> V_174 ;
F_109 ( & V_42 -> V_175 ) ;
F_110 ( & V_42 -> V_176 ) ;
V_105 -> V_86 = V_42 ;
F_111 ( & V_42 -> V_123 , F_92 ) ;
F_61 ( V_42 , V_177 ) ;
break;
case V_178 :
case V_179 :
...
F_84 () ;
V_42 -> V_56 = V_57 -> V_56 ;
if ( F_93 ( & V_42 -> V_129 ) == V_138 ) {
F_86 ( & V_42 -> V_123 , F_80 ) ;
F_61 ( V_42 , 0 ) ;
}
break;
case V_181 :
