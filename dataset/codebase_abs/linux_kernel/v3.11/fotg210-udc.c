...
{
struct V_9 * V_4 = F_102 ( & V_171 -> V_172 ) ;
F_103 ( & V_4 -> V_16 ) ;
F_104 ( V_4 -> V_5 ) ;
...
struct V_9 * V_4 = NULL ;
struct V_1 * V_32 [ V_176 ] ;
int V_75 = 0 ;
int V_86 ;
V_174 = F_108 ( V_171 , V_177 , 0 ) ;
if ( ! V_174 ) {
F_57 ( L_15 ) ;
return - V_178 ;
}
V_175 = F_108 ( V_171 , V_179 , 0 ) ;
if ( ! V_175 ) {
F_57 ( L_16 ) ;
return - V_178 ;
}
...
V_4 -> V_5 = F_109 ( V_174 -> V_182 , F_110 ( V_174 ) ) ;
if ( V_4 -> V_5 == NULL ) {
F_57 ( L_19 ) ;
goto V_183;
}
F_111 ( & V_4 -> V_20 ) ;
F_112 ( & V_171 -> V_172 , V_4 ) ;
V_4 -> V_16 . V_184 = & V_185 ;
V_4 -> V_16 . V_186 = V_114 ;
V_4 -> V_16 . V_172 . V_187 = & V_171 -> V_172 ;
V_4 -> V_16 . V_172 . V_188 = V_171 -> V_172 . V_188 ;
...
F_99 ( V_4 ) ;
F_96 ( V_4 ) ;
V_75 = F_113 ( V_175 -> V_182 , F_91 , V_195 ,
V_190 , V_4 ) ;
if ( V_75 < 0 ) {
F_57 ( L_20 , V_75 ) ;
goto V_196;
}
V_75 = F_114 ( & V_171 -> V_172 , & V_4 -> V_16 ) ;
if ( V_75 )
goto V_197;
F_115 ( & V_171 -> V_172 , L_21 , V_198 ) ;
return 0 ;
V_197:
V_196:
F_105 ( V_175 -> V_182 , V_4 ) ;
V_194:
F_45 ( & V_4 -> V_2 [ 0 ] -> V_2 , V_4 -> V_107 ) ;
V_183:
if ( V_4 -> V_5 )
