...
static T_2 F_30 ( int V_79 , void * V_80 )
{
struct V_6 * V_7 = V_80 ;
unsigned int V_27 ;
V_27 = F_7 ( V_7 -> V_20 + V_28 ) ;
...
{
struct V_6 * V_7 = F_32 ( V_86 ) ;
struct V_87 * V_88 = V_86 -> V_16 . V_89 ;
struct V_24 * V_24 ;
int V_14 ;
V_24 = F_33 ( & V_86 -> V_16 , L_14 ,
F_34 ( V_7 -> V_24 ) , 0 ,
V_7 -> V_20 + V_21 ,
V_90 , 3 ,
0 , NULL ) ;
...
if ( V_14 == - V_91 )
return 0 ;
F_6 ( & V_86 -> V_16 , L_15 , V_14 ) ;
return F_36 ( V_24 ) ;
}
V_14 = F_37 ( V_88 , V_92 , V_24 ) ;
if ( V_14 )
return V_14 ;
return 0 ;
}
...
if ( ! V_88 )
return - V_10 ;
V_7 = F_39 ( & V_86 -> V_16 , sizeof( * V_7 ) , V_96 ) ;
if ( ! V_7 )
return - V_97 ;
V_14 = F_40 ( V_88 , L_16 ) ;
if ( V_14 < 0 )
...
V_94 = F_44 ( V_86 , V_98 , 0 ) ;
V_7 -> V_20 = F_45 ( & V_86 -> V_16 , V_94 ) ;
if ( F_35 ( V_7 -> V_20 ) )
return F_36 ( V_7 -> V_20 ) ;
V_7 -> V_79 = F_46 ( V_86 , 0 ) ;
if ( V_7 -> V_79 < 0 ) {
V_14 = V_7 -> V_79 ;
F_6 ( & V_86 -> V_16 , L_20 ,
V_14 ) ;
...
V_7 -> V_16 = & V_86 -> V_16 ;
V_14 = F_47 ( & V_86 -> V_16 , V_7 -> V_79 , F_30 , 0 ,
L_21 , V_7 ) ;
if ( V_14 ) {
F_6 ( & V_86 -> V_16 , L_22 ) ;
return V_14 ;
