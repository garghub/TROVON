...
T_5 * V_33 ;
int V_7 = 0 ;
F_28 ( L_1 , V_34 , V_27 , V_28 , V_4 ? L_2 : L_3 ) ;
V_27 &= V_35 ;
V_2 = V_27 ;
V_32 = ( unsigned long ) V_28 << V_36 ;
V_3 = V_27 + V_32 ;
if ( F_10 ( ! F_29 ( V_4 ? V_37 : V_38 ,
V_27 , V_32 ) ) )
goto V_39;
F_28 ( L_4 , V_27 , V_3 ) ;
F_30 () ;
...
goto V_40;
if ( F_35 ( V_23 ) ) {
if ( ! F_19 ( ( T_3 * ) V_33 , V_41 , V_2 , V_18 ,
V_4 , V_6 , & V_7 ) )
goto V_40;
} else if ( F_20 ( V_33 ) ) {
if ( ! F_21 ( ( V_21 * ) V_33 , V_42 ,
V_2 , V_18 , V_4 , V_6 , & V_7 ) )
goto V_40;
