...
static int F_61 ( struct V_12 * V_1 , struct V_13 * V_118 ,
int V_24 , int V_83 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
...
static int F_67 ( struct V_130 * V_131 , struct V_12 * V_1 ,
...
F_9 ( V_2 ) ;
return F_69 ( V_17 , V_133 , V_24 ) ;
}
static int F_70 ( struct V_130 * V_131 , struct V_12 * V_1 ,
...
V_148 = V_147 ;
if ( F_73 ( V_148 , 0 , V_133 -> V_149 , V_144 ) ) {
if ( ! ( V_83 & V_150 ) )
F_74 ( & V_2 -> V_103 , V_147 ) ;
return - V_61 ;
}
F_75 ( V_133 , V_2 , V_147 ) ;
if ( V_2 -> V_137 == V_138 && V_133 -> V_139 ) {
struct V_151 * V_152 = F_76 ( V_147 ) ;
struct V_22 * V_13 =
(struct V_22 * ) V_133 -> V_139 ;
V_133 -> V_140 = sizeof( struct V_22 ) ;
F_3 ( L_20 , V_152 -> V_29 , V_152 -> V_39 ) ;
memset ( V_13 , 0 , sizeof( * V_13 ) ) ;
V_13 -> V_26 = V_27 ;
V_13 -> V_35 = V_153 ;
V_13 -> V_29 = V_152 -> V_29 ;
V_13 -> V_39 = V_152 -> V_39 ;
}
if ( ! ( V_83 & V_150 ) ) {
if ( V_2 -> V_137 == V_48 ||
V_2 -> V_137 == V_138 ||
...
struct V_1 * F_82 ( struct V_12 * V_1 , int type , T_5 V_157 )
{
struct V_1 * V_2 ;
struct V_16 * V_17 ;
V_2 = F_83 ( & V_158 , V_159 , V_157 , & V_160 ) ;
if ( ! V_2 )
return NULL ;
V_17 = V_16 ( V_2 ) ;
F_84 ( V_1 , V_2 ) ;
...
static int F_90 ( struct V_172 * V_172 , struct V_12 * V_1 ,
const struct V_35 * V_173 )
{
struct V_1 * V_2 ;
F_3 ( L_13 , V_1 ) ;
if ( V_1 -> type != V_48 &&
