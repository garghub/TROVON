...
F_88 ( V_236 , V_33 ) ;
F_89 ( V_246 , & V_33 -> V_208 . V_247 ) ;
V_33 -> V_26 . V_28 = & V_33 -> V_28 ;
F_90 ( & V_33 -> V_28 ,
1 + F_15 ( V_234 ) ) ;
if ( F_17 ( V_33 -> V_43 ) ) {
V_158 = F_91 ( & V_33 -> V_28 ,
& V_248 ,
V_166 ,
V_172 ,
0 , 0 ) ;
...
return 0 ;
exit:
F_94 ( V_33 -> V_208 . V_28 ) ;
return V_200 ;
}
static int F_95 ( struct V_235 * V_236 )
{
struct V_23 * V_33 = F_96 ( V_236 ) ;
F_94 ( V_33 -> V_208 . V_28 ) ;
F_97 ( & V_33 -> V_208 ) ;
F_98 ( & V_33 -> V_26 ) ;
F_77 ( V_33 -> V_225 ) ;
