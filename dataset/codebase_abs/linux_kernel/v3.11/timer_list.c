...
static int F_31 ( struct V_1 * V_2 , void * V_78 )
{
struct V_79 * V_80 = V_78 ;
if ( V_80 -> V_34 == - 1 && ! V_80 -> V_81 )
F_30 ( V_2 , V_80 -> V_10 ) ;
else if ( ! V_80 -> V_81 )
F_17 ( V_2 , V_80 -> V_34 , V_80 -> V_10 ) ;
#ifdef F_32
else if ( V_80 -> V_34 == - 1 && V_80 -> V_81 )
F_24 ( V_2 ) ;
else
F_23 ( V_2 , F_33 ( V_80 -> V_34 ) , V_80 -> V_34 ) ;
#endif
return 0 ;
}
void F_34 ( void )
...
static void * F_37 ( struct V_79 * V_80 , T_3 V_33 )
{
for (; V_33 ; V_33 -- ) {
V_80 -> V_34 = F_38 ( V_80 -> V_34 , V_82 ) ;
if ( V_80 -> V_34 >= V_83 ) {
#ifdef F_32
if ( ! V_80 -> V_81 ) {
V_80 -> V_34 = - 1 ;
...
static void * F_39 ( struct V_1 * V_84 , T_3 * V_33 )
{
struct V_79 * V_80 = V_84 -> V_85 ;
if ( ! * V_33 )
V_80 -> V_10 = F_6 ( F_35 () ) ;
V_80 -> V_34 = - 1 ;
V_80 -> V_81 = false ;
return F_37 ( V_80 , * V_33 ) ;
}
static void * F_40 ( struct V_1 * V_84 , void * V_78 , T_3 * V_33 )
{
struct V_79 * V_80 = V_84 -> V_85 ;
++ * V_33 ;
return F_37 ( V_80 , 1 ) ;
}
static void F_41 ( struct V_1 * V_86 , void * V_78 )
{
}
static int F_42 ( struct V_87 * V_87 , struct V_84 * V_88 )
{
return F_43 ( V_88 , & V_89 ,
sizeof( struct V_79 ) ) ;
}
static int T_4 F_44 ( void )
{
struct V_90 * V_91 ;
V_91 = F_45 ( L_39 , 0444 , NULL , & V_92 ) ;
if ( ! V_91 )
return - V_93 ;
return 0 ;
}
