...
for ( V_4 = 0 ; V_4 < V_58 -> V_73 ; V_4 ++ )
F_8 ( V_2 , V_4 , V_11 -> V_34 [ V_4 ] ) ;
F_23 ( V_2 -> V_80 , L_1 , V_2 -> V_64 ) ;
return 0 ;
}
static int F_24 ( struct V_55 * V_2 ,
const struct V_81 * V_82 )
{
return F_25 ( V_2 , & V_83 ,
V_82 -> V_84 ) ;
}
