...
static void F_32 ( struct V_34 * V_88 , struct V_89 * V_90 ,
struct V_12 * V_91 )
{
struct V_63 * V_64 = NULL ;
int V_73 ;
int V_92 , V_72 ;
for ( V_92 = V_72 = 0 ; V_92 < V_90 -> V_93 ; V_92 ++ ) {
V_64 = F_33 ( sizeof( struct V_63 ) , V_94 ) ;
if ( ! V_64 )
F_34 ( L_9 ) ;
#ifdef F_35
V_64 -> V_95 = V_90 -> V_95 ;
...
F_36 ( & V_64 -> V_76 ) ;
if ( V_90 -> V_97 )
V_64 -> V_97 = V_90 -> V_97 [ V_92 ] ;
V_73 = V_90 -> V_98 ( V_92 , V_64 ) ;
if ( V_73 > 0 ) {
V_73 = F_26 ( V_92 , V_64 ) ;
if ( V_73 ) {
F_37 ( V_64 ) ;
...
if ( V_90 -> V_99 )
V_64 -> V_2 = V_90 -> V_99 ( V_92 , V_64 ) ;
else
V_64 -> V_2 = F_38 ( V_88 , V_64 -> V_72 ,
V_90 -> V_100 , V_64 , & V_64 -> V_76 ) ;
if ( ! V_64 -> V_2 )
F_34 ( L_10 ) ;
V_72 = V_64 -> V_2 -> V_101 . V_19 + 1 ;
F_39 ( & V_64 -> V_102 , V_91 ) ;
} else {
F_37 ( V_64 ) ;
if ( V_73 < 0 )
break;
...
void F_40 ( struct V_34 * V_88 , struct V_89 * V_90 )
{
struct V_63 * V_64 ;
F_41 ( V_91 ) ;
F_42 ( V_103 ) ;
...
T_6 F_51 ( void * V_108 , const struct V_18 * V_79 ,
T_6 V_109 , T_6 V_110 )
{
struct V_5 * V_6 = V_108 ;
struct V_63 * V_64 = V_6 -> V_65 ;
T_6 V_20 = V_79 -> V_20 ;
if ( V_79 -> V_25 & V_80 && V_20 & 0x300 )
V_20 = ( V_20 + 0x3ff ) & ~ 0x3ff ;
V_20 = ( V_20 + V_110 - 1 ) & ~ ( V_110 - 1 ) ;
if ( V_64 -> V_96 )
return V_64 -> V_96 ( V_6 , V_79 , V_20 , V_109 , V_110 ) ;
return V_20 ;
}
int F_52 ( struct V_5 * V_6 , int V_111 )
{
T_2 V_54 , V_112 ;
int V_113 ;
struct V_18 * V_26 ;
...
int F_53 ( struct V_5 * V_6 , struct V_119 * V_120 ,
enum V_121 V_122 , int V_123 )
{
struct V_63 * V_124 = V_6 -> V_65 ;
unsigned long V_125 ;
if ( V_122 == V_126 ) {
return - V_115 ;
} else {
V_125 = V_120 -> V_127 + ( V_124 -> V_78 >> V_128 ) ;
}
V_120 -> V_129 = F_54 ( V_120 -> V_129 ) ;
if ( F_55 ( V_120 , V_120 -> V_130 , V_125 ,
V_120 -> V_131 - V_120 -> V_130 ,
V_120 -> V_129 ) )
return - V_132 ;
return 0 ;
}
void T_5 F_56 ( unsigned long V_133 )
{
struct V_134 V_135 = {
. V_136 = V_137 ,
. type = V_138 ,
