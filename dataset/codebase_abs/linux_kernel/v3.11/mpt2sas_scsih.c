...
V_6 -> V_142 = V_142 ;
V_6 -> V_72 = V_795 ++ ;
sprintf ( V_6 -> V_35 , L_369 , V_796 , V_6 -> V_72 ) ;
V_6 -> V_563 = V_563 ;
if ( V_72 -> V_43 == V_797 ) {
V_6 -> V_175 = 1 ;
V_6 -> V_273 = 1 ;
...
F_304 ( V_6 ) ;
F_305 ( V_142 ) ;
V_822 = F_306 ( V_563 , V_200 ) ;
F_3 ( V_58 L_378
L_379 , V_6 -> V_35 , V_563 ,
F_307 ( V_563 ) , V_822 ) ;
F_308 ( V_6 ) ;
F_309 ( V_563 ) ;
F_310 ( V_563 ) ;
