...
static int
F_39 ( const char T_3 * V_66 , T_2 V_67 , int V_68 )
{
T_1 V_2 ;
...
int
F_45 ( const char T_3 * V_66 , T_2 V_67 )
{
return F_39 ( V_66 , V_67 , V_82 ) ;
}
static void
...
if ( V_84 == NULL )
return;
while ( F_47 ( & F_48 ( V_84 ) -> V_87 ) != 1 && V_45 -- > 0 )
F_49 ( V_85 ) ;
if ( V_45 < 0 ) {
F_50 ( V_88
L_8 ,
...
F_53 (&d->skbpool, skb, tmp)
F_46 ( V_84 ) ;
F_54 ( & V_15 -> V_95 ) ;
}
struct V_14 *
F_55 ( T_1 V_96 , int V_97 , int V_98 )
{
struct V_14 * V_15 ;
int V_45 ;
T_1 V_2 ;
...
goto V_11;
V_15 = F_56 ( 1 , sizeof *V_15 , V_101 ) ;
if ( ! V_15 )
goto V_11;
V_15 -> V_50 = F_56 ( V_102 , sizeof( * V_15 -> V_50 ) , V_101 ) ;
if ( ! V_15 -> V_50 ) {
F_44 ( V_15 ) ;
V_15 = NULL ;
goto V_11;
...
static void
F_36 ( struct V_14 * V_15 , struct V_41 * V_40 )
{
struct V_36 * V_37 ;
