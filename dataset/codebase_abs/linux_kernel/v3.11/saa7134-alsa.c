...
if ( ! V_148 [ V_146 ] )
return - V_114 ;
V_37 = F_82 ( V_149 [ V_146 ] , V_81 [ V_146 ] , V_150 ,
sizeof( T_3 ) , & V_78 ) ;
if ( V_37 < 0 )
return V_37 ;
...
goto V_155;
F_86 ( V_78 , & V_50 -> V_64 -> V_2 ) ;
strcpy ( V_78 -> V_156 , L_15 ) ;
sprintf ( V_78 -> V_157 , L_17 ,
V_50 -> V_2 -> V_129 , V_50 -> V_152 , V_50 -> V_20 ) ;
F_57 ( V_158 L_18 , V_2 -> V_129 , V_78 -> V_157 , V_149 [ V_146 ] ) ;
if ( ( V_37 = F_87 ( V_78 ) ) == 0 ) {
V_159 [ V_146 ] = V_78 ;
return 0 ;
}
...
{
F_88 ( V_159 [ V_2 -> V_160 ] ) ;
V_159 [ V_2 -> V_160 ] = NULL ;
return 1 ;
}
...
V_164 = F_90 ;
F_57 ( V_158 L_19 ) ;
F_92 (list,&saa7134_devlist) {
V_2 = F_93 ( V_162 , struct V_1 , V_165 ) ;
if ( V_2 -> V_64 -> V_65 == V_166 )
F_57 ( V_158 L_20 ,
V_2 -> V_129 , V_167 [ V_2 -> V_168 ] . V_129 ) ;
else
F_89 ( V_2 ) ;
}
if ( V_2 == NULL )
