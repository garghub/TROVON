...
static void F_95 ( struct V_135 * V_136 , int error , int V_138 )
{
struct V_143 * V_144 = F_87 ( V_136 -> V_139 ) ;
struct V_1 * V_2 = F_85 ( V_136 -> V_139 ) ;
if ( error ) {
...
F_96 ( V_144 -> V_145 ) ;
F_97 ( V_2 , L_2 ,
V_136 -> V_150 , V_2 -> V_141 , V_2 -> V_140 ) ;
}
static void F_98 ( struct V_1 * V_2 )
{
struct V_151 * V_152 ;
unsigned int V_97 ;
struct V_116 * V_134 = & V_2 -> V_153 ;
struct V_5 * V_6 ;
struct V_67 * V_67 ;
unsigned int V_154 ;
F_99 ( V_2 ) ;
if ( ! V_2 -> V_155 )
return;
V_154 = F_100 ( V_2 , V_2 -> V_155 , sizeof( T_1 ) ) ;
V_67 = F_57 ( V_2 , V_156 , V_154 , V_2 -> V_155 ) ;
V_97 = sizeof( struct V_103 ) ;
F_30 (bd, head, bd_list) {
V_2 -> V_155 -- ;
if ( V_97 + sizeof( T_1 ) > V_2 -> V_157 . V_158 ) {
F_56 ( V_2 , V_67 ) ;
V_67 = F_58 ( V_78 , V_89 ) ;
V_152 = F_59 ( V_67 ) ;
F_60 ( V_152 ) ;
V_152 -> V_106 = F_61 ( V_107 ) ;
V_152 -> V_108 = F_61 ( V_159 ) ;
V_152 -> V_110 = F_61 ( V_160 ) ;
V_97 = sizeof( struct V_151 ) ;
}
* ( T_4 * ) ( F_59 ( V_67 ) + V_97 ) = F_75 ( V_6 -> V_161 ) ;
V_97 += sizeof( T_1 ) ;
}
F_5 ( V_2 , ! V_2 -> V_155 ) ;
F_56 ( V_2 , V_67 ) ;
}
static void F_101 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
struct V_116 * V_134 = & V_2 -> V_153 ;
struct V_5 * V_6 ;
struct V_19 * V_20 ;
...
return;
V_2 -> V_164 = 0 ;
V_2 -> V_165 = V_134 -> V_166 ;
}
static int F_104 ( struct V_135 * V_136 , unsigned int V_142 ,
struct V_103 * V_104 , T_4 * V_114 ,
int V_138 )
{
struct V_1 * V_2 = F_85 ( V_136 -> V_139 ) ;
unsigned int V_146 = F_88 ( V_104 -> V_101 ) ;
unsigned int V_167 = F_88 ( V_104 -> V_102 ) ;
struct V_3 * V_4 ;
unsigned int V_97 ;
T_1 V_83 ;
int V_168 = 1 ;
int error ;
if ( V_138 != 0 || F_88 ( V_104 -> V_100 ) != V_156 )
return 0 ;
V_97 = sizeof( struct V_103 ) ;
for (; V_146 ; F_89 ( V_2 , & V_142 ) , V_146 -- ) {
...
if ( ! V_168 )
F_105 ( V_2 , V_4 , V_159 ) ;
while ( V_97 + sizeof( T_1 ) <= V_2 -> V_157 . V_158 ) {
V_83 = F_90 ( * ( T_4 * ) ( V_4 -> V_37 + V_97 ) ) ;
error = F_106 ( V_2 , V_83 , V_142 ) ;
if ( error < 0 ) {
F_24 ( V_4 ) ;
return error ;
}
...
static void F_107 ( struct V_135 * V_136 , int error , int V_138 )
{
struct V_1 * V_2 = F_85 ( V_136 -> V_139 ) ;
if ( error ) {
F_108 ( V_2 ) ;
...
return;
F_97 ( V_2 , L_3 ,
V_136 -> V_150 , V_2 -> V_164 ) ;
F_108 ( V_2 ) ;
}
static void F_109 ( struct V_1 * V_2 )
{
unsigned int V_122 = F_78 ( V_2 ) / 2 ;
F_69 ( V_2 , V_122 , V_2 -> V_169 ,
& V_2 -> V_170 , 1 ) ;
}
static int F_110 ( struct V_135 * V_136 , unsigned int V_142 ,
struct V_103 * V_104 ,
T_4 * V_114 , int V_138 )
{
struct V_143 * V_144 = F_87 ( V_136 -> V_139 ) ;
...
static void F_112 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
struct V_116 * V_134 = & V_2 -> V_170 ;
struct V_5 * V_6 ;
if ( V_44 == NULL ) {
F_80 ( V_2 , F_81 ( V_134 ) ) ;
return;
