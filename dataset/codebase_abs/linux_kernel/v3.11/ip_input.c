...
return F_25 ( V_34 , V_35 , V_2 , V_2 -> V_9 , NULL ,
F_12 ) ;
}
...
goto V_80;
V_39 = F_2 ( V_2 ) ;
if ( F_31 ( F_49 ( ( T_1 * ) V_39 , V_39 -> V_43 ) ) )
goto V_82;
V_64 = F_50 ( V_39 -> V_83 ) ;
if ( V_2 -> V_64 < V_64 ) {
F_20 ( F_7 ( V_9 ) , V_84 ) ;
...
V_2 -> V_85 = V_2 -> V_86 + V_39 -> V_43 * 4 ;
memset ( F_29 ( V_2 ) , 0 , sizeof( struct V_87 ) ) ;
F_52 ( V_2 ) ;
return F_25 ( V_34 , V_88 , V_2 , V_9 , NULL ,
F_37 ) ;
V_82:
F_20 ( F_7 ( V_9 ) , V_89 ) ;
V_80:
