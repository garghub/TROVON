...
if ( ! V_103 )
goto V_73;
V_160 = F_96 ( V_21 , V_177 ) ;
if ( ! V_160 )
goto V_73;
V_170 = F_103 ( NULL , sizeof( * V_179 ) + V_175 ) ;
if ( ! V_170 )
goto V_73;
F_104 ( V_170 , V_175 ) ;
V_180 = sizeof( * V_179 ) ;
V_179 = (struct V_167 * ) F_105 ( V_170 , V_180 ) ;
V_179 -> V_181 . V_182 = V_183 ;
V_179 -> V_181 . V_184 = V_185 ;
memcpy ( V_179 -> V_147 , V_103 -> V_100 -> V_78 , V_7 ) ;
memcpy ( V_179 -> V_186 , V_177 -> V_129 , V_7 ) ;
V_179 -> V_181 . V_187 = V_188 ;
V_179 -> V_122 = V_122 ;
V_179 -> V_176 = F_106 ( V_136 ) ;
V_179 -> V_40 = V_189 ;
if ( V_178 )
V_179 -> V_40 |= V_190 ;
F_37 ( V_60 , V_21 , L_28 ,
V_177 -> V_129 , ( V_178 ? 'F' : '.' ) ) ;
F_109 ( V_21 , V_191 ) ;
if ( F_110 ( V_170 , V_177 , NULL ) != V_192 )
V_124 = 0 ;
V_73:
if ( V_103 )
F_54 ( V_103 ) ;
...
{
struct V_119 * V_193 ;
struct V_119 * V_194 = NULL ;
T_2 V_195 , V_196 , V_122 ;
int V_197 , V_124 = false ;
unsigned char * V_93 ;
bool V_178 ;
T_3 V_165 , V_171 ;
struct V_164 * V_170 = NULL ;
...
F_37 ( V_60 , V_21 ,
L_29 ,
V_179 -> V_147 , V_179 -> V_122 , V_179 -> V_186 ,
( V_179 -> V_40 & V_190 ? 'F' : '.' ) ) ;
V_193 = F_113 ( V_21 , V_179 -> V_186 ) ;
if ( ! V_193 )
goto V_73;
V_194 = F_113 ( V_21 , V_179 -> V_147 ) ;
if ( ! V_194 )
goto V_73;
V_195 = ( T_2 ) F_41 ( & V_193 -> V_135 ) ;
V_196 = V_179 -> V_122 ;
if ( V_195 != V_196 ||
V_179 -> V_176 != F_106 ( V_193 -> V_136 ) )
goto V_73;
if ( V_179 -> V_40 & V_190 ||
! V_193 -> V_93 )
V_178 = true ;
...
goto V_51;
F_104 ( V_170 , V_175 ) ;
V_198 = F_105 ( V_170 , V_174 ) ;
V_168 = (struct V_167 * ) V_198 ;
V_168 -> V_122 = V_196 ;
V_168 -> V_176 = F_106 ( V_171 ) ;
V_93 = V_170 -> V_10 + sizeof( * V_168 ) ;
memcpy ( V_93 , V_193 -> V_93 ,
V_193 -> V_155 ) ;
F_30 ( & V_193 -> V_156 ) ;
} else {
V_165 = ( T_3 ) F_41 ( & V_193 -> V_34 ) ;
V_165 *= sizeof( struct V_55 ) ;
V_122 = ( T_2 ) F_41 ( & V_193 -> V_135 ) ;
...
V_168 -> V_181 . V_182 = V_183 ;
V_168 -> V_181 . V_184 = V_185 ;
V_168 -> V_181 . V_187 = V_188 ;
memcpy ( V_168 -> V_147 , V_193 -> V_129 , V_7 ) ;
memcpy ( V_168 -> V_186 , V_179 -> V_147 , V_7 ) ;
V_168 -> V_40 = V_199 ;
if ( V_178 )
V_168 -> V_40 |= V_190 ;
F_37 ( V_60 , V_21 ,
L_30 ,
V_194 -> V_129 , V_193 -> V_129 , V_196 ) ;
F_109 ( V_21 , V_200 ) ;
V_197 = F_110 ( V_170 , V_194 , NULL ) ;
if ( V_197 != V_192 )
V_124 = true ;
goto V_73;
V_51:
...
F_37 ( V_60 , V_21 ,
L_31 ,
V_179 -> V_147 , V_179 -> V_122 ,
( V_179 -> V_40 & V_190 ? 'F' : '.' ) ) ;
V_201 = ( T_2 ) F_41 ( & V_21 -> V_23 . V_74 ) ;
V_196 = V_179 -> V_122 ;
V_33 = F_113 ( V_21 , V_179 -> V_147 ) ;
if ( ! V_33 )
goto V_73;
V_103 = F_108 ( V_21 ) ;
if ( ! V_103 )
goto V_73;
if ( V_179 -> V_40 & V_190 || V_201 != V_196 ||
! V_21 -> V_23 . V_95 )
V_178 = true ;
else
V_178 = false ;
...
V_165 = ( T_3 ) F_41 ( & V_21 -> V_23 . V_202 ) ;
V_165 *= sizeof( struct V_55 ) ;
...
( V_168 -> V_40 & V_190 ? 'F' : '.' ) ) ;
F_109 ( V_21 , V_200 ) ;
if ( F_110 ( V_170 , V_33 , NULL ) != V_192 )
V_124 = true ;
goto V_73;
V_51:
F_30 ( & V_21 -> V_23 . V_94 ) ;
...
if ( V_124 < 0 )
return V_124 ;
F_126 ( & V_21 -> V_23 . V_204 , V_205 ) ;
F_127 ( V_206 , & V_21 -> V_23 . V_204 ,
F_128 ( V_207 ) ) ;
return 1 ;
}
static void F_129 ( struct V_20 * V_21 )
{
struct V_208 * V_2 , * V_39 ;
F_26 ( & V_21 -> V_23 . V_209 ) ;
F_27 (node, safe, &bat_priv->tt.roam_list, list) {
F_28 ( & V_2 -> V_50 ) ;
F_16 ( V_2 ) ;
}
F_30 ( & V_21 -> V_23 . V_209 ) ;
}
...
if ( ! F_7 ( V_213 -> V_46 , V_212 ) )
continue;
if ( F_60 ( V_213 -> V_210 ,
V_211 ) )
continue;
if ( ! F_132 ( & V_213 -> V_214 ) )
goto V_51;
V_124 = true ;
break;
}
if ( ! V_124 ) {
V_213 = F_25 ( sizeof( * V_213 ) , V_44 ) ;
if ( ! V_213 )
goto V_51;
V_213 -> V_210 = V_68 ;
F_43 ( & V_213 -> V_214 ,
V_215 - 1 ) ;
memcpy ( V_213 -> V_46 , V_212 , V_7 ) ;
F_98 ( & V_213 -> V_50 , & V_21 -> V_23 . V_216 ) ;
V_124 = true ;
}
V_51:
F_30 ( & V_21 -> V_23 . V_209 ) ;
...
static void F_46 ( struct V_20 * V_21 , T_2 * V_212 ,
struct V_119 * V_33 )
{
struct V_164 * V_170 = NULL ;
struct V_217 * V_218 ;
...
goto V_73;
F_104 ( V_170 , V_175 ) ;
V_218 = (struct V_217 * ) F_105 ( V_170 , V_174 ) ;
V_218 -> V_181 . V_182 = V_219 ;
V_218 -> V_181 . V_184 = V_185 ;
V_218 -> V_181 . V_187 = V_188 ;
V_218 -> V_220 = 0 ;
V_103 = F_108 ( V_21 ) ;
if ( ! V_103 )
goto V_73;
memcpy ( V_218 -> V_147 , V_103 -> V_100 -> V_78 , V_7 ) ;
F_54 ( V_103 ) ;
memcpy ( V_218 -> V_186 , V_33 -> V_129 , V_7 ) ;
memcpy ( V_218 -> V_212 , V_212 , V_7 ) ;
F_37 ( V_60 , V_21 ,
L_36 ,
V_33 -> V_129 , V_212 ) ;
F_109 ( V_21 , V_221 ) ;
...
static void V_205 ( struct V_222 * V_204 )
{
struct V_223 * V_223 ;
struct V_224 * V_225 ;
struct V_20 * V_21 ;
V_223 = F_2 ( V_204 , struct V_223 , V_204 ) ;
V_225 = F_2 ( V_223 , struct V_224 , V_204 ) ;
V_21 = F_2 ( V_225 , struct V_20 , V_23 ) ;
F_61 ( V_21 ) ;
F_86 ( V_21 ) ;
F_95 ( V_21 ) ;
F_130 ( V_21 ) ;
...
return - V_229 ;
V_227 = F_135 ( V_21 -> V_23 . V_24 ,
V_75 , false ) ;
F_138 ( V_227 , & V_21 -> V_23 . V_202 ) ;
F_136 ( V_21 ) ;
...
if ( ! V_33 -> V_139 || V_122 != V_195 ||
V_33 -> V_136 != V_136 ) {
V_232:
F_37 ( V_60 , V_21 ,
L_39 ,
V_33 -> V_129 , V_122 , V_195 , V_136 ,
V_33 -> V_136 , V_154 ) ;
