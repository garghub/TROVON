...
if ( F_89 ( V_2 ) && F_114 ( V_2 ) && F_106 ( V_96 ) ) {
F_75 ( V_29 , L_26 ,
V_88 ) ;
F_97 ( V_96 ) ;
F_113 ( V_96 ) ;
...
V_95 = - V_104 ;
for ( V_101 = V_124 ; ; V_101 ++ )
if ( ( V_2 -> V_30 & V_101 -> V_125 ) == V_101 -> V_95 )
break;
if ( ! V_101 -> V_125 )
for ( V_101 = V_124 ; ; V_101 ++ )
if ( ( V_118 & V_101 -> V_125 ) == V_101 -> V_95 )
break;
...
void F_116 ( unsigned long V_29 , int V_28 , int V_30 )
{
struct V_126 * V_127 ;
unsigned long V_128 ;
struct V_129 V_130 = {
...
V_127 = & F_117 ( V_126 ) ;
F_118 ( & V_127 -> V_131 , V_128 ) ;
if ( F_119 ( & V_127 -> V_132 , & V_130 ) )
F_120 ( F_121 () , & V_127 -> V_133 ) ;
else
F_76 ( L_29 ,
V_29 ) ;
F_122 ( & V_127 -> V_131 , V_128 ) ;
F_123 ( V_126 ) ;
}
static void F_124 ( struct V_134 * V_133 )
{
struct V_126 * V_127 ;
...
for (; ; ) {
F_118 ( & V_127 -> V_131 , V_128 ) ;
V_135 = F_126 ( & V_127 -> V_132 , & V_130 ) ;
F_122 ( & V_127 -> V_131 , V_128 ) ;
if ( ! V_135 )
break;
F_102 ( V_130 . V_29 , V_130 . V_28 , V_130 . V_30 ) ;
}
}
...
int V_136 ;
F_128 (cpu) {
V_127 = & F_129 ( V_126 , V_136 ) ;
F_130 ( & V_127 -> V_131 ) ;
F_131 ( V_127 -> V_132 ) ;
F_132 ( & V_127 -> V_133 , F_124 ) ;
}
return 0 ;
}
int F_133 ( unsigned long V_29 )
{
struct V_1 * V_1 ;
struct V_1 * V_2 ;
int V_137 = 0 ;
...
static struct V_1 * F_134 ( struct V_1 * V_2 , unsigned long V_138 , int * * V_139 )
{
int V_140 = F_135 ( V_2 ) ;
if ( F_89 ( V_2 ) )
...
return F_138 ( V_140 , V_141 , 0 ) ;
}
static int F_139 ( struct V_1 * V_2 , unsigned long V_29 , int V_30 )
{
int V_33 ;
if ( V_30 & V_122 )
return 1 ;
...
if ( ! F_109 ( F_17 ( V_2 ) ) ) {
if ( F_89 ( V_2 ) ) {
F_30 ( L_34 , V_142 , V_29 ) ;
V_33 = 0 ;
} else if ( F_24 ( V_2 ) ) {
F_30 ( L_35 , V_142 , V_29 ) ;
V_33 = 0 ;
} else {
F_30 ( L_36 ,
V_142 , V_29 , V_2 -> V_30 ) ;
...
static int F_143 ( struct V_1 * V_1 , unsigned long V_29 , int V_30 )
{
int V_33 = F_139 ( V_1 , V_29 , V_30 ) ;
if ( V_33 == 1 && ! F_89 ( V_1 ) && ! F_22 ( V_1 ) ) {
F_113 ( V_1 ) ;
F_20 ( V_1 , 1 ) ;
V_33 = F_139 ( V_1 , V_29 , 0 ) ;
if ( ! F_22 ( V_1 ) ) {
F_30 ( L_37 ,
V_29 , V_1 -> V_30 ) ;
return - V_87 ;
...
static int F_144 ( struct V_1 * V_1 , int V_30 )
{
int V_33 ;
...
int F_146 ( struct V_1 * V_1 , int V_30 )
{
int V_33 ;
unsigned long V_29 = F_31 ( V_1 ) ;
struct V_1 * V_96 = F_147 ( V_1 ) ;
if ( F_93 ( V_1 ) ) {
F_30 ( L_40 , V_29 ) ;
return - V_104 ;
}
if ( ! F_89 ( V_1 ) && F_88 ( V_96 ) ) {
...
F_151 ( V_1 , V_147 +
F_152 ( V_1 ) ) ;
F_153 ( & V_1 -> V_148 , & V_146 ) ;
V_33 = F_154 ( & V_146 , F_134 , V_143 ,
V_144 , V_149 ) ;
if ( V_33 ) {
F_155 ( & V_146 ) ;
F_30 ( L_39 ,
