...
{
if ( F_27 () )
F_30 ( F_31 ( V_4 ) , F_3 , V_4 , 1 ) ;
else
F_4 ( V_4 ) ;
F_21 ( V_4 ) ;
}
void F_32 ( struct V_13 * V_14 , unsigned long V_15 )
{
if ( F_27 () ) {
struct V_5 V_6 ;
V_6 . V_7 = V_14 ;
V_6 . V_8 = V_15 ;
F_30 ( F_31 ( V_14 -> V_16 ) , F_5 ,
& V_6 , 1 ) ;
} else
F_6 ( V_14 , V_15 ) ;
F_21 ( V_14 -> V_16 ) ;
}
void F_33 ( unsigned long V_17 )
{
if ( F_27 () ) {
struct V_5 V_6 ;
V_6 . V_8 = V_17 ;
...
V_6 . V_8 = V_18 ;
V_6 . V_9 = V_19 ;
F_30 ( F_31 ( V_14 -> V_16 ) , F_9 ,
& V_6 , 1 ) ;
} else
F_10 ( V_14 , V_18 , V_19 ) ;
F_21 ( V_14 -> V_16 ) ;
}
void F_35 ( unsigned long V_18 , unsigned long V_19 )
{
if ( F_27 () ) {
struct V_5 V_6 ;
V_6 . V_8 = V_18 ;
