...
static int
F_91 ( struct V_18 * V_19 , T_1 V_117 )
{
struct V_85 * V_88 ;
struct V_92 * V_93 ;
F_9 ( 2 , V_62 , L_46 ) ;
...
static void
F_93 ( struct V_18 * V_19 , struct V_92 * V_93 )
{
F_9 ( 2 , V_62 , L_48 ) ;
...
return F_85 ( V_19 , V_88 , F_93 ) ;
}
static int
F_95 ( struct V_18 * V_19 , T_1 V_117 )
{
struct V_85 * V_88 ;
struct V_92 * V_93 ;
F_9 ( 2 , V_62 , L_50 ) ;
...
static void
F_96 ( struct V_18 * V_19 , struct V_92 * V_93 )
{
F_9 ( 2 , V_62 , L_51 ) ;
...
static int
F_97 ( struct V_18 * V_19 , T_1 V_117 )
{
struct V_85 * V_88 ;
struct V_92 * V_93 ;
F_9 ( 2 , V_62 , L_52 ) ;
...
V_93 -> V_93 . V_129 . V_21 = V_19 -> V_21 ;
V_93 -> V_93 . V_129 . V_130 = V_19 -> V_130 ;
return F_85 ( V_19 , V_88 , F_96 ) ;
}
static int
F_98 ( struct V_18 * V_19 , struct V_70 * V_28 )
{
struct V_85 * V_88 ;
struct V_92 * V_93 ;
F_9 ( 2 , V_62 , L_53 ) ;
...
static void
F_99 ( struct V_18 * V_19 , struct V_92 * V_93 )
{
F_9 ( 2 , V_62 , L_56 ) ;
V_19 -> V_143 =
...
F_103 ( & V_71 -> V_73 , & V_19 -> V_28 ) ;
F_28 ( & V_19 -> V_68 , V_34 ) ;
}
static void
F_104 ( T_2 V_71 , char * V_124 , struct V_153 * V_76 )
{
F_9 ( 4 , V_62 , L_62 ) ;
F_105 ( V_71 , V_124 ) ;
}
static inline void
F_106 ( struct V_18 * V_19 , struct V_154 * V_155 )
{
struct V_156 * V_157 ;
struct V_103 * V_104 ;
struct V_70 * V_71 ;
...
F_9 ( 4 , V_62 , L_63 ) ;
F_27 ( & V_19 -> V_68 , V_34 ) ;
F_107 (l, &card->ipm_list) {
V_71 = F_44 ( V_104 , struct V_70 , V_73 ) ;
for ( V_157 = F_108 ( V_155 -> V_160 ) ;
V_157 != NULL ; V_157 = F_108 ( V_157 -> V_161 ) ) {
F_104 ( V_157 -> V_162 , V_158 , V_19 -> V_76 ) ;
...
F_109 ( struct V_18 * V_19 , struct V_156 * V_157 , char * V_158 )
{
...
static inline void
F_110 ( struct V_18 * V_19 , struct V_154 * V_155 )
{
struct V_156 * V_157 ;
struct V_70 * V_71 ;
char V_158 [ V_159 ] ;
unsigned long V_34 ;
F_9 ( 4 , V_62 , L_65 ) ;
for ( V_157 = F_108 ( V_155 -> V_160 ) ; V_157 != NULL ;
V_157 = F_108 ( V_157 -> V_161 ) ) {
F_104 ( V_157 -> V_162 , V_158 , V_19 -> V_76 ) ;
V_71 = F_109 ( V_19 , V_157 , V_158 ) ;
if ( V_71 != NULL )
continue;
...
static long
F_123 ( struct V_168 * V_169 , struct V_170 * V_170 )
{
if ( ! F_124 ( V_170 ) )
return 0 ;
switch ( F_125 ( V_170 ) ) {
...
static int
F_127 ( struct V_168 * V_169 , struct V_170 * V_170 )
{
int V_172 , V_173 ;
char * V_174 ;
...
static void
F_129 ( struct V_168 * V_169 , unsigned long V_191 , struct V_170 * V_170 )
{
struct V_18 * V_19 ;
struct V_5 * V_6 ;
int V_20 , V_86 ;
int V_173 , V_172 ;
if ( F_123 ( V_169 , V_170 ) )
return;
V_19 = F_130 ( V_169 ) ;
...
V_86 = (struct V_30 * ) F_131 ( ( V_81 ) V_170 -> V_176 . V_93 . V_197 )
- V_6 -> V_29 ;
...
static void
F_134 ( struct V_5 * V_6 , struct V_85 * V_88 )
{
struct V_18 * V_19 ;
F_9 ( 5 , V_62 , L_88 ) ;
F_68 ( V_6 , V_88 ) ;
V_19 = F_135 ( V_6 , struct V_18 , V_27 ) ;
if ( F_136 ( V_19 -> V_76 ) && F_137 ( V_19 -> V_76 ) )
F_120 ( V_19 -> V_76 ) ;
F_79 ( & V_19 -> V_67 ) ;
V_19 -> V_66 -- ;
...
static int
F_138 ( struct V_18 * V_19 , struct V_205 * V_206 ,
struct V_153 * V_76 )
{
struct V_40 * V_207 ;
int V_20 = V_208 ;
...
F_142 ( V_206 , V_207 + 1 , V_206 -> V_215 ) ;
F_82 ( & V_19 -> V_67 ) ;
...
static int
F_143 ( struct V_205 * V_206 , struct V_153 * V_76 )
{
struct V_18 * V_19 ;
int V_20 ;
F_9 ( 5 , V_62 , L_90 ) ;
V_19 = (struct V_18 * ) V_76 -> V_166 ;
V_20 = F_138 ( V_19 , V_206 , V_76 ) ;
return V_20 ;
}
static int
F_144 ( struct V_18 * V_19 )
{
int V_20 ;
F_9 ( 2 , V_62 , L_91 ) ;
#ifdef F_145
V_19 -> V_21 = V_220 ;
V_20 = F_97 ( V_19 , V_123 ) ;
if ( V_20 == 0 )
return 0 ;
#endif
#ifdef F_146
...
{
struct V_18 * V_19 = F_135 ( V_225 , struct V_18 , V_167 ) ;
F_9 ( 5 , V_62 , L_95 ) ;
if ( F_38 ( V_19 , V_190 ) )
F_151 ( V_226 , V_19 , L_96 ) ;
#ifdef F_18
if ( F_38 ( V_19 , V_163 ) )
F_151 ( F_112 , V_19 , L_97 ) ;
#endif
}
static void
F_152 ( struct V_18 * V_19 , struct V_92 * V_93 )
{
F_9 ( 5 , V_62 , L_98 ) ;
if ( V_93 -> V_117 == V_227 ) {
switch( V_93 -> V_31 ) {
...
static void
F_154 ( struct V_18 * V_19 , char * V_229 , unsigned int V_230 )
{
struct V_205 * V_206 ;
F_9 ( 5 , V_62 , L_101 ) ;
if ( V_19 -> V_76 == NULL ||
...
memcpy ( F_156 ( V_206 , V_230 ) , V_229 , V_230 ) ;
V_206 -> V_213 = V_19 -> V_232 ( V_206 , V_19 -> V_76 ) ;
V_19 -> V_209 . V_233 += V_230 ;
V_19 -> V_209 . V_234 ++ ;
if ( V_206 -> V_213 == F_140 ( V_235 ) )
...
V_19 = F_135 ( V_6 , struct V_18 , V_26 ) ;
V_41 = 0 ;
while ( V_237 -> V_41 != 0 ) {
if ( V_237 -> V_41 <= 0 ||
V_237 -> V_41 > V_12 ||
...
if ( V_237 -> type == V_95 )
F_152 ( V_19 , (struct V_92 * ) V_237 ) ;
else if ( V_237 -> type == V_220 ||
V_237 -> type == V_240 ||
V_237 -> type == V_221 )
F_154 ( V_19 , ( char * ) ( V_237 + 1 ) ,
V_237 -> V_41 - V_41 -
sizeof( struct V_40 ) ) ;
else
;
...
static T_3
F_161 ( struct V_243 * V_76 , struct V_244 * V_245 , char * V_158 )
{
struct V_18 * V_19 ;
V_19 = F_162 ( V_76 ) ;
if ( ! V_19 )
...
static T_3
F_163 ( struct V_243 * V_76 , struct V_244 * V_245 , const char * V_158 , T_4 V_33 )
{
struct V_18 * V_19 ;
int V_246 ;
V_19 = F_162 ( V_76 ) ;
if ( ! V_19 )
return 0 ;
sscanf ( V_158 , L_111 , & V_246 ) ;
V_19 -> V_130 = V_246 ;
return V_33 ;
}
static T_3
F_164 ( struct V_243 * V_76 , struct V_244 * V_245 , char * V_158 )
{
struct V_247 * V_248 ;
V_248 = F_165 ( V_76 ) ;
if ( ! V_248 )
return - V_249 ;
return sprintf ( V_158 , L_112 , V_250 [ V_248 -> V_169 [ 0 ] -> V_251 . V_252 ] ) ;
}
static T_3
...
struct V_18 * V_19 ;
V_19 = F_162 ( V_76 ) ;
return V_19 ? sprintf ( V_158 , L_113 , V_19 -> V_24 ) : 0 ;
}
static T_3
F_167 ( struct V_243 * V_76 , struct V_244 * V_245 , const char * V_158 , T_4 V_33 )
{
struct V_18 * V_19 ;
int V_246 ;
V_19 = F_162 ( V_76 ) ;
...
static T_3
F_168 ( struct V_243 * V_76 , struct V_244 * V_245 ,
const char * V_158 , T_4 V_33 )
{
struct V_18 * V_19 = F_162 ( V_76 ) ;
char * V_149 ;
int V_222 ;
if ( ! V_19 )
return - V_253 ;
if ( V_19 -> V_15 != V_165 )
return - V_61 ;
V_222 = F_169 ( V_158 , & V_149 , 16 ) ;
if ( V_222 == 1 )
F_128 ( V_19 ) ;
return V_33 ;
}
static int
F_170 ( struct V_247 * V_254 )
{
struct V_18 * V_19 ;
if ( ! F_171 ( & V_254 -> V_76 ) )
return - V_249 ;
...
F_173 ( & V_254 -> V_76 , V_19 ) ;
V_254 -> V_169 [ 0 ] -> V_255 = F_129 ;
V_254 -> V_169 [ 1 ] -> V_255 = F_129 ;
V_19 -> V_256 = V_254 ;
F_174 ( & V_19 -> V_167 , F_150 ) ;
V_19 -> V_60 = 0 ;
V_19 -> V_57 = 0 ;
V_19 -> V_58 = 0 ;
...
static int
F_175 ( struct V_247 * V_254 )
{
struct V_18 * V_19 ;
F_9 ( 2 , V_8 , L_115 ) ;
V_19 = F_162 ( & V_254 -> V_76 ) ;
if ( V_19 -> V_76 -> V_258 != V_259 )
return 0 ;
F_176 ( V_19 -> V_76 , & V_254 -> V_76 ) ;
return F_177 ( V_19 -> V_76 ) ;
}
static int
F_178 ( struct V_247 * V_254 )
{
struct V_18 * V_19 ;
...
V_261 = V_19 -> V_15 ;
V_20 = F_179 ( V_19 -> V_26 . V_77 ) ;
if ( V_20 )
goto V_262;
V_20 = F_179 ( V_19 -> V_27 . V_77 ) ;
if ( V_20 )
goto V_263;
F_9 ( 3 , V_8 , L_117 ) ;
F_40 ( V_19 ) ;
...
if ( F_175 ( V_254 ) != 0 )
goto V_164;
F_102 ( L_124 , V_19 -> V_76 -> V_228 ,
( V_19 -> V_143 & V_272 ) ?
L_125 : L_126 ) ;
F_102 ( L_127 , V_19 -> V_76 -> V_228 ,
( V_19 -> V_143 & V_147 ) ?
L_125 : L_126 ) ;
return 0 ;
V_164:
F_182 ( V_19 -> V_27 . V_77 ) ;
V_263:
F_182 ( V_19 -> V_26 . V_77 ) ;
V_262:
return - V_249 ;
}
static int
F_183 ( struct V_247 * V_254 , int V_273 )
{
struct V_18 * V_19 ;
enum V_260 V_261 ;
...
F_16 ( 3 , V_8 , & V_19 , sizeof( void * ) ) ;
V_261 = V_19 -> V_15 ;
V_274 = F_159 ( V_19 -> V_76 ) ;
V_275 = F_182 ( V_19 -> V_26 . V_77 ) ;
V_276 = F_182 ( V_19 -> V_27 . V_77 ) ;
if ( ! V_274 )
V_274 = ( V_275 ) ? V_275 : V_276 ;
if ( V_274 )
F_39 ( 3 , V_8 , L_129 , V_274 ) ;
if ( V_261 == V_165 ) {
V_19 -> V_15 = V_271 ;
}
return 0 ;
...
static int
F_184 ( struct V_247 * V_254 )
{
return F_183 ( V_254 , 0 ) ;
}
static int
V_226 ( void * V_278 )
{
...
int V_20 = 0 ;
if ( V_19 -> V_15 == V_271 )
V_20 = F_178 ( V_19 -> V_256 ) ;
if ( V_19 -> V_76 )
F_190 ( V_19 -> V_76 ) ;
if ( V_20 ) {
F_126 ( & V_19 -> V_256 -> V_76 , L_136
L_137 ) ;
}
return V_20 ;
}
static int F_191 ( struct V_247 * V_256 )
{
return 0 ;
}
static void F_192 ( struct V_247 * V_256 )
{
return;
}
static int F_193 ( struct V_247 * V_256 )
{
struct V_18 * V_19 = F_162 ( & V_256 -> V_76 ) ;
return F_187 ( V_19 ) ;
}
static int F_194 ( struct V_247 * V_256 )
{
struct V_18 * V_19 = F_162 ( & V_256 -> V_76 ) ;
return F_189 ( V_19 ) ;
}
static int F_195 ( struct V_247 * V_256 )
{
struct V_18 * V_19 = F_162 ( & V_256 -> V_76 ) ;
return F_189 ( V_19 ) ;
}
static T_3 F_196 ( struct V_280 * V_281 ,
const char * V_158 , T_4 V_33 )
{
int V_282 ;
V_282 = F_197 ( V_283 , & V_284 , 2 , V_158 ) ;
