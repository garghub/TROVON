...
struct V_19 * V_20 , struct V_409 * V_410 )
{
T_7 V_40 = 0 ;
T_1 V_411 ;
T_7 V_128 = 0 ;
...
if ( F_19 ( V_164 , & V_1 -> V_136 ) ) {
V_128 = ( ( V_32 -> V_414 & 0x7 ) << V_415 )
| ( V_128 & 0x1fff ) ;
V_40 |= ( V_412 | V_413 ) ;
}
V_410 -> V_416 . V_417 . V_128 = F_70 ( V_128 ) ;
if ( F_261 ( V_20 ) ) {
V_411 = F_15 ( V_20 ) -> V_411 ;
if ( F_49 ( V_411 > V_1 -> V_48 -> V_64 ) ) {
F_30 ( V_1 , V_418 ) ;
return - V_419 ;
}
if ( F_49 ( ( V_411 + F_262 ( V_20 ) +
F_263 ( V_20 ) ) >= V_20 -> V_43 ) ) {
V_410 -> V_416 . V_417 . V_420 =
F_264 ( V_421 ) ;
V_410 -> V_416 . V_417 . V_422 = 0 ;
F_30 ( V_1 , V_423 ) ;
} else {
V_410 -> V_416 . V_417 . V_420 =
F_264 ( V_424 ) ;
V_410 -> V_416 . V_417 . V_422 = F_70 ( V_411 ) ;
}
if ( F_226 ( V_1 , V_20 ) ) {
F_30 ( V_1 , V_425 ) ;
return - V_419 ;
...
V_40 |= ( V_426 | V_427 ) ;
V_410 -> V_416 . V_417 . V_428 =
F_70 ( F_265 (
F_263 ( V_20 ) >> 2 , F_262 ( V_20 ) ) ) ;
} else {
V_410 -> V_416 . V_417 . V_420 = F_264 ( V_421 ) ;
V_410 -> V_416 . V_417 . V_422 = 0 ;
...
V_431 = F_229 ( V_20 ) -> V_100 ;
#ifdef F_266
else if ( V_20 -> V_100 ==
F_264 ( V_432 ) ) {
V_431 = F_232 ( V_20 ) -> V_433 ;
}
#endif
if ( V_431 == V_377 ) {
V_40 |= V_427 ;
...
V_410 -> V_416 . V_417 . V_428 = 0 ;
}
V_410 -> V_416 . V_417 . V_40 = F_70 ( V_40 ) ;
V_410 -> V_416 . V_417 . V_442 = F_267 ( V_20 -> V_43 ) ;
return 0 ;
}
static T_8
...
V_410 = & ( (struct V_409 * ) V_32 -> V_13 ) [ V_77 ] ;
V_443 = & V_16 [ V_77 ] ;
if ( F_258 ( V_1 , V_32 , V_20 , V_410 ) ) {
F_269 ( V_20 ) ;
return V_446 ;
}
V_410 -> V_416 . V_417 . V_453 = 0 ;
V_410 -> V_416 . V_417 . V_454 = V_25 ;
V_443 -> V_20 = V_20 ;
V_443 -> V_22 = 0 ;
V_18 = V_443 ;
V_26 = F_56 ( & V_1 -> V_23 -> V_24 , V_20 -> V_55 ,
V_43 , V_27 ) ;
F_51 ( V_26 , & V_410 -> V_21 [ 0 ] . V_88 ) ;
V_410 -> V_21 [ 0 ] . V_95 = F_70 ( V_43 ) ;
F_12 ( & V_18 -> V_25 [ 0 ] , V_26 , V_26 ) ;
V_443 -> V_22 ++ ;
for ( V_11 = 0 , V_444 = 0 ; V_11 < V_25 - 1 ; V_11 ++ ) {
const struct V_455 * V_456 = & F_15 ( V_20 ) -> V_29 [ V_11 ] ;
T_7 V_30 = F_271 ( V_456 ) ;
if ( F_49 ( V_30 == 0 ) ) {
F_8 ( V_1 , V_16 , V_12 ,
V_32 -> V_83 ) ;
F_269 ( V_20 ) ;
...
F_13 ( V_77 , V_12 ) ;
V_410 = & ( (struct V_409 * ) V_32 -> V_13 ) [ V_77 ] ;
V_410 -> V_416 . V_458 . V_420 =
F_264 ( V_459 ) ;
V_18 = & V_16 [ V_77 ] ;
}
V_26 = F_272 ( & V_1 -> V_23 -> V_24 , V_456 ,
0 , V_30 , V_27 ) ;
F_51 ( V_26 , & V_410 -> V_21 [ V_444 ] . V_88 ) ;
V_410 -> V_21 [ V_444 ] . V_95 = F_70 ( V_30 ) ;
F_12 ( & V_18 -> V_25 [ V_444 ] , V_26 ,
V_26 ) ;
V_443 -> V_22 ++ ;
}
...
goto V_467;
F_276 ( V_1 -> V_139 [ 0 ] . V_145 , V_461 , V_462 , NULL ) ;
if ( ! F_277 ( V_48 ) ) {
T_6 * V_468 ;
...
static int
F_283 ( struct V_47 * V_48 , T_9 V_431 , T_7 V_340 )
{
struct V_1 * V_1 = F_252 ( V_48 ) ;
unsigned long V_40 ;
if ( ! V_1 -> V_139 [ 0 ] . V_145 )
...
static int
F_284 ( struct V_47 * V_48 , T_9 V_431 , T_7 V_340 )
{
struct V_1 * V_1 = F_252 ( V_48 ) ;
unsigned long V_40 ;
if ( ! V_1 -> V_139 [ 0 ] . V_145 )
