...
F_5 ( F_70 ( V_165 ) <
V_173 + sizeof( struct V_176 ) ) ;
if ( ( ( const struct V_176 * ) V_165 -> V_58 + V_173 ) ->
V_177 != F_19 ( V_178 ) )
return - V_63 ;
V_173 += sizeof( struct V_176 ) ;
} else if ( V_165 -> V_174 != F_19 ( V_178 ) ) {
return - V_63 ;
}
...
if ( F_71 ( V_171 ) )
return - V_63 ;
F_5 ( F_70 ( V_165 ) < V_173 + 4 * V_171 -> V_179 + 4 ) ;
V_172 = ( const T_5 * ) ( V_165 -> V_58 + V_173 + 4 * V_171 -> V_179 ) ;
F_28 ( & V_5 , V_128 ,
V_24 -> V_49 ? V_47 : 0 ,
V_166 ) ;
V_118 = F_22 ( & V_5 , V_171 -> V_174 ,
V_171 -> V_180 , V_172 [ 1 ] , V_171 -> V_181 , V_172 [ 0 ] ) ;
if ( V_118 )
return V_118 ;
...
++ V_169 -> V_182 ;
F_74 ( V_24 , V_183 , V_24 -> V_120 ,
L_3 ,
( V_171 -> V_174 == V_65 ) ? L_4 : L_5 ,
& V_171 -> V_181 , F_16 ( V_172 [ 0 ] ) , & V_171 -> V_180 , F_16 ( V_172 [ 1 ] ) ,
V_166 , V_167 , V_118 ) ;
return V_118 ;
}
bool F_75 ( struct V_23 * V_24 , unsigned V_184 )
{
struct V_19 * V_20 = V_24 -> V_25 ;
struct V_18 * V_21 = & V_20 -> V_21 [ V_6 ] ;
unsigned V_185 = V_21 -> V_34 - 1 ;
unsigned V_104 ;
unsigned V_186 ;
if ( ! F_76 ( & V_20 -> V_122 ) )
return false ;
V_104 = V_20 -> V_187 ;
V_186 = ( V_104 + V_184 ) & V_185 ;
while ( V_104 != V_186 ) {
