...
static void F_68 ( struct V_11 * V_12 , bool V_87 )
{
struct V_17 * V_18 = V_12 -> V_19 ;
T_1 V_88 , V_89 ;
if ( V_18 -> V_70 == 1 ) {
...
static int F_71 ( struct V_90 * V_91 , void * V_75 )
{
struct V_92 * V_49 = (struct V_92 * ) V_91 -> V_93 ;
struct V_11 * V_12 = V_49 -> V_94 -> V_12 ;
struct V_17 * V_18 = V_12 -> V_19 ;
unsigned V_95 ;
F_26 ( V_12 -> V_12 ) ;
F_72 ( V_91 , L_25 , V_18 -> V_70 ) ;
for ( V_95 = 0 ; V_95 < F_73 ( V_96 ) ; V_95 ++ )
if ( V_18 -> V_70 >= V_96 [ V_95 ] . V_70 )
F_72 ( V_91 , L_26 , V_96 [ V_95 ] . V_3 ,
F_49 ( V_12 , V_96 [ V_95 ] . V_88 ) ) ;
F_28 ( V_12 -> V_12 ) ;
return 0 ;
}
static int F_74 ( struct V_90 * V_91 , void * V_75 )
{
struct V_92 * V_49 = (struct V_92 * ) V_91 -> V_93 ;
struct V_11 * V_12 = V_49 -> V_94 -> V_12 ;
return F_75 ( V_91 , V_12 -> V_97 ) ;
}
static int F_76 ( struct V_98 * V_94 )
{
struct V_11 * V_12 = V_94 -> V_12 ;
struct V_1 * V_2 ;
int V_54 ;
V_54 = F_77 ( V_99 ,
F_73 ( V_99 ) ,
...
static void F_78 ( struct V_98 * V_94 )
{
struct V_1 * V_2 ;
F_79 ( V_99 ,
F_73 ( V_99 ) , V_94 ) ;
F_14 (mod, &module_list, list)
if ( V_2 -> V_5 -> V_102 )
V_2 -> V_5 -> V_102 ( V_2 , V_94 ) ;
}
static int F_80 ( struct V_103 * V_12 )
{
struct V_11 * V_104 = F_81 ( V_12 ) ;
struct V_17 * V_18 = V_104 -> V_19 ;
unsigned V_95 , V_105 = 0 ;
F_82 ( V_104 ) ;
for ( V_95 = 0 ; V_95 < F_73 ( V_96 ) ; V_95 ++ )
if ( V_96 [ V_95 ] . V_106 && ( V_18 -> V_70 >= V_96 [ V_95 ] . V_70 ) )
V_18 -> V_107 [ V_105 ++ ] = F_49 ( V_104 , V_96 [ V_95 ] . V_88 ) ;
return 0 ;
}
static int F_83 ( struct V_103 * V_12 )
{
struct V_11 * V_104 = F_81 ( V_12 ) ;
struct V_17 * V_18 = V_104 -> V_19 ;
unsigned V_95 , V_105 = 0 ;
for ( V_95 = 0 ; V_95 < F_73 ( V_96 ) ; V_95 ++ )
if ( V_96 [ V_95 ] . V_106 && ( V_18 -> V_70 >= V_96 [ V_95 ] . V_70 ) )
F_84 ( V_104 , V_96 [ V_95 ] . V_88 , V_18 -> V_107 [ V_105 ++ ] ) ;
F_85 ( V_104 ) ;
return 0 ;
}
