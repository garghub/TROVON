...
F_35 ( V_15 -> V_108 , L_2 , V_15 -> V_104 ,
F_15 ( V_21 -> V_31 -> V_32 + V_109 ) ) ;
V_100 = F_36 ( V_15 , 4 ) ;
if ( V_100 )
return V_100 ;
V_16 = & V_15 -> V_59 [ 0 ] ;
...
V_100 = F_38 ( V_15 -> V_57 , F_16 , V_127 ,
L_3 , V_15 ) ;
if ( V_100 < 0 ) {
V_15 -> V_57 = 0 ;
F_33 ( V_15 -> V_108 , L_4 ) ;
...
{
return F_45 ( V_15 , & V_130 , V_129 -> V_131 ) ;
}
