...
V_80 ) )
goto V_46;
V_92 = sizeof( struct V_81 ) ;
break;
default:
goto V_46;
}
V_88 = (struct V_88 * ) ( V_6 -> V_15 + V_92 ) ;
V_11 = (struct V_10 * ) V_6 -> V_15 ;
if ( F_47 ( V_38 , V_88 -> V_93 ) )
V_11 -> V_75 = V_11 -> V_75 - 1 ;
V_91 = V_90 -> V_96 -> V_69 -> V_97 ;
if ( V_24 == V_25 &&
F_39 ( & V_38 -> V_98 ) &&
