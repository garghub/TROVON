...
void T_2 * V_9 = V_2 -> V_10 ;
unsigned long V_11 = V_3 << 2 ;
if ( V_3 == V_12 )
return F_2 ( V_9 - V_5 -> V_13 ) ;
return F_2 ( V_9 + V_11 ) ;
}
static inline void F_3 ( struct V_1 * V_2 , int V_3 , T_1 V_14 )
{
struct V_4 * V_5 = V_2 -> V_6 -> V_7 . V_8 ;
void T_2 * V_9 = V_2 -> V_10 ;
unsigned long V_11 = V_3 << 2 ;
...
V_5 -> V_49 ) ;
if ( V_41 == V_45 )
F_22 ( V_5 -> V_46 , V_5 -> V_49 ) ;
V_2 -> V_42 = V_41 ;
}
static void F_23 ( struct V_50 * V_51 )
{
struct V_1 * V_2 = F_24 ( V_51 , struct V_1 , V_51 ) ;
enum V_19 V_20 = V_2 -> V_52 ;
F_17 ( V_2 ) ;
if ( ( V_20 == 0 ) || ( V_20 == V_2 -> V_53 . V_35 ) )
F_18 ( V_2 , V_43 , V_20 ) ;
else {
F_18 ( V_2 , V_45 , 0 ) ;
F_8 ( V_2 , V_20 ) ;
...
static void F_25 ( struct V_54 * V_53 ,
enum V_19 V_20 )
{
struct V_1 * V_2 = F_24 ( V_53 , struct V_1 , V_53 ) ;
V_2 -> V_52 = V_20 ;
F_26 ( & V_2 -> V_51 ) ;
}
...
V_2 = F_28 ( & V_6 -> V_7 , sizeof( * V_2 ) , V_59 ) ;
if ( V_2 == NULL ) {
F_11 ( & V_6 -> V_7 , L_7 ) ;
return - V_60 ;
}
V_57 = F_29 ( V_6 , V_61 , 0 ) ;
if ( ! V_57 ) {
F_11 ( & V_6 -> V_7 , L_8 ) ;
return - V_62 ;
}
V_2 -> V_10 = F_30 ( & V_6 -> V_7 , V_57 -> V_15 ,
F_31 ( V_57 ) ) ;
if ( V_2 -> V_10 == NULL ) {
F_11 ( & V_6 -> V_7 , L_9 ) ;
return - V_62 ;
...
F_35 ( V_6 , V_2 ) ;
F_36 ( & V_2 -> V_51 , F_23 ) ;
V_2 -> V_53 . V_49 = V_5 -> V_49 ;
V_2 -> V_53 . V_20 = V_64 ;
V_2 -> V_53 . V_35 = V_5 -> V_35 ;
V_2 -> V_53 . V_65 = F_25 ;
V_2 -> V_53 . V_16 |= V_66 ;
V_23 = F_37 ( & V_6 -> V_7 , & V_2 -> V_53 ) ;
if ( V_23 < 0 )
goto V_30;
V_2 -> V_29 = V_2 -> V_53 . V_35 * V_2 -> V_33 ;
F_38 ( & V_6 -> V_7 ) ;
return 0 ;
V_30:
F_18 ( V_2 , V_63 , V_64 ) ;
...
static int F_39 ( struct V_55 * V_6 )
{
