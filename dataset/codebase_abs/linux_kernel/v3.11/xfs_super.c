...
V_13 -> V_311 = 1 ;
F_127 ( V_13 ) ;
if ( F_128 ( & V_10 -> V_141 ) == V_312 )
V_13 -> V_26 |= V_313 ;
error = F_129 ( V_10 ) ;
if ( error )
goto V_314;
V_276 = F_130 ( F_61 ( V_10 -> V_315 ) ) ;
if ( ! V_276 ) {
error = V_316 ;
goto V_317;
}
...
void * V_283 )
{
return F_133 ( V_320 , V_265 , V_321 , V_283 , F_119 ) ;
}
static int
F_134 (
struct V_12 * V_13 )
{
return F_135 ( F_77 ( V_13 ) ) ;
}
static void
F_136 (
struct V_12 * V_13 ,
