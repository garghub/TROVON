...
static int F_50 ( struct V_117 * V_45 ,
unsigned int type , unsigned int V_118 , int V_119 )
{
struct V_78 * V_66 = F_51 ( V_45 ) ;
struct V_120 * V_121 ;
int V_122 ;
if ( type == V_123 )
return F_52 ( V_45 , type , V_118 , V_119 ) ;
if ( type != V_124 )
return - 1 ;
V_122 = F_53 ( V_66 , type , V_118 , & V_121 ) ;
if ( V_122 == - 1 ) {
F_54 ( V_45 , L_25 ) ;
return - 1 ;
}
return F_55 ( V_121 , V_122 , V_119 ) ;
}
static int F_56 ( struct V_1 * V_2 )
{
struct V_10 * V_11 = F_2 ( V_2 ) ;
int V_14 ;
F_57 ( & V_2 -> V_45 , L_26 , V_2 -> V_68 ) ;
V_14 = F_58 ( V_2 -> V_68 , NULL , F_22 ,
V_125 | V_126 ,
V_2 -> V_127 , V_11 ) ;
if ( V_14 < 0 ) {
F_59 ( & V_2 -> V_45 ,
...
V_128 = F_12 ( V_42 -> V_130 ) ;
if ( V_128 < 4 || V_128 > sizeof( struct V_100 ) ) {
F_13 ( & V_2 -> V_45 , L_31 ,
V_128 ) ;
return - V_129 ;
}
if ( F_12 ( V_42 -> V_131 ) != 0x0100 ) {
F_13 ( & V_2 -> V_45 ,
L_32 ,
F_12 ( V_42 -> V_131 ) ) ;
return - V_129 ;
...
struct V_135 V_34 = { V_136 , NULL } ;
union V_137 V_138 [ 4 ] , * V_139 ;
struct V_140 V_141 ;
struct V_142 * V_143 ;
T_5 V_144 ;
V_144 = F_62 ( & V_2 -> V_45 ) ;
if ( ! V_144 || F_63 ( V_144 , & V_143 ) )
return - V_129 ;
V_141 . V_89 = F_64 ( V_138 ) ;
V_141 . V_145 = V_138 ;
V_138 [ 0 ] . type = V_146 ;
V_138 [ 0 ] . V_76 . V_18 = sizeof( V_134 ) ;
V_138 [ 0 ] . V_76 . V_145 = V_134 ;
V_138 [ 1 ] . type = V_147 ;
V_138 [ 1 ] . integer . V_119 = 1 ;
V_138 [ 2 ] . type = V_147 ;
V_138 [ 2 ] . integer . V_119 = 1 ;
V_138 [ 3 ] . type = V_147 ;
V_138 [ 3 ] . integer . V_119 = 0 ;
if ( F_65 ( F_66 ( V_144 , L_36 , & V_141 , & V_34 ) ) ) {
F_13 ( & V_2 -> V_45 , L_37 ) ;
return - V_129 ;
}
V_139 = (union V_137 * ) V_34 . V_145 ;
if ( V_139 -> type != V_147 ) {
F_13 ( & V_2 -> V_45 , L_38 ,
V_139 -> type ) ;
F_29 ( V_34 . V_145 ) ;
...
V_133 -> V_148 = V_139 -> integer . V_119 ;
F_29 ( V_34 . V_145 ) ;
return 0 ;
}
...
const struct V_149 * V_69 )
{
int V_14 ;
struct V_10 * V_11 ;
struct V_78 * V_66 ;
V_86 V_150 ;
struct V_132 * V_151 = V_2 -> V_45 . V_151 ;
F_39 ( L_39 , V_2 -> V_30 ) ;
if ( ! V_2 -> V_68 ) {
F_13 ( & V_2 -> V_45 ,
L_40 ) ;
...
F_68 ( V_2 , V_11 ) ;
V_11 -> V_2 = V_2 ;
V_150 = V_11 -> V_133 . V_148 ;
V_11 -> V_24 = F_69 ( V_150 ) ;
F_70 ( & V_11 -> V_19 ) ;
...
V_66 -> V_156 = F_33 ;
V_66 -> V_157 = F_35 ;
V_66 -> V_45 . V_158 = & V_2 -> V_45 ;
F_74 ( & V_66 -> V_45 , F_62 ( & V_2 -> V_45 ) ) ;
V_66 -> V_159 = V_160 ;
V_66 -> V_161 = F_12 ( V_11 -> V_42 . V_131 ) ;
V_66 -> V_162 = F_12 ( V_11 -> V_42 . V_163 ) ;
V_66 -> V_164 = F_12 ( V_11 -> V_42 . V_165 ) ;
snprintf ( V_66 -> V_127 , sizeof( V_66 -> V_127 ) , L_42 ,
V_2 -> V_127 , V_66 -> V_162 , V_66 -> V_164 ) ;
V_14 = F_75 ( V_66 ) ;
if ( V_14 ) {
if ( V_14 != - V_129 )
F_41 ( V_2 , L_43 , V_14 ) ;
...
static int F_79 ( struct V_73 * V_45 )
{
...
static int F_83 ( struct V_73 * V_45 )
{
int V_14 ;
struct V_1 * V_2 = F_80 ( V_45 ) ;
V_14 = F_16 ( V_2 ) ;
