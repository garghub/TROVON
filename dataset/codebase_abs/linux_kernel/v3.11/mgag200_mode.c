...
static int F_35 ( struct V_1 * V_2 , int V_107 , int V_108 ,
struct V_9 * V_123 )
{
...
F_12 ( 0x90 , 0 ) ;
if ( V_133 )
F_38 ( V_5 -> V_154 , V_155 , V_133 ) ;
if ( V_134 )
F_38 ( V_5 -> V_154 , V_156 , V_134 ) ;
F_39 ( 2 , 0xf ) ;
F_39 ( 3 , 0 ) ;
F_39 ( 4 , 0xe ) ;
...
static void F_42 ( struct V_1 * V_2 , int V_31 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_6 * V_7 = V_5 -> V_8 ;
T_1 V_165 = 0 , V_170 = 0 ;
...
static void F_46 ( struct V_1 * V_2 , T_4 * V_179 , T_4 * V_180 ,
...
struct V_3 * V_3 ;
int V_11 ;
V_3 = F_53 ( sizeof( struct V_3 ) +
( V_185 * sizeof( struct V_186 * ) ) ,
V_187 ) ;
if ( V_3 == NULL )
return;
F_54 ( V_7 -> V_5 , & V_3 -> V_188 , & V_189 ) ;
F_55 ( & V_3 -> V_188 , V_20 ) ;
V_7 -> V_190 . V_2 = V_3 ;
for ( V_11 = 0 ; V_11 < V_20 ; V_11 ++ ) {
V_3 -> V_21 [ V_11 ] = V_11 ;
...
void F_58 ( struct V_1 * V_2 , T_4 * V_179 , T_4 * V_180 ,
T_4 * V_181 , int V_192 )
{
struct V_3 * V_3 = F_2 ( V_2 ) ;
...
static bool F_59 ( struct V_193 * V_194 ,
const struct V_30 * V_31 ,
struct V_30 * V_32 )
{
return true ;
}
static void F_60 ( struct V_193 * V_194 ,
struct V_30 * V_31 ,
struct V_30 * V_32 )
{
}
static void F_61 ( struct V_193 * V_194 , int V_195 )
{
return;
}
...
void F_64 ( struct V_193 * V_194 )
{
struct V_196 * V_196 = F_65 ( V_194 ) ;
F_66 ( V_194 ) ;
F_49 ( V_196 ) ;
}
static struct V_193 * F_67 ( struct V_4 * V_5 )
{
struct V_193 * V_194 ;
struct V_196 * V_196 ;
V_196 = F_53 ( sizeof( struct V_196 ) , V_187 ) ;
if ( ! V_196 )
return NULL ;
V_194 = & V_196 -> V_188 ;
V_194 -> V_197 = 0x1 ;
F_68 ( V_5 , V_194 , & V_198 ,
V_199 ) ;
F_69 ( V_194 , & V_200 ) ;
return V_194 ;
}
static int F_70 ( struct V_186 * V_201 )
{
struct V_202 * V_202 = F_71 ( V_201 ) ;
struct V_203 * V_203 ;
int V_116 = 0 ;
V_203 = F_72 ( V_201 , & V_202 -> V_204 -> V_205 ) ;
if ( V_203 ) {
F_73 ( V_201 , V_203 ) ;
V_116 = F_74 ( V_201 , V_203 ) ;
F_49 ( V_203 ) ;
}
return V_116 ;
}
static T_5 F_75 ( struct V_30 * V_31 ,
int V_15 )
{
T_5 V_206 , V_207 ;
...
static int F_77 ( struct V_186 * V_201 ,
struct V_30 * V_31 )
{
...
struct V_193 * F_78 ( struct V_186
* V_201 )
{
...
static enum V_242 F_81 ( struct V_186
* V_201 , bool V_243 )
{
return V_244 ;
}
static void F_82 ( struct V_186 * V_201 )
{
struct V_202 * V_202 = F_71 ( V_201 ) ;
F_83 ( V_202 -> V_204 ) ;
F_84 ( V_201 ) ;
...
static struct V_186 * F_85 ( struct V_4 * V_5 )
{
struct V_186 * V_201 ;
struct V_202 * V_202 ;
V_202 = F_53 ( sizeof( struct V_202 ) , V_187 ) ;
if ( ! V_202 )
return NULL ;
V_201 = & V_202 -> V_188 ;
F_86 ( V_5 , V_201 ,
