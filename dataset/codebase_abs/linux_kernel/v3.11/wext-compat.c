...
int F_10 ( struct V_17 * V_17 , struct V_119 * V_107 )
{
if ( V_107 -> V_110 == 0 ) {
enum V_52 V_53 = V_22 ;
if ( V_107 -> V_109 < 0 )
...
return - V_16 ;
V_282 -> V_127 = 100000 * F_74 ( & V_294 . V_299 ) ;
return 0 ;
}
static struct V_300 * F_75 ( struct V_1 * V_2 )
{
struct V_7 * V_8 = V_2 -> V_9 ;
struct V_28 * V_29 = F_3 ( V_8 -> V_17 ) ;
...
if ( V_294 . V_297 & V_306 )
V_301 . V_307 . V_308 = V_294 . V_309 ;
if ( V_294 . V_297 & V_310 )
...
switch ( V_8 -> V_42 ) {
case V_36 :
return F_83 ( V_2 , V_4 , V_49 , V_314 ) ;
case V_34 :
...
switch ( V_8 -> V_42 ) {
case V_36 :
return F_86 ( V_2 , V_4 , V_49 , V_314 ) ;
case V_34 :
