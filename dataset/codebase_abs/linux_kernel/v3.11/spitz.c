...
static void F_52 ( enum V_64 V_65 , const char * V_66 )
{
T_4 V_67 = F_53 ( V_68 ) ;
if ( ( V_67 & 0xffff0000 ) == 0x7ff00000 )
F_54 ( ( V_67 & 0xffff ) | 0x7ee00000 , V_68 ) ;
F_50 () ;
}
...
static void T_1 F_61 ( struct V_75 * V_76 , char * * V_77 ,
struct V_78 * V_79 )
{
F_62 () ;
V_79 -> V_80 = 1 ;
V_79 -> V_81 [ 0 ] . V_82 = 0xa0000000 ;
V_79 -> V_81 [ 0 ] . V_53 = ( 64 * 1024 * 1024 ) ;
}
