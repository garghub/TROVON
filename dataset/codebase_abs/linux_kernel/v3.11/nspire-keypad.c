...
V_46 = F_20 ( V_41 , V_48 , 0 ) ;
if ( ! V_46 ) {
F_19 ( & V_41 -> V_44 , L_2 ) ;
return - V_47 ;
}
V_4 = F_21 ( & V_41 -> V_44 , sizeof( struct V_3 ) ,
V_49 ) ;
if ( ! V_4 ) {
F_19 ( & V_41 -> V_44 , L_3 ) ;
return - V_50 ;
...
V_4 -> V_22 = F_24 ( V_43 , L_8 ) ;
V_4 -> V_32 = F_25 ( & V_41 -> V_44 , NULL ) ;
if ( F_26 ( V_4 -> V_32 ) ) {
F_19 ( & V_41 -> V_44 , L_9 ) ;
return F_27 ( V_4 -> V_32 ) ;
}
V_4 -> V_16 = F_28 ( & V_41 -> V_44 , V_46 ) ;
if ( F_26 ( V_4 -> V_16 ) )
return F_27 ( V_4 -> V_16 ) ;
