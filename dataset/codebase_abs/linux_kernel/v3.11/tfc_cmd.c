...
F_2 ( L_10 ,
V_119 -> V_129 , V_119 -> V_120 , V_87 ) ;
F_37 ( V_2 , V_87 ) ;
}
static void F_43 ( struct V_130 * V_12 , struct V_26 * V_27 )
{
struct V_1 * V_2 ;
struct V_28 * V_29 = V_12 -> V_97 -> V_29 ;
V_2 = F_44 ( sizeof( * V_2 ) , V_131 ) ;
if ( ! V_2 )
goto V_132;
V_2 -> V_12 = V_12 ;
V_2 -> V_13 = V_29 -> V_31 . V_133 ( V_29 , V_27 ) ;
if ( ! V_2 -> V_13 ) {
F_13 ( V_2 ) ;
goto V_132;
}
...
F_46 ( V_12 -> V_97 -> V_136 -> V_137 , & V_2 -> V_134 ) ;
return;
V_132:
F_2 ( L_11 ) ;
F_34 ( V_29 , V_27 , V_138 , 0 ) ;
F_11 ( V_27 ) ;
F_12 ( V_12 ) ;
}
void F_47 ( struct V_130 * V_12 , struct V_26 * V_27 )
{
...
static void V_135 ( struct V_141 * V_134 )
{
struct V_1 * V_2 = F_15 ( V_134 , struct V_1 , V_134 ) ;
...
F_5 ( V_2 -> V_13 ) -> V_38 -> V_31 . V_162 ( V_2 -> V_13 , F_30 , V_2 ) ;
if ( F_48 ( & V_2 -> V_8 , V_2 -> V_12 -> V_113 , V_34 -> V_163 ,
& V_2 -> V_114 [ 0 ] , F_41 ( & V_34 -> V_115 ) ,
F_49 ( V_34 -> V_164 ) , V_143 , V_142 , 0 ) )
goto V_144;
F_2 ( L_12 , V_66 -> V_75 ) ;
return;
V_144:
