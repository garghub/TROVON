...
static void F_81 ( struct V_21 * V_131 , struct V_21 * V_132 )
{
T_1 V_133 [ V_56 ] ;
...
F_23 (bond, slave, i) {
memcpy ( V_148 , V_21 -> V_74 -> V_84 , V_56 ) ;
V_149 = F_80 ( V_21 -> V_74 , V_70 ) ;
memcpy ( V_21 -> V_74 -> V_84 , V_148 , V_56 ) ;
if ( V_149 )
goto V_150;
}
return 0 ;
V_150:
memcpy ( V_146 . V_128 , V_9 -> V_74 -> V_84 , V_9 -> V_74 -> V_127 ) ;
V_146 . V_129 = V_9 -> V_74 -> type ;
V_147 = V_21 ;
F_88 (bond, slave, i, bond->first_slave, stop_at) {
memcpy ( V_148 , V_21 -> V_74 -> V_84 , V_56 ) ;
F_80 ( V_21 -> V_74 , & V_146 ) ;
memcpy ( V_21 -> V_74 -> V_84 , V_148 , V_56 ) ;
}
return V_149 ;
}
...
int F_91 ( struct V_2 * V_3 , struct V_121 * V_151 )
{
struct V_8 * V_9 = F_92 ( V_151 ) ;
struct V_152 * V_153 ;
struct V_28 * V_29 = & ( F_5 ( V_9 ) ) ;
struct V_21 * V_17 = NULL ;
static const T_3 V_154 = F_93 ( 0xffffffff ) ;
int V_5 = 0 ;
int V_155 = 1 ;
T_2 V_40 = 0 ;
const T_1 * V_4 = NULL ;
...
case V_158 : {
const struct V_159 * V_160 = F_97 ( V_3 ) ;
if ( F_32 ( V_153 -> V_161 , V_80 ) ||
( V_160 -> V_162 == V_154 ) ||
( V_160 -> V_60 == V_163 ) ) {
V_155 = 0 ;
break;
...
V_4 = ( char * ) & ( F_98 ( V_3 ) -> V_162 ) ;
V_5 = sizeof( F_98 ( V_3 ) -> V_162 ) ;
break;
case V_167 :
if ( F_100 ( V_3 ) -> V_168 != V_169 ) {
V_155 = 0 ;
break;
}
...
void F_103 ( struct V_176 * V_177 )
{
struct V_8 * V_9 = F_104 ( V_177 , struct V_8 ,
V_178 . V_177 ) ;
struct V_28 * V_29 = & ( F_5 ( V_9 ) ) ;
struct V_21 * V_21 ;
int V_6 ;
...
V_182:
F_107 ( V_9 -> V_186 , & V_9 -> V_178 , V_187 ) ;
F_102 ( & V_9 -> V_179 ) ;
}
int F_108 ( struct V_8 * V_9 , struct V_21 * V_21 )
{
int V_149 ;
V_149 = F_79 ( V_21 , V_21 -> V_140 ) ;
if ( V_149 ) {
return V_149 ;
}
V_149 = F_85 ( V_9 , V_21 ) ;
...
void F_110 ( struct V_8 * V_9 , struct V_21 * V_21 , char V_188 )
{
struct V_28 * V_29 = & ( F_5 ( V_9 ) ) ;
if ( V_188 == V_189 ) {
F_16 ( V_9 , V_21 , 0 ) ;
...
void F_111 ( struct V_8 * V_9 , struct V_21 * V_191 )
__releases( &bond->curr_slave_lock
int F_112 ( struct V_121 * V_151 , void * V_70 )
