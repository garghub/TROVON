...
static int F_54 ( void * V_93 , const char * V_13 , int V_94 ,
T_3 V_95 , T_5 V_2 , unsigned int type )
{
struct V_96 * V_97 = V_93 ;
if ( F_6 ( V_97 -> V_4 , V_13 ) )
return 0 ;
V_97 -> V_98 -> V_99 = V_97 -> V_100 . V_99 ;
return ! F_55 ( V_97 -> V_98 , V_13 , V_94 , V_2 , type ) ;
}
static int F_56 ( struct V_21 * V_21 , struct V_101 * V_100 )
{
struct V_51 * V_55 = V_21 -> V_53 ;
struct V_21 * V_62 = V_55 -> V_62 ;
struct V_96 V_93 = {
...
int V_30 ;
V_62 -> V_44 = V_100 -> V_99 ;
V_30 = F_57 ( V_62 , & V_93 . V_100 ) ;
V_100 -> V_99 = V_93 . V_100 . V_99 ;
return V_30 ;
}
