...
static int F_180 ( struct V_310 * V_94 ,
...
if ( V_353 -> V_358 )
V_19 = ( ( T_2 * ) ( V_353 -> V_358 ) ) [ V_254 ] ;
else
V_19 = F_178 ( V_94 ) ;
if ( V_94 -> V_359 > 1 )
F_181 ( F_150 ( V_94 ) , V_254 , 1 ) ;
V_94 -> V_360 = 1 ;
switch ( V_19 & V_361 ) {
case V_168 :
if ( ( V_19 & V_20 ) == V_30 ) {
...
static void F_185 ( struct V_310 * V_94 )
{
F_184 ( V_94 ) ;
F_183 ( V_94 , NULL ) ;
}
...
{
if ( V_3 -> V_88 -> V_240 == V_363 ) {
if ( ! V_3 -> V_364 ) {
V_3 -> V_364 = 1 ;
F_19 ( & V_3 -> V_312 ) ;
}
}
if ( V_3 -> V_88 -> V_240 != V_365 )
return - V_61 ;
F_57 ( V_3 -> V_88 ) ;
return 0 ;
}
...
static int F_186 ( struct V_310 * V_366 , T_9 V_367 )
{
int V_43 , V_38 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
if ( V_45 [ V_43 ] && ( V_45 [ V_43 ] -> V_94 == V_366 ) ) {
V_38 = F_86 ( V_45 [ V_43 ] ) ;
if ( V_38 )
goto V_188;
}
...
static int F_187 ( struct V_310 * V_366 )
{
int V_43 , V_38 = 0 ;
struct V_1 * V_1 ;
for ( V_43 = 0 ; V_43 < V_44 ; V_43 ++ ) {
...
static void V_181 ( struct V_369 * V_179 )
{
...
struct V_332 * V_370 = F_1 ( V_315 [ V_43 ] ) -> V_332 ;
...
static struct V_371 * F_167 ( struct V_310 * V_311 ,
int type , int V_372 )
{
int V_43 ;
struct V_373 * V_366 = V_311 -> V_356 ;
struct V_371 * V_195 ;
for ( V_43 = 0 ; V_43 < V_366 -> V_256 . V_374 ; V_43 ++ ) {
V_195 = & V_366 -> V_375 [ V_43 ] . V_256 ;
if ( ( ( V_195 -> V_90 & V_376 ) == V_372 ) &&
( F_193 ( V_195 ) == type ) )
return V_195 ;
}
return NULL ;
}
static int F_182 ( struct V_310 * V_311 , unsigned char * V_377 )
{
int V_43 ;
struct V_373 * V_366 = V_311 -> V_356 ;
if ( V_366 -> V_378 == 3 ) {
...
for ( V_43 = 0 ; V_43 < V_366 -> V_256 . V_374 ; V_43 ++ ) {
if ( V_366 -> V_375 [ V_43 ] . V_378 == 3 ) {
* V_377 = V_366 -> V_375 [ V_43 ] . V_379 [ 2 ] ;
return 0 ;
}
}
return - 1 ;
