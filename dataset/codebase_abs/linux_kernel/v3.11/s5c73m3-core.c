...
V_117 -> V_131 = * F_48 ( V_127 , V_117 -> V_129 ) ;
return 0 ;
}
F_33 ( & V_30 -> V_95 ) ;
switch ( V_117 -> V_129 ) {
...
struct V_1 * V_2 =
F_48 ( V_127 , V_130 ) ;
V_169 -> V_171 = V_169 -> V_170 = V_2 -> V_6 ;
V_169 -> V_172 = V_169 -> V_173 = V_2 -> V_7 ;
return 0 ;
}
default:
return - V_66 ;
...
{
struct V_29 * V_30 = F_32 ( V_60 ) ;
F_67 ( V_60 -> V_174 , V_60 -> V_175 ) ;
F_20 ( V_60 , L_30 , V_30 -> V_176 ,
V_30 -> V_89 ) ;
return 0 ;
}
static int F_68 ( struct V_59 * V_60 , struct V_126 * V_127 )
{
struct V_1 * V_2 ;
V_2 = F_48 ( V_127 , V_138 ) ;
F_1 ( V_2 , & V_177 [ 1 ] ,
V_132 ) ;
V_2 = F_48 ( V_127 , V_154 ) ;
F_1 ( V_2 , & V_178 [ 1 ] ,
V_78 ) ;
return 0 ;
}
static int F_69 ( struct V_59 * V_60 , struct V_126 * V_127 )
{
struct V_1 * V_2 ;
V_2 = F_48 ( V_127 , V_130 ) ;
F_1 ( V_2 , & V_177 [ 1 ] ,
V_132 ) ;
V_2 = F_48 ( V_127 , V_133 ) ;
F_1 ( V_2 , & V_178 [ 1 ] ,
V_78 ) ;
V_2 = F_48 ( V_127 , V_134 ) ;
F_1 ( V_2 , & V_177 [ 1 ] ,
V_132 ) ;
return 0 ;
}
static int F_70 ( struct V_29 * V_179 , int V_180 , T_1 V_82 )
{
if ( ! F_71 ( V_179 -> V_181 [ V_180 ] . V_181 ) )
return 0 ;
F_72 ( V_179 -> V_181 [ V_180 ] . V_181 , ! ! V_82 ) ;
return 1 ;
}
static int F_73 ( struct V_29 * V_179 , int V_180 )
{
return F_70 ( V_179 , V_180 , V_179 -> V_181 [ V_180 ] . V_182 ) ;
}
static int F_74 ( struct V_29 * V_179 , int V_180 )
{
return F_70 ( V_179 , V_180 , ! V_179 -> V_181 [ V_180 ] . V_182 ) ;
}
...
V_17 = F_76 ( V_30 -> V_184 [ V_99 ] . V_185 ) ;
if ( V_17 )
goto V_186;
}
F_74 ( V_30 , V_187 ) ;
...
V_30 -> V_94 = 0 ;
V_30 -> V_68 = 0 ;
for ( V_99 = V_183 - 1 ; V_99 >= 0 ; V_99 -- ) {
V_17 = F_77 ( V_30 -> V_184 [ V_99 ] . V_185 ) ;
if ( V_17 )
goto V_186;
}
return 0 ;
V_186:
for ( ++ V_99 ; V_99 < V_183 ; V_99 ++ ) {
int V_189 = F_76 ( V_30 -> V_184 [ V_99 ] . V_185 ) ;
if ( V_189 < 0 )
F_9 ( & V_30 -> V_190 , L_31 ,
V_30 -> V_184 [ V_99 ] . V_191 , V_189 ) ;
}
return V_17 ;
}
static int F_79 ( struct V_59 * V_60 , int V_87 )
{
struct V_29 * V_30 = F_32 ( V_60 ) ;
int V_17 = 0 ;
F_33 ( & V_30 -> V_95 ) ;
...
struct V_29 * V_30 = F_32 ( V_60 ) ;
int V_17 ;
V_17 = F_81 ( V_60 -> V_192 , & V_30 -> V_45 ) ;
if ( V_17 ) {
F_9 ( V_60 -> V_192 , L_34 ,
V_30 -> V_190 . V_175 ) ;
return V_17 ;
}
V_17 = F_82 ( & V_30 -> V_45 . V_193 ,
V_138 , & V_30 -> V_190 . V_193 , V_130 ,
V_194 | V_195 ) ;
V_17 = F_82 ( & V_30 -> V_45 . V_193 ,
V_154 , & V_30 -> V_190 . V_193 , V_133 ,
V_194 | V_195 ) ;
F_33 ( & V_30 -> V_95 ) ;
V_17 = F_75 ( V_30 ) ;
if ( V_17 == 0 )
...
F_78 ( V_30 ) ;
F_34 ( & V_30 -> V_95 ) ;
F_8 ( 1 , V_18 , V_60 , L_35 ,
V_19 , V_17 ? L_7 : L_36 , V_17 ) ;
return V_17 ;
}
...
{
struct V_198 * V_65 = & V_30 -> V_12 -> V_65 ;
const struct V_199 * V_181 ;
unsigned long V_25 ;
int V_17 ;
V_30 -> V_181 [ V_187 ] . V_181 = - V_66 ;
V_30 -> V_181 [ V_188 ] . V_181 = - V_66 ;
V_181 = & V_197 -> V_200 ;
if ( F_71 ( V_181 -> V_181 ) ) {
V_25 = ( V_181 -> V_182 ? V_201 : V_202 )
| V_203 ;
V_17 = F_86 ( V_65 , V_181 -> V_181 , V_25 ,
L_37 ) ;
if ( V_17 < 0 )
return V_17 ;
V_30 -> V_181 [ V_187 ] = * V_181 ;
}
V_181 = & V_197 -> V_204 ;
if ( F_71 ( V_181 -> V_181 ) ) {
V_25 = ( V_181 -> V_182 ? V_201 : V_202 )
...
if ( V_17 < 0 )
return V_17 ;
V_30 -> V_181 [ V_188 ] = * V_181 ;
}
return 0 ;
}
static int F_87 ( struct V_12 * V_13 ,
const struct V_205 * V_180 )
{
struct V_198 * V_65 = & V_13 -> V_65 ;
const struct V_196 * V_197 = V_13 -> V_65 . V_206 ;
struct V_59 * V_60 ;
struct V_59 * V_190 ;
struct V_29 * V_30 ;
int V_17 , V_99 ;
...
V_30 = F_89 ( V_65 , sizeof( * V_30 ) , V_207 ) ;
if ( ! V_30 )
return - V_208 ;
F_90 ( & V_30 -> V_95 ) ;
V_60 = & V_30 -> V_45 ;
V_190 = & V_30 -> V_190 ;
F_91 ( V_60 , & V_209 ) ;
V_60 -> V_210 = V_13 -> V_211 -> V_211 . V_210 ;
F_92 ( V_60 , V_30 ) ;
F_93 ( V_60 -> V_175 , L_40 , sizeof( V_60 -> V_175 ) ) ;
V_60 -> V_212 = & V_213 ;
V_60 -> V_25 |= V_214 ;
V_30 -> V_215 [ V_154 ] . V_25 = V_216 ;
V_30 -> V_215 [ V_138 ] . V_25 = V_216 ;
V_60 -> V_193 . type = V_217 ;
V_17 = F_94 ( & V_60 -> V_193 , V_167 ,
V_30 -> V_215 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
F_95 ( V_190 , V_13 , & V_218 ) ;
strcpy ( V_190 -> V_175 , L_41 ) ;
V_190 -> V_212 = & V_219 ;
V_190 -> V_25 |= V_214 ;
V_30 -> V_220 [ V_130 ] . V_25 = V_221 ;
V_30 -> V_220 [ V_133 ] . V_25 = V_221 ;
V_30 -> V_220 [ V_134 ] . V_25 = V_216 ;
V_190 -> V_193 . type = V_217 ;
V_17 = F_94 ( & V_190 -> V_193 , V_222 ,
V_30 -> V_220 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
V_30 -> V_223 = V_197 -> V_223 ;
V_30 -> V_224 = V_197 -> V_224 ;
V_30 -> V_12 = V_13 ;
V_17 = F_85 ( V_30 , V_197 ) ;
if ( V_17 )
goto V_225;
for ( V_99 = 0 ; V_99 < V_183 ; V_99 ++ )
V_30 -> V_184 [ V_99 ] . V_191 = V_226 [ V_99 ] ;
V_17 = F_96 ( V_65 , V_183 ,
V_30 -> V_184 ) ;
if ( V_17 ) {
F_88 ( V_65 , L_42 ) ;
goto V_225;
...
if ( V_17 )
goto V_225;
V_30 -> V_70 [ V_71 ] = & V_177 [ 1 ] ;
V_30 -> V_70 [ V_73 ] = & V_178 [ 1 ] ;
V_30 -> V_137 [ V_71 ] = V_30 -> V_70 [ V_71 ] ;
V_30 -> V_137 [ V_73 ] = V_30 -> V_70 [ V_73 ] ;
V_30 -> V_77 = V_132 ;
V_30 -> V_83 = & V_143 [ V_227 ] ;
V_30 -> V_64 [ 0 ] = 'G' ;
V_30 -> V_64 [ 1 ] = 'C' ;
V_17 = F_98 ( V_30 ) ;
if ( V_17 < 0 )
...
{
struct V_59 * V_190 = F_101 ( V_13 ) ;
struct V_29 * V_30 = F_32 ( V_190 ) ;
