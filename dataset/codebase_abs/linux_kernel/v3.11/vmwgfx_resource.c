...
if ( V_9 -> V_21 ) {
F_86 ( & V_9 -> V_21 -> V_4 . V_132 -> V_89 . V_4 ) ;
F_9 ( & V_9 -> V_22 ) ;
F_13 ( & V_9 -> V_21 ) ;
}
V_9 -> V_21 = F_87 ( V_130 ) ;
F_86 ( & V_130 -> V_4 . V_132 -> V_89 . V_4 ) ;
...
F_84 ( & V_25 -> V_139 , & V_138 ) ;
V_30 = F_89 ( V_136 , & V_138 ) ;
if ( F_31 ( V_30 != 0 ) )
goto V_140;
...
int F_92 ( struct V_8 * V_9 , bool V_142 )
{
struct V_11 * V_12 = V_9 -> V_12 ;
int V_30 ;
F_5 ( & V_12 -> V_17 ) ;
