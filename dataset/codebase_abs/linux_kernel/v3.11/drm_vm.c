...
V_42 = ( unsigned long ) V_24 -> V_43 - V_4 -> V_16 ;
V_80 = V_42 >> V_56 ;
V_47 = F_34 ( ( V_79 -> V_81 [ V_80 ] + ( V_42 & ( ~ V_82 ) ) ) ) ;
F_15 ( V_47 ) ;
V_24 -> V_47 = V_47 ;
F_16 ( L_5 , V_42 , V_80 ) ;
return 0 ;
...
{
return F_33 ( V_4 , V_24 ) ;
}
static int F_39 ( struct V_3 * V_4 , struct V_23 * V_24 )
{
...
V_4 -> V_16 , V_4 -> V_17 - V_4 -> V_16 ) ;
F_41 ( & V_30 -> V_65 ) ;
V_89 = F_42 ( sizeof( * V_89 ) , V_90 ) ;
if ( V_89 ) {
V_89 -> V_4 = V_4 ;
V_89 -> V_91 = V_92 -> V_91 ;
F_43 ( & V_89 -> V_54 , & V_30 -> V_93 ) ;
}
}
...
static int F_47 ( struct V_94 * V_95 , struct V_3 * V_4 )
{
...
int F_54 ( struct V_94 * V_95 , struct V_3 * V_4 )
{
struct V_25 * V_26 = V_95 -> V_28 ;
struct V_29 * V_30 = V_26 -> V_31 -> V_30 ;
struct V_1 * V_2 = NULL ;
...
return F_47 ( V_95 , V_4 ) ;
if ( F_11 ( & V_30 -> V_39 , V_4 -> V_40 , & V_35 ) ) {
F_31 ( L_7 ) ;
return - V_97 ;
}
V_2 = F_12 ( V_35 , struct V_32 , V_35 ) -> V_2 ;
if ( ! V_2 || ( ( V_2 -> V_10 & V_116 ) && ! F_48 ( V_98 ) ) )
return - V_117 ;
if ( V_2 -> V_76 < V_4 -> V_17 - V_4 -> V_16 )
return - V_97 ;
if ( ! F_48 ( V_98 ) && ( V_2 -> V_10 & V_118 ) ) {
V_4 -> V_6 &= ~ ( V_100 | V_101 ) ;
#if F_3 ( V_7 ) || F_3 ( V_8 )
F_6 ( V_4 -> V_102 ) &= ~ V_103 ;
#else
...
int F_58 ( struct V_94 * V_95 , struct V_3 * V_4 )
{
struct V_25 * V_26 = V_95 -> V_28 ;
struct V_29 * V_30 = V_26 -> V_31 -> V_30 ;
int V_123 ;
