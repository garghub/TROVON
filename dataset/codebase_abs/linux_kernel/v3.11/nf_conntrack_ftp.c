...
return 0 ;
if ( V_2 <= V_32 ) {
if ( F_15 ( V_9 , V_31 , V_2 ) == 0 )
return - 1 ;
else return 0 ;
}
if ( F_15 ( V_9 , V_31 , V_32 ) != 0 ) {
#if 0
size_t i;
...
static int F_16 ( T_6 V_36 , const struct V_37 * V_38 , int V_39 )
{
unsigned int V_13 ;
...
static void F_17 ( struct V_42 * V_43 , T_6 V_44 ,
...
if ( F_18 ( V_38 -> V_41 [ V_39 ] [ 0 ] , V_38 -> V_41 [ V_39 ] [ 1 ] ) )
V_47 = 0 ;
else
V_47 = 1 ;
if ( F_19 ( V_44 , V_38 -> V_41 [ V_39 ] [ V_47 ] ) )
...
struct V_37 * V_61 = F_22 ( V_43 ) ;
struct V_62 * exp ;
union V_63 * V_64 ;
struct V_15 V_16 = {} ;
unsigned int V_13 ;
int V_65 = 0 , V_66 ;
F_23 (nf_nat_ftp_hook) V_67 ;
if ( V_51 != V_68 &&
V_51 != V_69 ) {
F_5 ( L_14 , V_51 ) ;
return V_70 ;
}
V_55 = F_24 ( V_46 , V_49 , sizeof( V_56 ) , & V_56 ) ;
if ( V_55 == NULL )
return V_70 ;
...
V_53 = V_46 -> V_14 - V_52 ;
F_25 ( & V_72 ) ;
V_57 = F_24 ( V_46 , V_52 , V_53 , V_73 ) ;
F_26 ( V_57 == NULL ) ;
V_66 = ( V_57 [ V_53 - 1 ] == '\n' ) ;
V_36 = F_27 ( V_55 -> V_36 ) + V_53 ;
if ( ! F_16 ( F_27 ( V_55 -> V_36 ) , V_61 , V_39 ) ) {
if ( F_28 ( V_61 -> V_74 [ V_39 ] & V_75 ) ) {
V_61 -> V_74 [ V_39 ] ^= V_75 ;
goto V_76;
}
F_5 ( L_16 ,
...
for ( V_13 = 0 ; V_13 < F_30 ( V_81 [ V_39 ] ) ; V_13 ++ ) {
V_65 = F_13 ( V_57 , V_53 ,
V_81 [ V_39 ] [ V_13 ] . V_31 ,
V_81 [ V_39 ] [ V_13 ] . V_32 ,
V_81 [ V_39 ] [ V_13 ] . V_33 ,
...
V_77:
if ( V_66 )
F_17 ( V_43 , V_36 , V_61 , V_39 , V_46 ) ;
V_83:
F_37 ( & V_72 ) ;
return V_7 ;
}
static int F_38 ( struct V_92 * V_93 , struct V_42 * V_43 )
{
struct V_37 * V_94 = F_22 ( V_43 ) ;
V_94 -> V_74 [ V_95 ] |= V_75 ;
V_94 -> V_74 [ V_96 ] |= V_75 ;
return 0 ;
}
...
V_94 [ V_13 ] [ V_97 ] . F_20 = F_20 ;
V_94 [ V_13 ] [ V_97 ] . V_109 = F_38 ;
if ( V_100 [ V_13 ] == V_103 )
