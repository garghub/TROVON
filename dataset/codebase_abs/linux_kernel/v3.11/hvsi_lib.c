...
int F_13 ( struct V_1 * V_2 , char * V_46 , int V_47 )
{
...
if ( V_2 -> V_41 ) {
unsigned int V_51 = F_15 ( V_47 , ( int ) V_2 -> V_41 ) ;
...
int F_16 ( struct V_1 * V_2 , const char * V_46 , int V_47 )
{
struct V_53 V_54 ;
int V_55 , V_56 = F_15 ( V_47 , V_57 ) ;
if ( F_14 ( ! V_2 ) )
return - V_58 ;
V_54 . V_12 . type = V_42 ;
...
static void F_17 ( unsigned long V_60 )
{
if ( F_18 () )
F_19 ( V_60 ) ;
else
...
V_10 . V_12 . type = V_13 ;
V_10 . V_12 . V_8 = sizeof( struct V_9 ) ;
V_10 . V_12 . V_5 = F_2 ( & V_2 -> V_5 ) ;
V_10 . V_14 = V_37 ;
V_55 = F_1 ( V_2 , & V_10 . V_12 ) ;
if ( V_55 <= 0 ) {
F_5 ( L_7 , V_2 -> V_7 , V_55 ) ;
return V_55 ;
}
...
int F_22 ( struct V_1 * V_2 , int V_63 )
{
struct V_16 V_17 ;
unsigned short V_21 ;
V_21 = V_2 -> V_21 ;
...
int F_25 ( struct V_1 * V_2 , struct V_68 * V_69 )
{
F_5 ( L_18 , V_2 -> V_7 ) ;
V_2 -> V_70 = F_26 ( & V_69 -> V_71 ) ;
F_23 ( V_2 ) ;
return 0 ;
}
void F_27 ( struct V_1 * V_2 , struct V_68 * V_69 )
{
unsigned long V_72 ;
F_5 ( L_19 , V_2 -> V_7 ) ;
if ( ! V_2 -> V_23 ) {
