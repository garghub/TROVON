...
{
struct V_197 * V_250 = (struct V_197 * ) V_248 -> V_251 ;
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_197 V_252 ;
struct V_34 * V_35 ;
T_4 V_253 , * V_254 ;
...
V_35 = F_124 ( V_2 , V_255 , V_248 -> V_258 & V_259 , & V_196 ) ;
if ( V_35 == NULL )
goto V_152;
F_125 ( V_35 , V_255 - V_249 ) ;
if ( F_126 ( F_127 ( V_35 , V_249 ) , V_248 -> V_267 , V_249 ) ) {
V_196 = - V_59 ;
F_35 ( V_35 ) ;
goto V_152;
}
...
F_130 ( V_3 , V_3 -> V_97 , V_35 ) ;
V_196 = V_249 ;
goto V_152;
}
F_129 ( V_35 , 1 + F_131 ( V_254 ) ) ;
V_256 = F_132 ( V_35 -> V_43 , & V_3 -> V_24 , & V_252 . V_204 ,
V_254 , V_72 , V_81 ) ;
F_133 ( V_35 , V_256 ) ;
* F_134 ( V_35 ) = V_268 ;
F_135 ( V_35 , V_3 -> T_2 -> V_7 ) ;
V_196 = V_249 ;
V_152:
F_73 ( V_2 ) ;
return V_196 ;
}
static int F_136 ( struct V_245 * V_246 , struct V_126 * V_1 ,
...
F_140 ( V_35 , 0 , V_248 -> V_267 , V_269 ) ;
if ( V_248 -> V_257 != 0 ) {
struct V_197 * V_252 = (struct V_197 * ) V_248 -> V_251 ;
T_4 V_22 ;
T_3 V_271 ;
const unsigned char * V_272 = F_141 ( V_35 ) ;
memset ( V_252 , 0 , sizeof( struct V_193 ) ) ;
F_142 ( V_272 + 1 , V_35 -> V_43 - V_272 - 1 , & V_271 , NULL ,
& V_22 , NULL , NULL ) ;
V_252 -> V_199 = V_200 ;
...
static int F_144 ( struct V_126 * V_2 , int V_273 )
{
return - V_153 ;
}
static int F_145 ( struct V_126 * V_1 , unsigned int V_53 , unsigned long V_54 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
void T_5 * V_274 = ( void T_5 * ) V_54 ;
int V_134 = 0 ;
F_70 ( V_2 ) ;
switch ( V_53 ) {
case V_275 : {
long V_276 ;
V_276 = V_2 -> V_177 - F_146 ( V_2 ) ;
if ( V_276 < 0 )
V_276 = 0 ;
V_134 = F_77 ( V_276 , ( int T_5 * ) V_274 ) ;
break;
}
case V_277 : {
struct V_34 * V_35 ;
long V_276 = 0L ;
if ( ( V_35 = F_147 ( & V_2 -> V_44 ) ) != NULL )
V_276 = V_35 -> V_249 ;
V_134 = F_77 ( V_276 , ( int T_5 * ) V_274 ) ;
break;
}
case V_278 :
V_134 = F_148 ( V_2 , V_274 ) ;
break;
case V_279 :
V_134 = F_149 ( V_2 , V_274 ) ;
break;
case V_280 :
case V_281 :
case V_282 : {
struct V_197 V_45 ;
if ( F_55 ( & V_45 , V_274 , sizeof( V_45 ) ) ) {
V_134 = - V_59 ;
break;
}
V_134 = F_150 ( V_53 , & V_45 ) ;
break;
}
case V_283 : {
long V_276 ;
...
V_134 = F_54 ( V_53 , V_274 ) ;
break;
case V_290 :
case V_291 : {
T_1 * V_3 = F_3 ( V_2 ) ;
struct V_292 V_293 ;
V_293 . V_86 = V_3 -> V_86 / V_52 ;
V_293 . V_88 = V_3 -> V_88 / V_52 ;
V_293 . V_93 = V_3 -> V_93 / V_52 ;
V_293 . V_95 = V_3 -> V_95 / ( 60 * V_52 ) ;
V_293 . V_91 = V_3 -> V_91 ;
V_293 . V_294 = F_152 ( & V_3 -> V_294 ) / V_52 ;
V_293 . V_295 = F_152 ( & V_3 -> V_295 ) / V_52 ;
V_293 . V_296 = F_152 ( & V_3 -> V_296 ) / V_52 ;
V_293 . V_297 = F_152 ( & V_3 -> V_297 ) / ( 60 * V_52 ) ;
V_293 . V_90 = V_3 -> V_90 ;
V_293 . V_46 = V_3 -> V_46 ;
V_293 . V_298 = F_153 ( V_2 ) ;
V_293 . V_299 = F_146 ( V_2 ) ;
V_293 . V_300 = V_3 -> V_300 ;
V_293 . V_301 = V_3 -> V_301 ;
V_293 . V_302 = V_3 -> V_302 ;
V_293 . V_303 = V_3 -> V_300 ;
V_293 . V_97 = V_3 -> V_97 ;
V_293 . V_83 = V_3 -> V_83 ;
if ( V_53 == V_291 ) {
static int V_304 = 0 ;
...
if ( F_78 ( V_274 , & V_293 , sizeof( struct V_306 ) ) ) {
V_134 = - V_59 ;
break;
}
} else {
if ( F_78 ( V_274 , & V_293 , sizeof( struct V_292 ) ) ) {
V_134 = - V_64 ;
break;
}
}
...
if ( F_55 ( & V_310 , V_274 , sizeof( V_310 ) ) ) {
V_134 = - V_59 ;
break;
}
V_134 = F_154 ( V_53 , & V_310 ) ;
break;
}
case V_311 :
case V_312 :
...
static void * F_155 ( struct V_322 * V_323 , T_9 * V_324 )
__acquires( V_5 )
{
F_6 ( & V_5 ) ;
return F_156 ( & V_20 , * V_324 ) ;
}
static void * F_157 ( struct V_322 * V_323 , void * V_325 , T_9 * V_324 )
{
return F_158 ( V_325 , & V_20 , V_324 ) ;
}
static void F_159 ( struct V_322 * V_323 , void * V_325 )
__releases( V_5 )
{
F_8 ( & V_5 ) ;
}
static int F_160 ( struct V_322 * V_323 , void * V_325 )
{
T_1 * V_3 = F_161 ( V_325 , struct T_1 , V_4 ) ;
char V_326 [ 11 ] ;
int V_57 ;
F_162 ( V_323 , L_3 ,
( long ) V_3 ,
V_3 -> T_2 == NULL ? L_4 : V_3 -> T_2 -> V_7 -> V_149 ,
F_163 ( V_326 , & V_3 -> V_24 ) ,
V_3 -> V_23 ? L_5 : L_6 ) ;
F_162 ( V_323 , L_7 , F_163 ( V_326 , & V_3 -> V_29 ) ) ;
for ( V_57 = 0 ; ( V_3 -> V_33 != NULL ) && ( V_57 < V_3 -> V_33 -> V_32 ) ; V_57 ++ ) {
F_162 ( V_323 , L_8 ,
F_163 ( V_326 , & V_3 -> V_33 -> V_67 [ V_57 ] ) ,
V_3 -> V_33 -> V_226 [ V_57 ] ? L_5 : L_6 ) ;
}
F_162 ( V_323 , L_9 ,
V_3 -> V_46 ,
V_3 -> V_300 , V_3 -> V_301 , V_3 -> V_302 ,
F_152 ( & V_3 -> V_294 ) / V_52 , V_3 -> V_86 / V_52 ,
F_152 ( & V_3 -> V_295 ) / V_52 , V_3 -> V_88 / V_52 ,
F_152 ( & V_3 -> V_296 ) / V_52 , V_3 -> V_93 / V_52 ,
F_152 ( & V_3 -> V_297 ) / ( 60 * V_52 ) ,
V_3 -> V_95 / ( 60 * V_52 ) ,
V_3 -> V_90 , V_3 -> V_91 ,
V_3 -> V_85 / V_52 ,
V_3 -> V_83 ,
...
static int F_166 ( struct V_327 * V_327 , struct V_328 * V_328 )
{
return F_167 ( V_328 , & V_329 ) ;
}
static int T_10 F_168 ( void )
{
int V_330 = F_169 ( & V_167 , 0 ) ;
if ( V_330 != 0 )
goto V_152;
F_170 ( & V_331 ) ;
F_171 ( & V_332 ) ;
F_172 ( & V_333 ) ;
F_173 ( L_12 , V_334 , V_15 . V_335 ,
& V_336 ) ;
F_173 ( L_13 , V_334 , V_15 . V_335 , & V_337 ) ;
F_173 ( L_14 , V_334 , V_15 . V_335 , & V_338 ) ;
V_152:
return V_330 ;
}
static void T_11 F_174 ( void )
{
F_175 ( L_12 , V_15 . V_335 ) ;
F_175 ( L_13 , V_15 . V_335 ) ;
F_175 ( L_14 , V_15 . V_335 ) ;
F_176 ( & V_333 ) ;
F_177 ( & V_332 ) ;
F_178 ( V_159 ) ;
F_179 ( & V_167 ) ;
