...
T_2 V_105 ;
V_29 = (struct V_21 * ) V_4 -> V_15 -> V_25 ;
V_105 = V_106 / sizeof( struct V_48 ) ;
if ( V_105 < V_29 -> V_52 + 1 )
return true ;
return false ;
}
...
V_4 -> V_87 = V_88 ;
V_29 = (struct V_21 * ) V_4 -> V_15 -> V_25 ;
V_29 -> V_94 = F_33 ( & V_6 -> V_64 ) ;
memcpy ( V_29 -> V_89 , V_90 , V_33 ) ;
V_29 -> V_111 . V_112 = V_113 ;
...
if ( ! V_97 )
continue;
if ( ! F_11 ( V_97 -> V_44 , V_99 -> V_104 ) )
goto V_115;
if ( V_97 -> V_116 -> V_117 != V_118 )
goto V_115;
if ( V_97 -> V_103 < 1 )
goto V_115;
V_110 = F_47 ( V_4 -> V_15 , sizeof( * V_8 ) ) ;
V_8 = (struct V_48 * ) V_110 ;
memcpy ( V_8 -> V_49 ,
V_97 -> V_116 -> V_60 -> V_119 ,
V_33 ) ;
memcpy ( V_8 -> V_51 , V_99 -> V_104 , V_33 ) ;
V_8 -> V_50 = V_97 -> V_103 ;
V_29 -> V_52 ++ ;
V_115:
F_62 ( V_97 ) ;
...
memcpy ( V_8 -> V_51 , V_109 -> V_44 , V_33 ) ;
V_8 -> V_50 = 0 ;
V_29 -> V_52 ++ ;
if ( F_63 ( V_4 ) )
goto V_120;
...
V_99 -> V_104 ) )
continue;
memcpy ( V_29 -> V_89 , V_99 -> V_104 , V_33 ) ;
V_125 = F_70 ( V_4 -> V_15 , V_45 ) ;
if ( ! V_125 )
continue;
V_126 = F_71 ( V_125 , V_99 , NULL ) ;
if ( V_126 == V_127 )
F_9 ( V_125 ) ;
}
F_16 () ;
...
struct V_21 * V_29 ;
V_29 = (struct V_21 * ) V_4 -> V_15 -> V_25 ;
V_99 = F_73 ( V_6 , V_29 -> V_89 ) ;
if ( ! V_99 )
goto V_65;
V_125 = F_70 ( V_4 -> V_15 , V_45 ) ;
if ( ! V_125 )
goto V_65;
if ( F_71 ( V_125 , V_99 , NULL ) == V_127 )
F_9 ( V_125 ) ;
V_65:
if ( V_99 )
F_74 ( V_99 ) ;
...
goto V_65;
V_29 = (struct V_21 * ) V_4 -> V_15 -> V_25 ;
if ( V_29 -> V_111 . V_112 < 2 ) {
F_76 ( L_7 ) ;
goto V_65;
}
memcpy ( V_29 -> V_85 , V_58 -> V_60 -> V_119 , V_33 ) ;
V_29 -> V_111 . V_112 -- ;
if ( F_58 ( V_29 -> V_89 ) )
F_69 ( V_6 , V_4 ) ;
else
...
static void F_77 ( struct V_128 * V_129 )
{
struct V_130 * V_130 ;
struct V_5 * V_6 ;
struct V_131 * V_132 ;
...
F_85 ( V_6 -> V_12 . V_31 ,
& V_136 ) ;
V_6 -> V_12 . V_107 = F_19 ( V_106 , V_45 ) ;
if ( ! V_6 -> V_12 . V_107 )
goto V_135;
V_82 = sizeof( * V_29 ) + V_106 + V_86 ;
V_6 -> V_12 . V_107 -> V_15 = F_51 ( NULL ,
V_82 ) ;
if ( ! V_6 -> V_12 . V_107 -> V_15 )
goto V_137;
F_52 ( V_6 -> V_12 . V_107 -> V_15 , V_86 ) ;
V_80 = V_6 -> V_12 . V_107 -> V_15 ;
V_29 = (struct V_21 * ) F_47 ( V_80 , sizeof( * V_29 ) ) ;
V_87 = V_88 - F_81 ( V_134 ) ;
V_6 -> V_12 . V_107 -> V_87 = V_87 ;
F_54 ( & V_6 -> V_12 . V_107 -> V_69 ) ;
F_54 ( & V_6 -> V_12 . V_107 -> V_11 ) ;
F_53 ( & V_6 -> V_12 . V_107 -> V_10 ) ;
V_6 -> V_12 . V_107 -> V_6 = V_6 ;
V_29 -> V_111 . V_138 = V_139 ;
V_29 -> V_111 . V_140 = V_141 ;
V_29 -> V_111 . V_112 = V_113 ;
V_29 -> V_84 = 0 ;
V_29 -> V_114 = 0 ;
V_29 -> V_52 = 0 ;
...
if ( V_81 != 0 ) {
F_84 ( L_9 ) ;
F_41 ( & V_6 -> V_12 . V_107 -> V_10 , F_1 ) ;
goto V_135;
}
F_8 ( & V_6 -> V_12 . V_67 ) ;
F_86 ( & V_6 -> V_12 . V_129 , F_77 ) ;
F_80 ( V_133 , & V_6 -> V_12 . V_129 ,
F_81 ( V_134 ) ) ;
return 0 ;
V_137:
...
static void F_88 ( struct V_16 * V_17 , void * V_143 )
{
struct V_3 * V_4 ;
