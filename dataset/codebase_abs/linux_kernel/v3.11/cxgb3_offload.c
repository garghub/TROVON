...
return - V_302 ;
V_305 = - V_59 ;
if ( V_18 -> V_310 ( V_18 , V_139 , & V_91 -> V_311 ) < 0 ||
V_18 -> V_310 ( V_18 , V_135 , & V_91 -> V_312 ) < 0 ||
V_18 -> V_310 ( V_18 , V_148 , & V_307 ) < 0 ||
V_18 -> V_310 ( V_18 , V_149 , & V_124 ) < 0 ||
V_18 -> V_310 ( V_18 , V_140 , & V_122 ) < 0 ||
V_18 -> V_310 ( V_18 , V_147 , & V_306 ) < 0 )
goto V_313;
V_305 = - V_302 ;
V_309 = F_154 ( V_307 ) ;
if ( ! V_309 )
goto V_313;
V_300 = F_24 ( V_122 . V_141 / 2 , V_314 ) ;
V_305 = F_145 ( & V_91 -> V_187 , V_122 . V_141 , V_300 ,
V_306 . V_141 , V_315 , V_306 . V_146 ) ;
if ( V_305 )
goto V_316;
V_91 -> V_151 = V_124 . V_151 ;
V_91 -> V_317 = V_124 . V_109 ;
F_155 ( & V_91 -> V_214 , F_68 ) ;
F_147 ( & V_91 -> V_215 ) ;
F_156 ( & V_91 -> V_318 ) ;
V_91 -> V_18 = V_18 ;
F_157 ( V_18 -> V_319 , V_309 ) ;
F_54 ( V_18 ) = V_91 ;
V_18 -> V_183 = F_122 ;
V_18 -> V_184 = F_129 ;
if ( F_158 ( & V_304 ) )
...
static void F_161 ( struct V_321 * V_322 )
{
struct V_308 * V_323 = F_69 ( V_322 , struct V_308 , V_321 ) ;
F_160 ( V_323 ) ;
}
...
V_323 = F_136 ( V_2 ) ;
F_21 () ;
F_157 ( V_2 -> V_319 , NULL ) ;
F_164 ( & V_323 -> V_321 , F_161 ) ;
if ( V_91 -> V_219 )
F_123 ( V_91 -> V_219 ) ;
F_144 ( V_91 ) ;
}
...
static int V_324 ;
F_5 ( & V_8 ) ;
snprintf ( V_2 -> V_55 , sizeof( V_2 -> V_55 ) , L_15 , V_324 ++ ) ;
F_6 ( & V_2 -> V_325 , & V_325 ) ;
F_8 ( & V_8 ) ;
}
