...
static void F_154 ( int V_34 )
{
struct V_3 * V_23 = & F_24 ( V_38 , V_34 ) ;
int V_64 ;
for ( V_64 = 0 ; V_64 < V_65 ; V_64 ++ ) {
V_23 -> V_13 [ V_64 ] . V_23 = V_23 ;
F_155 ( & V_23 -> V_13 [ V_64 ] . V_68 ) ;
}
F_72 ( V_23 ) ;
}
static void F_156 ( struct V_19 * V_158 ,
struct V_19 * V_27 )
{
struct V_20 * V_21 ;
struct V_66 * V_69 ;
...
V_27 = & F_69 ( V_38 ) ;
F_28 ( & V_27 -> V_24 ) ;
F_161 ( & V_158 -> V_24 , V_161 ) ;
for ( V_64 = 0 ; V_64 < V_65 ; V_64 ++ ) {
F_156 ( & V_158 -> V_13 [ V_64 ] ,
& V_27 -> V_13 [ V_64 ] ) ;
}
F_27 ( & V_158 -> V_24 ) ;
F_27 ( & V_27 -> V_24 ) ;
...
static int F_163 ( struct V_162 * V_163 ,
...
void T_6 F_166 ( void )
{
F_163 ( & V_175 , ( unsigned long ) V_166 ,
( void * ) ( long ) F_23 () ) ;
F_167 ( & V_175 ) ;
#ifdef F_19
F_168 ( V_111 , F_133 ) ;
...
int T_7
F_169 ( T_2 * V_28 , unsigned long V_94 ,
...
int T_7 F_171 ( T_2 * V_28 , unsigned long V_94 ,
const enum V_58 V_59 )
{
return F_169 ( V_28 , V_94 , V_59 ,
V_115 ) ;
}
int T_7 F_172 ( T_2 * V_28 ,
const enum V_58 V_59 )
{
return F_171 ( V_28 , 0 , V_59 ) ;
}
