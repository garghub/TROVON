...
const T_1 * V_5 , T_2 V_6 , T_4 V_39 )
{
struct V_10 * V_10 = V_8 -> V_10 ;
struct V_11 * V_12 = F_2 ( V_10 ) ;
struct V_94 * V_95 ;
...
if ( ! ( V_139 -> V_104 & F_62 ( V_121 ) ) ) {
F_85 ( false ) ;
return false ;
}
V_43 = V_5 + F_86 ( V_14 -> V_33 ) ;
V_140 = V_6 - F_86 ( V_14 -> V_33 ) ;
F_64 ( & V_8 -> V_106 ) ;
F_65 (reg, &wdev->mgmt_registrations, list) {
if ( V_95 -> V_91 != V_142 )
continue;
...
int V_154 , V_72 ;
V_145 = F_89 ( V_144 , struct V_145 , V_144 ) ;
V_12 = F_89 ( V_145 , struct V_11 ,
V_155 ) ;
V_10 = & V_12 -> V_10 ;
F_90 () ;
for ( V_154 = 0 ; V_154 < V_156 ; V_154 ++ ) {
V_149 = V_10 -> V_157 [ V_154 ] ;
if ( ! V_149 )
continue;
for ( V_72 = 0 ; V_72 < V_149 -> V_158 ; V_72 ++ ) {
V_150 = & V_149 -> V_159 [ V_72 ] ;
...
V_153 = F_66 ( V_153 , V_152 - V_164 ) ;
V_151 = true ;
}
}
F_94 () ;
if ( V_151 )
F_95 ( V_169 , & V_12 -> V_155 ,
V_153 ) ;
}
...
unsigned long V_152 ;
F_97 ( V_10 , V_147 ) ;
F_98 ( V_10 , V_147 , V_161 ) ;
V_152 = F_99 ( V_163 ) ;
F_95 ( V_169 , & V_12 -> V_155 ,
V_152 ) ;
F_93 ( V_12 , V_147 , V_170 , NULL , V_39 ) ;
}
void F_100 ( struct V_1 * V_24 ,
enum V_171 V_172 , T_4 V_39 )
{
...
if ( F_22 ( ! V_8 -> V_66 ) )
return;
F_92 ( & V_147 , V_8 -> V_66 , V_166 ) ;
switch ( V_172 ) {
case V_174 :
V_152 = V_8 -> V_175 +
F_99 ( V_176 ) ;
F_22 ( ! F_91 ( V_164 , V_152 ) ) ;
F_98 ( V_10 , & V_147 , V_177 ) ;
break;
case V_178 :
break;
default:
...
V_8 -> V_173 = false ;
F_93 ( V_12 , & V_147 , V_172 , V_24 , V_39 ) ;
}
