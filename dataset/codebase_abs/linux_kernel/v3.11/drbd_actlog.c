...
int F_85 ( struct V_1 * V_2 , void * V_116 )
{
...
int V_75 ;
memset ( V_91 , 0 , 4096 ) ;
V_91 -> V_122 = F_67 ( V_123 ) ;
V_91 -> V_154 = F_69 ( V_155 ) ;
V_91 -> F_73 = F_67 ( F_73 ( 0 , V_91 , 4096 ) ) ;
for ( V_75 = 0 ; V_75 < V_112 ; V_75 ++ ) {
int V_27 = F_27 ( V_2 , V_2 -> V_46 , V_153 + V_75 * 8 , V_30 ) ;
if ( V_27 )
return V_27 ;
}
return 0 ;
}
static int F_86 ( struct V_140 * V_141 , int V_142 )
{
struct V_156 * V_157 = F_76 ( V_141 , struct V_156 , V_141 ) ;
struct V_1 * V_2 = V_141 -> V_2 ;
...
F_90 ( V_2 , F_61 ( V_157 -> V_59 ) ) ;
F_66 ( V_2 ) ;
F_89 ( V_157 ) ;
if ( F_91 ( V_2 ) <= V_2 -> V_163 ) {
...
V_171 -> V_163 , V_169 ,
F_96 ( V_2 -> V_6 . V_164 ) ) ;
V_171 -> V_172 = F_97 ( V_2 , V_59 ) ;
}
} else {
int V_172 = F_97 ( V_2 , V_59 ) ;
if ( V_171 -> V_19 != 0 ) {
F_88 ( V_20 , L_16
L_17 ,
V_171 -> V_65 . V_81 , V_171 -> V_172 ,
...
F_58 ( V_2 -> V_62 , & V_171 -> V_65 ) ;
if ( V_171 -> V_172 == V_171 -> V_163 ) {
V_171 -> V_163 = 0 ;
V_157 = F_98 ( sizeof( * V_157 ) , V_173 ) ;
if ( V_157 ) {
V_157 -> V_59 = V_171 -> V_65 . V_81 ;
V_157 -> V_141 . V_147 = F_86 ;
V_157 -> V_141 . V_2 = V_2 ;
F_79 ( & V_2 -> V_84 -> V_148 , & V_157 -> V_141 ) ;
} else {
F_88 ( V_20 , L_20 ) ;
}
}
...
int F_7 = 0 ;
unsigned long V_19 ;
if ( V_25 <= 0 || ! F_102 ( V_25 , 512 ) || V_25 > V_190 ) {
F_14 ( V_20 , L_22 ,
...
if ( ! F_64 ( V_2 ) )
return;
V_189 = F_103 ( V_2 -> V_191 ) ;
V_188 = V_23 + ( V_25 >> 9 ) - 1 ;
if ( ! F_104 ( V_23 < V_189 ) )
goto V_40;
if ( ! F_104 ( V_188 < V_189 ) )
V_188 = V_189 - 1 ;
V_187 = F_105 ( V_189 - 1 ) ;
...
V_186 = F_105 ( V_188 - ( V_192 - 1 ) ) ;
V_185 = F_105 ( V_23 + V_192 - 1 ) ;
if ( V_185 > V_186 )
goto V_40;
V_169 = F_106 ( V_2 , V_185 , V_186 ) ;
if ( V_169 ) {
F_99 ( V_2 , F_91 ( V_2 ) ) ;
F_57 ( & V_2 -> V_70 , V_19 ) ;
F_94 ( V_2 , V_23 , V_169 , true ) ;
F_59 ( & V_2 -> V_70 , V_19 ) ;
F_7 = 1 ;
}
V_40:
...
static
struct V_58 * F_109 ( struct V_1 * V_2 , unsigned int V_59 )
{
struct V_60 * V_117 ;
struct V_58 * V_64 ;
int V_193 = 0 ;
...
static int F_111 ( struct V_1 * V_2 , unsigned int V_59 )
{
int V_149 ;
F_39 ( & V_2 -> V_70 ) ;
V_149 = F_112 ( V_2 -> V_73 , V_59 ) ;
F_41 ( & V_2 -> V_70 ) ;
return V_149 ;
}
int F_113 ( struct V_1 * V_2 , T_1 V_23 )
{
unsigned int V_59 = F_95 ( V_23 ) ;
struct V_58 * V_64 ;
int V_75 , V_197 ;
int V_198 = 200 ;
V_199:
V_197 = F_114 ( V_2 -> V_72 ,
( V_64 = F_109 ( V_2 , V_59 ) ) ) ;
if ( V_197 )
return - V_200 ;
...
V_64 = V_117 ? F_37 ( V_117 , struct V_58 , V_65 ) : NULL ;
if ( V_64 ) {
F_28 ( ! F_13 ( V_201 , & V_64 -> V_19 ) ) ;
F_28 ( F_13 ( V_66 , & V_64 -> V_19 ) ) ;
F_117 ( V_66 , & V_64 -> V_19 ) ;
V_2 -> V_202 = V_130 ;
if ( F_58 ( V_2 -> V_62 , & V_64 -> V_65 ) == 0 )
V_2 -> V_174 -- ;
F_7 ( & V_2 -> V_72 ) ;
...
return;
F_39 ( & V_2 -> V_70 ) ;
V_169 = F_123 ( V_2 , V_185 , V_186 ) ;
if ( V_169 ) {
V_2 -> V_163 += V_169 ;
if ( F_64 ( V_2 ) ) {
F_94 ( V_2 , V_23 , V_169 , false ) ;
F_66 ( V_2 ) ;
}
F_7 = 1 ;
}
