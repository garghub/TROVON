...
T_2 V_12 = 0x0218 * ( V_2 -> V_13 [ V_8 ] - 1 ) ;
T_2 V_14 = 0x0648 * ( V_2 -> V_13 [ V_8 ] - 1 ) ;
T_2 V_15 = 0x0218 ;
T_2 V_16 = 0x0648 ;
V_5 [ V_8 ] [ 0 ] = 0x10000000 | ( V_12 << 16 ) | V_7 ;
V_5 [ V_8 ] [ 1 ] = 0x00000000 | ( V_14 << 16 ) ;
V_7 += 0x0324 * ( V_2 -> V_13 [ V_8 ] - 1 ) ; ;
V_5 [ V_8 ] [ 2 ] = 0x10000000 | ( V_15 << 16 ) | V_7 ;
V_5 [ V_8 ] [ 3 ] = 0x00000000 | ( V_16 << 16 ) ;
V_7 += 0x0324 ;
}
for ( V_8 = 0 ; V_8 < V_2 -> V_11 ; V_8 ++ ) {
F_3 ( F_4 ( V_8 , 0x30c0 ) , V_5 [ V_8 ] [ 0 ] , 0 , 0 ) ;
F_3 ( F_4 ( V_8 , 0x30e4 ) , V_5 [ V_8 ] [ 1 ] | V_7 , 0 , 0 ) ;
V_7 += 0x07ff * ( V_2 -> V_13 [ V_8 ] - 1 ) ;
F_3 ( F_4 ( V_8 , 0x32c0 ) , V_5 [ V_8 ] [ 2 ] , 0 , 0 ) ;
F_3 ( F_4 ( V_8 , 0x32e4 ) , V_5 [ V_8 ] [ 3 ] | V_7 , 0 , 0 ) ;
V_7 += 0x07ff ;
}
