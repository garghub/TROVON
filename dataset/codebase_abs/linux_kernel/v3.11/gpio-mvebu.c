...
V_10 = V_11 ;
V_77 = F_54 ( V_69 , V_83 , 0 ) ;
if ( ! V_77 ) {
F_55 ( & V_69 -> V_74 , L_14 ) ;
return - V_84 ;
}
V_2 = F_56 ( & V_69 -> V_74 , sizeof( struct V_1 ) , V_85 ) ;
if ( ! V_2 ) {
F_55 ( & V_69 -> V_74 , L_15 ) ;
return - V_86 ;
}
if ( F_57 ( V_69 -> V_74 . V_75 , L_16 , & V_79 ) ) {
F_55 ( & V_69 -> V_74 , L_17 ) ;
return - V_84 ;
}
V_80 = F_58 ( V_69 -> V_74 . V_75 , L_18 ) ;
if ( V_80 < 0 ) {
F_55 ( & V_69 -> V_74 , L_19 ) ;
return V_80 ;
}
V_78 = F_59 ( & V_69 -> V_74 , NULL ) ;
if ( ! F_60 ( V_78 ) )
F_61 ( V_78 ) ;
V_2 -> V_10 = V_10 ;
V_2 -> V_19 . V_65 = F_62 ( & V_69 -> V_74 ) ;
