...
goto V_213;
F_2 ( L_40 ,
V_18 , V_210 -> V_216 , V_210 -> V_95 ) ;
for ( V_69 = 0 ; V_69 < V_210 -> V_216 ; V_69 ++ ) {
...
static T_7 F_138 ( struct V_92 * V_92 , T_6 V_228 )
{
struct V_229 * V_230 = V_92 -> V_132 ;
T_6 V_100 ;
V_100 = F_139 ( F_140 ( V_92 ) , V_44 ) ;
if ( V_100 != F_119 ( V_92 ) -> V_84 ) {
F_141 () ;
V_100 = F_142 ( & V_230 -> V_231 , V_228 + 1 , V_232 ) ;
F_143 () ;
}
if ( ! V_100 )
return F_140 ( V_92 ) - ( V_228 << V_81 ) ;
else
return ( V_100 - V_228 ) << V_81 ;
}
static void
...
T_7 V_233 ;
if ( V_225 -> V_226 == NULL )
V_233 = F_138 ( V_225 -> V_234 ,
V_220 -> V_235 ) ;
else
V_233 = F_146 ( V_225 -> V_226 ) ;
F_147 ( V_225 , V_220 , V_233 ) ;
}
}
static bool
...
static struct V_236 * F_149 ( struct V_237 * V_238 ,
struct V_239 * V_240 )
{
struct V_236 * V_241 , * V_236 ;
V_241 = F_150 ( V_238 , V_242 ) ;
if ( V_241 == NULL )
return F_31 ( - V_243 ) ;
V_236 = F_151 ( V_241 , L_43 , NULL , V_240 ) ;
F_152 ( V_241 ) ;
return V_236 ;
}
static void F_153 ( struct V_237 * V_238 ,
struct V_239 * V_240 )
{
if ( V_240 -> V_236 )
F_154 ( V_240 -> V_236 ) ;
}
static int F_155 ( struct V_244 * V_245 , unsigned long V_246 ,
void * V_247 )
{
struct V_237 * V_238 = V_247 ;
struct V_248 * V_248 = V_238 -> V_249 ;
struct V_250 * V_251 = F_156 ( V_248 , V_252 ) ;
struct V_236 * V_236 ;
int V_120 = 0 ;
if ( ! F_157 ( V_253 ) )
return 0 ;
...
switch ( V_246 ) {
case V_255 :
V_236 = F_149 ( V_238 , V_251 -> V_254 ) ;
if ( F_50 ( V_236 ) ) {
V_120 = F_51 ( V_236 ) ;
break;
}
V_251 -> V_254 -> V_236 = V_236 ;
break;
case V_256 :
if ( V_251 -> V_254 -> V_236 )
F_153 ( V_238 , V_251 -> V_254 ) ;
break;
default:
V_120 = - V_257 ;
break;
...
static struct V_236 * F_159 ( struct V_248 * V_248 ,
struct V_239 * V_240 )
{
struct V_237 * V_258 ;
struct V_236 * V_236 ;
...
if ( ! V_258 )
return NULL ;
V_236 = F_149 ( V_258 , V_240 ) ;
F_161 ( V_248 ) ;
return V_236 ;
}
static void F_162 ( struct V_248 * V_248 ,
struct V_239 * V_240 )
{
struct V_237 * V_258 ;
V_258 = F_160 ( V_248 ) ;
...
static int F_163 ( struct V_248 * V_248 )
{
struct V_250 * V_251 = F_156 ( V_248 , V_252 ) ;
struct V_236 * V_236 ;
F_164 ( & V_251 -> V_259 ) ;
V_251 -> V_254 = F_165 ( & V_260 , 0 ) ;
if ( F_50 ( V_251 -> V_254 ) )
return F_51 ( V_251 -> V_254 ) ;
V_236 = F_159 ( V_248 , V_251 -> V_254 ) ;
if ( F_50 ( V_236 ) ) {
F_166 ( V_251 -> V_254 ) ;
return F_51 ( V_236 ) ;
}
...
static void F_167 ( struct V_248 * V_248 )
{
struct V_250 * V_251 = F_156 ( V_248 , V_252 ) ;
F_162 ( V_248 , V_251 -> V_254 ) ;
F_166 ( V_251 -> V_254 ) ;
V_251 -> V_254 = NULL ;
}
