...
static int V_171 = 1 ;
struct V_1 * V_2 ;
unsigned long V_172 , V_173 , V_174 , V_175 ;
const T_2 * V_176 ;
const T_10 * V_177 ;
T_2 V_178 ;
void * V_179 ;
...
if ( F_102 ( V_168 , L_45 ) )
V_2 -> V_184 = V_185 ;
else if ( F_102 ( V_168 , L_46 ) )
V_2 -> V_184 = V_186 ;
else
V_2 -> V_184 = V_187 ;
F_103 ( V_2 -> V_15 , V_168 , V_171 ) ;
V_171 = 0 ;
V_2 -> V_188 = F_104 ( V_168 , 0 ) ;
if ( V_2 -> V_188 == NULL )
F_11 ( L_47 ) ;
V_177 = F_51 ( V_168 , L_48 , NULL ) ;
if ( ! V_177 )
V_2 -> V_4 . V_6 = 1 ;
else
V_2 -> V_4 . V_6 = * V_177 ;
V_2 -> V_4 . V_189 = F_105 ( & V_15 -> V_190 [ 0 ] ) ;
...
V_2 -> V_4 . V_146 = 0 ;
V_172 = F_106 ( V_2 -> V_4 . V_6 / 8 , sizeof( unsigned long ) ) ;
V_173 = V_172 ;
V_172 += V_2 -> V_4 . V_6 * sizeof( V_2 -> V_4 . V_154 [ 0 ] ) ;
V_174 = V_172 ;
V_172 += V_2 -> V_4 . V_6 * sizeof( V_2 -> V_4 . V_148 [ 0 ] ) ;
V_175 = V_172 ;
V_172 += V_2 -> V_4 . V_6 * sizeof( struct V_11 ) ;
V_179 = F_99 ( V_172 ) ;
memset ( V_179 , 0 , V_172 ) ;
V_2 -> V_4 . V_5 = V_179 ;
V_2 -> V_4 . V_154 = V_179 + V_173 ;
V_2 -> V_4 . V_148 = V_179 + V_174 ;
V_2 -> V_4 . V_8 = V_179 + V_175 ;
F_107 ( 0 , V_2 -> V_4 . V_5 ) ;
F_108 ( & V_2 -> V_4 . V_58 ) ;
F_108 ( & V_2 -> V_4 . V_76 ) ;
...
void T_11 F_110 ( struct V_167 * V_168 )
{
F_97 ( V_168 , 0 , V_54 ) ;
}
...
const T_2 * V_176 ;
T_2 V_169 ;
F_60 ( L_51 , V_168 -> V_180 ) ;
V_176 = F_51 ( V_168 , L_52 , NULL ) ;
if ( ! V_176 ) {
F_11 ( L_53 ) ;
return;
}
