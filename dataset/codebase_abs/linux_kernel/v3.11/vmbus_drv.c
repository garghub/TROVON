...
int F_51 ( struct V_66 * V_66 , struct V_117 * V_118 , const char * V_119 )
{
int V_54 ;
F_52 ( L_33 , V_66 -> V_57 ) ;
V_54 = F_1 () ;
...
int F_57 ( struct V_3 * V_123 )
{
int V_54 = 0 ;
static T_4 V_125 = F_58 ( 0 ) ;
F_59 ( & V_123 -> V_4 , L_36 ,
F_60 ( & V_125 ) ) ;
...
void F_63 ( struct V_3 * V_128 )
{
F_62 ( L_39 ,
F_17 ( & V_128 -> V_4 ) ) ;
F_64 ( & V_128 -> V_4 ) ;
}
static T_5 F_65 ( struct V_129 * V_130 , void * V_94 )
{
if ( V_130 -> type == V_131 ) {
struct V_132 * V_133 ;
...
static int F_66 ( struct V_136 * V_4 )
{
T_5 V_137 ;
V_1 = V_4 ;
V_137 = F_67 ( V_4 -> V_138 , V_139 ,
F_65 , & V_94 ) ;
if ( F_68 ( V_137 ) ) {
F_69 ( & V_140 ) ;
return - V_2 ;
