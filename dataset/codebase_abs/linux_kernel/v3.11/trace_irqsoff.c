...
static int F_65 ( int V_59 , int V_21 )
{
int V_27 ;
...
static int F_72 ( struct V_64 * V_64 , T_1 V_65 , int V_21 )
{
if ( V_65 & V_62 )
F_71 ( V_21 ) ;
return F_73 ( V_64 , V_65 , V_21 ) ;
}
