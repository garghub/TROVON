...
V_117 |= F_28 ( & V_26 -> V_139 , V_26 -> V_103 , V_26 -> V_104 ) ;
V_105 = V_26 -> V_104 / F_32 ( V_117 ) ;
F_31 ( & V_2 -> V_16 , L_20 ,
...
static int F_35 ( struct V_21 * V_22 , unsigned int V_144 ,
enum V_111 * V_97 )
{
if ( V_144 >= F_36 ( V_145 ) )
return - V_42 ;
...
static int F_37 ( struct V_21 * V_22 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_12 ( V_22 ) ;
struct V_19 * V_26 = F_7 ( V_2 ) ;
...
V_149 -> V_152 = V_153 ;
V_149 -> V_102 . V_92 = F_32 ( F_28 ( & V_26 -> V_139 ,
...
static int F_38 ( struct V_21 * V_22 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_12 ( V_22 ) ;
struct V_19 * V_26 = F_7 ( V_2 ) ;
struct V_148 * V_149 = & V_147 -> V_150 . V_151 ;
...
struct V_1 * V_2 = F_12 ( V_22 ) ;
struct V_67 * V_68 = F_19 ( V_2 ) ;
unsigned long V_10 = F_45 ( V_68 , V_171 ) ;
int V_5 ;
if ( V_10 & V_173 )
V_5 = F_6 ( V_2 , V_181 , V_182 , 0 ) ;
else
V_5 = F_6 ( V_2 , V_181 , 0 , V_182 ) ;
if ( V_5 )
return V_5 ;
if ( V_10 & V_176 )
V_5 = F_6 ( V_2 , V_183 , V_184 , 0 ) ;
else
V_5 = F_6 ( V_2 , V_183 , 0 , V_184 ) ;
if ( V_5 )
return V_5 ;
if ( V_10 & V_177 )
V_5 = F_6 ( V_2 , V_181 , V_185 , 0 ) ;
else
V_5 = F_6 ( V_2 , V_181 , 0 , V_185 ) ;
return V_5 ;
}
...
V_26 = F_48 ( & V_2 -> V_16 , sizeof( * V_26 ) , V_188 ) ;
if ( ! V_26 ) {
F_3 ( & V_2 -> V_16 ,
L_28 ) ;
return - V_189 ;
}
F_49 ( & V_26 -> V_20 , V_2 , & V_190 ) ;
F_50 ( & V_26 -> V_28 , 13 ) ;
F_51 ( & V_26 -> V_28 , & V_191 ,
V_59 , 0 , 1 , 1 , 0 ) ;
F_51 ( & V_26 -> V_28 , & V_191 ,
V_61 , 0 , 1 , 1 , 0 ) ;
V_26 -> V_192 = F_51 ( & V_26 -> V_28 , & V_191 ,
V_31 , 0 , 1 , 1 , 1 ) ;
V_26 -> V_33 = F_51 ( & V_26 -> V_28 , & V_191 ,
V_193 , 0 , 0x3f , 1 , V_194 ) ;
V_26 -> V_195 = F_51 ( & V_26 -> V_28 , & V_191 ,
V_34 , 0 , 1 , 1 , 1 ) ;
V_26 -> V_37 = F_51 ( & V_26 -> V_28 , & V_191 ,
V_196 , 0 , 0xff , 1 , V_197 ) ;
V_26 -> V_38 = F_51 ( & V_26 -> V_28 , & V_191 ,
V_198 , 0 , 0xff , 1 , V_199 ) ;
F_51 ( & V_26 -> V_28 , & V_191 ,
V_46 , 0 , 0xf , 1 , 0x8 ) ;
F_51 ( & V_26 -> V_28 , & V_191 ,
V_49 , 0 , V_51 , 1 , V_200 ) ;
F_51 ( & V_26 -> V_28 , & V_191 ,
V_52 , 0 , 0xff , 1 , 0x80 ) ;
V_26 -> V_201 = F_52 ( & V_26 -> V_28 ,
& V_191 , V_39 ,
V_56 , 0 , V_54 ) ;
V_26 -> V_41 = F_51 ( & V_26 -> V_28 , & V_191 ,
V_202 , 0 , 0xff , 1 , V_203 ) ;
F_51 ( & V_26 -> V_28 , & V_191 ,
V_57 , 0 , 0xff , 1 , 0x12 ) ;
V_26 -> V_20 . V_204 = & V_26 -> V_28 ;
if ( V_26 -> V_28 . error )
return V_26 -> V_28 . error ;
F_53 ( 2 , & V_26 -> V_192 , 0 , true ) ;
F_53 ( 3 , & V_26 -> V_195 , 0 , true ) ;
F_53 ( 2 , & V_26 -> V_201 ,
V_56 , true ) ;
