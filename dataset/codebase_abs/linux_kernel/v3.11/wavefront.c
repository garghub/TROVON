static int
F_1 ( int V_1 , T_1 * V_2 , struct V_3 * V_4 ,
...
static struct V_34 * F_12 ( struct V_35 * V_4 ,
int V_36 ,
T_1 * V_2 )
{
struct V_34 * V_37 ;
...
static struct V_34 * F_16 ( struct V_35 * V_4 ,
int V_36 ,
T_1 * V_2 ,
unsigned long V_46 )
{
...
static struct V_51 * F_18 ( struct V_35 * V_4 ,
int V_52 ,
T_1 * V_2 ,
unsigned long V_46 ,
T_3 V_14 )
...
static int F_40 ( struct V_94 * V_8 ,
unsigned int V_1 )
{
if ( ! V_95 [ V_1 ] )
return 0 ;
...
static int F_42 ( struct V_94 * V_8 ,
unsigned int V_1 )
{
struct V_35 * V_4 ;
int V_9 ;
...
static int F_46 ( struct V_94 * V_97 ,
unsigned int V_1 )
{
F_44 ( F_47 ( V_97 ) ) ;
return 0 ;
}
static int F_48 ( struct V_3 * V_98 ,
...
static void F_50 ( struct V_3 * V_98 )
{
F_44 ( F_51 ( V_98 ) ) ;
F_49 ( V_98 , NULL ) ;
}
