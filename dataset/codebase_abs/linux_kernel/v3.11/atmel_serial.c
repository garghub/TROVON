...
static int F_117 ( struct V_1 * V_5 ,
struct V_197 * V_198 )
{
int V_41 ;
...
static void F_124 ( struct V_2 * V_4 , int V_69 )
{
while ( ! ( F_15 ( V_4 ) & V_23 ) )
F_109 () ;
F_39 ( V_4 , V_69 ) ;
}
static void F_125 ( struct V_237 * V_238 , const char * V_239 , T_1 V_107 )
{
...
static void T_4 F_127 ( struct V_2 * V_4 , int * V_154 ,
int * V_84 , int * V_242 )
{
unsigned int V_243 , V_153 ;
V_153 = F_128 ( V_4 ) & V_244 ;
if ( ! V_153 )
return;
V_243 = F_8 ( V_4 ) & V_156 ;
if ( V_243 == V_169 )
...
static int T_4 F_129 ( struct V_237 * V_238 , char * V_245 )
{
int V_41 ;
struct V_2 * V_4 = & V_240 [ V_238 -> V_241 ] . V_3 ;
int V_154 = 115200 ;
...
V_41 = F_89 ( V_240 [ V_238 -> V_241 ] . V_146 ) ;
if ( V_41 )
return V_41 ;
F_7 ( V_4 , - 1 ) ;
F_20 ( V_4 , V_53 | V_141 ) ;
F_20 ( V_4 , V_142 | V_54 ) ;
if ( V_245 )
F_130 ( V_245 , & V_154 , & V_84 , & V_242 , & V_246 ) ;
else
F_127 ( V_4 , & V_154 , & V_84 , & V_242 ) ;
return F_131 ( V_4 , V_238 , V_154 , V_84 , V_242 , V_246 ) ;
}
...
V_4 -> V_147 = 0 ;
V_4 -> V_3 . line = V_249 ;
F_133 ( V_251 , V_249 , NULL ) ;
V_41 = F_117 ( V_4 , V_248 ) ;
if ( V_41 )
return V_41 ;
F_134 ( & V_252 ) ;
}
...
static inline bool F_136 ( struct V_2 * V_4 )
{
...
T_5 V_91 )
{
struct V_2 * V_4 = F_141 ( V_198 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
if ( F_136 ( V_4 ) && V_255 ) {
while ( ! ( F_15 ( V_4 ) & V_18 ) )
F_109 () ;
}
V_5 -> V_256 = F_142 ( & V_198 -> V_17 ) ;
if ( F_137 () )
F_143 ( & V_198 -> V_17 , 0 ) ;
F_144 ( & V_257 , V_4 ) ;
return 0 ;
}
static int F_145 ( struct V_197 * V_198 )
{
struct V_2 * V_4 = F_141 ( V_198 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
F_146 ( & V_257 , V_4 ) ;
F_143 ( & V_198 -> V_17 , V_5 -> V_256 ) ;
return 0 ;
}
...
F_148 ( V_77 & ( V_77 - 1 ) ) ;
if ( V_224 )
V_41 = F_149 ( V_224 , L_13 ) ;
else
if ( V_228 )
V_41 = V_228 -> V_250 ;
if ( V_41 < 0 )
V_41 = F_150 ( V_259 , V_260 ) ;
if ( V_41 >= V_260 ) {
V_41 = - V_247 ;
goto V_261;
}
...
V_4 -> V_147 = 0 ;
V_4 -> V_3 . line = V_41 ;
V_41 = F_117 ( V_4 , V_198 ) ;
if ( V_41 )
goto V_261;
V_258 = F_152 ( & V_198 -> V_17 ) ;
if ( F_120 ( V_258 ) ) {
V_41 = F_121 ( V_258 ) ;
goto V_261;
}
