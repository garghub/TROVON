...
void F_41 ( struct V_26 * V_27 , struct V_6 * V_7 , bool V_71 )
{
F_33 ( ! F_42 () && ! F_43 () ) ;
if ( F_34 ( ( V_7 -> V_34 & V_62 ) && ! V_71 ) ) {
F_44 ( V_7 ) ;
F_45 ( V_27 , V_7 ) ;
} else {
V_27 -> V_72 = ( unsigned long ) V_7 | V_73 ;
}
}
...
{
if ( V_7 -> V_29 -> V_75 )
V_7 -> V_29 -> V_75 ( V_7 , V_31 , V_74 ) ;
if ( V_31 != V_7 -> V_31 )
return;
if ( ! V_74 ) {
V_7 -> V_44 = V_7 -> V_45 = F_14 ;
} else {
V_7 -> V_31 = F_47 ( V_7 -> V_31 ) -> V_76 ;
F_19 ( V_7 -> V_31 ) ;
F_28 ( V_31 ) ;
}
}
static int F_48 ( struct V_77 * V_78 , unsigned long V_79 ,
void * V_80 )
{
struct V_30 * V_31 = F_49 ( V_80 ) ;
