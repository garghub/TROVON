...
int V_19 = 0 ;
int V_20 ;
for ( V_20 = 0 ; V_20 < F_8 ( V_83 ) ; V_20 += 2 ) {
V_19 = F_4 ( V_3 , V_83 [ V_20 ] ,
V_83 [ V_20 + 1 ] ) ;
if ( V_19 ) {
F_10 ( V_3 , L_10 ) ;
return V_19 ;
...
const struct V_84 * V_74 )
{
struct V_1 * V_13 ;
int V_19 ;
if ( ! F_19 ( V_11 -> V_85 , V_86 ) )
return - V_87 ;
F_20 ( V_11 , L_13 ,
V_11 -> V_88 << 1 , V_11 -> V_85 -> V_89 ) ;
V_13 = F_21 ( & V_11 -> V_90 , sizeof( struct V_1 ) ,
V_91 ) ;
if ( V_13 == NULL )
return - V_92 ;
V_13 -> V_42 = V_11 -> V_90 . V_93 ;
V_13 -> V_41 = 0x80 ;
V_13 -> V_30 = 0x00 ;
V_13 -> V_59 = 0x20 ;
V_13 -> V_69 = 0x00 ;
