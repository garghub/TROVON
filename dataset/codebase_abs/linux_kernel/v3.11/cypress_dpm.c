...
struct V_148 V_149 ;
int V_152 ;
V_20 = F_162 ( sizeof( struct V_19 ) , V_468 ) ;
if ( V_20 == NULL )
return - V_469 ;
V_2 -> V_407 . V_416 . V_470 = V_20 ;
V_5 = & V_20 -> V_471 ;
F_120 ( V_2 ) ;
V_20 -> V_472 . V_473 = false ;
V_5 -> V_356 = 0 ;
V_20 -> V_359 = 0 ;
V_5 -> V_358 = 0 ;
V_5 -> V_396 = 0 ;
...
if ( V_152 )
return V_152 ;
if ( V_2 -> V_407 . V_416 . V_474 == 0 )
V_2 -> V_407 . V_416 . V_474 = V_475 ;
if ( V_2 -> V_407 . V_416 . V_476 == 0 )
V_2 -> V_407 . V_416 . V_476 = V_477 ;
V_152 = F_42 ( V_2 , V_478 ,
0 , false , & V_149 ) ;
if ( V_152 )
...
{
int V_120 ;
for ( V_120 = 0 ; V_120 < V_2 -> V_407 . V_416 . V_504 ; V_120 ++ ) {
F_168 ( V_2 -> V_407 . V_416 . V_505 [ V_120 ] . V_506 ) ;
}
F_168 ( V_2 -> V_407 . V_416 . V_505 ) ;
F_168 ( V_2 -> V_407 . V_416 . V_470 ) ;
}
bool F_169 ( struct V_1 * V_2 )
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
T_1 V_507 = F_170 ( V_2 ) ;
T_1 V_508 = V_5 -> V_127 ? 450 : 300 ;
if ( V_507 < V_508 )
return true ;
else
return false ;
