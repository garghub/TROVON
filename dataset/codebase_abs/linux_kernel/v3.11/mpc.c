...
{
struct V_10 * V_11 = F_80 ( V_185 ) ;
struct V_1 * V_3 ;
struct V_143 * V_144 ;
if ( ! F_81 ( F_82 ( V_11 ) , & V_32 ) )
return V_186 ;
...
static void F_85 ( struct V_162 * V_197 ,
struct V_1 * V_203 ,
T_6 * V_16 )
{
T_1 V_13 = V_197 -> V_179 . V_198 . V_119 ;
...
F_9 ( V_203 -> V_66 ) ;
V_203 -> V_61 = 0 ;
V_203 -> V_66 = F_93 ( V_197 -> V_165 , V_64 , V_17 ) ;
if ( V_203 -> V_66 == NULL ) {
F_7 ( L_91 ) ;
return;
}
...
static int F_95 ( struct V_243 * V_130 , unsigned int V_244 ,
unsigned long V_108 )
{
int V_145 = 0 ;
struct V_7 * V_8 = F_96 ( V_130 ) ;
