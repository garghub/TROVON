...
static int F_32 ( struct V_6 * V_9 , bool V_41 )
{
if ( F_28 ( V_9 ) )
return F_31 ( & V_9 -> V_9 , V_41 ) ;
F_30 ( V_9 -> V_40 , V_41 ) ;
return 0 ;
}
...
static int F_35 ( struct V_6 * V_9 , bool V_41 )
{
if ( V_9 -> V_45 && ! V_9 -> V_46 )
return 0 ;
if ( ! F_34 ( & V_9 -> V_9 , V_41 ) )
return 0 ;
F_33 ( V_9 -> V_40 , V_41 ) ;
return 0 ;
}
...
static int F_43 ( struct V_48 * V_9 , T_1 * V_1 )
{
...
V_49 = V_6 -> V_51 == V_52
|| V_6 -> V_51 == V_53 ;
V_50 = ( F_45 ( V_6 -> V_54 ) << 16 ) | F_46 ( V_6 -> V_54 ) ;
* V_1 = F_47 ( F_37 ( V_9 -> V_42 ) , V_50 , V_49 ) ;
if ( ! * V_1 )
return - V_36 ;
return 0 ;
}
static void F_48 ( struct V_48 * V_9 )
{
struct V_6 * V_6 = F_44 ( V_9 ) ;
T_1 V_1 = F_37 ( V_9 ) ;
struct V_13 * V_55 ;
...
static void F_52 ( struct V_48 * V_9 )
{
T_1 V_1 = F_37 ( V_9 ) ;
struct V_13 * V_55 ;
if ( ! F_49 ( V_1 , & V_55 ) && V_55 -> V_56 . V_57 . V_58 ) {
...
static bool F_53 ( struct V_48 * V_9 )
{
return V_9 -> V_40 == & V_60 ;
}
