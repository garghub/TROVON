...
V_14 -> V_115 . V_24 ) ;
V_14 -> V_116 = F_32 ( L_37 , 0 , V_14 -> V_114 ) ;
if ( V_14 -> V_116 == NULL ) {
F_26 ( L_38 ) ;
return - V_117 ;
}
...
F_26 ( L_41 , V_14 -> V_105 ) ;
return - V_184 ;
}
if ( ! F_46 ( V_14 -> V_124 , V_185 , L_42 ) ) {
F_26 ( L_43 ,
V_14 -> V_105 ) ;
return - V_184 ;
}
...
snprintf ( V_14 -> V_115 . V_24 , sizeof( V_14 -> V_115 . V_24 ) , L_52 ,
V_14 -> V_105 ) ;
F_18 ( L_53 , V_14 -> V_105 ) ;
F_30 ( V_14 ) ;
if ( V_14 -> V_42 . V_104 == - 1 ) {
V_209 = - V_215 ;
goto V_216;
