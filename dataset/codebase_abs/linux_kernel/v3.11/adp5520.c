...
V_9 = F_29 ( & V_2 -> V_6 , sizeof( * V_9 ) , V_44 ) ;
if ( ! V_9 )
return - V_45 ;
F_30 ( V_2 , V_9 ) ;
V_9 -> V_2 = V_2 ;
...
V_9 -> V_35 , V_37 -> V_51 , sizeof( * V_37 -> V_51 ) ) ;
if ( F_35 ( V_40 ) ) {
V_5 = F_36 ( V_40 ) ;
goto V_52;
}
...
static int F_39 ( struct V_12 * V_6 )
{
struct V_1 * V_2 = F_11 ( V_6 ) ;
struct V_8 * V_9 = F_14 ( & V_2 -> V_6 ) ;
F_12 ( V_9 -> V_6 , V_25 , & V_9 -> V_56 ) ;
V_9 -> V_56 &= V_57 | V_58 | V_49 ;
F_10 ( V_9 -> V_6 , V_25 , 0 ) ;
return 0 ;
}
