...
while ( ( V_74 = F_115 ( & V_6 -> V_31 ) ) )
F_105 ( V_6 , V_74 ) ;
}
int F_116 ( struct V_5 * V_6 , struct V_128 * V_129 ,
struct V_163 * V_164 )
{
struct V_70 * V_151 ;
T_3 V_153 ;
...
T_5 F_119 ( unsigned char V_45 [ V_273 ] ,
...
static inline struct V_277 * F_120 ( struct V_278 * V_279 )
{
...
V_136 = F_122 ( V_136 , V_282 + sizeof( struct V_76 ) ) ;
V_74 = F_46 ( V_136 ) ;
if ( ! V_74 )
return;
...
V_287 |= V_298 ;
V_287 <<= ( V_299 * 4 ) % 32 ;
V_286 -> V_300 . V_301 [ V_299 * 4 / 32 ] = F_123 ( V_287 ) ;
...
static void F_124 ( struct V_128 * V_129 ,
struct V_278 * V_279 ,
enum V_302 V_303 )
{
struct V_5 * V_6 = V_129 -> V_304 . V_53 ;
struct V_277 * V_305 = F_120 ( V_279 ) ;
F_4 ( V_6 , L_57 ,
...
F_126 (rdata, &lport->disc.rports, peers)
V_129 -> V_313 . V_314 ( V_279 ) ;
...
struct V_278 * V_32 )
{
struct V_277 * V_305 = F_120 ( V_32 ) ;
if ( V_305 -> V_10 & V_335 ) {
F_121 ( V_6 , V_326 , V_250 , 0 ) ;
return;
}
switch ( V_6 -> V_2 ) {
case V_324 :
...
static void F_148 ( struct V_128 * V_129 , struct V_163 * V_164 )
{
struct V_350 V_351 ;
V_351 . V_352 = V_353 ;
V_351 . V_354 = V_355 ;
...
static void F_150 ( void (* F_151)( struct V_128 * ,
enum V_357 ) ,
struct V_128 * V_129 )
{
...
struct V_278 * V_279 ;
struct V_277 * V_305 ;
void (* F_151)( struct V_128 * , enum V_357 );
F_18 ( & V_304 -> V_315 ) ;
F_151 = V_304 -> V_359 ? V_304 -> V_316 : NULL ;
V_304 -> V_359 = 0 ;
F_126 (rdata, &disc->rports, peers) {
V_305 = F_120 ( V_279 ) ;
if ( V_305 -> time )
V_129 -> V_313 . V_344 ( V_279 ) ;
}
...
void F_155 ( struct V_128 * V_129 , struct V_5 * V_6 ,
enum V_1 V_363 )
{
void * V_53 ;
...
V_129 -> V_154 = 1 ;
V_129 -> V_313 . V_367 = F_148 ;
V_129 -> V_313 . V_368 = F_150 ;
...
F_162 ( V_129 ) ;
F_163 ( V_129 ) ;
F_155 ( V_129 , V_6 , V_6 -> V_13 ) ;
return 0 ;
}
void F_164 ( struct V_35 * V_37 )
{
struct V_33 * V_34 = F_165 ( V_37 ) ;
struct V_5 * V_6 = F_166 ( V_34 ) ;
struct V_8 * V_9 ;
F_18 ( & V_6 -> V_21 ) ;
F_18 ( & V_34 -> V_41 ) ;
V_9 = F_167 ( V_37 ) ;
...
void F_168 ( struct V_33 * V_34 )
{
struct V_5 * V_373 = F_166 ( V_34 ) ;
