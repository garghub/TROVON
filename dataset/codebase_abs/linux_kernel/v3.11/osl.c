...
void T_3 F_147 ( int V_185 , const struct V_194 * V_195 )
{
...
V_150 = F_149 ( V_180 ) ;
if ( F_150 ( V_150 ) )
F_11 (KERN_INFO PREFIX L_45 , str) ;
} else {
V_150 = F_151 ( V_180 ) ;
if ( F_150 ( V_150 ) )
...
if ( V_180 == NULL || * V_180 == '\0' )
return 0 ;
if ( ! strcmp ( L_48 , V_180 ) )
V_197 = V_198 ;
else if ( ! strcmp ( L_49 , V_180 ) )
V_197 = V_199 ;
else if ( ! strcmp ( L_50 , V_180 ) )
V_197 = V_200 ;
return 1 ;
}
int F_155 ( const struct V_201 * V_202 )
{
T_20 V_9 ;
T_7 V_5 ;
T_12 V_203 = 0 ;
...
if ( V_197 != V_200 )
V_203 = 1 ;
V_204 = F_157 ( V_9 , V_202 -> V_208 , V_5 , V_203 ) ;
if ( V_204 ) {
if ( V_197 != V_200 ) {
if ( V_197 == V_199 )
F_11 ( V_209 L_51
...
int F_158 ( T_21 V_208 , T_21 V_212 ,
const char * V_69 )
{
struct V_201 V_202 = {
. V_208 = V_208 ,
...
void F_160 ( T_22 V_163 )
{
F_161 ( V_163 ) ;
}
T_23 F_162 ( T_22 V_213 )
{
T_23 V_205 ;
F_163 ( V_213 , V_205 ) ;
return V_205 ;
}
void F_164 ( T_22 V_213 , T_23 V_205 )
{
F_165 ( V_213 , V_205 ) ;
}
T_11
F_166 ( char * V_69 , V_126 V_41 , V_126 V_214 , T_24 * * V_215 )
{
* V_215 = F_167 ( V_69 , V_41 , 0 , 0 , NULL ) ;
if ( * V_215 == NULL )
return V_139 ;
else
return V_65 ;
...
T_11 F_170 ( T_24 * V_215 )
{
F_171 ( V_215 ) ;
return ( V_65 ) ;
}
T_11 F_172 ( T_24 * V_215 , void * V_216 )
{
F_173 ( V_215 , V_216 ) ;
return ( V_65 ) ;
}
static int T_3 F_174 ( char * V_217 )
{
F_11 (KERN_NOTICE PREFIX L_57 ) ;
V_218 = TRUE ;
return 1 ;
}
T_11 T_3 F_175 ( void )
...
T_11 T_3 F_176 ( void )
{
V_160 = F_177 ( L_58 , 0 , 1 ) ;
V_159 = F_177 ( L_59 , 0 , 1 ) ;
V_157 = F_177 ( L_60 , 0 , 1 ) ;
F_132 ( ! V_160 ) ;
F_132 ( ! V_159 ) ;
F_132 ( ! V_157 ) ;
F_178 ( F_1 ) ;
...
T_11 F_181 ( T_12 V_219 , T_1 V_220 ,
T_1 V_221 )
{
int V_222 = 0 ;
if ( V_223 )
...
void F_182 ( int (* F_183)( T_12 V_219 ,
T_1 V_225 , T_1 V_226 ) )
{
V_223 = F_183 ;
}
void F_184 ( T_19 V_163 , T_1 type , void * V_112 ,
void (* F_183)( struct V_144 * V_145 ) )
{
struct V_227 * V_228 ;
int V_153 ;
V_228 = F_185 ( sizeof( * V_228 ) , V_56 ) ;
if ( ! V_228 )
return;
V_228 -> V_163 = V_163 ;
V_228 -> type = type ;
V_228 -> V_112 = V_112 ;
F_123 ( & V_228 -> V_145 , F_183 ) ;
V_153 = F_186 ( V_157 , & V_228 -> V_145 ) ;
if ( ! V_153 )
F_38 ( V_228 ) ;
}
