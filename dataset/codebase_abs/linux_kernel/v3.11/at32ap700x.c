...
V_148 -> V_156 . V_158 = ( F_73 ( 0 )
| F_74 ( 1 ) ) ;
V_148 -> V_156 . V_159 &= ~ ( V_160
| V_161 ) ;
V_115 -> V_162 = V_148 ;
if ( F_75 ( V_90 , V_115 ,
sizeof( struct V_146 ) ) )
...
V_149 |= 1 << 11 ;
V_149 |= 1 << 12 ;
if ( F_76 ( V_115 -> V_151 [ 0 ] . V_164 ) )
F_66 ( V_115 -> V_151 [ 0 ] . V_164 , 0 ) ;
if ( F_76 ( V_115 -> V_151 [ 0 ] . V_165 ) )
...
if ( F_76 ( V_115 -> V_151 [ 1 ] . V_164 ) )
F_66 ( V_115 -> V_151 [ 1 ] . V_164 , 0 ) ;
if ( F_76 ( V_115 -> V_151 [ 1 ] . V_165 ) )
...
struct V_88 * T_2
F_78 ( unsigned int V_89 , struct V_167 * V_115 ,
...
struct V_88 * T_2
F_84 ( unsigned int V_89 , unsigned int V_45 )
{
struct V_88 * V_90 ;
T_1 V_91 = 0 ;
switch ( V_89 ) {
...
struct V_88 * T_2
F_85 ( unsigned int V_89 , struct V_202 * V_115 )
{
struct {
struct V_202 V_107 ;
...
if ( F_75 ( V_90 , V_115 , sizeof( V_205 ) ) )
goto V_191;
if ( F_76 ( V_115 -> V_207 ) )
F_66 ( V_115 -> V_207 , 0 ) ;
...
static int T_2 F_86 ( struct V_88 * V_90 ,
...
struct V_88 * T_2
F_87 ( unsigned int V_89 , unsigned int V_214 ,
struct V_224 * V_115 )
{
struct V_88 * V_90 ;
V_90 = F_46 ( L_11 , V_89 ) ;
...
sizeof( struct V_224 ) ) )
goto V_153;
if ( F_86 ( V_90 , V_115 -> V_213 , V_214 ) )
goto V_153;
F_50 ( V_90 ) ;
return V_90 ;
V_153:
...
struct V_88 * T_2
F_88 ( unsigned int V_89 , unsigned int V_214 ,
struct V_225 * V_115 )
{
struct V_88 * V_90 ;
V_90 = F_46 ( L_12 , V_89 ) ;
...
struct V_88 * T_2
F_89 ( unsigned int V_89 , struct V_228 * V_115 )
{
struct V_88 * V_90 ;
if ( V_89 != 0 || ! V_115 )
return NULL ;
...
struct V_88 * T_2
F_90 ( unsigned int V_89 , struct V_234 * V_115 ,
unsigned int V_45 )
{
struct V_88 * V_90 ;
struct V_235 * V_236 ;
...
if ( ! V_115 ) {
V_115 = & V_238 ;
memset ( V_115 , 0 , sizeof( struct V_234 ) ) ;
V_115 -> V_226 = - V_241 ;
}
V_236 = & V_115 -> V_236 ;
V_237 = & V_115 -> V_237 ;
if ( V_45 & V_242 ) {
V_236 -> V_157 = & V_80 . V_67 ;
V_236 -> V_158 = F_73 ( 3 ) ;
V_236 -> V_159 &= ~ ( V_160 | V_161 ) ;
V_236 -> V_243 = 0 ;
V_236 -> V_244 = 1 ;
}
if ( V_45 & V_245 ) {
...
struct V_88 * T_2
F_91 ( unsigned int V_89 , struct V_247 * V_115 )
{
struct V_88 * V_90 ;
struct V_235 * V_248 ;
T_1 V_91 ;
...
goto V_240;
V_248 = & V_115 -> V_248 ;
V_248 -> V_157 = & V_80 . V_67 ;
V_248 -> V_158 = F_74 ( 2 ) ;
V_248 -> V_159 &= ~ ( V_160 | V_161 ) ;
V_248 -> V_243 = 0 ;
V_248 -> V_244 = 1 ;
if ( F_75 ( V_90 , V_115 ,
sizeof( struct V_247 ) ) )
...
void T_2 F_92 ( void )
{
T_1 V_252 = 0 , V_253 = 0 , V_254 = 0 , V_255 = 0 ;
int V_256 ;
if ( F_9 ( V_257 ) & F_7 ( V_71 ) ) {
V_44 = & V_70 ;
V_258 . V_9 = & V_70 ;
} else {
V_44 = & V_42 ;
...
#endif
F_39 ( & V_251 ) ;
for ( V_256 = 0 ; V_256 < F_48 ( V_266 ) ; V_256 ++ ) {
struct V_1 * V_1 = V_266 [ V_256 ] ;
F_94 ( V_1 ) ;
if ( V_1 -> V_39 == 0 )
continue;
if ( V_1 -> V_135 == & F_20 )
...
if ( ! V_268 )
goto V_153;
if ( F_98 ( V_268 , 0x24000000 , 0x8000 , - 1 ) )
goto V_269;
V_270 = V_268 ;
return 0 ;
V_269:
