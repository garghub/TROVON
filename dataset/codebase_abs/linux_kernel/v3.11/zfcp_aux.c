...
V_10 -> V_62 . V_87 = F_45 ;
F_66 ( & V_7 -> V_17 , V_10 ) ;
if ( F_67 ( & V_7 -> V_17 . V_88 ,
& V_89 ) )
goto V_74;
V_10 -> V_90 . V_91 = V_92 ;
V_10 -> V_7 -> V_17 . V_90 = & V_10 -> V_90 ;
V_10 -> V_56 = V_48 ;
if ( ! F_68 ( V_10 ) )
return V_10 ;
V_74:
...
F_71 ( V_10 -> V_93 ) ;
F_72 ( V_10 ) ;
F_73 ( & V_8 -> V_17 . V_88 , & V_89 ) ;
F_74 ( V_10 ) ;
F_75 ( V_10 ) ;
F_76 ( V_10 -> V_55 ) ;
F_12 ( V_10 ) ;
}
void F_77 ( struct V_94 * V_68 )
{
struct V_9 * V_10 = F_44 ( V_68 , struct V_9 ,
V_68 ) ;
struct V_7 * V_8 = V_10 -> V_7 ;
F_66 ( & V_10 -> V_7 -> V_17 , NULL ) ;
F_78 ( V_10 ) ;
F_36 ( V_10 ) ;
F_17 ( V_10 -> V_75 ) ;
F_17 ( V_10 -> V_95 ) ;
...
static void F_79 ( struct V_97 * V_17 )
{
struct V_11 * V_12 = F_44 ( V_17 , struct V_11 , V_17 ) ;
F_12 ( V_12 -> V_10 ) ;
F_17 ( V_12 ) ;
}
struct V_11 * F_80 ( struct V_9 * V_10 , T_2 V_5 ,
T_4 V_98 , T_4 V_99 )
{
struct V_11 * V_12 ;
int V_25 = - V_26 ;
...
F_62 ( & V_12 -> V_102 ) ;
F_82 ( & V_12 -> V_103 , 0 ) ;
F_56 ( & V_12 -> V_104 , V_105 ) ;
F_56 ( & V_12 -> V_106 , V_107 ) ;
F_56 ( & V_12 -> V_16 , V_108 ) ;
V_12 -> V_10 = V_10 ;
V_12 -> V_99 = V_99 ;
V_12 -> V_5 = V_5 ;
V_12 -> V_109 = V_110 ;
V_12 -> V_17 . V_111 = & V_10 -> V_7 -> V_17 ;
V_12 -> V_17 . V_112 = V_113 ;
V_12 -> V_17 . V_114 = F_79 ;
if ( F_83 ( & V_12 -> V_17 , L_10 , ( unsigned long long ) V_5 ) ) {
F_17 ( V_12 ) ;
goto V_24;
}
V_25 = - V_115 ;
...
F_85 ( & V_10 -> V_40 ) ;
F_86 ( & V_12 -> V_78 , & V_10 -> V_76 ) ;
F_87 ( & V_10 -> V_40 ) ;
F_88 ( V_98 | V_116 , & V_12 -> V_98 ) ;
return V_12 ;
V_24:
F_12 ( V_10 ) ;
return F_53 ( V_25 ) ;
}
void F_89 ( struct V_117 * V_118 , int V_119 )
{
int V_120 ;
for ( V_120 = 0 ; V_120 < V_119 ; V_120 ++ , V_118 ++ )
if ( V_118 )
F_90 ( ( unsigned long ) F_91 ( V_118 ) ) ;
else
break;
}
int F_92 ( struct V_117 * V_118 , int V_119 )
{
void * V_121 ;
int V_120 ;
F_93 ( V_118 , V_119 ) ;
for ( V_120 = 0 ; V_120 < V_119 ; V_120 ++ , V_118 ++ ) {
V_121 = ( void * ) F_94 ( V_23 ) ;
if ( ! V_121 ) {
F_89 ( V_118 , V_120 ) ;
return - V_26 ;
}
F_95 ( V_118 , V_121 , V_51 ) ;
}
return 0 ;
}
