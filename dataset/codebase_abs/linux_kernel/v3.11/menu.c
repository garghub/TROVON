...
static int F_25 ( struct V_15 * V_16 , struct V_15 * V_47 )
{
return V_47 -> type == V_48 || V_47 -> type == V_49 ||
( V_47 -> type == V_32 && F_26 ( V_16 , V_47 -> V_6 ) ) ;
}
...
switch ( V_9 -> type ) {
case V_43 :
if ( ( V_16 -> type == V_50 || V_16 -> type == V_48 || V_16 -> type == V_49 ) &&
V_9 -> V_21 -> type != V_28 )
F_2 ( V_9 ,
L_8
L_9 , V_16 -> V_6 ) ;
...
break;
V_47 = F_28 ( V_9 ) ;
if ( V_16 -> type == V_49 || V_16 -> type == V_48 ) {
if ( ! F_25 ( V_16 , V_47 ) )
F_2 ( V_9 ,
L_10 ,
V_16 -> V_6 ) ;
...
break;
case V_54 :
if ( V_16 -> type != V_48 && V_16 -> type != V_49 )
F_2 ( V_9 , L_16
L_17 ) ;
...
V_87 -> V_93 = V_79 -> V_94 - 1 ;
F_58 ( V_79 , L_28 , V_83 , ' ' ,
_ ( F_52 ( V_1 ) ) ) ;
if ( V_1 -> V_16 ) {
F_58 ( V_79 , L_29 , V_1 -> V_16 -> V_6 ?
V_1 -> V_16 -> V_6 : _ ( L_4 ) ,
F_62 ( V_1 -> V_16 ) ) ;
}
F_63 ( V_79 , L_2 ) ;
...
struct V_8 * V_9 ;
if ( V_16 && V_16 -> V_6 ) {
F_58 ( V_79 , L_30 , V_16 -> V_6 ,
F_62 ( V_16 ) ) ;
F_58 ( V_79 , L_31 , F_15 ( V_16 -> type ) ) ;
if ( V_16 -> type == V_48 || V_16 -> type == V_49 ) {
V_9 = F_67 ( V_16 ) ;
if ( V_9 ) {
F_58 ( V_79 , L_32 ) ;
...
V_9 = F_64 ( V_16 ) ;
if ( V_9 ) {
F_58 ( V_79 , _ ( L_33 ) , V_9 -> V_1 -> V_5 -> V_6 ,
V_9 -> V_1 -> V_7 ) ;
...
if ( F_55 ( V_1 ) ) {
if ( V_16 -> V_6 )
F_58 ( V_77 , L_40 , V_100 , V_16 -> V_6 ) ;
V_98 = F_56 ( V_1 ) ;
}
F_58 ( V_77 , L_41 , _ ( V_98 ) ) ;
if ( V_16 )
F_66 ( V_77 , V_16 , NULL ) ;
}
