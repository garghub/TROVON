...
static int F_21 ( T_3 * V_51 , T_1 V_60 , T_1 V_61 )
{
struct V_62 * V_27 ;
int V_28 , V_63 = 1000 ;
V_27 = F_2 () ;
...
int F_23 ( struct V_8 * V_9 , T_1 V_60 )
{
T_3 V_51 = V_9 -> V_51 ;
int V_28 ;
V_28 = F_21 ( & V_51 , V_60 , V_68 ) ;
if ( ! V_28 )
V_9 -> V_51 = V_51 ;
F_15 ( 3 , L_6 , V_9 -> V_55 , V_9 -> V_51 , V_28 ) ;
return V_28 ;
}
...
if ( ! F_25 ( V_9 ) )
return 0 ;
V_28 = F_21 ( & V_51 , 0 , V_69 ) ;
if ( ! V_28 )
V_9 -> V_51 = V_51 ;
F_15 ( 3 , L_7 , V_9 -> V_55 , V_9 -> V_51 , V_28 ) ;
return V_28 ;
}
...
V_28 = F_14 ( V_71 -> V_55 , V_71 -> V_51 , V_71 -> V_75 ) ;
if ( V_28 )
F_10 ( L_9 , V_71 -> V_55 ) ;
}
int F_30 ( void )
...
memset ( V_27 , 0 , sizeof( * V_27 ) ) ;
V_27 -> V_30 . V_31 . V_32 = sizeof( V_27 -> V_30 ) ;
V_27 -> V_30 . V_31 . V_33 = V_79 ;
V_27 -> V_11 . V_31 . V_32 = V_2 - V_80 ;
V_27 -> V_30 . V_77 = V_77 ;
V_28 = F_1 ( V_27 ) ;
if ( V_28 || V_27 -> V_11 . V_31 . V_35 != V_36 ) {
F_10 ( L_10 ,
...
F_31 ( V_27 -> V_11 . V_81 !=
sizeof( struct V_70 ) ) ;
V_78 = ( V_27 -> V_11 . V_31 . V_32 - V_80 ) /
V_27 -> V_11 . V_81 ;
F_32 ( L_11 , V_78 ) ;
V_77 = V_27 -> V_11 . V_77 ;
for ( V_39 = 0 ; V_39 < V_78 ; V_39 ++ )
F_26 ( & V_27 -> V_11 . V_82 [ V_39 ] ) ;
} while ( V_77 );
F_8 ( L_12 ,
V_27 -> V_11 . V_83 ) ;
V_54:
