...
struct V_55 * F_37 ( struct V_8 * V_8 ,
void T_5 * V_104 )
{
struct V_57 * V_10 ;
struct V_105 * V_106 = F_38 ( V_8 -> V_10 ) ;
struct V_107 * V_108 ;
V_10 = F_39 ( sizeof( * V_10 ) , V_109 ) ;
if ( ! V_10 )
goto V_110;
V_10 -> V_1 = V_8 ;
