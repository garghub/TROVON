...
if ( ! V_104 -> V_151 ) {
F_28 ( & V_104 -> V_81 , L_24 ) ;
return - V_152 ;
}
V_106 -> V_114 = V_104 -> V_151 ;
V_106 -> V_126 = 0 ;
...
snprintf ( V_6 -> V_163 , sizeof( V_6 -> V_163 ) , L_25 ,
V_6 -> V_164 ) ;
...
V_80 -> V_170 = F_69 ( 8 ) | F_69 ( 16 ) ;
V_80 -> V_164 = V_6 -> V_164 ;
V_80 -> V_171 = V_6 -> V_172 ;
V_80 -> V_173 = F_51 ;
V_80 -> V_174 = F_49 ;
V_80 -> V_101 = F_46 ;
F_64 ( V_6 ) ;
if ( V_6 -> V_63 && V_6 -> V_63 -> V_175 ) {
V_9 = V_6 -> V_63 -> V_175 ( V_6 ) ;
if ( V_9 ) {
F_70 ( & V_80 -> V_81 , L_27 ) ;
V_6 -> V_60 = 0 ;
}
