...
case V_219 :
{
struct V_220 * V_221 = V_120 ;
switch ( V_221 -> type ) {
case V_222 :
return F_61 ( & V_104 -> V_116 , V_221 , 0 ,
& V_223 ) ;
default:
return - V_24 ;
}
...
case V_232 :
case V_233 :
F_5 ( V_234 , L_11 , V_119 ) ;
return - V_29 ;
case V_235 :
return F_1 ( V_2 , V_120 ) ;
case V_236 :
return F_64 ( V_2 , V_120 ) ;
default:
F_5 ( V_234 , L_12 , V_119 ) ;
return - V_29 ;
}
return V_8 ;
}
static long F_65 ( struct V_109 * V_109 ,
...
return F_69 ( V_109 , V_119 , V_120 , F_39 ) ;
}
static int F_70 ( struct V_3 * V_239 ,
const struct V_240 T_6 * V_241 )
{
struct V_242 T_6 * V_243 ;
struct V_242 T_6 * V_244 ;
T_7 V_245 ;
if ( ! F_71 ( V_246 , V_241 , sizeof( * V_241 ) ) ||
F_72 ( V_239 , V_241 , F_73 ( F_74 ( * V_241 ) , V_26 ) ) ||
F_75 ( V_239 -> V_22 , & V_241 -> V_22 ) )
return - V_27 ;
...
if ( F_75 ( V_245 , & V_241 -> V_26 ) )
return - V_27 ;
V_243 = F_76 ( V_245 ) ;
if ( ! F_71 ( V_246 , V_243 , V_239 -> V_22 * sizeof( * V_243 ) ) )
return - V_27 ;
V_244 = F_77 ( V_239 -> V_22 * sizeof( * V_244 ) ) ;
if ( V_244 == NULL )
return - V_27 ;
V_239 -> V_26 = V_244 ;
if ( F_78 ( V_244 , V_243 , V_239 -> V_22 * sizeof( * V_243 ) ) )
return - V_27 ;
return 0 ;
}
static int F_79 ( const struct V_3 * V_239 ,
struct V_240 T_6 * V_241 )
{
struct V_242 T_6 * V_243 ;
struct V_242 T_6 * V_244 = V_239 -> V_26 ;
T_7 V_245 ;
if ( ! F_71 ( V_248 , V_241 , sizeof( * V_241 ) ) ||
F_80 ( V_241 , V_239 , F_73 ( F_74 ( * V_241 ) , V_26 ) ) ||
F_81 ( V_239 -> V_22 , & V_241 -> V_22 ) )
return - V_27 ;
if ( F_82 ( V_241 -> V_247 , sizeof( V_241 -> V_247 ) ) )
return - V_27 ;
if ( V_239 -> V_22 == 0 )
return 0 ;
if ( F_83 ( V_245 , & V_241 -> V_26 ) )
return - V_27 ;
V_243 = F_76 ( V_245 ) ;
if ( F_78 ( V_243 , V_244 , V_239 -> V_22 * sizeof( * V_243 ) ) )
return - V_27 ;
return 0 ;
}
static int F_84 ( struct V_249 * V_239 ,
const struct V_250 T_6 * V_241 )
{
T_5 T_6 * V_251 ;
T_5 T_6 * V_252 ;
T_7 V_245 ;
if ( ! F_71 ( V_246 , V_241 , sizeof( * V_241 ) ) ||
F_72 ( V_239 , V_241 , F_73 ( F_74 ( * V_241 ) , V_253 ) ) )
return - V_27 ;
if ( V_239 -> V_7 == 0 ) {
V_239 -> V_253 = NULL ;
return 0 ;
}
if ( F_75 ( V_245 , & V_241 -> V_253 ) )
return - V_27 ;
V_251 = F_76 ( V_245 ) ;
if ( ! F_71 ( V_246 , V_251 , V_239 -> V_7 ) )
return - V_27 ;
V_252 = F_77 ( V_239 -> V_7 ) ;
if ( V_252 == NULL )
return - V_27 ;
V_239 -> V_253 = V_252 ;
if ( F_78 ( V_252 , V_251 , V_239 -> V_7 ) )
return - V_27 ;
return 0 ;
}
static int F_85 ( const struct V_249 * V_239 ,
struct V_250 T_6 * V_241 )
{
T_5 T_6 * V_251 ;
T_5 T_6 * V_252 = V_239 -> V_253 ;
T_7 V_245 ;
if ( ! F_71 ( V_248 , V_241 , sizeof( * V_241 ) ) ||
F_80 ( V_241 , V_239 , F_73 ( F_74 ( * V_241 ) , V_253 ) ) )
return - V_27 ;
if ( V_239 -> V_7 == 0 )
return 0 ;
if ( F_83 ( V_245 , & V_241 -> V_253 ) )
return - V_27 ;
V_251 = F_76 ( V_245 ) ;
if ( ! F_71 ( V_246 , V_251 , V_239 -> V_7 ) )
return - V_27 ;
if ( F_78 ( V_251 , V_252 , V_239 -> V_7 ) )
return - V_27 ;
return 0 ;
}
static long F_86 ( struct V_109 * V_109 ,
unsigned int V_119 , unsigned long V_120 )
{
union {
struct V_3 V_4 ;
...
void T_6 * V_241 = F_76 ( V_120 ) ;
T_8 V_256 ;
long V_8 ;
switch ( V_119 ) {
case V_257 :
V_119 = V_235 ;
V_8 = F_70 ( & V_255 . V_4 , V_241 ) ;
break;
case V_258 :
V_119 = V_236 ;
V_8 = F_84 ( & V_255 . V_254 , V_241 ) ;
break;
default:
return - V_259 ;
}
V_256 = F_87 () ;
F_88 ( V_260 ) ;
V_8 = F_65 ( V_109 , V_119 , ( unsigned long ) & V_255 ) ;
F_88 ( V_256 ) ;
if ( V_8 < 0 )
return V_8 ;
switch ( V_119 ) {
case V_235 :
V_8 = F_79 ( & V_255 . V_4 , V_241 ) ;
break;
case V_236 :
V_8 = F_85 ( & V_255 . V_254 , V_241 ) ;
break;
}
return V_8 ;
}
static T_9 F_89 ( struct V_109 * V_109 , char T_6 * V_253 ,
T_10 V_154 , T_11 * V_261 )
{
F_5 ( V_110 , L_15 ) ;
return - V_24 ;
}
static int F_90 ( struct V_109 * V_109 , struct V_262 * V_263 )
{
struct V_103 * V_104 = V_109 -> V_118 ;
struct V_41 * V_42 = V_104 -> V_42 ;
F_5 ( V_110 , L_16 ) ;
return F_91 ( & V_42 -> V_86 , V_263 ) ;
}
static unsigned int F_92 ( struct V_109 * V_109 , T_12 * V_264 )
{
struct V_103 * V_104 = V_109 -> V_118 ;
struct V_41 * V_42 = V_104 -> V_42 ;
F_5 ( V_110 , L_17 ) ;
return F_93 ( & V_42 -> V_86 , V_109 , V_264 ) ;
}
static unsigned long F_94 ( struct V_109 * V_109 ,
unsigned long V_265 , unsigned long V_266 , unsigned long V_267 ,
unsigned long V_178 )
{
struct V_103 * V_104 = V_109 -> V_118 ;
struct V_41 * V_42 = V_104 -> V_42 ;
F_5 ( V_110 , L_18 ) ;
return F_95 ( & V_42 -> V_86 , V_267 ) ;
}
