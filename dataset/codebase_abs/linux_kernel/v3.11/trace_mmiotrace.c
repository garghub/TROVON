...
F_13 ( V_9 , L_6 ) ;
V_29 = F_18 ( sizeof( * V_29 ) , V_33 ) ;
if ( ! V_29 )
return;
V_29 -> V_11 = F_19 ( V_34 , V_34 , NULL ) ;
V_31 -> V_35 = V_29 ;
}
...
{
unsigned long V_36 = F_22 ( & V_37 , 0 ) ;
unsigned long V_38 = F_23 ( V_31 -> V_5 -> V_39 ) ;
if ( V_38 > V_4 )
V_36 += V_38 - V_4 ;
V_4 = V_38 ;
return V_36 ;
}
static T_2 F_24 ( struct V_30 * V_31 , struct V_40 * V_41 ,
...
return 0 ;
F_9 ( V_9 , V_29 -> V_11 ) ;
V_29 -> V_11 = F_19 ( V_34 , V_34 , V_29 -> V_11 ) ;
if ( ! V_29 -> V_11 ) {
F_14 ( V_29 ) ;
V_31 -> V_35 = NULL ;
}
V_45:
V_12 = F_26 ( V_9 , V_42 , V_36 ) ;
return ( V_12 == - V_46 ) ? 0 : V_12 ;
}
static enum V_47 F_27 ( struct V_30 * V_31 )
{
struct V_48 * V_49 = V_31 -> V_50 ;
struct V_51 * V_52 ;
struct V_53 * V_54 ;
struct V_8 * V_9 = & V_31 -> V_32 ;
unsigned long long V_55 = F_28 ( V_31 -> V_56 ) ;
...
static enum V_47 F_33 ( struct V_30 * V_31 )
{
...
V_49 = F_40 ( V_94 ) ;
V_49 -> V_54 = * V_54 ;
if ( ! F_41 ( V_90 , V_49 , V_39 , V_94 ) )
F_42 ( V_39 , V_94 , 0 , V_66 ) ;
}
void F_43 ( struct V_53 * V_54 )
{
struct V_1 * V_2 = V_7 ;
struct V_87 * V_88 = F_44 ( V_2 -> V_5 . V_88 , F_45 () ) ;
F_36 ( V_2 , V_88 , V_54 ) ;
}
...
void F_47 ( struct V_72 * V_74 )
{
struct V_1 * V_2 = V_7 ;
struct V_87 * V_88 ;
F_48 () ;
V_88 = F_44 ( V_2 -> V_5 . V_88 , F_45 () ) ;
F_46 ( V_2 , V_88 , V_74 ) ;
F_49 () ;
}
int F_50 ( const char * V_96 , T_7 args )
{
return F_51 ( 0 , V_96 , args ) ;
}
