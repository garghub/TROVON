...
static int F_53 ( struct V_97 * V_98 , struct V_1 * V_2 , int V_99 )
{
struct V_100 * V_100 ;
if ( F_6 ( ! V_2 ) )
return - V_28 ;
V_100 = F_54 ( V_98 , V_99 ) ;
if ( F_6 ( ! V_100 ) ) {
F_55 ( V_2 ) ;
return - V_101 ;
}
...
static int F_57 ( struct V_97 * V_98 , struct V_1 * V_2 ,
...
int V_107 ;
V_105 . V_108 = V_109 ;
V_105 . V_110 = & F_58 ( V_2 ) -> V_111 -> V_110 ;
V_105 . V_112 = NULL ;
V_105 . V_113 = 0 ;
for ( V_106 = F_59 ( V_103 ) , V_107 = F_60 ( V_103 ) ; V_107 > 0 ;
V_106 = F_61 ( V_106 , & V_107 ) ) {
switch ( F_62 ( V_106 ) ) {
case V_114 :
V_105 . V_112 = V_106 ;
break;
case V_115 :
V_105 . V_113 = F_63 ( V_106 ) ;
break;
}
}
return F_64 ( V_98 , V_2 , & V_105 ) ;
}
...
return F_67 ( V_98 , V_2 , F_59 ( V_116 ) ,
F_60 ( V_116 ) , true ) ;
}
...
break;
case V_121 :
V_2 -> V_122 = F_63 ( V_119 ) ;
break;
case V_123 :
F_58 ( V_2 ) -> V_124 = F_59 ( V_119 ) ;
break;
case V_125 :
V_8 = F_22 ( V_2 , F_59 ( V_119 ) ) ;
break;
case V_126 :
V_8 = F_39 ( V_2 , F_59 ( V_119 ) ) ;
break;
case V_127 :
V_8 = F_43 ( V_2 , F_59 ( V_119 ) ) ;
break;
case V_128 :
V_8 = F_52 ( V_2 , F_59 ( V_119 ) ) ;
break;
case V_129 :
V_8 = F_51 ( V_2 , F_59 ( V_119 ) ) ;
break;
}
return V_8 ;
}
static int F_67 ( struct V_97 * V_98 , struct V_1 * V_2 ,
const struct V_102 * V_103 , int V_23 , bool V_130 )
{
int V_131 = - 1 ;
const struct V_102 * V_106 ;
int V_107 ;
...
break;
case V_136 :
V_8 = F_68 ( V_2 , F_59 ( V_106 ) ) ;
break;
case V_137 :
V_8 = F_65 ( V_98 , V_2 , V_106 ) ;
break;
}
if ( F_6 ( V_8 ) ) {
F_55 ( V_2 ) ;
...
int F_71 ( struct V_97 * V_98 , struct V_1 * V_2 )
{
struct V_138 * V_139 = F_72 ( F_58 ( V_2 ) -> V_111 -> V_140 ) ;
F_58 ( V_2 ) -> V_124 = NULL ;
return F_67 ( V_98 , V_2 , V_139 -> V_141 ,
V_139 -> V_142 , false ) ;
}
