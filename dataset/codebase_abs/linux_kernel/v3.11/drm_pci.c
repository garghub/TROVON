...
int F_31 ( struct V_55 * V_10 , const struct V_56 * V_57 ,
struct V_58 * V_19 )
{
struct V_1 * V_2 ;
int V_26 ;
...
#endif
F_34 ( & V_66 ) ;
if ( ( V_26 = F_35 ( V_2 , V_57 , V_19 ) ) ) {
F_36 ( V_67 L_8 ) ;
goto V_68;
}
if ( F_28 ( V_2 , V_69 ) ) {
F_37 ( V_10 , V_2 ) ;
V_26 = F_38 ( V_2 , & V_2 -> V_70 , V_71 ) ;
if ( V_26 )
goto V_68;
}
if ( ( V_26 = F_38 ( V_2 , & V_2 -> V_72 , V_73 ) ) )
goto V_74;
if ( V_2 -> V_19 -> V_75 ) {
V_26 = V_2 -> V_19 -> V_75 ( V_2 , V_57 -> V_76 ) ;
if ( V_26 )
goto V_77;
}
if ( F_28 ( V_2 , V_69 ) ) {
...
F_40 ( & V_2 -> V_79 , & V_19 -> V_80 ) ;
F_41 ( L_9 ,
V_19 -> V_22 , V_19 -> V_81 , V_19 -> V_82 , V_19 -> V_83 ,
V_19 -> V_84 , F_42 ( V_10 ) , V_2 -> V_72 -> V_85 ) ;
F_43 ( & V_66 ) ;
return 0 ;
V_77:
F_44 ( & V_2 -> V_72 ) ;
...
int F_46 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
...
if ( V_19 -> V_89 & V_69 )
return F_48 ( V_18 ) ;
for ( V_87 = 0 ; V_18 -> V_90 [ V_87 ] . V_63 != 0 ; V_87 ++ ) {
V_86 = & V_18 -> V_90 [ V_87 ] ;
V_10 = NULL ;
while ( ( V_10 =
F_49 ( V_86 -> V_63 , V_86 -> V_61 , V_86 -> V_91 ,
V_86 -> V_92 , V_10 ) ) != NULL ) {
if ( ( V_10 -> V_93 & V_86 -> V_94 ) != V_86 -> V_93 )
continue;
F_50 ( V_10 ) ;
F_31 ( V_10 , V_86 , V_19 ) ;
}
...
int F_51 ( struct V_1 * V_2 , T_3 * V_95 )
{
struct V_55 * V_96 ;
T_3 V_97 , V_98 ;
* V_95 = 0 ;
if ( ! V_2 -> V_10 )
return - V_33 ;
V_96 = V_2 -> V_10 -> V_15 -> V_99 ;
if ( V_96 -> V_63 == V_100 ||
V_96 -> V_63 == V_101 )
return - V_33 ;
F_52 ( V_96 , V_102 , & V_97 ) ;
F_52 ( V_96 , V_103 , & V_98 ) ;
if ( V_98 ) {
if ( V_98 & V_104 )
* V_95 |= V_105 ;
if ( V_98 & V_106 )
...
F_41 ( L_10 , V_96 -> V_63 , V_96 -> V_61 , V_97 , V_98 ) ;
return 0 ;
}
int F_46 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
...
void F_53 ( struct V_58 * V_19 , struct V_17 * V_18 )
{
