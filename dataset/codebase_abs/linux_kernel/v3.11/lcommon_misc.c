...
F_5 ( V_44 , L_2 V_45 L_3 V_45 L_4 ,
V_32 -> V_46 , V_35 ) ;
F_8 ( & V_32 -> V_47 ) ;
V_32 -> V_46 &= V_35 ;
if ( V_32 -> V_48 )
...
int F_11 ( struct V_52 * V_53 , unsigned long V_54 , int V_55 ,
struct V_56 * V_57 )
{
struct V_58 * V_59 ;
struct V_60 * V_61 ;
...
V_61 -> V_68 = V_53 ;
V_61 -> V_69 = 1 ;
V_10 = F_16 ( V_59 , V_61 , V_70 , V_61 -> V_68 ) ;
if ( V_10 ) {
F_17 ( V_10 < 0 ) ;
F_18 ( V_59 , & V_67 ) ;
return V_10 ;
...
V_65 -> V_76 = V_54 ;
V_65 -> V_77 = V_78 ;
V_66 = V_79 | ( V_55 ? V_80 : 0 ) ;
V_65 -> V_81 = V_66 ;
V_63 = F_20 ( V_59 , V_61 , V_65 , V_82 , V_83 ) ;
if ( F_13 ( V_63 ) ) {
F_21 ( V_59 , V_61 ) ;
F_18 ( V_59 , & V_67 ) ;
return F_14 ( V_63 ) ;
...
{
struct V_58 * V_59 = V_57 -> V_84 ;
struct V_60 * V_61 = V_57 -> V_85 ;
struct V_62 * V_63 = V_57 -> V_86 ;
int V_67 ;
F_17 ( V_57 -> V_84 ) ;
F_17 ( V_57 -> V_87 ) ;
F_24 ( V_59 , & V_67 ) ;
