...
if ( ! V_36 )
return - V_40 ;
V_34 = F_9 ( V_32 , V_41 , 0 ) ;
if ( ! V_34 ) {
F_10 ( & V_32 -> V_2 , L_1 ) ;
return - V_42 ;
}
V_4 = F_11 ( sizeof( struct V_3 ) , V_43 ) ;
if ( ! V_4 ) {
F_10 ( & V_32 -> V_2 , L_2 ) ;
return - V_44 ;
}
...
if ( ! F_15 ( V_34 -> V_49 , F_16 ( V_34 ) ,
L_5 ) ) {
F_10 ( & V_32 -> V_2 , L_6 ) ;
V_38 = - V_45 ;
goto V_48;
}
V_50 = F_17 ( V_34 -> V_49 , F_16 ( V_34 ) ) ;
if ( ! V_50 ) {
F_10 ( & V_32 -> V_2 , L_7 ) ;
V_38 = - V_44 ;
goto V_51;
