...
F_35 ( V_16 -> V_68 , V_39 + V_67 , V_53 ) ;
return 0 ;
}
static int F_36 ( struct V_7 * V_8 )
{
struct V_69 * V_70 = V_8 -> V_70 -> V_69 ;
T_2 V_53 = V_41 . V_43 ;
F_12 ( L_1 , V_22 ) ;
if ( ! V_70 -> V_71 -> V_72 )
V_70 -> V_71 -> V_72 = & V_73 ;
if ( ! V_70 -> V_71 -> V_74 )
V_70 -> V_71 -> V_74 = F_37 ( 32 ) ;
return F_38 ( V_8 -> V_3 ,
V_75 , V_70 -> V_71 , V_53 , V_53 ) ;
}
static int F_39 ( struct V_76 * V_77 )
{
return F_40 ( & V_77 -> V_71 , & V_78 ) ;
}
