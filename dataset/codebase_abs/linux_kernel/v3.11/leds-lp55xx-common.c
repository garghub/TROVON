...
int F_55 ( struct V_4 * V_5 , struct V_76 * V_77 )
{
struct V_76 * V_78 ;
struct V_33 * V_34 ;
struct V_79 * V_9 ;
int V_67 ;
int V_69 = 0 ;
V_34 = F_56 ( V_5 , sizeof( * V_34 ) , V_50 ) ;
if ( ! V_34 )
return - V_80 ;
V_67 = F_57 ( V_77 ) ;
if ( V_67 == 0 ) {
...
V_9 = F_56 ( V_5 , sizeof( * V_9 ) * V_67 , V_50 ) ;
if ( ! V_9 )
return - V_80 ;
V_34 -> V_38 = & V_9 [ 0 ] ;
V_34 -> V_67 = V_67 ;
F_58 (np, child) {
V_9 [ V_69 ] . V_39 = V_69 ;
F_59 ( V_78 , L_18 , & V_9 [ V_69 ] . V_36 ) ;
F_60 ( V_78 , L_19 , & V_9 [ V_69 ] . V_22 ) ;
F_60 ( V_78 , L_20 , & V_9 [ V_69 ] . V_26 ) ;
V_69 ++ ;
}
F_59 ( V_77 , L_21 , & V_34 -> V_41 ) ;
F_60 ( V_77 , L_22 , & V_34 -> V_81 ) ;
V_5 -> V_82 = V_34 ;
return 0 ;
}
