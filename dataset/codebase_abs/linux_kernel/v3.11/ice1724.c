...
static int F_89 ( struct V_1 * V_2 , int V_174 )
{
struct V_175 * V_176 ;
int V_177 , V_134 ;
...
static int F_101 ( struct V_1 * V_2 , int V_174 )
{
char * V_187 ;
struct V_175 * V_176 ;
int V_204 , V_177 ;
...
static int F_105 ( struct V_1 * V_2 , int V_174 )
{
struct V_175 * V_176 ;
int V_204 ;
int V_134 ;
...
continue;
V_2 -> V_310 = V_301 ;
if ( ! V_301 -> V_311 || ! V_301 -> V_312 )
goto V_313;
F_155 ( L_41 ) ;
V_2 -> V_106 . V_229 = 2 ;
V_2 -> V_106 . V_137 = V_301 -> V_311 + 6 ;
memcpy ( V_2 -> V_106 . V_25 , V_301 -> V_312 , V_301 -> V_311 ) ;
goto V_314;
}
}
F_49 ( V_221 L_42 ,
...
if ( V_2 -> V_106 . V_229 != 1 && V_2 -> V_106 . V_229 != 2 )
F_49 ( V_221 L_44 ,
V_2 -> V_106 . V_229 ) ;
...
V_314:
V_2 -> V_106 . V_231 = F_109 ( V_2 , V_316 ) ;
V_2 -> V_106 . V_232 = F_109 ( V_2 , V_317 ) ;
V_2 -> V_106 . V_230 = F_109 ( V_2 , V_318 ) ;
return 0 ;
}
static void F_157 ( struct V_1 * V_2 )
{
F_9 ( V_319 , F_15 ( V_2 , V_320 ) ) ;
F_2 ( F_15 ( V_2 , V_320 ) ) ;
F_158 ( 10 ) ;
F_9 ( 0 , F_15 ( V_2 , V_320 ) ) ;
F_2 ( F_15 ( V_2 , V_320 ) ) ;
F_158 ( 10 ) ;
}
static int F_159 ( struct V_1 * V_2 )
{
F_9 ( V_2 -> V_106 . V_25 [ V_178 ] , F_15 ( V_2 , V_321 ) ) ;
F_9 ( V_2 -> V_106 . V_25 [ V_107 ] , F_15 ( V_2 , V_322 ) ) ;
F_9 ( V_2 -> V_106 . V_25 [ V_149 ] , F_15 ( V_2 , V_323 ) ) ;
F_9 ( V_2 -> V_106 . V_25 [ V_205 ] , F_15 ( V_2 , V_193 ) ) ;
V_2 -> V_122 . V_324 = V_2 -> V_106 . V_231 ;
V_2 -> V_122 . V_325 = V_2 -> V_106 . V_230 ;
F_18 ( V_2 , V_2 -> V_106 . V_231 ) ;
F_13 ( V_2 , V_2 -> V_106 . V_230 ) ;
F_20 ( V_2 , V_2 -> V_106 . V_232 ) ;
F_9 ( 0 , F_15 ( V_2 , V_326 ) ) ;
...
return - V_15 ;
if ( ! V_2 -> V_328 ) {
V_134 = F_162 ( V_2 -> V_181 ,
F_163 ( & V_329 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
}
V_134 = F_162 ( V_2 -> V_181 , F_163 ( & V_330 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_162 ( V_2 -> V_181 , V_327 = F_163 ( & V_331 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_327 -> V_284 . V_174 = V_2 -> V_176 -> V_174 ;
V_134 = F_162 ( V_2 -> V_181 , V_327 = F_163 ( & V_332 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_327 -> V_284 . V_174 = V_2 -> V_176 -> V_174 ;
V_134 = F_162 ( V_2 -> V_181 , V_327 = F_163 ( & V_333 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_327 -> V_284 . V_174 = V_2 -> V_176 -> V_174 ;
#if 0
...
{
int V_134 ;
V_134 = F_162 ( V_2 -> V_181 , F_163 ( & V_334 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_162 ( V_2 -> V_181 , F_163 ( & V_335 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_162 ( V_2 -> V_181 , F_163 ( & V_336 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
V_134 = F_162 ( V_2 -> V_181 , F_163 ( & V_337 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
if ( ! V_2 -> V_328 && V_2 -> V_163 > 0 ) {
struct V_338 V_339 = V_340 ;
V_339 . V_33 = V_2 -> V_163 ;
if ( V_2 -> V_28 && V_339 . V_33 > 2 )
V_339 . V_33 = 2 ;
V_134 = F_162 ( V_2 -> V_181 , F_163 ( & V_339 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
}
V_134 = F_162 ( V_2 -> V_181 , F_163 ( & V_341 , V_2 ) ) ;
if ( V_134 < 0 )
return V_134 ;
return 0 ;
}
...
static int F_171 ( struct V_344 * V_174 )
{
struct V_1 * V_2 = V_174 -> V_345 ;
return F_165 ( V_2 ) ;
}
static int F_172 ( struct V_346 * V_181 ,
struct V_347 * V_189 ,
const char * V_298 ,
struct V_1 * * V_348 )
{
...
F_176 ( & V_2 -> V_135 ) ;
F_176 ( & V_2 -> V_293 ) ;
V_2 -> V_122 . V_355 = F_18 ;
V_2 -> V_122 . V_356 = F_19 ;
V_2 -> V_122 . V_357 = F_13 ;
V_2 -> V_122 . V_358 = F_16 ;
V_2 -> V_122 . V_359 = F_20 ;
V_2 -> V_122 . V_360 = F_21 ;
V_2 -> V_181 = V_181 ;
V_2 -> V_189 = V_189 ;
V_2 -> V_63 = - 1 ;
F_177 ( V_189 ) ;
...
F_178 ( V_189 -> V_63 ) ;
V_181 -> V_20 = V_2 ;
V_134 = F_179 ( V_189 , L_7 ) ;
if ( V_134 < 0 ) {
F_170 ( V_2 ) ;
F_169 ( V_189 ) ;
return V_134 ;
}
V_2 -> V_234 = F_180 ( V_189 , 0 ) ;
V_2 -> V_147 = F_180 ( V_189 , 1 ) ;
if ( F_181 ( V_189 -> V_63 , F_47 ,
V_361 , V_362 , V_2 ) ) {
F_182 ( V_13 L_45 , V_189 -> V_63 ) ;
F_165 ( V_2 ) ;
return - V_15 ;
}
V_2 -> V_63 = V_189 -> V_63 ;
...
V_134 = F_183 ( V_181 , V_363 , V_2 , & V_127 ) ;
if ( V_134 < 0 ) {
F_165 ( V_2 ) ;
return V_134 ;
}
F_184 ( V_181 , & V_189 -> V_292 ) ;
* V_348 = V_2 ;
return 0 ;
}
static int F_185 ( struct V_347 * V_189 ,
...
V_134 = F_186 ( V_370 [ V_292 ] , V_284 [ V_292 ] , V_371 , 0 , & V_181 ) ;
if ( V_134 < 0 )
return V_134 ;
strcpy ( V_181 -> V_372 , L_7 ) ;
strcpy ( V_181 -> V_373 , L_46 ) ;
V_134 = F_172 ( V_181 , V_189 , V_308 [ V_292 ] , & V_2 ) ;
if ( V_134 < 0 ) {
F_187 ( V_181 ) ;
return V_134 ;
}
...
strcpy ( V_181 -> V_373 , V_301 -> V_187 ) ;
if ( V_301 -> V_372 )
strcpy ( V_181 -> V_372 , V_301 -> V_372 ) ;
if ( V_301 -> V_374 ) {
V_134 = V_301 -> V_374 ( V_2 ) ;
if ( V_134 < 0 ) {
F_187 ( V_181 ) ;
return V_134 ;
}
...
if ( ! V_2 -> V_114 )
F_78 ( V_2 ) ;
V_134 = F_89 ( V_2 , V_366 ++ ) ;
if ( V_134 < 0 ) {
F_187 ( V_181 ) ;
return V_134 ;
}
V_134 = F_101 ( V_2 , V_366 ++ ) ;
if ( V_134 < 0 ) {
F_187 ( V_181 ) ;
return V_134 ;
}
V_134 = F_105 ( V_2 , V_366 ++ ) ;
if ( V_134 < 0 ) {
F_187 ( V_181 ) ;
return V_134 ;
}
...
if ( ! V_301 -> V_379 ) {
if ( V_2 -> V_106 . V_25 [ V_178 ] & V_380 ) {
struct V_381 * V_38 ;
V_134 = F_188 ( V_181 , L_47 , 0 , 1 , 1 , & V_38 ) ;
if ( V_134 < 0 ) {
F_187 ( V_181 ) ;
return V_134 ;
}
...
F_9 ( V_387 | 0x1 ,
F_15 ( V_2 , V_388 ) ) ;
F_9 ( 0x1 , F_15 ( V_2 , V_388 ) ) ;
F_9 ( V_389 , F_15 ( V_2 , V_59 ) ) ;
}
}
sprintf ( V_181 -> V_227 , L_49 ,
V_181 -> V_373 , V_2 -> V_234 , V_2 -> V_63 ) ;
V_134 = F_190 ( V_181 ) ;
if ( V_134 < 0 ) {
F_187 ( V_181 ) ;
return V_134 ;
...
static void F_192 ( struct V_347 * V_189 )
{
struct V_346 * V_181 = F_193 ( V_189 ) ;
struct V_1 * V_2 = V_181 -> V_20 ;
if ( V_2 -> V_310 && V_2 -> V_310 -> V_390 )
V_2 -> V_310 -> V_390 ( V_2 ) ;
F_187 ( V_181 ) ;
}
static int F_194 ( struct V_174 * V_292 )
{
struct V_347 * V_189 = F_195 ( V_292 ) ;
struct V_346 * V_181 = F_196 ( V_292 ) ;
struct V_1 * V_2 = V_181 -> V_20 ;
if ( ! V_2 -> V_315 )
return 0 ;
F_197 ( V_181 , V_391 ) ;
...
F_199 ( V_2 -> V_17 ) ;
F_33 ( & V_2 -> V_53 ) ;
V_2 -> V_392 = V_2 -> V_5 ( V_2 ) ;
V_2 -> V_393 = F_12 ( F_3 ( V_2 , V_195 ) ) ;
V_2 -> V_394 = F_2 ( F_15 ( V_2 , V_193 ) ) ;
V_2 -> V_395 = F_17 ( F_3 ( V_2 , V_233 ) ) ;
F_34 ( & V_2 -> V_53 ) ;
if ( V_2 -> V_396 )
V_2 -> V_396 ( V_2 ) ;
F_169 ( V_189 ) ;
...
static int F_202 ( struct V_174 * V_292 )
{
struct V_347 * V_189 = F_195 ( V_292 ) ;
struct V_346 * V_181 = F_196 ( V_292 ) ;
struct V_1 * V_2 = V_181 -> V_20 ;
...
F_94 ( V_2 , V_2 -> V_393 ) ;
F_9 ( V_2 -> V_394 , F_15 ( V_2 , V_193 ) ) ;
F_14 ( V_2 -> V_395 , F_3 ( V_2 , V_233 ) ) ;
if ( V_2 -> V_17 )
F_205 ( V_2 -> V_17 ) ;
F_197 ( V_181 , V_400 ) ;
return 0 ;
