...
T_1 F_54 ( struct V_1 * V_2 , int V_13 ,
struct V_16 * V_116 )
{
T_1 V_117 ;
do {
...
F_59 ( & V_119 -> V_83 . V_124 ,
& V_119 -> V_83 . V_5 -> V_125 ) ;
F_60 ( & V_119 -> V_83 . V_5 -> V_126 ) ;
F_61 ( V_119 -> V_83 . V_127 , V_119 -> V_128 ,
V_119 -> V_122 . V_123 ) ;
}
void F_62 ( struct V_1 * V_2 , int V_13 ,
struct V_118 * V_119 )
{
struct V_16 V_114 ;
unsigned int V_120 ;
if ( V_13 >= 0 ) {
V_120 = F_54 ( V_2 , V_13 , & V_114 ) ;
} else {
V_120 = 0 ;
V_114 = F_52 () ;
}
V_119 -> V_128 = V_13 ;
F_56 ( V_2 , V_119 , V_120 , & V_114 ) ;
}
static void F_63 ( struct V_1 * V_2 , int V_13 )
{
...
F_64 () ;
F_65 ( V_129 , & V_2 -> V_29 [ V_13 ] ) ;
F_12 () ;
}
int F_66 ( struct V_1 * V_2 , int V_13 )
{
unsigned long V_17 , V_134 ;
int V_40 = 0 ;
F_5 ( & V_2 -> V_34 , V_17 ) ;
if ( F_67 ( 1 , & V_2 -> V_35 [ V_13 ] ) == 1 ) {
F_5 ( & V_2 -> V_24 , V_134 ) ;
if ( ! V_2 -> V_26 [ V_13 ] ) {
...
{
F_70 ( F_7 ( & V_2 -> V_35 [ V_13 ] ) == 0 ) ;
if ( F_71 ( & V_2 -> V_35 [ V_13 ] ) &&
( V_136 > 0 ) )
F_72 ( & V_2 -> V_36 ,
...
V_120 = F_54 ( V_2 , V_13 , & V_114 ) ;
F_74 ( & V_2 -> V_121 ) ;
F_75 (e, t, &dev->vblank_event_list, base.link) {
if ( V_119 -> V_128 != V_13 )
continue;
F_15 ( L_18 ,
V_119 -> V_122 . V_123 , V_120 ) ;
F_76 ( & V_119 -> V_83 . V_124 ) ;
F_69 ( V_2 , V_119 -> V_128 ) ;
F_56 ( V_2 , V_119 , V_120 , & V_114 ) ;
}
F_77 ( & V_2 -> V_121 ) ;
F_13 ( & V_2 -> V_34 , V_17 ) ;
...
void F_79 ( struct V_1 * V_2 , int V_13 )
{
unsigned long V_17 ;
if ( ! V_2 -> V_33 )
return;
...
int F_80 ( struct V_1 * V_2 , void * V_3 ,
struct V_4 * V_5 )
{
struct F_80 * V_140 = V_3 ;
unsigned int V_13 ;
if ( ! V_2 -> V_33 )
return 0 ;
if ( F_2 ( V_2 , V_64 ) )
...
static int F_81 ( struct V_1 * V_2 , int V_128 ,
union V_144 * V_145 ,
struct V_4 * V_5 )
{
struct V_118 * V_119 ;
...
F_59 ( & V_119 -> V_83 . V_124 , & V_2 -> V_158 ) ;
V_145 -> V_157 . V_123 = V_145 -> V_151 . V_123 ;
}
F_13 ( & V_2 -> V_121 , V_78 ) ;
return 0 ;
...
if ( V_78 & V_169 ) {
return F_81 ( V_2 , V_13 , V_145 , V_5 ) ;
}
if ( ( V_78 & V_156 ) &&
( V_120 - V_145 -> V_151 . V_123 ) <= ( 1 << 23 ) ) {
V_145 -> V_151 . V_123 = V_120 + 1 ;
...
F_84 ( V_40 , V_2 -> V_37 [ V_13 ] , 3 * V_138 ,
( ( ( F_53 ( V_2 , V_13 ) -
V_145 -> V_151 . V_123 ) <= ( 1 << 23 ) ) ||
! V_2 -> V_50 ) ) ;
if ( V_40 != - V_170 ) {
struct V_16 V_114 ;
V_145 -> V_157 . V_123 = F_54 ( V_2 , V_13 , & V_114 ) ;
...
static void F_85 ( struct V_1 * V_2 , int V_13 )
{
struct V_118 * V_119 , * V_139 ;
struct V_16 V_114 ;
unsigned long V_78 ;
...
bool F_87 ( struct V_1 * V_2 , int V_13 )
{
T_1 V_18 ;
T_2 V_19 ;
struct V_16 V_21 ;
