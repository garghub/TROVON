...
int V_38 ;
int V_49 ;
V_3 = F_30 ( & V_42 -> V_19 , sizeof( * V_3 ) , V_50 ) ;
if ( ! V_3 )
return - V_51 ;
F_31 ( & V_3 -> V_37 ) ;
V_49 = - V_30 ;
...
if ( ! V_47 )
goto V_56;
V_3 -> V_5 = F_33 ( & V_42 -> V_19 , V_47 -> V_54 ,
F_34 ( V_47 ) ) ;
if ( ! V_3 -> V_5 )
goto V_56;
...
static int F_48 ( struct V_41 * V_42 , T_4 V_81 )
{
struct V_2 * V_3 = F_47 ( V_42 ) ;
if ( V_3 -> V_53 && F_49 ( & V_42 -> V_19 ) )
F_50 ( V_3 -> V_53 ) ;
return 0 ;
}
