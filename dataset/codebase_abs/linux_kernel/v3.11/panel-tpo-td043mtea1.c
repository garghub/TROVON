...
if ( F_33 ( V_25 ) )
return 0 ;
V_48 -> V_49 . V_50 -> V_54 ( V_48 , V_28 -> V_55 ) ;
...
struct V_27 * V_28 = F_29 ( V_25 ) ;
struct V_24 * V_48 = V_28 -> V_48 ;
return V_48 -> V_49 . V_50 -> V_66 ( V_48 , V_64 ) ;
}
...
struct V_24 * V_25 ;
int V_10 ;
F_43 ( & V_2 -> V_14 , L_6 , V_72 ) ;
V_2 -> V_12 = 16 ;
V_2 -> V_38 = V_73 ;
V_10 = F_44 ( V_2 ) ;
if ( V_10 < 0 ) {
F_41 ( & V_2 -> V_14 , L_7 , V_10 ) ;
return V_10 ;
}
V_28 = F_45 ( & V_2 -> V_14 , sizeof( * V_28 ) , V_74 ) ;
if ( V_28 == NULL )
return - V_75 ;
F_46 ( & V_2 -> V_14 , V_28 ) ;
V_28 -> V_2 = V_2 ;
...
V_28 -> V_38 = V_76 ;
memcpy ( V_28 -> gamma , V_77 , sizeof( V_28 -> gamma ) ) ;
V_28 -> V_43 = F_47 ( & V_2 -> V_14 , L_8 ) ;
if ( F_48 ( V_28 -> V_43 ) ) {
F_41 ( & V_2 -> V_14 , L_9 ) ;
V_10 = F_49 ( V_28 -> V_43 ) ;
goto V_78;
