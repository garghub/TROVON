...
F_1 () ;
V_10 [ 0 ] = V_19 | V_22 ;
V_10 [ 1 ] = F_16 ( V_21 -> V_23 & 0x7F ) ;
V_10 [ 2 ] = F_16 ( V_21 -> V_24 & 0x7F ) ;
V_10 [ 3 ] = F_16 ( V_21 -> V_25 & 0x3F ) ;
V_10 [ 4 ] = F_16 ( V_21 -> V_26 & 0x3F ) ;
V_10 [ 5 ] = V_21 -> V_27 & 0x07 ;
V_10 [ 6 ] = F_16 ( ( V_21 -> V_28 + 1 ) & 0x1F ) ;
V_10 [ 7 ] = F_16 ( V_21 -> V_29 < 100 ? V_21 -> V_29 : V_21 -> V_29 - 100 ) ;
V_13 = F_9 ( V_7 , V_10 , sizeof( V_10 ) ) ;
if ( V_13 < 0 )
return V_13 ;
F_1 () ;
...
T_2 V_10 [ 2 ] , V_11 [ 2 ] ;
int V_13 , V_36 ;
V_35 = F_18 ( & V_7 -> V_2 , sizeof( struct V_34 ) ,
V_37 ) ;
if ( ! V_35 )
return - V_38 ;
V_7 -> V_2 . V_39 = V_35 ;
...
sprintf ( V_35 -> V_48 [ V_36 ] . V_14 , L_14 , V_36 ) ;
