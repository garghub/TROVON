...
V_469 . V_105 . V_293 += V_469 . V_105 . V_133 ;
V_65 = & V_469 . V_105 ;
} else {
V_467 = sizeof( struct V_472 ) ;
V_469 . V_292 . V_293 += V_469 . V_292 . V_133 ;
V_65 = & V_469 . V_292 ;
}
break;
case V_419 :
...
static int F_263 ( struct V_476 * V_477 ,
unsigned long V_226 , void * V_478 )
{
struct V_1 * V_2 ;
struct V_71 * V_72 = F_264 ( V_478 ) ;
struct V_186 * V_186 = F_113 ( V_72 ) ;
F_144 () ;
F_265 (sk, &net->packet.sklist) {
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_226 ) {
case V_479 :
if ( V_4 -> V_438 )
...
static int F_266 ( struct V_224 * V_1 , unsigned int V_483 ,
unsigned long V_484 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
switch ( V_483 ) {
...
{
int V_486 = F_267 ( V_2 ) ;
return F_261 ( V_486 , ( int T_7 * ) V_484 ) ;
}
case V_487 :
{
struct V_22 * V_23 ;
...
case V_488 :
return F_268 ( V_2 , (struct V_489 T_7 * ) V_484 ) ;
case V_490 :
return F_269 ( V_2 , (struct V_24 T_7 * ) V_484 ) ;
#ifdef F_270
case V_491 :
case V_492 :
case V_493 :
...
case V_503 :
case V_504 :
return V_505 . V_506 ( V_1 , V_483 , V_484 ) ;
#endif
default:
return - V_507 ;
}
...
static unsigned int F_271 ( struct V_508 * V_508 , struct V_224 * V_1 ,
T_8 * V_509 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned int V_510 = F_272 ( V_508 , V_1 , V_509 ) ;
F_231 ( & V_2 -> V_114 . V_63 ) ;
if ( V_4 -> V_62 . V_51 ) {
...
F_233 ( & V_2 -> V_114 . V_63 ) ;
F_231 ( & V_2 -> V_513 . V_63 ) ;
if ( V_4 -> V_58 . V_51 ) {
if ( F_27 ( V_4 , & V_4 -> V_58 , V_150 ) )
V_510 |= V_514 | V_515 ;
}
F_233 ( & V_2 -> V_513 . V_63 ) ;
return V_510 ;
}
static void F_273 ( struct V_516 * V_517 )
{
struct V_508 * V_508 = V_517 -> V_518 ;
struct V_224 * V_1 = V_508 -> V_519 ;
struct V_1 * V_2 = V_1 -> V_2 ;
if ( V_2 )
F_83 ( & F_2 ( V_2 ) -> V_520 ) ;
}
static void F_274 ( struct V_516 * V_517 )
{
struct V_508 * V_508 = V_517 -> V_518 ;
struct V_224 * V_1 = V_508 -> V_519 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
static void F_275 ( struct V_90 * V_51 , unsigned int V_521 ,
unsigned int V_153 )
{
int V_176 ;
for ( V_176 = 0 ; V_176 < V_153 ; V_176 ++ ) {
if ( F_70 ( V_51 [ V_176 ] . V_52 ) ) {
if ( F_276 ( V_51 [ V_176 ] . V_52 ) )
F_277 ( V_51 [ V_176 ] . V_52 ) ;
else
F_278 ( ( unsigned long ) V_51 [ V_176 ] . V_52 ,
V_521 ) ;
...
static char * F_279 ( unsigned long V_521 )
{
char * V_52 = NULL ;
T_9 V_522 = V_202 | V_523 |
V_524 | V_525 | V_526 ;
V_52 = ( char * ) F_280 ( V_522 , V_521 ) ;
if ( V_52 )
return V_52 ;
V_52 = F_281 ( ( 1 << V_521 ) * V_124 ) ;
if ( V_52 )
return V_52 ;
V_522 &= ~ V_526 ;
V_52 = ( char * ) F_280 ( V_522 , V_521 ) ;
...
static struct V_90 * F_282 ( struct V_527 * V_455 , int V_521 )
{
unsigned int V_528 = V_455 -> V_99 ;
struct V_90 * V_51 ;
int V_176 ;
V_51 = F_283 ( V_528 , sizeof( struct V_90 ) , V_202 ) ;
if ( F_39 ( ! V_51 ) )
goto V_115;
for ( V_176 = 0 ; V_176 < V_528 ; V_176 ++ ) {
V_51 [ V_176 ] . V_52 = F_279 ( V_521 ) ;
...
T_6 V_168 ;
int V_78 = - V_198 ;
struct V_527 * V_455 = & V_86 -> V_455 ;
if ( ! V_530 && V_58 && ( V_4 -> V_15 > V_19 ) ) {
F_17 ( 1 , L_7 ) ;
goto V_115;
}
V_46 = V_58 ? & V_4 -> V_58 : & V_4 -> V_62 ;
V_60 = V_58 ? & V_2 -> V_513 : & V_2 -> V_114 ;
V_78 = - V_459 ;
if ( ! V_530 ) {
if ( F_52 ( & V_4 -> V_520 ) )
goto V_115;
...
goto V_115;
if ( F_39 ( V_455 -> V_535 < V_4 -> V_101 +
V_4 -> V_303 ) )
goto V_115;
if ( F_39 ( V_455 -> V_535 & ( V_536 - 1 ) ) )
goto V_115;
V_46 -> V_50 = V_455 -> V_97 / V_455 -> V_535 ;
if ( F_39 ( V_46 -> V_50 <= 0 ) )
goto V_115;
...
goto V_115;
V_78 = - V_201 ;
V_521 = F_284 ( V_455 -> V_97 ) ;
V_51 = F_282 ( V_455 , V_521 ) ;
if ( F_39 ( ! V_51 ) )
goto V_115;
switch ( V_4 -> V_15 ) {
case V_21 :
...
V_78 = - V_459 ;
F_120 ( & V_4 -> V_336 ) ;
if ( V_530 || F_52 ( & V_4 -> V_520 ) == 0 ) {
V_78 = 0 ;
F_231 ( & V_60 -> V_63 ) ;
F_285 ( V_46 -> V_51 , V_51 ) ;
V_46 -> V_156 = ( V_455 -> V_537 - 1 ) ;
V_46 -> V_54 = 0 ;
V_46 -> V_53 = V_455 -> V_535 ;
F_233 ( & V_60 -> V_63 ) ;
F_285 ( V_46 -> V_538 , V_521 ) ;
F_285 ( V_46 -> V_539 , V_455 -> V_99 ) ;
V_46 -> V_540 = V_455 -> V_97 / V_124 ;
...
F_10 ( & V_4 -> V_9 ) ;
if ( V_530 && ( V_4 -> V_15 > V_19 ) ) {
if ( ! V_58 )
F_30 ( V_4 , V_58 , V_60 ) ;
}
F_214 ( V_2 ) ;
if ( V_51 )
F_275 ( V_51 , V_521 , V_455 -> V_99 ) ;
V_115:
return V_78 ;
}
static int F_286 ( struct V_508 * V_508 , struct V_224 * V_1 ,
struct V_516 * V_517 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned long V_541 , V_542 ;
struct V_45 * V_46 ;
unsigned long V_122 ;
int V_78 = - V_198 ;
int V_176 ;
...
if ( V_46 -> V_51 == NULL )
continue;
for ( V_176 = 0 ; V_176 < V_46 -> V_539 ; V_176 ++ ) {
struct V_325 * V_325 ;
void * V_546 = V_46 -> V_51 [ V_176 ] . V_52 ;
int V_547 ;
for ( V_547 = 0 ; V_547 < V_46 -> V_540 ; V_547 ++ ) {
V_325 = F_16 ( V_546 ) ;
V_78 = F_287 ( V_517 , V_122 , V_325 ) ;
if ( F_39 ( V_78 ) )
goto V_115;
V_122 += V_124 ;
V_546 += V_124 ;
...
static void * F_288 ( struct V_550 * V_551 , T_10 * V_552 )
__acquires( T_11 )
{
struct V_186 * V_186 = F_289 ( V_551 ) ;
F_144 () ;
return F_290 ( & V_186 -> V_372 . V_396 , * V_552 ) ;
}
static void * F_291 ( struct V_550 * V_551 , void * V_553 , T_10 * V_552 )
{
struct V_186 * V_186 = F_289 ( V_551 ) ;
return F_292 ( V_553 , & V_186 -> V_372 . V_396 , V_552 ) ;
}
static void F_293 ( struct V_550 * V_551 , void * V_553 )
__releases( T_11 )
{
F_148 () ;
}
static int F_294 ( struct V_550 * V_551 , void * V_553 )
{
if ( V_553 == V_554 )
F_295 ( V_551 , L_9 ) ;
else {
struct V_1 * V_555 = F_296 ( V_553 ) ;
const struct V_3 * V_4 = F_2 ( V_555 ) ;
F_297 ( V_551 ,
L_10 ,
V_555 ,
F_52 ( & V_555 -> V_556 ) ,
...
V_4 -> V_5 ,
F_52 ( & V_555 -> V_160 ) ,
F_298 ( F_299 ( V_551 ) , F_300 ( V_555 ) ) ,
F_301 ( V_555 ) ) ;
}
return 0 ;
}
static int F_302 ( struct V_557 * V_557 , struct V_508 * V_508 )
{
return F_303 ( V_557 , V_508 , & V_558 ,
sizeof( struct V_559 ) ) ;
}
static int T_12 F_304 ( struct V_186 * V_186 )
{
F_223 ( & V_186 -> V_372 . V_373 ) ;
F_305 ( & V_186 -> V_372 . V_396 ) ;
if ( ! F_306 ( L_11 , 0 , V_186 -> V_560 , & V_561 ) )
return - V_201 ;
return 0 ;
}
static void T_13 F_307 ( struct V_186 * V_186 )
{
F_308 ( L_11 , V_186 -> V_560 ) ;
}
