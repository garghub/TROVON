...
F_47 ( V_23 -> V_24 . V_68 , L_11 ,
& V_4 -> V_21 . V_22 ) ;
V_4 -> V_21 . V_69 = F_48 ( V_23 -> V_24 . V_68 ,
L_12 ) ;
}
if ( ! V_4 -> V_21 . V_22 )
V_4 -> V_21 . V_22 = 4 ;
...
V_17 = F_50 ( V_23 , V_72 , V_46 ) ;
if ( ! V_17 )
break;
V_4 -> V_17 [ V_46 ] . V_4 = V_4 ;
V_4 -> V_17 [ V_46 ] . V_29 = V_17 -> V_73 ;
}
V_4 -> V_74 = V_46 ;
if ( V_4 -> V_74 < 1 ) {
F_46 ( & V_23 -> V_24 , L_14 ) ;
...
V_7 -> V_1 = F_52 ( & V_23 -> V_24 , V_60 [ V_46 ] -> V_73 ,
F_51 ( V_60 [ V_46 ] ) ) ;
if ( ! V_7 -> V_1 ) {
F_46 ( & V_23 -> V_24 , L_16 ) ;
V_64 = - V_75 ;
...
for ( V_46 = 0 ; V_46 < V_4 -> V_74 ; V_46 ++ )
F_17 ( V_4 , V_46 , 1 ) ;
F_10 ( V_4 , V_41 , 0x0 ) ;
V_63 = V_4 -> V_17 [ 0 ] . V_29 ;
V_4 -> V_76 = true ;
for ( V_46 = 1 ; V_46 < V_4 -> V_74 ; V_46 ++ ) {
...
if ( V_4 -> V_76 ) {
if ( F_54 ( & V_23 -> V_24 , V_4 -> V_17 [ 0 ] . V_29 ,
F_36 ,
V_83 , V_62 , V_4 ) ) {
F_46 ( & V_23 -> V_24 , L_18 ) ;
V_64 = - V_84 ;
...
static int F_58 ( struct V_55 * V_23 )
{
struct V_3 * V_4 = F_59 ( V_23 ) ;
F_57 ( V_4 -> V_47 ) ;
return 0 ;
}
