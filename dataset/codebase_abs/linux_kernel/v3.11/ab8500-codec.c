...
break;
case 1 :
V_159 = F_41 ( ( unsigned long * ) & V_155 , 32 ) ;
...
F_10 ( V_9 , V_168 , V_122 , V_159 ) ;
F_10 ( V_9 , V_169 , V_122 , V_159 ) ;
V_159 = F_42 ( ( unsigned long * ) & V_155 , 32 , V_159 + 1 ) ;
F_10 ( V_9 , V_170 , V_122 , V_159 ) ;
F_10 ( V_9 , V_171 , V_122 , V_159 ) ;
break;
case 8 :
...
break;
case 1 :
V_159 = F_41 ( ( unsigned long * ) & V_156 , 32 ) ;
F_10 ( V_9 , F_43 ( V_159 ) ,
F_44 ( V_159 ) ,
F_45 ( V_173 , V_159 ) ) ;
break;
...
F_44 ( V_159 ) ,
F_45 ( V_173 , V_159 ) ) ;
V_159 = F_42 ( ( unsigned long * ) & V_156 , 32 , V_159 + 1 ) ;
F_10 ( V_9 ,
F_43 ( V_159 ) ,
F_44 ( V_159 ) ,
F_45 ( V_174 , V_159 ) ) ;
...
static void F_46 ( struct V_64 * V_14 , struct V_175 * V_176 ,
struct V_177 * V_9 )
{
T_2 V_12 ;
if ( F_47 ( V_176 , L_62 , NULL ) )
V_9 -> V_91 . V_105 = V_7 ;
else
V_9 -> V_91 . V_105 = V_6 ;
if ( F_47 ( V_176 , L_63 , NULL ) )
V_9 -> V_91 . V_108 = V_7 ;
else
V_9 -> V_91 . V_108 = V_6 ;
if ( F_47 ( V_176 , L_64 , NULL ) )
V_9 -> V_91 . V_99 = V_4 ;
else
V_9 -> V_91 . V_99 = V_3 ;
if ( F_47 ( V_176 , L_65 , NULL ) )
V_9 -> V_91 . V_101 = V_4 ;
else
V_9 -> V_91 . V_101 = V_3 ;
if ( F_47 ( V_176 , L_66 , NULL ) )
V_9 -> V_91 . V_103 = V_3 ;
else
V_9 -> V_91 . V_103 = V_4 ;
if ( ! F_48 ( V_176 , L_67 , & V_12 ) ) {
switch ( V_12 ) {
case 950 :
V_9 -> V_111 = V_113 ;
break;
...
V_34 = F_52 ( & V_194 -> V_14 , sizeof( struct V_33 ) ,
V_183 ) ;
V_34 -> V_44 = V_195 ;
V_34 -> V_63 = V_196 ;
