...
F_135 ( & V_6 -> V_198 , 6 ) ;
F_135 ( & V_6 -> V_209 , 2 ) ;
F_136 ( & V_6 -> V_209 , & V_273 ,
V_210 , 0 , 1 , 1 , 0 ) ;
F_136 ( & V_6 -> V_209 , & V_273 ,
V_212 , - 15 , 15 , 1 , 0 ) ;
F_136 ( & V_6 -> V_198 , & V_274 ,
V_203 , 0 , 255 , 1 , 54 ) ;
F_136 ( & V_6 -> V_198 , & V_274 ,
V_201 , 0 , 255 , 1 , 119 ) ;
F_136 ( & V_6 -> V_198 , & V_274 ,
...
if ( V_173 )
goto V_275;
V_6 -> V_267 = F_130 ( V_6 , & V_276 , L_46 ) ;
if ( ! V_6 -> V_267 ) {
F_138 ( V_277 L_47 ,
V_6 -> V_161 ) ;
V_173 = - V_81 ;
...
F_139 ( & V_6 -> V_7 . V_8 ) ;
F_139 ( & V_6 -> V_7 . V_245 ) ;
V_173 = F_140 ( V_6 -> V_267 , V_149 , V_278 ) ;
if ( V_173 < 0 ) {
F_138 ( V_277 L_47 ,
V_6 -> V_161 ) ;
V_269 ( V_6 -> V_267 ) ;
...
V_6 -> V_281 -> V_198 = & V_6 -> V_209 ;
V_173 = F_140 ( V_6 -> V_281 , V_242 ,
V_285 ) ;
if ( V_173 < 0 ) {
F_138 ( V_277 L_50 ,
V_6 -> V_161 ) ;
...
F_138 ( V_277 L_48 ,
V_6 -> V_161 , F_105 ( V_6 -> V_281 ) ) ;
}
F_138 ( V_277 L_51 , V_173 ) ;
return V_173 ;
V_284:
F_141 ( V_6 -> V_267 ) ;
V_275:
