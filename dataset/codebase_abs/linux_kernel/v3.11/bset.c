...
V_24 ++ ;
for ( V_21 = V_24 -> V_21 ;
V_21 != V_24 -> V_79 && F_22 ( V_8 -> V_21 , & F_39 ( V_21 ) ) > 0 ;
V_21 = F_7 ( V_21 ) )
...
static void F_113 ( struct V_35 * V_36 , struct V_89 * V_104 ,
struct V_98 * V_99 ,
...
F_115 ( L_6 , V_104 -> V_78 ) ;
F_116 ( V_36 , V_104 ) ;
}
static void F_117 ( struct V_35 * V_36 , struct V_98 * V_99 ,
unsigned V_77 , unsigned V_108 , bool V_105 )
{
V_7 V_109 ;
bool V_106 = ! V_36 -> V_110 ;
struct V_89 * V_104 = ( void * ) F_118 ( V_111 | V_20 ,
V_108 ) ;
if ( ! V_104 ) {
F_119 ( & V_36 -> V_13 -> V_112 ) ;
V_104 = V_36 -> V_13 -> V_113 ;
V_108 = F_120 ( F_121 ( V_36 -> V_13 ) ) ;
}
V_109 = F_122 () ;
F_113 ( V_36 , V_104 , V_99 , V_105 , V_106 ) ;
V_36 -> V_84 = V_77 ;
...
F_125 ( ( unsigned long ) V_104 , V_108 ) ;
if ( V_36 -> V_110 )
F_81 ( V_36 ) ;
if ( ! V_77 ) {
F_126 ( & V_36 -> V_13 -> V_115 ) ;
F_127 ( & V_36 -> V_13 -> V_116 , V_109 ) ;
F_128 ( & V_36 -> V_13 -> V_115 ) ;
}
}
void F_129 ( struct V_35 * V_36 , unsigned V_77 )
{
...
V_108 = F_4 ( F_131 ( V_36 -> V_82 -> V_65 ,
V_78 ) ) / V_117 ;
if ( V_108 )
V_108 = F_120 ( V_108 ) ;
}
F_117 ( V_36 , & V_99 , V_77 , V_108 , false ) ;
F_132 ( V_36 -> V_110 && F_130 ( V_36 ) != V_14 ) ;
}
void F_133 ( struct V_35 * V_36 , struct V_98 * V_99 )
{
F_35 ( ! V_36 -> V_110 ) ;
F_117 ( V_36 , V_99 , 0 , V_36 -> V_114 , true ) ;
}
void F_134 ( struct V_35 * V_36 , struct V_35 * V_16 )
{
V_7 V_109 = F_122 () ;
struct V_98 V_99 ;
F_110 ( V_36 , & V_99 , NULL ) ;
F_113 ( V_36 , V_16 -> V_82 -> V_65 , & V_99 , false , true ) ;
F_126 ( & V_36 -> V_13 -> V_115 ) ;
F_127 ( & V_36 -> V_13 -> V_116 , V_109 ) ;
F_128 ( & V_36 -> V_13 -> V_115 ) ;
...
static int F_137 ( struct V_35 * V_36 , struct V_122 * V_123 ,
struct V_124 * V_125 )
{
struct V_9 * V_21 ;
unsigned V_24 ;
...
int F_139 ( struct V_12 * V_13 , char * V_25 )
{
struct V_122 V_123 ;
struct V_124 V_62 ;
int V_101 ;
...
V_101 = F_141 ( V_124 , V_13 , & V_123 , & V_62 ) ;
if ( V_101 )
return V_101 ;
