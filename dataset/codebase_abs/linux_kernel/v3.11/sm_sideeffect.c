...
static void F_80 ( T_2 * V_100 ,
struct V_1 * V_2 ,
struct V_6 * V_7 )
{
struct V_134 * V_135 ;
struct V_82 * V_136 ;
while ( V_7 -> V_137 > V_7 -> V_109 -> V_54 ) {
V_135 = (struct V_134 * ) ( V_7 -> V_109 -> V_54 ) ;
V_136 = F_81 ( V_2 , V_7 , 0 ,
V_50 ) ;
if ( ! V_136 )
return;
F_82 ( & V_2 -> V_93 , V_136 ) ;
...
static void F_83 ( struct V_144 * V_93 ,
struct V_6 * V_7 )
{
struct V_145 * V_146 ;
F_84 (skip, chunk) {
F_85 ( V_93 , F_86 ( V_146 -> V_147 ) , F_86 ( V_146 -> V_148 ) ) ;
}
}
...
V_101 = F_89 ( V_150 , struct V_10 , V_151 ) ;
if ( ! F_90 ( & V_101 -> V_76 ,
& V_2 -> V_19 . V_152 ) ) {
F_91 ( V_2 , & V_101 -> V_76 ) ;
}
...
struct V_6 * V_168 = F_89 ( V_166 ,
struct V_6 , V_169 ) ;
F_101 ( V_166 ) ;
F_102 ( V_168 ) ;
if ( F_103 ( V_37 , V_2 , V_168 ) )
F_104 ( V_168 ) ;
else
V_2 -> V_170 = V_168 ;
}
...
F_105 * T_14 V_180 ( ( V_181 ) ) = V_175 [ V_91 ] ;
V_173 = F_106 ( V_37 , V_91 , V_48 , V_92 ) ;
F_107 ( & V_14 ) ;
F_108 () ;
V_174 = (* V_173 -> V_182 )( V_37 , V_49 , V_2 , V_92 , V_172 , & V_14 ) ;
F_109 () ;
error = F_110 ( V_91 , V_92 , V_48 ,
V_49 , V_2 , V_172 , V_174 ,
& V_14 , V_99 ) ;
F_111 () ;
return error ;
}
static int F_110 ( T_4 V_91 , T_5 V_92 ,
T_9 V_48 ,
struct V_171 * V_49 ,
struct V_1 * V_2 ,
void * V_172 ,
...
{
int error ;
if ( 0 != ( error = F_112 ( V_91 , V_92 , V_48 ,
V_49 , V_2 ,
V_172 , V_174 ,
V_14 , V_99 ) ) )
goto V_183;
...
V_192 -> V_204 . V_208 , NULL ) ;
break;
case V_209 :
F_124 ( & V_2 -> V_19 . V_24 , V_192 -> V_204 . V_208 ) ;
F_125 ( & V_2 -> V_93 , V_192 -> V_204 . V_208 ) ;
F_50 ( & V_2 -> V_93 , V_50 ) ;
break;
case V_210 :
F_83 ( & V_2 -> V_93 , V_192 -> V_204 . V_7 ) ;
break;
case V_211 :
V_13 = V_192 -> V_204 . V_212 ;
...
V_192 -> V_204 . V_216 , V_99 ) ;
break;
case V_217 :
V_193 = F_127 ( V_2 , V_7 ) ;
if ( ! V_193 ) {
if ( V_192 -> V_204 . V_7 )
F_104 ( V_192 -> V_204 . V_7 ) ;
goto V_33;
}
F_11 ( V_14 , V_34 ,
F_14 ( V_193 ) ) ;
...
case V_86 :
F_19 ( L_14 ,
V_40 , V_192 -> V_204 . V_222 , & V_2 -> V_93 ) ;
F_82 ( & V_2 -> V_93 , V_192 -> V_204 . V_222 ) ;
break;
case V_34 :
if ( ! V_2 -> V_89 . V_223 ) {
F_130 ( & V_2 -> V_89 ) ;
...
error = F_98 ( & V_2 -> V_89 , V_192 -> V_204 . V_7 ) ;
break;
case V_224 :
...
break;
case V_229 :
F_1 ( V_2 , V_192 -> V_204 . V_208 ) ;
break;
case V_230 :
V_193 = F_2 ( V_2 , V_192 -> V_204 . V_208 ,
V_7 ) ;
if ( V_193 )
F_11 ( V_14 , V_34 ,
F_14 ( V_193 ) ) ;
break;
case V_231 :
F_7 ( V_2 , V_192 -> V_204 . V_208 ) ;
break;
case V_232 :
F_67 ( V_14 , V_2 , V_192 -> V_204 . V_7 ) ;
break;
case V_233 :
V_156 = & V_2 -> V_53 [ V_192 -> V_204 . V_234 ] ;
if ( F_134 ( V_156 ) )
break;
case V_235 :
V_156 = & V_2 -> V_53 [ V_192 -> V_204 . V_234 ] ;
V_197 = V_2 -> V_27 [ V_192 -> V_204 . V_234 ] ;
F_76 ( ! V_197 ) ;
V_156 -> V_236 = V_42 + V_197 ;
F_27 ( V_2 ) ;
F_135 ( V_156 ) ;
break;
case V_30 :
...
break;
case V_240 :
F_44 ( V_14 , V_2 , V_192 -> V_204 . V_112 ) ;
break;
case V_241 :
F_49 ( V_14 , V_2 , V_91 ,
V_92 , V_7 , V_192 -> V_204 . V_112 ) ;
break;
case V_242 :
V_2 -> V_159 ++ ;
break;
...
break;
case V_255 :
V_199 . V_256 = V_192 -> V_204 . V_257 ;
V_199 . V_31 = V_2 -> V_19 . V_32 +
V_2 -> V_89 . V_258 ;
V_199 . V_259 = 0 ;
V_199 . V_260 = 0 ;
V_7 -> V_261 . V_262 = & V_199 ;
F_11 ( V_14 , V_213 ,
F_14 ( V_7 ) ) ;
break;
case V_263 :
...
V_2 -> V_19 . V_218 = V_2 -> V_19 . V_133 ;
error = F_118 ( & V_2 -> V_89 ) ;
V_200 = 0 ;
V_2 -> V_19 . V_218 = V_101 ;
break;
case V_275 :
F_92 ( V_2 , V_192 -> V_204 . error ) ;
break;
case V_276 :
F_93 ( V_14 , V_2 ,
V_192 -> V_204 . T_11 ) ;
...
break;
case V_279 :
V_2 -> V_19 . V_271 . V_272 = V_192 -> V_204 . V_208 ;
break;
case V_280 :
if ( ! V_2 -> V_89 . V_223 ) {
F_130 ( & V_2 -> V_89 ) ;
...
error = F_97 ( V_2 , V_192 -> V_204 . V_164 ) ;
break;
case V_281 :
F_99 ( V_2 ) ;
break;
