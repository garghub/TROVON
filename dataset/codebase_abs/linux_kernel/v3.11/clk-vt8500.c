...
static void F_32 ( unsigned long V_15 , unsigned long V_12 ,
T_1 * V_43 , T_1 * V_46 , T_1 * V_47 )
{
T_1 V_48 , V_49 , V_50 ;
T_1 V_51 , V_52 , V_53 ;
...
static int F_33 ( struct V_3 * V_4 , unsigned long V_15 ,
unsigned long V_12 )
{
struct V_58 * V_59 = F_34 ( V_4 ) ;
...
V_60 = F_36 ( V_48 , V_49 , V_50 ) ;
break;
case V_63 :
F_31 ( V_15 , V_12 , & V_57 , & V_48 , & V_49 , & V_50 ) ;
V_60 = F_37 ( V_57 , V_48 , V_49 , V_50 ) ;
break;
case V_64 :
F_32 ( V_15 , V_12 , & V_48 , & V_49 , & V_50 ) ;
V_60 = F_38 ( V_48 , V_49 , V_50 ) ;
break;
default:
F_15 ( L_12 , V_18 ) ;
return 0 ;
...
static long F_39 ( struct V_3 * V_4 , unsigned long V_15 ,
unsigned long * V_16 )
{
struct V_58 * V_59 = F_34 ( V_4 ) ;
T_1 V_57 , V_48 , V_49 , V_50 ;
...
V_66 = F_40 ( * V_16 , V_48 , V_49 ) ;
break;
case V_62 :
F_29 ( V_15 , * V_16 , & V_48 , & V_49 , & V_50 ) ;
V_66 = F_41 ( * V_16 , V_48 , V_49 , V_50 ) ;
break;
case V_63 :
F_31 ( V_15 , * V_16 , & V_57 , & V_48 , & V_49 , & V_50 ) ;
V_66 = F_42 ( * V_16 , V_48 , V_49 , V_50 ) ;
break;
case V_64 :
F_32 ( V_15 , * V_16 , & V_48 , & V_49 , & V_50 ) ;
V_66 = F_43 ( * V_16 , V_48 , V_49 , V_50 ) ;
break;
default:
V_66 = 0 ;
}
...
static T_2 void F_53 ( struct V_20 * V_21 , int V_68 )
{
T_1 V_65 ;
struct V_22 * V_22 ;
struct V_58 * V_69 ;
...
struct V_27 V_28 ;
int V_29 ;
V_29 = F_19 ( V_21 , L_13 , & V_65 ) ;
if ( F_18 ( V_29 ) )
return;
V_69 = F_17 ( sizeof( * V_69 ) , V_31 ) ;
if ( F_18 ( ! V_69 ) )
return;
V_69 -> V_65 = V_1 + V_65 ;
V_69 -> V_9 = & V_32 ;
...
static void T_2 F_54 ( struct V_20 * V_21 )
{
F_53 ( V_21 , V_61 ) ;
}
static void T_2 F_55 ( struct V_20 * V_21 )
{
F_53 ( V_21 , V_62 ) ;
}
static void T_2 F_56 ( struct V_20 * V_21 )
{
F_53 ( V_21 , V_63 ) ;
}
static void T_2 F_57 ( struct V_20 * V_21 )
{
F_53 ( V_21 , V_64 ) ;
}
void T_2 F_58 ( void T_3 * V_71 )
{
if ( ! V_71 )
return;
V_1 = V_71 ;
