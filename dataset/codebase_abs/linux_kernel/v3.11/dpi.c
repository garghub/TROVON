...
{
struct V_71 * V_73 = & V_49 . V_74 ;
int V_53 ;
F_29 ( & V_49 . V_75 ) ;
if ( F_30 ( V_76 ) && ! V_49 . V_77 ) {
F_31 ( L_3 ) ;
V_53 = - V_78 ;
goto V_79;
}
if ( V_73 == NULL || V_73 -> V_80 == NULL ) {
F_31 ( L_4 ) ;
V_53 = - V_78 ;
goto V_81;
}
...
void F_44 ( struct V_71 * V_72 )
{
struct V_57 * V_58 = V_49 . V_74 . V_80 ;
F_29 ( & V_49 . V_75 ) ;
F_45 ( V_58 ) ;
if ( V_49 . V_41 ) {
F_20 ( V_58 -> V_62 , V_19 ) ;
...
void F_51 ( struct V_71 * V_72 , int V_69 )
{
F_29 ( & V_49 . V_75 ) ;
V_49 . V_69 = V_69 ;
F_39 ( & V_49 . V_75 ) ;
...
static struct V_71 * F_60 ( struct V_1 * V_91 )
{
struct V_94 * V_95 = V_91 -> V_92 . V_96 ;
const char * V_97 = F_61 () ;
struct V_71 * V_98 ;
int V_50 ;
V_98 = NULL ;
for ( V_50 = 0 ; V_50 < V_95 -> V_99 ; ++ V_50 ) {
struct V_71 * V_72 = V_95 -> V_100 [ V_50 ] ;
if ( V_72 -> type != V_101 )
continue;
if ( V_98 == NULL )
V_98 = V_72 ;
if ( V_97 != NULL &&
strcmp ( V_72 -> V_102 , V_97 ) == 0 ) {
V_98 = V_72 ;
break;
}
}
...
static int F_62 ( struct V_1 * V_103 )
{
struct V_71 * V_104 ;
struct V_71 * V_72 ;
int V_53 ;
...
return V_53 ;
F_58 () ;
V_72 = F_63 ( & V_103 -> V_92 ) ;
if ( ! V_72 )
return - V_105 ;
F_64 ( V_72 , V_104 ) ;
V_53 = F_65 ( & V_49 . V_74 , V_72 ) ;
if ( V_53 ) {
F_31 ( L_10 ,
V_72 -> V_102 ) ;
F_66 ( V_72 ) ;
...
static void F_73 ( struct V_71 * V_72 ,
struct V_71 * V_106 )
{
F_5 ( V_106 != V_72 -> V_107 ) ;
if ( V_106 != V_72 -> V_107 )
return;
F_68 ( V_72 ) ;
if ( V_72 -> V_80 )
...
static void F_74 ( struct V_1 * V_91 )
{
struct V_71 * V_73 = & V_49 . V_74 ;
V_73 -> V_92 = & V_91 -> V_92 ;
V_73 -> V_62 = V_108 ;
...
V_73 -> V_102 = L_12 ;
V_73 -> V_93 = F_59 () ;
V_73 -> V_110 . V_49 = & V_111 ;
V_73 -> V_112 = V_113 ;
F_75 ( V_73 ) ;
}
static void T_1 F_76 ( struct V_1 * V_91 )
{
struct V_71 * V_73 = & V_49 . V_74 ;
F_77 ( V_73 ) ;
}
static int F_78 ( struct V_1 * V_91 )
{
int V_53 ;
V_49 . V_91 = V_91 ;
F_79 ( & V_49 . V_75 ) ;
...
static int T_1 F_80 ( struct V_1 * V_91 )
{
F_81 ( & V_91 -> V_92 ) ;
F_76 ( V_91 ) ;
return 0 ;
