...
T_1 V_40 ;
int V_56 ;
V_2 = F_43 ( V_42 , sizeof( struct V_1 ) , V_100 ) ;
if ( ! V_2 ) {
F_13 ( V_42 , L_10 ) ;
return - V_101 ;
}
...
if ( V_56 < 0 )
return V_56 ;
V_99 = F_44 ( V_94 , V_102 , 0 ) ;
V_2 -> V_5 = F_45 ( V_42 , V_99 ) ;
if ( F_46 ( V_2 -> V_5 ) )
return F_47 ( V_2 -> V_5 ) ;
V_2 -> V_69 = F_48 ( V_94 , 0 ) ;
F_49 ( & V_2 -> V_78 ) ;
F_50 ( & V_2 -> V_71 ) ;
V_81 = & V_2 -> V_81 ;
V_81 -> V_103 = V_94 -> V_104 ;
V_81 -> V_105 = & V_106 ;
V_81 -> V_107 = V_108 | V_109 ;
V_81 -> V_110 = 3 ;
V_81 -> V_42 . V_111 = V_42 ;
F_51 ( V_81 , V_2 ) ;
F_52 ( V_81 -> V_112 , V_94 -> V_112 , sizeof( V_81 -> V_112 ) ) ;
V_56 = F_53 ( V_42 , V_2 -> V_69 , F_26 , 0 ,
F_54 ( V_42 ) , V_2 ) ;
if ( V_56 < 0 ) {
F_13 ( V_42 , L_11 , V_2 -> V_69 ) ;
return V_56 ;
}
V_56 = F_55 ( V_81 ) ;
if ( V_56 < 0 ) {
