...
if ( ! V_296 )
return - V_298 ;
F_191 ( 0x00000002 , V_296 + V_299 ) ;
F_191 ( 0x00000005 , V_296 + V_300 ) ;
V_62 = F_192 ( V_296 + V_301 ) & 0xfffffffe ;
F_191 ( V_62 , V_296 + V_301 ) ;
V_297 = V_302 + F_193 ( V_303 ) ;
do {
V_62 = F_192 ( V_296 + V_304 ) ;
if ( ( V_62 & 0xb0000000 ) == 0 )
goto V_305;
F_186 ( 10 ) ;
} while ( F_194 ( V_302 , V_297 ) );
F_47 ( & V_2 -> V_2 , L_119 ) ;
V_305:
F_191 ( 0x00000002 , V_296 + V_306 ) ;
F_179 ( V_2 , V_296 ) ;
return 0 ;
}
int F_195 ( struct V_1 * V_2 , int V_286 )
{
const struct V_307 * V_143 ;
for ( V_143 = V_307 ; V_143 -> V_308 ; V_143 ++ ) {
if ( ( V_143 -> V_152 == V_2 -> V_152 ||
V_143 -> V_152 == ( T_2 ) V_255 ) &&
( V_143 -> V_78 == V_2 -> V_78 ||
V_143 -> V_78 == ( T_2 ) V_255 ) )
return V_143 -> V_308 ( V_2 , V_286 ) ;
}
return - V_289 ;
}
static struct V_1 * F_196 ( struct V_1 * V_2 )
{
if ( ! F_91 ( V_2 -> V_70 ) )
return F_197 ( V_2 ) ;
return F_129 ( V_2 -> V_71 , F_130 ( F_58 ( V_2 -> V_70 ) , 0 ) ) ;
}
struct V_1 * F_198 ( struct V_1 * V_2 )
{
const struct V_309 * V_143 ;
for ( V_143 = V_309 ; V_143 -> V_310 ; V_143 ++ ) {
if ( ( V_143 -> V_152 == V_2 -> V_152 ||
V_143 -> V_152 == ( T_2 ) V_255 ) &&
( V_143 -> V_78 == V_2 -> V_78 ||
V_143 -> V_78 == ( T_2 ) V_255 ) )
return V_143 -> V_310 ( V_2 ) ;
}
return F_197 ( V_2 ) ;
}
int F_199 ( struct V_1 * V_2 , T_2 V_311 )
{
const struct V_312 * V_143 ;
int V_313 ;
for ( V_143 = V_312 ; V_143 -> V_314 ; V_143 ++ ) {
if ( ( V_143 -> V_152 == V_2 -> V_152 ||
V_143 -> V_152 == ( T_2 ) V_255 ) &&
( V_143 -> V_78 == V_2 -> V_78 ||
V_143 -> V_78 == ( T_2 ) V_255 ) ) {
V_313 = V_143 -> V_314 ( V_2 , V_311 ) ;
if ( V_313 >= 0 )
return V_313 ;
}
}
