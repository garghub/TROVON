...
V_138 . V_143 = 0 ;
V_138 . V_144 = V_30 ;
V_32 = F_62 ( F_63 ( V_12 -> V_145 ) , & V_138 ,
V_12 -> V_146 ) ;
F_5 ( L_24 , V_8 , V_32 ) ;
if ( V_32 )
goto V_147;
...
F_5 ( L_29 , V_8 , V_150 -> V_156 ) ;
F_5 ( L_30 , V_8 , V_150 -> V_157 ) ;
F_5 ( L_31 , V_8 , V_150 -> V_158 ) ;
V_152 [ 0 ] = ( char * ) V_154 ;
V_152 [ 1 ] = L_32 ;
V_152 [ 2 ] = V_150 -> V_156 ;
V_152 [ 3 ] = L_33 ;
...
V_152 [ 6 ] = V_150 -> V_158 ;
V_152 [ 7 ] = NULL ;
V_153 = F_67 ( V_152 [ 0 ] , V_152 , V_151 , V_159 ) ;
if ( V_153 == - V_160 || V_153 == - V_155 ) {
F_56 ( V_126 L_35
L_36 ,
V_154 ) ;
V_154 [ 0 ] = '\0' ;
}
F_5 ( L_37 , V_8 , V_154 , V_153 ) ;
return V_153 ;
}
static void F_68 ( struct V_161 V_162 ,
char * V_163 , int V_164 ,
const char * V_165 )
{
if ( ! V_162 . V_24 )
return;
...
F_69 (
L_38 ,
V_165 , V_162 . V_24 , V_164 ) ;
V_162 . V_24 = V_164 - 1 ;
}
memcpy ( V_163 , V_162 . V_166 , V_162 . V_24 ) ;
}
static void F_70 ( struct V_161 V_162 ,
char V_167 [ V_168 ] )
{
int V_125 ;
char * V_169 ;
...
V_169 = V_167 ;
for ( V_125 = 0 ; V_125 < V_162 . V_24 ; V_125 ++ )
V_169 = F_71 ( V_169 , V_162 . V_166 [ V_125 ] ) ;
}
int F_72 ( struct V_133 * V_134 )
{
int V_171 ;
struct V_149 V_150 ;
if ( ! V_134 -> V_172 . V_173 . V_174 . V_24 )
return - V_175 ;
memset ( & V_150 , 0 , sizeof( V_150 ) ) ;
F_68 (
V_134 -> V_172 . V_173 . V_174 ,
V_150 . V_156 , sizeof( V_150 . V_156 ) , L_40 ) ;
F_68 (
V_134 -> V_176 ,
V_150 . V_157 , sizeof( V_150 . V_157 ) , L_41 ) ;
F_70 ( V_134 -> V_177 , V_150 . V_158 ) ;
V_171 = F_66 ( & V_150 ) ;
if ( V_171 > 0 )
V_171 = - V_175 ;
return V_171 ;
