...
T_6 V_104 ;
int V_105 ;
unsigned short V_7 = V_106 ;
int V_107 ;
V_47 = F_65 ( V_46 ) ;
if ( F_58 ( V_47 -> V_108 ) == V_72 ) {
V_103 = (struct V_102 * ) V_47 ;
V_7 = F_58 ( V_103 -> V_109 ) & V_73 ;
V_7 |= V_71 ;
V_104 = F_58 ( V_103 -> V_110 ) ;
V_105 = sizeof( * V_103 ) ;
} else {
V_104 = F_58 ( V_47 -> V_108 ) ;
V_105 = V_62 ;
}
if ( V_104 != V_58 )
return 0 ;
if ( F_43 ( ! F_66 ( V_46 , V_105 + F_67 ( V_46 -> V_111 ) ) ) )
return 0 ;
V_47 = F_65 ( V_46 ) ;
V_63 = (struct V_63 * ) ( ( T_2 * ) V_47 + V_105 ) ;
if ( V_63 -> V_112 != F_32 ( V_113 ) )
return 0 ;
if ( V_63 -> V_114 != F_32 ( V_115 ) )
return 0 ;
if ( V_63 -> V_116 != V_36 )
return 0 ;
if ( V_63 -> V_117 != 4 )
...
V_97 = V_52 + V_36 + 4 ;
V_98 = (struct V_53 * ) V_97 ;
V_107 = F_63 ( V_24 , V_49 , V_52 , V_97 ,
V_47 ) ;
if ( V_107 == 1 )
F_29 ( V_66 , V_24 ,
L_17 ,
...
static void F_68 ( struct V_23 * V_24 , int V_118 )
{
struct V_12 * V_19 ;
struct V_8 * V_37 ;
struct V_28 * V_29 ;
...
struct V_48 * V_49 ;
int V_38 ;
V_126 = F_5 ( V_125 , struct V_126 , V_125 ) ;
V_128 = F_5 ( V_126 , struct V_127 , V_125 ) ;
...
V_131 = V_79 - F_74 ( V_133 ) ;
for ( V_38 = 0 ; V_38 < V_134 ; V_38 ++ )
V_24 -> V_26 . V_135 [ V_38 ] . V_131 = V_131 ;
V_24 -> V_26 . V_136 = 0 ;
if ( V_24 -> V_26 . V_27 )
return 0 ;
...
& V_139 ) ;
F_29 ( V_66 , V_24 , L_22 ) ;
F_79 ( & V_24 -> V_26 . V_125 , F_72 ) ;
F_73 ( V_129 , & V_24 -> V_26 . V_125 ,
F_74 ( V_130 ) ) ;
return 0 ;
}
int F_80 ( struct V_23 * V_24 ,
struct V_45 * V_46 )
{
int V_38 , V_140 , V_107 = 0 ;
T_4 V_41 ;
struct V_141 * V_142 ;
struct V_143 * V_81 ;
V_142 = (struct V_141 * ) V_46 -> V_1 ;
V_41 = F_81 ( V_46 , ( V_144 * ) ( V_142 + 1 ) ) ;
F_22 ( & V_24 -> V_26 . V_132 ) ;
for ( V_38 = 0 ; V_38 < V_134 ; V_38 ++ ) {
V_140 = ( V_24 -> V_26 . V_136 + V_38 ) ;
V_140 %= V_134 ;
V_81 = & V_24 -> V_26 . V_135 [ V_140 ] ;
if ( F_69 ( V_81 -> V_131 ,
V_133 ) )
break;
if ( V_81 -> V_41 != V_41 )
continue;
if ( F_6 ( V_81 -> V_16 , V_142 -> V_16 ) )
continue;
V_107 = 1 ;
goto V_61;
}
V_140 = ( V_24 -> V_26 . V_136 + V_134 - 1 ) ;
V_140 %= V_134 ;
V_81 = & V_24 -> V_26 . V_135 [ V_140 ] ;
V_81 -> V_41 = V_41 ;
V_81 -> V_131 = V_79 ;
memcpy ( V_81 -> V_16 , V_142 -> V_16 , V_36 ) ;
V_24 -> V_26 . V_136 = V_140 ;
V_61:
F_25 ( & V_24 -> V_26 . V_132 ) ;
return V_107 ;
}
int F_82 ( struct V_23 * V_24 , T_2 * V_16 )
{
struct V_25 * V_5 = V_24 -> V_26 . V_33 ;
struct V_28 * V_29 ;
struct V_12 * V_19 ;
...
int F_83 ( struct V_45 * V_46 ,
struct V_82 * V_83 , int V_145 )
{
struct V_47 * V_47 ;
struct V_102 * V_103 ;
struct V_12 * V_19 ;
unsigned short V_7 = V_106 ;
if ( ! F_52 ( & V_83 -> V_24 -> V_123 ) )
return 0 ;
if ( ! F_66 ( V_46 , V_145 + V_62 ) )
return 0 ;
V_47 = (struct V_47 * ) ( ( ( T_2 * ) V_46 -> V_1 ) + V_145 ) ;
if ( F_58 ( V_47 -> V_108 ) == V_72 ) {
if ( ! F_66 ( V_46 , V_145 + sizeof( struct V_102 ) ) )
return 0 ;
V_103 = (struct V_102 * ) ( V_46 -> V_1 + V_145 ) ;
V_7 = F_58 ( V_103 -> V_109 ) & V_73 ;
V_7 |= V_71 ;
}
V_19 = F_20 ( V_83 -> V_24 ,
...
int F_87 ( struct V_23 * V_24 , struct V_45 * V_46 ,
unsigned short V_7 , bool V_146 )
{
struct V_47 * V_47 ;
...
int F_90 ( struct V_23 * V_24 , struct V_45 * V_46 ,
unsigned short V_7 )
{
struct V_47 * V_47 ;
struct V_3 V_92 , * V_4 = NULL ;
...
int F_91 ( struct V_149 * V_150 , void * V_151 )
{
struct V_50 * V_59 = (struct V_50 * ) V_150 -> V_152 ;
struct V_23 * V_24 = F_92 ( V_59 ) ;
struct V_25 * V_5 = V_24 -> V_26 . V_27 ;
struct V_3 * V_4 ;
struct V_48 * V_49 ;
struct V_28 * V_29 ;
...
int F_95 ( struct V_149 * V_150 , void * V_151 )
{
struct V_50 * V_59 = (struct V_50 * ) V_150 -> V_152 ;
struct V_23 * V_24 = F_92 ( V_59 ) ;
struct V_25 * V_5 = V_24 -> V_26 . V_33 ;
