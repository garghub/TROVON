...
static int
F_135 ( struct V_40 * V_56 , int V_104 , int V_100 )
{
struct V_40 * V_33 ;
struct V_22 * V_22 ;
int V_46 ;
...
struct V_40 * V_112 ;
V_112 = F_166 ( V_22 ) ;
if ( F_136 ( V_124 ) == V_22 -> V_46 && V_112 == V_124 ) {
goto V_105;
}
if ( ! V_112 )
goto V_105;
...
static void F_175 ( struct V_22 * V_22 , struct V_40 * V_129 )
{
if ( V_22 -> V_43 . V_32 . V_33 > V_129 -> V_63 )
F_174 ( V_22 ) ;
}
static void F_176 ( struct V_22 * V_22 )
{
F_173 ( V_22 ) ;
}
static void F_177 ( struct V_22 * V_22 , struct V_40 * V_56 )
{
if ( ! F_152 ( V_22 , V_56 ) &&
! F_145 ( V_22 -> V_33 ) &&
F_52 ( V_22 ) &&
...
static void F_178 ( struct V_40 * V_56 ,
...
static void F_181 ( struct V_22 * V_22 , struct V_40 * V_56 )
{
...
static void
F_186 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_133 )
{
if ( ! V_56 -> V_123 )
return;
if ( V_22 -> V_33 == V_56 ) {
...
V_134 = F_188 ( V_56 , V_136 ) ;
V_135 = F_189 ( V_56 , V_136 ) ;
if ( V_134 != V_137 ) {
unsigned long V_34 ;
...
V_34 = F_190 ( F_94 ( V_134 , V_135 ) , V_140 / V_141 ) ;
if ( V_56 -> V_43 . V_102 > V_34 )
V_56 -> V_142 . V_143 = V_56 -> V_89 . V_93 ;
}
}
static void F_191 ( struct V_22 * V_22 , struct V_40 * V_56 , int V_144 )
{
struct V_41 * V_42 = & V_56 -> V_43 ;
F_99 ( V_22 ) ;
F_187 ( V_22 , V_56 ) ;
...
static void F_193 ( struct V_22 * V_22 )
{
struct V_40 * V_56 = V_22 -> V_33 ;
V_56 -> V_89 . V_90 = F_100 ( V_22 ) ;
F_58 ( V_22 , V_56 ) ;
}
static unsigned int F_194 ( struct V_22 * V_22 , struct V_40 * V_112 )
{
...
void F_195 ( struct V_149 * V_150 , int V_46 )
{
T_4 V_74 ;
struct V_21 * V_21 ;
F_137 () ;
F_87 (rt_rq, iter, cpu_rq(cpu))
F_196 ( V_150 , V_46 , V_21 ) ;
F_141 () ;
}
