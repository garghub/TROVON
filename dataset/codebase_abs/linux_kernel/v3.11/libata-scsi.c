...
static int F_162 ( struct V_135 * V_136 ,
...
return - V_17 ;
V_412 = V_5 [ 0 ] & ( 1 << 2 ) ;
F_129 ( V_2 -> V_89 , V_410 , false ) ;
V_410 [ 2 ] &= ~ ( 1 << 2 ) ;
V_410 [ 2 ] |= V_412 ;
if ( memcmp ( V_410 + 2 , V_5 , V_411 - 2 ) != 0 )
return - V_17 ;
V_149 -> V_13 |= V_226 | V_227 ;
V_149 -> V_228 = V_229 ;
V_149 -> V_177 = 0 ;
V_149 -> V_151 = V_404 ;
V_149 -> V_153 = V_412 ? V_413 : V_414 ;
return 0 ;
}
static unsigned int F_163 ( struct V_135 * V_136 )
{
struct V_52 * V_143 = V_136 -> V_137 ;
const T_3 * V_222 = V_143 -> V_223 ;
const T_3 * V_320 ;
T_3 V_322 , V_323 ;
unsigned V_326 , V_415 , V_416 , V_417 ;
int V_42 ;
F_91 ( L_31 ) ;
V_326 = ( V_222 [ 0 ] == V_418 ) ;
if ( V_326 ) {
...
goto V_225;
if ( ! F_52 ( V_143 ) || F_51 ( V_143 ) -> V_419 < V_42 )
goto V_420;
...
static inline int F_168 ( struct V_52 * V_143 ,
struct V_25 * V_2 )
{
T_3 V_426 = V_143 -> V_223 [ 0 ] ;
T_9 V_275 ;
int V_29 = 0 ;
if ( V_2 -> V_46 == V_47 ) {
if ( F_17 ( ! V_143 -> V_224 || V_143 -> V_224 > V_2 -> V_345 ) )
goto V_427;
V_275 = F_164 ( V_2 , V_426 ) ;
} else {
if ( F_17 ( ! V_143 -> V_224 ) )
goto V_427;
V_275 = NULL ;
if ( F_63 ( ( V_426 != V_114 ) || ! V_428 ) ) {
int V_42 = F_169 ( V_426 ) ;
...
int F_173 ( struct V_443 * V_30 , struct V_444 * V_445 )
{
int V_159 , V_29 ;
for ( V_159 = 0 ; V_159 < V_30 -> V_446 ; V_159 ++ ) {
struct V_9 * V_10 = V_30 -> V_447 [ V_159 ] ;
struct V_7 * V_8 ;
V_29 = - V_109 ;
V_8 = F_174 ( V_445 , sizeof( struct V_9 * ) ) ;
if ( ! V_8 )
goto V_448;
V_8 -> V_449 = 1 ;
* (struct V_9 * * ) & V_8 -> V_450 [ 0 ] = V_10 ;
V_10 -> V_451 = V_8 ;
V_8 -> V_452 = V_453 ;
V_8 -> V_454 = V_10 -> V_176 ;
V_8 -> V_455 = 16 ;
V_8 -> V_456 = 1 ;
V_8 -> V_457 = 1 ;
V_8 -> V_458 = 16 ;
V_8 -> V_459 = 1 ;
V_29 = F_175 ( V_10 -> V_451 ,
& V_10 -> V_460 , V_10 -> V_30 -> V_2 ) ;
if ( V_29 )
goto V_461;
}
return 0 ;
V_461:
F_176 ( V_30 -> V_447 [ V_159 ] -> V_451 ) ;
V_448:
while ( -- V_159 >= 0 ) {
struct V_7 * V_8 = V_30 -> V_447 [ V_159 ] -> V_451 ;
F_177 ( V_8 ) ;
F_176 ( V_8 ) ;
}
return V_29 ;
}
void F_178 ( struct V_9 * V_10 , int V_462 )
{
int V_463 = 5 ;
struct V_25 * V_464 = NULL ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
V_465:
F_179 (link, ap, EDGE) {
...
V_362 = V_24 -> V_466 ;
V_22 = F_182 ( V_10 -> V_451 , V_362 , V_89 , 0 ,
NULL ) ;
if ( ! F_183 ( V_22 ) ) {
V_2 -> V_22 = V_22 ;
F_184 ( V_22 ) ;
...
F_189 ( V_469 , & V_10 -> V_470 ,
F_190 ( V_116 ) ) ;
}
int F_191 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 ) {
F_192 ( V_2 -> V_22 , V_471 ) ;
return 1 ;
}
return 0 ;
}
static void F_193 ( struct V_25 * V_2 )
{
struct V_9 * V_10 = V_2 -> V_24 -> V_10 ;
struct V_21 * V_22 ;
unsigned long V_13 ;
F_194 ( & V_10 -> V_451 -> V_472 ) ;
F_5 ( V_10 -> V_18 , V_13 ) ;
if ( F_185 ( V_2 ) )
F_195 ( V_2 ) ;
V_22 = V_2 -> V_22 ;
...
static void F_202 ( struct V_23 * V_24 )
{
...
void F_205 ( struct V_475 * V_476 )
{
struct V_9 * V_10 =
F_206 ( V_476 , struct V_9 , V_470 . V_476 ) ;
int V_159 ;
if ( V_10 -> V_36 & V_477 ) {
F_97 ( L_51 ) ;
return;
...
F_202 ( & V_10 -> V_24 ) ;
if ( V_10 -> V_361 )
for ( V_159 = 0 ; V_159 < V_479 ; V_159 ++ )
F_202 ( & V_10 -> V_361 [ V_159 ] ) ;
F_178 ( V_10 , 0 ) ;
F_198 ( & V_10 -> V_478 ) ;
F_97 ( L_33 ) ;
}
...
if ( ! V_10 -> V_61 -> V_171 )
return - V_34 ;
if ( V_363 != V_480 && V_363 )
return - V_17 ;
if ( ! F_153 ( V_10 ) ) {
if ( V_362 != V_480 && V_362 )
return - V_17 ;
V_40 = V_89 ;
} else {
if ( V_89 != V_480 && V_89 )
...
if ( V_2 ) {
struct V_481 * V_482 = & V_2 -> V_24 -> V_48 ;
V_482 -> V_483 |= 1 << V_2 -> V_40 ;
V_482 -> V_84 |= V_85 ;
} else
V_29 = - V_17 ;
}
...
void F_208 ( struct V_475 * V_476 )
{
struct V_9 * V_10 =
F_206 ( V_476 , struct V_9 , V_485 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_194 ( & V_10 -> V_478 ) ;
...
struct V_9 * F_210 ( struct V_443 * V_30 ,
struct V_486 * V_487 ,
struct V_7 * V_8 )
{
struct V_9 * V_10 ;
...
V_10 -> V_488 = 0 ;
V_10 -> V_18 = & V_30 -> V_18 ;
V_10 -> V_489 = V_487 -> V_489 ;
V_10 -> V_490 = V_487 -> V_490 ;
V_10 -> V_491 = V_487 -> V_491 ;
V_10 -> V_13 |= V_487 -> V_13 ;
V_10 -> V_61 = V_487 -> V_492 ;
V_10 -> V_493 = V_494 ;
return V_10 ;
}
...
{
int V_29 = V_10 -> V_61 -> V_496 ( V_10 ) ;
if ( V_29 )
return V_29 ;
V_10 -> V_176 = F_219 ( & V_497 ) ;
return 0 ;
}
void F_220 ( struct V_9 * V_10 )
{
if ( V_10 -> V_61 -> V_498 )
V_10 -> V_61 -> V_498 ( V_10 ) ;
F_43 ( V_10 ) ;
}
