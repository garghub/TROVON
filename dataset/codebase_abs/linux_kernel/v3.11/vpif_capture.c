...
{
F_113 ( & V_83 . V_259 , 0 , V_202 , V_260 ) ;
return 0 ;
}
...
static T_6 int F_115 ( struct V_271 * V_272 )
{
struct V_179 * V_273 ;
struct V_53 * V_91 ;
int V_86 , V_262 , V_274 , V_261 ;
int V_275 = 0 ;
struct V_276 * V_277 ;
struct V_7 * V_8 ;
struct V_10 * V_11 ;
...
V_261 = F_114 () ;
if ( V_261 ) {
F_116 ( V_55 -> V_216 , L_76 ) ;
return V_261 ;
}
V_261 = F_117 ( V_55 , & V_83 . V_259 ) ;
if ( V_261 ) {
F_116 ( V_55 -> V_216 , L_77 ) ;
return V_261 ;
}
while ( ( V_137 = F_118 ( V_272 , V_280 , V_275 ) ) ) {
V_261 = F_119 ( & V_272 -> V_82 , V_137 -> V_281 , F_45 ,
V_282 , L_78 ,
( void * ) ( & V_83 . V_82 [ V_275 ] ->
V_38 ) ) ;
if ( V_261 ) {
V_261 = - V_26 ;
goto V_283;
...
* V_278 = V_284 ;
V_278 -> V_259 = & V_83 . V_259 ;
V_278 -> V_285 = F_121 ;
snprintf ( V_278 -> V_184 , sizeof( V_278 -> V_184 ) ,
L_79 ,
V_286 ) ;
V_8 -> V_196 = V_278 ;
}
V_137 = F_118 ( V_272 , V_287 , 0 ) ;
if ( V_137 ) {
V_33 = F_122 ( V_137 ) ;
...
F_128 ( & V_8 -> V_145 ) ;
F_129 ( V_8 -> V_196 , V_8 ) ;
V_261 = F_88 ( V_91 , V_8 , 0 ) ;
if ( V_261 )
goto V_291;
V_261 = F_130 ( V_8 -> V_196 ,
V_292 , ( V_262 ? 1 : 0 ) ) ;
if ( V_261 )
goto V_291;
}
F_125 ( & V_83 . V_259 , L_83 ) ;
return 0 ;
V_291:
for ( V_274 = 0 ; V_274 < V_262 ; V_274 ++ ) {
V_8 = V_83 . V_82 [ V_274 ] ;
F_131 ( V_8 -> V_196 ) ;
}
V_290:
...
static int F_133 ( struct V_271 * V_293 )
{
struct V_7 * V_8 ;
int V_86 ;
F_132 ( & V_83 . V_259 ) ;
...
static int F_134 ( struct V_293 * V_82 )
{
struct V_10 * V_11 ;
struct V_7 * V_8 ;
int V_86 ;
...
static int F_135 ( struct V_293 * V_82 )
{
struct V_10 * V_11 ;
struct V_7 * V_8 ;
int V_86 ;
