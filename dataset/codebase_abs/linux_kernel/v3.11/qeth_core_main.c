...
return - V_703 ;
V_700 = F_343 ( V_698 , V_701 + sizeof( struct V_704 ) ) ;
if ( F_109 ( V_700 ) ) {
F_3 ( V_4 , 2 , L_296 ) ;
return F_110 ( V_700 ) ;
}
...
F_3 ( V_4 , 3 , L_298 ) ;
V_129 = (struct V_128 * ) V_116 ;
V_708 = (struct V_707 * ) V_124 -> V_383 ;
V_710 = V_129 -> V_116 . V_462 . V_132 . V_470 ;
V_709 = ( char * ) V_116 + 28 ;
if ( V_710 > ( V_708 -> V_711 - V_708 -> V_712 ) ) {
V_129 -> V_132 . V_138 = V_713 ;
return 0 ;
}
memcpy ( ( V_708 -> V_74 + V_708 -> V_712 ) , V_709 ,
V_710 ) ;
V_708 -> V_712 += V_710 ;
if ( V_129 -> V_116 . V_462 . V_132 . V_473 <
V_129 -> V_116 . V_462 . V_132 . V_472 )
...
if ( F_342 ( & V_717 , V_698 ,
sizeof( struct V_716 ) ) ) {
V_34 = - V_703 ;
goto V_68;
}
V_708 . V_711 = V_717 . V_711 ;
V_708 . V_712 = 0 ;
V_708 . V_74 = F_26 ( V_717 . V_711 , V_46 ) ;
if ( ! V_708 . V_74 ) {
V_34 = - V_47 ;
goto V_68;
}
V_112 = F_268 ( V_4 , V_718 ,
sizeof( struct V_646 ) +
sizeof( struct V_714 ) ) ;
V_129 = (struct V_128 * ) ( V_112 -> V_116 + V_387 ) ;
V_715 = & V_129 -> V_116 . V_462 . V_116 . V_719 ;
V_715 -> V_634 = V_717 . V_133 ;
V_34 = F_264 ( V_4 , V_112 , F_345 ,
& V_708 ) ;
if ( ! V_34 ) {
if ( F_347 () )
V_38 = F_348 ( V_717 . V_40 ) ;
else
V_38 = ( void T_4 * ) ( unsigned long ) V_717 . V_40 ;
if ( F_344 ( V_38 , V_708 . V_74 ,
V_708 . V_712 ) ) {
V_34 = - V_703 ;
goto V_720;
}
V_717 . V_712 = V_708 . V_712 ;
if ( F_344 ( V_698 , & V_717 ,
sizeof( struct V_716 ) ) )
V_34 = - V_703 ;
} else
if ( V_34 == V_713 )
...
F_164 ( V_4 , V_345 ) ;
F_31 ( V_345 ) ;
V_34 = F_352 ( V_721 , & V_4 -> V_725 ) ;
if ( V_34 )
F_38 ( V_60 , 2 , L_188 , V_34 ) ;
F_38 ( V_60 , 2 , L_302 , V_4 -> V_725 . V_726 ) ;
F_38 ( V_60 , 2 , L_303 , V_4 -> V_725 . V_727 ) ;
F_38 ( V_60 , 2 , L_303 , V_4 -> V_725 . V_728 ) ;
F_38 ( V_60 , 2 , L_304 , V_4 -> V_725 . V_729 ) ;
if ( ! ( ( V_4 -> V_725 . V_726 != V_730 ) ||
( ( V_4 -> V_725 . V_727 & V_731 ) == 0 ) ||
( ( V_4 -> V_725 . V_728 & V_732 ) == 0 ) ) ) {
F_83 ( & V_4 -> V_7 -> V_6 ,
L_305 ) ;
} else {
V_4 -> V_57 . V_58 = V_550 ;
...
F_355 [ V_41 ] = V_4 -> V_281 -> V_742 ;
F_354 ( V_4 , V_733 , F_355 ) ;
V_737 =
...
for ( V_41 = 0 , V_738 = 0 ; V_41 < V_4 -> V_43 . V_76 ; ++ V_41 )
for ( V_42 = 0 ; V_42 < V_63 ; ++ V_42 , ++ V_738 ) {
V_737 [ V_738 ] = (struct V_64 * ) F_302 (
V_4 -> V_43 . V_78 [ V_41 ] -> V_73 [ V_42 ] -> V_74 ) ;
}
memset ( & V_735 , 0 , sizeof( struct V_734 ) ) ;
V_735 . V_186 = F_37 ( V_4 ) ;
V_735 . V_744 = F_349 ( V_4 ) ;
V_735 . V_745 = 0 ;
V_735 . V_736 = V_736 ;
V_735 . V_746 = V_4 -> V_43 . V_67 ;
V_735 . V_747 = V_4 -> V_43 . V_76 ;
V_735 . V_748 = V_4 -> V_281 -> V_748 ;
V_735 . V_749 = V_4 -> V_281 -> V_749 ;
V_735 . V_750 = F_355 ;
V_735 . V_751 = ( unsigned long ) V_4 ;
V_735 . V_752 = ( void * * ) V_733 ;
V_735 . V_753 = ( void * * ) V_737 ;
V_735 . V_754 = V_4 -> V_43 . V_75 ;
V_735 . V_755 =
...
static inline int F_364 ( struct V_439 * V_760 ,
struct V_761 * V_238 ,
struct V_225 * * V_762 , int V_175 , int * V_763 , int V_582 )
{
...
* V_762 = F_256 ( V_440 + V_441 ) ;
if ( ! ( * V_762 ) )
return - V_47 ;
}
F_365 ( * V_762 , V_441 ) ;
if ( V_582 <= V_440 ) {
memcpy ( F_366 ( * V_762 , V_582 ) , V_238 -> V_243 + V_175 ,
V_582 ) ;
} else {
F_367 ( V_435 ) ;
memcpy ( F_366 ( * V_762 , V_440 ) ,
V_238 -> V_243 + V_175 , V_440 ) ;
F_368 ( * V_762 , * V_763 , V_435 ,
V_175 + V_440 ,
V_582 - V_440 ) ;
( * V_762 ) -> V_582 += V_582 - V_440 ;
( * V_762 ) -> V_154 += V_582 - V_440 ;
( * V_762 ) -> V_764 += V_582 - V_440 ;
( * V_763 ) ++ ;
}
} else {
F_367 ( V_435 ) ;
F_368 ( * V_762 , * V_763 , V_435 , V_175 , V_582 ) ;
( * V_762 ) -> V_582 += V_582 ;
( * V_762 ) -> V_154 += V_582 ;
( * V_762 ) -> V_764 += V_582 ;
( * V_763 ) ++ ;
...
struct V_439 * V_760 ,
struct V_761 * * V_765 , int * V_766 ,
struct V_584 * * V_132 )
{
struct V_761 * V_238 = * V_765 ;
struct V_64 * V_74 = V_760 -> V_74 ;
int V_175 = * V_766 ;
...
switch ( ( * V_132 ) -> V_132 . V_771 . V_313 ) {
case V_772 :
V_767 = ( * V_132 ) -> V_132 . V_771 . V_773 ;
break;
case V_774 :
V_767 = ( * V_132 ) -> V_132 . V_599 . V_246 ;
V_769 = V_441 ;
break;
case V_775 :
V_767 = ( * V_132 ) -> V_132 . V_776 . V_777 ;
V_769 = sizeof( struct V_584 ) ;
break;
default:
break;
}
if ( ! V_767 )
return NULL ;
if ( ( ( V_767 >= V_4 -> V_57 . V_274 ) &&
( ! ( V_4 -> V_9 . type == V_15 ) ) &&
( ! F_45 ( & V_4 -> V_517 ) ) ) ||
( V_4 -> V_57 . V_58 == V_59 ) ) {
V_770 = 1 ;
} else {
V_226 = F_256 ( V_767 + V_769 ) ;
if ( ! V_226 )
goto V_778;
if ( V_769 )
F_365 ( V_226 , V_769 ) ;
}
V_768 = V_238 -> V_243 + V_175 ;
while ( V_767 ) {
V_582 = F_208 ( V_767 , ( int ) ( V_238 -> V_246 - V_175 ) ) ;
if ( V_582 ) {
if ( V_770 ) {
if ( F_364 ( V_760 , V_238 ,
& V_226 , V_175 , & V_575 , V_582 ) )
goto V_778;
} else {
memcpy ( F_366 ( V_226 , V_582 ) , V_768 ,
V_582 ) ;
}
}
V_767 -= V_582 ;
...
* V_765 = V_238 ;
* V_766 = V_175 ;
if ( V_770 && V_4 -> V_57 . V_273 ) {
V_4 -> V_437 . V_779 ++ ;
V_4 -> V_437 . V_780 += F_307 ( V_226 ) -> V_576 ;
}
return V_226 ;
V_778:
if ( F_372 () ) {
...
{
int V_781 ;
for ( V_781 = 0 ; V_781 < V_782 ; V_781 ++ ) {
F_374 ( V_783 [ V_781 ] . V_313 ) ;
V_783 [ V_781 ] . V_313 = NULL ;
}
}
void F_375 ( T_5 * V_313 , int V_372 , char * V_784 , ... )
{
char V_785 [ 32 ] ;
T_6 args ;
...
return;
va_start ( args , V_784 ) ;
vsnprintf ( V_785 , sizeof( V_785 ) , V_784 , args ) ;
va_end ( args ) ;
F_376 ( V_313 , V_372 , V_785 ) ;
}
...
int V_781 ;
for ( V_781 = 0 ; V_781 < V_782 ; V_781 ++ ) {
V_783 [ V_781 ] . V_313 = F_378 ( V_783 [ V_781 ] . V_501 ,
V_783 [ V_781 ] . V_786 ,
V_783 [ V_781 ] . V_787 ,
V_783 [ V_781 ] . V_154 ) ;
if ( V_783 [ V_781 ] . V_313 == NULL ) {
F_373 () ;
return - V_47 ;
}
V_337 = F_379 ( V_783 [ V_781 ] . V_313 , V_783 [ V_781 ] . V_788 ) ;
if ( V_337 ) {
F_373 () ;
return V_337 ;
}
F_380 ( V_783 [ V_781 ] . V_313 , V_783 [ V_781 ] . V_372 ) ;
}
return 0 ;
}
...
{
struct V_795 * V_799 ;
V_4 -> V_800 = F_378 ( V_501 , 2 , 1 , 8 ) ;
if ( ! V_4 -> V_800 ) {
F_38 ( V_60 , 2 , L_191 , L_324 ) ;
goto V_801;
}
if ( F_379 ( V_4 -> V_800 , & V_802 ) )
goto V_803;
V_799 = F_26 ( sizeof( struct V_795 ) , V_46 ) ;
if ( ! V_799 )
goto V_803;
strncpy ( V_799 -> V_797 , V_501 , V_804 ) ;
V_799 -> V_798 = V_4 -> V_800 ;
F_382 ( & V_796 ) ;
F_32 ( & V_799 -> V_805 , & V_806 ) ;
F_385 ( & V_796 ) ;
return 0 ;
V_803:
F_374 ( V_4 -> V_800 ) ;
...
static int F_391 ( struct V_807 * V_7 )
{
struct V_3 * V_4 ;
struct V_808 * V_6 ;
int V_34 ;
...
snprintf ( V_797 , sizeof( V_797 ) , L_326 ,
F_63 ( & V_7 -> V_6 ) ) ;
V_4 -> V_800 = F_388 ( V_797 ) ;
if ( ! V_4 -> V_800 ) {
V_34 = F_389 ( V_4 , V_797 ) ;
if ( V_34 )
goto V_811;
}
...
F_393 ( & V_7 -> V_6 , V_4 ) ;
V_4 -> V_7 = V_7 ;
V_7 -> V_186 [ 0 ] -> V_812 = F_111 ;
V_7 -> V_186 [ 1 ] -> V_812 = F_111 ;
V_7 -> V_186 [ 2 ] -> V_812 = F_111 ;
V_34 = F_146 ( V_4 ) ;
if ( V_34 ) {
F_38 ( V_60 , 2 , L_141 , V_34 ) ;
goto V_811;
...
case V_15 :
case V_13 :
V_34 = F_381 ( V_4 , V_793 ) ;
if ( V_34 )
goto V_811;
V_34 = V_4 -> V_281 -> V_815 ( V_4 -> V_7 ) ;
if ( V_34 )
goto V_816;
case V_11 :
case V_14 :
...
F_394 ( & V_817 . V_818 , V_29 ) ;
F_95 ( & V_4 -> V_39 , & V_817 . V_39 ) ;
F_395 ( & V_817 . V_818 , V_29 ) ;
F_350 ( V_4 ) ;
return 0 ;
V_816:
F_386 ( V_4 ) ;
...
static void F_397 ( struct V_807 * V_7 )
{
unsigned long V_29 ;
...
static int F_399 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
int V_34 = 0 ;
int V_819 ;
...
V_34 = V_4 -> V_281 -> V_820 ( V_7 ) ;
V_801:
return V_34 ;
}
static int F_400 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
return V_4 -> V_281 -> V_821 ( V_7 ) ;
}
static void F_401 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
if ( V_4 -> V_281 && V_4 -> V_281 -> V_822 )
V_4 -> V_281 -> V_822 ( V_7 ) ;
}
static int F_402 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
if ( V_4 -> V_281 && V_4 -> V_281 -> V_823 )
return V_4 -> V_281 -> V_823 ( V_7 ) ;
return 0 ;
}
static void F_403 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
if ( V_4 -> V_281 && V_4 -> V_281 -> V_824 )
V_4 -> V_281 -> V_824 ( V_7 ) ;
}
static int F_404 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
...
static int F_405 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
...
static int F_406 ( struct V_807 * V_7 )
{
struct V_3 * V_4 = F_398 ( & V_7 -> V_6 ) ;
...
static T_7 F_407 ( struct V_828 * V_829 ,
const char * V_224 , T_8 V_158 )
{
int V_801 ;
V_801 = F_408 ( V_830 ,
& V_831 , 3 , V_224 ) ;
return V_801 ? V_801 : V_158 ;
}
int F_409 ( struct V_612 * V_6 , int V_832 )
{
switch ( V_832 ) {
case V_833 :
return ( sizeof( V_834 ) / V_835 ) ;
default:
return - V_402 ;
}
}
void F_410 ( struct V_612 * V_6 ,
struct V_836 * V_512 , T_9 * V_116 )
{
struct V_3 * V_4 = V_6 -> V_617 ;
V_116 [ 0 ] = V_4 -> V_512 . V_837 -
V_4 -> V_437 . V_838 ;
V_116 [ 1 ] = V_4 -> V_437 . V_839 ;
V_116 [ 2 ] = V_4 -> V_512 . V_840 -
V_4 -> V_437 . V_841 ;
V_116 [ 3 ] = V_4 -> V_437 . V_541 ;
V_116 [ 4 ] = V_4 -> V_512 . V_840 - V_4 -> V_437 . V_841
- V_4 -> V_437 . V_603 ;
V_116 [ 5 ] = V_4 -> V_437 . V_541 - V_4 -> V_437 . V_545 ;
V_116 [ 6 ] = V_4 -> V_437 . V_603 ;
V_116 [ 7 ] = V_4 -> V_437 . V_545 ;
V_116 [ 8 ] = V_4 -> V_437 . V_842 ;
V_116 [ 9 ] = V_4 -> V_437 . V_843 ;
V_116 [ 10 ] = V_4 -> V_437 . V_779 ;
V_116 [ 11 ] = V_4 -> V_437 . V_780 ;
V_116 [ 12 ] = V_4 -> V_437 . V_438 ;
V_116 [ 13 ] = ( V_4 -> V_437 . V_844 >> 10 ) ;
V_116 [ 14 ] = V_4 -> V_437 . V_845 ;
...
V_116 [ 23 ] = V_4 -> V_437 . V_846 ;
V_116 [ 24 ] = V_4 -> V_437 . V_847 ;
V_116 [ 25 ] = V_4 -> V_437 . V_521 ;
V_116 [ 26 ] = V_4 -> V_437 . V_519 ;
V_116 [ 27 ] = V_4 -> V_437 . V_564 ;
V_116 [ 28 ] = V_4 -> V_437 . V_560 ;
V_116 [ 29 ] = V_4 -> V_437 . V_848 ;
V_116 [ 30 ] = V_4 -> V_437 . V_849 ;
V_116 [ 31 ] = V_4 -> V_437 . V_538 ;
V_116 [ 32 ] = V_4 -> V_437 . V_534 ;
V_116 [ 33 ] = V_4 -> V_437 . V_850 ;
V_116 [ 34 ] = V_4 -> V_437 . V_851 ;
V_116 [ 35 ] = V_4 -> V_437 . V_552 ;
V_116 [ 36 ] = V_4 -> V_437 . V_556 ;
}
void F_411 ( struct V_612 * V_6 , V_688 V_832 , T_3 * V_116 )
{
switch ( V_832 ) {
case V_833 :
memcpy ( V_116 , & V_834 ,
...
void F_412 ( struct V_612 * V_6 ,
struct V_852 * V_9 )
{
struct V_3 * V_4 = V_6 -> V_617 ;
F_413 ( V_9 -> V_853 , V_4 -> V_57 . V_306 ? L_321 : L_320 ,
sizeof( V_9 -> V_853 ) ) ;
F_413 ( V_9 -> V_854 , L_328 , sizeof( V_9 -> V_854 ) ) ;
F_413 ( V_9 -> V_855 , V_4 -> V_9 . V_301 ,
sizeof( V_9 -> V_855 ) ) ;
snprintf ( V_9 -> V_856 , sizeof( V_9 -> V_856 ) , L_329 ,
F_414 ( V_4 ) , F_415 ( V_4 ) , F_416 ( V_4 ) ) ;
}
int F_417 ( struct V_612 * V_857 ,
struct V_858 * V_859 )
{
struct V_3 * V_4 = V_857 -> V_617 ;
enum V_447 V_16 ;
