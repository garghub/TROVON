...
V_409 -> V_423 = V_384 + 1 ;
V_409 -> V_424 = 0 ;
V_409 -> V_425 = V_383 -> V_426 ;
V_409 -> V_427 = V_383 -> V_428 ;
for ( V_352 = 0 ; V_352 < V_383 -> V_385 ; V_352 ++ ) {
const struct V_394 * V_395 = V_383 -> V_386 + V_352 ;
struct V_392 * V_393 ;
int V_429 ;
int V_148 ;
V_429 = sizeof( struct V_392 ) ;
if ( V_395 -> V_148 == V_151 ) {
V_405 = F_57 ( V_395 -> V_406 ) ;
V_429 += V_405 * 2 ;
} else {
...
V_307 = (struct V_58 * ) V_348 -> V_61 ;
V_307 -> V_319 = V_29 ;
if ( V_345 -> V_61 . V_432 && V_345 -> V_328 == V_329 )
V_307 -> V_320 = V_433 ;
else
...
return - V_71 ;
if ( ! V_409 -> V_423 || V_409 -> V_423 >= V_434 )
return - V_71 ;
...
V_383 -> V_412 . V_437 = F_152 ( 0xffff ) ;
V_90 = V_108 [ V_123 - 1 ] ;
if ( V_90 != NULL ) {
struct V_94 * V_95 = F_49 ( V_90 ) ;
if ( ! V_95 ) {
...
V_383 -> V_229 . V_239 = V_438 ;
V_383 -> V_229 . V_232 = V_438 ;
V_383 -> V_229 . V_238 = V_438 ;
V_383 -> V_229 . V_230 = V_438 ;
...
if ( V_183 . V_414 )
V_183 . V_437 = F_152 ( 0xffff ) ;
V_90 = V_108 [ V_123 - 1 ] ;
if ( V_90 != NULL ) {
struct V_94 * V_95 = F_49 ( V_90 ) ;
if ( ! V_95 )
return - V_31 ;
V_23 = F_153 ( & V_441 , V_95 ) ;
F_81 ( V_95 ) ;
if ( V_23 )
return V_23 ;
}
V_383 = F_160 ( V_10 , V_146 , V_391 ,
V_409 -> V_423 - 1 , & V_183 , V_441 ,
1 , & V_23 ) ;
F_161 ( V_441 ) ;
if ( V_383 == NULL )
return - V_315 ;
...
static int F_167 ( struct V_392 * V_443 , int V_47 ,
struct V_444 * V_445 )
{
int V_23 ;
struct V_392 * V_446 ;
...
V_47 < V_443 -> V_411 )
return - V_71 ;
V_23 = F_166 ( (struct V_78 * ) ( V_443 + 1 ) ,
V_443 -> V_411 ,
& V_445 -> V_447 , & V_445 -> V_448 ,
& V_445 -> V_449 ) ;
if ( V_23 )
return V_23 ;
V_446 = (struct V_392 * ) ( ( T_7 * ) V_443 + V_443 -> V_411 ) ;
V_47 -= V_443 -> V_411 ;
if ( V_47 <= sizeof( struct V_392 ) ||
V_47 < V_446 -> V_411 )
return - V_71 ;
V_23 = F_166 ( (struct V_78 * ) ( V_446 + 1 ) ,
V_446 -> V_411 ,
& V_445 -> V_450 , & V_445 -> V_451 ,
& V_445 -> V_452 ) ;
if ( V_23 )
return V_23 ;
if ( V_443 -> V_399 != V_446 -> V_399 ||
V_443 -> V_398 != V_446 -> V_398 ||
V_443 -> V_404 != V_446 -> V_404 )
return - V_71 ;
V_445 -> V_133 = V_443 -> V_399 ;
if ( ( V_148 = F_65 ( V_443 -> V_398 ) ) < 0 )
return - V_71 ;
V_445 -> V_148 = V_148 ;
V_445 -> V_269 = V_443 -> V_404 ;
return ( ( int ) ( V_443 -> V_411 +
V_446 -> V_411 ) ) ;
}
static int F_168 ( struct V_2 * V_3 , struct V_41 * V_8 ,
const struct V_58 * V_59 , void * const * V_108 )
{
int V_352 , V_47 , V_453 , V_23 = - V_71 ;
T_7 V_384 ;
struct V_76 * V_135 ;
struct V_454 * V_455 ;
struct V_408 * V_409 ;
...
V_455 = V_108 [ V_458 - 1 ] ;
V_409 = V_108 [ V_416 - 1 ] ;
if ( V_409 -> V_423 >= V_434 ) {
V_23 = - V_71 ;
goto V_35;
}
if ( V_455 ) {
V_457 . V_459 = V_455 -> V_460 ;
V_453 = F_166 ( (struct V_78 * ) ( V_455 + 1 ) ,
8 * ( V_455 -> V_461 ) - sizeof( * V_455 ) ,
& V_457 . V_462 , & V_457 . V_463 , & V_457 . V_134 ) ;
if ( V_453 < 0 ) {
V_23 = V_453 ;
goto V_35;
}
...
V_453 = F_167 ( V_393 , V_47 , & V_445 [ V_352 ] ) ;
if ( V_453 < 0 ) {
V_23 = V_453 ;
goto V_35;
} else {
V_393 = (struct V_392 * ) ( ( T_7 * ) V_393 + V_453 ) ;
V_47 -= V_453 ;
V_352 ++ ;
}
}
...
return V_444 ( & V_183 , V_384 , V_391 , V_445 , V_352 ,
V_455 ? & V_457 : NULL ) ;
V_35:
return V_23 ;
}
...
return - V_71 ;
V_384 = F_170 ( V_409 -> V_425 ) ;
if ( V_384 >= V_466 )
return - V_71 ;
V_465 = ( V_59 -> V_320 == V_433 ) ;
V_383 = F_171 ( V_10 , V_146 , V_391 ,
V_384 , V_409 -> V_425 , V_465 , & V_23 ) ;
if ( V_383 == NULL )
return - V_315 ;
if ( V_465 ) {
F_162 ( V_383 , V_23 ? 0 : 1 ,
...
{
struct V_10 * V_10 = F_7 ( & V_6 -> V_3 ) ;
return V_387 ( V_10 , & V_6 -> V_7 . V_378 . V_468 , F_172 , ( void * ) V_6 ) ;
}
static void F_174 ( struct V_1 * V_6 )
{
F_141 ( & V_6 -> V_7 . V_378 . V_468 ) ;
}
...
V_6 -> V_7 . V_7 = F_173 ;
V_6 -> V_7 . V_9 = F_174 ;
F_140 ( & V_6 -> V_7 . V_378 . V_468 , V_391 ) ;
return F_38 ( V_6 ) ;
}
...
struct V_41 * V_469 ;
struct V_58 * V_59 ;
V_469 = F_41 ( sizeof( struct V_58 ) + 16 , V_64 ) ;
if ( ! V_469 )
return - V_44 ;
V_59 = (struct V_58 * ) F_43 ( V_469 , sizeof( struct V_58 ) ) ;
V_59 -> V_320 = V_470 ;
V_59 -> V_62 = V_345 -> V_303 ;
V_59 -> V_323 = V_345 -> V_346 ;
V_59 -> V_319 = V_29 ;
...
V_59 -> V_73 = ( sizeof( struct V_58 ) / sizeof( V_74 ) ) ;
V_59 -> V_322 = 0 ;
F_34 ( V_469 , V_64 , V_53 , NULL , V_345 -> V_10 ) ;
return 0 ;
}
...
V_23 = - V_305 ;
if ( V_472 [ V_59 -> V_320 ] )
V_23 = V_472 [ V_59 -> V_320 ] ( V_3 , V_8 , V_59 , V_108 ) ;
}
return V_23 ;
}
static struct V_58 * F_180 ( struct V_41 * V_8 , int * V_473 )
{
...
const struct V_209 * V_477 )
{
unsigned int V_194 = V_477 -> V_213 . V_214 ;
...
{
unsigned int V_194 = V_477 -> V_213 . V_214 ;
if ( V_194 >= sizeof( V_395 -> V_479 ) * 8 )
return 0 ;
return ( V_395 -> V_479 >> V_194 ) & 1 ;
}
...
continue;
for ( V_457 = 1 ; ; V_457 ++ ) {
const struct V_209 * V_185 = F_120 ( V_457 ) ;
if ( ! V_185 )
break;
if ( ! V_185 -> V_212 )
continue;
...
struct V_482 * V_75 ;
int V_352 ;
V_75 = (struct V_482 * ) F_43 ( V_8 , sizeof( struct V_482 ) ) ;
V_75 -> V_483 = sizeof( struct V_482 ) / 8 ;
V_75 -> V_484 = V_485 ;
V_75 -> V_486 = 32 ;
memset ( V_75 -> V_487 , 0 , sizeof( V_75 -> V_487 ) ) ;
for ( V_352 = 0 ; ; V_352 ++ ) {
const struct V_209 * V_185 = F_120 ( V_352 ) ;
if ( ! V_185 )
break;
...
if ( F_181 ( V_395 , V_185 ) && V_185 -> V_360 ) {
struct V_481 * V_345 ;
V_345 = (struct V_481 * ) F_43 ( V_8 , sizeof( struct V_481 ) ) ;
memset ( V_345 , 0 , sizeof( * V_345 ) ) ;
V_75 -> V_483 += sizeof( struct V_481 ) / 8 ;
V_345 -> V_488 = V_185 -> V_213 . V_214 ;
V_345 -> V_489 = V_185 -> V_213 . V_490 ;
V_345 -> V_491 = V_185 -> V_213 . V_492 ;
V_345 -> V_493 = 24 * 60 * 60 ;
V_345 -> V_494 = 20 * 60 * 60 ;
V_345 -> V_495 = 8 * 60 * 60 ;
V_345 -> V_496 = 7 * 60 * 60 ;
}
}
...
V_345 -> V_489 = V_185 -> V_213 . V_490 ;
V_345 -> V_491 = V_185 -> V_213 . V_492 ;
V_345 -> V_497 = V_187 -> V_213 . V_214 ;
V_345 -> V_498 = V_187 -> V_213 . V_490 ;
V_345 -> V_499 = V_187 -> V_213 . V_492 ;
V_345 -> V_493 = 24 * 60 * 60 ;
V_345 -> V_494 = 20 * 60 * 60 ;
V_345 -> V_495 = 8 * 60 * 60 ;
V_345 -> V_496 = 7 * 60 * 60 ;
...
static struct V_382 * F_194 ( struct V_2 * V_3 , int V_506 ,
...
static int F_195 ( struct V_142 * V_164 , T_4 * V_511 , T_5 V_253 )
{
struct V_41 * V_8 ;
struct V_58 * V_59 ;
struct V_143 * V_135 ;
...
const struct V_440 * V_183 )
{
struct V_76 * V_79 ;
V_79 = (struct V_76 * ) F_43 ( V_8 , sizeof( struct V_76 ) + V_513 ) ;
V_79 -> V_86 = ( sizeof( struct V_76 ) + V_513 ) / 8 ;
V_79 -> V_248 = type ;
...
struct V_454 * V_455 ;
T_7 * V_135 ;
int V_134 = V_457 -> V_134 ;
int V_405 = F_57 ( V_134 ) ;
int V_514 ;
V_514 = ( sizeof( struct V_454 ) +
F_165 ( V_134 ) ) ;
V_455 = (struct V_454 * ) F_43 ( V_8 , V_514 ) ;
memset ( V_455 , 0 , V_514 ) ;
V_455 -> V_461 = V_514 / 8 ;
V_455 -> V_515 = V_458 ;
V_455 -> V_460 = V_457 -> V_459 ;
V_135 = ( T_7 * ) ( V_455 + 1 ) ;
if ( ! F_66 ( & V_457 -> V_462 , 0 , (struct V_78 * ) V_135 , V_134 ) ||
! F_66 ( & V_457 -> V_463 , 0 , (struct V_78 * ) ( V_135 + V_405 ) , V_134 ) )
return - V_71 ;
return 0 ;
}
static int F_198 ( struct V_41 * V_8 ,
V_72 V_133 , V_72 V_148 , int V_516 ,
...
int V_405 = F_57 ( V_134 ) ;
int V_514 ;
V_514 = sizeof( struct V_392 ) +
F_165 ( V_134 ) ;
V_393 = (struct V_392 * ) F_43 ( V_8 , V_514 ) ;
memset ( V_393 , 0 , V_514 ) ;
V_393 -> V_411 = V_514 ;
V_393 -> V_399 = V_133 ;
V_393 -> V_398 = V_148 ;
V_393 -> V_400 = V_516 ;
...
static int F_199 ( const struct V_440 * V_183 , T_7 V_384 , T_7 type ,
...
if ( type != V_391 )
return 0 ;
if ( V_517 <= 0 || V_517 > V_396 )
return - V_71 ;
if ( V_457 != NULL ) {
V_175 += F_63 ( sizeof( struct V_454 ) +
F_165 ( V_457 -> V_134 ) ) ;
}
V_518 = F_62 ( V_183 -> V_134 ) ;
if ( ! V_518 )
return - V_71 ;
V_175 += ( sizeof( struct V_76 ) + V_518 ) * 2 ;
V_519 += sizeof( struct V_408 ) ;
for ( V_352 = 0 , V_520 = V_445 ; V_352 < V_517 ; V_352 ++ , V_520 ++ ) {
V_519 += sizeof( struct V_392 ) +
F_165 ( V_520 -> V_449 ) ;
V_519 += sizeof( struct V_392 ) +
F_165 ( V_520 -> V_452 ) ;
}
V_175 += sizeof( struct V_58 ) + V_519 ;
V_8 = F_41 ( V_175 , V_64 ) ;
if ( V_8 == NULL )
return - V_31 ;
V_59 = (struct V_58 * ) F_43 ( V_8 , sizeof( struct V_58 ) ) ;
...
goto V_23;
F_196 ( V_8 , V_518 , V_119 , V_183 ) ;
F_196 ( V_8 , V_518 , V_120 , V_183 ) ;
V_409 = (struct V_408 * ) F_43 ( V_8 , sizeof( struct V_408 ) ) ;
V_409 -> V_410 = V_519 / 8 ;
V_409 -> V_415 = V_416 ;
V_409 -> V_417 = V_421 ;
...
V_409 -> V_427 = 0 ;
for ( V_352 = 0 , V_520 = V_445 ; V_352 < V_517 ; V_352 ++ , V_520 ++ ) {
int V_148 = F_64 ( V_520 -> V_148 ) ;
if ( V_148 < 0 )
goto V_23;
if ( F_198 ( V_8 , V_520 -> V_133 , V_148 ,
( V_520 -> V_269 ? V_403 : V_430 ) ,
V_520 -> V_269 , V_520 -> V_449 ,
& V_520 -> V_447 , & V_520 -> V_448 ) < 0 )
goto V_23;
if ( F_198 ( V_8 , V_520 -> V_133 , V_148 ,
( V_520 -> V_269 ? V_403 : V_430 ) ,
V_520 -> V_269 , V_520 -> V_452 ,
& V_520 -> V_450 , & V_520 -> V_451 ) < 0 )
goto V_23;
}
F_34 ( V_8 , V_64 , V_53 , NULL , & V_522 ) ;
return 0 ;
V_23:
F_5 ( V_8 ) ;
return - V_71 ;
...
goto V_35;
V_23 = - V_529 ;
if ( F_201 ( F_43 ( V_8 , V_47 ) , V_525 -> V_530 , V_47 ) )
goto V_35;
V_59 = F_180 ( V_8 , & V_23 ) ;
if ( ! V_59 )
goto V_35;
...
int V_532 , V_23 ;
V_23 = - V_71 ;
if ( V_218 & ~ ( V_533 | V_534 | V_535 | V_536 ) )
goto V_35;
V_525 -> V_537 = 0 ;
V_8 = F_203 ( V_3 , V_218 , V_218 & V_534 , & V_23 ) ;
if ( V_8 == NULL )
goto V_35;
V_532 = V_8 -> V_47 ;
if ( V_532 > V_47 ) {
...
goto V_538;
F_206 ( V_525 , V_3 , V_8 ) ;
V_23 = ( V_218 & V_535 ) ? V_8 -> V_47 : V_532 ;
if ( V_6 -> V_7 . V_7 != NULL &&
...
{
struct V_550 * V_551 ;
V_551 = F_226 ( L_6 , 0 , V_10 -> V_552 , & V_553 ) ;
if ( V_551 == NULL )
return - V_31 ;
return 0 ;
}
