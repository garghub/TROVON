...
V_1 -> V_51 = V_285 -> V_295 . V_297 ;
V_1 -> V_160 = V_290 -> V_262 & V_298 ;
F_119 ( & V_1 -> V_17 ) ;
F_120 ( V_285 , V_1 ) ;
...
V_1 -> V_5 = V_5 ;
V_33 = F_122 ( V_290 -> V_296 , F_81 , V_306 ,
V_303 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_24 , V_33 ) ;
goto V_293;
...
if ( V_1 -> V_51 -> V_52 ) {
snprintf ( V_291 , sizeof( V_291 ) , L_25 , V_285 -> V_307 ) ;
V_1 -> V_286 = F_123 ( & V_285 -> V_295 , V_291 ) ;
if ( F_124 ( V_1 -> V_286 ) ) {
F_116 ( & V_285 -> V_295 , L_26 ,
V_291 ) ;
V_33 = F_125 ( V_1 -> V_286 ) ;
goto V_308;
}
F_126 ( V_1 -> V_286 ) ;
}
...
F_56 ( V_1 ) ;
V_33 = F_127 ( & V_285 -> V_295 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_313;
F_128 ( & V_285 -> V_295 , L_27 , V_314 ) ;
return 0 ;
V_313:
F_92 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_205 ) ;
V_312:
