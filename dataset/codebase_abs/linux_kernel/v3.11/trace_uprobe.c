...
int V_28 ;
F_23 ( & V_30 ) ;
V_29 = F_17 ( V_7 -> V_17 . V_19 , V_7 -> V_17 . V_18 -> system ) ;
if ( V_29 ) {
V_28 = F_19 ( V_29 ) ;
if ( V_28 )
goto V_31;
...
V_28 = F_39 ( V_35 , & V_7 -> V_52 , & V_7 -> args [ V_24 ] , false , false ) ;
if ( V_28 ) {
F_29 ( L_18 , V_24 , V_28 ) ;
goto error;
}
...
V_7 -> V_85 |= V_97 ;
V_7 -> V_8 . V_2 = V_2 ;
V_28 = F_73 ( V_7 -> V_26 , V_7 -> V_39 , & V_7 -> V_8 ) ;
if ( V_28 )
V_7 -> V_85 &= ~ V_97 ;
return V_28 ;
}
...
for ( V_24 = 0 ; V_24 < V_7 -> V_25 ; V_24 ++ ) {
V_28 = F_78 ( V_99 , V_7 -> args [ V_24 ] . type -> V_101 ,
V_7 -> args [ V_24 ] . V_19 ,
...
if ( F_97 ( V_127 ) )
goto V_131;
V_75 = F_98 ( V_52 , V_17 -> V_11 . type , V_73 , & V_128 ) ;
if ( ! V_75 )
goto V_131;
if ( F_6 ( V_7 ) ) {
V_75 -> V_80 [ 0 ] = V_71 ;
...
for ( V_24 = 0 ; V_24 < V_7 -> V_25 ; V_24 ++ )
F_61 ( & V_7 -> args [ V_24 ] . V_81 , V_73 , V_78 + V_7 -> args [ V_24 ] . V_39 ) ;
F_99 ( V_75 , V_52 , V_128 , 0 , 1 , V_73 , V_127 , NULL ) ;
V_131:
F_100 () ;
}
static int F_101 ( struct V_6 * V_7 , struct V_72 * V_73 )
{
if ( ! F_90 ( & V_7 -> V_8 , 0 , V_132 -> V_112 ) )
return V_133 ;
if ( ! F_6 ( V_7 ) )
F_93 ( V_7 , 0 , V_73 ) ;
return 0 ;
}
static void F_102 ( struct V_6 * V_7 , unsigned long V_71 ,
struct V_72 * V_73 )
{
F_93 ( V_7 , V_71 , V_73 ) ;
}
static
int F_103 ( struct V_79 * V_11 , enum V_134 type , void * V_78 )
{
...
static int V_22 ( struct V_122 * V_141 , struct V_72 * V_73 )
{
struct V_6 * V_7 ;
int V_28 = 0 ;
V_7 = F_67 ( V_141 , struct V_6 , V_8 ) ;
V_7 -> V_69 ++ ;
if ( V_7 -> V_85 & V_95 )
V_28 |= F_64 ( V_7 , V_73 ) ;
#ifdef F_104
...
static int V_23 ( struct V_122 * V_141 ,
unsigned long V_71 , struct V_72 * V_73 )
{
struct V_6 * V_7 ;
V_7 = F_67 ( V_141 , struct V_6 , V_8 ) ;
...
int V_28 ;
F_3 ( & V_17 -> V_18 -> V_142 ) ;
V_17 -> V_11 . V_143 = & V_144 ;
V_17 -> V_18 -> V_145 = F_76 ;
if ( F_80 ( V_7 ) < 0 )
return - V_16 ;
V_28 = F_105 ( & V_17 -> V_11 ) ;
if ( ! V_28 ) {
F_13 ( V_17 -> V_110 ) ;
return - V_146 ;
}
V_17 -> V_85 = 0 ;
V_17 -> V_18 -> V_147 = F_103 ;
V_17 -> V_78 = V_7 ;
V_28 = F_106 ( V_17 ) ;
if ( V_28 ) {
F_29 ( L_34 , V_17 -> V_19 ) ;
...
if ( ! V_148 )
return 0 ;
F_111 ( L_35 , 0644 , V_148 ,
NULL , & V_149 ) ;
F_111 ( L_36 , 0444 , V_148 ,
NULL , & V_150 ) ;
return 0 ;
}
