...
T_4 * F_63 ( struct V_49 * V_50 , unsigned long V_62 , int V_55 )
{
T_4 * V_63 ;
V_63 = F_54 ( V_50 ) ;
if ( V_63 )
...
void F_64 ( struct V_49 * V_50 , unsigned long * V_64 , int V_55 )
{
...
void F_69 ( struct V_65 * V_66 , void * V_64 , int V_67 )
{
...
int F_74 ( struct V_71 * V_72 , unsigned long V_73 ,
...
V_76 = ! F_77 ( * ( V_10 ) , V_74 ) ;
if ( V_76 ) {
F_78 ( F_79 ( V_10 ) , F_80 ( V_74 ) ) ;
}
return V_76 ;
}
unsigned long F_81 ( struct V_49 * V_50 , unsigned long V_27 ,
...
T_3 F_86 ( struct V_71 * V_72 , unsigned long V_73 ,
T_3 * V_10 )
{
T_3 V_48 ;
F_87 ( V_73 & ~ V_82 ) ;
if ( F_49 ( * V_10 ) ) {
V_48 = F_88 ( V_72 -> V_77 , V_73 , V_10 ) ;
} else {
V_48 = * V_10 ;
F_89 ( V_10 ) ;
F_90 () ;
F_91 ( V_72 -> V_77 , & V_48 , V_73 ) ;
}
return V_48 ;
}
...
{
return F_93 ( V_72 -> V_77 , V_73 , V_10 ) ;
}
...
if ( ! ( V_79 & V_83 ) ) {
if ( V_79 & V_81 )
F_85 ( V_72 -> V_77 , V_73 , V_10 ) ;
}
}
void F_96 ( struct V_49 * V_50 , T_3 * V_10 ,
T_7 V_84 )
{
T_7 * V_85 ;
F_76 ( & V_50 -> V_52 ) ;
...
T_7 F_98 ( struct V_49 * V_50 , T_3 * V_10 )
{
T_7 V_84 ;
T_7 * V_85 ;
F_76 ( & V_50 -> V_52 ) ;
...
void F_99 ( struct V_49 * V_50 , unsigned long V_27 ,
T_3 * V_10 , T_3 V_48 )
{
#ifdef F_75
F_31 ( ! F_100 ( * V_10 ) ) ;
...
F_31 ( ! F_49 ( V_48 ) ) ;
#endif
return F_12 ( V_50 , V_27 , F_79 ( V_10 ) , F_80 ( V_48 ) ) ;
}
void F_101 ( struct V_71 * V_72 , unsigned long V_73 ,
T_3 * V_10 )
{
F_81 ( V_72 -> V_77 , V_73 , V_10 , V_21 ) ;
}
void F_85 ( struct V_49 * V_50 , unsigned long V_27 ,
T_3 * V_10 )
{
int V_87 , V_20 ;
unsigned long V_88 ;
...
V_91 = F_104 ( V_92 , V_20 ) ;
if ( ! V_91 )
continue;
V_93 = F_105 ( V_92 , V_20 ) ;
V_27 = V_88 + ( V_20 * ( 1ul << V_67 ) ) ;
if ( ! F_106 ( V_27 ) ) {
V_87 = F_107 ( V_27 ) ;
V_95 = F_108 ( V_50 -> V_53 . V_101 , V_27 , V_87 ) ;
F_31 ( V_95 == 0 ) ;
} else {
V_95 = F_109 ( V_27 , V_18 ) ;
V_87 = V_18 ;
}
V_94 = F_110 ( V_27 , V_95 , V_87 ) ;
V_96 = F_111 ( V_94 , V_67 , V_87 ) ;
if ( V_93 & V_102 )
V_96 = ~ V_96 ;
...
static T_3 F_112 ( T_3 V_48 , T_8 V_108 )
{
F_83 ( V_48 ) |= F_30 ( V_108 ) ;
return V_48 ;
}
T_3 F_113 ( unsigned long V_109 , T_8 V_108 )
{
T_3 V_48 ;
F_83 ( V_48 ) = V_109 << V_110 ;
F_83 ( V_48 ) |= V_111 ;
V_48 = F_112 ( V_48 , V_108 ) ;
return V_48 ;
}
T_3 F_114 ( struct V_47 * V_47 , T_8 V_108 )
{
return F_113 ( F_115 ( V_47 ) , V_108 ) ;
}
T_3 F_116 ( T_3 V_48 , T_8 V_112 )
{
F_83 ( V_48 ) &= V_113 ;
V_48 = F_112 ( V_48 , V_112 ) ;
return V_48 ;
}
void F_117 ( struct V_71 * V_72 , unsigned long V_27 ,
T_3 * V_48 )
{
return;
}
T_3 F_88 ( struct V_49 * V_50 ,
