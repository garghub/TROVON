...
bool V_39 ;
int V_18 ;
V_11 = F_17 ( sizeof( * V_2 ) ) ;
if ( V_11 == NULL )
return - V_40 ;
V_2 = F_5 ( V_11 ) ;
F_18 ( V_9 , V_11 ) ;
V_2 -> V_9 = V_9 ;
V_2 -> V_23 = F_19 ( & V_9 -> V_41 , L_2 ) ;
if ( F_20 ( V_2 -> V_23 ) ) {
V_18 = F_21 ( V_2 -> V_23 ) ;
goto V_42;
}
...
goto V_43;
if ( V_9 -> V_41 . V_44 ) {
V_39 = F_23 ( V_9 -> V_41 . V_44 ,
L_3 ) ;
} else {
struct V_45 * V_46 = V_9 -> V_41 . V_47 ;
if ( V_46 && V_46 -> V_48 )
V_39 = true ;
else
V_39 = false ;
...
static int F_29 ( struct V_36 * V_9 )
{
struct V_10 * V_11 = F_30 ( V_9 ) ;
struct V_1 * V_2 = F_5 ( V_11 ) ;
F_31 ( V_11 ) ;
if ( V_2 -> V_22 ) {
F_26 ( V_2 -> V_22 ) ;
