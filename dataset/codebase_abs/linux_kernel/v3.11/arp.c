...
F_11 ( V_71 , V_65 ) == V_58 &&
! F_30 ( V_20 , V_64 , V_65 ) )
F_29 ( V_116 , V_63 , V_64 , V_4 , V_65 , V_113 ,
V_4 -> V_42 , V_113 ) ;
goto V_99;
}
if ( V_91 -> V_107 == F_58 ( V_62 ) &&
...
if ( V_115 == V_58 ) {
int V_119 ;
V_119 = F_30 ( V_20 , V_64 , V_65 ) ;
if ( ! V_119 && F_68 ( V_20 ) )
V_119 = F_33 ( V_64 , V_65 , V_4 ) ;
if ( ! V_119 ) {
V_76 = F_69 ( & V_78 , V_113 , & V_64 , V_4 ) ;
if ( V_76 ) {
F_29 ( V_116 , V_63 , V_64 ,
...
int V_125 = V_126 ;
int V_127 ;
V_127 = F_75 ( V_80 , V_76 -> V_128 + V_76 -> V_22 -> V_129 ) ;
if ( V_91 -> V_107 != F_58 ( V_116 ) ||
V_51 -> V_122 != V_123 )
V_125 = V_130 ;
F_76 ( V_76 , V_113 , V_125 ,
V_127 ? V_131 : 0 ) ;
F_45 ( V_76 ) ;
}
V_99:
...
goto V_137;
memset ( F_72 ( V_51 ) , 0 , sizeof( struct V_139 ) ) ;
return F_61 ( V_110 , V_140 , V_51 , V_4 , NULL , F_62 ) ;
V_137:
F_18 ( V_51 ) ;
V_138:
return 0 ;
}
static int F_82 ( struct V_71 * V_71 , struct V_3 * V_4 , int V_141 )
{
if ( V_4 == NULL ) {
F_83 ( V_71 , V_142 ) = V_141 ;
return 0 ;
}
if ( F_84 ( V_4 ) ) {
F_85 ( F_84 ( V_4 ) , V_142 , V_141 ) ;
return 0 ;
}
return - V_143 ;
}
static int F_86 ( struct V_71 * V_71 , struct V_144 * V_145 ,
struct V_3 * V_4 )
{
T_1 V_146 = ( (struct V_147 * ) & V_145 -> V_148 ) -> V_149 . V_150 ;
T_1 V_151 = ( (struct V_147 * ) & V_145 -> V_152 ) -> V_149 . V_150 ;
if ( V_151 && V_151 != F_87 ( 0xFFFFFFFF ) )
return - V_13 ;
if ( ! V_4 && ( V_145 -> V_153 & V_154 ) ) {
V_4 = F_88 ( V_71 , V_145 -> V_155 . V_156 ,
V_145 -> V_155 . V_157 ) ;
if ( ! V_4 )
return - V_158 ;
}
if ( V_151 ) {
if ( F_71 ( & V_78 , V_71 , & V_146 , V_4 , 1 ) == NULL )
return - V_159 ;
return 0 ;
}
return F_82 ( V_71 , V_4 , 1 ) ;
}
static int F_89 ( struct V_71 * V_71 , struct V_144 * V_145 ,
struct V_3 * V_4 )
{
T_1 V_146 ;
struct V_16 * V_17 ;
...
return F_86 ( V_71 , V_145 , V_4 ) ;
V_146 = ( (struct V_147 * ) & V_145 -> V_148 ) -> V_149 . V_150 ;
if ( V_145 -> V_153 & V_162 )
V_145 -> V_153 |= V_154 ;
if ( V_4 == NULL ) {
struct V_68 * V_69 = F_34 ( V_71 , V_146 , 0 , V_163 , 0 ) ;
if ( F_35 ( V_69 ) )
return F_90 ( V_69 ) ;
V_4 = V_69 -> V_72 . V_4 ;
F_37 ( V_69 ) ;
...
V_17 = F_91 ( & V_78 , & V_146 , V_4 ) ;
V_160 = F_90 ( V_17 ) ;
if ( ! F_35 ( V_17 ) ) {
unsigned int V_125 = V_130 ;
if ( V_145 -> V_153 & V_162 )
V_125 = V_164 ;
V_160 = F_76 ( V_17 , ( V_145 -> V_153 & V_154 ) ?
...
static int F_93 ( struct V_144 * V_145 , struct V_3 * V_4 )
{
T_1 V_146 = ( (struct V_147 * ) & V_145 -> V_148 ) -> V_149 . V_150 ;
struct V_16 * V_17 ;
int V_160 = - V_143 ;
V_17 = F_94 ( & V_78 , & V_146 , V_4 ) ;
if ( V_17 ) {
F_95 ( & V_17 -> V_166 ) ;
memcpy ( V_145 -> V_155 . V_157 , V_17 -> V_38 , V_4 -> V_12 ) ;
V_145 -> V_153 = F_92 ( V_17 ) ;
F_96 ( & V_17 -> V_166 ) ;
V_145 -> V_155 . V_156 = V_4 -> type ;
F_97 ( V_145 -> V_167 , V_4 -> V_168 , sizeof( V_145 -> V_167 ) ) ;
F_45 ( V_17 ) ;
V_160 = 0 ;
}
return V_160 ;
}
int F_98 ( struct V_3 * V_4 , T_1 V_146 )
{
struct V_16 * V_17 = F_94 ( & V_78 , & V_146 , V_4 ) ;
int V_160 = - V_143 ;
if ( V_17 ) {
if ( V_17 -> V_25 & ~ V_26 )
V_160 = F_76 ( V_17 , NULL , V_169 ,
V_131 |
V_165 ) ;
F_45 ( V_17 ) ;
}
...
static int F_99 ( struct V_71 * V_71 , struct V_144 * V_145 ,
struct V_3 * V_4 )
{
T_1 V_146 = ( (struct V_147 * ) & V_145 -> V_148 ) -> V_149 . V_150 ;
T_1 V_151 = ( (struct V_147 * ) & V_145 -> V_152 ) -> V_149 . V_150 ;
if ( V_151 == F_87 ( 0xFFFFFFFF ) )
return F_100 ( & V_78 , V_71 , & V_146 , V_4 ) ;
if ( V_151 )
return - V_13 ;
return F_82 ( V_71 , V_4 , 0 ) ;
}
static int F_101 ( struct V_71 * V_71 , struct V_144 * V_145 ,
struct V_3 * V_4 )
{
T_1 V_146 ;
if ( V_145 -> V_153 & V_161 )
return F_99 ( V_71 , V_145 , V_4 ) ;
V_146 = ( (struct V_147 * ) & V_145 -> V_148 ) -> V_149 . V_150 ;
if ( V_4 == NULL ) {
struct V_68 * V_69 = F_34 ( V_71 , V_146 , 0 , V_163 , 0 ) ;
if ( F_35 ( V_69 ) )
...
return F_98 ( V_4 , V_146 ) ;
}
int F_102 ( struct V_71 * V_71 , unsigned int V_170 , void T_6 * V_171 )
{
int V_160 ;
struct V_144 V_145 ;
struct V_3 * V_4 = NULL ;
...
case V_172 :
case V_173 :
if ( ! F_103 ( V_71 -> V_174 , V_175 ) )
return - V_176 ;
case V_177 :
V_160 = F_104 ( & V_145 , V_171 , sizeof( struct V_144 ) ) ;
if ( V_160 )
return - V_178 ;
break;
default:
...
switch ( V_170 ) {
case V_172 :
V_160 = F_101 ( V_71 , & V_145 , V_4 ) ;
break;
case V_173 :
V_160 = F_89 ( V_71 , & V_145 , V_4 ) ;
break;
case V_177 :
V_160 = F_93 ( & V_145 , V_4 ) ;
break;
}
V_99:
F_107 () ;
if ( V_170 == V_177 && ! V_160 && F_108 ( V_171 , & V_145 , sizeof( V_145 ) ) )
V_160 = - V_178 ;
return V_160 ;
}
static int F_109 ( struct V_183 * V_184 , unsigned long V_185 ,
void * V_186 )
{
struct V_3 * V_4 = F_110 ( V_186 ) ;
struct V_187 * V_188 ;
switch ( V_185 ) {
case V_189 :
F_111 ( & V_78 , V_4 ) ;
...
F_118 () ;
#ifdef F_119
F_120 ( NULL , & V_78 . V_22 , L_4 , NULL ) ;
#endif
F_121 ( & V_194 ) ;
}
static char * F_122 ( T_8 * V_195 , char * V_196 )
{
char V_197 , * V_198 ;
int V_76 ;
...
static void F_123 ( struct V_200 * V_201 ,
struct V_16 * V_76 )
{
char V_202 [ V_203 ] ;
int V_204 , V_205 ;
...
F_127 ( V_201 , L_7 ,
V_206 , V_207 , F_92 ( V_76 ) , V_202 , V_4 -> V_168 ) ;
F_128 ( & V_76 -> V_166 ) ;
}
static void F_129 ( struct V_200 * V_201 ,
struct V_208 * V_76 )
{
struct V_3 * V_4 = V_76 -> V_4 ;
...
static int F_130 ( struct V_200 * V_201 , void * V_210 )
{
if ( V_210 == V_211 ) {
F_131 ( V_201 , L_9
L_10 ) ;
...
static void * F_132 ( struct V_200 * V_201 , T_9 * V_215 )
{
return F_133 ( V_201 , V_215 , & V_78 , V_216 ) ;
}
static int F_134 ( struct V_217 * V_217 , struct V_218 * V_218 )
{
return F_135 ( V_217 , V_218 , & V_219 ,
sizeof( struct V_212 ) ) ;
}
static int T_10 F_136 ( struct V_71 * V_71 )
{
if ( ! F_137 ( L_11 , V_220 , V_71 -> V_221 , & V_222 ) )
return - V_223 ;
return 0 ;
}
static void T_11 F_138 ( struct V_71 * V_71 )
{
F_139 ( L_11 , V_71 -> V_221 ) ;
}
