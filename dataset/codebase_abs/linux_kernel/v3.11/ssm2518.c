...
int V_19 ;
V_15 -> V_98 = V_1 -> V_31 ;
V_19 = F_23 ( V_15 , 0 , 0 , V_99 ) ;
if ( V_19 < 0 ) {
F_24 ( V_15 -> V_100 , L_1 , V_19 ) ;
return V_19 ;
}
...
static int F_26 ( struct V_14 * V_15 , int V_101 ,
int V_102 , unsigned int V_103 , int V_104 )
{
struct V_1 * V_1 = F_4 ( V_15 ) ;
unsigned int V_38 ;
if ( V_101 != V_105 )
...
static bool F_27 ( struct V_113 * V_100 , unsigned int V_114 )
{
return false ;
}
static int F_28 ( struct V_115 * V_116 ,
const struct V_117 * V_118 )
{
struct V_119 * V_120 = V_116 -> V_100 . V_121 ;
struct V_1 * V_1 ;
int V_19 ;
V_1 = F_29 ( & V_116 -> V_100 , sizeof( * V_1 ) , V_122 ) ;
if ( V_1 == NULL )
return - V_123 ;
if ( V_120 ) {
V_1 -> V_65 = V_120 -> V_65 ;
} else if ( V_116 -> V_100 . V_124 ) {
V_1 -> V_65 = F_30 ( V_116 -> V_100 . V_124 , 0 ) ;
if ( V_1 -> V_65 < 0 && V_1 -> V_65 != - V_125 )
return V_1 -> V_65 ;
} else {
V_1 -> V_65 = - 1 ;
}
if ( F_13 ( V_1 -> V_65 ) ) {
V_19 = F_31 ( & V_116 -> V_100 , V_1 -> V_65 ,
V_126 , L_2 ) ;
if ( V_19 )
return V_19 ;
}
F_32 ( V_116 , V_1 ) ;
V_1 -> V_31 = F_33 ( V_116 , & V_127 ) ;
if ( F_34 ( V_1 -> V_31 ) )
return F_35 ( V_1 -> V_31 ) ;
F_36 ( V_1 -> V_31 , true ) ;
...
if ( V_19 )
return V_19 ;
return F_37 ( & V_116 -> V_100 , & V_130 ,
& V_131 , 1 ) ;
}
static int F_38 ( struct V_115 * V_132 )
{
F_39 ( & V_132 -> V_100 ) ;
return 0 ;
}
