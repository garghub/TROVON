...
static int
F_74 ( struct V_146 * V_24 )
{
struct V_1 * V_2 = V_24 -> V_147 ;
return F_69 ( V_2 ) ;
}
static int
F_75 ( struct V_141 * V_99 ,
struct V_148 * V_149 ,
struct V_1 * * V_150 )
{
int V_86 ;
...
V_2 -> V_24 = V_149 ;
V_2 -> V_23 = - 1 ;
V_2 -> V_4 = F_77 ( V_149 -> V_156 . V_157 , V_158 ) ;
if ( V_2 -> V_4 == NULL ) {
...
F_79 ( & V_2 -> V_13 ) ;
F_79 ( & V_2 -> V_19 ) ;
if ( ( V_86 = F_80 ( V_99 , V_160 ,
V_2 , & V_152 ) ) < 0 ) {
goto V_159;
}
F_81 ( V_99 , & V_149 -> V_24 ) ;
* V_150 = V_2 ;
return 0 ;
V_159:
F_69 ( V_2 ) ;
...
struct V_141 * V_99 ;
struct V_1 * V_2 ;
V_86 = F_83 ( V_161 , V_162 , V_163 , 0 , & V_99 ) ;
if ( V_86 < 0 )
return V_86 ;
V_86 = F_75 ( V_99 , V_149 , & V_2 ) ;
if ( V_86 < 0 )
goto V_159;
V_86 = F_49 ( V_2 ) ;
if ( V_86 < 0 )
