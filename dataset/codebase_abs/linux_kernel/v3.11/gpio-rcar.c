...
struct V_60 * V_61 = V_2 -> V_25 -> V_26 . V_62 ;
struct V_63 args ;
int V_64 ;
if ( V_58 ) {
V_2 -> V_20 = * V_58 ;
} else if ( F_38 ( V_65 ) && V_61 ) {
V_64 = F_39 ( V_61 , L_3 ,
L_4 , 0 , & args ) ;
V_2 -> V_20 . V_66 = V_64 == 0 && args . V_67 == 3
? args . args [ 2 ]
: V_68 ;
V_2 -> V_20 . V_69 = - 1 ;
}
...
static int F_41 ( struct V_70 * V_25 )
{
struct V_1 * V_2 ;
struct V_71 * V_72 , * V_34 ;
struct V_43 * V_43 ;
struct V_54 * V_54 ;
const char * V_73 = F_42 ( & V_25 -> V_26 ) ;
int V_64 ;
V_2 = F_43 ( & V_25 -> V_26 , sizeof( * V_2 ) , V_74 ) ;
if ( ! V_2 ) {
F_44 ( & V_25 -> V_26 , L_6 ) ;
V_64 = - V_75 ;
goto V_76;
...
F_37 ( V_2 ) ;
F_46 ( V_25 , V_2 ) ;
V_72 = F_47 ( V_25 , V_77 , 0 ) ;
V_34 = F_47 ( V_25 , V_78 , 0 ) ;
if ( ! V_72 || ! V_34 ) {
F_44 ( & V_25 -> V_26 , L_7 ) ;
V_64 = - V_33 ;
goto V_76;
}
V_2 -> V_4 = F_48 ( & V_25 -> V_26 , V_72 -> V_79 ,
F_49 ( V_72 ) ) ;
if ( ! V_2 -> V_4 ) {
F_44 ( & V_25 -> V_26 , L_8 ) ;
V_64 = - V_80 ;
...
V_43 -> V_26 = & V_25 -> V_26 ;
V_43 -> V_88 = V_89 ;
V_43 -> V_4 = V_2 -> V_20 . V_69 ;
V_43 -> V_90 = V_2 -> V_20 . V_66 ;
V_54 = & V_2 -> V_54 ;
V_54 -> V_73 = V_73 ;
V_54 -> V_91 = F_7 ;
V_54 -> V_92 = F_10 ;
...
F_53 ( & V_25 -> V_26 , L_12 , V_2 -> V_20 . V_66 ) ;
if ( V_2 -> V_20 . V_98 ) {
V_64 = F_19 ( V_2 -> V_40 , 0 ) ;
if ( V_2 -> V_20 . V_98 != V_64 )
F_40 ( & V_25 -> V_26 , L_13 ,
V_2 -> V_20 . V_98 , V_64 ) ;
}
if ( V_2 -> V_20 . V_103 ) {
V_64 = F_54 ( V_43 , V_2 -> V_20 . V_103 , 0 ,
V_43 -> V_4 , V_43 -> V_90 ) ;
if ( V_64 < 0 )
F_40 ( & V_25 -> V_26 , L_14 ) ;
}
