...
{
struct V_34 * V_35 = F_11 ( V_31 -> V_36 . V_37 ) ;
struct V_32 * V_33 = F_17 ( V_35 -> V_36 ) ;
struct V_4 * V_5 ;
int V_45 , V_6 = 0 ;
struct V_53 V_54 = { } ;
F_18 ( & V_31 -> V_36 , L_6 , V_55 ) ;
if ( ! V_33 ) {
F_13 ( & V_31 -> V_36 , L_7 ) ;
return - V_56 ;
}
...
V_5 -> V_2 [ V_45 ] = F_20 ( & V_48 [ V_45 ] , & V_54 ) ;
if ( F_21 ( V_5 -> V_2 [ V_45 ] ) ) {
V_6 = F_22 ( V_5 -> V_2 [ V_45 ] ) ;
F_13 ( & V_31 -> V_36 ,
L_9 , V_45 ) ;
V_5 -> V_2 [ V_45 ] = NULL ;
goto V_59;
