...
if ( V_94 -> V_100 == 1 ) {
const char * V_101 ;
V_76 = F_35 ( & V_9 -> V_34 . V_65 ,
& V_102 . V_67 ) ;
if ( V_76 )
goto V_103;
V_76 = F_36 ( & V_9 -> V_34 . V_65 , & V_104 ) ;
if ( V_76 )
goto V_105;
F_1 ( V_2 ,
( unsigned int ) V_40 ,
...
struct V_1 * V_2 = F_5 ( V_9 ) ;
F_39 ( & V_9 -> V_34 . V_65 , & V_102 . V_67 ) ;
F_45 ( & V_9 -> V_34 . V_65 , & V_104 ) ;
F_40 ( V_9 , V_2 -> V_7 ) ;
F_41 ( V_9 ) ;
F_42 ( V_9 ) ;
F_43 ( V_2 ) ;
}
static int F_46 ( struct V_8 * V_9 , T_6 V_119 )
{
int V_76 ;
F_4 ( V_9 ) ;
V_76 = F_47 ( V_9 ) ;
