...
V_46 = ( * V_49 ) -> V_45 . V_46 ;
V_51 = V_46 [ 1 ] ;
if ( ( T_3 ) V_51 -> integer . V_55 > V_66 ) {
F_8 ( ( V_30 , V_2 -> V_31 ,
V_2 -> V_32 ,
L_11 ,
V_21 - 1 , V_21 ) ) ;
}
V_66 = ( T_3 ) V_51 -> integer . V_55 ;
V_49 ++ ;
}
return ( V_28 ) ;
}
...
if ( ( * V_49 ) -> V_45 . V_47 < V_71 ) {
return ( V_76 ) ;
}
V_46 = ( * V_49 ) -> V_45 . V_46 ;
V_51 = V_46 [ V_72 ] ;
if ( V_51 -> V_23 . type != V_65 ) {
return ( V_33 ) ;
}
if ( ( ( V_73 == V_17 ) &&
( V_51 -> integer . V_55 < V_66 ) ) ||
( ( V_73 == V_67 ) &&
( V_51 -> integer . V_55 > V_66 ) ) ) {
F_25 ( & V_16 -> V_45 .
V_46 [ V_70 ] ,
...
for ( V_80 = ( V_47 - 1 ) ; V_80 >= V_21 ; V_80 -- ) {
V_77 = V_46 [ V_80 - 1 ] -> V_45 . V_46 [ V_64 ] ;
V_78 = V_46 [ V_80 ] -> V_45 . V_46 [ V_64 ] ;
if ( ( ( V_73 == V_17 ) &&
( V_77 -> integer . V_55 >
V_78 -> integer . V_55 ) )
|| ( ( V_73 == V_67 )
