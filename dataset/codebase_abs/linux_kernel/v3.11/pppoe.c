...
static int F_84 ( struct V_154 * V_155 , void * V_156 )
{
struct V_18 * V_26 ;
char * V_157 ;
if ( V_156 == V_158 ) {
...
static inline struct V_18 * F_87 ( struct V_2 * V_19 , T_3 V_159 )
{
struct V_18 * V_26 ;
int V_12 ;
for ( V_12 = 0 ; V_12 < V_36 ; V_12 ++ ) {
...
static void * F_88 ( struct V_154 * V_155 , T_3 * V_159 )
__acquires( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_89 ( V_155 ) ) ;
T_3 V_160 = * V_159 ;
F_12 ( & V_19 -> V_29 ) ;
return V_160 ? F_87 ( V_19 , -- V_160 ) : V_158 ;
}
static void * F_90 ( struct V_154 * V_155 , void * V_156 , T_3 * V_159 )
{
struct V_2 * V_19 = F_2 ( F_89 ( V_155 ) ) ;
struct V_18 * V_26 ;
++ * V_159 ;
...
static void F_91 ( struct V_154 * V_155 , void * V_156 )
__releases( V_19 -> V_29 )
{
struct V_2 * V_19 = F_2 ( F_89 ( V_155 ) ) ;
F_15 ( & V_19 -> V_29 ) ;
}
static int F_92 ( struct V_161 * V_161 , struct V_162 * V_162 )
{
return F_93 ( V_161 , V_162 , & V_163 ,
sizeof( struct V_164 ) ) ;
}
...
struct V_165 * V_166 ;
F_95 ( & V_19 -> V_29 ) ;
V_166 = F_96 ( L_3 , V_167 , V_3 -> V_168 , & V_169 ) ;
#ifdef F_97
if ( ! V_166 )
return - V_81 ;
#endif
