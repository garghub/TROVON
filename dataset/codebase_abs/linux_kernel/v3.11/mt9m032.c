...
{
if ( V_136 -> V_137 == V_138 && V_136 -> V_118 >= 63 ) {
V_136 -> V_118 &= ~ 1 ;
}
return 0 ;
}
...
switch ( V_136 -> V_137 ) {
case V_138 :
return F_38 ( V_6 , V_136 -> V_118 ) ;
case V_141 :
return F_37 ( V_6 , V_6 -> V_121 -> V_118 ,
V_6 -> V_122 -> V_118 ) ;
case V_142 :
V_26 = F_3 ( V_2 , V_143 ,
( V_136 -> V_118 >> 16 ) & 0xffff ) ;
if ( V_26 < 0 )
return V_26 ;
...
{
struct V_53 * V_54 = V_2 -> V_58 . V_147 ;
...
if ( ! V_2 -> V_58 . V_147 )
return - V_152 ;
V_6 = F_46 ( & V_2 -> V_58 , sizeof( * V_6 ) , V_153 ) ;
if ( V_6 == NULL )
return - V_154 ;
F_47 ( & V_6 -> V_98 ) ;
V_6 -> V_54 = V_54 ;
F_48 ( & V_6 -> V_13 , V_2 , & V_155 ) ;
V_6 -> V_13 . V_156 |= V_157 ;
V_150 = F_1 ( V_2 , V_158 ) ;
if ( V_150 != V_159 ) {
F_43 ( & V_2 -> V_58 , L_4
L_5 , V_150 ) ;
...
F_52 ( 2 , & V_6 -> V_122 ) ;
V_6 -> V_13 . V_175 = & V_6 -> V_140 ;
V_6 -> V_176 . V_156 = V_177 ;
V_26 = F_53 ( & V_6 -> V_13 . V_178 , 1 , & V_6 -> V_176 , 0 ) ;
if ( V_26 < 0 )
goto V_174;
V_26 = F_3 ( V_2 , V_179 , 1 ) ;
if ( V_26 < 0 )
goto V_180;
V_26 = F_3 ( V_2 , V_179 , 0 ) ;
if ( V_26 < 0 )
goto V_180;
V_26 = F_14 ( V_6 ) ;
if ( V_26 < 0 )
...
V_26 = F_3 ( V_2 , V_184 , 1 ) ;
if ( V_26 < 0 )
goto V_180;
F_56 ( 100 ) ;
V_26 = F_3 ( V_2 , V_184 , 0 ) ;
if ( V_26 < 0 )
goto V_180;
F_56 ( 100 ) ;
V_26 = F_13 ( V_6 , false ) ;
