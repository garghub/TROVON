...
static int F_88 ( struct V_61 * V_62 , struct V_143 * V_144 )
{
struct V_18 * V_19 = F_78 ( V_62 ) ;
struct V_145 * V_146 ;
int V_24 = - V_68 ;
...
return V_24 ;
F_40 ( & V_146 -> V_147 ) ;
V_146 -> V_148 = F_89 ( V_19 -> V_127 , 10 ) ;
if ( F_8 ( V_146 -> V_148 == NULL ) )
goto V_150;
V_144 -> V_151 = V_146 ;
V_19 -> V_26 . V_152 = V_62 -> V_152 ;
return 0 ;
V_150:
F_76 ( V_146 ) ;
return V_24 ;
}
static long F_90 ( struct V_153 * V_154 , unsigned int V_155 ,
unsigned long V_156 )
{
struct V_143 * V_144 = V_154 -> V_157 ;
struct V_61 * V_62 = V_144 -> V_158 -> V_62 ;
unsigned int V_159 = F_91 ( V_155 ) ;
if ( ( V_159 >= V_160 ) && ( V_159 < V_161 )
&& ( V_159 < V_160 + V_62 -> V_162 -> V_163 ) ) {
struct V_164 * V_165 =
& V_166 [ V_159 - V_160 ] ;
if ( F_8 ( V_165 -> V_167 != V_155 ) ) {
F_14 ( L_41 ,
V_159 - V_160 ) ;
return - V_168 ;
}
}
return F_92 ( V_154 , V_155 , V_156 ) ;
}
...
{
struct V_180 * V_181 ;
V_181 = F_35 ( sizeof( * V_181 ) , V_67 ) ;
if ( F_8 ( V_181 == NULL ) )
return - V_68 ;
F_45 ( V_181 ) ;
F_46 ( & V_181 -> V_109 , true , V_110 ) ;
V_185 -> V_151 = V_181 ;
return 0 ;
}
...
struct V_184 * V_185 )
{
struct V_180 * V_181 = V_180 ( V_185 ) ;
V_185 -> V_151 = NULL ;
F_76 ( V_181 ) ;
}
...
struct V_18 * V_19 = F_78 ( V_62 ) ;
struct V_145 * V_146 = V_145 ( V_144 ) ;
struct V_180 * V_187 = V_19 -> V_111 ;
struct V_180 * V_181 = V_180 ( V_144 -> V_185 ) ;
int V_24 = 0 ;
if ( ! V_19 -> V_87 ) {
V_24 = F_26 ( V_19 , true ) ;
if ( F_8 ( V_24 != 0 ) )
...
if ( V_187 ) {
F_24 ( V_187 != & V_19 -> V_108 ) ;
V_24 = F_102 ( & V_187 -> V_109 , false , V_146 -> V_148 ) ;
if ( F_8 ( V_24 != 0 ) )
goto V_189;
F_46 ( & V_187 -> V_109 , true , V_110 ) ;
...
F_46 ( & V_181 -> V_109 , false , V_110 ) ;
if ( ! V_186 ) {
F_104 ( & V_181 -> V_109 ) ;
F_24 ( V_146 -> V_149 != V_144 -> V_185 ) ;
F_87 ( & V_146 -> V_149 ) ;
}
V_19 -> V_111 = V_181 ;
return 0 ;
...
struct V_180 * V_181 = V_180 ( V_144 -> V_185 ) ;
int V_24 ;
V_146 -> V_149 = F_106 ( V_144 -> V_185 ) ;
V_24 = F_102 ( & V_181 -> V_109 , false , V_146 -> V_148 ) ;
F_107 ( V_19 ) ;
if ( F_8 ( ( V_24 != 0 ) ) ) {
F_14 ( L_44 ) ;
F_87 ( & V_146 -> V_149 ) ;
...
static void F_109 ( struct V_191 * V_69 )
{
struct V_61 * V_62 = F_110 ( V_69 ) ;
F_111 ( V_62 ) ;
}
static int V_138 ( struct V_192 * V_193 , unsigned long V_194 ,
void * V_195 )
{
struct V_18 * V_19 =
F_112 ( V_193 , struct V_18 , V_136 ) ;
struct V_180 * V_181 = V_19 -> V_111 ;
switch ( V_194 ) {
case V_196 :
case V_197 :
F_113 ( & V_181 -> V_109 ) ;
...
static int F_117 ( struct V_191 * V_69 , T_4 V_33 )
{
struct V_61 * V_62 = F_110 ( V_69 ) ;
struct V_18 * V_19 = F_78 ( V_62 ) ;
if ( V_19 -> V_45 != 0 ) {
...
static int F_121 ( struct V_191 * V_69 )
{
F_120 ( V_69 , V_204 ) ;
F_122 ( V_69 ) ;
return F_123 ( V_69 ) ;
}
static int F_124 ( struct V_205 * V_206 )
{
struct V_191 * V_69 = F_125 ( V_206 ) ;
struct V_207 V_23 ;
V_23 . V_208 = 0 ;
...
static int F_129 ( struct V_191 * V_69 , const struct V_210 * V_211 )
{
return F_130 ( V_69 , V_211 , & V_162 ) ;
}
static int T_5 F_131 ( void )
{
int V_24 ;
V_24 = F_132 ( & V_162 , & V_212 ) ;
if ( V_24 )
F_14 ( L_48 ) ;
return V_24 ;
}
