...
unsigned V_277 = F_273 ( V_35 -> V_43 , V_270 ) ;
if ( V_277 == V_35 -> V_43 )
V_178 -> V_35 = V_35 -> V_192 ;
F_21 ( V_178 , V_35 , V_277 , error ) ;
V_271 += V_277 ;
V_270 -= V_277 ;
if ( ! V_270 )
break;
...
F_150 ( F_165 ( V_178 ) ) ;
if ( F_24 ( V_279 ) && V_178 -> V_49 == V_201 )
...
unsigned int V_270 , unsigned int V_278 )
{
struct V_11 * V_12 = V_2 -> V_12 ;
unsigned long V_63 ;
if ( F_275 ( V_2 , error , V_270 , V_278 ) )
return true ;
F_58 ( V_12 -> V_56 , V_63 ) ;
F_279 ( V_2 , error ) ;
F_59 ( V_12 -> V_56 , V_63 ) ;
...
if ( F_24 ( F_268 ( V_2 ) ) )
V_278 = F_32 ( V_2 -> V_269 ) ;
V_280 = F_281 ( V_2 , error , F_32 ( V_2 ) , V_278 ) ;
F_150 ( V_280 ) ;
}
...
if ( F_24 ( F_268 ( V_2 ) ) )
V_278 = F_32 ( V_2 -> V_269 ) ;
V_280 = F_282 ( V_2 , error , F_32 ( V_2 ) , V_278 ) ;
F_150 ( V_280 ) ;
}
...
{
V_288 -> V_7 = V_289 -> V_7 ;
V_288 -> V_40 = ( V_289 -> V_40 & V_290 ) | V_291 ;
V_288 -> V_49 = V_289 -> V_49 ;
V_288 -> V_23 = F_7 ( V_289 ) ;
V_288 -> V_187 = F_32 ( V_289 ) ;
V_288 -> V_189 = V_289 -> V_189 ;
V_288 -> V_193 = V_289 -> V_193 ;
V_288 -> V_292 = V_289 -> V_292 ;
}
int F_298 ( struct V_1 * V_2 , struct V_1 * V_293 ,
struct V_294 * V_295 , T_2 V_87 ,
...
{
return F_41 ( V_58 , V_301 , V_302 ) ;
}
void F_305 ( struct V_196 * V_197 )
{
struct V_303 * V_304 = V_146 ;
V_197 -> V_305 = V_306 ;
F_17 ( & V_197 -> V_213 ) ;
F_17 ( & V_197 -> V_307 ) ;
if ( ! V_304 -> V_197 ) {
...
static int F_306 ( void * V_308 , struct V_309 * V_310 , struct V_309 * V_221 )
{
struct V_1 * V_311 = F_34 ( V_310 , struct V_1 , V_21 ) ;
struct V_1 * V_312 = F_34 ( V_221 , struct V_1 , V_21 ) ;
...
return V_317 ;
F_150 ( V_320 < sizeof( * V_317 ) ) ;
V_317 = F_317 ( V_320 , V_241 ) ;
if ( V_317 ) {
V_317 -> V_296 = V_296 ;
V_317 -> V_318 = V_319 ;
...
void F_205 ( struct V_196 * V_197 , bool V_314 )
{
struct V_11 * V_12 ;
unsigned long V_63 ;
struct V_1 * V_2 ;
...
void F_325 ( struct V_11 * V_12 , struct V_323 * V_163 )
{
V_12 -> V_163 = V_163 ;
V_12 -> V_257 = V_259 ;
F_326 ( V_12 -> V_163 , - 1 ) ;
...
F_336 ( L_30 ) ;
V_96 = F_337 ( L_31 ,
sizeof( struct V_1 ) , 0 , V_331 , NULL ) ;
V_102 = F_337 ( L_32 ,
sizeof( struct V_11 ) , 0 , V_331 , NULL ) ;
return 0 ;
}
