...
V_2 -> V_6 = V_6 ;
V_2 -> V_8 = V_45 -> V_47 ;
V_2 -> V_17 = V_6 -> V_52 ? V_6 -> V_52 -> V_53 [ V_2 -> V_8 ] . V_17
: V_54 ;
V_2 -> V_35 = 0 ;
V_2 -> V_41 = 0 ;
V_2 -> V_39 = 0 ;
...
int V_55 , int V_56 )
{
static const unsigned int V_57 [] = { 1 , 4 , 16 , 64 } ;
struct V_1 * V_2 = F_21 ( V_45 ) ;
struct V_46 * V_6 = F_17 ( V_43 ) ;
unsigned int V_35 ;
bool V_58 = false ;
...
int V_29 ;
V_59 = F_24 ( V_6 -> V_31 ) ;
for ( V_35 = 0 ; V_35 < F_25 ( V_57 ) ; ++ V_35 ) {
V_41 = V_59 / V_57 [ V_35 ]
/ ( V_60 / V_56 ) ;
if ( V_41 <= 0xffff )
break;
}
if ( V_35 == F_25 ( V_57 ) || V_41 == 0 ) {
...
F_4 ( & V_6 -> V_13 -> V_14 ,
L_8 ,
V_59 , V_57 [ V_35 ] , V_41 , V_39 ) ;
if ( V_2 -> V_35 == V_35 && V_2 -> V_41 == V_41 )
V_58 = true ;
V_2 -> V_35 = V_35 ;
V_2 -> V_41 = V_41 ;
V_2 -> V_39 = V_39 ;
if ( ! F_26 ( V_62 , & V_45 -> V_26 ) )
return 0 ;
if ( V_58 && V_2 -> V_30 ) {
F_1 ( V_2 , V_38 , V_2 -> V_39 ) ;
...
static int F_30 ( struct V_64 * V_13 )
{
struct V_46 * V_6 ;
struct V_65 * V_66 ;
int V_29 ;
V_6 = F_31 ( & V_13 -> V_14 , sizeof( * V_6 ) , V_50 ) ;
if ( V_6 == NULL ) {
F_12 ( & V_13 -> V_14 , L_10 ) ;
return - V_51 ;
}
V_6 -> V_52 = V_13 -> V_14 . V_67 ;
V_66 = F_32 ( V_13 , V_68 , 0 ) ;
if ( ! V_66 ) {
F_12 ( & V_13 -> V_14 , L_11 ) ;
return - V_69 ;
}
V_6 -> V_5 = F_33 ( & V_13 -> V_14 , V_66 ) ;
if ( F_34 ( V_6 -> V_5 ) )
return F_35 ( V_6 -> V_5 ) ;
V_6 -> V_31 = F_36 ( & V_13 -> V_14 , NULL ) ;
if ( F_34 ( V_6 -> V_31 ) ) {
F_12 ( & V_13 -> V_14 , L_12 ) ;
return F_35 ( V_6 -> V_31 ) ;
}
F_37 ( V_13 , V_6 ) ;
F_38 ( & V_6 -> V_27 ) ;
V_6 -> V_13 = V_13 ;
...
F_40 ( & V_13 -> V_14 , L_14 , V_6 -> V_13 -> V_73 ) ;
F_41 ( & V_13 -> V_14 ) ;
return 0 ;
}
static int F_42 ( struct V_64 * V_13 )
{
struct V_46 * V_6 = F_43 ( V_13 ) ;
int V_29 ;
V_29 = F_44 ( & V_6 -> V_43 ) ;
if ( V_29 )
return V_29 ;
