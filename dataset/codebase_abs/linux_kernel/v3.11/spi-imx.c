...
if ( ! V_127 && ! V_133 ) {
F_58 ( & V_125 -> V_123 , L_4 ) ;
return - V_139 ;
}
V_137 = F_59 ( V_127 , L_5 , & V_138 ) ;
if ( V_137 < 0 ) {
if ( V_133 )
V_138 = V_133 -> V_140 ;
else
...
V_92 = F_60 ( & V_125 -> V_123 ,
sizeof( struct V_1 ) + sizeof( int ) * V_138 ) ;
if ( ! V_92 )
return - V_141 ;
F_61 ( V_125 , V_92 ) ;
V_92 -> V_142 = F_62 ( 1 , 32 ) ;
V_92 -> V_143 = V_125 -> V_144 ;
V_92 -> V_140 = V_138 ;
V_18 = F_41 ( V_92 ) ;
V_18 -> V_145 . V_92 = F_63 ( V_92 ) ;
for ( V_11 = 0 ; V_11 < V_92 -> V_140 ; V_11 ++ ) {
int V_146 = F_64 ( V_127 , L_6 , V_11 ) ;
if ( ! F_42 ( V_146 ) && V_133 )
V_146 = V_133 -> V_56 [ V_11 ] ;
V_18 -> V_56 [ V_11 ] = V_146 ;
if ( ! F_42 ( V_146 ) )
continue;
V_137 = F_65 ( V_18 -> V_56 [ V_11 ] , V_147 ) ;
if ( V_137 ) {
F_58 ( & V_125 -> V_123 , L_7 ) ;
goto V_148;
}
}
V_18 -> V_145 . V_56 = F_40 ;
V_18 -> V_145 . V_149 = F_47 ;
V_18 -> V_145 . V_150 = F_48 ;
V_18 -> V_145 . V_92 -> V_151 = F_51 ;
V_18 -> V_145 . V_92 -> V_152 = F_54 ;
V_18 -> V_145 . V_92 -> V_153 = V_43 | V_42 | V_44 ;
F_49 ( & V_18 -> V_108 ) ;
V_18 -> V_3 = V_130 ? V_130 -> V_154 :
(struct V_155 * ) V_125 -> V_156 -> V_157 ;
V_136 = F_66 ( V_125 , V_158 , 0 ) ;
if ( ! V_136 ) {
F_58 ( & V_125 -> V_123 , L_8 ) ;
V_137 = - V_141 ;
goto V_148;
}
if ( ! F_67 ( V_136 -> V_159 , F_68 ( V_136 ) , V_125 -> V_160 ) ) {
F_58 ( & V_125 -> V_123 , L_9 ) ;
V_137 = - V_161 ;
goto V_148;
}
V_18 -> V_25 = F_69 ( V_136 -> V_159 , F_68 ( V_136 ) ) ;
if ( ! V_18 -> V_25 ) {
V_137 = - V_139 ;
goto V_162;
}
V_18 -> V_102 = F_70 ( V_125 , 0 ) ;
if ( V_18 -> V_102 < 0 ) {
V_137 = - V_139 ;
goto V_163;
}
V_137 = F_71 ( V_18 -> V_102 , F_45 , 0 , V_147 , V_18 ) ;
if ( V_137 ) {
F_58 ( & V_125 -> V_123 , L_10 , V_18 -> V_102 , V_137 ) ;
goto V_163;
}
V_18 -> V_164 = F_72 ( & V_125 -> V_123 , L_11 ) ;
if ( F_73 ( V_18 -> V_164 ) ) {
V_137 = F_74 ( V_18 -> V_164 ) ;
goto V_165;
}
V_18 -> V_166 = F_72 ( & V_125 -> V_123 , L_12 ) ;
if ( F_73 ( V_18 -> V_166 ) ) {
V_137 = F_74 ( V_18 -> V_166 ) ;
goto V_165;
}
F_75 ( V_18 -> V_166 ) ;
F_75 ( V_18 -> V_164 ) ;
V_18 -> V_36 = F_76 ( V_18 -> V_166 ) ;
V_18 -> V_3 -> V_167 ( V_18 ) ;
V_18 -> V_3 -> V_107 ( V_18 , 0 ) ;
V_92 -> V_123 . V_128 = V_125 -> V_123 . V_128 ;
V_137 = F_77 ( & V_18 -> V_145 ) ;
if ( V_137 ) {
F_58 ( & V_125 -> V_123 , L_13 , V_137 ) ;
goto V_168;
}
F_78 ( & V_125 -> V_123 , L_14 ) ;
return V_137 ;
V_168:
F_79 ( V_18 -> V_166 ) ;
F_79 ( V_18 -> V_164 ) ;
V_165:
F_80 ( V_18 -> V_102 , V_18 ) ;
V_163:
F_81 ( V_18 -> V_25 ) ;
V_162:
F_82 ( V_136 -> V_159 , F_68 ( V_136 ) ) ;
V_148:
while ( -- V_11 >= 0 ) {
if ( F_42 ( V_18 -> V_56 [ V_11 ] ) )
F_83 ( V_18 -> V_56 [ V_11 ] ) ;
}
F_84 ( V_92 ) ;
F_85 ( V_92 ) ;
...
{
struct V_134 * V_92 = F_87 ( V_125 ) ;
struct V_135 * V_136 = F_66 ( V_125 , V_158 , 0 ) ;
