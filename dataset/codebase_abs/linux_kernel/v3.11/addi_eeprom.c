...
unsigned short V_9 )
{
const struct V_22 * V_23 = F_13 ( V_21 ) ;
...
V_10 = F_11 ( V_1 , type , V_9 + 6 ) ;
V_25 -> V_28 . V_30 = V_10 ;
V_25 -> V_28 . V_31 = 0xffffffff >> ( 32 - V_10 ) ;
}
...
unsigned short V_10 ;
V_10 = F_11 ( V_1 , type , V_9 + 10 ) ;
V_25 -> V_28 . V_33 = ( V_10 >> 4 ) & 0x3ff ;
V_10 = F_11 ( V_1 , type , V_9 + 16 ) ;
V_10 = ( V_10 >> 8 ) & 0xff ;
V_25 -> V_28 . V_34 = 0xfff >> ( 16 - V_10 ) ;
}
...
unsigned short V_10 ;
V_10 = F_11 ( V_1 , type , V_9 + 10 ) ;
V_25 -> V_28 . V_36 = ( V_10 >> 4 ) & 0x3ff ;
if ( ! strcmp ( V_23 -> V_37 , L_4 ) )
V_25 -> V_28 . V_36 *= 4 ;
V_10 = F_11 ( V_1 , type , V_9 + 16 ) ;
V_25 -> V_28 . V_38 = V_10 * 1000 ;
V_10 = F_11 ( V_1 , type , V_9 + 30 ) ;
V_25 -> V_28 . V_39 = V_10 * 1000 ;
V_10 = F_11 ( V_1 , type , V_9 + 20 ) ;
V_10 = F_11 ( V_1 , type , V_9 + 72 ) & 0xff ;
if ( V_10 ) {
V_35 = 74 + ( 2 * V_10 ) + ( 10 * ( 1 + ( V_10 / 16 ) ) ) ;
} else {
V_35 = 74 ;
}
V_10 = F_11 ( V_1 , type , V_9 + V_35 + 2 ) & 0x1f ;
V_25 -> V_28 . V_40 = 0xffff >> ( 16 - V_10 ) ;
}
...
unsigned char V_42 ;
int V_7 ;
V_41 = F_11 ( V_1 , type , 8 ) ;
V_42 = F_11 ( V_1 , type , 10 ) & 0xff ;
for ( V_7 = 0 ; V_7 < V_42 ; V_7 ++ ) {
unsigned short V_35 = V_7 * 4 ;
unsigned short V_9 ;
unsigned char V_43 ;
V_43 = F_11 ( V_1 , type , 12 + V_35 ) & 0x3f ;
V_9 = F_11 ( V_1 , type , 14 + V_35 ) ;
switch ( V_43 ) {
case V_44 :
F_12 ( V_21 , V_1 , V_9 ) ;
break;
