...
F_153 ( V_264 , & V_3 -> V_173 , & V_3 -> V_174 ) ;
V_3 -> V_272 = V_329 ;
...
static int F_155 ( struct V_258 * V_4 , enum V_337 V_338 ,
unsigned long V_339 )
{
struct V_2 * V_3 = F_87 ( V_4 , struct V_2 , V_4 ) ;
if ( V_3 -> V_11 == NULL ) {
...
static void T_9 F_156 ( struct V_109 * V_8 , struct V_345 * V_346 ,
...
F_24 ( & V_3 -> V_44 ) ;
F_24 ( & V_3 -> V_133 ) ;
F_158 ( & V_3 -> V_193 , F_93 ,
( unsigned long ) V_3 ) ;
F_28 ( & V_3 -> V_4 . V_350 ,
& V_346 -> V_349 ) ;
}
}
static void F_159 ( struct V_109 * V_8 , struct V_345 * V_5 )
{
...
static int T_9 F_160 ( struct V_109 * V_8 ,
int V_363 )
{
int V_192 ;
F_156 ( V_8 , & V_8 -> V_364 , V_8 -> V_365 ,
0 , V_8 -> V_216 ) ;
F_127 ( V_8 -> V_364 . V_244 ) ;
F_128 ( V_246 , V_8 -> V_364 . V_244 ) ;
F_128 ( V_356 , V_8 -> V_364 . V_244 ) ;
F_159 ( V_8 , & V_8 -> V_364 ) ;
V_192 = F_161 ( & V_8 -> V_364 ) ;
if ( V_192 ) {
F_99 ( V_8 -> V_5 , L_46 ) ;
goto V_366;
}
F_156 ( V_8 , & V_8 -> V_367 , V_8 -> V_365 ,
V_8 -> V_216 , V_8 -> V_368 ) ;
F_127 ( V_8 -> V_367 . V_244 ) ;
F_128 ( V_245 , V_8 -> V_367 . V_244 ) ;
F_128 ( V_354 , V_8 -> V_367 . V_244 ) ;
F_159 ( V_8 , & V_8 -> V_367 ) ;
V_192 = F_161 ( & V_8 -> V_367 ) ;
if ( V_192 ) {
F_99 ( V_8 -> V_5 ,
L_47 ) ;
goto V_369;
}
F_156 ( V_8 , & V_8 -> V_370 , V_8 -> V_371 ,
0 , V_363 ) ;
...
{
struct V_373 * V_374 = F_164 ( V_5 ) ;
struct V_109 * V_8 = F_165 ( V_374 ) ;
int V_34 = 0 ;
if ( V_8 -> V_375 )
V_34 = F_166 ( V_8 -> V_375 ) ;
return V_34 ;
}
...
int V_34 = 0 ;
if ( V_8 -> V_375 )
V_34 = F_170 ( V_8 -> V_375 ) ;
return V_34 ;
}
static int T_9 F_171 ( struct V_109 * V_8 )
{
int V_33 ;
int V_380 = 0 ;
T_2 V_148 [ 2 ] ;
...
static struct V_109 * T_9 F_175 ( struct V_373 * V_374 )
{
struct V_392 * V_74 = V_374 -> V_5 . V_393 ;
...
V_187 = F_179 ( V_374 , V_400 , L_53 ) ;
if ( ! V_187 )
goto V_399;
if ( F_180 ( V_187 -> V_401 , F_181 ( V_187 ) ,
V_402 L_54 ) == NULL )
goto V_399;
V_9 = F_182 ( V_187 -> V_401 , F_181 ( V_187 ) ) ;
if ( ! V_9 )
goto V_399;
for ( V_397 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_397 |= ( F_58 ( V_9 + F_181 ( V_187 ) - 0x20 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
for ( V_398 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_398 |= ( F_58 ( V_9 + F_181 ( V_187 ) - 0x10 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
if ( V_398 != V_403 ) {
F_99 ( & V_374 -> V_5 , L_55 ) ;
goto V_399;
}
if ( F_183 ( V_397 ) != V_404 ) {
F_99 ( & V_374 -> V_5 , L_56 ,
F_183 ( V_397 ) ,
V_404 ) ;
goto V_399;
...
F_174 ( & V_374 -> V_5 ,
L_58 ,
V_287 , V_187 -> V_401 , V_110 , V_216 ) ;
V_8 = F_185 ( F_47 ( sizeof( struct V_109 ) , 4 ) +
( V_110 + V_216 + V_368 ) *
...
V_8 -> V_117 . V_283 = V_418 ;
V_8 -> V_117 . V_284 = V_419 ;
V_8 -> V_117 . V_285 = V_420 ;
V_8 -> V_117 . V_286 = V_421 ;
V_8 -> V_117 . V_203 = V_422 ;
V_8 -> V_117 . V_201 = F_56 ( V_422 ) ;
...
V_8 -> V_117 . V_283 = V_430 ;
V_8 -> V_117 . V_284 = V_431 ;
V_8 -> V_117 . V_285 = V_432 ;
V_8 -> V_117 . V_286 = V_433 ;
V_8 -> V_117 . V_203 = V_434 ;
V_8 -> V_117 . V_201 = F_56 ( V_434 ) ;
V_8 -> V_117 . V_423 = V_435 ;
V_8 -> V_117 . V_425 = F_56 ( V_435 ) ;
}
V_8 -> V_111 = F_185 ( V_110 * sizeof( struct V_218 ) ,
V_409 ) ;
if ( ! V_8 -> V_111 )
goto V_399;
V_8 -> V_207 = F_185 ( V_110 *
sizeof( struct V_2 * ) ,
V_409 ) ;
if ( ! V_8 -> V_207 )
goto V_399;
V_8 -> V_208 = F_185 ( V_216 *
sizeof( struct V_2 * ) ,
V_409 ) ;
if ( ! V_8 -> V_208 )
goto V_399;
...
goto V_399;
V_8 -> V_36 . V_40 =
F_185 ( V_110 * sizeof( struct V_14 * )
* V_38 , V_409 ) ;
if ( ! V_8 -> V_36 . V_40 )
goto V_399;
V_8 -> V_48 = F_186 ( V_402 , sizeof( struct V_14 ) ,
0 , V_436 ,
NULL ) ;
if ( V_8 -> V_48 == NULL )
goto V_399;
...
static void T_9 F_191 ( struct V_109 * V_8 )
{
int V_33 ;
T_2 V_437 [ 2 ] = { 0 , 0 } ;
...
static int T_9 F_192 ( struct V_109 * V_8 )
{
...
V_445 [ V_33 ] = F_193 ( V_409 ,
V_8 -> V_36 . V_447 ) ;
if ( ! V_445 [ V_33 ] ) {
F_99 ( V_8 -> V_5 , L_60 ,
V_8 -> V_36 . V_447 ) ;
for ( V_235 = 0 ; V_235 < V_33 ; V_235 ++ )
F_194 ( V_445 [ V_235 ] , V_8 -> V_36 . V_447 ) ;
goto V_399;
}
...
static int T_9 F_196 ( struct V_373 * V_374 ,
struct V_350 * V_453 )
{
struct V_392 * V_454 ;
int V_455 = 0 , V_456 = 0 , V_457 = 0 ;
const const T_11 * V_458 ;
V_454 = F_197 ( & V_374 -> V_5 ,
sizeof( struct V_392 ) ,
V_409 ) ;
if ( ! V_454 )
return - V_25 ;
F_198 ( V_453 , L_62 , & V_455 ) ;
if ( V_455 > 0 )
V_454 -> V_405 = V_455 ;
V_458 = F_199 ( V_453 , L_63 , & V_456 ) ;
V_456 /= sizeof( * V_458 ) ;
...
V_457 ) ;
V_454 -> V_388 [ V_457 ] = - 1 ;
V_374 -> V_5 . V_393 = V_454 ;
return 0 ;
}
static int T_9 F_201 ( struct V_373 * V_374 )
{
struct V_392 * V_74 = V_374 -> V_5 . V_393 ;
struct V_350 * V_453 = V_374 -> V_5 . V_461 ;
int V_34 = - V_462 ;
struct V_109 * V_8 = NULL ;
struct V_395 * V_187 = NULL ;
int V_363 ;
...
F_157 ( & V_8 -> V_204 ) ;
F_157 ( & V_8 -> V_127 ) ;
V_187 = F_179 ( V_374 , V_400 , L_68 ) ;
if ( ! V_187 ) {
V_34 = - V_462 ;
F_99 ( & V_374 -> V_5 , L_69 ) ;
goto V_399;
}
V_8 -> V_463 = F_181 ( V_187 ) ;
V_8 -> V_464 = V_187 -> V_401 ;
if ( F_180 ( V_187 -> V_401 , F_181 ( V_187 ) ,
V_402 L_70 ) == NULL ) {
V_34 = - V_132 ;
F_99 ( & V_374 -> V_5 ,
L_71 ,
V_187 -> V_401 , V_187 -> V_465 ) ;
goto V_399;
}
...
V_8 -> V_296 = F_182 ( V_187 -> V_401 , F_181 ( V_187 ) ) ;
if ( ! V_8 -> V_296 ) {
V_34 = - V_25 ;
F_99 ( & V_374 -> V_5 , L_73 ) ;
goto V_399;
...
V_8 -> V_36 . V_8 = F_182 ( V_187 -> V_401 ,
F_181 ( V_187 ) ) ;
if ( ! V_8 -> V_36 . V_8 ) {
V_34 = - V_25 ;
F_99 ( & V_374 -> V_5 , L_76 ) ;
...
F_157 ( & V_8 -> V_36 . V_37 ) ;
V_8 -> V_198 = F_203 ( V_374 , 0 ) ;
V_34 = F_204 ( V_8 -> V_198 , F_95 , 0 , V_402 , V_8 ) ;
if ( V_34 ) {
F_99 ( & V_374 -> V_5 , L_78 ) ;
goto V_399;
}
...
F_209 ( V_8 -> V_5 ) ;
if ( V_8 -> V_74 -> V_73 ) {
V_8 -> V_375 = F_210 ( V_8 -> V_5 , L_74 ) ;
if ( F_177 ( V_8 -> V_375 ) ) {
F_99 ( & V_374 -> V_5 , L_79 ) ;
V_34 = F_211 ( V_8 -> V_375 ) ;
V_8 -> V_375 = NULL ;
goto V_399;
}
V_34 = F_170 ( V_8 -> V_375 ) ;
...
V_8 -> V_378 = true ;
V_34 = F_160 ( V_8 , V_363 ) ;
if ( V_34 )
goto V_399;
V_8 -> V_5 -> V_468 = & V_8 -> V_468 ;
V_34 = F_213 ( V_8 -> V_5 , V_98 ) ;
if ( V_34 ) {
F_99 ( & V_374 -> V_5 , L_81 ) ;
goto V_399;
}
...
F_194 ( ( unsigned long ) V_8 -> V_36 . V_8 ,
V_8 -> V_36 . V_447 ) ;
F_10 ( V_8 -> V_36 . V_451 ) ;
if ( V_8 -> V_464 )
F_190 ( V_8 -> V_464 ,
