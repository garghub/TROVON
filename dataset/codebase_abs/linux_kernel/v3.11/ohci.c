...
V_26 = ( F_53 ( V_4 -> V_273 [ 0 ] ) >> 16 ) & 0xff ;
F_48 () ;
for ( V_49 = 1 , V_261 = 0 ; V_261 < V_27 ; V_49 += 2 , V_261 ++ ) {
T_1 V_274 = F_53 ( V_4 -> V_273 [ V_49 ] ) ;
T_1 V_275 = F_53 ( V_4 -> V_273 [ V_49 + 1 ] ) ;
if ( V_274 != ~ V_275 ) {
if ( V_274 == 0xffff008f ) {
F_4 ( V_4 , L_51 ) ;
V_27 = V_261 ;
...
F_4 ( V_4 , L_52 ,
V_261 , V_27 , V_274 , V_275 ) ;
return;
}
V_4 -> V_30 [ V_261 ] = V_274 ;
}
if ( V_4 -> V_116 & V_276 ) {
V_27 = F_123 ( V_4 , V_27 ) ;
if ( V_27 < 0 ) {
...
static T_8 F_129 ( int V_287 , void * V_44 )
{
struct V_1 * V_4 = V_44 ;
T_1 V_288 , V_289 ;
int V_49 ;
V_288 = F_13 ( V_4 , V_277 ) ;
if ( ! V_288 || ! ~ V_288 )
return V_290 ;
F_11 ( V_4 , V_277 ,
V_288 & ~ ( V_9 | V_17 ) ) ;
F_2 ( V_4 , V_288 ) ;
if ( V_288 & V_10 )
F_130 ( V_291 , & V_4 -> F_124 ) ;
if ( V_288 & V_11 )
F_131 ( & V_4 -> V_118 . V_126 ) ;
if ( V_288 & V_12 )
F_131 ( & V_4 -> V_292 . V_126 ) ;
if ( V_288 & V_13 )
...
static void F_137 ( V_41 * V_302 , const V_41 * V_303 , T_9 V_94 )
{
T_9 V_304 = V_94 * 4 ;
...
if ( ! ( V_4 -> V_116 & V_320 ) )
F_19 ( 50 ) ;
for ( V_315 = 0 , V_49 = 0 ; ! V_315 && V_49 < 150 ; V_49 ++ ) {
F_19 ( 1 ) ;
...
static T_1 F_148 ( struct V_2 * V_3 , int V_352 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
T_1 V_353 ;
...
static void F_150 ( struct V_2 * V_3 , int V_352 , T_1 V_353 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
switch ( V_352 ) {
...
F_11 ( V_4 , V_326 , V_353 ) ;
F_15 ( V_4 ) ;
break;
case V_362 :
F_11 ( V_4 , V_334 , V_353 & 0x3f ) ;
F_15 ( V_4 ) ;
break;
default:
F_149 ( 1 ) ;
...
static void F_151 ( struct V_365 * V_63 )
{
...
static void F_152 ( struct V_365 * V_63 , const T_1 * V_370 )
{
T_1 * V_371 ;
...
V_371 [ 0 ] = F_153 ( V_370 [ 1 ] ) ;
if ( V_63 -> V_366 . V_372 > 4 )
V_371 [ 1 ] = F_153 ( V_370 [ 0 ] ) ;
...
static void F_157 ( struct V_365 * V_63 )
{
...
static void F_160 ( struct V_1 * V_4 , T_6 V_382 )
{
...
static struct V_390 * F_162 ( struct V_2 * V_3 ,
...
V_392 = & V_4 -> V_397 ;
V_153 = F_154 ;
V_65 = * V_382 & 1ULL << V_391 ? F_132 ( * V_392 ) - 1 : - 1 ;
if ( V_65 >= 0 ) {
* V_382 &= ~ ( 1ULL << V_391 ) ;
* V_392 &= ~ ( 1 << V_65 ) ;
V_74 = F_114 ( V_65 ) ;
...
V_392 = & V_4 -> V_397 ;
V_153 = F_156 ;
V_65 = ! V_4 -> V_399 ? F_132 ( * V_392 ) - 1 : - 1 ;
if ( V_65 >= 0 ) {
V_4 -> V_399 = true ;
* V_392 &= ~ ( 1 << V_65 ) ;
V_74 = F_114 ( V_65 ) ;
...
static int F_166 ( struct V_390 * V_366 ,
...
F_11 ( V_4 , F_167 ( V_63 -> V_143 . V_74 ) , V_406 ) ;
...
static int F_168 ( struct V_390 * V_366 )
{
...
static void F_170 ( struct V_390 * V_366 )
{
struct V_1 * V_4 = V_1 ( V_366 -> V_3 ) ;
struct V_365 * V_63 = F_1 ( V_366 , struct V_365 , V_366 ) ;
unsigned long V_154 ;
...
static int F_171 ( struct V_390 * V_366 , T_6 * V_382 )
{
struct V_1 * V_4 = V_1 ( V_366 -> V_3 ) ;
unsigned long V_154 ;
int V_57 ;
...
V_63 = & V_4 -> V_294 [ V_49 ] ;
if ( V_63 -> V_143 . V_168 )
F_166 ( & V_63 -> V_366 , 0 , V_63 -> V_403 , V_63 -> V_404 ) ;
}
...
static int F_173 ( struct V_365 * V_63 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
...
if ( V_92 -> V_98 > 0 )
V_141 ++ ;
V_426 = F_174 ( V_423 + V_92 -> V_99 ) >> V_428 ;
if ( V_92 -> V_99 > 0 )
V_422 = V_426 - ( V_423 >> V_428 ) ;
else
V_422 = 0 ;
V_141 += V_422 ;
V_421 = F_175 ( V_92 -> V_98 , sizeof( * V_67 ) ) ;
...
V_34 = ( T_4 * ) & V_67 [ 1 ] ;
V_34 [ 0 ] = F_33 ( F_176 ( V_92 -> V_429 ) |
F_177 ( V_92 -> V_430 ) |
F_178 ( V_181 ) |
F_179 ( V_63 -> V_366 . V_391 ) |
F_180 ( V_63 -> V_366 . V_31 ) ) ;
V_34 [ 1 ] =
...
static int F_184 ( struct V_365 * V_63 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
...
V_372 = F_185 ( V_63 -> V_366 . V_372 , ( T_9 ) 8 ) ;
V_421 = F_175 ( V_372 , sizeof( * V_67 ) ) ;
V_59 = V_109 >> V_428 ;
V_43 = V_109 & ~ V_377 ;
V_435 = V_174 -> V_99 / V_434 ;
for ( V_49 = 0 ; V_49 < V_434 ; V_49 ++ ) {
V_141 = F_175 ( V_435 + V_43 , V_71 ) + 1 ;
...
static int F_186 ( struct V_365 * V_63 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
...
V_43 = V_109 & ~ V_377 ;
V_433 = V_174 -> V_99 ;
V_141 = F_175 ( V_43 + V_433 , V_71 ) ;
if ( F_149 ( V_43 & 3 || V_433 & 3 || V_59 + V_141 > V_76 -> V_438 ) )
return - V_439 ;
...
static int F_187 ( struct V_390 * V_366 ,
struct V_418 * V_174 ,
struct V_419 * V_76 ,
unsigned long V_109 )
{
...
static void F_188 ( struct V_390 * V_366 )
{
struct V_143 * V_63 =
& F_1 ( V_366 , struct V_365 , V_366 ) -> V_143 ;
F_11 ( V_63 -> V_4 , F_36 ( V_63 -> V_74 ) , V_75 ) ;
}
static int F_189 ( struct V_390 * V_366 )
{
struct V_365 * V_63 = F_1 ( V_366 , struct V_365 , V_366 ) ;
int V_57 = 0 ;
F_96 ( & V_63 -> V_143 . V_126 ) ;
if ( ! F_190 ( 0 , & V_63 -> V_440 ) ) {
...
static void F_193 ( struct V_441 * V_442 )
{
if ( F_194 ( V_443 ) ) {
struct V_444 * V_445 = F_195 ( V_442 ) ;
if ( V_445 ) {
F_196 ( V_446 , V_445 , 0 , 1 ) ;
F_196 ( V_447 , V_445 , 0 , 1 ) ;
}
}
}
static void F_197 ( struct V_441 * V_442 )
{
if ( F_194 ( V_443 ) ) {
struct V_444 * V_445 = F_195 ( V_442 ) ;
if ( V_445 ) {
F_196 ( V_447 , V_445 , 0 , 0 ) ;
F_196 ( V_446 , V_445 , 0 , 0 ) ;
}
}
}
static inline void F_193 ( struct V_441 * V_442 ) {}
static inline void F_197 ( struct V_441 * V_442 ) {}
static int F_198 ( struct V_441 * V_442 ,
...
F_201 ( & V_4 -> V_3 , & V_458 , & V_442 -> V_442 ) ;
F_193 ( V_442 ) ;
V_454 = F_202 ( V_442 ) ;
if ( V_454 ) {
F_199 ( & V_442 -> V_442 , L_64 ) ;
goto V_459;
}
F_203 ( V_442 ) ;
F_204 ( V_442 , V_460 , 0 ) ;
...
if ( ! ( F_209 ( V_442 , 0 ) & V_461 ) ||
F_210 ( V_442 , 0 ) < V_462 ) {
F_20 ( V_4 , L_65 ) ;
V_454 = - V_463 ;
goto V_464;
}
V_454 = F_211 ( V_442 , 0 , V_465 ) ;
if ( V_454 ) {
F_20 ( V_4 , L_66 ) ;
goto V_464;
}
V_4 -> V_45 = F_212 ( V_442 , 0 , V_462 ) ;
if ( V_4 -> V_45 == NULL ) {
F_20 ( V_4 , L_67 ) ;
V_454 = - V_463 ;
goto V_466;
...
F_11 ( V_4 , V_414 , ~ 0 ) ;
V_4 -> V_397 = V_4 -> V_235 ;
V_4 -> V_416 = F_213 ( V_4 -> V_397 ) ;
V_304 = sizeof( struct V_365 ) * V_4 -> V_416 ;
V_4 -> V_294 = F_200 ( V_304 , V_127 ) ;
F_11 ( V_4 , V_409 , ~ 0 ) ;
V_4 -> V_234 = F_13 ( V_4 , V_409 ) ;
F_11 ( V_4 , V_413 , ~ 0 ) ;
V_4 -> V_394 = V_4 -> V_234 ;
V_4 -> V_417 = F_213 ( V_4 -> V_394 ) ;
V_304 = sizeof( struct V_365 ) * V_4 -> V_417 ;
V_4 -> V_296 = F_200 ( V_304 , V_127 ) ;
if ( V_4 -> V_296 == NULL || V_4 -> V_294 == NULL ) {
V_454 = - V_140 ;
goto V_481;
}
V_4 -> V_273 = V_4 -> V_131 + V_71 / 2 ;
V_4 -> V_324 = V_4 -> V_133 + V_71 / 2 ;
V_450 = F_13 ( V_4 , V_281 ) ;
V_451 = ( V_450 >> 12 ) & 0xf ;
V_452 = V_450 & 0x7 ;
...
V_454 = F_217 ( & V_4 -> V_3 , V_451 , V_452 , V_453 ) ;
if ( V_454 )
goto V_487;
V_316 = F_13 ( V_4 , V_46 ) & 0x00ff00ff ;
F_4 ( V_4 ,
...
static void F_224 ( struct V_441 * V_442 )
{
struct V_1 * V_4 = F_225 ( V_442 ) ;
...
F_136 ( V_4 ) ;
F_218 ( V_442 -> V_287 , V_4 ) ;
if ( V_4 -> V_278 && V_4 -> V_278 != V_4 -> V_206 )
F_83 ( V_4 -> V_3 . V_79 , V_202 ,
V_4 -> V_278 , V_4 -> V_280 ) ;
if ( V_4 -> V_206 )
F_83 ( V_4 -> V_3 . V_79 , V_202 ,
...
F_220 ( V_4 ) ;
F_197 ( V_442 ) ;
F_228 ( & V_442 -> V_442 , L_71 ) ;
}
static int F_229 ( struct V_441 * V_442 , T_11 V_488 )
{
struct V_1 * V_4 = F_225 ( V_442 ) ;
int V_454 ;
F_136 ( V_4 ) ;
...
V_454 = F_231 ( V_442 , F_232 ( V_442 , V_488 ) ) ;
if ( V_454 )
F_20 ( V_4 , L_73 , V_454 ) ;
F_197 ( V_442 ) ;
return 0 ;
}
static int F_233 ( struct V_441 * V_442 )
{
struct V_1 * V_4 = F_225 ( V_442 ) ;
int V_454 ;
F_193 ( V_442 ) ;
