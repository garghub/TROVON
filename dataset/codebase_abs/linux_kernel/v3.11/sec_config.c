...
if ( strncmp ( V_46 , V_103 , sizeof( V_103 ) - 1 ) != 0 ) {
F_3 ( L_30 , V_46 ) ;
RETURN ( - V_35 ) ;
}
V_46 += sizeof( V_103 ) - 1 ;
...
static int F_52 ( const char * V_106 , char * V_19 , int V_77 )
{
char * V_78 ;
int V_79 ;
V_78 = strrchr ( V_106 , '-' ) ;
...
V_79 = F_31 ( ( int ) ( V_78 - V_106 ) , V_77 - 1 ) ;
memcpy ( V_19 , V_106 , V_79 ) ;
V_19 [ V_79 ] = '\0' ;
return 0 ;
}
void F_53 ( const char * V_106 )
{
struct V_80 * V_81 ;
char V_76 [ 16 ] ;
if ( F_52 ( V_106 , V_76 , sizeof( V_76 ) ) )
return;
F_48 ( & V_104 ) ;
V_81 = F_43 ( V_76 , 0 ) ;
if ( V_81 && V_81 -> V_90 ) {
...
V_36 -> V_34 |= V_108 | V_109 ;
} else if ( V_66 == V_3 && V_67 == V_4 ) {
if ( V_107 && V_36 -> V_22 != V_37 )
V_36 -> V_34 |= V_110 ;
}
}
...
char V_93 [ V_101 ] ;
int V_79 , V_49 = 0 ;
F_30 ( V_97 -> V_112 , V_93 , sizeof( V_93 ) ) ;
F_48 ( & V_104 ) ;
V_81 = F_43 ( V_93 , 0 ) ;
if ( V_81 == NULL )
goto V_113;
V_79 = strlen ( V_97 -> V_112 ) ;
F_14 ( V_79 > 5 ) ;
memcpy ( V_93 , V_97 -> V_112 , V_79 - 5 ) ;
V_93 [ V_79 - 5 ] = '\0' ;
...
struct V_114 * V_115 ;
V_102 ;
F_14 ( strcmp ( V_10 -> V_11 -> V_12 , V_116 ) == 0 ||
strcmp ( V_10 -> V_11 -> V_12 , V_117 ) == 0 ) ;
F_25 ( V_70 , L_34 , V_10 -> V_118 . V_119 . V_120 . V_112 ) ;
F_61 ( & V_10 -> V_118 . V_119 . V_121 ) ;
V_115 = V_10 -> V_118 . V_119 . V_122 ;
if ( V_115 ) {
F_62 ( & V_115 -> V_123 ) ;
if ( V_115 -> V_124 )
V_115 -> V_125 = F_63 () +
...
V_128 = F_67 ( V_69 -> V_40 ) ;
if ( V_69 -> V_42 == V_8 && V_69 -> V_43 == V_8 )
V_127 [ 0 ] = '\0' ;
else
snprintf ( V_127 , sizeof( V_127 ) , L_35 ,
F_1 ( V_69 -> V_42 ) ,
F_1 ( V_69 -> V_43 ) ) ;
V_78 += snprintf ( V_19 , V_77 , L_36 , V_128 , V_127 ) ;
...
F_71 ( & V_132 , 1 , V_97 ) ;
F_71 ( & V_132 , 2 , V_46 ) ;
V_100 = F_72 ( V_135 , & V_132 ) ;
F_14 ( V_100 ) ;
V_77 = F_73 ( V_100 -> V_136 ,
V_100 -> V_137 ) ;
V_134 . V_138 = F_74 ( V_77 ) ;
V_134 . V_139 = V_140 ;
V_49 = F_75 ( NULL , V_130 , & V_134 , NULL , 0 , ( void * ) V_100 , - 1 ) ;
if ( V_49 )
F_3 ( L_37 , V_49 ) ;
F_76 ( V_100 ) ;
}
...
{
struct V_82 * V_83 ;
F_69 ( V_130 , V_81 -> V_91 , & V_81 -> V_85 ) ;
F_39 (conf_tgt, &conf->sc_tgts, sct_list) {
F_69 ( V_130 , V_83 -> V_95 ,
& V_83 -> V_86 ) ;
}
return 0 ;
}
...
int V_49 ;
V_102 ;
V_142 = F_79 ( V_10 , V_146 ) ;
if ( V_142 == NULL )
RETURN ( - V_35 ) ;
F_80 ( & V_144 , & V_10 -> V_147 , NULL ) ;
V_145 = F_81 ( V_148 , F_82 ( V_149 -> V_150 ) ,
strlen ( V_148 ) ) ;
if ( F_83 ( V_145 ) ) {
V_49 = F_84 ( V_145 ) ;
F_3 ( L_38 ,
...
V_49 = F_85 ( NULL , V_142 , NULL , V_152 ) ;
if ( V_49 < 0 && V_49 != - V_153 ) {
F_3 ( L_39 ,
V_10 -> V_154 , V_49 ) ;
GOTO ( V_155 , V_49 ) ;
}
V_49 = F_86 ( NULL , V_142 , & V_130 , NULL , V_152 ) ;
if ( V_49 )
GOTO ( V_155 , V_49 ) ;
V_49 = F_87 ( NULL , V_130 , V_156 , NULL ) ;
if ( V_49 )
GOTO ( V_157 , V_49 ) ;
V_49 = F_77 ( V_130 , V_81 ) ;
V_157:
F_88 ( NULL , V_130 ) ;
if ( V_49 == 0 )
V_49 = F_89 ( V_145 , V_10 -> V_147 . V_158 ,
V_152 , V_159 ) ;
V_155:
F_90 ( V_145 ) ;
V_151:
F_91 ( & V_144 , & V_10 -> V_147 , NULL ) ;
F_92 ( V_142 ) ;
F_25 ( V_70 , L_40 ,
V_10 -> V_154 , V_49 ) ;
RETURN ( V_49 ) ;
}
static int F_93 ( const struct V_160 * V_161 ,
struct V_129 * V_130 ,
struct V_133 * V_134 , void * V_162 )
{
struct V_80 * V_81 = (struct V_80 * ) V_162 ;
struct V_99 * V_100 = (struct V_99 * ) ( V_134 + 1 ) ;
int V_163 , V_49 ;
V_102 ;
if ( V_134 -> V_139 != V_140 ) {
F_3 ( L_41 , V_134 -> V_139 ) ;
RETURN ( - V_35 ) ;
}
V_163 = V_134 -> V_138 - sizeof( struct V_133 ) -
sizeof( struct V_164 ) ;
V_49 = F_94 ( V_100 , V_163 ) ;
if ( V_49 ) {
F_3 ( L_42 ) ;
RETURN ( V_49 ) ;
}
if ( V_100 -> V_165 != V_135 ) {
F_3 ( L_43 , V_100 -> V_165 ) ;
RETURN ( - V_35 ) ;
}
...
F_80 ( & V_144 , & V_10 -> V_147 , NULL ) ;
V_49 = F_96 ( NULL , V_142 , & V_130 , NULL , V_159 , V_166 ) ;
if ( V_49 < 0 ) {
if ( V_49 == - V_153 )
V_49 = 0 ;
GOTO ( V_167 , V_49 ) ;
...
V_49 = F_98 ( NULL , V_130 , F_93 , ( void * ) V_81 , NULL ) ;
if ( V_49 == 0 ) {
V_81 -> V_90 = 1 ;
} else {
F_32 ( V_81 ) ;
...
F_25 ( V_70 , L_48 , V_10 -> V_111 . V_112 ) ;
F_30 ( V_10 -> V_111 . V_112 , V_76 , sizeof( V_76 ) ) ;
F_48 ( & V_104 ) ;
V_81 = F_43 ( V_76 , 0 ) ;
if ( V_81 == NULL ) {
F_3 ( L_49 ) ;
