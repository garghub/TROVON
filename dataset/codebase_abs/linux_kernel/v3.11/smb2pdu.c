...
V_20 -> V_138 = F_36 ( sizeof( struct V_139 ) , V_140 ) ;
if ( ! V_20 -> V_138 )
return - V_72 ;
V_20 -> V_141 = V_142 ;
V_143:
if ( V_134 == V_144 )
V_134 = V_145 ;
V_34 = F_18 ( V_146 , NULL , ( void * * ) & V_84 ) ;
if ( V_34 )
return V_34 ;
V_84 -> V_2 . V_27 = 0 ;
V_84 -> V_147 = 0 ;
...
if ( V_134 == V_135 ) {
V_136 = F_36 ( sizeof( struct V_149 ) ,
V_140 ) ;
if ( V_136 == NULL ) {
V_34 = - V_72 ;
goto V_150;
...
V_89 = sizeof( struct V_149 ) ;
V_90 = V_136 ;
}
} else if ( V_134 == V_145 ) {
V_84 -> V_2 . V_27 = V_20 -> V_28 ;
V_136 = F_39 ( sizeof( struct V_149 ) + 500 ,
V_140 ) ;
if ( V_136 == NULL ) {
V_34 = - V_72 ;
goto V_150;
...
V_34 = F_42 ( V_79 -> V_158 ,
F_2 ( V_79 -> V_153 ) , V_20 ) ;
}
if ( V_34 != 0 )
goto V_150;
V_20 -> V_159 = F_2 ( V_79 -> V_160 ) ;
V_150:
F_22 ( V_78 , V_79 ) ;
if ( ( V_134 == V_144 ) && ( V_34 == 0 ) )
goto V_143;
return V_34 ;
}
int
F_43 ( const unsigned int V_82 , struct V_37 * V_20 )
{
struct V_161 * V_84 ;
int V_34 = 0 ;
struct V_38 * V_21 ;
...
return - V_48 ;
V_34 = F_18 ( V_162 , NULL , ( void * * ) & V_84 ) ;
if ( V_34 )
return V_34 ;
V_84 -> V_2 . V_27 = V_20 -> V_28 ;
if ( V_21 -> V_29 )
V_84 -> V_2 . V_30 |= V_31 ;
V_34 = F_44 ( V_82 , V_20 , ( char * ) & V_84 -> V_2 , 0 ) ;
return V_34 ;
}
static inline void F_45 ( struct V_4 * V_5 , T_3 V_163 )
{
F_21 ( & V_5 -> V_74 . V_75 . V_164 [ V_163 ] ) ;
}
int
F_15 ( const unsigned int V_82 , struct V_37 * V_20 , const char * V_165 ,
struct V_4 * V_5 , const struct V_35 * V_166 )
{
struct V_167 * V_84 ;
...
if ( V_5 && V_5 -> V_171 )
return - V_172 ;
V_170 = F_36 ( V_173 * 2 , V_140 ) ;
if ( V_170 == NULL )
return - V_72 ;
V_169 = F_46 ( V_170 , V_165 , strlen ( V_165 ) , V_166 ) + 1 ;
V_169 *= 2 ;
if ( V_169 < 2 ) {
F_38 ( V_170 ) ;
return - V_174 ;
...
V_79 = (struct V_168 * ) V_87 [ 0 ] . V_109 ;
if ( V_34 != 0 ) {
if ( V_5 ) {
F_45 ( V_5 , V_177 ) ;
V_5 -> V_59 = true ;
...
F_7 ( V_117 , L_24 , V_79 -> V_181 ) ;
V_34 = - V_151 ;
goto V_178;
}
V_5 -> V_187 = F_30 ( V_79 -> V_188 ) ;
V_5 -> V_22 = V_79 -> V_104 ;
V_5 -> V_189 = F_30 ( V_79 -> V_190 ) ;
V_5 -> V_40 = V_191 ;
V_5 -> V_59 = false ;
V_5 -> V_26 = V_79 -> V_2 . V_25 ;
F_47 ( V_5 -> V_61 , V_165 , sizeof( V_5 -> V_61 ) ) ;
if ( ( V_79 -> V_104 & V_192 ) &&
( ( V_5 -> V_187 & V_193 ) == 0 ) )
F_7 ( V_117 , L_25 ) ;
V_180:
...
return V_34 ;
V_178:
if ( V_79 -> V_2 . V_156 == V_194 ) {
F_7 ( V_117 , L_26 , V_165 ) ;
V_5 -> V_171 = true ;
}
goto V_180;
}
int
F_48 ( const unsigned int V_82 , struct V_4 * V_5 )
{
struct V_195 * V_84 ;
int V_34 = 0 ;
struct V_38 * V_21 ;
...
static struct V_197 *
F_49 ( T_6 * V_198 , T_6 V_199 )
{
struct V_197 * V_200 ;
V_200 = F_39 ( sizeof( struct V_197 ) , V_140 ) ;
if ( ! V_200 )
return NULL ;
V_200 -> V_201 . V_202 = F_50 ( * ( ( V_203 * ) V_198 ) ) ;
V_200 -> V_201 . V_204 = F_50 ( * ( ( V_203 * ) ( V_198 + 8 ) ) ) ;
if ( V_199 == V_205 )
V_200 -> V_201 . V_206 = V_207 |
V_208 ;
else if ( V_199 == V_209 )
V_200 -> V_201 . V_206 = V_208 ;
else if ( V_199 == V_210 )
V_200 -> V_201 . V_206 = V_211 |
V_208 |
V_207 ;
V_200 -> V_212 . V_213 = F_4 ( F_41
( struct V_197 , V_201 ) ) ;
V_200 -> V_212 . V_214 = F_5 ( sizeof( struct V_215 ) ) ;
V_200 -> V_212 . V_216 = F_4 ( F_41
( struct V_197 , V_217 ) ) ;
V_200 -> V_212 . V_218 = F_4 ( 4 ) ;
V_200 -> V_217 [ 0 ] = 'R' ;
V_200 -> V_217 [ 1 ] = 'q' ;
V_200 -> V_217 [ 2 ] = 'L' ;
V_200 -> V_217 [ 3 ] = 's' ;
...
{
struct V_219 * V_200 ;
V_200 = F_39 ( sizeof( struct V_219 ) , V_140 ) ;
if ( ! V_200 )
return NULL ;
V_200 -> V_212 . V_213 = F_4 ( F_41
( struct V_219 , V_220 ) ) ;
V_200 -> V_212 . V_214 = F_5 ( 16 ) ;
V_200 -> V_212 . V_216 = F_4 ( F_41
( struct V_219 , V_217 ) ) ;
V_200 -> V_212 . V_218 = F_4 ( 4 ) ;
V_200 -> V_217 [ 0 ] = 'D' ;
...
( struct V_219 , V_217 ) ) ;
V_200 -> V_212 . V_218 = F_4 ( 4 ) ;
V_200 -> V_220 . V_223 . V_224 = V_222 -> V_225 ;
V_200 -> V_220 . V_223 . V_226 = V_222 -> V_227 ;
V_200 -> V_217 [ 0 ] = 'D' ;
V_200 -> V_217 [ 1 ] = 'H' ;
V_200 -> V_217 [ 2 ] = 'n' ;
V_200 -> V_217 [ 3 ] = 'C' ;
...
char * V_233 ;
V_229 = ( char * ) V_79 + 4 + F_30 ( V_79 -> V_234 ) ;
V_230 = (struct V_197 * ) V_229 ;
do {
V_230 = (struct V_197 * ) ( ( char * ) V_230 + V_232 ) ;
V_233 = F_2 ( V_230 -> V_212 . V_216 ) + ( char * ) V_230 ;
if ( F_2 ( V_230 -> V_212 . V_218 ) != 4 ||
strncmp ( V_233 , L_28 , 4 ) ) {
V_232 = F_30 ( V_230 -> V_212 . V_235 ) ;
continue;
}
if ( V_230 -> V_201 . V_236 & V_237 )
return V_238 ;
V_231 = true ;
break;
} while ( V_232 != 0 );
if ( ! V_231 )
return 0 ;
return F_54 ( V_230 -> V_201 . V_206 ) ;
}
static int
F_55 ( struct V_86 * V_87 , unsigned int * V_239 , T_7 * V_199 )
{
struct V_240 * V_84 = V_87 [ 0 ] . V_109 ;
unsigned int V_241 = * V_239 ;
V_87 [ V_241 ] . V_109 = F_49 ( V_199 + 1 , * V_199 ) ;
if ( V_87 [ V_241 ] . V_109 == NULL )
return - V_72 ;
V_87 [ V_241 ] . V_110 = sizeof( struct V_197 ) ;
V_84 -> V_242 = V_243 ;
if ( ! V_84 -> V_234 )
V_84 -> V_234 = F_5 (
sizeof( struct V_240 ) - 4 +
V_87 [ V_241 - 1 ] . V_110 ) ;
V_84 -> V_244 = F_5 (
F_30 ( V_84 -> V_244 ) +
sizeof( struct V_197 ) ) ;
F_27 ( & V_84 -> V_2 , sizeof( struct V_197 ) ) ;
* V_239 = V_241 + 1 ;
return 0 ;
}
static int
F_56 ( struct V_86 * V_87 , unsigned int * V_239 ,
struct V_245 * V_246 )
{
struct V_240 * V_84 = V_87 [ 0 ] . V_109 ;
unsigned int V_241 = * V_239 ;
if ( V_246 -> V_247 ) {
V_87 [ V_241 ] . V_109 = F_52 ( V_246 -> V_222 ) ;
V_246 -> V_247 = false ;
} else
V_87 [ V_241 ] . V_109 = F_51 () ;
if ( V_87 [ V_241 ] . V_109 == NULL )
return - V_72 ;
V_87 [ V_241 ] . V_110 = sizeof( struct V_219 ) ;
if ( ! V_84 -> V_234 )
V_84 -> V_234 =
F_5 ( sizeof( struct V_240 ) - 4 +
V_87 [ 1 ] . V_110 ) ;
V_84 -> V_244 =
F_5 ( F_30 ( V_84 -> V_244 ) +
sizeof( struct V_219 ) ) ;
F_27 ( & V_84 -> V_2 , sizeof( struct V_219 ) ) ;
* V_239 = V_241 + 1 ;
return 0 ;
}
int
F_57 ( const unsigned int V_82 , struct V_245 * V_246 , T_1 * V_248 ,
T_7 * V_199 , struct V_249 * V_200 )
{
struct V_240 * V_84 ;
struct V_228 * V_79 ;
struct V_38 * V_21 ;
struct V_4 * V_5 = V_246 -> V_5 ;
struct V_37 * V_20 = V_5 -> V_20 ;
struct V_86 V_87 [ 4 ] ;
int V_78 ;
int V_250 ;
...
V_254 |= V_257 ;
V_84 -> V_258 = V_259 ;
V_84 -> V_260 = F_5 ( V_246 -> V_261 ) ;
V_84 -> V_262 = F_5 ( V_254 ) ;
V_84 -> V_263 = V_264 ;
V_84 -> V_265 = F_5 ( V_246 -> V_266 ) ;
V_84 -> V_267 = F_5 ( V_246 -> V_255 & V_268 ) ;
V_250 = ( 2 * F_58 ( ( V_269 * ) V_248 , V_270 ) ) + 2 ;
V_84 -> V_216 = F_4 ( sizeof( struct V_240 ) - 4 ) ;
V_87 [ 0 ] . V_109 = ( char * ) V_84 ;
V_87 [ 0 ] . V_110 = F_28 ( V_84 ) + 4 ;
V_84 -> V_218 = F_4 ( V_250 - 2 ) ;
V_87 [ 0 ] . V_110 -- ;
if ( V_250 % 8 != 0 ) {
V_252 = V_250 / 8 * 8 ;
if ( V_252 < V_250 )
V_252 += 8 ;
V_251 = F_39 ( V_252 , V_140 ) ;
if ( ! V_251 )
return - V_72 ;
memcpy ( ( char * ) V_251 , ( const char * ) V_248 ,
V_250 ) ;
V_250 = V_252 ;
V_248 = V_251 ;
}
...
if ( ! V_21 -> V_271 )
* V_199 = V_272 ;
if ( ! ( V_5 -> V_20 -> V_21 -> V_22 & V_273 ) ||
* V_199 == V_272 )
V_84 -> V_242 = * V_199 ;
else {
V_34 = F_55 ( V_87 , & V_253 , V_199 ) ;
if ( V_34 ) {
F_23 ( V_84 ) ;
F_38 ( V_251 ) ;
return V_34 ;
...
if ( V_5 -> V_20 -> V_21 -> V_22 & V_273 ) {
struct V_274 * V_212 =
(struct V_274 * ) V_87 [ V_253 - 1 ] . V_109 ;
V_212 -> V_235 =
F_5 ( sizeof( struct V_197 ) ) ;
}
V_34 = F_56 ( V_87 , & V_253 , V_246 ) ;
if ( V_34 ) {
F_23 ( V_84 ) ;
F_38 ( V_251 ) ;
F_38 ( V_87 [ V_253 - 1 ] . V_109 ) ;
return V_34 ;
}
}
V_34 = F_29 ( V_82 , V_20 , V_87 , V_253 , & V_78 , 0 ) ;
V_79 = (struct V_228 * ) V_87 [ 0 ] . V_109 ;
if ( V_34 != 0 ) {
F_45 ( V_5 , V_275 ) ;
goto V_276;
}
V_246 -> V_222 -> V_225 = V_79 -> V_224 ;
V_246 -> V_222 -> V_227 = V_79 -> V_226 ;
if ( V_200 ) {
memcpy ( V_200 , & V_79 -> V_277 , 32 ) ;
V_200 -> V_278 = V_79 -> V_278 ;
V_200 -> V_279 = V_79 -> V_280 ;
V_200 -> V_281 = V_79 -> V_262 ;
V_200 -> V_282 = F_5 ( 1 ) ;
V_200 -> V_283 = 0 ;
}
if ( V_79 -> V_284 == V_243 )
...
int
F_59 ( const unsigned int V_82 , struct V_4 * V_5 , V_203 V_225 ,
V_203 V_227 , T_9 V_285 , bool V_286 , char * V_287 ,
...
F_7 ( V_117 , L_31 , * V_290 ) ;
* V_290 = 0 ;
V_34 = - V_48 ;
goto V_301;
}
if ( F_28 ( V_79 ) < F_30 ( V_79 -> V_296 ) + * V_290 ) {
F_7 ( V_117 , L_32 , * V_290 ,
F_30 ( V_79 -> V_296 ) ) ;
* V_290 = 0 ;
V_34 = - V_48 ;
goto V_301;
}
* V_289 = F_36 ( * V_290 , V_140 ) ;
if ( * V_289 == NULL ) {
V_34 = - V_72 ;
goto V_301;
}
...
int
F_60 ( const unsigned int V_82 , struct V_4 * V_5 ,
V_203 V_225 , V_203 V_227 )
{
struct V_302 * V_84 ;
struct V_303 * V_79 ;
struct V_38 * V_21 ;
...
static int
F_61 ( unsigned int V_306 , unsigned int V_307 ,
struct V_1 * V_2 , unsigned int V_308 )
{
unsigned int V_309 = F_62 ( V_2 -> V_11 ) ;
...
static int
F_63 ( unsigned int V_306 , unsigned int V_307 ,
...
if ( ! V_314 )
return - V_174 ;
V_34 = F_61 ( V_306 , V_307 , V_2 , V_313 ) ;
if ( V_34 )
return V_34 ;
...
V_203 V_225 , V_203 V_227 , T_6 V_315 ,
T_10 V_316 , T_10 V_317 , void * V_314 )
{
struct V_318 * V_84 ;
...
struct V_249 * V_314 )
{
return F_64 ( V_82 , V_5 , V_225 , V_227 ,
V_328 ,
sizeof( struct V_249 ) + V_329 * 2 ,
sizeof( struct V_249 ) , V_314 ) ;
}
int
F_66 ( const unsigned int V_82 , struct V_4 * V_5 ,
V_203 V_225 , V_203 V_227 , T_11 * V_330 )
{
return F_64 ( V_82 , V_5 , V_225 , V_227 ,
V_331 ,
sizeof( struct V_332 ) ,
...
F_68 ( V_334 ) ;
F_69 ( V_21 , V_339 , V_342 ) ;
}
int
F_70 ( struct V_38 * V_21 )
{
struct V_343 * V_84 ;
int V_34 = 0 ;
struct V_86 V_87 ;
...
V_34 = F_71 ( V_21 , & V_345 , NULL , F_67 , V_21 ,
V_342 ) ;
if ( V_34 )
F_7 ( V_45 , L_39 , V_34 ) ;
F_23 ( V_84 ) ;
...
int
F_72 ( const unsigned int V_82 , struct V_4 * V_5 , V_203 V_225 ,
V_203 V_227 )
{
struct V_349 * V_84 ;
struct V_38 * V_21 ;
...
static int
F_73 ( struct V_86 * V_87 , struct V_351 * V_352 ,
...
V_84 -> V_224 = V_352 -> V_225 ;
V_84 -> V_226 = V_352 -> V_227 ;
V_84 -> V_359 = 0 ;
V_84 -> V_360 = 0 ;
V_84 -> V_148 = 0 ;
V_84 -> V_361 = 0 ;
V_84 -> V_362 = F_5 ( V_352 -> V_363 ) ;
V_84 -> V_364 = F_50 ( V_352 -> V_306 ) ;
if ( V_354 & V_365 ) {
if ( ! ( V_354 & V_366 ) ) {
V_84 -> V_2 . V_367 =
F_5 ( F_28 ( V_84 ) + 4 ) ;
...
V_84 -> V_224 = 0xFFFFFFFF ;
V_84 -> V_226 = 0xFFFFFFFF ;
}
}
...
static void
F_74 ( struct V_333 * V_334 )
{
struct V_371 * V_372 = V_334 -> V_335 ;
struct V_4 * V_5 = F_75 ( V_372 -> V_373 -> V_374 ) ;
struct V_38 * V_21 = V_5 -> V_20 -> V_21 ;
struct V_1 * V_200 = (struct V_1 * ) V_372 -> V_87 . V_109 ;
unsigned int V_339 = 1 ;
...
switch ( V_334 -> V_340 ) {
case V_341 :
V_339 = F_2 ( V_200 -> V_15 ) ;
if ( V_21 -> V_29 ) {
int V_34 ;
V_34 = F_76 ( & V_345 , V_21 ) ;
if ( V_34 )
F_7 ( V_117 , L_42 ,
V_34 ) ;
}
F_77 ( V_372 -> V_384 ) ;
F_78 ( V_5 , V_372 -> V_384 ) ;
break;
case V_385 :
case V_386 :
V_372 -> V_383 = - V_54 ;
...
if ( V_372 -> V_383 )
F_45 ( V_5 , V_388 ) ;
F_79 ( V_389 , & V_372 -> V_390 ) ;
F_68 ( V_334 ) ;
F_69 ( V_21 , V_339 , 0 ) ;
}
int
F_80 ( struct V_371 * V_372 )
{
int V_34 ;
struct V_1 * V_200 ;
struct V_351 V_352 ;
...
V_352 . V_5 = F_75 ( V_372 -> V_373 -> V_374 ) ;
V_352 . V_306 = V_372 -> V_306 ;
V_352 . V_363 = V_372 -> V_384 ;
V_352 . V_225 = V_372 -> V_373 -> V_222 . V_225 ;
V_352 . V_227 = V_372 -> V_373 -> V_222 . V_227 ;
V_352 . V_358 = V_372 -> V_358 ;
V_34 = F_73 ( & V_372 -> V_87 , & V_352 , 0 , 0 ) ;
if ( V_34 )
return V_34 ;
V_200 = (struct V_1 * ) V_372 -> V_87 . V_109 ;
V_372 -> V_87 . V_110 = F_28 ( V_372 -> V_87 . V_109 ) + 4 ;
F_81 ( & V_372 -> V_391 ) ;
V_34 = F_71 ( V_352 . V_5 -> V_20 -> V_21 , & V_345 ,
V_392 , F_74 ,
V_372 , 0 ) ;
if ( V_34 ) {
F_82 ( & V_372 -> V_391 , V_393 ) ;
F_45 ( V_352 . V_5 , V_388 ) ;
}
F_23 ( V_200 ) ;
return V_34 ;
}
int
F_83 ( const unsigned int V_82 , struct V_351 * V_352 ,
unsigned int * V_394 , char * * V_200 , int * V_395 )
{
int V_78 , V_34 = - V_355 ;
struct V_396 * V_79 = NULL ;
struct V_86 V_87 [ 1 ] ;
* V_394 = 0 ;
V_34 = F_73 ( V_87 , V_352 , 0 , 0 ) ;
if ( V_34 )
return V_34 ;
V_34 = F_29 ( V_82 , V_352 -> V_5 -> V_20 , V_87 , 1 ,
& V_78 , V_154 ) ;
V_79 = (struct V_396 * ) V_87 [ 0 ] . V_109 ;
if ( V_79 -> V_2 . V_156 == V_397 ) {
F_22 ( V_78 , V_87 [ 0 ] . V_109 ) ;
return 0 ;
}
if ( V_34 ) {
...
if ( * V_200 ) {
memcpy ( * V_200 , ( char * ) V_79 -> V_2 . V_12 + V_79 -> V_213 ,
* V_394 ) ;
F_22 ( V_78 , V_87 [ 0 ] . V_109 ) ;
} else if ( V_78 != V_155 ) {
* V_200 = V_87 [ 0 ] . V_109 ;
...
struct V_4 * V_5 = F_75 ( V_400 -> V_373 -> V_374 ) ;
unsigned int V_401 ;
...
V_400 -> V_383 = F_85 ( V_334 , V_5 -> V_20 -> V_21 , 0 ) ;
if ( V_400 -> V_383 != 0 )
break;
V_401 = F_30 ( V_79 -> V_214 ) ;
...
if ( V_400 -> V_383 )
F_45 ( V_5 , V_404 ) ;
F_79 ( V_389 , & V_400 -> V_390 ) ;
F_68 ( V_334 ) ;
F_69 ( V_5 -> V_20 -> V_21 , V_339 , 0 ) ;
}
int
F_86 ( struct V_399 * V_400 )
{
int V_34 = - V_355 ;
...
V_84 -> V_224 = V_400 -> V_373 -> V_222 . V_225 ;
V_84 -> V_226 = V_400 -> V_373 -> V_222 . V_227 ;
V_84 -> V_407 = 0 ;
V_84 -> V_408 = 0 ;
V_84 -> V_148 = 0 ;
V_84 -> V_364 = F_50 ( V_400 -> V_306 ) ;
V_84 -> V_213 = F_4 (
F_41 ( struct V_405 , V_158 ) - 4 ) ;
V_84 -> V_370 = 0 ;
...
F_81 ( & V_400 -> V_391 ) ;
V_34 = F_71 ( V_5 -> V_20 -> V_21 , & V_345 , NULL ,
F_84 , V_400 , 0 ) ;
if ( V_34 ) {
F_82 ( & V_400 -> V_391 , V_409 ) ;
F_45 ( V_5 , V_404 ) ;
}
V_406:
F_23 ( V_84 ) ;
...
int
F_87 ( const unsigned int V_82 , struct V_351 * V_352 ,
...
static unsigned int
F_88 ( char * V_411 , char * V_312 , char * * V_412 , T_10 V_413 )
{
int V_414 ;
...
V_203 V_225 , V_203 V_227 , int V_420 ,
struct V_421 * V_422 )
{
struct V_423 * V_84 ;
...
V_427 = F_90 (unsigned int, output_size, server->maxBuf) ;
V_427 = F_90 (unsigned int, output_size, 2 << 15 ) ;
V_84 -> V_324 = F_5 ( V_427 ) ;
V_87 [ 0 ] . V_109 = ( char * ) V_84 ;
V_87 [ 0 ] . V_110 = F_28 ( V_84 ) + 4 - 1 ;
V_87 [ 1 ] . V_109 = ( char * ) ( V_84 -> V_158 ) ;
V_87 [ 1 ] . V_110 = V_414 ;
F_27 ( V_84 , V_414 - 1 ) ;
V_34 = F_29 ( V_82 , V_20 , V_87 , 2 , & V_78 , 0 ) ;
...
V_203 V_225 , V_203 V_227 , T_9 V_358 , int V_315 ,
unsigned int V_241 , void * * V_314 , unsigned int * V_413 )
{
struct V_450 * V_84 ;
...
if ( ! V_241 )
return - V_174 ;
V_87 = F_36 ( sizeof( struct V_86 ) * V_241 , V_140 ) ;
if ( ! V_87 )
return - V_72 ;
...
F_27 ( V_84 , * V_413 - 1 ) ;
memcpy ( V_84 -> V_158 , * V_314 , * V_413 ) ;
V_87 [ 0 ] . V_109 = ( char * ) V_84 ;
V_87 [ 0 ] . V_110 = F_28 ( V_84 ) + 4 ;
for ( V_452 = 1 ; V_452 < V_241 ; V_452 ++ ) {
F_27 ( V_84 , V_413 [ V_452 ] ) ;
F_92 ( & V_84 -> V_454 , V_413 [ V_452 ] ) ;
V_87 [ V_452 ] . V_109 = ( char * ) V_314 [ V_452 ] ;
V_87 [ V_452 ] . V_110 = V_413 [ V_452 ] ;
}
V_34 = F_29 ( V_82 , V_20 , V_87 , V_241 , & V_78 , 0 ) ;
...
V_203 V_225 , V_203 V_227 , T_1 * V_456 )
{
struct V_457 V_458 ;
void * * V_314 ;
...
V_314 = F_36 ( sizeof( void * ) * 2 , V_140 ) ;
if ( ! V_314 )
return - V_72 ;
V_458 . V_459 = 1 ;
V_458 . V_460 = 0 ;
...
V_314 [ 1 ] = V_456 ;
V_413 [ 1 ] = V_414 + 2 ;
V_34 = F_91 ( V_82 , V_5 , V_225 , V_227 ,
...
int
F_95 ( const unsigned int V_82 , struct V_4 * V_5 , V_203 V_225 ,
V_203 V_227 , T_9 V_358 , T_11 * V_464 )
{
struct V_465 V_458 ;
void * V_314 ;
unsigned int V_413 ;
...
return F_91 ( V_82 , V_5 , V_225 , V_227 , V_358 ,
V_466 , 1 , & V_314 , & V_413 ) ;
}
int
F_96 ( const unsigned int V_82 , struct V_4 * V_5 ,
V_203 V_225 , V_203 V_227 , T_13 * V_200 )
{
unsigned int V_413 ;
V_413 = sizeof( T_13 ) ;
return F_91 ( V_82 , V_5 , V_225 , V_227 ,
V_17 -> V_18 , V_467 , 1 ,
( void * * ) & V_200 , & V_413 ) ;
}
int
F_97 ( const unsigned int V_82 , struct V_4 * V_5 ,
const V_203 V_225 , const V_203 V_227 ,
T_7 V_468 )
{
int V_34 ;
...
V_84 -> V_284 = V_468 ;
V_84 -> V_2 . V_15 = F_4 ( 1 ) ;
V_34 = F_44 ( V_82 , V_5 -> V_20 , ( char * ) V_84 , V_472 ) ;
if ( V_34 ) {
F_45 ( V_5 , V_473 ) ;
F_7 ( V_45 , L_54 , V_34 ) ;
}
...
static void
F_98 ( struct V_474 * V_475 ,
struct V_476 * V_477 )
{
V_477 -> V_478 = F_30 ( V_475 -> V_479 ) *
F_30 ( V_475 -> V_480 ) ;
V_477 -> V_481 = F_99 ( V_475 -> V_482 ) ;
V_477 -> V_483 = F_99 ( V_475 -> V_484 ) ;
V_477 -> V_485 = F_99 ( V_475 -> V_486 ) ;
return;
}
static int
F_100 ( struct V_86 * V_87 , struct V_4 * V_5 , int V_487 ,
int V_488 , V_203 V_225 , V_203 V_227 )
{
int V_34 ;
struct V_318 * V_84 ;
F_7 ( V_45 , L_55 , V_487 ) ;
...
V_203 V_225 , V_203 V_227 , struct V_476 * V_490 )
{
struct V_319 * V_79 = NULL ;
struct V_86 V_87 ;
int V_34 = 0 ;
...
const T_14 V_492 , const T_14 V_227 , const T_8 V_358 ,
const T_8 V_493 , struct V_494 * V_200 )
{
int V_34 = 0 ;
...
const T_14 V_492 , const T_14 V_227 , const T_8 V_358 ,
const T_14 V_363 , const T_14 V_306 , const T_8 V_503 ,
const bool V_504 )
{
struct V_494 V_505 ;
V_505 . V_364 = F_50 ( V_306 ) ;
V_505 . V_362 = F_50 ( V_363 ) ;
V_505 . V_30 = F_5 ( V_503 ) ;
if ( ! V_504 && V_503 != V_506 )
V_505 . V_30 |= F_5 ( V_507 ) ;
return F_102 ( V_82 , V_5 , V_492 , V_227 , V_358 , 1 , & V_505 ) ;
}
int
F_104 ( const unsigned int V_82 , struct V_4 * V_5 ,
T_7 * V_198 , const T_4 V_508 )
{
int V_34 ;
struct V_509 * V_84 = NULL ;
F_7 ( V_45 , L_58 ) ;
V_34 = F_18 ( V_53 , V_5 , ( void * * ) & V_84 ) ;
if ( V_34 )
return V_34 ;
