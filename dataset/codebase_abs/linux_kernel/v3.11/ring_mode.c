...
V_14 , V_26 ) ;
V_6 -> V_27 [ V_9 ] = V_12 -> V_23 ;
V_12 -> V_28 = V_12 -> V_23 + V_29 ;
V_6 -> V_30 -> V_12 -> V_31 ( V_12 , 1 , V_14 , V_4 ,
V_32 ) ;
F_4 () ;
V_9 = ( ++ V_6 -> V_10 ) % V_7 ;
if ( V_6 -> V_16 )
...
V_6 -> V_27 [ V_9 ] = V_12 -> V_23 ;
V_12 -> V_28 = V_12 -> V_23 + V_29 ;
V_6 -> V_30 -> V_12 -> V_31 ( V_12 , 0 , V_15 , V_4 ,
V_32 ) ;
F_4 () ;
V_6 -> V_30 -> V_12 -> V_33 ( V_12 ) ;
V_6 -> V_34 [ V_9 ] = NULL ;
} else {
V_12 -> V_23 = F_3 ( V_6 -> V_24 , V_3 -> V_25 ,
V_13 , V_26 ) ;
V_6 -> V_27 [ V_9 ] = V_12 -> V_23 ;
V_12 -> V_28 = V_12 -> V_23 + V_29 ;
V_6 -> V_30 -> V_12 -> V_31 ( V_12 , 1 , V_13 , V_4 ,
V_32 ) ;
}
return V_9 ;
}
static unsigned int F_5 ( int V_15 , int V_20 )
{
unsigned int V_35 = 0 ;
if ( V_15 >= V_29 )
V_35 = 1 ;
...
static void F_6 ( void * V_36 , struct V_11 * V_1 )
{
struct V_5 * V_6 = (struct V_5 * ) V_36 ;
if ( F_7 ( V_6 -> V_19 -> V_37 ) )
if ( V_6 -> V_38 >= V_21 )
V_1 -> V_28 = V_1 -> V_23 + V_21 ;
}
static void F_8 ( struct V_11 * V_1 )
{
V_1 -> V_28 = V_1 -> V_23 + V_21 ;
}
static void F_9 ( void * V_36 , struct V_11 * V_1 )
{
if ( F_7 ( V_1 -> V_28 ) )
V_1 -> V_28 = 0 ;
}
