...
F_38 ( & V_55 , V_53 ) ;
V_27 = 0 ;
F_9 ( & V_43 -> V_45 , V_50 | V_47 | ( V_51 << 8 ) ) ;
...
if ( V_68 == V_72 ) {
if ( V_53 & V_79 )
F_42 ( & V_41 -> V_44 . V_80 , V_69 ) ;
else
F_43 ( & V_41 -> V_44 . V_80 , V_69 ) ;
}
if ( V_68 == V_81 ) {
if ( V_53 & V_82 )
F_5 ( & V_71 -> V_83 , V_69 ) ;
...
F_3 ( & V_71 -> V_83 , V_69 ) ;
if ( V_53 & V_79 )
F_5 ( & V_41 -> V_44 . V_84 , V_69 ) ;
else
F_3 ( & V_41 -> V_44 . V_84 , V_69 ) ;
}
}
static void F_44 ( int V_68 , int V_69 , int V_53 )
{
struct V_85 T_5 * V_71 =
(struct V_85 T_5 * ) & V_41 -> V_86 ;
V_69 = 1 << ( 15 - V_69 ) ;
if ( V_68 != 0 )
V_71 += V_68 - 1 ;
if ( V_53 & V_75 )
...
F_49 ( struct V_122 * V_123 )
{
return F_50 ( V_123 , struct V_121 , V_123 ) ;
}
static void F_51 ( struct V_122 * V_123 )
{
struct V_121 * V_124 = F_49 ( V_123 ) ;
struct V_85 T_5 * V_71 = V_123 -> V_125 ;
V_124 -> V_126 = F_10 ( & V_71 -> V_127 ) ;
}
static int F_52 ( struct V_128 * V_129 , unsigned int V_130 )
{
struct V_122 * V_123 = F_53 ( V_129 ) ;
struct V_85 T_5 * V_71 = V_123 -> V_125 ;
T_9 V_131 ;
V_131 = 1 << ( 15 - V_130 ) ;
return ! ! ( F_10 ( & V_71 -> V_127 ) & V_131 ) ;
}
static void F_54 ( struct V_122 * V_123 , T_9 V_131 ,
int V_132 )
{
struct V_121 * V_124 = F_49 ( V_123 ) ;
struct V_85 T_5 * V_71 = V_123 -> V_125 ;
...
V_129 -> V_141 = F_52 ;
V_129 -> V_142 = F_55 ;
return F_61 ( V_20 , V_123 ) ;
}
static inline struct V_143 *
F_62 ( struct V_122 * V_123 )
{
return F_50 ( V_123 , struct V_143 , V_123 ) ;
}
static void F_63 ( struct V_122 * V_123 )
{
struct V_143 * V_124 = F_62 ( V_123 ) ;
struct V_144 T_5 * V_71 = V_123 -> V_125 ;
V_124 -> V_126 = F_48 ( & V_71 -> V_127 ) ;
}
static int F_64 ( struct V_128 * V_129 , unsigned int V_130 )
{
struct V_122 * V_123 = F_53 ( V_129 ) ;
struct V_144 T_5 * V_71 = V_123 -> V_125 ;
T_6 V_131 ;
...
static void F_65 ( struct V_122 * V_123 , T_6 V_131 ,
int V_132 )
{
struct V_143 * V_124 = F_62 ( V_123 ) ;
struct V_144 T_5 * V_71 = V_123 -> V_125 ;
...
static void F_66 ( struct V_128 * V_129 , unsigned int V_130 , int V_132 )
{
struct V_122 * V_123 = F_53 ( V_129 ) ;
struct V_143 * V_124 = F_62 ( V_123 ) ;
unsigned long V_53 ;
...
F_38 ( & V_124 -> V_133 , V_53 ) ;
F_65 ( V_123 , V_131 , V_132 ) ;
F_39 ( & V_124 -> V_133 , V_53 ) ;
}
static int F_67 ( struct V_128 * V_129 , unsigned int V_130 , int V_134 )
{
struct V_122 * V_123 = F_53 ( V_129 ) ;
struct V_143 * V_124 = F_62 ( V_123 ) ;
struct V_144 T_5 * V_71 = V_123 -> V_125 ;
...
F_38 ( & V_124 -> V_133 , V_53 ) ;
F_5 ( & V_71 -> V_76 , V_131 ) ;
F_65 ( V_123 , V_131 , V_134 ) ;
F_39 ( & V_124 -> V_133 , V_53 ) ;
return 0 ;
}
static int F_68 ( struct V_128 * V_129 , unsigned int V_130 )
{
struct V_122 * V_123 = F_53 ( V_129 ) ;
struct V_143 * V_124 = F_62 ( V_123 ) ;
struct V_144 T_5 * V_71 = V_123 -> V_125 ;
