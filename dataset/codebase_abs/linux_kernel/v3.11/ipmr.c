...
struct V_2 * V_2 = F_33 ( V_33 -> V_60 ) ;
struct V_1 * V_4 ;
if ( ! F_202 ( V_33 , sizeof( * V_331 ) + sizeof( struct V_114 ) ) )
goto V_332;
V_331 = F_203 ( V_33 ) ;
V_4 = F_191 ( V_2 , V_33 ) ;
if ( F_13 ( V_4 ) )
goto V_332;
if ( ! V_4 -> V_254 ||
V_331 -> V_333 != V_334 || V_331 -> V_210 != V_335 )
goto V_332;
if ( F_197 ( V_4 , V_33 , sizeof( * V_331 ) ) ) {
V_332:
F_48 ( V_33 ) ;
}
return 0 ;
...
if ( ! F_202 ( V_33 , sizeof( * V_331 ) + sizeof( struct V_114 ) ) )
goto V_332;
V_331 = (struct V_336 * ) F_198 ( V_33 ) ;
if ( V_331 -> type != ( ( V_337 << 4 ) | ( V_338 ) ) ||
( V_331 -> V_19 & V_339 ) ||
( F_205 ( ( void * ) V_331 , sizeof( * V_331 ) ) != 0 &&
...
struct V_137 * V_138 , struct V_340 * V_341 )
{
int V_285 ;
struct V_342 * V_343 ;
struct V_36 * V_344 ;
...
F_208 ( V_33 , V_347 , V_4 -> V_130 [ V_138 -> V_193 ] . V_60 -> V_99 ) < 0 )
return - V_197 ;
if ( ! ( V_344 = F_209 ( V_33 , V_348 ) ) )
return - V_197 ;
for ( V_285 = V_138 -> V_144 . V_8 . V_165 ; V_285 < V_138 -> V_144 . V_8 . V_128 ; V_285 ++ ) {
if ( F_63 ( V_4 , V_285 ) && V_138 -> V_144 . V_8 . V_164 [ V_285 ] < 255 ) {
if ( ! ( V_343 = F_210 ( V_33 , sizeof( * V_343 ) ) ) ) {
F_211 ( V_33 , V_344 ) ;
return - V_197 ;
}
V_343 -> V_349 = 0 ;
V_343 -> V_350 = V_138 -> V_144 . V_8 . V_164 [ V_285 ] ;
V_343 -> V_351 = V_4 -> V_130 [ V_285 ] . V_60 -> V_99 ;
V_343 -> V_352 = sizeof( * V_343 ) ;
}
}
F_212 ( V_33 , V_344 ) ;
V_346 . V_353 = V_138 -> V_144 . V_8 . V_198 ;
V_346 . V_354 = V_138 -> V_144 . V_8 . V_276 ;
V_346 . V_355 = V_138 -> V_144 . V_8 . V_277 ;
if ( F_213 ( V_33 , V_356 , sizeof( V_346 ) , & V_346 ) < 0 )
return - V_197 ;
V_341 -> V_357 = V_358 ;
return 1 ;
}
...
V_163 -> V_226 |= V_362 ;
V_12 = F_107 ( V_4 , V_33 , V_163 , V_341 ) ;
F_51 ( & V_104 ) ;
F_59 () ;
return V_12 ;
}
static int F_215 ( struct V_1 * V_4 , struct V_32 * V_33 ,
T_1 V_154 , T_1 V_363 , struct V_137 * V_138 , int V_261 )
{
struct V_147 * V_148 ;
struct V_340 * V_341 ;
int V_12 ;
V_148 = F_216 ( V_33 , V_154 , V_363 , V_261 , sizeof( * V_341 ) , V_364 ) ;
if ( V_148 == NULL )
return - V_197 ;
V_341 = F_82 ( V_148 ) ;
V_341 -> V_365 = V_366 ;
...
V_341 -> V_375 = V_377 ;
V_341 -> V_360 = 0 ;
if ( F_217 ( V_33 , V_378 , V_138 -> V_188 ) ||
F_217 ( V_33 , V_379 , V_138 -> V_189 ) )
goto V_372;
V_12 = F_107 ( V_4 , V_33 , V_138 , V_341 ) ;
...
+ F_222 ( 4 )
+ F_222 ( 0 )
+ V_128 * F_223 ( sizeof( struct V_342 ) )
+ F_222 ( sizeof( struct V_345 ) )
;
return V_107 ;
}
...
if ( V_12 < 0 )
goto V_380;
F_225 ( V_33 , V_2 , 0 , V_381 , NULL , V_194 ) ;
return;
V_380:
F_48 ( V_33 ) ;
if ( V_12 < 0 )
F_226 ( V_2 , V_381 , V_12 ) ;
}
static int F_227 ( struct V_32 * V_33 , struct V_382 * V_383 )
{
...
if ( V_384 > V_385 )
V_387 = 0 ;
for ( V_386 = V_387 ; V_386 < V_53 ; V_386 ++ ) {
F_97 (mfc, &mrt->mfc_cache_array[h], list) {
if ( V_142 < V_388 )
goto V_390;
if ( F_215 ( V_4 , V_33 ,
F_84 ( V_383 -> V_33 ) . V_154 ,
V_383 -> V_148 -> V_391 ,
V_218 , V_215 ) < 0 )
goto V_392;
V_390:
...
for ( V_395 -> V_285 = 0 ; V_395 -> V_285 < V_4 -> V_128 ; ++ V_395 -> V_285 ) {
if ( ! F_63 ( V_4 , V_395 -> V_285 ) )
continue;
if ( V_396 -- == 0 )
return & V_4 -> V_130 [ V_395 -> V_285 ] ;
}
return NULL ;
}
static void * F_229 ( struct V_397 * V_363 , T_9 * V_396 )
__acquires( V_104 )
{
struct V_394 * V_395 = V_363 -> V_398 ;
struct V_2 * V_2 = F_230 ( V_363 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , V_45 ) ;
if ( V_4 == NULL )
return F_192 ( - V_222 ) ;
V_395 -> V_4 = V_4 ;
F_49 ( & V_104 ) ;
return * V_396 ? F_228 ( V_2 , V_363 -> V_398 , * V_396 - 1 )
: V_399 ;
}
static void * F_231 ( struct V_397 * V_363 , void * V_62 , T_9 * V_396 )
{
struct V_394 * V_395 = V_363 -> V_398 ;
struct V_2 * V_2 = F_230 ( V_363 ) ;
struct V_1 * V_4 = V_395 -> V_4 ;
++ * V_396 ;
if ( V_62 == V_399 )
return F_228 ( V_2 , V_395 , 0 ) ;
while ( ++ V_395 -> V_285 < V_4 -> V_128 ) {
if ( ! F_63 ( V_4 , V_395 -> V_285 ) )
continue;
return & V_4 -> V_130 [ V_395 -> V_285 ] ;
}
...
static void F_232 ( struct V_397 * V_363 , void * V_62 )
__releases( V_104 )
{
F_51 ( & V_104 ) ;
}
static int F_233 ( struct V_397 * V_363 , void * V_62 )
{
struct V_394 * V_395 = V_363 -> V_398 ;
struct V_1 * V_4 = V_395 -> V_4 ;
if ( V_62 == V_399 ) {
...
static int F_236 ( struct V_400 * V_400 , struct V_401 * V_401 )
{
return F_237 ( V_400 , V_401 , & V_402 ,
sizeof( struct V_394 ) ) ;
}
...
struct V_137 * V_218 ;
F_57 () ;
for ( V_404 -> V_285 = 0 ; V_404 -> V_285 < V_53 ; V_404 -> V_285 ++ ) {
V_404 -> V_163 = & V_4 -> V_54 [ V_404 -> V_285 ] ;
...
static void * F_239 ( struct V_397 * V_363 , T_9 * V_396 )
{
...
V_404 -> V_163 = NULL ;
V_404 -> V_285 = 0 ;
return * V_396 ? F_238 ( V_2 , V_363 -> V_398 , * V_396 - 1 )
: V_399 ;
}
static void * F_240 ( struct V_397 * V_363 , void * V_62 , T_9 * V_396 )
{
...
++ * V_396 ;
if ( V_62 == V_399 )
return F_238 ( V_2 , V_363 -> V_398 , 0 ) ;
if ( V_218 -> V_50 . V_49 != V_404 -> V_163 )
return F_241 ( V_218 -> V_50 . V_49 , struct V_137 , V_50 ) ;
if ( V_404 -> V_163 == & V_4 -> V_55 )
goto V_405;
F_242 ( V_404 -> V_163 != & V_4 -> V_54 [ V_404 -> V_285 ] ) ;
while ( ++ V_404 -> V_285 < V_53 ) {
V_404 -> V_163 = & V_4 -> V_54 [ V_404 -> V_285 ] ;
if ( F_87 ( V_404 -> V_163 ) )
continue;
return F_243 ( V_404 -> V_163 , struct V_137 , V_50 ) ;
}
F_59 () ;
V_404 -> V_163 = & V_4 -> V_55 ;
V_404 -> V_285 = 0 ;
...
static void F_244 ( struct V_397 * V_363 , void * V_62 )
{
struct V_403 * V_404 = V_363 -> V_398 ;
struct V_1 * V_4 = V_404 -> V_4 ;
if ( V_404 -> V_163 == & V_4 -> V_55 )
F_132 ( & V_157 ) ;
else if ( V_404 -> V_163 == & V_4 -> V_54 [ V_404 -> V_285 ] )
F_59 () ;
}
static int F_245 ( struct V_397 * V_363 , void * V_62 )
{
int V_406 ;
if ( V_62 == V_399 ) {
F_234 ( V_363 ,
...
for ( V_406 = V_218 -> V_144 . V_8 . V_165 ;
V_406 < V_218 -> V_144 . V_8 . V_128 ; V_406 ++ ) {
if ( F_63 ( V_4 , V_406 ) &&
V_218 -> V_144 . V_8 . V_164 [ V_406 ] < 255 )
F_235 ( V_363 ,
L_12 ,
V_406 , V_218 -> V_144 . V_8 . V_164 [ V_406 ] ) ;
}
} else {
F_235 ( V_363 , L_11 , 0ul , 0ul , 0ul ) ;
}
F_246 ( V_363 , '\n' ) ;
}
return 0 ;
}
static int F_247 ( struct V_400 * V_400 , struct V_401 * V_401 )
{
return F_237 ( V_400 , V_401 , & V_407 ,
sizeof( struct V_403 ) ) ;
}
...
#ifdef F_249
V_12 = - V_46 ;
if ( ! F_250 ( L_13 , 0 , V_2 -> V_409 , & V_410 ) )
goto V_411;
if ( ! F_250 ( L_14 , 0 , V_2 -> V_409 , & V_412 ) )
goto V_413;
#endif
return 0 ;
#ifdef F_249
V_413:
F_251 ( L_13 , V_2 -> V_409 ) ;
V_411:
F_20 ( V_2 ) ;
#endif
V_408:
