...
V_41 = F_24 ( F_18 ( V_22 -> V_41 ) , V_72 [ 0 ] ) ;
if ( ! V_41 ) {
V_41 = F_25 ( V_22 -> V_41 , V_22 , V_72 [ 0 ] ) ;
if ( ! V_41 ) {
F_7 ( V_37 L_26 ,
V_20 -> V_75 ) ;
return;
...
V_41 -> V_77 = V_22 -> V_41 -> V_50 ;
F_26 ( V_41 , V_72 [ 0 ] , V_72 [ 1 ] ) ;
V_41 -> V_78 = 0 ;
V_28 = & V_22 -> V_27 [ V_79 ] ;
...
static struct V_21 * F_29 ( struct V_40 * V_41 ,
struct V_1 * V_85 )
{
...
static void F_33 ( struct V_1 * V_20 , struct V_40 * V_41 ,
int V_88 )
{
struct V_1 * V_89 ;
struct V_21 * V_22 ;
...
void F_27 ( struct V_1 * V_20 , struct V_40 * V_41 )
{
F_33 ( V_20 , V_41 , 0 ) ;
}
void F_37 ( struct V_1 * V_20 , struct V_40 * V_41 )
{
F_33 ( V_20 , V_41 , 1 ) ;
}
