...
V_38 = F_23 ( V_2 , V_8 ) ;
if ( V_38 && ( ( V_8 + V_21 ) <= V_38 -> V_42 ) )
return;
while ( V_38 ) {
if ( V_38 -> V_42 >= ( V_8 + V_21 ) )
break;
V_38 -> V_43 |= V_44 ;
V_40 . V_39 = V_38 ;
F_24 ( V_38 -> V_42 , V_38 -> V_45 ,
& V_40 ) ;
V_38 = V_38 -> V_46 ;
}
}
...
long F_25 ( unsigned long V_8 , unsigned long V_21 , T_1 T_8 * V_47 )
{
struct V_1 * V_2 = V_22 -> V_2 ;
struct V_3 * V_4 = & V_2 -> V_5 . V_4 ;
T_1 * * V_23 , * V_24 ;
...
unsigned long V_26 , V_27 ;
int V_48 ;
if ( ( V_8 & ~ V_49 ) || ( V_21 & ~ V_49 ) ||
V_8 >= V_50 || V_21 >= V_50 || V_8 + V_21 > V_50 )
return - V_51 ;
...
if ( ! F_27 ( V_52 , V_47 , ( V_21 >> V_31 ) * sizeof( T_1 ) ) )
return - V_53 ;
F_17 ( & V_2 -> V_28 ) ;
F_22 ( V_2 , V_8 , V_21 ) ;
...
F_19 ( & V_2 -> V_28 ) ;
V_48 = - V_53 ;
if ( F_32 ( V_24 , V_47 , V_25 * sizeof( T_1 ) ) )
goto V_57;
V_47 += V_25 ;
F_17 ( & V_2 -> V_28 ) ;
F_4 ( V_2 , V_8 , V_25 ) ;
