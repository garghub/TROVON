...
L_38 ,
F_7 ( V_3 ) , V_66 / 2 ,
( unsigned long long ) V_85 -> V_73 , V_76 ( V_85 ) / 2 ) ;
F_53 ( V_85 ) ;
return;
}
static void F_54 ( struct V_95 * V_96 , struct V_3 * V_3 )
{
F_55 ( V_96 , L_39 , V_3 -> V_45 / 2 ) ;
return;
}
...
struct V_4 * V_97 ;
int V_107 ;
if ( ( V_3 -> V_9 - 1 ) != V_3 -> V_98 ) {
F_6 ( V_50 L_45 ,
F_7 ( V_3 ) ) ;
return F_22 ( - V_46 ) ;
}
V_107 = 64 * 2 ;
while ( V_107 && ( V_3 -> V_80 & ( V_107 - 1 ) ) )
V_107 >>= 1 ;
if ( ( V_107 << 9 ) < V_83 )
return F_22 ( - V_46 ) ;
V_3 -> V_100 = 0 ;
...
static void * F_59 ( struct V_3 * V_3 )
{
if ( V_3 -> V_48 == 4 )
return F_56 ( V_3 ) ;
if ( V_3 -> V_48 == 5 ) {
...
static void F_60 ( struct V_3 * V_3 , int V_109 )
{
}
