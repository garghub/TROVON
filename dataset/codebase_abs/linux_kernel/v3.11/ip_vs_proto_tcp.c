...
if ( F_47 ( V_5 ) )
V_42 -> V_93 = V_5 -> V_94 [ V_42 -> V_65 = V_77 ] ;
else
V_42 -> V_93 = V_95 [ V_42 -> V_65 = V_77 ] ;
}
static void
...
struct V_14 V_15 , * V_16 ;
#ifdef F_13
int V_96 = V_42 -> V_1 == V_97 ? F_33 ( V_3 ) : sizeof( struct V_62 ) ;
#else
int V_96 = F_33 ( V_3 ) ;
#endif
V_16 = F_2 ( V_3 , V_96 , sizeof( V_15 ) , & V_15 ) ;
if ( V_16 == NULL )
return;
F_49 ( & V_42 -> V_98 ) ;
...
static inline T_2 F_51 ( T_1 V_99 )
{
return ( ( ( V_100 V_101 ) V_99 >> V_102 ) ^ ( V_100 V_101 ) V_99 )
& V_103 ;
}
static int F_52 ( struct V_11 * V_11 , struct V_104 * V_105 )
{
struct V_104 * V_106 ;
T_2 V_107 ;
T_1 V_99 = V_105 -> V_99 ;
...
struct V_4 * V_5 = F_53 ( V_11 , V_108 ) ;
V_107 = F_51 ( V_99 ) ;
...
F_55 ( & V_105 -> V_111 , & V_18 -> V_112 [ V_107 ] ) ;
F_46 ( & V_5 -> V_113 ) ;
V_110:
return V_47 ;
}
static void
F_56 ( struct V_11 * V_11 , struct V_104 * V_105 )
{
struct V_4 * V_5 = F_53 ( V_11 , V_108 ) ;
F_45 ( & V_5 -> V_113 ) ;
F_57 ( & V_105 -> V_111 ) ;
...
if ( F_60 ( V_42 ) != V_115 )
return 0 ;
V_107 = F_51 ( V_42 -> V_50 ) ;
F_5 () ;
F_61 (inc, &ipvs->tcp_apps[hash], p_list) {
if ( V_105 -> V_99 == V_42 -> V_50 ) {
if ( F_22 ( ! F_62 ( V_105 ) ) )
break;
F_9 () ;
F_41 ( 9 , L_10
...
F_43 ( V_42 -> V_50 ) ,
V_105 -> V_61 , F_43 ( V_105 -> V_99 ) ) ;
V_42 -> V_46 = V_105 ;
if ( V_105 -> V_117 )
V_114 = V_105 -> V_117 ( V_105 , V_42 ) ;
goto V_110;
}
}
F_9 () ;
...
{
struct V_17 * V_18 = F_4 ( V_11 ) ;
F_65 ( V_18 -> V_112 , V_119 ) ;
V_5 -> V_94 = F_66 ( ( int * ) V_95 ,
sizeof( V_95 ) ) ;
if ( ! V_5 -> V_94 )
return - V_120 ;
V_5 -> V_70 = V_72 ;
