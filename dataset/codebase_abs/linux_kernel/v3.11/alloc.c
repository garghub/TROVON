...
F_65 ( V_2 , V_2 -> V_7 -> V_78 &&
( V_2 -> V_11 > 64 ||
! V_2 -> V_69 ) ) ;
F_60 ( V_2 ) ;
F_65 ( V_2 , ! F_9 ( & V_2 -> V_7 -> V_77 ) ) ;
if ( F_5 ( & V_2 -> V_7 -> V_10 ) &&
( ! F_63 ( & V_2 -> V_63 ) ||
V_2 -> V_11 > 64 ) )
F_68 ( V_2 ) ;
...
long F_69 ( struct V_1 * V_2 , unsigned V_56 , struct V_79 * V_44 )
{
long V_20 = - 1 ;
V_80:
F_25 ( V_2 -> V_43 ) ;
...
T_3 V_81 ;
long V_19 ;
for ( V_81 = 0 ; V_81 < F_71 ( V_2 ) * 2 ; V_81 ++ )
F_42 ( V_2 -> F_71 [ V_81 ] == ( V_82 ) V_20 ) ;
F_72 (i, &ca->free, iter)
F_42 ( V_19 == V_20 ) ;
...
void F_79 ( struct V_13 * V_14 , struct V_85 * V_86 )
{
unsigned V_19 ;
for ( V_19 = 0 ; V_19 < F_80 ( V_86 ) ; V_19 ++ ) {
struct V_3 * V_4 = F_81 ( V_14 , V_86 , V_19 ) ;
F_74 ( V_4 , V_61 ) ;
F_73 ( V_4 , 0 ) ;
F_41 ( F_82 ( V_14 , V_86 , V_19 ) , V_4 ) ;
}
}
int F_83 ( struct V_13 * V_14 , unsigned V_56 ,
struct V_85 * V_86 , int V_73 , struct V_79 * V_44 )
{
int V_19 ;
F_84 ( & V_14 -> V_22 ) ;
F_42 ( ! V_73 || V_73 > V_14 -> V_87 || V_73 > 8 ) ;
F_85 ( V_86 ) ;
for ( V_19 = 0 ; V_19 < V_73 ; V_19 ++ ) {
struct V_1 * V_2 = V_14 -> V_88 [ V_19 ] ;
long V_4 = F_69 ( V_2 , V_56 , V_44 ) ;
if ( V_4 == - 1 )
goto V_89;
V_86 -> V_90 [ V_19 ] = F_86 ( V_2 -> V_60 [ V_4 ] . V_6 ,
F_35 ( V_14 , V_4 ) ,
V_2 -> V_10 . V_91 ) ;
F_87 ( V_86 , V_19 + 1 ) ;
}
...
int F_89 ( struct V_13 * V_14 , unsigned V_56 ,
struct V_85 * V_86 , int V_73 , struct V_79 * V_44 )
{
int V_5 ;
F_11 ( & V_14 -> V_22 ) ;
V_5 = F_83 ( V_14 , V_56 , V_86 , V_73 , V_44 ) ;
F_15 ( & V_14 -> V_22 ) ;
return V_5 ;
}
int F_90 ( struct V_1 * V_2 )
{
struct V_92 * V_86 = F_91 ( F_62 ,
V_2 , L_2 ) ;
if ( F_92 ( V_86 ) )
return F_93 ( V_86 ) ;
V_2 -> V_43 = V_86 ;
...
unsigned V_19 ;
V_2 -> V_56 [ V_93 ] = 0 ;
V_2 -> V_56 [ V_83 ] = F_71 ( V_2 ) ;
V_2 -> V_56 [ V_57 ] = 8 +
V_2 -> V_56 [ V_83 ] ;
V_2 -> V_56 [ V_94 ] = V_2 -> free . V_95 / 2 +
V_2 -> V_56 [ V_57 ] ;
for ( V_19 = 0 ; V_19 < V_96 ; V_19 ++ ) {
struct V_30 * V_31 = F_98 ( sizeof( * V_31 ) , V_97 ) ;
if ( ! V_31 )
return - V_98 ;
V_31 -> V_2 = V_2 ;
F_99 ( & V_31 -> V_32 , F_16 ) ;
