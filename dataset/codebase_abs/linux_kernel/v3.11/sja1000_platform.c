...
V_13 = F_11 ( V_7 , V_19 , 0 ) ;
V_14 = F_11 ( V_7 , V_20 , 0 ) ;
if ( ! V_13 || ! V_14 ) {
V_8 = - V_18 ;
goto exit;
}
if ( ! F_12 ( V_13 -> V_21 , F_13 ( V_13 ) ,
V_22 ) ) {
V_8 = - V_23 ;
goto exit;
}
V_9 = F_14 ( V_13 -> V_21 , F_13 ( V_13 ) ) ;
if ( ! V_9 ) {
V_8 = - V_24 ;
goto V_25;
}
...
V_2 = F_16 ( V_11 ) ;
V_11 -> V_27 = V_14 -> V_21 ;
V_2 -> V_28 = V_14 -> V_29 & V_30 ;
if ( V_14 -> V_29 & V_31 )
V_2 -> V_28 |= V_32 ;
V_2 -> V_4 = V_9 ;
V_2 -> V_33 . clock . V_34 = V_16 -> V_35 / 2 ;
V_2 -> V_36 = V_16 -> V_36 ;
V_2 -> V_37 = V_16 -> V_37 ;
switch ( V_13 -> V_29 & V_38 ) {
case V_39 :
V_2 -> V_40 = F_7 ;
V_2 -> V_41 = F_8 ;
break;
...
F_22 ( V_9 ) ;
V_25:
F_23 ( V_13 -> V_21 , F_13 ( V_13 ) ) ;
exit:
return V_8 ;
}
static int F_24 ( struct V_6 * V_7 )
{
struct V_10 * V_11 = F_25 ( V_7 ) ;
struct V_1 * V_2 = F_16 ( V_11 ) ;
struct V_12 * V_45 ;
F_26 ( V_11 ) ;
if ( V_2 -> V_4 )
F_22 ( V_2 -> V_4 ) ;
V_45 = F_11 ( V_7 , V_19 , 0 ) ;
F_23 ( V_45 -> V_21 , F_13 ( V_45 ) ) ;
F_21 ( V_11 ) ;
return 0 ;
}
