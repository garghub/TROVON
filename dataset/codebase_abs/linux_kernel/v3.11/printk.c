...
F_53 ( V_100 L_26 ,
( V_215 -> V_10 & V_217 ) ? L_27 : L_28 ,
V_215 -> V_177 , V_215 -> V_182 ) ;
}
}
int F_139 ( struct V_142 * V_142 )
{
...
static void F_143 ( struct V_226 * V_226 )
{
int V_227 = F_144 ( V_228 , 0 ) ;
if ( V_227 & V_229 ) {
char * V_39 = F_145 ( V_230 ) ;
F_53 ( V_231 L_30 , V_39 ) ;
}
if ( V_227 & V_232 )
F_146 ( & V_66 ) ;
}
...
int F_154 ( const char * V_235 )
{
return F_155 ( & V_236 , V_235 ) ;
}
bool F_156 ( unsigned long * V_237 ,
unsigned int V_238 )
{
if ( * V_237 == 0
|| ! F_157 ( V_111 , * V_237 ,
...
if ( ! V_240 -> V_244 ) {
V_240 -> V_244 = 1 ;
F_160 ( & V_240 -> V_245 , & V_246 ) ;
V_87 = 0 ;
}
F_161 ( & V_243 , V_10 ) ;
return V_87 ;
}
int F_162 ( struct V_239 * V_240 )
{
unsigned long V_10 ;
int V_87 = - V_44 ;
F_159 ( & V_243 , V_10 ) ;
...
bool F_169 ( struct V_239 * V_240 , bool V_115 ,
...
bool V_42 ;
F_49 ( & V_61 , V_10 ) ;
V_42 = F_169 ( V_240 , V_115 , line , V_15 , V_6 ) ;
F_50 ( & V_61 , V_10 ) ;
return V_42 ;
}
...
void T_9 F_174 ( const char * V_160 , ... )
{
T_11 args ;
va_start ( args , V_160 ) ;
...
void F_175 ( const char * V_258 )
{
F_53 ( L_31 ,
V_258 , F_176 () , V_30 -> V_259 , V_30 -> V_31 ,
F_177 () , F_178 () -> V_260 ,
( int ) strcspn ( F_178 () -> V_261 , L_32 ) ,
F_178 () -> V_261 ) ;
if ( V_257 [ 0 ] != '\0' )
F_53 ( L_33 ,
V_258 , V_257 ) ;
