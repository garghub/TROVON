...
static void F_61 ( struct F_51 * V_111 ,
enum V_112 V_112 )
{
switch ( V_112 ) {
case V_113 :
...
static void
F_62 ( struct V_116 * V_117 , const char * V_55 , unsigned int V_48 )
{
F_23 ( ( const unsigned char * ) V_55 , V_48 , 1 , 1 , 0 ) ;
}
static struct V_90 *
F_63 ( struct V_116 * V_51 , int * V_118 )
{
* V_118 = 0 ;
return V_110 ;
}
static int
F_64 ( struct V_119 * V_120 ,
unsigned long V_121 , void * V_17 )
{
F_58 () ;
return V_122 ;
}
