...
static int F_75 ( struct V_1 * V_2 , unsigned char V_10 )
{
int V_11 ;
F_3 ( V_10 , V_2 -> V_78 ) ;
V_11 = F_2 ( V_2 -> V_78 + 1 ) ;
...
static int F_82 ( struct V_73 * V_74 , int V_155 ,
struct V_156 * * V_157 )
{
struct V_1 * V_2 = V_74 -> V_75 ;
struct V_156 * V_158 ;
...
static int F_87 ( struct V_73 * V_74 , T_3 V_168 )
{
struct V_1 * V_2 = V_74 -> V_75 ;
F_88 ( V_74 , V_169 ) ;
F_89 ( V_2 -> V_158 ) ;
...
static int F_106 ( int V_198 , struct V_199 * V_200 )
{
if ( F_107 ( V_200 ) < 0 ) {
...
static int F_118 ( int V_198 , struct V_1 * V_2 ,
struct V_199 * V_200 )
{
V_2 -> V_198 = V_200 ;
...
static int F_119 ( int V_198 , struct V_1 * V_2 ,
struct V_201 * V_74 ,
...
static int F_123 ( struct V_73 * V_74 , int V_198 )
{
struct V_1 * V_2 = V_74 -> V_75 ;
struct V_208 * V_209 ;
int V_43 ;
...
static int F_128 ( struct V_155 * V_200 , unsigned int V_198 )
{
return V_216 [ V_198 ] && ! F_129 ( V_198 ) ;
}
static int F_130 ( int V_198 , struct V_155 * V_217 )
{
struct V_73 * V_74 ;
int V_43 ;
...
static int F_134 ( struct V_155 * V_200 , unsigned int V_198 )
{
int V_43 ;
...
static int F_137 ( struct V_155 * V_217 ,
unsigned int V_198 )
{
F_132 ( F_138 ( V_217 ) ) ;
return 0 ;
...
static int F_141 ( struct V_199 * V_200 ,
...
static void F_143 ( struct V_199 * V_200 )
{
F_132 ( F_144 ( V_200 ) ) ;
}
static int F_145 ( struct V_199 * V_200 , T_3 V_168 )
{
...
static int F_147 ( struct V_201 * V_228 ,
...
static void F_149 ( struct V_201 * V_228 )
{
F_132 ( F_150 ( V_228 ) ) ;
F_148 ( V_228 , NULL ) ;
}
static int F_151 ( struct V_201 * V_228 , T_3 V_168 )
{
