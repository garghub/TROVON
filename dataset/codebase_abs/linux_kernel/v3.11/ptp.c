...
void F_106 ( struct V_1 * V_2 , struct V_255 * V_256 )
{
struct V_26 * V_27 = V_2 -> V_8 ;
if ( ! V_27 )
return;
...
V_259 |
V_260 ) ;
V_256 -> V_261 = F_107 ( V_27 -> V_160 ) ;
V_256 -> V_262 = 1 << V_174 | 1 << V_241 ;
V_256 -> V_263 = ( 1 << V_176 |
1 << V_243 |
1 << V_244 |
1 << V_245 |
...
int F_108 ( struct V_1 * V_2 , struct V_264 * V_265 , int V_266 )
{
struct V_238 V_171 ;
int V_82 ;
if ( ! V_2 -> V_8 )
return - V_267 ;
if ( F_109 ( & V_171 , V_265 -> V_268 , sizeof( V_171 ) ) )
return - V_269 ;
V_82 = F_105 ( V_2 , & V_171 ) ;
if ( V_82 != 0 )
return V_82 ;
return F_110 ( V_265 -> V_268 , & V_171 , sizeof( V_171 ) )
? - V_269 : 0 ;
}
static void F_111 ( struct V_1 * V_2 , int V_270 )
{
struct V_26 * V_27 = V_2 -> V_8 ;
...
static void F_112 ( struct V_1 * V_2 , struct V_26 * V_27 )
{
...
F_42 ( & V_27 -> V_114 ) ;
if ( ! F_43 ( & V_27 -> V_120 ) ) {
V_117 = F_113 ( & V_27 -> V_120 ,
struct V_116 , V_118 ) ;
F_114 ( & V_117 -> V_118 ) ;
V_117 -> V_127 = F_115 ( V_27 -> V_271 [ 2 ] , V_272 ) ;
V_117 -> V_129 = ( F_115 ( V_27 -> V_271 [ 2 ] ,
V_273 ) |
( F_115 ( V_27 -> V_271 [ 1 ] ,
V_273 ) << 8 ) |
( F_115 ( V_27 -> V_271 [ 0 ] ,
V_273 ) << 16 ) ) ;
V_117 -> V_130 = F_38 (
F_115 ( V_27 -> V_271 [ 0 ] , V_272 ) ,
F_115 ( V_27 -> V_271 [ 1 ] , V_272 ) ) ;
V_117 -> V_119 = V_92 + F_27 ( V_216 ) ;
F_116 ( & V_117 -> V_118 , & V_27 -> V_115 ) ;
F_101 ( V_27 -> V_170 , & V_27 -> V_153 ) ;
} else {
...
static void F_117 ( struct V_1 * V_2 , struct V_26 * V_27 )
{
int V_274 = F_115 ( V_27 -> V_271 [ 0 ] , V_272 ) ;
if ( V_27 -> V_148 != 1 ) {
F_111 ( V_2 , 1 ) ;
return;
}
F_11 ( V_2 , V_78 , V_2 -> V_20 , L_13 , V_274 ) ;
}
...
void F_119 ( struct V_1 * V_2 , T_4 * V_275 )
{
struct V_26 * V_27 = V_2 -> V_8 ;
int V_274 = F_115 ( * V_275 , V_276 ) ;
if ( ! V_27 -> V_207 )
return;
if ( V_27 -> V_148 == 0 ) {
V_27 -> V_277 = V_274 ;
} else if ( V_27 -> V_277 != V_274 ) {
F_11 ( V_2 , V_78 , V_2 -> V_20 ,
L_14 , V_274 ) ;
V_27 -> V_148 = 0 ;
}
V_27 -> V_271 [ V_27 -> V_148 ++ ] = * V_275 ;
if ( ! F_120 ( * V_275 , V_278 ) ) {
switch ( V_274 ) {
case V_279 :
F_112 ( V_2 , V_27 ) ;
break;
...
V_27 -> V_148 = 0 ;
} else if ( V_282 == V_27 -> V_148 ) {
F_11 ( V_2 , V_78 , V_2 -> V_20 ,
L_16 ) ;
V_27 -> V_148 = 0 ;
}
}
static int V_191 ( struct V_283 * V_27 , T_5 V_69 )
{
...
V_69 = - V_185 ;
V_286 = ( ( ( T_6 ) V_69 * V_287 ) >>
( V_288 + V_289 ) ) ;
F_2 ( V_284 , V_5 , V_290 ) ;
F_2 ( V_284 , V_291 , ( T_3 ) V_286 ) ;
F_2 ( V_284 , V_292 ,
( T_3 ) ( V_286 >> 32 ) ) ;
F_2 ( V_284 , V_293 , 0 ) ;
F_2 ( V_284 , V_294 , 0 ) ;
V_82 = F_3 ( V_2 , V_12 , V_284 , sizeof( V_284 ) ,
NULL , 0 , NULL ) ;
if ( V_82 != 0 )
return V_82 ;
V_8 -> V_149 = V_69 ;
...
static int V_193 ( struct V_283 * V_27 , T_6 V_69 )
{
struct V_26 * V_8 = F_67 ( V_27 ,
struct V_26 ,
V_179 ) ;
struct V_1 * V_2 = V_8 -> V_9 -> V_2 ;
struct V_24 V_295 = F_121 ( V_69 ) ;
T_1 V_3 [ V_285 ] ;
F_2 ( V_3 , V_5 , V_290 ) ;
F_2 ( V_3 , V_291 , 0 ) ;
F_2 ( V_3 , V_292 , 0 ) ;
F_2 ( V_3 , V_293 , ( T_3 ) V_295 . V_36 ) ;
F_2 ( V_3 , V_294 , ( T_3 ) V_295 . V_38 ) ;
return F_3 ( V_2 , V_12 , V_3 , sizeof( V_3 ) ,
NULL , 0 , NULL ) ;
}
static int V_195 ( struct V_283 * V_27 , struct V_24 * V_296 )
{
struct V_26 * V_8 = F_67 ( V_27 ,
struct V_26 ,
V_179 ) ;
...
V_298 , sizeof( V_298 ) , NULL ) ;
if ( V_82 != 0 )
return V_82 ;
V_296 -> V_36 = F_20 ( V_298 , V_301 ) ;
V_296 -> V_38 = F_20 ( V_298 , V_302 ) ;
return 0 ;
}
static int V_197 ( struct V_283 * V_27 ,
const struct V_24 * V_303 )
{
int V_82 ;
struct V_24 V_304 ;
struct V_24 V_69 ;
V_82 = V_195 ( V_27 , & V_304 ) ;
if ( V_82 != 0 )
return V_82 ;
V_69 = F_122 ( * V_303 , V_304 ) ;
V_82 = V_193 ( V_27 , F_123 ( & V_69 ) ) ;
if ( V_82 != 0 )
return V_82 ;
return 0 ;
}
static int V_199 ( struct V_283 * V_27 ,
struct V_305 * V_306 ,
int V_198 )
{
struct V_26 * V_8 = F_67 ( V_27 ,
