...
V_49 . V_74 = V_52 + V_53 ;
V_51 = ( char * ) F_39 ( V_7 -> V_6 ) + V_7 -> V_21 ;
if ( V_69 ) {
...
V_62 -> V_77 = ( F_42 () + V_62 -> V_80 ) | 1 ;
}
if ( V_12 != NULL ) {
F_44 ( & V_49 , V_58 , V_50 , V_53 , V_60 ,
V_43 -> V_68 ) ;
F_37 ( V_12 ) ;
} else {
V_50 = F_45 () ;
...
F_48 () ;
F_35 ( & V_85 , V_43 , F_36 () ) ;
F_44 ( & V_85 , V_88 , V_84 , strlen ( V_84 ) ,
V_43 -> V_61 , V_43 -> V_68 ) ;
F_49 ( L_11 ) ;
}
static void
...
V_6 = V_7 -> V_6 ;
V_96 = F_39 ( V_6 ) ;
while ( V_96 < ( ( char * ) F_39 ( V_6 ) + V_7 -> V_21 ) ) {
struct V_48 * V_85 ;
int V_17 ;
V_85 = ( void * ) V_96 ;
V_96 += sizeof( * V_85 ) ;
...
F_44 ( V_85 , V_88 , V_96 , V_17 , V_60 , V_97 ) ;
V_96 += V_17 ;
}
F_62 ( & V_7 -> V_4 ) ;
F_10 ( V_7 ) ;
...
V_100 ;
F_66 () ;
V_99 = F_67 ( V_98 , V_101 | V_102 | V_103 | V_104 , 0600 ) ;
if ( F_68 ( V_99 ) ) {
V_45 = F_69 ( V_99 ) ;
V_99 = NULL ;
F_23 ( V_40 L_12 ,
...
int F_79 ( char * V_111 , int V_112 ,
const char * V_109 , char * V_117 )
{
int V_113 = strlen ( V_109 ) ;
if ( V_113 > V_112 )
V_113 = V_112 ;
if ( F_80 ( V_111 , V_109 , V_113 ) )
return - V_115 ;
if ( V_117 != NULL && V_113 < V_112 ) {
if ( F_80 ( V_111 + V_113 , V_117 , 1 ) )
return - V_115 ;
V_113 ++ ;
}
return V_113 ;
}
int F_81 ( char * * V_84 , int V_113 )
{
if ( V_113 > 2 * V_22 )
return - V_116 ;
...
void F_82 ( char * V_84 , int V_113 )
{
F_12 ( V_84 ) ;
}
int F_83 ( void * V_121 , int V_122 )
{
char * V_84 ;
int V_45 ;
V_45 = F_81 ( & V_84 , V_122 + 1 ) ;
if ( V_45 != 0 )
return V_45 ;
V_45 = F_76 ( V_84 , V_122 + 1 ,
V_121 , V_122 ) ;
if ( V_45 != 0 )
goto V_105;
if ( V_84 [ 0 ] != '/' ) {
...
int F_92 ( void * V_121 , int V_122 )
{
char V_84 [ 32 ] ;
int V_45 ;
V_45 = F_76 ( V_84 , sizeof( V_84 ) , V_121 , V_122 ) ;
if ( V_45 < 0 )
return V_45 ;
return F_89 ( F_86 ( V_84 , NULL , 0 ) ) ;
}
int F_93 ( void )
{
int V_14 ;
...
F_101 ( & V_135 ) ;
F_102 ( & V_31 -> V_33 , & V_135 ) ;
F_103 ( V_142 ) ;
F_104 ( & V_135 , V_142 ,
F_43 ( 1 ) ) ;
F_105 ( & V_31 -> V_33 , & V_135 ) ;
}
F_97 ( & V_31 -> V_143 ) ;
return 0 ;
}
