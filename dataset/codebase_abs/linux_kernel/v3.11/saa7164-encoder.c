...
static int F_23 ( struct V_58 * V_58 , void * V_59 , T_1 * V_12 )
{
struct V_60 * V_61 = V_58 -> V_62 ;
struct V_1 * V_2 = V_61 -> V_2 ;
* V_12 = V_2 -> V_66 ;
...
V_33 -> V_66 |= V_64 [ V_16 ] . V_12 ;
return 0 ;
}
static int F_25 ( struct V_58 * V_58 , void * V_59 , unsigned int * V_33 )
{
struct V_60 * V_61 = V_58 -> V_62 ;
struct V_1 * V_2 = V_61 -> V_2 ;
struct V_3 * V_4 = V_2 -> V_4 ;
...
static int F_27 ( struct V_58 * V_58 , void * V_59 , unsigned int V_33 )
{
struct V_60 * V_61 = V_58 -> V_62 ;
struct V_1 * V_2 = V_61 -> V_2 ;
struct V_3 * V_4 = V_2 -> V_4 ;
...
static int F_38 ( struct V_58 * V_58 , void * V_59 ,
struct V_143 * V_144 )
{
struct V_60 * V_61 = V_58 -> V_62 ;
struct V_1 * V_2 = V_61 -> V_2 ;
...
static int F_39 ( struct V_125 * V_126 , int V_151 )
{
int V_119 = - V_65 ;
switch ( V_126 -> V_12 ) {
case V_128 :
...
struct V_1 * V_2 = V_61 -> V_2 ;
struct V_3 * V_4 = V_2 -> V_4 ;
strcpy ( V_159 -> V_160 , V_4 -> V_70 ) ;
F_46 ( V_159 -> V_161 , V_162 [ V_4 -> V_163 ] . V_70 ,
sizeof( V_159 -> V_161 ) ) ;
sprintf ( V_159 -> V_164 , L_25 , F_47 ( V_4 -> V_165 ) ) ;
V_159 -> V_166 =
V_167 |
V_168 |
0 ;
...
if ( V_83 -> V_69 != 0 )
return - V_65 ;
F_46 ( V_83 -> V_172 , L_26 , sizeof( V_83 -> V_172 ) ) ;
V_83 -> V_173 = V_174 ;
return 0 ;
}
...
return NULL ;
* V_233 = * V_232 ;
snprintf ( V_233 -> V_70 , sizeof( V_233 -> V_70 ) , L_57 , V_4 -> V_70 ,
type , V_162 [ V_4 -> V_163 ] . V_70 ) ;
V_233 -> V_234 = & V_4 -> V_234 ;
V_233 -> V_235 = V_236 ;
return V_233 ;
}
...
V_2 -> V_7 . V_142 = V_243 ;
V_2 -> V_66 = V_244 ;
if ( V_2 -> V_11 . V_12 & V_245 )
V_2 -> V_9 = 480 ;
else
V_2 -> V_9 = 576 ;
V_2 -> V_227 = F_86 ( V_2 ,
V_4 -> V_165 , & V_246 , L_59 ) ;
if ( ! V_2 -> V_227 ) {
F_17 ( V_247 L_60 ,
V_4 -> V_70 ) ;
V_31 = - V_53 ;
