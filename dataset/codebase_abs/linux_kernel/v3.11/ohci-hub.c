...
V_33 |= 0x0008 ;
V_95 -> V_107 = ( V_108 V_109 ) F_40 ( V_2 , V_33 ) ;
V_96 = F_41 ( V_2 ) ;
...
static int F_42 ( struct V_31 * V_32 , unsigned V_114 )
{
struct V_1 * V_2 = F_20 ( V_32 ) ;
T_1 V_5 ;
if ( ! V_114 )
...
} while ( F_46 ( V_120 , V_122 ) && -- V_124 >= 0 );
return 0 ;
}
static int F_47 (
struct V_31 * V_32 ,
