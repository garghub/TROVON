...
if ( V_63 == 0 )
break;
V_64 = V_63 > V_56 ? V_63 - V_56 : 0 ;
V_9 = F_35 ( & V_47 -> V_53 , V_63 , V_64 ) ;
if ( F_36 ( V_63 == V_9 ) ) {
V_56 -= V_63 - V_64 ;
V_57 += V_63 - V_64 ;
break;
...
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_21 * V_22 = F_12 ( V_5 ) ;
return F_5 ( V_2 , L_1 , ( V_22 -> V_23 & V_66 ) ? 1 : 0 ) ;
}
...
V_22 -> V_23 &= ~ V_66 ;
V_9 = F_37 ( NULL , V_22 -> V_59 , sizeof( V_69 ) ,
V_69 , sizeof( V_67 ) , & V_67 , NULL ) ;
if ( V_9 )
F_41 ( L_18 , V_9 ) ;
return V_38 ;
}
...
{
struct V_4 * V_5 = V_2 -> V_6 ;
return F_5 ( V_2 , L_19 , F_12 ( V_5 ) -> V_70 ) ;
}
...
static int F_44 ( struct V_1 * V_2 , enum V_71 type )
{
struct V_4 * V_5 = V_2 -> V_6 ;
if ( F_12 ( V_5 ) -> V_72 == type ) {
return F_5 ( V_2 , L_20 ,
F_12 ( V_5 ) -> V_73 ) ;
} else if ( F_12 ( V_5 ) -> V_72 == V_74 ) {
return F_5 ( V_2 , L_21 ) ;
} else {
return F_5 ( V_2 , L_22 ) ;
}
}
static int F_45 ( const char * V_37 , unsigned long V_38 , void * V_75 ,
enum V_71 type )
{
struct V_4 * V_5 = V_75 ;
int V_9 , V_76 ;
V_9 = F_40 ( V_37 , V_38 , & V_76 ) ;
if ( V_9 )
return V_9 ;
F_12 ( V_5 ) -> V_73 = V_76 ;
if ( V_76 == 0 )
...
T_4 V_38 , T_5 * V_39 )
{
struct V_1 * V_79 = V_36 -> V_40 ;
return F_45 ( V_37 , V_38 , V_79 -> V_6 , V_78 ) ;
}
...
{
struct V_1 * V_79 = V_36 -> V_40 ;
return F_45 ( V_37 , V_38 , V_79 -> V_6 , V_80 ) ;
}
...
{
struct V_1 * V_79 = V_36 -> V_40 ;
return F_45 ( V_37 , V_38 , V_79 -> V_6 , V_81 ) ;
}
static int F_53 ( struct V_1 * V_2 , void * V_3 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_21 * V_22 = F_12 ( V_5 ) ;
return F_5 ( V_2 , L_1 , V_22 -> V_82 ) ;
}
...
void F_64 ( struct V_21 * V_22 , int V_95 , int V_38 )
{
if ( ! V_22 -> V_77 )
return;
if ( V_22 -> V_72 == V_74 )
F_65 ( V_22 -> V_77 , V_95 , V_38 ) ;
else if ( V_22 -> V_72 == V_78 &&
V_22 -> V_73 == V_96 -> V_76 )
F_65 ( V_22 -> V_77 , V_95 , V_38 ) ;
else if ( V_22 -> V_72 == V_80 &&
V_22 -> V_73 == V_96 -> V_97 -> V_76 )
F_65 ( V_22 -> V_77 , V_95 , V_38 ) ;
else if ( V_22 -> V_72 == V_81 &&
V_22 -> V_73 == F_66 () )
F_65 ( V_22 -> V_77 , V_95 , V_38 ) ;
}
int F_67 ( struct V_98 * V_97 ,
struct V_4 * V_5 , char * V_99 , char * V_100 )
{
struct V_101 V_102 [ 2 ] ;
struct V_103 * V_104 = F_68 ( V_5 ) ;
struct V_21 * V_22 = F_12 ( V_5 ) ;
struct V_105 * V_106 ;
T_6 * V_107 ;
...
V_22 -> V_115 = F_69 ( V_26 , V_97 , NULL , NULL ) ;
if ( F_70 ( V_22 -> V_115 ) ) {
V_110 = F_71 ( V_22 -> V_115 ) ;
V_22 -> V_115 = NULL ;
RETURN ( V_110 ) ;
}
V_9 = F_72 ( V_22 -> V_115 , L_34 , 0444 ,
& V_116 , V_22 ) ;
if ( V_9 )
F_41 ( L_35 ) ;
V_9 = F_72 ( V_22 -> V_115 , L_36 , 0644 ,
& V_117 , V_22 ) ;
if ( V_9 )
F_41 ( L_37 ) ;
V_9 = F_72 ( V_22 -> V_115 , L_38 ,
0644 , & V_118 , V_22 ) ;
if ( V_9 )
F_41 ( L_39 ) ;
V_9 = F_72 ( V_22 -> V_115 , L_40 , 0644 ,
& V_119 , V_22 ) ;
if ( V_9 )
F_41 ( L_41 ) ;
V_22 -> V_77 = F_73 ( V_120 ,
V_121 ) ;
if ( V_22 -> V_77 == NULL )
GOTO ( V_61 , V_110 = - V_122 ) ;
...
V_110 = F_75 ( V_22 -> V_115 , L_45 , V_22 -> V_77 ) ;
if ( V_110 )
GOTO ( V_61 , V_110 ) ;
V_22 -> V_130 = F_73 ( F_63 ( V_131 ) ,
V_121 ) ;
if ( V_22 -> V_130 == NULL )
GOTO ( V_61 , V_110 = - V_122 ) ;
for ( V_111 = 0 ; V_111 < F_63 ( V_131 ) ; V_111 ++ )
F_74 ( V_22 -> V_130 , V_111 , 0 ,
V_131 [ V_111 ] , L_44 ) ;
V_110 = F_75 ( V_22 -> V_115 , L_46 ,
V_22 -> V_130 ) ;
if ( V_110 )
GOTO ( V_61 , V_110 ) ;
V_110 = F_76 ( V_22 -> V_115 , V_132 , V_5 ) ;
if ( V_110 )
GOTO ( V_61 , V_110 ) ;
V_106 = F_77 ( V_100 ) ;
F_2 ( V_106 != NULL ) ;
...
V_107 = F_78 ( V_106 -> V_135 -> V_136 , V_22 -> V_115 ) ;
if ( V_107 == NULL )
GOTO ( V_61 , V_110 = - V_122 ) ;
snprintf ( V_26 , V_108 , L_47 ) ;
V_102 [ 0 ] . V_137 = & V_138 ;
V_110 = F_76 ( V_107 , V_102 , V_106 ) ;
if ( V_110 )
GOTO ( V_61 , V_110 ) ;
...
static void F_82 ( struct V_140 * V_141 ,
struct V_1 * V_79 , int V_142 )
{
...
V_146 = 0 ;
V_147 = 0 ;
for( V_93 = 0 ; V_93 < V_156 ; V_93 ++ ) {
V_143 += V_154 -> V_157 . V_158 [ V_93 ] ;
V_144 += V_154 -> V_159 . V_158 [ V_93 ] ;
}
for( V_93 = 0 ; V_93 < V_156 ; V_93 ++ ) {
V_149 = V_154 -> V_157 . V_158 [ V_93 ] ;
V_150 = V_154 -> V_159 . V_158 [ V_93 ] ;
V_145 += V_149 ;
V_146 += V_150 ;
V_148 = 1 << ( V_93 + V_160 - V_152 ) ;
F_5 ( V_79 , L_50
L_51 , V_147 , * V_151 , V_148 , * V_151 ,
( V_93 == V_156 - 1 ) ? '+' : ' ' ,
V_149 , F_83 ( V_149 , V_143 ) , F_83 ( V_145 , V_143 ) ,
V_150 , F_83 ( V_150 , V_144 ) , F_83 ( V_146 , V_144 ) ) ;
V_147 = V_148 ;
if ( V_147 == 1 << 10 ) {
V_147 = 1 ;
V_152 += 10 ;
...
static int F_84 ( struct V_1 * V_79 , void * V_3 )
{
struct V_161 V_162 ;
struct V_21 * V_22 = V_79 -> V_6 ;
...
F_5 ( V_79 , L_56 , L_57 , L_58 , L_59 ) ;
F_5 ( V_79 , L_60 ,
L_61 , L_62 , L_63 , L_64 ,
L_62 , L_63 , L_64 ) ;
F_19 ( & V_22 -> V_167 ) ;
for ( V_163 = 0 ; V_163 < V_168 ; V_163 ++ ) {
if ( V_141 -> V_155 [ V_163 ] . V_76 != 0 ) {
F_5 ( V_79 , L_65 ,
V_141 -> V_155 [ V_163 ] . V_76 ) ;
F_82 ( V_141 , V_79 , V_163 ) ;
}
}
F_20 ( & V_22 -> V_167 ) ;
return 0 ;
}
static T_3 F_86 ( struct V_36 * V_36 ,
...
V_22 -> V_164 = 1 ;
F_19 ( & V_22 -> V_167 ) ;
for ( V_93 = 0 ; V_93 < V_168 ; V_93 ++ ) {
V_141 -> V_155 [ V_93 ] . V_76 = 0 ;
F_87 ( & V_141 -> V_155 [ V_93 ] . V_157 ) ;
F_87 ( & V_141 -> V_155 [ V_93 ] . V_159 ) ;
}
F_20 ( & V_22 -> V_167 ) ;
return V_112 ;
}
static int F_88 ( struct V_1 * V_79 , void * V_3 )
{
struct V_161 V_162 ;
struct V_21 * V_22 = V_79 -> V_6 ;
struct V_140 * V_141 = & V_22 -> V_140 ;
...
L_62 , L_63 , L_64 ) ;
F_19 ( & V_22 -> V_32 ) ;
F_82 ( V_141 , V_79 , V_168 ) ;
F_20 ( & V_22 -> V_32 ) ;
return 0 ;
}
static T_3 F_89 ( struct V_36 * V_36 , const char * V_169 ,
T_4 V_112 , T_5 * V_39 )
{
struct V_1 * V_79 = V_36 -> V_40 ;
struct V_21 * V_22 = V_79 -> V_6 ;
...
void F_90 ( struct V_21 * V_22 , T_7 V_76 ,
...
( V_22 -> V_183 + 1 ) % V_168 ;
V_174 = V_22 -> V_183 ;
V_141 -> V_155 [ V_174 ] . V_76 = V_76 ;
F_87 ( & V_141 -> V_155 [ V_174 ] . V_157 ) ;
F_87 ( & V_141 -> V_155 [ V_174 ] . V_159 ) ;
}
for( V_93 = 0 ; ( V_38 >= ( 1 << V_160 << V_93 ) ) &&
( V_93 < ( V_156 - 1 ) ) ; V_93 ++ ) ;
if ( V_173 == 0 ) {
V_141 -> V_155 [ V_174 ] . V_157 . V_158 [ V_93 ] ++ ;
V_141 -> V_155 [ V_168 ] . V_157 . V_158 [ V_93 ] ++ ;
} else {
V_141 -> V_155 [ V_174 ] . V_159 . V_158 [ V_93 ] ++ ;
V_141 -> V_155 [ V_168 ] . V_159 . V_158 [ V_93 ] ++ ;
}
F_20 ( & V_22 -> V_167 ) ;
F_19 ( & V_22 -> V_184 ) ;
for ( V_93 = 0 ; V_93 < V_168 ; V_93 ++ ) {
if ( V_176 [ V_93 ] . V_185 == V_76 ) {
if ( V_176 [ V_93 ] . V_186 != V_36 ) {
V_176 [ V_93 ] . V_187 = V_172 ;
V_176 [ V_93 ] . V_188 = V_172 + V_38 ;
V_176 [ V_93 ] . V_189 = V_38 ;
V_176 [ V_93 ] . V_190 = V_38 ;
V_176 [ V_93 ] . V_191 = 0 ;
V_176 [ V_93 ] . V_186 = V_36 ;
F_20 ( & V_22 -> V_184 ) ;
return;
}
if ( V_176 [ V_93 ] . V_188 != V_172 ) {
* V_178 =
( * V_178 + 1 ) % V_192 ;
V_177 [ * V_178 ] . V_193 = V_176 [ V_93 ] . V_193 ;
V_177 [ * V_178 ] . V_185 = V_76 ;
V_177 [ * V_178 ] . V_187 =
V_176 [ V_93 ] . V_187 ;
V_177 [ * V_178 ] . V_194 =
V_176 [ V_93 ] . V_188 ;
...
V_177 [ * V_178 ] . V_191 =
V_176 [ V_93 ] . V_191 ;
V_176 [ V_93 ] . V_193 = V_173 ;
V_176 [ V_93 ] . V_187 = V_172 ;
V_176 [ V_93 ] . V_189 = V_38 ;
V_176 [ V_93 ] . V_190 = V_38 ;
V_176 [ V_93 ] . V_191 = V_172 -
V_176 [ V_93 ] . V_188 ;
}
if( V_176 [ V_93 ] . V_189 > V_38 )
V_176 [ V_93 ] . V_189 = V_38 ;
if( V_176 [ V_93 ] . V_190 < V_38 )
V_176 [ V_93 ] . V_190 = V_38 ;
V_176 [ V_93 ] . V_188 = V_172 + V_38 ;
F_20 ( & V_22 -> V_184 ) ;
return;
...
static int F_91 ( struct V_1 * V_79 , void * V_3 )
{
struct V_161 V_162 ;
struct V_21 * V_22 = V_79 -> V_6 ;
...
L_69 , L_70 , L_71 , L_72 ,
L_73 , L_74 , L_75 ) ;
for( V_93 = 0 ; V_93 < V_192 ; V_93 ++ ) {
if ( V_177 [ V_93 ] . V_185 != 0 )
F_5 ( V_79 , L_76 ,
V_177 [ V_93 ] . V_193 ? 'W' : 'R' ,
V_177 [ V_93 ] . V_185 ,
V_177 [ V_93 ] . V_187 ,
V_177 [ V_93 ] . V_194 ,
( unsigned long ) V_177 [ V_93 ] . V_189 ,
( unsigned long ) V_177 [ V_93 ] . V_190 ,
V_177 [ V_93 ] . V_191 ) ;
}
for( V_93 = 0 ; V_93 < V_168 ; V_93 ++ ) {
if ( V_176 [ V_93 ] . V_185 != 0 )
F_5 ( V_79 , L_76 ,
V_176 [ V_93 ] . V_193 ? 'W' : 'R' ,
V_176 [ V_93 ] . V_185 ,
V_176 [ V_93 ] . V_187 ,
V_176 [ V_93 ] . V_188 ,
( unsigned long ) V_176 [ V_93 ] . V_189 ,
( unsigned long ) V_176 [ V_93 ] . V_190 ,
V_176 [ V_93 ] . V_191 ) ;
}
F_20 ( & V_22 -> V_184 ) ;
return 0 ;
}
static T_3 F_92 ( struct V_36 * V_36 , const char * V_169 ,
T_4 V_112 , T_5 * V_39 )
{
struct V_1 * V_79 = V_36 -> V_40 ;
struct V_21 * V_22 = V_79 -> V_6 ;
struct V_175 * V_195 = V_22 -> V_175 ;
struct V_175 * V_196 = V_22 -> V_182 ;
int V_170 = 1 , V_9 = 0 ;
V_9 = F_40 ( V_169 , V_112 , & V_170 ) ;
if ( V_9 < 0 && ( strcmp ( V_169 , L_66 ) == 0 ||
strcmp ( V_169 , L_67 ) == 0 ) )
...
V_22 -> V_181 = 0 ;
V_22 -> V_179 = 0 ;
memset ( V_195 , 0 , sizeof( struct V_175 ) *
V_168 ) ;
