...
static int F_68 ( struct V_100 * V_101 , struct V_105 * V_106 )
{
struct V_31 * V_32 = V_101 -> V_102 ;
struct V_107 * V_107 ;
unsigned long V_108 ;
...
V_107 = F_69 ( V_32 -> V_33 -> V_2 [ V_37 ] . V_5 + V_108 ) ;
else
V_107 = F_70 ( ( void * ) ( unsigned long ) V_32 -> V_33 -> V_2 [ V_37 ] . V_5 + V_108 ) ;
F_71 ( V_107 ) ;
V_106 -> V_107 = V_107 ;
return 0 ;
}
...
if ( V_37 < 0 )
return - V_24 ;
V_101 -> V_114 = F_73 ( V_101 -> V_114 ) ;
return F_74 ( V_101 ,
V_101 -> V_115 ,
V_32 -> V_33 -> V_2 [ V_37 ] . V_5 >> V_111 ,
V_101 -> V_116 - V_101 -> V_115 ,
V_101 -> V_114 ) ;
}
static int F_75 ( struct V_100 * V_101 )
{
V_101 -> V_117 |= V_118 | V_119 ;
V_101 -> V_120 = & V_121 ;
F_66 ( V_101 ) ;
return 0 ;
}
static int F_76 ( struct V_70 * V_71 , struct V_100 * V_101 )
{
struct V_72 * V_73 = V_71 -> V_79 ;
struct V_31 * V_32 = V_73 -> V_29 ;
int V_37 ;
...
V_128 -> V_76 = V_131 ;
V_128 -> V_132 = & V_133 ;
F_81 ( & V_128 -> V_9 , L_18 , V_4 ) ;
V_129 = F_82 ( V_128 , V_60 , V_56 ) ;
if ( V_129 )
goto V_134;
V_135 = F_83 ( V_60 ) ;
V_136 = V_128 ;
...
F_31 ( V_32 ) ;
V_145:
F_100 ( & V_137 , F_86 ( V_135 , V_32 -> V_57 ) ) ;
V_144:
F_36 ( V_32 ) ;
V_143:
F_8 ( V_32 ) ;
