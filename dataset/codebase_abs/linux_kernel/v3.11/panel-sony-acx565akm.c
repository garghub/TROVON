...
V_83 -> V_84 . V_85 -> V_90 ( V_83 , V_2 -> V_91 ) ;
...
struct V_81 * V_83 = V_2 -> V_83 ;
V_2 -> V_89 = * V_99 ;
V_82 -> V_100 . V_99 = * V_99 ;
V_83 -> V_84 . V_85 -> V_88 ( V_83 , V_99 ) ;
}
...
struct V_1 * V_2 = F_37 ( V_82 ) ;
struct V_81 * V_83 = V_2 -> V_83 ;
return V_83 -> V_84 . V_85 -> V_101 ( V_83 , V_99 ) ;
}
static int F_53 ( struct V_102 * V_14 )
{
const struct V_103 * V_104 ;
struct V_1 * V_2 = F_28 ( & V_14 -> V_19 ) ;
struct V_81 * V_82 , * V_83 ;
V_104 = F_54 ( & V_14 -> V_19 ) ;
V_2 -> V_92 = V_104 -> V_92 ;
V_83 = F_55 ( V_104 -> V_105 ) ;
if ( V_83 == NULL ) {
F_19 ( & V_14 -> V_19 , L_19 ,
V_104 -> V_105 ) ;
return - V_106 ;
...
V_2 -> V_91 = V_104 -> V_91 ;
V_82 = & V_2 -> V_82 ;
V_82 -> V_40 = V_104 -> V_40 ;
return 0 ;
}
static int F_56 ( struct V_102 * V_14 )
{
struct V_1 * V_2 ;
struct V_81 * V_82 ;
struct V_63 * V_107 ;
...
V_14 -> V_54 = V_110 ;
V_2 = F_57 ( & V_14 -> V_19 , sizeof( * V_2 ) , V_111 ) ;
if ( V_2 == NULL )
return - V_112 ;
F_58 ( & V_14 -> V_19 , V_2 ) ;
V_2 -> V_14 = V_14 ;
...
V_2 -> V_31 = F_16 ( V_2 ) ;
V_13 = F_18 ( V_2 ) ;
if ( ! V_2 -> V_31 && F_43 ( V_2 -> V_92 ) )
F_44 ( V_2 -> V_92 , 0 ) ;
if ( V_13 ) {
F_19 ( & V_14 -> V_19 , L_21 , V_64 ) ;
goto V_115;
}
...
V_66 . V_69 = V_68 ;
V_66 . type = V_116 ;
V_107 = F_61 ( L_6 , & V_2 -> V_14 -> V_19 ,
V_2 , & V_117 , & V_66 ) ;
V_2 -> V_93 = V_107 ;
if ( V_2 -> V_42 ) {
V_13 = F_62 ( & V_107 -> V_19 . V_118 , & V_119 ) ;
if ( V_13 ) {
F_19 ( & V_107 -> V_19 ,
L_22 , V_64 ) ;
goto V_120;
...
V_70 = 0 ;
V_107 -> V_66 . V_108 = V_108 ;
V_107 -> V_66 . V_70 = V_70 ;
F_27 ( V_107 ) ;
V_2 -> V_89 = V_121 ;
V_82 = & V_2 -> V_82 ;
V_82 -> V_19 = & V_14 -> V_19 ;
...
static int F_67 ( struct V_102 * V_14 )
{
struct V_1 * V_2 = F_28 ( & V_14 -> V_19 ) ;
struct V_81 * V_82 = & V_2 -> V_82 ;
struct V_81 * V_83 = V_2 -> V_83 ;
F_6 ( & V_2 -> V_14 -> V_19 , L_13 , V_64 ) ;
F_64 ( & V_2 -> V_93 -> V_19 . V_118 , & V_119 ) ;
F_65 ( V_2 -> V_93 ) ;
F_68 ( V_82 ) ;
F_49 ( V_82 ) ;
F_39 ( V_82 ) ;
