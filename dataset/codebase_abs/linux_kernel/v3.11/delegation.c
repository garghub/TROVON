...
static int F_32 ( struct V_7 * V_7 , struct V_1 * V_2 , int V_49 )
{
int V_42 = 0 ;
V_42 = F_33 ( V_7 , V_2 -> V_3 , & V_2 -> V_16 , V_49 ) ;
F_1 ( V_2 ) ;
return V_42 ;
}
...
static struct V_1 * F_45 ( struct V_28 * V_29 ,
struct V_1 * V_2 ,
struct V_58 * V_59 )
{
struct V_50 * V_51 = V_59 -> V_50 ;
F_13 ( & V_51 -> V_56 ) ;
V_2 = F_40 ( V_29 , V_2 , V_51 ) ;
F_15 ( & V_51 -> V_56 ) ;
return V_2 ;
}
static struct V_1 *
...
{
struct V_28 * V_29 = F_9 ( V_7 ) ;
struct V_58 * V_59 = F_47 ( V_7 ) ;
struct V_1 * V_2 ;
V_2 = F_38 ( V_29 ) ;
if ( V_2 == NULL )
return NULL ;
return F_45 ( V_29 , V_2 , V_59 ) ;
}
int F_31 ( struct V_7 * V_7 , struct V_40 * V_3 , struct V_41 * V_42 )
{
struct V_58 * V_59 = F_47 ( V_7 ) ;
struct V_50 * V_51 = V_59 -> V_50 ;
struct V_28 * V_29 = F_9 ( V_7 ) ;
...
static int F_52 ( struct V_7 * V_7 , struct V_1 * V_2 , int V_49 )
{
struct V_50 * V_51 = F_47 ( V_7 ) -> V_50 ;
struct V_28 * V_29 = F_9 ( V_7 ) ;
int V_33 ;
if ( V_2 == NULL )
return 0 ;
...
if ( ! F_45 ( V_29 , V_2 , F_47 ( V_7 ) ) )
goto V_21;
V_33 = F_32 ( V_7 , V_2 , V_49 ) ;
V_21:
return V_33 ;
}
...
{
bool V_8 = false ;
if ( F_55 ( V_52 , & V_2 -> V_6 ) )
V_8 = true ;
if ( F_55 ( V_72 , & V_2 -> V_6 ) && ! V_8 ) {
struct V_7 * V_7 ;
F_13 ( & V_2 -> V_44 ) ;
V_7 = V_2 -> V_7 ;
if ( V_7 && F_56 ( & F_9 ( V_7 ) -> V_73 ) )
V_8 = true ;
F_15 ( & V_2 -> V_44 ) ;
}
return V_8 ;
}
int F_57 ( struct V_50 * V_51 )
{
struct V_1 * V_2 ;
struct V_58 * V_59 ;
struct V_7 * V_7 ;
...
V_74:
F_7 () ;
F_58 (server, &clp->cl_superblocks, client_link) {
F_58 (delegation, &server->delegations,
super_list) {
if ( ! F_54 ( V_2 ) )
continue;
V_7 = F_34 ( V_2 ) ;
...
struct V_1 * V_2 ;
bool V_8 = false ;
F_58 (delegation, &server->delegations, super_list) {
F_64 ( V_59 , V_2 ) ;
V_8 = true ;
}
return V_8 ;
...
void F_75 ( struct V_50 * V_51 , T_1 V_6 )
{
F_72 ( V_51 , V_6 ) ;
F_67 ( V_51 ) ;
}
...
struct V_7 * F_82 ( struct V_50 * V_51 ,
const struct V_80 * V_81 )
{
struct V_58 * V_59 ;
struct V_7 * V_42 = NULL ;
...
static void F_83 ( struct V_58 * V_59 )
{
struct V_1 * V_2 ;
F_58 (delegation, &server->delegations, super_list)
F_5 ( V_47 , & V_2 -> V_6 ) ;
}
void F_84 ( struct V_50 * V_51 )
{
struct V_58 * V_59 ;
F_7 () ;
F_58 (server, &clp->cl_superblocks, client_link)
...
bool F_87 ( T_2 * V_83 , struct V_7 * V_7 ,
T_1 V_6 )
{
struct V_28 * V_29 = F_9 ( V_7 ) ;
struct V_1 * V_2 ;
