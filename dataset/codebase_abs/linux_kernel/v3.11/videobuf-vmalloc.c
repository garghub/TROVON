...
if ( NULL == V_7 -> V_16 [ V_11 ] )
continue;
if ( V_7 -> V_16 [ V_11 ] -> V_4 != V_4 )
continue;
V_13 = V_7 -> V_16 [ V_11 ] -> V_17 ;
if ( V_13 ) {
F_7 ( V_13 -> V_18 , V_19 ) ;
F_2 ( 1 , L_4 ,
V_20 , V_11 , V_13 -> V_21 ) ;
...
V_7 -> V_16 [ V_11 ] -> V_4 = NULL ;
V_7 -> V_16 [ V_11 ] -> V_22 = 0 ;
}
F_9 ( V_4 ) ;
}
F_4 ( V_7 ) ;
...
struct V_55 * V_56 )
{
F_20 ( V_7 , V_47 , V_49 , V_50 , type , V_53 , V_54 ,
V_17 , & V_57 , V_56 ) ;
}
