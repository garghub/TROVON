...
if ( V_53 != NULL )
V_49 = V_53 -> V_49 ;
V_2 = F_23 ( & V_48 -> V_11 , sizeof( * V_2 ) , V_54 ) ;
if ( V_2 == NULL ) {
F_3 ( & V_48 -> V_11 , L_19 ) ;
return - V_55 ;
}
...
V_2 -> V_23 = V_51 -> V_59 ;
V_2 -> V_25 = V_2 -> V_23 + V_60 ;
V_2 -> V_26 = V_2 -> V_23 + V_61 ;
V_2 -> V_35 = V_2 -> V_23 + V_62 ;
V_2 -> V_10 = & V_48 -> V_11 ;
...
static int F_36 ( struct V_8 * V_11 )
{
struct V_1 * V_2 = F_7 ( V_11 ) ;
if ( F_37 ( V_11 ) )
F_38 ( V_2 -> V_56 ) ;
...
static int F_39 ( struct V_8 * V_11 )
{
struct V_1 * V_2 = F_7 ( V_11 ) ;
if ( F_37 ( V_11 ) )
F_40 ( V_2 -> V_56 ) ;
