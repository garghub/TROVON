...
if ( V_94 -> V_159 < V_160 * 10 )
V_94 -> V_159 ++ ;
if ( V_94 -> V_159 > V_160 )
return;
V_95 = F_147 ( V_94 -> V_95 ) ;
V_94 -> V_23 = F_148 ( long , 0 , V_57 - V_95 / 2 ) ;
V_94 -> V_124 = V_95 ;
V_94 -> V_161 = V_95 / 4 ;
F_149 ( V_94 , V_3 , V_91 ) ;
}
...
return V_166 ;
V_1 = F_99 ( V_3 , V_57 ) ;
if ( F_58 ( V_1 ) && ! ( V_163 -> V_19 & V_167 ) ) {
F_150 ( V_155 , V_94 , V_91 , V_1 , V_57 ) ;
} else if ( ! V_1 ) {
F_146 ( V_155 , V_94 , V_91 , V_57 ) ;
F_152 ( V_168 ) ;
F_153 ( V_155 -> V_169 , V_168 ) ;
V_17 = V_170 ;
V_171:
V_1 = F_99 ( V_3 , V_57 ) ;
if ( ! V_1 )
...
if ( ! F_154 ( V_1 , V_155 -> V_169 , V_163 -> V_19 ) ) {
F_22 ( V_1 ) ;
return V_17 | V_172 ;
}
if ( F_103 ( V_1 -> V_3 != V_3 ) ) {
...
int F_156 ( struct V_154 * V_155 , struct V_162 * V_163 )
{
struct V_1 * V_1 = V_163 -> V_1 ;
struct V_100 * V_100 = F_157 ( V_155 -> V_164 ) ;
int V_17 = V_174 ;
F_158 ( V_100 -> V_176 ) ;
F_159 ( V_155 -> V_164 ) ;
F_109 ( V_1 ) ;
...
int F_163 ( struct V_91 * V_91 , struct V_154 * V_155 )
{
struct V_2 * V_3 = V_91 -> V_99 ;
if ( ! V_3 -> V_12 -> V_120 )
return - V_179 ;
...
int F_164 ( struct V_91 * V_91 , struct V_154 * V_155 )
{
if ( ( V_155 -> V_156 & V_182 ) && ( V_155 -> V_156 & V_183 ) )
return - V_141 ;
return F_163 ( V_91 , V_155 ) ;
}
int F_163 ( struct V_91 * V_91 , struct V_154 * V_155 )
{
return - V_184 ;
...
int V_49 ;
V_187:
V_1 = F_165 ( V_3 , V_5 , F_166 , V_185 , V_60 ) ;
if ( F_169 ( V_1 ) )
return V_1 ;
if ( F_3 ( V_1 ) )
goto V_42;
...
void * V_185 )
{
return F_168 ( V_3 , V_5 , F_166 , V_185 , F_120 ( V_3 ) ) ;
}
...
T_3 V_60 )
{
T_9 * F_166 = ( T_9 * ) V_3 -> V_12 -> V_120 ;
return F_171 ( F_168 ( V_3 , V_5 , F_166 , NULL , V_60 ) ) ;
}
...
static T_8 F_174 ( char * V_188 ,
const struct V_132 * V_133 , T_8 V_189 , T_8 V_190 )
{
T_8 V_191 = 0 , V_126 = 0 ;
while ( V_190 ) {
char T_10 * V_128 = V_133 -> V_142 + V_189 ;
int V_192 = F_39 ( V_190 , V_133 -> V_139 - V_189 ) ;
V_189 = 0 ;
V_126 = F_175 ( V_188 , V_128 , V_192 ) ;
V_191 += V_192 ;
V_190 -= V_192 ;
V_188 += V_192 ;
V_133 ++ ;
...
T_8 F_176 ( struct V_1 * V_1 ,
struct V_193 * V_45 , unsigned long V_57 , T_8 V_190 )
{
char * V_125 ;
T_8 V_191 ;
F_10 ( ! F_177 () ) ;
...
int V_126 ;
char T_10 * V_128 = V_45 -> V_133 -> V_142 + V_45 -> V_194 ;
V_126 = F_175 ( V_125 + V_57 , V_128 , V_190 ) ;
V_191 = V_190 - V_126 ;
} else {
V_191 = F_174 ( V_125 + V_57 ,
...
int V_126 ;
char T_10 * V_128 = V_45 -> V_133 -> V_142 + V_45 -> V_194 ;
V_126 = F_179 ( V_125 + V_57 , V_128 , V_190 ) ;
V_191 = V_190 - V_126 ;
} else {
V_191 = F_174 ( V_125 + V_57 ,
V_45 -> V_133 , V_45 -> V_194 , V_190 ) ;
...
void F_180 ( struct V_193 * V_45 , T_8 V_190 )
{
...
T_8 V_189 = V_45 -> V_194 ;
unsigned long V_134 = V_45 -> V_134 ;
while ( V_190 || F_103 ( V_45 -> V_107 && ! V_133 -> V_139 ) ) {
int V_192 ;
...
int F_181 ( struct V_193 * V_45 , T_8 V_190 )
{
char T_10 * V_128 = V_45 -> V_133 -> V_142 + V_45 -> V_194 ;
V_190 = F_39 ( V_190 , V_45 -> V_133 -> V_139 - V_45 -> V_194 ) ;
return F_182 ( V_128 , V_190 ) ;
}
T_8 F_183 ( const struct V_193 * V_45 )
{
const struct V_132 * V_133 = V_45 -> V_133 ;
if ( V_45 -> V_134 == 1 )
return V_45 -> V_107 ;
...
inline int F_184 ( struct V_91 * V_91 , T_1 * V_145 , T_8 * V_107 , int V_195 )
{
struct V_100 * V_100 = V_91 -> V_99 -> V_48 ;
unsigned long V_196 = F_185 ( V_197 ) ;
if ( F_103 ( * V_145 < 0 ) )
return - V_141 ;
if ( ! V_195 ) {
if ( V_91 -> V_150 & V_198 )
...
if ( * V_107 > V_196 - ( F_187 ( V_196 ) ) * V_145 ) {
* V_107 = V_196 - ( F_187 ( V_196 ) ) * V_145 ;
}
}
}
if ( F_103 ( * V_145 + * V_107 > V_202 &&
! ( V_91 -> V_150 & V_203 ) ) ) {
if ( * V_145 >= V_202 ) {
return - V_201 ;
}
...
if ( F_58 ( ! V_195 ) ) {
if ( F_103 ( * V_145 >= V_100 -> V_176 -> V_204 ) ) {
if ( * V_107 || * V_145 > V_100 -> V_176 -> V_204 ) {
return - V_201 ;
}
}
if ( F_103 ( * V_145 + * V_107 > V_100 -> V_176 -> V_204 ) )
* V_107 = V_100 -> V_176 -> V_204 - * V_145 ;
} else {
#ifdef F_188
T_1 V_110 ;
if ( F_189 ( F_190 ( V_100 ) ) )
return - V_205 ;
V_110 = F_45 ( V_100 ) ;
if ( * V_145 >= V_110 ) {
...
int F_191 ( struct V_91 * V_91 , struct V_2 * V_3 ,
T_1 V_145 , unsigned V_206 , unsigned V_19 ,
struct V_1 * * V_81 , void * * V_207 )
{
const struct V_208 * V_209 = V_3 -> V_12 ;
return V_209 -> V_210 ( V_91 , V_3 , V_145 , V_206 , V_19 ,
V_81 , V_207 ) ;
}
int F_192 ( struct V_91 * V_91 , struct V_2 * V_3 ,
T_1 V_145 , unsigned V_206 , unsigned V_191 ,
struct V_1 * V_1 , void * V_207 )
{
const struct V_208 * V_209 = V_3 -> V_12 ;
F_128 ( V_1 ) ;
return V_209 -> V_211 ( V_91 , V_3 , V_145 , V_206 , V_191 , V_1 , V_207 ) ;
}
V_140
F_193 ( struct V_143 * V_144 , const struct V_132 * V_133 ,
...
T_2 V_24 ;
if ( V_107 != V_212 )
* V_134 = F_194 ( (struct V_132 * ) V_133 , * V_134 , V_107 ) ;
...
if ( V_131 > 0 ) {
V_145 += V_131 ;
if ( V_145 > F_45 ( V_100 ) && ! F_196 ( V_100 -> V_216 ) ) {
F_197 ( V_100 , V_145 ) ;
F_198 ( V_100 ) ;
}
* V_96 = V_145 ;
...
static V_140 F_200 ( struct V_91 * V_91 ,
...
void * V_207 ;
V_57 = ( V_145 & ( V_106 - 1 ) ) ;
V_190 = F_203 (unsigned long, PAGE_CACHE_SIZE - offset,
iov_iter_count(i)) ;
V_224:
if ( F_103 ( F_181 ( V_45 , V_190 ) ) ) {
V_217 = - V_130 ;
break;
}
V_217 = V_12 -> V_210 ( V_91 , V_3 , V_145 , V_190 , V_19 ,
& V_1 , & V_207 ) ;
if ( F_103 ( V_217 ) )
break;
if ( F_126 ( V_3 ) )
F_127 ( V_1 ) ;
F_204 () ;
V_191 = F_176 ( V_1 , V_45 , V_57 , V_190 ) ;
F_205 () ;
F_127 ( V_1 ) ;
F_128 ( V_1 ) ;
V_217 = V_12 -> V_211 ( V_91 , V_3 , V_145 , V_190 , V_191 ,
V_1 , V_207 ) ;
if ( F_103 ( V_217 < 0 ) )
break;
V_191 = V_217 ;
...
V_140
F_208 ( struct V_143 * V_144 , const struct V_132 * V_133 ,
unsigned long V_134 , T_1 V_145 , T_1 * V_96 ,
...
V_140 V_217 ;
struct V_193 V_45 ;
F_209 ( & V_45 , V_133 , V_134 , V_107 , V_131 ) ;
V_217 = F_200 ( V_91 , & V_45 , V_145 ) ;
if ( F_58 ( V_217 >= 0 ) ) {
V_131 += V_217 ;
* V_96 = V_145 + V_217 ;
}
...
V_140 F_210 ( struct V_143 * V_144 , const struct V_132 * V_133 ,
...
V_15 -> V_10 = V_3 -> V_10 ;
V_131 = 0 ;
V_49 = F_184 ( V_91 , & V_145 , & V_107 , F_196 ( V_100 -> V_216 ) ) ;
if ( V_49 )
goto V_42;
if ( V_107 == 0 )
goto V_42;
...
T_1 V_226 ;
V_140 V_227 ;
V_131 = F_193 ( V_144 , V_133 , & V_134 , V_145 ,
V_96 , V_107 , V_212 ) ;
if ( V_131 < 0 || V_131 == V_107 )
goto V_42;
V_145 += V_131 ;
V_107 -= V_131 ;
V_227 = F_208 ( V_144 , V_133 ,
...
V_49 = F_47 ( V_91 -> V_99 , V_145 , V_226 ) ;
if ( V_49 == 0 ) {
V_131 = V_227 ;
F_212 ( V_3 ,
V_145 >> V_37 ,
...
V_140 F_213 ( struct V_143 * V_144 , const struct V_132 * V_133 ,
unsigned long V_134 , T_1 V_145 )
{
struct V_91 * V_91 = V_144 -> V_146 ;
struct V_100 * V_100 = V_91 -> V_99 -> V_48 ;
...
F_214 ( & V_100 -> V_228 ) ;
V_17 = F_210 ( V_144 , V_133 , V_134 , & V_144 -> V_148 ) ;
F_215 ( & V_100 -> V_228 ) ;
if ( V_17 > 0 || V_17 == - V_229 ) {
V_140 V_49 ;
V_49 = F_216 ( V_91 , V_145 , V_17 ) ;
if ( V_49 < 0 && V_17 > 0 )
V_17 = V_49 ;
}
return V_17 ;
}
int F_217 ( struct V_1 * V_1 , T_3 V_55 )
{
