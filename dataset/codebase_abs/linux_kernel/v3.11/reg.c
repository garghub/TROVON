...
static const char * F_58 ( enum V_97 V_94 )
{
switch ( V_94 ) {
case V_98 :
return L_5 ;
...
static void F_75 ( struct V_3 * V_3 , unsigned int V_137 ,
struct V_138 * V_138 )
{
struct V_121 * V_122 ;
struct V_100 * V_101 ;
...
if ( F_76 ( V_101 -> V_88 != V_138 -> V_101 . V_88 ) )
return;
if ( V_101 -> V_119 )
return;
V_101 -> V_119 = true ;
...
static bool F_82 ( struct V_100 * V_101 )
{
if ( ! V_101 )
return false ;
if ( V_101 -> V_69 & V_106 )
...
static void F_87 ( enum V_97 V_94 )
{
struct V_154 * V_155 ;
struct V_3 * V_3 ;
F_9 () ;
...
static void F_99 ( struct V_7 * V_167 ,
enum V_97 V_168 )
{
struct V_3 * V_3 = NULL ;
if ( F_12 ( ! V_167 -> V_16 ) )
...
F_105 ( & V_172 ) ;
F_106 (pending_beacon, tmp,
&reg_pending_beacons, list) {
F_103 ( & V_170 -> V_36 ) ;
F_80 (rdev, &cfg80211_rdev_list, list)
F_78 ( & V_155 -> V_3 , V_170 ) ;
...
static void F_109 ( struct V_7 * V_31 )
{
...
static int F_110 ( const char * V_16 )
{
struct V_7 * V_31 ;
...
int F_112 ( struct V_3 * V_3 , const char * V_16 )
{
struct V_7 * V_31 ;
if ( F_12 ( ! V_16 || ! V_3 ) )
return - V_70 ;
...
void F_114 ( struct V_3 * V_3 , enum V_150 V_142 ,
...
static void F_117 ( char * V_16 , bool V_185 )
{
V_16 [ 0 ] = '9' ;
V_16 [ 1 ] = '7' ;
if ( F_20 () ) {
...
F_117 ( V_16 , V_185 ) ;
F_94 ( & V_161 ) ;
F_106 (reg_request, tmp, &reg_requests_list, list) {
if ( V_167 -> V_94 != V_96 )
continue;
F_121 ( & V_167 -> V_36 , & V_189 ) ;
}
F_95 ( & V_161 ) ;
F_105 ( & V_172 ) ;
F_106 (reg_beacon, btmp, &reg_pending_beacons, list) {
F_30 ( & V_138 -> V_36 ) ;
F_31 ( V_138 ) ;
}
F_107 ( & V_172 ) ;
F_106 (reg_beacon, btmp, &reg_beacon_list, list) {
F_30 ( & V_138 -> V_36 ) ;
F_31 ( V_138 ) ;
}
V_187 [ 0 ] = V_12 -> V_16 [ 0 ] ;
...
static bool F_124 ( T_3 V_191 )
{
if ( V_191 == F_125 ( 12 , V_192 ) ||
V_191 == F_125 ( 13 , V_192 ) ||
V_191 == F_125 ( 14 , V_192 ) )
return true ;
return false ;
}
static bool F_126 ( struct V_100 * V_193 )
{
struct V_138 * V_170 ;
...
static void F_130 ( const struct V_1 * V_15 )
{
unsigned int V_22 ;
const struct V_24 * V_52 = NULL ;
const struct V_46 * V_47 = NULL ;
...
static void F_133 ( const struct V_1 * V_15 )
{
struct V_7 * V_11 = F_6 () ;
if ( F_16 ( V_15 -> V_16 ) ) {
if ( V_11 -> V_94 == V_95 ) {
struct V_154 * V_155 ;
V_155 = F_134 ( V_11 -> V_104 ) ;
if ( V_155 ) {
F_42 ( L_35 ,
V_155 -> V_201 [ 0 ] ,
V_155 -> V_201 [ 1 ] ) ;
...
static void F_135 ( const struct V_1 * V_15 )
{
F_42 ( L_41 , V_15 -> V_16 [ 0 ] , V_15 -> V_16 [ 1 ] ) ;
F_130 ( V_15 ) ;
}
static int F_136 ( const struct V_1 * V_15 )
{
const struct V_1 * V_4 ;
...
int F_138 ( struct V_205 * V_41 , struct V_206 * V_178 )
{
struct V_7 * V_11 ;
T_2 V_16 [ 2 ] ;
bool V_207 = false ;
