...
V_4 = F_20 ( & V_6 -> V_7 , sizeof( struct V_1 ) , V_26 ) ;
if ( ! V_4 ) {
F_8 ( & V_6 -> V_7 , L_6 ) ;
return - V_27 ;
}
...
if ( ! V_24 )
return - V_10 ;
V_4 -> V_28 = (struct V_15 * ) V_24 ;
V_23 = F_21 ( V_6 , V_29 , 0 ) ;
V_4 -> V_23 = F_22 ( & V_6 -> V_7 , V_23 ) ;
if ( F_17 ( V_4 -> V_23 ) )
return F_19 ( V_4 -> V_23 ) ;
V_4 -> V_30 = V_23 -> V_31 ;
V_4 -> V_13 = F_23 ( & V_6 -> V_7 , L_7 ) ;
if ( F_17 ( V_4 -> V_13 ) ) {
F_8 ( & V_6 -> V_7 , L_8 ) ;
return - V_32 ;
}
F_9 ( V_4 -> V_13 ) ;
F_24 ( V_4 -> V_23 , V_33 , - 1 ) ;
F_25 ( V_4 -> V_23 , V_34 ) ;
F_11 ( V_4 -> V_13 ) ;
V_4 -> V_35 = F_26 ( V_6 , 0 ) ;
if ( ! V_4 -> V_35 ) {
...
static int F_30 ( struct V_16 * V_6 )
{
