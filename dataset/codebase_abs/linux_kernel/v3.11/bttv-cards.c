...
int V_241 , V_242 ;
struct V_1 * V_245 ;
static unsigned char V_246 [ 4 ] = { 3 , 0 , 2 , 1 } ;
V_245 = V_247 [ V_2 -> V_6 . V_12 ] ;
if ( V_245 == NULL ) {
return;
}
V_242 = ( V_2 -> V_6 . V_12 - V_245 -> V_6 . V_12 + 1 ) & 3 ;
V_242 = V_246 [ V_242 ] ;
V_244 = ( char * ) ( & V_245 -> V_44 ) ;
V_241 = V_59 & 0xf ;
if ( V_244 [ V_242 ] != V_241 )
{
F_78 ( V_245 , V_244 [ V_242 ] , V_242 , 0 ) ;
V_244 [ V_242 ] = V_241 ;
F_78 ( V_245 , V_241 , V_242 , 1 ) ;
}
}
static void F_43 ( struct V_1 * V_2 )
{
char * V_244 = ( char * ) ( & V_2 -> V_44 ) ;
int V_248 ;
...
return;
V_247 [ V_2 -> V_6 . V_12 - 1 ] = V_2 ;
V_247 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_247 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_247 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
}
...
char * V_244 ;
int V_241 , V_242 ;
static unsigned int V_246 [ 4 ] [ 4 ] = { { 0x0 , 0x4 , 0xa , 0x6 } ,
{ 0x1 , 0x5 , 0xb , 0x7 } ,
{ 0x2 , 0x8 , 0xc , 0xe } ,
{ 0x3 , 0x9 , 0xd , 0xf } } ;
V_59 = V_59 % 4 ;
...
V_242 = ( V_2 -> V_6 . V_12 - V_245 -> V_6 . V_12 ) & 3 ;
V_244 = ( char * ) ( & V_245 -> V_44 ) ;
V_241 = V_246 [ V_242 ] [ V_59 ] & 0xf ;
if ( V_244 [ V_242 ] != V_241 ) {
F_85 ( V_245 , V_244 [ V_242 ] , V_242 , 0 ) ;
V_244 [ V_242 ] = V_241 ;
F_85 ( V_245 , V_241 , V_242 , 1 ) ;
}
}
