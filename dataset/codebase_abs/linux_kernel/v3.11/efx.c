...
++ V_161 ;
if ( V_2 -> V_164 == V_165 ) {
struct V_166 V_167 [ V_99 ] ;
unsigned int V_29 ;
V_29 = F_132 ( V_2 ) ;
if ( V_168 )
V_29 *= 2 ;
V_29 += V_161 ;
V_29 = F_143 ( V_29 , V_159 ) ;
for ( V_43 = 0 ; V_43 < V_29 ; V_43 ++ )
V_167 [ V_43 ] . V_169 = V_43 ;
V_59 = F_144 ( V_2 -> V_92 , V_167 , V_29 ) ;
if ( V_59 > 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_45
L_46 , V_59 , V_29 ) ;
...
V_59 = F_146 ( V_2 -> V_92 ) ;
if ( V_59 == 0 ) {
F_145 ( V_2 , 0 ) -> V_33 = V_2 -> V_92 -> V_33 ;
} else {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_49 ) ;
V_2 -> V_164 = V_174 ;
...
V_2 -> V_175 = ( ( V_2 -> V_171 > 1 || ! F_140 ( V_2 ) ) ?
V_2 -> V_171 : F_141 ( V_2 ) ) ;
return 0 ;
}
static void F_88 ( struct V_1 * V_2 , bool V_176 )
{
struct V_9 * V_10 ;
F_20 ( V_2 -> V_3 == V_4 ) ;
if ( V_2 -> V_177 ) {
...
F_25 ( V_2 ) ;
F_53 (channel, efx) {
if ( ! V_10 -> type -> V_178 || ! V_176 )
F_32 ( V_10 ) ;
F_34 ( V_10 ) ;
}
F_149 ( V_2 ) ;
}
static void F_84 ( struct V_1 * V_2 , bool V_176 )
{
struct V_9 * V_10 ;
if ( V_2 -> V_3 == V_4 )
return;
...
V_2 -> type -> V_180 ( V_2 ) ;
if ( V_2 -> V_29 > 1 )
F_156 ( & V_2 -> V_181 , sizeof( V_2 -> V_181 ) ) ;
for ( V_43 = 0 ; V_43 < F_157 ( V_2 -> V_182 ) ; V_43 ++ )
V_2 -> V_182 [ V_43 ] =
F_158 ( V_43 , V_2 -> V_175 ) ;
F_154 ( V_2 ) ;
F_159 ( V_2 -> V_7 , V_2 -> V_170 ) ;
F_160 ( V_2 -> V_7 , V_2 -> V_171 ) ;
F_161 ( V_2 , V_183 , V_184 , true ,
true ) ;
return 0 ;
V_61:
V_2 -> type -> remove ( V_2 ) ;
...
static unsigned int F_175 ( unsigned int V_196 , unsigned int V_197 )
{
if ( V_196 == 0 )
return 0 ;
if ( V_196 * 1000 < V_197 )
...
int F_161 ( struct V_1 * V_2 , unsigned int V_198 ,
unsigned int V_199 , bool V_200 ,
bool V_201 )
{
struct V_9 * V_10 ;
unsigned int V_202 = F_176 ( V_2 -> type -> V_203 *
V_2 -> V_204 ,
1000 ) ;
unsigned int V_205 ;
unsigned int V_206 ;
...
return - V_187 ;
V_205 = F_175 ( V_198 , V_2 -> V_204 ) ;
V_206 = F_175 ( V_199 , V_2 -> V_204 ) ;
...
void F_178 ( struct V_1 * V_2 , unsigned int * V_198 ,
unsigned int * V_199 , bool * V_200 )
{
* V_200 = V_2 -> V_21 ;
* V_199 = F_176 ( V_2 -> V_28 *
V_2 -> V_204 ,
1000 ) ;
if ( V_2 -> V_66 == 0 )
* V_198 = * V_199 ;
...
static void F_179 ( struct V_128 * V_129 )
{
...
static int F_181 ( struct V_209 * V_7 , struct V_210 * V_211 , int V_212 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
struct V_213 * V_129 = F_183 ( V_211 ) ;
if ( V_212 == V_214 )
return F_184 ( V_2 , V_211 , V_212 ) ;
if ( ( V_212 == V_215 || V_212 == V_216 ) &&
( V_129 -> V_217 & 0xfc00 ) == 0x0400 )
V_129 -> V_217 ^= V_218 | 0x0400 ;
return F_185 ( & V_2 -> V_219 , V_129 , V_212 ) ;
}
static void F_85 ( struct V_9 * V_10 )
{
struct V_1 * V_2 = V_10 -> V_2 ;
V_10 -> V_54 = V_2 -> V_7 ;
F_186 ( V_10 -> V_54 , & V_10 -> V_19 ,
F_13 , V_220 ) ;
}
...
static void F_190 ( struct V_209 * V_7 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
struct V_9 * V_10 ;
F_53 (channel, efx)
...
static int F_192 ( struct V_209 * V_7 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
int V_59 ;
...
static struct V_222 * F_197 ( struct V_209 * V_7 ,
struct V_222 * V_223 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
...
static void F_200 ( struct V_209 * V_7 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
...
static int F_201 ( struct V_209 * V_7 , int V_257 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
int V_59 ;
V_59 = F_1 ( V_2 ) ;
...
static int F_202 ( struct V_209 * V_7 , void * V_129 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
...
static void F_205 ( struct V_209 * V_7 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
struct V_265 * V_266 ;
...
if ( V_2 -> V_94 )
F_209 ( V_2 -> V_189 , & V_2 -> V_130 ) ;
}
static int F_210 ( struct V_209 * V_7 , T_6 V_129 )
{
struct V_1 * V_2 = F_182 ( V_7 ) ;
...
static T_7
F_216 ( struct V_287 * V_93 , struct V_288 * V_289 , char * V_63 )
{
struct V_1 * V_2 = F_217 ( F_218 ( V_93 ) ) ;
...
F_226 () ;
V_59 = F_227 ( & V_2 -> V_92 -> V_93 , & V_299 ) ;
if ( V_59 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 ,
L_65 ) ;
goto V_300;
...
if ( ! V_2 -> V_7 )
return;
F_20 ( F_182 ( V_2 -> V_7 ) != V_2 ) ;
F_53 (channel, efx) {
F_46 (tx_queue, channel)
F_230 ( V_46 ) ;
}
F_231 ( V_2 -> V_67 , F_232 ( V_2 -> V_92 ) , sizeof( V_2 -> V_67 ) ) ;
F_233 ( & V_2 -> V_92 -> V_93 , & V_299 ) ;
F_221 () ;
F_228 ( V_2 -> V_7 ) ;
V_2 -> V_3 = V_301 ;
F_226 () ;
}
void F_234 ( struct V_1 * V_2 , enum V_302 V_303 )
{
F_72 ( V_2 ) ;
F_83 ( V_2 ) ;
F_84 ( V_2 , false ) ;
...
int F_235 ( struct V_1 * V_2 , enum V_302 V_303 , bool V_305 )
{
int V_59 ;
F_72 ( V_2 ) ;
...
int F_194 ( struct V_1 * V_2 , enum V_302 V_303 )
{
int V_59 , V_306 ;
bool V_307 ;
...
F_27 ( V_2 , V_6 , V_2 -> V_7 ,
L_75 ,
F_238 ( V_303 ) , F_238 ( type ) ) ;
break;
}
F_248 ( V_303 , & V_2 -> V_297 ) ;
F_222 () ;
if ( F_246 ( V_2 -> V_3 ) != V_296 )
return;
F_150 ( V_2 ) ;
F_209 ( V_318 , & V_2 -> V_313 ) ;
}
...
F_255 ( & V_2 -> V_320 ) ;
#endif
F_256 ( & V_2 -> V_313 , F_245 ) ;
F_257 ( & V_2 -> V_190 , F_179 ) ;
F_257 ( & V_2 -> V_321 , V_322 ) ;
V_2 -> V_92 = V_92 ;
V_2 -> V_323 = V_324 ;
V_2 -> V_3 = V_301 ;
F_231 ( V_2 -> V_67 , F_232 ( V_92 ) , sizeof( V_2 -> V_67 ) ) ;
V_2 -> V_7 = V_7 ;
F_253 ( & V_2 -> V_226 ) ;
F_258 ( & V_2 -> V_125 ) ;
V_2 -> V_138 = & V_325 ;
V_2 -> V_219 . V_93 = V_7 ;
F_256 ( & V_2 -> V_130 , F_112 ) ;
F_259 ( & V_2 -> V_326 ) ;
...
F_29 ( V_2 -> type -> V_160 > V_99 ) ;
V_2 -> V_164 = F_30 ( V_2 -> type -> V_327 ,
V_164 ) ;
snprintf ( V_2 -> V_328 , sizeof( V_2 -> V_328 ) , L_76 ,
F_232 ( V_92 ) ) ;
V_2 -> V_189 = F_260 ( V_2 -> V_328 ) ;
if ( ! V_2 -> V_189 )
goto V_61;
return 0 ;
V_61:
...
static void F_265 ( struct V_92 * V_92 )
{
struct V_1 * V_2 ;
V_2 = F_217 ( V_92 ) ;
if ( ! V_2 )
...
T_7 V_331 ;
int V_43 , V_47 ;
V_331 = F_272 ( V_93 , 0 , sizeof( V_329 ) , V_329 ) ;
if ( V_331 <= 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_78 ) ;
return;
}
V_43 = F_273 ( V_329 , 0 , V_331 , V_332 ) ;
if ( V_43 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_79 ) ;
return;
}
V_47 = F_274 ( & V_329 [ V_43 ] ) ;
V_43 += V_333 ;
if ( V_43 + V_47 > V_331 )
V_47 = V_331 - V_43 ;
V_43 = F_275 ( V_329 , V_43 , V_47 , L_80 ) ;
if ( V_43 < 0 ) {
F_2 ( V_2 , V_6 , V_2 -> V_7 , L_81 ) ;
return;
}
V_47 = F_276 ( & V_329 [ V_43 ] ) ;
V_43 += V_334 ;
if ( V_43 + V_47 > V_331 ) {
...
static int F_279 ( struct V_92 * V_92 ,
const struct V_336 * V_169 )
{
struct V_209 * V_7 ;
struct V_1 * V_2 ;
int V_59 ;
V_7 = F_280 ( sizeof( * V_2 ) , V_337 ,
V_338 ) ;
if ( ! V_7 )
return - V_104 ;
V_2 = F_182 ( V_7 ) ;
V_2 -> type = ( const struct V_339 * ) V_169 -> V_340 ;
...
static int F_285 ( struct V_287 * V_93 )
{
struct V_1 * V_2 = F_217 ( F_218 ( V_93 ) ) ;
F_221 () ;
if ( V_2 -> V_3 != V_4 ) {
...
static int F_286 ( struct V_287 * V_93 )
{
struct V_1 * V_2 = F_217 ( F_218 ( V_93 ) ) ;
F_221 () ;
if ( V_2 -> V_3 != V_4 ) {
...
static int F_287 ( struct V_287 * V_93 )
{
struct V_92 * V_92 = F_218 ( V_93 ) ;
struct V_1 * V_2 = F_217 ( V_92 ) ;
V_2 -> type -> V_144 ( V_2 ) ;
V_2 -> V_297 = 0 ;
F_288 ( V_92 ) ;
return F_289 ( V_92 , V_353 ) ;
}
...
static int F_292 ( struct V_287 * V_93 )
{
int V_59 ;
F_285 ( V_93 ) ;
V_59 = F_287 ( V_93 ) ;
...
static T_8 F_293 ( struct V_92 * V_355 ,
enum V_356 V_3 )
{
T_8 V_357 = V_358 ;
struct V_1 * V_2 = F_217 ( V_355 ) ;
if ( V_3 == V_359 )
return V_360 ;
F_221 () ;
if ( V_2 -> V_3 != V_4 ) {
...
static T_8 F_294 ( struct V_92 * V_355 )
{
struct V_1 * V_2 = F_217 ( V_355 ) ;
T_8 V_357 = V_358 ;
int V_59 ;
...
static void F_296 ( struct V_92 * V_355 )
{
struct V_1 * V_2 = F_217 ( V_355 ) ;
int V_59 ;
F_221 () ;
...
static int T_9 F_297 ( void )
{
int V_59 ;
F_298 ( V_363 L_95 V_364 L_96 ) ;
V_59 = F_299 ( & V_365 ) ;
if ( V_59 )
goto V_366;
V_59 = F_300 () ;
