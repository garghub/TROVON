...
V_88 . V_89 = F_33 ;
V_88 . V_90 = V_69 ;
V_88 . V_91 = V_92 + 5 * V_52 ;
F_35 ( & V_88 ) ;
}
static void F_36 ( void )
{
F_33 ( ( unsigned long ) & V_88 ) ;
}
static inline void F_36 ( void ) {}
static int
F_37 ( struct V_93 * V_57 ,
struct V_1 * V_2 )
{
struct V_29 * V_34 ;
V_34 = F_38 ( sizeof( struct V_29 ) , V_94 ) ;
if ( ! V_34 )
return - V_95 ;
...
static int F_43 ( struct V_93 * V_57 )
{
int V_96 , V_49 , V_37 ;
struct V_97 * V_98 ;
struct V_1 * V_2 ;
V_2 = F_38 ( sizeof( struct V_1 ) , V_94 ) ;
if ( ! V_2 )
return - V_95 ;
...
V_98 = F_48 ( V_57 , V_106 , 0 ) ;
if ( V_98 == NULL ) {
F_44 ( & V_57 -> V_57 , L_19 ) ;
V_49 = - V_107 ;
goto V_108;
}
if ( ! F_49 ( V_98 -> V_87 , F_30 ( V_98 ) , V_57 -> V_102 ) ) {
F_44 ( & V_57 -> V_57 , L_20 ) ;
V_49 = - V_109 ;
goto V_108;
}
V_2 -> V_4 = F_50 ( V_98 -> V_87 , F_30 ( V_98 ) ) ;
if ( ! V_2 -> V_4 ) {
F_44 ( & V_57 -> V_57 , L_21 ) ;
V_49 = - V_109 ;
goto V_110;
...
static int F_63 ( struct V_93 * V_57 )
{
struct V_1 * V_2 = F_64 ( V_57 ) ;
struct V_97 * V_98 = V_2 -> V_85 ;
F_18 ( V_2 ) ;
F_62 ( & V_2 -> V_59 ) ;
F_42 ( & V_57 -> V_57 , V_10 ,
V_2 -> V_9 , V_2 -> V_12 ) ;
