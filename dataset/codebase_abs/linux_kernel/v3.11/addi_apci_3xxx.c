...
break;
case V_77 :
V_28 [ 1 ] = ( V_9 -> V_75 & V_72 ) ? V_78 : V_79 ;
return V_27 -> V_31 ;
default:
return - V_45 ;
}
...
if ( V_29 )
return V_29 ;
V_4 -> V_70 = F_36 ( V_82 , 2 ) ;
V_6 -> V_13 = F_37 ( V_82 , 3 ) ;
if ( V_82 -> V_1 > 0 ) {
V_29 = F_38 ( V_82 -> V_1 , F_1 ,
V_92 , V_4 -> V_88 , V_4 ) ;
if ( V_29 == 0 )
V_4 -> V_1 = V_82 -> V_1 ;
}
V_83 = ( V_35 -> V_93 ? 0 : 1 ) + V_35 -> V_94 +
V_35 -> V_95 + V_35 -> V_96 +
V_35 -> V_97 ;
V_29 = F_39 ( V_4 , V_83 ) ;
if ( V_29 )
...
V_9 = & V_4 -> V_98 [ V_84 ] ;
V_9 -> type = V_99 ;
V_9 -> V_100 = V_101 | V_35 -> V_102 ;
V_9 -> V_103 = V_35 -> V_93 ;
V_9 -> V_104 = V_35 -> V_105 ;
V_9 -> V_106 = V_9 -> V_103 ;
V_9 -> V_107 = & V_108 ;
V_9 -> V_109 = F_11 ;
if ( V_4 -> V_1 ) {
...
static int F_44 ( struct V_81 * V_4 ,
const struct V_126 * V_127 )
{
return F_45 ( V_4 , & V_128 , V_127 -> V_129 ) ;
}
