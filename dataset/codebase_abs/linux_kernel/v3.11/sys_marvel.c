...
V_67 -> V_68 = F_37 ( V_67 -> time ) ;
}
static void
F_38 ( void * V_65 )
{
struct V_66 * V_67 = V_65 ;
V_67 -> V_68 = F_39 ( V_67 -> time ) ;
}
static unsigned int
F_40 ( struct V_69 * time )
{
#ifdef F_41
struct V_66 V_67 ;
if ( F_42 () != V_27 ) {
V_67 . time = time ;
F_43 ( V_27 , F_36 , & V_67 , 1 ) ;
return V_67 . V_68 ;
}
#endif
return F_37 ( time ) ;
...
static int
F_44 ( struct V_69 * time )
{
#ifdef F_41
struct V_66 V_67 ;
if ( F_42 () != V_27 ) {
V_67 . time = time ;
F_43 ( V_27 , F_38 , & V_67 , 1 ) ;
return V_67 . V_68 ;
}
#endif
return F_39 ( time ) ;
...
{
int V_70 = F_46 () ;
struct V_6 * V_6 = F_4 ( V_70 ) ;
unsigned int V_26 ;
if ( ! V_6 )
return;
F_5 ( L_9 , V_70 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_28 . V_13 , V_70 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_29 . V_13 , V_70 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_30 . V_13 , V_70 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_31 . V_13 , V_70 ) ;
F_12 ( V_6 , & V_6 -> V_11 -> V_32 . V_13 , V_70 ) ;
for ( V_26 = 0 ; V_26 < 0x60 ; ++ V_26 )
F_13 ( V_6 , V_26 , V_70 ) ;
F_13 ( V_6 , 0x74 , V_70 ) ;
F_13 ( V_6 , 0x75 , V_70 ) ;
