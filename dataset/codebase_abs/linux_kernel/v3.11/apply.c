...
for ( V_13 = 0 ; V_13 < V_40 ; ++ V_13 )
V_75 |= F_60 ( V_13 ) ;
V_49 = F_63 ( V_76 , NULL , V_75 ) ;
F_44 ( V_49 ) ;
V_4 . V_71 = false ;
}
static void V_76 ( void * V_77 , T_1 V_75 )
{
const int V_40 = F_15 () ;
int V_13 ;
bool V_78 ;
...
static void F_72 ( struct V_2 * V_3 , bool V_82 )
{
struct V_1 * V_15 ;
V_15 = F_1 ( V_3 ) ;
if ( V_15 -> V_36 == V_82 )
