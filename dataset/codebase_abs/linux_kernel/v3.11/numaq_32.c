...
static unsigned long F_35 ( T_3 * V_78 , int V_26 )
{
...
static inline void F_42 ( T_3 * V_84 , T_3 * V_85 )
{
...
static void F_48 ( int V_25 , T_3 * V_85 )
{
int V_1 = F_45 ( V_25 ) ;
...
static inline int F_53 ( int V_92 , int V_93 )
{
return V_92 >> V_93 ;
}
static int
F_54 ( struct V_50 * V_51 , char * V_94 , char * V_95 )
{
...
F_10 ( V_38
L_13 , V_96 ) ;
V_97 = F_57 ( V_98 , V_96 * V_99 ) ;
F_10 ( V_38
L_14 ,
( V_100 ) V_97 , ( V_100 ) V_96 * V_99 ) ;
}
