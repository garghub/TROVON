...
static int F_53 ( struct V_15 * V_16 , T_1 V_100 ,
...
struct V_108 * V_109 )
{
struct V_110 * V_111 = F_61 ( V_8 -> V_17 -> V_112 ) ;
int V_27 ;
V_8 -> V_12 = F_62 ( V_111 , V_109 -> V_113 [ 0 ] ) ;
if ( F_63 ( V_8 -> V_12 ) ) {
V_27 = F_64 ( V_8 -> V_12 ) ;
goto V_114;
}
V_8 -> V_13 = F_65 ( V_111 , V_109 -> V_13 ) ;
if ( F_63 ( V_8 -> V_13 ) ) {
V_27 = F_64 ( V_8 -> V_13 ) ;
goto V_114;
}
V_8 -> V_11 = F_66 ( V_111 , V_109 -> V_113 [ 0 ] ) ;
if ( F_63 ( V_8 -> V_11 ) ) {
V_27 = F_64 ( V_8 -> V_11 ) ;
goto V_114;
}
if ( V_109 -> V_14 >= 0 ) {
V_8 -> V_14 = F_67 ( V_111 , V_109 -> V_14 ) ;
if ( F_63 ( V_8 -> V_14 ) ) {
V_27 = F_64 ( V_8 -> V_14 ) ;
goto V_114;
}
}
V_8 -> V_10 = F_68 ( V_111 , V_109 -> V_10 ) ;
if ( F_63 ( V_8 -> V_10 ) ) {
V_27 = F_64 ( V_8 -> V_10 ) ;
goto V_114;
}
...
V_8 -> V_96 = F_71 ( V_111 , V_8 -> V_12 ,
V_119 ) ;
V_27 = F_72 ( V_8 -> V_17 , V_8 -> V_96 , F_44 , 0 ,
L_16 , V_8 ) ;
if ( V_27 < 0 ) {
...
if ( ! V_109 )
return - V_60 ;
V_121 -> V_17 . V_123 = F_74 ( 32 ) ;
V_8 = F_75 ( & V_121 -> V_17 , sizeof( * V_8 ) , V_124 ) ;
if ( ! V_8 )
return - V_125 ;
V_8 -> V_17 = & V_121 -> V_17 ;
V_27 = F_69 ( V_8 , V_109 ) ;
