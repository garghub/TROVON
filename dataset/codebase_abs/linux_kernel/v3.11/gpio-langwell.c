...
static void F_23 ( unsigned V_40 , struct V_41 * V_42 )
{
struct V_30 * V_43 = F_24 ( V_42 ) ;
struct V_6 * V_7 = F_25 ( V_43 ) ;
struct V_44 * V_2 = F_26 ( V_43 ) ;
T_3 V_45 , V_32 , V_46 ;
unsigned long V_47 ;
void T_1 * V_48 ;
...
static int F_31 ( struct V_51 * V_31 , unsigned int V_52 ,
T_4 V_53 )
{
struct V_6 * V_7 = V_31 -> V_54 ;
F_32 ( V_52 , & V_55 , V_56 ,
L_1 ) ;
F_33 ( V_52 , V_7 ) ;
F_34 ( V_52 , V_57 ) ;
...
static int F_35 ( struct V_58 * V_27 )
{
F_36 ( V_27 , 500 ) ;
return - V_59 ;
}
static int F_37 ( struct V_60 * V_26 ,
...
if ( V_65 )
return V_65 ;
V_65 = F_39 ( V_26 , 1 << 0 | 1 << 1 , F_40 ( V_26 ) ) ;
if ( V_65 ) {
F_41 ( & V_26 -> V_27 , L_2 ) ;
return V_65 ;
}
...
F_43 ( V_26 , 1 << 1 ) ;
V_7 = F_44 ( & V_26 -> V_27 , sizeof( * V_7 ) , V_67 ) ;
if ( ! V_7 ) {
F_41 ( & V_26 -> V_27 , L_3 ) ;
return - V_68 ;
}
V_7 -> V_11 = F_42 ( V_26 ) [ 0 ] ;
V_7 -> V_2 . V_69 = F_45 ( & V_26 -> V_27 ) ;
V_7 -> V_2 . V_70 = F_4 ;
V_7 -> V_2 . V_71 = F_10 ;
V_7 -> V_2 . V_72 = F_15 ;
V_7 -> V_2 . V_73 = F_7 ;
...
V_7 -> V_26 = V_26 ;
F_46 ( & V_7 -> V_28 ) ;
V_7 -> V_29 = F_47 ( V_26 -> V_27 . V_77 , V_9 , V_64 ,
& V_78 , V_7 ) ;
if ( ! V_7 -> V_29 )
return - V_68 ;
F_48 ( V_26 , V_7 ) ;
