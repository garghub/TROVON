...
F_54 ( V_213 -> V_7 , & V_3 -> V_214 [ V_215 ] ) ;
F_55 ( & V_3 -> V_214 [ V_216 ] ) ;
V_101 -> V_217 = V_25 -> V_201 - 1 ;
V_101 -> V_218 = ( int ) V_82 [ 5 ] ;
return 0 ;
}
...
static int F_58 ( struct V_2 * V_3 , void * V_125 ,
struct V_22 * V_37 )
{
T_2 * V_25 = ( T_2 * ) V_3 -> V_12 ;
T_5 * V_82 = V_25 -> V_61 ;
...
F_14 ( L_30 ,
F_60 ( V_221 ) , V_40 , V_51 -> V_53 ) ;
V_101 -> V_218 = ( int ) V_82 [ 5 ] ;
return V_40 ;
}
static int F_61 ( struct V_2 * V_3 , void * V_125 ,
struct V_22 * V_37 )
{
return 0 ;
}
...
V_133 ;
F_25 ( V_3 ) ;
V_223 = F_2 ( V_11 -> V_13 , V_15 , V_202 ) ;
if ( V_223 != V_15 )
F_14 ( L_31 ) ;
if ( V_7 > 4 * 1024 )
V_7 = 0 ;
...
T_9 * V_224 = V_125 ;
F_52 ( V_3 , V_37 ) ;
if ( V_224 -> V_16 >= V_5 -> V_8 || V_224 -> V_16 < 0 )
return - V_17 ;
F_63 ( V_3 , V_5 -> V_10 [ V_224 -> V_16 ] , V_224 -> V_7 ,
V_224 -> V_222 ) ;
F_54 ( V_224 -> V_7 , & V_3 -> V_214 [ V_215 ] ) ;
F_55 ( & V_3 -> V_214 [ V_216 ] ) ;
V_101 -> V_217 = V_25 -> V_201 - 1 ;
V_101 -> V_218 = ( int ) V_82 [ 5 ] ;
return 0 ;
...
T_2 * V_25 = ( T_2 * ) V_3 -> V_12 ;
T_10 * V_225 = V_125 ;
V_225 -> V_84 = V_25 -> V_119 ;
V_225 -> V_226 = V_25 -> V_120 ;
return 0 ;
}
static int F_67 ( struct V_2 * V_3 , void * V_125 ,
struct V_22 * V_37 )
{
T_2 * V_25 = ( T_2 * ) V_3 -> V_12 ;
F_52 ( V_3 , V_37 ) ;
...
static int F_68 ( struct V_2 * V_3 , void * V_125 ,
struct V_22 * V_37 )
{
T_2 * V_25 = ( T_2 * ) V_3 -> V_12 ;
F_52 ( V_3 , V_37 ) ;
...
static int F_71 ( struct V_2 * V_3 , void * V_125 ,
struct V_22 * V_37 )
{
T_2 * V_25 = V_3 -> V_12 ;
F_14 ( L_29 ) ;
...
int F_72 ( struct V_2 * V_3 , unsigned long V_87 )
{
V_3 -> V_228 += 4 ;
V_3 -> V_229 [ 6 ] = V_230 ;
V_3 -> V_229 [ 7 ] = V_231 ;
...
void F_75 ( struct V_2 * V_3 , struct V_22 * V_37 )
{
if ( V_3 -> V_12 ) {
T_2 * V_25 = V_3 -> V_12 ;
if ( V_25 -> V_227 )
...
if ( V_37 -> V_232 && V_37 -> V_232 -> V_233 . V_234 ) {
F_76 ( & V_37 -> V_232 -> V_233 ) ;
F_50 ( V_3 , V_37 ) ;
F_77 ( & V_37 -> V_232 -> V_233 ) ;
} else {
F_50 ( V_3 , V_37 ) ;
}
}
