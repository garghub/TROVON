...
V_34 = V_32 -> V_41 ;
V_30 = F_11 ( sizeof( struct V_7 ) , & V_45 ) ;
if ( V_30 == NULL ) {
F_7 ( & V_11 -> V_12 , L_5 ) ;
V_35 = - V_42 ;
goto V_44;
...
V_8 -> V_22 = V_14 -> V_22 ;
if ( V_14 -> V_22 >= V_47 ) {
V_36 = F_12 ( ( void T_4 * ) V_48 ) ;
V_36 |= V_49 ;
F_13 ( V_36 , ( void T_4 * ) V_48 ) ;
V_36 = F_12 ( ( void T_4 * ) V_50 ) ;
V_36 |= V_51 ;
F_13 ( V_36 , ( void T_4 * ) V_50 ) ;
} else {
V_36 = F_12 ( ( void T_4 * ) V_52 ) ;
if ( F_3 ( V_8 -> V_12 ) -> V_25 == 0 )
V_36 |= V_53 ;
else
V_36 |= V_54 ;
F_13 ( V_36 , ( void T_4 * ) V_52 ) ;
if ( F_3 ( V_8 -> V_12 ) -> V_25 == 0 &&
( V_14 -> V_19 -> V_55 & ( V_56 | V_57 ) ) ==
( V_57 | V_56 ) )
V_8 -> V_58 . V_59 = true ;
else
V_8 -> V_58 . V_59 = false ;
