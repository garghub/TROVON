...
static int F_8 ( const struct V_1 * V_11 , const struct V_1 * V_1 ,
unsigned int V_6 , const char * V_12 , const struct V_2 * V_7 )
{
unsigned V_13 = V_6 ;
unsigned V_14 = V_7 -> V_6 ;
F_2 ( V_12 , & V_13 ) ;
if ( F_9 ( V_7 -> V_7 , & V_14 ) )
return 1 ;
if ( F_10 ( V_11 -> V_9 , V_12 , V_13 , V_7 -> V_7 , V_14 , 0 ) )
return 1 ;
return 0 ;
}
