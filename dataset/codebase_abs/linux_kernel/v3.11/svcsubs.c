...
V_7 -> V_43 = 0 ;
F_23 ( & V_8 -> V_44 ) ;
for ( V_40 = V_8 -> V_45 ; V_40 ; V_40 = V_40 -> V_46 ) {
if ( V_40 -> V_47 != & V_48 )
continue;
V_7 -> V_43 ++ ;
V_41 = (struct V_36 * ) V_40 -> V_49 ;
if ( V_38 ( V_41 , V_37 ) ) {
struct V_39 V_50 = * V_40 ;
F_24 ( & V_8 -> V_44 ) ;
V_50 . V_51 = V_52 ;
V_50 . V_53 = 0 ;
V_50 . V_54 = V_55 ;
if ( F_25 ( V_7 -> V_9 , V_56 , & V_50 , NULL ) < 0 ) {
F_20 ( L_9 ,
__FILE__ , __LINE__ ) ;
return 1 ;
}
...
static int
F_26 ( void * V_57 , struct V_36 * V_58 )
{
return 1 ;
}
static inline int
...
struct V_8 * V_8 = F_22 ( V_7 ) ;
struct V_39 * V_40 ;
if ( V_7 -> V_34 || ! F_31 ( & V_7 -> V_30 ) || V_7 -> V_59 )
return 1 ;
F_23 ( & V_8 -> V_44 ) ;
for ( V_40 = V_8 -> V_45 ; V_40 ; V_40 = V_40 -> V_46 ) {
if ( V_40 -> V_47 == & V_48 ) {
...
static int
F_36 ( void * V_5 , struct V_36 * V_63 )
{
...
static int
F_37 ( void * V_5 , struct V_36 * V_66 )
{
struct V_36 * V_37 = V_5 ;
return V_37 == V_66 ;
}
static int
F_38 ( void * V_5 , struct V_36 * V_67 )
{
struct V_36 * V_37 = V_5 ;
if ( V_37 -> V_68 ) {
if ( V_37 -> V_69 )
...
static int
F_43 ( void * V_72 , struct V_6 * V_7 )
{
struct V_73 * V_74 = V_72 ;
return V_74 == V_7 -> V_9 -> V_75 . V_76 -> V_77 ;
}
int
F_44 ( struct V_73 * V_74 )
{
int V_62 ;
V_62 = F_32 ( V_74 , F_26 , F_43 ) ;
return V_62 ? - V_78 : 0 ;
}
static int
F_45 ( void * V_72 , struct V_36 * V_37 )
{
return F_46 ( F_47 ( V_37 ) , V_72 ) ;
}
int
F_48 ( struct V_79 * V_80 )
{
int V_62 ;
V_62 = F_32 ( V_80 , F_45 , NULL ) ;
return V_62 ? - V_78 : 0 ;
}
