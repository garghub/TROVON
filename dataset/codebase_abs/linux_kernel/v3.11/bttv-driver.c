...
V_332 = V_330 -> V_277 + V_330 -> V_144 - V_144 ;
V_332 = F_94 ( V_332 , ( T_2 ) V_334 ) ;
if ( V_11 -> V_28 . V_277 > V_332 )
V_11 -> V_28 . V_277 = V_332 ;
}
if ( V_39 < V_11 -> V_143 ) {
...
V_339 = 48 ;
V_340 = 32 ;
V_341 = F_94 ( V_330 -> V_144 , ( T_2 ) V_343 ) ;
V_342 = V_330 -> V_39 ;
...
V_342 >>= ! F_93 ( V_262 ) ;
if ( V_337 ) {
* V_144 = F_96 ( * V_144 , V_339 , V_341 ) ;
* V_39 = F_96 ( * V_39 , V_340 , V_342 ) ;
* V_144 = ( * V_144 + V_336 ) & V_335 ;
if ( V_338 ) {
F_92 ( V_11 , V_330 , * V_144 , * V_39 , V_262 ) ;
if ( V_10 -> V_29 > V_11 -> V_28 . V_25 ) {
...
static int
F_97 ( struct V_16 * V_17 , struct V_345 * V_346 ,
int V_337 , int V_338 )
{
enum V_261 V_262 ;
unsigned int V_335 ;
int V_265 ;
if ( V_346 -> V_347 . V_144 < 48 )
V_346 -> V_347 . V_144 = 48 ;
...
V_346 -> V_347 . V_144 -= V_346 -> V_347 . V_277 & ~ V_335 ;
V_346 -> V_347 . V_277 = ( V_346 -> V_347 . V_277 - V_335 - 1 ) & V_335 ;
V_265 = F_95 ( V_17 , & V_346 -> V_347 . V_144 , & V_346 -> V_347 . V_39 ,
V_262 , V_335 ,
0 ,
V_337 , V_338 ) ;
if ( 0 != V_265 )
...
static int F_99 ( struct V_16 * V_17 , struct V_9 * V_10 ,
...
V_357 = F_100 ( V_271 , V_360 ) ;
if ( NULL == V_357 )
return - V_361 ;
if ( V_358 > 0 ) {
if ( F_101 ( V_357 , V_346 -> V_357 , sizeof( struct V_356 ) * V_358 ) ) {
F_66 ( V_357 ) ;
return - V_362 ;
}
}
if ( NULL != V_10 -> V_279 . V_363 )
V_358 = F_102 ( V_10 -> V_279 . V_260 . V_144 , V_10 -> V_279 . V_260 . V_39 ,
& V_346 -> V_347 , V_357 , V_358 ) ;
F_103 ( V_357 , V_358 ) ;
switch ( V_17 -> V_354 -> V_275 ) {
case 8 :
case 24 :
F_104 ( & V_346 -> V_347 , V_357 , V_358 , 3 ) ;
break;
case 16 :
F_104 ( & V_346 -> V_347 , V_357 , V_358 , 1 ) ;
break;
case 32 :
break;
default:
...
V_17 -> V_364 . V_366 = 1 ;
V_10 -> V_367 . V_364 . V_347 . V_144 = V_346 -> V_347 . V_144 ;
V_10 -> V_367 . V_364 . V_347 . V_39 = V_346 -> V_347 . V_39 ;
V_10 -> V_367 . V_364 . V_262 = V_346 -> V_262 ;
V_250 = 0 ;
if ( F_12 ( V_17 , V_257 ) ) {
struct V_247 * V_248 ;
V_248 = F_105 ( sizeof( * V_248 ) ) ;
V_248 -> V_26 = V_10 -> V_26 [ ! ! V_17 -> V_27 ] . V_28 ;
F_106 ( V_10 , & V_17 -> V_364 , V_17 -> V_354 , V_248 ) ;
V_250 = F_64 ( V_10 , V_17 , V_248 ) ;
}
return V_250 ;
}
static struct V_258 * F_107 ( struct V_16 * V_17 )
{
...
static int F_109 ( struct V_16 * V_17 , enum V_373 type )
{
struct V_258 * V_259 = F_107 ( V_17 ) ;
int V_371 = F_108 ( V_17 ) ;
if ( F_12 ( V_17 , V_371 ) )
return - V_344 ;
if ( F_110 ( V_259 ) )
return - V_344 ;
...
V_294 -> V_376 = V_144 ;
V_294 -> V_377 = ( V_144 * V_39 * V_260 -> V_275 ) >> 3 ;
} else {
V_294 -> V_376 = ( V_144 * V_260 -> V_275 ) >> 3 ;
V_294 -> V_377 = V_39 * V_294 -> V_376 ;
}
}
static int F_112 ( struct V_290 * V_290 , void * V_291 ,
struct V_378 * V_294 )
{
struct V_16 * V_17 = V_291 ;
F_111 ( & V_294 -> V_260 . V_379 , V_17 -> V_260 ,
...
V_144 = V_294 -> V_260 . V_379 . V_144 ;
V_39 = V_294 -> V_260 . V_379 . V_39 ;
V_265 = F_95 ( V_17 , & V_144 , & V_39 , V_262 ,
~ 3 ,
2 ,
1 ,
0 ) ;
...
F_111 ( & V_294 -> V_260 . V_379 , V_260 , V_144 , V_39 ) ;
V_294 -> V_260 . V_379 . V_381 = V_382 ;
return 0 ;
}
...
T_2 V_144 , V_39 ;
enum V_261 V_262 ;
V_250 = F_109 ( V_17 , V_294 -> type ) ;
if ( 0 != V_250 )
return V_250 ;
V_250 = F_114 ( V_290 , V_291 , V_294 ) ;
if ( 0 != V_250 )
return V_250 ;
V_144 = V_294 -> V_260 . V_379 . V_144 ;
V_39 = V_294 -> V_260 . V_379 . V_39 ;
V_262 = V_294 -> V_260 . V_379 . V_262 ;
V_250 = F_95 ( V_17 , & V_144 , & V_39 , V_294 -> V_260 . V_379 . V_262 ,
~ 3 ,
2 ,
1 ,
1 ) ;
...
V_17 -> V_144 = V_294 -> V_260 . V_379 . V_144 ;
V_17 -> V_39 = V_294 -> V_260 . V_379 . V_39 ;
V_10 -> V_367 . V_260 = V_260 ;
V_10 -> V_367 . V_144 = V_294 -> V_260 . V_379 . V_144 ;
...
return F_99 ( V_17 , V_10 , & V_294 -> V_260 . V_346 , 1 ) ;
}
...
if ( 0 == V_389 )
return - V_97 ;
F_119 ( V_256 -> V_390 , L_20 , sizeof( V_256 -> V_390 ) ) ;
F_119 ( V_256 -> V_391 , V_10 -> V_392 -> V_302 , sizeof( V_256 -> V_391 ) ) ;
snprintf ( V_256 -> V_393 , sizeof( V_256 -> V_393 ) ,
L_21 , F_120 ( V_10 -> V_11 . V_394 ) ) ;
V_256 -> V_395 =
V_396 |
V_397 |
V_398 |
...
static int F_121 ( struct V_412 * V_294 )
{
int V_299 = - 1 , V_53 ;
for ( V_53 = 0 ; V_53 < V_245 ; V_53 ++ ) {
...
F_119 ( V_294 -> V_413 , V_246 [ V_53 ] . V_302 , sizeof( V_294 -> V_413 ) ) ;
return V_53 ;
}
static int F_122 ( struct V_290 * V_290 , void * V_291 ,
struct V_412 * V_294 )
{
int V_265 = F_121 ( V_294 ) ;
if ( V_265 < 0 )
return V_265 ;
return 0 ;
}
...
static int F_124 ( struct V_290 * V_290 , void * V_294 ,
struct V_414 * V_415 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
static int F_125 ( struct V_290 * V_290 , void * V_294 , unsigned int V_419 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
struct V_247 * V_248 ;
int V_250 = 0 ;
if ( V_419 ) {
if ( F_126 ( ! V_10 -> V_279 . V_363 ) ) {
return - V_97 ;
}
if ( F_126 ( ! V_17 -> V_364 . V_366 ) ) {
...
static int F_127 ( struct V_290 * V_290 , void * V_294 ,
...
T_2 V_144 = V_415 -> V_260 . V_144 ;
T_2 V_39 = V_415 -> V_260 . V_39 ;
V_250 = F_95 ( V_17 , & V_144 , & V_39 ,
V_351 ,
~ 3 ,
2 ,
0 ,
...
V_17 -> V_364 . V_347 . V_144 = V_415 -> V_260 . V_144 ;
V_17 -> V_364 . V_347 . V_39 = V_415 -> V_260 . V_39 ;
V_10 -> V_367 . V_364 . V_347 . V_144 = V_415 -> V_260 . V_144 ;
...
static int F_129 ( struct V_290 * V_290 , void * V_291 ,
struct V_424 * V_425 )
{
struct V_16 * V_17 = V_291 ;
return F_130 ( F_107 ( V_17 ) , V_425 ) ;
}
static int F_131 ( struct V_290 * V_290 , void * V_291 ,
struct V_426 * V_330 )
{
struct V_16 * V_17 = V_291 ;
return F_132 ( F_107 ( V_17 ) , V_330 ) ;
}
static int F_133 ( struct V_290 * V_290 , void * V_291 , struct V_426 * V_330 )
{
struct V_16 * V_17 = V_291 ;
struct V_9 * V_10 = V_17 -> V_10 ;
int V_371 = F_108 ( V_17 ) ;
...
return - V_344 ;
return F_134 ( F_107 ( V_17 ) , V_330 ) ;
}
static int F_135 ( struct V_290 * V_290 , void * V_291 , struct V_426 * V_330 )
{
struct V_16 * V_17 = V_291 ;
return F_136 ( F_107 ( V_17 ) , V_330 ,
V_290 -> V_427 & V_428 ) ;
}
static int F_137 ( struct V_290 * V_290 , void * V_291 ,
enum V_373 type )
{
struct V_16 * V_17 = V_291 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
if ( ! F_11 ( V_10 , V_17 , V_371 ) )
return - V_344 ;
return F_138 ( F_107 ( V_17 ) ) ;
}
static int F_139 ( struct V_290 * V_290 , void * V_291 ,
enum V_373 type )
{
struct V_16 * V_17 = V_291 ;
struct V_9 * V_10 = V_17 -> V_10 ;
int V_250 ;
int V_371 = F_108 ( V_17 ) ;
V_250 = F_140 ( F_107 ( V_17 ) ) ;
if ( V_250 < 0 )
return V_250 ;
F_18 ( V_10 , V_17 , V_371 ) ;
return 0 ;
}
static int F_141 ( struct V_290 * V_290 , void * V_294 ,
struct V_429 * V_430 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
F_142 ( V_36 [ V_10 -> V_35 ] . V_161 ,
& V_430 -> V_430 . V_287 . V_432 ) ;
return 0 ;
}
static int F_143 ( struct V_290 * V_290 , void * V_291 ,
struct V_310 * V_311 )
{
struct V_16 * V_17 = V_291 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
static int F_145 ( struct V_290 * V_290 , void * V_294 , struct V_440 * V_26 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
if ( V_26 -> type != V_368 &&
...
static int F_146 ( struct V_290 * V_290 , void * V_294 , const struct V_440 * V_26 )
{
struct V_16 * V_17 = V_294 ;
struct V_9 * V_10 = V_17 -> V_10 ;
const struct V_329 * V_330 ;
...
V_330 = & V_36 [ V_10 -> V_35 ] . V_37 . V_38 ;
V_441 = V_330 -> V_277 ;
V_443 = V_441 + V_330 -> V_144 ;
V_444 = V_330 -> V_25 + V_330 -> V_39 ;
V_442 = F_46 ( V_330 -> V_25 , V_10 -> V_29 ) ;
if ( V_442 + 32 >= V_444 ) {
return V_250 ;
}
V_11 . V_28 . V_277 = F_147 ( V_445 , V_26 -> V_11 . V_277 , V_441 , V_443 - 48 ) ;
V_11 . V_28 . V_277 = F_94 ( V_11 . V_28 . V_277 , ( T_2 ) V_334 ) ;
V_11 . V_28 . V_144 = F_147 ( V_445 , V_26 -> V_11 . V_144 ,
48 , V_443 - V_11 . V_28 . V_277 ) ;
V_11 . V_28 . V_25 = F_147 ( V_445 , V_26 -> V_11 . V_25 , V_442 , V_444 - 32 ) ;
V_11 . V_28 . V_25 = ( V_11 . V_28 . V_25 + 1 ) & ~ 1 ;
V_11 . V_28 . V_39 = F_147 ( V_445 , V_26 -> V_11 . V_39 ,
...
V_10 -> V_367 . V_144 = V_11 . V_142 ;
} else if ( V_17 -> V_144 > V_11 . V_145 ) {
V_17 -> V_144 = V_11 . V_145 ;
V_10 -> V_367 . V_144 = V_11 . V_145 ;
}
...
static T_1 F_148 ( struct V_290 * V_290 , char T_7 * V_237 ,
T_8 V_281 , T_9 * V_446 )
{
...
V_250 = F_149 ( & V_17 -> V_256 , V_237 , V_281 , V_446 ,
V_290 -> V_427 & V_428 ) ;
...
return - V_344 ;
V_250 = F_150 ( & V_17 -> V_370 , V_237 , V_281 , V_446 , 1 ,
V_290 -> V_427 & V_428 ) ;
break;
default:
F_98 () ;
...
static unsigned int F_151 ( struct V_290 * V_290 , T_10 * V_449 )
{
struct V_16 * V_17 = V_290 -> V_447 ;
struct V_247 * V_5 ;
enum V_261 V_262 ;
unsigned int V_265 = 0 ;
unsigned long V_450 = F_152 ( V_449 ) ;
if ( F_153 ( & V_17 -> V_17 ) )
V_265 = V_451 ;
else if ( V_450 & V_451 )
F_154 ( V_290 , & V_17 -> V_17 . V_449 , V_449 ) ;
if ( ! ( V_450 & ( V_452 | V_453 ) ) )
return V_265 ;
if ( V_369 == V_17 -> type ) {
if ( ! F_11 ( V_17 -> V_10 , V_17 , V_372 ) )
return V_265 | V_454 ;
return V_265 | F_155 ( V_290 , & V_17 -> V_370 , V_449 ) ;
}
if ( F_12 ( V_17 , V_22 ) ) {
if ( F_156 ( & V_17 -> V_256 . V_455 ) )
return V_265 | V_454 ;
V_5 = F_157 ( V_17 -> V_256 . V_455 . V_456 , struct V_247 , V_251 . V_455 ) ;
} else {
if ( NULL == V_17 -> V_256 . V_457 ) {
if ( F_13 ( V_17 -> V_10 , V_22 ) )
return V_265 | V_454 ;
V_17 -> V_256 . V_457 = F_105 ( V_17 -> V_256 . V_458 ) ;
if ( NULL == V_17 -> V_256 . V_457 )
return V_265 | V_454 ;
V_17 -> V_256 . V_457 -> V_459 = V_460 ;
V_262 = F_158 ( & V_17 -> V_256 ) ;
...
F_154 ( V_290 , & V_5 -> V_251 . V_465 , V_449 ) ;
if ( V_5 -> V_251 . V_252 == V_253 ||
V_5 -> V_251 . V_252 == V_466 )
V_265 = V_265 | V_452 | V_453 ;
return V_265 ;
}
static int F_159 ( struct V_290 * V_290 )
{
struct V_6 * V_324 = F_88 ( V_290 ) ;
struct V_9 * V_10 = F_160 ( V_290 ) ;
struct V_16 * V_17 ;
enum V_373 type = 0 ;
F_22 ( L_24 , F_161 ( V_324 ) ) ;
if ( V_324 -> V_408 == V_409 ) {
type = V_368 ;
} else if ( V_324 -> V_408 == V_411 ) {
type = V_369 ;
...
V_17 = F_100 ( sizeof( * V_17 ) , V_360 ) ;
if ( F_126 ( ! V_17 ) )
return - V_361 ;
V_10 -> V_109 ++ ;
V_290 -> V_447 = V_17 ;
* V_17 = V_10 -> V_367 ;
F_163 ( & V_17 -> V_17 , V_324 ) ;
V_17 -> type = type ;
V_17 -> V_364 . V_366 = 0 ;
F_164 ( & V_17 -> V_256 , & V_468 ,
& V_10 -> V_11 . V_394 -> V_8 , & V_10 -> V_166 ,
V_368 ,
V_351 ,
sizeof( struct V_247 ) ,
V_17 , & V_10 -> V_469 ) ;
F_164 ( & V_17 -> V_370 , & V_470 ,
& V_10 -> V_11 . V_394 -> V_8 , & V_10 -> V_166 ,
V_369 ,
V_384 ,
sizeof( struct V_247 ) ,
...
V_17 -> V_27 = ! V_471 ;
F_165 ( & V_17 -> V_33 , V_10 -> V_35 ) ;
F_62 ( V_10 ) ;
F_166 ( & V_17 -> V_17 ) ;
return 0 ;
}
static int F_167 ( struct V_290 * V_290 )
{
struct V_16 * V_17 = V_290 -> V_447 ;
struct V_9 * V_10 = V_17 -> V_10 ;
if ( F_12 ( V_17 , V_257 ) )
...
static int
F_172 ( struct V_290 * V_290 , struct V_472 * V_473 )
{
struct V_16 * V_17 = V_290 -> V_447 ;
F_22 ( L_26 ,
V_17 -> V_10 -> V_11 . V_58 , V_448 [ V_17 -> type ] ,
V_473 -> V_474 , V_473 -> V_475 - V_473 -> V_474 ) ;
return F_173 ( F_107 ( V_17 ) , V_473 ) ;
}
static int F_174 ( struct V_290 * V_290 )
{
struct V_6 * V_324 = F_88 ( V_290 ) ;
struct V_9 * V_10 = F_160 ( V_290 ) ;
struct V_16 * V_17 ;
...
static int F_175 ( struct V_290 * V_290 )
{
struct V_16 * V_17 = V_290 -> V_447 ;
struct V_9 * V_10 = V_17 -> V_10 ;
struct V_477 V_478 ;
...
F_66 ( V_17 ) ;
V_10 -> V_476 -- ;
F_51 ( V_10 , V_162 , V_479 , V_480 , & V_478 ) ;
if ( V_10 -> V_476 == 0 )
V_10 -> V_110 = 0 ;
return 0 ;
}
static int F_176 ( struct V_290 * V_290 , void * V_291 , struct V_310 * V_311 )
{
struct V_16 * V_17 = V_291 ;
struct V_9 * V_10 = V_17 -> V_10 ;
if ( 0 != V_311 -> V_299 )
...
static int F_177 ( struct V_290 * V_290 , void * V_291 ,
const struct V_310 * V_311 )
{
struct V_16 * V_17 = V_291 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
static T_1 F_178 ( struct V_290 * V_290 , char T_7 * V_237 ,
T_8 V_281 , T_9 * V_446 )
{
struct V_16 * V_17 = V_290 -> V_447 ;
struct V_9 * V_10 = V_17 -> V_10 ;
...
V_478 . V_484 = - V_467 ;
F_75 ( V_10 ) ;
F_51 ( V_10 , V_162 , V_479 , V_485 , & V_478 ) ;
return V_478 . V_484 ;
}
static unsigned int F_179 ( struct V_290 * V_290 , T_10 * V_449 )
{
struct V_16 * V_17 = V_290 -> V_447 ;
struct V_9 * V_10 = V_17 -> V_10 ;
unsigned long V_450 = F_152 ( V_449 ) ;
...
V_478 . V_486 = V_449 ;
V_478 . V_484 = V_371 ;
F_51 ( V_10 , V_162 , V_479 , V_487 , & V_478 ) ;
return V_478 . V_484 ;
}
static int F_180 ( T_4 V_488 )
{
...
int V_53 ;
F_181 ( L_53 , V_488 ,
V_489 [ V_488 >> 28 ] ? V_489 [ V_488 >> 28 ] : L_54 ) ;
for ( V_53 = F_182 ( V_44 ) - 1 ; V_53 >= 0 ; V_53 -- )
if ( V_488 & ( 1 << ( V_53 + 12 ) ) )
F_181 ( L_55 , V_44 [ V_53 ] ) ;
F_181 ( L_56 , V_488 & 0xfff ) ;
return V_498 [ V_488 >> 28 ] ? V_498 [ V_488 >> 28 ] : 1 ;
}
static void F_183 ( struct V_9 * V_10 ,
struct V_499 * V_488 )
{
unsigned int V_53 , V_500 , V_358 ;
F_23 ( L_57 ,
V_10 -> V_11 . V_325 . V_302 , V_488 -> V_501 , ( unsigned long ) V_488 -> V_502 ) ;
for ( V_53 = 0 ; V_53 < ( V_488 -> V_271 >> 2 ) ; V_53 += V_358 ) {
F_23 ( L_58 ,
V_10 -> V_11 . V_325 . V_302 ,
( unsigned long ) ( V_488 -> V_502 + ( V_53 << 2 ) ) ) ;
V_358 = F_180 ( F_184 ( V_488 -> V_501 [ V_53 ] ) ) ;
for ( V_500 = 1 ; V_500 < V_358 ; V_500 ++ )
F_23 ( L_59 ,
V_10 -> V_11 . V_325 . V_302 ,
( unsigned long ) ( V_488 -> V_502 + ( ( V_53 + V_500 ) << 2 ) ) ,
V_488 -> V_501 [ V_53 + V_500 ] , V_500 ) ;
if ( 0 == V_488 -> V_501 [ V_53 ] )
break;
}
}
static void F_185 ( struct V_9 * V_10 )
{
F_23 ( L_60 , ( unsigned long long ) V_10 -> main. V_502 ) ;
F_23 ( L_61 ,
V_10 -> V_503 ? ( unsigned long long ) V_10 -> V_503 -> V_25 . V_502 : 0 ,
V_10 -> V_503 ? ( unsigned long long ) V_10 -> V_503 -> V_504 . V_502 : 0 ) ;
F_23 ( L_62 ,
V_10 -> V_167 . V_25
? ( unsigned long long ) V_10 -> V_167 . V_25 -> V_25 . V_502 : 0 ,
V_10 -> V_167 . V_504
? ( unsigned long long ) V_10 -> V_167 . V_504 -> V_504 . V_502 : 0 ) ;
F_23 ( L_63 ,
V_10 -> V_254 ? ( unsigned long long ) V_10 -> V_254 -> V_25 . V_502 : 0 ,
V_10 -> V_254 ? ( unsigned long long ) V_10 -> V_254 -> V_504 . V_502 : 0 ) ;
F_183 ( V_10 , & V_10 -> main ) ;
}
static void F_186 ( T_4 V_505 , T_4 V_506 )
{
unsigned int V_53 ;
F_181 ( L_64 ) ;
for ( V_53 = 0 ; V_53 < F_182 ( V_507 ) ; V_53 ++ ) {
if ( V_505 & ( 1 << V_53 ) )
F_181 ( L_55 , V_507 [ V_53 ] ) ;
if ( V_506 & ( 1 << V_53 ) )
F_181 ( L_65 ) ;
}
}
static void F_187 ( struct V_9 * V_10 , T_4 V_265 )
{
F_188 ( L_66 ,
V_10 -> V_11 . V_58 ,
( unsigned long ) V_10 -> main. V_502 ,
( unsigned long ) F_184 ( V_10 -> main. V_501 [ V_508 + 1 ] ) ,
( unsigned long ) F_184 ( V_10 -> main. V_501 [ V_509 + 1 ] ) ,
( unsigned long ) V_265 ) ;
...
static int
F_191 ( struct V_9 * V_10 , struct V_510 * V_511 )
{
struct V_247 * V_512 ;
memset ( V_511 , 0 , sizeof( * V_511 ) ) ;
if ( ! F_156 ( & V_10 -> V_287 ) ) {
V_511 -> V_168 = 1 ;
V_512 = F_157 ( V_10 -> V_287 . V_456 , struct V_247 , V_251 . V_286 ) ;
if ( F_192 ( V_512 -> V_251 . V_262 ) )
V_511 -> V_25 = V_512 ;
if ( F_193 ( V_512 -> V_251 . V_262 ) )
V_511 -> V_504 = V_512 ;
if ( ! F_93 ( V_512 -> V_251 . V_262 ) &&
( V_512 -> V_251 . V_286 . V_456 != & V_10 -> V_287 ) ) {
V_512 = F_157 ( V_512 -> V_251 . V_286 . V_456 , struct V_247 , V_251 . V_286 ) ;
if ( ! F_93 ( V_512 -> V_251 . V_262 ) ) {
if ( NULL == V_511 -> V_504 &&
V_273 == V_512 -> V_251 . V_262 ) {
V_511 -> V_504 = V_512 ;
}
if ( NULL != V_511 -> V_25 && NULL != V_511 -> V_504 )
V_511 -> V_513 = 2 ;
}
}
}
...
if ( NULL == V_511 -> V_25 && NULL == V_511 -> V_504 ) {
V_511 -> V_25 = V_10 -> V_254 ;
V_511 -> V_504 = V_10 -> V_254 ;
}
} else {
...
F_22 ( L_71 ,
V_10 -> V_11 . V_58 , V_511 -> V_25 , V_511 -> V_504 ,
V_10 -> V_254 , V_511 -> V_168 , V_511 -> V_513 ) ;
return 0 ;
}
static void
F_194 ( struct V_9 * V_10 , struct V_510 * V_514 ,
struct V_510 * V_167 , unsigned int V_252 )
{
struct V_515 V_516 ;
F_195 ( & V_516 ) ;
if ( V_514 -> V_25 == V_514 -> V_504 ) {
if ( NULL != V_514 -> V_25 && V_167 -> V_25 != V_514 -> V_25 ) {
if ( V_517 > 1 )
F_61 ( L_72 ,
V_10 -> V_11 . V_58 , V_514 -> V_25 ) ;
V_514 -> V_25 -> V_251 . V_516 = V_516 ;
V_514 -> V_25 -> V_251 . V_242 = V_10 -> V_242 ;
V_514 -> V_25 -> V_251 . V_252 = V_252 ;
F_196 ( & V_514 -> V_25 -> V_251 . V_465 ) ;
}
} else {
if ( NULL != V_514 -> V_25 && V_167 -> V_25 != V_514 -> V_25 ) {
if ( V_517 > 1 )
...
if ( NULL != V_514 -> V_504 && V_167 -> V_504 != V_514 -> V_504 ) {
if ( V_517 > 1 )
F_61 ( L_74 ,
V_10 -> V_11 . V_58 , V_514 -> V_504 ) ;
V_514 -> V_504 -> V_251 . V_516 = V_516 ;
V_514 -> V_504 -> V_251 . V_242 = V_10 -> V_242 ;
V_514 -> V_504 -> V_251 . V_252 = V_252 ;
F_196 ( & V_514 -> V_504 -> V_251 . V_465 ) ;
}
}
}
static void
F_197 ( struct V_9 * V_10 , struct V_247 * V_514 ,
unsigned int V_252 )
{
struct V_515 V_516 ;
if ( NULL == V_514 )
return;
F_195 ( & V_516 ) ;
V_514 -> V_251 . V_516 = V_516 ;
V_514 -> V_251 . V_242 = V_10 -> V_242 ;
V_514 -> V_251 . V_252 = V_252 ;
F_196 ( & V_514 -> V_251 . V_465 ) ;
}
static void F_198 ( unsigned long V_237 )
{
struct V_9 * V_10 = (struct V_9 * ) V_237 ;
struct V_510 V_249 , V_248 ;
struct V_247 * V_518 ;
struct V_247 * V_512 ;
unsigned long V_164 ;
if ( V_60 ) {
F_23 ( L_75 ,
V_10 -> V_11 . V_58 , V_10 -> V_519 , V_10 -> V_520 , V_10 -> V_521 ,
F_16 ( V_522 ) ) ;
F_186 ( F_16 ( V_172 ) , 0 ) ;
F_181 ( L_76 ) ;
}
...
F_200 ( V_10 , NULL ) ;
F_59 ( V_10 , 0 ) ;
F_194 ( V_10 , & V_249 , & V_248 , V_466 ) ;
F_197 ( V_10 , V_518 , V_466 ) ;
while ( ! F_156 ( & V_10 -> V_287 ) ) {
V_512 = F_157 ( V_10 -> V_287 . V_456 , struct V_247 , V_251 . V_286 ) ;
F_201 ( & V_512 -> V_251 . V_286 ) ;
V_512 -> V_251 . V_252 = V_466 ;
F_196 ( & V_512 -> V_251 . V_465 ) ;
}
while ( ! F_156 ( & V_10 -> V_523 ) ) {
V_512 = F_157 ( V_10 -> V_523 . V_456 , struct V_247 , V_251 . V_286 ) ;
F_201 ( & V_512 -> V_251 . V_286 ) ;
V_512 -> V_251 . V_252 = V_466 ;
F_196 ( & V_512 -> V_251 . V_465 ) ;
}
...
static void
F_202 ( struct V_9 * V_10 )
{
struct V_247 * V_514 = V_10 -> V_167 . V_25 ;
if ( NULL == V_514 )
return;
F_203 ( & V_10 -> V_166 ) ;
V_10 -> V_167 . V_513 = 0 ;
V_10 -> V_167 . V_25 = NULL ;
F_204 ( V_10 , V_509 , NULL , 0 ) ;
F_195 ( & V_514 -> V_251 . V_516 ) ;
V_514 -> V_251 . V_242 = V_10 -> V_242 ;
V_514 -> V_251 . V_252 = V_253 ;
F_196 ( & V_514 -> V_251 . V_465 ) ;
F_205 ( & V_10 -> V_166 ) ;
}
static inline int F_206 ( struct V_499 * V_488 , T_4 V_265 )
{
if ( V_265 < V_488 -> V_502 )
return 0 ;
if ( V_265 > V_488 -> V_502 + V_488 -> V_271 )
return 0 ;
return 1 ;
}
static void
...
F_191 ( V_10 , & V_248 ) ;
V_265 = F_16 ( V_522 ) ;
if ( ( V_10 -> V_167 . V_25 && F_206 ( & V_10 -> V_167 . V_25 -> V_25 , V_265 ) ) ||
( V_10 -> V_167 . V_504 && F_206 ( & V_10 -> V_167 . V_504 -> V_504 , V_265 ) ) ) {
V_10 -> V_519 ++ ;
if ( V_524 )
F_187 ( V_10 , V_265 ) ;
F_205 ( & V_10 -> V_166 ) ;
...
F_194 ( V_10 , & V_249 , & V_248 , V_253 ) ;
F_205 ( & V_10 -> V_166 ) ;
}
static void
F_208 ( struct V_9 * V_10 )
{
...
F_203 ( & V_10 -> V_166 ) ;
if ( ! F_156 ( & V_10 -> V_523 ) )
V_248 = F_157 ( V_10 -> V_523 . V_456 , struct V_247 , V_251 . V_286 ) ;
V_249 = V_10 -> V_503 ;
V_265 = F_16 ( V_522 ) ;
if ( NULL != V_249 && ( F_206 ( & V_249 -> V_25 , V_265 ) ||
F_206 ( & V_249 -> V_504 , V_265 ) ) ) {
V_10 -> V_519 ++ ;
if ( V_524 )
F_187 ( V_10 , V_265 ) ;
F_205 ( & V_10 -> V_166 ) ;
...
F_200 ( V_10 , V_248 ) ;
F_59 ( V_10 , 0 ) ;
F_197 ( V_10 , V_249 , V_253 ) ;
F_205 ( & V_10 -> V_166 ) ;
}
static T_12 F_209 ( int V_525 , void * V_526 )
{
T_4 V_527 , V_528 ;
T_4 V_529 ;
int V_281 ;
struct V_9 * V_10 ;
int V_530 = 0 ;
V_10 = (struct V_9 * ) V_526 ;
V_281 = 0 ;
while ( 1 ) {
V_527 = F_16 ( V_172 ) ;
V_528 = V_527 & F_16 ( V_175 ) ;
if ( ! V_528 )
break;
V_530 = 1 ;
F_17 ( V_527 , V_172 ) ;
...
if ( ( V_528 & V_182 ) && ( V_527 & ( 4 << 28 ) ) )
F_208 ( V_10 ) ;
if ( ( V_528 & V_182 ) && ( V_527 & ( 2 << 28 ) ) )
F_202 ( V_10 ) ;
if ( ( V_528 & V_182 ) && ( V_527 & ( 1 << 28 ) ) )
F_207 ( V_10 ) ;
if ( ( V_528 & V_185 ) && V_10 -> V_108 )
F_36 ( V_10 , V_10 -> V_119 , V_10 -> V_103 ) ;
if ( V_528 & ( V_179 | V_183 ) ) {
F_23 ( L_85 ,
V_10 -> V_11 . V_58 ,
( V_528 & V_179 ) ? L_86 : L_87 ,
( V_528 & V_183 ) ? L_88 : L_87 ,
F_16 ( V_522 ) ) ;
F_186 ( V_527 , V_528 ) ;
F_181 ( L_76 ) ;
if ( V_535 )
...
if ( V_180 && V_528 & V_181 ) {
F_23 ( L_89 ,
V_10 -> V_11 . V_58 , F_16 ( V_522 ) ) ;
if ( V_535 )
F_185 ( V_10 ) ;
}
V_281 ++ ;
if ( V_281 > 4 ) {
if ( V_281 > 8 || ! ( V_528 & V_178 ) ) {
F_17 ( 0 , V_175 ) ;
F_19 ( L_90 ,
V_10 -> V_11 . V_58 ) ;
} else {
...
static struct V_6 * F_212 ( struct V_9 * V_10 ,
const struct V_6 * V_536 ,
const char * V_537 )
{
struct V_6 * V_7 ;
V_7 = F_213 () ;
...
if ( V_387 > 0 )
F_189 ( L_95 ) ;
V_10 -> V_392 = F_212 ( V_10 , & V_547 , L_96 ) ;
if ( NULL == V_10 -> V_392 )
goto V_292;
if ( F_221 ( V_10 -> V_392 , V_409 ,
V_548 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_161 ( V_10 -> V_392 ) ) ;
if ( F_222 ( & V_10 -> V_392 -> V_8 ,
& V_549 ) < 0 ) {
F_19 ( L_98 , V_10 -> V_11 . V_58 ) ;
goto V_292;
}
V_10 -> V_401 = F_212 ( V_10 , & V_547 , L_99 ) ;
if ( NULL == V_10 -> V_401 )
goto V_292;
if ( F_221 ( V_10 -> V_401 , V_411 ,
V_550 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_161 ( V_10 -> V_401 ) ) ;
if ( ! V_10 -> V_551 )
return 0 ;
V_10 -> V_403 = F_212 ( V_10 , & V_552 , L_100 ) ;
if ( NULL == V_10 -> V_403 )
goto V_292;
V_10 -> V_403 -> V_121 = & V_10 -> V_553 ;
if ( F_221 ( V_10 -> V_403 , V_554 ,
V_555 [ V_10 -> V_11 . V_58 ] ) < 0 )
goto V_292;
F_23 ( L_97 ,
V_10 -> V_11 . V_58 , F_161 ( V_10 -> V_403 ) ) ;
return 0 ;
V_292:
F_217 ( V_10 ) ;
return - 1 ;
}
static void F_223 ( struct V_556 * V_8 )
{
#if F_224 ( V_557 )
unsigned int V_478 ;
F_225 ( V_8 , V_558 , & V_478 ) ;
V_478 = ( V_478 | V_559 ) ;
F_226 ( V_8 , V_558 , V_478 ) ;
#endif
}
static int F_227 ( struct V_556 * V_8 , const struct V_560 * V_561 )
{
struct V_315 V_562 = {
. V_288 = 0 ,
. type = V_437 ,
...
return - V_361 ;
F_23 ( L_101 , V_566 ) ;
V_568 [ V_566 ] = V_10 = F_228 ( sizeof( * V_10 ) , V_360 ) ;
if ( V_10 == NULL ) {
F_19 ( L_102 ) ;
return - V_361 ;
}
...
F_230 ( & V_10 -> V_569 ) ;
F_231 ( & V_10 -> V_534 ) ;
F_232 ( & V_10 -> V_11 . V_570 ) ;
F_232 ( & V_10 -> V_287 ) ;
F_232 ( & V_10 -> V_523 ) ;
F_233 ( & V_10 -> V_571 ) ;
V_10 -> V_571 . V_572 = F_198 ;
...
V_10 -> V_149 = V_8 -> V_1 ;
if ( F_234 ( V_8 ) ) {
F_188 ( L_104 , V_10 -> V_11 . V_58 ) ;
return - V_575 ;
}
if ( F_235 ( V_8 , F_236 ( 32 ) ) ) {
F_188 ( L_105 , V_10 -> V_11 . V_58 ) ;
return - V_575 ;
}
if ( ! F_237 ( F_238 ( V_8 , 0 ) ,
F_239 ( V_8 , 0 ) ,
V_10 -> V_11 . V_325 . V_302 ) ) {
F_188 ( L_106 ,
V_10 -> V_11 . V_58 ,
( unsigned long long ) F_238 ( V_8 , 0 ) ) ;
return - V_344 ;
}
F_240 ( V_8 ) ;
F_223 ( V_8 ) ;
V_484 = F_241 ( & V_8 -> V_8 , & V_10 -> V_11 . V_325 ) ;
if ( V_484 < 0 ) {
F_188 ( L_107 , V_10 -> V_11 . V_58 ) ;
goto V_576;
}
V_565 = & V_10 -> V_121 ;
F_242 ( V_565 , 20 ) ;
...
F_243 ( V_8 , V_577 , & V_563 ) ;
F_23 ( L_108 ,
V_566 , V_10 -> V_149 , V_10 -> V_542 , F_120 ( V_8 ) ,
V_10 -> V_11 . V_394 -> V_525 , V_563 ,
( unsigned long long ) F_238 ( V_8 , 0 ) ) ;
F_244 () ;
V_10 -> V_578 = F_245 ( F_238 ( V_8 , 0 ) , 0x1000 ) ;
if ( NULL == V_10 -> V_578 ) {
...
F_246 ( V_10 ) ;
F_17 ( 0 , V_175 ) ;
V_484 = F_247 ( V_10 -> V_11 . V_394 -> V_525 , F_209 ,
V_580 | V_581 , V_10 -> V_11 . V_325 . V_302 , ( void * ) V_10 ) ;
if ( V_484 < 0 ) {
F_19 ( L_110 ,
V_566 , V_10 -> V_11 . V_394 -> V_525 ) ;
goto V_579;
}
if ( 0 != F_248 ( V_10 ) ) {
V_484 = - V_575 ;
...
F_250 ( V_565 , & V_584 , NULL ) ;
F_250 ( V_565 , & V_589 , NULL ) ;
F_250 ( V_565 , & V_586 , NULL ) ;
F_250 ( V_565 , & V_590 , NULL ) ;
F_250 ( V_565 , & V_593 , NULL ) ;
F_250 ( V_565 , & V_596 , NULL ) ;
F_250 ( V_565 , & V_594 , NULL ) ;
F_250 ( V_565 , & V_599 , NULL ) ;
F_250 ( V_565 , & V_600 , NULL ) ;
F_250 ( V_565 , & V_602 , NULL ) ;
if ( V_115 )
F_39 ( V_10 , L_111 ) ;
F_251 ( V_10 ) ;
F_56 ( V_10 ) ;
...
F_40 ( V_10 , 1 ) ;
if ( ! V_95 [ V_10 -> V_11 . type ] . V_173 ) {
F_256 ( & V_10 -> V_553 , V_565 ,
V_609 ) ;
if ( V_10 -> V_553 . error ) {
V_484 = V_10 -> V_553 . error ;
goto V_582;
}
...
return 0 ;
V_582:
F_260 ( V_10 -> V_11 . V_394 -> V_525 , V_10 ) ;
V_579:
F_261 ( & V_10 -> V_121 ) ;
F_261 ( & V_10 -> V_553 ) ;
F_262 ( & V_10 -> V_11 . V_325 ) ;
V_576:
if ( V_10 -> V_578 )
F_263 ( V_10 -> V_578 ) ;
F_264 ( F_238 ( V_10 -> V_11 . V_394 , 0 ) ,
F_239 ( V_10 -> V_11 . V_394 , 0 ) ) ;
return V_484 ;
}
static void F_265 ( struct V_556 * V_556 )
{
struct V_612 * V_325 = F_266 ( V_556 ) ;
struct V_9 * V_10 = F_267 ( V_325 ) ;
if ( V_60 )
...
F_261 ( & V_10 -> V_121 ) ;
F_261 ( & V_10 -> V_553 ) ;
F_271 ( V_10 -> V_11 . V_394 , & V_10 -> main ) ;
F_260 ( V_10 -> V_11 . V_394 -> V_525 , V_10 ) ;
F_263 ( V_10 -> V_578 ) ;
F_264 ( F_238 ( V_10 -> V_11 . V_394 , 0 ) ,
F_239 ( V_10 -> V_11 . V_394 , 0 ) ) ;
...
static int F_272 ( struct V_556 * V_556 , T_13 V_252 )
{
struct V_612 * V_325 = F_266 ( V_556 ) ;
struct V_9 * V_10 = F_267 ( V_325 ) ;
struct V_510 V_614 ;
...
V_10 -> V_252 . V_616 = V_10 -> V_167 ;
V_10 -> V_252 . V_370 = V_10 -> V_503 ;
...
F_17 ( 0 , V_175 ) ;
F_54 ( & V_10 -> V_166 , V_164 ) ;
V_10 -> V_252 . V_617 = F_16 ( V_238 ) ;
V_10 -> V_252 . V_618 = F_50 () ;
F_273 ( V_556 ) ;
if ( 0 != F_274 ( V_556 , F_275 ( V_556 , V_252 ) ) ) {
F_276 ( V_556 ) ;
V_10 -> V_252 . V_619 = 1 ;
}
return 0 ;
}
static int F_277 ( struct V_556 * V_556 )
{
struct V_612 * V_325 = F_266 ( V_556 ) ;
struct V_9 * V_10 = F_267 ( V_325 ) ;
unsigned long V_164 ;
...
F_278 ( V_556 ) ;
F_58 ( V_10 ) ;
F_32 ( 0xffffff , V_10 -> V_252 . V_617 ) ;
F_279 ( V_10 -> V_252 . V_618 ) ;
F_53 ( & V_10 -> V_166 , V_164 ) ;
V_10 -> V_167 = V_10 -> V_252 . V_616 ;
V_10 -> V_503 = V_10 -> V_252 . V_370 ;
V_10 -> V_255 = V_10 -> V_252 . V_255 ;
F_199 ( V_10 , & V_10 -> V_167 ) ;
F_200 ( V_10 , V_10 -> V_503 ) ;
F_59 ( V_10 , 0 ) ;
F_54 ( & V_10 -> V_166 , V_164 ) ;
return 0 ;
}
static int T_14 F_280 ( void )
{
int V_621 ;
V_566 = 0 ;
F_23 ( L_118 , V_622 ) ;
if ( V_282 < 2 || V_282 > V_623 )
V_282 = 2 ;
if ( V_283 > V_624 )
V_283 = V_624 ;
V_283 = ( V_283 + V_625 - 1 ) & V_626 ;
if ( V_60 )
F_23 ( L_119 ,
V_282 , V_283 >> 10 , V_283 >> V_627 ) ;
F_281 () ;
V_621 = F_282 ( & V_628 ) ;
if ( V_621 < 0 ) {
F_188 ( L_120 , V_621 ) ;
