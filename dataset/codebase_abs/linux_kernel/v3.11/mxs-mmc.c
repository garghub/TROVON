...
F_62 ( V_10 -> V_171 ) ;
F_8 ( V_4 ) ;
V_10 -> V_77 = F_63 ( & V_152 -> V_156 , L_5 ) ;
if ( ! V_10 -> V_77 ) {
F_60 ( F_21 ( V_4 -> V_2 ) ,
L_6 , V_94 ) ;
V_5 = - V_172 ;
...
V_179 | V_180 ;
F_64 ( V_158 , L_7 , & V_122 ) ;
if ( V_122 == 4 )
V_2 -> V_176 |= V_181 ;
else if ( V_122 == 8 )
V_2 -> V_176 |= V_181 | V_182 ;
V_4 -> V_12 = F_65 ( V_158 , L_8 ) ;
V_4 -> V_11 = F_65 ( V_158 , L_9 ) ;
if ( V_4 -> V_11 )
V_2 -> V_176 |= V_183 ;
V_4 -> V_6 = F_66 ( V_158 , L_10 , 0 , & V_71 ) ;
if ( V_71 & V_184 )
V_4 -> V_8 = 1 ;
V_4 -> V_15 = F_65 ( V_158 , L_11 ) ;
V_2 -> V_185 = 400000 ;
V_2 -> V_186 = 288000000 ;
...
static int F_80 ( struct V_195 * V_156 )
{
struct V_1 * V_2 = F_81 ( V_156 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_9 * V_10 = & V_4 -> V_10 ;
int V_5 = 0 ;
V_5 = F_82 ( V_2 ) ;
...
static int F_83 ( struct V_195 * V_156 )
{
struct V_1 * V_2 = F_81 ( V_156 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_9 * V_10 = & V_4 -> V_10 ;
