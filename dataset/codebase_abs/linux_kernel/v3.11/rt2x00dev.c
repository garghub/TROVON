...
return 0 ;
if ( F_35 ( V_2 ) )
return V_2 -> V_235 [ 0 ] . V_265 + V_2 -> V_235 [ 0 ] . V_266 ;
return V_2 -> V_235 [ 0 ] . V_265 ;
}
...
F_122 ( & V_2 -> V_55 ) ;
F_7 ( V_32 , & V_2 -> V_11 ) ;
V_2 -> V_29 -> V_272 = sizeof( struct V_22 ) ;
V_2 -> V_29 -> V_221 -> V_273 [ V_274 - 1 ] =
( V_2 -> V_7 -> V_8 - 1 ) ;
V_2 -> V_145 =
F_125 ( L_5 , 0 , F_126 ( V_2 -> V_29 -> V_221 ) ) ;
if ( ! V_2 -> V_145 ) {
V_246 = - V_215 ;
goto exit;
}
...
goto exit;
V_2 -> V_72 = F_119 ( V_2 ) ;
V_2 -> V_29 -> V_221 -> V_276 = F_117 ( V_277 ) ;
if ( V_2 -> V_278 -> V_236 > 0 )
V_2 -> V_29 -> V_221 -> V_276 |=
F_117 ( V_38 ) |
F_117 ( V_37 ) |
#ifdef F_118
F_117 ( V_39 ) |
...
int F_145 ( struct V_1 * V_2 , T_8 V_283 )
{
F_146 ( V_2 , L_8 ) ;
