...
int V_135 ;
int V_178 = 0 ;
V_177 = F_67 ( V_175 , V_179 , 0 ) ;
if ( V_177 == NULL )
return - V_95 ;
V_135 = F_68 ( V_175 , 0 ) ;
if ( V_135 <= 0 )
return - V_95 ;
V_2 = F_69 ( & V_175 -> V_78 , sizeof( struct V_1 ) ,
V_180 ) ;
if ( ! V_2 )
return - V_181 ;
V_2 -> V_182 = F_70 ( & V_175 -> V_78 , NULL ) ;
if ( F_71 ( V_2 -> V_182 ) ) {
F_72 ( & V_175 -> V_78 , L_15 ) ;
return F_73 ( V_2 -> V_182 ) ;
}
F_74 ( V_2 -> V_182 ) ;
V_21 = F_75 ( & V_175 -> V_78 , 1 ) ;
if ( ! V_21 ) {
F_72 ( & V_175 -> V_78 , L_16 ) ;
V_178 = - V_181 ;
goto V_183;
}
V_21 -> V_22 = V_2 ;
