...
F_21 ( V_10 -> V_20 , V_10 ) ;
F_22 ( & V_10 -> V_12 ) ;
V_10 -> V_34 = F_23 ( V_10 -> V_2 -> V_35 , V_36 ) ;
F_20 ( V_10 -> V_34 , V_10 ) ;
V_10 -> V_37 = F_23 ( V_10 -> V_2 -> V_35 , V_38 ) ;
F_20 ( V_10 -> V_37 , V_10 ) ;
F_24 ( & V_25 -> V_20 , 1 ) ;
F_25 ( V_10 , V_22 ) ;
return 0 ;
...
{
struct V_1 * V_25 = F_30 ( V_20 , struct V_1 , V_20 ) ;
struct V_9 * V_10 = F_7 ( V_25 ) ;
if ( F_31 ( V_20 ) && V_10 -> V_39 )
F_32 ( V_10 -> V_40 ) ;
return 0 ;
}
