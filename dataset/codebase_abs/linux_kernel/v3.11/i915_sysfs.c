...
static T_3 F_26 ( struct V_8 * V_9 , struct V_10 * V_11 , char * V_12 )
{
struct V_13 * V_46 = F_6 ( V_9 , struct V_13 , V_9 ) ;
struct V_1 * V_2 = V_46 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_22 ( & V_5 -> V_47 . V_48 ) ;
if ( F_23 ( V_5 -> V_2 ) )
V_36 = F_25 ( V_5 -> V_51 , V_5 -> V_47 . V_54 ) ;
else
V_36 = V_5 -> V_47 . V_54 * V_53 ;
F_15 ( & V_5 -> V_47 . V_48 ) ;
return snprintf ( V_12 , V_15 , L_3 , V_36 ) ;
}
static T_3 F_27 ( struct V_8 * V_9 ,
struct V_10 * V_11 ,
...
struct V_1 * V_2 = V_46 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
T_1 V_55 , V_56 , V_57 , V_58 , V_59 ;
T_3 V_36 ;
V_36 = F_28 ( V_12 , 0 , & V_55 ) ;
if ( V_36 )
return V_36 ;
F_22 ( & V_5 -> V_47 . V_48 ) ;
if ( F_23 ( V_5 -> V_2 ) ) {
V_55 = F_29 ( V_5 -> V_51 , V_55 ) ;
V_57 = F_30 ( V_5 ) ;
V_58 = F_31 ( V_5 ) ;
V_59 = V_57 ;
} else {
...
V_57 = V_5 -> V_47 . V_57 ;
V_59 = ( V_56 & 0xff ) ;
V_58 = ( ( V_56 & 0xff0000 ) >> 16 ) ;
}
if ( V_55 < V_58 || V_55 > V_57 ||
V_55 < V_5 -> V_47 . V_61 ) {
F_15 ( & V_5 -> V_47 . V_48 ) ;
return - V_24 ;
}
...
static T_3 F_35 ( struct V_8 * V_9 , struct V_10 * V_11 , char * V_12 )
{
struct V_13 * V_46 = F_6 ( V_9 , struct V_13 , V_9 ) ;
struct V_1 * V_2 = V_46 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_22 ( & V_5 -> V_47 . V_48 ) ;
if ( F_23 ( V_5 -> V_2 ) )
V_36 = F_25 ( V_5 -> V_51 , V_5 -> V_47 . V_61 ) ;
else
V_36 = V_5 -> V_47 . V_61 * V_53 ;
F_15 ( & V_5 -> V_47 . V_48 ) ;
return snprintf ( V_12 , V_15 , L_3 , V_36 ) ;
}
static T_3 F_36 ( struct V_8 * V_9 ,
struct V_10 * V_11 ,
const char * V_12 , T_5 V_32 )
{
struct V_13 * V_46 = F_6 ( V_9 , struct V_13 , V_9 ) ;
...
if ( V_55 < V_58 || V_55 > V_57 || V_55 > V_5 -> V_47 . V_54 ) {
F_15 ( & V_5 -> V_47 . V_48 ) ;
return - V_24 ;
}
if ( V_5 -> V_47 . V_52 < V_55 ) {
...
static T_3 F_37 ( struct V_8 * V_9 , struct V_10 * V_11 , char * V_12 )
{
struct V_13 * V_46 = F_6 ( V_9 , struct V_13 , V_9 ) ;
struct V_1 * V_2 = V_46 -> V_2 ;
struct V_4 * V_5 = V_2 -> V_6 ;
...
F_15 ( & V_2 -> V_40 ) ;
if ( V_11 == & V_62 ) {
V_55 = ( ( V_56 & 0x0000ff ) >> 0 ) * V_53 ;
} else if ( V_11 == & V_63 ) {
V_55 = ( ( V_56 & 0x00ff00 ) >> 8 ) * V_53 ;
} else if ( V_11 == & V_64 ) {
V_55 = ( ( V_56 & 0xff0000 ) >> 16 ) * V_53 ;
} else {
F_39 () ;
}
return snprintf ( V_12 , V_15 , L_3 , V_55 ) ;
}
...
#endif
if ( F_11 ( V_2 ) ) {
V_36 = F_45 ( & V_2 -> V_66 -> V_9 , & V_68 ) ;
if ( V_36 )
F_44 ( L_6 ) ;
}
if ( F_42 ( V_2 ) -> V_65 >= 6 ) {
V_36 = F_46 ( & V_2 -> V_66 -> V_9 . V_30 , V_69 ) ;
if ( V_36 )
F_44 ( L_7 ) ;
}
}
...
{
F_48 ( & V_2 -> V_66 -> V_9 . V_30 , V_69 ) ;
F_49 ( & V_2 -> V_66 -> V_9 , & V_68 ) ;
#ifdef F_41
F_50 ( & V_2 -> V_66 -> V_9 . V_30 , & V_67 ) ;
#endif
}
