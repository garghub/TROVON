...
{
F_115 ( & V_88 . V_183 , 0 , V_185 , V_256 ) ;
return 0 ;
}
...
static T_6 int F_117 ( struct V_270 * V_271 )
{
struct V_208 * V_272 ;
struct V_54 * V_98 ;
int V_90 , V_261 = 0 , V_273 , V_260 = 0 ;
int V_274 = 0 ;
struct V_275 * V_276 ;
struct V_7 * V_8 ;
struct V_32 * V_33 ;
...
V_260 = F_116 () ;
if ( V_260 ) {
F_118 ( V_56 -> V_156 , L_43 ) ;
return V_260 ;
}
V_260 = F_119 ( V_56 , & V_88 . V_183 ) ;
if ( V_260 ) {
F_118 ( V_56 -> V_156 , L_44 ) ;
return V_260 ;
}
while ( ( V_137 = F_120 ( V_271 , V_279 , V_274 ) ) ) {
V_260 = F_121 ( & V_271 -> V_87 , V_137 -> V_280 , F_47 ,
V_281 , L_45 ,
( void * ) ( & V_88 . V_87 [ V_274 ] ->
V_39 ) ) ;
if ( V_260 ) {
V_260 = - V_25 ;
F_9 ( L_46 ) ;
...
* V_277 = V_283 ;
V_277 -> V_183 = & V_88 . V_183 ;
V_277 -> V_284 = F_123 ;
V_277 -> V_285 = V_286 ;
snprintf ( V_277 -> V_213 , sizeof( V_277 -> V_213 ) ,
L_47 ,
V_287 ) ;
V_33 -> V_223 = V_277 ;
}
V_137 = F_120 ( V_271 , V_288 , 0 ) ;
if ( V_137 ) {
V_34 = F_124 ( V_137 ) ;
...
V_88 . V_215 [ V_90 ] = F_126 ( & V_88 . V_183 ,
V_276 ,
& V_272 [ V_90 ] . V_290 ,
NULL ) ;
if ( ! V_88 . V_215 [ V_90 ] ) {
...
if ( V_88 . V_215 [ V_90 ] )
V_88 . V_215 [ V_90 ] -> V_292 = 1 << V_90 ;
}
for ( V_261 = 0 ; V_261 < V_267 ; V_261 ++ ) {
V_33 = V_88 . V_87 [ V_261 ] ;
F_127 ( & V_33 -> V_143 , 0 ) ;
for ( V_273 = 0 ; V_273 < V_92 ; V_273 ++ ) {
V_33 -> V_8 [ V_273 ] . V_116 = 0 ;
V_8 = & V_33 -> V_8 [ V_273 ] ;
V_8 -> V_147 = 0 ;
V_8 -> V_66 = 0 ;
F_128 ( & V_8 -> V_49 ) ;
...
F_131 ( V_33 -> V_223 , V_33 ) ;
V_260 = F_103 ( V_98 , V_33 , 0 ) ;
if ( V_260 )
goto V_293;
F_51 ( 1 , V_101 , L_50 ,
( int ) V_33 , ( int ) & V_33 -> V_223 ) ;
V_260 = F_132 ( V_33 -> V_223 ,
V_294 , ( V_261 ? 3 : 2 ) ) ;
if ( V_260 < 0 )
goto V_293;
}
...
return 0 ;
V_293:
for ( V_273 = 0 ; V_273 < V_261 ; V_273 ++ ) {
V_33 = V_88 . V_87 [ V_273 ] ;
F_134 ( V_33 -> V_223 ) ;
F_123 ( V_33 -> V_223 ) ;
V_33 -> V_223 = NULL ;
}
...
static int F_136 ( struct V_270 * V_295 )
{
struct V_32 * V_33 ;
int V_90 ;
F_135 ( & V_88 . V_183 ) ;
...
static int F_137 ( struct V_295 * V_87 )
{
struct V_7 * V_8 ;
struct V_32 * V_33 ;
int V_90 ;
...
static int F_139 ( struct V_295 * V_87 )
{
struct V_7 * V_8 ;
struct V_32 * V_33 ;
int V_90 ;
