...
V_65 = F_37 ( V_2 , V_72 -> V_80 [ V_21 ] . V_82 ,
V_72 , L_3 ) ;
} else
V_65 = F_37 ( V_2 , V_72 -> V_80 [ V_21 ] . V_82 , V_72 ,
NULL ) ;
if ( V_65 < 0 )
return V_65 ;
}
for ( V_21 = 0 , V_78 = V_72 -> V_83 ; V_21 < V_72 -> V_84 ; V_21 ++ , V_78 ++ ) {
V_65 = F_37 ( V_2 , * V_78 , V_72 , NULL ) ;
if ( V_65 < 0 )
return V_65 ;
}
...
if ( V_65 < 0 )
return V_65 ;
V_65 = F_37 ( V_2 , V_72 -> V_92 , V_72 , NULL ) ;
if ( V_65 < 0 )
return V_65 ;
return 0 ;
}
