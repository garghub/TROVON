...
{
struct V_103 * V_104 = V_102 -> V_4 . V_105 ;
struct V_6 * V_12 ;
struct V_106 * V_107 ;
int V_95 ;
int V_68 ;
...
V_107 = F_63 ( V_102 , V_108 , 0 ) ;
if ( ! V_107 )
return - V_34 ;
V_95 = F_64 ( V_102 , 0 ) ;
if ( V_95 < 0 )
return V_95 ;
if ( ! F_65 ( V_107 -> V_109 , F_66 ( V_107 ) ,
V_110 ) )
return - V_111 ;
V_12 = F_33 ( sizeof( struct V_6 ) +
sizeof( struct V_7 ) * V_104 -> V_112 , V_69 ) ;
if ( ! V_12 ) {
V_68 = - V_76 ;
goto V_113;
}
F_6 ( & V_102 -> V_4 , L_27 , V_12 ) ;
V_12 -> V_14 = F_67 ( V_107 -> V_109 , F_66 ( V_107 ) ) ;
if ( ! V_12 -> V_14 ) {
F_16 ( & V_102 -> V_4 , L_28 ) ;
V_68 = - V_76 ;
goto V_114;
}
F_7 ( V_115 , V_12 -> V_14 + V_116 ) ;
F_7 ( 0x0 , V_12 -> V_14 + V_15 ) ;
F_7 ( 0xFFFFFFFF , V_12 -> V_14 + V_18 ) ;
F_68 ( & V_12 -> V_98 , F_57 , ( unsigned long ) V_12 ) ;
V_68 = F_69 ( V_95 , F_60 , V_117 , V_110 , V_12 ) ;
if ( V_68 ) {
F_16 ( & V_102 -> V_4 , L_29 ) ;
goto V_118;
}
V_12 -> V_62 . V_119 = F_45 ;
V_12 -> V_62 . V_120 = F_47 ;
V_12 -> V_62 . V_121 = F_50 ;
V_12 -> V_62 . V_122 = F_52 ;
F_70 ( V_123 , V_12 -> V_62 . V_124 ) ;
F_70 ( V_125 , V_12 -> V_62 . V_124 ) ;
V_12 -> V_62 . V_126 = F_53 ;
V_12 -> V_62 . V_127 = F_56 ;
V_12 -> V_62 . V_4 = & V_102 -> V_4 ;
F_71 ( & V_12 -> V_62 . V_64 ) ;
for ( V_60 = 0 ; V_60 < V_104 -> V_112 ; V_60 ++ ) {
struct V_7 * V_8 = & V_12 -> V_64 [ V_60 ] ;
struct V_128 * V_129 =
V_104 -> V_64 + V_60 ;
if ( ( V_60 % 2 ) == V_129 -> V_130 ) {
F_16 ( & V_102 -> V_4 , L_30 ) ;
V_68 = - V_34 ;
goto V_131;
}
...
F_71 ( & V_8 -> V_65 ) ;
F_71 ( & V_8 -> V_56 ) ;
V_8 -> V_27 = V_129 -> V_132 ;
V_8 -> V_72 = V_129 -> V_133 ;
V_8 -> V_44 = V_129 -> V_44 ;
V_8 -> V_39 = V_129 -> V_130 ? V_40 :
V_87 ;
V_8 -> V_14 = V_12 -> V_14 +
( V_60 / 2 ) * V_134 +
( V_129 -> V_130 ? 0 : V_135 ) ;
F_6 ( & V_102 -> V_4 , L_31 ,
V_60 , V_8 -> V_14 ) ;
F_30 ( & V_8 -> V_3 . V_136 , & V_12 -> V_62 . V_64 ) ;
}
V_68 = F_73 ( & V_12 -> V_62 ) ;
if ( V_68 ) {
F_16 ( & V_102 -> V_4 , L_32 ) ;
...
F_37 ( V_12 ) ;
V_113:
F_78 ( V_107 -> V_109 , F_66 ( V_107 ) ) ;
return V_68 ;
}
static int F_79 ( struct V_101 * V_102 )
{
struct V_6 * V_12 = F_80 ( V_102 ) ;
struct V_106 * V_107 = F_63 ( V_102 , V_108 , 0 ) ;
int V_95 = F_64 ( V_102 , 0 ) ;
F_81 ( & V_12 -> V_62 ) ;
F_75 ( V_95 , V_12 ) ;
F_76 ( & V_12 -> V_98 ) ;
F_77 ( V_12 -> V_14 ) ;
