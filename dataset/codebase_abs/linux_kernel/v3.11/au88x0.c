...
static int
F_17 ( struct V_17 * V_18 , struct V_1 * V_19 , T_2 * * V_20 )
{
T_2 * V_21 ;
int V_22 ;
...
V_22 = F_35 ( V_21 , V_56 , V_57 ) ;
if ( V_22 < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
#ifndef F_36
if ( ( V_22 = F_35 ( V_21 , V_58 , 1 ) ) < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
if ( ( V_22 = F_35 ( V_21 , V_59 , V_60 ) ) < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
#endif
#ifndef F_37
if ( ( V_22 = F_35 ( V_21 , V_61 , V_62 ) ) < 0 ) {
F_33 ( V_18 ) ;
return V_22 ;
}
#endif
...
static void F_46 ( struct V_1 * V_19 )
{
F_33 ( F_47 ( V_19 ) ) ;
}
