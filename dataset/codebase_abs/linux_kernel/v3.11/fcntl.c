...
break;
case V_60 :
V_32 = F_37 ( V_3 , (struct V_61 T_2 * ) V_4 ) ;
break;
case V_62 :
case V_63 :
V_32 = F_38 ( V_1 , V_3 , V_51 , (struct V_61 T_2 * ) V_4 ) ;
break;
case V_64 :
V_32 = F_20 ( V_3 ) ;
F_39 () ;
...
F_16 () ;
V_29 = F_47 ( V_78 ) ;
V_40 = ( ( F_48 ( V_80 -> V_31 , V_82 ) ||
F_48 ( V_80 -> V_31 , V_29 -> V_83 ) || F_48 ( V_80 -> V_31 , V_29 -> V_30 ) ||
F_48 ( V_80 -> V_30 , V_29 -> V_83 ) || F_48 ( V_80 -> V_30 , V_29 -> V_30 ) ) &&
! F_49 ( V_78 , V_80 , V_81 ) ) ;
F_18 () ;
return V_40 ;
}
...
struct V_79 * V_80 ,
int V_1 , int V_84 , int V_85 )
{
int V_70 = F_51 ( V_80 -> V_70 ) ;
if ( ! F_46 ( V_78 , V_80 , V_70 ) )
return;
switch ( V_70 ) {
T_4 V_86 ;
default:
...
V_86 . V_94 = V_95 [ V_84 - V_92 ] ;
V_86 . V_96 = V_1 ;
if ( ! F_53 ( V_70 , & V_86 , V_78 , V_85 ) )
break;
case 0 :
F_53 ( V_97 , V_98 , V_78 , V_85 ) ;
}
}
void F_54 ( struct V_79 * V_80 , int V_1 , int V_99 )
{
struct V_77 * V_78 ;
enum V_25 type ;
struct V_24 * V_24 ;
...
struct V_79 * V_80 , int V_85 )
{
if ( F_46 ( V_78 , V_80 , V_102 ) )
F_53 ( V_102 , V_98 , V_78 , V_85 ) ;
}
...
{
F_60 ( V_105 ,
F_61 ( V_104 , struct V_106 , V_107 ) ) ;
}
int F_62 ( struct V_2 * V_3 , struct V_106 * * V_108 )
{
struct V_106 * V_109 , * * V_110 ;
int V_34 = 0 ;
F_5 ( & V_3 -> V_22 ) ;
F_5 ( & V_111 ) ;
for ( V_110 = V_108 ; ( V_109 = * V_110 ) != NULL ; V_110 = & V_109 -> V_112 ) {
if ( V_109 -> V_113 != V_3 )
continue;
F_63 ( & V_109 -> V_114 ) ;
V_109 -> V_113 = NULL ;
...
struct V_106 * F_66 ( void )
{
return F_67 ( V_105 , V_115 ) ;
}
void F_68 ( struct V_106 * V_116 )
{
F_60 ( V_105 , V_116 ) ;
}
struct V_106 * F_69 ( int V_1 , struct V_2 * V_3 , struct V_106 * * V_108 , struct V_106 * V_116 )
{
struct V_106 * V_109 , * * V_110 ;
F_5 ( & V_3 -> V_22 ) ;
F_5 ( & V_111 ) ;
...
static int F_72 ( int V_1 , struct V_2 * V_3 , struct V_106 * * V_108 )
{
struct V_106 * V_116 ;
V_116 = F_66 () ;
if ( ! V_116 )
return - V_120 ;
if ( F_69 ( V_1 , V_3 , V_108 , V_116 ) ) {
F_68 ( V_116 ) ;
return 0 ;
}
return 1 ;
}
int F_73 ( int V_1 , struct V_2 * V_3 , int V_121 , struct V_106 * * V_108 )
{
if ( ! V_121 )
return F_62 ( V_3 , V_108 ) ;
return F_72 ( V_1 , V_3 , V_108 ) ;
}
static void F_74 ( struct V_106 * V_109 , int V_81 , int V_99 )
{
while ( V_109 ) {
struct V_79 * V_80 ;
unsigned long V_122 ;
...
F_76 ( & V_109 -> V_114 , V_122 ) ;
if ( V_109 -> V_113 ) {
V_80 = & V_109 -> V_113 -> V_27 ;
if ( ! ( V_81 == V_102 && V_80 -> V_70 == 0 ) )
F_54 ( V_80 , V_109 -> V_117 , V_99 ) ;
}
F_77 ( & V_109 -> V_114 , V_122 ) ;
V_109 = F_78 ( V_109 -> V_112 ) ;
}
}
void F_79 ( struct V_106 * * V_110 , int V_81 , int V_99 )
{
if ( * V_110 ) {
F_16 () ;
F_74 ( F_78 ( * V_110 ) , V_81 , V_99 ) ;
F_18 () ;
}
}
...
V_105 = F_83 ( L_3 ,
sizeof( struct V_106 ) , 0 , V_139 , NULL ) ;
return 0 ;
}
