...
return V_11 ;
F_3 ( V_2 , V_3 , 255 ) ;
F_4 ( ( V_3 * 0x64 ) / 0xff | V_13 , & V_8 -> V_14 ) ;
return 0 ;
}
static T_1 F_5 ( struct V_1 * V_2 , T_1 V_15 )
{
F_2 ( L_2 ) ;
return V_16 ;
}
...
static T_1 F_7 ( struct V_1 * V_2 , T_1 V_19 )
{
F_2 ( L_4 ) ;
return V_20 ;
}
...
if ( ! V_8 )
return;
V_22 = F_9 ( & V_8 -> V_23 ) & V_24 ;
if ( ! V_22 ) {
F_2 ( L_5 ) ;
return;
}
if ( V_22 & V_25 )
V_21 |= F_5 ( V_2 , F_9 ( & V_8 -> V_15 ) ) ;
if ( V_22 & V_26 )
V_21 |= F_1 ( V_2 , F_9 ( & V_8 -> V_3 ) ) ;
if ( V_22 & V_27 )
V_21 |= F_7 ( V_2 , F_9 ( & V_8 -> V_19 ) ) ;
if ( V_22 & V_28 )
V_21 |= F_6 ( V_2 , F_9 ( & V_8 -> V_17 ) ) ;
F_4 ( V_21 , & V_8 -> V_23 ) ;
}
...
T_1 V_56 ;
int V_57 = 0 ;
V_49 = F_12 ( & V_2 -> V_58 -> V_2 ) ;
if ( ! V_49 || F_13 ( V_49 , & V_51 ) )
return;
if ( F_14 ( V_49 ) )
V_53 = V_51 ;
else {
F_15 (acpi_cdev, &acpi_dev->children, node) {
if ( F_14 ( V_52 -> V_49 ) ) {
V_53 = V_52 ;
break;
}
...
F_15 (acpi_cdev, &acpi_video_bus->children, node) {
if ( V_57 >= 8 ) {
F_17 ( & V_2 -> V_58 -> V_2 ,
L_7 ) ;
return;
...
int V_99 = 0 ;
F_28 ( V_2 -> V_58 , V_100 , & V_95 ) ;
F_2 ( L_10 , V_95 ) ;
if ( V_95 == 0 ) {
F_2 ( L_11 ) ;
return - V_101 ;
}
V_94 = F_29 ( V_95 , V_102 ) ;
if ( ! V_94 )
return - V_103 ;
F_30 ( V_97 , V_94 , sizeof( V_97 ) ) ;
