...
{
struct V_111 * V_6 = V_110 -> V_54 . V_112 ;
struct V_26 * V_27 = F_76 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
const char * V_113 = F_77 ( V_27 ) ;
struct V_114 * V_115 ;
int V_116 ;
int V_91 ;
int V_117 ;
if ( V_6 && F_69 ( V_6 -> V_118 ) ) {
memcpy ( V_27 -> V_30 , V_6 -> V_118 , V_28 ) ;
} else {
F_78 ( V_27 ) ;
}
V_115 = F_79 ( V_110 , V_119 , 0 ) ;
if ( ! V_115 )
return - V_120 ;
V_116 = F_80 ( V_115 ) ;
if ( ! F_81 ( & V_110 -> V_54 , V_115 -> V_121 , V_116 , V_113 ) )
return - V_122 ;
V_2 -> V_4 = F_82 ( & V_110 -> V_54 , V_115 -> V_121 , V_116 ) ;
if ( ! V_2 -> V_4 )
return - V_122 ;
F_83 ( & V_2 -> V_18 ) ;
V_2 -> V_33 = V_116 < V_123 ;
if ( V_2 -> V_33 ) {
V_2 -> V_124 = F_10 ;
V_2 -> V_125 = F_14 ;
V_2 -> V_126 = F_15 ;
...
F_26 ( V_2 ) ;
if ( F_45 ( V_2 , V_130 ) != V_131 )
return - V_132 ;
V_91 = F_84 ( V_110 , 0 ) ;
if ( V_91 < 0 )
return V_91 ;
V_117 = F_85 ( V_91 , F_58 ,
V_133 , V_113 , V_27 ) ;
if ( V_117 < 0 )
return V_117 ;
V_2 -> V_91 = V_91 ;
V_2 -> V_56 = V_6 ? V_6 -> V_56 : - V_134 ;
if ( F_35 ( V_2 -> V_56 ) ) {
char * V_135 = F_86 ( & V_110 -> V_54 , 16 , V_136 ) ;
if ( ! V_135 )
return - V_87 ;
snprintf ( V_135 , 16 , L_6 , V_113 ) ;
V_2 -> V_137 = F_87 ( V_2 -> V_56 ) ;
if ( F_88 ( V_2 -> V_137 , F_62 ,
V_138 | V_139 ,
V_135 , V_2 -> V_27 ) < 0 )
V_2 -> V_56 = - V_134 ;
}
F_89 ( V_27 , L_7 , ( V_140 ) V_115 -> V_121 , V_91 ) ;
return 0 ;
}
...
static int F_99 ( struct V_109 * V_110 )
{
struct V_26 * V_27 = F_76 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
F_26 ( V_2 ) ;
F_100 ( V_2 -> V_91 , V_27 ) ;
if ( F_35 ( V_2 -> V_56 ) )
F_100 ( V_2 -> V_137 , V_27 ) ;
F_97 ( V_27 ) ;
F_98 ( V_27 ) ;
return 0 ;
}
static int F_101 ( struct V_152 * V_54 )
{
struct V_109 * V_110 = F_102 ( V_54 ) ;
struct V_26 * V_27 = F_76 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
if ( F_63 ( V_27 ) ) {
F_66 ( V_27 ) ;
...
static int F_104 ( struct V_152 * V_54 )
{
struct V_109 * V_110 = F_102 ( V_54 ) ;
struct V_26 * V_27 = F_76 ( V_110 ) ;
struct V_1 * V_2 = F_34 ( V_27 ) ;
