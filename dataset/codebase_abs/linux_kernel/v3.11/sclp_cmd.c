...
static int F_64 ( T_2 V_1 , T_5 V_144 )
{
struct V_145 * V_2 ;
int V_3 ;
if ( ! V_146 )
...
int F_66 ( T_5 V_144 )
{
return F_64 ( V_150 , V_144 ) ;
}
int F_67 ( T_5 V_144 )
{
return F_64 ( V_151 , V_144 ) ;
}
...
int F_69 ( struct V_154 V_155 )
{
return F_68 ( V_156 | V_155 . V_92 << 8 ) ;
}
int F_70 ( struct V_154 V_155 )
{
return F_68 ( V_157 | V_155 . V_92 << 8 ) ;
}
int F_71 ( struct V_158 * V_47 )
{
struct V_159 * V_2 ;
int V_3 ;
if ( ! V_160 )
