...
int V_39 = 0 ;
V_99 ;
if ( V_97 == NULL || V_97 -> V_100 )
V_39 = - V_101 ;
if ( V_39 == 0 && V_13 -> V_102 )
...
V_99 ;
V_19 = V_20 -> V_108 ;
V_107 = & V_19 -> V_109 . V_110 ;
F_13 ( V_64 , L_10 ,
V_107 -> V_111 , V_107 -> V_112 , V_107 -> V_113 ) ;
if ( V_107 -> V_112 )
F_24 ( V_11 , V_20 -> V_45 ,
V_107 -> V_111 , V_107 -> V_113 ) ;
RETURN ( 0 ) ;
}
static int F_41 ( void * V_114 , int V_115 )
{
struct V_116 * args = V_114 ;
args -> V_117 = V_115 ;
F_42 ( & args -> V_118 ) ;
return 0 ;
}
static int F_43 ( const struct V_10 * V_11 , struct V_31 * V_19 ,
struct V_16 * V_17 , void * V_119 )
{
const struct V_18 * V_3 ;
struct V_15 * V_120 ;
struct V_51 * V_52 ;
...
if ( V_52 -> V_122 & V_48 &&
! F_18 ( & V_52 -> V_56 ) )
F_44 ( V_123 , V_11 , V_17 , L_11 V_78 L_12 ,
V_121 , V_124 -> V_125 ) ;
{
struct V_17 * V_126 = F_45 ( V_11 , V_17 ) ;
if ( F_46 ( V_126 ) )
F_13 ( V_44 , L_13 ,
V_120 , V_17 -> V_90 ,
( V_52 -> V_122 & V_127 ) ) ;
...
struct V_9 * V_13 , T_2 V_129 )
{
struct V_65 * V_130 ;
int V_131 ;
T_1 V_121 ;
V_130 = V_13 -> V_14 . V_45 ;
V_121 = F_48 ( V_130 , V_129 ) ;
V_131 = F_26 ( V_130 , V_121 ) < V_129 ;
F_49 ( V_11 , V_130 , V_19 , V_121 + V_131 , V_132 ,
F_43 , ( void * ) & V_129 ) ;
}
static int F_50 ( const struct V_10 * V_11 ,
const struct V_12 * V_3 )
{
struct V_31 * V_19 = V_3 -> V_108 ;
struct V_9 * V_13 = F_4 ( V_11 , V_3 ) ;
struct V_65 * V_66 = V_3 -> V_45 ;
struct V_69 * V_70 = F_14 ( V_66 ) -> V_71 ;
struct V_72 * V_73 = & F_25 ( V_11 ) -> V_74 ;
struct V_133 * V_134 = & V_13 -> V_135 ;
struct V_116 * V_136 = & V_13 -> V_137 ;
T_2 V_129 = V_19 -> V_109 . V_138 . V_139 . V_81 ;
unsigned int V_140 = V_19 -> V_109 . V_138 . V_141 ;
int V_39 = 0 ;
struct V_142 V_143 = { { { 0 } } } ;
if ( F_51 ( V_19 ) )
V_39 = F_52 ( V_11 , V_13 , F_14 ( V_66 ) , V_129 ) ;
if ( V_39 == 0 && V_13 -> V_102 == 0 ) {
F_27 ( V_66 ) ;
V_39 = F_53 ( V_11 , V_66 , V_73 ) ;
if ( V_39 == 0 ) {
struct V_144 * V_145 = & V_19 -> V_109 . V_138 . V_139 ;
unsigned int V_146 = 0 ;
if ( V_140 & V_147 ) {
V_73 -> V_84 = V_73 -> V_82 = V_129 ;
V_146 = ( V_85 | V_83 ) ;
}
if ( V_140 & V_148 ) {
V_73 -> V_149 = V_145 -> V_150 ;
V_146 |= V_151 ;
}
if ( V_140 & V_152 ) {
V_73 -> V_153 = V_145 -> V_154 ;
V_146 |= V_155 ;
}
if ( V_140 & V_156 ) {
V_73 -> V_157 = V_145 -> V_158 ;
V_146 |= V_159 ;
}
V_39 = F_28 ( V_11 , V_66 , V_73 , V_146 ) ;
}
F_29 ( V_66 ) ;
}
memset ( V_134 , 0 , sizeof( * V_134 ) ) ;
if ( V_39 == 0 ) {
V_134 -> V_160 = V_70 -> V_161 ;
V_134 -> V_162 = V_73 -> V_149 ;
V_134 -> V_163 = V_73 -> V_153 ;
V_134 -> V_164 = V_73 -> V_157 ;
V_134 -> V_165 = V_166 | V_167 | V_168 |
V_169 | V_170 ;
if ( V_140 & V_147 ) {
V_134 -> V_171 = V_129 ;
V_134 -> V_172 = V_173 ;
V_134 -> V_165 |= V_174 | V_175 ;
if ( V_13 -> V_102 ) {
V_134 -> V_176 = V_177 ;
V_134 -> V_165 |= V_178 ;
}
...
V_143 . V_135 = V_134 ;
V_143 . V_179 = V_19 -> V_109 . V_138 . V_180 ;
F_54 ( & V_136 -> V_118 ) ;
if ( V_140 & V_147 )
...
if ( V_136 -> V_182 ) {
F_58 ( & V_136 -> V_118 ) ;
V_39 = V_19 -> V_183 = V_136 -> V_117 ;
}
if ( V_39 == 0 ) {
if ( V_13 -> V_102 ) {
struct V_92 * V_184 = F_32 ( V_66 -> V_94 . V_95 ) ;
F_8 ( F_51 ( V_19 ) ) ;
V_184 -> V_185 . V_186 ++ ;
}
}
...
memset ( V_134 , 0 , sizeof( * V_134 ) ) ;
V_134 -> V_160 = V_70 -> V_161 ;
V_134 -> V_165 = V_166 | V_167 ;
V_134 -> V_171 = V_107 -> V_192 ;
V_134 -> V_172 = V_107 -> V_193 ;
V_134 -> V_165 |= V_174 | V_175 ;
F_65 ( V_134 , V_107 -> V_194 ) ;
memset ( V_143 , 0 , sizeof( * V_143 ) ) ;
V_143 -> V_135 = V_134 ;
V_143 -> V_179 = V_107 -> V_195 ;
F_54 ( & V_136 -> V_118 ) ;
V_115 = F_66 ( F_37 ( V_66 ) , V_143 , F_41 , V_136 ,
V_181 ) ;
RETURN ( V_115 ) ;
}
...
{
struct V_31 * V_19 = V_3 -> V_108 ;
struct V_190 * V_107 = & V_19 -> V_109 . V_196 ;
struct V_65 * V_66 = V_3 -> V_45 ;
struct V_28 * V_29 = F_14 ( V_66 ) ;
T_1 V_121 = F_48 ( V_66 , V_107 -> V_192 ) ;
T_1 V_197 = F_48 ( V_66 , V_107 -> V_193 ) ;
int V_39 = 0 ;
V_99 ;
if ( V_107 -> V_193 == V_173 )
V_197 = V_132 ;
V_39 = F_68 ( V_11 , V_29 , V_121 , V_197 , 0 ,
V_107 -> V_198 == V_199 ) ;
if ( V_39 > 0 ) {
V_107 -> V_200 += V_39 ;
V_39 = 0 ;
}
if ( V_107 -> V_198 == V_201 ) {
int V_115 ;
V_115 = F_69 ( V_11 , V_29 , V_121 , V_197 ) ;
if ( V_39 == 0 )
V_39 = V_115 ;
V_115 = F_64 ( V_11 , V_29 , V_107 ) ;
if ( V_39 == 0 )
V_39 = V_115 ;
}
RETURN ( V_39 ) ;
...
const struct V_12 * V_3 )
{
struct V_190 * V_107 = & V_3 -> V_108 -> V_109 . V_196 ;
struct V_65 * V_66 = V_3 -> V_45 ;
T_1 V_121 = F_48 ( V_66 , V_107 -> V_192 ) ;
T_1 V_197 = F_48 ( V_66 , V_107 -> V_193 ) ;
int V_39 = 0 ;
if ( V_107 -> V_198 == V_202 ) {
V_39 = F_69 ( V_11 , F_14 ( V_66 ) , V_121 , V_197 ) ;
} else if ( V_107 -> V_198 == V_201 ) {
struct V_9 * V_13 = F_4 ( V_11 , V_3 ) ;
struct V_116 * V_136 = & V_13 -> V_137 ;
F_58 ( & V_136 -> V_118 ) ;
if ( V_39 == 0 )
...
struct V_133 * V_134 ;
struct V_144 * V_145 ;
V_143 = F_14 ( V_66 ) -> V_71 ;
V_145 = & V_143 -> V_80 ;
V_134 = V_73 -> V_216 ;
if ( ( V_208 & V_170 ) != 0 ) {
V_134 -> V_162 = V_145 -> V_150 ;
V_134 -> V_165 |= V_170 ;
}
if ( ( V_208 & V_168 ) != 0 ) {
V_134 -> V_163 = V_145 -> V_154 ;
V_134 -> V_165 |= V_168 ;
}
if ( ( V_208 & V_169 ) != 0 ) {
V_134 -> V_164 = V_145 -> V_158 ;
V_134 -> V_165 |= V_169 ;
}
if ( V_208 & V_167 ) {
F_77 ( & V_134 -> V_160 , F_78 ( & V_143 -> V_161 ) ) ;
V_134 -> V_165 |= V_167 ;
}
if ( V_208 & V_166 ) {
F_79 ( & V_134 -> V_160 , F_80 ( & V_143 -> V_161 ) ) ;
V_134 -> V_165 |= V_166 ;
}
if ( V_208 & V_217 ) {
V_210 = V_3 -> V_218 ;
...
cll_linkage)
F_84 ( V_123 , V_11 , V_225 ,
L_14 ) ;
F_44 ( V_123 , V_11 , V_211 ,
L_15 ) ;
F_85 ( NULL ) ;
F_86 () ;
}
