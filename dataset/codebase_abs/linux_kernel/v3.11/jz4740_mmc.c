...
goto V_158;
V_24 -> V_159 = & V_160 ;
V_24 -> V_161 = V_115 / 128 ;
V_24 -> V_162 = V_115 ;
V_24 -> V_163 = V_164 | V_165 ;
V_24 -> V_166 = ( V_122 && V_122 -> V_151 ) ? 0 : V_167 ;
V_24 -> V_166 |= V_168 ;
V_24 -> V_169 = ( 1 << 10 ) - 1 ;
V_24 -> V_170 = ( 1 << 15 ) - 1 ;
V_24 -> V_171 = V_24 -> V_169 * V_24 -> V_170 ;
V_24 -> V_172 = 128 ;
V_24 -> V_173 = V_24 -> V_171 ;
V_2 -> V_24 = V_24 ;
V_2 -> V_139 = V_139 ;
F_68 ( & V_2 -> V_6 ) ;
V_2 -> V_7 = 0xffff ;
...
V_137 = F_74 ( V_24 ) ;
if ( V_137 ) {
F_49 ( & V_139 -> V_132 , L_10 , V_137 ) ;
goto V_175;
}
F_75 ( & V_139 -> V_132 , L_11 ) ;
return 0 ;
V_175:
F_76 ( V_2 -> V_3 , V_2 ) ;
V_174:
