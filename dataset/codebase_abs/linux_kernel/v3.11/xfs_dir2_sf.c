...
T_13 * V_12 = NULL ;
F_35 ( args ) ;
ASSERT ( F_36 ( args ) == V_76 ) ;
V_15 = args -> V_15 ;
ASSERT ( V_15 -> V_50 . V_51 & V_53 ) ;
if ( V_15 -> V_54 . V_62 < F_37 ( T_5 , V_10 ) ) {
ASSERT ( F_38 ( V_15 -> V_26 ) ) ;
return F_39 ( V_77 ) ;
}
...
for ( V_73 = F_47 ( V_15 -> V_26 ) ,
V_87 = F_26 ( V_88 ) ,
V_82 = F_30 ( args -> V_14 ) ,
V_84 = ( char * ) V_87 == & V_83 [ V_74 ] ;
! V_84 ;
V_73 = V_86 + F_30 ( V_87 -> V_14 ) ,
V_87 = F_29 ( V_88 , V_87 ) ,
V_84 = ( char * ) V_87 == & V_83 [ V_74 ] ) {
V_86 = F_48 ( V_87 ) ;
if ( V_73 + V_82 <= V_86 )
...
V_9 = F_7 ( V_42 ) ;
V_4 = V_9 > V_31 ;
for ( V_6 = 0 , V_12 = F_26 ( V_42 ) ;
V_6 < V_42 -> V_20 ;
V_6 ++ , V_12 = F_29 ( V_42 , V_12 ) ) {
ASSERT ( F_48 ( V_12 ) >= V_73 ) ;
V_9 = F_10 ( V_42 , V_12 ) ;
V_4 += V_9 > V_31 ;
V_73 =
F_48 ( V_12 ) +
...
if ( V_15 -> V_54 . V_55 == V_94 ) {
V_15 -> V_50 . V_51 &= ~ V_52 ;
V_15 -> V_54 . V_55 = V_56 ;
F_32 ( args -> V_68 , V_15 , V_46 ) ;
V_15 -> V_50 . V_51 |= V_53 ;
}
ASSERT ( V_15 -> V_50 . V_51 & V_53 ) ;
ASSERT ( V_15 -> V_50 . V_57 == 0 ) ;
...
V_42 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
ASSERT ( V_15 -> V_54 . V_62 >= F_18 ( V_42 -> V_4 ) ) ;
if ( F_52 ( V_24 , V_96 -> V_100 ) > V_24 -> V_47 )
return 0 ;
V_98 = F_53 ( V_24 , V_24 -> V_47 ,
F_54 ( V_24 ) ) ;
V_99 = F_53 ( V_24 , V_24 -> V_47 ,
F_55 ( V_24 ) ) ;
if ( V_96 -> V_100 <= V_98 ) {
V_96 -> V_100 = V_98 & 0x7fffffff ;
if ( ! F_56 ( V_96 , L_1 , 1 , V_15 -> V_66 , V_101 ) )
return 0 ;
}
if ( V_96 -> V_100 <= V_99 ) {
V_9 = F_7 ( V_42 ) ;
V_96 -> V_100 = V_99 & 0x7fffffff ;
if ( ! F_56 ( V_96 , L_2 , 2 , V_9 , V_101 ) )
return 0 ;
}
V_12 = F_26 ( V_42 ) ;
for ( V_6 = 0 ; V_6 < V_42 -> V_20 ; V_6 ++ ) {
V_97 = F_53 ( V_24 , V_24 -> V_47 ,
F_48 ( V_12 ) ) ;
if ( V_96 -> V_100 > V_97 ) {
V_12 = F_29 ( V_42 , V_12 ) ;
continue;
...
V_9 = F_10 ( V_42 , V_12 ) ;
V_96 -> V_100 = V_97 & 0x7fffffff ;
if ( ! F_56 ( V_96 , ( char * ) V_12 -> V_13 , V_12 -> V_14 ,
V_9 , V_102 ) )
return 0 ;
V_12 = F_29 ( V_42 , V_12 ) ;
}
V_96 -> V_100 = F_53 ( V_24 , V_24 -> V_47 + 1 , 0 ) &
0x7fffffff ;
return 0 ;
}
int
...
V_105 = NULL ;
for ( V_6 = 0 , V_12 = F_26 ( V_42 ) ; V_6 < V_42 -> V_20 ;
V_6 ++ , V_12 = F_29 ( V_42 , V_12 ) ) {
V_104 = V_15 -> V_26 -> V_109 -> V_110 ( args , V_12 -> V_13 ,
V_12 -> V_14 ) ;
if ( V_104 != V_111 && V_104 != args -> V_106 ) {
args -> V_106 = V_104 ;
...
ASSERT ( args -> V_78 & V_112 ) ;
if ( ! V_105 )
return F_39 ( V_76 ) ;
error = F_58 ( args , V_105 -> V_13 , V_105 -> V_14 ) ;
return F_39 ( error ) ;
}
int
F_59 (
...
V_15 = args -> V_15 ;
ASSERT ( V_15 -> V_50 . V_51 & V_53 ) ;
V_115 = ( int ) V_15 -> V_54 . V_62 ;
if ( V_115 < F_37 ( T_5 , V_10 ) ) {
ASSERT ( F_38 ( V_15 -> V_26 ) ) ;
return F_39 ( V_77 ) ;
}
ASSERT ( V_15 -> V_50 . V_57 == V_115 ) ;
ASSERT ( V_15 -> V_50 . V_60 . V_61 != NULL ) ;
V_42 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
ASSERT ( V_115 >= F_18 ( V_42 -> V_4 ) ) ;
for ( V_6 = 0 , V_12 = F_26 ( V_42 ) ; V_6 < V_42 -> V_20 ;
V_6 ++ , V_12 = F_29 ( V_42 , V_12 ) ) {
if ( F_61 ( args , V_12 -> V_13 , V_12 -> V_14 ) ==
V_107 ) {
...
return F_39 ( V_76 ) ;
V_81 = ( int ) ( ( char * ) V_12 - ( char * ) V_42 ) ;
V_113 = F_40 ( V_42 , args -> V_14 ) ;
V_114 = V_115 - V_113 ;
if ( V_81 + V_113 < V_115 )
memmove ( ( char * ) V_42 + V_81 , ( char * ) V_42 + V_81 + V_113 ,
V_115 - ( V_81 + V_113 ) ) ;
V_42 -> V_20 -- ;
V_15 -> V_54 . V_62 = V_114 ;
F_24 ( V_15 , V_114 - V_115 , V_58 ) ;
V_42 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
#if V_29
if ( args -> V_30 > V_31 ) {
if ( V_42 -> V_4 == 1 )
...
F_67 ( args ) ;
V_15 = args -> V_15 ;
V_115 = V_15 -> V_50 . V_57 ;
V_83 = F_22 ( V_115 , V_44 ) ;
V_88 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
ASSERT ( V_88 -> V_4 == 1 ) ;
memcpy ( V_83 , V_88 , V_115 ) ;
V_114 =
V_115 -
( V_88 -> V_20 + 1 ) *
( ( V_32 ) sizeof( V_34 ) - ( V_32 ) sizeof( V_35 ) ) ;
F_24 ( V_15 , - V_115 , V_58 ) ;
F_24 ( V_15 , V_114 , V_58 ) ;
V_88 = ( T_5 * ) V_83 ;
V_42 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
V_42 -> V_20 = V_88 -> V_20 ;
V_42 -> V_4 = 0 ;
