...
static T_4
F_40 ( int V_37 , struct V_38 * V_39 , const struct V_40 * V_41 ,
T_1 V_42 , unsigned long V_43 )
{
F_2 ( V_10 , L_4 ,
V_39 -> V_44 -> V_45 . V_46 -> V_47 . V_48 ,
( long long ) V_42 , V_43 ) ;
return - V_49 ;
}
static int F_41 ( struct V_13 * V_14 , struct V_16 * V_8 ,
T_1 V_42 , unsigned V_23 , unsigned V_50 ,
struct V_3 * * V_51 , void * * V_52 )
{
int V_4 = 0 ;
struct V_3 * V_3 ;
struct V_26 * V_27 ;
...
T_1 V_42 , unsigned V_23 , unsigned V_56 ,
struct V_3 * V_3 , void * V_52 )
{
T_1 V_57 = V_42 + V_56 ;
struct V_7 * V_7 = V_3 -> V_8 -> V_9 ;
if ( F_46 ( V_56 < V_23 ) ) {
unsigned V_58 = V_42 & ( V_11 - 1 ) ;
F_47 ( V_3 , V_58 + V_56 , V_23 - V_56 ) ;
F_10 ( V_3 ) ;
}
if ( ! F_43 ( V_3 ) )
F_11 ( V_3 ) ;
if ( V_57 > V_7 -> V_59 ) {
F_48 ( V_7 , V_57 - V_7 -> V_59 ) ;
F_49 ( V_7 , V_57 ) ;
}
F_50 ( V_3 ) ;
F_14 ( V_3 ) ;
