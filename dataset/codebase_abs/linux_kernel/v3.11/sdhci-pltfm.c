...
if ( F_17 ( V_33 ) < 0x100 )
F_18 ( & V_11 -> V_12 , L_16 ) ;
if ( V_11 -> V_12 . V_38 != & V_39 && ! V_7 )
V_2 = F_19 ( V_11 -> V_12 . V_38 ,
...
V_2 -> V_43 = F_23 ( V_11 , 0 ) ;
if ( ! F_24 ( V_33 -> V_44 , F_17 ( V_33 ) ,
F_25 ( V_2 -> V_25 ) ) ) {
F_18 ( & V_11 -> V_12 , L_17 ) ;
V_34 = - V_45 ;
goto V_46;
}
V_2 -> V_47 = F_26 ( V_33 -> V_44 , F_17 ( V_33 ) ) ;
if ( ! V_2 -> V_47 ) {
F_18 ( & V_11 -> V_12 , L_18 ) ;
V_34 = - V_36 ;
goto V_48;
}
if ( V_2 -> V_41 && V_2 -> V_41 -> V_49 )
V_2 -> V_41 -> V_49 ( V_2 ) ;
F_27 ( V_11 , V_2 ) ;
return V_2 ;
V_48:
F_28 ( V_33 -> V_44 , F_17 ( V_33 ) ) ;
V_46:
F_29 ( V_2 ) ;
V_37:
F_18 ( & V_11 -> V_12 , L_19 , V_50 , V_34 ) ;
return F_30 ( V_34 ) ;
}
...
{
struct V_1 * V_2 = F_9 ( V_11 ) ;
int V_51 = ( F_36 ( V_2 -> V_47 + V_52 ) == 0xffffffff ) ;
F_37 ( V_2 , V_51 ) ;
F_31 ( V_11 ) ;
return 0 ;
}
static int F_38 ( struct V_53 * V_12 )
{
struct V_1 * V_2 = F_39 ( V_12 ) ;
return F_40 ( V_2 ) ;
}
static int F_41 ( struct V_53 * V_12 )
{
struct V_1 * V_2 = F_39 ( V_12 ) ;
return F_42 ( V_2 ) ;
}
