...
F_62 ( 'i' , L_51 , & V_105 , L_52 , L_53 ) ,
F_63 ( 'v' , L_54 , & V_118 , L_55 ) ,
F_60 ( 'D' , L_56 , & V_119 , L_57 ) ,
F_61 ()
} ;
...
if ( ! V_108 )
F_66 ( V_122 , V_117 ) ;
if ( ! strncmp ( V_109 [ 0 ] , L_63 , 3 ) ) {
return F_54 ( V_108 , V_109 ) ;
} else if ( ! strncmp ( V_109 [ 0 ] , L_64 , 6 ) ) {
V_75 = & V_126 ;
if ( V_108 ) {
