...
{
struct V_12 * V_33 = F_16 ( V_5 ) ;
memcpy ( V_5 -> V_81 , & V_33 -> V_26 . V_10 . V_20 , 4 ) ;
memcpy ( V_5 -> V_82 , & V_33 -> V_26 . V_10 . V_19 , 4 ) ;
V_33 -> V_83 = 0 ;
V_33 -> V_26 . V_10 . V_41 = V_24 ;
return F_30 ( V_5 ) ;
}
static void F_31 ( struct V_84 * V_11 [] ,
struct V_51 * V_26 )
{
...
return;
if ( V_11 [ V_85 ] )
V_26 -> V_86 = F_32 ( V_11 [ V_85 ] ) ;
if ( V_11 [ V_87 ] )
V_26 -> V_10 . V_20 = F_33 ( V_11 [ V_87 ] ) ;
if ( V_11 [ V_88 ] )
V_26 -> V_10 . V_19 = F_33 ( V_11 [ V_88 ] ) ;
if ( V_11 [ V_89 ] ) {
V_26 -> V_10 . V_27 = F_34 ( V_11 [ V_89 ] ) ;
if ( V_26 -> V_10 . V_27 )
V_26 -> V_10 . V_60 = F_18 ( V_61 ) ;
}
if ( V_11 [ V_90 ] )
V_26 -> V_10 . V_91 = F_34 ( V_11 [ V_90 ] ) ;
if ( ! V_11 [ V_92 ] || F_34 ( V_11 [ V_92 ] ) )
V_26 -> V_10 . V_60 = F_18 ( V_61 ) ;
}
static int F_35 ( struct V_4 * V_93 , struct V_39 * V_5 ,
struct V_84 * V_94 [] , struct V_84 * V_11 [] )
{
struct V_51 V_52 ;
F_31 ( V_11 , & V_52 ) ;
return F_36 ( V_5 , V_94 , & V_52 ) ;
}
static int F_37 ( struct V_39 * V_5 , struct V_84 * V_94 [] ,
struct V_84 * V_11 [] )
{
struct V_51 V_52 ;
F_31 ( V_11 , & V_52 ) ;
if ( ( ( V_5 -> V_70 & V_95 ) && ! V_52 . V_10 . V_19 ) ||
( ! ( V_5 -> V_70 & V_95 ) && V_52 . V_10 . V_19 ) )
return - V_62 ;
return F_38 ( V_5 , V_94 , & V_52 ) ;
}
...
{
struct V_12 * V_33 = F_16 ( V_5 ) ;
struct V_51 * V_96 = & V_33 -> V_26 ;
if ( F_42 ( V_2 , V_85 , V_96 -> V_86 ) ||
F_43 ( V_2 , V_87 , V_96 -> V_10 . V_20 ) ||
F_43 ( V_2 , V_88 , V_96 -> V_10 . V_19 ) ||
F_44 ( V_2 , V_89 , V_96 -> V_10 . V_27 ) ||
F_44 ( V_2 , V_90 , V_96 -> V_10 . V_91 ) ||
F_44 ( V_2 , V_92 ,
! ! ( V_96 -> V_10 . V_60 & F_18 ( V_61 ) ) ) )
goto V_97;
return 0 ;
V_97:
return - V_98 ;
