...
int F_194 ( const struct V_378 * V_379 , int V_257 , int V_258 , int V_380 )
{
struct V_381 * V_111 = V_379 -> V_111 ;
...
static T_9 F_198 ( struct V_357 * V_358 , struct V_359 * V_360 ,
const char * V_192 , T_10 V_36 )
{
struct V_344 * V_346 = F_199 ( V_358 ) ;
int V_388 = F_200 ( V_192 , NULL , 0 ) ;
if ( V_388 )
F_196 ( V_346 ) ;
else
F_197 ( V_346 ) ;
...
{
struct V_344 * V_346 = F_199 ( V_358 ) ;
int V_388 = F_195 ( V_346 -> V_346 ) ;
return snprintf ( V_192 , V_389 , L_21 , V_388 ) ;
}
static T_9 F_202 ( struct V_357 * V_358 , struct V_359 * V_360 ,
char * V_192 )
{
struct V_344 * V_346 = F_199 ( V_358 ) ;
...
int F_195 ( const struct V_378 * V_379 )
{
int V_79 , V_392 = 0 ;
for ( V_79 = 0 ; V_79 < V_108 ; V_79 ++ ) {
if ( V_113 [ V_79 ] == V_379 ) {
...
static int F_212 ( const struct V_378 * V_379 , int V_257 , int V_258 )
{
struct V_381 * V_111 = V_379 -> V_111 ;
struct V_344 * V_344 ;
const char * V_347 ;
...
int F_214 ( const struct V_378 * V_379 )
{
int V_79 , V_323 = - V_382 ;
if ( F_195 ( V_379 ) )
goto V_135;
...
int F_216 ( const struct V_378 * V_379 , int V_257 , int V_258 , int V_380 )
{
int V_135 ;
V_135 = F_212 ( V_379 , V_257 , V_258 ) ;
if ( V_135 == - V_402 )
V_135 = 0 ;
if ( ! V_135 )
F_191 ( V_379 , V_257 , V_258 , V_380 ) ;
...
void F_217 ( const struct V_378 * V_379 )
{
F_71 () ;
F_214 ( V_379 ) ;
F_72 () ;
...
if ( F_228 ( V_419 , V_302 , sizeof( V_419 ) ) )
return - V_306 ;
F_71 () ;
...
F_72 () ;
if ( F_230 ( V_302 , V_419 , sizeof( V_419 ) ) )
return - V_306 ;
return 0 ;
}
...
static int F_231 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
struct V_422 V_423 ;
int V_424 = - V_156 ;
int V_9 ;
...
V_424 = V_5 -> V_16 -> F_231 ( V_5 , & V_423 ) ;
else
V_424 = - V_426 ;
F_72 () ;
if ( V_424 )
...
if ( V_421 -> V_303 && F_230 ( V_421 -> V_303 , V_423 . V_303 , V_9 ) )
V_424 = - V_306 ;
V_427:
F_58 ( V_423 . V_303 ) ;
return V_424 ;
}
static int F_232 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
struct V_422 V_423 ;
int V_424 = - V_156 ;
int V_432 ;
...
V_423 . V_303 = F_233 ( V_421 -> V_303 , V_432 ) ;
if ( F_180 ( V_423 . V_303 ) )
return F_213 ( V_423 . V_303 ) ;
F_71 () ;
if ( V_5 -> V_87 != V_284 )
V_424 = - V_156 ;
else if ( V_5 -> V_16 -> F_232 )
V_424 = V_5 -> V_16 -> F_232 ( V_5 , & V_423 , V_421 -> V_374 ) ;
else
V_424 = - V_426 ;
F_72 () ;
F_58 ( V_423 . V_303 ) ;
...
static int F_234 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
...
if ( ! V_421 -> V_303 )
V_26 = NULL ;
else if ( F_235 ( V_367 , V_421 -> V_303 , V_437 - 1 ) < 0 )
return - V_306 ;
else
V_367 [ V_437 - 1 ] = 0 ;
F_71 () ;
...
if ( V_5 -> V_16 -> F_234 )
V_424 = V_5 -> V_16 -> F_234 ( V_5 , & V_423 , V_26 ) ;
else
V_424 = - V_426 ;
F_72 () ;
if ( ! V_424 ) {
...
V_424 = V_5 -> V_16 -> F_236 ( V_5 , V_346 ) ;
F_72 () ;
return V_424 ;
}
int F_237 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
switch ( V_421 -> V_421 ) {
case V_439 :
return F_232 ( V_5 , V_421 ) ;
case V_440 :
return F_231 ( V_5 , V_421 ) ;
case V_441 :
return F_234 ( V_5 , V_421 ) ;
case V_442 :
...
unsigned short * F_239 ( struct V_4 * V_5 , int V_444 , int V_13 )
{
...
T_1 F_242 ( struct V_4 * V_5 , const T_1 * V_445 )
{
if ( ( unsigned long ) V_445 == V_5 -> V_76 && V_81 != - 1 )
return V_81 ;
return F_19 ( V_445 ) ;
}
void F_243 ( struct V_4 * V_5 , T_1 V_446 , T_1 * V_445 )
{
F_28 ( V_446 , V_445 ) ;
