...
struct V_100 * V_278 = & V_273 -> V_109 [ V_180 ] ;
V_35 += V_278 -> V_103 ;
F_34 ( V_61 , V_278 -> V_103 , V_278 -> V_104 ) ;
}
}
V_61 -> V_34 += V_274 ;
V_35 += V_274 * sizeof( struct V_279 ) ;
return V_35 ;
}
static int
F_171 (
...
if ( ! ( V_61 -> V_19 & V_66 ) )
return 0 ;
V_280 -> V_281 = F_125 ( V_61 -> V_45 ) ;
V_280 -> V_282 = V_61 -> V_283 ;
V_280 -> V_284 = 0 ;
V_280 -> V_285 = V_286 ;
V_280 -> V_287 = 0 ;
V_61 -> V_19 &= ~ V_66 ;
...
* V_300 = 0 ;
* V_301 = 0 ;
if ( V_63 -> V_212 - V_302 <= sizeof( V_265 ) ) {
F_166 ( log , V_63 , * V_261 , * V_299 ) ;
* V_261 = 0 ;
* V_299 = 0 ;
F_12 ( & log -> V_112 ) ;
...
V_273 = V_272 ;
V_278 = V_273 -> V_109 ;
while ( V_273 && ( ! V_273 -> V_108 || V_305 < V_273 -> V_108 ) ) {
void * V_307 ;
int V_302 ;
...
if ( error )
return error ;
ASSERT ( V_302 <= V_63 -> V_212 - 1 ) ;
V_307 = V_63 -> V_215 + V_302 ;
if ( ! * V_304 )
* V_304 = F_154 ( V_63 -> V_202 . V_231 ) ;
while ( V_273 && ( ! V_273 -> V_108 || V_305 < V_273 -> V_108 ) ) {
struct V_100 * V_101 ;
struct V_279 * V_280 ;
int V_308 ;
...
bool V_309 = false ;
if ( V_273 -> V_276 == V_277 ) {
ASSERT ( V_273 -> V_108 == 0 ) ;
V_309 = true ;
goto V_310;
}
V_101 = & V_278 [ V_305 ] ;
ASSERT ( V_101 -> V_103 % sizeof( V_311 ) == 0 ) ;
ASSERT ( ( unsigned long ) V_307 % sizeof( V_311 ) == 0 ) ;
V_308 = F_171 ( V_307 , V_61 ) ;
if ( V_308 ) {
V_261 ++ ;
F_176 ( & V_307 , & V_35 , & V_302 ,
V_308 ) ;
}
V_280 = F_172 ( log , V_307 , V_61 , V_64 ) ;
if ( ! V_280 )
return F_30 ( V_29 ) ;
F_176 ( & V_307 , & V_35 , & V_302 ,
sizeof( struct V_279 ) ) ;
V_35 += F_173 ( V_61 , V_280 ,
V_63 -> V_212 - V_302 ,
V_101 -> V_103 ,
& V_291 , & V_292 ,
& V_300 ,
...
F_177 ( log , V_307 ) ;
ASSERT ( V_292 >= 0 ) ;
memcpy ( V_307 , V_101 -> V_102 + V_291 , V_292 ) ;
F_176 ( & V_307 , & V_35 , & V_302 , V_292 ) ;
V_292 += V_308 + sizeof( V_265 ) ;
V_261 ++ ;
V_299 += V_306 ? V_292 : 0 ;
...
V_315 = 0 ;
do {
if ( ! ( V_314 -> V_71 & ( V_73 | V_114 ) ) ) {
V_65 = F_154 ( V_314 -> V_202 . V_231 ) ;
if ( ( V_65 && ! V_315 ) ||
( F_135 ( V_65 , V_315 ) < 0 ) ) {
V_315 = V_65 ;
}
...
log -> V_166 ,
V_333 ) ;
V_2 -> V_334 = F_125 ( log -> V_186 ) ;
V_2 -> V_231 = F_182 (
F_134 ( log -> V_186 , log -> V_335 ) ) ;
ASSERT ( log -> V_335 >= 0 ) ;
}
...
V_338 = V_63 -> V_93 ;
V_63 -> V_71 = V_74 ;
V_63 -> V_202 . V_339 = F_125 ( log -> V_185 ) ;
log -> V_185 = log -> V_335 ;
log -> V_340 = log -> V_186 ;
log -> V_335 += F_121 ( V_338 ) + F_121 ( log -> V_166 ) ;
if ( F_108 ( & log -> V_147 -> V_164 ) &&
log -> V_147 -> V_164 . V_249 > 1 ) {
T_13 V_341 = F_121 ( log -> V_147 -> V_164 . V_249 ) ;
log -> V_335 = F_193 ( log -> V_335 , V_341 ) ;
}
if ( log -> V_335 >= log -> V_184 ) {
log -> V_186 ++ ;
if ( log -> V_186 == V_204 )
log -> V_186 ++ ;
log -> V_335 -= log -> V_184 ;
...
T_4 V_353 ;
int V_354 ;
V_16 = F_202 ( V_351 , V_352 ) ;
if ( ! V_16 )
return NULL ;
V_48 += sizeof( V_265 ) ;
V_48 += sizeof( V_355 ) ;
V_48 += sizeof( V_265 ) ;
V_354 = log -> V_162 - log -> V_166 ;
V_353 = F_203 ( V_48 , V_354 ) ;
V_48 += sizeof( V_265 ) * V_353 ;
while ( ! V_353 ||
F_203 ( V_48 , V_354 ) > V_353 ) {
V_48 += sizeof( V_265 ) ;
V_353 ++ ;
}
V_48 += log -> V_166 * V_353 ;
V_48 += log -> V_166 ;
if ( F_108 ( & log -> V_147 -> V_164 ) &&
log -> V_147 -> V_164 . V_249 > 1 ) {
...
int V_358 = 0 ;
for ( V_180 = 0 ; V_180 < log -> V_159 ; V_180 ++ ) {
if ( V_307 >= log -> V_200 [ V_180 ] &&
V_307 <= log -> V_200 [ V_180 ] + log -> V_162 )
V_358 ++ ;
}
if ( ! V_358 )
...
{
int V_361 ;
if ( F_206 ( V_138 ) == log -> V_340 ) {
V_361 =
log -> V_184 - ( log -> V_185 - F_153 ( V_138 ) ) ;
if ( V_361 < F_121 ( V_63 -> V_93 ) + F_121 ( log -> V_166 ) )
F_205 ( log -> V_147 , L_92 , V_111 ) ;
} else {
ASSERT ( F_206 ( V_138 ) + 1 == log -> V_340 ) ;
if ( F_153 ( V_138 ) == log -> V_185 )
F_205 ( log -> V_147 , L_93 , V_111 ) ;
V_361 = F_153 ( V_138 ) - log -> V_185 ;
if ( V_361 < F_121 ( V_63 -> V_93 ) + 1 )
F_205 ( log -> V_147 , L_92 , V_111 ) ;
}
}
STATIC void
...
T_20 V_366 ;
T_5 V_367 ;
int V_35 , V_180 , V_227 , V_228 , V_368 ;
int V_369 ;
F_12 ( & log -> V_112 ) ;
V_364 = log -> V_92 ;
for ( V_180 = 0 ; V_180 < log -> V_159 ; V_180 ++ ) {
...
V_307 = ( V_201 ) & V_63 -> V_202 ;
for ( V_307 += V_170 ; V_307 < ( ( V_201 ) & V_63 -> V_202 ) + V_244 ;
V_307 += V_170 ) {
if ( * ( T_16 * ) V_307 == F_125 ( V_204 ) )
...
V_363 = ( V_265 * ) V_307 ;
V_366 = ( T_20 )
( ( V_201 ) & ( V_363 -> V_282 ) - V_365 ) ;
if ( ! V_362 || ( V_366 & 0x1ff ) ) {
V_367 = V_363 -> V_282 ;
} else {
V_369 = F_132 ( ( V_201 ) & ( V_363 -> V_282 ) - V_63 -> V_215 ) ;
if ( V_369 >= ( V_165 / V_170 ) ) {
V_227 = V_369 / ( V_165 / V_170 ) ;
V_228 = V_369 % ( V_165 / V_170 ) ;
V_367 = F_207 (
V_233 [ V_227 ] . V_234 . V_235 [ V_228 ] ) ;
} else {
V_367 = F_207 (
V_63 -> V_202 . V_232 [ V_369 ] ) ;
}
}
if ( V_367 != V_54 && V_367 != V_55 )
F_61 ( log -> V_147 ,
L_97 ,
V_111 , V_367 , V_363 ,
( unsigned long ) V_366 ) ;
V_366 = ( T_20 )
( ( V_201 ) & ( V_363 -> V_284 ) - V_365 ) ;
if ( ! V_362 || ( V_366 & 0x1ff ) ) {
V_368 = F_157 ( V_363 -> V_284 ) ;
} else {
V_369 = F_132 ( ( T_20 ) & V_363 -> V_284 -
( T_20 ) V_63 -> V_215 ) ;
if ( V_369 >= ( V_165 / V_170 ) ) {
V_227 = V_369 / ( V_165 / V_170 ) ;
V_228 = V_369 % ( V_165 / V_170 ) ;
V_368 = F_157 ( V_233 [ V_227 ] . V_234 . V_235 [ V_228 ] ) ;
} else {
V_368 = F_157 ( V_63 -> V_202 . V_232 [ V_369 ] ) ;
}
}
V_307 += sizeof( V_265 ) + V_368 ;
}
}
STATIC int
F_208 (
