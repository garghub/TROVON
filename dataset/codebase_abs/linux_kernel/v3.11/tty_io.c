...
goto V_51;
V_162 = F_155 ( V_203 , V_56 , V_204 , & V_3 -> V_206 ) ;
if ( V_162 <= 0 )
goto V_51;
V_205 = F_48 ( V_3 ) ;
if ( V_205 ) {
if ( V_205 -> V_42 -> V_206 )
V_205 -> V_42 -> V_206 ( V_3 , V_204 ) ;
F_49 ( V_205 ) ;
}
if ( V_204 ) {
enum V_207 type ;
...
static int F_162 ( struct V_1 * V_3 , struct V_214 T_3 * V_65 )
{
int V_215 ;
F_31 ( & V_3 -> V_216 ) ;
V_215 = F_163 ( V_65 , & V_3 -> V_214 , sizeof( * V_65 ) ) ;
F_32 ( & V_3 -> V_216 ) ;
return V_215 ? - V_137 : 0 ;
}
int F_164 ( struct V_1 * V_3 , struct V_214 * V_217 )
{
struct V_76 * V_48 ;
unsigned long V_44 ;
F_31 ( & V_3 -> V_216 ) ;
...
static int F_165 ( struct V_1 * V_3 , struct V_214 T_3 * V_65 )
{
struct V_214 V_220 ;
if ( F_96 ( & V_220 , V_65 , sizeof( * V_65 ) ) )
return - V_137 ;
if ( V_3 -> V_42 -> V_221 )
return V_3 -> V_42 -> V_221 ( V_3 , & V_220 ) ;
else
return F_164 ( V_3 , & V_220 ) ;
}
...
static int F_170 ( struct V_1 * V_3 , struct V_1 * V_225 , T_7 T_3 * V_22 )
{
struct V_76 * V_76 ;
int V_45 ;
...
static int F_173 ( struct V_1 * V_3 , struct V_1 * V_225 , T_7 T_3 * V_22 )
{
struct V_76 * V_48 ;
T_7 V_226 ;
...
F_34 ( & V_3 -> V_47 , V_44 ) ;
F_57 ( V_225 -> V_48 ) ;
V_225 -> V_48 = F_58 ( V_48 ) ;
F_36 ( & V_3 -> V_47 , V_44 ) ;
V_49:
F_177 () ;
return V_162 ;
}
static int F_178 ( struct V_1 * V_3 , struct V_1 * V_225 , T_7 T_3 * V_22 )
{
if ( V_3 == V_225 && V_46 -> signal -> V_3 != V_225 )
return - V_67 ;
if ( ! V_225 -> V_79 )
return - V_67 ;
return F_171 ( F_172 ( V_225 -> V_79 ) , V_22 ) ;
}
...
if ( F_160 ( V_205 , V_22 ) )
return - V_137 ;
V_45 = F_180 ( V_3 , V_205 ) ;
return V_45 ;
}
static int F_181 ( struct V_1 * V_3 , unsigned int V_229 )
{
int V_162 ;
...
if ( V_162 != 0 )
return V_162 ;
if ( F_163 ( V_65 , & V_247 , sizeof( V_247 ) ) )
return - V_137 ;
return 0 ;
}
...
case V_255 :
return F_162 ( V_225 , V_22 ) ;
case V_256 :
return F_165 ( V_225 , V_22 ) ;
case V_257 :
return V_225 != V_3 ? - V_227 : F_166 ( V_7 ) ;
case V_258 :
...
case V_261 :
{
int V_262 = F_47 ( V_198 , & V_3 -> V_44 ) ;
return F_171 ( V_262 , ( int T_3 * ) V_22 ) ;
}
case V_263 :
if ( V_46 -> signal -> V_3 != V_3 )
return - V_67 ;
...
case V_265 :
return F_170 ( V_3 , V_225 , V_22 ) ;
case V_66 :
return F_173 ( V_3 , V_225 , V_22 ) ;
case V_266 :
return F_178 ( V_3 , V_225 , V_22 ) ;
case V_267 :
return F_171 ( V_3 -> V_205 -> V_42 -> V_35 , ( int T_3 * ) V_22 ) ;
case V_249 :
...
case V_269 :
{
unsigned int V_45 = F_190 ( F_191 ( V_225 ) ) ;
...
if ( V_3 -> V_42 -> V_275 ) {
V_162 = ( V_3 -> V_42 -> V_275 ) ( V_3 , V_64 , V_65 ) ;
if ( V_162 != - V_276 )
return V_162 ;
}
V_69 = F_92 ( V_3 ) ;
V_162 = - V_227 ;
if ( V_69 -> V_42 -> V_275 ) {
V_162 = V_69 -> V_42 -> V_275 ( V_3 , V_7 , V_64 , V_65 ) ;
if ( V_162 == - V_276 )
V_162 = - V_67 ;
}
F_49 ( V_69 ) ;
...
static int F_195 ( const void * V_278 , struct V_7 * V_7 , unsigned V_203 )
{
if ( F_196 ( V_7 -> V_95 -> V_126 != F_90 ) )
return 0 ;
return F_6 ( V_7 ) != V_278 ? 0 : V_203 + 1 ;
}
...
F_204 ( V_22 ) ;
V_124 = F_205 ( V_22 -> V_283 , 0 , F_195 , V_3 ) ;
if ( V_124 != 0 ) {
F_19 ( V_280 L_38
L_40 ,
F_201 ( V_22 ) , V_22 -> V_281 , V_124 - 1 ) ;
F_206 ( V_282 , V_22 ) ;
}
F_207 ( V_22 ) ;
} F_208 ( V_279 , V_22 ) ;
...
static int F_211 ( struct V_30 * V_4 , const void * V_284 )
{
const T_1 * V_285 = V_284 ;
return V_4 -> V_285 == * V_285 ;
}
static struct V_30 * F_212 ( struct V_1 * V_3 )
{
T_1 V_285 = F_191 ( V_3 ) ;
return F_213 ( V_286 , NULL , & V_285 , F_211 ) ;
}
...
int F_221 ( struct V_1 * V_3 , unsigned char V_210 )
{
if ( V_3 -> V_42 -> V_289 )
return V_3 -> V_42 -> V_289 ( V_3 , V_210 ) ;
return V_3 -> V_42 -> V_96 ( V_3 , & V_210 , 1 ) ;
}
static int F_222 ( struct V_29 * V_24 , T_1 V_4 ,
unsigned int V_31 , unsigned int V_23 )
{
F_223 ( & V_24 -> V_290 [ V_31 ] , & V_201 ) ;
V_24 -> V_290 [ V_31 ] . V_163 = V_24 -> V_163 ;
return F_224 ( & V_24 -> V_290 [ V_31 ] , V_4 , V_23 ) ;
}
...
{
char V_16 [ 64 ] ;
T_1 V_285 = F_27 ( V_24 -> V_33 , V_24 -> V_34 ) + V_31 ;
...
struct V_29 * F_236 ( unsigned int V_300 , struct V_301 * V_163 ,
unsigned long V_44 )
{
struct V_29 * V_24 ;
unsigned int V_290 = 1 ;
int V_215 ;
if ( ! V_300 || ( V_44 & V_147 && V_300 > 1 ) )
return F_115 ( - V_227 ) ;
...
V_24 -> V_44 = V_44 ;
if ( ! ( V_44 & V_178 ) ) {
V_24 -> V_150 = F_237 ( V_300 , sizeof( * V_24 -> V_150 ) ,
V_2 ) ;
V_24 -> V_154 = F_237 ( V_300 , sizeof( * V_24 -> V_154 ) ,
V_2 ) ;
...
if ( ! ( V_44 & V_295 ) ) {
V_24 -> V_168 = F_237 ( V_300 , sizeof( * V_24 -> V_168 ) ,
V_2 ) ;
if ( ! V_24 -> V_168 ) {
V_215 = - V_11 ;
goto V_303;
...
V_24 -> V_290 = F_237 ( V_290 , sizeof( * V_24 -> V_290 ) , V_2 ) ;
if ( ! V_24 -> V_290 ) {
V_215 = - V_11 ;
goto V_303;
}
...
F_31 ( & V_41 ) ;
F_11 ( & V_24 -> V_310 , & V_310 ) ;
F_32 ( & V_41 ) ;
if ( ! ( V_24 -> V_44 & V_305 ) ) {
for ( V_124 = 0 ; V_124 < V_24 -> V_35 ; V_124 ++ ) {
V_308 = F_225 ( V_24 , V_124 , NULL ) ;
if ( F_149 ( V_308 ) ) {
error = F_150 ( V_308 ) ;
goto V_311;
}
...
static char * F_254 ( struct V_30 * V_4 , T_10 * V_317 )
{
if ( ! V_317 )
return NULL ;
if ( V_4 -> V_285 == F_27 ( V_184 , 0 ) ||
V_4 -> V_285 == F_27 ( V_184 , 2 ) )
* V_317 = 0666 ;
return NULL ;
}
static int T_8 F_255 ( void )
{
V_286 = F_256 ( V_318 , L_17 ) ;
if ( F_149 ( V_286 ) )
return F_150 ( V_286 ) ;
V_286 -> V_319 = F_254 ;
return 0 ;
...
struct V_320 * V_321 , char * V_15 )
{
struct V_322 * V_323 [ 16 ] ;
int V_124 = 0 ;
struct V_322 * V_324 ;
T_2 V_23 = 0 ;
F_258 () ;
...
if ( ! V_324 -> V_96 )
continue;
if ( ( V_324 -> V_44 & V_325 ) == 0 )
continue;
V_323 [ V_124 ++ ] = V_324 ;
if ( V_124 >= F_260 ( V_323 ) )
break;
}
while ( V_124 -- )
V_23 += sprintf ( V_15 + V_23 , L_46 ,
V_323 [ V_124 ] -> V_16 , V_323 [ V_124 ] -> V_31 , V_124 ? ' ' : '\n' ) ;
F_261 () ;
return V_23 ;
}
void F_262 ( void )
{
if ( V_326 )
F_263 ( & V_326 -> V_327 , NULL , L_47 ) ;
}
int T_8 F_264 ( void )
{
F_223 ( & V_328 , & V_201 ) ;
if ( F_224 ( & V_328 , F_27 ( V_184 , 0 ) , 1 ) ||
F_246 ( F_27 ( V_184 , 0 ) , 1 , L_48 ) < 0 )
F_265 ( L_49 ) ;
F_266 ( V_286 , NULL , F_27 ( V_184 , 0 ) , NULL , L_17 ) ;
F_223 ( & V_329 , & V_330 ) ;
if ( F_224 ( & V_329 , F_27 ( V_184 , 1 ) , 1 ) ||
F_246 ( F_27 ( V_184 , 1 ) , 1 , L_50 ) < 0 )
F_265 ( L_51 ) ;
V_326 = F_266 ( V_286 , NULL , F_27 ( V_184 , 1 ) , NULL ,
L_52 ) ;
if ( F_149 ( V_326 ) )
V_326 = NULL ;
else
F_112 ( F_267 ( V_326 , & V_331 ) < 0 ) ;
#ifdef F_145
F_268 ( & V_330 ) ;
#endif
return 0 ;
