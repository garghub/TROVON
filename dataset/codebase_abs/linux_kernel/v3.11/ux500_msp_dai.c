...
{
struct V_5 * V_6 = F_2 ( V_2 -> V_7 ) ;
V_2 -> V_164 = & V_6 -> V_142 -> V_164 ;
V_2 -> V_165 = & V_6 -> V_142 -> V_165 ;
V_6 -> V_142 -> V_164 . V_129 = V_6 -> V_157 ;
V_6 -> V_142 -> V_165 . V_129 = V_6 -> V_157 ;
return 0 ;
}
static int F_32 ( struct V_166 * V_167 )
{
struct V_5 * V_6 ;
int V_116 = 0 ;
F_3 ( & V_167 -> V_7 , L_37 , V_27 ,
V_167 -> V_168 ) ;
V_6 = F_33 ( & V_167 -> V_7 ,
sizeof( struct V_5 ) ,
V_169 ) ;
...
F_37 ( V_149 , ( char * ) V_167 -> V_168 , 50 ) ;
V_6 -> V_143 = F_38 ( & V_167 -> V_7 , L_40 ) ;
if ( F_35 ( V_6 -> V_143 ) ) {
...
F_40 ( & V_167 -> V_7 , V_6 ) ;
V_116 = F_41 ( & V_167 -> V_7 , & V_174 ,
& V_175 [ V_6 -> V_142 -> V_140 ] , 1 ) ;
if ( V_116 < 0 ) {
F_5 ( & V_167 -> V_7 , L_44 ,
