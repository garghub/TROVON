...
static T_5
F_27 ( struct V_74 * V_75 , struct V_11 * V_76 )
{
...
static int F_46 ( struct V_1 * V_2 , struct V_3 * V_100 ,
...
V_19 = V_104 -> V_8 ;
error = - V_109 ;
if ( ! F_48 ( V_19 -> V_110 ) || V_19 -> V_111 -> V_112 != V_113 )
goto V_93;
if ( ! ( V_3 -> V_114 & V_115 ) )
V_82 |= V_83 ;
V_4 = F_1 ( V_2 , V_3 ) ;
...
V_2 -> V_120 = NULL ;
V_2 -> V_10 = 0 ;
V_2 -> V_121 = F_50 ( V_104 ) ;
F_51 ( V_104 , V_2 -> V_121 & ~ ( V_122 | V_123 ) ) ;
...
V_54 << ( V_59 - 9 ) ) ;
F_56 ( V_2 -> V_124 , V_54 ) ;
F_57 ( V_125 [ V_2 -> V_99 ] , V_4 ) ;
F_58 ( V_102 , V_4 << 9 ) ;
F_59 ( V_102 , V_2 -> V_118 ) ;
F_60 ( F_36 , V_2 , L_6 , V_2 -> V_99 ) ;
F_61 ( & V_2 -> V_97 ) ;
return 0 ;
V_93:
F_62 ( V_105 ) ;
...
static int F_63 ( struct V_1 * V_2 , struct V_101 * V_102 ,
int V_70 )
{
...
static int F_66 ( struct V_101 * V_102 , T_6 V_130 )
{
...
static int F_68 ( struct V_101 * V_102 , T_6 V_130 ,
...
static enum V_145 F_72 ( struct V_19 * V_100 , struct V_3 * V_3 ,
unsigned int V_136 , unsigned long V_137 ,
...
V_2 = V_153 ;
V_148 = F_73 ( V_156 , V_2 -> V_99 ) ;
if ( F_74 ( ( long ) F_75 ( V_148 ) , ( long * ) V_137 ) )
GOTO ( V_93 , V_79 = - V_144 ) ;
V_102 = F_76 ( V_148 , V_3 -> V_114 , NULL ) ;
if ( F_39 ( V_102 ) )
GOTO ( V_93 , V_79 = F_40 ( V_102 ) ) ;
F_77 ( V_3 ) ;
V_79 = F_46 ( V_2 , NULL , V_102 , V_3 ) ;
if ( V_79 ) {
F_65 ( V_3 ) ;
F_69 ( V_102 , 0 ) ;
}
...
F_26 ( V_163 , L_11 ,
V_156 , V_154 ) ;
V_149 = F_83 ( F_72 , 2 , V_160 ) ;
if ( V_149 == NULL )
goto V_164;
F_84 ( V_155 , V_154 * sizeof( * V_155 ) ) ;
if ( ! V_155 )
goto V_164;
F_84 ( V_125 , V_154 * sizeof( * V_125 ) ) ;
if ( ! V_125 )
goto V_165;
...
V_168:
while ( V_27 -- )
F_92 ( V_155 [ V_27 ] . V_124 ) ;
V_27 = V_154 ;
V_166:
while ( V_27 -- )
F_93 ( V_125 [ V_27 ] ) ;
F_94 ( V_125 , V_154 * sizeof( * V_125 ) ) ;
V_165:
F_94 ( V_155 , V_154 * sizeof( * V_155 ) ) ;
V_164:
F_95 ( V_156 , L_10 ) ;
F_96 ( V_149 ) ;
F_29 ( L_12 ) ;
