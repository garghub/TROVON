...
struct V_1 * V_2 ;
T_1 V_42 ;
V_2 = F_22 ( & V_41 -> V_19 , sizeof( * V_2 ) , V_43 ) ;
if ( ! V_2 )
return - V_44 ;
...
V_2 -> V_46 = F_25 ( V_41 , V_47 , 0 ) ;
if ( ! V_2 -> V_46 ) {
F_24 ( & V_41 -> V_19 , L_2 ) ;
return - V_45 ;
}
V_2 -> V_46 = F_26 ( & V_41 -> V_19 , V_2 -> V_46 -> V_48 ,
F_27 ( V_2 -> V_46 ) , V_41 -> V_49 ) ;
if ( ! V_2 -> V_46 ) {
F_24 ( & V_41 -> V_19 , L_3 ) ;
return - V_50 ;
}
V_2 -> V_4 = F_28 ( & V_41 -> V_19 , V_2 -> V_46 -> V_48 ,
F_27 ( V_2 -> V_46 ) ) ;
if ( ! V_2 -> V_4 ) {
F_24 ( & V_41 -> V_19 , L_4 ) ;
return - V_50 ;
...
V_11 = F_35 ( & V_41 -> V_19 , V_2 -> V_32 , F_18 , 0 ,
V_41 -> V_49 , V_2 ) ;
if ( V_11 ) {
