...
static int F_120 ( struct V_148 * V_148 , void * V_201 ,
enum V_282 type )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
if ( type == V_141 ) {
F_51 ( V_2 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_247 , V_283 , 1 ) ;
}
if ( V_109 -> type == V_141 ) {
...
static int F_123 ( struct V_148 * V_148 , void * V_201 ,
enum V_282 type )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
V_2 -> V_98 = 0 ;
F_80 ( & V_2 -> V_99 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_247 , V_283 , 0 ) ;
V_53 = F_56 ( V_2 ) ;
if ( V_53 != 0 )
return V_53 ;
for ( V_31 = 0 ; V_31 < V_239 ; V_31 ++ ) {
...
static int F_130 ( struct V_148 * V_148 , void * V_201 ,
struct V_287 * V_288 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
static int F_134 ( struct V_148 * V_148 , void * V_201 , struct V_289 * V_290 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
int V_53 ;
...
static int F_136 ( struct V_148 * V_148 , void * V_201 , struct V_289 * V_290 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
int V_53 ;
...
if ( V_109 -> type == V_141 )
V_53 = F_137 ( & V_109 -> V_161 , V_290 , V_148 -> V_181 & V_182 ) ;
else if ( V_109 -> type == V_143 )
V_53 = F_137 ( & V_109 -> V_164 , V_290 , V_148 -> V_181 & V_182 ) ;
return V_53 ;
}
