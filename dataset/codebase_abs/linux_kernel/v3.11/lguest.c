...
if ( F_89 ( V_213 -> V_19 , V_217 , V_42 ) != V_217 )
F_9 ( 1 , L_72 , V_106 . V_218 ) ;
V_215 = F_42 ( V_213 -> V_19 , V_2 + V_85 , V_86 ) ;
if ( V_215 >= 0 ) {
...
struct V_212 * V_213 ;
struct V_227 V_149 ;
V_11 = F_75 ( L_76 , V_228 ) ;
F_71 ( V_11 , V_153 , F_88 ) ;
V_213 = V_11 -> V_99 = malloc ( sizeof( * V_213 ) ) ;
V_213 -> V_19 = F_7 ( V_226 , V_69 | V_229 ) ;
V_213 -> V_7 = F_89 ( V_213 -> V_19 , 0 , V_230 ) ;
F_73 ( V_11 , V_231 ) ;
V_149 . V_232 = F_93 ( V_213 -> V_7 / 512 ) ;
F_73 ( V_11 , V_233 ) ;
V_149 . V_234 = F_94 ( V_153 - 2 ) ;
F_74 ( V_11 , F_95 ( struct V_227 , V_235 ) , & V_149 ) ;
F_21 ( L_77 ,
++ V_128 . V_154 , F_96 ( V_149 . V_232 ) ) ;
}
...
while ( ( V_243 = F_100 ( V_240 , V_241 , L_87 , V_251 , NULL ) ) != V_252 ) {
switch ( V_243 ) {
case 'v' :
F_21 = true ;
break;
...
V_268 = V_246 -> V_270 ;
V_269 = V_246 -> V_271 ;
if ( F_104 ( V_246 -> V_272 , V_269 ) != 0 )
F_9 ( 1 , L_95 ) ;
if ( F_105 ( V_269 , V_269 , V_269 ) != 0 )
F_9 ( 1 , L_96 ) ;
if ( F_106 ( V_268 , V_268 , V_268 ) != 0 )
F_9 ( 1 , L_97 ) ;
F_21 ( L_98 ) ;
}
F_107 () ;
