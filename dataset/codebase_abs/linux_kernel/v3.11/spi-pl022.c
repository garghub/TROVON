...
static int F_83 ( struct V_194 * V_17 )
{
struct V_2 * V_2 = F_79 ( V_17 ) ;
F_11 ( ( F_12 ( F_13 ( V_2 -> V_23 ) ) &
( ~ V_24 ) ) , F_13 ( V_2 -> V_23 ) ) ;
...
static inline T_1 F_88 ( T_1 V_224 , V_61 V_225 , V_61 V_226 )
{
return V_224 / ( V_225 * ( 1 + V_226 ) ) ;
}
static int F_89 ( struct V_2 * V_2 , int V_227 , struct
V_228 * V_229 )
{
V_61 V_225 = V_230 , V_226 = V_231 ;
T_1 V_224 , V_232 , V_233 , V_234 = 0 , V_235 = 0 ,
V_236 = 0 , V_237 , V_238 = 0 ;
V_224 = F_90 ( V_2 -> V_239 ) ;
V_232 = F_88 ( V_224 , V_230 , V_231 ) ;
V_233 = F_88 ( V_224 , V_240 , V_241 ) ;
if ( V_227 > V_232 )
F_71 ( & V_2 -> V_27 -> V_28 ,
L_44 ,
V_232 , V_227 ) ;
...
static int F_92 ( struct V_242 * V_18 )
{
struct V_201 const * V_202 ;
struct V_201 V_243 ;
struct V_32 * V_33 ;
...
V_33 = F_80 ( V_18 ) ;
if ( V_33 == NULL ) {
V_33 = F_93 ( sizeof( struct V_32 ) , V_164 ) ;
if ( ! V_33 ) {
F_62 ( & V_18 -> V_28 ,
L_49 ) ;
return - V_155 ;
...
T_1 V_259 ;
if ( V_2 -> V_34 -> V_42 ) {
F_95 ( V_33 -> V_37 , V_202 -> V_260 ,
V_261 , 13 ) ;
} else {
F_95 ( V_33 -> V_36 , V_202 -> V_221 ,
V_262 , 5 ) ;
F_95 ( V_33 -> V_36 , V_202 -> V_215 ,
V_263 , 16 ) ;
F_95 ( V_33 -> V_36 , V_202 -> V_203 ,
V_264 , 21 ) ;
F_95 ( V_33 -> V_37 , V_202 -> V_218 ,
V_265 , 6 ) ;
}
F_95 ( V_33 -> V_36 , V_244 - 1 ,
V_266 , 0 ) ;
if ( V_18 -> V_267 & V_268 ) {
V_237 = V_269 ;
V_259 = V_270 ;
...
F_95 ( V_33 -> V_37 , V_237 , V_273 , 4 ) ;
F_95 ( V_33 -> V_37 , V_259 , V_274 , 5 ) ;
F_95 ( V_33 -> V_37 , V_202 -> V_123 ,
V_275 , 7 ) ;
F_95 ( V_33 -> V_37 , V_202 -> V_130 ,
V_276 , 10 ) ;
} else {
F_95 ( V_33 -> V_36 , V_244 - 1 ,
V_277 , 0 ) ;
...
V_237 = V_281 ;
F_95 ( V_33 -> V_36 , V_237 , V_282 , 6 ) ;
if ( V_18 -> V_267 & V_283 )
V_237 = V_284 ;
else
V_237 = V_285 ;
F_95 ( V_33 -> V_36 , V_237 , V_286 , 7 ) ;
F_95 ( V_33 -> V_36 , V_229 . V_226 , V_287 , 8 ) ;
if ( V_2 -> V_34 -> V_288 ) {
if ( V_18 -> V_267 & V_289 )
V_237 = V_290 ;
else
V_237 = V_291 ;
F_95 ( V_33 -> V_37 , V_237 , V_292 , 0 ) ;
}
F_95 ( V_33 -> V_37 , V_293 , V_24 , 1 ) ;
F_95 ( V_33 -> V_37 , V_202 -> V_208 , V_294 , 2 ) ;
F_95 ( V_33 -> V_37 , V_202 -> V_295 , V_296 ,
3 ) ;
F_96 ( V_18 , V_33 ) ;
return V_184 ;
V_252:
...
static void F_97 ( struct V_242 * V_18 )
{
...
V_298 = F_99 ( V_28 , sizeof( struct V_297 ) , V_164 ) ;
if ( ! V_298 ) {
F_62 ( V_28 , L_71 ) ;
return NULL ;
}
V_298 -> V_299 = - 1 ;
V_298 -> V_186 = 1 ;
F_94 ( V_247 , L_72 , & V_237 ) ;
V_298 -> V_300 = V_237 ;
F_94 ( V_247 , L_73 ,
& V_298 -> V_200 ) ;
V_298 -> V_301 = F_100 ( V_247 , L_74 ) ;
return V_298 ;
}
static int F_101 ( struct V_302 * V_27 , const struct V_303 * V_304 )
{
...
V_17 = F_103 ( V_28 , sizeof( struct V_2 ) ) ;
if ( V_17 == NULL ) {
F_62 ( & V_27 -> V_28 , L_78 ) ;
return - V_155 ;
}
...
V_2 -> V_27 = V_27 ;
V_2 -> V_34 = V_304 -> V_84 ;
V_2 -> V_196 = F_99 ( V_28 , V_307 * sizeof( int ) ,
V_164 ) ;
F_104 ( V_28 ) ;
V_17 -> V_310 = V_305 -> V_299 ;
V_17 -> V_300 = V_307 ;
V_17 -> V_311 = F_97 ;
V_17 -> V_312 = F_92 ;
V_17 -> V_313 = F_81 ;
...
for ( V_87 = 0 ; V_87 < V_307 ; V_87 ++ ) {
int V_316 = F_105 ( V_247 , L_79 , V_87 ) ;
if ( V_316 == - V_317 ) {
V_184 = - V_317 ;
goto V_318;
}
V_2 -> V_196 [ V_87 ] = V_316 ;
if ( F_4 ( V_316 ) ) {
if ( F_106 ( V_28 , V_316 , L_80 ) )
F_62 ( & V_27 -> V_28 ,
L_81 ,
V_316 ) ;
else if ( F_107 ( V_316 , 1 ) )
F_62 ( & V_27 -> V_28 ,
L_82 ,
V_316 ) ;
}
...
V_17 -> V_319 = V_279 | V_283 | V_320 | V_289 ;
if ( V_2 -> V_34 -> V_35 )
V_17 -> V_319 |= V_268 ;
F_15 ( & V_27 -> V_28 , L_83 , V_17 -> V_310 ) ;
V_184 = F_108 ( V_27 , NULL ) ;
if ( V_184 )
goto V_321;
V_2 -> V_105 = V_27 -> V_322 . V_323 ;
V_2 -> V_23 = F_109 ( V_28 , V_27 -> V_322 . V_323 ,
F_110 ( & V_27 -> V_322 ) ) ;
if ( V_2 -> V_23 == NULL ) {
V_184 = - V_155 ;
goto V_324;
...
F_111 ( V_325 L_84 ,
V_27 -> V_322 . V_323 , V_2 -> V_23 ) ;
V_2 -> V_239 = F_112 ( & V_27 -> V_28 , NULL ) ;
if ( F_113 ( V_2 -> V_239 ) ) {
V_184 = F_114 ( V_2 -> V_239 ) ;
F_62 ( & V_27 -> V_28 , L_85 ) ;
goto V_326;
}
...
F_13 ( V_2 -> V_23 ) ) ;
F_25 ( V_2 ) ;
V_184 = F_118 ( V_28 , V_27 -> V_166 [ 0 ] , F_68 ,
0 , L_88 , V_2 ) ;
if ( V_184 < 0 ) {
...
static void F_132 ( struct V_2 * V_2 , bool V_331 )
{
F_123 ( V_2 -> V_239 ) ;
if ( V_331 )
F_133 ( & V_2 -> V_27 -> V_28 ) ;
...
static void F_135 ( struct V_2 * V_2 , bool V_331 )
{
F_104 ( & V_2 -> V_27 -> V_28 ) ;
if ( ! V_331 )
F_133 ( & V_2 -> V_27 -> V_28 ) ;
...
static int F_136 ( struct V_76 * V_28 )
{
struct V_2 * V_2 = F_137 ( V_28 ) ;
int V_113 ;
...
static int F_141 ( struct V_76 * V_28 )
{
struct V_2 * V_2 = F_137 ( V_28 ) ;
F_132 ( V_2 , true ) ;
return 0 ;
}
static int F_142 ( struct V_76 * V_28 )
{
struct V_2 * V_2 = F_137 ( V_28 ) ;
F_135 ( V_2 , true ) ;
return 0 ;
