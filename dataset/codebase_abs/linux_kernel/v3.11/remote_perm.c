...
int F_23 ( struct V_33 * V_33 , struct V_34 * V_35 )
{
struct V_15 * V_16 = F_24 ( V_33 ) ;
struct V_1 * V_2 = NULL , * V_36 = NULL ;
struct V_6 * V_18 , * V_37 = NULL ;
V_21 ;
F_25 ( F_26 ( V_33 ) -> V_38 & V_39 ) ;
#if 0
...
int F_30 ( struct V_33 * V_33 , int V_17 )
{
struct V_15 * V_16 = F_24 ( V_33 ) ;
struct V_48 * V_49 = F_26 ( V_33 ) ;
...
V_53 = F_35 ( V_33 ) ;
V_20 = F_36 ( V_49 -> V_56 , F_37 ( V_33 ) , V_53 ,
F_38 ( V_33 ) , & V_51 ) ;
F_39 ( V_53 ) ;
if ( V_20 ) {
F_33 ( & V_16 -> V_55 ) ;
