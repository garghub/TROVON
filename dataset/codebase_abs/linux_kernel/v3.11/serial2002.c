...
V_79 -> V_91 = 0 ;
F_21 ( V_79 -> V_87 ) ;
V_87 = F_22 ( sizeof( unsigned int ) * V_79 -> V_90 , V_92 ) ;
if ( ! V_87 )
return - V_93 ;
V_79 -> V_87 = V_87 ;
F_21 ( V_79 -> V_86 ) ;
...
if ( ! V_81 )
continue;
V_81 [ V_66 ] . V_70 = F_25 ( V_74 . V_73 ) ;
switch ( F_28 ( V_74 . V_73 ) ) {
case V_116 :
