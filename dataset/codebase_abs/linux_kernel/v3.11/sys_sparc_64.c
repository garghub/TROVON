...
T_2 V_25 ;
if ( F_6 ( V_29 ) ) {
V_58 -> V_62 &= 0xffffffff ;
V_58 -> V_63 &= 0xffffffff ;
}
#ifdef F_25
F_21 ( L_2 , V_58 -> V_62 , V_58 -> V_63 ) ;
#endif
V_25 . V_64 = V_65 ;
V_25 . V_66 = 0 ;
V_25 . V_67 = V_68 ;
V_25 . V_69 = ( void V_70 * ) V_58 -> V_62 ;
V_25 . V_71 = 0 ;
F_26 ( V_65 , & V_25 , V_18 ) ;
#ifdef F_25
F_21 ( L_3 , V_58 -> V_62 , V_58 -> V_63 ) ;
#endif
}
T_1 long F_27 ( unsigned long V_72 ,
struct V_57 * V_58 )
{
if ( V_72 >= 3 )
return - V_28 ;
V_58 -> V_73 = ( V_58 -> V_73 & ~ V_74 ) | ( V_72 << 14 ) ;
return 0 ;
}
T_1 long F_28 ( void )
{
