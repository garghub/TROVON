...
static T_7 F_108 ( int V_173 , void * V_187 )
{
...
T_2 V_202 , void T_8 * V_203 , T_2 V_98 )
{
struct V_11 * V_12 = F_111 ( V_195 ) ;
char * V_204 ;
...
T_2 V_202 , void T_8 * V_207 , T_2 V_98 )
{
struct V_11 * V_12 = F_111 ( V_195 ) ;
char * V_204 ;
if ( F_113 ( V_202 + V_98 > V_201 / 4 ) )
...
static int F_150 ( struct V_157 * V_158 ,
struct V_11 * V_12 )
{
struct V_255 * V_192 ;
int V_137 ;
...
V_137 = F_164 ( V_274 [ V_6 ] , V_253 [ V_6 ] , V_275 ,
...
strcpy ( V_158 -> V_277 , V_12 -> V_83 ) ;
sprintf ( V_158 -> V_278 , L_78 ,
V_158 -> V_277 , V_12 -> V_174 , V_12 -> V_173 ) ;
