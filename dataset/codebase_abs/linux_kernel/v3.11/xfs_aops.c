...
unsigned int V_146 )
{
F_112 ( V_1 -> V_124 -> V_147 , V_1 , V_62 ,
V_146 ) ;
F_113 ( V_1 , V_62 , V_146 ) ;
}
STATIC void
F_114 (
struct V_1 * V_1 )
{
struct V_9 * V_9 = V_1 -> V_124 -> V_147 ;
struct V_10 * V_11 = F_6 ( V_9 ) ;
struct V_4 * V_5 , * V_6 ;
T_3 V_62 = F_97 ( V_1 ) ;
if ( ! F_93 ( V_1 , V_84 ) )
...
if ( ! F_4 ( V_5 ) )
goto V_151;
V_150 = F_47 ( V_11 -> V_14 , V_62 ) ;
error = F_116 ( V_11 , V_150 , 1 ) ;
if ( error ) {
if ( ! F_36 ( V_11 -> V_14 ) ) {
F_115 ( V_11 -> V_14 ,
L_2 ) ;
...
struct V_4 * V_5 , * V_6 ;
struct V_63 V_64 ;
T_1 * V_18 = NULL , * V_152 = NULL ;
T_3 V_62 ;
unsigned int type ;
T_10 V_129 ;
T_9 V_153 , V_154 ;
T_4 V_131 ;
int V_155 , V_156 = 0 , V_133 = 1 ;
int V_66 = 0 ;
int V_65 = 0 ;
F_118 ( V_9 , V_1 , 0 , 0 ) ;
ASSERT ( F_94 ( V_1 ) ) ;
if ( F_119 ( ( V_157 -> V_158 & ( V_159 | V_160 ) ) ==
V_159 ) )
goto V_161;
if ( F_120 ( V_157 -> V_158 & V_44 ) )
goto V_161;
V_62 = F_121 ( V_9 ) ;
V_153 = V_62 >> V_162 ;
V_154 = ( V_62 - 1 ) >> V_162 ;
if ( V_1 -> V_134 >= V_153 ) {
unsigned V_163 = V_62 & ( V_137 - 1 ) ;
if ( V_1 -> V_134 >= V_153 + 1 || V_163 == 0 )
goto V_161;
F_122 ( V_1 , V_163 , V_137 ) ;
}
V_129 = F_99 (unsigned long long,
(xfs_off_t)(page->index + 1) << PAGE_CACHE_SHIFT,
offset) ;
...
if ( V_156 )
V_156 = F_54 ( V_9 , & V_64 , V_62 ) ;
if ( ! V_156 ) {
V_164 = 1 ;
V_155 = F_43 ( V_9 , V_62 , & V_64 , type ,
V_65 ) ;
if ( V_155 )
goto error;
V_156 = F_54 ( V_9 , & V_64 , V_62 ) ;
...
if ( F_36 ( V_13 ) )
return - F_44 ( V_57 ) ;
V_62 = ( T_6 ) V_168 << V_9 -> V_67 ;
ASSERT ( V_169 -> V_107 >= ( 1 << V_9 -> V_67 ) ) ;
V_173 = V_169 -> V_107 ;
if ( ! V_170 && V_171 && V_62 >= F_121 ( V_9 ) )
return 0 ;
if ( V_170 && ! V_171 ) {
V_172 = V_46 ;
F_24 ( V_11 , V_172 ) ;
...
ASSERT ( V_62 <= V_13 -> V_81 -> V_82 ) ;
if ( V_62 + V_173 > V_13 -> V_81 -> V_82 )
V_173 = V_13 -> V_81 -> V_82 - V_62 ;
V_69 = F_46 ( V_13 , ( V_83 ) V_62 + V_173 ) ;
V_68 = F_47 ( V_13 , V_62 ) ;
error = F_48 ( V_11 , V_68 , V_69 - V_68 ,
& V_64 , & V_72 , V_71 ) ;
if ( error )
...
V_174 = 1 ;
error = F_135 ( V_11 , V_62 , V_173 , & V_64 ) ;
if ( error )
goto V_175;
F_26 ( V_11 , V_172 ) ;
}
F_136 ( V_11 , V_62 , V_173 , 0 , & V_64 ) ;
} else if ( V_72 ) {
F_137 ( V_11 , V_62 , V_173 , 0 , & V_64 ) ;
F_26 ( V_11 , V_172 ) ;
} else {
F_138 ( V_11 , V_62 , V_173 ) ;
goto V_175;
}
if ( V_64 . V_85 != V_86 &&
V_64 . V_85 != V_87 ) {
if ( V_170 || ! F_139 ( & V_64 ) )
F_86 ( V_9 , V_169 , & V_64 , V_62 ) ;
if ( V_170 && F_139 ( & V_64 ) ) {
if ( V_171 )
V_169 -> V_21 = V_9 ;
F_140 ( V_169 ) ;
...
if ( V_171 || V_173 > ( 1 << V_9 -> V_67 ) ) {
T_6 V_176 ;
V_176 = V_64 . V_88 + V_64 . V_89 - V_168 ;
V_176 <<= V_9 -> V_67 ;
ASSERT ( V_176 > 0 ) ;
if ( V_176 > V_173 )
V_176 = V_173 ;
...
int V_170 )
{
return F_131 ( V_9 , V_168 , V_169 , V_170 , 0 ) ;
}
STATIC int
F_145 (
struct V_9 * V_9 ,
...
int V_170 )
{
return F_131 ( V_9 , V_168 , V_169 , V_170 , 1 ) ;
}
STATIC void
F_146 (
struct V_178 * V_179 ,
...
bool V_182 )
{
struct V_29 * V_18 = V_179 -> V_180 ;
if ( V_62 + V_173 > F_121 ( V_18 -> V_25 ) )
F_147 ( V_18 -> V_25 , V_62 + V_173 ) ;
V_179 -> V_180 = NULL ;
V_18 -> V_30 = V_62 ;
V_18 -> V_31 = V_173 ;
V_18 -> V_24 = V_179 ;
...
unsigned long V_186 )
{
struct V_9 * V_9 = V_179 -> V_187 -> V_188 -> V_147 ;
struct V_8 * V_189 = F_5 ( V_9 ) ;
struct V_29 * V_18 = NULL ;
T_4 V_181 ;
if ( V_183 & V_101 ) {
T_12 V_173 = F_149 ( V_185 , V_186 ) ;
V_179 -> V_180 = V_18 = F_39 ( V_9 , V_190 ) ;
if ( V_62 + V_173 > F_6 ( V_9 ) -> V_32 . V_33 )
V_18 -> V_53 = 1 ;
V_181 = F_150 ( V_183 , V_179 , V_9 , V_189 , V_185 ,
V_62 , V_186 ,
F_145 ,
F_146 , NULL , 0 ) ;
if ( V_181 != - V_191 && V_179 -> V_180 )
goto V_192;
} else {
V_181 = F_150 ( V_183 , V_179 , V_9 , V_189 , V_185 ,
V_62 , V_186 ,
...
T_5 V_69 ;
int error ;
V_150 = F_46 ( V_11 -> V_14 , V_193 ) ;
V_69 = F_46 ( V_11 -> V_14 , V_194 ) ;
if ( V_69 <= V_150 )
return;
F_24 ( V_11 , V_46 ) ;
error = F_116 ( V_11 , V_150 ,
V_69 - V_150 ) ;
if ( error ) {
if ( ! F_36 ( V_11 -> V_14 ) ) {
F_115 ( V_11 -> V_14 ,
...
if ( ! V_1 )
return - V_207 ;
V_205 = F_156 ( V_1 , V_195 , V_131 , F_144 ) ;
if ( F_157 ( V_205 ) ) {
struct V_9 * V_9 = V_124 -> V_147 ;
F_152 ( V_9 , V_1 , V_195 , V_131 ) ;
F_76 ( V_1 ) ;
if ( V_195 + V_131 > F_121 ( V_9 ) )
F_158 ( V_9 , V_195 + V_131 , F_121 ( V_9 ) ) ;
F_159 ( V_1 ) ;
V_1 = NULL ;
}
* V_203 = V_1 ;
...
int V_181 ;
ASSERT ( V_131 <= V_137 ) ;
V_181 = F_161 ( V_202 , V_124 , V_195 , V_131 , V_208 , V_1 , V_204 ) ;
if ( F_157 ( V_181 < V_131 ) ) {
struct V_9 * V_9 = V_124 -> V_147 ;
T_12 V_45 = F_121 ( V_9 ) ;
T_3 V_201 = V_195 + V_131 ;
if ( V_201 > V_45 ) {
F_158 ( V_9 , V_201 , V_45 ) ;
F_151 ( V_9 , V_45 , V_201 ) ;
}
}
return V_181 ;
}
...
T_7 V_209 )
{
struct V_9 * V_9 = (struct V_9 * ) V_124 -> V_147 ;
struct V_10 * V_11 = F_6 ( V_9 ) ;
F_163 ( F_6 ( V_9 ) ) ;
F_24 ( V_11 , V_210 ) ;
F_164 ( V_124 ) ;
F_26 ( V_11 , V_210 ) ;
return F_165 ( V_124 , V_209 , F_144 ) ;
}
STATIC int
F_166 (
struct V_202 * V_211 ,
...
unsigned V_213 )
{
return F_169 ( V_124 , V_145 , V_213 , F_144 ) ;
}
