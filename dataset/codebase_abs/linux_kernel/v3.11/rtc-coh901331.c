...
static int T_3 F_19 ( struct V_26 * V_27 )
{
int V_28 ;
struct V_3 * V_4 ;
struct V_29 * V_30 ;
...
if ( ! V_4 )
return - V_32 ;
V_30 = F_21 ( V_27 , V_33 , 0 ) ;
if ( ! V_30 )
return - V_34 ;
V_4 -> V_35 = V_30 -> V_36 ;
V_4 -> V_37 = F_22 ( V_30 ) ;
if ( F_23 ( & V_27 -> V_13 , V_4 -> V_35 , V_4 -> V_37 ,
L_1 ) == NULL )
return - V_38 ;
V_4 -> V_6 = F_24 ( & V_27 -> V_13 , V_4 -> V_35 , V_4 -> V_37 ) ;
if ( ! V_4 -> V_6 )
return - V_32 ;
V_4 -> V_1 = F_25 ( V_27 , 0 ) ;
if ( F_26 ( & V_27 -> V_13 , V_4 -> V_1 , F_1 , 0 ,
L_2 , V_4 ) )
return - V_39 ;
V_4 -> V_5 = F_27 ( & V_27 -> V_13 , NULL ) ;
if ( F_28 ( V_4 -> V_5 ) ) {
V_28 = F_29 ( V_4 -> V_5 ) ;
F_30 ( & V_27 -> V_13 , L_3 ) ;
return V_28 ;
