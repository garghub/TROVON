...
V_9 = F_5 ( V_2 , & V_8 ) ;
if ( V_9 < 0 )
F_2 ( & V_2 -> V_15 , L_2 , V_17 , V_9 ) ;
return V_9 ;
}
int F_6 ( struct V_18 * V_19 , const void * V_3 ,
...
int F_7 ( struct V_18 * V_19 , void * V_3 ,
const unsigned int V_4 , const unsigned int V_20 )
{
struct V_1 * V_2 = V_19 -> V_2 ;
T_1 V_21 = V_4 / V_20 ;
...
static int F_8 ( struct V_1 * V_27 )
{
int V_9 ;
struct V_18 * V_19 = F_9 ( V_27 -> V_15 . V_28 , struct V_18 ,
V_29 . V_28 ) ;
V_27 -> V_30 = 32 ;
V_9 = F_10 ( V_27 ) ;
if ( V_9 < 0 ) {
