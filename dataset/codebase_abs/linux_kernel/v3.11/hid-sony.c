...
V_78 -> V_82 = V_80 ;
F_22 ( V_2 , 0x00 ) ;
V_87 = strlen ( F_31 ( & V_2 -> V_43 ) ) + strlen ( L_7 ) + 1 ;
for ( V_81 = 0 ; V_81 < 4 ; V_81 ++ ) {
V_75 = F_30 ( sizeof( struct V_74 ) + V_87 , V_60 ) ;
if ( ! V_75 ) {
F_19 ( V_2 , L_8 , V_81 ) ;
goto V_89;
}
V_88 = ( void * ) ( & V_75 [ 1 ] ) ;
snprintf ( V_88 , V_87 , L_9 , F_31 ( & V_2 -> V_43 ) , V_81 + 1 ) ;
V_75 -> V_88 = V_88 ;
V_75 -> V_90 = 0 ;
V_75 -> V_91 = 1 ;
V_75 -> V_92 = F_27 ;
V_75 -> V_93 = F_25 ;
if ( F_32 ( & V_2 -> V_43 , V_75 ) ) {
F_19 ( V_2 , L_10 , V_81 ) ;
F_20 ( V_75 ) ;
goto V_89;
}
...
static int F_35 ( struct V_1 * V_2 , const struct V_94 * V_95 )
{
int V_50 ;
unsigned long V_25 = V_95 -> V_96 ;
struct V_23 * V_24 ;
unsigned int V_97 = V_98 ;
V_24 = F_30 ( sizeof( * V_24 ) , V_60 ) ;
if ( V_24 == NULL ) {
F_19 ( V_2 , L_11 ) ;
return - V_61 ;
}
