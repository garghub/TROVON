...
V_67 . V_122 = 1 ;
V_67 . V_108 = 1 ;
F_56 ( V_2 , V_172 , V_198 -> V_95 , & V_67 , V_175 ) ;
...
static int F_63 ( struct V_96 * V_192 , struct V_171 * V_172 )
{
struct V_203 V_67 ;
memset ( & V_67 , 0 , sizeof( V_67 ) ) ;
V_67 . V_95 = V_100 ;
V_67 . V_174 = V_172 ? V_175 : V_204 ;
V_67 . V_67 . V_107 = V_70 ;
V_67 . V_67 . V_122 = 4096 ;
V_67 . V_67 . V_108 = 4096 ;
F_62 ( V_192 , V_172 , & V_67 ) ;
return 0 ;
}
...
struct V_93 * V_67 ;
V_67 = & V_2 -> V_105 [ V_100 ] ;
V_2 -> V_209 . V_131 = V_67 -> V_122 ;
V_2 -> V_209 . V_134 = V_67 -> V_108 ;
V_2 -> V_209 . V_139 = 0 ;
F_46 ( V_2 , & V_2 -> V_209 ) ;
F_69 ( V_4 , V_210 ) ;
F_1 ( V_2 ) ;
...
const struct V_94 * V_216 ,
const struct V_94 * V_217 , T_2 V_218 )
{
...
if ( V_35 < 0 )
goto V_245;
V_35 = F_88 ( & V_2 -> V_137 . V_213 . V_101 , 0 ,
