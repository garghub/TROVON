...
if ( V_97 == NULL )
return NULL ;
V_106 = F_31 ( V_131 * sizeof( struct V_104 * ) , V_66 ) ;
if ( V_106 == NULL ) {
F_25 ( V_97 ) ;
return NULL ;
}
...
T_5
F_66 ( struct V_143 * V_144 , T_7 V_145 )
{
struct V_146 * V_147 = F_67 ( V_144 ) ;
T_8 V_82 ;
V_82 = V_145 - V_147 -> V_148 ;
F_68 ( V_82 , V_147 -> V_149 ) ;
V_82 += V_147 -> V_150 ;
return F_68 ( V_82 , V_147 -> V_57 -> V_114 ) ;
}
T_5
F_69 ( struct V_143 * V_144 , T_5 V_117 )
{
return F_67 ( V_144 ) -> V_57 -> V_65 [ V_117 ] ;
}
struct V_151 *
...
{
F_75 () ;
F_76 ( V_157 , & V_2 -> V_156 ) ;
F_77 () ;
F_78 ( & V_2 -> V_156 , V_157 ) ;
}
struct V_1 *
F_79 ( struct V_143 * V_144 , T_5 V_160 )
{
struct V_56 * V_57 = F_67 ( V_144 ) -> V_57 ;
struct V_1 * V_2 = V_57 -> V_62 [ V_160 ] ;
struct V_123 * V_161 = F_80 ( V_144 ) ;
if ( F_81 ( V_161 ) )
return NULL ;
if ( V_2 == NULL ) {
F_2 ( V_162 L_43 ,
...
if ( V_2 -> V_6 )
return V_2 ;
if ( F_83 ( V_157 , & V_2 -> V_156 ) == 0 ) {
struct V_38 * V_163 = F_55 ( V_144 -> V_164 -> V_165 ) ;
int V_166 ;
V_166 = F_14 ( V_163 , V_2 ) ;
if ( V_166 ) {
F_84 ( V_161 ) ;
V_2 = NULL ;
}
