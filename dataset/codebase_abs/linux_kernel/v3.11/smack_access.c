...
struct V_13 * F_16 ( const char * string )
{
struct V_13 * V_32 ;
...
struct V_13 * F_23 ( const char * string , int V_56 )
{
struct V_13 * V_32 ;
char * V_57 ;
int V_76 ;
...
if ( V_32 != NULL )
goto V_78;
V_32 = F_18 ( sizeof( * V_32 ) , V_59 ) ;
if ( V_32 == NULL )
goto V_78;
V_32 -> V_11 = V_57 ;
V_32 -> V_79 = V_80 ++ ;
V_32 -> V_81 . V_82 = V_32 -> V_11 ;
V_32 -> V_81 . V_68 =
V_83 | V_84 ;
V_76 = strlen ( V_57 ) ;
if ( V_76 < V_85 )
V_19 = F_19 ( V_86 , V_32 -> V_11 ,
& V_32 -> V_81 , V_76 ) ;
else
V_19 = F_19 ( V_87 , ( char * ) & V_32 -> V_79 ,
& V_32 -> V_81 , sizeof( V_32 -> V_79 ) ) ;
if ( V_19 >= 0 ) {
F_25 ( & V_32 -> V_27 ) ;
F_26 ( & V_32 -> V_88 ) ;
F_27 ( & V_32 -> V_89 , & V_90 ) ;
...
if ( string [ 0 ] == '-' )
return NULL ;
V_32 = F_23 ( string , V_56 ) ;
if ( V_32 == NULL )
return NULL ;
return V_32 -> V_11 ;
}
struct V_13 * F_31 ( const T_1 V_92 )
{
struct V_13 * V_32 ;
F_3 () ;
F_2 (skp, &smack_known_list, list) {
