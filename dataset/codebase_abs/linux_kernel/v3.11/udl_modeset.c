...
{
struct V_33 * V_34 = V_32 -> V_34 ;
struct V_49 * V_50 = F_22 ( V_32 -> V_51 ) ;
struct V_35 * V_36 = V_34 -> V_37 ;
char * V_1 ;
char * V_10 ;
int V_52 = 0 ;
...
V_10 = F_5 ( V_10 , V_52 ) ;
V_10 = F_6 ( V_10 , 0 ) ;
V_10 = F_7 ( V_10 , 2 * V_16 -> V_53 * V_16 -> V_29 ) ;
V_10 = F_12 ( V_10 , V_44 ) ;
V_10 = F_4 ( V_10 , V_8 ) ;
V_10 = F_3 ( V_10 ) ;
V_10 = F_13 ( V_10 ) ;
V_50 -> V_54 = true ;
if ( V_48 ) {
struct V_49 * V_55 = F_22 ( V_48 ) ;
V_55 -> V_54 = false ;
}
V_36 -> V_43 = V_10 - V_1 ;
F_23 ( V_50 , 0 , 0 , V_50 -> V_11 . V_56 , V_50 -> V_11 . V_57 ) ;
return 0 ;
}
...
{
struct V_31 * V_32 ;
V_32 = F_31 ( sizeof( struct V_31 ) + sizeof( struct V_58 * ) , V_59 ) ;
if ( V_32 == NULL )
return - V_40 ;
F_32 ( V_34 , V_32 , & V_60 ) ;
F_33 ( V_32 , & V_61 ) ;
