...
void F_50 ( void * V_89 , unsigned long V_90 , struct V_8 * V_8 )
{
F_51 ( V_89 ) ;
if ( ! F_14 () )
F_46 ( V_89 ) ;
}
void F_52 ( void * V_89 , void * V_91 , unsigned long V_90 ,
struct V_8 * V_92 )
{
F_29 () ;
F_30 ( F_53 ( V_91 ) , V_90 ) ;
...
void F_56 ( struct V_93 * V_94 , unsigned long V_64 )
{
unsigned long V_10 ;
F_47 ( V_10 ) ;
F_57 ( V_94 -> V_95 , 1 ) ;
...
void F_60 ( unsigned long V_96 , unsigned long V_97 ,
unsigned long V_98 )
{
unsigned long V_99 ;
...
static inline unsigned long F_64 ( struct V_93 * V_94 )
{
struct V_3 * V_4 ;
...
static inline T_1 * F_65 ( T_5 * V_107 , unsigned long V_64 )
{
T_1 * V_6 = NULL ;
if ( ! F_66 ( * V_107 ) ) {
T_6 * V_108 = F_67 ( V_107 , V_64 ) ;
if ( ! F_68 ( * V_108 ) ) {
T_7 * V_109 = F_69 ( V_108 , V_64 ) ;
if ( ! F_70 ( * V_109 ) )
V_6 = F_71 ( V_109 , V_64 ) ;
}
}
...
if ( V_94 -> V_95 == F_73 ( 3 ) ) {
for ( V_4 = V_94 -> V_104 ; V_4 ; V_4 = V_4 -> V_105 ) {
F_74 ( V_4 -> V_71 , V_4 -> V_106 ) ;
if ( ( V_4 -> V_58 & V_59 ) == 0 )
continue;
F_75 ( V_4 -> V_71 , V_4 -> V_106 ) ;
}
return;
}
V_107 = V_94 -> V_107 ;
...
void
F_77 ( unsigned long V_97 , unsigned long V_98 )
{
if ( ( V_98 - V_97 ) < V_85 )
F_74 ( V_97 , V_98 ) ;
else
...
void
F_78 ( unsigned long V_97 , unsigned long V_98 )
{
if ( ( V_98 - V_97 ) < V_85 )
F_75 ( V_97 , V_98 ) ;
else
...
void F_82 ( struct V_8 * V_8 , unsigned long V_90 )
{
void * V_89 ;
unsigned long V_10 ;
V_89 = F_83 ( V_8 ) ;
F_84 ( ( unsigned long ) V_89 ) ;
F_47 ( V_10 ) ;
F_48 ( V_89 ) ;
F_49 ( V_10 ) ;
F_29 () ;
...
void F_87 ( struct V_8 * V_111 , struct V_8 * V_112 ,
unsigned long V_90 , struct V_3 * V_4 )
{
void * V_91 , * V_89 ;
unsigned long V_10 ;
V_91 = F_83 ( V_112 ) ;
