...
if ( V_65 -> V_2 -> V_106 == V_107 )
memcpy ( V_65 -> V_72 . V_27 + V_104 ,
V_65 -> V_108 -> V_74 , V_109 ) ;
else
memcpy ( V_65 -> V_72 . V_27 + V_104 ,
V_65 -> V_2 -> V_74 , V_109 ) ;
V_3 = F_11 ( & V_65 -> V_2 -> V_5 . V_100 -> V_12 ,
V_65 -> V_72 . V_27 + V_104 , V_65 -> V_72 . V_28 - V_104 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_5 , V_25 ) ;
return V_3 ;
}
...
int
F_43 ( struct V_64 * V_65 , const struct V_66 * V_67 )
{
int V_3 ;
int V_110 ;
unsigned int V_111 ;
...
V_110 = V_69 + sizeof( struct V_112 ) ;
V_111 = V_65 -> V_72 . V_28 ;
V_114 = V_65 -> V_72 . V_27 ;
V_65 -> V_72 . V_27 = F_7 ( V_110 + V_111 , V_10 ) ;
if ( ! V_65 -> V_72 . V_27 ) {
V_3 = V_11 ;
V_65 -> V_72 . V_28 = 0 ;
goto V_115;
}
V_65 -> V_72 . V_28 += V_110 ;
V_113 = (struct V_112 * )
( V_65 -> V_72 . V_27 + V_69 ) ;
V_113 -> V_116 = F_16 ( 0x00000101 ) ;
V_113 -> V_117 = 0 ;
V_113 -> time = F_44 ( F_45 ( V_118 ) ) ;
F_46 ( & V_113 -> V_119 , sizeof( V_113 -> V_119 ) ) ;
V_113 -> V_120 = 0 ;
memcpy ( V_65 -> V_72 . V_27 + V_110 , V_114 , V_111 ) ;
V_3 = F_42 ( V_65 -> V_2 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_27 , V_3 ) ;
goto V_115;
...
struct V_126 V_127 ;
unsigned char V_128 [ V_69 ] ;
F_46 ( V_128 , V_69 ) ;
V_122 = F_48 ( L_31 , 0 , V_129 ) ;
if ( F_3 ( V_122 ) ) {
V_3 = F_5 ( V_122 ) ;
F_4 ( V_8 , L_32 ) ;
return V_3 ;
...
F_50 ( & V_124 , V_128 , V_69 ) ;
F_50 ( & V_125 , V_65 -> V_108 -> V_130 , V_131 ) ;
V_3 = F_51 ( & V_127 , & V_125 , & V_124 , V_131 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_34 , V_3 ) ;
F_52 ( V_122 ) ;
return V_3 ;
}
memcpy ( V_65 -> V_72 . V_27 , V_128 , V_69 ) ;
V_65 -> V_72 . V_28 = V_69 ;
F_52 ( V_122 ) ;
return V_3 ;
}
