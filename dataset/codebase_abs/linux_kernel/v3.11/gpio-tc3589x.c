...
{
struct V_5 * V_5 = F_39 ( V_65 -> V_43 . V_66 ) ;
struct V_67 * V_68 ;
...
if ( V_14 < 0 )
return V_14 ;
V_1 = F_41 ( sizeof( struct V_1 ) , V_71 ) ;
if ( ! V_1 )
return - V_72 ;
F_42 ( & V_1 -> V_29 ) ;
V_1 -> V_43 = & V_65 -> V_43 ;
...
if ( V_9 )
goto V_78;
V_9 = F_45 ( V_14 , NULL , F_23 , V_79 ,
L_3 , V_1 ) ;
if ( V_9 ) {
F_37 ( & V_65 -> V_43 , L_4 , V_9 ) ;
goto V_78;
}
V_9 = F_46 ( & V_1 -> V_3 ) ;
if ( V_9 ) {
F_37 ( & V_65 -> V_43 , L_5 , V_9 ) ;
goto V_80;
}
if ( V_68 && V_68 -> V_81 )
...
{
struct V_1 * V_1 = F_51 ( V_65 ) ;
struct V_5 * V_5 = V_1 -> V_5 ;
struct V_67 * V_68 = V_5 -> V_68 -> V_70 ;
int V_14 = F_40 ( V_65 , 0 ) ;
int V_9 ;
if ( V_68 && V_68 -> remove )
