...
F_26 ( V_83 ) ;
F_98 ( & V_83 -> V_62 . V_85 , & V_35 -> V_101 . V_175 ) ;
F_71 ( & V_124 ) ;
if ( V_170 )
F_52 ( V_170 ) ;
else if ( F_74 ( V_35 , V_60 , NULL ) )
F_99 ( & V_35 -> V_101 . V_148 ) ;
return 0 ;
}
struct V_54 * F_100 ( struct V_35 * V_35 , T_3 V_165 , T_4 type ,
...
struct V_54 * F_102 ( struct V_35 * V_35 , T_3 V_165 , T_4 type ,
...
static inline int
F_103 ( struct V_35 * V_35 , T_4 type , struct V_182 * V_183 )
{
int V_60 , V_179 = 0 ;
...
int F_105 ( struct V_35 * V_35 , T_4 type , struct V_182 * V_183 )
{
int V_60 , V_179 = 0 , V_129 = 0 ;
F_70 ( & V_124 ) ;
V_179 = F_103 ( V_35 , type , V_183 ) ;
if ( V_179 )
goto V_64;
for ( V_60 = 0 ; V_60 < V_141 ; V_60 ++ ) {
struct V_54 * V_81 ;
...
int F_106 ( struct V_35 * V_35 , struct F_106 * V_62 ,
int (* F_107)( struct V_54 * , int , int , void * ) ,
void * V_53 )
{
struct V_54 * V_81 ;
struct V_190 * V_41 ;
...
V_62 -> type != V_192 )
return - V_193 ;
if ( F_108 ( & V_62 -> V_62 . V_85 ) && V_62 -> V_194 != 0 )
return 0 ;
F_70 ( & V_124 ) ;
if ( F_108 ( & V_62 -> V_62 . V_85 ) )
V_41 = F_109 ( & V_35 -> V_101 . V_175 , struct V_190 , V_85 ) ;
else
V_41 = F_110 ( & V_62 -> V_62 . V_85 , struct V_190 , V_85 ) ;
F_111 (x, &net->xfrm.policy_all, all) {
if ( V_41 -> V_63 )
continue;
...
V_62 -> type != V_81 -> type )
continue;
error = F_107 ( V_81 , F_23 ( V_81 -> V_65 ) ,
V_62 -> V_194 , V_53 ) ;
if ( error ) {
F_112 ( & V_62 -> V_62 . V_85 , & V_41 -> V_85 ) ;
goto V_64;
}
V_62 -> V_194 ++ ;
}
...
F_113 ( & V_62 -> V_62 . V_85 ) ;
V_64:
F_71 ( & V_124 ) ;
return error ;
}
void F_114 ( struct F_106 * V_62 , T_4 type )
{
F_37 ( & V_62 -> V_62 . V_85 ) ;
V_62 -> V_62 . V_63 = 1 ;
V_62 -> type = type ;
...
void F_115 ( struct F_106 * V_62 )
{
if ( F_108 ( & V_62 -> V_62 . V_85 ) )
return;
F_70 ( & V_124 ) ;
F_116 ( & V_62 -> V_62 . V_85 ) ;
F_71 ( & V_124 ) ;
}
static int F_117 ( const struct V_54 * V_81 ,
...
if ( V_195 )
V_180 = F_118 ( V_81 -> V_95 , V_4 -> V_197 ,
V_60 ) ;
return V_180 ;
}
static struct V_54 * F_119 ( struct V_35 * V_35 , T_4 type ,
const struct V_3 * V_4 ,
T_5 V_28 , T_4 V_60 )
{
int V_179 ;
...
V_180 = NULL ;
F_83 (pol, chain, bydst) {
V_179 = F_117 ( V_81 , V_4 , type , V_28 , V_60 ) ;
if ( V_179 ) {
if ( V_179 == - V_189 )
continue;
else {
...
static struct V_54 *
F_122 ( struct V_35 * V_35 , const struct V_3 * V_4 , T_5 V_28 , T_4 V_60 )
{
#ifdef F_123
struct V_54 * V_81 ;
V_81 = F_119 ( V_35 , V_199 , V_4 , V_28 , V_60 ) ;
if ( V_81 != NULL )
return V_81 ;
#endif
return F_119 ( V_35 , V_200 , V_4 , V_28 , V_60 ) ;
}
static int F_124 ( int V_60 )
{
if ( V_135 == V_201 &&
V_137 == V_202 &&
V_139 == V_203 )
...
static struct V_79 *
F_125 ( struct V_35 * V_35 , const struct V_3 * V_4 , T_5 V_28 ,
T_4 V_60 , struct V_79 * V_204 , void * V_177 )
{
struct V_54 * V_81 ;
if ( V_204 )
F_28 ( F_31 ( V_204 , struct V_54 , V_80 ) ) ;
V_81 = F_122 ( V_35 , V_4 , V_28 , F_124 ( V_60 ) ) ;
if ( F_126 ( V_81 ) )
return F_127 ( V_81 ) ;
F_26 ( V_81 ) ;
return & V_81 -> V_80 ;
}
static inline int F_128 ( int V_60 )
{
if ( V_135 == V_201 &&
V_137 == V_202 &&
V_139 == V_203 )
...
static struct V_54 * F_129 ( struct V_205 * V_206 , int V_60 ,
const struct V_3 * V_4 )
{
struct V_54 * V_81 ;
F_77 ( & V_124 ) ;
...
static void F_130 ( struct V_54 * V_81 , int V_60 )
{
struct V_35 * V_35 = V_84 ( V_81 ) ;
struct V_103 * V_171 = F_56 ( V_35 , & V_81 -> V_117 ,
V_81 -> V_28 , V_60 ) ;
F_98 ( & V_81 -> V_62 . V_85 , & V_35 -> V_101 . V_175 ) ;
...
static struct V_54 * F_97 ( struct V_54 * V_81 ,
int V_60 )
{
struct V_35 * V_35 = V_84 ( V_81 ) ;
if ( F_131 ( & V_81 -> V_86 ) )
...
int F_132 ( struct V_205 * V_206 , int V_60 , struct V_54 * V_81 )
{
struct V_35 * V_35 = V_84 ( V_81 ) ;
struct V_54 * V_210 ;
#ifdef F_123
...
F_130 ( V_81 , V_141 + V_60 ) ;
}
if ( V_210 ) {
if ( V_81 )
F_85 ( V_210 , V_81 ) ;
F_97 ( V_210 , V_141 + V_60 ) ;
}
F_71 ( & V_124 ) ;
if ( V_210 ) {
F_52 ( V_210 ) ;
...
static struct V_54 * F_133 ( const struct V_54 * V_159 , int V_60 )
{
...
F_70 ( & V_124 ) ;
F_130 ( V_211 , V_141 + V_60 ) ;
F_71 ( & V_124 ) ;
F_28 ( V_211 ) ;
}
return V_211 ;
}
int F_135 ( struct V_205 * V_206 )
{
struct V_54 * V_217 = V_206 -> V_207 [ 0 ] ,
* V_156 = V_206 -> V_207 [ 1 ] ;
V_206 -> V_207 [ 0 ] = V_206 -> V_207 [ 1 ] = NULL ;
if ( V_217 && ( V_206 -> V_207 [ 0 ] = F_133 ( V_217 , 0 ) ) == NULL )
return - V_218 ;
if ( V_156 && ( V_206 -> V_207 [ 1 ] = F_133 ( V_156 , 1 ) ) == NULL )
return - V_218 ;
return 0 ;
}
static int
F_136 ( struct V_35 * V_35 , T_1 * V_219 , T_1 * V_220 ,
unsigned short V_28 )
{
int V_179 ;
...
static int
F_137 ( struct V_54 * V_83 , const struct V_3 * V_4 ,
struct V_40 * * V_101 , unsigned short V_28 )
{
struct V_35 * V_35 = V_84 ( V_83 ) ;
int V_222 ;
int V_123 , error ;
T_1 * V_9 = F_120 ( V_4 , V_28 ) ;
T_1 * V_12 = F_121 ( V_4 , V_28 ) ;
T_1 V_112 ;
...
V_219 = & V_223 -> V_12 ;
if ( F_138 ( V_219 , V_223 -> V_227 ) ) {
error = F_136 ( V_35 , & V_112 , V_220 , V_223 -> V_227 ) ;
if ( error )
goto V_198;
V_219 = & V_112 ;
}
}
V_41 = F_139 ( V_220 , V_219 , V_4 , V_223 , V_83 , & error , V_28 ) ;
...
static int
F_141 ( struct V_54 * * V_234 , int V_235 , const struct V_3 * V_4 ,
struct V_40 * * V_101 , unsigned short V_28 )
{
...
V_180 = F_137 ( V_234 [ V_123 ] , V_4 , & V_238 [ V_239 ] , V_28 ) ;
if ( V_180 < 0 ) {
error = V_180 ;
goto V_198;
} else
...
static inline int F_143 ( const struct V_3 * V_4 , int V_28 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
int V_36 ;
if ( ! V_32 )
...
static struct V_79 * F_144 ( struct V_79 * V_80 )
{
...
static int F_147 ( struct V_79 * V_80 )
{
struct V_242 * V_243 = F_31 ( V_80 , struct V_242 , V_80 ) ;
struct V_34 * V_37 = & V_243 -> V_7 . V_37 ;
if ( ! V_243 -> V_244 )
...
static inline struct V_242 * F_150 ( struct V_35 * V_35 , int V_28 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
struct V_247 * V_247 ;
struct V_242 * V_243 ;
...
V_243 = F_152 ( V_247 , NULL , 0 , V_251 , 0 ) ;
if ( F_153 ( V_243 ) ) {
struct V_34 * V_37 = & V_243 -> V_7 . V_37 ;
...
static inline int F_154 ( struct V_242 * V_254 , struct V_34 * V_37 ,
int V_255 )
{
struct V_31 * V_32 =
F_8 ( V_37 -> V_93 -> V_28 ) ;
...
static inline int F_155 ( struct V_242 * V_243 , struct V_257 * V_258 ,
const struct V_3 * V_4 )
{
struct V_31 * V_32 =
...
static struct V_34 * F_156 ( struct V_54 * V_83 ,
...
struct V_242 * V_243 = F_150 ( V_35 , V_28 ) ;
...
static int inline
F_165 ( void * * V_283 , const void * V_284 , int V_285 )
{
if ( ! * V_283 ) {
* V_283 = F_166 ( V_285 , V_212 ) ;
if ( ! * V_283 )
return - V_218 ;
}
...
static int inline
F_167 ( struct V_34 * V_37 , const struct V_1 * V_2 )
{
#ifdef F_123
struct V_242 * V_243 = (struct V_242 * ) V_37 ;
return F_165 ( ( void * * ) & ( V_243 -> V_286 ) ,
V_2 , sizeof( * V_2 ) ) ;
#else
return 0 ;
#endif
...
static int inline
F_168 ( struct V_34 * V_37 , const struct V_3 * V_4 )
{
#ifdef F_123
struct V_242 * V_243 = (struct V_242 * ) V_37 ;
return F_165 ( ( void * * ) & ( V_243 -> V_287 ) , V_4 , sizeof( * V_4 ) ) ;
#else
return 0 ;
#endif
}
static int F_169 ( const struct V_3 * V_4 , T_5 V_28 ,
struct V_54 * * V_234 ,
int * V_288 , int * V_245 )
{
int V_123 ;
...
if ( F_18 ( V_234 [ 0 ] ) )
return F_158 ( V_234 [ 0 ] ) ;
* V_245 = V_234 [ 0 ] -> V_214 ;
#ifdef F_123
if ( V_234 [ 0 ] && V_234 [ 0 ] -> V_213 == V_289 &&
V_234 [ 0 ] -> type != V_200 ) {
V_234 [ 1 ] = F_119 ( V_84 ( V_234 [ 0 ] ) ,
V_200 ,
V_4 , V_28 ,
V_137 ) ;
if ( V_234 [ 1 ] ) {
...
static struct V_242 *
F_171 ( struct V_54 * * V_234 , int V_288 ,
...
struct V_242 * V_243 ;
int V_179 ;
V_179 = F_141 ( V_234 , V_288 , V_4 , V_101 , V_28 ) ;
if ( V_179 <= 0 ) {
if ( V_179 != 0 && V_179 != - V_232 )
F_172 ( V_35 , V_291 ) ;
return F_15 ( V_179 ) ;
}
V_37 = F_156 ( V_234 [ 0 ] , V_101 , V_179 , V_4 , V_290 ) ;
if ( F_18 ( V_37 ) ) {
F_172 ( V_35 , V_292 ) ;
return F_127 ( V_37 ) ;
}
...
V_243 -> V_245 = V_179 ;
if ( V_288 > 1 )
V_179 = F_167 ( V_37 , & V_234 [ 1 ] -> V_117 ) ;
else
V_179 = F_168 ( V_37 , V_4 ) ;
if ( F_9 ( V_179 ) ) {
F_149 ( V_37 ) ;
F_172 ( V_35 , V_293 ) ;
return F_15 ( V_179 ) ;
...
V_243 -> V_294 = F_173 ( & V_234 [ 0 ] -> V_100 ) ;
return V_243 ;
}
...
struct V_3 V_4 ;
struct V_96 V_97 ;
F_174 ( & V_162 -> V_90 . V_61 ) ;
V_99 = F_175 ( & V_162 -> V_90 ) ;
V_37 = F_176 ( V_99 ) ;
V_206 = V_99 -> V_206 ;
F_177 ( V_99 , & V_4 , V_37 -> V_93 -> V_28 ) ;
F_178 ( & V_162 -> V_90 . V_61 ) ;
F_146 ( V_37 -> V_254 ) ;
V_37 = F_179 ( V_84 ( V_81 ) , V_37 -> V_254 , & V_4 ,
V_206 , 0 ) ;
if ( F_18 ( V_37 ) )
goto V_296;
if ( V_37 -> V_46 & V_246 ) {
...
F_25 ( & V_162 -> V_91 , V_78 + V_162 -> V_163 ) ;
return;
}
F_159 ( V_37 ) ;
F_86 ( & V_97 ) ;
...
while ( ! F_90 ( & V_97 ) ) {
V_99 = F_180 ( & V_97 ) ;
F_177 ( V_99 , & V_4 , F_176 ( V_99 ) -> V_93 -> V_28 ) ;
F_146 ( F_176 ( V_99 ) -> V_254 ) ;
V_37 = F_179 ( V_84 ( V_81 ) , F_176 ( V_99 ) -> V_254 ,
& V_4 , V_99 -> V_206 , 0 ) ;
if ( F_18 ( V_37 ) ) {
F_51 ( V_99 ) ;
continue;
...
{
unsigned long V_298 ;
struct V_34 * V_37 = F_176 ( V_99 ) ;
struct V_242 * V_243 = (struct V_242 * ) V_37 ;
struct V_161 * V_162 = & V_243 -> V_234 [ 0 ] -> V_89 ;
...
if ( F_45 ( & V_162 -> V_91 ) ) {
if ( F_187 ( V_162 -> V_91 . V_301 , V_298 ) )
V_298 = V_162 -> V_91 . V_301 ;
}
F_188 ( & V_162 -> V_90 , V_99 ) ;
F_25 ( & V_162 -> V_91 , V_298 ) ;
F_89 ( & V_162 -> V_90 . V_61 ) ;
return 0 ;
}
static struct V_242 * F_189 ( struct V_35 * V_35 ,
struct V_34 * V_37 ,
const struct V_3 * V_4 ,
int V_245 ,
T_5 V_28 )
...
V_267 -> V_269 = V_37 ;
V_267 -> V_254 = V_37 ;
F_154 ( (struct V_242 * ) V_267 , V_37 , 0 ) ;
V_179 = - V_281 ;
V_258 = V_37 -> V_258 ;
if ( ! V_258 )
goto V_282;
...
static struct V_79 *
F_190 ( struct V_35 * V_35 , const struct V_3 * V_4 , T_5 V_28 , T_4 V_60 ,
...
if ( V_243 == NULL ) {
V_288 = 1 ;
V_234 [ 0 ] = F_122 ( V_35 , V_4 , V_28 ,
F_124 ( V_60 ) ) ;
V_179 = F_169 ( V_4 , V_28 , V_234 ,
& V_288 , & V_245 ) ;
if ( V_179 < 0 )
goto V_308;
if ( V_288 == 0 )
...
V_306 = F_171 ( V_234 , V_288 , V_4 , V_28 , V_290 ) ;
if ( F_18 ( V_306 ) ) {
V_179 = F_158 ( V_306 ) ;
if ( V_179 != - V_232 )
goto error;
...
F_146 ( & V_306 -> V_7 . V_37 ) ;
return & V_306 -> V_80 ;
V_309:
V_243 = F_189 ( V_35 , V_290 , V_4 , V_245 , V_28 ) ;
if ( F_18 ( V_243 ) ) {
F_170 ( V_234 , V_288 ) ;
return F_127 ( V_243 ) ;
}
...
static struct V_34 * F_191 ( struct V_35 * V_35 , T_5 V_28 ,
struct V_34 * V_290 )
{
struct V_31 * V_32 = F_8 ( V_28 ) ;
struct V_34 * V_180 ;
...
struct V_34 * F_179 ( struct V_35 * V_35 , struct V_34 * V_290 ,
const struct V_3 * V_4 ,
...
F_170 ( V_234 , V_311 ) ;
F_172 ( V_35 , V_319 ) ;
return F_191 ( V_35 , V_28 , V_290 ) ;
}
if ( V_4 -> V_303 & V_304 ) {
F_193 ( V_320 , V_321 ) ;
F_194 ( & V_35 -> V_101 . V_322 , & V_320 ) ;
F_195 ( V_323 ) ;
F_196 () ;
F_195 ( V_324 ) ;
F_197 ( & V_35 -> V_101 . V_322 , & V_320 ) ;
if ( ! F_198 ( V_321 ) ) {
F_159 ( V_37 ) ;
goto V_312;
}
...
static inline int
F_199 ( int V_152 , struct V_98 * V_99 , const struct V_3 * V_4 )
{
struct V_40 * V_41 ;
...
static inline int
F_200 ( const struct V_216 * V_223 , const struct V_40 * V_41 ,
unsigned short V_28 )
{
if ( F_201 ( V_41 ) )
return V_223 -> V_233 && ! F_202 ( V_223 , V_41 , V_223 -> V_227 ) ;
...
! ( F_203 ( V_223 -> V_45 . V_20 , V_340 ) ) ) &&
! ( V_41 -> V_44 . V_224 != V_271 &&
F_202 ( V_223 , V_41 , V_28 ) ) ;
}
static inline int
F_204 ( const struct V_216 * V_223 , const struct V_341 * V_332 , int V_342 ,
unsigned short V_28 )
{
int V_152 = V_342 ;
if ( V_223 -> V_233 ) {
...
if ( F_200 ( V_223 , V_332 -> V_333 [ V_152 ] , V_28 ) )
return ++ V_152 ;
...
int F_205 ( struct V_98 * V_99 , struct V_3 * V_4 ,
...
V_179 = F_206 ( V_99 , & V_4 -> V_197 ) ;
F_13 ( V_32 ) ;
return V_179 ;
}
static inline int F_207 ( const struct V_341 * V_332 , int V_345 , int * V_346 )
{
...
int F_208 ( struct V_205 * V_206 , int V_60 , struct V_98 * V_99 ,
unsigned short V_28 )
{
struct V_35 * V_35 = F_209 ( V_99 -> V_258 ) ;
struct V_54 * V_81 ;
struct V_54 * V_234 [ V_191 ] ;
int V_235 = 0 ;
int V_214 ;
...
V_60 &= V_350 ;
V_348 = F_128 ( V_60 ) ;
if ( F_205 ( V_99 , & V_4 , V_28 , V_343 ) < 0 ) {
F_172 ( V_35 , V_351 ) ;
return 0 ;
}
F_210 ( V_99 , & V_4 , V_28 ) ;
...
if ( ! V_81 ) {
struct V_79 * V_80 ;
V_80 = F_192 ( V_35 , & V_4 , V_28 , V_348 ,
F_125 , NULL ) ;
if ( F_126 ( V_80 ) )
V_81 = F_127 ( V_80 ) ;
else
...
if ( ! V_81 ) {
if ( V_99 -> V_332 && F_207 ( V_99 -> V_332 , 0 , & V_349 ) ) {
F_199 ( V_349 , V_99 , & V_4 ) ;
F_172 ( V_35 , V_354 ) ;
return 0 ;
}
return 1 ;
...
V_214 = V_357 ;
if ( V_235 > 1 ) {
F_211 ( V_356 , V_238 , V_214 , V_28 ) ;
V_238 = V_356 ;
}
for ( V_123 = V_214 - 1 , V_345 = 0 ; V_123 >= 0 ; V_123 -- ) {
V_345 = F_204 ( V_238 [ V_123 ] , V_332 , V_345 , V_28 ) ;
if ( V_345 < 0 ) {
if ( V_345 < - 1 )
V_349 = - ( 2 + V_345 ) ;
F_172 ( V_35 , V_361 ) ;
...
int F_212 ( struct V_98 * V_99 , unsigned short V_28 )
{
struct V_35 * V_35 = F_209 ( V_99 -> V_258 ) ;
struct V_3 V_4 ;
struct V_34 * V_37 ;
int V_362 = 1 ;
if ( F_177 ( V_99 , & V_4 , V_28 ) < 0 ) {
F_172 ( V_35 , V_363 ) ;
return 0 ;
}
F_186 ( V_99 ) ;
V_37 = F_179 ( V_35 , F_176 ( V_99 ) , & V_4 , NULL , 0 ) ;
if ( F_18 ( V_37 ) ) {
V_362 = 0 ;
V_37 = NULL ;
}
...
static struct V_34 * F_213 ( struct V_34 * V_37 , T_3 V_364 )
{
if ( V_37 -> V_273 < 0 && ! F_145 ( V_37 ) )
return V_37 ;
return NULL ;
}
static int F_145 ( struct V_34 * V_37 )
{
return ! F_214 ( (struct V_242 * ) V_37 ) ;
}
void F_215 ( struct V_34 * V_37 , struct V_257 * V_258 )
{
while ( ( V_37 = V_37 -> V_269 ) && V_37 -> V_101 && V_37 -> V_258 == V_258 ) {
V_37 -> V_258 = F_209 ( V_258 ) -> V_365 ;
F_216 ( V_37 -> V_258 ) ;
F_217 ( V_258 ) ;
}
}
...
static void F_164 ( struct V_34 * V_37 )
{
do {
struct V_242 * V_243 = (struct V_242 * ) V_37 ;
T_3 V_367 , V_368 ;
...
V_243 -> V_369 = V_367 ;
V_367 = F_226 ( V_37 -> V_101 , V_367 ) ;
V_368 = F_225 ( V_243 -> V_244 ) ;
V_243 -> V_368 = V_368 ;
if ( V_367 > V_368 )
V_367 = V_368 ;
...
static int F_214 ( struct V_242 * V_371 )
{
struct V_34 * V_37 = & V_371 -> V_7 . V_37 ;
struct V_242 * V_372 ;
T_3 V_373 ;
if ( ! F_228 ( V_37 -> V_254 , ( (struct V_242 * ) V_37 ) -> V_374 ) ||
( V_37 -> V_258 && ! F_229 ( V_37 -> V_258 ) ) )
return 0 ;
if ( V_37 -> V_46 & V_246 )
return 1 ;
V_372 = NULL ;
...
return 0 ;
if ( V_243 -> V_288 > 0 &&
V_243 -> V_294 != F_173 ( & V_243 -> V_234 [ 0 ] -> V_100 ) )
return 0 ;
...
if ( ! F_228 ( V_243 -> V_244 , V_243 -> V_375 ) )
return 0 ;
V_373 = F_225 ( V_243 -> V_244 ) ;
...
if ( F_153 ( V_247 -> V_379 == NULL ) )
V_247 -> V_379 = V_380 ;
if ( F_153 ( V_247 -> V_381 == NULL ) )
V_247 -> V_381 = F_213 ;
if ( F_153 ( V_247 -> V_382 == NULL ) )
V_247 -> V_382 = F_230 ;
if ( F_153 ( V_247 -> V_373 == NULL ) )
V_247 -> V_373 = F_232 ;
if ( F_153 ( V_247 -> V_383 == NULL ) )
V_247 -> V_383 = F_219 ;
if ( F_153 ( V_247 -> V_384 == NULL ) )
V_247 -> V_384 = F_218 ;
if ( F_153 ( V_247 -> V_377 == NULL ) )
V_247 -> V_377 = F_234 ;
if ( F_153 ( V_32 -> V_385 == NULL ) )
V_32 -> V_385 = F_223 ;
...
{
struct V_257 * V_258 = F_245 ( V_390 ) ;
switch ( V_389 ) {
case V_391 :
F_221 ( F_209 ( V_258 ) ) ;
}
...
static int T_6 F_246 ( struct V_35 * V_35 )
{
int V_393 ;
if ( F_247 ( ( void V_394 * * ) V_35 -> V_395 . V_396 ,
sizeof( struct V_397 ) ,
F_248 ( struct V_397 ) ) < 0 )
return - V_218 ;
V_393 = F_249 ( V_35 ) ;
if ( V_393 < 0 )
F_250 ( ( void V_394 * * ) V_35 -> V_395 . V_396 ) ;
return V_393 ;
}
static void F_251 ( struct V_35 * V_35 )
{
F_252 ( V_35 ) ;
F_250 ( ( void V_394 * * ) V_35 -> V_395 . V_396 ) ;
}
...
static int T_6 F_253 ( struct V_35 * V_35 )
{
...
static void F_259 ( struct V_35 * V_35 )
{
struct V_182 V_183 ;
unsigned int V_398 ;
int V_60 ;
F_260 ( & V_35 -> V_101 . V_148 ) ;
#ifdef F_123
V_183 . V_184 = V_407 ;
V_183 . V_185 = - 1 ;
V_183 . V_186 = 0 ;
F_105 ( V_35 , V_199 , & V_183 ) ;
#endif
V_183 . V_184 = V_407 ;
V_183 . V_185 = - 1 ;
V_183 . V_186 = 0 ;
F_105 ( V_35 , V_200 , & V_183 ) ;
F_95 ( ! F_108 ( & V_35 -> V_101 . V_175 ) ) ;
for ( V_60 = 0 ; V_60 < V_141 * 2 ; V_60 ++ ) {
struct V_403 * V_404 ;
...
static int T_6 F_261 ( struct V_35 * V_35 )
{
int V_393 ;
V_393 = F_246 ( V_35 ) ;
if ( V_393 < 0 )
...
static void T_7 F_265 ( struct V_35 * V_35 )
{
F_266 ( V_35 ) ;
F_259 ( V_35 ) ;
F_264 ( V_35 ) ;
...
static void F_270 ( struct V_54 * V_55 ,
struct V_413 * V_414 )
{
...
switch( V_2 -> V_28 ) {
case V_29 :
F_271 ( V_414 , L_3 , & V_2 -> V_12 . V_10 ) ;
if ( V_2 -> V_13 != 32 )
F_271 ( V_414 , L_4 ,
V_2 -> V_13 ) ;
F_271 ( V_414 , L_5 , & V_2 -> V_9 . V_10 ) ;
if ( V_2 -> V_11 != 32 )
F_271 ( V_414 , L_6 ,
V_2 -> V_11 ) ;
break;
case V_30 :
F_271 ( V_414 , L_7 , V_2 -> V_12 . V_418 ) ;
if ( V_2 -> V_13 != 128 )
F_271 ( V_414 , L_4 ,
V_2 -> V_13 ) ;
F_271 ( V_414 , L_8 , V_2 -> V_9 . V_418 ) ;
if ( V_2 -> V_11 != 128 )
F_271 ( V_414 , L_6 ,
V_2 -> V_11 ) ;
break;
...
void F_272 ( struct V_54 * V_55 , int V_419 ,
...
if ( V_414 == NULL )
return;
F_274 ( V_420 , V_185 , V_186 , V_414 ) ;
F_271 ( V_414 , L_10 , V_419 ) ;
F_270 ( V_55 , V_414 ) ;
F_275 ( V_414 ) ;
}
void F_104 ( struct V_54 * V_55 , int V_419 ,
T_9 V_420 , T_3 V_185 , T_3 V_186 )
{
struct V_413 * V_414 ;
V_414 = F_273 ( L_11 ) ;
...
static bool F_276 ( const struct V_1 * V_421 ,
const struct V_1 * V_422 )
{
if ( V_421 -> V_20 == V_423 ) {
if ( V_422 -> V_28 == V_421 -> V_28 &&
F_277 ( & V_422 -> V_9 , & V_421 -> V_9 ,
V_421 -> V_28 ) &&
F_277 ( & V_422 -> V_12 , & V_421 -> V_12 ,
V_421 -> V_28 ) &&
...
static struct V_54 * F_278 ( const struct V_1 * V_2 ,
T_4 V_60 , T_4 type )
{
...
static int F_279 ( const struct V_424 * V_167 , const struct V_216 * V_425 )
{
int V_195 = 0 ;
...
case V_225 :
case V_226 :
if ( F_277 ( & V_425 -> V_45 . V_9 , & V_167 -> V_426 ,
V_167 -> V_427 ) &&
F_277 ( & V_425 -> V_12 , & V_167 -> V_428 ,
V_167 -> V_427 ) ) {
V_195 = 1 ;
}
break;
...
static int F_280 ( struct V_54 * V_81 ,
...
if ( ! F_279 ( V_430 , & V_81 -> V_215 [ V_123 ] ) )
continue;
V_432 ++ ;
...
static int F_281 ( const struct V_424 * V_167 , int V_429 )
{
int V_123 , V_431 ;
if ( V_429 < 1 || V_429 > V_237 )
return - V_193 ;
for ( V_123 = 0 ; V_123 < V_429 ; V_123 ++ ) {
if ( F_277 ( & V_167 [ V_123 ] . V_426 , & V_167 [ V_123 ] . V_433 ,
V_167 [ V_123 ] . V_427 ) &&
F_277 ( & V_167 [ V_123 ] . V_428 , & V_167 [ V_123 ] . V_434 ,
V_167 [ V_123 ] . V_427 ) )
return - V_193 ;
if ( F_138 ( & V_167 [ V_123 ] . V_433 , V_167 [ V_123 ] . V_435 ) ||
F_138 ( & V_167 [ V_123 ] . V_434 , V_167 [ V_123 ] . V_435 ) )
return - V_193 ;
...
struct V_424 * V_430 ;
if ( ( V_179 = F_281 ( V_167 , V_429 ) ) < 0 )
goto V_64;
if ( ( V_81 = F_278 ( V_2 , V_60 , type ) ) == NULL ) {
V_179 = - V_181 ;
goto V_64;
}
...
if ( ( V_179 = F_280 ( V_81 , V_167 , V_429 ) ) < 0 )
goto V_443;
if ( V_438 ) {
F_284 ( V_441 , V_438 ) ;
F_285 ( V_441 , V_438 ) ;
}
F_286 ( V_2 , V_60 , type , V_167 , V_429 , V_345 ) ;
F_28 ( V_81 ) ;
return 0 ;
V_64:
return V_179 ;
