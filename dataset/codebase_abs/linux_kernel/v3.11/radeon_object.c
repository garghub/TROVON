...
{
if ( ! V_6 -> V_87 ) {
V_6 -> V_73 . V_88 = F_49 ( V_6 -> V_73 . V_89 ,
V_6 -> V_73 . V_90 ) ;
}
F_50 ( L_6 ,
V_6 -> V_73 . V_91 >> 20 ,
...
F_50 ( L_7 ,
V_6 -> V_73 . V_92 , V_6 -> V_73 . V_93 ? 'D' : 'S' ) ;
return F_51 ( V_6 ) ;
}
...
void F_55 ( struct V_94 * V_95 ,
struct V_96 * V_97 )
{
if ( V_95 -> V_98 ) {
F_56 ( & V_95 -> V_99 . V_97 , V_97 ) ;
} else {
F_57 ( & V_95 -> V_99 . V_97 , V_97 ) ;
}
}
int F_58 ( struct V_100 * V_101 ,
struct V_96 * V_97 , int V_102 )
{
struct V_94 * V_95 ;
struct V_1 * V_2 ;
T_1 V_15 ;
int V_48 ;
V_48 = F_59 ( V_101 , V_97 ) ;
if ( F_20 ( V_48 != 0 ) ) {
return V_48 ;
}
...
int V_114 ;
int V_70 ;
F_66 ( & V_2 -> V_8 . V_115 -> V_116 . V_117 ) ;
if ( ! V_2 -> V_108 )
return 0 ;
if ( V_2 -> V_59 >= 0 ) {
V_112 = & V_6 -> V_118 [ V_2 -> V_59 ] ;
V_70 = V_2 -> V_59 ;
goto V_119;
}
V_114 = - 1 ;
for ( V_70 = 0 ; V_70 < V_120 ; V_70 ++ ) {
V_112 = & V_6 -> V_118 [ V_70 ] ;
if ( ! V_112 -> V_2 )
break;
V_113 = V_112 -> V_2 ;
if ( V_113 -> V_71 == 0 )
...
if ( V_114 == - 1 )
return - V_57 ;
V_112 = & V_6 -> V_118 [ V_114 ] ;
V_113 = V_112 -> V_2 ;
F_67 ( L_8 , V_114 , V_113 ) ;
F_68 ( & V_113 -> V_8 ) ;
V_113 -> V_59 = - 1 ;
V_70 = V_114 ;
}
...
V_112 -> V_2 = V_2 ;
V_119:
F_69 ( V_6 , V_70 , V_2 -> V_108 , V_2 -> V_121 ,
V_2 -> V_8 . V_122 . V_123 << V_46 ,
V_2 -> V_8 . V_66 << V_46 ) ;
return 0 ;
}
...
int V_48 ;
if ( V_6 -> V_124 >= V_125 ) {
unsigned V_126 , V_127 , V_128 , V_129 , V_130 ;
V_126 = ( V_108 >> V_131 ) & V_132 ;
V_127 = ( V_108 >> V_133 ) & V_134 ;
V_128 = ( V_108 >> V_135 ) & V_136 ;
V_129 = ( V_108 >> V_137 ) & V_138 ;
V_130 = ( V_108 >> V_139 ) & V_140 ;
switch ( V_126 ) {
case 0 :
case 1 :
case 2 :
...
int F_29 ( struct V_1 * V_2 , bool V_142 ,
bool V_143 )
{
if ( ! V_143 )
F_66 ( & V_2 -> V_8 . V_115 -> V_116 . V_117 ) ;
...
F_29 ( V_14 , 0 , 0 ) ;
V_6 = V_14 -> V_6 ;
if ( V_2 -> V_122 . V_145 == V_82 ) {
V_37 = V_2 -> V_122 . V_66 << V_46 ;
V_147 = V_2 -> V_122 . V_123 << V_46 ;
if ( ( V_147 + V_37 ) > V_6 -> V_73 . V_76 ) {
F_13 ( V_14 , V_22 ) ;
...
int F_78 ( struct V_1 * V_2 , T_1 * V_145 , bool V_148 )
{
int V_48 ;
V_48 = F_79 ( & V_2 -> V_8 , true , V_148 , false , 0 ) ;
if ( F_20 ( V_48 != 0 ) )
return V_48 ;
F_80 ( & V_2 -> V_8 . V_50 -> V_149 ) ;
if ( V_145 )
* V_145 = V_2 -> V_8 . V_122 . V_145 ;
if ( V_2 -> V_8 . V_150 )
V_48 = F_81 ( & V_2 -> V_8 , true , true , V_148 ) ;
F_82 ( & V_2 -> V_8 . V_50 -> V_149 ) ;
F_83 ( & V_2 -> V_8 ) ;
return V_48 ;
}
