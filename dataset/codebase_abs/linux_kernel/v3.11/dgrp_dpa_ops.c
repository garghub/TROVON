...
static void F_19 ( struct V_3 * V_4 , T_1 * V_22 , int V_92 )
{
int V_30 ;
int V_31 ;
unsigned long V_23 ;
...
void F_21 ( struct V_3 * V_4 , int type , T_1 * V_22 , int V_94 )
{
T_1 V_95 [ 5 ] ;
V_95 [ 0 ] = type ;
F_22 ( V_94 , V_95 + 1 ) ;
F_19 ( V_4 , V_95 , sizeof( V_95 ) ) ;
F_19 ( V_4 , V_22 , V_94 ) ;
}
