...
struct V_45 * V_46 = ( void * ) F_26 ( V_16 , V_47 ) ;
...
return F_9 ( V_9 , - V_80 ) ;
F_4 ( & V_28 -> V_87 ) ;
F_35 ( & V_28 -> V_33 , & V_9 -> V_11 ) ;
V_9 -> V_38 |= ( 1 << V_74 -> V_81 ) ;
V_13 = F_36 ( V_15 , V_7 , V_41 , V_88 |
V_74 -> V_81 , V_74 -> V_83 ,
V_74 -> V_85 , & V_28 -> V_28 ) ;
if ( V_13 )
goto V_89;
...
0 , 0 , & V_28 -> V_30 ) ;
if ( V_13 == 0 )
V_13 = F_38 ( V_28 -> V_30 , V_104 ) ;
if ( V_13 )
goto V_89;
if ( V_16 -> V_17 >= V_23 ) {
V_13 = F_39 ( V_28 -> V_30 , V_12 -> V_105 ,
& V_28 -> V_35 ) ;
if ( V_13 )
goto V_89;
}
V_13 = F_40 ( V_3 , V_28 -> V_30 -> V_36 ,
& V_74 -> V_106 ) ;
if ( V_13 )
goto V_89;
V_13 = F_41 ( & V_28 -> V_31 , 0 , V_103 , 1 ) ;
V_89:
if ( V_13 )
F_15 ( V_9 , V_28 ) ;
return F_9 ( V_9 , V_13 ) ;
...
if ( F_32 ( ! V_9 ) )
return - V_80 ;
if ( F_32 ( F_11 ( V_9 -> V_16 ) -> V_17 >= V_24 ) )
return F_9 ( V_9 , - V_72 ) ;
...
if ( ! V_30 )
return F_9 ( V_9 , - V_80 ) ;
F_35 ( & V_30 -> V_33 , & V_28 -> V_87 ) ;
V_30 -> V_39 = V_115 -> V_39 ;
V_13 = F_46 ( & V_28 -> V_31 , 1 , V_115 -> V_117 , V_115 -> V_117 , 1 ,
& V_30 -> V_32 ) ;
if ( V_13 )
goto V_89;
...
return F_9 ( V_9 , - V_109 ) ;
F_16 ( V_28 -> V_28 ) ;
V_13 = F_24 ( V_9 -> V_12 , V_28 -> V_28 -> V_39 , V_132 -> V_39 ) ;
if ( V_13 )
return F_9 ( V_9 , V_13 ) ;
