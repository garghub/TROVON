...
if ( F_67 ( V_32 ) -> V_167 == 0 ) {
struct V_168 * V_169 = (struct V_168 * ) F_74 ( V_32 , sizeof( struct V_103 ) ) ;
V_169 -> V_170 = V_171 ;
...
F_136 ( V_32 ) ;
V_208 = (struct V_207 * ) F_65 ( V_32 ) ;
V_208 -> V_211 = 0 ;
V_208 -> V_212 = V_137 ;
V_208 -> V_213 = V_4 -> V_58 ;
V_208 -> V_214 = 0 ;
V_208 -> V_215 = F_67 ( V_95 ) -> V_117 ;
V_208 -> V_216 = F_67 ( V_95 ) -> V_118 ;
V_32 -> V_128 = V_210 ;
} else
#endif
{
...
if ( F_119 ( & V_162 -> V_91 , & F_67 ( V_32 ) -> V_118 ) &&
F_119 ( & V_162 -> V_92 , & F_67 ( V_32 ) -> V_117 ) ) {
V_218 = true ;
break;
}
}
...
V_162 -> V_93 = - 1 ;
V_162 -> V_92 = F_67 ( V_32 ) -> V_117 ;
V_162 -> V_91 = F_67 ( V_32 ) -> V_118 ;
V_12 = F_82 ( V_4 , V_32 , V_200 , V_219 ) ;
if ( V_12 < 0 ) {
F_39 ( & V_67 ) ;
F_97 ( V_162 ) ;
F_80 ( V_32 ) ;
...
struct V_255 * F_176 ( struct V_2 * V_2 , struct V_31 * V_32 )
{
struct V_1 * V_4 ;
struct V_5 V_107 = {
. V_108 = V_32 -> V_133 ,
...
struct V_2 * V_2 = F_173 ( V_256 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , F_178 ( V_256 ) -> V_262 ? : V_44 ) ;
if ( V_4 == NULL )
return - V_76 ;
if ( V_259 != V_263 ) {
...
return - V_27 ;
if ( F_181 ( & V_79 , V_260 , sizeof( V_79 ) ) )
return - V_273 ;
if ( V_79 . V_186 >= V_182 )
return - V_251 ;
F_21 () ;
...
return - V_27 ;
if ( F_181 ( & V_63 , V_260 , sizeof( V_63 ) ) )
return - V_273 ;
if ( V_223 == 0 )
V_223 = V_63 . V_250 ;
F_21 () ;
...
int F_187 ( struct V_255 * V_256 , int V_290 , void T_8 * V_10 )
{
struct V_291 V_292 ;
struct V_293 V_294 ;
struct V_68 * V_79 ;
...
switch ( V_290 ) {
case V_295 :
if ( F_181 ( & V_294 , V_10 , sizeof( V_294 ) ) )
return - V_273 ;
...
F_37 ( & V_64 ) ;
if ( F_186 ( V_10 , & V_294 , sizeof( V_294 ) ) )
return - V_273 ;
return 0 ;
}
F_37 ( & V_64 ) ;
...
int F_188 ( struct V_255 * V_256 , unsigned int V_290 , void T_8 * V_10 )
{
struct V_306 V_292 ;
struct V_307 V_294 ;
struct V_68 * V_79 ;
...
V_79 -> V_85 ++ ;
V_79 -> V_84 += V_32 -> V_120 ;
if ( F_198 ( V_32 , sizeof( * V_310 ) + F_199 ( V_81 ) ) )
goto V_313;
V_310 = F_67 ( V_32 ) ;
V_310 -> V_314 -- ;
F_200 ( V_32 ) -> V_19 |= V_315 ;
return F_201 ( V_316 , V_317 , V_32 , V_32 -> V_81 , V_81 ,
F_189 ) ;
V_313:
F_80 ( V_32 ) ;
return 0 ;
...
F_67 ( V_32 ) -> V_314 > V_66 -> V_94 . V_8 . V_99 [ V_65 ] ) {
if ( V_318 != - 1 ) {
struct V_31 * V_327 = F_203 ( V_32 , V_204 ) ;
if ( V_327 )
F_194 ( V_2 , V_4 , V_327 , V_66 , V_318 ) ;
}
V_318 = V_65 ;
}
}
...
if ( V_162 -> V_93 >= V_182 )
return - V_76 ;
if ( F_41 ( V_4 , V_162 -> V_93 ) &&
F_205 ( V_32 , V_336 , V_4 -> V_72 [ V_162 -> V_93 ] . V_81 -> V_109 ) < 0 )
return - V_206 ;
V_333 = F_206 ( V_32 , V_337 ) ;
if ( V_333 == NULL )
return - V_206 ;
for ( V_65 = V_162 -> V_94 . V_8 . V_98 ; V_65 < V_162 -> V_94 . V_8 . V_71 ; V_65 ++ ) {
if ( F_41 ( V_4 , V_65 ) && V_162 -> V_94 . V_8 . V_99 [ V_65 ] < 255 ) {
V_332 = F_207 ( V_32 , sizeof( * V_332 ) ) ;
if ( V_332 == NULL ) {
F_208 ( V_32 , V_333 ) ;
return - V_206 ;
}
...
if ( F_210 ( V_32 , V_345 , sizeof( V_335 ) , & V_335 ) < 0 )
return - V_206 ;
V_330 -> V_346 = V_347 ;
return 1 ;
}
...
struct V_329 * V_330 ;
int V_12 ;
V_169 = F_213 ( V_32 , V_175 , V_74 , V_290 , sizeof( * V_330 ) , V_362 ) ;
if ( V_169 == NULL )
return - V_206 ;
V_330 = F_105 ( V_169 ) ;
V_330 -> V_363 = V_247 ;
...
V_330 -> V_372 = V_374 ;
V_330 -> V_359 = 0 ;
if ( F_210 ( V_32 , V_375 , 16 , & V_162 -> V_92 ) ||
F_210 ( V_32 , V_376 , 16 , & V_162 -> V_91 ) )
goto V_369;
...
if ( V_32 == NULL )
goto V_377;
V_12 = F_212 ( V_4 , V_32 , 0 , 0 , V_63 , V_290 ) ;
if ( V_12 < 0 )
goto V_377;
...
{
struct V_2 * V_2 = F_173 ( V_32 -> V_256 ) ;
struct V_1 * V_4 ;
struct V_59 * V_63 ;
