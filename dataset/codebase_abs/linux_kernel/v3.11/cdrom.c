...
F_59 ( & V_330 . V_314 , & V_360 , V_216 ) ;
F_59 ( & V_330 . V_313 , & V_330 . V_309 , V_216 ) ;
F_122 ( V_349 , struct V_304 , V_330 ) ;
return 0 ;
}
...
F_122 ( V_349 , struct V_369 , V_417 ) ;
return 0 ;
}
V_4 -> V_68 = V_130 ;
...
long V_426 = 0 ;
F_3 ( V_346 , L_110 ) ;
V_86 = F_131 ( V_2 , & V_426 ) ;
if ( V_86 )
return V_86 ;
F_122 ( V_349 , long , V_426 ) ;
return 0 ;
}
static T_12 int F_132 ( struct V_1 * V_2 ,
void T_10 * V_349 )
{
int V_86 ;
long V_427 = 0 ;
F_3 ( V_346 , L_111 ) ;
V_86 = F_133 ( V_2 , & V_427 ) ;
if ( V_86 )
return V_86 ;
F_122 ( V_349 , long , V_427 ) ;
return 0 ;
}
...
case V_371 :
case V_372 :
return F_125 ( V_2 , V_428 , & V_4 , V_72 ) ;
case V_390 :
case V_391 :
...
static int F_134 ( struct V_1 * V_2 , T_13 V_435 , T_9 type ,
T_14 * V_367 )
{
struct V_12 * V_13 = V_2 -> V_14 ;
struct V_3 V_4 ;
...
int F_133 ( struct V_1 * V_2 , long * V_440 )
{
struct V_199 V_441 ;
T_1 V_98 ;
T_14 V_367 ;
...
+ sizeof( V_367 . V_451 ) ) ) {
* V_440 = F_135 ( V_367 . V_451 ) ;
} else {
* V_440 = F_135 ( V_367 . V_447 ) +
F_135 ( V_367 . V_449 ) ;
if ( V_367 . V_452 )
* V_440 -= ( F_135 ( V_367 . V_452 ) + 7 ) ;
}
return 0 ;
V_444:
V_441 . V_206 = V_207 ;
...
static int F_131 ( struct V_1 * V_2 , long * V_454 )
{
T_1 V_98 ;
T_14 V_367 ;
T_13 V_442 ;
...
+ sizeof( V_367 . V_454 ) ) {
* V_454 = F_135 ( V_367 . V_454 ) ;
return 0 ;
}
V_455:
if ( ( V_86 = F_133 ( V_2 , V_454 ) ) ) {
* V_454 = 0 ;
return V_86 ;
} else {
* V_454 += 7 ;
...
static int F_136 ( const char * V_198 , int V_457 , char * V_178 ,
int * V_458 , enum V_459 V_460 )
{
const int V_461 = sizeof( V_462 . V_178 ) ;
struct V_1 * V_2 ;
int V_86 ;
V_86 = F_137 ( V_178 + * V_458 , V_461 - * V_458 , V_198 ) ;
if ( ! V_86 )
return 1 ;
* V_458 += V_86 ;
...
switch ( V_460 ) {
case V_463 :
V_86 = F_137 ( V_178 + * V_458 , V_461 - * V_458 ,
L_112 , V_2 -> V_62 ) ;
break;
case V_464 :
V_86 = F_137 ( V_178 + * V_458 , V_461 - * V_458 ,
...
static int F_139 ( T_16 * V_468 , int V_83 ,
...
if ( F_136 ( L_116 , 0 , V_178 , & V_458 , V_463 ) )
goto V_472;
if ( F_136 ( L_117 , 0 , V_178 , & V_458 , V_464 ) )
goto V_472;
if ( F_136 ( L_118 , 0 , V_178 , & V_458 , V_466 ) )
goto V_472;
if ( F_136 ( L_119 ,
...
goto V_472;
if ( ! F_137 ( V_178 + V_458 , V_461 - V_458 , L_136 ) )
goto V_472;
V_473:
F_10 ( & V_63 ) ;
return F_140 ( V_468 , V_83 , V_68 , V_469 , V_470 ) ;
V_472:
F_4 ( L_137 ) ;
goto V_473;
}
...
static int F_142 ( T_16 * V_468 , int V_83 ,
void T_10 * V_68 , T_17 * V_469 , T_18 * V_470 )
{
int V_86 ;
V_86 = F_143 ( V_468 , V_83 , V_68 , V_469 , V_470 ) ;
if ( V_83 ) {
V_47 = ! ! V_462 . V_47 ;
V_49 = ! ! V_462 . V_49 ;
V_353 = ! ! V_462 . V_353 ;
...
static int T_19 F_147 ( void )
{
F_5 () ;
return 0 ;
}
static void T_20 F_148 ( void )
{
F_4 ( L_138 ) ;
F_145 () ;
}
