...
static const void * F_25 ( struct V_4 * V_5 ,
struct V_68 * V_69 )
{
const struct V_70 * V_71 ;
int V_18 ;
for ( V_18 = 0 ; V_18 < F_26 ( V_72 ) ; V_18 ++ ) {
V_71 = & V_72 [ V_18 ] ;
if ( V_71 -> V_73 == V_69 -> V_74 )
return V_71 ;
}
return NULL ;
}
...
if ( V_76 )
return V_76 ;
V_5 -> V_20 = V_69 -> V_84 [ 0 ] -> V_85 ;
V_69 -> V_86 = V_5 ;
V_76 = F_30 ( V_69 , F_1 ) ;
if ( V_76 )
return V_76 ;
V_5 -> V_1 = V_69 -> V_1 ;
V_12 = F_31 ( sizeof( * V_12 ) , V_87 ) ;
if ( ! V_12 )
return - V_88 ;
V_5 -> V_13 = V_12 ;
V_76 = F_32 ( V_5 , 3 ) ;
...
V_7 -> V_114 = F_24 ;
F_33 ( V_5 -> V_29 , L_2 ,
V_5 -> V_115 -> V_116 , V_5 -> V_79 ,
V_5 -> V_20 , V_5 -> V_1 ) ;
return 0 ;
}
static int F_34 ( struct V_68 * V_69 )
{
return F_35 ( V_69 , & V_117 ) ;
}
