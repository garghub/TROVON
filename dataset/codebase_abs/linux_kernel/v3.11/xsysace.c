...
static void F_70 ( struct V_103 * V_112 , T_6 V_108 )
{
...
static int F_90 ( struct V_143 * V_20 , int V_30 , T_7 V_123 ,
int V_35 , int V_134 )
{
struct V_1 * V_2 ;
int V_122 ;
...
static void F_94 ( struct V_143 * V_20 )
{
...
static int F_96 ( struct V_149 * V_20 )
{
T_7 V_123 = 0 ;
int V_134 = V_135 ;
T_4 V_30 = V_20 -> V_30 ;
...
if ( F_97 ( V_20 -> V_20 . V_150 , L_45 , & V_30 ) )
V_30 = 0 ;
...
static int F_99 ( struct V_149 * V_20 )
{
F_94 ( & V_20 -> V_20 ) ;
return 0 ;
}
