...
V_47 = V_17 -> V_18 -> V_2 ;
while ( V_48 < V_47 -> V_14 ) {
struct V_7 * V_49 = & V_47 -> V_8 [ V_48 ] ;
if ( V_49 != V_17 -> V_43 ) {
V_48 ++ ;
continue;
}
...
static int F_28 ( struct V_7 * V_17 , T_3 V_26 )
{
int V_34 ;
V_34 = F_29 ( V_17 -> V_18 -> V_2 , V_50 ,
V_17 -> V_18 , V_17 -> V_19 , V_26 ) ;
if ( V_34 < 0 && V_34 != - V_39 )
return V_34 ;
V_34 = F_29 ( V_17 -> V_19 -> V_2 , V_50 ,
V_17 -> V_19 , V_17 -> V_18 , V_26 ) ;
if ( V_34 < 0 && V_34 != - V_39 ) {
F_29 ( V_17 -> V_18 -> V_2 , V_50 ,
...
int F_30 ( struct V_7 * V_17 , T_3 V_26 )
{
const T_3 V_51 = V_27 ;
struct V_30 * V_31 ;
...
if ( V_17 == NULL )
return - V_53 ;
if ( ( V_17 -> V_26 & ~ V_51 ) != ( V_26 & ~ V_51 ) )
return - V_53 ;
if ( V_17 -> V_26 & V_54 )
return V_17 -> V_26 == V_26 ? 0 : - V_53 ;
if ( V_17 -> V_26 == V_26 )
return 0 ;
V_18 = V_17 -> V_18 -> V_2 ;
V_19 = V_17 -> V_19 -> V_2 ;
...
V_34 = F_28 ( V_17 , V_26 ) ;
if ( V_31 -> V_56 )
V_31 -> V_56 ( V_17 , V_26 , V_58 ) ;
return V_34 ;
}
int F_31 ( struct V_7 * V_17 , T_3 V_26 )
{
int V_34 ;
...
struct V_7 *
F_32 ( struct V_4 * V_18 , struct V_4 * V_19 )
{
struct V_7 * V_17 ;
unsigned int V_10 ;
...
struct V_4 * F_33 ( struct V_4 * V_59 )
{
unsigned int V_10 ;
for ( V_10 = 0 ; V_10 < V_59 -> V_2 -> V_14 ; V_10 ++ ) {
struct V_7 * V_17 = & V_59 -> V_2 -> V_8 [ V_10 ] ;
if ( ! ( V_17 -> V_26 & V_27 ) )
continue;
if ( V_17 -> V_18 == V_59 )
return V_17 -> V_19 ;
