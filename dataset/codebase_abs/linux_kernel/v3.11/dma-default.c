...
return F_41 ( V_5 , V_3 ) + V_33 ;
}
static void F_43 ( struct V_4 * V_5 , struct V_38 * V_39 ,
int V_45 , enum V_29 V_30 ,
struct V_22 * V_23 )
{
int V_41 ;
...
F_32 ( F_39 ( V_39 ) , V_39 -> V_33 , V_39 -> V_42 ,
V_30 ) ;
F_23 ( V_5 , V_39 -> V_44 , V_39 -> V_42 , V_30 ) ;
}
}
...
struct V_38 * V_39 , int V_46 , enum V_29 V_30 )
{
int V_41 ;
for ( V_41 = 0 ; V_41 < V_46 ; V_41 ++ , V_39 ++ ) {
if ( F_7 ( V_5 ) )
F_32 ( F_39 ( V_39 ) , V_39 -> V_33 , V_39 -> V_42 ,
V_30 ) ;
}
...
int F_49 ( struct V_4 * V_5 , T_2 V_6 )
{
return F_50 ( V_5 , V_6 ) ;
}
int F_51 ( struct V_4 * V_5 , T_5 V_47 )
{
return F_52 ( V_5 , V_47 ) ;
}
void F_53 ( struct V_4 * V_5 , void * V_25 , T_4 V_19 ,
enum V_29 V_30 )
{
F_54 ( V_30 == V_48 ) ;
F_46 ( V_5 ) ;
