...
struct V_12 * V_13 , void * V_21 )
{
struct V_14 * V_15 = V_21 ;
F_9 ( F_10 ( & V_15 -> V_18 . V_19 ) ) ;
F_3 ( V_15 , V_16 ) ;
}
static void * F_11 ( const struct V_10 * V_11 ,
struct V_12 * V_13 )
{
struct V_22 * V_15 ;
F_5 ( V_15 , V_23 , V_17 ) ;
...
static void F_12 ( const struct V_10 * V_11 ,
struct V_12 * V_13 , void * V_21 )
{
struct V_22 * V_15 = V_21 ;
F_3 ( V_15 , V_23 ) ;
}
...
F_29 ( V_56 , V_57 * sizeof V_56 [ 0 ] ) ;
}
static struct V_24 * F_30 ( const struct V_1 * V_2 ,
struct V_24 * V_25 )
{
struct V_27 * V_28 = F_14 ( V_25 ) ;
...
F_31 ( F_32 ( V_25 ) ) ;
if ( V_28 -> V_30 != NULL )
F_29 ( V_28 -> V_30 , V_57 * sizeof V_28 -> V_30 [ 0 ] ) ;
if ( V_28 -> V_64 != NULL )
F_26 ( V_28 -> V_64 , V_57 ) ;
F_28 ( V_28 ) ;
return NULL ;
}
static void F_33 ( const struct V_1 * V_2 , struct V_24 * V_49 ,
T_1 V_65 )
{
...
static struct V_55 * * F_34 ( int V_57 )
{
struct V_55 * * V_66 ;
int V_26 ;
int V_52 ;
F_35 ( V_66 , V_57 * sizeof V_66 [ 0 ] ) ;
if ( V_66 == NULL )
return F_7 ( - V_20 ) ;
...
static int F_39 ( const struct V_1 * V_2 , struct V_27 * V_49 )
{
int V_52 ;
T_1 V_71 ;
T_1 V_72 ;
...
static int F_42 ( const struct V_1 * V_2 , struct V_24 * V_49 ,
T_1 V_65 )
{
...
F_43 ( V_78 ) ;
V_88 = V_87 -> V_90 ;
V_35 = F_48 ( V_25 -> V_79 , V_87 , & V_65 , & V_89 ) ;
if ( V_35 == 0 ) {
switch( V_88 ) {
case V_91 :
case V_92 :
V_35 = F_42 ( V_2 , V_25 , V_65 ) ;
if ( V_35 != 0 )
F_49 ( V_25 -> V_79 , V_65 , 0 , 0 ) ;
break;
case V_93 :
F_33 ( V_2 , V_25 , V_65 ) ;
break;
...
static struct V_24 * F_50 ( const struct V_1 * V_2 ,
struct V_94 * V_95 ,
struct V_86 * V_87 )
{
struct V_24 * V_25 ;
...
F_53 ( & V_28 -> V_76 ) ;
F_54 ( & V_28 -> V_76 , & V_101 ) ;
V_78 = F_55 ( F_56 ( V_87 , 0 ) ) ;
F_15 ( V_78 != NULL ) ;
V_35 = F_57 ( V_78 , V_87 ) ;
if ( V_35 ) {
F_30 ( V_2 , V_25 ) ;
