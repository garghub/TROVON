...
V_180 -> V_238 = & V_239 ;
F_83 ( V_2 ) ;
V_180 -> V_240 |= V_241 | V_242 ;
if ( V_9 && V_9 -> V_240 )
V_180 -> V_240 |= V_9 -> V_240 ;
V_180 -> V_243 = 32 ;
V_180 -> V_244 = 512 ;
V_180 -> V_245 = V_246 * V_180 -> V_243 ;
V_180 -> V_247 = V_180 -> V_245 / V_180 -> V_244 ;
V_180 -> V_248 = V_180 -> V_245 ;
F_94 ( V_232 , V_2 ) ;
F_95 ( & V_232 -> V_10 ) ;
V_2 -> V_203 = false ;
