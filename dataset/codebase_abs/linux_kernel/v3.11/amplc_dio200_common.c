...
unsigned int V_142 ;
unsigned int V_143 ;
V_142 = 1 << F_22 ( V_26 -> V_106 ) ;
if ( V_142 & 0x0000ff )
V_143 = 0x0000ff ;
else if ( V_142 & 0x00ff00 )
V_143 = 0x00ff00 ;
else if ( V_142 & 0x0f0000 )
V_143 = 0x0f0000 ;
else
V_143 = 0xf00000 ;
switch ( V_27 [ 0 ] ) {
...
break;
case V_146 :
V_27 [ 1 ] = ( V_24 -> V_136 & V_143 ) ? V_147 : V_148 ;
return V_26 -> V_33 ;
break;
default:
return - V_50 ;
...
{
unsigned int clock ;
clock = F_13 ( V_9 , V_151 ) & V_152 ;
F_16 ( V_9 , V_151 , clock | V_153 ) ;
F_16 ( V_9 , V_151 , clock ) ;
}
...
{
unsigned int V_156 ;
V_156 = F_13 ( V_9 , V_151 ) & V_152 ;
* V_154 = V_156 ;
* V_155 = ( V_156 < F_61 ( V_157 ) ) ?
V_157 [ V_156 ] : 0 ;
}
...
int F_66 ( struct V_8 * V_9 , unsigned int V_94 ,
unsigned long V_163 )
{
const struct V_5 * V_11 = F_6 ( V_9 ) ;
struct V_12 * V_13 = V_9 -> V_14 ;
...
int V_116 ;
V_13 -> V_99 = - 1 ;
V_116 = F_67 ( V_9 , V_7 -> V_165 ) ;
if ( V_116 )
return V_116 ;
for ( V_33 = 0 ; V_33 < V_9 -> V_166 ; V_33 ++ ) {
V_24 = & V_9 -> V_100 [ V_33 ] ;
switch ( V_7 -> V_167 [ V_33 ] ) {
case V_168 :
V_116 = F_53 ( V_9 , V_24 ,
V_7 -> V_169 [ V_33 ] ) ;
if ( V_116 < 0 )
...
V_164 = V_13 -> V_99 ;
if ( V_164 >= 0 && V_164 < V_9 -> V_166 )
V_9 -> V_175 = & V_9 -> V_100 [ V_164 ] ;
if ( V_94 ) {
if ( F_68 ( V_94 , F_40 , V_163 ,
V_9 -> V_176 , V_9 ) >= 0 ) {
V_9 -> V_94 = V_94 ;
} else {
F_69 ( V_9 -> V_177 ,
