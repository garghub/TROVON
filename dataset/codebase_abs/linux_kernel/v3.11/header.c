...
V_12 -> V_238 = F_80 ( V_15 , 0 , V_147 ) ;
V_12 -> V_239 = V_7 * sizeof( struct V_3 ) ;
if ( V_6 ) {
V_25 = F_10 ( V_15 , V_6 , V_12 -> V_239 ) ;
if ( V_25 < 0 ) {
F_32 ( L_85 ) ;
return V_25 ;
}
...
void * V_207 ,
int (* F_151)( struct V_206 * T_13 ,
struct V_11 * V_29 ,
int V_13 , int V_15 , void * V_207 ) )
{
struct V_206 * V_222 , * V_243 ;
int V_221 ;
int V_223 ;
int V_13 ;
int V_25 ;
...
if ( ! V_221 )
return 0 ;
V_222 = V_243 = calloc ( V_221 , sizeof( * V_222 ) ) ;
if ( ! V_222 )
return - 1 ;
V_223 = sizeof( * V_222 ) * V_221 ;
F_80 ( V_15 , V_12 -> V_226 + V_12 -> V_227 , V_149 ) ;
V_25 = F_149 ( V_12 , V_15 , V_222 , V_223 ) ;
if ( V_25 < 0 )
goto V_80;
F_146 (feat, header->adds_features, HEADER_LAST_FEATURE) {
V_25 = F_151 ( V_243 ++ , V_12 , V_13 , V_15 , V_207 ) ;
if ( V_25 < 0 )
goto V_80;
}
V_25 = 0 ;
...
static int F_152 ( T_10 V_244 , struct V_11 * V_29 )
{
T_10 V_245 , V_240 ;
int V_10 ;
for ( V_10 = 0 ; V_246 [ V_10 ] ; V_10 ++ ) {
V_245 = V_246 [ V_10 ]
+ sizeof( struct V_206 ) ;
if ( V_244 != V_245 ) {
V_240 = F_99 ( V_244 ) ;
...
static int F_153 ( T_10 V_244 , struct V_11 * V_29 )
{
T_1 V_240 ;
int V_10 ;
for ( V_10 = 0 ; V_247 [ V_10 ] ; V_10 ++ ) {
if ( V_244 != V_247 [ V_10 ] ) {
V_240 = F_99 ( V_244 ) ;
if ( V_240 != V_244 )
continue;
...
bool F_154 ( T_1 V_230 )
{
if ( ! memcmp ( & V_230 , V_248 , sizeof( V_230 ) )
|| V_230 == V_249
|| V_230 == V_250 )
return true ;
return false ;
}
static int F_155 ( T_1 V_230 , T_10 V_244 ,
bool V_251 , struct V_11 * V_29 )
{
int V_18 ;
V_18 = memcmp ( & V_230 , V_248 , sizeof( V_230 ) ) ;
if ( V_18 == 0 ) {
F_32 ( L_88 ) ;
if ( V_251 )
return F_153 ( V_244 , V_29 ) ;
return F_152 ( V_244 , V_29 ) ;
}
if ( V_230 == V_249 )
return 0 ;
if ( V_230 != V_250 )
...
return - 1 ;
if ( F_155 ( V_12 -> V_230 ,
V_12 -> V_240 , false , V_29 ) < 0 ) {
F_32 ( L_89 ) ;
return - 1 ;
}
if ( V_29 -> V_31 ) {
F_150 ( V_12 , F_157 ( struct V_233 ,
V_14 ) ) ;
}
if ( V_12 -> V_17 != sizeof( * V_12 ) ) {
if ( V_12 -> V_17 == F_157 ( F_158 ( * V_12 ) , V_14 ) )
F_159 ( V_12 -> V_14 , V_225 ) ;
else
return - 1 ;
} else if ( V_29 -> V_31 ) {
F_150 ( & V_12 -> V_14 ,
F_160 ( V_225 ) ) ;
if ( ! F_9 ( V_252 , V_12 -> V_14 ) ) {
F_150 ( & V_12 -> V_14 ,
F_160 ( V_225 ) ) ;
F_161 ( & V_12 -> V_14 ,
F_162 ( V_225 ) ) ;
...
sizeof( V_29 -> V_14 ) ) ;
V_29 -> V_238 = V_12 -> V_242 . V_146 ;
V_29 -> V_239 = V_12 -> V_242 . V_17 ;
V_29 -> V_226 = V_12 -> V_207 . V_146 ;
V_29 -> V_227 = V_12 -> V_207 . V_17 ;
return 0 ;
}
static int F_163 ( struct V_206 * T_13 ,
struct V_11 * V_29 ,
int V_13 , int V_15 , void * V_207 )
{
if ( F_80 ( V_15 , T_13 -> V_146 , V_149 ) == ( T_11 ) - 1 ) {
...
if ( ! V_217 [ V_13 ] . F_151 )
return 0 ;
return V_217 [ V_13 ] . F_151 ( T_13 , V_29 , V_15 , V_207 ) ;
}
static int F_164 ( struct V_228 * V_12 ,
struct V_11 * V_29 , int V_15 ,
bool V_254 )
{
int V_18 ;
...
if ( V_18 <= 0 )
return - 1 ;
if ( F_155 ( V_12 -> V_230 , V_12 -> V_17 , true , V_29 ) < 0 ) {
F_32 ( L_91 ) ;
return - 1 ;
}
if ( V_29 -> V_31 )
V_12 -> V_17 = F_99 ( V_12 -> V_17 ) ;
if ( V_254 && F_10 ( V_255 , V_12 , sizeof( * V_12 ) ) < 0 )
return - 1 ;
return 0 ;
}
static int F_165 ( struct V_61 * V_62 , int V_15 )
{
struct V_11 * V_12 = & V_62 -> V_12 ;
struct V_228 V_229 ;
if ( F_164 ( & V_229 , V_12 , V_15 ,
V_62 -> V_254 ) < 0 ) {
F_32 ( L_92 ) ;
return - V_256 ;
}
...
static int F_166 ( int V_15 , struct V_11 * V_29 ,
struct V_234 * V_235 )
{
struct V_257 * V_116 = & V_235 -> V_116 ;
T_2 V_30 , V_258 ;
T_2 V_259 = sizeof( V_235 -> V_116 ) ;
int V_18 ;
memset ( V_235 , 0 , sizeof( * V_235 ) ) ;
V_18 = F_16 ( V_15 , V_116 , V_260 ) ;
if ( V_18 <= 0 ) {
F_32 ( L_93 ,
V_260 ) ;
return - 1 ;
...
void * V_261 = V_116 ;
V_261 += V_260 ;
V_18 = F_16 ( V_15 , V_261 , V_258 ) ;
}
V_18 = F_16 ( V_15 , & V_235 -> V_117 , sizeof( V_235 -> V_117 ) ) ;
return V_18 <= 0 ? - 1 : 0 ;
}
static int F_167 ( struct V_111 * V_112 ,
struct V_262 * V_262 )
{
struct V_263 * V_208 ;
char V_20 [ 128 ] ;
...
V_208 = F_168 ( V_262 , V_112 -> V_116 . V_175 ) ;
if ( V_208 == NULL )
return - 1 ;
if ( ! V_112 -> V_2 ) {
...
static int F_169 ( struct V_89 * V_90 ,
struct V_262 * V_262 )
{
struct V_111 * V_46 ;
F_67 (pos, &evlist->entries, node) {
if ( V_46 -> V_116 . type == V_265 &&
F_167 ( V_46 , V_262 ) )
return - 1 ;
}
return 0 ;
}
int F_170 ( struct V_61 * V_62 , int V_15 )
{
struct V_11 * V_12 = & V_62 -> V_12 ;
struct V_233 V_229 ;
struct V_234 V_235 ;
T_1 V_266 ;
int V_267 , V_268 , V_10 , V_142 ;
V_62 -> V_90 = F_171 () ;
if ( V_62 -> V_90 == NULL )
return - V_8 ;
if ( V_62 -> V_269 )
return F_165 ( V_62 , V_15 ) ;
if ( F_156 ( & V_229 , V_12 , V_15 ) < 0 )
return - V_256 ;
V_267 = V_229 . V_241 . V_17 / V_229 . V_240 ;
F_80 ( V_15 , V_229 . V_241 . V_146 , V_149 ) ;
for ( V_10 = 0 ; V_10 < V_267 ; V_10 ++ ) {
struct V_111 * V_112 ;
T_11 V_184 ;
if ( F_166 ( V_15 , V_12 , & V_235 ) < 0 )
goto V_270;
if ( V_12 -> V_31 )
F_98 ( & V_235 . V_116 ) ;
V_184 = F_80 ( V_15 , 0 , V_147 ) ;
V_112 = F_172 ( & V_235 . V_116 , V_10 ) ;
if ( V_112 == NULL )
goto V_271;
V_112 -> V_31 = V_12 -> V_31 ;
F_173 ( V_62 -> V_90 , V_112 ) ;
V_268 = V_235 . V_117 . V_17 / sizeof( T_1 ) ;
if ( F_174 ( V_112 , 1 , V_268 ) )
goto V_271;
F_80 ( V_15 , V_235 . V_117 . V_146 , V_149 ) ;
for ( V_142 = 0 ; V_142 < V_268 ; V_142 ++ ) {
if ( F_149 ( V_12 , V_15 , & V_266 , sizeof( V_266 ) ) )
goto V_270;
F_175 ( V_62 -> V_90 , V_112 , 0 , V_142 , V_266 ) ;
}
F_80 ( V_15 , V_184 , V_149 ) ;
}
V_78 . V_272 = V_267 ;
if ( V_229 . V_242 . V_17 ) {
F_80 ( V_15 , V_229 . V_242 . V_146 , V_149 ) ;
V_6 = malloc ( V_229 . V_242 . V_17 ) ;
if ( V_6 == NULL )
return - V_8 ;
if ( F_149 ( V_12 , V_15 , V_6 ,
V_229 . V_242 . V_17 ) )
goto V_270;
V_7 = V_229 . V_242 . V_17 / sizeof( struct V_3 ) ;
}
F_142 ( V_12 , V_15 , & V_62 -> V_262 ,
F_163 ) ;
...
int F_177 ( struct V_273 * V_274 ,
struct V_257 * V_116 , T_3 V_117 , T_1 * V_1 ,
T_14 F_151 )
{
union V_275 * V_276 ;
T_2 V_17 ;
int V_25 ;
V_17 = sizeof( struct V_257 ) ;
...
if ( V_276 == NULL )
return - V_8 ;
V_276 -> V_116 . V_116 = * V_116 ;
memcpy ( V_276 -> V_116 . V_1 , V_1 , V_117 * sizeof( T_1 ) ) ;
V_276 -> V_116 . V_12 . type = V_277 ;
V_276 -> V_116 . V_12 . V_17 = ( T_7 ) V_17 ;
if ( V_276 -> V_116 . V_12 . V_17 == V_17 )
V_25 = F_151 ( V_274 , V_276 , NULL , NULL ) ;
else
V_25 = - V_278 ;
free ( V_276 ) ;
return V_25 ;
}
int F_178 ( struct V_273 * V_274 ,
struct V_61 * V_62 ,
T_14 F_151 )
{
struct V_111 * V_112 ;
int V_25 = 0 ;
F_67 (evsel, &session->evlist->entries, node) {
V_25 = F_177 ( V_274 , & V_112 -> V_116 , V_112 -> V_117 ,
V_112 -> V_1 , F_151 ) ;
if ( V_25 ) {
F_32 ( L_98 ) ;
return V_25 ;
...
int F_179 ( union V_275 * V_208 ,
struct V_89 * * V_279 )
{
T_3 V_10 , V_117 , V_280 ;
struct V_111 * V_112 ;
struct V_89 * V_90 = * V_279 ;
if ( V_90 == NULL ) {
* V_279 = V_90 = F_171 () ;
if ( V_90 == NULL )
return - V_8 ;
}
V_112 = F_172 ( & V_208 -> V_116 . V_116 , V_90 -> V_115 ) ;
if ( V_112 == NULL )
return - V_8 ;
F_173 ( V_90 , V_112 ) ;
V_117 = V_208 -> V_12 . V_17 ;
V_117 -= ( void * ) & V_208 -> V_116 . V_1 - ( void * ) V_208 ;
V_280 = V_117 / sizeof( T_1 ) ;
if ( F_174 ( V_112 , 1 , V_280 ) )
return - V_8 ;
for ( V_10 = 0 ; V_10 < V_280 ; V_10 ++ ) {
F_175 ( V_90 , V_112 , 0 , V_10 , V_208 -> V_116 . V_1 [ V_10 ] ) ;
}
V_78 . V_272 = V_90 -> V_115 ;
return 0 ;
}
int F_180 ( struct V_273 * V_274 ,
T_1 V_9 , char * V_2 ,
T_14 F_151 ,
struct V_52 * V_52 )
{
...
V_276 . V_281 . V_281 . V_9 = V_9 ;
memset ( V_276 . V_281 . V_281 . V_2 , 0 , V_5 ) ;
strncpy ( V_276 . V_281 . V_281 . V_2 , V_2 , V_5 - 1 ) ;
V_276 . V_281 . V_12 . type = V_282 ;
V_17 = strlen ( V_276 . V_281 . V_281 . V_2 ) ;
V_17 = F_14 ( V_17 , sizeof( T_1 ) ) ;
V_276 . V_281 . V_12 . V_17 = sizeof( V_276 . V_281 ) -
( sizeof( V_276 . V_281 . V_281 . V_2 ) - V_17 ) ;
V_25 = F_151 ( V_274 , & V_276 , NULL , V_52 ) ;
return V_25 ;
}
int F_181 ( struct V_273 * V_274 ,
T_14 F_151 ,
struct V_52 * V_52 )
{
struct V_3 * type ;
...
int F_182 ( struct V_273 * V_274 V_88 ,
union V_275 * V_208 )
{
if ( F_1 ( V_208 -> V_281 . V_281 . V_9 ,
V_208 -> V_281 . V_281 . V_2 ) < 0 )
return - V_8 ;
return 0 ;
}
int F_183 ( struct V_273 * V_274 , int V_15 ,
struct V_89 * V_90 ,
T_14 F_151 )
{
union V_275 V_276 ;
struct V_283 * V_284 ;
T_4 V_17 = 0 , V_285 = 0 , V_286 ;
int V_25 V_88 = 0 ;
V_284 = F_184 ( & V_90 -> V_91 , V_15 , true ) ;
if ( ! V_284 )
return - 1 ;
memset ( & V_276 , 0 , sizeof( V_276 ) ) ;
V_276 . V_283 . V_12 . type = V_287 ;
V_17 = V_284 -> V_17 ;
V_285 = F_14 ( V_17 , sizeof( T_1 ) ) ;
V_286 = V_285 - V_17 ;
V_276 . V_283 . V_12 . V_17 = sizeof( V_276 . V_283 ) ;
V_276 . V_283 . V_17 = V_285 ;
F_151 ( V_274 , & V_276 , NULL , NULL ) ;
F_185 ( V_284 ) ;
F_12 ( V_15 , NULL , 0 , V_286 ) ;
return V_285 ;
}
int F_186 ( union V_275 * V_208 ,
struct V_61 * V_62 )
{
T_4 V_288 , V_286 , V_17 = V_208 -> V_283 . V_17 ;
T_11 V_146 = F_80 ( V_62 -> V_15 , 0 , V_147 ) ;
char V_16 [ V_289 ] ;
F_80 ( V_62 -> V_15 , V_146 + sizeof( struct V_290 ) ,
V_149 ) ;
V_288 = F_116 ( V_62 -> V_15 , & V_62 -> V_262 ,
V_62 -> V_254 ) ;
V_286 = F_14 ( V_288 , sizeof( T_1 ) ) - V_288 ;
if ( F_16 ( V_62 -> V_15 , V_16 , V_286 ) < 0 ) {
F_187 ( L_100 , V_291 ) ;
return - 1 ;
}
if ( V_62 -> V_254 ) {
int V_292 = F_11 ( V_255 , V_16 , V_286 ) ;
...
V_27 = V_46 -> V_51 + 1 ;
V_27 = F_14 ( V_27 , V_24 ) ;
memcpy ( & V_276 . V_37 . V_37 , V_46 -> V_37 , sizeof( V_46 -> V_37 ) ) ;
V_276 . V_37 . V_12 . type = V_293 ;
V_276 . V_37 . V_12 . V_39 = V_39 ;
V_276 . V_37 . V_38 = V_52 -> V_38 ;
V_276 . V_37 . V_12 . V_17 = sizeof( V_276 . V_37 ) + V_27 ;
memcpy ( & V_276 . V_37 . V_74 , V_46 -> V_50 , V_46 -> V_51 ) ;
V_25 = F_151 ( V_274 , & V_276 , NULL , V_52 ) ;
return V_25 ;
}
int F_189 ( struct V_273 * V_274 V_88 ,
union V_275 * V_208 ,
struct V_61 * V_62 )
{
F_108 ( & V_208 -> V_37 ,
