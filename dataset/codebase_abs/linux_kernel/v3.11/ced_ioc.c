...
V_88 = F_49 ( V_111 , V_111 -> V_112 , V_102 , V_106 , 1 , 0 ,
V_87 , NULL ) ;
...
int F_64 ( T_1 * V_1 , T_9 T_2 * V_148 )
{
unsigned int V_29 , error ;
int V_17 ;
T_9 V_149 ;
...
static int F_68 ( T_1 * V_1 , unsigned char V_168 ,
unsigned int V_169 )
{
int V_17 ;
F_2 ( & V_1 -> V_2 -> V_3 , L_40 , V_4 ) ;
V_17 = F_15 ( V_1 -> V_31 , F_69 ( V_1 -> V_31 , 0 ) , V_168 ,
( V_146 | V_34 | V_35 ) ,
( unsigned short ) V_169 ,
( unsigned short ) ( V_169 >> 16 ) , NULL , 0 , V_37 ) ;
if ( V_17 < 0 )
...
V_17 = F_68 ( V_1 , V_173 , V_171 . V_172 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_174 , V_171 . V_175 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_176 , V_171 . V_177 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_178 , 0 ) ;
F_12 ( & V_1 -> V_27 ) ;
return V_17 ;
}
...
V_17 = F_68 ( V_1 , V_176 , V_171 . V_177 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_179 , V_171 . V_180 ) ;
F_12 ( & V_1 -> V_27 ) ;
return V_17 ;
}
...
V_17 = F_68 ( V_1 , V_173 , V_171 . V_172 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_181 , V_171 . V_182 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_183 , V_171 . V_184 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_174 , V_171 . V_175 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_176 , V_171 . V_177 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_185 , 0 ) ;
F_12 ( & V_1 -> V_27 ) ;
return V_17 ;
}
...
V_17 = F_68 ( V_1 , V_176 , V_171 . V_177 ) ;
if ( V_17 == V_24 )
V_17 = F_68 ( V_1 , V_186 , 0 ) ;
F_12 ( & V_1 -> V_27 ) ;
return V_17 ;
}
int F_74 ( T_1 * V_1 , T_10 T_2 * V_170 )
{
int V_17 ;
T_10 V_171 ;
...
int F_76 ( T_1 * V_1 , T_6 T_2 * V_120 )
{
int V_17 ;
bool V_190 ;
T_6 V_121 ;
...
int F_78 ( T_1 * V_1 , T_11 T_2 * V_192 )
{
int V_17 = V_24 ;
