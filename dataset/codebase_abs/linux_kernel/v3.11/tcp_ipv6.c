...
goto V_265;
#ifdef F_26
F_66 ( V_153 ) -> V_83 = & V_268 ;
#endif
F_141 ( & V_260 ) ;
V_260 . V_109 = V_110 - sizeof( struct V_111 ) - sizeof( struct V_112 ) ;
V_260 . V_269 = V_41 -> V_66 . V_269 ;
F_142 ( V_7 , & V_260 , 0 , NULL ) ;
if ( V_263 && ! V_260 . V_270 )
F_141 ( & V_260 ) ;
V_260 . V_271 = V_260 . V_270 ;
...
V_164 -> V_272 = V_3 -> V_65 ;
if ( ! V_3 -> V_65 &&
F_22 ( & V_164 -> V_168 ) & V_63 )
V_164 -> V_272 = F_64 ( V_7 ) ;
if ( ! V_261 ) {
if ( F_145 ( V_3 , V_7 ) ||
V_39 -> V_273 . V_274 . V_275 || V_39 -> V_273 . V_274 . V_276 ||
V_39 -> V_273 . V_274 . V_277 || V_39 -> V_273 . V_274 . V_278 ) {
F_146 ( & V_7 -> V_279 ) ;
V_164 -> V_172 = V_7 ;
}
if ( V_263 ) {
V_261 = F_147 ( V_3 , V_7 , & V_153 -> V_280 ) ;
V_153 -> V_281 = V_260 . V_271 ;
goto V_282;
}
if ( V_260 . V_270 &&
V_104 . V_105 &&
...
V_297 -> V_65 = V_164 -> V_272 ;
V_295 -> V_309 = NULL ;
V_292 -> V_301 = NULL ;
V_292 -> V_302 = NULL ;
V_292 -> V_273 . V_310 = V_39 -> V_273 . V_310 ;
V_292 -> V_303 = NULL ;
if ( V_164 -> V_172 != NULL ) {
...
if ( F_17 ( V_3 ) -> V_66 . V_269 &&
F_17 ( V_3 ) -> V_66 . V_269 < V_296 -> V_311 )
V_296 -> V_311 = F_17 ( V_3 ) -> V_66 . V_269 ;
F_167 ( V_297 ) ;
F_168 ( V_297 , V_153 ) ;
V_296 -> V_312 = V_153 -> V_313 ;
V_295 -> V_300 = V_295 -> V_89 = V_101 ;
V_295 -> V_90 = V_101 ;
#ifdef F_26
if ( ( V_199 = F_1 ( V_3 , & V_292 -> V_24 ) ) != NULL ) {
F_91 ( V_297 , (union V_173 * ) & V_292 -> V_24 ,
V_51 , V_199 -> V_199 , V_199 -> V_314 ,
F_161 ( V_3 , V_226 ) ) ;
}
#endif
if ( F_169 ( V_3 , V_297 ) < 0 ) {
F_170 ( V_297 ) ;
F_69 ( V_297 ) ;
goto V_138;
}
...
{
if ( V_7 -> V_234 == V_315 ) {
if ( ! F_172 ( V_7 -> V_196 , & F_14 ( V_7 ) -> V_26 ,
& F_14 ( V_7 ) -> V_24 , V_7 -> V_236 ) ) {
V_7 -> V_234 = V_316 ;
return 0 ;
}
}
V_7 -> V_236 = ~ F_173 ( F_172 ( V_7 -> V_196 ,
& F_14 ( V_7 ) -> V_26 ,
& F_14 ( V_7 ) -> V_24 , 0 ) ) ;
if ( V_7 -> V_196 <= 76 ) {
return F_174 ( V_7 ) ;
...
goto V_318;
if ( V_39 -> V_273 . V_310 )
V_317 = F_160 ( V_7 , F_161 ( V_3 , V_226 ) ) ;
if ( V_3 -> V_18 == V_319 ) {
struct V_8 * V_9 = V_3 -> V_12 ;
F_176 ( V_3 , V_7 ) ;
if ( V_9 ) {
if ( F_5 ( V_3 ) -> V_13 != V_7 -> V_14 ||
V_9 -> V_148 -> V_320 ( V_9 , V_39 -> V_16 ) == NULL ) {
F_154 ( V_9 ) ;
V_3 -> V_12 = NULL ;
}
}
if ( F_177 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_196 ) )
goto V_321;
if ( V_317 )
goto V_322;
return 0 ;
}
if ( V_7 -> V_196 < F_178 ( V_7 ) || F_179 ( V_7 ) )
goto V_323;
if ( V_3 -> V_18 == V_142 ) {
...
F_176 ( V_3 , V_7 ) ;
if ( F_182 ( V_3 , V_7 , F_15 ( V_7 ) , V_7 -> V_196 ) )
goto V_321;
if ( V_317 )
goto V_322;
return 0 ;
...
V_322:
V_41 = F_17 ( V_3 ) ;
if ( F_134 ( V_317 ) -> V_326 == V_41 -> V_327 &&
! ( ( 1 << V_3 -> V_18 ) & ( V_119 | V_118 ) ) ) {
if ( V_39 -> V_273 . V_274 . V_275 || V_39 -> V_273 . V_274 . V_276 )
V_39 -> V_304 = F_64 ( V_317 ) ;
if ( V_39 -> V_273 . V_274 . V_277 || V_39 -> V_273 . V_274 . V_278 )
V_39 -> V_305 = F_14 ( V_317 ) -> V_139 ;
if ( V_39 -> V_273 . V_274 . V_328 )
V_39 -> V_306 = F_158 ( F_14 ( V_7 ) ) ;
if ( F_145 ( V_3 , V_317 ) ) {
F_163 ( V_317 , V_3 ) ;
V_317 = F_183 ( & V_39 -> V_303 , V_317 ) ;
} else {
F_181 ( V_317 ) ;
V_317 = F_183 ( & V_39 -> V_303 , NULL ) ;
}
}
F_83 ( V_317 ) ;
return 0 ;
...
goto V_332;
F_81 ( V_130 , V_333 ) ;
if ( ! F_185 ( V_7 , sizeof( struct V_111 ) ) )
goto V_332;
V_128 = F_15 ( V_7 ) ;
if ( V_128 -> V_204 < sizeof( struct V_111 ) / 4 )
goto V_334;
if ( ! F_185 ( V_7 , V_128 -> V_204 * 4 ) )
goto V_332;
...
F_134 ( V_7 ) -> V_326 = ( F_134 ( V_7 ) -> V_129 + V_128 -> V_242 + V_128 -> V_243 +
V_7 -> V_196 - V_128 -> V_204 * 4 ) ;
F_134 ( V_7 ) -> V_227 = F_57 ( V_128 -> V_227 ) ;
F_134 ( V_7 ) -> V_262 = 0 ;
F_134 ( V_7 ) -> V_336 = F_158 ( V_126 ) ;
F_134 ( V_7 ) -> V_337 = 0 ;
V_3 = F_187 ( & V_132 , V_7 , V_128 -> V_28 , V_128 -> V_27 ) ;
if ( ! V_3 )
goto V_338;
V_339:
if ( V_3 -> V_18 == V_135 )
...
#ifdef F_191
struct V_40 * V_41 = F_17 ( V_3 ) ;
if ( ! V_41 -> V_343 . V_344 && V_41 -> V_343 . V_345 )
V_41 -> V_343 . V_344 = F_192 () ;
if ( V_41 -> V_343 . V_344 )
V_329 = V_86 ( V_3 , V_7 ) ;
else
#endif
...
return V_329 ? - 1 : 0 ;
V_338:
if ( ! F_188 ( NULL , V_342 , V_7 ) )
goto V_332;
if ( V_7 -> V_196 < ( V_128 -> V_204 << 2 ) || F_179 ( V_7 ) ) {
V_335:
F_81 ( V_130 , V_324 ) ;
V_334:
F_81 ( V_130 , V_325 ) ;
...
{
struct V_2 * V_350 ;
V_350 = F_120 ( F_48 ( V_7 -> V_131 ) , & V_132 ,
& F_14 ( V_7 ) -> V_26 , V_128 -> V_28 ,
& F_14 ( V_7 ) -> V_24 ,
...
if ( V_7 -> V_330 != V_331 )
return;
if ( ! F_185 ( V_7 , F_199 ( V_7 ) + sizeof( struct V_111 ) ) )
return;
V_126 = F_14 ( V_7 ) ;
V_128 = F_15 ( V_7 ) ;
if ( V_128 -> V_204 < sizeof( struct V_111 ) / 4 )
...
static void F_207 ( struct V_356 * V_129 ,
const struct V_2 * V_3 , struct V_152 * V_153 , int V_357 , T_9 V_358 )
{
int V_359 = V_153 -> V_360 - V_361 ;
const struct V_4 * V_362 = & F_73 ( V_153 ) -> V_167 ;
...
L_8 ,
V_357 ,
V_362 -> V_25 [ 0 ] , V_362 -> V_25 [ 1 ] ,
V_362 -> V_25 [ 2 ] , V_362 -> V_25 [ 3 ] ,
F_108 ( F_209 ( V_153 ) -> V_363 ) ,
V_27 -> V_25 [ 0 ] , V_27 -> V_25 [ 1 ] ,
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] ,
F_108 ( F_209 ( V_153 ) -> V_364 ) ,
V_157 ,
0 , 0 ,
1 ,
F_210 ( V_359 ) ,
V_153 -> V_365 ,
F_211 ( F_212 ( V_129 ) , V_358 ) ,
0 ,
0 ,
0 , V_153 ) ;
}
static void F_213 ( struct V_356 * V_129 , struct V_2 * V_366 , int V_357 )
{
const struct V_4 * V_27 , * V_362 ;
T_10 V_367 , V_368 ;
int V_369 ;
unsigned long V_370 ;
const struct V_34 * V_35 = F_5 ( V_366 ) ;
const struct V_40 * V_41 = F_17 ( V_366 ) ;
const struct V_36 * V_37 = F_8 ( V_366 ) ;
const struct V_38 * V_39 = F_6 ( V_366 ) ;
V_27 = & V_39 -> V_24 ;
V_362 = & V_39 -> V_91 ;
V_367 = F_108 ( V_35 -> V_113 ) ;
V_368 = F_108 ( V_35 -> V_99 ) ;
if ( V_37 -> V_371 == V_372 ) {
V_369 = 1 ;
V_370 = V_37 -> V_373 ;
} else if ( V_37 -> V_371 == V_374 ) {
V_369 = 4 ;
V_370 = V_37 -> V_373 ;
} else if ( F_214 ( & V_366 -> V_375 ) ) {
V_369 = 2 ;
V_370 = V_366 -> V_375 . V_360 ;
} else {
V_369 = 0 ;
V_370 = V_361 ;
}
...
V_357 ,
V_362 -> V_25 [ 0 ] , V_362 -> V_25 [ 1 ] ,
V_362 -> V_25 [ 2 ] , V_362 -> V_25 [ 3 ] , V_368 ,
V_27 -> V_25 [ 0 ] , V_27 -> V_25 [ 1 ] ,
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] , V_367 ,
V_366 -> V_18 ,
V_41 -> V_69 - V_41 -> V_143 ,
( V_366 -> V_18 == V_142 ) ? V_366 -> V_376 : ( V_41 -> V_327 - V_41 -> V_377 ) ,
V_369 ,
F_215 ( V_370 - V_361 ) ,
V_37 -> V_378 ,
F_211 ( F_212 ( V_129 ) , F_216 ( V_366 ) ) ,
V_37 -> V_379 ,
F_217 ( V_366 ) ,
F_218 ( & V_366 -> V_380 ) , V_366 ,
F_210 ( V_37 -> V_381 ) ,
F_210 ( V_37 -> V_382 . V_383 ) ,
( V_37 -> V_382 . V_384 << 1 ) | V_37 -> V_382 . V_385 ,
V_41 -> V_386 ,
F_219 ( V_41 ) ? - 1 : V_41 -> V_387
) ;
}
static void F_220 ( struct V_356 * V_129 ,
struct V_244 * V_245 , int V_357 )
{
const struct V_4 * V_27 , * V_362 ;
T_10 V_367 , V_368 ;
const struct V_388 * V_389 = F_221 ( (struct V_2 * ) V_245 ) ;
long V_390 = V_245 -> V_391 - V_361 ;
V_27 = & V_389 -> V_392 ;
V_362 = & V_389 -> V_393 ;
V_367 = F_108 ( V_245 -> V_394 ) ;
V_368 = F_108 ( V_245 -> V_395 ) ;
F_208 ( V_129 ,
L_7
L_8 ,
V_357 ,
...
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] , V_367 ,
V_245 -> V_396 , 0 , 0 ,
3 , F_215 ( V_390 ) , 0 , 0 , 0 , 0 ,
F_218 ( & V_245 -> V_397 ) , V_245 ) ;
}
static int F_222 ( struct V_356 * V_129 , void * V_398 )
{
struct V_399 * V_400 ;
if ( V_398 == V_401 ) {
F_223 ( V_129 ,
...
case V_404 :
case V_405 :
F_213 ( V_129 , V_398 , V_400 -> V_406 ) ;
break;
case V_407 :
F_207 ( V_129 , V_400 -> V_408 , V_398 , V_400 -> V_406 , V_400 -> V_358 ) ;
break;
case V_409 :
F_220 ( V_129 , V_398 , V_400 -> V_406 ) ;
break;
}
V_138:
return 0 ;
...
{
return F_225 ( V_130 , & V_410 ) ;
}
void F_226 ( struct V_130 * V_130 )
{
F_227 ( V_130 , & V_410 ) ;
}
static void F_228 ( struct V_2 * V_3 , int V_411 )
{
struct V_34 * V_35 = F_5 ( V_3 ) ;
F_229 ( V_3 , F_230 ( struct V_34 , V_298 ) ) ;
V_411 -= F_230 ( struct V_34 , V_298 ) + sizeof( V_35 -> V_298 ) ;
memset ( & V_35 -> V_298 + 1 , 0 , V_411 ) ;
}
static int T_11 F_231 ( struct V_130 * V_130 )
{
return F_232 ( & V_130 -> V_220 . F_17 , V_412 ,
V_413 , V_93 , V_130 ) ;
}
static void T_12 F_233 ( struct V_130 * V_130 )
{
F_234 ( V_130 -> V_220 . F_17 ) ;
}
static void T_12 F_235 ( struct V_414 * V_415 )
{
F_236 ( & V_132 , & V_104 , V_51 ) ;
}
int T_13 F_237 ( void )
{
int V_329 ;
V_329 = F_238 ( & V_416 , V_93 ) ;
if ( V_329 )
goto V_138;
V_329 = F_239 ( & V_417 ) ;
if ( V_329 )
