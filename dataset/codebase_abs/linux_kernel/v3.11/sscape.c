...
if ( V_27 -> type != V_87 ) {
F_61 ( V_30 ) ;
F_13 ( & V_30 -> V_105 , V_16 ) ;
F_62 ( V_30 , V_106 , 0x20 ) ;
F_14 ( & V_30 -> V_105 , V_16 ) ;
F_63 ( V_30 ) ;
}
V_22 = F_64 ( V_30 , 0 , & V_104 ) ;
if ( V_22 < 0 ) {
F_5 ( V_9 L_15
L_16 ) ;
goto V_107;
...
V_111 = F_53 ( V_27 -> type , V_76 [ V_52 ] ) ;
if ( V_111 == V_81 ) {
F_5 ( V_9 L_31 , V_76 [ V_52 ] ) ;
V_22 = - V_118 ;
goto V_46;
}
V_112 = F_53 ( V_27 -> type , V_119 [ V_52 ] ) ;
if ( V_112 == V_81 ) {
F_5 ( V_9 L_31 , V_119 [ V_52 ] ) ;
V_22 = - V_118 ;
goto V_46;
}
F_13 ( & V_27 -> V_17 , V_16 ) ;
F_8 ( V_27 -> V_11 , V_53 , 0x2e ) ;
F_8 ( V_27 -> V_11 , V_120 , 0x00 ) ;
F_8 ( V_27 -> V_11 , V_121 , 0x50 ) ;
V_110 = ( V_27 -> V_47 == V_48 ? 0x40 : 0x70 ) ;
F_8 ( V_27 -> V_11 , V_39 , V_110 ) ;
...
F_8 ( V_27 -> V_11 , V_123 , 0xf0 | V_112 ) ;
F_8 ( V_27 -> V_11 ,
V_26 , 0x09 | V_38
| ( V_35 [ V_52 ] << 4 ) | ( V_111 << 1 ) ) ;
F_8 ( V_27 -> V_11 , V_124 , 0x80 ) ;
F_14 ( & V_27 -> V_17 , V_16 ) ;
V_22 = F_59 ( V_49 , V_115 [ V_52 ] , V_76 [ V_52 ] ,
V_35 [ V_52 ] , V_97 [ V_52 ] ) ;
if ( V_22 < 0 ) {
F_5 ( V_9
L_32 ,
V_115 [ V_52 ] , V_76 [ V_52 ] ) ;
goto V_46;
}
strcpy ( V_49 -> V_125 , L_21 ) ;
strcpy ( V_49 -> V_126 , V_55 ) ;
snprintf ( V_49 -> V_127 , sizeof( V_49 -> V_127 ) ,
L_33 ,
...
static int F_75 ( struct V_131 * V_132 , unsigned int V_133 )
{
if ( V_90 [ V_133 ] == V_134 )
return 0 ;
if ( V_76 [ V_133 ] == V_135 ||
...
static int F_76 ( struct V_131 * V_132 , unsigned int V_52 )
{
struct V_2 * V_49 ;
struct V_1 * V_27 ;
int V_36 ;
V_36 = F_77 ( V_137 [ V_52 ] , V_138 [ V_52 ] , V_139 ,
...
static int F_82 ( struct V_131 * V_141 , unsigned int V_52 )
{
F_81 ( F_83 ( V_141 ) ) ;
return 0 ;
}
static inline int F_84 ( int V_133 )
{
while ( V_133 < V_142 && V_90 [ V_133 ] != V_134 )
++ V_133 ;
return V_133 ;
}
static int F_85 ( struct V_143 * V_144 ,
...
if ( V_147 >= V_142 )
return - V_149 ;
V_52 = F_86 ( V_144 , V_146 -> V_150 [ 0 ] . V_138 , NULL ) ;
if ( ! V_52 )
return - V_88 ;
if ( ! F_87 ( V_52 ) ) {
if ( F_88 ( V_52 ) < 0 ) {
...
V_36 = F_77 ( V_137 [ V_147 ] , V_138 [ V_147 ] , V_139 ,
sizeof( struct V_1 ) , & V_49 ) ;
if ( V_36 < 0 )
return V_36 ;
V_27 = F_1 ( V_49 ) ;
if ( ! strncmp ( L_40 , V_146 -> V_138 , 7 ) )
V_27 -> type = V_87 ;
else
V_27 -> type = V_117 ;
V_90 [ V_147 ] = F_89 ( V_52 , 0 ) ;
V_76 [ V_147 ] = F_90 ( V_52 , 0 ) ;
V_119 [ V_147 ] = F_90 ( V_52 , 1 ) ;
V_35 [ V_147 ] = F_91 ( V_52 , 0 ) & 0x03 ;
if ( V_27 -> type == V_117 ) {
V_97 [ V_147 ] = V_35 [ V_147 ] ;
V_115 [ V_147 ] = F_92 ( V_90 [ V_147 ] ) ;
} else {
V_115 [ V_147 ] = F_89 ( V_52 , 1 ) ;
V_97 [ V_147 ] = F_91 ( V_52 , 1 ) ;
}
F_78 ( V_49 , & V_144 -> V_49 -> V_52 ) ;
V_36 = F_69 ( V_147 , V_49 ) ;
if ( V_36 < 0 )
goto V_140;
V_36 = F_79 ( V_49 ) ;
if ( V_36 < 0 ) {
