...
F_45 ( V_13 -> V_64 . V_33 , V_24 ) ;
F_46 ( V_13 -> V_64 . V_33 , V_85 ) ;
F_47 ( V_13 -> V_64 . V_33 , V_24 ) ;
}
}
...
unsigned long V_24 ;
if ( F_9 ( V_60 , & V_13 -> V_15 ) ) {
F_45 ( V_13 -> V_32 . V_33 , V_24 ) ;
F_46 ( V_13 -> V_32 . V_33 , V_85 ) ;
F_47 ( V_13 -> V_32 . V_33 , V_24 ) ;
}
}
static int F_48 ( struct V_12 * V_13 , struct V_86 * V_33 ,
unsigned int V_87 )
{
int V_1 ;
V_33 -> V_34 -> V_88 . V_89 =
...
V_33 -> V_34 -> V_88 . V_98 = F_49 ( V_13 -> V_99 ) ;
...
if ( V_1 < 0 )
return V_1 ;
V_1 = F_51 ( V_33 -> V_34 , 0 , 32 , 24 ) ;
return V_1 ;
}
static int F_52 ( struct V_86 * V_33 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
int V_1 ;
V_13 -> V_64 . V_33 = V_33 ;
V_1 = F_48 ( V_13 , V_33 , V_13 -> V_64 . V_87 ) ;
if ( V_1 < 0 )
return V_1 ;
V_33 -> V_34 -> V_88 . V_113 =
F_53 ( V_13 -> V_99 , V_13 -> V_111 ) ;
...
int V_1 ;
V_13 -> V_32 . V_33 = V_33 ;
V_1 = F_48 ( V_13 , V_33 , V_13 -> V_32 . V_87 ) ;
if ( V_1 < 0 )
return V_1 ;
V_33 -> V_34 -> V_88 . V_113 =
F_53 ( V_13 -> V_99 * V_13 -> V_32 . V_55 ,
V_13 -> V_111 ) ;
F_54 ( & V_13 -> V_114 ) ;
V_1 = F_37 ( V_13 ) ;
if ( V_1 < 0 )
...
static int F_58 ( struct V_86 * V_33 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
F_54 ( & V_13 -> V_114 ) ;
F_38 ( V_13 ) ;
...
static int F_59 ( struct V_86 * V_33 ,
struct V_117 * V_118 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
int V_1 ;
...
static int F_62 ( struct V_86 * V_33 ,
struct V_117 * V_118 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
int V_1 ;
...
static int F_65 ( struct V_86 * V_33 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
int V_1 ;
F_54 ( & V_13 -> V_114 ) ;
...
static int F_66 ( struct V_86 * V_33 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
int V_1 ;
F_54 ( & V_13 -> V_114 ) ;
...
static int F_67 ( struct V_86 * V_33 , int V_119 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
switch ( V_119 ) {
case V_120 :
...
static int F_68 ( struct V_86 * V_33 , int V_119 )
{
struct V_12 * V_13 = V_33 -> V_112 ;
switch ( V_119 ) {
case V_120 :
...
static inline T_2 F_69 ( struct V_12 * V_13 ,
struct V_41 * V_42 )
{
unsigned long V_24 ;
unsigned int V_122 ;
...
static T_2 F_70 ( struct V_86 * V_123 )
{
struct V_12 * V_13 = V_123 -> V_112 ;
return F_69 ( V_13 , & V_13 -> V_64 ) ;
}
static T_2 F_71 ( struct V_86 * V_123 )
{
struct V_12 * V_13 = V_123 -> V_112 ;
return F_69 ( V_13 , & V_13 -> V_32 ) ;
}
static const struct V_124 *
F_72 ( struct V_125 * V_126 )
{
struct V_74 * V_127 ;
T_1 * V_128 ;
int V_129 ;
...
unsigned int V_146 ;
V_142 = F_72 ( V_13 -> V_76 [ V_82 ] ) ;
V_143 = F_72 ( V_13 -> V_76 [ V_83 ] ) ;
if ( ! V_142 || ! V_143 )
return - V_147 ;
switch ( V_142 -> V_148 ) {
case 3 :
...
V_13 -> V_99 = F_75 ( V_142 -> V_152 [ 0 ] ) ;
V_146 = F_75 ( V_143 -> V_152 [ 0 ] ) ;
if ( V_13 -> V_99 != V_146 ) {
F_22 ( & V_13 -> V_62 -> V_62 ,
L_20 ,
V_146 , V_13 -> V_99 ) ;
...
V_13 -> V_64 . V_158 = F_77 ( V_13 -> V_62 , F_78 ( V_145 ) ) ;
V_13 -> V_64 . V_159 = F_79 ( V_145 -> V_160 ) ;
V_145 = & V_13 -> V_76 [ V_83 ] -> V_131 [ 1 ] . V_157 [ 0 ] . V_78 ;
if ( ! F_80 ( V_145 ) ) {
F_22 ( & V_13 -> V_62 -> V_62 , L_23 ) ;
return - V_147 ;
}
V_13 -> V_32 . V_158 = F_81 ( V_13 -> V_62 , F_78 ( V_145 ) ) ;
V_13 -> V_32 . V_159 = F_79 ( V_145 -> V_160 ) ;
return 0 ;
}
static int F_82 ( struct V_12 * V_13 , struct V_41 * V_42 )
{
unsigned int V_161 , V_162 , V_163 , V_70 ;
T_3 V_164 ;
V_42 -> V_55 = V_55 ;
V_42 -> V_55 = F_83 ( V_42 -> V_55 ,
( unsigned int ) V_165 ) ;
V_42 -> V_55 = F_84 ( V_42 -> V_55 ,
( unsigned int ) V_166 ) ;
V_161 = V_42 -> V_55 ;
V_163 = V_167 / V_42 -> V_159 ;
for ( V_70 = 0 ; V_70 < F_85 ( V_42 -> V_168 ) ; ++ V_70 ) {
V_162 = F_84 ( V_161 , V_163 ) ;
V_164 = V_162 * V_42 -> V_159 ;
V_42 -> V_168 [ V_70 ] . V_169 =
F_86 ( V_13 -> V_62 , V_164 , V_72 ,
...
static void F_87 ( struct V_12 * V_13 , struct V_41 * V_42 )
{
unsigned int V_70 ;
for ( V_70 = 0 ; V_70 < F_85 ( V_42 -> V_168 ) ; ++ V_70 )
F_88 ( V_13 -> V_62 ,
...
static int F_89 ( struct V_12 * V_13 , struct V_41 * V_42 ,
void (* F_90)( struct V_20 * ) )
{
unsigned V_172 = V_42 -> V_159 ;
struct V_22 * V_20 ;
unsigned int V_173 , V_174 = 0 ;
for ( V_173 = 0 ; V_173 < F_85 ( V_42 -> V_168 ) ; ++ V_173 ) {
...
V_20 -> V_20 . V_179 = V_170 ;
V_20 -> V_20 . V_180 = V_172 ;
V_20 -> V_20 . V_181 = 1 ;
V_20 -> V_20 . V_182 = 1 ;
V_20 -> V_20 . V_23 = V_13 ;
V_20 -> V_20 . V_39 = F_90 ;
V_20 -> V_20 . V_36 [ 0 ] . V_183 = 0 ;
...
F_87 ( V_13 , & V_13 -> V_64 ) ;
F_87 ( V_13 , & V_13 -> V_32 ) ;
for ( V_70 = 0 ; V_70 < F_85 ( V_13 -> V_76 ) ; ++ V_70 ) {
F_54 ( & V_13 -> V_114 ) ;
V_76 = V_13 -> V_76 [ V_70 ] ;
V_13 -> V_76 [ V_70 ] = NULL ;
F_55 ( & V_13 -> V_114 ) ;
...
{
struct V_12 * V_13 = V_186 -> V_112 ;
F_99 ( & V_13 -> V_114 ) ;
}
static int F_100 ( struct V_125 * V_126 ,
...
struct V_185 * V_186 ;
struct V_12 * V_13 ;
unsigned int V_198 , V_70 ;
int V_199 ;
const char * V_200 ;
char V_201 [ 32 ] ;
int V_1 ;
V_199 = V_188 -> V_202 == 0x0044 ;
if ( V_126 -> V_131 -> V_78 . V_80 !=
V_196 [ V_199 ] [ 0 ] )
return - V_2 ;
F_54 ( & V_203 ) ;
for ( V_198 = 0 ; V_198 < V_204 ; ++ V_198 )
if ( V_205 [ V_198 ] && ! ( V_206 & ( 1 << V_198 ) ) )
break;
if ( V_198 >= V_204 ) {
F_55 ( & V_203 ) ;
return - V_3 ;
}
V_1 = F_101 ( V_207 [ V_198 ] , V_208 [ V_198 ] , V_209 ,
sizeof( * V_13 ) , & V_186 ) ;
if ( V_1 < 0 ) {
F_55 ( & V_203 ) ;
return V_1 ;
...
F_106 ( & V_13 -> V_19 ) ;
V_13 -> V_76 [ 0 ] = V_126 ;
for ( V_70 = 1 ; V_70 < F_85 ( V_13 -> V_76 ) ; ++ V_70 ) {
V_13 -> V_76 [ V_70 ] = F_107 ( V_13 -> V_62 ,
V_196 [ V_199 ] [ V_70 ] ) ;
if ( ! V_13 -> V_76 [ V_70 ] ) {
...
F_109 ( V_186 , & V_126 -> V_62 ) ;
V_1 = F_74 ( V_13 ) ;
if ( V_1 < 0 )
goto V_212;
V_200 = V_188 -> V_202 == 0x0044 ? L_27 : L_28 ;
strcpy ( V_186 -> V_214 , L_28 ) ;
strcpy ( V_186 -> V_215 , V_200 ) ;
F_110 ( V_13 -> V_62 , V_201 , sizeof( V_201 ) ) ;
snprintf ( V_13 -> V_186 -> V_216 , sizeof( V_13 -> V_186 -> V_216 ) ,
L_29 , V_200 ,
V_13 -> V_62 -> V_217 ? V_13 -> V_62 -> V_217 : L_30 , V_13 -> V_99 , V_201 ,
V_13 -> V_62 -> V_153 == V_155 ? L_31 : L_32 ) ;
V_1 = F_82 ( V_13 , & V_13 -> V_64 ) ;
if ( V_1 < 0 )
goto V_212;
V_1 = F_82 ( V_13 , & V_13 -> V_32 ) ;
if ( V_1 < 0 )
goto V_212;
V_1 = F_89 ( V_13 , & V_13 -> V_64 , F_25 ) ;
if ( V_1 < 0 )
goto V_212;
V_1 = F_89 ( V_13 , & V_13 -> V_32 , F_6 ) ;
if ( V_1 < 0 )
goto V_212;
V_1 = F_111 ( V_186 , V_200 , 0 , 1 , 1 , & V_13 -> V_218 ) ;
if ( V_1 < 0 )
goto V_212;
V_13 -> V_218 -> V_112 = V_13 ;
strcpy ( V_13 -> V_218 -> V_200 , V_200 ) ;
F_112 ( V_13 -> V_218 , V_219 , & V_220 ) ;
F_112 ( V_13 -> V_218 , V_221 , & V_222 ) ;
V_1 = F_113 ( V_186 , V_13 -> V_76 [ V_197 ] ,
& V_13 -> V_211 , & V_194 ) ;
if ( V_1 < 0 )
goto V_212;
V_1 = F_114 ( V_186 ) ;
...
static void F_116 ( struct V_125 * V_126 )
{
struct V_12 * V_13 = F_117 ( V_126 ) ;
struct V_223 * V_224 ;
if ( ! V_13 )
return;
F_54 ( & V_203 ) ;
