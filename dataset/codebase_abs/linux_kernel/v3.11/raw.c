...
struct V_155 * V_156 ;
F_66 () ;
V_156 = F_67 ( V_19 -> V_156 ) ;
if ( V_156 ) {
memcpy ( & V_132 , V_156 ,
sizeof( * V_156 ) + V_156 -> V_151 . V_157 ) ;
...
if ( V_19 -> V_69 )
goto V_158;
if ( V_129 . V_151 -> V_151 . V_159 ) {
if ( ! V_40 )
goto V_158;
V_40 = V_129 . V_151 -> V_151 . V_160 ;
}
}
V_130 = F_69 ( V_2 ) ;
if ( V_113 -> V_134 & V_161 )
V_130 |= V_162 ;
if ( F_70 ( V_40 ) ) {
if ( ! V_129 . V_153 )
V_129 . V_153 = V_19 -> V_163 ;
if ( ! V_39 )
V_39 = V_19 -> V_164 ;
} else if ( ! V_129 . V_153 )
V_129 . V_153 = V_19 -> V_165 ;
F_71 ( & V_77 , V_129 . V_153 , V_2 -> V_96 , V_130 ,
V_166 ,
V_19 -> V_69 ? V_167 : V_2 -> V_168 ,
F_72 ( V_2 ) | V_169 |
( V_19 -> V_69 ? V_170 : 0 ) ,
V_40 , V_39 , 0 , 0 ) ;
if ( ! V_19 -> V_69 ) {
...
V_47 = - V_171 ;
if ( V_84 -> V_172 & V_173 && ! F_78 ( V_2 , V_174 ) )
goto V_158;
...
static void F_87 ( struct V_1 * V_2 , long V_180 )
{
F_88 ( V_2 , 0 , NULL ) ;
F_89 ( V_2 ) ;
}
...
static int F_91 ( struct V_1 * V_2 , struct V_181 * V_182 , int V_183 )
{
struct V_18 * V_19 = F_2 ( V_2 ) ;
...
goto V_36;
V_185 = F_92 ( F_6 ( V_2 ) , V_149 -> V_146 . V_147 ) ;
V_184 = - V_187 ;
...
* V_183 = sizeof( * sin ) ;
if ( V_82 & V_193 ) {
V_47 = F_95 ( V_2 , V_113 , V_127 ) ;
goto V_36;
}
V_25 = F_96 ( V_2 , V_82 , V_191 , & V_47 ) ;
if ( ! V_25 )
goto V_36;
V_192 = V_25 -> V_127 ;
if ( V_127 < V_192 ) {
...
V_47 = F_97 ( V_25 , 0 , V_113 -> V_118 , V_192 ) ;
if ( V_47 )
goto V_158;
F_98 ( V_113 , V_2 , V_25 ) ;
if ( sin ) {
...
static int F_102 ( struct V_1 * V_2 , char T_6 * V_200 , int V_157 )
{
if ( V_157 > sizeof( struct F_13 ) )
V_157 = sizeof( struct F_13 ) ;
if ( F_103 ( & F_16 ( V_2 ) -> V_30 , V_200 , V_157 ) )
return - V_101 ;
return 0 ;
}
static int F_104 ( struct V_1 * V_2 , char T_6 * V_200 , int T_6 * V_157 )
{
...
V_184 = - V_101 ;
if ( F_105 ( V_127 , V_157 ) ||
F_106 ( V_200 , & F_16 ( V_2 ) -> V_30 , V_127 ) )
goto V_36;
V_184 = 0 ;
V_36: return V_184 ;
}
static int F_107 ( struct V_1 * V_2 , int V_201 , int V_202 ,
char T_6 * V_200 , unsigned int V_157 )
{
if ( V_202 == V_203 ) {
if ( F_2 ( V_2 ) -> V_10 != V_42 )
return - V_133 ;
else
return F_102 ( V_2 , V_200 , V_157 ) ;
}
return - V_204 ;
}
...
{
if ( V_201 != V_205 )
return F_109 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
return F_107 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
}
static int F_110 ( struct V_1 * V_2 , int V_201 , int V_202 ,
char T_6 * V_200 , unsigned int V_157 )
{
if ( V_201 != V_205 )
return F_111 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
return F_107 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
}
static int F_112 ( struct V_1 * V_2 , int V_201 , int V_202 ,
char T_6 * V_200 , int T_6 * V_157 )
{
if ( V_202 == V_203 ) {
if ( F_2 ( V_2 ) -> V_10 != V_42 )
return - V_133 ;
else
return F_104 ( V_2 , V_200 , V_157 ) ;
}
return - V_204 ;
}
...
{
if ( V_201 != V_205 )
return F_114 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
return F_112 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
}
static int F_115 ( struct V_1 * V_2 , int V_201 , int V_202 ,
char T_6 * V_200 , int T_6 * V_157 )
{
if ( V_201 != V_205 )
return F_116 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
return F_112 ( V_2 , V_201 , V_202 , V_200 , V_157 ) ;
}
static int F_117 ( struct V_1 * V_2 , int V_206 , unsigned long V_207 )
{
switch ( V_206 ) {
case V_208 : {
int V_209 = F_118 ( V_2 ) ;
return F_105 ( V_209 , ( int T_6 * ) V_207 ) ;
}
case V_210 : {
struct V_24 * V_25 ;
int V_209 = 0 ;
F_119 ( & V_2 -> V_211 . V_12 ) ;
V_25 = F_120 ( & V_2 -> V_211 ) ;
if ( V_25 != NULL )
V_209 = V_25 -> V_127 ;
F_121 ( & V_2 -> V_211 . V_12 ) ;
return F_105 ( V_209 , ( int T_6 * ) V_207 ) ;
}
default:
#ifdef F_122
return F_123 ( V_2 , V_206 , ( void T_6 * ) V_207 ) ;
#else
return - V_212 ;
#endif
}
}
static int F_124 ( struct V_1 * V_2 , unsigned int V_206 , unsigned long V_207 )
{
switch ( V_206 ) {
case V_208 :
case V_210 :
...
default:
#ifdef F_122
return F_125 ( V_2 , V_206 , F_126 ( V_207 ) ) ;
#else
return - V_212 ;
#endif
}
}
static struct V_1 * F_127 ( struct V_213 * V_214 )
{
struct V_1 * V_2 ;
struct V_215 * V_216 = F_128 ( V_214 ) ;
for ( V_216 -> V_217 = 0 ; V_216 -> V_217 < V_11 ;
++ V_216 -> V_217 ) {
F_129 (sk, &state->h->ht[state->bucket])
if ( F_6 ( V_2 ) == F_130 ( V_214 ) )
goto V_23;
}
V_2 = NULL ;
V_23:
...
static struct V_1 * F_131 ( struct V_213 * V_214 , struct V_1 * V_2 )
{
struct V_215 * V_216 = F_128 ( V_214 ) ;
do {
V_2 = F_24 ( V_2 ) ;
...
static struct V_1 * F_132 ( struct V_213 * V_214 , T_7 V_219 )
{
struct V_1 * V_2 = F_127 ( V_214 ) ;
if ( V_2 )
while ( V_219 && ( V_2 = F_131 ( V_214 , V_2 ) ) != NULL )
-- V_219 ;
return V_219 ? NULL : V_2 ;
}
void * F_133 ( struct V_213 * V_214 , T_7 * V_219 )
{
struct V_215 * V_216 = F_128 ( V_214 ) ;
F_18 ( & V_216 -> V_4 -> V_12 ) ;
return * V_219 ? F_132 ( V_214 , * V_219 - 1 ) : V_220 ;
}
void * F_134 ( struct V_213 * V_214 , void * V_221 , T_7 * V_219 )
{
struct V_1 * V_2 ;
if ( V_221 == V_220 )
V_2 = F_127 ( V_214 ) ;
else
V_2 = F_131 ( V_214 , V_221 ) ;
++ * V_219 ;
return V_2 ;
}
void F_135 ( struct V_213 * V_214 , void * V_221 )
{
struct V_215 * V_216 = F_128 ( V_214 ) ;
F_25 ( & V_216 -> V_4 -> V_12 ) ;
}
static void F_136 ( struct V_213 * V_214 , struct V_1 * V_222 , int V_117 )
{
...
F_138 ( V_222 ) ,
0 , 0L , 0 ,
F_139 ( F_140 ( V_214 ) , F_141 ( V_222 ) ) ,
0 , F_142 ( V_222 ) ,
F_143 ( & V_222 -> V_227 ) , V_222 , F_143 ( & V_222 -> V_75 ) ) ;
}
static int F_144 ( struct V_213 * V_214 , void * V_221 )
{
if ( V_221 == V_220 )
F_137 ( V_214 , L_4
L_5
...
F_136 ( V_214 , V_221 , F_128 ( V_214 ) -> V_217 ) ;
return 0 ;
}
int F_145 ( struct V_228 * V_229 , struct V_230 * V_230 ,
struct V_3 * V_4 , const struct V_231 * V_232 )
{
int V_47 ;
struct V_215 * V_117 ;
V_47 = F_146 ( V_229 , V_230 , V_232 , sizeof( struct V_215 ) ) ;
if ( V_47 < 0 )
return V_47 ;
V_117 = F_128 ( (struct V_213 * ) V_230 -> V_233 ) ;
V_117 -> V_4 = V_4 ;
return 0 ;
}
static int F_147 ( struct V_228 * V_228 , struct V_230 * V_230 )
{
return F_145 ( V_228 , V_230 , & V_35 , & V_234 ) ;
}
static T_9 int F_148 ( struct V_13 * V_13 )
{
if ( ! F_149 ( L_7 , V_235 , V_13 -> V_236 , & V_237 ) )
return - V_238 ;
return 0 ;
}
static T_10 void F_150 ( struct V_13 * V_13 )
{
F_151 ( L_7 , V_13 -> V_236 ) ;
}
int T_11 F_152 ( void )
{
return F_153 ( & V_239 ) ;
