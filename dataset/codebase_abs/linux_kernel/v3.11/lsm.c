...
error = F_64 ( F_65 ( V_4 -> V_21 ) ,
V_108 ) ;
else if ( strcmp ( V_107 , L_2 ) == 0 && V_4 -> V_110 )
error = F_64 ( F_65 ( V_4 -> V_110 ) ,
V_108 ) ;
else if ( strcmp ( V_107 , L_3 ) == 0 && V_4 -> V_111 )
error = F_64 ( F_65 ( V_4 -> V_111 ) ,
V_108 ) ;
else
error = - V_112 ;
F_66 ( V_1 ) ;
...
static int F_67 ( struct V_10 * V_106 , char * V_107 ,
...
V_117 . V_127 = V_107 ;
V_117 . error = - V_112 ;
F_73 ( V_128 , & V_115 , NULL ) ;
return - V_112 ;
}
static int F_74 ( struct V_10 * V_106 ,
unsigned int V_129 , struct V_130 * V_131 )
{
struct V_20 * V_21 = F_26 () ;
int error = 0 ;
if ( ! F_18 ( V_21 ) )
error = F_75 ( V_21 , V_106 , V_129 , V_131 ) ;
return error ;
}
static int T_8 F_76 ( char * V_132 )
{
unsigned long V_133 ;
int error = F_77 ( V_132 , 0 , & V_133 ) ;
if ( ! error )
V_134 = V_133 ? 1 : 0 ;
return 1 ;
}
static int F_78 ( const char * V_135 , const struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
if ( V_140 )
return - V_121 ;
return F_80 ( V_135 , V_137 ) ;
}
static int F_81 ( char * V_141 , const struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
return F_82 ( V_141 , V_137 ) ;
}
static int F_83 ( const char * V_135 , const struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
return F_80 ( V_135 , V_137 ) ;
}
static int F_84 ( char * V_141 , const struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
return F_82 ( V_141 , V_137 ) ;
}
static int F_85 ( const char * V_135 , const struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
return F_86 ( V_135 , V_137 ) ;
}
static int F_87 ( char * V_141 , const struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
return F_88 ( V_141 , V_137 ) ;
}
static int F_89 ( char * V_141 , struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
if ( ! V_134 )
...
static int F_90 ( const char * V_135 , struct V_136 * V_137 )
{
int V_144 ;
if ( ! F_79 ( V_138 ) )
return - V_139 ;
...
static int F_91 ( char * V_141 , struct V_136 * V_137 )
{
if ( ! F_79 ( V_138 ) )
return - V_139 ;
if ( ! V_134 )
...
static int F_92 ( const char * V_135 , struct V_136 * V_137 )
{
int V_144 ;
if ( ! F_79 ( V_138 ) )
return - V_139 ;
