...
V_63 = F_37 ( V_56 ) ;
F_89 ( V_63 , F_90 ( 0 , V_131 ) , V_133 -> V_157 ) ;
V_63 -> V_158 = V_90 -> V_28 . V_158 ;
V_63 -> V_159 = V_142 ;
...
T_2 * V_160 = ( T_2 * ) ( ( ( T_5 * ) V_63 ) + V_90 -> V_145 - 4 ) ;
if ( V_90 -> V_28 . V_51 & V_52 ) {
++ V_90 -> V_161 ;
* V_160 = F_91 ( V_90 -> V_161 ) ;
V_160 -- ;
}
if ( V_90 -> V_28 . V_51 & V_67 ) {
* V_160 = V_90 -> V_28 . V_162 ;
V_160 -- ;
}
if ( V_90 -> V_28 . V_51 & V_66 ) {
* V_160 = 0 ;
* ( T_7 * ) V_160 = F_92 ( ( void * ) ( V_63 + 1 ) ,
...
const struct V_164 * V_165 = F_97 ( V_56 ) ;
int V_81 = - 1 ;
struct V_132 V_133 ;
T_8 V_131 ;
T_6 V_75 ;
int V_91 ;
if ( ! ( V_17 -> V_28 . V_32 & V_166 ) )
V_81 = V_17 -> V_28 . V_81 ;
memcpy ( & V_133 , & V_17 -> V_167 . V_168 . V_169 , sizeof( V_133 ) ) ;
V_133 . V_170 = V_171 ;
V_131 = F_98 ( V_165 ) ;
if ( V_17 -> V_28 . V_32 & V_172 )
V_133 . V_157 |= F_91 ( ( T_6 ) V_165 -> V_173 << V_174 )
& V_175 ;
if ( V_17 -> V_28 . V_32 & V_176 )
V_133 . V_146 = V_56 -> V_177 ;
V_91 = F_62 ( V_56 , V_7 , V_131 , & V_133 , V_81 , & V_75 ) ;
if ( V_91 != 0 ) {
if ( V_91 == - V_151 )
F_99 ( V_56 , V_178 , V_179 ,
F_91 ( V_75 ) ) ;
return - 1 ;
}
return 0 ;
...
V_81 = V_74 -> V_81 - 1 ;
} else if ( ! ( V_17 -> V_28 . V_32 & V_166 ) )
V_81 = V_17 -> V_28 . V_81 ;
memcpy ( & V_133 , & V_17 -> V_167 . V_168 . V_169 , sizeof( V_133 ) ) ;
V_133 . V_170 = V_180 ;
V_131 = F_54 ( V_63 ) ;
if ( V_17 -> V_28 . V_32 & V_172 )
V_133 . V_157 |= ( * ( T_2 * ) V_63 & V_175 ) ;
if ( V_17 -> V_28 . V_32 & V_181 )
V_133 . V_157 |= ( * ( T_2 * ) V_63 & V_182 ) ;
if ( V_17 -> V_28 . V_32 & V_176 )
V_133 . V_146 = V_56 -> V_177 ;
V_91 = F_62 ( V_56 , V_7 , V_131 , & V_133 , V_81 , & V_75 ) ;
if ( V_91 != 0 ) {
...
const struct V_62 * V_183 )
{
return F_10 ( & V_17 -> V_28 . V_30 , & V_183 -> V_71 ) ;
}
...
break;
case F_8 ( V_186 ) :
V_184 = F_100 ( V_56 , V_7 ) ;
break;
default:
V_184 = F_103 ( V_56 , V_7 ) ;
break;
}
if ( V_184 < 0 )
goto V_185;
...
static void F_25 ( struct V_5 * V_17 , int V_190 )
{
struct V_6 * V_7 = V_17 -> V_7 ;
struct V_35 * V_36 = & V_17 -> V_28 ;
struct V_132 * V_133 = & V_17 -> V_167 . V_168 . V_169 ;
int V_191 = sizeof( struct V_62 ) + 4 ;
if ( V_7 -> type != V_24 ) {
memcpy ( V_7 -> V_192 , & V_36 -> V_29 , sizeof( struct V_1 ) ) ;
memcpy ( V_7 -> V_193 , & V_36 -> V_30 , sizeof( struct V_1 ) ) ;
}
V_133 -> V_71 = V_36 -> V_29 ;
V_133 -> V_70 = V_36 -> V_30 ;
V_133 -> V_194 = V_36 -> V_13 ;
V_133 -> V_157 = 0 ;
if ( ! ( V_36 -> V_32 & V_172 ) )
V_133 -> V_157 |= V_175 & V_36 -> V_195 ;
if ( ! ( V_36 -> V_32 & V_181 ) )
V_133 -> V_157 |= V_182 & V_36 -> V_195 ;
V_36 -> V_32 &= ~ ( V_196 | V_197 | V_198 ) ;
V_36 -> V_32 |= F_106 ( V_17 , & V_36 -> V_29 , & V_36 -> V_30 ) ;
if ( V_36 -> V_32 & V_196 &&
V_36 -> V_32 & V_197 && V_7 -> type != V_24 )
V_7 -> V_32 |= V_199 ;
else
V_7 -> V_32 &= ~ V_199 ;
V_7 -> V_200 = V_36 -> V_13 ;
...
if ( V_36 -> V_32 & V_196 ) {
int V_201 = ( F_107 ( & V_36 -> V_30 ) &
( V_202 | V_203 ) ) ;
struct V_204 * V_205 = F_108 ( F_5 ( V_7 ) ,
& V_36 -> V_30 , & V_36 -> V_29 ,
V_36 -> V_13 , V_201 ) ;
if ( V_205 == NULL )
return;
if ( V_205 -> V_139 . V_7 ) {
V_7 -> V_206 = V_205 -> V_139 . V_7 -> V_206 + V_191 ;
if ( V_190 ) {
V_7 -> V_75 = V_205 -> V_139 . V_7 -> V_75 - V_191 ;
if ( ! ( V_17 -> V_28 . V_32 & V_166 ) )
V_7 -> V_75 -= 8 ;
if ( V_7 -> V_75 < V_83 )
V_7 -> V_75 = V_83 ;
...
const struct V_35 * V_36 , int V_190 )
{
...
const struct V_207 * V_168 )
{
V_36 -> V_29 = V_168 -> V_29 ;
V_36 -> V_30 = V_168 -> V_30 ;
V_36 -> V_32 = V_168 -> V_32 ;
V_36 -> V_158 = V_168 -> V_158 ;
V_36 -> V_81 = V_168 -> V_81 ;
V_36 -> V_195 = V_168 -> V_195 ;
V_36 -> V_13 = V_168 -> V_13 ;
V_36 -> V_31 = V_168 -> V_31 ;
V_36 -> V_162 = V_168 -> V_162 ;
V_36 -> V_108 = V_168 -> V_108 ;
V_36 -> V_51 = V_168 -> V_51 ;
memcpy ( V_36 -> V_45 , V_168 -> V_45 , sizeof( V_168 -> V_45 ) ) ;
}
static void F_113 ( struct V_207 * V_168 ,
const struct V_35 * V_36 )
{
V_168 -> V_142 = V_208 ;
V_168 -> V_29 = V_36 -> V_29 ;
V_168 -> V_30 = V_36 -> V_30 ;
V_168 -> V_32 = V_36 -> V_32 ;
V_168 -> V_158 = V_36 -> V_158 ;
V_168 -> V_81 = V_36 -> V_81 ;
V_168 -> V_195 = V_36 -> V_195 ;
V_168 -> V_13 = V_36 -> V_13 ;
V_168 -> V_31 = V_36 -> V_31 ;
V_168 -> V_162 = V_36 -> V_162 ;
V_168 -> V_108 = V_36 -> V_108 ;
V_168 -> V_51 = V_36 -> V_51 ;
memcpy ( V_168 -> V_45 , V_36 -> V_45 , sizeof( V_168 -> V_45 ) ) ;
}
...
V_17 = NULL ;
if ( V_7 == V_20 -> V_34 ) {
if ( F_115 ( & V_36 , V_210 -> V_214 . V_215 , sizeof( V_36 ) ) ) {
V_91 = - V_216 ;
break;
}
F_112 ( & V_212 , & V_36 ) ;
V_17 = F_21 ( V_12 , & V_212 , 0 ) ;
}
if ( V_17 == NULL )
V_17 = F_12 ( V_7 ) ;
memset ( & V_36 , 0 , sizeof( V_36 ) ) ;
F_113 ( & V_36 , & V_17 -> V_28 ) ;
if ( F_116 ( V_210 -> V_214 . V_215 , & V_36 , sizeof( V_36 ) ) )
V_91 = - V_216 ;
break;
case V_217 :
case V_218 :
V_91 = - V_219 ;
if ( ! F_117 ( V_12 -> V_220 , V_221 ) )
goto V_222;
V_91 = - V_216 ;
if ( F_115 ( & V_36 , V_210 -> V_214 . V_215 , sizeof( V_36 ) ) )
goto V_222;
...
V_36 . V_162 = 0 ;
F_112 ( & V_212 , & V_36 ) ;
V_17 = F_21 ( V_12 , & V_212 , V_211 == V_217 ) ;
if ( V_7 != V_20 -> V_34 && V_211 == V_218 ) {
if ( V_17 != NULL ) {
if ( V_17 -> V_7 != V_7 ) {
V_91 = - V_224 ;
break;
...
static int F_121 ( struct V_6 * V_7 , int V_228 )
{
struct V_5 * V_90 = F_12 ( V_7 ) ;
if ( V_228 < 68 ||
V_228 > 0xFFF8 - V_7 -> V_206 - V_90 -> V_145 )
return - V_223 ;
V_7 -> V_75 = V_228 ;
return 0 ;
}
...
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_62 * V_63 = (struct V_62 * ) F_87 ( V_56 , V_17 -> V_145 ) ;
T_3 * V_36 = ( T_3 * ) ( V_63 + 1 ) ;
F_89 ( V_63 , 0 , V_17 -> V_167 . V_168 . V_169 . V_157 ) ;
V_63 -> V_158 = V_17 -> V_28 . V_158 ;
V_63 -> V_159 = V_155 ;
...
V_7 -> V_231 = F_123 ;
V_7 -> type = V_25 ;
V_7 -> V_206 = V_232 + sizeof( struct V_62 ) + 4 ;
V_7 -> V_75 = V_233 - sizeof( struct V_62 ) - 4 ;
V_17 = F_12 ( V_7 ) ;
if ( ! ( V_17 -> V_28 . V_32 & V_166 ) )
V_7 -> V_75 -= 8 ;
V_7 -> V_32 |= V_234 ;
...
memcpy ( V_7 -> V_192 , & V_90 -> V_28 . V_29 , sizeof( struct V_1 ) ) ;
memcpy ( V_7 -> V_193 , & V_90 -> V_28 . V_30 , sizeof( struct V_1 ) ) ;
if ( F_14 ( & V_90 -> V_28 . V_30 ) )
V_7 -> V_144 = & V_239 ;
V_7 -> V_97 = F_126 ( struct V_96 ) ;
if ( ! V_7 -> V_97 )
return - V_240 ;
return 0 ;
}
...
while ( V_17 != NULL ) {
F_129 ( V_17 -> V_7 , V_242 ) ;
V_17 = F_18 ( V_17 -> V_41 ) ;
}
}
}
}
static int T_11 F_130 ( struct V_12 * V_12 )
{
struct V_19 * V_20 = F_7 ( V_12 , V_21 ) ;
int V_91 ;
...
static void T_12 F_132 ( struct V_12 * V_12 )
{
struct V_19 * V_20 ;
F_133 ( V_247 ) ;
V_20 = F_7 ( V_12 , V_21 ) ;
...
static int F_137 ( struct V_248 * V_249 [] , struct V_248 * V_64 [] )
{
T_3 V_32 ;
if ( ! V_64 )
return 0 ;
V_32 = 0 ;
if ( V_64 [ V_250 ] )
V_32 |= F_138 ( V_64 [ V_250 ] ) ;
if ( V_64 [ V_251 ] )
V_32 |= F_138 ( V_64 [ V_251 ] ) ;
if ( V_32 & ( V_69 | V_68 ) )
return - V_223 ;
return 0 ;
}
static int F_139 ( struct V_248 * V_249 [] , struct V_248 * V_64 [] )
{
struct V_1 V_70 ;
if ( V_249 [ V_252 ] ) {
if ( F_140 ( V_249 [ V_252 ] ) != V_253 )
return - V_223 ;
if ( ! F_141 ( F_142 ( V_249 [ V_252 ] ) ) )
return - V_254 ;
}
if ( ! V_64 )
goto V_255;
if ( V_64 [ V_256 ] ) {
F_143 ( & V_70 , V_64 [ V_256 ] , sizeof( struct V_1 ) ) ;
if ( F_14 ( & V_70 ) )
return - V_223 ;
}
V_255:
return F_137 ( V_249 , V_64 ) ;
}
static void F_144 ( struct V_248 * V_64 [] ,
struct V_35 * V_28 )
{
...
return;
if ( V_64 [ V_257 ] )
V_28 -> V_13 = F_145 ( V_64 [ V_257 ] ) ;
if ( V_64 [ V_250 ] )
V_28 -> V_108 = F_138 ( V_64 [ V_250 ] ) ;
if ( V_64 [ V_251 ] )
V_28 -> V_51 = F_138 ( V_64 [ V_251 ] ) ;
if ( V_64 [ V_258 ] )
V_28 -> V_31 = F_146 ( V_64 [ V_258 ] ) ;
if ( V_64 [ V_259 ] )
V_28 -> V_162 = F_146 ( V_64 [ V_259 ] ) ;
if ( V_64 [ V_260 ] )
F_143 ( & V_28 -> V_29 , V_64 [ V_260 ] , sizeof( struct V_1 ) ) ;
if ( V_64 [ V_256 ] )
F_143 ( & V_28 -> V_30 , V_64 [ V_256 ] , sizeof( struct V_1 ) ) ;
if ( V_64 [ V_261 ] )
V_28 -> V_158 = F_147 ( V_64 [ V_261 ] ) ;
if ( V_64 [ V_262 ] )
V_28 -> V_81 = F_147 ( V_64 [ V_262 ] ) ;
if ( V_64 [ V_263 ] )
V_28 -> V_195 = F_145 ( V_64 [ V_263 ] ) ;
if ( V_64 [ V_264 ] )
V_28 -> V_32 = F_145 ( V_64 [ V_264 ] ) ;
}
...
static int F_151 ( struct V_12 * V_266 , struct V_6 * V_7 ,
...
static int F_153 ( struct V_6 * V_7 , struct V_248 * V_249 [] ,
struct V_248 * V_64 [] )
{
struct V_5 * V_17 , * V_44 ;
struct V_12 * V_12 = F_5 ( V_7 ) ;
...
V_17 = V_44 ;
F_19 ( V_20 , V_17 ) ;
F_110 ( V_17 , & V_36 , ! V_249 [ V_267 ] ) ;
F_16 ( V_20 , V_17 ) ;
F_119 ( V_7 ) ;
}
return 0 ;
}
static T_13 F_154 ( const struct V_6 * V_7 )
{
return
F_155 ( 4 ) +
F_155 ( 2 ) +
...
static int F_156 ( struct V_55 * V_56 , const struct V_6 * V_7 )
{
struct V_5 * V_17 = F_12 ( V_7 ) ;
struct V_35 * V_36 = & V_17 -> V_28 ;
if ( F_157 ( V_56 , V_257 , V_36 -> V_13 ) ||
F_158 ( V_56 , V_250 , V_36 -> V_108 ) ||
F_158 ( V_56 , V_251 , V_36 -> V_51 ) ||
F_159 ( V_56 , V_258 , V_36 -> V_31 ) ||
F_159 ( V_56 , V_259 , V_36 -> V_162 ) ||
F_160 ( V_56 , V_260 , sizeof( struct V_1 ) , & V_36 -> V_29 ) ||
F_160 ( V_56 , V_256 , sizeof( struct V_1 ) , & V_36 -> V_30 ) ||
F_161 ( V_56 , V_261 , V_36 -> V_158 ) ||
F_161 ( V_56 , V_262 , V_36 -> V_81 ) ||
F_159 ( V_56 , V_263 , V_36 -> V_195 ) ||
F_157 ( V_56 , V_264 , V_36 -> V_32 ) )
goto V_268;
return 0 ;
V_268:
return - V_151 ;
}
static int T_14 F_162 ( void )
{
int V_91 ;
F_163 ( L_9 ) ;
V_91 = F_164 ( & V_269 ) ;
