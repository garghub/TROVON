...
unsigned int V_30 , unsigned int V_10 )
{
...
{
struct V_1 * V_2 = F_37 ( V_7 ) ;
const struct V_55 * V_56 = F_42 ( V_2 , V_67 ) ;
if ( V_56 ) {
F_39 ( & V_2 -> V_66 ) ;
V_2 -> V_61 |= F_34 ( V_67 ) ;
F_32 ( V_2 , V_56 ) ;
...
{
struct V_1 * V_2 = F_37 ( V_7 ) ;
enum V_70 V_71 = F_47 ( * V_88 ) ;
int V_47 ;
T_1 V_3 , V_73 , V_74 , V_75 , V_5 , V_89 , V_90 ;
V_47 = F_45 ( V_7 , V_67 , V_71 , true ,
...
struct V_1 * V_2 = F_37 ( V_7 ) ;
enum V_70 V_71 = F_47 ( V_88 ) ;
unsigned int V_90 = F_50 ( V_88 ) ;
int V_47 ;
T_1 V_3 , V_73 , V_74 , V_75 , V_5 , V_89 ;
unsigned long V_59 ;
F_38 ( V_7 -> V_18 , L_9 ,
V_63 , V_91 [ V_67 ] . V_11 , V_88 ) ;
V_47 = F_45 ( V_7 , V_67 , V_71 , true ,
& V_3 , & V_73 , & V_74 , & V_75 , & V_5 ) ;
if ( V_47 < 0 )
return V_47 ;
...
struct V_1 * V_2 ;
struct V_104 * V_105 ;
V_2 = F_55 ( & V_103 -> V_18 , sizeof( * V_2 ) , V_28 ) ;
if ( ! V_2 ) {
F_14 ( & V_103 -> V_18 , L_14 ) ;
return - V_29 ;
}
V_2 -> V_18 = & V_103 -> V_18 ;
F_56 ( & V_2 -> V_66 ) ;
V_106 . V_11 = F_11 ( & V_103 -> V_18 ) ;
V_106 . V_12 = V_91 ;
V_106 . V_14 = F_6 ( V_91 ) ;
V_105 = F_57 ( V_103 , V_107 , 0 ) ;
if ( ! V_105 ) {
F_14 ( & V_103 -> V_18 , L_15 ) ;
return - V_108 ;
}
if ( ! F_58 ( & V_103 -> V_18 , V_105 -> V_109 ,
F_59 ( V_105 ) ,
F_11 ( & V_103 -> V_18 ) ) ) {
F_14 ( & V_103 -> V_18 ,
L_16 ) ;
...
V_2 -> V_4 = F_60 ( & V_103 -> V_18 , V_105 -> V_109 ,
F_59 ( V_105 ) ) ;
if ( ! V_2 -> V_4 ) {
F_14 ( & V_103 -> V_18 , L_17 ) ;
return - V_108 ;
}
V_2 -> V_9 = F_61 ( & V_106 , & V_103 -> V_18 , V_2 ) ;
if ( ! V_2 -> V_9 ) {
F_14 ( & V_103 -> V_18 , L_18 ) ;
return - V_108 ;
}
F_62 ( V_103 , V_2 ) ;
F_63 ( & V_103 -> V_18 , L_19 ) ;
return 0 ;
}
static int F_64 ( struct V_102 * V_103 )
{
struct V_1 * V_2 = F_65 ( V_103 ) ;
F_66 ( V_2 -> V_9 ) ;
return 0 ;
}
