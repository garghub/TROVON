...
union V_64 * V_65 )
{
struct V_4 * V_5 = F_21 ( V_61 , struct V_4 , V_28 ) ;
int V_7 = 0 ;
T_1 V_48 = F_7 ( V_5 -> V_2 , V_17 ) &
V_18 ;
switch ( V_63 ) {
...
union V_64 * V_65 )
{
struct V_4 * V_5 = F_21 ( V_61 , struct V_4 , V_57 ) ;
int V_7 = 0 ;
T_1 V_48 = F_7 ( V_5 -> V_2 , V_17 ) &
V_18 ;
switch ( V_63 ) {
...
int V_71 ;
T_1 V_72 ;
V_5 = F_25 ( & V_70 -> V_19 , sizeof( * V_5 ) , V_73 ) ;
if ( ! V_5 )
return - V_74 ;
F_26 ( V_70 , V_5 ) ;
...
V_5 -> V_57 . type = V_78 ;
V_5 -> V_57 . V_79 = V_80 ;
V_5 -> V_57 . V_81 = F_28 ( V_80 ) ;
V_5 -> V_57 . V_82 = F_23 ;
V_5 -> V_57 . V_83 = V_5 -> V_2 -> V_20 -> V_84 ;
V_5 -> V_57 . V_85 = V_5 -> V_2 -> V_20 -> V_86 ;
...
int V_71 ;
for ( V_71 = 0 ; V_71 < F_28 ( V_76 ) ; V_71 ++ )
F_34 ( V_5 -> V_2 , V_76 [ V_71 ] ) ;
F_35 ( & V_70 -> V_19 . V_88 , & V_89 ) ;
F_31 ( & V_5 -> V_28 ) ;
F_31 ( & V_5 -> V_58 ) ;
F_31 ( & V_5 -> V_57 ) ;
return 0 ;
