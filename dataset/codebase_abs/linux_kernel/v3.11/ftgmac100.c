...
F_98 ( V_2 -> V_73 , sizeof( struct V_23 ) ,
V_2 -> V_59 , V_2 -> V_22 ) ;
}
static int F_99 ( struct V_1 * V_2 )
{
int V_12 ;
V_2 -> V_59 = F_100 ( V_2 -> V_73 ,
sizeof( struct V_23 ) ,
& V_2 -> V_22 ,
V_116 | V_117 ) ;
if ( ! V_2 -> V_59 )
...
int V_121 ;
if ( V_120 -> V_29 == V_2 -> V_122 )
return;
V_2 -> V_122 = V_120 -> V_29 ;
V_121 = F_8 ( V_2 -> V_4 + V_123 ) ;
F_2 ( 0 , V_2 -> V_4 + V_123 ) ;
F_92 ( V_11 ) ;
F_16 ( V_2 ) ;
F_103 ( V_11 ) ;
...
struct V_119 * V_125 = V_2 -> V_126 -> V_127 [ V_12 ] ;
if ( V_125 ) {
V_120 = V_125 ;
break;
}
...
if ( ! V_120 ) {
F_47 ( V_11 , L_12 , V_11 -> V_128 ) ;
return - V_129 ;
}
V_120 = F_105 ( V_11 , F_106 ( & V_120 -> V_73 ) ,
& F_101 , V_130 ) ;
if ( F_107 ( V_120 ) ) {
F_10 ( V_11 , L_13 , V_11 -> V_128 ) ;
return F_108 ( V_120 ) ;
}
V_2 -> V_120 = V_120 ;
return 0 ;
}
static int F_109 ( struct V_126 * V_131 , int V_132 , int V_133 )
{
struct V_10 * V_11 = V_131 -> V_2 ;
struct V_1 * V_2 = F_102 ( V_11 ) ;
unsigned int V_134 ;
int V_12 ;
...
static int F_113 ( struct V_126 * V_131 , int V_132 ,
int V_133 , T_5 V_140 )
{
struct V_10 * V_11 = V_131 -> V_2 ;
struct V_1 * V_2 = F_102 ( V_11 ) ;
...
static int F_115 ( struct V_126 * V_131 )
{
return 0 ;
}
...
struct V_142 * V_143 )
{
F_117 ( V_143 -> V_144 , V_145 , sizeof( V_143 -> V_144 ) ) ;
F_117 ( V_143 -> V_146 , V_147 , sizeof( V_143 -> V_146 ) ) ;
F_117 ( V_143 -> V_148 , F_106 ( & V_11 -> V_73 ) , sizeof( V_143 -> V_148 ) ) ;
}
static int F_118 ( struct V_10 * V_11 ,
struct V_149 * V_150 )
{
struct V_1 * V_2 = F_102 ( V_11 ) ;
return F_119 ( V_2 -> V_120 , V_150 ) ;
}
static int F_120 ( struct V_10 * V_11 ,
struct V_149 * V_150 )
{
struct V_1 * V_2 = F_102 ( V_11 ) ;
return F_121 ( V_2 -> V_120 , V_150 ) ;
}
static T_6 F_122 ( int V_151 , void * V_152 )
{
struct V_10 * V_11 = V_152 ;
struct V_1 * V_2 = F_102 ( V_11 ) ;
if ( F_123 ( F_124 ( V_11 ) ) ) {
F_2 ( 0 , V_2 -> V_4 + V_123 ) ;
F_125 ( & V_2 -> V_85 ) ;
...
static int F_126 ( struct V_154 * V_85 , int V_155 )
{
...
if ( V_156 & ( V_161 | V_165 |
V_166 | V_167 ) ) {
if ( F_46 () )
F_47 ( V_11 , L_16 , V_156 ,
V_156 & V_161 ? L_17 : L_18 ,
V_156 & V_165 ? L_19 : L_18 ,
V_156 & V_166 ? L_20 : L_18 ,
V_156 & V_167 ? L_21 : L_18 ) ;
if ( V_156 & V_161 ) {
V_11 -> V_60 . V_168 ++ ;
}
if ( V_156 & V_165 ) {
...
V_118 = F_130 ( V_2 -> V_151 , F_122 , 0 , V_11 -> V_128 , V_11 ) ;
if ( V_118 ) {
F_10 ( V_11 , L_23 , V_2 -> V_151 ) ;
goto V_172;
}
V_2 -> V_58 = 0 ;
V_2 -> V_101 = 0 ;
...
V_72 = F_138 ( V_2 -> V_73 , V_68 -> V_138 , F_83 ( V_68 ) , V_105 ) ;
if ( F_45 ( F_95 ( V_2 -> V_73 , V_72 ) ) ) {
if ( F_46 () )
F_10 ( V_11 , L_25 ) ;
V_11 -> V_60 . V_175 ++ ;
...
static int F_139 ( struct V_10 * V_11 , struct V_176 * V_177 , int V_150 )
{
struct V_1 * V_2 = F_102 ( V_11 ) ;
return F_140 ( V_2 -> V_120 , V_177 , V_150 ) ;
}
static int F_141 ( struct V_178 * V_179 )
{
struct V_180 * V_181 ;
int V_151 ;
struct V_10 * V_11 ;
...
V_2 -> V_181 = F_150 ( V_181 -> V_191 , F_151 ( V_181 ) ,
F_106 ( & V_179 -> V_73 ) ) ;
if ( ! V_2 -> V_181 ) {
F_152 ( & V_179 -> V_73 , L_26 ) ;
V_118 = - V_115 ;
goto V_192;
}
V_2 -> V_4 = F_153 ( V_181 -> V_191 , F_151 ( V_181 ) ) ;
if ( ! V_2 -> V_4 ) {
F_152 ( & V_179 -> V_73 , L_27 ) ;
V_118 = - V_16 ;
goto V_193;
}
V_2 -> V_151 = V_151 ;
...
V_2 -> V_126 -> V_128 = L_28 ;
snprintf ( V_2 -> V_126 -> V_195 , V_196 , L_29 ) ;
V_2 -> V_126 -> V_2 = V_11 ;
V_2 -> V_126 -> V_197 = F_109 ;
V_2 -> V_126 -> V_198 = F_113 ;
V_2 -> V_126 -> V_199 = F_115 ;
V_2 -> V_126 -> V_151 = V_2 -> V_200 ;
for ( V_12 = 0 ; V_12 < V_124 ; V_12 ++ )
V_2 -> V_126 -> V_151 [ V_12 ] = V_201 ;
V_118 = F_155 ( V_2 -> V_126 ) ;
if ( V_118 ) {
F_152 ( & V_179 -> V_73 , L_30 ) ;
goto V_202;
}
V_118 = F_104 ( V_2 ) ;
if ( V_118 ) {
F_152 ( & V_179 -> V_73 , L_31 ) ;
goto V_203;
}
V_118 = F_156 ( V_11 ) ;
if ( V_118 ) {
F_152 ( & V_179 -> V_73 , L_32 ) ;
goto V_204;
}
F_47 ( V_11 , L_33 , V_2 -> V_151 , V_2 -> V_4 ) ;
if ( ! F_157 ( V_11 -> V_28 ) ) {
F_158 ( V_11 ) ;
F_47 ( V_11 , L_34 ,
V_11 -> V_28 ) ;
...
static int T_7 F_166 ( struct V_178 * V_179 )
{
struct V_10 * V_11 ;
struct V_1 * V_2 ;
V_11 = F_167 ( V_179 ) ;
