...
V_4 = F_32 ( & V_72 -> V_25 , sizeof( struct V_3 ) ,
V_82 ) ;
if ( V_4 == NULL ) {
F_29 ( & V_72 -> V_25 , L_11 ) ;
return - V_83 ;
...
V_32 = F_37 ( V_5 , F_38 ( V_72 , L_18 ) ) ;
V_23 = F_39 ( V_32 , NULL , F_12 ,
V_101 , V_4 -> V_67 , V_4 ) ;
if ( V_23 != 0 ) {
F_29 ( & V_72 -> V_25 , L_19 ,
V_32 , V_23 ) ;
...
V_32 = F_37 ( V_5 , F_38 ( V_72 , L_20 ) ) ;
V_23 = F_39 ( V_32 , NULL , F_14 ,
V_101 , V_4 -> V_67 , V_4 ) ;
if ( V_23 != 0 ) {
F_29 ( & V_72 -> V_25 , L_21 ,
V_32 , V_23 ) ;
...
{
struct V_3 * V_4 = F_45 ( V_72 ) ;
struct V_5 * V_5 = V_4 -> V_5 ;
F_41 ( F_37 ( V_5 , F_38 ( V_72 , L_20 ) ) ,
V_4 ) ;
F_41 ( F_37 ( V_5 , F_38 ( V_72 , L_18 ) ) ,
V_4 ) ;
F_42 ( V_4 -> V_34 ) ;
...
static int F_46 ( struct V_1 * V_2 , int V_53 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_5 = V_4 -> V_5 ;
T_1 V_6 = V_4 -> V_7 + V_22 ;
int V_104 ;
V_104 = F_47 ( V_2 , V_53 , V_53 ) ;
if ( V_104 < 0 )
return V_104 ;
...
{
struct V_3 * V_4 = F_45 ( V_72 ) ;
F_41 ( F_37 ( V_4 -> V_5 , F_38 ( V_72 , L_18 ) ) ,
V_4 ) ;
F_42 ( V_4 -> V_34 ) ;
return 0 ;
}
...
struct V_74 * V_63 = V_5 -> V_25 -> V_75 ;
struct V_76 V_77 = { } ;
int V_78 = V_72 -> V_78 % F_25 ( V_63 -> V_4 ) ;
struct V_3 * V_4 ;
struct V_79 * V_80 ;
int V_23 , V_32 ;
F_11 ( & V_72 -> V_25 , L_10 , V_78 + 1 ) ;
...
return - V_111 ;
V_4 = F_32 ( & V_72 -> V_25 , sizeof( struct V_3 ) , V_82 ) ;
if ( V_4 == NULL ) {
F_29 ( & V_72 -> V_25 , L_11 ) ;
return - V_83 ;
}
...
struct V_74 * V_63 = V_5 -> V_25 -> V_75 ;
struct V_76 V_77 = { } ;
int V_78 = V_72 -> V_78 % F_25 ( V_63 -> V_113 ) ;
struct V_3 * V_4 ;
int V_23 ;
