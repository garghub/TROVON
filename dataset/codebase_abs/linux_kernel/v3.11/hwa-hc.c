...
if ( V_3 < 0 )
goto V_128;
if ( V_6 -> V_101 -> V_129 > V_130 ) {
F_4 ( V_8 , L_32
L_33 , V_6 -> V_101 -> V_129 ) ;
V_4 -> V_131 = V_130 ;
} else {
V_4 -> V_131 = V_6 -> V_101 -> V_129 ;
}
V_4 -> V_132 = V_6 -> V_101 -> V_133 ;
V_4 -> V_134 = F_27 ;
V_4 -> V_135 = F_30 ;
V_4 -> V_136 = F_35 ;
V_4 -> V_137 = F_36 ;
...
static int F_68 ( struct V_125 * V_9 ,
...
static void F_74 ( struct V_125 * V_9 )
{
struct V_21 * V_21 ;
struct V_4 * V_4 ;
struct V_1 * V_1 ;
