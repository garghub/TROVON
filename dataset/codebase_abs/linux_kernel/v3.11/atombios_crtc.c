...
V_323 = V_9 -> V_341 . V_347 . V_343 ;
else
V_323 = V_9 -> V_341 . V_348 . V_343 ;
switch ( ( V_323 & 0xf0 ) >> 4 ) {
case 0 :
V_314 |= F_69 ( V_349 ) ;
break;
...
V_314 |= F_70 ( V_352 ) ;
F_71 ( V_316 , & V_317 , & V_318 , & V_319 , & V_320 ) ;
V_314 |= F_72 ( V_320 ) ;
V_314 |= F_73 ( V_317 ) ;
V_314 |= F_74 ( V_318 ) ;
V_314 |= F_75 ( V_319 ) ;
...
V_314 |= F_70 ( V_355 ) ;
if ( V_9 -> V_69 >= V_340 ) {
T_9 V_356 = V_9 -> V_341 . V_342 . V_357 ;
T_9 V_358 = V_9 -> V_341 . V_342 . V_359 ;
if ( V_356 > 8 )
V_356 = 8 ;
if ( V_356 == 8 )
V_314 |= F_77 ( V_360 ) ;
...
if ( V_9 -> V_69 >= V_194 ) {
if ( V_11 -> V_18 ) {
F_27 ( V_417 , F_79 ( V_313 ) ) ;
F_27 ( V_418 , F_79 ( V_313 ) ) ;
} else {
F_27 ( V_419 , F_79 ( V_313 ) ) ;
F_27 ( V_420 , F_79 ( V_313 ) ) ;
}
}
...
int F_83 ( struct V_1 * V_2 , int V_303 , int V_304 ,
struct V_301 * V_439 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
...
return F_82 ( V_2 , V_439 , V_303 , V_304 , 0 ) ;
else
return F_84 ( V_2 , V_439 , V_303 , V_304 , 0 ) ;
}
...
return F_82 ( V_2 , V_302 , V_303 , V_304 , 1 ) ;
else
return F_84 ( V_2 , V_302 , V_303 , V_304 , 1 ) ;
}
...
static T_9 F_87 ( struct V_1 * V_2 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_1 * V_450 ;
struct V_11 * V_451 ;
T_9 V_452 = 0 ;
F_88 (test_crtc, &dev->mode_config.crtc_list, head) {
if ( V_2 == V_450 )
continue;
V_451 = F_2 ( V_450 ) ;
...
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_179 * V_36 ;
F_88 (encoder, &dev->mode_config.encoder_list, head) {
if ( V_36 -> V_2 == V_2 ) {
V_11 -> V_36 = V_36 ;
...
break;
case V_252 :
if ( ( V_9 -> V_69 == V_465 ) || ( V_9 -> V_69 == V_340 ) )
F_48 ( V_2 , V_11 -> V_18 , V_11 -> V_132 ,
0 , 0 , V_84 , 0 , 0 , 0 , 0 , 0 , false , & V_145 ) ;
break;
default:
