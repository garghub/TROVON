...
{
return V_4 -> V_5 -> V_7 + F_3 ( V_4 ) ;
}
static int F_8 ( struct V_1 * V_4 )
{
const struct V_8 * V_5 = V_4 -> V_5 ;
const int V_6 = F_7 ( V_4 ) ;
if ( F_5 ( F_9 ( V_9 , & V_4 -> V_10 ) == 0 ,
L_2 , V_6 ) ) {
if ( ! F_10 ( V_5 -> V_11 ) ) {
F_11 ( L_3 , V_6 ) ;
F_12 ( V_9 , & V_4 -> V_10 ) ;
...
static struct V_8 * F_13 ( const struct V_1 * V_4 )
{
return V_4 ? V_4 -> V_5 : NULL ;
}
struct V_8 * F_14 ( unsigned V_6 )
{
return F_13 ( F_4 ( V_6 ) ) ;
}
static int F_15 ( int V_14 )
{
struct V_8 * V_5 ;
int V_7 = V_15 - V_14 ;
F_16 (chip, &gpio_chips, list) {
if ( V_5 -> V_7 + V_5 -> V_14 <= V_7 )
break;
else
V_7 = V_5 -> V_7 - V_14 ;
}
...
if ( V_19 > 0 ) {
V_19 = 1 ;
F_12 ( V_22 , & ( (struct V_1 * ) V_4 ) -> V_10 ) ;
}
if ( V_19 == 0 ) {
F_19 ( V_22 , & ( (struct V_1 * ) V_4 ) -> V_10 ) ;
}
return V_19 ;
}
...
V_42 = V_41 ;
V_4 -> V_10 &= V_58 ;
V_4 -> V_10 |= ( unsigned long ) V_42 << V_44 ;
if ( V_4 -> V_10 >> V_44 != V_42 ) {
V_41 = - V_59 ;
goto V_46;
}
}
...
V_19 = F_36 ( V_4 , V_24 , V_61 [ V_60 ] . V_10 ) ;
if ( ! V_19 )
V_19 = V_30 ;
}
F_24 ( & V_28 ) ;
...
{
int V_19 = 0 ;
if ( ! ! F_23 ( V_32 , & V_4 -> V_10 ) == ! ! V_31 )
return 0 ;
if ( V_31 )
F_19 ( V_32 , & V_4 -> V_10 ) ;
else
F_12 ( V_32 , & V_4 -> V_10 ) ;
if ( V_24 != NULL && ( ! ! F_23 ( V_51 , & V_4 -> V_10 ) ^
! ! F_23 ( V_48 , & V_4 -> V_10 ) ) ) {
unsigned long V_64 = V_4 -> V_10 & V_43 ;
F_36 ( V_4 , V_24 , 0 ) ;
...
struct V_25 * V_26 , char * V_27 )
{
const struct V_8 * V_5 = F_21 ( V_24 ) ;
return sprintf ( V_27 , L_12 , V_5 -> V_7 ) ;
}
...
{
const struct V_8 * V_5 = F_21 ( V_24 ) ;
return sprintf ( V_27 , L_16 , V_5 -> V_14 ) ;
}
...
static int F_81 ( struct V_8 * V_5 )
{
int V_19 ;
struct V_23 * V_24 ;
if ( ! V_73 . V_74 )
...
static void F_82 ( struct V_8 * V_5 )
{
int V_19 ;
struct V_23 * V_24 ;
F_22 ( & V_28 ) ;
...
static inline int F_81 ( struct V_8 * V_5 )
{
return 0 ;
}
static inline void F_82 ( struct V_8 * V_5 )
{
}
...
static int F_86 ( struct V_8 * V_5 )
{
struct V_91 * V_92 = & V_93 ;
struct V_8 * V_94 ;
int V_95 = 0 ;
F_87 (pos, &gpio_chips) {
V_94 = F_88 ( V_92 , struct V_8 , V_96 ) ;
if ( V_94 -> V_7 >= V_5 -> V_7 + V_5 -> V_14 )
break;
}
if ( V_92 != & V_93 && V_92 -> V_97 != & V_93 ) {
V_94 = F_88 ( V_92 -> V_97 , struct V_8 , V_96 ) ;
if ( V_94 -> V_7 + V_94 -> V_14 > V_5 -> V_7 ) {
F_89 ( V_5 -> V_24 ,
L_28 ) ;
V_95 = - V_98 ;
}
...
int F_91 ( struct V_8 * V_5 )
{
unsigned long V_10 ;
int V_19 = 0 ;
unsigned V_42 ;
int V_7 = V_5 -> V_7 ;
if ( ( ! F_6 ( V_7 ) || ! F_6 ( V_7 + V_5 -> V_14 - 1 ) )
&& V_7 >= 0 ) {
V_19 = - V_20 ;
goto V_99;
}
...
struct V_8 * F_99 ( void * V_85 ,
int (* F_100)( struct V_8 * V_5 ,
void * V_85 ) )
{
struct V_8 * V_5 ;
unsigned long V_10 ;
...
int F_101 ( struct V_8 * V_5 , const char * V_101 ,
...
int F_113 ( unsigned V_6 , unsigned long V_10 , const char * V_3 )
{
struct V_1 * V_4 ;
int V_95 ;
V_4 = F_4 ( V_6 ) ;
...
V_95 = F_113 ( V_125 -> V_6 , V_125 -> V_10 , V_125 -> V_3 ) ;
if ( V_95 )
goto V_127;
}
return 0 ;
...
const char * F_116 ( struct V_8 * V_5 , unsigned V_18 )
{
struct V_1 * V_4 ;
if ( ! F_117 ( V_5 , V_18 ) )
return NULL ;
V_4 = & V_5 -> V_4 [ V_18 ] ;
if ( F_23 ( V_9 , & V_4 -> V_10 ) == 0 )
return NULL ;
#ifdef F_2
return V_4 -> V_3 ;
#else
...
if ( V_31 && F_23 ( V_116 , & V_4 -> V_10 ) )
return F_28 ( V_4 ) ;
if ( ! V_31 && F_23 ( V_117 , & V_4 -> V_10 ) )
return F_28 ( V_4 ) ;
F_61 ( & V_76 , V_10 ) ;
V_5 = V_4 -> V_5 ;
if ( ! V_5 || ! V_5 -> V_130 || ! V_5 -> V_79 )
goto V_99;
V_19 = F_8 ( V_4 ) ;
if ( V_19 < 0 )
goto V_99;
...
F_110 ( V_5 -> V_115 ) ;
F_120 ( F_7 ( V_4 ) , 0 , V_31 ) ;
if ( F_23 ( V_116 , & V_4 -> V_10 ) )
F_126 ( V_4 , V_31 ) ;
else if ( F_23 ( V_117 , & V_4 -> V_10 ) )
F_127 ( V_4 , V_31 ) ;
else
...
V_5 = V_4 -> V_5 ;
V_18 = F_3 ( V_4 ) ;
return V_5 -> V_133 ? V_5 -> V_133 ( V_5 , V_18 ) : - V_134 ;
}
...
static void F_135 ( struct V_135 * V_136 , struct V_8 * V_5 )
{
unsigned V_60 ;
unsigned V_6 = V_5 -> V_7 ;
struct V_1 * V_137 = & V_5 -> V_4 [ 0 ] ;
int V_138 ;
for ( V_60 = 0 ; V_60 < V_5 -> V_14 ; V_60 ++ , V_6 ++ , V_137 ++ ) {
if ( ! F_23 ( V_9 , & V_137 -> V_10 ) )
continue;
F_18 ( V_137 ) ;
V_138 = F_23 ( V_22 , & V_137 -> V_10 ) ;
F_136 ( V_136 , L_41 ,
V_6 , V_137 -> V_3 ,
V_138 ? L_8 : L_42 ,
V_5 -> V_128
? ( V_5 -> V_128 ( V_5 , V_60 ) ? L_43 : L_44 )
: L_45 ) ;
F_136 ( V_136 , L_46 ) ;
}
}
static void * F_137 ( struct V_135 * V_136 , T_5 * V_92 )
{
unsigned long V_10 ;
struct V_8 * V_5 = NULL ;
T_5 V_139 = * V_92 ;
...
static void * F_138 ( struct V_135 * V_136 , void * V_141 , T_5 * V_92 )
{
unsigned long V_10 ;
struct V_8 * V_5 = V_141 ;
void * V_41 = NULL ;
F_61 ( & V_76 , V_10 ) ;
if ( F_139 ( & V_5 -> V_96 , & V_93 ) )
V_41 = NULL ;
else
V_41 = F_88 ( V_5 -> V_96 . V_142 , struct V_8 , V_96 ) ;
F_62 ( & V_76 , V_10 ) ;
V_136 -> V_140 = L_46 ;
++ * V_92 ;
return V_41 ;
}
static void F_140 ( struct V_135 * V_136 , void * V_141 )
{
}
static int F_141 ( struct V_135 * V_136 , void * V_141 )
{
struct V_8 * V_5 = V_141 ;
struct V_23 * V_24 ;
F_136 ( V_136 , L_47 , ( char * ) V_136 -> V_140 ,
V_5 -> V_7 , V_5 -> V_7 + V_5 -> V_14 - 1 ) ;
V_24 = V_5 -> V_24 ;
if ( V_24 )
F_136 ( V_136 , L_48 , V_24 -> V_143 ? V_24 -> V_143 -> V_62 : L_49 ,
F_142 ( V_24 ) ) ;
if ( V_5 -> V_3 )
F_136 ( V_136 , L_50 , V_5 -> V_3 ) ;
if ( V_5 -> V_115 )
F_136 ( V_136 , L_51 ) ;
F_136 ( V_136 , L_52 ) ;
if ( V_5 -> V_144 )
...
static int F_143 ( struct V_145 * V_145 , struct V_146 * V_146 )
{
return F_144 ( V_146 , & V_147 ) ;
}
static int T_4 F_145 ( void )
{
( void ) F_146 ( L_53 , V_148 | V_149 ,
NULL , NULL , & V_150 ) ;
return 0 ;
}
