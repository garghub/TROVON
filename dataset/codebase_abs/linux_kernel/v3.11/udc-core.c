...
V_27 -> V_9 . V_40 = V_41 ;
V_27 -> V_9 . V_29 = V_29 ;
V_30 = F_23 ( & V_27 -> V_9 , L_7 , F_28 ( & V_29 -> V_19 ) ) ;
if ( V_30 )
goto V_42;
V_27 -> V_2 = V_2 ;
F_29 ( & V_43 ) ;
...
int F_35 ( struct V_25 * V_29 , struct V_1 * V_2 )
{
...
if ( V_27 -> V_21 )
F_36 ( V_27 ) ;
F_37 ( & V_27 -> V_9 . V_19 , V_53 ) ;
F_41 ( & V_27 -> V_9 ) ;
F_41 ( & V_2 -> V_9 ) ;
}
static int F_42 ( struct V_26 * V_27 , struct V_20 * V_21 )
{
int V_30 ;
F_15 ( & V_27 -> V_9 , L_11 ,
V_21 -> V_54 ) ;
...
int F_44 ( const char * V_48 , struct V_20 * V_21 )
{
struct V_26 * V_27 = NULL ;
int V_30 = - V_56 ;
F_29 ( & V_43 ) ;
...
static T_1 F_48 ( struct V_25 * V_9 ,
...
static T_1 F_52 ( struct V_25 * V_9 ,
struct V_61 * V_62 , char * V_16 )
{
struct V_26 * V_27 = F_14 ( V_9 , struct V_26 , V_9 ) ;
struct V_1 * V_2 = V_27 -> V_2 ;
return sprintf ( V_16 , L_5 , F_53 ( V_2 -> V_18 ) ) ;
}
static int F_54 ( struct V_25 * V_9 , struct V_64 * V_65 )
{
struct V_26 * V_27 = F_14 ( V_9 , struct V_26 , V_9 ) ;
int V_30 ;
V_30 = F_55 ( V_65 , L_18 , V_27 -> V_2 -> V_48 ) ;
if ( V_30 ) {
F_3 ( V_9 , L_19 ) ;
return V_30 ;
}
