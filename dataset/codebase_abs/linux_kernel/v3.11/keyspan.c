...
V_50 = F_64 ( 0 , V_109 ) ;
if ( V_50 == NULL ) {
F_11 ( & V_85 -> V_133 -> V_57 , L_35 , V_58 , V_72 ) ;
return NULL ;
}
if ( V_72 == 0 ) {
return V_50 ;
...
if ( V_52 != 0 )
F_11 ( & V_85 -> V_57 -> V_57 , L_55 , V_58 , V_52 ) ;
}
if ( V_144 -> V_154 != NULL ) {
V_52 = F_15 ( V_144 -> V_154 , V_109 ) ;
if ( V_52 != 0 )
F_11 ( & V_85 -> V_57 -> V_57 , L_56 , V_58 , V_52 ) ;
}
return 0 ;
}
static void F_85 ( struct V_88 * V_85 )
{
struct V_143 * V_144 ;
V_144 = F_74 ( V_85 ) ;
F_51 ( V_144 -> V_148 ) ;
...
for ( V_71 = 0 ; V_71 <= V_15 -> V_274 ; ++ V_71 , ++ V_271 ) {
V_8 -> V_95 [ V_71 ] = F_62 ( V_85 , V_271 ,
V_150 , V_5 ,
V_8 -> V_275 [ V_71 ] , 64 ,
V_146 -> V_276 ) ;
}
V_271 = V_15 -> V_277 [ V_272 ] ;
for ( V_71 = 0 ; V_71 <= V_15 -> V_70 ; ++ V_71 , ++ V_271 ) {
V_8 -> V_60 [ V_71 ] = F_62 ( V_85 , V_271 ,
V_160 , V_5 ,
V_8 -> V_278 [ V_71 ] , 64 ,
V_146 -> V_279 ) ;
}
