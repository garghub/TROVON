...
static enum V_55
F_54 ( struct V_56 * V_57 , struct V_69 * V_36 )
{
if ( ! F_53 ( V_57 , ' ' ) )
return 0 ;
...
V_79 = F_59 ( V_75 , V_75 -> V_46 ) ;
if ( V_79 )
V_31 = F_60 ( V_79 , NULL ) ;
else {
F_61 ( V_75 -> V_34 -> V_33 , V_75 -> V_46 ,
NULL , NULL ) ;
V_31 = F_62 ( V_75 -> V_34 -> V_33 , V_75 -> V_46 ,
NULL , NULL ) ;
}
if ( ! V_31 )
return NULL ;
...
static int F_64 ( T_1 V_82 , struct V_56 * V_57 )
{
unsigned long V_83 ;
V_83 = F_65 ( V_82 , V_84 ) ;
V_83 /= 1000 ;
return F_50 ( V_57 , L_9 ,
( unsigned long ) V_82 , V_83 ) ;
}
static enum V_55
F_66 ( struct V_74 * V_75 , unsigned long V_85 ,
...
enum V_55
F_68 ( unsigned long long V_99 , struct V_56 * V_57 )
{
unsigned long V_100 = F_65 ( V_99 , 1000 ) ;
char V_101 [ 21 ] ;
char V_102 [ 5 ] ;
int V_1 , V_66 ;
int V_67 ;
sprintf ( V_101 , L_13 , ( unsigned long ) V_99 ) ;
V_1 = F_50 ( V_57 , L_14 , V_101 ) ;
if ( ! V_1 )
return V_59 ;
V_66 = strlen ( V_101 ) ;
if ( V_66 < 7 ) {
T_4 V_103 = F_69 ( T_4 , sizeof( V_102 ) , 8UL - V_66 ) ;
snprintf ( V_102 , V_103 , L_15 , V_100 ) ;
V_1 = F_50 ( V_57 , L_16 , V_102 ) ;
if ( ! V_1 )
return V_59 ;
V_66 += strlen ( V_102 ) ;
}
...
V_1 = F_50 ( V_57 , L_24 , ( void * ) V_28 -> V_2 ) ;
if ( ! V_1 )
return V_59 ;
return V_60 ;
}
static enum V_55
F_71 ( struct V_74 * V_75 ,
struct V_35 * V_36 ,
...
V_1 = F_50 ( V_57 , L_25 , ( void * ) V_28 -> V_2 ) ;
if ( ! V_1 )
return V_59 ;
return V_112 ;
}
static enum V_55
F_72 ( struct V_74 * V_75 , struct V_56 * V_57 ,
...
return V_59 ;
if ( type ) {
V_1 = F_66 ( V_75 , V_85 , type , V_46 , V_50 -> V_61 , V_25 ) ;
if ( V_1 == V_59 )
return V_59 ;
}
if ( ! ( V_91 & V_92 ) )
...
static int
F_73 ( struct V_74 * V_75 , T_3 V_25 ,
...
static int
F_74 ( struct V_74 * V_75 , T_3 V_25 , int V_3 )
{
int V_46 = V_75 -> V_46 ;
int * V_114 ;
struct V_70 * V_44 = V_75 -> V_77 ;
...
static enum V_55
F_75 ( struct V_35 * V_116 , struct V_56 * V_57 ,
...
int V_46 = V_75 -> V_46 ;
if ( F_73 ( V_75 , V_25 , V_28 -> V_2 , V_28 -> V_3 ) )
return V_60 ;
if ( F_72 ( V_75 , V_57 , V_38 , V_28 -> V_2 , V_25 ) )
return V_59 ;
V_117 = F_58 ( V_75 , V_116 ) ;
if ( V_117 )
V_1 = F_70 ( V_75 , V_116 , V_117 , V_57 , V_25 ) ;
else
V_1 = F_71 ( V_75 , V_116 , V_57 , V_46 , V_25 ) ;
if ( V_44 ) {
if ( V_57 -> V_118 ) {
V_44 -> V_81 = 1 ;
V_44 -> V_46 = V_46 ;
...
static enum V_55
F_76 ( struct V_15 * V_16 , struct V_56 * V_57 ,
...
V_1 = F_50 ( V_57 , L_27 , ( void * ) V_16 -> V_2 ) ;
if ( ! V_1 )
return V_59 ;
}
if ( V_25 & V_120 ) {
...
static enum V_55
F_77 ( struct V_56 * V_57 , struct V_69 * V_50 ,
struct V_74 * V_75 , T_3 V_25 )
{
...
enum V_55
F_81 ( struct V_74 * V_75 , T_3 V_25 )
{
struct V_35 * V_116 ;
struct V_70 * V_44 = V_75 -> V_77 ;
...
F_82 ( V_116 , V_36 ) ;
V_128 = * V_116 ;
return F_75 ( & V_128 , V_57 , V_75 , V_25 ) ;
}
case V_54 : {
struct V_53 * V_116 ;
F_82 ( V_116 , V_36 ) ;
return F_76 ( & V_116 -> V_1 , V_57 , V_36 , V_75 , V_25 ) ;
}
case V_129 :
case V_130 :
return V_90 ;
default:
return F_77 ( V_57 , V_36 , V_75 , V_25 ) ;
}
return V_60 ;
}
static enum V_55
...
{
return F_81 ( V_75 , V_131 . V_132 ) ;
}
static enum V_55
F_84 ( struct V_74 * V_75 , int V_25 ,
struct V_123 * V_31 )
{
return F_83 ( V_75 ) ;
}
static void F_85 ( struct V_133 * V_57 , T_3 V_25 )
{
static const char V_65 [] = L_31
L_32
L_33 ;
int V_134 = 0 ;
if ( V_25 & V_93 )
...
if ( V_25 & V_96 )
V_134 += 17 ;
F_86 ( V_57 , L_34 , V_134 , V_65 ) ;
F_86 ( V_57 , L_35 , V_134 , V_65 ) ;
F_86 ( V_57 , L_36 , V_134 , V_65 ) ;
F_86 ( V_57 , L_37 , V_134 , V_65 ) ;
F_86 ( V_57 , L_38 , V_134 , V_65 ) ;
}
static void F_87 ( struct V_133 * V_57 , T_3 V_25 )
{
...
void F_88 ( struct V_133 * V_57 )
{
F_89 ( V_57 , V_131 . V_132 ) ;
}
void F_89 ( struct V_133 * V_57 , T_3 V_25 )
{
...
void F_92 ( struct V_74 * V_75 )
{
struct V_70 * V_44 ;
int V_46 ;
V_75 -> V_77 = NULL ;
V_44 = F_93 ( sizeof( * V_44 ) , V_136 ) ;
if ( ! V_44 )
goto V_137;
V_44 -> V_73 = F_94 ( struct V_109 ) ;
if ( ! V_44 -> V_73 )
goto V_138;
F_95 (cpu) {
...
static int F_100 ( T_3 V_139 , T_3 V_140 , int V_141 )
{
if ( V_140 == V_115 )
V_40 = ! V_141 ;
return 0 ;
...
static T_5
F_101 ( struct V_142 * V_143 , const char T_6 * V_144 , T_4 V_145 ,
T_7 * V_146 )
{
unsigned long V_132 ;
int V_1 ;
V_1 = F_102 ( V_144 , V_145 , 10 , & V_132 ) ;
if ( V_1 )
return V_1 ;
V_47 = V_132 ;
* V_146 += V_145 ;
...
static T_5
F_103 ( struct V_142 * V_143 , char T_6 * V_144 , T_4 V_145 ,
T_7 * V_146 )
{
char V_147 [ 15 ] ;
int V_148 ;
V_148 = sprintf ( V_147 , L_52 , V_47 ) ;
return F_104 ( V_144 , V_145 , V_146 , V_147 , V_148 ) ;
}
static T_8 int F_105 ( void )
{
struct V_149 * V_150 ;
V_150 = F_106 () ;
if ( ! V_150 )
return 0 ;
F_107 ( L_53 , 0644 , V_150 ,
NULL , & V_151 ) ;
return 0 ;
}
