...
struct V_1 * V_2 ;
struct V_72 * V_73 ;
struct V_99 * V_100 = V_96 -> V_64 . V_101 ;
if ( ! V_96 -> V_64 . V_102 ) {
if ( V_100 ) {
V_8 = F_26 ( & V_96 -> V_64 , V_100 ) ;
if ( V_8 < 0 )
return V_8 ;
} else {
F_16 ( & V_96 -> V_64 , L_8 ) ;
...
V_73 = V_96 -> V_64 . V_102 ;
V_4 = F_27 ( & V_96 -> V_64 , sizeof( * V_4 ) , V_103 ) ;
if ( ! V_4 )
return - V_104 ;
V_2 = F_27 ( & V_96 -> V_64 ,
sizeof( * V_2 ) * V_73 -> V_105 , V_103 ) ;
if ( ! V_2 )
return - V_104 ;
V_4 -> V_63 = V_96 ;
V_4 -> V_73 = V_73 ;
