...
F_28 ( V_19 , V_79 , 0 , V_3 . V_11 , 0 , 0 ) ;
F_28 ( V_19 , V_80 , 0 , V_3 . V_12 , 0 , 0 ) ;
}
V_13 -> V_81 = 0x90 ;
F_26 ( V_13 -> V_73 , L_3 , sizeof( V_13 -> V_73 ) ) ;
}
error = F_19 ( V_13 , V_82 , true ) ;
...
static int F_38 ( struct V_42 * V_42 , struct V_86 * V_87 )
{
struct V_13 * V_13 ;
struct V_18 * V_18 ;
int V_88 ;
V_13 = F_39 ( sizeof( struct V_13 ) , V_89 ) ;
V_18 = F_40 () ;
if ( ! V_13 || ! V_18 ) {
V_88 = - V_90 ;
goto V_91;
...
V_18 -> V_73 = V_13 -> V_73 ;
V_18 -> V_92 = V_13 -> V_92 ;
V_18 -> V_81 . V_95 = V_13 -> V_81 ;
V_18 -> V_81 . V_96 = V_97 ;
V_18 -> V_81 . V_98 = 0x056a ;
V_18 -> V_81 . V_99 = 0x0100 ;
