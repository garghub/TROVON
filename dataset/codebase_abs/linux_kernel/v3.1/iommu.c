...
return NULL ;
V_63 = V_13 -> V_65 . V_35 ;
V_40 = F_20 ( V_63 , V_60 , V_37 ) ;
if ( F_7 ( ! V_40 ) )
return NULL ;
V_62 = ( unsigned long ) F_21 ( V_40 ) ;
memset ( ( char * ) V_62 , 0 , V_50 << V_37 ) ;
V_1 = V_13 -> V_65 . V_1 ;
F_34 ( & V_1 -> V_41 , V_61 ) ;
...
V_37 = F_23 ( V_58 ) ;
if ( V_37 < 10 )
F_36 ( ( unsigned long ) V_68 , V_37 ) ;
}
static T_2 F_39 ( struct V_12 * V_13 , struct V_40 * V_40 ,
unsigned long V_70 , T_4 V_38 ,
enum V_71 V_72 ,
struct V_73 * V_74 )
{
struct V_1 * V_1 ;
...
if ( F_7 ( V_72 == V_82 ) )
goto V_83;
V_77 = ( unsigned long ) ( F_21 ( V_40 ) + V_70 ) ;
...
if ( V_72 != V_88 )
V_80 |= V_66 ;
for ( V_36 = 0 ; V_36 < V_14 ; V_36 ++ , V_76 ++ , V_78 += V_67 )
F_5 ( * V_76 ) = V_80 | V_78 ;
return V_64 ;
V_86:
F_30 ( V_1 , V_57 ) ;
...
unsigned long V_36 ;
V_94:
for ( V_36 = 0 ; V_36 < V_14 ; V_36 ++ , V_89 += V_67 )
F_2 ( V_75 -> V_95 , V_89 ) ;
}
V_93:
if ( V_72 == V_88 )
...
T_4 V_38 , enum V_71 V_72 ,
struct V_73 * V_74 )
{
struct V_1 * V_1 ;
struct V_75 * V_75 ;
T_1 * V_76 ;
unsigned long V_61 , V_14 , V_57 , V_36 ;
if ( F_7 ( V_72 == V_82 ) ) {
if ( F_8 () )
F_9 ( 1 ) ;
return;
...
int V_101 , enum V_71 V_72 ,
struct V_73 * V_74 )
{
struct V_99 * V_102 , * V_103 , * V_104 ;
unsigned long V_61 , V_15 , V_105 , V_57 ;
T_2 V_106 = 0 , V_31 ;
unsigned int V_107 ;
unsigned long V_108 ;
...
F_41 ( V_75 , V_1 , V_79 , V_57 , V_14 , V_72 ) ;
F_35 ( & V_1 -> V_41 , V_61 ) ;
}
...
struct V_1 * V_1 ;
struct V_75 * V_75 ;
unsigned long V_61 , V_57 , V_14 , V_36 ;
