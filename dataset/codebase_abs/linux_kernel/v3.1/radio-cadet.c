...
switch ( V_42 -> V_53 ) {
case 0 :
F_25 ( V_42 -> V_54 , L_5 , sizeof( V_42 -> V_54 ) ) ;
V_42 -> V_55 = V_56 | V_57 |
V_58 ;
V_42 -> V_59 = 1400 ;
V_42 -> V_60 = 1728 ;
...
break;
case 1 :
F_25 ( V_42 -> V_54 , L_6 , sizeof( V_42 -> V_54 ) ) ;
V_42 -> V_55 = V_66 ;
V_42 -> V_59 = 8320 ;
V_42 -> V_60 = 26400 ;
V_42 -> V_61 = V_4 ;
...
if ( V_69 -> type != V_52 )
return - V_67 ;
if ( V_2 -> V_5 == 0 && ( V_69 -> V_71 < 1400 || V_69 -> V_71 > 1728 ) )
return - V_67 ;
if ( V_2 -> V_5 == 1 && ( V_69 -> V_71 < 8320 || V_69 -> V_71 > 26400 ) )
return - V_67 ;
F_9 ( V_2 , V_69 -> V_71 ) ;
return 0 ;
}
...
switch ( V_73 -> V_74 ) {
case V_75 :
return F_31 ( V_73 , 0 , 1 , 1 , 1 ) ;
case V_76 :
return F_31 ( V_73 , 0 , 0xff , 1 , 0xff ) ;
}
return - V_67 ;
}
...
static int F_34 ( struct V_30 * V_80 , void * V_40 , unsigned int * V_10 )
{
* V_10 = 0 ;
return 0 ;
}
static int F_35 ( struct V_30 * V_80 , void * V_40 , unsigned int V_10 )
{
return V_10 ? - V_67 : 0 ;
}
...
{
V_82 -> V_53 = 0 ;
F_25 ( V_82 -> V_54 , L_7 , sizeof( V_82 -> V_54 ) ) ;
V_82 -> V_55 = V_83 ;
return 0 ;
}
...
static unsigned int F_42 ( struct V_30 * V_30 , struct V_85 * V_86 )
{
struct V_1 * V_2 = F_21 ( V_30 ) ;
F_43 ( V_30 , & V_2 -> V_25 , V_86 ) ;
if ( V_2 -> V_22 != V_2 -> V_23 )
return V_87 | V_88 ;
return 0 ;
}
static int F_44 ( struct V_89 * V_2 , const struct V_90 * V_91 )
{
if ( ! V_2 )
return - V_92 ;
if ( V_7 > 0 )
...
int V_99 ;
F_25 ( V_98 -> V_54 , L_10 , sizeof( V_98 -> V_54 ) ) ;
F_51 ( & V_2 -> V_6 ) ;
if ( V_7 < 0 )
F_52 ( & V_100 ) ;
V_2 -> V_7 = V_7 ;
...
F_25 ( V_2 -> V_102 . V_54 , V_98 -> V_54 , sizeof( V_2 -> V_102 . V_54 ) ) ;
V_2 -> V_102 . V_98 = V_98 ;
V_2 -> V_102 . V_103 = & V_104 ;
V_2 -> V_102 . V_105 = & V_106 ;
V_2 -> V_102 . V_107 = V_108 ;
F_56 ( & V_2 -> V_102 , V_2 ) ;
if ( F_57 ( & V_2 -> V_102 , V_109 , V_110 ) < 0 ) {
F_58 ( V_98 ) ;
F_49 ( V_2 -> V_7 , 2 ) ;
goto V_101;
}
F_59 ( V_98 , L_14 , V_2 -> V_7 ) ;
return 0 ;
V_101:
F_60 ( & V_100 ) ;
return - V_92 ;
