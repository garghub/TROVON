...
static int T_4 F_44 ( T_5 * V_40 , unsigned long V_75 )
{
struct V_65 * V_66 ;
T_5 V_76 ;
int V_37 = - V_61 ;
V_66 = F_40 ( V_68 , V_75 , NULL ) ;
if ( ! V_66 )
return - V_61 ;
if ( F_45 ( V_66 , V_77 , & V_76 ) )
goto V_70;
V_40 [ 0 ] = V_76 ;
if ( F_45 ( V_66 , V_78 , & V_76 ) )
goto V_70;
V_40 [ 1 ] = V_76 ;
V_37 = 0 ;
V_70:
...
static int T_4 F_46 ( struct V_30 * V_31 )
{
struct V_18 * V_19 ;
struct V_79 * V_80 ;
int V_32 , V_37 ;
...
V_32 = 0 ;
do {
V_37 = F_39 ( V_19 , V_81 [ V_32 ] . V_63 ) ;
if ( V_37 == 0 )
break;
V_32 ++ ;
} while ( V_81 [ V_32 ] . V_63 );
if ( V_37 )
goto V_63;
V_37 = F_44 ( & V_19 -> V_40 [ 0 ] , V_81 [ V_32 ] . V_82 ) ;
if ( V_37 )
goto V_63;
F_44 ( & V_19 -> V_40 [ 2 ] , V_81 [ V_32 ] . V_82 + 1 ) ;
V_80 = F_47 ( V_19 -> V_71 , V_19 -> V_73 , V_17 ) ;
if ( ! V_80 ) {
V_37 = - V_83 ;
goto V_63;
}
V_19 -> V_21 = F_48 ( V_19 -> V_71 , V_19 -> V_73 ) ;
if ( ! V_19 -> V_21 ) {
V_37 = - V_83 ;
goto V_84;
}
...
F_49 ( V_31 , NULL ) ;
V_84:
F_51 ( V_19 -> V_71 , V_19 -> V_73 ) ;
V_63:
F_34 ( V_19 ) ;
return V_37 ;
}
static int T_7 F_52 ( struct V_30 * V_31 )
{
int V_32 ;
struct V_18 * V_19 = F_25 ( V_31 ) ;
F_53 ( V_19 -> V_60 ) ;
