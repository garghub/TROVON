...
F_59 ( & V_2 -> V_140 ) ;
F_59 ( & V_2 -> V_141 . V_105 ) ;
F_59 ( & V_2 -> V_142 . V_105 ) ;
F_59 ( & V_2 -> V_143 ) ;
if ( V_2 -> V_3 >= V_4 )
F_81 ( & V_2 -> V_144 . V_145 ) ;
F_59 ( & V_2 -> V_146 . V_105 ) ;
F_59 ( & V_2 -> V_67 . V_105 ) ;
F_59 ( & V_2 -> V_147 ) ;
F_82 ( & V_2 -> V_148 . V_145 ) ;
F_83 ( & V_2 -> V_146 . V_149 ) ;
F_84 ( & V_2 -> V_150 . V_151 ) ;
F_84 ( & V_2 -> V_150 . V_152 ) ;
V_17 = F_85 ( V_2 ) ;
if ( V_17 )
return V_17 ;
F_69 ( V_2 ) ;
...
if ( V_2 -> V_28 & V_155 )
V_2 -> V_154 = true ;
V_129 = V_2 -> V_154 ? 32 : 40 ;
V_17 = F_87 ( V_2 -> V_46 , F_88 ( V_129 ) ) ;
if ( V_17 ) {
V_2 -> V_154 = true ;
F_72 ( V_156 L_23 ) ;
}
V_2 -> V_157 = F_89 ( V_2 -> V_46 , 2 ) ;
V_2 -> V_158 = F_90 ( V_2 -> V_46 , 2 ) ;
V_2 -> V_159 = F_91 ( V_2 -> V_157 , V_2 -> V_158 ) ;
if ( V_2 -> V_159 == NULL ) {
return - V_84 ;
}
F_34 ( L_24 , ( T_1 ) V_2 -> V_157 ) ;
F_34 ( L_25 , ( unsigned ) V_2 -> V_158 ) ;
for ( V_5 = 0 ; V_5 < V_160 ; V_5 ++ ) {
if ( F_92 ( V_2 -> V_46 , V_5 ) & V_161 ) {
V_2 -> V_162 = F_90 ( V_2 -> V_46 , V_5 ) ;
V_2 -> V_98 = F_93 ( V_2 -> V_46 , V_5 , V_2 -> V_162 ) ;
break;
}
}
if ( V_2 -> V_98 == NULL )
F_57 ( L_26 ) ;
F_94 ( V_2 -> V_46 , V_2 , NULL , F_67 ) ;
F_95 ( V_2 -> V_46 ,
F_70 ,
NULL ,
F_77 ) ;
...
F_98 ( V_2 ) ;
F_103 ( V_2 -> V_46 ) ;
F_94 ( V_2 -> V_46 , NULL , NULL , NULL ) ;
if ( V_2 -> V_98 )
F_104 ( V_2 -> V_46 , V_2 -> V_98 ) ;
V_2 -> V_98 = NULL ;
F_105 ( V_2 -> V_159 ) ;
V_2 -> V_159 = NULL ;
}
...
struct V_172 * V_173 = F_108 ( V_166 -> V_174 ) ;
struct V_175 * V_176 ;
if ( V_173 == NULL || V_173 -> V_177 == NULL ) {
continue;
}
V_176 = F_109 ( V_173 -> V_177 ) ;
if ( ! F_110 ( V_2 , V_176 ) ) {
V_17 = F_9 ( V_176 , false ) ;
if ( V_17 == 0 ) {
F_12 ( V_176 ) ;
F_13 ( V_176 ) ;
}
...
V_188 [ V_187 ] . V_185 = V_185 ;
V_188 [ V_187 ] . V_190 = V_186 ;
V_187 ++ ;
#if F_137 ( V_191 )
F_138 ( V_185 , V_186 ,
V_2 -> V_78 -> V_192 -> V_193 ,
V_2 -> V_78 -> V_192 ) ;
F_138 ( V_185 , V_186 ,
V_2 -> V_78 -> V_194 -> V_193 ,
V_2 -> V_78 -> V_194 ) ;
#endif
return 0 ;
}
int F_139 ( struct V_195 * V_196 )
{
return 0 ;
}
void F_140 ( struct V_195 * V_196 )
{
unsigned V_5 ;
for ( V_5 = 0 ; V_5 < V_187 ; V_5 ++ ) {
F_141 ( V_188 [ V_5 ] . V_185 ,
V_188 [ V_5 ] . V_190 , V_196 ) ;
}
}
