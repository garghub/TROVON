...
F_51 ( V_265 L_34 , V_13 -> V_170 , V_153 , V_264 ) ;
goto V_266;
}
if ( ! F_81 ( V_13 -> V_14 , 32 ,
V_2 -> V_228 == V_229 ? L_35 : L_36 ) ) {
goto V_298;
}
if ( F_82 ( V_13 ) )
goto V_299;
...
F_85 ( V_13 ) ;
V_263 = F_86 ( L_37 , 0 , NULL , F_72 , V_2 ) ;
if ( ! V_263 )
F_51 ( V_300 L_38 ) ;
F_51 ( V_180 L_39 ,
...
V_484 = ( T_2 * ) & V_98 . V_488 ;
V_485 = 18 + V_2 -> V_205 ;
} else {
V_484 = ( T_2 * ) & V_98 . V_487 [ 0 ] ;
V_485 = 12 + V_2 -> V_205 ;
}
V_484 [ 0 ] = V_498 ;
V_484 [ 1 ] = V_2 -> V_205 ;
...
F_51 ( V_169 L_42 , V_2 -> V_13 -> V_170 ) ;
return - V_582 ;
}
...
F_51 ( V_169 L_45 , V_2 -> V_13 -> V_170 ) ;
return - V_580 ;
}
...
snprintf ( V_2 -> V_245 , 32 , L_54 , V_615 [ V_613 ] . V_616 ,
...
V_363 . V_306 = V_306 ;
if ( V_644 > V_645 )
F_51 ( V_169 L_57 , V_2 -> V_13 -> V_170 ) ;
