...
static int F_83 ( struct V_155 * V_156 , unsigned int * V_157 ,
...
V_160 [ V_20 ] = V_42 -> V_7 -> V_22 ;
V_159 [ V_20 ] = F_85 ( V_93 [ V_20 ] . V_98 ) ;
F_24 ( V_7 , L_27 , V_20 , V_159 [ V_20 ] ) ;
}
if ( * V_157 == 0 )
* V_157 = 1 ;
return 0 ;
...
{
struct V_163 * V_164 = F_87 ( V_162 , struct V_163 , V_162 ) ;
struct V_41 * V_42 = F_84 ( V_162 -> V_155 ) ;
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_165 ;
int V_166 = 0 ;
F_88 ( & V_42 -> V_167 , V_165 ) ;
if ( V_42 -> V_168 == V_169 ) {
V_42 -> V_168 = V_170 ;
V_166 = 1 ;
}
F_89 ( & V_164 -> V_171 , & V_42 -> V_172 ) ;
F_90 ( & V_42 -> V_167 , V_165 ) ;
if ( V_166 ) {
V_42 -> V_64 . V_173 ( V_42 , V_174 ) ;
F_91 ( V_7 ) ;
}
F_24 ( V_7 , L_28 ) ;
}
...
struct V_6 * V_7 = V_42 -> V_7 ;
unsigned long V_165 ;
F_13 ( V_7 , L_29 , V_42 -> V_47 . V_15 ) ;
F_88 ( & V_42 -> V_167 , V_165 ) ;
if ( V_42 -> V_177 == V_42 -> V_178 )
V_42 -> V_177 = NULL ;
if ( V_42 -> V_177 ) {
F_97 ( & V_42 -> V_177 -> V_162 , V_179 ) ;
V_42 -> V_177 = NULL ;
}
if ( V_42 -> V_178 ) {
F_97 ( & V_42 -> V_178 -> V_162 , V_179 ) ;
V_42 -> V_178 = NULL ;
}
F_90 ( & V_42 -> V_167 , V_165 ) ;
}
...
unsigned long V_165 ;
struct V_180 V_181 ;
struct V_163 * V_182 , * V_183 ;
F_24 ( V_7 , L_18 , V_43 ) ;
F_88 ( & V_42 -> V_167 , V_165 ) ;
V_42 -> V_168 = V_184 ;
F_99 (buf, buf_tmp, &layer->enq_list, list) {
F_100 ( & V_182 -> V_171 ) ;
F_97 ( & V_182 -> V_162 , V_179 ) ;
}
F_90 ( & V_42 -> V_167 , V_165 ) ;
F_101 ( & V_181 , F_96 ,
( unsigned long ) V_42 ) ;
