...
V_38 . V_52 = V_53 ;
V_38 . V_54 = V_55 ;
V_26 -> V_8 -> V_56 ( V_26 , V_57 ,
( unsigned long ) & V_38 ) ;
memset ( & V_5 -> V_58 , 0 , sizeof( V_5 -> V_58 ) ) ;
V_5 -> V_58 . V_59 = V_5 -> V_43 ;
V_5 -> V_58 . V_60 = V_5 -> V_61 ;
V_35 = V_26 -> V_8 -> V_62 ( V_26 ,
& V_5 -> V_58 ,
1 ,
V_47 ,
V_63 | V_64 ) ;
...
V_39 . V_54 = V_53 ;
V_39 . V_52 = V_55 ;
V_18 -> V_8 -> V_56 ( V_18 , V_57 ,
( unsigned long ) & V_39 ) ;
memset ( & V_5 -> V_70 , 0 , sizeof( V_5 -> V_70 ) ) ;
V_5 -> V_70 . V_59 = V_5 -> V_44 ;
V_5 -> V_70 . V_60 = V_5 -> V_61 ;
V_36 = V_18 -> V_8 -> V_62 ( V_18 ,
& V_5 -> V_70 ,
1 ,
V_67 ,
V_63 | V_64 ) ;
...
if ( ! V_72 )
return - V_75 ;
V_73 = ( F_16 ( V_72 ) & V_76 ) >> V_77 ;
V_5 -> V_78 = V_79 / ( V_73 + 1 ) ;
F_17 ( V_72 ) ;
V_5 -> V_80 = 16 ;
V_5 -> V_81 = 40 ;
#ifdef F_18
V_5 -> V_11 = F_19 ( sizeof( struct V_9 ) , V_82 ) ;
if ( ! V_5 -> V_11 )
return - V_75 ;
V_5 -> V_83 = & V_84 ;
#endif
