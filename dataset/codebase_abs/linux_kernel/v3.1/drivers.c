...
V_8 -> V_57 =
#ifdef F_50
F_51 ( V_112 , V_109 , V_115 , F_50 ) ;
#else
F_51 ( V_112 , V_109 , V_115 , V_116 ) ;
#endif
}
F_44 ( V_112 ) ;
if ( V_8 -> V_57 == NULL ) {
...
static unsigned int F_52 ( struct V_44 * V_8 ,
unsigned int V_117 )
{
struct V_4 * V_5 = V_8 -> V_55 ;
unsigned int V_118 = 0 ;
const unsigned V_119 = F_53 ( V_5 ) ;
...
unsigned int F_54 ( struct V_44 * V_8 )
{
unsigned int V_130 ;
unsigned int V_131 ;
if ( V_8 == NULL )
...
unsigned int F_57 ( struct V_44 * V_8 ,
unsigned int V_131 )
{
unsigned int V_130 = V_8 -> V_132 + V_8 -> V_58 ;
if ( ( int ) ( V_8 -> V_133 + V_131 - V_130 ) > 0 )
...
unsigned F_58 ( struct V_44 * V_8 , unsigned int V_131 )
{
...
V_8 -> V_124 += V_131 ;
V_8 -> V_134 += V_131 ;
F_52 ( V_8 , V_8 -> V_124 - V_8 -> V_123 ) ;
if ( V_8 -> V_134 >= V_8 -> V_58 )
V_8 -> V_134 %= V_8 -> V_58 ;
return V_131 ;
}
unsigned F_59 ( struct V_44 * V_8 , unsigned V_131 )
{
...
unsigned F_61 ( struct V_44 * V_8 , unsigned int V_131 )
{
F_55 () ;
...
void F_63 ( struct V_44 * V_8 , unsigned int V_73 ,
...
unsigned int F_64 ( struct V_44 * V_8 )
{
unsigned V_117 ;
if ( V_8 == NULL )
return 0 ;
...
{
unsigned int V_84 = F_64 ( V_8 ) ;
if ( V_84 < sizeof( short ) )
return 0 ;
F_59 ( V_8 , sizeof( short ) ) ;
* V_141 = * ( short * ) ( V_8 -> V_57 + V_8 -> V_136 ) ;
F_61 ( V_8 , sizeof( short ) ) ;
return 1 ;
}
int F_66 ( struct V_44 * V_8 , short V_141 )
{
unsigned int V_84 = F_57 ( V_8 , sizeof( short ) ) ;
if ( V_84 < sizeof( short ) ) {
V_8 -> V_142 |= V_143 ;
return 0 ;
}
...
static int F_68 ( struct V_40 * V_146 ,
...
if ( V_149 < 0 )
return V_149 ;
V_151 = F_71 ( sizeof( unsigned ) , V_52 ) ;
if ( V_151 == NULL ) {
V_150 = - V_53 ;
goto V_153;
}
...
static void F_73 ( struct V_40 * V_146 )
{
unsigned * V_149 = ( unsigned * ) F_74 ( V_146 ) ;
if ( V_149 == NULL )
return;
F_21 ( * V_149 >= V_37 ) ;
F_72 ( * V_149 ) ;
...
int F_75 ( struct V_156 * V_157 , const char * V_11 )
{
int V_147 [ 2 ] ;
V_147 [ 0 ] = V_157 -> V_158 -> V_159 ;
V_147 [ 1 ] = F_76 ( V_157 -> V_160 ) ;
return F_68 ( & V_157 -> V_2 , V_11 ,
V_147 , F_77 ( V_147 ) ) ;
}
void F_78 ( struct V_156 * V_157 )
{
F_73 ( & V_157 -> V_2 ) ;
}
int F_79 ( struct V_161 * V_162 , const char * V_11 )
{
F_21 ( V_162 == NULL ) ;
return F_68 ( & V_162 -> V_2 , V_11 , NULL , 0 ) ;
}
void F_80 ( struct V_161 * V_162 )
{
F_21 ( V_162 == NULL ) ;
F_73 ( & V_162 -> V_2 ) ;
}
