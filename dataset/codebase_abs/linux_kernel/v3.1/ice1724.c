...
V_134 = F_181 ( V_177 , V_359 , V_2 , & V_127 ) ;
if ( V_134 < 0 ) {
F_163 ( V_2 ) ;
return V_134 ;
}
...
V_134 = F_184 ( V_366 [ V_290 ] , V_282 [ V_290 ] , V_367 , 0 , & V_177 ) ;
if ( V_134 < 0 )
return V_134 ;
strcpy ( V_177 -> V_368 , L_7 ) ;
strcpy ( V_177 -> V_369 , L_46 ) ;
...
strcpy ( V_177 -> V_369 , V_299 -> V_183 ) ;
if ( V_299 -> V_368 )
strcpy ( V_177 -> V_368 , V_299 -> V_368 ) ;
if ( V_299 -> V_370 ) {
V_134 = V_299 -> V_370 ( V_2 ) ;
if ( V_134 < 0 ) {
F_185 ( V_177 ) ;
return V_134 ;
}
...
if ( ! V_2 -> V_114 )
F_78 ( V_2 ) ;
V_134 = F_88 ( V_2 , V_362 ++ ) ;
if ( V_134 < 0 ) {
F_185 ( V_177 ) ;
return V_134 ;
}
V_134 = F_100 ( V_2 , V_362 ++ ) ;
if ( V_134 < 0 ) {
F_185 ( V_177 ) ;
return V_134 ;
}
V_134 = F_104 ( V_2 , V_362 ++ ) ;
if ( V_134 < 0 ) {
F_185 ( V_177 ) ;
return V_134 ;
}
...
F_9 ( V_383 | 0x1 ,
F_15 ( V_2 , V_384 ) ) ;
F_9 ( 0x1 , F_15 ( V_2 , V_384 ) ) ;
F_9 ( V_385 , F_15 ( V_2 , V_59 ) ) ;
}
}
sprintf ( V_177 -> V_224 , L_49 ,
V_177 -> V_369 , V_2 -> V_232 , V_2 -> V_63 ) ;
V_134 = F_188 ( V_177 ) ;
if ( V_134 < 0 ) {
F_185 ( V_177 ) ;
return V_134 ;
...
static int F_192 ( struct V_343 * V_185 , T_8 V_386 )
{
...
V_2 -> V_390 = F_12 ( F_3 ( V_2 , V_191 ) ) ;
V_2 -> V_391 = F_2 ( F_15 ( V_2 , V_189 ) ) ;
V_2 -> V_392 = F_17 ( F_3 ( V_2 , V_231 ) ) ;
F_34 ( & V_2 -> V_53 ) ;
if ( V_2 -> V_393 )
V_2 -> V_393 ( V_2 ) ;
F_167 ( V_185 ) ;
F_196 ( V_185 ) ;
F_197 ( V_185 , F_198 ( V_185 , V_386 ) ) ;
return 0 ;
}
...
F_93 ( V_2 , V_2 -> V_390 ) ;
F_9 ( V_2 -> V_391 , F_15 ( V_2 , V_189 ) ) ;
F_14 ( V_2 -> V_392 , F_3 ( V_2 , V_231 ) ) ;
if ( V_2 -> V_17 )
F_202 ( V_2 -> V_17 ) ;
F_193 ( V_177 , V_396 ) ;
return 0 ;
