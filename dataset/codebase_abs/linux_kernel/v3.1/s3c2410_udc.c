...
static int F_84 ( struct V_228 * V_140 ,
...
static int F_89 ( struct V_228 * V_140 )
{
struct V_60 * V_61 = V_201 ;
if ( ! V_61 )
return - V_229 ;
...
V_200 = F_108 ( & V_236 -> V_63 , & V_61 -> V_142 ) ;
if ( V_200 )
goto V_263;
if ( V_264 ) {
V_61 -> V_265 = F_109 ( L_91 , V_266 ,
V_264 ,
V_61 , & V_267 ) ;
if ( ! V_61 -> V_265 )
F_110 ( V_63 , L_92 ) ;
...
static int F_121 ( struct V_235 * V_236 , T_8 V_268 )
{
F_81 ( V_223 ) ;
return 0 ;
}
...
{
int V_200 ;
F_6 ( V_90 , L_95 , V_248 , V_269 ) ;
V_264 = F_124 ( V_248 , NULL ) ;
if ( F_93 ( V_264 ) ) {
F_9 ( V_231 L_96 ,
V_248 , F_95 ( V_264 ) ) ;
V_264 = NULL ;
