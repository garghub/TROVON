...
static void F_162 ( struct V_1 * V_2 , struct V_255 * V_256 ,
struct V_255 * V_18 )
{
while ( V_256 < V_18 ) {
if ( ( V_256 -> V_167 == V_2 -> V_167 || V_256 -> V_167 == ( T_3 ) V_257 ) &&
( V_256 -> V_94 == V_2 -> V_94 || V_256 -> V_94 == ( T_3 ) V_257 ) ) {
F_163 ( & V_2 -> V_2 , L_105 , V_256 -> V_258 ) ;
V_256 -> V_258 ( V_2 ) ;
}
V_256 ++ ;
}
}
void F_164 ( enum V_259 V_260 , struct V_1 * V_2 )
{
struct V_255 * V_19 , * V_18 ;
switch( V_260 ) {
case V_261 :
V_19 = V_262 ;
V_18 = V_263 ;
...
static int F_167 ( struct V_1 * V_2 , int V_287 )
{
int V_223 ;
if ( V_2 -> V_11 == V_288 ) {
V_223 = F_113 ( V_2 , V_289 ) ;
if ( ! V_223 )
return - V_290 ;
if ( V_287 )
return 0 ;
...
static int F_169 ( struct V_1 * V_2 , int V_287 )
{
int V_223 ;
V_223 = F_113 ( V_2 , V_291 ) ;
if ( ! V_223 )
return - V_290 ;
if ( V_287 )
return 0 ;
...
int F_170 ( struct V_1 * V_2 , int V_287 )
{
const struct V_294 * V_3 ;
for ( V_3 = V_294 ; V_3 -> V_295 ; V_3 ++ ) {
if ( ( V_3 -> V_167 == V_2 -> V_167 ||
V_3 -> V_167 == ( T_3 ) V_257 ) &&
( V_3 -> V_94 == V_2 -> V_94 ||
V_3 -> V_94 == ( T_3 ) V_257 ) )
return V_3 -> V_295 ( V_2 , V_287 ) ;
}
return - V_290 ;
}
