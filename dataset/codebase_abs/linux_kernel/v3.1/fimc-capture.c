...
V_33 -> V_105 [ 0 ] = 0 ;
V_33 -> V_106 = V_107 | V_108 |
V_109 ;
return 0 ;
}
static int F_80 ( struct V_53 * V_54 )
{
struct V_61 * V_110 = & V_54 -> V_57 ;
struct V_2 * V_3 = V_54 -> V_2 ;
struct V_111 * V_64 = & V_3 -> V_9 . V_64 ;
int V_26 ;
V_64 -> V_112 = V_54 -> V_75 . V_113 ;
V_64 -> V_114 = V_54 -> V_75 . V_115 ;
V_26 = F_18 ( V_3 -> V_9 . V_10 , V_41 , V_116 , V_64 ) ;
if ( V_26 == - V_56 ) {
F_39 ( L_10 ) ;
return V_26 ;
}
F_31 ( L_11 , V_64 -> V_112 , V_64 -> V_114 , V_64 -> V_117 ) ;
V_110 -> V_64 = F_81 ( V_64 , V_118 ) ;
if ( ! V_110 -> V_64 ) {
F_39 ( L_12 ) ;
return - V_27 ;
}
V_110 -> V_66 = V_64 -> V_112 ;
V_110 -> V_67 = V_64 -> V_114 ;
V_110 -> V_112 = V_64 -> V_112 ;
V_110 -> V_114 = V_64 -> V_114 ;
V_110 -> V_113 = V_64 -> V_112 ;
V_110 -> V_115 = V_64 -> V_114 ;
V_110 -> V_119 = 0 ;
V_110 -> V_120 = 0 ;
return 0 ;
}
static int F_82 ( struct V_88 * V_88 , void * V_99 ,
struct V_121 * V_122 )
{
...
if ( V_122 -> type != V_80 )
return - V_27 ;
V_26 = F_83 ( V_88 , V_99 , V_122 ) ;
if ( V_26 )
return V_26 ;
if ( F_84 ( & V_3 -> V_9 . V_94 ) || F_20 ( V_3 ) )
return - V_90 ;
V_110 = & V_54 -> V_75 ;
V_124 = & V_122 -> V_64 . V_125 ;
V_110 -> V_64 = F_85 ( V_122 , V_126 | V_118 ) ;
if ( ! V_110 -> V_64 ) {
F_39 ( L_13 ) ;
return - V_27 ;
}
for ( V_22 = 0 ; V_22 < V_110 -> V_64 -> V_127 ; V_22 ++ ) {
V_110 -> V_128 [ V_22 ] =
( V_124 -> V_112 * V_124 -> V_114 * V_110 -> V_64 -> V_68 [ V_22 ] ) >> 3 ;
}
V_110 -> V_66 = V_124 -> V_129 [ 0 ] . V_130 * 8
/ V_110 -> V_64 -> V_68 [ 0 ] ;
V_110 -> V_67 = V_124 -> V_114 ;
V_110 -> V_112 = V_124 -> V_112 ;
V_110 -> V_114 = V_124 -> V_114 ;
V_110 -> V_113 = V_124 -> V_112 ;
V_110 -> V_115 = V_124 -> V_114 ;
V_110 -> V_119 = 0 ;
V_110 -> V_120 = 0 ;
V_54 -> V_38 |= ( V_58 | V_131 ) ;
V_26 = F_80 ( V_54 ) ;
return V_26 ;
}
static int F_86 ( struct V_88 * V_88 , void * V_99 ,
struct V_132 * V_22 )
{
struct V_53 * V_54 = V_99 ;
struct V_20 * V_133 = V_54 -> V_2 -> V_21 ;
struct V_4 * V_5 ;
if ( V_22 -> V_19 >= V_133 -> V_23 )
return - V_27 ;
V_5 = & V_133 -> V_5 [ V_22 -> V_19 ] ;
V_22 -> type = V_134 ;
...
return F_90 ( & V_3 -> V_9 . V_94 , type ) ;
}
static int F_91 ( struct V_88 * V_88 , void * V_99 ,
enum V_135 type )
{
struct V_53 * V_54 = V_99 ;
struct V_2 * V_3 = V_54 -> V_2 ;
return F_92 ( & V_3 -> V_9 . V_94 , type ) ;
}
static int F_93 ( struct V_88 * V_88 , void * V_99 ,
struct V_136 * V_137 )
{
struct V_53 * V_54 = V_99 ;
struct V_8 * V_33 = & V_54 -> V_2 -> V_9 ;
int V_26 ;
V_26 = F_94 ( & V_33 -> V_94 , V_137 ) ;
if ( ! V_26 )
V_33 -> V_86 = V_137 -> V_138 ;
return V_26 ;
}
static int F_95 ( struct V_88 * V_88 , void * V_99 ,
struct V_139 * V_35 )
{
struct V_53 * V_54 = V_99 ;
struct V_8 * V_33 = & V_54 -> V_2 -> V_9 ;
return F_96 ( & V_33 -> V_94 , V_35 ) ;
}
static int F_97 ( struct V_88 * V_88 , void * V_99 ,
struct V_139 * V_35 )
{
struct V_53 * V_54 = V_99 ;
struct V_8 * V_33 = & V_54 -> V_2 -> V_9 ;
return F_98 ( & V_33 -> V_94 , V_35 ) ;
}
static int F_99 ( struct V_88 * V_88 , void * V_99 ,
struct V_139 * V_35 )
{
struct V_53 * V_54 = V_99 ;
return F_100 ( & V_54 -> V_2 -> V_9 . V_94 , V_35 ,
V_88 -> V_140 & V_141 ) ;
}
static int F_101 ( struct V_88 * V_88 , void * V_99 ,
struct V_142 * V_143 )
{
struct V_53 * V_54 = V_99 ;
int V_26 = - V_27 ;
if ( ! F_20 ( V_54 -> V_2 ) ||
V_143 -> V_24 != V_144 ||
( V_143 -> V_145 != 90 && V_143 -> V_145 != 270 ) ) {
V_26 = F_102 ( V_54 , V_143 ) ;
if ( ! V_26 ) {
V_26 = F_103 ( V_54 , V_143 ) ;
if ( ! V_26 )
V_54 -> V_38 |= V_58 ;
}
}
...
static int F_104 ( struct V_88 * V_88 , void * V_147 ,
struct V_148 * V_149 )
{
struct V_61 * V_122 ;
...
V_149 -> V_150 . V_151 = 0 ;
V_149 -> V_150 . V_152 = 0 ;
V_149 -> V_150 . V_112 = V_122 -> V_113 ;
V_149 -> V_150 . V_114 = V_122 -> V_115 ;
V_149 -> V_153 = V_149 -> V_150 ;
return 0 ;
}
static int F_105 ( struct V_88 * V_88 , void * V_147 , struct V_154 * V_149 )
{
struct V_61 * V_122 ;
struct V_53 * V_54 = V_88 -> V_93 ;
V_122 = & V_54 -> V_57 ;
V_149 -> V_155 . V_151 = V_122 -> V_119 ;
V_149 -> V_155 . V_152 = V_122 -> V_120 ;
V_149 -> V_155 . V_112 = V_122 -> V_112 ;
V_149 -> V_155 . V_114 = V_122 -> V_114 ;
return 0 ;
}
static int F_106 ( struct V_88 * V_88 , void * V_147 ,
struct V_154 * V_149 )
{
struct V_61 * V_122 ;
struct V_53 * V_54 = V_88 -> V_93 ;
...
V_122 = & V_54 -> V_57 ;
V_26 = F_108 ( V_149 -> V_155 . V_112 , V_149 -> V_155 . V_114 ,
V_54 -> V_75 . V_112 , V_54 -> V_75 . V_114 ,
V_54 -> V_156 ) ;
if ( V_26 ) {
F_5 ( & V_3 -> V_9 . V_13 , L_17 ) ;
return V_26 ;
}
V_122 -> V_119 = V_149 -> V_155 . V_151 ;
V_122 -> V_120 = V_149 -> V_155 . V_152 ;
V_122 -> V_112 = V_149 -> V_155 . V_112 ;
V_122 -> V_114 = V_149 -> V_155 . V_114 ;
return 0 ;
}
...
V_54 -> V_162 = V_163 ;
V_54 -> V_38 = V_164 ;
V_122 . V_64 . V_124 . V_165 = V_166 ;
V_62 = & V_54 -> V_75 ;
V_62 -> V_64 = F_85 ( & V_122 , V_126 ) ;
V_62 -> V_112 = V_62 -> V_66 = V_62 -> V_113 = 640 ;
V_62 -> V_114 = V_62 -> V_67 = V_62 -> V_115 = 480 ;
if ( ! V_13 -> V_103 [ 0 ] )
snprintf ( V_13 -> V_103 , sizeof( V_13 -> V_103 ) ,
L_18 , F_111 ( & V_3 -> V_102 -> V_167 ) ) ;
V_26 = F_112 ( NULL , V_13 ) ;
if ( V_26 )
goto V_168;
V_158 = F_113 () ;
if ( ! V_158 ) {
...
snprintf ( V_158 -> V_103 , sizeof( V_158 -> V_103 ) , L_20 ,
F_111 ( & V_3 -> V_102 -> V_167 ) ) ;
V_158 -> V_170 = & V_171 ;
V_158 -> V_172 = & V_173 ;
V_158 -> V_174 = - 1 ;
V_158 -> V_175 = V_176 ;
...
V_52 -> V_181 = & V_182 ;
V_52 -> V_183 = & V_184 ;
V_52 -> V_185 = sizeof( struct V_34 ) ;
F_116 ( V_52 ) ;
V_26 = F_117 ( V_158 , V_186 , - 1 ) ;
if ( V_26 ) {
F_5 ( V_13 , L_21 ) ;
goto V_187;
}
...
V_168:
F_119 ( V_54 ) ;
F_120 ( & V_3 -> V_102 -> V_167 , L_23 ) ;
return V_26 ;
}
void F_121 ( struct V_2 * V_3 )
{
struct V_8 * V_189 = & V_3 -> V_9 ;
if ( V_189 -> V_158 )
F_122 ( V_189 -> V_158 ) ;
F_119 ( V_189 -> V_54 ) ;
}
