...
V_4 = V_2 -> V_8 ;
V_73 = V_2 -> V_7 ;
if ( F_28 ( V_75 , & V_4 -> V_13 ) ) {
F_29 ( V_73 , L_15 ,
V_4 -> V_9 ) ;
goto V_76;
}
if ( F_28 ( V_77 , & V_4 -> V_13 ) ) {
F_29 ( V_73 , L_16
L_17 ,
V_4 -> V_9 ) ;
goto V_76;
...
if ( ! ( F_28 ( V_160 , & V_19 -> V_161 ) ) ||
( F_28 ( V_162 , & V_19 -> V_161 ) ) ) {
F_11 (KERN_ERR PFX L_57 , op) ;
V_6 = - V_155 ;
goto V_156;
}
V_44 = F_47 ( V_19 , V_163 ) ;
if ( ! V_44 ) {
V_6 = - V_29 ;
goto V_156;
}
...
V_46 -> V_164 = V_141 ;
V_44 -> V_116 = V_46 -> V_164 ;
if ( ( V_140 >= V_84 ) && ( V_140 <= V_165 ) ) {
memcpy ( V_46 -> V_166 , V_119 , V_141 ) ;
} else {
...
goto V_156;
V_48 = & ( V_46 -> V_167 ) ;
V_154 = V_19 -> V_149 -> V_168 ;
V_24 = V_19 -> V_24 ;
if ( V_140 == V_134 )
F_49 ( V_48 , V_169 , V_154 , V_24 ,
V_170 , V_171 |
V_172 | V_173 , 0 ) ;
else
F_49 ( V_48 , V_174 , V_154 , V_24 ,
V_175 , V_171 |
V_172 | V_173 , 0 ) ;
V_9 = V_44 -> V_9 ;
V_152 = V_9 / V_176 ;
...
V_181 = ( T_4 * ) V_48 ;
V_182 = ( T_4 * )
& V_36 -> V_186 . V_187 . V_188 . V_189 . V_48 ;
V_181 [ 0 ] = F_58 ( V_182 [ 0 ] ) ;
V_181 [ 1 ] = F_58 ( V_182 [ 1 ] ) ;
V_181 [ 2 ] = F_58 ( V_182 [ 2 ] ) ;
V_46 -> V_51 =
V_36 -> V_186 . V_187 . V_188 . V_189 . V_190 ;
...
static void F_59 ( struct V_191 * V_192 , struct V_60 * V_61 ,
void * V_193 )
{
struct V_194 * V_195 = V_193 ;
struct V_196 * V_197 = F_60 ( V_192 ) ;
...
if ( V_21 -> V_203 ) {
if ( V_140 == V_84 ) {
F_11 (KERN_ERR PFX L_67 ) ;
F_64 ( V_21 -> V_203 ) ;
F_34 ( V_61 ) ;
return;
}
}
if ( F_65 ( V_195 , V_21 , V_61 ) ) {
F_34 ( V_61 ) ;
return;
}
}
V_195 -> V_204 ( V_21 , V_199 ) ;
V_200:
F_66 ( V_192 , V_61 , V_21 ) ;
}
static void F_67 ( struct V_191 * V_192 , struct V_60 * V_61 ,
void * V_193 )
{
struct V_194 * V_195 = V_193 ;
struct V_196 * V_197 = F_60 ( V_192 ) ;
struct V_20 * V_21 = V_197 -> V_198 ;
static T_3 V_205 [ V_206 ] = { 0 } ;
if ( ! F_61 ( V_61 ) )
V_195 -> V_204 ( V_21 , V_205 ) ;
F_68 ( V_192 , V_61 , V_21 ) ;
}
struct V_191 * F_69 ( struct V_20 * V_21 , T_1 V_154 ,
struct V_60 * V_61 , unsigned int V_140 ,
void (* F_70)( struct V_191 * ,
struct V_60 * ,
void * ) ,
void * V_193 , T_1 V_207 )
{
struct V_143 * V_144 = F_71 ( V_21 ) ;
struct V_145 * V_146 = V_144 -> V_147 ;
struct V_194 * V_195 = & V_146 -> V_208 ;
struct V_47 * V_64 = F_22 ( V_61 ) ;
switch ( V_140 ) {
case V_209 :
case V_210 :
return F_72 ( V_21 , V_154 , V_61 , V_140 , F_59 ,
V_195 , V_207 ) ;
case V_69 :
if ( F_73 ( V_64 -> V_211 ) != V_212 )
break;
return F_72 ( V_21 , V_154 , V_61 , V_140 , F_67 ,
V_195 , V_207 ) ;
}
return F_72 ( V_21 , V_154 , V_61 , V_140 , F_70 , V_193 , V_207 ) ;
}
