...
F_38 ( V_3 , V_39 ) ;
for ( V_40 = F_39 ( V_23 . V_28 , V_42 ) ;
V_40 < V_42 ;
V_40 = F_40 ( V_23 . V_28 , V_42 , V_40 + 1 ) ) {
...
static int F_43 ( struct V_21 * V_22 , unsigned int V_43 )
{
int V_15 = F_22 ( & V_23 . V_2 , V_22 -> V_14 ) ;
if ( V_43 ) {
if ( F_44 ( V_23 . V_44 , V_42 ) )
F_45 ( V_45 , 1 ) ;
F_46 ( V_15 , V_23 . V_44 ) ;
} else {
F_47 ( V_15 , V_23 . V_44 ) ;
...
static int T_3 F_48 ( struct V_46 * V_47 )
{
int V_40 , V_14 , V_48 ;
F_49 ( V_23 . V_28 , V_42 ) ;
F_49 ( V_23 . V_44 , V_42 ) ;
...
static int T_4 F_54 ( struct V_46 * V_47 )
{
int V_48 = F_55 ( & V_23 . V_2 ) ;
if ( V_48 < 0 )
return V_48 ;
F_56 ( V_45 , NULL ) ;
return 0 ;
