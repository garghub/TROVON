...
static int F_33 ( struct V_33 * log )
{
int V_13 = 0 ;
unsigned long V_67 ;
struct V_5 * V_6 = log -> V_45 ;
...
V_60 -> type = V_73 ;
V_60 -> V_50 = V_50 ;
F_42 ( & V_60 -> V_66 , & V_6 -> V_37 ) ;
F_35 ( & V_6 -> V_36 , V_67 ) ;
return;
}
static void F_43 ( struct V_33 * log , T_4 V_50 )
{
unsigned long V_67 ;
struct V_5 * V_6 = log -> V_45 ;
struct V_3 * V_60 ;
...
V_60 -> type = V_75 ;
V_60 -> V_50 = V_50 ;
F_42 ( & V_60 -> V_66 , & V_6 -> V_38 ) ;
F_35 ( & V_6 -> V_36 , V_67 ) ;
return;
}
static int F_44 ( struct V_33 * log , T_4 * V_50 )
{
int V_13 ;
T_2 V_12 ;
struct V_5 * V_6 = log -> V_45 ;
...
static void F_45 ( struct V_33 * log ,
T_4 V_50 , int V_55 )
{
int V_13 ;
struct V_5 * V_6 = log -> V_45 ;
...
static T_4 F_46 ( struct V_33 * log )
{
int V_13 ;
T_2 V_12 ;
T_3 V_79 ;
...
static int F_47 ( struct V_33 * log , T_6 V_81 ,
...
F_41 ( ! V_84 ) ;
V_84 ++ ;
F_48 ( L_16 , log -> type -> V_88 , V_6 -> V_44 ,
V_6 -> V_7 , V_84 ) ;
break;
}
return ( V_13 ) ? 0 : ( int ) V_85 ;
}
static int F_49 ( struct V_33 * log ,
T_4 V_50 )
{
int V_13 ;
T_3 V_51 = V_50 ;
