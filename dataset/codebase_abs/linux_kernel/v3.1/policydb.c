...
if ( V_7 -> V_162 >= V_190 )
V_189 = 3 ;
V_9 = F_70 ( V_159 , V_158 , sizeof( V_159 [ 0 ] ) * V_189 ) ;
if ( V_9 )
goto V_167;
V_166 = F_71 ( V_159 [ 0 ] ) ;
...
static int F_82 ( struct V_195 * V_196 , void * V_158 )
{
T_2 V_159 [ 1 ] ;
int V_9 ;
...
V_196 -> V_87 = F_71 ( V_159 [ 0 ] ) ;
V_9 = F_72 ( & V_196 -> V_122 , V_158 ) ;
if ( V_9 ) {
F_31 ( V_153 L_22 ) ;
return V_9 ;
}
...
V_8 [ V_166 ] = '\0' ;
V_9 = - V_12 ;
V_84 -> V_86 = F_36 ( sizeof( struct V_195 ) , V_197 ) ;
if ( ! V_84 -> V_86 )
goto V_167;
...
V_198 = V_7 -> V_82 [ V_198 -> V_69 - 1 ] ;
F_87 (&user->roles, node, bit) {
if ( F_67 ( & V_198 -> V_120 , V_201 ) )
continue;
F_31 ( V_153
L_25
L_26 ,
...
V_198 = V_7 -> V_71 [ V_198 -> V_69 - 1 ] ;
F_87 (&role->types, node, bit) {
if ( F_67 ( & V_198 -> V_119 , V_201 ) )
continue;
F_31 ( V_153
L_25
L_29 ,
...
V_207 -> V_207 = F_71 ( V_159 [ 3 ] ) ;
V_9 = F_99 ( & V_7 -> V_51 , V_26 -> V_31 , 1 ) ;
if ( V_9 )
goto V_14;
F_6 ( V_7 -> V_25 , V_26 , V_207 ) ;
}
F_29 ( V_7 -> V_25 , L_35 ) ;
return 0 ;
V_14:
...
{
int V_3 , V_175 , V_9 ;
T_1 V_97 , V_209 , V_166 , V_187 ;
T_2 V_159 [ 1 ] ;
struct V_126 * V_210 , * V_127 ;
struct V_126 * V_211 = NULL ;
struct V_135 * V_212 , * V_135 ;
struct V_135 * V_213 = NULL ;
V_9 = F_70 ( V_159 , V_158 , sizeof( T_1 ) ) ;
if ( V_9 )
goto V_14;
V_97 = F_71 ( V_159 [ 0 ] ) ;
...
V_166 = F_71 ( V_159 [ 0 ] ) ;
V_9 = - V_12 ;
V_213 = F_4 ( sizeof( * V_213 ) , V_13 ) ;
if ( ! V_213 )
goto V_14;
V_9 = - V_12 ;
V_213 -> V_147 = F_36 ( V_166 + 1 , V_13 ) ;
if ( ! V_213 -> V_147 )
goto V_14;
V_9 = F_70 ( V_213 -> V_147 , V_158 , V_166 ) ;
if ( V_9 )
goto V_14;
V_213 -> V_147 [ V_166 ] = 0 ;
for ( V_212 = NULL , V_135 = V_7 -> V_135 ; V_135 ;
V_212 = V_135 , V_135 = V_135 -> V_115 ) {
V_9 = - V_15 ;
if ( strcmp ( V_213 -> V_147 , V_135 -> V_147 ) == 0 ) {
F_31 ( V_153 L_36 ,
V_213 -> V_147 ) ;
goto V_14;
}
...
goto V_14;
V_209 = F_71 ( V_159 [ 0 ] ) ;
for ( V_175 = 0 ; V_175 < V_209 ; V_175 ++ ) {
V_9 = F_70 ( V_159 , V_158 , sizeof( T_1 ) ) ;
if ( V_9 )
goto V_14;
V_166 = F_71 ( V_159 [ 0 ] ) ;
V_9 = - V_12 ;
V_211 = F_4 ( sizeof( * V_211 ) , V_13 ) ;
if ( ! V_211 )
goto V_14;
V_9 = - V_12 ;
V_211 -> V_133 . V_33 = F_36 ( V_166 + 1 , V_13 ) ;
if ( ! V_211 -> V_133 . V_33 )
goto V_14;
V_9 = F_70 ( V_211 -> V_133 . V_33 , V_158 , V_166 ) ;
if ( V_9 )
goto V_14;
V_211 -> V_133 . V_33 [ V_166 ] = 0 ;
V_9 = F_70 ( V_159 , V_158 , sizeof( T_1 ) ) ;
if ( V_9 )
goto V_14;
V_211 -> V_39 . V_214 = F_71 ( V_159 [ 0 ] ) ;
V_9 = F_74 ( & V_211 -> V_128 [ 0 ] , V_7 , V_158 ) ;
if ( V_9 )
goto V_14;
for ( V_210 = NULL , V_127 = V_135 -> V_148 ; V_127 ;
V_210 = V_127 , V_127 = V_127 -> V_115 ) {
V_9 = - V_15 ;
if ( ! strcmp ( V_211 -> V_133 . V_33 , V_127 -> V_133 . V_33 ) &&
( ! V_127 -> V_39 . V_214 || ! V_211 -> V_39 . V_214 ||
V_211 -> V_39 . V_214 == V_127 -> V_39 . V_214 ) ) {
F_31 ( V_153 L_37 ,
V_135 -> V_147 , V_127 -> V_133 . V_33 ) ;
goto V_14;
}
V_166 = strlen ( V_211 -> V_133 . V_33 ) ;
...
if ( V_9 )
goto V_14;
V_127 -> V_133 . V_218 . V_219 = F_71 ( V_159 [ 0 ] ) ;
V_127 -> V_133 . V_218 . V_220 = F_71 ( V_159 [ 1 ] ) ;
V_127 -> V_133 . V_218 . V_221 = F_71 ( V_159 [ 2 ] ) ;
V_9 = F_74 ( & V_127 -> V_128 [ 0 ] , V_7 , V_158 ) ;
if ( V_9 )
goto V_14;
break;
case V_222 :
V_9 = F_70 ( V_215 , V_158 , sizeof( T_1 ) * 2 ) ;
if ( V_9 )
goto V_14;
V_127 -> V_133 . V_200 . V_223 = V_215 [ 0 ] ;
V_127 -> V_133 . V_200 . V_224 = V_215 [ 1 ] ;
V_9 = F_74 ( & V_127 -> V_128 [ 0 ] , V_7 , V_158 ) ;
if ( V_9 )
goto V_14;
break;
...
goto V_14;
V_9 = - V_15 ;
V_127 -> V_39 . V_225 = F_71 ( V_159 [ 0 ] ) ;
if ( V_127 -> V_39 . V_225 > V_226 )
goto V_14;
V_9 = - V_12 ;
V_166 = F_71 ( V_159 [ 1 ] ) ;
V_127 -> V_133 . V_33 = F_36 ( V_166 + 1 , V_13 ) ;
...
case V_227 : {
int V_24 ;
V_9 = F_70 ( V_215 , V_158 , sizeof( T_1 ) * 8 ) ;
if ( V_9 )
goto V_14;
for ( V_24 = 0 ; V_24 < 4 ; V_24 ++ )
V_127 -> V_133 . V_228 . V_223 [ V_24 ] = V_215 [ V_24 ] ;
for ( V_24 = 0 ; V_24 < 4 ; V_24 ++ )
V_127 -> V_133 . V_228 . V_224 [ V_24 ] = V_215 [ V_24 + 4 ] ;
V_9 = F_74 ( & V_127 -> V_128 [ 0 ] , V_7 , V_158 ) ;
if ( V_9 )
goto V_14;
break;
...
V_9 = - V_12 ;
V_229 = F_36 ( V_166 + 1 , V_13 ) ;
if ( ! V_229 ) {
F_31 ( V_153 L_42
L_43 , V_166 ) ;
goto V_167;
}
V_9 = F_70 ( V_229 , V_158 , V_166 ) ;
if ( V_9 ) {
F_31 ( V_153 L_44 ) ;
F_7 ( V_229 ) ;
goto V_167;
...
F_31 ( V_153 L_47
L_48 ,
F_71 ( V_159 [ 0 ] ) , V_232 , V_233 ) ;
goto V_167;
}
if ( ( F_71 ( V_159 [ 1 ] ) & V_234 ) ) {
V_7 -> V_103 = 1 ;
V_9 = - V_15 ;
if ( V_7 -> V_162 < V_163 ) {
F_31 ( V_153 L_49
...
V_7 -> V_235 = ! ! ( F_71 ( V_159 [ 1 ] ) & V_236 ) ;
V_7 -> V_237 = ! ! ( F_71 ( V_159 [ 1 ] ) & V_238 ) ;
if ( V_7 -> V_162 >= V_239 ) {
...
V_9 = - V_15 ;
if ( F_71 ( V_159 [ 2 ] ) != V_4 -> V_241 ||
F_71 ( V_159 [ 3 ] ) != V_4 -> V_216 ) {
F_31 ( V_153 L_53
L_54 , F_71 ( V_159 [ 2 ] ) ,
F_71 ( V_159 [ 3 ] ) ,
V_4 -> V_241 , V_4 -> V_216 ) ;
...
V_97 = F_71 ( V_159 [ 1 ] ) ;
for ( V_175 = 0 ; V_175 < V_97 ; V_175 ++ ) {
V_9 = V_242 [ V_3 ] ( V_7 , V_7 -> V_47 [ V_3 ] . V_21 , V_158 ) ;
if ( V_9 )
goto V_167;
}
...
V_142 -> V_32 = V_7 -> V_204 ;
if ( ! F_64 ( V_7 , V_142 -> V_11 ) ||
! F_65 ( V_7 , V_142 -> type ) ||
! F_63 ( V_7 , V_142 -> V_32 ) ||
! F_64 ( V_7 , V_142 -> V_244 ) )
goto V_167;
V_143 = V_142 ;
}
V_9 = F_70 ( V_159 , V_158 , sizeof( T_1 ) ) ;
...
V_139 -> V_244 = F_71 ( V_159 [ 1 ] ) ;
if ( ! F_64 ( V_7 , V_139 -> V_11 ) ||
! F_64 ( V_7 , V_139 -> V_244 ) )
goto V_167;
V_140 = V_139 ;
}
V_9 = F_98 ( V_7 , V_158 ) ;
...
goto V_167;
V_9 = - V_15 ;
V_7 -> V_246 = F_95 ( V_7 , V_7 -> V_204 , L_56 ) ;
V_7 -> V_246 |= F_95 ( V_7 , V_7 -> V_204 , L_57 ) ;
if ( ! V_7 -> V_246 )
goto V_167;
...
static int F_105 ( struct V_195 * V_210 , void * V_158 )
{
T_2 V_159 [ 1 ] ;
int V_9 ;
V_159 [ 0 ] = F_106 ( V_210 -> V_87 ) ;
V_9 = F_107 ( V_159 , sizeof( T_1 ) , 1 , V_158 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_108 ( & V_210 -> V_122 , V_158 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
...
T_4 V_160 ;
int V_9 , V_248 ;
V_248 = F_110 ( & V_157 -> V_86 [ 1 ] , & V_157 -> V_86 [ 0 ] ) ;
if ( V_248 )
V_160 = 2 ;
else
V_160 = 3 ;
...
static int F_111 ( void * V_249 , void * V_54 , void * V_250 )
{
char * V_8 = V_249 ;
struct V_83 * V_84 = V_54 ;
struct V_251 * V_252 = V_250 ;
void * V_158 = V_252 -> V_158 ;
T_2 V_159 [ 2 ] ;
T_4 V_166 ;
int V_9 ;
V_166 = strlen ( V_8 ) ;
...
static int F_112 ( void * V_249 , void * V_54 , void * V_250 )
{
char * V_8 = V_249 ;
...
static int F_116 ( void * V_249 , void * V_54 , void * V_158 )
{
char * V_8 = V_249 ;
...
static int F_117 ( void * V_249 , void * V_54 , void * V_250 )
{
char * V_8 = V_249 ;
...
static int F_118 ( struct V_6 * V_7 , struct V_106 * V_200 ,
void * V_158 )
{
struct V_106 * V_127 ;
struct V_109 * V_110 ;
...
T_1 V_97 ;
int V_9 ;
for ( V_127 = V_200 ; V_127 ; V_127 = V_127 -> V_115 ) {
V_97 = 0 ;
...
static int F_119 ( void * V_249 , void * V_54 , void * V_250 )
{
char * V_8 = V_249 ;
struct V_64 * V_65 = V_54 ;
struct V_251 * V_252 = V_250 ;
void * V_158 = V_252 -> V_158 ;
struct V_6 * V_7 = V_252 -> V_7 ;
struct V_106 * V_127 ;
T_2 V_159 [ 6 ] ;
T_1 V_170 ;
T_4 V_166 , V_187 ;
...
static int F_120 ( void * V_249 , void * V_54 , void * V_250 )
{
char * V_8 = V_249 ;
...
static int F_121 ( void * V_249 , void * V_54 , void * V_250 )
{
char * V_8 = V_249 ;
...
static int F_122 ( void * V_249 , void * V_54 , void * V_250 )
{
char * V_8 = V_249 ;
...
break;
case V_217 :
V_159 [ 0 ] = F_106 ( V_127 -> V_133 . V_218 . V_219 ) ;
V_159 [ 1 ] = F_106 ( V_127 -> V_133 . V_218 . V_220 ) ;
V_159 [ 2 ] = F_106 ( V_127 -> V_133 . V_218 . V_221 ) ;
V_9 = F_107 ( V_159 , sizeof( T_1 ) , 3 , V_158 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_115 ( V_7 , & V_127 -> V_128 [ 0 ] , V_158 ) ;
...
break;
case V_222 :
V_215 [ 0 ] = V_127 -> V_133 . V_200 . V_223 ;
V_215 [ 1 ] = V_127 -> V_133 . V_200 . V_224 ;
V_9 = F_107 ( V_215 , sizeof( T_1 ) , 2 , V_158 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_115 ( V_7 , & V_127 -> V_128 [ 0 ] , V_158 ) ;
if ( V_9 )
...
break;
case V_132 :
V_159 [ 0 ] = F_106 ( V_127 -> V_39 . V_225 ) ;
V_166 = strlen ( V_127 -> V_133 . V_33 ) ;
V_159 [ 1 ] = F_106 ( V_166 ) ;
V_9 = F_107 ( V_159 , sizeof( T_1 ) , 2 , V_158 ) ;
if ( V_9 )
...
V_215 [ V_175 ] = V_127 -> V_133 . V_228 . V_223 [ V_175 ] ;
for ( V_175 = 0 ; V_175 < 4 ; V_175 ++ )
V_215 [ V_175 + 4 ] = V_127 -> V_133 . V_228 . V_224 [ V_175 ] ;
V_9 = F_107 ( V_215 , sizeof( T_1 ) , 8 , V_158 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_115 ( V_7 , & V_127 -> V_128 [ 0 ] , V_158 ) ;
if ( V_9 )
...
if ( V_9 )
return V_9 ;
V_159 [ 0 ] = F_106 ( V_127 -> V_39 . V_214 ) ;
V_9 = F_107 ( V_159 , sizeof( T_1 ) , 1 , V_158 ) ;
if ( V_9 )
return V_9 ;
V_9 = F_115 ( V_7 , & V_127 -> V_128 [ 0 ] , V_158 ) ;
...
static int F_125 ( void * V_8 , void * V_254 , void * V_250 )
{
int * V_255 = V_250 ;
* V_255 = * V_255 + 1 ;
return 0 ;
}
static int F_126 ( void * V_8 , void * V_254 , void * V_250 )
{
T_2 V_159 [ 2 ] ;
struct V_40 * V_125 = V_8 ;
struct V_124 * V_157 = V_254 ;
struct V_251 * V_252 = V_250 ;
void * V_158 = V_252 -> V_158 ;
struct V_6 * V_7 = V_252 -> V_7 ;
int V_9 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_40 ( V_7 -> V_50 , F_126 , & V_252 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static int F_128 ( void * V_8 , void * V_254 , void * V_250 )
{
T_2 V_159 [ 4 ] ;
struct V_25 * V_26 = V_8 ;
struct V_206 * V_207 = V_254 ;
void * V_158 = V_250 ;
int V_9 ;
T_1 V_166 ;
...
V_159 [ 1 ] = F_106 ( V_257 ) ;
V_159 [ 2 ] = F_106 ( V_4 -> V_241 ) ;
V_159 [ 3 ] = F_106 ( V_4 -> V_216 ) ;
V_9 = F_107 ( V_159 , sizeof( T_1 ) , 4 , V_158 ) ;
if ( V_9 )
return V_9 ;
if ( V_7 -> V_162 >= V_239 ) {
...
if ( V_9 )
return V_9 ;
V_9 = F_40 ( V_7 -> V_47 [ V_3 ] . V_21 , V_258 [ V_3 ] , & V_252 ) ;
if ( V_9 )
return V_9 ;
}
