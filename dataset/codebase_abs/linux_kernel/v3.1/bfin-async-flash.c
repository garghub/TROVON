...
V_24 = F_28 ( V_2 -> V_49 , V_51 , & V_26 -> V_52 , 0 ) ;
if ( V_24 > 0 ) {
F_23 (KERN_NOTICE DRIVER_NAME L_3 ) ;
F_29 ( V_2 -> V_49 , V_26 -> V_52 , V_24 ) ;
V_2 -> V_52 = V_26 -> V_52 ;
} else if ( V_26 -> V_53 ) {
F_23 (KERN_NOTICE DRIVER_NAME L_4 ) ;
F_29 ( V_2 -> V_49 , V_26 -> V_52 , V_26 -> V_53 ) ;
} else {
F_23 (KERN_NOTICE DRIVER_NAME L_5 ) ;
F_29 ( V_2 -> V_49 , NULL , 0 ) ;
}
F_30 ( V_23 , V_2 ) ;
return 0 ;
}
static int T_5 F_31 ( struct V_22 * V_23 )
{
