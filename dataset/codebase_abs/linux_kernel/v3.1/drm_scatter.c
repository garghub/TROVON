...
V_8 -> V_11 = V_11 ;
V_8 -> V_12 = F_13 ( V_11 , sizeof( * V_8 -> V_12 ) , V_4 ) ;
if ( ! V_8 -> V_12 ) {
F_8 ( V_8 ) ;
return - V_23 ;
}
V_8 -> V_14 = F_13 ( V_11 , sizeof( * V_8 -> V_14 ) , V_4 ) ;
if ( ! V_8 -> V_14 ) {
F_8 ( V_8 -> V_12 ) ;
F_8 ( V_8 ) ;
return - V_23 ;
...
V_8 -> V_26 = F_14 ( ( unsigned long ) V_8 -> V_13 ) ;
F_10 ( L_3 , V_8 -> V_26 ) ;
F_10 ( L_4 , V_8 -> V_13 ) ;
for ( V_10 = ( unsigned long ) V_8 -> V_13 , V_19 = 0 ; V_19 < V_11 ;
V_10 += V_24 , V_19 ++ ) {
V_8 -> V_12 [ V_19 ] = F_15 ( ( void * ) V_10 ) ;
if ( ! V_8 -> V_12 [ V_19 ] )
goto V_27;
F_16 ( V_8 -> V_12 [ V_19 ] ) ;
}
...
int F_20 ( struct V_15 * V_16 , void * V_31 ,
struct V_32 * V_33 )
{
struct V_17 * V_18 = V_31 ;
struct V_7 * V_8 ;
