...
struct V_9 * V_10 , T_2 V_42 )
{
unsigned long V_5 = ( unsigned long ) F_2 ( V_2 ) ;
if ( ! ( V_2 -> V_43 & V_44 ) || ! V_34 -> V_45 ||
! V_10 -> type )
return 0 ;
if ( V_5 & V_37 && V_10 -> V_15 == ( V_36 | 0xff05 ) ) {
struct V_13 * V_14 = V_34 -> V_45 -> V_14 ;
static unsigned int V_46 = 0 ;
unsigned int V_47 = 0 ;
switch ( V_42 ) {
case 0x01 : V_47 = V_22 ; break;
case 0x02 : V_47 = V_24 ; break;
case 0x04 : V_47 = V_25 ; break;
case 0x08 : V_47 = V_26 ; break;
case 0x10 : V_47 = V_27 ; break;
}
if ( V_47 ) {
F_12 ( V_14 , V_10 -> type , V_47 , 1 ) ;
V_46 = V_47 ;
} else
F_12 ( V_14 , V_10 -> type , V_46 , 0 ) ;
return 1 ;
}
return 0 ;
}
static int F_13 ( struct V_1 * V_2 , const struct V_48 * V_49 )
{
unsigned long V_5 = V_49 -> V_50 ;
int V_38 ;
F_14 ( V_2 , ( void * ) V_5 ) ;
if ( V_5 & V_51 )
V_2 -> V_5 |= V_52 ;
