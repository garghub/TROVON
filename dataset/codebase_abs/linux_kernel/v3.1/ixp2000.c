...
V_30 = F_17 ( V_18 -> V_33 ) ;
F_18 ( & V_18 -> V_18 , L_3 ,
V_29 -> V_34 , ( ( V_35 ) V_30 >> 20 ) ) ;
if ( V_20 -> V_36 != 1 ) {
F_19 ( & V_18 -> V_18 , L_4 ,
V_20 -> V_36 * 8 ) ;
return - V_37 ;
}
V_23 = F_20 ( sizeof( struct V_22 ) , V_38 ) ;
if( ! V_23 ) {
V_31 = - V_39 ;
goto Error;
}
F_10 ( V_18 , V_23 ) ;
V_23 -> V_2 . V_40 = V_41 ;
V_23 -> V_2 . V_42 = V_29 -> V_34 * V_30 ;
V_23 -> V_2 . V_43 = 1 ;
V_23 -> V_2 . V_4 = ( unsigned long ) V_29 -> V_44 ;
V_23 -> V_2 . V_45 = F_21 ( & V_18 -> V_18 ) ;
V_23 -> V_2 . V_46 = F_4 ;
V_23 -> V_2 . V_47 = F_6 ;
V_23 -> V_2 . V_48 = F_5 ;
V_23 -> V_2 . V_49 = F_7 ;
V_23 -> V_26 = F_22 ( V_18 -> V_33 -> V_50 ,
F_17 ( V_18 -> V_33 ) ,
F_21 ( & V_18 -> V_18 ) ) ;
if ( ! V_23 -> V_26 ) {
F_19 ( & V_18 -> V_18 , L_5 ) ;
...
V_23 -> V_2 . V_10 =
( unsigned long ) F_23 ( V_18 -> V_33 -> V_50 ,
F_17 ( V_18 -> V_33 ) ) ;
if ( ! V_23 -> V_2 . V_10 ) {
F_19 ( & V_18 -> V_18 , L_6 ) ;
V_31 = - V_37 ;
...
V_6 ? L_8 : L_9 ) ;
#endif
V_23 -> V_24 = F_26 ( V_20 -> V_52 , & V_23 -> V_2 ) ;
if ( ! V_23 -> V_24 ) {
F_19 ( & V_18 -> V_18 , L_10 ) ;
V_31 = - V_53 ;
goto Error;
...
V_23 -> V_24 -> V_54 = V_55 ;
V_31 = F_27 ( V_23 -> V_24 , V_27 , & V_23 -> V_25 , 0 ) ;
if ( V_31 > 0 ) {
V_31 = F_28 ( V_23 -> V_24 , V_23 -> V_25 , V_31 ) ;
if( V_31 )
F_19 ( & V_18 -> V_18 , L_11 ) ;
}
if ( V_31 )
