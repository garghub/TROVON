...
V_100 . V_98 =
V_93 . V_98 ;
V_3 -> V_101 = F_32 ( V_102 ) ;
}
F_5 ( V_15 , L_13 ,
V_12 -> V_18 ,
F_33 ( V_78 -> V_15 -> V_41 ) ? L_14 : L_15 ,
V_12 -> V_4 . V_56 -> V_103 , V_12 -> V_4 . V_58 -> V_103 ,
V_12 -> V_53 -> V_103 ) ;
return 0 ;
V_79:
if ( V_12 -> V_62 )
F_34 ( V_12 -> V_53 , V_12 -> V_62 ) ;
if ( V_12 -> V_53 )
V_12 -> V_53 -> V_13 = NULL ;
if ( V_12 -> V_4 . V_58 )
...
ERROR ( V_15 , L_16 , V_3 -> V_103 , V_3 , V_17 ) ;
return V_17 ;
}
static void
F_35 ( struct V_77 * V_78 , struct V_2 * V_3 )
{
struct V_1 * V_12 = F_1 ( V_3 ) ;
if ( F_33 ( V_78 -> V_15 -> V_41 ) )
F_36 ( V_3 -> V_101 ) ;
...
static inline bool F_38 ( struct V_77 * V_78 )
{
return true ;
}
int F_39 ( struct V_77 * V_78 , T_2 V_18 )
{
struct V_1 * V_12 ;
int V_17 ;
if ( ! F_38 ( V_78 ) )
return - V_54 ;
if ( V_104 [ V_105 ] . V_106 == 0 ) {
V_17 = F_40 ( V_78 -> V_15 ) ;
if ( V_17 < 0 )
return V_17 ;
V_104 [ V_105 ] . V_106 = V_17 ;
V_82 . V_107 = V_17 ;
V_17 = F_40 ( V_78 -> V_15 ) ;
if ( V_17 < 0 )
return V_17 ;
V_104 [ V_108 ] . V_106 = V_17 ;
V_86 . V_107 = V_17 ;
V_17 = F_40 ( V_78 -> V_15 ) ;
if ( V_17 < 0 )
return V_17 ;
V_104 [ V_109 ] . V_106 = V_17 ;
V_80 . V_110 = V_17 ;
}
V_12 = F_41 ( sizeof *V_12 , V_94 ) ;
if ( ! V_12 )
return - V_111 ;
F_42 ( & V_12 -> V_66 ) ;
V_12 -> V_18 = V_18 ;
...
V_12 -> V_4 . V_113 = F_26 ;
V_12 -> V_4 . V_114 = F_27 ;
V_12 -> V_4 . V_5 . V_103 = L_17 ;
V_12 -> V_4 . V_5 . V_115 = V_116 ;
V_12 -> V_4 . V_5 . V_117 = F_28 ;
V_12 -> V_4 . V_5 . V_118 = F_35 ;
V_12 -> V_4 . V_5 . V_119 = F_12 ;
V_12 -> V_4 . V_5 . V_120 = F_7 ;
V_12 -> V_4 . V_5 . V_121 = F_18 ;
V_17 = F_43 ( V_78 , & V_12 -> V_4 . V_5 ) ;
if ( V_17 )
F_37 ( V_12 ) ;
return V_17 ;
}
