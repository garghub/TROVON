...
{
struct V_155 * V_156 = V_21 -> V_22 -> V_157 [ 1 ] ;
struct V_119 * V_120 = & V_156 -> V_109 ;
if ( V_156 -> V_158 && V_120 -> V_126 == 0 ) {
V_120 -> V_126 = F_34 ( 0x40 ) ;
F_32 ( & V_21 -> V_22 -> V_22 ,
L_33 ) ;
}
...
static void F_60 ( struct V_147 * V_159 )
{
struct V_10 * V_11 = F_61 ( V_159 , struct V_10 , V_147 ) ;
F_22 ( V_11 ) ;
}
...
F_9 ( L_14 , V_16 ) ;
F_42 ( V_7 ) ;
F_63 ( & V_11 -> V_147 , F_60 ) ;
return 0 ;
}
static int F_64 ( struct V_28 * V_29 , struct V_6 * V_7 )
{
...
if ( V_29 )
F_65 ( V_29 , V_7 , V_29 -> V_163 ) ;
V_101 = F_66 ( V_29 , V_7 ) ;
if ( ! V_101 )
F_67 ( & V_11 -> V_147 ) ;
return V_101 ;
}
static void F_68 ( struct V_6 * V_7 , int V_164 )
{
struct V_10 * V_11 = F_8 ( V_7 ) ;
F_27 ( & V_7 -> V_21 -> V_165 ) ;
if ( ! V_7 -> V_21 -> V_166 ) {
if ( ! V_164 && F_10 ( V_7 -> V_21 -> V_22 ,
F_11 ( V_7 -> V_21 -> V_22 , 0 ) ,
V_167 ,
V_168 ,
0 , V_11 -> V_25 , NULL , 0 ,
...
V_11 = F_8 ( V_7 ) ;
if ( V_11 -> V_37 == V_38 ) {
unsigned char * V_171 = V_169 ;
int V_124 , V_172 , V_173 ;
V_132 = 0 ;
F_74 ( & V_7 -> V_174 , V_32 ) ;
for ( V_124 = 0 ; V_124 < V_170 - 1 ; V_124 += V_11 -> V_127 ) {
V_172 = F_75 ( int , V_170 - V_124 , V_11 -> V_127 ) - 1 ;
V_173 = F_76 ( & V_7 -> V_175 , & V_171 [ V_124 + 1 ] , V_172 ) ;
if ( ! V_173 )
break;
V_171 [ V_124 ] = ( V_173 << 2 ) + 1 ;
V_132 += V_173 + 1 ;
}
F_77 ( & V_7 -> V_174 , V_32 ) ;
} else {
V_132 = F_78 ( & V_7 -> V_175 , V_169 , V_170 ,
& V_7 -> V_174 ) ;
}
return V_132 ;
}
...
char * V_176 , int V_172 )
{
int V_124 ;
char V_177 ;
char V_178 ;
char * V_179 ;
F_9 ( L_35 , V_16 , V_7 -> V_180 ) ;
if ( V_172 < 2 ) {
F_9 ( L_36 ) ;
return 0 ;
}
...
V_178 = V_187 ;
F_81 ( V_7 ) ;
} else if ( V_176 [ 1 ] & V_188 ) {
V_178 = V_189 ;
} else if ( V_176 [ 1 ] & V_190 ) {
V_178 = V_191 ;
}
if ( V_176 [ 1 ] & V_192 )
F_82 ( V_29 , 0 , V_193 ) ;
...
return 0 ;
V_179 = V_176 + 2 ;
if ( V_7 -> V_7 . V_195 && V_7 -> V_196 ) {
for ( V_124 = 0 ; V_124 < V_172 ; V_124 ++ , V_179 ++ ) {
if ( ! F_83 ( V_7 , * V_179 ) )
F_82 ( V_29 , * V_179 , V_178 ) ;
}
} else {
F_84 ( V_29 , V_179 , V_178 , V_172 ) ;
}
return V_172 ;
}
static void F_85 ( struct V_197 * V_197 )
{
struct V_6 * V_7 = V_197 -> V_198 ;
struct V_28 * V_29 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
char * V_199 = ( char * ) V_197 -> V_200 ;
int V_124 ;
int V_172 ;
int V_132 = 0 ;
V_29 = F_86 ( & V_7 -> V_7 ) ;
if ( ! V_29 )
return;
for ( V_124 = 0 ; V_124 < V_197 -> V_201 ; V_124 += V_11 -> V_127 ) {
V_172 = F_75 ( int , V_197 -> V_201 - V_124 , V_11 -> V_127 ) ;
V_132 += F_79 ( V_29 , V_7 , V_11 , & V_199 [ V_124 ] , V_172 ) ;
}
if ( V_132 )
F_87 ( V_29 ) ;
F_88 ( V_29 ) ;
}
static void F_89 ( struct V_28 * V_29 , int V_202 )
{
struct V_6 * V_7 = V_29 -> V_203 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
T_2 V_12 ;
if ( V_202 )
V_12 = V_11 -> V_204 | V_205 ;
else
V_12 = V_11 -> V_204 ;
...
struct V_6 * V_7 , struct V_208 * V_209 )
{
struct V_70 * V_22 = V_7 -> V_21 -> V_22 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_208 * V_163 = V_29 -> V_163 ;
unsigned int V_210 = V_163 -> V_211 ;
T_2 V_12 ;
unsigned int V_212 = V_163 -> V_213 ;
unsigned char V_214 ;
unsigned char V_215 ;
F_9 ( L_14 , V_16 ) ;
if ( V_11 -> V_150 && ( ( V_163 -> V_211 & V_216 ) != V_217 ) ) {
F_9 ( L_40 , V_16 ) ;
...
if ( V_210 & V_230 ) {
switch ( V_210 & V_230 ) {
case V_231 : V_12 |= 7 ; F_9 ( L_42 ) ; break;
case V_232 : V_12 |= 8 ; F_9 ( L_43 ) ; break;
default:
F_18 ( & V_7 -> V_22 , L_44 ) ;
}
}
...
V_16 ) ;
F_29 ( & V_11 -> V_89 ) ;
if ( ! V_209 || ( V_209 -> V_211 & V_216 ) == V_217 )
F_69 ( V_7 , V_14 | V_15 ) ;
}
if ( V_210 & V_218 ) {
F_9 ( L_49 , V_16 ) ;
...
F_9 ( L_51 ,
V_16 , V_212 ) ;
V_215 = V_163 -> V_235 [ V_236 ] ;
V_214 = V_163 -> V_235 [ V_237 ] ;
V_12 = ( V_214 << 8 ) | ( V_215 ) ;
if ( F_10 ( V_22 ,
F_11 ( V_22 , 0 ) ,
V_167 ,
...
if ( V_146 < 0 )
goto V_239;
V_146 = ( V_77 [ 0 ] & V_242 ? V_243 : 0 ) |
( V_77 [ 0 ] & V_244 ? V_245 : 0 ) |
( V_77 [ 0 ] & V_246 ? V_247 : 0 ) |
( V_77 [ 0 ] & V_248 ? V_249 : 0 ) |
V_11 -> V_27 ;
V_239:
F_22 ( V_77 ) ;
return V_146 ;
...
char V_257 = V_11 -> V_183 ;
if ( V_257 == 0 )
return - V_134 ;
V_11 -> V_183 = 0 ;
if ( ( ( V_251 & V_258 ) && ( V_257 & V_259 ) ) ||
( ( V_251 & V_243 ) && ( V_257 & V_260 ) ) ||
( ( V_251 & V_249 ) && ( V_257 & V_261 ) ) ||
( ( V_251 & V_245 ) && ( V_257 & V_262 ) ) ) {
return 0 ;
}
}
}
return 0 ;
case V_263 :
return F_30 ( V_7 , (struct V_82 T_3 * ) V_251 ) ;
break;
default:
break;
}
...
if ( V_265 > 0 && V_266 > 0 ) {
int V_124 ;
for ( V_124 = 0 ; V_267 [ V_124 ] . V_268 ; V_124 ++ )
;
V_267 [ V_124 ] . V_269 = V_270 ;
V_267 [ V_124 ] . V_268 = V_265 ;
V_267 [ V_124 ] . V_55 = V_266 ;
}
V_137 = F_96 ( & V_271 ) ;
if ( V_137 )
goto V_272;
...
if ( V_137 )
goto V_274;
F_98 (KERN_INFO KBUILD_MODNAME L_60 DRIVER_VERSION L_61
DRIVER_DESC L_62 ) ;
return 0 ;
V_274:
F_99 ( & V_271 ) ;
