...
void F_19 ( struct V_2 * V_3 , T_3 V_17 , void * V_20 ,
T_1 V_18 )
{
F_20 ( V_3 , V_18 , V_17 , V_21 ) ;
F_21 ( ( unsigned long ) V_20 , F_13 ( V_17 ) ) ;
}
static void F_22 ( struct V_2 * V_3 , T_3 V_17 , void * V_20 ,
T_1 V_18 )
{
unsigned long V_22 = ( unsigned long ) V_20 ;
int V_23 = F_13 ( V_17 ) ;
if ( F_23 ( V_3 , V_23 , V_20 ) )
return;
F_20 ( V_3 , V_18 , V_17 , V_21 ) ;
if ( ! F_5 ( V_3 ) )
V_22 = F_24 ( V_22 ) ;
...
static inline void F_25 ( void * V_22 , T_3 V_17 ,
enum V_24 V_25 )
{
switch ( V_25 ) {
case V_26 :
F_26 ( ( unsigned long ) V_22 , V_17 ) ;
break;
case V_27 :
F_27 ( ( unsigned long ) V_22 , V_17 ) ;
break;
case V_21 :
F_17 ( ( unsigned long ) V_22 , V_17 ) ;
break;
default:
F_28 () ;
}
...
unsigned long V_28 , T_3 V_17 , enum V_24 V_25 )
{
T_3 V_29 = V_17 ;
do {
T_3 V_30 = V_29 ;
...
T_3 V_17 , enum V_24 V_25 , struct V_33 * V_34 )
{
if ( F_4 ( V_3 ) )
F_29 ( F_1 ( V_3 , V_4 ) ,
V_4 & ~ V_32 , V_17 , V_25 ) ;
F_20 ( V_3 , V_4 , V_17 , V_25 ) ;
}
static int F_35 ( struct V_2 * V_3 , struct V_35 * V_36 ,
int V_37 , enum V_24 V_25 , struct V_33 * V_34 )
{
int V_38 ;
for ( V_38 = 0 ; V_38 < V_37 ; V_38 ++ , V_36 ++ ) {
if ( ! F_5 ( V_3 ) )
F_29 ( F_36 ( V_36 ) , V_36 -> V_28 , V_36 -> V_39 ,
V_25 ) ;
...
{
if ( ! F_5 ( V_3 ) )
F_29 ( V_1 , V_28 , V_17 , V_25 ) ;
return F_37 ( V_3 , V_1 ) + V_28 ;
}
static void F_39 ( struct V_2 * V_3 , struct V_35 * V_36 ,
int V_41 , enum V_24 V_25 ,
struct V_33 * V_34 )
{
int V_38 ;
...
F_29 ( F_36 ( V_36 ) , V_36 -> V_28 , V_36 -> V_39 ,
V_25 ) ;
F_20 ( V_3 , V_36 -> V_40 , V_36 -> V_39 , V_25 ) ;
}
}
static void F_40 ( struct V_2 * V_3 ,
T_1 V_18 , T_3 V_17 , enum V_24 V_25 )
{
if ( F_4 ( V_3 ) )
F_29 ( F_1 ( V_3 , V_18 ) ,
V_18 & ~ V_32 , V_17 , V_25 ) ;
...
struct V_35 * V_36 , int V_42 , enum V_24 V_25 )
{
int V_38 ;
...
void F_49 ( struct V_2 * V_3 , void * V_20 , T_3 V_17 ,
enum V_24 V_25 )
{
F_50 ( V_25 == V_44 ) ;
F_42 ( V_3 ) ;
