...
{
struct V_6 * V_41 ;
struct V_42 * V_42 = F_29 ( V_7 ) ;
struct V_43 * V_44 = F_30 ( V_42 , V_45 ) ;
char V_32 [ V_46 ] ;
int V_38 ;
if ( V_10 >= V_47 )
return - V_48 ;
...
V_41 = F_31 ( sizeof( struct V_20 ) , V_32 , V_54 ) ;
if ( V_41 == NULL )
return - V_14 ;
F_32 ( V_41 , V_42 ) ;
V_41 -> V_55 = V_7 -> V_55 ;
...
if ( ! F_35 ( V_21 -> V_62 , V_17 -> V_63 ) )
return;
if ( F_35 ( V_61 -> V_63 , V_21 -> V_62 ) &&
! F_35 ( V_61 -> V_63 , V_17 -> V_63 ) )
F_36 ( V_17 , V_61 -> V_63 ) ;
if ( ! F_35 ( V_61 -> V_63 , V_21 -> V_62 ) &&
F_35 ( V_61 -> V_63 , V_17 -> V_63 ) )
F_37 ( V_17 , V_61 -> V_63 ) ;
...
static void F_41 ( struct V_6 * V_17 , unsigned long V_72 )
{
switch ( V_72 ) {
case V_73 :
F_42 ( V_17 ) ;
...
static int F_45 ( struct V_76 * V_77 , unsigned long V_72 ,
void * V_78 )
{
...
static int F_53 ( struct V_42 * V_42 , void T_2 * V_98 )
{
int V_38 ;
struct V_99 args ;
struct V_6 * V_17 = NULL ;
if ( F_54 ( & args , V_98 , sizeof( struct V_99 ) ) )
return - V_100 ;
args . V_101 [ 23 ] = 0 ;
...
case V_111 :
V_38 = - V_112 ;
V_17 = F_56 ( V_42 , args . V_101 ) ;
if ( ! V_17 )
goto V_82;
V_38 = - V_113 ;
if ( args . V_104 != V_108 && ! F_47 ( V_17 ) )
goto V_82;
}
switch ( args . V_104 ) {
case V_105 :
...
if ( ! F_57 ( V_115 ) )
break;
V_38 = F_28 ( V_17 , args . V_102 . V_121 ) ;
break;
case V_109 :
V_38 = - V_114 ;
if ( ! F_57 ( V_115 ) )
...
static int T_3 F_65 ( struct V_42 * V_42 )
{
struct V_43 * V_44 = F_30 ( V_42 , V_45 ) ;
int V_38 ;
V_44 -> V_49 = V_52 ;
...
static void T_4 F_67 ( struct V_42 * V_42 )
{
F_68 ( V_42 ) ;
}
