...
V_177 -> V_178 ) ;
if ( V_177 -> V_179 == V_148 -> V_152 -> V_28 ) {
V_148 -> V_180 = V_177 ;
return true ;
} else {
return false ;
...
V_4 -> line , V_39 -> V_14 -> V_179 ) ;
if ( ! V_39 -> V_14 -> V_179 )
return;
F_121 ( V_181 ) ;
F_122 ( V_183 , V_181 ) ;
V_177 = & V_39 -> V_184 ;
V_177 -> V_178 = V_39 -> V_14 -> V_185 ;
V_177 -> V_179 = V_39 -> V_14 -> V_179 ;
V_39 -> V_136 = - V_27 ;
V_148 = F_123 ( V_181 , F_117 , V_177 ) ;
...
V_182 = F_127 ( V_4 -> V_28 , & V_39 -> V_134 , 1 , V_172 ) ;
if ( ! V_182 )
F_100 ( V_39 , false ) ;
else
...
V_189 [ 1 ] = V_189 [ 0 ] + V_39 -> V_144 ;
for ( V_68 = 0 ; V_68 < 2 ; V_68 ++ ) {
struct V_149 * V_150 = & V_39 -> V_143 [ V_68 ] ;
F_124 ( V_150 , 1 ) ;
F_125 ( V_150 , F_126 ( V_60 [ V_68 ] ) , V_39 -> V_144 ,
( int ) V_60 [ V_68 ] & ~ V_186 ) ;
F_97 ( V_150 ) = V_189 [ V_68 ] ;
}
...
static unsigned int F_135 ( unsigned int V_190 , unsigned int V_191 ,
unsigned long V_192 )
{
switch ( V_190 ) {
case V_193 :
return ( ( V_192 + 16 * V_191 ) / ( 16 * V_191 ) - 1 ) ;
case V_194 :
return ( ( V_192 + 16 * V_191 ) / ( 32 * V_191 ) - 1 ) ;
case V_195 :
return ( ( ( V_192 * 2 ) + 16 * V_191 ) / ( 16 * V_191 ) - 1 ) ;
case V_196 :
return ( ( ( V_192 * 2 ) + 16 * V_191 ) / ( 32 * V_191 ) - 1 ) ;
case V_197 :
return ( ( ( V_192 * 1000 / 32 ) / V_191 ) - 1 ) ;
}
F_136 ( 1 ) ;
return ( ( V_192 + 16 * V_191 ) / ( 32 * V_191 ) - 1 ) ;
}
...
F_23 ( V_4 , V_57 , 0x00 ) ;
if ( V_4 -> type != V_15 )
F_23 ( V_4 , V_198 , V_199 | V_200 ) ;
}
static void F_138 ( struct V_2 * V_4 , struct V_201 * V_202 ,
struct V_201 * V_203 )
{
struct V_1 * V_39 = F_1 ( V_4 ) ;
unsigned int V_204 , V_205 , V_206 ;
int V_207 = - 1 ;
T_2 V_208 = 0 ;
V_206 = V_4 -> V_30 ? V_4 -> V_30 / 16 : 115200 ;
V_204 = F_139 ( V_4 , V_202 , V_203 , 0 , V_206 ) ;
if ( F_140 ( V_204 && V_4 -> V_30 ) )
V_207 = F_135 ( V_39 -> V_14 -> V_209 , V_204 , V_4 -> V_30 ) ;
F_13 ( V_39 ) ;
F_137 ( V_4 ) ;
V_205 = F_21 ( V_4 , V_210 ) & 3 ;
if ( ( V_202 -> V_211 & V_212 ) == V_213 )
V_205 |= 0x40 ;
if ( V_202 -> V_211 & V_214 )
V_205 |= 0x20 ;
if ( V_202 -> V_211 & V_215 )
V_205 |= 0x30 ;
if ( V_202 -> V_211 & V_216 )
V_205 |= 0x08 ;
F_141 ( V_4 , V_202 -> V_211 , V_204 ) ;
F_23 ( V_4 , V_210 , V_205 ) ;
F_49 ( V_4 -> V_28 , L_32 , V_133 , V_205 , V_207 ,
V_39 -> V_14 -> V_97 ) ;
if ( V_207 > 0 ) {
if ( V_207 >= 256 ) {
F_23 ( V_4 , V_210 , ( F_21 ( V_4 , V_210 ) & ~ 3 ) | 1 ) ;
V_207 >>= 2 ;
} else
F_23 ( V_4 , V_210 , F_21 ( V_4 , V_210 ) & ~ 3 ) ;
F_23 ( V_4 , V_217 , V_207 ) ;
F_142 ( ( 1000000 + ( V_204 - 1 ) ) / V_204 ) ;
}
F_31 ( V_4 , V_202 -> V_211 ) ;
F_23 ( V_4 , V_198 , V_208 | ( ( V_202 -> V_211 & V_44 ) ? V_218 : 0 ) ) ;
F_23 ( V_4 , V_57 , V_39 -> V_14 -> V_97 ) ;
#ifdef F_63
if ( V_39 -> V_88 ) {
V_39 -> V_92 = ( V_4 -> V_219 - V_220 / 50 ) * V_39 -> V_144 * 3 /
V_4 -> V_48 / 2 ;
F_49 ( V_4 -> V_28 ,
L_33 ,
V_39 -> V_92 * 1000 / V_220 , V_4 -> V_219 ) ;
if ( V_39 -> V_92 < F_143 ( 20 ) )
V_39 -> V_92 = F_143 ( 20 ) ;
}
#endif
if ( ( V_202 -> V_211 & V_221 ) != 0 )
F_99 ( V_4 ) ;
F_17 ( V_39 ) ;
}
...
return 0 ;
if ( V_4 -> V_95 & V_222 ) {
V_4 -> V_10 = F_147 ( V_4 -> V_223 , V_9 ) ;
if ( F_80 ( ! V_4 -> V_10 ) ) {
F_78 ( V_4 -> V_28 , L_39 , V_4 -> line ) ;
return - V_224 ;
}
} else {
V_4 -> V_10 = ( void V_225 * ) V_4 -> V_223 ;
}
return 0 ;
}
...
struct V_226 * V_227 ;
int V_102 ;
V_227 = F_152 ( V_4 -> V_223 , V_9 , F_77 ( V_4 -> V_28 ) ) ;
if ( F_80 ( V_227 == NULL ) )
return - V_228 ;
V_102 = F_146 ( V_4 ) ;
if ( F_80 ( V_102 != 0 ) ) {
...
{
if ( V_95 & V_229 ) {
struct V_1 * V_230 = F_1 ( V_4 ) ;
V_4 -> type = V_230 -> V_14 -> type ;
F_151 ( V_4 ) ;
}
}
static int F_155 ( struct V_2 * V_4 , struct V_231 * V_232 )
{
struct V_1 * V_39 = F_1 ( V_4 ) ;
if ( V_232 -> V_86 != V_39 -> V_14 -> V_118 [ V_233 ] || V_232 -> V_86 > V_234 )
return - V_27 ;
if ( V_232 -> V_235 < 2400 )
return - V_27 ;
return 0 ;
}
static int T_6 F_156 ( struct V_236 * V_28 ,
struct V_1 * V_1 ,
unsigned int V_237 ,
struct V_13 * V_5 )
{
...
F_162 ( & V_1 -> V_77 ) ;
if ( ! V_5 -> V_243 )
V_5 -> V_243 = ( V_5 -> type == V_15 ) ?
V_244 : V_245 ;
if ( V_5 -> V_81 != V_82 ) {
if ( V_5 -> type == V_15 )
V_5 -> V_81 = 5 ;
else if ( V_5 -> V_209 == V_196 )
V_5 -> V_81 = 9 ;
else
V_5 -> V_81 = 0 ;
V_5 -> V_243 |= ( 1 << V_5 -> V_81 ) ;
}
V_1 -> V_14 = V_5 ;
V_4 -> V_223 = V_5 -> V_223 ;
V_4 -> type = V_5 -> type ;
V_4 -> V_95 = V_5 -> V_95 ;
V_4 -> V_11 = V_5 -> V_11 ;
V_4 -> V_86 = V_5 -> V_118 [ V_246 ] ;
V_4 -> V_123 = V_247 ;
V_4 -> V_248 = F_3 ;
V_4 -> V_249 = F_8 ;
if ( V_5 -> V_179 )
F_49 ( V_4 -> V_28 , L_44 ,
V_5 -> V_179 , V_5 -> V_185 , V_5 -> V_188 ) ;
return 0 ;
}
static void F_163 ( struct V_2 * V_4 , int V_250 )
{
F_27 ( V_4 , V_250 ) ;
}
static void F_164 ( struct V_251 * V_252 , const char * V_39 ,
unsigned V_56 )
{
struct V_1 * V_1 = & V_253 [ V_252 -> V_237 ] ;
struct V_2 * V_4 = & V_1 -> V_4 ;
unsigned short V_254 ;
F_13 ( V_1 ) ;
F_165 ( V_4 , V_39 , V_56 , F_163 ) ;
V_254 = F_28 ( V_4 ) | F_30 ( V_4 ) ;
while ( ( F_21 ( V_4 , V_34 ) & V_254 ) != V_254 )
F_166 () ;
F_17 ( V_1 ) ;
}
static int T_6 F_167 ( struct V_251 * V_252 , char * V_255 )
{
struct V_1 * V_1 ;
struct V_2 * V_4 ;
int V_204 = 115200 ;
...
int V_257 = 'n' ;
int V_102 ;
if ( V_252 -> V_237 < 0 || V_252 -> V_237 >= V_258 )
return - V_259 ;
V_1 = & V_253 [ V_252 -> V_237 ] ;
V_4 = & V_1 -> V_4 ;
if ( ! V_4 -> V_42 )
return - V_259 ;
V_102 = F_146 ( V_4 ) ;
...
F_13 ( V_1 ) ;
if ( V_255 )
F_168 ( V_255 , & V_204 , & V_256 , & V_254 , & V_257 ) ;
F_17 ( V_1 ) ;
return F_169 ( V_4 , V_252 , V_204 , V_256 , V_254 , V_257 ) ;
}
static int T_6 F_170 ( struct V_236 * V_260 )
{
struct V_13 * V_14 = V_260 -> V_28 . V_261 ;
if ( V_262 . V_80 )
return - V_263 ;
V_262 . V_237 = V_260 -> V_264 ;
F_156 ( NULL , & V_253 [ V_260 -> V_264 ] , V_260 -> V_264 , V_14 ) ;
F_167 ( & V_262 , V_265 ) ;
if ( ! strstr ( V_265 , L_45 ) )
V_262 . V_95 |= V_266 ;
F_171 ( & V_262 ) ;
return 0 ;
}
...
struct V_2 * V_4 = & V_1 -> V_4 ;
if ( F_174 ( V_4 ) ) {
V_1 -> V_267 = F_21 ( V_4 , V_210 ) ;
V_1 -> V_268 = F_21 ( V_4 , V_217 ) ;
V_1 -> V_269 = F_21 ( V_4 , V_198 ) ;
}
return 0 ;
}
...
if ( F_174 ( V_4 ) ) {
F_137 ( V_4 ) ;
F_23 ( V_4 , V_210 , V_1 -> V_267 ) ;
F_23 ( V_4 , V_217 , V_1 -> V_268 ) ;
F_23 ( V_4 , V_198 , V_1 -> V_269 ) ;
F_23 ( V_4 , V_57 , V_1 -> V_14 -> V_97 ) ;
}
return 0 ;
}
static inline int T_6 F_170 ( struct V_236 * V_260 )
{
return - V_27 ;
}
static int F_176 ( struct V_236 * V_28 )
{
...
static int T_6 F_182 ( struct V_236 * V_28 ,
unsigned int V_237 ,
struct V_13 * V_5 ,
struct V_1 * V_272 )
{
...
V_102 = F_156 ( V_28 , V_272 , V_237 , V_5 ) ;
if ( V_102 )
return V_102 ;
return F_183 ( & V_271 , & V_272 -> V_4 ) ;
}
static int T_6 F_184 ( struct V_236 * V_28 )
{
struct V_13 * V_5 = V_28 -> V_28 . V_261 ;
struct V_1 * V_273 = & V_253 [ V_28 -> V_264 ] ;
int V_102 ;
if ( F_185 ( V_28 ) )
return F_170 ( V_28 ) ;
F_186 ( V_28 , V_273 ) ;
V_102 = F_182 ( V_28 , V_28 -> V_264 , V_5 , V_273 ) ;
if ( V_102 )
goto V_274;
V_273 -> V_108 . V_275 = F_73 ;
V_102 = F_187 ( & V_273 -> V_108 ,
V_270 ) ;
if ( F_80 ( V_102 < 0 ) )
goto V_274;
#ifdef F_188
...
{
struct V_1 * V_230 = F_173 ( V_28 ) ;
if ( V_230 )
F_191 ( & V_271 , & V_230 -> V_4 ) ;
return 0 ;
}
