...
enum V_138 V_139 , enum V_140 V_69 )
{
T_1 V_11 ;
struct V_6 * V_7 = F_36 ( V_64 ) ;
V_11 = V_141 | V_18 | V_72 ;
V_11 |= V_7 -> V_11 ;
F_47 ( V_10 , V_139 , V_7 -> V_81 , V_7 -> V_78 , V_69 , V_11 , 0 ) ;
...
V_38 = V_7 -> V_38 ;
V_169 = V_7 -> V_33 ;
if ( V_13 -> V_69 != V_171 && F_10 ( V_10 ) == V_19 &&
( V_11 & ( V_141 | V_18 ) ) ==
( V_141 | V_18 ) ) {
F_27 ( & V_7 -> V_60 ) ;
V_38 = V_7 -> V_38 ;
...
if ( F_113 ( V_62 -> V_67 . V_68 ( V_62 , V_10 ) ) )
goto V_98;
if ( V_57 )
F_30 ( V_7 , V_57 ) ;
V_7 -> V_11 &= ~ V_71 ;
...
{
if ( ! V_62 -> V_67 . V_241 )
V_62 -> V_67 . V_241 = F_43 ;
if ( ! V_62 -> V_67 . V_242 )
V_62 -> V_67 . V_242 = F_44 ;
if ( ! V_62 -> V_67 . V_243 )
V_62 -> V_67 . V_243 = F_110 ;
if ( ! V_62 -> V_67 . V_244 )
V_62 -> V_67 . V_244 = F_35 ;
if ( ! V_62 -> V_67 . V_245 )
V_62 -> V_67 . V_245 = F_74 ;
if ( ! V_62 -> V_67 . V_246 )
V_62 -> V_67 . V_246 = F_64 ;
if ( ! V_62 -> V_67 . V_247 )
V_62 -> V_67 . V_247 = F_103 ;
if ( ! V_62 -> V_67 . V_248 )
V_62 -> V_67 . V_248 = F_48 ;
if ( ! V_62 -> V_67 . V_249 )
V_62 -> V_67 . V_249 = F_89 ;
if ( ! V_62 -> V_67 . V_250 )
V_62 -> V_67 . V_250 = F_90 ;
return 0 ;
}
int F_141 ( void )
{
