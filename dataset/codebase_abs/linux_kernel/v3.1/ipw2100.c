...
V_39 += sprintf ( V_39 , L_184 , V_22 -> V_261 ) ;
...
F_201 ( V_150 -> V_490 . V_491 [ V_22 -> V_150 -> V_490 . V_492 ] , L_193 ) ;
F_201 ( V_49 , L_194 ) ;
F_201 ( V_187 , L_194 ) ;
F_201 ( V_472 , L_194 ) ;
V_13 +=
...
F_201 ( V_215 , L_196 ) ;
F_201 ( V_76 , L_196 ) ;
F_201 ( V_424 . V_147 , L_196 ) ;
F_201 ( V_424 . V_494 , L_196 ) ;
F_201 ( V_410 . V_147 , L_196 ) ;
F_201 ( V_410 . V_495 , L_196 ) ;
F_201 ( V_90 . V_147 , L_196 ) ;
F_201 ( V_90 . V_495 , L_196 ) ;
F_201 ( V_92 . V_147 , L_196 ) ;
F_201 ( V_92 . V_494 , L_196 ) ;
F_201 ( V_401 . V_147 , L_196 ) ;
F_201 ( V_401 . V_494 , L_196 ) ;
F_201 ( V_414 . V_147 , L_196 ) ;
F_201 ( V_414 . V_495 , L_196 ) ;
F_201 ( V_150 -> V_296 , L_196 ) ;
F_201 ( V_47 , L_196 ) ;
return V_13 ;
}
...
F_271 ( V_22 , V_647 , sizeof( V_647 ) ) ;
F_272 ( V_22 , V_648 , sizeof( V_648 ) ) ;
snprintf ( V_81 -> V_652 , sizeof( V_81 -> V_652 ) , L_244 ,
V_647 , V_22 -> V_156 , V_648 ) ;
strcpy ( V_81 -> V_653 , F_273 ( V_22 -> V_258 ) ) ;
}
...
static void F_275 ( struct V_259 * V_260 )
{
struct V_21 * V_22 =
...
static struct V_1 * F_277 ( struct V_258 * V_258 ,
void V_5 * V_6 ,
unsigned long V_658 ,
unsigned long V_659 )
{
struct V_21 * V_22 ;
struct V_1 * V_2 ;
V_2 = F_278 ( sizeof( struct V_21 ) , 0 ) ;
if ( ! V_2 )
return NULL ;
V_22 = F_101 ( V_2 ) ;
V_22 -> V_150 = F_279 ( V_2 ) ;
V_22 -> V_258 = V_258 ;
V_22 -> V_33 = V_2 ;
...
F_185 ( & V_22 -> V_393 ) ;
F_225 ( & V_22 -> V_401 ) ;
F_283 ( & V_22 -> V_52 , F_107 ) ;
F_283 ( & V_22 -> V_292 , F_259 ) ;
F_283 ( & V_22 -> V_283 , V_689 ) ;
F_283 ( & V_22 -> V_182 , F_275 ) ;
F_283 ( & V_22 -> V_216 , F_276 ) ;
F_284 ( & V_22 -> V_295 , F_119 ) ;
F_283 ( & V_22 -> V_294 , F_118 ) ;
F_285 ( & V_22 -> V_457 , ( void (*) ( unsigned long ) )
F_173 , ( unsigned long ) V_22 ) ;
V_22 -> V_215 = 1 ;
V_22 -> V_181 = 1 ;
return V_2 ;
}
static int F_286 ( struct V_258 * V_258 ,
...
V_2 = F_277 ( V_258 , V_6 , V_658 , V_659 ) ;
if ( ! V_2 ) {
F_26 (KERN_WARNING DRV_NAME
L_255 ) ;
V_63 = - V_240 ;
...
if ( ( V_4 & 0x0000ff00 ) != 0 )
F_298 ( V_258 , 0x40 , V_4 & 0xffff00ff ) ;
F_299 ( V_258 , V_696 ) ;
if ( ! F_24 ( V_2 ) ) {
F_26 (KERN_WARNING DRV_NAME
L_259 ) ;
...
goto V_123;
F_83 ( & V_22 -> V_263 ) ;
F_30 ( L_265 , V_2 -> V_51 , F_273 ( V_258 ) ) ;
V_63 = F_303 ( & V_258 -> V_2 . V_698 , & V_699 ) ;
if ( V_63 )
goto V_71;
if ( ! ( V_22 -> V_49 & V_484 ) ) {
if ( F_82 ( V_22 ) ) {
...
F_67 ( V_22 ) ;
if ( V_2 -> V_454 )
F_306 ( V_2 -> V_454 , V_22 ) ;
F_220 ( V_22 ) ;
F_250 ( V_22 ) ;
F_307 ( & V_258 -> V_2 . V_698 ,
& V_699 ) ;
F_308 ( V_2 , 0 ) ;
F_293 ( V_258 , NULL ) ;
}
...
static void T_12 F_311 ( struct V_258 * V_258 )
{
struct V_21 * V_22 = F_312 ( V_258 ) ;
struct V_1 * V_2 ;
if ( V_22 ) {
F_83 ( & V_22 -> V_263 ) ;
V_22 -> V_49 &= ~ V_619 ;
...
static int F_313 ( struct V_258 * V_258 , T_13 V_102 )
{
struct V_21 * V_22 = F_312 ( V_258 ) ;
struct V_1 * V_2 = V_22 -> V_33 ;
F_30 ( L_267 , V_2 -> V_51 ) ;
...
static int F_316 ( struct V_258 * V_258 )
{
struct V_21 * V_22 = F_312 ( V_258 ) ;
struct V_1 * V_2 = V_22 -> V_33 ;
int V_63 ;
...
static void F_319 ( struct V_258 * V_258 )
{
struct V_21 * V_22 = F_312 ( V_258 ) ;
F_98 ( V_22 ) ;
F_296 ( V_258 ) ;
...
if ( ! memcmp ( V_772 , V_218 -> V_219 . V_628 , V_230 ) ||
! memcmp ( V_773 , V_218 -> V_219 . V_628 , V_230 ) ) {
F_329 ( L_280 ) ;
V_22 -> V_187 &= ~ V_625 ;
...
V_22 -> V_187 |= V_625 ;
memcpy ( V_22 -> V_774 , V_218 -> V_219 . V_628 , V_230 ) ;
V_63 = F_244 ( V_22 , V_218 -> V_219 . V_628 , 0 ) ;
F_329 ( L_281 , V_218 -> V_219 . V_628 ) ;
V_620:
F_84 ( & V_22 -> V_263 ) ;
return V_63 ;
}
...
struct V_21 * V_22 = F_101 ( V_2 ) ;
int V_63 = 0 , V_147 ;
if ( F_212 ( V_22 , V_218 -> V_756 . V_779 ) )
return - V_780 ;
if ( V_22 -> V_150 -> V_198 != V_431 )
return 0 ;
...
{
struct V_21 * V_22 = F_101 ( V_2 ) ;
return F_354 ( V_22 -> V_150 , V_81 , V_218 , V_709 ) ;
}
...
{
struct V_21 * V_22 = F_101 ( V_2 ) ;
return F_356 ( V_22 -> V_150 , V_81 , V_218 , V_593 ) ;
}
...
{
struct V_21 * V_22 = F_101 ( V_2 ) ;
return F_358 ( V_22 -> V_150 , V_81 , V_218 , V_593 ) ;
}
...
return - V_31 ;
if ( V_218 -> V_37 . V_284 ) {
V_14 = F_362 ( V_709 , V_218 -> V_37 . V_284 , V_239 ) ;
if ( V_14 == NULL )
return - V_240 ;
F_133 ( V_150 -> V_640 ) ;
V_150 -> V_640 = V_14 ;
...
case V_808 :
V_264 = F_269 ( V_22 , V_795 -> V_147 ) ;
break;
case V_809 :
V_264 = F_268 ( V_22 , V_795 -> V_147 ) ;
break;
case V_810 :
...
{
struct V_21 * V_22 = F_101 ( V_2 ) ;
return F_367 ( V_22 -> V_150 , V_81 , V_218 , V_709 ) ;
}
...
{
struct V_21 * V_22 = F_101 ( V_2 ) ;
return F_369 ( V_22 -> V_150 , V_81 , V_218 , V_709 ) ;
}
...
static struct V_824 * F_379 ( struct V_1 * V_2 )
{
enum {
V_825 = 30 ,
V_826 = 60 ,
...
static int F_380 ( struct V_119 * V_849 )
{
struct V_850 * V_851 =
(struct V_850 * ) V_849 -> V_852 -> V_37 ;
if ( F_381 ( V_851 -> V_121 ) != V_853 ) {
...
V_202 = F_383 ( & V_849 -> V_852 , V_857 , & V_22 -> V_258 -> V_2 ) ;
if ( V_202 < 0 ) {
F_26 (KERN_ERR DRV_NAME L_67
L_331 ,
