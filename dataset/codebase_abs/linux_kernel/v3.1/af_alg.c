...
static int F_39 ( struct V_19 * V_20 , struct V_19 * V_50 , int V_57 )
{
...
static int F_41 ( struct V_58 * V_58 , struct V_19 * V_20 , int V_59 ,
int V_60 )
{
struct V_20 * V_21 ;
int V_8 ;
...
int F_42 ( struct V_66 * V_67 , void T_1 * V_68 , int V_69 ,
int V_70 )
{
...
int V_74 ;
V_8 = - V_40 ;
if ( ! F_43 ( V_70 ? V_75 : V_76 , V_68 , V_69 ) )
goto V_41;
V_73 = V_71 & ~ V_77 ;
V_72 = ( V_73 + V_69 + V_78 - 1 ) >> V_79 ;
if ( V_72 > V_80 )
V_72 = V_80 ;
V_8 = F_44 ( V_71 , V_72 , V_70 , V_67 -> V_81 ) ;
if ( V_8 < 0 )
goto V_41;
V_72 = V_8 ;
V_8 = - V_31 ;
...
int V_83 = F_47 ( int , V_69 , V_78 - V_73 ) ;
F_48 ( V_67 -> V_82 + V_74 , V_67 -> V_81 [ V_74 ] , V_83 , V_73 ) ;
V_73 = 0 ;
V_69 -= V_83 ;
V_8 += V_83 ;
}
...
do {
F_50 ( V_67 -> V_81 [ V_74 ] ) ;
} while ( ! F_51 ( V_67 -> V_82 + ( V_74 ++ ) ) );
}
int F_52 ( struct V_84 * V_85 , struct V_86 * V_87 )
{
struct V_88 * V_89 ;
for ( V_89 = F_53 ( V_85 ) ; V_89 ; V_89 = F_54 ( V_85 , V_89 ) ) {
if ( ! F_55 ( V_85 , V_89 ) )
return - V_31 ;
if ( V_89 -> V_90 != V_48 )
continue;
switch( V_89 -> V_91 ) {
case V_92 :
if ( V_89 -> V_93 < F_56 ( sizeof( * V_87 -> V_94 ) ) )
return - V_31 ;
V_87 -> V_94 = ( void * ) F_57 ( V_89 ) ;
if ( V_89 -> V_93 < F_56 ( V_87 -> V_94 -> V_95 +
sizeof( * V_87 -> V_94 ) ) )
return - V_31 ;
break;
case V_96 :
if ( V_89 -> V_93 < F_56 ( sizeof( V_97 ) ) )
return - V_31 ;
V_87 -> V_98 = * ( V_97 * ) F_57 ( V_89 ) ;
break;
default:
return - V_31 ;
}
...
int F_58 ( int V_8 , struct V_99 * V_100 )
{
switch ( V_8 ) {
case - V_101 :
case - V_102 :
...
void F_61 ( struct V_103 * V_104 , int V_8 )
{
