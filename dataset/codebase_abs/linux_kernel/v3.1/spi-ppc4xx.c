...
V_6 -> V_105 = F_41 ( V_80 , 0 ) ;
V_84 = F_42 ( V_6 -> V_105 , F_16 ,
V_106 , L_18 , ( void * ) V_6 ) ;
if ( V_84 ) {
F_8 ( V_8 , L_19 ) ;
goto F_24;
}
if ( ! F_43 ( V_6 -> V_101 , V_6 -> V_103 , V_107 ) ) {
F_8 ( V_8 , L_20 ) ;
V_84 = - V_108 ;
goto V_109;
}
V_6 -> V_16 = F_44 ( V_6 -> V_101 , sizeof( struct V_104 ) ) ;
if ( ! V_6 -> V_16 ) {
F_8 ( V_8 , L_21 ) ;
V_84 = - V_110 ;
goto V_111;
...
static int T_5 F_51 ( struct V_73 * V_74 )
{
struct V_75 * V_12 = F_52 ( & V_74 -> V_8 ) ;
