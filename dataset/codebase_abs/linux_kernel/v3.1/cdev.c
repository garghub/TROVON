...
V_96 = F_51 ( V_79 -> V_105 , V_79 -> V_98 + 1 ) ;
if ( V_96 != V_79 -> V_98 )
goto V_99;
return 0 ;
V_99:
...
return - V_34 ;
if ( V_79 -> V_115 [ V_108 ] . V_98 > V_103 )
return - V_104 ;
V_79 -> V_115 [ V_108 ] . V_105 [ V_79 -> V_115 [ V_108 ] . V_98 ] = '\0' ;
V_96 = strlen ( V_79 -> V_115 [ V_108 ] . V_105 ) ;
...
if ( ! strcmp ( V_79 -> V_115 [ V_108 ] . V_105 , V_79 -> V_115 [ V_96 ] . V_105 ) ) {
F_4 ( L_21 ,
V_79 -> V_115 [ V_108 ] . V_105 ) ;
return - V_34 ;
}
}
}
...
const char * V_105 = V_79 -> V_115 [ V_108 ] . V_105 ;
...
! memcmp ( V_112 -> V_2 -> V_6 -> V_105 , V_105 , V_98 ) ) {
F_18 ( V_112 -> V_2 ) ;
F_57 ( V_112 ) ;
continue;
}
V_112 -> V_118 = V_98 ;
memcpy ( V_112 -> V_119 , V_105 , V_98 ) ;
F_58 ( & V_112 -> V_120 , & V_110 ) ;
F_59 ( L_23 ,
V_12 , V_112 -> V_2 -> V_6 -> V_105 , V_105 ) ;
}
if ( F_60 ( & V_110 ) )
return 0 ;
...
! memcmp ( V_112 -> V_119 , V_113 -> V_2 -> V_6 -> V_105 ,
V_113 -> V_2 -> V_6 -> V_98 ) ) {
V_121 = 1 ;
break;
}
...
F_59 ( L_25 ,
V_113 -> V_2 -> V_6 -> V_12 , V_113 -> V_2 -> V_6 -> V_105 ) ;
}
F_21 ( & V_7 -> V_92 ) ;
V_4 = F_64 ( V_7 , & V_110 ) ;
F_23 ( & V_7 -> V_92 ) ;
