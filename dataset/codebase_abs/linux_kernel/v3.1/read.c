...
static int F_58 ( struct V_25 * V_82 , struct V_76 * V_18 )
{
...
static int F_64 ( struct V_25 * V_82 , struct V_76 * V_18 )
{
struct V_35 * V_38 ;
struct V_10 * * V_6 ;
struct V_1 * V_15 ;
...
int F_67 ( struct V_25 * V_82 , struct V_76 * V_77 )
{
if ( V_82 -> V_31 < V_14 )
return F_58 ( V_82 , V_77 ) ;
return F_64 ( V_82 , V_77 ) ;
}
static int F_68 ( struct V_25 * V_82 )
{
F_69 ( V_77 ) ;
int V_78 ;
V_78 = F_67 ( V_82 , & V_77 ) ;
...
int F_70 ( struct V_52 * V_53 , struct V_1 * V_15 )
{
int V_95 ;
F_34 ( L_4 , V_96 , V_53 -> V_69 ,
V_53 -> V_97 ) ;
V_95 = F_40 ( V_15 -> V_27 ) -> F_71 ( V_53 , V_15 ) ;
if ( V_95 != 0 )
return V_95 ;
F_72 ( V_15 -> V_27 , V_98 , V_15 -> V_18 . V_17 ) ;
if ( V_53 -> V_97 == - V_99 ) {
F_73 ( V_100 , & F_74 ( V_15 -> V_27 ) -> V_67 ) ;
F_75 ( V_15 -> V_27 ) ;
}
return 0 ;
}
static void F_76 ( struct V_52 * V_53 , struct V_1 * V_15 )
{
struct V_101 * V_102 = & V_15 -> args ;
struct V_103 * V_104 = & V_15 -> V_18 ;
if ( V_104 -> V_22 || V_104 -> V_17 == V_102 -> V_17 )
return;
F_77 ( V_15 -> V_27 , V_105 ) ;
if ( V_104 -> V_17 == 0 )
return;
...
F_78 ( V_53 , F_19 ( V_15 -> V_27 ) -> V_107 ) ;
}
static void F_79 ( struct V_52 * V_53 , void * V_108 )
{
struct V_1 * V_15 = V_108 ;
if ( F_70 ( V_53 , V_15 ) != 0 )
return;
if ( V_53 -> V_97 < 0 )
return;
...
void F_83 ( struct V_52 * V_53 , void * V_108 )
{
struct V_1 * V_15 = V_108 ;
if ( F_84 ( F_19 ( V_15 -> V_27 ) ,
& V_15 -> args . V_109 , & V_15 -> V_18 . V_110 ,
0 , V_53 ) )
return;
F_85 ( V_53 ) ;
}
static void F_86 ( struct V_1 * V_15 )
{
...
static void F_88 ( struct V_52 * V_53 , void * V_108 )
{
struct V_1 * V_15 = V_108 ;
if ( F_70 ( V_53 , V_15 ) != 0 )
return;
...
int F_90 ( struct V_111 * V_111 , struct V_10 * V_10 )
{
struct V_33 * V_34 ;
struct V_27 * V_27 = V_10 -> V_112 -> V_113 ;
int error ;
F_34 ( L_5 ,
V_10 , V_14 , V_10 -> V_114 ) ;
F_77 ( V_27 , V_115 ) ;
F_72 ( V_27 , V_116 , 1 ) ;
error = F_91 ( V_27 , V_10 ) ;
if ( error )
goto V_117;
if ( F_32 ( V_10 ) )
goto V_117;
...
if ( V_111 == NULL ) {
error = - V_118 ;
V_34 = F_93 ( V_27 , NULL , V_119 ) ;
if ( V_34 == NULL )
goto V_117;
} else
V_34 = F_46 ( F_94 ( V_111 ) ) ;
if ( ! F_95 ( V_27 ) ) {
error = F_96 ( V_34 , V_27 , V_10 ) ;
if ( error == 0 )
goto V_93;
}
...
static int
F_97 ( void * V_15 , struct V_10 * V_10 )
{
struct V_120 * V_82 = (struct V_120 * ) V_15 ;
struct V_27 * V_27 = V_10 -> V_112 -> V_113 ;
struct V_35 * V_36 ;
unsigned int V_37 ;
int error ;
...
int F_98 ( struct V_111 * V_123 , struct V_124 * V_112 ,
struct V_76 * V_6 , unsigned V_125 )
{
struct V_25 V_26 ;
struct V_120 V_82 = {
. V_26 = & V_26 ,
} ;
struct V_27 * V_27 = V_112 -> V_113 ;
unsigned long V_7 ;
int V_78 = - V_99 ;
F_34 ( L_6 ,
V_27 -> V_43 -> V_44 ,
...
goto V_93;
if ( V_123 == NULL ) {
V_82 . V_34 = F_93 ( V_27 , NULL , V_119 ) ;
if ( V_82 . V_34 == NULL )
return - V_118 ;
} else
V_82 . V_34 = F_46 ( F_94 ( V_123 ) ) ;
V_78 = F_99 ( V_82 . V_34 , V_27 , V_112 ,
V_6 , & V_125 ) ;
if ( V_78 == 0 )
goto V_127;
F_21 ( & V_26 , V_27 ) ;
V_78 = F_100 ( V_112 , V_6 , F_97 , & V_82 ) ;
F_30 ( & V_26 ) ;
V_7 = ( V_26 . V_128 + V_14 - 1 ) >> V_23 ;
F_72 ( V_27 , V_116 , V_7 ) ;
V_127:
F_11 ( V_82 . V_34 ) ;
V_93:
