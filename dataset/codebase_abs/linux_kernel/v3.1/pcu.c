...
V_46 -> V_47 += F_8 ( V_2 , V_48 ) ;
V_46 -> V_49 += F_8 ( V_2 , V_50 ) ;
V_46 -> V_51 += F_8 ( V_2 , V_52 ) ;
V_46 -> V_53 += F_8 ( V_2 , V_54 ) ;
V_46 -> V_55 += F_8 ( V_2 , V_56 ) ;
}
...
unsigned int V_57 ;
T_2 V_58 = V_59 ;
for ( V_57 = 0 ; V_57 < V_2 -> V_60 [ V_58 ] . V_61 ; V_57 ++ ) {
T_3 V_62 ;
T_4 V_63 ;
if ( V_2 -> V_64 )
V_5 = & V_2 -> V_60 [ V_58 ] . V_65 [ V_66 [ V_57 ] ] ;
else if ( V_57 < 4 )
V_5 = & V_2 -> V_60 [ V_58 ] . V_65 [ 0 ] ;
else
V_5 = & V_2 -> V_60 [ V_58 ] . V_65 [ 4 ] ;
V_62 = F_10 ( V_5 -> V_39 ) ;
