...
V_136 = F_65 ( V_125 , V_157 , 0 ) ;
if ( ! V_136 ) {
F_57 ( & V_125 -> V_123 , L_8 ) ;
V_137 = - V_141 ;
goto V_158;
}
if ( ! F_66 ( V_136 -> V_159 , F_67 ( V_136 ) , V_125 -> V_160 ) ) {
F_57 ( & V_125 -> V_123 , L_9 ) ;
V_137 = - V_161 ;
goto V_158;
}
V_18 -> V_25 = F_68 ( V_136 -> V_159 , F_67 ( V_136 ) ) ;
if ( ! V_18 -> V_25 ) {
V_137 = - V_139 ;
goto V_162;
}
V_18 -> V_102 = F_69 ( V_125 , 0 ) ;
if ( V_18 -> V_102 < 0 ) {
V_137 = - V_139 ;
goto V_163;
}
V_137 = F_70 ( V_18 -> V_102 , F_43 , 0 , V_146 , V_18 ) ;
if ( V_137 ) {
F_57 ( & V_125 -> V_123 , L_10 , V_18 -> V_102 , V_137 ) ;
goto V_163;
}
V_18 -> V_164 = F_71 ( & V_125 -> V_123 , NULL ) ;
if ( F_72 ( V_18 -> V_164 ) ) {
F_57 ( & V_125 -> V_123 , L_11 ) ;
V_137 = F_73 ( V_18 -> V_164 ) ;
goto V_165;
}
F_74 ( V_18 -> V_164 ) ;
V_18 -> V_36 = F_75 ( V_18 -> V_164 ) ;
V_18 -> V_3 -> V_166 ( V_18 ) ;
V_18 -> V_3 -> V_107 ( V_18 , 0 ) ;
V_92 -> V_123 . V_128 = V_125 -> V_123 . V_128 ;
V_137 = F_76 ( & V_18 -> V_144 ) ;
if ( V_137 ) {
F_57 ( & V_125 -> V_123 , L_12 , V_137 ) ;
goto V_167;
}
F_77 ( & V_125 -> V_123 , L_13 ) ;
return V_137 ;
V_167:
F_78 ( V_18 -> V_164 ) ;
F_79 ( V_18 -> V_164 ) ;
...
struct V_135 * V_136 = F_65 ( V_125 , V_157 , 0 ) ;
