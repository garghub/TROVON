...
V_15 -> V_42 = F_50 ( V_15 -> V_42 , V_108 ) ;
...
V_1 -> V_114 = F_34 ;
F_51 ( V_1 , V_15 ) ;
V_1 -> V_115 [ 0 ] = F_52 ( V_116 ) | F_52 ( V_117 ) ;
F_53 ( V_1 , V_12 , V_13 ) ;
V_1 -> V_30 = V_15 -> V_30 ;
V_1 -> V_118 = sizeof( V_15 -> V_30 [ 0 ] ) ;
V_1 -> V_119 = V_36 ;
if ( V_54 -> V_32 )
V_1 -> V_119 *= 2 ;
V_15 -> V_32 = V_54 -> V_32 ;
...
F_54 ( V_90 , V_29 ,
V_1 -> V_30 , V_1 -> V_121 ) ;
V_93 = F_55 ( V_15 -> V_47 , F_15 , V_122 ,
V_87 -> V_102 , V_15 ) ;
if ( V_93 ) {
F_36 ( & V_87 -> V_81 , L_8 ) ;
goto V_123;
...
static int F_68 ( struct V_82 * V_81 )
{
struct V_86 * V_87 = F_69 ( V_81 ) ;
struct V_14 * V_15 = F_66 ( V_87 ) ;
if ( F_70 ( & V_87 -> V_81 ) ) {
F_16 ( V_15 , true ) ;
F_71 ( V_15 -> V_47 ) ;
...
F_73 ( & V_15 -> V_37 -> V_125 ) ;
if ( V_15 -> V_37 -> V_126 )
F_28 ( V_15 ) ;
F_74 ( & V_15 -> V_37 -> V_125 ) ;
}
return 0 ;
}
static int F_75 ( struct V_82 * V_81 )
{
struct V_86 * V_87 = F_69 ( V_81 ) ;
struct V_14 * V_15 = F_66 ( V_87 ) ;
int V_93 = 0 ;
