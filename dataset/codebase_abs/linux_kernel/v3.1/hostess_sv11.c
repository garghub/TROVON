...
V_29 = F_28 ( sizeof( struct V_1 ) , V_31 ) ;
if ( ! V_29 )
goto V_32;
V_29 -> V_33 = 0 ;
V_29 -> V_16 . V_34 = V_27 + 1 ;
V_29 -> V_16 . V_35 = V_27 + 3 ;
V_29 -> V_36 . V_34 = - 1 ;
V_29 -> V_36 . V_35 = - 1 ;
V_29 -> V_16 . V_37 = & V_38 ;
V_29 -> V_36 . V_37 = & V_38 ;
F_29 ( 0 , V_27 + 4 ) ;
if ( F_30 ( V_28 , V_39 , V_40 ,
L_3 , V_29 ) < 0 ) {
F_27 ( L_4 , V_28 ) ;
goto V_41;
}
...
if ( F_31 ( V_29 -> V_16 . V_43 , L_5 ) )
goto V_45;
if ( V_15 == 1 )
if ( F_31 ( V_29 -> V_16 . V_44 , L_6 ) )
goto V_46;
}
F_32 ( V_28 ) ;
if ( F_33 ( V_29 ) ) {
...
F_43 ( V_3 -> V_16 . V_34 - 1 , 8 ) ;
F_39 ( V_3 -> V_16 . V_11 ) ;
F_42 ( V_3 ) ;
}
int F_47 ( void )
{
if ( ( V_57 = F_25 ( V_58 , V_28 ) ) == NULL )
return - V_59 ;
return 0 ;
}
void F_48 ( void )
