...
{
if ( V_25 )
V_27 = F_22 ( V_25 , NULL , 0 ) ;
return 0 ;
}
int T_2 F_23 ( char * V_28 )
{
if ( F_18 ( V_29 ) ) {
unsigned long V_30 = F_22 ( V_28 , NULL , 0 ) ;
F_24 ( V_31 L_3 , V_30 ) ;
F_25 ( 0 ) ;
F_25 ( V_30 ) ;
}
...
unsigned char F_28 ( int V_33 )
{
if ( V_20 . V_34 )
return V_20 . V_34 ( V_33 ) ;
return 0xff ;
}
void F_29 ( unsigned char V_30 , int V_33 )
{
if ( V_20 . V_35 )
V_20 . V_35 ( V_33 , V_30 ) ;
}
