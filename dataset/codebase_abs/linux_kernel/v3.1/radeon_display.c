...
F_84 ( V_5 ) ;
F_74 ( V_5 ) ;
F_76 (drm_connector, &dev->mode_config.connector_list, head)
F_85 ( V_135 ) ;
}
return V_186 ;
}
...
& V_191 -> V_196 -> V_198 ) ;
else if ( V_140 -> V_150 && ! V_140 -> V_197 )
V_140 -> V_197 = F_89 ( & V_140 -> V_92 ,
& V_140 -> V_150 -> V_198 ) ;
} else {
if ( V_140 -> V_150 && ! V_140 -> V_197 )
V_140 -> V_197 = F_89 ( & V_140 -> V_92 ,
& V_140 -> V_150 -> V_198 ) ;
}
if ( ! V_140 -> V_197 ) {
...
V_186 = F_92 ( & V_140 -> V_92 , V_140 -> V_197 ) ;
return V_186 ;
}
F_91 ( & V_140 -> V_92 , NULL ) ;
return 0 ;
}
static int F_85 ( struct V_135 * V_139 )
{
struct V_197 * V_197 ;
struct V_140 * V_140 = F_77 ( V_139 ) ;
int V_186 = 0 ;
if ( V_140 -> V_160 . V_161 )
F_87 ( V_140 ) ;
if ( ! V_140 -> V_150 )
return - 1 ;
V_197 = F_89 ( V_139 , & V_140 -> V_150 -> V_198 ) ;
if ( V_197 ) {
F_75 ( L_30 ,
F_93 ( V_139 ) ) ;
F_33 ( V_197 ) ;
...
static void F_94 ( struct V_200 * V_201 ,
T_3 V_202 ,
T_3 V_203 ,
T_3 V_204 ,
T_3 * V_205 ,
...
static T_3 F_95 ( struct V_200 * V_201 ,
T_3 V_202 )
{
...
{
T_3 V_202 = V_221 / 10 ;
T_3 V_203 = F_95 ( V_201 , V_202 ) ;
T_3 V_204 = V_201 -> V_227 ;
T_3 V_205 = 0 , V_206 = 0 , V_207 ;
if ( V_201 -> V_81 & V_228 )
V_204 = V_201 -> V_229 ;
if ( V_201 -> V_81 & V_230 ) {
F_94 ( V_201 , V_202 , V_203 , V_204 , & V_205 , & V_206 ) ;
...
static inline T_1 F_97 ( T_5 V_233 , T_1 V_234 )
{
T_5 V_235 ;
V_233 += V_234 / 2 ;
V_235 = F_98 ( V_233 , V_234 ) ;
return V_233 ;
}
void F_99 ( struct V_200 * V_201 ,
T_5 V_221 ,
T_1 * V_222 ,
T_1 * V_223 ,
T_1 * V_224 ,
...
{
struct V_105 * V_269 = F_58 ( V_104 ) ;
return F_103 ( V_100 , V_269 -> V_109 , V_271 ) ;
}
void
...
{
V_272 -> V_109 = V_109 ;
F_105 ( V_5 , & V_272 -> V_92 , & V_275 ) ;
F_106 ( & V_272 -> V_92 , V_274 ) ;
}
static struct V_103 *
...
struct V_108 * V_109 ;
struct V_105 * V_269 ;
V_109 = F_108 ( V_5 , V_100 , V_274 -> V_271 ) ;
if ( V_109 == NULL ) {
F_109 ( & V_5 -> V_276 -> V_5 , L_35
L_36 , V_274 -> V_271 ) ;
return F_110 ( - V_277 ) ;
}
...
static bool F_135 ( struct V_309 * V_310 )
{
...
if ( V_3 -> V_321 != V_322 ) {
T_6 V_331 , V_332 ;
V_331 . V_333 = F_139 ( V_315 ) ;
V_332 . V_333 = F_139 ( V_316 ) ;
V_3 -> V_334 . V_333 = F_140 ( V_331 , V_332 ) ;
V_331 . V_333 = F_139 ( V_317 ) ;
V_332 . V_333 = F_139 ( V_318 ) ;
V_3 -> V_335 . V_333 = F_140 ( V_331 , V_332 ) ;
} else {
V_3 -> V_334 . V_333 = F_139 ( 1 ) ;
V_3 -> V_335 . V_333 = F_139 ( 1 ) ;
}
return true ;
}
