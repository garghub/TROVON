...
V_2 -> V_18 = F_2 ( V_66 , & V_65 , V_4 , & V_2 -> V_67 ) ;
if ( ! V_2 -> V_18 ) {
F_3 ( V_40 L_5 ) ;
return - V_19 ;
}
...
V_2 -> V_41 = 0 ;
V_68 = V_2 -> V_7 -> V_8 -> V_9 [ V_2 -> V_10 ] ;
V_69 = F_9 ( V_2 ) ;
if ( V_69 < 0 || V_2 -> V_10 < 2 )
return V_69 ;
V_54 . V_56 = V_68 -> V_70 ;
V_54 . V_60 = 3 ;
V_59 [ 0 ] = 0xf1 ;
...
{
V_2 -> V_18 = F_2 ( V_72 , & V_73 , & V_2 -> V_3 ) ;
if ( V_2 -> V_18 == NULL ) {
F_3 (KERN_ERR DEVICE_NAME L_8 ) ;
return - V_19 ;
}
F_2 ( V_74 , V_2 -> V_18 , & V_2 -> V_3 ,
& V_75 , 0 ) ;
return ( V_2 -> V_18 ) ? 0 : - V_19 ;
}
static T_3 F_20 ( struct V_76 * V_7 ,
enum V_77 V_78 )
{
...
static T_3 F_21 ( struct V_76 * V_7 )
{
F_3 (KERN_INFO DEVICE_NAME L_10 ) ;
return 0 ;
}
static T_3 F_22 ( struct V_76 * V_7 )
{
F_3 (KERN_INFO DEVICE_NAME L_11 ) ;
return 0 ;
}
static void F_23 ( struct V_76 * V_7 )
{
