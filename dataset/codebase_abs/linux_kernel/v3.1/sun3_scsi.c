...
F_26 ( V_64 , V_65 ) ;
F_28 ( V_67 ) ;
for( V_61 = V_68 + V_69 ; F_29 ( V_68 , V_61 ) ; )
F_30 () ;
F_9 ( L_13 ) ;
}
const char * F_31 ( struct V_15 * V_70 ) {
return L_14 ;
}
static T_2 V_51 ( int V_46 , void * V_71 )
{
...
static unsigned long F_34 ( void * V_78 , unsigned long V_79 , int V_80 )
{
#ifdef F_10
if( V_80 )
...
if( V_81 != NULL )
F_35 ( V_81 ) ;
V_83 = ( void * ) F_36 ( ( unsigned long ) V_78 , V_79 ) ;
V_81 = V_83 ;
V_82 = V_79 ;
#endif
V_5 -> V_59 = 0 ;
...
#ifdef F_10
V_37 -> V_86 = ( ( F_38 ( V_39 ) & 0xff0000 ) >> 8 ) ;
V_37 -> V_87 = ( F_38 ( V_39 ) & 0xffff ) ;
#else
...
F_5 ( ( ( F_38 ( V_37 ) & 0xff0000 ) >> 8 ) ,
V_96 ) ;
F_5 ( ( F_38 ( V_37 ) & 0xffff ) , V_97 ) ;
F_5 ( 0xd , V_98 ) ;
F_5 ( V_99 , V_7 ) ;
return V_79 ;
}
...
static inline unsigned long F_40 ( struct V_15 * V_16 )
{
return V_101 ;
}
static inline unsigned long F_41 ( unsigned long V_102 ,
struct V_103 * V_104 ,
int V_80 )
{
...
static inline int F_42 ( unsigned long V_79 , unsigned char * V_78 )
{
F_5 ( V_108 , V_7 ) ;
return 0 ;
}
static int F_43 ( int V_80 )
{
unsigned short V_79 ;
