...
{
struct V_53 * V_17 = & V_16 -> V_17 ;
struct V_54 V_55 [ 2 ] ;
const struct V_54 * V_56 [] = { & V_55 [ 0 ] , & V_55 [ 1 ] } ;
unsigned long V_57 ;
struct V_58 * V_5 ;
struct V_3 * V_4 ;
int V_59 ;
...
if ( V_59 )
return V_59 ;
V_4 = F_17 ( V_17 , sizeof( * V_4 ) , V_63 ) ;
if ( ! V_4 )
return - V_64 ;
F_18 ( V_16 , 0x54 , & V_4 -> V_9 ) ;
V_59 = F_19 ( V_16 , V_56 , & V_5 ) ;
if ( V_59 )
return V_59 ;
V_5 -> V_6 = V_4 ;
F_20 ( V_16 , 1 ) ;
V_5 -> V_62 |= V_65 ;
F_21 ( V_16 ) ;
return F_22 ( V_5 , V_66 , & V_67 ) ;
}
static void F_23 ( struct V_15 * V_16 )
{
struct V_58 * V_5 = F_24 ( & V_16 -> V_17 ) ;
