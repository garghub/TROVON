...
struct V_45 * V_27 ;
int V_63 = - V_64 ;
if ( V_26 -> V_51 . V_65 == NULL ) {
return 0 ;
}
V_2 = F_27 ( sizeof( * V_2 ) , V_66 ) ;
V_27 = F_28 () ;
if ( ! V_2 || ! V_27 )
goto V_67;
V_2 -> V_26 = V_26 ;
...
goto V_67;
V_2 -> V_44 = 100 ;
snprintf ( V_2 -> V_72 , sizeof( V_2 -> V_72 ) , L_7 ,
V_26 -> V_72 ) ;
F_29 ( V_26 -> V_73 , V_2 -> V_74 , sizeof( V_2 -> V_74 ) ) ;
F_30 ( V_2 -> V_74 , L_8 , sizeof( V_2 -> V_74 ) ) ;
V_27 -> V_75 = V_2 -> V_72 ;
V_27 -> V_76 = V_2 -> V_74 ;
V_27 -> V_77 . V_78 = V_79 ;
V_27 -> V_77 . V_80 = 1 ;
V_27 -> V_77 . V_81 = F_31 ( V_26 -> V_73 -> V_82 . V_83 ) ;
V_27 -> V_77 . V_84 = F_31 ( V_26 -> V_73 -> V_82 . V_85 ) ;
V_27 -> V_26 . V_86 = & V_26 -> V_73 -> V_26 ;
V_27 -> V_87 = V_26 -> V_51 . V_65 ;
V_27 -> V_88 = V_89 ;
V_63 = F_32 ( V_27 ) ;
if ( V_63 )
goto V_90;
...
{
struct V_25 * V_26 =
F_15 ( V_43 , struct V_25 , V_91 . V_43 ) ;
int V_92 ;
V_92 = F_38 ( V_26 , V_93 ) ;
if ( V_92 & V_94 ) {
T_3 V_95 ;
V_95 = ( ( T_3 ) V_92 ) & ~ V_94 ;
F_24 ( V_26 , V_93 , & V_95 , 1 ) ;
F_39 ( V_26 -> V_96 , V_97 ,
1 ) ;
F_39 ( V_26 -> V_96 , V_97 ,
0 ) ;
...
F_29 ( V_26 -> V_73 , V_26 -> V_100 ,
sizeof( V_26 -> V_100 ) ) ;
F_30 ( V_26 -> V_100 , L_11 ,
sizeof( V_26 -> V_100 ) ) ;
F_19 ( & V_26 -> V_91 , F_37 ) ;
V_99 -> V_72 = L_12 ;
V_99 -> V_74 = V_26 -> V_100 ;
V_99 -> V_101 [ 0 ] = F_44 ( V_102 ) | F_44 ( V_103 ) ;
F_45 ( V_97 , V_99 -> V_104 ) ;
V_99 -> V_105 = 0 ;
V_99 -> V_106 = 0 ;
V_99 -> V_107 . V_78 = V_79 ;
V_99 -> V_107 . V_81 = F_31 ( V_26 -> V_73 -> V_82 . V_83 ) ;
V_99 -> V_107 . V_84 = F_31 ( V_26 -> V_73 -> V_82 . V_85 ) ;
V_99 -> V_107 . V_80 = 1 ;
V_99 -> V_26 . V_86 = & V_26 -> V_73 -> V_26 ;
V_63 = F_46 ( V_99 ) ;
if ( V_63 ) {
F_43 ( L_13 ) ;
F_47 ( V_99 ) ;
