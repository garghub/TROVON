...
struct V_38 * F_12 ( int V_40 , int V_41 ,
int V_42 )
{
struct V_38 * V_39 ;
int V_43 ;
...
void F_18 ( struct V_12 * V_13 , struct V_14 * V_47 , T_3 * V_56 )
{
T_4 V_57 = V_13 -> V_57 ;
T_5 V_58 = NULL ;
...
if ( ! F_19 ( V_47 -> V_1 ) )
return;
if ( F_20 ( V_60 -> V_29 ) || F_21 ( V_60 -> V_29 ) )
return;
#ifdef F_22
if( V_63 -> V_64 >= 4096 )
return;
...
if( V_57 -> V_69 )
{
if ( ! F_23 ( V_13 , ( V_70 * ) ( & V_58 ) , V_60 -> V_29 , V_47 -> V_71 , V_72 , true ) )
{
F_4 ( L_6 ) ;
return;
}
...
{
if ( F_25 ( V_58 -> V_73 . V_77 . V_78 . V_79 , ( V_58 -> V_80 + 1 ) % 4096 ) )
V_58 -> V_76 = true ;
else
goto V_75;
}
...
extern void F_26 ( struct V_12 * V_13 , T_3 * V_56 )
{
V_56 -> V_94 = false ;
if ( V_56 -> V_95 == 2 )
{
...
extern void
F_27 ( struct V_12 * V_13 , T_3 * V_56 )
{
T_4 V_57 = V_13 -> V_57 ;
V_56 -> V_99 = false ;
if( ! V_57 -> V_61 || ! V_57 -> V_62 )
...
void F_28 ( struct V_12 * V_13 , T_3 * V_56 )
{
T_4 V_57 = V_13 -> V_57 ;
V_56 -> V_104 = false ;
if( ! V_57 -> V_61 || ! V_57 -> V_62 )
...
void F_29 ( struct V_12 * V_13 , T_3 * V_56 , struct V_14 * V_47 )
{
V_56 -> V_110 = false ;
V_56 -> V_111 = false ;
V_56 -> V_112 = false ;
...
void F_30 ( struct V_12 * V_13 , T_3 * V_56 )
{
#ifdef F_22
if( ! F_31 ( V_128 ) )
{
...
void F_32 ( struct V_12 * V_13 , struct V_14 * V_47 , T_1 * V_135 )
{
...
{
T_5 V_136 = NULL ;
if ( ! F_23 ( V_13 , ( V_70 * ) ( & V_136 ) , V_135 , V_47 -> V_71 , V_72 , true ) )
{
return;
}
...
if ( V_39 )
{
T_3 * V_56 = ( T_3 * ) ( V_39 -> V_45 [ 0 ] -> V_46 + V_201 ) ;
V_56 -> V_207 = 1 ;
if ( F_20 ( V_24 . V_29 ) )
V_56 -> V_105 = 1 ;
if ( F_21 ( V_24 . V_29 ) )
