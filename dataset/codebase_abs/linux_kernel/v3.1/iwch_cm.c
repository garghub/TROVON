...
static int F_108 ( struct V_1 * V_2 , T_1 V_179 )
{
struct V_180 * V_27 ;
struct V_17 * V_18 ;
...
V_27 -> V_182 = F_20 ( F_109 ( V_179 ) | F_110 ( 1 ) ) ;
V_18 -> V_33 = V_183 ;
...
F_112 ( V_18 , & ( V_2 -> V_139 [ V_2 -> V_188 ] ) ,
V_18 -> V_75 ) ;
V_2 -> V_188 += V_18 -> V_75 ;
...
V_205 | V_206 |
V_207 | V_208 ;
V_187 = F_113 ( V_2 -> V_5 . V_169 -> V_209 ,
...
unsigned int V_179 = F_100 ( V_215 -> V_179 ) ;
unsigned long V_53 ;
int V_220 = 0 ;
F_2 ( L_22 , V_3 , V_2 , V_179 ) ;
if ( V_179 == 0 ) {
...
V_62 = & V_83 -> V_62 ;
V_249 = F_134 ( V_62 ) ;
V_63 = F_135 ( V_16 , V_249 , V_249 -> V_77 ) ;
if ( ! V_63 ) {
...
int F_146 ( struct V_289 * V_166 , const void * V_149 , T_6 V_290 )
{
int V_187 ;
...
V_187 = F_93 ( V_2 , V_149 , V_290 ) ;
V_187 = F_139 ( V_2 , 0 , V_28 ) ;
}
F_10 ( & V_2 -> V_5 ) ;
return 0 ;
}
int F_148 ( struct V_289 * V_166 , struct V_291 * V_292 )
{
int V_187 ;
struct V_184 V_185 ;
enum V_186 V_43 ;
struct V_1 * V_2 = F_147 ( V_166 ) ;
struct V_293 * V_294 = F_149 ( V_166 -> V_295 ) ;
struct V_296 * V_169 = F_150 ( V_294 , V_292 -> V_297 ) ;
F_2 ( L_57 , V_3 , V_2 , V_2 -> V_25 ) ;
if ( F_33 ( & V_2 -> V_5 ) == V_177 ) {
V_187 = - V_67 ;
goto V_187;
...
F_85 ( F_33 ( & V_2 -> V_5 ) != V_213 ) ;
F_85 ( ! V_169 ) ;
if ( ( V_292 -> V_200 > V_169 -> V_209 -> V_281 . V_298 ) ||
( V_292 -> V_198 > V_169 -> V_209 -> V_281 . V_299 ) ) {
F_102 ( V_2 , NULL , V_28 ) ;
V_187 = - V_189 ;
goto V_187;
}
...
V_2 -> V_5 . V_166 = V_166 ;
V_2 -> V_5 . V_169 = V_169 ;
V_2 -> V_198 = V_292 -> V_198 ;
V_2 -> V_200 = V_292 -> V_200 ;
...
static int F_152 ( struct V_289 * V_166 )
{
struct V_302 * V_77 ;
...
int F_155 ( struct V_289 * V_166 , struct V_291 * V_292 )
{
struct V_293 * V_294 = F_149 ( V_166 -> V_295 ) ;
struct V_248 * V_249 ;
struct V_1 * V_2 ;
...
V_166 -> V_300 ( V_166 ) ;
V_2 -> V_5 . V_166 = V_166 ;
V_2 -> V_5 . V_169 = F_150 ( V_294 , V_292 -> V_297 ) ;
F_85 ( ! V_2 -> V_5 . V_169 ) ;
F_2 ( L_60 , V_3 , V_292 -> V_297 ,
V_2 -> V_5 . V_169 , V_166 ) ;
V_2 -> V_117 = F_156 ( V_294 -> V_22 . V_304 , & V_157 , V_2 ) ;
if ( V_2 -> V_117 == - 1 ) {
...
V_2 -> V_62 = & V_83 -> V_62 ;
V_249 = F_134 ( V_2 -> V_62 ) ;
V_2 -> V_63 = F_135 ( V_2 -> V_5 . V_16 , V_249 , V_249 -> V_77 ) ;
if ( ! V_2 -> V_63 ) {
...
int F_157 ( struct V_289 * V_166 , int V_309 )
{
int V_187 = 0 ;
struct V_293 * V_294 = F_149 ( V_166 -> V_295 ) ;
struct V_227 * V_2 ;
...
V_2 -> V_309 = V_309 ;
V_2 -> V_5 . V_118 = V_166 -> V_118 ;
V_2 -> V_230 = F_159 ( V_294 -> V_22 . V_304 , & V_157 , V_2 ) ;
if ( V_2 -> V_230 == - 1 ) {
F_8 (KERN_ERR MOD L_61 , __func__) ;
V_187 = - V_36 ;
goto V_305;
...
int F_139 ( struct V_1 * V_2 , int V_312 , T_3 V_58 )
{
int V_275 = 0 ;
unsigned long V_53 ;
int V_313 = 0 ;
...
int F_164 ( void * V_154 , struct V_250 * V_316 , struct V_250 * V_55 ,
struct V_19 * V_63 )
{
struct V_1 * V_2 = V_154 ;
if ( V_2 -> V_62 != V_316 )
...
struct V_15 * V_16 ;
int V_275 ;
while ( ( V_18 = F_167 ( & V_319 ) ) ) {
V_2 = * ( ( void * * ) ( V_18 -> V_320 ) ) ;
V_16 = * ( (struct V_15 * * ) ( V_18 -> V_320 + sizeof( void * ) ) ) ;
V_275 = V_321 [ F_168 ( F_99 ( ( V_322 T_4 ) V_18 -> V_323 ) ) ] ( V_16 , V_18 , V_2 ) ;
if ( V_275 & V_218 )
F_13 ( V_18 ) ;
