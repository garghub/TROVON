...
static V_71 F_58 ( struct V_55 * V_56 )
{
return 1 << V_56 -> V_75 ;
}
...
static void F_61 ( struct V_102 * V_103 , int V_106 )
{
struct V_107 * V_108 ;
unsigned long V_33 ;
void * V_109 ;
...
int V_112 = F_63 ( V_106 - V_110 , 0 ) ;
V_109 = F_64 ( V_108 , & V_33 ) ;
...
static struct V_102 * F_66 ( struct V_102 * * V_113 , struct V_102 * * V_114 ,
struct V_115 * * V_116 ,
int V_95 , T_3 V_117 )
{
...
( int ) V_118 -> V_124 ) ;
V_116 = F_69 ( V_118 , ( V_95 - V_121 ) / 512ULL ) ;
if ( ! V_116 )
goto V_123;
F_70 ( V_104 , & V_116 -> V_125 ) ;
* V_114 = & V_116 -> V_126 ;
} else {
F_70 ( V_104 , V_118 ) ;
* V_114 = V_118 -> V_105 ;
...
static void F_72 ( struct V_129 * V_130 )
{
F_22 ( V_130 ) ;
}
...
F_63 = V_141 = V_54 -> V_146 ;
while ( F_63 < V_54 -> V_121 && V_54 -> V_143 [ F_63 ] . V_93 )
F_63 ++ ;
for ( V_61 = V_141 ; V_61 < F_63 ; V_61 ++ ) {
F_76 ( V_137 , V_54 -> V_143 [ V_61 ] . V_144 ,
...
int V_21 , V_71 V_95 )
{
F_73 ( V_148 -> V_137 , V_148 -> V_54 , V_148 -> V_149 , V_21 , V_95 ) ;
}
...
F_81 ( & V_56 -> V_63 ) ;
V_148 = F_82 ( & V_3 -> V_27 -> V_170 , V_33 ,
V_65 ,
V_130 ,
false ,
V_134 , V_153 , V_102 ) ;
...
V_169 -> V_150 = F_84 ( V_177 ) ;
strncpy ( V_148 -> V_178 , V_151 , sizeof( V_148 -> V_178 ) ) ;
V_148 -> V_179 = strlen ( V_148 -> V_178 ) ;
V_162 = & V_148 -> V_180 ;
memset ( V_162 , 0 , sizeof( * V_162 ) ) ;
V_162 -> V_181 = F_85 ( 1 << V_182 ) ;
V_162 -> V_183 = F_85 ( 1 ) ;
V_162 -> V_184 = F_85 ( 1 << V_182 ) ;
V_162 -> V_185 = F_85 ( - 1 ) ;
V_162 -> V_186 = F_85 ( V_3 -> V_187 ) ;
F_86 ( & V_3 -> V_27 -> V_170 , V_162 , V_150 ,
V_94 , & V_95 , & V_163 , V_148 , V_130 ) ;
F_87 ( V_148 , V_94 , & V_95 ,
V_130 ,
V_65 ,
& V_165 ,
...
F_83 ( & V_56 -> V_63 ) ;
if ( V_159 ) {
F_88 ( & V_3 -> V_27 -> V_170 , V_148 ) ;
* V_159 = V_148 ;
}
V_21 = F_89 ( & V_3 -> V_27 -> V_170 , V_148 , false ) ;
if ( V_21 < 0 )
goto V_52;
if ( ! F_80 ) {
V_21 = F_90 ( & V_3 -> V_27 -> V_170 , V_148 ) ;
if ( V_160 )
...
F_91 ( V_148 ) ;
V_171:
F_78 ( V_167 , V_21 , V_95 ) ;
F_22 ( V_167 ) ;
return V_21 ;
}
static void F_92 ( struct V_156 * V_148 , struct V_157 * V_158 )
{
...
F_61 ( V_167 -> V_102 , V_145 ) ;
V_145 = V_167 -> V_95 ;
}
F_78 ( V_167 , V_144 , V_145 ) ;
if ( V_167 -> V_102 )
F_59 ( V_167 -> V_102 ) ;
F_91 ( V_148 ) ;
F_22 ( V_167 ) ;
}
static void F_94 ( struct V_156 * V_148 , struct V_157 * V_158 )
{
F_91 ( V_148 ) ;
}
...
T_4 V_133 ;
V_154 = F_96 ( V_94 , V_95 ) ;
V_153 = F_97 ( V_154 , V_23 ) ;
if ( F_16 ( V_153 ) )
return F_37 ( V_153 ) ;
if ( ! V_198 ) {
V_133 = ( V_33 & V_199 ? V_95 : 0 ) ;
V_21 = F_71 ( & V_130 , 1 , V_132 , V_133 ) ;
if ( V_21 < 0 )
goto V_93;
if ( ( V_33 & V_199 ) && V_109 ) {
V_21 = F_98 ( V_153 , V_109 , V_94 , V_95 ) ;
if ( V_21 < 0 )
goto V_200;
}
}
V_21 = F_79 ( NULL , V_3 , V_65 , V_150 ,
...
goto V_200;
if ( ( V_33 & V_201 ) && V_109 )
V_21 = F_99 ( V_153 , V_109 , V_94 , V_21 ) ;
V_200:
if ( ! V_198 )
F_72 ( V_130 ) ;
V_93:
...
goto V_93;
F_32 ( V_203 < V_95 ) ;
V_21 = F_79 ( V_137 , V_4 , V_65 , V_150 ,
V_96 , V_202 , V_203 ,
V_102 ,
NULL , 0 ,
V_33 ,
...
int V_149 )
{
return F_101 ( V_137 , V_4 , V_65 , V_177 ,
V_204 ,
V_199 | V_205 ,
2 ,
V_94 , V_95 , V_102 , V_54 , V_149 ) ;
}
static int F_103 ( struct V_136 * V_137 ,
struct V_1 * V_4 ,
V_71 V_150 ,
V_71 V_94 , V_71 V_95 ,
struct V_102 * V_102 ,
...
int V_21 ;
V_21 = F_71 ( & V_130 , 1 , V_207 , 0 ) ;
if ( V_21 < 0 )
return V_21 ;
V_130 [ 0 ] . V_208 . V_160 = F_84 ( V_3 -> V_56 . V_209 ) ;
V_130 [ 0 ] . V_208 . V_210 = V_206 ;
V_130 [ 0 ] . V_208 . V_211 = 0 ;
V_21 = F_79 ( NULL , V_3 , NULL , V_177 ,
V_151 , 0 , 0 , NULL ,
V_153 , 0 ,
V_201 ,
V_130 ,
...
static void F_106 ( V_71 V_160 , V_71 V_206 , T_6 V_132 , void * V_212 )
{
...
F_105 ( V_3 , V_160 , V_206 , V_3 -> V_213 ) ;
}
...
int V_21 = F_71 ( & V_130 , 1 , V_219 , 0 ) ;
if ( V_21 < 0 )
return V_21 ;
V_21 = F_112 ( V_170 , F_106 , 0 ,
( void * ) V_3 , & V_3 -> V_220 ) ;
if ( V_21 < 0 )
goto V_221;
V_130 [ 0 ] . V_208 . V_160 = F_84 ( V_160 ) ;
V_130 [ 0 ] . V_208 . V_210 = F_84 ( V_3 -> V_220 -> V_210 ) ;
...
static void F_115 ( V_71 V_160 , V_71 V_206 , T_6 V_132 , void * V_212 )
{
struct V_1 * V_3 = (struct V_1 * ) V_212 ;
if ( ! V_3 )
return;
...
int V_21 ;
V_21 = F_71 ( & V_130 , 1 , V_228 , V_133 ) ;
if ( V_21 < 0 )
return V_21 ;
V_227 . V_3 = V_3 ;
V_21 = F_112 ( V_170 , F_115 , 1 ,
( void * ) & V_227 , & V_225 ) ;
if ( V_21 < 0 )
goto V_221;
...
static int F_119 ( struct V_1 * V_3 ,
const char * V_151 ,
const char * V_235 ,
const char * V_236 ,
const char * V_212 ,
...
static struct V_53 * F_120 ( int V_247 )
{
struct V_53 * V_54 =
...
static void F_121 ( struct V_139 * V_140 )
{
...
V_253 = ( F_124 ( V_137 ) == V_259 ) ;
V_89 = F_125 ( V_137 ) ;
V_94 = F_126 ( V_137 ) * 512ULL ;
V_251 = V_137 -> V_102 ;
if ( V_253 && V_4 -> V_12 ) {
F_123 ( V_137 , - V_14 ) ;
goto V_114;
...
NULL , NULL ) ;
F_36 ( & V_54 -> V_25 ) ;
V_102 = F_66 ( & V_251 , & V_252 , & V_116 ,
V_254 , V_249 ) ;
if ( ! V_102 ) {
F_73 ( V_137 , V_54 , V_256 ,
- V_22 , V_254 ) ;
goto V_261;
}
if ( V_253 )
...
static int F_127 ( struct V_139 * V_140 , struct V_262 * V_263 ,
struct V_107 * V_264 )
{
struct V_1 * V_4 = V_140 -> V_250 ;
unsigned int V_265 = 1 << ( V_4 -> V_56 . V_75 - 9 ) ;
T_7 V_266 = V_263 -> V_267 + F_128 ( V_263 -> V_127 ) ;
...
static int F_134 ( struct V_1 * V_3 ,
const char * V_87 ,
T_3 V_60 )
{
...
if ( V_3 -> V_86 )
return - V_43 ;
V_21 = F_135 ( & V_3 -> V_27 -> V_276 , V_3 -> V_187 ,
& V_274 ) ;
F_11 ( L_30 , V_274 ) ;
if ( V_21 < 0 )
return V_21 ;
...
F_136 ( & V_90 , V_275 , V_87 , V_273 , V_277 ) ;
F_137 ( & V_90 , V_275 , V_274 , V_277 ) ;
V_21 = F_119 ( V_3 , V_3 -> V_213 , L_31 , L_32 ,
...
static void F_138 ( struct V_1 * V_4 )
{
struct V_279 * V_234 ;
while ( ! F_139 ( & V_4 -> V_83 ) ) {
V_234 = F_140 ( & V_4 -> V_83 , struct V_279 , V_26 ) ;
F_141 ( V_4 , V_234 ) ;
}
}
...
V_71 V_80 ;
int V_281 = 0 ;
V_21 = F_133 ( V_4 , & V_280 ) ;
if ( V_21 < 0 )
return V_21 ;
F_142 ( V_4 -> V_9 , V_280 . V_74 / 512ULL ) ;
F_52 ( & V_4 -> V_56 . V_63 ) ;
...
static int F_144 ( struct V_1 * V_4 )
{
struct V_8 * V_9 ;
struct V_139 * V_140 ;
int V_144 ;
V_71 V_282 = 0 ;
V_144 = F_133 ( V_4 , & V_4 -> V_56 ) ;
if ( V_144 )
return V_144 ;
V_144 = F_143 ( V_4 ) ;
if ( V_144 )
...
V_9 -> V_11 = V_4 ;
V_144 = - V_22 ;
V_140 = F_146 ( F_121 , & V_4 -> V_289 ) ;
if ( ! V_140 )
goto V_290;
F_147 ( V_140 , F_58 ( & V_4 -> V_56 ) / 512ULL ) ;
F_148 ( V_140 , F_58 ( & V_4 -> V_56 ) ) ;
F_149 ( V_140 , F_58 ( & V_4 -> V_56 ) ) ;
F_150 ( V_140 , F_58 ( & V_4 -> V_56 ) ) ;
F_151 ( V_140 , F_127 ) ;
V_9 -> V_270 = V_140 ;
V_140 -> V_250 = V_4 ;
V_4 -> V_9 = V_9 ;
V_4 -> V_140 = V_140 ;
F_142 ( V_9 , V_282 / 512ULL ) ;
F_152 ( V_9 ) ;
F_153 ( L_34 ,
...
static T_8 F_156 ( struct V_2 * V_3 ,
struct V_291 * V_292 , char * V_109 )
{
struct V_1 * V_4 = F_1 ( V_3 ) ;
return sprintf ( V_109 , L_37 , F_157 ( V_4 -> V_27 ) ) ;
}
...
static T_8 F_161 ( struct V_2 * V_3 ,
struct V_291 * V_292 ,
const char * V_109 ,
T_9 V_89 )
{
...
static T_8 F_164 ( struct V_2 * V_3 ,
struct V_291 * V_292 ,
char * V_109 )
{
struct V_279 * V_234 = F_2 ( V_3 , struct V_279 , V_3 ) ;
...
static int F_167 ( struct V_1 * V_4 ,
struct V_279 * V_234 ,
struct V_2 * V_295 )
{
...
const char * F_173 ( const char * V_294 , const char * V_300 )
{
if ( V_294 < V_300 + 2 )
return NULL ;
V_294 -= 2 ;
...
F_174 (p, n, &rbd_dev->snaps) {
V_71 V_305 ;
V_302 = F_175 ( V_90 , struct V_279 , V_26 ) ;
if ( V_61 )
...
if ( V_302 -> V_84 == V_305 ) {
V_61 -- ;
V_294 = F_173 ( V_294 , V_301 ) ;
continue;
}
for (; V_61 > 0 ;
V_61 -- , V_294 = F_173 ( V_294 , V_301 ) ) {
if ( ! V_294 ) {
F_93 ( 1 ) ;
return - V_43 ;
}
...
if ( V_305 >= V_302 -> V_84 )
break;
V_21 = F_170 ( V_4 , V_61 - 1 , V_294 , & V_234 ) ;
if ( V_21 < 0 )
return V_21 ;
F_176 ( & V_234 -> V_26 , V_304 ) ;
V_90 = & V_234 -> V_26 ;
}
}
for (; V_61 > 0 ; V_61 -- ) {
...
static int F_178 ( struct V_1 * V_4 )
{
int V_21 = - V_22 ;
struct V_2 * V_3 ;
struct V_279 * V_234 ;
...
static void F_179 ( struct V_1 * V_4 )
{
F_166 ( & V_4 -> V_3 ) ;
}
...
static T_8 F_181 ( struct V_312 * V_306 ,
const char * V_109 ,
T_9 V_313 )
{
struct V_218 * V_170 ;
...
F_14 ( & V_4 -> V_83 ) ;
F_107 ( & V_214 , V_215 ) ;
F_184 (tmp, &rbd_dev_list) {
struct V_1 * V_4 ;
V_4 = F_175 ( V_104 , struct V_1 , V_26 ) ;
if ( V_4 -> V_84 >= V_315 )
V_315 = V_4 -> V_84 + 1 ;
}
V_4 -> V_84 = V_315 ;
F_19 ( & V_4 -> V_26 , & V_323 ) ;
if ( sscanf ( V_109 , L_41 F_185 ( V_319 ) L_42
L_41 F_185 ( V_319 ) L_42
L_41 F_185 ( V_324 ) L_42
L_41 F_185 ( V_325 ) L_43
L_41 F_185 ( V_326 ) L_43 ,
...
V_144 = F_186 ( V_170 -> V_331 , V_4 -> V_293 ) ;
if ( V_144 < 0 )
goto V_332;
V_4 -> V_187 = V_144 ;
V_314 = F_187 ( 0 , V_4 -> V_294 ) ;
if ( V_314 < 0 ) {
V_144 = V_314 ;
goto V_332;
}
...
static struct V_1 * F_191 ( unsigned long V_84 )
{
struct V_303 * V_104 ;
struct V_1 * V_4 ;
F_184 (tmp, &rbd_dev_list) {
...
static T_8 F_193 ( struct V_312 * V_306 ,
const char * V_109 ,
T_9 V_313 )
{
struct V_1 * V_4 = NULL ;
...
static T_8 F_195 ( struct V_2 * V_3 ,
struct V_291 * V_292 ,
const char * V_109 ,
T_9 V_313 )
{
...
static T_8 F_196 ( struct V_2 * V_3 ,
struct V_291 * V_292 ,
const char * V_109 ,
T_9 V_313 )
{
...
return V_144 ;
F_183 ( & V_30 ) ;
F_153 ( L_50 V_342 L_51 ) ;
return 0 ;
}
void T_11 F_202 ( void )
{
F_199 () ;
}
