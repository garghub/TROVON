...
F_19 ( V_40 -> V_67 , V_42 , 0 ) ;
}
}
static void
F_20 ( struct V_68 * V_69 , int V_70 ,
...
V_40 . V_67 = V_67 ;
V_40 . V_41 = 0 ;
F_22 ( V_69 -> V_74 , V_75 , F_9 ,
& V_40 ) ;
if ( ! V_40 . V_41 )
return;
V_73 = sizeof( * V_40 . V_42 ) * V_40 . V_41 ;
V_40 . V_42 = F_23 ( V_73 , V_76 ) ;
if ( ! V_40 . V_42 )
goto V_77;
V_40 . V_53 = F_24 ( V_76 , L_13 , V_71 , V_70 ) ;
if ( ! V_40 . V_53 )
goto V_78;
V_40 . V_41 = 0 ;
F_22 ( V_69 -> V_74 , V_75 , F_10 ,
& V_40 ) ;
F_17 ( & V_40 ) ;
return;
V_78:
...
struct V_72 * T_6 F_26 ( struct V_79 * V_63 )
{
...
V_67 = F_35 ( NULL , V_70 , & V_89 , V_83 ) ;
if ( V_67 ) {
F_20 ( V_69 , V_70 , V_71 , V_67 ) ;
V_67 -> V_90 = F_36 ( V_67 ) ;
}
}
if ( V_67 ) {
struct V_72 * V_54 ;
F_37 (child, &bus->children, node) {
struct V_91 * V_92 = V_54 -> V_92 ;
if ( ! V_92 )
continue;
F_38 ( V_54 , V_92 -> V_93 ) ;
}
