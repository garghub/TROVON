...
V_103 = V_100 . V_113 ;
V_104 = F_55 ( & V_100 ) ;
if ( ! F_56 ( V_34 , V_103 , V_104 , V_114 ) ) {
F_42 ( V_34 , L_17 ) ;
return - V_90 ;
}
V_8 -> V_9 = F_57 ( V_34 , V_103 , V_104 ) ;
if ( ! V_8 -> V_9 ) {
F_42 ( V_34 , L_18 ) ;
return - V_45 ;
}
...
F_65 ( & V_8 -> V_29 ) ;
V_107 = F_66 ( V_34 , V_8 -> V_25 , & F_14 , 0 , V_114 ,
V_2 ) ;
if ( V_107 ) {
F_42 ( V_34 , L_26 ) ;
goto error;
}
if ( F_67 ( V_2 , F_68 ( V_105 ) ) ) {
F_42 ( V_34 , L_27 ) ;
...
F_70 ( V_34 , V_2 ) ;
V_107 = F_71 ( V_2 , V_145 , & V_102 , 0 ) ;
#ifdef F_72
if ( V_107 == 0 )
V_107 = F_73 ( V_34 , V_43 , & V_102 ) ;
#endif
if ( V_107 < 0 ) {
F_42 ( V_34 , L_29 ) ;
F_69 ( V_34 , V_8 -> V_25 , V_2 ) ;
...
static int T_9 F_75 ( struct V_95 * V_96 )
{
struct V_93 * V_34 = & V_96 -> V_34 ;
...
static int T_10 F_78 ( void )
{
return F_79 ( & V_146 ) ;
}
static void T_11 F_80 ( void )
{
F_81 ( & V_146 ) ;
}
