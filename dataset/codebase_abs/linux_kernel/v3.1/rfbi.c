...
F_51 ( V_34 , V_23 , V_24 , V_17 , V_25 , true ) ;
F_25 ( V_34 -> V_40 -> V_41 , * V_17 , * V_25 ) ;
}
return 0 ;
}
int F_52 ( struct V_33 * V_34 ,
T_3 V_23 , T_3 V_24 , T_3 V_17 , T_3 V_25 ,
...
F_20 ( V_126 , V_22 , V_23 , V_24 , V_17 , V_25 ) ;
F_24 ( V_37 ) ;
}
return 0 ;
}
void F_53 ( struct V_131 * V_132 )
{
#define F_54 ( V_6 ) seq_printf(s, "%-35s %08x\n", #r, rfbi_read_reg(r))
if ( F_5 () )
return;
F_54 ( V_133 ) ;
F_54 ( V_134 ) ;
...
F_59 ( V_34 -> V_40 -> V_41 ,
V_142 ) ;
F_60 ( V_34 -> V_40 -> V_41 , V_34 -> V_143 . V_114 ) ;
...
static int F_65 ( struct V_145 * V_7 )
{
T_1 V_146 ;
struct V_147 * V_148 ;
struct V_149 * V_149 ;
...
V_4 . V_7 = V_7 ;
F_66 ( & V_4 . V_9 , 1 ) ;
V_148 = F_67 ( V_4 . V_7 , V_150 , 0 ) ;
if ( ! V_148 ) {
F_38 ( L_20 ) ;
V_6 = - V_93 ;
goto V_151;
}
V_4 . V_5 = F_68 ( V_148 -> V_152 , F_69 ( V_148 ) ) ;
if ( ! V_4 . V_5 ) {
F_38 ( L_21 ) ;
V_6 = - V_153 ;
goto V_151;
...
V_149 = F_76 ( & V_7 -> V_8 , L_22 ) ;
if ( F_77 ( V_149 ) ) {
F_38 ( L_23 ) ;
V_6 = F_78 ( V_149 ) ;
goto V_155;
}
V_4 . V_47 = F_79 ( V_149 ) / 1000 ;
F_80 ( V_149 ) ;
V_146 = F_3 ( V_133 ) ;
F_81 ( & V_7 -> V_8 , L_24 ,
F_82 ( V_146 , 7 , 4 ) , F_82 ( V_146 , 3 , 0 ) ) ;
F_9 () ;
return 0 ;
V_155:
F_9 () ;
...
static int F_85 ( struct V_145 * V_7 )
{
F_83 ( & V_7 -> V_8 ) ;
F_84 ( V_4 . V_5 ) ;
return 0 ;
}
static int F_86 ( struct V_156 * V_8 )
{
F_87 () ;
F_88 () ;
return 0 ;
}
static int F_89 ( struct V_156 * V_8 )
{
int V_6 ;
V_6 = F_90 () ;
if ( V_6 < 0 )
