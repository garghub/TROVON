...
unsigned long V_111 ;
V_81 = V_49 -> V_15 ;
F_79 ( & V_49 -> V_112 , V_111 ) ;
F_94 ( V_49 -> V_113 + V_114 , F_82 ( V_81 ) ) ;
F_95 ( V_49 -> V_115 | V_116 , V_49 -> V_113 + V_117 ) ;
F_96 ( V_49 , V_118 ,
V_119 , ( V_110 & V_120 ) , V_110 ) ;
F_80 ( & V_49 -> V_112 , V_111 ) ;
}
static void F_97 ( struct V_48 * V_49 )
{
T_3 V_17 ;
unsigned long V_111 ;
if ( ! V_121 && ! F_98 ( V_49 -> V_52 ) )
return;
F_79 ( & V_49 -> V_112 , V_111 ) ;
F_95 ( V_49 -> V_115 | V_122 , V_49 -> V_113 + V_117 ) ;
F_96 ( V_49 , V_118 ,
...
break;
case V_128 :
V_17 = V_128 | F_100 ( V_124 ) ;
break;
case V_129 :
V_17 = V_129 | F_100 ( V_124 )
| F_101 ( V_125 ) | F_102 ( V_126 ) ;
break;
default:
F_103 () ;
}
V_17 |= V_130 ;
F_79 ( & V_49 -> V_112 , V_111 ) ;
F_94 ( V_49 -> V_113 + V_131 , V_17 ) ;
F_96 ( V_49 , V_131 ,
V_132 , ( ! ( V_17 & V_130 ) ) , V_17 ) ;
F_80 ( & V_49 -> V_112 , V_111 ) ;
}
static void F_104 ( struct V_48 * V_49 , T_4 V_124 ,
V_23 V_81 , unsigned int V_133 , V_23 type )
{
int V_134 = F_105 ( V_49 -> V_66 ) ;
V_23 V_17 = 0 , V_135 = 0 ;
unsigned long V_111 ;
switch ( type ) {
case V_136 :
...
break;
case V_138 :
V_17 = V_138 | V_137 | F_106 ( V_124 ) ;
break;
case V_139 :
V_17 = V_139 | V_137 | F_106 ( V_124 ) ;
V_135 = V_133 | V_81 ;
break;
default:
F_103 () ;
...
F_79 ( & V_49 -> V_112 , V_111 ) ;
if ( V_135 )
F_94 ( V_49 -> V_113 + V_134 , V_135 ) ;
F_94 ( V_49 -> V_113 + V_134 + 8 , V_17 ) ;
F_96 ( V_49 , V_134 + 8 ,
V_132 , ( ! ( V_17 & V_137 ) ) , V_17 ) ;
F_80 ( & V_49 -> V_112 , V_111 ) ;
if ( F_108 ( V_17 ) == 0 )
F_42 ( V_141 L_14 ) ;
if ( F_108 ( V_17 ) != F_109 ( type ) )
F_110 ( L_15 ,
( unsigned long long ) F_109 ( type ) ,
( unsigned long long ) F_108 ( V_17 ) ) ;
}
static struct V_142 * F_111 (
...
return NULL ;
F_79 ( & V_146 , V_58 ) ;
F_113 (info, &domain->devices, link)
...
return NULL ;
if ( ! F_114 ( V_144 -> V_147 , V_148 ) )
return NULL ;
if ( ! F_115 ( V_144 -> V_147 ) )
return NULL ;
V_144 -> V_49 = V_49 ;
return V_144 ;
}
...
if ( ! V_144 )
return;
F_117 ( V_144 -> V_147 , V_10 ) ;
}
static void F_118 ( struct V_142 * V_144 )
{
if ( ! V_144 -> V_147 || ! F_119 ( V_144 -> V_147 ) )
return;
F_120 ( V_144 -> V_147 ) ;
}
static void F_121 ( struct V_55 * V_56 ,
...
V_150 = F_122 ( V_144 -> V_147 ) ;
F_123 ( V_144 -> V_49 , V_149 , V_150 , V_81 , V_70 ) ;
}
F_80 ( & V_146 , V_58 ) ;
}
static void F_124 ( struct V_48 * V_49 , T_4 V_124 ,
unsigned long V_5 , unsigned int V_151 , int V_152 )
{
unsigned int V_70 = F_125 ( F_126 ( V_151 ) ) ;
V_31 V_81 = ( V_31 ) V_5 << V_10 ;
F_62 ( V_151 == 0 ) ;
if ( ! F_127 ( V_49 -> V_52 ) || V_70 > F_128 ( V_49 -> V_52 ) )
V_49 -> V_153 . V_154 ( V_49 , V_124 , 0 , 0 ,
V_138 ) ;
else
V_49 -> V_153 . V_154 ( V_49 , V_124 , V_81 , V_70 ,
V_139 ) ;
if ( ! F_129 ( V_49 -> V_52 ) || ! V_152 )
F_121 ( V_49 -> V_155 [ V_124 ] , V_81 , V_70 ) ;
}
static void F_130 ( struct V_48 * V_49 )
{
T_3 V_156 ;
unsigned long V_58 ;
F_79 ( & V_49 -> V_112 , V_58 ) ;
V_156 = V_119 ( V_49 -> V_113 + V_157 ) ;
V_156 &= ~ V_158 ;
F_95 ( V_156 , V_49 -> V_113 + V_157 ) ;
F_96 ( V_49 , V_157 ,
V_119 , ! ( V_156 & V_159 ) , V_156 ) ;
F_80 ( & V_49 -> V_112 , V_58 ) ;
}
...
F_79 ( & V_49 -> V_112 , V_58 ) ;
V_49 -> V_115 |= V_160 ;
F_95 ( V_49 -> V_115 , V_49 -> V_113 + V_117 ) ;
F_96 ( V_49 , V_118 ,
...
unsigned long V_162 ;
unsigned long V_163 ;
V_162 = F_134 ( V_49 -> V_52 ) ;
F_110 ( L_16 , V_49 -> V_164 ,
V_162 ) ;
V_163 = F_135 ( V_162 ) ;
F_136 ( & V_49 -> V_84 ) ;
V_49 -> V_165 = F_137 ( V_163 , sizeof( unsigned long ) , V_166 ) ;
if ( ! V_49 -> V_165 ) {
F_42 ( V_141 L_17 ) ;
return - V_108 ;
}
V_49 -> V_155 = F_137 ( V_162 , sizeof( struct V_55 * ) ,
V_166 ) ;
if ( ! V_49 -> V_155 ) {
F_42 ( V_141 L_18 ) ;
return - V_108 ;
...
F_132 ( V_49 ) ;
if ( V_49 -> V_169 ) {
F_143 ( V_49 -> V_169 , NULL ) ;
F_144 ( V_49 -> V_169 , V_49 ) ;
F_145 ( V_49 -> V_169 ) ;
}
F_146 ( V_49 -> V_155 ) ;
F_146 ( V_49 -> V_165 ) ;
...
static int F_148 ( struct V_55 * V_56 ,
struct V_48 * V_49 )
{
int V_170 ;
unsigned long V_162 ;
...
static void F_157 ( struct V_55 * V_56 )
{
F_158 ( & V_174 , & V_56 -> V_187 ) ;
}
static inline int F_159 ( int V_107 )
{
int V_1 ;
...
static int F_160 ( struct V_55 * V_56 , int V_188 )
{
struct V_48 * V_49 ;
int V_189 , V_1 ;
unsigned long V_51 ;
F_152 ( & V_56 -> V_187 , V_175 ) ;
F_136 ( & V_56 -> V_167 ) ;
F_157 ( V_56 ) ;
V_49 = F_61 ( V_56 ) ;
if ( V_188 > F_161 ( V_49 -> V_52 ) )
V_188 = F_161 ( V_49 -> V_52 ) ;
V_56 -> V_107 = V_188 ;
V_189 = F_159 ( V_188 ) ;
V_1 = F_3 ( V_189 ) ;
V_51 = F_57 ( V_49 -> V_52 ) ;
...
static int F_167 ( struct V_55 * V_56 , int V_72 ,
...
F_27 ( V_21 , V_171 ) ;
if ( V_191 != V_192 ) {
V_144 = F_111 ( V_56 , V_72 , V_73 , V_74 ) ;
V_191 = V_144 ? V_195 :
V_193 ;
}
if ( F_170 ( V_191 == V_192 ) )
...
static int
F_172 ( struct V_55 * V_56 , struct V_172 * V_173 ,
int V_191 )
{
int V_86 ;
struct V_172 * V_106 , * V_91 ;
V_86 = F_167 ( V_56 , F_173 ( V_173 -> V_73 ) ,
...
static int F_176 ( struct V_172 * V_173 )
{
int V_86 ;
struct V_172 * V_106 , * V_91 ;
struct V_48 * V_49 ;
V_49 = F_74 ( F_173 ( V_173 -> V_73 ) , V_173 -> V_73 -> V_78 ,
V_173 -> V_74 ) ;
if ( ! V_49 )
return - V_180 ;
...
static inline unsigned long F_177 ( unsigned long V_200 ,
T_5 V_82 )
{
V_200 &= ~ V_201 ;
return F_178 ( V_200 + V_82 ) >> V_10 ;
}
static inline int F_179 ( struct V_55 * V_56 ,
unsigned long V_202 ,
unsigned long V_203 ,
unsigned long V_151 )
{
...
static int F_180 ( struct V_55 * V_56 , unsigned long V_202 ,
...
V_31 V_106 ;
if ( ! V_213 ) {
V_213 = F_177 ( V_209 -> V_92 , V_209 -> V_216 ) ;
V_209 -> V_217 = ( ( V_218 ) V_202 << V_10 ) + V_209 -> V_92 ;
V_209 -> V_219 = V_209 -> V_216 ;
V_96 = F_181 ( F_182 ( V_209 ) ) | V_30 ;
V_210 = V_96 >> V_10 ;
}
if ( ! V_26 ) {
V_214 = F_179 ( V_56 , V_202 , V_210 , V_213 ) ;
...
V_106 = F_183 ( & V_26 -> V_17 , 0ULL , V_96 ) ;
if ( V_106 ) {
static int V_220 = 5 ;
F_42 ( V_221 L_24 ,
...
int V_30 )
{
return F_180 ( V_56 , V_202 , V_209 , 0 , V_211 , V_30 ) ;
}
static inline int F_188 ( struct V_55 * V_56 , unsigned long V_202 ,
unsigned long V_210 , unsigned long V_211 ,
int V_30 )
{
return F_180 ( V_56 , V_202 , NULL , V_210 , V_211 , V_30 ) ;
}
static void F_189 ( struct V_48 * V_49 , T_2 V_73 , T_2 V_74 )
{
if ( ! V_49 )
return;
F_84 ( V_49 , V_73 , V_74 ) ;
...
static void F_165 ( struct V_55 * V_56 )
{
struct V_142 * V_144 ;
unsigned long V_58 ;
struct V_48 * V_49 ;
F_79 ( & V_146 , V_58 ) ;
while ( ! F_190 ( & V_56 -> V_77 ) ) {
V_144 = F_191 ( V_56 -> V_77 . V_222 ,
struct V_142 , V_223 ) ;
F_192 ( & V_144 -> V_223 ) ;
F_192 ( & V_144 -> V_224 ) ;
if ( V_144 -> V_147 )
...
F_189 ( V_49 , V_144 -> V_73 , V_144 -> V_74 ) ;
F_53 ( V_144 ) ;
F_79 ( & V_146 , V_58 ) ;
}
F_80 ( & V_146 , V_58 ) ;
...
static struct V_55 * F_194 ( struct V_172 * V_173 , int V_107 )
{
...
F_79 ( & V_146 , V_58 ) ;
F_113 (info, &device_domain_list, global) {
if ( V_144 -> V_72 == V_72 &&
...
V_143 = NULL ;
F_79 ( & V_146 , V_58 ) ;
F_113 (tmp, &device_domain_list, global) {
if ( V_106 -> V_72 == V_72 &&
...
F_197 ( & V_144 -> V_223 , & V_56 -> V_77 ) ;
F_197 ( & V_144 -> V_224 , & V_229 ) ;
F_80 ( & V_146 , V_58 ) ;
}
}
V_227:
...
struct V_55 * V_56 ;
int V_86 ;
V_56 = F_194 ( V_173 , V_54 ) ;
if ( ! V_56 )
return - V_108 ;
if ( V_56 == V_232 && V_233 ) {
F_42 ( L_28 ,
F_196 ( V_173 ) , V_185 , V_186 ) ;
return 0 ;
}
F_42 ( V_35
L_29 ,
...
V_86 = F_198 ( V_56 , V_185 , V_186 ) ;
if ( V_86 )
goto error;
V_86 = F_172 ( V_56 , V_173 , V_193 ) ;
if ( V_86 )
goto error;
return 0 ;
error:
...
static inline int F_202 ( struct V_238 * V_239 ,
struct V_172 * V_173 )
{
if ( V_173 -> V_147 . V_225 . V_49 == V_240 )
return 0 ;
return F_199 ( V_173 , V_239 -> V_241 ,
V_239 -> V_242 ) ;
}
static inline void F_203 ( void )
{
struct V_172 * V_173 ;
int V_86 ;
V_173 = F_204 ( V_243 << 8 , NULL ) ;
if ( ! V_173 )
return;
F_42 ( V_35 L_33 ) ;
V_86 = F_199 ( V_173 , 0 , 16 * 1024 * 1024 - 1 ) ;
if ( V_86 )
F_42 ( V_141 L_34
L_35 ) ;
}
...
static int T_1 F_205 ( unsigned long V_102 ,
...
static int T_1 F_206 ( int V_246 )
{
struct V_68 * V_69 ;
struct V_48 * V_49 ;
int V_97 , V_86 = 0 ;
...
if ( ! V_232 )
return - V_194 ;
F_110 ( L_36 , V_232 -> V_171 ) ;
F_70 (iommu, drhd) {
V_86 = F_148 ( V_232 , V_49 ) ;
if ( V_86 ) {
F_142 ( V_232 ) ;
return - V_194 ;
}
...
return 0 ;
F_208 (nid) {
F_209 ( V_97 , F_205 , & V_86 ) ;
if ( V_86 )
return V_86 ;
}
return 0 ;
}
static int F_210 ( struct V_172 * V_173 )
{
struct V_142 * V_144 ;
if ( F_211 ( ! V_247 ) )
return 0 ;
...
if ( ! V_144 )
return - V_108 ;
V_86 = F_172 ( V_56 , V_173 , V_191 ) ;
if ( V_86 ) {
F_53 ( V_144 ) ;
return V_86 ;
}
V_144 -> V_72 = F_173 ( V_173 -> V_73 ) ;
V_144 -> V_73 = V_173 -> V_73 -> V_78 ;
V_144 -> V_74 = V_173 -> V_74 ;
V_144 -> V_147 = V_173 ;
V_144 -> V_56 = V_56 ;
...
static int F_213 ( struct V_172 * V_173 , int V_248 )
{
if ( ( V_247 & V_249 ) && F_214 ( V_173 ) )
return 1 ;
if ( ( V_247 & V_250 ) && F_215 ( V_173 ) )
return 1 ;
if ( ! ( V_247 & V_251 ) )
return 0 ;
if ( ! F_175 ( V_173 ) ) {
...
return V_256 >= F_217 ( & V_173 -> V_147 ) ;
}
return 1 ;
}
static int T_1 F_218 ( int V_246 )
{
struct V_172 * V_173 = NULL ;
int V_86 ;
V_86 = F_206 ( V_246 ) ;
...
if ( F_213 ( V_173 , 1 ) ) {
F_42 ( V_35 L_37 ,
V_246 ? L_38 : L_39 , F_196 ( V_173 ) ) ;
V_86 = F_212 ( V_232 , V_173 ,
V_246 ? V_192 :
V_193 ) ;
if ( V_86 )
return V_86 ;
...
V_63 = F_137 ( V_62 , sizeof( struct V_48 * ) ,
V_166 ) ;
if ( ! V_63 ) {
F_42 ( V_141 L_40 ) ;
V_86 = - V_108 ;
...
V_49 = V_69 -> V_49 ;
if ( F_225 ( V_49 ) ) {
V_49 -> V_153 . V_197 = F_99 ;
V_49 -> V_153 . V_154 = F_104 ;
F_42 ( V_35 L_42
L_43 ,
V_49 -> V_164 ,
...
static struct V_46 * F_231 ( struct V_265 * V_147 ,
struct V_55 * V_56 ,
unsigned long V_266 , V_31 V_256 )
{
struct V_172 * V_173 = F_232 ( V_147 ) ;
struct V_46 * V_46 = NULL ;
V_256 = F_233 ( V_31 , F_234 ( V_56 -> V_107 ) , V_256 ) ;
if ( ! V_37 && V_256 > F_235 ( 32 ) ) {
V_46 = F_236 ( & V_56 -> V_187 , V_266 ,
F_155 ( F_235 ( 32 ) ) , 1 ) ;
if ( V_46 )
return V_46 ;
}
V_46 = F_236 ( & V_56 -> V_187 , V_266 , F_155 ( V_256 ) , 1 ) ;
if ( F_170 ( ! V_46 ) ) {
F_42 ( V_141 L_48 ,
V_266 , F_196 ( V_173 ) ) ;
return NULL ;
...
static struct V_55 * F_237 ( struct V_172 * V_173 )
{
struct V_55 * V_56 ;
int V_86 ;
V_56 = F_194 ( V_173 ,
...
if ( F_170 ( ! F_176 ( V_173 ) ) ) {
V_86 = F_172 ( V_56 , V_173 ,
V_193 ) ;
if ( V_86 ) {
F_42 ( V_141
L_50 ,
...
static inline struct V_55 * F_238 ( struct V_172 * V_147 )
{
struct V_142 * V_144 ;
...
static int F_239 ( struct V_172 * V_173 )
{
return V_173 -> V_147 . V_225 . V_49 == V_240 ;
}
static int F_240 ( struct V_265 * V_147 )
{
struct V_172 * V_173 ;
int V_143 ;
if ( F_170 ( V_147 -> V_73 != & V_267 ) )
return 1 ;
V_173 = F_232 ( V_147 ) ;
if ( F_239 ( V_173 ) )
return 1 ;
...
static V_218 F_242 ( struct V_265 * V_268 , T_6 V_269 ,
T_5 V_82 , int V_270 , V_23 V_256 )
{
struct V_172 * V_173 = F_232 ( V_268 ) ;
struct V_55 * V_56 ;
T_6 V_271 ;
struct V_46 * V_46 ;
int V_30 = 0 ;
...
return 0 ;
V_49 = F_61 ( V_56 ) ;
V_82 = F_177 ( V_269 , V_82 ) ;
V_46 = F_231 ( V_268 , V_56 , F_10 ( V_82 ) , V_256 ) ;
if ( ! V_46 )
goto error;
...
V_30 |= V_28 ;
V_86 = F_188 ( V_56 , F_11 ( V_46 -> V_277 ) ,
F_11 ( V_272 ) , V_82 , V_30 ) ;
if ( V_86 )
goto error;
if ( F_129 ( V_49 -> V_52 ) )
F_124 ( V_49 , V_56 -> V_171 , F_11 ( V_46 -> V_277 ) , V_82 , 1 ) ;
else
F_97 ( V_49 ) ;
...
error:
if ( V_46 )
F_244 ( & V_56 -> V_187 , V_46 ) ;
F_42 ( V_141 L_53 ,
F_196 ( V_173 ) , V_82 , ( unsigned long long ) V_269 , V_270 ) ;
return 0 ;
}
static V_218 F_245 ( struct V_265 * V_147 , struct V_12 * V_12 ,
unsigned long V_92 , T_5 V_82 ,
enum V_278 V_270 ,
struct V_279 * V_280 )
{
return F_242 ( V_147 , F_181 ( V_12 ) + V_92 , V_82 ,
V_270 , F_232 ( V_147 ) -> V_256 ) ;
}
...
if ( F_129 ( V_49 -> V_52 ) )
F_124 ( V_49 , V_56 -> V_171 ,
V_46 -> V_277 , V_46 -> V_283 - V_46 -> V_277 + 1 , 0 ) ;
else {
V_70 = F_125 ( F_11 ( V_46 -> V_283 - V_46 -> V_277 + 1 ) ) ;
F_121 ( V_258 [ V_64 ] . V_56 [ V_281 ] ,
( V_31 ) V_46 -> V_277 << V_9 , V_70 ) ;
}
F_244 ( & V_258 [ V_64 ] . V_56 [ V_281 ] -> V_187 , V_46 ) ;
}
V_258 [ V_64 ] . V_222 = 0 ;
}
V_284 = 0 ;
}
static void F_164 ( unsigned long V_285 )
{
unsigned long V_58 ;
F_79 ( & V_286 , V_58 ) ;
F_246 () ;
...
static void F_247 ( struct V_55 * V_287 , struct V_46 * V_46 )
{
unsigned long V_58 ;
int V_222 , V_57 ;
struct V_48 * V_49 ;
...
V_258 [ V_57 ] . V_222 ++ ;
if ( ! V_282 ) {
F_248 ( & V_289 , V_290 + F_249 ( 10 ) ) ;
V_282 = 1 ;
}
V_284 ++ ;
F_80 ( & V_286 , V_58 ) ;
}
static void F_250 ( struct V_265 * V_147 , V_218 V_291 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_251 ( & V_56 -> V_187 , F_155 ( V_291 ) ) ;
if ( F_252 ( ! V_46 , L_54 ,
...
F_110 ( L_55 ,
F_196 ( V_173 ) , V_102 , V_103 ) ;
F_89 ( V_56 , V_102 , V_103 ) ;
F_90 ( V_56 , V_102 , V_103 ) ;
if ( V_38 ) {
F_124 ( V_49 , V_56 -> V_171 , V_102 ,
V_103 - V_102 + 1 , 0 ) ;
F_244 ( & V_56 -> V_187 , V_46 ) ;
} else {
F_247 ( V_56 , V_46 ) ;
...
static void * F_253 ( struct V_265 * V_268 , T_5 V_82 ,
...
if ( ! F_240 ( V_268 ) )
V_58 &= ~ ( V_293 | V_294 ) ;
else if ( V_268 -> V_257 < F_217 ( V_268 ) ) {
if ( V_268 -> V_257 < F_235 ( 32 ) )
V_58 |= V_293 ;
else
V_58 |= V_294 ;
}
V_41 = ( void * ) F_255 ( V_58 , V_105 ) ;
if ( ! V_41 )
return NULL ;
memset ( V_41 , 0 , V_82 ) ;
* V_292 = F_242 ( V_268 , F_256 ( V_41 ) , V_82 ,
V_275 ,
V_268 -> V_257 ) ;
if ( * V_292 )
return V_41 ;
F_257 ( ( unsigned long ) V_41 , V_105 ) ;
return NULL ;
}
static void F_258 ( struct V_265 * V_268 , T_5 V_82 , void * V_41 ,
V_218 V_292 )
{
int V_105 ;
V_82 = F_178 ( V_82 ) ;
V_105 = F_254 ( V_82 ) ;
F_250 ( V_268 , V_292 , V_82 , V_275 , NULL ) ;
F_257 ( ( unsigned long ) V_41 , V_105 ) ;
}
static void F_259 ( struct V_265 * V_268 , struct V_208 * V_295 ,
...
F_62 ( ! V_56 ) ;
V_49 = F_61 ( V_56 ) ;
V_46 = F_251 ( & V_56 -> V_187 , F_155 ( V_295 [ 0 ] . V_217 ) ) ;
if ( F_252 ( ! V_46 , L_56 ,
...
static int F_260 ( struct V_265 * V_297 ,
struct V_208 * V_295 , int V_296 , int V_270 )
{
int V_64 ;
struct V_208 * V_209 ;
F_261 (sglist, sg, nelems, i) {
F_62 ( ! F_182 ( V_209 ) ) ;
V_209 -> V_217 = F_181 ( F_182 ( V_209 ) ) + V_209 -> V_92 ;
V_209 -> V_219 = V_209 -> V_216 ;
}
return V_296 ;
}
static int F_262 ( struct V_265 * V_268 , struct V_208 * V_295 , int V_296 ,
...
F_62 ( V_270 == V_273 ) ;
if ( F_240 ( V_268 ) )
return F_260 ( V_268 , V_295 , V_296 , V_270 ) ;
V_56 = F_238 ( V_173 ) ;
if ( ! V_56 )
return 0 ;
V_49 = F_61 ( V_56 ) ;
F_261 (sglist, sg, nelems, i)
V_82 += F_177 ( V_209 -> V_92 , V_209 -> V_216 ) ;
V_46 = F_231 ( V_268 , V_56 , F_10 ( V_82 ) ,
V_173 -> V_256 ) ;
if ( ! V_46 ) {
V_295 -> V_219 = 0 ;
return 0 ;
...
V_86 = F_187 ( V_56 , V_298 , V_295 , V_82 , V_30 ) ;
if ( F_170 ( V_86 ) ) {
F_89 ( V_56 , V_298 ,
V_298 + V_82 - 1 ) ;
F_90 ( V_56 , V_298 ,
...
if ( F_129 ( V_49 -> V_52 ) )
F_124 ( V_49 , V_56 -> V_171 , V_298 , V_82 , 1 ) ;
else
F_97 ( V_49 ) ;
return V_296 ;
}
static int F_263 ( struct V_265 * V_147 , V_218 V_299 )
{
return ! V_299 ;
}
static inline int F_264 ( void )
{
int V_86 = 0 ;
V_44 = F_265 ( L_57 ,
sizeof( struct V_55 ) ,
...
static void T_1 F_270 ( void )
{
F_269 ( V_45 ) ;
F_269 ( V_44 ) ;
F_269 ( V_47 ) ;
}
static void F_271 ( struct V_172 * V_173 )
{
struct V_68 * V_69 ;
T_3 V_302 ;
int V_303 ;
V_303 = F_272 ( V_173 -> V_73 , F_273 ( 0 , 0 ) , 0xb0 , & V_302 ) ;
if ( V_303 ) {
F_274 ( & V_173 -> V_147 , L_63 ) ;
return;
}
V_302 &= 0xffff0000 ;
V_69 = F_195 ( V_173 ) ;
if ( F_275 ( ! V_69 || V_69 -> V_260 - V_302 != 0xa000 ,
V_304 ,
L_64 ) )
...
if ( ! V_69 -> V_77 [ V_64 ] )
continue;
V_69 -> V_77 [ V_64 ] -> V_147 . V_225 . V_49 = V_240 ;
}
}
}
}
static int F_277 ( void )
{
struct V_68 * V_69 ;
struct V_48 * V_49 = NULL ;
F_70 (iommu, drhd)
...
static int F_281 ( void )
{
struct V_68 * V_69 ;
struct V_48 * V_49 = NULL ;
unsigned long V_111 ;
F_70 (iommu, drhd) {
V_49 -> V_306 = F_221 ( sizeof( T_3 ) * V_307 ,
V_42 ) ;
if ( ! V_49 -> V_306 )
goto V_308;
}
...
F_70 (iommu, drhd) {
F_79 ( & V_49 -> V_112 , V_111 ) ;
F_95 ( V_49 -> V_306 [ V_309 ] ,
V_49 -> V_113 + V_310 ) ;
F_95 ( V_49 -> V_306 [ V_311 ] ,
V_49 -> V_113 + V_312 ) ;
F_95 ( V_49 -> V_306 [ V_313 ] ,
V_49 -> V_113 + V_314 ) ;
F_95 ( V_49 -> V_306 [ V_315 ] ,
V_49 -> V_113 + V_316 ) ;
F_80 ( & V_49 -> V_112 , V_111 ) ;
}
F_70 (iommu, drhd)
...
static void T_1 F_284 ( void )
{
F_285 ( & V_317 ) ;
}
static inline void F_284 ( void ) {}
static int F_286 ( struct V_318 * V_319 ,
...
static void F_295 ( struct V_48 * V_49 ,
struct V_172 * V_173 )
{
struct V_172 * V_106 , * V_91 ;
if ( ! V_49 || ! V_173 )
...
return;
F_79 ( & V_146 , V_58 ) ;
F_296 (entry, tmp, &domain->devices) {
V_144 = F_191 ( V_329 , struct V_142 , V_223 ) ;
if ( V_144 -> V_72 == F_173 ( V_173 -> V_73 ) &&
V_144 -> V_73 == V_173 -> V_73 -> V_78 &&
V_144 -> V_74 == V_173 -> V_74 ) {
F_192 ( & V_144 -> V_223 ) ;
F_192 ( & V_144 -> V_224 ) ;
...
if ( V_143 == 0 ) {
unsigned long V_330 ;
F_79 ( & V_56 -> V_167 , V_330 ) ;
F_140 ( V_49 -> V_164 , & V_56 -> V_61 ) ;
V_56 -> V_168 -- ;
F_73 ( V_56 ) ;
F_80 ( & V_56 -> V_167 , V_330 ) ;
if ( ! ( V_56 -> V_58 & V_59 ) &&
! ( V_56 -> V_58 & V_60 ) ) {
F_79 ( & V_49 -> V_84 , V_330 ) ;
F_140 ( V_56 -> V_171 , V_49 -> V_165 ) ;
V_49 -> V_155 [ V_56 -> V_171 ] = NULL ;
F_80 ( & V_49 -> V_84 , V_330 ) ;
}
}
}
static void F_297 ( struct V_55 * V_56 )
{
struct V_142 * V_144 ;
struct V_48 * V_49 ;
...
V_49 = F_74 ( V_144 -> V_72 , V_144 -> V_73 , V_144 -> V_74 ) ;
F_189 ( V_49 , V_144 -> V_73 , V_144 -> V_74 ) ;
F_295 ( V_49 , V_144 -> V_147 ) ;
F_79 ( & V_56 -> V_167 , V_332 ) ;
if ( F_298 ( V_49 -> V_164 ,
& V_56 -> V_61 ) ) {
V_56 -> V_168 -- ;
F_73 ( V_56 ) ;
}
F_80 ( & V_56 -> V_167 , V_332 ) ;
F_53 ( V_144 ) ;
F_79 ( & V_146 , V_331 ) ;
}
F_80 ( & V_146 , V_331 ) ;
}
static struct V_55 * F_299 ( void )
{
struct V_55 * V_56 ;
V_56 = F_48 () ;
if ( ! V_56 )
...
static int F_207 ( struct V_55 * V_56 , int V_188 )
{
int V_189 ;
F_152 ( & V_56 -> V_187 , V_175 ) ;
F_136 ( & V_56 -> V_167 ) ;
...
static void F_300 ( struct V_55 * V_56 )
{
unsigned long V_58 ;
struct V_68 * V_69 ;
struct V_48 * V_49 ;
...
static void F_141 ( struct V_55 * V_56 )
{
if ( ! V_56 )
return;
F_297 ( V_56 ) ;
...
static int F_301 ( struct V_335 * V_56 )
{
struct V_55 * V_55 ;
V_55 = F_299 () ;
if ( ! V_55 ) {
...
static void F_302 ( struct V_335 * V_56 )
{
struct V_55 * V_55 = V_56 -> V_336 ;
V_56 -> V_336 = NULL ;
F_141 ( V_55 ) ;
}
static int F_303 ( struct V_335 * V_56 ,
struct V_265 * V_147 )
{
struct V_55 * V_55 = V_56 -> V_336 ;
struct V_172 * V_173 = F_232 ( V_147 ) ;
...
return - V_180 ;
V_90 = F_2 ( V_49 -> V_1 ) ;
if ( V_90 > F_161 ( V_49 -> V_52 ) )
V_90 = F_161 ( V_49 -> V_52 ) ;
...
return F_212 ( V_55 , V_173 , V_193 ) ;
}
static void F_304 ( struct V_335 * V_56 ,
struct V_265 * V_147 )
{
struct V_55 * V_55 = V_56 -> V_336 ;
struct V_172 * V_173 = F_232 ( V_147 ) ;
...
static int F_305 ( struct V_335 * V_56 ,
...
V_82 = F_177 ( V_339 , V_82 ) ;
V_86 = F_188 ( V_55 , V_46 >> V_10 ,
V_339 >> V_10 , V_82 , V_30 ) ;
return V_86 ;
}
static int F_307 ( struct V_335 * V_56 ,
...
static T_6 F_308 ( struct V_335 * V_56 ,
unsigned long V_46 )
{
struct V_55 * V_55 = V_56 -> V_336 ;
struct V_25 * V_26 ;
...
static int F_309 ( struct V_335 * V_56 ,
unsigned long V_52 )
{
struct V_55 * V_55 = V_56 -> V_336 ;
if ( V_52 == V_346 )
...
static void T_8 F_311 ( struct V_172 * V_147 )
{
unsigned short V_350 ;
if ( F_312 ( V_147 , V_351 , & V_350 ) )
return;
if ( ! ( V_350 & V_352 ) ) {
F_42 ( V_35 L_80 ) ;
V_36 = 0 ;
...
static void T_1 F_227 ( void )
{
struct V_172 * V_173 ;
T_9 V_353 ;
V_173 = F_313 ( V_354 , 0x3a3e , NULL ) ;
if ( ! V_173 )
return;
F_314 ( V_173 ) ;
V_173 = F_313 ( V_354 , 0x342e , NULL ) ;
if ( ! V_173 )
return;
if ( F_315 ( V_173 , 0x188 , & V_353 ) ) {
F_314 ( V_173 ) ;
return;
}
F_314 ( V_173 ) ;
