...
{
struct V_188 * V_189 = F_96 ( F_97 ( V_92 ) ) ;
if ( ! V_189 || F_98 ( V_189 ) )
return - V_190 ;
V_92 -> V_33 = V_189 -> V_191 ;
return 0 ;
}
static T_4
F_99 ( struct V_192 * V_77 )
{
struct V_193 * V_194 ;
T_4 V_195 = 0 ;
V_194 = F_35 ( sizeof( struct V_193 ) , V_121 ) ;
if ( ! V_194 )
return 0 ;
F_100 ( & V_77 -> V_196 , V_194 ) ;
if ( V_194 -> V_197 . V_198 == V_199 )
V_195 |= V_200 | V_201 |
V_202 | V_203 ;
else if ( V_194 -> V_197 . V_198 == V_204 ) {
if ( V_194 -> V_197 . V_205 ) {
V_195 |= V_201 |
V_202 |
V_203 | V_206 ;
} else {
...
} else if ( V_194 -> V_197 . V_198 == V_207 ) {
V_195 |= V_202 | V_203 |
V_206 ;
} else if ( V_194 -> V_197 . V_198 == V_208 ) {
V_195 |= V_209 ;
}
F_68 ( V_194 ) ;
return V_195 ;
...
char V_210 [ V_211 ] ;
struct V_212 * V_213 = F_102 ( & V_13 -> V_77 ) ;
F_103 ( V_31 ) =
F_104 ( ( F_105 ( V_104 -> V_214 ) ) ) ;
F_106 ( V_31 ) =
F_104 ( ( F_107 ( V_104 -> V_214 ) ) ) ;
F_108 ( V_31 ) = F_109 ( & V_13 -> V_77 ) ;
F_110 ( V_31 ) = V_215 ;
memset ( F_111 ( V_31 ) , 0 ,
sizeof( F_111 ( V_31 ) ) ) ;
if ( V_216 & V_217 )
F_111 ( V_31 ) [ 2 ] = 1 ;
F_111 ( V_31 ) [ 7 ] = 1 ;
strncpy ( V_210 , V_13 -> V_218 . V_219 . V_220 . V_221 . V_222 . V_210 ,
V_211 ) ;
sprintf ( F_112 ( V_31 ) , L_16 , V_210 ) ;
F_113 ( V_31 ) = F_99 ( & V_13 -> V_77 ) ;
F_114 ( V_31 ) = V_213 -> V_223 . V_224 ;
}
static void
F_115 ( struct V_51 * V_52 , struct V_16 * V_17 )
{
struct V_225 V_226 ;
struct V_188 * V_188 ;
struct V_14 * V_15 ;
V_226 . V_227 =
F_104 ( F_116 ( & V_17 -> V_80 ) ) ;
V_226 . V_228 =
F_104 ( F_40 ( & V_17 -> V_80 ) ) ;
V_226 . V_229 =
F_117 ( F_41 ( & V_17 -> V_80 ) ) ;
V_226 . V_230 = V_231 ;
V_17 -> V_188 = V_188 =
F_118 ( V_52 -> V_49 , 0 , & V_226 ) ;
if ( ! V_188 )
return;
V_188 -> V_232 =
F_119 ( & V_17 -> V_80 ) ;
V_188 -> V_233 = F_120 ( & V_17 -> V_80 ) ;
V_15 = V_188 -> V_191 ;
V_15 -> V_17 = V_17 ;
V_226 . V_230 |= V_234 ;
if ( V_226 . V_230 != V_231 )
F_121 ( V_188 , V_226 . V_230 ) ;
if ( ( V_188 -> V_235 != - 1 )
&& ( V_188 -> V_235 < V_90 ) )
V_17 -> V_187 = V_188 -> V_235 ;
return;
}
static void
...
static int
F_124 ( struct V_10 * V_11 , void (* F_125) ( struct V_10 * ) )
{
struct V_51 * V_52 =
...
int V_59 ;
int V_238 = 0 ;
struct V_188 * V_189 = F_96 ( F_97 ( V_11 -> V_30 ) ) ;
V_59 = F_98 ( V_189 ) ;
if ( V_59 ) {
V_11 -> V_26 = V_59 ;
F_125 ( V_11 ) ;
...
V_11 -> V_26 = F_5 ( V_241 , 0 ) ;
goto V_242;
}
V_17 = V_15 -> V_17 ;
if ( ! V_17 ) {
V_11 -> V_26 = F_5 ( V_243 , 0 ) ;
goto V_242;
}
V_56 = F_127 ( & V_13 -> V_77 , (struct V_2 * ) V_11 ,
V_17 -> V_73 , V_238 ) ;
if ( ! V_56 ) {
F_50 ( V_122 L_22 ) ;
F_19 ( & V_13 -> V_61 , V_57 ) ;
