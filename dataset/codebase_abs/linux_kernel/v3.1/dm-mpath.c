...
V_62 = - V_74 ;
F_39 ( & V_13 -> V_25 , V_64 ) ;
return V_62 ? : F_110 ( V_19 , V_165 , V_163 , V_164 ) ;
}
static int F_111 ( struct V_9 * V_10 ,
T_5 V_167 , void * V_139 )
{
struct V_12 * V_13 = V_10 -> V_14 ;
struct V_5 * V_6 ;
struct V_1 * V_97 ;
...
F_26 (pg, &m->priority_groups, list) {
F_26 (p, &pg->pgpaths, list) {
V_110 = V_167 ( V_10 , V_97 -> V_17 . V_18 , V_10 -> V_168 , V_10 -> V_113 , V_139 ) ;
if ( V_110 )
goto V_85;
}
}
...
unsigned long V_64 ;
F_36 ( & V_13 -> V_25 , V_64 ) ;
if ( F_115 ( ! V_13 -> V_50 && V_13 -> V_54 ) )
V_6 = V_13 -> V_54 ;
else if ( F_116 ( V_13 -> V_44 ) )
V_6 = V_13 -> V_44 ;
else
goto V_85;
V_169 = 1 ;
