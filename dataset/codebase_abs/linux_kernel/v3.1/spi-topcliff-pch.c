...
F_59 ( V_163 ) = V_122 -> V_179 + V_163 -> V_172 ;
}
V_163 = V_122 -> V_130 ;
...
F_60 ( & V_6 -> V_2 -> V_40 , V_163 , V_165 , V_180 ) ;
V_134 -> V_177 = NULL ;
V_134 -> V_178 = V_6 ;
V_122 -> V_128 = V_165 ;
V_122 -> V_134 = V_134 ;
...
static void F_61 ( struct V_182 * V_183 )
{
struct V_84 * V_85 ;
struct V_5 * V_6 ;
int V_106 ;
V_6 = F_62 ( V_183 , struct V_5 , V_102 ) ;
...
F_14 ( & V_6 -> V_2 -> V_40 ,
L_43 , V_41 ) ;
V_6 -> V_51 = F_65 ( V_6 -> V_100 . V_184 , struct V_84 ,
V_100 ) ;
F_32 ( & V_6 -> V_51 -> V_100 ) ;
V_6 -> V_51 -> V_53 = 0 ;
...
F_46 ( V_6 ,
V_6 -> V_51 -> V_70 -> V_67 ) ;
F_1 ( V_6 -> V_2 , V_113 , V_185 ) ;
do {
F_63 ( & V_6 -> V_91 ) ;
if ( V_6 -> V_57 == NULL ) {
V_6 -> V_57 =
F_65 ( V_6 -> V_51 -> V_89 . V_184 ,
struct V_86 , V_186 ) ;
F_14 ( & V_6 -> V_2 -> V_40 , L_44
L_45 , V_41 ) ;
} else {
V_6 -> V_57 =
F_65 ( V_6 -> V_57 -> V_186 . V_184 ,
struct V_86 , V_186 ) ;
F_14 ( & V_6 -> V_2 -> V_40 , L_44
L_46 , V_41 ) ;
}
...
V_122 = & V_6 -> V_122 ;
if ( V_122 -> V_179 )
F_72 ( & V_47 -> V_49 -> V_40 , V_193 ,
V_122 -> V_131 , V_122 -> V_179 ) ;
if ( V_122 -> V_173 )
F_72 ( & V_47 -> V_49 -> V_40 , V_193 ,
...
V_193 , & V_122 -> V_179 , V_111 ) ;
V_122 -> V_123 = F_74 ( & V_47 -> V_49 -> V_40 ,
V_193 , & V_122 -> V_173 , V_111 ) ;
}
static int T_7 F_75 ( struct V_194 * V_195 )
{
int V_44 ;
struct V_1 * V_2 ;
struct V_46 * V_47 = F_76 ( & V_195 -> V_40 ) ;
struct V_5 * V_6 ;
F_14 ( & V_195 -> V_40 , L_57 , V_41 ) ;
V_2 = F_77 ( & V_47 -> V_49 -> V_40 ,
sizeof( struct V_5 ) ) ;
if ( ! V_2 ) {
F_12 ( & V_195 -> V_40 , L_58 ,
V_195 -> V_196 ) ;
return - V_112 ;
}
V_6 = F_2 ( V_2 ) ;
...
V_197 * V_195 -> V_196 ;
if ( ! V_6 -> V_7 ) {
F_12 ( & V_195 -> V_40 , L_59 , V_41 ) ;
V_44 = - V_112 ;
goto V_198;
}
F_14 ( & V_195 -> V_40 , L_60 ,
V_195 -> V_196 , V_6 -> V_7 ) ;
V_2 -> V_153 = - 1 ;
V_2 -> V_199 = V_200 ;
V_2 -> V_201 = F_19 ;
...
V_44 = F_69 ( V_47 , V_6 ) ;
if ( V_44 ) {
F_12 ( & V_195 -> V_40 , L_61 , V_41 , V_44 ) ;
goto V_204;
}
...
static int T_8 F_91 ( struct V_194 * V_195 )
{
struct V_46 * V_47 = F_76 ( & V_195 -> V_40 ) ;
struct V_5 * V_6 = F_92 ( V_195 ) ;
int V_209 ;
unsigned long V_71 ;
F_14 ( & V_195 -> V_40 , L_65 ,
V_41 , V_195 -> V_196 , V_47 -> V_49 -> V_42 ) ;
if ( V_58 )
F_71 ( V_47 , V_6 ) ;
V_209 = 500 ;
F_23 ( & V_6 -> V_91 , V_71 ) ;
V_6 -> V_53 = V_96 ;
while ( ( F_22 ( & V_6 -> V_100 ) == 0 ) && -- V_209 ) {
...
static int F_95 ( struct V_194 * V_211 ,
T_9 V_212 )
{
T_5 V_209 ;
struct V_46 * V_47 = F_76 ( & V_211 -> V_40 ) ;
struct V_5 * V_6 = F_92 ( V_211 ) ;
F_14 ( & V_211 -> V_40 , L_50 , V_41 ) ;
if ( ! V_47 ) {
F_12 ( & V_211 -> V_40 ,
L_67 , V_41 ) ;
return - V_213 ;
...
static int F_96 ( struct V_194 * V_211 )
{
struct V_46 * V_47 = F_76 ( & V_211 -> V_40 ) ;
struct V_5 * V_6 = F_92 ( V_211 ) ;
int V_88 ;
...
const struct V_214 * V_196 )
{
struct V_46 * V_47 ;
struct V_194 * V_211 = NULL ;
int V_88 ;
int V_166 ;
struct V_215 * V_216 ;
V_216 = F_30 ( sizeof( struct V_215 ) , V_111 ) ;
if ( ! V_216 ) {
...
V_88 = F_98 ( V_49 , V_190 ) ;
if ( V_88 ) {
F_12 ( & V_49 -> V_40 , L_71 , V_41 ) ;
goto F_98;
}
V_47 -> V_49 = V_49 ;
V_47 -> V_165 = V_196 -> V_218 ;
V_216 -> V_165 = V_196 -> V_218 ;
V_216 -> V_47 = V_47 ;
V_88 = F_99 ( V_49 ) ;
if ( V_88 ) {
...
V_211 = F_100 ( L_73 , V_166 ) ;
if ( ! V_211 ) {
F_12 ( & V_49 -> V_40 , L_74 ) ;
goto V_219;
}
V_216 -> V_220 [ V_166 ] = V_211 ;
V_211 -> V_40 . V_221 = & V_49 -> V_40 ;
V_88 = F_101 ( V_211 , V_47 ,
sizeof( * V_47 ) ) ;
if ( V_88 ) {
F_12 ( & V_49 -> V_40 ,
L_75 ) ;
...
{
int V_166 ;
struct V_215 * V_216 = F_108 ( V_49 ) ;
F_14 ( & V_49 -> V_40 , L_77 , V_41 , V_49 ) ;
for ( V_166 = 0 ; V_166 < V_216 -> V_165 ; V_166 ++ )
F_109 ( V_216 -> V_220 [ V_166 ] ) ;
F_105 ( V_49 ) ;
F_106 ( V_49 ) ;
F_31 ( V_216 -> V_47 ) ;
F_31 ( V_216 ) ;
}
static int F_110 ( struct V_147 * V_49 , T_9 V_212 )
{
int V_88 ;
struct V_215 * V_216 = F_108 ( V_49 ) ;
F_14 ( & V_49 -> V_40 , L_50 , V_41 ) ;
V_216 -> V_47 -> V_48 = true ;
V_88 = F_111 ( V_49 ) ;
if ( V_88 == 0 ) {
F_112 ( V_49 , V_222 , 0 ) ;
F_105 ( V_49 ) ;
