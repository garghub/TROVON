...
void F_112 ( struct V_88 * V_89 , T_2 V_205 , T_1 V_206 , int V_230 )
{
struct V_42 * V_43 = F_48 ( & V_89 -> V_102 ) ;
struct V_1 * V_2 ;
...
struct V_1 * V_2 ;
T_2 V_232 = V_89 -> V_187 ;
V_2 = F_99 ( V_43 , V_232 , 1 , V_166 ) ;
if ( ! V_2 )
return;
F_109 ( V_89 , V_232 , 1 , V_166 ) ;
F_98 ( V_2 -> V_68 , V_2 -> V_47 [ 0 ] . V_48 , 1 ) ;
F_60 ( V_2 , V_2 -> V_47 [ 0 ] . V_48 -> V_49 ) ;
F_113 ( V_2 ) ;
}
static void F_117 ( struct V_1 * V_2 , T_2 V_232 )
{
struct V_42 * V_43 = V_2 -> V_27 ;
struct V_1 * V_233 ;
V_233 = F_99 ( V_43 , V_232 , 1 , V_204 ) ;
if ( ! V_233 )
return;
F_118 ( V_43 , V_2 == V_233 ) ;
if ( ! V_2 -> V_52 )
F_6 ( V_2 ) ;
V_2 -> V_52 -- ;
V_2 -> V_50 ++ ;
...
{
F_117 ( V_2 , V_89 -> V_187 ) ;
F_109 ( V_89 , V_89 -> V_187 , 1 , V_204 ) ;
F_108 ( V_89 , - 1 , V_89 -> V_102 . V_225 , V_89 -> V_102 . V_226 ) ;
F_114 ( V_89 , V_89 -> V_187 , 1 ) ;
}
int F_120 ( struct V_42 * V_43 , T_2 V_162 , unsigned int type )
{
struct V_1 * V_2 ;
struct V_115 V_116 , V_234 ;
struct V_88 * V_89 = F_40 ( V_43 -> V_87 ) ;
int V_235 = 0 ;
int error ;
if ( ! F_91 ( V_89 -> V_117 ) ) {
...
if ( ! V_2 )
goto V_236;
error = F_57 ( V_2 -> V_68 , V_118 , 0 , & V_234 ) ;
if ( error )
goto V_236;
...
void F_121 ( struct V_42 * V_43 , struct V_238 * V_239 ,
T_2 V_8 )
{
struct V_1 * V_2 ;
struct V_1 * * V_31 ;
...
for ( V_46 = 0 ; V_46 < V_239 -> V_242 ; V_46 ++ )
if ( V_239 -> V_243 [ V_46 ] == V_2 )
return;
if ( V_239 -> V_242 == V_239 -> V_244 ) {
V_240 = V_239 -> V_244 + 10 ;
V_31 = F_38 ( V_240 , sizeof( struct V_1 * ) ,
V_77 | V_210 ) ;
if ( V_239 -> V_243 ) {
memcpy ( V_31 , V_239 -> V_243 ,
V_239 -> V_244 * sizeof( struct V_1 * ) ) ;
F_31 ( V_239 -> V_243 ) ;
}
V_239 -> V_244 = V_240 ;
V_239 -> V_243 = V_31 ;
}
V_239 -> V_243 [ V_239 -> V_242 ++ ] = V_2 ;
}
void F_122 ( struct V_238 * V_239 , unsigned int V_30 )
{
unsigned int V_46 ;
V_239 -> V_241 = F_38 ( V_239 -> V_242 , sizeof( struct V_115 ) ,
V_77 | V_210 ) ;
for ( V_46 = 0 ; V_46 < V_239 -> V_242 ; V_46 ++ )
F_123 ( V_239 -> V_243 [ V_46 ] -> V_68 ,
V_30 , 0 ,
& V_239 -> V_241 [ V_46 ] ) ;
}
void F_124 ( struct V_238 * V_239 )
{
unsigned int V_46 ;
F_31 ( V_239 -> V_243 ) ;
if ( V_239 -> V_241 ) {
for ( V_46 = 0 ; V_46 < V_239 -> V_242 ; V_46 ++ )
F_125 ( & V_239 -> V_241 [ V_46 ] ) ;
F_31 ( V_239 -> V_241 ) ;
}
}
