...
struct V_109 * V_110 ;
F_17 ( L_4 , V_78 -> V_127 ) ;
V_78 -> V_128 = V_129 -> V_130 ;
if ( F_35 ( V_78 , sizeof( struct V_131 ) ) < 0 )
return - V_92 ;
V_78 -> V_132 = F_19 ;
V_78 -> V_133 = F_26 ;
V_80 -> V_79 = V_126 -> V_134 [ 0 ] ;
V_80 -> V_37 = V_126 -> V_134 [ 1 ] ;
F_17 ( L_5 , V_80 -> V_79 , V_80 -> V_37 ) ;
if ( F_36 ( V_78 , 5 ) < 0 )
return - V_92 ;
V_110 = V_78 -> V_116 + 0 ;
V_110 -> type = V_135 ;
