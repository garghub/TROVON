...
if ( V_101 -> V_85 && ! V_109 ) {
struct V_96 * V_117 ;
V_117 = F_114 ( F_98 , V_101 , L_10 , V_3 ,
V_101 -> V_66 ) ;
if ( F_115 ( V_117 ) ) {
V_25 = F_116 ( V_117 ) ;
goto V_116;
...
F_41 ( V_3 , V_5 , V_22 ) ;
} else if ( V_101 -> V_7 & V_120 ) {
unsigned int V_131 = V_101 -> V_7 & V_120 ;
unsigned int V_132 = F_124 ( V_5 ) ;
if ( V_131 != V_132 )
F_125 ( L_11 ,
V_3 , V_131 , V_132 ) ;
}
...
V_119:
if ( V_101 -> V_16 ) {
struct V_96 * V_117 = V_101 -> V_16 ;
V_101 -> V_16 = NULL ;
if ( F_131 ( ! F_91 ( V_100 , & V_101 -> V_18 ) ) )
F_132 ( V_117 ) ;
F_133 ( V_117 ) ;
}
V_116:
...
int F_135 ( unsigned int V_3 , struct V_14 * V_137 )
{
int V_138 ;
struct V_4 * V_5 = F_3 ( V_3 ) ;
F_86 ( V_5 ) ;
V_138 = F_109 ( V_3 , V_5 , V_137 ) ;
F_90 ( V_5 ) ;
return V_138 ;
}
static struct V_14 * F_136 ( unsigned int V_3 , void * V_72 )
{
struct V_4 * V_5 = F_3 ( V_3 ) ;
...
void F_145 ( unsigned int V_3 , struct V_14 * V_137 )
{
F_136 ( V_3 , V_137 -> V_72 ) ;
}
void F_146 ( unsigned int V_3 , void * V_72 )
{
struct V_4 * V_5 = F_3 ( V_3 ) ;
if ( ! V_5 )
return;
...
#endif
F_86 ( V_5 ) ;
F_148 ( F_136 ( V_3 , V_72 ) ) ;
F_90 ( V_5 ) ;
}
int F_149 ( unsigned int V_3 , T_4 V_105 ,
T_4 V_85 , unsigned long V_61 ,
const char * V_140 , void * V_72 )
{
struct V_14 * V_15 ;
struct V_4 * V_5 ;
int V_138 ;
...
V_15 = F_150 ( sizeof( struct V_14 ) , V_38 ) ;
if ( ! V_15 )
return - V_118 ;
V_15 -> V_105 = V_105 ;
V_15 -> V_85 = V_85 ;
...
int F_152 ( unsigned int V_3 , T_4 V_105 ,
...
return - V_26 ;
if ( F_112 ( V_5 ) ) {
V_25 = F_149 ( V_3 , NULL , V_105 ,
V_7 , V_66 , V_72 ) ;
return ! V_25 ? V_141 : V_25 ;
}
V_25 = F_153 ( V_3 , V_105 , V_7 , V_66 , V_72 ) ;
return ! V_25 ? V_142 : V_25 ;
}
