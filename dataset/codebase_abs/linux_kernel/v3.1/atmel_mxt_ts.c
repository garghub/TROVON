...
for ( V_63 = 0 ; V_63 < V_48 -> V_64 . V_65 ; V_63 ++ ) {
V_62 = V_48 -> V_66 + V_63 ;
V_112 += sprintf ( V_45 + V_112 ,
L_26 ,
V_63 + 1 , V_62 -> type ) ;
if ( ! F_1 ( V_62 -> type ) ) {
V_112 += sprintf ( V_45 + V_112 , L_27 ) ;
continue;
}
...
goto V_168;
F_8 ( V_33 ) ;
while ( V_162 < V_161 -> V_109 ) {
V_163 = F_5 ( V_33 ,
V_40 ) ;
if ( V_163 )
goto V_168;
V_49 = ( ( * ( V_161 -> V_48 + V_162 ) << 8 ) | * ( V_161 -> V_48 + V_162 + 1 ) ) ;
V_49 += 2 ;
F_10 ( V_33 , V_161 -> V_48 + V_162 , V_49 ) ;
V_163 = F_5 ( V_33 ,
V_42 ) ;
if ( V_163 )
goto V_168;
V_162 += V_49 ;
F_4 ( V_27 , L_30 , V_162 , V_161 -> V_109 ) ;
}
V_168:
F_42 ( V_161 ) ;
if ( V_33 -> V_54 == V_166 )
...
{
const struct V_103 * V_104 = V_33 -> V_27 . V_174 ;
struct V_61 * V_48 ;
struct V_72 * V_72 ;
int error ;
if ( ! V_104 )
...
V_104 -> V_188 , V_33 -> V_27 . V_189 -> V_176 , V_48 ) ;
if ( error ) {
F_7 ( & V_33 -> V_27 , L_34 ) ;
goto V_187;
}
...
if ( error )
goto V_190;
error = F_62 ( & V_33 -> V_27 . V_191 , & V_192 ) ;
if ( error )
goto V_193;
return 0 ;
V_193:
