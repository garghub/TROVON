...
snprintf ( V_8 -> V_26 , sizeof( V_8 -> V_26 ) , L_2 , V_8 -> V_2 ) ;
V_8 -> V_6 = V_6 ;
V_8 -> V_27 = 1 ;
V_9 = F_8 ( & V_8 -> V_8 ) ;
if ( V_9 ) {
...
! ( V_28 -> V_36 && V_28 -> V_37 ) &&
! ( V_28 -> V_38 && V_28 -> V_39 && V_28 -> V_35 ) ) {
F_3 ( V_12 L_4 ) ;
return ( - V_40 ) ;
}
if ( ! V_28 -> V_38 && ! V_28 -> V_34 && V_28 -> V_41 ) {
F_3 ( V_12 L_5
L_6 ) ;
V_28 -> V_41 = NULL ;
}
...
memcpy ( V_8 -> V_13 , V_28 , sizeof( struct V_10 ) ) ;
V_8 -> V_18 = 1 ;
V_8 -> V_49 = F_17 ( & V_50 , V_8 , L_7 , V_8 -> V_26 ) ;
if ( F_18 ( V_8 -> V_49 ) ) {
V_30 = F_19 ( V_8 -> V_49 ) ;
F_20 ( & V_8 -> V_8 ,
L_8 ,
...
void F_34 ( struct V_10 * V_61 )
{
struct V_1 * V_8 , * V_33 = NULL ;
F_14 (dev, &w1_masters, w1_master_entry) {
if ( ! V_8 -> V_18 )
continue;
if ( V_8 -> V_13 -> V_62 == V_61 -> V_62 ) {
V_33 = V_8 ;
break;
}
}
