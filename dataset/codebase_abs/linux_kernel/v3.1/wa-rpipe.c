...
V_62 = V_10 -> V_63 && ! V_10 -> V_64 ? 0x80 : 0 ;
F_26 ( V_2 , F_20 ( V_21 -> V_4 . V_32 ) ) ;
F_29 ( & V_21 -> V_65 , F_20 ( V_21 -> V_4 . V_66 ) ) ;
V_21 -> V_4 . V_67 = F_30 ( 16 ) ;
V_21 -> V_4 . V_68 = F_30 ( V_33 -> V_50 . V_68 ) ;
V_21 -> V_4 . V_69 = 0 ;
V_21 -> V_4 . V_70 = F_31 ( V_59 -> V_8 -> V_71 ) ;
V_21 -> V_4 . V_72 = F_32 ( V_59 -> V_73 ) == 0 ?
V_74 : V_75 ;
F_33 ( V_8 , L_15 ,
V_59 -> V_8 -> V_76 , V_59 -> V_8 -> V_76 | V_62 ,
F_20 ( V_21 -> V_4 . V_32 ) ,
F_32 ( V_59 -> V_73 ) , V_21 -> V_4 . V_72 ) ;
if ( F_34 ( V_59 -> V_8 -> V_76 == 0x80 ) )
V_21 -> V_4 . V_77 = 0 ;
else
V_21 -> V_4 . V_77 = V_59 -> V_8 -> V_76 | V_62 ;
V_21 -> V_4 . V_51 = V_33 -> V_50 . V_51 ;
V_21 -> V_4 . V_78 = 0 ;
V_21 -> V_4 . V_79 = F_35 ( 1 ) ;
V_21 -> V_4 . V_80 = V_49 -> V_81 - 1 ;
V_21 -> V_4 . V_82 = V_33 -> V_50 . V_82 ;
V_21 -> V_4 . V_83 = 0 ;
V_21 -> V_4 . V_84 = V_33 -> V_50 . V_85 & 0x03 ;
V_21 -> V_4 . V_86 = 15 ;
V_21 -> V_4 . V_87 = 0 ;
...
static int F_36 ( const struct V_20 * V_21 , const struct V_1 * V_2 ,
...
struct V_7 * V_8 = & V_2 -> V_9 -> V_8 ;
struct V_61 * V_10 = V_59 -> V_8 ;
T_3 V_62 = ( V_10 -> V_63 && ! V_10 -> V_64 ) ? 0x80 : 0 ;
T_3 V_71 = F_31 ( V_59 -> V_8 -> V_71 ) ;
#define F_37 ( T_6 , T_7 , T_8 ) \
do { \
...
F_37 ( V_68 , F_30 ( V_33 -> V_50 . V_68 ) ,
L_17 ) ;
F_37 ( V_70 , V_71 , L_17 ) ;
F_37 ( V_72 , F_32 ( V_59 -> V_73 ) == 0 ?
V_74 : V_75 ,
L_17 ) ;
F_37 ( V_77 , V_59 -> V_8 -> V_76 | V_62 , L_17 ) ;
F_37 ( V_51 , V_33 -> V_50 . V_51 , L_17 ) ;
F_37 ( V_82 , V_33 -> V_50 . V_82 , L_17 ) ;
F_37 ( V_84 , V_33 -> V_50 . V_85 & 0x03 , L_17 ) ;
#undef F_37
return V_6 ;
}
int F_38 ( struct V_1 * V_2 , struct V_44 * V_33 ,
...
if ( V_21 != NULL ) {
if ( V_90 == 1 ) {
V_6 = F_36 ( V_21 , V_2 , V_33 , V_59 , V_37 ) ;
if ( V_6 < 0 )
goto error;
}
F_40 ( V_21 ) ;
...
V_6 = - V_91 ;
V_88 = V_33 -> V_50 . V_85 & 0x03 ;
V_6 = F_23 ( & V_21 , V_2 , 1 << V_88 , V_37 ) ;
if ( V_6 < 0 )
goto error;
...
{
V_2 -> V_29 = V_2 -> V_92 -> V_93 ;
V_2 -> V_28 = F_24 ( F_44 ( V_2 -> V_29 ) *sizeof( unsigned long ) ,
V_94 ) ;
if ( V_2 -> V_28 == NULL )
return - V_38 ;
return 0 ;
...
{
struct V_7 * V_8 = & V_2 -> V_9 -> V_8 ;
if ( ! F_46 ( V_2 -> V_28 , V_2 -> V_29 ) ) {
char V_95 [ 256 ] ;
F_47 ( 1 ) ;
F_48 ( V_95 , sizeof( V_95 ) , V_2 -> V_28 , V_2 -> V_29 ) ;
F_4 ( V_8 , L_20 , V_95 ) ;
}
F_22 ( V_2 -> V_28 ) ;
}
