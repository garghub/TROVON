...
if ( V_18 > F_16 ( & V_4 -> V_20 ) )
return V_23 ;
V_11 = F_19 ( sizeof( struct V_10 ) +
...
V_11 -> V_31 = V_18 ;
V_11 -> V_32 = V_13 -> V_33 ;
V_11 -> V_34 [ 1 ] . V_35 = F_21 ( V_13 -> V_36 ) >> V_37 ;
V_11 -> V_34 [ 1 ] . V_38
= ( unsigned long ) V_13 -> V_36 & ( V_39 - 1 ) ;
V_11 -> V_34 [ 1 ] . V_33 = F_22 ( V_13 ) ;
for ( V_22 = 0 ; V_22 < F_13 ( V_13 ) -> V_19 ; V_22 ++ ) {
T_1 * V_40 = & F_13 ( V_13 ) -> V_41 [ V_22 ] ;
V_11 -> V_34 [ V_22 + 2 ] . V_35 = F_23 ( V_40 -> V_42 ) ;
...
V_36 = F_37 ( F_38 ( V_11 -> V_34 [ V_22 ] . V_35 ) ,
V_56 ) ;
V_36 = ( void * ) ( unsigned long ) V_36 +
V_11 -> V_34 [ V_22 ] . V_38 ;
memcpy ( F_39 ( V_13 , V_11 -> V_34 [ V_22 ] . V_33 ) , V_36 ,
V_11 -> V_34 [ V_22 ] . V_33 ) ;
F_40 ( ( void * ) ( ( unsigned long ) V_36 -
V_11 -> V_34 [ V_22 ] . V_38 ) , V_56 ) ;
}
F_41 ( V_54 ) ;
V_13 -> V_57 = F_42 ( V_13 , V_2 ) ;
V_13 -> V_58 = V_59 ;
V_2 -> V_27 . V_60 ++ ;
...
struct V_3 * V_52 ;
struct V_1 * V_2 ;
V_52 = F_46 ( V_69 , struct V_3 , V_53 . V_70 ) ;
V_2 = F_27 ( & V_52 -> V_7 -> V_51 ) ;
F_29 ( V_2 ) ;
}
static int F_47 ( struct V_5 * V_17 )
{
struct V_1 * V_2 = NULL ;
struct V_3 * V_4 ;
struct V_71 V_72 ;
int V_8 ;
V_2 = F_48 ( sizeof( struct V_3 ) ) ;
if ( ! V_2 )
return - 1 ;
F_32 ( V_2 ) ;
V_4 = F_3 ( V_2 ) ;
...
F_28 ( V_2 ) ;
memcpy ( V_2 -> V_74 , V_72 . V_75 , V_76 ) ;
V_2 -> V_77 = & V_78 ;
V_2 -> V_79 = V_80 ;
V_2 -> V_81 = V_80 ;
F_54 ( V_2 , & V_82 ) ;
...
static int F_58 ( struct V_5 * V_17 )
{
struct V_1 * V_2 = F_27 ( & V_17 -> V_51 ) ;
struct V_3 * V_52 ;
if ( V_2 == NULL ) {
F_59 ( & V_17 -> V_51 , L_12 ) ;
return 0 ;
