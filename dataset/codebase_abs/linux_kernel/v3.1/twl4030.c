...
static void F_48 ( struct V_1 * V_2 , int V_142 ,
int V_27 )
{
T_1 V_3 , V_102 ;
V_3 = F_1 ( V_2 , V_38 ) ;
...
static int F_49 ( struct V_130 * V_148 ,
struct V_149 * V_150 )
{
struct V_151 * V_152 = V_148 -> V_153 ;
struct V_1 * V_2 = V_152 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
F_50 ( V_148 -> V_135 , 0 , 32 , 24 ) ;
if ( V_10 -> V_133 ) {
V_10 -> V_134 = V_148 ;
if ( V_10 -> V_111 )
F_46 ( V_10 , V_10 -> V_133 ) ;
} else {
if ( ! ( F_1 ( V_2 , V_31 ) &
V_154 ) ) {
F_47 ( V_148 -> V_135 ,
...
static void F_51 ( struct V_130 * V_148 ,
struct V_149 * V_150 )
{
struct V_151 * V_152 = V_148 -> V_153 ;
struct V_1 * V_2 = V_152 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
if ( V_10 -> V_133 == V_148 )
V_10 -> V_133 = V_10 -> V_134 ;
V_10 -> V_134 = NULL ;
if ( ! V_10 -> V_133 )
V_10 -> V_111 = 0 ;
else if ( ! V_10 -> V_133 -> V_135 -> V_141 )
V_10 -> V_111 = 0 ;
if ( V_148 -> V_135 -> V_141 == 4 )
F_48 ( V_2 , V_148 -> V_155 , 0 ) ;
}
static int F_52 ( struct V_130 * V_148 ,
struct V_156 * V_157 ,
struct V_149 * V_150 )
{
struct V_151 * V_152 = V_148 -> V_153 ;
struct V_1 * V_2 = V_152 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
T_1 V_28 , V_158 , V_159 , V_160 ;
if ( F_53 ( V_157 ) == 4 ) {
V_159 = F_1 ( V_2 , V_81 ) ;
V_28 = F_1 ( V_2 , V_31 ) ;
if ( ( V_28 & V_154 ) &&
( ( V_159 & V_161 ) == V_162 ) )
F_48 ( V_2 , V_148 -> V_155 , 1 ) ;
else
return - V_116 ;
}
if ( V_10 -> V_111 )
...
V_10 -> V_111 = 1 ;
V_10 -> V_137 = F_54 ( V_157 ) ;
V_10 -> V_139 = F_56 ( V_157 ,
V_138 ) -> V_180 ;
V_10 -> V_141 = F_53 ( V_157 ) ;
if ( V_10 -> V_134 )
F_46 ( V_10 , V_148 ) ;
return 0 ;
}
static int F_57 ( struct V_149 * V_181 ,
...
break;
default:
F_58 ( V_2 -> V_35 , L_10 , V_183 ) ;
return - V_116 ;
}
if ( ( V_183 / 1000 ) != V_10 -> V_88 ) {
F_58 ( V_2 -> V_35 ,
L_11 ,
V_183 , V_10 -> V_88 * 1000 ) ;
return - V_116 ;
}
return 0 ;
}
static int F_59 ( struct V_149 * V_181 ,
unsigned int V_185 )
{
struct V_1 * V_2 = V_181 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
...
static int F_60 ( struct V_149 * V_150 , int V_195 )
{
...
static void F_61 ( struct V_1 * V_2 , int V_142 ,
int V_27 )
{
T_1 V_3 , V_102 ;
V_3 = F_1 ( V_2 , V_38 ) ;
...
static int F_62 ( struct V_130 * V_148 ,
struct V_149 * V_150 )
{
struct V_151 * V_152 = V_148 -> V_153 ;
struct V_1 * V_2 = V_152 -> V_2 ;
...
static void F_63 ( struct V_130 * V_148 ,
struct V_149 * V_150 )
{
struct V_151 * V_152 = V_148 -> V_153 ;
struct V_1 * V_2 = V_152 -> V_2 ;
F_61 ( V_2 , V_148 -> V_155 , 0 ) ;
}
static int F_64 ( struct V_130 * V_148 ,
struct V_156 * V_157 , struct V_149 * V_150 )
{
struct V_151 * V_152 = V_148 -> V_153 ;
struct V_1 * V_2 = V_152 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
T_1 V_158 , V_28 ;
F_61 ( V_2 , V_148 -> V_155 , 1 ) ;
V_158 = F_1 ( V_2 , V_31 )
& ~ ( V_163 ) ;
V_28 = V_158 ;
switch ( F_54 ( V_157 ) ) {
...
static int F_65 ( struct V_149 * V_181 ,
int V_182 , unsigned int V_183 , int V_184 )
{
struct V_1 * V_2 = V_181 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
...
static int F_66 ( struct V_149 * V_181 ,
unsigned int V_185 )
{
struct V_1 * V_2 = V_181 -> V_2 ;
struct V_9 * V_10 = F_4 ( V_2 ) ;
...
static int F_67 ( struct V_149 * V_150 , int V_195 )
{
struct V_1 * V_2 = V_150 -> V_2 ;
...
static int F_68 ( struct V_1 * V_2 , T_2 V_207 )
{
F_45 ( V_2 , V_129 ) ;
return 0 ;
}
...
{
struct V_9 * V_10 ;
V_10 = F_71 ( sizeof( struct V_9 ) , V_208 ) ;
if ( V_10 == NULL ) {
F_40 ( L_19 ) ;
return - V_209 ;
}
...
static int T_3 F_77 ( struct V_212 * V_213 )
{
struct V_40 * V_41 = V_213 -> V_35 . V_83 ;
if ( ! V_41 ) {
F_58 ( & V_213 -> V_35 , L_20 ) ;
return - V_116 ;
}
return F_78 ( & V_213 -> V_35 , & V_214 ,
V_215 , F_43 ( V_215 ) ) ;
}
static int T_4 F_79 ( struct V_212 * V_213 )
{
F_80 ( & V_213 -> V_35 ) ;
return 0 ;
}
