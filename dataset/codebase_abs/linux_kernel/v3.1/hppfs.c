...
static int F_68 ( struct V_4 * V_4 , char T_2 * V_117 ,
int V_118 )
{
struct V_4 * V_28 = F_1 ( V_4 -> V_33 ) -> V_28 ;
return V_28 -> V_33 -> V_119 -> V_120 ( V_28 , V_117 ,
V_118 ) ;
}
static void * F_69 ( struct V_4 * V_4 , struct V_26 * V_27 )
{
struct V_4 * V_28 = F_1 ( V_4 -> V_33 ) -> V_28 ;
return V_28 -> V_33 -> V_119 -> V_121 ( V_28 , V_27 ) ;
}
static void F_70 ( struct V_4 * V_4 , struct V_26 * V_27 ,
void * V_122 )
{
struct V_4 * V_28 = F_1 ( V_4 -> V_33 ) -> V_28 ;
if ( V_28 -> V_33 -> V_119 -> V_123 )
V_28 -> V_33 -> V_119 -> V_123 ( V_28 , V_27 , V_122 ) ;
}
...
V_2 -> V_137 = V_124 -> V_137 ;
V_2 -> V_138 = V_124 -> V_138 ;
V_2 -> V_139 = V_124 -> V_139 ;
return V_2 ;
}
static int F_74 ( struct V_5 * V_6 , void * V_93 , int V_140 )
{
struct V_2 * V_141 ;
struct V_83 * V_84 ;
int V_30 = - V_32 ;
V_84 = F_46 ( V_142 -> V_143 -> V_144 -> V_84 ) ;
if ( F_18 ( V_84 ) )
goto V_36;
V_6 -> V_145 = 1024 ;
V_6 -> V_146 = 10 ;
...
V_6 -> V_86 = V_84 ;
V_30 = - V_24 ;
V_141 = F_19 ( V_6 , F_45 ( V_84 -> V_150 -> V_10 ) ) ;
if ( ! V_141 )
goto V_151;
V_6 -> V_10 = F_75 ( V_141 ) ;
if ( ! V_6 -> V_10 )
...
static struct V_4 * F_77 ( struct V_153 * type ,
int V_154 , const char * V_155 ,
void * V_56 )
{
return F_78 ( type , V_154 , V_56 , F_74 ) ;
}
