...
{
struct V_3 * V_4 = V_6 -> V_37 ;
return F_30 ( V_4 -> V_34 -> V_41 , V_4 -> V_34 -> V_64 , V_62 , V_63 ) ;
}
static int F_31 ( struct V_5 * V_6 , struct V_65 * V_66 ,
struct V_67 * V_68 , int V_69 )
{
struct V_3 * V_4 = V_6 -> V_37 ;
struct V_70 * V_71 = F_32 ( V_4 -> V_34 -> V_41 ) ;
if ( ! V_71 -> V_72 )
return V_69 ;
V_66 -> V_40 = V_4 -> V_34 -> V_41 ;
V_66 -> V_38 = F_14 ( V_6 , V_66 -> V_38 ) ;
return F_33 ( V_69 , V_71 -> V_72 ( V_71 , V_66 , V_68 ) ) ;
}
static int F_34 ( struct V_5 * V_6 , T_3 V_73 , void * V_43 )
{
struct V_3 * V_4 = V_6 -> V_37 ;
return V_73 ( V_6 , V_4 -> V_34 , V_4 -> V_30 , V_6 -> V_74 , V_43 ) ;
}
