...
return - V_98 ;
F_100 ( V_75 -> V_266 , V_77 [ V_75 -> V_105 ] . V_184 , sizeof( V_75 -> V_266 ) ) ;
...
if ( V_53 < 0 )
return V_53 ;
V_75 -> V_154 . V_267 . V_268 = 0 ;
F_19 ( & V_2 -> V_86 , 0 , V_269 , V_270 , & V_75 -> V_154 . V_267 ) ;
if ( V_75 -> V_154 . V_267 . V_268 == 0 )
V_53 = - V_98 ;
return V_53 ;
}
...
struct V_71 * V_72 = V_152 ;
struct V_1 * V_2 = V_72 -> V_2 ;
V_77 -> V_154 . V_269 . V_271 = V_2 -> V_35 ;
V_77 -> V_154 . V_269 . V_272 = V_273 ;
V_77 -> V_154 . V_269 . V_26 = 0 ;
V_77 -> V_154 . V_269 . V_89 = 0 ;
V_77 -> V_154 . V_269 . V_274 = 6750000 * 4 / 2 ;
V_77 -> V_154 . V_269 . V_70 [ 0 ] = V_2 -> V_36 ;
V_77 -> V_154 . V_269 . V_70 [ 1 ] = V_2 -> V_36 ;
if ( V_2 -> V_170 & V_275 ) {
V_77 -> V_154 . V_269 . V_276 [ 0 ] = 10 ;
V_77 -> V_154 . V_269 . V_276 [ 1 ] = 273 ;
} else if ( V_2 -> V_170 & V_277 ) {
V_77 -> V_154 . V_269 . V_276 [ 0 ] = 6 ;
V_77 -> V_154 . V_269 . V_276 [ 1 ] = 318 ;
}
return 0 ;
}
...
return V_53 ;
if ( V_72 -> type == V_126 )
return F_108 ( & V_72 -> V_167 , V_279 ) ;
else
return F_108 ( & V_72 -> V_245 , V_279 ) ;
}
...
return V_53 ;
if ( V_72 -> type == V_126 )
return F_110 ( & V_72 -> V_167 , V_281 ) ;
else {
int V_282 = F_110 ( & V_72 -> V_245 , V_281 ) ;
V_281 -> V_283 = V_2 -> V_35 * V_2 -> V_36 * 2 ;
return V_282 ;
}
}
static int F_111 ( struct V_151 * V_151 , void * V_152 , struct V_280 * V_281 )
{
struct V_71 * V_72 = V_152 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
return V_53 ;
if ( V_72 -> type == V_126 )
return F_112 ( & V_72 -> V_167 , V_281 ) ;
else
return F_112 ( & V_72 -> V_245 , V_281 ) ;
}
static int F_113 ( struct V_151 * V_151 , void * V_152 , struct V_280 * V_281 )
{
struct V_71 * V_72 = V_152 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
return V_53 ;
if ( V_72 -> type == V_126 )
return F_114 ( & V_72 -> V_167 , V_281 , V_151 -> V_284 &
V_285 ) ;
else
return F_114 ( & V_72 -> V_245 , V_281 , V_151 -> V_284 &
V_285 ) ;
}
...
static int F_123 ( struct V_151 * V_288 )
{
int V_289 = 0 , V_83 = 0 ;
struct V_290 * V_190 = F_124 ( V_288 ) ;
struct V_1 * V_2 = F_125 ( V_288 ) ;
enum V_244 V_291 = 0 ;
struct V_71 * V_72 ;
enum V_93 V_94 ;
switch ( V_190 -> V_292 ) {
...
F_38 ( L_51 ,
F_126 ( V_190 ) , V_296 [ V_291 ] ,
V_2 -> V_297 ) ;
V_72 = F_127 ( sizeof( struct V_71 ) , V_298 ) ;
if ( ! V_72 ) {
F_49 ( L_52 ) ;
return - V_299 ;
}
...
V_72 -> type = V_291 ;
V_288 -> V_300 = V_72 ;
if ( V_72 -> type == V_126 && V_2 -> V_297 == 0 ) {
F_128 ( V_2 , V_301 ) ;
F_58 ( V_2 ) ;
F_59 ( V_2 ) ;
F_129 ( V_2 ) ;
...
V_94 = V_163 ;
F_130 ( & V_72 -> V_167 , & V_303 ,
NULL , & V_2 -> V_90 ,
V_126 , V_94 ,
sizeof( struct V_5 ) , V_72 , & V_2 -> V_304 ) ;
F_130 ( & V_72 -> V_245 , & V_305 ,
NULL , & V_2 -> V_90 ,
V_128 ,
V_306 ,
sizeof( struct V_5 ) , V_72 , & V_2 -> V_304 ) ;
...
static int F_136 ( struct V_151 * V_288 )
{
struct V_71 * V_72 = V_288 -> V_300 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_289 ;
F_38 ( L_55 , V_2 -> V_297 ) ;
if ( F_39 ( V_72 , V_127 ) ) {
...
F_19 ( & V_2 -> V_86 , 0 , V_171 , V_308 , 0 ) ;
F_140 ( V_2 ) ;
F_128 ( V_2 , V_309 ) ;
V_2 -> V_310 = 0 ;
F_38 ( L_56 ) ;
V_289 = F_141 ( V_2 -> V_252 , 0 , 0 ) ;
if ( V_289 < 0 ) {
F_49 ( L_57
L_58 , V_289 ) ;
}
...
static T_3
F_144 ( struct V_151 * V_288 , char T_4 * V_6 , T_5 V_70 ,
T_6 * V_31 )
{
struct V_71 * V_72 = V_288 -> V_300 ;
struct V_1 * V_2 = V_72 -> V_2 ;
...
static unsigned int F_146 ( struct V_151 * V_288 , T_7 * V_312 )
{
struct V_71 * V_72 = V_288 -> V_300 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
if ( ! F_37 ( V_72 , V_127 ) )
return V_313 ;
return F_147 ( V_288 , & V_72 -> V_167 , V_312 ) ;
} else if ( V_72 -> type == V_128 ) {
if ( ! F_37 ( V_72 , V_129 ) )
return V_313 ;
return F_147 ( V_288 , & V_72 -> V_245 , V_312 ) ;
} else {
return V_313 ;
}
}
static int F_148 ( struct V_151 * V_288 , struct V_314 * V_315 )
{
struct V_71 * V_72 = V_288 -> V_300 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
return V_53 ;
if ( V_72 -> type == V_126 )
V_53 = F_149 ( & V_72 -> V_167 , V_315 ) ;
else if ( V_72 -> type == V_128 )
V_53 = F_149 ( & V_72 -> V_245 , V_315 ) ;
F_38 ( L_59 ,
( unsigned long ) V_315 -> V_316 ,
( unsigned long ) V_315 -> V_317 - ( unsigned long ) V_315 -> V_316 ,
V_53 ) ;
return V_53 ;
}
static struct V_290 * F_150 ( struct V_1 * V_2 ,
const struct V_290 * V_318 ,
const char * V_319 )
{
struct V_290 * V_320 ;
V_320 = F_151 () ;
...
V_320 -> V_321 = F_134 ;
V_320 -> V_322 = V_323 ;
V_320 -> V_304 = & V_2 -> V_304 ;
snprintf ( V_320 -> V_184 , sizeof( V_320 -> V_184 ) , L_60 ,
V_2 -> V_184 , V_319 ) ;
F_152 ( V_320 , V_2 ) ;
return V_320 ;
}
...
V_2 -> V_138 = 1 ;
V_2 -> V_140 = 0x1f ;
V_229 = ( T_8 ) F_87 ( V_2 , V_329 ) ;
F_155 ( V_2 , V_329 ,
( V_330 | V_229 ) ) ;
F_156 ( V_2 ) ;
F_157 ( V_2 ) ;
F_158 ( V_2 ) ;
V_2 -> V_190 = F_150 ( V_2 , & V_326 , L_62 ) ;
if ( ! V_2 -> V_190 ) {
F_49 ( L_63 ) ;
return - V_145 ;
}
V_226 = F_159 ( V_2 -> V_190 , V_293 ,
V_331 [ V_2 -> V_332 ] ) ;
if ( V_226 ) {
F_49 ( L_64 ,
V_226 ) ;
...
if ( F_28 ( V_2 ) == 1 ) {
V_2 -> V_259 = F_150 ( V_2 , & V_326 ,
L_65 ) ;
V_226 = F_159 ( V_2 -> V_259 , V_294 ,
V_333 [ V_2 -> V_332 ] ) ;
if ( V_226 < 0 ) {
F_49 ( L_66 ) ;
return V_226 ;
...
if ( V_250 [ V_2 -> V_251 ] . V_83 . type == V_334 ) {
V_2 -> V_307 = F_150 ( V_2 , & V_335 ,
L_67 ) ;
if ( ! V_2 -> V_307 ) {
F_49 ( L_63 ) ;
return - V_145 ;
}
V_226 = F_159 ( V_2 -> V_307 , V_295 ,
V_336 [ V_2 -> V_332 ] ) ;
if ( V_226 < 0 ) {
F_49 ( L_68 ) ;
return V_226 ;
