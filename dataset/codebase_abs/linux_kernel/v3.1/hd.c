...
V_76:
V_69 = V_19 ;
F_33 ( V_60 , V_69 -> V_77 , 256 ) ;
#ifdef F_34
F_14 ( L_32 ,
V_69 -> V_23 -> V_24 , F_15 ( V_69 ) + 1 ,
F_35 ( V_69 ) - 1 , V_69 -> V_77 + 512 ) ;
#endif
if ( F_8 ( 0 , 512 ) ) {
F_24 ( & F_32 ) ;
return;
...
static void F_39 ( unsigned long V_79 )
{
char * V_22 ;
V_80 = NULL ;
if ( ! V_19 )
...
static int F_42 ( struct V_50 * V_51 , struct V_68 * V_69 )
{
if ( V_51 -> V_65 ) {
V_51 -> V_65 = 0 ;
F_22 ( V_51 , V_51 -> V_11 , 0 , 0 , 0 , V_83 , & F_38 ) ;
return V_57 ;
}
if ( V_51 -> V_10 > 16 ) {
...
V_84 = F_15 ( V_69 ) ;
V_52 = F_35 ( V_69 ) ;
if ( V_84 >= F_45 ( V_69 -> V_23 ) ||
( ( V_84 + V_52 ) > F_45 ( V_69 -> V_23 ) ) ) {
F_14 ( L_37 ,
...
F_14 ( L_38 ,
V_69 -> V_23 -> V_24 ,
F_46 ( V_69 ) == V_88 ? L_39 : L_40 ,
V_12 , V_10 , V_85 , V_52 , V_69 -> V_77 ) ;
#endif
if ( V_69 -> V_89 == V_90 ) {
switch ( F_47 ( V_69 ) ) {
case V_88 :
...
static T_2 F_50 ( int V_104 , void * V_105 )
{
void (* F_51)( void ) = V_80 ;
F_52 ( V_81 -> V_82 ) ;
V_80 = NULL ;
...
V_51 -> V_70 = V_113 ;
F_62 ( V_51 , V_113 -> V_10 * V_113 -> V_11 * V_113 -> V_12 ) ;
V_51 -> V_119 = V_81 ;
V_113 -> V_58 = V_48 ;
V_120 [ V_48 ] = V_51 ;
F_14 ( L_46 ,
V_51 -> V_24 , ( unsigned long ) F_45 ( V_51 ) / 2048 ,
V_113 -> V_12 , V_113 -> V_10 , V_113 -> V_11 ) ;
}
if ( F_63 ( V_121 , F_50 , V_122 , L_42 , NULL ) ) {
F_14 ( L_47 ,
V_121 ) ;
goto V_123;
}
...
static int T_1 F_70 ( char * line )
{
int V_7 [ 6 ] ;
( void ) F_71 ( line , F_72 ( V_7 ) , V_7 ) ;
F_7 ( NULL , V_7 ) ;
return 1 ;
}
