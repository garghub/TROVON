...
int T_1 F_45 ( unsigned long V_17 ,
...
static int T_1 F_46 ( struct V_43 * V_44 ,
...
if ( F_18 () )
return;
F_49 (nid, N_HIGH_MEMORY) {
unsigned long V_17 , V_57 ;
V_17 = V_14 ( V_15 ) ;
V_57 = F_50 ( V_15 ) ;
for ( V_11 = V_17 ;
V_11 < V_57 ;
V_11 = F_51 ( V_11 + 1 , V_36 ) ) {
if ( ! F_52 ( V_11 ) )
continue;
if ( F_43 ( V_11 ) != V_15 )
continue;
...
unsigned short F_57 ( T_5 V_67 ,
unsigned short V_68 , unsigned short V_69 )
{
int type = F_58 ( V_67 ) ;
unsigned long V_12 = F_59 ( V_67 ) ;
...
unsigned short F_63 ( T_5 V_67 , unsigned short V_3 )
{
int type = F_58 ( V_67 ) ;
unsigned long V_12 = F_59 ( V_67 ) ;
unsigned long V_61 = V_12 / V_70 ;
...
int F_65 ( int type , unsigned long V_78 )
{
void * V_79 ;
unsigned long V_80 ;
unsigned long V_63 ;
