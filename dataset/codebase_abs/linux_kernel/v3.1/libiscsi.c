...
break;
case V_414 :
sscanf ( V_395 , L_118 , & V_5 -> V_415 ) ;
break;
case V_416 :
sscanf ( V_395 , L_118 , & V_5 -> V_417 ) ;
break;
case V_418 :
sscanf ( V_395 , L_118 , & V_5 -> V_419 ) ;
break;
case V_420 :
sscanf ( V_395 , L_118 , & V_397 ) ;
F_16 ( V_397 ) ;
break;
case V_421 :
sscanf ( V_395 , L_118 , & V_397 ) ;
...
case V_428 :
sscanf ( V_395 , L_118 , & V_5 -> V_429 ) ;
break;
case V_430 :
sscanf ( V_395 , L_118 , & V_2 -> V_431 ) ;
break;
case V_432 :
...
break;
case V_414 :
V_44 = sprintf ( V_395 , L_120 , V_5 -> V_415 ) ;
break;
case V_416 :
V_44 = sprintf ( V_395 , L_120 , V_5 -> V_417 ) ;
break;
case V_418 :
V_44 = sprintf ( V_395 , L_120 , V_5 -> V_419 ) ;
break;
case V_427 :
V_44 = sprintf ( V_395 , L_122 , V_5 -> V_317 ) ;
break;
case V_428 :
V_44 = sprintf ( V_395 , L_120 , V_5 -> V_429 ) ;
break;
case V_423 :
...
case V_445 :
if ( sin )
V_44 = sprintf ( V_395 , L_123 , & sin -> V_446 . V_447 ) ;
else
V_44 = sprintf ( V_395 , L_124 , & V_439 -> V_448 ) ;
break;
case V_449 :
if ( sin )
V_44 = sprintf ( V_395 , L_121 , F_22 ( sin -> V_450 ) ) ;
else
...
break;
case V_404 :
V_44 = sprintf ( V_395 , L_3 , V_2 -> V_405 ) ;
break;
case V_406 :
...
break;
case V_421 :
V_44 = sprintf ( V_395 , L_120 , V_2 -> V_453 ) ;
break;
case V_422 :
V_44 = sprintf ( V_395 , L_3 , V_2 -> V_35 ) ;
break;
case V_430 :
V_44 = sprintf ( V_395 , L_120 , V_2 -> V_431 ) ;
break;
case V_432 :
...
int F_192 ( struct V_3 * V_4 , enum V_454 V_390 ,
char * V_395 )
{
struct V_7 * V_8 = F_2 ( V_4 ) ;
int V_44 ;
...
int F_193 ( struct V_3 * V_4 , enum V_454 V_390 ,
