...
while ( V_20 > 0 ) {
V_155 = V_152 ;
error = F_104 ( args -> V_51 , args -> V_22 , ( V_159 ) V_158 ,
args -> V_121 ,
V_160 | V_161 ,
...
V_153 = F_105 ( V_33 , V_151 [ V_144 ] . V_162 ) ;
V_157 = F_106 ( V_33 , V_151 [ V_144 ] . V_165 ) ;
error = F_107 ( V_33 , V_33 -> V_166 , V_153 ,
V_157 , V_167 | V_168 ,
& V_113 ) ;
if ( error )
return ( error ) ;
...
? V_20 : F_108 ( V_113 ) ;
F_109 ( V_113 , 0 , V_156 , V_154 , V_169 ) ;
F_110 ( V_113 ) ;
V_154 += V_156 ;
V_20 -= V_156 ;
...
V_170 = 0 ;
error = F_111 ( args -> V_51 , args -> V_22 , V_157 , & V_170 ,
V_24 ) ;
if ( error ) {
return ( error ) ;
}
...
F_35 ( args -> V_40 , args -> V_39 ) ;
V_155 = 1 ;
error = F_104 ( args -> V_51 , V_22 , ( V_159 ) V_158 ,
V_157 ,
V_160 | V_161 |
V_172 ,
...
F_35 ( args -> V_40 , args -> V_39 ) ;
V_155 = 1 ;
error = F_104 ( NULL , V_22 , ( V_159 ) V_158 ,
args -> V_121 ,
V_160 | V_161 ,
...
ASSERT ( ( V_151 . V_162 != V_163 ) &&
( V_151 . V_162 != V_164 ) ) ;
V_153 = F_105 ( V_33 , V_151 . V_162 ) ,
V_157 = F_106 ( V_33 , V_151 . V_165 ) ;
V_113 = F_112 ( V_33 -> V_166 , V_153 , V_157 ,
V_167 | V_168 ) ;
ASSERT ( ! F_113 ( V_113 ) ) ;
V_156 = ( V_20 < F_108 ( V_113 ) ) ? V_20 :
F_108 ( V_113 ) ;
F_109 ( V_113 , 0 , V_156 , V_171 , V_173 ) ;
if ( V_156 < F_108 ( V_113 ) )
F_114 ( V_113 , V_156 , F_108 ( V_113 ) - V_156 ) ;
if ( ( error = F_115 ( V_33 , V_113 ) ) ) {
return ( error ) ;
}
V_171 += V_156 ;
V_20 -= V_156 ;
...
F_35 ( args -> V_40 , args -> V_39 ) ;
V_155 = 1 ;
error = F_104 ( NULL , args -> V_22 , ( V_159 ) V_158 ,
args -> V_121 ,
V_160 | V_161 ,
args -> V_39 , 0 , & V_151 , & V_155 ,
args -> V_40 ) ;
...
V_153 = F_105 ( V_33 , V_151 . V_162 ) ,
V_157 = F_106 ( V_33 , V_151 . V_165 ) ;
V_113 = F_116 ( V_33 -> V_166 , V_153 , V_157 , V_175 ) ;
if ( V_113 ) {
F_117 ( V_113 ) ;
F_118 ( V_113 ) ;
F_110 ( V_113 ) ;
...
while ( ! V_174 ) {
F_35 ( args -> V_40 , args -> V_39 ) ;
error = F_119 ( args -> V_51 , args -> V_22 , V_158 , V_157 ,
V_160 | V_161 ,
