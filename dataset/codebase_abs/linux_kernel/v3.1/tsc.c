...
V_13 = F_26 () ;
F_60 ( & V_124 , V_5 ) ;
V_119 = F_12 ( & V_120 , V_13 ) ;
return;
}
V_121 = F_12 ( & V_122 , V_13 ) ;
if ( V_120 == V_122 )
goto V_123;
if ( V_119 == V_20 || V_121 == V_20 )
goto V_123;
V_35 = V_121 - V_119 ;
V_35 *= 1000000LL ;
if ( V_13 )
V_87 = F_16 ( V_35 , V_120 , V_122 ) ;
else
V_87 = F_18 ( V_35 , V_120 , V_122 ) ;
if ( abs ( V_67 - V_87 ) > V_67 / 100 )
goto V_123;
V_67 = V_87 ;
F_9 ( V_60 L_21
L_22 , ( unsigned long ) V_67 / 1000 ,
