...
int F_156 ( struct V_6 * V_7 , struct V_73 * V_74 )
{
struct V_116 * V_117 = F_6 ( V_7 ) ;
int V_264 ;
int V_137 = F_76 ( V_7 ) ;
if ( ! F_157 ( V_7 , V_268 , V_74 ) )
goto V_269;
F_158 ( V_74 ) ;
if ( V_117 -> V_270 ) {
...
static void F_165 ( struct V_6 * * V_277 , unsigned int V_34 ,
...
V_7 = V_277 [ V_279 ] ;
if ( F_87 ( V_280 == NULL ) )
V_280 = ( V_279 == V_278 ) ? V_74 : F_166 ( V_74 , V_281 ) ;
if ( ! V_280 ) {
F_121 ( & V_7 -> V_233 ) ;
F_120 ( F_5 ( V_7 ) , V_267 ,
F_76 ( V_7 ) ) ;
...
if ( V_280 && F_156 ( V_7 , V_280 ) <= 0 )
V_280 = NULL ;
}
if ( F_40 ( V_280 ) )
F_154 ( V_280 ) ;
}
static int F_167 ( struct V_1 * V_1 , struct V_73 * V_74 ,
struct V_85 * V_86 ,
T_2 V_47 , T_2 V_55 ,
struct V_20 * V_21 )
{
...
while ( V_7 ) {
V_277 [ V_34 ++ ] = V_7 ;
V_7 = F_56 ( V_1 , F_169 ( V_7 ) , V_86 -> V_91 ,
V_55 , V_86 -> V_92 , V_47 , V_57 ) ;
if ( F_40 ( V_34 == F_170 ( V_277 ) ) ) {
if ( ! V_7 )
break;
F_165 ( V_277 , V_34 , V_74 , ~ 0 ) ;
V_34 = 0 ;
}
}
for ( V_279 = 0 ; V_279 < V_34 ; V_279 ++ )
...
static inline int F_172 ( struct V_73 * V_74 , struct V_85 * V_86 ,
int V_282 )
{
...
if ( ! F_135 ( V_74 ) )
V_74 -> V_126 = F_174 ( V_76 -> V_47 , V_76 -> V_55 ,
V_74 -> V_119 , V_282 , 0 ) ;
return 0 ;
}
int F_175 ( struct V_73 * V_74 , struct V_20 * V_21 ,
int V_282 )
{
struct V_6 * V_7 ;
struct V_85 * V_86 ;
unsigned short V_157 ;
struct V_160 * V_161 = F_176 ( V_74 ) ;
T_2 V_47 , V_55 ;
struct V_1 * V_1 = F_52 ( V_74 -> V_77 ) ;
if ( ! F_177 ( V_74 , sizeof( struct V_85 ) ) )
goto V_269;
V_86 = F_67 ( V_74 ) ;
...
goto V_286;
if ( V_282 == V_130 ) {
if ( V_157 < sizeof( * V_86 ) || F_178 ( V_74 , V_157 ) )
goto V_286;
V_86 = F_67 ( V_74 ) ;
}
if ( F_172 ( V_74 , V_86 , V_282 ) )
goto V_287;
if ( V_161 -> V_211 & ( V_212 | V_288 ) )
return F_167 ( V_1 , V_74 , V_86 ,
V_47 , V_55 , V_21 ) ;
V_7 = F_49 ( V_74 , V_86 -> V_92 , V_86 -> V_91 , V_21 ) ;
if ( V_7 != NULL ) {
int V_227 = F_156 ( V_7 , V_74 ) ;
F_42 ( V_7 ) ;
if ( V_227 > 0 )
return - V_227 ;
return 0 ;
}
if ( ! F_157 ( NULL , V_268 , V_74 ) )
goto V_269;
F_158 ( V_74 ) ;
if ( F_119 ( V_74 ) )
goto V_287;
F_120 ( V_1 , V_289 , V_282 == V_283 ) ;
F_179 ( V_74 , V_101 , V_290 , 0 ) ;
F_154 ( V_74 ) ;
return 0 ;
V_286:
F_107 ( V_218 L_6 ,
...
int F_180 ( struct V_73 * V_74 )
{
return F_175 ( V_74 , & V_20 , V_130 ) ;
}
...
int F_182 ( struct V_6 * V_7 , int V_291 , int V_292 ,
char V_239 * V_293 , unsigned int V_197 ,
int (* F_183)( struct V_6 * ) )
{
struct V_116 * V_117 = F_6 ( V_7 ) ;
int V_294 ;
int V_90 = 0 ;
...
if ( V_197 < sizeof( int ) )
return - V_178 ;
if ( F_184 ( V_294 , ( int V_239 * ) V_293 ) )
return - V_295 ;
switch ( V_292 ) {
case V_296 :
if ( V_294 != 0 ) {
...
int F_185 ( struct V_6 * V_7 , int V_291 , int V_292 ,
char V_239 * V_293 , unsigned int V_197 )
{
if ( V_291 == V_309 || V_291 == V_310 )
return F_182 ( V_7 , V_291 , V_292 , V_293 , V_197 ,
F_82 ) ;
return F_186 ( V_7 , V_291 , V_292 , V_293 , V_197 ) ;
}
int F_187 ( struct V_6 * V_7 , int V_291 , int V_292 ,
char V_239 * V_293 , unsigned int V_197 )
{
if ( V_291 == V_309 || V_291 == V_310 )
return F_182 ( V_7 , V_291 , V_292 , V_293 , V_197 ,
...
int F_189 ( struct V_6 * V_7 , int V_291 , int V_292 ,
char V_239 * V_293 , int V_239 * V_197 )
{
struct V_116 * V_117 = F_6 ( V_7 ) ;
int V_294 , V_119 ;
if ( F_184 ( V_119 , V_197 ) )
return - V_295 ;
V_119 = F_190 (unsigned int, len, sizeof(int)) ;
if ( V_119 < 0 )
return - V_178 ;
switch ( V_292 ) {
case V_296 :
...
return - V_295 ;
if ( F_191 ( V_293 , & V_294 , V_119 ) )
return - V_295 ;
return 0 ;
}
int F_192 ( struct V_6 * V_7 , int V_291 , int V_292 ,
char V_239 * V_293 , int V_239 * V_197 )
{
if ( V_291 == V_309 || V_291 == V_310 )
return F_189 ( V_7 , V_291 , V_292 , V_293 , V_197 ) ;
return F_193 ( V_7 , V_291 , V_292 , V_293 , V_197 ) ;
}
int F_194 ( struct V_6 * V_7 , int V_291 , int V_292 ,
char V_239 * V_293 , int V_239 * V_197 )
{
if ( V_291 == V_309 || V_291 == V_310 )
return F_189 ( V_7 , V_291 , V_292 , V_293 , V_197 ) ;
return F_195 ( V_7 , V_291 , V_292 , V_293 , V_197 ) ;
}
unsigned int F_196 ( struct V_311 * V_311 , struct V_312 * V_6 , T_7 * V_313 )
{
unsigned int V_31 = F_197 ( V_311 , V_6 , V_313 ) ;
...
static struct V_6 * F_198 ( struct V_320 * V_321 , int V_322 )
{
struct V_6 * V_7 ;
struct V_323 * V_324 = V_321 -> V_325 ;
struct V_1 * V_1 = F_199 ( V_321 ) ;
...
static struct V_6 * F_201 ( struct V_320 * V_321 , struct V_6 * V_7 )
{
struct V_323 * V_324 = V_321 -> V_325 ;
struct V_1 * V_1 = F_199 ( V_321 ) ;
do {
...
return F_198 ( V_321 , V_324 -> V_326 + 1 ) ;
}
return V_7 ;
}
static struct V_6 * F_202 ( struct V_320 * V_321 , T_8 V_328 )
{
struct V_6 * V_7 = F_198 ( V_321 , 0 ) ;
if ( V_7 )
while ( V_328 && ( V_7 = F_201 ( V_321 , V_7 ) ) != NULL )
-- V_328 ;
return V_328 ? NULL : V_7 ;
}
static void * F_203 ( struct V_320 * V_321 , T_8 * V_328 )
{
struct V_323 * V_324 = V_321 -> V_325 ;
V_324 -> V_326 = V_329 ;
return * V_328 ? F_202 ( V_321 , * V_328 - 1 ) : V_330 ;
}
static void * F_204 ( struct V_320 * V_321 , void * V_331 , T_8 * V_328 )
{
struct V_6 * V_7 ;
if ( V_331 == V_330 )
V_7 = F_202 ( V_321 , 0 ) ;
else
V_7 = F_201 ( V_321 , V_331 ) ;
++ * V_328 ;
return V_7 ;
}
static void F_205 ( struct V_320 * V_321 , void * V_331 )
{
struct V_323 * V_324 = V_321 -> V_325 ;
if ( V_324 -> V_326 <= V_324 -> V_20 -> V_31 )
F_21 ( & V_324 -> V_20 -> V_72 [ V_324 -> V_326 ] . V_17 ) ;
}
static int F_206 ( struct V_332 * V_332 , struct V_311 * V_311 )
{
struct V_333 * V_334 = F_207 ( V_332 ) -> V_84 ;
struct V_323 * V_82 ;
int V_90 ;
V_90 = F_208 ( V_332 , V_311 , & V_334 -> V_335 ,
sizeof( struct V_323 ) ) ;
if ( V_90 < 0 )
return V_90 ;
...
int F_209 ( struct V_1 * V_1 , struct V_333 * V_334 )
{
struct V_337 * V_338 ;
int V_264 = 0 ;
V_334 -> V_339 . V_340 = F_206 ;
V_334 -> V_339 . V_341 = V_342 ;
V_334 -> V_339 . V_343 = V_344 ;
V_334 -> V_339 . V_345 = V_346 ;
V_334 -> V_335 . V_322 = F_203 ;
V_334 -> V_335 . V_131 = F_204 ;
V_334 -> V_335 . V_347 = F_205 ;
V_338 = F_210 ( V_334 -> V_348 , V_349 , V_1 -> V_350 ,
& V_334 -> V_339 , V_334 ) ;
if ( ! V_338 )
V_264 = - V_266 ;
return V_264 ;
}
void F_211 ( struct V_1 * V_1 , struct V_333 * V_334 )
{
F_212 ( V_1 , V_334 -> V_348 ) ;
}
static void F_213 ( struct V_6 * V_351 , struct V_320 * V_352 ,
int V_326 , int * V_119 )
{
...
F_129 ( V_351 ) ,
F_215 ( V_351 ) ,
0 , 0L , 0 , F_216 ( V_351 ) , 0 , F_217 ( V_351 ) ,
F_218 ( & V_351 -> V_69 ) , V_351 ,
F_218 ( & V_351 -> V_233 ) , V_119 ) ;
}
int F_219 ( struct V_320 * V_321 , void * V_331 )
{
if ( V_331 == V_330 )
F_214 ( V_321 , L_12 ,
L_13
...
struct V_323 * V_324 = V_321 -> V_325 ;
int V_119 ;
F_213 ( V_331 , V_321 , V_324 -> V_326 , & V_119 ) ;
F_214 ( V_321 , L_16 , 127 - V_119 , L_8 ) ;
}
return 0 ;
}
static int T_9 F_220 ( struct V_1 * V_1 )
{
return F_209 ( V_1 , & V_355 ) ;
}
static void T_10 F_221 ( struct V_1 * V_1 )
{
F_211 ( V_1 , & V_355 ) ;
}
int T_11 F_222 ( void )
...
static int T_11 F_226 ( char * V_357 )
{
if ( ! V_357 )
return 0 ;
V_358 = F_227 ( V_357 , & V_357 , 0 ) ;
if ( V_358 && V_358 < V_359 )
V_358 = V_359 ;
return 1 ;
}
void T_11 F_228 ( struct V_20 * V_360 , const char * V_348 )
{
unsigned int V_279 ;
if ( ! V_361 )
V_360 -> V_72 = F_229 ( V_348 ,
2 * sizeof( struct V_3 ) ,
V_358 ,
21 ,
0 ,
...
V_360 -> V_72 = F_230 ( V_359 *
2 * sizeof( struct V_3 ) , V_362 ) ;
if ( ! V_360 -> V_72 )
F_231 ( V_348 ) ;
V_360 -> log = F_232 ( V_359 ) ;
V_360 -> V_31 = V_359 - 1 ;
}
V_360 -> V_70 = V_360 -> V_72 + ( V_360 -> V_31 + 1 ) ;
for ( V_279 = 0 ; V_279 <= V_360 -> V_31 ; V_279 ++ ) {
F_233 ( & V_360 -> V_72 [ V_279 ] . V_41 , V_279 ) ;
V_360 -> V_72 [ V_279 ] . V_34 = 0 ;
F_234 ( & V_360 -> V_72 [ V_279 ] . V_17 ) ;
}
for ( V_279 = 0 ; V_279 <= V_360 -> V_31 ; V_279 ++ ) {
F_233 ( & V_360 -> V_70 [ V_279 ] . V_41 , V_279 ) ;
V_360 -> V_70 [ V_279 ] . V_34 = 0 ;
F_234 ( & V_360 -> V_70 [ V_279 ] . V_17 ) ;
}
}
void T_11 F_235 ( void )
{
unsigned long V_363 ;
F_228 ( & V_20 , L_17 ) ;
V_363 = F_236 () / 8 ;
V_363 = F_237 ( V_363 , 128UL ) ;
V_364 [ 0 ] = V_363 / 4 * 3 ;
V_364 [ 1 ] = V_363 ;
V_364 [ 2 ] = V_364 [ 0 ] * 2 ;
V_365 = V_366 ;
...
int F_238 ( struct V_73 * V_74 )
{
const struct V_75 * V_76 ;
struct V_85 * V_86 ;
if ( ! F_177 ( V_74 , sizeof( * V_86 ) ) )
return - V_178 ;
V_76 = F_50 ( V_74 ) ;
V_86 = F_67 ( V_74 ) ;
...
struct V_73 * F_239 ( struct V_73 * V_74 , V_50 V_368 )
{
struct V_73 * V_369 = F_240 ( - V_178 ) ;
unsigned int V_370 ;
int V_124 ;
T_4 V_126 ;
...
goto V_98;
if ( F_241 ( V_74 , V_368 | V_372 ) ) {
int type = F_68 ( V_74 ) -> V_373 ;
if ( F_40 ( type & ~ ( V_374 | V_375 ) ||
! ( type & ( V_374 ) ) ) )
goto V_98;
F_68 ( V_74 ) -> V_376 = F_242 ( V_74 -> V_119 , V_370 ) ;
V_369 = NULL ;
goto V_98;
}
V_124 = F_243 ( V_74 ) ;
...
V_124 += V_74 -> V_128 ;
* ( V_377 * ) ( V_74 -> V_84 + V_124 ) = F_244 ( V_126 ) ;
V_74 -> V_132 = V_133 ;
V_369 = F_245 ( V_74 , V_368 ) ;
V_98:
return V_369 ;
}
