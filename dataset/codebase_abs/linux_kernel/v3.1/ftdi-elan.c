...
if ( ! V_3 -> V_111 &&
F_128 ( V_275 ) ) {
V_276 = F_129 ( V_275 -> V_281 ) ;
V_3 -> V_112 = V_276 ;
V_3 -> V_111 = V_275 -> V_282 ;
...
V_273 -> V_279 . V_283 , V_3 -> V_111 ,
V_3 -> V_132 ) ;
F_132 ( V_91 , V_3 ) ;
if ( V_273 -> V_279 . V_283 == 0 &&
V_3 -> V_111 == 0x81 &&
V_3 -> V_132 == 0x02 ) {
V_75 = F_133 ( V_91 , & V_284 ) ;
if ( V_75 ) {
...
} else if ( V_273 -> V_279 . V_283 == 1 &&
V_3 -> V_111 == 0x83 &&
V_3 -> V_132 == 0x04 ) {
V_3 -> V_285 = NULL ;
F_31 ( & V_3 -> V_4 -> V_5 , L_82
L_83 , V_3 , V_273 -> V_279 . V_283 ) ;
F_134 ( & V_3 -> V_13 , F_50 ) ;
F_134 ( & V_3 -> V_15 , F_42 ) ;
F_134 ( & V_3 -> V_17 , F_48 ) ;
...
V_3 -> V_6 += 1 ;
if ( V_3 -> V_285 ) {
int V_286 = V_91 -> V_286 ;
struct V_287 * V_285 = V_3 -> V_285 ;
F_132 ( V_91 , NULL ) ;
F_136 ( V_91 , V_285 ) ;
