...
V_3 F_60 ( struct V_65 * V_61 , V_3 V_134 )
{
struct V_4 * V_5 = F_33 ( V_61 ) ;
if ( ( V_5 -> V_71 & V_135 ) ) {
V_3 V_136 = V_134 ^ V_61 -> V_134 ;
...
int F_61 ( struct V_65 * V_61 , V_3 V_134 )
{
struct V_4 * V_5 = F_33 ( V_61 ) ;
V_3 V_136 = V_61 -> V_134 ^ V_134 ;
...
int
F_70 ( struct V_4 * V_5 , T_6 V_142 , V_3 V_157 )
{
unsigned long V_71 ;
int V_103 ;
void T_2 * V_1 = NULL ;
