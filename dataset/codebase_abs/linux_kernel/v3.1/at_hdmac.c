...
V_166 = F_97 ( V_165 ) ;
if ( ! F_98 ( V_165 -> V_174 , V_166 , V_161 -> V_76 . V_175 -> V_176 ) ) {
V_167 = - V_103 ;
goto V_177;
}
V_12 -> V_178 = F_99 ( V_165 -> V_174 , V_166 ) ;
if ( ! V_12 -> V_178 ) {
V_167 = - V_172 ;
goto V_179;
}
V_12 -> V_180 = F_100 ( & V_161 -> V_76 , L_36 ) ;
if ( F_101 ( V_12 -> V_180 ) ) {
V_167 = F_102 ( V_12 -> V_180 ) ;
goto V_181;
}
F_103 ( V_12 -> V_180 ) ;
F_92 ( V_12 ) ;
V_167 = F_104 ( V_69 , F_57 , 0 , L_37 , V_12 ) ;
if ( V_167 )
goto V_182;
F_105 ( V_161 , V_12 ) ;
V_12 -> V_15 = F_106 ( L_38 ,
...
V_12 -> V_75 . V_187 = F_88 ;
V_12 -> V_75 . V_188 = F_90 ;
V_12 -> V_75 . V_189 = F_84 ;
V_12 -> V_75 . V_190 = F_87 ;
V_12 -> V_75 . V_76 = & V_161 -> V_76 ;
if ( F_110 ( V_191 , V_12 -> V_75 . V_173 ) )
V_12 -> V_75 . V_192 = F_65 ;
if ( F_110 ( V_193 , V_12 -> V_75 . V_173 ) )
V_12 -> V_75 . V_194 = F_69 ;
if ( F_110 ( V_195 , V_12 -> V_75 . V_173 ) )
V_12 -> V_75 . V_196 = F_79 ;
if ( F_110 ( V_193 , V_12 -> V_75 . V_173 ) ||
F_110 ( V_195 , V_12 -> V_75 . V_173 ) )
V_12 -> V_75 . V_197 = F_82 ;
F_34 ( V_12 , V_157 , V_198 ) ;
F_111 ( & V_161 -> V_76 , L_40 ,
F_110 ( V_191 , V_12 -> V_75 . V_173 ) ? L_41 : L_42 ,
F_110 ( V_193 , V_12 -> V_75 . V_173 ) ? L_43 : L_42 ,
V_12 -> V_75 . V_77 ) ;
F_112 ( & V_12 -> V_75 ) ;
return 0 ;
V_183:
F_105 ( V_161 , NULL ) ;
F_113 ( F_95 ( V_161 , 0 ) , V_12 ) ;
V_182:
F_114 ( V_12 -> V_180 ) ;
F_115 ( V_12 -> V_180 ) ;
V_181:
...
static int F_127 ( struct V_13 * V_76 )
{
struct V_160 * V_161 = F_128 ( V_76 ) ;
struct V_11 * V_12 = F_120 ( V_161 ) ;
F_92 ( F_120 ( V_161 ) ) ;
F_114 ( V_12 -> V_180 ) ;
return 0 ;
}
static int F_129 ( struct V_13 * V_76 )
{
struct V_160 * V_161 = F_128 ( V_76 ) ;
struct V_11 * V_12 = F_120 ( V_161 ) ;
F_103 ( V_12 -> V_180 ) ;
