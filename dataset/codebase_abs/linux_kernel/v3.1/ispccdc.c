...
static void F_91 ( struct V_1 * V_2 , T_1 V_365 )
{
unsigned long V_114 ;
if ( V_365 & V_366 ) {
F_23 ( V_2 ) ;
...
struct V_370 * V_371 ;
int V_372 = 0 ;
if ( F_50 ( & V_2 -> V_325 . V_373 ) )
goto V_132;
if ( V_2 -> V_95 == V_339 && V_2 -> V_374 ) {
V_372 = 1 ;
V_2 -> V_374 = 0 ;
goto V_132;
}
...
V_371 = F_94 ( & V_2 -> V_325 , V_2 -> error ) ;
if ( V_371 != NULL ) {
F_66 ( V_2 , V_371 -> V_375 ) ;
V_372 = 1 ;
}
V_200 -> V_95 |= V_376 ;
if ( V_2 -> V_95 == V_377 &&
...
int F_99 ( struct V_1 * V_2 , T_1 V_365 )
{
if ( V_2 -> V_95 == V_193 )
return 0 ;
if ( V_365 & V_378 )
...
static int F_100 ( struct V_380 * V_381 , struct V_370 * V_371 )
{
struct V_1 * V_2 = & V_381 -> V_4 -> V_196 ;
if ( ! ( V_2 -> V_301 & V_302 ) )
return - V_382 ;
F_66 ( V_2 , V_371 -> V_375 ) ;
V_2 -> V_374 = 1 ;
...
static long F_101 ( struct V_276 * V_383 , unsigned int V_384 , void * V_385 )
{
struct V_1 * V_2 = F_102 ( V_383 ) ;
int V_124 ;
switch ( V_384 ) {
case V_386 :
F_81 ( & V_2 -> V_343 ) ;
V_124 = F_57 ( V_2 , V_385 ) ;
F_83 ( & V_2 -> V_343 ) ;
break;
default:
return - V_387 ;
...
static int F_103 ( struct V_276 * V_383 , struct V_388 * V_389 ,
struct V_390 * V_391 )
{
if ( V_391 -> type != V_364 )
return - V_57 ;
return F_104 ( V_389 , V_391 , V_392 ) ;
}
static int F_105 ( struct V_276 * V_383 , struct V_388 * V_389 ,
struct V_390 * V_391 )
{
return F_106 ( V_389 , V_391 ) ;
}
static int F_107 ( struct V_276 * V_383 , int V_86 )
{
struct V_1 * V_2 = F_102 ( V_383 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
int V_124 = 0 ;
...
static struct V_44 *
F_8 ( struct V_1 * V_2 , struct V_395 * V_389 ,
unsigned int V_285 , enum V_396 V_294 )
{
if ( V_294 == V_397 )
return F_110 ( V_389 , V_285 ) ;
else
return & V_2 -> V_297 [ V_285 ] ;
}
static void
F_111 ( struct V_1 * V_2 , struct V_395 * V_389 ,
unsigned int V_285 , struct V_44 * V_398 ,
enum V_396 V_294 )
{
struct V_44 * V_45 ;
const struct V_278 * V_399 ;
unsigned int V_63 = V_398 -> V_63 ;
unsigned int V_64 = V_398 -> V_64 ;
unsigned int V_400 ;
switch ( V_285 ) {
case V_61 :
for ( V_400 = 0 ; V_400 < F_112 ( V_401 ) ; V_400 ++ ) {
if ( V_398 -> V_87 == V_401 [ V_400 ] )
break;
}
if ( V_400 >= F_112 ( V_401 ) )
V_398 -> V_87 = V_88 ;
V_398 -> V_63 = F_113 ( T_1 , V_63 , 32 , 4096 ) ;
V_398 -> V_64 = F_113 ( T_1 , V_64 , 32 , 4096 ) ;
break;
case V_317 :
V_45 = F_8 ( V_2 , V_389 , V_61 , V_294 ) ;
memcpy ( V_398 , V_45 , sizeof( * V_398 ) ) ;
V_398 -> V_63 = F_113 ( T_1 , V_63 , 32 , ( V_398 -> V_63 + 15 ) & ~ 15 ) ;
V_398 -> V_63 &= ~ 15 ;
V_398 -> V_64 = F_113 ( T_1 , V_64 , 32 , V_398 -> V_64 ) ;
break;
case V_327 :
V_45 = F_8 ( V_2 , V_389 , V_61 , V_294 ) ;
memcpy ( V_398 , V_45 , sizeof( * V_398 ) ) ;
V_399 = F_74 ( V_398 -> V_87 ) ;
V_398 -> V_87 = V_399 -> V_402 ;
V_398 -> V_63 = F_113 ( T_1 , V_63 , 32 , V_398 -> V_63 ) ;
V_398 -> V_64 = F_113 ( T_1 , V_64 , 32 , V_398 -> V_64 - 1 ) ;
break;
}
V_398 -> V_403 = V_404 ;
V_398 -> V_405 = V_406 ;
}
static int F_114 ( struct V_276 * V_383 ,
struct V_395 * V_389 ,
struct V_407 * V_87 )
{
struct V_1 * V_2 = F_102 ( V_383 ) ;
...
switch ( V_87 -> V_285 ) {
case V_61 :
if ( V_87 -> V_293 >= F_112 ( V_401 ) )
return - V_57 ;
V_87 -> V_87 = V_401 [ V_87 -> V_293 ] ;
break;
case V_317 :
case V_327 :
if ( V_87 -> V_293 != 0 )
return - V_57 ;
V_45 = F_8 ( V_2 , V_389 , V_61 ,
V_397 ) ;
V_87 -> V_87 = V_45 -> V_87 ;
break;
default:
...
static int F_115 ( struct V_276 * V_383 ,
struct V_395 * V_389 ,
struct V_408 * V_409 )
{
struct V_1 * V_2 = F_102 ( V_383 ) ;
...
if ( V_409 -> V_293 != 0 )
return - V_57 ;
V_45 . V_87 = V_409 -> V_87 ;
V_45 . V_63 = 1 ;
V_45 . V_64 = 1 ;
F_111 ( V_2 , V_389 , V_409 -> V_285 , & V_45 , V_397 ) ;
V_409 -> V_50 = V_45 . V_63 ;
V_409 -> V_51 = V_45 . V_64 ;
if ( V_45 . V_87 != V_409 -> V_87 )
return - V_57 ;
V_45 . V_87 = V_409 -> V_87 ;
V_45 . V_63 = - 1 ;
V_45 . V_64 = - 1 ;
F_111 ( V_2 , V_389 , V_409 -> V_285 , & V_45 , V_397 ) ;
V_409 -> V_410 = V_45 . V_63 ;
V_409 -> V_411 = V_45 . V_64 ;
return 0 ;
}
static int F_116 ( struct V_276 * V_383 , struct V_395 * V_389 ,
struct V_280 * V_398 )
{
struct V_1 * V_2 = F_102 ( V_383 ) ;
struct V_44 * V_45 ;
V_45 = F_8 ( V_2 , V_389 , V_398 -> V_285 , V_398 -> V_294 ) ;
if ( V_45 == NULL )
return - V_57 ;
V_398 -> V_45 = * V_45 ;
return 0 ;
}
static int F_117 ( struct V_276 * V_383 , struct V_395 * V_389 ,
struct V_280 * V_398 )
{
struct V_1 * V_2 = F_102 ( V_383 ) ;
struct V_44 * V_45 ;
...
if ( V_45 == NULL )
return - V_57 ;
F_111 ( V_2 , V_389 , V_398 -> V_285 , & V_398 -> V_45 , V_398 -> V_294 ) ;
* V_45 = V_398 -> V_45 ;
if ( V_398 -> V_285 == V_61 ) {
V_45 = F_8 ( V_2 , V_389 , V_317 ,
V_398 -> V_294 ) ;
* V_45 = V_398 -> V_45 ;
F_111 ( V_2 , V_389 , V_317 , V_45 ,
V_398 -> V_294 ) ;
V_45 = F_8 ( V_2 , V_389 , V_327 ,
V_398 -> V_294 ) ;
* V_45 = V_398 -> V_45 ;
F_111 ( V_2 , V_389 , V_327 , V_45 ,
V_398 -> V_294 ) ;
}
return 0 ;
}
static int F_118 ( struct V_276 * V_383 , struct V_395 * V_389 )
{
struct V_280 V_45 ;
memset ( & V_45 , 0 , sizeof( V_45 ) ) ;
V_45 . V_285 = V_61 ;
V_45 . V_294 = V_389 ? V_397 : V_62 ;
V_45 . V_45 . V_87 = V_88 ;
V_45 . V_45 . V_63 = 4096 ;
V_45 . V_45 . V_64 = 4096 ;
F_117 ( V_383 , V_389 , & V_45 ) ;
return 0 ;
}
static int F_119 ( struct V_412 * V_202 ,
const struct V_284 * V_413 ,
const struct V_284 * V_414 , T_1 V_114 )
{
struct V_276 * V_383 = F_72 ( V_202 ) ;
struct V_1 * V_2 = F_102 ( V_383 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
switch ( V_413 -> V_293 | F_120 ( V_414 -> V_202 ) ) {
case V_61 | V_415 :
if ( ! ( V_114 & V_416 ) ) {
V_2 -> V_215 = V_417 ;
break;
...
if ( V_2 -> V_215 != V_417 )
return - V_103 ;
if ( V_414 -> V_202 == & V_4 -> V_418 . V_201 . V_202 )
V_2 -> V_215 = V_419 ;
else if ( V_414 -> V_202 == & V_4 -> V_420 . V_201 . V_202 )
V_2 -> V_215 = V_421 ;
else if ( V_414 -> V_202 == & V_4 -> V_422 . V_201 . V_202 )
V_2 -> V_215 = V_423 ;
else
V_2 -> V_215 = V_237 ;
break;
...
{
struct V_276 * V_383 = & V_2 -> V_201 ;
struct V_284 * V_288 = V_2 -> V_288 ;
struct V_412 * V_426 = & V_383 -> V_202 ;
int V_124 ;
V_2 -> V_215 = V_417 ;
F_122 ( V_383 , & V_427 ) ;
V_383 -> V_428 = & V_429 ;
F_123 ( V_383 -> V_430 , L_17 , sizeof( V_383 -> V_430 ) ) ;
V_383 -> V_431 = 1 << 16 ;
F_124 ( V_383 , V_2 ) ;
V_383 -> V_114 |= V_432 | V_433 ;
V_288 [ V_61 ] . V_114 = V_434 ;
V_288 [ V_327 ] . V_114 = V_435 ;
V_288 [ V_317 ] . V_114 = V_435 ;
V_426 -> V_436 = & V_437 ;
V_124 = F_125 ( V_426 , V_438 , V_288 , 0 ) ;
if ( V_124 < 0 )
return V_124 ;
F_118 ( V_383 , NULL ) ;
V_2 -> V_325 . type = V_439 ;
V_2 -> V_325 . V_436 = & V_440 ;
V_2 -> V_325 . V_4 = F_2 ( V_2 ) ;
V_2 -> V_325 . V_441 = F_126 ( 4096 * 4096 ) * 3 ;
V_2 -> V_325 . V_442 = 32 ;
V_124 = F_127 ( & V_2 -> V_325 , L_18 ) ;
if ( V_124 < 0 )
return V_124 ;
V_124 = F_128 ( & V_2 -> V_201 . V_202 , V_317 ,
& V_2 -> V_325 . V_381 . V_202 , 0 , 0 ) ;
if ( V_124 < 0 )
return V_124 ;
return 0 ;
}
...
{
int V_124 ;
V_124 = F_134 ( V_361 , & V_2 -> V_201 ) ;
if ( V_124 < 0 )
goto error;
V_124 = F_135 ( & V_2 -> V_325 , V_361 ) ;
if ( V_124 < 0 )
goto error;
return 0 ;
error:
