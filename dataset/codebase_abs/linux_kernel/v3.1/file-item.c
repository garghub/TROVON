...
struct V_51 * V_51 , T_1 V_10 , T_4 * V_53 )
{
return F_27 ( V_4 , V_50 , V_51 , V_10 , V_53 , 1 ) ;
}
...
if ( V_90 . V_10 > V_85 )
V_85 = V_90 . V_10 ;
V_95 = F_24 ( V_23 , V_21 -> V_29 [ 0 ] ) ;
V_96 = V_90 . V_10 + ( V_95 / V_37 ) * V_4 -> V_84 ;
if ( V_96 <= V_85 ) {
V_21 -> V_29 [ 0 ] ++ ;
continue;
}
V_96 = F_46 ( V_96 , V_86 + 1 ) ;
V_17 = F_6 ( V_21 -> V_28 [ 0 ] , V_21 -> V_29 [ 0 ] ,
struct V_32 ) ;
while ( V_85 < V_96 ) {
V_95 = F_47 ( T_5 , V_96 - V_85 ,
F_48 ( V_4 ) ) ;
V_92 = F_49 ( F_50 ( V_4 , V_95 ) ,
V_82 ) ;
F_5 ( ! V_92 ) ;
V_94 = V_92 -> V_92 ;
V_92 -> V_33 = V_85 ;
...
int F_52 ( struct V_3 * V_4 , struct V_50 * V_50 ,
struct V_51 * V_51 , T_1 V_98 , int V_99 )
{
struct V_91 * V_92 ;
struct V_93 * V_94 ;
struct V_100 * V_101 ;
...
T_1 V_62 ;
F_29 ( V_51 -> V_69 <= 0 ) ;
V_92 = F_49 ( F_50 ( V_4 , V_51 -> V_66 ) , V_82 ) ;
if ( ! V_92 )
return - V_24 ;
V_94 = V_92 -> V_92 ;
V_62 = ( T_1 ) V_51 -> V_72 << 9 ;
...
V_10 = F_31 ( V_57 -> V_73 ) + V_57 -> V_74 ;
V_101 = F_54 ( V_50 , V_10 ) ;
F_5 ( ! V_101 ) ;
V_92 -> V_33 = V_101 -> V_85 ;
while ( V_59 < V_51 -> V_69 ) {
if ( ! V_99 )
V_10 = F_31 ( V_57 -> V_73 ) + V_57 -> V_74 ;
if ( ! V_99 && ( V_10 >= V_101 -> V_105 + V_101 -> V_97 ||
V_10 < V_101 -> V_105 ) ) {
unsigned long V_106 ;
V_92 -> V_97 = V_104 ;
V_104 = 0 ;
F_55 ( V_50 , V_101 , V_92 ) ;
F_56 ( V_101 ) ;
V_106 = V_51 -> V_66 - V_103 ;
V_92 = F_49 ( F_50 ( V_4 , V_106 ) ,
V_82 ) ;
F_5 ( ! V_92 ) ;
V_94 = V_92 -> V_92 ;
V_92 -> V_97 = V_106 ;
...
static T_6 int F_61 ( struct V_1 * V_2 ,
struct V_3 * V_4 ,
struct V_20 * V_21 ,
struct V_18 * V_90 ,
T_1 V_33 , T_1 V_97 )
...
int V_15 ;
V_23 = V_21 -> V_28 [ 0 ] ;
V_96 = F_24 ( V_23 , V_21 -> V_29 [ 0 ] ) / V_37 ;
V_96 <<= V_4 -> V_38 -> V_44 -> V_45 ;
V_96 += V_90 -> V_10 ;
if ( V_90 -> V_10 < V_33 && V_96 <= V_108 ) {
T_4 V_110 = ( V_33 - V_90 -> V_10 ) >> V_109 ;
V_110 *= V_37 ;
V_15 = F_62 ( V_2 , V_4 , V_21 , V_110 , 1 ) ;
} else if ( V_90 -> V_10 >= V_33 && V_96 > V_108 &&
V_108 > V_90 -> V_10 ) {
T_4 V_110 = ( V_96 - V_108 ) >> V_109 ;
V_110 *= V_37 ;
V_15 = F_62 ( V_2 , V_4 , V_21 , V_110 , 0 ) ;
V_90 -> V_10 = V_108 ;
V_15 = F_63 ( V_2 , V_4 , V_21 , V_90 ) ;
F_5 ( V_15 ) ;
} else {
F_64 () ;
}
...
V_10 *= V_37 ;
V_111 = ( V_97 >> V_109 ) * V_37 ;
V_112 = F_67 ( V_23 ,
V_21 -> V_29 [ 0 ] ) ;
F_68 ( V_23 , 0 , V_112 + V_10 ,
V_111 ) ;
V_90 . V_10 = V_33 ;
V_15 = F_69 ( V_2 , V_4 , V_21 , & V_90 , V_10 ) ;
F_5 ( V_15 && V_15 != - V_113 ) ;
V_90 . V_10 = V_108 - 1 ;
} else {
V_15 = F_61 ( V_2 , V_4 , V_21 ,
& V_90 , V_33 , V_97 ) ;
F_5 ( V_15 ) ;
if ( V_90 . V_10 < V_33 )
break;
...
int V_122 = V_21 -> V_29 [ 0 ] + 1 ;
V_117 = F_44 ( V_21 -> V_28 [ 0 ] ) ;
...
V_36 = 0 ;
if ( V_115 ) {
T_1 V_124 = V_103 + V_4 -> V_84 ;
T_1 V_125 = V_94 -> V_33 ;
struct V_93 * V_126 = V_94 + 1 ;
while ( V_124 < V_92 -> V_97 ) {
if ( V_125 + V_4 -> V_84 != V_126 -> V_33 )
break;
V_124 += V_4 -> V_84 ;
V_125 = V_126 -> V_33 ;
V_126 ++ ;
}
V_124 = F_46 ( V_124 , V_114 - V_19 . V_10 ) ;
V_124 >>= V_4 -> V_38 -> V_44 -> V_45 ;
V_124 = F_73 ( ( T_1 ) 1 , V_124 ) ;
V_124 = F_46 ( V_124 , ( T_1 ) F_71 ( V_4 , V_37 ) ) ;
V_118 = V_37 * V_124 ;
} else {
V_118 = V_37 ;
}
...
V_125:
F_74 ( V_23 , & V_94 -> V_55 , ( unsigned long ) V_17 , V_37 ) ;
V_103 += V_4 -> V_84 ;
V_94 ++ ;
if ( V_103 < V_92 -> V_97 ) {
