...
int V_36 = 0 ;
unsigned long V_37 ;
F_47 ( & V_75 -> V_124 , & type , & V_122 , & V_11 ) ;
F_48 ( V_6 , V_43 ) ;
F_13 ( & V_6 -> V_125 , V_37 ) ;
if ( V_6 -> V_1 == V_126 ) {
if ( ! V_122 ) {
...
{
struct V_27 * V_28 ;
T_4 V_136 = V_75 -> V_139 . V_140 . V_136 ;
unsigned long V_37 ;
V_28 = & V_6 -> V_35 [ V_138 - V_6 -> V_141 - V_6 -> V_142 ] ;
F_13 ( & V_6 -> V_40 [ 0 ] , V_37 ) ;
if ( F_53 ( V_28 , V_136 ) ) {
V_6 -> V_31 [ 0 ] = V_136 ;
V_6 -> V_29 [ 0 ] = 1 ;
...
F_43 ( V_8 ) = V_120 ;
V_146 = & V_75 -> V_139 . V_146 ;
switch ( V_122 ) {
case V_150 :
V_8 -> V_106 = ( V_151 << 16 ) | V_146 -> V_152 ;
V_144 = F_34 ( V_8 ) ;
F_59 ( V_8 , V_146 -> V_153 ) ;
if ( V_146 -> V_37 & V_154 )
V_144 -= V_146 -> V_153 ;
...
break;
case V_164 :
V_8 -> V_106 = ( V_165 << 16 ) | V_146 -> V_152 ;
break;
case V_166 :
V_8 -> V_106 = ( V_167 << 16 ) | V_146 -> V_152 ;
break;
case V_168 :
F_59 ( V_8 , V_146 -> V_153 ) ;
V_8 -> V_106 = ( V_167 << 16 ) | V_146 -> V_152 ;
break;
case V_169 :
V_8 -> V_106 = ( V_170 << 16 ) | V_146 -> V_152 ;
break;
case V_171 :
case V_172 :
case V_173 :
...
F_9 ( V_15 , V_6 -> V_110 ) ;
if ( V_8 -> V_93 == V_94 ) {
V_6 -> V_45 -> V_179 . V_180 ++ ;
V_6 -> V_181 += V_144 ;
} else if ( V_8 -> V_93 == V_96 ) {
V_6 -> V_45 -> V_179 . V_182 ++ ;
V_6 -> V_183 += V_144 ;
} else
V_6 -> V_45 -> V_179 . V_184 ++ ;
if ( V_8 -> V_118 )
V_8 -> V_118 ( V_8 ) ;
}
...
F_47 ( & V_75 -> V_124 , & type , & V_122 , & V_11 ) ;
F_56 ( & V_11 , & V_143 ) ;
if ( ( V_143 & V_185 ) >= V_147 )
return;
V_8 = F_57 ( V_6 -> V_45 -> V_46 , V_143 & V_185 ) ;
F_58 ( ! V_8 ) ;
if ( ! V_8 )
return;
V_119 = F_5 ( V_6 , V_8 ) ;
...
F_62 ( V_178 , V_6 -> V_45 -> V_46 ,
L_21 ,
F_3 ( F_43 ( V_8 ) ) , V_143 ) ;
F_16 ( V_119 , V_37 ) ;
}
}
static int F_66 ( struct V_191 * V_192 ,
unsigned int V_138 ,
struct V_121 * V_75 )
{
struct V_6 * V_6 = F_67 ( V_192 ) ;
int V_36 = 0 ;
switch ( V_75 -> V_124 . type ) {
case V_193 :
F_54 ( V_6 , V_138 , V_75 ) ;
break;
case V_194 :
...
int F_68 ( struct V_6 * V_6 , int V_199 )
{
unsigned int V_200 = 0 ;
unsigned int V_77 , V_138 ;
unsigned int V_201 ;
for ( V_77 = 0 ; V_77 < V_6 -> V_202 ; V_77 ++ ) {
V_138 = V_77 + V_6 -> V_141 + V_6 -> V_142 ;
V_201 = F_69 ( & V_6 -> V_203 [ V_138 ] ,
F_66 ,
V_199 ) ;
V_200 += V_201 ;
}
...
static void F_48 ( struct V_6 * V_6 , int V_204 )
{
unsigned int V_77 ;
struct V_14 * V_15 ;
...
{
T_2 V_143 ;
struct V_6 * V_6 = F_67 ( V_28 -> V_192 ) ;
struct V_14 * V_15 ;
struct V_7 * V_8 ;
unsigned long V_37 ;
T_1 * V_119 ;
F_56 ( & V_75 -> V_124 . V_11 , & V_143 ) ;
V_143 &= V_185 ;
if ( V_143 >= V_147 )
return;
V_8 = F_57 ( V_6 -> V_45 -> V_46 , V_143 ) ;
...
F_72 ( V_28 , V_11 | V_186 ,
0 , V_210 , V_11 , V_81 , V_15 -> V_103 ,
V_6 -> V_60 . V_211 , V_6 -> V_60 . V_212 ) ;
F_16 ( & V_6 -> V_40 [ 0 ] , V_37 ) ;
return 0 ;
}
...
struct V_7 * V_8 ;
struct V_80 V_81 ;
struct V_71 * V_218 = V_69 -> V_73 ;
struct V_50 * V_45 = V_218 -> V_219 ;
...
V_210 = V_217 ;
F_30 ( V_8 -> V_70 -> V_87 , & V_81 ) ;
if ( F_71 ( V_6 , V_8 -> V_10 -> V_11 , V_210 ,
V_81 . V_80 , V_15 ) ) {
F_13 ( V_119 , V_37 ) ;
V_15 = (struct V_14 * ) F_44 ( V_8 ) ;
if ( V_15 )
...
struct V_7 * V_8 ;
struct V_80 V_81 ;
struct V_156 * V_232 = V_231 -> V_70 ;
F_77 ( V_224 ) ;
for ( V_11 = 0 ; V_11 < V_147 ; V_11 ++ ) {
V_8 = F_57 ( V_6 -> V_45 -> V_46 , V_11 ) ;
if ( ! V_8 || V_8 == V_231 || V_8 -> V_70 != V_232 )
continue;
V_119 = F_5 ( V_6 , V_8 ) ;
F_13 ( V_119 , V_37 ) ;
V_15 = (struct V_14 * ) F_44 ( V_8 ) ;
if ( ! V_15 || V_8 -> V_70 != V_232 ) {
F_16 ( V_119 , V_37 ) ;
continue;
}
F_17 ( V_44 , V_6 -> V_45 -> V_46 ,
...
int V_36 ;
unsigned long V_241 ;
struct V_237 * V_238 = V_8 -> V_70 -> V_46 ;
struct V_50 * V_51 = F_38 ( V_238 ) ;
V_36 = F_84 ( V_238 ) ;
if ( V_36 == V_223 ) {
V_241 = V_242 + V_243 * V_244 ;
V_36 = V_225 ;
while ( F_86 ( V_242 , V_241 ) ) {
if ( ( V_51 -> V_1 == V_107 ) &&
( V_51 -> V_108 ) ) {
V_36 = V_223 ;
break;
...
void F_92 ( struct V_50 * V_51 , T_2 V_250 , T_2 V_251 )
{
struct V_6 * V_6 = F_40 ( V_51 ) ;
if ( V_250 )
goto V_252;
