...
int V_52 ;
struct V_53 * V_54 ;
V_54 = F_27 ( V_50 , V_55 , 0 ) ;
if ( ! V_54 ) {
F_28 ( & V_50 -> V_56 , L_2 ) ;
return - V_57 ;
}
V_52 = F_29 ( V_54 ) ;
if ( ! F_30 ( & V_50 -> V_56 , V_54 -> V_58 , V_52 ,
V_54 -> V_59 ) ) {
F_28 ( & V_50 -> V_56 , L_3 ,
V_52 , V_54 -> V_58 ) ;
return - V_60 ;
}
V_2 . V_3 = F_31 ( & V_50 -> V_56 , V_54 -> V_58 , V_52 ) ;
if ( ! V_2 . V_3 ) {
F_28 ( & V_50 -> V_56 , L_4 ) ;
return - V_60 ;
}
V_2 . V_18 = F_32 ( & V_50 -> V_56 , NULL ) ;
if ( F_33 ( V_2 . V_18 ) ) {
F_28 ( & V_50 -> V_56 , L_5 ) ;
return F_34 ( V_2 . V_18 ) ;
}
V_2 . V_8 = F_35 ( unsigned , V_8 , 1 , V_40 ) ;
if ( V_2 . V_8 != V_8 )
F_36 ( & V_50 -> V_56 , L_6
L_7 , V_8 , V_2 . V_8 ) ;
F_37 ( & V_2 . V_13 , F_6 , 0 ) ;
...
static int T_7 F_41 ( struct V_49 * V_50 )
{
F_42 ( & V_26 ) ;
