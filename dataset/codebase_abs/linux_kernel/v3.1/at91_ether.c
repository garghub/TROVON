...
V_71 = V_23 -> V_73 . V_74 ;
if ( ! V_71 ) {
F_20 ( & V_23 -> V_75 , V_9 + V_76 ) ;
return;
}
V_72 = F_21 ( V_71 , F_18 , 0 , V_20 -> V_32 , V_20 ) ;
if ( V_72 ) {
...
static void F_27 ( unsigned long V_52 )
{
struct V_19 * V_20 = (struct V_19 * ) V_52 ;
struct V_22 * V_23 = F_14 ( V_20 ) ;
F_5 () ;
...
static short T_3 F_28 ( struct V_19 * V_20 , unsigned int V_82 , unsigned int V_83 )
{
char V_84 [ 6 ] ;
if ( F_29 () ) {
V_84 [ 5 ] = ( V_83 & 0xff ) ;
...
static void T_3 F_31 ( struct V_19 * V_20 )
{
if ( F_28 ( V_20 , F_1 ( V_86 ) , F_1 ( V_87 ) ) )
return;
if ( F_28 ( V_20 , F_1 ( V_88 ) , F_1 ( V_89 ) ) )
return;
if ( F_28 ( V_20 , F_1 ( V_90 ) , F_1 ( V_91 ) ) )
return;
if ( F_28 ( V_20 , F_1 ( V_92 ) , F_1 ( V_93 ) ) )
return;
F_9 ( V_77 L_7 ) ;
}
...
static int F_33 ( struct V_19 * V_20 , void * V_84 )
{
...
static int F_40 ( struct V_19 * V_20 , int V_114 , int V_115 )
{
unsigned int V_4 ;
F_12 ( V_114 , V_115 , & V_4 ) ;
return V_4 ;
}
static void F_41 ( struct V_19 * V_20 , int V_114 , int V_115 , int V_4 )
{
F_11 ( V_114 , V_115 , V_4 ) ;
}
static int F_42 ( struct V_19 * V_20 , struct V_116 * V_117 )
{
struct V_22 * V_23 = F_14 ( V_20 ) ;
int V_118 ;
F_22 ( & V_23 -> V_78 ) ;
F_5 () ;
V_118 = F_43 ( & V_23 -> V_30 , V_117 ) ;
F_6 () ;
F_23 ( & V_23 -> V_78 ) ;
if ( V_23 -> V_119 == V_120 ) {
V_117 -> V_121 = V_122 ;
...
static int F_44 ( struct V_19 * V_20 , struct V_116 * V_117 )
{
struct V_22 * V_23 = F_14 ( V_20 ) ;
int V_118 ;
F_22 ( & V_23 -> V_78 ) ;
F_5 () ;
V_118 = F_45 ( & V_23 -> V_30 , V_117 ) ;
F_6 () ;
F_23 ( & V_23 -> V_78 ) ;
return V_118 ;
}
...
F_22 ( & V_23 -> V_78 ) ;
F_5 () ;
V_118 = F_47 ( & V_23 -> V_30 ) ;
F_6 () ;
F_23 ( & V_23 -> V_78 ) ;
return V_118 ;
}
static void F_48 ( struct V_19 * V_20 , struct V_124 * V_125 )
{
F_49 ( V_125 -> V_126 , V_127 , sizeof( V_125 -> V_126 ) ) ;
F_49 ( V_125 -> V_128 , V_129 , sizeof( V_125 -> V_128 ) ) ;
F_49 ( V_125 -> V_130 , F_50 ( V_20 -> V_20 . V_131 ) , sizeof( V_125 -> V_130 ) ) ;
}
static int F_51 ( struct V_19 * V_20 , struct V_132 * V_133 , int V_117 )
{
struct V_22 * V_23 = F_14 ( V_20 ) ;
int V_134 ;
if ( ! F_52 ( V_20 ) )
...
F_22 ( & V_23 -> V_78 ) ;
F_5 () ;
V_134 = F_53 ( & V_23 -> V_30 , F_54 ( V_133 ) , V_117 , NULL ) ;
F_6 () ;
F_23 ( & V_23 -> V_78 ) ;
return V_134 ;
}
...
static int F_62 ( struct V_159 * V_160 , struct V_19 * V_20 )
{
struct V_22 * V_23 = F_14 ( V_20 ) ;
if ( F_1 ( V_161 ) & V_162 ) {
F_60 ( V_20 ) ;
...
V_23 -> V_165 = F_63 ( NULL , V_160 -> V_166 , V_160 -> V_164 , V_167 ) ;
...
static struct V_174 * F_64 ( struct V_19 * V_20 )
{
...
if ( V_160 != NULL ) {
F_67 ( V_160 , 2 ) ;
memcpy ( F_68 ( V_160 , V_210 ) , V_209 , V_210 ) ;
V_160 -> V_212 = F_69 ( V_160 , V_20 ) ;
...
static T_2 F_71 ( int V_51 , void * V_52 )
{
struct V_19 * V_20 = (struct V_19 * ) V_52 ;
struct V_22 * V_23 = F_14 ( V_20 ) ;
...
F_72 ( V_23 -> V_160 ) ;
V_23 -> V_160 = NULL ;
F_73 ( NULL , V_23 -> V_165 , V_23 -> V_163 , V_167 ) ;
}
F_74 ( V_20 ) ;
}
if ( V_218 & V_152 ) {
...
static int T_3 F_78 ( unsigned long V_54 , unsigned short V_33 ,
...
unsigned int V_226 ;
int V_134 ;
V_20 = F_79 ( sizeof( struct V_22 ) ) ;
if ( ! V_20 )
return - V_227 ;
V_20 -> V_228 = V_3 ;
V_20 -> V_51 = V_229 ;
if ( F_21 ( V_20 -> V_51 , F_71 , 0 , V_20 -> V_32 , V_20 ) ) {
F_80 ( V_20 ) ;
return - V_230 ;
}
V_23 = F_14 ( V_20 ) ;
V_23 -> V_137 = (struct V_136 * ) F_81 ( NULL , sizeof( struct V_136 ) , ( V_231 * ) & V_23 -> V_138 , V_232 ) ;
if ( V_23 -> V_137 == NULL ) {
F_26 ( V_20 -> V_51 , V_20 ) ;
F_80 ( V_20 ) ;
return - V_227 ;
...
F_26 ( V_20 -> V_51 , V_20 ) ;
F_80 ( V_20 ) ;
F_88 ( NULL , sizeof( struct V_136 ) , V_23 -> V_137 , ( V_231 ) V_23 -> V_138 ) ;
return V_134 ;
}
F_22 ( & V_23 -> V_78 ) ;
F_5 () ;
...
V_23 -> V_75 . V_245 = F_27 ;
} else if ( V_23 -> V_73 . V_74 >= 32 )
F_90 ( V_23 -> V_73 . V_74 , L_12 ) ;
F_9 ( V_31 L_13 ,
...
static int T_3 F_91 ( struct V_221 * V_222 )
{
...
case V_65 :
case V_250 :
V_253 = F_78 ( V_114 , V_33 , V_222 , V_148 ) ;
break;
}
V_33 ++ ;
}
...
static int T_5 F_94 ( struct V_221 * V_222 )
{
struct V_19 * V_20 = F_95 ( V_222 ) ;
struct V_22 * V_23 = F_14 ( V_20 ) ;
if ( V_23 -> V_73 . V_74 >= 32 )
F_96 ( V_23 -> V_73 . V_74 ) ;
F_97 ( V_20 ) ;
F_26 ( V_20 -> V_51 , V_20 ) ;
F_88 ( NULL , sizeof( struct V_136 ) , V_23 -> V_137 , ( V_231 ) V_23 -> V_138 ) ;
...
static int F_99 ( struct V_221 * V_222 , T_6 V_257 )
{
struct V_19 * V_258 = F_95 ( V_222 ) ;
...
static int F_102 ( struct V_221 * V_222 )
{
struct V_19 * V_258 = F_95 ( V_222 ) ;
struct V_22 * V_23 = F_14 ( V_258 ) ;
int V_259 = V_23 -> V_73 . V_74 ;
