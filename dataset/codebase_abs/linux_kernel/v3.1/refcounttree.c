...
F_12 ( V_177 -> V_97 ) , F_12 ( V_177 -> V_125 ) ) ;
...
F_5 ( ! V_124 . V_129 ) ;
V_11 = (struct V_10 * ) V_117 -> V_12 ;
if ( F_11 ( V_11 -> V_96 . V_125 ) + V_225 * 2 >
F_97 ( V_11 -> V_96 . V_97 ) )
V_227 ++ ;
* V_107 += 1 ;
F_58 ( V_117 ) ;
