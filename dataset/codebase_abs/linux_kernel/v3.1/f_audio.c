...
if ( F_18 ( V_15 -> V_3 ) )
return - V_5 ;
for ( V_82 = 0 ; V_82 < V_84 && V_30 == 0 ; V_82 ++ ) {
V_25 = F_31 ( V_35 , V_4 ) ;
if ( V_25 ) {
V_25 -> V_6 = F_2 ( V_85 ,
V_4 ) ;
...
static int T_4
F_36 ( struct V_93 * V_94 , struct V_9 * V_10 )
{
struct V_27 * V_28 = V_94 -> V_28 ;
struct V_8 * V_15 = F_6 ( V_10 ) ;
int V_34 ;
struct V_22 * V_23 ;
F_33 ( V_15 ) ;
...
V_99 . V_97 = V_34 ;
V_34 = - V_100 ;
V_23 = F_38 ( V_28 -> V_78 , & V_101 ) ;
if ( ! V_23 )
goto V_95;
V_15 -> V_35 = V_23 ;
V_15 -> V_35 -> V_102 = & V_101 ;
V_23 -> V_83 = V_28 ;
V_34 = - V_5 ;
if ( F_39 ( V_94 -> V_28 -> V_78 ) ) {
V_94 -> V_103 = true ;
...
static void
F_41 ( struct V_93 * V_94 , struct V_9 * V_10 )
{
struct V_8 * V_15 = F_6 ( V_10 ) ;
F_42 ( V_10 -> V_106 ) ;
F_42 ( V_10 -> V_104 ) ;
