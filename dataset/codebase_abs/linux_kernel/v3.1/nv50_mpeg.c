...
static int
F_20 ( struct V_1 * V_2 , int V_10 , bool V_31 )
{
F_8 ( V_2 , 0x00b32c , 0x00000001 , 0x00000000 ) ;
...
F_21 ( struct V_1 * V_2 )
{
T_1 V_32 = F_9 ( V_2 , 0x00b100 ) ;
T_1 type = F_9 ( V_2 , 0x00b230 ) ;
T_1 V_33 = F_9 ( V_2 , 0x00b234 ) ;
T_1 V_34 = F_9 ( V_2 , 0x00b238 ) ;
T_1 V_35 = V_32 ;
if ( V_32 & 0x01000000 ) {
...
F_21 ( V_2 ) ;
if ( F_9 ( V_2 , 0x00b800 ) ) {
T_1 V_32 = F_9 ( V_2 , 0x00b800 ) ;
F_23 ( V_2 , L_4 , V_32 ) ;
F_17 ( V_2 , 0xb800 , V_32 ) ;
}
}
static void
F_26 ( struct V_1 * V_2 , int V_10 )
{
struct V_36 * V_37 = F_27 ( V_2 , V_10 ) ;
F_28 ( V_2 , 0 ) ;
F_29 ( V_2 , V_38 ) ;
F_30 ( V_37 ) ;
}
...
if ( V_5 -> V_7 == 0x50 ) {
F_33 ( V_2 , 0 , F_25 ) ;
F_34 ( V_2 , V_38 , & V_37 -> V_41 ) ;
F_35 ( V_2 , 0x3174 , V_38 ) ;
#if 0
