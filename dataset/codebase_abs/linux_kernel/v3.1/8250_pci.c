...
static inline int F_69 ( T_5 V_126 , T_5 V_127 )
{
return V_126 == V_128 || V_126 == V_127 ;
}
static struct V_129 * F_70 ( struct V_2 * V_3 )
{
struct V_129 * V_130 ;
for ( V_130 = V_131 ; ; V_130 ++ )
if ( F_69 ( V_130 -> V_5 , V_3 -> V_5 ) &&
F_69 ( V_130 -> V_6 , V_3 -> V_6 ) &&
F_69 ( V_130 -> V_132 , V_3 -> V_7 ) &&
F_69 ( V_130 -> V_133 , V_3 -> V_8 ) )
break;
return V_130 ;
}
...
static int T_6
F_72 ( struct V_2 * V_3 , struct V_29 * V_30 )
{
const struct V_136 * V_137 ;
int V_138 , V_139 , V_140 = - 1 , V_65 ;
if ( ( ( ( V_3 -> V_83 >> 8 ) != V_141 ) &&
( ( V_3 -> V_83 >> 8 ) != V_142 ) ) ||
( V_3 -> V_83 & 0xff ) > 6 )
return - V_46 ;
for ( V_137 = V_143 ;
V_137 < V_143 + F_40 ( V_143 ) ;
V_137 ++ ) {
if ( V_3 -> V_5 == V_137 -> V_5 &&
V_3 -> V_6 == V_137 -> V_6 )
return - V_46 ;
}
V_138 = V_139 = 0 ;
for ( V_65 = 0 ; V_65 < V_18 ; V_65 ++ ) {
if ( F_6 ( V_3 , V_65 ) & V_144 ) {
V_139 ++ ;
if ( V_140 == - 1 )
V_140 = V_65 ;
}
...
static inline int
F_73 ( const struct V_29 * V_30 ,
const struct V_29 * V_145 )
{
return
V_30 -> V_79 == V_145 -> V_79 &&
V_30 -> V_146 == V_145 -> V_146 &&
V_30 -> V_34 == V_145 -> V_34 &&
V_30 -> V_35 == V_145 -> V_35 &&
V_30 -> V_32 == V_145 -> V_32 ;
}
struct V_9 *
F_74 ( struct V_2 * V_3 , const struct V_29 * V_30 )
{
struct V_11 V_147 ;
struct V_9 * V_10 ;
struct V_129 * V_130 ;
...
V_10 = F_76 ( sizeof( struct V_9 ) +
sizeof( unsigned int ) * V_148 ,
V_151 ) ;
if ( ! V_10 ) {
V_10 = F_75 ( - V_22 ) ;
goto V_152;
...
V_10 -> V_3 = V_3 ;
V_10 -> V_130 = V_130 ;
memset ( & V_147 , 0 , sizeof( struct V_11 ) ) ;
V_147 . V_33 = V_153 | V_154 | V_155 ;
V_147 . V_156 = V_30 -> V_146 * 16 ;
V_147 . V_135 = F_71 ( V_3 , V_30 ) ;
V_147 . V_3 = & V_3 -> V_3 ;
for ( V_65 = 0 ; V_65 < V_148 ; V_65 ++ ) {
if ( V_130 -> V_157 ( V_10 , V_30 , & V_147 , V_65 ) )
break;
#ifdef F_77
F_2 ( V_47 L_20 ,
V_147 . V_25 , V_147 . V_135 , V_147 . V_23 ) ;
#endif
V_10 -> line [ V_65 ] = F_78 ( & V_147 ) ;
if ( V_10 -> line [ V_65 ] < 0 ) {
...
struct V_129 * V_130 ;
int V_65 ;
for ( V_65 = 0 ; V_65 < V_10 -> V_158 ; V_65 ++ )
F_80 ( V_10 -> line [ V_65 ] ) ;
for ( V_65 = 0 ; V_65 < V_18 ; V_65 ++ ) {
if ( V_10 -> V_21 [ V_65 ] )
F_19 ( V_10 -> V_21 [ V_65 ] ) ;
...
int V_65 ;
if ( V_10 -> V_130 -> V_149 )
V_10 -> V_130 -> V_149 ( V_10 -> V_3 ) ;
for ( V_65 = 0 ; V_65 < V_10 -> V_158 ; V_65 ++ )
if ( V_10 -> line [ V_65 ] >= 0 )
F_85 ( V_10 -> line [ V_65 ] ) ;
}
static int T_6
F_86 ( struct V_2 * V_3 , const struct V_136 * V_159 )
{
struct V_129 * V_130 ;
struct V_9 * V_10 ;
const struct V_29 * V_30 ;
...
V_130 = F_70 ( V_3 ) ;
if ( V_130 -> V_161 ) {
V_36 = V_130 -> V_161 ( V_3 ) ;
if ( V_36 )
return V_36 ;
}
if ( V_159 -> V_162 >= F_40 ( V_163 ) ) {
F_2 ( V_108 L_22 ,
V_159 -> V_162 ) ;
return - V_19 ;
}
V_30 = & V_163 [ V_159 -> V_162 ] ;
V_36 = F_87 ( V_3 ) ;
F_88 ( V_3 ) ;
if ( V_36 )
return V_36 ;
if ( V_159 -> V_162 == V_164 ) {
memcpy ( & V_160 , V_30 , sizeof( struct V_29 ) ) ;
V_30 = & V_160 ;
V_36 = F_72 ( V_3 , & V_160 ) ;
if ( V_36 )
goto V_165;
} else {
memcpy ( & V_160 , & V_163 [ V_164 ] ,
sizeof( struct V_29 ) ) ;
V_36 = F_72 ( V_3 , & V_160 ) ;
if ( V_36 == 0 && F_73 ( V_30 , & V_160 ) )
F_1 ( L_23 ,
V_3 ) ;
}
V_10 = F_74 ( V_3 , V_30 ) ;
...
static void T_3 F_93 ( struct V_2 * V_3 )
{
struct V_9 * V_10 = F_94 ( V_3 ) ;
F_90 ( V_3 , NULL ) ;
F_79 ( V_10 ) ;
F_92 ( V_3 ) ;
}
static int F_95 ( struct V_2 * V_3 , T_7 V_166 )
{
struct V_9 * V_10 = F_94 ( V_3 ) ;
if ( V_10 )
F_82 ( V_10 ) ;
F_88 ( V_3 ) ;
F_96 ( V_3 , F_97 ( V_3 , V_166 ) ) ;
return 0 ;
}
