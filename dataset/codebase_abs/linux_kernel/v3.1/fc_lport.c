...
if ( F_84 ( V_4 ) == - V_233 )
return;
if ( V_2 -> V_232 < V_2 -> V_234 ) {
V_2 -> V_232 ++ ;
if ( ! V_4 )
V_231 = F_85 ( 500 ) ;
else
V_231 = F_85 ( V_2 -> V_120 ) ;
F_86 ( & V_2 -> V_175 , V_231 ) ;
} else
F_38 ( V_2 ) ;
}
static void F_87 ( struct V_217 * V_95 , struct V_3 * V_4 ,
void * V_235 )
{
...
return;
F_5 ( & V_2 -> V_11 ) ;
if ( V_2 -> V_13 < V_16 || V_2 -> V_13 > V_238 ) {
F_4 ( V_2 , L_27
L_28 , F_8 ( V_2 ) ) ;
if ( F_90 ( V_4 ) )
goto V_239;
...
V_193 = F_63 ( V_4 ) ;
V_237 = F_32 ( V_4 , sizeof( * V_237 ) ) ;
if ( V_193 && V_237 && V_193 -> V_220 == V_240 &&
V_237 -> V_241 == V_242 &&
V_237 -> V_243 == V_244 &&
F_91 ( V_237 -> V_245 ) == V_246 )
switch ( V_2 -> V_13 ) {
case V_16 :
F_6 ( V_2 , V_247 ) ;
break;
...
static void F_93 ( struct V_217 * V_95 , struct V_3 * V_4 ,
void * V_235 )
{
struct V_1 * V_2 = V_235 ;
V_98 V_93 ;
...
F_8 ( V_2 ) ) ;
F_40 ( V_2 , V_250 ) ;
V_4 = F_33 ( V_2 , sizeof( struct V_251 ) ) ;
if ( ! V_4 ) {
F_65 ( V_2 , V_4 ) ;
return;
}
if ( ! V_2 -> V_17 . V_252 ( V_2 , V_253 , V_4 , V_254 ,
F_93 , V_2 ,
2 * V_2 -> V_230 ) )
F_65 ( V_2 , NULL ) ;
}
...
break;
case V_247 :
V_132 = F_94 ( F_95 ( V_2 -> V_170 ) , 255 ) ;
if ( ! V_132 )
return F_6 ( V_2 , V_249 ) ;
V_256 = V_260 ;
...
if ( ! V_2 -> V_17 . V_252 ( V_2 , V_268 , V_4 , V_256 ,
F_87 ,
V_2 , 3 * V_2 -> V_230 ) )
F_65 ( V_2 , V_4 ) ;
}
...
static void F_97 ( struct V_271 * V_272 )
{
struct V_1 * V_2 =
F_98 ( V_272 , struct V_1 ,
V_175 . V_272 ) ;
F_5 ( & V_2 -> V_11 ) ;
switch ( V_2 -> V_13 ) {
case V_166 :
...
if ( ! V_2 -> V_17 . V_252 ( V_2 , V_206 , V_4 , V_205 ,
F_99 , V_2 ,
2 * V_2 -> V_230 ) )
F_65 ( V_2 , NULL ) ;
}
void F_100 ( struct V_217 * V_95 , struct V_3 * V_4 ,
void * V_235 )
{
struct V_1 * V_2 = V_235 ;
struct V_91 * V_194 ;
...
V_275 = F_101 ( V_4 ) ;
if ( F_68 ( V_4 ) == V_130 && V_275 ) {
V_194 = F_32 ( V_4 , sizeof( * V_194 ) ) ;
if ( V_194 ) {
V_109 = F_91 ( V_194 -> V_103 . V_107 ) &
V_277 ;
if ( V_109 >= V_278 &&
V_109 < V_2 -> V_109 )
V_2 -> V_109 = V_109 ;
V_276 = F_91 ( V_194 -> V_103 . V_115 ) ;
V_230 = F_28 ( V_194 -> V_103 . V_279 ) ;
V_120 = F_28 ( V_194 -> V_103 . V_119 ) ;
if ( V_276 & V_280 )
V_120 /= 1000000 ;
V_2 -> V_281 = ! ! ( V_276 & V_282 ) ;
if ( ( V_276 & V_283 ) == 0 ) {
if ( V_120 > V_2 -> V_120 )
V_2 -> V_120 = V_120 ;
V_2 -> V_230 = 2 * V_120 ;
...
if ( ! V_4 )
return F_65 ( V_2 , V_4 ) ;
if ( ! V_2 -> V_17 . V_252 ( V_2 , V_206 , V_4 ,
V_2 -> V_187 ? V_284 : V_114 ,
F_100 , V_2 ,
V_2 -> V_187 ? 2 * V_2 -> V_230 :
V_2 -> V_120 ) )
F_65 ( V_2 , NULL ) ;
}
int F_102 ( struct V_1 * V_2 )
{
F_103 ( & V_2 -> V_175 , F_97 ) ;
F_104 ( & V_2 -> V_11 ) ;
F_40 ( V_2 , V_166 ) ;
F_27 ( V_2 , V_285 ) ;
F_27 ( V_2 , V_240 ) ;
...
F_108 ( V_2 -> V_170 ) = V_2 -> V_101 ;
F_109 ( V_2 -> V_170 ) = V_2 -> V_99 ;
F_110 ( V_2 -> V_170 ) = V_289 ;
memset ( F_111 ( V_2 -> V_170 ) , 0 ,
sizeof( F_111 ( V_2 -> V_170 ) ) ) ;
F_111 ( V_2 -> V_170 ) [ 2 ] = 1 ;
F_111 ( V_2 -> V_170 ) [ 7 ] = 1 ;
memset ( F_112 ( V_2 -> V_170 ) , 0 ,
sizeof( F_112 ( V_2 -> V_170 ) ) ) ;
F_112 ( V_2 -> V_170 ) [ 2 ] = 1 ;
F_112 ( V_2 -> V_170 ) [ 7 ] = 1 ;
F_113 ( V_2 -> V_170 ) = V_2 -> V_109 ;
F_114 ( V_2 -> V_170 ) = 0 ;
if ( V_2 -> V_290 & V_291 )
F_114 ( V_2 -> V_170 ) |= V_291 ;
if ( V_2 -> V_290 & V_292 )
F_114 ( V_2 -> V_170 ) |= V_292 ;
F_115 ( V_2 ) ;
return 0 ;
}
static void F_116 ( struct V_217 * V_95 , struct V_3 * V_4 ,
void * V_293 )
{
struct V_294 * V_295 = V_293 ;
struct V_296 * V_297 = V_295 -> V_297 ;
struct V_1 * V_2 = V_295 -> V_2 ;
struct V_135 * V_193 ;
T_4 V_132 ;
void * V_298 ;
if ( F_90 ( V_4 ) ) {
V_297 -> V_299 -> V_300 = ( F_84 ( V_4 ) == - V_233 ) ?
- V_301 : - V_302 ;
V_297 -> V_303 = sizeof( V_304 ) ;
V_297 -> V_305 |= V_306 ;
V_297 -> V_307 ( V_297 ) ;
F_117 ( V_295 ) ;
return;
...
V_298 = F_32 ( V_4 , 0 ) ;
if ( F_118 ( V_4 ) == V_308 && ! F_91 ( V_193 -> V_309 ) ) {
unsigned short V_256 = ( V_295 -> V_310 == V_246 ) ?
F_91 ( ( (struct V_236 * ) V_298 ) -> V_245 ) :
( unsigned short ) F_68 ( V_4 ) ;
V_297 -> V_299 -> V_311 . V_312 . V_313 =
( V_256 == V_295 -> V_310 ) ?
V_314 : V_315 ;
}
V_297 -> V_299 -> V_316 +=
F_119 ( V_298 , V_132 , V_295 -> V_317 , & V_295 -> V_318 ,
& V_295 -> V_319 , V_320 , NULL ) ;
if ( F_120 ( V_4 ) == V_321 &&
( F_121 ( V_193 -> V_322 ) & ( V_323 | V_324 ) ) ==
( V_323 | V_324 ) ) {
if ( V_297 -> V_299 -> V_316 >
V_297 -> V_325 . V_326 )
V_297 -> V_299 -> V_316 =
V_297 -> V_325 . V_326 ;
V_297 -> V_299 -> V_300 = 0 ;
...
char * V_133 ;
int V_132 ;
V_4 = F_33 ( V_2 , V_297 -> V_328 . V_326 ) ;
if ( ! V_4 )
return - V_329 ;
V_132 = V_297 -> V_328 . V_326 ;
V_133 = F_32 ( V_4 , V_132 ) ;
F_123 ( V_297 -> V_328 . V_330 ,
V_297 -> V_328 . V_331 ,
V_133 , V_132 ) ;
V_193 = F_63 ( V_4 ) ;
V_193 -> V_332 = V_333 ;
...
V_193 -> V_220 = V_334 ;
F_64 ( V_193 -> V_322 , V_335 ) ;
V_193 -> V_336 = 0 ;
V_193 -> V_337 = 0 ;
V_193 -> V_338 = 0 ;
V_295 = F_124 ( sizeof( struct V_294 ) , V_339 ) ;
if ( ! V_295 ) {
F_2 ( V_4 ) ;
return - V_329 ;
}
...
V_295 -> V_2 = V_2 ;
V_295 -> V_310 = V_130 ;
V_295 -> V_318 = V_297 -> V_325 . V_331 ;
V_295 -> V_317 = V_297 -> V_325 . V_330 ;
if ( ! V_2 -> V_17 . V_340 ( V_2 , V_4 , F_116 ,
NULL , V_295 , V_327 ) ) {
F_117 ( V_295 ) ;
return - V_341 ;
}
...
struct V_1 * V_2 , T_1 V_275 , T_1 V_327 )
{
struct V_294 * V_295 ;
struct V_3 * V_4 ;
struct V_135 * V_193 ;
struct V_342 * V_237 ;
T_4 V_132 ;
V_4 = F_33 ( V_2 , sizeof( struct V_236 ) +
V_297 -> V_328 . V_326 ) ;
if ( ! V_4 )
return - V_329 ;
V_132 = V_297 -> V_328 . V_326 ;
V_237 = F_32 ( V_4 , V_132 ) ;
F_123 ( V_297 -> V_328 . V_330 ,
V_297 -> V_328 . V_331 ,
V_237 , V_132 ) ;
V_193 = F_63 ( V_4 ) ;
...
int F_126 ( struct V_296 * V_297 )
{
struct V_344 * V_345 = V_297 -> V_139 -> V_346 ;
struct V_37 * V_38 = V_297 -> V_38 ;
struct V_1 * V_2 = F_14 ( V_38 ) ;
struct V_347 * V_348 ;
struct V_5 * V_6 ;
int V_165 = - V_179 ;
...
V_297 -> V_299 -> V_316 = 0 ;
if ( V_345 )
V_345 -> V_349 = V_297 -> V_325 . V_326 ;
F_5 ( & V_2 -> V_11 ) ;
switch ( V_297 -> V_344 -> V_350 ) {
case V_351 :
V_348 = V_297 -> V_348 ;
if ( ! V_348 )
break;
V_6 = V_348 -> V_352 ;
V_165 = F_122 ( V_297 , V_2 , V_348 -> V_10 ,
V_6 -> V_120 ) ;
break;
case V_353 :
V_348 = V_297 -> V_348 ;
...
break;
V_6 = V_348 -> V_352 ;
V_165 = F_125 ( V_297 , V_2 , V_348 -> V_10 ,
V_6 -> V_120 ) ;
break;
case V_354 :
V_275 = F_121 ( V_297 -> V_344 -> V_355 . V_356 . V_10 ) ;
if ( V_275 == V_268 )
V_6 = V_2 -> V_15 ;
else
...
if ( ! V_6 )
break;
V_165 = F_125 ( V_297 , V_2 , V_275 , V_6 -> V_120 ) ;
break;
case V_358 :
V_275 = F_121 ( V_297 -> V_344 -> V_355 . V_359 . V_10 ) ;
V_165 = F_122 ( V_297 , V_2 , V_275 , V_2 -> V_120 ) ;
break;
}
F_7 ( & V_2 -> V_11 ) ;
return V_165 ;
