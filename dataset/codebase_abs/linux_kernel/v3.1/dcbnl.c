...
if ( strncmp ( V_181 -> V_184 , V_25 -> V_184 , V_196 ) == 0 ) {
...
( strncmp ( V_181 -> V_184 , V_207 -> V_184 , V_196 ) == 0 ) ) {
...
struct V_180 * V_181 ;
struct V_180 V_2 ;
memcpy ( & V_2 . V_184 , V_207 -> V_184 , sizeof( V_2 . V_184 ) ) ;
...
strncpy ( V_268 -> V_184 , V_207 -> V_184 , V_196 ) ;
