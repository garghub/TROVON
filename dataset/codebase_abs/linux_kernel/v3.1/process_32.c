...
F_21 ( L_5 ,
V_23 -> V_27 , V_23 -> V_28 , V_23 -> V_29 , V_23 -> V_30 , F_22 () ) ;
F_21 ( L_6 , ( void * ) V_23 -> V_28 ) ;
F_21 ( L_7 ,
...
void F_23 ( struct V_33 * V_34 , unsigned long * V_35 )
{
...
int V_2 = 0 ;
if ( V_34 != NULL )
V_37 = ( unsigned long ) F_24 ( V_34 ) ;
else
V_37 = ( unsigned long ) F_25 () ;
...
int F_35 ( struct V_22 * V_51 , T_3 * V_61 )
{
if ( F_36 () ) {
...
if ( F_38 ( V_63 ) ) {
F_39 ( F_40 () | V_64 ) ;
F_41 ( & V_41 -> V_65 . V_66 [ 0 ] , & V_41 -> V_65 . V_67 ,
...
T_2 int F_43 ( struct V_22 * V_51 )
{
int error , V_78 = 0 ;
char * V_79 ;
if( V_51 -> V_26 [ V_80 ] == 0 )
V_78 = 1 ;
V_79 = F_44 ( ( char T_1 * ) V_51 -> V_26 [ V_78 + V_81 ] ) ;
error = F_45 ( V_79 ) ;
if( F_46 ( V_79 ) )
goto V_82;
error = F_47 ( V_79 ,
...
T_4 F_49 ( int (* F_50)( void * ) , void * V_83 , unsigned long V_84 )
{
long V_85 ;
...
unsigned long F_51 ( struct V_33 * V_86 )
{
