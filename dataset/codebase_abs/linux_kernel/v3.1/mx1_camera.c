...
( V_91 & V_103 ) ) {
if ( ! V_37 -> V_97 ||
V_37 -> V_97 -> V_65 & V_104 )
V_91 &= ~ V_103 ;
else
V_91 &= ~ V_102 ;
}
V_26 = V_6 -> V_92 -> V_105 ( V_6 , V_91 ) ;
if ( V_26 < 0 )
return V_26 ;
...
V_117 . V_30 = V_114 -> V_30 ;
V_117 . V_31 = V_114 -> V_31 ;
V_117 . V_25 = V_114 -> V_25 ;
V_117 . V_121 = V_114 -> V_121 ;
V_117 . V_29 = V_112 -> V_29 ;
V_26 = F_51 ( V_86 , V_87 , V_122 , & V_117 ) ;
if ( V_26 < 0 )
return V_26 ;
if ( V_117 . V_29 != V_112 -> V_29 )
return - V_32 ;
V_114 -> V_30 = V_117 . V_30 ;
V_114 -> V_31 = V_117 . V_31 ;
V_114 -> V_25 = V_117 . V_25 ;
...
V_117 . V_121 = V_114 -> V_121 ;
V_117 . V_29 = V_112 -> V_29 ;
V_26 = F_51 ( V_86 , V_87 , V_123 , & V_117 ) ;
if ( V_26 < 0 )
return V_26 ;
V_114 -> V_30 = V_117 . V_30 ;
V_114 -> V_31 = V_117 . V_31 ;
...
struct V_15 * V_16 = F_10 ( V_6 -> V_127 . V_128 [ V_126 ] ,
struct V_15 , V_18 ) ;
V_16 -> V_28 = 0 ;
F_59 ( & V_16 -> V_18 . V_27 ) ;
}
...
struct V_15 * V_16 ;
V_16 = F_30 ( V_6 -> V_127 . V_132 . V_62 , struct V_15 ,
V_18 . V_132 ) ;
F_61 ( V_129 , & V_16 -> V_18 . V_61 , V_130 ) ;
if ( V_16 -> V_18 . V_22 == V_58 ||
V_16 -> V_18 . V_22 == V_133 )
return V_134 | V_135 ;
return 0 ;
}
...
static int T_3 F_64 ( struct V_142 * V_143 )
{
struct V_36 * V_37 ;
struct V_144 * V_44 ;
struct V_145 V_146 ;
...
unsigned int V_147 ;
int V_148 = 0 ;
V_44 = F_65 ( V_143 , V_149 , 0 ) ;
V_147 = F_66 ( V_143 , 0 ) ;
if ( ! V_44 || ( int ) V_147 <= 0 ) {
V_148 = - V_150 ;
goto exit;
}
V_74 = F_67 ( & V_143 -> V_41 , L_17 ) ;
if ( F_68 ( V_74 ) ) {
V_148 = F_69 ( V_74 ) ;
goto exit;
}
V_37 = F_70 ( sizeof( * V_37 ) , V_151 ) ;
if ( ! V_37 ) {
F_16 ( & V_143 -> V_41 , L_18 ) ;
V_148 = - V_152 ;
goto V_153;
}
V_37 -> V_44 = V_44 ;
V_37 -> V_74 = V_74 ;
V_37 -> V_97 = V_143 -> V_41 . V_154 ;
if ( V_37 -> V_97 )
V_37 -> V_72 = V_37 -> V_97 -> V_155 * 10000 ;
if ( ! V_37 -> V_72 ) {
F_56 ( & V_143 -> V_41 ,
L_19
L_20 ) ;
...
F_59 ( & V_37 -> V_51 ) ;
F_71 ( & V_37 -> V_66 ) ;
if ( ! F_72 ( V_44 -> V_45 , F_73 ( V_44 ) , V_156 ) ) {
V_148 = - V_80 ;
goto V_157;
}
...
V_37 -> V_147 = V_147 ;
V_37 -> V_54 = V_54 ;
V_37 -> V_43 = F_75 ( V_156 , V_159 ) ;
if ( V_37 -> V_43 < 0 ) {
F_16 ( & V_143 -> V_41 , L_21 ) ;
V_148 = - V_80 ;
goto V_160;
}
F_3 ( & V_143 -> V_41 , L_22 , V_37 -> V_43 ) ;
F_76 ( V_37 -> V_43 , F_32 , NULL ,
V_37 ) ;
F_77 ( V_37 -> V_43 , V_161 ,
V_162 , V_163 , 0 ) ;
F_78 ( V_37 -> V_43 , 0 ) ;
V_148 = F_79 ( & V_164 ) ;
if ( V_148 ) {
F_16 ( & V_143 -> V_41 , L_23 ) ;
goto V_165;
}
F_80 ( & V_166 , & V_167 -
& V_166 ) ;
V_146 . V_168 = ( long ) V_169 ;
V_146 . V_170 = ( long ) F_81 ( V_37 -> V_43 ) ;
V_146 . V_171 = ( long ) V_37 -> V_54 + V_55 ;
V_146 . V_172 = ( long ) V_37 -> V_54 + V_173 ;
V_146 . V_174 = 1 << V_37 -> V_43 ;
F_82 ( & V_146 ) ;
F_83 ( V_147 , 1 ) ;
F_84 ( V_147 ) ;
V_37 -> V_175 . V_176 = V_156 ;
V_37 -> V_175 . V_92 = & V_177 ;
V_37 -> V_175 . V_50 = V_37 ;
V_37 -> V_175 . V_178 . V_41 = & V_143 -> V_41 ;
V_37 -> V_175 . V_179 = V_143 -> V_180 ;
V_148 = F_85 ( & V_37 -> V_175 ) ;
if ( V_148 )
goto V_181;
F_47 ( & V_143 -> V_41 , L_24 ) ;
return 0 ;
V_181:
F_86 ( V_147 ) ;
F_83 ( V_147 , 0 ) ;
...
static int T_5 F_93 ( struct V_142 * V_143 )
{
struct V_48 * V_175 = F_20 ( & V_143 -> V_41 ) ;
struct V_36 * V_37 = F_10 ( V_175 ,
struct V_36 , V_175 ) ;
struct V_144 * V_44 ;
F_88 ( V_37 -> V_43 ) ;
F_86 ( V_37 -> V_147 ) ;
...
F_90 ( V_44 -> V_45 , F_73 ( V_44 ) ) ;
F_91 ( V_37 ) ;
F_47 ( & V_143 -> V_41 , L_25 ) ;
return 0 ;
}
static int T_3 F_95 ( void )
{
return F_96 ( & V_182 , F_64 ) ;
}
