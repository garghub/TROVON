...
static int F_105 ( struct V_15 * V_16 , T_2 * V_22 , T_1 type )
{
...
static int F_106 ( struct V_12 * V_13 , T_1 V_14 )
{
...
static int F_108 ( struct V_12 * V_13 , T_1 V_147 )
{
F_2 ( L_22 , V_13 , V_147 ) ;
if ( V_13 -> type != V_32 && V_13 -> type != V_31 )
return - V_47 ;
...
static int F_109 ( struct V_12 * V_13 , struct V_44 * V_45 )
{
struct V_11 * V_17 = V_13 -> V_18 ;
if ( ! V_17 )
goto V_52;
...
F_111 ( & V_58 . V_20 ) ;
F_46 (sk, node, &sco_sk_list.head) {
F_112 ( V_149 , L_24 , F_24 ( & F_23 ( V_3 ) -> V_21 ) ,
F_24 ( & F_23 ( V_3 ) -> V_23 ) , V_3 -> V_4 ) ;
}
F_113 ( & V_58 . V_20 ) ;
return 0 ;
}
static int F_114 ( struct V_151 * V_151 , struct V_152 * V_152 )
{
return F_115 ( V_152 , F_110 , V_151 -> V_153 ) ;
}
int T_6 F_116 ( void )
{
int V_26 ;
