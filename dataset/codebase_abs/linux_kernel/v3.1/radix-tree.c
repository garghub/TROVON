...
unsigned long V_34 = * V_49 ;
V_50 = F_40 ( V_50 , F_28 ( V_32 ) ) ;
if ( V_34 > V_50 )
return 0 ;
if ( ! V_51 )
return 0 ;
...
V_47 = & V_45 [ 0 ] ;
while ( V_47 -> V_8 ) {
if ( F_8 ( V_47 -> V_8 , V_53 , V_47 -> V_10 ) )
break;
F_4 ( V_47 -> V_8 , V_53 , V_47 -> V_10 ) ;
V_47 ++ ;
}
V_55:
...
static unsigned int
F_43 ( struct V_7 * V_38 , void * * * V_58 , unsigned long * V_59 ,
unsigned long V_34 , unsigned int V_60 , unsigned long * V_61 )
{
unsigned int V_62 = 0 ;
...
for ( V_26 = V_34 & V_41 ; V_26 < V_63 ; V_26 ++ ) {
if ( V_38 -> V_28 [ V_26 ] ) {
V_58 [ V_62 ] = & ( V_38 -> V_28 [ V_26 ] ) ;
if ( V_59 )
V_59 [ V_62 ] = V_34 ;
if ( ++ V_62 == V_60 ) {
V_34 ++ ;
...
unsigned int
F_44 ( struct V_3 * V_4 , void * * V_58 ,
unsigned long V_64 , unsigned int V_60 )
{
unsigned long V_65 ;
struct V_7 * V_8 ;
unsigned long V_66 = V_64 ;
unsigned int V_16 ;
V_8 = F_33 ( V_4 -> V_35 ) ;
if ( ! V_8 )
return 0 ;
...
V_16 = 0 ;
while ( V_16 < V_60 ) {
unsigned int V_62 , V_67 , V_26 ;
unsigned long V_61 ;
if ( V_66 > V_65 )
break;
V_67 = F_43 ( V_8 , ( void * * * ) V_58 + V_16 , NULL ,
V_66 , V_60 - V_16 , & V_61 ) ;
V_62 = 0 ;
for ( V_26 = 0 ; V_26 < V_67 ; V_26 ++ ) {
struct V_7 * V_38 ;
V_38 = * ( ( ( void * * * ) V_58 ) [ V_16 + V_26 ] ) ;
if ( ! V_38 )
continue;
V_58 [ V_16 + V_62 ] =
F_2 ( F_33 ( V_38 ) ) ;
...
static unsigned int
F_46 ( struct V_7 * V_38 , void * * * V_58 , unsigned long V_34 ,
unsigned int V_60 , unsigned long * V_61 , unsigned int V_9 )
{
unsigned int V_62 = 0 ;
unsigned int V_39 , V_32 ;
V_32 = V_38 -> V_32 ;
...
V_32 -- ;
if ( V_32 == 0 ) {
unsigned long V_68 = V_34 & V_41 ;
for ( ; V_68 < V_63 ; V_68 ++ ) {
V_34 ++ ;
if ( ! F_8 ( V_38 , V_9 , V_68 ) )
continue;
if ( V_38 -> V_28 [ V_68 ] ) {
V_58 [ V_62 ++ ] = & ( V_38 -> V_28 [ V_68 ] ) ;
if ( V_62 == V_60 )
goto V_31;
}
}
...
if ( V_66 > V_65 )
break;
V_67 = F_46 ( V_8 , ( void * * * ) V_58 + V_16 ,
V_66 , V_60 - V_16 , & V_61 , V_9 ) ;
V_62 = 0 ;
for ( V_26 = 0 ; V_26 < V_67 ; V_26 ++ ) {
struct V_7 * V_38 ;
V_38 = * ( ( ( void * * * ) V_58 ) [ V_16 + V_26 ] ) ;
...
unsigned long V_34 , unsigned long * V_69 )
{
unsigned int V_39 , V_32 ;
unsigned long V_26 ;
V_32 = V_38 -> V_32 ;
...
if ( V_66 > V_65 )
break;
V_66 = F_49 ( V_8 , V_37 , V_66 , & V_69 ) ;
F_52 () ;
F_53 () ;
} while ( V_66 != 0 && V_66 <= V_65 );
return V_69 ;
}
unsigned long F_50 ( struct V_3 * V_4 , void * V_37 )
{
