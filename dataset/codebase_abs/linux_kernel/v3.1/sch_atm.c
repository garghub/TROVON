...
static void F_46 ( unsigned long V_94 )
{
...
V_6 -> V_26 . V_17 = 1 ;
F_64 ( & V_6 -> V_30 , F_46 , ( unsigned long ) V_3 ) ;
return 0 ;
}
...
if ( V_104 == NULL )
goto V_107;
F_71 ( V_29 , V_46 , V_7 -> V_39 , V_7 -> V_40 ) ;
if ( V_7 -> V_22 ) {
struct V_108 V_109 ;
int V_110 ;
V_109 . V_111 = V_112 ;
...
F_71 ( V_29 , V_119 , sizeof( V_109 ) , & V_109 ) ;
V_110 = F_72 ( V_7 -> V_22 -> V_120 ) ;
F_73 ( V_29 , V_121 , V_110 ) ;
}
if ( V_7 -> V_25 )
F_73 ( V_29 , V_48 , V_7 -> V_4 ) ;
else
F_73 ( V_29 , V_48 , 0 ) ;
F_74 ( V_29 , V_104 ) ;
return V_29 -> V_99 ;
...
{
struct V_1 * V_7 = (struct V_1 * ) V_8 ;
V_7 -> V_89 . V_92 = V_7 -> V_14 -> V_14 . V_92 ;
if ( F_77 ( V_123 , & V_7 -> V_91 ) < 0 ||
