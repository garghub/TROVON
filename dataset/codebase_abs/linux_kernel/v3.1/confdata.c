...
fprintf ( V_66 , L_26 V_54 L_27 ,
V_11 -> V_8 , ( * V_67 == 'y' ) ) ;
fprintf ( V_66 , L_26 V_54 L_28 ,
V_11 -> V_8 , ( * V_67 == 'm' ) ) ;
break;
}
case V_38 : {
...
static void F_39 ( T_2 * V_66 , struct V_10 * V_11 ,
...
static void
F_41 ( T_2 * V_66 , struct V_73 * V_74 , void * V_75 )
{
char V_17 [ 256 ] ;
...
V_58 = F_25 ( F_26 ( V_11 ) ) ;
V_87 = F_47 ( V_58 ) ;
if ( ! F_48 ( V_58 ) && V_11 == V_87 ) {
if ( ( V_11 -> type == V_31 ) &&
F_31 ( V_11 ) == V_32 )
goto V_86;
}
}
F_39 ( V_84 , V_11 , & V_88 , NULL ) ;
}
V_86:
if ( V_83 -> V_85 != NULL ) {
V_83 = V_83 -> V_85 ;
...
struct V_16 V_95 ;
char * V_96 ;
if ( ! V_16 ( V_8 , & V_95 ) && F_50 ( V_95 . V_97 ) ) {
strcpy ( V_92 , V_8 ) ;
strcat ( V_92 , L_39 ) ;
V_91 = F_6 () ;
...
V_20 = getenv ( L_41 ) ;
if ( ! V_20 || ! * V_20 ) {
sprintf ( V_93 , L_42 , V_92 , ( int ) F_51 () ) ;
...
strcpy ( V_102 , L_48 ) ;
V_106 = F_56 ( V_100 , V_109 | V_110 | V_111 , 0644 ) ;
if ( V_106 == - 1 ) {
if ( V_112 != V_113 ) {
V_105 = 1 ;
break;
...
* V_102 = 0 ;
if ( V_16 ( V_100 , & V_104 ) && F_57 ( V_100 , 0755 ) ) {
V_105 = 1 ;
goto V_84;
}
* V_102 ++ = '/' ;
...
F_41 ( V_84 , & V_88 , NULL ) ;
F_41 ( V_114 , & V_116 , NULL ) ;
F_41 ( V_115 , & V_117 , NULL ) ;
F_21 (i, sym) {
F_10 ( V_11 ) ;
if ( ! ( V_11 -> V_30 & V_63 ) || ! V_11 -> V_8 )
continue;
F_39 ( V_84 , V_11 , & V_88 , ( void * ) 1 ) ;
F_39 ( V_114 , V_11 , & V_116 , ( void * ) 1 ) ;
F_39 ( V_115 , V_11 , & V_117 , NULL ) ;
}
fclose ( V_84 ) ;
fclose ( V_114 ) ;
fclose ( V_115 ) ;
...
static void F_62 ( struct V_10 * V_122 )
{
struct V_41 * V_42 ;
struct V_10 * V_11 ;
struct V_47 * V_60 ;
int V_123 , V_23 ;
if ( V_122 -> V_64 . V_28 != V_32 )
return;
V_42 = F_26 ( V_122 ) ;
V_123 = 0 ;
...
static void F_63 ( struct V_10 * V_122 )
{
struct V_41 * V_42 ;
struct V_10 * V_11 ;
struct V_47 * V_60 ;
...
void F_64 ( enum V_124 V_125 )
{
struct V_10 * V_11 , * V_122 ;
int V_40 , V_123 ;
F_21 (i, sym) {
if ( F_30 ( V_11 ) )
continue;
...
break;
case V_129 :
V_123 = F_65 ( V_11 ) == V_27 ? 3 : 2 ;
V_11 -> V_23 [ V_55 ] . V_28 = ( V_114 ) ( rand () % V_123 ) ;
break;
default:
continue;
}
if ( ! ( F_22 ( V_11 ) && V_125 == V_129 ) )
V_11 -> V_30 |= V_65 ;
break;
default:
break;
