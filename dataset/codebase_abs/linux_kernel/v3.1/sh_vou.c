...
if ( V_45 < 0 )
goto V_252;
V_232 = F_110 ( & V_2 -> V_85 , V_227 ,
V_224 -> V_253 , NULL ) ;
if ( ! V_232 ) {
V_45 = - V_206 ;
goto V_254;
}
V_45 = F_111 ( V_34 , V_255 , - 1 ) ;
if ( V_45 < 0 )
goto V_256;
return 0 ;
V_256:
...
F_116 ( V_2 -> V_5 ) ;
V_244:
F_117 ( V_229 -> V_240 , F_101 ( V_229 ) ) ;
V_243:
F_84 ( V_2 ) ;
return V_45 ;
}
static int T_7 F_118 ( struct V_222 * V_223 )
{
int V_181 = F_94 ( V_223 , 0 ) ;
struct V_257 * V_85 = F_119 ( V_223 ) ;
struct V_1 * V_2 = F_120 ( V_85 ,
struct V_1 , V_85 ) ;
struct V_231 * V_258 = F_72 ( V_85 -> V_259 . V_58 ,
struct V_231 , V_260 ) ;
struct V_261 * V_262 = F_121 ( V_258 ) ;
struct V_228 * V_229 ;
if ( V_181 > 0 )
F_115 ( V_181 , V_2 ) ;
F_113 ( & V_223 -> V_39 ) ;
