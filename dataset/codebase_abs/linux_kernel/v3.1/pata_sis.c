...
{
const struct V_68 * V_69 [] = { NULL , NULL } ;
struct V_1 * V_18 = NULL ;
struct V_52 * V_70 = NULL ;
struct V_52 * V_71 ;
int V_72 ;
static struct V_52 V_73 [] = {
{ 0x0968 , & V_57 } ,
{ 0x0966 , & V_57 } ,
{ 0x0965 , & V_57 } ,
{ 0x0745 , & V_59 } ,
...
if ( V_72 )
return V_72 ;
for ( V_71 = & V_73 [ 0 ] ; V_71 -> V_5 ; V_71 ++ ) {
V_18 = F_29 ( V_79 , V_71 -> V_5 , NULL ) ;
if ( V_18 != NULL ) {
V_70 = V_71 ;
if ( V_71 -> V_5 == 0x630 ) {
if ( V_18 -> V_80 >= 0x30 )
...
T_1 V_82 ;
F_16 ( V_17 , 0x54 , & V_81 ) ;
F_23 ( V_17 , 0x54 , V_81 & 0x7fffffff ) ;
F_5 ( V_17 , V_83 , & V_82 ) ;
F_23 ( V_17 , 0x54 , V_81 ) ;
switch( V_82 ) {
case 0x5518 :
V_70 = & V_75 ;
if ( ( V_81 & 0x40000000 ) == 0 ) {
F_23 ( V_17 , 0x54 , V_81 | 0x40000000 ) ;
F_30 ( V_84 L_1 ) ;
}
break;
case 0x0180 :
...
T_2 V_87 ;
F_7 ( V_17 , 0x4a , & V_87 ) ;
F_10 ( V_17 , 0x4a , V_87 | 0x10 ) ;
F_5 ( V_17 , V_83 , & V_82 ) ;
F_10 ( V_17 , 0x4a , V_87 ) ;
switch( V_82 ) {
case 0x5517 :
V_85 = F_31 ( V_17 -> V_88 , 0x10 ) ;
if ( V_85 == NULL )
break;
F_7 ( V_17 , 0x49 , & V_86 ) ;
F_32 ( V_85 ) ;
if ( V_85 -> V_80 == 0x10 && ( V_86 & 0x80 ) ) {
V_70 = & V_74 ;
break;
}
V_70 = & V_77 ;
...
V_69 [ 0 ] = V_70 -> V_56 ;
F_24 ( V_17 , V_70 ) ;
return F_33 ( V_17 , V_69 , & V_90 , V_70 , 0 ) ;
}
static int F_34 ( struct V_1 * V_17 )
{
struct V_91 * V_18 = F_35 ( & V_17 -> V_2 ) ;
int V_72 ;
V_72 = F_36 ( V_17 ) ;
if ( V_72 )
return V_72 ;
