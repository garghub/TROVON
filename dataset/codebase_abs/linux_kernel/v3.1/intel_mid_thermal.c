...
static struct V_18 * F_15 ( int V_48 )
{
struct V_18 * V_19 =
F_16 ( sizeof( struct V_18 ) , V_49 ) ;
if ( ! V_19 )
return NULL ;
...
static int F_18 ( struct V_51 * V_52 , T_5 V_53 )
{
return F_7 ( 0 ) ;
}
static int F_19 ( struct V_16 * V_17 , unsigned long * V_6 )
{
F_20 ( V_17 == NULL ) ;
return F_4 ( V_17 , V_6 ) ;
}
...
int V_38 ;
struct V_56 * V_57 ;
V_57 = F_16 ( sizeof( struct V_56 ) , V_49 ) ;
if ( ! V_57 )
return - V_58 ;
V_23 = F_11 ( & V_52 -> V_45 ) ;
if ( V_23 ) {
...
struct V_18 * V_19 = F_15 ( V_38 ) ;
if ( ! V_19 ) {
V_23 = - V_58 ;
goto V_59;
}
V_57 -> V_17 [ V_38 ] = F_23 ( V_54 [ V_38 ] ,
0 , V_19 , & V_60 , 0 , 0 , 0 , 0 ) ;
if ( F_24 ( V_57 -> V_17 [ V_38 ] ) ) {
F_22 ( V_19 ) ;
V_23 = F_25 ( V_57 -> V_17 [ V_38 ] ) ;
goto V_59;
}
}
V_57 -> V_52 = V_52 ;
