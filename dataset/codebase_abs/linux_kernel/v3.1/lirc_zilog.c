...
F_27 ( L_13 ,
V_51 [ 0 ] , V_51 [ 1 ] , V_51 [ 2 ] , V_51 [ 3 ] , V_51 [ 4 ] ) ;
...
int V_29 = 0 ;
int V_106 ;
if ( F_65 ( & V_106 , V_51 + V_62 , sizeof( V_106 ) ) ) {
F_4 ( & V_2 -> V_38 ) ;
F_4 ( & V_22 -> V_35 ) ;
F_24 ( V_22 , false ) ;
return - V_71 ;
...
if ( V_29 == 0 ) {
V_29 = F_63 ( V_22 , ( unsigned ) V_106 >> 16 ,
( unsigned ) V_106 & 0xFFFF ) ;
if ( V_29 == - V_67 ) {
F_4 ( & V_2 -> V_38 ) ;
F_4 ( & V_22 -> V_35 ) ;
F_24 ( V_22 , false ) ;
...
V_29 = F_57 ( V_10 ) ? 0 : ( V_108 | V_109 ) ;
F_27 ( L_47 , V_29 ? L_48 : L_49 ) ;
return V_29 ;
}
static long F_68 ( struct V_86 * V_87 , unsigned int V_110 , unsigned long V_44 )
{
struct V_1 * V_2 = V_87 -> V_91 ;
int V_111 ;
unsigned long V_112 , V_18 ;
V_18 = V_2 -> V_7 . V_18 ;
switch ( V_110 ) {
case V_113 :
V_111 = F_69 ( ( unsigned long ) 13 ,
( unsigned long * ) V_44 ) ;
break;
case V_114 :
V_111 = F_69 ( V_18 , ( unsigned long * ) V_44 ) ;
break;
case V_115 :
if ( ! ( V_18 & V_116 ) )
return - V_117 ;
...
if ( ! ( V_18 & V_116 ) )
return - V_117 ;
V_111 = F_71 ( V_112 , ( unsigned long * ) V_44 ) ;
if ( ! V_111 && ! ( F_72 ( V_112 ) & V_18 ) )
V_111 = - V_98 ;
break;
case V_119 :
if ( ! ( V_18 & V_120 ) )
return - V_117 ;
V_111 = F_69 ( V_121 , ( unsigned long * ) V_44 ) ;
break;
case V_122 :
if ( ! ( V_18 & V_120 ) )
return - V_117 ;
V_111 = F_71 ( V_112 , ( unsigned long * ) V_44 ) ;
if ( ! V_111 && V_112 != V_121 )
return - V_98 ;
break;
default:
return - V_98 ;
...
static int F_76 ( struct V_124 * V_125 , struct V_86 * V_87 )
{
struct V_1 * V_2 ;
unsigned int V_8 = F_77 ( V_125 -> V_126 ) ;
V_2 = F_73 ( V_8 ) ;
if ( V_2 == NULL )
return - V_127 ;
F_78 ( & V_2 -> V_46 ) ;
...
static int F_80 ( struct V_124 * V_125 , struct V_86 * V_87 )
{
struct V_1 * V_2 = V_87 -> V_91 ;
if ( V_2 == NULL ) {
F_30 ( L_50 ) ;
...
{
if ( strncmp ( L_51 , V_129 -> V_130 , 8 ) == 0 ) {
struct V_21 * V_22 = F_83 ( V_129 ) ;
if ( V_22 != NULL ) {
F_3 ( & V_22 -> V_35 ) ;
V_22 -> V_36 = NULL ;
F_4 ( & V_22 -> V_35 ) ;
...
} else if ( strncmp ( L_52 , V_129 -> V_130 , 8 ) == 0 ) {
struct V_14 * V_15 = F_83 ( V_129 ) ;
if ( V_15 != NULL ) {
F_3 ( & V_15 -> V_35 ) ;
V_15 -> V_36 = NULL ;
F_4 ( & V_15 -> V_35 ) ;
...
static struct V_1 * F_84 ( struct V_131 * V_132 )
{
struct V_1 * V_2 ;
if ( F_74 ( & V_123 ) )
return NULL ;
...
static int F_85 ( struct V_128 * V_129 , const struct V_133 * V_58 )
{
struct V_1 * V_2 ;
struct V_21 * V_22 ;
struct V_14 * V_15 ;
struct V_131 * V_134 = V_129 -> V_132 ;
int V_29 ;
bool V_135 = false ;
F_27 ( L_53 ,
V_136 , V_58 -> V_130 , V_134 -> V_137 , V_134 -> V_130 , V_129 -> V_138 ) ;
if ( V_58 -> V_139 & V_140 )
V_135 = true ;
else if ( V_141 )
return - V_34 ;
F_86 ( L_54 ,
V_135 ? L_55 : L_56 , V_134 -> V_130 , V_134 -> V_137 ) ;
F_3 ( & V_5 ) ;
V_2 = F_84 ( V_134 ) ;
if ( V_2 == NULL ) {
V_2 = F_87 ( sizeof( struct V_1 ) , V_142 ) ;
if ( V_2 == NULL ) {
V_29 = - V_85 ;
goto V_143;
}
...
F_93 ( & V_2 -> V_23 ) ;
F_93 ( & V_2 -> V_16 ) ;
memcpy ( & V_2 -> V_7 , & V_144 , sizeof( struct V_145 ) ) ;
V_2 -> V_7 . V_10 = & V_2 -> V_10 ;
V_2 -> V_7 . V_83 = & V_134 -> V_83 ;
V_29 = F_94 ( V_2 -> V_7 . V_10 ,
V_2 -> V_7 . V_97 , V_2 -> V_7 . V_146 ) ;
if ( V_29 )
goto V_147;
}
if ( V_135 ) {
V_15 = F_13 ( V_2 ) ;
V_22 = F_87 ( sizeof( struct V_21 ) , V_142 ) ;
if ( V_22 == NULL ) {
V_29 = - V_85 ;
goto V_148;
}
...
V_22 -> V_41 = 1 ;
V_22 -> V_105 =
( V_58 -> V_139 & V_149 ) ? false : true ;
V_22 -> V_2 = F_1 ( V_2 , true ) ;
F_95 ( V_129 , F_22 ( V_2 ) ) ;
F_50 ( V_22 ) ;
if ( V_15 == NULL && ! V_141 ) {
F_86 ( L_57
L_58 , V_134 -> V_130 , V_134 -> V_137 ) ;
goto V_150;
}
} else {
V_22 = F_22 ( V_2 ) ;
V_15 = F_87 ( sizeof( struct V_14 ) , V_142 ) ;
if ( V_15 == NULL ) {
V_29 = - V_85 ;
goto V_148;
}
...
if ( V_2 -> V_7 . V_8 < 0 || V_2 -> V_7 . V_8 >= V_9 ) {
F_30 ( L_64 ,
V_136 , V_9 - 1 , V_2 -> V_7 . V_8 ) ;
V_29 = - V_151 ;
goto V_148;
}
F_86 ( L_65 ,
V_134 -> V_130 , V_134 -> V_137 , V_2 -> V_7 . V_8 ) ;
V_150:
if ( V_15 != NULL )
F_20 ( V_15 , true ) ;
if ( V_22 != NULL )
...
V_143:
F_30 ( L_67 ,
V_136 , V_135 ? L_55 : L_56 , V_134 -> V_130 , V_134 -> V_137 ,
V_29 ) ;
F_4 ( & V_5 ) ;
return V_29 ;
}
