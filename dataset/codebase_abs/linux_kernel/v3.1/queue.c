...
struct V_35 * F_15 ( int V_36 , int * V_37 )
{
struct V_35 * V_38 ;
...
int F_22 ( struct V_13 * V_14 , struct V_41 * V_42 ,
...
if ( F_23 ( V_55 ) -> V_60 && * F_23 ( V_55 ) -> V_60 )
V_56 = * F_23 ( V_55 ) -> V_60 ;
V_14 -> V_42 = V_42 ;
V_14 -> V_15 = F_24 ( F_12 , V_52 ) ;
if ( ! V_14 -> V_15 )
return - V_40 ;
...
F_31 ( V_14 -> V_15 , V_56 ) ;
F_32 ( V_14 -> V_15 ,
F_35 ( V_55 -> V_67 , V_55 -> V_65 / 512 ) ) ;
F_33 ( V_14 -> V_15 , V_55 -> V_62 ) ;
F_34 ( V_14 -> V_15 , V_55 -> V_66 ) ;
...
F_36 ( & V_14 -> V_19 , 1 ) ;
V_14 -> V_34 = F_37 ( F_3 , V_14 , L_5 ,
V_55 -> V_73 , V_53 ? V_53 : L_6 ) ;
if ( F_38 ( V_14 -> V_34 ) ) {
V_58 = F_39 ( V_14 -> V_34 ) ;
goto V_74;
}
...
unsigned int F_49 ( struct V_13 * V_14 , struct V_20 * V_59 )
{
unsigned int V_36 ;
T_3 V_76 ;
struct V_35 * V_38 ;
int V_77 ;
if ( ! V_59 -> V_68 )
return F_50 ( V_14 -> V_15 , V_59 -> V_4 , V_59 -> V_38 ) ;
F_51 ( ! V_59 -> V_72 ) ;
V_36 = F_50 ( V_14 -> V_15 , V_59 -> V_4 , V_59 -> V_72 ) ;
V_59 -> V_78 = V_36 ;
V_76 = 0 ;
F_52 (mqrq->bounce_sg, sg, sg_len, i)
V_76 += V_38 -> V_79 ;
F_53 ( V_59 -> V_38 , V_59 -> V_68 , V_76 ) ;
return 1 ;
}
void F_54 ( struct V_20 * V_59 )
{
if ( ! V_59 -> V_68 )
return;
if ( F_55 ( V_59 -> V_4 ) != V_80 )
return;
F_56 ( V_59 -> V_72 , V_59 -> V_78 ,
V_59 -> V_68 , V_59 -> V_38 [ 0 ] . V_79 ) ;
}
void F_57 ( struct V_20 * V_59 )
{
if ( ! V_59 -> V_68 )
return;
if ( F_55 ( V_59 -> V_4 ) != V_81 )
return;
F_58 ( V_59 -> V_72 , V_59 -> V_78 ,
V_59 -> V_68 , V_59 -> V_38 [ 0 ] . V_79 ) ;
}
