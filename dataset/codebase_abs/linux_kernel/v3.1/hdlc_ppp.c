...
V_38 = (struct V_37 * ) F_19 ( V_15 , sizeof( struct V_37 ) ) ;
V_38 -> V_35 = V_35 ;
V_38 -> V_36 = V_36 ;
V_38 -> V_18 = F_6 ( sizeof( struct V_37 ) + V_39 + V_18 ) ;
if ( V_39 )
memcpy ( F_19 ( V_15 , V_39 ) , & V_40 , V_39 ) ;
if ( V_18 )
memcpy ( F_19 ( V_15 , V_18 ) , V_17 , V_18 ) ;
#if V_41
F_20 ( V_35 >= V_46 ) ;
V_43 = V_47 ;
* V_43 = '\x0' ;
for ( V_42 = 0 ; V_42 < F_21 (unsigned int, magic_len + len, DEBUG_CP) ; V_42 ++ ) {
...
static void F_24 ( struct V_2 * V_3 , T_1 V_6 , T_1 V_51 , T_3 V_35 ,
T_3 V_36 , unsigned int V_18 , const void * V_17 )
{
int V_52 , V_53 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
...
F_26 ( V_3 , L_9 , F_4 ( V_6 ) ) ;
if ( V_6 == V_7 ) {
F_27 ( V_3 ) ;
F_24 ( V_3 , V_10 , V_86 , 0 , 0 , 0 , NULL ) ;
F_24 ( V_3 , V_12 , V_86 , 0 , 0 , 0 , NULL ) ;
V_1 -> V_87 = V_65 ;
F_25 ( & V_5 -> V_63 , V_5 -> V_64 =
V_65 + V_1 -> V_88 * V_67 ) ;
}
...
if ( V_52 == V_85 && V_5 -> V_4 != V_85 ) {
F_26 ( V_3 , L_10 , F_4 ( V_6 ) ) ;
if ( V_6 == V_7 ) {
F_28 ( V_3 ) ;
F_24 ( V_3 , V_10 , V_89 , 0 , 0 , 0 , NULL ) ;
F_24 ( V_3 , V_12 , V_89 , 0 , 0 , 0 , NULL ) ;
}
}
...
static void F_30 ( struct V_2 * V_3 , T_1 V_6 , T_3 V_36 ,
...
if ( V_97 )
F_24 ( V_3 , V_6 , V_104 , V_105 , V_36 , V_97 , V_95 ) ;
else if ( V_96 )
F_24 ( V_3 , V_6 , V_104 , V_106 , V_36 , V_96 , V_95 ) ;
else
F_24 ( V_3 , V_6 , V_107 , V_78 , V_36 , V_91 , V_17 ) ;
F_32 ( V_95 ) ;
}
...
for ( V_42 = 0 ; V_42 < F_21 (unsigned int, len, DEBUG_CP) ; V_42 ++ ) {
...
switch ( V_38 -> V_35 ) {
case V_112 :
V_6 = F_35 ( * ( T_2 * ) V_15 -> V_17 ) ;
if ( V_6 == V_7 || V_6 == V_10 ||
V_6 == V_12 )
F_24 ( V_3 , V_6 , V_113 , 0 , 0 ,
0 , NULL ) ;
goto V_95;
case V_44 :
...
switch ( V_38 -> V_35 ) {
case V_74 :
F_30 ( V_3 , V_6 , V_38 -> V_36 , V_18 , V_15 -> V_17 ) ;
goto V_95;
case V_78 :
if ( V_38 -> V_36 == V_5 -> V_75 )
F_24 ( V_3 , V_6 , V_116 , 0 , 0 , 0 , NULL ) ;
goto V_95;
case V_105 :
case V_106 :
if ( V_38 -> V_36 == V_5 -> V_75 )
F_24 ( V_3 , V_6 , V_117 , 0 , 0 , 0 , NULL ) ;
goto V_95;
case V_80 :
F_24 ( V_3 , V_6 , V_118 , 0 , V_38 -> V_36 , 0 , NULL ) ;
goto V_95;
case V_82 :
F_24 ( V_3 , V_6 , V_119 , 0 , 0 , 0 , NULL ) ;
goto V_95;
case V_84 :
F_24 ( V_3 , V_6 , V_113 , 0 , 0 , 0 , NULL ) ;
goto V_95;
default:
V_18 += sizeof( struct V_37 ) ;
if ( V_18 > V_3 -> V_120 )
V_18 = V_3 -> V_120 ;
F_24 ( V_3 , V_6 , V_121 , 0 , 0 , V_18 , V_38 ) ;
goto V_95;
}
goto V_95;
V_111:
V_3 -> V_99 . V_101 ++ ;
V_95:
F_36 ( & V_1 -> V_110 , V_109 ) ;
F_37 ( V_15 ) ;
F_12 () ;
return V_122 ;
}
static void F_38 ( unsigned long V_123 )
{
...
case V_126 :
if ( V_5 -> V_69 ) {
F_24 ( V_5 -> V_3 , V_5 -> V_6 , V_127 , 0 , 0 ,
0 , NULL ) ;
V_5 -> V_69 -- ;
} else
F_24 ( V_5 -> V_3 , V_5 -> V_6 , V_128 , 0 , 0 ,
0 , NULL ) ;
break;
case V_85 :
if ( V_5 -> V_6 != V_7 )
break;
if ( F_39 ( V_65 , V_1 -> V_87 +
V_1 -> V_129 * V_67 ) ) {
F_26 ( V_5 -> V_3 , L_15 ) ;
F_24 ( V_5 -> V_3 , V_7 , V_89 , 0 , 0 , 0 , NULL ) ;
F_24 ( V_5 -> V_3 , V_7 , V_86 , 0 , 0 , 0 , NULL ) ;
} else {
V_1 -> V_114 = ++ V_1 -> V_76 ;
...
F_24 ( V_3 , V_7 , V_86 , 0 , 0 , 0 , NULL ) ;
}
static void F_43 ( struct V_2 * V_3 )
{
F_24 ( V_3 , V_7 , V_89 , 0 , 0 , 0 , NULL ) ;
}
static void F_44 ( struct V_2 * V_3 )
{
F_12 () ;
}
static int F_45 ( struct V_2 * V_3 , struct V_133 * V_134 )
{
T_5 * V_135 = F_2 ( V_3 ) ;
struct V_1 * V_1 ;
int V_136 ;
...
if ( V_136 )
return V_136 ;
V_136 = F_47 ( V_3 , & V_5 , sizeof( struct V_1 ) ) ;
if ( V_136 )
return V_136 ;
V_1 = F_1 ( V_3 ) ;
F_48 ( & V_1 -> V_110 ) ;
