...
if ( ! ( V_11 && V_23 ) )
return - V_16 ;
for ( V_29 = V_24 ; V_29 <= V_25 ; ++ V_29 ) {
V_7 = F_28 ( sizeof ( struct V_7 ) , V_30 ) ;
if ( ! V_7 )
goto error;
V_1 =
F_28 ( sizeof ( struct V_1 ) , V_30 ) ;
if ( ! V_1 )
goto V_31;
V_7 -> V_1 = V_1 ;
V_4 = F_28 ( sizeof ( struct V_3 ) , V_30 ) ;
if ( ! V_4 )
goto V_32;
V_1 -> V_4 = V_4 ;
V_7 -> V_23 = V_23 ;
V_7 -> V_33 = V_29 ;
V_7 -> V_34 = F_29 ( V_29 , 0 ) ;
snprintf ( V_26 , V_27 , L_7 , V_23 -> V_33 , V_29 ) ;
V_1 -> V_8 = V_7 ;
V_1 -> V_35 = & F_24 ;
V_1 -> V_12 = & V_36 ;
F_5 ( L_8 , V_26 ) ;
...
V_4 -> V_38 = F_19 ( V_7 ) ;
F_5 ( L_9 , V_26 ) ;
V_20 = F_30 ( V_7 -> V_1 , V_23 , V_29 , V_26 ) ;
if ( V_20 ) {
F_10 ( L_10 , V_20 ) ;
goto V_39;
}
