...
struct V_112 * time , struct V_108 * V_109 )
{
int V_20 ;
T_2 V_67 = 0 ;
T_1 V_55 ;
...
V_67 = F_67 ( V_55 , & V_114 -> V_118 , sizeof( * V_114 ) +
V_115 . V_119 ) ;
if ( V_67 == - V_9 )
goto V_117;
else if ( V_67 < 0 ) {
...
if ( F_74 ( V_114 -> V_118 . V_120 , V_121 ) != 0 )
goto V_117;
* V_61 = V_55 ;
if ( F_74 ( V_114 -> V_122 . V_123 ,
V_124 ) == 0 )
* type = V_125 ;
else if ( F_74 ( V_114 -> V_122 . V_123 ,
V_126 ) == 0 )
* type = V_127 ;
else
* type = V_128 ;
...
static T_1 F_75 ( enum V_111 type , unsigned int V_134 ,
...
V_114 -> V_118 . V_135 = V_136 ;
V_114 -> V_118 . V_137 = V_138 ;
V_114 -> V_118 . V_139 = 1 ;
V_114 -> V_118 . V_140 = V_141 ;
V_114 -> V_118 . V_129 = V_130 ;
V_114 -> V_118 . V_132 = F_76 () ;
V_114 -> V_118 . V_95 = sizeof( * V_114 ) + V_47 ;
V_114 -> V_118 . V_120 = V_121 ;
V_114 -> V_118 . V_142 = V_143 ;
V_114 -> V_118 . V_55 = F_77 () ;
V_114 -> V_118 . V_52 = V_144 ;
V_114 -> V_122 . V_145 = sizeof( * V_114 ) ;
V_114 -> V_122 . V_146 = V_47 ;
V_114 -> V_122 . V_135 = V_147 ;
V_114 -> V_122 . V_129 = 0 ;
V_114 -> V_122 . V_52 = V_148 ;
switch ( type ) {
case V_125 :
...
const char * V_160 = F_83 ( V_150 ) ;
F_84 ( V_36 L_10 , V_160 ) ;
V_20 = - V_10 ;
goto V_156;
}
V_20 = F_70 ( V_40 ) ;
...
F_85 ( & V_152 ) ;
F_27 ( & V_15 ) ;
V_20 = F_86 ( & V_15 , & V_152 ) ;
if ( V_20 )
goto V_161;
V_20 = F_87 ( & V_152 , L_12 ) ;
if ( V_20 )
goto V_161;
V_20 = F_88 ( & V_15 ) ;
if ( V_20 )
...
V_154 = F_89 ( V_42 . V_45 , V_42 . V_47 , L_12 ) ;
if ( ! V_154 ) {
F_84 ( V_36
L_16 ,
