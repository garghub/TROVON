...
if ( ( V_44 [ 0 ] == 5 ) && ( V_44 [ 2 ] == 0 ) && ( V_40 -> V_84 == NULL ) ) {
V_82 ++ ;
V_2 -> V_83 ++ ;
V_8 = 0 ;
goto V_81;
...
unsigned long F_43 ( const volatile void T_4 * V_45 , unsigned long V_86 )
{
unsigned long V_87 ;
struct V_20 * V_21 ;
struct V_39 * V_40 ;
V_87 = F_24 ( ( unsigned long V_88 ) V_45 ) ;
V_21 = F_44 ( V_87 ) ;
if ( ! V_21 ) {
V_89 ++ ;
return V_86 ;
...
int F_49 ( struct V_20 * V_21 , enum V_95 V_93 )
{
struct V_39 * V_40 = F_45 ( V_21 ) ;
...
F_55 ( V_2 , V_25 * 4 , 4 , V_2 -> V_101 [ V_25 ] ) ;
}
F_55 ( V_2 , 12 * 4 , 4 , V_2 -> V_101 [ 12 ] ) ;
#define F_56 ( T_5 ) (8*((OFF)/4)+3-(OFF))
#define F_57 ( T_5 ) (((u8 *)(pdn->config_space))[BYTE_SWAP(OFF)])
F_55 ( V_2 , V_102 , 1 ,
F_57 ( V_102 ) ) ;
F_55 ( V_2 , V_103 , 1 ,
F_57 ( V_103 ) ) ;
F_55 ( V_2 , 15 * 4 , 4 , V_2 -> V_101 [ 15 ] ) ;
F_12 ( V_2 , V_31 , 4 , & V_100 ) ;
if ( V_2 -> V_101 [ 1 ] & V_104 )
V_100 |= V_104 ;
else
V_100 &= ~ V_104 ;
if ( V_2 -> V_101 [ 1 ] & V_105 )
V_100 |= V_105 ;
else
V_100 &= ~ V_105 ;
F_55 ( V_2 , V_31 , 4 , V_100 ) ;
}
...
if ( ! V_2 )
return;
if ( ( V_2 -> V_59 & V_60 ) && ! F_58 ( V_2 -> V_106 ) )
F_54 ( V_2 ) ;
F_15 (pdn->node, dn)
F_20 ( F_16 ( V_40 ) ) ;
}
...
F_12 ( V_2 , V_25 * 4 , 4 , & V_2 -> V_101 [ V_25 ] ) ;
}
void
F_19 ( struct V_1 * V_2 )
{
...
static int F_60 ( int V_6 ,
struct V_109 * V_110 )
{
unsigned int V_44 [ 3 ] ;
int V_69 ;
if ( V_111 != V_48 ) {
V_69 = F_3 ( V_111 , 4 , 2 , V_44 ,
V_6 , V_110 -> V_112 , V_110 -> V_113 , 1 ) ;
if ( V_69 || ( V_44 [ 0 ] == 0 ) )
return 0 ;
V_69 = F_3 ( V_111 , 4 , 2 , V_44 ,
V_6 , V_110 -> V_112 , V_110 -> V_113 , 0 ) ;
if ( V_69 )
return 0 ;
return V_44 [ 0 ] ;
}
if ( V_114 != V_48 ) {
V_69 = F_3 ( V_114 , 4 , 2 , V_44 ,
V_6 , V_110 -> V_112 , V_110 -> V_113 , 0 ) ;
if ( V_69 )
return 0 ;
return V_44 [ 0 ] ;
...
static void * F_61 ( struct V_39 * V_40 , void * V_115 )
{
unsigned int V_44 [ 3 ] ;
struct V_109 * V_110 = V_115 ;
int V_69 ;
const T_2 * V_106 = F_40 ( V_40 , L_40 , NULL ) ;
const T_2 * V_116 = F_40 ( V_40 , L_41 , NULL ) ;
const T_2 * V_117 = F_40 ( V_40 , L_42 , NULL ) ;
const T_2 * V_118 ;
int V_119 ;
struct V_1 * V_2 = F_16 ( V_40 ) ;
V_2 -> V_106 = 0 ;
...
V_2 -> V_106 = * V_106 ;
V_118 = F_40 ( V_40 , L_44 , NULL ) ;
if ( V_118 ) {
V_69 = F_3 ( V_91 , 4 , 1 , NULL ,
V_118 [ 0 ] , V_110 -> V_112 , V_110 -> V_113 ,
V_121 ) ;
V_119 = 0 ;
if ( V_69 == 0 ) {
V_2 -> V_12 = V_118 [ 0 ] ;
V_2 -> V_13 = F_60 ( V_2 -> V_12 , V_110 ) ;
V_69 = F_21 ( V_2 , V_44 ) ;
if ( ( V_69 == 0 ) && ( V_44 [ 1 ] == 1 ) )
V_119 = 1 ;
}
...
for ( V_15 = F_68 ( NULL , L_60 ) ; V_15 ;
V_15 = F_68 ( V_15 , L_60 ) ) {
unsigned long V_16 ;
V_16 = F_69 ( V_15 ) ;
if ( V_16 == 0 || F_16 ( V_15 ) == NULL )
continue;
V_110 . V_113 = F_5 ( V_16 ) ;
V_110 . V_112 = F_4 ( V_16 ) ;
F_70 ( V_15 , F_61 , & V_110 ) ;
}
if ( V_72 )
F_11 ( V_124 L_61 ) ;
else
...
return;
V_110 . V_112 = F_4 ( V_15 -> V_16 ) ;
V_110 . V_113 = F_5 ( V_15 -> V_16 ) ;
F_61 ( V_40 , & V_110 ) ;
}
...
void F_79 ( struct V_127 * V_128 )
{
struct V_20 * V_21 ;
F_80 (dev, &bus->devices, bus_list) {
F_73 ( V_21 ) ;
if ( V_21 -> V_129 == V_130 ) {
struct V_127 * V_131 = V_21 -> V_132 ;
if ( V_131 )
F_79 ( V_131 ) ;
}
}
...
{
struct V_127 * V_128 = V_21 -> V_132 ;
struct V_20 * V_84 , * V_133 ;
F_81 ( V_21 ) ;
if ( V_128 && V_21 -> V_129 == V_130 ) {
F_85 (child, tmp, &bus->devices, bus_list)
F_84 ( V_84 ) ;
}
}
static int F_86 ( struct V_134 * V_135 , void * V_136 )
{
if ( 0 == V_72 ) {
F_87 ( V_135 , L_67 ) ;
F_87 ( V_135 , L_68 , V_71 ) ;
} else {
F_87 ( V_135 , L_69 ) ;
F_87 ( V_135 ,
L_70
...
static int F_88 ( struct V_137 * V_137 , struct V_138 * V_138 )
{
return F_89 ( V_138 , F_86 , NULL ) ;
}
static int T_6 F_90 ( void )
{
if ( F_91 ( V_139 ) )
F_92 ( L_76 , 0 , NULL , & V_140 ) ;
return 0 ;
}
