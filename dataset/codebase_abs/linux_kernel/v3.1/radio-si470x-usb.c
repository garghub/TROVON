...
static int F_40 ( struct V_98 * V_13 ,
const struct V_99 * V_100 )
{
struct V_1 * V_2 ;
struct V_101 * V_102 ;
struct V_103 * V_104 ;
int V_105 , V_106 , V_6 = 0 ;
...
F_43 ( & V_2 -> V_75 ) ;
V_102 = V_13 -> V_110 ;
for ( V_105 = 0 ; V_105 < V_102 -> V_111 . V_112 ; ++ V_105 ) {
V_104 = & V_102 -> V_104 [ V_105 ] . V_111 ;
if ( ( ( V_104 -> V_79 & V_113 ) ==
V_11 ) && ( ( V_104 -> V_114 &
V_115 ) == V_116 ) )
V_2 -> V_78 = V_104 ;
...
V_106 = F_28 ( V_2 -> V_78 -> V_80 ) ;
V_2 -> V_53 = F_44 ( V_106 , V_82 ) ;
if ( ! V_2 -> V_53 ) {
F_30 ( & V_13 -> V_14 , L_9 ) ;
V_6 = - V_108 ;
goto V_117;
...
F_30 ( & V_13 -> V_14 , L_11 ,
V_2 -> V_19 [ V_122 ] , V_2 -> V_19 [ V_123 ] ) ;
if ( ( V_2 -> V_19 [ V_123 ] & V_124 ) < V_125 ) {
F_4 ( & V_13 -> V_14 ,
L_12
L_13 , V_125 ) ;
F_4 ( & V_13 -> V_14 ,
...
static int F_54 ( struct V_98 * V_13 ,
T_1 V_134 )
{
F_30 ( & V_13 -> V_14 , L_24 ) ;
return 0 ;
}
static int F_55 ( struct V_98 * V_13 )
{
F_30 ( & V_13 -> V_14 , L_25 ) ;
return 0 ;
}
static void F_56 ( struct V_98 * V_13 )
{
