...
F_48 ( struct V_2 * V_3 )
{
struct V_137 * V_138 = F_49 ( V_3 -> V_15 ) ;
struct V_139 * V_140 ;
int V_141 ;
V_140 = F_50 ( V_138 , V_142 , 0 ) ;
if ( ! V_140 ) {
F_51 ( & V_138 -> V_15 , L_8 ) ;
return - V_143 ;
}
V_141 = F_52 ( V_140 ) ;
V_140 = F_53 ( & V_138 -> V_15 , V_140 -> V_144 ,
V_141 , F_54 ( & V_138 -> V_15 ) ) ;
if ( ! V_140 ) {
F_51 ( & V_138 -> V_15 , L_9 ) ;
return - V_17 ;
}
if ( V_3 -> V_4 & V_136 ) {
V_3 -> V_7 = F_55 ( & V_138 -> V_15 ,
V_3 -> V_145 , V_141 ) ;
if ( V_3 -> V_7 == NULL )
return - V_146 ;
}
...
static void
F_59 ( struct V_156 * V_157 , const char * V_158 , T_3 V_159 )
{
struct V_1 * V_67 ;
struct V_2 * V_3 ;
unsigned long V_4 ;
...
V_3 = & V_67 -> V_3 ;
F_5 ( & V_5 , V_4 ) ;
F_60 ( V_3 , V_158 , V_159 , F_58 ) ;
F_7 ( & V_5 , V_4 ) ;
}
static int T_4
F_61 ( struct V_156 * V_157 , char * V_163 )
{
struct V_1 * V_67 ;
struct V_2 * V_3 ;
int V_109 = 115200 ;
...
V_3 -> V_69 = F_33 ( V_67 -> V_70 ) ;
if ( V_163 )
F_62 ( V_163 , & V_109 , & V_29 , & V_164 , & V_165 ) ;
return F_63 ( V_3 , V_157 , V_109 , V_29 , V_164 , V_165 ) ;
}
static int T_4
F_64 ( void )
{
...
struct V_70 * V_70 ;
int V_150 ;
V_167 = F_50 ( V_138 , V_142 , 0 ) ;
V_168 = F_50 ( V_138 , V_169 , 0 ) ;
if ( ! V_167 || ! V_168 )
return - V_143 ;
...
return - V_17 ;
V_70 = F_67 ( & V_138 -> V_15 , L_10 ) ;
if ( F_68 ( V_70 ) ) {
F_36 ( L_11 ) ;
return - V_171 ;
}
V_93 = F_69 ( V_138 , L_12 ) ;
V_95 = F_69 ( V_138 , L_13 ) ;
V_97 = F_69 ( V_138 , L_14 ) ;
if ( ( V_93 < 0 ) | ( V_95 < 0 ) | ( V_97 < 0 ) )
return - V_143 ;
V_67 = F_70 ( sizeof( struct V_1 ) , V_172 ) ;
if ( ! V_67 )
return - V_146 ;
V_3 = & V_67 -> V_3 ;
V_3 -> V_173 = V_174 ;
