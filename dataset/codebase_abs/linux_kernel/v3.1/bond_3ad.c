...
V_207:
if ( ! V_4 -> V_205 )
F_81 ( V_4 -> V_208 , & V_4 -> V_203 , V_209 ) ;
V_206:
F_82 ( & V_4 -> V_204 ) ;
}
...
if ( V_8 ) {
V_215 -> V_216 = V_8 -> V_155 ;
V_215 -> V_217 = V_8 -> V_86 ;
V_215 -> V_69 = V_8 -> V_156 ;
V_215 -> V_53 = V_8 -> V_157 ;
...
V_220 = V_4 -> V_225 ( V_90 , V_221 ) ;
F_92 (bond, slave, i) {
struct V_8 * V_9 = F_4 ( V_3 ) . V_2 . V_8 ;
if ( V_9 && ( V_9 -> V_155 == V_222 ) ) {
V_220 -- ;
if ( V_220 < 0 )
break;
}
...
return;
F_80 ( & V_4 -> V_204 ) ;
F_83 ( (struct V_46 * ) V_90 -> V_228 , V_3 , V_90 -> V_229 ) ;
F_82 ( & V_4 -> V_204 ) ;
}
