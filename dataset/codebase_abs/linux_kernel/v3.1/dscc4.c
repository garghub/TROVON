...
if ( ! V_10 ) {
if ( V_32 > 4 )
F_17 ( V_33 L_38 , V_3 -> V_34 ,
V_10 ) ;
if ( ( V_32 > 1 ) && ( V_233 > 1 ) )
F_17 ( V_33 L_39 , V_3 -> V_34 , V_233 ) ;
if ( V_233 && F_121 ( V_3 ) )
if ( ( V_8 -> V_17 - V_8 -> V_28 ) % V_18 )
F_122 ( V_3 ) ;
...
V_8 -> V_122 [ V_64 ] = 0 ;
V_8 -> V_257 ++ ;
if ( F_15 ( V_10 , V_8 , V_3 , L_53 ) < 0 )
return;
if ( ! ( V_10 & V_235 ) ) {
struct V_26 * V_39 ;
if ( V_32 > 4 )
F_17 ( V_33 L_54 , V_3 -> V_34 ,
V_10 ) ;
V_10 &= 0x00ffffff ;
if ( V_10 & V_255 ) {
