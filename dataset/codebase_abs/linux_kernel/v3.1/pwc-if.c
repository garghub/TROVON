...
static int F_63 ( struct V_137 * V_138 , unsigned int * V_139 ,
...
* V_139 = V_144 ;
* V_140 = 1 ;
V_141 [ 0 ] = F_65 ( ( V_3 -> V_145 . V_146 * V_3 -> V_145 . V_147 * 3 ) / 2 ) ;
return 0 ;
}
static int F_66 ( struct V_148 * V_23 )
{
...
static int F_68 ( struct V_148 * V_23 )
{
...
static int F_69 ( struct V_148 * V_23 )
{
struct V_2 * V_3 = F_64 ( V_23 -> V_137 ) ;
struct V_1 * V_5 = F_52 ( V_23 , struct V_1 , V_23 ) ;
return F_70 ( V_3 , V_5 ) ;
}
static void F_71 ( struct V_148 * V_23 )
{
struct V_1 * V_5 = F_52 ( V_23 , struct V_1 , V_23 ) ;
F_72 ( V_5 -> V_18 ) ;
}
static void F_73 ( struct V_148 * V_23 )
{
struct V_2 * V_3 = F_64 ( V_23 -> V_137 ) ;
struct V_1 * V_5 = F_52 ( V_23 , struct V_1 , V_23 ) ;
unsigned long V_4 = 0 ;
...
F_76 ( V_3 , 1 ) ;
if ( V_3 -> V_150 ) {
F_77 ( V_3 , V_3 -> V_151 . V_146 , V_3 -> V_151 . V_147 ,
V_3 -> V_152 , V_3 -> V_153 ,
V_3 -> V_154 ) ;
}
...
static int F_84 ( struct V_64 * V_65 , const struct V_158 * V_159 )
{
...
int V_164 = V_150 ;
char V_165 [ 30 ] , * V_166 ;
V_160 = F_23 ( V_61 -> V_167 . V_168 ) ;
V_161 = F_23 ( V_61 -> V_167 . V_169 ) ;
F_86 ( L_56 ,
V_160 , V_161 ,
V_65 -> V_170 -> V_72 . V_171 ) ;
if ( V_65 -> V_170 -> V_72 . V_171 > 0 )
return - V_119 ;
if ( V_160 == 0x0471 ) {
switch ( V_161 ) {
case 0x0302 :
...
V_164 = 0 ;
memset ( V_165 , 0 , 30 ) ;
F_88 ( V_61 , V_61 -> V_167 . V_172 , V_165 , 29 ) ;
F_86 ( L_114 , V_165 ) ;
if ( V_61 -> V_167 . V_173 > 1 )
F_89 ( L_115 ) ;
...
V_3 -> type = V_162 ;
V_3 -> V_152 = V_174 ;
strcpy ( V_3 -> V_175 , V_165 ) ;
V_3 -> V_113 = V_113 ;
if ( V_160 == 0x046D && V_161 == 0x08B5 ) {
V_3 -> V_176 . V_177 = - 7000 ;
V_3 -> V_176 . V_178 = 7000 ;
V_3 -> V_176 . V_179 = - 3000 ;
V_3 -> V_176 . V_180 = 2500 ;
}
F_91 ( V_3 ) ;
F_92 ( & V_3 -> V_157 ) ;
F_92 ( & V_3 -> V_181 ) ;
...
V_3 -> V_128 . type = V_183 ;
V_3 -> V_128 . V_184 = V_185 | V_186 | V_187 ;
V_3 -> V_128 . V_188 = V_3 ;
V_3 -> V_128 . V_189 = sizeof( struct V_1 ) ;
V_3 -> V_128 . V_190 = & V_191 ;
V_3 -> V_128 . V_192 = & V_193 ;
F_95 ( & V_3 -> V_128 ) ;
memcpy ( & V_3 -> V_100 , & V_194 , sizeof( V_194 ) ) ;
V_3 -> V_100 . V_195 = & V_65 -> V_86 ;
V_3 -> V_100 . V_196 = & V_3 -> V_157 ;
strcpy ( V_3 -> V_100 . V_166 , V_166 ) ;
F_96 ( & V_3 -> V_100 , V_3 ) ;
V_3 -> V_197 = F_23 ( V_61 -> V_167 . V_198 ) ;
F_86 ( L_117 , V_3 -> V_197 ) ;
for ( V_122 = 0 ; V_122 < V_123 ; V_122 ++ ) {
if ( ( ( V_124 [ V_122 ] . type == - 1 ) || ( V_124 [ V_122 ] . type == V_3 -> type ) ) &&
( V_124 [ V_122 ] . V_3 == NULL ) ) {
if ( ( V_124 [ V_122 ] . V_165 [ 0 ] == '*' ) || ! strcmp ( V_124 [ V_122 ] . V_165 , V_165 ) ) {
V_163 = V_124 [ V_122 ] . V_199 ;
F_86 ( L_118 , V_163 ) ;
break;
}
}
...
#endif
F_78 ( V_3 , 0 , 0 ) ;
V_110 = F_77 ( V_3 , V_3 -> V_200 . V_146 , V_3 -> V_200 . V_147 ,
...
F_76 ( V_3 , 0 ) ;
V_110 = F_101 ( & V_3 -> V_100 , V_202 , V_163 ) ;
if ( V_110 < 0 ) {
F_17 ( L_122 , V_110 ) ;
goto V_203;
}
...
F_104 ( V_61 , V_3 -> V_205 , sizeof( V_3 -> V_205 ) ) ;
F_105 ( V_3 -> V_205 , L_125 , sizeof( V_3 -> V_205 ) ) ;
V_3 -> V_13 -> V_166 = L_126 ;
V_3 -> V_13 -> V_206 = V_3 -> V_205 ;
F_106 ( V_3 -> V_61 , & V_3 -> V_13 -> V_159 ) ;
V_3 -> V_13 -> V_86 . V_195 = & V_3 -> V_61 -> V_86 ;
V_3 -> V_13 -> V_207 [ 0 ] = F_107 ( V_208 ) ;
V_3 -> V_13 -> V_209 [ F_108 ( V_14 ) ] = F_107 ( V_14 ) ;
...
V_124 [ V_33 ] . type = - 1 ;
strcpy ( V_124 [ V_33 ] . V_165 , L_137 ) ;
V_216 = V_217 = V_215 ;
while ( * V_216 != '\0' && * V_216 != ':' )
V_216 ++ ;
while ( * V_217 != '\0' && * V_217 != '.' )
V_217 ++ ;
if ( * V_217 != '\0' && V_217 > V_216 ) {
F_17 ( L_138 ) ;
return - V_109 ;
}
if ( * V_216 == '\0' ) {
...
F_117 ( V_215 , NULL , 10 ) ;
V_124 [ V_33 ] . V_199 =
F_117 ( V_216 + 1 , NULL , 10 ) ;
if ( * V_217 != '\0' ) {
int V_219 ;
V_217 ++ ;
V_219 = 0 ;
while ( * V_217 != ':' && V_219 < 29 ) {
V_124 [ V_33 ] . V_165 [ V_219 ++ ] = * V_217 ;
V_217 ++ ;
}
V_124 [ V_33 ] . V_165 [ V_219 ] = '\0' ;
}
}
F_8 ( L_140 , V_33 ) ;
F_8 ( L_141 , V_124 [ V_33 ] . type ) ;
F_8 ( L_142 , V_124 [ V_33 ] . V_165 ) ;
F_8 ( L_143 , V_124 [ V_33 ] . V_199 ) ;
}
else
V_124 [ V_33 ] . type = 0 ;
}
