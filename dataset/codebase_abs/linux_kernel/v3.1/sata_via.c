...
static void F_45 ( struct V_12 * V_13 , int V_94 )
{
T_2 V_95 ;
F_7 ( V_13 , V_96 , & V_95 ) ;
F_46 ( & V_13 -> V_15 , L_9 ,
( int ) ( V_95 & 0xf0 ) == 0xf0 ? 0 : V_95 & 0x0f ) ;
F_7 ( V_13 , V_97 , & V_95 ) ;
if ( ( V_95 & V_98 ) != V_98 ) {
F_47 ( & V_13 -> V_15 , L_10 ,
( int ) V_95 ) ;
...
static int F_48 ( struct V_12 * V_13 , const struct V_104 * V_105 )
{
unsigned int V_47 ;
int V_85 ;
struct V_81 * V_14 = NULL ;
int V_94 = ( int ) V_105 -> V_106 ;
const unsigned * V_107 ;
F_49 ( & V_13 -> V_15 , V_108 ) ;
V_85 = F_50 ( V_13 ) ;
if ( V_85 )
return V_85 ;
if ( V_94 == V_103 )
...
V_107 = & V_110 [ 0 ] ;
for ( V_47 = 0 ; V_47 < F_39 ( V_110 ) ; V_47 ++ )
if ( ( F_51 ( V_13 , V_47 ) == 0 ) ||
( F_52 ( V_13 , V_47 ) < V_107 [ V_47 ] ) ) {
F_36 ( & V_13 -> V_15 ,
L_13 ,
V_47 ,
( unsigned long long ) F_51 ( V_13 , V_47 ) ,
( unsigned long long ) F_52 ( V_13 , V_47 ) ) ;
return - V_111 ;
}
switch ( V_94 ) {
case V_102 :
...
F_45 ( V_13 , V_94 ) ;
F_53 ( V_13 ) ;
return F_54 ( V_14 , V_13 -> V_113 , V_114 ,
V_115 , & V_116 ) ;
}
