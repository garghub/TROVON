...
static int F_143 ( int V_175 )
{
struct V_176 * V_1 = V_6 [ V_175 - V_4 ] . V_8 ;
struct V_176 * V_177 = V_6 [ V_175 - V_4 ] . V_7 ;
unsigned long V_178 [ 3 ] ;
if ( F_144 ( V_175 == V_179 ) )
return V_148 ;
#ifdef F_145
V_178 [ 0 ] = F_14 () & F_146 () ;
#else
...
if ( V_178 [ 0 ] & V_1 -> V_21 )
#else
if ( V_178 [ ( V_1 -> V_20 - V_4 ) / 32 ] & V_1 -> V_21 )
#endif
return V_1 -> V_20 ;
}
}
void F_160 ( int V_175 , struct V_44 * V_180 )
{
int V_25 = F_143 ( V_175 ) ;
if ( V_25 == - 1 )
return;
F_161 ( V_25 , V_180 ) ;
}
...
if ( V_25 <= V_148 )
return V_25 ;
for ( V_181 = 0 ; V_181 < V_10 ; V_181 ++ ) {
struct V_176 * V_1 = V_9 + V_181 ;
if ( V_1 -> V_20 == V_25 ) {
for ( V_182 = 0 ; V_182 <= V_3 - V_4 ; V_182 ++ ) {
if ( V_6 [ V_182 ] . V_8 <= V_1 &&
V_6 [ V_182 ] . V_7 > V_1 )
return V_4 + V_182 ;
}
}
...
T_7 int F_163 ( int V_175 , struct V_44 * V_45 )
{
struct V_184 * V_185 = F_164 () ;
...
return 0 ;
if ( V_25 == V_190 ) {
#if ! F_3 ( V_191 ) || F_3 ( F_128 )
F_165 ( 1 ) ;
#endif
F_166 ( V_192 ) . V_193 = V_45 -> V_193 ;
F_166 ( V_192 ) . V_194 = V_45 -> V_194 ;
if ( V_187 != V_195 )
F_166 ( V_192 ) . V_193 &= ~ 0x10 ;
else
F_166 ( V_192 ) . V_193 |= 0x10 ;
}
if ( V_187 == V_195 ) {
V_189 = F_74 ( V_196 , & V_185 -> V_61 ) ;
F_167 () ;
}
F_33 ( V_25 ) ;
F_34 ( V_25 , V_45 ) ;
...
F_171 ( V_201 ) ;
if ( ! V_189 ) {
F_77 ( V_196 , & V_185 -> V_61 ) ;
return ! F_80 ( V_202 , & V_185 -> V_61 ) ;
}
}
return 0 ;
}
