...
if ( ! V_62 )
return - V_73 ;
V_2 = F_23 ( sizeof( struct V_1 ) , V_74 ) ;
if ( ! V_2 )
return - V_75 ;
V_2 -> V_14 = V_14 ;
F_24 ( & V_2 -> V_41 ) ;
...
V_69 = V_14 -> V_44 . V_76 ;
if ( V_69 && V_69 -> V_77 )
V_2 -> V_33 . V_77 = V_69 -> V_77 ;
else
V_2 -> V_33 . V_77 = F_26 ( & V_14 -> V_44 ) ;
V_2 -> V_33 . type = V_78 ;
V_2 -> V_33 . V_79 = V_80 ;
V_2 -> V_33 . V_40 = V_62 -> V_81 ;
V_2 -> V_33 . V_59 = V_62 -> V_82 ;
V_2 -> V_33 . V_38 = V_62 -> V_82 * V_62 -> V_83 ;
V_2 -> V_33 . V_84 = F_11 ;
V_2 -> V_33 . V_85 = F_17 ;
V_2 -> V_33 . V_86 = F_18 ;
F_27 ( & V_14 -> V_44 , L_4 , V_62 -> V_77 ,
...
V_2 -> V_33 . V_88 ) ;
if ( F_29 () ) {
static const char * V_89 [] = { L_7 , NULL } ;
V_72 = F_30 ( & V_2 -> V_33 ,
V_89 ,
& V_71 , 0 ) ;
}
if ( V_72 <= 0 && V_69 && V_69 -> V_71 ) {
V_71 = V_69 -> V_71 ;
V_72 = V_69 -> V_72 ;
}
if ( V_72 > 0 ) {
...
L_10 ,
V_55 , V_71 [ V_55 ] . V_77 ,
( long long ) V_71 [ V_55 ] . V_30 ,
( long long ) V_71 [ V_55 ] . V_38 ,
( long long ) ( V_71 [ V_55 ] . V_38 >> 10 ) ) ;
}
V_2 -> V_90 = 1 ;
return F_31 ( & V_2 -> V_33 , V_71 ,
V_72 ) ;
}
V_51 = F_31 ( & V_2 -> V_33 , NULL , 0 ) ;
if ( V_51 == 1 ) {
F_32 ( V_2 ) ;
F_25 ( & V_14 -> V_44 , NULL ) ;
return - V_73 ;
...
static int T_6 F_33 ( struct V_63 * V_14 )
{
struct V_1 * V_2 = F_34 ( & V_14 -> V_44 ) ;
int V_51 ;
V_51 = F_35 ( & V_2 -> V_33 ) ;
if ( V_51 == 0 )
F_32 ( V_2 ) ;
