...
struct V_216 * V_217 , struct V_216 * V_218 )
{
int V_19 ;
int V_219 ;
...
if ( V_217 -> V_220 & V_228 )
V_22 = V_229 ;
else
V_22 = V_201 ;
if ( V_217 -> V_220 & V_230 ) {
if ( ! ( V_217 -> V_220 & V_231 ) )
V_20 = V_232 ;
else
V_20 = V_233 ;
} else {
...
if ( ( V_217 -> V_220 & V_234 ) && ( V_6 -> V_46 == 256 ) )
V_6 -> V_185 |= V_192 ;
else
V_6 -> V_185 &= ~ V_192 ;
V_217 -> V_220 &= ~ V_235 ;
V_19 = F_90 ( V_27 , V_217 , V_218 , 0 , V_27 -> V_196 / 16 ) ;
F_73 ( & V_27 -> V_164 , V_163 ) ;
F_86 ( V_27 , V_217 -> V_220 , V_19 ) ;
V_219 = F_8 ( V_6 , V_19 , V_20 , V_21 , V_22 ) ;
if ( V_219 )
goto V_236;
if ( F_91 ( V_217 ) )
F_92 ( V_217 , V_19 , V_19 ) ;
V_236:
F_74 ( & V_27 -> V_164 , V_163 ) ;
}
