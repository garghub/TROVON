...
static void F_32 ( T_2 V_52 , T_2 * V_53 )
{
if ( V_52 & V_54 ) {
* V_53 |= V_55 ;
} else {
...
static void F_33 ( struct V_1 * V_2 , T_2 V_52 )
{
struct V_11 * V_12 = F_4 ( V_2 ) ;
unsigned long V_40 ;
T_2 V_53 ;
F_26 ( & V_12 -> V_23 , V_40 ) ;
V_53 = F_17 ( V_12 -> V_20 . V_38 + V_39 ) ;
F_32 ( V_52 , & V_53 ) ;
F_18 ( V_53 , V_12 -> V_20 . V_38 + V_39 ) ;
F_27 ( & V_12 -> V_23 , V_40 ) ;
}
static void F_34 ( struct V_11 * V_12 )
{
F_33 ( V_12 -> V_2 , V_12 -> V_2 -> V_52 ) ;
}
static T_2 F_35 ( struct V_1 * V_2 , T_2 V_52 )
{
if ( V_52 & V_54 )
V_52 |= V_56 ;
else
...
static int F_36 ( struct V_1 * V_2 , T_2 V_52 )
{
T_2 V_57 = V_2 -> V_52 ^ V_52 ;
if ( V_57 & V_54 )
F_33 ( V_2 , V_52 ) ;
return 0 ;
}
