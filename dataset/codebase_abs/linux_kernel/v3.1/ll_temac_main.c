...
F_63 ( V_41 , V_157 ) ;
V_41 -> V_25 = V_27 ;
V_41 -> V_160 = F_64 ( V_41 , V_27 ) ;
F_65 ( V_41 ) ;
if ( ( ( V_2 -> V_161 & V_162 ) != 0 ) &&
( V_41 -> V_160 == F_66 ( V_163 ) ) &&
( V_41 -> V_46 > 64 ) ) {
...
static T_4 F_70 ( int V_168 , void * V_169 )
{
...
static T_4 F_71 ( int V_168 , void * V_169 )
{
struct V_26 * V_27 = V_169 ;
struct V_1 * V_2 = F_22 ( V_27 ) ;
unsigned int V_170 ;
...
F_20 ( & V_27 -> V_25 , L_16 ) ;
if ( V_2 -> V_177 ) {
V_2 -> V_105 = F_73 ( V_2 -> V_27 , V_2 -> V_177 ,
F_47 , 0 , 0 ) ;
if ( ! V_2 -> V_105 ) {
F_29 ( V_2 -> V_25 , L_17 ) ;
return - V_178 ;
...
V_176 = F_75 ( V_2 -> V_179 , F_70 , 0 , V_27 -> V_180 , V_27 ) ;
if ( V_176 )
goto V_181;
V_176 = F_75 ( V_2 -> V_182 , F_71 , 0 , V_27 -> V_180 , V_27 ) ;
if ( V_176 )
goto V_183;
F_45 ( V_27 ) ;
return 0 ;
...
static T_5 F_82 ( struct V_184 * V_25 ,
struct V_185 * V_186 , char * V_187 )
{
struct V_26 * V_27 = F_83 ( V_25 ) ;
struct V_1 * V_2 = F_22 ( V_27 ) ;
int V_28 , V_46 = 0 ;
...
static int T_6 F_84 ( struct V_18 * V_19 )
{
struct V_20 * V_21 ;
struct V_1 * V_2 ;
struct V_26 * V_27 ;
...
F_89 ( & V_2 -> V_158 ) ;
F_90 ( & V_2 -> V_62 ) ;
V_2 -> V_4 = F_91 ( V_19 -> V_25 . V_195 , 0 ) ;
if ( ! V_2 -> V_4 ) {
F_29 ( & V_19 -> V_25 , L_24 ) ;
goto V_196;
}
V_2 -> V_161 = 0 ;
V_65 = ( T_7 * ) F_92 ( V_19 -> V_25 . V_195 , L_25 , NULL ) ;
if ( V_65 && F_93 ( * V_65 ) ) {
V_2 -> V_161 |= V_197 ;
V_27 -> V_189 |= V_198 ;
}
V_65 = ( T_7 * ) F_92 ( V_19 -> V_25 . V_195 , L_26 , NULL ) ;
if ( V_65 && F_93 ( * V_65 ) )
V_2 -> V_161 |= V_162 ;
V_21 = F_94 ( V_19 -> V_25 . V_195 , L_27 , 0 ) ;
if ( ! V_21 ) {
F_29 ( & V_19 -> V_25 , L_28 ) ;
goto V_199;
}
if ( F_16 ( V_2 , V_19 , V_21 ) ) {
V_2 -> V_16 = F_91 ( V_21 , 0 ) ;
if ( V_2 -> V_16 ) {
V_2 -> V_23 = F_10 ;
V_2 -> V_24 = F_11 ;
...
V_2 -> V_182 = F_96 ( V_21 , 0 ) ;
V_2 -> V_179 = F_96 ( V_21 , 1 ) ;
F_95 ( V_21 ) ;
...
V_67 = F_92 ( V_19 -> V_25 . V_195 , L_32 , & V_151 ) ;
if ( ( ! V_67 ) || ( V_151 != 6 ) ) {
F_29 ( & V_19 -> V_25 , L_33 ) ;
V_176 = - V_178 ;
goto V_201;
...
F_33 ( V_27 , ( void * ) V_67 ) ;
V_176 = F_97 ( V_2 , V_19 -> V_25 . V_195 ) ;
if ( V_176 )
F_98 ( & V_19 -> V_25 , L_34 ) ;
V_2 -> V_177 = F_94 ( V_19 -> V_25 . V_195 , L_35 , 0 ) ;
if ( V_2 -> V_177 )
F_20 ( V_2 -> V_25 , L_36 , V_21 -> V_202 , V_21 ) ;
V_176 = F_99 ( & V_2 -> V_25 -> V_203 , & V_204 ) ;
if ( V_176 ) {
F_29 ( V_2 -> V_25 , L_37 ) ;
goto V_201;
}
V_176 = F_100 ( V_2 -> V_27 ) ;
if ( V_176 ) {
...
static int T_8 F_104 ( struct V_18 * V_19 )
{
struct V_26 * V_27 = F_83 ( & V_19 -> V_25 ) ;
struct V_1 * V_2 = F_22 ( V_27 ) ;
F_105 ( V_2 ) ;
F_106 ( V_27 ) ;
F_101 ( & V_2 -> V_25 -> V_203 , & V_204 ) ;
