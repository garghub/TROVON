...
static long F_96 ( struct V_109 * V_109 , unsigned int V_39 , unsigned long V_140 )
{
struct V_3 * V_4 = V_109 -> V_114 ;
int V_40 * V_141 = ( int V_40 * ) V_140 ;
int V_22 ;
switch ( V_39 ) {
case V_142 :
return F_97 ( V_4 -> V_11 , V_141 ) ;
case V_143 : {
int V_62 ;
if ( F_98 ( V_62 , V_141 ) )
return - V_41 ;
...
case V_151 :
case V_152 : {
void V_40 * V_141 = ( void V_40 * ) V_140 ;
return F_99 ( V_4 -> V_62 , NULL , V_109 -> V_116 , V_39 , V_141 ) ;
}
case V_153 : {
struct V_32 * V_33 ;
...
int V_85 ;
T_2 V_61 [ V_154 ] ;
if ( F_24 ( & V_35 , V_141 , sizeof( V_35 ) ) )
return - V_41 ;
...
if ( F_50 ( V_141 , & V_35 , sizeof( V_35 ) ) )
return - V_41 ;
return V_22 ;
}
default:
...
return;
F_71 ( & V_126 ) ;
F_102 ( & V_134 , V_67 -> V_130 ) ;
F_103 ( & V_31 -> V_156 , L_13 ) ;
F_104 ( V_67 -> V_69 ) ;
V_67 -> V_69 = NULL ;
F_75 ( & V_67 -> V_121 , F_67 ) ;
F_73 ( & V_126 ) ;
...
F_71 ( & V_126 ) ;
V_22 = F_106 ( & V_134 , V_13 ) ;
if ( ! V_22 ) {
V_22 = - V_14 ;
goto V_25;
}
V_22 = F_107 ( & V_134 , V_67 , & V_130 ) ;
if ( V_22 < 0 )
goto V_25;
if ( V_130 >= V_160 ) {
F_108 ( V_161 L_14 ) ;
...
V_67 -> V_130 = V_130 ;
V_67 -> V_62 = V_31 ;
V_67 -> V_123 = F_109 ( V_123 ) ;
V_67 -> V_124 = V_124 ;
F_110 ( & V_67 -> V_121 ) ;
V_157 = F_111 ( V_163 , V_67 -> V_130 ) ;
V_69 = F_112 ( V_164 , V_123 , V_157 , NULL , L_15 , V_158 ) ;
if ( F_53 ( V_69 ) ) {
V_22 = F_55 ( V_69 ) ;
goto V_165;
}
V_67 -> V_69 = V_69 ;
if ( V_31 -> V_156 . V_166 ) {
V_22 = F_113 ( & V_31 -> V_156 , & V_67 -> V_69 -> V_156 , L_13 ) ;
if ( V_22 )
goto V_167;
}
F_73 ( & V_126 ) ;
...
static char * F_114 ( struct V_122 * V_157 , T_8 * V_168 )
{
return F_115 ( V_13 , L_16 , F_83 ( V_157 ) ) ;
}
...
for ( V_169 = 0 ; V_169 < V_20 ; V_169 ++ )
F_118 ( & V_19 [ V_169 ] ) ;
V_164 = F_119 ( V_171 , L_13 ) ;
if ( F_53 ( V_164 ) ) {
V_22 = F_55 ( V_164 ) ;
goto V_172;
}
V_164 -> V_173 = F_114 ;
V_22 = F_120 ( & V_170 , 0 , V_160 , L_13 ) ;
if ( V_22 )
goto V_174;
V_163 = F_121 ( V_170 ) ;
F_122 ( & V_175 , & V_176 ) ;
V_22 = F_123 ( & V_175 , F_111 ( V_163 , 0 ) , V_160 ) ;
if ( V_22 )
goto V_177;
