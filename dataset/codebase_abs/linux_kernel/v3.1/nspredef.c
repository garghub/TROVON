...
static void F_25 ( char * V_99 , T_2 V_18 )
{
T_2 V_100 ;
T_2 V_49 ;
T_2 V_77 ;
...
V_99 [ 0 ] = 0 ;
V_100 = V_67 ;
for ( V_49 = 0 ; V_49 < V_101 ; V_49 ++ ) {
if ( V_18 & V_100 ) {
F_28 ( V_99 , & V_102 [ V_49 ] [ V_77 ] ) ;
V_77 = 0 ;
}
V_100 <<= 1 ;
}
