...
static T_3 * F_34 ( struct V_11 * V_12 , int V_31 )
{
int V_34 = F_20 ( V_31 ) ;
struct V_33 * V_45 = F_22 ( V_12 , V_34 ) ;
...
T_4 * V_66 ;
int V_67 ;
V_66 = ( T_4 * ) F_34 ( V_12 , V_69 ) ;
for ( V_67 = 0 ; V_67 < V_65 ; V_67 ++ )
* ( V_66 + V_67 ) = ( T_4 ) ( F_31 ( V_12 , V_70 ) >> 8 ) ;
}
...
static T_5 F_63 ( int V_120 , void * V_2 )
{
struct V_5 * V_6 = V_2 ;
T_1 V_73 = F_44 ( V_6 ) ;
...
static T_6 F_86 ( struct V_16 * V_17 )
{
struct V_11 * V_12 = F_17 ( V_17 ) ;
...
V_7 = F_101 ( V_120 , & F_63 , V_180 ,
V_169 -> V_181 , V_6 ) ;
if ( V_7 ) {
F_29 ( & V_167 -> V_56 , L_12 ) ;
goto V_182;
}
V_7 = F_102 ( & V_167 -> V_56 , & V_183 ) ;
if ( V_7 < 0 ) {
F_29 ( & V_167 -> V_56 , L_13 ) ;
goto V_184;
}
V_7 = F_103 ( & V_167 -> V_56 , V_185 ,
F_104 ( V_185 ) ) ;
if ( V_7 < 0 ) {
