...
static T_2 F_50 ( T_1 V_1 , T_2 V_88 )
{
if ( V_88 == V_89 && V_1 == 2 )
return V_90 ;
if ( V_88 == V_91 && V_1 < 4 )
...
int
F_51 ( struct V_71 * V_72 , T_2 * V_93 )
{
struct V_94 * V_95 ;
T_3 V_96 ;
T_2 V_88 ;
...
V_88 = F_50 ( V_72 -> V_98 , V_88 ) ;
if ( V_88 == V_90 || V_72 -> V_117 ) {
F_26 ( L_12 ) ;
F_53 ( V_72 , V_118 , NULL ) ;
return 0 ;
}
if ( V_72 -> V_99 != 0 )
* V_97 ++ = V_88 ;
...
F_53 ( V_72 , V_95 -> V_102 , V_93 + 1 ) ;
return 1 ;
}
int F_54 ( struct V_121 * V_121 , struct V_122 * V_122 )
{
int V_30 ;
F_5 ( & V_21 ) ;
if ( V_22 == NULL ) {
...
F_30 ( V_22 ) ;
V_30 = F_55 ( V_22 , V_122 ) ;
F_6 ( & V_21 ) ;
return V_30 ;
}
int F_56 ( struct V_121 * V_121 , struct V_122 * V_122 )
{
int V_30 = F_57 ( V_121 , V_122 ) ;
F_5 ( & V_21 ) ;
F_38 ( V_22 ) ;
F_6 ( & V_21 ) ;
return V_30 ;
