...
goto V_187;
V_71 = 0 ;
if ( V_143 -> V_146 -> V_188 ) {
V_71 = V_143 -> V_146 -> V_188 ( V_5 , V_178 ) ;
if ( V_71 == - V_189 ) {
F_149 ( V_5 -> V_154 ) ;
V_5 -> V_154 = NULL ;
V_5 -> V_165 = NULL ;
...
V_5 -> V_154 = F_148 ( V_143 , V_144 ) ;
if ( ! ( V_143 -> V_67 & V_191 ) ||
! V_5 -> V_154 || ! V_5 -> V_154 -> V_192 ) {
V_71 = - V_145 ;
goto V_187;
}
F_143 ( V_5 , ( T_2 ) V_5 -> V_154 -> V_192 << 9 ) ;
}
} else {
if ( V_5 -> V_121 == V_5 ) {
V_71 = 0 ;
if ( V_5 -> V_165 -> V_146 -> V_188 )
V_71 = V_5 -> V_165 -> V_146 -> V_188 ( V_5 , V_178 ) ;
if ( V_5 -> V_124 && ( ! V_71 || V_71 == - V_190 ) )
F_152 ( V_5 -> V_165 , V_5 ) ;
if ( V_71 )
goto V_193;
...
int V_56 ;
F_123 ( ( V_178 & V_194 ) && ! V_135 ) ;
if ( ( V_178 & V_194 ) && V_135 ) {
...
struct V_4 * F_158 ( const char * V_198 , T_7 V_178 ,
void * V_135 )
{
struct V_4 * V_5 ;
int V_108 ;
...
if ( V_78 -> V_200 & V_205 )
V_78 -> V_203 |= V_194 ;
if ( ( V_78 -> V_200 & V_206 ) == 3 )
V_78 -> V_203 |= V_207 ;
V_5 = F_100 ( V_2 ) ;
if ( V_5 == NULL )
return - V_148 ;
V_78 -> V_53 = V_5 -> V_19 -> V_22 ;
return F_155 ( V_5 , V_78 -> V_203 , V_78 ) ;
}
...
if ( V_5 -> V_121 == V_5 ) {
if ( V_143 -> V_146 -> V_209 )
V_71 = V_143 -> V_146 -> V_209 ( V_143 , V_178 ) ;
}
if ( ! V_5 -> V_186 ) {
struct V_210 * V_147 = V_143 -> V_146 -> V_147 ;
F_115 ( V_143 ) ;
F_114 ( V_147 ) ;
F_149 ( V_5 -> V_154 ) ;
V_5 -> V_154 = NULL ;
...
if ( ! V_221 || ! * V_221 )
return F_41 ( - V_25 ) ;
error = F_176 ( V_221 , V_222 , & V_198 ) ;
if ( error )
return F_41 ( error ) ;
V_2 = V_198 . V_102 -> V_223 ;
error = - V_224 ;
if ( ! F_177 ( V_2 -> V_125 ) )
goto V_225;
error = - V_199 ;
if ( V_198 . V_226 -> V_227 & V_228 )
goto V_225;
error = - V_148 ;
V_5 = F_100 ( V_2 ) ;
if ( ! V_5 )
