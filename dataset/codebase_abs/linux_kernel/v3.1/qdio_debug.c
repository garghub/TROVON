...
static int F_22 ( struct V_64 * V_64 , struct V_65 * V_66 )
{
return F_16 ( V_66 , F_17 ,
V_66 -> V_67 . V_68 -> V_69 -> V_70 ) ;
}
static void F_23 ( struct V_29 * V_30 , struct V_81 * V_19 )
{
char V_82 [ V_83 ] ;
snprintf ( V_82 , V_83 , L_30 ,
V_30 -> V_38 ? L_31 : L_32 ,
V_30 -> V_84 ) ;
V_30 -> V_85 = F_24 ( V_82 , V_86 | V_87 | V_88 ,
V_30 -> V_4 -> V_89 , V_30 , & V_90 ) ;
if ( F_25 ( V_30 -> V_85 ) )
V_30 -> V_85 = NULL ;
}
void F_26 ( struct V_3 * V_4 , struct V_81 * V_19 )
{
struct V_29 * V_30 ;
int V_32 ;
V_4 -> V_89 = F_27 ( F_4 ( & V_19 -> V_20 ) ,
V_91 ) ;
if ( F_25 ( V_4 -> V_89 ) )
V_4 -> V_89 = NULL ;
V_4 -> V_92 = F_24 ( L_33 ,
...
void F_28 ( struct V_3 * V_4 , struct V_81 * V_19 )
{
struct V_29 * V_30 ;
int V_32 ;
F_20 (irq_ptr, q, i)
...
{
V_91 = F_27 ( L_34 , NULL ) ;
V_94 = F_5 ( L_35 , 16 , 1 , 16 ) ;
F_6 ( V_94 , & V_22 ) ;
F_7 ( V_94 , V_95 ) ;
F_2 ( L_36 ) ;
V_96 = F_5 ( L_37 , 4 , 1 , 16 ) ;
F_6 ( V_96 , & V_22 ) ;
F_7 ( V_96 , V_95 ) ;
F_31 ( L_36 ) ;
return 0 ;
