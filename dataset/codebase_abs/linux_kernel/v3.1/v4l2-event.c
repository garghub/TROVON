...
V_5 = 1 ;
if ( V_44 -> type == V_48 ) {
V_41 = F_26 ( V_7 -> V_49 , V_44 -> V_25 ) ;
if ( V_41 == NULL )
return - V_50 ;
}
V_2 = F_27 ( sizeof( * V_2 ) + sizeof( struct V_10 ) * V_5 , V_51 ) ;
if ( ! V_2 )
return - V_52 ;
...
F_5 ( & V_7 -> V_13 -> V_14 , V_12 ) ;
if ( V_2 && V_2 -> type == V_48 ) {
struct V_46 * V_41 = F_26 ( V_7 -> V_49 , V_2 -> V_25 ) ;
if ( V_41 )
F_33 ( V_41 , V_2 ) ;
}
F_29 ( V_2 ) ;
