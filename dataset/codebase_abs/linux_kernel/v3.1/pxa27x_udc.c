...
static int F_118 ( struct V_221 * V_11 ,
...
static int F_124 ( struct V_221 * V_11 )
{
struct V_4 * V_5 = V_222 ;
if ( ! V_5 )
return - V_10 ;
...
V_223 = F_152 ( & V_274 -> V_90 , & V_5 -> V_78 ) ;
if ( V_223 )
goto V_291;
F_14 ( V_5 ) ;
return 0 ;
...
static int T_6 F_156 ( struct V_273 * V_270 )
{
struct V_4 * V_5 = F_157 ( V_270 ) ;
...
static void F_162 ( struct V_273 * V_270 )
{
struct V_4 * V_5 = F_157 ( V_270 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_108 ( V_5 ) ;
}
static int F_163 ( struct V_273 * V_270 , T_7 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_157 ( V_270 ) ;
struct V_44 * V_45 ;
...
static int F_164 ( struct V_273 * V_270 )
{
int V_48 ;
struct V_4 * V_5 = F_157 ( V_270 ) ;
struct V_44 * V_45 ;
...
if ( ! F_167 () && ! F_168 () )
return - V_10 ;
F_169 ( V_295 L_95 , V_14 , V_15 ) ;
return F_170 ( & V_296 , F_139 ) ;
}
