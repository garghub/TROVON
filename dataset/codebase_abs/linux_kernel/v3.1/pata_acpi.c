...
if ( V_5 -> V_9 == NULL )
return - V_11 ;
V_7 = V_5 -> V_8 = F_17 ( & V_39 -> V_36 , sizeof( struct V_6 ) , V_41 ) ;
if ( V_5 -> V_8 == NULL )
return - V_42 ;
V_7 -> V_12 [ 0 ] = F_5 ( V_5 , & V_5 -> V_2 . V_43 [ 0 ] ) ;
V_7 -> V_12 [ 1 ] = F_5 ( V_5 , & V_5 -> V_2 . V_43 [ 1 ] ) ;
return F_18 ( V_5 ) ;
}
static int F_19 ( struct V_38 * V_39 , const struct V_44 * V_45 )
{
...
return F_22 ( V_39 , V_57 , & V_61 , NULL , 0 ) ;
}
