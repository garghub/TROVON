...
T_2 V_109 ;
unsigned long V_110 ;
F_34 ( & V_2 -> V_111 , V_110 ) ;
F_9 ( V_2 , V_70 ,
V_112 , V_2 -> V_113 > 0 ) ;
if ( ! V_2 -> V_113 )
goto V_114;
F_35 ( V_2 -> V_115 >= 100 || V_2 -> V_115 <= 0 ) ;
...
V_2 -> V_135 = ! V_2 -> V_135 ;
V_2 -> V_136 = F_42 ( V_133 , V_27 ) ;
if ( ! V_2 -> V_136 )
V_2 -> V_136 = 1 ;
}
V_132 = F_43 ( V_2 -> V_136 , ( unsigned int ) V_141 ) ;
V_2 -> V_136 -= V_132 ;
F_18 ( L_54 , V_132 * V_27 ,
V_134 ? L_55 : L_56 ) ;
if ( V_134 )
V_132 |= V_142 ;
F_6 ( V_2 ,
...
exit:
if ( V_146 )
F_44 ( & V_2 -> V_147 , V_148 + V_149 / 500 ) ;
}
static void F_45 ( unsigned long V_150 )
{
...
static T_4 F_46 ( int V_100 , void * V_150 )
{
T_1 V_160 , V_3 ;
int V_161 , V_151 ;
bool V_134 ;
...
F_18 ( L_62 , V_161 , V_134 ? L_55 : L_56 ) ;
...
static int F_51 ( struct V_170 * V_68 )
{
...
static void F_52 ( struct V_170 * V_68 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
unsigned long V_110 ;
F_34 ( & V_2 -> V_111 , V_110 ) ;
...
static int F_53 ( struct V_170 * V_68 , T_3 V_172 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
F_18 ( L_63 , V_172 ) ;
if ( ! V_172 || V_172 & ~ 0x03 ) {
...
static int F_54 ( struct V_170 * V_68 , T_3 V_59 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
T_3 V_61 = 2000000 / V_59 ;
F_18 ( L_65 , V_59 ) ;
if ( V_61 && ( V_61 > V_173 ||
V_61 < V_174 ) ) {
F_18 ( L_66 ,
2000 / V_174 , 2000 / V_173 ) ;
return - 1 ;
}
V_2 -> V_113 = V_61 ;
F_33 ( V_2 ) ;
...
static int F_55 ( struct V_170 * V_68 , T_3 V_60 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
F_18 ( L_67 , V_60 ) ;
V_2 -> V_115 = V_60 ;
...
static int F_56 ( struct V_170 * V_68 , int V_69 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
unsigned long V_110 ;
if ( V_69 == V_2 -> V_81 )
...
static int F_57 ( struct V_170 * V_68 , int V_69 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
unsigned long V_110 ;
if ( V_69 == V_2 -> V_66 )
...
static void F_58 ( struct V_170 * V_68 , bool V_175 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
if ( V_175 ) {
F_32 ( V_2 ) ;
...
static int F_59 ( struct V_170 * V_68 , unsigned * V_176 , unsigned V_177 )
{
struct V_1 * V_2 = V_68 -> V_171 ;
unsigned long V_110 ;
V_2 -> V_131 = V_176 ;
...
static int F_61 ( struct V_178 * V_178 , const struct V_179 * V_180 )
{
int error = - V_181 ;
struct V_170 * V_68 ;
struct V_1 * V_2 ;
V_2 = F_62 ( sizeof( struct V_1 ) , V_182 ) ;
V_68 = F_63 () ;
if ( ! V_2 || ! V_68 )
goto V_183;
error = - V_31 ;
...
F_67 ( & V_2 -> V_111 ) ;
error = - V_185 ;
V_2 -> V_4 = F_68 ( V_178 , 0 ) ;
if ( ! F_69 ( V_2 -> V_4 , V_184 , V_186 ) ) {
V_2 -> V_4 = - 1 ;
V_2 -> V_100 = - 1 ;
goto error;
}
V_2 -> V_100 = F_70 ( V_178 , 0 ) ;
if ( F_71 ( V_2 -> V_100 , F_46 ,
V_187 , V_186 , ( void * ) V_2 ) ) {
V_2 -> V_100 = - 1 ;
goto error;
}
F_72 ( V_178 , V_2 ) ;
...
static void F_82 ( struct V_178 * V_178 )
{
struct V_1 * V_2 = F_83 ( V_178 ) ;
unsigned long V_110 ;
F_34 ( & V_2 -> V_111 , V_110 ) ;
F_31 ( V_2 ) ;
F_15 ( V_2 ) ;
...
static void F_85 ( struct V_1 * V_2 , int V_69 )
{
V_69 = V_69 && F_86 ( & V_2 -> V_178 -> V_2 ) ;
F_18 ( L_76 , V_69 ? L_77 : L_78 ) ;
F_9 ( V_2 , V_35 , V_205 , V_69 ) ;
}
static int F_87 ( struct V_178 * V_178 , T_5 V_206 )
{
struct V_1 * V_2 = F_83 ( V_178 ) ;
F_85 ( V_2 , true ) ;
return 0 ;
}
static int F_88 ( struct V_178 * V_178 )
{
struct V_1 * V_2 = F_83 ( V_178 ) ;
F_50 ( V_2 ) ;
if ( V_2 -> V_108 )
...
static void F_89 ( struct V_178 * V_178 )
{
struct V_1 * V_2 = F_83 ( V_178 ) ;
F_85 ( V_2 , true ) ;
}
