...
if ( ( V_193 - V_52 -> V_194 . V_197 ) >= V_200 ) {
V_203 = true ;
V_52 -> V_194 . V_197 = V_193 ;
}
...
static void F_87 ( struct V_85 * V_44 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_61 * V_22 = V_3 -> V_22 ;
struct V_51 * V_52 = F_18 ( V_22 ) ;
int V_20 V_239 ( ( V_240 ) ) ;
T_1 V_68 ;
F_4 ( & V_3 -> V_69 ) ;
if ( V_3 -> V_89 & V_90 ) {
F_40 ( V_52 , V_241 , L_32 ) ;
F_6 ( & V_3 -> V_69 ) ;
return;
}
F_7 ( V_3 ) ;
...
static int F_95 ( struct V_85 * V_44 ,
struct V_35 * V_36 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
...
F_40 ( V_52 , V_94 ,
L_37 , V_36 -> type , V_130 -> V_100 ) ;
V_251:
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
return V_20 ;
}
static void F_99 ( struct V_85 * V_44 ,
struct V_35 * V_36 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
...
static int F_102 ( struct V_85 * V_44 , T_4 V_253 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
...
if ( V_253 & V_260 ) {
struct V_62 * V_75 = V_44 -> V_64 . V_63 ;
int V_261 = V_75 -> V_262 ;
F_40 ( V_52 , V_94 , L_41 ,
V_75 -> V_76 ) ;
F_104 ( & V_3 -> V_22 -> V_263 [ V_261 ] ,
V_44 -> V_64 . V_63 ,
V_44 -> V_64 . V_264 ) ;
if ( F_39 ( V_3 , V_44 , & V_3 -> V_22 -> V_263 [ V_261 ] ) < 0 ) {
F_30 ( V_52 , L_42 ) ;
F_6 ( & V_3 -> V_69 ) ;
return - V_7 ;
}
...
static void F_106 ( struct V_85 * V_44 ,
unsigned int V_269 ,
unsigned int * V_270 ,
T_5 V_271 )
{
...
V_3 -> V_274 = * V_270 ;
V_272 = F_107 ( V_3 ) ;
F_108 ( V_3 -> V_22 , V_272 ) ;
F_40 ( F_18 ( V_3 -> V_22 ) , V_94 ,
L_45 , V_272 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
}
static int F_109 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
struct V_127 * V_128 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
...
static int F_110 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
struct V_127 * V_128 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
...
F_7 ( V_3 ) ;
V_133 = (struct V_132 * ) V_128 -> V_131 ;
F_111 ( V_3 -> V_82 , V_133 -> V_100 ) ;
V_20 = F_48 ( V_3 , V_36 , V_128 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
return V_20 ;
}
static int F_112 ( struct V_85 * V_44 , T_3 V_275 ,
...
V_279 . V_288 = V_277 -> V_289 ;
V_280 = F_113 ( V_275 , V_3 -> V_290 ) ;
F_40 ( V_52 , V_94 ,
L_46 ,
V_275 , V_280 , V_277 -> V_283 , V_277 -> V_285 ,
V_277 -> V_287 , V_277 -> V_289 ) ;
V_20 = F_114 ( V_3 , V_280 , & V_279 ) ;
if ( V_20 ) {
F_30 ( V_52 , L_47 ) ;
goto V_251;
}
...
static int F_116 ( struct V_85 * V_44 ,
enum V_292 V_293 ,
struct V_35 * V_36 ,
struct V_127 * V_128 ,
struct V_294 * V_295 )
...
switch ( V_293 ) {
case V_298 :
V_20 = F_117 ( V_52 , V_36 , V_128 , V_295 ) ;
if ( V_20 >= 0 ) {
V_295 -> V_299 = V_20 ;
V_295 -> V_92 |= V_300 ;
...
F_40 ( V_52 , V_94 ,
L_49 ,
V_52 -> V_135 , V_52 -> V_308 ) ;
}
static void F_121 ( void * V_33 , T_1 * V_34 , struct V_35 * V_36 )
{
struct V_2 * V_3 = (struct V_2 * ) V_33 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
struct V_37 * V_38 = & V_36 -> V_38 ;
if ( ( V_36 -> type == V_60 ) && V_38 -> V_42 ) {
V_52 -> V_308 = V_38 -> V_309 ;
...
static void F_123 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
struct V_37 * V_38 ,
T_4 V_253 )
{
...
static T_5 F_127 ( struct V_85 * V_44 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
T_5 V_321 ;
F_4 ( & V_3 -> V_69 ) ;
F_7 ( V_3 ) ;
V_321 = F_128 ( V_3 -> V_22 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
return V_321 ;
}
static void F_129 ( struct V_85 * V_44 , T_5 V_321 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
F_7 ( V_3 ) ;
F_130 ( V_3 -> V_22 , V_321 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
}
static void F_131 ( struct V_85 * V_44 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
F_7 ( V_3 ) ;
...
static int F_133 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
enum V_179 V_180 ,
struct V_127 * V_128 ,
T_3 V_181 , T_3 * V_322 , T_1 V_323 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_132 * V_133 ;
int V_20 = 0 ;
...
if ( ! V_20 )
F_134 ( V_36 , V_128 -> V_54 , V_181 ) ;
break;
case V_326 :
F_61 ( V_3 , V_36 , V_128 , V_180 , V_181 ) ;
F_135 ( V_36 , V_128 -> V_54 , V_181 ) ;
break;
case V_327 :
V_133 = (struct V_132 * ) V_128 -> V_131 ;
F_62 ( & V_3 -> V_70 . V_189 ) ;
V_133 -> V_190 [ V_181 ] = V_328 ;
F_63 ( & V_3 -> V_70 . V_189 ) ;
break;
default:
...
static void F_136 ( struct V_85 * V_44 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
F_62 ( & V_3 -> V_329 ) ;
...
static void F_137 ( struct V_85 * V_44 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
F_62 ( & V_3 -> V_329 ) ;
...
static int F_138 ( struct V_85 * V_44 , T_4 V_330 )
{
return 0 ;
}
static void F_139 ( struct V_85 * V_44 ,
T_1 V_331 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
F_4 ( & V_3 -> V_69 ) ;
F_7 ( V_3 ) ;
V_3 -> V_22 -> V_331 = V_331 ;
F_126 ( V_3 -> V_22 ) ;
F_8 ( V_3 ) ;
F_6 ( & V_3 -> V_69 ) ;
}
static int F_140 ( struct V_85 * V_44 ,
struct V_35 * V_36 ,
const struct V_332 * V_49 )
{
struct V_2 * V_3 = V_44 -> V_3 ;
struct V_51 * V_52 = F_18 ( V_3 -> V_22 ) ;
struct V_333 V_334 ;
...
V_334 . V_119 = V_130 -> V_100 ;
V_334 . V_154 = V_335 ;
V_334 . V_49 = F_50 ( V_49 -> V_336 [ V_335 ] . V_337 ) ;
F_34 ( V_338 , & V_334 ) ;
if ( V_20 ) {
F_30 ( V_52 ,
L_55
...
V_334 . V_154 = V_339 ;
V_334 . V_49 = F_50 ( V_49 -> V_336 [ V_339 ] . V_337 ) ;
F_34 ( V_338 , & V_334 ) ;
if ( V_20 ) {
F_30 ( V_52 ,
L_57
...
F_40 ( V_52 , V_94 ,
L_58 ,
V_49 -> V_336 [ V_335 ] . V_337 ,
V_49 -> V_336 [ V_339 ] . V_337 ) ;
V_251:
return V_20 ;
}
