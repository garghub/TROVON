...
V_306 = F_7 ( V_2 , V_29 ) ;
F_34 ( V_2 , V_125 , L_86 , V_306 ) ;
if ( V_306 == 0x43218765 ) {
F_34 ( V_2 , V_125 , L_87
L_88 ) ;
F_14 ( V_2 , V_307 , 0xffffffff ) ;
V_306 = F_7 ( V_2 , V_29 ) ;
V_306 = F_7 ( V_2 , V_29 ) ;
}
if ( V_306 != 0x87654321 ) {
F_24 ( V_2 , V_128 , L_86 , V_306 ) ;
...
F_136 ( V_84 ) ;
V_84 -> V_5 |= V_309 ;
F_137 ( V_84 , & V_2 -> V_183 , F_64 , V_310 ) ;
V_84 -> V_311 = & V_312 ;
V_84 -> V_313 = & V_314 ;
return 0 ;
}
static int T_7 F_138 ( struct V_136 * V_137 )
{
struct V_83 * V_84 ;
struct V_1 * V_2 ;
struct V_315 * V_316 ;
...
F_141 ( V_137 , NULL ) ;
F_142 ( V_84 ) ;
F_143 ( V_84 -> V_130 , V_84 ) ;
V_316 = F_144 ( V_137 , V_317 ,
L_96 ) ;
if ( ! V_316 )
V_316 = F_145 ( V_137 , V_317 , 0 ) ;
F_146 ( V_316 -> V_318 , F_147 ( V_316 ) ) ;
F_148 ( V_2 -> V_7 ) ;
F_149 ( V_84 ) ;
return 0 ;
}
static int T_5 F_150 ( struct V_136 * V_137 )
{
struct V_83 * V_84 ;
struct V_1 * V_2 ;
struct V_319 * V_4 = V_137 -> V_84 . V_320 ;
struct V_315 * V_316 , * V_321 ;
...
V_322 = F_147 ( V_316 ) ;
V_321 = F_145 ( V_137 , V_326 , 0 ) ;
if ( ! V_321 ) {
F_152 ( L_100 ) ;
V_324 = - V_124 ;
goto V_325;
}
if ( ! F_153 ( V_316 -> V_318 , V_322 , V_281 ) ) {
V_324 = - V_269 ;
goto V_325;
}
V_84 = F_154 ( sizeof( struct V_1 ) ) ;
if ( ! V_84 ) {
F_152 ( L_101 ) ;
V_324 = - V_140 ;
goto V_327;
}
F_155 ( V_84 , & V_137 -> V_84 ) ;
V_2 = F_42 ( V_84 ) ;
V_84 -> V_130 = V_321 -> V_318 ;
V_323 = V_321 -> V_5 & V_328 ;
V_2 -> V_7 = F_156 ( V_316 -> V_318 , V_322 ) ;
memcpy ( & V_2 -> V_4 , V_4 , sizeof( V_2 -> V_4 ) ) ;
V_2 -> V_84 = V_84 ;
V_2 -> V_285 = ( ( 1 << V_329 ) - 1 ) ;
if ( V_2 -> V_7 == NULL ) {
F_24 ( V_2 , V_125 , L_102 ) ;
V_324 = - V_140 ;
goto V_330;
}
V_2 -> V_11 = & V_331 ;
...
if ( V_324 < 0 )
goto V_334;
if ( V_2 -> V_4 . V_220 == V_335 )
V_211 |= V_221 ;
if ( V_2 -> V_4 . V_222 == V_336 )
V_211 |= V_223 ;
F_14 ( V_2 , V_224 , V_211 ) ;
F_14 ( V_2 , V_190 , 0 ) ;
F_14 ( V_2 , V_188 , 0xFFFFFFFF ) ;
V_324 = F_157 ( V_84 -> V_130 , F_102 ,
V_323 | V_337 , V_84 -> V_129 , V_84 ) ;
if ( V_324 ) {
F_24 ( V_2 , V_125 ,
L_103 , V_84 -> V_130 ) ;
goto V_334;
...
V_324 = F_158 ( V_84 ) ;
if ( V_324 ) {
F_24 ( V_2 , V_125 , L_104 , V_324 ) ;
goto V_338;
} else {
F_34 ( V_2 , V_125 ,
L_105 , V_84 -> V_129 ) ;
}
V_324 = F_55 ( V_137 , V_84 ) ;
if ( V_324 ) {
F_24 ( V_2 , V_125 , L_106 , V_324 ) ;
goto V_339;
}
F_84 ( & V_2 -> V_37 ) ;
if ( F_83 ( V_84 -> V_206 ) ) {
...
F_34 ( V_2 , V_125 ,
L_107 ) ;
} else if ( F_83 ( V_2 -> V_4 . V_340 ) ) {
memcpy ( V_84 -> V_206 , V_2 -> V_4 . V_340 , 6 ) ;
F_34 ( V_2 , V_125 ,
L_108 ) ;
} else {
F_159 ( V_84 ) ;
...
static int F_161 ( struct V_341 * V_84 )
{
struct V_83 * V_342 = F_162 ( V_84 ) ;
struct V_1 * V_2 = F_42 ( V_342 ) ;
F_14 ( V_2 , V_343 ,
V_344 | V_345 |
V_346 | V_347 ) ;
return 0 ;
}
static int F_163 ( struct V_341 * V_84 )
{
struct V_83 * V_342 = F_162 ( V_84 ) ;
struct V_1 * V_2 = F_42 ( V_342 ) ;
unsigned int V_348 = 100 ;
F_14 ( V_2 , V_29 , 0 ) ;
while ( ! ( F_7 ( V_2 , V_343 ) & V_349 ) && -- V_348 )
F_32 ( 1000 ) ;
return ( V_348 == 0 ) ? - V_25 : 0 ;
}
