...
static int F_31 ( struct V_1 * V_1 , int V_74 )
{
struct V_4 * V_5 ;
struct V_6 * V_7 ;
int error ;
if ( ( V_74 & V_75 ) && F_32 ( V_1 -> V_18 ) )
return - V_76 ;
V_5 = F_7 ( V_1 ) ;
if ( F_12 ( V_5 ) )
return F_19 ( V_5 ) ;
V_7 = F_5 ( V_1 ) -> V_13 ;
if ( ! V_7 )
error = V_74 & V_59 ? - V_76 : 0 ;
else
error = F_20 ( V_5 -> V_58 , V_7 , V_74 & ~ V_77 ) ;
F_15 ( V_5 ) ;
return error ;
}
...
if ( V_38 -> V_91 & V_92 )
return - V_93 ;
return ! F_5 ( V_35 -> V_55 ) -> V_12 -> V_94 ;
}
static int F_42 ( const struct V_35 * V_35 )
{
return ! ! F_5 ( V_35 -> V_55 ) -> V_12 -> V_94 ;
}
static int F_43 ( const struct V_35 * V_95 ,
const struct V_1 * V_96 ,
const struct V_35 * V_35 , const struct V_1 * V_1 ,
unsigned int V_33 , const char * V_97 , const struct V_31 * V_32 )
{
struct V_4 * V_5 ;
if ( ! V_1 )
return 1 ;
