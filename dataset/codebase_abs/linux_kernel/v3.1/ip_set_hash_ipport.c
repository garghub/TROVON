...
T_3 V_75 ;
if ( ! ( V_27 -> V_76 == V_77 || V_27 -> V_76 == V_78 ) )
return - V_79 ;
if ( F_21 ( ! F_23 ( V_42 , V_80 ) ||
! F_23 ( V_42 , V_81 ) ||
! F_23 ( V_42 , V_20 ) ) )
return - V_51 ;
if ( V_42 [ V_80 ] ) {
...
if ( V_42 [ V_81 ] )
V_66 = F_54 ( V_42 [ V_81 ] ) ;
V_23 = F_55 ( sizeof( * V_23 ) , V_83 ) ;
if ( ! V_23 )
return - V_84 ;
V_23 -> V_66 = V_66 ;
F_56 ( & V_23 -> V_85 , sizeof( V_23 -> V_85 ) ) ;
V_23 -> V_21 = V_86 ;
V_75 = F_57 ( V_72 ) ;
V_23 -> V_87 = F_58 (
sizeof( struct V_88 )
+ F_59 ( V_75 ) * sizeof( struct V_89 ) ) ;
if ( ! V_23 -> V_87 ) {
F_60 ( V_23 ) ;
return - V_84 ;
}
...
F_63 ( L_1 ,
V_27 -> V_94 , F_59 ( V_23 -> V_87 -> F_57 ) ,
V_23 -> V_87 -> F_57 , V_23 -> V_66 , V_27 -> V_13 , V_23 -> V_87 ) ;
return 0 ;
}
static int T_4
F_64 ( void )
