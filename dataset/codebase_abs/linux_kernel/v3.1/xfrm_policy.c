...
if ( F_135 ( V_230 ) ) {
memset ( & V_230 -> V_7 . V_238 . V_239 , 0 ,
sizeof( * V_230 ) - sizeof( struct V_30 ) ) ;
...
static int inline
F_150 ( void * * V_269 , const void * V_270 , int V_271 )
{
if ( ! * V_269 ) {
* V_269 = F_151 ( V_271 , V_199 ) ;
if ( ! * V_269 )
return - V_205 ;
}
...
static int inline
F_152 ( struct V_30 * V_35 , const struct V_1 * V_2 )
{
#ifdef F_106
struct V_229 * V_230 = (struct V_229 * ) V_35 ;
return F_150 ( ( void * * ) & ( V_230 -> V_272 ) ,
V_2 , sizeof( * V_2 ) ) ;
#else
return 0 ;
#endif
...
static int inline
F_153 ( struct V_30 * V_35 , const struct V_3 * V_4 )
{
#ifdef F_106
struct V_229 * V_230 = (struct V_229 * ) V_35 ;
return F_150 ( ( void * * ) & ( V_230 -> V_273 ) , V_4 , sizeof( * V_4 ) ) ;
#else
return 0 ;
#endif
}
static int F_154 ( const struct V_3 * V_4 , T_5 V_27 ,
struct V_52 * * V_221 ,
int * V_274 , int * V_232 )
{
int V_115 ;
...
* V_232 = V_221 [ 0 ] -> V_201 ;
#ifdef F_106
if ( V_221 [ 0 ] && V_221 [ 0 ] -> V_200 == V_275 &&
V_221 [ 0 ] -> type != V_186 ) {
...
#endif
for ( V_115 = 0 ; V_115 < * V_274 ; V_115 ++ ) {
if ( V_221 [ V_115 ] -> V_200 != V_275 ) {
* V_232 = - 1 ;
break;
}
}
...
static struct V_229 *
F_156 ( struct V_52 * * V_221 , int V_274 ,
...
struct V_229 * V_230 ;
int V_165 ;
V_165 = F_123 ( V_221 , V_274 , V_4 , V_91 , V_27 ) ;
if ( V_165 <= 0 ) {
if ( V_165 != 0 && V_165 != - V_219 )
F_157 ( V_31 , V_277 ) ;
return F_10 ( V_165 ) ;
}
V_35 = F_138 ( V_221 [ 0 ] , V_91 , V_165 , V_4 , V_276 ) ;
if ( F_14 ( V_35 ) ) {
F_157 ( V_31 , V_278 ) ;
return F_109 ( V_35 ) ;
}
...
V_230 -> V_232 = V_165 ;
if ( V_274 > 1 )
V_165 = F_152 ( V_35 , & V_221 [ 1 ] -> V_109 ) ;
else
V_165 = F_153 ( V_35 , V_4 ) ;
if ( F_9 ( V_165 ) ) {
F_131 ( V_35 ) ;
F_157 ( V_31 , V_279 ) ;
return F_10 ( V_165 ) ;
...
V_230 -> V_274 = V_274 ;
memcpy ( V_230 -> V_221 , V_221 , sizeof( struct V_52 * ) * V_274 ) ;
V_230 -> V_280 = F_158 ( & V_221 [ 0 ] -> V_90 ) ;
return V_230 ;
}
static struct V_77 *
F_159 ( struct V_31 * V_31 , const struct V_3 * V_4 , T_5 V_27 , T_4 V_58 ,
struct V_77 * V_281 , void * V_163 )
{
struct V_30 * V_276 = (struct V_30 * ) V_163 ;
struct V_52 * V_221 [ V_177 ] ;
struct V_229 * V_230 , * V_282 ;
int V_274 = 0 , V_232 = 0 , V_115 , V_165 , V_283 ;
V_230 = NULL ;
if ( V_281 ) {
V_230 = F_27 ( V_281 , struct V_229 , V_78 ) ;
V_274 = V_230 -> V_274 ;
V_232 = V_230 -> V_232 ;
V_283 = 0 ;
for ( V_115 = 0 ; V_115 < V_274 ; V_115 ++ ) {
V_221 [ V_115 ] = V_230 -> V_221 [ V_115 ] ;
V_283 |= V_221 [ V_115 ] -> V_60 . V_61 ;
}
if ( V_283 ) {
...
V_282 = F_156 ( V_221 , V_274 , V_4 , V_27 , V_276 ) ;
if ( F_14 ( V_282 ) ) {
V_165 = F_140 ( V_282 ) ;
if ( V_165 != - V_219 )
goto error;
...
static struct V_30 * F_160 ( struct V_31 * V_31 , T_5 V_27 ,
struct V_30 * V_276 )
{
struct V_33 * V_34 = F_8 ( V_27 ) ;
struct V_30 * V_166 ;
...
V_166 = V_34 -> V_286 ( V_31 , V_276 ) ;
}
F_11 ( V_34 ) ;
return V_166 ;
}
struct V_30 * F_161 ( struct V_31 * V_31 , struct V_30 * V_276 ,
const struct V_3 * V_4 ,
...
T_5 V_27 = V_276 -> V_87 -> V_27 ;
T_4 V_58 = F_110 ( V_129 ) ;
int V_115 , V_165 , V_274 , V_232 = 0 , V_287 = 0 ;
V_288:
V_35 = NULL ;
V_230 = NULL ;
V_231 = NULL ;
...
F_128 ( & V_230 -> V_7 . V_35 ) ;
F_162 ( & V_291 ) ;
V_230 -> V_7 . V_35 . V_55 = V_292 ;
V_292 = & V_230 -> V_7 . V_35 ;
F_163 ( & V_291 ) ;
V_231 = V_230 -> V_231 ;
}
}
...
V_274 = V_230 -> V_274 ;
V_232 = V_230 -> V_232 ;
memcpy ( V_221 , V_230 -> V_221 , sizeof( struct V_52 * ) * V_274 ) ;
V_231 = V_230 -> V_231 ;
}
V_35 = & V_230 -> V_7 . V_35 ;
...
F_155 ( V_221 , V_287 ) ;
F_157 ( V_31 , V_296 ) ;
return F_160 ( V_31 , V_27 , V_276 ) ;
}
if ( V_4 -> V_297 & V_298 ) {
F_165 ( V_299 , V_300 ) ;
F_166 ( & V_31 -> V_91 . V_301 , & V_299 ) ;
F_167 ( V_302 ) ;
F_168 () ;
F_167 ( V_303 ) ;
F_169 ( & V_31 -> V_91 . V_301 , & V_299 ) ;
if ( ! F_170 ( V_300 ) ) {
F_141 ( V_35 ) ;
goto V_288;
}
...
static inline int
F_171 ( int V_144 , struct V_310 * V_311 , const struct V_3 * V_4 )
{
struct V_38 * V_39 ;
if ( ! V_311 -> V_312 || V_144 < 0 || V_144 >= V_311 -> V_312 -> V_150 )
return 0 ;
V_39 = V_311 -> V_312 -> V_313 [ V_144 ] ;
if ( ! V_39 -> type -> V_314 )
return 0 ;
return V_39 -> type -> V_314 ( V_39 , V_311 , V_4 ) ;
}
static inline int
F_172 ( const struct V_203 * V_210 , const struct V_38 * V_39 ,
unsigned short V_27 )
{
if ( F_173 ( V_39 ) )
return V_210 -> V_220 && ! F_174 ( V_210 , V_39 , V_210 -> V_214 ) ;
return V_39 -> V_43 . V_19 == V_210 -> V_43 . V_19 &&
( V_39 -> V_43 . V_315 == V_210 -> V_43 . V_315 || ! V_210 -> V_43 . V_315 ) &&
( V_39 -> V_42 . V_316 == V_210 -> V_316 || ! V_210 -> V_316 ) &&
V_39 -> V_42 . V_211 == V_210 -> V_211 &&
( V_210 -> V_317 || ( V_210 -> V_318 & ( 1 << V_39 -> V_42 . V_319 ) ) ||
! ( F_175 ( V_210 -> V_43 . V_19 , V_320 ) ) ) &&
! ( V_39 -> V_42 . V_211 != V_258 &&
F_174 ( V_210 , V_39 , V_27 ) ) ;
}
static inline int
F_176 ( const struct V_203 * V_210 , const struct V_321 * V_312 , int V_322 ,
unsigned short V_27 )
{
int V_144 = V_322 ;
if ( V_210 -> V_220 ) {
...
V_322 = - 1 ;
for (; V_144 < V_312 -> V_150 ; V_144 ++ ) {
if ( F_172 ( V_210 , V_312 -> V_313 [ V_144 ] , V_27 ) )
return ++ V_144 ;
if ( V_312 -> V_313 [ V_144 ] -> V_42 . V_211 != V_258 ) {
if ( V_322 == - 1 )
V_322 = - 2 - V_144 ;
break;
}
...
int F_177 ( struct V_310 * V_311 , struct V_3 * V_4 ,
unsigned int V_27 , int V_323 )
{
struct V_33 * V_34 = F_8 ( V_27 ) ;
int V_165 ;
if ( F_9 ( V_34 == NULL ) )
return - V_36 ;
V_34 -> V_324 ( V_311 , V_4 , V_323 ) ;
V_165 = F_178 ( V_311 , & V_4 -> V_183 ) ;
F_11 ( V_34 ) ;
return V_165 ;
}
static inline int F_179 ( const struct V_321 * V_312 , int V_325 , int * V_326 )
{
for (; V_325 < V_312 -> V_150 ; V_325 ++ ) {
if ( V_312 -> V_313 [ V_325 ] -> V_42 . V_211 != V_258 ) {
* V_326 = V_325 ;
return 1 ;
}
}
...
int F_180 ( struct V_191 * V_192 , int V_58 , struct V_310 * V_311 ,
unsigned short V_27 )
{
struct V_31 * V_31 = F_181 ( V_311 -> V_245 ) ;
struct V_52 * V_79 ;
struct V_52 * V_221 [ V_177 ] ;
int V_222 = 0 ;
int V_201 ;
...
V_58 &= V_330 ;
V_328 = F_110 ( V_58 ) ;
if ( F_177 ( V_311 , & V_4 , V_27 , V_323 ) < 0 ) {
F_157 ( V_31 , V_331 ) ;
return 0 ;
}
F_182 ( V_311 , & V_4 , V_27 ) ;
if ( V_311 -> V_312 ) {
int V_115 ;
for ( V_115 = V_311 -> V_312 -> V_150 - 1 ; V_115 >= 0 ; V_115 -- ) {
struct V_38 * V_39 = V_311 -> V_312 -> V_313 [ V_115 ] ;
...
if ( ! V_79 ) {
struct V_77 * V_78 ;
V_78 = F_164 ( V_31 , & V_4 , V_27 , V_328 ,
F_107 , NULL ) ;
if ( F_108 ( V_78 ) )
V_79 = F_109 ( V_78 ) ;
else
...
if ( ! V_79 ) {
if ( V_311 -> V_312 && F_179 ( V_311 -> V_312 , 0 , & V_329 ) ) {
F_171 ( V_329 , V_311 , & V_4 ) ;
F_157 ( V_31 , V_334 ) ;
return 0 ;
}
return 1 ;
...
struct V_203 * V_336 [ V_224 ] ;
struct V_203 * * V_225 = V_223 ;
int V_337 = 0 ;
int V_115 , V_325 ;
if ( ( V_312 = V_311 -> V_312 ) == NULL )
V_312 = & V_335 ;
for ( V_327 = 0 ; V_327 < V_222 ; V_327 ++ ) {
if ( V_221 [ V_327 ] != V_79 &&
V_221 [ V_327 ] -> V_200 != V_275 ) {
F_157 ( V_31 , V_338 ) ;
goto V_314;
}
if ( V_337 + V_221 [ V_327 ] -> V_201 >= V_224 ) {
F_157 ( V_31 , V_339 ) ;
goto V_340;
}
for ( V_115 = 0 ; V_115 < V_221 [ V_327 ] -> V_201 ; V_115 ++ )
V_225 [ V_337 ++ ] = & V_221 [ V_327 ] -> V_202 [ V_115 ] ;
}
V_201 = V_337 ;
if ( V_222 > 1 ) {
F_183 ( V_336 , V_225 , V_201 , V_27 ) ;
V_225 = V_336 ;
}
for ( V_115 = V_201 - 1 , V_325 = 0 ; V_115 >= 0 ; V_115 -- ) {
V_325 = F_176 ( V_225 [ V_115 ] , V_312 , V_325 , V_27 ) ;
if ( V_325 < 0 ) {
if ( V_325 < - 1 )
V_329 = - ( 2 + V_325 ) ;
F_157 ( V_31 , V_341 ) ;
...
int F_184 ( struct V_310 * V_311 , unsigned short V_27 )
{
struct V_31 * V_31 = F_181 ( V_311 -> V_245 ) ;
struct V_3 V_4 ;
struct V_30 * V_35 ;
int V_342 = 1 ;
if ( F_185 ( V_311 , & V_4 , V_27 ) < 0 ) {
F_157 ( V_31 , V_343 ) ;
return 0 ;
}
F_186 ( V_311 ) ;
V_35 = F_161 ( V_31 , F_187 ( V_311 ) , & V_4 , NULL , 0 ) ;
if ( F_14 ( V_35 ) ) {
V_342 = 0 ;
V_35 = NULL ;
}
...
static struct V_30 * F_189 ( struct V_30 * V_35 , T_3 V_344 )
{
...
{
return ! F_190 ( (struct V_229 * ) V_35 ) ;
}
void F_191 ( struct V_30 * V_35 , struct V_244 * V_245 )
{
while ( ( V_35 = V_35 -> V_256 ) && V_35 -> V_91 && V_35 -> V_245 == V_245 ) {
V_35 -> V_245 = F_181 ( V_245 ) -> V_345 ;
F_192 ( V_35 -> V_245 ) ;
F_193 ( V_245 ) ;
}
}
static void F_194 ( struct V_310 * V_311 )
{
}
static struct V_30 * F_195 ( struct V_30 * V_35 )
{
if ( V_35 ) {
if ( V_35 -> V_260 ) {
F_141 ( V_35 ) ;
...
static void F_196 ( struct V_31 * V_31 )
{
struct V_30 * V_346 , * V_55 ;
F_197 () ;
F_162 ( & V_291 ) ;
V_346 = V_292 ;
V_292 = NULL ;
...
static void F_149 ( struct V_30 * V_35 )
{
do {
struct V_229 * V_230 = (struct V_229 * ) V_35 ;
T_3 V_347 , V_348 ;
V_347 = F_198 ( V_35 -> V_256 ) ;
V_230 -> V_349 = V_347 ;
V_347 = F_199 ( V_35 -> V_91 , V_347 ) ;
V_348 = F_198 ( V_230 -> V_231 ) ;
V_230 -> V_348 = V_348 ;
if ( V_347 > V_348 )
V_347 = V_348 ;
F_200 ( V_35 , V_350 , V_347 ) ;
} while ( ( V_35 = V_35 -> V_55 ) );
}
static int F_190 ( struct V_229 * V_351 )
{
struct V_30 * V_35 = & V_351 -> V_7 . V_35 ;
struct V_229 * V_352 ;
T_3 V_353 ;
if ( ! F_201 ( V_35 -> V_241 , ( (struct V_229 * ) V_35 ) -> V_354 ) ||
( V_35 -> V_245 && ! F_202 ( V_35 -> V_245 ) ) )
return 0 ;
V_352 = NULL ;
do {
struct V_229 * V_230 = (struct V_229 * ) V_35 ;
...
return 0 ;
if ( V_230 -> V_274 > 0 &&
V_230 -> V_280 != F_158 ( & V_230 -> V_221 [ 0 ] -> V_90 ) )
return 0 ;
V_353 = F_198 ( V_35 -> V_256 ) ;
if ( V_230 -> V_349 != V_353 ) {
V_352 = V_230 ;
V_230 -> V_349 = V_353 ;
}
if ( ! F_201 ( V_230 -> V_231 , V_230 -> V_355 ) )
return 0 ;
V_353 = F_198 ( V_230 -> V_231 ) ;
if ( V_230 -> V_348 != V_353 ) {
V_352 = V_230 ;
V_230 -> V_348 = V_353 ;
}
V_35 = V_35 -> V_256 ;
...
for (; ; ) {
V_35 = & V_352 -> V_7 . V_35 ;
V_353 = F_199 ( V_35 -> V_91 , V_353 ) ;
if ( V_353 > V_352 -> V_348 )
V_353 = V_352 -> V_348 ;
F_200 ( V_35 , V_350 , V_353 ) ;
if ( V_352 == V_351 )
break;
V_352 = (struct V_229 * ) V_352 -> V_7 . V_35 . V_55 ;
V_352 -> V_349 = V_353 ;
}
return 1 ;
}
...
{
return F_204 ( V_35 -> V_241 ) ;
}
static unsigned int F_205 ( const struct V_30 * V_35 )
{
return F_198 ( V_35 -> V_241 ) ;
}
static struct V_356 * F_206 ( const struct V_30 * V_35 , const void * V_9 )
{
return F_207 ( V_35 -> V_241 , V_9 ) ;
}
...
V_233 -> V_365 = F_194 ;
if ( F_135 ( V_233 -> V_366 == NULL ) )
V_233 -> V_366 = F_206 ;
if ( F_135 ( V_34 -> V_367 == NULL ) )
V_34 -> V_367 = F_196 ;
V_33 [ V_34 -> V_27 ] = V_34 ;
}
F_63 ( & V_358 ) ;
...
switch ( V_34 -> V_27 ) {
case V_28 :
V_368 = & V_31 -> V_91 . V_234 ;
break;
#if F_133 ( V_235 ) || F_133 ( V_236 )
case V_29 :
V_368 = & V_31 -> V_91 . V_237 ;
break;
#endif
default:
F_41 () ;
...
static void T_6 F_213 ( struct V_31 * V_31 )
{
struct V_33 * V_34 ;
F_69 ( & V_358 ) ;
V_34 = V_33 [ V_28 ] ;
...
static int F_214 ( struct V_369 * V_370 , unsigned long V_371 , void * V_372 )
{
struct V_244 * V_245 = V_372 ;
switch ( V_371 ) {
case V_373 :
F_196 ( F_181 ( V_245 ) ) ;
}
...
static int T_6 F_215 ( struct V_31 * V_31 )
{
int V_375 ;
if ( F_216 ( ( void V_376 * * ) V_31 -> V_377 . V_378 ,
sizeof( struct V_379 ) ,
F_217 ( struct V_379 ) ) < 0 )
return - V_205 ;
V_375 = F_218 ( V_31 ) ;
if ( V_375 < 0 )
F_219 ( ( void V_376 * * ) V_31 -> V_377 . V_378 ) ;
return V_375 ;
}
static void F_220 ( struct V_31 * V_31 )
{
F_221 ( V_31 ) ;
F_219 ( ( void V_376 * * ) V_31 -> V_377 . V_378 ) ;
}
...
static int T_6 F_222 ( struct V_31 * V_31 )
{
unsigned int V_94 , V_380 ;
int V_58 ;
if ( F_223 ( V_31 , & V_381 ) )
V_360 = F_224 ( L_1 ,
sizeof( struct V_229 ) ,
...
NULL ) ;
V_94 = 8 - 1 ;
V_380 = ( V_94 + 1 ) * sizeof( struct V_93 ) ;
V_31 -> V_91 . V_119 = F_61 ( V_380 ) ;
if ( ! V_31 -> V_91 . V_119 )
goto V_384;
V_31 -> V_91 . V_92 = V_94 ;
for ( V_58 = 0 ; V_58 < V_133 * 2 ; V_58 ++ ) {
...
F_225 ( & V_31 -> V_91 . V_97 [ V_58 ] ) ;
V_386 = & V_31 -> V_91 . V_95 [ V_58 ] ;
V_386 -> V_98 = F_61 ( V_380 ) ;
if ( ! V_386 -> V_98 )
goto V_387;
V_386 -> V_94 = V_94 ;
}
F_33 ( & V_31 -> V_91 . V_161 ) ;
F_226 ( & V_31 -> V_91 . V_140 , F_71 ) ;
if ( F_223 ( V_31 , & V_381 ) )
F_227 ( & V_388 ) ;
return 0 ;
V_387:
...
struct V_385 * V_386 ;
V_386 = & V_31 -> V_91 . V_95 [ V_58 ] ;
F_64 ( V_386 -> V_98 , V_380 ) ;
}
F_64 ( V_31 -> V_91 . V_119 , V_380 ) ;
V_384:
return - V_205 ;
}
static void F_228 ( struct V_31 * V_31 )
{
struct V_168 V_169 ;
unsigned int V_380 ;
int V_58 ;
F_229 ( & V_31 -> V_91 . V_140 ) ;
#ifdef F_106
V_169 . V_170 = - 1 ;
V_169 . V_171 = - 1 ;
V_169 . V_172 = 0 ;
...
V_386 = & V_31 -> V_91 . V_95 [ V_58 ] ;
V_380 = ( V_386 -> V_94 + 1 ) ;
F_79 ( ! F_57 ( V_386 -> V_98 ) ) ;
F_64 ( V_386 -> V_98 , V_380 ) ;
}
V_380 = ( V_31 -> V_91 . V_92 + 1 ) * sizeof( struct V_93 ) ;
F_79 ( ! F_57 ( V_31 -> V_91 . V_119 ) ) ;
F_64 ( V_31 -> V_91 . V_119 , V_380 ) ;
}
static int T_6 F_230 ( struct V_31 * V_31 )
{
int V_375 ;
V_375 = F_215 ( V_31 ) ;
if ( V_375 < 0 )
...
static void T_7 F_234 ( struct V_31 * V_31 )
{
F_235 ( V_31 ) ;
F_228 ( V_31 ) ;
F_233 ( V_31 ) ;
...
static void F_239 ( struct V_52 * V_53 ,
struct V_394 * V_395 )
{
...
if ( V_163 )
F_240 ( V_395 , L_2 ,
V_163 -> V_396 , V_163 -> V_397 , V_163 -> V_398 ) ;
switch( V_2 -> V_27 ) {
case V_28 :
F_240 ( V_395 , L_3 , & V_2 -> V_11 . V_399 ) ;
if ( V_2 -> V_12 != 32 )
F_240 ( V_395 , L_4 ,
V_2 -> V_12 ) ;
F_240 ( V_395 , L_5 , & V_2 -> V_9 . V_399 ) ;
if ( V_2 -> V_10 != 32 )
F_240 ( V_395 , L_6 ,
V_2 -> V_10 ) ;
break;
case V_29 :
F_240 ( V_395 , L_7 , V_2 -> V_11 . V_400 ) ;
if ( V_2 -> V_12 != 128 )
F_240 ( V_395 , L_4 ,
V_2 -> V_12 ) ;
F_240 ( V_395 , L_8 , V_2 -> V_9 . V_400 ) ;
if ( V_2 -> V_10 != 128 )
F_240 ( V_395 , L_6 ,
V_2 -> V_10 ) ;
break;
...
void F_241 ( struct V_52 * V_53 , int V_401 ,
T_9 V_402 , T_3 V_171 , T_3 V_172 )
{
struct V_394 * V_395 ;
V_395 = F_242 ( L_9 ) ;
if ( V_395 == NULL )
return;
F_243 ( V_402 , V_171 , V_172 , V_395 ) ;
F_240 ( V_395 , L_10 , V_401 ) ;
F_239 ( V_53 , V_395 ) ;
F_244 ( V_395 ) ;
}
void F_87 ( struct V_52 * V_53 , int V_401 ,
T_9 V_402 , T_3 V_171 , T_3 V_172 )
{
struct V_394 * V_395 ;
V_395 = F_242 ( L_11 ) ;
...
static int F_245 ( const struct V_1 * V_403 ,
const struct V_1 * V_404 )
{
if ( V_403 -> V_19 == V_405 ) {
if ( V_404 -> V_27 == V_403 -> V_27 &&
F_246 ( & V_404 -> V_9 , & V_403 -> V_9 ,
V_403 -> V_27 ) == 0 &&
F_246 ( & V_404 -> V_11 , & V_403 -> V_11 ,
V_403 -> V_27 ) == 0 &&
V_404 -> V_10 == V_403 -> V_10 &&
V_404 -> V_12 == V_403 -> V_12 ) {
return 1 ;
}
} else {
...
static struct V_52 * F_247 ( const struct V_1 * V_2 ,
T_4 V_58 , T_4 type )
{
...
T_3 V_159 = ~ 0U ;
F_69 ( & V_116 ) ;
V_153 = F_50 ( & V_381 , & V_2 -> V_9 , & V_2 -> V_11 , V_2 -> V_27 , V_58 ) ;
F_75 (pol, entry, chain, bydst) {
if ( F_245 ( V_2 , & V_79 -> V_109 ) &&
V_79 -> type == type ) {
V_166 = V_79 ;
V_159 = V_166 -> V_159 ;
break;
...
static int F_248 ( const struct V_406 * V_157 , const struct V_203 * V_407 )
{
int V_181 = 0 ;
if ( V_407 -> V_211 == V_157 -> V_211 && V_407 -> V_43 . V_19 == V_157 -> V_19 &&
( V_157 -> V_316 == 0 || V_407 -> V_316 == V_157 -> V_316 ) ) {
switch ( V_407 -> V_211 ) {
case V_212 :
case V_213 :
if ( F_246 ( & V_407 -> V_43 . V_9 , & V_157 -> V_408 ,
V_157 -> V_409 ) == 0 &&
F_246 ( & V_407 -> V_11 , & V_157 -> V_410 ,
V_157 -> V_409 ) == 0 ) {
V_181 = 1 ;
}
break;
...
static int F_249 ( struct V_52 * V_79 ,
struct V_406 * V_157 , int V_411 )
{
struct V_406 * V_412 ;
int V_115 , V_413 , V_414 = 0 ;
F_62 ( & V_79 -> V_59 ) ;
if ( F_9 ( V_79 -> V_60 . V_61 ) ) {
F_63 ( & V_79 -> V_59 ) ;
return - V_167 ;
...
for ( V_413 = 0 , V_412 = V_157 ; V_413 < V_411 ; V_413 ++ , V_412 ++ ) {
if ( ! F_248 ( V_412 , & V_79 -> V_202 [ V_115 ] ) )
continue;
V_414 ++ ;
if ( V_79 -> V_202 [ V_115 ] . V_211 != V_212 &&
V_79 -> V_202 [ V_115 ] . V_211 != V_213 )
continue;
memcpy ( & V_79 -> V_202 [ V_115 ] . V_43 . V_9 , & V_412 -> V_415 ,
sizeof( V_79 -> V_202 [ V_115 ] . V_43 . V_9 ) ) ;
memcpy ( & V_79 -> V_202 [ V_115 ] . V_11 , & V_412 -> V_416 ,
sizeof( V_79 -> V_202 [ V_115 ] . V_11 ) ) ;
V_79 -> V_202 [ V_115 ] . V_214 = V_412 -> V_417 ;
F_45 ( & V_79 -> V_90 ) ;
}
}
F_63 ( & V_79 -> V_59 ) ;
...
static int F_250 ( const struct V_406 * V_157 , int V_411 )
{
int V_115 , V_413 ;
if ( V_411 < 1 || V_411 > V_224 )
return - V_179 ;
for ( V_115 = 0 ; V_115 < V_411 ; V_115 ++ ) {
if ( ( F_246 ( & V_157 [ V_115 ] . V_408 , & V_157 [ V_115 ] . V_415 ,
V_157 [ V_115 ] . V_409 ) == 0 ) &&
( F_246 ( & V_157 [ V_115 ] . V_410 , & V_157 [ V_115 ] . V_416 ,
V_157 [ V_115 ] . V_409 ) == 0 ) )
return - V_179 ;
if ( F_120 ( & V_157 [ V_115 ] . V_415 , V_157 [ V_115 ] . V_417 ) ||
F_120 ( & V_157 [ V_115 ] . V_416 , V_157 [ V_115 ] . V_417 ) )
return - V_179 ;
for ( V_413 = V_115 + 1 ; V_413 < V_411 ; V_413 ++ ) {
if ( ! memcmp ( & V_157 [ V_115 ] . V_408 , & V_157 [ V_413 ] . V_408 ,
sizeof( V_157 [ V_115 ] . V_408 ) ) &&
! memcmp ( & V_157 [ V_115 ] . V_410 , & V_157 [ V_413 ] . V_410 ,
sizeof( V_157 [ V_115 ] . V_410 ) ) &&
V_157 [ V_115 ] . V_19 == V_157 [ V_413 ] . V_19 &&
V_157 [ V_115 ] . V_211 == V_157 [ V_413 ] . V_211 &&
V_157 [ V_115 ] . V_316 == V_157 [ V_413 ] . V_316 &&
V_157 [ V_115 ] . V_409 == V_157 [ V_413 ] . V_409 )
return - V_179 ;
}
}
return 0 ;
}
int V_406 ( const struct V_1 * V_2 , T_4 V_58 , T_4 type ,
struct V_406 * V_157 , int V_411 ,
struct V_419 * V_325 )
{
int V_115 , V_165 , V_420 = 0 , V_421 = 0 ;
struct V_52 * V_79 = NULL ;
struct V_38 * V_39 , * V_422 ;
struct V_38 * V_423 [ V_224 ] ;
struct V_38 * V_424 [ V_224 ] ;
struct V_406 * V_412 ;
if ( ( V_165 = F_250 ( V_157 , V_411 ) ) < 0 )
goto V_62;
if ( ( V_79 = F_247 ( V_2 , V_58 , type ) ) == NULL ) {
V_165 = - V_167 ;
goto V_62;
}
for ( V_115 = 0 , V_412 = V_157 ; V_115 < V_411 ; V_115 ++ , V_412 ++ ) {
if ( ( V_39 = F_251 ( V_412 ) ) ) {
V_423 [ V_420 ] = V_39 ;
V_420 ++ ;
if ( ( V_422 = F_252 ( V_39 , V_412 ) ) ) {
V_424 [ V_421 ] = V_422 ;
V_421 ++ ;
} else {
V_165 = - V_418 ;
...
if ( ( V_165 = F_249 ( V_79 , V_157 , V_411 ) ) < 0 )
goto V_425;
if ( V_420 ) {
F_253 ( V_423 , V_420 ) ;
F_254 ( V_423 , V_420 ) ;
}
F_255 ( V_2 , V_58 , type , V_157 , V_411 , V_325 ) ;
F_24 ( V_79 ) ;
return 0 ;
V_62:
return V_165 ;
