...
V_54 -> V_206 = V_207 ;
V_54 -> V_208 = V_209 | V_210 ;
V_54 -> V_211 = V_199 -> V_157 ;
V_200 -> V_31 = V_199 -> V_31 ;
V_54 -> V_212 = sizeof( struct V_130 ) ;
V_54 -> V_213 = & V_214 ;
V_54 -> V_215 . V_216 = V_199 -> V_216 ;
V_54 -> V_217 = F_102 ;
V_54 -> V_218 = V_219 ;
F_104 ( & V_200 -> V_179 , & V_220 ) ;
V_78 = F_105 ( V_54 ) ;
if ( V_78 ) {
F_4 ( L_11 , V_54 -> V_76 ) ;
F_89 ( & V_200 -> V_179 ) ;
...
static int T_5 F_106 ( struct V_50 * V_221 )
{
...
if ( ! V_200 )
return - V_185 ;
V_200 -> V_85 = V_221 -> V_54 . V_57 . V_58 . V_76 ;
memcpy ( & V_200 -> V_60 , V_221 , sizeof( struct V_50 ) ) ;
...
V_58 -> V_212 = sizeof( struct V_81 ) ;
V_58 -> V_217 = F_40 ;
V_58 -> V_224 = F_42 ;
F_104 ( & V_200 -> V_60 . V_179 , & V_225 ) ;
V_78 = F_107 ( V_77 ) ;
if ( V_78 ) {
F_4 ( L_11 , V_58 -> V_76 ) ;
...
static int T_5 F_108 ( const struct V_226 * V_199 )
{
...
V_77 -> V_222 = F_64 ;
V_57 = & V_77 -> V_57 ;
V_57 -> V_232 = V_199 -> V_100 ;
V_58 = & V_57 -> V_58 ;
snprintf ( V_58 -> V_76 , V_202 , L_9 , V_199 -> V_203 ) ;
snprintf ( V_58 -> V_204 , V_202 , L_10 , V_199 -> V_203 ) ;
V_58 -> V_206 = V_207 ;
V_58 -> V_208 = V_233 | V_79 ;
V_58 -> V_211 = V_199 -> V_157 ;
V_58 -> V_212 = sizeof( struct V_66 ) ;
V_58 -> V_218 = V_219 ;
V_58 -> V_217 = F_30 ;
V_58 -> V_224 = F_38 ;
F_104 ( & V_200 -> V_179 , & V_234 ) ;
V_78 = F_107 ( V_77 ) ;
if ( V_78 ) {
F_4 ( L_11 , V_58 -> V_76 ) ;
F_89 ( & V_200 -> V_179 ) ;
...
if ( V_237 ++ )
goto V_80;
for ( V_153 = 0 ; V_153 < V_238 ; V_153 ++ ) {
V_78 = F_108 ( & V_239 [ V_153 ] ) ;
if ( V_78 ) {
F_99 () ;
goto V_80;
}
}
for ( V_153 = 0 ; V_153 < V_240 ; V_153 ++ ) {
V_78 = F_103 ( & V_241 [ V_153 ] ) ;
if ( V_78 ) {
F_99 () ;
goto V_80;
}
...
static int F_113 ( struct V_242 * V_243 , struct V_244 * V_245 ,
unsigned long V_246 )
{
const unsigned int * V_247 ;
unsigned int V_248 ;
int V_153 ;
for ( V_153 = 0 ; V_153 < V_245 -> V_249 ; V_153 ++ ) {
if ( V_245 -> V_250 [ V_153 ] . V_251 == V_246 )
break;
}
if ( V_153 == V_245 -> V_249 )
return - V_107 ;
V_248 = V_245 -> V_250 [ V_153 ] . V_248 ;
V_247 = F_114 ( V_243 -> V_243 . V_252 , L_15 , NULL ) ;
if ( ! V_247 )
return - V_107 ;
for ( V_153 = 0 ; V_153 < V_243 -> V_253 . V_254 ; V_153 ++ ) {
if ( V_247 [ V_153 ] == V_248 )
return V_153 ;
}
return - V_107 ;
}
static int F_115 ( struct V_242 * V_243 , struct V_244 * V_245 ,
const char * V_255 , struct V_1 * V_200 ,
T_7 V_256 )
{
unsigned long V_257 ;
int V_258 ;
V_257 = F_116 ( V_200 -> V_16 , & V_200 -> V_259 ) ;
if ( V_257 )
return - V_121 ;
V_258 = F_113 ( V_243 , V_245 , V_200 -> V_259 ) ;
if ( V_258 < 0 )
return V_258 ;
V_200 -> V_13 = V_243 -> V_253 . V_260 [ V_258 ] ;
sprintf ( V_200 -> V_255 , L_16 , V_255 , V_258 ) ;
return F_117 ( V_200 -> V_13 , V_256 , V_261 ,
V_200 -> V_255 , V_200 ) ;
}
static void * F_118 ( unsigned long V_4 )
{
return F_119 ( V_262 [ V_4 - 1 ] , V_201 ) ;
}
static void F_120 ( void * V_200 , unsigned long V_4 )
{
return F_121 ( V_262 [ V_4 - 1 ] , V_200 ) ;
}
...
T_8 V_264 ;
unsigned long V_15 ;
if ( F_127 ( & V_200 -> V_265 ) )
return - V_121 ;
if ( ! F_128 ( & V_264 , V_201 ) )
return - V_185 ;
F_129 ( V_264 , & V_266 -> V_267 ) ;
F_130 ( V_266 , & V_200 -> V_265 ) ;
...
static void F_135 ( struct V_268 * V_269 )
{
struct V_1 * V_200 , * V_270 ;
F_88 (p, n, list, list) {
int V_153 ;
for ( V_153 = 0 ; V_153 < V_271 ; V_153 ++ ) {
...
static int F_137 ( struct V_272 * V_273 ,
struct V_242 * V_243 ,
T_2 V_274 , struct V_1 * V_200 ,
struct V_1 * * V_275 )
{
T_2 V_276 ;
F_138 (arc, mdesc, node, MDESC_ARC_TYPE_BACK) {
T_2 V_277 = F_139 ( V_273 , V_276 ) ;
const char * V_203 = F_140 ( V_273 , V_277 ) ;
const T_2 * V_278 ;
if ( strcmp ( V_203 , L_19 ) )
continue;
V_278 = F_141 ( V_273 , V_277 , L_20 , NULL ) ;
if ( V_275 [ * V_278 ] != NULL ) {
F_142 ( & V_243 -> V_243 , L_21 ,
V_243 -> V_243 . V_252 -> V_279 ) ;
return - V_121 ;
}
F_143 ( * V_278 , V_200 -> V_265 ) ;
V_275 [ * V_278 ] = V_200 ;
}
return 0 ;
}
static int F_144 ( struct V_244 * V_245 , struct V_268 * V_269 ,
struct V_242 * V_243 , struct V_272 * V_273 ,
T_2 V_274 , const char * V_280 , unsigned long V_4 ,
T_7 V_256 , struct V_1 * * V_275 )
{
struct V_1 * V_200 ;
int V_78 ;
V_200 = F_84 ( sizeof( struct V_1 ) , V_201 ) ;
if ( ! V_200 ) {
F_142 ( & V_243 -> V_243 , L_22 ,
V_243 -> V_243 . V_252 -> V_279 ) ;
return - V_185 ;
}
F_145 ( V_200 -> V_265 ) ;
...
V_200 -> V_4 = V_4 ;
F_81 ( & V_200 -> V_281 ) ;
F_104 ( & V_200 -> V_269 , V_269 ) ;
V_78 = F_137 ( V_273 , V_243 , V_274 , V_200 , V_275 ) ;
if ( V_78 )
return V_78 ;
V_78 = F_133 ( V_200 ) ;
if ( V_78 )
return V_78 ;
return F_115 ( V_243 , V_245 , V_280 , V_200 , V_256 ) ;
}
static int F_147 ( struct V_272 * V_273 , struct V_242 * V_243 ,
struct V_244 * V_245 , struct V_268 * V_269 ,
...
const char * type ;
type = F_141 ( V_273 , V_274 , L_24 , NULL ) ;
if ( ! type || strcmp ( type , V_282 ) )
continue;
V_78 = F_144 ( V_245 , V_269 , V_243 , V_273 , V_274 ,
V_282 , V_4 , V_256 , V_275 ) ;
if ( V_78 ) {
F_135 ( V_269 ) ;
break;
}
...
static int T_5 F_149 ( struct V_272 * V_273 , T_2 V_274 ,
struct V_244 * V_245 )
{
const T_2 * V_251 ;
int V_283 ;
int V_153 ;
V_251 = F_141 ( V_273 , V_274 , L_25 , & V_283 ) ;
if ( ! V_251 ) {
F_150 ( L_26 ) ;
return - V_107 ;
}
V_245 -> V_249 = V_283 / sizeof( T_2 ) ;
V_245 -> V_250 = F_84 ( ( sizeof( struct V_284 ) *
V_245 -> V_249 ) ,
V_201 ) ;
if ( ! V_245 -> V_250 )
return - V_185 ;
for ( V_153 = 0 ; V_153 < V_245 -> V_249 ; V_153 ++ ) {
struct V_284 * V_285 = & V_245 -> V_250 [ V_153 ] ;
V_285 -> V_248 = V_153 + 1 ;
V_285 -> V_251 = V_251 [ V_153 ] ;
}
return 0 ;
}
static int T_5 F_151 ( struct V_272 * V_273 ,
struct V_242 * V_243 ,
struct V_244 * V_245 ,
const char * V_286 )
{
...
T_2 V_274 ;
V_287 = F_114 ( V_243 -> V_243 . V_252 , L_27 , NULL ) ;
if ( ! V_287 )
return - V_107 ;
F_148 (mdesc, node, L_28 ) {
const char * V_203 ;
const T_2 * V_288 ;
V_203 = F_141 ( V_273 , V_274 , L_29 , NULL ) ;
if ( ! V_203 || strcmp ( V_203 , V_286 ) )
continue;
V_288 = F_141 ( V_273 , V_274 , L_30 , NULL ) ;
if ( ! V_288 || ( * V_288 != * V_287 ) )
continue;
V_245 -> V_289 = * V_288 ;
return F_149 ( V_273 , V_274 , V_245 ) ;
}
return - V_107 ;
}
...
goto V_294;
V_78 = - V_185 ;
V_109 = F_84 ( sizeof( struct V_1 * ) * V_271 ,
V_201 ) ;
if ( ! V_109 )
goto V_295;
V_296 = F_84 ( sizeof( struct V_1 * ) * V_271 ,
V_201 ) ;
if ( ! V_296 )
goto V_297;
V_78 = 0 ;
...
static struct V_298 * T_5 F_158 ( void )
{
struct V_298 * V_299 = F_84 ( sizeof( struct V_298 ) , V_201 ) ;
if ( V_299 )
F_81 ( & V_299 -> V_300 ) ;
return V_299 ;
}
static void F_159 ( struct V_298 * V_299 )
{
if ( V_299 -> V_301 . V_250 ) {
F_90 ( V_299 -> V_301 . V_250 ) ;
V_299 -> V_301 . V_250 = NULL ;
}
F_90 ( V_299 ) ;
}
...
static int T_5 F_161 ( struct V_242 * V_243 )
{
struct V_272 * V_273 ;
const char * V_279 ;
struct V_298 * V_299 ;
int V_78 ;
F_160 () ;
V_279 = V_243 -> V_243 . V_252 -> V_279 ;
F_76 ( L_32 , V_279 ) ;
V_299 = F_158 () ;
if ( ! V_299 ) {
F_142 ( & V_243 -> V_243 , L_33 ,
V_279 ) ;
return - V_185 ;
}
V_78 = F_156 () ;
if ( V_78 ) {
F_142 ( & V_243 -> V_243 , L_34
L_35 , V_279 ) ;
goto V_304;
}
V_273 = F_162 () ;
if ( ! V_273 ) {
F_142 ( & V_243 -> V_243 , L_36 ,
V_279 ) ;
V_78 = - V_107 ;
goto V_305;
}
V_78 = F_151 ( V_273 , V_243 , & V_299 -> V_301 , L_37 ) ;
if ( V_78 ) {
F_142 ( & V_243 -> V_243 , L_38 ,
V_279 ) ;
F_163 ( V_273 ) ;
goto V_305;
}
V_78 = F_147 ( V_273 , V_243 , & V_299 -> V_301 , & V_299 -> V_300 ,
L_39 , V_263 , F_3 ,
V_109 ) ;
F_163 ( V_273 ) ;
if ( V_78 ) {
F_142 ( & V_243 -> V_243 , L_40 ,
V_279 ) ;
goto V_305;
}
V_78 = F_109 () ;
if ( V_78 ) {
F_142 ( & V_243 -> V_243 , L_41 ,
V_279 ) ;
goto V_306;
}
F_164 ( & V_243 -> V_243 , V_299 ) ;
return 0 ;
V_306:
F_135 ( & V_299 -> V_300 ) ;
V_305:
...
static int T_6 F_165 ( struct V_242 * V_243 )
{
struct V_298 * V_299 = F_166 ( & V_243 -> V_243 ) ;
F_112 () ;
F_135 ( & V_299 -> V_300 ) ;
F_157 () ;
F_159 ( V_299 ) ;
...
static struct V_307 * T_5 F_167 ( void )
{
struct V_307 * V_308 = F_84 ( sizeof( struct V_307 ) , V_201 ) ;
if ( V_308 )
F_81 ( & V_308 -> V_309 ) ;
return V_308 ;
}
static void F_168 ( struct V_307 * V_308 )
{
if ( V_308 -> V_310 . V_250 ) {
F_90 ( V_308 -> V_310 . V_250 ) ;
V_308 -> V_310 . V_250 = NULL ;
}
F_90 ( V_308 ) ;
}
static int T_5 F_169 ( struct V_242 * V_243 )
{
struct V_272 * V_273 ;
const char * V_279 ;
struct V_307 * V_308 ;
...
V_78 = F_151 ( V_273 , V_243 , & V_308 -> V_310 , L_44 ) ;
if ( V_78 ) {
F_142 ( & V_243 -> V_243 , L_38 ,
V_279 ) ;
F_163 ( V_273 ) ;
...
V_78 = F_147 ( V_273 , V_243 , & V_308 -> V_310 , & V_308 -> V_309 ,
L_45 , V_5 , F_10 ,
V_296 ) ;
F_163 ( V_273 ) ;
if ( V_78 ) {
F_142 ( & V_243 -> V_243 , L_46 ,
V_279 ) ;
goto V_305;
}
F_164 ( & V_243 -> V_243 , V_308 ) ;
return 0 ;
V_305:
F_157 () ;
V_311:
...
static int T_6 F_170 ( struct V_242 * V_243 )
{
struct V_307 * V_308 = F_166 ( & V_243 -> V_243 ) ;
F_135 ( & V_308 -> V_309 ) ;
F_157 () ;
F_168 ( V_308 ) ;
return 0 ;
