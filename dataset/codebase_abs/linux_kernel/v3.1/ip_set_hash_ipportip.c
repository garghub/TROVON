...
T_3 V_77 ;
if ( ! ( V_28 -> V_78 == V_79 || V_28 -> V_78 == V_80 ) )
return - V_81 ;
if ( F_21 ( ! F_23 ( V_44 , V_82 ) ||
! F_23 ( V_44 , V_83 ) ||
! F_23 ( V_44 , V_21 ) ) )
return - V_53 ;
if ( V_44 [ V_82 ] ) {
...
if ( V_44 [ V_83 ] )
V_68 = F_54 ( V_44 [ V_83 ] ) ;
V_24 = F_55 ( sizeof( * V_24 ) , V_85 ) ;
if ( ! V_24 )
return - V_86 ;
V_24 -> V_68 = V_68 ;
F_56 ( & V_24 -> V_87 , sizeof( V_24 -> V_87 ) ) ;
V_24 -> V_22 = V_88 ;
V_77 = F_57 ( V_74 ) ;
V_24 -> V_89 = F_58 (
sizeof( struct V_90 )
+ F_59 ( V_77 ) * sizeof( struct V_91 ) ) ;
if ( ! V_24 -> V_89 ) {
F_60 ( V_24 ) ;
return - V_86 ;
}
...
F_63 ( L_1 ,
V_28 -> V_96 , F_59 ( V_24 -> V_89 -> F_57 ) ,
V_24 -> V_89 -> F_57 , V_24 -> V_68 , V_28 -> V_13 , V_24 -> V_89 ) ;
return 0 ;
}
static int T_4
F_64 ( void )
