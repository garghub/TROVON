...
T_2 * V_91 ;
int V_32 , V_5 ;
static T_2 V_92 [ 8 ] = { 0x55 , 0xaa , 0 , 0 , 0 , 0 , 0 , 0 } ;
static T_2 V_93 [ 4 ] = { 0x5a , 0 , 0 , 0 } ;
V_53 = F_17 ( V_46 , V_54 ) ;
if ( ! V_53 )
return - V_55 ;
if ( V_46 == 8 )
...
int F_34 ( struct V_3 * V_4 , T_2 V_99 )
{
int V_5 , V_100 ;
if ( V_99 == V_101 )
V_100 = 8 ;
...
return - V_67 ;
F_33 ( V_4 , V_4 -> V_2 , V_95 , V_100 ) ;
V_5 = F_33 ( V_4 , V_4 -> V_2 , V_96 , V_100 ) ;
return V_5 ;
}
