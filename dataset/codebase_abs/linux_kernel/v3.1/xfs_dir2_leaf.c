...
V_15 = args -> V_17 ;
V_12 = V_7 -> V_16 ;
ASSERT ( V_109 >= F_5 ( V_12 ) &&
V_109 < F_69 ( V_12 ) ) ;
error = F_70 ( V_15 , V_7 , F_43 ( V_12 , V_109 ) , - 1 , & V_62 ,
V_49 ) ;
if ( error ) {
return error ;
}
...
V_10 = V_62 -> V_19 ;
ASSERT ( V_10 -> V_4 . V_63 . V_25 == F_10 ( V_18 ) ) ;
V_11 = F_17 ( V_15 -> V_117 , V_10 ) ;
V_115 = F_18 ( V_11 ) + V_113 ;
V_116 = F_18 ( V_11 ) + V_114 ;
F_71 ( V_15 , V_62 , ( V_105 ) ( ( char * ) V_115 - ( char * ) V_10 ) ,
( V_105 ) ( ( char * ) V_116 - ( char * ) V_10 + sizeof( * V_116 ) - 1 ) ) ;
}
void
F_12 (
T_13 * V_15 ,
...
V_10 = V_62 -> V_19 ;
ASSERT ( V_10 -> V_4 . V_63 . V_25 == F_10 ( V_18 ) ||
V_10 -> V_4 . V_63 . V_25 == F_10 ( V_120 ) ) ;
V_118 = & V_10 -> V_22 [ V_113 ] ;
V_119 = & V_10 -> V_22 [ V_114 ] ;
F_71 ( V_15 , V_62 , ( V_105 ) ( ( char * ) V_118 - ( char * ) V_10 ) ,
( V_105 ) ( ( char * ) V_119 - ( char * ) V_10 + sizeof( * V_119 ) - 1 ) ) ;
}
void
F_49 (
T_13 * V_15 ,
...
ASSERT ( V_10 -> V_4 . V_63 . V_25 == F_10 ( V_18 ) ||
V_10 -> V_4 . V_63 . V_25 == F_10 ( V_120 ) ) ;
F_71 ( V_15 , V_62 , ( V_105 ) ( ( char * ) & V_10 -> V_4 - ( char * ) V_10 ) ,
( V_105 ) ( sizeof( V_10 -> V_4 ) - 1 ) ) ;
}
STATIC void
F_42 (
T_13 * V_15 ,
...
ASSERT ( V_10 -> V_4 . V_63 . V_25 == F_10 ( V_18 ) ) ;
V_11 = F_17 ( V_12 , V_10 ) ;
F_71 ( V_15 , V_62 , ( V_105 ) ( ( char * ) V_11 - ( char * ) V_10 ) ,
( V_105 ) ( V_12 -> V_24 - 1 ) ) ;
}
int
F_72 (
...
if ( F_11 ( V_40 -> V_34 ) == V_35 )
continue;
V_123 = F_33 ( V_12 , F_11 ( V_40 -> V_34 ) ) ;
if ( V_123 != V_78 ) {
if ( V_1 )
F_34 ( V_15 , V_1 ) ;
error = F_30 ( V_15 , V_7 ,
...
V_126 = V_12 -> V_127 -> V_128 ( args , V_41 -> V_61 , V_41 -> V_50 ) ;
if ( V_126 != V_129 && V_126 != args -> V_130 ) {
args -> V_130 = V_126 ;
* V_67 = V_31 ;
if ( V_126 == V_131 ) {
* V_122 = V_1 ;
...
F_7 ( V_7 , V_1 ) ;
V_40 = & V_10 -> V_22 [ V_31 ] ;
V_135 = F_33 ( V_12 , F_11 ( V_40 -> V_34 ) ) ;
V_41 = ( T_14 * )
( ( char * ) V_4 + F_75 ( V_12 , F_11 ( V_40 -> V_34 ) ) ) ;
V_14 = V_13 = 0 ;
V_136 = F_13 ( V_4 -> V_28 [ 0 ] . V_29 ) ;
V_11 = F_17 ( V_12 , V_10 ) ;
V_2 = F_18 ( V_11 ) ;
ASSERT ( F_13 ( V_2 [ V_135 ] ) == V_136 ) ;
F_14 ( V_15 , V_1 ,
...
if ( V_13 )
F_19 ( V_15 , V_1 ) ;
if ( F_13 ( V_4 -> V_28 [ 0 ] . V_29 ) != V_136 ) {
V_2 [ V_135 ] = V_4 -> V_28 [ 0 ] . V_29 ;
F_21 ( V_15 , V_8 , V_135 , V_135 ) ;
}
F_7 ( V_7 , V_1 ) ;
if ( F_13 ( V_4 -> V_28 [ 0 ] . V_29 ) ==
V_12 -> V_24 - ( V_105 ) sizeof( * V_4 ) ) {
ASSERT ( V_135 != V_12 -> V_137 ) ;
if ( ( error = F_79 ( args , V_135 , V_1 ) ) ) {
...
V_1 = NULL ;
if ( V_135 == F_11 ( V_11 -> V_27 ) - 1 ) {
for ( V_44 = V_135 - 1 ; V_44 > 0 ; V_44 -- ) {
if ( V_2 [ V_44 ] != F_10 ( V_52 ) )
break;
}
memmove ( & V_2 [ V_135 - V_44 ] , V_2 ,
( F_11 ( V_11 -> V_27 ) - ( V_135 - V_44 ) ) * sizeof( * V_2 ) ) ;
F_41 ( & V_11 -> V_27 , - ( V_135 - V_44 ) ) ;
F_42 ( V_15 , V_8 ) ;
F_21 ( V_15 , V_8 , 0 , F_11 ( V_11 -> V_27 ) - 1 ) ;
} else
V_2 [ V_135 ] = F_10 ( V_52 ) ;
}
else if ( V_135 != V_12 -> V_137 && V_1 != NULL ) {
F_22 ( V_1 ) ;
V_1 = NULL ;
}
F_20 ( V_7 , V_8 ) ;
...
return 0 ;
#endif
for ( V_40 = V_10 -> V_22 , V_141 = 0 , V_140 = F_13 ( V_10 -> V_4 . V_20 ) - 1 ,
V_139 = args -> V_51 ;
V_141 <= V_140 ; ) {
V_142 = ( V_141 + V_140 ) >> 1 ;
if ( ( V_138 = F_11 ( V_40 [ V_142 ] . V_51 ) ) == V_139 )
break;
if ( V_138 < V_139 )
V_141 = V_142 + 1 ;
else
...
if ( V_138 == V_139 ) {
while ( V_142 > 0 && F_11 ( V_40 [ V_142 - 1 ] . V_51 ) == V_139 ) {
V_142 -- ;
}
}
else if ( V_138 < V_139 )
...
V_12 = V_7 -> V_16 ;
V_15 = args -> V_17 ;
if ( ( error = F_30 ( V_15 , V_7 , F_43 ( V_12 , V_135 ) , - 1 , & V_1 ,
V_49 ) ) ) {
return error ;
}
V_10 = V_8 -> V_19 ;
...
#ifdef F_85
{
struct V_143 * V_4 = V_1 -> V_19 ;
ASSERT ( V_4 -> V_25 == F_15 ( V_26 ) ) ;
ASSERT ( F_13 ( V_4 -> V_28 [ 0 ] . V_29 ) ==
V_12 -> V_24 - ( V_105 ) sizeof( * V_4 ) ) ;
ASSERT ( V_135 == F_11 ( V_11 -> V_27 ) - 1 ) ;
}
#endif
if ( ( error = F_79 ( args , V_135 , V_1 ) ) ) {
ASSERT ( error != V_57 ) ;
...
{
int V_146 ;
V_146 = F_13 ( V_4 -> V_20 ) - F_13 ( V_4 -> V_21 ) ;
return sizeof( V_147 ) +
V_146 * sizeof( T_6 ) +
V_145 * sizeof( V_53 ) +
sizeof( T_11 ) ;
...
V_7 = args -> V_7 ;
V_15 = args -> V_17 ;
if ( ( error = F_89 ( V_15 , V_7 , & V_150 , V_49 ) ) ) {
return error ;
}
V_150 -= V_12 -> V_98 ;
while ( V_150 > V_12 -> V_154 ) {
if ( ( error = F_90 ( args , V_150 , & V_151 ) ) ) {
return error ;
}
if ( V_151 )
V_150 -= V_12 -> V_98 ;
...
if ( ( error = F_91 ( V_15 , V_7 , & V_150 , V_49 ) ) ) {
return error ;
}
if ( F_92 ( V_12 , V_150 ) > V_97 + V_12 -> V_24 )
return 0 ;
V_8 = V_148 -> V_152 . V_155 [ 0 ] . V_62 ;
V_10 = V_8 -> V_19 ;
ASSERT ( V_10 -> V_4 . V_63 . V_25 == F_10 ( V_120 ) ) ;
if ( ( error = F_30 ( V_15 , V_7 , V_12 -> V_154 , - 1 , & V_149 ,
V_49 ) ) ) {
return error ;
}
free = V_149 -> V_19 ;
ASSERT ( free -> V_4 . V_25 == F_15 ( V_156 ) ) ;
ASSERT ( ! free -> V_4 . V_157 ) ;
if ( F_86 ( & V_10 -> V_4 , F_11 ( free -> V_4 . V_158 ) ) >
V_12 -> V_24 ) {
F_34 ( V_15 , V_149 ) ;
return 0 ;
}
...
V_11 = F_17 ( V_12 , V_10 ) ;
V_11 -> V_27 = free -> V_4 . V_158 ;
memcpy ( F_18 ( V_11 ) , free -> V_159 ,
F_11 ( V_11 -> V_27 ) * sizeof( V_53 ) ) ;
F_21 ( V_15 , V_8 , 0 , F_11 ( V_11 -> V_27 ) - 1 ) ;
F_42 ( V_15 , V_8 ) ;
F_20 ( V_7 , V_8 ) ;
error = F_79 ( args , F_69 ( V_12 ) , V_149 ) ;
if ( error ) {
ASSERT ( error != V_57 ) ;
return error ;
}
