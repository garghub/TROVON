...
struct V_111 * V_112 = & F_51 ( V_2 ) -> V_113 [ V_41 ] ;
V_27 = F_52 ( V_112 -> V_114 . V_115 , V_22 -> V_106 ,
& V_22 -> V_116 [ V_41 ] ) ;
if ( V_27 )
return V_27 ;
}
...
struct V_1 * V_2 = V_22 -> V_2 ;
struct V_5 * V_6 = V_2 -> V_7 ;
struct V_119 * V_120 = V_119 ( V_22 -> V_121 ) ;
struct V_105 * V_106 = V_120 ? V_120 -> V_106 : V_6 -> V_122 ;
struct V_34 * V_123 = NULL , * V_124 = NULL ;
int V_27 , V_41 ;
F_13 ( V_2 , L_10 , V_22 -> V_13 , V_117 , V_118 ) ;
if ( V_6 -> V_89 == V_125 )
...
if ( V_106 ) {
T_1 V_126 = ( V_6 -> V_127 == 0x50 ) ? 0x1400 : 0x0200 ;
T_3 V_128 = V_22 -> V_40 -> V_51 + V_126 ;
T_1 V_129 = V_22 -> V_40 -> V_48 ;
if ( V_129 != ~ 0 )
V_129 += V_126 ;
V_27 = F_35 ( V_2 , V_129 , V_128 , 0x4000 ,
0 , & V_22 -> V_130 ) ;
if ( V_27 )
return V_27 ;
F_49 ( V_106 , & V_22 -> V_106 , V_22 -> V_130 ) ;
}
if ( V_6 -> V_89 < V_90 ) {
F_54 ( V_6 -> V_131 , & V_22 -> V_131 , NULL ) ;
} else {
...
if ( V_27 )
return V_27 ;
V_27 = F_55 ( V_2 , V_131 , & V_22 -> V_131 ) ;
F_20 ( NULL , & V_131 ) ;
if ( V_27 )
return V_27 ;
for ( V_41 = 0 ; V_41 < 2 ; V_41 ++ ) {
struct V_34 * V_114 = NULL ;
struct V_111 * V_112 =
& F_51 ( V_2 ) -> V_113 [ V_41 ] ;
T_3 V_71 = V_112 -> V_114 . V_115 -> V_115 . V_71 ;
V_27 = F_40 ( V_22 , 0x3d , V_71 , 0xfff ,
V_79 ,
V_81 , & V_114 ) ;
if ( V_27 )
return V_27 ;
V_27 = F_43 ( V_22 , V_132 + V_41 , V_114 ) ;
F_20 ( NULL , & V_114 ) ;
if ( V_27 )
return V_27 ;
}
...
F_13 ( V_2 , L_7 , V_22 -> V_13 ) ;
if ( V_6 -> V_89 >= V_90 ) {
struct F_51 * V_136 = F_51 ( V_2 ) ;
for ( V_41 = 0 ; V_41 < 2 ; V_41 ++ ) {
struct V_111 * V_112 = & V_136 -> V_113 [ V_41 ] ;
F_57 ( V_112 -> V_114 . V_115 , & V_22 -> V_116 [ V_41 ] ) ;
}
F_49 ( NULL , & V_22 -> V_106 , V_22 -> V_130 ) ;
F_20 ( NULL , & V_22 -> V_130 ) ;
}
if ( F_58 ( & V_22 -> V_47 ) )
F_59 ( & V_22 -> V_47 ) ;
F_20 ( NULL , & V_22 -> V_40 ) ;
...
if ( V_38 -> V_50 != V_57 )
continue;
V_38 -> V_137 = F_61 ( V_38 -> V_32 ) ;
if ( ! V_38 -> V_137 ) {
F_62 ( V_2 ) ;
return - V_11 ;
}
for ( V_41 = 0 ; V_41 < V_38 -> V_32 ; V_41 += 4 )
V_38 -> V_137 [ V_41 / 4 ] = F_63 ( V_38 , V_41 ) ;
}
return 0 ;
}
void
...
continue;
for ( V_41 = 0 ; V_41 < V_38 -> V_32 ; V_41 += 4 )
F_21 ( V_38 , V_41 , V_38 -> V_137 [ V_41 / 4 ] ) ;
F_64 ( V_38 -> V_137 ) ;
V_38 -> V_137 = NULL ;
}
V_6 -> V_4 . V_37 . V_59 ( V_2 ) ;
...
struct V_138 * V_121 )
{
struct V_139 * V_140 = V_23 ;
struct V_17 * V_22 ;
int V_27 ;
if ( V_140 -> V_99 == ~ 0 )
return - V_21 ;
V_22 = F_66 ( V_121 , V_140 -> V_141 ) ;
if ( F_67 ( V_22 ) )
return F_68 ( V_22 ) ;
if ( F_69 ( V_22 , V_140 -> V_99 ) ) {
V_27 = - V_142 ;
goto V_143;
}
V_27 = F_44 ( V_22 , V_140 -> V_99 , V_140 -> V_3 ) ;
if ( V_27 ) {
F_45 ( V_2 , L_16 ,
V_27 , V_140 -> V_141 , V_140 -> V_99 ) ;
}
V_143:
F_70 ( & V_22 ) ;
return V_27 ;
...
struct V_138 * V_121 )
{
struct V_144 * V_145 = V_23 ;
struct V_17 * V_22 ;
int V_27 ;
V_22 = F_66 ( V_121 , V_145 -> V_141 ) ;
if ( F_67 ( V_22 ) )
return F_68 ( V_22 ) ;
F_72 ( V_22 ) ;
V_27 = F_73 ( V_22 , V_145 -> V_99 ) ;
F_70 ( & V_22 ) ;
return V_27 ;
}
T_1
...
V_147 = F_75 ( V_2 , 0x700000 + ( V_31 & 0xffff ) ) ;
F_11 ( & V_6 -> V_148 , V_26 ) ;
return V_147 ;
}
...
void
F_21 ( struct V_34 * V_38 , T_1 V_71 , T_1 V_147 )
{
struct V_5 * V_6 = V_38 -> V_2 -> V_7 ;
struct V_1 * V_2 = V_38 -> V_2 ;
unsigned long V_26 ;
...
F_74 ( V_2 , 0x700000 + ( V_31 & 0xffff ) , V_147 ) ;
F_11 ( & V_6 -> V_148 , V_26 ) ;
return;
}
F_77 ( V_2 , V_38 -> V_48 + V_71 , V_147 ) ;
}
