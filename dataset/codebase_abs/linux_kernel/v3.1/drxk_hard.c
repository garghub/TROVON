...
T_1 IF ;
F_12 ( 1 , L_3 ) ;
if ( V_928 -> V_933 . V_934 )
V_928 -> V_933 . V_934 ( V_928 , 1 ) ;
if ( V_928 -> V_933 . V_935 . V_936 )
V_928 -> V_933 . V_935 . V_936 ( V_928 , V_314 ) ;
if ( V_928 -> V_933 . V_934 )
V_928 -> V_933 . V_934 ( V_928 , 0 ) ;
V_2 -> V_365 = * V_314 ;
V_928 -> V_933 . V_935 . V_937 ( V_928 , & IF ) ;
F_52 ( V_2 , 0 , IF ) ;
return 0 ;
}
