...
static int F_21 ( struct V_2 * V_3 , int V_67 , int V_68 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
int V_69 , V_70 ;
int V_71 ;
...
static void F_22 ( struct V_2 * V_3 , T_4 V_43 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
if ( V_43 == V_20 -> V_43 )
return;
...
static void F_23 ( struct V_2 * V_3 , struct V_104 * V_105 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
int V_73 = ( V_20 -> V_43 & V_74 ) ;
T_1 V_106 [ 24 ] ;
...
static int F_24 ( struct V_2 * V_3 , struct V_104 * V_115 )
{
static T_5 V_116 [] = {
0 , V_110 , 0 ,
0 , V_111 ,
...
return 0 ;
for ( V_28 = 2 ; V_28 <= 23 ; V_28 ++ ) {
T_1 V_117 = F_11 ( V_3 , V_28 - 2 + V_108 ) ;
V_115 -> V_109 [ 0 ] [ V_28 ] = V_116 [ V_117 >> 4 ] ;
V_115 -> V_109 [ 1 ] [ V_28 ] = V_116 [ V_117 & 0xf ] ;
V_115 -> V_118 |=
V_115 -> V_109 [ 0 ] [ V_28 ] | V_115 -> V_109 [ 1 ] [ V_28 ] ;
}
return 0 ;
}
static int F_25 ( struct V_2 * V_3 , struct V_119 * V_105 )
{
F_23 ( V_3 , NULL ) ;
return 0 ;
}
static int F_26 ( struct V_2 * V_3 , struct V_104 * V_105 )
{
F_23 ( V_3 , V_105 ) ;
return 0 ;
}
static int F_27 ( struct V_2 * V_3 , struct V_120 * V_105 )
{
if ( V_105 -> V_121 != V_122 )
return - V_42 ;
V_105 -> V_123 = V_124 ;
V_105 -> V_125 = V_126 ;
return F_21 ( V_3 , V_105 -> V_67 , V_105 -> V_68 ) ;
}
static int F_28 ( struct V_2 * V_3 , struct V_127 * V_128 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
...
static int F_29 ( struct V_2 * V_3 , struct V_133 * V_134 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
int V_135 ;
if ( V_20 -> V_136 )
...
static int F_30 ( struct V_2 * V_3 , T_4 V_43 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
V_20 -> V_136 = 0 ;
F_22 ( V_3 , V_43 ) ;
...
static int F_33 ( struct V_2 * V_3 , T_2 V_56 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
if ( V_20 -> V_22 > V_14 )
return - V_42 ;
...
static int F_34 ( struct V_2 * V_3 , int V_152 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
...
static int F_35 ( struct V_2 * V_3 , T_2 V_35 , T_2 V_154 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
...
static int F_36 ( struct V_2 * V_3 , T_2 V_56 )
{
F_10 ( 1 , V_23 , V_3 , L_18 ) ;
F_9 ( V_3 , V_92 ) ;
return 0 ;
}
static int F_37 ( struct V_2 * V_3 , struct V_160 * V_21 )
{
switch ( V_21 -> V_12 ) {
case V_112 :
...
static int F_38 ( struct V_2 * V_3 , T_4 * V_43 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
int V_162 ;
* V_43 = V_163 ;
if ( V_20 -> V_22 != V_17 ) {
int V_164 = F_11 ( V_3 , V_137 ) ;
if ( V_164 & 0x20 )
* V_43 = V_44 ;
else
* V_43 = V_74 ;
...
static int F_39 ( struct V_2 * V_3 , T_2 * V_135 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
int V_162 = 0x80 ;
int V_164 ;
...
if ( V_20 -> V_22 == V_17 )
V_162 = F_11 ( V_3 , V_165 ) ;
V_164 = F_11 ( V_3 , V_137 ) ;
if ( ( V_164 & 0xc1 ) == 0x81 && ( V_162 & 0xc0 ) == 0x80 )
* V_135 = 0 ;
return 0 ;
}
static int F_40 ( struct V_2 * V_3 , struct V_169 * V_8 )
{
struct V_10 * V_11 = F_5 ( V_3 ) ;
if ( ! F_41 ( V_11 , & V_8 -> V_170 ) )
return - V_42 ;
if ( ! F_42 ( V_171 ) )
return - V_172 ;
...
static int F_43 ( struct V_2 * V_3 , struct V_169 * V_8 )
{
struct V_10 * V_11 = F_5 ( V_3 ) ;
if ( ! F_41 ( V_11 , & V_8 -> V_170 ) )
return - V_42 ;
...
static int F_44 ( struct V_2 * V_3 , struct V_174 * V_175 )
{
struct V_1 * V_20 = F_1 ( V_3 ) ;
struct V_10 * V_11 = F_5 ( V_3 ) ;
return F_45 ( V_11 , V_175 , V_20 -> V_22 , 0 ) ;
}
...
int V_176 ;
int V_177 ;
F_47 ( V_3 , L_19 , V_20 -> V_53 ) ;
if ( V_20 -> V_22 != V_17 ) {
V_164 = F_11 ( V_3 , V_137 ) ;
V_176 = ( V_164 & 0xc1 ) == 0x81 ;
F_47 ( V_3 , L_20 , V_176 ? L_21 : L_22 ) ;
F_47 ( V_3 , L_23 , ( V_164 & 0x20 ) ? L_24 : L_25 ) ;
return 0 ;
}
V_162 = F_11 ( V_3 , V_165 ) ;
V_164 = F_11 ( V_3 , V_137 ) ;
V_176 = ( V_164 & 0xc1 ) == 0x81 && ( V_162 & 0xc0 ) == 0x80 ;
V_177 = ! ( V_164 & 0x10 ) ;
if ( V_20 -> V_138 >= 6 )
F_47 ( V_3 , L_26 , V_20 -> V_138 - 6 ) ;
else
F_47 ( V_3 , L_27 , V_20 -> V_138 ) ;
F_47 ( V_3 , L_20 , V_176 ? ( V_177 ? L_28 : L_29 ) : L_22 ) ;
F_47 ( V_3 , L_23 , ( V_164 & 0x20 ) ? L_24 : L_25 ) ;
switch ( V_162 & 0x03 ) {
case 1 :
F_47 ( V_3 , L_30 ) ;
...
F_47 ( V_3 , L_34 , V_20 -> V_67 , V_20 -> V_68 ) ;
F_48 ( & V_20 -> V_7 , V_3 -> V_178 ) ;
return 0 ;
}
static int F_49 ( struct V_10 * V_11 ,
const struct V_179 * V_12 )
{
struct V_1 * V_20 ;
struct V_2 * V_3 ;
struct V_180 * V_7 ;
...
char V_178 [ 17 ] ;
char V_181 ;
int V_182 = ! V_12 || V_12 -> V_183 == 1 ;
if ( ! F_50 ( V_11 -> V_184 , V_185 ) )
return - V_161 ;
for ( V_28 = 0 ; V_28 < 0x0f ; V_28 ++ ) {
F_6 ( V_11 , 0 , V_28 ) ;
V_178 [ V_28 ] = ( F_12 ( V_11 , 0 ) & 0x0f ) + '0' ;
if ( V_178 [ V_28 ] > '9' )
V_178 [ V_28 ] += 'a' - '9' - 1 ;
}
V_178 [ V_28 ] = '\0' ;
V_181 = V_178 [ 5 ] ;
if ( memcmp ( V_178 + 1 , L_35 , 4 ) ) {
F_51 ( 1 , V_23 , V_11 , L_36 ,
V_11 -> V_186 << 1 , V_178 ) ;
return - V_187 ;
}
if ( ! V_182 && V_12 -> V_178 [ 6 ] != V_181 ) {
F_52 ( V_11 , L_37 ,
V_181 , V_12 -> V_178 ) ;
}
snprintf ( V_11 -> V_178 , sizeof( V_11 -> V_178 ) , L_38 , V_181 ) ;
F_53 ( V_11 , L_39 , V_181 , V_178 ,
V_11 -> V_186 << 1 , V_11 -> V_184 -> V_178 ) ;
V_20 = F_54 ( sizeof( struct V_1 ) , V_188 ) ;
if ( V_20 == NULL )
return - V_189 ;
V_3 = & V_20 -> V_3 ;
F_55 ( V_3 , V_11 , & V_190 ) ;
...
F_57 ( V_7 , & V_191 ,
V_65 , - 128 , 127 , 1 , 0 ) ;
V_20 -> V_55 = F_57 ( V_7 , & V_191 ,
V_54 , 0 , 1 , 1 , 1 ) ;
V_20 -> V_57 = F_57 ( V_7 , & V_191 ,
V_192 , 0 , 127 , 1 , 40 ) ;
V_20 -> V_57 -> V_193 = 1 ;
V_3 -> V_194 = V_7 ;
if ( V_7 -> error ) {
