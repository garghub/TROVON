...
V_76 = F_27 ( V_2 -> V_56 -> V_136 , V_130 ) ;
...
V_153 = F_28 ( V_2 , V_161 ,
0 , 0 , & V_151 ) ;
return V_153 ;
}
int F_38 ( struct V_1 * V_2 , int V_35 , T_1 * V_149 ,
int V_162 )
{
struct V_37 V_163 ;
int V_153 ;
...
V_170 -> V_97 [ V_139 ] = true ;
else
V_170 -> V_97 [ V_139 ] = false ;
}
V_170 ++ ;
V_173 ++ ;
if ( V_173 >= V_179 )
