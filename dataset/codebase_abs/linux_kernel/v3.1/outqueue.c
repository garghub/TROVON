...
& V_36 -> V_127 ) ;
if ( ! V_121 )
V_121 = V_24 -> V_67 . V_129 ;
} else if ( ( V_121 -> V_41 == V_130 ) ||
( V_121 -> V_41 == V_131 ) ) {
...
T_5 V_85 ;
int V_119 ;
V_85 = V_164 -> V_168 - V_164 -> V_93 - 1 ;
V_167 = V_166 -> V_169 ;
for ( V_119 = 0 ; V_119 < F_61 ( V_166 -> V_170 ) ; V_119 ++ ) {
V_85 -= ( ( F_61 ( V_167 [ V_119 ] . V_171 . V_172 ) -
F_61 ( V_167 [ V_119 ] . V_171 . V_173 ) + 1 ) ) ;
}
V_164 -> V_85 = V_85 ;
}
...
V_217 = V_20 - V_176 ;
for ( V_119 = 0 ; V_119 < F_61 ( V_166 -> V_170 ) ; ++ V_119 ) {
if ( F_63 ( F_61 ( V_167 [ V_119 ] . V_171 . V_173 ) , V_217 ) &&
F_63 ( V_217 , F_61 ( V_167 [ V_119 ] . V_171 . V_172 ) ) )
goto V_218;
}
return 0 ;
V_218:
...
{
int V_119 ;
for ( V_119 = 0 ; V_119 < V_221 ; V_119 ++ ) {
if ( V_220 [ V_119 ] . V_222 == V_222 )
return V_119 ;
}
return V_119 ;
}
