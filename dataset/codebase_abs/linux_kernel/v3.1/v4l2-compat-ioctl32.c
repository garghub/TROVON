...
static int F_38 ( struct V_116 * V_9 , struct V_117 T_1 * V_11 )
{
if ( ! F_3 ( V_53 , V_11 , sizeof( struct V_117 ) ) ||
F_9 ( V_9 -> type , & V_11 -> type ) ||
F_11 ( & V_11 -> V_118 , & V_9 -> V_118 , sizeof( V_9 -> V_118 ) ) ||
F_9 ( V_9 -> V_119 , & V_11 -> V_119 ) ||
F_9 ( V_9 -> V_94 , & V_11 -> V_94 ) ||
F_39 ( & V_9 -> V_84 , & V_11 -> V_84 ) ||
F_9 ( V_9 -> V_57 , & V_11 -> V_57 ) ||
F_11 ( V_11 -> V_62 , V_9 -> V_62 , 8 * sizeof( V_63 ) ) )
return - V_17 ;
return 0 ;
}
static long F_40 ( struct V_1 * V_1 , unsigned int V_2 , unsigned long V_3 )
{
union {
struct V_32 V_120 ;
struct V_76 V_121 ;
...
long V_131 = 0 ;
switch ( V_2 ) {
case V_132 : V_2 = V_133 ; break;
case V_134 : V_2 = V_135 ; break;
...
case V_169 :
case V_173 :
V_131 = F_5 ( V_129 . V_128 , ( V_174 T_1 * ) V_11 ) ;
V_130 = 0 ;
break;
case V_167 :
case V_171 :
...
case V_135 :
case V_151 :
V_131 = F_20 ( & V_129 . V_120 , V_11 ) ;
V_130 = 0 ;
break;
case V_137 :
case V_143 :
case V_145 :
V_131 = F_27 ( & V_129 . V_121 , V_11 ) ;
V_130 = 0 ;
break;
case V_141 :
V_131 = F_31 ( & V_129 . V_122 , V_11 ) ;
V_130 = 0 ;
break;
case V_139 :
V_130 = 0 ;
break;
case V_147 :
V_131 = F_23 ( & V_129 . V_124 , V_11 ) ;
V_130 = 0 ;
break;
case V_149 :
V_131 = F_33 ( & V_129 . V_123 , V_11 ) ;
V_130 = 0 ;
break;
case V_153 :
case V_155 :
case V_157 :
V_131 = F_36 ( & V_129 . V_125 , V_11 ) ;
V_130 = 0 ;
break;
case V_159 :
V_130 = 0 ;
...
return V_131 ;
if ( V_130 )
V_131 = F_1 ( V_1 , V_2 , ( unsigned long ) V_11 ) ;
else {
T_5 V_175 = F_41 () ;
F_42 ( V_176 ) ;
V_131 = F_1 ( V_1 , V_2 , ( unsigned long ) & V_129 ) ;
F_42 ( V_175 ) ;
}
switch ( V_2 ) {
case V_153 :
...
case V_167 :
case V_171 :
V_131 = F_9 ( ( ( V_174 ) V_129 . V_128 ) , ( V_174 T_1 * ) V_11 ) ;
break;
case V_139 :
V_131 = F_32 ( & V_129 . V_122 , V_11 ) ;
break;
case V_159 :
V_131 = F_38 ( & V_129 . V_126 , V_11 ) ;
break;
case V_133 :
case V_135 :
case V_151 :
V_131 = F_22 ( & V_129 . V_120 , V_11 ) ;
break;
case V_137 :
case V_143 :
case V_145 :
V_131 = F_30 ( & V_129 . V_121 , V_11 ) ;
break;
case V_147 :
V_131 = F_24 ( & V_129 . V_124 , V_11 ) ;
break;
case V_149 :
V_131 = F_34 ( & V_129 . V_123 , V_11 ) ;
break;
}
return V_131 ;
}
long F_43 ( struct V_1 * V_1 , unsigned int V_2 , unsigned long V_3 )
{
long V_4 = - V_5 ;
if ( ! V_1 -> V_6 -> V_7 )
return V_4 ;
...
case V_227 :
case V_228 :
V_4 = F_40 ( V_1 , V_2 , V_3 ) ;
break;
default:
F_21 ( V_229 L_2
L_3 ,
F_44 ( V_2 ) , F_45 ( V_2 ) , F_46 ( V_2 ) , V_2 ) ;
break;
}
return V_4 ;
}
