...
return - V_28 ;
if ( V_112 -> V_114 & V_124 ) {
struct V_125 * V_24 = F_66 ( V_68 ) ;
if ( F_15 ( V_24 -> V_126 . V_127 ) <= 0x0001 )
return - V_28 ;
}
...
for ( V_45 = 0 ; V_45 < V_68 -> V_105 -> V_106 . V_107 ; V_45 ++ ) {
V_103 = & V_68 -> V_105 -> V_108 [ V_45 ] . V_106 ;
if ( ! V_2 -> V_33 && F_68 ( V_103 ) ) {
V_2 -> V_33 = V_103 ;
continue;
}
if ( ! V_2 -> V_88 && F_69 ( V_103 ) ) {
V_2 -> V_88 = V_103 ;
continue;
}
if ( ! V_2 -> V_44 && F_70 ( V_103 ) ) {
V_2 -> V_44 = V_103 ;
continue;
}
}
...
if ( ! V_140 )
F_38 ( V_141 , & V_10 -> V_142 ) ;
if ( V_143 || V_112 -> V_114 & V_144 ) {
if ( ! V_145 )
F_38 ( V_146 , & V_10 -> V_142 ) ;
}
if ( V_112 -> V_114 & V_147 )
V_2 -> V_101 = NULL ;
...
struct V_125 * V_24 = V_2 -> V_24 ;
if ( F_15 ( V_24 -> V_126 . V_127 ) < 0x117 )
F_38 ( V_141 , & V_10 -> V_142 ) ;
}
if ( V_112 -> V_114 & V_123 ) {
struct V_125 * V_24 = V_2 -> V_24 ;
if ( F_15 ( V_24 -> V_126 . V_127 ) > 0x997 )
F_38 ( V_149 , & V_10 -> V_142 ) ;
V_2 -> V_101 = NULL ;
}
if ( V_112 -> V_114 & V_150 ) {
unsigned char V_151 [] = { 0x3b , 0xfc , 0x01 , 0x00 } ;
struct V_62 * V_63 ;
V_63 = F_77 ( sizeof( V_151 ) , V_70 ) ;
if ( V_63 ) {
memcpy ( F_78 ( V_63 , sizeof( V_151 ) ) , V_151 , sizeof( V_151 ) ) ;
F_79 ( & V_10 -> V_152 , V_63 ) ;
}
}
if ( V_2 -> V_101 ) {
V_13 = F_80 ( & V_153 ,
...
F_88 ( & V_153 , V_2 -> V_101 ) ;
F_89 ( V_10 ) ;
F_81 ( V_10 ) ;
}
static int F_90 ( struct V_100 * V_68 , T_2 V_154 )
{
struct V_1 * V_2 = F_85 ( V_68 ) ;
F_6 ( L_14 , V_68 ) ;
if ( V_2 -> V_155 ++ )
