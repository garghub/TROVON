...
static void F_77 ( struct V_1 * V_1 , T_2 V_6 )
{
F_1 ( V_1 , F_52 ( V_6 ) ,
V_104 ) ;
}
static void F_78 ( struct V_1 * V_1 , struct V_89 * V_90 )
{
struct V_5 * V_6 =
...
static void F_79 ( struct V_1 * V_1 , T_4 V_105 )
{
...
static void F_81 ( struct V_1 * V_1 , struct V_89 * V_90 )
{
...
static int F_82 ( struct V_1 * V_1 , struct V_89 * V_90 )
{
T_2 * V_109 = ( T_2 * ) V_90 ;
T_2 V_80 = 0 ;
T_2 V_59 = 0 ;
...
static void F_84 ( struct V_5 * V_6 , T_5 V_124 ,
T_1 V_125 )
{
T_1 V_3 ;
T_1 V_4 ;
...
F_3 ( V_124 , V_6 -> V_1 -> V_4 + F_86 ( V_6 -> V_9 ) ) ;
V_3 = F_87 ( V_125 ) | V_126 |
V_127 | V_128 | V_129 ;
F_3 ( V_3 , V_6 -> V_1 -> V_4 + F_85 ( V_6 -> V_9 ) ) ;
F_3 ( 0x0 , V_6 -> V_1 -> V_4 + F_88 ( V_6 -> V_9 ) ) ;
F_1 ( V_6 -> V_1 , V_130 ,
F_89 ( V_6 -> V_9 ) ) ;
}
...
{
T_5 V_124 ;
V_124 = F_94 ( NULL , V_45 -> V_45 . V_63 , V_45 -> V_45 . V_56 , V_137 ) ;
if ( F_95 ( NULL , V_124 ) ) {
F_50 ( V_66 L_10 ) ;
return;
}
F_96 ( NULL , V_124 , V_45 -> V_45 . V_56 , V_137 ) ;
F_1 ( V_6 -> V_1 , V_54 ,
F_92 ( V_6 -> V_9 ) ) ;
F_84 ( V_6 , V_124 , V_45 -> V_45 . V_56 ) ;
F_90 ( V_6 ) ;
...
static T_6 F_109 ( int V_147 , void * V_148 )
{
...
static int F_116 ( struct V_191 * V_174 ,
int (* F_117)( struct V_192 * ) )
{
...
V_194 = F_118 ( & V_1 -> V_73 . V_198 ) ;
if ( V_194 ) {
F_12 ( L_31 , V_194 ) ;
goto error;
}
V_194 = F_117 ( & V_1 -> V_73 ) ;
if ( V_194 ) {
F_12 ( L_32 , V_194 ) ;
F_119 ( & V_1 -> V_73 . V_198 ) ;
goto error;
}
return 0 ;
error:
...
static int F_120 ( struct V_191 * V_174 )
{
struct V_1 * V_1 = V_193 ;
...
static int F_121 ( struct V_192 * V_200 , int V_201 )
{
return 0 ;
}
static int T_7 F_122 ( struct V_202 * V_203 )
{
struct V_1 * V_1 = F_123 ( & V_203 -> V_198 ) ;
F_124 ( & V_1 -> V_73 ) ;
F_125 ( V_1 -> V_4 ) ;
F_126 ( F_127 ( V_203 , 0 ) , V_1 ) ;
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_101 ) ;
F_43 ( V_1 ) ;
return 0 ;
}
static int T_8 F_128 ( struct V_202 * V_203 )
{
...
int V_80 = 0 ;
int V_59 ;
V_205 = F_129 ( V_203 , V_208 , 0 ) ;
if ( ! V_205 ) {
V_80 = - V_195 ;
F_12 ( L_33 ) ;
goto V_209;
}
V_206 = F_129 ( V_203 , V_210 , 0 ) ;
if ( ! V_206 ) {
V_80 = - V_195 ;
F_130 ( & V_203 -> V_198 ,
L_34 ) ;
...
V_4 = F_131 ( V_205 -> V_211 , F_132 ( V_205 ) ) ;
if ( V_4 == NULL ) {
V_80 = - V_212 ;
F_12 ( L_36 ) ;
goto V_209;
...
F_133 ( & V_1 -> V_49 ) ;
F_134 ( & V_203 -> V_198 , V_1 ) ;
V_1 -> V_73 . V_213 = & V_214 ;
F_135 ( & V_1 -> V_73 . V_198 ) ;
F_136 ( & V_1 -> V_73 . V_198 , L_39 ) ;
V_1 -> V_73 . V_215 = 1 ;
...
V_1 -> V_4 = V_4 ;
V_80 = F_137 ( V_206 -> V_211 , F_109 , V_221 | V_222 ,
V_220 , V_1 ) ;
if ( V_80 < 0 ) {
F_12 ( L_40 , V_80 ) ;
goto V_209;
}
V_80 = F_137 ( V_207 -> V_211 , F_109 ,
...
goto V_228;
F_115 ( V_1 ) ;
V_80 = F_138 ( & V_203 -> V_198 , & V_1 -> V_73 ) ;
if ( V_80 )
goto V_229;
F_139 ( & V_203 -> V_198 , L_42 , V_230 ) ;
return 0 ;
V_229:
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_101 ) ;
V_228:
F_126 ( V_206 -> V_211 , V_1 ) ;
V_209:
if ( V_1 ) {
if ( V_1 -> V_101 )
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 ,
