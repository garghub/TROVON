...
static int F_54 ( struct V_101 * V_17 )
{
struct V_12 * V_13 ;
struct V_102 * V_103 ;
struct V_104 * V_105 = V_17 -> V_17 . V_106 ;
const struct V_107 * V_108 = F_55 ( V_17 ) ;
enum V_109 V_110 = V_108 -> V_111 ;
int V_59 ;
int V_112 ;
V_103 = F_56 ( V_17 , V_113 , 0 ) ;
V_112 = F_57 ( V_17 , 0 ) ;
if ( V_103 == NULL || V_112 < 0 )
return - V_114 ;
if ( ! F_58 ( V_103 -> V_115 , F_59 ( V_103 ) , V_103 -> V_116 ) )
return - V_117 ;
V_13 = F_60 ( sizeof( struct V_12 ) , V_118 ) ;
if ( ! V_13 ) {
V_59 = - V_117 ;
goto V_119;
}
V_13 -> V_16 . V_120 = V_121 ;
V_13 -> V_16 . V_80 = 5 ;
F_61 ( & V_13 -> V_75 ) ;
F_62 ( & V_13 -> V_76 ) ;
V_13 -> V_16 . V_122 = V_17 -> V_108 ;
snprintf ( V_13 -> V_16 . V_116 , sizeof( V_13 -> V_16 . V_116 ) , L_36 ,
V_13 -> V_16 . V_122 ) ;
V_13 -> V_123 = F_63 ( & V_17 -> V_17 , NULL ) ;
if ( F_64 ( V_13 -> V_123 ) ) {
V_59 = F_65 ( V_13 -> V_123 ) ;
goto V_124;
}
V_13 -> V_125 = F_66 ( V_103 -> V_115 , F_59 ( V_103 ) ) ;
if ( ! V_13 -> V_125 ) {
V_59 = - V_126 ;
goto V_127;
}
V_13 -> V_128 = V_13 -> V_125 + V_129 [ V_110 ] . V_130 ;
V_13 -> V_131 = V_13 -> V_125 + V_129 [ V_110 ] . V_132 ;
V_13 -> V_133 = V_13 -> V_125 + V_129 [ V_110 ] . V_29 ;
V_13 -> V_134 = V_13 -> V_125 + V_129 [ V_110 ] . V_57 ;
if ( V_110 != V_135 )
V_13 -> V_48 = V_13 -> V_125 + V_129 [ V_110 ] . V_136 ;
V_13 -> V_137 = V_103 -> V_115 ;
V_13 -> V_138 = F_59 ( V_103 ) ;
V_13 -> V_112 = V_112 ;
V_13 -> V_49 = V_139 ;
#ifdef F_30
if ( V_105 ) {
V_13 -> V_49 = V_105 -> V_49 ;
V_13 -> V_60 = V_105 -> V_60 ;
}
#endif
F_67 ( V_13 -> V_123 ) ;
if ( V_105 ) {
V_13 -> V_16 . V_140 = V_105 -> V_140 ;
V_13 -> V_82 = V_105 -> V_82 ;
V_13 -> V_51 = V_105 -> V_51 ;
}
if ( V_13 -> V_82 ) {
V_13 -> V_16 . V_141 = & V_142 ;
} else {
V_13 -> V_16 . V_141 = & V_143 ;
V_59 = F_68 ( V_112 , F_43 , V_144 ,
V_13 -> V_16 . V_116 , V_13 ) ;
if ( V_59 )
goto V_145;
}
F_27 ( V_13 ) ;
V_13 -> V_16 . V_79 = V_13 ;
V_13 -> V_16 . V_17 . V_146 = & V_17 -> V_17 ;
#ifdef F_69
V_13 -> V_16 . V_17 . V_147 = V_17 -> V_17 . V_147 ;
#endif
V_59 = F_70 ( & V_13 -> V_16 ) ;
if ( V_59 < 0 ) {
F_2 ( V_148 L_37 ) ;
...
F_78 ( V_13 ) ;
V_119:
F_79 ( V_103 -> V_115 , F_59 ( V_103 ) ) ;
return V_59 ;
}
static int T_3 F_80 ( struct V_101 * V_17 )
{
struct V_12 * V_13 = F_81 ( V_17 ) ;
F_72 ( V_17 , NULL ) ;
F_82 ( & V_13 -> V_16 ) ;
if ( ! V_13 -> V_82 )
F_74 ( V_13 -> V_112 , V_13 ) ;
F_75 ( V_13 -> V_123 ) ;
F_77 ( V_13 -> V_123 ) ;
F_76 ( V_13 -> V_125 ) ;
F_79 ( V_13 -> V_137 , V_13 -> V_138 ) ;
F_78 ( V_13 ) ;
return 0 ;
}
static int F_83 ( struct V_150 * V_17 )
{
struct V_101 * V_151 = F_84 ( V_17 ) ;
struct V_12 * V_13 = F_81 ( V_151 ) ;
F_75 ( V_13 -> V_123 ) ;
return 0 ;
}
static int F_85 ( struct V_150 * V_17 )
{
struct V_101 * V_151 = F_84 ( V_17 ) ;
struct V_12 * V_13 = F_81 ( V_151 ) ;
F_67 ( V_13 -> V_123 ) ;
