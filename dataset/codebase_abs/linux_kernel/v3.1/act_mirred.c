...
V_58 = F_25 ( V_54 -> V_70 ) ;
V_57 = F_26 ( V_54 , V_71 , V_2 -> V_46 ) ;
if ( V_57 == NULL )
goto V_66;
if ( ! ( V_58 & V_72 ) ) {
if ( V_2 -> V_50 )
F_27 ( V_57 , V_57 -> V_23 -> V_73 ) ;
}
if ( V_2 -> V_48 != V_30 )
V_57 -> V_70 = F_28 ( V_57 -> V_70 , V_58 ) ;
...
static int F_31 ( struct V_53 * V_54 , struct V_13 * V_14 , int V_3 , int V_78 )
{
unsigned char * V_79 = F_32 ( V_54 ) ;
struct V_1 * V_2 = V_14 -> V_52 ;
struct V_18 V_80 = {
. V_41 = V_2 -> V_81 ,
. V_47 = V_2 -> V_46 ,
...
struct V_84 V_85 ;
F_33 ( V_54 , V_28 , sizeof( V_80 ) , & V_80 ) ;
V_85 . V_86 = F_34 ( V_63 - V_2 -> V_61 . V_86 ) ;
V_85 . V_62 = F_34 ( V_63 - V_2 -> V_61 . V_62 ) ;
V_85 . V_87 = F_34 ( V_2 -> V_61 . V_87 ) ;
F_33 ( V_54 , V_88 , sizeof( V_85 ) , & V_85 ) ;
return V_54 -> V_89 ;
V_90:
F_35 ( V_54 , V_79 ) ;
return - 1 ;
