...
static void F_54 ( struct V_14 * V_15 , unsigned int V_61 )
{
const struct V_26 * V_27 = V_15 -> V_17 ;
struct V_47 * V_48 ;
...
F_51 ( V_15 , V_82 ) ;
V_48 = F_49 ( V_15 ) ;
if ( F_46 ( V_86 , & V_15 -> V_37 ) &&
V_82 != V_29 && V_15 -> V_80 == V_29 )
V_15 -> V_74 = V_29 ;
if ( F_56 ( V_82 != V_15 -> V_74 ) ) {
if ( V_48 && ! F_46 ( V_86 , & V_15 -> V_37 ) ) {
if ( V_61 & V_87 ) {
if ( ( V_48 -> V_54 & V_88 ) == 0 )
F_57 ( & V_48 -> V_51 , & V_15 -> V_30 ) ;
V_48 = F_49 ( V_15 ) ;
V_15 -> V_74 = V_48 -> V_52 ;
goto V_89;
}
...
break;
default:
F_59 ( V_91 L_1 , V_15 -> V_74 , V_82 ) ;
F_15 ( V_15 , 1 ) ;
}
F_25 ( & V_15 -> V_85 ) ;
return;
}
if ( F_60 ( V_86 , & V_15 -> V_37 ) )
F_53 ( V_15 ) ;
if ( V_82 != V_29 ) {
if ( V_27 -> V_92 ) {
F_25 ( & V_15 -> V_85 ) ;
...
static void F_58 ( struct V_14 * V_15 , struct V_47 * V_48 , unsigned int V_95 )
__releases( &gl->gl_spin
static inline struct V_47 * F_61 ( const struct V_14 * V_15 )
{
struct V_47 * V_48 ;
if ( ! F_19 ( & V_15 -> V_30 ) ) {
...
static void F_62 ( struct V_14 * V_15 , const int V_96 )
__releases( &gl->gl_spin
...
V_101 = V_15 -> V_104 ;
if ( V_101 )
V_102 = F_64 ( V_2 -> V_105 , V_103 , 1 ) ;
else
V_102 = F_65 ( V_2 , V_103 , NULL , V_106 ) ;
if ( V_102 && ! F_66 ( V_102 ) ) {
F_67 ( V_102 ) ;
F_68 ( V_102 ) ;
}
...
int V_109 = 0 ;
if ( F_60 ( V_110 , & V_15 -> V_37 ) ) {
F_54 ( V_15 , V_15 -> V_111 ) ;
V_109 = 1 ;
}
F_21 ( & V_15 -> V_85 ) ;
if ( F_46 ( V_112 , & V_15 -> V_37 ) &&
V_15 -> V_28 != V_29 &&
V_15 -> V_80 != V_53 ) {
...
V_107 = 0 ;
if ( F_71 ( V_116 , & V_15 -> V_108 , V_107 ) == 0 )
F_31 ( V_15 ) ;
}
if ( V_109 )
F_31 ( V_15 ) ;
}
int F_72 ( struct V_1 * V_2 , V_7 V_117 ,
...
F_80 ( & V_15 -> V_40 , & V_11 [ V_10 ] ) ;
F_5 ( V_10 ) ;
}
* V_119 = V_15 ;
return 0 ;
}
void F_81 ( struct V_14 * V_15 , unsigned int V_82 , unsigned V_140 ,
struct V_47 * V_48 )
{
F_82 ( & V_48 -> V_51 ) ;
V_48 -> V_146 = V_15 ;
V_48 -> V_147 = ( unsigned long ) F_83 ( 0 ) ;
V_48 -> V_148 = F_84 ( F_85 ( V_149 ) ) ;
V_48 -> V_52 = V_82 ;
V_48 -> V_54 = V_140 ;
V_48 -> V_65 = 0 ;
V_48 -> V_60 = 0 ;
...
void F_86 ( unsigned int V_82 , unsigned V_140 , struct V_47 * V_48 )
{
V_48 -> V_52 = V_82 ;
V_48 -> V_54 = V_140 ;
V_48 -> V_60 = 0 ;
...
F_93 () ;
F_94 ( & V_48 -> V_60 , V_59 , F_89 , V_152 ) ;
if ( F_95 ( V_79 , V_151 + V_153 ) )
V_48 -> V_146 -> V_75 = F_96 ( V_48 -> V_146 -> V_75 +
V_154 ,
V_155 ) ;
}
...
{
F_93 () ;
F_94 ( & V_15 -> V_37 , V_81 , F_91 , V_152 ) ;
}
static void F_98 ( struct V_14 * V_15 , unsigned int V_82 ,
unsigned long V_107 )
{
...
int F_100 ( struct V_47 * V_48 )
{
F_92 ( V_48 ) ;
return V_48 -> V_65 ;
}
void F_101 ( struct V_159 * V_160 , const char * V_161 , ... )
{
struct V_162 V_163 ;
T_1 args ;
va_start ( args , V_161 ) ;
...
__releases( &gl->gl_spin
int F_104 ( struct V_47 * V_48 )
{
struct V_14 * V_15 = V_48 -> V_146 ;
struct V_1 * V_2 = V_15 -> V_22 ;
int error = 0 ;
if ( F_56 ( F_46 ( V_168 , & V_2 -> V_169 ) ) )
return - V_66 ;
...
if ( F_61 ( V_15 ) == NULL ) {
if ( V_27 -> V_175 ) {
F_15 ( V_15 , F_107 ( V_94 , & V_15 -> V_37 ) ) ;
F_25 ( & V_15 -> V_85 ) ;
V_27 -> V_175 ( V_48 ) ;
F_21 ( & V_15 -> V_85 ) ;
F_28 ( V_94 , & V_15 -> V_37 ) ;
...
if ( F_19 ( & V_15 -> V_30 ) &&
! F_46 ( V_112 , & V_15 -> V_37 ) &&
! F_46 ( V_81 , & V_15 -> V_37 ) )
V_173 = 1 ;
}
if ( ! F_46 ( V_176 , & V_15 -> V_37 ) )
F_29 ( V_15 ) ;
F_47 ( V_48 , 0 ) ;
F_25 ( & V_15 -> V_85 ) ;
if ( F_108 ( V_173 ) )
...
void F_110 ( struct V_47 * V_48 )
{
F_106 ( V_48 ) ;
F_88 ( V_48 ) ;
}
int F_111 ( struct V_1 * V_2 , V_7 V_117 ,
const struct V_26 * V_27 ,
unsigned int V_82 , int V_140 , struct V_47 * V_48 )
{
struct V_14 * V_15 ;
int error ;
error = F_72 ( V_2 , V_117 , V_27 , V_177 , & V_15 ) ;
if ( ! error ) {
error = F_112 ( V_15 , V_82 , V_140 , V_48 ) ;
F_31 ( V_15 ) ;
}
return error ;
}
static int F_113 ( const void * V_178 , const void * V_179 )
{
...
if ( V_182 -> V_6 < V_183 -> V_6 )
return - 1 ;
F_114 ( V_180 -> V_146 -> V_17 -> V_122 == V_181 -> V_146 -> V_17 -> V_122 ) ;
return 0 ;
}
static int F_115 ( unsigned int V_184 , struct V_47 * V_185 ,
struct V_47 * * V_186 )
{
unsigned int V_187 ;
int error = 0 ;
...
F_116 ( V_186 , V_184 , sizeof( struct V_47 * ) , F_113 , NULL ) ;
for ( V_187 = 0 ; V_187 < V_184 ; V_187 ++ ) {
V_186 [ V_187 ] -> V_54 &= ~ ( V_67 | V_172 ) ;
error = F_104 ( V_186 [ V_187 ] ) ;
if ( error ) {
while ( V_187 -- )
F_106 ( V_186 [ V_187 ] ) ;
break;
...
int F_117 ( unsigned int V_184 , struct V_47 * V_185 )
{
struct V_47 * V_62 [ 4 ] ;
...
if ( V_184 <= 4 )
break;
V_188 = F_118 ( V_184 * sizeof( struct V_47 * ) , V_141 ) ;
if ( ! V_188 )
return - V_127 ;
}
error = F_115 ( V_184 , V_185 , V_188 ) ;
if ( V_188 != V_62 )
F_119 ( V_188 ) ;
return error ;
}
void F_120 ( unsigned int V_184 , struct V_47 * V_185 )
{
while ( V_184 -- )
F_106 ( & V_185 [ V_184 ] ) ;
}
void F_121 ( unsigned int V_184 , struct V_47 * V_185 )
{
while ( V_184 -- )
F_110 ( & V_185 [ V_184 ] ) ;
}
void F_122 ( struct V_14 * V_15 , unsigned int V_82 )
{
unsigned long V_107 = 0 ;
unsigned long V_113 ;
...
if ( F_70 ( V_114 , V_113 ) )
V_107 = V_113 - V_114 ;
if ( F_46 ( V_110 , & V_15 -> V_37 ) )
V_107 = V_15 -> V_75 ;
}
F_21 ( & V_15 -> V_85 ) ;
F_98 ( V_15 , V_82 , V_107 ) ;
F_25 ( & V_15 -> V_85 ) ;
if ( F_71 ( V_116 , & V_15 -> V_108 , V_107 ) == 0 )
F_31 ( V_15 ) ;
}
...
void F_124 ( struct V_14 * V_15 , int V_61 )
{
struct V_189 * V_190 = & V_15 -> V_22 -> V_42 ;
F_21 ( & V_15 -> V_85 ) ;
V_15 -> V_111 = V_61 ;
if ( F_56 ( F_46 ( V_191 , & V_190 -> V_192 ) ) ) {
if ( F_123 ( V_15 ) ) {
...
F_125 () ;
F_14 ( V_15 ) ;
if ( F_71 ( V_116 , & V_15 -> V_108 , 0 ) == 0 )
F_31 ( V_15 ) ;
}
static int F_126 ( struct V_193 * V_194 ,
struct V_195 * V_196 )
{
struct V_14 * V_15 ;
int V_197 ;
...
static void F_131 ( T_3 V_205 , const struct V_1 * V_2 ,
unsigned int V_10 )
{
struct V_14 * V_15 ;
...
F_131 ( V_205 , V_2 , V_187 ) ;
}
static void F_134 ( struct V_14 * V_15 )
{
if ( ! F_60 ( V_171 , & V_15 -> V_37 ) )
return;
F_24 ( V_110 , & V_15 -> V_37 ) ;
F_14 ( V_15 ) ;
if ( F_71 ( V_116 , & V_15 -> V_108 , 0 ) == 0 )
...
static int F_137 ( struct V_159 * V_160 , struct V_14 * V_15 )
{
int V_61 ;
F_21 ( & V_15 -> V_85 ) ;
V_61 = F_138 ( V_160 , V_15 ) ;
F_25 ( & V_15 -> V_85 ) ;
return V_61 ;
}
...
F_133 ( F_135 , V_2 ) ;
F_141 ( V_116 ) ;
F_142 ( V_2 -> V_24 , F_16 ( & V_2 -> V_23 ) == 0 ) ;
F_133 ( F_139 , V_2 ) ;
}
void F_143 ( struct V_100 * V_101 )
{
struct V_14 * V_15 = V_101 -> V_210 ;
int V_61 ;
V_61 = F_144 ( V_101 ) ;
F_145 ( V_15 -> V_22 , V_61 == 0 ) ;
F_21 ( & V_15 -> V_85 ) ;
F_28 ( V_94 , & V_15 -> V_37 ) ;
F_62 ( V_15 , 1 ) ;
F_25 ( & V_15 -> V_85 ) ;
}
static const char * F_146 ( unsigned V_82 )
{
switch( V_82 ) {
case V_29 :
return L_4 ;
...
static const char * F_147 ( char * V_211 , unsigned V_140 , unsigned long V_212 )
{
char * V_186 = V_211 ;
if ( V_140 & V_67 )
* V_186 ++ = 't' ;
...
static int F_148 ( struct V_159 * V_160 , const struct V_47 * V_48 )
{
struct V_214 * V_215 = NULL ;
char V_216 [ 32 ] ;
if ( V_48 -> V_148 )
V_215 = F_149 ( V_48 -> V_148 , V_217 ) ;
F_101 ( V_160 , L_9 ,
F_146 ( V_48 -> V_52 ) ,
F_147 ( V_216 , V_48 -> V_54 , V_48 -> V_60 ) ,
V_48 -> V_65 ,
V_48 -> V_148 ? ( long ) F_150 ( V_48 -> V_148 ) : - 1 ,
V_215 ? V_215 -> V_218 : L_10 ,
( void * ) V_48 -> V_147 ) ;
return 0 ;
}
static const char * F_151 ( char * V_211 , const struct V_14 * V_15 )
{
...
static int F_138 ( struct V_159 * V_160 , const struct V_14 * V_15 )
{
const struct V_26 * V_27 = V_15 -> V_17 ;
...
F_151 ( V_224 , V_15 ) ,
F_146 ( V_15 -> V_74 ) ,
F_146 ( V_15 -> V_80 ) , V_223 ,
F_16 ( & V_15 -> V_225 ) ,
F_16 ( & V_15 -> V_226 ) ,
F_16 ( & V_15 -> V_25 ) , V_15 -> V_75 ) ;
F_50 (gh, &gl->gl_holders, gh_list) {
error = F_148 ( V_160 , V_48 ) ;
if ( error )
goto V_90;
}
...
static inline struct V_14 * F_160 ( unsigned V_10 )
{
return F_161 ( F_162 ( & V_11 [ V_10 ] ) ,
struct V_14 , V_40 ) ;
}
static inline struct V_14 * F_163 ( struct V_14 * V_15 )
{
return F_161 ( F_164 ( V_15 -> V_40 . V_50 ) ,
struct V_14 , V_40 ) ;
}
static int F_165 ( struct V_164 * V_165 )
{
struct V_14 * V_15 ;
do {
V_15 = V_165 -> V_15 ;
if ( V_15 ) {
V_165 -> V_15 = F_163 ( V_15 ) ;
} else {
V_165 -> V_15 = F_160 ( V_165 -> V_10 ) ;
}
...
static void * F_166 ( struct V_159 * V_160 , T_5 * V_208 )
{
struct V_164 * V_165 = V_160 -> V_166 ;
T_5 V_234 = * V_208 ;
V_165 -> V_10 = 0 ;
...
static void * F_167 ( struct V_159 * V_160 , void * V_235 ,
T_5 * V_208 )
{
struct V_164 * V_165 = V_160 -> V_166 ;
( * V_208 ) ++ ;
...
static void F_168 ( struct V_159 * V_160 , void * V_235 )
{
struct V_164 * V_165 = V_160 -> V_166 ;
if ( V_165 -> V_15 )
F_74 () ;
...
static int F_169 ( struct V_159 * V_160 , void * V_235 )
{
return F_137 ( V_160 , V_235 ) ;
}
static int F_170 ( struct V_102 * V_102 , struct V_236 * V_236 )
{
int V_61 = F_171 ( V_236 , & V_237 ,
sizeof( struct V_164 ) ) ;
if ( V_61 == 0 ) {
...
{
V_2 -> V_240 = F_173 ( V_2 -> V_241 , V_242 ) ;
if ( ! V_2 -> V_240 )
return - V_127 ;
V_2 -> V_243 = F_174 ( L_14 ,
V_244 | V_245 ,
V_2 -> V_240 , V_2 ,
& V_246 ) ;
if ( ! V_2 -> V_243 )
