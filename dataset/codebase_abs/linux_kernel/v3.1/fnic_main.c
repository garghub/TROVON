...
static int T_3 F_54 ( struct V_96 * V_97 ,
...
for ( V_57 = 0 ; V_57 < V_14 -> V_63 ; V_57 ++ ) {
V_70 = F_83 ( & V_14 -> V_64 [ V_57 ] , V_165 ) ;
if ( V_70 ) {
F_21 ( V_62 , V_14 -> V_32 -> V_19 ,
L_32
L_33 ) ;
...
V_70 = F_84 ( V_13 -> V_19 , & V_97 -> V_167 ) ;
if ( V_70 ) {
F_21 ( V_62 , V_14 -> V_32 -> V_19 ,
L_34 ) ;
goto V_166;
...
V_13 -> V_168 = 0 ;
V_13 -> V_169 = V_14 -> V_126 . V_170 ;
V_13 -> V_171 = V_14 -> V_126 . V_172 ;
V_13 -> V_173 = ( V_174 | V_175 |
V_176 ) ;
if ( V_14 -> V_126 . V_25 & V_177 )
V_13 -> V_173 |= V_178 ;
V_13 -> V_52 = V_26 ;
V_13 -> V_179 = V_14 -> V_126 . V_180 ;
V_13 -> V_181 = V_14 -> V_126 . V_182 ;
V_13 -> V_183 = V_17 ;
F_85 ( V_13 , V_14 -> V_126 . V_184 ) ;
F_86 ( V_13 , V_14 -> V_126 . V_185 ) ;
F_87 ( V_13 , & V_14 -> V_104 , & V_186 , 0 ) ;
if ( ! F_88 ( V_13 , V_187 , V_188 ,
V_189 , NULL ) ) {
V_70 = - V_102 ;
goto V_190;
}
F_89 ( V_13 ) ;
F_90 ( V_13 ) ;
if ( F_91 ( V_13 , V_14 -> V_126 . V_191 +
sizeof( struct V_192 ) ) ) {
V_70 = - V_193 ;
goto V_194;
}
F_92 ( V_13 -> V_19 ) = V_13 -> V_195 ;
F_93 ( V_13 -> V_19 ) = V_14 -> V_126 . V_196 / 1000 ;
sprintf ( F_94 ( V_13 -> V_19 ) ,
V_106 L_35 V_197 L_36 , V_14 -> V_105 ) ;
F_14 ( & V_198 , V_25 ) ;
F_95 ( & V_14 -> V_199 , & V_200 ) ;
F_16 ( & V_198 , V_25 ) ;
F_96 ( & V_14 -> V_69 , V_201 ) ;
...
static void T_5 F_116 ( struct V_96 * V_97 )
{
struct V_14 * V_14 = F_117 ( V_97 ) ;
...
F_123 ( V_13 ) ;
F_36 ( V_14 ) ;
F_124 ( ! F_125 ( & V_14 -> V_204 ) ) ;
F_124 ( ! F_125 ( & V_14 -> V_205 ) ) ;
F_14 ( & V_198 , V_25 ) ;
F_126 ( & V_14 -> V_199 ) ;
F_16 ( & V_198 , V_25 ) ;
F_106 ( V_14 -> V_32 -> V_19 ) ;
...
V_117 = sizeof( struct V_207 ) ;
V_145 [ V_146 ] = F_129
( L_39 , V_117 + V_208 , V_208 ,
V_209 ,
NULL ) ;
if ( ! V_145 [ V_146 ] ) {
F_56 (KERN_ERR PFX L_40 ) ;
V_70 = - V_102 ;
goto V_210;
}
V_117 = sizeof( struct V_211 ) ;
V_145 [ V_148 ] = F_129
( L_41 , V_117 + V_208 , V_208 ,
V_209 ,
NULL ) ;
if ( ! V_145 [ V_148 ] ) {
