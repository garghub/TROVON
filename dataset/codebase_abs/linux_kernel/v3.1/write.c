...
{
F_91 ( V_20 -> V_80 ) ;
F_92 ( V_20 -> V_80 -> V_23 -> V_24 , V_85 ) ;
}
static void
F_93 ( struct V_19 * V_20 , struct V_86 * V_13 )
{
struct V_22 * V_22 = V_20 -> V_82 -> V_83 -> V_84 ;
struct V_73 * V_74 = F_70 ( V_22 ) ;
F_22 ( & V_22 -> V_25 ) ;
...
return 0 ;
F_22 ( & V_22 -> V_25 ) ;
V_45 = F_106 ( V_74 , V_98 , V_99 , V_10 , V_87 ) ;
if ( V_45 > 0 )
V_74 -> V_88 -= V_45 ;
F_23 ( & V_22 -> V_25 ) ;
if ( F_103 ( F_70 ( V_22 ) ) )
...
F_145 ( V_20 ) ;
if ( ( V_169 -> V_175 & V_44 ) &&
( V_169 -> V_176 || F_70 ( V_169 -> V_177 ) -> V_88 ||
V_169 -> V_178 > V_171 ) )
V_169 -> V_175 &= ~ V_44 ;
V_26 = 0 ;
V_173 = V_169 -> V_178 ;
...
int F_154 ( struct V_55 * V_169 , struct V_97 * V_165 )
{
if ( V_169 -> V_172 < V_187 )
return F_143 ( V_169 , V_165 ) ;
return F_150 ( V_169 , V_165 ) ;
}
static int F_155 ( struct V_55 * V_169 )
{
F_156 ( V_165 ) ;
int V_45 ;
V_45 = F_154 ( V_169 , & V_165 ) ;
if ( V_45 == 0 )
...
{
F_158 ( V_56 , V_22 , & V_189 ,
F_38 ( V_22 ) -> V_171 , V_188 ) ;
}
void F_159 ( struct V_55 * V_56 )
{
V_56 -> V_190 = & V_189 ;
...
struct V_22 * V_22 , int V_188 )
{
if ( ! F_160 ( V_56 , V_22 , V_188 ) )
F_157 ( V_56 , V_22 , V_188 ) ;
}
static void F_161 ( struct V_136 * V_137 , void * V_191 )
{
...
void F_166 ( struct V_136 * V_137 , void * V_191 )
{
struct V_1 * V_65 = V_191 ;
if ( F_167 ( F_38 ( V_65 -> V_22 ) ,
& V_65 -> args . V_193 ,
& V_65 -> V_142 . V_194 , 1 , V_137 ) )
return;
F_168 ( V_137 ) ;
}
static void F_169 ( struct V_136 * V_137 , void * V_191 )
{
struct V_1 * V_65 = V_191 ;
F_162 ( V_137 , V_65 ) ;
}
static void F_170 ( void * V_191 )
{
struct V_1 * V_65 = V_191 ;
int V_109 = V_65 -> V_137 . V_157 ;
...
void F_162 ( struct V_136 * V_137 , struct V_1 * V_65 )
{
...
static int F_176 ( struct V_73 * V_74 , int V_212 )
{
int V_45 ;
if ( ! F_164 ( V_213 , & V_74 -> V_18 ) )
return 1 ;
if ( ! V_212 )
return 0 ;
V_45 = F_177 ( & V_74 -> V_18 ,
V_213 ,
V_69 ,
V_70 ) ;
return ( V_45 < 0 ) ? V_45 : 1 ;
}
void F_178 ( struct V_73 * V_74 )
{
F_88 ( V_213 , & V_74 -> V_18 ) ;
F_74 () ;
F_75 ( & V_74 -> V_18 , V_213 ) ;
}
void F_179 ( void * V_65 )
{
...
int F_180 ( struct V_1 * V_65 , struct V_131 * V_132 ,
const struct V_133 * V_134 ,
int V_127 )
{
struct V_136 * V_137 ;
...
F_126 ( V_65 -> V_22 ) -> F_181 ( V_65 , & V_139 ) ;
...
void F_182 ( struct V_1 * V_65 ,
struct V_97 * V_165 ,
struct V_86 * V_13 )
{
struct V_19 * V_214 = F_144 ( V_165 -> V_167 ) ;
struct V_22 * V_22 = V_214 -> V_82 -> V_83 -> V_84 ;
F_183 ( V_165 , & V_65 -> V_5 ) ;
V_65 -> V_22 = V_22 ;
V_65 -> V_144 = V_214 -> V_82 -> V_144 ;
V_65 -> V_13 = V_13 ;
V_65 -> V_215 = & V_216 ;
V_65 -> args . V_158 = F_133 ( V_65 -> V_22 ) ;
V_65 -> args . V_26 = 0 ;
V_65 -> args . V_27 = 0 ;
V_65 -> args . V_14 = F_135 ( V_214 -> V_82 ) ;
V_65 -> V_142 . V_27 = 0 ;
V_65 -> V_142 . V_164 = & V_65 -> V_164 ;
V_65 -> V_142 . V_91 = & V_65 -> V_91 ;
F_136 ( & V_65 -> V_164 ) ;
}
void F_184 ( struct V_97 * V_217 ,
struct V_86 * V_13 )
{
struct V_19 * V_20 ;
while ( ! F_140 ( V_217 ) ) {
V_20 = F_144 ( V_217 -> V_167 ) ;
F_145 ( V_20 ) ;
F_93 ( V_20 , V_13 ) ;
F_99 ( V_20 -> V_80 , V_89 ) ;
...
static int
F_185 ( struct V_22 * V_22 , struct V_97 * V_165 , int V_127 )
{
struct V_1 * V_65 ;
V_65 = F_1 () ;
if ( ! V_65 )
goto V_180;
F_182 ( V_65 , V_165 , NULL ) ;
return F_180 ( V_65 , F_138 ( V_22 ) , V_65 -> V_215 , V_127 ) ;
V_180:
F_184 ( V_165 , NULL ) ;
F_178 ( F_70 ( V_22 ) ) ;
return - V_184 ;
}
static void F_186 ( struct V_136 * V_137 , void * V_191 )
{
struct V_1 * V_65 = V_191 ;
F_119 ( L_17 ,
V_137 -> V_153 , V_137 -> V_157 ) ;
F_126 ( V_65 -> V_22 ) -> F_187 ( V_137 , V_65 ) ;
}
void F_188 ( struct V_1 * V_65 )
{
struct V_19 * V_20 ;
int V_109 = V_65 -> V_137 . V_157 ;
while ( ! F_140 ( & V_65 -> V_5 ) ) {
...
if ( ! memcmp ( V_20 -> V_192 . V_219 , V_65 -> V_91 . V_219 , sizeof( V_65 -> V_91 . V_219 ) ) ) {
F_85 ( V_20 ) ;
F_119 ( L_9 ) ;
goto V_167;
}
...
static void F_189 ( void * V_191 )
{
struct V_1 * V_65 = V_191 ;
F_188 ( V_65 ) ;
F_178 ( F_70 ( V_65 -> V_22 ) ) ;
F_179 ( V_191 ) ;
}
int F_190 ( struct V_22 * V_22 , int V_127 )
{
F_156 ( V_165 ) ;
int V_212 = V_127 & V_156 ;
int V_142 ;
V_142 = F_176 ( F_70 ( V_22 ) , V_212 ) ;
if ( V_142 <= 0 )
goto V_220;
V_142 = F_105 ( V_22 , & V_165 , 0 , 0 ) ;
if ( V_142 ) {
int error ;
error = F_191 ( V_22 , & V_165 , V_127 ) ;
if ( error == V_221 )
error = F_185 ( V_22 , & V_165 , V_127 ) ;
if ( error < 0 )
return error ;
if ( ! V_212 )
goto V_220;
error = F_192 ( & F_70 ( V_22 ) -> V_18 ,
V_213 ,
V_69 ,
V_70 ) ;
if ( error < 0 )
...
static int F_193 ( struct V_22 * V_22 , struct V_36 * V_37 )
{
struct V_73 * V_74 = F_70 ( V_22 ) ;
int V_18 = V_156 ;
int V_45 = 0 ;
if ( V_37 -> V_62 == V_63 ) {
if ( V_74 -> V_88 <= ( V_74 -> V_10 >> 1 ) )
goto V_220;
V_18 = 0 ;
}
V_45 = F_190 ( V_22 , V_18 ) ;
if ( V_45 >= 0 ) {
if ( V_37 -> V_62 == V_63 ) {
if ( V_45 < V_37 -> V_222 )
V_37 -> V_222 -= V_45 ;
...
int F_194 ( struct V_22 * V_22 , struct V_36 * V_37 )
{
int V_45 ;
V_45 = F_193 ( V_22 , V_37 ) ;
if ( V_45 >= 0 && F_56 ( V_223 , & F_70 ( V_22 ) -> V_18 ) ) {
int V_109 ;
bool V_224 = true ;
if ( V_37 -> V_62 == V_63 )
V_224 = false ;
V_109 = F_195 ( V_22 , V_224 ) ;
if ( V_109 < 0 )
return V_109 ;
}
return V_45 ;
}
int F_196 ( struct V_22 * V_22 )
{
struct V_36 V_37 = {
. V_62 = V_225 ,
. V_222 = V_226 ,
...
return F_197 ( V_22 , & V_37 ) ;
}
int F_198 ( struct V_22 * V_22 , struct V_11 * V_11 )
{
struct V_19 * V_20 ;
int V_45 = 0 ;
F_55 ( ! F_199 ( V_11 ) ) ;
...
int F_204 ( struct V_66 * V_23 , struct V_11 * V_231 ,
struct V_11 * V_11 )
{
struct V_19 * V_20 ;
int V_45 ;
