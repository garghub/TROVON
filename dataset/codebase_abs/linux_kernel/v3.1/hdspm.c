...
static inline void F_20 ( struct V_3 * V_77 )
{
V_77 -> V_70 |= ( V_78 | V_79 ) ;
...
static int F_23 ( struct V_3 * V_77 , unsigned int V_85 )
{
int V_1 ;
F_24 ( & V_77 -> V_22 ) ;
V_85 >>= 7 ;
...
static T_2 F_27 ( struct V_3 * V_3 , T_2 V_87 )
{
T_2 V_88 ;
if ( V_87 == 0 )
return 0 ;
...
return F_29 ( V_88 , V_87 ) ;
}
static void F_30 ( struct V_3 * V_3 , int V_29 )
{
T_2 V_1 ;
if ( V_29 >= 112000 )
V_29 /= 4 ;
...
static int F_32 ( struct V_3 * V_3 , int V_29 , int V_90 )
{
int V_91 ;
int V_30 ;
int V_92 = 0 ;
...
static void F_34 ( struct V_3 * V_3 , int V_142 )
{
int V_16 , V_143 ;
unsigned int V_144 ;
if ( V_142 > V_145 )
...
static inline unsigned char F_35 ( struct V_3 * V_3 ,
int V_146 )
{
return F_4 ( V_3 , V_3 -> V_147 [ V_146 ] . V_148 ) ;
}
static inline void F_36 ( struct V_3 * V_3 , int V_146 ,
int V_5 )
{
return F_2 ( V_3 , V_3 -> V_147 [ V_146 ] . V_149 , V_5 ) ;
}
static inline int F_37 ( struct V_3 * V_3 , int V_146 )
{
...
static void F_39 ( struct V_3 * V_3 , int V_146 )
{
while ( F_37 ( V_3 , V_146 ) )
F_35 ( V_3 , V_146 ) ;
}
...
if ( V_154 -> V_157 &&
! F_41 ( V_154 -> V_157 ) ) {
V_155 = F_38 ( V_154 -> V_3 ,
V_154 -> V_146 ) ;
if ( V_155 > 0 ) {
if ( V_155 > ( int ) sizeof ( V_81 ) )
V_155 = sizeof ( V_81 ) ;
V_156 = F_42 ( V_154 -> V_157 , V_81 ,
V_155 ) ;
if ( V_156 > 0 ) {
...
static int F_43 ( struct V_153 * V_154 )
{
unsigned char V_81 [ 128 ] ;
unsigned long V_20 ;
int V_155 ;
int V_16 ;
F_13 ( & V_154 -> V_22 , V_20 ) ;
V_155 = F_37 ( V_154 -> V_3 , V_154 -> V_146 ) ;
if ( V_155 > 0 ) {
if ( V_154 -> V_158 ) {
if ( V_155 > ( int ) sizeof ( V_81 ) )
V_155 = sizeof ( V_81 ) ;
for ( V_16 = 0 ; V_16 < V_155 ; ++ V_16 )
V_81 [ V_16 ] = F_35 ( V_154 -> V_3 ,
V_154 -> V_146 ) ;
if ( V_155 )
F_44 ( V_154 -> V_158 , V_81 ,
V_155 ) ;
} else {
while ( V_155 -- )
F_35 ( V_154 -> V_3 ,
...
static void
F_45 ( struct V_161 * V_162 , int V_163 )
{
struct V_3 * V_3 ;
struct V_153 * V_154 ;
unsigned long V_20 ;
...
static void F_46 ( unsigned long V_13 )
{
...
static void
F_48 ( struct V_161 * V_162 , int V_163 )
{
struct V_153 * V_154 ;
unsigned long V_20 ;
V_154 = V_162 -> V_164 -> V_165 ;
...
static int F_51 ( struct V_161 * V_162 )
{
struct V_153 * V_154 ;
V_154 = V_162 -> V_164 -> V_165 ;
F_24 ( & V_154 -> V_22 ) ;
F_39 ( V_154 -> V_3 , V_154 -> V_146 ) ;
V_154 -> V_158 = V_162 ;
F_26 ( & V_154 -> V_22 ) ;
return 0 ;
}
...
static int T_3 F_55 ( struct V_171 * V_172 ,
...
V_173 = F_57 ( V_172 , V_81 , V_146 , 1 , 1 ,
...
static void F_59 ( unsigned long V_208 )
{
...
V_222 )
{
struct V_3 * V_3 = F_63 ( V_212 ) ;
V_222 -> V_217 . integer . V_217 [ 0 ] = F_60 ( V_3 ) ;
return 0 ;
}
...
static int F_67 ( struct V_3 * V_3 , unsigned int V_226 )
{
...
static void F_71 ( struct V_3 * V_3 , int V_236 )
{
switch ( V_3 -> V_31 ) {
case V_47 :
case V_48 :
...
{
struct V_3 * V_3 = F_63 ( V_212 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_70 ( V_3 ) ;
return 0 ;
}
...
static int F_76 ( struct V_3 * V_3 , int V_236 )
{
int V_29 ;
switch ( V_236 ) {
case 0 :
...
static int F_77 ( struct V_211 * V_212 ,
struct V_213 * V_214 )
{
V_214 -> type = V_227 ;
V_214 -> V_216 = 1 ;
...
{
struct V_3 * V_3 = F_63 ( V_212 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_75 ( V_3 ) ;
return 0 ;
}
...
static int F_81 ( struct V_3 * V_3 , int V_247 )
{
int V_248 = 0 ;
switch ( V_3 -> V_31 ) {
case V_32 :
...
static int F_88 ( struct V_3 * V_3 , int V_263 )
{
if ( V_263 )
V_3 -> V_70 |= V_262 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . integer . V_217 [ 0 ] = F_87 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_92 ( struct V_3 * V_3 , int V_263 )
{
if ( V_263 )
V_3 -> V_70 |= V_264 ;
else
...
static int F_93 ( struct V_211 * V_212 ,
struct V_221 * V_222 )
{
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . integer . V_217 [ 0 ] = F_91 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_96 ( struct V_3 * V_3 , int V_263 )
{
if ( V_263 )
V_3 -> V_70 |= V_265 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . integer . V_217 [ 0 ] = F_95 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_100 ( struct V_3 * V_3 , int V_263 )
{
if ( V_263 )
V_3 -> V_70 |= V_266 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . integer . V_217 [ 0 ] = F_99 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_104 ( struct V_3 * V_3 , int V_268 )
{
if ( V_268 )
V_3 -> V_70 |= V_267 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_103 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
V_5 = V_222 -> V_217 . integer . V_217 [ 0 ] & 1 ;
F_24 ( & V_3 -> V_22 ) ;
V_239 = ( int ) V_5 != F_103 ( V_3 ) ;
F_104 ( V_3 , V_5 ) ;
F_26 ( & V_3 -> V_22 ) ;
return V_239 ;
}
static int F_107 ( struct V_3 * V_3 )
{
return ( V_3 -> V_70 & V_269 ) ? 1 : 0 ;
}
static int F_108 ( struct V_3 * V_3 , int V_270 )
{
if ( V_270 )
V_3 -> V_70 |= V_269 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_107 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_112 ( struct V_3 * V_3 , int V_270 )
{
if ( V_270 )
V_3 -> V_70 |= V_271 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_111 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_116 ( struct V_3 * V_3 , int V_263 )
{
if ( V_263 )
V_3 -> V_70 |= V_272 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_115 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_121 ( struct V_3 * V_3 , int V_274 )
{
if ( V_274 )
V_3 -> V_70 |= V_273 ;
else
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_120 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_126 ( struct V_3 * V_3 , int V_236 )
{
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_125 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_131 ( struct V_3 * V_3 , int V_236 )
{
V_3 -> V_70 &= ~ ( V_72 | V_71 ) ;
switch ( V_236 ) {
case 0 :
...
struct V_3 * V_3 = F_63 ( V_212 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_222 -> V_217 . V_228 . V_230 [ 0 ] = F_130 ( V_3 ) ;
F_26 ( & V_3 -> V_22 ) ;
return 0 ;
}
...
static int F_142 ( struct V_3 * V_3 )
{
int V_25 , V_26 ;
switch ( V_3 -> V_31 ) {
case V_32 :
...
static int F_144 ( struct V_3 * V_3 , int V_226 )
{
int V_25 , V_22 , V_282 ;
V_25 = F_4 ( V_3 , V_223 ) ;
...
static int F_146 ( struct V_3 * V_3 , int V_226 )
{
int V_26 , V_22 , V_282 ;
V_26 = F_4 ( V_3 , V_33 ) ;
...
V_5 = F_145 ( V_3 ) ; break;
default:
V_5 = F_144 ( V_3 , V_222 -> V_146 . V_233 - 1 ) ;
}
case V_47 :
switch ( V_212 -> V_232 ) {
case 0 :
...
static void F_149 ( struct V_3 * V_3 )
{
...
static int F_168 ( struct V_3 * V_3 )
{
int V_16 ;
...
F_169 ( V_3 -> V_172 , V_316 |
V_317 ,
& V_3 -> V_309 [ V_16 ] -> V_146 ) ;
}
return 0 ;
}
static int F_170 ( struct V_171 * V_172 ,
struct V_3 * V_3 )
{
...
for ( V_226 = 0 ; V_226 < V_318 ; ++ V_226 ) {
V_327 . V_233 = V_226 + 1 ;
V_319 = F_173 ( & V_327 , V_3 ) ;
V_173 = F_172 ( V_172 , V_319 ) ;
if ( V_173 < 0 )
return V_173 ;
...
V_379 = F_4 ( V_3 , V_283 ) ;
V_333 = V_3 -> V_70 ;
F_175 ( V_332 , L_128 , V_378 ) ;
F_175 ( V_332 , L_129 , V_26 ) ;
F_175 ( V_332 , L_130 , V_379 ) ;
F_175 ( V_332 , L_131 ) ;
F_175 ( V_332 , L_132 ,
( F_70 ( V_3 ) == 0 ) ? L_133 : L_134 ) ;
F_175 ( V_332 , L_135 ,
F_60 ( V_3 ) ) ;
F_175 ( V_332 , L_136 ) ;
V_22 = 0x1 ;
...
F_175 ( V_332 , L_141 , V_16 ) ;
for ( V_143 = 0 ; V_143 < 16 ; V_143 += 4 )
F_175 ( V_332 , L_142 , F_4 ( V_3 , V_16 + V_143 ) ) ;
F_175 ( V_332 , L_114 ) ;
}
}
static void F_179 ( struct V_329 * V_330 ,
struct V_331 * V_332 )
{
struct V_3 * V_3 = V_330 -> V_165 ;
int V_16 ;
...
F_175 ( V_332 , L_144 , V_16 + 1 , V_3 -> V_126 [ V_16 ] ) ;
}
}
...
F_175 ( V_332 , L_144 , V_16 + 1 , V_3 -> V_128 [ V_16 ] ) ;
}
}
static void T_3 F_181 ( struct V_3 * V_3 )
{
struct V_329 * V_330 ;
if ( ! F_182 ( V_3 -> V_172 , L_145 , & V_330 ) ) {
switch ( V_3 -> V_31 ) {
case V_32 :
F_183 ( V_330 , V_3 ,
F_176 ) ;
...
if ( ! F_182 ( V_3 -> V_172 , L_146 , & V_330 ) ) {
F_183 ( V_330 , V_3 , F_179 ) ;
}
if ( ! F_182 ( V_3 -> V_172 , L_147 , & V_330 ) ) {
F_183 ( V_330 , V_3 , F_180 ) ;
}
#ifdef F_184
if ( ! F_182 ( V_3 -> V_172 , L_148 , & V_330 ) )
F_183 ( V_330 , V_3 ,
F_178 ) ;
#endif
}
...
static T_4 F_187 ( int V_179 , void * V_382 )
{
...
static T_1 F_190 ( struct V_391
* V_162 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
return F_19 ( V_3 ) ;
}
static int F_192 ( struct V_391 * V_162 )
{
...
static int F_194 ( struct V_391 * V_162 ,
struct V_400 * V_401 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
int V_173 ;
...
if ( F_195 ( V_401 ) != V_3 -> V_99 ) {
F_26 ( & V_3 -> V_22 ) ;
F_196 ( V_401 ,
V_405 ) ;
return - V_115 ;
}
if ( F_197 ( V_401 ) != V_3 -> V_73 / 4 ) {
F_26 ( & V_3 -> V_22 ) ;
F_196 ( V_401 ,
V_406 ) ;
return - V_115 ;
...
F_26 ( & V_3 -> V_22 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_173 = F_32 ( V_3 , F_195 ( V_401 ) , 0 ) ;
if ( V_173 < 0 ) {
F_33 ( V_407 L_149 , V_173 ) ;
F_26 ( & V_3 -> V_22 ) ;
F_196 ( V_401 ,
V_405 ) ;
return V_173 ;
...
F_198 ( V_162 , V_408 ) ;
if ( V_173 < 0 ) {
F_33 ( V_407 L_151 , V_173 ) ;
return V_173 ;
}
if ( V_162 -> V_395 == V_396 ) {
F_199 ( V_3 , V_162 , V_409 ,
F_200 ( V_401 ) ) ;
for ( V_16 = 0 ; V_16 < F_200 ( V_401 ) ; ++ V_16 )
F_11 ( V_3 , V_16 , 1 ) ;
V_3 -> V_82 =
...
if ( V_413 == F_202 ( V_401 ) ) {
if ( ! ( V_3 -> V_70 & V_414 ) )
F_33 ( V_407 L_154 ) ;
V_3 -> V_70 |= V_414 ;
} else if ( V_415 == F_202 ( V_401 ) ) {
if ( V_3 -> V_70 & V_414 )
F_33 ( V_407 L_155 ) ;
V_3 -> V_70 &= ~ V_414 ;
}
...
static int F_203 ( struct V_391 * V_162 )
{
int V_16 ;
struct V_3 * V_3 = F_191 ( V_162 ) ;
if ( V_162 -> V_395 == V_396 ) {
...
static int F_205 ( struct V_391 * V_162 ,
struct V_416 * V_417 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
if ( V_162 -> V_395 == V_396 ) {
if ( F_31 ( V_417 -> V_279 >= V_3 -> V_124 ) ) {
F_33 ( V_407 L_156 , V_417 -> V_279 ) ;
return - V_112 ;
}
if ( V_3 -> V_120 [ V_417 -> V_279 ] < 0 ) {
F_33 ( V_407 L_157 , V_417 -> V_279 ) ;
return - V_112 ;
}
V_417 -> V_418 = V_3 -> V_120 [ V_417 -> V_279 ] *
V_84 ;
} else {
if ( F_31 ( V_417 -> V_279 >= V_3 -> V_122 ) ) {
F_33 ( V_407 L_158 , V_417 -> V_279 ) ;
return - V_112 ;
}
if ( V_3 -> V_118 [ V_417 -> V_279 ] < 0 ) {
F_33 ( V_407 L_159 , V_417 -> V_279 ) ;
return - V_112 ;
}
...
return F_205 ( V_162 , V_417 ) ;
}
default:
break;
}
return F_207 ( V_162 , V_420 , V_208 ) ;
}
static int F_208 ( struct V_391 * V_162 , int V_420 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
struct V_391 * V_394 ;
int V_397 ;
...
static int F_212 ( struct V_391 * V_162 )
{
return 0 ;
}
...
struct V_3 * V_3 = V_428 -> V_429 ;
struct V_430 * V_431 = F_214 ( V_401 ,
V_432 ) ;
V_321 [ 0 ] = V_3 -> V_138 ;
V_321 [ 1 ] = V_3 -> V_132 ;
V_321 [ 2 ] = V_3 -> V_123 ;
return F_220 ( V_431 , 3 , V_321 , 0 ) ;
}
static int F_221 ( struct V_400 * V_401 ,
struct V_427 * V_428 )
{
unsigned int V_321 [ 3 ] ;
struct V_3 * V_3 = V_428 -> V_429 ;
...
static int F_222 ( struct V_391 * V_162 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
struct V_392 * V_393 = V_162 -> V_393 ;
F_24 ( & V_3 -> V_22 ) ;
...
static int F_227 ( struct V_391 * V_162 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_3 -> V_23 = - 1 ;
...
static int F_228 ( struct V_391 * V_162 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
struct V_392 * V_393 = V_162 -> V_393 ;
F_24 ( & V_3 -> V_22 ) ;
...
static int F_229 ( struct V_391 * V_162 )
{
struct V_3 * V_3 = F_191 ( V_162 ) ;
F_24 ( & V_3 -> V_22 ) ;
V_3 -> V_24 = - 1 ;
...
static int F_230 ( struct V_445 * V_435 , struct V_446 * V_446 )
{
return 0 ;
}
static inline int F_231 ( void T_6 * V_447 , void T_7 * V_448 )
{
V_15 V_5 = F_5 ( V_448 ) ;
return F_232 ( V_447 , & V_5 , 4 ) ;
}
static int F_233 ( struct V_445 * V_435 , struct V_446 * V_446 ,
unsigned int V_420 , unsigned long T_6 V_208 )
{
...
V_77 = F_232 ( V_449 , V_455 , sizeof( struct V_454 ) ) ;
if ( 0 != V_77 ) {
return - V_479 ;
}
break;
...
V_77 = F_232 ( V_449 , & V_342 , sizeof( struct V_456 ) ) ;
if ( 0 != V_77 ) {
return - V_479 ;
}
break;
...
F_24 ( & V_3 -> V_22 ) ;
V_417 . V_335 = F_80 ( V_3 ) ;
V_417 . V_495 = F_142 ( V_3 ) ;
V_417 . V_99 = V_3 -> V_99 ;
V_417 . V_496 =
F_15 ( V_3 ) ;
V_417 . V_337 = F_70 ( V_3 ) ;
V_417 . V_497 = F_75 ( V_3 ) ;
V_417 . V_336 = F_16 ( V_3 ) ;
V_417 . V_498 = F_87 ( V_3 ) ;
V_417 . V_499 = 0 ;
F_26 ( & V_3 -> V_22 ) ;
if ( F_232 ( ( void T_6 * ) V_208 , & V_417 , sizeof( V_417 ) ) )
return - V_479 ;
break;
case V_500 :
V_25 . V_501 = V_3 -> V_31 ;
...
if ( F_232 ( ( void T_6 * ) V_208 , & V_25 , sizeof( V_25 ) ) )
return - V_479 ;
break;
case V_514 :
...
if ( V_3 -> V_224 )
V_453 . V_517 |= V_518 ;
if ( F_232 ( ( void T_6 * ) V_208 , & V_453 ,
sizeof( V_453 ) ) )
return - V_479 ;
break;
case V_519 :
if ( F_234 ( & V_10 , ( void T_6 * ) V_208 , sizeof( V_10 ) ) )
return - V_479 ;
if ( F_232 ( ( void T_6 * ) V_10 . V_10 , V_3 -> V_10 ,
sizeof( struct V_520 ) ) )
return - V_479 ;
break;
default:
...
static int T_3 F_235 ( struct V_171 * V_172 ,
struct V_3 * V_3 )
{
struct V_445 * V_435 ;
int V_173 ;
V_173 = F_236 ( V_172 , L_160 , 0 , & V_435 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 -> V_521 = V_435 ;
V_435 -> V_165 = V_3 ;
strcpy ( V_435 -> V_199 , L_161 ) ;
V_435 -> V_522 . V_523 = F_230 ;
V_435 -> V_522 . V_524 = F_233 ;
V_435 -> V_522 . V_525 = F_230 ;
return 0 ;
}
static int T_3 F_237 ( struct V_3 * V_3 )
{
int V_173 ;
struct V_526 * V_527 ;
T_8 V_528 ;
...
static void F_199 ( struct V_3 * V_3 ,
struct V_391 * V_162 ,
...
F_2 ( V_3 , V_4 + 4 * V_16 ,
F_240 ( V_162 , 4096 * V_16 ) ) ;
}
static int T_3 F_241 ( struct V_171 * V_172 ,
struct V_3 * V_3 )
{
struct V_526 * V_527 ;
int V_173 ;
V_173 = F_242 ( V_172 , V_3 -> V_346 , 0 , 1 , 1 , & V_527 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 -> V_527 = V_527 ;
V_527 -> V_165 = V_3 ;
...
static inline void F_244 ( struct V_3 * V_3 )
{
int V_16 ;
...
int V_173 , V_16 ;
F_201 ( L_164 ) ;
V_173 = F_241 ( V_172 , V_3 ) ;
if ( V_173 < 0 )
return V_173 ;
V_16 = 0 ;
while ( V_16 < V_3 -> V_209 ) {
V_173 = F_55 ( V_172 , V_3 , V_16 ) ;
if ( V_173 < 0 ) {
return V_173 ;
}
V_16 ++ ;
}
V_173 = F_170 ( V_172 , V_3 ) ;
if ( V_173 < 0 )
return V_173 ;
V_173 = F_235 ( V_172 , V_3 ) ;
if ( V_173 < 0 )
return V_173 ;
F_201 ( L_165 ) ;
F_181 ( V_3 ) ;
...
static int T_3 F_247 ( struct V_171 * V_172 ,
struct V_3 * V_3 ) {
...
return V_173 ;
F_250 ( V_3 -> V_530 ) ;
V_173 = F_251 ( V_530 , L_145 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 -> V_352 = F_252 ( V_530 , 0 ) ;
V_538 = F_253 ( V_530 , 0 ) ;
F_201 ( L_179 ,
V_3 -> V_352 , V_3 -> V_352 + V_538 - 1 ) ;
V_3 -> V_6 = F_254 ( V_3 -> V_352 , V_538 ) ;
if ( ! V_3 -> V_6 ) {
F_33 ( V_113 L_1
L_180 ,
V_3 -> V_352 , V_3 -> V_352 + V_538 - 1 ) ;
...
V_3 -> V_352 + V_538 - 1 ) ;
if ( F_255 ( V_530 -> V_179 , F_187 ,
V_552 , V_553 , V_3 ) ) {
F_33 ( V_113 L_182 , V_530 -> V_179 ) ;
return - V_115 ;
}
F_201 ( L_183 , V_530 -> V_179 ) ;
V_3 -> V_179 = V_530 -> V_179 ;
F_201 ( L_184 ,
sizeof( struct V_520 ) ) ;
V_3 -> V_10 = F_256 ( sizeof( struct V_520 ) , V_554 ) ;
if ( ! V_3 -> V_10 ) {
F_33 ( V_113 L_1
L_185 ,
...
switch ( V_3 -> V_31 ) {
case V_32 :
V_3 -> V_123 = V_3 -> V_125 = V_555 ;
V_3 -> V_132 = V_3 -> V_133 = V_555 ;
V_3 -> V_138 = V_3 -> V_139 = V_555 ;
V_3 -> V_119 = V_3 -> V_121 =
V_556 ;
V_3 -> V_130 = V_3 -> V_131 =
V_556 ;
...
V_591 ) {
V_3 -> V_209 ++ ;
V_3 -> V_224 = F_256 ( sizeof( struct V_592 ) ,
V_554 ) ;
if ( NULL != V_3 -> V_224 ) {
F_149 ( V_3 ) ;
}
...
static int F_258 ( struct V_3 * V_3 )
{
if ( V_3 -> V_352 ) {
V_3 -> V_70 &=
~ ( V_79 | V_78 |
...
static void F_264 ( struct V_171 * V_172 )
{
struct V_3 * V_3 = V_172 -> V_165 ;
if ( V_3 )
F_258 ( V_3 ) ;
}
static int T_3 F_265 ( struct V_537 * V_530 ,
...
V_173 = F_266 ( V_233 [ V_603 ] , V_146 [ V_603 ] ,
V_607 , sizeof( struct V_3 ) , & V_172 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 = V_172 -> V_165 ;
V_172 -> V_608 = F_264 ;
V_3 -> V_603 = V_603 ;
V_3 -> V_530 = V_530 ;
F_267 ( V_172 , & V_530 -> V_603 ) ;
V_173 = F_247 ( V_172 , V_3 ) ;
if ( V_173 < 0 ) {
F_268 ( V_172 ) ;
return V_173 ;
}
...
V_3 -> V_346 ,
( F_4 ( V_3 , V_182 ) >> 8 ) & 0xFFFFFF ) ;
sprintf ( V_172 -> V_609 , L_191 ,
V_3 -> V_346 ,
( F_4 ( V_3 , V_182 ) >> 8 ) & 0xFFFFFF ,
V_3 -> V_352 , V_3 -> V_179 ) ;
} else {
sprintf ( V_172 -> V_198 , L_192 , V_3 -> V_346 ) ;
sprintf ( V_172 -> V_609 , L_193 ,
...
static void T_9 F_270 ( struct V_537 * V_530 )
{
F_268 ( F_271 ( V_530 ) ) ;
F_269 ( V_530 , NULL ) ;
}
