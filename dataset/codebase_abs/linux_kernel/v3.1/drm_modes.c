...
const char * V_5 ;
unsigned int V_131 ;
bool V_132 = false , V_133 = false , V_134 = false ;
unsigned int V_135 = 0 , V_136 = 0 , V_137 = 32 , V_73 = 0 ;
bool V_138 = false , V_139 = false , V_140 = false ;
bool V_29 = false , V_20 = false , V_141 = false ;
int V_110 ;
enum V_142 V_143 = V_144 ;
#ifdef F_60
if ( ! V_129 )
V_129 = V_145 ;
#endif
...
break;
case 'M' :
if ( V_138 || V_139 || V_141 )
goto V_147;
V_139 = true ;
break;
case 'R' :
if ( V_138 || V_139 || V_140 || V_141 )
goto V_147;
V_140 = true ;
break;
case 'm' :
...
if ( V_110 < 0 && V_138 ) {
char * V_154 ;
V_135 = F_61 ( V_5 , & V_154 , 10 ) ;
if ( ( V_154 != NULL ) && ( * V_154 == 'x' ) )
V_132 = true ;
else
V_110 = V_154 - V_5 ;
} else if ( ! V_138 && V_141 ) {
...
struct V_1 *
F_63 ( struct V_16 * V_17 ,
struct V_130 * V_156 )
{
struct V_1 * V_2 ;
if ( V_156 -> V_139 )
V_2 = F_3 ( V_17 ,
V_156 -> V_135 , V_156 -> V_136 ,
V_156 -> V_134 ? V_156 -> V_73 : 60 ,
V_156 -> V_140 , V_156 -> V_29 ,
V_156 -> V_20 ) ;
else
V_2 = F_32 ( V_17 ,
V_156 -> V_135 , V_156 -> V_136 ,
