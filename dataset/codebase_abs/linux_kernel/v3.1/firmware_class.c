...
static T_1 F_29 ( struct V_40 * V_41 , struct V_42 * V_43 ,
struct V_44 * V_45 ,
char * V_46 , T_3 V_47 , T_2 V_22 )
{
struct V_11 * V_12 = F_30 ( V_43 ) ;
struct V_10 * V_13 = F_3 ( V_12 ) ;
struct V_1 * V_2 ;
T_1 V_48 ;
F_24 ( & V_35 ) ;
V_2 = V_13 -> V_2 ;
if ( ! V_2 || F_19 ( V_49 , & V_13 -> V_15 ) ) {
V_48 = - V_50 ;
goto V_51;
}
if ( V_47 > V_2 -> V_8 ) {
...
if ( V_22 > V_2 -> V_8 - V_47 )
V_22 = V_2 -> V_8 - V_47 ;
V_48 = V_22 ;
while ( V_22 ) {
void * V_52 ;
int V_53 = V_47 >> V_54 ;
int V_55 = V_47 & ( V_56 - 1 ) ;
int V_57 = F_31 ( T_2 , V_56 - V_55 , V_22 ) ;
V_52 = F_32 ( V_13 -> V_25 [ V_53 ] ) ;
memcpy ( V_46 , V_52 + V_55 , V_57 ) ;
F_33 ( V_13 -> V_25 [ V_53 ] ) ;
V_46 += V_57 ;
V_47 += V_57 ;
V_22 -= V_57 ;
...
V_13 -> V_36 * sizeof( void * ) ) ;
memset ( & V_62 [ V_13 -> V_36 ] , 0 , sizeof( void * ) *
( V_60 - V_13 -> V_36 ) ) ;
F_14 ( V_13 -> V_25 ) ;
V_13 -> V_25 = V_62 ;
V_13 -> V_36 = V_60 ;
...
int V_57 = F_31 ( T_2 , V_56 - V_55 , V_22 ) ;
V_52 = F_32 ( V_13 -> V_25 [ V_53 ] ) ;
memcpy ( V_52 + V_55 , V_46 , V_57 ) ;
F_33 ( V_13 -> V_25 [ V_53 ] ) ;
V_46 += V_57 ;
V_47 += V_57 ;
V_22 -= V_57 ;
}
V_2 -> V_8 = F_41 ( T_2 , V_47 , V_2 -> V_8 ) ;
V_51:
F_25 ( & V_35 ) ;
return V_65 ;
}
...
int
F_74 ( const struct V_1 * * V_80 , const char * V_3 ,
struct V_11 * V_11 )
{
return F_62 ( V_80 , V_3 , V_11 , true , false ) ;
}
void F_73 ( const struct V_1 * V_2 )
{
if ( V_2 ) {
if ( ! F_2 ( V_2 ) )
F_20 ( V_2 ) ;
