...
F_81 () ;
V_117 = & F_82 ( V_127 ) ;
while ( V_117 -> V_70 < F_83 ( V_117 -> V_128 ) ) {
F_84 () ;
V_119 = F_85 ( V_123 ,
V_90 ) ;
if ( F_38 ( V_119 == NULL ) ) {
...
F_81 () ;
V_117 = & F_82 ( V_127 ) ;
if ( V_117 -> V_70 < F_83 ( V_117 -> V_128 ) )
V_117 -> V_128 [ V_117 -> V_70 ++ ] = V_119 ;
else
F_86 ( V_123 , V_119 ) ;
}
F_84 () ;
...
if ( V_117 -> V_70 <= 0 )
goto V_54;
V_119 = V_117 -> V_128 [ V_117 -> V_70 - 1 ] ;
F_2 ( V_119 == NULL ) ;
V_117 -> V_128 [ V_117 -> V_70 - 1 ] = NULL ;
V_117 -> V_70 -- ;
V_41 = F_90 ( & V_132 ) ;
if ( V_41 > V_133 )
V_133 = V_41 ;
...
static void * F_95 ( char * V_136 , T_3 V_8 , bool V_137 , int V_138 ,
struct V_68 * V_69 , struct V_45 * V_32 ,
T_2 V_46 )
{
void * V_139 = NULL , * V_48 ;
T_3 V_87 ;
int V_63 ;
unsigned long V_41 ;
struct V_47 * V_47 = (struct V_47 * ) ( V_136 ) ;
...
V_139 = ( void * ) F_35 ( V_43 , V_69 -> V_44 , V_32 ,
V_46 , V_47 , V_48 , V_87 ) ;
if ( V_139 != NULL ) {
V_41 = F_90 ( & V_144 ) ;
if ( V_41 > V_145 )
...
V_139 = ( void * ) F_57 ( V_2 -> V_86 , V_69 -> V_44 ,
V_32 , V_46 , V_48 , V_87 ) ;
if ( V_139 == NULL )
goto V_54;
V_41 = F_90 ( & V_146 ) ;
...
static int F_99 ( char * V_136 , T_3 * V_150 , bool V_137 ,
void * V_139 , struct V_68 * V_69 ,
struct V_45 * V_32 , T_2 V_46 )
{
int V_63 = 0 ;
F_2 ( F_100 ( V_69 ) ) ;
F_66 ( (struct V_47 * ) ( V_136 ) , V_139 ) ;
return V_63 ;
}
static int F_101 ( char * V_136 , T_3 * V_150 , bool V_137 ,
void * V_139 , struct V_68 * V_69 ,
struct V_45 * V_32 , T_2 V_46 )
{
int V_63 = 0 ;
F_2 ( ! F_100 ( V_69 ) ) ;
F_40 ( (struct V_47 * ) ( V_136 ) , V_139 ) ;
F_33 ( (struct V_10 * ) V_139 ) ;
F_32 ( & V_144 ) ;
return V_63 ;
}
static void F_102 ( void * V_139 , struct V_68 * V_69 ,
struct V_45 * V_32 , T_2 V_46 )
{
struct V_1 * V_2 = V_69 -> V_114 ;
if ( F_100 ( V_69 ) ) {
...
F_60 ( V_2 -> V_86 , (struct V_84 * ) V_139 ) ;
F_32 ( & V_146 ) ;
F_2 ( F_92 ( & V_146 ) < 0 ) ;
}
}
...
static int F_105 ( void * V_139 , struct V_120 * V_121 )
{
return - 1 ;
}
static bool F_106 ( void * V_139 )
{
return 0 ;
}
static int F_96 ( struct V_47 * V_151 , void * * V_152 , T_3 * V_60 )
{
int V_63 = 0 ;
unsigned char * V_153 = F_82 ( V_154 ) ;
unsigned char * V_155 = F_82 ( V_156 ) ;
char * V_62 ;
F_2 ( ! F_58 () ) ;
if ( F_38 ( V_153 == NULL || V_155 == NULL ) )
goto V_54;
V_62 = F_41 ( V_151 , V_65 ) ;
F_107 () ;
V_63 = F_108 ( V_62 , V_13 , V_153 , V_60 , V_155 ) ;
F_2 ( V_63 != V_66 ) ;
* V_152 = V_153 ;
F_43 ( V_62 , V_65 ) ;
V_63 = 1 ;
...
static int F_109 ( struct V_157 * V_158 ,
unsigned long V_159 , void * V_160 )
{
int V_161 = ( long ) V_160 ;
struct V_116 * V_117 ;
switch ( V_159 ) {
case V_162 :
F_110 ( V_154 , V_161 ) = ( void * ) F_111 (
V_163 | V_164 ,
V_165 ) ,
F_110 ( V_156 , V_161 ) =
F_112 ( V_166 ,
...
case V_167 :
case V_168 :
F_113 ( ( unsigned long ) F_110 ( V_154 , V_161 ) ,
V_165 ) ;
F_110 ( V_154 , V_161 ) = NULL ;
F_114 ( F_110 ( V_156 , V_161 ) ) ;
F_110 ( V_156 , V_161 ) = NULL ;
V_117 = & F_110 ( V_127 , V_161 ) ;
while ( V_117 -> V_70 ) {
F_86 ( V_123 ,
V_117 -> V_128 [ V_117 -> V_70 - 1 ] ) ;
V_117 -> V_128 [ V_117 -> V_70 - 1 ] = NULL ;
V_117 -> V_70 -- ;
}
...
{
int V_63 = - 1 ;
int V_70 = V_173 -> V_174 ;
T_6 V_175 = V_173 -> V_175 ;
if ( V_70 >= 0 ) {
if ( ! ( V_175 & V_176 ) )
goto V_54;
if ( F_37 ( & V_125 ) ) {
...
static int F_116 ( int V_108 , int V_44 , struct V_45 * V_178 ,
T_2 V_46 , struct V_47 * V_47 )
{
struct V_68 * V_69 ;
int V_63 = - 1 ;
...
if ( F_38 ( V_69 == NULL ) )
goto V_54;
if ( ! V_179 && F_80 ( V_69 ) == 0 ) {
V_63 = F_117 ( V_69 , V_178 , V_46 , ( char * ) ( V_47 ) ,
V_13 , 0 , F_100 ( V_69 ) ) ;
if ( V_63 < 0 ) {
if ( F_100 ( V_69 ) )
V_180 ++ ;
...
V_182 ++ ;
if ( F_92 ( & V_69 -> V_183 ) > 0 )
( void ) F_46 ( V_69 , V_178 , V_46 ) ;
F_47 ( V_69 ) ;
}
V_54:
return V_63 ;
}
static int F_118 ( int V_108 , int V_44 , struct V_45 * V_178 ,
T_2 V_46 , struct V_47 * V_47 )
{
struct V_68 * V_69 ;
int V_63 = - 1 ;
...
if ( F_20 ( V_69 != NULL ) ) {
if ( F_92 ( & V_69 -> V_183 ) > 0 )
V_63 = F_119 ( V_69 , V_178 , V_46 , ( char * ) ( V_47 ) ,
& V_8 , 0 , F_100 ( V_69 ) ) ;
F_47 ( V_69 ) ;
}
F_65 ( V_94 ) ;
...
goto V_54;
F_26 ( & V_2 -> V_111 ) ;
V_69 = F_128 ( sizeof( struct V_68 ) , V_163 ) ;
if ( V_69 == NULL ) {
F_126 ( L_7 ) ;
goto V_54;
}
...
{
T_8 V_191 = ( T_8 ) V_46 ;
struct V_45 V_32 = * (struct V_45 * ) & V_190 ;
if ( F_20 ( V_191 == V_46 ) )
...
struct V_45 V_32 = * (struct V_45 * ) & V_190 ;
if ( F_20 ( V_191 == V_46 ) )
( void ) F_120 ( V_4 , V_44 , & V_32 , V_191 ) ;
}
...
static int F_136 ( T_3 V_192 )
{
F_2 ( sizeof( struct V_189 ) !=
sizeof( struct V_45 ) ) ;
F_2 ( V_192 != V_13 ) ;
return F_127 ( V_4 , 0 ) ;
}
static int F_137 ( char * V_193 , T_3 V_192 )
{
F_2 ( sizeof( struct V_189 ) !=
sizeof( struct V_45 ) ) ;
F_2 ( V_192 != V_13 ) ;
...
struct V_194 F_138 ( void )
{
struct V_194 V_195 =
F_139 ( & V_196 ) ;
return V_195 ;
}
static inline struct V_45 F_140 ( unsigned type , T_8 V_191 )
{
struct V_45 V_32 = { . V_32 = { 0 } } ;
V_32 . V_32 [ 0 ] = F_141 ( type , V_191 ) ;
return V_32 ;
}
...
T_5 V_197 = ( T_5 ) V_12 ;
T_8 V_191 = ( T_8 ) V_12 ;
struct V_45 V_32 = F_140 ( type , V_191 ) ;
int V_63 = - 1 ;
unsigned long V_94 ;
F_2 ( ! F_143 ( V_47 ) ) ;
if ( F_20 ( V_197 == V_191 ) ) {
F_63 ( V_94 ) ;
V_63 = F_116 ( V_4 , V_198 ,
& V_32 , F_144 ( V_191 ) , V_47 ) ;
F_65 ( V_94 ) ;
}
return V_63 ;
}
...
struct V_45 V_32 ;
int V_191 ;
for ( V_191 = V_199 ; V_191 >= 0 ; V_191 -- ) {
V_32 = F_140 ( type , V_191 ) ;
( void ) F_121 ( V_4 ,
V_198 , & V_32 ) ;
}
}
static void F_148 ( unsigned V_200 )
{
if ( V_198 < 0 )
V_198 =
F_127 ( V_4 , V_188 ) ;
}
struct V_201 F_149 ( void )
{
struct V_201 V_195 =
F_150 ( & V_202 ) ;
return V_195 ;
}
static int T_9 F_151 ( char * V_203 )
{
V_204 = 1 ;
return 1 ;
}
static int T_9 F_152 ( char * V_203 )
{
V_205 = 0 ;
return 1 ;
}
static int T_9 F_153 ( char * V_203 )
{
V_206 = 0 ;
return 1 ;
}
...
int V_63 = 0 ;
#ifdef F_155
V_63 = F_156 ( V_207 , & V_208 ) ;
if ( V_63 ) {
F_157 ( L_12 ) ;
goto V_54;
}
#endif
#if F_158 ( V_209 ) || F_158 ( F_78 )
if ( V_204 ) {
unsigned int V_161 ;
F_159 ( & V_210 ) ;
F_160 ( & V_211 ) ;
