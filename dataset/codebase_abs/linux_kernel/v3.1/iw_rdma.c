...
F_19 ( V_112 ) ;
unsigned long V_92 ;
unsigned int V_113 = 0 , V_114 = 0 , V_115 = 0 , V_116 ;
int V_55 = 0 ;
F_52 ( V_117 ) ;
F_59 ( & V_69 -> V_73 ) ;
F_45 ( & V_69 -> V_39 , V_92 ) ;
...
F_48 ( & V_69 -> V_39 , V_92 ) ;
V_116 = F_58 ( V_69 , V_110 ) ;
if ( ! F_14 ( & V_111 ) ) {
V_114 = F_61 ( V_69 , & V_111 ,
& V_112 , & V_115 ) ;
if ( V_110 )
F_60 ( & V_111 , & V_112 ) ;
}
...
F_62 ( V_115 , & V_69 -> V_89 ) ;
F_62 ( V_114 , & V_69 -> V_119 ) ;
F_62 ( V_113 , & V_69 -> V_88 ) ;
F_63 ( & V_69 -> V_73 ) ;
return V_55 ;
}
static void V_75 ( struct V_120 * V_121 )
{
struct V_68 * V_69 = F_64 ( V_121 , struct V_68 , V_74 ) ;
F_42 ( V_69 , 0 ) ;
}
void F_65 ( void * V_105 , int V_122 )
{
struct V_90 * V_91 = V_105 ;
...
void * F_72 ( struct V_44 * V_43 , unsigned long V_123 ,
struct V_16 * V_17 , T_3 * V_124 )
{
struct V_1 * V_2 ;
struct V_90 * V_91 = NULL ;
struct V_3 * V_4 ;
...
V_91 -> V_4 = V_4 ;
V_91 -> V_70 = V_2 ;
V_55 = F_74 ( V_2 -> V_84 , V_91 , V_43 , V_123 ) ;
if ( V_55 == 0 )
* V_124 = V_91 -> V_127 -> V_128 ;
else
F_29 ( V_57 L_4 , V_55 ) ;
V_126:
if ( V_55 ) {
...
struct V_131 * V_127 ;
int V_96 ;
V_127 = F_75 ( V_2 -> V_132 , V_69 -> V_76 ) ;
if ( F_73 ( V_127 ) ) {
V_96 = F_76 ( V_127 ) ;
F_29 ( V_57 L_5 , V_96 ) ;
return V_96 ;
}
V_130 = F_77 ( V_2 -> V_51 , V_69 -> V_76 ) ;
if ( F_73 ( V_130 ) ) {
V_96 = F_76 ( V_130 ) ;
F_29 ( V_57 L_6 , V_96 ) ;
F_78 ( V_127 ) ;
...
static int F_79 ( struct V_133 * V_94 )
{
struct V_90 * V_91 = V_94 -> V_103 ;
struct V_134 V_135 , * V_136 ;
int V_55 ;
F_80 ( V_91 -> V_127 , V_91 -> V_137 ++ ) ;
V_94 -> V_138 = V_91 -> V_127 -> V_128 ;
memset ( & V_135 , 0 , sizeof( V_135 ) ) ;
V_135 . V_139 = V_140 ;
V_135 . V_141 = V_142 ;
V_135 . V_143 . V_144 . V_145 = V_94 -> V_108 . V_49 ;
V_135 . V_143 . V_144 . V_128 = V_94 -> V_138 ;
V_135 . V_143 . V_144 . V_130 = V_91 -> V_130 ;
V_135 . V_143 . V_144 . V_146 = V_94 -> V_108 . V_47 ;
V_135 . V_143 . V_144 . V_147 = V_64 ;
V_135 . V_143 . V_144 . V_148 = V_149 |
V_150 |
V_151 ;
V_135 . V_143 . V_144 . V_152 = 0 ;
V_135 . V_153 = V_154 ;
V_136 = & V_135 ;
V_55 = F_81 ( V_91 -> V_4 -> V_155 , & V_135 , & V_136 ) ;
F_13 ( V_136 != & V_135 ) ;
if ( V_55 )
F_82 ( V_57 L_7 ,
V_156 , __LINE__ , V_55 ) ;
...
{
struct V_134 V_157 , * V_136 ;
int V_55 = 0 ;
if ( ! V_91 -> V_4 -> V_155 || ! V_91 -> V_127 )
goto V_126;
memset ( & V_157 , 0 , sizeof( V_157 ) ) ;
V_157 . V_139 = V_158 ;
V_157 . V_141 = V_159 ;
V_157 . V_160 . V_161 = V_91 -> V_127 -> V_128 ;
V_157 . V_153 = V_154 ;
V_136 = & V_157 ;
V_55 = F_81 ( V_91 -> V_4 -> V_155 , & V_157 , & V_136 ) ;
if ( V_55 ) {
F_82 ( V_57 L_7 ,
V_156 , __LINE__ , V_55 ) ;
goto V_126;
...
V_91 -> V_130 -> V_130 [ V_53 ] = V_52 [ V_53 ] ;
V_55 = F_79 ( V_94 ) ;
if ( V_55 )
goto V_126;
F_52 ( V_163 ) ;
