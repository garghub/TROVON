...
V_13 -> V_48 = V_52 -> V_73 ;
F_12 ( 4 , L_12 , V_9 , V_13 -> V_48 ) ;
V_13 -> V_50 = * V_50 ;
V_13 -> V_52 = V_52 ;
F_44 ( V_1 -> V_7 , ( V_74 * ) V_13 , ( long ) V_13 , NULL ) ;
if ( V_49 > V_75 )
V_13 -> V_76 = V_75 ;
else
V_13 -> V_76 = V_49 ;
...
V_125 = F_70 ( sizeof( struct V_12 ) , V_38 ) ;
if ( ! V_125 ) {
F_12 ( 0 , L_34 , V_9 ) ;
F_55 ( & V_1 -> V_7 -> V_126 , V_89 ) ;
return NULL ;
}
memcpy ( V_125 , V_124 , sizeof( struct V_12 ) ) ;
F_37 ( & V_125 -> V_47 ) ;
F_55 ( & V_1 -> V_7 -> V_126 , V_89 ) ;
...
F_36 ( V_125 ) ;
F_44 ( V_1 -> V_7 , ( V_74 * ) V_125 , ( long ) V_125 , NULL ) ;
return V_125 ;
}
