...
F_30 ( V_106 , * V_96 ) ;
F_30 ( V_107 , * V_96 ) ;
F_30 ( ( * V_96 ) -> V_108 , V_97 ) ;
* V_96 = NULL ;
}
}
static inline char * F_31 ( struct V_2 * V_3 )
{
return F_4 ( V_3 ) ? L_9 : L_10 ;
}
static int F_32 ( struct V_109 * V_110 , void * V_73 )
{
...
F_34 ( V_110 , L_18 ) ;
F_34 ( V_110 , L_19 ) ;
F_34 ( V_110 , L_20 , V_3 -> V_34 ) ;
F_34 ( V_110 , L_21 ) ;
F_34 ( V_110 , L_22 ) ;
F_34 ( V_110 , L_23 , V_3 -> V_59 ) ;
F_34 ( V_110 , L_24 ,
V_3 -> V_113 ) ;
F_34 ( V_110 , L_25 ,
V_3 -> V_18 ) ;
...
static int F_36 ( struct V_114 * V_114 , struct V_115 * V_115 )
{
return F_37 ( V_115 , F_32 , F_38 ( V_114 ) -> V_103 ) ;
}
static int F_39 ( struct V_109 * V_110 , void * V_73 )
{
struct V_2 * V_3 = V_110 -> V_111 ;
struct V_12 * V_13 = V_3 -> V_13 ;
int V_116 ;
...
F_11 ( V_3 ) ;
F_34 ( V_110 , L_27 ,
( V_3 -> V_117 & 0x0010 ) ? L_28 : L_29 ) ;
F_34 ( V_110 , L_30 ,
( V_3 -> V_28 < 0 ) ? L_31 :
( ( V_3 -> V_28 > 0 ) ? L_32 : L_33 ) ) ;
V_116 = abs ( V_3 -> V_28 ) * F_3 ( V_3 ) ;
V_116 *= ( F_4 ( V_3 ) ) ? ( V_3 -> V_38 *
F_2 ( V_3 ) / 1000 ) : 1 ;
F_34 ( V_110 , L_34 , V_116 ,
F_31 ( V_3 ) ) ;
F_34 ( V_110 , L_35 ,
V_3 -> V_54 * F_5 ( V_3 ) ,
F_31 ( V_3 ) ) ;
...
static int F_40 ( struct V_114 * V_114 , struct V_115 * V_115 )
{
return F_37 ( V_115 , F_39 , F_38 ( V_114 ) -> V_103 ) ;
}
static int F_41 ( struct V_109 * V_110 , void * V_73 )
{
struct V_2 * V_3 = V_110 -> V_111 ;
struct V_12 * V_13 = V_3 -> V_13 ;
int V_62 = 0 ;
...
static T_2
F_42 ( struct V_115 * V_115 , const char T_4 * V_118 ,
T_3 V_93 , T_5 * V_119 )
{
struct V_109 * V_110 = V_115 -> V_120 ;
struct V_2 * V_3 = V_110 -> V_111 ;
struct V_12 * V_13 = V_3 -> V_13 ;
char V_121 [ 12 ] = { '\0' } ;
int V_62 = 0 ;
...
if ( V_93 > sizeof( V_121 ) - 1 ) {
V_62 = - V_17 ;
goto V_78;
}
if ( F_43 ( V_121 , V_118 , V_93 ) ) {
V_62 = - V_122 ;
goto V_78;
}
V_121 [ V_93 ] = 0 ;
V_3 -> V_79 = F_44 ( V_121 , NULL , 0 ) /
F_5 ( V_3 ) ;
F_19 ( V_3 ) ;
V_78:
F_35 ( & V_13 -> V_112 ) ;
...
static int F_45 ( struct V_114 * V_114 , struct V_115 * V_115 )
{
return F_37 ( V_115 , F_41 , F_38 ( V_114 ) -> V_103 ) ;
}
static int F_46 ( struct V_109 * V_110 , void * V_73 )
{
struct V_12 * V_13 = V_110 -> V_111 ;
F_33 ( & V_13 -> V_112 ) ;
F_34 ( V_110 , L_41 ,
V_13 -> V_16 ? L_42 : L_43 ) ;
F_35 ( & V_13 -> V_112 ) ;
...
static int F_47 ( struct V_114 * V_114 , struct V_115 * V_115 )
{
return F_37 ( V_115 , F_46 , F_38 ( V_114 ) -> V_103 ) ;
}
static int F_48 ( struct V_2 * V_3 )
{
int V_62 = 0 , V_123 = V_3 -> V_24 ;
T_1 V_117 ;
if ( V_3 -> V_13 -> V_84 ) {
V_62 = F_13 ( V_3 -> V_13 -> V_64 , V_65 ,
V_66 , 0x01 , ( V_67 * ) & V_117 ) ;
if ( ! V_62 )
V_3 -> V_24 = V_117 & ( 1 << V_3 -> V_82 ) ;
V_117 &= 0x0fff ;
V_117 |= 1 << ( V_3 -> V_82 + 12 ) ;
F_20 ( V_3 -> V_13 -> V_64 , V_85 ,
V_66 , 0x01 , ( V_67 * ) & V_117 , 2 ) ;
} else if ( V_3 -> V_82 == 0 )
V_3 -> V_24 = 1 ;
if ( V_62 || ! V_3 -> V_24 )
return V_62 ;
...
static int F_49 ( struct V_12 * V_13 , int V_82 )
{
...
V_3 -> V_130 . V_136 = F_9 ;
V_62 = F_51 ( & V_13 -> V_88 -> V_89 , & V_3 -> V_130 ) ;
if ( V_62 )
goto V_78;
V_62 = F_52 ( V_3 -> V_130 . V_89 , & V_137 ) ;
if ( V_62 )
goto V_78;
V_3 -> V_138 = 1 ;
V_78:
...
static void F_53 ( struct V_12 * V_13 , int V_82 )
{
struct V_2 * V_3 = & V_13 -> V_3 [ V_82 ] ;
if ( V_3 -> V_130 . V_89 ) {
if ( V_3 -> V_138 )
F_54 ( V_3 -> V_130 . V_89 , & V_137 ) ;
F_55 ( & V_3 -> V_130 ) ;
}
#ifdef F_50
if ( V_3 -> V_125 )
F_29 ( & V_3 -> V_125 , V_126 ) ;
#endif
}
...
#ifdef F_50
if ( V_13 -> V_139 )
F_29 ( & V_13 -> V_139 , V_140 ) ;
#endif
}
static void F_58 ( void * V_146 )
{
int V_82 ;
...
V_13 -> V_16 ) ;
#endif
F_61 ( & V_13 -> V_143 . V_89 -> V_151 , V_152 ) ;
}
if ( V_13 -> V_84 ) {
...
V_130 -> V_24 ) ;
#endif
F_61 ( & V_130 -> V_130 . V_89 -> V_151 , V_152 ) ;
}
}
}
static int F_62 ( struct V_155 * V_88 )
{
struct V_12 * V_13 ;
int V_62 = 0 ;
int V_82 ;
V_13 = F_63 ( sizeof( struct V_12 ) , V_156 ) ;
if ( ! V_13 ) {
V_62 = - V_157 ;
goto V_78;
}
F_64 ( & V_13 -> V_112 ) ;
V_13 -> V_64 = F_65 ( V_88 -> V_158 ) ;
V_13 -> V_88 = V_88 ;
strcpy ( F_66 ( V_88 ) , V_159 ) ;
strcpy ( F_67 ( V_88 ) , V_160 ) ;
V_88 -> V_161 = V_13 ;
V_62 = F_56 ( V_13 ) ;
if ( V_62 )
goto V_78;
...
F_49 ( V_13 , 0 ) ;
F_68 ( V_13 -> V_64 , F_58 , V_13 ) ;
V_78:
if ( V_62 )
F_69 ( V_88 , 0 ) ;
return V_62 ;
}
static int F_69 ( struct V_155 * V_88 , int type )
{
struct V_12 * V_13 ;
int V_82 ;
if ( ! V_88 )
...
static int F_76 ( struct V_155 * V_88 )
{
struct V_12 * V_13 ;
if ( ! V_88 )
return - V_17 ;
