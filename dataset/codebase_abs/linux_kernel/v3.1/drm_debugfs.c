...
if ( ! V_17 ) {
char V_26 [ 64 ] ;
strncpy ( V_26 , V_12 -> V_30 . V_26 ,
F_6 ( V_12 -> V_30 . V_31 , 64U ) ) ;
F_7 ( L_1 ,
V_26 , V_9 [ V_19 ] . V_26 ) ;
F_8 ( V_18 ) ;
V_20 = - 1 ;
...
int F_11 ( struct V_13 * V_14 , int V_35 ,
struct V_11 * V_12 )
{
struct V_15 * V_16 = V_14 -> V_16 ;
char V_26 [ 64 ] ;
...
int F_10 ( struct V_8 * V_9 , int V_10 ,
struct V_13 * V_14 )
{
...
int V_19 ;
for ( V_19 = 0 ; V_19 < V_10 ; V_19 ++ ) {
F_15 (pos, q, &minor->debugfs_nodes.list) {
V_18 = F_16 ( V_41 , struct V_3 , V_33 ) ;
