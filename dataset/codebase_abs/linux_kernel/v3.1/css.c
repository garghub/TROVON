...
static int F_133 ( struct V_144 * V_145 , void * V_76 )
{
struct V_146 * V_147 = F_134 ( V_145 ) ;
if ( V_147 -> V_148 )
return V_147 -> V_148 () ;
return 0 ;
}
...
return - V_149 ;
F_87 ( V_37 ) ;
return F_138 ( & V_20 , NULL , NULL , F_133 ) ;
}
...
if ( ! V_151 )
continue;
F_143 ( V_45 , & V_151 -> V_153 ) ;
}
}
static T_1 F_144 ( struct V_154 * V_154 , const char T_5 * V_51 ,
T_4 V_113 , T_6 * V_155 )
{
int V_4 ;
F_145 () ;
...
static int F_149 ( struct V_10 * V_11 , struct V_144 * V_145 )
{
struct V_12 * V_13 = F_5 ( V_11 ) ;
struct V_146 * V_59 = F_134 ( V_145 ) ;
struct V_160 * V_46 ;
...
static int F_153 ( struct V_10 * V_11 , struct V_165 * V_166 )
{
struct V_12 * V_13 = F_5 ( V_11 ) ;
int V_4 ;
V_4 = F_154 ( V_166 , L_23 , V_13 -> V_52 ) ;
if ( V_4 )
return V_4 ;
V_4 = F_154 ( V_166 , L_24 , V_13 -> V_52 ) ;
return V_4 ;
}
...
int F_161 ( struct V_146 * V_172 )
{
V_172 -> V_145 . V_55 = & V_20 ;
return F_162 ( & V_172 -> V_145 ) ;
}
void F_163 ( struct V_146 * V_172 )
{
F_164 ( & V_172 -> V_145 ) ;
}
