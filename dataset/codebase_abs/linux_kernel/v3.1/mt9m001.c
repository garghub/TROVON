...
int V_13 ;
F_37 ( ! V_23 -> V_113 ||
F_38 ( V_23 -> V_113 ) -> V_114 != V_23 -> V_115 ) ;
...
{
struct V_25 * V_26 = F_17 ( V_23 ) ;
F_13 ( V_23 -> V_122 , L_11 ,
V_23 -> V_113 , V_23 -> V_123 ) ;
if ( V_26 -> V_124 )
V_26 -> V_124 ( V_26 ) ;
}
static int F_42 ( struct V_18 * V_19 , T_4 * V_125 )
{
struct V_8 * V_9 = F_15 ( V_19 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
* V_125 = V_7 -> V_59 ;
...
static int F_43 ( struct V_18 * V_19 , unsigned int V_126 ,
enum V_2 * V_3 )
{
struct V_8 * V_9 = F_15 ( V_19 ) ;
struct V_7 * V_7 = F_2 ( V_9 ) ;
...
struct V_7 * V_7 ;
struct V_22 * V_23 = V_9 -> V_14 . V_43 ;
struct V_129 * V_130 = F_45 ( V_9 -> V_14 . V_113 ) ;
struct V_25 * V_26 ;
int V_13 ;
if ( ! V_23 ) {
F_39 ( & V_9 -> V_14 , L_12 ) ;
...
V_7 = F_48 ( sizeof( struct V_7 ) , V_132 ) ;
if ( ! V_7 )
return - V_133 ;
F_49 ( & V_7 -> V_10 , V_9 , & V_134 ) ;
V_23 -> V_70 = & V_108 ;
V_7 -> V_59 = 0 ;
V_7 -> V_41 . V_51 = V_52 ;
V_7 -> V_41 . V_55 = V_56 ;
