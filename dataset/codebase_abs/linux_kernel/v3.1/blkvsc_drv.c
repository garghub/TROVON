...
F_8 ( & V_17 -> V_48 , V_47 ) ;
F_22 ( V_17 , V_96 ) ;
F_46 ( (struct V_113 * ) V_18 -> V_114 ) ;
}
static int F_47 ( struct V_115 * V_116 , T_1 V_44 )
{
struct V_16 * V_17 = V_116 -> V_46 ;
unsigned long V_47 ;
F_7 ( & V_17 -> V_48 , V_47 ) ;
if ( ( -- V_17 -> V_49 == 0 ) && ( V_17 -> V_110 ) ) {
F_38 ( V_17 -> V_111 -> V_112 ) ;
F_8 ( & V_17 -> V_48 , V_47 ) ;
F_22 ( V_17 , V_96 ) ;
F_39 ( V_17 -> V_111 ) ;
...
F_53 (blkvsc_req, &group->blkvsc_req_list, req_entry) {
if ( V_125 ) {
F_52 ( & V_14 -> V_108 ,
& V_17 -> V_137 ) ;
} else {
...
V_144 -> V_148 . V_149 = V_150 ;
V_6 = F_61 ( & V_144 -> V_148 ) ;
return V_6 ;
}
...
static int F_64 ( struct V_1 * V_18 )
{
struct V_16 * V_17 = NULL ;
struct V_4 V_5 ;
struct V_151 V_152 ;
int V_6 = 0 ;
V_17 = F_65 ( sizeof( struct V_16 ) , V_84 ) ;
if ( ! V_17 ) {
V_6 = - V_85 ;
goto V_98;
}
...
goto V_98;
if ( V_152 . V_154 ) {
V_6 = F_71 ( V_152 . V_155 , V_152 . V_156 ) ;
if ( V_6 != 0 ) {
F_72 ( V_157 ,
L_2 , V_6 ) ;
goto remove;
...
F_73 ( V_157 , L_3 ,
V_152 . V_155 ) ;
V_17 -> V_111 = F_74 ( V_158 ) ;
if ( ! V_17 -> V_111 ) {
V_6 = - 1 ;
goto V_98;
}
V_17 -> V_111 -> V_112 = F_75 ( V_13 , & V_17 -> V_48 ) ;
F_76 ( V_17 -> V_111 -> V_112 , V_135 ) ;
F_77 ( V_17 -> V_111 -> V_112 , V_132 ) ;
F_78 ( V_17 -> V_111 -> V_112 , V_135 - 1 ) ;
F_79 ( V_17 -> V_111 -> V_112 , V_159 ) ;
F_80 ( V_17 -> V_111 -> V_112 , 511 ) ;
...
V_17 -> V_111 -> V_164 = & ( V_17 -> V_40 -> V_2 ) ;
sprintf ( V_17 -> V_111 -> V_165 , L_4 , 'a' + V_152 . V_160 ) ;
F_22 ( V_17 , V_89 ) ;
F_22 ( V_17 , V_92 ) ;
F_81 ( V_17 -> V_111 , V_17 -> V_94 * ( V_17 -> V_93 / 512 ) ) ;
F_82 ( V_17 -> V_111 -> V_112 , V_17 -> V_93 ) ;
F_83 ( V_17 -> V_111 ) ;
F_73 ( V_157 , L_5 ,
V_17 -> V_111 -> V_165 , ( unsigned long ) V_17 -> V_94 ,
V_17 -> V_93 ) ;
return V_6 ;
remove:
F_42 ( V_18 ) ;
