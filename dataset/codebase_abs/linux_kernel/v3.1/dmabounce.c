...
T_3 F_31 ( struct V_1 * V_2 , struct V_43 * V_43 ,
...
V_34 = F_32 ( V_2 , F_33 ( V_43 ) ) + V_44 ;
V_45 = F_24 ( V_2 , V_34 , V_18 ) ;
if ( V_45 < 0 )
return ~ 0 ;
if ( V_45 == 0 ) {
F_34 ( V_43 , V_44 , V_18 , V_20 ) ;
return V_34 ;
}
if ( F_35 ( V_43 ) ) {
F_23 ( V_2 , L_14 ) ;
...
return F_25 ( V_2 , F_36 ( V_43 ) + V_44 , V_18 , V_20 ) ;
}
...
if ( ! V_5 ) {
F_38 ( F_39 ( F_40 ( V_2 , V_34 ) ) ,
V_34 & ~ V_46 , V_18 , V_20 ) ;
return;
}
F_28 ( V_2 , V_5 , V_18 , V_20 ) ;
}
int F_41 ( struct V_1 * V_2 , T_3 V_47 ,
unsigned long V_48 , T_2 V_49 , enum V_19 V_20 )
{
struct V_16 * V_5 ;
F_3 ( V_2 , L_16 ,
V_24 , V_47 , V_48 , V_49 , V_20 ) ;
V_5 = F_21 ( V_2 , V_47 , V_24 ) ;
if ( ! V_5 )
return 1 ;
F_29 ( V_5 -> V_26 != V_20 ) ;
F_3 ( V_2 , L_10 ,
...
if ( V_20 == V_42 || V_20 == V_41 ) {
F_3 ( V_2 , L_12 ,
V_24 , V_5 -> V_27 + V_48 , V_5 -> V_17 + V_48 , V_49 ) ;
memcpy ( V_5 -> V_17 + V_48 , V_5 -> V_27 + V_48 , V_49 ) ;
}
return 0 ;
}
int F_42 ( struct V_1 * V_2 , T_3 V_47 ,
unsigned long V_48 , T_2 V_49 , enum V_19 V_20 )
{
struct V_16 * V_5 ;
F_3 ( V_2 , L_16 ,
...
if ( V_20 == V_40 || V_20 == V_41 ) {
F_3 ( V_2 , L_17 ,
V_24 , V_5 -> V_17 + V_48 , V_5 -> V_27 + V_48 , V_49 ) ;
memcpy ( V_5 -> V_27 + V_48 , V_5 -> V_17 + V_48 , V_49 ) ;
}
return 0 ;
}
static int F_43 ( struct V_21 * V_22 , struct V_1 * V_2 ,
const char * V_50 , unsigned long V_18 )
{
V_22 -> V_18 = V_18 ;
F_26 ( V_22 -> V_11 = 0 ) ;
V_22 -> V_22 = F_44 ( V_50 , V_2 , V_18 ,
0 ,
0 ) ;
return V_22 -> V_22 ? 0 : - V_51 ;
}
int F_45 ( struct V_1 * V_2 , unsigned long V_52 ,
unsigned long V_53 ,
int (* F_46)( struct V_1 * , T_3 , T_2 ) )
{
struct V_6 * V_7 ;
int V_45 ;
