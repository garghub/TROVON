...
if ( V_60 -> V_70 == 0 )
return - V_68 ;
V_64 = F_46 ( V_60 -> V_70 * ( sizeof *V_64 ) , V_20 ) ;
if ( ! V_64 )
return - V_21 ;
V_63 = NULL ;
V_19 = 0 ;
...
V_64 [ V_19 ] . V_9 = F_49 ( V_63 , 0 , & V_72 ) ;
V_64 [ V_19 ] . V_34 = V_72 & V_73 ;
V_65 = F_44 ( V_63 , L_10 , & V_66 ) ;
if ( ! V_65 ) {
F_35 ( V_48 , L_11 , V_64 [ V_19 ] . V_9 ) ;
goto V_74;
}
V_64 [ V_19 ] . V_24 = F_50 ( V_65 ) ;
V_64 [ V_19 ] . V_46 = F_44 ( V_63 , L_12 , & V_66 ) ;
V_65 = F_44 ( V_63 , L_13 , & V_66 ) ;
V_64 [ V_19 ] . type = V_65 ? F_50 ( V_65 ) : V_2 ;
V_64 [ V_19 ] . V_75 = ! ! F_44 ( V_63 , L_14 , NULL ) ;
V_65 = F_44 ( V_63 , L_15 , & V_66 ) ;
V_64 [ V_19 ] . V_52 = V_65 ? F_50 ( V_65 ) : 5 ;
V_19 ++ ;
}
V_60 -> V_64 = V_64 ;
return 0 ;
...
{
struct V_59 * V_60 = V_45 -> V_48 . V_77 ;
struct V_12 * V_13 ;
struct V_47 * V_48 = & V_45 -> V_48 ;
struct V_59 V_78 ;
struct V_31 * V_32 ;
...
int V_75 = 0 ;
if ( ! V_60 ) {
error = F_43 ( V_48 , & V_78 ) ;
if ( error )
return error ;
V_60 = & V_78 ;
}
V_13 = F_46 ( sizeof( struct V_12 ) +
V_60 -> V_70 * sizeof( struct V_5 ) ,
V_20 ) ;
V_32 = F_52 () ;
if ( ! V_13 || ! V_32 ) {
F_35 ( V_48 , L_16 ) ;
...
F_54 ( V_45 , V_13 ) ;
F_55 ( V_32 , V_13 ) ;
V_32 -> V_80 = V_60 -> V_80 ? : V_45 -> V_80 ;
V_32 -> V_81 = L_17 ;
V_32 -> V_48 . V_57 = & V_45 -> V_48 ;
V_32 -> V_82 = F_40 ;
V_32 -> V_83 = F_42 ;
V_32 -> V_84 . V_85 = V_86 ;
V_32 -> V_84 . V_87 = 0x0001 ;
V_32 -> V_84 . V_88 = 0x0001 ;
V_32 -> V_84 . V_89 = 0x0100 ;
if ( V_60 -> V_69 )
F_12 ( V_90 , V_32 -> V_91 ) ;
for ( V_19 = 0 ; V_19 < V_60 -> V_70 ; V_19 ++ ) {
...
error = F_57 ( & V_45 -> V_48 . V_92 , & V_93 ) ;
if ( error ) {
F_35 ( V_48 , L_18 ,
error ) ;
goto V_50;
