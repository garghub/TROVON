...
{
#ifdef F_6
unsigned long V_83 = ( unsigned long ) V_27 + ( 4UL << 20 ) ;
if ( ! V_28 || ! V_29 )
return;
if ( V_28 >= V_83 )
return;
memmove ( ( void * ) V_83 , ( void * ) V_28 , V_29 ) ;
V_28 = V_83 ;
#endif
}
...
V_85 = V_21 + V_14 ;
V_84 = V_21 + V_14 + 1 ;
V_70 = F_40 ( V_84 , V_86 - V_14 - 1 ) ;
if ( V_70 ) {
if ( * V_84 == '=' )
memmove ( V_21 , V_84 + 1 , V_70 ) ;
else
* V_85 = ' ' ;
}
}
