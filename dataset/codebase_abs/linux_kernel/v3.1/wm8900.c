...
static int F_24 ( struct V_33 * V_85 , int V_132 )
{
struct V_1 * V_2 = V_85 -> V_2 ;
T_1 V_3 ;
V_3 = F_5 ( V_2 , V_46 ) ;
...
static int F_28 ( struct V_1 * V_2 , T_3 V_152 )
{
struct V_68 * V_69 = F_20 ( V_2 ) ;
int V_71 = V_69 -> V_71 ;
int V_70 = V_69 -> V_70 ;
...
struct V_68 * V_69 = F_20 ( V_2 ) ;
int V_153 = 0 , V_3 ;
V_153 = F_34 ( V_2 , 8 , 16 , V_69 -> V_159 ) ;
if ( V_153 != 0 ) {
F_29 ( V_2 -> V_154 , L_8 , V_153 ) ;
return V_153 ;
}
V_3 = F_5 ( V_2 , V_4 ) ;
if ( V_3 != 0x8900 ) {
F_29 ( V_2 -> V_154 , L_9 , V_3 ) ;
return - V_160 ;
}
F_2 ( V_2 ) ;
F_25 ( V_2 , V_142 ) ;
...
static int T_4 F_37 ( struct V_173 * V_174 )
{
struct V_68 * V_69 ;
int V_153 ;
V_69 = F_38 ( sizeof( struct V_68 ) , V_157 ) ;
if ( V_69 == NULL )
return - V_175 ;
V_69 -> V_159 = V_176 ;
F_39 ( V_174 , V_69 ) ;
V_153 = F_40 ( & V_174 -> V_154 ,
& V_177 , & V_178 , 1 ) ;
if ( V_153 < 0 )
F_32 ( V_69 ) ;
return V_153 ;
}
static int T_5 F_41 ( struct V_173 * V_174 )
{
F_42 ( & V_174 -> V_154 ) ;
F_32 ( F_43 ( V_174 ) ) ;
return 0 ;
}
static T_4 int F_44 ( struct V_179 * V_180 ,
...
F_45 ( V_180 , V_69 ) ;
V_69 -> V_159 = V_183 ;
V_153 = F_40 ( & V_180 -> V_154 ,
& V_177 , & V_178 , 1 ) ;
if ( V_153 < 0 )
F_32 ( V_69 ) ;
return V_153 ;
}
static T_5 int F_46 ( struct V_179 * V_184 )
{
F_42 ( & V_184 -> V_154 ) ;
F_32 ( F_47 ( V_184 ) ) ;
return 0 ;
