...
struct V_46 * V_46 ;
#ifdef F_119
V_46 = F_120 ( V_127 -> V_132 >> V_29 ) ;
F_121 ( ( unsigned long ) V_127 ,
sizeof( struct V_126 ) ) ;
#else
V_46 = F_122 ( V_127 ) ;
#endif
...
static void T_4 F_125 ( struct V_20 * V_21 )
{
unsigned long V_49 ;
...
static char * T_4 F_127 ( char * V_135 , unsigned long V_136 )
{
if ( V_136 >= ( 1UL << 30 ) )
...
F_129 ( V_137 L_4
L_5 ,
F_127 ( V_135 , F_66 ( V_21 ) ) ,
V_21 -> V_56 ) ;
}
}
static void F_130 ( struct V_20 * V_21 , unsigned long V_138 ,
T_2 * V_93 )
{
int V_49 ;
if ( V_21 -> V_28 >= V_68 )
return;
F_131 (i, *nodes_allowed) {
...
static inline void F_130 ( struct V_20 * V_21 , unsigned long V_138 ,
T_2 * V_93 )
{
}
static int F_133 ( struct V_20 * V_21 , T_2 * V_93 ,
int V_106 )
{
int V_96 , V_97 ;
int V_98 = 0 ;
...
static unsigned long F_134 ( struct V_20 * V_21 , unsigned long V_138 ,
T_2 * V_93 )
{
...
return V_21 -> V_134 ;
F_73 ( & V_82 ) ;
while ( V_21 -> V_84 && V_138 > F_135 ( V_21 ) ) {
if ( ! F_133 ( V_21 , V_93 , - 1 ) )
break;
}
while ( V_138 > F_135 ( V_21 ) ) {
F_74 ( & V_82 ) ;
V_98 = F_95 ( V_21 , V_93 ) ;
F_73 ( & V_82 ) ;
if ( ! V_98 )
...
F_130 ( V_21 , V_140 , V_93 ) ;
while ( V_140 < F_135 ( V_21 ) ) {
if ( ! F_98 ( V_21 , V_93 , 0 ) )
break;
}
while ( V_138 < F_135 ( V_21 ) ) {
...
static struct V_20 * F_137 ( struct V_143 * V_144 , int * V_145 )
{
int V_49 ;
...
return F_138 ( V_144 , V_145 ) ;
}
static T_5 F_139 ( struct V_143 * V_144 ,
struct V_149 * V_150 , char * V_135 )
{
struct V_20 * V_21 ;
unsigned long V_69 ;
int V_53 ;
V_21 = F_137 ( V_144 , & V_53 ) ;
if ( V_53 == V_105 )
V_69 = V_21 -> V_69 ;
else
V_69 = V_21 -> V_70 [ V_53 ] ;
...
unsigned long V_138 ;
struct V_20 * V_21 ;
F_141 ( T_2 , V_93 , V_13 | V_153 ) ;
V_67 = F_142 ( V_135 , 10 , & V_138 ) ;
if ( V_67 )
goto V_141;
V_21 = F_137 ( V_144 , & V_53 ) ;
if ( V_21 -> V_28 >= V_68 ) {
...
V_93 = & V_113 [ V_114 ] ;
V_21 -> V_134 = F_134 ( V_21 , V_138 , V_93 ) ;
if ( V_93 != & V_113 [ V_114 ] )
F_144 ( V_93 ) ;
return V_152 ;
V_141:
...
static T_5 F_146 ( struct V_143 * V_144 ,
struct V_149 * V_150 , char * V_135 )
{
return F_139 ( V_144 , V_150 , V_135 ) ;
}
static T_5 F_147 ( struct V_143 * V_144 ,
struct V_149 * V_150 , const char * V_135 , T_6 V_152 )
{
return F_140 ( false , V_144 , V_150 , V_135 , V_152 ) ;
}
...
struct V_149 * V_150 , const char * V_135 , T_6 V_152 )
{
return F_140 ( true , V_144 , V_150 , V_135 , V_152 ) ;
}
static T_5 F_150 ( struct V_143 * V_144 ,
struct V_149 * V_150 , char * V_135 )
{
struct V_20 * V_21 = F_137 ( V_144 , NULL ) ;
...
static int F_155 ( struct V_20 * V_21 , struct V_143 * V_156 ,
struct V_143 * * V_147 ,
struct V_157 * V_158 )
{
int V_159 ;
int V_160 = V_21 - V_148 ;
V_147 [ V_160 ] = F_156 ( V_21 -> V_161 , V_156 ) ;
if ( ! V_147 [ V_160 ] )
return - V_14 ;
V_159 = F_157 ( V_147 [ V_160 ] , V_158 ) ;
if ( V_159 )
F_158 ( V_147 [ V_160 ] ) ;
return V_159 ;
}
...
struct V_20 * V_21 ;
int V_67 ;
V_162 = F_156 ( L_7 , V_163 ) ;
if ( ! V_162 )
return;
F_65 (h) {
V_67 = F_155 ( V_21 , V_162 ,
V_147 , & V_158 ) ;
if ( V_67 )
F_129 ( V_164 L_8 ,
V_21 -> V_161 ) ;
...
if ( V_167 -> V_162 )
return;
V_167 -> V_162 = F_156 ( L_7 ,
& V_169 -> V_170 . V_144 ) ;
if ( ! V_167 -> V_162 )
return;
F_65 (h) {
V_67 = F_155 ( V_21 , V_167 -> V_162 ,
V_167 -> V_147 ,
& V_173 ) ;
if ( V_67 ) {
F_129 ( V_164 L_8
...
static int T_4 F_170 ( char * V_186 )
{
unsigned long * V_187 ;
...
{
V_175 = F_172 ( V_186 , & V_186 ) ;
return 1 ;
}
static unsigned int F_173 ( unsigned int * V_189 )
{
int V_169 ;
unsigned int V_190 = 0 ;
F_131 (node, cpuset_current_mems_allowed)
V_190 += V_189 [ V_169 ] ;
return V_190 ;
}
static int F_174 ( bool V_151 ,
...
V_98 = F_175 ( V_192 , V_193 , V_194 , V_195 , V_196 ) ;
if ( V_98 )
goto V_141;
if ( V_193 ) {
F_141 ( T_2 , V_93 ,
...
V_21 -> V_134 = F_134 ( V_21 , V_108 , V_93 ) ;
if ( V_93 != & V_113 [ V_114 ] )
F_144 ( V_93 ) ;
}
V_141:
...
int F_176 ( struct V_191 * V_192 , int V_193 ,
void T_8 * V_194 , T_6 * V_195 , T_9 * V_196 )
{
return F_174 ( false , V_192 , V_193 ,
V_194 , V_195 , V_196 ) ;
}
int F_177 ( struct V_191 * V_192 , int V_193 ,
void T_8 * V_194 , T_6 * V_195 , T_9 * V_196 )
{
return F_174 ( true , V_192 , V_193 ,
V_194 , V_195 , V_196 ) ;
}
...
T_6 * V_195 , T_9 * V_196 )
{
F_179 ( V_192 , V_193 , V_194 , V_195 , V_196 ) ;
if ( V_199 )
V_66 = V_200 ;
else
V_66 = V_201 ;
...
int F_180 ( struct V_191 * V_192 , int V_193 ,
void T_8 * V_194 ,
T_6 * V_195 , T_9 * V_196 )
{
struct V_20 * V_21 = & V_180 ;
...
static int F_185 ( struct V_20 * V_21 , long V_106 )
{
int V_98 = - V_14 ;
F_73 ( & V_82 ) ;
if ( V_106 > 0 ) {
...
static int F_190 ( struct V_22 * V_23 , struct V_206 * V_207 )
{
F_160 () ;
return 0 ;
}
static T_10 F_191 ( struct V_22 * V_23 , struct V_46 * V_46 ,
int V_208 )
{
T_10 V_209 ;
if ( V_208 ) {
V_209 =
F_192 ( F_193 ( F_194 ( V_46 , V_23 -> V_210 ) ) ) ;
} else {
V_209 = F_195 ( F_194 ( V_46 , V_23 -> V_210 ) ) ;
}
V_209 = F_196 ( V_209 ) ;
V_209 = F_197 ( V_209 ) ;
return V_209 ;
...
{
T_10 V_209 ;
V_209 = F_192 ( F_193 ( F_199 ( V_211 ) ) ) ;
if ( F_200 ( V_23 , V_24 , V_211 , V_209 , 1 ) )
F_201 ( V_23 , V_24 , V_211 ) ;
}
int F_202 ( struct V_212 * V_47 , struct V_212 * V_48 ,
struct V_22 * V_23 )
{
...
V_213 = F_203 ( V_48 , V_115 ) ;
if ( ! V_213 )
continue;
V_214 = F_204 ( V_47 , V_115 , V_217 ) ;
if ( ! V_214 )
goto V_220;
if ( V_214 == V_213 )
continue;
F_73 ( & V_47 -> V_221 ) ;
F_205 ( & V_48 -> V_221 , V_222 ) ;
if ( ! F_206 ( F_199 ( V_213 ) ) ) {
if ( V_216 )
F_207 ( V_48 , V_115 , V_213 ) ;
V_209 = F_199 ( V_213 ) ;
V_215 = F_208 ( V_209 ) ;
F_209 ( V_215 ) ;
F_210 ( V_215 ) ;
F_211 ( V_47 , V_115 , V_214 , V_209 ) ;
}
F_74 ( & V_48 -> V_221 ) ;
F_74 ( & V_47 -> V_221 ) ;
}
...
static int F_212 ( T_10 V_223 )
{
T_11 V_224 ;
if ( F_206 ( V_223 ) || F_213 ( V_223 ) )
return 0 ;
V_224 = F_214 ( V_223 ) ;
if ( F_215 ( V_224 ) && F_216 ( V_224 ) )
return 1 ;
else
return 0 ;
}
static int F_217 ( T_10 V_223 )
{
T_11 V_224 ;
if ( F_206 ( V_223 ) || F_213 ( V_223 ) )
return 0 ;
V_224 = F_214 ( V_223 ) ;
if ( F_215 ( V_224 ) && F_218 ( V_224 ) )
return 1 ;
else
return 0 ;
}
void F_219 ( struct V_22 * V_23 , unsigned long V_204 ,
...
F_220 ( V_228 ) ;
F_124 ( ! F_22 ( V_23 ) ) ;
F_70 ( V_204 & ~ F_221 ( V_21 ) ) ;
F_70 ( V_16 & ~ F_221 ( V_21 ) ) ;
F_222 ( V_226 , V_204 , V_16 ) ;
F_73 ( & V_226 -> V_221 ) ;
for ( V_24 = V_204 ; V_24 < V_16 ; V_24 += V_217 ) {
V_211 = F_203 ( V_226 , V_24 ) ;
if ( ! V_211 )
continue;
if ( F_223 ( V_226 , & V_24 , V_211 ) )
continue;
if ( V_225 ) {
V_223 = F_199 ( V_211 ) ;
if ( F_206 ( V_223 ) )
...
F_74 ( & V_226 -> V_221 ) ;
F_227 ( V_23 , V_204 , V_16 ) ;
F_228 ( V_226 , V_204 , V_16 ) ;
...
void F_230 ( struct V_22 * V_23 , unsigned long V_204 ,
unsigned long V_16 , struct V_46 * V_225 )
{
F_231 ( & V_23 -> V_116 -> V_117 -> V_230 ) ;
F_219 ( V_23 , V_204 , V_16 , V_225 ) ;
F_232 ( & V_23 -> V_116 -> V_117 -> V_230 ) ;
}
static int F_233 ( struct V_212 * V_226 , struct V_22 * V_23 ,
...
struct V_232 V_233 ;
T_1 V_234 ;
V_24 = V_24 & F_221 ( V_21 ) ;
V_234 = ( ( V_24 - V_23 -> V_25 ) >> V_29 )
+ ( V_23 -> V_26 >> V_29 ) ;
V_81 = (struct V_80 * ) F_68 ( V_46 ) ;
F_231 ( & V_81 -> V_230 ) ;
F_234 (iter_vma, &iter, &mapping->i_mmap, pgoff, pgoff) {
if ( V_231 == V_23 )
continue;
if ( ! F_34 ( V_231 , V_45 ) )
F_219 ( V_231 ,
...
static int F_235 ( struct V_212 * V_226 , struct V_22 * V_23 ,
...
if ( V_238 ) {
if ( F_236 ( V_236 ) )
F_237 ( V_236 , V_23 , V_24 ) ;
F_198 ( V_23 , V_24 , V_211 ) ;
return 0 ;
}
if ( ! ( V_23 -> V_37 & V_38 ) &&
F_34 ( V_23 , V_45 ) &&
...
F_238 ( V_236 ) ;
F_74 ( & V_226 -> V_221 ) ;
V_237 = F_108 ( V_23 , V_24 , V_239 ) ;
if ( F_239 ( V_237 ) ) {
F_240 ( V_236 ) ;
if ( V_239 ) {
F_70 ( F_206 ( V_223 ) ) ;
if ( F_233 ( V_226 , V_23 , V_236 , V_24 ) ) {
F_70 ( F_71 ( V_236 ) != 1 ) ;
F_70 ( F_206 ( V_223 ) ) ;
F_73 ( & V_226 -> V_221 ) ;
goto V_240;
...
F_244 ( V_237 , V_236 , V_24 , V_23 ,
F_40 ( V_21 ) ) ;
F_245 ( V_237 ) ;
F_73 ( & V_226 -> V_221 ) ;
V_211 = F_203 ( V_226 , V_24 & F_221 ( V_21 ) ) ;
if ( F_246 ( F_247 ( F_199 ( V_211 ) , V_223 ) ) ) {
F_222 ( V_226 ,
V_24 & F_221 ( V_21 ) ,
( V_24 & F_221 ( V_21 ) ) + F_66 ( V_21 ) ) ;
F_248 ( V_23 , V_24 , V_211 ) ;
F_211 ( V_226 , V_24 , V_211 ,
F_191 ( V_23 , V_237 , 1 ) ) ;
F_229 ( V_236 ) ;
F_249 ( V_237 , V_23 , V_24 ) ;
V_237 = V_236 ;
F_228 ( V_226 ,
V_24 & F_221 ( V_21 ) ,
( V_24 & F_221 ( V_21 ) ) + F_66 ( V_21 ) ) ;
...
static struct V_46 * F_250 ( struct V_20 * V_21 ,
struct V_22 * V_23 , unsigned long V_24 )
{
struct V_80 * V_81 ;
T_1 V_120 ;
...
return F_251 ( V_81 , V_120 ) ;
}
static bool F_252 ( struct V_20 * V_21 ,
struct V_22 * V_23 , unsigned long V_24 )
{
struct V_80 * V_81 ;
T_1 V_120 ;
...
V_81 = V_23 -> V_116 -> V_117 ;
V_120 = F_16 ( V_21 , V_23 , V_24 ) ;
V_46 = F_253 ( V_81 , V_120 ) ;
if ( V_46 )
F_77 ( V_46 ) ;
return V_46 != NULL ;
}
static int F_254 ( struct V_212 * V_226 , struct V_22 * V_23 ,
...
V_120 = F_16 ( V_21 , V_23 , V_24 ) ;
V_111:
V_46 = F_251 ( V_81 , V_120 ) ;
if ( ! V_46 ) {
V_79 = F_255 ( V_81 -> V_119 ) >> F_17 ( V_21 ) ;
if ( V_120 >= V_79 )
goto V_141;
...
F_256 ( V_46 , V_24 , F_40 ( V_21 ) ) ;
F_245 ( V_46 ) ;
if ( V_23 -> V_37 & V_38 ) {
int V_67 ;
struct V_118 * V_118 = V_81 -> V_119 ;
V_67 = F_257 ( V_46 , V_81 , V_120 , V_13 ) ;
if ( V_67 ) {
F_77 ( V_46 ) ;
if ( V_67 == - V_243 )
goto V_111;
...
goto V_249;
V_98 = 0 ;
if ( ! F_206 ( F_199 ( V_211 ) ) )
goto V_249;
V_241 = F_191 ( V_23 , V_46 , ( ( V_23 -> V_37 & V_250 )
&& ( V_23 -> V_37 & V_218 ) ) ) ;
F_211 ( V_226 , V_24 , V_211 , V_241 ) ;
if ( ( V_41 & V_248 ) && ! ( V_23 -> V_37 & V_218 ) ) {
V_98 = F_235 ( V_226 , V_23 , V_24 , V_211 , V_241 , V_46 ) ;
}
F_74 ( & V_226 -> V_221 ) ;
F_262 ( V_46 ) ;
V_141:
...
int F_263 ( struct V_212 * V_226 , struct V_22 * V_23 ,
...
V_209 = F_199 ( V_211 ) ;
if ( F_45 ( F_212 ( V_209 ) ) ) {
F_265 ( V_226 , ( V_252 * ) V_211 , V_24 ) ;
return 0 ;
} else if ( F_45 ( F_217 ( V_209 ) ) )
return V_253 |
F_261 ( V_21 - V_148 ) ;
}
V_211 = F_204 ( V_226 , V_24 , F_66 ( V_21 ) ) ;
if ( ! V_211 )
return V_124 ;
F_231 ( & V_251 ) ;
V_209 = F_199 ( V_211 ) ;
if ( F_206 ( V_209 ) ) {
V_98 = F_254 ( V_226 , V_23 , V_24 , V_211 , V_41 ) ;
goto V_254;
}
V_98 = 0 ;
if ( ( V_41 & V_248 ) && ! F_266 ( V_209 ) ) {
if ( F_106 ( V_21 , V_23 , V_24 ) < 0 ) {
V_98 = V_124 ;
goto V_254;
}
...
F_259 ( V_46 ) ;
F_73 ( & V_226 -> V_221 ) ;
if ( F_45 ( ! F_247 ( V_209 , F_199 ( V_211 ) ) ) )
goto V_255;
if ( V_41 & V_248 ) {
if ( ! F_266 ( V_209 ) ) {
V_98 = F_235 ( V_226 , V_23 , V_24 , V_211 , V_209 ,
V_235 ) ;
goto V_255;
}
V_209 = F_193 ( V_209 ) ;
...
V_209 = F_196 ( V_209 ) ;
if ( F_200 ( V_23 , V_24 , V_211 , V_209 ,
V_41 & V_248 ) )
F_201 ( V_23 , V_24 , V_211 ) ;
V_255:
F_74 ( & V_226 -> V_221 ) ;
...
struct V_46 *
F_267 ( struct V_212 * V_226 , unsigned long V_24 ,
T_12 * V_256 , int V_193 )
{
F_160 () ;
return NULL ;
}
int F_268 ( struct V_212 * V_226 , struct V_22 * V_23 ,
...
int V_263 ;
struct V_46 * V_46 ;
V_223 = F_203 ( V_226 , V_261 & F_221 ( V_21 ) ) ;
V_263 = ! V_223 || F_206 ( F_199 ( V_223 ) ) ;
if ( V_263 && ( V_41 & V_264 ) &&
! F_252 ( V_21 , V_23 , V_261 ) ) {
V_262 = 0 ;
break;
}
if ( V_263 ||
( ( V_41 & V_265 ) && ! F_266 ( F_199 ( V_223 ) ) ) ) {
int V_98 ;
F_74 ( & V_226 -> V_221 ) ;
V_98 = F_263 ( V_226 , V_23 , V_261 ,
( V_41 & V_265 ) ? V_248 : 0 ) ;
F_73 ( & V_226 -> V_221 ) ;
if ( ! ( V_98 & V_266 ) )
continue;
...
V_260 = ( V_261 & ~ F_221 ( V_21 ) ) >> V_29 ;
V_46 = F_208 ( F_199 ( V_223 ) ) ;
V_267:
if ( V_257 ) {
V_257 [ V_49 ] = F_269 ( V_46 , V_260 ) ;
F_209 ( V_257 [ V_49 ] ) ;
}
if ( V_258 )
V_258 [ V_49 ] = V_23 ;
...
if ( ! F_206 ( F_199 ( V_211 ) ) ) {
V_223 = F_224 ( V_226 , V_24 , V_211 ) ;
V_223 = F_197 ( F_272 ( V_223 , V_269 ) ) ;
F_211 ( V_226 , V_24 , V_211 , V_223 ) ;
}
}
F_74 ( & V_226 -> V_221 ) ;
F_232 ( & V_23 -> V_116 -> V_117 -> V_230 ) ;
...
int F_273 ( struct V_118 * V_118 ,
long V_10 , long V_9 ,
struct V_22 * V_23 ,
T_14 V_37 )
{
long V_98 , V_12 ;
struct V_20 * V_21 = F_274 ( V_118 ) ;
if ( V_37 & V_43 )
return 0 ;
...
void F_275 ( struct V_118 * V_118 , long V_271 , long V_272 )
{
struct V_20 * V_21 = F_274 ( V_118 ) ;
long V_12 = F_10 ( & V_118 -> V_121 -> V_122 , V_271 ) ;
F_73 ( & V_118 -> V_244 ) ;
V_118 -> V_245 -= ( F_258 ( V_21 ) * V_272 ) ;
F_74 ( & V_118 -> V_244 ) ;
F_75 ( V_118 -> V_121 , ( V_12 - V_272 ) ) ;
F_185 ( V_21 , - ( V_12 - V_272 ) ) ;
}
static int F_276 ( struct V_46 * V_273 )
{
struct V_46 * V_46 ;
struct V_46 * V_108 ;
