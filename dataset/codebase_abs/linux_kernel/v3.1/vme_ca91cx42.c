...
static T_7 F_44 ( struct V_114 * V_70 ,
void * V_172 , T_8 V_173 , T_9 V_174 )
{
T_7 V_116 ;
void * V_77 = V_70 -> V_120 + V_174 ;
...
if ( ( int ) V_77 & 0x2 ) {
if ( ( V_173 - V_175 ) < 2 ) {
* ( V_177 * ) ( V_172 + V_175 ) = F_45 ( V_77 + V_175 ) ;
V_175 += 1 ;
goto V_178;
} else {
* ( V_179 * ) ( V_172 + V_175 ) = F_46 ( V_77 + V_175 ) ;
V_175 += 2 ;
}
}
V_176 = ( V_173 - V_175 ) & ~ 0x3 ;
if ( V_176 > 0 ) {
F_47 ( V_172 + V_175 , V_77 + V_175 , ( unsigned int ) V_173 ) ;
V_175 += V_176 ;
}
if ( ( V_173 - V_175 ) & 0x2 ) {
* ( V_179 * ) ( V_172 + V_175 ) = F_46 ( V_77 + V_175 ) ;
...
static T_7 F_48 ( struct V_114 * V_70 ,
void * V_172 , T_8 V_173 , T_9 V_174 )
{
T_7 V_116 ;
void * V_77 = V_70 -> V_120 + V_174 ;
...
if ( ( int ) V_77 & 0x2 ) {
if ( ( V_173 - V_175 ) < 2 ) {
F_49 ( * ( V_177 * ) ( V_172 + V_175 ) , V_77 + V_175 ) ;
V_175 += 1 ;
goto V_178;
} else {
F_50 ( * ( V_179 * ) ( V_172 + V_175 ) , V_77 + V_175 ) ;
V_175 += 2 ;
}
}
V_176 = ( V_173 - V_175 ) & ~ 0x3 ;
if ( V_176 > 0 ) {
F_51 ( V_77 + V_175 , V_172 + V_175 , V_176 ) ;
V_175 += V_176 ;
}
if ( ( V_173 - V_175 ) & 0x2 ) {
F_50 ( * ( V_179 * ) ( V_172 + V_175 ) , V_77 + V_175 ) ;
...
static unsigned int F_52 ( struct V_114 * V_70 ,
...
static int F_53 ( struct V_192 * V_193 ,
struct V_194 * V_195 , struct V_194 * V_196 , T_8 V_173 )
{
...
int V_116 = 0 ;
struct V_184 * V_48 ;
V_48 = V_193 -> V_21 -> V_21 -> V_21 ;
V_198 = F_35 ( sizeof( struct V_197 ) , V_205 ) ;
if ( V_198 == NULL ) {
F_8 ( V_48 , L_22
L_23 ) ;
V_116 = - V_125 ;
...
if ( ( V_203 -> V_75 & ~ ( V_83 | V_85 | V_87 | V_89 |
V_91 ) ) != 0 ) {
F_8 ( V_48 , L_26 ) ;
V_116 = - V_66 ;
goto V_163;
}
if ( ( V_203 -> V_76 & ~ ( V_171 | V_142 | V_105 | V_107 |
V_109 | V_111 ) ) != 0 ) {
F_8 ( V_48 , L_26 ) ;
V_116 = - V_66 ;
goto V_215;
...
V_198 -> V_207 . V_230 = V_173 ;
V_198 -> V_207 . V_231 = V_201 -> V_232 ;
V_198 -> V_207 . V_233 = V_203 -> V_232 ;
V_198 -> V_207 . V_234 = V_235 ;
F_54 ( & V_198 -> V_193 , & V_193 -> V_236 ) ;
if ( V_198 -> V_193 . V_199 != & V_193 -> V_236 ) {
V_199 = F_55 ( V_198 -> V_193 . V_199 , struct V_197 ,
V_193 ) ;
V_204 = F_56 ( & V_198 -> V_207 ) ;
...
V_239 = V_193 -> V_21 ;
V_2 = V_239 -> V_21 -> V_18 ;
V_48 = V_239 -> V_21 -> V_21 ;
F_26 ( & V_239 -> V_241 ) ;
if ( ! ( F_59 ( & V_239 -> V_242 ) ) ) {
F_28 ( & V_239 -> V_241 ) ;
return - V_243 ;
} else {
F_60 ( & V_193 -> V_193 , & V_239 -> V_242 ) ;
}
V_198 = F_61 ( & V_193 -> V_236 , struct V_197 ,
V_193 ) ;
V_240 = F_56 ( & V_198 -> V_207 ) ;
F_28 ( & V_239 -> V_241 ) ;
F_14 ( 0 , V_2 -> V_19 + V_244 ) ;
F_14 ( V_240 & ~ V_208 , V_2 -> V_19 + V_245 ) ;
V_17 = F_7 ( V_2 -> V_19 + V_20 ) ;
V_17 &= ( V_246 | V_247 ) ;
V_17 |= ( V_248 | V_249 | V_250 |
V_251 | V_252 | V_253 |
V_254 ) ;
...
static int F_63 ( struct V_192 * V_193 )
{
struct V_257 * V_258 , * V_259 ;
struct V_197 * V_198 ;
F_64 (pos, temp, &list->entries) {
F_62 ( V_258 ) ;
V_198 = F_55 ( V_258 , struct V_197 , V_193 ) ;
F_33 ( V_198 ) ;
}
return 0 ;
}
static int F_65 ( struct V_260 * V_261 ,
unsigned long long V_262 , T_4 V_75 , T_5 V_76 )
{
T_1 V_263 , V_264 = 0 ;
int V_6 ;
struct V_1 * V_2 ;
...
if ( V_76 & V_111 )
V_264 |= V_272 ;
F_14 ( V_262 , V_2 -> V_19 + V_273 ) ;
F_14 ( V_264 , V_2 -> V_19 + V_274 ) ;
F_28 ( & V_261 -> V_241 ) ;
return 0 ;
}
static int F_66 ( struct V_260 * V_261 ,
unsigned long long * V_262 , T_4 * V_75 , T_5 * V_76 )
{
T_1 V_264 , V_71 = 0 ;
struct V_1 * V_2 ;
V_2 = V_261 -> V_21 -> V_18 ;
F_26 ( & V_261 -> V_241 ) ;
* V_262 = ( unsigned long long ) F_7 ( V_2 -> V_19 + V_273 ) ;
V_264 = F_7 ( V_2 -> V_19 + V_274 ) ;
if ( V_264 & V_275 )
V_71 = 1 ;
if ( ( V_264 & V_276 ) == V_266 )
* V_75 = V_83 ;
if ( ( V_264 & V_276 ) == V_267 )
* V_75 = V_85 ;
if ( ( V_264 & V_276 ) == V_268 )
* V_75 = V_87 ;
* V_76 = 0 ;
if ( V_264 & V_269 )
* V_76 |= V_105 ;
...
static int F_67 ( struct V_260 * V_261 , int V_277 ,
void (* F_68)( int ) )
{
T_1 V_264 , V_45 ;
struct V_1 * V_2 ;
...
F_26 ( & V_261 -> V_241 ) ;
V_264 = F_7 ( V_2 -> V_19 + V_274 ) ;
if ( ( V_264 & ( V_271 | V_272 ) ) == 0 ) {
F_28 ( & V_261 -> V_241 ) ;
F_8 ( V_48 , L_34 ) ;
return - V_66 ;
}
if ( V_2 -> V_9 [ V_277 ] != NULL ) {
F_28 ( & V_261 -> V_241 ) ;
F_8 ( V_48 , L_35 ) ;
return - V_243 ;
}
...
static int F_69 ( struct V_260 * V_261 , int V_277 )
{
T_1 V_45 ;
struct V_1 * V_2 ;
V_2 = V_261 -> V_21 -> V_18 ;
...
V_35 ) ) == 0 ) {
V_45 = F_7 ( V_2 -> V_19 + V_274 ) ;
V_45 &= ~ V_275 ;
F_14 ( V_45 , V_2 -> V_19 + V_274 ) ;
}
F_28 ( & V_261 -> V_241 ) ;
return 0 ;
}
...
V_2 = V_16 -> V_18 ;
if ( ! V_279 ) {
V_278 = F_7 ( V_2 -> V_19 + V_280 ) ;
V_278 = ( ( V_278 & V_281 ) >> 27 ) ;
} else
V_278 = V_279 ;
return ( int ) V_278 ;
}
...
V_278 = F_70 ( V_16 ) ;
if ( V_279 )
F_14 ( V_279 << 27 , V_2 -> V_19 + V_280 ) ;
F_74 ( & V_47 -> V_48 , L_36 , V_278 ) ;
if ( V_278 == 0 ) {
F_8 ( & V_47 -> V_48 , L_37
L_38 ) ;
return - V_66 ;
}
V_2 -> V_283 = F_75 ( V_47 , V_284 ,
& V_2 -> V_285 ) ;
if ( V_2 -> V_283 == NULL ) {
F_8 ( & V_47 -> V_48 , L_39
L_40 ) ;
...
memset ( V_2 -> V_283 , 0 , V_284 ) ;
V_282 = V_278 * ( 512 * 1024 ) ;
F_14 ( V_2 -> V_285 - V_282 , V_2 -> V_19 + V_286 ) ;
V_45 = F_7 ( V_2 -> V_19 + V_287 ) ;
V_45 |= V_288 ;
F_14 ( V_45 , V_2 -> V_19 + V_287 ) ;
return 0 ;
}
...
V_45 &= ~ V_288 ;
F_14 ( V_45 , V_2 -> V_19 + V_287 ) ;
F_14 ( 0 , V_2 -> V_19 + V_286 ) ;
F_77 ( V_47 , V_284 , V_2 -> V_283 ,
V_2 -> V_285 ) ;
}
static int F_78 ( struct V_46 * V_47 , const struct V_289 * V_290 )
{
int V_116 , V_6 ;
T_1 V_291 ;
...
struct V_238 * V_295 ;
struct V_260 * V_261 ;
V_16 = F_79 ( sizeof( struct V_15 ) , V_205 ) ;
if ( V_16 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_292 = F_79 ( sizeof( struct V_1 ) , V_205 ) ;
if ( V_292 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_291 = F_7 ( V_292 -> V_19 + V_300 ) & 0x0000FFFF ;
if ( V_291 != V_301 ) {
F_8 ( & V_47 -> V_48 , L_45 ) ;
V_116 = - V_299 ;
goto V_302;
...
F_17 ( & V_16 -> V_304 ) ;
for ( V_6 = 0 ; V_6 < V_305 ; V_6 ++ ) {
V_293 = F_35 ( sizeof( struct V_114 ) ,
V_205 ) ;
if ( V_293 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_48 ) ;
...
V_293 -> V_307 = 0 ;
V_293 -> V_82 = V_6 ;
V_293 -> V_308 = V_83 | V_85 | V_87 |
V_94 | V_89 | V_91 ;
V_293 -> V_309 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
V_293 -> V_310 = V_147 | V_149 | V_151 | V_153 ;
memset ( & V_293 -> V_117 , 0 ,
sizeof( struct V_122 ) ) ;
V_293 -> V_120 = NULL ;
F_54 ( & V_293 -> V_193 ,
& V_16 -> V_304 ) ;
...
F_17 ( & V_16 -> V_311 ) ;
for ( V_6 = 0 ; V_6 < V_312 ; V_6 ++ ) {
V_294 = F_35 ( sizeof( struct V_69 ) ,
V_205 ) ;
if ( V_294 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_49 ) ;
...
V_294 -> V_307 = 0 ;
V_294 -> V_82 = V_6 ;
V_294 -> V_308 = V_85 | V_87 | V_89 |
V_91 ;
if ( V_6 == 0 || V_6 == 4 )
V_294 -> V_308 |= V_83 ;
V_294 -> V_309 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
F_54 ( & V_294 -> V_193 ,
& V_16 -> V_311 ) ;
}
...
V_295 = F_35 ( sizeof( struct V_238 ) ,
V_205 ) ;
if ( V_295 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_50 ) ;
...
F_17 ( & V_16 -> V_321 ) ;
V_261 = F_35 ( sizeof( struct V_260 ) , V_205 ) ;
if ( V_261 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_51 ) ;
V_116 = - V_125 ;
...
V_16 -> V_338 = F_69 ;
V_16 -> V_339 = F_70 ;
V_291 = F_7 ( V_292 -> V_19 + V_340 ) ;
F_74 ( & V_47 -> V_48 , L_52 ,
( V_291 & V_341 ) ? L_53 : L_54 ) ;
F_74 ( & V_47 -> V_48 , L_55 ,
F_70 ( V_16 ) ) ;
if ( F_73 ( V_16 , V_47 ) )
F_8 ( & V_47 -> V_48 , L_56 ) ;
...
F_76 ( V_16 , V_47 ) ;
V_322:
F_87 (pos, &ca91cx42_bridge->lm_resources) {
V_261 = F_55 ( V_258 , struct V_260 , V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_261 ) ;
}
V_316:
F_87 (pos, &ca91cx42_bridge->dma_resources) {
V_295 = F_55 ( V_258 , struct V_238 , V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_295 ) ;
}
V_313:
F_87 (pos, &ca91cx42_bridge->slave_resources) {
V_294 = F_55 ( V_258 , struct V_69 , V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_294 ) ;
}
V_306:
F_87 (pos, &ca91cx42_bridge->master_resources) {
V_293 = F_55 ( V_258 , struct V_114 ,
V_193 ) ;
F_62 ( V_258 ) ;
F_33 ( V_293 ) ;
}
...
static void F_90 ( struct V_46 * V_47 )
{
struct V_257 * V_258 = NULL ;
struct V_114 * V_293 ;
struct V_69 * V_294 ;
...
struct V_260 * V_261 ;
struct V_1 * V_2 ;
struct V_15 * V_16 = F_91 ( V_47 ) ;
V_2 = V_16 -> V_18 ;
F_14 ( 0 , V_2 -> V_19 + V_29 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_343 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_344 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_345 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_346 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_347 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_348 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_349 ) ;
F_14 ( 0x00800000 , V_2 -> V_19 + V_350 ) ;
F_14 ( 0x00F00000 , V_2 -> V_19 + V_351 ) ;
F_14 ( 0x00F00000 , V_2 -> V_19 + V_352 ) ;
F_14 ( 0x00F00000 , V_2 -> V_19 + V_353 ) ;
F_14 ( 0x00F00000 , V_2 -> V_19 + V_354 ) ;
F_14 ( 0x00F00000 , V_2 -> V_19 + V_355 ) ;
F_14 ( 0x00F00000 , V_2 -> V_19 + V_356 ) ;
