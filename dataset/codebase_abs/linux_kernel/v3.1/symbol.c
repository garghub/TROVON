...
case V_35 :
F_19 ( V_52 ) ;
return ( V_52 -> V_29 . V_27 == V_22 ) ? L_14 : L_15 ;
case V_19 :
return L_16 ;
}
break;
...
continue;
if ( regexec ( & V_83 , V_2 -> V_47 , 0 , NULL , 0 ) )
continue;
if ( V_82 + 1 >= V_62 ) {
void * V_87 = V_81 ;
V_62 += 16 ;
...
for (; V_89 ; V_89 = V_89 -> V_56 ) {
V_2 = V_89 -> V_2 ;
V_93 = V_89 -> V_56 ? V_89 -> V_56 -> V_2 : V_92 ;
V_5 = V_89 -> V_5 ;
if ( V_5 == NULL )
V_5 = V_89 -> V_2 -> V_5 ;
if ( F_32 ( V_2 ) || F_8 ( V_2 ) ) {
...
if ( V_89 -> V_2 == V_92 )
fprintf ( V_50 , L_23 ,
V_5 -> V_95 -> V_47 , V_5 -> V_96 ) ;
if ( V_89 -> V_7 ) {
fprintf ( V_50 , L_24 ,
V_5 -> V_95 -> V_47 , V_5 -> V_96 ,
V_2 -> V_47 ? V_2 -> V_47 : L_25 ,
F_58 ( V_5 -> type ) ,
V_93 -> V_47 ? V_93 -> V_47 : L_25 ) ;
} else if ( V_89 -> V_5 ) {
fprintf ( V_50 , L_26 ,
V_5 -> V_95 -> V_47 , V_5 -> V_96 ,
V_2 -> V_47 ? V_2 -> V_47 : L_25 ,
...
V_5 -> V_96 = F_63 () ;
if ( V_2 ) {
for ( V_111 = & V_2 -> V_5 ; * V_111 ; V_111 = & ( * V_111 ) -> V_56 )
;
* V_111 = V_5 ;
}
return V_5 ;
