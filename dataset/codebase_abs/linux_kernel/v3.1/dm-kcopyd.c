...
{
int V_43 ;
unsigned V_18 = F_40 ( V_26 -> V_57 [ 0 ] . V_58 , V_59 >> 9 ) ;
V_43 = F_10 ( V_26 -> V_2 , V_18 , & V_26 -> V_12 ) ;
if ( ! V_43 ) {
...
struct V_22 * V_26 ;
V_26 = F_54 ( V_2 -> V_35 , V_73 ) ;
memset ( V_26 , 0 , sizeof( struct V_22 ) ) ;
V_26 -> V_2 = V_2 ;
V_26 -> V_33 = V_33 ;
V_26 -> V_30 = V_30 ;
V_26 -> V_34 = V_26 ;
...
void F_57 ( void * V_74 , int V_31 , unsigned long V_32 )
{
struct V_22 * V_26 = V_74 ;
struct V_1 * V_2 = V_26 -> V_2 ;
V_26 -> V_31 = V_31 ;
V_26 -> V_32 = V_32 ;
F_27 ( & V_2 -> V_41 , V_26 ) ;
