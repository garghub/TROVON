...
int F_83 ( struct V_21 * V_22 , int V_215 ,
int V_216 )
{
struct V_9 * V_10 = F_3 ( V_22 -> V_30 ) ;
struct V_25 * V_2 ;
...
static unsigned int F_86 ( struct V_134 * V_135 )
{
struct V_52 * V_142 = V_135 -> V_136 ;
...
static unsigned int F_88 ( struct V_134 * V_135 )
{
struct V_147 * V_148 = & V_135 -> V_148 ;
V_148 -> V_13 |= V_223 ;
V_148 -> V_225 = V_226 ;
...
static void F_89 ( const T_3 * V_219 , T_7 * V_242 , T_8 * V_243 )
{
T_7 V_244 = 0 ;
T_8 V_42 ;
F_90 ( L_29 ) ;
...
static unsigned int F_93 ( struct V_134 * V_135 )
{
struct V_52 * V_142 = V_135 -> V_136 ;
struct V_147 * V_148 = & V_135 -> V_148 ;
struct V_25 * V_2 = V_135 -> V_2 ;
...
static unsigned int F_97 ( struct V_134 * V_135 )
{
struct V_52 * V_142 = V_135 -> V_136 ;
const T_3 * V_219 = V_142 -> V_220 ;
...
V_29 = F_98 ( & V_135 -> V_148 , V_135 -> V_2 , V_185 , V_246 , V_259 ,
V_135 -> V_268 ) ;
if ( F_63 ( V_29 == 0 ) )
return 0 ;
if ( V_29 == - V_269 )
...
static int F_101 ( struct V_25 * V_2 , struct V_52 * V_53 ,
T_9 V_272 )
{
...
F_102 ( V_135 , F_51 ( V_53 ) , F_52 ( V_53 ) ) ;
...
static void * F_104 ( struct V_52 * V_53 , bool V_286 ,
unsigned long * V_13 )
{
F_5 ( & V_287 , * V_13 ) ;
memset ( V_288 , 0 , V_289 ) ;
if ( V_286 )
F_105 ( F_51 ( V_53 ) , F_52 ( V_53 ) ,
V_288 , V_289 ) ;
return V_288 ;
}
static inline void F_106 ( struct V_52 * V_53 , bool V_290 ,
unsigned long * V_13 )
{
if ( V_290 )
F_107 ( F_51 ( V_53 ) , F_52 ( V_53 ) ,
V_288 , V_289 ) ;
F_7 ( & V_287 , * V_13 ) ;
}
static unsigned int F_108 ( struct V_291 * args , T_3 * V_292 )
{
const T_3 V_293 [] = {
0x60 ,
0x03 ,
...
static unsigned int F_114 ( struct V_291 * args , T_3 * V_292 )
{
struct V_147 V_148 ;
...
V_148 . V_177 = 0x1 ;
V_148 . V_176 = 0x1 ;
F_115 ( & V_148 , 0 , 1 , & V_292 [ 36 ] ) ;
V_292 [ 36 ] = 0x34 ;
V_292 [ 56 ] = V_303 ;
memcpy ( & V_292 [ 60 ] , & args -> V_89 [ 0 ] , 512 ) ;
return 0 ;
}
static unsigned int F_116 ( struct V_291 * args , T_3 * V_292 )
{
T_6 V_304 ;
V_292 [ 1 ] = 0xb0 ;
V_292 [ 3 ] = 0x3c ;
V_304 = 1 << F_117 ( args -> V_89 ) ;
F_118 ( V_304 , & V_292 [ 6 ] ) ;
if ( F_119 ( args -> V_89 ) ) {
F_120 ( 65535 * 512 / 8 , & V_292 [ 36 ] ) ;
F_121 ( 1 , & V_292 [ 28 ] ) ;
}
return 0 ;
}
static unsigned int F_122 ( struct V_291 * args , T_3 * V_292 )
{
int V_305 = F_123 ( args -> V_89 ) ;
int V_306 = F_124 ( args -> V_89 ) ;
V_292 [ 1 ] = 0xb1 ;
V_292 [ 3 ] = 0x3c ;
V_292 [ 4 ] = V_306 >> 8 ;
V_292 [ 5 ] = V_306 ;
...
static unsigned int F_127 ( T_6 * V_89 , T_3 * V_5 )
{
...
if ( ! F_133 ( V_89 ) )
return 0 ;
F_134 ( V_89 , V_310 , V_92 , sizeof( V_310 ) ) ;
F_134 ( V_89 , V_311 , V_94 , sizeof( V_311 ) ) ;
...
V_320 = 0 ;
if ( F_132 ( args -> V_89 ) && ( V_2 -> V_13 & V_251 ) &&
...
T_6 V_333 ;
V_199 = F_72 ( V_2 -> V_89 ) ;
V_332 = F_117 ( V_2 -> V_89 ) ;
V_333 = F_137 ( V_2 -> V_89 , V_332 ) ;
F_90 ( L_34 ) ;
...
static unsigned int F_139 ( struct V_291 * args , T_3 * V_292 )
{
F_90 ( L_34 ) ;
V_292 [ 3 ] = 8 ;
return 0 ;
}
static void F_140 ( struct V_134 * V_135 )
{
...
F_144 ( V_135 ) ;
F_145 ( & V_135 -> V_337 , V_53 -> V_60 , V_107 ) ;
F_102 ( V_135 , & V_135 -> V_337 , 1 ) ;
V_135 -> V_277 = V_112 ;
...
static void F_146 ( struct V_134 * V_135 )
{
struct V_52 * V_53 = V_135 -> V_136 ;
...
unsigned long V_13 ;
T_3 * V_5 ;
V_5 = F_104 ( V_53 , true , & V_13 ) ;
if ( V_5 [ 2 ] == 0 ) {
V_5 [ 2 ] = 0x5 ;
V_5 [ 3 ] = 0x32 ;
}
F_106 ( V_53 , true , & V_13 ) ;
}
V_53 -> V_57 = V_237 ;
}
V_135 -> V_137 ( V_53 ) ;
...
static unsigned int F_147 ( struct V_134 * V_135 )
{
struct V_52 * V_142 = V_135 -> V_136 ;
struct V_25 * V_2 = V_135 -> V_2 ;
...
V_135 -> V_148 . V_150 = V_340 ;
F_53 ( V_135 ) ;
if ( ! V_348 && ! V_349 && F_148 ( V_135 ) )
V_349 = 1 ;
V_146 = F_76 ( F_149 ( V_135 ) , ( unsigned int ) 63 * 1024 ) ;
if ( V_146 & 0x1 )
V_146 ++ ;
...
static struct V_25 * F_150 ( struct V_9 * V_10 , int V_40 )
{
if ( ! F_151 ( V_10 ) ) {
if ( F_63 ( V_40 < F_152 ( & V_10 -> V_24 ) ) )
...
static unsigned int F_154 ( struct V_134 * V_135 )
{
struct V_147 * V_148 = & ( V_135 -> V_148 ) ;
struct V_52 * V_142 = V_135 -> V_136 ;
struct V_25 * V_2 = V_135 -> V_2 ;
const T_3 * V_219 = V_142 -> V_220 ;
if ( ( V_148 -> V_225 = F_153 ( V_219 [ 1 ] ) ) == V_360 )
goto V_222;
if ( V_219 [ 0 ] == V_114 ) {
if ( V_219 [ 1 ] & 0x01 ) {
V_148 -> V_361 = V_219 [ 3 ] ;
...
if ( ! F_52 ( V_142 ) )
goto V_222;
V_5 = F_157 ( F_158 ( F_51 ( V_142 ) ) ) ;
V_400 = F_159 ( V_5 , 512 , V_185 , V_246 ) ;
V_148 -> V_225 = V_358 ;
V_148 -> V_361 = 0 ;
V_148 -> V_152 = V_401 ;
...
static inline T_9 F_160 ( struct V_25 * V_2 , T_3 V_53 )
{
switch ( V_53 ) {
case V_266 :
case V_264 :
...
static inline void F_162 ( struct V_9 * V_10 ,
struct V_52 * V_53 )
{
#ifdef F_163
...
static inline int F_164 ( struct V_52 * V_142 ,
struct V_25 * V_2 )
{
...
goto V_407;
V_272 = F_160 ( V_2 , V_406 ) ;
} else {
if ( F_17 ( ! V_142 -> V_221 ) )
goto V_407;
V_272 = NULL ;
if ( F_63 ( ( V_406 != V_114 ) || ! V_408 ) ) {
int V_42 = F_165 ( V_406 ) ;
...
int F_167 ( struct V_7 * V_8 , struct V_52 * V_53 )
{
struct V_9 * V_10 ;
struct V_25 * V_2 ;
struct V_21 * V_98 = V_53 -> V_1 ;
...
void F_166 ( struct V_25 * V_2 , struct V_52 * V_53 )
{
struct V_291 args ;
...
int F_169 ( struct V_425 * V_30 , struct V_426 * V_427 )
{
int V_158 , V_29 ;
...
struct V_7 * V_8 ;
V_29 = - V_109 ;
V_8 = F_170 ( V_427 , sizeof( struct V_9 * ) ) ;
if ( ! V_8 )
goto V_430;
...
V_8 -> V_439 = 16 ;
V_8 -> V_440 = 1 ;
V_29 = F_171 ( V_10 -> V_432 , V_10 -> V_30 -> V_2 ) ;
if ( V_29 )
goto V_441;
}
return 0 ;
V_441:
F_172 ( V_30 -> V_429 [ V_158 ] -> V_432 ) ;
V_430:
while ( -- V_158 >= 0 ) {
...
void F_174 ( struct V_9 * V_10 , int V_442 )
{
int V_443 = 5 ;
...
V_355 = V_24 -> V_446 ;
V_22 = F_178 ( V_10 -> V_432 , V_355 , V_89 , 0 ,
NULL ) ;
if ( ! F_179 ( V_22 ) ) {
V_2 -> V_22 = V_22 ;
F_180 ( V_22 ) ;
...
F_183 ( V_448 , & V_10 -> V_449 ,
F_184 ( V_116 ) ) ;
}
int F_185 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 ) {
F_186 ( V_2 -> V_22 , V_450 ) ;
return 1 ;
}
return 0 ;
}
static void F_187 ( struct V_25 * V_2 )
{
struct V_9 * V_10 = V_2 -> V_24 -> V_10 ;
struct V_21 * V_22 ;
unsigned long V_13 ;
F_188 ( & V_10 -> V_432 -> V_451 ) ;
F_5 ( V_10 -> V_18 , V_13 ) ;
V_22 = V_2 -> V_22 ;
V_2 -> V_22 = NULL ;
if ( V_22 ) {
...
void F_196 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 )
F_197 ( V_2 -> V_22 , V_205 ,
V_454 ) ;
}
void F_198 ( struct V_455 * V_456 )
{
struct V_9 * V_10 =
F_199 ( V_456 , struct V_9 , V_449 . V_456 ) ;
int V_158 ;
if ( V_10 -> V_36 & V_457 ) {
F_96 ( L_54 ) ;
return;
...
F_195 ( & V_10 -> V_354 [ V_158 ] ) ;
F_174 ( V_10 , 0 ) ;
F_191 ( & V_10 -> V_458 ) ;
F_96 ( L_36 ) ;
}
int F_200 ( struct V_7 * V_8 , unsigned int V_355 ,
...
struct V_25 * V_2 = F_150 ( V_10 , V_40 ) ;
if ( V_2 ) {
...
void F_201 ( struct V_455 * V_456 )
{
struct V_9 * V_10 =
F_199 ( V_456 , struct V_9 , V_465 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_188 ( & V_10 -> V_458 ) ;
...
struct V_9 * F_203 ( struct V_425 * V_30 ,
struct V_466 * V_467 ,
struct V_7 * V_8 )
{
struct V_9 * V_10 ;
...
int F_210 ( struct V_21 * V_22 , struct V_9 * V_10 )
{
F_61 ( V_22 ) ;
F_66 ( V_22 , V_10 -> V_24 . V_1 ) ;
return 0 ;
}
int F_211 ( struct V_52 * V_53 , struct V_9 * V_10 )
{
int V_29 = 0 ;
F_162 ( V_10 , V_53 ) ;
if ( F_63 ( F_84 ( V_10 -> V_24 . V_1 ) ) )
V_29 = F_164 ( V_53 , V_10 -> V_24 . V_1 ) ;
else {
V_53 -> V_57 = ( V_410 << 16 ) ;
V_53 -> V_76 ( V_53 ) ;
}
