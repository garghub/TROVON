...
V_4 -> V_79 = F_23 ( V_31 , V_154 , V_155 ,
V_92 ) ;
...
static struct V_171 * T_8 F_65 ( struct V_85 * V_31 ,
...
T_4 V_174 ;
int V_102 = 0 ;
V_5 = F_66 ( V_31 , sizeof( struct V_3 ) ) ;
if ( V_5 == NULL ) {
V_102 = - V_93 ;
goto V_175;
}
F_67 ( V_31 , V_5 ) ;
V_102 = F_68 ( V_31 , V_173 , V_130 ) ;
if ( V_102 )
goto V_176;
V_5 -> V_177 = F_36 ;
V_3 = F_2 ( V_5 ) ;
...
if ( ! F_83 ( V_192 ) ) {
F_25 ( V_31 , L_16 , V_197 , V_192 ) ;
V_102 = V_192 ;
goto V_201;
}
V_102 = F_84 ( V_192 , F_18 ( V_31 ) ) ;
if ( V_102 ) {
F_25 ( V_31 , L_17 , V_197 , V_102 ) ;
goto V_201;
}
...
static int F_87 ( struct V_85 * V_31 )
{
struct V_29 * V_30 = V_31 -> V_33 ;
struct V_189 * V_190 = F_78 ( V_30 ) ;
int V_197 ;
...
{
struct V_85 * V_31 = & V_204 -> V_31 ;
struct V_137 * V_138 = V_204 -> V_31 . V_139 ;
struct V_171 * V_5 ;
struct V_172 V_173 ;
struct V_172 V_130 ;
int V_102 = - V_93 ;
...
V_5 = F_65 ( V_31 , & V_173 , V_130 . V_181 ) ;
if ( F_92 ( V_5 ) ) {
V_102 = F_93 ( V_5 ) ;
goto V_175;
}
...
if ( V_130 <= 0 )
return - V_51 ;
V_5 = F_65 ( & V_205 -> V_31 , V_173 , V_130 ) ;
if ( F_92 ( V_5 ) )
return F_93 ( V_5 ) ;
return 0 ;
}
