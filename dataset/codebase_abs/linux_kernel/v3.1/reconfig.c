...
if ( ! V_2 )
return - V_48 ;
V_52 = F_34 ( V_36 , V_37 , & V_11 , & V_38 , & V_35 ) ;
if ( ! V_52 )
return - V_16 ;
V_54 = F_36 ( V_11 , V_38 , V_35 , NULL ) ;
if ( ! V_54 )
return - V_18 ;
if ( ! strcmp ( V_11 , L_4 ) || ! strcmp ( V_11 , L_5 ) )
F_47 ( * ( int * ) V_35 ) ;
V_55 = F_44 ( V_2 , V_11 , NULL ) ;
if ( ! V_55 ) {
if ( strlen ( V_11 ) )
return F_42 ( V_2 , V_54 ) ;
return - V_48 ;
}
V_53 = F_48 ( V_2 , V_54 , V_55 ) ;
if ( V_53 )
return V_53 ;
if ( ! strcmp ( V_11 , L_6 ) ) {
int V_22 ;
V_52 = F_34 ( V_52 , V_37 , & V_11 ,
& V_38 , & V_35 ) ;
if ( ! V_52 )
return - V_16 ;
if ( ! strcmp ( V_11 , L_7 ) )
...
static T_3 F_49 ( struct V_58 * V_58 , const char T_4 * V_36 , T_1 V_59 ,
T_5 * V_60 )
{
int V_45 = 0 ;
char * V_61 ;
...
V_39 ++ ;
if ( ! strcmp ( V_61 , L_8 ) )
V_45 = F_37 ( V_39 , V_59 - ( V_39 - V_61 ) ) ;
else if ( ! strcmp ( V_61 , L_9 ) )
V_45 = F_38 ( V_39 ) ;
else if ( ! strcmp ( V_61 , L_10 ) )
V_45 = F_41 ( V_39 , V_59 - ( V_39 - V_61 ) ) ;
else if ( ! strcmp ( V_61 , L_11 ) )
V_45 = F_43 ( V_39 , V_59 - ( V_39 - V_61 ) ) ;
else if ( ! strcmp ( V_61 , L_12 ) )
V_45 = F_46 ( V_39 , V_59 - ( V_39 - V_61 ) ) ;
else
V_45 = - V_16 ;
V_46:
F_11 ( V_61 ) ;
