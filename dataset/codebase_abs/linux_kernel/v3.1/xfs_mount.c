...
return;
V_2 = V_221 -> V_266 ;
V_152 = F_162 ( V_221 , V_2 , 0 ) ;
V_23 = sizeof( T_4 ) ;
V_265 = 0 ;
F_55 ( F_63 ( V_152 ) , & V_2 -> V_4 , V_138 ) ;
V_141 = ( T_12 ) F_163 ( ( T_5 ) V_138 ) ;
ASSERT ( ( 1LL << V_141 ) & V_267 ) ;
V_265 = V_143 [ V_141 + 1 ] . V_144 - 1 ;
V_141 = ( T_12 ) F_56 ( ( T_5 ) V_138 ) ;
ASSERT ( ( 1LL << V_141 ) & V_267 ) ;
V_23 = V_143 [ V_141 ] . V_144 ;
F_164 ( V_221 , V_152 , V_23 , V_265 ) ;
}
STATIC int
F_165 (
T_3 * V_2 ,
...
V_2 -> V_4 . V_122 = V_272 + F_166 ( V_2 ) ;
return 0 ;
case V_283 :
V_272 = ( long long ) V_2 -> V_4 . V_123 ;
V_272 += V_269 ;
if ( V_272 < 0 ) {
return F_4 ( V_280 ) ;
}
...
#endif
F_27 ( & V_2 -> V_193 ) ;
V_292 = F_165 ( V_2 , V_268 , V_269 , V_270 ) ;
F_29 ( & V_2 -> V_193 ) ;
return V_292 ;
}
int
...
T_18 * V_221 ;
int error ;
ASSERT ( V_138 & ( V_198 | V_199 | V_301 |
V_232 | V_233 |
V_236 ) ) ;
V_221 = F_92 ( V_2 , V_302 ) ;
error = F_93 ( V_221 , 0 , V_2 -> V_4 . V_51 + 128 , 0 , 0 ,
V_225 ) ;
if ( error ) {
F_94 ( V_221 , 0 ) ;
...
V_309 = ( T_21 * )
F_179 ( V_2 -> V_311 , ( unsigned long ) V_308 ) ;
switch ( V_307 ) {
case V_312 :
case V_313 :
...
T_21 * V_309 ;
int V_7 ;
V_2 -> V_311 = F_186 ( T_21 ) ;
if ( V_2 -> V_311 == NULL )
return - V_87 ;
#ifdef F_187
V_2 -> V_310 . V_322 = F_178 ;
V_2 -> V_310 . V_323 = 0 ;
F_188 ( & V_2 -> V_310 ) ;
#endif
F_189 (i) {
V_309 = ( T_21 * ) F_179 ( V_2 -> V_311 , V_7 ) ;
memset ( V_309 , 0 , sizeof( T_21 ) ) ;
}
F_42 ( & V_2 -> V_324 ) ;
V_2 -> V_325 = - 1 ;
...
return;
F_199 ( V_2 ) ;
if ( ! F_195 ( V_268 , & V_2 -> V_325 ) ) {
F_201 ( V_2 , & V_329 , V_330 ) ;
switch( V_268 ) {
case V_275 :
...
V_331 = V_2 -> V_4 . V_122 ;
V_332 = F_50 ( V_331 , V_334 ) ;
if ( V_331 < F_207 ( V_335 , F_208 ( V_2 ) ) )
return;
break;
default:
F_46 () ;
...
V_338:
F_211 () ;
V_326 = F_212 ( V_2 -> V_311 ) ;
if ( F_34 ( F_202 ( V_2 , V_268 ) ) )
goto V_339;
F_194 ( V_326 ) ;
if ( F_34 ( F_202 ( V_2 , V_268 ) ) ) {
F_197 ( V_326 ) ;
...
break;
case V_277 :
F_213 ( ( V_2 -> V_278 - V_2 -> V_279 ) != 0 ) ;
V_272 = V_326 -> V_320 - F_166 ( V_2 ) ;
V_272 += V_269 ;
if ( F_34 ( V_272 < 0 ) )
goto V_340;
V_326 -> V_320 = V_272 + F_166 ( V_2 ) ;
break;
default:
F_46 () ;
break;
...
F_27 ( & V_2 -> V_193 ) ;
V_337 = F_165 ( V_2 , V_268 , V_269 , V_270 ) ;
F_29 ( & V_2 -> V_193 ) ;
if ( V_337 != V_280 )
F_181 ( V_2 , V_268 , 0 ) ;
F_182 ( V_2 ) ;
