...
struct V_9 * V_10 = V_72 -> V_10 ;
int V_25 , V_20 ;
T_9 V_134 = V_132 -> V_134 ;
memset ( V_132 , 0 , sizeof( * V_132 ) ) ;
V_20 = ! ! ( V_134 & V_154 ) ;
V_132 -> V_134 = V_134 & ~ V_154 ;
for ( V_25 = 0 ; V_25 < F_72 ( V_155 ) ; V_25 ++ ) {
if ( V_20 ) {
if ( V_132 -> V_134 < V_155 [ V_25 ] )
V_132 -> V_134 = V_155 [ V_25 ] ;
else
continue;
}
if ( V_132 -> V_134 == V_155 [ V_25 ] )
...
switch ( V_158 -> V_134 ) {
case V_135 :
V_158 -> V_159 = V_10 -> V_64 . V_160 ;
break;
case V_136 :
V_158 -> V_159 = V_10 -> V_64 . V_161 ;
break;
case V_137 :
V_158 -> V_159 = V_10 -> V_64 . V_162 ;
break;
case V_138 :
V_158 -> V_159 = V_10 -> V_64 . V_163 ;
break;
case V_139 :
V_158 -> V_159 = V_10 -> V_64 . V_164 ;
break;
default:
return - V_111 ;
}
...
switch ( V_158 -> V_134 ) {
case V_135 :
V_26 = F_40 ( V_10 , V_165 , V_158 -> V_159 ) ;
if ( ! V_26 )
V_10 -> V_64 . V_160 = V_158 -> V_159 ;
break;
case V_136 :
V_26 = F_40 ( V_10 , V_166 , V_158 -> V_159 ) ;
if ( ! V_26 )
V_10 -> V_64 . V_161 = V_158 -> V_159 ;
break;
case V_137 :
V_26 = F_40 ( V_10 , V_167 , V_158 -> V_159 ) ;
if ( ! V_26 )
V_10 -> V_64 . V_162 = V_158 -> V_159 ;
break;
case V_138 :
V_26 = F_40 ( V_10 , V_168 , V_158 -> V_159 ) ;
if ( ! V_26 )
V_10 -> V_64 . V_163 = V_158 -> V_159 ;
break;
case V_139 :
V_26 = F_40 ( V_10 , V_169 , V_158 -> V_159 ) ;
if ( ! V_26 )
V_10 -> V_64 . V_164 = V_158 -> V_159 ;
break;
default:
return - V_111 ;
}
...
switch ( V_158 -> V_134 ) {
case V_140 :
V_158 -> V_159 = V_130 -> V_127 ;
break;
case V_143 :
V_158 -> V_159 = V_144 ;
break;
case V_145 :
V_158 -> V_159 = V_130 -> V_150 == V_151
? V_147
: V_146 ;
break;
case V_148 :
V_158 -> V_159 = V_130 -> V_171 * 100000 ;
break;
case V_149 :
V_158 -> V_159 = V_130 -> V_172 * 100000 ;
break;
case V_173 :
V_158 -> V_159 = V_174 ;
break;
...
for ( V_25 = 0 ; V_25 < V_176 -> V_4 ; V_25 ++ ) {
struct V_170 * V_158 = V_176 -> V_179 + V_25 ;
V_45 = F_75 ( & V_10 -> V_64 , V_158 ) ;
if ( V_45 ) {
V_176 -> V_180 = V_25 ;
break;
}
...
static int F_77 ( struct V_170 * V_158 , int V_133 )
{
int V_40 = - V_111 ;
switch ( V_158 -> V_134 ) {
case V_140 :
if ( V_158 -> V_159 == V_141 ||
( V_133 && V_158 -> V_159 == V_142 ) )
V_40 = 0 ;
break;
case V_143 :
if ( V_158 -> V_159 == V_144 )
V_40 = 0 ;
break;
case V_145 :
if ( V_158 -> V_159 == V_147 ||
V_158 -> V_159 == V_146 )
V_40 = 0 ;
break;
case V_148 :
{
T_1 V_171 = V_158 -> V_159 / 100000 ;
if ( V_171 >= 10 && V_171 <= 135 )
V_40 = 0 ;
break;
}
case V_149 :
{
T_1 V_172 = V_158 -> V_159 / 100000 ;
if ( V_172 >= 10 && V_172 <= 202 )
V_40 = 0 ;
break;
}
case V_173 :
if ( V_158 -> V_159 == V_174 )
V_40 = 0 ;
break;
default:
return - V_111 ;
...
case V_149 : {
T_1 V_172 = V_158 -> V_159 / 100000 ;
if ( V_130 -> V_150 == V_151 )
break;
if ( V_130 -> V_171 < V_172 ) {
V_130 -> V_172 = V_172 ;
F_80 ( V_10 ) ;
} else
V_40 = - V_111 ;
...
struct V_183 * V_184 )
{
if ( V_184 -> V_109 != 0 || V_184 -> type != V_185 )
return - V_111 ;
V_184 -> V_152 = V_186 ;
strncpy ( V_184 -> V_187 , L_25 , 32 ) ;
V_184 -> V_188 = V_189 ;
return 0 ;
}
...
return - V_44 ;
V_184 -> type = V_185 ;
V_184 -> V_192 . V_193 . V_188 = V_189 ;
V_184 -> V_192 . V_193 . V_59 = V_191 -> V_59 ;
V_184 -> V_192 . V_193 . V_60 = V_191 -> V_60 ;
V_184 -> V_192 . V_193 . V_194 = V_10 -> V_35 ;
V_184 -> V_192 . V_193 . V_195 = 0 ;
V_184 -> V_192 . V_193 . V_196 = 0 ;
V_184 -> V_192 . V_193 . V_197 = V_198 ;
F_14 ( V_191 ) ;
return 0 ;
}
...
int V_201 ;
F_26 ( & V_10 -> V_42 ) ;
memset ( & V_200 -> V_202 , 0 , sizeof( V_200 -> V_202 ) ) ;
switch ( V_200 -> V_203 ) {
case V_204 :
V_200 -> V_152 = 0 ;
V_201 = F_36 ( V_10 ) ;
...
int F_92 ( struct V_9 * V_10 , struct V_213 * V_214 ,
int V_215 )
{
V_10 -> V_89 = F_93 () ;
if ( ! V_10 -> V_89 ) {
...
V_10 -> V_89 -> V_214 = V_214 ;
F_94 ( V_10 -> V_89 , V_10 ) ;
if ( F_95 ( V_10 -> V_89 , V_217 , V_215 ) ) {
F_19 ( & V_10 -> V_31 , L_28 ) ;
goto error;
}
return 0 ;
