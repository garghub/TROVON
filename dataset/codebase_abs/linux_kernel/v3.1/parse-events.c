...
const char * V_48 = * V_66 ;
int V_101 = 0 ;
int V_102 = 0 , V_103 = 0 , V_104 = 0 , V_105 = 0 ;
if ( ! * V_48 )
return 0 ;
if ( * V_48 == ',' )
return 0 ;
...
{
enum V_56 V_110 ;
V_110 = F_27 ( V_73 , V_48 , V_38 ) ;
if ( V_110 != V_59 )
goto V_111;
V_110 = F_35 ( V_48 , V_38 ) ;
if ( V_110 != V_59 )
goto V_111;
V_110 = F_37 ( V_48 , V_38 ) ;
if ( V_110 != V_59 )
goto V_111;
V_110 = F_33 ( V_48 , V_38 ) ;
if ( V_110 != V_59 )
goto V_111;
V_110 = F_21 ( V_48 , V_38 ) ;
if ( V_110 != V_59 )
goto V_111;
V_110 = F_30 ( V_48 , V_38 ) ;
if ( V_110 != V_59 )
goto V_111;
fprintf ( V_112 , L_29 , * V_48 ) ;
fprintf ( V_112 , L_30 ) ;
return V_59 ;
V_111:
if ( F_38 ( V_48 , V_38 ) < 0 ) {
fprintf ( V_112 , L_31 , * V_48 ) ;
fprintf ( V_112 , L_32 ) ;
return V_59 ;
}
return V_110 ;
}
int F_26 ( struct V_72 * V_73 , const char * V_48 , int T_4 V_113 )
{
struct V_57 V_38 ;
enum V_56 V_110 ;
const char * V_114 ;
...
if ( V_110 != V_80 ) {
struct V_36 * V_37 ;
V_37 = F_40 ( & V_38 , V_73 -> V_115 ) ;
if ( V_37 == NULL )
return - 1 ;
F_41 ( V_73 , V_37 ) ;
V_37 -> V_22 = calloc ( V_48 - V_114 + 1 , 1 ) ;
if ( ! V_37 -> V_22 )
return - 1 ;
strncpy ( V_37 -> V_22 , V_114 , V_48 - V_114 ) ;
}
if ( * V_48 == 0 )
break;
if ( * V_48 == ',' )
...
int F_42 ( const struct V_116 * V_117 , const char * V_48 ,
int T_4 V_113 )
{
struct V_72 * V_73 = * (struct V_72 * * ) V_117 -> V_118 ;
return F_26 ( V_73 , V_48 , T_4 ) ;
}
int F_43 ( const struct V_116 * V_117 , const char * V_48 ,
int T_4 V_113 )
{
struct V_72 * V_73 = * (struct V_72 * * ) V_117 -> V_118 ;
struct V_36 * V_119 = NULL ;
if ( V_73 -> V_115 > 0 )
V_119 = F_44 ( V_73 -> V_120 . V_121 , struct V_36 , V_122 ) ;
if ( V_119 == NULL || V_119 -> V_38 . type != V_34 ) {
fprintf ( V_112 ,
L_33 ) ;
return - 1 ;
}
V_119 -> V_123 = F_45 ( V_48 ) ;
if ( V_119 -> V_123 == NULL ) {
fprintf ( V_112 , L_34 ) ;
return - 1 ;
}
...
void F_46 ( const char * V_124 , const char * V_125 )
{
T_2 * V_2 , * V_3 ;
struct V_1 * V_14 , * V_15 , V_16 , V_17 ;
char V_4 [ V_5 ] ;
...
void F_48 ( T_3 type )
{
struct V_128 * V_129 = V_95 ;
unsigned int V_52 ;
char V_22 [ 64 ] ;
for ( V_52 = 0 ; V_52 < F_34 ( V_95 ) ; V_52 ++ , V_129 ++ ) {
if ( type != V_129 -> type )
continue;
if ( strlen ( V_129 -> V_97 ) )
snprintf ( V_22 , sizeof( V_22 ) , L_36 ,
V_129 -> V_96 , V_129 -> V_97 ) ;
else
snprintf ( V_22 , sizeof( V_22 ) , L_37 , V_129 -> V_96 ) ;
printf ( L_35 , V_22 ,
V_126 [ type ] ) ;
}
}
int F_49 ( const char * V_125 )
{
unsigned int type , V_130 , V_52 , V_131 = 0 ;
for ( type = 0 ; type < V_43 ; type ++ ) {
for ( V_130 = 0 ; V_130 < V_44 ; V_130 ++ ) {
if ( ! F_14 ( type , V_130 ) )
continue;
for ( V_52 = 0 ; V_52 < V_45 ; V_52 ++ ) {
char * V_22 = F_16 ( type , V_130 , V_52 ) ;
if ( V_125 != NULL && ! F_25 ( V_22 , V_125 ) )
continue;
printf ( L_35 , V_22 ,
V_126 [ V_35 ] ) ;
++ V_131 ;
...
void F_50 ( const char * V_125 )
{
unsigned int V_52 , type , V_132 = - 1 , V_131 = 0 , V_133 = 0 ;
struct V_128 * V_129 = V_95 ;
char V_22 [ V_134 ] ;
printf ( L_38 ) ;
printf ( L_39 ) ;
...
if ( V_125 != NULL &&
! ( F_25 ( V_129 -> V_96 , V_125 ) ||
( V_129 -> V_97 && F_25 ( V_129 -> V_97 , V_125 ) ) ) )
continue;
if ( strlen ( V_129 -> V_97 ) )
snprintf ( V_22 , V_134 , L_36 , V_129 -> V_96 , V_129 -> V_97 ) ;
else
strncpy ( V_22 , V_129 -> V_96 , V_134 ) ;
printf ( L_35 , V_22 ,
V_126 [ type ] ) ;
V_132 = type ;
++ V_131 ;
