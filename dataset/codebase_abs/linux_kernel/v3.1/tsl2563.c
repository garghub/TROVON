...
static T_4 F_31 ( struct V_71 * V_72 ,
int V_89 ,
int V_75 )
{
struct V_1 * V_2 = F_25 ( V_72 ) ;
...
struct V_71 * V_72 ;
struct V_1 * V_2 ;
struct V_105 * V_106 = V_5 -> V_107 . V_108 ;
int V_109 = 0 ;
int V_11 ;
T_1 V_27 ;
...
V_2 -> V_85 = 1 ;
V_95 ( & V_5 -> V_107 , L_2 , V_27 >> 4 , V_27 & 0x0f ) ;
V_72 -> V_113 = V_5 -> V_113 ;
V_72 -> V_114 = V_115 ;
V_72 -> V_116 = F_45 ( V_115 ) ;
V_72 -> V_107 . V_117 = & V_5 -> V_107 ;
V_72 -> V_118 = V_119 ;
if ( V_5 -> V_93 )
V_72 -> V_120 = & V_121 ;
else
...
static int F_56 ( struct V_4 * V_5 , T_7 V_43 )
{
struct V_1 * V_2 = F_53 ( V_5 ) ;
int V_11 ;
F_27 ( & V_2 -> V_83 ) ;
