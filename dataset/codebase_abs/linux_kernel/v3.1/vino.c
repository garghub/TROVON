...
F_49 ( V_57 ) ;
F_52 ( V_57 ) ;
F_2 ( L_72 , V_256 [ V_57 -> V_164 ] . V_257 ) ;
V_41:
F_32 ( & V_187 -> V_194 , V_52 ) ;
return V_16 ;
}
...
{
struct V_56 * V_258 = ( V_57 -> V_139 == V_140 ) ?
...
if ( V_164 != V_258 -> V_164 ) {
V_16 = - V_192 ;
goto V_41;
}
V_57 -> V_164 = V_164 ;
V_57 -> V_74 = V_258 -> V_74 ;
}
if ( V_187 -> V_244 == V_57 -> V_139 ) {
if ( V_258 -> V_164 == V_165 ) {
V_187 -> V_244 = V_258 -> V_139 ;
} else {
V_187 -> V_244 = V_246 ;
}
}
...
V_187 -> V_244 = V_57 -> V_139 ;
if ( V_187 -> V_243 == V_57 -> V_139 ) {
if ( ( V_258 -> V_164 == V_239 ) ||
( V_258 -> V_164 == V_241 ) ) {
V_187 -> V_243 = V_258 -> V_139 ;
} else {
V_187 -> V_243 = V_246 ;
}
}
...
F_49 ( V_57 ) ;
F_52 ( V_57 ) ;
F_2 ( L_74 , V_256 [ V_57 -> V_164 ] . V_257 ) ;
V_41:
F_32 ( & V_187 -> V_194 , V_52 ) ;
return V_16 ;
}
...
static int F_104 ( T_5 V_259 )
{
int V_4 ;
for ( V_4 = 0 ; V_4 < V_260 ; V_4 ++ ) {
if ( V_65 [ V_4 ] . V_259 == V_259 )
return V_4 ;
}
return V_26 ;
}
...
static int F_107 ( struct V_261 * V_261 , void * V_262 ,
struct V_263 * V_264 )
{
memset ( V_264 , 0 , sizeof( struct V_263 ) ) ;
strcpy ( V_264 -> V_265 , V_266 ) ;
strcpy ( V_264 -> V_267 , V_268 ) ;
strcpy ( V_264 -> V_269 , V_270 ) ;
V_264 -> V_271 =
V_272 |
V_273 ;
return 0 ;
}
static int F_108 ( struct V_261 * V_261 , void * V_262 ,
struct V_274 * V_4 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
T_5 V_195 = V_4 -> V_195 ;
int V_164 ;
F_2 ( L_76 , V_195 ) ;
...
return - V_17 ;
V_4 -> type = V_275 ;
V_4 -> V_251 = V_256 [ V_164 ] . V_251 ;
strcpy ( V_4 -> V_257 , V_256 [ V_164 ] . V_257 ) ;
if ( V_164 == V_239 || V_164 == V_241 )
F_100 ( V_248 , V_276 , & V_4 -> V_277 ) ;
return 0 ;
}
static int F_110 ( struct V_261 * V_261 , void * V_262 ,
unsigned int * V_4 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
T_5 V_195 ;
...
static int F_111 ( struct V_261 * V_261 , void * V_262 ,
unsigned int V_4 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
int V_164 ;
...
static int F_112 ( struct V_261 * V_261 , void * V_262 ,
T_4 * V_251 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_113 ( struct V_261 * V_261 , void * V_262 ,
T_4 * V_251 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_114 ( struct V_261 * V_261 , void * V_262 ,
T_4 * V_251 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
if ( ( * V_251 ) & V_256 [ V_57 -> V_164 ] . V_251 ) {
F_2 ( L_80 ) ;
if ( V_57 -> V_164 == V_165 )
goto V_41;
if ( ( * V_251 ) & V_278 ) {
...
static int F_115 ( struct V_261 * V_261 , void * V_262 ,
struct V_281 * V_282 )
{
F_2 ( L_81 , V_282 -> V_195 ) ;
if ( V_282 -> V_195 >= V_260 )
return - V_17 ;
F_2 ( L_82 , V_65 [ V_282 -> V_195 ] . V_283 ) ;
V_282 -> V_259 = V_65 [ V_282 -> V_195 ] . V_259 ;
strcpy ( V_282 -> V_283 , V_65 [ V_282 -> V_195 ] . V_283 ) ;
return 0 ;
}
static int F_116 ( struct V_261 * V_261 , void * V_262 ,
struct V_284 * V_29 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
struct V_56 V_285 ;
unsigned long V_52 ;
struct V_286 * V_287 = & V_29 -> V_288 . V_289 ;
F_2 ( L_83 ,
V_287 -> V_75 , V_287 -> V_76 ) ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
memcpy ( & V_285 , V_57 , sizeof( struct V_56 ) ) ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
V_285 . V_25 = F_104 ( V_287 -> V_259 ) ;
if ( V_285 . V_25 == V_26 ) {
V_285 . V_25 = V_181 ;
V_287 -> V_259 =
V_65 [ V_285 . V_25 ] .
...
F_47 ( & V_285 , V_287 -> V_75 , V_287 -> V_76 ) ;
F_2 ( L_84 ,
V_65 [ V_285 . V_25 ] . V_283 ) ;
V_287 -> V_75 = ( V_285 . V_59 . V_60 - V_285 . V_59 . V_61 ) /
V_285 . V_63 ;
V_287 -> V_76 = ( V_285 . V_59 . V_80 - V_285 . V_59 . V_79 ) /
V_285 . V_63 ;
V_287 -> V_137 = V_290 ;
V_287 -> V_291 = V_285 . V_67 ;
V_287 -> V_292 = V_285 . V_67 *
( V_285 . V_59 . V_80 - V_285 . V_59 . V_79 ) /
V_285 . V_63 ;
V_287 -> V_293 =
V_65 [ V_285 . V_25 ] . V_293 ;
V_287 -> V_294 = 0 ;
return 0 ;
}
static int F_117 ( struct V_261 * V_261 , void * V_262 ,
struct V_284 * V_29 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
struct V_286 * V_287 = & V_29 -> V_288 . V_289 ;
F_31 ( & V_187 -> V_194 , V_52 ) ;
V_287 -> V_75 = ( V_57 -> V_59 . V_60 - V_57 -> V_59 . V_61 ) /
V_57 -> V_63 ;
V_287 -> V_76 = ( V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ) /
V_57 -> V_63 ;
V_287 -> V_259 =
V_65 [ V_57 -> V_25 ] . V_259 ;
V_287 -> V_137 = V_290 ;
V_287 -> V_291 = V_57 -> V_67 ;
V_287 -> V_292 = V_57 -> V_67 *
( V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ) /
V_57 -> V_63 ;
V_287 -> V_293 =
V_65 [ V_57 -> V_25 ] . V_293 ;
V_287 -> V_294 = 0 ;
F_32 ( & V_187 -> V_194 , V_52 ) ;
return 0 ;
}
static int F_118 ( struct V_261 * V_261 , void * V_262 ,
struct V_284 * V_29 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
int V_25 ;
...
F_47 ( V_57 , V_287 -> V_75 , V_287 -> V_76 ) ;
F_2 ( L_84 ,
V_65 [ V_57 -> V_25 ] . V_283 ) ;
V_287 -> V_75 = V_57 -> V_59 . V_60 - V_57 -> V_59 . V_61 ;
V_287 -> V_76 = V_57 -> V_59 . V_80 - V_57 -> V_59 . V_79 ;
V_287 -> V_137 = V_290 ;
V_287 -> V_291 = V_57 -> V_67 ;
...
static int F_119 ( struct V_261 * V_261 , void * V_262 ,
struct V_295 * V_296 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
const struct V_135 * V_136 ;
...
static int F_120 ( struct V_261 * V_261 , void * V_262 ,
struct V_305 * V_306 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_121 ( struct V_261 * V_261 , void * V_262 ,
struct V_305 * V_306 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_122 ( struct V_261 * V_261 , void * V_262 ,
struct V_307 * V_308 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_123 ( struct V_261 * V_261 , void * V_262 ,
struct V_307 * V_308 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_124 ( struct V_261 * V_261 , void * V_262 ,
struct V_316 * V_317 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
if ( V_57 -> V_318 )
...
V_320 : V_327 ;
V_142 -> V_328 . V_49 = V_2 -> V_49 ;
V_142 -> V_329 = V_2 -> V_153 ;
V_142 -> V_30 = V_2 -> V_14 ;
V_142 -> V_137 = V_290 ;
V_142 -> V_330 = V_2 -> V_138 ;
memcpy ( & V_142 -> V_212 , & V_2 -> V_212 ,
sizeof( struct V_213 ) ) ;
F_2 ( L_89 ,
V_2 -> V_35 , V_2 -> V_14 , V_2 -> V_153 , V_2 -> V_49 ) ;
}
static int F_126 ( struct V_261 * V_261 , void * V_262 ,
struct V_322 * V_142 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
struct V_1 * V_2 ;
...
static int F_127 ( struct V_261 * V_261 , void * V_262 ,
struct V_322 * V_142 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
struct V_1 * V_2 ;
...
static int F_128 ( struct V_261 * V_261 , void * V_262 ,
struct V_322 * V_142 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned int V_331 = V_261 -> V_332 & V_333 ;
struct V_1 * V_2 ;
...
static int F_129 ( struct V_261 * V_261 , void * V_262 ,
enum V_335 V_4 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned int V_199 ;
...
static int F_130 ( struct V_261 * V_261 , void * V_262 ,
enum V_335 V_4 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
if ( V_57 -> V_318 )
...
static int F_131 ( struct V_261 * V_261 , void * V_262 ,
struct V_336 * V_337 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_132 ( struct V_261 * V_261 , void * V_262 ,
struct V_344 * V_155 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
static int F_134 ( struct V_261 * V_261 , void * V_262 ,
struct V_344 * V_155 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_52 ;
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_346 < V_339 [ V_4 ] . V_347 ||
V_155 -> V_346 > V_339 [ V_4 ] . V_348 ) {
V_124 = - V_349 ;
goto V_41;
}
V_124 = F_133 ( V_252 , V_350 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
if ( V_124 )
goto V_41;
if ( V_155 -> V_346 < V_343 [ V_4 ] . V_347 ||
V_155 -> V_346 > V_343 [ V_4 ] . V_348 ) {
V_124 = - V_349 ;
goto V_41;
}
V_124 = F_100 ( V_252 , V_350 , V_155 ) ;
if ( V_124 )
V_124 = - V_17 ;
break;
}
...
static int F_135 ( struct V_261 * V_261 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
int V_16 = 0 ;
F_2 ( L_99 ,
...
static int F_136 ( struct V_261 * V_261 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
F_2 ( L_104 ) ;
F_26 ( & V_57 -> V_351 ) ;
...
static void F_137 ( struct V_353 * V_354 )
{
struct V_1 * V_2 = V_354 -> V_355 ;
V_2 -> V_55 ++ ;
F_2 ( L_105 , V_2 -> V_55 ) ;
}
static void F_138 ( struct V_353 * V_354 )
{
struct V_1 * V_2 = V_354 -> V_355 ;
V_2 -> V_55 -- ;
F_2 ( L_106 , V_2 -> V_55 ) ;
}
static int F_139 ( struct V_261 * V_261 , struct V_353 * V_354 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned long V_198 = V_354 -> V_356 ;
unsigned long V_14 = V_354 -> V_357 - V_354 -> V_356 ;
unsigned long V_49 = V_354 -> V_358 << V_359 ;
struct V_1 * V_2 = NULL ;
...
if ( V_14 < V_9 )
break;
if ( F_142 ( V_354 , V_198 , V_363 , V_9 ,
V_354 -> V_364 ) ) {
F_2 ( L_115 ) ;
V_16 = - V_334 ;
goto V_41;
...
static unsigned int F_143 ( struct V_261 * V_261 , T_6 * V_371 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
unsigned int V_210 ;
unsigned int V_16 = 0 ;
...
if ( V_210 > 0 )
goto V_373;
F_144 ( V_261 , & V_57 -> V_197 . V_203 , V_371 ) ;
if ( F_38 ( & V_57 -> V_197 , & V_210 ) ) {
F_2 ( L_117 ) ;
V_16 = V_372 ;
goto error;
...
static long F_145 ( struct V_261 * V_261 ,
unsigned int V_376 , unsigned long V_377 )
{
struct V_56 * V_57 = F_109 ( V_261 ) ;
long V_16 ;
if ( F_140 ( & V_57 -> V_351 ) )
return - V_204 ;
V_16 = F_146 ( V_261 , V_376 , V_377 ) ;
F_27 ( & V_57 -> V_351 ) ;
return V_16 ;
}
static void F_147 ( int V_378 )
{
switch( V_378 ) {
case 11 :
F_148 ( V_187 -> V_142 . V_379 ) ;
V_187 -> V_142 . V_379 = NULL ;
case 10 :
F_148 ( V_187 -> V_141 . V_379 ) ;
V_187 -> V_141 . V_379 = NULL ;
case 9 :
F_149 ( & V_380 ) ;
case 8 :
F_150 ( V_381 , NULL ) ;
case 7 :
if ( V_187 -> V_142 . V_379 ) {
F_151 ( V_187 -> V_142 . V_379 ) ;
V_187 -> V_142 . V_379 = NULL ;
}
case 6 :
if ( V_187 -> V_141 . V_379 ) {
F_151 ( V_187 -> V_141 . V_379 ) ;
V_187 -> V_141 . V_379 = NULL ;
}
case 5 :
F_5 ( NULL ,
...
V_127 = (struct V_389 * ) F_156 ( V_390 , sizeof( struct V_389 ) ) ;
if ( ! V_127 ) {
F_34 ( V_54 L_124 ) ;
return - V_106 ;
}
V_391 ++ ;
if ( F_157 ( V_385 , & ( V_127 -> V_385 ) ) ) {
F_34 ( V_54 L_125 ) ;
F_147 ( V_391 ) ;
return - V_255 ;
}
if ( F_158 ( V_385 ) != V_392 ) {
F_34 ( V_54 L_126 ,
V_385 ) ;
F_147 ( V_391 ) ;
return - V_255 ;
}
F_34 ( V_393 L_127 , F_159 ( V_385 ) ) ;
return 0 ;
}
...
int V_124 ;
int V_4 ;
V_187 = F_161 ( sizeof( struct V_395 ) , V_18 ) ;
if ( ! V_187 ) {
F_147 ( V_391 ) ;
return - V_19 ;
}
V_391 ++ ;
F_162 ( V_187 -> V_384 . V_257 , L_128 ,
sizeof( V_187 -> V_384 . V_257 ) ) ;
V_124 = F_163 ( NULL , & V_187 -> V_384 ) ;
if ( V_124 )
return V_124 ;
V_391 ++ ;
V_187 -> V_383 = F_13 ( V_18 | V_20 ) ;
if ( ! V_187 -> V_383 ) {
F_147 ( V_391 ) ;
return - V_19 ;
}
...
( void * ) V_187 -> V_383 ,
V_9 , V_10 ) ;
for ( V_4 = 0 ; V_4 < V_382 ; V_4 ++ ) {
V_187 -> V_188 . V_7 [ V_4 ] = V_394 ;
}
V_127 -> V_155 = 0 ;
...
F_54 ( V_147 ) ;
V_127 -> V_156 = 0 ;
V_127 -> V_141 . V_396 = V_397 ;
V_127 -> V_142 . V_396 = V_397 ;
return 0 ;
}
static int F_164 ( struct V_56 * V_57 ,
unsigned int V_139 , const char * V_257 )
{
V_57 -> V_139 = V_139 ;
V_57 -> V_164 = V_254 ;
V_57 -> V_148 = 0 ;
...
V_391 ++ ;
memcpy ( V_57 -> V_379 , & V_398 ,
sizeof( struct V_399 ) ) ;
strcpy ( V_57 -> V_379 -> V_257 , V_257 ) ;
V_57 -> V_379 -> V_400 = F_151 ;
V_57 -> V_379 -> V_384 = & V_187 -> V_384 ;
F_168 ( V_57 -> V_379 , V_57 ) ;
return 0 ;
}
...
if ( V_16 )
return V_16 ;
V_16 = F_164 ( & V_187 -> V_142 , V_403 ,
V_404 ) ;
if ( V_16 )
return V_16 ;
V_16 = F_170 ( V_381 , F_91 , 0 ,
V_268 , NULL ) ;
if ( V_16 ) {
F_34 ( V_54 L_130 ,
V_381 ) ;
...
F_172 ( & V_380 , & V_187 -> V_384 ) ;
V_391 ++ ;
V_16 = F_173 ( V_187 -> V_141 . V_379 ,
V_405 , - 1 ) ;
if ( V_16 < 0 ) {
F_34 ( V_54 L_132
L_133 ) ;
