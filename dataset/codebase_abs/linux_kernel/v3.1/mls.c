...
return 0 ;
F_3 (&l->cat, node, i) {
if ( V_2 > V_23 -> V_30 . V_28 )
return 0 ;
if ( ! F_8 ( & V_26 -> V_16 -> V_19 , V_2 ) ) {
return 0 ;
}
}
return 1 ;
...
V_81 . V_84 = V_75 -> type ;
V_81 . V_85 = V_76 ;
V_32 = F_7 ( V_12 . V_86 , & V_81 ) ;
if ( V_32 )
return F_21 ( V_78 , V_32 ) ;
case V_87 :
if ( ( V_76 == V_12 . V_88 ) || ( V_79 == true ) )
...
if ( ! V_12 . V_13 )
return;
V_91 -> V_92 . V_93 . V_94 = V_1 -> V_15 . V_16 [ 0 ] . V_17 - 1 ;
V_91 -> V_95 |= V_96 ;
}
...
if ( ! V_12 . V_13 )
return;
V_1 -> V_15 . V_16 [ 0 ] . V_17 = V_91 -> V_92 . V_93 . V_94 + 1 ;
V_1 -> V_15 . V_16 [ 1 ] . V_17 = V_1 -> V_15 . V_16 [ 0 ] . V_17 ;
}
...
if ( ! V_12 . V_13 )
return 0 ;
V_51 = F_32 ( & V_1 -> V_15 . V_16 [ 0 ] . V_19 ,
& V_91 -> V_92 . V_93 . V_19 ) ;
if ( V_51 == 0 && V_91 -> V_92 . V_93 . V_19 != NULL )
V_91 -> V_95 |= V_97 ;
return V_51 ;
}
