...
static int F_47 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_87 V_36 = { . V_36 = V_88 } ;
int V_89 ;
if ( ! V_2 -> V_16 -> V_90 )
return - V_59 ;
V_89 = V_2 -> V_16 -> V_90 ( V_2 , & V_36 ) ;
if ( V_89 < 0 )
return V_89 ;
if ( F_25 ( V_34 , & V_36 , sizeof( V_36 ) ) )
return - V_46 ;
...
static int F_48 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_87 V_36 ;
if ( ! V_2 -> V_16 -> V_91 )
return - V_59 ;
...
static T_4 int F_49 ( struct V_1 * V_2 ,
void T_2 * V_34 )
{
struct V_92 V_93 ;
const struct V_16 * V_54 = V_2 -> V_16 ;
...
F_50 ( V_93 . V_98 , F_51 ( V_2 -> V_2 . V_96 ) ,
sizeof( V_93 . V_98 ) ) ;
F_50 ( V_93 . V_97 , V_2 -> V_2 . V_96 -> V_97 -> V_99 ,
sizeof( V_93 . V_97 ) ) ;
} else {
return - V_59 ;
}
...
static T_4 int F_52 ( struct V_1 * V_2 ,
void T_2 * V_34 )
{
struct V_111 V_93 ;
T_5 V_112 ;
...
memset ( & V_93 , 0 , sizeof( V_93 ) ) ;
V_93 . V_36 = V_117 ;
V_116 = F_54 ( V_115 * sizeof( T_1 ) , V_118 ) ;
if ( ! V_116 )
return - V_119 ;
...
V_125 = F_54 ( V_93 . V_129 * sizeof( T_1 ) ,
V_118 ) ;
if ( ! V_125 )
return - V_119 ;
}
...
V_28 -> V_152 = F_62 ( 0xffffffff ) ;
if ( ! ( V_144 -> V_153 | V_28 -> V_153 ) )
V_28 -> V_153 = F_62 ( 0xffffffff ) ;
if ( ! ( V_144 -> V_154 | V_28 -> V_154 ) )
V_28 -> V_154 = F_63 ( 0xffff ) ;
if ( ! ( V_144 -> V_155 | V_28 -> V_155 ) )
V_28 -> V_155 = F_63 ( 0xffff ) ;
...
static T_4 int F_64 ( struct V_1 * V_2 ,
void T_2 * V_34 )
{
struct V_160 V_36 ;
const struct V_16 * V_54 = V_2 -> V_16 ;
...
static int F_65 ( struct V_1 * V_2 , char T_2 * V_34 )
{
struct V_163 V_164 ;
const struct V_16 * V_54 = V_2 -> V_16 ;
void * V_165 ;
...
static int F_68 ( struct V_1 * V_2 , char T_2 * V_34 )
{
struct V_84 V_169 ;
int V_48 ;
if ( ! V_2 -> V_16 -> V_169 )
...
static int F_69 ( struct V_1 * V_2 , char T_2 * V_34 )
{
...
if ( ! V_2 -> V_16 -> V_177 )
return - V_59 ;
V_85 . V_5 = F_73 ( V_2 ) && V_2 -> V_16 -> V_177 ( V_2 ) ;
if ( F_25 ( V_34 , & V_85 , sizeof( V_85 ) ) )
return - V_46 ;
return 0 ;
}
static int F_74 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_178 V_179 ;
const struct V_16 * V_54 = V_2 -> V_16 ;
...
return - V_14 ;
V_5 = F_60 ( V_184 , V_118 ) ;
if ( ! V_5 )
return - V_119 ;
V_181 = V_179 . V_168 ;
while ( V_181 > 0 ) {
V_179 . V_168 = F_75 ( V_181 , ( T_1 ) V_184 ) ;
...
static T_4 int F_78 ( struct V_1 * V_2 ,
void T_2 * V_34 )
{
struct V_186 V_187 ;
if ( ! V_2 -> V_16 -> V_190 )
...
static int F_79 ( struct V_1 * V_2 , void T_2 * V_34 )
{
...
static int F_80 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_191 V_192 ;
if ( ! V_2 -> V_16 -> V_195 )
return - V_59 ;
...
static T_4 int F_81 ( struct V_1 * V_2 ,
void T_2 * V_34 )
{
...
static int F_83 ( struct V_1 * V_2 , void T_2 * V_34 )
{
...
static int F_84 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_201 V_202 ;
if ( ! V_2 -> V_16 -> V_205 )
return - V_59 ;
...
V_89 = V_2 -> V_16 -> V_23 ( V_2 , 0 ) ;
if ( V_89 )
return V_89 ;
}
if ( ! V_5 && V_2 -> V_16 -> V_206 ) {
V_89 = V_2 -> V_16 -> V_206 ( V_2 , 0 ) ;
if ( V_89 )
return V_89 ;
}
...
static int F_85 ( struct V_1 * V_2 , char T_2 * V_34 )
{
struct V_208 V_209 ;
const struct V_16 * V_54 = V_2 -> V_16 ;
T_5 * V_5 ;
...
return - V_46 ;
V_209 . V_168 = V_210 ;
V_5 = F_60 ( V_210 * sizeof( T_5 ) , V_118 ) ;
if ( ! V_5 )
return - V_119 ;
...
static int F_87 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_212 V_213 ;
T_3 * V_5 ;
int V_48 ;
...
return V_48 ;
V_213 . V_168 = V_48 ;
V_5 = F_60 ( V_213 . V_168 * V_215 , V_118 ) ;
if ( ! V_5 )
return - V_119 ;
...
static int F_88 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_84 V_216 ;
static bool V_217 ;
int V_100 ;
...
static int F_95 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_229 V_230 ;
const struct V_16 * V_54 = V_2 -> V_16 ;
T_5 * V_5 ;
...
return - V_46 ;
V_230 . V_104 = V_104 ;
V_5 = F_60 ( V_104 * sizeof( T_5 ) , V_118 ) ;
if ( ! V_5 )
return - V_119 ;
...
static int F_96 ( struct V_1 * V_2 , void T_2 * V_34 )
{
struct V_232 V_233 ;
...
static int F_97 ( struct V_1 * V_2 , char T_2 * V_34 ,
...
static int F_98 ( struct V_1 * V_2 , char T_2 * V_34 ,
...
static T_4 int F_100 ( struct V_1 * V_2 ,
char T_2 * V_34 )
{
struct V_237 V_238 ;
...
int F_104 ( struct V_247 * V_247 , struct V_248 * V_249 )
{
struct V_1 * V_2 = F_105 ( V_247 , V_249 -> V_250 ) ;
...
case V_261 :
case V_128 :
V_100 = F_57 ( V_2 , V_79 , V_34 ) ;
break;
case V_124 :
case V_285 :
case V_286 :
V_100 = F_56 ( V_2 , V_79 , V_34 ) ;
break;
case V_287 :
