...
{
F_37 ( & V_8 -> V_5 . V_61 , & V_9 -> V_5 . V_61 ) ;
V_8 -> V_6 = V_9 -> V_6 ;
}
static inline void
F_38 ( struct V_60 * V_7 )
{
V_7 -> V_6 = 0 ;
}
static inline void
F_39 ( union V_62 * V_5 , T_2 V_63 )
{
V_5 -> V_64 [ 0 ] &= F_40 ( V_63 ) [ 0 ] ;
V_5 -> V_64 [ 1 ] &= F_40 ( V_63 ) [ 1 ] ;
V_5 -> V_64 [ 2 ] &= F_40 ( V_63 ) [ 2 ] ;
V_5 -> V_64 [ 3 ] &= F_40 ( V_63 ) [ 3 ] ;
}
static inline void
F_41 ( struct V_60 * V_7 , T_2 V_6 )
{
F_39 ( & V_7 -> V_5 , V_6 ) ;
V_7 -> V_6 = V_6 ;
}
static bool
F_42 ( struct V_10 * V_11 , const struct V_60 * V_12 )
{
F_43 ( V_11 , V_13 , & V_12 -> V_5 ) ;
F_9 ( V_11 , V_14 , V_12 -> V_6 ) ;
return 0 ;
V_15:
return 1 ;
...
static bool
F_44 ( struct V_10 * V_11 , const struct V_60 * V_12 )
{
const struct V_65 * V_66 =
( const struct V_65 * ) V_12 ;
F_43 ( V_11 , V_13 , & V_66 -> V_5 ) ;
...
static int
F_46 ( struct V_24 * V_25 , const struct V_10 * V_11 ,
const struct V_26 * V_27 ,
enum V_28 V_29 , const struct V_30 * V_31 )
{
const struct V_20 * V_21 = V_25 -> V_12 ;
...
if ( V_29 == V_37 )
V_12 . V_6 = V_35 ;
F_47 ( V_11 , V_31 -> V_38 & V_39 , & V_12 . V_5 . V_61 ) ;
F_39 ( & V_12 . V_5 , V_12 . V_6 ) ;
return V_32 ( V_25 , & V_12 , F_18 ( V_31 , V_21 ) , V_31 -> V_40 ) ;
}
static int
F_48 ( struct V_24 * V_25 , struct V_41 * V_42 [] ,
enum V_28 V_29 , T_1 * V_43 , T_1 V_38 , bool V_44 )
{
const struct V_20 * V_21 = V_25 -> V_12 ;
T_3 V_32 = V_25 -> V_33 -> V_29 [ V_29 ] ;
...
static int
F_50 ( struct V_24 * V_25 , struct V_41 * V_42 [] , T_1 V_38 )
{
...
if ( V_42 [ V_77 ] )
V_59 = F_51 ( V_42 [ V_77 ] ) ;
V_21 = F_52 ( sizeof( * V_21 )
+ sizeof( struct V_79 )
* ( V_25 -> V_72 == V_73 ? 32 : 128 ) , V_80 ) ;
if ( ! V_21 )
return - V_81 ;
V_21 -> V_59 = V_59 ;
F_53 ( & V_21 -> V_82 , sizeof( V_21 -> V_82 ) ) ;
V_21 -> V_19 = V_83 ;
V_71 = F_54 ( V_68 ) ;
V_21 -> V_84 = F_55 (
sizeof( struct V_85 )
+ F_56 ( V_71 ) * sizeof( struct V_86 ) ) ;
if ( ! V_21 -> V_84 ) {
F_57 ( V_21 ) ;
return - V_81 ;
}
...
F_60 ( L_1 ,
V_25 -> V_91 , F_56 ( V_21 -> V_84 -> F_54 ) ,
V_21 -> V_84 -> F_54 , V_21 -> V_59 , V_25 -> V_12 , V_21 -> V_84 ) ;
return 0 ;
}
static int T_4
F_61 ( void )
