...
static int F_37 ( const char * V_126 )
{
if ( strcmp ( V_126 , L_5 ) == 0 )
return 0 ;
if ( strcmp ( V_126 , L_6 ) == 0 )
return 1 ;
return - V_33 ;
}
...
{
struct V_18 * V_19 = F_9 ( V_2 ) ;
struct V_127 * V_128 = V_19 -> V_128 ;
struct V_129 * V_130 ;
int V_131 , V_132 , V_133 , V_10 , V_20 , V_134 ;
struct V_50 * V_51 ;
V_51 = & V_19 -> V_6 [ 0 ] ;
if ( ! V_128 || ! V_19 -> V_135 )
return;
...
V_131 = 0 ;
V_132 = V_137 ;
for ( V_10 = 0 ; V_10 < V_128 -> V_138 ; V_10 ++ ) {
if ( strcmp ( V_128 -> V_139 [ V_10 ] . V_126 , V_19 -> V_140 [ V_20 ] ) == 0 &&
abs ( V_128 -> V_139 [ V_10 ] . V_42 - V_134 ) < V_132 ) {
V_131 = V_10 ;
V_132 = abs ( V_128 -> V_139 [ V_10 ] . V_42 - V_134 ) ;
}
}
F_30 ( V_2 -> V_64 , L_7 ,
V_128 -> V_139 [ V_131 ] . V_126 ,
V_128 -> V_139 [ V_131 ] . V_42 , V_134 ) ;
V_133 = F_25 ( V_2 , V_141 ) ;
F_10 ( V_2 , V_141 , V_142 , 0 ) ;
V_130 = & V_128 -> V_139 [ V_20 ] ;
F_2 ( V_2 , 0 , 0 , V_130 -> V_143 ) ;
F_2 ( V_2 , 0 , 1 , V_130 -> V_144 ) ;
F_2 ( V_2 , 0 , 2 , V_130 -> V_145 ) ;
F_2 ( V_2 , 0 , 3 , V_130 -> V_146 ) ;
F_2 ( V_2 , 0 , 4 , V_130 -> V_147 ) ;
F_10 ( V_2 , V_141 , V_142 , V_133 ) ;
}
...
V_128 -> V_139 [ V_131 ] . V_42 , V_134 ) ;
V_133 = F_25 ( V_2 , V_141 ) ;
F_10 ( V_2 , V_141 , V_148 , 0 ) ;
V_130 = & V_128 -> V_139 [ V_20 ] ;
F_2 ( V_2 , 1 , 0 , V_130 -> V_143 ) ;
F_2 ( V_2 , 1 , 1 , V_130 -> V_144 ) ;
F_2 ( V_2 , 1 , 2 , V_130 -> V_145 ) ;
F_2 ( V_2 , 1 , 3 , V_130 -> V_146 ) ;
F_2 ( V_2 , 1 , 4 , V_130 -> V_147 ) ;
F_10 ( V_2 , V_141 , V_148 ,
V_133 ) ;
}
...
struct V_18 * V_19 = F_9 ( V_2 ) ;
struct V_127 * V_128 = V_19 -> V_128 ;
int V_34 = F_37 ( V_15 -> V_149 . V_126 ) ;
struct V_50 * V_51 ;
...
struct V_50 * V_51 ;
V_51 = & V_19 -> V_6 [ V_34 ] ;
V_17 -> V_21 . V_150 . V_151 [ 0 ] = V_51 -> V_136 ;
return 0 ;
}
...
for ( V_154 = 0 ; V_154 < V_19 -> V_135 ; V_154 ++ ) {
if ( strcmp ( V_152 [ V_10 ] . V_126 , V_19 -> V_140 [ V_154 ] ) == 0 )
break;
}
if ( V_154 != V_19 -> V_135 )
continue;
V_155 = F_44 ( V_19 -> V_140 ,
sizeof( char * ) * ( V_19 -> V_135 + 1 ) ,
V_160 ) ;
if ( V_155 == NULL )
continue;
V_155 [ V_19 -> V_135 ] = V_152 [ V_10 ] . V_126 ;
V_19 -> V_135 ++ ;
V_19 -> V_140 = V_155 ;
}
V_19 -> V_159 . V_161 = V_19 -> V_140 ;
V_19 -> V_159 . V_162 = V_19 -> V_135 ;
V_156 = F_45 ( V_2 , V_158 , F_21 ( V_158 ) ) ;
if ( V_156 != 0 )
F_26 ( V_2 -> V_64 , L_8 , V_156 ) ;
}
...
V_19 -> V_99 = ( V_53 ? 1 : 0 ) ;
F_4 ( V_2 , V_167 , V_53 ) ;
V_53 = ( ( V_128 -> V_168 ) ? V_169 : 0 ) ;
F_10 ( V_2 , V_170 ,
V_171 , V_53 ) ;
if ( V_128 -> V_138 )
F_42 ( V_2 ) ;
}
static int F_47 ( struct V_1 * V_2 , T_3 V_35 )
{
F_36 ( V_2 , V_123 ) ;
return 0 ;
}
...
int V_156 = 0 ;
V_2 -> V_110 = 1 ;
V_156 = F_50 ( V_2 , 8 , 8 , V_172 ) ;
if ( V_156 != 0 ) {
F_26 ( V_2 -> V_64 , L_10 , V_156 ) ;
return V_156 ;
}
...
V_19 -> V_22 = 0 ;
V_19 -> V_26 = 0 ;
V_156 = F_25 ( V_2 , V_174 ) ;
if ( V_156 < 0 ) {
F_26 ( V_2 -> V_64 , L_11 ,
V_156 ) ;
goto V_175;
}
F_51 ( V_2 -> V_64 , L_12 , V_156 + 'A' ) ;
F_4 ( V_2 , V_58 , V_176 ) ;
F_36 ( V_2 , V_120 ) ;
F_4 ( V_2 , V_177 , 0x00 ) ;
F_4 ( V_2 , V_178 ,
...
const struct V_193 * V_149 )
{
struct V_18 * V_19 ;
int V_156 ;
V_19 = F_55 ( sizeof( struct V_18 ) , V_160 ) ;
if ( V_19 == NULL )
return - V_194 ;
V_19 -> V_195 = V_149 -> V_196 ;
F_56 ( V_192 , V_19 ) ;
V_19 -> V_197 = V_192 ;
V_19 -> V_128 = V_192 -> V_64 . V_198 ;
V_156 = F_57 ( & V_192 -> V_64 ,
& V_199 , & V_200 [ 0 ] , 2 ) ;
if ( V_156 < 0 )
F_53 ( V_19 ) ;
return V_156 ;
}
static int T_4 F_58 ( struct V_191 * V_201 )
{
F_59 ( & V_201 -> V_64 ) ;
F_53 ( F_60 ( V_201 ) ) ;
return 0 ;
