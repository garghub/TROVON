...
return NULL ;
if ( F_28 ( V_1 + 5 , 10 , & V_49 ) || V_49 > V_50 )
return NULL ;
V_48 = F_8 ( V_2 , struct V_47 , V_51 ) ;
...
V_32 -> V_52 = V_48 ;
F_29 ( & V_32 -> V_53 ) ;
V_17 = F_30 ( & V_54 -> V_55 , V_2 , & V_32 -> V_28 ,
V_32 , V_56 ) ;
if ( V_17 < 0 ) {
F_19 ( V_32 ) ;
return NULL ;
}
V_32 -> V_57 = F_31 ( L_12 , 0 , 1 ) ;
if ( ! V_32 -> V_57 ) {
F_19 ( V_32 ) ;
return NULL ;
}
F_32 ( & V_58 ) ;
F_33 ( & V_32 -> V_59 , & V_48 -> V_60 ) ;
F_34 ( & V_58 ) ;
return & V_32 -> V_28 ;
}
...
struct V_31 * F_40 ( struct V_63 * V_64 )
{
struct V_47 * V_48 ;
struct V_31 * V_32 ;
F_22 (lacl, &ft_lport_list, list) {
if ( V_48 -> V_33 == V_64 -> V_33 ) {
...
F_33 ( & V_48 -> V_59 , & V_68 ) ;
F_3 ( V_48 -> V_1 , sizeof( V_48 -> V_1 ) , V_33 ) ;
F_34 ( & V_58 ) ;
return & V_48 -> V_51 ;
}
static void F_42 ( struct V_46 * V_2 )
{
struct V_47 * V_48 = F_8 ( V_2 ,
struct V_47 , V_51 ) ;
F_2 ( L_15 ,
F_17 ( & V_2 -> V_69 . V_40 ) ) ;
F_32 ( & V_58 ) ;
...
char * V_20 )
{
return sprintf ( V_20 , L_16 V_70 L_17
L_18 V_71 L_19 , F_44 () -> V_72 , F_44 () -> V_73 ) ;
}
static char * F_45 ( void )
{
return L_20 ;
}
static char * F_46 ( struct V_27 * V_28 )
{
struct V_31 * V_32 = V_28 -> V_74 ;
return V_32 -> V_52 -> V_1 ;
}
static T_6 F_47 ( struct V_27 * V_28 )
{
struct V_31 * V_32 = V_28 -> V_74 ;
return V_32 -> V_49 ;
}
...
static T_6 F_52 ( struct V_75 * V_75 , T_3 V_76 )
{
return 0 ;
}
static T_3 F_53 ( struct V_27 * V_28 )
{
struct V_31 * V_32 = V_28 -> V_74 ;
return V_32 -> V_49 ;
}
...
V_77 -> V_55 = V_80 ;
V_77 -> V_55 . V_81 = 1 ;
F_58 ( V_77 ) -> V_82 . V_83 = V_84 ;
F_58 ( V_77 ) -> V_85 . V_83 = NULL ;
F_58 ( V_77 ) -> V_86 . V_83 = NULL ;
F_58 ( V_77 ) -> V_87 . V_83 = NULL ;
F_58 ( V_77 ) -> V_88 . V_83 = NULL ;
F_58 ( V_77 ) -> V_89 . V_83 =
V_90 ;
F_58 ( V_77 ) -> V_91 . V_83 = NULL ;
F_58 ( V_77 ) -> V_92 . V_83 = NULL ;
F_58 ( V_77 ) -> V_93 . V_83 = NULL ;
V_17 = F_59 ( V_77 ) ;
if ( V_17 < 0 ) {
F_2 ( L_22
L_23 ) ;
