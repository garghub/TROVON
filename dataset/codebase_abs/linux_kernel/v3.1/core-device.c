...
V_94 = F_36 ( sizeof( * V_94 ) * V_97 +
sizeof( * V_95 ) * V_97 , V_98 ) ;
if ( V_94 == NULL )
return - V_53 ;
V_95 = & V_94 [ V_97 ] ;
memset ( V_94 , 0 , sizeof( * V_94 ) * V_97 ) ;
V_42 -> V_90 = V_99 ;
for ( V_16 = 0 ; V_16 < 5 ; V_16 ++ ) {
if ( F_31 ( V_42 , V_55 , V_16 , & V_94 [ V_16 ] ) != V_100 )
goto V_101;
if ( V_16 == 0 && V_94 [ V_16 ] == 0 )
goto V_101;
}
V_42 -> V_90 = V_42 -> V_102 -> V_90 ;
if ( ( V_94 [ 2 ] & 0x7 ) < V_42 -> V_90 ||
V_42 -> V_90 == V_103 ||
V_42 -> V_56 -> V_104 ) {
T_1 V_105 ;
if ( V_42 -> V_90 == V_103 )
V_42 -> V_90 = V_42 -> V_56 -> V_106 ;
while ( V_42 -> V_90 > V_99 ) {
if ( F_31 ( V_42 , V_55 , 0 , & V_105 ) ==
V_100 )
break;
V_42 -> V_90 -- ;
}
...
V_16 ++ ;
for (; V_16 < V_4 ; V_16 ++ ) {
if ( F_31 ( V_42 , V_55 , V_16 , & V_94 [ V_16 ] ) !=
V_100 )
goto V_101;
if ( ( V_5 >> 30 ) != 3 || ( V_94 [ V_16 ] >> 30 ) < 2 )
continue;
if ( V_16 + ( V_94 [ V_16 ] & 0xffffff ) >= V_97 ) {
F_38 ( L_9 ,
V_94 [ V_16 ] ,
V_16 * 4 | V_86 | V_87 ) ;
V_94 [ V_16 ] = 0 ;
...
V_95 [ V_96 ++ ] = V_16 + V_94 [ V_16 ] ;
}
if ( V_78 < V_16 )
V_78 = V_16 ;
}
V_92 = V_42 -> V_29 ;
V_93 = F_39 ( V_94 , V_78 * 4 , V_98 ) ;
if ( V_93 == NULL )
goto V_101;
F_40 ( & V_65 ) ;
V_42 -> V_29 = V_93 ;
...
F_42 ( V_92 ) ;
V_64 = 0 ;
V_42 -> V_107 = V_94 [ 2 ] >> 12 & 0xf ;
V_42 -> V_108 = V_94 [ 2 ] >> 30 & 1 ;
V_42 -> V_109 = V_94 [ 2 ] >> 31 & 1 ;
V_101:
F_42 ( V_94 ) ;
return V_64 ;
}
...
{
return V_43 -> type == & V_110 ;
}
static void F_44 ( struct V_54 * V_42 )
{
struct V_1 V_2 ;
struct V_27 * V_28 ;
int V_5 , V_6 , V_16 ;
...
if ( V_5 != ( V_81 | V_82 ) )
continue;
V_28 = F_45 ( sizeof( * V_28 ) , V_98 ) ;
if ( V_28 == NULL ) {
F_38 ( L_10 ) ;
continue;
}
V_28 -> V_7 = V_2 . V_3 + V_6 - 1 ;
V_28 -> V_42 . V_111 = & V_112 ;
V_28 -> V_42 . type = & V_110 ;
V_28 -> V_42 . V_79 = & V_42 -> V_42 ;
F_46 ( & V_28 -> V_42 , L_11 , F_47 ( & V_42 -> V_42 ) , V_16 ++ ) ;
F_48 ( F_24 ( V_28 -> V_77 . V_69 ) <
F_24 ( V_113 ) +
F_24 ( V_74 ) ) ;
F_23 ( & V_28 -> V_42 ,
V_113 ,
...
static int F_50 ( struct V_42 * V_42 , void * V_84 )
{
F_51 ( V_42 ) ;
return 0 ;
}
struct V_54 * F_52 ( T_5 V_115 )
{
struct V_54 * V_42 ;
F_20 ( & V_65 ) ;
V_42 = F_53 ( & V_116 , F_54 ( V_115 ) ) ;
if ( V_42 )
F_55 ( V_42 ) ;
F_21 ( & V_65 ) ;
return V_42 ;
}
static void F_56 ( struct V_54 * V_42 ,
unsigned long V_117 )
{
F_57 ( V_118 , & V_42 -> V_119 , V_117 ) ;
}
static void F_58 ( struct V_120 * V_119 )
{
struct V_54 * V_42 =
F_12 ( V_119 , struct V_54 , V_119 . V_119 ) ;
int V_121 = F_54 ( V_42 -> V_42 . V_115 ) ;
if ( F_59 ( F_60 () ,
V_42 -> V_56 -> V_122 + V_123 )
&& ! F_61 ( & V_42 -> V_56 -> V_124 ) ) {
F_56 ( V_42 , V_123 ) ;
return;
}
if ( F_62 ( & V_42 -> V_125 ,
...
{
struct V_54 * V_42 = V_54 ( V_43 ) ;
struct V_128 * V_56 = V_42 -> V_56 ;
unsigned long V_129 ;
F_68 ( & V_56 -> V_130 , V_129 ) ;
V_42 -> V_102 -> V_84 = NULL ;
F_69 ( & V_56 -> V_130 , V_129 ) ;
F_70 ( V_42 -> V_102 ) ;
F_42 ( V_42 -> V_29 ) ;
F_42 ( V_42 ) ;
F_71 ( V_56 ) ;
...
static void F_76 ( struct V_120 * V_119 )
{
struct V_54 * V_42 =
F_12 ( V_119 , struct V_54 , V_119 . V_119 ) ;
F_77 ( V_42 ) ;
F_64 ( & V_42 -> V_42 , NULL , F_73 ) ;
}
static int F_78 ( struct V_42 * V_43 , void * V_84 )
{
struct V_54 * V_133 = V_54 ( V_43 ) ;
struct V_54 * V_134 = V_84 ;
struct V_128 * V_56 = V_134 -> V_56 ;
int V_32 = 0 ;
if ( ! F_72 ( V_43 ) )
return 0 ;
F_20 ( & V_65 ) ;
F_79 ( & V_56 -> V_130 ) ;
if ( memcmp ( V_133 -> V_29 , V_134 -> V_29 , 6 * 4 ) == 0 &&
F_62 ( & V_133 -> V_125 ,
V_126 ,
V_135 ) == V_126 ) {
struct V_136 * V_137 = V_134 -> V_102 ;
struct V_136 * V_138 = V_133 -> V_102 ;
V_134 -> V_102 = V_138 ;
V_134 -> V_102 -> V_84 = V_134 ;
V_133 -> V_102 = V_137 ;
V_133 -> V_102 -> V_84 = V_133 ;
V_133 -> V_90 = V_134 -> V_90 ;
V_133 -> V_58 = V_137 -> V_58 ;
F_80 () ;
V_133 -> V_55 = V_56 -> V_55 ;
V_133 -> V_139 = 0 ;
F_81 ( L_12 , F_47 ( V_43 ) ) ;
F_82 ( & V_133 -> V_119 , F_76 ) ;
F_56 ( V_133 , 0 ) ;
if ( V_137 == V_56 -> V_140 )
F_83 ( V_56 , 0 ) ;
V_32 = 1 ;
...
int F_87 ( struct V_42 * V_43 , void * V_151 )
{
if ( F_72 ( V_43 ) )
F_85 ( V_54 ( V_43 ) , ( long ) V_151 ) ;
return 0 ;
}
static void F_88 ( struct V_120 * V_119 )
{
struct V_54 * V_42 =
F_12 ( V_119 , struct V_54 , V_119 . V_119 ) ;
struct V_42 * V_152 ;
int V_121 , V_64 ;
if ( F_35 ( V_42 , V_42 -> V_55 ) < 0 ) {
if ( V_42 -> V_139 < V_153 &&
F_89 ( & V_42 -> V_125 ) == V_154 ) {
V_42 -> V_139 ++ ;
F_56 ( V_42 , V_155 ) ;
} else {
if ( V_42 -> V_102 -> V_156 )
F_81 ( L_13 ,
V_42 -> V_58 ) ;
if ( V_42 -> V_102 == V_42 -> V_56 -> V_140 )
F_83 ( V_42 -> V_56 , 0 ) ;
F_67 ( & V_42 -> V_42 ) ;
}
return;
}
V_152 = F_90 ( V_42 -> V_56 -> V_42 ,
V_42 , F_78 ) ;
if ( V_152 ) {
F_91 ( V_152 ) ;
F_67 ( & V_42 -> V_42 ) ;
...
F_55 ( V_42 ) ;
F_40 ( & V_65 ) ;
V_64 = F_93 ( & V_116 , V_98 ) ?
F_94 ( & V_116 , V_42 , & V_121 ) :
- V_53 ;
F_41 ( & V_65 ) ;
if ( V_64 < 0 )
goto error;
V_42 -> V_42 . V_111 = & V_112 ;
V_42 -> V_42 . type = & V_131 ;
V_42 -> V_42 . V_79 = V_42 -> V_56 -> V_42 ;
V_42 -> V_42 . V_115 = F_95 ( V_157 , V_121 ) ;
F_46 ( & V_42 -> V_42 , L_14 , V_121 ) ;
F_48 ( F_24 ( V_42 -> V_77 . V_69 ) <
F_24 ( V_158 ) +
F_24 ( V_74 ) ) ;
F_23 ( & V_42 -> V_42 ,
V_158 ,
...
static int F_97 ( struct V_54 * V_42 , int V_55 )
{
T_1 V_160 ;
int V_16 ;
for ( V_16 = 0 ; V_16 < 6 ; V_16 ++ ) {
if ( F_31 ( V_42 , V_55 , V_16 , & V_160 ) != V_100 )
return V_161 ;
if ( V_16 == 0 && V_160 == 0 )
return V_162 ;
if ( V_160 != V_42 -> V_29 [ V_16 ] )
return V_163 ;
}
return V_164 ;
}
static void F_98 ( struct V_120 * V_119 )
{
struct V_54 * V_42 =
F_12 ( V_119 , struct V_54 , V_119 . V_119 ) ;
struct V_128 * V_56 = V_42 -> V_56 ;
int V_58 = V_42 -> V_58 ;
switch ( F_97 ( V_42 , V_42 -> V_55 ) ) {
case V_161 :
if ( V_42 -> V_139 < V_153 / 2 &&
F_89 ( & V_42 -> V_125 ) == V_154 ) {
V_42 -> V_139 ++ ;
F_56 ( V_42 , V_155 / 2 ) ;
return;
...
F_77 ( V_42 ) ;
F_44 ( V_42 ) ;
F_99 ( & V_42 -> V_42 . V_167 , V_168 ) ;
if ( F_62 ( & V_42 -> V_125 ,
V_154 ,
V_135 ) == V_126 )
goto V_166;
F_81 ( L_19 , F_47 ( & V_42 -> V_42 ) ) ;
V_42 -> V_139 = 0 ;
goto V_101;
V_165:
F_81 ( L_20 , F_47 ( & V_42 -> V_42 ) ) ;
V_166:
F_100 ( & V_42 -> V_125 , V_126 ) ;
F_82 ( & V_42 -> V_119 , F_58 ) ;
F_56 ( V_42 , V_123 ) ;
V_101:
if ( V_58 == V_56 -> V_140 -> V_58 )
F_83 ( V_56 , 0 ) ;
}
void F_101 ( struct V_128 * V_56 , struct V_136 * V_102 , int V_169 )
{
struct V_54 * V_42 ;
switch ( V_169 ) {
case V_170 :
V_171:
V_42 = F_45 ( sizeof( * V_42 ) , V_172 ) ;
if ( V_42 == NULL )
break;
F_100 ( & V_42 -> V_125 , V_154 ) ;
V_42 -> V_56 = F_102 ( V_56 ) ;
V_42 -> V_102 = F_103 ( V_102 ) ;
V_42 -> V_58 = V_102 -> V_58 ;
V_42 -> V_55 = V_56 -> V_55 ;
V_42 -> V_173 = V_102 == V_56 -> V_174 ;
F_104 ( & V_42 -> V_175 ) ;
F_105 ( & V_42 -> V_176 ) ;
V_102 -> V_84 = V_42 ;
F_106 ( & V_42 -> V_119 , F_88 ) ;
F_56 ( V_42 , V_177 ) ;
break;
case V_178 :
case V_179 :
...
F_80 () ;
V_42 -> V_55 = V_56 -> V_55 ;
if ( F_89 ( & V_42 -> V_125 ) == V_135 ) {
F_82 ( & V_42 -> V_119 , F_76 ) ;
F_56 ( V_42 , 0 ) ;
}
break;
case V_181 :
