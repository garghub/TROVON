...
if ( V_64 -> V_72 . V_128 && ! F_55 ( V_64 -> V_72 . V_128 ) )
F_56 ( V_64 -> V_72 . V_128 ) ;
if ( V_64 -> V_72 . V_129 && ! F_55 ( V_64 -> V_72 . V_129 ) )
F_56 ( V_64 -> V_72 . V_129 ) ;
F_13 ( L_53 ) ;
if ( V_64 -> V_72 . V_118 != NULL ) {
F_57 ( V_64 -> V_72 . V_118 ) ;
...
static void F_59 ( struct V_126 * V_72 )
{
F_36 ( & V_72 -> V_14 ) ;
V_72 -> V_73 = V_102 ;
F_37 ( & V_72 -> V_14 ) ;
}
static void F_60 ( struct V_78 * V_64 )
{
...
V_64 -> V_72 . V_135 . V_137 = F_58 ;
V_64 -> V_72 . V_135 . V_138 = F_59 ;
F_64 ( & V_64 -> V_72 ) ;
}
...
V_23 -> V_33 = V_141 ;
V_23 -> V_142 = 1 ;
V_139 = F_67 ( & F_68 ( V_26 ) -> V_143 , & V_144 ) ;
if ( V_139 ) {
F_18 ( L_57 ) ;
return V_139 ;
}
...
{
struct V_25 * V_26 = F_11 ( V_23 ) ;
F_74 ( & V_23 -> V_146 . V_147 -> V_82 , L_60 , V_148 ) ;
F_75 ( & V_26 -> V_14 ) ;
V_23 -> V_33 = V_34 ;
F_76 ( & V_26 -> V_14 ) ;
return 0 ;
...
V_23 = F_79 ( & V_156 , & V_152 -> V_82 , F_80 ( & V_152 -> V_82 ) ) ;
if ( ! V_23 ) {
F_18 ( L_63 ) ;
return - V_122 ;
}
...
static int F_86 ( struct V_151 * V_152 , T_4 V_33 )
{
struct V_22 * V_23 ;
int V_9 = 0 ;
int V_158 = 0 ;
...
{
struct V_22 * V_23 ;
F_74 ( & V_152 -> V_82 , L_60 , V_148 ) ;
V_23 = F_84 ( V_152 ) ;
F_89 ( V_160 , & V_23 -> V_12 ) ;
F_7 ( V_23 ) ;
return 0 ;
}
static void F_90 ( struct V_95 * V_82 )
{
return;
}
