...
{
struct V_39 * V_40 ;
V_40 = F_38 ( V_2 -> V_70 . V_71 , struct V_39 , V_72 ) ;
if ( V_40 -> V_69 . V_73 )
F_39 ( V_2 ) ;
else
F_40 ( V_2 ) ;
...
static void F_42 ( unsigned int V_9 )
{
F_43 ( V_9 ) ;
}
int T_4 F_44 ( void )
...
static struct V_87 * F_55 ( struct V_1 * V_2 )
{
struct V_87 * V_88 ;
...
int F_58 ( struct V_1 * V_2 , T_5 V_89 )
{
struct V_87 * V_88 ;
V_88 = F_15 ( sizeof( struct V_87 ) , V_42 ) ;
if ( ! V_88 )
return - V_57 ;
F_56 ( & V_90 ) ;
if ( F_55 ( V_2 ) ) {
