...
F_16 ( V_65 , 4 , V_57 + V_66 ) ;
F_16 ( V_67 , 4 , V_57 + V_48 ) ;
F_16 ( V_68 , 4 , 0xfffffc01 ) ;
} else {
F_31 ( L_16 ) ;
}
F_31 ( L_17 ,
...
F_6 ( L_20 ) ;
* V_10 = V_69 | V_11 | V_70 | V_71 ;
#ifdef F_33
* V_58 = V_72 | V_73 | V_74 | V_75 ;
#else
* V_58 = V_72 | V_73 ;
#endif
F_6 ( L_21 ) ;
}
int F_34 ( int V_76 , struct V_77 * V_78 )
{
struct V_79 * V_80 ;
if ( V_76 >= 1 )
return 0 ;
V_80 = F_35 ( sizeof( * V_80 ) * 2 , V_81 ) ;
if ( V_80 == NULL ) {
F_36 ( L_22 ) ;
}
F_16 ( V_82 , 2 , V_83 | V_84 ) ;
V_80 [ 0 ] . V_85 = L_23 ;
V_80 [ 0 ] . V_86 = 0x00000000 ;
V_80 [ 0 ] . V_87 = 0x0000ffff ;
V_80 [ 0 ] . V_3 = V_88 ;
V_80 [ 1 ] . V_85 = L_24 ;
V_80 [ 1 ] . V_86 = V_89 ;
V_80 [ 1 ] . V_87 = V_90 ;
...
struct V_32 * T_7 F_38 ( int V_76 , struct V_77 * V_78 )
{
return F_39 ( V_78 -> V_96 , & V_97 , V_78 ) ;
}
int F_40 ( struct V_45 * V_46 , T_8 V_98 )
{
if ( V_98 >= V_48 - 1 )
return 0 ;
return - V_99 ;
