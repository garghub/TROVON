...
static int T_2 F_3 ( struct V_11 * V_12 )
{
...
static int T_2 F_6 ( struct V_11 * V_12 , unsigned int V_17 )
{
unsigned int V_13 = 100 ;
while ( V_13 -- ) {
...
static void T_2 F_7 ( struct V_11 * V_12 , unsigned int V_19 ,
...
static int T_2 F_9 ( struct V_27 * V_28 )
{
...
static int T_2 F_20 ( struct V_27 * V_28 )
{
struct V_11 * V_12 = V_28 -> V_29 ;
unsigned int V_13 = 100 ;
F_15 ( & V_28 -> V_37 ) ;
...
static void T_2 F_21 ( struct V_27 * V_28 )
{
struct V_11 * V_12 = V_28 -> V_29 ;
F_8 ( V_12 , 1 , V_47 ) ;
F_8 ( V_12 , 0 , V_48 ) ;
...
static int T_2 F_22 ( struct V_27 * V_28 )
{
struct V_11 * V_12 = V_28 -> V_29 ;
unsigned int V_21 ;
T_3 V_50 ;
...
int T_2 F_36 ( const struct V_1 * V_102 , T_7 V_103 , T_7 V_104 )
{
return 71 ;
}
static int T_2 F_37 ( void )
{
return F_38 ( V_105 ) ? 3 : 2 ;
}
static void T_2 F_39 ( void * V_21 , T_8 V_106 )
{
struct V_27 * V_28 = V_21 ;
int V_32 ;
V_28 -> V_57 = F_38 ( V_107 ) ;
V_32 = F_9 ( V_28 ) ;
if ( F_11 ( V_32 < 0 ) ) {
F_40 ( L_4 ,
V_28 -> V_34 ) ;
...
V_109 = & V_110 ;
V_111 = V_109 -> V_112 () ;
F_44 ( V_111 > F_45 ( V_113 ) ) ;
if ( F_11 ( V_111 == 0 ) )
return - V_114 ;
V_115 = F_46 ( V_111 * sizeof( struct V_27 ) ,
V_116 ) ;
if ( F_11 ( ! V_115 ) )
return - V_117 ;
V_108 = F_12 ( NULL , L_8 ) ;
