...
return V_68 ;
V_66 = V_12 -> V_69 ;
* V_63 = ( V_66 [ 0 ] & V_77 ) == V_77 ;
* V_64 = ( V_66 [ 0 ] & V_78 ) == V_78 ;
* V_65 = ( V_66 [ 3 ] & V_79 ) == V_79 ;
* V_10 = ( V_66 [ 3 ] >> 1 ) & 0x7F ;
* V_62 = ( V_66 [ 2 ] >> 1 ) & 0x7F ;
return V_76 ;
}
...
void F_22 ( struct V_1 * V_2 , int V_82 , unsigned char V_59 ,
unsigned char V_60 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
F_1 ( V_2 ) ;
