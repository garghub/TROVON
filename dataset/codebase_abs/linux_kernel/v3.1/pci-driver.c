...
error = V_2 -> V_61 -> V_63 ( V_37 ) ;
return error ;
}
static void F_81 ( struct V_4 * V_37 )
{
struct V_22 * V_2 = V_37 -> V_20 ;
...
{
struct V_36 * V_36 = F_42 ( V_37 ) ;
const struct V_65 * V_61 = V_37 -> V_20 ? V_37 -> V_20 -> V_61 : NULL ;
if ( F_72 ( V_36 ) )
return F_60 ( V_37 , V_66 ) ;
if ( ! V_61 ) {
F_70 ( V_36 ) ;
goto V_67;
}
...
T_5 V_53 = V_36 -> V_45 ;
int error ;
error = V_61 -> V_68 ( V_37 ) ;
F_61 ( V_61 -> V_68 , error ) ;
if ( error )
return error ;
if ( ! V_36 -> V_54 && V_36 -> V_45 != V_46
&& V_36 -> V_45 != V_47 ) {
...
if ( F_72 ( V_36 ) )
return F_65 ( V_37 ) ;
if ( V_2 && V_2 -> V_61 && V_2 -> V_61 -> V_69 )
error = V_2 -> V_61 -> V_69 ( V_37 ) ;
return error ;
}
...
if ( V_61 -> V_71 ) {
int error ;
error = V_61 -> V_71 ( V_37 ) ;
F_61 ( V_61 -> V_71 , error ) ;
if ( error )
return error ;
}
return 0 ;
...
if ( V_61 -> V_76 ) {
int error ;
error = V_61 -> V_76 ( V_37 ) ;
F_61 ( V_61 -> V_76 , error ) ;
if ( error )
return error ;
}
V_67:
...
struct V_22 * V_2 = V_37 -> V_20 ;
if ( F_72 ( F_42 ( V_37 ) ) )
return F_63 ( V_37 , V_75 ) ;
if ( ! V_2 || ! V_2 -> V_61 )
return 0 ;
if ( V_2 -> V_61 -> V_77 ) {
int error ;
error = V_2 -> V_61 -> V_77 ( V_37 ) ;
F_61 ( V_2 -> V_61 -> V_77 , error ) ;
if ( error )
return error ;
}
...
return - V_81 ;
F_54 ( V_36 ) ;
F_98 ( V_36 , V_46 , true , false ) ;
F_55 ( V_58 , V_36 ) ;
return V_61 -> V_82 ( V_37 ) ;
}
...
int F_101 ( struct V_1 * V_2 , struct V_84 * V_85 ,
const char * V_86 )
{
int error ;
V_2 -> V_20 . V_87 = V_2 -> V_87 ;
V_2 -> V_20 . V_88 = & V_89 ;
V_2 -> V_20 . V_85 = V_85 ;
V_2 -> V_20 . V_86 = V_86 ;
F_102 ( & V_2 -> V_16 . V_17 ) ;
...
{
struct V_36 * V_36 = F_42 ( V_37 ) ;
struct V_1 * V_99 = F_14 ( V_2 ) ;
const struct V_26 * V_100 ;
V_100 = F_24 ( V_99 , V_36 ) ;
if ( V_100 )
return 1 ;
return 0 ;
}
...
int F_111 ( struct V_4 * V_37 , struct V_101 * V_102 )
{
return - V_32 ;
}
