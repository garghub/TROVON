...
{
if ( V_32 -> V_34 [ 0 ] == 0x3d600000 + ( ( V_33 + 0x8000 ) >> 16 )
&& V_32 -> V_34 [ 1 ] == 0x396b0000 + ( V_33 & 0xffff ) )
return 1 ;
return 0 ;
}
...
V_32 -> V_34 [ 0 ] = 0x3d600000 + ( ( V_33 + 0x8000 ) >> 16 ) ;
V_32 -> V_34 [ 1 ] = 0x396b0000 + ( V_33 & 0xffff ) ;
V_32 -> V_34 [ 2 ] = 0x7d6903a6 ;
