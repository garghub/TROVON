...
if ( ( V_48 = F_162 ( V_182 , V_338 , V_14 , & V_247 ) ) < 0 ) {
F_153 ( V_14 ) ;
return V_48 ;
}
F_151 ( V_6 ) ;
...
unsigned int V_9 ;
int V_48 ;
V_48 = F_168 ( V_228 , V_185 , V_348 , 0 , & V_182 ) ;
if ( V_48 < 0 )
return V_48 ;
V_347 = V_346 -> V_349 ;
switch ( V_347 ) {
...
for ( V_9 = 0 ; V_9 < F_72 ( V_352 ) ; V_9 ++ ) {
if ( V_6 -> V_110 == V_352 [ V_9 ] . V_110 ) {
V_92 = V_352 [ V_9 ] . type ;
strcpy ( V_182 -> V_200 , V_352 [ V_9 ] . V_205 ) ;
break;
}
}
if ( V_92 != V_272 ) {
if ( V_353 == V_354 )
V_353 = F_164 ( V_6 , V_6 -> V_110 ) ;
if ( V_353 == V_355 )
V_92 = V_272 ;
else
V_92 = V_335 ;
