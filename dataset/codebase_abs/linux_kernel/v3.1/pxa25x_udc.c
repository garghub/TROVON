...
if ( V_23 -> V_34 != V_21 -> V_34
&& V_23 -> V_34 != V_35
&& V_21 -> V_34 != V_36 ) {
F_13 ( L_2 , V_32 , V_19 -> V_26 ) ;
return - V_33 ;
}
if ( ( V_21 -> V_34 == V_35
&& F_12 ( V_21 -> V_31 )
...
if ( ! V_25 )
return - V_125 ;
if ( ! V_39 || V_39 != V_25 -> V_39 || ! V_39 -> V_176 )
return - V_33 ;
F_76 () ;
V_25 -> F_53 = 0 ;
F_53 ( V_25 ) ;
...
static T_5
F_78 ( int V_179 , void * V_180 )
{
struct V_24 * V_25 = V_180 ;
int V_136 ;
V_25 -> V_84 . V_159 ++ ;
switch ( V_179 ) {
case V_181 :
...
F_18 ( & V_25 -> V_23 [ V_123 ] , - V_185 ) ;
}
static void F_82 ( unsigned long V_180 )
{
struct V_24 * V_25 = ( void * ) V_180 ;
F_76 () ;
if ( V_25 -> V_60 == V_122
&& ( V_76 & V_155 ) == 0
&& ( V_76 & V_156 ) == 0 ) {
...
if ( ( V_186 & V_77 ) != 0 && V_25 -> V_60 != V_61 ) {
F_18 ( V_23 , 0 ) ;
F_84 ( & V_25 -> V_178 ) ;
F_30 ( V_25 ) ;
}
...
V_191 . V_189 [ V_123 ] = ( T_4 ) V_82 ;
}
if ( F_35 ( ( V_76 & V_98 ) != 0 ) )
goto V_194;
V_196:
F_15 ( V_47 , L_76 ,
V_191 . V_188 . V_197 , V_191 . V_188 . V_198 ,
F_12 ( V_191 . V_188 . V_199 ) ,
F_12 ( V_191 . V_188 . V_200 ) ,
F_12 ( V_191 . V_188 . V_201 ) ) ;
V_25 -> V_202 = ( V_191 . V_188 . V_197 & V_203 )
== V_204 ;
V_25 -> V_105 = 0 ;
V_25 -> V_81 = 1 ;
switch ( V_191 . V_188 . V_198 ) {
case V_205 :
if ( V_191 . V_188 . V_197 == V_206 ) {
V_207:
V_25 -> V_105 = 1 ;
F_81 ( V_25 ) ;
}
...
if ( V_191 . V_188 . V_197 & V_113 )
V_25 -> V_60 = V_101 ;
else
V_25 -> V_60 = V_103 ;
V_123 = V_25 -> V_39 -> V_173 ( & V_25 -> V_40 , & V_191 . V_188 ) ;
if ( V_123 < 0 ) {
if ( V_25 -> V_105 ) {
F_85 ( L_79 ,
V_191 . V_188 . V_198 , V_123 ) ;
return;
}
F_15 ( V_47 , L_80
L_81 , V_76 , V_123 ) ;
...
|| V_25 -> V_202 || V_191 . V_188 . V_201 ) )
F_36 ( V_25 , 0 , L_83 ) ;
else
F_36 ( V_25 , V_87 , L_84 ) ;
}
return;
} else if ( F_29 ( ( V_186 & ( V_78 | V_77 ) )
== ( V_78 | V_77 ) ) ) {
unsigned V_123 ;
F_15 ( V_47 , L_85 ) ;
F_18 ( V_23 , - V_193 ) ;
for ( V_123 = 0 ; V_123 < 8 ; V_123 ++ )
V_191 . V_189 [ V_123 ] = ( T_4 ) V_82 ;
if ( ( V_191 . V_188 . V_197 & V_211 )
> V_212 )
goto V_195;
if ( V_191 . V_190 [ 0 ] == 0 && V_191 . V_190 [ 1 ] == 0 )
goto V_195;
goto V_196;
} else {
V_76 = V_186 & ( V_77 | V_78 ) ;
}
break;
case V_101 :
if ( V_186 & V_78 ) {
...
if ( F_35 ( V_213 ) ) {
V_146 = V_127 ;
if ( F_29 ( V_23 -> V_34 == V_35 ) )
V_146 |= V_124 ;
V_146 &= V_88 ;
if ( F_29 ( V_146 ) )
* V_23 -> V_71 = V_146 ;
if ( V_52 && F_29 ( ( V_88 & V_74 ) != 0 ) )
V_214 = F_34 ( V_23 , V_52 ) ;
} else {
if ( F_29 ( V_23 -> V_34 == V_35 ) )
V_146 = V_215 | V_216 ;
else
...
T_3 V_221 = V_79 & ~ V_12 ;
T_3 V_222 = V_147 & ~ V_13 ;
int V_123 ;
if ( F_35 ( ! V_221 && ! V_222 ) )
continue;
F_15 ( V_70 , L_92 , V_222 , V_221 ) ;
if ( V_221 & V_80 ) {
V_25 -> V_23 [ 0 ] . V_45 ++ ;
F_83 ( V_25 ) ;
V_218 = 1 ;
...
for ( V_123 = 0 ; V_123 < 8 ; V_123 ++ ) {
T_3 V_146 = 1 << V_123 ;
if ( V_123 && ( V_221 & V_146 ) ) {
F_86 ( & V_25 -> V_23 [ V_123 ] ) ;
V_79 |= V_146 ;
V_218 = 1 ;
}
#ifndef F_88
if ( V_222 & V_146 ) {
F_86 ( & V_25 -> V_23 [ V_123 + 8 ] ) ;
V_147 |= V_146 ;
V_218 = 1 ;
}
#endif
...
static void F_89 ( struct V_223 * V_25 )
{
F_13 ( L_93 , V_32 , F_90 ( V_25 ) ) ;
}
static int T_6 F_91 ( struct V_224 * V_225 )
{
struct V_24 * V_25 = & V_226 ;
int V_171 , V_179 ;
T_3 V_227 ;
...
if ( V_179 < 0 )
return - V_125 ;
V_25 -> V_139 = F_95 ( & V_225 -> V_25 , NULL ) ;
if ( F_96 ( V_25 -> V_139 ) ) {
V_171 = F_97 ( V_25 -> V_139 ) ;
goto V_247;
}
F_98 ( L_96 , V_230 , V_179 ,
V_25 -> V_106 ? L_11 : L_97 ,
V_248 L_38
) ;
V_25 -> V_25 = & V_225 -> V_25 ;
V_25 -> V_2 = V_225 -> V_25 . V_249 ;
V_25 -> V_141 = F_99 () ;
if ( F_2 ( V_25 -> V_2 -> V_6 ) ) {
if ( ( V_171 = F_100 ( V_25 -> V_2 -> V_6 ,
L_98 ) ) ) {
F_101 ( & V_225 -> V_25 ,
L_99 ,
V_25 -> V_2 -> V_6 , V_171 ) ;
...
F_102 ( V_25 -> V_2 -> V_6 , 0 ) ;
}
F_103 ( & V_25 -> V_178 ) ;
V_25 -> V_178 . V_251 = F_82 ;
V_25 -> V_178 . V_252 = ( unsigned long ) V_25 ;
F_104 ( & V_25 -> V_40 . V_25 ) ;
V_25 -> V_40 . V_25 . V_253 = & V_225 -> V_25 ;
V_25 -> V_40 . V_25 . V_254 = V_225 -> V_25 . V_254 ;
V_3 = V_25 ;
F_105 ( V_225 , V_25 ) ;
F_57 ( V_25 ) ;
F_67 ( V_25 ) ;
V_25 -> V_136 = 0 ;
V_171 = F_106 ( V_179 , F_87 ,
V_255 , V_230 , V_25 ) ;
if ( V_171 != 0 ) {
F_92 ( L_100 ,
V_230 , V_179 , V_171 ) ;
...
#endif
F_109 ( V_25 ) ;
V_171 = F_110 ( & V_225 -> V_25 , & V_25 -> V_40 ) ;
if ( ! V_171 )
return V_171 ;
F_111 ( V_25 ) ;
#ifdef F_107
...
static void F_116 ( struct V_224 * V_180 )
{
F_1 () ;
}
static int T_7 F_117 ( struct V_224 * V_225 )
{
struct V_24 * V_25 = F_118 ( V_225 ) ;
F_119 ( & V_25 -> V_40 ) ;
if ( V_25 -> V_39 )
return - V_174 ;
V_25 -> F_53 = 0 ;
...
static int F_120 ( struct V_224 * V_25 , T_8 V_261 )
{
struct V_24 * V_134 = F_118 ( V_25 ) ;
unsigned long V_48 ;
if ( ! F_2 ( V_134 -> V_2 -> V_6 ) && ! V_134 -> V_2 -> V_7 )
F_85 ( L_102 ) ;
V_134 -> V_137 = 1 ;
...
static int F_121 ( struct V_224 * V_25 )
{
struct V_24 * V_134 = F_118 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
...
{
F_123 ( L_103 , V_230 , V_262 ) ;
return F_124 ( & V_263 , F_91 ) ;
}
