...
static int F_123 ( struct V_211 * V_111 , T_7 V_249 )
{
struct V_250 * V_150 = F_124 ( V_111 ) ;
...
F_129 ( V_111 ) ;
F_130 ( V_111 ) ;
F_131 ( V_111 , F_132 ( V_111 , V_249 ) ) ;
return 0 ;
}
static int F_133 ( struct V_211 * V_111 )
{
struct V_250 * V_150 = F_124 ( V_111 ) ;
struct V_1 * V_2 = V_150 -> V_18 ;
struct V_41 * V_42 ;
...
static void F_159 ( struct V_275 * V_276 , bool V_287 )
{
struct V_1 * V_2 = V_276 -> V_18 ;
unsigned long V_263 = V_2 -> V_5 + V_278 ;
...
static int F_167 ( struct V_291 * V_149 )
{
struct V_1 * V_2 = V_149 -> V_292 ;
return F_160 ( V_2 ) ;
}
static int T_5 F_168 ( struct V_250 * V_150 ,
struct V_211 * V_111 ,
int V_115 ,
int V_293 ,
int V_294 ,
...
return V_112 ;
if ( F_169 ( V_111 , F_170 ( 28 ) ) < 0 ||
F_171 ( V_111 , F_170 ( 28 ) ) < 0 ) {
F_71 ( V_116 L_20 ) ;
F_129 ( V_111 ) ;
return - V_299 ;
}
...
V_2 -> V_151 = V_293 ;
V_2 -> V_152 = V_294 ;
if ( ( V_112 = F_175 ( V_111 , L_10 ) ) < 0 ) {
F_63 ( V_2 ) ;
F_129 ( V_111 ) ;
return V_112 ;
}
V_2 -> V_5 = F_176 ( V_111 , 0 ) ;
if ( F_177 ( V_111 -> V_178 , F_107 , V_300 ,
V_301 , V_2 ) ) {
...
for ( V_21 = 0 ; V_21 < ( int ) F_178 ( V_302 ) ; V_21 ++ ) {
if ( V_2 -> type == V_302 [ V_21 ] . type &&
V_205 == V_302 [ V_21 ] . V_269 ) {
V_251 = 1 ;
break;
}
}
...
V_2 -> V_251 = V_251 ;
F_118 ( V_2 ) ;
if ( ( V_112 = F_179 ( V_150 , V_303 , V_2 , & V_195 ) ) < 0 ) {
F_160 ( V_2 ) ;
return V_112 ;
}
F_180 ( V_150 , & V_111 -> V_113 ) ;
#ifdef F_163
V_2 -> V_276 . V_18 = V_2 ;
V_2 -> V_276 . V_195 = & V_304 ;
F_181 ( V_2 -> V_276 . V_150 , L_23 , sizeof( V_2 -> V_276 . V_150 ) ) ;
sprintf ( V_2 -> V_276 . V_305 , L_24 , F_145 ( V_111 ) ) ;
if ( ! F_182 ( & V_2 -> V_276 ) )
F_91 ( V_146 L_25 ) ;
#endif
* V_296 = V_2 ;
...
static int T_5 F_183 ( struct V_211 * V_111 ,
...
V_112 = F_184 ( V_20 [ V_113 ] , V_173 [ V_113 ] , V_311 , 0 , & V_150 ) ;
if ( V_112 < 0 )
return V_112 ;
if ( V_115 [ V_113 ] < 128 )
V_115 [ V_113 ] = 128 ;
...
strcpy ( V_150 -> V_317 , L_27 ) ;
break;
case V_318 :
strcpy ( V_150 -> V_266 , L_28 ) ;
strcpy ( V_150 -> V_317 , L_29 ) ;
break;
case V_319 :
strcpy ( V_150 -> V_266 , L_30 ) ;
strcpy ( V_150 -> V_317 , L_31 ) ;
break;
}
...
unsigned short V_205 ;
F_114 ( V_2 -> V_111 , V_206 , & V_205 ) ;
for ( V_21 = 0 ; V_21 < F_178 ( V_321 ) ; V_21 ++ ) {
if ( V_2 -> type == V_321 [ V_21 ] . type &&
V_205 == V_321 [ V_21 ] . V_269 ) {
V_320 [ V_113 ] = 0 ;
break;
}
}
...
if ( V_320 [ V_113 ] ) {
if ( ( V_112 = F_186 ( V_150 , 0 , V_322 ,
V_2 -> V_5 + V_323 ,
V_324 ,
V_2 -> V_178 , 0 , & V_2 -> V_184 ) ) < 0 ) {
F_91 ( V_325 L_32 ) ;
}
}
F_139 ( V_2 , V_113 ) ;
...
if ( ! V_2 -> clock )
F_88 ( V_2 ) ;
sprintf ( V_150 -> V_326 , L_35 ,
V_150 -> V_317 , V_2 -> V_5 , V_2 -> V_178 ) ;
if ( ( V_112 = F_187 ( V_150 ) ) < 0 ) {
F_185 ( V_150 ) ;
return V_112 ;
}
F_188 ( V_111 , V_150 ) ;
...
static void T_8 F_189 ( struct V_211 * V_111 )
{
F_185 ( F_124 ( V_111 ) ) ;
F_188 ( V_111 , NULL ) ;
}
