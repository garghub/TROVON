...
static int F_26 ( struct V_5 * V_6 , T_4 V_144 )
{
F_23 ( V_6 , V_133 ) ;
return 0 ;
}
...
struct V_67 * V_68 = F_12 ( V_6 ) ;
int V_66 ;
V_73 = F_30 ( V_6 , 7 , 9 , V_68 -> V_145 ) ;
if ( V_73 < 0 ) {
F_10 ( V_6 -> V_43 , L_18 , V_73 ) ;
return V_73 ;
}
V_73 = F_6 ( V_6 , V_146 , 0x8983 ) ;
if ( V_73 < 0 ) {
F_10 ( V_6 -> V_43 , L_19 , V_73 ) ;
return V_73 ;
}
for ( V_66 = 0 ; V_66 < F_16 ( V_147 ) ; ++ V_66 )
F_5 ( V_6 , V_147 [ V_66 ] ,
0x100 , 0x100 ) ;
for ( V_66 = V_148 ;
V_66 <= V_149 ; ++ V_66 )
...
static int T_5 F_31 ( struct V_153 * V_154 )
{
struct V_67 * V_68 ;
int V_73 ;
V_68 = F_32 ( sizeof *V_68 , V_155 ) ;
if ( ! V_68 )
return - V_156 ;
V_68 -> V_145 = V_157 ;
F_33 ( V_154 , V_68 ) ;
V_73 = F_34 ( & V_154 -> V_43 ,
& V_158 , & V_159 , 1 ) ;
if ( V_73 < 0 )
F_35 ( V_68 ) ;
return V_73 ;
}
static int T_6 F_36 ( struct V_153 * V_154 )
{
F_37 ( & V_154 -> V_43 ) ;
F_35 ( F_38 ( V_154 ) ) ;
return 0 ;
}
static T_5 int F_39 ( struct V_160 * V_161 ,
...
V_68 -> V_145 = V_164 ;
F_40 ( V_161 , V_68 ) ;
V_73 = F_34 ( & V_161 -> V_43 ,
& V_158 , & V_159 , 1 ) ;
if ( V_73 < 0 )
F_35 ( V_68 ) ;
return V_73 ;
}
static T_6 int F_41 ( struct V_160 * V_165 )
{
F_37 ( & V_165 -> V_43 ) ;
F_35 ( F_42 ( V_165 ) ) ;
return 0 ;
