...
int V_89 = 1 ;
V_89 = F_83 ( V_2 -> V_88 , F_36 , V_145 , L_53 , V_2 ) ;
if ( V_89 )
F_17 ( V_53 L_54 ,
V_2 -> V_88 , V_89 ) ;
}
...
if ( F_84 ( V_124 ) )
F_85 ( L_55 ) ;
F_17 ( V_146 L_56 , V_99 ) ;
return 0 ;
}
static void F_86 ( struct V_147 * V_147 , const char * V_26 ,
unsigned int V_27 )
{
struct V_1 * V_2 = & V_101 [ V_147 -> V_10 ] ;
char V_64 [ V_96 ] V_55 ;
...
static struct V_149 * F_87 ( struct V_147 * V_147 ,
int * V_10 )
{
* V_10 = V_147 -> V_10 ;
return V_124 ;
}
static int T_4 F_88 ( struct V_147 * V_147 , char * V_150 )
{
struct V_1 * V_2 ;
int V_89 ;
if ( V_147 -> V_10 < 0 || V_147 -> V_10 >= V_99 )
return - 1 ;
V_2 = & V_101 [ V_147 -> V_10 ] ;
F_56 ( V_2 ) ;
V_89 = F_51 ( V_2 ) ;
if ( V_89 < 0 )
return V_89 ;
...
struct V_151 * V_152 ;
F_47 = F_41 ;
for ( V_152 = F_90 ( NULL , L_57 , L_58 ) ;
V_152 != NULL ;
V_152 = F_90 ( V_152 , L_57 , L_58 ) ) {
struct V_1 * V_2 ;
const T_5 * V_29 , * V_79 ;
V_29 = F_91 ( V_152 , L_59 , NULL ) ;
V_79 = F_91 ( V_152 , L_60 , NULL ) ;
if ( ! V_29 || ! V_79 )
continue;
if ( V_99 >= V_153 ) {
F_92 ( V_152 ) ;
