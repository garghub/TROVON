...
V_22 = V_47 -> V_58 ;
V_22 -> V_24 = V_47 ;
V_22 -> V_58 = V_47 -> V_58 + sizeof( * V_22 ) ;
return V_160 ;
}
void F_72 ( struct V_155 * V_160 )
{
F_73 ( V_160 ) ;
}
int F_74 ( struct V_76 * V_25 )
{
int V_40 ;
int V_161 ;
for ( V_161 = 0 ; V_161 < V_25 -> V_162 ; V_161 ++ ) {
struct V_54 * V_55 = V_25 -> V_163 [ V_161 ] ;
struct V_56 * V_57 = V_55 -> V_58 ;
if ( F_75 ( & V_57 -> V_63 ,
V_25 -> V_164 * 2 , NULL ,
sizeof( struct V_59 ) ) ) {
...
if ( F_76 ( & V_57 -> V_62 ,
V_25 -> V_164 * 4 * sizeof( void * ) , V_166 ) ) {
F_77 ( & V_57 -> V_63 ) ;
goto V_165;
}
}
...
struct V_54 * V_55 = V_25 -> V_163 [ V_40 ] ;
struct V_56 * V_57 = V_55 -> V_58 ;
F_78 ( & V_57 -> V_62 ) ;
F_77 ( & V_57 -> V_63 ) ;
}
...
void F_79 ( struct V_76 * V_25 )
{
int V_40 ;
for ( V_40 = 0 ; V_40 < V_25 -> V_162 ; V_40 ++ ) {
struct V_54 * V_55 = V_25 -> V_163 [ V_40 ] ;
struct V_56 * V_57 = V_55 -> V_58 ;
F_78 ( & V_57 -> V_62 ) ;
F_77 ( & V_57 -> V_63 ) ;
