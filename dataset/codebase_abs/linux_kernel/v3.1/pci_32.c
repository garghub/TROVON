...
void T_4 F_23 ( struct V_23 * V_24 )
{
unsigned long V_41 ;
struct V_3 * V_42 = & V_24 -> V_43 ;
V_41 = ( unsigned long ) V_24 -> V_44 - V_45 ;
V_42 -> V_4 = ( V_42 -> V_4 + V_41 ) & 0xffffffffu ;
V_42 -> V_5 = ( V_42 -> V_5 + V_41 ) & 0xffffffffu ;
}
...
struct V_23 * V_24 , * V_25 ;
F_10 (hose, tmp, &hose_list, list_node)
if ( V_34 >= V_24 -> V_31 && V_34 <= V_24 -> V_50 )
return V_24 ;
return NULL ;
}
long F_30 ( long V_54 , unsigned long V_34 , unsigned long V_35 )
{
struct V_23 * V_24 ;
long V_55 = - V_56 ;
V_24 = F_29 ( V_34 ) ;
