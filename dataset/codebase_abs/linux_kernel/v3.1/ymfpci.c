...
if ( ( V_38 = F_24 ( V_2 , 2 , NULL ) ) < 0 ) {
F_21 ( V_31 ) ;
return V_38 ;
}
if ( ( V_38 = F_25 ( V_2 , 3 , NULL ) ) < 0 ) {
F_21 ( V_31 ) ;
return V_38 ;
}
if ( ( V_38 = F_26 ( V_2 , V_62 [ V_3 ] ) ) < 0 ) {
F_21 ( V_31 ) ;
return V_38 ;
}
...
if ( V_2 -> V_33 ) {
if ( ( V_38 = F_28 ( V_31 , 0 , V_63 ,
V_49 [ V_3 ] ,
V_64 ,
V_13 -> V_61 , 0 , & V_2 -> V_65 ) ) < 0 ) {
F_4 ( V_66 L_23 , V_49 [ V_3 ] ) ;
V_4 &= ~ V_54 ;
F_12 ( V_13 , V_21 , V_4 ) ;
}
}
