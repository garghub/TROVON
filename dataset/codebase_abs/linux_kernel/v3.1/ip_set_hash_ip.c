...
{
F_36 ( & V_7 -> V_5 . V_60 , & V_8 -> V_5 . V_60 ) ;
}
static inline void
F_37 ( struct V_59 * V_6 )
{
F_38 ( & V_6 -> V_5 . V_60 , 0 , 0 , 0 , 0 ) ;
}
static inline void
F_39 ( union V_61 * V_5 , T_4 V_62 )
{
V_5 -> V_63 [ 0 ] &= F_40 ( V_62 ) [ 0 ] ;
V_5 -> V_63 [ 1 ] &= F_40 ( V_62 ) [ 1 ] ;
V_5 -> V_63 [ 2 ] &= F_40 ( V_62 ) [ 2 ] ;
V_5 -> V_63 [ 3 ] &= F_40 ( V_62 ) [ 3 ] ;
}
static bool
F_41 ( struct V_9 * V_10 , const struct V_59 * V_11 )
{
F_42 ( V_10 , V_12 , & V_11 -> V_5 ) ;
return 0 ;
V_13:
return 1 ;
}
static bool
F_43 ( struct V_9 * V_10 , const struct V_59 * V_11 )
{
const struct V_64 * V_65 =
( const struct V_64 * ) V_11 ;
F_42 ( V_10 , V_12 , & V_65 -> V_5 ) ;
F_8 ( V_10 , V_16 ,
F_9 ( F_10 ( V_65 -> V_17 ) ) ) ;
return 0 ;
V_13:
...
static inline void
F_44 ( struct V_18 * V_19 , const struct V_59 * V_20 )
{
}
static int
F_45 ( struct V_22 * V_23 , const struct V_9 * V_10 ,
const struct V_24 * V_25 ,
enum V_26 V_27 , const struct V_28 * V_29 )
{
const struct V_18 * V_19 = V_23 -> V_11 ;
T_2 V_30 = V_23 -> V_31 -> V_27 [ V_27 ] ;
union V_61 V_5 ;
F_46 ( V_10 , V_29 -> V_32 & V_33 , & V_5 . V_60 ) ;
F_39 ( & V_5 , V_19 -> V_34 ) ;
if ( F_34 ( & V_5 . V_60 ) )
return - V_35 ;
return V_30 ( V_23 , & V_5 , F_16 ( V_29 , V_19 ) , V_29 -> V_36 ) ;
...
static int
F_47 ( struct V_22 * V_23 , struct V_37 * V_38 [] ,
enum V_26 V_27 , T_1 * V_39 , T_1 V_32 , bool V_40 )
{
const struct V_18 * V_19 = V_23 -> V_11 ;
T_2 V_30 = V_23 -> V_31 -> V_27 [ V_27 ] ;
...
static int
F_49 ( struct V_22 * V_23 , struct V_37 * V_38 [] , T_1 V_32 )
{
...
V_19 = F_52 ( sizeof( * V_19 ) , V_80 ) ;
if ( ! V_19 )
return - V_81 ;
V_19 -> V_58 = V_58 ;
V_19 -> V_34 = V_34 ;
F_53 ( & V_19 -> V_82 , sizeof( V_19 -> V_82 ) ) ;
V_19 -> V_17 = V_83 ;
V_69 = F_54 ( V_66 ) ;
V_19 -> V_84 = F_55 (
sizeof( struct V_85 )
+ F_56 ( V_69 ) * sizeof( struct V_86 ) ) ;
if ( ! V_19 -> V_84 ) {
F_57 ( V_19 ) ;
return - V_81 ;
}
...
F_50 ( L_4 ,
V_23 -> V_74 , F_56 ( V_19 -> V_84 -> F_54 ) ,
V_19 -> V_84 -> F_54 , V_19 -> V_58 , V_23 -> V_11 , V_19 -> V_84 ) ;
return 0 ;
}
static int T_5
F_60 ( void )
