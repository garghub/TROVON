...
static void T_5 F_85 ( int V_165 )
{
unsigned int V_33 , V_51 ;
if ( ! V_165 )
F_4 ( V_140
...
if ( NULL != V_2 -> V_187 )
return;
if ( V_167 [ V_2 -> V_180 ] . V_188 != V_185 -> type )
return;
...
static int T_5 F_94 ( struct V_39 * V_39 ,
...
if ( V_193 == V_194 )
return - V_45 ;
V_2 = F_95 ( sizeof( * V_2 ) , V_195 ) ;
if ( NULL == V_2 )
return - V_45 ;
V_186 = F_96 ( & V_39 -> V_2 , & V_2 -> V_175 ) ;
if ( V_186 )
goto V_196;
V_2 -> V_22 = V_39 ;
if ( F_97 ( V_39 ) ) {
...
V_2 -> V_199 = V_193 ;
sprintf ( V_2 -> V_12 , L_54 , V_39 -> V_23 , V_2 -> V_199 ) ;
if ( V_200 ) {
if ( V_200 & V_201 )
...
F_4 ( V_202 L_67 ,
V_2 -> V_12 , V_206 ) ;
F_99 ( V_39 , V_211 , V_206 ) ;
}
V_2 -> V_212 = V_39 -> V_213 ;
F_100 ( V_39 , V_211 , & V_2 -> V_214 ) ;
F_4 ( V_202 L_68
L_69 , V_2 -> V_12 ,
F_101 ( V_39 ) , V_2 -> V_212 , V_39 -> V_76 ,
V_2 -> V_214 , ( unsigned long long ) F_102 ( V_39 , 0 ) ) ;
F_103 ( V_39 ) ;
if ( ! F_104 ( V_39 , F_105 ( 32 ) ) ) {
F_4 ( L_70 , V_2 -> V_12 ) ;
V_186 = - V_197 ;
goto V_198;
}
V_2 -> V_180 = V_192 -> V_169 ;
if ( V_215 [ V_2 -> V_199 ] >= 0 &&
V_215 [ V_2 -> V_199 ] < V_166 )
...
V_2 -> V_219 = V_167 [ V_2 -> V_180 ] . V_219 ;
...
F_4 ( V_202 L_71 ,
V_2 -> V_12 , V_39 -> V_225 ,
V_39 -> V_226 , V_167 [ V_2 -> V_180 ] . V_12 ,
V_2 -> V_180 , V_2 -> V_218 ?
L_72 : L_73 ) ;
if ( ! F_106 ( F_102 ( V_39 , 0 ) ,
F_107 ( V_39 , 0 ) ,
V_2 -> V_12 ) ) {
V_186 = - V_227 ;
F_4 ( V_228 L_74 ,
V_2 -> V_12 , ( unsigned long long ) F_102 ( V_39 , 0 ) ) ;
goto V_198;
}
V_2 -> V_229 = F_108 ( F_102 ( V_39 , 0 ) ,
F_107 ( V_39 , 0 ) ) ;
...
F_109 ( V_2 ) ;
F_69 ( V_2 ) ;
V_186 = F_110 ( V_39 -> V_76 , F_60 ,
V_234 | V_235 , V_2 -> V_12 , V_2 ) ;
if ( V_186 < 0 ) {
F_4 ( V_228 L_76 ,
V_2 -> V_12 , V_39 -> V_76 ) ;
goto V_236;
...
if ( F_10 ( V_2 ) ) {
struct V_237 * V_238 =
F_114 ( & V_2 -> V_175 , & V_2 -> V_239 ,
L_77 ,
V_167 [ V_2 -> V_180 ] . V_240 , NULL ) ;
if ( V_238 )
V_238 -> V_241 = V_242 ;
}
if ( V_167 [ V_2 -> V_180 ] . V_243 ) {
struct V_237 * V_238 ;
V_238 = F_114 ( & V_2 -> V_175 ,
& V_2 -> V_239 , L_78 ,
0 , F_115 ( V_167 [ V_2 -> V_180 ] . V_243 ) ) ;
if ( V_238 ) {
...
V_2 -> V_181 = F_86 ( V_2 , & V_252 , L_20 ) ;
V_186 = F_121 ( V_2 -> V_181 , V_253 ,
V_254 [ V_2 -> V_199 ] ) ;
if ( V_186 < 0 ) {
F_4 ( V_202 L_81 ,
V_2 -> V_12 ) ;
...
F_4 ( V_202 L_82 ,
V_2 -> V_12 , F_122 ( V_2 -> V_181 ) ) ;
V_2 -> V_182 = F_86 ( V_2 , & V_252 , L_19 ) ;
V_186 = F_121 ( V_2 -> V_182 , V_256 ,
V_257 [ V_2 -> V_199 ] ) ;
if ( V_186 < 0 )
goto V_255;
F_4 ( V_202 L_83 ,
...
if ( F_123 ( V_2 ) ) {
V_2 -> V_183 = F_86 ( V_2 , & V_258 , L_84 ) ;
V_186 = F_121 ( V_2 -> V_183 , V_259 ,
V_260 [ V_2 -> V_199 ] ) ;
if ( V_186 < 0 )
goto V_255;
F_4 ( V_202 L_83 ,
...
static void T_6 F_130 ( struct V_39 * V_39 )
{
...
static int F_133 ( struct V_39 * V_39 , T_7 V_54 )
{
struct V_262 * V_175 = F_131 ( V_39 ) ;
struct V_1 * V_2 = F_9 ( V_175 , struct V_1 , V_175 ) ;
V_2 -> V_91 = 0 ;
...
int F_151 ( struct V_184 * V_185 )
{
struct V_1 * V_2 ;
F_117 ( & V_246 ) ;
F_118 (dev, &saa7134_devlist, devlist)
F_92 ( V_185 , V_2 ) ;
F_40 ( & V_185 -> V_57 , & V_267 ) ;
F_119 ( & V_246 ) ;
return 0 ;
}
void F_152 ( struct V_184 * V_185 )
{
struct V_1 * V_2 ;
F_117 ( & V_246 ) ;
F_46 ( & V_185 -> V_57 ) ;
