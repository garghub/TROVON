...
V_74 = F_40 ( V_41 + V_76 ) ;
F_43 ( V_77 , V_41 + V_71 ) ;
for ( V_75 = 30 ; V_75 > 0 ; -- V_75 ) {
if ( ( F_40 ( V_41 + V_71 ) & V_77 ) == 0 )
break;
F_25 ( 1 ) ;
}
F_43 ( V_74 , V_41 + V_76 ) ;
}
F_43 ( ~ ( T_2 ) 0 , V_41 + V_78 ) ;
F_43 ( ~ ( T_2 ) 0 , V_41 + V_79 ) ;
F_45 ( V_41 ) ;
}
...
{
int V_83 = 1 , V_84 = 0 ;
if ( V_40 -> V_72 == 0x8086 && V_40 -> V_85 == 0x283a ) {
if ( F_47 ( V_86 ) )
V_83 = 0 ;
}
if ( V_83 && ( V_81 & V_87 ) ) {
...
static int F_52 ( void T_5 * V_101 , T_2 V_58 , T_2 V_102 ,
int V_103 , int V_104 )
{
T_2 V_105 ;
do {
...
{
return V_40 -> V_107 == V_108 &&
V_40 -> V_72 == V_109 &&
V_40 -> V_85 == V_110 ;
}
void F_54 ( struct V_37 * V_111 )
{
T_2 V_112 ;
V_112 = 0xffffffff ;
F_17 ( V_111 , V_113 ,
...
if ( V_41 == NULL )
return;
V_115 = F_59 ( V_41 , V_117 ) ;
do {
if ( ! V_115 )
goto V_118;
V_23 = F_40 ( V_41 + V_115 ) ;
if ( F_60 ( V_23 ) == V_119 )
break;
V_115 = F_59 ( V_41 , V_115 ) ;
} while ( 1 );
if ( V_23 & V_120 ) {
F_43 ( V_23 | V_121 , V_41 + V_115 ) ;
V_116 = F_52 ( V_41 + V_115 , V_120 ,
0 , 5000 , 10 ) ;
if ( V_116 ) {
F_27 ( & V_40 -> V_46 , L_18
L_19 , V_23 ) ;
F_43 ( V_23 & ~ V_120 , V_41 + V_115 ) ;
}
}
F_43 ( V_122 ,
V_41 + V_115 + V_123 ) ;
...
F_54 ( V_40 ) ;
V_118:
V_80 = V_41 + F_61 ( F_40 ( V_41 ) ) ;
V_116 = F_52 ( V_80 + V_124 , V_125 , 0 ,
5000 , 10 ) ;
if ( V_116 ) {
V_23 = F_40 ( V_80 + V_124 ) ;
F_27 ( & V_40 -> V_46 ,
L_20
L_21 , V_23 ) ;
}
V_23 = F_40 ( V_80 + V_126 ) ;
V_23 &= ~ ( V_127 | V_128 ) ;
F_43 ( V_23 , V_80 + V_126 ) ;
V_116 = F_52 ( V_80 + V_124 , V_129 , 1 ,
V_130 , 125 ) ;
if ( V_116 ) {
V_23 = F_40 ( V_80 + V_124 ) ;
F_27 ( & V_40 -> V_46 ,
...
if ( V_40 -> V_107 == V_131 )
F_32 ( V_40 ) ;
else if ( V_40 -> V_107 == V_132 )
F_38 ( V_40 ) ;
else if ( V_40 -> V_107 == V_133 )
F_49 ( V_40 ) ;
else if ( V_40 -> V_107 == V_108 )
F_56 ( V_40 ) ;
}
