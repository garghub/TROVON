...
static void T_2 F_81 ( struct V_1 * V_2 )
{
struct V_157 * V_158 ;
...
static int T_2 F_84 ( struct V_1 * V_2 )
{
struct V_157 * V_160 ;
struct V_157 * V_161 ;
...
return - V_167 ;
if ( ! V_160 ) {
V_160 = F_87 ( NULL , L_14 ) ;
while ( V_160 && V_160 -> V_159 != V_2 -> V_144 )
V_160 = F_87 ( V_160 , L_14 ) ;
}
if ( ! V_160 ) {
F_78 ( V_2 -> V_144 ) ;
V_2 -> V_144 = NULL ;
...
V_162 = F_89 ( V_160 , L_15 , NULL ) ;
if ( V_162 && * V_162 < 16 )
V_2 -> V_168 = * V_162 ;
V_162 = F_89 ( V_160 , L_16 , NULL ) ;
if ( V_162 ) {
F_90 ( V_177 L_17
L_18
L_19 ) ;
...
V_162 = F_89 ( V_160 , L_31 , NULL ) ;
if ( V_162 )
V_2 -> V_183 = * V_162 ;
V_161 = F_87 ( NULL , L_32 ) ;
V_2 -> V_184 = ( V_161 != NULL ) ;
F_78 ( V_161 ) ;
V_165 = F_91 ( V_2 -> V_144 , V_185 ) ;
if ( V_165 == NULL )
F_90 ( V_186 L_33 ) ;
else {
struct V_187 * V_9 = NULL ;
F_92 (pdev) {
struct V_157 * V_188 = F_93 ( V_9 ) ;
...
L_35 ) ;
F_81 ( V_2 ) ;
V_162 = F_89 ( V_160 , L_36 , & V_163 ) ;
if ( ! V_162 )
V_162 = F_89 ( V_160 , L_37 , & V_163 ) ;
if ( V_162 ) {
int V_19 ;
V_2 -> V_96 = 0 ;
...
static int F_94 ( struct V_191 * V_192 ,
struct V_193 * V_194 )
{
struct V_1 * V_2 = F_95 ( V_192 ) ;
...
int T_2 F_98 ( struct V_1 * V_2 )
{
int V_113 ;
V_2 -> V_196 = 1 ;
V_113 = F_99 ( V_2 -> V_115 , F_100 ( & V_198 [ 0 ] , V_2 ) ) ;
if ( V_113 < 0 ) {
F_90 ( V_199 L_38 ) ;
return V_113 ;
}
V_2 -> V_200 = F_100 ( & V_198 [ 1 ] , V_2 ) ;
return F_99 ( V_2 -> V_115 , V_2 -> V_200 ) ;
}
int T_2 F_101 ( struct V_201 * V_115 , struct V_1 * * V_202 )
{
struct V_1 * V_2 ;
struct V_157 * V_188 ;
int V_19 , V_113 ;
...
V_2 -> V_38 = F_106 ( V_203 , 0x1000 ) ;
V_2 -> V_32 . V_35 = F_106 ( V_204 , 0x100 ) ;
V_2 -> V_33 . V_35 = F_106 ( V_205 , 0x100 ) ;
if ( V_2 -> V_137 <= V_178 ) {
V_128 = F_107 ( V_188 , 0 ) ;
if ( F_108 ( V_128 , F_68 , 0 ,
L_47 , ( void * ) V_2 ) ) {
F_69 ( V_199 L_48 ,
V_128 ) ;
V_113 = - V_76 ;
...
V_128 = F_107 ( V_188 , 1 ) ;
if ( F_108 ( V_128 , F_66 , 0 , L_49 , ( void * ) V_2 ) ) {
...
V_2 -> V_147 = V_128 ;
V_128 = F_107 ( V_188 , 2 ) ;
if ( F_108 ( V_128 , F_67 , 0 , L_50 , ( void * ) V_2 ) ) {
F_69 ( V_199 L_48 , V_128 ) ;
V_113 = - V_76 ;
goto V_209;
}
...
if ( V_2 -> V_174 ) {
V_2 -> V_150 = F_106 ( 0xf301a000 , 0x1000 ) ;
F_109 ( V_2 -> V_150 + 0x190 ) ;
} else if ( V_2 -> V_175 ) {
struct V_157 * V_158 ;
for ( V_158 = V_2 -> V_144 -> V_159 ; V_158 ; V_158 = V_158 -> V_159 ) {
if ( strcmp ( V_158 -> V_120 , L_2 ) == 0 ) {
struct V_212 V_190 ;
if ( F_104 ( V_158 , 0 , & V_190 ) == 0 )
V_2 -> V_149 =
F_106 ( V_190 . V_153 , 0x40 ) ;
break;
}
}
if ( V_2 -> V_149 )
F_110 ( V_2 -> V_149 + 0x37 , 3 ) ;
}
F_63 ( V_2 ) ;
if ( ( V_113 = F_111 ( V_115 , V_213 , V_2 , & V_207 ) ) < 0 )
goto V_209;
* V_202 = V_2 ;
return 0 ;
V_209:
...
{
unsigned long V_214 ;
F_113 ( V_2 -> V_115 , V_215 ) ;
if ( V_2 -> V_216 )
V_2 -> V_216 ( V_2 ) ;
F_114 ( V_2 -> V_112 ) ;
F_115 ( & V_2 -> V_62 , V_214 ) ;
F_33 ( V_2 ) ;
