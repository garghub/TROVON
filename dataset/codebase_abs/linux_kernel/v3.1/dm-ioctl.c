...
F_101 ( V_14 ) ;
if ( F_102 ( V_14 ) == V_130 )
F_103 ( V_14 , F_104 ( V_129 ) ) ;
else if ( F_102 ( V_14 ) != F_104 ( V_129 ) ) {
F_38 ( L_23 ) ;
F_33 ( V_129 ) ;
F_105 ( V_14 ) ;
V_82 = - V_44 ;
...
static int F_107 ( struct V_36 * V_37 , T_2 V_48 )
{
struct V_11 * V_12 ;
struct V_17 * V_14 ;
F_22 ( & V_24 ) ;
...
struct V_133 * V_134 ;
struct V_135 * V_136 ;
V_136 = F_46 ( V_37 , V_48 , & V_52 ) ;
F_109 (tmp, dm_table_get_devices(table))
V_131 ++ ;
V_54 = sizeof( * V_136 ) + ( sizeof( * V_136 -> V_16 ) * V_131 ) ;
if ( V_52 < V_54 ) {
V_37 -> V_41 |= V_60 ;
return;
}
...
V_136 -> V_16 [ V_131 ++ ] = F_49 ( V_134 -> V_137 . V_138 -> V_139 ) ;
V_37 -> V_49 = V_37 -> V_53 + V_54 ;
}
static int F_110 ( struct V_36 * V_37 , T_2 V_48 )
{
struct V_17 * V_14 ;
struct V_28 * V_29 ;
V_14 = F_73 ( V_37 ) ;
...
V_29 = F_60 ( V_14 , V_37 ) ;
if ( V_29 ) {
F_108 ( V_29 , V_37 , V_48 ) ;
F_32 ( V_29 ) ;
}
F_15 ( V_14 ) ;
return 0 ;
}
static int F_111 ( struct V_36 * V_37 , T_2 V_48 )
{
struct V_17 * V_14 ;
struct V_28 * V_29 ;
V_14 = F_73 ( V_37 ) ;
...
struct V_28 * V_29 ;
struct V_117 * V_118 ;
struct V_142 * V_143 = ( void * ) V_37 + V_37 -> V_53 ;
V_14 = F_73 ( V_37 ) ;
if ( ! V_14 )
return - V_43 ;
if ( V_143 < (struct V_142 * ) V_37 -> V_88 ||
F_76 ( V_143 -> V_144 , ( void * ) V_37 + V_48 ) ) {
F_38 ( L_25 ) ;
V_82 = - V_44 ;
goto V_61;
}
V_82 = F_113 ( & V_140 , & V_141 , V_143 -> V_144 ) ;
if ( V_82 ) {
F_38 ( L_26 ) ;
goto V_61;
}
...
V_118 = F_115 ( V_29 , V_143 -> V_147 ) ;
if ( ! F_116 ( V_118 ) ) {
F_38 ( L_28 ) ;
V_82 = - V_44 ;
} else if ( V_118 -> type -> V_144 )
V_82 = V_118 -> type -> V_144 ( V_118 , V_140 , V_141 ) ;
else {
F_38 ( L_29 ) ;
V_82 = - V_44 ;
}
...
static T_5 F_117 ( unsigned int V_148 )
{
static struct {
int V_148 ;
T_5 V_149 ;
...
return ( V_148 >= F_118 ( V_150 ) ) ? NULL : V_150 [ V_148 ] . V_149 ;
}
static int F_119 ( unsigned int V_148 , struct V_36 T_6 * V_167 )
{
V_63 V_71 [ 3 ] ;
int V_82 = 0 ;
if ( F_120 ( V_71 , V_167 -> V_71 , sizeof( V_71 ) ) )
return - V_168 ;
if ( ( V_169 != V_71 [ 0 ] ) ||
( V_170 < V_71 [ 1 ] ) ) {
F_38 ( L_30
...
V_169 , V_170 ,
V_171 ,
V_71 [ 0 ] , V_71 [ 1 ] , V_71 [ 2 ] , V_148 ) ;
V_82 = - V_44 ;
}
V_71 [ 0 ] = V_169 ;
V_71 [ 1 ] = V_170 ;
V_71 [ 2 ] = V_171 ;
if ( F_121 ( V_167 -> V_71 , V_71 , sizeof( V_71 ) ) )
return - V_168 ;
return V_82 ;
}
static int F_122 ( struct V_36 T_6 * V_167 , struct V_36 * * V_37 )
{
struct V_36 V_132 , * V_172 ;
int V_173 ;
if ( F_120 ( & V_132 , V_167 , sizeof( V_132 ) - sizeof( V_132 . V_88 ) ) )
return - V_168 ;
if ( V_132 . V_49 < ( sizeof( V_132 ) - sizeof( V_132 . V_88 ) ) )
return - V_44 ;
V_173 = V_132 . V_41 & V_174 ;
V_172 = F_123 ( V_132 . V_49 ) ;
if ( ! V_172 ) {
if ( V_173 && F_124 ( V_167 , V_132 . V_49 ) )
return - V_168 ;
return - V_23 ;
}
if ( F_120 ( V_172 , V_167 , V_132 . V_49 ) )
goto V_25;
if ( V_173 && F_124 ( V_167 , V_132 . V_49 ) )
goto V_25;
* V_37 = V_172 ;
...
V_25:
if ( V_173 )
memset ( V_172 , 0 , V_132 . V_49 ) ;
F_125 ( V_172 ) ;
return - V_168 ;
}
static int F_126 ( T_7 V_148 , struct V_36 * V_37 )
{
V_37 -> V_41 &= ~ V_60 ;
V_37 -> V_41 &= ~ V_47 ;
V_37 -> V_41 &= ~ V_174 ;
...
static int F_127 ( T_7 V_175 , struct V_36 T_6 * V_167 )
{
int V_82 = 0 ;
int V_176 ;
unsigned int V_148 ;
struct V_36 * V_177 ( V_37 ) ;
T_5 V_149 = NULL ;
T_2 V_178 ;
if ( ! F_128 ( V_179 ) )
return - V_180 ;
if ( F_129 ( V_175 ) != V_181 )
return - V_182 ;
V_148 = F_130 ( V_175 ) ;
V_82 = F_119 ( V_148 , V_167 ) ;
if ( V_82 )
return V_82 ;
if ( V_148 == V_151 )
return 0 ;
...
V_183 -> V_41 |= V_184 ;
V_82 = F_122 ( V_167 , & V_37 ) ;
V_183 -> V_41 &= ~ V_184 ;
if ( V_82 )
return V_82 ;
V_178 = V_37 -> V_49 ;
V_176 = V_37 -> V_41 & V_174 ;
V_82 = F_126 ( V_148 , V_37 ) ;
if ( V_82 )
goto V_61;
V_37 -> V_49 = sizeof( * V_37 ) ;
V_82 = V_149 ( V_37 , V_178 ) ;
if ( ! V_82 && F_121 ( V_167 , V_37 , V_37 -> V_49 ) )
V_82 = - V_168 ;
V_61:
if ( V_176 )
memset ( V_37 , 0 , V_178 ) ;
...
static long F_131 ( struct V_185 * V_185 , T_7 V_175 , T_8 V_186 )
{
return ( long ) F_127 ( V_175 , (struct V_36 T_6 * ) V_186 ) ;
}
static long F_132 ( struct V_185 * V_185 , T_7 V_175 , T_8 V_186 )
{
return ( long ) F_131 ( V_185 , V_175 , ( T_8 ) F_133 ( V_186 ) ) ;
}
int T_9 F_134 ( void )
{
int V_82 ;
...
int F_140 ( struct V_17 * V_14 , char * V_13 , char * V_15 )
{
int V_82 = 0 ;
struct V_11 * V_12 ;
if ( ! V_14 )
