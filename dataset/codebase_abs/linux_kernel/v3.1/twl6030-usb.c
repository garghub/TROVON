...
static void F_29 ( struct V_74 * V_4 )
{
struct V_1 * V_2 = F_30 ( V_4 , struct V_1 ,
V_75 ) ;
if ( V_2 -> V_76 )
F_1 ( V_2 , V_49 , 0x40 ,
V_77 ) ;
...
static int F_31 ( struct V_8 * V_9 , bool V_78 )
{
struct V_1 * V_2 = F_7 ( V_9 ) ;
V_2 -> V_76 = V_78 ;
F_32 ( & V_2 -> V_75 ) ;
...
static int F_33 ( struct V_8 * V_9 , struct V_79 * V_80 )
{
struct V_1 * V_2 ;
if ( ! V_9 )
return - V_32 ;
...
static int T_4 F_34 ( struct V_81 * V_82 )
{
struct V_1 * V_2 ;
int V_45 , V_83 ;
struct V_12 * V_13 ;
struct V_11 * V_7 = & V_82 -> V_7 ;
V_13 = V_7 -> V_14 ;
V_2 = F_35 ( sizeof *V_2 , V_84 ) ;
if ( ! V_2 )
return - V_85 ;
V_2 -> V_7 = & V_82 -> V_7 ;
...
F_39 ( & V_2 -> V_54 ) ;
F_40 ( V_82 , V_2 ) ;
if ( F_41 ( & V_82 -> V_7 , & V_94 ) )
F_42 ( & V_82 -> V_7 , L_12 ) ;
F_43 ( & V_2 -> V_54 . V_59 ) ;
F_44 ( & V_2 -> V_75 , F_29 ) ;
V_2 -> V_95 = true ;
V_45 = F_45 ( V_2 -> V_73 , NULL , F_25 ,
V_96 | V_97 ,
L_13 , V_2 ) ;
if ( V_45 < 0 ) {
F_3 ( & V_82 -> V_7 , L_14 ,
...
static int T_5 F_49 ( struct V_81 * V_82 )
{
struct V_1 * V_2 = F_50 ( V_82 ) ;
struct V_12 * V_13 ;
struct V_11 * V_7 = & V_82 -> V_7 ;
V_13 = V_7 -> V_14 ;
F_51 ( V_99 ,
