...
static T_5 * F_52 ( struct V_51 * V_52 )
{
...
F_34 ( V_170 , 0 , V_70 ) ;
F_31 ( V_170 , 1 , & V_70 ) ;
F_13 ( & V_70 , V_172 , V_52 -> V_76 -> V_61 ) ;
F_13 ( & V_70 , V_173 ,
! F_54 ( V_174 , & V_169 -> V_113 ) ) ;
F_13 ( & V_70 , V_175 ,
F_54 ( V_176 , & V_169 -> V_113 ) ) ;
...
F_31 ( V_170 , 3 , & V_70 ) ;
F_13 ( & V_70 , V_181 ,
! F_54 ( V_182 , & V_169 -> V_113 ) ) ;
F_13 ( & V_70 , V_183 , 2 ) ;
F_34 ( V_170 , 3 , V_70 ) ;
V_75 -> V_71 = V_170 ;
V_75 -> V_184 = V_185 ;
}
static void F_55 ( struct V_51 * V_52 ,
struct V_186 * V_187 )
{
struct V_67 * V_68 = V_52 -> V_69 ;
T_5 * V_188 = V_68 -> V_71 ;
...
static void F_76 ( unsigned long V_17 )
{
struct V_1 * V_2 = (struct V_1 * ) V_17 ;
F_57 ( V_2 ) ;
F_65 ( V_2 , V_134 ) ;
...
T_2 V_210 ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_2 -> V_217 -> V_80 -> V_218 ; V_4 ++ ) {
F_3 ( V_2 , V_219 , & V_210 ) ;
if ( ! F_4 ( V_210 , V_220 ) )
break;
if ( ! F_78 ( & V_2 -> V_212 , & V_210 ) ) {
F_61 ( V_2 , L_8
L_9 ) ;
break;
}
...
static T_6 F_79 ( int V_221 , void * V_222 )
{
...
if ( V_162 )
return V_162 ;
F_88 ( V_231 , & V_2 -> V_232 ) ;
F_88 ( V_233 , & V_2 -> V_232 ) ;
F_88 ( V_234 , & V_2 -> V_232 ) ;
if ( ! F_2 ( V_2 ) )
F_88 ( V_235 , & V_2 -> V_232 ) ;
F_88 ( V_236 , & V_2 -> V_232 ) ;
F_88 ( V_237 , & V_2 -> V_232 ) ;
F_88 ( V_238 , & V_2 -> V_232 ) ;
F_88 ( V_239 , & V_2 -> V_232 ) ;
if ( ! V_240 )
F_88 ( V_241 , & V_2 -> V_232 ) ;
F_88 ( V_242 , & V_2 -> V_232 ) ;
F_88 ( V_243 , & V_2 -> V_232 ) ;
V_2 -> V_244 = V_245 ;
return 0 ;
}
static int F_89 ( struct V_246 * V_247 )
{
return F_90 ( V_247 , & V_248 ) ;
}
static int F_91 ( struct V_249 * V_249 ,
const struct V_250 * V_251 )
{
return F_92 ( V_249 , & V_248 ) ;
}
static int T_7 F_93 ( void )
{
int V_252 = 0 ;
#if F_94 ( V_253 ) || F_94 ( V_254 )
V_252 = F_95 ( & V_255 ) ;
if ( V_252 )
return V_252 ;
#endif
