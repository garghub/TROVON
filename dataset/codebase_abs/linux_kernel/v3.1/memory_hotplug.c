...
long V_111 = 0 ;
int V_59 ;
V_59 = F_74 ( V_21 , V_38 - V_21 , & V_111 ,
F_126 ) ;
if ( V_59 < 0 )
V_111 = ( long ) V_59 ;
return V_111 ;
...
F_136 () ;
F_135 () ;
V_114 = F_128 ( V_21 , V_38 ) ;
if ( V_114 < 0 ) {
V_59 = - V_62 ;
goto V_118;
}
F_11 ( V_124 L_5 , V_114 ) ;
F_125 ( V_21 , V_38 ) ;
F_137 ( V_21 , V_38 ) ;
V_42 -> V_86 -= V_114 ;
V_42 -> V_56 -> F_70 -= V_114 ;
V_75 -= V_114 ;
F_77 () ;
if ( ! F_70 ( V_40 ) ) {
F_138 ( V_40 , V_87 ) ;
...
V_21 = F_141 ( V_3 ) ;
V_38 = V_21 + F_141 ( V_4 ) ;
return F_129 ( V_21 , V_38 , 120 * V_127 ) ;
}
int F_140 ( T_1 V_3 , T_1 V_4 )
{
return - V_63 ;
