...
return V_22 ;
if ( V_15 == 1 ) {
V_17 = F_21 ( ( char * ) V_16 [ 1 ] , & V_21 ) ;
if ( V_17 )
return V_17 ;
}
V_16 = NULL ;
if ( V_21 != ~ 0 ) {
if ( V_21 >= F_23 () || ! F_24 ( V_21 ) ) {
F_8 ( L_10 , V_21 ) ;
return 0 ;
}
sprintf ( V_26 , L_11 , F_25 ( V_21 ) ) ;
F_26 ( V_26 ) ;
return 0 ;
}
F_8 ( L_12 ) ;
