...
static int F_58 ( unsigned long V_41 , unsigned int V_63 )
{
unsigned char V_161 ;
while ( V_63 -- ) {
if ( F_59 ( V_161 , V_41 ) )
...
static void F_60 ( const char * V_162 , unsigned long V_41 ,
...
if ( V_168 ) {
if ( F_61 ( & V_169 , V_41 , V_165 ) )
break;
} else if ( F_62 ( & V_169 , V_41 , V_165 ) )
break;
F_16 ( V_162 , V_169 ) ;
if ( V_163 )
F_20 ( V_169 , & V_47 ) ;
...
static int F_65 ( int V_25 , const char * * V_26 )
{
...
if ( V_168 ) {
if ( F_61 ( & V_169 , V_188 , V_165 )
|| V_169 )
break;
} else if ( F_62 ( & V_169 , V_188 , V_165 ) || V_169 )
break;
}
V_189 = F_66 ( V_166 , V_167 ) ;
F_60 ( V_162 , V_41 , V_163 , V_164 , V_165 ,
V_166 , V_167 , V_168 ) ;
V_41 += V_165 * V_189 ;
V_167 -= V_189 ;
...
case 8 :
V_197 = F_71 ( V_10 , & V_202 , V_36 ) ;
if ( ! V_197 )
break;
V_72 += F_16 ( L_97 , V_197 , V_202 ) ;
break;
case 16 :
V_197 = F_71 ( V_10 , & V_201 , V_36 ) ;
if ( ! V_197 )
break;
V_72 += F_16 ( L_98 , V_197 , V_201 ) ;
break;
case 32 :
V_197 = F_71 ( V_10 , & V_200 , V_36 ) ;
if ( ! V_197 )
break;
V_72 += F_16 ( L_99 , V_197 , V_200 ) ;
break;
case 64 :
V_197 = F_71 ( V_10 , & V_199 , V_36 ) ;
if ( ! V_197 )
break;
...
case 8 :
V_202 = V_199 ;
F_73 ( V_10 , & V_202 , V_36 ) ;
break;
case 16 :
V_201 = V_199 ;
F_73 ( V_10 , & V_201 , V_36 ) ;
break;
case 32 :
V_200 = V_199 ;
F_73 ( V_10 , & V_200 , V_36 ) ;
break;
case 64 :
F_73 ( V_10 , & V_199 , V_36 ) ;
break;
}
}
return V_21 ;
...
return V_29 ;
F_16 ( L_103 ) ;
F_78 (mod, kdb_modules, list) {
F_16 ( L_104 , V_206 -> V_40 ,
V_206 -> V_207 , ( void * ) V_206 ) ;
#ifdef F_79
F_16 ( L_105 , F_80 ( V_206 ) ) ;
#endif
...
static int F_81 ( int V_25 , const char * * V_26 )
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_11 ; V_10 ++ ) {
if ( V_8 [ V_10 ] )
...
V_217 = V_216 [ 2 ] ;
V_218 = V_216 [ 3 ] ;
#define F_86 ( V_3 ) (((p - syslog_data[0]) % logsize) + syslog_data[0])
...
if ( F_31 ( V_88 ) )
return 0 ;
while ( V_217 < V_218 && ( V_161 = * F_86 ( V_217 ) ) &&
...
static int F_90 ( int V_25 , const char * * V_26 )
{
unsigned long V_229 ;
int V_21 ;
if ( V_25 == 0 ) {
...
{
int V_231 = 0 , V_232 = 0 ;
unsigned long V_233 = F_92 ( L_130 ) ,
V_234 = F_92 ( L_131 ) ;
unsigned long V_2 ;
...
void F_97 ( const struct V_1 * V_3 )
{
int V_2 ;
unsigned long V_236 ;
if ( ! V_3 || F_98 ( & V_236 , ( char * ) V_3 , sizeof( unsigned long ) ) )
return;
V_2 = F_48 ( V_3 ) ;
F_16 ( L_138 ,
...
static int F_99 ( int V_25 , const char * * V_26 )
{
...
static int F_102 ( int V_25 , const char * * V_26 )
{
int V_21 = 0 ;
unsigned long V_41 ;
long V_39 = 0 ;
...
goto V_246;
V_41 = V_243 + V_244 ;
if ( F_62 ( & V_243 , V_41 , sizeof( V_243 ) ) )
goto V_246;
}
V_246:
F_26 ( V_61 ) ;
...
static void F_107 ( struct V_260 * V_261 , struct V_262 * V_263 )
{
...
static void F_108 ( struct V_272 * V_20 )
{
struct V_260 V_273 ;
F_109 ( & V_273 ) ;
...
#define F_114 ( T_10 ) ((x) >> FSHIFT)
#define F_115 ( T_10 ) LOAD_INT(((x) & (FIXED_1-1)) * 100)
F_16 ( L_171 ,
F_114 ( V_20 . V_274 [ 0 ] ) , F_115 ( V_20 . V_274 [ 0 ] ) ,
F_114 ( V_20 . V_274 [ 1 ] ) , F_115 ( V_20 . V_274 [ 1 ] ) ,
F_114 ( V_20 . V_274 [ 2 ] ) , F_115 ( V_20 . V_274 [ 2 ] ) ) ;
#undef F_114
#undef F_115
#define F_116 ( T_10 ) ((x) << (PAGE_SHIFT - 10))
F_16 ( L_172
L_173 ,
...
#ifdef F_118
#define F_119 ( V_2 ) __per_cpu_offset(cpu)
#else
#ifdef V_123
#define F_119 ( V_2 ) __per_cpu_offset[cpu]
#else
...
continue;
V_41 = V_293 + F_119 ( V_2 ) ;
V_21 = F_62 ( & V_20 , V_41 , V_165 ) ;
if ( V_21 ) {
...
static int F_120 ( int V_25 , const char * * V_26 )
{
F_16 ( L_179 ) ;
F_16 ( L_180 ) ;
F_16 ( L_181 ) ;
...
short V_297 )
{
return F_121 ( V_103 , V_296 , V_66 , V_67 , V_297 ,
V_99 ) ;
}
...
static void T_13 F_123 ( void )
{
int V_10 ;
T_4 * V_298 ;
F_34 (kp, i)
V_298 -> V_92 = NULL ;
F_121 ( L_77 , F_65 , L_194 ,
L_195 , 1 ,
V_100 ) ;
F_121 ( L_76 , F_65 , L_196 ,
L_197 , 0 , V_100 ) ;
F_121 ( L_79 , F_65 , L_198 ,
L_199 , 0 , V_100 ) ;
F_121 ( L_78 , F_65 , L_194 ,
L_200 , 0 , V_100 ) ;
F_121 ( L_201 , F_67 , L_202 ,
L_203 , 0 , V_100 ) ;
F_121 ( L_204 , F_69 , L_205 ,
L_206 , 1 , V_99 ) ;
F_121 ( L_207 , F_70 , L_1 ,
L_208 , 0 , V_99 ) ;
F_121 ( L_209 , F_72 , L_210 ,
L_211 , 0 , V_99 ) ;
F_121 ( L_212 , F_76 , L_194 ,
L_213 , 0 , V_99 ) ;
F_121 ( L_214 , V_304 , L_205 ,
L_215 , 1 , V_99 ) ;
F_121 ( L_216 , V_304 , L_217 ,
L_218 , 0 , V_99 ) ;
F_121 ( L_219 , V_304 , L_220 ,
L_221 , 0 , V_99 ) ;
F_121 ( L_222 , V_304 , L_1 ,
L_223 , 0 , V_99 ) ;
F_121 ( L_224 , V_304 , L_194 ,
L_225 , 0 ,
V_99 ) ;
F_121 ( L_226 , F_102 , L_227 ,
L_228 , 0 , V_99 ) ;
F_121 ( L_229 , F_81 , L_1 ,
L_230 , 0 , V_99 ) ;
F_121 ( L_53 , F_15 , L_1 ,
L_231 , 0 , V_99 ) ;
F_121 ( L_232 , F_104 , L_1 ,
L_233 , 1 , V_99 ) ;
F_121 ( L_234 , F_104 , L_1 ,
L_233 , 0 , V_99 ) ;
F_121 ( L_235 , F_90 , L_236 ,
L_237 , 0 , V_99 ) ;
F_121 ( L_238 , F_103 , L_1 ,
L_239 , 0 , V_99 ) ;
F_121 ( L_240 , F_99 , L_241 ,
L_242 , 0 , V_99 ) ;
F_121 ( L_243 , F_100 , L_244 ,
L_245 , 0 , V_99 ) ;
F_121 ( L_246 , F_40 , L_1 ,
L_247 , 0 , V_99 ) ;
#if F_52 ( V_305 )
F_121 ( L_248 , F_77 , L_1 ,
L_249 , 0 , V_99 ) ;
#endif
#if F_52 ( V_306 )
F_121 ( L_250 , F_74 , L_251 ,
L_252 , 0 , V_99 ) ;
#endif
#if F_52 ( V_307 )
F_121 ( L_253 , F_83 , L_254 ,
L_255 , 0 , V_99 ) ;
#endif
F_121 ( L_256 , F_27 , L_257 ,
L_258 , 0 , V_99 ) ;
F_121 ( L_259 , F_105 , L_260 ,
L_261 , 0 , V_99 ) ;
F_121 ( L_262 , F_111 , L_1 ,
L_263 , 4 , V_99 ) ;
F_121 ( L_264 , F_117 , L_265 ,
L_266 , 3 , V_99 ) ;
F_121 ( L_267 , F_120 , L_1 ,
L_268 , 0 , V_99 ) ;
}
