...
int V_12 ;
V_12 = F_3 ( V_13 , V_215 ) ;
if ( ! F_36 ( V_9 -> V_31 . V_32 , V_12 , & V_213 ,
& V_214 ) )
return V_180 ;
memset ( & args , 0 , sizeof( args ) ) ;
switch ( V_213 ) {
...
F_5 ( V_9 -> V_31 . V_32 ,
V_12 , ( V_33 * ) & args ) ;
V_180 = F_37 ( args . V_165 . V_216 ) * 10 ;
break;
case 3 :
...
F_5 ( V_9 -> V_31 . V_32 ,
V_12 , ( V_33 * ) & args ) ;
V_180 = F_39 ( args . V_147 . V_235 . V_236 ) * 10 ;
...
args . V_244 . V_259 = F_42 ( V_250 * 100000 ) ;
...
break;
case 6 :
args . V_246 . V_247 = F_42 ( V_18 << 24 | clock / 10 ) ;
args . V_246 . V_237 = V_248 ;
args . V_246 . V_252 = F_4 ( V_249 ) ;
args . V_246 . V_259 = F_42 ( V_250 * 100000 ) ;
args . V_246 . V_238 = V_240 ;
args . V_246 . V_255 = 0 ;
if ( V_177 && ( V_144 -> type & V_159 ) )
args . V_246 . V_255 |= V_263 ;
switch ( V_183 ) {
case 8 :
default:
args . V_246 . V_255 |= V_264 ;
break;
case 10 :
...
if ( V_42 -> V_43 & ( V_44 ) )
F_47 ( V_176 , V_180 , & V_268 , & V_249 , & V_250 ,
& V_248 , & V_240 ) ;
else if ( F_7 ( V_9 ) )
F_48 ( V_176 , V_180 , & V_268 , & V_249 , & V_250 ,
& V_248 , & V_240 ) ;
else
F_47 ( V_176 , V_180 , & V_268 , & V_249 , & V_250 ,
& V_248 , & V_240 ) ;
...
V_282 ;
if ( V_144 . type & V_283 )
V_279 = ( 4 * V_153 * V_248 * ( V_144 . V_284 * 2048 ) ) /
( 125 * 25 * V_176 -> V_285 / 100 ) ;
else
V_279 = ( 2 * V_153 * V_248 * ( V_144 . V_284 * 2048 ) ) /
( 125 * 25 * V_176 -> V_285 / 100 ) ;
V_144 . V_155 = V_279 ;
}
...
F_26 ( V_330 + V_11 -> V_331 ,
F_64 ( V_298 ) ) ;
F_26 ( V_332 + V_11 -> V_331 ,
F_64 ( V_298 ) ) ;
F_26 ( V_333 + V_11 -> V_331 ,
( T_8 ) V_298 & V_334 ) ;
F_26 ( V_335 + V_11 -> V_331 ,
( T_8 ) V_298 & V_334 ) ;
F_26 ( V_336 + V_11 -> V_331 , V_299 ) ;
F_26 ( V_337 + V_11 -> V_331 , V_302 ) ;
F_26 ( V_338 + V_11 -> V_331 , 0 ) ;
F_26 ( V_339 + V_11 -> V_331 , 0 ) ;
F_26 ( V_340 + V_11 -> V_331 , 0 ) ;
F_26 ( V_341 + V_11 -> V_331 , 0 ) ;
F_26 ( V_342 + V_11 -> V_331 , V_293 -> V_343 ) ;
F_26 ( V_344 + V_11 -> V_331 , V_293 -> V_345 ) ;
V_300 = V_293 -> V_346 / ( V_293 -> V_310 / 8 ) ;
F_26 ( V_347 + V_11 -> V_331 , V_300 ) ;
F_26 ( V_348 + V_11 -> V_331 , 1 ) ;
F_26 ( V_349 + V_11 -> V_331 ,
V_2 -> V_4 . V_350 ) ;
V_288 &= ~ 3 ;
V_289 &= ~ 1 ;
F_26 ( V_351 + V_11 -> V_331 ,
( V_288 << 16 ) | V_289 ) ;
V_305 = V_2 -> V_4 . V_352 ;
V_306 = ( V_2 -> V_4 . V_350 + 1 ) & ~ 1 ;
F_26 ( V_353 + V_11 -> V_331 ,
( V_305 << 16 ) | V_306 ) ;
V_304 = F_25 ( V_354 + V_11 -> V_331 ) ;
V_304 &= ~ V_355 ;
F_26 ( V_354 + V_11 -> V_331 , V_304 ) ;
F_26 ( V_356 + V_11 -> V_331 , 0 ) ;
...
if ( V_9 -> V_70 >= V_190 ) {
if ( V_11 -> V_18 ) {
F_26 ( V_372 , F_64 ( V_298 ) ) ;
F_26 ( V_373 , F_64 ( V_298 ) ) ;
} else {
F_26 ( V_374 , F_64 ( V_298 ) ) ;
F_26 ( V_375 , F_64 ( V_298 ) ) ;
}
}
F_26 ( V_376 + V_11 -> V_331 ,
( T_8 ) V_298 ) ;
F_26 ( V_377 +
V_11 -> V_331 , ( T_8 ) V_298 ) ;
F_26 ( V_378 + V_11 -> V_331 , V_299 ) ;
if ( V_9 -> V_70 >= V_367 )
F_26 ( V_379 + V_11 -> V_331 , V_302 ) ;
F_26 ( V_380 + V_11 -> V_331 , 0 ) ;
F_26 ( V_381 + V_11 -> V_331 , 0 ) ;
F_26 ( V_382 + V_11 -> V_331 , 0 ) ;
F_26 ( V_383 + V_11 -> V_331 , 0 ) ;
F_26 ( V_384 + V_11 -> V_331 , V_293 -> V_343 ) ;
F_26 ( V_385 + V_11 -> V_331 , V_293 -> V_345 ) ;
V_300 = V_293 -> V_346 / ( V_293 -> V_310 / 8 ) ;
F_26 ( V_386 + V_11 -> V_331 , V_300 ) ;
F_26 ( V_387 + V_11 -> V_331 , 1 ) ;
F_26 ( V_388 + V_11 -> V_331 ,
V_2 -> V_4 . V_350 ) ;
V_288 &= ~ 3 ;
V_289 &= ~ 1 ;
F_26 ( V_389 + V_11 -> V_331 ,
( V_288 << 16 ) | V_289 ) ;
V_305 = V_2 -> V_4 . V_352 ;
V_306 = ( V_2 -> V_4 . V_350 + 1 ) & ~ 1 ;
F_26 ( V_390 + V_11 -> V_331 ,
( V_305 << 16 ) | V_306 ) ;
V_304 = F_25 ( V_391 + V_11 -> V_331 ) ;
V_304 &= ~ V_392 ;
F_26 ( V_391 + V_11 -> V_331 , V_304 ) ;
F_26 ( V_393 + V_11 -> V_331 , 0 ) ;
if ( ! V_290 && V_287 && V_287 != V_2 -> V_287 ) {
V_292 = F_52 ( V_287 ) ;
V_297 = F_53 ( V_292 -> V_295 ) ;
V_307 = F_54 ( V_297 , false ) ;
...
int F_68 ( struct V_1 * V_2 , int V_288 , int V_289 ,
struct V_286 * V_394 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_24 ( V_9 ) )
return F_49 ( V_2 , V_394 , V_288 , V_289 , 0 ) ;
else if ( F_7 ( V_9 ) )
return F_67 ( V_2 , V_394 , V_288 , V_289 , 0 ) ;
else
return F_69 ( V_2 , V_394 , V_288 , V_289 , 0 ) ;
}
int F_70 ( struct V_1 * V_2 ,
struct V_286 * V_287 ,
int V_288 , int V_289 , enum V_395 V_75 )
{
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
if ( F_24 ( V_9 ) )
...
return F_67 ( V_2 , V_287 , V_288 , V_289 , 1 ) ;
else
...
if ( V_405 -> V_2 && ( V_405 -> V_2 == V_2 ) ) {
if ( F_33 ( V_405 ) == V_226 ) {
if ( F_28 ( V_9 ) || V_9 -> clock . V_408 )
return V_139 ;
}
}
}
...
struct V_3 * V_4 ,
struct V_3 * V_5 ,
int V_288 , int V_289 , struct V_286 * V_394 )
{
struct V_11 * V_11 = F_2 ( V_2 ) ;
struct V_6 * V_7 = V_2 -> V_7 ;
struct V_8 * V_9 = V_7 -> V_10 ;
