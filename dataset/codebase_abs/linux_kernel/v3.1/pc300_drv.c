...
if ( ( V_629 = F_144 ( V_625 ) ) < 0 )
return V_629 ;
V_1 = F_145 ( sizeof( T_1 ) , V_632 ) ;
if ( V_1 == NULL ) {
F_10 ( L_67
L_68 ,
( unsigned long long ) F_146 ( V_625 , 3 ) ) ;
V_629 = - V_39 ;
goto V_633;
}
V_629 = - V_634 ;
...
V_1 -> V_7 . V_637 = F_147 ( V_625 , 1 ) ;
V_1 -> V_7 . V_638 = F_146 ( V_625 , 2 ) ;
V_1 -> V_7 . V_639 = F_147 ( V_625 , 2 ) ;
V_1 -> V_7 . V_614 = F_146 ( V_625 , 3 ) ;
V_1 -> V_7 . V_640 = F_147 ( V_625 , 3 ) ;
V_1 -> V_7 . V_641 = F_146 ( V_625 , 4 ) ;
V_1 -> V_7 . V_642 = F_147 ( V_625 , 4 ) ;
V_1 -> V_7 . V_643 = F_146 ( V_625 , 5 ) ;
V_1 -> V_7 . V_644 = F_147 ( V_625 , 5 ) ;
switch ( V_631 ) {
case V_645 :
case V_646 :
case V_647 :
...
#ifdef F_148
F_10 ( L_69 , V_625 -> V_622 -> V_652 , V_625 -> V_653 ) ;
F_10 ( L_70 , V_625 -> V_654 , V_1 -> V_7 . V_400 ) ;
F_10 ( L_71
L_72 ,
V_1 -> V_7 . V_614 , V_1 -> V_7 . V_643 , V_1 -> V_7 . V_638 ,
V_1 -> V_7 . V_641 ) ;
#endif
if ( ! F_149 ( V_1 -> V_7 . V_636 , V_1 -> V_7 . V_637 , L_73 ) ) {
F_10 ( L_74
L_75 , V_1 -> V_7 . V_614 ) ;
}
if ( V_1 -> V_7 . V_643 ) {
F_150 ( V_625 , V_655 , V_1 -> V_7 . V_643 ) ;
} else {
V_630 = 1 ;
V_1 -> V_7 . V_643 = F_146 ( V_625 , 0 ) ;
V_1 -> V_7 . V_644 = F_147 ( V_625 , 0 ) ;
}
if ( ! F_151 ( V_1 -> V_7 . V_643 , V_1 -> V_7 . V_644 ,
L_73 ) ) {
F_10 ( L_76
L_77 ,
V_1 -> V_7 . V_614 ) ;
...
if ( ! F_151 ( V_1 -> V_7 . V_614 , V_1 -> V_7 . V_640 ,
L_78 ) ) {
F_10 ( L_76
L_79 ,
V_1 -> V_7 . V_614 ) ;
...
if ( ! F_151 ( V_1 -> V_7 . V_638 , V_1 -> V_7 . V_639 ,
L_80 ) ) {
F_10 ( L_76
L_81 ,
V_1 -> V_7 . V_614 ) ;
...
V_1 -> V_7 . V_406 = F_152 ( V_1 -> V_7 . V_643 , V_1 -> V_7 . V_644 ) ;
V_1 -> V_7 . V_8 = F_152 ( V_1 -> V_7 . V_614 , V_1 -> V_7 . V_640 ) ;
V_1 -> V_7 . V_26 = F_152 ( V_1 -> V_7 . V_638 , V_1 -> V_7 . V_639 ) ;
switch ( V_631 ) {
case V_646 :
case V_649 :
case V_647 :
case V_650 :
F_151 ( V_1 -> V_7 . V_641 , V_1 -> V_7 . V_642 ,
L_82 ) ;
V_1 -> V_7 . V_53 = F_152 ( V_1 -> V_7 . V_641 , V_1 -> V_7 . V_642 ) ;
break;
case V_645 :
case V_648 :
default:
...
V_1 -> V_7 . V_561 = 0x50 ;
V_1 -> V_7 . V_407 = 0x4c ;
if ( ( F_12 ( V_1 -> V_7 . V_406 + V_1 -> V_7 . V_561 ) & V_660 ) ) {
V_1 -> V_7 . type = V_405 ;
} else {
V_1 -> V_7 . type = V_404 ;
}
...
if ( F_154 ( V_1 -> V_7 . V_400 , F_99 , V_661 , L_84 , V_1 ) ) {
F_10 ( L_85 ,
...
if ( V_1 -> V_7 . type == V_321 ) {
F_155 ( V_1 -> V_7 . V_53 ) ;
F_156 ( V_1 -> V_7 . V_641 , V_1 -> V_7 . V_642 ) ;
}
F_156 ( V_1 -> V_7 . V_638 , V_1 -> V_7 . V_639 ) ;
V_658:
F_156 ( V_1 -> V_7 . V_614 , V_1 -> V_7 . V_640 ) ;
V_657:
F_156 ( V_1 -> V_7 . V_643 , V_1 -> V_7 . V_644 ) ;
V_656:
F_157 ( V_1 -> V_7 . V_636 , V_1 -> V_7 . V_637 ) ;
F_158 ( V_1 ) ;
V_633:
F_159 ( V_625 ) ;
return V_629 ;
}
static void T_17 F_160 ( struct V_624 * V_625 )
{
T_1 * V_1 = F_161 ( V_625 ) ;
if ( V_1 -> V_7 . V_8 ) {
int V_3 ;
...
if ( V_1 -> V_7 . V_400 )
F_163 ( V_1 -> V_7 . V_400 , V_1 ) ;
F_158 ( V_1 ) ;
F_159 ( V_625 ) ;
}
}
static int T_18 F_164 ( void )
{
return F_165 ( & V_663 ) ;
}
static void T_19 F_166 ( void )
{
F_167 ( & V_663 ) ;
}
