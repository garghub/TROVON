...
static void T_9 F_167 ( struct V_27 * V_28 )
{
struct V_1 * V_2 ;
struct V_19 * V_20 ;
V_2 = F_168 ( V_28 ) ;
...
static T_10 F_179 ( struct V_27 * V_28 ,
T_11 V_218 )
{
struct V_1 * V_2 = F_168 ( V_28 ) ;
if ( V_218 == V_286 )
...
static T_10 F_181 ( struct V_27 * V_28 )
{
int V_37 = 0 ;
V_37 = F_175 ( V_28 ) ;
...
static int
F_188 ( struct V_27 * V_28 , T_12 V_218 )
{
struct V_1 * V_2 = F_168 ( V_28 ) ;
int V_292 ;
F_174 ( V_2 ) ;
...
F_166 ( V_28 ) ;
F_176 ( V_28 , F_189 ( V_28 , V_218 ) ) ;
return 0 ;
}
static int
F_190 ( struct V_27 * V_28 )
{
return F_175 ( V_28 ) ;
}
static int F_191 ( struct V_19 * V_20 )
{
struct V_1 * V_2 = F_47 ( V_20 ) ;
int V_37 = 0 ;
if ( V_2 -> V_148 )
...
F_199 ( V_296 ) -> V_313 > 0 ) {
V_303 = F_200 ( V_296 ) + F_201 ( V_296 ) ;
V_294 -> V_314 = F_202 ( F_199 ( V_296 ) -> V_313 ) ;
V_294 -> V_315 = V_303 ;
if ( V_305 ) {
V_294 -> V_315 += V_316 ;
V_294 -> V_317 = V_316 ;
...
V_297 = ( V_299 == F_195 ( V_319 ) ) ?
V_320 : V_321 ;
V_304 = 1 ;
} else if ( V_296 -> V_322 == V_323 ) {
T_13 V_324 ;
if ( V_299 == F_195 ( V_325 ) ) {
V_324 = F_203 ( V_296 ) -> V_299 ;
if ( V_324 == V_326 )
V_297 = V_327 ;
else if( V_324 == V_328 )
V_297 = V_329 ;
} else if ( V_299 == F_195 ( V_319 ) ) {
V_324 = F_204 ( V_296 ) -> V_330 ;
if ( V_324 == V_326 )
V_297 = V_331 ;
else if( V_324 == V_328 )
V_297 = V_332 ;
...
V_294 -> V_317 += F_200 ( V_296 ) ;
V_294 -> V_318 += F_205 ( V_296 ) ;
F_206 ( V_294 , V_95 , V_297 ) ;
if ( ! V_304 )
return;
V_6 = V_4 -> V_6 ;
V_301 = 0 ;
...
V_302 = F_207 ( ( int ) sizeof( struct V_293 ) - V_146 ,
V_303 + V_316 ) ;
V_308 = (struct V_307 * ) ( ( char * ) V_306 + 2 ) ;
F_208 ( V_296 , V_308 , 12 ) ;
V_308 -> V_335 = F_209 ( V_309 ) ;
V_308 -> V_336 = F_209 ( V_300 ) ;
F_210 ( V_296 , 12 ,
( char * ) V_308 + 16 , V_302 - 16 ) ;
V_301 = V_302 - V_316 ;
V_146 = 0 ;
V_6 = F_211 ( V_6 , V_4 -> V_337 ) ;
}
while ( V_301 < V_303 ) {
V_302 = F_207 ( ( int ) sizeof( struct V_293 ) - V_146 ,
( V_303 - V_301 ) ) ;
...
int V_70 , V_344 ;
T_16 V_345 ;
V_344 = F_199 ( V_296 ) -> V_344 ;
V_341 = & V_339 -> V_346 [ 0 ] ;
V_345 = F_214 ( V_28 , V_296 -> V_52 ,
F_215 ( V_296 ) , V_347 ) ;
if ( F_216 ( V_28 , V_345 ) )
goto V_348;
V_341 -> V_349 = V_345 ;
V_341 -> V_350 = F_215 ( V_296 ) ;
for ( V_70 = 0 ; V_70 < V_344 ; V_70 ++ ) {
V_343 = & F_199 ( V_296 ) -> V_351 [ V_70 ] ;
V_341 = & V_339 -> V_346 [ V_70 + 1 ] ;
V_345 = F_217 ( V_28 , V_343 -> V_352 , V_343 -> V_353 ,
V_343 -> V_16 , V_347 ) ;
if ( F_216 ( V_28 , V_345 ) )
goto V_354;
V_341 -> V_349 = V_345 ;
...
while ( -- V_70 >= 0 ) {
V_341 = & V_339 -> V_346 [ V_70 + 1 ] ;
F_218 ( V_28 , V_341 -> V_349 , V_341 -> V_350 , V_347 ) ;
}
V_341 = & V_339 -> V_346 [ 0 ] ;
F_219 ( V_28 , V_341 -> V_349 , F_215 ( V_296 ) , V_347 ) ;
V_348:
return - V_23 ;
}
static inline void
...
static T_17
F_221 ( struct V_295 * V_296 , struct V_19 * V_20 )
{
struct V_1 * V_2 = F_47 ( V_20 ) ;
...
int V_359 , V_360 ;
T_2 V_174 = V_4 -> V_337 ;
V_359 = F_199 ( V_296 ) -> V_344 + 1 ;
if ( ! F_222 ( V_296 ) && V_359 > V_361 ) {
for ( V_70 = 0 ; V_70 < ( V_359 - V_361 ) ; V_70 ++ ) {
V_343 = & F_199 ( V_296 ) -> V_351 [ V_70 ] ;
V_358 += V_343 -> V_16 ;
}
if ( ! F_223 ( V_296 , V_358 ) )
goto V_362;
V_359 = 1 + F_199 ( V_296 ) -> V_344 ;
}
V_360 = ( V_359 + 3 ) >> 2 ;
if ( F_224 ( F_225 ( V_4 ) <= V_363 ) ) {
F_226 ( V_20 ) ;
F_113 () ;
if ( F_225 ( V_4 ) > V_363 )
F_192 ( V_20 ) ;
...
V_339 = & V_4 -> V_334 [ V_6 ] ;
V_28 = V_2 -> V_28 ;
if ( F_213 ( V_28 , V_296 , V_339 ) )
goto V_362;
V_339 -> V_296 = V_296 ;
V_339 -> V_359 = V_359 ;
V_294 = V_306 = & V_4 -> V_333 [ V_6 ] ;
F_220 ( ( T_3 * ) V_306 ) ;
F_227 ( V_294 , V_359 , V_296 -> V_365 ) ;
F_228 ( V_294 , V_2 -> V_154 ) ;
...
V_306 -> V_366 [ V_357 ] = F_202 ( V_356 -> V_350 ) ;
switch ( V_357 ) {
case 0 :
V_306 -> V_367 = F_229 ( V_356 -> V_349 ) ;
break;
case 1 :
V_306 -> V_368 = F_229 ( V_356 -> V_349 ) ;
break;
case 2 :
V_306 -> V_369 = F_229 ( V_356 -> V_349 ) ;
break;
case 3 :
V_306 -> V_370 = F_229 ( V_356 -> V_349 ) ;
break;
}
}
V_4 -> V_6 = F_211 ( V_6 , V_174 ) ;
F_194 ( V_20 , V_4 , V_294 , V_296 ) ;
...
void F_234 ( struct V_1 * V_2 , int V_215 )
{
struct V_19 * V_20 = V_2 -> V_20 ;
...
if ( F_28 ( V_2 -> V_32 . V_33 ) ) {
V_47 = F_27 ( V_2 , V_389 ) ;
V_47 = F_238 ( V_2 -> V_32 . V_100 , V_47 ) ;
V_215 = ( V_47 == V_390 ) ;
} else {
V_47 = F_27 ( V_2 , V_391 ) ;
...
static void F_239 ( struct V_19 * V_20 )
{
struct V_1 * V_2 = F_47 ( V_20 ) ;
if ( F_240 ( V_228 , & V_2 -> V_218 ) )
return;
F_71 ( & V_20 -> V_43 , L_41 ) ;
F_241 ( & V_2 -> V_249 ) ;
}
...
static struct V_400 * F_243 ( struct V_19 * V_20 ,
struct V_400 * V_371 )
{
struct V_1 * V_2 = F_47 ( V_20 ) ;
...
struct V_1 * V_2 = V_10 -> V_2 ;
T_2 V_410 = 0 ;
V_410 = F_244 ( V_2 -> V_104 ) ;
if ( ! ( V_410 & V_2 -> V_101 ) )
return V_411 ;
if ( F_28 ( V_2 -> V_32 . V_33 ) ) {
V_410 = F_244 ( V_2 -> V_107 ) ;
if ( ! F_245 ( V_410 ) )
return V_411 ;
} else {
unsigned long V_412 = 0 ;
V_412 = F_244 ( V_2 -> V_107 ) ;
if ( ! F_112 ( ( 7 + V_2 -> V_154 ) , & V_412 ) )
return V_411 ;
F_246 ( ( V_412 & 0xffffffff ) , V_2 -> V_107 ) ;
F_4 ( V_10 ) ;
}
F_246 ( 0xffffffff , V_2 -> V_102 ) ;
F_244 ( V_2 -> V_104 ) ;
F_244 ( V_2 -> V_104 ) ;
F_247 ( & V_10 -> V_24 ) ;
return V_413 ;
...
{
struct V_9 * V_10 =
F_242 ( V_24 , struct V_9 , V_24 ) ;
struct V_1 * V_2 = V_10 -> V_2 ;
int V_416 ;
int V_417 ;
V_416 = F_248 ( V_2 ) ;
V_417 = F_249 ( V_10 , V_415 ) ;
if ( ( V_417 < V_415 ) && V_416 ) {
F_250 ( & V_10 -> V_24 ) ;
if ( F_240 ( V_217 , & V_2 -> V_218 ) )
F_5 ( V_10 ) ;
}
return V_417 ;
}
static void F_251 ( struct V_19 * V_20 )
{
int V_21 ;
struct V_9 * V_10 ;
struct V_1 * V_2 = F_47 ( V_20 ) ;
...
{
F_259 ( & V_2 -> V_427 , V_425 ) ;
F_260 ( & V_2 -> V_427 , V_426 ) ;
}
static void
...
static T_21
F_266 ( struct V_444 * V_43 ,
struct V_445 * V_446 , const char * V_447 , T_22 V_365 )
{
struct V_19 * V_448 = F_267 ( V_43 ) ;
...
static T_21
F_271 ( struct V_444 * V_43 ,
struct V_445 * V_446 , const char * V_447 , T_22 V_365 )
{
struct V_1 * V_2 = F_272 ( V_43 ) ;
unsigned long V_449 ;
if ( F_268 ( V_447 , 2 , & V_449 ) )
return - V_81 ;
...
static T_21
F_276 ( struct V_458 * V_459 , struct V_460 * V_461 ,
struct V_462 * V_446 ,
char * V_447 , T_23 V_146 , T_22 V_16 )
{
struct V_444 * V_43 = F_242 ( V_461 , struct V_444 , V_461 ) ;
struct V_1 * V_2 = F_272 ( V_43 ) ;
T_2 V_52 ;
T_3 V_463 ;
int V_419 ;
V_419 = F_274 ( V_2 , V_146 , V_16 ) ;
if ( V_419 != 0 )
return V_419 ;
if ( F_28 ( V_2 -> V_32 . V_33 ) &&
F_275 ( V_146 , V_456 ,
V_457 ) ) {
F_277 ( V_2 , V_146 , & V_463 ) ;
...
static T_21
F_278 ( struct V_458 * V_459 , struct V_460 * V_461 ,
struct V_462 * V_446 ,
char * V_447 , T_23 V_146 , T_22 V_16 )
{
struct V_444 * V_43 = F_242 ( V_461 , struct V_444 , V_461 ) ;
...
static T_21
F_281 ( struct V_458 * V_459 , struct V_460 * V_461 ,
struct V_462 * V_446 ,
char * V_447 , T_23 V_146 , T_22 V_16 )
{
struct V_444 * V_43 = F_242 ( V_461 , struct V_444 , V_461 ) ;
...
static T_21 F_282 ( struct V_458 * V_459 , struct V_460 * V_461 ,
...
static void
F_178 ( struct V_19 * V_43 , unsigned long V_470 )
{
struct V_471 * V_472 ;
struct V_1 * V_2 = F_47 ( V_43 ) ;
if ( ! F_287 ( V_2 ) )
...
static int F_293 ( struct V_478 * V_479 ,
...
switch ( V_470 ) {
case V_285 :
F_290 ( V_2 , V_473 -> V_474 , V_475 ) ;
break;
case V_476 :
F_290 ( V_2 , V_473 -> V_474 , V_477 ) ;
break;
default:
break;
}
