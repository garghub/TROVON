...
static T_1 int F_27 ( struct V_1 * V_26 )
{
unsigned long V_15 = F_2 ( V_16 ) ;
unsigned int V_17 = V_26 -> V_17 ;
struct V_1 * V_8 ;
int V_27 ;
V_27 = F_23 ( V_26 ) ;
if ( V_27 < 0 )
...
for ( V_1 = 0 ; V_1 < F_33 ( V_4 ) ; V_1 ++ )
V_4 [ V_1 ] . V_8 = V_28 ;
F_34 ( V_4 , F_33 ( V_4 ) ) ;
F_34 ( V_24 , F_33 ( V_24 ) ) ;
for ( V_1 = 0 ; V_1 < F_33 ( V_23 ) ; V_1 ++ ) {
V_27 = F_22 ( V_1 ) ;
if ( V_27 < 0 ) {
F_32 ( V_29 L_3 , V_1 ) ;
return;
