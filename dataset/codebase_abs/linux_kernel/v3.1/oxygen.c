...
V_86 -> V_95 == V_88 ||
V_86 -> V_95 == V_90 ) {
V_2 -> V_30 . V_116 = V_117 ;
V_2 -> V_30 . V_101 |= V_118 | V_119 ;
}
if ( V_86 -> V_95 < F_5 ( V_66 ) && V_66 [ V_86 -> V_95 ] )
V_2 -> V_30 . V_110 = V_66 [ V_86 -> V_95 ] ;
return 0 ;
}
static int T_3 F_68 ( struct V_120 * V_121 ,
const struct V_85 * V_122 )
{
static int V_123 ;
int V_78 ;
if ( V_123 >= V_124 )
...
V_78 = F_69 ( V_121 , V_128 [ V_123 ] , V_86 [ V_123 ] , V_129 ,
V_130 , F_66 ) ;
if ( V_78 >= 0 )
++ V_123 ;
return V_78 ;
