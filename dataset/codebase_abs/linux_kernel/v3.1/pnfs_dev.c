...
struct V_11 *
F_21 ( struct V_11 * V_27 )
{
struct V_11 * V_17 ;
long V_16 ;
F_13 ( & V_22 ) ;
V_16 = F_3 ( & V_27 -> V_20 ) ;
V_17 = F_7 ( V_27 -> V_13 , V_27 -> V_14 , & V_27 -> V_20 , V_16 ) ;
if ( V_17 ) {
F_14 ( & V_22 ) ;
return V_17 ;
}
F_22 ( & V_27 -> V_23 , & V_28 [ V_16 ] ) ;
F_14 ( & V_22 ) ;
F_9 ( & V_27 -> V_21 ) ;
return V_27 ;
}
...
static void
F_24 ( const struct V_14 * V_15 , long V_16 )
{
struct V_11 * V_17 ;
struct V_18 * V_19 ;
F_25 ( V_29 ) ;
...
F_16 () ;
while ( ! F_27 ( & V_29 ) ) {
V_17 = F_28 ( V_29 . V_30 , struct V_11 , V_25 ) ;
F_29 ( & V_17 -> V_25 ) ;
if ( F_17 ( & V_17 -> V_21 ) )
V_17 -> V_13 -> V_24 ( V_17 ) ;
}
...
F_5 (d, n, &nfs4_deviceid_cache[i], node)
if ( V_17 -> V_14 == V_15 )
F_32 ( V_36 , & V_17 -> V_26 ) ;
}
F_10 () ;
