...
F_8 ( & V_2 -> V_9 . V_17 , V_16 ) ;
if ( F_40 ( & V_2 -> V_9 . V_18 ) ) {
F_9 ( & V_2 -> V_9 . V_17 , V_16 ) ;
return 0 ;
}
V_15 = F_17 ( V_2 -> V_9 . V_18 . V_46 ,
struct V_14 , V_22 ) ;
F_41 ( V_15 ) ;
F_9 ( & V_2 -> V_9 . V_17 , V_16 ) ;
...
struct V_14 * F_41 ( struct V_14 * V_15 )
{
F_44 ( & V_15 -> V_35 ) ;
return V_15 ;
}
...
struct V_56 * V_48 = V_54 -> V_57 -> V_48 ;
struct V_1 * V_2 = V_48 -> V_58 ;
struct V_14 * V_15 ;
F_57 ( V_51 , L_6 ,
F_4 ( V_2 ) ) ;
if ( ! F_40 ( & V_2 -> V_9 . V_18 ) ) {
