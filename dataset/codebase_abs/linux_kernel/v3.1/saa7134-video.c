...
static int F_147 ( struct V_215 * V_215 , void * V_234 , struct V_367 * V_368 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
if ( V_368 -> type != V_235 &&
...
V_371 -> V_379 = F_150 ( V_11 ) ;
V_371 -> V_380 = F_151 ( V_371 -> V_379 ) ;
}
...
static int F_155 ( struct V_215 * V_215 , void * V_216 , struct V_389 * V_109 )
{
...
static int F_157 ( struct V_215 * V_215 , void * V_234 , enum V_390 * V_391 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
* V_391 = F_158 ( & V_11 -> V_219 ) ;
return 0 ;
}
...
if ( V_234 -> V_320 >= V_8 )
return - V_129 ;
F_140 ( V_234 -> V_393 , V_9 [ V_234 -> V_320 ] . V_20 ,
sizeof( V_234 -> V_393 ) ) ;
...
static int F_166 ( struct V_215 * V_215 , void * V_234 , unsigned int V_400 )
{
struct V_12 * V_13 = V_234 ;
struct V_10 * V_11 = V_13 -> V_11 ;
unsigned long V_217 ;
...
static int F_171 ( struct V_215 * V_215 , void * V_216 , struct V_402 * V_110 )
{
struct V_12 * V_13 = V_216 ;
return F_172 ( F_93 ( V_13 ) , V_110 ) ;
}
static int F_173 ( struct V_215 * V_215 , void * V_216 , struct V_402 * V_110 )
{
struct V_12 * V_13 = V_216 ;
...
V_371 -> signal = 0xf800 - ( ( F_136 ( 0x581 ) & 0x1f ) << 11 ) ;
V_371 -> V_379 = ( F_136 ( 0x529 ) & 0x08 ) ?
V_411 : V_412 ;
}
return 0 ;
}
...
static int F_186 ( struct V_215 * V_414 , void * V_216 , unsigned int * V_3 )
{
* V_3 = 0 ;
return 0 ;
}
...
static int F_189 ( struct V_215 * V_414 , void * V_216 , unsigned int V_3 )
{
return 0 ;
}
