...
static inline void
F_164 ( unsigned long V_365 , unsigned V_11 , T_3 * V_366 )
{
unsigned V_1 ;
...
F_171 ( V_15 -> V_59 ) ;
#else
F_166 ( V_15 -> V_367 , V_15 -> V_18 ,
F_50 ( V_15 -> V_367 ) ) ;
F_7 ( ( ( T_2 * ) V_15 -> V_367 ) [ 1 ] , V_15 -> V_18 + 2 ) ;
#endif
}
static int
F_172 ( struct V_331 * V_85 , T_8 V_368 )
{
