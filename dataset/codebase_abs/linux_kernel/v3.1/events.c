...
int F_98 ( unsigned int V_15 , unsigned int V_6 )
{
struct V_117 V_118 ;
int V_5 , V_2 ;
F_85 ( & V_79 ) ;
...
static void F_99 ( unsigned int V_2 )
{
struct V_72 V_73 ;
int V_5 = F_10 ( V_2 ) ;
F_85 ( & V_79 ) ;
...
if ( V_2 < 0 )
return V_2 ;
V_124 = F_101 ( V_2 , V_120 , V_121 , V_122 , V_123 ) ;
if ( V_124 != 0 ) {
F_99 ( V_2 ) ;
return V_124 ;
}
...
void F_105 ( unsigned int V_2 , void * V_123 )
{
F_106 ( V_2 , V_123 ) ;
F_99 ( V_2 ) ;
}
void F_107 ( unsigned int V_6 , enum V_10 V_20 )
{
int V_2 = F_7 ( V_14 , V_6 ) [ V_20 ] ;
F_4 ( V_2 < 0 ) ;
F_38 ( V_2 ) ;
}
T_5 F_108 ( int V_2 , void * V_123 )
{
...
V_129 = F_7 ( V_46 , V_6 ) ;
F_76 ( L_13 ) ;
for ( V_36 = F_115 ( V_28 -> V_30 ) - 1 ; V_36 >= 0 ; V_36 -- )
F_76 ( L_14 , ( int ) sizeof( V_28 -> V_30 [ 0 ] ) * 2 ,
V_28 -> V_30 [ V_36 ] ,
V_36 % 8 == 0 ? L_15 : L_16 ) ;
F_76 ( L_17 ) ;
for ( V_36 = F_115 ( V_28 -> V_32 ) - 1 ; V_36 >= 0 ; V_36 -- )
F_76 ( L_14 ,
...
void F_126 ( struct V_146 * V_147 )
{
struct V_146 * V_148 = F_127 ( V_147 ) ;
F_128 () ;
F_129 () ;
F_117 () ;
F_130 () ;
...
static int F_136 ( unsigned V_2 , unsigned V_149 )
{
struct V_150 V_151 ;
int V_5 = F_10 ( V_2 ) ;
if ( ! F_39 ( V_5 ) )
...
static int F_137 ( struct V_34 * V_60 , const struct V_154 * V_155 ,
bool V_156 )
{
unsigned V_149 = F_138 ( V_155 ) ;
return F_136 ( V_60 -> V_2 , V_149 ) ;
}
int F_139 ( unsigned int V_2 )
{
...
static void F_140 ( struct V_34 * V_60 )
{
int V_5 = F_10 ( V_60 -> V_2 ) ;
if ( F_39 ( V_5 ) )
F_42 ( V_5 ) ;
...
static int F_143 ( struct V_34 * V_60 )
{
int V_5 = F_10 ( V_60 -> V_2 ) ;
struct V_27 * V_28 = V_41 ;
int V_25 = 0 ;
...
static void F_145 ( unsigned int V_6 )
{
struct V_117 V_118 ;
int V_15 , V_2 , V_5 ;
...
V_168 . V_169 = 1 ;
V_168 . V_166 = V_166 ;
F_151 ( V_168 . V_170 , & V_5 ) ;
if ( F_152 ( V_171 , & V_168 ) != 0 )
F_80 () ;
}
}
void F_153 ( int V_2 )
