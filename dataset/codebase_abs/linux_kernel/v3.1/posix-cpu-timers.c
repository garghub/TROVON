...
static int F_104 ( const T_2 V_8 , int V_56 ,
...
static int F_109 ( const T_2 V_8 , int V_56 ,
...
F_7 ( V_8 ) == V_13 -> V_10 ) )
return - V_12 ;
error = F_104 ( V_8 , V_56 , V_147 , & V_34 ) ;
if ( error == - V_150 ) {
if ( V_56 & V_95 )
return - V_153 ;
if ( V_151 && F_111 ( V_151 , & V_34 . V_94 , sizeof *V_151 ) )
return - V_154 ;
V_152 -> V_155 = V_156 ;
V_152 -> V_157 . V_158 = V_8 ;
V_152 -> V_157 . V_151 = V_151 ;
V_152 -> V_157 . V_38 = F_112 ( V_147 ) ;
}
return error ;
}
...
error = F_104 ( V_8 , V_95 , & V_50 , & V_34 ) ;
if ( error == - V_150 ) {
struct V_15 T_4 * V_151 = V_152 -> V_157 . V_151 ;
if ( V_151 && F_111 ( V_151 , & V_34 . V_94 , sizeof *V_151 ) )
return - V_154 ;
V_152 -> V_157 . V_38 = F_112 ( & V_50 ) ;
}
return error ;
}
...
static int F_115 ( struct V_31 * V_32 )
{
V_32 -> V_36 = V_159 ;
return F_50 ( V_32 ) ;
}
static int F_116 ( const T_2 V_8 , int V_56 ,
struct V_15 * V_147 ,
struct V_15 T_4 * V_151 )
{
return F_109 ( V_159 , V_56 , V_147 , V_151 ) ;
}
static long F_117 ( struct V_152 * V_152 )
{
return - V_12 ;
}
static int F_118 ( const T_2 V_8 ,
struct V_15 * V_16 )
{
