...
{
struct V_180 * V_181 ;
V_2 -> V_180 = V_181 = F_105 () ;
if ( ! V_181 ) {
F_12 ( V_21 L_23 ) ;
return - V_182 ;
}
F_106 ( V_181 , L_24 ) ;
F_107 ( V_181 , L_25 , F_108 ( V_2 -> V_125 ) ) ;
F_109 ( V_181 , & V_2 -> V_125 -> V_183 ) ;
V_181 -> V_184 = V_2 -> V_185 ;
F_110 ( V_181 ) ;
return 0 ;
}
...
F_127 ( V_116 , & V_125 -> V_183 ) ;
* V_191 = V_2 ;
return 0 ;
}
static T_6 V_176 ( int V_173 , void * V_203 )
{
...
V_102 = F_137 ( V_222 [ V_183 ] , V_209 [ V_183 ] , V_223 , 0 , & V_116 ) ;
if ( V_102 < 0 )
return V_102 ;
