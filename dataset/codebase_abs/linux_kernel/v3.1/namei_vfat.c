...
if ( ( V_97 = V_39 -> V_100 ( V_58 , V_15 - V_31 , ( T_1 * ) V_93 ) ) < 0 )
return - V_32 ;
V_58 += V_97 ;
V_31 += V_97 ;
V_93 += 2 ;
...
int V_15 , int V_101 , int V_102 ,
struct V_103 * V_104 ,
struct V_105 * V_106 , int * V_107 )
{
struct V_108 * V_109 = F_11 ( V_33 -> V_56 ) ;
struct V_54 * V_55 = & V_109 -> V_57 ;
struct V_105 * V_110 ;
struct V_111 * V_112 ;
unsigned char V_113 , V_53 ;
unsigned char V_114 [ V_78 ] ;
T_1 * V_50 ;
T_2 time , V_115 ;
T_3 V_116 ;
int V_36 , V_51 , V_117 , V_31 ;
T_4 V_118 ;
* V_107 = 0 ;
V_50 = F_34 () ;
if ( ! V_50 )
return - V_119 ;
V_36 = F_31 ( V_16 , V_15 , ( unsigned char * ) V_50 , & V_51 , & V_117 ,
V_55 -> V_120 , V_55 -> V_91 , V_109 -> V_23 ) ;
if ( V_36 )
goto V_121;
V_36 = F_22 ( V_50 , V_51 ) ;
if ( V_36 )
goto V_121;
V_36 = F_28 ( V_33 , V_109 -> V_122 , V_50 , V_51 ,
V_114 , & V_53 ) ;
if ( V_36 < 0 )
goto V_121;
else if ( V_36 == 1 ) {
V_112 = (struct V_111 * ) V_106 ;
V_36 = 0 ;
goto V_80;
}
V_113 = F_35 ( V_114 ) ;
* V_107 = V_117 / 13 ;
for ( V_110 = V_106 , V_31 = * V_107 ; V_31 > 0 ; V_31 -- , V_110 ++ ) {
V_110 -> V_123 = V_31 ;
V_110 -> V_124 = V_125 ;
V_110 -> V_126 = 0 ;
V_110 -> V_127 = V_113 ;
V_110 -> V_128 = 0 ;
V_118 = ( V_31 - 1 ) * 13 ;
F_36 ( V_110 -> V_129 , V_50 + V_118 , 5 ) ;
F_36 ( V_110 -> V_130 , V_50 + V_118 + 5 , 6 ) ;
F_36 ( V_110 -> V_131 , V_50 + V_118 + 11 , 2 ) ;
}
V_106 [ 0 ] . V_123 |= 0x40 ;
V_112 = (struct V_111 * ) V_110 ;
V_80:
( * V_107 ) ++ ;
memcpy ( V_112 -> V_16 , V_114 , V_78 ) ;
V_112 -> V_124 = V_101 ? V_132 : V_133 ;
V_112 -> V_53 = V_53 ;
F_37 ( V_109 , V_104 , & time , & V_115 , & V_116 ) ;
V_112 -> time = V_112 -> ctime = time ;
V_112 -> V_115 = V_112 -> V_134 = V_112 -> V_135 = V_115 ;
V_112 -> V_136 = V_116 ;
V_112 -> V_128 = F_38 ( V_102 ) ;
V_112 -> V_137 = F_38 ( V_102 >> 16 ) ;
V_112 -> V_138 = 0 ;
V_121:
F_39 ( V_50 ) ;
return V_36 ;
}
static int F_40 ( struct V_18 * V_33 , struct V_17 * V_139 , int V_101 ,
...
if ( V_15 == 0 )
return - V_37 ;
V_106 = F_41 ( sizeof( * V_106 ) * V_140 , V_141 ) ;
if ( V_106 == NULL )
return - V_119 ;
V_36 = F_33 ( V_33 , V_139 -> V_16 , V_15 , V_101 , V_102 , V_104 ,
V_106 , & V_107 ) ;
if ( V_36 )
goto V_142;
V_36 = F_42 ( V_33 , V_106 , V_107 , V_35 ) ;
if ( V_36 )
goto V_142;
V_33 -> V_143 = V_33 -> V_144 = V_33 -> V_145 = * V_104 ;
if ( F_43 ( V_33 ) )
( void ) F_44 ( V_33 ) ;
else
F_45 ( V_33 ) ;
...
static int F_47 ( struct V_18 * V_33 , struct V_17 * V_139 ,
struct V_34 * V_35 )
{
unsigned int V_15 = F_7 ( V_139 ) ;
if ( V_15 == 0 )
return - V_37 ;
return F_48 ( V_33 , V_139 -> V_16 , V_15 , V_35 ) ;
}
static int F_49 ( struct V_1 * V_1 )
{
return F_50 ( V_1 ) && ( V_1 -> V_146 & V_147 ) ;
}
static struct V_1 * F_51 ( struct V_18 * V_33 , struct V_1 * V_1 ,
struct V_8 * V_9 )
{
struct V_148 * V_149 = V_33 -> V_56 ;
struct V_34 V_35 ;
struct V_18 * V_18 ;
struct V_1 * V_150 ;
int V_36 ;
F_52 ( V_149 ) ;
V_36 = F_47 ( V_33 , & V_1 -> V_151 , & V_35 ) ;
if ( V_36 ) {
if ( V_36 == - V_37 ) {
V_18 = NULL ;
goto V_152;
...
V_18 = F_53 ( V_149 , V_35 . V_112 , V_35 . V_153 ) ;
F_25 ( V_35 . V_38 ) ;
if ( F_54 ( V_18 ) ) {
V_36 = F_55 ( V_18 ) ;
goto error;
...
static int F_66 ( struct V_18 * V_33 , struct V_1 * V_1 , int V_155 ,
struct V_8 * V_9 )
{
struct V_148 * V_149 = V_33 -> V_56 ;
struct V_18 * V_18 ;
...
F_52 ( V_149 ) ;
V_104 = V_156 ;
V_36 = F_40 ( V_33 , & V_1 -> V_151 , 0 , 0 , & V_104 , & V_35 ) ;
if ( V_36 )
goto V_152;
V_33 -> V_7 ++ ;
V_18 = F_53 ( V_149 , V_35 . V_112 , V_35 . V_153 ) ;
...
V_18 -> V_7 ++ ;
V_18 -> V_144 = V_18 -> V_145 = V_18 -> V_143 = V_104 ;
V_1 -> V_4 = V_1 -> V_5 -> V_6 -> V_7 ;
F_67 ( V_1 , V_18 ) ;
V_152:
F_62 ( V_149 ) ;
...
static int F_75 ( struct V_18 * V_33 , struct V_1 * V_1 , int V_155 )
{
struct V_148 * V_149 = V_33 -> V_56 ;
struct V_18 * V_18 ;
struct V_34 V_35 ;
...
F_52 ( V_149 ) ;
V_104 = V_156 ;
V_102 = F_76 ( V_33 , & V_104 ) ;
if ( V_102 < 0 ) {
V_36 = V_102 ;
goto V_152;
}
V_36 = F_40 ( V_33 , & V_1 -> V_151 , 1 , V_102 , & V_104 , & V_35 ) ;
if ( V_36 )
goto V_121;
V_33 -> V_7 ++ ;
F_77 ( V_33 ) ;
...
static int F_79 ( struct V_18 * V_158 , struct V_1 * V_159 ,
...
struct V_103 V_104 ;
T_4 V_168 , V_169 ;
int V_36 , V_101 , V_170 , V_171 = 0 ;
struct V_148 * V_149 = V_158 -> V_56 ;
V_167 . V_38 = V_35 . V_38 = V_163 = NULL ;
V_165 = V_159 -> V_6 ;
V_166 = V_161 -> V_6 ;
F_52 ( V_149 ) ;
V_36 = F_47 ( V_158 , & V_159 -> V_151 , & V_167 ) ;
if ( V_36 )
goto V_152;
V_101 = F_59 ( V_165 -> V_154 ) ;
V_170 = ( V_101 && V_158 != V_160 ) ;
if ( V_170 ) {
if ( F_80 ( V_165 , & V_163 , & V_164 ,
& V_168 ) < 0 ) {
V_36 = - V_172 ;
goto V_152;
}
...
V_169 = F_81 ( V_166 ) -> V_153 ;
F_73 ( V_166 ) ;
} else {
V_36 = F_40 ( V_160 , & V_161 -> V_151 , V_101 , 0 ,
& V_104 , & V_35 ) ;
if ( V_36 )
goto V_152;
V_169 = V_35 . V_153 ;
...
F_45 ( V_165 ) ;
if ( V_170 ) {
int V_128 = F_81 ( V_160 ) -> V_174 ;
V_164 -> V_128 = F_38 ( V_128 ) ;
V_164 -> V_137 = F_38 ( V_128 >> 16 ) ;
F_83 ( V_163 , V_165 ) ;
if ( F_43 ( V_160 ) ) {
V_36 = F_84 ( V_163 ) ;
if ( V_36 )
...
{
F_11 ( V_149 ) -> V_178 = & V_179 ;
if ( F_11 ( V_149 ) -> V_57 . V_180 != 's' )
V_149 -> V_181 = & V_182 ;
else
V_149 -> V_181 = & V_183 ;
}
static int F_87 ( struct V_148 * V_149 , void * V_184 , int V_185 )
{
return F_88 ( V_149 , V_184 , V_185 , 1 , F_86 ) ;
}
static struct V_1 * F_89 ( struct V_186 * V_187 ,
int V_10 , const char * V_188 ,
void * V_184 )
{
return F_90 ( V_187 , V_10 , V_188 , V_184 , F_87 ) ;
}
