...
struct V_307 * V_308 = V_305 -> V_309 [ V_20 ] ;
F_288 ( V_308 ) ;
}
F_88 ( V_305 ) ;
}
int F_289 ( struct V_18 * V_18 , enum V_310 V_311 , T_5 V_142 ,
int V_171 , const void * V_299 )
{
int V_20 ;
struct V_69 * V_305 ;
V_305 = F_290 ( V_18 -> V_68 [ V_311 ] , & V_18 -> V_50 ) ;
for ( V_20 = 0 ; V_20 < V_305 -> V_306 ; V_20 ++ )
if ( ! F_291 ( V_305 -> V_309 [ V_20 ] , V_142 , V_171 , V_299 ) )
return 0 ;
return - V_291 ;
}
int F_292 ( struct V_18 * V_18 , enum V_310 V_311 , T_5 V_142 ,
...
V_305 = F_290 ( V_18 -> V_68 [ V_311 ] , & V_18 -> V_50 ) ;
for ( V_20 = 0 ; V_20 < V_305 -> V_306 ; V_20 ++ )
if ( ! F_293 ( V_305 -> V_309 [ V_20 ] , V_142 , V_171 , V_299 ) )
return 0 ;
return - V_291 ;
}
int F_294 ( struct V_18 * V_18 , enum V_310 V_311 ,
struct V_307 * V_312 )
{
struct V_69 * V_313 , * V_305 ;
V_305 = V_18 -> V_68 [ V_311 ] ;
if ( V_305 -> V_306 > V_314 - 1 )
return - V_315 ;
V_313 = F_77 ( sizeof( struct V_69 ) , V_37 ) ;
if ( ! V_313 )
return - V_39 ;
memcpy ( V_313 , V_305 , sizeof( struct V_69 ) ) ;
V_313 -> V_309 [ V_313 -> V_306 ++ ] = V_312 ;
F_12 ( V_18 -> V_68 [ V_311 ] , V_313 ) ;
F_117 ( & V_18 -> V_50 ) ;
F_88 ( V_305 ) ;
return 0 ;
}
int F_295 ( struct V_18 * V_18 , enum V_310 V_311 ,
struct V_307 * V_312 )
{
int V_20 , V_34 ;
struct V_69 * V_313 , * V_305 ;
...
memcpy ( V_313 , V_305 , sizeof( struct V_69 ) ) ;
V_34 = - V_133 ;
for ( V_20 = 0 ; V_20 < V_313 -> V_306 ; V_20 ++ )
if ( V_313 -> V_309 [ V_20 ] == V_312 ) {
V_34 = 0 ;
V_313 -> V_309 [ V_20 ] = V_313 -> V_309 [ -- V_313 -> V_306 ] ;
break;
}
if ( V_34 ) {
F_88 ( V_313 ) ;
...
static int F_296 ( void * V_316 , T_10 * V_299 )
{
unsigned V_172 = ( long ) V_316 ;
struct V_18 * V_18 ;
* V_299 = 0 ;
F_83 ( & V_76 ) ;
F_297 ( V_18 , & V_77 , V_77 )
* V_299 += * ( T_6 * ) ( ( void * ) V_18 + V_172 ) ;
F_85 ( & V_76 ) ;
return 0 ;
}
static int F_298 ( void * V_316 , T_10 * V_299 )
{
unsigned V_172 = ( long ) V_316 ;
struct V_18 * V_18 ;
struct V_6 * V_7 ;
...
{
struct V_317 * V_249 ;
V_318 = F_300 ( L_8 , NULL ) ;
for ( V_249 = V_319 ; V_249 -> V_320 ; ++ V_249 )
V_249 -> V_321 = F_301 ( V_249 -> V_320 , 0444 , V_318 ,
...
static inline
struct V_6 * F_307 ( struct V_16 * V_324 )
{
return F_50 ( V_324 , struct V_6 , V_16 ) ;
}
static void F_308 ( struct V_16 * V_324 , int V_8 )
{
struct V_6 * V_7 = F_307 ( V_324 ) ;
F_17 ( V_7 , V_8 ) ;
}
static void F_309 ( struct V_16 * V_324 ,
struct V_149 * V_325 )
{
struct V_6 * V_7 = F_307 ( V_324 ) ;
F_21 ( V_7 ) ;
}
int F_310 ( void * V_326 , unsigned V_327 , unsigned V_328 ,
struct V_329 * V_329 )
{
int V_34 ;
int V_8 ;
...
F_316 ( & V_337 ) ;
if ( ! V_328 )
V_328 = F_317 ( struct V_6 ) ;
V_338 = F_318 ( L_9 , V_327 , V_328 ,
0 , NULL ) ;
if ( ! V_338 ) {
V_34 = - V_39 ;
goto V_339;
