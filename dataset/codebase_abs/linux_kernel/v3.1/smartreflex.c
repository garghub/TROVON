...
V_23 = F_28 ( V_33 , V_151 , 0 ) ;
F_57 ( & V_33 -> V_34 ) ;
F_58 ( & V_33 -> V_34 ) ;
V_19 -> V_33 = V_33 ;
V_19 -> V_152 = V_33 -> V_153 ;
V_19 -> V_18 = V_59 -> V_18 ;
V_19 -> V_98 = V_59 -> V_98 ;
V_19 -> V_99 = V_59 -> V_99 ;
...
V_147 = F_62 ( V_19 -> V_18 ) ;
if ( ! V_147 ) {
V_63 = - V_21 ;
goto V_156;
}
V_19 -> V_157 = F_63 ( L_35 , V_147 ) ;
if ( F_14 ( V_19 -> V_157 ) ) {
F_15 ( & V_33 -> V_34 , L_36 ,
V_20 ) ;
V_63 = F_64 ( V_19 -> V_157 ) ;
goto V_156;
}
( void ) F_65 ( L_37 , V_158 | V_159 ,
V_19 -> V_157 , ( void * ) V_19 , & V_160 ) ;
( void ) F_66 ( L_38 , V_158 , V_19 -> V_157 ,
& V_19 -> V_41 ) ;
( void ) F_66 ( L_39 , V_158 , V_19 -> V_157 ,
& V_19 -> V_43 ) ;
( void ) F_66 ( L_40 , V_158 , V_19 -> V_157 ,
& V_19 -> V_121 ) ;
V_148 = F_63 ( L_41 , V_19 -> V_157 ) ;
if ( F_14 ( V_148 ) ) {
F_15 ( & V_33 -> V_34 , L_42
L_43 , V_20 ) ;
V_63 = F_64 ( V_148 ) ;
...
char V_47 [ V_162 + 1 ] ;
snprintf ( V_47 , sizeof( V_47 ) , L_47 ,
V_134 [ V_97 ] . V_163 ) ;
( void ) F_66 ( V_47 , V_158 | V_159 , V_148 ,
...
static int T_6 F_69 ( struct V_145 * V_33 )
{
struct V_58 * V_59 = V_33 -> V_34 . V_60 ;
struct V_1 * V_19 ;
struct V_61 * V_62 ;
