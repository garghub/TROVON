...
if ( F_68 ( V_142 , V_149 , & V_144 ) < 0 ) {
F_21 ( & V_17 -> V_32 -> V_17 , L_65 ) ;
return - V_148 ;
}
F_69 ( V_142 , V_147 ) ;
...
static int F_71 ( struct V_16 * V_17 , void * V_48 ,
T_1 * V_49 , int V_50 )
{
struct V_151 * V_15 = V_48 ;
struct V_141 * V_152 = V_15 -> V_152 ;
struct V_6 * V_18 = (struct V_6 * ) V_152 -> V_2 ;
int V_153 = 0 ;
T_1 V_28 ;
T_1 V_154 ;
F_20 ( & V_17 -> V_32 -> V_17 , L_13 , V_41 ) ;
...
F_73 ( V_152 , V_147 ) ;
F_74 ( V_152 , V_152 -> V_121 - V_149 ) ;
V_15 -> V_157 ( V_15 -> V_158 , V_152 , 0 ) ;
F_75 ( V_15 ) ;
return 0 ;
error:
F_72 ( V_152 ) ;
V_15 -> V_157 ( V_15 -> V_158 , NULL , V_153 ) ;
F_75 ( V_15 ) ;
return 0 ;
}
int F_76 ( struct V_112 * V_112 , T_4 V_137 ,
struct V_141 * V_142 ,
T_5 V_157 ,
void * V_158 )
{
...
V_145 +
V_149 ;
V_152 = F_77 ( V_159 , V_53 ) ;
if ( ! V_152 ) {
V_20 = - V_148 ;
goto error;
}
V_18 = (struct V_6 * ) V_152 -> V_2 ;
V_42 = (struct V_6 * ) V_142 -> V_2 ;
V_15 = F_78 ( sizeof( struct V_151 ) , V_53 ) ;
if ( ! V_15 ) {
V_20 = - V_148 ;
goto V_160;
}
...
V_15 -> V_157 = V_157 ;
V_15 -> V_158 = V_158 ;
V_20 = F_31 ( V_17 , V_42 , V_18 , V_159 ,
F_71 , V_15 ,
V_53 ) ;
if ( V_20 ) {
F_21 ( & V_17 -> V_32 -> V_17 , L_40
...
static int F_80 ( struct V_16 * V_17 , T_1 V_162 , T_1 * V_163 ,
T_1 V_164 )
{
int V_20 ;
T_1 * V_49 ;
...
V_49 = F_16 ( V_17 -> V_42 ) ;
V_49 [ 0 ] = V_162 ;
memcpy ( & V_49 [ 1 ] , V_163 , V_164 ) ;
V_17 -> V_42 -> V_3 += ( 1 + V_164 ) ;
F_8 ( V_17 -> V_42 ) ;
V_20 = F_34 ( V_17 , V_17 -> V_42 , V_17 -> V_18 ,
V_17 -> V_125 ) ;
return V_20 ;
}
static int F_81 ( struct V_166 * V_32 ,
...
int V_5 ;
T_4 V_118 ;
V_17 = F_82 ( sizeof( * V_17 ) , V_53 ) ;
if ( ! V_17 )
return - V_148 ;
V_17 -> V_179 = F_83 ( F_84 ( V_32 ) ) ;
V_17 -> V_32 = V_32 ;
F_85 ( & V_17 -> V_25 , 1 ) ;
V_172 = V_32 -> V_180 ;
for ( V_5 = 0 ; V_5 < V_172 -> V_181 . V_182 ; ++ V_5 ) {
V_174 = & V_172 -> V_174 [ V_5 ] . V_181 ;
if ( ! V_177 && F_86 ( V_174 ) ) {
V_17 -> V_125 = F_87 ( V_174 -> V_183 ) ;
V_177 = V_174 -> V_184 ;
}
if ( ! V_178 && F_88 ( V_174 ) ) {
V_17 -> V_185 =
...
V_17 -> V_18 = F_78 ( V_17 -> V_125 , V_53 ) ;
V_17 -> V_34 = F_89 ( 0 , V_53 ) ;
V_17 -> V_42 = F_78 ( V_17 -> V_185 , V_53 ) ;
V_17 -> V_43 = F_89 ( 0 , V_53 ) ;
if ( ! V_17 -> V_18 || ! V_17 -> V_42 ||
! V_17 -> V_34 || ! V_17 -> V_43 )
goto error;
F_90 ( V_17 -> V_34 , V_17 -> V_179 ,
F_91 ( V_17 -> V_179 , V_177 ) ,
NULL , 0 , NULL , V_17 ) ;
F_90 ( V_17 -> V_43 , V_17 -> V_179 ,
F_92 ( V_17 -> V_179 , V_178 ) ,
NULL , 0 ,
F_37 , V_17 ) ;
F_93 ( & V_17 -> V_37 , F_15 , ( V_187 ) V_17 ) ;
F_94 ( V_32 , V_17 ) ;
F_5 ( V_17 -> V_42 , V_188 ) ;
F_8 ( V_17 -> V_42 ) ;
V_20 = F_34 ( V_17 , V_17 -> V_42 , V_17 -> V_18 ,
...
V_170 = (struct V_169 * )
F_16 ( V_17 -> V_18 ) ;
F_95 ( & V_17 -> V_32 -> V_17 , L_75
L_76 , V_170 -> V_190 , V_170 -> V_191 ) ;
V_118 = V_89
| V_71 | V_85
| V_73
| V_75 ;
V_17 -> V_112 = F_96 ( & V_192 , V_118 ) ;
if ( ! V_17 -> V_112 )
goto V_189;
F_97 ( V_17 -> V_112 , & V_32 -> V_17 ) ;
F_98 ( V_17 -> V_112 , V_17 ) ;
V_20 = F_99 ( V_17 -> V_112 ) ;
if ( V_20 )
goto V_193;
V_176 . V_194 = V_195 ;
V_176 . V_196 = 2 ;
V_176 . V_197 = V_198 ;
V_20 = F_80 ( V_17 , V_199 ,
( T_1 * ) & V_176 , sizeof( V_176 ) ) ;
if ( V_20 ) {
F_21 ( & V_17 -> V_32 -> V_17 , L_77
L_78 ) ;
goto V_193;
}
return 0 ;
...
static void F_103 ( struct V_166 * V_32 )
{
struct V_16 * V_17 ;
V_17 = F_104 ( V_32 ) ;
F_94 ( V_32 , NULL ) ;
