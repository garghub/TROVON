...
int V_62 , V_7 V_63 , struct V_64 * V_65 ,
unsigned int V_66 )
{
struct V_67 * V_68 ;
V_7 V_69 = V_65 -> V_70 ? V_65 -> V_70 -> V_71 : 0 ;
int V_72 = - V_73 ;
...
struct V_60 * F_38 ( struct V_83 * V_84 , T_3 V_85 , V_7 V_86 )
{
if ( V_84 ) {
struct V_60 * V_61 ;
F_39 (fa, fah, fa_list) {
...
V_10 -> V_24 = V_100 -> V_109 ;
V_10 -> V_27 = V_100 -> V_110 + 1 ;
V_105 = F_47 ( V_100 ) ;
if ( V_105 > 0 ) {
struct V_111 * V_112 , * V_113 = F_48 ( V_100 ) ;
V_112 = F_49 ( V_113 , V_105 , V_114 ) ;
V_10 -> V_25 = V_112 ? F_50 ( V_112 ) : 0 ;
#ifdef F_19
V_112 = F_49 ( V_113 , V_105 , V_115 ) ;
V_10 -> V_28 = V_112 ? F_51 ( V_112 ) : 0 ;
#endif
}
V_100 = F_45 ( V_100 , & V_101 ) ;
} F_8 ( V_4 ) ;
...
{
unsigned int V_32 = ( V_35 - 1 ) ;
return ( ( V_39 V_7 ) V_31 ^
( ( V_39 V_7 ) V_31 >> 7 ) ^
( ( V_39 V_7 ) V_31 >> 14 ) ) & V_32 ;
}
...
goto V_169;
if ( V_104 -> V_170 ) {
V_4 -> V_6 = F_65 ( sizeof( V_7 ) * V_47 , V_75 ) ;
if ( ! V_4 -> V_6 )
goto V_169;
} else
V_4 -> V_6 = ( V_7 * ) V_8 ;
...
goto V_167;
V_23 -> V_26 = V_178 ;
V_23 -> V_11 = F_80 ( V_121 , V_4 -> V_21 -> V_24 ) ;
V_72 = - V_129 ;
if ( V_23 -> V_11 == NULL )
goto V_169;
} else {
F_6 (fi) {
V_72 = F_53 ( V_104 , V_4 , V_10 ) ;
if ( V_72 != 0 )
goto V_169;
} F_8 (fi)
}
...
int F_33 ( struct V_67 * V_68 , V_7 V_77 , V_7 V_69 , int V_58 ,
V_7 V_63 , T_3 type , T_1 V_181 , int V_62 , T_3 V_85 ,
...
V_183 -> V_189 = V_190 ;
F_85 ( V_68 , V_191 , V_63 ) ;
V_183 -> V_192 = type ;
V_183 -> V_193 = V_4 -> V_48 ;
V_183 -> V_194 = V_4 -> V_38 ;
V_183 -> V_195 = V_4 -> V_37 ;
if ( V_183 -> V_186 )
F_86 ( V_68 , V_196 , V_181 ) ;
if ( V_4 -> V_40 )
F_85 ( V_68 , V_197 , V_4 -> V_40 ) ;
if ( F_87 ( V_68 , V_4 -> V_6 ) < 0 )
goto V_198;
if ( V_4 -> V_17 )
...
if ( V_10 -> V_29 & V_30 )
V_208 ++ ;
else if ( V_10 -> V_11 == V_51 &&
V_10 -> V_26 != V_140 ) {
V_10 -> V_29 |= V_30 ;
#ifdef F_18
F_12 ( & V_209 ) ;
V_4 -> V_210 -= V_10 -> V_211 ;
V_10 -> V_211 = 0 ;
F_15 ( & V_209 ) ;
#endif
V_208 ++ ;
