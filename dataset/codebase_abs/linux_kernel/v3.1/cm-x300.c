...
static void T_1 F_61 ( struct V_43 * V_44 , struct V_45 * V_46 ,
char * * V_47 , struct V_48 * V_49 )
{
for (; V_46 -> V_50 . V_51 ; V_46 = F_62 ( V_46 ) )
if ( V_46 -> V_50 . V_45 == V_52 &&
V_46 -> V_53 . V_54 . V_55 == 0x80000000 ) {
V_46 -> V_53 . V_54 . V_55 = 0xa0000000 ;
break;
}
}
