...
{
struct V_1 * V_2 = V_56 -> V_57 ;
memcpy ( & V_2 -> V_115 , & V_2 -> V_28 , sizeof( V_2 -> V_115 ) ) ;
}
...
{
struct V_1 * V_2 = V_56 -> V_57 ;
struct V_158 * V_159 = & V_56 -> V_160 ;
struct V_64 V_65 ;
T_8 V_161 ;
int V_36 , V_84 , V_19 , V_162 = 1 ;
F_9 ( L_14 , V_15 ) ;
switch ( V_159 -> V_39 ) {
case V_163 :
F_9 ( L_50 , V_15 ) ;
...
case V_171 :
F_9 ( L_53 , V_15 ) ;
if ( V_159 -> V_40 != V_172 && V_159 -> V_40 != V_164 ) {
F_9 ( L_51 ,
V_15 , V_159 -> V_40 ) ;
return - V_37 ;
}
switch ( V_159 -> V_173 ) {
case V_174 :
V_2 -> V_28 . V_165 = ( V_159 -> V_40 == V_164 )
? V_166 : V_175 ;
V_162 ++ ;
break;
case V_176 :
...
V_2 -> V_28 . V_42 = V_159 -> V_39 ;
V_2 -> V_28 . V_40 = V_159 -> V_40 ;
V_2 -> V_28 . V_183 = V_159 -> V_183 ;
V_2 -> V_28 . V_173 = V_159 -> V_173 ;
V_2 -> V_28 . V_167 = V_159 -> V_167 ;
V_19 = F_8 ( V_2 , V_159 -> V_26 ) ;
if ( V_19 != 0 )
return V_19 ;
V_19 = F_12 ( V_2 , V_159 -> V_39 , V_159 -> V_40 , V_159 -> V_184 ) ;
if ( V_19 != 0 )
return V_19 ;
V_19 = F_13 ( V_2 , V_159 -> V_54 ) ;
if ( V_19 != 0 )
return V_19 ;
F_27 ( V_56 ) ;
F_9 ( L_56 , V_15 , V_2 -> V_115 . V_42 ) ;
F_9 ( L_57 , V_15 , V_2 -> V_115 . V_40 ) ;
F_9 ( L_58 , V_15 , V_2 -> V_115 . V_183 ) ;
F_9 ( L_59 , V_15 ,
V_2 -> V_115 . V_173 , V_2 -> V_115 . V_165 ) ;
F_9 ( L_60 , V_15 , V_162 ) ;
F_9 ( L_61 , V_15 ,
V_2 -> V_115 . V_167 , V_2 -> V_115 . V_169 ) ;
F_9 ( L_62 , V_15 , V_2 -> V_115 . V_54 ) ;
F_9 ( L_63 , V_15 ,
V_2 -> V_115 . V_41 , V_2 -> V_115 . V_46 , V_2 -> V_115 . V_44 ) ;
F_9 ( L_64 , V_15 ,
V_2 -> V_115 . V_26 , V_2 -> V_115 . V_29 ) ;
if ( V_2 -> V_9 -> V_185 )
V_2 -> V_9 -> V_185 ( V_56 , 0 ) ;
V_65 . args [ 0x00 ] = V_186 ;
V_65 . args [ 0x01 ] = 0x01 ;
V_65 . V_12 = 0x02 ;
V_19 = F_18 ( V_56 , & V_65 ) ;
if ( V_19 != 0 )
return V_19 ;
V_65 . args [ 0x00 ] = V_187 ;
V_65 . args [ 0x01 ] = ( V_2 -> V_115 . V_183 & 0xff0000 ) >> 16 ;
V_65 . args [ 0x02 ] = ( V_2 -> V_115 . V_183 & 0x00ff00 ) >> 8 ;
V_65 . args [ 0x03 ] = ( V_2 -> V_115 . V_183 & 0x0000ff ) ;
V_65 . args [ 0x04 ] = ( ( V_2 -> V_115 . V_54 / 1000 ) & 0xff00 ) >> 8 ;
V_65 . args [ 0x05 ] = ( ( V_2 -> V_115 . V_54 / 1000 ) & 0x00ff ) ;
V_65 . args [ 0x06 ] = V_2 -> V_115 . V_29 ;
V_65 . args [ 0x07 ] = V_2 -> V_115 . V_44 | V_2 -> V_115 . V_165 ;
V_65 . args [ 0x08 ] = V_188 >> 8 ;
V_65 . args [ 0x09 ] = V_188 & 0xff ;
V_65 . args [ 0x0a ] = 0x00 ;
V_65 . args [ 0x0b ] = 0x00 ;
V_65 . args [ 0x0c ] = V_2 -> V_115 . V_169 ;
...
F_9 ( L_66 , V_15 ) ;
if ( V_2 -> V_115 . V_173 == V_174 )
V_65 . args [ 0x07 ] ^= V_175 ;
} while ( -- V_162 );
V_189:
V_65 . args [ 0x00 ] = V_186 ;
V_65 . args [ 0x01 ] = 0x00 ;
...
static int F_42 ( struct V_55 * V_56 , struct V_156 * V_190 ,
unsigned int V_191 , unsigned int * V_192 , T_8 * V_84 )
{
* V_192 = V_193 / 5 ;
if ( V_190 ) {
int V_19 = F_41 ( V_56 , V_190 ) ;
if ( V_19 )
return V_19 ;
}
