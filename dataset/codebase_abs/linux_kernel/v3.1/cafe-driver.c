...
V_38 = F_44 ( V_57 -> V_77 , F_32 , V_97 , L_9 , V_14 ) ;
if ( V_38 )
goto V_98;
F_28 ( V_7 ) ;
F_30 ( V_7 ) ;
...
static void F_49 ( struct V_1 * V_14 )
{
F_50 ( & V_14 -> V_7 ) ;
F_25 ( V_14 ) ;
F_46 ( V_14 -> V_57 -> V_77 , V_14 ) ;
F_47 ( V_14 -> V_57 , V_14 -> V_7 . V_95 ) ;
}
static void F_51 ( struct V_82 * V_57 )
{
struct V_2 * V_6 = F_52 ( & V_57 -> V_3 ) ;
struct V_1 * V_14 = F_1 ( V_6 ) ;
if ( V_14 == NULL ) {
F_24 ( V_100 L_10 , V_57 ) ;
return;
}
F_49 ( V_14 ) ;
F_27 ( V_14 ) ;
}
static int F_53 ( struct V_82 * V_57 , T_5 V_101 )
{
struct V_2 * V_6 = F_52 ( & V_57 -> V_3 ) ;
struct V_1 * V_14 = F_1 ( V_6 ) ;
int V_38 ;
...
static int F_56 ( struct V_82 * V_57 )
{
struct V_2 * V_6 = F_52 ( & V_57 -> V_3 ) ;
struct V_1 * V_14 = F_1 ( V_6 ) ;
int V_38 = 0 ;
