...
struct V_19 * V_78 = V_5 -> V_20 ;
struct V_67 * V_62 = V_5 -> V_62 ;
int V_24 = 0 ;
if ( ! V_63 -> V_64 -> V_79 )
V_63 -> V_64 -> V_79 = & V_80 ;
if ( ! V_63 -> V_64 -> V_81 )
V_63 -> V_64 -> V_81 = 0xffffffff ;
if ( V_78 -> V_82 -> V_83 . V_84 ) {
V_24 = F_30 ( V_62 ,
V_36 ) ;
if ( V_24 )
return V_24 ;
}
if ( V_78 -> V_82 -> V_85 . V_84 ) {
V_24 = F_30 ( V_62 ,
V_86 ) ;
if ( V_24 )
return V_24 ;
...
static int T_4 F_35 ( struct V_87 * V_88 )
{
return F_36 ( & V_88 -> V_64 , & V_89 ) ;
}
static int T_5 F_37 ( struct V_87 * V_88 )
{
F_38 ( & V_88 -> V_64 ) ;
return 0 ;
}
