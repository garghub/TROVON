...
V_37 . V_10 = V_10 ;
F_30 ( V_10 , & V_37 ) ;
V_37 . V_50 = F_31 ( V_69 , V_10 ,
& V_70 , V_71 ) ;
if ( F_32 ( V_37 . V_50 ) ) {
V_65 = F_33 ( V_37 . V_50 ) ;
goto V_72;
}
F_34 ( V_63 , F_35 ( & V_37 . V_50 -> V_10 ) ) ;
F_13 ( & V_6 ) ;
F_18 ( & V_37 , V_57 | V_47 ) ;
V_39 = F_4 ( V_45 ) ;
F_14 ( & V_6 ) ;
if ( ! ( V_39 & V_24 ) || ( V_39 & ( V_73 ) ) )
F_29 ( V_10 , L_8 ) ;
if ( V_64 ) {
V_65 = F_36 ( V_64 , F_23 ,
V_74 , F_35 ( & V_37 . V_50 -> V_10 ) ,
V_37 . V_50 ) ;
if ( V_65 < 0 ) {
F_29 ( V_10 , L_9 ,
V_64 , V_65 ) ;
...
static int F_43 ( struct V_9 * V_10 , T_5 V_76 )
{
struct V_37 * V_38 = F_12 ( V_10 ) ;
unsigned char V_77 ;
F_13 ( & V_6 ) ;
V_38 -> V_78 = V_77 = F_4 ( V_45 ) ;
if ( V_77 & ( V_57 | V_47 ) ) {
unsigned char V_51 ;
if ( F_44 ( V_10 ) )
V_51 = V_3 & ~ V_47 ;
...
{
return F_43 ( V_10 , V_80 ) ;
}
static int F_47 ( struct V_9 * V_10 )
{
struct V_37 * V_38 = F_12 ( V_10 ) ;
unsigned char V_77 = V_38 -> V_78 ;
if ( V_77 & V_3 ) {
unsigned char V_51 ;
if ( V_38 -> V_79 ) {
F_48 ( V_38 -> V_40 ) ;
...
static int T_3 F_49 ( struct V_82 * V_83 )
{
return F_26 ( & V_83 -> V_10 ,
F_50 ( V_83 , V_84 , 0 ) ,
F_51 ( V_83 , 0 ) ) ;
}
static int T_4 F_52 ( struct V_82 * V_83 )
{
F_41 ( & V_83 -> V_10 ) ;
return 0 ;
}
