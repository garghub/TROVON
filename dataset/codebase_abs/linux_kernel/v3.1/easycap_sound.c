...
struct V_1 * V_2 ;
struct V_106 * V_107 ;
int V_16 , V_108 , V_109 , V_110 , V_19 ;
int V_111 ;
if ( ! V_4 ) {
F_4 ( L_3 ) ;
return - V_51 ;
...
V_105 = F_36 ( V_107 , struct V_104 , V_106 ) ;
if ( V_105 && V_105 -> V_2 ) {
V_2 = V_105 -> V_2 ;
V_111 = V_105 -> V_111 ;
V_2 -> V_113 = 1 ;
V_2 -> V_93 = V_4 -> V_94 ;
V_2 -> V_114 = F_37 ( V_4 -> V_94 ,
V_4 -> V_115 ) ;
V_2 -> V_116 = V_117 ;
V_2 -> V_38 = V_4 -> V_118 [ V_111 ] . V_119 ;
V_2 -> V_120 = V_4 -> V_121 ;
V_2 -> V_122 = F_1 ;
V_2 -> V_24 = V_4 ;
V_2 -> V_123 = 0 ;
V_2 -> V_34 = V_4 -> V_124 ;
for ( V_16 = 0 ; V_16 < V_4 -> V_124 ; V_16 ++ ) {
V_2 -> V_35 [ V_16 ] . V_39 = V_16 * V_4 -> V_125 ;
V_2 -> V_35 [ V_16 ] . V_126 = V_4 -> V_125 ;
}
V_19 = F_8 ( V_2 , V_127 ) ;
if ( V_19 ) {
V_108 ++ ;
