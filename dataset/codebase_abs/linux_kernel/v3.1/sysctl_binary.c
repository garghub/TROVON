...
static void F_35 ( const int * V_37 , int V_38 )
{
int V_23 ;
...
static void F_38 ( const int * V_37 , int V_38 )
{
int V_23 ;
T_7 V_71 = V_72 ;
for ( V_23 = 0 ; V_23 < V_38 ; V_23 ++ )
...
static T_1 F_40 ( int T_2 * V_76 , int V_38 ,
void T_2 * V_2 , T_3 V_3 , void T_2 * V_4 , T_3 V_5 )
{
int V_37 [ V_77 ] ;
int V_23 ;
...
T_8 long F_41 ( struct V_78 T_2 * args )
{
struct V_78 V_54 ;
T_9 T_2 * V_79 ;
T_3 V_3 = 0 ;
T_1 V_7 ;
if ( F_42 ( & V_54 , args , sizeof( V_54 ) ) )
return - V_13 ;
...
return - V_13 ;
V_7 = F_40 ( F_43 ( V_54 . V_37 ) , V_54 . V_38 ,
F_43 ( V_54 . V_2 ) , V_3 ,
F_43 ( V_54 . V_4 ) , V_54 . V_5 ) ;
if ( V_7 >= 0 ) {
V_3 = V_7 ;
V_7 = 0 ;
}
