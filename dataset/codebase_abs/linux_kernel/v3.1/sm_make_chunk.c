...
V_415 = F_17 ( V_400 -> V_68 . V_14 ) ;
if ( V_415 < sizeof( V_376 ) +
sizeof( T_11 ) )
return 0 ;
break;
case V_407 :
...
V_416 = ( T_28 * ) V_381 -> V_6 -> V_152 ;
V_386 = F_96 ( V_416 -> V_386 ) ;
V_14 = sizeof( T_28 ) ;
...
V_105 -= V_14 ;
V_417 = F_135 ( V_19 , V_386 , V_105 * 4 ) ;
if ( ! V_417 )
goto V_419;
while ( V_105 > 0 ) {
...
static T_1 F_151 ( struct V_1 * V_417 ,
V_376 * V_400 ,
int V_425 )
{
V_376 * V_426 ;
...
V_399 = V_428 ;
V_427 = F_17 ( V_417 -> V_139 -> V_14 ) -
sizeof( T_20 ) ;
V_14 = sizeof( T_28 ) ;
V_426 = ( V_376 * ) ( V_417 -> V_6 -> V_152 +
V_14 ) ;
V_427 -= V_14 ;
while ( V_427 > 0 ) {
if ( V_426 -> V_398 == V_400 -> V_398 ) {
switch( V_426 -> V_68 . type ) {
case V_407 :
return V_406 ;
case V_408 :
V_14 = sizeof( V_376 ) ;
V_402 = ( void * ) V_426 + V_14 ;
V_427 -= V_14 ;
if ( V_427 > 0 )
return V_402 -> V_13 ;
else
...
V_14 = F_17 ( V_426 -> V_68 . V_14 ) ;
V_426 = ( void * ) V_426 + V_14 ;
V_427 -= V_14 ;
}
return V_399 ;
}
...
struct V_1 * V_417 )
{
struct V_1 * V_381 = V_19 -> V_429 ;
union V_357 * V_358 ;
V_376 * V_400 ;
int V_14 = 0 ;
int V_430 = V_381 -> V_6 -> V_12 ;
int V_418 = 0 ;
int V_425 = 1 ;
int V_28 = 0 ;
T_1 V_399 = V_406 ;
...
T_2 V_138 ;
int V_300 ;
V_138 = ( V_434 + 1 ) * sizeof( T_13 ) ;
V_28 = F_18 ( V_19 , V_304 , 0 , V_138 ) ;
if ( ! V_28 )
return NULL ;
V_438 . V_433 = F_13 ( V_433 ) ;
V_28 -> V_15 . V_440 =
F_7 ( V_28 , sizeof( V_438 ) , & V_438 ) ;
for ( V_300 = 0 ; V_300 < V_434 ; V_300 ++ ) {
V_439 . V_107 = V_436 [ V_300 ] . V_107 ;
V_439 . V_102 = V_436 [ V_300 ] . V_102 ;
F_7 ( V_28 , sizeof( V_439 ) , & V_439 ) ;
}
return V_28 ;
}
