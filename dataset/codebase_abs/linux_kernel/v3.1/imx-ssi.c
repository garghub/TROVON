...
{
struct V_132 * V_123 = V_131 -> V_123 -> V_132 ;
struct V_1 * V_82 = V_131 -> V_2 ;
struct V_113 * V_114 = V_131 -> V_114 ;
int V_108 = 0 ;
if ( ! V_123 -> V_121 -> V_133 )
V_123 -> V_121 -> V_133 = & V_134 ;
if ( ! V_123 -> V_121 -> V_135 )
V_123 -> V_121 -> V_135 = F_21 ( 32 ) ;
if ( V_82 -> V_136 -> V_137 . V_138 ) {
V_108 = F_18 ( V_114 ,
V_74 ) ;
if ( V_108 )
goto V_139;
}
if ( V_82 -> V_136 -> V_140 . V_138 ) {
V_108 = F_18 ( V_114 ,
V_141 ) ;
if ( V_108 )
goto V_139;
...
T_3 V_142 ;
F_26 ( V_82 , V_8 ) ;
V_142 = F_27 ( V_8 -> V_75 . V_143 ) |
F_28 ( V_8 -> V_76 . V_143 ) ;
F_5 ( V_142 , V_8 -> V_10 + V_144 ) ;
return 0 ;
}
...
F_5 ( F_33 ( 3 ) , V_10 + V_145 ) ;
F_5 ( V_20 | V_21 | V_99 |
V_96 | V_97 ,
V_10 + V_19 ) ;
F_5 ( V_146 , V_10 + V_147 ) ;
F_5 ( 0xff , V_10 + V_148 ) ;
F_5 ( 0x300 , V_10 + V_149 ) ;
}
static void F_34 ( struct V_150 * V_151 , unsigned short V_72 ,
unsigned short V_142 )
{
struct V_7 * V_7 = V_152 ;
void T_4 * V_10 = V_7 -> V_10 ;
unsigned int V_153 ;
unsigned int V_154 ;
if ( V_72 > 0x7f )
return;
F_17 ( L_2 , V_112 , V_72 , V_142 ) ;
V_153 = V_72 << 12 ;
F_5 ( V_153 , V_10 + V_155 ) ;
V_154 = V_142 << 4 ;
F_5 ( V_154 , V_10 + V_156 ) ;
F_5 ( V_146 | V_157 , V_10 + V_147 ) ;
F_35 ( 100 ) ;
}
static unsigned short F_36 ( struct V_150 * V_151 ,
unsigned short V_72 )
{
struct V_7 * V_7 = V_152 ;
void T_4 * V_10 = V_7 -> V_10 ;
unsigned short V_142 = - 1 ;
unsigned int V_153 ;
V_153 = ( V_72 & 0x7f ) << 12 ;
F_5 ( V_153 , V_10 + V_155 ) ;
F_5 ( V_146 | V_158 , V_10 + V_147 ) ;
F_35 ( 100 ) ;
V_142 = ( F_3 ( V_10 + V_156 ) >> 4 ) & 0xffff ;
F_17 ( L_2 , V_112 , V_72 , V_142 ) ;
return V_142 ;
}
static void F_37 ( struct V_150 * V_151 )
{
struct V_7 * V_7 = V_152 ;
if ( V_7 -> V_159 )
V_7 -> V_159 ( V_151 ) ;
}
static void F_38 ( struct V_150 * V_151 )
{
struct V_7 * V_7 = V_152 ;
if ( V_7 -> V_160 )
V_7 -> V_160 ( V_151 ) ;
...
struct V_163 * V_164 ;
struct V_7 * V_8 ;
struct V_165 * V_166 = V_162 -> V_121 . V_167 ;
int V_108 = 0 ;
struct V_168 * V_82 ;
V_8 = F_40 ( sizeof( * V_8 ) , V_127 ) ;
if ( ! V_8 )
return - V_128 ;
F_41 ( & V_162 -> V_121 , V_8 ) ;
if ( V_166 ) {
V_8 -> V_159 = V_166 -> V_159 ;
V_8 -> V_160 = V_166 -> V_160 ;
V_8 -> V_27 = V_166 -> V_27 ;
}
V_8 -> V_169 = F_42 ( V_162 , 0 ) ;
V_8 -> V_170 = F_43 ( & V_162 -> V_121 , NULL ) ;
if ( F_44 ( V_8 -> V_170 ) ) {
V_108 = F_45 ( V_8 -> V_170 ) ;
F_46 ( & V_162 -> V_121 , L_3 ,
V_108 ) ;
goto V_171;
}
F_47 ( V_8 -> V_170 ) ;
V_164 = F_48 ( V_162 , V_172 , 0 ) ;
if ( ! V_164 ) {
V_108 = - V_173 ;
goto V_174;
}
if ( ! F_49 ( V_164 -> V_175 , F_50 ( V_164 ) , V_176 ) ) {
F_46 ( & V_162 -> V_121 , L_4 ) ;
V_108 = - V_177 ;
goto V_174;
}
V_8 -> V_10 = F_51 ( V_164 -> V_175 , F_50 ( V_164 ) ) ;
if ( ! V_8 -> V_10 ) {
F_46 ( & V_162 -> V_121 , L_5 ) ;
V_108 = - V_173 ;
goto V_178;
}
if ( V_8 -> V_27 & V_103 ) {
...
V_8 -> V_76 . V_110 = V_164 -> V_175 + V_182 ;
V_8 -> V_75 . V_110 = V_164 -> V_175 + V_183 ;
V_8 -> V_75 . V_143 = 4 ;
V_8 -> V_76 . V_143 = 4 ;
V_164 = F_52 ( V_162 , V_184 , L_6 ) ;
if ( V_164 )
V_8 -> V_75 . V_185 = V_164 -> V_175 ;
V_164 = F_52 ( V_162 , V_184 , L_7 ) ;
if ( V_164 )
V_8 -> V_76 . V_185 = V_164 -> V_175 ;
F_53 ( V_162 , V_8 ) ;
V_108 = F_54 ( & V_162 -> V_121 , V_82 ) ;
if ( V_108 ) {
F_46 ( & V_162 -> V_121 , L_8 ) ;
goto V_186;
}
V_8 -> V_187 = F_55 ( L_9 , V_162 -> V_188 ) ;
if ( ! V_8 -> V_187 ) {
V_108 = - V_128 ;
goto V_189;
}
...
if ( V_108 ) {
F_46 ( & V_162 -> V_121 , L_10 ) ;
goto V_190;
}
V_8 -> V_191 = F_55 ( L_11 , V_162 -> V_188 ) ;
if ( ! V_8 -> V_191 ) {
V_108 = - V_128 ;
goto V_192;
}
F_53 ( V_8 -> V_191 , V_8 ) ;
V_108 = F_56 ( V_8 -> V_191 ) ;
if ( V_108 ) {
F_46 ( & V_162 -> V_121 , L_10 ) ;
goto V_193;
}
...
static int T_5 F_65 ( struct V_161 * V_162 )
{
struct V_163 * V_164 = F_48 ( V_162 , V_172 , 0 ) ;
struct V_7 * V_8 = F_66 ( V_162 ) ;
F_67 ( V_8 -> V_191 ) ;
F_67 ( V_8 -> V_187 ) ;
F_59 ( & V_162 -> V_121 ) ;
if ( V_8 -> V_27 & V_103 )
