...
static int F_49 ( struct V_80 * V_81 , struct V_42 * V_42 )
{
struct V_2 * V_2 = V_81 -> V_82 ;
if ( ! F_48 ( V_2 , V_42 ) ) {
F_7 ( V_2 , & V_2 -> V_23 . V_83 ) ;
F_47 ( V_42 ) ;
return 0 ;
}
if ( F_16 ( ! V_2 -> V_84 ) && F_50 ( V_2 ) ) {
F_47 ( V_42 ) ;
return 0 ;
}
...
F_13 ( V_2 , V_88 << V_86 ) ;
V_2 -> V_58 = F_58 ( V_89 , V_49 ) ;
if ( ! V_2 -> V_58 ) {
F_31 ( L_19 ) ;
V_43 = - V_50 ;
goto V_90;
}
V_2 -> V_57 = ( void * ) F_59 ( V_91 , 1 ) ;
if ( ! V_2 -> V_57 ) {
F_31 ( L_20 ) ;
V_43 = - V_50 ;
goto V_90;
...
F_61 ( V_2 -> V_92 , V_2 -> V_16 >> V_73 ) ;
F_62 ( V_93 , V_2 -> V_92 -> V_81 ) ;
V_2 -> V_30 = F_63 () ;
if ( ! V_2 -> V_30 ) {
F_31 ( L_22 ) ;
V_43 = - V_50 ;
...
void F_64 ( struct V_94 * V_95 , unsigned long V_6 )
{
struct V_2 * V_2 ;
V_2 = V_95 -> V_96 -> V_97 ;
F_15 ( V_2 , V_6 ) ;
F_7 ( V_2 , & V_2 -> V_23 . V_98 ) ;
}
static int F_65 ( struct V_2 * V_2 , int V_99 )
{
int V_43 = 0 ;
F_66 ( & V_2 -> V_66 ) ;
F_67 ( & V_2 -> V_85 ) ;
...
V_2 -> V_92 -> V_81 = V_2 -> V_81 ;
V_2 -> V_92 -> V_97 = V_2 ;
snprintf ( V_2 -> V_92 -> V_105 , 16 , L_27 , V_99 ) ;
F_61 ( V_2 -> V_92 , 0 ) ;
F_74 ( V_2 -> V_92 -> V_81 , V_14 ) ;
F_75 ( V_2 -> V_92 -> V_81 ,
V_79 ) ;
F_76 ( V_2 -> V_92 -> V_81 , V_14 ) ;
F_77 ( V_2 -> V_92 -> V_81 , V_14 ) ;
F_78 ( V_2 -> V_92 ) ;
V_43 = F_79 ( & F_80 ( V_2 -> V_92 ) -> V_106 ,
& V_107 ) ;
if ( V_43 < 0 ) {
F_73 ( L_28 ) ;
goto V_27;
...
F_14 ( L_33 , V_109 ) ;
V_113 = F_58 ( V_109 * sizeof( struct V_2 ) , V_49 ) ;
if ( ! V_113 ) {
V_43 = - V_50 ;
goto V_114;
}
for ( V_108 = 0 ; V_108 < V_109 ; V_108 ++ ) {
V_43 = F_65 ( & V_113 [ V_108 ] , V_108 ) ;
if ( V_43 )
goto V_115;
}
return 0 ;
