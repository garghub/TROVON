...
F_87 ( ( char * ) V_228 -> V_229 , V_17 -> V_21 -> V_36 ,
sizeof V_228 -> V_229 ) ;
if ( V_17 -> V_31 -> V_230 != NULL ) {
F_87 ( ( char * ) V_228 -> V_231 , V_17 -> V_31 -> V_230 ,
sizeof V_228 -> V_231 ) ;
} else {
...
V_65 < V_17 -> V_21 -> V_175 ;
V_65 ++ , V_174 ++ ) {
if ( V_17 -> V_240 & ( 1 << V_65 ) )
continue;
if ( V_37 == V_174 -> V_241 . V_37 )
return V_65 ;
}
return - 1 ;
}
...
if ( V_17 -> V_240 & ( 1 << V_65 ) )
continue;
if ( V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_37 < V_37 )
continue;
if ( V_244 >= 0
&& V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_37
> V_17 -> V_21 -> V_174 [ V_244 ] . V_241 . V_37 )
continue;
V_244 = V_65 ;
}
} else {
V_244 = F_88 ( V_17 , V_37 ) ;
}
if ( V_244 < 0 )
return - V_49 ;
V_174 = & V_17 -> V_21 -> V_174 [ V_244 ] ;
memcpy ( V_243 , & V_174 -> V_241 , sizeof *V_243 ) ;
if ( V_17 -> V_85 . V_174 != NULL ) {
V_168 = & V_17 -> V_85 . V_174 [ V_244 ] ;
V_243 -> V_247 = V_168 -> V_177 ;
V_243 -> V_248 = V_168 -> V_249 ;
V_243 -> V_250 = V_168 -> V_251 ;
}
if ( V_17 -> V_252 & ( 1 << V_244 ) )
V_243 -> V_14 |= V_253 ;
return 0 ;
}
...
if ( V_17 -> V_85 . V_174 != NULL ) {
V_168 = & V_17 -> V_85 . V_174 [ V_244 ] ;
if ( V_169 -> V_255 < V_168 -> V_249
|| V_169 -> V_255 > V_168 -> V_251 )
return - V_256 ;
} else {
V_168 = NULL ;
if ( V_169 -> V_255 < V_174 -> V_241 . V_248
|| V_169 -> V_255 > V_174 -> V_241 . V_250 )
return - V_256 ;
}
F_2 ( V_5 , L_43 , V_169 -> V_37 , V_169 -> V_255 ) ;
if ( F_57 ( & V_17 -> V_157 ) )
return - V_158 ;
if ( ! V_17 -> V_132 ) {
V_19 = - V_28 ;
...
V_17 -> V_160 = 0 ;
if ( V_174 -> V_257 != NULL ) {
V_19 = V_174 -> V_257 ( V_17 , V_169 -> V_255 ) ;
goto V_163;
}
if ( V_168 != NULL ) {
V_168 -> V_176 = V_169 -> V_255 ;
if ( V_174 -> V_258 != NULL
&& V_17 -> V_84 )
V_174 -> V_258 ( V_17 ) ;
}
...
V_17 -> V_160 = 0 ;
if ( V_174 -> V_259 != NULL ) {
V_19 = V_174 -> V_259 ( V_17 , & V_169 -> V_255 ) ;
goto V_163;
}
if ( V_17 -> V_85 . V_174 != NULL )
V_169 -> V_255 = V_17 -> V_85 . V_174 [ V_244 ] . V_176 ;
V_19 = 0 ;
V_163:
F_60 ( & V_17 -> V_157 ) ;
return V_19 ;
...
if ( ! V_17 -> V_21 -> V_262 )
return - V_49 ;
return V_17 -> V_21 -> V_262 ( V_17 , V_261 ) ;
}
static int F_93 ( struct V_112 * V_112 , void * V_181 ,
struct V_263 * V_264 )
{
struct V_17 * V_17 = V_181 ;
if ( V_264 -> V_122 != 0 )
return - V_49 ;
V_264 -> type = V_265 ;
V_264 -> V_20 = V_17 -> V_85 . V_266 ;
F_87 ( V_264 -> V_36 , V_17 -> V_21 -> V_36 ,
sizeof V_264 -> V_36 ) ;
return 0 ;
}
...
static int F_95 ( struct V_112 * V_112 , void * V_181 , unsigned int V_65 )
{
if ( V_65 > 0 )
return - V_49 ;
return ( 0 ) ;
...
if ( V_268 -> V_115 == 0 )
goto V_163;
V_19 = F_42 ( V_17 , V_112 , V_268 -> V_114 , V_268 -> V_115 ) ;
if ( V_19 == 0 ) {
V_268 -> V_115 = V_17 -> V_121 ;
if ( V_84 )
V_19 = F_56 ( V_17 ) ;
}
V_163:
F_60 ( & V_17 -> V_199 ) ;
F_2 ( V_6 , L_44 , V_19 , V_268 -> V_115 ) ;
return V_19 ;
}
...
V_17 -> V_160 = 0 ;
if ( V_17 -> V_132 )
V_19 = V_17 -> V_21 -> V_277 ( V_17 , V_276 ) ;
else
V_19 = - V_28 ;
F_60 ( & V_17 -> V_157 ) ;
return V_19 ;
}
static int F_101 ( struct V_112 * V_112 , void * V_181 ,
struct V_275 * V_276 )
{
struct V_17 * V_17 = V_181 ;
int V_19 ;
...
V_17 -> V_160 = 0 ;
if ( V_17 -> V_132 )
V_19 = V_17 -> V_21 -> V_278 ( V_17 , V_276 ) ;
else
V_19 = - V_28 ;
F_60 ( & V_17 -> V_157 ) ;
return V_19 ;
...
{
struct V_17 * V_17 = V_181 ;
V_280 -> V_280 . V_281 . V_282 = V_17 -> V_283 ;
if ( V_17 -> V_21 -> V_284 ) {
int V_19 ;
if ( F_57 ( & V_17 -> V_157 ) )
return - V_158 ;
...
static int F_103 ( struct V_112 * V_206 , void * V_181 ,
struct V_279 * V_280 )
{
struct V_17 * V_17 = V_181 ;
int V_146 ;
V_146 = V_280 -> V_280 . V_281 . V_282 ;
...
static int F_104 ( struct V_112 * V_112 , struct V_7 * V_8 )
{
struct V_17 * V_17 = V_112 -> V_222 ;
struct V_9 * V_10 ;
struct V_286 * V_286 ;
unsigned long V_287 , V_165 , V_288 ;
int V_65 , V_19 ;
V_165 = V_8 -> V_289 ;
V_288 = V_8 -> V_290 - V_8 -> V_289 ;
F_2 ( V_6 , L_46 , ( int ) V_165 , ( int ) V_288 ) ;
if ( F_57 ( & V_17 -> V_199 ) )
return - V_158 ;
if ( ! V_17 -> V_132 ) {
V_19 = - V_28 ;
...
V_10 = NULL ;
for ( V_65 = 0 ; V_65 < V_17 -> V_121 ; ++ V_65 ) {
if ( V_17 -> V_10 [ V_65 ] . V_13 . V_114 != V_270 ) {
F_2 ( V_6 , L_47 ) ;
break;
}
if ( ( V_17 -> V_10 [ V_65 ] . V_13 . V_127 . V_83 >> V_291 )
== V_8 -> V_292 ) {
V_10 = & V_17 -> V_10 [ V_65 ] ;
break;
}
...
if ( V_288 != V_10 -> V_13 . V_126 ) {
F_2 ( V_6 , L_49 ) ;
V_19 = - V_49 ;
goto V_163;
}
V_8 -> V_293 |= V_294 ;
V_287 = ( unsigned long ) V_10 -> V_71 ;
while ( V_288 > 0 ) {
V_286 = F_105 ( ( void * ) V_287 ) ;
V_19 = F_106 ( V_8 , V_165 , V_286 ) ;
if ( V_19 < 0 )
goto V_163;
V_165 += V_295 ;
V_287 += V_295 ;
...
static int F_108 ( struct V_17 * V_17 , struct V_112 * V_112 ,
enum V_113 V_114 )
{
int V_19 ;
if ( F_57 ( & V_17 -> V_199 ) )
return - V_158 ;
V_19 = F_107 ( V_17 , V_112 , V_114 ) ;
F_60 ( & V_17 -> V_199 ) ;
return V_19 ;
}
static int F_109 ( struct V_112 * V_112 , void * V_181 ,
struct V_272 * V_13 )
{
struct V_17 * V_17 = V_181 ;
struct V_9 * V_10 ;
...
return - V_158 ;
for (; ; ) {
V_19 = F_107 ( V_17 , V_112 , V_13 -> V_114 ) ;
if ( V_19 < 0 )
goto V_163;
if ( V_19 > 0 )
break;
F_60 ( & V_17 -> V_199 ) ;
if ( V_112 -> V_298 & V_299 )
return - V_300 ;
V_19 = F_110 ( V_17 -> V_104 ,
F_108 ( V_17 , V_112 , V_13 -> V_114 ) ,
F_111 ( 3000 ) ) ;
if ( V_19 < 0 )
return V_19 ;
if ( V_19 == 0 )
...
V_19 = 0 ;
if ( V_17 -> V_114 == V_271 ) {
if ( F_112 ( ( V_302 V_303 * ) V_10 -> V_13 . V_127 . V_304 ,
V_10 -> V_71 ,
V_10 -> V_13 . V_100 ) ) {
F_2 ( V_25 | V_6 ,
L_52 ) ;
...
static int F_113 ( struct V_112 * V_112 , void * V_181 ,
struct V_272 * V_13 )
{
struct V_17 * V_17 = V_181 ;
struct V_9 * V_10 ;
...
if ( V_10 -> V_13 . V_14 & V_306 ) {
F_2 ( V_105 , L_56 ) ;
V_19 = - V_49 ;
goto V_163;
}
V_10 -> V_13 . V_14 |= V_102 ;
if ( V_10 -> V_13 . V_114 == V_271 ) {
V_10 -> V_13 . V_127 . V_304 = V_13 -> V_127 . V_304 ;
...
V_268 . V_115 = V_17 -> V_283 ;
V_268 . type = V_123 ;
V_268 . V_114 = V_269 ;
V_19 = F_96 ( V_112 , V_17 , & V_268 ) ;
if ( V_19 != 0 ) {
F_2 ( V_6 , L_58 , V_19 ) ;
return V_19 ;
}
...
V_13 . type = V_123 ;
V_13 . V_114 = V_269 ;
for ( V_65 = 0 ; V_65 < V_17 -> V_283 ; V_65 ++ ) {
V_13 . V_122 = V_65 ;
V_19 = F_113 ( V_112 , V_17 , & V_13 ) ;
if ( V_19 != 0 ) {
F_2 ( V_6 , L_59 , V_19 ) ;
return V_19 ;
}
...
V_19 = F_98 ( V_112 , V_17 , V_123 ) ;
if ( V_19 != 0 )
F_2 ( V_6 , L_60 , V_19 ) ;
return V_19 ;
}
static unsigned int F_115 ( struct V_112 * V_112 , T_5 * V_307 )
{
struct V_17 * V_17 = V_112 -> V_222 ;
int V_19 ;
F_2 ( V_105 , L_61 ) ;
F_116 ( V_112 , & V_17 -> V_104 , V_307 ) ;
if ( V_17 -> V_114 == V_129 ) {
V_19 = F_114 ( V_17 , V_112 ) ;
if ( V_19 != 0 )
return V_308 ;
}
...
static T_6 F_117 ( struct V_112 * V_112 , char V_303 * V_71 ,
T_7 V_115 , T_8 * V_312 )
{
struct V_17 * V_17 = V_112 -> V_222 ;
struct V_9 * V_10 ;
...
if ( -- V_146 < 0 )
break;
if ( V_10 -> V_13 . V_95 . V_315 >= V_95 . V_315 )
break;
V_19 = F_113 ( V_112 , V_17 , & V_13 ) ;
if ( V_19 != 0 ) {
F_2 ( V_6 , L_64 , V_19 ) ;
...
V_19 = F_112 ( V_71 , V_10 -> V_71 , V_115 ) ;
if ( V_19 != 0 ) {
F_2 ( V_25 | V_6 ,
L_65 , V_19 , V_115 ) ;
V_19 = - V_305 ;
...
V_65 < V_17 -> V_21 -> V_175 ;
V_65 ++ , V_169 ++ ) {
V_169 -> V_177 = V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_247 ;
V_169 -> V_176 = V_169 -> V_177 ;
V_169 -> V_249 = V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_248 ;
V_169 -> V_251 = V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_250 ;
}
}
int F_119 ( struct V_61 * V_62 ,
const struct V_316 * V_37 ,
const struct V_21 * V_21 ,
int V_317 ,
struct V_221 * V_221 )
{
struct V_17 * V_17 ;
struct V_47 * V_31 = F_120 ( V_62 ) ;
int V_19 ;
F_2 ( V_217 , L_66 , V_37 -> V_233 , V_37 -> V_234 ) ;
if ( V_317 < sizeof *V_17 )
V_317 = sizeof *V_17 ;
V_17 = F_121 ( V_317 , V_53 ) ;
if ( ! V_17 ) {
F_7 ( L_67 ) ;
return - V_34 ;
}
V_17 -> V_218 = F_122 ( V_318 , V_53 ) ;
if ( ! V_17 -> V_218 ) {
F_7 ( L_68 ) ;
V_19 = - V_34 ;
goto V_163;
...
V_17 -> V_31 = V_31 ;
V_17 -> V_66 = V_62 -> V_67 -> V_68 . V_319 ;
V_17 -> V_144 = V_62 -> V_320 ;
if ( V_31 -> V_321 -> V_68 . V_322 != 1 ) {
int V_65 ;
struct V_61 * V_323 ;
for ( V_65 = 0 ; V_65 < V_31 -> V_321 -> V_68 . V_322 ; V_65 ++ ) {
V_323 = V_31 -> V_321 -> V_324 [ V_65 ] ;
if ( V_323 != NULL
&& V_323 -> V_145 != NULL
&& V_323 -> V_145 -> V_68 . V_325 ==
V_326 ) {
V_17 -> V_327 = 1 ;
break;
}
...
V_17 -> V_283 = 2 ;
V_17 -> V_82 = - 1 ;
V_19 = V_21 -> V_321 ( V_17 , V_37 ) ;
if ( V_19 < 0 )
goto V_163;
if ( V_17 -> V_85 . V_174 != NULL )
F_118 ( V_17 ) ;
V_19 = V_21 -> V_328 ( V_17 ) ;
if ( V_19 < 0 )
goto V_163;
F_61 ( V_17 ) ;
V_19 = F_8 ( V_17 ) ;
...
F_123 ( & V_17 -> V_199 ) ;
F_124 ( & V_17 -> V_104 ) ;
memcpy ( & V_17 -> V_216 , & V_329 , sizeof V_329 ) ;
V_17 -> V_216 . V_42 = & V_62 -> V_31 ;
V_17 -> V_221 = V_221 ;
V_17 -> V_132 = 1 ;
V_19 = F_125 ( & V_17 -> V_216 ,
V_330 ,
- 1 ) ;
if ( V_19 < 0 ) {
F_7 ( L_69 , V_19 ) ;
...
{
struct V_47 * V_31 = F_120 ( V_62 ) ;
if ( V_31 -> V_232 . V_333 != 1 ) {
F_7 ( L_71 ,
V_37 -> V_233 , V_37 -> V_234 ) ;
return - V_28 ;
}
if ( V_31 -> V_321 -> V_68 . V_322 != 1
&& V_62 -> V_67 -> V_68 . V_319 != 0 )
return - V_28 ;
return F_119 ( V_62 , V_37 , V_21 , V_317 , V_221 ) ;
}
void F_130 ( struct V_61 * V_62 )
{
struct V_17 * V_17 = F_131 ( V_62 ) ;
#if F_127 ( V_331 ) || F_127 ( V_332 )
struct V_32 * V_32 ;
#endif
F_2 ( V_217 , L_72 ,
...
int F_133 ( struct V_61 * V_62 , T_9 V_334 )
{
struct V_17 * V_17 = F_131 ( V_62 ) ;
if ( ! V_17 -> V_84 )
return 0 ;
...
struct V_17 * V_17 = F_131 ( V_62 ) ;
V_17 -> V_75 = 0 ;
V_17 -> V_21 -> V_328 ( V_17 ) ;
F_25 ( V_17 ) ;
if ( V_17 -> V_84 )
return F_56 ( V_17 ) ;
return 0 ;
}
int F_135 ( struct V_17 * V_17 , int V_335 ,
int V_336 , int V_337 , int V_338 , int V_339 )
{
int V_65 , V_340 , V_341 , V_342 , V_343 , V_344 , V_345 ;
const struct V_169 * V_346 = NULL ;
const struct V_169 * V_347 = NULL ;
const struct V_169 * V_348 = NULL ;
int V_349 = 0 ;
for ( V_65 = 0 ; V_65 < V_17 -> V_21 -> V_175 ; V_65 ++ ) {
if ( V_17 -> V_240 & ( 1 << V_65 ) )
continue;
if ( V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_37 == V_350 )
V_346 = & V_17 -> V_21 -> V_174 [ V_65 ] ;
if ( V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_37 == V_351 )
V_347 = & V_17 -> V_21 -> V_174 [ V_65 ] ;
if ( V_17 -> V_21 -> V_174 [ V_65 ] . V_241 . V_37 == V_352 )
...
if ( V_346 -> V_259 ( V_17 , & V_341 ) ||
V_347 -> V_259 ( V_17 , & V_343 ) ||
V_348 -> V_259 ( V_17 , & V_345 ) || ! V_345 )
return 0 ;
V_342 = V_341 ;
V_344 = V_343 ;
V_340 = abs ( V_336 - V_335 ) / V_337 ;
F_2 ( V_105 , L_75 ,
V_335 , V_336 , V_340 ) ;
for ( V_65 = 0 ; V_65 < V_340 ; V_65 ++ ) {
if ( V_335 > V_336 ) {
if ( V_341 > V_338 )
V_341 -- ;
else if ( V_343 > V_339 )
V_343 -- ;
else if ( V_341 > V_346 -> V_241 . V_247 )
V_341 -- ;
else if ( V_343 > V_347 -> V_241 . V_248 )
V_343 -- ;
else if ( V_341 > V_346 -> V_241 . V_248 )
V_341 -- ;
else
break;
} else {
if ( V_341 < V_346 -> V_241 . V_247 )
V_341 ++ ;
else if ( V_343 < V_339 )
V_343 ++ ;
else if ( V_341 < V_338 )
V_341 ++ ;
else if ( V_343 < V_347 -> V_241 . V_250 )
V_343 ++ ;
else if ( V_341 < V_346 -> V_241 . V_250 )
V_341 ++ ;
else
break;
}
...
if ( V_341 != V_342 ) {
V_346 -> V_257 ( V_17 , V_341 ) ;
V_349 = 1 ;
}
if ( V_343 != V_344 ) {
V_347 -> V_257 ( V_17 , V_343 ) ;
V_349 = 1 ;
}
return V_349 ;
}
