...
V_85 = F_5 ( V_2 + V_86 ) ;
F_19 ( ( V_85 & ~ 0x3F ) , V_2 + V_86 ) ;
F_3 ( L_66 , F_5 ( V_2 + V_161 ) ) ;
F_19 ( 0x01000000 , V_2 + V_161 ) ;
...
static int F_70 ( struct V_162 * V_163 )
{
int V_164 = - V_165 ;
void T_1 * V_2 = NULL ;
void T_1 * V_78 = NULL ;
...
struct V_155 * V_46 ;
T_2 V_85 ;
struct F_44 V_166 = V_167 [ 0 ] ;
const struct F_44 * V_168 [] = { & V_166 , NULL } ;
F_71 ( & V_163 -> V_53 , L_67 ) ;
V_2 = F_72 ( V_163 -> V_53 . V_169 , 0 ) ;
if ( ! V_2 )
goto V_170;
V_78 = V_2 + 0x100 ;
V_72 = V_2 + 0x140 ;
if ( ! F_73 ( V_163 -> V_53 . V_169 , L_68 ) ) {
V_85 = F_5 ( V_72 + V_171 ) ;
V_85 = V_85 & 0xffffffe0 ;
F_19 ( V_85 | V_172 , V_72 + V_171 ) ;
}
F_3 ( L_69 , F_5 ( V_72 + V_171 ) ) ;
...
V_45 -> V_78 = V_78 ;
V_45 -> V_72 = V_72 ;
V_153 = F_74 ( V_163 -> V_53 . V_169 , 0 ) ;
if ( V_153 < 0 ) {
F_75 ( & V_163 -> V_53 , L_72 ) ;
goto V_170;
}
V_45 -> V_153 = V_153 ;
if ( F_73 ( V_163 -> V_53 . V_169 , L_73 ) )
V_45 -> V_22 = V_173 ;
else
V_45 -> V_22 = V_174 ;
V_46 = F_76 ( & V_163 -> V_53 , V_168 , V_175 ) ;
V_46 -> V_43 = V_45 ;
F_69 ( V_46 ) ;
F_77 ( V_46 , V_153 , F_65 , V_176 ,
& V_177 ) ;
F_78 ( & V_163 -> V_53 , V_46 ) ;
return 0 ;
V_170:
if ( V_2 )
F_79 ( V_2 ) ;
...
{
struct V_155 * V_46 = F_81 ( & V_163 -> V_53 ) ;
struct V_44 * V_45 = V_46 -> V_43 ;
F_82 ( V_46 ) ;
F_78 ( & V_163 -> V_53 , NULL ) ;
F_83 ( V_45 -> V_153 ) ;
F_79 ( V_45 -> V_2 ) ;
F_31 ( V_45 ) ;
return 0 ;
}
static int F_84 ( struct V_162 * V_178 , T_6 V_179 )
{
struct V_155 * V_46 = F_81 ( & V_178 -> V_53 ) ;
return F_85 ( V_46 , V_179 ) ;
}
static int F_86 ( struct V_162 * V_178 )
{
struct V_155 * V_46 = F_81 ( & V_178 -> V_53 ) ;
struct V_44 * V_45 = V_46 -> V_43 ;
int V_180 ;
