...
static int T_7 F_80 ( struct V_1 * V_2 )
{
struct V_196 * V_197 ;
struct V_198 V_124 ;
#ifndef F_50
...
static int T_7 F_86 ( struct V_1 * V_2 , struct V_29 * V_30 , int V_7 )
{
int V_233 = 2 * ( V_61 / 2 +
V_59 / 2 +
1 + V_60 / 2 + 1 ) ;
...
static int F_106 ( struct V_245 * V_169 , T_8 V_284 )
{
struct V_285 * V_126 = F_107 ( V_169 ) ;
...
F_105 ( V_169 ) ;
F_111 ( V_169 ) ;
F_112 ( V_169 , F_113 ( V_169 , V_284 ) ) ;
return 0 ;
}
static int F_114 ( struct V_245 * V_169 )
{
struct V_285 * V_126 = F_107 ( V_169 ) ;
struct V_1 * V_2 = V_126 -> V_44 ;
int V_91 , V_286 ;
...
static int T_7 F_121 ( struct V_1 * V_2 )
{
struct V_129 * V_129 ;
int V_45 ;
V_129 = F_122 () ;
if ( ! V_129 )
return - V_150 ;
snprintf ( V_2 -> V_295 , sizeof( V_2 -> V_295 ) , L_9 ,
F_123 ( V_2 -> V_169 ) ) ;
V_129 -> V_167 = V_2 -> V_126 -> V_161 ;
V_129 -> V_295 = V_2 -> V_295 ;
V_129 -> V_128 . V_296 = V_297 ;
V_129 -> V_128 . V_298 = V_2 -> V_169 -> V_298 ;
V_129 -> V_128 . V_299 = V_2 -> V_169 -> V_158 ;
V_129 -> V_300 . V_301 = & V_2 -> V_169 -> V_300 ;
...
V_2 -> V_244 = 1 ;
V_2 -> V_145 = V_325 ;
V_2 -> V_146 = F_137 ( V_2 -> V_145 , sizeof( struct V_29 ) ,
V_313 ) ;
if ( V_2 -> V_146 == NULL ) {
F_99 ( V_2 ) ;
F_105 ( V_169 ) ;
...
V_45 = F_138 ( & V_2 -> V_214 ,
L_14 , & V_169 -> V_300 ) ;
if ( V_45 < 0 ) {
F_96 ( V_2 ) ;
return V_45 ;
}
V_45 = F_138 ( & V_2 -> V_218 ,
L_15 , & V_169 -> V_300 ) ;
if ( V_45 < 0 ) {
F_96 ( V_2 ) ;
return V_45 ;
}
if ( ( V_45 = F_139 ( V_169 , V_126 -> V_161 ) ) < 0 ) {
F_96 ( V_2 ) ;
return V_45 ;
}
V_2 -> V_5 = F_140 ( V_169 , 0 ) ;
F_119 ( V_169 ) ;
F_90 ( V_2 ) ;
F_11 ( V_2 ) ;
F_75 ( V_2 ) ;
F_88 ( V_2 , 1 ) ;
F_89 ( V_2 ) ;
if ( F_141 ( V_169 -> V_133 , F_56 , V_326 ,
V_327 , V_2 ) ) {
F_37 ( V_106 L_16 , V_169 -> V_133 ) ;
F_96 ( V_2 ) ;
return - V_150 ;
}
V_2 -> V_133 = V_169 -> V_133 ;
#ifdef F_100
V_2 -> V_283 = F_142 ( sizeof( T_1 ) * ( V_328 + V_329 ) ) ;
if ( V_2 -> V_283 == NULL )
F_37 ( V_330 L_17 ) ;
#endif
if ( ( V_45 = F_143 ( V_126 , V_331 , V_2 , & V_202 ) ) < 0 ) {
F_96 ( V_2 ) ;
return V_45 ;
}
if ( ( V_45 = F_80 ( V_2 ) ) < 0 )
...
F_95 ( V_2 ) ;
F_13 ( V_2 ) ;
F_144 ( V_126 , & V_169 -> V_300 ) ;
* V_308 = V_2 ;
return 0 ;
}
static int T_7
F_145 ( struct V_245 * V_169 , const struct V_332 * V_333 )
{
static int V_300 ;
struct V_285 * V_126 ;
struct V_1 * V_2 ;
...
V_45 = F_146 ( V_7 [ V_300 ] , V_128 [ V_300 ] , V_339 , 0 , & V_126 ) ;
if ( V_45 < 0 )
return V_45 ;
switch ( V_169 -> V_158 ) {
case V_314 :
...
V_126 -> V_44 = V_2 ;
sprintf ( V_126 -> V_340 , L_23 , V_126 -> V_161 ) ;
sprintf ( V_126 -> V_341 , L_24 ,
V_126 -> V_340 , V_2 -> V_5 , V_2 -> V_133 ) ;
if ( ( V_45 = F_148 ( V_126 ) ) < 0 ) {
F_147 ( V_126 ) ;
return V_45 ;
}
#if 0
...
static void T_9 F_150 ( struct V_245 * V_169 )
{
F_147 ( F_107 ( V_169 ) ) ;
F_149 ( V_169 , NULL ) ;
}
