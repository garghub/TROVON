...
if ( V_141 -> V_142 != 0 )
return - V_121 ;
F_42 ( V_141 -> V_143 , L_26 , sizeof( V_141 -> V_143 ) ) ;
V_141 -> V_144 = V_145 ;
return 0 ;
}
...
F_48 ( V_2 , V_141 -> V_147 . V_148 . V_71 , V_141 -> V_147 . V_148 . V_70 , V_141 -> V_147 . V_148 . V_115 ) ;
F_15 ( V_41 , V_69 , 2 , 0 ,
...
static int F_49 ( struct V_90 * V_90 , void * V_34 , struct V_153 * V_154 )
{
struct V_91 * V_107 = V_34 ;
return ( F_50 ( & V_107 -> V_152 , V_154 ) ) ;
}
static int F_51 ( struct V_90 * V_90 , void * V_34 , struct V_155 * V_154 )
{
struct V_91 * V_107 = V_34 ;
return ( F_52 ( & V_107 -> V_152 , V_154 ) ) ;
}
static int F_53 ( struct V_90 * V_90 , void * V_34 , struct V_155 * V_154 )
{
struct V_91 * V_107 = V_34 ;
return ( F_54 ( & V_107 -> V_152 , V_154 ) ) ;
}
static int F_55 ( struct V_90 * V_90 , void * V_34 , struct V_155 * V_154 )
{
struct V_91 * V_107 = V_34 ;
return ( F_56 ( & V_107 -> V_152 , V_154 ,
V_90 -> V_156 & V_157 ) ) ;
}
static int F_57 ( struct V_90 * V_90 , void * V_34 , enum V_158 V_43 )
{
struct V_91 * V_107 = V_34 ;
return F_58 ( & V_107 -> V_152 ) ;
}
static int F_59 ( struct V_90 * V_90 , void * V_34 , enum V_158 V_43 )
{
struct V_91 * V_107 = V_34 ;
return F_60 ( & V_107 -> V_152 ) ;
}
...
return - V_121 ;
return F_62 ( & V_41 -> V_72 , 0 , V_141 , V_162 ) ;
}
...
F_26 ( V_41 ) ;
V_154 = V_41 -> V_72 ;
V_50 = F_62 ( & V_154 , 0 , V_141 , V_164 ) ;
if ( ! V_50 ) {
V_50 = F_22 ( V_41 , F_13 , & V_41 -> V_72 , & V_154 ) ;
V_41 -> V_72 = V_154 ;
}
return V_50 ;
}
...
if ( F_72 ( V_137 == V_2 -> V_130 . V_138 ) )
return - V_121 ;
V_141 -> type = V_171 ;
V_141 -> V_172 = V_2 -> V_173 ;
F_69 ( V_2 , V_174 , V_175 , V_141 ) ;
return 0 ;
}
...
if ( ! V_41 -> V_2 -> V_192 && F_23 ( V_41 ) < 0 ) {
V_188 -> V_193 ( V_188 ) ;
F_85 ( & V_41 -> V_2 -> V_177 ) ;
return - V_121 ;
}
F_14 ( 1 , L_37 , F_96 ( V_186 ) ) ;
V_107 = F_97 ( sizeof( * V_107 ) , V_194 ) ;
if ( NULL == V_107 ) {
V_188 -> V_193 ( V_188 ) ;
F_85 ( & V_41 -> V_2 -> V_177 ) ;
return - V_195 ;
...
static T_4
F_105 ( struct V_90 * V_90 , char T_5 * V_38 , T_6 V_106 , T_7 * V_201 )
{
struct V_91 * V_107 = V_90 -> V_196 ;
struct V_40 * V_41 = V_107 -> V_41 ;
if ( ! V_41 -> V_78 )
F_25 ( V_90 , V_107 ) ;
return F_106 ( & V_107 -> V_152 , V_38 , V_106 , V_201 , 0 ,
V_90 -> V_156 & V_157 ) ;
}
static unsigned int
F_107 ( struct V_90 * V_90 , struct V_202 * V_203 )
{
struct V_91 * V_107 = V_90 -> V_196 ;
struct V_40 * V_41 = V_107 -> V_41 ;
if ( ! V_41 -> V_78 )
F_25 ( V_90 , V_107 ) ;
return F_108 ( V_90 , & V_107 -> V_152 , V_203 ) ;
}
static int
F_109 ( struct V_90 * V_90 , struct V_204 * V_205 )
{
struct V_91 * V_107 = V_90 -> V_196 ;
return F_110 ( & V_107 -> V_152 , V_205 ) ;
}
...
static int F_113 ( struct V_187 * V_188 )
{
struct V_1 * V_2 = V_188 -> V_2 ;
int V_50 = 0 ;
switch ( V_2 -> V_206 ) {
...
{
int V_50 ;
V_41 -> V_208 = F_119 ( V_41 -> V_2 , V_41 -> V_66 ,
& V_209 , L_38 ) ;
F_120 ( V_41 -> V_208 , V_41 ) ;
V_50 = F_121 ( V_41 -> V_208 , V_210 , - 1 ) ;
if ( V_50 < 0 ) {
F_68 ( V_211 L_39 ,
V_41 -> V_2 -> V_131 ) ;
return V_50 ;
...
F_68 ( V_211 L_40 ,
V_41 -> V_2 -> V_131 , F_96 ( V_41 -> V_208 ) ) ;
return 0 ;
}
