...
static struct V_25 * F_113 ( struct V_1 * V_185 , struct V_2 * V_186 )
{
do {
T_1 V_187 ;
if ( V_186 )
...
static struct V_25 * F_115 ( struct V_49 * V_50 )
{
...
if ( ! V_185 )
return NULL ;
return F_113 ( V_185 , V_186 ) ;
}
static struct V_25 * F_117 ( struct V_49 * V_50 , int V_188 )
{
struct V_25 * V_12 = F_115 ( V_50 ) ;
while ( V_12 && V_188 -- > 0 )
V_12 = F_116 ( V_12 ) ;
return V_12 ;
}
...
int V_168 = 0 ;
for ( V_12 = F_115 ( V_50 ) ; V_12 ; V_12 = F_116 ( V_12 ) ) {
V_168 += F_111 ( V_12 ) ;
...
static int F_120 ( T_1 V_43 , int V_39 , struct V_80 * V_190 ,
struct V_90 * V_91 ,
...
if ( F_121 ( V_192 , F_122 ( V_194 -> V_192 ) . V_197 ,
V_194 -> V_198 -> V_199 ,
V_127 ,
V_91 -> V_105 ,
V_22 -> V_117 ,
...
if ( F_107 ( & V_40 -> V_42 ) )
continue;
if ( F_120 ( V_12 -> V_43 , V_40 -> V_39 , & V_40 -> V_42 , V_91 , V_192 , V_194 ) < 0 ) {
V_194 -> args [ 4 ] = V_8 ;
return - 1 ;
}
V_8 ++ ;
...
int F_124 ( struct V_90 * V_91 , struct V_191 * V_192 ,
struct V_193 * V_194 )
{
struct V_25 * V_12 ;
struct V_49 * V_50 = (struct V_49 * ) V_91 -> V_94 ;
...
V_12 = F_77 ( V_50 , V_43 ) ;
if ( ! V_12 )
V_12 = F_117 ( V_50 , V_202 ) ;
}
while ( V_12 ) {
V_194 -> args [ 2 ] = V_12 -> V_43 ;
if ( F_123 ( V_12 , V_91 , V_192 , V_194 ) < 0 ) {
V_194 -> args [ 3 ] = V_202 ;
F_102 () ;
return - 1 ;
}
...
static struct V_2 * F_129 ( struct V_206 * V_207 )
{
...
static void F_131 ( struct V_49 * V_50 , struct V_210 * V_211 )
{
struct V_2 * V_48 ;
struct V_206 V_207 ;
memset ( V_211 , 0 , sizeof( * V_211 ) ) ;
F_99 () ;
for ( V_48 = F_130 ( & V_207 , V_50 ) ; V_48 ; V_48 = F_129 ( & V_207 ) ) {
if ( F_42 ( V_48 ) ) {
...
static void F_132 ( struct V_220 * V_221 , struct V_210 * V_222 )
{
unsigned int V_8 , F_127 , V_223 , V_224 , V_225 ;
if ( V_222 -> V_212 )
...
F_133 ( V_221 , L_14 ,
V_225 / 100 , V_225 % 100 ) ;
F_133 ( V_221 , L_15 , V_222 -> V_214 ) ;
F_133 ( V_221 , L_16 , V_222 -> V_212 ) ;
V_224 = sizeof( struct V_25 ) * V_222 -> V_212 ;
F_133 ( V_221 , L_17 , V_222 -> V_215 ) ;
V_224 += sizeof( struct V_27 ) * V_222 -> V_215 ;
F_133 ( V_221 , L_18 , V_222 -> V_216 ) ;
V_224 += sizeof( struct V_1 ) * V_222 -> V_216 ;
F_127 = V_217 ;
while ( F_127 > 0 && V_222 -> V_218 [ F_127 - 1 ] == 0 )
F_127 -- ;
V_223 = 0 ;
for ( V_8 = 1 ; V_8 <= F_127 ; V_8 ++ )
if ( V_222 -> V_218 [ V_8 ] != 0 ) {
F_133 ( V_221 , L_19 , V_8 , V_222 -> V_218 [ V_8 ] ) ;
V_223 += ( 1 << V_8 ) * V_222 -> V_218 [ V_8 ] ;
}
F_134 ( V_221 , '\n' ) ;
F_133 ( V_221 , L_20 , V_223 ) ;
V_224 += sizeof( struct V_2 * ) * V_223 ;
F_133 ( V_221 , L_21 , V_222 -> V_219 ) ;
F_133 ( V_221 , L_22 , ( V_224 + 1023 ) / 1024 ) ;
}
static void F_135 ( struct V_220 * V_221 ,
const struct V_226 * V_64 )
{
F_133 ( V_221 , L_23 ) ;
F_133 ( V_221 , L_24 , V_64 -> gets ) ;
F_133 ( V_221 , L_25 , V_64 -> V_172 ) ;
F_133 ( V_221 , L_26 ,
V_64 -> V_145 ) ;
F_133 ( V_221 , L_27 ,
V_64 -> V_159 ) ;
F_133 ( V_221 , L_28 , V_64 -> V_169 ) ;
F_133 ( V_221 , L_29 ,
V_64 -> V_65 ) ;
}
static void F_136 ( struct V_220 * V_221 , struct V_90 * V_91 )
{
if ( V_91 -> V_105 == V_227 )
F_137 ( V_221 , L_30 ) ;
...
F_133 ( V_221 , L_32 , V_91 -> V_105 ) ;
}
static int F_138 ( struct V_220 * V_221 , void * V_229 )
{
...
F_132 ( V_221 , & V_222 ) ;
#ifdef F_63
F_135 ( V_221 , & V_50 -> V_64 ) ;
#endif
}
}
return 0 ;
}
static int F_139 ( struct V_70 * V_70 , struct V_236 * V_236 )
{
return F_140 ( V_70 , V_236 , F_138 ) ;
}
static struct V_2 * F_141 ( struct V_220 * V_221 , T_7 V_18 )
{
struct V_206 * V_207 = V_221 -> V_231 ;
struct V_230 * V_230 = F_142 ( V_221 ) ;
T_7 V_187 = 0 ;
unsigned int V_232 ;
for ( V_232 = 0 ; V_232 < V_233 ; V_232 ++ ) {
struct V_78 * V_20 = & V_230 -> V_234 . V_235 [ V_232 ] ;
...
F_69 (tb, node, head, tb_hlist) {
struct V_2 * V_48 ;
for ( V_48 = F_130 ( V_207 ,
(struct V_49 * ) V_91 -> V_94 ) ;
V_48 ; V_48 = F_129 ( V_207 ) )
if ( V_18 == V_187 ++ ) {
V_207 -> V_91 = V_91 ;
return V_48 ;
}
...
static void * F_143 ( struct V_220 * V_221 , T_7 * V_18 )
__acquires( T_8 )
{
F_99 () ;
return F_141 ( V_221 , * V_18 ) ;
}
static void * F_144 ( struct V_220 * V_221 , void * V_229 , T_7 * V_18 )
{
struct V_206 * V_207 = V_221 -> V_231 ;
struct V_230 * V_230 = F_142 ( V_221 ) ;
...
while ( ( V_237 = F_100 ( F_145 ( & V_91 -> V_238 ) ) ) ) {
V_91 = F_146 ( V_237 , struct V_90 , V_238 ) ;
V_48 = F_130 ( V_207 , (struct V_49 * ) V_91 -> V_94 ) ;
if ( V_48 )
goto V_168;
}
while ( ++ V_232 < V_233 ) {
...
static void F_147 ( struct V_220 * V_221 , void * V_229 )
__releases( T_8 )
{
F_102 () ;
}
static void F_148 ( struct V_220 * V_221 , int V_48 )
{
while ( V_48 -- > 0 )
F_137 ( V_221 , L_35 ) ;
}
static inline const char * F_149 ( char * V_239 , T_2 V_201 , enum V_240 V_211 )
{
switch ( V_211 ) {
...
static inline const char * F_150 ( char * V_239 , T_2 V_201 , unsigned int V_50 )
{
...
F_148 ( V_221 , V_207 -> V_208 ) ;
F_133 ( V_221 , L_44 , & V_248 ) ;
F_69 (li, node, &l->list, hlist) {
struct V_21 * V_22 ;
F_95 (fa, &li->falh, fa_list) {
char V_249 [ 32 ] , V_250 [ 32 ] ;
F_148 ( V_221 , V_207 -> V_208 + 1 ) ;
F_133 ( V_221 , L_45 , V_40 -> V_39 ,
F_149 ( V_249 , sizeof( V_249 ) ,
V_22 -> V_108 -> V_142 ) ,
F_150 ( V_250 , sizeof( V_250 ) ,
V_22 -> V_117 ) ) ;
if ( V_22 -> V_107 )
F_133 ( V_221 , L_46 , V_22 -> V_107 ) ;
F_134 ( V_221 , '\n' ) ;
}
}
}
...
static int F_152 ( struct V_70 * V_70 , struct V_236 * V_236 )
{
return F_153 ( V_70 , V_236 , & V_251 ,
sizeof( struct V_206 ) ) ;
}
static struct V_25 * F_154 ( struct V_252 * V_207 , T_7 V_18 )
{
...
static void * F_155 ( struct V_220 * V_221 , T_7 * V_18 )
__acquires( T_8 )
{
struct V_252 * V_207 = V_221 -> V_231 ;
struct V_90 * V_91 ;
F_99 () ;
V_91 = F_156 ( F_142 ( V_221 ) , V_228 ) ;
if ( ! V_91 )
return NULL ;
...
return F_154 ( V_207 , * V_18 - 1 ) ;
}
static void * F_157 ( struct V_220 * V_221 , void * V_229 , T_7 * V_18 )
{
struct V_252 * V_207 = V_221 -> V_231 ;
...
static void F_158 ( struct V_220 * V_221 , void * V_229 )
__releases( T_8 )
{
F_102 () ;
}
...
static int F_160 ( struct V_220 * V_221 , void * V_229 )
{
struct V_25 * V_12 = V_229 ;
struct V_27 * V_40 ;
struct V_79 * V_3 ;
if ( V_229 == V_254 ) {
F_133 ( V_221 , L_47 , L_48
L_49
L_50 ) ;
return 0 ;
}
...
unsigned int V_255 = F_159 ( V_22 -> V_117 , V_101 , V_97 ) ;
int V_201 ;
if ( V_22 -> V_117 == V_264
|| V_22 -> V_117 == V_265 )
continue;
...
V_263 , 0 , V_255 , 0 , 0 , 0 ,
V_101 , 0 , 0 , 0 , & V_201 ) ;
F_133 ( V_221 , L_55 , 127 - V_201 , L_56 ) ;
}
}
return 0 ;
}
static int F_161 ( struct V_70 * V_70 , struct V_236 * V_236 )
{
return F_153 ( V_70 , V_236 , & V_271 ,
sizeof( struct V_252 ) ) ;
}
int T_9 F_162 ( struct V_230 * V_230 )
{
if ( ! F_163 ( V_230 , L_5 , V_272 , & V_273 ) )
goto V_274;
if ( ! F_163 ( V_230 , L_57 , V_272 ,
& V_275 ) )
goto V_276;
if ( ! F_163 ( V_230 , L_58 , V_272 , & V_277 ) )
goto V_278;
return 0 ;
V_278:
F_164 ( V_230 , L_57 ) ;
...
void T_10 F_165 ( struct V_230 * V_230 )
{
F_164 ( V_230 , L_5 ) ;
F_164 ( V_230 , L_57 ) ;
F_164 ( V_230 , L_58 ) ;
