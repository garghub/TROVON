...
V_103 -> V_295 = V_20 ;
V_21 = F_164 ( V_103 -> V_294 , 0 , 1 , NULL ) ;
if ( V_21 < 0 )
F_17 ( V_276
L_66 ) ;
}
...
if ( V_275 [ V_149 ] ) {
V_20 = V_275 [ V_149 ] ;
F_161 ( V_103 -> V_130 , V_296 , V_20 ) ;
V_103 -> V_297 = V_20 ;
}
#endif
strcpy ( V_132 -> V_298 , L_40 ) ;
strcpy ( V_132 -> V_299 , L_67 ) ;
#ifdef F_160
snprintf ( V_132 -> V_259 , sizeof( V_132 -> V_259 ) ,
L_68 ,
V_132 -> V_299 , V_103 -> V_68 , V_103 -> V_236 , V_103 -> V_291 ,
