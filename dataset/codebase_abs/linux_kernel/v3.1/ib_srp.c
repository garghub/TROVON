...
V_416 -> V_421 = 1 ;
V_416 -> V_422 = V_423 ;
V_416 -> V_424 = sizeof ( (struct V_222 * ) ( void * ) 0L ) -> V_313 ;
V_6 = F_1 ( V_416 ) ;
V_6 -> V_126 = V_408 ;
V_6 -> V_85 = V_416 ;
V_6 -> V_12 = V_3 ;
V_6 -> V_259 = V_3 -> V_22 -> V_425 -> V_259 ;
V_6 -> V_192 = V_3 -> V_22 -> V_425 -> V_192 ;
V_6 -> V_238 = V_426 ;
V_6 -> V_414 = V_427 ? : V_426 ;
V_6 -> V_239 = V_239 ;
V_32 = F_137 ( V_19 , V_6 ) ;
if ( V_32 )
goto V_58;
...
V_3 -> V_22 = V_311 ;
V_3 -> V_35 = V_35 ;
V_3 -> V_23 . V_432 = & V_433 ;
V_3 -> V_23 . V_434 = V_311 -> V_23 -> V_382 ;
F_155 ( & V_3 -> V_23 , L_74 , V_311 -> V_23 -> V_377 , V_35 ) ;
if ( F_156 ( & V_3 -> V_23 ) )
goto V_435;
if ( F_157 ( & V_3 -> V_23 , & V_436 ) )
goto V_437;
if ( F_157 ( & V_3 -> V_23 , & V_438 ) )
goto V_437;
if ( F_157 ( & V_3 -> V_23 , & V_439 ) )
goto V_437;
return V_3 ;
V_437:
F_158 ( & V_3 -> V_23 ) ;
...
struct V_442 V_443 ;
struct V_12 * V_3 ;
int V_444 , V_445 , V_446 , V_447 , V_393 ;
V_441 = F_5 ( sizeof *V_441 , V_33 ) ;
if ( ! V_441 )
return;
if ( F_160 ( V_311 , V_441 ) ) {
...
if ( ! V_22 )
goto V_448;
V_445 = F_161 ( 12 , F_162 ( V_441 -> V_449 ) - 1 ) ;
V_22 -> V_220 = 1 << V_445 ;
...
V_43 |
V_42 ) ;
V_22 -> V_206 = F_165 ( V_22 -> V_74 , & V_443 ) ;
if ( ! F_20 ( V_22 -> V_206 ) )
break;
}
if ( F_20 ( V_22 -> V_206 ) )
V_22 -> V_206 = NULL ;
if ( V_311 -> V_462 == V_463 ) {
V_446 = 0 ;
V_447 = 0 ;
} else {
V_446 = 1 ;
...
for ( V_393 = V_446 ; V_393 <= V_447 ; ++ V_393 ) {
V_3 = F_154 ( V_22 , V_393 ) ;
if ( V_3 )
F_65 ( & V_3 -> V_159 , & V_22 -> V_450 ) ;
}
F_166 ( V_311 , & V_465 , V_22 ) ;
goto V_448;
V_453:
F_167 ( V_22 -> V_74 ) ;
V_451:
...
{
struct V_200 * V_22 ;
struct V_12 * V_3 , * V_466 ;
F_169 ( V_386 ) ;
struct V_1 * V_6 , * V_467 ;
V_22 = F_170 ( V_311 , & V_465 ) ;
