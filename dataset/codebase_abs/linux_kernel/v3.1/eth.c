...
int F_25 ( struct V_3 * V_4 , int V_47 )
{
if ( V_47 < 68 || V_47 > V_48 )
return - V_49 ;
V_4 -> V_50 = V_47 ;
return 0 ;
}
...
struct V_3 * F_28 ( int V_61 , unsigned int V_62 ,
unsigned int V_63 )
{
return F_29 ( V_61 , L_2 , F_27 , V_62 , V_63 ) ;
}
static T_2 F_30 ( char * V_64 , int V_65 ,
const unsigned char * V_43 , int V_7 )
{
int V_66 ;
char * V_67 = V_64 ;
for ( V_66 = 0 ; V_66 < V_7 ; V_66 ++ ) {
V_67 += F_31 ( V_67 , V_65 - ( V_67 - V_64 ) , L_3 , V_43 [ V_66 ] ) ;
if ( V_66 == V_7 - 1 )
break;
V_67 += F_31 ( V_67 , V_65 - ( V_67 - V_64 ) , L_4 ) ;
}
return V_67 - V_64 ;
}
T_3 F_32 ( char * V_64 , const unsigned char * V_43 , int V_7 )
{
T_2 V_68 ;
V_68 = F_30 ( V_64 , V_69 , V_43 , V_7 ) ;
V_68 += F_31 ( V_64 + V_68 , V_69 - V_68 , L_5 ) ;
return ( T_3 ) V_68 ;
}
