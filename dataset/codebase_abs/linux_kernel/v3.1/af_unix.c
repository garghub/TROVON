...
static int F_155 ( struct V_190 * V_190 , struct V_87 * V_11 ,
struct V_191 * V_192 , T_2 V_23 )
{
struct V_193 * V_194 = F_156 ( V_190 ) ;
struct V_11 * V_12 = V_11 -> V_12 ;
struct V_32 * V_32 = F_33 ( V_12 ) ;
struct V_36 * V_37 = F_31 ( V_12 ) ;
...
V_194 -> V_2 = & V_197 ;
F_157 () ;
V_89 = F_158 ( V_11 , V_192 , V_194 -> V_2 ) ;
if ( V_89 < 0 )
return V_89 ;
V_89 = - V_94 ;
...
goto V_95;
V_4 = F_159 ( V_12 , V_23 , V_192 -> V_198 & V_202 , & V_89 ) ;
if ( V_4 == NULL )
goto V_95;
...
F_1 ( V_194 -> V_2 , V_4 ) ;
F_160 ( V_4 ) ;
V_89 = F_161 ( F_162 ( V_4 , V_23 ) , V_192 -> V_204 , V_23 ) ;
if ( V_89 )
goto V_203;
...
static int F_166 ( struct V_190 * V_190 , struct V_87 * V_11 ,
struct V_191 * V_192 , T_2 V_23 )
{
struct V_193 * V_194 = F_156 ( V_190 ) ;
struct V_11 * V_12 = V_11 -> V_12 ;
...
if ( V_207 > V_213 )
V_207 = V_213 ;
V_4 = F_159 ( V_12 , V_207 , V_192 -> V_198 & V_202 ,
& V_89 ) ;
if ( V_4 == NULL )
goto V_210;
V_207 = F_167 ( int , V_207 , F_168 ( V_4 ) ) ;
...
V_183 = V_89 + 1 ;
V_209 = true ;
V_89 = F_161 ( F_162 ( V_4 , V_207 ) , V_192 -> V_204 , V_207 ) ;
if ( V_89 ) {
F_62 ( V_4 ) ;
goto V_210;
}
...
static int F_170 ( struct V_190 * V_190 , struct V_87 * V_11 ,
struct V_191 * V_192 , T_2 V_23 )
{
int V_89 ;
struct V_11 * V_12 = V_11 -> V_12 ;
...
if ( V_192 -> V_200 )
V_192 -> V_200 = 0 ;
return F_155 ( V_190 , V_11 , V_192 , V_23 ) ;
}
static int F_172 ( struct V_190 * V_217 , struct V_87 * V_11 ,
...
if ( V_12 -> V_73 != V_169 )
return - V_180 ;
return F_173 ( V_217 , V_11 , V_192 , V_207 , V_152 ) ;
}
static void F_174 ( struct V_191 * V_192 , struct V_11 * V_12 )
{
struct V_36 * V_37 = F_31 ( V_12 ) ;
V_192 -> V_200 = 0 ;
if ( V_37 -> V_19 ) {
...
int V_152 )
{
struct V_193 * V_194 = F_156 ( V_217 ) ;
struct V_1 V_197 ;
struct V_11 * V_12 = V_11 -> V_12 ;
struct V_36 * V_37 = F_31 ( V_12 ) ;
...
goto V_95;
V_192 -> V_200 = 0 ;
V_89 = F_175 ( & V_37 -> V_108 ) ;
if ( V_89 ) {
V_89 = F_126 ( F_176 ( V_12 , V_218 ) ) ;
goto V_95;
}
...
V_50 | V_51 | V_52 ) ;
if ( V_192 -> V_195 )
F_174 ( V_192 , V_4 -> V_12 ) ;
if ( V_207 > V_4 -> V_23 )
V_207 = V_4 -> V_23 ;
else if ( V_207 < V_4 -> V_23 )
V_192 -> V_198 |= V_219 ;
V_89 = F_177 ( V_4 , 0 , V_192 -> V_204 , V_207 ) ;
if ( V_89 )
goto V_203;
if ( F_49 ( V_12 , V_206 ) )
F_178 ( V_192 , V_12 , V_4 ) ;
if ( ! V_194 -> V_2 ) {
V_194 -> V_2 = & V_197 ;
memset ( & V_197 , 0 , sizeof( V_197 ) ) ;
}
F_179 ( V_194 -> V_2 , F_144 ( V_4 ) . V_90 , F_144 ( V_4 ) . V_92 ) ;
F_3 ( V_194 -> V_2 , V_4 ) ;
if ( ! ( V_152 & V_220 ) ) {
if ( F_144 ( V_4 ) . V_181 )
F_143 ( V_194 -> V_2 , V_4 ) ;
...
V_89 = V_207 ;
F_180 ( V_11 , V_192 , V_194 -> V_2 , V_152 ) ;
V_203:
F_138 ( V_12 , V_4 ) ;
V_96:
F_93 ( & V_37 -> V_108 ) ;
...
static long F_181 ( struct V_11 * V_12 , long V_159 )
{
F_119 ( V_49 ) ;
F_11 ( V_12 ) ;
for (; ; ) {
F_182 ( F_183 ( V_12 ) , & V_49 , V_161 ) ;
if ( ! F_46 ( & V_12 -> V_14 ) ||
V_12 -> V_58 ||
( V_12 -> V_71 & V_162 ) ||
F_127 ( V_85 ) ||
! V_159 )
break;
F_184 ( V_221 , & V_12 -> V_61 -> V_152 ) ;
F_13 ( V_12 ) ;
V_159 = F_121 ( V_159 ) ;
F_11 ( V_12 ) ;
F_185 ( V_221 , & V_12 -> V_61 -> V_152 ) ;
}
F_122 ( F_183 ( V_12 ) , & V_49 ) ;
F_13 ( V_12 ) ;
return V_159 ;
}
static int F_186 ( struct V_190 * V_217 , struct V_87 * V_11 ,
struct V_191 * V_192 , T_2 V_207 ,
int V_152 )
{
struct V_193 * V_194 = F_156 ( V_217 ) ;
...
if ( V_152 & V_199 )
goto V_95;
V_224 = F_187 ( V_12 , V_152 & V_225 , V_207 ) ;
V_159 = F_176 ( V_12 , V_152 & V_202 ) ;
V_192 -> V_200 = 0 ;
if ( ! V_194 -> V_2 ) {
V_194 -> V_2 = & V_197 ;
memset ( & V_197 , 0 , sizeof( V_197 ) ) ;
...
V_226 = F_167 (unsigned int, skb->len, size) ;
if ( F_189 ( V_192 -> V_204 , V_4 -> V_228 , V_226 ) ) {
F_188 ( & V_12 -> V_14 , V_4 ) ;
if ( V_222 == 0 )
V_222 = - V_229 ;
break;
...
static int F_192 ( struct V_87 * V_11 , int V_139 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
struct V_11 * V_55 ;
...
static int F_193 ( struct V_87 * V_11 , unsigned int V_232 , unsigned long V_233 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
long V_234 = 0 ;
int V_89 ;
...
case V_235 :
V_234 = F_194 ( V_12 ) ;
V_89 = F_195 ( V_234 , ( int V_236 * ) V_233 ) ;
break;
case V_237 :
{
struct V_3 * V_4 ;
...
static unsigned int F_198 ( struct V_239 * V_239 , struct V_87 * V_11 , T_3 * V_49 )
{
struct V_11 * V_12 = V_11 -> V_12 ;
unsigned int V_240 ;
F_199 ( V_239 , F_183 ( V_12 ) , V_49 ) ;
V_240 = 0 ;
if ( V_12 -> V_58 )
V_240 |= V_241 ;
if ( V_12 -> V_71 == V_72 )
...
static unsigned int F_200 ( struct V_239 * V_239 , struct V_87 * V_11 ,
T_3 * V_49 )
{
...
if ( V_55 ) {
if ( F_6 ( V_55 ) != V_12 ) {
F_199 ( V_239 , & F_31 ( V_55 ) -> V_56 , V_49 ) ;
if ( F_8 ( V_55 ) )
V_246 = 0 ;
}
F_60 ( V_55 ) ;
...
F_184 ( V_250 , & V_12 -> V_61 -> V_152 ) ;
return V_240 ;
}
static struct V_11 * F_201 ( int * V_41 )
{
for ( * V_41 = 0 ; * V_41 <= V_10 ; ( * V_41 ) ++ ) {
if ( ! F_202 ( & V_126 [ * V_41 ] ) )
return F_203 ( & V_126 [ * V_41 ] ) ;
}
return NULL ;
}
static struct V_11 * F_204 ( int * V_41 , struct V_11 * V_16 )
{
struct V_11 * V_251 = F_205 ( V_16 ) ;
if ( V_251 )
return V_251 ;
...
static struct V_11 * F_206 ( struct V_252 * V_253 , T_4 V_254 )
{
struct V_255 * V_256 = V_253 -> V_257 ;
T_4 V_258 = 0 ;
struct V_11 * V_16 ;
for ( V_16 = F_201 ( & V_256 -> V_41 ) ; V_16 ; V_16 = F_204 ( & V_256 -> V_41 , V_16 ) ) {
if ( F_33 ( V_16 ) != F_207 ( V_253 ) )
continue;
if ( V_258 == V_254 )
return V_16 ;
++ V_258 ;
...
static void * F_208 ( struct V_252 * V_253 , T_4 * V_254 )
__acquires( V_31 )
{
F_26 ( & V_31 ) ;
return * V_254 ? F_206 ( V_253 , * V_254 - 1 ) : V_259 ;
}
static void * F_209 ( struct V_252 * V_253 , void * V_260 , T_4 * V_254 )
{
struct V_255 * V_256 = V_253 -> V_257 ;
struct V_11 * V_12 = V_260 ;
++ * V_254 ;
if ( V_260 == V_259 )
V_12 = F_201 ( & V_256 -> V_41 ) ;
else
V_12 = F_204 ( & V_256 -> V_41 , V_12 ) ;
while ( V_12 && ( F_33 ( V_12 ) != F_207 ( V_253 ) ) )
V_12 = F_204 ( & V_256 -> V_41 , V_12 ) ;
return V_12 ;
}
static void F_210 ( struct V_252 * V_253 , void * V_260 )
__releases( V_31 )
{
F_27 ( & V_31 ) ;
}
static int F_211 ( struct V_252 * V_253 , void * V_260 )
{
if ( V_260 == V_259 )
F_212 ( V_253 , L_4
L_5 ) ;
...
for ( ; V_41 < V_23 ; V_41 ++ )
F_215 ( V_253 , V_37 -> V_19 -> V_38 -> V_28 [ V_41 ] ) ;
}
F_13 ( V_16 ) ;
F_215 ( V_253 , '\n' ) ;
}
...
static int F_217 ( struct V_40 * V_40 , struct V_239 * V_239 )
{
return F_218 ( V_40 , V_239 , & V_265 ,
sizeof( struct V_255 ) ) ;
}
static int T_5 F_219 ( struct V_32 * V_32 )
{
int error = - V_121 ;
V_32 -> V_103 . V_104 = 10 ;
if ( F_220 ( V_32 ) )
...
static void T_6 F_224 ( struct V_32 * V_32 )
{
F_223 ( V_32 ) ;
F_225 ( V_32 , L_7 ) ;
}
...
int V_267 = - 1 ;
struct V_3 * V_268 ;
F_227 ( sizeof( struct V_269 ) > sizeof( V_268 -> V_270 ) ) ;
V_267 = F_228 ( & V_99 , 1 ) ;
if ( V_267 != 0 ) {
F_51 ( V_271 L_8 ,
V_272 ) ;
