...
V_13 -> V_17 -> V_18 ) ;
struct V_19 * V_20 = F_7 ( V_13 -> V_21 ) ;
struct V_1 * V_2 = V_20 -> V_22 ;
if ( V_15 < 0 )
return V_15 ;
* V_11 = V_15 * V_13 -> V_23 ;
if ( ! * V_10 || * V_10 < F_8 ( V_2 -> V_24 ) )
* V_10 = F_8 ( V_2 -> V_24 ) ;
if ( * V_11 * * V_10 > V_25 * 1024 * 1024 )
* V_10 = ( V_25 * 1024 * 1024 ) / * V_11 ;
F_9 ( V_13 -> V_21 ,
L_1 , V_26 , * V_10 , * V_11 ) ;
return 0 ;
}
static void F_10 ( struct V_8 * V_9 , struct V_27 * V_28 ,
enum V_29 V_24 )
{
...
struct V_12 * V_13 = V_9 -> V_14 ;
struct V_33 * V_34 = V_13 -> V_21 ;
struct V_35 * V_36 = F_15 ( V_31 ) ;
F_16 ( V_34 , V_36 ) ;
F_17 ( V_36 ) ;
}
V_31 -> V_37 = V_38 ;
...
struct V_30 * V_31 , enum V_39 V_40 )
{
struct V_12 * V_13 = V_9 -> V_14 ;
struct V_27 * V_28 = F_19 ( V_31 , struct V_27 , V_31 ) ;
int V_15 = F_6 ( V_13 -> V_16 ,
V_13 -> V_17 -> V_18 ) ;
struct V_19 * V_20 = F_7 ( V_13 -> V_21 ) ;
struct V_1 * V_2 = V_20 -> V_22 ;
...
F_11 ( NULL == V_13 -> V_17 ) ;
V_28 -> V_43 = 1 ;
if ( V_28 -> V_44 != V_13 -> V_17 -> V_44 || V_31 -> V_40 != V_40 ||
V_31 -> V_45 != V_13 -> V_16 ||
V_31 -> V_46 != V_13 -> V_23 ) {
V_28 -> V_44 = V_13 -> V_17 -> V_44 ;
V_31 -> V_45 = V_13 -> V_16 ;
V_31 -> V_46 = V_13 -> V_23 ;
V_31 -> V_40 = V_40 ;
V_31 -> V_37 = V_38 ;
}
V_31 -> V_11 = V_15 * V_31 -> V_46 ;
if ( V_31 -> V_47 && V_31 -> V_48 < V_31 -> V_11 ) {
V_41 = - V_49 ;
goto V_50;
}
if ( V_31 -> V_37 == V_38 ) {
V_41 = F_22 ( V_9 , V_31 , NULL ) ;
if ( V_41 )
goto V_51;
V_31 -> V_37 = V_52 ;
}
...
return 0 ;
V_51:
F_10 ( V_9 , V_28 , V_2 -> V_24 ) ;
V_50:
V_28 -> V_43 = 0 ;
return V_41 ;
}
static void F_23 ( int V_53 , struct V_27 * V_28 ,
enum V_29 V_24 )
{
T_3 V_54 ;
unsigned int V_55 ;
...
if ( F_27 ( V_28 -> V_59 < V_55 ) )
V_55 = V_28 -> V_59 ;
if ( F_20 ( V_54 & ( F_28 ( V_24 ) *
V_60 - 1 ) ) ) {
V_54 = F_29 ( V_54 , F_28 ( V_24 ) *
V_60 ) ;
V_55 &= ~ ( F_28 ( V_24 ) *
V_60 - 1 ) ;
}
...
static struct V_27 * F_33 ( struct V_1 * V_2 )
{
struct V_27 * V_28 ;
V_28 = V_2 -> V_67 ;
if ( ! V_28 ) {
if ( F_21 ( & V_2 -> V_68 ) )
return V_28 ;
V_28 = F_34 ( V_2 -> V_68 . V_69 ,
struct V_27 , V_31 . V_42 ) ;
V_28 -> V_31 . V_37 = V_70 ;
V_2 -> V_67 = V_28 ;
F_35 ( & V_28 -> V_31 . V_42 ) ;
}
if ( V_2 -> V_24 == V_32 ) {
F_23 ( V_2 -> V_53 , V_28 , V_2 -> V_24 ) ;
} else {
V_28 -> V_56 = NULL ;
}
return V_28 ;
}
static struct V_71 * F_36 ( int V_53 , struct V_27 * V_28 )
{
struct V_71 * V_56 ;
if ( F_37 ( V_28 -> V_56 ) ) {
if ( F_27 ( ! V_28 -> V_59 ) ) {
...
struct V_35 * V_36 = F_15 ( & V_28 -> V_31 ) ;
V_56 = V_36 -> V_72 ;
if ( ! ( F_20 ( ! V_56 ) ) ) {
V_28 -> V_56 = V_56 ;
V_28 -> V_61 = 0 ;
V_28 -> V_59 = V_28 -> V_31 . V_11 ;
V_28 -> V_57 = V_73 ;
}
}
if ( V_56 )
...
{
struct V_27 * V_28 =
F_19 ( V_31 , struct V_27 , V_31 ) ;
struct V_12 * V_13 = V_9 -> V_14 ;
struct V_33 * V_34 = V_13 -> V_21 ;
struct V_19 * V_20 = F_7 ( V_34 ) ;
struct V_1 * V_2 = V_20 -> V_22 ;
switch ( V_31 -> V_37 ) {
case V_73 :
F_9 ( V_34 , L_3 , V_26 ) ;
...
struct V_27 * V_28 = V_2 -> V_75 ;
struct V_30 * V_31 ;
struct V_33 * V_34 = V_2 -> V_13 -> V_21 ;
if ( F_20 ( ! V_28 ) ) {
F_43 ( V_2 ) ;
F_45 ( V_2 ) ;
return;
...
F_73 ( V_11 , F_28 ( V_24 ) * V_60 ) ;
}
static int F_74 ( int * V_45 , int * V_46 ,
const struct V_132 * V_133 ,
enum V_29 V_24 , bool V_147 )
{
T_5 V_15 = F_6 ( * V_45 , V_133 ) ;
if ( V_15 < 0 )
return V_15 ;
if ( ! F_72 ( V_15 , * V_46 , V_24 ) ) {
unsigned int V_148 = F_75 ( V_15 / * V_45 ) ;
unsigned int V_149 = F_32 ( V_24 ) +
V_65 - V_148 ;
...
static int F_77 ( struct V_1 * V_2 , struct V_33 * V_34 ,
struct V_12 * V_13 , struct V_128 * V_129 ,
struct V_151 * V_152 ,
const struct V_126 * V_127 )
{
T_5 V_15 ;
int V_41 = F_78 ( V_2 , V_34 , V_13 , V_129 , V_153 , V_152 ) ;
if ( V_41 < 0 ) {
F_79 ( V_34 , L_20 , V_26 ) ;
return V_41 ;
}
...
if ( ! F_72 ( V_15 , V_152 -> V_46 , V_2 -> V_24 ) ) {
F_79 ( V_34 , L_23 ,
V_26 , V_152 -> V_45 , V_152 -> V_46 ) ;
return - V_49 ;
}
return 0 ;
}
...
struct V_151 V_152 ;
int V_41 ;
V_41 = F_78 ( V_2 , V_34 , V_13 , V_129 , V_159 , V_155 ) ;
if ( V_41 < 0 ) {
F_59 ( V_34 , L_24 , V_26 ,
...
V_41 = F_74 ( & V_152 . V_45 , & V_152 . V_46 , V_127 -> V_18 , V_2 -> V_24 ,
false ) ;
if ( V_41 < 0 ) {
F_79 ( V_34 , L_26 ,
V_26 , V_152 . V_45 , V_152 . V_46 ,
...
if ( ! V_41 ) {
V_41 = F_77 ( V_2 , V_34 , V_13 , V_129 , & V_152 , V_127 ) ;
if ( V_41 < 0 ) {
F_79 ( V_34 , L_27 , V_26 ) ;
return V_41 ;
}
...
struct V_1 * V_2 = V_20 -> V_22 ;
int V_41 ;
V_41 = V_2 -> V_173 ( V_170 , V_28 , V_172 ) ;
if ( V_41 == - V_174 )
V_175 = true ;
return V_41 ;
}
...
V_13 -> V_21 , & V_2 -> V_98 ,
V_177 , V_178 ,
sizeof( struct V_27 ) , V_13 , & V_13 -> V_179 ) ;
else
F_87 ( V_170 , & V_176 ,
V_13 -> V_21 , & V_2 -> V_98 ,
V_177 , V_178 ,
sizeof( struct V_27 ) , V_13 , & V_13 -> V_179 ) ;
V_2 -> V_24 = V_175 ? V_74 : V_32 ;
...
struct V_27 * V_28 = F_19 ( V_13 -> V_184 . V_185 [ V_183 ] ,
struct V_27 , V_31 ) ;
V_28 -> V_43 = 0 ;
F_89 ( & V_28 -> V_31 . V_42 ) ;
}
...
( V_194 & V_199 ) ) {
if ( ! V_2 -> V_200 ||
V_2 -> V_200 -> V_97 & V_201 )
V_194 &= ~ V_199 ;
else
V_194 &= ~ V_198 ;
}
V_41 = V_13 -> V_195 -> V_202 ( V_13 , V_194 ) ;
if ( V_41 < 0 )
return V_41 ;
V_76 = F_40 ( V_2 , V_77 ) ;
if ( V_76 & V_82 )
...
if ( V_76 & V_82 )
F_41 ( V_2 , V_77 , V_76 ) ;
V_127 = F_82 ( V_13 , V_192 ) ;
V_133 = V_127 -> V_18 ;
V_78 = F_58 ( V_2 , V_79 ) & ~ ( V_83 | V_84 | V_85 ) ;
if ( V_133 -> V_204 == V_205 ) {
F_9 ( V_34 , L_33 ) ;
F_41 ( V_2 , V_79 , V_78 & ~ V_206 ) ;
} else {
F_9 ( V_34 , L_34 ) ;
F_41 ( V_2 , V_79 , V_78 | V_206 ) ;
}
...
static unsigned int F_94 ( struct V_207 * V_207 , T_7 * V_208 )
{
struct V_12 * V_13 = V_207 -> V_209 ;
struct V_27 * V_28 ;
V_28 = F_34 ( V_13 -> V_184 . V_210 . V_69 , struct V_27 ,
V_31 . V_210 ) ;
F_95 ( V_207 , & V_28 -> V_31 . V_91 , V_208 ) ;
if ( V_28 -> V_31 . V_37 == V_73 ||
V_28 -> V_31 . V_37 == V_58 )
return V_211 | V_212 ;
return 0 ;
}
static int T_8 F_96 ( struct V_213 * V_214 )
{
struct V_1 * V_2 ;
struct V_215 * V_216 ;
struct V_113 * V_113 ;
...
unsigned int V_99 ;
int V_217 = 0 ;
V_216 = F_97 ( V_214 , V_218 , 0 ) ;
V_99 = F_98 ( V_214 , 0 ) ;
if ( ! V_216 || ( int ) V_99 <= 0 ) {
V_217 = - V_219 ;
goto exit;
}
V_113 = F_99 ( & V_214 -> V_34 , L_35 ) ;
if ( F_100 ( V_113 ) ) {
V_217 = F_101 ( V_113 ) ;
goto exit;
}
V_2 = F_102 ( sizeof( * V_2 ) + F_103 ( V_216 ) , V_220 ) ;
if ( ! V_2 ) {
F_79 ( & V_214 -> V_34 , L_36 ) ;
V_217 = - V_174 ;
goto V_221;
}
V_2 -> V_216 = V_216 ;
V_2 -> V_113 = V_113 ;
V_2 -> V_200 = V_214 -> V_34 . V_222 ;
V_2 -> V_108 = V_2 -> V_200 -> V_97 ;
if ( V_2 -> V_200 )
V_2 -> V_118 = V_2 -> V_200 -> V_223 * 1000 ;
switch ( V_2 -> V_118 ) {
case 6000000 :
case 8000000 :
case 9600000 :
...
F_89 ( & V_2 -> V_68 ) ;
F_105 ( & V_2 -> V_98 ) ;
if ( ! F_106 ( V_216 -> V_224 , F_103 ( V_216 ) , V_225 ) ) {
V_217 = - V_112 ;
goto V_226;
}
V_6 = F_107 ( V_216 -> V_224 , F_103 ( V_216 ) ) ;
if ( ! V_6 ) {
V_217 = - V_174 ;
goto V_227;
}
...
V_2 -> V_6 = V_6 ;
F_61 ( V_2 , true ) ;
V_217 = F_108 ( V_228 , V_225 ,
F_54 , ( void * ) V_2 , & V_2 -> V_53 ) ;
if ( V_217 < 0 ) {
F_79 ( & V_214 -> V_34 , L_41 ) ;
V_217 = - V_112 ;
goto V_229;
}
F_9 ( & V_214 -> V_34 , L_42 , V_2 -> V_53 ) ;
F_109 ( V_2 -> V_53 , V_230 ,
V_231 , V_216 -> V_224 + V_232 ,
0 , 0 ) ;
F_110 ( V_2 -> V_53 , V_233 ) ;
F_111 ( V_2 -> V_53 , V_2 -> V_53 ) ;
V_217 = F_112 ( V_2 -> V_99 , F_57 , 0 , V_225 , V_2 ) ;
if ( V_217 ) {
F_79 ( & V_214 -> V_34 , L_43 ) ;
goto V_234;
}
V_2 -> V_235 . V_236 = V_225 ;
V_2 -> V_235 . V_195 = & V_237 ;
V_2 -> V_235 . V_22 = V_2 ;
V_2 -> V_235 . V_238 . V_34 = & V_214 -> V_34 ;
V_2 -> V_235 . V_239 = V_214 -> V_240 ;
V_217 = F_113 ( & V_2 -> V_235 ) ;
if ( V_217 )
goto V_241;
F_104 ( & V_214 -> V_34 , L_44 ) ;
return 0 ;
V_241:
F_114 ( V_2 -> V_99 , V_2 ) ;
V_234:
...
static int T_10 F_120 ( struct V_213 * V_214 )
{
struct V_19 * V_235 = F_7 ( & V_214 -> V_34 ) ;
struct V_1 * V_2 = F_19 ( V_235 ,
struct V_1 , V_235 ) ;
struct V_215 * V_216 ;
F_114 ( V_2 -> V_99 , V_2 ) ;
F_115 ( V_2 -> V_53 ) ;
