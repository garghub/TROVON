...
do {
F_88 ( V_209 ) ;
F_89 ( & V_149 . V_204 , V_206 ) ;
if ( ! F_90 ( & V_149 . V_204 ) )
V_149 . V_210 = NULL ;
if ( F_91 ( V_149 . V_210 ) )
F_92 () ;
F_93 ( & V_149 . V_204 ) ;
} while ( V_149 . V_210 && V_22 -> V_86 && ! F_94 ( V_208 ) );
F_95 ( V_211 ) ;
}
V_201 = F_1 () ;
V_22 -> V_88 += F_83 ( F_96 ( V_201 , V_200 ) ) ;
V_22 -> V_207 = F_85 ( V_199 , V_22 -> V_29 ) ;
}
...
V_22 -> V_212 += F_99 ( V_22 ) ;
}
static inline int F_100 ( const struct V_21 * V_22 , int V_214 )
{
...
static void F_103 ( struct V_21 * V_22 , int V_214 )
{
struct V_218 * V_219 = V_22 -> V_215 [ V_214 ] . V_219 ;
if ( ! V_219 ) {
V_219 = F_104 ( & V_171 , V_220 ,
( V_221 * ) & V_22 -> V_99 ,
( V_221 * ) & V_22 -> V_98 ,
V_222 ,
V_22 -> V_223 ,
...
static int F_113 ( struct V_234 * V_235 , struct V_21 * V_22 )
{
...
int V_150 ;
T_11 * V_245 ;
V_244 = V_219 -> V_225 . V_226 - F_119 ( V_235 ) ;
if ( V_244 > 0 ) {
V_150 = F_120 ( V_235 , V_244 , 0 , V_246 ) ;
if ( V_150 < 0 ) {
F_50 ( L_229 ,
V_150 ) ;
goto V_14;
...
F_121 ( V_235 , V_247 ) ;
V_150 = F_113 ( V_235 , V_22 ) ;
if ( V_150 ) {
F_50 ( L_230 , V_150 ) ;
goto V_14;
}
V_245 = ( T_11 * ) F_122 ( V_235 , V_247 ) ;
...
static void F_124 ( V_231 * V_249 , struct V_21 * V_22 )
{
unsigned V_60 ;
for ( V_60 = 0 ; V_60 < V_22 -> V_59 ; V_60 ++ )
...
static inline T_10 F_125 ( unsigned int V_250 , unsigned int V_251 ,
unsigned int V_252 )
{
return F_126 ( V_250 | ( V_251 << 12 ) | ( V_252 << 13 ) ) ;
}
static void F_127 ( struct V_21 * V_22 , struct V_234 * V_235 ,
int V_253 )
{
struct V_254 V_255 ;
struct V_256 * V_257 ;
V_257 = (struct V_256 * ) F_128 ( V_235 , sizeof( * V_257 ) ) ;
V_253 -= sizeof( * V_257 ) ;
if ( V_22 -> V_28 <= 0 ) {
memset ( F_128 ( V_235 , V_253 ) , 0 , V_253 ) ;
} else {
int V_258 = V_22 -> V_28 ;
int V_60 , V_114 ;
int V_259 ;
...
if ( V_114 > 0 ) {
memset ( F_128 ( V_235 , V_114 ) , 0 , V_114 ) ;
V_253 = V_258 * V_261 ;
}
V_60 = 0 ;
...
V_70 = V_22 -> V_70 ;
V_22 -> V_136 = F_131 ( V_70 , V_262 | V_263 , 0 ) ;
if ( ! V_22 -> V_136 )
break;
}
F_132 ( V_235 ) -> V_258 [ V_60 ] . V_136 = V_22 -> V_136 ;
F_133 ( V_22 -> V_136 ) ;
F_132 ( V_235 ) -> V_258 [ V_60 ] . V_264 = 0 ;
if ( V_60 == ( V_258 - 1 ) )
F_132 ( V_235 ) -> V_258 [ V_60 ] . V_265 =
( V_253 < V_261 ? V_253 : V_261 ) ;
else
F_132 ( V_235 ) -> V_258 [ V_60 ] . V_265 = V_259 ;
V_253 -= F_132 ( V_235 ) -> V_258 [ V_60 ] . V_265 ;
V_235 -> V_114 += F_132 ( V_235 ) -> V_258 [ V_60 ] . V_265 ;
V_235 -> V_266 += F_132 ( V_235 ) -> V_258 [ V_60 ] . V_265 ;
V_60 ++ ;
F_132 ( V_235 ) -> V_267 = V_60 ;
}
}
V_257 -> V_268 = F_31 ( V_269 ) ;
V_257 -> V_93 = F_31 ( V_22 -> V_93 ) ;
F_134 ( & V_255 ) ;
V_257 -> V_270 = F_31 ( V_255 . V_270 ) ;
V_257 -> V_271 = F_31 ( V_255 . V_271 ) ;
}
static struct V_234 * F_135 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
...
V_70 = F_130 () ;
V_235 = F_136 ( V_286 + V_22 -> V_130 + 64
+ V_253 + V_22 -> V_212 , V_287 , 0 , V_70 ) ;
if ( F_91 ( V_235 ) ) {
F_137 ( V_235 , V_286 ) ;
V_235 -> V_163 = V_50 ;
}
...
F_139 ( V_235 -> V_15 ) ;
F_137 ( V_235 , V_253 ) ;
V_245 = ( T_11 * ) F_122 ( V_235 , 14 ) ;
V_249 = ( V_231 * ) F_128 ( V_235 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_124 ( V_249 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_280 = ( T_10 * ) F_128 ( V_235 , sizeof( T_10 ) ) ;
* V_280 = F_125 ( V_22 -> V_65 ,
V_22 -> V_67 ,
V_22 -> V_66 ) ;
V_281 = ( T_10 * ) F_128 ( V_235 , sizeof( T_10 ) ) ;
* V_281 = F_126 ( V_284 ) ;
}
V_278 = ( T_10 * ) F_128 ( V_235 , sizeof( T_10 ) ) ;
* V_278 = F_125 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_279 = ( T_10 * ) F_128 ( V_235 , sizeof( T_10 ) ) ;
* V_279 = F_126 ( V_277 ) ;
}
V_235 -> V_288 = V_235 -> V_289 ;
V_235 -> V_290 = V_235 -> V_288 + sizeof( struct V_275 ) ;
F_128 ( V_235 , sizeof( struct V_275 ) + sizeof( struct V_272 ) ) ;
F_140 ( V_235 , V_282 ) ;
V_235 -> V_291 = V_22 -> V_36 ;
V_276 = F_141 ( V_235 ) ;
V_273 = F_142 ( V_235 ) ;
memcpy ( V_245 , V_22 -> V_143 , 12 ) ;
* ( T_10 * ) & V_245 [ 12 ] = V_243 ;
...
V_273 -> V_292 = F_126 ( V_22 -> V_101 ) ;
V_273 -> V_293 = F_126 ( V_22 -> V_100 ) ;
V_273 -> V_114 = F_126 ( V_253 + 8 ) ;
V_273 -> V_294 = 0 ;
V_276 -> V_295 = 5 ;
V_276 -> V_9 = 4 ;
V_276 -> V_296 = 32 ;
...
V_276 -> V_250 = F_126 ( V_22 -> V_300 ) ;
V_22 -> V_300 ++ ;
V_276 -> V_301 = 0 ;
V_274 = 20 + 8 + V_253 ;
V_276 -> V_302 = F_126 ( V_274 ) ;
V_276 -> V_294 = 0 ;
V_276 -> V_294 = F_143 ( ( void * ) V_276 , V_276 -> V_295 ) ;
V_235 -> V_243 = V_243 ;
V_235 -> V_303 = ( V_235 -> V_288 - V_247 -
V_22 -> V_212 ) ;
V_235 -> V_163 = V_50 ;
V_235 -> V_304 = V_305 ;
F_127 ( V_22 , V_235 , V_253 ) ;
#ifdef F_21
if ( ! F_118 ( V_22 , V_235 , V_243 ) )
return NULL ;
#endif
return V_235 ;
}
static unsigned int F_39 ( const char * V_232 , char V_306 [ 16 ] )
{
unsigned int V_60 ;
...
V_307 = F_144 ( V_232 , & V_311 , 16 ) ;
V_60 = V_311 - V_232 ;
if ( ! V_60 )
return 0 ;
if ( V_309 == 12 && V_232 [ V_60 ] == '.' ) {
V_115 = F_38 ( V_232 ) ;
...
static struct V_234 * F_146 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
struct V_234 * V_235 = NULL ;
T_11 * V_245 ;
...
V_235 -> V_288 = V_235 -> V_289 ;
V_235 -> V_290 = V_235 -> V_288 + sizeof( struct V_313 ) ;
F_128 ( V_235 , sizeof( struct V_313 ) + sizeof( struct V_272 ) ) ;
F_140 ( V_235 , V_282 ) ;
V_235 -> V_291 = V_22 -> V_36 ;
V_276 = F_147 ( V_235 ) ;
V_273 = F_142 ( V_235 ) ;
...
V_273 -> V_292 = F_126 ( V_22 -> V_101 ) ;
V_273 -> V_293 = F_126 ( V_22 -> V_100 ) ;
V_273 -> V_114 = F_126 ( V_253 + sizeof( struct V_272 ) ) ;
V_273 -> V_294 = 0 ;
* ( V_231 * ) V_276 = F_31 ( 0x60000000 ) ;
if ( V_22 -> V_69 ) {
* ( V_231 * ) V_276 |= F_31 ( 0x60000000 | ( V_22 -> V_69 << 20 ) ) ;
}
V_276 -> V_315 = 32 ;
V_276 -> V_316 = F_126 ( sizeof( struct V_272 ) + V_253 ) ;
V_276 -> V_317 = V_297 ;
F_40 ( & V_276 -> V_299 , & V_22 -> V_97 ) ;
F_40 ( & V_276 -> V_298 , & V_22 -> V_96 ) ;
V_235 -> V_303 = ( V_235 -> V_288 - V_247 -
V_22 -> V_212 ) ;
V_235 -> V_243 = V_243 ;
V_235 -> V_163 = V_50 ;
...
static struct V_234 * F_149 ( struct V_162 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
...
static void F_150 ( struct V_148 * V_149 )
{
struct V_21 * V_22 ;
int V_319 = 0 ;
F_151 () ;
...
static int F_152 ( const struct V_148 * V_149 )
{
const struct V_21 * V_22 ;
F_47 (pkt_dev, &t->if_list, list)
if ( V_22 -> V_86 )
...
static int F_153 ( struct V_148 * V_149 )
{
F_46 ( V_149 ) ;
while ( F_152 ( V_149 ) ) {
F_48 ( V_149 ) ;
...
{
int V_267 = V_22 -> V_235 ? F_132 ( V_22 -> V_235 ) -> V_267 : - 1 ;
if ( ! V_22 -> V_86 ) {
F_13 ( L_237 ,
V_22 -> V_31 ) ;
return - V_125 ;
...
static struct V_21 * F_160 ( struct V_148 * V_149 )
{
...
if ( V_328 == NULL )
V_328 = V_22 ;
else if ( F_4 ( V_22 -> V_207 , V_328 -> V_207 ) )
V_328 = V_22 ;
}
F_48 ( V_149 ) ;
return V_328 ;
...
F_46 ( V_149 ) ;
F_163 (q, n, &t->if_list) {
V_331 = F_164 ( V_330 , struct V_21 , V_332 ) ;
if ( ! V_331 -> V_157 )
continue;
F_123 ( V_331 -> V_235 ) ;
V_331 -> V_235 = NULL ;
...
static void F_166 ( struct V_148 * V_149 )
{
struct V_329 * V_330 , * V_113 ;
struct V_21 * V_331 ;
F_151 () ;
...
{
F_62 ( V_149 -> V_333 -> V_334 , V_165 ) ;
}
static void F_168 ( struct V_21 * V_22 )
{
T_1 V_335 = F_1 () ;
F_92 () ;
V_22 -> V_88 += F_83 ( F_96 ( F_1 () , V_335 ) ) ;
}
static void F_169 ( struct V_21 * V_22 )
{
T_1 V_335 = F_1 () ;
while ( F_170 ( & ( V_22 -> V_235 -> V_336 ) ) != 1 ) {
if ( F_94 ( V_208 ) )
break;
if ( F_171 () )
F_168 ( V_22 ) ;
...
T_13 (* F_174)( struct V_234 * , struct V_162 * )
= V_50 -> V_337 -> V_338 ;
struct V_339 * V_340 ;
V_248 V_282 ;
int V_150 ;
...
V_22 -> V_207 = F_85 ( F_1 () , V_341 ) ;
return;
}
if ( ! V_22 -> V_235 || ( V_22 -> V_342 &&
...
V_22 -> V_344 = V_22 -> V_235 -> V_114 ;
V_22 -> V_345 ++ ;
V_22 -> V_343 = 0 ;
}
if ( V_22 -> V_29 && V_22 -> V_342 )
F_80 ( V_22 , V_22 -> V_207 ) ;
V_282 = F_176 ( V_22 -> V_235 ) ;
V_340 = F_177 ( V_50 , V_282 ) ;
F_178 ( V_340 ) ;
if ( F_129 ( F_179 ( V_340 ) ) ) {
V_150 = V_346 ;
V_22 -> V_342 = 0 ;
goto V_347;
}
F_180 ( & ( V_22 -> V_235 -> V_336 ) ) ;
V_150 = (* F_174)( V_22 -> V_235 , V_50 ) ;
switch ( V_150 ) {
case V_348 :
F_181 ( V_340 ) ;
V_22 -> V_342 = 1 ;
...
F_186 ( & V_149 -> V_356 ) ;
F_187 ( & V_149 -> V_357 ) ;
F_60 ( L_240 , V_355 , F_188 ( V_208 ) ) ;
F_88 ( V_209 ) ;
F_189 () ;
while ( ! F_190 () ) {
V_22 = F_160 ( V_149 ) ;
if ( F_129 ( ! V_22 && V_149 -> V_152 == 0 ) ) {
if ( V_358 )
break;
F_191 ( V_149 -> V_356 ,
V_149 -> V_152 != 0 ,
...
F_60 ( L_241 , V_149 -> V_333 -> V_334 ) ;
F_161 ( V_149 ) ;
F_60 ( L_242 , V_149 -> V_333 -> V_334 ) ;
F_166 ( V_149 ) ;
F_60 ( L_243 , V_149 -> V_333 -> V_334 ) ;
F_167 ( V_149 ) ;
while ( ! F_190 () ) {
F_88 ( V_209 ) ;
F_92 () ;
...
static int F_193 ( struct V_148 * V_149 ,
struct V_21 * V_22 )
{
int V_360 = 0 ;
F_46 ( V_149 ) ;
...
V_22 -> V_215 = F_197 ( V_145 * sizeof( struct V_365 ) ,
V_70 ) ;
if ( V_22 -> V_215 == NULL ) {
F_198 ( V_22 ) ;
return - V_364 ;
...
static int T_14 F_200 ( int V_355 )
{
struct V_148 * V_149 ;
struct V_374 * V_375 ;
struct V_376 * V_326 ;
V_149 = F_196 ( sizeof( struct V_148 ) , V_262 ,
F_195 ( V_355 ) ) ;
if ( ! V_149 ) {
F_50 ( L_248 ) ;
return - V_364 ;
...
F_209 ( V_326 , V_355 ) ;
V_149 -> V_333 = V_326 ;
V_375 = F_63 ( V_149 -> V_333 -> V_334 , 0600 , V_165 ,
& V_379 , V_149 ) ;
if ( ! V_375 ) {
F_50 ( L_247 ,
V_371 , V_149 -> V_333 -> V_334 ) ;
F_210 ( V_326 ) ;
F_207 ( & V_149 -> V_377 ) ;
F_198 ( V_149 ) ;
return - V_125 ;
...
static void F_213 ( struct V_148 * V_149 ,
struct V_21 * V_22 )
{
struct V_329 * V_330 , * V_113 ;
struct V_21 * V_326 ;
F_163 (q, n, &t->if_list) {
V_326 = F_164 ( V_330 , struct V_21 , V_332 ) ;
if ( V_326 == V_22 )
F_207 ( & V_326 -> V_332 ) ;
}
}
...
int V_150 = 0 ;
F_35 ( L_253 , V_9 ) ;
V_165 = F_215 ( V_371 , V_171 . V_380 ) ;
if ( ! V_165 )
return - V_177 ;
V_375 = F_216 ( V_381 , 0600 , V_165 , & V_382 ) ;
if ( V_375 == NULL ) {
F_50 ( L_254 , V_381 ) ;
V_150 = - V_125 ;
goto V_383;
...
V_149 = F_164 ( V_330 , struct V_148 , V_377 ) ;
F_210 ( V_149 -> V_333 ) ;
F_198 ( V_149 ) ;
}
F_220 ( & V_384 ) ;
