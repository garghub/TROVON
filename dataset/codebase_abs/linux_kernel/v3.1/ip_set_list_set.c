...
{
const struct V_2 * V_76 = V_30 -> V_20 ;
const struct V_2 * V_77 = V_31 -> V_20 ;
return V_76 -> V_23 == V_77 -> V_23 &&
V_76 -> V_9 == V_77 -> V_9 ;
}
static void
F_46 ( unsigned long V_78 )
{
...
F_21 ( V_3 ) ;
F_48 ( & V_11 -> V_79 ) ;
V_3 -> V_61 . V_80 = V_81 + F_49 ( V_3 -> V_9 ) * V_82 ;
F_50 ( & V_3 -> V_61 ) ;
}
static void
...
static bool
F_53 ( struct V_10 * V_11 , T_1 V_23 , T_3 V_6 ,
unsigned long V_9 )
{
struct V_2 * V_3 ;
struct V_1 * V_29 ;
T_1 V_21 ;
V_3 = F_54 ( sizeof( * V_3 ) + V_23 * V_6 , V_84 ) ;
if ( ! V_3 )
return false ;
V_3 -> V_23 = V_23 ;
V_3 -> V_6 = V_6 ;
