...
V_25 == V_104 )
continue;
F_11 ( V_7 , V_25 , V_168 [ V_25 ] ) ;
}
for ( V_25 = V_172 ; V_25 < V_173 ; V_25 += 2 )
F_11 ( V_7 , V_25 , V_168 [ V_25 ] ) ;
F_11 ( V_7 , V_141 ,
V_168 [ V_141 ] ) ;
F_11 ( V_7 , V_13 ,
...
int V_180 ;
struct V_41 * V_42 = F_14 ( V_7 ) ;
V_176 = F_48 ( V_42 -> V_164 [ V_181 ] . V_182 ) ;
V_177 = F_48 ( V_42 -> V_164 [ V_183 ] . V_182 ) ;
V_175 = F_48 ( V_42 -> V_164 [ V_184 ] . V_182 ) ;
V_176 = V_176 / 1000 ;
V_177 = V_177 / 1000 ;
V_175 = V_175 / 1000 ;
if ( V_176 <= 0 || V_177 <= 0 || V_175 < 0 ) {
F_17 ( V_7 -> V_83 , L_8 ) ;
return - V_49 ;
}
if ( V_176 > 3600 || V_177 > 3600 || V_175 > 1980 ) {
F_17 ( V_7 -> V_83 ,
L_9 ,
V_176 , V_177 , V_175 ) ;
return - V_49 ;
...
V_185 ;
V_179 = F_8 ( V_7 , V_141 ) ;
if ( V_177 < 3100 && V_176 < 3100 ) {
F_2 ( V_7 , V_100 ,
V_186 ,
V_186 ) ;
V_178 |= V_187 ;
} else if ( V_177 >= 3100 && V_176 >= 3100 ) {
F_2 ( V_7 , V_13 ,
V_187 , 0 ) ;
V_179 |= V_188 ;
V_179 |= V_189 <<
...
if ( V_180 <= V_192 )
V_180 = 0 ;
else if ( V_180 >= V_192 + V_193 *
( V_194 >> V_195 ) )
V_180 = V_194 >> V_195 ;
else
V_180 = ( V_180 - V_192 ) / V_193 ;
F_2 ( V_7 , V_174 ,
V_180 << V_195 ,
V_180 << V_195 ) ;
V_180 = V_177 / 2 ;
...
struct V_41 * V_42 = F_14 ( V_7 ) ;
int V_116 ;
V_116 = F_28 ( V_7 , & V_202 , V_203 ) ;
if ( V_116 ) {
F_17 ( V_7 -> V_83 ,
L_10 , V_116 ) ;
return V_116 ;
}
V_42 -> V_164 [ V_184 ] . V_204 = V_205 ;
V_116 = F_50 ( V_7 -> V_83 , F_40 ( V_42 -> V_164 ) ,
V_42 -> V_164 ) ;
if ( V_116 ) {
F_36 ( V_7 ) ;
F_17 ( V_7 -> V_83 , L_11 , V_116 ) ;
return V_116 ;
}
F_51 ( V_7 -> V_83 , L_12 ) ;
return 0 ;
}
static int F_52 ( struct V_24 * V_7 )
{
T_1 V_25 ;
int V_116 ;
int V_206 ;
...
int V_208 = 0 ;
struct V_41 * V_42 = F_14 ( V_7 ) ;
for ( V_207 = 0 ; V_207 < F_40 ( V_42 -> V_164 ) ; V_207 ++ )
V_42 -> V_164 [ V_207 ] . V_204 = V_209 [ V_207 ] ;
V_116 = F_50 ( V_7 -> V_83 , F_40 ( V_42 -> V_164 ) ,
V_42 -> V_164 ) ;
if ( ! V_116 )
V_208 = 1 ;
...
V_206 = ( V_25 & V_216 ) >> V_217 ;
F_51 ( V_7 -> V_83 , L_14 , V_206 ) ;
if ( V_208 && V_206 >= 0x11 ) {
F_42 ( F_40 ( V_42 -> V_164 ) ,
V_42 -> V_164 ) ;
F_53 ( F_40 ( V_42 -> V_164 ) ,
V_42 -> V_164 ) ;
V_116 = F_49 ( V_7 ) ;
if ( V_116 )
return V_116 ;
...
static int F_54 ( struct V_24 * V_7 )
{
int V_116 ;
struct V_41 * V_42 = F_14 ( V_7 ) ;
V_116 = F_55 ( V_7 , 16 , 16 , V_218 ) ;
if ( V_116 < 0 ) {
F_17 ( V_7 -> V_83 , L_15 , V_116 ) ;
return V_116 ;
}
V_116 = F_52 ( V_7 ) ;
if ( V_116 )
...
F_56 ( V_7 , V_233 ,
F_40 ( V_233 ) ) ;
F_57 ( & V_7 -> V_161 , V_234 ,
F_40 ( V_234 ) ) ;
F_58 ( & V_7 -> V_161 , V_235 ,
F_40 ( V_235 ) ) ;
F_59 ( & V_7 -> V_161 ) ;
return 0 ;
V_219:
...
static int F_60 ( struct V_24 * V_7 )
{
struct V_41 * V_42 = F_14 ( V_7 ) ;
F_38 ( V_7 , V_163 ) ;
F_42 ( F_40 ( V_42 -> V_164 ) ,
...
static T_4 int F_61 ( struct V_236 * V_237 ,
...
return - V_147 ;
F_62 ( V_237 , V_42 ) ;
V_116 = F_63 ( & V_237 -> V_83 ,
& V_240 , & V_241 , 1 ) ;
if ( V_116 ) {
F_17 ( & V_237 -> V_83 , L_16 , V_116 ) ;
F_32 ( V_42 ) ;
return V_116 ;
}
return 0 ;
}
static T_5 int F_64 ( struct V_236 * V_237 )
{
struct V_41 * V_42 = F_65 ( V_237 ) ;
F_66 ( & V_237 -> V_83 ) ;
F_32 ( V_42 ) ;
return 0 ;
}
