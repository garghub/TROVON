...
static T_6 F_47 ( struct V_32 * V_12 , struct V_69 * V_96 ,
char * V_71 )
{
struct V_1 * V_2 = F_13 ( V_12 ) ;
...
static int F_49 ( struct V_1 * V_100 ,
struct V_101 * V_102 )
{
struct V_103 * V_4 = V_100 -> V_4 ;
int V_104 = V_100 -> V_5 ;
const char * V_105 = NULL ;
int V_106 , V_107 , V_108 , V_109 , V_110 ;
if ( ! F_50 ( V_4 , V_111 ) )
return - V_112 ;
if ( ( V_106 = F_5 ( V_100 ,
V_113 ) ) < 0
...
V_115 ) ) < 0 )
return - V_112 ;
if ( V_106 == 0x01 || V_106 == 0x5C || V_106 == 0x41 ) {
V_109 = F_5 ( V_100 ,
V_116 ) ;
if ( V_109 < 0 )
return - V_112 ;
...
return - V_112 ;
if ( V_107 == V_106
&& ( V_104 == 0x4C || V_104 == 0x4D || V_104 == 0x4E )
&& ( V_108 & 0x1F ) == ( V_106 & 0x0F )
&& V_110 <= 0x09 ) {
if ( V_104 == 0x4C )
V_105 = L_16 ;
else
...
F_18 ( & V_4 -> V_12 ,
L_23
L_24 , V_104 , V_106 , V_107 ) ;
return - V_112 ;
}
F_52 ( V_102 -> type , V_105 , V_121 ) ;
return 0 ;
}
static void F_53 ( struct V_1 * V_2 , struct V_18 * V_19 )
{
if ( V_19 -> V_6 & V_122 )
F_54 ( & V_2 -> V_12 . V_123 , & V_124 ) ;
if ( V_19 -> V_6 & V_125 )
F_54 ( & V_2 -> V_12 . V_123 ,
& V_126 ) ;
if ( V_19 -> V_6 & V_60 )
...
& V_128 . V_129 ) ;
F_55 ( & V_2 -> V_12 , & V_130 ) ;
F_54 ( & V_2 -> V_12 . V_123 , & V_131 ) ;
}
static void F_56 ( struct V_1 * V_2 )
{
T_2 V_21 , V_132 ;
struct V_18 * V_19 = F_14 ( V_2 ) ;
if ( F_3 ( V_2 , V_115 , & V_132 ) < 0 ) {
F_6 ( & V_2 -> V_12 , L_25 ) ;
V_132 = V_133 ;
}
V_19 -> V_134 = V_132 ;
...
static int F_57 ( struct V_1 * V_100 ,
const struct V_136 * V_137 )
{
struct V_103 * V_4 = F_58 ( V_100 -> V_12 . V_138 ) ;
struct V_18 * V_19 ;
int V_11 ;
V_19 = F_59 ( sizeof( struct V_18 ) , V_139 ) ;
if ( ! V_19 ) {
V_11 = - V_140 ;
goto exit;
}
F_60 ( V_100 , V_19 ) ;
F_61 ( & V_19 -> V_34 ) ;
V_19 -> V_22 = V_137 -> V_141 ;
if ( V_19 -> V_22 == V_142 ) {
if ( ! F_50 ( V_4 , V_117 ) )
V_100 -> V_6 &= ~ V_7 ;
}
V_19 -> V_66 = V_143 [ V_19 -> V_22 ] . V_66 ;
V_19 -> V_6 = V_143 [ V_19 -> V_22 ] . V_6 ;
V_19 -> V_47 = V_143 [ V_19 -> V_22 ] . V_47 ;
V_19 -> V_30 = V_143 [ V_19 -> V_22 ] . V_30 ;
F_56 ( V_100 ) ;
V_11 = F_62 ( & V_100 -> V_12 . V_123 , & V_131 ) ;
if ( V_11 )
goto V_144;
if ( V_100 -> V_6 & V_7 ) {
V_11 = F_63 ( & V_100 -> V_12 , & V_130 ) ;
if ( V_11 )
goto V_145;
}
if ( V_19 -> V_6 & V_57 ) {
V_11 = F_63 ( & V_100 -> V_12 ,
& V_128 . V_129 ) ;
if ( V_11 )
goto V_145;
}
if ( V_19 -> V_6 & V_60 ) {
V_11 = F_62 ( & V_100 -> V_12 . V_123 ,
& V_127 ) ;
if ( V_11 )
goto V_145;
}
...
V_19 -> V_146 = F_64 ( & V_100 -> V_12 ) ;
if ( F_65 ( V_19 -> V_146 ) ) {
V_11 = F_66 ( V_19 -> V_146 ) ;
goto V_145;
}
return 0 ;
V_145:
...
static void F_70 ( struct V_1 * V_2 , unsigned int V_147 )
{
struct V_18 * V_19 = F_14 ( V_2 ) ;
T_2 V_21 , V_39 , V_148 = 0 ;
F_3 ( V_2 , V_63 , & V_39 ) ;
if ( V_19 -> V_22 == V_23 )
F_3 ( V_2 , V_64 , & V_148 ) ;
if ( ( V_39 & 0x7f ) == 0 && ( V_148 & 0xfe ) == 0 ) {
F_51 ( & V_2 -> V_12 , L_27 ) ;
} else {
if ( V_39 & 0x61 )
F_6 ( & V_2 -> V_12 ,
