...
if ( V_278 & V_287 )
F_121 ( V_45 , F_11 ( V_1 + V_17 ) & V_288 ) ;
V_281:
F_22 ( V_25 ) ;
return 0 ;
}
...
static void F_14 ( struct V_26 * V_64 , int V_305 )
{
void T_1 * V_1 ;
if ( V_305 < 0 || V_305 > 2 )
return;
...
V_305 |= V_335 ;
F_5 ( V_1 , V_336 , ( T_2 ) V_305 ) ;
if ( F_40 ( V_64 -> V_139 ) && V_298 >= 921600 )
return - 1 ;
V_298 = F_136 ( V_64 , V_298 ) ;
if ( V_318 -> V_300 & ( V_301 | V_302 | V_303 ) ) {
F_86 ( & V_10 ) ;
F_32 ( V_318 -> V_337 [ V_338 ] , V_1 + V_11 ) ;
F_32 ( V_318 -> V_337 [ V_339 ] , V_1 + V_340 ) ;
F_32 ( V_341 , V_1 + V_5 ) ;
F_1 ( V_1 ) ;
F_87 ( & V_10 ) ;
}
...
static int F_24 ( struct V_26 * V_379 ,
...
return F_13 ( V_381 , & V_44 , sizeof( * V_381 ) ) ? - V_40 : 0 ;
}
static int F_26 ( struct V_26 * V_379 ,
