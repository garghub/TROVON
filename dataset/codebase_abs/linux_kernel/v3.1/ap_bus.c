...
F_60 ( & V_94 -> V_91 ) ;
V_41 -> V_96 -- ;
V_41 -> V_43 -> V_97 ( V_41 , V_94 , F_61 ( - V_3 ) ) ;
}
...
static int F_112 ( struct V_40 * V_41 , unsigned long * V_71 )
{
struct V_4 V_12 ;
struct V_93 * V_94 ;
if ( V_41 -> V_45 <= 0 )
...
F_113 ( & V_99 ) ;
F_28 ( V_41 ) ;
F_114 (ap_msg, &ap_dev->pendingq, list) {
if ( V_94 -> V_30 != V_41 -> V_118 -> V_30 )
continue;
F_60 ( & V_94 -> V_91 ) ;
V_41 -> V_96 -- ;
V_41 -> V_43 -> V_97 ( V_41 , V_94 , V_41 -> V_118 ) ;
break;
}
if ( V_41 -> V_45 > 0 )
* V_71 |= 1 ;
...
static int F_116 ( struct V_40 * V_41 , unsigned long * V_71 )
{
struct V_4 V_12 ;
struct V_93 * V_94 ;
if ( V_41 -> V_98 <= 0 ||
V_41 -> V_45 >= V_41 -> V_6 )
return 0 ;
V_94 = F_117 ( V_41 -> V_134 . V_95 , struct V_93 , V_91 ) ;
...
static inline int F_120 ( struct V_40 * V_41 , unsigned long * V_71 )
{
int V_28 ;
V_28 = F_112 ( V_41 , V_71 ) ;
if ( V_28 )
return V_28 ;
return F_116 ( V_41 , V_71 ) ;
}
static int F_121 ( struct V_40 * V_41 , struct V_93 * V_94 )
{
struct V_4 V_12 ;
if ( F_122 ( & V_41 -> V_134 ) &&
V_41 -> V_45 < V_41 -> V_6 ) {
...
case V_34 :
case V_17 :
F_123 ( & V_94 -> V_91 , & V_41 -> V_134 ) ;
V_41 -> V_98 ++ ;
V_41 -> V_57 ++ ;
return - V_24 ;
case V_35 :
case V_146 :
V_41 -> V_43 -> V_97 ( V_41 , V_94 , F_61 ( - V_25 ) ) ;
return - V_25 ;
default:
V_41 -> V_43 -> V_97 ( V_41 , V_94 , F_61 ( - V_3 ) ) ;
return - V_3 ;
...
void F_124 ( struct V_40 * V_41 , struct V_93 * V_94 )
{
unsigned long V_71 ;
int V_28 ;
F_33 ( & V_41 -> V_56 ) ;
if ( ! V_41 -> V_76 ) {
V_28 = F_120 ( V_41 , & V_71 ) ;
if ( ! V_28 )
V_28 = F_121 ( V_41 , V_94 ) ;
if ( ! V_28 )
F_125 ( & V_147 ) ;
if ( V_28 == - V_3 )
V_41 -> V_76 = 1 ;
...
void F_126 ( struct V_40 * V_41 , struct V_93 * V_94 )
{
struct V_93 * V_148 ;
F_33 ( & V_41 -> V_56 ) ;
if ( ! F_122 ( & V_94 -> V_91 ) ) {
F_114 (tmp, &ap_dev->pendingq, list)
...
static enum F_111 F_127 ( struct V_150 * V_129 )
{
F_52 ( & V_75 ) ;
return V_151 ;
}
...
static void F_129 ( unsigned long V_39 )
{
unsigned long V_71 ;
struct V_40 * V_41 ;
if ( F_1 () )
...
V_71 = 0 ;
F_131 ( & V_90 ) ;
F_114 (ap_dev, &ap_device_list, list) {
F_131 ( & V_41 -> V_56 ) ;
F_44 ( V_41 , & V_71 ) ;
F_132 ( & V_41 -> V_56 ) ;
}
...
F_142 ( & V_159 ) ;
if ( ! V_107 ) {
V_107 = F_143 ( F_133 , NULL , L_18 ) ;
V_28 = F_144 ( V_107 ) ? F_145 ( V_107 ) : 0 ;
if ( V_28 )
V_107 = NULL ;
}
else
...
V_28 = F_157 ( & V_104 , V_161 [ V_13 ] ) ;
if ( V_28 )
goto V_162;
}
V_139 = F_158 ( L_22 ) ;
V_28 = F_144 ( V_139 ) ? F_145 ( V_139 ) : 0 ;
if ( V_28 )
goto V_162;
V_74 = F_49 ( L_15 ) ;
if ( ! V_74 ) {
...
static int F_166 ( struct V_50 * V_51 , void * V_81 )
{
return 1 ;
}
void F_167 ( void )
