...
struct V_107 V_67 ;
struct V_2 * V_3 = NULL ;
V_133 = F_88 ( V_178 -> V_180 . V_183 ) ;
if ( V_133 )
return V_133 ;
if ( ( ! F_89 ( V_11 -> V_184 ) ) || ! ( V_178 -> V_185 & V_186 ) )
goto V_27;
if ( V_11 -> V_187 & ( V_188 | V_189 ) ) {
V_133 = - V_190 ;
goto V_27;
}
V_3 = F_90 ( sizeof( struct V_2 ) , V_191 ) ;
if ( ! V_3 ) {
V_133 = - V_31 ;
F_6 ( V_133 ) ;
goto V_27;
...
V_3 -> V_26 = V_178 ;
if ( V_179 ) {
if ( F_91 ( & V_67 , (struct V_107 * ) V_179 ,
sizeof( V_67 ) ) ) {
V_133 = - V_192 ;
goto V_27;
}
...
V_27:
if ( V_179 ) {
if ( F_93 ( (struct V_107 * ) V_179 , & V_67 ,
sizeof( V_67 ) ) )
V_133 = - V_192 ;
}
F_94 ( V_3 ) ;
F_95 ( V_178 -> V_180 . V_183 ) ;
return V_133 ;
}
