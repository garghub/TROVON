...
static void F_111 ( struct V_146 * V_4 )
{
struct V_2 * V_3 = F_109 ( & V_4 -> V_37 ) ;
struct V_20 * V_21 ;
F_103 ( F_2 ( V_4 ) ) ;
...
static void F_112 ( struct V_37 * V_160 ,
struct V_161 * V_7 )
{
if ( F_113 ( V_7 -> V_162 ) )
F_114 ( V_160 , F_115 ( V_7 -> V_162 ) ,
F_113 ( V_7 -> V_162 ) ,
V_7 -> V_162 -> V_163 ) ;
...
static unsigned int F_116 ( T_6 * V_22 , T_6 * V_167 )
{
int V_168 ;
V_167 [ 0 ] = 0x70 ;
V_167 [ 1 ] = 0x0 ;
...
static void F_117 ( struct V_6 * V_50 ,
struct V_22 * V_23 )
{
struct V_161 * V_7 =
...
if ( V_177 == V_175 << 16 && F_119 ( * V_23 ) > 1 )
V_177 = F_116 ( F_120 ( * V_23 ) ,
V_7 -> V_162 -> V_183 ) ;
} else {
V_177 = V_180 << 16 ;
F_55 ( V_7 -> V_21 ) ;
...
F_48 ( V_37 -> V_9 -> V_37 , V_7 -> V_52 . V_31 ,
sizeof( V_7 -> V_11 ) , V_72 ) ;
F_112 ( V_37 -> V_9 -> V_37 , V_7 ) ;
V_7 -> V_162 -> V_177 = V_177 ;
V_7 -> V_162 -> V_184 ( V_7 -> V_162 ) ;
}
static int F_121 ( struct V_161 * V_7 ,
struct V_1 * V_37 , struct V_20 * V_21 )
{
struct V_185 * V_186 = F_115 ( V_7 -> V_162 ) ;
int V_139 , V_187 ;
V_187 = F_122 ( V_37 -> V_9 -> V_37 , V_186 , F_113 ( V_7 -> V_162 ) ,
V_7 -> V_162 -> V_163 ) ;
if ( V_187 == 0 )
goto V_188;
if ( V_187 == 1 ) {
...
F_21 ( F_123 ( V_186 ) ) ;
V_7 -> V_11 . V_64 |=
F_21 ( F_124 ( F_125 ( V_186 ) ) ) ;
return 0 ;
}
F_126 (sg, sg, n, i) {
V_7 -> V_166 [ V_139 ] . V_40 = F_21 ( F_125 ( V_186 ) << 16 ) ;
V_7 -> V_166 [ V_139 ] . V_41 = F_21 ( F_123 ( V_186 ) ) ;
}
V_7 -> V_165 =
...
return 0 ;
V_190:
F_114 ( V_37 -> V_9 -> V_37 , F_115 ( V_7 -> V_162 ) ,
F_113 ( V_7 -> V_162 ) , V_7 -> V_162 -> V_163 ) ;
V_188:
return - V_58 ;
}
static int F_127 ( struct V_84 * V_85 ,
struct V_191 * V_162 )
{
...
V_15 = V_37 -> V_15 ;
F_66 () ;
if ( F_113 ( V_162 ) && F_121 ( V_7 , V_37 , V_21 ) < 0 )
goto V_77;
...
return - V_201 ;
V_93 -> V_202 = 1 ;
F_131 ( V_93 -> V_203 , 4 - 1 ) ;
if ( V_21 -> V_3 -> V_113 & V_204 )
V_93 -> V_205 = 36 ;
return 0 ;
}
static int F_132 ( struct V_92 * V_93 )
{
struct V_20 * V_21 = V_93 -> V_86 ;
V_93 -> V_206 = 1 ;
if ( V_69 )
...
F_133 ( V_93 -> V_203 , 128 * 1024 / 512 ) ;
F_134 ( V_93 -> V_203 , V_147 ) ;
return 0 ;
}
static int F_135 ( struct V_191 * V_162 )
{
struct V_20 * V_21 = V_162 -> V_37 -> V_86 ;
...
static T_7 F_136 ( struct V_37 * V_145 ,
struct V_219 * V_220 , char * V_221 )
{
struct V_92 * V_93 = F_137 ( V_145 ) ;
struct V_20 * V_21 ;
if ( ! V_93 )
return 0 ;
V_21 = V_93 -> V_86 ;
