...
V_55 -> V_58 . V_65 = F_71 ( V_178 ) ;
if ( ! F_72 ( V_55 -> V_58 . V_60 ,
V_55 -> V_58 . V_65 , V_30 -> V_186 ) ) {
V_152 = - V_201 ;
goto V_196;
}
V_55 -> V_66 = F_73 ( V_55 -> V_58 . V_60 , V_55 -> V_58 . V_65 ) ;
if ( ! V_55 -> V_66 )
goto V_202;
} else {
V_152 = F_28 ( V_2 ) ;
...
V_55 -> V_58 . V_203 = V_177 -> V_200 ;
V_55 -> V_58 . V_204 = F_71 ( V_177 ) ;
if ( ! F_72 ( V_55 -> V_58 . V_203 ,
V_55 -> V_58 . V_204 , V_30 -> V_186 ) ) {
V_152 = - V_201 ;
goto V_205;
}
V_2 -> V_206 = F_73 ( V_55 -> V_58 . V_203 , V_55 -> V_58 . V_204 ) ;
if ( ! V_2 -> V_206 ) {
F_10 ( V_31 , L_35 ) ;
goto V_207;
}
F_15 ( V_2 ) ;
V_152 = F_74 ( V_2 -> V_199 , F_54 , 0 , V_30 -> V_186 , V_55 ) ;
if ( V_152 ) {
...
V_2 -> V_183 ( 1 ) ;
F_59 ( V_31 , L_40 ,
V_55 -> V_212 , V_55 -> V_58 . V_203 , V_2 -> V_206 , V_2 -> V_199 ) ;
return 0 ;
V_211:
F_77 ( V_31 , NULL ) ;
V_210:
...
F_83 ( V_2 -> V_206 ) ;
V_207:
F_84 ( V_55 -> V_58 . V_203 , V_55 -> V_58 . V_204 ) ;
V_205:
if ( V_178 )
F_83 ( V_55 -> V_66 ) ;
else
...
V_202:
if ( V_178 )
F_84 ( V_55 -> V_58 . V_60 , V_55 -> V_58 . V_65 ) ;
V_196:
F_63 ( V_2 ) ;
F_85 ( V_2 -> V_76 ) ;
V_193:
...
static int T_4 F_87 ( struct V_174 * V_30 )
{
struct V_64 * V_31 = & V_30 -> V_31 ;
struct V_54 * V_55 = F_88 ( V_31 ) ;
struct V_1 * V_2 ;
if ( ! V_55 || ! V_55 -> V_56 )
return 0 ;
V_2 = V_55 -> V_56 ;
...
static int F_90 ( struct V_174 * V_30 , T_5 V_213 )
{
struct V_54 * V_55 = F_91 ( V_30 ) ;
struct V_1 * V_2 = V_55 -> V_56 ;
F_2 ( V_2 , V_141 , ~ 0UL ) ;
V_2 -> V_214 = F_3 ( V_2 , V_23 ) ;
F_2 ( V_2 , V_24 , 0 ) ;
if ( V_2 -> V_183 )
V_2 -> V_183 ( 0 ) ;
F_23 ( V_2 ) ;
...
static int F_92 ( struct V_174 * V_30 )
{
struct V_54 * V_55 = F_91 ( V_30 ) ;
struct V_1 * V_2 = V_55 -> V_56 ;
F_61 ( V_2 ) ;
