...
void T_5 F_82 ( char * V_123 )
{
int V_124 ;
#ifdef F_17
if ( ! strncmp ( V_123 , L_23 , 4 ) ) {
V_115 = 1 ;
V_123 += 4 ;
if ( * V_123 == '=' )
++ V_123 ;
if ( isdigit ( * V_123 ) && F_83 ( & V_123 , & V_124 ) )
V_125 = V_124 ;
}
#endif
if ( isdigit ( * V_123 ) && F_83 ( & V_123 , & V_124 ) )
V_45 = V_124 ;
if ( ! strncmp ( V_123 , L_24 , 9 ) )
V_18 = 1 ;
if ( ! strncmp ( V_123 , L_25 , 11 ) )
V_18 = 0 ;
if ( ! strncmp ( V_123 , L_26 , 5 ) )
V_80 = 1 ;
if ( ! strncmp ( V_123 , L_27 , 10 ) )
V_126 = 0 ;
if ( ! strncmp ( V_123 , L_28 , 5 ) )
V_127 = 1 ;
if ( ! strncmp ( V_123 , L_29 , 7 ) )
V_127 = 1 ;
if ( ! strncmp ( V_123 , L_30 , 7 ) ) {
V_128 = 1 ;
V_123 += 7 ;
if ( * V_123 == '=' ) {
++ V_123 ;
