...
if ( V_185 -> V_168 != 0 )
return - V_156 ;
F_56 ( V_185 -> V_209 , L_82 , sizeof( V_185 -> V_209 ) ) ;
V_185 -> V_210 = V_211 ;
return 0 ;
}
...
struct V_140 * V_141 = V_161 -> V_162 ;
struct V_1 * V_2 = V_141 -> V_2 ;
V_185 -> V_213 . V_214 . V_210 = V_211 ;
V_185 -> V_213 . V_214 . V_215 = 0 ;
V_185 -> V_213 . V_214 . V_216 =
V_2 -> V_121 . V_143 * V_2 -> V_121 . V_145 ;
V_185 -> V_213 . V_214 . V_217 = 0 ;
V_185 -> V_213 . V_214 . V_123 = V_2 -> V_121 . V_123 ;
V_185 -> V_213 . V_214 . V_122 = V_2 -> V_121 . V_122 ;
V_185 -> V_213 . V_214 . V_151 = V_141 -> V_218 . V_151 ;
F_2 ( 1 , L_83 ,
V_2 -> V_121 . V_123 , V_2 -> V_121 . V_122 , V_141 -> V_218 . V_151 ) ;
return 0 ;
}
...
V_185 -> V_213 . V_214 . V_217 = 0 ;
F_2 ( 1 , L_85 ,
V_185 -> V_213 . V_214 . V_123 , V_185 -> V_213 . V_214 . V_122 , V_185 -> V_213 . V_214 . V_151 ) ;
return 0 ;
}
...
{
struct V_140 * V_141 = V_161 -> V_162 ;
return F_63 ( & V_141 -> V_218 , V_220 ) ;
}
static int F_64 ( struct V_161 * V_161 , void * V_86 ,
struct V_221 * V_220 )
{
struct V_140 * V_141 = V_161 -> V_162 ;
return F_65 ( & V_141 -> V_218 , V_220 ) ;
}
static int F_66 ( struct V_161 * V_161 , void * V_86 ,
struct V_221 * V_220 )
{
struct V_140 * V_141 = V_161 -> V_162 ;
return F_67 ( & V_141 -> V_218 , V_220 ) ;
}
static int F_68 ( struct V_161 * V_161 , void * V_86 , struct V_221 * V_222 )
{
struct V_140 * V_141 = V_86 ;
return F_69 ( & V_141 -> V_218 , V_222 , V_161 -> V_223 & V_224 ) ;
}
static int F_70 ( struct V_161 * V_161 , void * V_86 ,
enum V_225 V_93 )
{
struct V_140 * V_141 = V_161 -> V_162 ;
return F_71 ( & V_141 -> V_218 ) ;
}
static int F_72 ( struct V_161 * V_161 , void * V_86 , enum V_225 V_93 )
{
struct V_140 * V_141 = V_161 -> V_162 ;
return F_73 ( & V_141 -> V_218 ) ;
}
...
struct V_140 * V_141 = V_86 ;
struct V_1 * V_2 = V_141 -> V_2 ;
if ( V_185 -> V_227 != V_228 )
return - V_156 ;
return F_75 ( & V_2 -> V_124 , 0 , V_185 , V_229 ) ;
}
...
return - V_156 ;
V_220 = V_2 -> V_124 ;
V_100 = F_75 ( & V_220 , 0 , V_185 , V_231 ) ;
if ( V_100 == 0 ) {
V_100 = F_28 ( V_2 , F_19 ,
& V_2 -> V_124 , & V_220 ) ;
V_2 -> V_124 = V_220 ;
...
return - V_156 ;
V_220 = V_2 -> V_124 ;
V_100 = F_75 ( & V_220 , 0 , V_185 , V_232 ) ;
return V_100 ;
}
...
struct V_140 * V_141 ;
F_2 ( 2 , L_1 , V_4 ) ;
V_141 = F_84 ( sizeof( * V_141 ) , V_237 ) ;
if ( ! V_141 )
return - V_238 ;
V_161 -> V_162 = V_141 ;
V_141 -> V_2 = V_2 ;
F_85 ( & V_141 -> V_218 , & V_239 ,
& V_2 -> V_117 -> V_2 , & V_2 -> V_121 . V_240 ,
V_241 ,
V_242 ,
sizeof( struct V_152 ) ,
V_141 , NULL ) ;
...
if ( V_141 -> V_218 . V_245 )
F_73 ( & V_141 -> V_218 ) ;
if ( V_141 -> V_218 . V_246 )
F_90 ( & V_141 -> V_218 ) ;
F_91 ( & V_141 -> V_218 ) ;
V_161 -> V_162 = NULL ;
F_92 ( V_141 ) ;
...
struct V_1 * V_2 = V_141 -> V_2 ;
F_2 ( 2 , L_1 , V_4 ) ;
if ( F_87 ( & V_141 -> V_243 , 0 , 1 ) == 0 ) {
if ( F_94 ( & V_2 -> V_244 ) == 1 ) {
if ( F_29 ( V_2 ) < 0 )
return - V_156 ;
}
}
return F_95 ( & V_141 -> V_218 , V_90 , V_139 , V_247 , 0 ,
V_161 -> V_223 & V_224 ) ;
}
...
struct V_1 * V_2 = V_141 -> V_2 ;
F_2 ( 2 , L_89 , V_4 ) ;
return F_97 ( V_161 , & V_141 -> V_218 , V_249 ) ;
}
static int F_98 ( struct V_161 * V_161 , struct V_250 * V_251 )
{
struct V_140 * V_141 = V_161 -> V_162 ;
struct V_1 * V_2 = V_141 -> V_2 ;
F_2 ( 2 , L_1 , V_4 ) ;
return F_99 ( & V_141 -> V_218 , V_251 ) ;
}
...
return NULL ;
* V_256 = * V_255 ;
snprintf ( V_256 -> V_171 , sizeof( V_256 -> V_171 ) , L_90 , V_2 -> V_171 ,
type , V_169 [ V_199 -> V_2 -> V_170 ] . V_171 ) ;
V_256 -> V_257 = & V_117 -> V_2 ;
V_256 -> V_258 = F_103 ;
return V_256 ;
}
...
struct V_198 * V_199 = & V_2 -> V_121 ;
F_2 ( 1 , L_1 , V_4 ) ;
if ( V_169 [ V_2 -> V_170 ] . V_260 != V_261 )
return V_100 ;
V_2 -> V_126 = V_163 [ 0 ] ;
if ( V_2 -> V_126 . V_127 & V_262 )
V_199 -> V_122 = 480 ;
else
V_199 -> V_122 = 576 ;
V_199 -> V_123 = 720 ;
F_107 ( & V_2 -> V_124 ) ;
V_2 -> V_124 . V_263 = V_264 ;
V_2 -> V_252 = F_104 ( V_199 ,
V_2 -> V_117 , & V_265 , L_91 ) ;
F_108 ( V_2 -> V_252 , V_2 ) ;
V_100 = F_109 ( V_2 -> V_252 ,
V_266 , - 1 ) ;
if ( V_100 < 0 ) {
F_20 ( V_233 L_92 , V_2 -> V_171 ) ;
return V_100 ;
}
F_20 ( V_233 L_93 ,
V_2 -> V_171 , F_110 ( V_2 -> V_252 ) ) ;
return 0 ;
}
