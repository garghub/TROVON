...
static T_1 F_30 ( struct V_53 * V_53 , T_1 V_268 )
{
T_1 V_269 ;
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_270 , V_53 ) -> V_271 , V_47 ) ;
F_149 ( V_268 , V_53 -> V_217 + 0x0 ) ;
V_269 = F_150 ( V_53 -> V_217 + 0x4 ) ;
F_151 (
& F_148 ( V_53 , struct V_270 , V_53 ) -> V_271 , V_47 ) ;
return V_269 ;
}
static void F_28 ( struct V_53 * V_53 , T_1 V_268 , T_1 V_48 )
{
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_270 , V_53 ) -> V_271 , V_47 ) ;
...
static T_1 F_98 ( struct V_53 * V_53 , T_1 V_268 )
{
T_1 V_269 ;
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_270 , V_53 ) -> V_272 , V_47 ) ;
F_149 ( V_268 , V_53 -> V_217 + 0x10 ) ;
V_269 = F_150 ( V_53 -> V_217 + 0x14 ) ;
F_151 (
& F_148 ( V_53 , struct V_270 , V_53 ) -> V_272 , V_47 ) ;
return V_269 ;
}
static void F_99 ( struct V_53 * V_53 , T_1 V_268 , T_1 V_48 )
{
unsigned long V_47 ;
F_147 (
& F_148 ( V_53 , struct V_270 , V_53 ) -> V_272 , V_47 ) ;
...
int T_5 F_152 ( struct V_53 * * V_273 )
{
struct V_270 * V_270 ;
* V_273 = NULL ;
V_270 = F_2 ( sizeof( * V_270 ) , V_4 ) ;
if ( ! V_270 )
return - V_5 ;
F_153 ( & V_270 -> V_271 ) ;
F_153 ( & V_270 -> V_272 ) ;
...
if ( V_53 -> V_217 )
F_138 ( V_53 ) ;
F_4 ( F_148 ( V_53 , struct V_270 , V_53 ) ) ;
return 0 ;
}
