...
static int F_42 ( struct V_1 * V_2 , const struct V_49 * V_50 ,
const struct V_4 * V_17 )
{
int V_6 , V_34 = 0 ;
struct V_75 * V_76 ;
...
continue;
V_25 = F_43 ( sizeof( struct V_9 ) , V_57 ) ;
if ( ! V_25 )
return - V_58 ;
...
if ( V_76 -> V_94 != V_76 -> V_64 ) {
F_38 ( L_15 ,
V_76 -> V_27 , V_76 -> V_64 - V_76 -> V_94 ) ;
V_25 -> V_95 = 1 ;
continue;
}
V_25 -> V_64 = V_76 -> V_64 ;
V_25 -> V_93 =
( long long ) ( V_25 -> V_64 - 1 ) * V_25 -> V_87 ;
V_25 -> V_93 += V_76 -> V_96 ;
V_25 -> V_92 = V_76 -> V_96 ;
}
V_25 = F_43 ( sizeof( struct V_9 ) , V_57 ) ;
...
V_25 -> V_35 = 1 ;
V_25 -> V_37 = V_85 ;
V_25 -> V_28 = sizeof( V_97 ) - 1 ;
memcpy ( V_25 -> V_30 , V_97 , V_25 -> V_28 + 1 ) ;
V_25 -> V_87 = V_2 -> V_41 ;
V_25 -> V_64 = V_25 -> V_34 ;
V_25 -> V_92 = V_25 -> V_34 ;
V_25 -> V_93 =
...
static int F_45 ( const struct V_9 * V_25 ,
const struct V_75 * V_76 )
{
int V_7 ;
if ( V_76 -> V_102 >= V_25 -> V_34 ) {
V_7 = 1 ;
goto V_40;
}
if ( V_76 -> V_94 > V_25 -> V_34 ) {
V_7 = 2 ;
goto V_40;
}
...
struct V_75 * V_76 ;
struct V_9 * V_25 ;
if ( V_50 -> V_103 > V_104 + V_2 -> V_11 ) {
F_16 ( L_19 ,
V_50 -> V_103 , V_104 , V_2 -> V_11 ) ;
return - V_48 ;
}
if ( V_50 -> V_105 >= V_2 -> V_11 + V_104 &&
V_50 -> V_105 < V_106 ) {
F_16 ( L_20 ,
V_50 -> V_105 ) ;
return - V_48 ;
...
int F_50 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
int V_6 , V_7 ;
struct V_75 * V_76 ;
...
V_2 -> V_19 = F_51 ( V_2 -> V_19 , V_2 -> V_42 ) ;
V_76 = F_44 ( V_50 , V_13 ) ;
if ( ! V_76 ) {
if ( V_50 -> V_108 ) {
V_2 -> V_17 = F_41 ( V_2 , V_50 ) ;
if ( F_24 ( V_2 -> V_17 ) )
...
V_2 -> V_99 = V_2 -> V_45 - V_2 -> V_100 ;
V_7 = F_42 ( V_2 , V_50 , V_2 -> V_17 ) ;
if ( V_7 )
goto V_60;
V_7 = F_48 ( V_2 , V_50 ) ;
if ( V_7 )
