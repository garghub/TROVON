...
goto V_222;
F_129 ( V_223 , V_207 -> V_224 ) ;
if ( V_207 -> V_225 )
F_129 ( STRING , V_207 -> V_225 ) ;
}
break;
case V_226 : {
...
break;
case V_233 : {
struct V_234 * V_207 = ( void * ) V_213 ;
F_14 ( L_25 ) ;
if ( V_24 != sizeof *V_207 )
goto V_222;
if ( V_207 -> V_235 )
F_129 ( STRING , V_207 -> V_235 ) ;
}
break;
case V_236 :
case V_237 :
...
case V_239 :
case V_240 :
F_14 ( L_26 , V_213 -> V_215 ) ;
return - V_46 ;
default:
F_14 ( L_27 , V_213 -> V_215 ) ;
return - V_46 ;
V_222:
F_14 ( L_28 ,
...
if ( V_101 == V_63 )
V_13 = NULL ;
V_16 = V_210 ( V_243 , ( T_7 * ) V_101 , ( void * ) V_13 , V_211 ) ;
if ( F_10 ( V_16 < 0 ) ) {
F_16 ( L_29 ,
V_101 , V_16 ) ;
return V_16 ;
...
if ( ! V_13 )
return V_242 - V_14 ;
V_16 = F_125 ( V_13 , V_14 , V_210 , V_211 ) ;
if ( F_10 ( V_16 < 0 ) ) {
...
static int F_131 ( enum V_244 type ,
T_7 * V_245 , struct V_212 * V_209 ,
void * V_211 )
{
...
break;
case V_248 :
if ( ( * V_245 & V_249 ) > V_10 -> V_167 )
V_10 -> V_167 = ( * V_245 & V_249 ) ;
break;
}
return 0 ;
}
...
static int F_139 ( enum V_244 type , T_7 * V_245 ,
struct V_212 * V_209 ,
void * V_211 )
{
...
return 0 ;
if ( V_274 )
V_76 -> V_4 . V_275 [ ( long ) V_245 ] = V_209 ;
else
V_76 -> V_4 . V_277 [ ( long ) V_245 ] = V_209 ;
if ( ! V_209 || V_209 -> V_215 != V_226 )
return 0 ;
V_276 = ( V_207 -> V_230 & V_249 ) - 1 ;
...
V_82 -> V_6 = V_6 ;
V_82 -> V_8 = V_8 ;
V_76 -> V_280 [ V_207 -> V_230 &
V_249 ] = V_276 + 1 ;
}
F_140 ( L_38 , V_207 , V_207 -> V_214 ) ;
return 0 ;
}
static int F_142 ( enum V_244 type , T_7 * V_245 ,
struct V_212 * V_209 ,
void * V_211 )
{
struct V_1 * V_76 = V_211 ;
...
break;
case V_247 :
V_281 = V_76 -> V_10 -> V_170 [ 0 ] -> V_185 [ * V_245 - 1 ] . V_186 ;
break;
case V_248 :
...
V_281 = V_208 [ V_208 [ 0 ] ? 0 : 1 ] -> V_230 ;
}
break;
}
F_14 ( L_39 , * V_245 , V_281 ) ;
* V_245 = V_281 ;
return 0 ;
}
