...
( long long ) V_78 ,
( long long ) V_79 ) ;
for ( V_31 = 0 ; V_31 < F_56 ( V_86 ) ; V_31 ++ ) {
if ( V_78 & V_79 & V_86 [ V_31 ] . type )
V_80 += sprintf ( V_80 , L_18 , V_86 [ V_31 ] . V_2 ) ;
else if ( V_78 & V_86 [ V_31 ] . type )
V_80 += sprintf ( V_80 , L_19 , V_86 [ V_31 ] . V_2 ) ;
}
if ( V_80 != V_77 )
V_80 -- ;
* V_80 = '\n' ;
...
while ( ( V_80 = F_59 ( ( char * * ) & V_87 , L_21 ) ) != NULL ) {
if ( ! * V_80 )
break;
if ( * V_80 == '+' ) {
V_88 = true ;
...
if ( ! V_88 && ! V_89 && ! strncasecmp ( V_80 , V_93 , sizeof( V_93 ) ) ) {
V_80 += sizeof( V_93 ) ;
V_90 = 0 ;
V_91 ++ ;
} else {
for ( V_31 = 0 ; V_31 < F_56 ( V_86 ) ; V_31 ++ ) {
if ( ! strcasecmp ( V_80 , V_86 [ V_31 ] . V_2 ) ) {
V_80 += strlen ( V_86 [ V_31 ] . V_2 ) ;
V_90 = V_86 [ V_31 ] . type ;
break;
}
}
...
static int F_62 ( struct V_73 * V_73 , struct V_96 * V_97 )
{
struct V_25 * V_26 = F_53 ( V_73 ) ;
if ( V_26 -> V_5 . V_2 )
F_63 ( L_26 , V_26 -> V_5 . V_2 ) ;
if ( V_26 -> V_98 )
F_63 ( L_27 , V_26 -> V_98 ) ;
return 0 ;
}
struct V_25 * F_64 ( void )
{
struct V_25 * V_26 ;
V_26 = F_65 ( sizeof( * V_26 ) , V_15 ) ;
if ( ! V_26 )
return NULL ;
V_26 -> V_35 = F_66 () ;
if ( ! V_26 -> V_35 ) {
...
V_26 -> V_35 -> V_99 = F_32 ;
V_26 -> V_35 -> V_100 = F_25 ;
F_67 ( V_26 -> V_35 , V_26 ) ;
F_68 ( & V_26 -> V_5 . V_46 ) ;
F_68 ( & V_26 -> V_59 ) ;
F_69 ( & V_26 -> V_46 ) ;
F_70 ( & V_26 -> V_67 , F_38 , ( unsigned long ) V_26 ) ;
V_26 -> V_26 . type = & V_101 ;
V_26 -> V_26 . V_102 = & V_103 ;
F_71 ( & V_26 -> V_26 ) ;
F_72 ( V_95 ) ;
return V_26 ;
}
...
return - V_48 ;
F_78 ( V_108 , V_26 -> V_35 -> V_109 ) ;
F_78 ( V_110 , V_26 -> V_35 -> V_109 ) ;
F_78 ( V_62 , V_26 -> V_35 -> V_109 ) ;
F_78 ( V_63 , V_26 -> V_35 -> V_111 ) ;
if ( V_26 -> V_71 )
V_26 -> V_35 -> V_71 = F_47 ;
if ( V_26 -> V_72 )
V_26 -> V_35 -> V_72 = F_48 ;
F_54 ( & V_26 -> V_46 ) ;
V_26 -> V_104 = ( unsigned long ) ( F_79 ( & V_104 ) - 1 ) ;
F_80 ( & V_26 -> V_26 , L_28 , V_26 -> V_104 ) ;
F_81 ( & V_26 -> V_26 , V_26 ) ;
V_6 = F_82 ( & V_26 -> V_26 ) ;
if ( V_6 )
goto V_112;
...
if ( V_6 )
goto V_113;
V_26 -> V_35 -> V_26 . V_114 = & V_26 -> V_26 ;
memcpy ( & V_26 -> V_35 -> V_115 , & V_26 -> V_116 , sizeof( V_26 -> V_116 ) ) ;
V_26 -> V_35 -> V_117 = V_26 -> V_118 ;
V_26 -> V_35 -> V_2 = V_26 -> V_55 ;
V_6 = F_83 ( V_26 -> V_35 ) ;
if ( V_6 )
goto V_119;
V_26 -> V_35 -> V_120 [ V_121 ] = 500 ;
V_26 -> V_35 -> V_120 [ V_122 ] = 125 ;
V_105 = F_84 ( & V_26 -> V_26 . V_123 , V_15 ) ;
F_8 ( V_8 L_29 ,
F_51 ( & V_26 -> V_26 ) ,
...
F_17 ( 1 , L_32 ,
V_26 -> V_104 ,
V_26 -> V_98 ? V_26 -> V_98 : L_33 ,
V_5 -> V_2 ? V_5 -> V_2 : L_33 ,
V_26 -> V_81 == V_124 ? L_34 : L_35 ) ;
return 0 ;
V_126:
if ( V_26 -> V_81 == V_124 )
F_86 ( V_26 ) ;
