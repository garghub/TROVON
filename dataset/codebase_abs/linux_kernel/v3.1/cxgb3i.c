...
V_2 -> V_96 = 0 ;
V_2 -> V_41 = F_120 ( V_167 , F_121 ( V_201 ) , V_206 ) ;
if ( ! V_2 -> V_41 ) {
F_98 ( L_28 ) ;
return - V_211 ;
}
...
V_4 -> V_142 = (struct V_143 * ) V_2 ;
F_32 ( V_4 , F_17 ) ;
V_2 -> V_109 = V_2 -> V_101 = F_123 ( V_167 ) -> V_213 - 1 ;
V_2 -> V_107 = 0 ;
...
static inline void F_129 ( struct V_3 * V_4 , unsigned int V_233 )
{
struct V_234 * V_10 = (struct V_234 * ) V_4 -> V_11 ;
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_14 . V_15 = F_3 ( F_4 ( V_235 ) ) ;
V_10 -> V_236 = F_3 ( F_130 ( V_233 >> 5 ) |
F_131 ( V_237 ) ) ;
V_10 -> V_87 = F_3 ( F_132 ( V_238 >> 5 ) |
F_133 ( ( V_238 >> 3 ) + 1 ) ) ;
}
static int F_134 ( struct V_1 * V_2 , struct V_239 * V_197 ,
...
static void F_136 ( struct V_202 * V_203 , unsigned int V_251 ,
unsigned int V_31 , unsigned int V_240 )
{
...
V_10 -> V_253 = F_138 ( V_253 ? 0 : 1 ) ;
V_10 -> V_258 = 0 ;
V_10 -> V_259 = F_139 ( 31 ) ;
V_10 -> V_260 = F_140 ( 0xF0000000 ) ;
V_10 -> V_255 = F_140 ( V_255 << 28 ) ;
V_4 -> V_12 = V_250 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
...
V_10 -> V_258 = 0 ;
V_10 -> V_259 = F_139 ( 31 ) ;
V_10 -> V_260 = F_140 ( 0x0F000000 ) ;
V_10 -> V_255 = F_140 ( V_255 << 24 ) ;
V_4 -> V_12 = V_250 ;
F_26 ( V_2 -> V_39 -> V_40 , V_4 ) ;
return 0 ;
}
...
V_163 = F_146 ( V_39 , V_265 . V_247 , V_265 . V_270 ,
...
{
struct V_208 * V_39 = F_149 ( V_167 ) ;
struct V_285 * V_285 = F_152 ( V_167 ) ;
int V_82 , V_163 ;
if ( V_39 ) {
F_38 ( L_45 , V_39 ) ;
return;
}
V_39 = F_153 ( 0 , V_285 -> V_286 . V_287 ) ;
if ( ! V_39 ) {
F_127 ( L_46 , V_167 ) ;
return;
}
...
static void F_155 ( struct V_42 * V_167 , T_1 V_308 , T_1 V_215 )
{
struct V_208 * V_39 = F_149 ( V_167 ) ;
F_14 ( 1 << V_35 ,
L_50 ,
...
{
int V_218 ;
F_157 ( V_311 L_51 , V_312 ) ;
V_218 = F_158 ( & V_303 , & V_307 ) ;
if ( V_218 < 0 )
return V_218 ;
F_159 ( & V_117 ) ;
return 0 ;
