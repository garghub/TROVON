...
V_82 -> V_76 = V_2 -> V_330 + V_4 -> V_72 [ V_331 ] ;
V_82 -> V_83 = V_328 -> V_332 ;
V_82 -> V_86 = 0x08 ;
V_82 -> V_85 = 0x04 ;
V_82 -> V_84 = 0x02 ;
V_82 -> V_87 = 0x01 ;
V_82 -> V_79 . V_333 = & V_334 ;
...
V_4 -> V_252 -> V_336 = & V_2 -> V_104 ;
snprintf ( V_4 -> V_252 -> V_253 , V_250 , L_22 , V_253 ) ;
V_4 -> V_252 -> V_228 = F_50 ( sizeof( int ) * V_337 , V_122 ) ;
if ( ! V_4 -> V_252 -> V_228 ) {
V_117 = - V_123 ;
goto V_338;
}
for ( V_11 = 0 ; V_11 < V_337 ; V_11 ++ )
V_4 -> V_252 -> V_228 [ V_11 ] = V_339 ;
...
static const T_3 * F_135 ( int V_340 )
{
const T_3 * V_72 = NULL ;
switch ( V_340 ) {
case V_341 :
...
break;
default:
F_14 ( V_20 L_23 , V_340 ) ;
break;
}
return V_72 ;
}
static int F_136 ( struct V_346 * V_273 )
{
int V_117 , V_347 = 0 ;
struct V_348 * V_349 ;
struct V_1 * V_2 = NULL ;
...
V_2 -> V_360 = V_361 ;
V_4 -> V_264 = V_362 ;
V_4 -> V_363 = V_364 >> ( V_347 << 1 ) ;
V_4 -> V_365 = V_366 >> ( V_347 << 1 ) ;
F_30 ( V_2 , V_328 -> V_367 ) ;
if ( ! V_347 ) {
if ( V_4 -> V_39 -> V_368 ) {
struct V_348 * V_369 ;
V_369 = F_137 ( V_273 , V_350 , 1 ) ;
if ( ! V_369 ) {
F_51 ( & V_273 -> V_104 , L_26 ) ;
goto V_353;
}
V_4 -> V_370 = F_147 ( V_369 -> V_351 ,
F_148 ( V_369 ) ) ;
}
if ( V_4 -> V_39 -> V_371 )
V_4 -> V_39 -> V_371 ( V_2 ) ;
...
goto V_372;
F_150 ( L_27 ,
( V_61 ) V_2 -> V_330 , V_2 -> V_68 , V_2 -> V_228 ) ;
F_151 ( V_273 , V_2 ) ;
return V_117 ;
V_372:
F_152 ( V_2 ) ;
...
static int F_155 ( struct V_346 * V_273 )
{
