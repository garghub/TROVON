...
for ( V_79 = 0 ; V_79 < V_1 -> V_194 ; V_79 ++ ) {
F_29 ( V_1 , V_41 , V_168 , & V_1 -> V_26 [ V_79 ] ,
F_13 ( V_200 ) + V_79 * F_13 ( V_201 ) ,
0x1000 ) ;
}
if ( V_1 -> V_164 == 0 ) {
V_1 -> V_164 = V_1 -> V_174 ;
F_29 ( V_1 , V_41 , V_168 , & V_1 -> V_33 [ 0 ] ,
F_13 ( V_202 ) , F_13 ( V_34 ) * V_1 -> V_164 ) ;
}
V_1 -> V_29 = 1 + F_126 ( V_1 -> V_164 - 1 ) ;
V_1 -> V_31 = ( 1 << V_1 -> V_29 ) - 1 ;
V_1 -> V_203 = F_127 ( V_41 , V_204 ,
...
F_34 ( V_45 L_38
L_39 ,
V_104 , V_166 , ( unsigned long long ) V_168 , V_1 -> V_194 ) ;
F_34 ( V_45 L_40 ,
...
void T_3 F_129 ( struct V_1 * V_1 , unsigned int V_209 ,
T_2 V_168 )
{
unsigned int V_210 = V_209 * V_1 -> V_164 ;
F_24 ( V_209 >= V_211 ) ;
F_29 ( V_1 , V_1 -> V_203 -> V_142 ,
V_168 , & V_1 -> V_33 [ V_209 ] , 0 ,
F_13 ( V_34 ) * V_1 -> V_164 ) ;
if ( ( V_210 + V_1 -> V_164 ) > V_1 -> V_174 )
V_1 -> V_174 = V_210 + V_1 -> V_164 ;
}
void T_3 F_130 ( struct V_1 * V_1 , T_4 * V_130 , int V_212 )
{
V_1 -> V_130 = V_130 ;
V_1 -> V_131 = V_212 ;
}
void T_3 F_131 ( struct V_1 * V_1 )
{
int V_79 ;
int V_2 ;
F_24 ( V_1 -> V_174 == 0 ) ;
...
F_31 ( V_1 -> V_21 , F_13 ( V_217 ) , V_1 -> V_147 ) ;
if ( ! ( V_1 -> V_3 & V_218 ) )
F_31 ( V_1 -> V_21 , F_13 ( V_187 ) ,
F_32 ( V_1 -> V_21 , F_13 ( V_187 ) )
| V_219 ) ;
...
F_70 ( F_13 ( V_213 ) , 0 ) ;
#ifdef F_46
V_1 -> V_58 = F_134 ( V_1 -> V_174 * sizeof( * V_1 -> V_58 ) ,
V_84 ) ;
F_24 ( V_1 -> V_58 == NULL ) ;
#endif
}
void T_3 F_135 ( struct V_1 * V_1 , T_1 V_222 )
{
T_1 V_223 ;
V_223 = F_32 ( V_1 -> V_21 , V_224 ) ;
V_223 &= ~ V_225 ;
V_223 |= F_136 ( V_222 ) ;
F_31 ( V_1 -> V_21 , V_224 , V_223 ) ;
}
void T_3 F_137 ( struct V_1 * V_1 , int V_226 )
{
unsigned long V_3 ;
T_1 V_223 ;
F_43 ( & V_227 , V_3 ) ;
...
void F_111 ( unsigned int V_80 , unsigned int V_229 )
{
...
{
struct V_1 * V_1 = V_208 ;
return F_71 ( F_13 ( V_213 ) ) ;
}
void F_140 ( int V_233 )
{
struct V_1 * V_1 = V_208 ;
V_233 &= V_234 ;
F_70 ( F_13 ( V_213 ) , V_233 ) ;
}
void F_141 ( int V_235 )
{
struct V_1 * V_1 = V_208 ;
unsigned long V_3 ;
T_1 V_231 = 1 << F_2 () ;
...
static unsigned int F_142 ( struct V_1 * V_1 , int V_8 )
{
T_1 V_94 ;
...
#endif
if ( F_144 ( V_94 == V_1 -> V_147 ) ) {
if ( V_1 -> V_3 & V_236 )
F_69 ( V_1 ) ;
return V_237 ;
}
if ( F_144 ( V_1 -> V_148 && F_103 ( V_94 , V_1 -> V_148 ) ) ) {
F_145 ( V_238 L_46 ,
V_1 -> V_104 , ( int ) V_94 ) ;
F_69 ( V_1 ) ;
return V_237 ;
}
return F_146 ( V_1 -> V_203 , V_94 ) ;
}
unsigned int F_147 ( struct V_1 * V_1 )
{
return F_142 ( V_1 , F_13 ( V_239 ) ) ;
}
unsigned int F_148 ( void )
{
struct V_1 * V_1 = V_208 ;
F_24 ( V_1 == NULL ) ;
return F_147 ( V_1 ) ;
}
unsigned int F_149 ( void )
{
#ifdef F_150
struct V_1 * V_1 = V_208 ;
T_1 V_94 ;
...
unsigned int F_152 ( void )
{
struct V_1 * V_1 = V_208 ;
F_24 ( V_1 == NULL ) ;
return F_142 ( V_1 , F_13 ( V_241 ) ) ;
}
void F_153 ( void )
{
struct V_1 * V_1 = V_208 ;
...
F_34 ( V_45 L_47 ) ;
for ( V_79 = 0 ; V_79 < 4 ; V_79 ++ ) {
unsigned int V_242 = F_154 ( V_1 -> V_203 ,
V_1 -> V_95 [ 0 ] + V_79 ) ;
if ( V_242 == V_237 ) {
F_34 ( V_106 L_48 , V_243 [ V_79 ] ) ;
continue;
}
F_155 ( V_242 , V_79 ) ;
}
}
void F_156 ( int V_2 , int V_244 )
{
struct V_1 * V_1 = V_208 ;
T_1 V_245 ;
F_24 ( V_1 == NULL ) ;
if ( ( unsigned int ) V_244 > 3 ) {
F_34 ( L_49 ,
F_157 () , V_244 ) ;
return;
}
#ifdef F_158
F_42 ( L_50 , V_1 -> V_104 , V_244 ) ;
#endif
V_245 = 1 << F_64 ( V_2 ) ;
F_70 ( F_13 ( V_246 ) +
V_244 * F_13 ( V_247 ) , V_245 ) ;
}
int T_3 F_159 ( void )
{
int V_248 ;
...
T_1 V_250 ;
int V_110 = F_64 ( V_2 ) ;
V_250 = F_32 ( V_1 -> V_21 , F_13 ( V_251 ) ) ;
V_250 |= ( 1 << V_110 ) ;
F_31 ( V_1 -> V_21 , F_13 ( V_251 ) , V_250 ) ;
F_32 ( V_1 -> V_21 , F_13 ( V_251 ) ) ;
V_250 &= ~ ( 1 << V_110 ) ;
F_31 ( V_1 -> V_21 , F_13 ( V_251 ) , V_250 ) ;
F_32 ( V_1 -> V_21 , F_13 ( V_251 ) ) ;
}
