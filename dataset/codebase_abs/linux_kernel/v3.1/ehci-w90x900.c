...
if ( V_12 < 0 )
goto V_35;
V_11 = F_13 ( V_6 , V_12 , V_36 ) ;
if ( V_11 != 0 )
goto V_35;
F_14 ( V_8 , 1 , & V_8 -> V_25 -> V_37 ) ;
return V_11 ;
V_35:
F_15 ( V_6 -> V_25 ) ;
V_27:
F_16 ( V_6 -> V_19 , V_6 -> V_21 ) ;
V_24:
F_17 ( V_6 ) ;
V_16:
return V_11 ;
...
static
void F_18 ( struct V_5 * V_6 , struct V_3 * V_4 )
{
F_19 ( V_6 ) ;
F_15 ( V_6 -> V_25 ) ;
F_16 ( V_6 -> V_19 , V_6 -> V_21 ) ;
...
static int T_1 F_20 ( struct V_3 * V_4 )
{
if ( F_21 () )
return - V_38 ;
return F_1 ( & V_39 , V_4 ) ;
}
static int T_2 F_22 ( struct V_3 * V_4 )
{
