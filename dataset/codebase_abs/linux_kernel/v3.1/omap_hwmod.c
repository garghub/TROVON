...
static int T_3 F_99 ( struct V_1 * V_2 , void * V_97 )
{
if ( V_2 -> V_98 != V_99 )
return 0 ;
if ( V_2 -> V_11 & V_101 )
...
int T_3 F_100 ( const char * V_161 )
{
struct V_1 * V_2 ;
int V_133 ;
F_24 ( L_50 , V_161 , V_115 ) ;
if ( ! V_141 ) {
F_42 ( L_51 ,
V_161 , V_155 ) ;
return - V_6 ;
...
int F_111 ( struct V_1 * V_2 , struct V_162 * V_163 )
{
int V_52 , V_164 , V_165 , V_166 ;
int V_133 = 0 ;
V_165 = F_36 ( V_2 ) ;
for ( V_52 = 0 ; V_52 < V_165 ; V_52 ++ ) {
( V_163 + V_133 ) -> V_5 = ( V_2 -> V_72 + V_52 ) -> V_5 ;
( V_163 + V_133 ) -> V_167 = ( V_2 -> V_72 + V_52 ) -> V_73 ;
( V_163 + V_133 ) -> V_168 = ( V_2 -> V_72 + V_52 ) -> V_73 ;
( V_163 + V_133 ) -> V_46 = V_169 ;
V_133 ++ ;
}
V_166 = F_37 ( V_2 ) ;
for ( V_52 = 0 ; V_52 < V_166 ; V_52 ++ ) {
( V_163 + V_133 ) -> V_5 = ( V_2 -> V_76 + V_52 ) -> V_5 ;
( V_163 + V_133 ) -> V_167 = ( V_2 -> V_76 + V_52 ) -> V_77 ;
( V_163 + V_133 ) -> V_168 = ( V_2 -> V_76 + V_52 ) -> V_77 ;
( V_163 + V_133 ) -> V_46 = V_170 ;
V_133 ++ ;
}
for ( V_52 = 0 ; V_52 < V_2 -> V_53 ; V_52 ++ ) {
struct V_54 * V_55 ;
...
V_55 = V_2 -> V_56 [ V_52 ] ;
V_171 = F_38 ( V_55 ) ;
for ( V_164 = 0 ; V_164 < V_171 ; V_164 ++ ) {
( V_163 + V_133 ) -> V_5 = ( V_55 -> V_80 + V_164 ) -> V_5 ;
( V_163 + V_133 ) -> V_167 = ( V_55 -> V_80 + V_164 ) -> V_81 ;
( V_163 + V_133 ) -> V_168 = ( V_55 -> V_80 + V_164 ) -> V_82 ;
( V_163 + V_133 ) -> V_46 = V_172 ;
V_133 ++ ;
}
}
return V_133 ;
}
struct V_173 * F_112 ( struct V_1 * V_2 )
{
struct V_50 * V_51 ;
if ( ! V_2 )
return NULL ;
...
int F_122 ( struct V_1 * V_2 , T_2 V_175 )
{
int V_48 ;
unsigned long V_46 ;
if ( ! V_2 )
