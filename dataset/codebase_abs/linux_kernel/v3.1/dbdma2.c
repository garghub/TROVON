...
{
struct V_47 * V_48 = V_26 -> V_48 -> V_47 ;
struct V_45 * V_46 = V_26 -> V_46 ;
F_39 ( V_46 , V_49 ,
V_48 -> V_50 , V_51 , ( 4096 * 1024 ) - 1 ) ;
return 0 ;
}
static int T_3 F_40 ( struct V_52 * V_53 )
{
struct V_1 * V_54 ;
struct V_55 * V_56 ;
int V_33 ;
V_54 = F_41 ( 2 * sizeof( struct V_1 ) , V_57 ) ;
if ( ! V_54 )
return - V_22 ;
V_56 = F_42 ( V_53 , V_58 , 0 ) ;
if ( ! V_56 ) {
V_33 = - V_59 ;
goto V_60;
}
V_54 [ V_61 ] . V_20 = V_56 -> V_62 ;
V_56 = F_42 ( V_53 , V_58 , 1 ) ;
if ( ! V_56 ) {
V_33 = - V_59 ;
goto V_60;
}
V_54 [ V_19 ] . V_20 = V_56 -> V_62 ;
F_43 ( V_53 , V_54 ) ;
V_33 = F_44 ( & V_53 -> V_50 , & V_63 ) ;
if ( ! V_33 )
return V_33 ;
V_60:
F_45 ( V_54 ) ;
...
static int T_4 F_46 ( struct V_52 * V_53 )
{
struct V_1 * V_54 = F_47 ( V_53 ) ;
F_48 ( & V_53 -> V_50 ) ;
F_45 ( V_54 ) ;
return 0 ;
}
...
struct V_52 * F_53 ( struct V_52 * V_53 )
{
struct V_55 * V_65 , * V_56 ;
struct V_52 * V_66 ;
int V_67 [ 2 ] ;
int V_33 ;
V_56 = F_42 ( V_53 , V_58 , 0 ) ;
...
return NULL ;
V_67 [ 1 ] = V_56 -> V_62 ;
V_65 = F_41 ( sizeof( struct V_55 ) * 2 , V_57 ) ;
if ( ! V_65 )
return NULL ;
V_65 [ 0 ] . V_62 = V_65 [ 0 ] . V_68 = V_67 [ 0 ] ;
V_65 [ 1 ] . V_62 = V_65 [ 1 ] . V_68 = V_67 [ 1 ] ;
V_65 [ 0 ] . V_69 = V_65 [ 1 ] . V_69 = V_58 ;
V_66 = F_54 ( L_5 , V_53 -> V_67 ) ;
if ( ! V_66 )
goto V_18;
V_66 -> V_55 = V_65 ;
V_66 -> V_70 = 2 ;
