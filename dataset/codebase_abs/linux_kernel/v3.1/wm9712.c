...
static int F_15 ( struct V_4 * V_5 , struct V_46 * V_38 )
{
int V_34 = 5 * V_16 ;
if ( ! V_5 -> V_37 ) {
T_1 V_47 = F_8 ( V_5 , V_29 ) ;
if ( ! ( V_47 & V_36 ) )
return V_39 ;
V_5 -> V_37 = 1 ;
}
if ( V_5 -> V_40 && V_5 -> V_40 -> V_41 )
V_5 -> V_40 -> V_41 ( V_48 | V_49 ) ;
F_9 ( V_5 , V_24 ,
V_50 | V_43 | F_7 ( V_16 ) ) ;
F_1 ( V_16 ) ;
V_38 -> V_51 = F_8 ( V_5 , V_29 ) ;
while ( ( F_8 ( V_5 , V_24 ) & V_43 )
&& V_34 ) {
F_2 ( V_2 ) ;
V_34 -- ;
...
V_38 -> V_53 = V_54 ;
if ( V_5 -> V_40 && V_5 -> V_40 -> V_44 )
V_5 -> V_40 -> V_44 ( V_48 | V_49 ) ;
if ( ! ( V_38 -> V_51 & V_48 ) || ! ( V_38 -> V_52 & V_49 ) )
goto V_55;
if ( V_13 && ! ( V_38 -> V_53 & V_56 ) )
goto V_55;
if ( ! ( V_38 -> V_51 & V_36 ) || ! ( V_38 -> V_52 & V_36 ) ) {
V_5 -> V_37 = 0 ;
return V_39 ;
}
return V_45 ;
...
static int F_16 ( struct V_4 * V_5 , struct V_46 * V_38 )
{
int V_57 ;
if ( V_22 ) {
V_57 = F_15 ( V_5 , V_38 ) ;
...
V_57 = F_14 ( V_5 , V_48 | V_36 ,
& V_38 -> V_51 ) ;
if ( V_57 != V_45 )
return V_57 ;
V_57 = F_14 ( V_5 , V_49 | V_36 ,
& V_38 -> V_52 ) ;
if ( V_57 != V_45 )
return V_57 ;
if ( V_13 && ! V_11 ) {
V_57 = F_14 ( V_5 , V_56 | V_36 ,
& V_38 -> V_53 ) ;
if ( V_57 != V_45 )
return V_57 ;
} else
