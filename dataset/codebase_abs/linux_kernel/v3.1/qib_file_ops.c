...
unsigned int V_283 ;
if ( V_15 -> V_171 & V_284 ) {
V_282 -> V_285 = F_75 ( & V_15 -> V_120 -> V_286 ,
V_15 -> V_46 ,
V_10 -> V_67 ,
V_282 -> V_116 ) ;
if ( ! V_282 -> V_285 )
...
F_83 ( V_15 , V_10 -> V_293 , V_10 -> V_69 ,
V_296 , V_10 ) ;
...
static int F_89 ( struct V_267 * V_268 , struct V_5 * V_6 )
{
int V_11 = 0 ;
struct V_270 * V_282 ;
struct V_9 * V_10 ;
...
F_90 () ;
if ( V_282 -> V_285 ) {
F_91 ( V_10 -> V_17 , V_282 -> V_285 ) ;
F_92 ( V_282 -> V_285 ) ;
}
if ( V_282 -> V_271 != - 1 )
F_93 ( V_282 -> V_271 , V_289 ) ;
if ( -- V_10 -> V_106 ) {
...
V_308 , V_67 ) ;
F_29 ( V_10 , V_15 ) ;
F_96 ( V_15 , V_10 -> V_293 , V_10 -> V_69 ) ;
F_83 ( V_15 , V_10 -> V_293 ,
...
static int F_100 ( struct V_314 * V_285 ,
V_89 T_2 * V_315 )
{
const V_89 V_316 = F_101 ( V_285 ) ;
if ( F_102 ( V_316 , V_315 ) )
return - V_100 ;
return 0 ;
}
...
if ( ! V_285 )
return - V_22 ;
V_318 = F_104 ( V_17 , V_285 ) ;
if ( V_318 < 0 )
return V_318 ;
V_316 = F_105 ( V_285 ) ;
if ( F_102 ( V_316 , V_317 ) )
return - V_100 ;
return 0 ;
}
...
int F_108 ( struct V_16 * V_17 , const int V_320 )
{
struct V_9 * V_10 ;
unsigned V_67 ;
int V_11 = 0 ;
...
static T_9 F_111 ( struct V_5 * V_6 , const char T_2 * V_323 ,
...
break;
case V_334 :
V_11 = F_81 ( V_6 , & V_331 . V_331 . V_335 ) ;
if ( V_11 )
goto V_23;
...
static T_9 F_114 ( struct V_359 * V_360 , const struct V_361 * V_362 ,
unsigned long V_363 , T_10 V_325 )
{
struct V_270 * V_6 = V_360 -> V_364 -> V_269 ;
struct V_9 * V_10 = F_5 ( V_360 -> V_364 ) ;
struct V_314 * V_285 = V_6 -> V_285 ;
if ( ! V_363 || ! V_285 )
return - V_22 ;
return F_115 ( V_10 , V_285 , V_362 , V_363 ) ;
}
int F_116 ( int V_365 , const char * V_366 ,
const struct V_367 * V_368 ,
struct V_369 * * V_370 , struct V_371 * * V_372 )
{
const T_11 V_286 = F_117 ( F_118 ( V_373 ) , V_365 ) ;
struct V_369 * V_369 ;
...
V_369 -> V_374 = V_375 ;
V_369 -> V_376 = V_368 ;
F_121 ( & V_369 -> V_377 , V_366 ) ;
V_11 = F_122 ( V_369 , V_286 , 1 ) ;
if ( V_11 < 0 ) {
F_120 (KERN_ERR QIB_DRV_NAME
L_32 ,
minor, name, -ret) ;
...
V_371 = F_123 ( V_379 , NULL , V_286 , NULL , V_366 ) ;
if ( ! F_124 ( V_371 ) )
goto V_118;
V_11 = F_125 ( V_371 ) ;
V_371 = NULL ;
...
void F_127 ( struct V_369 * * V_370 , struct V_371 * * V_372 )
{
...
{
int V_11 ;
V_11 = F_130 ( & V_373 , 0 , V_380 , V_381 ) ;
if ( V_11 < 0 ) {
F_120 (KERN_ERR QIB_DRV_NAME L_35
L_36 , -ret) ;
goto V_118;
}
V_379 = F_131 ( V_375 , L_37 ) ;
if ( F_124 ( V_379 ) ) {
V_11 = F_125 ( V_379 ) ;
F_120 (KERN_ERR QIB_DRV_NAME L_33
L_38 , -ret) ;
...
int V_11 ;
if ( F_25 ( & V_382 ) == 1 ) {
V_11 = F_116 ( 0 , L_37 , & V_387 ,
& V_383 , & V_384 ) ;
if ( V_11 )
goto V_118;
}
snprintf ( V_366 , sizeof( V_366 ) , L_39 , V_15 -> V_46 ) ;
V_11 = F_116 ( V_15 -> V_46 + 1 , V_366 , & V_387 ,
