...
goto V_397;
V_152 = F_147 ( V_355 -> V_357 . V_145 . V_388 ) ;
...
int F_148 ( struct V_7 * V_8 , struct V_416 * V_417 )
{
struct V_354 * V_355 ;
int V_43 = 0 ;
F_35 ( & V_8 -> V_221 ) ;
...
if ( F_149 ( V_355 , V_417 -> V_419 , V_417 -> V_418 ) ) {
F_73 ( V_355 ) ;
V_43 = - V_420 ;
goto V_100;
}
...
if ( V_43 == 0 && F_150 ( V_417 -> V_419 , V_355 , V_417 -> V_418 ) )
V_43 = - V_420 ;
F_73 ( V_355 ) ;
V_100:
F_37 ( & V_8 -> V_221 ) ;
...
F_151 ( V_8 -> V_55 , V_435 , & V_430 , NULL ) ;
}
