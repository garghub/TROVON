...
struct V_137 * V_138 = F_37 ( V_21 -> V_129 ) ;
...
{
struct V_20 * V_21 = V_78 ;
F_36 ( V_78 , V_80 , V_69 , V_81 , V_21 -> V_129 -> V_163 . V_164 ) ;
}
static void
...
struct V_82 * V_83 ;
struct V_20 * V_21 = V_78 ;
struct V_167 * V_129 = V_21 -> V_129 ;
int V_130 = 0 ;
int V_12 ;
for ( V_12 = 0 ; V_12 < V_168 ; V_12 ++ ) {
V_80 = V_129 -> V_169 -> V_170 [ V_12 ] ;
if ( V_80 && V_80 -> V_171 > V_130 )
V_130 = V_80 -> V_171 ;
}
V_83 = F_43 ( sizeof( struct V_15 ) , V_166 ) ;
if ( ! V_83 )
return NULL ;
V_83 -> V_161 = F_43 ( sizeof( struct V_172 ) * V_130 , V_166 ) ;
if ( ! V_83 -> V_161 )
goto error;
V_83 -> V_58 = F_44 ( V_173 * V_130 , V_166 ) ;
if ( ! V_83 -> V_58 )
goto V_174;
return V_83 ;
V_174:
...
static void *
F_47 ( struct V_167 * V_129 , struct V_175 * V_176 )
{
return V_92 . V_177 ( V_129 , V_176 ) ;
}
static void
F_48 ( void * V_78 )
{
