...
static int F_25 ( struct V_74 * V_74 , struct V_75 * V_75 )
{
if ( F_26 ( 0 , & V_76 ) )
return - V_77 ;
F_12 () ;
F_17 () ;
return F_27 ( V_74 , V_75 ) ;
}
static int F_28 ( struct V_74 * V_74 , struct V_75 * V_75 )
{
if ( V_78 == 42 ) {
F_15 () ;
} else {
...
static T_3 F_30 ( struct V_75 * V_75 , const char T_4 * V_58 ,
T_5 V_27 , T_6 * V_80 )
{
if ( V_27 ) {
if ( ! V_81 ) {
...
static long F_32 ( struct V_75 * V_75 , unsigned int V_84 ,
unsigned long V_85 )
{
void T_4 * V_86 = ( void T_4 * ) V_85 ;
int T_4 * V_30 = V_86 ;
int V_59 ;
int V_87 = - V_88 ;
switch ( V_84 ) {
...
static void T_1 F_35 ( struct V_97 * V_98 )
{
V_69 = 1 ;
}
static void T_1 F_35 ( struct V_97 * V_98 )
...
struct V_99 * V_100 ;
if ( V_44 -> type == V_101 ) {
V_100 = (struct V_99 * ) V_44 ;
if ( V_100 -> V_102 & 0x01 )
V_71 = 1 ;
}
}
static int T_1 F_38 ( struct V_97 * V_98 )
{
int V_9 ;
F_11 ( F_37 , NULL ) ;
if ( ! V_71 ) {
...
V_12 . V_13 . V_104 = 0x0D ;
V_12 . V_13 . V_16 = 0x02 ;
}
if ( V_105 )
V_106 . V_105 = 0x7FFFFFFF ;
V_9 = F_39 ( & V_106 ) ;
if ( V_9 != 0 ) {
F_36 ( & V_98 -> V_98 ,
L_16 ,
...
static int T_1 F_43 ( struct V_97 * V_98 ,
...
static void T_7 F_49 ( struct V_97 * V_98 )
{
if ( ! V_81 )
F_15 () ;
F_50 ( & V_117 ) ;
