...
void F_82 ( unsigned long V_156 , struct V_21 * V_21 )
{
if ( V_156 != ~ 0UL ) {
F_83 ( & V_157 ) ;
V_149 . V_153 = V_156 ? ( int ) V_156 :
V_21 -> V_29 . V_115 . V_116 ;
} else {
if ( ! F_84 ( & V_157 ) ) {
F_50 ( & V_21 -> V_29 . V_112 , V_114 + V_158 ) ;
return;
}
...
F_87 ( & V_21 -> V_29 . V_112 ) ;
F_88 ( & V_157 ) ;
}
static void F_89 ( unsigned long V_71 )
{
F_82 ( 0 , (struct V_21 * ) V_71 ) ;
}
static int T_4 F_90 ( struct V_21 * V_21 )
{
T_7 V_159 = sizeof( struct V_42 ) * V_27 ;
F_91 ( & V_21 -> V_29 . V_112 , F_89 , ( unsigned long ) V_21 ) ;
V_21 -> V_29 . V_109 = F_18 ( sizeof( * V_21 -> V_29 . V_109 ) , V_160 ) ;
if ( ! V_21 -> V_29 . V_109 )
goto V_161;
V_159 = F_92 ( T_7 , V_159 , V_162 ) ;
V_21 -> V_29 . V_30 = F_18 ( V_159 , V_160 ) ;
if ( ! V_21 -> V_29 . V_30 )
goto V_163;
...
static void F_94 ( struct V_21 * V_21 )
{
F_95 ( V_21 , NULL ) ;
F_96 ( & V_21 -> V_29 . V_112 ) ;
#ifdef F_93
F_30 ( V_21 -> V_29 . V_47 ) ;
#endif
F_30 ( V_21 -> V_29 . V_46 ) ;
...
if ( V_167 )
goto V_170;
V_167 = F_100 ( V_171 , V_172 , NULL , F_37 ,
NULL ) ;
if ( V_167 )
goto V_173;
V_75:
