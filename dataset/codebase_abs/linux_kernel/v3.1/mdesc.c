...
static void * T_3 F_72 ( struct V_1 * V_2 , T_2 V_88 , int V_119 , void * V_118 )
{
...
const char * V_127 ;
V_127 = F_49 ( V_2 , V_100 ) ;
if ( ! strcmp ( V_127 , L_35 ) ) {
F_55 ( V_87 , V_2 , V_100 ) ;
continue;
}
...
void T_3 F_74 ( T_5 * V_107 )
{
struct V_1 * V_2 ;
F_67 ( F_72 , NULL , V_107 ) ;
#ifdef F_53
V_128 = 1 ;
#endif
V_2 = F_20 () ;
...
static T_6 F_76 ( struct V_129 * V_129 , char T_7 * V_130 ,
T_8 V_46 , T_9 * V_131 )
{
struct V_1 * V_2 = F_20 () ;
int V_132 ;
...
if ( V_46 < V_2 -> V_3 )
V_132 = - V_134 ;
else if ( F_77 ( V_130 , & V_2 -> V_5 , V_2 -> V_3 ) )
V_132 = - V_135 ;
F_24 ( V_2 ) ;
return V_132 ;
}
