...
static int T_1 F_34 ( struct V_2 * V_3 ,
struct V_22 * V_23 )
{
...
+ strlen ( F_37 ( V_3 ) ) + 1 , V_5 ) ;
if ( ! V_28 ) {
V_29 = - V_31 ;
goto V_16;
}
F_15 ( V_3 , V_28 ) ;
sprintf ( V_28 -> V_32 , V_30 L_5 , F_37 ( V_3 ) ) ;
F_2 ( & V_3 -> V_3 , L_6 ) ;
F_38 ( & V_33 ) ;
V_29 = F_39 ( V_3 ) ;
if ( V_29 )
...
static int T_1 F_47 ( struct V_2 * V_3 )
{
struct V_1 * V_4 ;
unsigned long V_12 ;
int V_29 = 0 ;
...
static int T_1 F_49 ( struct V_2 * V_3 ,
...
V_20 -> V_18 ) ;
if ( V_20 -> V_18 ) {
F_53 (KERN_WARNING DRV_NAME L_19
L_20 ,
pci_name(found_psdev->dev)) ;
F_53 (KERN_WARNING DRV_NAME L_21
L_22 ) ;
F_53 (KERN_WARNING DRV_NAME L_23
L_24 ) ;
F_53 (KERN_WARNING DRV_NAME L_25
L_26 ) ;
F_54 ( V_20 -> V_18 ,
V_20 -> V_3 ) ;
}
...
static T_3 F_59 ( struct V_1 * V_4 ,
T_4 V_54 , int V_55 ,
T_3 V_56 )
{
T_3 V_57 = V_56 ;
...
F_62 ( V_64 , ( unsigned long * ) & V_4 -> V_18 -> V_12 ) ;
F_62 ( V_65 ,
( unsigned long * ) & V_4 -> V_18 -> V_61 -> V_12 ) ;
F_61 () ;
F_63 ( V_4 -> V_18 -> V_66 ) ;
V_60 = F_64 ( V_33 ,
! ( F_65 ( V_65 , ( unsigned long * )
...
F_66 ( V_64 , ( unsigned long * ) & V_4 -> V_18 -> V_12 ) ;
if ( F_65 ( V_68 ,
( unsigned long * ) & V_4 -> V_18 -> V_61 -> V_12 ) ) {
F_2 ( & V_4 -> V_3 -> V_3 ,
L_36 ) ;
...
static T_3 F_68 ( struct V_2 * V_3 )
{
struct V_1 * V_4 ;
T_3 V_56 ;
V_56 = V_69 ;
...
static inline int F_74 ( const char * V_79 , int * V_8 , int * V_9 ,
int * V_10 , int * V_11 )
{
int V_29 ;
...
static inline int F_75 ( const char * V_79 , int * V_8 , int * V_9 , int
...
static int F_76 ( int V_8 , int V_9 , int V_10 , int V_11 )
{
struct V_22 * V_84 ;
unsigned long V_12 ;
V_84 = F_77 ( sizeof( * V_84 ) , V_85 ) ;
if ( ! V_84 )
return - V_31 ;
V_84 -> V_8 = V_8 ;
V_84 -> V_9 = V_9 ;
...
unsigned long V_12 ;
F_22 ( & V_26 , V_12 ) ;
F_79 (pci_dev_id, t, &pcistub_device_ids,
slot_list) {
if ( V_84 -> V_8 == V_8
...
static int F_80 ( int V_8 , int V_9 , int V_10 , int V_11 , int V_81 ,
int V_82 , int V_83 )
{
int V_29 = 0 ;
struct V_1 * V_4 ;
...
static T_5 F_82 ( struct V_97 * V_98 , const char * V_79 ,
T_6 V_99 )
{
int V_8 , V_9 , V_10 , V_11 ;
int V_29 ;
V_29 = F_74 ( V_79 , & V_8 , & V_9 , & V_10 , & V_11 ) ;
if ( V_29 )
goto V_16;
V_29 = F_76 ( V_8 , V_9 , V_10 , V_11 ) ;
V_16:
if ( ! V_29 )
V_29 = V_99 ;
return V_29 ;
}
static T_5 F_83 ( struct V_97 * V_98 , const char * V_79 ,
T_6 V_99 )
{
int V_8 , V_9 , V_10 , V_11 ;
int V_29 ;
...
static T_5 F_84 ( struct V_97 * V_98 , char * V_79 )
{
struct V_22 * V_84 ;
T_6 V_99 = 0 ;
unsigned long V_12 ;
...
if ( V_99 >= V_100 )
break;
V_99 += F_85 ( V_79 + V_99 , V_100 - V_99 ,
L_55 ,
V_84 -> V_8 , V_84 -> V_9 ,
F_69 ( V_84 -> V_15 ) ,
F_70 ( V_84 -> V_15 ) ) ;
...
static T_5 F_87 ( struct V_97 * V_98 ,
const char * V_79 ,
T_6 V_99 )
{
struct V_1 * V_4 ;
...
static T_5 F_88 ( struct V_97 * V_98 , const char * V_79 ,
T_6 V_99 )
{
int V_8 , V_9 , V_10 , V_11 , V_81 , V_82 , V_83 ;
int V_29 ;
V_29 = F_75 ( V_79 , & V_8 , & V_9 , & V_10 , & V_11 , & V_81 , & V_82 ,
& V_83 ) ;
if ( V_29 )
goto V_16;
V_29 = F_80 ( V_8 , V_9 , V_10 , V_11 , V_81 , V_82 , V_83 ) ;
V_16:
if ( ! V_29 )
V_29 = V_99 ;
return V_29 ;
}
static T_5 F_89 ( struct V_97 * V_98 , char * V_79 )
{
int V_99 = 0 ;
unsigned long V_12 ;
struct V_104 * V_105 ;
...
L_62 ,
V_105 -> V_18 -> V_9 -> V_14 ,
F_69 ( V_105 -> V_18 -> V_15 ) ,
F_70 ( V_105 -> V_18 -> V_15 ) ,
...
static T_5 F_92 ( struct V_97 * V_98 , char * V_79 )
{
struct V_1 * V_4 ;
struct V_27 * V_28 ;
T_6 V_99 = 0 ;
...
continue;
V_99 +=
F_85 ( V_79 + V_99 , V_100 - V_99 , L_67 ,
F_37 ( V_4 -> V_3 ) ) ;
}
F_26 ( & V_13 , V_12 ) ;
return V_99 ;
...
{
F_94 ( & V_116 . V_117 , & V_118 ) ;
F_94 ( & V_116 . V_117 ,
& V_119 ) ;
F_94 ( & V_116 . V_117 , & V_120 ) ;
F_94 ( & V_116 . V_117 , & V_121 ) ;
F_94 ( & V_116 . V_117 ,
& V_122 ) ;
F_94 ( & V_116 . V_117 ,
& V_123 ) ;
