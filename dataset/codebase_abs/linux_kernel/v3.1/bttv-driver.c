...
static int F_121 ( struct V_409 * V_242 )
{
int V_307 = - 1 , V_18 ;
for ( V_18 = 0 ; V_18 < V_260 ; V_18 ++ ) {
...
F_119 ( V_242 -> V_410 , V_261 [ V_18 ] . V_310 , sizeof( V_242 -> V_410 ) ) ;
return V_18 ;
}
...
V_412 -> V_413 = V_414 ;
if ( V_21 -> V_360 )
V_412 -> V_275 . V_386 = V_21 -> V_360 -> V_259 ;
return 0 ;
}
static int F_125 ( struct V_214 * V_214 , void * V_242 , unsigned int V_415 )
{
struct V_20 * V_21 = V_242 ;
struct V_9 * V_10 = V_21 -> V_10 ;
struct V_262 * V_263 ;
...
! F_89 ( V_416 ) )
return - V_335 ;
V_275 = F_65 ( V_412 -> V_275 . V_386 ) ;
if ( NULL == V_275 )
return - V_100 ;
if ( 0 == ( V_275 -> V_162 & V_365 ) )
return - V_100 ;
V_265 = - V_100 ;
if ( V_412 -> V_162 & V_417 ) {
T_2 V_144 = V_412 -> V_275 . V_144 ;
T_2 V_43 = V_412 -> V_275 . V_43 ;
...
V_10 -> V_294 . V_369 = V_412 -> V_369 ;
V_10 -> V_294 . V_275 . V_144 = V_412 -> V_275 . V_144 ;
V_10 -> V_294 . V_275 . V_43 = V_412 -> V_275 . V_43 ;
if ( 0 != V_412 -> V_275 . V_382 )
V_10 -> V_294 . V_275 . V_382 = V_412 -> V_275 . V_382 ;
else
...
V_21 -> V_370 . V_355 . V_144 = V_412 -> V_275 . V_144 ;
V_21 -> V_370 . V_355 . V_43 = V_412 -> V_275 . V_43 ;
V_10 -> V_373 . V_370 . V_355 . V_144 = V_412 -> V_275 . V_144 ;
V_10 -> V_373 . V_370 . V_355 . V_43 = V_412 -> V_275 . V_43 ;
F_68 ( V_21 -> V_370 . V_363 ) ;
...
static int F_131 ( struct V_214 * V_214 , void * V_215 , struct V_420 * V_338 )
{
struct V_20 * V_21 = V_215 ;
struct V_9 * V_10 = V_21 -> V_10 ;
int V_377 = F_108 ( V_21 ) ;
...
static int F_133 ( struct V_214 * V_214 , void * V_215 , struct V_420 * V_338 )
{
struct V_20 * V_21 = V_215 ;
...
static int F_143 ( struct V_214 * V_214 , void * V_242 , enum V_435 * V_419 )
{
struct V_20 * V_21 = V_242 ;
struct V_9 * V_10 = V_21 -> V_10 ;
* V_419 = F_144 ( & V_10 -> V_244 ) ;
return 0 ;
}
...
static int F_148 ( struct V_214 * V_214 , void * V_242 , struct V_438 * V_30 )
{
struct V_20 * V_21 = V_242 ;
struct V_9 * V_10 = V_21 -> V_10 ;
if ( V_30 -> type != V_374 &&
...
static int F_149 ( struct V_214 * V_214 , void * V_242 , struct V_438 * V_30 )
{
struct V_20 * V_21 = V_242 ;
struct V_9 * V_10 = V_21 -> V_10 ;
const struct V_337 * V_338 ;
...
V_338 = & V_40 [ V_10 -> V_39 ] . V_41 . V_42 ;
V_439 = V_338 -> V_292 ;
V_441 = V_439 + V_338 -> V_144 ;
V_442 = V_338 -> V_29 + V_338 -> V_43 ;
V_440 = F_49 ( V_338 -> V_29 , V_10 -> V_33 ) ;
if ( V_440 + 32 >= V_442 ) {
return V_265 ;
}
V_11 . V_32 . V_292 = F_96 ( V_30 -> V_11 . V_292 , V_439 , V_441 - 48 ) ;
V_11 . V_32 . V_292 = F_94 ( V_11 . V_32 . V_292 , ( T_2 ) V_342 ) ;
V_11 . V_32 . V_144 = F_96 ( V_30 -> V_11 . V_144 ,
48 , V_441 - V_11 . V_32 . V_292 ) ;
V_11 . V_32 . V_29 = F_96 ( V_30 -> V_11 . V_29 , V_440 , V_442 - 32 ) ;
V_11 . V_32 . V_29 = ( V_11 . V_32 . V_29 + 1 ) & ~ 1 ;
V_11 . V_32 . V_43 = F_96 ( V_30 -> V_11 . V_43 ,
32 , V_442 - V_11 . V_32 . V_29 ) ;
...
static int F_150 ( struct V_214 * V_214 , void * V_215 , struct V_443 * V_444 )
{
if ( F_82 ( V_444 -> V_307 ) )
return - V_100 ;
strcpy ( V_444 -> V_310 , L_26 ) ;
return 0 ;
}
static int F_151 ( struct V_214 * V_214 , void * V_215 , struct V_443 * V_444 )
{
if ( F_82 ( V_444 -> V_307 ) )
return - V_100 ;
return 0 ;
...
T_8 V_296 , T_9 * V_445 )
{
struct V_20 * V_21 = V_214 -> V_446 ;
int V_265 = 0 ;
if ( V_21 -> V_10 -> V_213 )
F_59 ( V_21 -> V_10 ) ;
F_24 ( L_27 ,
V_21 -> V_10 -> V_11 . V_61 , ( int ) V_296 , V_447 [ V_21 -> type ] ) ;
switch ( V_21 -> type ) {
case V_374 :
if ( ! F_13 ( V_21 -> V_10 , V_21 , V_25 ) ) {
return - V_352 ;
}
V_265 = F_153 ( & V_21 -> V_271 , V_251 , V_296 , V_445 ,
V_214 -> V_421 & V_422 ) ;
...
return - V_352 ;
V_265 = F_154 ( & V_21 -> V_376 , V_251 , V_296 , V_445 , 1 ,
V_214 -> V_421 & V_422 ) ;
break;
default:
F_98 () ;
...
static unsigned int F_155 ( struct V_214 * V_214 , T_10 * V_448 )
{
struct V_20 * V_21 = V_214 -> V_446 ;
struct V_262 * V_5 ;
enum V_276 V_277 ;
unsigned int V_280 = V_449 ;
if ( V_375 == V_21 -> type ) {
if ( ! F_13 ( V_21 -> V_10 , V_21 , V_378 ) )
return V_449 ;
return F_156 ( V_214 , & V_21 -> V_376 , V_448 ) ;
}
if ( F_14 ( V_21 , V_26 ) ) {
if ( F_157 ( & V_21 -> V_271 . V_450 ) )
goto V_243;
V_5 = F_158 ( V_21 -> V_271 . V_450 . V_451 , struct V_262 , V_266 . V_450 ) ;
} else {
if ( NULL == V_21 -> V_271 . V_452 ) {
if ( F_15 ( V_21 -> V_10 , V_26 ) )
goto V_243;
V_21 -> V_271 . V_452 = F_105 ( V_21 -> V_271 . V_453 ) ;
if ( NULL == V_21 -> V_271 . V_452 )
goto V_243;
V_21 -> V_271 . V_452 -> V_454 = V_455 ;
V_277 = F_159 ( & V_21 -> V_271 ) ;
if ( 0 != V_21 -> V_271 . V_456 -> V_457 ( & V_21 -> V_271 , V_21 -> V_271 . V_452 , V_277 ) ) {
F_68 ( V_21 -> V_271 . V_452 ) ;
V_21 -> V_271 . V_452 = NULL ;
goto V_243;
}
V_21 -> V_271 . V_456 -> V_458 ( & V_21 -> V_271 , V_21 -> V_271 . V_452 ) ;
V_21 -> V_271 . V_459 = 0 ;
}
V_5 = (struct V_262 * ) V_21 -> V_271 . V_452 ;
}
F_160 ( V_214 , & V_5 -> V_266 . V_460 , V_448 ) ;
if ( V_5 -> V_266 . V_267 == V_268 ||
V_5 -> V_266 . V_267 == V_461 )
V_280 = V_462 | V_463 ;
else
V_280 = 0 ;
V_243:
...
{
struct V_6 * V_464 = F_162 ( V_214 ) ;
struct V_9 * V_10 = F_163 ( V_214 ) ;
struct V_20 * V_21 ;
enum V_379 type = 0 ;
F_24 ( V_105 L_28 , F_164 ( V_464 ) ) ;
if ( V_464 -> V_465 == V_466 ) {
type = V_374 ;
} else if ( V_464 -> V_465 == V_467 ) {
type = V_375 ;
} else {
F_165 ( 1 ) ;
return - V_468 ;
...
F_167 ( & V_21 -> V_271 , & V_469 ,
& V_10 -> V_11 . V_399 -> V_8 , & V_10 -> V_164 ,
V_374 ,
V_359 ,
sizeof( struct V_262 ) ,
V_21 , & V_10 -> V_470 ) ;
F_167 ( & V_21 -> V_376 , & V_471 ,
& V_10 -> V_11 . V_399 -> V_8 , & V_10 -> V_164 ,
V_375 ,
V_388 ,
sizeof( struct V_262 ) ,
...
if ( V_21 -> V_271 . V_452 ) {
F_76 ( & V_21 -> V_271 , V_21 -> V_271 . V_452 ) ;
F_68 ( V_21 -> V_271 . V_452 ) ;
}
if ( F_14 ( V_21 , V_25 ) ) {
F_20 ( V_10 , V_21 , V_25 ) ;
...
static int
F_173 ( struct V_214 * V_214 , struct V_473 * V_474 )
{
struct V_20 * V_21 = V_214 -> V_446 ;
F_24 ( L_30 ,
V_21 -> V_10 -> V_11 . V_61 , V_447 [ V_21 -> type ] ,
V_474 -> V_475 , V_474 -> V_476 - V_474 -> V_475 ) ;
return F_174 ( F_107 ( V_21 ) , V_474 ) ;
}
...
F_68 ( V_21 ) ;
V_10 -> V_115 -- ;
F_43 ( V_10 , V_123 , V_480 , V_481 , & V_479 ) ;
return 0 ;
}
...
F_119 ( V_271 -> V_396 , V_10 -> V_482 -> V_310 , sizeof( V_271 -> V_396 ) ) ;
...
static int F_183 ( struct V_214 * V_483 , void * V_215 , unsigned int V_18 )
{
if ( F_82 ( V_18 ) )
return - V_100 ;
return 0 ;
...
static int F_186 ( struct V_214 * V_483 , void * V_215 , unsigned int * V_18 )
{
* V_18 = 0 ;
return 0 ;
}
...
V_479 . V_486 = V_214 ;
V_479 . V_487 = - V_468 ;
F_43 ( V_10 , V_123 , V_480 , V_488 , & V_479 ) ;
return V_479 . V_487 ;
}
static unsigned int F_188 ( struct V_214 * V_214 , T_10 * V_448 )
{
struct V_20 * V_21 = V_214 -> V_446 ;
struct V_9 * V_10 = V_21 -> V_10 ;
struct V_478 V_479 ;
...
V_479 . V_489 = V_448 ;
V_479 . V_487 = - V_468 ;
F_43 ( V_10 , V_123 , V_480 , V_490 , & V_479 ) ;
return V_479 . V_487 ;
}
static int F_189 ( T_4 V_491 )
{
static char * V_492 [ 16 ] = {
[ V_493 >> 28 ] = L_33 ,
[ V_494 >> 28 ] = L_34 ,
[ V_495 >> 28 ] = L_35 ,
[ V_496 >> 28 ] = L_36 ,
...
int V_18 ;
F_21 ( L_57 , V_491 ,
V_492 [ V_491 >> 28 ] ? V_492 [ V_491 >> 28 ] : L_58 ) ;
for ( V_18 = F_12 ( V_48 ) - 1 ; V_18 >= 0 ; V_18 -- )
if ( V_491 & ( 1 << ( V_18 + 12 ) ) )
F_21 ( L_59 , V_48 [ V_18 ] ) ;
F_21 ( L_60 , V_491 & 0xfff ) ;
return V_501 [ V_491 >> 28 ] ? V_501 [ V_491 >> 28 ] : 1 ;
}
static void F_190 ( struct V_9 * V_10 ,
struct V_502 * V_491 )
{
unsigned int V_18 , V_503 , V_364 ;
F_21 ( L_61 ,
V_10 -> V_11 . V_504 . V_310 , V_491 -> V_505 , ( unsigned long ) V_491 -> V_506 ) ;
for ( V_18 = 0 ; V_18 < ( V_491 -> V_286 >> 2 ) ; V_18 += V_364 ) {
F_21 ( L_62 , V_10 -> V_11 . V_504 . V_310 ,
( unsigned long ) ( V_491 -> V_506 + ( V_18 << 2 ) ) ) ;
V_364 = F_189 ( F_191 ( V_491 -> V_505 [ V_18 ] ) ) ;
for ( V_503 = 1 ; V_503 < V_364 ; V_503 ++ )
F_21 ( L_63 ,
V_10 -> V_11 . V_504 . V_310 , ( unsigned long ) ( V_491 -> V_506 + ( ( V_18 + V_503 ) << 2 ) ) ,
V_491 -> V_505 [ V_18 + V_503 ] , V_503 ) ;
if ( 0 == V_491 -> V_505 [ V_18 ] )
break;
}
}
...
{
F_21 ( L_64 ,
( unsigned long long ) V_10 -> main. V_506 ) ;
F_21 ( L_65 ,
V_10 -> V_507 ? ( unsigned long long ) V_10 -> V_507 -> V_29 . V_506 : 0 ,
V_10 -> V_507 ? ( unsigned long long ) V_10 -> V_507 -> V_508 . V_506 : 0 ) ;
F_21 ( L_66 ,
V_10 -> V_165 . V_29 ? ( unsigned long long ) V_10 -> V_165 . V_29 -> V_29 . V_506 : 0 ,
V_10 -> V_165 . V_508 ? ( unsigned long long ) V_10 -> V_165 . V_508 -> V_508 . V_506 : 0 ) ;
F_21 ( L_67 ,
V_10 -> V_269 ? ( unsigned long long ) V_10 -> V_269 -> V_29 . V_506 : 0 ,
V_10 -> V_269 ? ( unsigned long long ) V_10 -> V_269 -> V_508 . V_506 : 0 ) ;
F_190 ( V_10 , & V_10 -> main ) ;
}
static void F_193 ( T_4 V_509 , T_4 V_510 )
{
unsigned int V_18 ;
F_21 ( L_68 ) ;
for ( V_18 = 0 ; V_18 < F_12 ( V_511 ) ; V_18 ++ ) {
if ( V_509 & ( 1 << V_18 ) )
F_21 ( L_59 , V_511 [ V_18 ] ) ;
if ( V_510 & ( 1 << V_18 ) )
F_21 ( L_69 ) ;
}
}
...
F_21 ( L_70 ,
V_10 -> V_11 . V_61 ,
( unsigned long ) V_10 -> main. V_506 ,
( unsigned long ) F_191 ( V_10 -> main. V_505 [ V_512 + 1 ] ) ,
( unsigned long ) F_191 ( V_10 -> main. V_505 [ V_513 + 1 ] ) ,
( unsigned long ) V_280 ) ;
...
static int
F_196 ( struct V_9 * V_10 , struct V_514 * V_515 )
{
struct V_262 * V_516 ;
memset ( V_515 , 0 , sizeof( * V_515 ) ) ;
if ( ! F_157 ( & V_10 -> V_302 ) ) {
V_515 -> V_166 = 1 ;
V_516 = F_158 ( V_10 -> V_302 . V_451 , struct V_262 , V_266 . V_301 ) ;
if ( F_197 ( V_516 -> V_266 . V_277 ) )
V_515 -> V_29 = V_516 ;
if ( F_198 ( V_516 -> V_266 . V_277 ) )
V_515 -> V_508 = V_516 ;
if ( ! F_93 ( V_516 -> V_266 . V_277 ) &&
( V_516 -> V_266 . V_301 . V_451 != & V_10 -> V_302 ) ) {
V_516 = F_158 ( V_516 -> V_266 . V_301 . V_451 , struct V_262 , V_266 . V_301 ) ;
if ( ! F_93 ( V_516 -> V_266 . V_277 ) ) {
if ( NULL == V_515 -> V_508 &&
V_288 == V_516 -> V_266 . V_277 ) {
V_515 -> V_508 = V_516 ;
}
if ( NULL != V_515 -> V_29 && NULL != V_515 -> V_508 )
V_515 -> V_517 = 2 ;
}
}
}
...
if ( NULL == V_515 -> V_29 && NULL == V_515 -> V_508 ) {
V_515 -> V_29 = V_10 -> V_269 ;
V_515 -> V_508 = V_10 -> V_269 ;
}
} else {
...
F_24 ( L_75 ,
V_10 -> V_11 . V_61 , V_515 -> V_29 , V_515 -> V_508 ,
V_10 -> V_269 , V_515 -> V_166 , V_515 -> V_517 ) ;
return 0 ;
}
static void
F_199 ( struct V_9 * V_10 , struct V_514 * V_518 ,
struct V_514 * V_165 , unsigned int V_267 )
{
struct V_519 V_520 ;
F_200 ( & V_520 ) ;
if ( V_518 -> V_29 == V_518 -> V_508 ) {
if ( NULL != V_518 -> V_29 && V_165 -> V_29 != V_518 -> V_29 ) {
if ( V_521 > 1 )
F_21 ( L_76 , V_10 -> V_11 . V_61 , V_518 -> V_29 ) ;
V_518 -> V_29 -> V_266 . V_520 = V_520 ;
V_518 -> V_29 -> V_266 . V_257 = V_10 -> V_257 ;
V_518 -> V_29 -> V_266 . V_267 = V_267 ;
F_201 ( & V_518 -> V_29 -> V_266 . V_460 ) ;
}
} else {
if ( NULL != V_518 -> V_29 && V_165 -> V_29 != V_518 -> V_29 ) {
if ( V_521 > 1 )
F_21 ( L_77 , V_10 -> V_11 . V_61 , V_518 -> V_29 ) ;
V_518 -> V_29 -> V_266 . V_520 = V_520 ;
V_518 -> V_29 -> V_266 . V_257 = V_10 -> V_257 ;
V_518 -> V_29 -> V_266 . V_267 = V_267 ;
F_201 ( & V_518 -> V_29 -> V_266 . V_460 ) ;
}
if ( NULL != V_518 -> V_508 && V_165 -> V_508 != V_518 -> V_508 ) {
if ( V_521 > 1 )
F_21 ( L_78 , V_10 -> V_11 . V_61 , V_518 -> V_508 ) ;
V_518 -> V_508 -> V_266 . V_520 = V_520 ;
V_518 -> V_508 -> V_266 . V_257 = V_10 -> V_257 ;
V_518 -> V_508 -> V_266 . V_267 = V_267 ;
F_201 ( & V_518 -> V_508 -> V_266 . V_460 ) ;
}
}
}
static void
F_202 ( struct V_9 * V_10 , struct V_262 * V_518 ,
unsigned int V_267 )
{
struct V_519 V_520 ;
if ( NULL == V_518 )
return;
F_200 ( & V_520 ) ;
V_518 -> V_266 . V_520 = V_520 ;
V_518 -> V_266 . V_257 = V_10 -> V_257 ;
V_518 -> V_266 . V_267 = V_267 ;
F_201 ( & V_518 -> V_266 . V_460 ) ;
}
static void F_203 ( unsigned long V_251 )
{
struct V_9 * V_10 = (struct V_9 * ) V_251 ;
struct V_514 V_264 , V_263 ;
struct V_262 * V_522 ;
struct V_262 * V_516 ;
unsigned long V_162 ;
if ( V_212 ) {
F_21 ( V_63 L_79 ,
V_10 -> V_11 . V_61 , V_10 -> V_523 , V_10 -> V_524 , V_10 -> V_525 ,
F_18 ( V_526 ) ) ;
F_193 ( F_18 ( V_170 ) , 0 ) ;
F_21 ( L_80 ) ;
}
...
F_205 ( V_10 , NULL ) ;
F_60 ( V_10 , 0 ) ;
F_199 ( V_10 , & V_264 , & V_263 , V_461 ) ;
F_202 ( V_10 , V_522 , V_461 ) ;
while ( ! F_157 ( & V_10 -> V_302 ) ) {
V_516 = F_158 ( V_10 -> V_302 . V_451 , struct V_262 , V_266 . V_301 ) ;
F_206 ( & V_516 -> V_266 . V_301 ) ;
V_516 -> V_266 . V_267 = V_461 ;
F_201 ( & V_516 -> V_266 . V_460 ) ;
}
while ( ! F_157 ( & V_10 -> V_527 ) ) {
V_516 = F_158 ( V_10 -> V_527 . V_451 , struct V_262 , V_266 . V_301 ) ;
F_206 ( & V_516 -> V_266 . V_301 ) ;
V_516 -> V_266 . V_267 = V_461 ;
F_201 ( & V_516 -> V_266 . V_460 ) ;
}
...
{
struct V_262 * V_518 = V_10 -> V_165 . V_29 ;
if ( NULL == V_518 )
return;
F_208 ( & V_10 -> V_164 ) ;
V_10 -> V_165 . V_517 = 0 ;
V_10 -> V_165 . V_29 = NULL ;
F_209 ( V_10 , V_513 , NULL , 0 ) ;
F_200 ( & V_518 -> V_266 . V_520 ) ;
V_518 -> V_266 . V_257 = V_10 -> V_257 ;
V_518 -> V_266 . V_267 = V_268 ;
F_201 ( & V_518 -> V_266 . V_460 ) ;
F_210 ( & V_10 -> V_164 ) ;
}
static inline int F_211 ( struct V_502 * V_491 , T_4 V_280 )
{
if ( V_280 < V_491 -> V_506 )
return 0 ;
if ( V_280 > V_491 -> V_506 + V_491 -> V_286 )
return 0 ;
return 1 ;
}
static void
...
( V_10 -> V_165 . V_508 && F_211 ( & V_10 -> V_165 . V_508 -> V_508 , V_280 ) ) ) {
V_10 -> V_523 ++ ;
if ( V_528 )
F_194 ( V_10 , V_280 ) ;
F_210 ( & V_10 -> V_164 ) ;
...
F_208 ( & V_10 -> V_164 ) ;
if ( ! F_157 ( & V_10 -> V_527 ) )
V_263 = F_158 ( V_10 -> V_527 . V_451 , struct V_262 , V_266 . V_301 ) ;
V_264 = V_10 -> V_507 ;
V_280 = F_18 ( V_526 ) ;
if ( NULL != V_264 && ( F_211 ( & V_264 -> V_29 , V_280 ) ||
F_211 ( & V_264 -> V_508 , V_280 ) ) ) {
V_10 -> V_523 ++ ;
if ( V_528 )
F_194 ( V_10 , V_280 ) ;
F_210 ( & V_10 -> V_164 ) ;
...
static T_12 F_214 ( int V_529 , void * V_530 )
{
T_4 V_531 , V_532 ;
T_4 V_533 ;
int V_296 ;
struct V_9 * V_10 ;
int V_534 = 0 ;
V_10 = (struct V_9 * ) V_530 ;
V_296 = 0 ;
while ( 1 ) {
V_531 = F_18 ( V_170 ) ;
V_532 = V_531 & F_18 ( V_173 ) ;
if ( ! V_532 )
break;
V_534 = 1 ;
F_19 ( V_531 , V_170 ) ;
...
F_193 ( V_531 , V_532 ) ;
if ( V_531 & V_183 )
F_21 ( L_83 , ( V_533 & V_112 )
? L_84 : L_85 ) ;
if ( V_531 & V_535 )
F_21 ( L_86 , ( V_533 & V_314 )
? L_84 : L_85 ) ;
if ( V_531 & V_182 )
F_21 ( L_87 , ( V_533 & V_303 )
? L_88 : L_89 ) ;
F_21 ( L_80 ) ;
}
if ( V_532 & V_256 )
V_10 -> V_257 ++ ;
if ( ( V_532 & V_176 ) && V_10 -> V_536 ) {
F_215 ( V_10 ) ;
}
if ( V_532 & V_172 ) {
V_10 -> V_537 = V_531 ;
...
if ( ( V_532 & V_180 ) && ( V_531 & ( 4 << 28 ) ) )
F_213 ( V_10 ) ;
if ( ( V_532 & V_180 ) && ( V_531 & ( 2 << 28 ) ) )
F_207 ( V_10 ) ;
if ( ( V_532 & V_180 ) && ( V_531 & ( 1 << 28 ) ) )
F_212 ( V_10 ) ;
if ( ( V_532 & V_183 ) && V_10 -> V_114 )
F_46 ( V_10 , V_10 -> V_107 ) ;
if ( V_532 & ( V_177 | V_181 ) ) {
F_21 ( V_63 L_90 , V_10 -> V_11 . V_61 ,
( V_532 & V_177 ) ? L_91 : L_92 ,
( V_532 & V_181 ) ? L_93 : L_92 ,
F_18 ( V_526 ) ) ;
F_193 ( V_531 , V_532 ) ;
F_21 ( L_80 ) ;
if ( V_539 )
...
if ( V_178 && V_532 & V_179 ) {
F_21 ( V_63 L_94 ,
V_10 -> V_11 . V_61 , F_18 ( V_526 ) ) ;
if ( V_539 )
F_192 ( V_10 ) ;
}
V_296 ++ ;
if ( V_296 > 4 ) {
if ( V_296 > 8 || ! ( V_532 & V_176 ) ) {
F_19 ( 0 , V_173 ) ;
F_21 ( V_392
L_95 , V_10 -> V_11 . V_61 ) ;
} else {
...
return NULL ;
* V_7 = * V_540 ;
V_7 -> V_504 = & V_10 -> V_11 . V_504 ;
V_7 -> V_542 = V_543 ;
V_7 -> V_544 = V_539 ;
F_219 ( V_7 , V_10 ) ;
snprintf ( V_7 -> V_310 , sizeof( V_7 -> V_310 ) , L_98 ,
V_10 -> V_17 , ( V_10 -> V_17 == 848 && V_10 -> V_545 == 0x12 ) ? L_99 : L_92 ,
V_541 , V_98 [ V_10 -> V_11 . type ] . V_310 ) ;
return V_7 ;
}
...
if ( V_391 > 0 )
F_21 ( L_100 ) ;
V_10 -> V_397 = F_217 ( V_10 , & V_547 , L_101 ) ;
if ( NULL == V_10 -> V_397 )
goto V_243;
if ( F_224 ( V_10 -> V_397 , V_466 ,
...
V_10 -> V_546 = F_217 ( V_10 , & V_547 , L_104 ) ;
if ( NULL == V_10 -> V_546 )
goto V_243;
if ( F_224 ( V_10 -> V_546 , V_467 ,
V_550 [ V_10 -> V_11 . V_61 ] ) < 0 )
goto V_243;
F_21 ( V_63 L_102 ,
V_10 -> V_11 . V_61 , F_164 ( V_10 -> V_546 ) ) ;
if ( ! V_10 -> V_551 )
return 0 ;
V_10 -> V_482 = F_217 ( V_10 , & V_552 , L_105 ) ;
if ( NULL == V_10 -> V_482 )
goto V_243;
if ( F_224 ( V_10 -> V_482 , V_553 ,
V_554 [ V_10 -> V_11 . V_61 ] ) < 0 )
goto V_243;
F_21 ( V_63 L_102 ,
V_10 -> V_11 . V_61 , F_164 ( V_10 -> V_482 ) ) ;
return 0 ;
V_243:
F_220 ( V_10 ) ;
return - 1 ;
}
static void F_226 ( struct V_555 * V_8 )
{
#if F_227 ( V_556 )
unsigned int V_479 ;
F_228 ( V_8 , V_557 , & V_479 ) ;
V_479 = ( V_479 | V_558 ) ;
F_229 ( V_8 , V_557 , V_479 ) ;
#endif
}
static int T_13 F_230 ( struct V_555 * V_8 ,
...
if ( V_562 == V_563 )
return - V_367 ;
F_21 ( V_63 L_106 , V_562 ) ;
V_564 [ V_562 ] = V_10 = F_231 ( sizeof( * V_10 ) , V_366 ) ;
if ( V_10 == NULL ) {
F_21 ( V_392 L_107 ) ;
return - V_367 ;
}
V_10 -> V_11 . V_61 = V_562 ;
snprintf ( V_10 -> V_11 . V_504 . V_310 , sizeof( V_10 -> V_11 . V_504 . V_310 ) ,
L_108 , V_10 -> V_11 . V_61 ) ;
F_232 ( & V_10 -> V_470 ) ;
F_233 ( & V_10 -> V_164 ) ;
F_233 ( & V_10 -> V_565 ) ;
F_234 ( & V_10 -> V_538 ) ;
F_235 ( & V_10 -> V_11 . V_566 ) ;
F_235 ( & V_10 -> V_302 ) ;
F_235 ( & V_10 -> V_527 ) ;
F_236 ( & V_10 -> V_244 ) ;
F_237 ( & V_10 -> V_567 ) ;
V_10 -> V_567 . V_568 = F_203 ;
V_10 -> V_567 . V_251 = ( unsigned long ) V_10 ;
V_10 -> V_569 = - 1 ;
V_10 -> V_168 = V_12 ;
V_10 -> V_167 = V_12 ;
V_10 -> V_551 = V_570 [ V_10 -> V_11 . V_61 ] ;
V_10 -> V_11 . V_399 = V_8 ;
V_10 -> V_17 = V_8 -> V_1 ;
if ( F_238 ( V_8 ) ) {
F_21 ( V_571 L_109 ,
...
F_244 ( V_8 ) ;
F_226 ( V_8 ) ;
V_487 = F_245 ( & V_8 -> V_8 , & V_10 -> V_11 . V_504 ) ;
if ( V_487 < 0 ) {
F_21 ( V_571 L_112 , V_10 -> V_11 . V_61 ) ;
goto V_573;
}
V_10 -> V_545 = V_8 -> V_545 ;
F_246 ( V_8 , V_574 , & V_561 ) ;
F_21 ( V_63 L_113 ,
V_562 , V_10 -> V_17 , V_10 -> V_545 , F_120 ( V_8 ) ) ;
F_21 ( L_114 ,
V_10 -> V_11 . V_399 -> V_529 , V_561 ,
( unsigned long long ) F_242 ( V_8 , 0 ) ) ;
F_247 () ;
V_10 -> V_575 = F_248 ( F_242 ( V_8 , 0 ) , 0x1000 ) ;
if ( NULL == V_10 -> V_575 ) {
...
F_249 ( V_10 ) ;
F_19 ( 0 , V_173 ) ;
V_487 = F_250 ( V_10 -> V_11 . V_399 -> V_529 , F_214 ,
V_577 | V_578 , V_10 -> V_11 . V_504 . V_310 , ( void * ) V_10 ) ;
if ( V_487 < 0 ) {
F_21 ( V_392 L_116 ,
V_562 , V_10 -> V_11 . V_399 -> V_529 ) ;
goto V_576;
}
if ( 0 != F_251 ( V_10 ) ) {
V_487 = - V_572 ;
...
return 0 ;
V_579:
F_260 ( V_10 -> V_11 . V_399 -> V_529 , V_10 ) ;
V_576:
F_261 ( & V_10 -> V_11 . V_504 ) ;
V_573:
if ( V_10 -> V_575 )
F_262 ( V_10 -> V_575 ) ;
...
static void T_14 F_264 ( struct V_555 * V_555 )
{
struct V_593 * V_504 = F_265 ( V_555 ) ;
struct V_9 * V_10 = F_266 ( V_504 ) ;
if ( V_212 )
...
F_243 ( V_10 -> V_11 . V_399 , 0 ) ) ;
F_261 ( & V_10 -> V_11 . V_504 ) ;
V_564 [ V_10 -> V_11 . V_61 ] = NULL ;
F_68 ( V_10 ) ;
return;
}
static int F_271 ( struct V_555 * V_555 , T_15 V_267 )
{
struct V_593 * V_504 = F_265 ( V_555 ) ;
struct V_9 * V_10 = F_266 ( V_504 ) ;
struct V_514 V_595 ;
unsigned long V_162 ;
F_24 ( L_122 , V_10 -> V_11 . V_61 , V_267 . V_596 ) ;
F_55 ( & V_10 -> V_164 , V_162 ) ;
memset ( & V_595 , 0 , sizeof( V_595 ) ) ;
V_10 -> V_267 . V_597 = V_10 -> V_165 ;
V_10 -> V_267 . V_376 = V_10 -> V_507 ;
...
F_19 ( 0 , V_173 ) ;
F_56 ( & V_10 -> V_164 , V_162 ) ;
V_10 -> V_267 . V_598 = F_18 ( V_252 ) ;
V_10 -> V_267 . V_599 = F_53 () ;
F_272 ( V_555 ) ;
if ( 0 != F_273 ( V_555 , F_274 ( V_555 , V_267 ) ) ) {
F_275 ( V_555 ) ;
V_10 -> V_267 . V_600 = 1 ;
}
return 0 ;
}
static int F_276 ( struct V_555 * V_555 )
{
struct V_593 * V_504 = F_265 ( V_555 ) ;
struct V_9 * V_10 = F_266 ( V_504 ) ;
unsigned long V_162 ;
...
F_277 ( V_555 ) ;
F_59 ( V_10 ) ;
F_34 ( 0xffffff , V_10 -> V_267 . V_598 ) ;
F_278 ( V_10 -> V_267 . V_599 ) ;
F_55 ( & V_10 -> V_164 , V_162 ) ;
V_10 -> V_165 = V_10 -> V_267 . V_597 ;
V_10 -> V_507 = V_10 -> V_267 . V_376 ;
V_10 -> V_270 = V_10 -> V_267 . V_270 ;
F_204 ( V_10 , & V_10 -> V_165 ) ;
F_205 ( V_10 , V_10 -> V_507 ) ;
F_60 ( V_10 , 0 ) ;
F_56 ( & V_10 -> V_164 , V_162 ) ;
return 0 ;
}
...
F_21 ( V_63 L_124 ,
V_603 ) ;
if ( V_297 < 2 || V_297 > V_604 )
V_297 = 2 ;
if ( V_298 > V_605 )
V_298 = V_605 ;
V_298 = ( V_298 + V_606 - 1 ) & V_607 ;
if ( V_212 )
F_21 ( V_63 L_125 ,
V_297 , V_298 >> 10 , V_298 >> V_608 ) ;
F_280 () ;
V_602 = F_281 ( & V_609 ) ;
if ( V_602 < 0 ) {
F_21 ( V_571 L_126 , V_602 ) ;
return V_602 ;
}
V_602 = F_282 ( & V_610 ) ;
if ( V_602 < 0 )
