...
const struct V_212 * V_36 )
{
struct V_143 * V_65 = F_83 ( V_53 ) ;
struct V_34 * V_35 ;
int V_112 ;
if ( V_36 -> V_147 && V_36 -> V_213 )
F_16 ( V_183 , L_97
L_98 , V_65 -> V_214 , V_36 -> V_147 ,
V_36 -> V_213 ) ;
else
F_16 ( V_183 , L_99 ,
V_65 -> V_214 ) ;
...
? V_36 -> V_218 : V_217 ;
if ( V_65 -> V_219 != NULL )
F_17 ( V_35 -> V_69 , V_65 -> V_219 , sizeof V_35 -> V_69 ) ;
else
snprintf ( V_35 -> V_69 , sizeof V_35 -> V_69 ,
L_100 ,
F_31 ( V_65 -> V_146 . V_147 ) ,
F_31 ( V_65 -> V_146 . V_213 ) ) ;
if ( F_42 ( V_35 ) < 0 ) {
F_16 ( V_183 , L_101
L_102 ) ;
goto error;
...
V_65 -> V_219 ? V_65 -> V_219 : L_104 ,
F_31 ( V_65 -> V_146 . V_147 ) ,
F_31 ( V_65 -> V_146 . V_213 ) ) ;
if ( V_35 -> V_97 != V_36 -> V_218 ) {
F_18 ( V_71 , L_105
L_106 , V_35 -> V_97 ) ;
F_18 ( V_71 , L_107
L_108 ) ;
...
F_17 ( V_35 -> V_202 . V_220 , V_35 -> V_69 , sizeof( V_35 -> V_202 . V_220 ) ) ;
if ( V_65 -> V_221 )
F_17 ( V_35 -> V_202 . V_221 , V_65 -> V_221 ,
sizeof( V_35 -> V_202 . V_221 ) ) ;
strcpy ( V_35 -> V_202 . V_222 , V_65 -> V_214 ) ;
V_35 -> V_202 . V_223 = F_31 ( V_65 -> V_146 . V_224 ) ;
V_35 -> V_202 . V_225 = V_226 ;
if ( F_86 ( & V_35 -> V_202 ) < 0 )
goto error;
V_35 -> V_201 . V_202 = & V_35 -> V_202 ;
#endif
if ( F_87 ( & V_53 -> V_35 , & V_35 -> V_201 ) < 0 )
goto error;
if ( F_88 ( V_35 ) < 0 )
goto error;
if ( F_54 ( V_35 ) < 0 )
...
static int F_94 ( struct V_52 * V_53 , T_7 V_230 )
{
struct V_34 * V_35 = F_93 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_231 , L_113 ,
...
static int F_97 ( struct V_52 * V_53 , int V_233 )
{
struct V_34 * V_35 = F_93 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_231 , L_116 ,
...
static int F_102 ( struct V_52 * V_53 )
{
return F_97 ( V_53 , 1 ) ;
}
static int F_103 ( char * V_50 , struct V_234 * V_235 )
{
if ( V_236 == V_237 )
...
static int F_104 ( const char * V_238 , struct V_234 * V_235 )
{
if ( strncasecmp ( V_238 , L_120 , strlen ( L_120 ) ) == 0 )
V_238 += strlen ( L_120 ) ;
if ( strcasecmp ( V_238 , L_121 ) == 0 )
V_236 = V_237 ;
else if ( strcasecmp ( V_238 , L_122 ) == 0 )
V_236 = V_239 ;
else
return - V_68 ;
return 0 ;
