...
struct V_179 * V_180 = V_175 -> V_180 + V_93 ;
...
{
struct V_184 * V_185 = V_61 -> V_29 . V_107 ;
struct V_172 * V_173 ;
struct V_186 * V_187 ;
F_37 ( V_188 , & V_61 -> V_29 , L_44 ) ;
V_173 = F_111 ( & V_61 -> V_29 , sizeof( * V_173 ) , V_112 ) ;
if ( ! V_173 )
return - V_117 ;
V_187 = F_128 ( V_61 , V_189 , 0 ) ;
if ( ! V_187 )
return - V_140 ;
V_173 -> V_170 = F_129 ( & V_61 -> V_29 , V_187 -> V_190 ,
F_130 ( V_187 ) ) ;
if ( ! V_173 -> V_170 )
return - V_95 ;
V_187 = F_128 ( V_61 , V_189 , 1 ) ;
if ( ! V_187 )
return - V_140 ;
V_173 -> V_191 = F_129 ( & V_61 -> V_29 , V_187 -> V_190 ,
F_130 ( V_187 ) ) ;
if ( ! V_173 -> V_191 )
return - V_95 ;
F_113 ( V_61 , V_173 ) ;
if ( V_185 != NULL && V_185 -> V_175 != NULL )
F_121 ( V_173 , V_185 -> V_175 ) ;
return 0 ;
}
static int F_131 ( struct V_151 * V_61 )
{
return 0 ;
}
