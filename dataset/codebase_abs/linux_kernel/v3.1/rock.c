...
V_3 -> V_78 = F_16 ( V_2 -> V_4 . V_76 . V_79 ) ;
V_3 -> V_80 = F_16 ( V_2 -> V_4 . V_76 . V_81 ) ;
V_3 -> V_82 = F_16 ( V_2 -> V_4 . V_76 . V_83 ) ;
break;
case F_13 ( 'P' , 'N' ) :
{
int V_84 , V_85 ;
...
case F_13 ( 'T' , 'F' ) :
V_63 = 0 ;
if ( V_2 -> V_4 . V_90 . V_53 & V_91 ) {
V_3 -> V_92 . V_93 =
F_20 ( V_2 -> V_4 . V_90 . V_94 [ V_63 ++ ] . time ,
0 ) ;
V_3 -> V_92 . V_95 = 0 ;
}
if ( V_2 -> V_4 . V_90 . V_53 & V_96 ) {
V_3 -> V_97 . V_93 =
F_20 ( V_2 -> V_4 . V_90 . V_94 [ V_63 ++ ] . time ,
0 ) ;
V_3 -> V_97 . V_95 = 0 ;
}
if ( V_2 -> V_4 . V_90 . V_53 & V_98 ) {
V_3 -> V_99 . V_93 =
F_20 ( V_2 -> V_4 . V_90 . V_94 [ V_63 ++ ] . time ,
0 ) ;
V_3 -> V_99 . V_95 = 0 ;
}
if ( V_2 -> V_4 . V_90 . V_53 & V_100 ) {
V_3 -> V_92 . V_93 =
F_20 ( V_2 -> V_4 . V_90 . V_94 [ V_63 ++ ] . time ,
0 ) ;
V_3 -> V_92 . V_95 = 0 ;
...
static char * F_27 ( char * V_123 , struct V_1 * V_2 , char * V_124 )
{
int V_101 ;
int V_65 ;
struct V_102 * V_104 ;
...
switch ( V_103 -> V_53 & ~ 1 ) {
case 0 :
if ( V_103 -> V_14 > V_124 - V_123 )
return NULL ;
memcpy ( V_123 , V_103 -> V_125 , V_103 -> V_14 ) ;
V_123 += V_103 -> V_14 ;
break;
case 2 :
if ( V_123 >= V_124 )
...
int F_28 ( struct V_10 * V_11 , struct V_3 * V_3 )
{
...
static int F_29 ( struct V_127 * V_127 , struct V_128 * V_128 )
{
struct V_3 * V_3 = V_128 -> V_129 -> V_130 ;
struct V_131 * V_132 = F_21 ( V_3 ) ;
struct V_133 * V_134 = F_2 ( V_3 -> V_7 ) ;
char * V_106 = F_30 ( V_128 ) ;
unsigned long V_135 = F_31 ( V_3 ) ;
struct V_28 * V_29 ;
char * V_123 = V_106 ;
unsigned char * V_136 ;
struct V_10 * V_137 ;
