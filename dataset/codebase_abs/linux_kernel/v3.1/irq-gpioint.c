...
V_6 -> V_37 . V_61 = V_62 ;
V_6 -> V_37 . V_63 = F_1 ,
V_6 -> V_26 . V_64 = V_41 + F_9 ( V_31 - V_30 -> V_49 ) ;
V_6 -> V_26 . V_35 = V_42 + F_9 ( V_31 - V_30 -> V_49 ) ;
V_6 -> V_26 . type = V_65 + F_9 ( V_31 - V_30 -> V_49 ) ;
F_22 ( V_4 , F_23 ( V_37 -> V_37 . V_66 ) ,
V_67 ,
V_68 | V_69 , 0 ) ;
return 0 ;
}
int T_1 F_24 ( int V_70 )
{
struct V_39 * V_71 = F_25 ( V_70 ) ;
int V_43 , V_31 ;
int V_72 ;
if ( ! V_71 )
return - V_23 ;
V_43 = V_70 - V_71 -> V_37 . V_73 ;
V_31 = V_71 -> V_31 ;
if ( V_71 -> V_10 )
return V_71 -> V_10 + V_43 ;
V_72 = F_16 ( V_71 ) ;
if ( V_72 == 0 ) {
V_71 -> V_37 . V_74 = V_75 ;
F_3 ( V_52 L_4 ,
...
int T_1 F_26 ( int V_76 , int V_49 , int V_38 )
{
struct V_29 * V_30 ;
