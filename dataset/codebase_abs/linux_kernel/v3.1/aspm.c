...
struct V_1 * V_2 , * V_106 , * V_114 ;
if ( ( V_109 && ! V_97 ) || ! F_14 ( V_17 ) ||
! V_35 || ! V_35 -> V_69 )
return;
if ( ( V_35 -> V_86 != V_108 ) &&
( V_35 -> V_86 != V_105 ) )
...
static void F_49 ( struct V_13 * V_17 , int V_94 , bool V_115 )
{
struct V_13 * V_35 = V_17 -> V_67 -> V_68 ;
struct V_1 * V_2 ;
if ( V_109 || ! F_14 ( V_17 ) )
...
{
F_49 ( V_17 , V_94 , false ) ;
}
void F_51 ( struct V_13 * V_17 , int V_94 )
{
F_49 ( V_17 , V_94 , true ) ;
}
static int F_52 ( const char * V_93 , struct V_117 * V_118 )
{
int V_119 ;
struct V_1 * V_2 ;
if ( V_109 )
return - V_120 ;
for ( V_119 = 0 ; V_119 < F_53 ( V_121 ) ; V_119 ++ )
...
static int F_54 ( char * V_122 , struct V_117 * V_118 )
{
int V_119 , V_123 = 0 ;
for ( V_119 = 0 ; V_119 < F_53 ( V_121 ) ; V_119 ++ )
if ( V_119 == V_3 )
...
static T_3 F_55 ( struct V_124 * V_48 ,
struct V_125 * V_126 ,
char * V_127 )
{
struct V_13 * V_128 = F_56 ( V_48 ) ;
struct V_1 * V_69 = V_128 -> V_69 ;
return sprintf ( V_127 , L_7 , V_69 -> V_80 ) ;
}
static T_3 F_57 ( struct V_124 * V_48 ,
struct V_125 * V_126 ,
const char * V_127 ,
T_4 V_129 )
{
struct V_13 * V_17 = F_56 ( V_48 ) ;
...
return;
if ( V_69 -> V_83 )
F_61 ( & V_17 -> V_48 . V_130 ,
& V_131 . V_126 , V_132 ) ;
if ( V_69 -> V_22 )
F_61 ( & V_17 -> V_48 . V_130 ,
& V_133 . V_126 , V_132 ) ;
}
void F_62 ( struct V_13 * V_17 )
{
struct V_1 * V_69 = V_17 -> V_69 ;
if ( ! F_14 ( V_17 ) ||
( V_17 -> V_86 != V_108 &&
...
return;
if ( V_69 -> V_83 )
F_63 ( & V_17 -> V_48 . V_130 ,
& V_131 . V_126 , V_132 ) ;
if ( V_69 -> V_22 )
F_63 ( & V_17 -> V_48 . V_130 ,
& V_133 . V_126 , V_132 ) ;
}
static int T_5 F_64 ( char * V_134 )
{
if ( ! strcmp ( V_134 , L_8 ) ) {
V_109 = 1 ;
V_135 = false ;
