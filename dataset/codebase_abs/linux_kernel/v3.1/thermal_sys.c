...
{
struct V_16 * V_17 = F_28 ( V_85 , struct
V_16 ,
V_78 . V_85 ) ;
F_20 ( V_17 ) ;
}
...
struct V_41 * V_88 ;
int V_25 ;
if ( V_33 >= V_17 -> V_89 || ( V_33 < 0 && V_33 != V_46 ) )
return - V_31 ;
...
V_25 =
F_60 ( & V_17 -> V_11 . V_90 , & V_42 -> V_11 . V_90 , V_12 -> V_35 ) ;
if ( V_25 )
goto F_7;
sprintf ( V_12 -> V_91 , L_20 , V_12 -> V_4 ) ;
F_44 ( & V_12 -> V_14 . V_14 ) ;
V_12 -> V_14 . V_14 . V_35 = V_12 -> V_91 ;
...
if ( V_86 -> V_17 == V_17 && V_86 -> V_33 == V_33 && V_86 -> V_42 == V_42 ) {
V_25 = - V_93 ;
break;
}
if ( ! V_25 )
F_45 ( & V_12 -> V_74 , & V_17 -> V_94 ) ;
F_6 ( & V_17 -> V_3 ) ;
if ( ! V_25 )
return 0 ;
F_46 ( & V_17 -> V_11 , & V_12 -> V_14 ) ;
V_92:
F_61 ( & V_17 -> V_11 . V_90 , V_12 -> V_35 ) ;
F_7:
...
return - V_97 ;
V_96:
F_46 ( & V_17 -> V_11 , & V_86 -> V_14 ) ;
F_61 ( & V_17 -> V_11 . V_90 , V_86 -> V_35 ) ;
...
struct V_16 * V_17 ;
struct V_41 * V_42 ;
if ( ! strncmp ( F_64 ( V_12 ) , L_21 , sizeof "thermal_zone" - 1 ) ) {
V_17 = F_10 ( V_12 ) ;
F_47 ( V_17 ) ;
} else {
V_42 = F_23 ( V_12 ) ;
...
struct V_41 * F_65 (
char * type , void * V_98 , const struct V_99 * V_20 )
{
struct V_41 * V_42 ;
struct V_16 * V_86 ;
int V_25 ;
...
V_42 -> V_20 = V_20 ;
V_42 -> V_11 . V_102 = & V_103 ;
V_42 -> V_98 = V_98 ;
F_67 ( & V_42 -> V_11 , L_22 , V_42 -> V_4 ) ;
V_25 = F_68 ( & V_42 -> V_11 ) ;
if ( V_25 ) {
F_7 ( & V_100 , & V_101 , V_42 -> V_4 ) ;
F_47 ( V_42 ) ;
return F_66 ( V_25 ) ;
}
if ( type ) {
V_25 = F_43 ( & V_42 -> V_11 , & V_104 ) ;
if ( V_25 )
goto V_105;
}
V_25 = F_43 ( & V_42 -> V_11 , & V_106 ) ;
if ( V_25 )
goto V_105;
...
goto V_105;
F_4 ( & V_45 ) ;
F_69 ( & V_42 -> V_74 , & V_108 ) ;
F_17 (pos, &thermal_tz_list, node) {
if ( ! V_86 -> V_20 -> V_109 )
continue;
V_25 = V_86 -> V_20 -> V_109 ( V_86 , V_42 ) ;
if ( V_25 )
break;
}
F_6 ( & V_45 ) ;
...
if ( ! V_17 -> V_20 -> V_96 )
continue;
V_17 -> V_20 -> V_96 ( V_17 , V_42 ) ;
}
F_6 ( & V_45 ) ;
if ( V_42 -> type [ 0 ] )
F_46 ( & V_42 -> V_11 , & V_104 ) ;
F_46 ( & V_42 -> V_11 , & V_106 ) ;
...
F_72 (KERN_WARNING PREFIX L_23
L_12 , tz->id) ;
goto V_111;
}
for ( V_28 = 0 ; V_28 < V_17 -> V_89 ; V_28 ++ ) {
V_17 -> V_20 -> V_34 ( V_17 , V_28 , & V_110 ) ;
V_17 -> V_20 -> V_40 ( V_17 , V_28 , & V_79 ) ;
switch ( V_110 ) {
case V_36 :
if ( V_60 >= V_79 ) {
if ( V_17 -> V_20 -> V_112 )
V_19 = V_17 -> V_20 -> V_112 ( V_17 , V_28 ,
V_110 ) ;
if ( ! V_19 ) {
F_72 ( V_113
L_24 ,
...
if ( V_60 >= V_79 )
if ( V_17 -> V_20 -> V_112 )
V_17 -> V_20 -> V_112 ( V_17 , V_28 , V_110 ) ;
break;
case V_39 :
F_17 (instance, &tz->cooling_devices,
node) {
...
for ( V_28 = 0 ; V_28 < V_89 ; V_28 ++ ) {
F_77 ( & V_17 -> V_11 , V_28 , V_25 ) ;
if ( V_25 )
goto V_105;
V_17 -> V_20 -> V_34 ( V_17 , V_28 , & V_110 ) ;
if ( V_110 == V_38 )
...
goto V_105;
F_4 ( & V_45 ) ;
F_45 ( & V_17 -> V_74 , & V_122 ) ;
if ( V_20 -> V_109 )
F_17 (pos, &thermal_cdev_list, node) {
V_25 = V_20 -> V_109 ( V_17 , V_86 ) ;
if ( V_25 )
break;
}
F_6 ( & V_45 ) ;
...
int F_83 ( T_3 V_123 , enum V_124 V_125 )
{
struct V_126 * V_127 ;
struct V_128 * V_14 ;
struct V_129 * V_130 ;
...
int V_132 ;
int V_25 ;
V_132 = F_84 ( sizeof( struct V_129 ) ) + \
F_84 ( 0 ) ;
V_127 = F_85 ( V_132 , V_133 ) ;
if ( ! V_127 )
return - V_8 ;
V_131 = F_86 ( V_127 , 0 , V_134 ++ ,
& V_135 , 0 ,
V_136 ) ;
if ( ! V_131 ) {
F_87 ( V_127 ) ;
...
V_130 -> V_123 = V_123 ;
V_130 -> V_125 = V_125 ;
V_25 = F_90 ( V_127 , V_131 ) ;
if ( V_25 < 0 ) {
F_87 ( V_127 ) ;
return V_25 ;
}
V_25 = F_91 ( V_127 , 0 , V_138 . V_4 , V_133 ) ;
if ( V_25 )
F_72 ( V_139 L_26 , V_25 ) ;
return V_25 ;
}
