...
if ( ! F_98 ( V_254 -> V_75 , F_99 ( V_254 ) ,
V_23 -> V_22 . V_263 -> V_141 ) ) {
F_97 ( & V_23 -> V_22 , L_19 ) ;
return - V_264 ;
}
V_256 = F_100 ( V_23 , V_265 , L_20 ) ;
if ( ! V_256 ) {
V_76 = - V_223 ;
goto V_266;
}
V_255 = F_100 ( V_23 , V_265 , L_21 ) ;
if ( ! V_255 ) {
V_76 = - V_223 ;
goto V_266;
}
V_2 = F_101 ( sizeof( * V_2 ) , V_267 ) ;
if ( V_2 == NULL ) {
V_76 = - V_268 ;
goto V_269;
}
...
V_2 -> V_17 . V_249 = 2 ;
F_102 ( & ( V_2 -> V_17 . V_80 ) ) ;
F_102 ( & ( V_2 -> V_17 . V_276 ) ) ;
V_2 -> V_17 . V_29 = V_21 ;
V_2 -> V_17 . V_20 = V_21 ;
}
V_244 [ V_23 -> V_24 ] = V_2 ;
F_82 ( V_2 ) ;
V_76 = F_103 ( & V_242 , & V_2 -> V_4 ) ;
if ( V_76 != 0 )
goto V_269;
F_104 ( V_23 , V_2 ) ;
return 0 ;
V_266:
F_97 ( & V_23 -> V_22 , L_23 ,
V_23 -> V_24 , V_277 , V_76 ) ;
V_269:
F_105 ( V_254 -> V_75 , F_99 ( V_254 ) ) ;
return V_76 ;
}
static int F_106 ( struct V_241 * V_22 )
{
struct V_1 * V_2 = F_84 ( V_22 ) ;
F_104 ( V_22 , NULL ) ;
if ( V_2 ) {
