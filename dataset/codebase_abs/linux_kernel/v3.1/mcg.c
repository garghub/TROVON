...
return V_17 ;
* V_68 = * V_3 ;
* V_3 = F_19 ( V_27 -> V_72 ) >> 6 ;
} while ( * V_3 );
* V_3 = - 1 ;
return V_17 ;
}
int F_37 ( struct V_1 * V_2 , struct V_73 * V_45 , T_1 V_65 [ 16 ] ,
int V_74 , enum V_66 V_32 ,
enum V_21 V_12 )
{
struct F_9 * V_57 = F_9 ( V_2 ) ;
struct V_4 * V_5 ;
...
int F_41 ( struct V_1 * V_2 , struct V_73 * V_45 , T_1 V_65 [ 16 ] ,
...
V_27 -> V_45 [ V_53 - 1 ] = 0 ;
if ( V_32 == V_61 )
V_79 = F_29 ( V_2 , 0 , V_11 , V_12 , V_3 , V_45 -> V_22 ) ;
if ( V_53 != 1 && ( V_32 != V_61 || ! V_79 ) ) {
V_17 = F_3 ( V_2 , V_3 , V_5 ) ;
goto V_54;
}
V_27 -> V_28 = F_20 ( ( T_2 ) V_32 << 30 ) ;
if ( V_68 == - 1 ) {
int V_80 = F_19 ( V_27 -> V_72 ) >> 6 ;
if ( V_80 ) {
V_17 = F_1 ( V_2 , V_80 , V_5 ) ;
if ( V_17 )
goto V_54;
} else
...
goto V_54;
if ( V_80 ) {
if ( V_80 < V_2 -> V_33 . V_77 )
F_26 ( V_2 , L_12 ,
V_3 , V_80 , V_2 -> V_33 . V_77 ) ;
else
F_40 ( & V_57 -> V_58 . V_76 ,
V_80 - V_2 -> V_33 . V_77 ) ;
}
} else {
int V_81 = F_19 ( V_27 -> V_72 ) >> 6 ;
V_17 = F_1 ( V_2 , V_68 , V_5 ) ;
if ( V_17 )
goto V_54;
V_27 -> V_72 = F_20 ( V_81 << 6 ) ;
V_17 = F_3 ( V_2 , V_68 , V_5 ) ;
if ( V_17 )
goto V_54;
if ( V_3 < V_2 -> V_33 . V_77 )
F_26 ( V_2 , L_13 ,
V_68 , V_3 , V_2 -> V_33 . V_77 ) ;
else
F_40 ( & V_57 -> V_58 . V_76 ,
V_3 - V_2 -> V_33 . V_77 ) ;
}
...
int F_42 ( struct V_1 * V_2 , struct V_73 * V_45 , T_1 V_65 [ 16 ] ,
int V_74 , enum V_66 V_32 )
{
enum V_21 V_12 ;
V_12 = ( F_43 ( & V_65 [ 10 ] ) ) ? V_82 : V_83 ;
if ( V_32 == V_61 &&
! ( V_2 -> V_33 . V_70 & V_71 ) )
return 0 ;
if ( V_32 == V_61 )
...
int F_44 ( struct V_1 * V_2 , struct V_73 * V_45 , T_1 V_65 [ 16 ] ,
enum V_66 V_32 )
{
enum V_21 V_12 ;
V_12 = ( F_43 ( & V_65 [ 10 ] ) ) ? V_82 : V_83 ;
...
{
if ( ! ( V_2 -> V_33 . V_70 & V_71 ) )
return 0 ;
return F_30 ( V_2 , 0 , V_11 , V_83 , V_22 ) ;
}
int F_46 ( struct V_1 * V_2 , T_2 V_22 , T_1 V_11 )
{
if ( ! ( V_2 -> V_33 . V_70 & V_71 ) )
return 0 ;
return F_33 ( V_2 , 0 , V_11 , V_83 , V_22 ) ;
}
...
struct F_9 * V_57 = F_9 ( V_2 ) ;
int V_17 ;
V_17 = F_50 ( & V_57 -> V_58 . V_76 , V_2 -> V_33 . V_84 ,
V_2 -> V_33 . V_84 - 1 , 0 , 0 ) ;
if ( V_17 )
return V_17 ;
F_51 ( & V_57 -> V_58 . V_59 ) ;
