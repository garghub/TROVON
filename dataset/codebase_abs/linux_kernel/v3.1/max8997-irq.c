...
static T_2 F_13 ( int V_19 , void * V_18 )
{
struct V_2 * V_3 = V_18 ;
T_1 V_33 [ V_22 ] = {} ;
T_1 V_34 ;
...
F_16 ( V_3 -> V_8 , V_47 ,
V_46 , V_45 ) ;
for ( V_21 = 0 ; V_21 < V_46 ; V_21 ++ ) {
bool V_48 = false ;
switch ( V_45 [ V_21 ] & V_49 ) {
case V_50 :
if ( V_3 -> V_51 [ V_21 ] != V_45 [ V_21 ] )
V_48 = true ;
break;
case V_52 :
if ( ( V_3 -> V_51 [ V_21 ] != V_45 [ V_21 ] ) &&
