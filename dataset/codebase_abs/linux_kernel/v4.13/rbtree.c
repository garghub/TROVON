...
static T_1 void
F_12 ( struct V_1 * V_11 , struct V_8 * V_9 ,
void (* F_8)( struct V_1 * V_6 , struct V_1 * V_7 ) )
{
...
void F_14 ( struct V_1 * V_11 , struct V_8 * V_9 ,
void (* F_8)( struct V_1 * V_6 , struct V_1 * V_7 ) )
{
F_12 ( V_11 , V_9 , F_8 ) ;
}
static inline void F_15 ( struct V_1 * V_12 , struct V_1 * V_21 ) {}
...
{
struct V_1 * V_22 ;
V_22 = F_20 ( V_12 , V_9 , & V_23 ) ;
if ( V_22 )
F_12 ( V_22 , V_9 , F_17 ) ;
}
void F_21 ( struct V_1 * V_12 , struct V_8 * V_9 ,
void (* F_8)( struct V_1 * V_6 , struct V_1 * V_7 ) )
{
F_7 ( V_12 , V_9 , F_8 ) ;
}
...
struct V_1 * F_23 ( const struct V_8 * V_9 )
{
struct V_1 * V_24 ;
V_24 = V_9 -> V_1 ;
if ( ! V_24 )
...
struct V_1 * F_26 ( const struct V_1 * V_12 )
{
struct V_1 * V_11 ;
if ( F_25 ( V_12 ) )
return NULL ;
...
void F_27 ( struct V_1 * V_25 , struct V_1 * V_7 ,
struct V_8 * V_9 )
{
...
void F_28 ( struct V_1 * V_25 , struct V_1 * V_7 ,
struct V_8 * V_9 )
{
struct V_1 * V_11 = F_4 ( V_25 ) ;
* V_7 = * V_25 ;
...
if ( V_25 -> V_15 )
F_13 ( V_25 -> V_15 , V_7 ) ;
F_29 ( V_25 , V_7 , V_11 , V_9 ) ;
}
static struct V_1 * F_30 ( const struct V_1 * V_12 )
{
for (; ; ) {
if ( V_12 -> V_17 )
V_12 = V_12 -> V_17 ;
...
struct V_1 * F_31 ( const struct V_1 * V_12 )
{
const struct V_1 * V_11 ;
if ( ! V_12 )
return NULL ;
V_11 = F_4 ( V_12 ) ;
if ( V_11 && V_12 == V_11 -> V_17 && V_11 -> V_15 ) {
return F_30 ( V_11 -> V_15 ) ;
} else
return (struct V_1 * ) V_11 ;
}
struct V_1 * F_32 ( const struct V_8 * V_9 )
{
if ( ! V_9 -> V_1 )
return NULL ;
return F_30 ( V_9 -> V_1 ) ;
