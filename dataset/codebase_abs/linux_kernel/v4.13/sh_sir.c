...
& V_2 -> V_59 , ( T_3 ) V_4 ) ;
if ( V_93 & F_3 ( V_2 , V_94 ) )
continue;
break;
}
}
static T_5 F_38 ( int V_95 , void * V_96 )
{
struct V_1 * V_2 = V_96 ;
struct V_14 * V_15 = & V_2 -> V_16 -> V_15 ;
int V_67 = F_31 ( V_2 ) ;
...
static int F_39 ( struct V_99 * V_100 , struct V_101 * V_16 )
{
struct V_1 * V_2 = F_40 ( V_16 ) ;
int V_102 = F_41 ( V_100 ) ;
if ( ( 0 < V_102 ) &&
( 9600 != V_102 ) ) {
F_11 ( & V_16 -> V_15 , L_18 , V_102 ) ;
return - V_18 ;
}
F_42 ( V_16 ) ;
...
V_2 -> V_60 . V_82 = 0 ;
if ( V_100 -> V_82 )
V_2 -> V_60 . V_82 = F_43 ( V_100 , V_2 -> V_60 . V_4 ,
V_2 -> V_60 . V_55 ) ;
F_30 ( V_2 , V_70 ) ;
F_44 ( V_100 ) ;
return 0 ;
}
static int F_45 ( struct V_101 * V_16 , struct V_103 * V_103 , int V_104 )
{
return 0 ;
}
static struct V_105 * F_46 ( struct V_101 * V_16 )
{
struct V_1 * V_2 = F_40 ( V_16 ) ;
return & V_2 -> V_16 -> V_92 ;
}
static int F_47 ( struct V_101 * V_16 )
{
struct V_1 * V_2 = F_40 ( V_16 ) ;
int V_63 ;
F_48 ( V_2 -> V_21 ) ;
...
goto V_106;
F_17 ( V_2 , 9600 ) ;
V_2 -> V_107 = F_49 ( V_16 , & V_2 -> V_108 , V_109 ) ;
if ( ! V_2 -> V_107 ) {
V_63 = - V_110 ;
goto V_106;
}
F_5 ( V_2 , V_94 , V_111 , V_111 ) ;
F_3 ( V_2 , V_85 ) ;
F_3 ( V_2 , V_91 ) ;
F_30 ( V_2 , V_76 ) ;
F_50 ( V_16 ) ;
...
static int F_53 ( struct V_101 * V_16 )
{
struct V_1 * V_2 = F_40 ( V_16 ) ;
if ( V_2 -> V_107 ) {
F_54 ( V_2 -> V_107 ) ;
...
int V_95 ;
int V_63 = - V_54 ;
V_115 = F_56 ( V_113 , V_117 , 0 ) ;
V_95 = F_57 ( V_113 , 0 ) ;
if ( ! V_115 || V_95 < 0 ) {
F_11 ( & V_113 -> V_15 , L_21 ) ;
goto exit;
}
...
goto exit;
V_2 = F_40 ( V_16 ) ;
V_2 -> V_5 = F_59 ( V_115 -> V_118 , F_60 ( V_115 ) ) ;
if ( ! V_2 -> V_5 ) {
V_63 = - V_119 ;
F_11 ( & V_113 -> V_15 , L_22 ) ;
goto V_120;
}
V_63 = F_28 ( V_2 , V_121 , V_122 ) ;
if ( V_63 )
goto V_123;
snprintf ( V_116 , sizeof( V_116 ) , L_23 , V_113 -> V_124 ) ;
V_2 -> V_21 = F_13 ( & V_113 -> V_15 , V_116 ) ;
if ( F_18 ( V_2 -> V_21 ) ) {
F_11 ( & V_113 -> V_15 , L_24 , V_116 ) ;
V_63 = - V_110 ;
goto V_125;
}
F_61 ( & V_2 -> V_108 ) ;
...
V_16 -> V_95 = V_95 ;
V_2 -> V_16 = V_16 ;
V_2 -> V_108 . V_128 . V_129 &= V_130 ;
V_2 -> V_108 . V_131 . V_129 = 1 ;
F_62 ( & V_2 -> V_108 ) ;
V_63 = F_63 ( V_16 ) ;
if ( V_63 )
goto V_132;
F_64 ( V_113 , V_16 ) ;
V_63 = F_65 ( & V_113 -> V_15 , V_95 , F_38 , 0 , L_25 , V_2 ) ;
if ( V_63 ) {
F_23 ( & V_113 -> V_15 , L_26 ) ;
goto V_132;
}
F_51 ( & V_113 -> V_15 , L_27 ) ;
goto exit;
V_132:
F_15 ( V_2 -> V_21 ) ;
V_125:
