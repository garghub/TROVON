...
return true ;
else if ( V_45 > V_2 -> V_52 -> V_53 )
return false ;
return V_2 -> V_52 -> V_53 - V_45 >
V_2 -> V_6 . V_7 . V_46 . V_19 . V_50 * V_54 ;
}
STATIC int
F_52 (
struct V_1 * V_2 ,
...
type , F_66 ( V_84 , V_78 ) ,
V_79 ) ;
V_99 = F_75 ( sizeof( struct V_98 ) ,
V_100 | V_101 ) ;
F_76 ( & V_99 -> V_102 ) ;
V_99 -> V_103 = type ;
V_99 -> V_104 = V_78 ;
V_99 -> V_105 = V_79 ;
F_77 ( V_57 , V_106 , & V_99 -> V_102 ) ;
return 0 ;
}
int
F_78 (
...
if ( ! F_79 ( & V_84 -> V_48 ) )
return 0 ;
return F_73 ( V_84 , V_57 , V_93 ,
V_108 -> V_109 , V_108 -> V_110 ) ;
}
int
F_80 (
struct V_83 * V_84 ,
...
* V_111 = V_37 ;
* V_112 = 0 ;
error = F_1 ( V_2 , V_25 , & V_114 ) ;
if ( error )
goto V_23;
if ( ! V_114 ) {
error = F_38 ( V_2 , 0 , & V_114 ) ;
if ( error )
goto V_23;
if ( ! V_114 )
goto V_115;
...
* V_111 = V_28 . V_12 ;
* V_112 = F_39 ( V_28 . V_13 , V_25 + V_33 - * V_111 ) ;
if ( ! V_113 )
goto V_115;
while ( * V_111 + * V_112 < V_25 + V_33 ) {
error = F_38 ( V_2 , 0 , & V_114 ) ;
if ( error )
goto V_23;
if ( ! V_114 )
...
F_18 ( V_2 -> V_5 , V_22 == 1 , V_23 ) ;
if ( V_28 . V_12 >= V_25 + V_33 ||
V_28 . V_12 != * V_111 + * V_112 )
break;
* V_112 = F_39 ( * V_112 + V_28 . V_13 , V_25 + V_33 - * V_111 ) ;
}
V_115:
F_83 ( V_2 -> V_5 ,
V_2 -> V_6 . V_7 . V_8 , * V_111 , * V_112 ) ;
V_23:
if ( error )
F_84 ( V_2 -> V_5 ,
V_2 -> V_6 . V_7 . V_8 , error , V_21 ) ;
...
void * V_46 )
{
struct V_122 * V_123 = V_46 ;
struct V_124 * V_125 ;
if ( F_6 ( V_16 -> V_19 . V_20 ) != 1 )
return - V_90 ;
V_125 = F_75 ( sizeof( struct V_124 ) , V_100 ) ;
F_5 ( V_16 , & V_125 -> V_126 ) ;
F_96 ( & V_125 -> V_127 , V_123 ) ;
return 0 ;
}
int
F_97 (
...
V_130 . V_11 . V_12 = V_116 ;
V_131 . V_11 . V_12 = - 1U ;
error = F_99 ( V_2 , & V_130 , & V_131 ,
F_95 , & V_123 ) ;
if ( error )
goto V_134;
F_62 ( V_2 , V_76 ) ;
...
error = F_102 ( V_84 , & F_103 ( V_84 ) -> V_135 , 0 , 0 , 0 , & V_71 ) ;
if ( error )
goto V_136;
F_104 ( V_84 , V_8 , & V_125 -> V_126 ) ;
F_105 ( & V_57 , & V_120 ) ;
V_25 = V_125 -> V_126 . V_12 - V_116 ;
V_120 = F_54 ( V_84 , V_8 , V_25 ) ;
error = F_94 ( V_84 , & V_57 , V_120 ,
V_125 -> V_126 . V_13 ) ;
if ( error )
goto V_137;
F_55 ( V_84 , & V_57 , V_120 ,
V_125 -> V_126 . V_13 , NULL ) ;
