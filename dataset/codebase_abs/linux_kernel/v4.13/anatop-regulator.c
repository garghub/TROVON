...
V_30 -> type = V_39 ;
V_30 -> V_40 = V_41 ;
F_16 ( V_26 , L_1 , & V_30 -> V_42 ) ;
if ( ! V_30 -> V_42 ) {
F_17 ( V_24 , L_2 ) ;
return - V_43 ;
}
V_34 = F_18 ( V_24 , V_26 , V_30 ) ;
if ( ! V_34 )
return - V_38 ;
V_34 -> V_44 = L_3 ;
V_32 -> V_34 = V_34 ;
...
F_24 ( V_26 , L_18 ,
& V_32 -> V_12 ) ;
V_30 -> V_52 = ( V_32 -> V_51 - V_32 -> V_50 ) / 25000 + 1
+ V_32 -> V_49 ;
V_30 -> V_53 = V_32 -> V_50 ;
V_30 -> V_54 = 25000 ;
V_30 -> V_55 = V_32 -> V_49 ;
V_30 -> V_56 = V_32 -> V_46 ;
V_30 -> V_57 = ( ( 1 << V_32 -> V_47 ) - 1 ) <<
V_32 -> V_48 ;
V_30 -> V_58 = 125000 ;
V_36 . V_24 = & V_22 -> V_24 ;
V_36 . V_59 = V_34 ;
...
V_36 . V_61 = V_32 -> V_10 ;
if ( V_32 -> V_46 && V_32 -> V_9 ) {
V_30 -> V_62 = & V_63 ;
V_8 = F_3 ( V_36 . V_61 , V_30 -> V_56 , & V_7 ) ;
if ( V_8 ) {
F_17 ( V_24 , L_19 ) ;
return V_8 ;
}
V_32 -> V_15 = ( V_7 & V_30 -> V_57 ) >> V_32 -> V_48 ;
if ( V_32 -> V_15 == V_17 ) {
V_32 -> V_15 = 0 ;
V_32 -> V_16 = true ;
}
if ( ! V_32 -> V_15 && ! strcmp ( V_30 -> V_42 , L_20 ) )
V_32 -> V_15 = 22 ;
if ( ! V_32 -> V_15 && ! strcmp ( V_30 -> V_42 , L_21 ) )
V_32 -> V_15 = 0x10 ;
