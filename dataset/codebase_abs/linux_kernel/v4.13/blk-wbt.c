...
if ( F_10 ( & V_20 -> V_21 ) &&
V_20 -> V_21 . V_71 . V_72 != & V_21 -> V_73 )
return false ;
return F_2 ( & V_20 -> V_24 , F_45 ( V_2 , V_68 ) ) ;
}
static void F_49 ( struct V_1 * V_2 , unsigned long V_68 , T_4 * V_74 )
__releases( V_74 )
__acquires( V_74 )
{
...
static inline bool F_56 ( struct V_1 * V_2 , struct V_76 * V_76 )
{
const int V_77 = F_57 ( V_76 ) ;
if ( V_77 != V_78 )
return false ;
if ( ( V_76 -> V_79 & ( V_80 | V_81 ) ) == ( V_80 | V_81 ) )
return false ;
return true ;
}
enum V_22 F_58 ( struct V_1 * V_2 , struct V_76 * V_76 , T_4 * V_74 )
{
unsigned int V_37 = 0 ;
if ( ! F_1 ( V_2 ) )
return 0 ;
...
void F_64 ( struct V_1 * V_2 , bool V_84 )
{
if ( V_2 )
V_2 -> V_28 = V_84 ;
}
...
{
struct V_1 * V_2 = V_86 -> V_1 ;
if ( V_2 && V_2 -> V_87 == V_88 )
F_66 ( V_86 ) ;
}
void F_67 ( struct V_85 * V_86 )
{
if ( V_86 -> V_1 )
return;
if ( ! F_68 ( V_89 , & V_86 -> V_90 ) )
return;
if ( ( V_86 -> V_91 && F_69 ( V_92 ) ) ||
( V_86 -> V_93 && F_69 ( V_94 ) ) )
F_70 ( V_86 ) ;
}
T_2 F_71 ( struct V_85 * V_86 )
{
if ( F_72 ( V_86 ) )
return 2000000ULL ;
else
...
static int F_73 ( const struct V_95 * V_96 )
{
return F_74 ( V_96 ) ;
}
int F_70 ( struct V_85 * V_86 )
{
struct V_1 * V_2 ;
int V_18 ;
F_75 ( V_97 > V_98 ) ;
V_2 = F_76 ( sizeof( * V_2 ) , V_99 ) ;
if ( ! V_2 )
return - V_100 ;
...
V_2 -> V_38 = F_71 ( V_86 ) ;
F_63 ( V_2 , F_82 ( V_86 ) ) ;
F_64 ( V_2 , F_68 ( V_103 , & V_86 -> V_90 ) ) ;
return 0 ;
}
void F_66 ( struct V_85 * V_86 )
{
struct V_1 * V_2 = V_86 -> V_1 ;
if ( V_2 ) {
F_83 ( V_86 , V_2 -> V_62 ) ;
