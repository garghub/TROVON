...
if ( V_84 . V_96 == 0 )
V_84 . V_96 = V_80 ;
V_79 = V_3 -> V_97 ( V_87 , V_84 . V_96 , & V_81 ) ;
if ( ! V_79 ) {
V_17 = - V_98 ;
goto V_67;
}
V_3 -> V_99 ( V_3 -> V_94 , F_32 ( V_81 ) ) ;
V_3 -> V_100 ( V_3 , V_81 , 1 , V_101 , NULL ) ;
F_19 ( V_84 . V_96 , V_79 ) ;
if ( V_3 -> V_64 & V_102 ) {
F_33 () ;
F_34 ( V_79 + 2 , V_85 , V_80 - 1 ) ;
F_33 () ;
F_35 ( V_85 [ V_80 - 1 ] , V_79 + V_80 + 1 ) ;
} else
F_34 ( V_79 + 2 , V_85 , V_80 ) ;
if ( V_3 -> V_64 & V_103 ) {
T_1 V_104 = ( V_81 >= V_3 -> V_51 ) ? 2047 : 1023 ;
F_33 () ;
F_35 ( 0xaebecede , V_79 + V_104 ) ;
}
F_33 () ;
F_36 ( V_3 , V_81 ) ;
V_3 -> V_100 ( V_3 , V_81 , 1 , V_105 , NULL ) ;
V_17 = sizeof( V_84 ) ;
V_67:
F_37 ( V_85 ) ;
return V_17 ;
}
static int F_38 ( struct V_70 * V_71 , struct V_72 * V_73 )
{
F_26 ( & V_74 ) ;
F_3 ( V_73 -> V_77 ) ;
V_73 -> V_77 = NULL ;
...
static const struct V_106 * F_42 ( struct V_2 * V_3 ,
T_1 V_112 )
{
struct V_108 * V_109 ;
...
while ( V_109 ) {
V_107 = V_109 -> V_107 ;
if ( V_112 >= V_107 -> V_113 && V_112 <= V_107 -> V_114 )
break;
V_109 = V_109 -> V_6 ;
}
if ( ! V_109 )
...
static T_5 F_43 ( struct V_72 * V_73 , char T_3 * V_68 ,
T_4 V_60 , T_6 * V_78 )
{
...
V_17 = - V_66 ;
else if ( V_4 -> V_10 < V_117 && ( * V_78 || V_60 != 8 ) )
V_17 = - V_66 ;
else {
unsigned long V_64 ;
V_41 V_118 = 0 ;
...
if ( V_107 ) {
T_1 V_29 = * V_78 ;
V_17 = V_107 -> V_120 ( V_3 , V_107 , V_29 , & V_118 , 0 , V_119 ) ;
}
F_41 ( & V_3 -> V_110 , V_64 ) ;
if ( ! V_107 ) {
if ( V_119 )
...
static T_5 F_44 ( struct V_72 * V_73 , const char T_3 * V_68 ,
T_4 V_60 , T_6 * V_78 )
{
struct V_1 * V_4 = V_73 -> V_77 ;
struct V_2 * V_3 = V_4 -> V_3 ;
...
V_17 = - V_66 ;
else if ( V_4 -> V_10 < V_117 &&
( ( * V_78 || V_60 != 8 ) || V_4 -> V_10 != V_121 ) )
V_17 = - V_66 ;
else {
unsigned long V_64 ;
const struct V_106 * V_107 = NULL ;
int V_119 = ( V_60 % 8 ) || ( * V_78 % 8 ) ;
if ( V_60 == 4 || V_60 == 8 ) {
V_41 V_118 ;
T_1 V_29 = * V_78 ;
V_17 = F_18 ( & V_118 , V_68 , V_60 ) ;
if ( V_17 ) {
V_17 = - V_69 ;
goto V_67;
}
...
V_107 = F_42 ( V_3 , * V_78 ) ;
if ( V_107 )
V_17 = V_107 -> V_120 ( V_3 , V_107 , V_29 , & V_118 , ~ 0Ull ,
V_119 ) ;
F_41 ( & V_3 -> V_110 , V_64 ) ;
}
if ( ! V_107 ) {
