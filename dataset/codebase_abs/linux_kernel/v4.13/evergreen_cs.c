...
V_105 = V_144 -> V_105 + 1 ;
V_145 = V_144 -> V_145 ;
for ( V_14 = 0 ; V_14 <= V_144 -> V_146 ; V_14 ++ , V_105 ++ , V_145 += 4 ) {
...
case V_179 :
case V_180 :
V_87 = F_73 ( V_53 , & V_148 , 0 ) ;
if ( V_87 ) {
F_7 ( V_53 -> V_66 , L_53
L_54 , V_145 ) ;
return - V_68 ;
}
V_89 [ V_105 ] += ( T_1 ) ( ( V_148 -> V_181 >> 8 ) & 0xffffffff ) ;
break;
case V_182 :
...
V_89 [ V_105 ] &= ~ F_74 ( 0xf ) ;
V_13 -> V_33 &= ~ F_74 ( 0xf ) ;
V_89 [ V_105 ] |= F_74 ( F_1 ( V_148 -> V_1 ) ) ;
V_13 -> V_33 |= F_74 ( F_1 ( V_148 -> V_1 ) ) ;
if ( V_148 -> V_1 & V_2 ) {
unsigned V_75 , V_78 , V_190 , V_191 ;
F_75 ( V_148 -> V_1 ,
& V_75 , & V_78 , & V_190 ,
& V_191 ) ;
V_89 [ V_105 ] |= F_76 ( F_2 ( V_13 -> V_7 ) ) ;
V_89 [ V_105 ] |= F_77 ( V_191 ) |
F_78 ( V_75 ) |
F_79 ( V_78 ) |
F_80 ( V_190 ) ;
}
...
V_89 [ V_105 ] |= F_81 ( F_1 ( V_148 -> V_1 ) ) ;
V_13 -> V_21 [ V_91 ] |= F_81 ( F_1 ( V_148 -> V_1 ) ) ;
}
V_13 -> V_28 = true ;
break;
case V_238 :
...
V_89 [ V_105 ] |= F_83 ( V_191 ) |
F_84 ( V_75 ) |
F_85 ( V_78 ) |
F_86 ( V_190 ) ;
}
}
V_91 = ( ( V_145 - V_266 ) / 0x3c ) ;
...
V_91 = ( V_145 - V_310 ) / 0x3c ;
V_13 -> V_20 [ V_91 ] = F_43 ( V_53 , V_105 ) ;
V_89 [ V_105 ] += ( T_1 ) ( ( V_148 -> V_181 >> 8 ) & 0xffffffff ) ;
V_13 -> V_19 [ V_91 ] = V_148 -> V_197 ;
V_13 -> V_28 = true ;
break;
case V_318 :
case V_319 :
...
unsigned V_105 ;
unsigned V_14 ;
unsigned V_430 , V_431 , V_145 ;
int V_87 ;
T_1 V_432 ;
V_13 = (struct V_12 * ) V_53 -> V_13 ;
V_89 = V_53 -> V_89 . V_90 ;
V_105 = V_144 -> V_105 + 1 ;
V_432 = F_43 ( V_53 , V_105 ) ;
switch ( V_144 -> V_433 ) {
case V_434 :
{
int V_435 ;
...
V_13 -> V_451 = F_23 ( V_148 -> V_197 ) ;
V_89 [ V_105 + 1 ] = V_148 -> V_181 ;
V_89 [ V_105 + 2 ] = F_91 ( V_148 -> V_181 ) & 0xff ;
break;
}
case V_452 :
case V_453 :
{
T_3 V_93 = V_144 -> V_433 == V_452 ? 16 : 20 ;
if ( V_144 -> V_146 != 1 ) {
F_64 ( L_76 ) ;
return - V_68 ;
}
if ( V_432 + V_93 > V_13 -> V_451 ) {
F_7 ( V_53 -> V_66 , L_77 ,
V_432 , V_93 , V_13 -> V_451 ) ;
return - V_68 ;
}
V_87 = F_63 ( V_53 ) ;
if ( V_87 ) {
...
V_89 [ V_105 + 0 ] = V_432 + ( T_1 ) ( V_148 -> V_181 & 0xffffffff ) ;
V_87 = F_63 ( V_53 ) ;
if ( V_87 ) {
F_7 ( V_53 -> V_66 , L_65 , V_67 , __LINE__ ) ;
return V_87 ;
...
case V_457 :
{
T_1 V_458 , V_93 , V_459 ;
T_3 V_86 , V_91 ;
if ( V_144 -> V_146 != 4 ) {
F_64 ( L_82 ) ;
return - V_68 ;
}
V_458 = F_43 ( V_53 , V_105 + 4 ) ;
V_93 = V_458 & 0x1fffff ;
V_459 = F_43 ( V_53 , V_105 + 1 ) ;
if ( ( ( ( V_459 & 0x60000000 ) >> 29 ) != 0 ) ||
( ( ( V_459 & 0x00300000 ) >> 20 ) != 0 ) ||
( ( ( ( V_459 & 0x00300000 ) >> 20 ) == 0 ) &&
( V_458 & V_460 ) ) ||
( ( ( ( V_459 & 0x60000000 ) >> 29 ) == 0 ) &&
( V_458 & V_461 ) ) ) {
if ( V_93 % 4 ) {
F_64 ( L_83 ) ;
return - V_68 ;
...
( ( T_3 ) ( F_43 ( V_53 , V_105 + 1 ) & 0xff ) << 32 ) ;
V_86 = V_148 -> V_181 + V_91 ;
if ( ( V_91 + V_93 ) > F_23 ( V_148 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_87 ,
V_91 + V_93 , F_23 ( V_148 -> V_197 ) ) ;
return - V_68 ;
}
V_89 [ V_105 ] = V_86 ;
V_89 [ V_105 + 1 ] = ( V_89 [ V_105 + 1 ] & 0xffffff00 ) | ( F_91 ( V_86 ) & 0xff ) ;
} else if ( ( ( V_459 & 0x60000000 ) >> 29 ) != 2 ) {
F_64 ( L_88 ) ;
return - V_68 ;
}
}
if ( V_458 & V_460 ) {
if ( ( ( V_459 & 0x00300000 ) >> 20 ) != 1 ) {
F_64 ( L_89 ) ;
return - V_68 ;
}
} else {
...
V_89 [ V_105 + 2 ] += ( T_1 ) ( ( V_148 -> V_181 >> 8 ) & 0xffffffff ) ;
}
break;
case V_466 :
if ( V_144 -> V_146 != 2 && V_144 -> V_146 != 0 ) {
F_64 ( L_96 ) ;
return - V_68 ;
}
if ( V_144 -> V_146 ) {
...
for ( V_145 = V_430 , V_105 ++ ; V_145 <= V_431 ; V_145 += 4 , V_105 ++ ) {
if ( F_88 ( V_53 , V_145 ) )
continue;
...
for ( V_14 = 0 ; V_14 < ( V_144 -> V_146 / 8 ) ; V_14 ++ ) {
struct V_102 * V_103 , * V_104 ;
T_1 V_106 , V_107 ;
T_1 V_93 , V_86 , V_478 , V_479 ;
...
& V_75 , & V_78 , & V_190 ,
& V_191 ) ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 6 ] |= F_94 ( V_191 ) ;
...
V_103 = V_148 -> V_197 ;
V_106 = ( T_1 ) ( ( V_148 -> V_181 >> 8 ) & 0xffffffff ) ;
V_479 = V_89 [ V_105 + 1 + ( V_14 * 8 ) + 0 ] & 0x7 ;
V_478 = V_89 [ V_105 + 1 + ( V_14 * 8 ) + 3 ] ;
if ( ( V_479 == V_481 || V_479 == V_482 ) &&
! V_478 &&
! F_99 ( V_53 ) ) {
V_107 = 0 ;
V_104 = NULL ;
...
V_107 = ( T_1 ) ( ( V_148 -> V_181 >> 8 ) & 0xffffffff ) ;
V_104 = V_148 -> V_197 ;
}
...
if ( V_53 -> V_184 && ( V_93 + V_86 ) > F_23 ( V_148 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_104 ) ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 1 ] = F_23 ( V_148 -> V_197 ) - V_86 ;
}
V_484 = V_148 -> V_181 + V_86 ;
V_89 [ V_105 + 1 + ( V_14 * 8 ) + 0 ] = V_484 ;
...
if ( ( V_86 + 4 ) > F_23 ( V_148 -> V_197 ) ) {
F_64 ( L_111 ,
V_86 + 4 , F_23 ( V_148 -> V_197 ) ) ;
return - V_68 ;
}
V_86 += V_148 -> V_181 ;
V_89 [ V_105 + 1 ] = V_86 ;
...
if ( ( V_86 + 8 ) > F_23 ( V_148 -> V_197 ) ) {
F_64 ( L_117 ,
V_86 + 8 , F_23 ( V_148 -> V_197 ) ) ;
return - V_68 ;
}
V_86 += V_148 -> V_181 ;
V_89 [ V_105 + 0 ] = V_86 ;
...
V_86 += ( ( T_3 ) ( F_43 ( V_53 , V_105 + 2 ) & 0xff ) ) << 32 ;
V_86 += V_148 -> V_181 ;
V_89 [ V_105 + 1 ] = ( V_86 & 0xfffffffc ) | V_509 ;
V_89 [ V_105 + 2 ] = F_91 ( V_86 ) & 0xff ;
} else {
F_64 ( L_126 ) ;
return - V_68 ;
...
int V_87 ;
if ( V_53 -> V_13 == NULL ) {
V_13 = F_102 ( sizeof( * V_13 ) , V_511 ) ;
if ( V_13 == NULL )
return - V_512 ;
F_3 ( V_13 ) ;
if ( V_53 -> V_184 -> V_114 >= V_185 ) {
V_91 = V_53 -> V_184 -> V_513 . V_514 . V_515 ;
V_13 -> V_429 = V_516 ;
} else {
V_91 = V_53 -> V_184 -> V_513 . V_517 . V_515 ;
V_13 -> V_429 = V_518 ;
}
F_103 ( F_104 ( V_516 ) != V_428 ) ;
F_103 ( F_104 ( V_518 ) != V_428 ) ;
switch ( V_91 & 0xf ) {
case 0 :
V_13 -> V_76 = 1 ;
break;
...
} while ( V_53 -> V_105 < V_53 -> V_523 -> V_524 );
#if 0
...
{
struct V_525 * V_526 = V_53 -> V_523 ;
struct V_147 * V_527 , * V_528 , * V_529 ;
T_1 V_530 , V_531 , V_146 , V_532 ;
T_2 * V_89 = V_53 -> V_89 . V_90 ;
T_1 V_105 ;
T_3 V_533 , V_534 , V_535 ;
int V_87 ;
do {
if ( V_53 -> V_105 >= V_526 -> V_524 ) {
F_64 ( L_129 ,
V_53 -> V_105 , V_526 -> V_524 ) ;
return - V_68 ;
}
V_105 = V_53 -> V_105 ;
V_530 = F_43 ( V_53 , V_105 ) ;
V_531 = F_108 ( V_530 ) ;
V_146 = F_109 ( V_530 ) ;
V_532 = F_110 ( V_530 ) ;
switch ( V_531 ) {
...
V_534 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 >> 8 ) ;
V_53 -> V_105 += V_146 + 7 ;
break;
case 0 :
V_534 = F_43 ( V_53 , V_105 + 1 ) ;
V_534 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 2 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_528 -> V_181 ) & 0xff ;
V_53 -> V_105 += V_146 + 3 ;
break;
default:
F_64 ( L_131 , V_105 , V_530 ) ;
return - V_68 ;
}
if ( ( V_534 + ( V_146 * 4 ) ) > F_23 ( V_528 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_132 ,
V_534 , F_23 ( V_528 -> V_197 ) ) ;
return - V_68 ;
}
break;
case V_537 :
V_87 = F_111 ( V_53 , & V_527 ) ;
if ( V_87 ) {
F_64 ( L_133 ) ;
return - V_68 ;
}
...
switch ( V_532 ) {
case 0x00 :
V_533 = F_43 ( V_53 , V_105 + 2 ) ;
V_533 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 4 ) & 0xff ) ) << 32 ;
V_534 = F_43 ( V_53 , V_105 + 1 ) ;
V_534 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_533 + ( V_146 * 4 ) ) > F_23 ( V_527 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_134 ,
V_533 + ( V_146 * 4 ) , F_23 ( V_527 -> V_197 ) ) ;
return - V_68 ;
}
if ( ( V_534 + ( V_146 * 4 ) ) > F_23 ( V_528 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_135 ,
V_534 + ( V_146 * 4 ) , F_23 ( V_528 -> V_197 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_527 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_528 -> V_181 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_527 -> V_181 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
case 0x08 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
V_533 = F_43 ( V_53 , V_105 + 1 ) ;
V_533 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_527 -> V_181 >> 8 ) ;
V_534 = F_43 ( V_53 , V_105 + 7 ) ;
V_534 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_528 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_528 -> V_181 ) & 0xff ;
} else {
V_533 = F_43 ( V_53 , V_105 + 7 ) ;
V_533 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 8 ) & 0xff ) ) << 32 ;
V_89 [ V_105 + 7 ] += ( T_1 ) ( V_527 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 8 ] += F_91 ( V_527 -> V_181 ) & 0xff ;
V_534 = F_43 ( V_53 , V_105 + 1 ) ;
V_534 <<= 8 ;
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 >> 8 ) ;
}
...
V_534 = F_43 ( V_53 , V_105 + 1 ) ;
V_534 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 3 ) & 0xff ) ) << 32 ;
if ( ( V_533 + V_146 ) > F_23 ( V_527 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_138 ,
V_533 + V_146 , F_23 ( V_527 -> V_197 ) ) ;
return - V_68 ;
}
if ( ( V_534 + V_146 ) > F_23 ( V_528 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_139 ,
V_534 + V_146 , F_23 ( V_528 -> V_197 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_527 -> V_181 & 0xffffffff ) ;
V_89 [ V_105 + 3 ] += F_91 ( V_528 -> V_181 ) & 0xff ;
V_89 [ V_105 + 4 ] += F_91 ( V_527 -> V_181 ) & 0xff ;
V_53 -> V_105 += 5 ;
break;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_527 -> V_181 & 0xffffffff ) ;
V_89 [ V_105 + 2 ] += F_91 ( V_527 -> V_181 ) & 0xff ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_528 -> V_181 & 0xffffffff ) ;
V_89 [ V_105 + 5 ] += F_91 ( V_528 -> V_181 ) & 0xff ;
V_53 -> V_105 += 9 ;
break;
case 0x44 :
...
V_535 = F_43 ( V_53 , V_105 + 2 ) ;
V_535 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 5 ) & 0xff ) ) << 32 ;
V_533 = F_43 ( V_53 , V_105 + 3 ) ;
V_533 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 6 ) & 0xff ) ) << 32 ;
if ( ( V_533 + ( V_146 * 4 ) ) > F_23 ( V_527 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_142 ,
V_533 + ( V_146 * 4 ) , F_23 ( V_527 -> V_197 ) ) ;
return - V_68 ;
...
if ( ( V_535 + ( V_146 * 4 ) ) > F_23 ( V_529 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_144 ,
V_535 + ( V_146 * 4 ) , F_23 ( V_529 -> V_197 ) ) ;
return - V_68 ;
}
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_529 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( T_1 ) ( V_527 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 4 ] += F_91 ( V_528 -> V_181 ) & 0xff ;
V_89 [ V_105 + 5 ] += F_91 ( V_529 -> V_181 ) & 0xff ;
V_89 [ V_105 + 6 ] += F_91 ( V_527 -> V_181 ) & 0xff ;
V_53 -> V_105 += 7 ;
break;
case 0x48 :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_535 = F_43 ( V_53 , V_105 + 2 ) ;
V_535 <<= 8 ;
V_533 = F_43 ( V_53 , V_105 + 8 ) ;
V_533 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 9 ) & 0xff ) ) << 32 ;
if ( ( V_533 + ( V_146 * 4 ) ) > F_23 ( V_527 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_146 ,
V_533 + ( V_146 * 4 ) , F_23 ( V_527 -> V_197 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 >> 8 ) ;
V_89 [ V_105 + 2 ] += ( T_1 ) ( V_529 -> V_181 >> 8 ) ;
V_89 [ V_105 + 8 ] += ( T_1 ) ( V_527 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 9 ] += F_91 ( V_527 -> V_181 ) & 0xff ;
V_53 -> V_105 += 10 ;
break;
case 0x49 :
if ( V_53 -> V_114 < V_185 ) {
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_527 -> V_181 >> 8 ) ;
V_89 [ V_105 + 4 ] += ( T_1 ) ( V_528 -> V_181 >> 8 ) ;
V_53 -> V_105 += 13 ;
break;
case 0x4f :
if ( F_43 ( V_53 , V_105 + 2 ) & ( 1 << 31 ) ) {
...
V_534 = F_43 ( V_53 , V_105 + 1 ) ;
V_534 |= ( ( T_3 ) ( F_43 ( V_53 , V_105 + 3 ) & 0x00ff0000 ) ) << 16 ;
if ( ( V_534 + ( V_146 * 4 ) ) > F_23 ( V_528 -> V_197 ) ) {
F_7 ( V_53 -> V_66 , L_157 ,
V_534 , F_23 ( V_528 -> V_197 ) ) ;
return - V_68 ;
...
V_89 [ V_105 + 1 ] += ( T_1 ) ( V_528 -> V_181 & 0xfffffffc ) ;
V_89 [ V_105 + 3 ] += ( F_91 ( V_528 -> V_181 ) << 16 ) & 0x00ff0000 ;
V_53 -> V_105 += 4 ;
break;
case V_539 :
V_53 -> V_105 += 1 ;
...
static int F_113 ( struct V_614 * V_184 ,
T_1 * V_89 , struct V_143 * V_144 )
{
T_1 V_105 = V_144 -> V_105 + 1 ;
T_1 V_432 = V_89 [ V_105 ] ;
T_1 V_430 , V_431 , V_145 , V_14 ;
T_1 V_458 , V_459 ;
switch ( V_144 -> V_433 ) {
case V_510 :
break;
...
for ( V_14 = 0 ; V_14 < V_144 -> V_146 ; V_14 ++ ) {
V_145 = V_430 + ( 4 * V_14 ) ;
if ( ! F_112 ( V_145 ) )
return - V_68 ;
}
...
for ( V_14 = 0 ; V_14 < ( V_458 & 0x1fffff ) ; V_14 ++ ) {
V_145 = V_430 + ( 4 * V_14 ) ;
if ( ! F_112 ( V_145 ) ) {
F_64 ( L_161 ) ;
return - V_68 ;
...
int F_114 ( struct V_614 * V_184 , struct V_624 * V_89 )
{
int V_625 = 0 ;
T_1 V_105 = 0 ;
struct V_143 V_144 ;
...
V_144 . V_146 = F_116 ( V_89 -> V_90 [ V_105 ] ) ;
V_144 . V_626 = 0 ;
switch ( V_144 . type ) {
case V_520 :
F_87 ( V_184 -> V_66 , L_163 ) ;
V_625 = - V_68 ;
break;
case V_521 :
V_105 += 1 ;
break;
case V_522 :
V_144 . V_433 = F_117 ( V_89 -> V_90 [ V_105 ] ) ;
V_625 = F_113 ( V_184 , V_89 -> V_90 , & V_144 ) ;
V_105 += V_144 . V_146 + 2 ;
break;
default:
F_87 ( V_184 -> V_66 , L_128 , V_144 . type ) ;
V_625 = - V_68 ;
break;
}
if ( V_625 )
break;
} while ( V_105 < V_89 -> V_524 );
return V_625 ;
}
int F_118 ( struct V_614 * V_184 , struct V_624 * V_89 )
{
T_1 V_105 = 0 ;
T_1 V_530 , V_531 , V_146 , V_532 ;
do {
V_530 = V_89 -> V_90 [ V_105 ] ;
V_531 = F_108 ( V_530 ) ;
V_146 = F_109 ( V_530 ) ;
V_532 = F_110 ( V_530 ) ;
switch ( V_531 ) {
