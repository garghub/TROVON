...
if ( V_59 . V_19 < V_48 -> V_19 || V_59 . V_62 > V_48 -> V_62 ) {
F_14 ( V_16 -> V_22 ,
L_5 ,
V_52 -> V_60 ) ;
V_20 = - V_63 ;
...
int V_20 ;
int (* F_50)( void );
V_16 = F_42 ( & V_70 -> V_22 , sizeof( * V_16 ) , V_28 ) ;
if ( ! V_16 )
return - V_29 ;
V_16 -> V_22 = & V_70 -> V_22 ;
V_48 = F_51 ( V_70 , V_71 , 0 ) ;
if ( ! V_48 ) {
F_14 ( V_16 -> V_22 , L_18 ) ;
return - V_63 ;
}
V_26 = F_31 ( V_48 ) ;
if ( ! F_52 ( V_16 -> V_22 , V_48 -> V_19 , V_26 , V_70 -> V_27 ) ) {
F_14 ( V_16 -> V_22 , L_19 ) ;
return - V_72 ;
}
if ( F_53 ( V_70 -> V_22 . V_51 , L_20 ) )
