...
struct V_80 * V_81 )
{
struct V_82 * V_83 = & V_81 -> V_81 ;
struct V_1 * V_24 = F_1 ( V_3 ) ;
if ( V_81 -> V_84 )
return - V_18 ;
if ( V_24 -> V_70 == V_85 )
V_24 -> V_70 = V_86 ;
V_83 -> V_87 = V_88 [ V_24 -> V_70 ] . V_89 . V_90 . V_87 ;
V_83 -> V_91 = V_88 [ V_24 -> V_70 ] . V_89 . V_90 . V_91 ;
V_83 -> V_92 = V_93 ;
V_83 -> V_94 = V_95 ;
V_83 -> V_96 = V_97 ;
return 0 ;
...
return - V_18 ;
V_83 -> V_92 = V_93 ;
V_98 = abs ( V_83 -> V_87 - 352 ) ;
V_99 = abs ( V_83 -> V_87 - 480 ) ;
V_100 = abs ( V_83 -> V_87 - 720 ) ;
if ( V_100 < V_99 ) {
V_83 -> V_87 = 720 ;
V_83 -> V_91 = 576 ;
} else if ( V_99 < V_98 ) {
...
V_83 -> V_87 = 352 ;
if ( abs ( V_83 -> V_91 - 576 ) < abs ( V_83 -> V_91 - 288 ) )
V_83 -> V_91 = 576 ;
else
V_83 -> V_91 = 288 ;
}
...
if ( V_83 -> V_87 == 720 )
V_24 -> V_70 = V_86 ;
else if ( V_83 -> V_87 == 480 )
V_24 -> V_70 = V_104 ;
else if ( V_83 -> V_91 == 576 )
V_24 -> V_70 = V_105 ;
else
V_24 -> V_70 = V_106 ;
return 0 ;
}
static int F_19 ( struct V_2 * V_3 , T_5 V_107 )
{
struct V_1 * V_24 = F_1 ( V_3 ) ;
V_24 -> V_71 = V_107 ;
return 0 ;
...
T_2 V_111 [ 12 ] ;
F_21 ( V_5 , L_1 ,
V_5 -> V_110 << 1 , V_5 -> V_112 -> V_113 ) ;
V_24 = F_22 ( & V_5 -> V_114 , sizeof( * V_24 ) , V_115 ) ;
if ( V_24 == NULL )
return - V_116 ;
V_3 = & V_24 -> V_3 ;
F_23 ( V_3 , V_5 , & V_117 ) ;
F_4 ( V_5 , & V_110 , 1 ) ;
F_5 ( V_5 , V_111 , sizeof( V_111 ) ) ;
V_24 -> V_118 = ( V_111 [ 8 ] << 8 ) | V_111 [ 9 ] ;
V_24 -> V_119 = 0 ;
if ( V_24 -> V_118 == 0x0206 ) {
V_24 -> V_119 = 1 ;
F_21 ( V_5 , L_2 ) ;
}
V_24 -> V_26 = V_120 ;
...
~ ( 1 << V_128 ) ,
V_128 ) ;
V_24 -> V_129 = F_25 ( V_43 , & V_121 ,
V_45 ,
V_130 , 0 ,
V_30 ) ;
V_24 -> V_47 = F_26 ( V_43 , & V_121 ,
V_131 , 1000000 , 27000000 , 1000 , 6000000 ) ;
F_26 ( V_43 , & V_121 ,
V_49 , 0 , ( 1 << 14 ) - 1 , 1 , 16 ) ;
F_26 ( V_43 , & V_121 ,
V_51 , 0 , ( 1 << 14 ) - 1 , 1 , 260 ) ;
