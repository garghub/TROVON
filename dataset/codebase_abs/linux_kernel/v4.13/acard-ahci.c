...
int V_20 ;
if ( V_23 &&
! F_13 ( & V_2 -> V_15 , F_14 ( 64 ) ) ) {
V_20 = F_15 ( & V_2 -> V_15 , F_14 ( 64 ) ) ;
if ( V_20 ) {
V_20 = F_15 ( & V_2 -> V_15 , F_14 ( 32 ) ) ;
if ( V_20 ) {
F_3 ( & V_2 -> V_15 ,
L_2 ) ;
return V_20 ;
...
V_105 . V_13 |= V_121 ;
F_49 ( V_7 , & V_105 ) ;
V_108 = F_50 ( F_51 ( V_7 -> V_82 ) , F_52 ( V_7 -> V_122 ) ) ;
V_5 = F_53 ( & V_2 -> V_15 , V_107 , V_108 ) ;
if ( ! V_5 )
return - V_81 ;
V_5 -> V_8 = V_7 ;
if ( ! ( V_7 -> V_82 & V_123 ) || V_124 )
V_5 -> V_13 |= V_125 ;
else
F_54 ( V_126 L_12 ) ;
for ( V_109 = 0 ; V_109 < V_5 -> V_108 ; V_109 ++ ) {
struct V_42 * V_43 = V_5 -> V_127 [ V_109 ] ;
F_55 ( V_43 , V_113 , - 1 , L_13 ) ;
F_55 ( V_43 , V_113 ,
0x100 + V_43 -> V_90 * 0x80 , L_14 ) ;
if ( ! ( V_7 -> V_122 & ( 1 << V_109 ) ) )
V_43 -> V_128 = & V_129 ;
}
V_20 = F_12 ( V_2 , V_7 -> V_82 & V_130 ) ;
if ( V_20 )
return V_20 ;
V_20 = F_9 ( V_5 ) ;
if ( V_20 )
