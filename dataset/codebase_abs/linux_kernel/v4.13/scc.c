...
static void F_35 ( struct V_7 * V_8 , int V_82 )
{
F_36 ( & V_8 -> V_11 ) ;
switch ( V_82 & V_83 )
{
...
case V_87 : F_33 ( V_8 ) ; break;
}
F_37 ( & V_8 -> V_11 ) ;
}
static T_2 F_38 ( int V_88 , void * V_89 )
{
int V_90 = ( long ) V_89 ;
unsigned char V_82 ;
struct V_7 * V_8 ;
...
static inline void F_39 ( struct V_7 * V_8 , unsigned int V_103 )
{
F_11 ( V_8 , V_31 , V_104 ) ;
...
F_2 ( & V_8 -> V_11 , V_3 ) ;
if ( V_8 -> V_28 . V_107 > 0 )
F_39 ( V_8 , ( unsigned ) ( V_8 -> clock / ( V_8 -> V_28 . V_107 * 64 ) ) - 2 ) ;
F_7 ( & V_8 -> V_11 , V_3 ) ;
}
static inline void F_41 ( struct V_7 * V_8 )
{
F_9 ( V_8 , V_31 , V_108 ) ;
...
static void F_47 ( struct V_7 * V_8 , char V_158 )
{
unsigned int V_159 ;
if ( V_8 -> V_138 & V_160 )
...
void F_49 ( struct V_7 * V_8 , void (* F_50)( unsigned long ) , unsigned long V_165 )
{
F_43 ( & V_8 -> V_111 ) ;
if ( V_165 == 0 )
{
F_50 ( ( unsigned long ) V_8 ) ;
} else
if ( V_165 != V_166 )
{
V_8 -> V_111 . V_25 = ( unsigned long ) V_8 ;
V_8 -> V_111 . V_167 = F_50 ;
V_8 -> V_111 . V_168 = V_169 + ( V_165 * V_170 ) / 100 ;
F_51 ( & V_8 -> V_111 ) ;
}
}
static void F_29 ( struct V_7 * V_8 , void (* F_50)( unsigned long ) , unsigned long V_165 )
{
unsigned long V_3 ;
F_2 ( & V_8 -> V_11 , V_3 ) ;
F_49 ( V_8 , F_50 , V_165 ) ;
...
static inline int F_54 ( struct V_7 * V_8 )
{
int V_24 ;
struct V_7 * V_183 ;
...
static void F_55 ( unsigned long V_189 )
{
...
{
Rand = Rand * 17 + 31 ;
if ( V_8 -> V_56 || ( V_8 -> V_18 . V_192 ) < Rand || ( V_8 -> V_18 . V_186 && F_54 ( V_8 ) ) )
{
F_52 ( V_8 ) ;
F_29 ( V_8 , F_55 , V_8 -> V_18 . V_193 ) ;
return ;
}
}
...
{
V_8 -> V_22 . V_40 = V_190 ;
F_29 ( V_8 , F_55 , V_8 -> V_18 . V_197 * 100 ) ;
return;
}
V_8 -> V_22 . V_40 = V_191 ;
F_24 ( V_8 -> V_37 ) ;
...
static unsigned int F_57 ( struct V_7 * V_8 , unsigned int V_199 , unsigned int V_200 )
{
switch ( V_199 )
{
...
static unsigned long F_58 ( struct V_7 * V_8 , unsigned int V_199 )
{
switch ( V_199 )
{
case V_201 : return F_59 ( V_8 -> V_18 . V_61 ) ;
case V_202 : return F_59 ( V_8 -> V_18 . V_192 ) ;
case V_203 : return F_59 ( V_8 -> V_18 . V_193 ) ;
case V_204 : return F_59 ( V_8 -> V_18 . V_182 ) ;
case V_205 : return F_59 ( V_8 -> V_18 . V_19 ) ;
case V_215 : return F_59 ( V_8 -> V_18 . V_55 ) ;
case V_206 : return F_59 ( ( V_8 -> V_10 [ V_118 ] & V_120 ) ? 1 : 0 ) ;
case V_217 : return F_59 ( ( V_8 -> V_10 [ V_118 ] & V_67 ) ? 1 : 0 ) ;
case V_216 : return F_59 ( V_8 -> V_28 . V_107 ) ;
case V_207 : return F_59 ( V_8 -> V_18 . V_186 ) ;
case V_208 : return F_59 ( V_8 -> V_18 . V_177 ) ;
case V_209 : return F_59 ( V_8 -> V_18 . V_197 ) ;
case V_210 : return F_59 ( V_8 -> V_18 . V_173 ) ;
case V_211 : return F_59 ( V_8 -> V_18 . V_212 ) ;
case V_213 : return F_59 ( V_8 -> V_18 . V_171 ) ;
case V_214 : return F_59 ( V_8 -> V_18 . V_163 ) ;
default: return V_219 ;
}
}
static void F_60 ( unsigned long V_189 )
{
struct V_7 * V_8 = (struct V_7 * ) V_189 ;
unsigned long V_3 ;
F_2 ( & V_8 -> V_11 , V_3 ) ;
...
static void
F_61 ( struct V_7 * V_8 , int V_220 , unsigned char V_221 )
{
unsigned long V_3 ;
F_2 ( & V_8 -> V_11 , V_3 ) ;
F_56 ( V_8 -> V_37 ) ;
...
static int F_63 ( const char * V_233 , struct V_7 * V_8 )
{
int V_234 ;
struct V_235 * V_37 ;
V_37 = F_64 ( 0 , V_233 , V_236 , V_237 ) ;
if ( ! V_37 )
return - V_238 ;
V_37 -> V_239 = V_8 ;
V_8 -> V_37 = V_37 ;
...
static int F_69 ( struct V_235 * V_37 )
{
...
static int F_72 ( struct V_235 * V_37 )
{
struct V_7 * V_8 = (struct V_7 * ) V_37 -> V_239 ;
unsigned long V_3 ;
F_56 ( V_37 ) ;
...
V_16 -> V_261 = F_74 ( V_16 , V_8 -> V_37 ) ;
F_75 ( V_16 ) ;
}
static T_3 F_76 ( struct V_15 * V_16 , struct V_235 * V_37 )
{
struct V_7 * V_8 = (struct V_7 * ) V_37 -> V_239 ;
unsigned long V_3 ;
char V_262 ;
if ( V_16 -> V_261 == F_77 ( V_263 ) )
return F_78 ( V_16 ) ;
...
F_26 ( V_16 , 1 ) ;
if ( V_262 ) {
F_57 ( V_8 , V_262 , * V_16 -> V_25 ) ;
F_13 ( V_16 ) ;
return V_265 ;
}
F_2 ( & V_8 -> V_11 , V_3 ) ;
if ( F_79 ( & V_8 -> V_13 ) > V_8 -> V_37 -> V_241 ) {
struct V_15 * V_269 ;
V_269 = F_15 ( & V_8 -> V_13 ) ;
F_13 ( V_269 ) ;
}
...
static int F_82 ( struct V_235 * V_37 , struct V_270 * V_271 , int V_199 )
{
struct V_272 V_273 ;
struct V_274 V_275 ;
struct V_276 V_277 ;
...
{
int V_285 = 1 ;
if ( ! F_83 ( V_286 ) ) return - V_287 ;
if ( ! V_200 ) return - V_288 ;
if ( V_94 >= V_289 )
return - V_218 ;
if ( F_84 ( & V_277 , V_200 , sizeof( V_277 ) ) )
return - V_288 ;
...
{
if ( F_85 ( V_277 . V_88 , F_38 ,
0 , L_10 ,
( void * ) ( long ) V_277 . V_88 ) )
F_32 ( V_97 L_11 , V_277 . V_88 ) ;
else
V_226 [ V_277 . V_88 ] . V_227 = 1 ;
}
if ( V_277 . V_290 && ! V_92 ) {
if ( ! F_86 ( V_277 . V_290 , 1 , L_12 ) )
F_32 ( V_97 L_13 , V_277 . V_290 ) ;
else
V_92 = V_277 . V_290 ;
}
if ( V_277 . clock == 0 )
...
if ( V_285 )
{
F_86 ( V_95 [ 2 * V_94 + V_280 ] . V_9 , 1 , L_20 ) ;
F_86 ( V_95 [ 2 * V_94 + V_280 ] . V_25 , 1 , L_21 ) ;
if ( V_94 + V_280 != 0 &&
F_63 ( V_281 ,
& V_95 [ 2 * V_94 + V_280 ] ) )
return - V_218 ;
...
if ( V_199 == V_299 )
{
if ( ! F_83 ( V_300 ) ) return - V_287 ;
if ( ! V_200 ) return - V_218 ;
V_8 -> V_22 . V_69 = V_301 ;
if ( F_84 ( & V_8 -> V_28 , V_200 , sizeof( struct V_302 ) ) )
return - V_218 ;
...
case V_305 :
if ( ! F_83 ( V_286 ) ) return - V_287 ;
if ( ! V_200 || F_84 ( & V_275 , V_200 , sizeof( V_275 ) ) )
return - V_218 ;
V_8 -> V_22 . V_69 = V_275 . V_69 ;
return 0 ;
case V_306 :
if ( ! V_200 || F_89 ( V_200 , & V_8 -> V_22 , sizeof( V_8 -> V_22 ) ) )
return - V_218 ;
return 0 ;
case V_307 :
if ( ! V_200 || F_84 ( & V_273 , V_200 , sizeof( V_273 ) ) )
return - V_218 ;
V_273 . V_308 = F_58 ( V_8 , V_273 . V_309 ) ;
if ( F_89 ( V_200 , & V_273 , sizeof( V_273 ) ) )
return - V_218 ;
return 0 ;
case V_310 :
if ( ! F_83 ( V_300 ) ) return - V_287 ;
if ( ! V_200 || F_84 ( & V_273 , V_200 , sizeof( V_273 ) ) )
return - V_218 ;
return F_57 ( V_8 , V_273 . V_309 , V_273 . V_308 ) ;
case V_311 :
if ( ! F_83 ( V_286 ) ) return - V_287 ;
if ( ! V_200 || F_84 ( & V_279 , V_200 , sizeof( V_279 ) ) || V_279 . time == 0 )
return - V_218 ;
F_61 ( V_8 , V_279 . time , V_279 . V_221 ) ;
return 0 ;
default:
return - V_304 ;
}
...
static int F_90 ( struct V_235 * V_37 , void * V_312 )
{
struct V_313 * V_314 = (struct V_313 * ) V_312 ;
memcpy ( V_37 -> V_249 , V_314 -> V_315 , V_37 -> V_257 ) ;
return 0 ;
}
static struct V_316 * F_91 ( struct V_235 * V_37 )
{
struct V_7 * V_8 = (struct V_7 * ) V_37 -> V_239 ;
...
static inline struct V_7 * F_92 ( T_5 V_321 )
{
int V_24 ;
for ( V_24 = 0 ; V_24 < V_94 * 2 ; ++ V_24 ) {
if ( ! V_95 [ V_24 ] . V_258 )
...
static void * F_93 ( struct V_322 * V_323 , T_5 * V_321 )
{
return * V_321 ? F_92 ( * V_321 - 1 ) : V_324 ;
}
static void * F_94 ( struct V_322 * V_323 , void * V_325 , T_5 * V_321 )
{
unsigned V_24 ;
...
static void F_95 ( struct V_322 * V_323 , void * V_325 )
{
}
static int F_96 ( struct V_322 * V_323 , void * V_325 )
{
if ( V_325 == V_324 ) {
F_97 ( V_323 , L_22 V_326 L_8 ) ;
} else if ( ! V_232 ) {
F_97 ( V_323 , L_23 ) ;
} else if ( ! V_94 ) {
F_97 ( V_323 , L_24 ) ;
...
V_22 -> V_23 , V_22 -> V_40 ) ;
#define F_99 ( T_6 ) kiss->x
F_98 ( V_323 , L_29 ,
F_99 ( V_61 ) , F_99 ( V_192 ) , F_99 ( V_193 ) , F_99 ( V_182 ) ,
F_99 ( V_19 ) , F_99 ( V_212 ) , F_99 ( V_197 ) , F_99 ( V_173 ) ,
F_99 ( V_177 ) , F_99 ( V_171 ) , F_99 ( V_163 ) , F_99 ( V_186 ) ) ;
#undef F_99
#ifdef F_100
{
int V_2 ;
...
F_98 ( V_323 , L_31 , V_8 -> V_10 [ V_2 ] ) ;
F_98 ( V_323 , L_8 ) ;
F_98 ( V_323 , L_32 , F_1 ( V_8 -> V_9 , V_42 ) , F_1 ( V_8 -> V_9 , V_74 ) ) ;
for ( V_2 = 3 ; V_2 < 8 ; V_2 ++ )
F_98 ( V_323 , L_31 , F_1 ( V_8 -> V_9 , V_2 ) ) ;
F_98 ( V_323 , L_33 ) ;
...
static int F_102 ( struct V_329 * V_329 , struct V_330 * V_330 )
{
return F_103 ( V_330 , & V_331 ) ;
}
...
F_106 () ;
F_107 ( L_36 , 0 , V_335 . V_336 , & V_337 ) ;
return 0 ;
}
...
for ( V_24 = 0 ; V_24 < V_225 ; V_24 ++ )
if ( V_226 [ V_24 ] . V_227 ) F_111 ( V_24 , NULL ) ;
F_112 () ;
for ( V_24 = 0 ; V_24 < V_94 * 2 ; V_24 ++ )
{
V_8 = & V_95 [ V_24 ] ;
