...
if ( V_62 && V_63 && V_63 > V_61 ) {
memset ( V_62 , 0 , V_63 - V_61 ) ;
V_16 = F_36 ( V_4 , V_67 , V_65 + V_61 ,
V_62 , V_63 - V_61 ) ;
if ( V_16 < 0 )
return V_16 ;
}
...
{
return F_29 ( V_3 , V_75 , 0 , 0 , 0 ) ;
}
int F_41 ( struct V_2 * V_3 , const struct V_76 * V_77 )
{
return F_34 ( V_3 , V_78 , V_77 -> V_79 , V_77 -> V_80 ,
V_77 -> V_79 , NULL , 0 ) ;
}
int F_42 ( struct V_2 * V_3 , void * V_81 , unsigned int V_79 )
{
...
int F_44 ( struct V_2 * V_3 , void * V_81 , unsigned int V_79 )
{
return F_34 ( V_3 , V_84 , V_79 , NULL , 0 ,
V_81 , V_79 ) ;
}
int F_45 ( struct V_2 * V_3 , unsigned int V_85 ,
void * V_81 , unsigned int V_79 )
{
return F_34 ( V_3 , V_86 , V_85 ,
NULL , 0 , V_81 , V_79 ) ;
}
