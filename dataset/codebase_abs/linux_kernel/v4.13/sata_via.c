...
int V_85 ;
if ( V_86 ) {
V_83 [ 0 ] -> V_87 -> V_88 = F_1 ;
V_83 [ 0 ] -> V_87 -> V_89 = F_3 ;
}
V_85 = F_34 ( V_13 , V_83 , & V_14 ) ;
if ( V_85 )
return V_85 ;
* V_82 = V_14 ;
V_85 = F_35 ( V_13 , 1 << 5 , V_90 ) ;
if ( V_85 ) {
F_36 ( & V_13 -> V_15 , L_6 ) ;
return V_85 ;
}
V_14 -> V_91 [ 0 ] -> V_8 . V_9 = F_28 ( V_14 -> V_73 [ 5 ] , 0 ) ;
V_14 -> V_91 [ 1 ] -> V_8 . V_9 = F_28 ( V_14 -> V_73 [ 5 ] , 1 ) ;
return 0 ;
}
...
V_14 -> V_73 = F_40 ( V_13 ) ;
for ( V_47 = 0 ; V_47 < V_14 -> V_95 ; V_47 ++ )
F_30 ( V_14 -> V_91 [ V_47 ] ) ;
V_85 = F_41 ( & V_13 -> V_15 , V_96 ) ;
if ( V_85 )
return V_85 ;
V_85 = F_42 ( & V_13 -> V_15 , V_96 ) ;
if ( V_85 )
return V_85 ;
return 0 ;
}
...
{
const struct F_20 * V_83 [] = { & V_97 , NULL } ;
struct V_81 * V_14 ;
int V_47 , V_85 ;
V_85 = F_34 ( V_13 , V_83 , & V_14 ) ;
if ( V_85 )
...
T_2 V_98 ;
F_7 ( V_13 , 0x52 , & V_98 ) ;
F_12 ( V_13 , 0x52 , V_98 | F_46 ( 2 ) ) ;
}
static T_4 F_47 ( int V_99 , void * V_100 )
{
struct V_81 * V_14 = V_100 ;
T_4 V_85 = F_48 ( V_99 , V_100 ) ;
if ( V_85 != V_101 ) {
T_1 V_102 ;
unsigned long V_30 ;
F_49 ( & V_14 -> V_103 , V_30 ) ;
F_1 ( & V_14 -> V_91 [ 0 ] -> V_2 , V_22 , & V_102 ) ;
if ( V_102 & V_104 ) {
F_50 ( & V_14 -> V_91 [ 0 ] -> V_2 . V_105 ) ;
F_51 ( V_14 -> V_91 [ 0 ] ) ;
V_85 = V_101 ;
}
F_1 ( & V_14 -> V_91 [ 1 ] -> V_2 , V_22 , & V_102 ) ;
if ( V_102 & V_104 ) {
F_50 ( & V_14 -> V_91 [ 1 ] -> V_2 . V_105 ) ;
F_51 ( V_14 -> V_91 [ 1 ] ) ;
V_85 = V_101 ;
}
F_52 ( & V_14 -> V_103 , V_30 ) ;
}
return V_85 ;
}
static void F_53 ( struct V_24 * V_7 )
{
struct V_106 * V_107 = V_7 -> V_14 -> V_108 ;
struct V_12 * V_13 = F_6 ( V_7 -> V_14 -> V_15 ) ;
T_1 V_102 ;
if ( ! V_107 -> V_109 ) {
F_1 ( & V_7 -> V_2 , V_22 , & V_102 ) ;
if ( V_102 == 0x1000500 ) {
F_54 ( V_7 , L_9 ) ;
F_45 ( V_13 ) ;
V_107 -> V_109 = true ;
V_7 -> V_2 . V_37 . V_47 . V_30 |= V_110 ;
}
}
F_55 ( V_7 ) ;
}
static void F_56 ( struct V_12 * V_13 , int V_111 ,
struct V_106 * V_107 )
{
T_2 V_98 ;
F_7 ( V_13 , V_112 , & V_98 ) ;
...
( int ) V_98 ) ;
V_98 |= V_117 ;
F_12 ( V_13 , V_116 , V_98 ) ;
}
if ( ( V_111 == V_118 && V_86 ) || V_111 == V_119 ) {
F_7 ( V_13 , V_120 , & V_98 ) ;
if ( ( V_98 & V_121 ) != V_121 ) {
F_58 ( & V_13 -> V_15 ,
L_14 ,
...
static int F_59 ( struct V_12 * V_13 , const struct V_122 * V_123 )
{
unsigned int V_47 ;
int V_85 ;
struct V_81 * V_14 = NULL ;
int V_111 = ( int ) V_123 -> V_124 ;
const unsigned * V_125 ;
struct V_106 * V_107 ;
F_60 ( & V_13 -> V_15 , V_126 ) ;
V_85 = F_61 ( V_13 ) ;
if ( V_85 )
return V_85 ;
if ( V_111 == V_119 )
...
V_125 = & V_128 [ 0 ] ;
for ( V_47 = 0 ; V_47 < F_39 ( V_128 ) ; V_47 ++ )
if ( ( F_62 ( V_13 , V_47 ) == 0 ) ||
( F_63 ( V_13 , V_47 ) < V_125 [ V_47 ] ) ) {
F_36 ( & V_13 -> V_15 ,
L_15 ,
V_47 ,
...
if ( V_85 )
return V_85 ;
V_107 = F_64 ( & V_13 -> V_15 , sizeof( * V_107 ) , V_131 ) ;
if ( ! V_107 )
return - V_94 ;
V_14 -> V_108 = V_107 ;
F_56 ( V_13 , V_111 , V_107 ) ;
F_65 ( V_13 ) ;
if ( ( V_111 == V_118 && V_86 ) || V_111 == V_119 )
return F_66 ( V_14 , V_13 -> V_99 , F_47 ,
V_132 , & V_133 ) ;
else
return F_66 ( V_14 , V_13 -> V_99 , F_48 ,
V_132 , & V_133 ) ;
}
