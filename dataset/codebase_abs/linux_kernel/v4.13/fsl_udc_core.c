...
F_53 ( & V_19 -> V_20 , V_144 ) ;
V_15 -> V_15 . V_152 = V_142 ;
V_15 -> V_15 . V_141 = V_141 ;
V_15 -> V_22 = 0 ;
F_47 ( V_19 , ( unsigned char ) F_54 ( V_15 ) ,
( unsigned char ) ( ( V_141 -> V_153 & V_154 )
? V_137 : V_135 ) ,
( unsigned char ) ( V_141 -> V_150
& V_155 ) ,
V_142 , V_120 , V_121 ) ;
F_44 ( ( unsigned char ) F_54 ( V_15 ) ,
( unsigned char ) ( ( V_141 -> V_153 & V_154 )
? V_137 : V_135 ) ,
( unsigned char ) ( V_141 -> V_150
& V_155 ) ) ;
F_55 ( & V_19 -> V_20 , V_144 ) ;
V_143 = 0 ;
...
static struct V_156 *
F_57 ( struct V_138 * V_139 , T_3 V_157 )
{
struct V_16 * V_17 = NULL ;
V_17 = F_58 ( sizeof *V_17 , V_157 ) ;
if ( ! V_17 )
return NULL ;
...
static void F_60 ( struct V_138 * V_139 , struct V_156 * V_160 )
{
struct V_16 * V_17 = NULL ;
...
static void F_62 ( struct V_14 * V_15 , struct V_23 * V_161 )
{
struct V_122 * V_162 = F_63 ( V_15 ) ;
V_162 -> V_133 = F_10 ( V_161 -> V_33
& V_163 ) ;
V_162 -> V_134 &= F_10 ( ~ ( V_164
| V_165 ) ) ;
F_64 () ;
F_35 ( F_20 ( V_15 ) ? ( 1 << ( F_54 ( V_15 ) + 16 ) )
: ( 1 << ( F_54 ( V_15 ) ) ) , & V_46 -> V_166 ) ;
}
static void F_65 ( struct V_14 * V_15 , struct V_16 * V_17 )
{
T_1 V_96 , V_167 , V_168 ;
V_167 = F_20 ( V_15 )
? ( 1 << ( F_54 ( V_15 ) + 16 ) )
: ( 1 << ( F_54 ( V_15 ) ) ) ;
if ( ! ( F_27 ( & V_15 -> V_27 ) ) && ! ( F_54 ( V_15 ) == 0 ) ) {
struct V_16 * V_169 ;
...
static struct V_23 * F_66 ( struct V_16 * V_17 , unsigned * V_38 ,
T_4 * V_158 , int * V_176 , T_3 V_157 )
{
T_1 V_177 ;
struct V_23 * V_178 ;
* V_38 = F_67 ( V_17 -> V_17 . V_38 - V_17 -> V_17 . V_37 ,
( unsigned ) V_179 ) ;
V_178 = F_68 ( V_9 -> V_32 , V_157 , V_158 ) ;
if ( V_178 == NULL )
return V_178 ;
V_178 -> V_33 = * V_158 ;
...
static int F_70 ( struct V_16 * V_17 , T_3 V_157 )
{
unsigned V_192 ;
int V_176 ;
int V_193 = 1 ;
...
T_4 V_158 ;
do {
V_178 = F_66 ( V_17 , & V_192 , & V_158 , & V_176 , V_157 ) ;
if ( V_178 == NULL )
return - V_195 ;
if ( V_193 ) {
V_193 = 0 ;
...
static int
F_71 ( struct V_138 * V_139 , struct V_156 * V_160 , T_3 V_157 )
{
...
if ( F_72 ( ! V_139 || ! V_15 -> V_15 . V_141 ) ) {
F_21 ( L_15 , V_104 ) ;
return - V_66 ;
}
if ( F_73 ( V_15 -> V_15 . V_141 ) ) {
...
return - V_35 ;
V_17 -> V_15 = V_15 ;
V_197 = F_74 ( & V_15 -> V_19 -> V_34 , & V_17 -> V_17 , F_20 ( V_15 ) ) ;
if ( V_197 )
return V_197 ;
V_17 -> V_17 . V_18 = - V_28 ;
V_17 -> V_17 . V_37 = 0 ;
...
if ( V_17 != NULL )
F_75 ( & V_17 -> V_27 , & V_15 -> V_27 ) ;
F_55 ( & V_19 -> V_20 , V_144 ) ;
return 0 ;
}
static int F_76 ( struct V_138 * V_139 , struct V_156 * V_160 )
{
struct V_14 * V_15 = F_50 ( V_139 , struct V_14 , V_15 ) ;
struct V_16 * V_17 ;
unsigned long V_144 ;
...
F_35 ( V_118 , & V_46 -> V_84 [ V_42 ] ) ;
V_15 -> V_22 = V_22 ;
F_55 ( & V_15 -> V_19 -> V_20 , V_144 ) ;
return V_197 ;
}
static int F_78 ( struct V_138 * V_139 , int V_115 )
{
struct V_14 * V_15 = NULL ;
unsigned long V_144 = 0 ;
int V_18 = - V_205 ;
...
struct V_122 * V_162 ;
V_15 = F_50 ( V_139 , struct V_14 , V_15 ) ;
if ( ! V_139 || ( ! V_15 -> V_15 . V_141 && F_54 ( V_15 ) != 0 ) )
return - V_212 ;
V_19 = (struct V_21 * ) V_15 -> V_19 ;
if ( ! V_19 -> V_147 || V_19 -> V_34 . V_148 == V_149 )
return - V_35 ;
V_162 = F_63 ( V_15 ) ;
V_167 = ( F_20 ( V_15 ) ) ? ( 1 << ( F_54 ( V_15 ) + 16 ) ) :
( 1 << ( F_54 ( V_15 ) ) ) ;
...
static int F_82 ( struct V_216 * V_34 )
{
...
static int F_83 ( struct V_21 * V_19 )
{
return V_19 -> V_147 && V_19 -> V_224 && V_19 -> V_225 ;
}
static int F_84 ( struct V_216 * V_34 , int V_226 )
{
struct V_21 * V_19 ;
unsigned long V_144 ;
...
static int F_85 ( struct V_216 * V_34 , unsigned V_227 )
{
struct V_21 * V_19 ;
V_19 = F_50 ( V_34 , struct V_21 , V_34 ) ;
if ( ! F_86 ( V_19 -> V_228 ) )
return F_87 ( V_19 -> V_228 , V_227 ) ;
return - V_221 ;
}
static int F_88 ( struct V_216 * V_34 , int V_229 )
{
struct V_21 * V_19 ;
V_19 = F_50 ( V_34 , struct V_21 , V_34 ) ;
if ( ! V_19 -> V_225 )
...
static void F_89 ( struct V_138 * V_15 , struct V_156 * V_17 ) { }
static void F_90 ( struct V_21 * V_19 )
{
T_1 V_40 ;
...
static int F_91 ( struct V_21 * V_19 , int V_230 )
{
...
V_17 -> V_17 . V_18 = - V_28 ;
V_17 -> V_17 . V_37 = 0 ;
V_17 -> V_17 . V_198 = F_89 ;
V_17 -> V_30 = 0 ;
V_197 = F_74 ( & V_15 -> V_19 -> V_34 , & V_17 -> V_17 , F_20 ( V_15 ) ) ;
if ( V_197 )
return V_197 ;
if ( F_70 ( V_17 , V_237 ) == 0 )
F_65 ( V_15 , V_17 ) ;
else
return - V_195 ;
F_75 ( & V_17 -> V_27 , & V_15 -> V_27 ) ;
...
static void F_92 ( struct V_21 * V_19 , T_5 V_238 )
{
struct V_14 * V_15 = F_93 ( V_19 , V_238 ) ;
if ( V_15 -> V_36 )
F_25 ( V_15 , - V_35 ) ;
}
static void F_94 ( struct V_21 * V_19 , T_6 V_115 , T_6 V_239 , T_6 V_38 )
{
...
static void F_95 ( struct V_21 * V_19 , T_5 V_243 , T_6 V_115 ,
T_6 V_239 , T_6 V_38 )
{
T_6 V_40 = 0 ;
struct V_16 * V_17 ;
...
struct V_14 * V_250 ;
V_250 = F_93 ( V_19 , F_96 ( V_239 ) ) ;
if ( ! V_250 -> V_15 . V_141 )
goto V_251;
V_40 = F_46 ( F_54 ( V_250 ) , F_20 ( V_250 ) )
<< V_252 ;
}
V_19 -> V_210 = V_154 ;
V_17 = V_19 -> V_231 ;
* ( ( T_6 * ) V_17 -> V_17 . V_199 ) = F_97 ( V_40 ) ;
V_17 -> V_15 = V_15 ;
V_17 -> V_17 . V_38 = 2 ;
V_17 -> V_17 . V_18 = - V_28 ;
V_17 -> V_17 . V_37 = 0 ;
...
static void F_98 ( struct V_21 * V_19 ,
struct V_254 * V_255 )
__releases( V_19 -> V_20 )
__acquires( V_19 -> V_20 )
{
T_6 V_256 = F_99 ( V_255 -> V_256 ) ;
T_6 V_257 = F_99 ( V_255 -> V_257 ) ;
T_6 V_258 = F_99 ( V_255 -> V_258 ) ;
F_92 ( V_19 , 0 ) ;
switch ( V_255 -> V_259 ) {
case V_260 :
...
!= ( V_154 | V_263 ) )
break;
F_95 ( V_19 , V_255 -> V_261 , V_256 , V_257 , V_258 ) ;
return;
case V_264 :
if ( V_255 -> V_261 != ( V_233 | V_263
| V_245 ) )
break;
F_94 ( V_19 , V_256 , V_257 , V_258 ) ;
return;
case V_265 :
case V_266 :
{
...
== ( V_249 | V_263 ) ) {
int V_238 = F_96 ( V_257 ) ;
struct V_14 * V_15 ;
if ( V_256 != 0 || V_258 != 0 || V_238 >= V_19 -> V_269 )
break;
V_15 = F_93 ( V_19 , V_238 ) ;
F_22 ( & V_19 -> V_20 ) ;
V_267 = F_78 ( & V_15 -> V_15 ,
( V_255 -> V_259 == V_266 )
? 1 : 0 ) ;
F_24 ( & V_19 -> V_20 ) ;
...
static void F_102 ( struct V_21 * V_19 , struct V_14 * V_280 ,
struct V_16 * V_17 )
{
if ( V_19 -> V_241 == V_242 ) {
...
static void F_103 ( struct V_21 * V_19 , T_5 V_42 , T_5 * V_284 )
{
T_1 V_96 ;
struct V_122 * V_162 ;
...
static int F_104 ( struct V_21 * V_19 , int V_238 ,
struct V_16 * V_290 )
{
struct V_23 * V_24 ;
...
static void F_105 ( struct V_21 * V_19 )
{
T_1 V_303 ;
...
if ( ! ( V_303 & V_305 ) )
continue;
V_306 = F_93 ( V_19 , V_304 ) ;
if ( V_306 -> V_36 == NULL ) {
F_106 ( L_33 ) ;
continue;
}
F_107 (curr_req, temp_req, &curr_ep->queue,
queue) {
V_18 = F_104 ( V_19 , V_304 , V_290 ) ;
F_21 ( L_34 ,
V_18 , V_42 ) ;
if ( V_18 == V_302 )
break;
...
static inline enum V_309 F_108 ( T_1 V_310 )
{
switch ( V_310 & V_311 ) {
case V_312 :
return V_313 ;
...
static int F_112 ( struct V_21 * V_19 , bool V_318 )
{
T_5 V_238 ;
...
F_22 ( & V_19 -> V_20 ) ;
if ( V_318 )
F_113 ( & V_19 -> V_34 , V_19 -> V_147 ) ;
else
V_19 -> V_147 -> V_326 ( & V_19 -> V_34 ) ;
F_24 ( & V_19 -> V_20 ) ;
return 0 ;
}
static void F_114 ( struct V_21 * V_19 )
{
T_1 V_96 ;
unsigned long V_45 ;
...
static T_7 F_115 ( int V_329 , void * V_330 )
{
...
static int F_118 ( struct V_216 * V_342 )
{
struct V_14 * V_346 ;
unsigned long V_144 ;
if ( ! F_86 ( V_9 -> V_228 ) )
F_117 ( V_9 -> V_228 -> V_345 , NULL ) ;
F_42 ( V_9 ) ;
V_9 -> V_241 = V_328 ;
V_9 -> V_208 = V_209 ;
V_9 -> V_210 = 0 ;
...
static int F_119 ( struct V_347 * V_348 , void * V_2 )
{
unsigned long V_144 ;
int V_304 ;
T_1 V_349 ;
...
F_120 ( V_348 , L_100 , V_304 , V_349 ) ;
}
V_349 = F_31 ( & V_46 -> V_166 ) ;
F_120 ( V_348 , L_101 , V_349 ) ;
#ifndef F_39
if ( V_19 -> V_4 -> V_52 ) {
V_349 = V_54 -> V_94 ;
F_120 ( V_348 , L_102 , V_349 ) ;
V_349 = V_54 -> V_55 ;
F_120 ( V_348 , L_103 , V_349 ) ;
}
#endif
V_15 = & V_19 -> V_234 [ 0 ] ;
F_120 ( V_348 , L_104 ,
V_15 -> V_15 . V_36 , F_121 ( V_15 ) , F_54 ( V_15 ) ) ;
if ( F_27 ( & V_15 -> V_27 ) ) {
F_122 ( V_348 , L_105 ) ;
} else {
F_77 (req, &ep->queue, queue) {
...
static int F_123 ( struct V_355 * V_355 , struct V_356 * V_356 )
{
return F_124 ( V_356 , F_119 , NULL ) ;
}
static void F_125 ( struct V_357 * V_358 )
{
V_198 ( V_9 -> F_16 ) ;
F_126 ( V_358 -> V_359 , V_9 -> V_360 ,
V_9 -> V_82 , V_9 -> V_79 ) ;
F_61 ( V_9 ) ;
}
static int F_127 ( struct V_21 * V_19 ,
struct V_361 * V_362 )
{
struct V_3 * V_4 ;
T_8 V_211 ;
V_4 = F_128 ( & V_362 -> V_358 ) ;
V_19 -> V_50 = V_4 -> V_50 ;
V_19 -> V_234 = F_58 ( sizeof( struct V_14 ) * V_19 -> V_269 , V_363 ) ;
if ( ! V_19 -> V_234 )
return - 1 ;
...
V_19 -> V_82 = F_129 ( & V_362 -> V_358 , V_211 ,
& V_19 -> V_79 , V_363 ) ;
if ( ! V_19 -> V_82 ) {
F_37 ( L_111 ) ;
F_61 ( V_19 -> V_234 ) ;
...
V_19 -> V_360 = V_211 ;
V_19 -> V_231 = F_50 ( F_57 ( NULL , V_363 ) ,
struct V_16 , V_17 ) ;
V_19 -> V_231 -> V_17 . V_199 = F_130 ( 8 , V_363 ) ;
V_19 -> V_320 = V_365 ;
V_19 -> V_241 = V_366 ;
V_19 -> V_210 = 0 ;
V_19 -> V_220 = 0 ;
...
static int F_131 ( struct V_21 * V_19 , unsigned char V_239 ,
char * V_36 , int V_367 )
{
...
F_132 ( & V_15 -> V_15 , ( unsigned short ) ~ 0 ) ;
F_59 ( & V_15 -> V_27 ) ;
if ( V_367 )
F_75 ( & V_15 -> V_15 . V_377 , & V_19 -> V_34 . V_377 ) ;
V_15 -> V_34 = & V_19 -> V_34 ;
V_15 -> V_162 = & V_19 -> V_82 [ V_239 ] ;
return 0 ;
}
static int F_133 ( struct V_361 * V_362 )
{
struct V_3 * V_4 ;
struct V_378 * V_379 ;
int V_197 = - V_212 ;
unsigned int V_304 ;
T_1 V_83 ;
V_9 = F_58 ( sizeof( struct V_21 ) , V_363 ) ;
if ( V_9 == NULL )
return - V_195 ;
V_4 = F_128 ( & V_362 -> V_358 ) ;
V_9 -> V_4 = V_4 ;
...
#endif
V_379 = F_137 ( V_362 , V_384 , 0 ) ;
if ( ! V_379 ) {
V_197 = - V_385 ;
goto V_383;
}
if ( V_4 -> V_380 == V_386 ) {
if ( ! F_138 ( V_379 -> V_387 , F_139 ( V_379 ) ,
V_351 ) ) {
...
V_46 = F_140 ( V_379 -> V_387 , F_139 ( V_379 ) ) ;
if ( ! V_46 ) {
V_197 = - V_195 ;
goto V_389;
}
...
V_9 -> V_329 = F_142 ( V_362 , 0 ) ;
if ( ! V_9 -> V_329 ) {
V_197 = - V_212 ;
goto V_395;
}
V_197 = F_143 ( V_9 -> V_329 , F_115 , V_397 ,
V_351 , V_9 ) ;
if ( V_197 != 0 ) {
F_37 ( L_115 ,
V_9 -> V_329 , V_197 ) ;
...
F_132 ( & V_9 -> V_234 [ 0 ] . V_15 ,
V_136 ) ;
for ( V_304 = 1 ; V_304 < ( int ) ( V_9 -> V_269 / 2 ) ; V_304 ++ ) {
char V_36 [ 14 ] ;
sprintf ( V_36 , L_119 , V_304 ) ;
F_131 ( V_9 , V_304 * 2 , V_36 , 1 ) ;
sprintf ( V_36 , L_120 , V_304 ) ;
F_131 ( V_9 , V_304 * 2 + 1 , V_36 , 1 ) ;
}
V_9 -> V_32 = F_146 ( L_121 , & V_362 -> V_358 ,
sizeof( struct V_23 ) ,
V_403 , V_404 ) ;
if ( V_9 -> V_32 == NULL ) {
V_197 = - V_195 ;
...
V_197 = F_147 ( & V_362 -> V_358 , & V_9 -> V_34 ,
F_125 ) ;
if ( V_197 )
goto V_405;
F_148 () ;
...
V_389:
if ( V_4 -> V_380 == V_386 )
F_153 ( V_379 -> V_387 , F_139 ( V_379 ) ) ;
V_383:
F_61 ( V_9 ) ;
V_9 = NULL ;
return V_197 ;
}
static int F_154 ( struct V_361 * V_362 )
{
struct V_378 * V_379 = F_137 ( V_362 , V_384 , 0 ) ;
struct V_3 * V_4 = F_128 ( & V_362 -> V_358 ) ;
F_155 ( F_16 ) ;
if ( ! V_9 )
return - V_212 ;
V_9 -> F_16 = & F_16 ;
...
static int F_159 ( struct V_361 * V_362 , T_9 V_406 )
{
F_42 ( V_9 ) ;
return 0 ;
}
static int F_160 ( struct V_361 * V_362 )
{
if ( V_9 -> V_22 ) {
F_29 ( V_9 ) ;
F_41 ( V_9 ) ;
...
static int F_161 ( struct V_357 * V_358 , T_9 V_406 )
{
struct V_21 * V_19 = V_9 ;
T_1 V_407 , V_67 ;
...
static int F_163 ( struct V_357 * V_358 )
{
F_43 ( L_126 , V_104 ,
V_9 -> V_22 , V_9 -> V_408 ) ;
if ( V_9 -> V_408 ) {
