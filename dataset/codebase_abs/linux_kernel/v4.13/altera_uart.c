...
static void F_58 ( struct V_79 * V_80 , const char * V_81 ,
unsigned int V_82 )
{
struct V_92 * V_93 = V_80 -> V_67 ;
F_52 ( & V_93 -> V_2 , V_81 , V_82 , F_50 ) ;
}
static int T_3 F_59 ( struct V_92 * V_93 ,
const char * V_85 )
{
...
V_2 -> V_4 + V_18 ) ;
if ( V_93 -> V_28 ) {
unsigned int V_29 = V_2 -> V_30 / V_93 -> V_28 ;
F_4 ( V_29 , V_2 -> V_4 + V_32 ) ;
}
V_93 -> V_94 -> V_95 = F_58 ;
return 0 ;
}
...
{
struct V_98 * V_99 = F_61 ( & V_97 -> V_93 ) ;
struct V_1 * V_2 ;
struct V_100 * V_101 ;
struct V_100 * V_102 ;
int V_103 = V_97 -> V_104 ;
int V_72 ;
if ( V_103 == - 1 ) {
...
V_72 = F_63 ( V_97 -> V_93 . V_109 , L_4 ,
& V_2 -> V_30 ) ;
if ( V_72 )
return V_72 ;
}
V_2 -> V_4 = F_64 ( V_2 -> V_105 , V_110 ) ;
if ( ! V_2 -> V_4 )
return - V_111 ;
if ( V_99 )
V_2 -> V_5 = V_99 -> V_112 ;
