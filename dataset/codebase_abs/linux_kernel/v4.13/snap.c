...
{
struct V_54 * V_54 = & V_53 -> V_55 ;
struct V_1 * V_2 = F_65 ( V_54 -> V_92 ) -> V_2 ;
F_55 ( V_57 -> V_91 ) ;
V_57 -> V_93 = V_54 -> V_94 ;
V_57 -> V_95 = V_54 -> V_96 ;
V_57 -> V_97 = V_54 -> V_98 ;
...
V_57 -> V_102 = V_53 -> V_103 ;
V_57 -> V_104 = V_53 -> V_105 ;
if ( V_57 -> V_88 ) {
F_2 ( L_24
L_25 , V_54 , V_57 ,
...
{
struct V_52 * V_53 ;
struct V_54 * V_111 = NULL ;
struct V_3 * V_48 ;
F_2 ( L_27 , V_4 , V_4 -> V_16 ) ;
F_5 ( & V_4 -> V_25 ) ;
F_46 (ci, &realm->inodes_with_caps,
i_snap_realm_item) {
struct V_54 * V_54 = F_67 ( & V_53 -> V_55 ) ;
if ( ! V_54 )
continue;
F_7 ( & V_4 -> V_25 ) ;
F_68 ( V_111 ) ;
...
void * V_12 , void * V_112 , bool V_113 ,
struct V_3 * * V_114 )
{
struct V_115 * V_116 ;
T_3 * V_29 ;
...
F_2 ( L_30 , V_113 ) ;
V_120:
F_71 ( & V_12 , V_112 , sizeof( * V_116 ) , V_121 ) ;
V_116 = V_12 ;
V_12 += sizeof( * V_116 ) ;
F_71 ( & V_12 , V_112 , sizeof( T_1 ) * ( F_72 ( V_116 -> V_42 ) +
F_72 ( V_116 -> V_41 ) ) , V_121 ) ;
V_29 = V_12 ;
V_12 += sizeof( T_1 ) * F_72 ( V_116 -> V_42 ) ;
V_28 = V_12 ;
V_12 += sizeof( T_1 ) * F_72 ( V_116 -> V_41 ) ;
V_4 = F_20 ( V_2 , F_73 ( V_116 -> V_16 ) ) ;
if ( ! V_4 ) {
V_4 = F_13 ( V_2 , F_73 ( V_116 -> V_16 ) ) ;
if ( F_38 ( V_4 ) ) {
V_39 = F_39 ( V_4 ) ;
goto V_43;
}
}
V_39 = F_37 ( V_2 , V_4 , F_73 ( V_116 -> V_13 ) ) ;
if ( V_39 < 0 )
goto V_43;
V_118 += V_39 ;
if ( F_73 ( V_116 -> V_44 ) > V_4 -> V_44 ) {
F_2 ( L_31 ,
V_4 -> V_16 , V_4 , V_4 -> V_44 , F_73 ( V_116 -> V_44 ) ) ;
V_4 -> V_44 = F_73 ( V_116 -> V_44 ) ;
V_4 -> V_122 = F_73 ( V_116 -> V_122 ) ;
V_4 -> V_47 = F_73 ( V_116 -> V_47 ) ;
V_4 -> V_42 = F_72 ( V_116 -> V_42 ) ;
...
struct V_128 * V_129 )
{
struct V_130 * V_131 = V_2 -> V_132 -> V_131 ;
int V_133 = V_126 -> V_134 ;
T_1 V_135 ;
int V_136 ;
int V_137 ;
struct V_3 * V_4 = NULL ;
void * V_12 = V_129 -> V_138 . V_139 ;
void * V_112 = V_12 + V_129 -> V_138 . V_140 ;
struct V_141 * V_142 ;
int V_143 , V_144 ;
T_3 * V_145 = NULL , * V_146 = NULL ;
int V_46 ;
int V_147 = 0 ;
if ( V_129 -> V_138 . V_140 < sizeof( * V_142 ) )
goto V_121;
V_142 = V_12 ;
V_136 = F_72 ( V_142 -> V_136 ) ;
V_135 = F_73 ( V_142 -> V_135 ) ;
V_143 = F_72 ( V_142 -> V_143 ) ;
V_144 = F_72 ( V_142 -> V_144 ) ;
V_137 = F_72 ( V_142 -> V_137 ) ;
V_12 += sizeof( * V_142 ) ;
F_2 ( L_38 , V_133 ,
F_79 ( V_136 ) , V_135 , V_137 ) ;
F_80 ( & V_126 -> V_127 ) ;
V_126 -> V_148 ++ ;
F_76 ( & V_126 -> V_127 ) ;
F_36 ( & V_2 -> V_31 ) ;
...
for ( V_46 = 0 ; V_46 < V_143 ; V_46 ++ ) {
struct V_151 V_152 = {
. V_16 = F_73 ( V_145 [ V_46 ] ) ,
. V_153 = V_154 ,
} ;
struct V_54 * V_54 = F_81 ( V_131 , V_152 ) ;
struct V_52 * V_53 ;
struct V_3 * V_155 ;
if ( ! V_54 )
continue;
