...
V_9 -> V_33 == F_3 ( V_34 ) ) {
V_5 = F_14 ( V_27 , V_27 -> V_53 ,
( V_54 )
( ( char * ) V_10 - ( char * ) V_9 ) ) ;
V_23 . V_23 = V_10 -> V_23 ;
V_23 . V_55 = V_10 -> V_47 ;
V_15 = V_19 -> V_56 -> V_57 ( & V_23 ) ;
for ( V_16 = 0 ; V_16 < F_7 ( V_7 -> V_8 ) ; V_16 ++ ) {
if ( F_7 ( V_18 [ V_16 ] . V_58 ) == V_5 &&
F_7 ( V_18 [ V_16 ] . V_59 ) == V_15 )
break;
}
F_6 ( V_19 ,
V_16 < F_7 ( V_7 -> V_8 ) ) ;
...
int * V_98 )
{
return F_36 ( V_2 -> V_100 -> V_30 , V_2 -> V_101 ,
V_9 , V_98 ) ;
}
int
F_38 (
...
V_19 = V_2 -> V_100 ;
V_84 = args -> V_103 ;
error = F_39 ( V_84 , V_2 , F_40 ( args -> V_27 , V_67 ) ,
- 1 , & V_4 , V_89 ) ;
if ( error )
return error ;
V_4 -> V_71 = & V_74 ;
...
V_9 -> V_33 == F_3 ( V_35 ) ||
V_9 -> V_33 == F_3 ( V_34 ) ) ;
F_45 ( args -> V_103 , V_4 , ( V_108 ) ( ( char * ) V_10 - ( char * ) V_9 ) ,
( V_108 ) ( ( char * ) ( args -> V_2 -> V_101 -> V_50 ( V_10 ) + 1 ) -
( char * ) V_9 - 1 ) ) ;
}
void
F_42 (
...
V_9 -> V_33 == F_3 ( V_35 ) ||
V_9 -> V_33 == F_3 ( V_34 ) ) ;
F_45 ( args -> V_103 , V_4 , ( V_108 ) ( ( char * ) V_12 - ( char * ) V_9 ) ,
...
V_117 = NULL ;
if ( ( char * ) V_9 + V_44 + V_55 < V_113 ) {
V_116 =
( T_6 * ) ( ( char * ) V_9 + V_44 + V_55 ) ;
...
V_114 = ( V_6 [ 2 ] . V_43 != 0 ) ;
F_47 ( & V_117 -> V_43 , V_55 + F_9 ( V_116 -> V_43 ) ) ;
* F_10 ( V_117 ) =
...
V_115 -> V_43 = F_34 ( V_55 + F_9 ( V_116 -> V_43 ) ) ;
* F_10 ( V_115 ) =
...
ASSERT ( V_44 + V_55 <= ( char * ) V_12 + F_9 ( V_12 -> V_43 ) - ( char * ) V_9 ) ;
...
V_120 = ( char * ) V_12 + V_123 - ( char * ) V_9 == V_44 + V_55 ;
ASSERT ( * V_112 == 0 ) ;
V_114 = 0 ;
if ( V_121 && V_120 ) {
if ( V_11 ) {
...
V_115 = ( T_6 * ) ( ( char * ) V_9 + V_44 + V_55 ) ;
V_115 -> V_45 = F_34 ( V_46 ) ;
V_115 -> V_43 = F_34 ( V_123 - V_55 ) ;
* F_10 ( V_115 ) =
F_34 ( ( char * ) V_115 - ( char * ) V_9 ) ;
F_43 ( args , V_4 , V_115 ) ;
if ( V_11 ) {
...
F_34 ( ( char * ) V_115 - ( char * ) V_9 ) ;
F_43 ( args , V_4 , V_115 ) ;
V_122 = ( T_6 * ) ( ( char * ) V_9 + V_44 + V_55 ) ;
V_122 -> V_45 = F_34 ( V_46 ) ;
V_122 -> V_43 = F_34 ( V_123 - V_55 - F_9 ( V_115 -> V_43 ) ) ;
* F_10 ( V_122 ) =
