...
V_725 = V_34 ;
for ( V_34 = 0 ; V_34 < V_147 -> V_37 ; V_34 ++ )
V_286 += sprintf ( V_724 + V_286 , L_126 ,
V_34 , V_147 -> V_160 [ V_34 ] . V_39 / 100 ,
( V_34 == V_725 ) ? L_127 : L_128 ) ;
break;
case V_448 :
F_14 ( V_5 -> V_21 , V_601 ) ;
clock = F_6 ( V_5 -> V_6 , V_599 ) ;
...
V_725 = V_34 ;
for ( V_34 = 0 ; V_34 < V_127 -> V_37 ; V_34 ++ )
V_286 += sprintf ( V_724 + V_286 , L_129 , V_34 ,
( V_127 -> V_160 [ V_34 ] . V_39 == 0 ) ? L_130 :
( V_127 -> V_160 [ V_34 ] . V_39 == 1 ) ? L_131 :
( V_127 -> V_160 [ V_34 ] . V_39 == 2 ) ? L_132 : L_128 ,
( V_34 == V_725 ) ? L_127 : L_128 ) ;
break;
default:
break;
...
T_5 V_34 ;
T_2 V_714 ;
T_2 V_284 = V_282 ( V_753 , ( T_2 ) V_621 ) ;
F_2 ((clock >= min), L_135 , return 0 ) ;
for ( V_34 = V_754 ; ; V_34 -- ) {
V_714 = clock >> V_34 ;
