...
int V_189 ;
int V_45 = 0 ;
struct V_203 * V_204 = F_90 ( & V_198 -> V_2 ) ;
T_1 V_205 = V_204 ? V_204 -> V_205 : 0 ;
...
F_92 ( V_44 , & V_198 -> V_2 ) ;
F_93 ( V_198 , V_44 ) ;
V_200 = F_94 ( V_198 , V_207 , 0 ) ;
if ( ! V_200 ) {
F_17 ( & V_198 -> V_2 , L_19 ) ;
V_45 = - V_128 ;
goto free;
}
V_201 = F_95 ( & V_198 -> V_2 , V_200 -> V_208 ,
...
V_44 -> V_138 = V_201 -> V_208 ;
V_200 = F_94 ( V_198 , V_207 , 1 ) ;
if ( V_200 ) {
V_202 = F_95 ( & V_198 -> V_2 , V_200 -> V_208 ,
F_96 ( V_200 ) , V_200 -> V_137 ) ;
if ( ! V_202 ) {
F_17 ( & V_198 -> V_2 , L_21 ) ;
V_45 = - V_128 ;
...
V_44 -> V_21 = V_202 -> V_208 ;
V_44 -> V_139 = V_202 -> V_209 ;
}
V_200 = F_94 ( V_198 , V_210 , 0 ) ;
if ( ! V_200 ) {
F_17 ( & V_198 -> V_2 , L_22 ) ;
V_45 = - V_128 ;
goto free;
}
V_44 -> V_88 = V_200 -> V_208 ;
V_61 = F_19 ( V_44 ) ;
V_61 -> V_44 = V_44 ;
...
V_44 -> V_139 = V_44 -> V_21 + V_211 ;
}
V_61 -> V_4 = V_204 ? V_204 -> V_4 :
F_99 ( V_198 -> V_2 . V_213 ) ;
...
F_33 ( & V_198 -> V_2 , L_26 ,
V_61 -> V_28 , V_61 -> V_36 ) ;
V_61 -> V_23 = F_101 ( & V_198 -> V_2 , V_189 * sizeof( void * ) , V_212 ) ;
if ( ! V_61 -> V_23 ) {
V_45 = - V_206 ;
goto free;
}
if ( V_204 ) {
F_102 ( V_44 -> V_149 , V_204 -> V_214 ) ;
V_61 -> V_126 = V_204 -> V_126 ;
} else {
const void * V_95 ;
V_95 = F_103 ( V_198 -> V_2 . V_213 ) ;
if ( V_95 )
F_102 ( V_44 -> V_149 , V_95 ) ;
V_61 -> V_126 = - 1 ;
}
if ( ! F_68 ( V_44 -> V_149 ) )
...
F_66 ( V_44 ) ;
if ( ! V_205 ) {
struct V_215 * V_215 = F_105 ( & V_198 -> V_2 , NULL ) ;
if ( ! F_106 ( V_215 ) ) {
V_61 -> V_215 = V_215 ;
F_107 ( V_215 ) ;
V_205 = F_108 ( V_215 ) ;
...
if ( V_205 ) {
T_1 V_216 = F_109 ( V_205 / 2500000 + 1 ) ;
if ( ! V_216 )
V_216 = 2 ;
F_33 ( & V_198 -> V_2 , L_27 , V_216 ) ;
F_4 ( V_61 , V_217 ,
( F_1 ( V_61 , V_217 ) & V_218 ) |
V_216 ) ;
}
V_61 -> V_127 = F_110 () ;
if ( ! V_61 -> V_127 ) {
...
snprintf ( V_61 -> V_127 -> V_220 , V_221 , L_29 ,
V_61 -> V_127 -> V_137 , V_198 -> V_220 ) ;
V_61 -> V_127 -> V_222 = F_39 ;
V_61 -> V_127 -> V_223 = F_42 ;
V_61 -> V_127 -> V_61 = V_61 ;
V_45 = F_111 ( V_61 -> V_127 ) ;
if ( V_45 ) {
F_17 ( & V_44 -> V_2 , L_30 ) ;
goto V_219;
}
...
static int F_124 ( struct V_197 * V_198 , T_7 V_232 )
{
return - V_171 ;
}
static int F_125 ( struct V_197 * V_198 )
{
return - V_171 ;
}
