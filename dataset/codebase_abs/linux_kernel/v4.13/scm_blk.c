...
int F_71 ( struct V_29 * V_30 , struct V_40 * V_41 )
{
...
V_30 -> V_95 . V_96 = & V_97 ;
V_30 -> V_95 . V_98 = V_99 ;
V_30 -> V_95 . V_100 = V_17 * V_99 ;
V_30 -> V_95 . V_22 = V_101 ;
V_20 = F_74 ( & V_30 -> V_95 ) ;
if ( V_20 )
goto V_21;
V_66 = F_75 ( & V_30 -> V_95 ) ;
...
V_66 -> V_72 = V_41 ;
V_30 -> V_42 -> V_43 = V_41 ;
V_30 -> V_42 -> V_108 = & V_109 ;
V_30 -> V_42 -> V_71 = V_66 ;
V_30 -> V_42 -> V_110 = V_111 ;
V_30 -> V_42 -> V_112 = V_88 * V_106 ;
V_91 = snprintf ( V_30 -> V_42 -> V_113 , V_114 , L_9 ) ;
if ( V_88 > 25 ) {
V_91 += snprintf ( V_30 -> V_42 -> V_113 + V_91 ,
V_114 - V_91 , L_10 ,
'a' + ( V_88 / 26 ) - 1 ) ;
V_88 = V_88 % 26 ;
}
snprintf ( V_30 -> V_42 -> V_113 + V_91 , V_114 - V_91 , L_10 ,
'a' + V_88 ) ;
F_85 ( V_30 -> V_42 , V_41 -> V_115 >> 9 ) ;
F_86 ( & V_41 -> V_73 , V_30 -> V_42 ) ;
return 0 ;
V_107:
F_87 ( V_66 ) ;
V_102:
