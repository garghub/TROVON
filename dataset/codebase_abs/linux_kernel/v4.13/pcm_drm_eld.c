...
if ( V_1 ) {
V_9 = F_5 ( V_3 , V_14 ) ;
for ( V_11 = F_6 ( V_12 ) ; V_11 > 0 ; V_11 -- , V_1 += 3 ) {
unsigned V_15 = F_1 ( V_1 ) ;
if ( V_9 -> V_16 <= V_15 )
V_10 |= V_1 [ 1 ] ;
}
}
return F_7 ( V_7 , F_8 ( V_17 ) , V_17 ,
V_10 ) ;
}
...
return F_11 ( V_9 , & V_18 ) ;
}
int F_12 ( struct V_21 * V_22 , void * V_12 )
{
int V_23 ;
V_23 = F_13 ( V_22 , 0 , V_20 ,
F_2 , V_12 ,
V_14 , - 1 ) ;
if ( V_23 < 0 )
return V_23 ;
V_23 = F_13 ( V_22 , 0 , V_14 ,
F_9 , V_12 ,
V_20 , - 1 ) ;
return V_23 ;
}
