...
V_15 = V_22 -> V_10 -> V_14 ;
F_95 ( V_280 , L_166 , V_286 ? L_15 : L_167 , V_15 ) ;
V_286 = 0 ;
}
F_95 ( V_280 , L_168 ) ;
}
...
while ( ( V_301 = F_105 ( V_295 , V_296 , L_173 ) ) != - 1 ) {
switch ( V_301 ) {
case 'i' :
V_297 = V_305 ;
break;
