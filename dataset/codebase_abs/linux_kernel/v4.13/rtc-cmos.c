...
static void F_105 ( struct V_145 * V_146 )
{
F_72 ( & V_146 -> V_13 ) ;
}
...
static T_13 void F_107 ( struct V_152 * V_153 )
{
...
if ( ! V_155 )
return;
V_11 = F_108 ( V_155 , L_35 , NULL ) ;
if ( V_11 )
F_31 ( F_109 ( V_11 ) , V_33 ) ;
V_11 = F_108 ( V_155 , L_36 , NULL ) ;
if ( V_11 )
F_31 ( F_109 ( V_11 ) , V_111 ) ;
...
static inline void F_107 ( struct V_152 * V_153 ) {}
static int T_13 F_111 ( struct V_152 * V_153 )
{
struct V_80 * V_80 ;
int V_21 ;
F_107 ( V_153 ) ;
F_94 ( & V_153 -> V_13 ) ;
if ( V_88 )
V_80 = F_112 ( V_153 , V_149 , 0 ) ;
else
V_80 = F_112 ( V_153 , V_158 , 0 ) ;
V_21 = F_113 ( V_153 , 0 ) ;
if ( V_21 < 0 )
V_21 = - 1 ;
...
static void F_115 ( struct V_152 * V_153 )
{
