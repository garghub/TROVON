...
F_2 (self->magic == IRCOMM_TTY_MAGIC, return -1;) ;
if ( V_2 -> V_9 == V_10 )
return 0 ;
F_3 ( & V_2 -> V_11 , V_5 ) ;
V_7 = V_2 -> V_12 ;
...
T_1 V_9 = ( T_1 ) V_21 -> V_23 . V_24 ;
F_2 (self != NULL, return -1;) ;
F_2 (self->magic == IRCOMM_TTY_MAGIC, return -1;) ;
if ( V_22 ) {
V_21 -> V_23 . V_24 = V_2 -> V_25 . V_9 ;
return 0 ;
}
V_9 &= V_2 -> V_9 ;
if ( ! V_9 ) {
...
F_12 ( L_10 , V_17 , ( T_1 ) V_21 -> V_23 . V_24 ) ;
return 0 ;
}
...
struct V_1 * V_2 = (struct V_1 * ) V_20 ;
T_1 V_42 ;
F_12 ( L_14 , V_17 , ( T_1 ) V_21 -> V_23 . V_24 ) ;
