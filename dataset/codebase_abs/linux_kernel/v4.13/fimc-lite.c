...
unsigned int V_76 [] , struct V_77 * V_78 [] )
{
struct V_13 * V_14 = V_73 -> V_70 ;
struct V_79 * V_80 = & V_14 -> V_21 ;
const struct V_1 * V_6 = V_80 -> V_6 ;
unsigned long V_81 = V_80 -> V_82 * V_80 -> V_83 ;
int V_8 ;
if ( V_6 == NULL )
return - V_22 ;
if ( * V_75 ) {
...
if ( V_76 [ V_8 ] < ( V_81 * V_6 -> V_85 [ V_8 ] ) / 8 )
return - V_22 ;
return 0 ;
}
* V_75 = V_6 -> V_84 ;
for ( V_8 = 0 ; V_8 < V_6 -> V_84 ; V_8 ++ )
V_76 [ V_8 ] = ( V_81 * V_6 -> V_85 [ V_8 ] ) / 8 ;
return 0 ;
}
...
return - V_22 ;
for ( V_8 = 0 ; V_8 < V_14 -> V_21 . V_6 -> V_84 ; V_8 ++ ) {
...
{
struct V_79 * V_80 = & V_14 -> V_20 ;
F_73 ( & V_137 -> V_121 , 0 , V_80 -> V_82 , 0 ,
& V_137 -> V_124 , 0 , V_80 -> V_83 , 0 , 0 ) ;
V_137 -> V_138 = F_80 ( T_1 , V_137 -> V_138 , 0 , V_80 -> V_82 - V_137 -> V_121 ) ;
V_137 -> V_138 = F_81 ( V_137 -> V_138 , V_14 -> V_116 -> V_139 ) ;
V_137 -> V_140 = F_80 ( T_1 , V_137 -> V_140 , 0 , V_80 -> V_83 - V_137 -> V_124 ) ;
...
V_137 -> V_140 = F_80 ( T_1 , V_137 -> V_140 , 0 , V_14 -> V_21 . V_83 - V_137 -> V_124 ) ;
...
struct V_79 * V_80 = & V_14 -> V_21 ;
const struct V_1 * V_6 = V_80 -> V_6 ;
V_163 -> V_164 = ( V_80 -> V_82 * V_6 -> V_85 [ 0 ] ) / 8 ;
V_163 -> V_165 = V_163 -> V_164 * V_80 -> V_83 ;
V_160 -> V_75 = V_6 -> V_84 ;
V_160 -> V_2 = V_6 -> V_12 ;
V_160 -> V_121 = V_80 -> V_82 ;
V_160 -> V_124 = V_80 -> V_83 ;
V_160 -> V_135 = V_136 ;
...
if ( ( V_167 == 0 || ( ( V_167 * 8 ) / V_6 -> V_85 [ 0 ] ) < V_160 -> V_121 ) )
...
return V_71 ;
V_80 -> V_6 = V_6 ;
V_14 -> V_88 [ 0 ] = F_92 ( ( V_160 -> V_121 * V_160 -> V_124 * V_6 -> V_85 [ 0 ] ) / 8 ,
V_160 -> V_163 [ 0 ] . V_165 ) ;
V_80 -> V_82 = V_160 -> V_121 ;
V_80 -> V_83 = V_160 -> V_124 ;
return 0 ;
}
...
break;
if ( V_171 == & V_14 -> V_134 ) {
struct V_79 * V_176 = & V_14 -> V_21 ;
V_129 . V_114 . V_121 = V_176 -> V_82 ;
V_129 . V_114 . V_124 = V_176 -> V_83 ;
...
V_191 -> V_137 . V_138 = 0 ;
V_191 -> V_137 . V_140 = 0 ;
V_191 -> V_137 . V_121 = V_154 -> V_82 ;
V_191 -> V_137 . V_124 = V_154 -> V_83 ;
return 0 ;
case V_196 :
...
struct V_79 * V_154 = & V_14 -> V_20 ;
if ( V_6 -> V_132 == V_133 ) {
V_118 = F_115 ( V_171 , V_112 , V_6 -> V_119 ) ;
V_6 -> V_114 = * V_118 ;
return 0 ;
}
F_61 ( & V_14 -> V_98 ) ;
...
if ( V_6 -> V_119 == V_120 ) {
V_118 -> V_121 = V_154 -> V_82 ;
V_118 -> V_124 = V_154 -> V_83 ;
} else {
...
if ( V_6 -> V_119 == V_120 ) {
V_128 -> V_82 = V_118 -> V_121 ;
V_128 -> V_83 = V_118 -> V_124 ;
V_128 -> V_6 = V_166 ;
...
V_210 -> V_82 = V_118 -> V_121 ;
V_210 -> V_83 = V_118 -> V_124 ;
}
F_65 ( & V_14 -> V_98 ) ;
return 0 ;
}
...
V_154 -> V_131 . V_124 , V_154 -> V_82 , V_154 -> V_83 ) ;
return 0 ;
}
...
static int F_120 ( struct V_170 * V_171 , int V_215 )
{
struct V_13 * V_14 = F_111 ( V_171 ) ;
unsigned long V_11 ;
int V_71 ;
...
static int F_122 ( struct V_170 * V_171 )
{
struct V_13 * V_14 = F_111 ( V_171 ) ;
F_13 ( V_14 , V_27 ) ;
return 0 ;
...
V_68 -> type = V_227 ;
V_68 -> V_228 = V_229 | V_230 ;
V_68 -> V_231 = & V_232 ;
V_68 -> V_233 = & V_234 ;
V_68 -> V_235 = sizeof( struct V_29 ) ;
V_68 -> V_70 = V_14 ;
V_68 -> V_236 = V_237 ;
V_68 -> V_98 = & V_14 -> V_98 ;
V_68 -> V_103 = & V_14 -> V_102 -> V_103 ;
V_71 = F_125 ( V_68 ) ;
if ( V_71 < 0 )
return V_71 ;
V_14 -> V_238 . V_11 = V_175 ;
V_71 = F_126 ( & V_217 -> V_97 , 1 , & V_14 -> V_238 ) ;
if ( V_71 < 0 )
return V_71 ;
F_127 ( V_217 , V_14 ) ;
V_14 -> V_44 . V_182 = F_4 ( V_171 ) ;
V_71 = F_128 ( V_217 , V_239 , - 1 ) ;
if ( V_71 < 0 ) {
F_129 ( & V_217 -> V_97 ) ;
V_14 -> V_44 . V_182 = NULL ;
return V_71 ;
}
F_130 ( V_171 -> V_222 , L_12 ,
V_217 -> V_156 , F_131 ( V_217 ) ) ;
return 0 ;
}
static void F_132 ( struct V_170 * V_171 )
{
struct V_13 * V_14 = F_111 ( V_171 ) ;
if ( V_14 == NULL )
return;
F_61 ( & V_14 -> V_98 ) ;
if ( F_133 ( & V_14 -> V_44 . V_89 ) ) {
F_134 ( & V_14 -> V_44 . V_89 ) ;
F_129 ( & V_14 -> V_44 . V_89 . V_97 ) ;
V_14 -> V_44 . V_182 = NULL ;
}
F_65 ( & V_14 -> V_98 ) ;
}
...
{
struct V_13 * V_14 = F_54 ( V_241 -> V_242 , struct V_13 ,
V_243 ) ;
F_25 ( V_48 , & V_14 -> V_32 ) ;
return 0 ;
}
...
V_128 -> V_82 = V_244 ;
V_128 -> V_83 = V_245 ;
V_128 -> V_131 . V_121 = V_244 ;
V_128 -> V_131 . V_124 = V_245 ;
V_128 -> V_131 . V_138 = 0 ;
V_128 -> V_131 . V_140 = 0 ;
* V_210 = * V_128 ;
}
...
{
struct V_246 * V_242 = & V_14 -> V_243 ;
struct V_170 * V_171 = & V_14 -> V_134 ;
int V_71 ;
F_138 ( V_171 , & V_247 ) ;
V_171 -> V_11 |= V_248 ;
snprintf ( V_171 -> V_156 , sizeof( V_171 -> V_156 ) , L_13 , V_14 -> V_5 ) ;
V_14 -> V_249 [ V_120 ] . V_11 = V_175 ;
V_14 -> V_249 [ V_205 ] . V_11 = V_250 ;
V_14 -> V_249 [ V_207 ] . V_11 = V_250 ;
V_71 = F_126 ( & V_171 -> V_97 , V_251 ,
V_14 -> V_249 ) ;
if ( V_71 )
return V_71 ;
F_139 ( V_242 , 1 ) ;
V_14 -> V_24 = F_140 ( V_242 , & V_252 ,
NULL ) ;
if ( V_242 -> error ) {
F_129 ( & V_171 -> V_97 ) ;
return V_242 -> error ;
...
V_171 -> V_243 = V_242 ;
V_171 -> V_253 = & V_254 ;
V_171 -> V_97 . V_255 = V_256 ;
V_171 -> V_97 . V_231 = & V_257 ;
V_171 -> V_258 = V_259 ;
F_141 ( V_171 , V_14 ) ;
return 0 ;
}
...
{
V_14 -> clock = F_150 ( & V_14 -> V_102 -> V_103 , V_260 ) ;
if ( F_146 ( V_14 -> clock ) )
return F_151 ( V_14 -> clock ) ;
return 0 ;
}
static int F_152 ( struct V_261 * V_102 )
{
struct V_115 * V_262 = NULL ;
struct V_77 * V_103 = & V_102 -> V_103 ;
...
if ( ! V_103 -> V_267 )
return - V_268 ;
V_14 = F_153 ( V_103 , sizeof( * V_14 ) , V_269 ) ;
if ( ! V_14 )
return - V_270 ;
V_264 = F_154 ( V_271 , V_103 -> V_267 ) ;
if ( V_264 )
V_262 = (struct V_115 * ) V_264 -> V_272 ;
V_14 -> V_5 = F_155 ( V_103 -> V_267 , L_14 ) ;
if ( ! V_262 || V_14 -> V_5 >= V_262 -> V_273 ||
V_14 -> V_5 < 0 ) {
F_156 ( V_103 , L_15 ,
V_103 -> V_267 -> V_274 ) ;
return - V_22 ;
...
F_158 ( & V_14 -> V_23 ) ;
F_159 ( & V_14 -> V_98 ) ;
V_266 = F_160 ( V_102 , V_275 , 0 ) ;
V_14 -> V_276 = F_161 ( V_103 , V_266 ) ;
if ( F_146 ( V_14 -> V_276 ) )
return F_151 ( V_14 -> V_276 ) ;
V_266 = F_160 ( V_102 , V_277 , 0 ) ;
if ( V_266 == NULL ) {
F_156 ( V_103 , L_16 ) ;
return - V_19 ;
}
...
if ( V_71 )
return V_71 ;
V_71 = F_162 ( V_103 , V_266 -> V_278 , F_32 ,
0 , F_85 ( V_103 ) , V_14 ) ;
if ( V_71 ) {
F_156 ( V_103 , L_17 , V_71 ) ;
goto V_279;
}
V_71 = F_137 ( V_14 ) ;
if ( V_71 )
...
F_164 ( V_103 ) ;
if ( ! F_165 ( V_103 ) ) {
V_71 = F_166 ( V_14 -> clock ) ;
if ( V_71 < 0 )
goto V_280;
}
F_167 ( V_103 , F_168 ( 32 ) ) ;
F_136 ( V_14 ) ;
F_169 ( V_103 , L_18 ,
V_14 -> V_5 ) ;
return 0 ;
...
static int F_170 ( struct V_77 * V_103 )
{
struct V_13 * V_14 = F_171 ( V_103 ) ;
F_166 ( V_14 -> clock ) ;
return 0 ;
}
static int F_172 ( struct V_77 * V_103 )
{
struct V_13 * V_14 = F_171 ( V_103 ) ;
F_173 ( V_14 -> clock ) ;
return 0 ;
}
static int F_174 ( struct V_77 * V_103 )
{
struct V_13 * V_14 = F_171 ( V_103 ) ;
struct V_29 * V_30 ;
unsigned long V_11 ;
...
static int F_175 ( struct V_77 * V_103 )
{
struct V_13 * V_14 = F_171 ( V_103 ) ;
bool V_28 = F_28 ( V_101 , & V_14 -> V_32 ) ;
int V_71 ;
if ( F_44 ( V_281 , & V_14 -> V_32 ) )
return 0 ;
V_71 = F_23 ( V_14 , V_28 ) ;
if ( V_71 < 0 || ! F_24 ( V_14 ) )
return V_71 ;
...
static int F_176 ( struct V_261 * V_102 )
{
struct V_13 * V_14 = F_177 ( V_102 ) ;
struct V_77 * V_103 = & V_102 -> V_103 ;
F_178 ( V_103 ) ;
F_179 ( V_103 ) ;
F_142 ( V_14 ) ;
