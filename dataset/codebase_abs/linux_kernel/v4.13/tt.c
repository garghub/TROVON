...
struct V_76 * V_77 ;
int V_78 , V_79 ;
for ( V_78 = 0 ; V_78 < F_33 ( V_2 -> V_80 ) ; V_78 ++ ) {
V_77 = F_47 ( V_2 , V_78 ) ;
if ( ! V_77 )
continue;
if ( V_75 == V_77 -> V_81 )
...
{
struct V_1 * V_2 = (struct V_1 * ) V_129 -> V_130 ;
if ( V_135 < 0 || V_135 >= V_34 )
return - V_23 ;
* V_16 = V_2 -> V_35 . V_122 [ V_135 ] * 1000 ;
return 0 ;
}
static int F_64 ( struct V_128 * V_129 ,
int V_135 , enum V_136 * type )
{
if ( V_135 < 0 || V_135 >= V_34 )
return - V_23 ;
* type = V_137 ;
...
F_67 ( F_33 ( V_139 ) >= V_140 ) ;
V_2 -> V_35 . V_36 = F_68 ( V_139 ,
V_34 ,
V_141 ,
V_2 , & V_142 ,
NULL , 0 , 0 ) ;
...
unsigned long * V_103 )
{
struct V_1 * V_2 = (struct V_1 * ) ( V_144 -> V_130 ) ;
...
V_2 ,
& V_147 ) ;
if ( F_69 ( V_2 -> V_111 . V_144 ) ) {
F_15 ( V_2 ,
L_29 ,
F_70 ( V_2 -> V_111 . V_144 ) ) ;
V_2 -> V_111 . V_144 = NULL ;
return;
}
}
...
{
if ( ! F_75 ( V_2 ) || ! V_2 -> V_111 . V_144 )
return;
F_15 ( V_2 , L_31 ) ;
if ( V_2 -> V_111 . V_144 ) {
F_80 ( V_2 -> V_111 . V_144 ) ;
V_2 -> V_111 . V_144 = NULL ;
}
}
void F_81 ( struct V_1 * V_2 , T_1 V_86 )
{
struct V_3 * V_4 = & V_2 -> V_5 ;
F_15 ( V_2 , L_32 ) ;
if ( V_2 -> V_148 -> V_149 )
V_4 -> V_7 = * V_2 -> V_148 -> V_149 ;
else
V_4 -> V_7 = V_150 ;
V_4 -> V_11 = false ;
V_4 -> V_12 = false ;
