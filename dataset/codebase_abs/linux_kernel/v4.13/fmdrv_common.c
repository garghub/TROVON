...
int F_33 ( struct V_1 * V_1 , T_1 V_49 , T_2 type , void * V_50 ,
...
static inline void F_40 ( struct V_1 * V_1 , T_1 V_4 )
{
struct V_8 * V_9 ;
if ( ! F_38 ( V_1 , & V_9 ) )
F_2 ( V_1 , V_4 ) ;
}
static void F_41 ( unsigned long V_15 )
{
struct V_1 * V_1 ;
struct V_34 * V_68 ;
F_42 ( L_27 ) ;
...
V_1 -> V_2 . V_39 = F_45 ( ( V_75 V_59 ) V_1 -> V_2 . V_39 ) ;
F_42 ( L_29 , V_1 -> V_2 . V_39 ) ;
F_2 ( V_1 , V_76 ) ;
}
...
static void F_49 ( struct V_1 * V_1 , T_1 V_86 )
{
...
F_42 ( L_40 ) ;
F_50 ( V_1 , & V_110 ) ;
V_119 = F_45 ( ( V_75 V_59 ) V_110 . V_15 . V_125 . V_126 ) ;
...
if ( V_113 == V_129 ) {
F_49 ( V_1 , V_110 . V_15 . V_130 . V_86 [ 0 ] ) ;
F_49 ( V_1 , V_110 . V_15 . V_130 . V_86 [ 1 ] ) ;
}
}
V_120 -= V_117 ;
V_114 += V_117 ;
...
T_2 V_158 ;
T_2 V_50 ;
F_42 ( L_49 , V_1 -> V_30 . V_88 . V_102 [ V_1 -> V_30 . V_148 ] ) ;
...
struct V_178 * V_179 )
{
F_77 ( V_177 , & V_1 -> V_30 . V_112 . V_135 , V_179 ) ;
if ( V_1 -> V_30 . V_112 . V_134 != V_1 -> V_30 . V_112 . V_132 )
return 0 ;
return - V_180 ;
}
int F_78 ( struct V_1 * V_1 , struct V_177 * V_177 ,
...
return - V_186 ;
V_62 = F_79 ( V_1 -> V_30 . V_112 . V_135 ,
...
int F_81 ( struct V_1 * V_1 , T_3 V_188 )
{
switch ( V_1 -> V_189 ) {
case V_190 :
return F_82 ( V_1 , V_188 ) ;
case V_191 :
return F_83 ( V_1 , V_188 ) ;
default:
return - V_54 ;
}
}
int F_84 ( struct V_1 * V_1 , T_3 * V_192 )
{
...
int F_85 ( struct V_1 * V_1 , T_1 V_29 )
{
switch ( V_1 -> V_189 ) {
case V_190 :
return F_86 ( V_1 , V_29 ) ;
case V_191 :
return F_87 ( V_1 , V_29 ) ;
default:
return - V_54 ;
}
}
int F_88 ( struct V_1 * V_1 , T_1 V_194 )
{
switch ( V_1 -> V_189 ) {
case V_190 :
...
int F_91 ( struct V_1 * V_1 , T_2 V_195 )
{
switch ( V_1 -> V_189 ) {
case V_190 :
...
int F_94 ( struct V_1 * V_1 , T_1 V_196 )
{
switch ( V_1 -> V_189 ) {
case V_190 :
return F_95 ( V_1 , V_196 ) ;
case V_191 :
return F_96 ( V_1 , V_196 ) ;
default:
return - V_54 ;
}
}
...
V_50 = 0x0 ;
V_62 = F_33 ( V_1 , V_199 , V_152 , & V_50 ,
sizeof( V_50 ) , NULL , NULL ) ;
if ( V_62 < 0 )
return V_62 ;
return F_98 ( V_1 ) ;
}
static int F_99 ( struct V_1 * V_1 , const T_1 * V_200 )
{
...
V_211 = 0 ;
F_16 ( V_55 , & V_1 -> V_39 ) ;
V_62 = F_100 ( & V_202 , V_200 ,
& V_1 -> V_212 -> V_213 ) ;
if ( V_62 < 0 ) {
F_13 ( L_57 , V_200 ) ;
return V_62 ;
}
F_42 ( L_58 , V_200 , V_202 -> V_53 ) ;
...
{
int V_62 ;
V_62 = F_104 ( V_1 , V_220 ) ;
if ( V_62 < 0 )
return V_62 ;
return F_105 ( V_1 , V_221 ) ;
}
static int F_106 ( struct V_1 * V_1 , T_1 V_195 )
{
T_2 V_50 ;
V_59 V_222 , V_223 ;
int V_224 , V_62 ;
...
V_50 = V_226 ;
if ( F_33 ( V_1 , V_199 , V_152 , & V_50 ,
sizeof( V_50 ) , NULL , NULL ) )
goto V_227;
F_108 ( 20 ) ;
if ( F_33 ( V_1 , V_228 , V_73 , NULL ,
sizeof( V_222 ) , & V_222 , & V_224 ) )
goto V_227;
if ( F_33 ( V_1 , V_229 , V_73 , NULL ,
sizeof( V_223 ) , & V_223 , & V_224 ) )
goto V_227;
F_42 ( L_64 ,
F_45 ( V_222 ) , F_45 ( V_223 ) ) ;
...
int F_110 ( struct V_1 * V_1 , T_1 * V_234 )
{
if ( ! F_15 ( V_197 , & V_1 -> V_39 ) ) {
F_13 ( L_55 ) ;
return - V_193 ;
...
static long F_111 ( void * V_33 , struct V_8 * V_9 )
{
struct V_1 * V_1 ;
V_1 = (struct V_1 * ) V_33 ;
if ( V_9 == NULL ) {
...
memcpy ( F_112 ( V_9 , 1 ) , & V_9 -> V_235 [ 0 ] , 1 ) ;
F_32 ( & V_1 -> V_36 , V_9 ) ;
F_23 ( & V_1 -> V_236 ) ;
return 0 ;
}
static void F_113 ( void * V_33 , int V_15 )
{
struct V_1 * V_1 ;
V_1 = (struct V_1 * ) V_33 ;
V_1 -> V_237 = V_15 ;
...
F_116 ( & V_1 -> V_43 ) ;
F_117 ( & V_1 -> V_46 ) ;
F_118 ( & V_1 -> V_47 , F_24 , ( unsigned long ) V_1 ) ;
F_117 ( & V_1 -> V_36 ) ;
F_118 ( & V_1 -> V_236 , F_11 , ( unsigned long ) V_1 ) ;
V_1 -> V_2 . V_4 = 0 ;
F_20 ( & V_1 -> V_45 , 1 ) ;
V_1 -> V_42 = NULL ;
F_119 ( & V_1 -> V_2 . V_5 , & F_41 ,
( unsigned long ) V_1 ) ;
V_1 -> V_2 . V_78 = V_77 ;
...
V_1 -> V_2 . V_69 = 0 ;
F_72 ( V_1 ) ;
F_120 ( & V_1 -> V_30 . V_112 . V_135 ) ;
F_121 ( V_1 ) ;
F_16 ( V_197 , & V_1 -> V_39 ) ;
return V_62 ;
}
int F_98 ( struct V_1 * V_1 )
{
static struct V_239 V_240 ;
int V_62 ;
if ( ! F_15 ( V_197 , & V_1 -> V_39 ) ) {
...
int V_62 = - V_57 ;
F_42 ( L_85 , V_264 ) ;
V_1 = F_125 ( sizeof( struct V_1 ) , V_265 ) ;
if ( NULL == V_1 ) {
F_13 ( L_86 ) ;
return V_62 ;
}
V_1 -> V_30 . V_112 . V_133 = V_266 * V_117 ;
V_1 -> V_30 . V_112 . V_108 = F_125 ( V_1 -> V_30 . V_112 . V_133 , V_265 ) ;
if ( NULL == V_1 -> V_30 . V_112 . V_108 ) {
F_13 ( L_87 ) ;
goto V_267;
}
V_62 = F_126 ( V_1 , V_268 ) ;
if ( V_62 < 0 )
goto V_269;
V_1 -> V_2 . V_3 = V_270 ;
V_1 -> V_189 = V_198 ;
