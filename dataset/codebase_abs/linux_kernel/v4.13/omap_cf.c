...
if ( ! V_5 )
return - V_57 ;
F_19 ( & V_5 -> V_11 , F_2 , ( unsigned long ) V_5 ) ;
V_5 -> V_50 = V_50 ;
F_20 ( V_50 , V_5 ) ;
V_52 = F_21 ( V_14 , F_7 , V_58 ,
V_7 , V_5 ) ;
if ( V_52 < 0 )
goto V_59;
V_5 -> V_14 = V_14 ;
...
V_5 -> V_63 . V_40 = V_5 -> V_41 ;
V_5 -> V_63 . V_64 = V_5 -> V_63 . V_64 + V_65 - 1 ;
V_5 -> V_63 . V_28 = V_66 ;
V_5 -> V_8 . V_67 = ( unsigned long )
F_23 ( V_5 -> V_41 + V_42 , V_44 ) ;
if ( ! V_5 -> V_8 . V_67 )
goto V_62;
if ( ! F_24 ( V_5 -> V_41 , V_65 , V_7 ) )
goto V_62;
F_25 ( V_68 ) ;
F_25 ( V_69 ) ;
F_25 ( V_70 ) ;
...
F_3 () ? L_2 : L_9 ) ;
V_5 -> V_8 . V_75 = V_76 ;
V_5 -> V_8 . V_53 . V_77 = & V_50 -> V_53 ;
V_5 -> V_8 . V_78 = & V_79 ;
V_5 -> V_8 . V_80 = & V_81 ;
V_5 -> V_8 . V_82 = V_83 | V_84
| V_85 ;
V_5 -> V_8 . V_86 = V_44 ;
V_5 -> V_8 . V_36 [ 0 ] . V_87 = & V_5 -> V_63 ;
V_52 = F_31 ( & V_5 -> V_8 ) ;
if ( V_52 < 0 )
goto V_88;
V_5 -> V_10 = 1 ;
