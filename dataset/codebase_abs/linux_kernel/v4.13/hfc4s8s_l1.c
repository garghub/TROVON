...
F_51 ( & V_51 -> V_28 ) ;
V_51 -> V_8 = V_8 ;
F_52 ( & V_51 -> V_40 , ( void * ) F_29 ,
( long ) ( V_51 ) ) ;
V_51 -> V_33 = V_149 ;
F_53 ( & V_51 -> V_29 ) ;
V_51 -> V_43 . V_20 . V_21 = V_8 -> V_19 + V_149 ;
V_51 -> V_43 . V_20 . V_170 = ( void * ) F_18 ;
F_51 ( & V_51 -> V_115 [ 0 ] . V_28 ) ;
V_51 -> V_115 [ 0 ] . V_67 . V_20 . V_170 = ( void * ) F_27 ;
...
V_51 -> V_115 [ 1 ] . V_67 . V_20 . V_170 = ( void * ) F_27 ;
...
F_49 ( V_8 ) ;
F_41 ( V_8 ) ;
V_149 = F_9 ( V_8 , V_171 ) >> V_172 ;
if ( V_149 != V_8 -> V_111 . V_173 ) {
F_26 ( V_46
L_10 ,
V_149 , V_8 -> V_111 . V_173 ) ;
goto V_174;
}
V_149 = F_9 ( V_8 , V_175 ) & 0xf ;
if ( ! V_149 ) {
F_26 ( V_46
L_11 ) ;
goto V_174;
...
F_54 ( & V_8 -> V_34 , F_36 ) ;
if ( F_55
( V_8 -> V_176 , F_40 , V_177 , V_8 -> V_178 , V_8 ) ) {
F_26 ( V_46
L_12 ,
V_8 -> V_176 ) ;
goto V_174;
...
static int
F_57 ( struct V_179 * V_164 , const struct V_180 * V_181 )
{
int V_167 = - V_182 ;
T_6 * V_111 = ( T_6 * ) V_181 -> V_111 ;
T_1 * V_8 ;
if ( ! ( V_8 = F_58 ( sizeof( T_1 ) , V_183 ) ) ) {
F_26 ( V_93 L_14 ) ;
return ( V_167 ) ;
}
V_8 -> V_164 = V_164 ;
...
goto V_174;
V_8 -> V_110 = V_184 ;
sprintf ( V_8 -> V_178 , L_15 , V_8 -> V_110 ) ;
F_26 ( V_46 L_16 ,
V_111 -> V_185 , V_8 -> V_178 , F_60 ( V_164 ) ) ;
F_51 ( & V_8 -> V_28 ) ;
V_8 -> V_111 = * V_111 ;
V_8 -> V_176 = V_164 -> V_176 ;
V_8 -> V_3 = F_61 ( V_164 , 0 ) ;
if ( ! F_62 ( V_8 -> V_3 , 8 , V_8 -> V_178 ) ) {
F_26 ( V_46
L_17 ,
V_8 -> V_3 ) ;
V_167 = - V_186 ;
