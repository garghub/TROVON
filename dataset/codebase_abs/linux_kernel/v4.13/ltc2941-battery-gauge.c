...
V_2 -> V_12 = ( unsigned long ) F_37 ( & V_8 -> V_22 ) ;
V_2 -> V_72 . V_73 = V_68 -> V_73 ;
V_13 = F_38 ( V_68 , L_6 , & V_42 ) ;
if ( V_13 < 0 ) {
F_5 ( & V_8 -> V_22 ,
L_7 ) ;
return V_13 ;
...
V_2 -> V_58 = F_42 ( & V_8 -> V_22 , & V_2 -> V_72 ,
& V_66 ) ;
if ( F_43 ( V_2 -> V_58 ) ) {
F_5 ( & V_8 -> V_22 , L_11 ) ;
...
static int F_45 ( struct V_88 * V_22 )
{
...
static int F_47 ( struct V_88 * V_22 )
{
struct V_7 * V_8 = F_46 ( V_22 ) ;
struct V_1 * V_2 = F_30 ( V_8 ) ;
F_28 ( & V_2 -> V_60 , V_61 * V_62 ) ;
