...
return;
F_24 ( V_35 ) ;
V_33 = F_25 ( V_35 , L_1 , NULL ) ;
if ( V_33 )
strncpy ( V_36 , V_33 ,
sizeof( V_36 ) ) ;
V_34 = F_25 ( V_35 , L_2 , NULL ) ;
if ( V_34 )
V_37 = F_26 ( V_34 , 1 ) ;
F_27 ( V_35 ) ;
}
...
int V_48 ;
struct V_12 * V_13 = F_3 ( V_4 -> V_5 ) ;
V_9 -> V_19 = (struct V_21 * ) F_34 ( V_49 ) ;
if ( ! V_9 -> V_19 )
goto V_50;
V_9 -> V_18 = V_45 / sizeof( * V_9 -> V_19 ) ;
V_9 -> V_17 = F_35 ( V_4 -> V_5 , V_9 -> V_19 ,
V_9 -> V_18 * sizeof( * V_9 -> V_19 ) ,
V_20 ) ;
if ( F_36 ( V_4 -> V_5 , V_9 -> V_17 ) )
goto V_51;
F_23 () ;
F_28 ( V_4 ) ;
V_48 = V_11 = F_9 ( V_46 ,
...
F_32 ( V_4 -> V_5 , L_6 , V_11 ) ;
goto V_53;
}
V_9 -> V_25 = 0 ;
F_37 ( & V_9 -> V_24 ) ;
F_38 ( & V_4 -> V_6 , ( void * ) F_19 ,
( unsigned long ) V_4 ) ;
if ( F_39 ( V_13 -> V_1 ,
F_1 ,
0 , L_7 , ( void * ) V_4 ) != 0 ) {
...
V_58 -> V_18 = V_18 ;
V_58 -> V_60 = 0 ;
V_58 -> V_61 = F_43 ( V_58 -> V_18 , sizeof( * V_58 -> V_61 ) , V_49 ) ;
if ( ! V_58 -> V_61 )
return - V_62 ;
V_58 -> V_63 =
F_44 ( V_4 -> V_5 ,
...
F_46 ( & V_66 -> free , 1 ) ;
V_66 -> V_22 . V_26 = V_67 ;
V_66 -> V_22 . V_68 = F_47 ( sizeof( * V_66 -> V_69 ) ) ;
V_66 -> V_22 . V_70 = F_48 ( V_58 -> V_64 +
...
static void F_49 ( struct V_57 * V_58 ,
struct V_3 * V_4 )
{
int V_59 , V_73 = 0 ;
for ( V_59 = 0 ; V_59 < V_58 -> V_18 ; ++ V_59 ) {
if ( F_50 ( & V_58 -> V_61 [ V_59 ] . free ) != 1 )
++ V_73 ;
...
{
if ( ! F_52 ( V_58 , V_66 ) ) {
F_40 ( V_66 -> V_4 -> V_5 , L_13
L_14 , V_66 , V_58 -> V_61 ) ;
return;
}
if ( F_54 ( & V_66 -> free ) != 1 ) {
F_40 ( V_66 -> V_4 -> V_5 , L_15
L_16 , V_66 ) ;
return;
}
}
static struct V_65 * F_55 ( struct V_57 * V_58 )
{
int V_59 ;
int V_77 = V_58 -> V_18 ;
int V_78 = V_58 -> V_60 ;
...
static void F_58 ( struct V_65 * V_80 ,
...
static void F_61 ( struct V_88 * V_87 ,
struct V_65 * V_80 ,
struct V_99 * V_5 )
{
T_4 V_100 , V_101 ;
...
static int F_63 ( struct V_86 * V_87 , int V_103 ,
struct V_75 * V_104 )
{
int V_59 ;
struct V_105 * V_106 ;
...
V_108 -> V_109 = F_48 ( F_65 ( V_106 ) ) ;
V_108 -> V_110 = F_30 ( F_66 ( V_106 ) ) ;
V_108 -> V_111 = 0 ;
V_107 += F_66 ( V_106 ) ;
}
return V_107 ;
...
return 0 ;
F_59 ( V_87 , V_88 , V_112 ) ;
if ( V_112 == 1 ) {
F_63 ( V_87 , V_112 , V_31 ) ;
return 1 ;
}
V_115 -> V_116 . V_109 = 0 ;
V_115 -> V_116 . V_110 = F_30 ( V_112 *
sizeof( struct V_75 ) ) ;
V_115 -> V_116 . V_111 = 0 ;
if ( V_112 <= V_93 ) {
V_107 = F_63 ( V_87 , V_112 ,
& V_115 -> V_117 [ 0 ] ) ;
V_115 -> V_110 = F_30 ( V_107 ) ;
return 1 ;
}
if ( ! V_80 -> V_71 ) {
...
V_107 = F_63 ( V_87 , V_112 , V_80 -> V_71 ) ;
V_115 -> V_110 = F_30 ( V_107 ) ;
V_115 -> V_116 . V_109 = F_48 ( V_80 -> V_72 ) ;
V_115 -> V_116 . V_110 = F_30 ( V_112 *
...
return F_67 ( V_87 , V_80 , V_88 , V_5 ) ;
}
static void F_72 ( struct V_3 * V_4 , int V_121 )
{
struct V_65 * V_66 ;
unsigned long V_23 ;
F_14 ( V_4 -> V_122 -> V_123 , V_23 ) ;
while ( ! F_73 ( & V_4 -> V_124 ) ) {
V_66 = F_74 ( & V_4 -> V_124 , struct V_65 , V_125 ) ;
F_75 ( & V_66 -> V_125 ) ;
F_76 ( & V_66 -> V_126 ) ;
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
if ( V_66 -> V_83 ) {
V_66 -> V_83 -> V_127 = ( V_121 << 16 ) ;
F_61 ( & V_66 -> V_128 . V_129 . V_87 , V_66 ,
V_66 -> V_4 -> V_5 ) ;
if ( V_66 -> V_84 )
V_66 -> V_84 ( V_66 -> V_83 ) ;
...
static void F_80 ( struct V_65 * V_80 )
{
...
static int F_81 ( struct V_65 * V_80 ,
struct V_3 * V_4 ,
unsigned long V_82 )
{
...
int V_145 = V_139 ;
struct V_65 * V_146 ;
F_82 (tmp_evt, &hostdata->sent, list) {
V_145 ++ ;
}
if ( V_145 > 2 )
goto V_143;
...
F_83 ( & V_80 -> V_125 , & V_4 -> V_124 ) ;
F_84 ( & V_80 -> V_126 ) ;
if ( V_82 ) {
V_80 -> V_126 . V_31 = ( unsigned long ) V_80 ;
V_80 -> V_126 . V_149 = V_150 + ( V_82 * V_151 ) ;
V_80 -> V_126 . V_152 = ( void (*) ( unsigned long ) ) F_80 ;
F_85 ( & V_80 -> V_126 ) ;
}
V_11 = F_17 ( V_4 , F_86 ( V_138 [ 0 ] ) ,
F_86 ( V_138 [ 1 ] ) ) ;
if ( V_11 != 0 ) {
F_75 ( & V_80 -> V_125 ) ;
F_76 ( & V_80 -> V_126 ) ;
...
return 0 ;
V_143:
F_61 ( & V_80 -> V_128 . V_129 . V_87 , V_80 , V_4 -> V_5 ) ;
F_53 ( & V_4 -> V_58 , V_80 ) ;
if ( V_140 && V_139 != - 1 )
F_87 ( & V_4 -> V_134 ) ;
return V_153 ;
...
F_92 ( V_83 , F_91 ( V_147 -> V_163 ) ) ;
}
if ( V_80 -> V_84 )
V_80 -> V_84 ( V_83 ) ;
}
static inline T_6 F_93 ( struct V_164 * V_5 )
{
return ( 0x2 << 14 ) | ( V_5 -> V_165 << 8 ) | ( V_5 -> V_166 << 5 ) | V_5 -> V_167 ;
}
static int F_94 ( struct V_86 * V_83 ,
void (* V_32) ( struct V_86 * ) )
{
struct V_88 * V_88 ;
struct V_65 * V_80 ;
struct V_114 * V_115 ;
struct V_3 * V_4 = F_95 ( V_83 -> V_99 -> V_122 ) ;
T_6 V_167 = F_93 ( V_83 -> V_99 ) ;
T_4 V_100 , V_101 ;
V_83 -> V_127 = ( V_168 << 16 ) ;
V_80 = F_55 ( & V_4 -> V_58 ) ;
if ( ! V_80 )
...
F_96 ( V_167 , & V_88 -> V_167 ) ;
if ( ! F_71 ( V_83 , V_80 , V_88 , V_4 -> V_5 ) ) {
if ( ! F_69 ( V_118 ) )
F_70 ( V_79 , V_83 -> V_99 ,
L_27 ) ;
F_53 ( & V_4 -> V_58 , V_80 ) ;
...
V_115 -> V_116 . V_109 == 0 ) {
V_115 -> V_116 . V_109 =
F_48 ( F_86 ( V_80 -> V_22 . V_70 ) +
F_97 ( struct V_88 , V_113 ) +
F_97 ( struct V_114 , V_117 ) ) ;
}
return F_81 ( V_80 , V_4 , 0 ) ;
}
...
static void F_99 ( struct V_65 * V_80 )
{
struct V_3 * V_4 = V_80 -> V_4 ;
switch ( V_80 -> V_69 -> V_129 . F_99 . V_132 ) {
case V_176 :
break;
case V_177 :
F_29 ( V_4 -> V_5 , L_28 ,
...
V_4 -> V_180 = 0 ;
F_46 ( & V_4 -> V_134 ,
F_91 ( V_80 -> V_69 -> V_129 . F_99 . V_181 ) ) ;
F_100 ( V_4 -> V_122 ) ;
}
...
unsigned long V_23 ;
struct V_182 * V_183 ;
struct V_65 * V_80 = F_55 ( & V_4 -> V_58 ) ;
F_102 ( ! V_80 ) ;
F_58 ( V_80 , F_99 ,
V_141 , V_184 ) ;
...
V_183 -> V_132 = V_133 ;
V_183 -> V_185 = F_30 ( sizeof( union V_186 ) ) ;
V_183 -> V_187 = F_47 ( V_188 |
V_189 ) ;
F_14 ( V_4 -> V_122 -> V_123 , V_23 ) ;
F_46 ( & V_4 -> V_134 , 0 ) ;
V_11 = F_81 ( V_80 , V_4 , V_184 * 2 ) ;
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
F_29 ( V_4 -> V_5 , L_31 ) ;
return V_11 ;
}
static void F_103 ( struct V_65 * V_80 )
{
struct V_3 * V_4 = V_80 -> V_4 ;
...
V_4 -> V_174 . V_23 = F_30 ( V_204 ) ;
if ( V_4 -> V_180 )
V_4 -> V_174 . V_23 |= F_30 ( V_205 ) ;
strncpy ( V_4 -> V_174 . V_206 , F_105 ( & V_4 -> V_122 -> V_207 ) ,
sizeof( V_4 -> V_174 . V_206 ) ) ;
V_4 -> V_174 . V_206 [ sizeof( V_4 -> V_174 . V_206 ) - 1 ] = '\0' ;
V_202 = F_25 ( V_201 , L_36 , NULL ) ;
V_202 = V_202 ? V_202 : F_105 ( V_4 -> V_5 ) ;
strncpy ( V_4 -> V_174 . V_208 , V_202 , sizeof( V_4 -> V_174 . V_208 ) ) ;
V_4 -> V_174 . V_208 [ sizeof( V_4 -> V_174 . V_208 ) - 1 ] = '\0' ;
V_199 -> V_192 . type = F_30 ( V_209 ) ;
V_199 -> V_210 = F_48 ( V_4 -> V_173 ) ;
V_4 -> V_174 . V_193 . V_192 . V_211 =
F_30 ( V_212 ) ;
V_4 -> V_174 . V_193 . V_192 . V_213 =
F_47 ( sizeof( V_4 -> V_174 . V_193 ) ) ;
V_4 -> V_174 . V_193 . V_192 . V_194 =
F_47 ( V_195 ) ;
V_4 -> V_174 . V_193 . V_214 = F_30 ( 1 ) ;
if ( V_196 ) {
V_4 -> V_174 . V_197 . V_192 . V_211 =
F_30 ( V_215 ) ;
V_4 -> V_174 . V_197 . V_192 . V_213 =
F_47 ( sizeof( V_4 -> V_174 . V_197 ) ) ;
V_4 -> V_174 . V_197 . V_192 . V_194 =
F_47 ( V_195 ) ;
V_4 -> V_174 . V_197 . type =
F_30 ( V_216 ) ;
V_199 -> V_192 . V_213 =
F_47 ( sizeof( V_4 -> V_174 ) ) ;
} else
V_199 -> V_192 . V_213 = F_47 ( sizeof( V_4 -> V_174 ) -
sizeof( V_4 -> V_174 . V_197 ) ) ;
F_14 ( V_4 -> V_122 -> V_123 , V_23 ) ;
if ( F_81 ( V_80 , V_4 , V_203 * 2 ) )
F_40 ( V_4 -> V_5 , L_37 ) ;
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
}
static void F_106 ( struct V_65 * V_80 )
{
struct V_3 * V_4 = V_80 -> V_4 ;
T_6 V_156 = F_107 ( V_80 -> V_69 -> V_190 . V_217 . V_192 . V_156 ) ;
if ( V_156 == V_218 )
F_40 ( V_4 -> V_5 , L_38 ) ;
else if ( V_156 == V_219 )
F_40 ( V_4 -> V_5 , L_39 ) ;
else if ( V_156 != V_220 )
F_40 ( V_4 -> V_5 , L_40 , V_156 ) ;
F_104 ( V_4 ) ;
}
...
V_80 = F_55 ( & V_4 -> V_58 ) ;
F_102 ( ! V_80 ) ;
F_58 ( V_80 , F_106 , V_130 , V_203 ) ;
V_222 = & V_80 -> V_128 . V_190 . V_217 ;
memset ( V_222 , 0 , sizeof( * V_222 ) ) ;
V_222 -> V_192 . type = F_30 ( V_223 ) ;
V_222 -> V_192 . V_213 = F_47 ( sizeof( * V_222 ) ) ;
F_14 ( V_4 -> V_122 -> V_123 , V_23 ) ;
V_11 = F_81 ( V_80 , V_4 , V_203 * 2 ) ;
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
return V_11 ;
}
static void F_109 ( struct V_65 * V_80 )
{
struct V_3 * V_4 = V_80 -> V_4 ;
...
F_91 ( V_4 -> V_38 . V_37 ) ,
F_91 ( V_4 -> V_38 . V_43 ) ,
F_91 ( V_4 -> V_38 . V_225 [ 0 ] ) ) ;
if ( V_4 -> V_38 . V_225 [ 0 ] )
V_4 -> V_122 -> V_226 =
F_91 ( V_4 -> V_38 . V_225 [ 0 ] ) >> 9 ;
if ( F_91 ( V_4 -> V_38 . V_43 ) == V_227 &&
...
V_199 -> V_192 . type = F_30 ( V_230 ) ;
V_199 -> V_192 . V_213 = F_47 ( sizeof( V_4 -> V_38 ) ) ;
V_199 -> V_210 = F_48 ( V_4 -> V_175 ) ;
F_14 ( V_4 -> V_122 -> V_123 , V_23 ) ;
if ( F_81 ( V_80 , V_4 , V_203 * 2 ) )
F_40 ( V_4 -> V_5 , L_47 ) ;
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
...
static void F_112 ( struct V_65 * V_80 )
{
if ( V_80 -> V_85 )
* V_80 -> V_85 = * V_80 -> V_69 ;
F_113 ( & V_80 -> V_231 ) ;
}
static int F_114 ( struct V_86 * V_87 )
{
struct V_3 * V_4 = F_95 ( V_87 -> V_99 -> V_122 ) ;
struct V_232 * V_233 ;
struct V_65 * V_66 ;
...
V_233 -> V_132 = V_144 ;
F_96 ( V_167 , & V_233 -> V_167 ) ;
V_233 -> V_242 = V_243 ;
V_233 -> V_244 = ( T_2 ) V_234 ;
V_66 -> V_85 = & V_154 ;
F_115 ( & V_66 -> V_231 ) ;
V_236 = F_81 ( V_66 , V_4 , V_241 * 2 ) ;
if ( V_236 != V_153 )
break;
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
F_8 ( 10 ) ;
F_14 ( V_4 -> V_122 -> V_123 , V_23 ) ;
} while ( F_116 ( V_150 , V_237 ) );
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
if ( V_236 != 0 ) {
F_70 ( V_79 , V_87 -> V_99 ,
L_49 , V_236 ) ;
...
F_70 ( V_245 , V_87 -> V_99 ,
L_50 ,
( ( ( T_2 ) V_167 ) << 48 ) , ( T_2 ) V_234 ) ;
F_117 ( & V_66 -> V_231 ) ;
if ( F_89 ( V_154 . V_129 . V_147 . V_132 != V_155 ) ) {
if ( F_90 () )
F_70 ( V_246 , V_87 -> V_99 , L_51 ,
...
if ( V_234 == NULL ) {
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
F_70 ( V_245 , V_87 -> V_99 , L_53 ,
V_233 -> V_244 ) ;
return V_239 ;
}
F_70 ( V_245 , V_87 -> V_99 , L_54 ,
V_233 -> V_244 ) ;
V_87 -> V_127 = ( V_248 << 16 ) ;
F_75 ( & V_234 -> V_125 ) ;
F_61 ( & V_234 -> V_128 . V_129 . V_87 , V_234 ,
V_234 -> V_4 -> V_5 ) ;
F_53 ( & V_234 -> V_4 -> V_58 , V_234 ) ;
F_16 ( V_4 -> V_122 -> V_123 , V_23 ) ;
F_87 ( & V_4 -> V_134 ) ;
return V_239 ;
}
static int F_118 ( struct V_86 * V_87 )
{
struct V_3 * V_4 = F_95 ( V_87 -> V_99 -> V_122 ) ;
struct V_232 * V_233 ;
struct V_65 * V_66 ;
...
F_70 ( V_245 , V_87 -> V_99 , L_57 ,
( ( ( T_2 ) V_167 ) << 48 ) ) ;
F_117 ( & V_66 -> V_231 ) ;
if ( F_89 ( V_154 . V_129 . V_147 . V_132 != V_155 ) ) {
if ( F_90 () )
F_70 ( V_246 , V_87 -> V_99 , L_58 ,
V_154 . V_129 . V_147 . V_132 ) ;
return V_240 ;
}
if ( V_154 . V_129 . V_147 . V_23 & V_247 )
...
F_14 ( V_4 -> V_122 -> V_123 , V_23 ) ;
F_119 (tmp_evt, pos, &hostdata->sent, list) {
if ( ( V_146 -> V_83 ) && ( V_146 -> V_83 -> V_99 == V_87 -> V_99 ) ) {
if ( V_146 -> V_83 )
V_146 -> V_83 -> V_127 = ( V_252 << 16 ) ;
F_75 ( & V_146 -> V_125 ) ;
F_61 ( & V_146 -> V_128 . V_129 . V_87 , V_146 ,
V_146 -> V_4 -> V_5 ) ;
F_53 ( & V_146 -> V_4 -> V_58 ,
V_146 ) ;
F_87 ( & V_4 -> V_134 ) ;
...
static int F_120 ( struct V_86 * V_87 )
{
unsigned long V_237 = 0 ;
struct V_3 * V_4 = F_95 ( V_87 -> V_99 -> V_122 ) ;
F_40 ( V_4 -> V_5 , L_60 ) ;
...
if ( V_22 -> V_81 == V_141 )
F_121 ( F_91 ( V_80 -> V_69 -> V_129 . V_147 . V_181 ) ,
& V_4 -> V_134 ) ;
F_76 ( & V_80 -> V_126 ) ;
...
F_75 ( & V_80 -> V_125 ) ;
F_53 ( & V_80 -> V_4 -> V_58 , V_80 ) ;
F_16 ( V_80 -> V_4 -> V_122 -> V_123 , V_23 ) ;
}
static int F_122 ( struct V_164 * V_262 )
{
...
if ( V_262 -> type == V_266 ) {
V_262 -> V_267 = 1 ;
F_123 ( V_262 -> V_268 , 120 * V_151 ) ;
}
F_16 ( V_264 -> V_123 , V_265 ) ;
return 0 ;
}
static int F_124 ( struct V_164 * V_262 , int V_269 )
{
if ( V_269 > V_270 )
V_269 = V_270 ;
return F_125 ( V_262 , V_269 ) ;
}
static T_7 F_126 ( struct V_99 * V_5 ,
struct V_271 * V_272 , char * V_273 )
{
struct V_263 * V_264 = F_127 ( V_5 ) ;
struct V_3 * V_4 = F_95 ( V_264 ) ;
int V_110 ;
...
static T_7 F_134 ( struct V_99 * V_5 ,
struct V_271 * V_272 , char * V_273 )
{
return 0 ;
}
...
static int F_140 ( void * V_31 )
{
struct V_3 * V_4 = V_31 ;
int V_11 ;
F_141 ( V_279 , V_280 ) ;
while ( 1 ) {
V_11 = F_142 ( V_4 -> V_137 ,
F_138 ( V_4 ) ) ;
F_102 ( V_11 ) ;
if ( F_139 () )
break;
...
static int F_143 ( struct V_12 * V_13 , const struct V_281 * V_165 )
{
struct V_3 * V_4 ;
struct V_263 * V_122 ;
...
V_4 -> V_291 = F_149 ( F_140 , V_4 , L_78 ,
L_7 , V_122 -> V_292 ) ;
if ( F_150 ( V_4 -> V_291 ) ) {
F_40 ( & V_13 -> V_5 , L_79 ,
F_151 ( V_4 -> V_291 ) ) ;
...
V_11 = F_33 ( & V_4 -> V_9 , V_4 , V_275 ) ;
if ( V_11 != 0 && V_11 != V_52 ) {
F_40 ( & V_13 -> V_5 , L_80 , V_11 ) ;
goto V_294;
}
if ( F_42 ( & V_4 -> V_58 , V_275 , V_4 ) != 0 ) {
F_40 ( & V_13 -> V_5 , L_81 ) ;
goto V_295;
}
V_122 -> V_296 = V_297 ;
...
if ( F_152 ( V_4 -> V_122 , V_4 -> V_5 ) )
goto V_301;
memcpy ( V_283 . V_302 , V_4 -> V_38 . V_36 ,
sizeof( V_283 . V_302 ) ) ;
V_283 . V_303 = V_304 ;
V_285 = F_153 ( V_122 , & V_283 ) ;
if ( F_150 ( V_285 ) )
goto V_305;
...
static int F_161 ( struct V_99 * V_5 )
{
