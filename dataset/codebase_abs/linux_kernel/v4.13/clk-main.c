...
static void T_2 F_15 ( struct V_30 * V_31 )
{
struct V_5 * V_6 ;
const char * V_15 = V_31 -> V_15 ;
const char * V_16 ;
struct V_1 * V_1 ;
bool V_17 ;
F_16 ( V_31 , L_1 , & V_15 ) ;
