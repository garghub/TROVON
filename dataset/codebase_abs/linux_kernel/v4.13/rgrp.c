...
if ( ! V_76 )
return - V_48 ;
V_22 -> V_78 = F_63 ( V_76 , sizeof( struct V_9 ) , V_115 ) ;
if ( ! V_22 -> V_78 )
return - V_116 ;
V_114 = V_22 -> V_113 ;
...
struct V_90 * V_91 = F_65 ( V_121 ) ;
char V_40 [ sizeof( struct V_123 ) ] ;
int error , V_124 ;
for ( V_124 = 0 ; ; V_124 ++ ) {
T_6 V_125 = V_124 * sizeof( struct V_123 ) ;
if ( V_125 + sizeof( struct V_123 ) > F_66 ( V_121 ) )
break;
error = F_67 ( V_91 , V_40 , & V_125 ,
sizeof( struct V_123 ) ) ;
if ( error != sizeof( struct V_123 ) )
break;
V_120 += F_68 ( ( (struct V_123 * ) V_40 ) -> V_126 ) ;
}
return V_120 ;
}
...
F_70 ( & V_22 -> V_87 , V_128 , V_127 ) ;
F_71 ( & V_22 -> V_87 , & V_75 -> V_86 ) ;
V_75 -> V_130 ++ ;
return 0 ;
}
...
int error ;
struct V_69 * V_22 ;
if ( V_125 >= F_66 ( & V_91 -> V_92 ) )
return 1 ;
error = F_67 ( V_91 , ( char * ) & V_40 , & V_125 ,
sizeof( struct V_123 ) ) ;
if ( error != sizeof( struct V_123 ) )
return ( error == 0 ) ? 1 : error ;
V_22 = F_73 ( V_112 , V_115 ) ;
error = - V_116 ;
if ( ! V_22 )
return error ;
V_22 -> V_55 = V_75 ;
V_22 -> V_23 = F_74 ( V_40 . V_132 ) ;
V_22 -> V_57 = F_68 ( V_40 . V_133 ) ;
V_22 -> V_46 = F_74 ( V_40 . V_134 ) ;
V_22 -> V_49 = F_68 ( V_40 . V_126 ) ;
V_22 -> V_113 = F_68 ( V_40 . V_135 ) ;
F_75 ( & V_22 -> V_105 ) ;
error = F_62 ( V_22 ) ;
if ( error )
goto V_136;
...
{
struct V_90 * V_91 = F_65 ( V_75 -> V_122 ) ;
...
T_4 V_161 ;
V_161 = F_68 ( V_160 -> V_161 ) ;
V_161 &= ~ V_162 ;
V_22 -> V_143 &= V_162 ;
V_22 -> V_143 |= V_161 ;
V_22 -> V_79 = F_68 ( V_160 -> V_163 ) ;
V_22 -> V_80 = F_68 ( V_160 -> V_164 ) ;
V_22 -> V_165 = F_74 ( V_160 -> V_166 ) ;
}
...
{
struct V_140 * V_169 = V_22 -> V_139 ;
T_4 V_177 = F_68 ( V_169 -> V_178 ) + V_176 ;
...
if ( F_86 ( V_175 ) != V_22 -> V_139 -> V_174 )
return F_94 ( V_22 ) ;
V_170 = F_68 ( V_22 -> V_139 -> V_170 ) ;
V_170 &= ~ V_162 ;
V_22 -> V_143 &= V_162 ;
V_22 -> V_143 |= ( V_170 | V_144 | V_183 ) ;
if ( V_22 -> V_139 -> V_178 == 0 )
V_22 -> V_143 &= ~ V_183 ;
V_22 -> V_79 = F_68 ( V_22 -> V_139 -> V_171 ) ;
V_22 -> V_184 = V_22 -> V_79 ;
V_22 -> V_80 = F_68 ( V_22 -> V_139 -> V_172 ) ;
V_22 -> V_165 = F_74 ( V_22 -> V_139 -> V_173 ) ;
return 0 ;
}
...
F_70 ( & V_36 -> V_99 , V_128 , V_127 ) ;
F_71 ( & V_36 -> V_99 , & V_22 -> V_100 ) ;
...
continue;
* V_260 = V_44 ;
error = F_76 ( V_75 , V_44 , & V_265 , V_138 , & V_110 ) ;
if ( error )
continue;
V_91 = V_110 -> V_189 ;
...
continue;
V_269 ++ ;
if ( V_91 == F_65 ( V_75 -> V_122 ) && ! V_75 -> V_154 ) {
error = F_79 ( V_91 ) ;
if ( error )
return error ;
}
...
V_31 = F_63 ( V_347 , sizeof( struct V_69 * ) ,
V_115 | V_321 ) ;
if ( V_346 -> V_350 ) {
