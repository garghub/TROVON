...
F_31 ( V_4 , V_101 , & V_87 ) ;
F_6 ( V_56 L_23 ,
V_89 , V_2 -> V_82 , V_2 -> V_100 , V_4 -> V_102 -> V_103 ,
F_32 ( V_4 -> V_104 ) , F_33 ( V_4 -> V_104 ) ) ;
F_6 ( L_24 ,
V_2 -> V_49 , V_87 , V_2 -> V_98 ) ;
#ifdef F_34
V_2 -> V_105 = ( unsigned char * ) V_2 -> V_98 ;
#else
V_2 -> V_105 = F_35 ( V_2 -> V_98 , 0x1000 ) ;
#endif
F_12 ( 0 , V_106 ) ;
V_86 = F_36 ( V_2 -> V_49 , F_17 ,
V_107 , L_22 , ( void * ) V_2 ) ;
if ( V_86 == - V_17 ) {
F_6 ( V_16 L_25 ,
V_89 ) ;
...
static void F_42 ( struct V_84 * V_84 )
{
T_3 V_110 ;
...
F_12 ( 0 , V_42 ) ;
F_12 ( ~ 0U , V_46 ) ;
F_31 ( V_2 -> V_4 , V_111 , & V_110 ) ;
V_110 &= ~ V_112 ;
F_44 ( V_2 -> V_4 , V_111 , V_110 ) ;
F_39 ( V_2 -> V_49 , V_2 ) ;
F_6 ( V_113 L_29 , V_2 -> V_105 ) ;
if ( V_2 -> V_105 )
F_45 ( V_2 -> V_105 ) ;
F_40 ( F_28 ( V_2 -> V_4 , 0 ) ,
F_30 ( V_2 -> V_4 , 0 ) ) ;
