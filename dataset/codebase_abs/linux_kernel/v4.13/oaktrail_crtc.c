...
struct V_8 * V_9 = V_7 -> V_10 ;
struct V_42 * V_42 = F_10 ( V_3 ) ;
struct V_79 * V_139 = V_3 -> V_140 -> V_139 ;
struct V_141 * V_142 = F_29 ( V_139 ) ;
int V_43 = V_42 -> V_43 ;
const struct V_44 * V_45 = & V_9 -> V_46 [ V_43 ] ;
...
if ( ! F_12 ( V_7 , true ) )
return 0 ;
V_143 = V_142 -> V_146 -> V_144 ;
V_144 = V_78 * V_139 -> V_147 [ 0 ] + V_77 * V_139 -> V_148 -> V_149 [ 0 ] ;
F_19 ( V_45 -> V_150 , V_139 -> V_147 [ 0 ] ) ;
V_82 = F_17 ( V_45 -> V_58 ) ;
V_82 &= ~ V_151 ;
switch ( V_139 -> V_148 -> V_149 [ 0 ] * 8 ) {
case 8 :
V_82 |= V_152 ;
break;
case 16 :
if ( V_139 -> V_148 -> V_153 == 15 )
V_82 |= V_154 ;
else
V_82 |= V_155 ;
break;
