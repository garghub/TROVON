...
V_2 -> V_4 = V_7 ;
V_26:
V_18 = (struct V_17 * ) V_7 -> V_24 -> V_28 ;
V_7 -> V_19 = 1 ;
V_7 -> V_40 = 0 ;
V_7 -> V_21 = 0 ;
V_7 -> V_41 = 0 ;
...
F_13 ( V_7 -> V_24 , sizeof( * V_18 ) ) ;
V_7 -> V_50 . V_51 = NULL ;
if ( V_7 -> V_22 + sizeof( * V_18 ) < F_23 ( V_7 -> V_24 ) ) {
V_7 -> V_19 = 0 ;
...
void F_27 ( struct V_1 * V_10 , T_1 V_52 )
{
F_3 ( & V_10 -> V_5 , V_52 ) ;
}
