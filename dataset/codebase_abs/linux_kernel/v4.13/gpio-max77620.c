...
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_33 * V_34 = F_15 ( V_5 -> V_10 -> V_35 ) ;
return F_16 ( V_34 -> V_36 , V_3 ) ;
}
static int F_17 ( struct V_37 * V_38 )
{
struct V_33 * V_34 = F_15 ( V_38 -> V_10 . V_35 ) ;
struct V_4 * V_5 ;
int V_39 ;
int V_6 ;
V_39 = F_18 ( V_38 , 0 ) ;
...
V_5 = F_19 ( & V_38 -> V_10 , sizeof( * V_5 ) , V_41 ) ;
if ( ! V_5 )
return - V_42 ;
V_5 -> V_7 = V_34 -> V_7 ;
V_5 -> V_10 = & V_38 -> V_10 ;
...
V_5 -> V_1 . V_54 = - 1 ;
#ifdef F_20
V_5 -> V_1 . V_55 = V_38 -> V_10 . V_35 -> V_55 ;
#endif
F_21 ( V_38 , V_5 ) ;
V_6 = F_22 ( & V_38 -> V_10 , & V_5 -> V_1 , V_5 ) ;
if ( V_6 < 0 ) {
F_5 ( & V_38 -> V_10 , L_8 ) ;
return V_6 ;
}
V_6 = F_23 ( & V_38 -> V_10 , V_34 -> V_7 , V_39 ,
V_56 , - 1 ,
& V_57 ,
& V_34 -> V_36 ) ;
if ( V_6 < 0 ) {
