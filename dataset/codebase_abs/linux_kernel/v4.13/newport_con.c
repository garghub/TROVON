...
static bool F_44 ( struct V_97 * V_98 , unsigned int V_148 , unsigned int V_149 ,
enum V_150 V_151 , unsigned int V_152 )
{
...
if ( V_151 == V_157 ) {
V_17 = ( V_17 + ( V_152 << 4 ) ) & 0x3ff ;
F_11 ( V_98 -> V_103 - V_152 ,
V_98 -> V_103 - 1 ,
( V_98 -> V_108 & 0xf0 ) >> 4 ) ;
} else {
V_17 = ( V_17 + ( - V_152 << 4 ) ) & 0x3ff ;
...
V_117 = ( V_149 - V_148 - V_152 ) * V_98 -> V_102 ;
if ( V_151 == V_157 ) {
V_153 = 0 ;
V_154 = V_148 ;
V_116 = ( unsigned short * ) ( V_98 -> V_158 +
V_98 -> V_159 * ( V_148 + V_152 ) ) ;
...
V_155 = ( unsigned short * ) ( V_98 -> V_158 +
V_98 -> V_159 * ( V_149 - V_152 ) ) ;
V_153 = 0 ;
V_154 = V_149 - V_152 ;
for ( V_117 = 0 ; V_117 < ( V_152 * V_98 -> V_102 ) ; V_117 ++ ) {
if ( F_32 ( V_155 ) != V_98 -> V_160 ) {
F_29 ( V_98 , V_98 -> V_160 ,
V_154 , V_153 ) ;
F_45 ( V_98 -> V_160 , V_155 ) ;
}
V_155 ++ ;
if ( ++ V_153 == V_98 -> V_102 ) {
V_153 = 0 ;
...
if ( V_6 )
return - V_169 ;
V_165 = V_162 -> V_167 . V_168 + 0xF0000 ;
if ( ! F_48 ( V_165 , 0x10000 , L_4 ) )
return - V_170 ;
V_6 = (struct V_171 * )
F_49 ( V_165 , sizeof( struct V_171 ) ) ;
F_50 () ;
V_166 = F_51 ( & V_105 , 0 , V_86 - 1 , 1 ) ;
F_52 () ;
return V_166 ;
}
static void F_53 ( struct V_161 * V_162 )
{
F_54 ( & V_105 ) ;
F_55 ( ( void * ) V_6 ) ;
}
