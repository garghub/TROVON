...
if ( V_77 )
return V_77 ;
return F_116 ( V_242 , V_244 , V_280 , V_197 , V_255 ) ;
}
...
int V_283 ;
int V_150 ;
V_250 = F_140 ( V_273 , V_274 , L_25 , & V_283 ) ;
if ( ! V_250 ) {
F_149 ( L_26 ) ;
return - V_104 ;
}
V_244 -> V_248 = V_283 / sizeof( T_2 ) ;
V_244 -> V_249 = F_85 ( ( sizeof( struct V_284 ) *
V_244 -> V_248 ) ,
V_198 ) ;
if ( ! V_244 -> V_249 )
return - V_182 ;
for ( V_150 = 0 ; V_150 < V_244 -> V_248 ; V_150 ++ ) {
struct V_284 * V_285 = & V_244 -> V_249 [ V_150 ] ;
V_285 -> V_247 = V_150 + 1 ;
V_285 -> V_250 = V_250 [ V_150 ] ;
}
return 0 ;
}
...
T_2 V_274 ;
V_287 = F_115 ( V_242 -> V_242 . V_251 , L_27 , NULL ) ;
if ( ! V_287 )
return - V_104 ;
...
if ( ! V_201 || strcmp ( V_201 , V_286 ) )
continue;
V_288 = F_140 ( V_273 , V_274 , L_30 , NULL ) ;
...
static struct V_298 * F_157 ( void )
{
struct V_298 * V_299 = F_85 ( sizeof( struct V_298 ) , V_198 ) ;
if ( V_299 )
F_82 ( & V_299 -> V_300 ) ;
return V_299 ;
}
static void F_158 ( struct V_298 * V_299 )
{
if ( V_299 -> V_301 . V_249 ) {
F_91 ( V_299 -> V_301 . V_249 ) ;
V_299 -> V_301 . V_249 = NULL ;
}
F_91 ( V_299 ) ;
}
...
V_273 = F_161 () ;
if ( ! V_273 ) {
F_141 ( & V_242 -> V_242 , L_36 ,
V_279 ) ;
V_77 = - V_104 ;
goto V_305;
}
V_77 = F_150 ( V_273 , V_242 , & V_299 -> V_301 , L_37 ) ;
if ( V_77 ) {
F_141 ( & V_242 -> V_242 , L_38 ,
V_279 ) ;
F_162 ( V_273 ) ;
goto V_305;
}
V_77 = F_146 ( V_273 , V_242 , & V_299 -> V_301 , & V_299 -> V_300 ,
L_39 , V_261 , F_3 ,
V_106 ) ;
F_162 ( V_273 ) ;
if ( V_77 ) {
...
V_77 = F_110 () ;
if ( V_77 ) {
F_141 ( & V_242 -> V_242 , L_41 ,
V_279 ) ;
goto V_306;
}
F_163 ( & V_242 -> V_242 , V_299 ) ;
return 0 ;
V_306:
F_134 ( & V_299 -> V_300 ) ;
V_305:
...
{
struct V_298 * V_299 = F_165 ( & V_242 -> V_242 ) ;
F_113 () ;
F_134 ( & V_299 -> V_300 ) ;
F_156 () ;
F_158 ( V_299 ) ;
...
static struct V_307 * F_166 ( void )
{
struct V_307 * V_308 = F_85 ( sizeof( struct V_307 ) , V_198 ) ;
if ( V_308 )
F_82 ( & V_308 -> V_309 ) ;
return V_308 ;
}
...
{
if ( V_308 -> V_310 . V_249 ) {
F_91 ( V_308 -> V_310 . V_249 ) ;
V_308 -> V_310 . V_249 = NULL ;
}
F_91 ( V_308 ) ;
}
...
V_77 = F_150 ( V_273 , V_242 , & V_308 -> V_310 , L_44 ) ;
if ( V_77 ) {
F_141 ( & V_242 -> V_242 , L_38 ,
V_279 ) ;
F_162 ( V_273 ) ;
...
V_77 = F_146 ( V_273 , V_242 , & V_308 -> V_310 , & V_308 -> V_309 ,
L_45 , V_5 , F_10 ,
V_296 ) ;
F_162 ( V_273 ) ;
if ( V_77 ) {
F_141 ( & V_242 -> V_242 , L_46 ,
V_279 ) ;
goto V_305;
}
F_163 ( & V_242 -> V_242 , V_308 ) ;
return 0 ;
V_305:
F_156 () ;
V_311:
...
{
struct V_307 * V_308 = F_165 ( & V_242 -> V_242 ) ;
F_134 ( & V_308 -> V_309 ) ;
F_156 () ;
F_167 ( V_308 ) ;
return 0 ;
...
{
return F_171 ( V_312 , F_172 ( V_312 ) ) ;
}
static void T_7 F_173 ( void )
{
F_174 ( V_312 , F_172 ( V_312 ) ) ;
}
