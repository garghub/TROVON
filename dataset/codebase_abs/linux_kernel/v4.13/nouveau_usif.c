...
struct V_57 * V_58 ;
int V_44 = - V_45 ;
if ( ! ( V_58 = F_16 ( sizeof( * V_58 ) , V_48 ) ) )
return - V_49 ;
F_18 ( & V_58 -> V_8 , & V_6 -> V_60 ) ;
if ( ! ( V_44 = F_15 ( V_44 , & V_11 , & V_12 , args -> V_14 , 0 , 0 , true ) ) ) {
V_58 -> V_22 = args -> V_14 . V_22 ;
V_58 -> V_20 = args -> V_14 . V_20 ;
args -> V_14 . V_22 = V_61 ;
args -> V_14 . V_20 = ( unsigned long ) ( void * ) V_58 ;
V_44 = F_17 ( V_40 , V_37 , V_38 ) ;
args -> V_14 . V_20 = V_58 -> V_20 ;
args -> V_14 . V_22 = V_58 -> V_22 ;
}
if ( V_44 )
F_23 ( V_58 ) ;
return V_44 ;
...
int
F_25 ( struct V_2 * V_3 , void T_2 * V_62 , T_1 V_38 )
{
struct V_5 * V_6 = V_5 ( V_3 ) ;
struct V_39 * V_40 = & V_6 -> V_26 ;
...
if ( V_44 = - V_49 , ! V_37 )
goto V_53;
if ( V_44 = - V_65 , F_26 ( V_37 , V_62 , V_12 ) )
goto V_53;
if ( ! ( V_44 = F_15 ( - V_45 , & V_11 , & V_12 , V_37 -> V_14 , 0 , 0 , true ) ) ) {
V_64 = V_37 -> V_14 . V_64 ;
if ( V_37 -> V_14 . V_58 == 0ULL &&
V_37 -> V_14 . type != V_66 )
V_37 -> V_14 . V_64 = V_67 ;
else
V_37 -> V_14 . V_64 = V_61 ;
...
F_27 ( & V_6 -> V_68 ) ;
if ( V_37 -> V_14 . V_22 ) {
if ( V_44 = - V_69 , V_37 -> V_14 . V_22 == 0xff )
...
if ( V_37 -> V_14 . V_22 == V_61 ) {
V_58 = ( void * ) ( unsigned long ) V_37 -> V_14 . V_20 ;
V_37 -> V_14 . V_22 = V_58 -> V_22 ;
V_37 -> V_14 . V_20 = V_58 -> V_20 ;
if ( V_44 == 0 && V_37 -> V_14 . type == V_66 ) {
F_4 ( & V_58 -> V_8 ) ;
F_5 ( V_58 ) ;
}
} else {
