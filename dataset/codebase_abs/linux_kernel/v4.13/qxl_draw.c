...
int V_68 = V_93 -> V_101 . V_103 -> V_104 [ 0 ] * 8 ;
T_1 * V_105 ;
struct V_3 * V_4 ;
struct V_6 * V_7 ;
struct V_71 * V_72 ;
...
V_32 = F_28 ( int , V_32 , ( int ) V_98 -> V_106 ) ;
V_34 = F_29 ( int , V_34 , ( int ) V_98 -> V_107 ) ;
V_31 = F_28 ( int , V_31 , ( int ) V_98 -> y1 ) ;
V_33 = F_29 ( int , V_33 , ( int ) V_98 -> V_108 ) ;
}
V_65 = V_34 - V_32 ;
V_66 = V_33 - V_31 ;
...
if ( V_12 )
goto V_110;
V_12 = F_4 ( V_78 , ( void * * ) & V_105 ) ;
if ( V_12 )
goto V_110;
V_12 = F_19 ( V_2 , V_4 , V_72 , V_105 ,
...
V_100 [ V_24 ] . V_32 = V_98 -> V_106 ;
V_100 [ V_24 ] . V_34 = V_98 -> V_107 ;
V_100 [ V_24 ] . V_31 = V_98 -> y1 ;
V_100 [ V_24 ] . V_33 = V_98 -> V_108 ;
}
F_14 ( V_7 ) ;
F_23 ( V_2 , V_4 , V_91 , false ) ;
F_24 ( V_4 ) ;
...
V_22 . V_34 = V_62 + V_65 ;
V_22 . V_33 = V_64 + V_66 ;
V_12 = F_9 ( V_2 , 0 , V_115 , & V_22 , V_4 ) ;
if ( V_12 ) {
F_18 ( V_4 ) ;
goto V_114;
}
V_23 = (struct V_19 * ) F_10 ( V_2 , V_4 ) ;
V_23 -> V_79 . V_116 . V_117 . V_61 = V_112 ;
V_23 -> V_79 . V_116 . V_117 . V_63 = V_113 ;
F_11 ( V_2 , V_4 , & V_23 -> V_42 ) ;
F_23 ( V_2 , V_4 , V_91 , false ) ;
F_24 ( V_4 ) ;
V_114:
...
void F_31 ( struct F_31 * V_118 )
{
struct V_1 * V_2 = V_118 -> V_2 ;
struct V_10 V_22 = V_118 -> V_22 ;
V_45 V_94 = V_118 -> V_94 ;
T_4 V_119 = V_118 -> V_119 ;
struct V_19 * V_23 ;
struct V_3 * V_4 ;
int V_12 ;
V_12 = F_5 ( V_2 , & V_4 ) ;
...
if ( V_12 )
goto V_114;
V_12 = F_9 ( V_2 , 0 , V_120 , & V_22 , V_4 ) ;
if ( V_12 ) {
F_18 ( V_4 ) ;
goto V_114;
}
V_23 = (struct V_19 * ) F_10 ( V_2 , V_4 ) ;
V_23 -> V_79 . V_121 . V_122 . type = V_123 ;
V_23 -> V_79 . V_121 . V_122 . V_79 . V_94 = V_94 ;
V_23 -> V_79 . V_121 . V_84 = V_119 ;
V_23 -> V_79 . V_121 . V_87 . V_88 = 0 ;
V_23 -> V_79 . V_121 . V_87 . V_89 . V_61 = 0 ;
V_23 -> V_79 . V_121 . V_87 . V_89 . V_63 = 0 ;
V_23 -> V_79 . V_121 . V_87 . V_80 = 0 ;
F_11 ( V_2 , V_4 , & V_23 -> V_42 ) ;
F_23 ( V_2 , V_4 , V_91 , false ) ;
F_24 ( V_4 ) ;
V_114:
