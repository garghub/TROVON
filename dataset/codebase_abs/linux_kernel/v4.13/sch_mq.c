...
static void F_30 ( struct V_1 * V_2 , unsigned long V_40 )
{
}
...
static int F_32 ( struct V_1 * V_2 , unsigned long V_40 ,
struct V_49 * V_50 )
{
struct V_12 * V_13 = F_23 ( V_2 , V_40 ) ;
V_2 = V_13 -> V_33 ;
if ( F_33 ( & V_2 -> V_51 , V_50 , NULL , & V_2 -> V_31 ) < 0 ||
F_34 ( V_50 , NULL , & V_2 -> V_32 , V_2 -> V_29 . V_30 ) < 0 )
return - 1 ;
return 0 ;
}
static void F_35 ( struct V_1 * V_2 , struct V_52 * V_53 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned int V_7 ;
if ( V_53 -> V_54 )
