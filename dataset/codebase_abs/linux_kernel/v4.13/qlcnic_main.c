...
static int
F_384 ( struct V_614 * V_615 ,
unsigned long V_606 , void * V_616 )
{
struct V_1 * V_2 ;
struct V_21 * V_30 ;
struct V_619 * V_609 = (struct V_619 * ) V_616 ;
V_30 = V_609 -> V_620 ? V_609 -> V_620 -> V_30 : NULL ;
V_617:
if ( V_30 == NULL )
goto V_521;
if ( F_381 ( V_30 ) ) {
...
{ }
static int T_15 F_385 ( void )
{
int V_26 ;
F_386 ( V_488 L_120 , V_621 ) ;
#ifdef F_387
F_388 ( & V_622 ) ;
F_389 ( & V_623 ) ;
#endif
