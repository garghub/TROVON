...
int F_24 ( struct V_41 * V_40 )
{
return V_40 -> V_44 . V_29 ;
}
int F_25 ( struct V_41 * V_40 )
{
...
struct V_55 * V_56 ;
char * V_57 , * V_58 , * V_59 ;
V_56 = F_27 ( V_40 -> V_60 . V_61 , struct V_55 ,
V_62 ) ;
V_57 = V_56 -> V_57 ;
V_58 = V_56 -> V_58 ;
V_59 = V_56 -> V_59 ;
V_21 = & V_40 -> V_63 ;
V_21 -> V_64 = F_28 ( V_59 , V_65 , 0 ) ;
if ( F_29 ( V_21 -> V_64 ) ) {
int V_66 = F_30 ( V_21 -> V_64 ) ;
ERROR ( V_40 , L_4 ,
V_59 ) ;
V_21 -> V_64 = NULL ;
return V_66 ;
...
static int F_31 ( struct V_41 * V_71 )
{
struct V_20 * V_21 ;
V_21 = & V_71 -> V_63 ;
if ( V_21 -> V_64 )
