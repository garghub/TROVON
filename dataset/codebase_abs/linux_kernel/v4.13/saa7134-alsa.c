...
struct V_128 * V_33 ;
int V_35 ;
if ( ( V_35 = F_72 ( V_96 -> V_87 , L_15 , V_74 , 0 , 1 , & V_33 ) ) < 0 )
return V_35 ;
F_73 ( V_33 , V_129 , & V_130 ) ;
V_33 -> V_34 = V_96 ;
V_33 -> V_131 = 0 ;
strcpy ( V_33 -> V_132 , L_15 ) ;
return 0 ;
}
...
goto V_157;
strcpy ( V_87 -> V_158 , L_17 ) ;
sprintf ( V_87 -> V_159 , L_19 ,
