...
F_59 ( & V_13 -> V_164 ) ;
V_163:
F_60 ( & V_8 -> V_161 , V_160 ) ;
return error ;
}
static void F_61 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
int V_10 = 0 ;
unsigned long V_160 ;
...
static void F_66 ( struct V_165 * V_151 )
{
...
static int F_75 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
...
V_29 = F_76 ( V_8 -> V_59 , V_193 ) ;
if ( ! V_29 )
return - V_194 ;
F_77 ( & V_8 -> V_128 [ 0 ] , V_29 , V_8 -> V_59 ) ;
V_8 -> V_131 = 1 ;
V_8 -> V_129 = 0 ;
V_8 -> V_127 = 0 ;
V_8 -> V_135 = V_136 ;
...
if ( F_18 ( V_29 -> V_197 ) != V_198 ) {
F_71 ( V_199 L_68 ,
F_72 ( & V_13 -> V_42 ) , F_18 ( V_29 -> V_197 ) ) ;
V_10 = - V_200 ;
goto V_196;
}
if ( V_29 -> V_148 > V_201 ) {
...
V_189 = V_29 -> V_148 ;
V_8 -> V_202 . V_203 = F_78 ( V_189 + 1 ,
sizeof( * V_8 -> V_202 . V_203 ) ,
V_193 ) ;
if ( ! V_8 -> V_202 . V_203 ) {
V_10 = - V_194 ;
goto V_196;
...
V_8 -> V_202 . V_91 = L_70 ;
V_43 = F_79 ( V_29 , V_192 , V_193 ) ;
if ( ! V_43 ) {
V_10 = - V_194 ;
goto V_196;
}
for ( V_45 = 0 ; V_45 < V_189 ; ++ V_45 ) {
V_44 = F_80 ( sizeof( struct V_27 ) , V_193 ) ;
if ( ! V_44 ) {
V_10 = - V_194 ;
goto V_204;
}
V_8 -> V_202 . V_203 [ V_45 ] = & V_44 -> V_31 . V_29 ;
V_190 = F_20 ( V_29 -> V_205 [ V_45 ] . V_206 ) ;
V_44 -> V_46 = F_20 ( V_29 -> V_205 [ V_45 ] . V_46 ) ;
F_34 ( & V_13 -> V_42 , L_71
L_72 , V_45 , V_29 -> V_205 [ V_45 ] . V_207 , V_190 ,
V_44 -> V_46 ) ;
V_44 -> V_207 = V_29 -> V_205 [ V_45 ] . V_207 ;
if ( F_14 ( V_44 -> V_207 ) )
snprintf ( V_44 -> V_91 , sizeof( V_44 -> V_91 ) , L_35 ,
F_14 ( V_29 -> V_205 [ V_45 ] . V_207 ) ) ;
else
snprintf ( V_44 -> V_91 , sizeof( V_44 -> V_91 ) ,
L_73 , V_29 -> V_205 [ V_45 ] . V_207 ) ;
F_81 ( & V_44 -> V_31 . V_29 ) ;
V_44 -> V_31 . V_29 . V_91 = V_44 -> V_91 ;
V_44 -> V_31 . V_29 . V_3 = V_208 ;
V_44 -> V_31 . V_209 = F_25 ( V_44 -> V_207 ) ;
if ( ! V_44 -> V_46 )
continue;
V_44 -> V_48 = F_76 ( V_44 -> V_46 , V_193 ) ;
if ( ! V_44 -> V_48 ) {
V_10 = - V_194 ;
goto V_204;
}
...
+ 1 ) * V_8 -> V_59 - V_191 ;
V_43 = F_76 ( V_192 , V_193 ) ;
if ( ! V_43 ) {
V_10 = - V_194 ;
goto V_196;
}
}
F_77 ( & V_8 -> V_128 [ 0 ] , V_43 , V_192 ) ;
V_8 -> V_131 = 1 ;
V_8 -> V_129 = 0 ;
V_8 -> V_127 = 0 ;
V_8 -> V_135 = V_136 ;
...
V_8 -> system = V_183 ;
V_8 -> V_153 = F_43 ;
V_13 -> V_210 . V_211 = F_32 ( struct V_212 , V_213 ) ;
V_13 -> V_210 . V_214 = sizeof( struct V_105 ) ;
V_13 -> V_210 . V_215 = F_32 ( struct V_212 , V_140 ) ;
V_13 -> V_210 . V_216 = sizeof( struct V_139 ) ;
if ( F_74 ( V_13 ) )
return - V_217 ;
...
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_172 * V_156 = V_13 -> V_156 ;
struct V_95 * V_219 = NULL ;
struct V_50 * V_220 = NULL ;
struct V_27 * V_44 = NULL ;
int V_10 , V_18 ;
T_5 V_221 = V_222 ;
unsigned long V_223 ;
if ( V_156 -> V_42 . V_224 && * ( V_156 -> V_42 . V_224 ) )
V_221 = * ( V_156 -> V_42 . V_224 ) ;
for ( V_10 = 0 ; V_8 -> V_202 . V_203 [ V_10 ] ; ++ V_10 ) {
V_44 = F_12 ( V_8 -> V_202 . V_203 [ V_10 ] ) ;
if ( V_44 -> V_207 == V_40 )
V_219 = V_44 -> V_48 ;
else if ( V_44 -> V_207 == V_33 )
V_220 = V_44 -> V_48 ;
}
if ( ! V_219 || ! V_220 )
return - V_200 ;
V_8 -> V_26 = F_18 ( V_219 -> V_26 ) ;
V_8 -> V_23 = F_18 ( V_219 -> V_23 ) ;
V_8 -> V_25 = F_18 ( V_219 -> V_25 ) ;
V_8 -> V_59 = F_18 ( V_220 -> V_71 ) ;
F_2 ( & V_12 ) ;
V_18 = F_84 ( & V_20 , V_13 , 0 , 256 , V_193 ) ;
F_3 ( & V_12 ) ;
if ( V_18 < 0 )
return V_18 ;
V_8 -> V_5 = F_85 ( 1 << V_19 ) ;
...
V_8 -> V_157 = F_86 ( F_66 , & V_8 -> V_161 ) ;
if ( ! V_8 -> V_157 ) {
V_10 = - V_194 ;
goto V_226;
}
V_8 -> V_157 -> V_166 = V_13 ;
F_87 ( V_8 -> V_157 , V_221 ) ;
F_88 ( V_8 -> V_157 , V_227 ) ;
F_89 ( V_8 -> V_157 , V_228 ) ;
F_90 ( V_8 -> V_157 ,
V_227 * V_8 -> V_59 ) ;
V_8 -> V_5 -> V_229 = V_229 ;
V_8 -> V_5 -> V_230 = V_18 << V_19 ;
V_8 -> V_5 -> V_231 = & V_232 ;
V_8 -> V_14 = 1 ;
V_8 -> V_5 -> V_9 = V_8 ;
V_8 -> V_5 -> V_157 = V_8 -> V_157 ;
sprintf ( V_8 -> V_5 -> V_233 , L_78 , V_18 ) ;
F_91 ( V_8 -> V_157 , V_8 -> V_59 ) ;
V_223 = F_18 ( V_220 -> V_58 ) ;
V_223 *= F_18 ( V_220 -> V_56 ) ;
V_223 *= V_8 -> V_59 >> 9 ;
F_92 ( V_8 -> V_5 , V_223 ) ;
F_34 ( & V_13 -> V_42 , L_79 , V_223 ) ;
F_93 ( & V_13 -> V_42 , V_8 -> V_5 ) ;
V_8 -> V_234 = 1 ;
return 0 ;
V_226:
F_9 ( V_8 -> V_5 ) ;
...
struct V_27 * V_44 ;
if ( V_8 -> V_202 . V_203 ) {
for ( V_45 = 0 ; V_8 -> V_202 . V_203 [ V_45 ] ; ++ V_45 ) {
V_44 = F_12 ( V_8 -> V_202
. V_203 [ V_45 ] ) ;
F_7 ( V_44 -> V_48 ) ;
F_7 ( V_44 ) ;
...
struct V_7 * V_8 ;
int V_10 = 0 ;
V_8 = F_80 ( sizeof( struct V_7 ) , V_193 ) ;
if ( ! V_8 )
return - V_194 ;
F_97 ( V_13 , V_8 ) ;
V_8 -> V_13 = V_13 ;
...
if ( V_10 )
goto V_235;
V_10 = F_99 ( & V_13 -> V_42 . V_236 , & V_8 -> V_202 ) ;
if ( V_10 )
goto V_235;
V_10 = F_83 ( V_13 ) ;
if ( ! V_10 ) {
...
F_100 ( & V_13 -> V_42 . V_236 , & V_8 -> V_202 ) ;
V_235:
F_97 ( V_13 , NULL ) ;
F_94 ( V_8 ) ;
F_7 ( V_8 ) ;
...
static int F_104 ( struct V_99 * V_13 , T_6 V_240 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
struct V_7 * V_241 ;
struct V_172 * V_156 = V_13 -> V_156 ;
struct V_27 * V_44 , * V_242 ;
unsigned char V_45 ;
F_2 ( & V_156 -> V_243 ) ;
V_241 = F_80 ( sizeof( struct V_7 ) , V_193 ) ;
if ( ! V_241 ) {
V_10 = - V_194 ;
goto V_244;
}
...
if ( F_82 ( V_13 ) )
goto V_235;
for ( V_45 = 0 ; V_241 -> V_202 . V_203 [ V_45 ]
&& V_8 -> V_202 . V_203 [ V_45 ] ; ++ V_45 ) {
V_44 = F_12 ( V_241 -> V_202 . V_203 [ V_45 ] ) ;
V_242 = F_12 ( V_8 -> V_202 . V_203 [ V_45 ] ) ;
if ( V_44 -> V_207 == V_33
&& V_242 -> V_207 == V_44 -> V_207 ) {
if ( memcmp ( V_44 -> V_48 , V_242 -> V_48 , V_44 -> V_46 ) )
break;
V_8 -> V_234 = 1 ;
break;
}
...
{
int V_10 = - V_194 ;
V_10 = F_108 ( V_229 , V_245 ) ;
if ( V_10 < 0 ) {
F_71 (KERN_ERR DRIVER_NAME L_81
L_82 , major, rc) ;
return V_10 ;
}
if ( ! V_229 )
