...
static void F_62 ( struct V_8 * V_9 , unsigned V_248 )
{
struct V_39 * V_40 , * V_249 ;
struct V_39 * V_250 [ V_251 ] ;
unsigned V_27 , V_252 = 0 , V_253 ;
struct V_36 * V_254 ;
struct V_255 * V_179 = & V_9 -> V_12 -> V_256 ;
#ifdef F_57
...
} while ( F_172 ( & V_179 -> V_257 , V_253 ) );
for ( V_27 = 0 ; V_27 < V_252 ; V_27 ++ )
V_250 [ V_27 ] -> V_258 ( V_250 [ V_27 ] , V_259 ) ;
}
static void F_65 ( struct V_8 * V_9 , T_2 V_260 )
{
...
void F_173 ( struct V_8 * V_9 , T_2 V_260 )
{
F_174 ( V_9 , V_260 ) ;
F_52 ( & V_9 -> V_52 ) ;
F_21 ( V_9 , V_201 ) ;
if ( V_260 & V_9 -> V_206 )
V_9 -> V_264 ++ ;
else if ( V_260 & V_9 -> V_205 )
V_9 -> V_265 ++ ;
else if ( V_260 & V_9 -> V_204 )
V_9 -> V_266 ++ ;
F_65 ( V_9 , V_260 ) ;
F_53 ( & V_9 -> V_52 ) ;
}
void F_175 ( struct V_8 * V_9 , T_2 V_260 )
{
unsigned long V_31 ;
#ifdef F_57
F_17 ( V_9 -> V_12 , L_29 ,
...
V_9 -> V_13 , F_58 ( __FILE__ ) , __LINE__ , V_23 ) ;
#endif
F_11 ( V_9 , F_22 ( V_288 ) , V_9 -> V_187 ) ;
F_178 ( V_9 ) ;
F_179 ( V_9 , 0 ) ;
F_11 ( V_9 , F_22 ( V_289 ) , V_194 ) ;
F_11 ( V_9 , F_22 ( V_35 ) , 0 ) ;
F_11 ( V_9 , F_22 ( V_290 ) , V_9 -> V_184 ) ;
F_11 ( V_9 , F_22 ( V_291 ) ,
( ( T_2 ) V_285 << F_22 ( V_292 ) ) |
( ( T_2 ) ( V_285 * V_9 -> V_13 ) <<
F_22 ( V_293 ) ) ) ;
F_11 ( V_9 , F_22 ( V_294 ) , ~ 0ull ) ;
F_183 ( V_9 ) ;
V_287 = V_295 ;
V_286 = V_296 ;
F_11 ( V_9 , F_22 ( V_297 ) ,
...
V_318 = & V_9 -> V_185 [ V_80 ] ;
V_319 [ 0 ] = F_168 ( V_318 -> V_229 [ 0 ] ) ;
V_319 [ 1 ] = F_168 ( V_318 -> V_229 [ 1 ] ) ;
V_31 [ 0 ] = ( V_319 [ 1 ] & V_216 ) ? 'I' : '-' ;
V_31 [ 1 ] = ( V_319 [ 1 ] & V_215 ) ?
'H' : '-' ;
V_31 [ 2 ] = ( V_319 [ 0 ] & V_323 ) ? 'F' : '-' ;
V_31 [ 3 ] = ( V_319 [ 0 ] & V_324 ) ? 'L' : '-' ;
V_320 = ( V_319 [ 0 ] >> V_325 )
& V_326 ;
V_321 = ( V_319 [ 1 ] >> V_327 )
& V_328 ;
...
! F_158 ( & V_9 -> V_45 ) ,
V_9 -> V_337 ,
( unsigned long long ) F_13 ( V_9 , V_338 ) ) ;
while ( V_80 != V_81 ) {
char V_31 [ 6 ] = { 'x' , 'x' , 'x' , 'x' , 0 } ;
V_318 = & V_9 -> V_185 [ V_80 ] ;
V_319 [ 0 ] = F_168 ( V_318 -> V_229 [ 0 ] ) ;
...
static inline T_2 F_189 ( struct V_8 * V_9 , T_2 V_339 )
{
T_5 V_340 = ( V_9 -> V_72 >> V_9 -> V_203 ) & 3 ;
V_339 &= ~ V_341 ;
V_339 |= ( ( T_2 ) V_340 & V_328 )
<< V_327 ;
return V_339 ;
}
...
T_5 V_233 = 0 , V_234 = F_166 ( V_37 ) ;
V_81 = V_9 -> V_72 & V_9 -> V_79 ;
V_9 -> V_185 [ V_81 ] . V_229 [ 0 ] = F_191 ( V_225 -> V_229 [ 0 ] ) ;
V_9 -> V_185 [ V_81 ] . V_229 [ 1 ] = F_191 ( F_189 ( V_9 , V_225 -> V_229 [ 1 ] ) ) ;
F_192 ( V_9 , V_225 -> V_229 [ 0 ] , V_225 -> V_229 [ 1 ] ,
V_81 , & V_9 -> V_185 [ V_81 ] ) ;
V_81 = ++ V_9 -> V_72 & V_9 -> V_79 ;
V_225 ++ ;
if ( V_234 > V_235 )
...
V_339 = F_189 ( V_9 , V_225 -> V_229 [ 1 ] ) ;
}
V_9 -> V_185 [ V_81 ] . V_229 [ 1 ] = F_191 ( V_339 ) ;
F_192 ( V_9 , V_225 -> V_229 [ 0 ] , V_339 ,
V_81 , & V_9 -> V_185 [ V_81 ] ) ;
V_81 = ++ V_9 -> V_72 & V_9 -> V_79 ;
}
V_37 -> V_83 = V_81 ;
...
V_37 -> V_41 = V_9 -> V_342 ++ ;
F_193 ( V_9 , V_37 -> V_41 ) ;
F_26 ( V_9 -> V_77 [ V_9 -> V_336 & V_9 -> V_79 ] ) ;
#endif
V_9 -> V_77 [ V_9 -> V_336 ++ & V_9 -> V_79 ] = V_37 ;
V_9 -> V_84 -= V_37 -> V_232 ;
return V_81 ;
}
static int F_194 (
...
unsigned V_253 ;
V_253 = F_195 (
( const V_345 * ) & V_9 -> V_52 . V_346 ) ;
V_142 = V_40 -> V_344 ( V_9 , V_40 , V_37 , V_253 ) ;
if ( V_142 == - V_343 )
V_9 -> V_84 = F_63 ( V_9 ) ;
} else {
V_142 = - V_347 ;
...
struct V_354 * V_355 , T_1 * V_356 )
{
struct V_36 * V_37 , * V_357 ;
int V_142 = 0 ;
unsigned long V_31 ;
T_4 V_81 = V_358 ;
T_1 V_359 = 0 , V_360 = 0 , V_361 ;
F_33 ( & V_9 -> V_69 , V_31 ) ;
V_241:
...
static void F_46 ( struct V_8 * V_9 , enum V_364 V_365 )
{
unsigned long V_31 ;
F_33 ( & V_9 -> V_69 , V_31 ) ;
F_52 ( & V_9 -> V_52 ) ;
...
{
int V_27 ;
if ( F_79 ( ( V_37 -> V_232 == ( V_383 - 1 ) ) ) ) {
if ( ! V_37 -> V_348 ) {
V_37 -> V_237 = V_383 ;
} else if ( ! V_37 -> V_236 ) {
V_37 -> V_236 = F_204 ( V_37 -> V_348 + sizeof( T_1 ) ,
V_384 ) ;
if ( ! V_37 -> V_236 )
goto V_385;
V_37 -> V_386 = 0 ;
...
int type , void * V_387 , struct V_388 * V_388 ,
unsigned long V_389 , T_4 V_322 )
{
int V_390 , V_121 ;
T_10 V_320 ;
...
memcpy ( V_37 -> V_236 + V_37 -> V_386 , V_387 , V_322 ) ;
V_37 -> V_386 += V_322 ;
if ( type == V_228 )
F_208 ( V_388 ) ;
if ( V_37 -> V_348 - V_37 -> V_386 )
return 0 ;
V_390 = V_37 -> V_392 & ( sizeof( T_1 ) - 1 ) ;
if ( V_390 ) {
V_390 = sizeof( T_1 ) - V_390 ;
memset ( V_37 -> V_236 + V_37 -> V_386 , 0 , V_390 ) ;
V_37 -> V_392 += V_390 ;
V_37 -> V_348 += V_390 ;
}
V_320 = F_209 ( & V_12 -> V_178 -> V_179 ,
V_37 -> V_236 ,
V_37 -> V_348 ,
V_227 ) ;
if ( F_79 ( F_210 ( & V_12 -> V_178 -> V_179 , V_320 ) ) ) {
F_27 ( V_12 , V_37 ) ;
return - V_393 ;
}
V_37 -> V_237 = V_383 ;
return F_211 ( V_12 , V_226 , V_37 ,
V_320 , V_37 -> V_348 ) ;
}
return 1 ;
}
void F_212 ( struct V_16 * V_12 , T_2 V_125 , T_1 V_394 )
{
struct V_8 * V_9 ;
int V_27 ;
T_2 V_395 ;
V_395 = ( ( V_125 & F_22 ( V_396 ) ) <<
F_22 ( V_397 ) ) |
( ( ( V_394 & V_125 ) & F_22 ( V_398 ) ) <<
F_22 ( V_399 ) ) ;
for ( V_27 = 0 ; V_27 < V_12 -> V_28 ; V_27 ++ ) {
F_213 ( V_400 , L_39 ,
V_27 , ( T_1 ) V_395 ) ;
V_9 = & V_12 -> V_29 [ V_27 ] ;
F_11 ( V_9 , F_22 ( V_316 ) , V_395 ) ;
}
}
...
V_391 ,
V_12 -> V_180 ,
sizeof( T_1 ) - ( V_37 -> V_392 & ( sizeof( T_1 ) - 1 ) ) ) ;
F_216 ( V_12 , V_37 ) ;
return V_121 ;
}
void F_217 (
...
T_5 V_404 )
{
T_1 V_27 , V_405 = 0 , V_319 = 0 ;
T_5 V_234 ;
F_26 ( V_401 > 9 || ( V_404 & 3 ) || V_404 == 4 ) ;
if ( V_401 == 1 )
V_234 = V_235 ;
else if ( V_401 <= 5 )
V_234 = V_406 ;
...
( ( ( T_2 ) V_403 [ 0 ] & V_411 )
<< V_412 ) ;
for ( V_27 = 0 ; V_27 < ( V_401 - 1 ) ; V_27 ++ ) {
if ( ! V_405 && ! ( V_27 & 2 ) )
V_319 ++ ;
V_37 -> V_238 [ V_319 ] . V_229 [ ! ! ( V_27 & 2 ) ] |=
( ( ( T_2 ) V_403 [ V_27 + 1 ] )
<< V_405 ) ;
V_405 = ( V_405 + 32 ) & 63 ;
}
...
while ( 1 ) {
V_413 = F_220 ( F_169 ( V_9 -> V_209 ) ) ;
if ( V_413 > 31 ) {
F_219 ( V_9 , - V_393 ) ;
return - V_393 ;
}
V_414 = F_221 ( V_413 , & V_9 -> V_209 ) ;
if ( ! V_414 )
break;
F_222 () ;
}
...
void F_223 ( struct V_8 * V_9 , int V_415 )
{
if ( ! V_9 )
return;
F_224 ( V_9 , V_415 ) ;
if ( V_415 < 0 || V_415 > 31 )
return;
F_225 ( V_415 , & V_9 -> V_209 ) ;
}
void F_226 ( struct V_16 * V_12 , int V_416 )
{
int V_27 ;
enum V_364 V_365 = V_416 ? V_373 :
V_370 ;
F_67 ( & V_12 -> V_87 , V_12 -> V_28 ) ;
for ( V_27 = 0 ; V_27 < V_12 -> V_28 ; V_27 ++ )
F_46 ( & V_12 -> V_29 [ V_27 ] , V_365 ) ;
}
