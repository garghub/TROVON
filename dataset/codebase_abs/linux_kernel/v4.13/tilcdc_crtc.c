...
static void F_48 ( struct V_11 * V_12 , bool V_139 )
{
struct V_4 * V_4 = F_7 ( V_12 ) ;
struct V_6 * V_7 = V_12 -> V_7 ;
struct V_15 * V_16 = V_7 -> V_17 ;
...
{
return V_12 -> V_86 && V_12 -> V_86 -> V_148 && V_12 -> V_86 -> V_149 ;
}
static void F_56 ( struct V_150 * V_2 )
{
struct V_4 * V_4 =
F_2 ( V_2 , struct V_4 , V_151 ) ;
struct V_11 * V_12 = & V_4 -> V_8 ;
F_57 ( V_12 -> V_7 -> V_7 , L_9 , V_48 ) ;
F_58 ( & V_12 -> V_10 , NULL ) ;
if ( ! F_55 ( V_12 ) )
goto V_152;
F_53 ( V_12 ) ;
...
T_5 V_158 ;
F_44 ( & V_4 -> V_142 , V_129 ) ;
V_157 = F_66 ( V_4 -> V_143 ,
1000000 / V_12 -> V_136 . V_159 ) ;
V_158 = F_67 ( F_68 ( V_157 , F_45 () ) ) ;
if ( V_158 < V_160 )
V_4 -> V_146 = V_14 ;
else
F_6 ( V_12 , V_14 ) ;
...
if ( ! V_4 -> V_161 )
return true ;
V_87 -> V_162 = V_30 -> V_97 - V_30 -> V_98 ;
V_87 -> V_129 |= V_163 ;
if ( V_30 -> V_129 & V_130 ) {
V_87 -> V_129 |= V_164 ;
V_87 -> V_129 &= ~ V_130 ;
...
if ( ! V_86 -> V_149 )
return 0 ;
if ( V_86 -> V_86 -> V_166 [ 0 ] . V_167 != V_12 -> V_88 ||
V_86 -> V_86 -> V_166 [ 0 ] . V_86 == NULL ||
V_86 -> V_86 -> V_166 [ 0 ] . V_86 -> V_12 != V_12 ) {
F_71 ( V_12 -> V_7 -> V_7 , L_11 ) ;
return - V_168 ;
}
V_35 = F_72 ( V_12 , V_30 ) ;
if ( V_35 ) {
F_71 ( V_12 -> V_7 -> V_7 , L_12 , V_30 -> V_169 ) ;
return - V_168 ;
}
return 0 ;
}
...
int F_72 ( struct V_11 * V_12 , struct V_85 * V_30 )
{
struct V_15 * V_16 = V_12 -> V_7 -> V_17 ;
unsigned int V_171 ;
T_3 V_79 , V_80 , V_81 , V_82 , V_83 , V_84 ;
if ( V_30 -> V_99 > F_75 ( V_12 ) )
return V_172 ;
if ( V_30 -> V_99 & 0xf )
return V_172 ;
if ( V_30 -> V_31 > 2048 )
...
if ( V_30 -> clock > V_16 -> V_178 ) {
F_32 ( L_20 ) ;
return V_179 ;
}
if ( V_30 -> V_99 > V_16 -> V_170 )
return V_180 ;
V_171 = V_30 -> V_99 * V_30 -> V_31 *
F_76 ( V_30 ) ;
if ( V_171 > V_16 -> V_181 ) {
F_32 ( L_21 ) ;
return V_182 ;
...
if ( ! V_186 ) {
struct V_154 * V_155 ;
F_44 ( & V_7 -> V_188 , V_129 ) ;
V_155 = V_4 -> V_155 ;
V_4 -> V_155 = NULL ;
if ( V_155 )
F_83 ( V_12 , V_155 ) ;
F_46 ( & V_7 -> V_188 , V_129 ) ;
}
if ( V_4 -> V_189 )
V_4 -> V_190 = 0 ;
else
...
struct V_11 * V_12 ;
int V_35 ;
V_4 = F_89 ( V_7 -> V_7 , sizeof( * V_4 ) , V_197 ) ;
if ( ! V_4 ) {
F_20 ( V_7 -> V_7 , L_25 ) ;
return - V_198 ;
}
F_90 ( & V_4 -> V_36 ) ;
V_4 -> V_199 = F_91 ( V_7 -> V_7 ,
V_40 ,
& V_4 -> V_37 ,
V_197 | V_200 ) ;
if ( ! V_4 -> V_199 )
...
F_99 ( V_12 , & V_204 ) ;
if ( V_16 -> V_205 ) {
V_12 -> V_153 = F_100 ( V_7 -> V_7 -> V_206 , 0 ) ;
if ( ! V_12 -> V_153 ) {
F_20 ( V_7 -> V_7 , L_28 ,
V_7 -> V_7 -> V_206 -> V_207 ) ;
V_35 = - V_168 ;
