...
static inline struct V_3 * F_26 ( struct V_1 * V_2 )
{
register struct V_6 * V_7 ;
struct V_3 * V_4 , * V_31 ;
int V_32 , V_18 ;
...
static inline void F_28 ( struct V_33 * V_34 )
{
F_29 ( & V_34 -> V_9 ) ;
F_15 ( & V_34 -> V_2 ) ;
F_30 ( V_34 , V_13 ) ;
...
F_31 ( int V_26 , const union V_35 * V_27 )
{
T_1 V_36 = V_27 -> V_37 ;
#ifdef F_32
if ( V_26 == V_38 )
...
#endif
return ( F_33 ( V_36 ) * 2654435761UL ) & V_40 ;
}
static void
F_34 ( struct V_41 * V_42 , struct V_33 * V_34 )
{
unsigned int V_43 = F_31 ( V_34 -> V_26 , & V_34 -> V_27 ) ;
F_35 ( & V_34 -> V_9 , & V_42 -> V_44 [ V_43 ] ) ;
F_6 ( & V_42 -> V_45 ) ;
}
static inline struct V_33 *
F_36 ( int V_26 , struct V_41 * V_42 ,
const union V_35 * V_27 )
{
unsigned int V_43 = F_31 ( V_26 , V_27 ) ;
struct V_33 * V_34 ;
F_37 (en, &tbl->bucket[hash], list)
if ( F_38 ( V_26 , & V_34 -> V_27 , V_27 ) )
return V_34 ;
return NULL ;
}
static inline struct V_33 *
F_39 ( struct V_41 * V_42 , const union V_35 * V_46 ,
T_2 V_26 , struct V_3 * V_4 )
{
struct V_33 * V_34 ;
V_34 = F_36 ( V_26 , V_42 , V_46 ) ;
if ( ! V_34 ) {
V_34 = F_3 ( sizeof( * V_34 ) , V_8 ) ;
if ( ! V_34 )
return NULL ;
V_34 -> V_26 = V_26 ;
F_40 ( V_26 , & V_34 -> V_27 , V_46 ) ;
V_34 -> V_47 = V_12 ;
F_41 ( & ( V_34 -> V_2 . V_10 ) , 0 ) ;
F_42 ( & V_34 -> V_2 . V_9 ) ;
...
F_45 (en, next, &tbl->bucket[i], list) {
F_28 ( V_34 ) ;
}
}
F_46 ( & V_49 -> V_54 ) ;
...
{
#ifdef F_48
return V_49 -> V_57 -> F_47 ;
#else
return V_58 ;
#endif
}
static inline void F_49 ( struct V_48 * V_49 )
{
struct V_41 * V_42 = V_49 -> V_50 ;
...
V_60 = ( V_60 + 1 ) & V_40 ;
F_50 ( & V_49 -> V_54 ) ;
F_45 (en, next, &tbl->bucket[j], list) {
if ( F_51 ( V_34 -> V_47 +
F_47 ( V_49 ) , V_59 ) )
continue;
F_28 ( V_34 ) ;
...
static void F_53 ( unsigned long V_62 )
{
...
static inline int
F_63 ( struct V_3 * V_4 , struct V_48 * V_49 )
{
...
static struct V_3 *
F_64 ( struct V_48 * V_49 , const struct V_74 * V_75 ,
struct V_76 * V_77 )
{
struct V_41 * V_42 = V_49 -> V_50 ;
struct V_3 * V_4 ;
struct V_33 * V_34 ;
F_57 ( 6 , L_7 , V_25 ) ;
V_34 = F_36 ( V_49 -> V_26 , V_42 , & V_77 -> V_46 ) ;
if ( V_34 ) {
V_34 -> V_47 = V_12 ;
V_4 = F_17 ( & V_34 -> V_2 ) ;
if ( F_19 ( & V_34 -> V_2 . V_10 ) > 1 &&
F_51 ( V_12 , V_34 -> V_2 . V_11 +
F_47 ( V_49 ) ) ) {
F_44 ( & V_49 -> V_54 ) ;
if ( F_19 ( & V_34 -> V_2 . V_10 ) > 1 ) {
struct V_3 * V_78 ;
...
F_44 ( & V_49 -> V_54 ) ;
if ( ! V_42 -> V_55 )
F_39 ( V_42 , & V_77 -> V_46 , V_49 -> V_26 , V_4 ) ;
F_46 ( & V_49 -> V_54 ) ;
V_66:
F_22 ( 6 , L_10 ,
...
static int T_3 F_66 ( struct V_79 * V_79 )
{
struct V_80 * V_57 = F_67 ( V_79 ) ;
if ( ! V_57 )
return - V_81 ;
if ( ! F_68 ( V_79 , & V_82 ) ) {
V_57 -> V_83 = F_69 ( V_84 ,
...
V_57 -> V_83 = V_84 ;
V_57 -> F_47 = V_58 ;
V_57 -> V_83 [ 0 ] . V_62 = & V_57 -> F_47 ;
V_57 -> V_88 =
F_70 ( V_79 , L_11 , V_57 -> V_83 ) ;
if ( ! V_57 -> V_88 ) {
if ( ! F_68 ( V_79 , & V_82 ) )
F_10 ( V_57 -> V_83 ) ;
return - V_72 ;
...
static void T_4 F_71 ( struct V_79 * V_79 )
{
struct V_80 * V_57 = F_67 ( V_79 ) ;
F_72 ( V_57 -> V_88 ) ;
if ( ! F_68 ( V_79 , & V_82 ) )
...
static int T_3 F_66 ( struct V_79 * V_79 ) { return 0 ; }
static void T_4 F_71 ( struct V_79 * V_79 ) { }
