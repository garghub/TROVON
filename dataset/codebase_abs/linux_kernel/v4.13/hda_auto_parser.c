...
const char * V_113 = F_32 ( V_14 , V_1 ) ;
V_11 = F_30 ( V_1 , V_9 , V_10 ) ;
if ( V_11 < 0 )
return - 1 ;
for ( V_111 = 0 ; V_111 < V_11 ; V_111 ++ )
if ( V_113 == F_32 ( V_14 , V_9 [ V_111 ] ) )
V_112 ++ ;
return V_112 ;
}
...
if ( ! strcmp ( V_114 , L_39 ) && V_35 == V_94 )
V_114 = L_40 ;
V_113 = F_32 ( V_14 , V_1 ) ;
if ( V_16 ) {
V_117 = F_31 ( V_1 , V_16 -> V_45 , V_16 -> V_61 ,
V_109 ) ;
if ( ! V_117 )
V_117 = F_31 ( V_1 , V_16 -> V_47 , V_16 -> V_62 ,
V_109 ) ;
if ( ! V_117 ) {
int V_112 = F_33 ( V_14 , V_1 , V_16 -> V_49 ,
V_16 -> V_63 ) ;
if ( V_112 >= 0 && V_109 )
* V_109 = V_112 ;
V_117 = L_36 ;
...
continue;
V_114 = F_27 ( V_14 , V_16 , V_11 ) ;
if ( V_114 )
break;
}
}
if ( ! V_114 )
V_114 = F_28 ( V_14 , NULL , V_1 , true ) ;
break;
}
if ( ! V_114 )
return 0 ;
F_37 ( V_115 , V_114 , V_116 ) ;
return 1 ;
}
...
struct V_120 * * V_121 = F_41 ( & V_14 -> V_122 , V_11 ) ;
F_42 ( V_14 , * V_121 ) ;
}
}
...
{
for (; V_16 -> V_1 ; V_16 ++ )
F_44 ( V_14 , V_16 -> V_1 , V_16 -> V_126 ) ;
}
static void F_45 ( struct V_13 * V_14 ,
const struct V_125 * V_16 )
{
for (; V_16 -> V_1 ; V_16 ++ )
F_46 ( V_14 , V_16 -> V_1 , V_16 -> V_126 ) ;
}
static void F_47 ( struct V_13 * V_14 , int V_127 , int V_128 , int V_129 )
{
const char * V_130 = V_14 -> V_131 ;
while ( V_127 >= 0 ) {
const struct V_132 * V_133 = V_14 -> V_134 + V_127 ;
if ( V_133 -> V_135 )
F_47 ( V_14 , V_133 -> V_136 , V_128 , V_129 + 1 ) ;
switch ( V_133 -> type ) {
case V_137 :
if ( V_128 != V_138 || ! V_133 -> V_121 . V_9 )
break;
F_26 ( V_14 , L_45 ,
V_14 -> V_91 . V_92 , V_130 ) ;
F_43 ( V_14 , V_133 -> V_121 . V_9 ) ;
break;
case V_139 :
if ( V_128 != V_140 || ! V_133 -> V_121 . V_122 )
break;
F_26 ( V_14 , L_46 ,
V_14 -> V_91 . V_92 , V_130 ) ;
F_38 ( V_14 , V_133 -> V_121 . V_122 ) ;
break;
case V_141 :
if ( ! V_133 -> V_121 . V_142 )
break;
F_26 ( V_14 , L_47 ,
V_14 -> V_91 . V_92 , V_130 ) ;
V_133 -> V_121 . V_142 ( V_14 , V_133 , V_128 ) ;
break;
case V_143 :
if ( V_128 != V_140 || ! V_133 -> V_121 . V_9 )
break;
F_26 ( V_14 , L_48 ,
V_14 -> V_91 . V_92 , V_130 ) ;
F_45 ( V_14 , V_133 -> V_121 . V_9 ) ;
break;
default:
F_48 ( V_14 , L_49 ,
V_14 -> V_91 . V_92 , V_133 -> type ) ;
break;
}
if ( ! V_133 -> V_144 || V_133 -> V_135 )
break;
if ( ++ V_129 > 10 )
break;
V_127 = V_133 -> V_136 ;
...
void F_49 ( struct V_13 * V_14 , int V_128 )
{
if ( V_14 -> V_134 )
F_47 ( V_14 , V_14 -> V_145 , V_128 , 0 ) ;
}
static bool F_50 ( struct V_13 * V_14 ,
const struct V_125 * V_9 )
{
int V_11 ;
for ( V_11 = 0 ; V_11 < V_14 -> V_146 . V_124 ; V_11 ++ ) {
struct V_147 * V_12 = F_41 ( & V_14 -> V_146 , V_11 ) ;
T_1 V_1 = V_12 -> V_1 ;
T_2 V_16 = V_12 -> V_16 ;
const struct V_125 * V_148 ;
int V_149 ;
V_148 = V_9 ;
V_149 = 0 ;
for (; V_148 -> V_1 ; V_148 ++ ) {
if ( V_148 -> V_1 == V_1 ) {
V_149 = 1 ;
if ( ( V_148 -> V_126 & V_150 ) == ( V_16 & V_150 ) )
break;
else if ( ( V_16 & 0xf0000000 ) == 0x40000000 && ( V_148 -> V_126 & 0xf0000000 ) == 0x40000000 )
break;
else
return false ;
}
}
if ( ! V_149 && ( V_16 & 0xf0000000 ) != 0x40000000 )
return false ;
}
return true ;
}
...
if ( V_14 -> V_145 != V_155 )
return;
for ( V_154 = V_152 ; V_154 -> V_156 ; V_154 ++ ) {
if ( ( V_14 -> V_91 . V_157 & 0xffff0000 ) != ( V_154 -> V_156 << 16 ) )
continue;
if ( V_14 -> V_91 . V_158 != V_154 -> V_14 )
continue;
if ( F_50 ( V_14 , V_154 -> V_9 ) ) {
V_14 -> V_145 = V_154 -> V_159 ;
#ifdef F_52
V_14 -> V_131 = V_154 -> V_114 ;
F_26 ( V_14 , L_50 ,
V_14 -> V_91 . V_92 , V_14 -> V_131 ) ;
#endif
V_14 -> V_134 = V_153 ;
return;
}
...
if ( V_14 -> V_145 != V_155 )
return;
if ( V_14 -> V_130 && ! strcmp ( V_14 -> V_130 , L_51 ) ) {
V_14 -> V_134 = NULL ;
V_14 -> V_131 = NULL ;
V_14 -> V_145 = V_165 ;
F_26 ( V_14 , L_52 ,
...
if ( V_14 -> V_130 && V_161 ) {
while ( V_161 -> V_114 ) {
if ( ! strcmp ( V_14 -> V_130 , V_161 -> V_114 ) ) {
V_14 -> V_145 = V_161 -> V_127 ;
V_14 -> V_131 = V_161 -> V_114 ;
V_14 -> V_134 = V_153 ;
F_26 ( V_14 , L_53 ,
V_14 -> V_91 . V_92 , V_14 -> V_131 ) ;
return;
...
if ( V_163 ) {
V_164 = F_54 ( V_14 -> V_166 -> V_167 , V_163 ) ;
if ( V_164 ) {
V_127 = V_164 -> V_159 ;
#ifdef F_52
V_114 = V_164 -> V_114 ;
F_26 ( V_14 , L_54 ,
V_14 -> V_91 . V_92 , V_114 , V_164 -> V_168 ? L_36 : L_55 ) ;
#endif
}
}
if ( V_127 < 0 && V_163 ) {
for ( V_164 = V_163 ; V_164 -> V_156 || V_164 -> V_169 ; V_164 ++ ) {
unsigned int V_170 =
V_164 -> V_169 | ( V_164 -> V_156 << 16 ) ;
unsigned int V_171 = 0xffff0000 | V_164 -> V_168 ;
if ( ( V_14 -> V_91 . V_157 & V_171 ) == ( V_170 & V_171 ) ) {
V_127 = V_164 -> V_159 ;
#ifdef F_52
V_114 = V_164 -> V_114 ;
F_26 ( V_14 , L_56 ,
V_14 -> V_91 . V_92 , V_114 ) ;
#endif
break;
}
}
