...
F_100 ( & V_23 -> V_250 , V_164 ) ;
if ( V_6 )
if ( ! F_108 ( V_23 -> V_46 , V_253 , V_6 ) )
V_23 -> V_46 = NULL ;
if ( error && V_23 -> V_46 ) {
T_7 V_254 = F_109 ( error ) ;
F_53 ( L_88 ) ;
if ( ! F_108 ( V_23 -> V_46 , V_254 , V_23 -> V_102 ) )
V_23 -> V_46 = NULL ;
}
if ( V_23 -> V_46 )
F_53 ( L_89 ) ;
...
static int F_110 ( struct V_255 * V_256 , T_8 V_257 )
{
struct V_258 * V_259 = V_256 -> V_260 ;
struct V_22 * V_23 = V_259 -> V_261 ;
F_53 ( L_90 ) ;
F_111 ( & V_262 ) ;
if ( V_23 && V_23 -> V_44 )
V_23 -> V_263 ++ ;
...
static int F_114 ( struct V_258 * V_259 )
{
struct V_22 * V_23 = V_259 -> V_261 ;
F_53 ( L_91 ) ;
F_111 ( & V_262 ) ;
...
static void F_117 ( struct V_258 * V_259 , T_8 V_257 )
{
F_114 ( V_259 ) ;
}
...
struct V_266 * V_267 )
{
struct V_22 * V_23 = V_256 -> V_260 -> V_261 ;
* V_267 = V_23 -> V_236 ;
return 0 ;
}
static void F_119 ( struct V_268 * V_269 )
{
struct V_43 * V_44 = V_269 -> V_270 ;
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_271 * V_46 = NULL ;
F_53 ( L_92 ) ;
if ( V_23 -> V_272 ) {
F_40 ( L_93 ) ;
F_27 ( ! V_23 -> V_273 ) ;
while ( ( V_46 = F_102 ( V_269 ) ) != NULL )
F_120 ( V_46 , V_274 ) ;
return;
}
if ( V_23 -> V_46 )
...
static int F_121 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
return ( V_23 -> V_272 == 0 ) ;
}
static void F_122 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
unsigned long V_164 ;
F_40 ( L_94 ) ;
...
if ( V_23 -> V_46 ) {
F_100 ( & V_23 -> V_250 , V_164 ) ;
F_125 ( V_23 -> V_251 , V_23 -> V_46 ) ;
V_23 -> V_46 = NULL ;
F_101 ( & V_23 -> V_250 , V_164 ) ;
}
}
static void F_126 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
unsigned long V_164 ;
F_40 ( L_95 ) ;
...
static int F_128 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_131 * V_52 = V_44 -> V_52 ;
int V_275 ;
T_9 V_276 = V_277 ;
unsigned long V_278 ;
if ( V_52 -> V_279 . V_280 && * ( V_52 -> V_279 . V_280 ) )
V_276 = * ( V_52 -> V_279 . V_280 ) ;
F_111 ( & V_262 ) ;
V_23 -> V_265 = F_129 ( & V_264 , V_44 , 0 , 256 , V_201 ) ;
F_112 ( & V_262 ) ;
if ( V_23 -> V_265 < 0 )
return V_23 -> V_265 ;
V_23 -> V_259 = F_130 ( 0 ) ;
...
V_23 -> V_251 = F_131 ( F_119 , & V_23 -> V_250 ) ;
if ( ! V_23 -> V_251 ) {
V_275 = - V_202 ;
goto V_282;
}
V_23 -> V_251 -> V_270 = V_44 ;
F_132 ( V_23 -> V_251 , V_276 ) ;
F_133 ( V_23 -> V_251 , V_283 ) ;
F_134 ( V_23 -> V_251 , V_284 ) ;
F_135 ( V_23 -> V_251 ,
V_283 * V_23 -> V_102 ) ;
F_136 ( V_23 -> V_251 , V_23 -> V_102 ) ;
sprintf ( V_23 -> V_259 -> V_285 , L_96 , V_23 -> V_265 ) ;
V_23 -> V_259 -> V_286 = & V_287 ;
V_23 -> V_259 -> V_261 = V_23 ;
V_23 -> V_259 -> V_251 = V_23 -> V_251 ;
V_23 -> V_259 -> V_164 |= V_288 ;
V_278 = V_23 -> V_116 * V_23 -> V_172 ;
V_278 *= ( V_23 -> V_102 / 512 ) ;
F_137 ( V_23 -> V_259 , V_278 ) ;
F_40 ( L_97 , V_278 ) ;
V_23 -> V_263 = 1 ;
V_23 -> V_219 = F_138 ( L_98 , V_289 ) ;
F_139 ( & V_23 -> V_220 , F_98 ) ;
F_41 ( V_23 -> V_249 , V_284 + 1 ) ;
if ( V_23 -> V_31 )
F_140 ( V_23 -> V_259 , 1 ) ;
F_126 ( V_44 ) ;
F_141 ( & V_44 -> V_279 , V_23 -> V_259 ) ;
F_40 ( L_99 ) ;
return 0 ;
V_282:
F_116 ( V_23 -> V_259 ) ;
...
static int F_142 ( struct V_43 * V_44 )
{
struct V_22 * V_23 ;
int V_275 = 0 ;
...
static int F_148 ( struct V_43 * V_44 , T_10 V_47 )
{
F_122 ( V_44 ) ;
return 0 ;
}
...
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_22 * V_294 = NULL ;
bool V_272 = true ;
#ifndef F_150
V_23 -> V_272 = true ;
return 0 ;
#endif
F_111 ( & V_44 -> V_52 -> V_295 ) ;
V_294 = F_77 ( sizeof( struct V_22 ) , V_201 ) ;
if ( ! V_294 )
goto V_9;
V_294 -> V_44 = V_44 ;
F_143 ( V_44 , V_294 ) ;
...
if ( F_95 ( V_44 ) )
goto V_9;
if ( V_23 -> V_170 != V_294 -> V_170 )
goto V_9;
if ( memcmp ( V_23 -> V_200 , V_294 -> V_200 ,
sizeof( struct V_181 ) ) )
goto V_9;
if ( V_23 -> V_172 != V_294 -> V_172 ||
memcmp ( V_23 -> V_179 , V_294 -> V_179 ,
V_23 -> V_172 ) )
goto V_9;
if ( V_23 -> V_29 != V_294 -> V_29 ||
memcmp ( V_23 -> V_30 , V_294 -> V_30 ,
V_23 -> V_29 / 8 ) )
goto V_9;
V_272 = false ;
V_9:
...
F_126 ( V_44 ) ;
F_112 ( & V_44 -> V_52 -> V_295 ) ;
return 0 ;
}
static int T_11 F_151 ( void )
{
int V_275 = F_152 ( & V_296 ) ;
if ( V_275 )
F_17 ( L_102 , V_275 ) ;
return V_275 ;
}
