...
F_20 ( & V_179 -> V_56 . V_60 , & V_182 -> V_56 . V_60 ) ;
V_179 -> V_125 = V_182 -> V_125 ;
V_179 -> V_128 = V_182 -> V_128 ;
V_179 -> V_130 = V_182 -> V_130 ;
return 0 ;
} else if ( V_178 -> V_180 == sizeof( V_184 ) ) {
V_184 * V_185 = V_178 -> V_183 ;
V_179 -> V_122 = V_185 -> V_122 ;
V_179 -> V_49 = V_185 -> V_49 ;
V_179 -> V_132 = V_185 -> V_132 ;
V_179 -> V_64 = V_185 -> V_64 ;
V_179 -> V_48 = V_185 -> V_48 ;
V_179 -> V_124 = V_185 -> V_124 ;
F_20 ( & V_179 -> V_56 . V_60 , & V_185 -> V_56 . V_60 ) ;
V_179 -> V_125 = V_185 -> V_125 ;
V_179 -> V_128 = V_185 -> V_128 ;
V_179 -> V_130 = V_185 -> V_130 ;
return 0 ;
}
return - V_186 ;
}
