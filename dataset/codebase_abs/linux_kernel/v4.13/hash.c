...
static int F_125 ( const char * V_159 ,
const T_2 * V_152 , unsigned int V_153 ,
void * V_160 , void * V_161 )
{
struct V_3 * V_4 ;
struct V_113 * V_86 ;
unsigned int V_115 ;
...
if ( V_94 )
goto V_166;
V_94 = F_113 ( V_4 , V_154 , V_160 , V_115 ) ;
if ( V_94 )
goto V_166;
V_94 = F_113 ( V_4 , V_155 , V_161 , V_115 ) ;
V_166:
F_124 ( V_154 ) ;
V_165:
F_132 ( V_4 ) ;
...
{
struct V_167 * V_78 = F_62 ( V_4 -> V_12 . V_86 ) ;
struct V_40 V_82 = { } ;
F_99 ( & V_82 , V_168 ) ;
memcpy ( V_82 . V_78 . V_79 . V_169 , V_78 -> V_169 , sizeof( V_78 -> V_169 ) ) ;
F_60 ( V_4 , & V_82 , true ) ;
return 0 ;
}
...
unsigned int V_153 )
{
struct V_167 * V_78 = F_62 ( F_130 ( V_86 ) ) ;
struct V_122 V_160 , V_161 ;
int V_94 , V_45 ;
V_94 = F_125 ( L_2 , V_152 , V_153 , & V_160 , & V_161 ) ;
if ( V_94 )
return V_94 ;
for ( V_45 = 0 ; V_45 < F_47 ( V_160 . V_79 ) ; V_45 ++ )
V_78 -> V_169 [ V_45 ] = F_137 ( V_160 . V_79 [ V_45 ] ) ;
for ( V_45 = 0 ; V_45 < F_47 ( V_161 . V_79 ) ; V_45 ++ )
V_78 -> V_169 [ V_45 + 8 ] = F_137 ( V_161 . V_79 [ V_45 ] ) ;
return 0 ;
}
...
{
struct V_167 * V_78 = F_62 ( F_130 ( V_86 ) ) ;
struct V_134 V_160 , V_161 ;
int V_94 , V_45 ;
V_94 = F_125 ( L_3 , V_152 , V_153 , & V_160 , & V_161 ) ;
if ( V_94 )
return V_94 ;
for ( V_45 = 0 ; V_45 < F_47 ( V_160 . V_49 ) ; V_45 ++ )
V_78 -> V_169 [ V_45 ] = F_137 ( V_160 . V_49 [ V_45 ] ) ;
for ( V_45 = 0 ; V_45 < F_47 ( V_161 . V_49 ) ; V_45 ++ )
V_78 -> V_169 [ V_45 + 8 ] = F_137 ( V_161 . V_49 [ V_45 ] ) ;
return 0 ;
}
...
{
struct V_167 * V_78 = F_62 ( F_130 ( V_86 ) ) ;
struct V_146 V_160 , V_161 ;
int V_94 , V_45 ;
V_94 = F_125 ( L_4 , V_152 , V_153 , & V_160 , & V_161 ) ;
if ( V_94 )
return V_94 ;
for ( V_45 = 0 ; V_45 < F_47 ( V_160 . V_49 ) ; V_45 ++ )
V_78 -> V_169 [ V_45 ] = F_137 ( V_160 . V_49 [ V_45 ] ) ;
