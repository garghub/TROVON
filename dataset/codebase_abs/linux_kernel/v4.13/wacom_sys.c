...
char * V_3 , int V_301 )
{
struct V_193 * V_19 = F_110 ( V_204 -> V_302 ) ;
struct V_1 * V_2 = F_56 ( V_19 ) ;
struct V_14 * V_14 = F_6 ( V_2 ) ;
T_1 V_303 ;
V_303 = V_14 -> V_167 . V_168 [ V_301 ] . V_176 ;
if ( V_303 >= 0 && V_303 < 3 )
return snprintf ( V_3 , V_297 , L_18 , V_303 ) ;
else
return snprintf ( V_3 , V_297 , L_18 , - 1 ) ;
}
...
V_306 -> V_307 [ V_301 ] . V_206 . V_207 = F_73 ( & V_14 -> V_2 -> V_19 ,
V_41 ,
L_19 , V_304 ) ;
if ( ! V_306 -> V_307 [ V_301 ] . V_206 . V_207 )
return - V_113 ;
error = F_63 ( V_14 , V_306 -> V_308 ,
& V_306 -> V_307 [ V_301 ] . V_206 ) ;
if ( error ) {
V_306 -> V_307 [ V_301 ] . V_206 . V_207 = NULL ;
F_3 ( V_14 -> V_2 ,
L_15 , error ) ;
return error ;
}
...
V_306 -> V_307 [ 0 ] . V_206 = V_316 ;
V_306 -> V_307 [ 1 ] . V_206 = V_317 ;
V_306 -> V_307 [ 2 ] . V_206 = V_318 ;
V_306 -> V_307 [ 3 ] . V_206 = V_319 ;
V_306 -> V_307 [ 4 ] . V_206 = V_320 ;
...
V_14 -> V_167 . V_168 [ V_76 ] . V_176 = V_323 ;
...
! V_16 -> V_235 )
return - V_113 ;
V_16 -> V_329 -> V_207 = V_16 -> V_330 ;
V_16 -> V_97 -> V_207 = V_16 -> V_331 ;
V_16 -> V_235 -> V_207 = V_16 -> V_332 ;
return 0 ;
}
...
while ( 1 ) {
char * V_343 = strstr ( V_207 , L_28 ) ;
if ( V_343 == NULL )
break;
memmove ( V_343 , V_343 + 1 , strlen ( V_343 ) ) ;
}
if ( strstr ( V_207 , L_29 ) == V_207 ) {
int V_38 = strlen ( V_207 ) ;
int V_344 = strlen ( L_30 ) ;
memmove ( V_207 , V_207 + V_344 , V_38 - V_344 + 1 ) ;
}
if ( strstr ( V_207 , L_31 ) == V_207 ) {
int V_38 = strlen ( V_207 ) ;
int V_344 = strlen ( L_32 ) ;
memmove ( V_207 , V_207 + V_344 , V_38 - V_344 + 1 ) ;
}
...
if ( V_16 -> V_346 ) {
V_16 -> V_160 -> V_346 = true ;
V_16 -> V_160 -> V_347 = true ;
}
if ( V_16 -> V_160 -> V_346 &&
V_16 -> V_160 -> V_97 ) {
F_141 ( V_348 , V_16 -> V_160 -> V_97 -> V_349 ) ;
F_142 ( V_16 -> V_160 -> V_97 , V_348 ,
V_350 ) ;
}
}
static int F_143 ( struct V_14 * V_14 , bool V_351 )
{
struct V_16 * V_16 = & V_14 -> V_16 ;
struct V_32 * V_33 = & V_16 -> V_33 ;
struct V_1 * V_2 = V_14 -> V_2 ;
...
{
struct V_14 * V_14 = F_43 ( V_251 , struct V_14 , V_362 ) ;
struct V_363 * V_364 = V_14 -> V_364 ;
struct V_16 * V_16 = & V_14 -> V_16 ;
struct V_1 * V_365 , * V_366 ;
struct V_14 * V_367 , * V_368 ;
struct V_16 * V_369 , * V_370 ;
int error ;
F_105 ( V_14 ) ;
V_365 = F_150 ( V_364 -> V_371 -> V_372 [ 1 ] ) ;
V_367 = F_6 ( V_365 ) ;
V_369 = & ( V_367 -> V_16 ) ;
F_139 ( V_367 ) ;
V_366 = F_150 ( V_364 -> V_371 -> V_372 [ 2 ] ) ;
V_368 = F_6 ( V_366 ) ;
V_370 = & ( V_368 -> V_16 ) ;
F_139 ( V_368 ) ;
if ( V_16 -> V_170 == 0 ) {
...
V_369 -> V_33 =
* ( (struct V_32 * ) V_42 -> V_376 ) ;
V_369 -> V_170 = V_16 -> V_170 ;
F_148 ( V_365 ) ;
error = F_143 ( V_367 , true ) ;
if ( error )
goto V_336;
if ( V_369 -> V_33 . V_40 ||
( V_369 -> V_33 . type >= V_377 &&
V_369 -> V_33 . type <= V_71 ) ) {
V_370 -> V_33 =
* ( (struct V_32 * ) V_42 -> V_376 ) ;
V_370 -> V_170 = V_16 -> V_170 ;
F_148 ( V_366 ) ;
error = F_143 ( V_368 , true ) ;
if ( error )
goto V_336;
}
F_138 ( V_16 -> V_207 , V_369 -> V_207 ,
sizeof( V_16 -> V_207 ) ) ;
error = F_104 ( V_14 ) ;
if ( error )
goto V_336;
...
static void F_151 ( struct V_14 * V_14 , unsigned int V_301 )
{
struct V_305 * V_306 = V_14 -> V_306 ;
T_6 V_304 = V_306 -> V_307 [ V_301 ] . V_304 ;
int V_76 ;
unsigned long V_221 ;
F_152 ( & V_306 -> V_314 , V_221 ) ;
V_306 -> V_307 [ V_301 ] . V_378 = false ;
F_153 ( & V_306 -> V_314 , V_221 ) ;
...
V_306 -> V_307 [ V_76 ] . V_304 = 0 ;
V_306 -> V_307 [ V_76 ] . V_206 . V_207 = NULL ;
V_306 -> V_307 [ V_76 ] . V_378 = false ;
V_306 -> V_307 [ V_76 ] . V_260 . V_260 = NULL ;
V_14 -> V_167 . V_168 [ V_76 ] . V_176 = V_323 ;
}
}
}
static int F_154 ( struct V_14 * V_14 , T_6 V_304 ,
unsigned int V_301 )
{
struct V_305 * V_306 = V_14 -> V_306 ;
struct V_193 * V_19 = & V_14 -> V_2 -> V_19 ;
int error , V_379 ;
for ( V_379 = 0 ; V_379 < V_322 ; V_379 ++ ) {
if ( V_306 -> V_307 [ V_379 ] . V_304 == V_304 )
break;
}
if ( V_379 < V_322 ) {
...
if ( error )
goto V_336;
V_306 -> V_307 [ V_301 ] . V_380 = F_123 ( V_14 ) ;
if ( ! V_306 -> V_307 [ V_301 ] . V_380 ) {
error = - V_113 ;
goto V_336;
}
V_306 -> V_307 [ V_301 ] . V_380 -> V_326 = V_306 -> V_307 [ V_301 ] . V_206 . V_207 ;
V_306 -> V_307 [ V_301 ] . V_380 -> V_207 = V_14 -> V_16 . V_332 ;
if ( ! V_306 -> V_307 [ V_301 ] . V_380 -> V_207 ) {
error = - V_115 ;
goto V_336;
}
error = F_132 ( V_306 -> V_307 [ V_301 ] . V_380 ,
& V_14 -> V_16 ) ;
if ( error )
goto V_336;
V_306 -> V_307 [ V_301 ] . V_304 = V_304 ;
error = F_130 ( V_306 -> V_307 [ V_301 ] . V_380 ) ;
if ( error )
goto V_336;
error = F_79 (
& V_306 -> V_307 [ V_301 ] . V_380 -> V_19 ,
V_14 , V_301 , 3 , true ) ;
if ( error )
goto V_336;
V_306 -> V_307 [ V_301 ] . V_378 = true ;
...
static int F_155 ( struct V_14 * V_14 , int V_301 )
{
struct V_305 * V_306 = V_14 -> V_306 ;
int error ;
if ( ! V_306 -> V_307 [ V_301 ] . V_378 )
return 0 ;
if ( V_306 -> V_307 [ V_301 ] . V_260 . V_260 )
return 0 ;
if ( V_14 -> V_167 . V_168 [ V_301 ] . V_176 == V_323 )
return 0 ;
error = F_96 ( V_14 ,
...
{
struct V_14 * V_14 = F_43 ( V_251 , struct V_14 , V_381 ) ;
struct V_305 * V_306 = V_14 -> V_306 ;
struct V_315 V_17 ;
unsigned long V_221 ;
unsigned int V_195 ;
...
int V_76 ;
F_152 ( & V_306 -> V_314 , V_221 ) ;
V_195 = F_157 ( & V_306 -> V_313 , & V_17 , sizeof( V_17 ) ) ;
...
if ( ! F_158 ( & V_306 -> V_313 ) )
F_159 ( & V_14 -> V_16 , V_382 ) ;
F_153 ( & V_306 -> V_314 , V_221 ) ;
for ( V_76 = 0 ; V_76 < V_322 ; V_76 ++ ) {
V_304 = V_17 . V_306 [ V_76 ] . V_304 ;
if ( V_17 . V_306 [ V_76 ] . V_383 ) {
if ( V_306 -> V_307 [ V_76 ] . V_304 == V_304 ) {
F_155 ( V_14 , V_76 ) ;
continue;
}
...
{
struct V_14 * V_14 = F_43 ( V_251 , struct V_14 , V_384 ) ;
struct V_385 * V_160 = V_14 -> V_16 . V_160 ;
struct V_14 * V_367 = NULL ;
struct V_14 * V_368 = NULL ;
bool V_386 = V_14 -> V_16 . V_95 ;
int error = 0 ;
if ( V_160 -> V_67 ) {
V_367 = F_6 ( V_160 -> V_67 ) ;
F_139 ( V_367 ) ;
F_148 ( V_367 -> V_2 ) ;
V_367 -> V_16 . V_94 = true ;
V_367 -> V_16 . V_95 = V_386 ;
}
if ( V_160 -> V_161 ) {
V_368 = F_6 ( V_160 -> V_161 ) ;
F_139 ( V_368 ) ;
F_148 ( V_368 -> V_2 ) ;
V_368 -> V_16 . V_94 = true ;
V_368 -> V_16 . V_95 = V_386 ;
}
if ( V_367 ) {
error = F_143 ( V_367 , false ) ;
if ( error )
return;
}
if ( V_368 ) {
error = F_143 ( V_368 , false ) ;
if ( error )
return;
}
return;
...
const struct V_373 * V_42 )
{
struct V_128 * V_129 = F_162 ( V_2 -> V_19 . V_302 ) ;
struct V_363 * V_19 = F_163 ( V_129 ) ;
struct V_14 * V_14 ;
struct V_16 * V_16 ;
struct V_32 * V_33 ;
int error ;
...
V_14 -> V_2 = V_2 ;
V_16 = & V_14 -> V_16 ;
V_16 -> V_33 = * ( (struct V_32 * ) V_42 -> V_376 ) ;
V_33 = & V_16 -> V_33 ;
if ( V_33 -> V_389 && V_33 -> V_390 != V_2 -> type ) {
error = - V_358 ;
goto V_336;
}
V_16 -> V_34 . V_48 = - 1 ;
...
F_167 ( & V_14 -> V_362 , F_149 ) ;
F_167 ( & V_14 -> V_339 , F_135 ) ;
F_167 ( & V_14 -> V_381 , F_156 ) ;
F_167 ( & V_14 -> V_384 , F_160 ) ;
error = F_168 ( V_2 ) ;
if ( error ) {
F_3 ( V_2 , L_48 ) ;
goto V_336;
