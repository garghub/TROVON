...
static int F_35 ( struct V_2 * V_3 , char * V_30 )
{
...
static inline void F_39 ( struct V_1 * V_8 ,
struct V_2 * V_3 )
{
...
static void F_45 ( struct V_35 * V_36 )
{
struct V_90 * V_91 ;
struct V_1 * V_92 ;
int V_42 ;
...
static int F_50 ( struct V_35 * V_36 , const struct V_94 * V_95 )
{
struct V_90 * V_4 ;
struct V_1 * V_8 ;
void T_3 * V_58 ;
...
V_96 = - V_113 ;
V_4 -> V_114 = ( V_115 * ) F_62 ( V_36 ,
V_66 * sizeof( V_115 ) , & V_4 -> V_116 ) ;
if ( ! V_4 -> V_114 )
goto V_117;
F_5 ( V_4 -> V_116 , V_58 + V_118 ) ;
for ( V_42 = 0 ; V_42 < V_93 ; V_42 ++ ) {
V_8 = V_4 -> V_92 + V_42 ;
V_8 -> V_70 = ( V_115 * ) F_62 ( V_36 ,
...
F_20 ( V_36 , V_66 * sizeof( T_1 ) , V_4 -> V_114 ,
V_4 -> V_116 ) ;
V_117:
...
static void F_77 ( unsigned long V_46 )
{
...
static void F_82 ( struct V_35 * V_36 , void T_3 * V_58 )
{
int V_42 ;
F_83 ( & V_167 ) ;
...
static int F_93 ( struct V_1 * V_8 , struct V_2 * V_3 )
{
}
static T_7 V_151 ( struct V_40 * V_53 ,
struct V_2 * V_3 )
{
struct V_1 * V_8 = F_1 ( V_3 ) ;
...
V_8 -> V_45 [ V_184 ] = V_53 ;
V_38 = V_8 -> V_38 + V_184 ;
V_38 -> V_10 = V_185 | F_94 ( V_53 -> V_47 ) ;
...
static inline int F_102 ( int V_188 )
{
int V_31 = 0 ;
#ifdef F_103
if ( V_188 >= 2 )
...
static int F_104 ( struct V_2 * V_3 , T_1 * V_189 , T_1 * V_10 )
{
struct V_1 * V_8 = F_1 ( V_3 ) ;
int V_31 = - 1 ;
T_1 V_190 ;
...
static int F_105 ( struct V_2 * V_3 , struct V_198 * V_199 , int V_200 )
{
T_6 T_8 * line = V_199 -> V_201 . V_202 . V_203 ;
struct V_1 * V_8 = F_1 ( V_3 ) ;
const T_9 V_204 = sizeof( V_8 -> V_163 ) ;
int V_31 = 0 ;
if ( V_3 -> V_67 & V_205 )
return - V_206 ;
if ( V_200 != V_207 )
...
if ( F_108 ( & V_8 -> V_163 , line , V_204 ) )
return - V_211 ;
V_31 = F_109 ( V_8 , V_3 ) ;
break;
default:
V_31 = F_110 ( V_3 , V_199 , V_200 ) ;
break;
}
return V_31 ;
}
static int F_111 ( const struct V_214 * V_5 , int V_7 )
{
int V_42 ;
...
static int F_109 ( struct V_1 * V_8 , struct V_2 * V_3 )
{
struct {
int (* F_116)( struct V_1 * , struct V_2 * );
} * V_5 , V_226 [] = {
{ F_113 } ,
{ F_112 } ,
{ F_114 } ,
...
int V_31 = 0 ;
for ( V_5 = V_226 ; V_5 -> F_116 ; V_5 ++ ) {
if ( ( V_31 = V_5 -> F_116 ( V_8 , V_3 ) ) < 0 )
break;
}
return V_31 ;
}
static T_10 V_106 ( int V_103 , void * V_227 )
{
...
if ( V_4 -> V_114 [ V_4 -> V_230 ++ % V_66 ] & F_28 ( V_63 ) )
F_34 ( V_3 , L_35 ) ;
if ( ! ( V_10 &= ~ V_229 ) )
goto V_98;
}
...
static void F_118 ( struct V_90 * V_4 ,
struct V_1 * V_8 )
{
struct V_2 * V_3 = F_3 ( V_8 ) ;
T_1 V_10 ;
...
static struct V_40 * F_126 ( struct V_1 * V_8 )
{
struct V_40 * V_53 ;
V_53 = F_26 ( V_239 ) ;
if ( V_53 ) {
...
F_20 ( V_36 , V_66 * sizeof( T_1 ) , V_91 -> V_114 ,
V_91 -> V_116 ) ;
for ( V_42 = 0 ; V_42 < V_93 ; V_42 ++ ) {
struct V_1 * V_8 = V_92 + V_42 ;
F_19 ( V_8 ) ;
...
static int T_11 F_130 ( char * V_278 )
{
int * args [] = { & V_32 , & V_159 , NULL } , * * V_5 = args ;
while ( * V_5 && ( F_131 ( & V_278 , * V_5 ) == 2 ) )
V_5 ++ ;
return 1 ;
}
