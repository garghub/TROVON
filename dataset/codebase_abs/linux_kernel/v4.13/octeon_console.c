...
struct V_97 * V_98 ;
T_1 V_29 , V_99 ;
if ( V_7 < sizeof( struct V_97 ) ) {
F_11 ( & V_4 -> V_20 -> V_21 , L_18 ,
( T_1 ) V_7 ,
( T_1 ) sizeof( struct V_97 ) ) ;
return - V_100 ;
}
V_98 = (struct V_97 * ) V_93 ;
if ( F_42 ( V_98 -> V_101 ) != V_102 ) {
F_11 ( & V_4 -> V_20 -> V_21 , L_19 ) ;
return - V_100 ;
}
V_94 = F_43 ( ( unsigned int ) ~ 0 , V_93 ,
sizeof( struct V_97 ) -
sizeof( T_1 ) ) ^ ~ 0U ;
if ( V_94 != F_42 ( V_98 -> F_43 ) ) {
F_11 ( & V_4 -> V_20 -> V_21 , L_20 ,
V_94 , F_42 ( V_98 -> F_43 ) ) ;
return - V_100 ;
}
if ( strncmp ( V_103 , V_98 -> V_104 , strlen ( V_103 ) ) ) {
F_11 ( & V_4 -> V_20 -> V_21 , L_21 ,
V_103 , V_98 -> V_104 ) ;
return - V_100 ;
}
if ( memcmp ( V_105 , V_98 -> V_104 + strlen ( V_103 ) ,
strlen ( V_105 ) ) ) {
F_11 ( & V_4 -> V_20 -> V_21 , L_22 ,
V_105 ,
V_98 -> V_104 + strlen ( V_103 ) ) ;
return - V_100 ;
}
if ( F_42 ( V_98 -> V_106 ) > V_107 ) {
F_11 ( & V_4 -> V_20 -> V_21 , L_23 ,
F_42 ( V_98 -> V_106 ) ) ;
return - V_100 ;
}
F_28 ( & V_4 -> V_20 -> V_21 , L_24 , V_98 -> V_104 ) ;
snprintf ( V_4 -> V_108 . V_109 , 32 , L_25 ,
V_98 -> V_104 ) ;
V_93 += sizeof( struct V_97 ) ;
F_28 ( & V_4 -> V_20 -> V_21 , L_26 , V_22 ,
F_42 ( V_98 -> V_106 ) ) ;
for ( V_29 = 0 ; V_29 < F_42 ( V_98 -> V_106 ) ; V_29 ++ ) {
V_95 = F_44 ( V_98 -> V_24 [ V_29 ] . V_8 ) ;
V_96 = F_42 ( V_98 -> V_24 [ V_29 ] . V_10 ) ;
