...
static int F_20 ( struct V_43 * V_11 )
{
enum V_44 type = F_21 ( V_11 ) -> V_45 ;
struct V_1 * V_2 ;
struct V_5 * V_6 ;
int V_7 ;
V_2 = F_22 ( & V_11 -> V_46 , sizeof( * V_6 ) ) ;
if ( V_2 == NULL ) {
F_23 ( & V_11 -> V_46 , L_1 ) ;
return - V_47 ;
}
...
V_6 -> V_11 = V_11 ;
V_6 -> V_34 = & V_48 [ type ] ;
V_2 -> V_46 . V_49 = & V_11 -> V_46 ;
V_2 -> V_50 = F_21 ( V_11 ) -> V_50 ;
V_2 -> V_21 = & V_51 ;
V_2 -> V_52 = V_53 ;
V_2 -> V_54 = V_55 ;
V_2 -> V_56 = V_6 -> V_34 -> V_56 ;
if ( V_6 -> V_34 -> V_35 == 0 ) {
V_6 -> V_36 [ 0 ] . V_57 = L_2 ;
V_6 -> V_36 [ 1 ] . V_57 = L_3 ;
V_7 = F_25 ( & V_6 -> V_11 -> V_46 ,
...
static int F_29 ( struct V_43 * V_11 )
{
struct V_1 * V_2 = F_30 ( V_11 ) ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_31 ( V_2 ) ;
if ( V_6 -> V_34 -> V_35 == 0 )
F_28 ( F_9 ( V_6 -> V_36 ) , V_6 -> V_36 ) ;
