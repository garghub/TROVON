...
static int F_24 ( struct V_23 * V_24 , T_4 V_41 )
{
struct V_27 * V_38 ;
struct V_22 * V_25 ;
int V_16 ;
...
int F_25 ( struct V_23 * V_24 , T_4 V_67 )
{
struct V_27 * V_38 ;
struct V_22 * V_25 ;
int V_16 ;
...
if ( V_71 || V_24 != V_68 )
return 0 ;
return F_24 ( V_24 , V_72 ) ;
}
int F_27 ( struct V_23 * V_24 )
{
if ( V_71 || V_24 != V_68 )
return 0 ;
return F_24 ( V_24 , V_73 ) ;
}
...
struct V_27 * V_38 ;
struct V_22 * V_25 ;
struct V_23 * V_24 = F_18 ( V_2 , struct V_23 ,
V_49 ) ;
V_76 = sizeof( * V_38 ) - sizeof( V_38 -> V_78 . V_40 ) ;
V_77 = F_30 ( V_79 , V_24 -> V_43 -> V_80 - V_76 ) ;
if ( V_10 > V_77 ) {
F_31 ( V_2 , L_7 ,
...
V_38 -> V_41 = V_81 ;
V_38 -> V_78 . V_82 = V_10 ;
memcpy ( V_38 -> V_78 . V_40 , V_5 , V_10 ) ;
V_25 -> V_34 = V_10 + V_76 ;
V_16 = F_15 ( V_24 -> V_43 , V_25 ) ;
if ( V_16 < 0 )
goto exit;
...
bool F_36 ( struct V_23 * V_24 )
{
return ! ! F_14 ( V_24 , NULL , NULL ) ;
}
static T_5 F_37 ( struct V_83 * V_84 ,
struct V_85 * V_86 , int V_87 )
{
struct V_1 * V_2 = F_18 ( V_84 , struct V_1 , V_84 ) ;
struct V_23 * V_24 = F_18 ( V_2 ,
struct V_23 , V_49 ) ;
struct V_88 * V_89 = F_38 ( V_24 -> V_2 ) ;
struct V_90 * V_91 = V_89 -> V_2 . V_92 ;
int V_93 ;
V_93 = strcmp ( V_91 -> V_94 , V_95 ) ;
if ( V_93 != 0 )
return 0 ;
if ( F_36 ( V_24 ) ) {
V_68 = V_24 ;
