...
static unsigned int F_26 ( T_2 V_8 )
{
T_2 V_50 = ( V_8 << 9 ) + V_51 - 1 ;
return F_27 ( V_50 >> V_52 , ( T_2 ) V_53 ) ;
}
int F_28 ( struct V_5 * V_6 , T_2 V_7 ,
...
V_11 , V_10 ) ;
if ( V_36 != - V_20 || ( V_10 & V_55 ) )
goto V_56;
V_36 = 0 ;
while ( V_8 != 0 ) {
V_1 = F_1 ( V_1 , F_26 ( V_8 ) ,
V_9 ) ;
V_1 -> V_30 . V_31 = V_7 ;
V_1 -> V_32 = V_6 ;
F_14 ( V_1 , V_57 , 0 ) ;
while ( V_8 != 0 ) {
V_54 = F_27 ( ( T_2 ) V_51 , V_8 << 9 ) ;
V_33 = F_29 ( V_1 , F_30 ( 0 ) , V_54 , 0 ) ;
V_8 -= V_33 >> 9 ;
V_7 += V_33 >> 9 ;
if ( V_33 < V_54 )
break;
...
int F_31 ( struct V_5 * V_6 , T_2 V_7 ,
