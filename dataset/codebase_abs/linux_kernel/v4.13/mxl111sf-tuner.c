...
static int F_13 ( struct V_28 * V_29 , T_2 * V_53 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
int V_54 , V_55 , V_20 ;
* V_53 = 0 ;
V_20 = F_11 ( V_2 , & V_54 , & V_55 ) ;
if ( F_9 ( V_20 ) )
goto V_25;
F_14 ( L_7 , V_54 ? L_8 : L_9 ,
V_55 ? L_10 : L_9 ) ;
if ( ( V_54 ) || ( V_55 ) )
* V_53 |= V_56 ;
V_25:
...
static int F_15 ( struct V_28 * V_29 , T_3 * V_57 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
T_1 V_58 , V_59 ;
int V_20 ;
...
if ( F_9 ( V_20 ) )
goto V_25;
V_20 = F_1 ( V_2 , V_61 , & V_59 ) ;
if ( F_9 ( V_20 ) )
goto V_25;
* V_57 = V_58 | ( ( V_59 & 0x07 ) << 8 ) ;
V_25:
V_20 = F_2 ( V_2 , 0x00 , 0x00 ) ;
F_9 ( V_20 ) ;
return V_20 ;
}
static int F_16 ( struct V_28 * V_29 , T_2 * V_51 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
* V_51 = V_2 -> V_51 ;
return 0 ;
}
static int F_17 ( struct V_28 * V_29 , T_2 * V_52 )
{
struct V_1 * V_2 = V_29 -> V_30 ;
* V_52 = V_2 -> V_52 ;
return 0 ;
...
struct V_74 * V_7 ,
const struct V_75 * V_5 )
{
struct V_1 * V_2 = NULL ;
F_8 ( L_4 ) ;
V_2 = F_22 ( sizeof( struct V_1 ) , V_76 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_7 = V_7 ;
V_2 -> V_5 = V_5 ;
memcpy ( & V_29 -> V_77 . V_78 , & V_79 ,
sizeof( struct V_80 ) ) ;
V_29 -> V_30 = V_2 ;
return V_29 ;
}
