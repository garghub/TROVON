...
V_11 . V_48 = V_14 -> V_35 ;
V_11 . V_33 = V_35 ;
V_11 . V_49 = F_28 ( V_26 -> V_44 -> V_45 ,
V_26 -> V_44 -> V_46 , V_35 - V_14 -> V_35 ) ;
V_11 . V_50 = V_11 . V_49 * ( V_26 -> V_44 -> V_51 - 1 )
+ 2 * V_26 -> V_44 -> V_52 ;
V_41 = V_14 ;
V_42 = 0 ;
V_32 = V_35 - V_11 . V_50 ;
F_29 (p2, &pde->pulses, head) {
T_1 V_5 ;
if ( V_41 -> V_35 < V_32 )
break;
...
static T_1
F_30 ( struct V_25 * V_26 , T_2 V_35 )
{
T_1 V_38 = 0 ;
...
static void F_32 ( struct V_25 * V_26 , T_2 V_35 )
{
struct V_10 * V_11 , * V_12 ;
struct V_13 * V_14 , * V_15 ;
...
static void F_33 ( struct V_25 * V_59 )
{
F_32 ( V_59 , 0 ) ;
F_6 () ;
F_10 ( V_59 ) ;
}
static struct V_10 * F_34 ( struct V_25 * V_59 ,
struct V_60 * V_61 )
{
T_1 V_62 ;
struct V_10 * V_11 ;
...
return NULL ;
if ( V_44 -> V_67 && V_44 -> V_67 != V_61 -> V_67 )
return NULL ;
V_59 -> V_33 = V_35 ;
V_62 = F_30 ( V_59 , V_35 ) ;
...
struct V_25 * F_35 ( const struct V_63 * V_44 )
{
struct V_25 * V_59 ;
V_59 = F_36 ( sizeof( * V_59 ) , V_36 ) ;
if ( V_59 == NULL )
return NULL ;
V_59 -> exit = F_33 ;
V_59 -> V_68 = F_34 ;
