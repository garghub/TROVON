...
for ( V_5 = 0 ; V_5 < F_3 ( V_45 -> V_66 ) ; V_5 ++ ) {
if ( ! V_45 -> V_66 [ V_5 ] )
continue;
V_43 = F_6 ( V_18 , V_20 ,
V_45 -> V_66 [ V_5 ] , V_48 ) ;
...
static int F_25 ( struct V_67 * V_30 , void * V_68 )
{
F_26 ( F_27 ( V_30 ) ) ;
return 0 ;
}
...
if ( V_20 -> V_57 )
V_71 |= V_73 ;
F_34 ( V_20 -> V_74 + V_75 , V_76 | V_77 ) ;
F_34 ( V_20 -> V_74 + V_78 , V_71 ) ;
}
return 0 ;
}
