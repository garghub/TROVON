...
if ( ! V_21 )
V_21 ++ ;
return V_27 * V_19 * V_20 / V_21 ;
}
static unsigned long F_11 ( struct V_33 * V_34 ,
struct V_22 * V_23 ,
unsigned long * V_27 ,
unsigned long V_2 ,
void * V_35 )
{
struct V_24 * V_4 = V_35 ;
struct V_3 V_36 ;
V_36 . V_14 = V_4 -> V_19 . V_37 ? : 1 ;
V_36 . V_15 = V_4 -> V_19 . V_38 ? : 1 << V_4 -> V_19 . V_31 ;
V_36 . V_12 = V_4 -> V_20 . V_37 ? : 1 ;
V_36 . V_13 = V_4 -> V_20 . V_38 ? : 1 << V_4 -> V_20 . V_31 ;
V_36 . V_16 = 1 ;
V_36 . V_17 = V_4 -> V_21 . V_38 ? : 1 << V_4 -> V_21 . V_31 ;
F_1 ( * V_27 , V_2 , & V_36 ) ;
return * V_27 * V_36 . V_19 * V_36 . V_20 / V_36 . V_21 ;
}
static int F_12 ( struct V_22 * V_23 ,
struct V_39 * V_40 )
{
struct V_24 * V_4 = F_3 ( V_23 ) ;
return F_13 ( & V_4 -> V_25 , & V_4 -> V_34 ,
V_40 , F_11 , V_4 ) ;
}
...
V_28 |= ( V_36 . V_19 - V_4 -> V_19 . V_32 ) << V_4 -> V_19 . V_30 ;
V_28 |= ( V_36 . V_20 - V_4 -> V_20 . V_32 ) << V_4 -> V_20 . V_30 ;
V_28 |= ( V_36 . V_21 - V_4 -> V_21 . V_32 ) << V_4 -> V_21 . V_30 ;
F_17 ( V_28 , V_4 -> V_25 . V_29 + V_4 -> V_25 . V_28 ) ;
F_18 ( V_4 -> V_25 . V_42 , V_41 ) ;
F_19 ( & V_4 -> V_25 , V_4 -> V_42 ) ;
return 0 ;
}
static T_2 F_20 ( struct V_22 * V_23 )
{
struct V_24 * V_4 = F_3 ( V_23 ) ;
return F_21 ( & V_4 -> V_25 , & V_4 -> V_34 ) ;
}
static int F_22 ( struct V_22 * V_23 , T_2 V_43 )
{
struct V_24 * V_4 = F_3 ( V_23 ) ;
return F_23 ( & V_4 -> V_25 , & V_4 -> V_34 , V_43 ) ;
}
