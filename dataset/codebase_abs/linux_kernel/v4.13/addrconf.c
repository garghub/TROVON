...
static inline bool F_171 ( struct V_8 * V_9 )
{
#ifdef F_172
return V_9 && V_9 -> V_43 . V_250 && V_9 -> V_43 . V_251 ;
#else
return false ;
#endif
}
...
F_287 ( V_9 , & V_459 , 128 , V_300 ) ;
F_97 (dev_net(dev), sp_dev) {
if ( ! strcmp ( V_456 -> V_56 , V_11 -> V_56 ) )
continue;
V_9 = F_58 ( V_456 ) ;
if ( ! V_9 )
continue;
F_183 ( & V_9 -> V_40 ) ;
F_93 (sp_ifa, &idev->addr_list, if_list) {
if ( V_457 -> V_59 & ( V_304 | V_153 ) )
continue;
if ( V_457 -> V_6 ) {
if ( ! F_86 ( & V_457 -> V_6 -> V_460 ) ) {
F_112 ( V_457 -> V_6 ) ;
V_457 -> V_6 = NULL ;
} else {
continue;
...
V_458 = F_130 ( V_9 , & V_457 -> V_169 , false ) ;
if ( ! F_59 ( V_458 ) ) {
V_457 -> V_6 = V_458 ;
F_292 ( V_458 ) ;
}
...
static bool F_294 ( struct V_171 V_461 )
{
if ( ( V_461 . V_417 [ 2 ] | V_461 . V_417 [ 3 ] ) == 0 )
return true ;
if ( V_461 . V_417 [ 2 ] == F_249 ( 0x02005eff ) &&
( ( V_461 . V_417 [ 3 ] & F_249 ( 0xfe000000 ) ) == F_249 ( 0xfe000000 ) ) )
return true ;
if ( V_461 . V_417 [ 2 ] == F_249 ( 0xfdffffff ) &&
( ( V_461 . V_417 [ 3 ] & F_249 ( 0xffffff80 ) ) == F_249 ( 0xffffff80 ) ) )
return true ;
return false ;
}
static int F_210 ( struct V_171 * V_461 ,
T_5 V_462 ,
const struct V_8 * V_9 )
{
static F_295 ( V_40 ) ;
static V_244 V_463 [ V_464 ] ;
static V_244 V_465 [ V_466 ] ;
static union {
char V_467 [ V_468 ] ;
struct {
struct V_171 V_469 ;
T_6 V_390 [ 2 ] ;
unsigned char V_470 [ V_471 ] ;
T_5 V_462 ;
} V_472 ;
} V_473 ;
struct V_171 V_469 ;
struct V_171 V_474 ;
struct V_115 * V_115 = F_38 ( V_9 -> V_11 ) ;
F_296 ( sizeof( V_473 . V_467 ) != sizeof( V_473 ) ) ;
if ( V_9 -> V_43 . V_45 . V_46 )
V_469 = V_9 -> V_43 . V_45 . V_469 ;
else if ( V_115 -> V_22 . V_44 -> V_45 . V_46 )
V_469 = V_115 -> V_22 . V_44 -> V_45 . V_469 ;
else
return - 1 ;
V_237:
F_152 ( & V_40 ) ;
...
memcpy ( V_473 . V_470 , V_9 -> V_11 -> V_335 , V_9 -> V_11 -> V_324 ) ;
V_473 . V_390 [ 0 ] = V_461 -> V_417 [ 0 ] ;
V_473 . V_390 [ 1 ] = V_461 -> V_417 [ 1 ] ;
V_473 . V_469 = V_469 ;
V_473 . V_462 = V_462 ;
F_298 ( V_463 , V_473 . V_467 , V_465 ) ;
V_474 = * V_461 ;
V_474 . V_417 [ 2 ] = ( V_425 T_6 ) V_463 [ 0 ] ;
V_474 . V_417 [ 3 ] = ( V_425 T_6 ) V_463 [ 1 ] ;
F_153 ( & V_40 ) ;
if ( F_294 ( V_474 ) ) {
V_462 ++ ;
if ( V_462 > F_38 ( V_9 -> V_11 ) -> V_22 . V_314 . V_315 )
return - 1 ;
goto V_237;
}
* V_461 = V_474 ;
...
{
struct V_475 * V_476 = & V_9 -> V_43 . V_45 ;
if ( V_476 -> V_46 )
return;
V_476 = & V_9 -> V_43 . V_45 ;
F_167 ( & V_476 -> V_469 , sizeof( V_476 -> V_469 ) ) ;
V_476 -> V_46 = true ;
}
static void F_300 ( struct V_8 * V_9 , bool V_477 )
{
struct V_171 V_169 ;
if ( F_251 ( V_9 -> V_11 ) )
return;
...
struct V_13 * V_14 )
{
if ( ! V_14 -> V_6 || ! F_86 ( & V_14 -> V_6 -> V_460 ) ) {
struct V_178 * V_6 , * V_480 ;
...
return;
F_155 ( & V_9 -> V_40 ) ;
F_306 (ifp, tmp, &idev->addr_list, if_list) {
if ( ( V_14 -> V_59 & V_211 ) &&
F_304 ( V_9 , V_14 ) < 0 ) {
F_158 ( & V_9 -> V_40 ) ;
F_151 ( V_14 ) ;
...
static int F_307 ( struct V_481 * V_482 , unsigned long V_102 ,
void * V_483 )
{
struct V_10 * V_11 = F_308 ( V_483 ) ;
struct V_484 * V_485 ;
...
V_9 = F_32 ( V_11 ) ;
if ( F_59 ( V_9 ) )
return F_309 ( F_131 ( V_9 ) ) ;
}
break;
case V_488 :
if ( V_11 -> V_37 < V_38 ) {
F_310 ( V_11 , V_11 != V_115 -> V_489 ) ;
break;
}
if ( V_9 ) {
F_311 ( V_11 , V_11 -> V_37 ) ;
...
case V_499 :
V_485 = V_483 ;
if ( V_485 -> V_500 && F_251 ( V_485 -> V_500 ) )
F_310 ( V_11 , 0 ) ;
}
return V_501 ;
}
static void F_314 ( struct V_10 * V_11 , unsigned long V_102 )
{
struct V_8 * V_9 ;
F_33 () ;
V_9 = F_58 ( V_11 ) ;
...
static bool F_317 ( const struct V_171 * V_169 )
{
return F_123 ( V_169 ) &
( V_391 | V_185 ) ;
}
static int F_310 ( struct V_10 * V_11 , int V_502 )
{
struct V_115 * V_115 = F_38 ( V_11 ) ;
struct V_8 * V_9 ;
...
if ( V_502 ) {
V_9 -> V_85 = 1 ;
F_320 ( V_11 -> V_80 , NULL ) ;
F_53 ( V_9 ) ;
}
V_504 = V_115 -> V_22 . V_129 -> V_506 ;
if ( ! V_504 )
V_504 = V_9 -> V_43 . V_506 ;
V_505 = ! ( V_502 || V_504 <= 0 || V_9 -> V_43 . V_189 ) ;
for ( V_20 = 0 ; V_20 < V_507 ; V_20 ++ ) {
...
F_10 ( V_9 ) ;
if ( ! V_502 )
V_9 -> V_77 &= ~ ( V_509 | V_510 | V_78 ) ;
while ( ! F_253 ( & V_9 -> V_68 ) ) {
V_150 = F_321 ( & V_9 -> V_68 ,
struct V_13 , V_205 ) ;
F_156 ( & V_150 -> V_205 ) ;
F_158 ( & V_9 -> V_40 ) ;
F_152 ( & V_150 -> V_40 ) ;
...
V_505 = ( ! V_502 && V_504 > 0 && ! V_9 -> V_43 . V_189 ) ;
F_36 ( & V_503 ) ;
F_306 (ifa, tmp, &idev->addr_list, if_list) {
struct V_178 * V_6 = NULL ;
bool V_511 ;
F_13 ( V_150 ) ;
V_511 = V_505 && ( V_150 -> V_59 & V_211 ) &&
! F_317 ( & V_150 -> V_169 ) ;
if ( ! V_511 )
F_322 ( & V_150 -> V_170 , & V_503 ) ;
F_158 ( & V_9 -> V_40 ) ;
F_152 ( & V_150 -> V_40 ) ;
if ( V_511 ) {
V_164 = V_165 ;
...
static void V_42 ( unsigned long V_473 )
{
struct V_8 * V_9 = (struct V_8 * ) V_473 ;
...
if ( V_9 -> V_77 & V_510 )
goto V_111;
if ( V_9 -> V_513 ++ < V_9 -> V_43 . V_67 || V_9 -> V_43 . V_67 < 0 ) {
F_140 ( & V_9 -> V_40 ) ;
if ( ! F_196 ( V_11 , & V_512 , V_153 ) )
F_327 ( V_11 , & V_512 ,
& V_84 ) ;
else
goto V_401;
...
V_517 = F_3 () % ( V_9 -> V_43 . V_516 ? : 1 ) ;
V_518 = 0 ;
if ( V_9 -> V_43 . V_519 ||
F_38 ( V_9 -> V_11 ) -> V_22 . V_129 -> V_519 ) {
do
F_167 ( & V_518 , 6 ) ;
while ( V_518 == 0 );
}
V_14 -> V_520 = V_518 ;
V_14 -> V_521 = V_9 -> V_43 . V_241 ;
F_20 ( V_14 , V_517 ) ;
}
static void F_329 ( struct V_13 * V_14 )
{
struct V_8 * V_9 = V_14 -> V_9 ;
struct V_10 * V_11 = V_9 -> V_11 ;
bool V_522 , V_523 = false ;
F_211 ( V_11 , & V_14 -> V_169 ) ;
F_330 ( ( V_425 T_1 ) V_14 -> V_169 . V_417 [ 3 ] ) ;
F_183 ( & V_9 -> V_40 ) ;
F_128 ( & V_14 -> V_40 ) ;
if ( V_14 -> V_164 == V_165 )
goto V_111;
...
static void V_199 ( struct V_525 * V_526 )
{
struct V_13 * V_14 = F_332 ( F_333 ( V_526 ) ,
struct V_13 ,
V_15 ) ;
struct V_8 * V_9 = V_14 -> V_9 ;
bool V_522 , V_189 = false ;
struct V_171 V_527 ;
enum {
V_528 ,
V_529 ,
...
V_209 = V_530 ;
V_14 -> V_164 = V_307 ;
if ( V_9 -> V_43 . V_62 > 1 && ! V_9 -> V_43 . V_189 &&
! ( V_14 -> V_59 & V_308 ) ) {
struct V_171 V_169 ;
V_169 . V_417 [ 0 ] = F_249 ( 0xfe800000 ) ;
V_169 . V_417 [ 1 ] = 0 ;
...
F_137 ( & V_14 -> V_40 ) ;
F_158 ( & V_9 -> V_40 ) ;
F_212 ( & V_14 -> V_169 , & V_527 ) ;
F_334 ( V_14 -> V_9 -> V_11 , & V_14 -> V_169 , & V_527 , & V_76 ,
V_14 -> V_520 ) ;
V_111:
F_23 ( V_14 ) ;
F_101 () ;
...
if ( V_531 -> V_175 > V_296 )
break;
if ( V_14 != V_531 && V_531 -> V_175 == V_296 &&
( V_531 -> V_59 & ( V_211 | V_153 |
V_247 | V_304 ) ) ==
V_211 )
return false ;
}
...
static void F_331 ( struct V_13 * V_14 , bool V_522 )
{
...
F_159 ( V_444 , V_14 ) ;
F_183 ( & V_14 -> V_9 -> V_40 ) ;
V_533 = V_14 -> V_175 == V_296 && F_335 ( V_14 ) ;
V_532 = V_533 &&
F_326 ( V_14 -> V_9 ) &&
...
static struct V_13 * F_337 ( struct V_535 * V_101 , T_10 V_536 )
{
struct V_13 * V_150 = NULL ;
struct V_537 * V_164 = V_101 -> V_538 ;
...
static struct V_13 * F_339 ( struct V_535 * V_101 ,
struct V_13 * V_150 )
{
struct V_537 * V_164 = V_101 -> V_538 ;
struct V_115 * V_115 = F_338 ( V_101 ) ;
...
static void * F_341 ( struct V_535 * V_101 , T_10 * V_536 )
__acquires( T_11 )
{
F_124 () ;
return F_337 ( V_101 , * V_536 ) ;
}
static void * F_342 ( struct V_535 * V_101 , void * V_541 , T_10 * V_536 )
{
struct V_13 * V_150 ;
V_150 = F_339 ( V_101 , V_541 ) ;
++ * V_536 ;
return V_150 ;
}
static void F_343 ( struct V_535 * V_101 , void * V_541 )
__releases( T_11 )
{
F_125 () ;
}
static int F_344 ( struct V_535 * V_101 , void * V_541 )
{
struct V_13 * V_14 = (struct V_13 * ) V_541 ;
F_345 ( V_101 , L_26 ,
& V_14 -> V_169 ,
V_14 -> V_9 -> V_11 -> V_97 ,
V_14 -> V_200 ,
...
static int F_346 ( struct V_542 * V_542 , struct V_543 * V_543 )
{
return F_347 ( V_542 , V_543 , & V_544 ,
sizeof( struct V_537 ) ) ;
}
static int T_12 F_348 ( struct V_115 * V_115 )
{
if ( ! F_349 ( L_27 , V_545 , V_115 -> V_546 , & V_547 ) )
return - V_34 ;
return 0 ;
}
static void T_13 F_350 ( struct V_115 * V_115 )
{
F_351 ( L_27 , V_115 -> V_546 ) ;
}
int T_14 F_352 ( void )
{
return F_353 ( & V_548 ) ;
...
{
unsigned long V_233 , V_549 , V_550 , V_551 ;
struct V_13 * V_14 ;
int V_20 ;
F_33 () ;
F_124 () ;
V_233 = V_17 ;
V_549 = F_357 ( V_233 + V_552 ) ;
F_14 ( & V_553 ) ;
for ( V_20 = 0 ; V_20 < V_507 ; V_20 ++ ) {
V_508:
...
if ( ( V_14 -> V_176 != V_443 ) &&
( F_146 ( V_14 -> V_79 + V_14 -> V_176 * V_3 , V_549 ) ) )
V_549 = V_14 -> V_79 + V_14 -> V_176 * V_3 ;
F_137 ( & V_14 -> V_40 ) ;
if ( V_554 ) {
F_21 ( V_14 ) ;
F_159 ( 0 , V_14 ) ;
...
if ( F_146 ( V_14 -> V_79 + V_14 -> V_177 * V_3 , V_549 ) )
V_549 = V_14 -> V_79 + V_14 -> V_177 * V_3 ;
if ( ! V_14 -> V_238 && V_220 ) {
V_14 -> V_238 ++ ;
F_21 ( V_14 ) ;
F_21 ( V_220 ) ;
...
} else if ( F_146 ( V_14 -> V_79 + V_14 -> V_177 * V_3 - V_229 * V_3 , V_549 ) )
V_549 = V_14 -> V_79 + V_14 -> V_177 * V_3 - V_229 * V_3 ;
F_137 ( & V_14 -> V_40 ) ;
} else {
if ( F_146 ( V_14 -> V_79 + V_14 -> V_177 * V_3 , V_549 ) )
V_549 = V_14 -> V_79 + V_14 -> V_177 * V_3 ;
...
V_550 = F_357 ( V_549 ) ;
V_551 = V_549 ;
if ( F_146 ( V_550 , V_549 + V_555 ) )
V_551 = V_550 ;
if ( F_146 ( V_551 , V_17 + V_556 ) )
V_551 = V_17 + V_556 ;
F_42 ( V_557 L_28 ,
V_233 , V_549 , V_550 , V_551 ) ;
F_22 ( V_19 , & V_553 , V_551 - V_233 ) ;
F_125 () ;
}
static void F_358 ( struct V_525 * V_526 )
{
F_269 () ;
F_281 () ;
F_101 () ;
...
static struct V_171 * F_359 ( struct V_123 * V_169 , struct V_123 * V_558 ,
struct V_171 * * V_433 )
{
...
V_345 = F_360 ( V_169 ) ;
if ( V_558 ) {
if ( V_345 && F_361 ( V_558 , V_345 , sizeof( * V_345 ) ) )
* V_433 = V_345 ;
V_345 = F_360 ( V_558 ) ;
}
return V_345 ;
...
struct V_115 * V_115 = F_78 ( V_96 -> V_122 ) ;
struct V_559 * V_560 ;
struct V_123 * V_124 [ V_561 + 1 ] ;
struct V_171 * V_345 , * V_433 ;
T_1 V_434 ;
int V_36 ;
V_36 = F_79 ( V_104 , sizeof( * V_560 ) , V_124 , V_561 , V_562 ,
V_121 ) ;
if ( V_36 < 0 )
return V_36 ;
V_560 = F_67 ( V_104 ) ;
V_345 = F_359 ( V_124 [ V_563 ] , V_124 [ V_564 ] , & V_433 ) ;
if ( ! V_345 )
return - V_39 ;
V_434 = V_124 [ V_565 ] ? F_363 ( V_124 [ V_565 ] ) : V_560 -> V_434 ;
V_434 &= V_385 ;
return F_282 ( V_115 , V_560 -> V_566 , V_434 , V_345 ,
V_560 -> V_567 ) ;
}
...
F_152 ( & V_14 -> V_40 ) ;
V_568 = V_14 -> V_59 & V_385 ;
V_569 = V_14 -> V_59 & V_211 &&
! ( V_14 -> V_59 & V_212 ) ;
...
if ( ! V_150 ) {
return F_280 ( V_115 , V_560 -> V_566 , V_345 , V_433 ,
V_560 -> V_567 , V_434 ,
V_311 , V_176 ) ;
}
if ( V_104 -> V_575 & V_576 ||
! ( V_104 -> V_575 & V_577 ) )
V_36 = - V_195 ;
else
...
static void F_366 ( struct V_103 * V_104 , T_5 V_578 , T_1 V_59 ,
T_5 V_175 , int V_97 )
{
struct V_559 * V_560 ;
V_560 = F_67 ( V_104 ) ;
...
unsigned long V_79 , T_1 V_580 , T_1 V_392 )
{
struct V_571 V_572 ;
V_572 . V_1 = F_1 ( V_1 ) ;
V_572 . V_79 = F_1 ( V_79 ) ;
V_572 . V_574 = V_580 ;
V_572 . V_573 = V_392 ;
return F_368 ( V_96 , V_570 , sizeof( V_572 ) , & V_572 ) ;
}
...
{
return F_62 ( sizeof( struct V_559 ) )
+ F_63 ( 16 )
+ F_63 ( 16 )
+ F_63 ( sizeof( struct V_571 ) )
+ F_63 ( 4 ) ;
}
...
struct V_103 * V_104 ;
T_1 V_580 , V_392 ;
V_104 = F_66 ( V_96 , V_100 , V_101 , V_102 , sizeof( struct V_559 ) , V_59 ) ;
if ( ! V_104 )
return - V_106 ;
...
V_392 = V_150 -> V_176 ;
if ( V_580 != V_443 ) {
long V_584 = ( V_17 - V_150 -> V_79 ) / V_3 ;
if ( V_580 > V_584 )
V_580 -= V_584 ;
else
V_580 = 0 ;
...
if ( F_372 ( V_96 , V_564 , & V_150 -> V_169 ) < 0 ||
F_372 ( V_96 , V_563 , & V_150 -> V_173 ) < 0 )
goto error;
} else
if ( F_372 ( V_96 , V_563 , & V_150 -> V_169 ) < 0 )
goto error;
if ( F_367 ( V_96 , V_150 -> V_1 , V_150 -> V_79 , V_580 , V_392 ) < 0 )
goto error;
if ( F_373 ( V_96 , V_565 , V_150 -> V_59 ) < 0 )
goto error;
F_69 ( V_96 , V_104 ) ;
return 0 ;
error:
...
static int F_374 ( struct V_95 * V_96 , struct V_585 * V_586 ,
T_1 V_100 , T_1 V_101 , int V_102 , T_15 V_59 )
{
struct V_103 * V_104 ;
T_5 V_175 = V_583 ;
int V_97 = V_586 -> V_9 -> V_11 -> V_97 ;
if ( F_168 ( & V_586 -> V_587 ) & V_581 )
V_175 = V_582 ;
V_104 = F_66 ( V_96 , V_100 , V_101 , V_102 , sizeof( struct V_559 ) , V_59 ) ;
if ( ! V_104 )
return - V_106 ;
F_366 ( V_104 , 128 , V_211 , V_175 , V_97 ) ;
if ( F_372 ( V_96 , V_588 , & V_586 -> V_587 ) < 0 ||
F_367 ( V_96 , V_586 -> V_589 , V_586 -> V_590 ,
V_443 , V_443 ) < 0 ) {
F_70 ( V_96 , V_104 ) ;
return - V_106 ;
}
...
static int F_375 ( struct V_95 * V_96 , struct V_591 * V_592 ,
T_1 V_100 , T_1 V_101 , int V_102 , unsigned int V_59 )
{
struct V_103 * V_104 ;
T_5 V_175 = V_583 ;
int V_97 = V_592 -> V_593 -> V_11 -> V_97 ;
if ( F_168 ( & V_592 -> V_594 ) & V_581 )
V_175 = V_582 ;
V_104 = F_66 ( V_96 , V_100 , V_101 , V_102 , sizeof( struct V_559 ) , V_59 ) ;
if ( ! V_104 )
return - V_106 ;
F_366 ( V_104 , 128 , V_211 , V_175 , V_97 ) ;
if ( F_372 ( V_96 , V_595 , & V_592 -> V_594 ) < 0 ||
F_367 ( V_96 , V_592 -> V_596 , V_592 -> V_597 ,
V_443 , V_443 ) < 0 ) {
F_70 ( V_96 , V_104 ) ;
return - V_106 ;
}
...
struct V_134 * V_135 , enum V_598 type ,
int V_599 , int * V_600 )
{
struct V_585 * V_586 ;
struct V_591 * V_592 ;
...
case V_603 :
for ( V_586 = V_9 -> V_604 ; V_586 ;
V_586 = V_586 -> V_549 , V_601 ++ ) {
if ( V_601 < V_599 )
continue;
V_36 = F_374 ( V_96 , V_586 ,
F_82 ( V_135 -> V_96 ) . V_100 ,
V_135 -> V_104 -> V_132 ,
V_605 ,
V_147 ) ;
...
break;
case V_606 :
for ( V_592 = V_9 -> V_607 ; V_592 ;
V_592 = V_592 -> V_608 , V_601 ++ ) {
if ( V_601 < V_599 )
continue;
V_36 = F_375 ( V_96 , V_592 ,
F_82 ( V_135 -> V_96 ) . V_100 ,
V_135 -> V_104 -> V_132 ,
V_609 ,
V_147 ) ;
...
if ( V_36 < 0 )
goto V_117;
V_169 = F_359 ( V_124 [ V_563 ] , V_124 [ V_564 ] , & V_610 ) ;
if ( ! V_169 ) {
V_36 = - V_39 ;
goto V_117;
}
...
int V_36 = - V_116 ;
if ( V_150 -> V_59 & V_153 && V_102 == V_221 )
return;
...
F_75 ( V_96 , V_115 , 0 , V_612 , NULL , V_131 ) ;
return;
V_117:
if ( V_36 < 0 )
F_76 ( V_115 , V_612 , V_36 ) ;
}
static inline void F_383 ( struct V_98 * V_43 ,
T_4 * V_613 , int V_614 )
{
F_384 ( V_614 < ( V_615 * 4 ) ) ;
memset ( V_613 , 0 , V_614 ) ;
V_613 [ V_616 ] = V_43 -> V_53 ;
V_613 [ V_617 ] = V_43 -> V_618 ;
V_613 [ V_619 ] = V_43 -> V_50 ;
V_613 [ V_620 ] = V_43 -> V_621 ;
V_613 [ V_622 ] = V_43 -> V_623 ;
V_613 [ V_624 ] = V_43 -> V_398 ;
V_613 [ V_625 ] = V_43 -> V_241 ;
V_613 [ V_626 ] = V_43 -> V_67 ;
V_613 [ V_627 ] =
F_385 ( V_43 -> V_534 ) ;
V_613 [ V_628 ] =
F_385 ( V_43 -> V_515 ) ;
V_613 [ V_629 ] =
F_385 ( V_43 -> V_516 ) ;
V_613 [ V_630 ] = V_43 -> V_631 ;
V_613 [ V_632 ] =
F_385 ( V_43 -> V_633 ) ;
V_613 [ V_634 ] =
F_385 ( V_43 -> V_635 ) ;
V_613 [ V_636 ] = V_43 -> V_74 ;
V_613 [ V_637 ] = V_43 -> V_245 ;
V_613 [ V_638 ] = V_43 -> V_243 ;
V_613 [ V_639 ] = V_43 -> V_239 ;
V_613 [ V_640 ] = V_43 -> V_234 ;
V_613 [ V_641 ] = V_43 -> V_317 ;
V_613 [ V_642 ] = V_43 -> V_643 ;
V_613 [ V_644 ] = V_43 -> V_645 ;
V_613 [ V_646 ] = V_43 -> V_647 ;
#ifdef F_386
V_613 [ V_648 ] = V_43 -> V_649 ;
V_613 [ V_650 ] =
F_385 ( V_43 -> V_651 ) ;
#ifdef F_387
V_613 [ V_652 ] = V_43 -> V_653 ;
V_613 [ V_654 ] = V_43 -> V_655 ;
#endif
#endif
V_613 [ V_656 ] = V_43 -> V_113 ;
V_613 [ V_657 ] = V_43 -> V_658 ;
#ifdef F_172
V_613 [ V_659 ] = V_43 -> V_250 ;
V_613 [ V_660 ] = V_43 -> V_251 ;
#endif
#ifdef F_64
V_613 [ V_661 ] = V_43 -> V_112 ;
#endif
V_613 [ V_662 ] = V_43 -> V_189 ;
V_613 [ V_663 ] = V_43 -> V_62 ;
V_613 [ V_664 ] = V_43 -> V_665 ;
V_613 [ V_666 ] = V_43 -> V_667 ;
V_613 [ V_668 ] = V_43 -> V_669 ;
V_613 [ V_670 ] = V_43 -> V_671 ;
V_613 [ V_672 ] = V_43 -> V_673 ;
V_613 [ V_674 ] = V_43 -> V_114 ;
V_613 [ V_675 ] = V_43 -> V_293 ;
V_613 [ V_676 ] = V_43 -> V_677 ;
V_613 [ V_678 ] = V_43 -> V_679 ;
V_613 [ V_680 ] = V_43 -> V_506 ;
V_613 [ V_681 ] = V_43 -> V_682 ;
#ifdef F_388
V_613 [ V_683 ] = V_43 -> V_684 ;
#endif
V_613 [ V_685 ] = V_43 -> V_519 ;
V_613 [ V_686 ] = V_43 -> V_47 ;
V_613 [ V_687 ] = V_43 -> V_196 ;
}
static inline T_16 F_389 ( void )
{
return F_63 ( 4 )
+ F_63 ( sizeof( struct V_688 ) )
+ F_63 ( V_615 * 4 )
+ F_63 ( V_689 * 8 )
+ F_63 ( V_690 * 8 )
...
{
return F_62 ( sizeof( struct V_691 ) )
+ F_63 ( V_692 )
+ F_63 ( V_471 )
+ F_63 ( 4 )
+ F_63 ( 4 )
...
static inline void F_391 ( T_3 * V_21 , T_17 * V_693 ,
int V_614 )
{
int V_20 ;
int V_694 = V_614 - sizeof( T_3 ) * V_690 ;
F_384 ( V_694 < 0 ) ;
F_392 ( V_690 , & V_21 [ 0 ] ) ;
for ( V_20 = 1 ; V_20 < V_690 ; V_20 ++ )
F_392 ( F_393 ( & V_693 [ V_20 ] ) , & V_21 [ V_20 ] ) ;
memset ( & V_21 [ V_690 ] , 0 , V_694 ) ;
}
static inline void F_394 ( T_3 * V_21 , void T_18 * V_693 ,
int V_614 , T_16 V_695 )
{
int V_20 , V_696 ;
T_3 V_697 [ V_689 ] ;
int V_694 = V_614 - sizeof( T_3 ) * V_689 ;
F_384 ( V_694 < 0 ) ;
memset ( V_697 , 0 , sizeof( V_697 ) ) ;
V_697 [ 0 ] = V_689 ;
F_26 (c) {
for ( V_20 = 1 ; V_20 < V_689 ; V_20 ++ )
V_697 [ V_20 ] += F_395 ( V_693 , V_696 , V_20 , V_695 ) ;
}
memcpy ( V_21 , V_697 , V_689 * sizeof( T_3 ) ) ;
memset ( & V_21 [ V_689 ] , 0 , V_694 ) ;
}
static void F_396 ( T_3 * V_21 , struct V_8 * V_9 , int V_698 ,
int V_614 )
{
switch ( V_698 ) {
case V_699 :
F_394 ( V_21 , V_9 -> V_21 . V_22 , V_614 ,
F_397 ( struct V_23 , V_26 ) ) ;
break;
case V_700 :
F_391 ( V_21 , V_9 -> V_21 . V_27 -> V_701 , V_614 ) ;
break;
}
}
...
struct V_123 * V_703 ;
struct V_688 V_572 ;
if ( F_373 ( V_96 , V_704 , V_9 -> V_77 ) )
goto V_110;
V_572 . V_705 = V_706 ;
V_572 . V_79 = F_1 ( V_9 -> V_79 ) ;
V_572 . V_707 = F_385 ( V_9 -> V_51 -> V_707 ) ;
V_572 . V_708 = F_385 ( F_163 ( V_9 -> V_51 , V_242 ) ) ;
if ( F_368 ( V_96 , V_709 , sizeof( V_572 ) , & V_572 ) )
goto V_110;
V_703 = F_399 ( V_96 , V_710 , V_615 * sizeof( T_2 ) ) ;
if ( ! V_703 )
goto V_110;
F_383 ( & V_9 -> V_43 , F_360 ( V_703 ) , F_400 ( V_703 ) ) ;
if ( V_702 & V_711 )
return 0 ;
V_703 = F_399 ( V_96 , V_699 , V_689 * sizeof( T_3 ) ) ;
if ( ! V_703 )
goto V_110;
F_396 ( F_360 ( V_703 ) , V_9 , V_699 , F_400 ( V_703 ) ) ;
V_703 = F_399 ( V_96 , V_700 , V_690 * sizeof( T_3 ) ) ;
if ( ! V_703 )
goto V_110;
F_396 ( F_360 ( V_703 ) , V_9 , V_700 , F_400 ( V_703 ) ) ;
V_703 = F_399 ( V_96 , V_712 , sizeof( struct V_171 ) ) ;
if ( ! V_703 )
goto V_110;
if ( F_401 ( V_96 , V_713 , V_9 -> V_43 . V_47 ) )
goto V_110;
F_183 ( & V_9 -> V_40 ) ;
memcpy ( F_360 ( V_703 ) , V_9 -> V_75 . V_236 , F_400 ( V_703 ) ) ;
F_188 ( & V_9 -> V_40 ) ;
return 0 ;
V_110:
return - V_106 ;
...
goto V_383;
if ( ! V_9 -> V_85 && ( V_9 -> V_77 & V_78 ) &&
! F_196 ( V_11 , & V_717 , V_153 |
V_247 ) ) {
F_327 ( V_11 , & V_717 , & V_84 ) ;
V_716 = true ;
}
V_383:
F_155 ( & V_9 -> V_40 ) ;
...
const struct V_123 * V_703 )
{
struct V_123 * V_124 [ V_718 + 1 ] ;
if ( V_11 && ! F_58 ( V_11 ) )
return - V_719 ;
return F_406 ( V_124 , V_718 , V_703 , V_720 ,
NULL ) ;
}
static int F_407 ( int V_721 )
{
if ( V_721 != V_478 &&
V_721 != V_479 &&
V_721 != V_48 &&
...
static int F_409 ( struct V_10 * V_11 , const struct V_123 * V_703 )
{
int V_36 = - V_39 ;
struct V_8 * V_9 = F_58 ( V_11 ) ;
struct V_123 * V_124 [ V_718 + 1 ] ;
if ( ! V_9 )
return - V_719 ;
if ( F_406 ( V_124 , V_718 , V_703 , NULL , NULL ) < 0 )
F_410 () ;
if ( V_124 [ V_712 ] ) {
V_36 = F_404 ( V_9 , F_360 ( V_124 [ V_712 ] ) ) ;
if ( V_36 )
return V_36 ;
}
if ( V_124 [ V_713 ] ) {
T_5 V_721 = F_411 ( V_124 [ V_713 ] ) ;
if ( F_407 ( V_721 ) < 0 ||
F_408 ( V_9 , F_38 ( V_11 ) , V_721 ) < 0 )
return - V_39 ;
V_9 -> V_43 . V_47 = V_721 ;
V_36 = 0 ;
}
...
struct V_103 * V_104 ;
void * V_723 ;
V_104 = F_66 ( V_96 , V_100 , V_101 , V_102 , sizeof( * V_722 ) , V_59 ) ;
if ( ! V_104 )
return - V_106 ;
V_722 = F_67 ( V_104 ) ;
V_722 -> V_724 = V_108 ;
V_722 -> V_725 = 0 ;
V_722 -> V_726 = V_11 -> type ;
V_722 -> V_727 = V_11 -> V_97 ;
V_722 -> V_728 = F_413 ( V_11 ) ;
V_722 -> V_729 = 0 ;
if ( F_414 ( V_96 , V_730 , V_11 -> V_56 ) ||
( V_11 -> V_324 &&
F_368 ( V_96 , V_731 , V_11 -> V_324 , V_11 -> V_326 ) ) ||
F_373 ( V_96 , V_732 , V_11 -> V_37 ) ||
( V_11 -> V_97 != F_415 ( V_11 ) &&
F_373 ( V_96 , V_733 , F_415 ( V_11 ) ) ) ||
F_401 ( V_96 , V_734 ,
F_50 ( V_11 ) ? V_11 -> V_735 : V_736 ) )
goto V_110;
V_723 = F_416 ( V_96 , V_737 ) ;
if ( ! V_723 )
goto V_110;
...
void F_313 ( int V_102 , struct V_8 * V_9 )
{
struct V_95 * V_96 ;
struct V_115 * V_115 = F_38 ( V_9 -> V_11 ) ;
int V_36 = - V_116 ;
...
F_75 ( V_96 , V_115 , 0 , V_738 , NULL , V_131 ) ;
return;
V_117:
if ( V_36 < 0 )
F_76 ( V_115 , V_738 , V_36 ) ;
}
static inline T_16 F_419 ( void )
{
return F_62 ( sizeof( struct V_739 ) )
+ F_63 ( sizeof( struct V_171 ) )
+ F_63 ( sizeof( struct V_740 ) ) ;
}
...
struct V_103 * V_104 ;
struct V_740 V_572 ;
V_104 = F_66 ( V_96 , V_100 , V_101 , V_102 , sizeof( * V_741 ) , V_59 ) ;
if ( ! V_104 )
return - V_106 ;
V_741 = F_67 ( V_104 ) ;
V_741 -> V_742 = V_108 ;
V_741 -> V_743 = 0 ;
V_741 -> V_744 = 0 ;
V_741 -> V_745 = V_9 -> V_11 -> V_97 ;
V_741 -> V_200 = V_381 -> V_200 ;
V_741 -> V_746 = V_381 -> type ;
V_741 -> V_747 = 0 ;
V_741 -> V_748 = 0 ;
if ( V_381 -> V_301 )
V_741 -> V_748 |= V_749 ;
if ( V_381 -> V_398 )
V_741 -> V_748 |= V_750 ;
if ( F_368 ( V_96 , V_751 , sizeof( V_381 -> V_390 ) , & V_381 -> V_390 ) )
goto V_110;
V_572 . V_752 = F_260 ( V_381 -> V_393 ) ;
V_572 . V_753 = F_260 ( V_381 -> V_392 ) ;
if ( F_368 ( V_96 , V_754 , sizeof( V_572 ) , & V_572 ) )
goto V_110;
F_69 ( V_96 , V_104 ) ;
return 0 ;
V_110:
...
F_75 ( V_96 , V_115 , 0 , V_755 , NULL , V_131 ) ;
return;
V_117:
if ( V_36 < 0 )
F_76 ( V_115 , V_755 , V_36 ) ;
}
static void F_323 ( int V_102 , struct V_13 * V_14 )
{
struct V_115 * V_115 = F_38 ( V_14 -> V_9 -> V_11 ) ;
if ( V_102 )
F_33 () ;
...
static
int F_424 ( struct V_156 * V_757 , int V_758 ,
void T_8 * V_759 , T_16 * V_760 , T_10 * V_761 )
{
int * V_762 = V_757 -> V_473 ;
int V_763 = * V_762 ;
T_10 V_536 = * V_761 ;
struct V_156 V_764 ;
int V_231 ;
V_764 = * V_757 ;
V_764 . V_473 = & V_763 ;
V_231 = F_425 ( & V_764 , V_758 , V_759 , V_760 , V_761 ) ;
if ( V_758 )
V_231 = F_98 ( V_757 , V_762 , V_763 ) ;
if ( V_231 )
* V_761 = V_536 ;
return V_231 ;
}
static
int F_426 ( struct V_156 * V_757 , int V_758 ,
void T_8 * V_759 , T_16 * V_760 , T_10 * V_761 )
{
struct V_8 * V_9 = V_757 -> V_162 ;
int V_765 = V_38 ;
struct V_156 V_764 ;
V_764 = * V_757 ;
V_764 . V_162 = & V_765 ;
V_764 . V_160 = V_9 ? & V_9 -> V_11 -> V_37 : NULL ;
return F_427 ( & V_764 , V_758 , V_759 , V_760 , V_761 ) ;
}
...
if ( ! V_9 || ! V_9 -> V_11 )
return;
F_429 ( & V_485 , V_9 -> V_11 ) ;
if ( V_9 -> V_43 . V_189 )
F_307 ( NULL , V_222 , & V_485 ) ;
else
F_307 ( NULL , V_193 , & V_485 ) ;
}
...
static
int F_432 ( struct V_156 * V_757 , int V_758 ,
void T_8 * V_759 , T_16 * V_760 , T_10 * V_761 )
{
int * V_762 = V_757 -> V_473 ;
int V_763 = * V_762 ;
...
V_231 = F_425 ( & V_764 , V_758 , V_759 , V_760 , V_761 ) ;
if ( V_758 )
V_231 = F_431 ( V_757 , V_762 , V_763 ) ;
if ( V_231 )
* V_761 = V_536 ;
return V_231 ;
}
static
int F_433 ( struct V_156 * V_757 , int V_758 ,
void T_8 * V_759 , T_16 * V_760 , T_10 * V_761 )
{
int * V_762 = V_757 -> V_473 ;
int V_231 ;
int V_159 , V_767 ;
V_159 = * V_762 ;
V_231 = F_425 ( V_757 , V_758 , V_759 , V_760 , V_761 ) ;
V_767 = * V_762 ;
if ( V_758 && V_159 != V_767 ) {
struct V_115 * V_115 = V_757 -> V_160 ;
if ( ! F_99 () )
return F_100 () ;
if ( V_762 == & V_115 -> V_22 . V_44 -> V_113 )
F_71 ( V_115 , V_133 ,
V_93 ,
V_130 ,
V_115 -> V_22 . V_44 ) ;
else if ( V_762 == & V_115 -> V_22 . V_129 -> V_113 )
F_71 ( V_115 , V_133 ,
V_93 ,
V_128 ,
V_115 -> V_22 . V_129 ) ;
...
static int F_434 ( struct V_156 * V_757 , int V_758 ,
void T_8 * V_759 , T_16 * V_760 ,
T_10 * V_761 )
{
int V_231 = 0 ;
int V_768 ;
struct V_8 * V_9 = (struct V_8 * ) V_757 -> V_162 ;
struct V_115 * V_115 = (struct V_115 * ) V_757 -> V_160 ;
if ( ! F_99 () )
return F_100 () ;
V_231 = F_425 ( V_757 , V_758 , V_759 , V_760 , V_761 ) ;
if ( V_758 ) {
V_768 = * ( ( int * ) V_757 -> V_473 ) ;
if ( F_407 ( V_768 ) < 0 ) {
V_231 = - V_39 ;
goto V_111;
}
if ( & V_115 -> V_22 . V_44 -> V_47 == V_757 -> V_473 ) {
V_49 . V_47 = V_768 ;
} else {
if ( ! V_9 )
goto V_111;
if ( F_408 ( V_9 , V_115 , V_768 ) < 0 ) {
V_231 = - V_39 ;
goto V_111;
}
if ( V_9 -> V_43 . V_47 != V_768 ) {
V_9 -> V_43 . V_47 = V_768 ;
F_301 ( V_9 -> V_11 ) ;
}
}
...
static int F_435 ( struct V_156 * V_757 , int V_758 ,
void T_8 * V_759 , T_16 * V_760 ,
T_10 * V_761 )
{
int V_36 ;
struct V_171 V_169 ;
char V_769 [ V_770 ] ;
struct V_156 V_764 = * V_757 ;
struct V_115 * V_115 = V_757 -> V_160 ;
struct V_475 * V_469 = V_757 -> V_473 ;
if ( & V_115 -> V_22 . V_129 -> V_45 == V_757 -> V_473 )
return - V_771 ;
V_764 . V_772 = V_770 ;
V_764 . V_473 = V_769 ;
if ( ! F_99 () )
...
V_36 = snprintf ( V_769 , sizeof( V_769 ) , L_29 , & V_469 -> V_469 ) ;
if ( V_36 >= sizeof( V_769 ) ) {
V_36 = - V_771 ;
goto V_111;
}
V_36 = F_436 ( & V_764 , V_758 , V_759 , V_760 , V_761 ) ;
if ( V_36 || ! V_758 )
goto V_111;
if ( F_437 ( V_769 , - 1 , V_169 . V_773 . V_774 , - 1 , NULL ) != 1 ) {
V_36 = - V_771 ;
goto V_111;
}
V_469 -> V_46 = true ;
V_469 -> V_469 = V_169 ;
if ( & V_115 -> V_22 . V_44 -> V_45 == V_757 -> V_473 ) {
struct V_10 * V_11 ;
F_97 (net, dev) {
struct V_8 * V_9 = F_58 ( V_11 ) ;
if ( V_9 ) {
...
static
void F_440 ( struct V_8 * V_9 , int V_763 )
{
struct V_13 * V_150 ;
F_183 ( & V_9 -> V_40 ) ;
F_93 (ifa, &idev->addr_list, if_list) {
...
struct V_368 * V_157 = V_6 -> V_775 ;
int V_776 ;
F_441 ( & V_157 -> V_370 ) ;
F_439 ( V_150 -> V_6 , V_763 ) ;
if ( V_6 -> V_777 ) {
F_26 (cpu) {
struct V_178 * * V_778 ;
V_778 = F_27 ( V_6 -> V_777 , V_776 ) ;
F_439 ( * V_778 , V_763 ) ;
}
}
F_442 ( & V_157 -> V_370 ) ;
...
static
int F_443 ( struct V_156 * V_757 , int * V_762 , int V_763 )
{
struct V_8 * V_9 ;
struct V_115 * V_115 ;
if ( ! F_99 () )
return F_100 () ;
* V_762 = V_763 ;
V_115 = (struct V_115 * ) V_757 -> V_160 ;
if ( V_762 == & V_115 -> V_22 . V_44 -> V_196 ) {
F_101 () ;
return 0 ;
}
if ( V_762 == & V_115 -> V_22 . V_129 -> V_196 ) {
struct V_10 * V_11 ;
F_97 (net, dev) {
V_9 = F_58 ( V_11 ) ;
if ( V_9 )
...
static
int F_444 ( struct V_156 * V_757 , int V_758 ,
void T_8 * V_759 , T_16 * V_760 ,
T_10 * V_761 )
{
int * V_762 = V_757 -> V_473 ;
...
V_764 . V_473 = & V_763 ;
V_231 = F_425 ( & V_764 , V_758 , V_759 , V_760 , V_761 ) ;
if ( V_758 && ( * V_762 != V_763 ) )
V_231 = F_443 ( V_757 , V_762 , V_763 ) ;
if ( V_231 )
* V_761 = V_536 ;
return V_231 ;
}
static int F_445 ( struct V_115 * V_115 , char * V_779 ,
struct V_8 * V_9 , struct V_98 * V_158 )
{
int V_20 , V_97 ;
struct V_156 * V_157 ;
char V_780 [ sizeof( L_30 ) + V_692 ] ;
V_157 = F_446 ( V_781 , sizeof( V_781 ) , V_29 ) ;
if ( ! V_157 )
goto V_111;
for ( V_20 = 0 ; V_157 [ V_20 ] . V_473 ; V_20 ++ ) {
V_157 [ V_20 ] . V_473 += ( char * ) V_158 - ( char * ) & V_98 ;
if ( ! V_157 [ V_20 ] . V_162 && ! V_157 [ V_20 ] . V_160 ) {
V_157 [ V_20 ] . V_162 = V_9 ;
V_157 [ V_20 ] . V_160 = V_115 ;
}
}
snprintf ( V_780 , sizeof( V_780 ) , L_31 , V_779 ) ;
V_158 -> V_782 = F_447 ( V_115 , V_780 , V_157 ) ;
if ( ! V_158 -> V_782 )
goto free;
if ( ! strcmp ( V_779 , L_32 ) )
V_97 = V_128 ;
else if ( ! strcmp ( V_779 , L_33 ) )
V_97 = V_130 ;
else
V_97 = V_9 -> V_11 -> V_97 ;
...
if ( ! V_158 -> V_782 )
return;
V_157 = V_158 -> V_782 -> V_783 ;
F_449 ( V_158 -> V_782 ) ;
V_158 -> V_782 = NULL ;
F_30 ( V_157 ) ;
F_71 ( V_115 , V_784 , 0 , V_97 , NULL ) ;
}
...
{
int V_36 = - V_34 ;
struct V_98 * V_89 , * V_786 ;
V_89 = F_446 ( & V_98 , sizeof( V_98 ) , V_29 ) ;
if ( ! V_89 )
goto V_787;
V_786 = F_446 ( & V_49 , sizeof( V_49 ) , V_29 ) ;
if ( ! V_786 )
goto V_788;
V_786 -> V_398 = V_789 . V_398 ;
V_786 -> V_189 = V_789 . V_189 ;
V_786 -> V_45 . V_46 = false ;
V_89 -> V_45 . V_46 = false ;
V_115 -> V_22 . V_129 = V_89 ;
V_115 -> V_22 . V_44 = V_786 ;
#ifdef F_454
V_36 = F_445 ( V_115 , L_32 , NULL , V_89 ) ;
if ( V_36 < 0 )
goto V_790;
V_36 = F_445 ( V_115 , L_33 , NULL , V_786 ) ;
if ( V_36 < 0 )
goto V_791;
#endif
return 0 ;
...
F_258 () ;
F_463 ( & V_798 ) ;
V_36 = F_464 ( V_799 , V_800 , NULL , F_418 ,
NULL ) ;
if ( V_36 < 0 )
goto V_117;
F_464 ( V_799 , V_444 , F_365 , NULL , NULL ) ;
F_464 ( V_799 , V_221 , F_362 , NULL , NULL ) ;
F_464 ( V_799 , V_801 , F_381 ,
F_378 , NULL ) ;
F_464 ( V_799 , V_605 , NULL ,
F_379 , NULL ) ;
F_464 ( V_799 , V_609 , NULL ,
F_380 , NULL ) ;
F_464 ( V_799 , V_802 , F_77 ,
F_84 , NULL ) ;
F_465 () ;
return 0 ;
V_117:
