...
if ( error )
goto V_62;
V_38 = F_65 ( T_13 , V_38 , 1024 * V_123 ) ;
...
T_5 V_124 ;
T_2 V_125 ;
V_124 = F_66 ( V_7 , V_20 + V_38 - 1 ) ;
V_125 = F_17 ( V_7 , V_124 ) +
V_114 ;
V_26 = F_6 ( V_2 , 0 ) ;
if ( V_26 )
V_125 = F_9 ( V_125 , V_26 ) ;
V_125 = F_60 ( V_125 , V_109 ) ;
ASSERT ( V_125 > V_40 ) ;
V_114 = V_125 - V_112 ;
}
}
...
error = F_74 ( V_2 , & V_130 ,
V_34 ) ;
if ( error )
goto V_138;
V_130 = F_75 ( V_130 , V_112 ) ;
if ( ( V_131 + V_41 ) > V_130 ) {
V_41 = V_130 - V_131 ;
if ( V_41 == 0 ) {
error = - V_139 ;
...
{
if ( F_59 ( V_2 ) && ( V_108 & ( V_149 | V_150 ) ) )
return true ;
if ( ( V_108 & V_151 ) && ( V_108 & V_149 ) )
return true ;
return false ;
}
static int
...
T_2 V_40 , V_112 ;
int V_45 = 1 , error = 0 ;
bool V_121 = false , V_152 = false ;
unsigned V_54 ;
struct V_153 * V_24 ;
if ( F_83 ( V_7 ) )
return - V_154 ;
if ( ( ( V_108 & ( V_149 | V_151 ) ) == V_149 ) &&
! F_26 ( V_107 ) && ! F_15 ( V_2 ) ) {
...
if ( ( V_108 & V_155 ) && ! ( V_2 -> V_156 . V_60 & V_61 ) ) {
error = - V_139 ;
goto V_62;
}
...
goto V_62;
if ( V_108 & V_157 ) {
error = F_86 ( V_2 , & V_5 , & V_121 ,
& V_152 ) ;
if ( error )
goto V_62;
}
if ( ( V_108 & ( V_149 | V_150 ) ) && F_59 ( V_2 ) ) {
if ( V_108 & V_151 ) {
if ( V_108 & V_155 ) {
error = - V_139 ;
goto V_62;
}
error = F_87 ( V_2 , & V_5 , & V_121 ,
& V_54 ) ;
if ( error )
goto V_62;
} else {
error = F_62 ( V_2 , & V_5 , & V_121 ) ;
if ( error )
goto V_62;
}
...
if ( ( V_108 & V_149 ) && F_80 ( V_107 , & V_5 , V_45 ) ) {
if ( V_108 & V_155 ) {
error = - V_139 ;
goto V_62;
}
V_22 = F_65 ( T_13 , V_22 , 1024 * V_123 ) ;
if ( V_54 == V_71 )
F_88 ( V_2 , V_54 ) ;
...
V_24 = V_3 -> V_24 ;
if ( F_89 ( V_24 -> V_158 ) )
V_3 -> V_159 = F_90 ( V_24 -> V_160 -> V_161 ) ;
else
V_3 -> V_159 = NULL ;
if ( V_121 )
V_3 -> V_108 |= V_162 ;
...
V_164 = F_18 ( V_7 , V_20 + V_163 ) ;
V_112 = F_18 ( V_7 , V_20 + V_22 ) ;
if ( ( V_3 -> V_108 & V_128 ) && V_164 < V_112 ) {
F_92 ( F_5 ( V_2 ) , F_3 ( V_7 , V_164 ) ,
F_3 ( V_7 , V_112 ) - 1 ) ;
F_29 ( V_2 , V_71 ) ;
error = F_93 ( V_2 , V_164 ,
V_112 - V_164 ) ;
F_24 ( V_2 , V_71 ) ;
if ( error && ! F_83 ( V_7 ) ) {
F_94 ( V_7 , L_4 ,
...
return - V_154 ;
V_54 = F_98 ( V_2 ) ;
if ( ! F_99 ( V_2 ) || ! V_2 -> V_146 . V_166 ) {
error = - V_167 ;
goto V_62;
}
ASSERT ( V_2 -> V_146 . V_168 != V_169 ) ;
error = F_85 ( V_2 , V_40 , V_112 - V_40 , & V_5 ,
& V_45 , V_170 | V_171 ) ;
V_62:
F_24 ( V_2 , V_54 ) ;
