...
V_13 = V_161 - V_20 ;
V_166:
for ( V_48 = 0 , V_162 = V_167 ; V_48 < F_66 ( V_153 ) ; V_48 ++ ) {
#ifdef F_10
F_11 ( L_38 ,
F_67 ( V_153 ) , V_48 ,
( F_68 ( V_153 ) == V_168 ) ? L_39 : L_40 ) ;
#endif
V_158 = F_67 ( V_153 ) + V_48 ;
if ( ( int ) V_158 > V_161 -> V_169 ) {
V_162 = V_170 ;
break;
}
V_21 = V_158 / ( V_161 -> V_97 -> V_98 * V_161 -> type -> V_99 ) ;
V_159 = V_158 % ( V_161 -> V_97 -> V_98 * V_161 -> type -> V_99 ) ;
V_37 = F_69 ( V_153 -> V_171 ) + 512 * V_48 ;
#ifdef F_10
F_11 ( L_41
...
static int F_72 ( struct V_172 * V_173 , struct V_174 * V_175 )
{
int V_13 = F_73 ( V_173 -> V_176 ) & 3 ;
V_175 -> V_139 = V_20 [ V_13 ] . type -> V_139 ;
V_175 -> V_177 = V_20 [ V_13 ] . V_97 -> V_98 * V_20 [ V_13 ] . type -> V_99 ;
V_175 -> V_178 = V_20 [ V_13 ] . type -> V_42 ;
return 0 ;
}
static int F_74 ( struct V_172 * V_173 , T_5 V_179 ,
unsigned int V_180 , unsigned long V_181 )
{
struct V_160 * V_182 = V_173 -> V_183 -> V_165 ;
int V_13 = V_182 - V_20 ;
static struct V_184 V_185 ;
void T_6 * V_186 = ( void T_6 * ) V_181 ;
switch( V_180 ) {
case V_187 :
F_9 ( V_13 ) ;
if ( V_188 [ V_13 ] > 1 ) {
...
break;
case V_192 :
if ( V_181 < V_182 -> type -> V_42 * V_182 -> type -> V_139 )
{
F_9 ( V_13 ) ;
if ( F_32 ( V_13 , V_181 ) != 0 ) {
memset ( V_182 -> V_110 , V_193 ,
V_182 -> V_97 -> V_98 * V_182 -> type -> V_99 * 512 ) ;
F_61 ( V_13 ) ;
}
F_30 ( V_13 ) ;
F_15 () ;
...
break;
case V_196 :
memset ( ( void * ) & V_185 , 0 , sizeof ( V_185 ) ) ;
V_185 . V_21 = V_182 -> type -> V_42 ;
V_185 . V_197 = V_182 -> type -> V_139 ;
V_185 . V_106 = V_182 -> V_97 -> V_98 * V_182 -> type -> V_99 ;
V_185 . V_198 = V_182 -> V_169 ;
if ( F_77 ( V_186 , & V_185 , sizeof( struct V_184 ) ) )
return - V_199 ;
break;
case V_200 :
case V_201 :
...
#ifdef F_78
case V_203 :
if ( F_77 ( V_186 , V_72 , V_182 -> type -> V_73 ) )
return - V_199 ;
else
return V_182 -> type -> V_73 ;
#endif
default:
F_11 ( V_204 L_43 ,
V_180 , V_13 ) ;
...
static int F_79 ( struct V_172 * V_173 , T_5 V_179 ,
unsigned int V_180 , unsigned long V_181 )
{
int V_206 ;
F_5 ( & V_207 ) ;
V_206 = F_74 ( V_173 , V_179 , V_180 , V_181 ) ;
F_7 ( & V_207 ) ;
return V_206 ;
}
static void F_80 ( int V_208 )
{
unsigned long V_155 ;
int type ;
int V_13 ;
V_13 = V_208 & 3 ;
V_155 = F_33 ( V_13 ) ;
for ( type = 0 ; type < V_209 ; type ++ )
if ( V_210 [ type ] . V_155 == V_155 )
break;
if ( type >= V_209 ) {
F_11 ( V_26 L_44
L_45 , V_155 ) ;
V_20 [ V_13 ] . type = & V_210 [ V_209 - 1 ] ;
return;
}
V_20 [ V_13 ] . type = V_210 + type ;
V_20 [ V_13 ] . V_21 = - 1 ;
V_20 [ V_13 ] . V_116 = - 1 ;
V_20 [ V_13 ] . V_23 = 0 ;
V_20 [ V_13 ] . V_211 = 0 ;
...
static int F_81 ( struct V_172 * V_173 , T_5 V_179 )
{
int V_13 = F_73 ( V_173 -> V_176 ) & 3 ;
int system = ( F_73 ( V_173 -> V_176 ) & 4 ) >> 2 ;
int V_213 ;
unsigned long V_15 ;
F_5 ( & V_207 ) ;
V_213 = V_214 [ V_13 ] ;
if ( V_188 [ V_13 ] && V_213 != system ) {
F_7 ( & V_207 ) ;
return - V_189 ;
}
if ( V_179 & ( V_215 | V_216 ) ) {
F_82 ( V_173 ) ;
if ( V_179 & V_216 ) {
int V_217 ;
F_9 ( V_13 ) ;
...
V_214 [ V_13 ] = system ;
F_14 ( V_15 ) ;
V_20 [ V_13 ] . V_97 = & V_219 [ system ] ;
V_20 [ V_13 ] . V_169 = V_20 [ V_13 ] . type -> V_139 * V_20 [ V_13 ] . type -> V_42 *
V_219 [ system ] . V_98 * V_20 [ V_13 ] . type -> V_99 ;
F_83 ( V_20 [ V_13 ] . V_156 , V_20 [ V_13 ] . V_169 ) ;
F_11 ( V_100 L_46 , V_13 ,
V_20 [ V_13 ] . type -> V_220 , V_219 [ system ] . V_220 ) ;
F_7 ( & V_207 ) ;
return 0 ;
}
static void F_84 ( struct V_156 * V_116 , T_5 V_179 )
{
struct V_160 * V_182 = V_116 -> V_165 ;
int V_13 = V_182 - V_20 ;
F_5 ( & V_207 ) ;
if ( V_20 [ V_13 ] . V_84 == 1 ) {
F_24 ( V_144 + V_13 ) ;
...
static unsigned F_85 ( struct V_156 * V_116 , unsigned int V_222 )
{
struct V_160 * V_182 = V_116 -> V_165 ;
int V_13 = V_182 - V_20 ;
int V_223 ;
...
V_116 -> V_157 = F_88 ( F_71 , & V_229 ) ;
if ( ! V_116 -> V_157 ) {
V_20 [ V_13 ] . type -> V_155 = V_54 ;
continue;
}
V_227 ++ ;
if ( ( V_20 [ V_13 ] . V_110 = F_89 ( V_230 * 512 , V_231 ) ) == NULL ) {
F_11 ( L_49 ) ;
V_20 [ V_13 ] . type = & V_210 [ V_209 - 1 ] ;
V_227 -- ;
V_228 = 1 ;
...
static struct V_239 * F_91 ( T_8 V_208 , int * V_240 , void * V_37 )
{
int V_13 = * V_240 & 3 ;
if ( V_20 [ V_13 ] . type -> V_155 == V_54 )
return NULL ;
* V_240 = 0 ;
return F_92 ( V_20 [ V_13 ] . V_156 ) ;
}
static int T_7 F_93 ( struct V_241 * V_242 )
{
int V_50 , V_206 ;
if ( F_94 ( V_233 , L_54 ) )
return - V_189 ;
V_206 = - V_238 ;
V_72 = F_95 ( V_243 , L_55 ) ;
if ( ! V_72 ) {
F_11 ( L_56 ) ;
goto V_244;
}
V_206 = - V_189 ;
if ( F_96 ( V_245 , F_36 , 0 , L_57 , NULL ) ) {
F_11 ( L_58 ) ;
goto V_246;
}
if ( F_96 ( V_247 , F_1 , 0 , L_59 , NULL ) ) {
F_11 ( L_60 ) ;
goto V_248;
}
V_206 = - V_190 ;
...
V_36 [ V_50 ] . V_251 = F_27 ;
F_99 ( & V_144 [ V_50 ] ) ;
V_144 [ V_50 ] . V_33 = 0 ;
V_144 [ V_50 ] . V_37 = V_50 ;
V_144 [ V_50 ] . V_251 = F_60 ;
V_20 [ V_50 ] . V_21 = - 1 ;
}
F_99 ( & V_61 ) ;
V_61 . V_33 = 0 ;
...
{
return F_104 ( & V_255 , F_93 ) ;
}
static int T_7 F_105 ( char * V_256 )
{
int V_40 ;
if ( ! V_257 )
return 0 ;
