...
int F_39 ( struct V_135 * V_136 , void * V_201 , struct V_202 * V_203 )
{
T_1 * V_1 = V_136 -> V_138 ;
T_13 * V_211 = V_201 ;
int V_212 ;
...
if ( F_40 ( V_211 -> V_212 , & V_212 , sizeof( int ) ) ) {
F_15 ( L_13 ) ;
return - V_218 ;
}
return 0 ;
}
static int F_41 ( struct V_135 * V_136 , void * V_201 , struct V_202 * V_203 )
{
T_1 * V_1 = V_136 -> V_138 ;
T_7 * V_219 = V_201 ;
V_9 ;
...
F_3 ( V_16 , 0x00000000 ,
V_16 , 0x00000000 ,
V_16 , 0x00000000 , V_221 , 0x00000000 ) ;
F_4 () ;
return 0 ;
}
static int F_42 ( struct V_135 * V_136 , void * V_201 , struct V_202 *
V_203 )
{
T_1 * V_1 = V_136 -> V_138 ;
T_7 * V_219 = V_201 ;
