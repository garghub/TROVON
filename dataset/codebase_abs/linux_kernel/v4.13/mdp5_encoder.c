...
F_18 ( V_1 , V_77 , V_72 ) ;
F_18 ( V_1 , V_78 , 1 ) ;
F_68 ( V_9 -> V_54 , V_70 -> V_54 , true ) ;
F_69 ( V_1 ) ;
return 0 ;
}
void F_70 ( struct V_2 * V_3 , bool V_79 )
{
struct V_9 * V_9 = F_12 ( V_3 ) ;
struct V_59 * V_19 = V_9 -> V_19 ;
if ( V_79 ) {
...
struct V_2 * V_3 = NULL ;
struct V_9 * V_9 ;
int V_82 = ( V_19 -> type == V_43 ) ?
V_83 : V_84 ;
int V_85 ;
V_9 = F_72 ( sizeof( * V_9 ) , V_86 ) ;
if ( ! V_9 ) {
V_85 = - V_87 ;
goto V_88;
}
