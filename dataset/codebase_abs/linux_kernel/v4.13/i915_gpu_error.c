...
L_113 , V_75 -> V_195 [ V_152 ] ) ;
if ( V_75 -> V_196 ) {
F_28 ( V_57 , L_114 ,
V_151 -> V_1 [ V_62 ] -> V_59 ,
V_75 -> V_196 ) ;
for ( V_152 = 0 ; V_152 < V_75 -> V_196 ; V_152 ++ )
F_35 ( V_57 , L_19 , & V_75 -> V_197 [ V_152 ] ) ;
}
if ( F_66 ( V_75 -> V_198 ) ) {
F_28 ( V_57 , L_115 ,
V_151 -> V_1 [ V_62 ] -> V_59 ) ;
...
V_151 -> V_1 [ V_62 ] -> V_59 ,
V_75 -> V_199 ) ;
for ( V_152 = 0 ; V_152 < V_75 -> V_199 ; V_152 ++ ) {
F_28 ( V_57 , L_117 ,
V_75 -> V_198 [ V_152 ] . V_86 ,
V_75 -> V_198 [ V_152 ] . V_96 ,
V_75 -> V_198 [ V_152 ] . V_87 ) ;
}
}
F_47 ( V_57 , V_151 -> V_1 [ V_62 ] ,
L_118 , V_75 -> V_200 ) ;
...
F_47 ( V_57 , NULL , L_123 , error -> V_204 ) ;
F_47 ( V_57 , NULL , L_124 , error -> V_205 ) ;
if ( error -> V_206 )
...
if ( ! V_216 )
return NULL ;
V_221 = F_77 ( T_3 , V_216 -> V_17 , V_216 -> V_137 -> V_225 . V_17 ) >> V_226 ;
...
struct V_215 * V_216 )
{
struct V_241 * V_137 = V_216 -> V_137 ;
int V_62 ;
V_15 -> V_17 = V_137 -> V_225 . V_17 ;
V_15 -> V_59 = V_137 -> V_225 . V_59 ;
for ( V_62 = 0 ; V_62 < V_66 ; V_62 ++ )
V_15 -> V_67 [ V_62 ] = F_81 ( & V_216 -> V_242 [ V_62 ] ) ;
V_15 -> V_68 = F_81 ( & V_137 -> V_243 ) ;
V_15 -> V_1 = F_83 ( & V_137 -> V_243 ) ;
V_15 -> V_63 = V_216 -> V_227 . V_21 ;
V_15 -> V_64 = V_137 -> V_225 . V_64 ;
V_15 -> V_65 = V_137 -> V_225 . V_65 ;
V_15 -> V_72 = V_216 -> V_182 ? V_216 -> V_182 -> V_240 : - 1 ;
V_15 -> V_7 = F_85 ( V_137 ) ;
V_15 -> V_11 = V_137 -> V_244 . V_11 ;
V_15 -> V_12 = V_137 -> V_244 . V_245 != V_246 ;
V_15 -> V_69 = V_137 -> V_69 . V_244 != NULL ;
...
int V_62 ;
if ( F_33 ( V_151 ) >= 6 ) {
for ( V_62 = 0 ; V_62 < V_151 -> V_250 ; V_62 ++ )
...
static void F_144 ( struct V_237 * V_238 ,
struct V_84 * V_85 )
{
V_85 -> V_89 = V_238 -> V_95 -> V_98 ;
V_85 -> V_88 = V_238 -> V_95 -> V_88 ;
V_85 -> V_86 = V_238 -> V_239 ;
V_85 -> V_90 = V_238 -> V_281 ;
V_85 -> V_91 = V_238 -> V_91 ;
V_85 -> V_92 = V_238 -> V_92 ;
F_145 () ;
V_85 -> V_87 = V_238 -> V_95 -> V_87 ? F_146 ( V_238 -> V_95 -> V_87 ) : 0 ;
F_147 () ;
}
...
if ( ! V_61 )
return;
V_75 -> V_197 = F_150 ( V_61 , sizeof( * V_75 -> V_197 ) , V_35 ) ;
if ( ! V_75 -> V_197 )
return;
V_75 -> V_196 = V_61 ;
V_61 = 0 ;
...
struct V_237 * V_285 = F_152 ( & V_283 [ V_284 ] ) ;
if ( ! V_285 )
break;
F_144 ( V_285 , & V_75 -> V_133 [ V_284 ] ) ;
}
}
static void F_153 ( struct V_94 * V_14 ,
struct V_286 * V_95 )
{
if ( V_95 -> V_87 ) {
struct V_287 * V_288 ;
F_145 () ;
V_288 = F_154 ( V_95 -> V_87 , V_289 ) ;
if ( V_288 ) {
...
V_14 -> V_98 = V_95 -> V_98 ;
V_14 -> V_88 = V_95 -> V_88 ;
V_14 -> V_99 = V_95 -> V_291 ;
V_14 -> V_100 = V_95 -> V_292 ;
}
...
V_294 = NULL ;
if ( V_61 )
V_294 = F_150 ( V_61 , sizeof( * V_294 ) , V_35 ) ;
if ( ! V_294 )
return;
V_61 = 0 ;
for ( V_29 = V_238 -> V_295 ; V_29 ; V_29 = V_29 -> V_296 ) {
...
static void F_156 ( struct V_142 * V_151 ,
struct V_150 * error )
{
struct V_217 * V_218 = & V_151 -> V_218 ;
int V_62 ;
error -> V_204 =
F_76 ( V_151 , V_151 -> V_204 ) ;
for ( V_62 = 0 ; V_62 < V_66 ; V_62 ++ ) {
...
V_75 -> V_200 =
F_76 ( V_151 , V_298 -> V_216 ) ;
F_148 ( V_1 , V_238 , V_75 ) ;
}
V_75 -> V_201 =
F_76 ( V_151 ,
V_1 -> V_305 . V_216 ) ;
V_75 -> V_202 =
F_76 ( V_151 , V_1 -> V_202 . V_216 ) ;
}
}
static void F_160 ( struct V_142 * V_151 ,
struct V_150 * error ,
struct V_306 * V_189 ,
int V_252 )
{
...
struct V_150 * error )
{
int V_308 = 0 , V_62 , V_152 ;
F_162 ( F_59 ( error -> V_1 ) > F_59 ( error -> V_190 ) ) ;
F_162 ( F_59 ( error -> V_190 ) != F_59 ( error -> V_187 ) ) ;
F_162 ( F_59 ( error -> V_190 ) != F_59 ( error -> V_191 ) ) ;
for ( V_62 = 0 ; V_62 < F_59 ( error -> V_1 ) ; V_62 ++ ) {
struct V_74 * V_75 = & error -> V_1 [ V_62 ] ;
bool V_309 ;
if ( ! V_75 -> V_189 )
continue;
V_309 = false ;
for ( V_152 = 0 ; V_152 < V_62 && ! V_309 ; V_152 ++ )
V_309 = error -> V_1 [ V_152 ] . V_189 == V_75 -> V_189 ;
if ( ! V_309 )
F_160 ( V_151 , error , V_75 -> V_189 , V_308 ++ ) ;
}
}
static void F_163 ( struct V_142 * V_151 ,
struct V_150 * error )
{
struct V_306 * V_189 = & V_151 -> V_218 . V_225 ;
struct V_60 * V_294 ;
struct V_215 * V_216 ;
int V_310 , V_311 ;
V_310 = 0 ;
...
static void F_164 ( struct V_142 * V_151 ,
struct V_150 * error )
{
if ( ! V_151 -> V_313 . log . V_216 || ( V_70 . V_314 < 0 ) )
return;
error -> V_205 = F_76 ( V_151 ,
V_151 -> V_313 . log . V_216 ) ;
}
static void F_165 ( struct V_142 * V_151 ,
struct V_150 * error )
{
int V_62 ;
if ( F_166 ( V_151 ) ) {
...
if ( F_136 ( V_151 ) ) {
error -> V_176 = F_167 ( V_321 ) ;
error -> V_322 = F_94 ( V_323 ) ;
error -> V_123 = F_94 ( V_324 ) ;
}
if ( F_33 ( V_151 ) >= 7 )
error -> V_176 = F_167 ( V_325 ) ;
if ( F_33 ( V_151 ) >= 6 ) {
...
for ( V_62 = 0 ; V_62 < 4 ; V_62 ++ )
error -> V_174 [ V_62 ] = F_94 ( F_168 ( V_62 ) ) ;
error -> V_173 = 4 ;
} else if ( F_169 ( V_151 ) ) {
...
V_107 V_340 ;
int V_79 = - 1 , V_19 ;
V_340 = F_89 ( V_151 , error , & V_79 ) ;
V_19 = F_65 ( error -> V_153 , sizeof( error -> V_153 ) ,
L_125 ,
F_33 ( V_151 ) , V_79 , V_340 ) ;
...
static void F_173 ( struct V_142 * V_151 ,
struct V_150 * error )
{
error -> V_168 = V_151 -> V_341 . V_168 ;
error -> V_169 = F_174 ( & V_151 -> V_342 . V_343 ) ;
error -> V_170 = V_151 -> V_342 . V_170 ;
error -> V_163 = - 1 ;
#ifdef F_175
error -> V_163 = V_344 ;
#endif
error -> V_159 = F_176 ( & V_151 -> V_179 ) ;
error -> V_160 = V_151 -> V_160 ;
memcpy ( & error -> V_161 ,
F_177 ( V_151 ) ,
sizeof( error -> V_161 ) ) ;
}
static T_5 void F_178 ( const char * type , void * T_4 )
{
if ( ! F_52 ( type , L_73 ) )
* ( void * * ) T_4 = F_179 ( * ( void * * ) T_4 , V_35 ) ;
}
static int F_180 ( void * V_345 )
{
struct V_150 * error = V_345 ;
F_181 ( & error -> time ) ;
error -> V_157 = F_182 ( F_183 () ) ;
error -> V_158 =
F_182 ( F_184 ( F_185 () ,
error -> V_70 -> V_341 . V_346 ) ) ;
error -> V_208 = V_70 ;
#define F_186 ( T_6 , T_4 ) dup_param(#T, &error->params.x);
F_56 ( F_186 ) ;
#undef F_186
F_173 ( error -> V_70 , error ) ;
...
error -> V_206 = F_187 ( error -> V_70 ) ;
error -> V_207 = F_188 ( error -> V_70 ) ;
return 0 ;
}
struct V_150 *
F_189 ( struct V_142 * V_70 )
{
struct V_150 * error ;
error = F_190 ( sizeof( * error ) , V_35 ) ;
if ( ! error )
return NULL ;
F_191 ( & error -> V_214 ) ;
error -> V_70 = V_70 ;
F_192 ( F_180 , error , NULL ) ;
return error ;
}
void F_193 ( struct V_142 * V_151 ,
V_107 V_339 ,
const char * V_153 )
{
static bool V_347 ;
...
F_172 ( V_151 , error , V_339 , V_153 ) ;
F_196 ( L_78 , error -> V_153 ) ;
if ( ! error -> V_303 ) {
F_197 ( & V_151 -> V_179 . V_350 , V_348 ) ;
if ( ! V_151 -> V_179 . V_349 ) {
V_151 -> V_179 . V_349 = error ;
error = NULL ;
}
F_198 ( & V_151 -> V_179 . V_350 , V_348 ) ;
}
if ( error ) {
F_72 ( & error -> V_214 ) ;
return;
...
if ( ! V_347 &&
F_199 () - V_351 < F_200 ( 180 ) ) {
F_196 ( L_131 ) ;
F_196 ( L_132 ) ;
F_196 ( L_133 ) ;
F_196 ( L_134 ) ;
F_196 ( L_135 ,
V_151 -> V_145 . V_352 -> V_353 ) ;
V_347 = true ;
}
}
struct V_150 *
F_201 ( struct V_142 * V_70 )
{
struct V_150 * error ;
F_202 ( & V_70 -> V_179 . V_350 ) ;
