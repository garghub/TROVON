...
static bool F_152 ( struct V_49 * V_143 , int V_79 ,
int V_60 )
{
if ( V_143 -> V_79 == V_79 &&
V_143 -> V_60 == V_60 )
...
F_56 ( V_4 , & V_39 , & V_89 ) ;
V_44 = V_3 -> V_49 [ V_39 ] ;
V_121 = ( V_44 -> V_17 * V_110 ) & ~ V_145 ;
V_129 = & F_157 ( V_142 ) ;
V_129 -> V_140 = V_22 ;
if ( V_121 + V_44 -> V_17 <= V_108 ) {
V_129 -> V_133 = F_128 ( V_1 ) ;
V_144 = V_129 -> V_133 + V_121 ;
goto V_100;
}
V_18 [ 0 ] = V_1 ;
V_18 [ 1 ] = F_94 ( V_1 ) ;
F_57 ( ! V_18 [ 1 ] ) ;
V_144 = F_141 ( V_129 , V_18 , V_121 , V_44 -> V_17 ) ;
V_100:
if ( F_60 ( ! F_5 ( V_1 ) ) )
V_144 += V_6 ;
return V_144 ;
...
V_148 = V_37 & ~ V_145 ;
V_147 = F_50 ( V_4 ) ;
for ( V_58 = 0 ; V_58 < V_146 ; V_58 ++ )
V_147 = F_94 ( V_147 ) ;
V_125 = F_128 ( V_147 ) ;
V_124 = (struct V_123 * ) V_125 + V_148 / sizeof( * V_124 ) ;
...
void * V_125 ;
V_13 &= ~ V_149 ;
F_96 ( V_13 , & V_150 , & V_152 ) ;
V_151 = ( V_44 -> V_17 * V_152 ) & ~ V_145 ;
V_4 = F_93 ( V_150 ) ;
V_125 = F_128 ( V_150 ) ;
V_124 = (struct V_123 * ) ( V_125 + V_151 ) ;
...
static void F_163 ( struct V_49 * V_44 , unsigned long V_153 ,
unsigned long V_154 )
{
...
void * V_161 , * V_162 ;
int V_163 , V_164 , V_17 ;
int V_165 = 0 ;
V_163 = V_164 = V_44 -> V_17 ;
F_96 ( V_154 , & V_155 , & V_157 ) ;
F_96 ( V_153 , & V_156 , & V_158 ) ;
V_159 = ( V_44 -> V_17 * V_157 ) & ~ V_145 ;
V_160 = ( V_44 -> V_17 * V_158 ) & ~ V_145 ;
if ( V_159 + V_44 -> V_17 > V_108 )
V_163 = V_108 - V_159 ;
...
V_162 = F_128 ( V_156 ) ;
while ( 1 ) {
V_17 = F_164 ( V_163 , V_164 ) ;
memcpy ( V_162 + V_160 , V_161 + V_159 , V_17 ) ;
V_165 += V_17 ;
if ( V_165 == V_44 -> V_17 )
break;
V_159 += V_17 ;
...
unsigned long V_11 ;
struct V_1 * V_155 = V_167 -> V_155 ;
struct V_1 * V_156 = V_167 -> V_156 ;
int V_110 = V_167 -> V_110 ;
int V_144 = 0 ;
while ( 1 ) {
V_11 = F_165 ( V_44 , V_155 , & V_110 ) ;
if ( ! V_11 ) {
V_155 = F_94 ( V_155 ) ;
if ( ! V_155 )
break;
...
if ( F_153 ( V_44 , F_93 ( V_156 ) ) ) {
F_108 ( V_11 ) ;
V_144 = - V_131 ;
break;
}
V_168 = F_100 ( V_11 ) ;
V_169 = F_160 ( V_44 , F_93 ( V_156 ) , V_11 ) ;
F_163 ( V_44 , V_169 , V_168 ) ;
V_110 ++ ;
V_169 |= F_167 ( V_114 ) ;
F_27 ( V_11 , V_169 ) ;
F_108 ( V_11 ) ;
...
static struct V_4 * F_168 ( struct V_49 * V_44 , bool V_170 )
{
int V_58 ;
struct V_4 * V_4 ;
...
static struct V_83 * F_170 ( struct V_171 * V_172 ,
int V_12 , const char * V_173 , void * V_174 )
{
static const struct V_175 V_176 = {
. V_177 = V_178 ,
} ;
return F_171 ( V_172 , L_26 , NULL , & V_176 , V_179 ) ;
}
static int F_7 ( void )
{
int V_144 = 0 ;
...
struct V_1 * V_182 , struct V_1 * V_183 )
{
struct V_1 * V_1 ;
...
F_130 ( V_44 , V_4 , V_18 ) ;
F_53 ( V_182 , F_52 ( V_183 ) ) ;
if ( F_95 ( F_5 ( V_183 ) ) )
V_182 -> V_73 = V_183 -> V_73 ;
F_186 ( V_182 , F_187 ( V_183 ) ) ;
}
bool F_188 ( struct V_1 * V_1 , T_7 V_184 )
{
struct V_2 * V_3 ;
struct V_49 * V_44 ;
int V_39 ;
...
int F_191 ( struct V_185 * V_186 , struct V_1 * V_182 ,
struct V_1 * V_1 , enum V_188 V_184 )
{
struct V_2 * V_3 ;
struct V_49 * V_44 ;
int V_39 ;
...
V_162 = F_128 ( V_182 ) ;
memcpy ( V_162 , V_161 , V_108 ) ;
F_129 ( V_162 ) ;
for ( V_134 = V_161 + V_37 ; V_134 < V_161 + V_190 ;
V_134 += V_44 -> V_17 ) {
...
F_192 () ;
V_191 = F_100 ( V_11 ) ;
F_96 ( V_191 , & V_189 , & V_110 ) ;
V_192 = ( unsigned long ) F_98 ( V_182 ,
V_110 ) ;
V_192 |= F_167 ( V_114 ) ;
F_27 ( V_11 , V_192 ) ;
}
}
F_185 ( V_44 , V_4 , V_182 , V_1 ) ;
F_193 ( V_182 ) ;
F_184 ( V_4 ) ;
if ( ! F_44 ( V_4 ) )
F_169 ( V_44 , V_4 ) ;
...
{
V_3 -> V_80 = F_196 ( V_180 -> V_199 ) ;
if ( F_173 ( V_3 -> V_80 ) ) {
V_3 -> V_80 = NULL ;
return 1 ;
}
V_3 -> V_80 -> V_200 -> V_187 = V_3 ;
V_3 -> V_80 -> V_200 -> V_201 = & V_202 ;
return 0 ;
}
static void F_10 ( struct V_2 * V_3 )
{
...
static void F_199 ( struct V_203 * V_204 )
{
int V_58 ;
struct V_49 * V_44 ;
unsigned int V_39 ;
enum V_40 V_41 ;
struct V_4 * V_4 , * V_205 ;
F_200 ( V_206 ) ;
struct V_2 * V_3 = F_201 ( V_204 , struct V_2 ,
V_198 ) ;
for ( V_58 = 0 ; V_58 < V_48 ; V_58 ++ ) {
V_44 = V_3 -> V_49 [ V_58 ] ;
if ( V_44 -> V_73 != V_58 )
...
F_74 ( & V_44 -> V_74 ) ;
while ( ( V_208 = F_168 ( V_44 , true ) ) ) {
if ( ! F_75 ( V_44 ) )
break;
V_167 . V_110 = 0 ;
V_167 . V_155 = F_50 ( V_208 ) ;
while ( ( V_209 = F_168 ( V_44 , false ) ) ) {
V_167 . V_156 = F_50 ( V_209 ) ;
if ( ! F_166 ( V_3 , V_44 , & V_167 ) )
break;
F_169 ( V_44 , V_209 ) ;
}
if ( V_209 == NULL )
break;
F_169 ( V_44 , V_209 ) ;
if ( F_169 ( V_44 , V_208 ) == V_90 ) {
F_126 ( V_3 , V_44 , V_208 ) ;
V_3 -> V_52 . V_210 += V_44 -> V_79 ;
}
F_76 ( & V_44 -> V_74 ) ;
F_208 () ;
F_74 ( & V_44 -> V_74 ) ;
...
return V_3 -> V_52 . V_210 ;
}
void F_210 ( struct V_2 * V_3 , struct F_210 * V_52 )
{
memcpy ( V_52 , & V_3 -> V_52 , sizeof( struct F_210 ) ) ;
}
static unsigned long F_211 ( struct V_211 * V_211 ,
struct V_212 * V_213 )
{
unsigned long V_214 ;
struct V_2 * V_3 = F_201 ( V_211 , struct V_2 ,
V_211 ) ;
V_214 = V_3 -> V_52 . V_210 ;
V_214 = F_209 ( V_3 ) - V_214 ;
return V_214 ? V_214 : V_215 ;
}
static unsigned long F_212 ( struct V_211 * V_211 ,
struct V_212 * V_213 )
{
int V_58 ;
struct V_49 * V_44 ;
...
{
V_3 -> V_211 . V_218 = F_211 ;
V_3 -> V_211 . V_219 = F_212 ;
V_3 -> V_211 . V_220 = 0 ;
V_3 -> V_211 . V_221 = V_222 ;
return F_216 ( & V_3 -> V_211 ) ;
}
struct V_2 * F_30 ( const char * V_14 )
{
int V_58 ;
struct V_2 * V_3 ;
struct V_49 * V_223 = NULL ;
V_3 = F_217 ( sizeof( * V_3 ) , V_137 ) ;
if ( ! V_3 )
return NULL ;
F_15 ( V_3 ) ;
V_3 -> V_14 = F_218 ( V_14 , V_137 ) ;
if ( ! V_3 -> V_14 )
goto V_224;
if ( F_17 ( V_3 ) )
goto V_224;
...
F_219 ( & V_44 -> V_74 ) ;
V_3 -> V_49 [ V_58 ] = V_44 ;
for ( V_41 = V_90 ; V_41 < V_225 ;
V_41 ++ )
F_220 ( & V_44 -> V_96 [ V_41 ] ) ;
V_223 = V_44 ;
}
F_80 ( V_3 , V_14 ) ;
if ( F_9 ( V_3 ) )
