...
if ( V_37 -> V_82 -> V_83 ) {
memcpy ( & V_79 -> V_82 -> V_84 ,
& V_37 -> V_82 -> V_84 ,
sizeof( V_37 -> V_82 -> V_84 ) ) ;
V_79 -> V_82 -> V_83 = true ;
}
if ( V_37 -> V_82 -> V_85 ) {
V_79 -> V_82 -> V_86 |=
...
T_1 V_68 , T_1 V_6 , T_1 V_90 , int V_91 ,
int V_51 )
{
struct V_1 * V_92 ;
struct V_28 * V_29 ;
...
V_37 -> type = V_4 ;
V_92 -> V_91 = V_91 ;
F_49 ( V_54 , V_37 , V_92 , V_51 ) ;
V_60 = F_37 ( V_26 , V_29 , V_89 , V_37 ) ;
if ( V_60 > 0 )
F_50 ( V_96 , V_92 ) ;
}
static T_2 void
...
struct V_12 * V_89 ,
struct V_36 * V_37 , T_1 V_19 ,
T_1 V_68 , T_1 V_6 , T_1 V_90 , T_1 V_97 ,
T_1 V_11 , int V_51 )
{
struct V_7 * V_92 ;
struct V_28 * V_29 ;
...
V_92 -> V_10 = V_97 ;
V_92 -> V_11 = V_11 ;
F_52 ( V_54 , V_37 , V_92 , V_51 ) ;
V_60 = F_37 ( V_26 , V_29 , V_89 , V_37 ) ;
if ( V_60 > 0 )
F_50 ( V_98 , V_92 ) ;
}
int F_53 ( struct V_53 * V_54 ,
struct V_25 * V_26 ,
T_1 V_19 , T_1 V_68 , T_1 V_6 ,
T_1 V_90 , int V_91 , int V_51 ,
struct V_99 * V_82 ,
int * V_80 , int * V_100 )
{
struct V_1 * V_37 ;
...
int V_103 ;
F_42 ( V_82 && V_82 -> V_55 ) ;
V_37 = F_54 ( V_96 , V_104 ) ;
if ( ! V_37 )
return - V_105 ;
V_89 = F_54 ( V_106 , V_104 ) ;
if ( ! V_89 )
goto V_107;
if ( F_55 ( V_108 , & V_54 -> V_109 ) &&
F_45 ( V_90 ) ) {
V_102 = F_56 ( sizeof( * V_102 ) , V_104 ) ;
if ( ! V_102 )
goto V_110;
}
V_89 -> V_82 = V_82 ;
V_29 = & V_26 -> V_30 -> V_29 ;
F_16 ( & V_29 -> V_31 ) ;
V_89 = F_57 ( V_54 , V_26 , & V_89 -> V_8 , V_102 ,
V_19 , V_68 , 0 , 0 , V_51 , 0 ,
& V_103 , V_80 ,
V_100 ) ;
F_44 ( V_54 , V_26 , V_89 , & V_37 -> V_8 , V_19 ,
V_68 , V_6 , V_90 , V_91 , V_51 ) ;
F_14 ( & V_29 -> V_31 ) ;
if ( V_103 )
return F_58 ( V_54 , V_102 ) ;
return 0 ;
V_110:
F_50 ( V_106 , V_89 ) ;
V_107:
...
T_1 V_19 , T_1 V_68 ,
T_1 V_6 , T_1 V_90 ,
T_1 V_97 , T_1 V_11 , T_1 V_111 , int V_51 ,
int * V_80 , int * V_100 )
{
struct V_7 * V_37 ;
struct V_12 * V_89 ;
...
F_16 ( & V_29 -> V_31 ) ;
V_89 = F_57 ( V_54 , V_26 , & V_89 -> V_8 , V_102 ,
V_19 , V_68 , V_90 , V_111 ,
V_51 , 1 , & V_103 ,
V_80 , V_100 ) ;
F_51 ( V_54 , V_26 , V_89 , & V_37 -> V_8 , V_19 ,
V_68 , V_6 , V_90 , V_97 , V_11 ,
V_51 ) ;
F_14 ( & V_29 -> V_31 ) ;
if ( V_103 )
return F_58 ( V_54 , V_102 ) ;
...
V_29 = & V_26 -> V_30 -> V_29 ;
F_16 ( & V_29 -> V_31 ) ;
F_57 ( V_54 , V_26 , & V_89 -> V_8 , NULL , V_19 ,
V_68 , 0 , 0 , V_112 ,
V_82 -> V_55 , NULL , NULL , NULL ) ;
F_14 ( & V_29 -> V_31 ) ;
return 0 ;
}
struct V_12 *
F_61 ( struct V_28 * V_29 , T_1 V_19 )
{
