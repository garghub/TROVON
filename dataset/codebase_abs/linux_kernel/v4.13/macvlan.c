...
{
if ( V_160 [ V_199 ] ) {
if ( F_172 ( V_160 [ V_199 ] ) != V_28 )
return - V_131 ;
if ( ! F_105 ( F_173 ( V_160 [ V_199 ] ) ) )
return - V_123 ;
}
if ( V_87 && V_87 [ V_200 ] &&
F_174 ( V_87 [ V_200 ] ) & ~ V_103 )
return - V_131 ;
if ( V_87 && V_87 [ V_201 ] ) {
...
if ( V_87 && V_87 [ V_208 ] ) {
if ( F_172 ( V_87 [ V_208 ] ) != V_28 )
return - V_131 ;
if ( ! F_105 ( F_173 ( V_87 [ V_208 ] ) ) )
return - V_123 ;
}
if ( V_87 && V_87 [ V_209 ] )
return - V_131 ;
...
char * V_6 = NULL ;
int V_74 , V_210 , V_56 ;
struct V_159 * V_211 , * V_212 ;
struct V_16 * V_17 ;
if ( V_87 [ V_208 ] )
V_6 = F_173 ( V_87 [ V_208 ] ) ;
if ( V_44 == V_204 ) {
if ( ! V_6 )
return - V_131 ;
...
if ( ! V_87 || ! V_87 [ V_213 ] )
return 0 ;
V_212 = F_173 ( V_87 [ V_213 ] ) ;
V_56 = F_172 ( V_87 [ V_213 ] ) ;
F_177 (nla, head, len, rem) {
if ( F_178 ( V_211 ) != V_208 ||
F_172 ( V_211 ) != V_28 )
continue;
V_6 = F_173 ( V_211 ) ;
V_74 = F_18 ( V_13 , V_6 ) ;
...
int F_179 ( struct V_214 * V_215 , struct V_9 * V_10 ,
...
if ( ! V_160 [ V_218 ] )
return - V_131 ;
V_89 = F_180 ( V_215 , F_175 ( V_160 [ V_218 ] ) ) ;
if ( V_89 == NULL )
return - V_219 ;
if ( F_181 ( V_89 ) )
V_89 = F_182 ( V_89 ) ;
...
V_13 -> V_44 = V_67 ;
if ( V_87 && V_87 [ V_201 ] )
V_13 -> V_44 = F_175 ( V_87 [ V_201 ] ) ;
if ( V_87 && V_87 [ V_200 ] )
V_13 -> V_3 = F_174 ( V_87 [ V_200 ] ) ;
if ( V_13 -> V_44 == V_68 ) {
if ( V_2 -> V_146 ) {
V_47 = - V_131 ;
goto V_222;
...
V_216 = F_175 ( V_87 [ V_203 ] ) ;
V_47 = F_176 ( V_13 , V_216 , V_87 ) ;
if ( V_47 )
goto V_222;
}
V_47 = F_187 ( V_10 ) ;
...
static int F_193 ( struct V_214 * V_215 , struct V_9 * V_10 ,
struct V_159 * V_160 [] , struct V_159 * V_87 [] ,
struct V_197 * V_198 )
{
return F_179 ( V_215 , V_10 , V_160 , V_87 ) ;
}
void F_194 ( struct V_9 * V_10 , struct V_225 * V_212 )
{
struct V_12 * V_13 = F_78 ( V_10 ) ;
if ( V_13 -> V_44 == V_202 )
F_64 ( V_13 -> V_2 , V_13 ) ;
...
if ( V_87 && V_87 [ V_200 ] ) {
T_8 V_3 = F_174 ( V_87 [ V_200 ] ) ;
bool V_228 = ( V_3 ^ V_13 -> V_3 ) & V_103 ;
if ( F_1 ( V_13 -> V_2 ) && V_228 ) {
int V_47 ;
if ( V_3 & V_103 )
...
return 0 ;
return F_200 ( 0 )
+ V_13 -> V_24 * F_200 ( sizeof( V_229 ) * V_28 ) ;
}
...
if ( V_17 -> V_13 != V_13 )
continue;
if ( F_203 ( V_30 , V_208 , V_28 , V_17 -> V_6 ) )
return 1 ;
}
return 0 ;
}
...
int V_46 ;
struct V_159 * V_230 ;
if ( F_205 ( V_30 , V_201 , V_13 -> V_44 ) )
goto V_231;
if ( F_206 ( V_30 , V_200 , V_13 -> V_3 ) )
goto V_231;
if ( F_205 ( V_30 , V_209 , V_13 -> V_24 ) )
goto V_231;
if ( V_13 -> V_24 > 0 ) {
V_230 = F_207 ( V_30 , V_213 ) ;
if ( V_230 == NULL )
goto V_231;
for ( V_46 = 0 ; V_46 < V_51 ; V_46 ++ ) {
...
static struct V_214 * F_211 ( const struct V_9 * V_10 )
{
return F_74 ( F_182 ( V_10 ) ) ;
}
static int F_212 ( struct V_242 * V_243 ,
unsigned long V_244 , void * V_245 )
{
struct V_9 * V_10 = F_213 ( V_245 ) ;
struct V_12 * V_13 , * V_246 ;
struct V_1 * V_2 ;
F_214 ( V_247 ) ;
if ( ! F_184 ( V_10 ) )
return V_248 ;
...
V_13 -> V_10 -> V_107 -> V_258 ( V_13 -> V_10 , & V_247 ) ;
F_220 ( & V_247 ) ;
break;
case V_259 :
return V_254 ;
