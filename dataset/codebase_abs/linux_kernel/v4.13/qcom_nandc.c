...
static int F_95 ( struct V_269 * V_270 )
{
struct V_4 * V_6 = F_96 ( V_270 ) ;
struct V_248 * V_271 = V_6 -> V_82 -> V_272 ;
int V_74 ;
V_74 = F_89 ( V_271 , L_25 , & V_6 -> V_92 ) ;
if ( V_74 ) {
F_18 ( V_6 -> V_82 , L_26 ) ;
return V_74 ;
}
V_74 = F_89 ( V_271 , L_27 , & V_6 -> V_89 ) ;
if ( V_74 ) {
F_18 ( V_6 -> V_82 , L_28 ) ;
return V_74 ;
}
...
static int F_97 ( struct V_269 * V_270 )
{
struct V_4 * V_6 ;
struct V_1 * V_43 ;
const void * V_273 ;
struct V_250 * V_82 = & V_270 -> V_82 ;
struct V_248 * V_249 = V_82 -> V_272 , * V_274 ;
struct V_275 * V_276 ;
int V_74 ;
V_6 = F_81 ( & V_270 -> V_82 , sizeof( * V_6 ) , V_75 ) ;
if ( ! V_6 )
return - V_76 ;
F_98 ( V_270 , V_6 ) ;
V_6 -> V_82 = V_82 ;
V_273 = F_99 ( V_82 ) ;
if ( ! V_273 ) {
F_18 ( & V_270 -> V_82 , L_29 ) ;
return - V_245 ;
}
V_6 -> V_221 = ( unsigned long ) V_273 ;
V_276 = F_100 ( V_270 , V_277 , 0 ) ;
V_6 -> V_8 = F_101 ( V_82 , V_276 ) ;
if ( F_102 ( V_6 -> V_8 ) )
return F_103 ( V_6 -> V_8 ) ;
V_6 -> V_87 = F_104 ( V_82 , ( V_278 ) V_276 -> V_279 ) ;
V_6 -> V_280 = F_105 ( V_82 , L_30 ) ;
if ( F_102 ( V_6 -> V_280 ) )
return F_103 ( V_6 -> V_280 ) ;
V_6 -> V_281 = F_105 ( V_82 , L_31 ) ;
if ( F_102 ( V_6 -> V_281 ) )
return F_103 ( V_6 -> V_281 ) ;
V_74 = F_95 ( V_270 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_78 ( V_6 ) ;
if ( V_74 )
return V_74 ;
V_74 = F_106 ( V_6 -> V_280 ) ;
if ( V_74 )
goto V_282;
V_74 = F_106 ( V_6 -> V_281 ) ;
if ( V_74 )
goto V_283;
V_74 = F_87 ( V_6 ) ;
if ( V_74 )
...
static int F_114 ( struct V_269 * V_270 )
{
struct V_4 * V_6 = F_96 ( V_270 ) ;
struct V_1 * V_43 ;
F_34 (host, &nandc->host_list, node)
