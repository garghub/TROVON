...
void F_5 ( int V_26 , unsigned * V_7 )
{
* V_7 &= ~ V_27 ;
* V_7 |= V_26 ;
}
int F_6 ( struct V_28 * V_2 ,
struct V_29 * V_30 ,
const T_1 * V_31 ,
unsigned int V_32 ,
T_2 * V_33 ,
...
static void T_3 F_8 ( struct V_28 * V_38 )
{
struct V_29 * V_39 = F_9 ( V_38 ) ;
struct V_8 * V_9 ;
struct V_10 * V_11 ;
struct V_40 * V_41 ;
const T_4 * V_42 ;
...
static void T_3 F_22 ( const struct V_52 * V_53 )
{
struct V_29 * V_54 = F_23 ( L_6 ) ;
const struct V_52 * V_55 ;
if ( ! V_54 )
return;
V_55 = F_24 ( V_53 , V_54 ) ;
if ( V_55 ) {
void (* F_25)( void ) = V_55 -> V_56 ;
F_25 () ;
}
F_16 ( V_54 ) ;
}
struct V_28 * T_3 F_26 ( struct V_29 * V_39 ,
