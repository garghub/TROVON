...
enum V_92 V_138 ;
T_1 V_139 ;
T_2 = F_86 ( V_100 , L_23 , & V_139 ) ;
if ( T_2 )
V_139 = 0 ;
if ( V_139 >= V_5 . V_80 -> V_137 )
continue;
V_138 = V_5 . V_80 -> V_140 [ V_139 ] ;
switch ( V_138 ) {
case V_141 :
V_136 = F_87 ( V_104 , V_100 ) ;
break;
case V_9 :
V_136 = F_88 ( V_104 , V_100 ) ;
break;
default:
break;
}
} while ( ! V_136 &&
( V_100 = F_85 ( V_134 , V_100 ) ) != NULL );
if ( V_136 )
F_89 ( V_104 ) ;
return V_136 ;
}
...
{
struct V_133 * V_142 = V_104 -> V_105 . V_135 ;
struct V_143 * V_144 ;
int T_2 ;
if ( ! V_142 )
return 0 ;
...
if ( F_97 ( V_142 , L_29 , L_30 ) >= 0 ) {
V_5 . V_147 = F_98 ( V_104 , 0 , V_144 ) ;
if ( F_69 ( V_5 . V_147 ) )
return F_70 ( V_5 . V_147 ) ;
}
if ( F_97 ( V_142 , L_29 , L_31 ) >= 0 ) {
V_5 . V_148 = F_98 ( V_104 , 1 , V_144 ) ;
if ( F_69 ( V_5 . V_148 ) ) {
F_99 ( V_5 . V_147 ) ;
return F_70 ( V_5 . V_148 ) ;
}
}
return 0 ;
}
static int F_100 ( struct V_149 * V_105 )
{
...
if ( T_2 )
return T_2 ;
V_151 = F_102 ( V_5 . V_104 , V_153 , 0 ) ;
if ( ! V_151 ) {
F_13 ( L_32 ) ;
return - V_101 ;
}
V_5 . V_6 = F_103 ( & V_104 -> V_105 , V_151 -> V_51 ,
F_104 ( V_151 ) ) ;
if ( ! V_5 . V_6 ) {
F_13 ( L_33 ) ;
return - V_113 ;
...
V_152 = F_4 ( V_46 ) ;
F_107 ( V_158 L_34 ,
F_108 ( V_152 , 7 , 4 ) , F_108 ( V_152 , 3 , 0 ) ) ;
F_33 () ;
...
static void F_113 ( struct V_149 * V_105 )
{
struct V_109 * V_104 = F_101 ( V_105 ) ;
V_1 = false ;
...
static int F_115 ( struct V_149 * V_105 , void * V_68 )
{
struct V_149 * V_160 = V_68 ;
return V_105 == V_160 ;
}
static int F_116 ( struct V_149 * V_105 , void * V_68 )
{
struct V_161 * * V_162 = V_68 ;
if ( strstr ( F_117 ( V_105 ) , L_36 ) )
return 0 ;
F_118 ( V_105 -> V_134 , V_162 , F_115 , V_105 ) ;
return 0 ;
}
...
int T_2 ;
F_120 ( & V_104 -> V_105 , & V_162 , F_116 ) ;
T_2 = F_121 ( & V_104 -> V_105 , & V_163 , V_162 ) ;
if ( T_2 )
return T_2 ;
return 0 ;
}
...
{
F_123 ( & V_104 -> V_105 , & V_163 ) ;
return 0 ;
}
static int F_124 ( struct V_149 * V_105 )
{
F_6 () ;
F_125 ( V_105 , 0 ) ;
F_126 ( V_105 ) ;
...
static int F_127 ( struct V_149 * V_105 )
{
int T_2 ;
F_128 ( V_105 ) ;
