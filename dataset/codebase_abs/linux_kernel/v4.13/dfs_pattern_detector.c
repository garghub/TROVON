...
static bool
F_21 ( struct V_6 * V_7 , struct V_27 * V_28 )
{
T_1 V_4 ;
struct V_8 * V_9 ;
if ( V_7 -> V_3 == V_29 )
return true ;
V_9 = F_15 ( V_7 , V_28 -> V_16 ) ;
if ( V_9 == NULL )
return false ;
if ( V_28 -> V_30 < V_7 -> V_12 )
F_17 ( V_7 ) ;
V_7 -> V_12 = V_28 -> V_30 ;
for ( V_4 = 0 ; V_4 < V_7 -> V_10 ; V_4 ++ ) {
struct V_14 * V_31 = V_9 -> V_11 [ V_4 ] ;
struct V_32 * V_33 = V_31 -> V_34 ( V_31 , V_28 ) ;
if ( V_33 != NULL ) {
F_14 ( V_7 -> V_24 , V_25 ,
L_2
L_3 ,
V_28 -> V_16 , V_31 -> V_21 -> V_35 ,
V_33 -> V_36 , V_33 -> V_37 , V_33 -> V_38 ) ;
V_31 -> F_4 ( V_31 , V_7 -> V_12 ) ;
return true ;
}
}
return false ;
...
struct V_6 *
F_24 ( struct V_42 * V_24 ,
enum V_2 V_3 )
{
struct V_6 * V_7 ;
if ( ! F_25 ( V_43 ) )
return NULL ;
V_7 = F_9 ( sizeof( * V_7 ) , V_44 ) ;
if ( V_7 == NULL )
return NULL ;
* V_7 = V_45 ;
F_10 ( & V_7 -> V_23 ) ;
