...
F_64 ( 1 , V_190 , V_11 ,
L_6 ,
V_11 -> V_18 << 1 , V_11 -> V_22 -> V_191 ) ;
goto V_189;
}
F_65 ( V_11 , L_7 ,
V_11 -> V_18 << 1 , V_11 -> V_22 -> V_191 ) ;
V_25 -> V_83 = & V_192 [ V_160 -> V_184 ] ;
V_25 -> V_44 = & V_74 [ 0 ] ;
V_25 -> V_40 = 0 ;
V_39 . V_47 = 1 ;
V_39 . V_48 = 30 ;
...
F_67 ( & V_25 -> V_7 , & V_195 ,
V_167 , 0 , 1 , 1 , 0 ) ;
V_25 -> V_165 = F_67 ( & V_25 -> V_7 , & V_195 ,
V_164 , 0 , 256 , 1 , 128 ) ;
V_25 -> V_136 = F_67 ( & V_25 -> V_7 , & V_195 ,
V_196 , - 180 , 180 , 5 , 0 ) ;
V_25 -> V_149 = F_67 ( & V_25 -> V_7 , & V_195 ,
V_197 , 0 , 255 , 1 , 128 ) ;
V_25 -> V_198 = F_67 ( & V_25 -> V_7 , & V_195 ,
V_161 , 0 , 1 , 1 , 1 ) ;
V_25 -> V_170 = F_67 ( & V_25 -> V_7 , & V_195 ,
V_199 , 0 , 65535 , 1 , 500 ) ;
V_25 -> V_200 = F_68 ( & V_25 -> V_7 , & V_195 ,
V_168 , V_169 , 0 ,
V_159 ) ;
V_3 -> V_201 = & V_25 -> V_7 ;
if ( V_25 -> V_7 . error ) {
