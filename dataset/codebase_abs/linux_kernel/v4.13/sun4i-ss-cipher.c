...
V_74 = F_38 ( V_4 -> V_75 , struct V_73 ,
V_76 . V_77 . V_38 ) ;
V_6 -> V_8 = V_74 -> V_8 ;
F_39 ( F_40 ( V_4 ) ,
sizeof( struct V_10 ) ) ;
...
int F_41 ( struct V_3 * V_4 , const T_2 * V_37 ,
unsigned int V_36 )
{
struct V_5 * V_6 = F_3 ( V_4 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
...
int F_44 ( struct V_3 * V_4 , const T_2 * V_37 ,
unsigned int V_36 )
{
struct V_5 * V_6 = F_3 ( V_4 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
...
int V_84 ;
if ( F_45 ( V_36 != V_85 ) ) {
F_42 ( V_8 -> V_31 , L_6 , V_36 ) ;
F_43 ( V_4 , V_81 ) ;
return - V_32 ;
}
V_29 = F_46 ( V_4 ) ;
V_84 = F_47 ( V_82 , V_37 ) ;
if ( F_45 ( ! V_84 ) && ( V_29 & V_86 ) ) {
F_43 ( V_4 , V_87 ) ;
...
int F_48 ( struct V_3 * V_4 , const T_2 * V_37 ,
unsigned int V_36 )
{
struct V_5 * V_6 = F_3 ( V_4 ) ;
struct V_7 * V_8 = V_6 -> V_8 ;
