...
static int F_32 ( struct V_6 * V_6 , T_2 V_47 )
{
int V_5 ;
T_1 V_15 [ 2 ] ;
...
static int F_33 ( struct V_6 * V_6 , T_2 V_47 )
{
int V_5 ;
T_1 V_15 [ 1 ] ;
struct V_1 * V_1 = (struct V_1 * ) V_6 ;
...
static int F_34 ( struct V_6 * V_6 , T_2 V_47 )
{
int V_5 ;
T_1 V_15 [ 2 ] ;
struct V_1 * V_1 = (struct V_1 * ) V_6 ;
...
V_5 = F_21 ( V_6 , V_41 , V_39 ) ;
return V_5 ;
}
static int F_36 ( struct V_58 * V_59 )
{
struct V_6 * V_6 =
F_37 ( V_59 -> V_60 , struct V_6 , V_29 ) ;
int V_5 ;
if ( ! V_6 -> V_61 )
return 0 ;
switch ( V_59 -> V_62 ) {
case V_32 :
V_5 = F_33 ( V_6 , V_59 -> V_47 ) ;
break;
case V_34 :
V_5 = F_34 ( V_6 , V_59 -> V_47 ) ;
break;
case V_37 :
V_5 = F_32 ( V_6 , V_59 -> V_47 ) ;
break;
case V_40 :
V_5 = F_35 ( V_6 ) ;
break;
...
static int F_28 ( struct V_1 * V_1 , T_1 V_47 )
{
int V_5 = 0 ;
T_1 V_15 [ 1 ] ;
V_5 = F_38 ( V_1 , V_63 , V_15 ) ;
if ( V_5 < 0 )
return V_5 ;
if ( V_47 )
V_15 [ 0 ] = V_15 [ 0 ] | V_64 ;
...
static int F_20 ( struct V_1 * V_1 , T_1 * V_65 )
{
int V_5 = F_38 ( V_1 , V_63 , V_65 ) ;
* V_65 = ( * V_65 & V_66 ) ? 0 : 1 ;
return V_5 ;
}
