...
V_6 -= V_28 ;
V_23 += V_28 ;
if ( ! F_15 ( V_19 -> V_32 , & V_19 -> V_33 , V_28 ) )
return - V_27 ;
}
return V_26 ;
}
...
V_47 . V_37 , V_21 , V_46 . V_52 ) ;
if ( V_26 ) {
F_25 ( & V_2 -> V_10 . V_11 ,
L_3 ,
( V_21 == V_53 ) ? L_4 : L_5 ,
( unsigned long long ) V_46 . V_52 , V_6 ) ;
V_44 -> V_54 = F_26 ( V_26 ) ;
break;
}
}
...
T_2 V_57 , void * V_31 , T_6 V_58 , int V_21 ,
unsigned long V_59 )
{
struct V_1 * V_2 = F_30 ( & V_56 -> V_11 ) ;
struct V_14 * V_22 = F_8 ( V_2 ) ;
T_2 V_23 ;
V_23 = F_5 ( V_2 , V_57 , V_58 ) ;
if ( F_31 ( V_57 + V_58 > V_2 -> V_60 ) ) {
F_7 ( & V_56 -> V_11 , 1 , L_2 ) ;
return - V_61 ;
}
if ( V_23 == V_12 )
return - V_27 ;
return V_22 -> V_36 ( V_22 , V_23 , V_31 , V_58 , V_21 ) ;
}
...
V_62 -> V_73 = V_43 ;
V_62 -> V_59 = V_74 ;
F_45 ( & V_2 -> V_10 , V_62 -> V_75 ) ;
F_46 ( V_62 , 0 ) ;
F_47 ( V_11 , V_62 ) ;
if ( F_39 ( V_11 , F_34 , V_62 ) )
return - V_67 ;
if ( F_1 ( V_2 ) ) {
int V_76 = F_48 ( V_62 , F_1 ( V_2 ) ) ;
if ( V_76 )
return V_76 ;
}
F_46 ( V_62 , V_63 >> V_41 ) ;
...
static int F_50 ( struct V_16 * V_11 )
{
struct V_55 * V_56 ;
struct V_1 * V_2 ;
V_56 = F_51 ( V_11 ) ;
...
if ( F_56 ( V_11 ) )
return F_57 ( V_56 ) ;
else if ( F_58 ( V_11 , V_56 ) == 0 ) {
return - V_78 ;
} else
return F_37 ( V_2 ) ;
}
static int F_59 ( struct V_16 * V_11 )
{
if ( F_56 ( V_11 ) )
F_60 ( F_61 ( V_11 ) ) ;
return 0 ;
