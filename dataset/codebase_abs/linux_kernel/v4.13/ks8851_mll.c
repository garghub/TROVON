...
static int F_78 ( struct V_53 * V_23 ,
struct V_169 * V_157 )
{
struct V_1 * V_2 = F_36 ( V_23 ) ;
F_79 ( & V_2 -> V_159 , V_157 ) ;
return 0 ;
}
static int F_80 ( struct V_53 * V_23 ,
const struct V_169 * V_157 )
{
struct V_1 * V_2 = F_36 ( V_23 ) ;
...
V_2 -> V_133 = 0 ;
V_2 -> V_122 = 0 ;
V_2 -> V_57 = F_97 ( & V_2 -> V_209 -> V_165 , F_96 ,
V_210 ) ;
if ( ! V_2 -> V_57 )
return false ;
F_67 ( V_2 , V_211 ) ;
...
static int F_98 ( struct V_212 * V_209 )
{
int V_94 ;
...
T_2 V_216 , V_4 ;
const char * V_217 ;
V_23 = F_99 ( sizeof( struct V_1 ) ) ;
if ( ! V_23 )
return - V_218 ;
F_100 ( V_23 , & V_209 -> V_165 ) ;
V_2 = F_36 ( V_23 ) ;
V_2 -> V_23 = V_23 ;
V_214 = F_101 ( V_209 , V_219 , 0 ) ;
V_2 -> V_10 = F_102 ( & V_209 -> V_165 , V_214 ) ;
if ( F_103 ( V_2 -> V_10 ) ) {
V_94 = F_104 ( V_2 -> V_10 ) ;
goto V_220;
}
V_215 = F_101 ( V_209 , V_219 , 1 ) ;
V_2 -> V_9 = F_102 ( & V_209 -> V_165 , V_215 ) ;
if ( F_103 ( V_2 -> V_9 ) ) {
V_94 = F_104 ( V_2 -> V_9 ) ;
goto V_220;
}
V_23 -> V_80 = F_105 ( V_209 , 0 ) ;
if ( ( int ) V_23 -> V_80 < 0 ) {
V_94 = V_23 -> V_80 ;
goto V_220;
}
...
V_2 -> V_159 . V_226 = 1 ;
V_2 -> V_159 . V_227 = 0xf ;
V_2 -> V_159 . V_228 = F_87 ;
V_2 -> V_159 . V_229 = F_88 ;
F_92 ( V_23 , L_14 , V_167 ) ;
V_2 -> V_167 = F_108 ( V_167 , ( V_230 |
V_231 |
V_232 ) ) ;
F_16 ( V_2 ) ;
if ( ( F_4 ( V_2 , V_233 ) & ~ V_234 ) != V_235 ) {
F_91 ( V_23 , L_15 ) ;
V_94 = - V_236 ;
goto V_220;
}
...
F_94 ( V_2 ) ;
V_4 = F_4 ( V_2 , V_238 ) ;
F_6 ( V_2 , V_238 , V_4 | V_239 ) ;
if ( V_209 -> V_165 . V_240 ) {
V_217 = F_111 ( V_209 -> V_165 . V_240 ) ;
if ( V_217 )
memcpy ( V_2 -> V_148 , V_217 , V_143 ) ;
} else {
struct V_241 * V_101 ;
V_101 = F_112 ( & V_209 -> V_165 ) ;
if ( ! V_101 ) {
F_91 ( V_23 , L_16 ) ;
V_94 = - V_236 ;
goto V_242;
}
memcpy ( V_2 -> V_148 , V_101 -> V_148 , V_143 ) ;
}
if ( ! F_113 ( V_2 -> V_148 ) ) {
F_114 ( V_2 -> V_148 ) ;
F_92 ( V_23 , L_17 ) ;
...
memcpy ( V_23 -> V_152 , V_2 -> V_148 , V_143 ) ;
F_67 ( V_2 , V_23 -> V_152 ) ;
V_216 = F_4 ( V_2 , V_233 ) ;
F_92 ( V_23 , L_19 ,
( V_216 >> 8 ) & 0xff , ( V_216 >> 4 ) & 0xf , ( V_216 >> 1 ) & 0x7 ) ;
return 0 ;
V_242:
F_115 ( V_23 ) ;
V_220:
...
static int F_117 ( struct V_212 * V_209 )
{
struct V_53 * V_23 = F_118 ( V_209 ) ;
F_115 ( V_23 ) ;
F_116 ( V_23 ) ;
return 0 ;
}
