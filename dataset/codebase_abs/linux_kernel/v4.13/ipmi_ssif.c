...
{
struct V_1 * V_1 = V_108 ;
if ( ! F_47 ( F_48 ( V_1 -> V_40 -> V_121 ) ) )
return - V_122 ;
F_49 ( V_1 -> V_40 ) ;
return 0 ;
}
static void F_50 ( void * V_108 )
{
struct V_1 * V_1 = V_108 ;
F_51 ( V_1 -> V_40 ) ;
F_52 ( V_1 -> V_40 -> V_121 ) ;
}
static int F_53 ( void * V_108 ,
T_1 V_6 )
{
struct V_1 * V_1 = V_108 ;
V_1 -> V_6 = V_6 ;
...
static int F_54 ( struct V_62 * V_40 )
{
struct V_1 * V_1 = F_32 ( V_40 ) ;
struct V_123 * V_119 ;
int V_49 ;
...
F_59 (addr_info, &ssif_infos, link) {
if ( V_119 -> V_40 == V_40 ) {
V_119 -> V_40 = NULL ;
break;
}
...
static int F_61 ( struct V_62 * V_40 , int V_69 , unsigned char * V_5 ,
...
static int F_63 ( struct V_62 * V_40 , struct V_132 * V_133 )
{
unsigned char * V_126 ;
unsigned char V_5 [ 3 ] ;
int V_49 ;
int V_69 ;
V_126 = F_64 ( V_82 , V_134 ) ;
if ( ! V_126 )
return - V_135 ;
V_5 [ 0 ] = V_16 << 2 ;
V_5 [ 1 ] = V_136 ;
V_49 = F_61 ( V_40 , 2 , V_5 , & V_69 , V_126 ) ;
if ( V_49 )
V_49 = - V_122 ;
else
F_65 ( V_133 -> type , V_137 , V_138 ) ;
F_60 ( V_126 ) ;
return V_49 ;
}
static int F_66 ( struct V_139 * V_140 , void * V_141 )
{
F_67 ( V_140 , L_21 ) ;
return 0 ;
}
static int F_68 ( struct V_142 * V_142 , struct V_143 * V_143 )
{
return F_69 ( V_143 , F_66 , V_142 -> V_144 ) ;
}
static int F_70 ( struct V_139 * V_140 , void * V_141 )
{
...
static int F_73 ( struct V_142 * V_142 , struct V_143 * V_143 )
{
return F_69 ( V_143 , F_70 , F_74 ( V_142 ) ) ;
}
static int F_75 ( char * V_146 , char * V_147 )
{
while ( * V_146 && * V_147 ) {
while ( isspace ( * V_146 ) )
V_146 ++ ;
...
static struct V_123 * F_76 ( unsigned short V_148 ,
char * V_149 ,
bool V_150 )
{
struct V_123 * V_133 , * V_151 = NULL ;
V_106:
F_59 (info, &ssif_infos, link) {
if ( V_133 -> V_152 . V_148 == V_148 ) {
if ( V_133 -> V_149 || V_149 ) {
if ( ! V_133 -> V_149 != ! V_149 ) {
continue;
}
if ( V_149 &&
...
static bool F_77 ( struct V_1 * V_1 , struct V_153 * V_118 )
{
#ifdef F_78
T_3 T_3 ;
T_3 = F_79 ( V_118 ) ;
if ( T_3 ) {
V_1 -> V_117 = V_154 ;
V_1 -> V_119 . V_155 . T_3 = T_3 ;
return true ;
}
#endif
return false ;
}
static int F_80 ( struct V_62 * V_40 , int V_156 )
{
#ifdef F_81
if ( ! V_156 )
V_156 = F_82 (
...
static int F_83 ( struct V_62 * V_40 , const struct V_158 * V_159 )
{
unsigned char V_5 [ 3 ] ;
unsigned char * V_126 ;
struct V_1 * V_1 ;
...
int V_77 ;
T_4 V_156 = 0 ;
struct V_123 * V_119 = NULL ;
V_126 = F_64 ( V_82 , V_134 ) ;
if ( ! V_126 )
return - V_135 ;
V_1 = F_84 ( sizeof( * V_1 ) , V_134 ) ;
if ( ! V_1 ) {
F_60 ( V_126 ) ;
return - V_135 ;
}
if ( ! F_77 ( V_1 , & V_40 -> V_118 ) ) {
V_119 = F_76 ( V_40 -> V_148 , V_40 -> V_121 -> V_160 ,
true ) ;
if ( ! V_119 ) {
V_1 -> V_117 = V_161 ;
} else {
...
V_156 = F_80 ( V_40 , V_156 ) ;
F_29 ( V_8 L_35 ,
F_85 ( V_1 -> V_117 ) ,
V_40 -> V_148 , V_40 -> V_121 -> V_160 , V_156 ) ;
V_5 [ 0 ] = V_16 << 2 ;
V_5 [ 1 ] = V_136 ;
V_49 = F_61 ( V_40 , 2 , V_5 , & V_69 , V_126 ) ;
if ( V_49 )
goto V_163;
V_49 = F_86 ( V_126 , V_69 , & V_1 -> V_164 ) ;
if ( V_49 )
goto V_163;
V_1 -> V_40 = V_40 ;
F_87 ( V_40 , V_1 ) ;
...
V_5 [ 1 ] = V_165 ;
V_5 [ 2 ] = 0 ;
V_49 = F_61 ( V_40 , 3 , V_5 , & V_69 , V_126 ) ;
...
F_91 ( & V_1 -> V_184 [ V_77 ] , 0 ) ;
if ( V_1 -> V_170 )
V_1 -> V_40 -> V_2 |= V_185 ;
V_1 -> V_186 . V_187 = V_188 ;
V_1 -> V_186 . V_189 = F_53 ;
V_1 -> V_186 . F_43 = F_43 ;
V_1 -> V_186 . F_40 = F_40 ;
V_1 -> V_186 . F_45 = F_45 ;
V_1 -> V_186 . F_46 = F_46 ;
...
{
unsigned int V_190 ;
V_190 = ( ( F_48 ( V_1 -> V_40 -> V_121 )
<< 8 ) |
V_1 -> V_40 -> V_148 ) ;
F_23 ( & V_1 -> V_35 ) ;
V_1 -> V_124 = F_92 ( F_20 , V_1 ,
L_42 , V_190 ) ;
if ( F_93 ( V_1 -> V_124 ) ) {
V_49 = F_94 ( V_1 -> V_124 ) ;
F_95 ( & V_1 -> V_40 -> V_118 ,
...
static int F_99 ( struct V_153 * V_194 , void * V_195 )
{
struct V_123 * V_119 = V_195 ;
if ( V_194 -> type != & V_196 )
return 0 ;
F_100 ( F_101 ( V_194 ) , & V_119 -> V_152 ) ;
if ( ! V_119 -> V_149 )
return 1 ;
return 0 ;
}
static int F_102 ( int V_148 , char * V_149 ,
int V_162 , int V_156 ,
enum V_197 V_116 ,
struct V_153 * V_118 )
{
...
int V_49 = 0 ;
F_103 ( & V_198 ) ;
if ( F_76 ( V_148 , V_149 , false ) ) {
V_49 = - V_199 ;
goto V_200;
}
V_119 = F_84 ( sizeof( * V_119 ) , V_134 ) ;
if ( ! V_119 ) {
V_49 = - V_135 ;
goto V_200;
}
if ( V_149 ) {
V_119 -> V_149 = F_104 ( V_149 , V_134 ) ;
if ( ! V_119 -> V_149 ) {
F_60 ( V_119 ) ;
V_49 = - V_135 ;
goto V_200;
...
strncpy ( V_119 -> V_152 . type , V_137 ,
sizeof( V_119 -> V_152 . type ) ) ;
V_119 -> V_152 . V_148 = V_148 ;
V_119 -> V_152 . V_201 = V_119 ;
V_119 -> V_162 = V_162 ;
V_119 -> V_156 = V_156 ;
V_119 -> V_116 = V_116 ;
V_119 -> V_118 = V_118 ;
...
{
struct V_123 * V_133 , * V_205 ;
F_103 ( & V_198 ) ;
F_110 (info, tmp, &ssif_infos, link) {
F_111 ( & V_133 -> V_202 ) ;
F_60 ( V_133 -> V_149 ) ;
F_60 ( V_133 ) ;
}
...
static unsigned short * F_112 ( void )
{
struct V_123 * V_133 ;
...
F_59 (info, &ssif_infos, link)
V_206 ++ ;
V_207 = F_84 ( sizeof( * V_207 ) * ( V_206 + 1 ) , V_134 ) ;
if ( ! V_207 )
return NULL ;
V_77 = 0 ;
F_59 (info, &ssif_infos, link) {
unsigned short V_148 = V_133 -> V_152 . V_148 ;
int V_208 ;
...
return F_102 ( V_213 , NULL , 0 , 0 , V_221 , NULL ) ;
}
...
static void F_114 ( void ) { }
static int F_116 ( struct V_228 * V_229 )
{
T_4 type , V_156 = 0 ;
T_6 V_230 ;
int V_49 ;
if ( ! V_231 )
return - V_122 ;
V_49 = F_117 ( & V_229 -> V_118 , L_51 , & type ) ;
if ( V_49 )
return - V_122 ;
if ( type != V_157 )
return - V_122 ;
V_49 = F_118 ( & V_229 -> V_118 , L_52 , & V_230 ) ;
if ( V_49 ) {
F_119 ( & V_229 -> V_118 , V_8 L_53 ) ;
return - V_122 ;
}
V_49 = F_117 ( & V_229 -> V_118 , L_54 , & V_156 ) ;
if ( V_49 )
F_119 ( & V_229 -> V_118 , L_55 ) ;
return F_102 ( V_230 , NULL , 0 ,
V_156 , V_232 , & V_229 -> V_118 ) ;
}
static int F_116 ( struct V_228 * V_229 )
{
return - V_122 ;
}
static int F_120 ( struct V_228 * V_118 )
{
return F_116 ( V_118 ) ;
}
static int F_121 ( struct V_228 * V_118 )
{
struct V_123 * V_119 = F_122 ( & V_118 -> V_118 ) ;
if ( ! V_119 )
return 0 ;
F_103 ( & V_198 ) ;
if ( V_119 -> V_40 )
...
V_49 = F_102 ( V_148 [ V_77 ] , V_149 [ V_77 ] ,
V_233 [ V_77 ] , V_234 [ V_77 ] ,
V_235 , NULL ) ;
if ( V_49 )
F_8 ( V_8
L_57 ,
