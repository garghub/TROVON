...
V_52 = F_28 ( V_50 , sizeof( struct V_51 ) ) ;
F_29 ( V_50 ) ;
F_30 ( V_50 ) ;
F_28 ( V_50 , V_56 ) ;
F_29 ( V_50 ) ;
...
F_41 ( V_54 , & V_7 -> V_64 ) ;
F_42 ( F_19 ( & V_7 -> V_64 ) < 0 ) ;
}
return F_38 ( V_10 ) ;
}
static struct V_8 * F_43 ( char * V_86 )
{
struct V_8 * V_9 ;
F_9 (sk, &iucv_sk_list.head)
...
static void F_49 ( struct V_8 * V_94 )
{
struct V_8 * V_9 ;
while ( ( V_9 = F_50 ( V_94 , NULL ) ) ) {
F_51 ( V_9 ) ;
F_52 ( V_9 ) ;
}
V_94 -> V_13 = V_20 ;
...
static int F_57 ( struct V_8 * V_9 , T_2 V_29 )
{
int V_10 = 0 ;
int V_102 ;
struct V_49 * V_50 ;
...
static void F_65 ( struct V_8 * V_9 , struct V_8 * V_94 )
{
if ( V_94 ) {
V_9 -> V_80 = V_94 -> V_80 ;
F_66 ( V_94 , V_9 ) ;
...
static struct V_8 * F_67 ( struct V_115 * V_8 , int V_116 , T_3 V_117 , int V_118 )
{
struct V_8 * V_9 ;
struct V_6 * V_7 ;
V_9 = F_68 ( & V_119 , V_120 , V_117 , & V_121 , V_118 ) ;
if ( ! V_9 )
return NULL ;
V_7 = F_10 ( V_9 ) ;
F_69 ( V_8 , V_9 ) ;
...
static int F_76 ( struct V_135 * V_135 , struct V_115 * V_8 , int V_83 ,
int V_118 )
{
struct V_8 * V_9 ;
if ( V_83 && V_83 != V_120 )
...
V_9 = F_67 ( V_8 , V_83 , V_142 , V_118 ) ;
if ( ! V_9 )
return - V_85 ;
F_65 ( V_9 , NULL ) ;
return 0 ;
}
void F_75 ( struct V_143 * V_144 , struct V_8 * V_9 )
{
F_77 ( & V_144 -> V_12 ) ;
F_78 ( V_9 , & V_144 -> V_55 ) ;
F_79 ( & V_144 -> V_12 ) ;
}
void F_53 ( struct V_143 * V_144 , struct V_8 * V_9 )
{
F_77 ( & V_144 -> V_12 ) ;
F_80 ( V_9 ) ;
F_79 ( & V_144 -> V_12 ) ;
}
void F_81 ( struct V_8 * V_94 , struct V_8 * V_9 )
{
unsigned long V_29 ;
struct V_6 * V_145 = F_10 ( V_94 ) ;
F_82 ( V_9 ) ;
F_83 ( & V_145 -> V_123 , V_29 ) ;
F_84 ( & F_10 ( V_9 ) -> V_122 , & V_145 -> V_122 ) ;
F_85 ( & V_145 -> V_123 , V_29 ) ;
F_10 ( V_9 ) -> V_94 = V_94 ;
F_86 ( V_94 ) ;
}
...
struct V_8 * F_50 ( struct V_8 * V_94 , struct V_115 * V_146 )
{
struct V_6 * V_147 , * V_148 ;
struct V_8 * V_9 ;
F_90 (isk, n, &iucv_sk(parent)->accept_q, accept_q) {
...
{
char V_149 [ 12 ] ;
sprintf ( V_149 , L_6 , F_93 ( & V_11 . V_150 ) ) ;
while ( F_43 ( V_149 ) ) {
sprintf ( V_149 , L_6 ,
F_93 ( & V_11 . V_150 ) ) ;
}
...
static int F_94 ( struct V_115 * V_8 , struct V_151 * V_152 ,
int V_153 )
{
...
static int F_101 ( struct V_115 * V_8 , struct V_151 * V_152 ,
int V_180 , int V_29 )
{
struct V_154 * V_155 = (struct V_154 * ) V_152 ;
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_6 * V_7 = F_10 ( V_9 ) ;
int V_10 ;
if ( V_180 < sizeof( struct V_154 ) || V_152 -> V_158 != V_159 )
return - V_160 ;
...
if ( V_7 -> V_35 == V_108 )
V_10 = F_57 ( V_8 -> V_9 , V_60 ) ;
else
V_10 = F_99 ( V_8 , V_152 ) ;
if ( V_10 )
goto V_162;
if ( V_9 -> V_13 != V_16 )
V_10 = F_62 ( V_9 , F_16 ( V_9 , V_16 ,
V_14 ) ,
F_102 ( V_9 , V_29 & V_181 ) ) ;
...
static int F_103 ( struct V_115 * V_8 , int V_182 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
int V_10 ;
F_60 ( V_9 ) ;
...
static int F_104 ( struct V_115 * V_8 , struct V_115 * V_146 ,
int V_29 , bool V_118 )
{
F_105 ( V_45 , V_185 ) ;
...
V_107 = F_107 ( V_9 , V_29 & V_181 ) ;
F_108 ( F_109 ( V_9 ) , & V_45 ) ;
while ( ! ( V_186 = F_50 ( V_9 , V_146 ) ) ) {
F_110 ( V_188 ) ;
if ( ! V_107 ) {
V_10 = - V_177 ;
break;
...
static int F_115 ( struct V_115 * V_8 , struct V_151 * V_152 ,
int * V_78 , int V_191 )
{
...
static int F_116 ( struct V_99 * V_37 , struct V_26 * V_27 ,
struct V_49 * V_50 )
{
T_2 V_196 [ 8 ] ;
...
static int F_117 ( struct V_115 * V_8 , struct V_199 * V_27 ,
T_1 V_78 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_6 * V_7 = F_10 ( V_9 ) ;
...
switch ( V_204 -> V_219 ) {
case V_220 :
if ( V_204 -> V_221 != F_121 ( V_222 ) ) {
V_10 = - V_160 ;
goto V_214;
}
memcpy ( & V_202 . V_216 ,
( void * ) F_122 ( V_204 ) , V_222 ) ;
break;
default:
V_10 = - V_160 ;
goto V_214;
...
V_50 = F_123 ( V_9 , V_200 + V_201 , V_78 - V_201 ,
V_208 , & V_10 , 0 ) ;
if ( ! V_50 )
goto V_214;
if ( V_200 )
...
V_10 = F_125 ( V_50 , 0 , & V_27 -> V_227 , V_78 ) ;
if ( V_10 )
goto V_228;
V_107 = F_102 ( V_9 , V_208 ) ;
V_10 = F_62 ( V_9 , F_17 ( V_9 ) , V_107 ) ;
if ( V_10 )
goto V_228;
if ( V_9 -> V_13 != V_16 ) {
V_10 = - V_113 ;
...
V_50 -> V_78 <= 7 ) {
V_10 = F_116 ( V_7 -> V_37 , & V_202 , V_50 ) ;
if ( V_10 == 0 ) {
F_39 ( V_50 , & V_7 -> V_21 ) ;
F_40 ( V_50 ) ;
}
...
V_230 [ 0 ] . V_32 = ( V_233 ) F_130 ( V_50 ) ;
for ( V_231 = 0 ; V_231 < F_131 ( V_50 ) -> V_235 ; V_231 ++ ) {
T_4 * V_236 = & F_131 ( V_50 ) -> V_237 [ V_231 ] ;
V_230 [ V_231 + 1 ] . V_232 =
( V_233 ) ( V_234 ) F_132 ( V_236 ) ;
V_230 [ V_231 + 1 ] . V_32 = ( V_233 ) F_133 ( V_236 ) ;
}
...
static struct V_49 * F_134 ( unsigned long V_78 )
{
T_1 V_200 , V_201 ;
struct V_49 * V_50 ;
int V_10 ;
...
V_50 = F_135 ( V_200 + V_201 , V_78 - V_201 ,
0 , & V_10 , V_84 | V_133 ) ;
F_136 ( ! V_50 ,
L_9 ,
V_78 , V_10 ) ;
...
static void F_137 ( struct V_8 * V_9 , struct V_49 * V_50 ,
struct V_99 * V_37 ,
struct V_26 * V_27 )
{
int V_239 ;
...
F_90 (p, n, &iucv->message_q.list, list) {
V_50 = F_134 ( F_15 ( & V_245 -> V_27 ) ) ;
if ( ! V_50 )
break;
F_137 ( V_9 , V_50 , V_245 -> V_37 , & V_245 -> V_27 ) ;
F_142 ( & V_245 -> V_125 ) ;
F_143 ( V_245 ) ;
if ( ! F_61 ( & V_7 -> V_22 ) )
break;
...
static int F_144 ( struct V_115 * V_8 , struct V_199 * V_27 ,
T_1 V_78 , int V_29 )
{
...
F_61 ( & V_7 -> V_22 ) &&
F_61 ( & V_9 -> V_87 ) &&
F_145 ( & V_7 -> V_124 . V_125 ) )
return 0 ;
if ( V_29 & ( V_211 ) )
return - V_212 ;
V_50 = F_146 ( V_9 , V_29 , V_208 , & V_10 ) ;
if ( ! V_50 ) {
if ( V_9 -> V_104 & V_106 )
return 0 ;
return V_10 ;
}
V_242 = F_126 ( V_50 ) -> V_242 ;
V_247 = V_50 -> V_78 - V_242 ;
V_246 = F_147 (unsigned int, rlen, len) ;
if ( ! V_247 )
V_9 -> V_104 = V_9 -> V_104 | V_106 ;
V_249 = V_50 ;
if ( F_148 ( V_249 , V_242 , V_27 , V_246 ) ) {
if ( ! ( V_29 & V_250 ) )
F_149 ( & V_9 -> V_87 , V_50 ) ;
return - V_251 ;
}
...
V_10 = F_150 ( V_27 , V_218 , V_220 ,
sizeof( F_126 ( V_50 ) -> V_216 ) ,
( void * ) & F_126 ( V_50 ) -> V_216 ) ;
if ( V_10 ) {
if ( ! ( V_29 & V_250 ) )
F_149 ( & V_9 -> V_87 , V_50 ) ;
return V_10 ;
...
static inline unsigned int F_154 ( struct V_8 * V_94 )
{
struct V_6 * V_147 , * V_148 ;
struct V_8 * V_9 ;
F_90 (isk, n, &iucv_sk(parent)->accept_q, accept_q) {
...
unsigned int F_155 ( struct V_255 * V_255 , struct V_115 * V_8 ,
T_5 * V_45 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
unsigned int V_256 = 0 ;
F_156 ( V_255 , F_109 ( V_9 ) , V_45 ) ;
if ( V_9 -> V_13 == V_19 )
return F_154 ( V_9 ) ;
if ( V_9 -> V_23 || ! F_61 ( & V_9 -> V_88 ) )
V_256 |= V_257 |
( F_46 ( V_9 , V_258 ) ? V_259 : 0 ) ;
if ( V_9 -> V_104 & V_106 )
V_256 |= V_260 ;
if ( V_9 -> V_104 == V_261 )
V_256 |= V_262 ;
...
if ( V_9 -> V_13 == V_14 )
V_256 |= V_253 ;
if ( F_157 ( V_9 ) && F_17 ( V_9 ) )
V_256 |= V_263 | V_264 | V_265 ;
else
F_158 ( V_266 , V_9 ) ;
return V_256 ;
}
static int F_159 ( struct V_115 * V_8 , int V_267 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_6 * V_7 = F_10 ( V_9 ) ;
struct V_26 V_202 ;
...
static int F_160 ( struct V_115 * V_8 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
int V_10 = 0 ;
if ( ! V_9 )
...
static int F_164 ( struct V_115 * V_8 , int V_270 , int V_271 ,
...
if ( V_78 < 0 )
return - V_160 ;
V_78 = F_147 (unsigned int, len, sizeof(int)) ;
switch ( V_271 ) {
case V_276 :
...
if ( F_165 ( V_78 , V_273 ) )
return - V_251 ;
if ( F_166 ( V_272 , & V_274 , V_78 ) )
return - V_251 ;
return 0 ;
}
static int F_167 ( struct V_99 * V_37 ,
...
V_186 = F_67 ( NULL , V_9 -> V_80 , V_84 , 0 ) ;
if ( ! V_186 ) {
V_10 = V_100 -> V_101 ( V_37 , V_98 ) ;
F_56 ( V_37 ) ;
goto V_228;
...
static void F_172 ( struct V_99 * V_37 , T_2 V_281 [ 16 ] )
{
struct V_8 * V_9 = V_37 -> V_286 ;
V_9 -> V_13 = V_16 ;
V_9 -> V_25 ( V_9 ) ;
}
static void F_173 ( struct V_99 * V_37 , struct V_26 * V_27 )
{
struct V_8 * V_9 = V_37 -> V_286 ;
struct V_6 * V_7 = F_10 ( V_9 ) ;
struct V_49 * V_50 ;
...
F_174 ( & V_7 -> V_124 . V_12 ) ;
if ( ! F_145 ( & V_7 -> V_124 . V_125 ) ||
! F_61 ( & V_7 -> V_22 ) )
goto V_289;
V_78 = F_19 ( & V_9 -> V_90 ) ;
V_78 += F_175 ( F_15 ( V_27 ) ) ;
if ( V_78 > V_9 -> V_290 )
goto V_289;
V_50 = F_134 ( F_15 ( V_27 ) ) ;
if ( ! V_50 )
goto V_289;
F_137 ( V_9 , V_50 , V_37 , V_27 ) ;
goto V_291;
V_289:
V_287 = F_176 ( sizeof( struct V_244 ) , V_84 | V_133 ) ;
if ( ! V_287 )
goto V_291;
V_287 -> V_37 = V_37 ;
V_287 -> V_27 = * V_27 ;
F_84 ( & V_287 -> V_125 , & V_7 -> V_124 . V_125 ) ;
V_291:
F_177 ( & V_7 -> V_124 . V_12 ) ;
}
static void F_178 ( struct V_99 * V_37 ,
struct V_26 * V_27 )
{
struct V_8 * V_9 = V_37 -> V_286 ;
...
if ( V_27 -> V_229 == F_126 ( V_294 ) -> V_229 ) {
V_292 = V_294 ;
break;
}
V_294 = V_294 -> V_295 ;
...
static void F_180 ( struct V_99 * V_37 , T_2 V_281 [ 16 ] )
{
struct V_8 * V_9 = V_37 -> V_286 ;
if ( V_9 -> V_13 == V_20 )
return;
...
static void F_181 ( struct V_99 * V_37 , T_2 V_281 [ 16 ] )
{
struct V_8 * V_9 = V_37 -> V_286 ;
F_169 ( V_9 ) ;
if ( V_9 -> V_13 != V_20 ) {
...
static void F_182 ( struct V_49 * V_50 )
{
struct V_51 * V_296 =
...
static int F_187 ( struct V_8 * V_9 , struct V_49 * V_50 )
{
struct V_6 * V_7 = F_10 ( V_9 ) ;
struct V_51 * V_296 =
(struct V_51 * ) V_50 -> V_197 ;
...
if ( V_9 -> V_13 != V_16 )
return V_300 ;
F_41 ( V_296 -> V_61 , & V_7 -> V_39 ) ;
F_20 ( V_9 ) ;
return V_300 ;
}
static int F_188 ( struct V_8 * V_9 , struct V_49 * V_50 )
{
struct V_6 * V_7 = F_10 ( V_9 ) ;
if ( ! V_7 ) {
F_40 ( V_50 ) ;
...
static int F_191 ( struct V_49 * V_50 , struct V_156 * V_4 ,
...
if ( F_130 ( V_50 ) < ( V_56 + sizeof( struct V_51 ) ) )
if ( F_192 ( V_50 ) ) {
F_136 ( 1 , L_11 ,
( int ) V_50 -> V_78 ) ;
F_40 ( V_50 ) ;
...
F_189 ( V_50 , V_56 ) ;
V_296 = (struct V_51 * ) V_50 -> V_197 ;
F_168 ( V_296 -> V_67 , sizeof( V_296 -> V_67 ) ) ;
F_168 ( V_296 -> V_65 , sizeof( V_296 -> V_65 ) ) ;
F_168 ( V_296 -> V_71 , sizeof( V_296 -> V_71 ) ) ;
F_168 ( V_296 -> V_69 , sizeof( V_296 -> V_69 ) ) ;
...
case ( V_268 ) :
case 0 :
F_126 ( V_50 ) -> V_216 = V_296 -> V_73 . V_216 ;
V_10 = F_188 ( V_9 , V_50 ) ;
break;
default:
;
...
struct V_49 * V_53 ;
unsigned long V_29 ;
F_193 ( & V_11 . V_12 , V_29 ) ;
F_9 (sk, &iucv_sk_list.head)
if ( V_9 == V_147 ) {
V_7 = F_10 ( V_9 ) ;
break;
}
F_194 ( & V_11 . V_12 , V_29 ) ;
if ( ! V_7 || F_46 ( V_9 , V_95 ) )
return;
V_125 = & V_7 -> V_21 ;
F_83 ( & V_125 -> V_12 , V_29 ) ;
if ( F_61 ( V_125 ) )
...
static int F_195 ( struct V_314 * V_292 ,
unsigned long V_315 , void * V_316 )
{
struct V_156 * V_317 = F_196 ( V_316 ) ;
struct V_8 * V_9 ;
struct V_6 * V_7 ;
switch ( V_315 ) {
case V_318 :
...
if ( V_10 )
goto V_326;
V_327 = F_176 ( sizeof( struct V_3 ) , V_142 ) ;
if ( ! V_327 ) {
V_10 = - V_85 ;
goto V_328;
}
...
V_327 -> V_330 = ( void ( * ) ( struct V_3 * ) ) F_143 ;
V_327 -> V_331 = & V_324 ;
V_10 = F_200 ( V_327 ) ;
if ( V_10 )
goto V_328;
...
int V_10 ;
if ( V_333 ) {
F_203 ( L_13 , V_167 , sizeof( V_167 ) , & V_10 ) ;
if ( F_98 ( V_10 ) ) {
F_42 ( V_10 ) ;
V_10 = - V_136 ;
goto V_214;
}
V_100 = F_204 ( F_205 ( V_334 ) , L_14 ) ;
if ( ! V_100 ) {
F_5 ( V_5 L_15 ) ;
