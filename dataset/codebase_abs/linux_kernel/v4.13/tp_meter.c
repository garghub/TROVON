...
if ( F_18 ( F_44 ( & V_11 -> V_52 ) == 0 ) )
goto V_107;
if ( F_58 ( F_59 ( V_79 -> V_74 ) ,
( T_1 ) F_44 ( & V_11 -> V_60 ) ) )
goto V_107;
V_101 = F_60 ( V_26 ) ;
if ( F_18 ( ! V_101 ) )
goto V_107;
V_73 = F_61 ( V_26 , V_79 -> V_87 ) ;
if ( F_18 ( ! V_73 ) )
goto V_107;
V_103 = F_11 ( V_33 ) - F_59 ( V_79 -> V_77 ) ;
if ( V_79 -> V_77 && V_103 )
F_8 ( V_11 , V_103 ) ;
F_43 ( V_11 ) ;
V_104 = F_59 ( V_79 -> V_74 ) ;
...
F_63 ( V_104 - F_44 ( & V_11 -> V_60 ) ,
& V_11 -> V_51 ) ;
F_64 ( & V_11 -> V_108 , 0 ) ;
if ( V_11 -> V_111 ) {
if ( F_58 ( V_104 , V_11 -> V_109 ) ) {
...
static int F_69 ( struct V_10 * V_11 , T_4 V_116 )
{
int V_117 ;
V_117 = F_70 ( V_11 -> V_62 ,
F_68 ( V_11 , V_116 ) ,
V_118 / 10 ) ;
return V_117 ;
}
static int F_71 ( void * V_56 )
{
...
V_113 = V_59 ;
F_72 ( sizeof( struct V_78 ) > V_59 ) ;
F_43 ( V_11 ) ;
F_73 ( V_122 , & V_11 -> V_45 ,
F_46 ( V_11 -> V_123 ) ) ;
while ( F_44 ( & V_11 -> V_52 ) != 0 ) {
if ( F_18 ( ! F_68 ( V_11 , V_113 ) ) ) {
F_69 ( V_11 , V_113 ) ;
continue;
}
...
void F_82 ( struct V_25 * V_26 , const T_2 * V_24 ,
T_1 V_123 , T_1 * V_3 )
{
struct V_10 * V_11 ;
T_2 V_127 [ 2 ] ;
...
V_11 -> V_120 = V_121 ;
F_64 ( & V_11 -> V_52 , 1 ) ;
memcpy ( V_11 -> V_1 , V_127 , sizeof( V_127 ) ) ;
V_11 -> V_2 = V_2 ;
V_11 -> V_61 = V_132 ;
F_64 ( & V_11 -> V_60 , V_132 ) ;
V_11 -> V_111 = false ;
V_11 -> V_109 = V_132 ;
V_11 -> V_14 = V_59 * 3 ;
V_11 -> V_15 = V_9 ;
...
void F_94 ( struct V_25 * V_26 , const T_2 * V_24 ,
T_2 V_136 )
{
struct V_72 * V_73 ;
struct V_10 * V_11 ;
...
static void F_96 ( unsigned long V_56 )
{
struct V_10 * V_11 = (struct V_10 * ) V_56 ;
struct V_39 * V_40 , * V_41 ;
struct V_25 * V_26 ;
...
static int F_98 ( struct V_25 * V_26 , const T_2 * V_24 ,
T_1 V_139 , T_5 V_77 , const T_2 * V_1 ,
int V_140 )
{
struct V_100 * V_101 = NULL ;
struct V_72 * V_73 ;
...
V_79 -> V_96 = V_141 ;
memcpy ( V_79 -> V_1 , V_1 , sizeof( V_79 -> V_1 ) ) ;
V_79 -> V_74 = F_55 ( V_139 ) ;
V_79 -> V_77 = V_77 ;
V_82 = F_56 ( V_81 , V_73 , NULL ) ;
if ( F_18 ( V_82 < 0 ) || ( V_82 == V_142 ) ) {
V_117 = V_58 ;
goto V_107;
}
V_117 = 0 ;
...
static bool F_99 ( struct V_10 * V_11 ,
const struct V_80 * V_81 )
{
const struct V_78 * V_79 ;
...
T_1 V_113 ;
bool V_144 = false ;
V_143 = F_85 ( sizeof( * V_143 ) , V_131 ) ;
if ( F_18 ( ! V_143 ) )
return false ;
V_79 = (struct V_78 * ) V_81 -> V_83 ;
V_143 -> V_74 = F_59 ( V_79 -> V_74 ) ;
V_113 = V_81 -> V_75 - sizeof( struct V_106 ) ;
V_143 -> V_75 = V_113 ;
F_6 ( & V_11 -> V_42 ) ;
if ( F_100 ( & V_11 -> V_133 ) ) {
F_101 ( & V_143 -> V_43 , & V_11 -> V_133 ) ;
goto V_107;
}
F_102 (un, &tp_vars->unacked_list, list) {
if ( V_143 -> V_74 == V_40 -> V_74 ) {
if ( V_143 -> V_75 > V_40 -> V_75 )
V_40 -> V_75 = V_143 -> V_75 ;
F_26 ( V_143 ) ;
V_144 = true ;
break;
}
if ( F_58 ( V_143 -> V_74 , V_40 -> V_74 ) )
continue;
F_103 ( & V_143 -> V_43 , & V_40 -> V_43 ) ;
V_144 = true ;
break;
}
if ( ! V_144 )
...
F_6 ( & V_11 -> V_42 ) ;
F_24 (un, safe, &tp_vars->unacked_list, list) {
if ( F_58 ( V_11 -> V_146 , V_40 -> V_74 ) )
break;
V_145 = V_40 -> V_74 + V_40 -> V_75 - V_11 -> V_146 ;
if ( F_58 ( V_11 -> V_146 , V_40 -> V_74 + V_40 -> V_75 ) )
V_11 -> V_146 += V_145 ;
F_25 ( & V_40 -> V_43 ) ;
F_26 ( V_40 ) ;
}
...
V_11 -> V_138 = V_33 ;
if ( F_58 ( V_74 , V_11 -> V_146 ) )
goto V_150;
if ( F_59 ( V_79 -> V_74 ) != V_11 -> V_146 ) {
if ( ! F_99 ( V_11 , V_81 ) )
goto V_107;
goto V_150;
}
V_149 = V_81 -> V_75 - sizeof( struct V_106 ) ;
V_11 -> V_146 += V_149 ;
F_104 ( V_11 ) ;
V_150:
F_98 ( V_26 , V_79 -> V_87 , V_11 -> V_146 ,
V_79 -> V_77 , V_79 -> V_1 , V_79 -> V_76 ) ;
V_107:
if ( F_65 ( V_11 ) )
F_28 ( V_11 ) ;
}
void F_107 ( struct V_25 * V_26 , struct V_80 * V_81 )
{
struct V_78 * V_79 ;
V_79 = (struct V_78 * ) V_81 -> V_83 ;
switch ( V_79 -> V_96 ) {
