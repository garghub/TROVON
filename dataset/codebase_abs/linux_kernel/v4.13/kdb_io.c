...
while ( V_59 ) {
V_59 -> V_78 ( V_59 , V_14 , V_50 - ( V_14 - V_67 ) ) ;
F_8 () ;
V_59 = V_59 -> V_79 ;
}
}
...
while ( V_59 ) {
V_59 -> V_78 ( V_59 , V_57 , strlen ( V_57 ) ) ;
F_8 () ;
V_59 = V_59 -> V_79 ;
}
if ( V_48 )
