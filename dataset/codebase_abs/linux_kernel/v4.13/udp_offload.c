...
V_49 = F_24 ( F_21 ( V_54 ) -> V_61 , V_54 , V_46 , V_2 ) ;
V_22:
F_6 () ;
V_33:
F_20 ( V_2 ) -> V_52 |= V_52 ;
...
static struct V_1 * * F_25 ( struct V_1 * * V_46 ,
struct V_1 * V_2 )
{
...
if ( F_20 ( V_2 ) -> V_52 )
goto V_67;
if ( F_27 ( V_2 , V_68 , V_26 -> V_38 ,
V_69 ) )
goto V_52;
else if ( V_26 -> V_38 )
F_28 ( V_2 , V_68 , V_26 -> V_38 ,
V_69 ) ;
V_67:
F_20 ( V_2 ) -> V_4 = 0 ;
...
int F_29 ( struct V_1 * V_2 , int V_71 ,
T_4 V_47 )
{
T_2 V_72 = F_30 ( V_2 -> V_35 - V_71 ) ;
...
static int F_31 ( struct V_1 * V_2 , int V_71 )
{
...
return F_29 ( V_2 , V_71 , V_70 ) ;
}
int T_5 F_32 ( void )
{
return F_33 ( & V_78 , V_68 ) ;
}
