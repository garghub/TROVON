...
static int F_99 ( struct V_177 * * V_195 )
{
int V_196 = 0 ;
struct V_177 * V_155 = * V_195 ;
if ( V_155 -> V_155 . V_197 || V_155 -> V_155 . V_198 || V_155 -> V_155 . V_199 || V_155 -> V_155 . V_200 ) {
T_3 V_201 ;
T_3 V_202 ;
unsigned char * V_32 ;
int V_6 ;
int V_203 ;
V_202 = V_155 -> V_155 . V_69 - sizeof( struct V_146 ) ;
V_32 = & V_155 -> V_155 . V_184 [ V_202 ] ;
V_201 = V_32 [ 1 ] ;
if ( V_155 -> V_155 . V_197 > V_155 -> V_155 . V_69 )
V_155 -> V_155 . V_197 -= V_201 ;
if ( V_155 -> V_155 . V_198 > V_155 -> V_155 . V_69 )
V_155 -> V_155 . V_198 -= V_201 ;
if ( V_155 -> V_155 . V_199 > V_155 -> V_155 . V_69 )
V_155 -> V_155 . V_199 -= V_201 ;
if ( V_155 -> V_155 . V_200 > V_155 -> V_155 . V_69 )
V_155 -> V_155 . V_200 -= V_201 ;
V_155 -> V_155 . V_69 = 0 ;
memmove ( V_32 , V_32 + V_201 ,
V_155 -> V_155 . V_149 - V_202 - V_201 ) ;
V_6 = 0 ;
V_203 = 0 ;
while ( V_6 < V_155 -> V_155 . V_149 )
if ( V_155 -> V_155 . V_184 [ V_6 ] != V_204 ) {
V_6 += V_155 -> V_155 . V_184 [ V_6 + 1 ] ;
V_203 = V_6 ;
} else
V_6 ++ ;
V_196 = V_155 -> V_155 . V_149 ;
V_155 -> V_155 . V_149 = ( V_203 + 3 ) & ~ 3 ;
V_196 -= V_155 -> V_155 . V_149 ;
} else {
* V_195 = NULL ;
V_196 = V_155 -> V_155 . V_149 ;
...
struct V_179 * V_180 ;
V_180 = F_90 ( V_176 ) ;
V_155 = F_91 ( V_180 -> V_185 , 1 ) ;
if ( ! V_155 || V_155 -> V_155 . V_69 == 0 )
return;
V_196 = F_99 ( & V_180 -> V_185 ) ;
if ( V_180 -> V_186 && V_196 > 0 ) {
...
int V_33 ;
struct V_146 * V_147 ;
struct V_208 * V_155 = & F_106 ( V_145 ) -> V_155 ;
...
V_174 = V_33 ;
V_158 = ( V_174 + 3 ) & ~ 3 ;
V_209 = V_158 - V_155 -> V_149 ;
V_33 = F_107 ( V_145 , F_108 ( V_145 ) + V_209 ) ;
if ( V_33 < 0 )
return V_33 ;
if ( V_209 > 0 ) {
V_147 = F_82 ( V_145 ) ;
F_109 ( V_145 , V_209 ) ;
memmove ( ( char * ) V_147 - V_209 , V_147 , V_147 -> V_151 << 2 ) ;
F_110 ( V_145 ) ;
V_147 = F_82 ( V_145 ) ;
} else if ( V_209 < 0 ) {
V_147 = F_82 ( V_145 ) ;
memset ( V_147 + 1 , V_204 , V_155 -> V_149 ) ;
} else
V_147 = F_82 ( V_145 ) ;
if ( V_155 -> V_149 > 0 )
