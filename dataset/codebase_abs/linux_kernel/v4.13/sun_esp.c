...
int V_126 ;
if ( V_41 -> V_51 &&
( ! strcmp ( V_41 -> V_51 -> V_127 , L_1 ) ||
! strcmp ( V_41 -> V_51 -> V_127 , L_13 ) ) )
V_125 = V_41 -> V_51 ;
else if ( ! strcmp ( V_41 -> V_127 , L_14 ) ) {
...
if ( ! V_3 )
return - V_128 ;
V_126 = F_44 ( V_24 , V_3 , V_23 ) ;
if ( V_126 )
F_55 ( & V_3 -> V_25 ) ;
return V_126 ;
}
static int F_56 ( struct V_2 * V_24 )
{
struct V_1 * V_1 = F_57 ( & V_24 -> V_25 ) ;
...
V_1 -> V_29 ,
V_1 -> V_30 ) ;
F_51 ( & V_24 -> V_6 [ ( V_129 ? 1 : 0 ) ] , V_1 -> V_27 ,
V_28 ) ;
