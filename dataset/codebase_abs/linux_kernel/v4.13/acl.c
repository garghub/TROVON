...
static int F_22 ( struct V_38 * V_38 , int V_40 , struct V_7 * V_12 )
{
char * V_8 = NULL ;
T_1 V_5 = 0 ;
int V_39 ;
...
V_39 = F_25 ( V_38 , V_40 , L_2 , V_8 , V_5 , 0 ) ;
if ( ! V_8 && V_39 == - V_45 )
V_39 = 0 ;
F_18 ( V_8 ) ;
return V_39 ;
}
int F_26 ( struct V_38 * V_38 , struct V_7 * V_12 , int type )
{
int V_39 , V_40 ;
switch ( type ) {
case V_41 :
...
V_39 = F_22 ( V_38 , V_40 , V_12 ) ;
if ( ! V_39 )
F_31 ( V_38 , type , V_12 ) ;
return V_39 ;
}
int F_32 ( struct V_38 * V_57 , struct V_38 * V_38 , T_3 * V_48 )
{
struct V_7 * V_58 , * V_12 ;
int V_39 ;
F_33 ( V_38 ) ;
V_39 = F_34 ( V_57 , V_48 , & V_58 , & V_12 ) ;
if ( V_39 )
return V_39 ;
if ( V_58 ) {
F_31 ( V_38 , V_43 , V_58 ) ;
...
int F_35 ( struct V_38 * V_38 )
{
int V_39 ;
if ( V_38 -> V_59 ) {
V_39 = F_22 ( V_38 , V_44 , V_38 -> V_59 ) ;
if ( V_39 )
return V_39 ;
}
if ( V_38 -> V_60 ) {
V_39 = F_22 ( V_38 , V_42 , V_38 -> V_60 ) ;
if ( V_39 )
return V_39 ;
}
return 0 ;
