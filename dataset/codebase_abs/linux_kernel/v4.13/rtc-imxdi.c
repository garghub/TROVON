...
int V_96 , V_97 ;
int V_54 ;
V_2 = F_46 ( & V_9 -> V_10 , sizeof( * V_2 ) , V_98 ) ;
if ( ! V_2 )
return - V_99 ;
V_2 -> V_9 = V_9 ;
V_95 = F_47 ( V_9 , V_100 , 0 ) ;
...
F_54 ( & V_2 -> V_88 , F_42 ) ;
F_55 ( & V_2 -> V_61 ) ;
V_2 -> V_102 = F_56 ( & V_9 -> V_10 , NULL ) ;
if ( F_49 ( V_2 -> V_102 ) )
return F_50 ( V_2 -> V_102 ) ;
V_54 = F_57 ( V_2 -> V_102 ) ;
if ( V_54 )
return V_54 ;
F_2 ( 0 , V_2 -> V_5 + V_58 ) ;
...
if ( V_54 != 0 )
goto V_103;
V_54 = F_58 ( & V_9 -> V_10 , V_96 , F_38 ,
V_104 , V_9 -> V_105 , V_2 ) ;
if ( V_54 ) {
F_12 ( & V_9 -> V_10 , L_29 ) ;
goto V_103;
}
V_54 = F_58 ( & V_9 -> V_10 , V_97 , F_38 ,
V_104 , V_9 -> V_105 , V_2 ) ;
if ( V_54 ) {
F_12 ( & V_9 -> V_10 , L_30 ) ;
}
F_59 ( V_9 , V_2 ) ;
V_2 -> V_90 = F_60 ( & V_9 -> V_10 , V_9 -> V_105 ,
& V_106 , V_107 ) ;
if ( F_49 ( V_2 -> V_90 ) ) {
V_54 = F_50 ( V_2 -> V_90 ) ;
goto V_103;
