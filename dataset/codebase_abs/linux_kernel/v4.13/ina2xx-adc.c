...
{
struct V_15 * V_16 = F_5 ( V_8 ) ;
unsigned int V_74 = F_8 ( V_16 ) ;
F_44 ( & V_8 -> V_2 , L_2 ,
( unsigned int ) ( * V_8 -> V_76 ) ,
1000000 / V_74 , V_16 -> V_24 ) ;
F_44 ( & V_8 -> V_2 , L_3 , V_74 ) ;
F_44 ( & V_8 -> V_2 , L_4 ,
V_16 -> V_61 ) ;
V_16 -> V_77 = F_45 ( F_40 , ( void * ) V_8 ,
L_5 , V_8 -> V_78 , V_8 -> V_79 ,
V_74 ) ;
return F_46 ( V_16 -> V_77 ) ;
}
...
unsigned V_3 , unsigned V_80 , unsigned * V_81 )
{
struct V_15 * V_16 = F_5 ( V_8 ) ;
if ( ! V_81 )
return F_25 ( V_16 -> V_19 , V_3 , V_80 ) ;
return F_6 ( V_16 -> V_19 , V_3 , V_81 ) ;
}
...
enum V_87 type ;
int V_14 ;
V_8 = F_52 ( & V_83 -> V_2 , sizeof( * V_16 ) ) ;
if ( ! V_8 )
return - V_88 ;
V_16 = F_5 ( V_8 ) ;
F_53 ( V_83 , V_8 ) ;
V_16 -> V_19 = F_54 ( V_83 , & V_89 ) ;
if ( F_55 ( V_16 -> V_19 ) ) {
F_56 ( & V_83 -> V_2 , L_6 ) ;
return F_57 ( V_16 -> V_19 ) ;
}
if ( V_83 -> V_2 . V_90 )
type = (enum V_87 ) F_58 ( & V_83 -> V_2 ) ;
else
type = V_79 -> V_91 ;
V_16 -> V_31 = & V_92 [ type ] ;
F_59 ( & V_16 -> V_54 ) ;
if ( F_60 ( V_83 -> V_2 . V_90 ,
L_7 , & V_11 ) < 0 ) {
struct V_93 * V_94 =
F_61 ( & V_83 -> V_2 ) ;
if ( V_94 )
...
V_16 -> V_24 = 1 ;
F_18 ( V_16 , V_100 , & V_11 ) ;
F_20 ( V_16 , V_100 , & V_11 ) ;
}
V_14 = F_50 ( V_16 , V_11 ) ;
if ( V_14 ) {
F_56 ( & V_83 -> V_2 , L_8 ) ;
...
V_8 -> V_101 = V_102 | V_103 ;
V_8 -> V_2 . V_104 = & V_83 -> V_2 ;
V_8 -> V_2 . V_90 = V_83 -> V_2 . V_90 ;
if ( V_79 -> V_91 == V_57 ) {
V_8 -> V_105 = V_106 ;
V_8 -> V_107 = F_11 ( V_106 ) ;
V_8 -> V_108 = & V_109 ;
} else {
V_8 -> V_105 = V_110 ;
V_8 -> V_107 = F_11 ( V_110 ) ;
V_8 -> V_108 = & V_111 ;
}
V_8 -> V_78 = V_79 -> V_78 ;
V_8 -> V_112 = & V_113 ;
