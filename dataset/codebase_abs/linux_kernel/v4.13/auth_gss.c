...
static void F_36 ( struct V_47 * V_47 )
{
struct V_48 * V_49 = F_32 ( V_47 , V_50 ) ;
if ( F_37 ( & V_49 -> V_53 , & V_51 ) ) {
V_49 -> V_52 = - 1 ;
F_35 ( & V_51 ) ;
}
}
static void
F_38 ( struct V_55 * V_56 )
{
...
static struct V_55 *
F_44 ( struct V_60 * V_61 , T_3 V_62 , const struct V_63 * V_57 )
{
struct V_55 * V_64 ;
F_45 (pos, &pipe->in_downcall, list) {
if ( ! F_46 ( V_64 -> V_62 , V_62 ) )
continue;
...
struct V_55 * V_66 ;
F_33 ( & V_61 -> V_67 ) ;
V_66 = F_44 ( V_61 , V_56 -> V_62 , V_56 -> V_57 ) ;
if ( V_66 == NULL ) {
F_2 ( & V_56 -> V_3 ) ;
F_48 ( & V_56 -> V_58 , & V_61 -> V_68 ) ;
} else
V_56 = V_66 ;
F_35 ( & V_61 -> V_67 ) ;
return V_56 ;
...
static void
F_55 ( struct V_6 * V_6 , struct V_55 * V_56 )
{
...
int V_15 ;
V_15 = F_61 ( V_12 , V_85 , L_5 , V_84 -> V_86 ,
F_58 ( & V_80 , V_56 -> V_62 ) ) ;
V_85 -= V_15 ;
V_12 += V_15 ;
V_56 -> V_69 . V_15 = V_15 ;
if ( V_83 ) {
V_15 = F_61 ( V_12 , V_85 , L_6 , V_83 ) ;
V_85 -= V_15 ;
V_12 += V_15 ;
V_56 -> V_69 . V_15 += V_15 ;
}
if ( V_82 != NULL ) {
V_15 = F_61 ( V_12 , V_85 , L_7 , V_82 ) ;
V_85 -= V_15 ;
V_12 += V_15 ;
V_56 -> V_69 . V_15 += V_15 ;
}
if ( V_84 -> V_87 ) {
V_15 = F_61 ( V_12 , V_85 , L_8 ,
V_84 -> V_87 ) ;
V_85 -= V_15 ;
V_12 += V_15 ;
V_56 -> V_69 . V_15 += V_15 ;
}
V_15 = F_61 ( V_12 , V_85 , L_9 ) ;
if ( V_15 == 0 )
goto V_88;
V_56 -> V_69 . V_15 += V_15 ;
V_56 -> V_69 . V_20 = V_56 -> V_81 ;
...
static struct V_55 *
F_68 ( struct V_63 * V_63 , struct V_4 * V_5 )
{
struct V_6 * V_6 = F_7 ( V_5 ,
struct V_6 , V_7 ) ;
struct V_55 * V_94 , * V_56 ;
T_3 V_62 = V_5 -> V_95 ;
V_94 = F_63 ( V_63 , V_62 , V_6 -> V_96 ) ;
if ( F_17 ( V_94 ) )
return V_94 ;
V_56 = F_47 ( V_94 ) ;
if ( V_56 == V_94 ) {
...
int V_35 = 0 ;
F_29 ( L_12 ,
V_76 -> V_99 , V_46 , F_58 ( & V_80 , V_5 -> V_95 ) ) ;
V_56 = F_68 ( V_63 , V_5 ) ;
if ( F_30 ( V_56 ) == - V_54 ) {
F_70 () ;
V_76 -> V_100 = 15 * V_38 ;
F_72 ( & V_101 , V_76 , NULL ) ;
return - V_54 ;
}
if ( F_17 ( V_56 ) ) {
V_35 = F_30 ( V_56 ) ;
...
F_33 ( & V_61 -> V_67 ) ;
if ( V_6 -> V_74 != NULL )
F_72 ( & V_6 -> V_74 -> V_59 , V_76 , NULL ) ;
else if ( V_56 -> V_2 == NULL && V_56 -> V_69 . V_70 >= 0 ) {
V_76 -> V_100 = 0 ;
V_6 -> V_74 = V_56 ;
F_2 ( & V_56 -> V_3 ) ;
F_72 ( & V_56 -> V_59 , V_76 , F_56 ) ;
} else {
F_55 ( V_6 , V_56 ) ;
V_35 = V_56 -> V_69 . V_70 ;
}
...
F_29 ( L_13 ,
V_76 -> V_99 , V_46 ,
F_58 ( & V_80 , V_5 -> V_95 ) , V_35 ) ;
return V_35 ;
}
static inline int
F_73 ( struct V_63 * V_63 , struct V_6 * V_6 )
{
...
F_35 ( & V_61 -> V_67 ) ;
V_109:
F_80 ( & V_56 -> V_71 , & V_103 ) ;
F_38 ( V_56 ) ;
V_102:
F_29 ( L_15 ,
V_46 , F_58 ( & V_80 , V_5 -> V_95 ) , V_35 ) ;
return V_35 ;
}
static T_5
F_81 ( struct V_110 * V_111 , const char T_6 * V_112 , T_1 V_113 )
{
const void * V_12 , * V_13 ;
void * V_114 ;
struct V_55 * V_56 ;
struct V_60 * V_61 = F_82 ( F_83 ( V_111 ) ) -> V_61 ;
struct V_1 * V_2 ;
T_4 V_115 ;
T_3 V_62 ;
T_5 V_35 = - V_116 ;
...
goto V_102;
V_35 = - V_22 ;
V_114 = F_84 ( V_113 , V_21 ) ;
if ( ! V_114 )
goto V_102;
V_35 = - V_17 ;
if ( F_85 ( V_114 , V_112 , V_113 ) )
goto V_35;
...
static int F_89 ( struct V_125 * V_125 , int V_126 )
{
...
static int F_93 ( struct V_125 * V_125 )
{
return F_89 ( V_125 , 1 ) ;
}
static void
F_94 ( struct V_125 * V_125 )
{
struct V_47 * V_47 = V_125 -> V_127 -> V_128 ;
struct V_60 * V_61 = F_82 ( V_125 ) -> V_61 ;
struct V_55 * V_56 ;
V_130:
F_33 ( & V_61 -> V_67 ) ;
F_45 (gss_msg, &pipe->in_downcall, list) {
if ( ! F_40 ( & V_56 -> V_69 . V_58 ) )
continue;
...
static void F_96 ( struct V_134 * V_135 ,
struct V_136 * V_137 )
{
...
struct V_134 * V_134 ;
V_134 = F_99 ( V_135 , V_12 -> V_139 , V_12 -> V_140 , V_12 -> V_61 ) ;
if ( F_17 ( V_134 ) )
return F_30 ( V_134 ) ;
V_12 -> V_61 -> V_134 = V_134 ;
return 0 ;
}
static struct V_91 * F_100 ( struct V_141 * V_140 ,
const char * V_139 ,
const struct V_142 * V_143 )
{
struct V_91 * V_12 ;
int V_35 = - V_22 ;
V_12 = F_84 ( sizeof( * V_12 ) , V_144 ) ;
if ( V_12 == NULL )
goto V_35;
V_12 -> V_61 = F_101 ( V_143 , V_145 ) ;
if ( F_17 ( V_12 -> V_61 ) ) {
V_35 = F_30 ( V_12 -> V_61 ) ;
goto V_146;
}
...
static int F_104 ( struct V_136 * V_137 , void * V_20 )
{
struct V_91 * V_91 ;
...
static struct V_136 * F_106 ( void * V_20 )
{
struct V_91 * V_91 ;
struct V_148 * args = V_20 ;
V_91 = F_100 ( args -> V_140 , args -> V_139 , args -> V_143 ) ;
if ( ! F_17 ( V_91 ) )
return & V_91 -> V_137 ;
return NULL ;
}
static struct V_91 * F_107 ( struct V_141 * V_140 ,
const char * V_139 ,
const struct V_142 * V_143 )
{
struct V_47 * V_47 = F_108 ( V_140 ) ;
struct V_136 * V_137 ;
struct V_148 args = {
. V_140 = V_140 ,
. V_139 = V_139 ,
...
static void F_110 ( struct V_91 * V_12 )
{
...
static void F_114 ( struct V_91 * V_12 )
{
if ( V_12 != NULL )
F_115 ( & V_12 -> V_93 , F_113 ) ;
}
static struct V_63 *
F_116 ( struct V_151 * args , struct V_141 * V_140 )
{
...
if ( ! F_117 ( V_154 ) )
return F_15 ( V_35 ) ;
if ( ! ( V_63 = F_84 ( sizeof( * V_63 ) , V_144 ) ) )
goto V_155;
F_118 ( & V_63 -> V_156 ) ;
V_63 -> V_83 = NULL ;
if ( args -> V_83 ) {
V_63 -> V_83 = F_119 ( args -> V_83 , V_144 ) ;
if ( V_63 -> V_83 == NULL )
goto V_157;
}
V_63 -> V_158 = V_140 ;
V_63 -> V_47 = F_120 ( F_108 ( V_140 ) ) ;
V_35 = - V_118 ;
V_63 -> V_84 = F_121 ( V_152 ) ;
if ( ! V_63 -> V_84 ) {
F_29 ( L_21 , V_152 ) ;
goto V_159;
}
V_63 -> V_65 = F_122 ( V_63 -> V_84 , V_152 ) ;
if ( V_63 -> V_65 == 0 )
goto V_160;
if ( ! F_75 ( V_63 -> V_47 ) )
goto V_160;
...
if ( V_35 )
goto V_160;
V_91 = F_107 ( V_140 , L_22 , & V_171 ) ;
if ( F_17 ( V_91 ) ) {
V_35 = F_30 ( V_91 ) ;
goto V_172;
}
V_63 -> V_91 [ 1 ] = V_91 ;
V_91 = F_107 ( V_140 , V_63 -> V_84 -> V_86 ,
& V_173 ) ;
if ( F_17 ( V_91 ) ) {
V_35 = F_30 ( V_91 ) ;
goto V_174;
...
static void
F_131 ( struct V_93 * V_93 )
{
struct V_63 * V_63 = F_7 ( V_93 , struct V_63 , V_93 ) ;
F_130 ( V_63 ) ;
}
static void
F_42 ( struct V_63 * V_63 )
{
F_115 ( & V_63 -> V_93 , F_131 ) ;
}
static void
F_132 ( struct V_98 * V_57 )
{
...
if ( ! F_137 ( & V_63 -> V_98 . V_170 ) )
continue;
goto V_102;
}
if ( V_176 )
F_138 ( V_178 , & V_176 -> V_156 , V_177 ) ;
V_63 = V_176 ;
V_102:
F_35 ( & V_175 ) ;
return V_63 ;
...
static struct V_63 *
F_139 ( struct V_151 * args , struct V_141 * V_140 )
{
struct V_63 * V_63 ;
struct V_63 * V_176 ;
V_63 = F_135 ( args , V_140 , NULL ) ;
if ( V_63 != NULL )
goto V_102;
V_176 = F_116 ( args , V_140 ) ;
if ( F_17 ( V_176 ) )
return V_176 ;
V_63 = F_135 ( args , V_140 , V_176 ) ;
if ( V_63 != V_176 )
F_132 ( & V_176 -> V_98 ) ;
V_102:
return V_63 ;
...
static struct V_98 *
F_140 ( struct V_151 * args , struct V_141 * V_140 )
{
struct V_63 * V_63 ;
struct V_179 * V_180 = F_141 ( V_140 -> V_181 . V_182 ) ;
while ( V_140 != V_140 -> V_183 ) {
struct V_141 * V_184 = V_140 -> V_183 ;
if ( F_141 ( V_184 -> V_181 . V_182 ) != V_180 )
break;
V_140 = V_184 ;
}
V_63 = F_139 ( args , V_140 ) ;
if ( F_17 ( V_63 ) )
return F_142 ( V_63 ) ;
return & V_63 -> V_98 ;
}
static int
F_143 ( struct V_4 * V_5 )
{
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 , V_7 ) ;
struct V_63 * V_63 = F_7 ( V_5 -> V_97 , struct V_63 , V_98 ) ;
struct V_1 * V_2 = F_144 ( V_6 -> V_10 , 1 ) ;
struct V_75 * V_76 ;
...
V_5 -> V_186 = & V_187 ;
F_145 ( V_5 ) ;
V_76 = F_146 ( V_63 -> V_158 , V_5 , V_188 | V_189 ) ;
if ( ! F_17 ( V_76 ) )
F_147 ( V_76 ) ;
F_148 ( V_5 ) ;
return 1 ;
...
F_5 ( struct V_1 * V_2 )
{
F_152 ( & V_2 -> V_192 , F_151 ) ;
}
static void
F_153 ( struct V_6 * V_6 )
{
F_29 ( L_25 , V_46 , V_6 ) ;
F_43 ( V_6 ) ;
}
static void
F_154 ( struct V_190 * V_191 )
{
...
static int
F_158 ( struct V_194 * V_195 , unsigned int V_196 )
{
return F_159 ( F_58 ( & V_80 , V_195 -> V_62 ) , V_196 ) ;
}
static struct V_4 *
F_160 ( struct V_98 * V_57 , struct V_194 * V_195 , int V_197 )
{
return F_161 ( V_57 , V_195 , V_197 , V_21 ) ;
}
static struct V_4 *
F_162 ( struct V_98 * V_57 , struct V_194 * V_195 , int V_197 , T_8 V_198 )
{
struct V_63 * V_63 = F_7 ( V_57 , struct V_63 , V_98 ) ;
struct V_6 * V_5 = NULL ;
int V_35 = - V_22 ;
F_29 ( L_26 ,
V_46 , F_58 ( & V_80 , V_195 -> V_62 ) ,
V_57 -> V_168 ) ;
if ( ! ( V_5 = F_24 ( sizeof( * V_5 ) , V_198 ) ) )
goto V_199;
F_163 ( & V_5 -> V_7 , V_195 , V_57 , & V_200 ) ;
V_5 -> V_7 . V_9 = 1UL << V_8 ;
V_5 -> V_201 = V_63 -> V_65 ;
V_5 -> V_96 = NULL ;
if ( V_195 -> V_202 )
...
static int
F_164 ( struct V_98 * V_57 , struct V_4 * V_5 )
{
struct V_63 * V_63 = F_7 ( V_57 , struct V_63 , V_98 ) ;
struct V_6 * V_6 = F_7 ( V_5 , struct V_6 , V_7 ) ;
int V_35 ;
...
F_20 () ;
V_2 = F_21 ( V_6 -> V_10 ) ;
if ( ! V_2 || F_167 ( V_30 , V_2 -> V_37 ) )
V_34 = - V_41 ;
F_22 () ;
return V_34 ;
}
static int
F_168 ( struct V_194 * V_195 , struct V_4 * V_205 , int V_197 )
{
struct V_6 * V_6 = F_7 ( V_205 , struct V_6 , V_7 ) ;
struct V_1 * V_2 ;
int V_34 ;
...
if ( V_6 -> V_96 != NULL )
return 0 ;
V_34 = F_46 ( V_205 -> V_95 , V_195 -> V_62 ) ;
V_207:
if ( V_34 == 0 )
return V_34 ;
if ( F_8 ( V_208 , & V_195 -> V_209 ) &&
( F_166 ( V_205 ) != 0 ) ) {
F_169 ( V_208 , & V_195 -> V_209 ) ;
F_10 ( V_210 , & V_195 -> V_209 ) ;
}
return V_34 ;
}
static T_9 *
F_170 ( struct V_75 * V_76 , T_9 * V_12 )
{
...
F_35 ( & V_2 -> V_26 ) ;
* V_12 ++ = F_171 ( ( T_2 ) V_222 ) ;
* V_12 ++ = F_171 ( ( T_2 ) V_2 -> V_23 ) ;
* V_12 ++ = F_171 ( ( T_2 ) V_212 -> V_221 ) ;
* V_12 ++ = F_171 ( ( T_2 ) V_6 -> V_201 ) ;
V_12 = F_172 ( V_12 , & V_2 -> V_42 ) ;
* V_213 = F_171 ( ( V_12 - ( V_213 + 1 ) ) << 2 ) ;
V_217 . V_223 = F_173 ( V_212 -> V_224 ,
V_212 -> V_225 . V_191 [ 0 ] . V_223 ) ;
V_217 . V_226 = ( V_227 * ) V_12 - ( V_227 * ) V_217 . V_223 ;
F_174 ( & V_217 , & V_219 ) ;
* V_12 ++ = F_171 ( V_220 ) ;
V_215 . V_20 = ( V_227 * ) ( V_12 + 1 ) ;
V_214 = F_175 ( V_2 -> V_43 , & V_219 , & V_215 ) ;
if ( V_214 == V_228 ) {
F_12 ( V_11 , & V_5 -> V_9 ) ;
} else if ( V_214 != 0 ) {
F_88 ( L_29 , V_214 ) ;
...
V_12 = F_176 ( V_12 , NULL , V_215 . V_15 ) ;
F_3 ( V_2 ) ;
return V_12 ;
V_229:
F_3 ( V_2 ) ;
...
static int F_177 ( struct V_75 * V_76 )
{
...
if ( F_179 ( V_31 , V_232 , V_233 ) )
return 1 ;
}
return 0 ;
}
static int
F_180 ( struct V_75 * V_76 )
{
struct V_4 * V_5 = V_76 -> V_77 -> V_78 ;
int V_34 = 0 ;
if ( F_178 ( V_5 ) )
...
static int
F_181 ( struct V_75 * V_76 )
{
return 0 ;
}
static T_9 *
F_182 ( struct V_75 * V_76 , T_9 * V_12 )
{
struct V_4 * V_5 = V_76 -> V_77 -> V_78 ;
struct V_1 * V_2 = F_19 ( V_5 ) ;
T_9 * V_235 = NULL ;
...
V_215 . V_15 = V_15 ;
V_34 = F_15 ( - V_41 ) ;
V_214 = F_184 ( V_2 -> V_43 , & V_219 , & V_215 ) ;
if ( V_214 == V_228 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_214 ) {
F_29 ( L_30 ,
...
V_5 -> V_97 -> V_239 = F_185 ( V_15 ) + 2 ;
F_3 ( V_2 ) ;
F_29 ( L_31 ,
V_76 -> V_99 , V_46 ) ;
F_43 ( V_235 ) ;
return V_12 + F_185 ( V_15 ) ;
V_238:
F_3 ( V_2 ) ;
...
static void F_186 ( T_10 V_240 , struct V_211 * V_241 ,
T_9 * V_12 , void * V_242 )
{
struct V_243 V_244 ;
F_187 ( & V_244 , & V_241 -> V_225 , V_12 ) ;
...
* V_12 ++ = F_171 ( V_241 -> V_221 ) ;
F_186 ( V_240 , V_241 , V_12 , V_242 ) ;
if ( F_189 ( V_245 , & V_246 ,
V_248 , V_245 -> V_15 - V_248 ) )
return V_249 ;
* V_247 = F_171 ( V_246 . V_15 ) ;
...
V_215 . V_20 = ( V_227 * ) ( V_12 + 1 ) ;
V_214 = F_175 ( V_2 -> V_43 , & V_246 , & V_215 ) ;
V_249 = - V_123 ;
if ( V_214 == V_228 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
else if ( V_214 )
return V_249 ;
V_16 = F_176 ( V_12 , NULL , V_215 . V_15 ) ;
...
F_191 ( V_241 -> V_254 [ V_252 ] ) ;
F_43 ( V_241 -> V_254 ) ;
}
static int
F_192 ( struct V_211 * V_241 )
{
struct V_218 * V_245 = & V_241 -> V_225 ;
...
V_241 -> V_254
= F_84 ( V_241 -> V_253 * sizeof( struct V_259 * ) ,
V_21 ) ;
if ( ! V_241 -> V_254 )
goto V_102;
for ( V_252 = 0 ; V_252 < V_241 -> V_253 ; V_252 ++ ) {
V_241 -> V_254 [ V_252 ] = F_193 ( V_21 ) ;
...
if ( V_245 -> V_250 || V_245 -> V_251 [ 0 ] . V_226 ) {
V_265 = F_195 ( V_241 -> V_254 [ V_241 -> V_253 - 1 ] ) ;
memcpy ( V_265 , V_245 -> V_251 [ 0 ] . V_223 , V_245 -> V_251 [ 0 ] . V_226 ) ;
V_245 -> V_251 [ 0 ] . V_223 = V_265 ;
}
V_214 = F_196 ( V_2 -> V_43 , V_248 , V_245 , V_263 ) ;
F_39 ( V_245 -> V_15 > V_245 -> V_85 ) ;
V_249 = - V_123 ;
if ( V_214 == V_228 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
else if ( V_214 )
return V_249 ;
* V_262 = F_171 ( V_245 -> V_15 - V_248 ) ;
if ( V_245 -> V_250 || V_245 -> V_251 [ 0 ] . V_226 )
V_217 = V_245 -> V_251 ;
else
V_217 = V_245 -> V_191 ;
...
break;
case V_268 :
V_249 = F_188 ( V_5 , V_2 , V_240 , V_241 , V_12 , V_242 ) ;
break;
case V_269 :
V_249 = F_194 ( V_5 , V_2 , V_240 , V_241 , V_12 , V_242 ) ;
break;
}
V_102:
F_3 ( V_2 ) ;
...
if ( V_273 > V_270 -> V_15 )
return V_249 ;
if ( F_183 ( * ( * V_12 ) ++ ) != V_241 -> V_221 )
return V_249 ;
if ( F_189 ( V_270 , & V_246 , V_272 ,
V_273 - V_272 ) )
return V_249 ;
if ( F_199 ( V_270 , & V_215 , V_273 ) )
return V_249 ;
V_214 = F_184 ( V_2 -> V_43 , & V_246 , & V_215 ) ;
if ( V_214 == V_228 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_214 != V_274 )
return V_249 ;
...
static inline int
F_200 ( struct V_4 * V_5 , struct V_1 * V_2 ,
struct V_211 * V_241 , T_9 * * V_12 )
{
struct V_218 * V_270 = & V_241 -> V_271 ;
T_2 V_248 ;
...
V_214 = F_201 ( V_2 -> V_43 , V_248 , V_270 ) ;
if ( V_214 == V_228 )
F_12 ( V_11 , & V_5 -> V_9 ) ;
if ( V_214 != V_274 )
return V_249 ;
...
static int
F_202 ( T_11 V_275 , struct V_211 * V_241 ,
T_9 * V_12 , void * V_242 )
{
struct V_243 V_244 ;
F_203 ( & V_244 , & V_241 -> V_271 , V_12 ) ;
return V_275 ( V_241 , & V_244 , V_242 ) ;
}
static int
F_204 ( struct V_75 * V_76 ,
...
break;
case V_269 :
V_249 = F_200 ( V_5 , V_2 , V_241 , & V_12 ) ;
if ( V_249 )
goto V_102;
break;
}
...
+ ( V_277 - V_191 -> V_226 ) ;
V_278:
V_249 = F_202 ( V_275 , V_241 , V_12 , V_242 ) ;
V_102:
F_3 ( V_2 ) ;
F_29 ( L_33 ,
...
static T_12 int F_205 ( struct V_47 * V_47 )
{
return F_206 ( V_47 ) ;
}
static T_13 void F_207 ( struct V_47 * V_47 )
{
F_208 ( V_47 ) ;
}
static int T_14 F_209 ( void )
{
int V_35 = 0 ;
V_35 = F_210 ( & V_167 ) ;
if ( V_35 )
