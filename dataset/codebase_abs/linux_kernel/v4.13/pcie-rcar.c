...
F_7 ( V_5 , F_56 ( 0 ) , 0xff , V_111 ) ;
F_7 ( V_5 , F_56 ( V_112 ) ,
V_113 , V_114 << 4 ) ;
F_7 ( V_5 , F_17 ( V_115 ) , 0x7f ,
V_116 ) ;
F_7 ( V_5 , F_56 ( V_117 ) , V_118 ,
V_118 ) ;
F_7 ( V_5 , F_56 ( V_119 ) , V_120 , 0 ) ;
F_7 ( V_5 , V_121 + 1 , 0x3f , 50 ) ;
F_7 ( V_5 , F_57 ( 0 ) , 0xfff00000 , 0 ) ;
if ( F_43 ( V_88 ) )
...
{
unsigned int V_59 = 10 ;
F_53 ( V_5 , 0 , 0x42 , 0x1 , 0x0EC34191 ) ;
F_53 ( V_5 , 1 , 0x42 , 0x1 , 0x0EC34180 ) ;
F_53 ( V_5 , 0 , 0x43 , 0x1 , 0x00210188 ) ;
F_53 ( V_5 , 1 , 0x43 , 0x1 , 0x00210188 ) ;
F_53 ( V_5 , 0 , 0x44 , 0x1 , 0x015C0014 ) ;
F_53 ( V_5 , 1 , 0x44 , 0x1 , 0x015C0014 ) ;
F_53 ( V_5 , 1 , 0x4C , 0x1 , 0x786174A0 ) ;
F_53 ( V_5 , 1 , 0x4D , 0x1 , 0x048000BB ) ;
F_53 ( V_5 , 0 , 0x51 , 0x1 , 0x079EC062 ) ;
F_53 ( V_5 , 0 , 0x52 , 0x1 , 0x20000000 ) ;
F_53 ( V_5 , 1 , 0x52 , 0x1 , 0x20000000 ) ;
F_53 ( V_5 , 1 , 0x56 , 0x1 , 0x00003806 ) ;
F_53 ( V_5 , 0 , 0x60 , 0x1 , 0x004B03A5 ) ;
F_53 ( V_5 , 0 , 0x64 , 0x1 , 0x3F0F1F0F ) ;
F_53 ( V_5 , 0 , 0x66 , 0x1 , 0x00008000 ) ;
while ( V_59 -- ) {
if ( F_5 ( V_5 , V_125 ) )
return F_55 ( V_5 ) ;
F_38 ( 5 ) ;
...
static int F_66 ( struct V_1 * V_3 , int V_133 )
{
int V_89 ;
F_62 ( & V_3 -> V_129 ) ;
V_89 = F_67 ( V_3 -> V_130 , V_131 ,
F_68 ( V_133 ) ) ;
F_65 ( & V_3 -> V_129 ) ;
return V_89 ;
}
static void F_69 ( struct V_1 * V_3 , unsigned long V_134 )
{
F_62 ( & V_3 -> V_129 ) ;
F_70 ( V_134 , V_3 -> V_130 ) ;
F_65 ( & V_3 -> V_129 ) ;
}
static T_3 F_71 ( int V_134 , void * V_11 )
{
struct V_4 * V_5 = V_11 ;
...
return V_136 ;
while ( V_7 ) {
unsigned int V_19 = F_72 ( & V_7 , 32 ) ;
unsigned int V_134 ;
F_3 ( V_5 , 1 << V_19 , V_135 ) ;
V_134 = F_73 ( V_89 -> V_137 , V_19 ) ;
if ( V_134 ) {
if ( F_74 ( V_19 , V_89 -> V_130 ) )
F_75 ( V_134 ) ;
else
F_39 ( V_17 , L_10 ) ;
} else {
...
static int F_76 ( struct V_2 * V_3 , struct V_139 * V_140 ,
struct V_141 * V_142 )
{
...
if ( type == V_153 )
return - V_146 ;
F_80 ( ! F_81 ( & V_140 -> V_17 . V_154 ) ) ;
V_142 = F_82 ( V_140 -> V_17 . V_154 . V_155 , struct V_141 , V_156 ) ;
V_145 = F_66 ( V_89 , V_152 ) ;
if ( V_145 < 0 )
return - V_132 ;
V_134 = F_73 ( V_89 -> V_137 , V_145 ) ;
if ( ! V_134 )
...
if ( F_83 ( V_134 , V_55 , V_142 ) ) {
return - V_146 ;
}
}
V_142 -> V_157 = V_152 ;
V_142 -> V_158 . V_159 = F_68 ( V_152 ) ;
V_144 . V_147 = F_5 ( V_5 , V_148 ) & ~ V_149 ;
V_144 . V_150 = F_5 ( V_5 , V_151 ) ;
V_144 . V_11 = V_145 ;
F_78 ( V_134 , & V_144 ) ;
...
static void F_84 ( struct V_2 * V_3 , unsigned int V_134 )
{
struct V_1 * V_89 = F_1 ( V_3 ) ;
struct V_160 * V_161 = F_85 ( V_134 ) ;
F_69 ( V_89 , V_161 -> V_145 ) ;
}
static int F_86 ( struct V_162 * V_137 , unsigned int V_134 ,
T_4 V_145 )
{
F_87 ( V_134 , & V_163 , V_164 ) ;
F_88 ( V_134 , V_137 -> V_165 ) ;
return 0 ;
}
...
V_89 -> V_3 . V_167 = F_79 ;
V_89 -> V_3 . V_168 = F_84 ;
V_89 -> V_137 = F_91 ( V_17 -> V_169 , V_131 ,
& V_170 , & V_89 -> V_3 ) ;
if ( ! V_89 -> V_137 ) {
F_36 ( V_17 , L_12 ) ;
return - V_171 ;
...
F_92 ( V_89 -> V_137 , V_55 ) ;
V_104 = F_93 ( V_17 , V_89 -> V_172 , F_71 ,
V_173 | V_174 ,
V_163 . V_175 , V_5 ) ;
if ( V_104 < 0 ) {
...
V_104 = F_93 ( V_17 , V_89 -> V_176 , F_71 ,
V_173 | V_174 ,
V_163 . V_175 , V_5 ) ;
if ( V_104 < 0 ) {
F_36 ( V_17 , L_13 , V_104 ) ;
...
V_89 -> V_177 = F_94 ( V_178 , 0 ) ;
V_8 = F_95 ( ( void * ) V_89 -> V_177 ) ;
...
struct V_43 V_44 ;
int V_104 , V_55 ;
V_104 = F_98 ( V_17 -> V_169 , 0 , & V_44 ) ;
if ( V_104 )
return V_104 ;
V_5 -> V_8 = F_99 ( V_17 , & V_44 ) ;
if ( F_100 ( V_5 -> V_8 ) )
return F_101 ( V_5 -> V_8 ) ;
V_5 -> V_180 = F_102 ( V_17 , L_14 ) ;
if ( F_100 ( V_5 -> V_180 ) ) {
F_36 ( V_17 , L_15 ) ;
return F_101 ( V_5 -> V_180 ) ;
}
V_104 = F_103 ( V_5 -> V_180 ) ;
if ( V_104 )
return V_104 ;
V_5 -> V_181 = F_102 ( V_17 , L_16 ) ;
if ( F_100 ( V_5 -> V_181 ) ) {
F_36 ( V_17 , L_17 ) ;
V_104 = F_101 ( V_5 -> V_181 ) ;
goto V_182;
}
V_104 = F_103 ( V_5 -> V_181 ) ;
if ( V_104 )
goto V_182;
V_55 = F_104 ( V_17 -> V_169 , 0 ) ;
if ( ! V_55 ) {
F_36 ( V_17 , L_18 ) ;
V_104 = - V_183 ;
goto V_184;
...
V_47 |= V_195 ;
if ( V_188 > 0 ) {
unsigned long V_196 = F_107 ( V_188 ) ;
T_5 V_197 = 1ULL << V_196 ;
V_38 = F_108 ( V_186 -> V_38 , V_197 ) ;
} else {
V_38 = V_186 -> V_38 ;
}
V_38 = F_108 ( V_38 , 1ULL << 32 ) ;
V_10 = F_24 ( V_38 ) - 1 ;
V_10 &= ~ 0xf ;
while ( V_188 < V_189 ) {
F_3 ( V_5 , F_29 ( V_190 ) ,
F_109 ( V_193 ) ) ;
F_3 ( V_5 , F_29 ( V_188 ) , F_110 ( V_193 ) ) ;
...
int V_205 ;
V_200 -> V_202 = V_202 ;
V_200 -> V_206 = F_113 ( V_202 ) ;
V_200 -> V_207 = V_200 -> V_206 + V_203 + V_204 ;
V_200 -> V_186 = F_114 ( V_202 , L_20 , & V_205 ) ;
if ( ! V_200 -> V_186 )
return - V_183 ;
...
int V_19 = 0 ;
int V_104 ;
if ( F_112 ( & V_200 , V_207 ) )
return - V_146 ;
F_116 (&parser, &range) {
T_5 V_208 = V_186 . V_188 + V_186 . V_38 - 1 ;
F_19 ( V_5 -> V_17 , L_21 ,
V_186 . V_47 , V_186 . V_188 , V_208 , V_186 . V_190 ) ;
V_104 = F_106 ( V_5 , & V_186 , & V_19 ) ;
if ( V_104 )
return V_104 ;
}
return 0 ;
}
static int F_117 ( struct V_4 * V_53 )
{
int V_104 ;
...
V_104 = F_118 ( V_207 , 0 , 0xff , & V_53 -> V_212 ,
& V_210 ) ;
if ( V_104 )
return V_104 ;
V_104 = F_119 ( V_17 , & V_53 -> V_212 ) ;
if ( V_104 )
goto V_213;
F_120 (win, tmp, &pci->resources) {
struct V_43 * V_44 = V_42 -> V_44 ;
if ( F_33 ( V_44 ) == V_48 ) {
V_104 = F_121 ( V_44 , V_210 ) ;
if ( V_104 ) {
F_122 ( V_17 , L_22 ,
V_104 , V_44 ) ;
F_123 ( V_42 ) ;
...
static int F_125 ( struct V_214 * V_140 )
{
struct V_58 * V_17 = & V_140 -> V_17 ;
struct V_4 * V_5 ;
unsigned int V_11 ;
int V_104 ;
int (* F_126)( struct V_4 * );
struct V_75 * V_76 ;
V_76 = F_127 ( sizeof( * V_5 ) ) ;
if ( ! V_76 )
return - V_171 ;
V_5 = F_128 ( V_76 ) ;
V_5 -> V_17 = V_17 ;
