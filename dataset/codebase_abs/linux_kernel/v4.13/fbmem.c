...
V_235 = F_79 ( ( V_57 & ~ V_238 ) + V_58 ) >> V_239 ;
if ( V_234 -> V_240 >= V_235 ) {
if ( V_10 -> V_13 . V_241 ) {
F_5 ( & V_10 -> V_236 ) ;
return - V_147 ;
}
...
F_5 ( & V_10 -> V_236 ) ;
V_234 -> V_242 = F_80 ( V_234 -> V_243 ) ;
F_81 ( V_123 , V_234 , V_57 ) ;
return F_82 ( V_234 , V_57 , V_58 ) ;
}
static int
F_83 ( struct V_122 * V_122 , struct V_123 * V_123 )
__acquires( &info->lock
static int
F_84 ( struct V_122 * V_122 , struct V_123 * V_123 )
__acquires( &info->lock
unsigned long F_85 ( struct V_123 * V_244 ,
unsigned long V_42 , unsigned long V_58 ,
unsigned long V_245 , unsigned long V_43 )
{
struct V_1 * const V_10 = V_244 -> V_126 ;
unsigned long V_246 = F_79 ( V_10 -> V_15 . V_137 ) ;
...
static int F_92 ( struct V_255 * V_261 ,
...
if ( F_100 ( V_1 -> V_271 ) ) {
F_58 ( V_181 L_11 , V_35 , F_101 ( V_1 -> V_271 ) ) ;
V_1 -> V_271 = NULL ;
} else
F_102 ( V_1 ) ;
...
F_103 ( & V_1 -> V_168 ) ;
if ( V_1 -> V_282 )
F_104 ( V_1 -> V_271 , false ) ;
else
F_104 ( V_1 -> V_271 , true ) ;
F_55 ( & V_179 , & V_1 -> V_13 ) ;
...
return - V_147 ;
if ( V_1 -> V_271 ) {
F_109 ( V_272 , F_99 ( V_274 , V_35 ) ) ;
V_1 -> V_271 = NULL ;
}
return 0 ;
}
int F_110 ( struct V_255 * V_261 ,
const char * V_262 , bool V_263 )
{
int V_162 ;
F_3 ( & V_5 ) ;
V_162 = F_92 ( V_261 , V_262 , V_263 ) ;
F_5 ( & V_5 ) ;
return V_162 ;
}
int
...
void F_113 ( struct V_1 * V_10 , int V_95 )
{
struct V_154 V_155 ;
V_155 . V_10 = V_10 ;
if ( V_95 ) {
...
{
int V_162 ;
if ( ! F_115 ( L_12 , 0 , NULL , & V_290 ) )
return - V_139 ;
V_162 = F_116 ( V_274 , L_12 , & V_291 ) ;
if ( V_162 ) {
F_58 ( L_13 , V_274 ) ;
goto V_292;
}
V_272 = F_117 ( V_293 , L_14 ) ;
if ( F_100 ( V_272 ) ) {
V_162 = F_101 ( V_272 ) ;
F_118 ( L_15 , V_162 ) ;
V_272 = NULL ;
...
V_168 = F_125 ( V_117 , struct V_296 , V_297 ) ;
V_116 = & V_168 -> V_179 ;
F_126 ( & V_13 , V_116 ) ;
V_13 . V_153 = V_298 ;
