...
{
struct V_2 * V_3 = & V_7 -> V_4 ;
return V_6 -> V_34 == & V_3 -> V_8 ;
}
void F_40 ( struct V_35 * V_30 , T_1 V_36 , T_1 V_26 )
{
F_41 ( & V_30 -> V_37 ) ;
V_30 -> V_27 = V_36 ;
V_30 -> V_24 = V_26 ;
...
while ( * V_56 ) {
V_57 = * V_56 ;
V_58 = F_63 ( V_57 , struct V_1 ,
V_60 ) ;
if ( F_64 ( & V_7 -> V_4 , & V_58 -> V_4 ) )
V_56 = & V_57 -> V_61 ;
else {
V_56 = & V_57 -> V_62 ;
V_59 = 0 ;
...
F_65 ( & V_7 -> V_60 , V_57 , V_56 ) ;
F_66 ( & V_7 -> V_60 , & V_6 -> V_49 ) ;
}
...
if ( F_7 ( & V_7 -> V_60 ) )
return;
if ( V_6 -> V_63 == & V_7 -> V_60 ) {
struct V_8 * V_64 ;
V_64 = F_68 ( & V_7 -> V_60 ) ;
V_6 -> V_63 = V_64 ;
if ( V_64 ) {
V_6 -> V_44 . V_46 = F_63 ( V_64 ,
struct V_1 , V_60 ) -> V_4 . V_25 ;
}
}
F_69 ( & V_7 -> V_60 , & V_6 -> V_49 ) ;
F_70 ( & V_7 -> V_60 ) ;
}
static inline int F_71 ( struct V_5 * V_5 )
{
return ! F_72 ( & V_5 -> V_4 . V_49 ) ;
}
...
struct V_8 * V_59 = V_6 -> V_34 ;
struct V_2 * V_58 ;
V_58 = F_63 ( V_59 , struct V_2 , V_8 ) ;
V_6 -> V_44 . V_45 = V_58 -> V_25 ;
F_134 ( & V_5 -> V_11 -> V_120 , V_5 -> V_52 , V_58 -> V_25 ) ;
}
}
...
while ( * V_56 ) {
V_57 = * V_56 ;
V_58 = F_63 ( V_57 , struct V_2 , V_8 ) ;
if ( F_87 ( V_3 -> V_25 , V_58 -> V_25 ) )
V_56 = & V_57 -> V_61 ;
else {
V_56 = & V_57 -> V_62 ;
V_59 = 0 ;
...
if ( V_59 )
V_6 -> V_34 = & V_3 -> V_8 ;
F_65 ( & V_3 -> V_8 , V_57 , V_56 ) ;
F_66 ( & V_3 -> V_8 , & V_6 -> V_42 ) ;
F_137 ( V_3 , V_6 ) ;
}
...
{
if ( V_5 -> V_45 -> V_55 == 1 ||
F_158 ( & V_5 -> V_11 -> V_120 , V_5 -> V_45 , NULL ) == - 1 )
return;
if ( V_7 -> V_55 != 1 &&
F_158 ( & V_5 -> V_11 -> V_120 , V_7 , NULL ) != - 1 )
return;
F_110 ( V_5 ) ;
}
...
struct V_6 * V_6 )
{
struct V_8 * V_80 = V_6 -> V_34 ;
if ( ! V_80 )
return NULL ;
return F_63 ( V_80 , struct V_2 , V_8 ) ;
}
struct V_1 *
F_163 ( struct V_5 * V_5 , struct V_1 * V_65 , struct V_92 * V_93 )
{
struct V_2 * V_3 ;
struct V_1 * V_7 ;
struct V_6 * V_6 ;
...
static void F_167 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_139 )
{
F_120 ( V_5 ) ;
if ( F_165 ( V_5 ) && V_139 && V_7 -> V_4 . V_26 > 0 &&
F_39 ( V_7 , & V_5 -> V_4 ) )
F_160 ( V_5 , V_7 ) ;
}
static void F_168 ( struct V_1 * V_7 )
{
}
...
static int F_170 ( struct V_5 * V_5 , struct V_1 * V_7 , int V_52 )
{
if ( ! F_171 ( V_5 , V_7 ) &&
F_172 ( V_52 , & V_7 -> V_72 ) )
return 1 ;
...
static struct V_1 * F_173 ( struct V_5 * V_5 , int V_52 )
{
struct V_8 * V_64 = V_5 -> V_4 . V_63 ;
struct V_1 * V_7 = NULL ;
if ( ! F_71 ( V_5 ) )
return NULL ;
V_64:
if ( V_64 ) {
V_7 = F_63 ( V_64 , struct V_1 , V_60 ) ;
if ( F_170 ( V_5 , V_7 , V_52 ) )
return V_7 ;
V_64 = F_68 ( V_64 ) ;
goto V_64;
}
...
{
struct V_141 * V_142 ;
struct V_143 * V_144 = F_174 ( V_145 ) ;
int V_146 = F_175 () ;
int V_147 , V_52 = F_30 ( V_140 ) ;
if ( F_94 ( ! V_144 ) )
return - 1 ;
if ( V_140 -> V_55 == 1 )
return - 1 ;
V_147 = F_158 ( & F_5 ( V_140 ) -> V_11 -> V_120 ,
V_140 , V_144 ) ;
if ( V_147 == - 1 )
return - 1 ;
if ( F_172 ( V_52 , V_144 ) )
return V_52 ;
if ( ! F_172 ( V_146 , V_144 ) )
V_146 = - 1 ;
F_152 () ;
F_176 (cpu, sd) {
if ( V_142 -> V_32 & V_148 ) {
if ( V_146 != - 1 &&
F_172 ( V_146 , F_177 ( V_142 ) ) ) {
F_155 () ;
return V_146 ;
}
if ( V_147 < V_73 &&
F_172 ( V_147 , F_177 ( V_142 ) ) ) {
F_155 () ;
return V_147 ;
}
}
...
static struct V_1 * F_178 ( struct V_5 * V_5 )
{
struct V_1 * V_7 ;
if ( ! F_71 ( V_5 ) )
return NULL ;
V_7 = F_63 ( V_5 -> V_4 . V_63 ,
struct V_1 , V_60 ) ;
...
static void F_184 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
if ( ! F_171 ( V_5 , V_7 ) &&
! F_159 ( V_5 -> V_45 ) &&
V_7 -> V_55 > 1 &&
...
static void F_185 ( struct V_1 * V_7 ,
...
static void F_189 ( struct V_5 * V_5 )
{
if ( V_5 -> V_4 . V_48 )
F_51 ( V_5 ) ;
F_190 ( & V_5 -> V_11 -> V_120 , V_5 -> V_52 ) ;
if ( V_5 -> V_4 . V_54 > 0 )
...
unsigned int V_10 ;
F_194 (i)
F_195 ( & F_76 ( V_145 , V_10 ) ,
V_164 , F_196 ( V_10 ) ) ;
}
static void F_197 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
...
static void F_198 ( struct V_5 * V_5 , struct V_1 * V_7 )
{
if ( F_22 ( & V_7 -> V_4 . V_20 ) == 1 )
F_23 ( V_7 ) ;
if ( ! F_21 ( V_7 ) ) {
...
F_201 () ;
V_30 = F_8 ( V_52 ) ;
F_202 ( & V_30 -> V_16 , V_32 ) ;
if ( V_18 < V_30 -> V_41 )
V_152 = - V_166 ;
F_203 ( & V_30 -> V_16 , V_32 ) ;
F_204 () ;
if ( V_152 )
break;
}
...
int F_206 ( struct V_1 * V_7 , int V_167 ,
const struct V_168 * V_169 )
{
struct V_9 * V_30 = F_8 ( F_30 ( V_7 ) ) ;
T_1 V_36 = V_169 -> V_170 ? : V_169 -> V_171 ;
T_1 V_26 = V_169 -> V_172 ;
T_1 V_18 = F_207 ( V_167 ) ? F_44 ( V_36 , V_26 ) : 0 ;
int V_13 , V_173 = - 1 ;
if ( V_18 == V_7 -> V_4 . V_9 && F_208 ( V_7 ) )
return 0 ;
F_31 ( & V_30 -> V_16 ) ;
V_13 = F_12 ( F_30 ( V_7 ) ) ;
if ( F_207 ( V_167 ) && ! F_208 ( V_7 ) &&
! F_209 ( V_30 , V_13 , 0 , V_18 ) ) {
if ( F_26 ( & V_7 -> V_4 . V_20 ) )
F_32 ( V_30 , V_7 -> V_4 . V_9 , V_13 ) ;
F_210 ( V_30 , V_18 , V_13 ) ;
V_173 = 0 ;
} else if ( F_207 ( V_167 ) && F_208 ( V_7 ) &&
! F_209 ( V_30 , V_13 , V_7 -> V_4 . V_9 , V_18 ) ) {
F_32 ( V_30 , V_7 -> V_4 . V_9 , V_13 ) ;
F_210 ( V_30 , V_18 , V_13 ) ;
F_20 ( V_7 , V_18 ) ;
V_173 = 0 ;
...
void F_211 ( struct V_1 * V_7 , const struct V_168 * V_169 )
{
struct V_2 * V_3 = & V_7 -> V_4 ;
...
void F_212 ( struct V_1 * V_7 , struct V_168 * V_169 )
{
struct V_2 * V_3 = & V_7 -> V_4 ;
...
bool F_213 ( const struct V_168 * V_169 )
{
if ( V_169 -> V_171 == 0 )
return false ;
...
bool F_214 ( struct V_1 * V_7 , const struct V_168 * V_169 )
{
struct V_2 * V_3 = & V_7 -> V_4 ;
...
int F_215 ( struct V_1 * V_7 , const struct V_143 * V_177 )
{
...
F_202 ( & V_30 -> V_16 , V_32 ) ;
V_13 = F_12 ( V_178 ) ;
V_179 = F_209 ( V_30 , V_13 , 0 , V_7 -> V_4 . V_9 ) ;
if ( V_179 )
V_152 = - V_166 ;
else {
F_210 ( V_30 , V_7 -> V_4 . V_9 , V_13 ) ;
V_152 = 0 ;
}
F_203 ( & V_30 -> V_16 , V_32 ) ;
F_204 () ;
...
int F_216 ( const struct V_143 * V_180 ,
...
V_182 = F_217 ( V_181 ) ;
F_202 ( & V_183 -> V_16 , V_32 ) ;
if ( V_183 -> V_40 != - 1 &&
V_183 -> V_40 * V_182 < V_183 -> V_41 )
V_152 = 0 ;
F_203 ( & V_183 -> V_16 , V_32 ) ;
F_204 () ;
return V_152 ;
}
bool F_218 ( unsigned int V_52 )
{
unsigned long V_32 ;
struct V_9 * V_30 ;
bool V_179 ;
...
F_202 ( & V_30 -> V_16 , V_32 ) ;
V_13 = F_12 ( V_52 ) ;
V_179 = F_209 ( V_30 , V_13 , 0 , 0 ) ;
F_203 ( & V_30 -> V_16 , V_32 ) ;
F_204 () ;
return V_179 ;
}
void F_219 ( struct V_184 * V_185 , int V_52 )
{
F_220 ( V_185 , V_52 , & F_11 ( V_52 ) -> V_4 ) ;
}
