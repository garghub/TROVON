...
T_1 * V_17 = V_4 -> V_18 ;
if ( V_4 -> V_19 ) {
T_1 * V_20 = V_17 + ( V_9 - V_4 -> V_19 ) ;
V_16 = F_7 ( V_15 , V_4 -> V_19 ) ;
V_4 -> V_19 -= V_16 ;
V_15 -= V_16 ;
memcpy ( V_20 , V_14 , V_16 ) ;
V_14 += V_16 ;
if ( ! V_4 -> V_19 ) {
F_8 ( V_21 , V_4 , V_17 ,
V_9 ) ;
...
if ( V_4 -> V_19 ) {
T_1 * V_20 = V_17 + ( V_9 - V_4 -> V_19 ) ;
memset ( V_20 , 0 , V_4 -> V_19 ) ;
F_8 ( V_21 , V_4 , V_17 , V_9 ) ;
V_4 -> V_19 = 0 ;
}
return 0 ;
}
