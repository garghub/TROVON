...
static int F_20 ( struct V_5 * V_6 , struct V_27 * V_47 )
{
T_1 V_48 ;
do {
V_48 = F_2 ( V_6 , V_17 ) ;
...
static int F_24 ( struct V_5 * V_6 , struct V_50 * V_28 )
{
struct V_8 * V_9 = F_3 ( V_6 ) ;
struct V_1 * V_10 = F_4 ( V_9 ) ;
F_9 ( V_6 , & V_28 -> time ) ;
...
V_10 = F_26 ( & V_9 -> V_6 , sizeof( * V_10 ) , V_60 ) ;
if ( ! V_10 )
return - V_61 ;
V_59 = F_27 ( V_62 , & V_9 -> V_6 ) ;
if ( V_59 )
V_10 -> V_3 = (enum V_63 ) V_59 -> V_2 ;
else
V_10 -> V_3 = V_9 -> V_64 -> V_65 ;
V_54 = F_28 ( V_9 , V_66 , 0 ) ;
V_10 -> V_11 = F_29 ( & V_9 -> V_6 , V_54 ) ;
if ( F_30 ( V_10 -> V_11 ) )
return F_31 ( V_10 -> V_11 ) ;
V_10 -> V_67 = F_32 ( & V_9 -> V_6 , L_1 ) ;
if ( F_30 ( V_10 -> V_67 ) ) {
F_33 ( & V_9 -> V_6 , L_2 ) ;
return F_31 ( V_10 -> V_67 ) ;
}
V_57 = F_34 ( V_10 -> V_67 ) ;
if ( V_57 )
return V_57 ;
V_10 -> V_68 = F_32 ( & V_9 -> V_6 , L_3 ) ;
if ( F_30 ( V_10 -> V_68 ) ) {
F_33 ( & V_9 -> V_6 , L_4 ) ;
V_57 = F_31 ( V_10 -> V_68 ) ;
goto V_69;
...
if ( V_10 -> V_36 >= 0 )
F_40 ( & V_9 -> V_6 , 1 ) ;
V_33 = F_41 ( & V_9 -> V_6 , V_9 -> V_79 , & V_80 ,
V_81 ) ;
if ( F_30 ( V_33 ) ) {
V_57 = F_31 ( V_33 ) ;
goto V_74;
