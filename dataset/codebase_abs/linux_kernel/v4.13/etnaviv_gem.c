...
static void F_68 ( struct V_40 * V_35 , struct V_89 * V_90 )
{
struct V_1 * V_2 = F_29 ( V_35 ) ;
struct V_95 * V_96 = V_2 -> V_82 ;
struct V_97 * V_98 ;
struct V_87 * V_88 ;
unsigned long V_99 = F_69 ( & V_35 -> V_54 ) ;
F_67 ( V_90 , L_7 ,
V_2 -> V_8 , F_70 ( V_2 ) ? 'A' : 'I' ,
V_35 -> V_100 , F_71 ( & V_35 -> V_101 ) ,
...
V_88 = F_73 ( V_98 -> V_104 [ V_102 ] ) ;
F_65 ( V_88 , L_8 , V_90 ) ;
}
}
V_88 = F_73 ( V_96 -> V_105 ) ;
if ( V_88 )
F_65 ( V_88 , L_9 , V_90 ) ;
F_74 () ;
}
void F_75 ( struct V_106 * V_107 ,
struct V_89 * V_90 )
{
struct V_1 * V_2 ;
int V_108 = 0 ;
...
void F_79 ( struct V_40 * V_35 )
{
struct V_1 * V_2 = F_29 ( V_35 ) ;
struct V_55 * V_58 , * V_110 ;
F_44 ( F_70 ( V_2 ) ) ;
F_50 ( & V_2 -> V_111 ) ;
F_80 (mapping, tmp, &etnaviv_obj->vram_list,
obj_node) {
...
int F_85 ( struct V_3 * V_4 , struct V_40 * V_35 )
{
...
static int F_86 ( struct V_3 * V_4 , T_4 V_21 , T_4 V_8 ,
...
static struct V_40 * F_89 ( struct V_3 * V_4 ,
T_4 V_21 , T_4 V_8 )
{
struct V_40 * V_35 = NULL ;
int V_16 ;
V_21 = F_90 ( V_21 ) ;
V_16 = F_86 ( V_4 , V_21 , V_8 , NULL ,
& V_120 , & V_35 ) ;
if ( V_16 )
goto V_121;
V_16 = F_91 ( V_4 , V_35 , V_21 ) ;
if ( V_16 == 0 ) {
struct V_122 * V_58 ;
...
int F_93 ( struct V_3 * V_4 , struct V_125 * V_34 ,
T_4 V_21 , T_4 V_8 , T_4 * V_126 )
{
struct V_40 * V_35 ;
int V_16 ;
V_35 = F_89 ( V_4 , V_21 , V_8 ) ;
if ( F_7 ( V_35 ) )
return F_9 ( V_35 ) ;
V_16 = F_85 ( V_4 , V_35 ) ;
if ( V_16 < 0 ) {
...
V_16 = F_94 ( V_34 , V_35 , V_126 ) ;
F_46 ( V_35 ) ;
return V_16 ;
}
struct V_40 * F_95 ( struct V_3 * V_4 ,
T_4 V_21 , T_4 V_8 )
{
struct V_40 * V_35 ;
int V_16 ;
...
struct V_40 * V_35 ;
int V_16 ;
V_16 = F_86 ( V_4 , V_21 , V_8 , V_96 , V_18 , & V_35 ) ;
if ( V_16 )
return V_16 ;
F_97 ( V_4 , V_35 , V_21 ) ;
* V_127 = F_29 ( V_35 ) ;
...
T_6 V_134 ;
unsigned int V_8 = 0 ;
V_133 = F_99 ( V_20 , sizeof( struct V_13 * ) , V_63 ) ;
if ( ! V_133 )
return F_16 ( - V_50 ) ;
if ( ! V_2 -> V_135 . V_136 )
V_8 |= V_137 ;
...
F_100 ( & V_129 -> V_138 ) ;
while ( V_132 < V_20 ) {
V_16 = F_101 ( V_131 , V_129 , V_134 , V_20 - V_132 ,
V_8 , V_133 + V_132 , NULL , NULL ) ;
if ( V_16 < 0 )
break;
V_134 += V_16 * V_139 ;
V_132 += V_16 ;
...
{
struct V_142 * V_143 = F_106 ( V_141 , F_107 ( * V_143 ) , V_143 ) ;
struct V_1 * V_2 = V_143 -> V_2 ;
struct V_13 * * V_133 ;
V_133 = F_98 ( V_2 , V_143 -> V_129 , V_143 -> V_131 ) ;
F_43 ( & V_2 -> V_17 ) ;
if ( F_7 ( V_133 ) ) {
...
V_132 = F_112 ( V_2 -> V_135 . V_134 , V_20 ,
...
F_115 ( & V_143 -> V_143 , F_105 ) ;
F_116 ( V_2 -> V_5 . V_4 , & V_143 -> V_143 ) ;
return - V_45 ;
}
...
int F_119 ( struct V_3 * V_4 , struct V_125 * V_34 ,
T_6 V_134 , T_4 V_21 , T_4 V_8 , T_4 * V_126 )
{
struct V_1 * V_2 ;
int V_16 ;
V_16 = F_96 ( V_4 , V_21 , V_85 , NULL ,
& V_145 , & V_2 ) ;
if ( V_16 )
return V_16 ;
...
F_114 ( V_144 ) ;
V_16 = F_85 ( V_4 , & V_2 -> V_5 ) ;
if ( V_16 )
goto V_147;
V_16 = F_94 ( V_34 , & V_2 -> V_5 , V_126 ) ;
V_147:
F_46 ( & V_2 -> V_5 ) ;
return V_16 ;
}
