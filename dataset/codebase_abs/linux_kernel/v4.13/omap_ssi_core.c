...
if ( ! V_8 )
return - V_30 ;
V_102 = F_76 ( & V_104 , 0 , 0 , V_103 ) ;
if ( V_102 < 0 )
goto V_105;
V_5 -> V_106 = V_102 ;
V_5 -> V_107 = V_108 ;
V_5 -> V_10 . V_11 = & V_93 -> V_67 ;
F_77 ( & V_5 -> V_10 , L_29 , V_5 -> V_106 ) ;
F_78 ( V_5 , V_8 ) ;
V_8 -> V_67 = & V_5 -> V_10 ;
V_102 = F_68 ( V_93 , L_30 , & V_8 -> V_9 , NULL ) ;
if ( V_102 < 0 )
goto V_105;
V_102 = F_68 ( V_93 , L_23 , & V_8 -> V_15 , NULL ) ;
if ( V_102 < 0 )
goto V_105;
V_102 = F_79 ( V_93 , L_31 ) ;
if ( V_102 < 0 ) {
F_80 ( & V_93 -> V_67 , L_32 ) ;
goto V_105;
}
...
V_8 -> V_39 = F_83 ( & V_5 -> V_10 , V_5 -> V_84 ,
sizeof( * V_8 -> V_39 ) , V_103 ) ;
if ( ! V_8 -> V_39 ) {
V_102 = - V_30 ;
goto V_105;
}
V_8 -> V_74 = F_84 ( & V_5 -> V_10 , L_34 ) ;
if ( F_72 ( V_8 -> V_74 ) ) {
F_80 ( & V_93 -> V_67 , L_35 ,
F_73 ( V_8 -> V_74 ) ) ;
V_102 = - V_109 ;
...
F_92 ( & V_8 -> V_69 ) ;
F_93 ( V_5 ) ;
F_94 ( V_8 -> V_74 , & V_8 -> V_79 ) ;
F_88 ( & V_104 , V_106 ) ;
}
static inline int F_95 ( const struct V_120 * V_121 )
{
struct V_120 * V_122 ;
int V_43 = 0 ;
F_96 (np, child)
...
static int F_98 ( struct V_10 * V_67 , void * V_123 )
{
struct V_92 * V_54 = F_99 ( V_67 ) ;
if ( ! V_67 -> V_124 )
return 0 ;
F_100 ( V_67 -> V_124 , V_125 ) ;
F_101 ( V_54 ) ;
return 0 ;
}
...
if ( ! F_97 ( V_122 , L_38 ) )
continue;
V_126 = F_107 ( V_122 , NULL , & V_93 -> V_67 ) ;
if ( ! V_126 ) {
V_102 = - V_109 ;
F_80 ( & V_93 -> V_67 , L_41 ) ;
goto V_130;
...
F_108 ( & V_93 -> V_67 , L_42 ,
V_5 -> V_106 , V_84 ) ;
return V_102 ;
V_130:
F_109 ( & V_93 -> V_67 , NULL , F_98 ) ;
V_129:
F_91 ( V_5 ) ;
V_128:
F_104 ( V_93 , NULL ) ;
...
static int F_111 ( struct V_92 * V_93 )
{
struct V_4 * V_5 = F_69 ( V_93 ) ;
F_109 ( & V_93 -> V_67 , NULL , F_98 ) ;
#ifdef F_106
...
static int F_112 ( struct V_10 * V_67 )
{
struct V_4 * V_5 = F_113 ( V_67 ) ;
struct V_7 * V_8 = F_2 ( V_5 ) ;
F_43 ( V_67 , L_43 ) ;
if ( V_8 -> V_113 )
V_8 -> V_131 =
...
static int F_114 ( struct V_10 * V_67 )
{
struct V_4 * V_5 = F_113 ( V_67 ) ;
struct V_7 * V_8 = F_2 ( V_5 ) ;
F_43 ( V_67 , L_44 ) ;
