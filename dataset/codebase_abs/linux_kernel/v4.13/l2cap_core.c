...
static void F_219 ( void * * V_434 , T_1 type , T_1 V_193 , unsigned long V_436 )
{
struct V_437 * V_438 = * V_434 ;
...
static void F_220 ( void * * V_434 , struct V_11 * V_23 )
{
struct V_440 V_441 ;
switch ( V_23 -> V_147 ) {
case V_150 :
...
V_27:
if ( V_23 -> V_117 != V_38 )
F_219 ( & V_434 , V_462 , 2 , V_23 -> V_117 ) ;
switch ( V_23 -> V_147 ) {
case V_148 :
if ( V_318 )
break;
...
V_455 . V_51 = 0 ;
V_455 . V_465 = 0 ;
F_219 ( & V_434 , V_466 , sizeof( V_455 ) ,
( unsigned long ) & V_455 ) ;
break;
case V_150 :
V_455 . V_147 = V_150 ;
...
static int F_230 ( struct V_11 * V_23 , void * V_194 )
{
...
V_61 = F_66 ( T_2 , F_231 ( V_455 . V_465 ) ,
...
V_504 . V_17 = F_249 ( V_17 ) ;
V_504 . V_16 = F_249 ( V_16 ) ;
...
V_23 = F_240 ( V_13 , V_430 , V_194 , V_500 ,
V_279 -> V_281 ) ;
if ( V_23 ) {
struct V_142 * V_143 = V_13 -> V_8 -> V_142 ;
struct V_7 * V_206 ;
V_206 = F_260 ( V_195 , V_541 ,
& V_13 -> V_8 -> V_156 ) ;
if ( ! V_206 ) {
F_259 ( V_195 ) ;
F_248 ( V_13 , V_430 -> V_19 , V_23 -> V_17 ,
...
static void F_261 ( struct V_11 * V_23 , T_1 V_544 )
{
struct V_545 V_279 ;
T_1 V_19 ;
...
static void F_264 ( struct V_12 * V_13 , T_2 V_546 )
{
struct V_551 V_552 ;
...
static void F_278 ( struct V_12 * V_13 , T_2 V_546 , T_2 V_159 )
{
struct V_11 * V_23 ;
struct V_146 * V_202 = NULL ;
V_23 = F_7 ( V_13 , V_546 ) ;
...
static void F_279 ( struct V_12 * V_13 , T_1 V_19 , T_2 V_546 ,
T_2 V_159 )
{
struct V_11 * V_23 ;
V_23 = F_13 ( V_13 , V_19 ) ;
...
if ( V_502 != sizeof( * V_158 ) )
return - V_505 ;
V_546 = F_231 ( V_158 -> V_546 ) ;
V_159 = F_231 ( V_158 -> V_159 ) ;
F_23 ( L_64 , V_546 , V_159 ) ;
if ( V_159 == V_565 || V_159 == V_576 )
F_278 ( V_13 , V_546 , V_159 ) ;
else
F_279 ( V_13 , V_430 -> V_19 , V_546 , V_159 ) ;
return 0 ;
}
...
return - V_505 ;
V_546 = F_231 ( V_552 -> V_546 ) ;
V_159 = F_231 ( V_552 -> V_159 ) ;
F_23 ( L_64 , V_546 , V_159 ) ;
V_23 = F_11 ( V_13 , V_546 ) ;
if ( ! V_23 ) {
F_265 ( V_13 , V_430 -> V_19 , V_546 ) ;
return 0 ;
}
if ( V_23 -> V_203 == V_564 ) {
if ( V_159 == V_563 ) {
...
if ( ! V_24 ) {
T_1 V_583 ;
V_583 = F_284 ( V_8 , V_345 , V_346 , V_347 ,
V_349 ) ;
...
switch ( V_430 -> V_192 ) {
case V_522 :
F_238 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_280 :
V_24 = F_242 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_171 :
case V_500 :
F_245 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_334 :
V_24 = F_250 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_519 :
F_251 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_323 :
V_24 = F_253 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_530 :
F_254 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_586 :
...
break;
case V_313 :
V_24 = F_255 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_534 :
F_256 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_283 :
V_24 = F_257 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_547 :
V_24 = F_277 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_550 :
F_280 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_553 :
V_24 = F_281 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_556 :
F_282 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
default:
...
break;
case V_166 :
F_286 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_305 :
V_24 = F_289 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_596 :
V_24 = F_291 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
case V_323 :
V_24 = F_253 ( V_13 , V_430 , V_502 , V_194 ) ;
break;
...
V_24 = F_287 ( V_13 , & V_430 , V_502 , V_194 ) ;
if ( V_24 ) {
struct V_503 V_504 ;
F_288 ( L_74 , V_24 ) ;
V_504 . V_74 = F_18 ( V_506 ) ;
...
static void F_299 ( struct V_52 * V_56 , struct V_52 * V_602 ,
struct V_52 * * V_603 )
{
if ( ! F_300 ( V_56 ) )
...
void F_304 ( struct V_11 * V_23 , int V_605 )
{
T_1 V_417 ;
if ( V_23 -> V_147 != V_150 )
return;
...
if ( V_8 -> type == V_2 &&
F_326 ( & V_8 -> V_195 -> V_631 , & V_8 -> V_156 ,
F_3 ( V_8 ) ) ) {
F_97 ( V_56 ) ;
return;
}
...
if ( V_8 -> type == V_123 &&
F_243 ( V_8 -> V_195 , V_635 ) )
V_13 -> V_269 |= V_270 ;
if ( F_243 ( V_8 -> V_195 , V_636 ) &&
( F_332 ( V_8 -> V_195 ) ||
...
int F_342 ( struct V_267 * V_195 , T_4 * V_630 )
{
...
return;
V_10 = F_3 ( V_8 ) ;
if ( F_326 ( & V_195 -> V_631 , & V_8 -> V_156 , V_10 ) )
return;
V_507 = F_343 ( NULL , V_8 ) ;
while ( V_507 ) {
...
static inline void F_352 ( struct V_11 * V_23 , T_1 V_653 )
{
if ( V_23 -> V_39 != V_122 )
return;
if ( V_653 == 0x00 ) {
...
static void F_353 ( struct V_7 * V_8 , T_1 V_169 , T_1 V_653 )
{
struct V_12 * V_13 = V_8 -> V_362 ;
struct V_11 * V_23 ;
if ( ! V_13 )
...
static int F_356 ( struct V_663 * V_664 , void * V_28 )
{
struct V_11 * V_15 ;
F_122 ( & V_25 ) ;
F_5 (c, &chan_list, global_l) {
...
static int F_358 ( struct V_665 * V_665 , struct V_666 * V_666 )
{
return F_359 ( V_666 , F_356 , V_665 -> V_667 ) ;
}
int T_11 F_360 ( void )
{
int V_24 ;
...
if ( F_363 ( V_669 ) )
return 0 ;
V_670 = F_364 ( L_134 , 0444 , V_669 ,
NULL , & V_671 ) ;
F_365 ( L_135 , 0644 , V_669 ,
& V_115 ) ;
F_365 ( L_136 , 0644 , V_669 ,
& V_118 ) ;
return 0 ;
}
void F_366 ( void )
