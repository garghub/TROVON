...
static void T_3 F_60 ( struct V_65 * V_66 , int V_25 )
{
struct V_79 * V_12 ;
struct V_88 * V_89 ;
struct V_15 * * V_90 ;
...
V_12 = & V_1 . V_12 [ V_25 ] ;
V_91 = F_61 ( V_66 , L_16 ) ;
F_62 ( F_31 ( V_12 -> div ) < 4 ) ;
V_90 = F_63 ( 4 , sizeof( struct V_15 * ) , V_55 ) ;
if ( ! V_90 )
return;
V_89 = F_64 ( sizeof( * V_89 ) , V_55 ) ;
if ( ! V_89 )
goto V_92;
if ( V_91 <= 3 ) {
...
static void T_3 F_65 ( struct V_65 * V_66 )
{
F_60 ( V_66 , V_16 ) ;
}
...
static struct V_15 * F_67 ( struct V_97 * V_98 , void * V_99 )
{
struct V_1 * V_2 = V_99 ;
struct V_15 * V_15 ;
struct V_79 * V_12 ;
...
return V_15 ;
V_101:
F_18 ( L_18 , V_36 , type , V_25 ) ;
return F_41 ( - V_30 ) ;
}
static bool T_3 F_68 ( void )
{
T_1 V_103 = F_69 ( V_104 ) ;
int V_50 ;
V_103 &= ~ V_105 ;
...
return;
V_1 . V_67 = V_66 ;
V_1 . V_57 = F_70 ( V_66 , 0 ) ;
if ( ! V_1 . V_57 &&
F_71 ( V_108 , L_19 ) ) {
V_1 . V_57 = F_72 ( 0x1ee1000 , 0x1000 ) ;
V_107 = true ;
}
if ( ! V_1 . V_57 ) {
F_18 ( L_20 , V_36 , V_66 -> V_49 ) ;
return;
}
for ( V_50 = 0 ; V_50 < F_31 ( V_109 ) ; V_50 ++ ) {
if ( F_71 ( V_66 , V_109 [ V_50 ] . V_110 ) )
break;
if ( V_107 &&
! strcmp ( V_109 [ V_50 ] . V_110 , L_21 ) )
break;
}
if ( V_50 == F_31 ( V_109 ) ) {
F_18 ( L_22 , V_36 ,
