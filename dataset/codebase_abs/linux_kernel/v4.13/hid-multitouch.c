...
static int F_52 ( struct V_11 * V_12 , struct V_57 * V_58 ,
struct V_30 * V_31 , struct V_32 * V_33 ,
unsigned long * * V_65 , int * V_66 )
{
if ( V_31 -> V_185 == V_186 )
...
static int F_53 ( struct V_11 * V_34 , struct V_30 * V_31 ,
struct V_32 * V_33 , T_4 V_43 )
{
struct V_1 * V_2 = F_4 ( V_34 ) ;
...
static void F_54 ( struct V_11 * V_34 , struct V_20 * V_21 )
{
struct V_1 * V_2 = F_4 ( V_34 ) ;
...
if ( V_2 -> V_38 < 0 )
return;
V_188 = & ( V_12 -> V_190 [ V_28 ] ) ;
V_167 = V_188 -> V_191 [ V_2 -> V_38 ] ;
if ( V_167 ) {
if ( V_68 -> V_14 & V_192 ) {
V_189 = F_8 ( V_167 ) ;
V_10 = F_9 ( V_167 , V_26 ) ;
...
F_10 ( V_12 , V_167 -> V_27 , V_10 , V_189 ,
V_28 ,
V_29 ) ;
F_13 ( V_10 ) ;
}
V_167 -> V_31 [ 0 ] -> V_43 [ V_2 -> V_39 ] = V_2 -> V_78 ;
F_57 ( V_12 , V_167 , V_193 ) ;
}
}
...
return;
V_188 = & V_12 -> V_190 [ V_28 ] ;
V_167 = V_188 -> V_191 [ V_2 -> V_41 ] ;
if ( V_167 ) {
V_66 = V_2 -> V_13 . V_42 ;
V_194 = V_167 -> V_31 [ 0 ] -> V_44 ;
V_66 = F_31 ( V_194 , V_66 ) ;
...
struct V_67 * V_68 = & V_2 -> V_13 ;
if ( V_2 -> V_103 > 0 ) {
int V_195 = V_60 -> V_62 / V_2 -> V_103 ;
V_2 -> V_166 = V_60 -> V_64 [ V_195 - 1 ] ;
}
if ( V_2 -> V_18 < 0 )
V_68 -> V_14 &= ~ V_19 ;
}
static int F_59 ( struct V_11 * V_12 , struct V_57 * V_58 )
{
struct V_1 * V_2 = F_4 ( V_12 ) ;
char * V_95 ;
...
if ( V_58 -> V_21 -> V_31 [ 0 ] -> V_185 == V_186 ) {
V_196 = L_8 ;
F_49 ( V_197 , V_58 -> V_50 -> V_198 ) ;
} else {
switch ( V_31 -> V_70 ) {
case V_183 :
V_196 = L_9 ;
...
if ( V_196 ) {
V_95 = F_60 ( & V_58 -> V_50 -> V_7 ,
strlen ( V_12 -> V_95 ) + strlen ( V_196 ) + 2 ,
V_26 ) ;
if ( V_95 ) {
sprintf ( V_95 , L_16 , V_12 -> V_95 , V_196 ) ;
V_58 -> V_50 -> V_95 = V_95 ;
}
}
return 0 ;
}
static void F_61 ( struct V_30 * V_31 , unsigned int V_33 )
{
...
static void F_62 ( struct V_11 * V_12 , unsigned int V_33 )
{
struct V_20 * V_21 ;
int V_203 ;
F_63 (report,
...
if ( ! V_21 -> V_118 )
continue;
for ( V_203 = 0 ; V_203 < V_21 -> V_118 ; V_203 ++ )
if ( V_21 -> V_31 [ V_203 ] -> V_204 >= 1 )
F_61 ( V_21 -> V_31 [ V_203 ] , V_33 ) ;
}
}
static void F_64 ( struct V_11 * V_34 )
{
struct V_57 * V_161 ;
struct V_1 * V_2 = F_4 ( V_34 ) ;
...
int V_203 ;
if ( V_135 ) {
for ( V_203 = 0 ; V_203 < V_135 -> V_205 ; V_203 ++ ) {
V_137 ( V_49 , V_203 ) ;
F_30 ( V_49 ,
V_143 ,
false ) ;
...
static void F_65 ( unsigned long V_206 )
{
struct V_11 * V_12 = ( void * ) V_206 ;
struct V_1 * V_2 = F_4 ( V_12 ) ;
if ( F_42 ( V_169 , & V_2 -> V_156 ) )
return;
if ( F_37 ( V_157 , & V_2 -> V_156 ) )
...
static int F_66 ( struct V_11 * V_12 , const struct V_207 * V_27 )
{
int V_22 , V_203 ;
struct V_1 * V_2 ;
struct V_67 * V_13 = V_208 ;
for ( V_203 = 0 ; V_208 [ V_203 ] . V_95 ; V_203 ++ ) {
if ( V_27 -> V_209 == V_208 [ V_203 ] . V_95 ) {
V_13 = & ( V_208 [ V_203 ] ) ;
break;
}
}
V_2 = F_60 ( & V_12 -> V_7 , sizeof( struct V_1 ) , V_26 ) ;
if ( ! V_2 ) {
F_15 ( & V_12 -> V_7 , L_17 ) ;
return - V_210 ;
}
...
V_2 -> V_104 = - 1 ;
F_67 ( V_12 , V_2 ) ;
V_2 -> V_61 = F_60 ( & V_12 -> V_7 , sizeof( struct V_59 ) ,
V_26 ) ;
if ( ! V_2 -> V_61 ) {
F_15 ( & V_12 -> V_7 , L_18 ) ;
return - V_210 ;
}
if ( V_27 -> V_212 == V_213 && V_27 -> V_214 == V_213 )
V_2 -> V_176 = true ;
V_2 -> V_24 = V_12 -> V_14 ;
V_12 -> V_14 |= V_215 ;
V_12 -> V_14 |= V_216 ;
V_12 -> V_14 |= V_217 ;
V_12 -> V_14 |= V_25 ;
F_68 ( & V_2 -> V_173 , F_65 , ( long ) V_12 ) ;
V_22 = F_69 ( V_12 ) ;
if ( V_22 != 0 )
return V_22 ;
if ( V_13 -> V_14 & V_218 )
F_62 ( V_12 , V_102 ) ;
V_22 = F_70 ( V_12 , V_219 ) ;
if ( V_22 )
return V_22 ;
V_22 = F_71 ( & V_12 -> V_7 . V_220 , & V_221 ) ;
if ( V_22 )
F_11 ( & V_12 -> V_7 , L_19 ,
V_12 -> V_95 ) ;
F_58 ( V_12 ) ;
F_55 ( V_12 ) ;
F_72 ( & V_12 -> V_7 , V_2 -> V_61 ) ;
V_2 -> V_61 = NULL ;
return 0 ;
}
