...
if ( V_53 >= V_7 -> V_54 -> V_55 )
return F_33 ( - V_18 ) ;
return & V_7 -> V_56 [ V_53 ] . V_5 ;
}
static int F_34 ( const enum V_57 V_58 ,
const unsigned int V_59 )
{
switch ( V_58 ) {
case V_60 :
return ( V_59 == 0 ) ? 0 : 3 ;
...
static int F_35 ( struct V_63 * V_15 ,
const struct V_64 * V_65 )
{
struct V_6 * V_7 ;
struct V_66 V_67 ;
const char * V_68 [ 2 ] ;
unsigned int V_59 , V_53 = 0 ;
int V_69 ;
V_7 = F_36 ( & V_15 -> V_2 , sizeof( * V_7 ) , V_70 ) ;
if ( V_7 == NULL )
return - V_71 ;
F_37 ( V_15 , V_7 ) ;
V_7 -> V_15 = V_15 ;
V_7 -> V_54 = F_38 ( & V_15 -> V_2 ) ;
...
V_7 -> V_87 . V_40 = 0 ;
V_7 -> V_87 . V_7 = V_7 ;
V_7 -> V_87 . V_5 . V_67 = & V_67 ;
V_69 = F_46 ( & V_15 -> V_2 , & V_7 -> V_87 . V_5 ) ;
if ( V_69 ) {
F_43 ( & V_15 -> V_2 , L_8 , V_67 . V_79 ) ;
goto V_83;
}
for ( V_59 = 0 ; V_59 < V_7 -> V_54 -> V_88 ; V_59 ++ ) {
V_53 = F_34 ( V_7 -> V_54 -> V_58 , V_59 ) ;
memset ( & V_67 , 0 , sizeof( V_67 ) ) ;
V_67 . V_79 = V_89 [ V_53 ] ;
V_67 . V_81 = & V_90 ;
V_67 . V_77 = V_86 ;
V_67 . V_68 = V_84 ;
V_67 . V_76 = 1 ;
V_7 -> V_91 [ V_59 ] . V_40 = V_53 ;
V_7 -> V_91 [ V_59 ] . V_7 = V_7 ;
V_7 -> V_91 [ V_59 ] . V_5 . V_67 = & V_67 ;
V_69 = F_46 ( & V_15 -> V_2 , & V_7 -> V_91 [ V_59 ] . V_5 ) ;
if ( V_69 ) {
F_43 ( & V_15 -> V_2 , L_8 ,
V_67 . V_79 ) ;
goto V_83;
...
V_67 . V_68 = V_80 ;
V_67 . V_76 = 1 ;
V_7 -> V_56 [ 0 ] . V_40 = V_53 ;
V_7 -> V_56 [ 0 ] . V_7 = V_7 ;
V_7 -> V_56 [ 0 ] . V_5 . V_67 = & V_67 ;
V_69 = F_46 ( & V_15 -> V_2 , & V_7 -> V_56 [ 0 ] . V_5 ) ;
if ( V_69 ) {
F_43 ( & V_15 -> V_2 , L_8 ,
V_67 . V_79 ) ;
goto V_83;
}
for ( V_59 = 1 ; V_59 < V_7 -> V_54 -> V_55 ; V_59 ++ ) {
V_53 = F_34 ( V_7 -> V_54 -> V_58 , V_59 - 1 ) ;
V_68 [ 0 ] = V_89 [ V_53 ] ;
if ( V_59 == 1 )
V_68 [ 1 ] = V_80 [ 0 ] ;
else
V_68 [ 1 ] = V_92 [ V_59 - 1 ] ;
memset ( & V_67 , 0 , sizeof( V_67 ) ) ;
V_67 . V_79 = V_92 [ V_53 + 1 ] ;
V_67 . V_81 = & V_93 ;
V_67 . V_77 = V_86 ;
V_67 . V_68 = V_68 ;
V_67 . V_76 = 2 ;
V_7 -> V_56 [ V_59 ] . V_40 = V_53 ;
V_7 -> V_56 [ V_59 ] . V_7 = V_7 ;
V_7 -> V_56 [ V_59 ] . V_5 . V_67 = & V_67 ;
V_69 = F_46 ( & V_15 -> V_2 ,
& V_7 -> V_56 [ V_59 ] . V_5 ) ;
if ( V_69 ) {
F_43 ( & V_15 -> V_2 , L_8 ,
...
V_69 = F_47 ( V_15 -> V_2 . V_94 , F_32 , V_7 ) ;
if ( V_69 ) {
F_43 ( & V_15 -> V_2 , L_9 ) ;
goto V_83;
}
return 0 ;
V_83:
if ( V_7 -> V_54 -> V_77 & V_78 )
F_48 ( V_7 -> V_72 ) ;
return V_69 ;
}
static int F_49 ( struct V_63 * V_15 )
{
