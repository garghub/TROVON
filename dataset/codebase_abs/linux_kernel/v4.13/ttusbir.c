...
for ( V_29 = 0 ; V_29 < V_41 -> V_55 && V_50 == - 1 ; V_29 ++ ) {
int V_56 , V_57 = - 1 , V_58 = - 1 ;
V_45 = & V_41 -> V_50 [ V_29 ] . V_47 ;
for ( V_49 = 0 ; V_49 < V_45 -> V_59 ; V_49 ++ ) {
V_47 = & V_41 -> V_50 [ V_29 ] . V_60 [ V_49 ] . V_47 ;
V_56 = F_23 ( V_47 -> V_61 ) ;
if ( F_24 ( V_47 ) &&
F_25 ( V_47 ) &&
V_56 == 0x10 )
...
V_19 -> V_17 = V_5 -> V_12 ;
V_19 -> V_20 = V_5 ;
V_19 -> V_64 = F_32 ( V_5 -> V_12 , V_5 -> V_58 ) ;
V_19 -> V_65 = 1 ;
V_63 = F_33 ( V_5 -> V_12 , 128 , V_51 ,
& V_19 -> V_66 ) ;
if ( ! V_63 ) {
F_34 ( V_19 ) ;
V_10 = - V_53 ;
...
V_19 -> V_73 [ V_49 ] . V_74 = V_49 * 16 ;
V_19 -> V_73 [ V_49 ] . V_75 = 16 ;
}
V_5 -> V_19 [ V_29 ] = V_19 ;
}
...
V_5 -> V_57 ) , V_5 -> V_14 , sizeof( V_5 -> V_14 ) ,
F_10 , V_5 ) ;
V_5 -> V_6 . V_76 = L_5 ;
V_5 -> V_6 . V_77 = L_6 ;
V_5 -> V_6 . V_78 = F_9 ;
...
if ( V_10 )
goto V_54;
F_39 ( V_5 -> V_12 , V_5 -> V_80 , sizeof( V_5 -> V_80 ) ) ;
V_36 -> V_81 = V_82 ;
V_36 -> V_83 = V_5 -> V_80 ;
F_40 ( V_5 -> V_12 , & V_36 -> V_84 ) ;
V_36 -> V_17 . V_85 = & V_41 -> V_17 ;
V_36 -> V_86 = V_87 ;
V_36 -> V_88 = V_5 ;
V_36 -> V_89 = V_90 ;
V_36 -> V_91 = V_92 ;
...
V_54:
if ( V_5 ) {
for ( V_29 = 0 ; V_29 < V_62 && V_5 -> V_19 [ V_29 ] ; V_29 ++ ) {
...
static int F_51 ( struct V_40 * V_41 , T_2 V_101 )
{
struct V_4 * V_5 = F_50 ( V_41 ) ;
int V_29 ;
for ( V_29 = 0 ; V_29 < V_62 ; V_29 ++ )
