...
int V_10 , V_31 ;
char V_51 [ 20 ] ;
V_10 = F_20 ( V_43 -> V_52 , & V_49 ) ;
if ( V_10 ) {
F_2 ( & V_43 -> V_6 , L_5 ) ;
return V_10 ;
}
V_50 = V_49 -> V_53 ;
V_3 = F_21 ( sizeof( struct V_2 ) , V_54 ) ;
if ( ! V_3 ) {
V_10 = - V_55 ;
goto error;
}
...
snprintf ( V_51 , sizeof( V_51 ) , L_8 ,
F_30 ( & V_59 ) - 1 ) ;
memset ( & V_30 , 0 , sizeof( struct V_46 ) ) ;
V_30 . type = V_60 ;
V_30 . V_61 = 0xff ;
V_3 -> V_27 = F_31 ( V_51 , NULL , V_3 ,
& V_62 , & V_30 ) ;
if ( F_32 ( V_3 -> V_27 ) ) {
F_2 ( & V_43 -> V_6 , L_9 ) ;
V_10 = F_33 ( V_3 -> V_27 ) ;
