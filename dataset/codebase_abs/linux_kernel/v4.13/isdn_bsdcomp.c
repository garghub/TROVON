...
F_26 ( V_72 ,
( unsigned char ) ( ( V_75 | ( 0xff << ( V_74 - 8 ) ) ) >> 24 ) ) ;
...
static void F_27 ( void * V_19 , struct V_70 * V_71 , int V_73 )
{
F_20 ( V_19 , V_71 , NULL , V_73 ) ;
}
static int F_28 ( void * V_19 , struct V_70 * V_71 , struct V_70 * V_72 ,
struct V_36 * V_37 )
{
struct V_1 * V_2 ;
unsigned int V_4 ;
