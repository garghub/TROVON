...
F_42 ( V_20 , V_28 ) ;
V_29 = ( unsigned long ) ( V_28 + 1 ) ;
if ( F_43 ( V_14 , V_20 , V_7 -> V_24 [ 0 ] , V_28 ) )
return NULL ;
if ( F_41 ( V_20 , V_28 ) == V_12 &&
...
int V_15 = 0 ;
V_20 = V_7 -> V_23 [ 0 ] ;
V_63 = sizeof( * V_22 ) + F_41 ( V_20 , V_22 ) +
F_42 ( V_20 , V_22 ) ;
...
if ( type == V_38 )
V_66 = V_69 ;
if ( F_41 ( V_20 , V_28 ) > V_66 ) {
F_51 ( V_14 , L_2 ,
( unsigned ) F_41 ( V_20 , V_28 ) ) ;
return 1 ;
}
V_66 = F_41 ( V_20 , V_28 ) ;
V_15 = F_52 ( V_20 , V_53 ,
( unsigned long ) ( V_28 + 1 ) , V_66 ) ;
if ( ! V_15 )
return 1 ;
if ( ( F_42 ( V_20 , V_28 ) +
F_41 ( V_20 , V_28 ) ) >
...
bool F_52 ( struct V_19 * V_20 , int V_53 ,
unsigned long V_65 , T_3 V_12 )
{
