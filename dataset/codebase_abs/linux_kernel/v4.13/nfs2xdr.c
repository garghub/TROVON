...
static int F_41 ( struct V_17 * V_18 , struct V_106 * V_22 )
{
int error ;
...
static int F_42 ( struct V_17 * V_18 , struct V_106 * V_22 )
{
enum V_31 V_32 ;
int error ;
error = F_10 ( V_18 , & V_32 ) ;
...
const void * V_38 )
{
const struct V_107 * args = V_38 ;
F_12 ( V_18 , args -> V_36 ) ;
F_27 ( V_18 , args -> V_108 ) ;
}
static void F_45 ( struct V_1 * V_2 ,
struct V_17 * V_18 ,
const void * V_38 )
{
const struct V_109 * args = V_38 ;
...
* V_20 ++ = F_16 ( V_24 ) ;
* V_20 = F_16 ( V_24 ) ;
F_35 ( V_18 , args -> V_4 , args -> V_111 , V_24 ) ;
}
...
const struct V_114 * args = V_38 ;
F_49 ( V_18 , args ) ;
V_18 -> V_99 -> V_117 |= V_119 ;
}
static void F_51 ( struct V_1 * V_2 ,
struct V_17 * V_18 ,
const void * V_38 )
{
const struct V_120 * args = V_38 ;
F_40 ( V_18 , args -> V_36 , args -> V_93 , args -> V_6 ) ;
F_27 ( V_18 , args -> V_108 ) ;
}
...
const void * V_38 )
{
const struct V_122 * args = V_38 ;
const struct V_123 * V_124 = args -> V_125 ;
const struct V_123 * V_126 = args -> V_127 ;
F_40 ( V_18 , args -> V_128 , V_124 -> V_93 , V_124 -> V_6 ) ;
F_40 ( V_18 , args -> V_129 , V_126 -> V_93 , V_126 -> V_6 ) ;
}
static void F_54 ( struct V_1 * V_2 ,
struct V_17 * V_18 ,
const void * V_38 )
{
const struct V_130 * args = V_38 ;
F_12 ( V_18 , args -> V_131 ) ;
F_40 ( V_18 , args -> V_132 , args -> V_133 , args -> V_134 ) ;
}
static void F_55 ( struct V_1 * V_2 ,
struct V_17 * V_18 ,
const void * V_38 )
{
const struct V_135 * args = V_38 ;
F_40 ( V_18 , args -> V_131 , args -> V_136 , args -> V_137 ) ;
F_34 ( V_18 , args -> V_4 , args -> V_138 ) ;
F_27 ( V_18 , args -> V_108 ) ;
}
...
return F_38 ( V_18 , V_22 -> V_46 , & V_22 -> V_103 ) ;
}
int F_64 ( struct V_17 * V_18 , struct V_146 * V_147 ,
bool V_148 )
{
T_2 * V_20 ;
int error ;
...
if ( F_7 ( V_20 == NULL ) )
goto V_25;
V_147 -> V_152 = F_8 ( V_20 ) ;
error = F_33 ( V_18 , & V_147 -> V_93 , & V_147 -> V_6 ) ;
if ( F_7 ( error ) )
return error ;
V_147 -> V_153 = V_147 -> V_140 ;
V_20 = F_6 ( V_18 , 4 ) ;
if ( F_7 ( V_20 == NULL ) )
goto V_25;
V_147 -> V_140 = F_8 ( V_20 ) ;
V_147 -> V_154 = V_155 ;
return 0 ;
V_25:
F_3 ( V_29 , V_18 ) ;
...
static int F_67 ( struct V_17 * V_18 , struct V_156 * V_22 )
{
T_2 * V_20 ;
V_20 = F_6 ( V_18 , V_157 << 2 ) ;
if ( F_7 ( V_20 == NULL ) )
goto V_25;
V_22 -> V_158 = F_8 ( V_20 ++ ) ;
V_22 -> V_159 = F_8 ( V_20 ++ ) ;
...
{
int V_162 ;
for ( V_162 = 0 ; V_163 [ V_162 ] . V_164 != - 1 ; V_162 ++ ) {
if ( V_163 [ V_162 ] . V_164 == ( int ) V_32 )
return V_163 [ V_162 ] . V_165 ;
}
F_4 ( L_11 , V_32 ) ;
return V_163 [ V_162 ] . V_165 ;
}
