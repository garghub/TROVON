...
if ( V_44 == 0 ) {
F_1 (
F_46 ( V_151 , V_12 + sizeof( T_2 ) ) ,
V_146 ) ;
V_148 -= V_12 + sizeof( T_2 ) ;
}
F_45 ( V_151 , V_48 -> V_1 , V_148 ) ;
F_41 ( V_48 , V_148 ) ;
if ( V_147 )
F_3 ( V_14 , V_151 , V_17 ) ;
if ( V_14 -> V_189 &
...
F_45 ( V_40 -> V_46 [ 0 ] , V_48 -> V_1 , V_48 -> V_36 ) ;
}
V_166:
if ( V_40 )
{
...
V_58 -> V_97 = F_47 ( V_14 -> V_117 , V_14 -> V_210 , V_14 -> V_211 ) ;
F_25 ( V_14 , V_58 ) ;
