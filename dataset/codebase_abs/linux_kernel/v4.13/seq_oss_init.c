...
sprintf ( V_6 . V_13 , L_6 , V_47 -> V_52 ) ;
V_6 . V_16 = V_75 | V_17 ;
V_6 . type = V_76 ;
V_6 . V_77 = 128 ;
V_6 . V_78 = 128 ;
...
return F_35 ( V_47 -> V_48 , V_47 -> V_6 ) ;
}
static int
...
{
int V_45 ;
for ( V_45 = 0 ; V_45 < V_47 -> V_89 ; V_45 ++ )
F_41 ( V_47 , V_45 ) ;
if ( V_47 -> V_57 != V_64 ) {
...
return V_91 [ V_90 & V_92 ] ;
}
void
F_48 ( struct V_93 * V_94 )
{
int V_45 ;
struct V_46 * V_47 ;
F_49 ( V_94 , L_15 , V_3 ) ;
...
F_49 ( V_94 , L_20 , V_47 -> V_6 , V_47 -> V_49 ) ;
F_49 ( V_94 , L_21 ,
( V_47 -> V_57 ? L_22 : L_23 ) ,
F_47 ( V_47 -> V_58 ) ) ;
if ( V_47 -> V_57 )
F_49 ( V_94 , L_24 ,
V_47 -> V_62 -> V_95 , V_47 -> V_62 -> V_96 ) ;
F_49 ( V_94 , L_25 , V_60 ) ;
if ( F_24 ( V_47 -> V_58 ) && V_47 -> V_59 )
F_50 ( V_47 -> V_59 , V_94 ) ;
}
}
