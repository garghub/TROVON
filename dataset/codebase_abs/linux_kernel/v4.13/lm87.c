...
static T_2 F_52 ( struct V_6 * V_7 , struct V_44 * V_45 ,
const char * V_46 , T_3 V_50 )
{
struct V_5 * V_8 = F_6 ( V_7 ) ;
unsigned long V_51 ;
int V_52 ;
V_52 = F_53 ( V_46 , 10 , & V_51 ) ;
if ( V_52 )
return V_52 ;
if ( V_51 > 255 )
return - V_53 ;
...
{
struct V_5 * V_8 = F_5 ( V_7 ) ;
return sprintf ( V_46 , L_3 , F_55 ( V_8 -> V_42 ) ) ;
}
static T_2 F_56 ( struct V_6 * V_7 ,
struct V_44 * V_45 ,
const char * V_46 , T_3 V_50 )
{
struct V_1 * V_2 = F_6 ( V_7 ) ;
...
static T_2 F_58 ( struct V_6 * V_7 , struct V_44 * V_45 ,
char * V_46 )
{
struct V_5 * V_8 = F_5 ( V_7 ) ;
...
static int F_59 ( struct V_1 * V_2 , struct V_56 * V_57 )
{
...
F_61 ( V_57 -> type , V_60 , V_69 ) ;
return 0 ;
}
static void F_62 ( void * V_70 )
{
struct V_1 * V_2 = V_70 ;
struct V_5 * V_8 = F_7 ( V_2 ) ;
F_3 ( V_2 , V_65 , V_8 -> V_71 ) ;
}
static int F_63 ( struct V_1 * V_2 )
{
struct V_5 * V_8 = F_7 ( V_2 ) ;
int V_72 ;
struct V_73 * V_74 = V_2 -> V_7 . V_74 ;
T_1 V_51 = 0 ;
...
if ( F_64 ( V_74 , L_9 ) )
V_51 |= F_14 ( 1 ) ;
V_76 = F_65 ( & V_2 -> V_7 , L_10 ) ;
if ( ! F_66 ( V_76 ) ) {
if ( F_67 ( V_76 ) == 5000000 )
V_51 |= V_77 ;
}
V_8 -> V_16 = V_51 ;
F_3 ( V_2 ,
V_78 , V_8 -> V_16 ) ;
} else if ( F_68 ( & V_2 -> V_7 ) ) {
V_8 -> V_16 = * ( T_1 * ) F_68 ( & V_2 -> V_7 ) ;
F_3 ( V_2 ,
V_78 , V_8 -> V_16 ) ;
} else {
V_8 -> V_16 = F_1 ( V_2 , V_78 ) ;
}
V_8 -> V_71 = F_1 ( V_2 , V_65 ) & 0x6F ;
V_72 = F_69 ( & V_2 -> V_7 , F_62 , V_2 ) ;
if ( V_72 )
return V_72 ;
if ( ! ( V_8 -> V_71 & 0x01 ) ) {
int V_14 ;
...
if ( ( V_8 -> V_71 & 0x09 ) != 0x01 )
F_3 ( V_2 , V_65 ,
( V_8 -> V_71 & 0x77 ) | 0x01 ) ;
return 0 ;
}
static int F_70 ( struct V_1 * V_2 , const struct V_79 * V_80 )
{
struct V_5 * V_8 ;
struct V_6 * V_81 ;
int V_52 ;
unsigned int V_82 = 0 ;
V_8 = F_71 ( & V_2 -> V_7 , sizeof( struct V_5 ) , V_83 ) ;
if ( ! V_8 )
return - V_84 ;
F_72 ( V_2 , V_8 ) ;
F_73 ( & V_8 -> V_9 ) ;
...
V_8 -> V_49 [ 0 ] = 2500 ;
V_8 -> V_49 [ 1 ] = 2700 ;
V_8 -> V_49 [ 2 ] = ( V_8 -> V_16 & V_77 ) ? 5000 : 3300 ;
V_8 -> V_49 [ 3 ] = 5000 ;
V_8 -> V_49 [ 4 ] = 12000 ;
V_8 -> V_49 [ 5 ] = 2700 ;
V_8 -> V_49 [ 6 ] = 1875 ;
