...
static void
F_26 ( struct V_1 * V_2 , struct V_53 * V_54 )
{
struct V_59 * V_60 =
(struct V_59 * ) V_54 ;
V_2 -> V_8 = 0 ;
...
static void
F_27 ( struct V_1 * V_2 , struct V_68 * V_22 )
{
V_2 -> V_52 = V_69 ;
F_28 ( & V_2 -> V_11 ) ;
V_2 -> V_22 = V_22 ;
...
static void
F_30 ( struct V_70 * V_71 , enum V_72 V_15 )
{
switch ( V_15 ) {
case V_73 :
F_7 ( V_71 , V_74 ) ;
...
static void
F_37 ( struct V_70 * V_71 , struct V_53 * V_54 )
{
struct V_55 * V_30 = (struct V_55 * ) V_54 ;
struct V_85 * V_86 ;
int V_44 ;
...
static void
F_38 ( struct V_70 * V_71 , struct V_68 * V_22 )
{
V_71 -> V_52 = V_96 ;
V_71 -> V_22 = V_22 ;
F_7 ( V_71 , F_30 ) ;
...
F_41 ( V_98 -> V_2 . V_49 , V_22 -> V_2 . V_49 . V_101 ) ;
V_98 -> V_2 . V_102 = F_17 ( V_22 -> V_2 . V_52 ) ;
F_41 ( V_98 -> V_71 . V_49 , V_22 -> V_71 . V_49 . V_101 ) ;
V_98 -> V_71 . V_102 = F_17 ( V_22 -> V_71 . V_52 ) ;
F_18 ( V_22 -> V_40 , & V_22 -> V_99 , NULL , NULL ) ;
}
static void
F_42 ( void * V_95 , struct V_53 * V_32 )
{
...
static void
F_44 ( void * V_95 , enum V_108 V_15 )
{
struct V_68 * V_22 = (struct V_68 * ) V_95 ;
switch ( V_15 ) {
case V_109 :
F_45 ( & V_22 -> V_23 , F_40 , V_22 ) ;
F_46 ( & V_22 -> V_23 ) ;
F_15 ( & V_22 -> V_2 , V_16 ) ;
F_46 ( & V_22 -> V_23 ) ;
F_15 ( & V_22 -> V_71 , V_73 ) ;
...
F_48 ( void )
{
return F_49 ( V_112 , V_113 ) +
F_49 ( V_114 , V_113 ) ;
}
void
F_50 ( struct V_68 * V_22 , T_2 * V_50 , T_4 V_101 )
{
V_22 -> V_2 . V_49 . V_50 = V_50 ;
V_22 -> V_2 . V_49 . V_101 = V_101 ;
V_50 += F_49 ( V_112 , V_113 ) ;
V_101 += F_49 ( V_112 , V_113 ) ;
V_22 -> V_71 . V_49 . V_50 = V_50 ;
V_22 -> V_71 . V_49 . V_101 = V_101 ;
}
void
F_51 ( struct V_68 * V_22 , struct V_115 * V_40 )
{
V_22 -> V_40 = V_40 ;
F_27 ( & V_22 -> V_2 , V_22 ) ;
F_38 ( & V_22 -> V_71 , V_22 ) ;
F_52 ( V_22 -> V_40 , V_34 , F_42 , V_22 ) ;
F_53 ( & V_22 -> V_116 , F_44 , V_22 ) ;
F_54 ( V_22 -> V_40 , & V_22 -> V_116 ) ;
}
void
F_55 ( struct V_68 * V_22 , enum V_117 V_87 ,
T_5 V_94 , void * V_95 )
{
...
void
F_56 ( struct V_68 * V_22 , struct V_3 * V_41 )
{
if ( F_22 ( V_41 -> V_48 -> V_44 ) <=
F_23 ( & V_22 -> V_2 ) ) {
F_19 ( & V_22 -> V_2 , V_41 ) ;
...
F_57 ( & V_41 -> V_12 , & V_22 -> V_2 . V_11 ) ;
}
}
void
F_58 ( struct V_68 * V_22 , T_2 * V_118 , T_1 V_119 )
{
