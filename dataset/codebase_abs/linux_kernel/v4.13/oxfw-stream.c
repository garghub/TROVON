...
struct V_10 * V_27 )
{
if ( ( ( V_27 == & V_2 -> V_20 ) && ( V_2 -> V_61 > 0 ) ) ||
( ( V_27 == & V_2 -> V_33 ) && ( V_2 -> V_62 > 0 ) ) )
return;
F_7 ( V_2 , V_27 ) ;
}
...
if ( V_63 == NULL )
return - V_66 ;
V_4 = F_35 ( V_2 -> V_5 , V_17 , 0 , V_63 , & V_18 ) ;
if ( V_4 < 0 )
goto V_7;
if ( V_18 < 3 ) {
V_4 = - V_67 ;
...
struct V_14 * V_15 )
{
unsigned int V_19 , V_68 , V_69 , type ;
memset ( V_15 , 0 , sizeof( struct V_14 ) ) ;
if ( ( V_63 [ 0 ] != 0x90 ) || ( V_63 [ 1 ] != 0x40 ) )
return - V_70 ;
for ( V_19 = 0 ; V_19 < F_37 ( V_71 ) ; V_19 ++ ) {
if ( V_63 [ 2 ] == V_71 [ V_19 ] )
break;
}
if ( V_19 == F_37 ( V_71 ) )
...
unsigned int V_75 , T_1 * V_76 , unsigned int * V_18 ,
T_1 * * V_13 )
{
struct V_14 V_15 ;
unsigned int V_19 , V_77 ;
int V_4 ;
V_4 = F_35 ( V_2 -> V_5 , V_17 , V_75 , V_76 , V_18 ) ;
if ( V_4 < 0 ) {
F_20 ( & V_2 -> V_5 -> V_41 ,
L_5 ,
( V_17 == V_6 ) ? L_6 : L_7 ,
...
if ( V_4 < 0 )
goto V_7;
V_13 [ V_77 ] = F_39 ( V_76 , * V_18 , V_65 ) ;
if ( V_13 [ V_77 ] == NULL ) {
V_4 = - V_66 ;
goto V_7;
}
for ( V_19 = 0 ; V_19 < F_37 ( V_72 ) ; V_19 ++ ) {
if ( V_15 . V_3 == V_72 [ V_19 ] )
continue;
V_4 = F_40 ( V_2 -> V_5 ,
V_72 [ V_19 ] ,
V_17 , V_75 ) ;
...
V_13 = V_2 -> V_22 ;
V_18 = V_64 ;
V_4 = F_42 ( V_2 -> V_5 , V_17 , 0 , V_76 , & V_18 , 0 ) ;
if ( V_4 == - V_70 ) {
V_18 = V_64 ;
V_4 = F_38 ( V_2 , V_17 , V_75 , V_76 , & V_18 ,
V_13 ) ;
goto V_7;
} else if ( V_4 < 0 ) {
F_20 ( & V_2 -> V_5 -> V_41 ,
L_8 ,
V_77 , ( V_17 == V_6 ) ? L_6 : L_7 ,
V_75 , V_4 ) ;
goto V_7;
}
while ( V_77 < V_23 ) {
...
unsigned int V_19 ;
int V_4 ;
V_4 = F_44 ( V_2 -> V_5 , 0x1f , 0x07 , 0x00 , V_79 ) ;
if ( V_4 < 0 ) {
F_20 ( & V_2 -> V_5 -> V_41 ,
L_9 ,
V_4 ) ;
goto V_7;
} else if ( ( V_79 [ 0 ] == 0 ) && ( V_79 [ 1 ] == 0 ) ) {
V_4 = - V_70 ;
goto V_7;
}
if ( V_79 [ 1 ] > 0 ) {
