...
F_9 ( & V_5 -> V_7 . V_26 ) ;
F_10 ( & V_19 -> V_26 , V_25 ) ;
V_5 -> V_7 . V_57 = F_31 ( V_58 , & V_5 -> V_7 , L_27 ) ;
V_5 -> V_7 . V_59 = F_31 ( V_60 , & V_5 -> V_7 , L_28 ) ;
F_32 ( V_5 , V_10 ) ;
return V_46 ;
}
static void F_33 ( int V_61 )
{
struct V_62 * V_8 ;
V_8 = V_63 + V_61 ;
if ( V_61 == 0 )
...
snprintf ( V_8 -> V_33 , V_64 + 1 , L_30 , V_61 ) ;
V_8 -> V_39 . V_39 . V_33 = V_8 -> V_33 ;
V_8 -> V_39 . V_39 . V_65 = V_66 ;
V_8 -> V_39 . V_67 = F_14 ;
F_34 ( & V_8 -> V_39 . V_39 ) ;
}
...
{
int V_61 ;
V_63 = F_36 ( V_40 , sizeof( struct V_62 ) ,
V_68 ) ;
if ( V_63 == NULL )
return - V_69 ;
...
struct V_70 * * V_71 ;
int V_36 , V_24 ;
V_71 = F_36 ( ( V_40 + 5 ) , sizeof( struct V_70 * ) ,
V_68 ) ;
if ( V_71 == NULL )
return - V_69 ;
V_36 = F_35 () ;
...
* ( V_71 + V_24 + 4 ) = & ( ( V_63 + V_24 ) -> V_39 . V_39 ) ;
V_76 . V_71 = V_71 ;
return 0 ;
}
void F_40 ( void )
