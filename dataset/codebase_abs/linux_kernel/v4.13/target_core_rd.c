...
static struct V_15 * F_31 ( struct V_1 * V_1 , T_1 V_18 )
{
struct V_15 * V_16 ;
T_1 V_22 , V_25 = ( V_34 /
sizeof( struct V_20 ) ) ;
...
static T_2 F_32 ( struct V_64 * V_65 , bool V_66 )
{
...
if ( V_67 -> V_54 . V_78 ) {
if ( V_66 )
V_41 = F_34 ( V_65 , V_65 -> V_76 , V_70 , 0 ,
V_69 , V_72 ) ;
else
V_41 = F_34 ( V_65 , V_65 -> V_76 , V_70 , 0 ,
V_65 -> V_79 , 0 ) ;
...
if ( ! V_41 )
F_35 ( V_65 , V_70 , V_66 , V_69 , V_72 ) ;
return V_41 ;
}
static T_2
F_36 ( struct V_64 * V_65 , struct V_20 * V_80 , T_1 V_81 ,
enum V_82 V_83 )
{
struct V_2 * V_67 = V_65 -> V_67 ;
struct V_1 * V_3 = F_1 ( V_67 ) ;
...
return - V_9 ;
V_105 = V_107 ;
while ( ( V_106 = F_45 ( & V_107 , L_25 ) ) != NULL ) {
if ( ! * V_106 )
continue;
V_110 = F_46 ( V_106 , V_111 , args ) ;
switch ( V_110 ) {
case V_112 :
F_47 ( args , & V_109 ) ;
V_1 -> V_42 = V_109 ;
...
static T_5 F_48 ( struct V_2 * V_3 , char * V_114 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
...
static T_7 F_49 ( struct V_2 * V_3 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
