...
F_142 ( V_35 , 0 , V_247 , V_268 ) ;
if ( V_247 -> V_250 ) {
T_4 V_22 ;
T_3 V_270 ;
const unsigned char * V_271 = F_143 ( V_35 ) ;
F_124 ( struct V_198 * , V_251 , V_247 -> V_250 ) ;
memset ( V_251 , 0 , sizeof( struct V_194 ) ) ;
F_144 ( V_271 + 1 , V_35 -> V_43 - V_271 - 1 , & V_270 , NULL ,
& V_22 , NULL , NULL ) ;
V_251 -> V_200 = V_201 ;
...
static int F_146 ( struct V_126 * V_2 , int V_272 )
{
return - V_153 ;
}
...
V_292 . V_91 = V_3 -> V_91 ;
V_292 . V_293 = F_154 ( & V_3 -> V_293 ) / V_52 ;
V_292 . V_294 = F_154 ( & V_3 -> V_294 ) / V_52 ;
V_292 . V_295 = F_154 ( & V_3 -> V_295 ) / V_52 ;
V_292 . V_296 = F_154 ( & V_3 -> V_296 ) / ( 60 * V_52 ) ;
V_292 . V_90 = V_3 -> V_90 ;
V_292 . V_46 = V_3 -> V_46 ;
V_292 . V_297 = F_155 ( V_2 ) ;
V_292 . V_298 = F_148 ( V_2 ) ;
...
static void * F_157 ( struct V_321 * V_322 , T_9 * V_323 )
__acquires( V_5 )
{
F_6 ( & V_5 ) ;
return F_158 ( & V_20 , * V_323 ) ;
}
static void * F_159 ( struct V_321 * V_322 , void * V_324 , T_9 * V_323 )
{
return F_160 ( V_324 , & V_20 , V_323 ) ;
}
static void F_161 ( struct V_321 * V_322 , void * V_324 )
__releases( V_5 )
{
F_8 ( & V_5 ) ;
}
static int F_162 ( struct V_321 * V_322 , void * V_324 )
{
T_1 * V_3 = F_163 ( V_324 , struct T_1 , V_4 ) ;
char V_325 [ 11 ] ;
int V_57 ;
F_164 ( V_322 , L_3 ,
( long ) V_3 ,
V_3 -> T_2 == NULL ? L_4 : V_3 -> T_2 -> V_7 -> V_149 ,
F_165 ( V_325 , & V_3 -> V_24 ) ,
V_3 -> V_23 ? L_5 : L_6 ) ;
F_164 ( V_322 , L_7 , F_165 ( V_325 , & V_3 -> V_29 ) ) ;
for ( V_57 = 0 ; ( V_3 -> V_33 != NULL ) && ( V_57 < V_3 -> V_33 -> V_32 ) ; V_57 ++ ) {
F_164 ( V_322 , L_8 ,
F_165 ( V_325 , & V_3 -> V_33 -> V_67 [ V_57 ] ) ,
V_3 -> V_33 -> V_227 [ V_57 ] ? L_5 : L_6 ) ;
}
F_164 ( V_322 , L_9 ,
V_3 -> V_46 ,
V_3 -> V_299 , V_3 -> V_300 , V_3 -> V_301 ,
F_154 ( & V_3 -> V_293 ) / V_52 , V_3 -> V_86 / V_52 ,
F_154 ( & V_3 -> V_294 ) / V_52 , V_3 -> V_88 / V_52 ,
F_154 ( & V_3 -> V_295 ) / V_52 , V_3 -> V_93 / V_52 ,
F_154 ( & V_3 -> V_296 ) / ( 60 * V_52 ) ,
V_3 -> V_95 / ( 60 * V_52 ) ,
V_3 -> V_90 , V_3 -> V_91 ,
V_3 -> V_85 / V_52 ,
V_3 -> V_83 ,
...
static int F_168 ( struct V_326 * V_326 , struct V_327 * V_327 )
{
return F_169 ( V_327 , & V_328 ) ;
}
static int T_10 F_170 ( void )
{
int V_329 = F_171 ( & V_168 , 0 ) ;
if ( V_329 != 0 )
goto V_152;
F_172 ( & V_330 ) ;
F_173 ( & V_331 ) ;
F_174 ( & V_332 ) ;
F_175 ( L_12 , V_333 , V_15 . V_334 ,
& V_335 ) ;
F_175 ( L_13 , V_333 , V_15 . V_334 , & V_336 ) ;
F_175 ( L_14 , V_333 , V_15 . V_334 , & V_337 ) ;
V_152:
return V_329 ;
}
static void T_11 F_176 ( void )
{
F_177 ( L_12 , V_15 . V_334 ) ;
F_177 ( L_13 , V_15 . V_334 ) ;
F_177 ( L_14 , V_15 . V_334 ) ;
F_178 ( & V_332 ) ;
F_179 ( & V_331 ) ;
F_180 ( V_160 ) ;
F_181 ( & V_168 ) ;
