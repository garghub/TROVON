...
T_2 T_5 *
F_29 ( struct V_1 * V_2 , const char * V_33 , int V_34 , int V_35 ,
T_3 V_16 , unsigned long V_36 , struct V_37 * * V_38 )
{
T_2 T_5 * V_39 ;
T_1 V_40 ;
V_40 = F_30 ( V_35 , V_27 , 0 , V_34 ) ;
* V_38 = F_31 ( V_2 , V_33 , V_40 , V_16 , V_36 ) ;
if ( ! * V_38 )
goto V_41;
V_39 = F_32 ( * V_38 ) ;
if ( ! V_39 )
