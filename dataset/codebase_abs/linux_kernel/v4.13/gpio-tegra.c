...
static int F_40 ( struct V_11 * V_12 , unsigned V_13 )
{
struct V_1 * V_2 = F_14 ( V_12 ) ;
...
static int F_65 ( struct V_61 * V_49 )
{
struct V_62 * V_63 = F_66 ( V_49 ) ;
...
for ( V_65 = 0 ; V_65 < F_69 ( V_6 -> V_17 ) ; V_65 ++ ) {
...
static int F_71 ( struct V_61 * V_49 )
{
struct V_62 * V_63 = F_66 ( V_49 ) ;
struct V_1 * V_2 = F_67 ( V_63 ) ;
unsigned long V_25 ;
...
static int F_72 ( struct V_32 * V_33 , unsigned int V_74 )
{
struct V_22 * V_6 = F_43 ( V_33 ) ;
int V_9 = V_33 -> V_34 ;
T_1 V_7 , V_8 , V_75 ;
...
V_6 -> V_73 [ V_7 ] &= ~ V_75 ;
return F_73 ( V_6 -> V_76 , V_74 ) ;
}
static int F_74 ( struct V_77 * V_78 , void * V_79 )
{
...
static int F_76 ( struct V_83 * V_83 , struct V_84 * V_84 )
{
return F_77 ( V_84 , F_74 , V_83 -> V_85 ) ;
}
...
V_2 = F_82 ( & V_63 -> V_49 , sizeof( * V_2 ) , V_92 ) ;
if ( ! V_2 )
return - V_91 ;
V_2 -> V_67 = V_28 ;
V_2 -> V_49 = & V_63 -> V_49 ;
...
V_2 -> V_48 . V_101 = F_40 ;
V_2 -> V_48 . V_102 = 0 ;
V_2 -> V_48 . V_103 = V_2 -> V_66 * 32 ;
V_2 -> V_48 . V_104 = & V_63 -> V_49 ;
V_2 -> V_48 . V_105 = V_63 -> V_49 . V_105 ;
V_2 -> V_106 . V_107 = L_7 ;
V_2 -> V_106 . V_108 = F_42 ;
V_2 -> V_106 . V_109 = F_45 ;
V_2 -> V_106 . V_110 = F_47 ;
V_2 -> V_106 . V_111 = F_48 ;
V_2 -> V_106 . V_112 = F_53 ;
#ifdef F_84
V_2 -> V_106 . V_113 = F_72 ;
#endif
F_85 ( V_63 , V_2 ) ;
if ( V_28 -> V_68 )
V_2 -> V_48 . V_114 = F_37 ;
V_2 -> V_23 = F_82 ( & V_63 -> V_49 , V_2 -> V_66 *
sizeof( * V_2 -> V_23 ) , V_92 ) ;
if ( ! V_2 -> V_23 )
return - V_91 ;
V_2 -> V_31 = F_86 ( V_63 -> V_49 . V_105 ,
V_2 -> V_48 . V_103 ,
& V_115 , NULL ) ;
if ( ! V_2 -> V_31 )
return - V_91 ;
for ( V_81 = 0 ; V_81 < V_2 -> V_66 ; V_81 ++ ) {
V_90 = F_83 ( V_63 , V_93 , V_81 ) ;
if ( ! V_90 ) {
F_50 ( & V_63 -> V_49 , L_5 ) ;
return - V_91 ;
}
...
V_90 = F_83 ( V_63 , V_117 , 0 ) ;
V_2 -> V_5 = F_87 ( & V_63 -> V_49 , V_90 ) ;
if ( F_88 ( V_2 -> V_5 ) )
return F_89 ( V_2 -> V_5 ) ;
for ( V_81 = 0 ; V_81 < V_2 -> V_66 ; V_81 ++ ) {
for ( V_82 = 0 ; V_82 < 4 ; V_82 ++ ) {
...
V_36 = F_90 ( & V_63 -> V_49 , & V_2 -> V_48 , V_2 ) ;
if ( V_36 < 0 ) {
F_91 ( V_2 -> V_31 ) ;
return V_36 ;
}
for ( V_9 = 0 ; V_9 < V_2 -> V_48 . V_103 ; V_9 ++ ) {
int V_76 = F_92 ( V_2 -> V_31 , V_9 ) ;
V_6 = & V_2 -> V_23 [ F_29 ( V_9 ) ] ;
F_93 ( V_76 , & V_118 ) ;
F_94 ( V_76 , V_6 ) ;
F_95 ( V_76 , & V_2 -> V_106 , V_119 ) ;
}
for ( V_81 = 0 ; V_81 < V_2 -> V_66 ; V_81 ++ ) {
V_6 = & V_2 -> V_23 [ V_81 ] ;
F_96 ( V_6 -> V_76 ,
