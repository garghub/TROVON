...
if ( ! V_2 . V_31 )
return;
V_157 = F_118 ( V_2 . V_31 , L_36 , & V_6 ) ;
V_158 = F_118 ( V_2 . V_31 , L_37 , & V_156 ) ;
if ( V_157 || V_158 ) {
F_25 ( V_2 . V_31 ) ;
V_2 . V_31 = NULL ;
return;
...
V_2 . V_6 = V_6 ;
V_2 . V_156 = V_156 ;
V_159 = F_118 ( V_2 . V_31 , L_38 , & V_54 ) ;
V_2 . V_54 = V_159 ? V_2 . V_6 : V_54 ;
#ifdef F_119
if ( F_120 ( V_160 ) ) {
V_154 = F_121 ( V_161 , V_155 ) ;
V_151 = F_26 ( L_29 ) ;
}
#endif
V_162 = F_122 ( V_163 , V_164 , V_154 ) ;
#ifdef F_123
V_41 = F_26 ( L_39 ) ;
#endif
}
int T_1 F_124 ( unsigned long V_165 ,
const char * V_166 , int V_167 , void * V_95 )
{
const T_3 * V_168 , * V_169 , * V_170 ;
if ( V_167 != 1 || strcmp ( V_166 , L_35 ) != 0 )
return 0 ;
V_168 = F_125 ( V_165 , L_36 , NULL ) ;
V_169 = F_125 ( V_165 , L_38 , NULL ) ;
V_170 = F_125 ( V_165 , L_37 , NULL ) ;
...
#ifdef F_126
V_168 = F_125 ( V_165 , L_40 , NULL ) ;
if ( V_168 )
V_11 = * V_168 ;
V_168 = F_125 ( V_165 , L_41 , NULL ) ;
if ( V_168 )
V_12 = * V_168 ;
if ( V_11 != V_28 &&
V_12 != V_28 )
...
F_131 () ;
F_129 ( & V_171 ) ;
F_133 ( V_172 >> 32 , V_172 & 0xffffffff ) ;
V_172 = 0 ;
F_6 ( & V_171 ) ;
}
