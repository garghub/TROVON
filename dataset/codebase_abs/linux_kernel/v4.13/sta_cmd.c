...
for ( V_54 = 0 ;
V_54 < sizeof( V_51 -> V_63 ) / sizeof( T_1 ) ;
V_54 ++ )
V_51 -> V_63 [ V_54 ] =
F_2 ( V_46 [ 2 + V_54 ] ) ;
...
V_57 * V_327 , V_467 ;
T_1 V_468 = 0 ;
struct V_469 * V_11 = V_2 -> V_470 ;
V_4 -> V_6 = F_2 ( V_471 ) ;
V_4 -> V_8 = F_2 ( V_10 ) ;
F_7 ( & V_4 -> V_8 ,
sizeof( struct V_449 ) ) ;
V_450 -> V_472 = 0 ;
memcpy ( V_450 -> V_473 , V_452 -> V_473 , V_138 ) ;
V_327 = ( V_57 * ) V_450 + sizeof( struct V_449 ) ;
switch ( V_452 -> V_440 ) {
case V_474 :
V_450 -> V_440 = F_2 ( V_475 ) ;
break;
case V_476 :
V_450 -> V_440 = F_2 ( V_477 ) ;
break;
case V_478 :
V_450 -> V_440 = F_2 ( V_479 ) ;
if ( ! V_11 ) {
F_4 ( V_2 -> V_29 , ERROR ,
L_33 ,
V_452 -> V_473 ) ;
...
F_8 ( V_11 -> V_481 , V_327 ) ;
V_468 += sizeof( V_11 -> V_481 ) ;
V_467 = V_11 -> V_482 | ( V_11 -> V_483 << 5 ) ;
V_458 = (struct V_457 * ) ( V_327 +
V_468 ) ;
V_458 -> V_126 . type = F_2 ( V_484 ) ;
V_458 -> V_126 . V_128 = F_2 ( sizeof( V_467 ) ) ;
V_458 -> V_467 = V_467 ;
V_468 += sizeof( struct V_457 ) ;
if ( V_11 -> V_485 ) {
...
F_2 ( V_486 ) ;
V_456 -> V_126 . V_128 =
F_2 ( sizeof( struct V_487 ) ) ;
memcpy ( & V_456 -> V_488 , V_11 -> V_485 ,
sizeof( struct V_487 ) ) ;
V_468 += sizeof( struct V_455 ) ;
}
...
V_454 -> V_126 . V_128 =
F_2 ( V_11 -> V_490 ) ;
memcpy ( V_454 -> V_492 , V_11 -> V_489 ,
V_11 -> V_490 ) ;
V_468 += sizeof( struct V_453 ) +
V_11 -> V_490 ;
}
if ( V_11 -> V_493 && V_11 -> V_494 ) {
V_460 = (struct V_459 * ) ( V_327 +
V_468 ) ;
V_460 -> V_126 . type =
F_2 ( V_495 ) ;
V_460 -> V_126 . V_128 = F_2 ( V_11 -> V_494 ) ;
memcpy ( V_460 -> V_493 , V_11 -> V_493 ,
V_11 -> V_494 ) ;
V_468 += sizeof( struct V_459 ) +
V_11 -> V_494 ;
}
if ( V_11 -> V_496 ) {
...
F_2 ( V_497 ) ;
V_462 -> V_126 . V_128 =
F_2 ( sizeof( struct V_498 ) ) ;
memcpy ( & V_462 -> V_499 , V_11 -> V_496 ,
sizeof( struct V_498 ) ) ;
V_468 += sizeof( struct V_461 ) ;
}
if ( V_11 -> V_464 ) {
V_464 = (struct V_463 * ) ( V_327 + V_468 ) ;
V_464 -> V_126 . type = F_2 ( V_500 ) ;
V_464 -> V_126 . V_128 = F_2 ( sizeof( V_11 -> V_464 ) ) ;
V_464 -> V_464 = F_2 ( V_11 -> V_464 ) ;
V_468 += sizeof( struct V_463 ) ;
}
V_466 = ( void * ) ( V_327 + V_468 ) ;
V_466 -> V_126 . type = F_2 ( V_501 ) ;
V_466 -> V_126 . V_128 = F_2 ( sizeof( V_466 -> V_43 ) ) ;
V_466 -> V_43 = F_2 ( V_502 ) ;
V_468 += sizeof( struct V_465 ) ;
break;
default:
...
{
V_4 -> V_6 = F_2 ( V_506 ) ;
V_4 -> V_8 = F_2 ( sizeof( struct V_507 ) +
V_10 ) ;
return 0 ;
}
static int F_57 ( struct V_1 * V_2 , T_1 V_508 )
{
if ( ! F_58 ( V_2 -> V_29 -> V_509 ) ) {
switch ( V_508 ) {
case V_262 :
case V_510 :
case V_511 :
...
int F_59 ( struct V_1 * V_2 , T_4 V_508 ,
T_1 V_5 , T_2 V_31 ,
void * V_78 , void * V_513 )
{
struct V_3 * V_514 = V_513 ;
int V_236 = 0 ;
if ( F_57 ( V_2 , V_508 ) ) {
F_4 ( V_2 -> V_29 , ERROR ,
L_35 ,
...
switch ( V_508 ) {
case V_515 :
V_236 = F_60 ( V_2 , V_514 ) ;
break;
case V_379 :
V_236 = F_45 ( V_2 , V_514 , V_78 ) ;
break;
case V_30 :
V_236 = F_3 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_133 :
V_236 = F_18 ( V_2 , V_514 ,
V_5 ) ;
break;
case V_144 :
V_236 = F_19 ( V_514 , V_5 ,
V_78 ) ;
break;
case V_55 :
V_236 = F_12 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_76 :
V_236 = F_14 ( V_514 , V_5 ,
V_78 ) ;
break;
case V_80 :
V_236 = F_15 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_87 :
V_236 = F_16 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_516 :
V_236 = F_61 ( V_2 , V_514 , V_5 ,
( T_4 ) V_31 , V_78 ) ;
break;
case V_113 :
V_236 = F_17 ( V_2 , V_514 , V_5 ,
(struct V_103 * ) V_78 ) ;
break;
case V_517 :
V_236 = F_62 ( V_514 , V_78 ) ;
break;
case V_518 :
V_236 = F_63 ( V_2 , V_514 ,
V_78 ) ;
break;
case V_519 :
V_236 = F_64 ( V_514 ) ;
break;
case V_520 :
V_236 = F_65 ( V_2 , V_514 , V_78 ) ;
break;
case V_151 :
V_236 = F_20 ( V_2 , V_514 ,
V_78 ) ;
break;
case V_510 :
V_236 = F_66 ( V_2 , V_514 ,
V_78 ) ;
break;
case V_44 :
V_236 = F_11 ( V_514 ) ;
...
break;
case V_7 :
V_236 = F_1 ( V_2 , V_514 , V_5 ) ;
break;
case V_37 :
V_236 = F_6 ( V_2 , V_514 , V_5 ,
V_31 , V_78 ) ;
break;
case V_521 :
V_514 -> V_6 =
...
case V_524 :
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_11 . V_525 . V_526 =
( V_57 ) ( F_68 ( ( T_2 * ) V_78 ) ) ;
memcpy ( & V_514 -> V_11 , V_78 ,
sizeof( struct V_527 ) ) ;
V_514 -> V_8 =
...
case V_528 :
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_11 . V_529 . V_13 = F_2 ( V_5 ) ;
V_514 -> V_11 . V_529 . V_530 = F_5 (
F_68 ( ( T_2 * ) V_78 ) ) ;
V_514 -> V_8 =
...
break;
case V_534 :
V_236 = F_69 ( V_2 , V_514 , V_5 , V_78 ) ;
break;
case V_535 :
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_11 . V_536 . V_13 = F_2 ( V_5 ) ;
V_514 -> V_11 . V_536 . V_258 =
F_2 ( * ( T_1 * ) V_78 ) ;
V_514 -> V_8 =
F_2 ( sizeof( struct V_537 ) +
V_10 ) ;
break;
case V_538 :
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_11 . V_539 . V_13 = F_2 ( V_5 ) ;
V_514 -> V_11 . V_539 . V_77 = F_2 (
F_68 ( ( T_1 * ) V_78 ) ) ;
V_514 -> V_8 =
F_2 ( sizeof( struct V_540 ) +
V_10 ) ;
break;
case V_541 :
if ( V_2 -> V_29 -> V_542 == V_543 )
V_2 -> V_29 -> V_542 = V_544 ;
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_8 = F_2 ( V_10 ) ;
break;
case V_545 :
V_2 -> V_29 -> V_542 = V_543 ;
V_514 -> V_6 = F_2 ( V_508 ) ;
V_514 -> V_8 = F_2 ( V_10 ) ;
break;
case V_546 :
V_236 = F_70 ( V_514 , V_78 ) ;
break;
case V_547 :
V_236 = F_71 ( V_514 , V_78 ) ;
break;
case V_548 :
V_236 = F_72 ( V_2 , V_514 , V_78 ) ;
break;
case V_203 :
V_236 = F_29 ( V_2 , V_514 ,
V_5 , V_31 ,
V_78 ) ;
break;
case V_253 :
V_236 = F_30 ( V_2 , V_514 ,
V_5 ) ;
break;
case V_549 :
V_236 = F_73 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_550 :
V_236 = F_74 ( V_514 , V_5 ,
V_78 ) ;
break;
case V_551 :
V_236 = F_75 ( V_2 , V_514 , V_5 , V_78 ) ;
break;
case V_552 :
F_4 ( V_2 -> V_29 , V_36 ,
L_36 ) ;
V_514 -> V_6 = F_2 ( V_552 ) ;
V_514 -> V_8 =
F_2 ( sizeof( struct V_553 ) +
V_10 ) ;
V_236 = 0 ;
break;
case V_262 :
V_236 = F_31 ( V_514 , V_5 ,
V_78 ) ;
break;
case V_554 :
V_236 = F_76 ( V_2 , V_514 , V_78 ) ;
break;
case V_269 :
V_236 = F_32 ( V_514 , V_5 , V_78 ) ;
break;
case V_273 :
case V_277 :
case V_280 :
...
case V_286 :
case V_288 :
V_236 = F_33 ( V_514 , V_5 , V_78 ) ;
break;
case V_555 :
V_514 -> V_6 = F_2 ( V_508 ) ;
if ( V_2 -> V_223 == V_224 )
V_514 -> V_11 . V_223 . V_556 =
V_557 ;
else if ( V_2 -> V_223 == V_558 ||
V_2 -> V_223 == V_559 )
V_514 -> V_11 . V_223 . V_556 =
V_560 ;
else if ( V_2 -> V_223 == V_561 ||
V_2 -> V_223 == V_562 )
V_514 -> V_11 . V_223 . V_556 = V_563 ;
V_514 -> V_8 = F_2 ( sizeof( struct
V_564 ) + V_10 ) ;
V_236 = 0 ;
break;
case V_300 :
V_236 = F_34 ( V_2 , V_514 , V_5 ) ;
break;
case V_328 :
V_236 = F_35 ( V_2 , V_514 , V_78 ) ;
break;
case V_363 :
V_236 = F_38 ( V_2 , V_514 , V_78 ) ;
break;
case V_424 :
V_236 = F_52 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_471 :
V_236 = F_54 ( V_2 , V_514 , V_78 ) ;
break;
case V_439 :
V_236 = F_53 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_565 :
V_236 = F_77 ( V_2 , V_514 ,
V_78 ) ;
break;
case V_505 :
V_236 = F_55 ( V_514 , V_5 ,
V_78 ) ;
break;
case V_506 :
V_236 = F_56 ( V_2 , V_514 ) ;
break;
case V_388 :
V_236 = F_47 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_394 :
V_236 = F_48 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_402 :
V_236 = F_49 ( V_2 , V_514 , V_5 ,
V_78 ) ;
break;
case V_414 :
V_236 = F_51 ( V_2 , V_514 , V_5 ) ;
break;
default:
F_4 ( V_2 -> V_29 , ERROR ,
L_37 , V_508 ) ;
...
int F_78 ( struct V_1 * V_2 , V_57 V_566 , bool V_567 )
{
struct V_105 * V_29 = V_2 -> V_29 ;
int V_236 ;
struct V_568 V_569 ;
...
F_44 ( V_2 , V_379 ,
V_28 , 0 , NULL , true ) ;
V_236 = F_44 ( V_2 , V_515 ,
V_39 , 0 , NULL , true ) ;
if ( V_236 )
return - 1 ;
if ( V_2 -> V_29 -> V_578 == V_580 &&
F_81 ( V_2 -> V_29 -> V_509 ) &&
! V_2 -> V_29 -> V_581 ) {
V_576 = true ;
V_236 = F_44 ( V_2 ,
...
V_575 . V_602 = V_603 ;
V_236 = F_44 ( V_2 , V_551 ,
V_28 , 0 , & V_575 , true ) ;
if ( V_567 ) {
V_2 -> V_29 -> V_604 = V_551 ;
V_236 = - V_605 ;
}
return V_236 ;
}
