...
F_56 ( struct V_1 * V_2 ,
struct V_75 * V_300 ,
int V_263 , int V_264 , bool V_301 )
{
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_10 * V_6 = V_2 -> V_6 ;
struct V_23 * V_24 = V_23 ( V_6 ) ;
...
V_9 -> V_76 . V_63 = V_76 -> V_259 -> V_305 . V_63 ;
if ( V_9 -> V_296 . V_240 != V_302 -> V_239 -> V_240 ) {
V_9 -> V_296 . V_240 = V_302 -> V_239 -> V_240 ;
F_52 ( V_2 ) ;
}
V_11 -> V_7 [ V_238 ] &= ~ 3 ;
V_11 -> V_7 [ V_238 ] |= ( V_302 -> V_239 -> V_240 + 1 ) / 8 ;
V_11 -> V_242 &= ~ V_246 ;
if ( V_302 -> V_239 -> V_240 == 16 )
V_11 -> V_242 |= V_246 ;
F_1 ( V_2 , V_11 , V_238 ) ;
F_8 ( V_6 , V_9 -> V_5 , V_306 ,
V_11 -> V_242 ) ;
V_11 -> V_7 [ V_154 ] = V_302 -> V_155 [ 0 ] >> 3 ;
V_11 -> V_7 [ V_160 ] =
F_24 ( V_302 -> V_155 [ 0 ] >> 3 , 8 , V_161 ) ;
V_11 -> V_7 [ V_162 ] =
F_24 ( V_302 -> V_155 [ 0 ] / 8 , 11 , V_163 ) ;
F_1 ( V_2 , V_11 , V_160 ) ;
F_1 ( V_2 , V_11 , V_154 ) ;
F_1 ( V_2 , V_11 , V_162 ) ;
V_11 -> V_307 = V_9 -> V_76 . V_63 & ~ 3 ;
V_11 -> V_307 += ( V_264 * V_302 -> V_155 [ 0 ] ) + ( V_263 * V_302 -> V_239 -> V_308 [ 0 ] ) ;
F_57 ( V_6 , V_9 -> V_5 , V_11 -> V_307 ) ;
F_58 ( V_6 , V_2 -> V_21 . clock , V_302 -> V_239 -> V_308 [ 0 ] * 8 ,
& V_303 , & V_304 ) ;
V_11 -> V_7 [ V_309 ] = V_303 ;
V_11 -> V_7 [ V_310 ] = V_304 & 0xff ;
F_1 ( V_2 , V_11 , V_309 ) ;
F_1 ( V_2 , V_11 , V_310 ) ;
if ( V_24 -> V_27 . V_28 . V_41 . V_51 >= V_311 ) {
V_11 -> V_7 [ V_312 ] = V_304 >> 8 ;
F_1 ( V_2 , V_11 , V_312 ) ;
}
return 0 ;
}
...
F_59 ( struct V_1 * V_2 ,
struct V_75 * V_76 ,
int V_263 , int V_264 , enum V_313 V_32 )
{
...
static void F_62 ( struct V_10 * V_6 , struct V_315 * V_316 ,
struct V_315 * V_317 )
{
int V_318 = F_63 ( V_6 ) ;
T_2 V_319 ;
int V_294 , V_320 ;
for ( V_294 = 0 ; V_294 < V_318 ; V_294 ++ ) {
for ( V_320 = 0 ; V_320 < V_318 ; V_320 ++ ) {
V_319 = F_64 ( V_316 , V_294 * 64 + V_320 ) ;
F_65 ( V_317 , V_294 * V_318 + V_320 , ( V_319 & 0x80000000 ) >> 16
| ( V_319 & 0xf80000 ) >> 9
| ( V_319 & 0xf800 ) >> 6
| ( V_319 & 0xf8 ) >> 3 ) ;
}
...
static void F_66 ( struct V_10 * V_6 , struct V_315 * V_316 ,
struct V_315 * V_317 )
{
T_2 V_319 ;
int V_321 , V_294 ;
for ( V_294 = 0 ; V_294 < 64 * 64 ; V_294 ++ ) {
V_319 = F_64 ( V_316 , V_294 ) ;
V_321 = V_319 >> 24 ;
if ( V_321 > 0 && V_321 < 255 )
V_319 = ( V_319 & 0x00ffffff ) | ( ( V_321 + 1 ) << 24 ) ;
#ifdef F_46
{
struct V_23 * V_24 = V_23 ( V_6 ) ;
if ( V_24 -> V_27 . V_28 . V_41 . V_42 == 0x11 ) {
V_319 = ( ( V_319 & 0x000000ff ) << 24 ) |
( ( V_319 & 0x0000ff00 ) << 8 ) |
( ( V_319 & 0x00ff0000 ) >> 8 ) |
( ( V_319 & 0xff000000 ) >> 24 ) ;
}
...
#endif
F_67 ( V_317 , V_294 , V_319 ) ;
}
}
static int
F_68 ( struct V_1 * V_2 , struct V_322 * V_323 ,
T_2 V_324 , T_2 V_318 , T_2 V_325 )
{
struct V_23 * V_24 = V_23 ( V_2 -> V_6 ) ;
struct V_10 * V_6 = V_24 -> V_6 ;
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_315 * V_61 = NULL ;
struct V_326 * V_327 ;
int V_258 = 0 ;
if ( ! V_324 ) {
V_9 -> V_61 . V_328 ( V_9 , true ) ;
return 0 ;
}
if ( V_318 != 64 || V_325 != 64 )
return - V_329 ;
V_327 = F_69 ( V_323 , V_324 ) ;
if ( ! V_327 )
return - V_330 ;
V_61 = F_70 ( V_327 ) ;
V_258 = F_71 ( V_61 ) ;
...
F_50 ( V_61 ) ;
V_9 -> V_61 . V_63 = V_9 -> V_61 . V_259 -> V_305 . V_63 ;
V_9 -> V_61 . V_62 ( V_9 , V_9 -> V_61 . V_63 ) ;
V_9 -> V_61 . V_332 ( V_9 , true ) ;
V_331:
F_72 ( V_327 ) ;
return V_258 ;
}
...
{
struct F_3 * V_9 = F_3 ( V_2 ) ;
V_9 -> V_61 . V_333 ( V_9 , V_263 , V_264 ) ;
return 0 ;
}
static int
F_74 ( struct V_334 * V_335 ,
struct V_298 * V_299 )
{
struct V_10 * V_6 ;
struct V_23 * V_24 ;
...
V_6 = V_335 -> V_2 -> V_6 ;
V_258 = F_75 ( V_6 -> V_6 ) ;
if ( V_258 < 0 && V_258 != - V_337 )
return V_258 ;
V_258 = F_76 ( V_335 , V_299 ) ;
V_24 = V_23 ( V_6 ) ;
...
int
F_79 ( struct V_10 * V_6 , int V_340 )
{
struct F_3 * V_9 ;
int V_258 , V_294 ;
V_9 = F_80 ( sizeof( * V_9 ) , V_341 ) ;
if ( ! V_9 )
return - V_342 ;
for ( V_294 = 0 ; V_294 < 256 ; V_294 ++ ) {
...
V_9 -> V_343 = F_35 ;
V_9 -> V_344 = F_37 ;
F_81 ( V_6 , & V_9 -> V_286 , & V_345 ) ;
F_82 ( & V_9 -> V_286 , & V_346 ) ;
F_83 ( & V_9 -> V_286 , 256 ) ;
