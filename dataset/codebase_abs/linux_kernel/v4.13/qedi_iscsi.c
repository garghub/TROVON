...
memcpy ( V_72 -> V_150 , & V_271 -> V_290 . V_291 ,
sizeof( struct V_292 ) ) ;
V_72 -> V_157 = F_68 ( V_271 -> V_293 ) ;
V_72 -> V_151 = V_152 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_28 ,
...
memcpy ( V_72 -> V_150 , & V_273 -> V_295 ,
sizeof( struct V_296 ) ) ;
V_72 -> V_157 = F_68 ( V_273 -> V_297 ) ;
V_72 -> V_151 = V_191 ;
F_10 ( & V_2 -> V_35 , V_154 ,
L_29 ,
V_72 -> V_150 , V_72 -> V_157 ) ;
...
if ( V_282 )
goto V_300;
V_282 = V_125 -> V_301 ( V_2 -> V_127 , & V_72 -> V_128 ,
...
V_278 . V_130 = V_2 -> V_309 ;
V_72 -> V_130 = V_2 -> V_309 ;
if ( V_72 -> V_151 == V_152 ) {
memcpy ( & V_278 . V_146 . V_310 , & V_72 -> V_150 ,
sizeof( struct V_292 ) ) ;
V_278 . V_311 = 4 ;
} else {
memcpy ( & V_278 . V_146 . V_312 , & V_72 -> V_150 ,
sizeof( struct V_296 ) ) ;
V_278 . V_311 = 16 ;
}
...
V_72 -> V_94 = V_326 ;
V_282 = V_125 -> V_327 ( V_2 -> V_127 , V_72 -> V_128 , V_201 ) ;
if ( V_282 ) {
F_70 ( & V_2 -> V_35 ,
L_38 , V_282 ) ;
} else {
...
V_326 ) ,
V_320 ) ;
if ( ( V_282 <= 0 ) || ( V_72 -> V_94 == V_326 ) ) {
F_70 ( & V_2 -> V_35 ,
L_39 ,
V_282 , V_320 , V_72 -> V_87 ) ;
}
}
V_325:
V_282 = V_125 -> V_315 ( V_2 -> V_127 , V_72 -> V_128 ) ;
if ( V_282 )
F_70 ( & V_2 -> V_35 ,
L_40 ,
V_282 , V_72 -> V_87 ) ;
...
V_331 = (struct V_330 * ) V_276 -> V_331 ;
if ( ! V_331 ) {
F_18 ( & V_2 -> V_35 , L_42 ) ;
return - V_93 ;
}
...
F_93 ( V_333 , V_205 ) ;
memcpy ( V_333 -> V_262 , V_276 -> V_336 , V_205 ) ;
V_333 -> V_337 = V_338 ;
if ( V_329 )
F_94 ( V_333 , F_95 ( V_339 ) , V_329 ) ;
V_253 = V_125 -> V_340 -> V_341 ( V_127 , V_333 ) ;
if ( V_253 ) {
F_18 ( & V_2 -> V_35 , L_45 ,
V_253 ) ;
F_96 ( V_333 ) ;
...
V_282 = F_77 ( V_72 -> V_305 ,
( V_72 -> V_94 ==
V_318 ) ,
V_320 ) ;
if ( ( V_282 <= 0 ) || ( V_72 -> V_94 != V_318 ) ) {
V_72 -> V_94 = V_317 ;
F_18 ( & V_2 -> V_35 ,
L_47 ,
V_72 -> V_87 , V_72 ) ;
...
static int F_99 ( struct V_9 * V_10 , struct V_277 * V_345 )
{
struct V_1 * V_2 ;
struct V_71 * V_72 ;
int V_282 = 0 ;
...
char * F_113 ( enum V_399 V_400 )
{
int V_4 ;
char * V_401 = NULL ;
for ( V_4 = 0 ; V_4 < F_114 ( V_402 ) ; V_4 ++ ) {
...
void F_115 ( struct V_71 * V_67 , struct V_405 * V_262 )
{
struct V_3 * V_3 ;
struct V_1 * V_2 ;
char V_406 [] = L_59 ;
...
void F_116 ( struct V_71 * V_67 , struct V_405 * V_262 )
{
struct V_3 * V_3 ;
if ( ! V_67 )
return;
