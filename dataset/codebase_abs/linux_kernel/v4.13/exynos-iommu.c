...
if ( V_45 ) {
struct V_99 * V_100 = V_45 -> V_101 . V_86 ;
F_67 ( & V_100 -> V_102 ) ;
if ( V_12 -> V_10 ) {
F_25 ( V_12 -> V_40 , L_13 ) ;
F_40 ( V_12 ) ;
...
static inline void F_70 ( T_3 * V_44 , T_3 V_103 )
{
F_71 ( V_104 , F_72 ( V_44 ) , sizeof( * V_44 ) ,
V_105 ) ;
* V_44 = F_73 ( V_103 ) ;
F_74 ( V_104 , F_72 ( V_44 ) , sizeof( * V_44 ) ,
V_105 ) ;
}
...
V_10 -> V_5 [ V_16 ] = V_115 ;
V_106 = F_79 ( V_104 , V_10 -> V_5 , V_116 ,
V_105 ) ;
...
if ( V_8 -> type == V_107 )
F_83 ( V_8 ) ;
F_89 ( V_104 , F_72 ( V_10 -> V_5 ) , V_116 ,
V_105 ) ;
for ( V_16 = 0 ; V_16 < V_114 ; V_16 ++ )
if ( F_30 ( V_10 -> V_5 + V_16 ) ) {
T_4 V_126 = F_6 ( V_10 -> V_5 + V_16 ) ;
F_89 ( V_104 , V_126 , V_127 ,
V_105 ) ;
F_90 ( V_128 ,
F_5 ( V_126 ) ) ;
}
...
struct V_78 * V_79 )
{
struct V_99 * V_100 = V_79 -> V_101 . V_86 ;
struct V_7 * V_10 = F_7 ( V_8 ) ;
T_4 V_129 = F_72 ( V_10 -> V_5 ) ;
struct V_11 * V_12 , * V_124 ;
unsigned long V_66 ;
if ( ! F_92 ( V_79 ) || V_100 -> V_10 != V_8 )
return;
F_67 ( & V_100 -> V_102 ) ;
...
F_71 ( V_104 , F_72 ( V_44 ) ,
sizeof( * V_44 ) * V_142 ,
V_105 ) ;
memset ( V_44 , 0 , sizeof( * V_44 ) * V_142 ) ;
F_74 ( V_104 , F_72 ( V_44 ) ,
sizeof( * V_44 ) * V_142 ,
V_105 ) ;
V_75 = V_150 ;
...
return - V_131 ;
if ( ! V_100 ) {
V_100 = F_76 ( sizeof( * V_100 ) , V_82 ) ;
if ( ! V_100 )
return - V_83 ;
F_81 ( & V_100 -> V_157 ) ;
F_141 ( & V_100 -> V_102 ) ;
V_79 -> V_101 . V_86 = V_100 ;
}
F_93 (entry, &owner->controllers, owner_node)
if ( V_144 == V_12 )
return 0 ;
F_98 ( & V_12 -> V_158 , & V_100 -> V_157 ) ;
V_12 -> V_45 = V_79 ;
...
static int T_7 F_149 ( struct V_167 * V_156 )
{
struct V_76 * V_77 ;
if ( ! V_166 )
F_143 () ;
V_77 = F_150 ( V_156 , NULL , V_164 . V_168 ) ;
if ( ! V_77 )
return - V_131 ;
if ( ! V_104 )
V_104 = & V_77 -> V_79 ;
