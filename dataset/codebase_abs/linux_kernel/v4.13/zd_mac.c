...
if ( F_72 ( ! F_73 ( V_85 -> V_90 , V_60 -> V_11 ) ) )
continue;
V_62 = F_65 ( V_44 ) ;
V_65 = V_62 -> V_70 . V_71 [ 0 ] . V_72 ;
F_13 ( 0 <= V_65 && V_65 < F_2 ( V_73 ) ) ;
...
void F_75 ( struct V_43 * V_44 , int error )
{
struct V_61 * V_62 = F_65 ( V_44 ) ;
struct V_8 * V_9 = V_62 -> V_93 [ 0 ] ;
struct V_10 * V_11 = F_4 ( V_9 ) ;
F_66 ( V_62 ) ;
F_76 ( V_44 , sizeof( struct V_94 ) ) ;
if ( F_72 ( error ||
( V_62 -> V_25 & V_95 ) ) ) {
F_67 ( V_9 , V_44 ) ;
} else {
...
static int F_79 ( T_1 * V_97 , T_1 V_98 , T_3 V_99 )
{
...
static void F_81 ( struct V_10 * V_11 , struct V_94 * V_118 ,
struct V_84 * V_119 ,
struct V_61 * V_62 )
{
V_118 -> V_120 = 0 ;
...
static bool F_83 ( struct V_10 * V_11 , struct V_43 * V_47 )
{
if ( ! V_11 -> V_47 . V_130 )
return false ;
...
{
F_13 ( F_85 ( & V_11 -> V_16 . V_132 ) ) ;
F_86 ( V_11 -> V_47 . V_130 ) ;
...
V_135 = 1 + F_90 ( & V_11 -> V_16 ) + V_139 ;
V_143 = F_91 ( V_135 * sizeof( struct V_142 ) , V_145 ) ;
if ( ! V_143 ) {
V_13 = - V_146 ;
goto V_144;
}
V_13 = F_92 ( & V_11 -> V_16 , 0 , V_147 ) ;
if ( V_13 < 0 )
goto V_19;
V_13 = F_93 ( & V_11 -> V_16 , & V_137 , V_147 ) ;
if ( V_13 < 0 )
goto V_148;
if ( V_133 && V_137 & 0x2 ) {
V_13 = - V_149 ;
...
F_95 ( V_136 != V_135 ) ;
V_13 = F_96 ( & V_11 -> V_16 , V_143 , V_135 ) ;
V_148:
V_140 = V_58 + V_150 / 2 ;
V_134 = F_92 ( & V_11 -> V_16 , 1 , V_147 ) ;
while ( V_134 < 0 ) {
if ( V_133 || F_94 ( V_140 ) ) {
V_134 = - V_151 ;
break;
...
V_47 = NULL ;
V_13 = F_92 ( & V_11 -> V_16 , 0x00000400 | ( V_139 << 19 ) ,
V_156 ) ;
V_19:
F_97 ( V_143 ) ;
V_144:
...
unsigned int V_161 ;
struct V_162 * V_163 ;
struct V_94 * V_118 = F_101 ( V_44 , sizeof( struct V_94 ) ) ;
struct V_61 * V_62 = F_65 ( V_44 ) ;
F_13 ( V_159 <= 0xffff ) ;
if ( ! F_82 ( V_158 -> V_124 ) )
V_158 -> V_164 = 0 ;
V_163 = F_102 ( V_11 -> V_9 , V_62 ) ;
V_118 -> V_165 = V_163 -> V_92 ;
if ( V_62 -> V_120 . V_71 [ 0 ] . V_25 & V_166 )
V_118 -> V_165 = V_163 -> V_167 ;
V_118 -> V_99 = F_103 ( V_159 ) ;
F_81 ( V_11 , V_118 , V_158 , V_62 ) ;
V_161 = V_159 + sizeof( struct V_94 ) + 10 ;
F_13 ( V_161 <= 0xffff ) ;
V_118 -> V_161 = F_103 ( F_90 ( & V_11 -> V_16 ) ?
V_161 - V_159 : V_161 ) ;
V_118 -> V_97 = 0 ;
V_13 = F_79 ( & V_118 -> V_97 , F_104 ( V_118 -> V_165 ) ,
F_105 ( V_118 -> V_99 ) ) ;
if ( V_13 < 0 )
return V_13 ;
V_118 -> V_168 = F_103 ( V_13 ) ;
V_118 -> V_169 = 0 ;
return 0 ;
}
...
struct V_61 * V_62 = F_65 ( V_44 ) ;
int V_13 ;
V_13 = F_100 ( V_11 , V_44 ) ;
if ( V_13 )
goto V_171;
V_62 -> V_93 [ 0 ] = V_9 ;
V_13 = F_107 ( & V_11 -> V_16 . V_36 , V_44 ) ;
if ( V_13 )
goto V_171;
return;
V_171:
...
static int F_109 ( struct V_8 * V_9 , struct V_84 * V_172 ,
struct V_173 * V_174 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_43 * V_44 ;
...
continue;
V_85 = (struct V_84 * ) V_44 -> V_89 ;
if ( F_111 ( F_73 ( V_85 -> V_175 , V_172 -> V_90 ) ) )
{
V_82 = 1 ;
break;
}
...
int F_112 ( struct V_8 * V_9 , const T_1 * V_176 , unsigned int V_177 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
struct V_173 V_174 ;
...
V_174 . V_189 = V_190 [ F_113 ( & V_11 -> V_16 ) - 1 ] . V_191 ;
V_174 . V_192 = V_193 ;
V_174 . signal = F_3 ( V_9 , V_70 -> V_194 ) ;
V_75 = F_114 ( V_176 , V_70 ) ;
...
V_176 += V_182 ;
if ( ! V_179 &&
F_109 ( V_9 , (struct V_84 * ) V_176 , & V_174 )
&& ! V_11 -> V_28 )
return 0 ;
V_180 = F_115 ( ( T_4 * ) V_176 ) ;
V_181 = F_116 ( V_180 ) ^ F_117 ( V_180 ) ;
V_44 = F_118 ( V_177 + ( V_181 ? 2 : 0 ) ) ;
if ( V_44 == NULL )
return - V_146 ;
if ( V_181 ) {
F_119 ( V_44 , 2 ) ;
}
F_120 ( V_44 , V_176 , V_177 ) ;
memcpy ( F_121 ( V_44 ) , & V_174 , sizeof( V_174 ) ) ;
F_122 ( V_9 , V_44 ) ;
return 0 ;
}
...
static int F_125 ( struct V_8 * V_9 , T_2 V_203 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
...
if ( ! F_127 ( V_42 , & V_11 -> V_25 ) )
return;
if ( ! V_11 -> V_31 || V_11 -> V_31 -> type != V_32 )
return;
while ( ! F_128 ( V_11 -> V_9 , 0 ) ) {
V_44 = F_129 ( V_11 -> V_9 , V_11 -> V_31 ) ;
if ( ! V_44 )
break;
F_106 ( V_11 -> V_9 , NULL , V_44 ) ;
}
V_47 = F_61 ( V_11 -> V_9 , V_11 -> V_31 ) ;
if ( V_47 )
...
T_3 V_210 ;
unsigned long V_25 ;
struct V_10 * V_11 = F_131 ( V_209 , struct V_10 , V_211 ) ;
F_27 ( & V_11 -> V_21 , V_25 ) ;
V_210 = F_105 ( * ( T_4 * ) ( V_11 -> V_212 + 4 ) ) ;
F_28 ( & V_11 -> V_21 , V_25 ) ;
if ( V_210 & V_213 ) {
F_126 ( V_11 ) ;
} else {
...
F_136 ( & V_34 ) ;
F_27 ( & V_11 -> V_21 , V_25 ) ;
V_11 -> V_185 = ! ! ( * V_221 & V_225 ) ;
V_11 -> V_28 = ! ! ( * V_221 & V_226 ) ;
V_11 -> V_48 = V_34 ;
F_28 ( & V_11 -> V_21 , V_25 ) ;
F_35 ( & V_11 -> V_16 , & V_34 ) ;
if ( V_220 & V_226 ) {
...
V_230 = F_139 ( V_228 -> V_236 ) ;
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_230 = V_230 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_229 & V_237 ) {
F_16 ( & V_11 -> V_21 ) ;
V_11 -> V_49 = V_228 -> V_238 ;
F_17 ( & V_11 -> V_21 ) ;
F_60 ( V_11 , V_228 -> V_238 ) ;
}
}
static T_5 F_140 ( struct V_8 * V_9 , struct V_198 * V_31 )
{
struct V_10 * V_11 = F_4 ( V_9 ) ;
return F_141 ( & V_11 -> V_16 ) ;
}
struct V_8 * F_142 ( struct V_239 * V_157 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
V_9 = F_143 ( sizeof( struct V_10 ) , & V_240 ) ;
if ( ! V_9 ) {
F_58 ( & V_157 -> V_241 , L_18 ) ;
return NULL ;
}
V_11 = F_4 ( V_9 ) ;
...
V_11 -> V_9 = V_9 ;
V_11 -> type = V_199 ;
memcpy ( V_11 -> V_242 , V_190 , sizeof( V_190 ) ) ;
memcpy ( V_11 -> V_71 , V_91 , sizeof( V_91 ) ) ;
V_11 -> V_192 . V_195 = F_2 ( V_91 ) ;
V_11 -> V_192 . V_196 = V_11 -> V_71 ;
V_11 -> V_192 . V_243 = F_2 ( V_190 ) ;
V_11 -> V_192 . V_242 = V_11 -> V_242 ;
V_9 -> V_23 -> V_244 [ V_193 ] = & V_11 -> V_192 ;
F_145 ( V_9 , V_245 ) ;
F_145 ( V_9 , V_246 ) ;
F_145 ( V_9 , V_247 ) ;
F_145 ( V_9 , V_248 ) ;
...
F_148 ( & V_11 -> V_46 ) ;
V_11 -> V_88 = 0 ;
F_149 ( & V_11 -> V_16 , V_9 , V_157 ) ;
F_150 ( V_11 ) ;
F_151 ( V_11 ) ;
F_152 ( & V_11 -> V_211 , F_130 ) ;
F_153 ( V_9 , & V_157 -> V_241 ) ;
return V_9 ;
}
static void F_154 ( struct V_208 * V_209 )
{
struct V_10 * V_11 =
F_131 ( V_209 , struct V_10 , V_47 . V_256 . V_209 ) ;
struct V_43 * V_47 ;
unsigned long V_257 ;
int V_53 , V_54 ;
if ( ! F_127 ( V_42 , & V_11 -> V_25 ) )
...
F_155 ( V_53 * 1024 / 1000 ) * 3 ;
F_17 ( & V_11 -> V_21 ) ;
if ( V_53 > 0 && F_156 ( V_257 ) ) {
F_58 ( F_6 ( V_11 ) , L_19
L_20
L_21 ,
V_53 , V_54 ) ;
...
V_258:
F_157 ( V_24 , & V_11 -> V_47 . V_256 ,
V_259 ) ;
}
static void F_151 ( struct V_10 * V_11 )
{
F_158 ( & V_11 -> V_47 . V_256 , F_154 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_159 ( & V_11 -> V_47 . V_256 ) ;
F_87 ( V_11 ) ;
}
static void F_160 ( struct V_208 * V_209 )
{
struct V_10 * V_11 =
F_131 ( V_209 , struct V_10 , V_260 . V_261 . V_209 ) ;
struct V_17 * V_16 = & V_11 -> V_16 ;
int V_262 ;
int V_13 ;
if ( ! F_127 ( V_42 , & V_11 -> V_25 ) )
...
V_263:
F_157 ( V_24 , & V_11 -> V_260 . V_261 ,
V_266 ) ;
}
static void F_150 ( struct V_10 * V_11 )
{
F_158 ( & V_11 -> V_260 . V_261 , F_160 ) ;
}
...
{
F_58 ( F_6 ( V_11 ) , L_4 ) ;
F_159 ( & V_11 -> V_260 . V_261 ) ;
F_161 ( & V_11 -> V_16 , V_267 ) ;
}
