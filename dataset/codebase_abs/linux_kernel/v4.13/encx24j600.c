...
V_223 | V_224 |
V_225 | V_226 ;
F_100 ( V_36 -> V_227 . V_220 ,
V_220 ) ;
V_36 -> V_228 . V_45 = V_7 -> V_45 ;
V_36 -> V_228 . V_171 = V_7 -> V_48 ? V_172 : V_229 ;
V_36 -> V_228 . V_230 = V_231 ;
V_36 -> V_228 . V_41 = V_7 -> V_41 ? V_42 : V_57 ;
return 0 ;
}
static int
F_101 ( struct V_9 * V_10 ,
const struct V_219 * V_36 )
{
return F_68 ( V_10 , V_36 -> V_228 . V_41 ,
V_36 -> V_228 . V_45 , V_36 -> V_228 . V_171 ) ;
}
static T_6 F_102 ( struct V_9 * V_10 )
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
return V_7 -> V_232 ;
}
static void F_103 ( struct V_9 * V_10 , T_6 V_28 )
{
struct V_6 * V_7 = F_69 ( V_10 ) ;
V_7 -> V_232 = V_28 ;
}
static int F_104 ( struct V_233 * V_188 )
{
int V_29 ;
struct V_9 * V_11 ;
struct V_6 * V_7 ;
T_1 V_234 ;
V_11 = F_105 ( sizeof( struct V_6 ) ) ;
if ( ! V_11 ) {
V_29 = - V_89 ;
goto V_235;
}
V_7 = F_69 ( V_11 ) ;
F_106 ( V_188 , V_7 ) ;
F_107 ( & V_188 -> V_10 , V_7 ) ;
F_108 ( V_11 , & V_188 -> V_10 ) ;
V_7 -> V_232 = F_109 ( V_236 , V_237 ) ;
V_7 -> V_11 = V_11 ;
V_7 -> V_48 = true ;
V_7 -> V_41 = V_42 ;
V_7 -> V_45 = V_46 ;
V_7 -> V_30 . V_188 = V_188 ;
F_110 ( & V_188 -> V_10 , & V_7 -> V_30 ) ;
...
F_112 ( & V_7 -> V_198 ) ;
F_113 ( & V_7 -> V_204 , F_89 ) ;
F_113 ( & V_7 -> V_193 , F_83 ) ;
V_7 -> V_243 = F_114 ( V_244 , & V_7 -> V_198 ,
L_65 ) ;
if ( F_115 ( V_7 -> V_243 ) ) {
V_29 = F_116 ( V_7 -> V_243 ) ;
goto V_242;
}
F_71 ( V_7 , V_11 -> V_181 ) ;
V_11 -> V_245 = & V_246 ;
...
static int F_120 ( struct V_233 * V_188 )
{
struct V_6 * V_7 = F_121 ( & V_188 -> V_10 ) ;
F_118 ( V_7 -> V_11 ) ;
F_119 ( V_7 -> V_11 ) ;
return 0 ;
}
