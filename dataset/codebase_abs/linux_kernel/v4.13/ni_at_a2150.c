...
V_18 -> V_77 ) < 0 )
return - 1 ;
if ( F_18 ( V_18 -> V_75 [ 0 ] ) == V_99 )
V_6 -> V_69 |= V_100 ;
else
V_6 -> V_69 &= ~ V_100 ;
if ( F_18 ( V_18 -> V_75 [ 2 ] ) == V_99 )
V_6 -> V_69 |= V_101 ;
else
V_6 -> V_69 &= ~ V_101 ;
F_11 ( V_4 , & V_18 -> V_95 , V_18 -> V_52 ) ;
F_9 ( V_6 -> V_69 , V_4 -> V_30 + V_102 ) ;
V_6 -> V_40 = V_18 -> V_94 * V_18 -> V_77 ;
F_4 ( V_11 -> V_38 ) ;
#define F_27 333333333
V_11 -> V_39 = F_28 ( V_13 ) * V_18 -> V_77 *
F_27 / V_18 -> V_95 ;
if ( V_11 -> V_39 > V_11 -> V_103 )
V_11 -> V_39 = V_11 -> V_103 ;
...
V_6 -> V_46 |= V_47 | V_48 ;
F_9 ( V_6 -> V_46 , V_4 -> V_30 + V_49 ) ;
F_29 ( V_4 -> V_104 , 2 , 72 , V_105 | V_106 ) ;
V_97 = 0 ;
if ( V_18 -> V_83 == V_84 &&
( V_96 & V_70 ) !=
( V_6 -> V_69 & V_70 ) ) {
...
if ( V_18 -> V_83 == V_85 ) {
V_97 |= V_109 ;
} else if ( V_18 -> V_83 == V_110 ) {
F_26 ( V_4 -> V_78 , L_6 ) ;
}
F_9 ( V_97 , V_4 -> V_30 + V_111 ) ;
if ( V_18 -> V_83 == V_84 )
...
static int F_31 ( struct V_3 * V_4 , struct V_12 * V_13 ,
...
int V_120 ;
F_9 ( 0 , V_4 -> V_30 + V_50 ) ;
if ( F_14 ( V_4 , F_17 ( V_114 -> V_121 ) , 1 ) < 0 )
return - 1 ;
V_6 -> V_69 &= ~ V_100 ;
V_6 -> V_69 &= ~ V_101 ;
F_9 ( V_6 -> V_69 , V_4 -> V_30 + V_102 ) ;
V_6 -> V_46 &= ~ V_47 & ~ V_48 ;
F_9 ( V_6 -> V_46 , V_4 -> V_30 + V_49 ) ;
F_9 ( 0 , V_4 -> V_30 + V_111 ) ;
F_9 ( 0 , V_4 -> V_30 + V_112 ) ;
for ( V_119 = 0 ; V_119 < 36 ; V_119 ++ ) {
V_120 = F_32 ( V_4 , V_13 , V_114 , F_30 , 0 ) ;
if ( V_120 )
return V_120 ;
F_2 ( V_4 -> V_30 + V_122 ) ;
}
...
if ( V_120 )
return V_120 ;
V_118 [ V_119 ] = F_2 ( V_4 -> V_30 + V_122 ) ;
V_118 [ V_119 ] ^= 0x8000 ;
}
F_9 ( 0 , V_4 -> V_30 + V_50 ) ;
return V_119 ;
...
{
struct V_5 * V_6 = V_4 -> V_7 ;
unsigned int V_125 = V_124 -> V_126 [ 1 ] ;
unsigned int V_127 = V_124 -> V_126 [ 2 ] ;
if ( V_125 > 15 || V_127 > 7 ||
! ( ( 1 << V_125 ) & 0xdef8 ) || ! ( ( 1 << V_127 ) & 0xef ) )
return;
if ( F_34 ( V_125 , F_1 , 0 , V_4 -> V_128 , V_4 ) )
return;
V_6 -> V_9 = F_35 ( V_4 , 1 , V_127 , V_127 ,
V_129 ,
V_130 ) ;
if ( ! V_6 -> V_9 ) {
F_36 ( V_125 , V_4 ) ;
...
static const struct V_53 * F_41 ( struct V_3 * V_4 )
{
int V_131 = F_42 ( F_2 ( V_4 -> V_30 + V_31 ) ) ;
if ( V_131 >= F_43 ( V_132 ) )
return NULL ;
return & V_132 [ V_131 ] ;
}
static int F_44 ( struct V_3 * V_4 , struct V_123 * V_124 )
{
const struct V_53 * V_54 ;
struct V_5 * V_6 ;
struct V_12 * V_13 ;
static const int V_133 = 2000 ;
int V_27 ;
int V_120 ;
V_6 = F_45 ( V_4 , sizeof( * V_6 ) ) ;
if ( ! V_6 )
return - V_134 ;
V_120 = F_46 ( V_4 , V_124 -> V_126 [ 0 ] , 0x1c ) ;
if ( V_120 )
return V_120 ;
V_54 = F_41 ( V_4 ) ;
if ( ! V_54 )
return - V_135 ;
V_4 -> V_55 = V_54 ;
V_4 -> V_128 = V_54 -> V_136 ;
F_33 ( V_4 , V_124 ) ;
V_4 -> V_104 = F_47 ( V_4 -> V_30 + V_137 ,
0 , V_138 , 0 ) ;
if ( ! V_4 -> V_104 )
return - V_134 ;
V_120 = F_48 ( V_4 , 1 ) ;
...
V_4 -> V_14 = V_13 ;
V_13 -> V_141 |= V_150 ;
V_13 -> V_151 = V_13 -> V_145 ;
V_13 -> V_152 = F_25 ;
V_13 -> V_153 = F_20 ;
V_13 -> V_154 = F_10 ;
}
F_9 ( V_6 -> V_46 , V_4 -> V_30 + V_49 ) ;
F_49 ( V_155 | V_156 , V_4 -> V_30 + V_102 ) ;
F_49 ( V_155 , V_4 -> V_30 + V_102 ) ;
V_6 -> V_69 = 0 ;
F_9 ( V_6 -> V_69 , V_4 -> V_30 + V_102 ) ;
for ( V_27 = 0 ; V_27 < V_133 ; V_27 ++ ) {
...
{
if ( V_4 -> V_30 )
F_9 ( V_156 | V_155 , V_4 -> V_30 + V_102 ) ;
F_39 ( V_4 ) ;
F_52 ( V_4 ) ;
}
