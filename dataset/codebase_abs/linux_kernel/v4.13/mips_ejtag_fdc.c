...
int __weak F_73 ( void )
{
return - 1 ;
}
static int F_74 ( struct V_108 * V_52 )
{
int V_38 , V_109 ;
struct V_42 * V_43 ;
struct V_1 * V_2 ;
...
V_2 = F_75 ( & V_52 -> V_52 , sizeof( * V_2 ) , V_96 ) ;
if ( ! V_2 )
return - V_98 ;
V_2 -> V_28 = V_52 -> V_28 ;
V_2 -> V_52 = & V_52 -> V_52 ;
...
F_77 ( & V_2 -> V_57 , 0 ) ;
F_78 ( & V_2 -> V_39 ) ;
V_2 -> V_5 = F_79 ( V_2 -> V_52 , V_52 -> V_111 . V_112 ,
F_80 ( & V_52 -> V_111 ) ) ;
if ( ! V_2 -> V_5 ) {
F_81 ( V_2 -> V_52 , L_3 ,
& V_52 -> V_111 ) ;
...
V_79 . V_37 = V_99 ;
F_87 ( & V_2 -> V_61 ) ;
V_2 -> V_133 = F_88 ( F_32 , V_2 , V_2 -> V_119 ) ;
if ( F_12 ( V_2 -> V_133 ) ) {
V_38 = F_18 ( V_2 -> V_133 ) ;
F_81 ( V_2 -> V_52 , L_7 , V_38 ) ;
goto V_134;
}
F_89 ( V_2 -> V_133 , V_52 -> V_28 ) ;
F_90 ( V_2 -> V_133 ) ;
V_2 -> V_63 = F_73 () ;
if ( V_2 -> V_63 >= 0 ) {
V_38 = F_91 ( V_2 -> V_52 , V_2 -> V_63 , F_48 ,
V_135 | V_136 |
V_137 | V_138 ,
V_2 -> V_119 , V_2 ) ;
if ( V_38 )
...
F_92 ( & V_2 -> V_90 , F_50 ,
( unsigned long ) V_2 ) ;
V_2 -> V_90 . V_140 = V_91 + V_92 ;
F_93 ( & V_2 -> V_90 , V_52 -> V_28 ) ;
F_94 ( V_2 -> V_52 , L_8 ) ;
}
V_38 = F_95 ( V_99 ) ;
if ( V_38 < 0 ) {
F_81 ( V_2 -> V_52 , L_9 , V_38 ) ;
goto V_141;
}
return 0 ;
V_141:
...
static int F_100 ( struct V_108 * V_52 )
{
struct V_1 * V_2 = F_101 ( V_52 ) ;
unsigned int V_59 ;
if ( V_2 -> V_63 >= 0 ) {
F_37 ( & V_2 -> V_39 ) ;
V_59 = F_3 ( V_2 , V_64 ) ;
...
F_107 ( L_11 , V_146 [ V_143 ] ) ;
return V_146 [ V_143 ++ ] ;
}
static void F_108 ( void )
{
const char * V_147 [ 1 ] = { V_148 } ;
struct V_6 V_10 ;
void T_2 * V_24 ;
unsigned int V_26 ;
V_10 = F_5 ( V_147 , & V_149 , 1 ) ;
V_149 -= V_10 . V_15 ;
for ( V_26 = 0 ; V_26 < V_149 ; ++ V_26 )
V_148 [ V_26 ] = V_148 [ V_26 + V_10 . V_15 ] ;
V_24 = F_105 () ;
if ( F_12 ( V_24 ) )
return;
while ( F_4 ( V_24 + V_33 ) & V_34 )
...
static void F_110 ( V_14 V_150 )
{
F_107 ( L_12 , V_150 ) ;
V_148 [ V_149 ++ ] = V_150 ;
if ( V_149 >= sizeof( V_148 ) )
F_108 () ;
}
