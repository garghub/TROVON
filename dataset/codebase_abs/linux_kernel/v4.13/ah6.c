...
F_40 ( V_74 , V_3 + V_77 ) ;
V_55 = F_41 ( V_59 , V_74 , 0 , V_59 -> V_5 ) ;
if ( F_42 ( V_55 < 0 ) )
goto V_86;
if ( V_62 -> V_80 . V_81 & V_82 ) {
...
F_44 ( V_15 , V_74 , V_14 , V_59 -> V_5 + V_75 ) ;
F_45 ( V_15 , 0 , F_23 , V_59 ) ;
F_27 ( V_59 ) -> V_12 = V_57 ;
V_55 = F_46 ( V_15 ) ;
if ( V_55 ) {
if ( V_55 == - V_98 )
...
static void F_47 ( struct V_54 * V_10 , int V_55 )
{
T_1 * V_70 ;
T_1 * V_14 ;
T_1 * V_101 ;
struct V_58 * V_59 = V_10 -> V_60 ;
struct V_61 * V_62 = F_48 ( V_59 ) ;
struct V_64 * V_65 = V_62 -> V_60 ;
struct V_67 * V_68 = V_67 ( V_59 ) ;
int V_102 = F_26 ( V_59 ) ;
...
V_55 = F_49 ( V_14 , V_70 , V_65 -> V_71 ) ? - V_104 : 0 ;
if ( V_55 )
goto V_79;
V_55 = V_68 -> V_48 ;
V_59 -> V_105 += V_103 ;
memcpy ( F_50 ( V_59 ) , V_101 , V_102 ) ;
F_51 ( V_59 , V_103 + V_102 ) ;
...
static int F_55 ( struct V_61 * V_62 , struct V_58 * V_59 )
{
T_1 * V_70 ;
T_1 * V_14 ;
T_1 * V_101 ;
...
int V_77 = 0 ;
struct V_7 * V_78 ;
if ( ! F_56 ( V_59 , sizeof( struct V_67 ) ) )
goto V_79;
if ( F_57 ( V_59 , V_8 ) )
goto V_79;
V_59 -> V_109 = V_110 ;
...
static int F_58 ( struct V_58 * V_59 , struct V_114 * V_18 ,
T_1 type , T_1 V_115 , int V_13 , T_2 V_116 )
{
struct V_117 * V_117 = F_59 ( V_59 -> V_118 ) ;
...
type != V_120 )
return 0 ;
V_62 = F_60 ( V_117 , V_59 -> V_121 , ( V_122 * ) & V_24 -> V_41 , V_68 -> V_91 , V_85 , V_123 ) ;
if ( ! V_62 )
return 0 ;
if ( type == V_120 )
F_61 ( V_59 , V_117 , V_59 -> V_118 -> V_124 , 0 ,
F_62 ( V_117 , NULL ) ) ;
else
F_63 ( V_59 , V_117 , V_116 , 0 , 0 , F_62 ( V_117 , NULL ) ) ;
F_64 ( V_62 ) ;
return 0 ;
}
...
if ( V_62 -> V_128 )
goto error;
V_65 = F_66 ( sizeof( * V_65 ) , V_129 ) ;
if ( ! V_65 )
return - V_83 ;
V_2 = F_67 ( V_62 -> V_127 -> V_130 , 0 , 0 ) ;
if ( F_68 ( V_2 ) )
goto error;
V_65 -> V_2 = V_2 ;
if ( F_69 ( V_2 , V_62 -> V_127 -> V_131 ,
( V_62 -> V_127 -> V_132 + 7 ) / 8 ) )
goto error;
V_126 = F_70 ( V_62 -> V_127 -> V_130 , 0 ) ;
F_71 ( ! V_126 ) ;
...
static int F_75 ( struct V_58 * V_59 , int V_55 )
{
return 0 ;
}
...
{
if ( F_81 ( & V_143 , V_85 ) < 0 )
F_72 ( L_8 , V_141 ) ;
if ( F_79 ( & V_140 , V_123 ) < 0 )
F_72 ( L_9 , V_141 ) ;
}
