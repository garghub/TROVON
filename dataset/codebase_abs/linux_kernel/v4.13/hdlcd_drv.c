...
static void F_64 ( struct V_67 * V_9 )
{
...
static int F_69 ( struct V_67 * V_9 , void * V_81 )
{
...
V_72 = F_71 ( V_8 -> V_9 . V_73 , 0 , 0 ) ;
if ( ! V_72 )
return - V_27 ;
F_72 ( & V_8 -> V_9 , & V_84 , F_69 , V_72 ) ;
F_60 ( V_72 ) ;
return F_73 ( & V_8 -> V_9 , & V_85 ,
V_84 ) ;
}
...
static int T_3 F_76 ( struct V_67 * V_9 )
{
struct V_1 * V_2 = F_65 ( V_9 ) ;
...
static int T_3 F_80 ( struct V_67 * V_9 )
{
struct V_1 * V_2 = F_65 ( V_9 ) ;
struct V_4 * V_5 = V_2 ? V_2 -> V_6 : NULL ;
if ( ! V_5 )
