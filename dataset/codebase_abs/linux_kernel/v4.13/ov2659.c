...
if ( ! V_114 )
return NULL ;
V_112 = F_40 ( F_41 ( V_114 ) ) ;
if ( F_42 ( V_112 ) ) {
V_23 = NULL ;
goto V_118;
}
V_23 = F_43 ( & V_5 -> V_16 , sizeof( * V_23 ) , V_119 ) ;
if ( ! V_23 )
goto V_118;
if ( ! V_112 -> V_120 ) {
F_12 ( & V_5 -> V_16 ,
...
V_1 = F_43 ( & V_5 -> V_16 , sizeof( * V_1 ) , V_119 ) ;
if ( ! V_1 )
return - V_124 ;
V_1 -> V_23 = V_23 ;
V_1 -> V_5 = V_5 ;
V_123 = F_47 ( & V_5 -> V_16 , L_17 ) ;
if ( F_42 ( V_123 ) )
return F_48 ( V_123 ) ;
V_1 -> V_38 = F_49 ( V_123 ) ;
if ( V_1 -> V_38 < 6000000 ||
...
V_11 = F_55 ( & V_3 -> V_137 , 1 , & V_1 -> V_86 ) ;
if ( V_11 < 0 ) {
F_56 ( & V_1 -> V_99 ) ;
return V_11 ;
}
