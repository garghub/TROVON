...
break;
if ( type == V_100 ) {
if ( V_92 == sizeof( V_101 ) )
return * ( ( T_3 * ) V_86 ) ;
}
V_86 += V_92 ;
}
F_39 ( & V_99 ) ;
return F_40 ( F_41 ( V_99 ) ) ;
}
static int F_42 ( struct V_66 * V_67 , char * V_102 ,
...
T_4 * V_106 ;
T_4 * V_2 ;
if ( ! V_67 -> V_2 -> V_5 . V_107 ) {
F_4 ( V_8 , L_16 , V_27 ) ;
return - 1 ;
}
F_26 ( V_67 -> V_75 , V_103 , V_69 ) ;
V_3 = F_43 ( V_67 -> V_2 -> V_5 . V_108 , V_103 ,
V_104 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_17 , V_27 ) ;
return V_3 ;
}
V_3 = F_15 ( & V_67 -> V_2 -> V_5 . V_107 -> V_12 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_18 , V_27 ) ;
return V_3 ;
}
V_31 = V_67 -> V_109 ? strlen ( V_67 -> V_109 ) : 0 ;
...
if ( V_31 ) {
V_31 = F_34 ( V_105 , V_67 -> V_109 , V_31 , V_69 ) ;
F_44 ( V_105 ) ;
} else {
memset ( V_105 , '\0' , 2 ) ;
}
V_3 = F_10 ( & V_67 -> V_2 -> V_5 . V_107 -> V_12 ,
( char * ) V_105 , 2 * V_31 ) ;
F_45 ( V_105 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_19 , V_27 ) ;
...
V_106 = F_7 ( 2 + ( V_31 * 2 ) , V_10 ) ;
if ( V_106 == NULL ) {
V_3 = - V_11 ;
return V_3 ;
}
V_31 = F_34 ( ( V_91 * ) V_106 , V_67 -> V_88 , V_31 ,
V_69 ) ;
V_3 =
F_10 ( & V_67 -> V_2 -> V_5 . V_107 -> V_12 ,
( char * ) V_106 , 2 * V_31 ) ;
F_45 ( V_106 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_20 ,
...
V_31 = strlen ( V_67 -> V_110 ) ;
V_2 = F_7 ( 2 + ( V_31 * 2 ) , V_10 ) ;
if ( V_2 == NULL ) {
V_3 = - V_11 ;
return V_3 ;
}
V_31 = F_34 ( ( V_91 * ) V_2 , V_67 -> V_110 , V_31 ,
V_69 ) ;
V_3 =
F_10 ( & V_67 -> V_2 -> V_5 . V_107 -> V_12 ,
( char * ) V_2 , 2 * V_31 ) ;
...
V_3 = F_13 ( & V_67 -> V_2 -> V_5 . V_107 -> V_12 ,
V_102 ) ;
if ( V_3 )
F_4 ( V_8 , L_22 , V_27 ) ;
return V_3 ;
...
static int
F_46 ( const struct V_66 * V_67 , char * V_102 )
{
int V_3 ;
struct V_111 * V_112 = (struct V_111 * )
( V_67 -> V_74 . V_36 + V_71 ) ;
unsigned int V_113 ;
V_113 = V_67 -> V_74 . V_31 - ( V_71 +
F_47 ( struct V_111 , V_114 . V_115 [ 0 ] ) ) ;
if ( ! V_67 -> V_2 -> V_5 . V_107 ) {
F_4 ( V_8 , L_16 , V_27 ) ;
return - 1 ;
}
V_3 = F_43 ( V_67 -> V_2 -> V_5 . V_108 ,
V_102 , V_116 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_23 ,
V_27 ) ;
...
if ( V_67 -> V_2 -> V_117 == V_118 )
memcpy ( V_112 -> V_114 . V_115 ,
V_67 -> V_119 -> V_76 , V_120 ) ;
else
memcpy ( V_112 -> V_114 . V_115 ,
V_67 -> V_2 -> V_76 , V_120 ) ;
V_3 = F_10 ( & V_67 -> V_2 -> V_5 . V_107 -> V_12 ,
V_112 -> V_114 . V_115 , V_113 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_8 , V_27 ) ;
return V_3 ;
}
...
if ( V_2 -> V_5 . V_107 )
return 0 ;
V_2 -> V_5 . V_108 = F_2 ( L_24 , 0 , 0 ) ;
if ( F_3 ( V_2 -> V_5 . V_108 ) ) {
F_4 ( V_8 , L_25 ) ;
V_3 = F_5 ( V_2 -> V_5 . V_108 ) ;
V_2 -> V_5 . V_108 = NULL ;
return V_3 ;
}
V_4 = sizeof( struct V_9 ) +
F_6 ( V_2 -> V_5 . V_108 ) ;
V_2 -> V_5 . V_107 = F_7 ( V_4 , V_10 ) ;
if ( ! V_2 -> V_5 . V_107 ) {
F_8 ( V_2 -> V_5 . V_108 ) ;
V_2 -> V_5 . V_108 = NULL ;
return - V_11 ;
}
V_2 -> V_5 . V_107 -> V_12 . V_13 = V_2 -> V_5 . V_108 ;
V_2 -> V_5 . V_107 -> V_12 . V_14 = 0x0 ;
return 0 ;
}
int
F_49 ( struct V_66 * V_67 , const struct V_68 * V_69 )
{
int V_3 ;
int V_121 ;
unsigned int V_122 ;
...
V_124 = F_38 ( V_67 ) ;
V_121 = V_71 + sizeof( struct V_111 ) ;
V_122 = V_67 -> V_74 . V_31 ;
V_123 = V_67 -> V_74 . V_36 ;
V_67 -> V_74 . V_36 = F_7 ( V_121 + V_122 , V_10 ) ;
if ( ! V_67 -> V_74 . V_36 ) {
V_3 = - V_11 ;
V_67 -> V_74 . V_31 = 0 ;
goto V_126;
}
V_67 -> V_74 . V_31 += V_121 ;
V_112 = (struct V_111 * )
( V_67 -> V_74 . V_36 + V_71 ) ;
V_112 -> V_127 = F_17 ( 0x00000101 ) ;
V_112 -> V_128 = 0 ;
V_112 -> time = V_124 ;
F_50 ( & V_112 -> V_129 , sizeof( V_112 -> V_129 ) ) ;
V_112 -> V_130 = 0 ;
memcpy ( V_67 -> V_74 . V_36 + V_121 , V_123 , V_122 ) ;
F_22 ( & V_67 -> V_2 -> V_64 ) ;
V_3 = F_48 ( V_67 -> V_2 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_29 , V_3 ) ;
...
return - V_11 ;
F_50 ( V_139 , V_71 ) ;
V_133 = F_52 ( L_33 , 0 , V_140 ) ;
if ( F_3 ( V_133 ) ) {
V_3 = F_5 ( V_133 ) ;
F_4 ( V_8 , L_34 ) ;
goto V_141;
}
V_3 = F_53 ( V_133 , V_67 -> V_74 . V_36 ,
V_71 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_35 ,
V_27 ) ;
...
V_138 = F_54 ( V_133 , V_10 ) ;
if ( ! V_138 ) {
V_3 = - V_11 ;
F_4 ( V_8 , L_36 ) ;
goto V_142;
}
F_55 ( & V_135 , V_139 , V_71 ) ;
F_55 ( & V_136 , V_67 -> V_119 -> V_143 , V_144 ) ;
F_56 ( V_138 , 0 , NULL , NULL ) ;
F_57 ( V_138 , & V_135 , & V_136 , V_144 , NULL ) ;
V_3 = F_58 ( V_138 ) ;
F_59 ( V_138 ) ;
if ( V_3 ) {
F_4 ( V_8 , L_37 , V_3 ) ;
...
memcpy ( V_67 -> V_74 . V_36 , V_139 , V_71 ) ;
V_67 -> V_74 . V_31 = V_71 ;
V_142:
F_60 ( V_133 ) ;
V_141:
