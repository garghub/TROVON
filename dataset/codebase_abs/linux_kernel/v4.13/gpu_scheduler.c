...
F_46 ( & V_38 -> V_45 , V_10 -> V_42 ) ;
F_57 (s_job, tmp, &sched->ring_mirror_list, node) {
...
V_48 -> V_10 = V_10 ;
V_48 -> V_33 = V_7 ;
V_48 -> V_27 = F_63 ( V_7 , V_58 ) ;
if ( ! V_48 -> V_27 )
return - V_59 ;
V_48 -> V_60 = F_64 ( & V_10 -> V_61 ) ;
F_65 ( & V_48 -> V_39 , F_43 ) ;
F_3 ( & V_48 -> V_41 ) ;
F_66 ( & V_48 -> V_45 , F_50 ) ;
return 0 ;
...
V_72 = F_81 ( & V_7 -> V_15 , & V_31 ,
sizeof( V_31 ) ) ;
F_82 ( V_72 != sizeof( V_31 ) ) ;
F_83 ( & V_10 -> V_20 ) ;
}
return 0 ;
}
...
F_17 ( & V_10 -> V_52 , 0 ) ;
F_86 ( & V_10 -> V_61 , 0 ) ;
V_10 -> V_78 = F_87 ( F_76 , V_10 , V_10 -> V_77 ) ;
if ( F_88 ( V_10 -> V_78 ) ) {
F_59 ( L_3 , V_77 ) ;
return F_89 ( V_10 -> V_78 ) ;
}
return 0 ;
}
