...
static int F_45 ( struct V_78 * V_79 , unsigned int V_80 ,
unsigned int V_32 ,
const char * * V_3 , unsigned int * V_24 ,
...
enum V_87 V_88 ;
struct V_1 * V_2 = F_46 ( V_79 , & V_88 ) ;
struct V_89 * V_89 = F_47 ( V_2 ) ;
enum V_90 V_91 = F_48 ( V_88 ) ;
union V_11 * V_92 ;
struct V_93 V_66 ;
...
V_97 = F_53 ( V_66 . V_67 . V_70 . V_71 . V_27 ) & ~ 1 ;
V_98 = F_17 ( V_97 ) ;
V_99 = F_17 ( V_97 + 1 ) ;
if ( V_94 ) {
V_101 = F_54 ( V_100 ) ;
...
if ( V_85 == NULL )
goto V_114;
F_57 ( V_85 , V_64 , F_8 ( V_2 ) , V_92 , V_81 ,
V_47 , NULL , & V_98 ) ;
V_86 = F_56 ( V_2 ) ;
if ( V_86 == NULL )
goto V_115;
F_57 ( V_86 , V_64 , F_8 ( V_2 ) , V_92 , V_81 ,
V_47 , NULL , & V_99 ) ;
V_101 = F_54 ( V_100 ) ;
...
unsigned int V_119 ;
for ( V_119 = 0 ; V_119 < F_61 ( V_120 ) ; V_119 ++ ) {
V_118 = & V_120 [ V_119 ] ;
if ( V_26 < V_118 -> V_6 ||
...
static int F_62 ( struct V_78 * V_79 , unsigned int V_80 ,
unsigned int V_32 ,
const char * * V_3 , unsigned int * V_24 ,
unsigned int V_121 )
{
...
enum V_87 V_88 ;
struct V_1 * V_2 = F_46 ( V_79 , & V_88 ) ;
struct V_134 * V_135 = F_65 ( V_2 ) ;
if ( ( V_133 >= 100 && V_133 <= 199 ) ||
( V_133 >= 200 && V_133 <= 299 ) )
return F_62 ( V_79 , V_80 , V_32 , V_3 , V_24 , V_121 ) ;
...
unsigned int V_15 ;
F_43 ( V_2 , true ) ;
V_15 = F_62 ( V_79 , V_80 , V_32 , V_3 , V_24 , V_121 ) ;
if ( V_15 == V_105 )
V_135 -> V_136 = V_121 ;
return V_15 ;
}
...
V_150 = V_25 + V_26 + 1 ;
for ( V_119 = 0 ; V_119 < F_61 ( V_152 ) ; V_119 ++ ) {
...
static int F_74 ( struct V_78 * V_79 , struct V_1 * V_2 ,
...
V_15 = F_72 ( V_79 , V_80 , V_32 , V_3 , V_24 ) ;
...
V_88 != V_169 )
return V_105 ;
V_162 = F_76 ( V_79 , V_80 , sizeof( V_163 ) , & V_163 ) ;
if ( V_162 == NULL )
return V_105 ;
V_32 = V_80 + V_162 -> V_170 * 4 ;
if ( V_32 >= V_79 -> V_6 )
return V_105 ;
F_77 ( V_2 , V_79 , V_142 * V_74 ) ;
if ( F_78 ( F_79 ( V_79 ) ) )
return V_96 ;
V_3 = V_79 -> V_171 + V_32 ;
V_24 = V_79 -> V_6 - V_32 ;
...
static int F_80 ( struct V_78 * V_79 , unsigned int V_80 ,
struct V_1 * V_2 , enum V_87 V_88 )
{
unsigned int V_32 , V_24 ;
const char * V_3 ;
...
if ( V_24 < strlen ( L_17 ) )
return V_105 ;
return F_74 ( V_79 , V_2 , V_80 , V_32 , & V_3 , & V_24 ) ;
}
