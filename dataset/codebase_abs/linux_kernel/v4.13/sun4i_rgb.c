...
int F_28 ( struct V_41 * V_42 , struct V_7 * V_8 )
{
struct V_4 * V_5 ;
struct V_43 * V_44 ;
struct V_1 * V_6 ;
int V_45 ;
V_6 = F_29 ( V_42 -> V_46 , sizeof( * V_6 ) , V_47 ) ;
if ( ! V_6 )
return - V_48 ;
V_6 -> V_8 = V_8 ;
V_5 = & V_6 -> V_5 ;
V_45 = F_30 ( V_8 -> V_46 -> V_49 , 1 , 0 ,
& V_8 -> V_9 , & V_44 ) ;
if ( V_45 ) {
F_31 ( V_42 -> V_46 , L_7 ) ;
return 0 ;
...
V_6 -> V_5 . V_54 = F_35 ( F_36 ( & V_8 -> V_55 -> V_55 ) ) ;
if ( V_8 -> V_9 ) {
F_37 ( & V_6 -> V_3 ,
& V_56 ) ;
V_45 = F_38 ( V_42 , & V_6 -> V_3 ,
& V_57 ,
V_58 ) ;
if ( V_45 ) {
F_34 ( V_42 -> V_46 , L_9 ) ;
