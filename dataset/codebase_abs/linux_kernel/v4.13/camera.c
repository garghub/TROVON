...
if ( V_125 > 1024 )
return - V_81 ;
V_155 = F_34 ( V_125 + 1 , V_16 ) ;
if ( ! V_155 )
return - V_17 ;
if ( F_64 ( V_155 , V_134 , V_125 ) ) {
V_15 = - V_156 ;
goto V_82;
}
V_155 [ V_125 ] = '\0' ;
V_15 = V_115 -> V_154 ( V_24 , V_155 , V_125 ) ;
V_82:
F_35 ( V_155 ) ;
return V_15 ;
}
static int F_65 ( struct V_157 * V_157 , struct V_148 * V_148 )
{
unsigned int V_3 ;
for ( V_3 = 0 ; V_3 < F_2 ( V_158 ) ; ++ V_3 ) {
const struct V_150 * V_159 =
& V_158 [ V_3 ] ;
if ( ! strcmp ( V_148 -> V_160 . V_161 -> V_162 , V_159 -> V_21 ) ) {
V_148 -> V_151 = ( void * ) V_159 ;
break;
}
}
return 0 ;
...
char V_163 [ 27 ] ;
unsigned int V_3 ;
snprintf ( V_163 , 27 , L_23 , V_7 -> V_52 -> V_53 ,
V_24 -> V_61 -> V_164 ) ;
V_24 -> V_137 . V_165 = F_67 ( V_163 , F_68 () ) ;
if ( F_19 ( V_24 -> V_137 . V_165 ) ) {
F_9 ( V_24 , L_24 ,
F_20 ( V_24 -> V_137 . V_165 ) ) ;
return F_20 ( V_24 -> V_137 . V_165 ) ;
}
...
V_161 = F_70 ( V_159 -> V_21 , V_159 -> V_153 ,
V_24 -> V_137 . V_165 , V_24 ,
& V_167 ) ;
if ( F_19 ( V_161 ) ) {
F_9 ( V_24 ,
L_25 ,
V_159 -> V_21 , F_20 ( V_161 ) ) ;
return F_20 ( V_161 ) ;
}
}
return 0 ;
...
{
struct V_170 * V_171 =
F_76 ( V_169 , struct V_170 , V_172 ) ;
F_35 ( V_171 -> V_123 ) ;
}
static int F_77 ( struct V_173 * V_61 ,
const struct V_174 * V_164 )
{
struct V_6 * V_59 ;
struct V_23 * V_24 ;
T_1 V_175 = 0 ;
...
if ( V_61 -> V_176 != 2 )
return - V_177 ;
for ( V_3 = 0 ; V_3 < V_61 -> V_176 ; ++ V_3 ) {
struct V_178 * V_179 = & V_61 -> V_180 [ V_3 ] ;
switch ( V_179 -> V_181 ) {
case V_182 :
V_175 = F_11 ( V_179 -> V_164 ) ;
break;
case V_183 :
V_62 = F_11 ( V_179 -> V_164 ) ;
break;
default:
return - V_177 ;
}
...
if ( V_15 < 0 )
goto error;
V_24 -> V_184 . V_123 = V_24 ;
V_24 -> V_184 . V_185 = & V_186 ;
V_24 -> V_184 . V_53 = V_24 -> V_7 -> V_52 -> V_53 ;
V_24 -> V_184 . V_187 = F_75 ;
V_15 = F_81 ( & V_24 -> V_184 ) ;
if ( V_15 < 0 )
goto error;
F_82 ( V_61 , V_24 ) ;
F_32 ( V_24 -> V_61 ) ;
...
static void F_83 ( struct V_173 * V_61 )
{
...
static int F_86 ( struct V_188 * V_20 )
{
struct V_173 * V_61 = F_87 ( V_20 ) ;
struct V_23 * V_24 = F_84 ( V_61 ) ;
if ( V_24 -> V_65 )
F_25 ( V_24 -> V_65 ) ;
F_25 ( V_24 -> V_7 ) ;
...
static int F_88 ( struct V_188 * V_20 )
{
struct V_173 * V_61 = F_87 ( V_20 ) ;
struct V_23 * V_24 = F_84 ( V_61 ) ;
int V_15 ;
