...
static struct V_19 * F_101 ( struct V_15 * V_16 )
{
struct V_19 * V_20 = F_102 ( - V_31 ) ;
if ( ! F_103 ( & V_16 -> V_129 , 1 , V_16 -> V_141 ) )
goto V_8;
F_6 ( & V_16 -> V_140 ) ;
V_20 = F_104 ( sizeof( struct V_19 ) , V_142 ) ;
F_2 ( & V_16 -> V_140 ) ;
if ( V_20 != NULL )
goto V_8;
F_105 ( & V_16 -> V_129 ) ;
...
struct V_15 * F_119 ( struct V_147 * V_147 , T_3 V_148 ,
unsigned int V_149 ,
unsigned int V_150 )
{
struct V_15 * V_16 ;
struct V_19 * V_20 ;
int V_151 ;
V_16 = F_104 ( V_148 , V_152 ) ;
if ( V_16 == NULL )
goto V_8;
F_120 ( V_16 , V_147 ) ;
for ( V_151 = 0 ; V_151 < V_149 ; V_151 ++ ) {
V_20 = F_104 ( sizeof( struct V_19 ) , V_152 ) ;
if ( ! V_20 )
goto V_153;
F_116 ( & V_20 -> V_117 , & V_16 -> free ) ;
}
...
static void F_120 ( struct V_15 * V_16 , struct V_147 * V_147 )
{
F_137 ( & V_16 -> V_170 ) ;
F_138 ( & V_16 -> V_40 ) ;
F_138 ( & V_16 -> V_140 ) ;
...
F_146 ( & V_16 -> V_57 ) ;
if ( strlen ( args -> V_106 ) > V_183 ) {
F_147 ( V_16 ) ;
return F_102 ( - V_184 ) ;
}
V_16 -> V_106 = F_148 ( args -> V_106 , V_152 ) ;
if ( V_16 -> V_106 == NULL ) {
F_147 ( V_16 ) ;
return F_102 ( - V_143 ) ;
}
...
static void F_155 ( struct V_170 * V_170 )
{
F_147 ( F_57 ( V_170 , struct V_15 , V_170 ) ) ;
}
struct V_15 * F_156 ( struct V_15 * V_16 )
{
if ( V_16 != NULL && F_157 ( & V_16 -> V_170 ) )
return V_16 ;
return NULL ;
}
