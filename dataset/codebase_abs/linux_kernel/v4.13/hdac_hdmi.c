...
struct V_207 * * V_248 ,
struct V_2 * V_3 , int V_249 )
{
struct V_207 * V_250 ;
struct V_4 * V_5 ;
char V_131 [ V_188 ] , V_251 [ V_188 ] ;
int V_43 = 0 ;
T_5 V_118 , V_252 ;
unsigned int V_253 = 384000 , V_254 = 8000 ;
T_3 V_41 ;
int V_63 ;
V_250 = F_76 ( & V_16 -> V_17 ,
( sizeof( * V_250 ) * V_249 ) ,
V_132 ) ;
if ( ! V_250 )
return - V_133 ;
...
if ( V_63 )
return V_63 ;
sprintf ( V_251 , L_23 , V_43 + 1 ) ;
V_250 [ V_43 ] . V_131 = F_58 ( & V_16 -> V_17 ,
V_251 , V_132 ) ;
if ( ! V_250 [ V_43 ] . V_131 )
return - V_133 ;
snprintf ( V_131 , sizeof( V_131 ) , L_24 , V_43 + 1 ) ;
V_250 [ V_43 ] . V_104 . V_214 =
F_58 ( & V_16 -> V_17 , V_131 , V_132 ) ;
if ( ! V_250 [ V_43 ] . V_104 . V_214 )
return - V_133 ;
V_250 [ V_43 ] . V_104 . V_41 = V_41 ;
V_250 [ V_43 ] . V_104 . V_118 = V_118 ;
V_250 [ V_43 ] . V_104 . V_253 = V_253 ;
V_250 [ V_43 ] . V_104 . V_254 = V_254 ;
V_250 [ V_43 ] . V_104 . V_116 = 2 ;
V_250 [ V_43 ] . V_104 . V_117 = 2 ;
V_250 [ V_43 ] . V_104 . V_105 = V_252 ;
V_250 [ V_43 ] . V_71 = & V_255 ;
V_43 ++ ;
}
* V_248 = V_250 ;
return 0 ;
...
F_96 ( V_16 ) ;
F_97 ( V_16 ) ;
V_256 = F_100 ( V_16 , V_16 -> V_257 , & V_21 ) ;
if ( ! V_21 || V_256 <= 0 ) {
F_44 ( & V_16 -> V_17 , L_25 ) ;
return - V_107 ;
}
V_16 -> V_256 = V_256 ;
V_16 -> V_258 = V_21 ;
for ( V_43 = 0 ; V_43 < V_16 -> V_256 ; V_43 ++ , V_21 ++ ) {
unsigned int V_22 ;
unsigned int type ;
V_22 = F_10 ( V_16 , V_21 ) ;
type = F_11 ( V_22 ) ;
...
return - V_31 ;
V_63 = F_98 ( V_16 , V_248 , V_3 , V_3 -> V_192 ) ;
if ( V_63 ) {
F_35 ( & V_16 -> V_17 , L_26 ,
V_63 ) ;
return V_63 ;
...
static void F_101 ( void * V_261 , int V_8 , int V_262 )
{
struct V_10 * V_11 = V_261 ;
struct V_2 * V_3 = V_11 -> V_61 ;
struct V_58 * V_12 = NULL ;
struct V_7 * V_263 = NULL ;
struct V_264 * V_265 = V_11 -> V_266 ;
int V_43 ;
T_1 V_48 = V_8 + 0x04 ;
F_6 ( & V_11 -> V_16 . V_17 , L_27 , V_93 ,
V_48 , V_262 ) ;
if ( F_102 ( V_265 -> V_209 . V_221 -> V_267 ) !=
V_268 )
return;
if ( F_103 ( & V_11 -> V_16 . V_269 ) )
return;
F_2 (pin, &hdmi->pin_list, head) {
if ( V_12 -> V_21 != V_48 )
continue;
...
V_12 -> V_30 = true ;
if ( V_12 -> V_215 [ V_43 ] . V_32 == V_262 ) {
V_263 = & V_12 -> V_215 [ V_43 ] ;
break;
}
}
}
...
static struct V_270 * F_104 ( struct V_271 * V_221 ,
int V_35 )
{
struct V_272 * V_273 ;
F_2 (rtd, &card->rtd_list, list) {
if ( V_273 -> V_6 && ( V_273 -> V_6 -> V_35 == V_35 ) )
return V_273 -> V_6 ;
}
return NULL ;
}
static int F_105 ( struct V_271 * V_221 ,
struct V_10 * V_11 )
{
struct V_58 * V_12 ;
struct V_126 * V_153 ;
char V_187 [ V_188 ] , V_274 [ V_188 ] ;
char * V_131 ;
int V_43 = 0 , V_206 ;
struct V_264 * V_265 = V_11 -> V_266 ;
struct V_2 * V_3 = V_11 -> V_61 ;
V_153 = F_106 ( V_265 -> V_17 , V_3 -> V_29 ,
sizeof( * V_153 ) , V_132 ) ;
if ( ! V_153 )
return - V_133 ;
F_2 (pin, &hdmi->pin_list, head) {
for ( V_206 = 0 ; V_206 < V_12 -> V_29 ; V_206 ++ ) {
snprintf ( V_274 , sizeof( V_274 ) , L_28 ,
V_12 -> V_21 , V_12 -> V_215 [ V_206 ] . V_32 ) ;
V_131 = F_58 ( V_265 -> V_17 , V_274 , V_132 ) ;
if ( ! V_131 )
return - V_133 ;
snprintf ( V_187 , sizeof( V_187 ) , L_29 , V_274 ) ;
V_153 [ V_43 ] . V_131 = F_58 ( V_265 -> V_17 , V_187 ,
V_132 ) ;
if ( ! V_153 [ V_43 ] . V_131 )
return - V_133 ;
...
V_153 [ V_43 ] . V_195 = 0 ;
V_153 [ V_43 ] . V_67 = V_275 ;
V_153 [ V_43 ] . V_197 = V_276 ;
V_153 [ V_43 ] . V_198 = V_277 ;
V_43 ++ ;
}
}
return F_107 ( V_221 , V_153 , V_43 ) ;
}
int F_108 ( struct V_264 * V_265 ,
struct V_176 * V_13 )
{
struct V_10 * V_11 = F_109 ( V_265 ) ;
struct V_2 * V_3 = V_11 -> V_61 ;
struct V_58 * V_12 ;
struct V_120 * V_203 ;
struct V_140 * V_141 ;
...
F_2 (pin, &hdmi->pin_list, head) {
for ( V_206 = 0 ; V_206 < V_12 -> V_29 ; V_206 ++ ) {
snprintf ( V_278 , sizeof( V_278 ) , L_28 ,
V_12 -> V_21 , V_12 -> V_215 [ V_206 ] . V_32 ) ;
V_63 = F_56 ( V_13 -> V_17 , & V_203 [ V_43 ] ,
V_279 , NULL ,
V_278 , NULL , NULL , 0 , NULL , 0 ) ;
if ( V_63 < 0 )
return V_63 ;
...
F_111 ( & V_6 -> V_112 ) ;
F_112 ( & V_6 -> V_111 ) ;
V_270 = F_104 ( V_86 -> V_209 -> V_221 , V_35 ) ;
if ( V_270 ) {
V_114 = F_113 ( V_270 , V_35 , & V_3 -> V_70 ) ;
if ( V_114 < 0 ) {
F_35 ( & V_11 -> V_16 . V_17 ,
L_30 ,
V_114 , V_35 ) ;
...
F_74 ( & V_6 -> V_183 , & V_3 -> V_281 ) ;
return 0 ;
}
static void F_115 ( struct V_10 * V_11 ,
struct V_2 * V_3 , bool V_282 )
{
int V_43 ;
struct V_58 * V_12 ;
F_2 (pin, &hdmi->pin_list, head) {
...
static int F_116 ( struct V_264 * V_265 )
{
struct V_10 * V_11 = F_109 ( V_265 ) ;
struct V_2 * V_3 = V_11 -> V_61 ;
struct V_176 * V_13 =
...
int V_63 ;
V_11 -> V_266 = V_265 ;
V_284 = F_118 ( V_11 -> V_285 , F_119 ( & V_11 -> V_16 . V_17 ) ) ;
if ( ! V_284 ) {
F_35 ( & V_11 -> V_16 . V_17 , L_31 ) ;
return - V_31 ;
}
F_120 ( V_11 -> V_285 , V_284 ) ;
V_63 = F_80 ( V_13 ) ;
if ( V_63 < 0 )
return V_63 ;
V_286 . V_287 = V_11 ;
...
F_115 ( V_11 , V_3 , true ) ;
V_11 -> V_221 = V_13 -> V_221 -> V_267 ;
F_122 ( & V_11 -> V_16 . V_17 ) ;
F_123 ( & V_11 -> V_16 . V_17 ) ;
F_124 ( & V_11 -> V_16 . V_17 ) ;
return 0 ;
}
static int F_125 ( struct V_264 * V_265 )
{
struct V_10 * V_11 = F_109 ( V_265 ) ;
...
{
struct V_36 * V_265 = & V_11 -> V_16 ;
struct V_2 * V_289 ;
struct V_207 * V_250 = NULL ;
struct V_283 * V_284 = NULL ;
int V_249 = 0 ;
int V_63 = 0 ;
V_284 = F_118 ( V_11 -> V_285 , F_119 ( & V_11 -> V_16 . V_17 ) ) ;
...
F_120 ( V_11 -> V_285 , V_284 ) ;
V_289 = F_76 ( & V_265 -> V_17 , sizeof( * V_289 ) , V_132 ) ;
if ( V_289 == NULL )
return - V_133 ;
V_11 -> V_61 = V_289 ;
F_138 ( V_265 , & V_289 -> V_70 ) ;
V_289 -> V_70 . V_71 . V_290 = F_131 ;
V_289 -> V_70 . V_71 . V_291 = F_133 ;
V_289 -> V_70 . V_71 . V_292 = F_134 ;
V_289 -> V_70 . V_71 . V_293 = F_135 ;
F_139 ( & V_265 -> V_17 , V_11 ) ;
F_112 ( & V_289 -> V_212 ) ;
F_112 ( & V_289 -> V_211 ) ;
F_112 ( & V_289 -> V_281 ) ;
F_111 ( & V_289 -> V_182 ) ;
V_63 = F_140 ( V_11 -> V_16 . V_294 , true ) ;
if ( V_63 < 0 ) {
F_35 ( & V_11 -> V_16 . V_17 ,
L_33 ,
V_63 ) ;
...
V_63 = F_99 ( V_11 , & V_250 , & V_249 ) ;
if ( V_63 < 0 ) {
F_35 ( & V_265 -> V_17 ,
L_34 , V_63 ) ;
return V_63 ;
}
V_63 = F_141 ( & V_265 -> V_17 , & V_295 ,
V_250 , V_249 ) ;
F_142 ( V_11 -> V_285 , V_284 ) ;
return V_63 ;
}
static int F_143 ( struct V_10 * V_11 )
{
struct V_2 * V_3 = V_11 -> V_61 ;
struct V_58 * V_12 , * V_296 ;
struct V_4 * V_5 , * V_297 ;
struct V_1 * V_6 , * V_298 ;
struct V_7 * V_8 , * V_299 ;
int V_43 ;
...
struct V_10 * V_11 = F_18 ( V_17 ) ;
struct V_36 * V_16 = & V_11 -> V_16 ;
struct V_300 * V_294 = V_16 -> V_294 ;
struct V_301 * V_285 = F_146 ( V_294 ) ;
struct V_283 * V_284 = NULL ;
int V_114 ;
F_6 ( V_17 , L_35 , V_93 ) ;
if ( ! V_294 )
...
F_14 ( V_16 , V_16 -> V_257 , 0 , V_150 ,
V_161 ) ;
V_114 = F_140 ( V_294 , false ) ;
if ( V_114 < 0 ) {
F_35 ( V_294 -> V_17 , L_36 ) ;
return V_114 ;
}
V_284 = F_118 ( V_285 , F_119 ( V_17 ) ) ;
if ( ! V_284 ) {
F_35 ( V_17 , L_31 ) ;
return - V_31 ;
}
