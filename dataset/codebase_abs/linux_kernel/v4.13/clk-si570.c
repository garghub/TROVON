...
T_4 V_55 , V_56 , V_57 ;
int V_6 ;
enum V_58 V_59 = V_52 -> V_60 ;
V_2 = F_22 ( & V_45 -> V_40 , sizeof( * V_2 ) , V_61 ) ;
if ( ! V_2 )
return - V_62 ;
V_54 . V_63 = & V_64 ;
V_54 . V_65 = 0 ;
...
if ( F_24 ( V_45 -> V_40 . V_68 , L_6 ,
& V_54 . V_71 ) )
V_54 . V_71 = V_45 -> V_40 . V_68 -> V_71 ;
V_6 = F_23 ( V_45 -> V_40 . V_68 , L_7 ,
& V_56 ) ;
if ( V_6 ) {
F_13 ( & V_45 -> V_40 , L_8 ) ;
return V_6 ;
}
V_2 -> V_9 = F_25 ( V_45 , & V_72 ) ;
if ( F_26 ( V_2 -> V_9 ) ) {
F_13 ( & V_45 -> V_40 , L_9 ) ;
return F_27 ( V_2 -> V_9 ) ;
}
...
if ( V_6 )
return V_6 ;
V_6 = F_29 ( & V_45 -> V_40 , & V_2 -> V_36 ) ;
if ( V_6 ) {
F_13 ( & V_45 -> V_40 , L_10 ) ;
return V_6 ;
}
V_6 = F_30 ( V_45 -> V_40 . V_68 , V_73 ,
& V_2 -> V_36 ) ;
if ( V_6 ) {
F_13 ( & V_45 -> V_40 , L_11 ) ;
return V_6 ;
}
if ( ! F_23 ( V_45 -> V_40 . V_68 , L_12 ,
& V_55 ) ) {
V_6 = F_31 ( V_2 -> V_36 . V_74 , V_55 ) ;
if ( V_6 ) {
F_32 ( V_45 -> V_40 . V_68 ) ;
return V_6 ;
}
