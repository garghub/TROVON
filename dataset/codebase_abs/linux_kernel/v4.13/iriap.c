...
V_2 -> V_36 = V_37 ;
F_22 ( & V_2 -> V_4 ) ;
F_23 ( V_11 , ( V_38 * ) V_2 , ( long ) V_2 , NULL ) ;
F_24 ( V_2 , V_39 ) ;
F_25 ( V_2 , V_40 ) ;
F_26 ( V_2 , V_41 ) ;
F_27 ( V_2 , V_42 ) ;
...
F_28 (self->magic == IAS_MAGIC, return;) ;
F_29 ( & V_2 -> V_4 ) ;
if ( V_2 -> V_43 )
F_30 ( V_2 -> V_43 ) ;
V_2 -> V_32 = 0 ;
...
int V_67 , V_68 , V_69 ;
T_2 * V_70 ;
F_28 (self != NULL, return -1;) ;
F_28 (self->magic == IAS_MAGIC, return -1;) ;
if ( ! V_65 )
return - 1 ;
V_2 -> V_65 = V_65 ;
V_2 -> V_64 = V_64 ;
...
F_28 (self != NULL, return;) ;
F_28 (self->magic == IAS_MAGIC, return;) ;
F_28 (value != NULL, return;) ;
F_28 (value->len <= 1024 , return;) ;
V_85 = 0 ;
...
V_85 = 1 ;
V_67 = V_84 [ V_85 ++ ] ;
F_28 (name_len < IAS_MAX_CLASSNAME + 1 , return;) ;
memcpy ( V_56 , V_84 + V_85 , V_67 ) ; V_85 += V_67 ;
V_56 [ V_67 ] = '\0' ;
V_68 = V_84 [ V_85 ++ ] ;
F_28 (attr_len < IAS_MAX_ATTRIBNAME + 1 , return;) ;
...
V_2 = V_55 ;
F_28 (skb != NULL, return;) ;
F_28 (self != NULL, goto out;) ;
F_28 (self->magic == IAS_MAGIC, goto out;) ;
...
struct V_98 * V_99 ;
F_28 (obj->magic == IAS_OBJECT_MAGIC, return -EINVAL;) ;
F_81 ( V_121 , L_42 ,
V_7 -> V_56 , V_7 -> V_104 ) ;
F_82 ( & V_7 -> V_124 -> V_16 ) ;
...
F_28 (attrib->magic == IAS_ATTRIB_MAGIC,
goto outloop; ) ;
F_81 ( V_121 , L_43 ,
V_99 -> V_56 ) ;
F_81 ( V_121 , L_44 ,
...
{
F_28 ( irias_objects != NULL, return -EINVAL;) ;
