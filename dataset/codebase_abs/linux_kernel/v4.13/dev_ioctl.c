...
void F_24 ( struct V_1 * V_1 , const char * V_125 )
{
struct V_16 * V_17 ;
int V_126 ;
F_25 () ;
...
V_126 = ! V_17 ;
if ( V_126 && F_27 ( V_127 ) )
V_126 = F_28 ( L_1 , V_125 ) ;
if ( V_126 && F_27 ( V_128 ) )
F_28 ( L_2 , V_125 ) ;
}
int F_29 ( struct V_1 * V_1 , unsigned int V_25 , void T_1 * V_3 )
{
struct V_2 V_4 ;
int V_129 ;
char * V_130 ;
if ( V_25 == V_131 ) {
F_30 () ;
V_129 = F_6 ( V_1 , ( char T_1 * ) V_3 ) ;
F_31 () ;
return V_129 ;
}
if ( V_25 == V_132 )
return F_1 ( V_1 , (struct V_2 T_1 * ) V_3 ) ;
if ( V_25 >= V_133 && V_25 <= V_134 ) {
struct V_135 V_136 ;
if ( F_2 ( & V_136 , V_3 , sizeof( V_136 ) ) )
return - V_5 ;
V_136 . V_6 [ sizeof( V_136 . V_6 ) - 1 ] = 0 ;
return F_32 ( V_1 , & V_136 , V_25 , V_3 ) ;
}
if ( F_2 ( & V_4 , V_3 , sizeof( struct V_2 ) ) )
return - V_5 ;
V_4 . V_6 [ V_7 - 1 ] = 0 ;
V_130 = strchr ( V_4 . V_6 , ':' ) ;
if ( V_130 )
* V_130 = 0 ;
switch ( V_25 ) {
case V_28 :
...
case V_118 :
case V_107 :
if ( ! F_34 ( V_1 -> V_138 , V_127 ) )
return - V_139 ;
F_24 ( V_1 , V_4 . V_6 ) ;
F_30 () ;
V_129 = F_14 ( V_1 , & V_4 , V_25 ) ;
F_31 () ;
if ( ! V_129 ) {
if ( V_130 )
* V_130 = ':' ;
