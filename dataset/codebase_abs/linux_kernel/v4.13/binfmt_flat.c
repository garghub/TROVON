...
T_5 V_68 , V_95 , V_96 , V_97 , V_98 , V_99 ;
...
V_14 = V_68 + V_95 + V_102 + V_70 * sizeof( T_5 ) ;
V_14 = F_42 ( V_14 ) ;
...
continue;
V_64 = F_50 ( V_146 ) ;
V_104 = ( T_5 T_1 * ) F_17 ( V_64 , V_88 , V_65 , 1 ) ;
if ( V_104 == ( T_5 T_1 * ) V_76 ) {
V_33 = - V_44 ;
goto V_116;
}
V_33 = F_51 ( V_104 , V_146 , V_99 ,
& V_64 , & V_145 ) ;
if ( F_12 ( V_33 ) )
goto V_116;
if ( V_64 != 0 ) {
