...
int F_170 ( struct V_224 * V_95 , T_1 V_278 , T_1 V_279 , int V_280 )
{
struct V_227 * V_228 = F_153 ( V_95 ) ;
struct V_225 * V_26 ;
struct V_235 * V_246 ;
...
int F_175 ( struct V_1 * V_2 , T_1 V_283 , T_1 V_284 , V_84 V_285 )
{
struct V_7 * V_8 ;
struct V_7 T_3 * * V_181 ;
struct V_27 * V_28 ;
...
if ( V_181 ) {
T_2 V_182 = F_105 ( ( V_179 T_2 ) V_283 , V_180 ) ;
...
static inline struct V_7 * F_176 ( struct V_286 * V_287 )
{
struct V_59 * V_59 = F_177 ( V_287 ) ;
struct V_7 * V_8 = NULL ;
struct V_288 * V_289 = F_178 ( V_287 ) ;
V_289 -> V_2 = NULL ;
F_179 (net, state->dev) {
struct V_1 * V_2 ;
V_2 = F_84 ( V_289 -> V_50 ) ;
...
static struct V_7 * F_180 ( struct V_286 * V_287 , struct V_7 * V_8 )
{
struct V_288 * V_289 = F_178 ( V_287 ) ;
V_8 = F_171 ( V_8 -> V_188 ) ;
while ( ! V_8 ) {
V_289 -> V_50 = F_181 ( V_289 -> V_50 ) ;
if ( ! V_289 -> V_50 ) {
V_289 -> V_2 = NULL ;
break;
}
V_289 -> V_2 = F_84 ( V_289 -> V_50 ) ;
if ( ! V_289 -> V_2 )
continue;
V_8 = F_171 ( V_289 -> V_2 -> V_189 ) ;
}
return V_8 ;
}
static struct V_7 * F_182 ( struct V_286 * V_287 , T_6 V_290 )
{
struct V_7 * V_8 = F_176 ( V_287 ) ;
if ( V_8 )
while ( V_290 && ( V_8 = F_180 ( V_287 , V_8 ) ) != NULL )
-- V_290 ;
return V_290 ? NULL : V_8 ;
}
static void * F_183 ( struct V_286 * V_287 , T_6 * V_290 )
__acquires( V_11 )
{
F_58 () ;
return * V_290 ? F_182 ( V_287 , * V_290 - 1 ) : V_291 ;
}
static void * F_184 ( struct V_286 * V_287 , void * V_292 , T_6 * V_290 )
{
struct V_7 * V_8 ;
if ( V_292 == V_291 )
V_8 = F_176 ( V_287 ) ;
else
V_8 = F_180 ( V_287 , V_292 ) ;
++ * V_290 ;
return V_8 ;
}
static void F_185 ( struct V_286 * V_287 , void * V_292 )
__releases( V_11 )
{
struct V_288 * V_289 = F_178 ( V_287 ) ;
V_289 -> V_2 = NULL ;
...
static int F_186 ( struct V_286 * V_287 , void * V_292 )
{
if ( V_292 == V_291 )
F_187 ( V_287 ,
L_1 ) ;
else {
struct V_7 * V_8 = (struct V_7 * ) V_292 ;
struct V_288 * V_289 = F_178 ( V_287 ) ;
char * V_293 ;
long V_212 ;
#ifdef F_102
V_293 = F_2 ( V_289 -> V_2 ) ? L_2 :
F_3 ( V_289 -> V_2 ) ? L_3 :
L_4 ;
#else
V_293 = L_5 ;
#endif
if ( F_188 ( V_289 -> V_2 -> V_189 ) == V_8 ) {
F_189 ( V_287 , L_6 ,
V_289 -> V_50 -> V_72 , V_289 -> V_50 -> V_294 , V_289 -> V_2 -> V_184 , V_293 ) ;
}
...
static int F_191 ( struct V_295 * V_295 , struct V_296 * V_296 )
{
return F_192 ( V_295 , V_296 , & V_297 ,
sizeof( struct V_288 ) ) ;
}
static inline struct V_27 * F_193 ( struct V_286 * V_287 )
{
struct V_59 * V_59 = F_177 ( V_287 ) ;
struct V_27 * V_28 = NULL ;
struct V_7 * V_8 = NULL ;
struct V_298 * V_289 = F_194 ( V_287 ) ;
V_289 -> V_202 = NULL ;
V_289 -> V_8 = NULL ;
F_179 (net, state->dev) {
struct V_1 * V_202 ;
V_202 = F_84 ( V_289 -> V_50 ) ;
if ( F_121 ( ! V_202 ) )
continue;
...
static struct V_27 * F_196 ( struct V_286 * V_287 , struct V_27 * V_28 )
{
struct V_298 * V_289 = F_194 ( V_287 ) ;
V_28 = V_28 -> V_47 ;
while ( ! V_28 ) {
F_14 ( & V_289 -> V_8 -> V_12 ) ;
V_289 -> V_8 = V_289 -> V_8 -> V_129 ;
while ( ! V_289 -> V_8 ) {
V_289 -> V_50 = F_181 ( V_289 -> V_50 ) ;
if ( ! V_289 -> V_50 ) {
V_289 -> V_202 = NULL ;
...
V_289 -> V_202 = F_84 ( V_289 -> V_50 ) ;
if ( ! V_289 -> V_202 )
continue;
V_289 -> V_8 = F_171 ( V_289 -> V_202 -> V_189 ) ;
}
if ( ! V_289 -> V_8 )
break;
F_11 ( & V_289 -> V_8 -> V_12 ) ;
...
static struct V_27 * F_197 ( struct V_286 * V_287 , T_6 V_290 )
{
struct V_27 * V_28 = F_193 ( V_287 ) ;
if ( V_28 )
while ( V_290 && ( V_28 = F_196 ( V_287 , V_28 ) ) != NULL )
-- V_290 ;
return V_290 ? NULL : V_28 ;
}
static void * F_198 ( struct V_286 * V_287 , T_6 * V_290 )
__acquires( V_11 )
{
F_58 () ;
return * V_290 ? F_197 ( V_287 , * V_290 - 1 ) : V_291 ;
}
static void * F_199 ( struct V_286 * V_287 , void * V_292 , T_6 * V_290 )
{
struct V_27 * V_28 ;
if ( V_292 == V_291 )
V_28 = F_193 ( V_287 ) ;
else
V_28 = F_196 ( V_287 , V_292 ) ;
++ * V_290 ;
return V_28 ;
}
static void F_200 ( struct V_286 * V_287 , void * V_292 )
__releases( V_11 )
{
struct V_298 * V_289 = F_194 ( V_287 ) ;
if ( F_195 ( V_289 -> V_8 ) ) {
...
static int F_201 ( struct V_286 * V_287 , void * V_292 )
{
struct V_27 * V_28 = (struct V_27 * ) V_292 ;
struct V_298 * V_289 = F_194 ( V_287 ) ;
if ( V_292 == V_291 ) {
F_187 ( V_287 , L_8 ) ;
} else {
...
L_9
L_10 ,
V_289 -> V_50 -> V_72 , V_289 -> V_50 -> V_294 ,
F_202 ( V_289 -> V_8 -> V_106 ) ,
F_202 ( V_28 -> V_122 ) ,
V_28 -> V_37 [ V_36 ] ,
V_28 -> V_37 [ V_39 ] ) ;
}
...
static int F_203 ( struct V_295 * V_295 , struct V_296 * V_296 )
{
return F_192 ( V_295 , V_296 , & V_299 ,
sizeof( struct V_298 ) ) ;
}
...
struct V_300 * V_301 ;
int V_198 ;
V_301 = F_205 ( L_11 , V_302 , V_59 -> V_303 , & V_304 ) ;
if ( ! V_301 )
goto V_305;
V_301 = F_205 ( L_12 , V_302 , V_59 -> V_303 ,
& V_306 ) ;
if ( ! V_301 )
goto V_307;
V_198 = F_206 ( & V_59 -> V_115 . V_308 , V_270 ,
V_309 , 0 , V_59 ) ;
if ( V_198 < 0 ) {
F_207 ( L_13 ,
V_198 ) ;
...
return 0 ;
V_310:
F_208 ( L_12 , V_59 -> V_303 ) ;
V_307:
F_208 ( L_11 , V_59 -> V_303 ) ;
V_305:
return - V_311 ;
}
...
F_208 ( L_12 , V_59 -> V_303 ) ;
F_208 ( L_11 , V_59 -> V_303 ) ;
F_210 ( V_59 -> V_115 . V_308 ) ;
}
static int F_211 ( struct V_312 * V_313 ,
unsigned long V_314 , void * V_315 )
{
struct V_49 * V_50 = F_212 ( V_315 ) ;
struct V_1 * V_2 ;
switch ( V_314 ) {
case V_316 :
V_2 = F_145 ( V_50 ) ;
