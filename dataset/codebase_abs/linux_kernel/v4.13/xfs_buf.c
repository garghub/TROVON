...
V_150 -> V_168 = F_138 ;
V_150 -> V_151 = V_2 ;
F_146 ( V_150 , V_156 , V_157 ) ;
for (; V_59 && V_160 ; V_160 -- , V_158 ++ ) {
int V_169 , V_60 = V_5 - V_61 ;
if ( V_60 > V_59 )
V_60 = V_59 ;
V_169 = F_147 ( V_150 , V_2 -> V_53 [ V_158 ] , V_60 ,
V_61 ) ;
if ( V_169 < V_60 )
break;
V_61 = 0 ;
...
F_169 ( V_205 ) ;
int V_208 = 0 ;
while ( F_170 ( & V_91 -> V_14 ) )
F_171 ( 100 ) ;
F_172 ( V_91 -> V_49 -> V_174 ) ;
while ( F_173 ( & V_91 -> V_19 ) ) {
F_174 ( & V_91 -> V_19 , F_164 ,
& V_205 , V_209 ) ;
while ( ! F_38 ( & V_205 ) ) {
struct V_1 * V_2 ;
V_2 = F_175 ( & V_205 , struct V_1 , V_20 ) ;
F_176 ( & V_2 -> V_20 ) ;
if ( V_2 -> V_7 & V_148 ) {
F_65 ( V_91 -> V_49 ,
L_7 ,
...
V_91 -> V_95 = V_217 ;
V_91 -> V_96 = V_217 - 1 ;
if ( F_189 ( V_91 -> V_116 , V_217 ) ) {
F_79 ( V_91 -> V_49 ,
L_9 ,
V_217 , V_91 -> V_116 ) ;
return - V_218 ;
}
V_91 -> V_219 = F_190 ( V_91 -> V_116 ) ;
V_91 -> V_220 = F_190 ( V_91 -> V_116 ) - 1 ;
return 0 ;
}
STATIC int
F_191 (
...
if ( F_193 ( & V_91 -> V_19 ) )
goto error;
if ( F_194 ( & V_91 -> V_14 , 0 , V_226 ) )
goto error;
V_91 -> V_215 . V_227 = F_181 ;
V_91 -> V_215 . V_228 = F_179 ;
...
struct V_1 * V_2 ;
while ( ! F_38 ( V_232 ) ) {
V_2 = F_175 ( V_232 , struct V_1 , V_40 ) ;
F_75 ( V_2 ) ;
V_2 -> V_7 &= ~ V_16 ;
F_176 ( & V_2 -> V_40 ) ;
F_80 ( V_2 ) ;
...
int V_242 = 0 ;
struct V_172 V_173 ;
F_203 ( NULL , V_238 , F_201 ) ;
F_154 ( & V_173 ) ;
F_204 (bp, n, buffer_list, b_list) {
if ( ! V_239 ) {
if ( F_205 ( V_2 ) ) {
V_242 ++ ;
continue;
...
F_202 ( V_238 , & V_239 ) ;
while ( ! F_38 ( & V_239 ) ) {
V_2 = F_175 ( & V_239 , struct V_1 , V_40 ) ;
F_176 ( & V_2 -> V_40 ) ;
F_75 ( V_2 ) ;
V_243 = V_2 -> V_121 ;
F_80 ( V_2 ) ;
