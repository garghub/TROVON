...
V_32 = F_68 ( & V_42 -> V_52 -> V_56 ,
V_12 -> V_117 ) ;
V_68 = F_69 ( & V_42 -> V_52 -> V_56 ,
V_42 -> V_57 ,
V_12 -> V_117 , V_32 ) ;
V_68 = F_70 ( & V_42 -> V_52 -> V_56 ) ;
F_2 ( V_10 , V_12 ,
V_42 -> V_52 -> V_14 . V_14 , true ) ;
V_12 -> V_55 = true ;
F_14 ( V_42 -> V_52 , V_10 ) ;
V_107 = F_71 ( V_12 -> V_117 ) ;
V_108 = F_71 ( V_42 -> V_52 -> V_56 . V_118 ) ;
V_61 = F_72 ( V_107 , V_108 ) ;
F_18 ( V_9 , V_61 ) ;
F_73 ( & V_10 -> V_18 , V_119 , 0 ,
V_12 -> V_28 ) ;
V_68 = F_74 ( & V_42 -> V_52 -> V_56 ) ;
V_68 = F_75 ( & V_42 -> V_52 -> V_56 ) ;
break;
case V_120 :
case V_121 :
case V_122 :
...
F_74 ( & V_42 -> V_52 -> V_56 ) ;
F_75 ( & V_42 -> V_52 -> V_56 ) ;
F_77 ( & V_42 -> V_52 -> V_56 , V_12 -> V_57 ) ;
V_12 -> V_55 = false ;
F_14 ( V_42 -> V_52 , V_10 ) ;
F_2 ( V_10 , V_12 ,
V_42 -> V_52 -> V_14 . V_14 , false ) ;
F_73 ( & V_10 -> V_18 , V_123 , 0 ,
V_12 -> V_28 ) ;
if ( ! V_12 -> V_112 )
F_78 ( V_20 , V_12 -> V_28 ) ;
V_12 -> V_112 = false ;
...
static bool F_79 ( struct V_77 * V_91 ,
...
int V_125 = 24 ;
V_12 = V_9 -> V_54 ;
V_12 -> V_117 = F_80 ( V_124 -> clock , V_125 ) ;
...
F_81 ( V_124 , 0 ) ;
V_97 = V_12 -> V_49 -> V_98 ;
V_97 -> V_129 = F_82 ( V_97 -> V_130 ) ;
V_97 -> V_95 = F_83 ( V_97 -> V_130 ) ;
F_7 ( L_15 , V_97 ,
V_97 -> V_129 , V_97 -> V_95 ) ;
return true ;
}
static void F_84 ( struct V_77 * V_91 )
{
struct V_42 * V_42 ;
struct V_9 * V_9 , * V_10 ;
struct V_11 * V_12 ;
...
static void F_87 ( struct V_77 * V_91 )
{
F_34 ( V_91 ) ;
F_35 ( V_91 ) ;
}
...
return 0 ;
V_68 = F_93 ( & V_42 -> V_142 -> V_146 , V_150 , V_147 ,
1 ) ;
if ( V_68 ) {
if ( V_147 [ 0 ] & V_151 ) {
F_7 ( L_19 ) ;
...
int V_68 = 0 ;
bool V_156 ;
V_155 = F_93 ( & V_42 -> V_142 -> V_146 ,
V_157 , V_154 , 8 ) ;
V_158:
if ( V_155 == 8 ) {
F_7 ( L_21 , V_154 [ 0 ] , V_154 [ 1 ] , V_154 [ 2 ] ) ;
V_68 = F_96 ( & V_42 -> V_56 , V_154 , & V_156 ) ;
if ( V_156 ) {
for ( V_153 = 0 ; V_153 < 3 ; V_153 ++ ) {
int V_159 ;
V_159 = F_97 ( & V_42 -> V_142 -> V_146 ,
V_157 + 1 , & V_154 [ 1 ] , 3 ) ;
if ( V_159 == 3 )
break;
}
...
if ( ! V_97 -> V_152 )
continue;
F_99 ( V_162 , & V_42 -> V_56 ) ;
for ( V_46 = 0 ; V_46 < V_42 -> V_59 ; V_46 ++ )
F_100 ( V_162 , L_24 , V_46 ,
V_42 -> V_58 [ V_46 ] . V_28 ,
V_42 -> V_58 [ V_46 ] . V_32 ) ;
}
F_48 ( V_17 ) ;
...
int F_101 ( struct V_19 * V_20 )
{
#if F_102 ( V_169 )
return F_103 ( V_20 , V_170 , 1 ) ;
#endif
return 0 ;
}
