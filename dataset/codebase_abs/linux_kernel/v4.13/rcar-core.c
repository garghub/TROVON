...
F_7 ( V_26 , L_12 ,
F_23 ( F_24 ( V_54 [ 0 ] -> V_48 . V_49 . V_49 ) ) ) ;
V_26 -> V_24 . V_58 = 1 ;
V_26 -> V_24 . V_54 = V_54 ;
V_26 -> V_24 . V_59 = F_12 ;
V_26 -> V_24 . V_60 = F_10 ;
V_26 -> V_24 . V_61 = F_4 ;
V_27 = F_25 ( & V_26 -> V_30 , & V_26 -> V_24 ) ;
if ( V_27 < 0 ) {
F_6 ( V_26 , L_13 ) ;
return V_27 ;
}
...
if ( ! V_26 )
return - V_57 ;
V_48 = F_27 ( F_28 ( V_68 ) , & V_63 -> V_50 ) ;
if ( ! V_48 )
return - V_55 ;
V_26 -> V_50 = & V_63 -> V_50 ;
V_26 -> V_69 = (enum V_70 ) V_48 -> V_71 ;
V_66 = F_29 ( V_63 , V_72 , 0 ) ;
if ( V_66 == NULL )
return - V_9 ;
V_26 -> V_73 = F_30 ( V_26 -> V_50 , V_66 ) ;
if ( F_31 ( V_26 -> V_73 ) )
return F_32 ( V_26 -> V_73 ) ;
V_67 = F_33 ( V_63 , 0 ) ;
if ( V_67 < 0 )
return V_67 ;
V_27 = F_34 ( V_26 , V_67 ) ;
