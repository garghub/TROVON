...
while ( V_22 ) {
V_23 = F_8 ( V_24 , V_22 ) ;
F_9 ( V_2 -> V_11 -> V_12 , L_4 ,
V_23 , V_22 - V_23 ) ;
for ( V_4 = 0 ; V_4 < V_23 ; V_4 ++ )
V_20 [ V_4 ] = F_10 ( V_19 [ V_4 ] ) ;
V_19 = V_19 + V_23 ;
...
int F_11 ( struct V_1 * V_2 , T_3 V_18 , T_3 V_3 )
{
V_10 * V_31 ;
...
V_20 [ V_4 ] = 0x0100 | V_31 [ V_4 + 1 ] ;
V_20 [ V_4 + 1 ] = 0x0100 | V_31 [ V_4 ] ;
}
#else
for ( V_4 = 0 ; V_4 < V_23 ; V_4 ++ )
V_20 [ V_4 ] = 0x0100 | V_31 [ V_4 ] ;
#endif
V_31 = V_31 + V_23 ;
