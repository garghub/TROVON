...
F_46 ( V_5 ) ;
V_148 = F_66 ( V_3 , 1 , NULL ) ;
if ( V_148 )
goto error;
F_47 ( V_5 ) ;
if ( V_4 -> V_174 & V_175 )
V_4 -> V_174 |= V_176 ;
if ( V_3 -> V_75 + V_3 -> V_74 > V_177 + V_178 - 8 ) {
F_58 ( V_5 -> V_24 , L_7 ) ;
V_148 = - V_179 ;
goto error;
}
if ( V_4 -> V_115 . V_135 == V_136 ) {
if ( V_3 -> V_75 != V_177 && V_3 -> V_74 < 64 ) {
F_58 ( V_5 -> V_24 , L_8 ) ;
V_148 = - V_179 ;
goto error;
}
...
V_4 -> V_115 . V_183 = F_44 ;
V_4 -> V_115 . V_184 = F_45 ;
V_4 -> V_115 . V_58 = V_177 ;
}
V_148 = F_67 ( V_3 ) ;
if ( V_148 )
goto error;
...
static int F_75 ( struct V_185 * V_24 )
{
...
static int F_77 ( struct V_185 * V_24 )
{
struct V_2 * V_3 = F_76 ( V_24 ) ;
struct V_1 * V_5 = F_1 ( V_3 ) ;
F_78 ( V_24 ) ;
