...
{
struct V_25 * V_25 = V_21 -> V_26 -> V_27 ;
if ( ! V_21 -> V_28 -> V_29 )
return - V_30 ;
if ( ! V_24 && ( V_25 -> V_31 & V_32 ) ) {
F_24 ( & V_25 -> V_33 ) ;
V_25 -> V_31 &= ~ V_32 ;
F_25 ( & V_25 -> V_33 ) ;
F_26 ( V_25 ) ;
}
return V_21 -> V_28 -> V_29 ( V_21 , V_22 , V_23 , V_24 ) ;
}
int F_27 ( struct V_21 * V_21 , int V_24 )
{
return F_23 ( V_21 , 0 , V_34 , V_24 ) ;
}
static int F_28 ( unsigned int V_35 , int V_24 )
{
struct V_35 V_36 = F_29 ( V_35 ) ;
int V_8 = - V_37 ;
if ( V_36 . V_21 ) {
V_8 = F_27 ( V_36 . V_21 , V_24 ) ;
F_30 ( V_36 ) ;
}
return V_8 ;
}
