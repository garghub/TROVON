...
V_63 . V_72 = V_17 -> V_71 -> V_72 ;
V_7 -> V_73 . V_74 = V_17 -> V_46 + V_47 ;
V_7 -> V_73 . V_75 = V_76 [ V_64 ] ;
V_7 -> V_73 . V_57 = F_22 ( V_77 ) - 1 ;
V_7 -> V_73 . V_50 = 0 ;
V_7 -> V_73 . V_51 = & V_17 -> V_51 ;
V_7 -> V_73 . V_78 = NULL ;
V_7 -> V_73 . V_79 . V_63 = & V_63 ;
V_7 -> V_13 = F_26 ( V_9 , & V_7 -> V_73 . V_79 ) ;
if ( F_27 ( V_7 -> V_13 ) ) {
V_10 = F_28 ( V_7 -> V_13 ) ;
...
unsigned int V_64 ;
for ( V_64 = 0 ; V_64 < V_17 -> V_3 . V_66 ; V_64 ++ )
F_31 ( & V_17 -> V_3 . V_81 [ V_64 ] , & V_58 [ V_64 ] ) ;
}
...
struct V_84 * V_85 ;
int V_10 ;
V_17 = F_33 ( & V_83 -> V_9 , sizeof( * V_17 ) , V_86 ) ;
if ( ! V_17 )
return - V_87 ;
V_85 = F_34 ( V_83 , V_88 , 0 ) ;
V_17 -> V_46 = F_35 ( & V_83 -> V_9 , V_85 ) ;
if ( F_27 ( V_17 -> V_46 ) )
...
V_17 -> V_3 . V_90 = V_91 ;
V_17 -> V_3 . V_92 = 3 ;
V_17 -> V_71 = F_37 ( & V_83 -> V_9 ) ;
V_17 -> V_26 = F_22 ( V_17 -> V_3 . V_66 ) - 1 ;
V_58 = F_38 ( & V_83 -> V_9 , V_17 -> V_3 . V_66 , sizeof( * V_17 ) ,
V_86 ) ;
if ( ! V_58 )
return - V_87 ;
V_10 = F_25 ( V_17 , V_58 ) ;
