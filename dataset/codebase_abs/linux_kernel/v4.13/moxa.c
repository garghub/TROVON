...
if ( F_58 ( & V_78 -> V_50 [ V_187 ] . V_64 ) )
F_59 ( & V_78 -> V_50 [ V_187 ] . V_64 , false ) ;
...
struct V_77 * V_139 ;
unsigned int V_46 ;
int V_221 = V_220 -> V_28 ;
int V_138 ;
V_138 = F_63 ( V_218 ) ;
if ( V_138 ) {
F_64 ( & V_218 -> V_198 , L_24 ) ;
goto V_83;
}
for ( V_46 = 0 ; V_46 < V_48 ; V_46 ++ )
...
V_138 = - V_37 ;
if ( V_46 >= V_48 ) {
F_65 ( & V_218 -> V_198 , L_25
L_26 , V_48 ) ;
goto V_83;
}
V_139 = & V_49 [ V_46 ] ;
V_138 = F_66 ( V_218 , 2 , L_27 ) ;
if ( V_138 ) {
F_64 ( & V_218 -> V_198 , L_28 ) ;
goto V_83;
}
V_139 -> V_89 = F_67 ( F_68 ( V_218 , 2 ) , 0x4000 ) ;
if ( V_139 -> V_89 == NULL ) {
F_64 ( & V_218 -> V_198 , L_29 ) ;
V_138 = - V_202 ;
goto V_222;
}
V_139 -> V_80 = V_221 ;
...
V_139 -> V_123 = V_124 ;
V_138 = F_47 ( V_139 , & V_218 -> V_198 ) ;
if ( V_138 )
goto V_223;
F_69 ( V_218 , V_139 ) ;
F_70 ( & V_218 -> V_198 , L_30 ,
V_224 [ V_221 - 1 ] , V_139 -> V_130 ) ;
return 0 ;
V_223:
F_61 ( V_139 -> V_89 ) ;
V_139 -> V_89 = NULL ;
...
static void F_72 ( struct V_217 * V_218 )
{
struct V_77 * V_78 = F_73 ( V_218 ) ;
F_57 ( V_78 ) ;
F_71 ( V_218 , 2 ) ;
}
...
V_214 -> V_236 = V_237 ;
V_214 -> V_238 = V_239 ;
V_214 -> V_238 . V_67 = V_206 | V_207 | V_208 | V_209 | V_210 ;
V_214 -> V_238 . V_240 = 9600 ;
V_214 -> V_238 . V_241 = 9600 ;
F_78 ( V_214 , & V_242 ) ;
F_79 ( & V_228 , V_214 , V_32 ) ;
if ( F_80 ( V_214 ) ) {
F_36 ( V_99 L_33 ) ;
F_81 ( V_214 ) ;
return - 1 ;
...
type [ V_46 ] == V_244 ) {
F_82 ( L_34 ,
V_225 + 1 , V_224 [ type [ V_46 ] - 1 ] ,
V_243 [ V_46 ] ) ;
V_78 -> V_80 = type [ V_46 ] ;
V_78 -> V_130 = type [ V_46 ] == V_81 ? 8 :
V_245 [ V_46 ] ;
V_78 -> V_123 = V_246 ;
V_78 -> V_89 = F_67 ( V_243 [ V_46 ] , 0x4000 ) ;
if ( ! V_78 -> V_89 ) {
F_36 ( V_99 L_35 ,
V_243 [ V_46 ] ) ;
continue;
...
static void F_89 ( struct V_248 * V_64 )
{
struct V_26 * V_27 = F_90 ( V_64 , struct V_26 , V_64 ) ;
F_91 ( V_27 ) ;
F_14 ( V_27 , 2 ) ;
}
static int F_92 ( struct V_248 * V_64 )
{
struct V_26 * V_27 = F_90 ( V_64 , struct V_26 , V_64 ) ;
int V_63 ;
F_93 ( & V_64 -> V_249 ) ;
...
static void F_95 ( struct V_248 * V_64 , int V_250 )
{
struct V_26 * V_27 = F_90 ( V_64 , struct V_26 , V_64 ) ;
F_96 ( V_27 , V_250 , V_250 ) ;
}
static int F_97 ( struct V_24 * V_25 , struct V_199 * V_251 )
{
struct V_77 * V_78 ;
struct V_26 * V_27 ;
int V_64 ;
...
V_27 -> V_64 . V_255 ++ ;
V_25 -> V_28 = V_27 ;
F_100 ( & V_27 -> V_64 , V_25 ) ;
F_23 ( & V_27 -> V_64 . V_69 ) ;
if ( ! F_58 ( & V_27 -> V_64 ) ) {
V_27 -> V_256 = 0 ;
F_101 ( V_25 , & V_25 -> V_66 ) ;
F_96 ( V_27 , 1 , 1 ) ;
F_102 ( V_27 ) ;
F_103 ( V_27 , V_27 -> type == V_205 ) ;
F_104 ( & V_27 -> V_64 , 1 ) ;
}
F_25 ( & V_27 -> V_64 . V_69 ) ;
F_25 ( & V_216 ) ;
return F_105 ( & V_27 -> V_64 , V_25 , V_251 ) ;
}
static void F_106 ( struct V_24 * V_25 , struct V_199 * V_251 )
{
struct V_26 * V_27 = V_25 -> V_28 ;
V_27 -> V_65 = V_25 -> V_66 . V_67 ;
F_107 ( & V_27 -> V_64 , V_25 , V_251 ) ;
}
...
return 0 ;
F_6 ( & V_52 , V_9 ) ;
V_16 = F_109 ( V_25 , V_87 , V_255 ) ;
F_8 ( & V_52 , V_9 ) ;
F_110 ( V_257 , & V_27 -> V_256 ) ;
return V_16 ;
}
...
return;
F_101 ( V_25 , V_272 ) ;
if ( ! ( V_272 -> V_67 & V_209 ) && F_120 ( V_25 ) )
F_121 ( & V_27 -> V_64 . V_273 ) ;
}
...
if ( V_27 == NULL )
return;
if ( ! F_125 ( V_274 , & V_27 -> V_256 ) )
return;
F_126 ( V_27 ) ;
F_127 ( V_274 , & V_27 -> V_256 ) ;
}
...
static void F_130 ( struct V_26 * V_45 , T_4 V_63 )
{
unsigned long V_9 ;
V_63 = ! ! V_63 ;
F_6 ( & V_45 -> V_64 . V_249 , V_9 ) ;
if ( V_63 != V_45 -> V_140 ) {
V_45 -> V_140 = V_63 ;
F_8 ( & V_45 -> V_64 . V_249 , V_9 ) ;
if ( ! V_63 )
F_59 ( & V_45 -> V_64 , true ) ;
}
else
...
static int F_131 ( struct V_26 * V_45 , unsigned int V_275 ,
T_2 T_1 * V_276 )
{
struct V_24 * V_25 = F_21 ( & V_45 -> V_64 ) ;
void T_1 * V_1 ;
unsigned int V_277 = F_58 ( & V_45 -> V_64 ) ;
T_2 V_278 ;
if ( V_25 ) {
if ( F_125 ( V_260 , & V_45 -> V_256 ) &&
F_17 ( V_45 ) == 0 ) {
F_127 ( V_260 , & V_45 -> V_256 ) ;
F_114 ( V_25 ) ;
}
if ( F_125 ( V_257 , & V_45 -> V_256 ) && ! V_25 -> V_258 &&
F_17 ( V_45 ) <= V_279 ) {
F_127 ( V_257 , & V_45 -> V_256 ) ;
F_114 ( V_25 ) ;
}
if ( V_277 && ! F_132 ( V_25 ) &&
F_16 ( V_45 ) > 0 ) {
...
V_1 = V_45 -> V_73 ;
if ( V_278 & V_281 )
F_7 ( F_2 ( V_1 + V_282 ) & ~ V_283 ,
V_1 + V_282 ) ;
if ( ! V_277 )
goto V_280;
if ( V_25 && ( V_278 & V_284 ) && ! F_135 ( V_25 ) ) {
F_136 ( & V_45 -> V_64 , 0 , V_285 ) ;
F_134 ( & V_45 -> V_64 ) ;
}
if ( V_278 & V_286 )
F_130 ( V_45 , F_11 ( V_1 + V_17 ) & V_287 ) ;
V_280:
F_22 ( V_25 ) ;
return 0 ;
}
static void F_137 ( unsigned long V_288 )
{
struct V_77 * V_78 ;
T_2 T_1 * V_276 ;
unsigned int V_289 , V_64 , V_290 = 0 ;
F_138 ( & V_52 ) ;
for ( V_289 = 0 ; V_289 < V_48 ; V_289 ++ ) {
V_78 = & V_49 [ V_289 ] ;
if ( ! V_78 -> V_53 )
continue;
V_290 ++ ;
...
V_276 = V_78 -> V_136 + F_11 ( V_78 -> V_132 ) ;
for ( V_64 = 0 ; V_64 < V_78 -> V_130 ; V_64 ++ )
F_131 ( & V_78 -> V_50 [ V_64 ] , ! ! V_276 , V_276 + V_64 ) ;
if ( V_276 )
F_32 ( 0 , V_78 -> V_134 ) ;
if ( V_291 ) {
...
static void F_101 ( struct V_24 * V_25 , struct V_271 * V_272 )
{
register struct V_271 * V_293 = & V_25 -> V_66 ;
struct V_26 * V_27 = V_25 -> V_28 ;
int V_263 , V_61 , V_294 , V_295 , V_296 , V_297 ;
V_263 = V_61 = V_294 = V_295 = V_296 = 0 ;
if ( V_293 -> V_67 & V_298 )
V_263 = V_61 = 1 ;
...
V_296 = 1 ;
V_293 -> V_67 &= ~ V_303 ;
F_140 ( V_27 , V_263 , V_61 , V_294 , V_295 , V_296 ) ;
V_297 = F_141 ( V_27 , V_293 , F_142 ( V_25 ) ) ;
if ( V_297 == - 1 )
V_297 = F_143 ( V_272 ) ;
F_144 ( V_25 , V_297 , V_297 ) ;
}
static void F_14 ( struct V_26 * V_64 , int V_304 )
{
void T_1 * V_1 ;
if ( V_304 < 0 || V_304 > 2 )
return;
...
static void F_102 ( struct V_26 * V_64 )
{
void T_1 * V_1 ;
T_2 V_306 = 512 ;
V_1 = V_64 -> V_73 ;
...
static void F_91 ( struct V_26 * V_64 )
{
...
static T_10 F_145 ( struct V_26 * V_64 , T_10 V_297 )
{
void T_1 * V_1 = V_64 -> V_73 ;
unsigned int clock , V_314 ;
T_10 V_315 ;
V_315 = F_40 ( V_64 -> V_139 ) ? 460800 : 921600 ;
if ( V_297 < 50 )
return 0 ;
if ( V_297 > V_315 )
V_297 = V_315 ;
...
static int F_141 ( struct V_26 * V_64 , struct V_271 * V_317 ,
T_10 V_297 )
{
void T_1 * V_1 ;
T_11 V_304 = 0 ;
V_1 = V_64 -> V_73 ;
V_304 = V_317 -> V_67 & V_318 ;
if ( V_304 == V_319 )
V_304 = V_320 ;
else if ( V_304 == V_321 )
V_304 = V_322 ;
...
V_304 |= V_334 ;
F_5 ( V_1 , V_335 , ( T_2 ) V_304 ) ;
if ( F_40 ( V_64 -> V_139 ) && V_297 >= 921600 )
return - 1 ;
V_297 = F_145 ( V_64 , V_297 ) ;
if ( V_317 -> V_299 & ( V_300 | V_301 | V_302 ) ) {
F_93 ( & V_10 ) ;
F_32 ( V_317 -> V_336 [ V_337 ] , V_1 + V_11 ) ;
F_32 ( V_317 -> V_336 [ V_338 ] , V_1 + V_339 ) ;
F_32 ( V_340 , V_1 + V_5 ) ;
F_1 ( V_1 ) ;
F_94 ( & V_10 ) ;
}
...
static int F_117 ( struct V_26 * V_64 , int * V_341 ,
int * V_342 )
{
if ( V_341 )
* V_341 = ! ! ( V_64 -> V_343 & V_344 ) ;
if ( V_342 )
* V_342 = ! ! ( V_64 -> V_343 & V_345 ) ;
return 0 ;
}
static void F_96 ( struct V_26 * V_64 , int V_262 , int V_263 )
{
T_4 V_304 = 0 ;
if ( V_262 )
V_304 |= V_344 ;
...
V_304 |= V_345 ;
V_64 -> V_343 = V_304 ;
F_5 ( V_64 -> V_73 , V_346 , V_304 ) ;
}
static void F_140 ( struct V_26 * V_64 , int V_263 , int V_61 ,
int V_294 , int V_295 , int V_347 )
{
int V_304 = 0 ;
if ( V_263 )
V_304 |= V_348 ;
...
V_1 = V_64 -> V_73 ;
if ( F_40 ( V_64 -> V_139 ) )
V_314 = F_9 ( V_1 , V_353 , 0 ) ;
else
V_314 = F_2 ( V_1 + V_17 ) >> 4 ;
V_314 &= 0x0B ;
if ( V_314 & 8 )
V_314 |= 4 ;
F_130 ( V_64 , V_314 & 8 ) ;
...
const unsigned char * V_354 , int V_16 )
{
struct V_26 * V_64 = V_25 -> V_28 ;
void T_1 * V_88 , * V_1 , * V_355 ;
unsigned int V_356 , V_357 ;
T_2 V_358 , V_359 , V_360 , V_361 , V_362 ;
T_2 V_363 , V_364 , V_365 ;
V_1 = V_64 -> V_73 ;
...
V_359 = F_2 ( V_1 + V_366 ) ;
V_358 = F_2 ( V_1 + V_367 ) ;
V_356 = ( V_358 > V_359 ) ? ( V_358 - V_359 - 1 ) : ( V_358 - V_359 + V_360 ) ;
if ( V_356 > V_16 )
V_356 = V_16 ;
V_38 . V_368 [ V_64 -> V_64 . V_25 -> V_31 ] += V_356 ;
V_357 = V_356 ;
if ( V_361 == V_362 ) {
V_365 = F_2 ( V_1 + V_178 ) ;
F_7 ( V_361 , V_88 + V_91 ) ;
...
V_16 = V_360 + 1 - V_359 ;
V_16 = ( V_356 > V_16 ) ? V_16 : V_356 ;
V_355 = V_88 + V_102 + V_365 + V_359 ;
F_35 ( V_355 , V_354 , V_16 ) ;
V_354 += V_16 ;
V_359 = ( V_359 + V_16 ) & V_360 ;
V_356 -= V_16 ;
}
} else {
V_363 = V_361 + ( V_359 >> 13 ) ;
V_364 = V_359 & V_369 ;
while ( V_356 > 0 ) {
V_16 = V_370 - V_364 ;
if ( V_16 > V_356 )
V_16 = V_356 ;
F_32 ( V_363 , V_88 + V_91 ) ;
V_355 = V_88 + V_102 + V_364 ;
F_35 ( V_355 , V_354 , V_16 ) ;
V_354 += V_16 ;
if ( ++ V_363 == V_362 )
V_363 = V_361 ;
...
V_359 = ( V_359 + V_357 ) & V_360 ;
}
F_7 ( V_359 , V_1 + V_366 ) ;
F_32 ( 1 , V_1 + V_371 ) ;
return V_357 ;
}
static int F_133 ( struct V_26 * V_64 )
{
struct V_24 * V_25 = V_64 -> V_64 . V_25 ;
unsigned char * V_372 ;
void T_1 * V_88 , * V_1 , * V_355 ;
unsigned int V_255 , V_16 , V_357 ;
T_2 V_359 , V_373 , V_361 , V_362 ;
T_2 V_363 , V_364 , V_365 , V_358 ;
V_1 = V_64 -> V_73 ;
V_88 = V_64 -> V_139 -> V_89 ;
V_358 = F_2 ( V_1 + V_19 ) ;
V_359 = F_2 ( V_1 + V_20 ) ;
...
V_361 = F_2 ( V_1 + V_148 ) ;
V_362 = F_2 ( V_1 + V_150 ) ;
V_255 = ( V_359 >= V_358 ) ? ( V_359 - V_358 ) : ( V_359 - V_358 + V_373 + 1 ) ;
if ( V_255 == 0 )
return 0 ;
V_357 = V_255 ;
V_38 . V_374 [ V_25 -> V_31 ] += V_357 ;
if ( V_361 == V_362 ) {
V_365 = F_2 ( V_1 + V_375 ) ;
F_7 ( V_361 , V_88 + V_91 ) ;
while ( V_255 > 0 ) {
V_355 = V_88 + V_102 + V_365 + V_358 ;
V_16 = ( V_359 >= V_358 ) ? ( V_359 - V_358 ) :
( V_373 + 1 - V_358 ) ;
V_16 = F_146 ( & V_64 -> V_64 , & V_372 ,
F_147 ( V_16 , V_255 ) ) ;
F_148 ( V_372 , V_355 , V_16 ) ;
V_358 = ( V_358 + V_16 ) & V_373 ;
V_255 -= V_16 ;
}
} else {
V_363 = V_361 + ( V_358 >> 13 ) ;
V_364 = V_358 & V_369 ;
while ( V_255 > 0 ) {
F_7 ( V_363 , V_88 + V_91 ) ;
V_355 = V_88 + V_102 + V_364 ;
V_16 = F_146 ( & V_64 -> V_64 , & V_372 ,
F_147 ( V_370 - V_364 , V_255 ) ) ;
F_148 ( V_372 , V_355 , V_16 ) ;
V_255 -= V_16 ;
V_364 = ( V_364 + V_16 ) & V_369 ;
if ( V_364 == 0 && ++ V_363 == V_362 )
V_363 = V_361 ;
}
V_358 = ( V_358 + V_357 ) & V_373 ;
}
F_7 ( V_358 , V_1 + V_19 ) ;
if ( F_11 ( V_1 + V_17 ) & V_18 ) {
V_291 = 1 ;
...
static int F_112 ( struct V_26 * V_64 )
{
void T_1 * V_1 = V_64 -> V_73 ;
T_2 V_13 , V_14 , V_15 ;
V_13 = F_2 ( V_1 + V_367 ) ;
...
static void F_123 ( struct V_26 * V_64 )
{
F_5 ( V_64 -> V_73 , V_376 , V_76 ) ;
}
static void F_126 ( struct V_26 * V_64 )
{
F_5 ( V_64 -> V_73 , V_377 , V_76 ) ;
}
static int F_24 ( struct V_26 * V_378 ,
struct V_379 T_3 * V_380 )
{
struct V_379 V_44 = {
. type = V_378 -> type ,
. line = V_378 -> V_64 . V_25 -> V_31 ,
. V_9 = V_378 -> V_64 . V_9 ,
. V_381 = 921600 ,
. V_382 = V_378 -> V_64 . V_382
} ;
return F_13 ( V_380 , & V_44 , sizeof( * V_380 ) ) ? - V_40 : 0 ;
}
static int F_26 ( struct V_26 * V_378 ,
struct V_379 T_3 * V_383 )
{
struct V_379 V_384 ;
if ( F_149 ( & V_384 , V_383 , sizeof( V_384 ) ) )
return - V_40 ;
if ( V_384 . V_385 != 0 || V_384 . V_64 != 0 ||
V_384 . V_386 != 0 ||
V_384 . V_381 != 921600 )
return - V_253 ;
if ( ! F_98 ( V_252 ) ) {
if ( ( ( V_384 . V_9 & ~ V_387 ) !=
( V_378 -> V_64 . V_9 & ~ V_387 ) ) )
return - V_253 ;
} else
V_378 -> V_64 . V_382 = V_384 . V_382 * V_213 / 100 ;
V_384 . V_9 = ( V_384 . V_9 & ~ V_388 ) ;
V_384 . V_9 |= ( V_378 -> V_64 . V_9 & V_388 ) ;
F_103 ( V_378 , V_384 . type == V_205 ) ;
V_378 -> type = V_384 . type ;
return 0 ;
}
static void F_103 ( struct V_26 * V_64 , int V_389 )
{
void T_1 * V_1 = V_64 -> V_73 ;
if ( ! V_389 ) {
F_5 ( V_1 , V_390 , 0 ) ;
