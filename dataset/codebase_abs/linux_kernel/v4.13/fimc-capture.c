...
struct V_297 * V_215 )
{
struct V_298 * V_299 = & V_2 -> V_5 . V_40 . V_81 ;
struct V_71 * V_72 = & V_2 -> V_5 . V_102 ;
struct V_7 * V_8 ;
struct V_23 * V_5 ;
struct V_90 * V_12 ;
int V_9 = - V_300 ;
V_8 = F_161 ( sizeof( * V_8 ) , V_301 ) ;
if ( ! V_8 )
return - V_300 ;
V_8 -> V_1 = V_2 ;
V_8 -> V_302 = V_303 ;
...
snprintf ( V_299 -> V_174 , sizeof( V_299 -> V_174 ) , L_13 , V_2 -> V_307 ) ;
V_299 -> V_308 = & V_309 ;
V_299 -> V_310 = & V_311 ;
V_299 -> V_215 = V_215 ;
V_299 -> V_312 = - 1 ;
...
V_72 -> type = V_291 ;
V_72 -> V_316 = V_317 | V_318 | V_319 ;
V_72 -> V_74 = V_8 ;
V_72 -> V_320 = & V_321 ;
V_72 -> V_322 = & V_323 ;
V_72 -> V_324 = sizeof( struct V_25 ) ;
V_72 -> V_325 = V_326 ;
...
V_5 -> V_224 . V_115 = V_292 ;
V_5 -> V_224 . V_116 = V_293 ;
V_5 -> V_224 . V_117 = V_12 -> V_136 ;
V_8 -> V_11 . V_115 = V_292 ;
V_8 -> V_11 . V_116 = V_293 ;
V_8 -> V_11 . V_12 = V_12 ;
V_12 = F_91 ( NULL , NULL , V_140 , 0 ) ;
V_5 -> V_285 = V_5 -> V_224 ;
V_5 -> V_285 . V_117 = V_12 -> V_136 ;
V_5 -> V_328 . V_10 = V_199 ;
V_299 -> V_82 . V_329 = V_330 ;
V_9 = F_164 ( & V_299 -> V_82 , 1 , & V_5 -> V_328 ) ;
if ( V_9 )
goto V_327;
V_9 = F_82 ( V_8 ) ;
if ( V_9 )
goto V_331;
V_9 = F_165 ( V_299 , V_332 , - 1 ) ;
if ( V_9 )
goto V_333;
F_166 ( V_215 , L_14 ,
V_299 -> V_174 , F_167 ( V_299 ) ) ;
V_299 -> V_272 = & V_8 -> V_270 . V_271 ;
return 0 ;
V_333:
F_81 ( V_8 ) ;
V_331:
...
F_177 ( V_187 , & V_335 ) ;
V_187 -> V_10 |= V_336 ;
snprintf ( V_187 -> V_174 , sizeof( V_187 -> V_174 ) , L_15 , V_2 -> V_307 ) ;
V_2 -> V_5 . V_337 [ V_201 ] . V_10 = V_199 ;
V_2 -> V_5 . V_337 [ V_139 ] . V_10 = V_199 ;
V_2 -> V_5 . V_337 [ V_135 ] . V_10 = V_182 ;
V_9 = F_164 ( & V_187 -> V_82 , V_338 ,
V_2 -> V_5 . V_337 ) ;
if ( V_9 )
return V_9 ;
V_187 -> V_82 . V_320 = & V_339 ;
V_187 -> V_340 = & V_341 ;
F_178 ( V_187 , V_2 ) ;
return 0 ;
}
