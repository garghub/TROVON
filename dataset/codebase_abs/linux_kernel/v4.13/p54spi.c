...
int V_31 ;
V_31 = F_19 ( & V_33 , L_5 , & V_2 -> V_14 -> V_24 ) ;
if ( V_31 < 0 ) {
#ifdef F_20
F_21 ( & V_2 -> V_14 -> V_24 , L_6 ) ;
V_31 = F_22 ( V_24 , ( void * ) V_34 ,
sizeof( V_34 ) ) ;
#else
F_13 ( & V_2 -> V_14 -> V_24 , L_7 ) ;
#endif
} else {
F_21 ( & V_2 -> V_14 -> V_24 , L_8 ) ;
V_31 = F_22 ( V_24 , ( void * ) V_33 -> V_35 ,
( int ) V_33 -> V_36 ) ;
F_17 ( V_33 ) ;
}
return V_31 ;
}
static int F_23 ( struct V_30 * V_24 )
{
struct V_1 * V_2 = V_24 -> V_2 ;
...
T_1 * V_41 ;
V_37 = V_2 -> V_32 -> V_36 ;
V_41 = F_24 ( V_2 -> V_32 -> V_35 , V_37 , V_42 ) ;
if ( ! V_41 )
return - V_43 ;
F_9 ( V_2 , V_44 , F_2 (
V_45 | V_46 |
...
static inline void F_36 ( struct V_1 * V_2 , T_4 V_16 )
{
F_10 ( V_2 , V_57 , F_27 ( V_16 ) ) ;
}
...
T_6 V_5 ;
T_6 V_73 [ 2 ] ;
#define F_42 (sizeof(rx_head)-sizeof(u16))
if ( F_37 ( V_2 ) < 0 )
return - V_62 ;
...
if ( V_5 <= F_42 ) {
F_44 ( V_72 , V_73 + 1 , V_5 ) ;
} else {
F_44 ( V_72 , V_73 + 1 , F_42 ) ;
F_1 ( V_2 , V_29 ,
F_45 ( V_72 , V_5 - F_42 ) ,
V_5 - F_42 ) ;
}
F_38 ( V_2 ) ;
F_45 ( V_72 , 4 ) ;
if ( F_46 ( V_2 -> V_74 , V_72 ) == 0 )
F_47 ( V_72 ) ;
return 0 ;
}
static T_7 F_48 ( int V_75 , void * V_76 )
{
struct V_77 * V_14 = V_76 ;
struct V_1 * V_2 = F_49 ( V_14 ) ;
F_50 ( V_2 -> V_74 , & V_2 -> V_78 ) ;
return V_79 ;
}
static int F_51 ( struct V_1 * V_2 , struct V_71 * V_72 )
{
...
F_55 ( & V_2 -> V_92 , V_91 ) ;
while ( ! F_56 ( & V_2 -> V_93 ) ) {
V_85 = F_57 ( V_2 -> V_93 . V_94 ,
struct V_84 , V_95 ) ;
F_58 ( & V_85 -> V_95 ) ;
F_59 ( & V_2 -> V_92 , V_91 ) ;
V_90 = F_60 ( ( void * ) V_85 , struct V_84 ,
V_95 ) ;
V_89 = F_60 ( ( void * ) V_90 , struct V_88 ,
V_35 ) ;
V_87 = F_60 ( ( void * ) V_89 , struct V_86 ,
V_96 ) ;
V_72 = F_60 ( ( void * ) V_87 , struct V_71 , V_97 ) ;
V_31 = F_51 ( V_2 , V_72 ) ;
if ( V_31 < 0 ) {
F_53 ( V_2 -> V_74 , V_72 ) ;
return V_31 ;
...
static void F_61 ( struct V_30 * V_24 , struct V_71 * V_72 )
{
struct V_1 * V_2 = V_24 -> V_2 ;
struct V_86 * V_87 = F_62 ( V_72 ) ;
struct V_88 * V_98 = (struct V_88 * ) V_87 -> V_96 ;
struct V_84 * V_99 = (struct V_84 * ) V_98 -> V_35 ;
unsigned long V_91 ;
F_63 ( sizeof( * V_99 ) > sizeof( ( V_98 -> V_35 ) ) ) ;
F_55 ( & V_2 -> V_92 , V_91 ) ;
F_64 ( & V_99 -> V_95 , & V_2 -> V_93 ) ;
F_59 ( & V_2 -> V_92 , V_91 ) ;
F_50 ( V_2 -> V_74 , & V_2 -> V_78 ) ;
}
static void F_65 ( struct V_100 * V_78 )
{
struct V_1 * V_2 = F_60 ( V_78 , struct V_1 , V_78 ) ;
T_4 V_101 ;
int V_31 ;
F_66 ( & V_2 -> V_102 ) ;
if ( V_2 -> V_66 == V_103 )
...
static int F_68 ( struct V_30 * V_24 )
{
struct V_1 * V_2 = V_24 -> V_2 ;
unsigned long V_104 ;
int V_31 = 0 ;
...
static void F_73 ( struct V_30 * V_24 )
{
struct V_1 * V_2 = V_24 -> V_2 ;
unsigned long V_91 ;
F_66 ( & V_2 -> V_102 ) ;
...
static int F_76 ( struct V_77 * V_14 )
{
struct V_1 * V_2 = NULL ;
struct V_30 * V_74 ;
int V_31 = - V_107 ;
V_74 = F_77 ( sizeof( * V_2 ) ) ;
if ( ! V_74 ) {
F_13 ( & V_14 -> V_24 , L_14 ) ;
return - V_43 ;
}
...
F_88 ( & V_2 -> V_92 ) ;
F_89 ( V_74 , & V_14 -> V_24 ) ;
V_2 -> V_114 . V_115 = F_68 ;
V_2 -> V_114 . V_116 = F_73 ;
V_2 -> V_114 . V_117 = F_61 ;
V_31 = F_14 ( V_74 ) ;
if ( V_31 < 0 )
goto V_118;
V_31 = F_18 ( V_74 ) ;
...
static int F_94 ( struct V_77 * V_14 )
{
struct V_1 * V_2 = F_49 ( V_14 ) ;
F_95 ( V_2 -> V_74 ) ;
F_91 ( F_32 ( V_55 ) , V_14 ) ;
