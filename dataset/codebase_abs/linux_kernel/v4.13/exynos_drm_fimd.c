...
unsigned int V_150 = V_141 -> V_151 -> V_152 [ 0 ] ;
unsigned int V_153 = V_141 -> V_154 [ 0 ] ;
if ( V_4 -> V_6 )
return;
V_144 = V_36 -> V_155 . V_156 * V_150 ;
V_144 += V_36 -> V_155 . V_157 * V_153 ;
V_142 = F_66 ( V_141 , 0 ) + V_144 ;
V_5 = ( unsigned long ) V_142 ;
F_4 ( V_5 , V_4 -> V_9 + F_67 ( V_24 , 0 ) ) ;
V_143 = V_153 * V_36 -> V_2 . V_158 ;
V_5 = ( unsigned long ) ( V_142 + V_143 ) ;
F_4 ( V_5 , V_4 -> V_9 + F_68 ( V_24 , 0 ) ) ;
F_11 ( L_10 ,
( unsigned long ) V_142 , V_5 , V_143 ) ;
F_11 ( L_11 ,
V_36 -> V_2 . V_159 , V_36 -> V_2 . V_158 ) ;
V_147 = V_153 - ( V_36 -> V_2 . V_159 * V_150 ) ;
V_148 = V_36 -> V_2 . V_159 * V_150 ;
V_5 = F_69 ( V_147 ) |
F_70 ( V_148 ) |
F_71 ( V_147 ) |
F_72 ( V_148 ) ;
F_4 ( V_5 , V_4 -> V_9 + F_73 ( V_24 , 0 ) ) ;
V_5 = F_74 ( V_36 -> V_2 . V_156 ) |
F_75 ( V_36 -> V_2 . V_157 ) |
F_76 ( V_36 -> V_2 . V_156 ) |
F_77 ( V_36 -> V_2 . V_157 ) ;
F_4 ( V_5 , V_4 -> V_9 + F_78 ( V_24 ) ) ;
V_145 = V_36 -> V_2 . V_156 + V_36 -> V_2 . V_159 ;
if ( V_145 )
V_145 -- ;
V_146 = V_36 -> V_2 . V_157 + V_36 -> V_2 . V_158 ;
if ( V_146 )
V_146 -- ;
...
F_11 ( L_12 ,
V_36 -> V_2 . V_156 , V_36 -> V_2 . V_157 , V_145 , V_146 ) ;
if ( V_24 != 3 && V_24 != 4 ) {
T_1 V_144 = F_84 ( V_24 ) ;
if ( V_24 == 0 )
V_144 = F_49 ( V_24 ) ;
V_5 = V_36 -> V_2 . V_159 * V_36 -> V_2 . V_158 ;
F_4 ( V_5 , V_4 -> V_9 + V_144 ) ;
F_11 ( L_13 , ( unsigned int ) V_5 ) ;
}
F_42 ( V_4 , V_24 , V_141 -> V_151 -> V_151 , V_36 -> V_155 . V_159 ) ;
if ( V_24 != 0 )
F_54 ( V_4 , V_24 ) ;
F_12 ( V_4 , V_24 , true ) ;
if ( V_4 -> V_33 -> V_34 )
...
static void F_89 ( struct V_162 * V_29 )
{
...
static void F_96 ( struct V_167 * V_168 , bool V_25 )
{
struct V_3 * V_4 = F_97 ( V_168 , struct V_3 ,
V_169 ) ;
T_1 V_5 = V_25 ? V_170 : V_171 ;
F_4 ( V_5 , V_4 -> V_9 + V_172 ) ;
}
static T_5 F_98 ( int V_173 , void * V_174 )
{
...
static int F_99 ( struct V_162 * V_29 , struct V_162 * V_180 , void * V_181 )
{
struct V_3 * V_4 = F_90 ( V_29 ) ;
...
V_4 -> V_165 = V_165 ;
for ( V_136 = 0 ; V_136 < V_32 ; V_136 ++ ) {
V_4 -> V_185 [ V_136 ] . V_186 = V_187 ;
V_4 -> V_185 [ V_136 ] . V_188 = F_100 ( V_187 ) ;
V_4 -> V_185 [ V_136 ] . V_189 = V_136 ;
V_4 -> V_185 [ V_136 ] . type = V_190 [ V_136 ] ;
V_184 = F_101 ( V_165 , & V_4 -> V_161 [ V_136 ] , V_136 ,
& V_4 -> V_185 [ V_136 ] ) ;
if ( V_184 )
return V_184 ;
}
V_183 = & V_4 -> V_161 [ V_191 ] ;
V_4 -> V_2 = F_102 ( V_165 , & V_183 -> V_54 ,
V_192 , & V_193 , V_4 ) ;
if ( F_103 ( V_4 -> V_2 ) )
return F_104 ( V_4 -> V_2 ) ;
if ( V_4 -> V_33 -> V_194 ) {
V_4 -> V_169 . V_25 = F_96 ;
V_4 -> V_2 -> V_195 = & V_4 -> V_169 ;
}
if ( V_4 -> V_196 )
F_105 ( V_165 , V_4 -> V_196 ) ;
if ( F_106 ( V_165 ) )
F_16 ( V_4 -> V_2 ) ;
return F_107 ( V_165 , V_29 ) ;
}
static void F_108 ( struct V_162 * V_29 , struct V_162 * V_180 ,
void * V_181 )
{
struct V_3 * V_4 = F_90 ( V_29 ) ;
F_87 ( V_4 -> V_2 ) ;
F_109 ( V_4 -> V_165 , V_4 -> V_29 ) ;
if ( V_4 -> V_196 )
F_110 ( V_4 -> V_196 ) ;
}
static int F_111 ( struct V_197 * V_198 )
{
struct V_162 * V_29 = & V_198 -> V_29 ;
struct V_3 * V_4 ;
struct V_199 * V_200 ;
struct V_201 * V_202 ;
int V_184 ;
if ( ! V_29 -> V_203 )
return - V_204 ;
V_4 = F_112 ( V_29 , sizeof( * V_4 ) , V_205 ) ;
if ( ! V_4 )
return - V_206 ;
V_4 -> V_29 = V_29 ;
V_4 -> V_6 = true ;
V_4 -> V_33 = F_113 ( V_29 ) ;
if ( F_114 ( V_29 -> V_203 , L_14 ) )
V_4 -> V_70 |= V_207 ;
if ( F_114 ( V_29 -> V_203 , L_15 ) )
V_4 -> V_70 |= V_208 ;
V_200 = F_115 ( V_29 -> V_203 , L_16 ) ;
if ( V_200 ) {
T_1 V_5 ;
V_4 -> V_12 = true ;
if ( V_4 -> V_33 -> V_87 )
...
V_4 -> V_96 |= V_210 ;
V_4 -> V_96 |= V_211 ;
if ( F_116 ( V_200 , L_17 , & V_5 ) )
V_5 = 0 ;
V_4 -> V_58 = F_117 ( V_5 ) ;
if ( F_116 ( V_200 , L_18 , & V_5 ) )
V_5 = 0 ;
V_4 -> V_58 |= F_118 ( V_5 ) ;
if ( F_116 ( V_200 , L_19 , & V_5 ) )
V_5 = 1 ;
V_4 -> V_58 |= F_119 ( V_5 ) ;
if ( F_116 ( V_200 , L_20 , & V_5 ) )
V_5 = 0 ;
V_4 -> V_58 |= F_120 ( V_5 ) ;
}
F_121 ( V_200 ) ;
V_4 -> V_61 = F_122 ( V_29 -> V_203 ,
L_21 ) ;
if ( F_103 ( V_4 -> V_61 ) ) {
F_123 ( V_29 , L_22 ) ;
V_4 -> V_61 = NULL ;
...
V_202 = F_126 ( V_198 , V_212 , 0 ) ;
V_4 -> V_9 = F_127 ( V_29 , V_202 ) ;
if ( F_103 ( V_4 -> V_9 ) )
return F_104 ( V_4 -> V_9 ) ;
V_202 = F_128 ( V_198 , V_213 ,
V_4 -> V_12 ? L_27 : L_28 ) ;
if ( ! V_202 ) {
F_125 ( V_29 , L_29 ) ;
return - V_214 ;
}
V_184 = F_129 ( V_29 , V_202 -> V_215 , F_98 ,
0 , L_30 , V_4 ) ;
if ( V_184 ) {
F_125 ( V_29 , L_29 ) ;
return V_184 ;
...
F_8 ( & V_4 -> V_21 , 0 ) ;
F_131 ( V_198 , V_4 ) ;
V_4 -> V_196 = F_132 ( V_29 ) ;
if ( F_103 ( V_4 -> V_196 ) )
return F_104 ( V_4 -> V_196 ) ;
F_133 ( V_29 ) ;
V_184 = F_134 ( V_29 , & V_216 ) ;
if ( V_184 )
goto V_217;
return V_184 ;
V_217:
...
static int F_136 ( struct V_197 * V_198 )
{
F_135 ( & V_198 -> V_29 ) ;
F_137 ( & V_198 -> V_29 , & V_216 ) ;
return 0 ;
}
...
static int F_139 ( struct V_162 * V_29 )
{
struct V_3 * V_4 = F_90 ( V_29 ) ;
int V_184 ;
V_184 = F_18 ( V_4 -> V_30 ) ;
