...
int V_266 ;
F_100 ( V_253 ) ;
V_264 = F_101 ( V_253 ) - F_102 ( V_253 ) ;
if ( F_27 ( ! F_103 ( V_253 , sizeof( * V_262 ) ) ) )
goto V_31;
V_262 = F_104 ( V_253 ) ;
V_265 = V_262 -> V_265 * 4 ;
if ( V_265 < sizeof( * V_262 ) )
goto V_31;
V_266 = F_43 ( V_262 -> V_266 ) ;
V_47 = V_262 -> V_43 ;
if ( F_27 ( ! F_103 ( V_253 , V_265 ) ) )
goto V_31;
F_105 ( V_253 , V_265 ) ;
V_258 = F_106 ( V_253 ) -> V_267 > 0 ;
if ( V_258 )
V_254 &= V_253 -> V_268 -> V_269 ;
F_106 ( V_253 ) -> V_267 += V_265 ;
F_107 ( V_253 ) ;
V_259 = F_99 ( - V_55 ) ;
if ( ! V_253 -> V_270 || V_258 ) {
V_255 = ! ! ( F_108 ( V_253 ) -> V_271 & V_272 ) ;
V_256 = ! ! ( F_108 ( V_253 ) -> V_271 & V_273 ) ;
if ( V_256 && ! ( F_104 ( V_253 ) -> V_274 & F_18 ( V_275 ) ) )
goto V_31;
}
V_62 = F_96 ( V_276 [ V_47 ] ) ;
if ( F_109 ( V_62 && V_62 -> V_277 . V_278 ) )
V_259 = V_62 -> V_277 . V_278 ( V_253 , V_254 ) ;
if ( F_110 ( V_259 ) )
goto V_31;
V_257 = ! ! ( F_108 ( V_259 ) -> V_271 & V_279 ) ;
V_253 = V_259 ;
do {
V_262 = (struct V_261 * ) ( F_102 ( V_253 ) + V_264 ) ;
if ( V_255 ) {
V_262 -> V_274 = F_18 ( V_181 >> 3 ) ;
if ( V_253 -> V_280 )
V_262 -> V_274 |= F_18 ( V_281 ) ;
V_181 += V_253 -> V_282 - V_264 - V_265 ;
V_263 = V_253 -> V_282 - V_264 ;
} else if ( F_111 ( V_253 ) ) {
if ( ! V_256 ) {
V_262 -> V_266 = F_18 ( V_266 ) ;
V_266 += F_108 ( V_253 ) -> V_283 ;
}
if ( V_257 )
V_263 = F_108 ( V_253 ) -> V_284 +
F_106 ( V_253 ) -> V_285 +
...
struct V_252 * * F_114 ( struct V_252 * * V_286 , struct V_252 * V_253 )
{
const struct V_260 * V_62 ;
...
V_262 = F_116 ( V_253 , V_291 ) ;
if ( F_117 ( V_253 , V_290 ) ) {
V_262 = F_118 ( V_253 , V_290 , V_291 ) ;
if ( F_27 ( ! V_262 ) )
goto V_31;
}
V_47 = V_262 -> V_43 ;
...
if ( F_119 ( V_262 ) )
goto V_294;
if ( F_27 ( F_120 ( ( V_288 * ) V_262 , 5 ) ) )
goto V_294;
V_266 = F_121 ( * ( T_2 * ) & V_262 -> V_266 ) ;
V_292 = ( V_295 ) ( ( F_121 ( * ( T_2 * ) V_262 ) ^ F_122 ( V_253 ) ) | ( V_266 & ~ V_275 ) ) ;
V_266 >>= 16 ;
for ( V_220 = * V_286 ; V_220 ; V_220 = V_220 -> V_280 ) {
struct V_261 * V_296 ;
V_295 V_297 ;
if ( ! F_123 ( V_220 ) -> V_298 )
continue;
...
( ( V_262 -> V_274 ^ V_296 -> V_274 ) & F_18 ( V_275 ) ) ;
F_123 ( V_220 ) -> V_292 |= V_292 ;
V_297 = ( V_295 ) ( V_266 - F_43 ( V_296 -> V_266 ) ) ;
if ( ! F_123 ( V_220 ) -> V_302 ||
! ( V_262 -> V_274 & F_18 ( V_275 ) ) ) {
V_297 ^= F_123 ( V_220 ) -> V_303 ;
V_297 = V_297 ? 0xFFFF : 0 ;
}
if ( F_123 ( V_253 ) -> V_302 )
F_123 ( V_220 ) -> V_297 = V_297 ;
else
F_123 ( V_220 ) -> V_297 |= V_297 ;
}
F_123 ( V_253 ) -> V_302 = ! ! ( V_262 -> V_274 & F_18 ( V_275 ) ) ;
F_123 ( V_253 ) -> V_292 |= V_292 ;
F_124 ( V_253 , V_291 ) ;
F_125 ( V_253 , sizeof( * V_262 ) ) ;
F_126 ( V_253 , F_115 ( V_253 ) ) ;
V_289 = F_127 ( V_62 -> V_277 . V_293 , V_286 , V_253 ) ;
V_294:
F_28 () ;
V_31:
F_128 ( V_253 , V_289 , V_292 ) ;
return V_289 ;
}
static struct V_252 * * F_129 ( struct V_252 * * V_286 ,
struct V_252 * V_253 )
{
if ( F_123 ( V_253 ) -> V_304 ) {
F_123 ( V_253 ) -> V_292 = 1 ;
return NULL ;
}
F_123 ( V_253 ) -> V_304 = 1 ;
return F_114 ( V_286 , V_253 ) ;
}
T_2 F_130 ( void )
{
T_1 V_305 ;
...
struct V_307 V_308 ;
F_131 ( & V_308 ) ;
( void ) F_132 ( V_308 . V_309 , V_310 , & V_305 ) ;
V_306 = V_305 * V_311 ;
...
int F_136 ( struct V_252 * V_253 , int V_264 )
{
T_6 V_319 = F_18 ( V_253 -> V_282 - V_264 ) ;
struct V_261 * V_262 = (struct V_261 * ) ( V_253 -> V_161 + V_264 ) ;
const struct V_260 * V_62 ;
int V_47 = V_262 -> V_43 ;
int V_27 = - V_320 ;
if ( V_253 -> V_270 ) {
F_137 ( V_253 , F_138 ( V_321 ) ) ;
F_139 ( V_253 , V_264 ) ;
}
F_140 ( & V_262 -> V_322 , V_262 -> V_263 , V_319 ) ;
V_262 -> V_263 = V_319 ;
F_25 () ;
V_62 = F_96 ( V_276 [ V_47 ] ) ;
...
static int F_141 ( struct V_252 * V_253 , int V_264 )
{
V_253 -> V_270 = 1 ;
F_108 ( V_253 ) -> V_271 |= V_324 ;
return F_136 ( V_253 , V_264 ) ;
}
int F_142 ( struct V_1 * * V_2 , unsigned short V_325 ,
unsigned short type , unsigned char V_43 ,
struct V_42 * V_42 )
{
struct V_24 * V_1 ;
int V_326 = F_143 ( V_42 , V_325 , type , V_43 , & V_1 ) ;
if ( V_326 == 0 ) {
* V_2 = V_1 -> V_2 ;
( * V_2 ) -> V_327 = V_328 ;
( * V_2 ) -> V_20 -> V_329 ( * V_2 ) ;
...
T_7 F_144 ( void T_8 * V_330 , int V_331 , int V_332 )
{
return * ( ( ( unsigned long * ) F_145 ( V_330 , V_331 ) ) + V_332 ) ;
}
unsigned long F_146 ( void T_8 * V_330 , int V_332 )
{
unsigned long V_333 = 0 ;
int V_334 ;
F_147 (i)
V_333 += F_144 ( V_330 , V_334 , V_332 ) ;
return V_333 ;
}
T_7 F_148 ( void T_8 * V_330 , int V_331 , int V_332 ,
T_3 V_335 )
{
void * V_336 ;
struct V_337 * V_338 ;
T_7 V_339 ;
unsigned int V_340 ;
V_336 = F_145 ( V_330 , V_331 ) ;
V_338 = (struct V_337 * ) ( V_336 + V_335 ) ;
do {
V_340 = F_149 ( V_338 ) ;
V_339 = * ( ( ( T_7 * ) V_336 ) + V_332 ) ;
} while ( F_150 ( V_338 , V_340 ) );
return V_339 ;
}
T_7 F_151 ( void T_8 * V_330 , int V_332 , T_3 V_335 )
{
T_7 V_333 = 0 ;
int V_331 ;
F_147 (cpu) {
V_333 += F_148 ( V_330 , V_331 , V_332 , V_335 ) ;
}
return V_333 ;
}
...
{
int V_334 ;
V_42 -> V_330 . V_341 = F_153 ( struct V_342 ) ;
if ( ! V_42 -> V_330 . V_341 )
goto V_343;
V_42 -> V_330 . V_344 = F_153 ( struct V_345 ) ;
if ( ! V_42 -> V_330 . V_344 )
goto V_346;
F_147 (i) {
struct V_345 * V_347 ;
V_347 = F_145 ( V_42 -> V_330 . V_344 , V_334 ) ;
F_154 ( & V_347 -> V_338 ) ;
}
V_42 -> V_330 . V_348 = F_153 ( struct V_349 ) ;
if ( ! V_42 -> V_330 . V_348 )
goto V_350;
V_42 -> V_330 . V_351 = F_153 ( struct V_352 ) ;
if ( ! V_42 -> V_330 . V_351 )
goto V_353;
V_42 -> V_330 . V_354 = F_153 ( struct V_352 ) ;
if ( ! V_42 -> V_330 . V_354 )
goto V_355;
V_42 -> V_330 . V_356 = F_153 ( struct V_357 ) ;
if ( ! V_42 -> V_330 . V_356 )
goto V_358;
V_42 -> V_330 . V_359 = F_155 ( sizeof( struct V_360 ) ,
V_67 ) ;
if ( ! V_42 -> V_330 . V_359 )
goto V_361;
F_156 ( V_42 ) ;
return 0 ;
V_361:
F_157 ( V_42 -> V_330 . V_356 ) ;
V_358:
F_157 ( V_42 -> V_330 . V_354 ) ;
V_355:
F_157 ( V_42 -> V_330 . V_351 ) ;
V_353:
F_157 ( V_42 -> V_330 . V_348 ) ;
V_350:
F_157 ( V_42 -> V_330 . V_344 ) ;
V_346:
F_157 ( V_42 -> V_330 . V_341 ) ;
V_343:
return - V_362 ;
}
static T_10 void F_158 ( struct V_42 * V_42 )
{
F_10 ( V_42 -> V_330 . V_359 ) ;
F_157 ( V_42 -> V_330 . V_356 ) ;
F_157 ( V_42 -> V_330 . V_354 ) ;
F_157 ( V_42 -> V_330 . V_351 ) ;
F_157 ( V_42 -> V_330 . V_348 ) ;
...
{
F_162 ( & V_42 -> V_76 . V_364 . V_365 ) ;
V_42 -> V_76 . V_364 . V_366 [ 0 ] = 32768 ;
V_42 -> V_76 . V_364 . V_366 [ 1 ] = 60999 ;
F_162 ( & V_42 -> V_76 . V_367 . V_365 ) ;
V_42 -> V_76 . V_367 . V_366 [ 0 ] = F_163 ( & V_368 , 1 ) ;
V_42 -> V_76 . V_367 . V_366 [ 1 ] = F_163 ( & V_368 , 0 ) ;
...
static int T_11 F_173 ( void )
{
struct V_45 * V_384 ;
struct V_221 * V_385 ;
int V_326 = - V_28 ;
F_174 ( sizeof( struct V_386 ) ) ;
V_326 = F_175 ( & V_387 , 1 ) ;
if ( V_326 )
goto V_31;
V_326 = F_175 ( & V_388 , 1 ) ;
...
F_177 () ;
#endif
if ( F_178 ( & V_395 , V_396 ) < 0 )
F_169 ( L_11 , V_249 ) ;
if ( F_178 ( & V_397 , V_398 ) < 0 )
F_169 ( L_12 , V_249 ) ;
if ( F_178 ( & V_399 , V_159 ) < 0 )
F_169 ( L_13 , V_249 ) ;
#ifdef F_179
if ( F_178 ( & V_400 , V_401 ) < 0 )
F_169 ( L_14 , V_249 ) ;
#endif
for ( V_385 = & V_227 [ 0 ] ; V_385 < & V_227 [ V_225 ] ; ++ V_385 )
F_180 ( V_385 ) ;
for ( V_384 = V_402 ; V_384 < & V_402 [ V_403 ] ; ++ V_384 )
F_76 ( V_384 ) ;
F_181 () ;
F_182 () ;
F_183 () ;
