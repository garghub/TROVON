...
void F_14 ( struct V_30 * V_30 , int V_31 ,
const struct V_1 * V_2 )
{
F_9 ( V_30 , F_15 ( V_31 ) , V_2 -> V_27 ) ;
F_9 ( V_30 , F_16 ( V_31 ) , V_2 -> V_28 ) ;
F_9 ( V_30 , F_17 ( V_31 ) , V_2 -> V_29 ) ;
F_9 ( V_30 , F_18 ( V_31 ) , V_2 -> V_22 ) ;
F_9 ( V_30 , F_19 ( V_31 ) , V_2 -> V_32 ) ;
}
...
void F_22 ( struct V_30 * V_30 , int V_31 ,
struct V_1 * V_2 )
{
F_21 ( V_30 , F_15 ( V_31 ) , & V_2 -> V_27 ) ;
F_21 ( V_30 , F_16 ( V_31 ) , & V_2 -> V_28 ) ;
F_21 ( V_30 , F_17 ( V_31 ) , & V_2 -> V_29 ) ;
F_21 ( V_30 , F_18 ( V_31 ) , & V_2 -> V_22 ) ;
F_21 ( V_30 , F_19 ( V_31 ) , & V_2 -> V_32 ) ;
}
