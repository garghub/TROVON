...
const unsigned int V_248 = V_249 ;
V_247 = F_129 ( V_204 ) ;
if ( V_247 < 0 )
return V_247 ;
if ( ! F_130 ( & V_204 -> V_162 , F_131 ( V_248 ) ) ) {
F_132 ( & V_204 -> V_162 , F_131 ( V_248 ) ) ;
} else {
F_130 ( & V_204 -> V_162 , F_131 ( 32 ) ) ;
F_132 ( & V_204 -> V_162 , F_131 ( 32 ) ) ;
}
if ( ! V_53 -> V_217 ) {
V_247 = F_133 ( V_204 , L_4 ) ;
if ( V_247 < 0 )
goto V_250;
if ( V_53 -> V_179 == V_186 )
...
if ( V_53 -> V_212 < 0 ) {
V_247 = F_134 ( V_204 -> V_212 , F_127 , V_252 ,
V_253 , V_53 ) ;
if ( V_247 < 0 ) {
F_93 ( V_53 -> V_161 -> V_162 ,
L_5 , V_204 -> V_212 ) ;
...
static int F_140 ( struct V_53 * V_53 )
{
if ( V_53 -> V_212 >= 0 )
F_141 ( V_53 -> V_212 , V_53 ) ;
V_53 -> V_212 = - 1 ;
F_123 ( V_53 -> V_218 ) ;
V_53 -> V_218 = NULL ;
if ( V_53 -> V_217 )
...
static int F_142 ( struct V_53 * V_53 , struct V_254 * V_152 )
{
int V_247 ;
unsigned int V_171 ;
T_1 V_48 ;
...
static int F_143 ( struct V_53 * V_53 )
{
struct V_203 * V_204 = V_53 -> V_204 ;
F_138 ( V_53 ) ;
if ( V_53 -> V_179 == V_186 ) {
...
{
return F_142 ( V_53 , V_152 ) ;
}
static T_1 F_30 ( struct V_53 * V_53 , T_1 V_267 )
{
T_1 V_268 ;
unsigned long V_47 ;
F_145 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_270 , V_47 ) ;
F_147 ( V_267 , V_53 -> V_217 + 0x0 ) ;
V_268 = F_148 ( V_53 -> V_217 + 0x4 ) ;
F_149 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_270 , V_47 ) ;
return V_268 ;
}
static void F_28 ( struct V_53 * V_53 , T_1 V_267 , T_1 V_48 )
{
unsigned long V_47 ;
F_145 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_270 , V_47 ) ;
F_147 ( V_267 , V_53 -> V_217 + 0x0 ) ;
F_147 ( V_48 , V_53 -> V_217 + 0x4 ) ;
F_149 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_270 , V_47 ) ;
}
static T_1 F_99 ( struct V_53 * V_53 , T_1 V_267 )
{
T_1 V_268 ;
unsigned long V_47 ;
F_145 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
F_147 ( V_267 , V_53 -> V_217 + 0x10 ) ;
V_268 = F_148 ( V_53 -> V_217 + 0x14 ) ;
F_149 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
return V_268 ;
}
static void F_100 ( struct V_53 * V_53 , T_1 V_267 , T_1 V_48 )
{
unsigned long V_47 ;
F_145 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
F_147 ( V_267 , V_53 -> V_217 + 0x10 ) ;
F_147 ( V_48 , V_53 -> V_217 + 0x14 ) ;
F_149 (
& F_146 ( V_53 , struct V_269 , V_53 ) -> V_271 , V_47 ) ;
}
int F_150 ( struct V_53 * * V_272 )
{
struct V_269 * V_269 ;
* V_272 = NULL ;
V_269 = F_2 ( sizeof( * V_269 ) , V_4 ) ;
if ( ! V_269 )
return - V_5 ;
F_151 ( & V_269 -> V_270 ) ;
F_151 ( & V_269 -> V_271 ) ;
...
int F_152 ( struct V_53 * V_53 )
{
if ( V_53 -> V_217 )
F_140 ( V_53 ) ;
F_4 ( F_146 ( V_53 , struct V_269 , V_53 ) ) ;
return 0 ;
}
