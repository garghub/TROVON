...
{
struct V_59 * V_60 = F_28 ( & V_2 -> V_49 ) ;
enum V_15 V_26 ;
struct V_36 * V_36 ;
if ( V_2 -> V_36 || ! V_60 || ! F_29 ( V_60 ) )
return;
V_26 = F_4 ( V_2 ) ;
if ( V_26 == V_24 )
return;
V_36 = F_30 ( sizeof( struct V_36 ) , V_61 ) ;
if ( ! V_36 )
return;
V_36 -> V_26 = V_26 ;
F_22 ( V_2 ) ;
