...
static int F_55 ( long T_1 * V_9 , int V_120 )
{
long V_121 ;
int V_122 = 1 ;
V_121 = F_56 ( ( unsigned long ) V_9 , V_122 ,
...
static int F_58 ( struct V_1 * V_2 , unsigned long * V_125 ,
long T_1 * V_126 )
{
T_5 V_127 ;
int V_99 ;
if ( F_2 ( V_2 ) )
return F_59 ( * V_125 , V_126 ) ;
V_99 = F_59 ( V_127 , ( T_5 T_1 * ) V_126 ) ;
* V_125 = V_127 ;
return V_99 ;
}
...
unsigned long V_111 ;
unsigned long V_114 ;
if ( ! F_61 ( V_130 , ( V_126 ) , sizeof( * V_126 ) ) )
return - V_63 ;
while ( 1 ) {
int V_131 = 0 ;
F_62 () ;
V_99 = F_58 ( V_2 , & V_111 , V_126 ) ;
F_63 () ;
if ( ! V_99 )
break;
if ( V_99 == - V_63 )
V_99 = F_55 ( V_126 , V_131 ) ;
if ( V_99 )
return V_99 ;
}
V_129 = V_111 & V_116 ;
V_114 = F_57 ( V_2 , V_111 ) ;
if ( ! V_129 && V_114 )
return - V_11 ;
if ( ! V_129 )
return - V_132 ;
...
unsigned long V_149 ;
unsigned long V_150 ;
V_149 = V_114 + F_65 ( V_2 , V_145 ) ;
V_150 = V_114 + F_65 ( V_2 , V_146 - 1 ) ;
V_150 += F_64 ( V_2 ) ;
V_148 = F_68 ( V_2 , V_149 ) ;
...
if ( ! ( V_148 -> V_152 & V_17 ) )
return - V_11 ;
V_7 = F_69 ( V_148 -> V_153 , V_150 ) - V_9 ;
F_70 ( V_148 , V_9 , V_7 ) ;
F_71 ( V_9 , V_9 + V_7 ) ;
V_148 = V_148 -> V_154 ;
V_9 = V_148 -> V_151 ;
...
return F_74 ( V_2 , V_114 , F_3 ( V_2 ) , NULL ) ;
}
...
struct V_147 * V_157 ;
struct V_147 * V_158 ;
unsigned long V_159 = V_149 & ~ ( F_66 ( V_2 ) - 1 ) ;
unsigned long V_160 = V_159 + F_66 ( V_2 ) ;
unsigned long V_106 ( V_114 ) ;
void T_1 * V_161 ;
int V_99 ;
V_157 = F_76 ( V_2 , V_149 , & V_158 ) ;
...
V_161 = V_2 -> V_100 . V_101 + F_72 ( V_2 , V_149 ) ;
V_99 = F_60 ( V_2 , V_161 , & V_114 ) ;
if ( V_99 == - V_132 ) {
V_99 = 0 ;
return 0 ;
}
...
if ( ( V_149 == V_159 ) &&
( V_150 == V_160 ) )
return F_73 ( V_2 , V_161 , V_114 ) ;
return F_67 ( V_2 , V_114 , V_149 , V_150 ) ;
}
...
while ( V_163 < V_150 ) {
int V_99 ;
unsigned long V_164 = F_79 ( V_163 + 1 ,
F_66 ( V_2 ) ) ;
unsigned long V_165 = V_150 ;
if ( V_165 > V_164 )
V_165 = V_164 ;
V_99 = F_75 ( V_2 , V_163 , V_165 ) ;
if ( V_99 )
return V_99 ;
V_163 = V_164 ;
}
...
void F_80 ( struct V_1 * V_2 , struct V_147 * V_148 ,
unsigned long V_149 , unsigned long V_150 )
{
int V_99 ;
if ( ! F_54 ( V_8 -> V_2 ) )
