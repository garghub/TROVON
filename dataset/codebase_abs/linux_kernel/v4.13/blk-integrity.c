...
static T_3 F_30 ( struct V_64 * V_10 )
{
return V_65 ;
}
void F_31 ( struct V_20 * V_49 , struct V_23 * V_66 )
{
struct V_23 * V_51 = & V_49 -> V_25 -> V_26 ;
V_51 -> V_60 = V_61 | V_62 |
V_66 -> V_60 ;
V_51 -> V_29 = V_66 -> V_29 ? :
F_32 ( F_33 ( V_49 -> V_25 ) ) ;
V_51 -> V_28 = V_66 -> V_28 ? V_66 -> V_28 : & V_67 ;
V_51 -> V_32 = V_66 -> V_32 ;
V_51 -> V_33 = V_66 -> V_33 ;
V_49 -> V_25 -> V_68 -> V_69 |= V_70 ;
}
