...
{
unsigned int V_317 = F_163 () ;
struct V_318 * V_319 ;
int V_247 ;
V_317 &= V_308 ;
if ( V_317 > V_6 -> V_14 . V_320 ) {
V_319 = F_240 ( V_6 -> V_14 . V_321 , V_317 *
sizeof( * V_6 -> V_14 . V_321 ) , V_322 ) ;
if ( F_132 ( ! V_319 ) ) {
V_317 = V_6 -> V_14 . V_320 ;
} else {
V_6 -> V_14 . V_321 = V_319 ;
V_6 -> V_14 . V_320 = V_317 ;
}
}
if ( V_317 )
F_241 ( V_6 -> V_14 . V_321 , 0 , V_317 ) ;
for ( V_247 = V_317 ; V_247 < V_6 -> V_14 . V_323 ; ++ V_247 ) {
V_6 -> V_14 . V_321 [ V_247 ] . V_324 = F_242 ( V_247 ) ;
V_6 -> V_14 . V_321 [ V_247 ] . V_325 [ 0 ] = 0 ;
V_6 -> V_14 . V_321 [ V_247 ] . V_325 [ 1 ] = 0 ;
V_6 -> V_14 . V_321 [ V_247 ] . V_326 = 0 ;
}
V_6 -> V_14 . V_323 = V_317 ;
}
static void F_243 ( struct V_5 * V_6 )
{
if ( V_6 -> V_14 . V_321 )
F_244 ( V_6 -> V_14 . V_321 , 0 ,
V_6 -> V_14 . V_323 ) ;
}
static void F_245 ( struct V_5 * V_6 , int V_309 )
{
struct V_327 * V_327 = V_6 -> V_327 ;
struct V_328 * V_329 = & V_327 -> V_14 . V_329 ;
bool V_330 ;
V_330 = ( V_6 -> V_14 . V_331 != V_309 ) ;
V_6 -> V_14 . V_331 = V_309 ;
if ( V_315 ) {
if ( V_330 ||
( V_6 -> V_14 . V_316 [ V_309 ] ^ F_231 ( V_309 ) ) &
V_332 ) {
F_230 ( V_309 , V_6 ) ;
V_6 -> V_14 . V_316 [ V_309 ] = F_231 ( V_309 ) ;
F_246 ( V_6 ,
V_6 -> V_14 . V_316 [ V_309 ] ) ;
}
F_247 ( V_311 , V_6 -> V_14 . V_316 [ V_309 ] ) ;
} else {
if ( V_330 || V_333 [ V_309 ] != V_6 )
F_234 () ;
V_333 [ V_309 ] = V_6 ;
if ( F_248 ( V_309 , & V_327 -> V_14 . V_334 )
|| ( F_249 ( V_309 , V_329 ) ^ F_250 ( V_309 ) ) &
F_251 ( V_309 ) )
F_252 ( V_329 , V_309 ) ;
}
}
static int F_253 ( struct V_5 * V_6 , int V_309 )
{
struct V_52 * V_53 = V_6 -> V_14 . V_53 ;
bool V_330 , V_335 ;
V_330 = ( V_6 -> V_14 . V_336 != V_309 ) ;
V_335 = V_330 || ( V_337 [ V_309 ] != V_6 ) ;
V_337 [ V_309 ] = V_6 ;
F_254 ( V_53 ) ;
if ( V_338 -> V_51 & V_339 ) {
F_255 () ;
...
if ( V_42 )
F_299 (
V_53 -> V_158 [ V_344 ] [ V_345 ] ) ;
if ( V_150 )
F_103 ( 0 ) ;
return 0 ;
}
static int F_300 ( struct V_5 * V_6 , int V_309 )
{
struct V_52 * V_53 = V_6 -> V_14 . V_53 ;
if ( V_338 -> V_51 & V_339 )
F_239 ( V_6 ) ;
...
static unsigned int F_345 ( unsigned int V_347 )
{
unsigned int V_348 = 0 , V_212 = 0 , V_349 ;
if ( V_289 )
F_346 ( V_350 ,
( V_347 - 1 ) << V_351 ) ;
if ( V_295 ) {
V_348 = F_178 () ;
if ( V_172 || ( V_348 & V_352 ) ==
V_353 ) {
V_348 &= ~ V_354 ;
V_348 |= ( ( V_347 - 1 ) >> V_355 ) <<
V_356 ;
...
{
unsigned int V_362 , V_363 , V_364 ;
T_7 V_365 , V_366 ;
switch ( F_350 () ) {
case V_183 :
V_365 = F_351 () ;
...
V_45 . V_375 = V_362 ;
V_45 . V_376 = V_362 ;
V_45 . V_243 . V_375 = V_363 ;
F_234 () ;
break;
default:
V_362 = V_45 . V_376 ;
V_364 = V_45 . V_375 - V_362 ;
V_363 = F_345 ( V_362 ) ;
V_45 . V_243 . V_375 = V_363 + V_364 ;
F_234 () ;
V_363 = V_362 - F_355 () - 2 ;
V_363 = F_345 ( V_363 ) ;
V_45 . V_243 . V_375 = V_363 + V_364 ;
if ( F_356 ( & V_377 , 0 , V_363 ) &&
F_82 ( V_363 != V_377 ,
L_12 ) )
return - V_110 ;
break;
...
static int F_361 ( struct V_327 * V_327 , long V_386 )
{
int V_387 ;
switch ( V_386 ) {
case V_388 :
...
static void F_363 ( struct V_5 * V_6 )
{
int V_309 ;
F_238 (cpu) {
if ( V_337 [ V_309 ] == V_6 )
...
static int F_364 ( struct V_5 * V_6 )
{
struct V_52 * V_53 = V_6 -> V_14 . V_53 ;
...
F_365 ( V_6 , V_44 ) ;
if ( V_172 )
F_366 ( V_53 , V_391 | V_392 | V_393 ) ;
if ( V_172 )
F_367 ( V_53 ,
F_163 () & V_360 ) ;
F_368 ( V_53 , V_394 | V_88 ) ;
if ( V_172 )
F_369 ( V_53 , V_198 , F_71 () ) ;
F_370 ( V_53 , F_170 () &
( V_395 | V_396 | V_397 ) ) ;
F_371 ( V_53 , V_199 . V_398 ) ;
F_318 ( V_53 , ( V_87 ) 0x80000000 | V_6 -> V_399 ) ;
F_320 ( V_53 ) ;
F_372 ( V_53 , V_7 ,
V_400 >> V_401 ) ;
F_372 ( V_53 , V_402 , F_373 () ) ;
if ( V_289 ) {
F_374 ( V_53 , V_21 ) ;
F_321 ( V_53 ) ;
F_375 ( V_53 , V_403 |
...
if ( V_100 ) {
F_384 ( V_53 , 0x00200010 ) ;
F_385 ( V_53 , 0x00000002 |
( V_400 >> V_401 ) <<
( 16 + V_420 ) ) ;
F_386 ( V_53 , 0x00380438 ) ;
}
if ( V_240 && V_172 ) {
F_387 ( V_53 , 0x0c30c302 ) ;
F_388 ( V_53 , 1 << V_421 ) ;
}
if ( V_42 )
V_53 -> V_158 [ V_344 ] [ V_345 ] = 0 ;
V_6 -> V_14 . V_93 = F_389 ( 0x1fc00000 ) ;
return 0 ;
}
static void F_390 ( struct V_327 * V_327 )
{
if ( V_315 ) {
F_391 ( V_327 ) ;
} else {
F_392 ( & V_327 -> V_14 . V_334 ) ;
F_391 ( V_327 ) ;
}
}
static void F_393 ( struct V_327 * V_327 ,
const struct V_422 * V_423 )
{
F_390 ( V_327 ) ;
}
static void F_394 ( struct V_131 * V_115 , struct V_5 * V_6 )
{
int V_309 = F_395 () ;
int V_424 ;
V_424 = F_235 ( V_6 , V_309 ) ;
if ( V_424 )
F_239 ( V_6 ) ;
F_245 ( V_6 , V_309 ) ;
if ( V_424 )
...
static int F_396 ( struct V_131 * V_115 , struct V_5 * V_6 )
{
int V_309 = F_395 () ;
int V_387 ;
F_55 ( V_6 ) ;
...
F_245 ( V_6 , V_309 ) ;
F_243 ( V_6 ) ;
V_387 = V_6 -> V_14 . V_425 ( V_115 , V_6 ) ;
F_239 ( V_6 ) ;
return V_387 ;
}
int F_398 ( struct V_426 * * V_427 )
{
if ( ! V_428 )
return - V_429 ;
if ( F_82 ( V_430 == - 1 ,
