...
V_2 -> V_46 = V_86 ;
F_39 ( V_2 ) ;
if ( F_43 ( V_2 -> V_51 , ( V_2 -> V_50 == V_59 ) ||
( V_2 -> V_50 == V_62 ) , V_87 ) ) {
V_69 = ( V_2 -> V_50 == V_62 ) ? V_86 : - V_88 ;
goto V_60;
} else {
V_2 -> V_44 = NULL ;
V_2 -> V_36 = NULL ;
...
static T_3 F_46 ( struct V_84 * V_32 )
{
return V_90 | V_91 ;
}
...
T_1 V_30 ;
T_3 V_14 ;
V_2 = F_48 ( & V_93 -> V_33 , sizeof( * V_2 ) , V_98 ) ;
if ( ! V_2 )
return - V_99 ;
V_97 = F_49 ( V_93 , V_100 , 0 ) ;
V_2 -> V_7 = F_50 ( & V_93 -> V_33 , V_97 ) ;
if ( F_51 ( V_2 -> V_7 ) )
return F_52 ( V_2 -> V_7 ) ;
V_52 = F_53 ( V_93 , 0 ) ;
if ( V_52 < 0 )
...
F_57 ( & V_2 -> V_56 ) ;
F_58 ( & V_2 -> V_51 ) ;
V_2 -> V_103 = F_59 ( & V_93 -> V_33 , NULL ) ;
if ( F_51 ( V_2 -> V_103 ) ) {
F_60 ( & V_93 -> V_33 , L_19 ) ;
return F_52 ( V_2 -> V_103 ) ;
}
V_8 = F_61 ( V_2 -> V_103 ) ;
if ( V_8 ) {
F_60 ( & V_93 -> V_33 , L_20 ) ;
...
if ( V_95 ) {
for ( V_30 = 0 ; V_30 < V_95 -> V_110 ; V_30 ++ )
F_68 ( & V_2 -> V_32 , V_95 -> V_111 + V_30 ) ;
}
return 0 ;
V_107:
F_69 ( & V_93 -> V_33 ) ;
...
static int T_5 F_75 ( struct V_112 * V_33 )
{
struct V_92 * V_93 = F_76 ( V_33 ) ;
struct V_1 * V_2 = F_73 ( V_93 ) ;
F_77 ( V_2 -> V_103 ) ;
return 0 ;
}
static int T_5 F_78 ( struct V_112 * V_33 )
{
struct V_92 * V_93 = F_76 ( V_33 ) ;
struct V_1 * V_2 = F_73 ( V_93 ) ;
int V_8 ;
