...
static T_1 F_33 ( struct V_2 * V_2 , void * V_51 ,
const char * V_52 , T_2 V_53 )
{
unsigned int V_33 ;
int V_60 ;
...
static T_1 F_35 ( struct V_2 * V_2 , void * V_51 ,
const char * V_52 , T_2 V_53 )
{
struct V_38 * V_39 = V_2 -> V_40 ;
T_2 V_63 ;
...
static void F_37 ( struct V_2 * V_2 , unsigned char V_65 [] )
{
...
static void F_41 ( struct V_78 * V_79 , int V_80 , bool V_81 ,
...
if ( V_87 -> V_98 == 2 ) {
V_91 = 1 ;
F_41 ( V_79 , 0 , false , 0 , 0 ) ;
}
V_87 -> V_98 = 2 ;
F_41 ( V_79 , 1 , V_91 == 2 , V_70 , V_71 ) ;
} else {
if ( V_87 -> V_98 == 1 ) {
V_91 = 1 ;
F_41 ( V_79 , 1 , false , 0 , 0 ) ;
}
V_87 -> V_98 = 1 ;
F_41 ( V_79 , 0 , V_91 != 0 , V_70 , V_71 ) ;
}
} else {
...
if ( V_91 == 1 || ( V_91 == 2 && ! ( V_65 [ 0 ] & V_97 ) ) ) {
F_44 ( V_79 , V_101 , V_70 ) ;
F_44 ( V_79 , V_102 , V_71 ) ;
}
F_46 ( V_79 , V_103 , V_65 [ 0 ] & 0x01 ) ;
F_46 ( V_79 , V_104 , V_65 [ 0 ] & 0x02 ) ;
F_46 ( V_79 , V_105 , V_91 ) ;
F_46 ( V_79 , V_106 , V_91 == 1 ) ;
F_46 ( V_79 , V_107 , V_91 == 2 ) ;
break;
case V_76 :
...
F_48 ( V_79 , V_109 , V_89 - V_90 ) ;
F_46 ( V_79 , V_110 , V_89 ) ;
F_46 ( V_79 , V_111 , V_90 ) ;
F_46 ( V_79 , V_103 , V_65 [ 0 ] & 1 ) ;
F_46 ( V_79 , V_112 , ( V_65 [ 0 ] >> 2 ) & 1 ) ;
F_46 ( V_79 , V_104 , ( V_65 [ 0 ] >> 1 ) & 1 ) ;
V_92 = V_65 [ 1 ] ? ( int ) V_65 [ 1 ] - ( int ) ( ( V_65 [ 0 ] << 4 ) & 0x100 ) : 0 ;
V_93 = V_65 [ 2 ] ? ( int ) ( ( V_65 [ 0 ] << 3 ) & 0x100 ) - ( int ) V_65 [ 2 ] : 0 ;
F_48 ( V_79 , V_113 , V_92 ) ;
F_48 ( V_79 , V_114 , V_93 ) ;
break;
}
F_49 ( V_79 ) ;
return V_115 ;
...
struct V_38 * V_39 = V_2 -> V_40 ;
if ( V_39 -> V_118 < V_119 ) {
F_54 ( V_112 , V_79 -> V_127 ) ;
F_54 ( V_110 , V_79 -> V_127 ) ;
F_54 ( V_111 , V_79 -> V_127 ) ;
F_54 ( V_108 , V_79 -> V_128 ) ;
F_54 ( V_109 , V_79 -> V_128 ) ;
} else {
int V_70 = 967 , V_71 = 711 ;
F_54 ( V_129 , V_79 -> V_130 ) ;
F_55 ( V_131 , V_79 -> V_130 ) ;
F_54 ( V_105 , V_79 -> V_127 ) ;
F_54 ( V_106 , V_79 -> V_127 ) ;
F_54 ( V_107 , V_79 -> V_127 ) ;
F_54 ( V_132 , V_79 -> V_133 ) ;
F_56 ( V_79 , V_101 , 0 , V_70 , 0 , 0 ) ;
F_56 ( V_79 , V_102 , 0 , V_71 , 0 , 0 ) ;
F_57 ( V_79 , 2 , 0 ) ;
F_56 ( V_79 , V_85 , 0 , V_70 , 0 , 0 ) ;
F_56 ( V_79 , V_86 , 0 , V_71 , 0 , 0 ) ;
}
return 0 ;
}
int F_58 ( struct V_2 * V_2 , bool V_134 )
{
int V_135 ;
...
V_2 -> V_40 = V_143 = F_66 ( sizeof( struct V_38 ) , V_144 ) ;
if ( ! V_143 )
return - V_145 ;
V_143 -> V_118 = V_118 ;
V_143 -> V_20 = V_20 ;
...
if ( error )
goto V_151;
error = F_67 ( & V_2 -> V_4 . V_140 -> V_79 . V_141 ,
& V_142 ) ;
if ( error ) {
F_20 ( V_2 ,
L_29 , error ) ;
