...
static void F_56 ( struct V_250 * V_251 , unsigned V_252 , int V_253 )
{
struct V_4 * V_5 = F_57 ( V_251 ) ;
F_42 ( V_5 -> V_20 , V_254 + V_252 ,
V_255 , ! ! V_253 << V_256 ) ;
}
static int F_58 ( struct V_250 * V_251 ,
...
static int F_59 ( struct V_250 * V_251 , unsigned V_252 )
{
struct V_4 * V_5 = F_57 ( V_251 ) ;
unsigned int V_38 ;
int V_57 ;
...
static void F_61 ( struct V_164 * V_165 )
{
struct V_4 * V_5 = F_62 ( V_165 ) ;
int V_57 ;
V_5 -> V_250 = V_261 ;
V_5 -> V_250 . V_262 = 6 ;
...
V_5 -> V_250 . V_70 = - 1 ;
V_57 = F_63 ( & V_5 -> V_250 , V_5 ) ;
if ( V_57 != 0 )
F_4 ( & V_165 -> V_10 , L_74 , V_57 ) ;
}
static void F_64 ( struct V_164 * V_165 )
{
struct V_4 * V_5 = F_62 ( V_165 ) ;
F_65 ( & V_5 -> V_250 ) ;
}
...
{
struct V_273 * V_18 = F_73 ( & V_165 -> V_10 ) ;
struct V_4 * V_5 ;
unsigned int V_38 ;
int V_57 , V_8 , V_274 ;
V_5 = F_74 ( & V_165 -> V_10 , sizeof( struct V_4 ) ,
V_275 ) ;
if ( V_5 == NULL )
return - V_276 ;
V_5 -> V_10 = & V_165 -> V_10 ;
V_5 -> V_20 = F_75 ( V_165 , & V_277 ) ;
if ( F_76 ( V_5 -> V_20 ) ) {
V_57 = F_77 ( V_5 -> V_20 ) ;
F_4 ( & V_165 -> V_10 , L_77 ,
V_57 ) ;
...
F_82 ( & V_165 -> V_10 , L_87 , V_5 -> V_287 + 'A' ) ;
V_57 = F_10 ( V_5 ) ;
if ( V_57 < 0 ) {
F_4 ( & V_165 -> V_10 , L_88 ) ;
goto V_285;
...
V_57 = F_84 ( V_165 -> V_196 , NULL ,
F_55 , V_274 ,
L_90 , V_5 ) ;
else
V_57 = F_84 ( V_165 -> V_196 , NULL , F_53 ,
V_274 , L_90 ,
V_5 ) ;
if ( V_57 != 0 ) {
F_4 ( & V_165 -> V_10 , L_91 ,
...
static int F_91 ( struct V_164 * V_165 )
{
struct V_4 * V_5 = F_62 ( V_165 ) ;
F_92 ( & V_165 -> V_10 ) ;
if ( V_165 -> V_196 )
...
static int F_93 ( struct V_310 * V_10 )
{
...
static int F_97 ( struct V_310 * V_10 )
{
struct V_4 * V_5 = F_94 ( V_10 ) ;
int V_57 ;
V_57 = F_81 ( F_3 ( V_5 -> V_279 ) ,
