...
long
F_154 ( struct V_145 * V_145 , unsigned int V_146 , unsigned long V_147 )
{
...
if ( V_20 < 0 && V_20 != - V_138 )
return V_20 ;
switch ( F_155 ( V_146 ) - V_151 ) {
case V_152 :
V_20 = F_156 ( V_148 , ( void V_153 * ) V_147 , F_157 ( V_146 ) ) ;
break;
default:
V_20 = F_158 ( V_145 , V_146 , V_147 ) ;
break;
}
F_88 ( V_11 -> V_11 ) ;
F_150 ( V_11 -> V_11 ) ;
...
struct V_10 *
F_160 ( const struct V_160 * V_161 ,
struct V_7 * V_2 ,
struct V_75 * * V_162 )
{
struct V_10 * V_18 ;
int V_163 ;
V_163 = F_161 ( V_161 , V_2 , V_23 , V_24 ,
true , true , ~ 0ULL , V_162 ) ;
if ( V_163 )
goto V_164;
V_18 = F_162 ( & V_165 , & V_2 -> V_11 ) ;
if ( F_163 ( V_18 ) ) {
V_163 = F_164 ( V_18 ) ;
goto V_164;
}
