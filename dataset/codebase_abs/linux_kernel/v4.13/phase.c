...
struct V_49 * V_50 )
{
static const char * const V_77 [ 2 ] = { L_1 , L_2 } ;
return F_42 ( V_50 , 1 , 2 , V_77 ) ;
}
static int F_43 ( struct V_39 * V_40 ,
struct V_41 * V_42 )
{
struct V_1 * V_2 = F_17 ( V_40 ) ;
V_42 -> V_44 . V_78 . V_79 [ 0 ] = ( F_12 ( V_2 , V_80 ) & 0x8 ) ==
0x8 ;
return 0 ;
}
...
for ( V_24 = 0 ; V_24 < F_46 ( V_84 ) ; V_24 ++ ) {
V_5 = F_47 ( V_2 -> V_83 ,
F_48 ( & V_84 [ V_24 ] , V_2 ) ) ;
if ( V_5 < 0 )
return V_5 ;
