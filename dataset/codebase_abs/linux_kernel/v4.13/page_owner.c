...
F_37 ( V_41 , L_2 , V_42 -> V_57 , V_43 -> V_58 ) ;
...
goto V_62;
F_41 ( V_28 , & V_24 ) ;
V_59 += F_42 ( V_60 + V_59 , V_26 - V_59 , & V_24 , 0 ) ;
if ( V_59 >= V_26 )
goto V_62;
if ( V_15 -> V_32 != - 1 ) {
V_59 += snprintf ( V_60 + V_59 , V_26 - V_59 ,
...
static T_5
F_49 ( struct V_68 * V_68 , char T_6 * V_1 , T_7 V_26 , T_8 * V_69 )
{
unsigned long V_44 ;
struct V_19 * V_19 ;
struct V_16 * V_16 ;
...
static void F_52 ( T_4 * V_42 , struct V_43 * V_43 )
{
struct V_19 * V_19 ;
struct V_16 * V_16 ;
unsigned long V_44 = V_43 -> V_45 , V_46 ;
