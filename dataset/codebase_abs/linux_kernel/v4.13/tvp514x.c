...
if ( ! V_187 )
return NULL ;
if ( F_34 ( F_35 ( V_187 ) , & V_185 ) )
goto V_193;
V_183 = F_36 ( & V_12 -> V_190 , sizeof( * V_183 ) , V_194 ) ;
if ( ! V_183 )
goto V_193;
...
static int
F_38 ( struct V_11 * V_12 , const struct V_203 * V_133 )
{
...
int V_204 ;
if ( V_183 == NULL ) {
F_39 ( & V_12 -> V_190 , L_16 ) ;
return - V_100 ;
}
if ( ! F_40 ( V_12 -> V_93 , V_205 ) )
return - V_206 ;
V_77 = F_36 ( & V_12 -> V_190 , sizeof( * V_77 ) , V_194 ) ;
if ( ! V_77 )
return - V_207 ;
* V_77 = V_208 ;
...
V_204 = F_43 ( & V_77 -> V_3 . V_215 , 1 , & V_77 -> V_167 ) ;
if ( V_204 < 0 ) {
F_15 ( V_3 , L_17 ,
V_3 -> V_91 ) ;
return V_204 ;
