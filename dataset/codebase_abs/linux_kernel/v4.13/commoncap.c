...
V_39 -> V_97 = V_39 -> V_98 = V_39 -> V_16 ;
V_39 -> V_99 = V_39 -> V_100 = V_39 -> V_90 ;
if ( V_52 || V_83 )
F_25 ( V_39 -> V_42 ) ;
...
if ( ! F_12 ( V_101 , V_39 -> V_11 ) ||
! F_5 ( V_39 -> V_16 , V_84 ) || ! F_5 ( V_39 -> V_86 , V_84 ) ||
F_40 ( V_85 ) ) {
V_25 = F_43 ( V_45 , V_39 , V_40 ) ;
if ( V_25 < 0 )
return V_25 ;
}
}
V_39 -> V_102 &= ~ F_44 ( V_103 ) ;
if ( F_22 ( ! F_23 ( V_39 ) ) )
return - V_12 ;
return 0 ;
}
...
int F_46 ( struct V_46 * V_46 , const char * V_104 ,
...
int F_47 ( struct V_46 * V_46 , const char * V_104 )
{
if ( ! strcmp ( V_104 , V_48 ) ) {
if ( ! F_7 ( V_107 ) )
return - V_12 ;
...
static inline void F_48 ( struct V_4 * V_39 , const struct V_4 * V_40 )
{
...
int F_49 ( struct V_4 * V_39 , const struct V_4 * V_40 , int V_106 )
{
switch ( V_106 ) {
case V_110 :
case V_111 :
...
if ( ! F_40 ( V_113 ) ) {
T_3 V_84 = F_39 ( V_40 -> V_10 , 0 ) ;
if ( F_5 ( V_40 -> V_98 , V_84 ) && ! F_5 ( V_39 -> V_98 , V_84 ) )
V_39 -> V_11 =
F_50 ( V_39 -> V_11 ) ;
if ( ! F_5 ( V_40 -> V_98 , V_84 ) && F_5 ( V_39 -> V_98 , V_84 ) )
V_39 -> V_11 =
...
static int F_52 ( struct V_22 * V_115 )
{
int V_116 , V_25 = 0 ;
F_9 () ;
V_116 = F_12 ( F_11 ( V_115 ) -> V_29 ,
F_10 () -> V_29 ) ;
...
int F_53 ( struct V_22 * V_115 )
{
return F_52 ( V_115 ) ;
}
int F_54 ( struct V_22 * V_115 , int V_118 )
{
return F_52 ( V_115 ) ;
}
int F_55 ( struct V_22 * V_115 , int V_119 )
{
return F_52 ( V_115 ) ;
}
static int F_56 ( unsigned long V_7 )
{
struct V_4 * V_39 ;
if ( ! F_13 ( F_57 () , V_37 ) )
return - V_12 ;
...
int F_62 ( int V_121 , unsigned long V_122 , unsigned long V_123 ,
...
if ( ! F_58 ( V_122 ) )
return - V_43 ;
return ! ! F_4 ( V_40 -> V_41 , V_122 ) ;
case V_127 :
return F_56 ( V_122 ) ;
case V_128 :
if ( ( ( ( V_40 -> V_102 & V_129 ) >> 1 )
& ( V_40 -> V_102 ^ V_122 ) )
|| ( ( V_40 -> V_102 & V_129 & ~ V_122 ) )
|| ( V_122 & ~ ( V_129 | V_130 ) )
|| ( F_3 ( F_10 () ,
F_10 () -> V_10 , V_37 ,
V_38 ) != 0 )
...
if ( ( ( ! F_58 ( V_123 ) ) | V_124 | V_125 ) )
return - V_43 ;
if ( V_122 == V_137 ) {
return ! ! F_4 ( F_10 () -> V_42 , V_123 ) ;
} else if ( V_122 != V_138 &&
V_122 != V_139 ) {
return - V_43 ;
} else {
...
return - V_120 ;
if ( V_122 == V_138 )
F_63 ( V_39 -> V_42 , V_123 ) ;
else
F_60 ( V_39 -> V_42 , V_123 ) ;
return F_61 ( V_39 ) ;
}
default:
return - V_141 ;
...
int F_64 ( struct V_142 * V_143 , long V_144 )
{
int V_145 = 0 ;
...
int F_66 ( struct V_75 * V_75 , unsigned long V_151 ,
unsigned long V_152 , unsigned long V_106 )
{
return 0 ;
}
void T_5 F_67 ( void )
{
F_68 ( V_153 , F_69 ( V_153 ) ,
L_6 ) ;
}
