...
V_11 -> V_21 = V_74 ;
V_11 -> V_75 = V_43 ;
V_69 = F_13 ( & V_43 -> V_44 , & V_8 , & V_9 ) ;
if ( V_69 < 0 )
goto error;
V_69 = F_13 ( & V_43 -> V_45 , & V_8 , & V_9 ) ;
if ( V_69 < 0 )
goto error;
V_69 = F_16 ( & V_43 -> V_46 , V_76 ,
& V_8 , & V_9 ) ;
if ( V_69 < 0 )
goto error;
if ( V_9 < 4 * 8 + 2 * 4 )
goto V_77;
V_43 -> V_78 = F_21 ( ( const V_79 * ) V_8 ) ;
V_8 += 2 ;
V_43 -> V_80 = F_21 ( ( const V_79 * ) V_8 ) ;
V_8 += 2 ;
V_43 -> V_81 = F_21 ( ( const V_79 * ) V_8 ) ;
V_8 += 2 ;
V_43 -> V_82 = F_21 ( ( const V_79 * ) V_8 ) ;
V_8 += 2 ;
V_43 -> V_83 = F_5 ( * V_8 ++ ) ;
V_43 -> V_84 = F_5 ( * V_8 ++ ) ;
V_9 -= 4 * 8 + 2 * 4 ;
...
goto error;
F_22 ( ( V_73 - V_8 ) << 2 , == , V_9 ) ;
V_69 = F_19 ( & V_43 -> V_30 , & V_43 -> V_23 ,
& V_8 , & V_9 ) ;
if ( V_69 < 0 )
goto error;
V_69 = F_19 ( & V_43 -> V_51 , & V_43 -> V_86 ,
& V_8 , & V_9 ) ;
if ( V_69 < 0 )
goto error;
F_22 ( ( V_73 - V_8 ) << 2 , == , V_9 ) ;
...
V_69 = F_48 ( V_107 , & V_32 , sizeof( V_32 ) , NULL , NULL ) ;
if ( V_69 < 0 )
goto error;
...
struct V_107 * F_51 ( const char * V_127 )
{
const struct V_122 * V_122 = F_45 () ;
struct V_107 * V_107 ;
int V_69 ;
V_107 = F_46 ( & V_116 , V_127 ,
V_123 , V_124 , V_122 ,
V_128 , V_125 , NULL ) ;
if ( F_31 ( V_107 ) )
return V_107 ;
V_69 = F_48 ( V_107 , NULL , 0 , NULL , NULL ) ;
if ( V_69 < 0 ) {
F_49 ( V_107 ) ;
F_50 ( V_107 ) ;
return F_52 ( V_69 ) ;
...
char T_6 * V_129 , T_1 V_130 )
{
const struct V_10 * V_11 ;
const struct V_34 * V_35 ;
T_1 V_131 ;
T_2 T_6 * V_8 , * V_132 ;
T_3 V_133 , V_134 , V_135 , V_136 , V_137 ;
T_5 V_138 [ V_95 ] ;
int V_36 ;
F_4 ( L_35 ) ;
...
case V_22 :
V_134 += 9 * 4 ;
V_134 += F_54 ( V_11 -> V_17 -> V_23 ) ;
break;
case V_74 :
V_35 = & V_11 -> V_75 -> V_44 ;
V_134 += 4 + V_35 -> V_38 * 4 ;
for ( V_36 = 0 ; V_36 < V_35 -> V_38 ; V_36 ++ )
V_134 += F_54 ( strlen ( V_35 -> V_37 [ V_36 ] ) ) ;
V_134 += 4 + F_54 ( strlen ( V_35 -> V_39 ) ) ;
V_35 = & V_11 -> V_75 -> V_45 ;
V_134 += 4 + V_35 -> V_38 * 4 ;
for ( V_36 = 0 ; V_36 < V_35 -> V_38 ; V_36 ++ )
V_134 += F_54 ( strlen ( V_35 -> V_37 [ V_36 ] ) ) ;
V_134 += 4 + F_54 ( strlen ( V_35 -> V_39 ) ) ;
V_134 += 8 + F_54 ( V_11 -> V_75 -> V_46 . V_63 ) ;
V_134 += 4 * 8 + 2 * 4 ;
V_134 += 4 + V_11 -> V_75 -> V_48 * 8 ;
for ( V_36 = 0 ; V_36 < V_11 -> V_75 -> V_48 ; V_36 ++ )
V_134 += F_54 ( V_11 -> V_75 -> V_47 [ V_36 ] . V_63 ) ;
V_134 += 4 + F_54 ( V_11 -> V_75 -> V_23 ) ;
V_134 += 4 + F_54 ( V_11 -> V_75 -> V_86 ) ;
V_134 += 4 + V_11 -> V_75 -> V_50 * 8 ;
for ( V_36 = 0 ; V_36 < V_11 -> V_75 -> V_50 ; V_36 ++ )
V_134 += F_54 ( V_11 -> V_75 -> V_49 [ V_36 ] . V_63 ) ;
break;
default:
F_27 () ;
continue;
...
F_58 ( V_35 -> V_37 [ V_36 ] ) ;
F_58 ( V_35 -> V_39 ) ;
F_55 ( V_11 -> V_75 -> V_46 . V_62 ) ;
F_56 ( V_11 -> V_75 -> V_46 . V_63 ,
V_11 -> V_75 -> V_46 . V_32 ) ;
F_57 ( V_11 -> V_75 -> V_78 ) ;
F_57 ( V_11 -> V_75 -> V_80 ) ;
F_57 ( V_11 -> V_75 -> V_81 ) ;
...
F_55 ( V_11 -> V_75 -> V_48 ) ;
for ( V_36 = 0 ; V_36 < V_11 -> V_75 -> V_48 ; V_36 ++ ) {
F_55 ( V_11 -> V_75 -> V_47 [ V_36 ] . V_62 ) ;
F_56 ( V_11 -> V_75 -> V_47 [ V_36 ] . V_63 ,
V_11 -> V_75 -> V_47 [ V_36 ] . V_32 ) ;
}
F_56 ( V_11 -> V_75 -> V_23 , V_11 -> V_75 -> V_30 ) ;
F_56 ( V_11 -> V_75 -> V_86 , V_11 -> V_75 -> V_51 ) ;
F_55 ( V_11 -> V_75 -> V_50 ) ;
for ( V_36 = 0 ; V_36 < V_11 -> V_75 -> V_50 ; V_36 ++ ) {
F_55 ( V_11 -> V_75 -> V_49 [ V_36 ] . V_62 ) ;
F_56 ( V_11 -> V_75 -> V_49 [ V_36 ] . V_63 ,
...
F_22 ( ( unsigned long ) V_8 - ( unsigned long ) V_132 , == ,
V_134 ) ;
}
#undef F_58
#undef F_56
