...
int F_130 ( struct V_126 * V_79 , struct V_127 * V_128 )
{
switch( V_79 -> V_129 . type ) {
#ifdef F_131
case V_130 :
if ( F_132 ( V_128 , V_79 -> V_129 . V_131 ) )
return - V_132 ;
break;
#endif
case V_133 :
if ( F_133 ( V_128 , V_79 -> V_129 . V_134 ) )
return - V_132 ;
break;
default:
F_134 () ;
...
static int T_7 F_135 ( struct V_121 * V_122 , enum V_39 V_40 )
{
struct V_126 * V_79 ;
F_129 ( V_122 , V_136 ) ;
do {
F_136 ( V_137 ) ;
F_137 ( & V_122 -> V_3 , V_40 ) ;
if ( F_2 ( V_122 -> V_124 ) )
F_138 () ;
F_27 ( & V_122 -> V_3 ) ;
V_40 = V_98 ;
} while ( V_122 -> V_124 && ! F_139 ( V_136 ) );
F_140 ( V_138 ) ;
if ( ! V_122 -> V_124 )
return 0 ;
V_79 = & V_136 -> V_126 ;
if ( V_79 -> V_129 . type != V_139 ) {
T_1 V_92 = F_102 ( & V_122 -> V_3 ) ;
struct V_127 V_140 ;
if ( V_92 <= 0 )
return 0 ;
V_140 = F_141 ( V_92 ) ;
return F_130 ( V_79 , & V_140 ) ;
}
return - V_135 ;
}
static long T_7 F_142 ( struct V_126 * V_79 )
{
struct V_121 V_122 ;
int V_90 ;
F_39 ( & V_122 . V_3 , V_79 -> V_129 . V_41 ,
V_98 ) ;
F_143 ( & V_122 . V_3 , V_79 -> V_129 . V_10 ) ;
V_90 = F_135 ( & V_122 , V_98 ) ;
F_42 ( & V_122 . V_3 ) ;
return V_90 ;
}
long F_144 ( const struct V_127 * V_141 ,
...
T_3 V_142 ;
V_142 = V_136 -> V_143 ;
if ( F_145 ( V_136 ) || F_146 ( V_136 ) )
V_142 = 0 ;
F_39 ( & V_122 . V_3 , V_41 , V_40 ) ;
F_94 ( & V_122 . V_3 , F_147 ( * V_141 ) , V_142 ) ;
V_90 = F_135 ( & V_122 , V_40 ) ;
if ( V_90 != - V_135 )
goto V_144;
if ( V_40 == V_98 ) {
V_90 = - V_145 ;
...
V_79 = & V_136 -> V_126 ;
V_79 -> V_103 = F_142 ;
V_79 -> V_129 . V_41 = V_122 . V_3 . V_5 -> V_41 ;
V_79 -> V_129 . V_10 = F_64 ( & V_122 . V_3 ) ;
V_144:
F_42 ( & V_122 . V_3 ) ;
return V_90 ;
}
int F_148 ( unsigned int V_63 )
{
struct V_14 * V_7 = & F_11 ( V_17 , V_63 ) ;
int V_146 ;
for ( V_146 = 0 ; V_146 < V_95 ; V_146 ++ ) {
V_7 -> V_23 [ V_146 ] . V_7 = V_7 ;
F_149 ( & V_7 -> V_23 [ V_146 ] . V_43 ) ;
}
V_7 -> V_63 = V_63 ;
F_65 ( V_7 ) ;
return 0 ;
}
static void F_150 ( struct V_1 * V_147 ,
struct V_1 * V_9 )
{
struct V_2 * V_3 ;
struct V_46 * V_48 ;
while ( ( V_48 = F_51 ( & V_147 -> V_43 ) ) ) {
V_3 = F_52 ( V_48 , struct V_2 , V_48 ) ;
F_121 ( F_16 ( V_3 ) ) ;
F_47 ( V_3 ) ;
F_87 ( V_3 , V_147 , V_75 , 0 ) ;
V_3 -> V_5 = V_9 ;
F_85 ( V_3 , V_9 ) ;
}
}
int F_151 ( unsigned int V_148 )
{
struct V_14 * V_147 , * V_9 ;
int V_146 ;
F_121 ( F_152 ( V_148 ) ) ;
F_153 ( V_148 ) ;
F_154 () ;
V_147 = & F_11 ( V_17 , V_148 ) ;
V_9 = F_14 ( & V_17 ) ;
F_18 ( & V_9 -> V_8 ) ;
F_155 ( & V_147 -> V_8 , V_149 ) ;
for ( V_146 = 0 ; V_146 < V_95 ; V_146 ++ ) {
F_150 ( & V_147 -> V_23 [ V_146 ] ,
& V_9 -> V_23 [ V_146 ] ) ;
}
F_17 ( & V_147 -> V_8 ) ;
F_17 ( & V_9 -> V_8 ) ;
...
F_42 ( & V_122 . V_3 ) ;
F_140 ( V_138 ) ;
return ! V_122 . V_124 ? 0 : - V_150 ;
}
int T_7 F_161 ( T_1 * V_10 , T_3 V_74 ,
const enum V_39 V_40 )
{
return F_159 ( V_10 , V_74 , V_40 ,
V_99 ) ;
}
int T_7 F_162 ( T_1 * V_10 ,
const enum V_39 V_40 )
{
return F_161 ( V_10 , 0 , V_40 ) ;
}
