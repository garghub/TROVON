...
static int F_68 ( bool V_90 )
{
int V_137 ;
if ( V_90 ) {
V_137 = F_69 ( V_138 , 1 , false ) ;
if ( V_137 < 0 )
F_70 ( L_1 , V_137 ) ;
} else {
V_137 = F_69 ( V_139 ,
...
static struct V_3 * F_71 ( struct V_1 * V_2 ,
struct V_141 * V_142 ,
bool V_90 )
{
struct V_3 * V_3 ;
...
V_147 -= V_139 ;
F_76 ( & V_3 -> V_2 , L_4 , V_147 ) ;
V_3 -> V_102 = F_31 ;
V_3 -> V_96 = F_35 ;
}
V_3 -> V_87 = true ;
V_3 -> V_70 . V_2 = F_77 ( V_2 ) ;
V_3 -> V_70 . V_148 = F_78 ( & V_3 -> V_2 ) ;
V_3 -> V_70 . V_142 = V_142 ;
V_3 -> V_70 . V_71 = V_3 ;
V_3 -> V_2 . V_149 = & V_150 ;
if ( V_2 )
V_3 -> V_2 . V_151 = & V_2 -> V_2 ;
V_3 -> V_2 . V_152 = F_79 ( V_153 , V_137 ) ;
V_3 -> V_2 . V_154 = F_27 ;
F_80 ( & V_3 -> V_2 ) ;
if ( ! V_90 ) {
error = F_81 ( & V_3 -> V_70 ) ;
...
{
F_89 ( & V_3 -> V_99 , & V_3 -> V_2 ) ;
F_67 ( V_3 ) ;
F_86 ( F_90 ( V_3 -> V_2 . V_152 ) ) ;
if ( V_3 != V_46 )
F_84 ( & V_3 -> V_70 ) ;
F_85 ( & V_3 -> V_2 ) ;
}
...
static void F_99 ( struct V_69 * V_70 )
{
struct V_3 * V_3 = V_70 -> V_71 ;
F_94 ( V_3 ) ;
F_88 ( V_3 ) ;
