...
V_40 = F_16 ( V_41 , & V_6 -> V_42 ) ;
if ( ! V_40 )
return - V_43 ;
V_30 = & V_37 [ V_40 -> V_38 ] ;
}
V_32 = F_17 ( V_6 -> V_42 . V_44 ) ;
V_34 = F_18 ( & V_6 -> V_42 ) ;
if ( ( V_6 -> V_45 & ~ ( ( 1 << V_30 -> V_46 ) - 1 ) ) !=
V_30 -> V_47 ) {
F_19 ( & V_6 -> V_42 , L_1 ,
V_6 -> V_45 ) ;
return - V_43 ;
...
F_20 ( & V_6 -> V_42 , L_2
L_3 ,
V_6 -> V_48 , V_30 -> V_1 , V_6 -> V_45 ) ;
if ( ! F_21 ( V_32 , V_49 ) )
return - V_50 ;
if ( V_34 ) {
if ( V_34 -> V_51 != V_30 -> V_1 ) {
F_19 ( & V_6 -> V_42 , L_4
L_5 ,
V_34 -> V_51 , V_30 -> V_1 ) ;
return - V_43 ;
...
V_9 = F_22 ( & V_6 -> V_42 , sizeof( * V_9 ) , V_52 ) ;
if ( ! V_9 )
return - V_53 ;
V_9 -> V_54 = F_22 ( & V_6 -> V_42 ,
sizeof( * V_15 ) * V_30 -> V_1 , V_52 ) ;
if ( ! V_9 -> V_54 )
return - V_53 ;
F_23 ( V_6 , V_9 ) ;
F_24 ( & V_9 -> V_19 ) ;
...
V_15 -> V_9 = V_9 ;
if ( V_34 ) {
if ( V_34 -> V_54 [ V_35 ] . V_48 )
snprintf ( V_15 -> V_48 ,
sizeof( V_15 -> V_48 ) , L_6 ,
V_34 -> V_54 [ V_35 ] . V_48 ) ;
if ( V_34 -> V_54 [ V_35 ] . V_55 )
V_15 -> V_12 . V_55 =
V_34 -> V_54 [ V_35 ] . V_55 ;
} else {
snprintf ( V_15 -> V_48 , sizeof( V_15 -> V_48 ) ,
L_7 , V_35 ) ;
}
V_15 -> V_12 . V_48 = V_15 -> V_48 ;
V_15 -> V_12 . V_56 = F_11 ;
V_36 = F_25 ( & V_6 -> V_42 ,
& V_15 -> V_12 ) ;
if ( V_36 < 0 )
