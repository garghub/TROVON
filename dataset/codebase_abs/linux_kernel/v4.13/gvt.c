...
if ( F_27 ( V_14 -> V_41 ) ) {
F_28 ( L_7 ) ;
return F_29 ( V_14 -> V_41 ) ;
}
return 0 ;
}
void F_30 ( struct V_42 * V_20 )
{
struct V_13 * V_14 = F_31 ( V_20 ) ;
if ( F_32 ( ! V_14 ) )
return;
F_22 ( V_14 ) ;
F_33 ( V_14 ) ;
...
if ( F_32 ( V_20 -> V_14 ) )
return - V_48 ;
V_14 = F_47 ( sizeof( struct V_13 ) , V_49 ) ;
if ( ! V_14 )
return - V_50 ;
F_7 ( L_8 ) ;
F_48 ( & V_14 -> V_44 ) ;
...
if ( V_34 )
goto V_62;
V_34 = F_60 ( & V_20 -> V_21 . V_19 -> V_43 , V_14 ,
& V_63 ) ;
if ( V_34 ) {
F_28 ( L_9 , V_34 ) ;
goto V_64;
