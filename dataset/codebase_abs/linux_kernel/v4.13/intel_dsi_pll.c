...
static void F_27 ( enum V_2 V_3 , int V_61 )
{
int V_6 = F_2 ( V_3 ) ;
F_28 ( V_6 != V_61 ,
L_9 ,
...
static T_1 F_29 ( struct V_32 * V_33 , int V_61 ,
struct V_9 * V_10 )
{
struct V_7 * V_8 = F_9 ( V_33 -> V_34 . V_35 ) ;
struct V_36 * V_36 = F_10 ( & V_33 -> V_34 ) ;
...
for ( V_66 = 0 ; V_66 < F_30 ( V_30 ) ; V_66 ++ ) {
if ( V_30 [ V_66 ] == V_64 )
break;
}
if ( V_66 == F_30 ( V_30 ) ) {
...
static T_1 F_31 ( struct V_32 * V_33 , int V_61 ,
struct V_9 * V_10 )
{
T_1 V_1 ;
T_1 V_38 ;
...
T_1 F_32 ( struct V_32 * V_33 , int V_61 ,
struct V_9 * V_10 )
{
if ( F_33 ( F_9 ( V_33 -> V_34 . V_35 ) ) )
return F_31 ( V_33 , V_61 , V_10 ) ;
else
return F_29 ( V_33 , V_61 , V_10 ) ;
}
static void F_34 ( struct V_32 * V_33 , enum V_73 V_73 )
{
T_1 V_74 ;
struct V_7 * V_8 = F_9 ( V_33 -> V_34 . V_35 ) ;
struct V_36 * V_36 = F_10 ( & V_33 -> V_34 ) ;
...
static void F_36 ( struct V_78 * V_35 ,
const struct V_9 * V_10 )
{
...
if ( V_82 <= 10 )
V_84 = V_82 ;
else if ( ( V_82 > 10 ) && ( V_82 <= 20 ) )
V_84 = F_37 ( V_82 , 2 ) ;
else if ( ( V_82 > 20 ) && ( V_82 <= 30 ) )
V_84 = F_37 ( V_82 , 4 ) ;
else if ( ( V_82 > 30 ) && ( V_82 <= 40 ) )
V_84 = F_37 ( V_82 , 6 ) ;
else if ( ( V_82 > 40 ) && ( V_82 <= 50 ) )
V_84 = F_37 ( V_82 , 8 ) ;
else
V_84 = 10 ;
V_83 = F_37 ( V_82 , V_84 ) ;
...
static void F_38 ( struct V_78 * V_35 , enum V_73 V_73 ,
const struct V_9 * V_10 )
{
struct V_7 * V_8 = F_9 ( V_35 ) ;
T_1 V_50 ;
...
V_80 = V_10 -> V_26 . V_27 & V_71 ;
V_79 = ( V_72 * V_80 ) / 2 ;
V_91 = F_37 ( V_79 , 20000 ) - 1 ;
V_90 = F_37 ( V_79 , 150000 ) - 1 ;
V_93 = V_90 & V_96 ;
V_92 = ( V_90 & V_97 ) >> 2 ;
V_94 = 0x2 ;
V_50 |= F_43 ( V_73 , V_94 ) ;
...
if ( V_70 < V_98 || V_70 > V_99 ) {
F_5 ( L_14 ) ;
return - V_23 ;
} else
F_11 ( L_15 ) ;
V_10 -> V_26 . V_27 = V_70 | V_104 | V_105 ;
if ( F_48 ( V_8 ) && V_70 <= 50 )
V_10 -> V_26 . V_27 |= V_106 ;
return 0 ;
}
...
T_1 V_53 ;
F_11 ( L_4 ) ;
F_25 ( V_58 , V_10 -> V_26 . V_27 ) ;
F_50 ( V_58 ) ;
if ( F_48 ( V_8 ) ) {
F_51 (port, intel_dsi->ports)
F_38 ( V_33 -> V_34 . V_35 , V_73 , V_10 ) ;
} else {
F_36 ( V_33 -> V_34 . V_35 , V_10 ) ;
}
V_53 = F_21 ( V_57 ) ;
V_53 |= V_55 ;
F_25 ( V_57 , V_53 ) ;
...
F_25 ( F_60 ( V_73 ) , V_108 ) ;
}
void F_61 ( struct V_32 * V_33 , enum V_73 V_73 )
{
struct V_7 * V_8 = F_9 ( V_33 -> V_34 . V_35 ) ;
if ( F_33 ( V_8 ) )
F_59 ( V_33 , V_73 ) ;
else if ( F_56 ( V_8 ) || F_6 ( V_8 ) )
F_34 ( V_33 , V_73 ) ;
}
