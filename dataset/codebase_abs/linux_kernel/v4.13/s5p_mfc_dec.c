...
static int F_60 ( struct V_184 * V_185 )
{
struct V_186 * V_187 = F_61 ( V_185 ) ;
struct V_171 * V_172 = V_185 -> V_171 ;
struct V_12 * V_13 = F_13 ( V_172 -> V_178 ) ;
unsigned int V_5 ;
if ( V_172 -> type == V_58 ) {
if ( V_13 -> V_22 == V_23 )
...
if ( F_65 ( V_185 , 0 ) < V_13 -> V_72 ||
F_65 ( V_185 , 1 ) < V_13 -> V_73 ) {
F_16 ( L_39 ) ;
return - V_54 ;
}
V_5 = V_185 -> V_53 ;
V_13 -> V_122 [ V_5 ] . V_188 = V_187 ;
V_13 -> V_122 [ V_5 ] . V_189 . V_190 . V_191 =
F_64 ( V_185 , 0 ) ;
V_13 -> V_122 [ V_5 ] . V_189 . V_190 . V_192 =
F_64 ( V_185 , 1 ) ;
V_13 -> V_99 ++ ;
} else if ( V_172 -> type == V_74 ) {
if ( F_62 ( F_63 (
...
if ( F_65 ( V_185 , 0 ) < V_13 -> V_75 ) {
F_16 ( L_41 ) ;
return - V_54 ;
}
V_5 = V_185 -> V_53 ;
V_13 -> V_193 [ V_5 ] . V_188 = V_187 ;
...
static int F_66 ( struct V_171 * V_195 , unsigned int V_92 )
{
struct V_12 * V_13 = F_13 ( V_195 -> V_178 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
F_67 ( & V_13 -> V_196 ) ;
if ( V_13 -> V_15 == V_20 ||
V_13 -> V_15 == V_121 )
...
static void F_68 ( struct V_171 * V_195 )
{
unsigned long V_123 ;
struct V_12 * V_13 = F_13 ( V_195 -> V_178 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
...
static void F_71 ( struct V_184 * V_185 )
{
struct V_171 * V_172 = V_185 -> V_171 ;
struct V_12 * V_13 = F_13 ( V_172 -> V_178 ) ;
struct V_31 * V_32 = V_13 -> V_32 ;
...
struct V_160 * V_207 ;
if ( V_172 -> type == V_74 ) {
V_207 = & V_13 -> V_193 [ V_185 -> V_53 ] ;
V_207 -> V_123 &= ~ V_166 ;
F_51 ( & V_32 -> V_162 , V_123 ) ;
F_72 ( & V_207 -> V_165 , & V_13 -> V_163 ) ;
V_13 -> V_14 ++ ;
F_53 ( & V_32 -> V_162 , V_123 ) ;
} else if ( V_172 -> type == V_58 ) {
V_207 = & V_13 -> V_122 [ V_185 -> V_53 ] ;
V_207 -> V_123 &= ~ V_166 ;
F_51 ( & V_32 -> V_162 , V_123 ) ;
F_73 ( V_185 -> V_53 , & V_13 -> V_204 ) ;
F_72 ( & V_207 -> V_165 , & V_13 -> V_202 ) ;
V_13 -> V_18 ++ ;
F_53 ( & V_32 -> V_162 , V_123 ) ;
} else {
...
const struct V_208 * F_74 ( void )
{
return & V_209 ;
}
struct V_210 * F_75 ( void )
{
return & V_211 ;
}
const struct V_212 * F_76 ( void )
{
return & V_213 ;
}
