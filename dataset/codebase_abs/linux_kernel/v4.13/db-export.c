...
static int F_24 ( struct V_1 * V_2 , struct V_41 * V_42 ,
...
* V_43 = V_33 -> V_15 ;
if ( ! V_42 -> V_37 ) {
V_42 -> V_37 = F_25 ( V_42 -> V_46 , 0 , 0 , L_1 ) ;
if ( V_42 -> V_37 )
F_26 ( V_33 , V_42 -> V_45 -> type , V_42 -> V_37 ) ;
}
if ( V_42 -> V_37 ) {
...
static struct V_48 * F_27 ( struct V_1 * V_2 ,
struct V_18 * V_18 ,
struct V_21 * V_21 ,
struct V_49 * V_50 ,
struct V_13 * V_14 )
...
V_42 . V_37 = F_32 ( V_42 . V_45 -> V_33 , V_66 ,
V_42 . V_46 ) ;
F_24 ( V_2 , & V_42 , & V_43 , & V_38 , & V_44 ) ;
V_52 = F_33 ( V_2 -> V_53 , V_52 ,
V_42 . V_37 , V_8 -> V_65 ,
V_51 ) ;
F_34 ( & V_62 ) ;
}
...
int F_35 ( struct V_1 * V_2 , T_2 V_67 ,
const char * V_68 )
{
if ( V_2 -> V_69 )
...
int F_36 ( struct V_1 * V_2 , union V_70 * V_71 ,
...
if ( V_5 )
return V_5 ;
V_22 = F_37 ( V_42 -> V_18 , V_21 ) ;
if ( V_22 )
V_10 = F_38 ( V_42 -> V_18 , V_22 ) ;
...
V_73 . V_15 = ++ V_2 -> V_75 ;
V_5 = F_24 ( V_2 , V_42 , & V_73 . V_43 , & V_73 . V_38 , & V_73 . V_44 ) ;
if ( V_5 )
goto V_27;
if ( V_2 -> V_53 ) {
struct V_48 * V_76 = F_27 ( V_2 , V_42 -> V_18 ,
V_21 , V_50 ,
V_14 ) ;
if ( V_76 ) {
F_39 ( V_2 , V_76 ) ;
...
struct V_41 V_81 ;
F_41 ( V_21 , & V_81 , V_50 ) ;
V_5 = F_24 ( V_2 , & V_81 , & V_73 . V_82 ,
& V_73 . V_83 , & V_73 . V_84 ) ;
if ( V_5 )
goto V_27;
if ( V_2 -> V_12 ) {
V_5 = F_42 ( V_21 , V_10 , V_50 , V_42 ,
& V_81 , V_73 . V_15 ,
V_2 -> V_12 ) ;
if ( V_5 )
goto V_27;
...
int F_39 ( struct V_1 * V_2 , struct V_48 * V_76 )
{
int V_5 ;
if ( V_76 -> V_15 )
return 0 ;
if ( V_76 -> V_87 ) {
V_5 = F_39 ( V_2 , V_76 -> V_87 ) ;
if ( V_5 )
return V_5 ;
}
V_76 -> V_15 = ++ V_2 -> V_88 ;
...
int F_44 ( struct V_1 * V_2 , struct V_90 * V_91 )
{
int V_5 ;
if ( V_91 -> V_15 )
return 0 ;
V_5 = F_39 ( V_2 , V_91 -> V_76 ) ;
if ( V_5 )
return V_5 ;
V_91 -> V_15 = ++ V_2 -> V_92 ;
if ( V_2 -> V_93 )
