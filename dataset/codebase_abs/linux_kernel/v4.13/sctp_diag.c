...
V_62 = F_11 ( V_61 ) ;
F_9 (laddr, address_list, list) {
memcpy ( V_62 , & V_8 -> V_23 , sizeof( V_8 -> V_23 ) ) ;
memset ( V_62 + sizeof( V_8 -> V_23 ) , 0 , V_57 - sizeof( V_8 -> V_23 ) ) ;
V_62 += V_57 ;
}
return 0 ;
}
...
transports) {
memcpy ( V_62 , & V_66 -> V_24 , sizeof( V_66 -> V_24 ) ) ;
memset ( V_62 + sizeof( V_66 -> V_24 ) , 0 ,
V_57 - sizeof( V_66 -> V_24 ) ) ;
V_62 += V_57 ;
}
return 0 ;
}
...
if ( ! F_15 ( V_4 ) -> V_80 )
goto V_138;
F_13 (assoc, &sctp_sk(sk)->ep->asocs, asocs) {
