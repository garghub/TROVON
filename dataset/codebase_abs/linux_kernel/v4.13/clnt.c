...
T_4 F_126 ( struct V_1 * V_2 , struct V_207 * V_208 , T_4 V_209 )
{
T_4 V_210 ;
struct V_38 * V_39 ;
F_80 () ;
...
const char * F_127 ( struct V_1 * V_2 ,
enum V_212 V_213 )
{
struct V_38 * V_39 ;
V_39 = F_81 ( V_2 -> V_44 ) ;
...
static int F_128 ( struct V_3 * V_3 , struct V_207 * V_215 , T_4 V_216 ,
struct V_207 * V_208 , int V_217 )
{
struct V_218 * V_219 ;
int V_57 ;
V_57 = F_129 ( V_3 , V_215 -> V_133 ,
V_220 , V_221 , & V_219 , 1 ) ;
if ( V_57 < 0 ) {
F_45 ( L_22 , V_57 ) ;
goto V_58;
...
V_57 = F_131 ( V_219 , V_215 , V_216 , 0 ) ;
if ( V_57 < 0 ) {
F_45 ( L_24 , V_57 ) ;
goto V_225;
}
V_57 = F_132 ( V_219 , V_208 , & V_217 ) ;
if ( V_57 < 0 ) {
F_45 ( L_25 , V_57 ) ;
goto V_225;
}
...
static int F_134 ( int V_227 , struct V_207 * V_208 , T_4 V_217 )
{
switch ( V_227 ) {
case V_136 :
...
int F_135 ( struct V_1 * V_2 , struct V_207 * V_208 , T_4 V_217 )
{
struct V_228 V_120 ;
...
V_3 = F_136 ( V_39 -> V_229 ) ;
F_82 () ;
F_137 ( V_215 , 0 ) ;
V_57 = F_128 ( V_3 , V_215 , V_216 , V_208 , V_217 ) ;
F_138 ( V_3 ) ;
if ( V_57 != 0 )
return F_134 ( V_215 -> V_133 , V_208 , V_217 ) ;
return 0 ;
}
void
F_139 ( struct V_1 * V_2 , unsigned int V_230 , unsigned int V_231 )
{
struct V_38 * V_39 ;
F_80 () ;
V_39 = F_81 ( V_2 -> V_44 ) ;
...
{
struct V_1 * V_2 = V_165 -> V_166 ;
int V_242 = V_165 -> V_175 . V_176 -> V_243 ;
F_45 ( L_31 , V_165 -> V_244 ,
V_2 -> V_16 -> V_18 , V_2 -> V_86 ,
F_148 ( V_165 ) ,
( F_149 ( V_165 ) ? L_32 : L_33 ) ) ;
if ( V_2 -> V_16 -> V_71 [ V_2 -> V_86 ] )
V_2 -> V_16 -> V_71 [ V_2 -> V_86 ] -> V_245 [ V_242 ] ++ ;
V_2 -> V_87 -> V_246 ++ ;
V_165 -> V_183 = V_247 ;
}
static void
...
F_45 ( L_38 ,
V_165 -> V_244 , V_30 , V_187 ) ;
F_98 ( V_165 , V_187 ) ;
}
static void
V_253 ( struct V_156 * V_165 )
{
unsigned int V_258 = V_165 -> V_199 -> V_259 -> V_260 -> V_261 ;
struct V_193 * V_194 = V_165 -> V_199 ;
struct V_38 * V_39 = V_194 -> V_262 ;
const struct V_239 * V_240 = V_165 -> V_175 . V_176 ;
int V_187 ;
F_150 ( V_165 ) ;
V_165 -> V_190 = 0 ;
...
V_194 -> V_269 = V_270 + ( V_258 << 1 ) + V_240 -> V_266 ;
V_194 -> V_269 <<= 2 ;
V_194 -> V_271 = V_272 + V_258 + V_240 -> V_268 ;
V_194 -> V_271 <<= 2 ;
V_187 = V_39 -> V_232 -> V_273 ( V_165 ) ;
F_158 ( V_39 ) ;
if ( V_187 == 0 )
return;
if ( V_187 != - V_77 ) {
...
F_45 ( L_39 , V_165 -> V_244 ) ;
if ( F_149 ( V_165 ) || ! F_159 ( V_274 ) ) {
V_165 -> V_183 = V_253 ;
F_153 ( V_165 , V_163 >> 4 ) ;
return;
}
...
static void
V_263 ( struct V_156 * V_165 )
{
struct V_38 * V_39 = V_165 -> V_199 -> V_262 ;
F_150 ( V_165 ) ;
V_165 -> V_183 = V_282 ;
if ( ! F_38 ( V_39 ) ) {
V_165 -> V_183 = V_283 ;
V_165 -> V_284 = V_39 -> V_285 ;
V_39 -> V_232 -> V_286 ( V_165 ) ;
}
}
static void
V_283 ( struct V_156 * V_165 )
{
int V_187 = - V_160 ;
if ( V_165 -> V_190 >= 0 ) {
F_150 ( V_165 ) ;
...
switch ( V_165 -> V_190 ) {
case - V_77 :
F_45 ( L_41 , V_165 -> V_244 ) ;
F_153 ( V_165 , V_163 >> 2 ) ;
goto V_287;
case - V_255 :
F_45 ( L_42
L_43 , V_165 -> V_244 ) ;
if ( V_165 -> V_175 . V_176 -> V_265 == 0 ) {
V_187 = - V_288 ;
break;
}
if ( V_165 -> V_289 == 0 )
...
F_45 ( L_49 ,
V_165 -> V_244 , V_39 ,
( F_168 ( V_39 ) ? L_50 : L_51 ) ) ;
V_165 -> V_183 = V_302 ;
if ( ! F_168 ( V_39 ) ) {
V_165 -> V_183 = V_303 ;
if ( V_165 -> V_190 < 0 )
return;
if ( V_165 -> V_158 & V_304 ) {
F_98 ( V_165 , - V_295 ) ;
return;
}
F_169 ( V_165 ) ;
...
return;
if ( V_308 )
V_165 -> V_166 -> V_87 -> V_311 ++ ;
V_310 ( V_165 ) ;
if ( F_175 ( V_165 ) )
return;
V_165 -> V_183 = V_312 ;
F_100 ( & V_165 -> V_199 -> V_262 -> V_313 , V_165 ) ;
}
static void
V_310 ( struct V_156 * V_165 )
{
V_165 -> V_183 = V_309 ;
if ( V_165 -> V_190 == 0 ) {
F_176 ( V_165 ) ;
...
if ( V_194 -> V_306 != V_194 -> V_262 -> V_318 )
V_194 -> V_276 = 0 ;
F_174 ( V_165 ) ;
if ( V_165 -> V_190 == - V_153 )
goto V_319;
...
F_100 ( & V_194 -> V_262 -> V_313 , V_165 ) ;
V_317:
V_165 -> V_183 = V_312 ;
return;
V_319:
V_194 -> V_306 = V_194 -> V_262 -> V_318 ;
V_315:
V_165 -> V_190 = 0 ;
}
static void
V_309 ( struct V_156 * V_165 )
{
struct V_1 * V_2 = V_165 -> V_166 ;
struct V_193 * V_194 = V_165 -> V_199 ;
int V_187 ;
if ( V_194 -> V_320 > 0 && ! V_194 -> V_276 )
V_165 -> V_190 = V_194 -> V_320 ;
F_150 ( V_165 ) ;
V_187 = V_165 -> V_190 ;
if ( V_187 >= 0 ) {
V_165 -> V_183 = V_321 ;
...
F_45 ( L_55 , V_165 -> V_244 ) ;
goto V_322;
}
F_45 ( L_56 , V_165 -> V_244 ) ;
V_165 -> V_323 ++ ;
if ( F_167 ( V_165 ) ) {
F_98 ( V_165 , - V_254 ) ;
return;
...
static void
V_321 ( struct V_156 * V_165 )
{
struct V_1 * V_2 = V_165 -> V_166 ;
struct V_193 * V_194 = V_165 -> V_199 ;
T_7 V_326 = V_165 -> V_175 . V_176 -> V_267 ;
T_6 * V_278 ;
F_150 ( V_165 ) ;
if ( V_165 -> V_158 & V_325 ) {
if ( V_2 -> V_113 ) {
...
F_181 () ;
V_194 -> V_279 . V_200 = V_194 -> V_327 . V_200 ;
F_182 ( memcmp ( & V_194 -> V_279 , & V_194 -> V_327 ,
...
V_165 -> V_183 = V_312 ;
if ( V_326 ) {
V_165 -> V_190 = F_184 ( V_165 , V_326 , V_194 , V_278 ,
V_165 -> V_175 . V_178 ) ;
}
F_45 ( L_61 , V_165 -> V_244 ,
V_165 -> V_190 ) ;
return;
V_315:
V_165 -> V_190 = 0 ;
if ( V_165 -> V_199 == V_194 ) {
V_194 -> V_320 = V_194 -> V_279 . V_200 = 0 ;
...
struct V_1 * V_2 = V_165 -> V_166 ;
struct V_193 * V_194 = V_165 -> V_199 ;
T_6 * V_278 = V_194 -> V_328 [ 0 ] . V_329 ;
V_278 = F_185 ( V_194 -> V_262 , V_278 ) ;
* V_278 ++ = V_194 -> V_330 ;
* V_278 ++ = F_186 ( V_331 ) ;
* V_278 ++ = F_186 ( V_332 ) ;
* V_278 ++ = F_186 ( V_2 -> V_83 ) ;
* V_278 ++ = F_186 ( V_2 -> V_86 ) ;
* V_278 ++ = F_186 ( V_165 -> V_175 . V_176 -> V_265 ) ;
V_278 = F_187 ( V_165 , V_278 ) ;
V_194 -> V_333 = F_188 ( & V_194 -> V_328 [ 0 ] , V_278 ) ;
return V_278 ;
}
static T_6 *
...
{
struct V_1 * V_2 = V_165 -> V_166 ;
struct V_334 * V_335 = & V_165 -> V_199 -> V_279 . V_201 [ 0 ] ;
int V_200 = V_165 -> V_199 -> V_279 . V_200 >> 2 ;
T_6 * V_278 = V_335 -> V_329 ;
T_3 V_336 ;
int error = - V_255 ;
if ( ( V_165 -> V_199 -> V_279 . V_200 & 3 ) != 0 ) {
F_45 ( L_62
L_63 , V_165 -> V_244 , V_30 ,
...
goto V_337;
V_278 += 1 ;
if ( ( V_336 = F_189 ( * V_278 ++ ) ) != V_338 ) {
F_45 ( L_64 ,
V_165 -> V_244 , V_30 , V_336 ) ;
error = - V_160 ;
goto V_339;
}
if ( ( V_336 = F_189 ( * V_278 ++ ) ) != V_340 ) {
if ( -- V_200 < 0 )
goto V_337;
switch ( ( V_336 = F_189 ( * V_278 ++ ) ) ) {
case V_341 :
break;
case V_342 :
F_45 ( L_65 ,
...
error = F_21 ( V_278 ) ;
F_45 ( L_74 ,
V_165 -> V_244 , V_30 , error ) ;
goto V_339;
}
V_200 = V_278 - ( T_6 * ) V_335 -> V_329 - 1 ;
if ( V_200 < 0 )
goto V_337;
switch ( ( V_336 = F_189 ( * V_278 ++ ) ) ) {
case V_351 :
...
V_76:
F_98 ( V_165 , error ) ;
F_45 ( L_83 , V_165 -> V_244 ,
V_30 , error ) ;
return F_19 ( error ) ;
V_337:
F_45 ( L_84 , V_165 -> V_244 ,
V_30 ) ;
goto V_339;
}
static void F_191 ( struct V_193 * V_357 , struct V_358 * V_359 ,
const void * V_360 )
{
}
static int F_192 ( struct V_193 * V_357 , struct V_358 * V_359 ,
void * V_360 )
{
return 0 ;
}
...
int V_57 ;
V_174 . V_179 = V_362 . V_363 ( NULL , NULL , 0 ) ;
...
struct V_38 * V_39 , struct V_179 * V_364 , int V_103 ,
...
struct V_156 * F_195 ( struct V_1 * V_2 , struct V_179 * V_364 , int V_103 )
{
return F_194 ( V_2 , NULL , V_364 , V_103 , NULL , NULL ) ;
}
static void F_196 ( struct V_156 * V_165 , void * V_365 )
{
struct V_366 * V_154 = V_365 ;
if ( V_165 -> V_190 == 0 )
F_197 ( V_154 -> V_66 , V_154 -> V_39 ) ;
}
static void F_198 ( void * V_365 )
{
struct V_366 * V_154 = V_365 ;
F_69 ( V_154 -> V_39 ) ;
F_61 ( V_154 -> V_66 ) ;
...
struct V_179 * V_364 ;
struct V_156 * V_165 ;
V_154 = F_200 ( sizeof( * V_154 ) , V_368 ) ;
if ( ! V_154 )
return - V_77 ;
V_154 -> V_66 = F_72 ( V_66 ) ;
V_154 -> V_39 = F_77 ( V_39 ) ;
V_364 = V_362 . V_363 ( NULL , NULL , 0 ) ;
V_165 = F_194 ( V_2 , V_39 , V_364 ,
V_169 | V_198 | V_188 ,
& V_369 , V_154 ) ;
F_193 ( V_364 ) ;
if ( F_18 ( V_165 ) )
...
struct V_179 * V_364 ;
struct V_156 * V_165 ;
struct V_370 * V_371 = (struct V_370 * ) V_154 ;
int V_187 = - V_305 ;
V_39 = F_77 ( V_39 ) ;
F_72 ( V_66 ) ;
if ( F_202 ( V_66 , (struct V_207 * ) & V_39 -> V_211 ) )
goto V_76;
V_364 = V_362 . V_363 ( NULL , NULL , 0 ) ;
V_165 = F_194 ( V_2 , V_39 , V_364 ,
V_169 | V_198 ,
...
if ( V_187 < 0 )
goto V_76;
V_371 -> V_372 ( V_2 , V_39 , V_371 -> V_154 ) ;
return 1 ;
V_76:
F_69 ( V_39 ) ;
F_61 ( V_66 ) ;
F_16 ( L_85 ,
V_187 , V_39 -> V_214 [ V_373 ] ) ;
return V_187 ;
}
int F_203 ( struct V_1 * V_2 ,
struct V_114 * V_115 ,
int (* F_204)( struct V_1 * ,
struct V_65 * ,
struct V_38 * ,
void * ) ,
void * V_154 )
...
V_39 -> V_141 = V_141 ;
if ( V_39 -> V_232 -> V_378 != NULL )
V_39 -> V_232 -> V_378 ( V_39 ,
V_374 ,
V_375 ) ;
F_206 ( V_66 ) ;
if ( F_204 ) {
V_155 = F_204 ( V_2 , V_66 , V_39 , V_154 ) ;
if ( V_155 != 0 )
goto V_379;
}
F_197 ( V_66 , V_39 ) ;
...
void F_210 ( struct V_1 * V_2 , struct V_38 * V_39 )
{
F_80 () ;
F_197 ( F_81 ( V_2 -> V_93 . V_144 ) ,
V_39 ) ;
F_82 () ;
}
...
static void F_213 ( const struct V_1 * V_2 ,
const struct V_156 * V_165 )
{
const char * V_382 = L_88 ;
if ( F_99 ( V_165 ) )
V_382 = F_214 ( V_165 -> V_161 ) ;
F_20 ( V_21 L_89 ,
V_165 -> V_244 , V_165 -> V_158 , V_165 -> V_190 ,
V_2 , V_165 -> V_199 , V_165 -> V_284 , V_165 -> V_192 ,
V_2 -> V_16 -> V_18 , V_2 -> V_86 , F_148 ( V_165 ) ,
V_165 -> V_183 , V_382 ) ;
}
void F_215 ( struct V_3 * V_3 )
{
struct V_1 * V_2 ;
struct V_156 * V_165 ;
int V_383 = 0 ;
