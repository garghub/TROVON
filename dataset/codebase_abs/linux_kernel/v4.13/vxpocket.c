...
static int F_11 ( struct V_7 * V_8 , int V_35 , int V_3 )
{
int V_19 ;
struct V_10 * V_11 = V_8 -> V_11 ;
struct V_13 * V_15 = F_10 ( V_8 ) ;
F_12 ( V_36 L_1 , V_35 , V_3 ) ;
V_15 -> V_35 = V_35 ;
...
static int F_23 ( struct V_1 * V_25 )
{
struct V_10 * V_11 ;
struct V_13 * V_15 ;
int V_54 , V_19 ;
...
if ( ! V_59 [ V_54 ] )
return - V_53 ;
V_19 = F_25 ( & V_25 -> V_51 , V_60 [ V_54 ] , V_61 [ V_54 ] , V_62 ,
0 , & V_11 ) ;
if ( V_19 < 0 ) {
F_24 ( V_57 L_14 ) ;
return V_19 ;
