...
unsigned int V_24 ;
int V_25 ;
V_25 = F_8 ( V_9 -> V_12 , V_26 ,
V_27 , 0x0a ) ;
if ( V_25 )
return V_25 ;
V_25 = F_8 ( V_9 -> V_12 , V_28 ,
V_27 , 0x0a ) ;
if ( V_25 )
return V_25 ;
V_25 = F_8 ( V_9 -> V_12 , V_29 ,
V_27 , 0x0a ) ;
if ( V_25 )
return V_25 ;
V_23 = V_30 | V_31 ;
...
V_23 |= V_37 | V_38 ;
V_24 |= V_39 | V_38 ;
V_25 = F_8 ( V_9 -> V_12 , V_13 , V_23 , V_24 ) ;
if ( V_25 )
return V_25 ;
return F_8 ( V_9 -> V_12 , V_40 ,
V_41 , 1 ) ;
}
...
struct V_1 * V_9 = F_1 ( V_4 ) ;
unsigned long V_45 ;
V_45 = F_20 ( V_9 -> V_11 , 2000UL * V_16 -> clock ) / 2000 ;
if ( V_45 == V_16 -> clock )
return V_46 ;
V_45 = F_20 ( V_9 -> V_11 , 1000UL * V_16 -> clock ) / 1000 ;
if ( V_45 == V_16 -> clock )
return V_46 ;
F_21 ( V_9 -> V_47 , L_1 ,
V_16 -> V_48 , V_16 -> V_49 ) ;
...
int div = 1 ;
int V_25 ;
V_45 = 2000UL * V_16 -> clock ;
F_24 ( V_9 -> V_11 , V_45 ) ;
V_52 = F_25 ( V_9 -> V_11 ) ;
if ( V_52 >= V_45 )
div = 2 ;
F_24 ( V_9 -> V_53 , V_52 / div ) ;
V_25 = F_26 ( V_9 -> V_54 , V_9 -> V_53 ) ;
if ( V_25 < 0 ) {
F_27 ( V_9 -> V_47 , L_2 ,
V_25 ) ;
}
...
V_24 = V_75 ;
V_25 = F_8 ( V_9 -> V_12 , V_13 ,
V_72 , V_24 ) ;
if ( V_25 < 0 ) {
F_27 ( V_9 -> V_47 , L_4 , V_25 ) ;
return V_25 ;
}
return 0 ;
}
...
V_89 = V_9 -> V_16 == V_17 ?
V_90 : V_91 ;
V_25 = F_43 ( V_88 , & V_9 -> V_7 , V_9 -> V_47 -> V_92 ) ;
if ( V_25 )
return V_25 ;
F_44 ( & V_9 -> V_7 , & V_93 ) ;
...
if ( V_9 -> V_16 == V_17 ) {
V_25 = F_60 ( V_101 , L_10 ,
& V_9 -> V_63 ) ;
if ( V_25 < 0 ) {
F_27 ( V_47 , L_11 ) ;
return V_25 ;
}
V_25 = F_60 ( V_101 , L_12 ,
& V_9 -> V_64 ) ;
if ( V_25 < 0 ) {
F_27 ( V_47 , L_13 ) ;
return V_25 ;
...
if ( ! F_40 ( V_9 -> V_119 ) ) {
if ( F_67 ( V_9 -> V_119 ) != V_120 )
F_21 ( V_47 , L_20 , V_120 ) ;
V_25 = F_68 ( V_9 -> V_119 ) ;
if ( V_25 )
return V_25 ;
}
V_9 -> V_11 = F_69 ( V_47 , L_14 ) ;
if ( F_40 ( V_9 -> V_11 ) ) {
F_27 ( V_47 , L_21 ,
F_41 ( V_9 -> V_11 ) ) ;
return F_41 ( V_9 -> V_11 ) ;
}
V_9 -> V_54 = F_69 ( V_47 , L_22 ) ;
if ( F_40 ( V_9 -> V_54 ) ) {
F_27 ( V_47 , L_23 ,
F_41 ( V_9 -> V_54 ) ) ;
...
{
return F_75 ( & V_108 -> V_47 , & V_123 ) ;
}
static int F_76 ( struct V_107 * V_108 )
{
F_77 ( & V_108 -> V_47 , & V_123 ) ;
return 0 ;
}
