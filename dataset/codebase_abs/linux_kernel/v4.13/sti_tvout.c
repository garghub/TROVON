...
F_19 ( V_72 , L_27 ) ;
V_44 = ( V_5 & V_30 ) ;
F_18 ( V_72 , L_32 , L_33 , V_80 [ V_44 ] ) ;
}
static void F_20 ( struct V_71 * V_72 , int V_5 )
{
F_18 ( V_72 , L_34 , L_35 ,
V_5 & 1 ? L_36 : L_37 ) ;
}
static int F_21 ( struct V_71 * V_72 , void * V_81 )
{
struct V_82 * V_83 = V_72 -> V_84 ;
struct V_1 * V_2 = (struct V_1 * ) V_83 -> V_85 -> V_81 ;
struct V_86 * V_87 ;
F_18 ( V_72 , L_38 , V_2 -> V_4 ) ;
F_19 ( V_72 , L_39 ) ;
V_87 = V_2 -> V_88 -> V_87 ;
if ( V_87 ) {
F_18 ( V_72 , L_40 ,
...
static int F_24 ( struct V_1 * V_2 , struct V_105 * V_106 )
{
unsigned int V_35 ;
for ( V_35 = 0 ; V_35 < F_25 ( V_107 ) ; V_35 ++ )
V_107 [ V_35 ] . V_81 = V_2 ;
return F_26 ( V_107 ,
F_25 ( V_107 ) ,
V_106 -> V_108 , V_106 ) ;
}
static void F_27 ( struct V_109 * V_110 , int V_34 )
{
}
...
{
struct V_112 * V_113 = F_30 ( V_110 ) ;
F_31 ( V_110 ) ;
F_32 ( V_113 ) ;
}
static int F_33 ( struct V_109 * V_110 )
{
struct V_1 * V_2 = F_34 ( V_110 ) ;
int V_114 ;
if ( V_2 -> V_115 )
return 0 ;
V_114 = F_24 ( V_2 , V_110 -> V_45 -> V_116 ) ;
if ( V_114 )
return V_114 ;
V_2 -> V_115 = true ;
return 0 ;
...
static struct V_109 *
F_38 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
struct V_112 * V_110 ;
struct V_109 * V_109 ;
V_110 = F_39 ( V_2 -> V_45 , sizeof( * V_110 ) , V_118 ) ;
if ( ! V_110 )
return NULL ;
V_110 -> V_2 = V_2 ;
...
static struct V_109 * F_44 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
struct V_112 * V_110 ;
struct V_109 * V_109 ;
...
static struct V_109 * F_47 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
struct V_112 * V_110 ;
struct V_109 * V_109 ;
...
static void F_48 ( struct V_117 * V_45 ,
struct V_1 * V_2 )
{
V_2 -> V_88 = F_47 ( V_45 , V_2 ) ;
V_2 -> V_91 = F_44 ( V_45 , V_2 ) ;
V_2 -> V_89 = F_38 ( V_45 , V_2 ) ;
}
...
static int F_50 ( struct V_129 * V_45 , struct V_129 * V_130 , void * V_81 )
{
struct V_1 * V_2 = F_51 ( V_45 ) ;
struct V_117 * V_131 = V_81 ;
V_2 -> V_131 = V_131 ;
F_48 ( V_131 , V_2 ) ;
return 0 ;
}
static void F_52 ( struct V_129 * V_45 , struct V_129 * V_130 ,
void * V_81 )
{
struct V_1 * V_2 = F_51 ( V_45 ) ;
F_49 ( V_2 ) ;
...
if ( ! V_83 )
return - V_138 ;
V_2 = F_39 ( V_45 , sizeof( * V_2 ) , V_118 ) ;
if ( ! V_2 )
return - V_139 ;
V_2 -> V_45 = V_45 ;
V_137 = F_55 ( V_133 , V_140 , L_47 ) ;
if ( ! V_137 ) {
F_56 ( L_48 ) ;
return - V_139 ;
}
V_2 -> V_4 = F_57 ( V_45 , V_137 -> V_141 , F_58 ( V_137 ) ) ;
if ( ! V_2 -> V_4 )
return - V_139 ;
V_2 -> V_142 = F_59 ( V_45 , L_49 ) ;
if ( ! F_60 ( V_2 -> V_142 ) )
F_61 ( V_2 -> V_142 ) ;
F_62 ( V_133 , V_2 ) ;
return F_63 ( V_45 , & V_143 ) ;
}
static int F_64 ( struct V_132 * V_133 )
{
F_65 ( & V_133 -> V_45 , & V_143 ) ;
return 0 ;
}
