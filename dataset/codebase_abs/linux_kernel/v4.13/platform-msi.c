...
static struct V_25 *
F_24 ( struct V_38 * V_39 , unsigned int V_41 ,
T_4 V_54 )
{
struct V_25 * V_55 ;
if ( ! V_39 -> V_56 || ! V_54 || ! V_41 || V_41 > V_57 )
return F_25 ( - V_58 ) ;
if ( V_39 -> V_56 -> V_59 != V_53 ) {
F_26 ( V_39 , L_1 ) ;
return F_25 ( - V_58 ) ;
}
if ( ! F_15 ( F_16 ( V_39 ) ) )
return F_25 ( - V_60 ) ;
V_55 = F_27 ( sizeof( * V_55 ) , V_61 ) ;
if ( ! V_55 )
return F_25 ( - V_46 ) ;
V_55 -> V_3 = F_28 ( & V_62 ,
0 , 1 << V_6 , V_61 ) ;
...
static void F_30 ( struct V_25 * V_22 )
{
F_31 ( & V_62 , V_22 -> V_3 ) ;
F_29 ( V_22 ) ;
}
int F_32 ( struct V_38 * V_39 , unsigned int V_41 ,
T_4 V_54 )
{
struct V_25 * V_26 ;
int V_63 ;
V_26 = F_24 ( V_39 , V_41 , V_54 ) ;
if ( F_33 ( V_26 ) )
return F_34 ( V_26 ) ;
V_63 = F_20 ( V_39 , V_41 , V_26 ) ;
if ( V_63 )
goto V_64;
V_63 = F_35 ( V_39 -> V_56 , V_39 , V_41 ) ;
if ( V_63 )
goto V_65;
return 0 ;
V_65:
...
struct V_10 * V_11 ;
int V_63 ;
V_22 = F_24 ( V_39 , V_41 , V_54 ) ;
if ( F_33 ( V_22 ) )
return NULL ;
V_22 -> V_66 = V_66 ;
V_11 = F_41 ( V_39 -> V_56 , 0 , V_41 ,
V_39 -> V_48 , V_18 , V_22 ) ;
if ( ! V_11 )
goto V_68;
...
struct V_25 * V_22 = V_11 -> V_66 ;
int V_63 ;
V_63 = F_14 ( V_22 -> V_39 , V_14 , V_71 , V_22 ) ;
if ( V_63 )
return V_63 ;
