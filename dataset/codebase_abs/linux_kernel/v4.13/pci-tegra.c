...
V_198 -> V_33 = 0xfcfffff000 ;
F_3 ( V_5 , V_198 -> V_33 >> V_56 -> V_226 , V_121 ) ;
F_3 ( V_5 , V_198 -> V_33 , V_123 ) ;
F_3 ( V_5 , 1 , V_122 ) ;
F_3 ( V_5 , 0xffffffff , V_227 ) ;
...
static int F_137 ( struct V_4 * V_5 , T_1 V_139 ,
T_1 * V_236 )
{
struct V_14 * V_15 = V_5 -> V_15 ;
...
static bool F_139 ( struct V_185 * V_186 ,
struct V_244 * V_179 ,
unsigned int V_178 )
{
char V_245 [ 32 ] ;
...
snprintf ( V_245 , 32 , L_75 , V_179 [ V_21 ] . V_246 ) ;
if ( F_95 ( V_186 , V_245 , NULL ) == NULL )
return false ;
}
return true ;
}
...
if ( ! V_5 -> V_179 )
return - V_24 ;
V_5 -> V_179 [ 0 ] . V_246 = L_77 ;
V_5 -> V_179 [ 1 ] . V_246 = L_78 ;
if ( V_5 -> V_178 > 2 )
V_5 -> V_179 [ 2 ] . V_246 = L_79 ;
return F_141 ( V_15 , V_5 -> V_178 , V_5 -> V_179 ) ;
}
static int F_142 ( struct V_4 * V_5 , T_1 V_248 )
{
struct V_14 * V_15 = V_5 -> V_15 ;
struct V_185 * V_186 = V_15 -> V_190 ;
unsigned int V_21 = 0 ;
...
if ( ! V_5 -> V_179 )
return - V_24 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_80 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_81 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_82 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_83 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_84 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_85 ;
} else if ( F_138 ( V_186 , L_64 ) ) {
V_5 -> V_178 = 7 ;
V_5 -> V_179 = F_93 ( V_15 , V_5 -> V_178 ,
sizeof( * V_5 -> V_179 ) ,
V_23 ) ;
if ( ! V_5 -> V_179 )
return - V_24 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_86 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_82 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_87 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_88 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_84 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_85 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_89 ;
} else if ( F_138 ( V_186 , L_68 ) ) {
...
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_88 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_85 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_90 ;
if ( V_249 ) {
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_91 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_92 ;
}
if ( V_250 ) {
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_93 ;
V_5 -> V_179 [ V_21 ++ ] . V_246 = L_94 ;
}
} else if ( F_138 ( V_186 , L_72 ) ) {
V_5 -> V_178 = 5 ;
V_5 -> V_179 = F_93 ( V_15 , V_5 -> V_178 ,
...
if ( ! V_5 -> V_179 )
return - V_24 ;
V_5 -> V_179 [ 0 ] . V_246 = L_95 ;
V_5 -> V_179 [ 1 ] . V_246 = L_96 ;
V_5 -> V_179 [ 2 ] . V_246 = L_87 ;
V_5 -> V_179 [ 3 ] . V_246 = L_90 ;
V_5 -> V_179 [ 4 ] . V_246 = L_97 ;
}
if ( F_139 ( V_15 -> V_190 , V_5 -> V_179 ,
V_5 -> V_178 ) )
return F_141 ( V_15 , V_5 -> V_178 ,
V_5 -> V_179 ) ;
F_118 ( V_15 , L_98 ) ;
F_42 ( V_15 , V_5 -> V_179 ) ;
V_5 -> V_178 = 0 ;
...
struct V_192 V_193 ;
int V_22 ;
if ( F_144 ( & V_252 , V_186 ) ) {
F_19 ( V_15 , L_99 ) ;
return - V_213 ;
}
F_145 (&parser, &range) {
V_22 = F_146 ( & V_254 , V_186 , & V_193 ) ;
if ( V_22 < 0 )
return V_22 ;
...
V_5 -> V_72 . V_188 = V_186 -> V_247 ;
V_5 -> V_73 . V_19 = V_254 . V_261 ;
V_5 -> V_73 . V_262 = V_254 . V_261 + V_254 . V_97 - 1 ;
...
V_255 |= ( ( 1 << V_6 ) - 1 ) << V_256 ;
V_256 += V_6 ;
V_265 = F_152 ( V_15 , sizeof( * V_265 ) , V_23 ) ;
if ( ! V_265 )
return - V_24 ;
V_22 = F_153 ( V_46 , 0 , & V_265 -> V_64 ) ;
if ( V_22 < 0 ) {
F_19 ( V_15 , L_104 , V_22 ) ;
return V_22 ;
}
...
V_265 -> V_5 = V_5 ;
V_265 -> V_186 = V_46 ;
V_265 -> V_48 = F_154 ( V_15 , & V_265 -> V_64 ) ;
if ( F_25 ( V_265 -> V_48 ) )
return F_26 ( V_265 -> V_48 ) ;
F_27 ( & V_265 -> V_25 , & V_5 -> V_266 ) ;
}
V_22 = F_137 ( V_5 , V_139 , & V_5 -> V_155 ) ;
if ( V_22 < 0 ) {
F_19 ( V_15 , L_109 ) ;
return V_22 ;
}
V_22 = F_142 ( V_5 , V_255 ) ;
if ( V_22 < 0 )
return V_22 ;
return 0 ;
}
static bool F_155 ( struct V_45 * V_46 )
{
struct V_14 * V_15 = V_46 -> V_5 -> V_15 ;
unsigned int V_267 = 3 ;
unsigned long V_6 ;
V_6 = F_6 ( V_46 -> V_48 + V_268 ) ;
V_6 &= ~ V_269 ;
V_6 |= V_270 ;
F_4 ( V_6 , V_46 -> V_48 + V_268 ) ;
do {
unsigned int V_124 = V_271 ;
do {
V_6 = F_6 ( V_46 -> V_48 + V_272 ) ;
if ( V_6 & V_273 )
break;
F_35 ( 1000 , 2000 ) ;
} while ( -- V_124 );
...
static void * F_157 ( struct V_277 * V_278 , T_9 * V_279 )
{
struct V_4 * V_5 = V_278 -> V_280 ;
if ( F_158 ( & V_5 -> V_266 ) )
return NULL ;
F_159 ( V_278 , L_113 ) ;
return F_160 ( & V_5 -> V_266 , * V_279 ) ;
}
static void * F_161 ( struct V_277 * V_278 , void * V_281 , T_9 * V_279 )
{
struct V_4 * V_5 = V_278 -> V_280 ;
return F_162 ( V_281 , & V_5 -> V_266 , V_279 ) ;
}
static void F_163 ( struct V_277 * V_278 , void * V_281 )
{
}
static int F_164 ( struct V_277 * V_278 , void * V_281 )
{
bool V_282 = false , V_283 = false ;
struct V_45 * V_46 ;
unsigned int V_6 ;
V_46 = F_165 ( V_281 , struct V_45 , V_25 ) ;
V_6 = F_6 ( V_46 -> V_48 + V_272 ) ;
if ( V_6 & V_273 )
V_282 = true ;
V_6 = F_6 ( V_46 -> V_48 + V_275 ) ;
...
static int F_166 ( struct V_284 * V_284 , struct V_285 * V_285 )
{
struct V_4 * V_5 = V_284 -> V_286 ;
struct V_277 * V_278 ;
int V_22 ;
V_22 = F_167 ( V_285 , & V_287 ) ;
if ( V_22 )
return V_22 ;
V_278 = V_285 -> V_288 ;
V_278 -> V_280 = V_5 ;
...
{
struct V_289 * V_285 ;
V_5 -> V_290 = F_169 ( L_40 , NULL ) ;
if ( ! V_5 -> V_290 )
return - V_24 ;
V_285 = F_170 ( L_119 , V_291 | V_292 , V_5 -> V_290 ,
V_5 , & V_293 ) ;
if ( ! V_285 )
goto remove;
return 0 ;
...
static int F_172 ( struct V_191 * V_77 )
{
