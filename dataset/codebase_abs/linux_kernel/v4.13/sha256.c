...
int F_12 ( struct V_20 * V_21 , const T_2 * V_31 , unsigned int V_32 )
{
...
if ( V_33 ) {
V_34 = - V_33 ;
memcpy ( V_21 -> V_36 + V_33 , V_31 , V_34 + 64 ) ;
V_35 = V_21 -> V_36 ;
}
do {
F_8 ( V_21 -> V_8 , V_35 ) ;
...
memcpy ( V_21 -> V_36 + V_33 , V_35 , V_32 - V_34 ) ;
return 0 ;
}
int F_13 ( struct V_20 * V_21 , T_2 * V_37 )
{
V_7 * V_38 = ( V_7 * ) V_37 ;
T_3 V_39 ;
unsigned int V_40 , V_41 ;
int V_19 ;
static const T_2 V_42 [ 64 ] = { 0x80 , } ;
V_39 = F_14 ( V_21 -> V_30 << 3 ) ;
V_40 = V_21 -> V_30 & 0x3f ;
V_41 = ( V_40 < 56 ) ? ( 56 - V_40 ) : ( ( 64 + 56 ) - V_40 ) ;
F_12 ( V_21 , V_42 , V_41 ) ;
F_12 ( V_21 , ( const T_2 * ) & V_39 , sizeof( V_39 ) ) ;
for ( V_19 = 0 ; V_19 < 8 ; V_19 ++ )
V_38 [ V_19 ] = F_15 ( V_21 -> V_8 [ V_19 ] ) ;
