...
! F_20 ( V_2 ) )
continue;
F_21 ( V_17 , V_7 , V_21 ? V_21 -> V_33 : 0 ,
V_24 ) ;
V_24 = false ;
}
if ( V_17 -> V_34 -> V_50 )
...
V_17 -> V_34 -> V_53 ( V_17 ) ;
if ( V_21 && V_21 -> V_54 ) {
F_26 ( V_17 , V_21 -> V_54 , V_21 -> V_55 ,
V_56 ) ;
}
if ( V_25 != ~ 0 && V_17 -> V_34 -> V_57 )
F_27 ( V_17 , V_25 ) ;
V_17 -> V_44 = V_26 ;
if ( V_4 && V_17 -> V_34 -> V_58 )
F_28 ( V_17 ) ;
F_29 ( V_17 ) ;
return 0 ;
}
...
struct V_16 * V_17 = V_2 -> V_65 [ V_29 ] ;
if ( ! V_17 || ! V_17 -> V_31 )
continue;
V_8 = F_38 ( V_17 , V_66 ) ;
if ( V_8 ) {
V_17 -> V_31 = false ;
if ( V_17 == & V_2 -> V_67 . V_68 [ 0 ] ) {
F_39 ( L_7 , V_8 ) ;
V_2 -> V_69 = false ;
return V_8 ;
} else {
...
static int F_40 ( struct V_70 * V_71 , void * V_72 )
{
struct V_73 * V_74 = (struct V_73 * ) V_71 -> V_75 ;
