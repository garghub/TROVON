...
void
F_64 ( T_1 V_287 , T_7 * V_162 , T_8 V_290 , const char * V_291 , ... )
{
T_9 V_292 ;
struct V_293 V_294 ;
if ( ! F_63 ( V_287 ) )
return;
va_start ( V_292 , V_291 ) ;
V_294 . V_291 = V_291 ;
V_294 . V_292 = & V_292 ;
if ( V_162 != NULL ) {
const struct V_295 * V_10 = V_162 -> V_163 -> V_10 ;
F_65 ( L_12 ,
V_296 , F_66 ( & ( V_10 -> V_297 ) ) , V_290 + V_298 ,
V_162 -> V_167 , & V_294 ) ;
} else {
F_65 ( L_13 ,
V_296 , L_14 , V_290 + V_298 , & V_294 ) ;
}
va_end ( V_292 ) ;
}
void
F_67 ( T_1 V_287 , struct V_295 * V_10 , T_8 V_290 ,
const char * V_291 , ... )
{
T_9 V_292 ;
struct V_293 V_294 ;
...
V_294 . V_292 = & V_292 ;
F_65 ( L_13 ,
V_296 , F_66 ( & ( V_10 -> V_297 ) ) , V_290 + V_298 , & V_294 ) ;
va_end ( V_292 ) ;
}
void
F_47 ( T_1 V_287 , T_7 * V_162 , T_8 V_290 , const char * V_291 , ... )
{
T_9 V_292 ;
struct V_293 V_294 ;
char V_299 [ 128 ] ;
...
if ( V_162 != NULL ) {
const struct V_295 * V_10 = V_162 -> V_163 -> V_10 ;
snprintf ( V_299 , sizeof( V_299 ) , L_15 ,
V_296 , F_66 ( & ( V_10 -> V_297 ) ) , V_290 , V_162 -> V_167 ) ;
} else {
snprintf ( V_299 , sizeof( V_299 ) , L_16 ,
V_296 , L_14 , V_290 ) ;
}
V_299 [ sizeof( V_299 ) - 1 ] = 0 ;
va_start ( V_292 , V_291 ) ;
V_294 . V_291 = V_291 ;
V_294 . V_292 = & V_292 ;
switch ( V_287 ) {
case V_301 :
F_68 ( L_17 , V_299 , & V_294 ) ;
break;
case V_164 :
F_69 ( L_17 , V_299 , & V_294 ) ;
break;
case V_166 :
F_65 ( L_17 , V_299 , & V_294 ) ;
break;
default:
F_70 ( L_17 , V_299 , & V_294 ) ;
break;
}
va_end ( V_292 ) ;
}
void
F_71 ( T_1 V_287 , struct V_295 * V_10 , T_8 V_290 ,
const char * V_291 , ... )
{
T_9 V_292 ;
struct V_293 V_294 ;
...
void
F_72 ( T_1 V_287 , T_7 * V_162 , T_8 V_290 )
{
int V_302 ;
struct V_1 * V_2 = V_162 -> V_163 ;
struct V_96 T_3 * V_37 = & V_2 -> V_38 -> V_97 ;
struct V_36 T_3 * V_303 = & V_2 -> V_38 -> V_39 ;
struct V_304 T_3 * V_305 = & V_2 -> V_38 -> V_306 ;
T_2 T_3 * V_218 ;
if ( ! F_63 ( V_287 ) )
return;
if ( F_59 ( V_2 ) )
...
F_64 ( V_287 , V_162 , V_290 , L_18 ) ;
for ( V_302 = 0 ; V_302 < 6 ; V_302 ++ )
F_64 ( V_287 , V_162 , V_290 ,
L_19 , V_302 , F_14 ( V_218 ++ ) ) ;
}
void
F_75 ( T_1 V_287 , T_7 * V_162 , T_8 V_290 ,
T_5 * V_75 , T_10 V_115 )
{
T_10 V_30 ;
if ( ! F_63 ( V_287 ) )
...
F_64 ( V_287 , V_162 , V_290 , L_22 , V_30 ) ;
F_76 ( V_308 , L_23 , V_309 , 16 , 1 ,
V_75 + V_30 , F_77 ( 16U , V_115 - V_30 ) , false ) ;
}
}
void
F_78 ( T_1 V_287 , struct V_310 * V_311 , T_8 V_290 ,
const char * V_291 , ... )
{
T_9 V_292 ;
struct V_293 V_294 ;
...
return;
if ( V_311 != NULL ) {
const struct V_295 * V_10 = V_311 -> V_10 ;
snprintf ( V_299 , sizeof( V_299 ) , L_24 ,
V_296 , F_66 ( & ( V_10 -> V_297 ) ) , V_290 ) ;
} else {
snprintf ( V_299 , sizeof( V_299 ) , L_16 ,
V_296 , L_14 , V_290 ) ;
...
void
F_79 ( T_1 V_287 , struct V_310 * V_311 , T_8 V_290 ,
const char * V_291 , ... )
{
T_9 V_292 ;
struct V_293 V_294 ;
