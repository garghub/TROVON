...
static T_3 int
F_37 ( struct V_10 * V_11 , unsigned int V_79 ,
const T_2 V_80 , unsigned int V_81 , const T_2 V_82 )
{
union V_12 * V_62 = F_26 ( V_11 ) ;
...
V_73 = F_6 ( V_62 [ V_69 ] . V_84 [ V_79 ] ) ;
if ( V_81 == F_7 ( V_80 , V_73 ) )
return 0 ;
V_73 &= ~ V_80 ;
V_73 |= F_34 ( V_80 , V_81 ) ;
V_62 [ V_69 ] . V_84 [ V_79 ] = F_35 ( V_73 ) ;
V_62 [ V_69 ] . V_75 |= F_35 ( V_82 ) ;
F_27 ( V_11 , true ) ;
return 0 ;
}
