...
switch ( V_12 -> V_80 ) {
case 0 : {
char V_81 [ sizeof( V_82 ) ] ;
memcpy ( V_81 , V_82 , sizeof( V_82 ) ) ;
F_6 ( V_2 , V_81 , 4 ) ;
F_1 ( V_2 , V_74 ,
sizeof( V_74 ) ) ;
V_12 -> V_80 ++ ;
...
break;
case 3 : {
char V_81 [ sizeof( V_83 ) ] ;
memcpy ( V_81 , V_83 , sizeof( V_83 ) ) ;
V_81 [ 2 ] = F_36 ( V_48 ) ;
F_6 ( V_2 , V_81 , 10 ) ;
F_1 ( V_2 , V_74 ,
sizeof( V_74 ) ) ;
...
int V_78 ;
struct V_47 * V_81 ;
V_81 = F_49 ( sizeof( * V_81 ) , V_84 ) ;
if ( ! V_81 )
return NULL ;
for ( V_78 = 0 ; V_78 < V_72 ; V_78 ++ ) {
V_81 -> V_30 [ F_26 ( V_52 ) ] [ V_78 ]
= 0x20 ;
V_81 -> V_30 [ F_26 ( V_55 ) ] [ V_78 ] = 0x00 ;
V_81 -> V_30 [ F_26 ( V_60 ) ] [ V_78 ] = 0x00 ;
V_81 -> V_30 [ F_26 ( V_61 ) ] [ V_78 ] = 0x00 ;
V_81 -> V_30 [ F_26 ( V_56 ) ] [ V_78 ] = 0x00 ;
V_81 -> V_30 [ F_26 ( V_58 ) ] [ V_78 ] = 0x00 ;
}
return V_81 ;
}
...
for ( V_78 = 0 ; V_78 < V_72 ; V_78 ++ ) {
for ( V_64 = 0 ; V_64 < V_65 ; V_64 ++ ) {
V_81 -> V_30 [ V_64 ] [ 0 ] [ V_78 ] = 0x0c ;
V_81 -> V_30 [ V_64 ] [ 3 ] [ V_78 ] = 0x00 ;
switch ( V_64 ) {
case 0 :
V_81 -> V_30 [ V_64 ] [ 1 ] [ V_78 ] = 0x05 ;
V_81 -> V_30 [ V_64 ] [ 2 ] [ V_78 ] = 0xff ;
break;
case 1 :
V_81 -> V_30 [ V_64 ] [ 1 ] [ V_78 ] = 0x0e ;
V_81 -> V_30 [ V_64 ] [ 2 ] [ V_78 ] = 0x02 ;
break;
case 2 :
V_81 -> V_30 [ V_64 ] [ 1 ] [ V_78 ] = 0x1b ;
V_81 -> V_30 [ V_64 ] [ 2 ] [ V_78 ] = 0x02 ;
break;
case 3 :
V_81 -> V_30 [ V_64 ] [ 1 ] [ V_78 ] = 0x2f
- V_85 ;
V_81 -> V_30 [ V_64 ] [ 2 ] [ V_78 ] = 0xff ;
break;
}
