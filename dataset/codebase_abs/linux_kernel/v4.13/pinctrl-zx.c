...
V_2 -> V_81 = V_73 ;
V_69 = F_18 ( & V_68 -> V_75 , V_14 -> V_74 * sizeof( * V_69 ) ,
V_76 ) ;
if ( ! V_69 )
return - V_77 ;
V_70 = 0 ;
...
V_2 -> V_84 = V_70 ;
V_69 = F_20 ( V_69 , V_70 * sizeof( * V_69 ) ,
V_76 ) ;
for ( V_66 = 0 ; V_66 < V_14 -> V_74 ; V_66 ++ ) {
const struct V_15 * V_16 = V_14 -> V_17 + V_66 ;
struct V_18 * V_19 = V_16 -> V_20 ;
...
return - V_77 ;
F_22 ( & V_12 -> V_36 ) ;
V_91 = F_23 ( V_68 , V_93 , 0 ) ;
V_12 -> V_43 = F_24 ( & V_68 -> V_75 , V_91 ) ;
if ( F_25 ( V_12 -> V_43 ) )
return F_26 ( V_12 -> V_43 ) ;
V_89 = F_27 ( V_68 -> V_75 . V_94 , L_1 , 0 ) ;
if ( ! V_89 ) {
F_28 ( & V_68 -> V_75 , L_2 ) ;
return - V_95 ;
}
V_12 -> V_42 = F_29 ( V_89 , 0 ) ;
if ( ! V_12 -> V_42 )
return - V_77 ;
V_12 -> V_75 = & V_68 -> V_75 ;
V_12 -> V_14 = V_14 ;
...
V_88 -> V_100 = & V_101 ;
V_88 -> V_102 = & V_103 ;
V_12 -> V_2 = F_31 ( & V_68 -> V_75 , V_88 , V_12 ) ;
if ( F_25 ( V_12 -> V_2 ) ) {
V_92 = F_26 ( V_12 -> V_2 ) ;
F_28 ( & V_68 -> V_75 , L_3 , V_92 ) ;
return V_92 ;
}
F_32 ( V_68 , V_12 ) ;
V_92 = F_16 ( V_68 ) ;
if ( V_92 ) {
F_28 ( & V_68 -> V_75 , L_4 , V_92 ) ;
return V_92 ;
}
F_33 ( & V_68 -> V_75 , L_5 ) ;
return 0 ;
