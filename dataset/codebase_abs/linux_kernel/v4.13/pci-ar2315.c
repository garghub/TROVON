...
{
struct V_1 * V_8 = F_19 ( V_55 ) ;
T_1 V_56 = F_3 ( V_8 , V_27 ) &
F_3 ( V_8 , V_57 ) ;
unsigned V_58 = 0 ;
if ( V_56 )
V_58 = F_20 ( V_8 -> V_59 , F_21 ( V_56 ) ) ;
if ( V_58 )
F_22 ( V_58 ) ;
else
F_23 () ;
...
{
struct V_1 * V_8 = F_25 ( V_61 ) ;
F_7 ( V_8 , V_57 , F_26 ( V_61 -> V_62 ) , 0 ) ;
}
static void F_27 ( struct V_60 * V_61 )
{
struct V_1 * V_8 = F_25 ( V_61 ) ;
T_1 V_63 = F_26 ( V_61 -> V_62 ) ;
F_7 ( V_8 , V_57 , V_63 , 0 ) ;
F_5 ( V_8 , V_27 , V_63 ) ;
}
...
{
struct V_1 * V_8 = F_25 ( V_61 ) ;
F_7 ( V_8 , V_57 , 0 , F_26 ( V_61 -> V_62 ) ) ;
}
static int F_29 ( struct V_64 * V_61 , unsigned V_65 ,
T_2 V_66 )
{
F_30 ( V_65 , & V_67 , V_68 ) ;
F_31 ( V_65 , V_61 -> V_69 ) ;
