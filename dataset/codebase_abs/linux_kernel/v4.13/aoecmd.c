...
} while ( F_116 ( V_164 , V_198 ? V_200 : V_201 , V_82 -> V_165 . V_95 ) );
if ( ! V_197 )
F_117 ( V_167 ) ;
}
static void
...
F_121 ( V_3 , sizeof( * V_202 ) ) ;
V_204 = (struct V_42 * ) V_3 -> V_207 ;
F_121 ( V_3 , sizeof( * V_204 ) ) ;
if ( V_204 -> V_104 & 0xa9 ) {
F_71 ( L_11 ,
V_205 -> V_104 , V_204 -> V_104 ,
V_10 -> V_37 , V_10 -> V_39 ) ;
V_206: if ( V_58 )
V_58 -> V_82 -> V_199 = V_201 ;
goto V_152;
}
V_18 = V_205 -> V_94 << 9 ;
switch ( V_205 -> V_104 ) {
...
break;
F_101 ( & V_10 -> V_149 ) ;
F_104 ( V_10 , V_24 , V_3 -> V_207 ) ;
F_102 ( & V_10 -> V_149 ) ;
break;
default:
F_61 ( L_18 ,
V_205 -> V_104 ,
F_124 ( F_125 ( & V_202 -> V_36 ) ) ,
V_202 -> V_38 ) ;
}
V_152:
F_101 ( & V_10 -> V_149 ) ;
...
if ( V_143 == V_213 )
return 1 ;
if ( F_31 ( & V_214 [ V_183 ] . V_13 ) )
return 0 ;
V_14 = V_214 [ V_183 ] . V_13 . V_64 ;
F_11 ( V_14 ) ;
V_16 = F_10 ( V_14 , struct V_8 , V_13 ) ;
F_102 ( & V_214 [ V_183 ] . V_149 ) ;
F_120 ( V_16 ) ;
...
do {
F_101 ( V_220 -> V_149 ) ;
V_223 = V_220 -> V_226 ( V_220 -> V_183 ) ;
if ( ! V_223 ) {
F_137 ( V_220 -> V_227 , & V_221 ) ;
F_138 ( V_228 ) ;
}
F_102 ( V_220 -> V_149 ) ;
if ( ! V_223 ) {
F_139 () ;
F_140 ( V_220 -> V_227 , & V_221 ) ;
} else
F_141 () ;
} while ( ! F_142 () );
F_136 ( & V_220 -> V_225 ) ;
...
void
F_143 ( struct V_219 * V_220 )
{
F_144 ( V_220 -> V_229 ) ;
F_145 ( & V_220 -> V_225 ) ;
}
int
F_131 ( struct V_219 * V_220 )
{
struct V_230 * V_229 ;
F_146 ( & V_220 -> V_225 ) ;
V_229 = F_147 ( F_133 , V_220 , L_19 , V_220 -> V_231 ) ;
if ( V_229 == NULL || F_148 ( V_229 ) )
return - V_232 ;
V_220 -> V_229 = V_229 ;
F_145 ( & V_220 -> V_225 ) ;
F_146 ( & V_220 -> V_225 ) ;
...
T_1 V_61 ;
V_16 -> V_60 = V_3 ;
V_183 = V_16 -> V_24 -> V_10 -> V_39 % V_215 ;
F_79 ( & V_214 [ V_183 ] . V_149 , V_61 ) ;
if ( ! V_216 [ V_183 ] . V_217 ) {
F_80 ( & V_214 [ V_183 ] . V_149 , V_61 ) ;
V_183 = 0 ;
F_79 ( & V_214 [ V_183 ] . V_149 , V_61 ) ;
}
F_40 ( & V_16 -> V_13 , & V_214 [ V_183 ] . V_13 ) ;
F_80 ( & V_214 [ V_183 ] . V_149 , V_61 ) ;
F_149 ( & V_233 [ V_183 ] ) ;
}
struct V_1 *
...
static void
F_164 ( struct V_23 * V_24 , struct V_115 * V_30 , int V_242 )
{
struct V_9 * V_10 ;
struct V_51 * V_126 , * V_127 ;
int V_243 ;
...
int V_143 ;
int V_250 ;
V_126 = ( void * ) F_172 ( V_251 ) ;
if ( ! V_126 )
return - V_232 ;
V_133 = F_173 ( V_126 ) ;
V_215 = F_174 () ;
V_214 = F_32 ( V_215 , sizeof( struct V_252 ) , V_251 ) ;
if ( ! V_214 )
return - V_232 ;
...
V_233 = F_32 ( V_215 , sizeof( V_254 ) , V_251 ) ;
if ( ! V_233 ) {
V_250 = - V_232 ;
goto V_255;
}
