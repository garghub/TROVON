...
if ( V_279 < 2 )
return 0 ;
if ( F_178 ( V_8 , V_259 ) < 0 )
return - 1 ;
if ( V_279 < 3 )
return 0 ;
return F_178 ( V_8 , V_263 ) ;
}
static void F_179 ( struct V_280 * V_80 )
{
int V_281 ;
for ( V_281 = V_282 ; V_281 < V_283 ; V_281 ++ )
F_180 ( & V_80 -> V_41 , V_281 ) ;
F_181 ( & V_80 -> V_41 , V_284 ) ;
F_181 ( & V_80 -> V_41 , V_285 ) ;
F_181 ( & V_80 -> V_41 , V_286 ) ;
F_181 ( & V_80 -> V_41 , V_287 ) ;
}
static int F_182 ( int V_88 , const char * * V_89 )
{
struct V_280 * V_80 ;
struct V_288 * V_23 = & V_22 . V_23 ;
V_88 = F_183 ( V_88 , V_89 , V_289 , V_290 ,
V_291 ) ;
if ( V_292 )
V_23 -> V_293 = V_292 ;
if ( V_131 != 1 || V_294 ) {
...
static int F_185 ( struct V_35 * T_1 V_36 ,
union V_37 * V_38 ,
struct V_280 * V_80 )
{
struct V_297 * V_298 = & V_38 -> V_298 ;
struct V_9 * V_45 ;
struct V_1 V_299 , * V_68 = NULL ;
const char * * V_89 = V_80 -> V_41 . V_222 . V_300 ;
int V_88 = V_80 -> V_41 . V_222 . V_301 ;
F_29 (evsel_list, counter)
F_31 ( & V_13 , V_45 ) ;
if ( V_298 -> type == V_302 )
F_81 ( & V_120 , V_298 -> time ) ;
if ( V_13 . V_90 && V_298 -> time ) {
V_299 . V_5 = V_298 -> time / V_7 ;
V_299 . V_6 = V_298 -> time % V_7 ;
V_68 = & V_299 ;
}
F_36 ( V_68 , V_88 , V_89 ) ;
return 0 ;
...
static
int F_186 ( struct V_35 * T_1 ,
union V_37 * V_38 ,
struct V_280 * V_80 V_36 )
{
struct V_22 * V_229 = F_187 ( T_1 , struct V_22 , T_1 ) ;
F_188 ( & V_13 , & V_38 -> V_13 ) ;
if ( F_189 ( V_229 -> V_82 ) ) {
...
static int F_190 ( struct V_22 * V_229 )
{
if ( ! V_229 -> V_82 || ! V_229 -> V_31 )
return 0 ;
if ( F_191 ( V_229 -> V_303 , L_114 ) )
return - V_107 ;
F_192 ( V_8 , V_229 -> V_82 , V_229 -> V_31 ) ;
if ( F_193 ( V_8 , true ) )
return - V_87 ;
V_229 -> V_303 = true ;
return 0 ;
...
V_229 -> V_31 = F_195 ( & V_38 -> V_84 ) ;
if ( ! V_229 -> V_31 )
return - V_87 ;
return F_190 ( V_229 ) ;
}
static
int F_196 ( struct V_35 * T_1 ,
union V_37 * V_38 ,
struct V_280 * V_80 V_36 )
{
struct V_22 * V_229 = F_187 ( T_1 , struct V_22 , T_1 ) ;
...
V_82 = F_197 ( & V_38 -> V_83 . V_184 ) ;
if ( ! V_82 )
return - V_87 ;
V_229 -> V_82 = V_82 ;
return F_190 ( V_229 ) ;
}
static int F_198 ( int V_88 , const char * * V_89 )
{
struct V_280 * V_80 ;
const struct V_213 V_304 [] = {
F_199 ( 'i' , L_117 , & V_305 , L_118 , L_119 ) ,
F_200 ( 0 , L_120 , & V_22 . V_134 ,
L_121 , V_136 ) ,
F_200 ( 0 , L_122 , & V_22 . V_134 ,
L_123 , V_135 ) ,
F_200 ( 'A' , L_124 , & V_22 . V_134 ,
L_125 , V_137 ) ,
F_201 ()
} ;
struct V_306 V_229 ;
int V_66 ;
V_88 = F_183 ( V_88 , V_89 , V_304 , V_307 , 0 ) ;
if ( ! V_305 || ! strlen ( V_305 ) ) {
if ( ! F_202 ( V_308 , & V_229 ) && F_203 ( V_229 . V_309 ) )
V_305 = L_126 ;
else
V_305 = L_127 ;
}
V_22 . V_23 . V_293 = V_305 ;
V_22 . V_23 . V_310 = V_311 ;
V_80 = F_184 ( & V_22 . V_23 , false , & V_22 . T_1 ) ;
if ( V_80 == NULL )
return - 1 ;
V_22 . V_80 = V_80 ;
V_13 . V_63 = V_268 ;
...
int F_207 ( int V_88 , const char * * V_89 )
{
const char * const V_312 [] = {
L_128 ,
NULL
} ;
int V_96 = - V_107 , V_313 ;
const char * V_310 ;
T_9 * V_63 = V_268 ;
unsigned int V_90 ;
const char * const V_314 [] = { L_129 , L_130 } ;
setlocale ( V_315 , L_33 ) ;
V_8 = F_208 () ;
if ( V_8 == NULL )
return - V_87 ;
F_209 () ;
V_88 = F_210 ( V_88 , V_89 , V_289 , V_314 ,
( const char * * ) V_312 ,
V_291 ) ;
F_211 ( V_8 ) ;
F_212 () ;
if ( V_125 ) {
V_124 = true ;
if ( ! strcmp ( V_125 , L_131 ) )
V_125 = L_132 ;
} else
V_125 = V_316 ;
if ( V_88 && ! strncmp ( V_89 [ 0 ] , L_133 , 3 ) ) {
V_88 = F_182 ( V_88 , V_89 ) ;
if ( V_88 < 0 )
return - 1 ;
} else if ( V_88 && ! strncmp ( V_89 [ 0 ] , L_134 , 3 ) )
return F_198 ( V_88 , V_89 ) ;
V_90 = V_13 . V_90 ;
if ( ! V_21 && V_292 && strcmp ( V_292 , L_126 ) )
V_63 = NULL ;
if ( V_292 && V_317 ) {
fprintf ( V_268 , L_135 ) ;
F_213 ( V_312 , V_289 , L_136 , 1 ) ;
F_213 ( NULL , V_289 , L_137 , 0 ) ;
goto V_150;
}
...
if ( V_317 < 0 ) {
fprintf ( V_268 , L_140 ) ;
F_213 ( V_312 , V_289 , L_137 , 0 ) ;
goto V_150;
}
if ( ! V_63 ) {
struct V_1 V_44 ;
V_310 = V_318 ? L_141 : L_142 ;
V_63 = fopen ( V_292 , V_310 ) ;
if ( ! V_63 ) {
perror ( L_143 ) ;
return - 1 ;
}
F_34 ( V_319 , & V_44 ) ;
fprintf ( V_63 , L_144 , ctime ( & V_44 . V_5 ) ) ;
} else if ( V_317 > 0 ) {
V_310 = V_318 ? L_141 : L_142 ;
V_63 = fdopen ( V_317 , V_310 ) ;
if ( ! V_63 ) {
perror ( L_145 ) ;
return - V_106 ;
}
...
if ( V_215 == 1 ) {
fprintf ( V_268 , L_146 ) ;
F_213 ( V_312 , V_289 , L_147 , 1 ) ;
F_213 ( NULL , V_289 , L_148 , 1 ) ;
goto V_150;
} else
V_168 = false ;
} else if ( V_215 == 0 )
...
fprintf ( V_268 , L_151
L_152 ) ;
F_213 ( NULL , V_289 , L_153 , 1 ) ;
F_213 ( NULL , V_289 , L_154 , 1 ) ;
goto V_150;
}
if ( ( ( V_13 . V_134 != V_140 &&
V_13 . V_134 != V_139 ) || V_275 ) &&
! F_8 ( & V_28 ) ) {
fprintf ( V_268 , L_155
L_156 ) ;
F_213 ( V_312 , V_289 , L_157 , 1 ) ;
F_213 ( NULL , V_289 , L_158 , 1 ) ;
F_213 ( NULL , V_289 , L_141 , 1 ) ;
goto V_150;
}
if ( F_174 () )
goto V_150;
...
if ( F_136 ( & V_28 ) ) {
F_16 ( L_159 ) ;
F_213 ( V_312 , V_289 , L_153 , 1 ) ;
F_213 ( NULL , V_289 , L_154 , 1 ) ;
} else if ( F_8 ( & V_28 ) ) {
perror ( L_160 ) ;
F_213 ( V_312 , V_289 , L_161 , 1 ) ;
F_213 ( NULL , V_289 , L_141 , 1 ) ;
}
goto V_150;
}
...
signal ( V_322 , F_139 ) ;
V_96 = 0 ;
for ( V_313 = 0 ; V_294 || V_313 < V_131 ; V_313 ++ ) {
if ( V_131 != 1 && V_62 > 0 )
fprintf ( V_63 , L_167 ,
V_313 + 1 ) ;
V_96 = F_84 ( V_88 , V_89 ) ;
...
if ( ! V_294 && V_96 != - 1 && ! V_90 )
F_36 ( NULL , V_88 , V_89 ) ;
if ( V_21 ) {
int V_86 = F_70 ( & V_22 . V_23 ) ;
int V_79 = F_217 ( ( void * ) & V_22 ,
F_14 ,
& V_22 . V_80 -> V_323 . V_324 ) ;
if ( V_79 ) {
F_32 ( L_168
L_169 ) ;
}
if ( ! V_90 ) {
if ( F_35 ( V_120 . V_217 , V_325 ) )
F_16 ( L_8 ) ;
}
if ( ! V_22 . V_23 . V_24 ) {
V_22 . V_80 -> V_41 . V_326 += V_22 . V_43 ;
