...
V_82 -> V_21 . V_29 . V_30 ,
V_82 -> V_21 . V_25 . V_28 ) ;
F_84 ( V_101 , & V_82 -> V_21 ,
F_85 ( V_82 -> V_21 . V_29 . V_30 ) ,
F_86 ( V_82 -> V_21 . V_29 . V_30 ,
V_82 -> V_21 . V_25 . V_28 ) ) ;
if ( V_82 -> V_41 & V_44 ) {
F_83 ( V_101 , L_6 ) ;
V_102 = L_7 ;
...
static int F_88 ( struct V_106 * V_106 , struct V_107 * V_107 )
{
return F_89 ( V_106 , V_107 , & V_108 ,
sizeof( struct V_95 ) ) ;
}
static int F_90 ( struct V_7 * V_7 )
{
#ifdef F_91
struct V_109 * V_110 ;
T_6 V_111 ;
T_7 V_112 ;
V_110 = F_92 ( L_13 , 0440 , V_7 -> V_113 ,
& V_114 ) ;
if ( ! V_110 )
return - V_115 ;
V_111 = F_93 ( V_7 -> V_116 , 0 ) ;
V_112 = F_94 ( V_7 -> V_116 , 0 ) ;
if ( F_95 ( V_111 ) && F_96 ( V_112 ) )
F_97 ( V_110 , V_111 , V_112 ) ;
#endif
return 0 ;
}
