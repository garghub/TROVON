...
V_79 = V_31 -> V_82 ;
F_9 ( V_2 , V_81 , V_31 -> V_83 - 1 ) ;
F_9 ( V_2 , V_80 , V_79 - 1 ) ;
V_46 = ( V_31 -> V_83 == 1 ) ? 1 : V_31 -> V_46 ;
V_39 = F_11 ( V_31 ) ;
...
V_2 -> V_37 = 1 ;
if ( V_39 == V_84 ) {
const T_3 * V_85 = ( T_3 * ) F_12 ( V_31 -> V_42 ) ;
memcpy ( V_2 -> V_43 , V_85 , V_31 -> V_42 -> V_44 ) ;
}
}
static void F_24 ( struct V_86 * V_18 , struct V_70 * V_78 )
{
...
F_22 ( V_2 , V_78 ) ;
F_4 ( V_2 , V_78 -> V_9 ) ;
if ( V_78 -> V_9 -> V_26 == V_87 &&
V_78 -> V_9 -> V_29 == ( V_88 | V_89 | V_23 ) )
V_78 -> V_9 -> error = - V_90 ;
}
static void F_27 ( struct V_86 * V_18 , struct V_91 * V_92 )
{
struct V_1 * V_2 = F_25 ( V_18 ) ;
V_2 -> V_27 = V_92 -> V_27 ;
V_2 -> V_93 = V_2 -> V_27 ;
}
static int F_28 ( struct V_86 * V_18 )
{
T_6 V_72 ;
struct V_1 * V_2 = F_25 ( V_18 ) ;
V_72 = F_17 ( V_2 , V_73 ) ;
...
int V_57 ;
T_7 V_100 ;
V_98 = F_30 ( V_96 , V_101 , 0 ) ;
V_57 = F_31 ( V_96 , 0 ) ;
if ( V_98 == NULL || V_57 < 0 )
return - V_102 ;
V_18 = F_32 ( sizeof( struct V_1 ) , & V_96 -> V_4 ) ;
if ( V_18 == NULL ) {
V_99 = - V_103 ;
goto V_104;
}
V_2 = F_25 ( V_18 ) ;
V_2 -> V_18 = V_18 ;
F_33 ( L_7 , ( long ) V_98 -> V_105 , ( long ) V_98 -> V_106 ) ;
V_2 -> V_107 = F_34 ( V_98 -> V_105 , F_35 ( V_98 ) ) ;
if ( V_2 -> V_107 == NULL ) {
V_99 = - V_103 ;
goto V_108;
}
V_2 -> V_43 = F_36 ( & V_96 -> V_4 , V_109 ,
& V_100 , V_110 ) ;
if ( V_2 -> V_43 == 0 ) {
V_99 = - V_103 ;
goto V_111;
...
V_99 = F_37 ( V_2 -> V_57 , F_18 , 0 , V_128 , V_2 ) ;
if ( V_99 ) {
F_6 ( & V_96 -> V_4 , L_8 ) ;
goto V_129;
}
...
{
struct V_1 * V_2 = F_46 ( V_96 ) ;
F_47 ( V_2 == NULL ) ;
F_48 ( V_2 -> V_18 ) ;
F_49 ( V_2 -> V_57 , V_2 ) ;
F_42 ( & V_96 -> V_4 , V_109 , V_2 -> V_43 , V_2 -> V_112 ) ;
F_43 ( V_2 -> V_107 ) ;
F_44 ( V_2 -> V_18 ) ;
return 0 ;
}
