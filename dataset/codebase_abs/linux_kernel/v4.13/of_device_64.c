...
static struct V_41 * T_3 F_35 ( struct V_12 * V_58 ,
struct V_43 * V_33 )
{
struct V_41 * V_42 = F_36 ( sizeof( * V_42 ) , V_96 ) ;
...
static void T_3 F_40 ( struct V_12 * V_58 , struct V_43 * V_33 )
{
while ( V_58 ) {
struct V_41 * V_42 = F_35 ( V_58 , V_33 ) ;
if ( V_42 )
F_40 ( V_58 -> V_104 , & V_42 -> V_48 ) ;
V_58 = V_58 -> V_105 ;
}
}
static int T_3 F_41 ( void )
{
struct V_12 * V_106 = F_42 ( L_27 ) ;
struct V_41 * V_33 ;
V_33 = F_35 ( V_106 , NULL ) ;
if ( ! V_33 )
return 0 ;
F_40 ( V_106 -> V_104 , & V_33 -> V_48 ) ;
return 0 ;
}
static int T_3 F_43 ( char * V_107 )
{
int V_108 = 0 ;
F_44 ( & V_107 , & V_108 ) ;
if ( V_108 & 1 )
