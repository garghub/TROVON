...
int V_20 ;
V_20 = F_152 ( V_36 ) ;
if ( V_20 == 0 || V_20 == - V_205 )
V_36 -> V_206 = V_7 ;
F_153 ( & V_36 -> V_207 , F_154 ( V_36 ) ) ;
#else
F_152 ( V_36 ) ;
#endif
}
bool F_155 ( struct V_129 * V_65 , struct V_4 * V_5 ,
struct V_36 * V_36 )
{
...
static void F_159 ( struct V_12 * V_13 , T_7 V_214 ,
...
return;
V_168 = F_160 ( V_214 ) ;
V_195 = F_161 ( V_13 -> V_200 ) ;
V_195 [ V_168 ] . V_201 += time ;
V_195 [ V_168 ] . V_202 ++ ;
F_162 ( V_13 -> V_200 ) ;
}
void F_163 ( struct V_217 * V_218 , T_3 V_219 )
{
struct V_129 * V_65 = V_218 -> V_65 ;
struct V_12 * V_13 = V_65 -> V_13 ;
F_159 ( V_13 , F_164 ( & V_218 -> V_220 ) ,
F_165 ( V_218 ) , V_219 >> 10 ) ;
}
void F_166 ( struct V_36 * V_36 )
{
struct V_1 * V_7 ;
T_3 V_221 ;
unsigned long V_222 ;
...
V_221 = F_137 () ;
V_7 -> V_177 = V_221 >> 10 ;
V_223 = F_167 ( & V_36 -> V_207 ) >> 10 ;
V_222 = F_168 ( V_221 ) >> 10 ;
if ( ! V_223 || V_222 <= V_223 )
return;
V_224 = V_222 - V_223 ;
if ( ! ( V_36 -> V_207 . V_212 & V_213 ) )
F_159 ( V_7 -> V_13 , F_164 ( & V_36 -> V_207 ) ,
F_19 ( V_36 ) , V_224 ) ;
...
static void F_169 ( struct V_8 * V_10 )
{
struct V_1 * V_7 ;
while ( ( V_7 = F_54 ( V_10 ) ) ) {
struct V_8 * V_9 = & V_7 -> V_11 ;
...
if ( ! V_13 )
return - V_229 ;
V_13 -> V_200 = F_173 ( sizeof( struct V_197 ) *
V_191 , F_174 ( T_3 ) ) ;
if ( ! V_13 -> V_200 ) {
F_53 ( V_13 ) ;
return - V_229 ;
}
F_175 ( & V_13 -> V_136 , F_104 ) ;
F_37 ( & V_13 -> V_11 ) ;
V_65 -> V_13 = V_13 ;
V_13 -> V_130 = V_65 ;
V_13 -> V_68 [ V_32 ] = true ;
...
void F_178 ( struct V_129 * V_65 )
{
F_82 ( ! V_65 -> V_13 ) ;
F_132 ( V_65 ) ;
F_179 ( V_65 , & V_6 ) ;
F_177 ( V_65 -> V_13 -> V_200 ) ;
F_53 ( V_65 -> V_13 ) ;
}
void F_180 ( struct V_129 * V_65 )
{
struct V_12 * V_13 ;
int V_192 ;
V_13 = V_65 -> V_13 ;
...
T_4 F_182 ( struct V_129 * V_65 , char * V_237 )
{
if ( ! V_65 -> V_13 )
return - V_158 ;
return sprintf ( V_237 , L_31 , F_183 ( V_65 -> V_13 -> V_18 ) ) ;
}
T_4 F_184 ( struct V_129 * V_65 ,
