...
F_30 ( V_2 , V_32 ) ;
error = F_31 ( V_2 -> V_39 , F_15 , V_54 -> V_80 ,
V_2 -> V_68 , V_32 ) ;
if ( error ) {
F_3 ( V_12 , L_9 ,
error ) ;
...
static int T_5 F_42 ( struct V_42 * V_12 )
{
struct V_1 * V_2 = F_17 ( V_12 ) ;
if ( F_43 ( & V_2 -> V_12 ) )
F_44 ( V_2 -> V_39 ) ;
...
static int T_5 F_45 ( struct V_42 * V_12 )
{
struct V_1 * V_2 = F_17 ( V_12 ) ;
if ( F_43 ( & V_2 -> V_12 ) )
F_46 ( V_2 -> V_39 ) ;
