...
T_3 V_99 ;
int error = 0 ;
V_94 = F_24 ( V_27 -> V_71 -> V_100 ) ;
V_95 = F_42 ( V_27 -> V_71 ) ;
if ( V_57 [ 0 ] . V_9 >= V_95 )
return 0 ;
else if ( V_57 [ 0 ] . V_9 < V_94 )
V_57 [ 0 ] . V_9 = V_94 ;
if ( V_57 [ 1 ] . V_9 >= V_95 )
V_57 [ 1 ] . V_9 = V_95 - 1 ;
V_92 = V_57 [ 0 ] . V_9 ;
V_93 = V_57 [ 1 ] . V_9 ;
F_8 ( V_2 , V_92 , & V_96 , & V_98 ) ;
F_8 ( V_2 , V_93 , & V_97 , & V_99 ) ;
V_22 -> V_24 = V_57 [ 0 ] ;
V_22 -> V_24 . V_9 = F_10 ( V_27 , V_98 ) ;
V_22 -> V_24 . V_13 = 0 ;
memset ( & V_22 -> V_60 , 0xFF , sizeof( V_22 -> V_60 ) ) ;
error = F_34 ( V_2 , & V_22 -> V_101 ) ;
if ( error )
goto V_87;
for ( V_22 -> V_102 = V_96 ;
V_22 -> V_102 <= V_97 ;
...
F_18 ( V_2 , V_22 -> V_40 , V_22 -> V_102 ,
V_22 -> V_24 . V_9 ,
V_22 -> V_24 . V_13 ,
V_22 -> V_24 . V_11 ) ;
F_19 ( V_2 , V_22 -> V_40 , V_22 -> V_102 ,
V_22 -> V_60 . V_9 ,
V_22 -> V_60 . V_13 ,
V_22 -> V_60 . V_11 ) ;
error = F_43 ( V_2 , V_22 -> V_102 ,
...
V_22 -> V_38 = true ;
error = F_12 ( V_2 , V_97 , V_99 , 0 , V_22 ) ;
if ( error )
goto V_87;
V_87:
F_33 ( & V_22 -> V_101 ) ;
...
struct V_5 * V_103 )
{
if ( V_103 -> V_7 == 0 || V_103 -> V_7 == V_104 ||
V_103 -> V_7 == F_46 ( V_2 -> V_105 -> V_106 ) )
return true ;
if ( F_6 ( V_2 ) -> V_107 &&
V_103 -> V_7 == F_46 ( F_6 ( V_2 ) -> V_107 -> V_106 ) )
return true ;
return false ;
}
static bool F_47 ( struct V_5 * V_108 ,
struct V_5 * V_109 )
{
if ( V_108 -> V_7 > V_109 -> V_7 )
return false ;
if ( V_108 -> V_7 < V_109 -> V_7 )
return true ;
if ( V_108 -> V_9 > V_109 -> V_9 )
return false ;
if ( V_108 -> V_9 < V_109 -> V_9 )
return true ;
if ( V_108 -> V_11 > V_109 -> V_11 )
return false ;
if ( V_108 -> V_11 < V_109 -> V_11 )
return true ;
return false ;
}
int F_48 ( struct V_1 * V_2 , struct V_110 * V_111 ,
T_6 V_112 , void * V_113 )
{
struct V_5 V_114 [ 2 ] ;
struct V_17 V_115 [ V_116 ] ;
struct V_21 V_22 = { 0 } ;
int V_117 ;
int error = 0 ;
if ( V_111 -> V_118 & ~ V_119 )
return - V_120 ;
if ( ! F_45 ( V_2 , & V_111 -> V_121 [ 0 ] ) ||
! F_45 ( V_2 , & V_111 -> V_121 [ 1 ] ) )
return - V_120 ;
V_111 -> V_37 = 0 ;
memset ( V_115 , 0 , sizeof( V_115 ) ) ;
V_115 [ 0 ] . V_20 = F_46 ( V_2 -> V_105 -> V_106 ) ;
V_115 [ 0 ] . V_122 = F_41 ;
if ( F_6 ( V_2 ) -> V_107 ) {
V_115 [ 1 ] . V_20 = F_46 (
F_6 ( V_2 ) -> V_107 -> V_106 ) ;
...
F_49 ( V_115 , V_116 , sizeof( struct V_17 ) ,
F_3 , NULL ) ;
V_114 [ 0 ] = V_111 -> V_121 [ 0 ] ;
V_114 [ 0 ] . V_9 += V_114 [ 0 ] . V_13 ;
V_114 [ 0 ] . V_11 = 0 ;
V_114 [ 0 ] . V_13 = 0 ;
memset ( & V_114 [ 1 ] , 0xFF , sizeof( struct V_5 ) ) ;
if ( ! F_47 ( V_114 , & V_111 -> V_121 [ 1 ] ) )
return - V_120 ;
V_22 . V_33 = V_111 -> V_121 [ 0 ] . V_9 +
V_111 -> V_121 [ 0 ] . V_13 ;
V_22 . V_43 = V_112 ;
V_22 . V_44 = V_113 ;
V_22 . V_35 = V_111 ;
for ( V_117 = 0 ; V_117 < V_116 ; V_117 ++ ) {
if ( ! V_115 [ V_117 ] . V_122 )
continue;
if ( V_111 -> V_121 [ 0 ] . V_7 > V_115 [ V_117 ] . V_20 )
continue;
if ( V_111 -> V_121 [ 1 ] . V_7 < V_115 [ V_117 ] . V_20 )
break;
if ( V_115 [ V_117 ] . V_20 == V_111 -> V_121 [ 1 ] . V_7 )
V_114 [ 1 ] = V_111 -> V_121 [ 1 ] ;
if ( V_115 [ V_117 ] . V_20 > V_111 -> V_121 [ 0 ] . V_7 )
memset ( & V_114 [ 0 ] , 0 , sizeof( struct V_5 ) ) ;
V_22 . V_40 = V_115 [ V_117 ] . V_20 ;
V_22 . V_38 = false ;
V_22 . V_102 = - 1 ;
error = V_115 [ V_117 ] . V_122 ( V_2 , V_114 , & V_22 ) ;
if ( error )
break;
V_22 . V_33 = 0 ;
}
