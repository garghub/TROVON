...
struct V_22 * V_23 = V_56 -> V_23 ;
if ( V_220 -> type == V_221 ) {
V_220 -> V_222 . V_223 = V_23 -> V_122 ? 54 : 11 ;
V_220 -> V_222 . V_224 = V_23 -> V_122 ? 59 : 10 ;
} else if ( V_220 -> type == V_225 ) {
V_220 -> V_222 . V_223 = V_23 -> V_226 ? 54 : 11 ;
V_220 -> V_222 . V_224 = V_23 -> V_226 ? 59 : 10 ;
} else {
return - V_65 ;
}
return 0 ;
...
default:
return F_116 ( V_89 , V_351 ) ;
}
}
static int F_117 ( struct V_88 * V_88 , void * V_89 )
{
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
T_2 V_32 [ V_33 ] ;
...
struct V_209 V_356 ;
int V_15 ;
F_118 ( L_19 , V_357 , V_23 -> V_203 ) ;
if ( V_23 -> V_277 & V_358 ) {
struct V_359 V_360 ;
F_119 ( V_23 , & V_360 ) ;
}
F_89 ( V_23 , V_361 , V_362 ) ;
F_70 ( V_23 , V_23 -> V_247 , & V_355 ) ;
F_61 ( V_23 , V_23 -> V_212 , & V_356 ) ;
F_118 ( L_20 , V_355 . V_295 ) ;
F_118 ( L_21 , V_356 . V_295 ,
V_23 -> V_363 == V_364 ?
L_22 : L_23 ) ;
if ( V_354 ) {
struct V_218 V_365 ;
struct V_215 V_366 ;
int V_367 = V_23 -> V_82 ;
static const char * const V_368 [ 5 ] = {
L_24 ,
L_25 ,
L_26 ,
L_27 ,
...
static const char * const V_369 [ 4 ] = {
L_24 ,
L_29 ,
L_30 ,
L_31
...
F_72 ( V_23 , V_23 -> V_260 , & V_365 ) ;
F_66 ( V_23 , 0 , & V_366 ) ;
F_118 ( L_48 , V_365 . V_295 ) ;
if ( V_367 < 0 || V_367 > V_370 )
V_367 = V_83 ;
F_118 ( L_49 , V_368 [ V_367 ] ) ;
F_111 ( V_23 , V_32 , V_338 , 0 ) ;
V_32 [ 0 ] |= ( F_95 ( 0x2a00 ) >> 7 ) & 0x40 ;
F_118 ( L_50 ,
V_32 [ 0 ] & 1 ? L_51 : L_52 ,
...
F_120 ( & V_23 -> V_37 . V_371 , V_23 -> V_372 . V_295 ) ;
F_118 ( L_56 , V_23 -> V_47 ) ;
for ( V_15 = 0 ; V_15 < V_373 ; V_15 ++ ) {
struct V_60 * V_54 = & V_23 -> V_61 [ V_15 ] ;
if ( V_54 -> V_258 . V_372 == NULL || V_54 -> V_374 == 0 )
continue;
F_118 ( L_57 , V_54 -> V_295 , V_54 -> V_375 ,
( V_54 -> V_374 - V_54 -> V_376 . V_374 ) * 100 / V_54 -> V_374 ,
( V_54 -> V_374 * V_54 -> V_377 ) / 1024 , V_54 -> V_374 ) ;
}
F_118 ( L_58 ,
...
static int F_121 ( struct V_88 * V_88 , void * V_89 , struct V_57 * V_380 )
{
struct V_55 * V_56 = F_30 ( V_88 -> V_199 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
F_105 ( L_59 , V_380 -> V_66 ) ;
return F_23 ( V_23 , V_56 , V_380 , false ) ;
}
static int F_122 ( struct V_88 * V_88 , void * V_89 , struct V_57 * V_380 )
{
struct V_55 * V_56 = F_30 ( V_88 -> V_199 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
F_105 ( L_60 , V_380 -> V_66 ) ;
return F_23 ( V_23 , V_56 , V_380 , true ) ;
}
static T_8 void F_123 ( const char * V_295 )
{
F_124 ( L_61 ,
V_295 ) ;
}
static int F_125 ( struct V_88 * V_381 , unsigned int V_66 , void * V_382 )
{
struct V_55 * V_56 = F_30 ( V_381 -> V_199 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
struct V_60 * V_54 = & V_23 -> V_61 [ V_56 -> type ] ;
#ifdef F_126
int V_383 = V_381 -> V_384 & V_385 ;
unsigned long V_386 = ( unsigned long ) V_382 ;
#endif
switch ( V_66 ) {
case V_387 : {
struct V_388 * args = V_382 ;
F_105 ( L_62 ) ;
if ( ! ( V_23 -> V_63 & V_64 ) )
return - V_65 ;
if ( args -> type != V_225 )
return - V_65 ;
if ( V_23 -> V_82 == V_389 && args -> V_390 == NULL )
return 0 ;
if ( F_26 ( V_56 , V_56 -> type ) ) {
return - V_75 ;
}
if ( F_24 ( V_23 , V_389 ) != V_389 ) {
F_127 ( V_54 ) ;
return - V_75 ;
}
V_56 -> V_391 = 1 ;
if ( args -> V_390 == NULL )
return 0 ;
return F_128 ( V_23 , args ) ;
}
case V_392 :
F_105 ( L_63 ) ;
if ( ! ( V_23 -> V_63 & V_64 ) )
return - V_65 ;
return F_129 ( V_23 , * ( int * ) V_382 != 0 ) ;
#ifdef F_126
case V_393 : {
T_9 * V_81 = V_382 ;
T_9 V_394 ;
...
case V_403 : {
struct V_404 * V_405 = V_382 ;
F_10 ( V_35 ) ;
F_123 ( L_72 ) ;
if ( ! ( V_23 -> V_63 & V_64 ) )
return - V_65 ;
memset ( V_405 , 0 , sizeof( * V_405 ) ) ;
F_28 ( V_406 , & V_23 -> V_47 ) ;
while ( 1 ) {
if ( F_25 ( V_407 , & V_23 -> V_47 ) )
V_405 -> type = V_408 ;
else if ( F_25 ( V_409 , & V_23 -> V_47 ) ) {
V_405 -> type = V_410 ;
V_405 -> V_411 . V_412 = F_15 ( V_413 , & V_23 -> V_47 ) ?
V_414 : V_415 ;
if ( V_23 -> V_82 == V_389 &&
( V_23 -> V_127 . V_128 & V_129 ) ==
V_134 ) {
V_405 -> V_411 . V_412 = V_416 ;
}
}
if ( V_405 -> type )
return 0 ;
...
return - V_417 ;
F_13 ( & V_23 -> V_43 ) ;
F_14 ( & V_23 -> V_418 , & V_35 , V_45 ) ;
if ( ! F_15 ( V_407 , & V_23 -> V_47 ) &&
! F_15 ( V_409 , & V_23 -> V_47 ) )
F_17 () ;
F_18 ( & V_23 -> V_418 , & V_35 ) ;
F_19 ( & V_23 -> V_43 ) ;
if ( F_16 ( V_48 ) ) {
F_21 ( L_73 ) ;
return - V_49 ;
...
if ( V_386 > V_423 )
return - V_65 ;
return F_131 ( V_23 -> V_424 , V_386 + 1 ) ;
case V_425 :
F_123 ( L_77 ) ;
if ( V_386 > V_423 )
return - V_65 ;
return F_131 ( V_23 -> V_426 , V_386 + 1 ) ;
#endif
default:
return - V_65 ;
}
...
static long F_132 ( struct V_88 * V_88 , void * V_89 , bool V_427 ,
unsigned int V_66 , void * V_382 )
{
struct V_22 * V_23 = F_30 ( V_89 ) -> V_23 ;
if ( ! V_427 ) {
switch ( V_66 ) {
...
case V_428 : {
T_2 V_184 = * ( T_2 * ) V_382 ;
if ( ( V_184 == 0 && V_23 -> V_429 . V_430 ) || ( V_184 & 0x01 ) )
F_133 ( V_23 ) ;
if ( V_184 & 0x02 )
F_34 ( V_23 -> V_123 , V_361 , V_431 , 0 ) ;
break;
}
case V_387 :
case V_392 :
...
case V_425 :
#endif
return F_125 ( V_88 , V_66 , ( void * ) V_382 ) ;
default:
return - V_271 ;
}
return 0 ;
}
void F_134 ( struct V_432 * V_258 )
{
V_258 -> V_433 = & V_434 ;
}
