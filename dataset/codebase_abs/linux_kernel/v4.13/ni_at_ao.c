...
V_5 -> V_7 = 0 ;
F_2 ( V_5 -> V_7 , V_2 -> V_9 + V_10 ) ;
F_15 ( V_2 -> V_38 , 0 , V_39 | V_40 ) ;
F_15 ( V_2 -> V_38 , 1 , V_39 | V_40 ) ;
F_16 ( V_2 -> V_38 , 0 , 0x0003 ) ;
F_2 ( V_37 , V_2 -> V_9 + V_35 ) ;
V_5 -> V_27 = 0 ;
F_2 ( V_5 -> V_27 , V_2 -> V_9 + V_30 ) ;
F_9 ( V_2 -> V_9 + V_41 ) ;
...
static int F_17 ( struct V_1 * V_2 , struct V_45 * V_46 )
{
const struct V_47 * V_48 = V_2 -> V_49 ;
struct V_4 * V_5 ;
struct V_11 * V_12 ;
int V_25 ;
V_25 = F_18 ( V_2 , V_46 -> V_50 [ 0 ] , 0x20 ) ;
if ( V_25 )
return V_25 ;
V_5 = F_19 ( V_2 , sizeof( * V_5 ) ) ;
if ( ! V_5 )
return - V_51 ;
V_2 -> V_38 = F_20 ( V_2 -> V_9 + V_52 ,
0 , V_53 , 0 ) ;
if ( ! V_2 -> V_38 )
return - V_51 ;
V_25 = F_21 ( V_2 , 4 ) ;
...
V_12 -> V_58 = V_48 -> V_59 ;
V_12 -> V_60 = 0x0fff ;
V_12 -> V_61 = V_46 -> V_50 [ 3 ] ? & V_62 : & V_63 ;
V_12 -> V_64 = F_3 ;
V_25 = F_22 ( V_12 ) ;
if ( V_25 )
return V_25 ;
