...
int V_25 ;
struct V_3 * V_4 = F_10 ( V_11 ) ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_4 -> V_5 . V_42 ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_60 ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_30 ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_10 -> V_17 ;
V_25 = F_14 ( V_11 , V_43 ,
V_44 , V_10 -> V_16 , V_10 -> V_17 ) ;
F_6 ( V_10 ) ;
return V_25 ;
...
static int F_32 ( struct V_19 * V_11 ,
struct V_9 * V_10 )
{
T_2 V_29 , V_31 ;
int V_25 ;
...
int F_33 ( struct V_19 * V_11 ,
T_2 V_72 , struct V_9 * V_10 )
{
int V_25 = 0 ;
struct V_3 * V_4 = F_10 ( V_11 ) ;
F_34 ( L_3 , V_72 ) ;
...
return 0 ;
default:
F_35 ( & V_11 -> V_12 -> V_8 , L_4 ) ;
return 1 ;
}
F_6 ( V_10 ) ;
return V_25 ;
}
static void F_36 ( struct V_19 * V_11 , T_2 V_56 , T_2 V_34 ,
T_2 V_35 , T_2 V_77 )
{
struct V_9 * V_10 ;
struct V_50 * V_51 ;
...
V_51 -> V_78 = V_77 ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_4 -> V_5 . V_36 | 0x10 ;
F_7 ( V_4 , V_10 ) ;
}
static void F_38 ( void * V_79 , struct V_9 * V_10 ,
int V_80 )
{
struct V_3 * V_4 = V_79 ;
struct V_22 * V_23 ;
...
V_4 -> V_5 . V_36 |= 0x10 ;
V_25 = F_39 ( V_4 -> V_11 -> V_12 , V_4 -> V_5 . V_83 ,
V_49 , V_84 ) ;
if ( V_25 < 0 )
return;
V_4 -> V_5 . V_42 = 0 ;
if ( F_40 ( V_23 -> V_38 ) != V_4 -> V_5 . V_77 )
F_36 ( V_4 -> V_11 , V_23 -> V_56 ,
V_23 -> V_34 , V_23 -> V_35 ,
F_40 ( V_23 -> V_38 ) ) ;
break;
default:
...
int F_41 ( struct V_19 * V_11 , T_2 * V_85 , T_1 V_24 )
{
struct V_9 * V_10 ;
struct V_3 * V_4 = F_10 ( V_11 ) ;
struct V_20 * V_21 ;
...
V_21 -> V_29 = V_68 ;
V_21 -> V_31 = V_69 ;
memset ( V_21 -> V_33 , 0 , V_90 ) ;
V_87 = V_11 -> V_12 -> V_91 ;
if ( V_87 -> V_92 > 0 )
memcpy ( V_21 -> V_33 , V_87 -> V_93 ,
V_87 -> V_92 ) ;
else
F_43 ( V_21 -> V_33 , V_90 ) ;
V_21 -> V_56 = 0x0 ;
...
V_4 -> V_5 . V_77 = F_40 ( V_21 -> V_38 ) ;
return F_4 ( V_11 , V_14 ,
V_15 , V_10 -> V_16 ,
V_10 -> V_17 , V_4 -> V_18 , V_4 ) ;
}
static void F_45 ( void * V_79 , struct V_9 * V_10 ,
int V_80 )
{
struct V_3 * V_4 = V_79 ;
struct V_61 * V_95 ;
...
F_29 ( L_2 ) ;
F_30 ( V_10 , V_63 ) ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_71 ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_68 ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_10 -> V_17 ;
* ( T_2 * ) F_23 ( V_10 , 1 ) = V_4 -> V_5 . V_36 | 0x10 ;
F_7 ( V_4 , V_10 ) ;
break;
...
int F_46 ( struct V_19 * V_11 , struct V_9 * V_10 )
{
struct V_3 * V_4 = F_10 ( V_11 ) ;
V_4 -> V_81 = V_82 ;
V_4 -> V_94 = V_4 ;
...
{
struct V_3 * V_4 = F_10 ( V_11 ) ;
F_48 ( & V_4 -> V_5 . V_6 , F_1 ) ;
V_4 -> V_5 . V_42 = 0 ;
V_4 -> V_5 . V_83 = 0 ;
V_4 -> V_5 . V_36 = V_37 ;
}
void F_49 ( struct V_19 * V_11 )
{
struct V_3 * V_4 = F_10 ( V_11 ) ;
F_50 ( & V_4 -> V_5 . V_6 ) ;
}
