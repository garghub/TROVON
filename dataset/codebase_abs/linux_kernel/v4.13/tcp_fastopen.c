...
if ( V_72 -> V_88 == 0 )
return false ;
if ( V_72 -> V_74 >= V_72 -> V_88 ) {
struct V_23 * V_89 ;
F_14 ( & V_72 -> V_73 ) ;
V_89 = V_72 -> V_90 ;
if ( ! V_89 || F_54 ( V_89 -> V_91 . V_92 , V_93 ) ) {
F_55 ( F_56 ( V_45 ) ,
V_94 ) ;
F_18 ( & V_72 -> V_73 ) ;
return false ;
...
struct V_61 * V_62 )
{
struct V_18 V_96 = { . V_10 = - 1 } ;
bool V_97 = F_31 ( V_46 ) -> V_49 != F_31 ( V_46 ) -> V_54 + 1 ;
struct V_44 * V_66 ;
if ( V_19 -> V_10 == 0 )
F_59 ( F_56 ( V_45 ) , V_98 ) ;
if ( ! ( ( V_99 & V_100 ) &&
...
V_19 -> V_10 == V_22 &&
V_19 -> V_10 == V_96 . V_10 &&
! memcmp ( V_19 -> V_21 , V_96 . V_21 , V_19 -> V_10 ) ) {
V_102:
...
bool F_60 ( struct V_44 * V_45 , T_3 * V_105 ,
struct V_18 * V_106 )
{
unsigned long V_107 = 0 ;
int V_108 = 0 ;
F_61 ( V_45 , V_105 , V_106 , & V_108 , & V_107 ) ;
if ( V_108 > 1 &&
F_62 ( V_93 , V_107 + ( 60 * V_109 << V_108 ) ) ) {
V_106 -> V_10 = - 1 ;
return false ;
}
if ( F_63 ( V_45 ) ) {
...
{
struct V_18 V_106 = { . V_10 = 0 } ;
struct V_47 * V_48 = F_30 ( V_45 ) ;
T_3 V_105 ;
if ( V_48 -> V_111 && ! V_48 -> V_112 ) {
if ( F_60 ( V_45 , & V_105 , & V_106 ) ) {
F_65 ( V_45 ) -> V_113 = 1 ;
return true ;
}
V_48 -> V_112 = F_66 ( sizeof( * V_48 -> V_112 ) ,
V_45 -> V_114 ) ;
if ( V_48 -> V_112 )
V_48 -> V_112 -> V_106 = V_106 ;
else
* V_11 = - V_115 ;
}
return false ;
...
{
int V_119 = F_71 ( & V_116 ) ;
int V_120 ;
unsigned long V_121 ;
if ( ! V_119 )
return false ;
V_120 = 1 << F_72 ( V_119 - 1 , 6 ) ;
V_121 = V_120 * V_122 * V_109 ;
if ( F_62 ( V_93 , V_117 + V_121 ) )
return true ;
F_30 ( V_45 ) -> V_123 = 1 ;
return false ;
}
...
return;
if ( ! V_48 -> V_127 ) {
V_125 = F_74 ( & V_48 -> V_128 ) ;
if ( V_125 && ! F_75 ( V_125 ) ) {
V_46 = F_76 ( V_125 , struct V_25 , V_129 ) ;
if ( F_31 ( V_46 ) -> V_55 & V_60 ) {
F_67 ( V_45 ) ;
return;
}
...
F_71 ( & V_116 ) ) {
V_62 = F_77 ( V_45 ) ;
if ( ! ( V_62 && V_62 -> V_130 && ( V_62 -> V_130 -> V_131 & V_132 ) ) )
F_69 () ;
F_78 ( V_62 ) ;
}
}
