...
struct V_127 * V_128 )
{
struct V_129 * V_110 = & V_128 -> V_128 ;
if ( V_128 -> V_130 || V_110 -> V_131 != V_132 )
return - V_43 ;
V_110 -> V_133 = V_134 ;
V_110 -> V_135 = V_136 ;
...
static int F_27 ( struct V_2 * V_3 , struct V_139 * V_140 )
{
struct V_1 * V_21 = F_1 ( V_3 ) ;
...
V_27 += 4 ;
V_140 -> V_27 = V_27 ;
V_140 -> V_144 = ( ( V_142 & 0x40 ) != 0 ) ;
V_140 -> line = ( V_142 & 0x3f ) << 3 ;
V_140 -> line |= ( V_143 & 0x70 ) >> 4 ;
V_143 &= 0xf ;
if ( ! memcmp ( V_27 , V_141 , sizeof( V_141 ) ) )
return 0 ;
switch ( V_143 ) {
case 1 :
V_140 -> type = V_115 ;
...
static int F_28 ( struct V_2 * V_3 , struct V_145 * V_146 )
{
struct V_1 * V_21 = F_1 ( V_3 ) ;
int V_147 ;
if ( V_21 -> V_148 )
return 0 ;
V_147 = F_11 ( V_3 , V_149 ) ;
F_10 ( 1 , V_24 , V_3 , L_8 , V_147 ) ;
V_146 -> signal = ( ( V_147 & ( 1 << 6 ) ) == 0 ) ? 0xffff : 0x0 ;
return 0 ;
}
...
{
struct V_1 * V_21 = F_1 ( V_3 ) ;
T_1 V_153 = ( V_21 -> V_23 <= V_14 ) ? 0xf8 : 0xf0 ;
F_10 ( 1 , V_24 , V_3 , L_9 ,
V_150 , V_151 ) ;
if ( ( V_21 -> V_23 <= V_16 ||
V_21 -> V_23 == V_15 ) &&
...
if ( V_150 > V_156 )
return - V_43 ;
if ( V_21 -> V_150 == V_150 && V_21 -> V_151 == V_151 )
return 0 ;
F_10 ( 1 , V_24 , V_3 , L_10 ,
( V_150 >= V_157 ) ? L_11 : L_12 ,
( V_151 == V_158 ) ? L_13 : L_14 ) ;
V_21 -> V_150 = V_150 ;
if ( V_21 -> V_23 <= V_14 ) {
if ( V_150 >= V_154 )
V_150 -= 2 ;
...
F_4 ( V_3 , V_161 ,
( F_11 ( V_3 , V_161 ) & V_153 ) |
V_150 ) ;
F_4 ( V_3 , V_162 ,
( F_11 ( V_3 , V_162 ) & 0x7f ) |
( V_21 -> V_150 >= V_157 ? 0x80 : 0x0 ) ) ;
V_21 -> V_151 = V_151 ;
if ( V_21 -> V_23 == V_17 ||
V_21 -> V_23 == V_18 ) {
F_4 ( V_3 , V_163 ,
...
static int F_33 ( struct V_2 * V_3 , int V_166 )
{
struct V_1 * V_21 = F_1 ( V_3 ) ;
...
return 0 ;
V_21 -> V_166 = V_166 ;
if ( ! F_7 ( V_21 -> V_23 , V_167 ) )
return 0 ;
F_4 ( V_3 , V_167 , V_21 -> V_166 ) ;
return 0 ;
}
static int F_34 ( struct V_2 * V_3 , T_2 V_36 , T_2 V_168 )
{
struct V_1 * V_21 = F_1 ( V_3 ) ;
if ( V_36 != V_169 && V_36 != V_170 )
return - V_43 ;
V_21 -> V_46 = V_36 ;
V_21 -> V_50 = V_168 & V_171 ;
V_21 -> V_48 = ( V_168 & V_172 ) ? 3 : 4 ;
V_21 -> V_47 = V_168 & V_173 ;
V_21 -> V_49 = V_168 & V_174 ;
F_16 ( V_3 , V_21 -> V_55 ) ;
return 0 ;
}
...
static int F_36 ( struct V_2 * V_3 , struct V_175 * V_22 )
{
switch ( V_22 -> V_12 ) {
case V_117 :
...
struct V_1 * V_21 = F_1 ( V_3 ) ;
int V_177 , V_178 ;
V_177 = F_11 ( V_3 , V_149 ) ;
if ( V_21 -> V_23 == V_18 ) {
V_178 = F_11 ( V_3 , V_179 ) ;
F_10 ( 1 , V_24 , V_3 , L_19 , V_178 ) ;
switch ( V_178 & 0x03 ) {
case 1 :
* V_44 &= V_180 ;
break;
case 2 :
* V_44 &= V_181 | V_182 | V_103 |
V_102 | V_104 ;
break;
case 3 :
* V_44 &= V_106 ;
...
static int F_38 ( struct V_2 * V_3 , T_2 * V_147 )
{
struct V_1 * V_21 = F_1 ( V_3 ) ;
int V_178 = 0x80 ;
int V_177 ;
...
V_178 = F_11 ( V_3 , V_179 ) ;
V_177 = F_11 ( V_3 , V_149 ) ;
if ( ( V_177 & 0xc1 ) == 0x81 && ( V_178 & 0xc0 ) == 0x80 )
* V_147 = 0 ;
return 0 ;
}
static int F_39 ( struct V_2 * V_3 , struct V_186 * V_8 )
{
V_8 -> V_58 = F_11 ( V_3 , V_8 -> V_8 & 0xff ) ;
V_8 -> V_187 = 1 ;
return 0 ;
}
static int F_40 ( struct V_2 * V_3 , const struct V_186 * V_8 )
{
...
if ( V_21 -> V_23 != V_18 ) {
V_177 = F_11 ( V_3 , V_149 ) ;
V_188 = ( V_177 & 0xc1 ) == 0x81 ;
F_42 ( V_3 , L_23 , V_188 ? L_24 : L_25 ) ;
F_42 ( V_3 , L_26 , ( V_177 & 0x20 ) ? L_27 : L_28 ) ;
return 0 ;
}
V_178 = F_11 ( V_3 , V_179 ) ;
V_177 = F_11 ( V_3 , V_149 ) ;
V_188 = ( V_177 & 0xc1 ) == 0x81 && ( V_178 & 0xc0 ) == 0x80 ;
V_189 = ! ( V_177 & 0x10 ) ;
if ( V_21 -> V_150 >= 6 )
F_42 ( V_3 , L_29 , V_21 -> V_150 - 6 ) ;
else
F_42 ( V_3 , L_30 , V_21 -> V_150 ) ;
F_42 ( V_3 , L_23 , V_188 ? ( V_189 ? L_31 : L_32 ) : L_25 ) ;
F_42 ( V_3 , L_26 , ( V_177 & 0x20 ) ? L_27 : L_28 ) ;
switch ( V_178 & 0x03 ) {
case 1 :
F_42 ( V_3 , L_33 ) ;
...
V_192 = F_11 ( V_3 , V_96 ) ;
V_192 &= ~ V_194 ;
V_192 |= ( ( * V_22 -> V_193 ) << V_195 ) ;
F_4 ( V_3 , V_96 , V_192 ) ;
}
if ( V_22 -> V_196 ) {
V_192 = F_11 ( V_3 , V_159 ) ;
V_192 &= ~ V_197 ;
if ( * V_22 -> V_196 )
V_192 |= ( 1 << V_198 ) ;
F_4 ( V_3 , V_159 , V_192 ) ;
...
V_192 = F_11 ( V_3 , V_159 ) ;
V_192 &= ~ V_200 ;
V_192 |= ( * V_22 -> V_199 << V_201 ) ;
F_4 ( V_3 , V_159 , V_192 ) ;
}
if ( V_22 -> V_202 ) {
V_192 = F_11 ( V_3 , V_203 ) ;
V_192 &= ~ V_204 ;
V_192 |= ( * V_22 -> V_202 << V_205 ) ;
F_45 ( * V_22 -> V_202 == V_206 ) ;
F_4 ( V_3 , V_203 , V_192 ) ;
}
if ( V_22 -> V_207 ) {
V_192 = F_11 ( V_3 , V_203 ) ;
V_192 &= ~ V_208 ;
V_192 |= ( * V_22 -> V_207 << V_209 ) ;
F_4 ( V_3 , V_203 , V_192 ) ;
}
if ( V_22 -> V_210 ) {
V_192 = F_11 ( V_3 , V_160 ) ;
V_192 &= ~ V_211 ;
if ( * V_22 -> V_210 )
V_192 |= ( 1 << V_212 ) ;
F_4 ( V_3 , V_160 , V_192 ) ;
...
int V_29 ;
int V_217 ;
V_217 = ! V_12 || V_12 -> V_218 == 1 ;
for ( V_29 = 0 ; V_29 < V_215 ; V_29 ++ ) {
F_6 ( V_11 , 0 , V_29 ) ;
V_214 [ V_29 ] = F_12 ( V_11 , 0 ) ;
V_190 [ V_29 ] = ( V_214 [ V_29 ] & 0x0f ) + '0' ;
if ( V_190 [ V_29 ] > '9' )
V_190 [ V_29 ] += 'a' - '9' - 1 ;
}
V_190 [ V_29 ] = '\0' ;
if ( ! memcmp ( V_190 + 1 , L_38 , 4 ) ) {
V_216 = V_190 [ 5 ] ;
snprintf ( V_190 , V_215 , L_39 , V_216 ) ;
if ( ! V_217 && strcmp ( V_190 , V_12 -> V_190 ) )
return - V_43 ;
switch ( V_216 ) {
case '1' :
if ( V_214 [ 0 ] & 0xf0 ) {
snprintf ( V_190 , V_215 , L_40 , V_216 ) ;
F_47 ( V_11 , L_41 ) ;
return V_14 ;
}
return V_13 ;
...
if ( ! memcmp ( V_190 , L_43 , 4 ) ) {
V_216 = 0 ;
for ( V_29 = 0 ; V_29 < 4 ; V_29 ++ ) {
V_216 = V_216 << 1 ;
V_216 |= ( V_214 [ V_29 ] & 0x80 ) ? 1 : 0 ;
}
F_48 ( V_190 , L_44 , V_215 ) ;
if ( ! V_217 && strcmp ( V_190 , V_12 -> V_190 ) )
return - V_43 ;
F_49 ( 1 , V_24 , V_11 ,
L_45 ,
V_190 , 16 , V_214 , V_11 -> V_219 << 1 ) ;
return V_15 ;
}
if ( ! memcmp ( V_190 , L_46 , V_215 ) ) {
F_48 ( V_190 , L_47 , V_215 ) ;
if ( ! V_217 && strcmp ( V_190 , V_12 -> V_190 ) )
return - V_43 ;
F_49 ( 1 , V_24 , V_11 ,
L_45 ,
...
F_49 ( 1 , V_24 , V_11 , L_48 ,
16 , V_214 , V_11 -> V_219 << 1 ) ;
return - V_220 ;
}
...
int V_184 ;
#endif
if ( ! F_52 ( V_11 -> V_224 , V_225 ) )
return - V_176 ;
V_23 = F_46 ( V_11 , V_12 , V_190 ) ;
if ( V_23 == - V_43 ) {
F_53 ( V_11 , L_49 ,
V_190 , V_12 -> V_190 ) ;
return - V_220 ;
...
if ( V_23 < 0 )
return V_23 ;
F_48 ( V_11 -> V_190 , V_190 , sizeof( V_11 -> V_190 ) ) ;
V_21 = F_54 ( & V_11 -> V_226 , sizeof( * V_21 ) , V_227 ) ;
if ( V_21 == NULL )
return - V_228 ;
V_3 = & V_21 -> V_3 ;
F_55 ( V_3 , V_11 , & V_229 ) ;
#if F_51 ( V_223 )
V_21 -> V_230 [ V_231 ] . V_168 = V_232 ;
V_21 -> V_230 [ V_233 ] . V_168 = V_234 ;
V_21 -> V_230 [ V_235 ] . V_168 = V_234 ;
V_3 -> V_236 . V_237 = V_238 ;
V_184 = F_56 ( & V_3 -> V_236 , V_239 , V_21 -> V_230 ) ;
if ( V_184 < 0 )
return V_184 ;
#endif
F_47 ( V_11 , L_50 , V_190 ,
V_11 -> V_219 << 1 , V_11 -> V_224 -> V_190 ) ;
V_7 = & V_21 -> V_7 ;
F_57 ( V_7 , 6 ) ;
F_58 ( V_7 , & V_240 ,
V_61 , 0 , 255 , 1 , 128 ) ;
...
F_58 ( V_7 , & V_240 ,
V_67 , - 128 , 127 , 1 , 0 ) ;
V_21 -> V_57 = F_58 ( V_7 , & V_240 ,
V_56 , 0 , 1 , 1 , 1 ) ;
V_21 -> V_59 = F_58 ( V_7 , & V_240 ,
V_241 , 0 , 127 , 1 , 40 ) ;
V_3 -> V_242 = V_7 ;
if ( V_7 -> error ) {
int V_30 = V_7 -> error ;
...
V_21 -> V_23 = V_23 ;
V_21 -> V_55 = 48000 ;
F_10 ( 1 , V_24 , V_3 , L_51 ) ;
V_21 -> V_46 = V_170 ;
V_222 = V_11 -> V_226 . V_243 ;
switch ( V_21 -> V_23 ) {
case V_13 :
case V_14 :
F_9 ( V_3 , V_244 ) ;
