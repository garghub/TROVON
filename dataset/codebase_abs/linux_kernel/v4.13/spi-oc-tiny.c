...
if ( ! F_25 ( V_46 , L_1 , & V_48 ) )
V_7 -> V_8 = V_48 ;
if ( ! F_25 ( V_46 , L_2 , & V_48 ) )
V_7 -> V_9 = V_48 ;
return 0 ;
}
static int F_20 ( struct V_43 * V_44 )
...
{
struct V_53 * V_54 = F_27 ( & V_44 -> V_41 ) ;
struct V_1 * V_7 ;
struct V_55 * V_4 ;
struct V_56 * V_57 ;
unsigned int V_33 ;
int V_58 = - V_51 ;
V_4 = F_28 ( & V_44 -> V_41 , sizeof( struct V_1 ) ) ;
if ( ! V_4 )
return V_58 ;
V_4 -> V_59 = V_44 -> V_60 ;
V_4 -> V_61 = 255 ;
...
V_7 -> V_52 . V_65 = F_6 ;
V_7 -> V_52 . V_66 = F_15 ;
V_57 = F_30 ( V_44 , V_67 , 0 ) ;
V_7 -> V_20 = F_31 ( & V_44 -> V_41 , V_57 ) ;
if ( F_32 ( V_7 -> V_20 ) ) {
V_58 = F_33 ( V_7 -> V_20 ) ;
goto exit;
}
V_7 -> V_34 = F_34 ( V_44 , 0 ) ;
if ( V_7 -> V_34 >= 0 ) {
F_35 ( & V_7 -> V_39 ) ;
V_58 = F_36 ( & V_44 -> V_41 , V_7 -> V_34 , F_18 , 0 ,
V_44 -> V_68 , V_7 ) ;
if ( V_58 )
goto exit;
}
...
for ( V_33 = 0 ; V_33 < V_7 -> V_11 ; V_33 ++ ) {
V_58 = F_37 ( V_7 -> V_12 [ V_33 ] , F_38 ( & V_44 -> V_41 ) ) ;
if ( V_58 )
goto V_70;
F_39 ( V_7 -> V_12 [ V_33 ] , 1 ) ;
}
V_7 -> V_52 . V_4 -> V_61 = F_40 ( 1 , V_7 -> V_11 ) ;
V_58 = F_41 ( & V_7 -> V_52 ) ;
if ( V_58 )
goto exit;
F_42 ( & V_44 -> V_41 , L_3 , V_7 -> V_20 , V_7 -> V_34 ) ;
return 0 ;
V_70:
while ( V_33 -- > 0 )
F_43 ( V_7 -> V_12 [ V_33 ] ) ;
