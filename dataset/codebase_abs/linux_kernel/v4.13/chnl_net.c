...
static void F_53 ( struct V_54 * V_19 )
{
struct V_11 * V_12 ;
V_19 -> V_81 = & V_81 ;
V_19 -> V_82 = true ;
...
V_12 -> V_26 . V_92 = V_93 ;
V_12 -> V_26 . V_94 = V_95 ;
V_12 -> V_26 . V_96 . V_97 . V_98 . V_99 = V_100 ;
V_12 -> V_49 = false ;
F_54 ( & V_12 -> V_51 ) ;
}
static int F_55 ( struct V_9 * V_10 , const struct V_54 * V_19 )
{
struct V_11 * V_12 ;
T_1 V_101 ;
V_12 = F_35 ( V_19 ) ;
if ( F_56 ( V_10 , V_102 ,
V_12 -> V_26 . V_96 . V_97 . V_98 . V_99 ) ||
F_56 ( V_10 , V_103 ,
V_12 -> V_26 . V_96 . V_97 . V_98 . V_99 ) )
goto V_104;
V_101 = V_12 -> V_26 . V_21 == V_27 ;
if ( F_57 ( V_10 , V_105 , V_101 ) )
goto V_104;
return 0 ;
V_104:
return - V_106 ;
...
static int F_61 ( struct V_110 * V_111 , struct V_54 * V_19 ,
struct V_107 * V_112 [] , struct V_107 * V_108 [] ,
struct V_113 * V_114 )
{
int V_115 ;
struct V_11 * V_116 ;
F_2 () ;
V_116 = F_35 ( V_19 ) ;
F_58 ( V_108 , & V_116 -> V_26 ) ;
V_115 = F_62 ( V_19 ) ;
if ( V_115 )
F_36 ( L_23 ) ;
else
F_63 ( & V_116 -> V_36 , & V_117 ) ;
if ( V_116 -> V_26 . V_96 . V_97 . V_98 . V_99 == V_100 ) {
V_116 -> V_26 . V_96 . V_97 . V_98 . V_99 = V_19 -> V_118 ;
V_116 -> V_26 . V_21 = V_27 ;
}
return V_115 ;
}
static int F_64 ( struct V_54 * V_19 , struct V_107 * V_112 [] ,
struct V_107 * V_108 [] ,
struct V_113 * V_114 )
{
struct V_11 * V_116 ;
...
static T_2 F_66 ( const struct V_54 * V_19 )
{
return
F_67 ( 4 ) +
F_67 ( 4 ) +
