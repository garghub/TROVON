...
F_24 ( & V_1 -> V_40 , & V_46 ) ;
F_25 ( ( const struct V_20 * ) V_18 , V_43 ,
& V_1 -> V_40 ) ;
if ( F_26 ( V_1 ) ) {
F_27 ( & V_1 -> V_40 ) ;
F_24 ( & V_46 , & V_1 -> V_40 ) ;
...
static T_2 F_29 ( struct V_3 * V_3 , struct V_35 * V_36 ,
char * V_18 )
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
unsigned int V_43 ;
...
int V_14 ;
V_13 = V_1 -> V_13 ;
V_13 . V_49 = F_31 ( V_18 , V_48 , 0 ) ;
if ( ( V_14 = F_9 ( V_1 , & V_13 ) ) )
return V_14 ;
return V_37 ;
}
static T_2 F_32 ( struct V_3 * V_3 , struct V_35 * V_36 ,
char * V_18 )
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
...
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
return snprintf ( V_18 , V_31 , L_2 , V_1 -> V_13 . V_50 ) ;
}
...
int V_14 ;
V_13 = V_1 -> V_13 ;
V_13 . V_51 = F_31 ( V_18 , & V_48 , 0 ) ;
V_48 ++ ;
if ( V_48 - V_18 >= V_37 )
return - V_45 ;
V_13 . V_52 = F_31 ( V_48 , & V_48 , 0 ) ;
if ( ( V_14 = F_9 ( V_1 , & V_13 ) ) )
return V_14 ;
return V_37 ;
}
...
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
return snprintf ( V_18 , V_31 , L_3 , V_1 -> V_13 . V_51 ,
V_1 -> V_13 . V_52 ) ;
}
...
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
return snprintf ( V_18 , V_31 , L_2 , V_1 -> V_53 . V_54 ) ;
}
...
F_10 () ;
V_1 -> V_16 |= V_17 ;
V_14 = F_39 ( V_1 , F_31 ( V_18 , & V_48 , 0 ) ) ;
V_1 -> V_16 &= ~ V_17 ;
F_12 () ;
if ( V_14 < 0 )
return V_14 ;
...
static T_2 F_44 ( struct V_3 * V_3 ,
struct V_35 * V_36 , char * V_18 )
{
return 0 ;
}
...
int V_14 ;
V_13 = V_1 -> V_13 ;
V_13 . V_55 = F_31 ( V_18 , & V_48 , 0 ) ;
V_48 ++ ;
if ( V_48 - V_18 >= V_37 )
return - V_45 ;
V_13 . V_56 = F_31 ( V_48 , & V_48 , 0 ) ;
F_10 () ;
V_14 = F_46 ( V_1 , & V_13 ) ;
F_12 () ;
if ( V_14 < 0 )
...
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
return snprintf ( V_18 , V_31 , L_3 , V_1 -> V_13 . V_55 ,
V_1 -> V_13 . V_56 ) ;
}
static T_2 F_48 ( struct V_3 * V_3 ,
struct V_35 * V_36 , char * V_18 )
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
return snprintf ( V_18 , V_31 , L_4 , V_1 -> V_53 . V_57 ) ;
}
static T_2 F_49 ( struct V_3 * V_3 ,
struct V_35 * V_36 ,
const char * V_18 , T_1 V_37 )
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
...
{
struct V_1 * V_1 = F_15 ( V_3 ) ;
return snprintf ( V_18 , V_31 , L_2 , V_1 -> V_58 ) ;
}
...
V_63 += F_56 ( & V_18 [ V_63 ] , V_31 - V_63 , L_6 ,
V_1 -> V_62 + V_43 ) ;
F_54 ( & V_1 -> V_10 ) ;
return V_63 ;
}
...
F_58 ( V_1 -> V_4 , V_1 ) ;
V_1 -> V_64 |= V_65 ;
for ( V_43 = 0 ; V_43 < F_59 ( V_66 ) ; V_43 ++ ) {
error = F_60 ( V_1 -> V_4 , & V_66 [ V_43 ] ) ;
if ( error )
break;
}
if ( error ) {
while ( -- V_43 >= 0 )
F_61 ( V_1 -> V_4 , & V_66 [ V_43 ] ) ;
V_1 -> V_64 &= ~ V_65 ;
}
return 0 ;
}
...
void F_63 ( struct V_1 * V_1 , T_4 V_67 , T_4 V_68 , T_4 F_18 )
{
