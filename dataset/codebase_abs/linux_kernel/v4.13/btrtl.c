...
if ( V_7 -> V_10 != sizeof( struct V_70 ) ) {
F_4 ( L_31 ,
V_2 -> V_9 ) ;
F_6 ( V_7 ) ;
return F_26 ( - V_11 ) ;
...
if ( F_3 ( V_7 ) )
return - F_5 ( V_7 ) ;
V_71 = (struct V_70 * ) V_7 -> V_12 ;
F_7 ( L_32
L_33 , V_2 -> V_9 , V_71 -> V_72 , V_71 -> V_73 ,
V_71 -> V_74 , V_71 -> V_14 ) ;
V_14 = F_11 ( V_71 -> V_14 ) ;
F_6 ( V_7 ) ;
switch ( V_14 ) {
