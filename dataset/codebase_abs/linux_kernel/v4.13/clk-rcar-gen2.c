...
V_23 = L_4 ;
div = V_65 & F_22 ( 18 ) ? 36 : 24 ;
} else if ( ! strcmp ( V_28 , L_9 ) ) {
V_23 = L_10 ;
div = ( V_65 & ( F_22 ( 3 ) | F_22 ( 2 ) | F_22 ( 1 ) ) ) == F_22 ( 2 )
? 8 : 10 ;
...
return F_24 ( NULL , V_28 , V_23 , 0 ,
V_22 -> V_8 + V_69 , V_57 ,
4 , 0 , V_51 , & V_22 -> V_45 ) ;
}
static T_1 T_2 F_25 ( void )
{
void T_3 * V_70 = F_26 ( V_71 , 4 ) ;
T_1 V_72 ;
F_27 ( ! V_70 ) ;
V_72 = F_28 ( V_70 ) ;
F_29 ( V_70 ) ;
...
static void T_2 F_30 ( struct V_36 * V_37 )
{
const struct V_54 * V_55 ;
struct V_21 * V_22 ;
struct V_20 * * V_73 ;
...
V_73 = F_11 ( V_74 * sizeof( * V_73 ) , V_26 ) ;
if ( V_22 == NULL || V_73 == NULL ) {
F_34 ( L_17 , V_76 ) ;
return;
}
F_35 ( & V_22 -> V_45 ) ;
V_22 -> V_77 . V_73 = V_73 ;
V_22 -> V_77 . V_78 = V_74 ;
V_22 -> V_8 = F_36 ( V_37 , 0 ) ;
if ( F_37 ( V_22 -> V_8 == NULL ) )
return;
V_55 = & V_79 [ F_38 ( V_65 ) ] ;
...
if ( F_14 ( V_20 ) )
F_34 ( L_18 ,
V_76 , V_37 -> V_28 , V_28 , F_40 ( V_20 ) ) ;
else
V_22 -> V_77 . V_73 [ V_15 ] = V_20 ;
}
F_41 ( V_37 , V_80 , & V_22 -> V_77 ) ;
F_42 ( V_37 ) ;
}
