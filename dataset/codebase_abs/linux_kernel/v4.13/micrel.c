...
if ( V_35 -> V_38 >= 0 )
F_8 ( V_2 , V_35 -> type -> V_39 , V_35 -> V_38 ) ;
return 0 ;
}
...
int V_68 ;
int V_69 = 0 ;
if ( ! F_19 ( V_43 , V_60 , & V_64 ) )
V_69 ++ ;
if ( ! F_19 ( V_43 , V_61 , & V_65 ) )
V_69 ++ ;
if ( ! F_19 ( V_43 , V_62 , & V_66 ) )
V_69 ++ ;
if ( ! F_19 ( V_43 , V_63 , & V_67 ) )
V_69 ++ ;
if ( ! V_69 )
return 0 ;
if ( V_69 < 4 )
...
if ( ! F_19 ( V_43 , V_82 [ V_85 ] , V_4 + V_85 ) )
V_69 ++ ;
if ( ! V_69 )
return 0 ;
if ( V_69 < V_83 )
V_68 = F_22 ( V_2 , V_86 , 2 , V_24 ) ;
else
V_68 = 0 ;
...
return F_21 ( V_2 , V_86 , 2 , V_24 , V_68 ) ;
}
static int F_24 ( struct V_1 * V_2 )
{
int V_88 ;
V_88 = F_21 ( V_2 , V_86 , 0 ,
V_89 , 0x0006 ) ;
V_88 = F_21 ( V_2 , V_86 , 0 ,
V_90 , 0x1A80 ) ;
if ( V_88 )
...
{
int V_24 ;
V_24 = F_22 ( V_2 , V_86 , 0x1C , V_91 ) ;
if ( V_24 < 0 )
return V_24 ;
return F_21 ( V_2 , V_86 , 0x1C , V_91 ,
V_24 | V_92 ) ;
}
...
static int
F_34 ( struct V_1 * V_2 , int V_115 , T_2 V_3 )
{
return - 1 ;
}
static int
F_35 ( struct V_1 * V_2 , int V_115 , T_2 V_3 , T_2 V_4 )
{
return - 1 ;
}
...
static void F_38 ( struct V_1 * V_2 , T_3 * V_117 )
{
int V_85 ;
for ( V_85 = 0 ; V_85 < F_37 ( V_116 ) ; V_85 ++ ) {
memcpy ( V_117 + V_85 * V_118 ,
V_116 [ V_85 ] . string , V_118 ) ;
}
}
static T_5 F_39 ( struct V_1 * V_2 , int V_85 )
{
...
{
const struct V_11 * type = V_2 -> V_12 -> V_13 ;
const struct V_42 * V_126 = V_2 -> V_44 . V_45 . V_43 ;
struct V_34 * V_35 ;
struct V_127 * V_127 ;
int V_30 ;
V_35 = F_46 ( & V_2 -> V_44 . V_45 , sizeof( * V_35 ) , V_128 ) ;
if ( ! V_35 )
return - V_129 ;
V_2 -> V_35 = V_35 ;
V_35 -> type = type ;
if ( type -> V_39 ) {
V_30 = F_19 ( V_126 , L_18 ,
& V_35 -> V_38 ) ;
if ( V_30 )
V_35 -> V_38 = - 1 ;
if ( V_35 -> V_38 > 3 ) {
...
V_127 = F_47 ( & V_2 -> V_44 . V_45 , L_20 ) ;
if ( ! F_48 ( V_127 ) ) {
unsigned long V_130 = F_49 ( V_127 ) ;
bool V_131 ;
V_35 -> V_36 = type -> V_132 ;
V_131 = F_15 ( V_126 ,
L_21 ) ;
if ( V_130 > 24500000 && V_130 < 25500000 ) {
V_35 -> V_37 = V_131 ;
} else if ( V_130 > 49500000 && V_130 < 50500000 ) {
V_35 -> V_37 = ! V_131 ;
} else {
F_9 ( V_2 , L_22 ,
V_130 ) ;
