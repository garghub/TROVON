...
F_22 ( V_2 , V_23 , V_31 ) ;
F_24 ( V_2 , V_23 ) ;
F_20 ( V_2 , L_10 , F_48 ( & V_23 -> V_42 . V_43 ) ) ;
if ( F_43 ( V_2 ) )
goto V_44;
V_24 = 0 ;
V_44:
...
static int F_50 ( struct V_57 * V_57 , struct V_58 * V_58 )
{
return F_51 ( V_57 , V_58 , & V_59 ,
sizeof( struct V_11 ) ) ;
}
static void * F_52 ( struct V_1 * V_10 , T_1 * V_19 )
{
...
continue;
* V_19 = V_60 + 1 ;
return F_54 ( V_41 -> V_23 . V_63 , V_60 ) ;
}
return NULL ;
}
static void * F_55 ( struct V_1 * V_10 , void * V_21 , T_1 * V_19 )
{
struct V_41 * V_41 = F_29 ( V_10 ) ;
int V_60 ;
...
static void F_56 ( struct V_1 * V_10 , void * V_21 )
{
}
static int F_57 ( struct V_1 * V_10 , void * V_21 )
{
struct V_41 * V_41 = F_29 ( V_10 ) ;
unsigned int V_64 = F_48 ( & V_41 -> V_23 . V_65 ) ;
...
static int F_58 ( struct V_57 * V_57 , struct V_58 * V_58 )
{
return F_51 ( V_57 , V_58 , & V_78 ,
sizeof( struct V_79 ) ) ;
}
static int F_59 ( struct V_41 * V_41 )
{
struct V_80 * V_81 ;
T_5 V_82 ;
T_6 V_83 ;
V_81 = F_60 ( L_14 , 0440 , V_41 -> V_84 , & V_85 ) ;
if ( ! V_81 )
goto V_86;
V_82 = F_61 ( V_41 -> V_87 , 0 ) ;
V_83 = F_62 ( V_41 -> V_87 , 0 ) ;
if ( F_63 ( V_82 ) && F_64 ( V_83 ) )
F_65 ( V_81 , V_82 , V_83 ) ;
V_81 = F_60 ( L_14 , V_88 , V_41 -> V_89 ,
& V_90 ) ;
if ( ! V_81 )
goto V_91;
return 0 ;
...
static void F_67 ( struct V_41 * V_41 )
{
F_66 ( L_14 , V_41 -> V_89 ) ;
F_66 ( L_14 , V_41 -> V_84 ) ;
}
...
static int
F_68 ( struct V_93 * V_94 , int V_95 ,
void T_7 * V_96 , T_8 * V_97 , T_1 * V_98 )
{
int V_24 ;
V_24 = F_69 ( V_94 , V_95 , V_96 , V_97 , V_98 ) ;
if ( V_24 < 0 || ! V_95 )
return V_24 ;
V_24 = F_70 ( V_99 ) ;
V_99 = V_100 ;
...
static int F_71 ( struct V_41 * V_41 )
{
struct V_93 * V_94 ;
V_94 = F_72 ( V_101 , sizeof( V_101 ) ,
V_102 ) ;
if ( ! V_94 )
goto V_103;
...
if ( ! F_36 ( & V_109 , V_41 ) )
V_94 [ 2 ] . V_110 = 0444 ;
V_41 -> V_23 . V_111 = F_73 ( V_41 , L_15 , V_94 ) ;
if ( ! V_41 -> V_23 . V_111 )
goto V_112;
return 0 ;
V_112:
...
static void F_75 ( struct V_41 * V_41 )
{
struct V_93 * V_94 ;
V_94 = V_41 -> V_23 . V_111 -> V_113 ;
F_76 ( V_41 -> V_23 . V_111 ) ;
F_74 ( V_94 ) ;
}
static int F_71 ( struct V_41 * V_41 )
{
...
static int F_77 ( struct V_41 * V_41 )
{
int V_24 ;
V_24 = F_78 ( V_41 ) ;
if ( V_24 < 0 )
...
{
struct V_41 * V_41 ;
F_81 (net, net_exit_list, exit_list) {
F_75 ( V_41 ) ;
F_67 ( V_41 ) ;
}
F_82 ( V_118 ) ;
