...
bool F_94 ( const struct V_20 * V_21 )
{
struct V_22 * V_16 = F_95 ( V_21 ) ;
return ! ! V_16 -> V_76 ;
}
int F_96 ( struct V_22 * V_16 , T_2 V_97 )
{
int V_30 = 0 ;
struct V_46 * V_47 ;
struct V_4 * V_56 ;
...
if ( V_16 -> V_32 == V_97 )
return 0 ;
F_97 (p, &br->port_list, list) {
V_12 = F_10 ( V_47 ) ;
F_97 (vlan, &vg->vlan_list, vlist) {
...
return 0 ;
V_99:
F_98 (vlan, &vg->vlan_list, vlist)
F_22 ( V_47 -> V_21 , V_97 , V_56 -> V_6 ) ;
F_98 (p, &br->port_list, list) {
V_12 = F_10 ( V_47 ) ;
F_97 (vlan, &vg->vlan_list, vlist)
F_22 ( V_47 -> V_21 , V_97 , V_56 -> V_6 ) ;
}
...
int F_99 ( struct V_22 * V_16 , unsigned long V_90 )
{
if ( V_90 != V_85 && V_90 != V_100 )
return - V_101 ;
return F_96 ( V_16 , F_87 ( V_90 ) ) ;
}
int F_100 ( struct V_22 * V_16 , unsigned long V_90 )
{
switch ( V_90 ) {
case 0 :
case 1 :
...
static bool F_101 ( struct V_11 * V_12 , T_1 V_6 )
{
struct V_4 * V_14 ;
if ( V_6 != V_12 -> V_13 )
return false ;
...
static void F_102 ( struct V_22 * V_16 )
{
struct V_46 * V_47 ;
T_1 V_13 = V_16 -> V_102 ;
if ( F_101 ( F_9 ( V_16 ) , V_13 ) )
F_80 ( V_16 , V_13 ) ;
F_97 (p, &br->port_list, list) {
if ( F_101 ( F_10 ( V_47 ) , V_13 ) )
F_103 ( V_47 , V_13 ) ;
}
V_16 -> V_102 = 0 ;
}
int F_104 ( struct V_22 * V_16 , T_1 V_13 )
{
...
V_105 = F_105 ( F_106 ( V_106 ) , sizeof( unsigned long ) ,
V_79 ) ;
if ( ! V_105 )
return - V_80 ;
V_104 = V_16 -> V_102 ;
...
F_24 ( V_12 , V_13 ) )
continue;
V_30 = F_108 ( V_47 , V_13 ,
V_18 |
V_19 ) ;
if ( V_30 )
goto V_107;
F_103 ( V_47 , V_104 ) ;
F_107 ( V_47 -> V_108 , V_105 ) ;
}
V_16 -> V_102 = V_13 ;
V_48:
F_31 ( V_105 ) ;
...
int F_110 ( struct V_22 * V_16 , unsigned long V_90 )
{
T_1 V_13 = V_90 ;
int V_30 = 0 ;
if ( V_90 >= V_109 )
...
V_30 = F_104 ( V_16 , V_13 ) ;
V_48:
return V_30 ;
}
int F_112 ( struct V_22 * V_16 )
{
struct V_11 * V_12 ;
int V_77 = - V_80 ;
...
goto V_112;
F_115 ( & V_12 -> V_37 ) ;
F_116 ( V_47 -> V_82 , V_12 ) ;
if ( V_47 -> V_16 -> V_102 ) {
V_77 = F_108 ( V_47 , V_47 -> V_16 -> V_102 ,
V_18 |
V_19 ) ;
if ( V_77 )
goto V_113;
...
int F_108 ( struct V_46 * V_17 , T_1 V_6 , T_1 V_15 )
{
struct V_23 V_14 = {
. V_24 . V_25 = V_17 -> V_21 ,
. V_24 . V_26 = V_27 ,
...
int F_103 ( struct V_46 * V_17 , T_1 V_6 )
{
struct V_4 * V_14 ;
F_75 () ;
...
void F_119 ( const struct V_4 * V_14 ,
struct V_60 * V_43 )
{
int V_115 ;
...
struct V_60 * V_120 ;
unsigned int V_121 ;
V_120 = F_121 ( V_14 -> V_43 , V_115 ) ;
do {
V_121 = F_122 ( & V_120 -> V_64 ) ;
V_116 = V_120 -> V_75 ;
V_117 = V_120 -> V_74 ;
V_119 = V_120 -> V_65 ;
V_118 = V_120 -> V_67 ;
} while ( F_123 ( & V_120 -> V_64 , V_121 ) );
V_43 -> V_75 += V_116 ;
V_43 -> V_74 += V_117 ;
V_43 -> V_65 += V_119 ;
V_43 -> V_67 += V_118 ;
