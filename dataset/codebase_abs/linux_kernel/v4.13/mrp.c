...
return - 1 ;
V_30 = F_18 ( V_7 -> V_29 , sizeof( * V_30 ) ) ;
F_21 ( V_31 , V_30 ) ;
return 0 ;
}
...
return - 1 ;
V_32 = F_18 ( V_7 -> V_29 , sizeof( * V_32 ) ) ;
V_32 -> V_36 = V_36 ;
V_32 -> V_37 = V_37 ;
...
return - 1 ;
V_39 = F_18 ( V_7 -> V_29 , sizeof( * V_39 ) + V_37 ) ;
F_21 ( 0 , & V_39 -> V_42 ) ;
...
static void F_56 ( unsigned long V_84 )
{
struct V_6 * V_7 = (struct V_6 * ) V_84 ;
F_53 ( & V_7 -> V_75 ) ;
F_45 ( V_7 , V_87 ) ;
...
static int F_57 ( struct V_19 * V_20 , int * V_88 )
{
T_2 V_30 ;
if ( F_58 ( V_20 , * V_88 , & V_30 , sizeof( V_30 ) ) < 0 )
return - 1 ;
if ( V_30 == V_31 ) {
* V_88 += sizeof( V_30 ) ;
return - 1 ;
...
struct V_19 * V_20 , int * V_88 )
{
struct V_41 V_98 ;
T_3 V_99 ;
T_1 V_47 , V_45 ;
F_23 ( V_20 ) -> V_39 = F_61 ( V_20 , * V_88 , sizeof( V_98 ) ,
& V_98 ) ;
if ( ! F_23 ( V_20 ) -> V_39 )
return - 1 ;
* V_88 += sizeof( V_98 ) ;
...
V_100 )
F_45 ( V_7 , V_101 ) ;
V_99 = F_33 ( F_34 ( & F_23 ( V_20 ) -> V_39 -> V_42 ) &
V_102 ) ;
if ( sizeof( struct V_73 ) + F_23 ( V_20 ) -> V_32 -> V_37 >
F_41 ( struct V_19 , V_74 ) )
return - 1 ;
if ( F_58 ( V_20 , * V_88 , F_23 ( V_20 ) -> V_43 ,
F_23 ( V_20 ) -> V_32 -> V_37 ) < 0 )
return - 1 ;
* V_88 += F_23 ( V_20 ) -> V_32 -> V_37 ;
while ( V_99 > 0 ) {
if ( F_58 ( V_20 , * V_88 , & V_47 ,
sizeof( V_47 ) ) < 0 )
return - 1 ;
* V_88 += sizeof( V_47 ) ;
V_45 = V_47 / ( V_50 *
...
static int F_62 ( struct V_6 * V_7 , struct V_19 * V_20 ,
int * V_88 )
{
struct V_38 V_103 ;
F_23 ( V_20 ) -> V_32 = F_61 ( V_20 , * V_88 , sizeof( V_103 ) , & V_103 ) ;
if ( ! F_23 ( V_20 ) -> V_32 )
return - 1 ;
* V_88 += sizeof( V_103 ) ;
if ( F_23 ( V_20 ) -> V_32 -> V_36 == 0 ||
F_23 ( V_20 ) -> V_32 -> V_36 > V_7 -> V_7 -> V_104 ||
F_23 ( V_20 ) -> V_32 -> V_37 == 0 )
return - 1 ;
while ( V_20 -> V_2 > * V_88 ) {
if ( F_57 ( V_20 , V_88 ) < 0 )
break;
if ( F_60 ( V_7 , V_20 , V_88 ) < 0 )
return - 1 ;
}
return 0 ;
}
static int F_63 ( struct V_19 * V_20 , struct V_67 * V_23 ,
struct V_105 * V_106 , struct V_67 * V_107 )
{
struct V_68 * V_69 = F_64 ( V_106 , struct V_68 ,
V_27 ) ;
struct V_70 * V_71 ;
struct V_6 * V_7 ;
struct V_21 V_108 ;
...
if ( F_66 ( ! V_71 ) )
goto V_111;
V_7 = F_68 ( V_71 -> V_72 [ V_69 -> type ] ) ;
if ( F_66 ( ! V_7 ) )
goto V_111;
V_22 = F_61 ( V_20 , V_88 , sizeof( V_108 ) , & V_108 ) ;
if ( ! V_22 )
goto V_111;
V_88 += sizeof( V_108 ) ;
...
static int F_70 ( struct V_67 * V_23 )
{
struct V_70 * V_71 ;
V_71 = F_71 ( sizeof( * V_71 ) , V_112 ) ;
if ( ! V_71 )
return - V_25 ;
F_72 ( V_23 -> V_70 , V_71 ) ;
return 0 ;
}
static void F_73 ( struct V_67 * V_23 )
{
struct V_70 * V_71 = F_40 ( V_23 -> V_70 ) ;
unsigned int V_113 ;
for ( V_113 = 0 ; V_113 <= V_114 ; V_113 ++ ) {
if ( F_40 ( V_71 -> V_72 [ V_113 ] ) )
return;
}
F_74 ( V_23 -> V_70 , NULL ) ;
F_75 ( V_71 , V_115 ) ;
}
int F_76 ( struct V_67 * V_23 , struct V_68 * V_69 )
{
struct V_6 * V_7 ;
int V_48 ;
F_77 () ;
...
V_48 = - V_25 ;
V_7 = F_71 ( sizeof( * V_7 ) , V_112 ) ;
if ( ! V_7 )
goto V_117;
V_48 = F_78 ( V_23 , V_69 -> V_33 ) ;
if ( V_48 < 0 )
goto V_118;
V_7 -> V_23 = V_23 ;
V_7 -> V_7 = V_69 ;
...
F_79 ( & V_7 -> V_75 ) ;
F_80 ( & V_7 -> V_35 ) ;
F_72 ( V_23 -> V_70 -> V_72 [ V_69 -> type ] , V_7 ) ;
F_81 ( & V_7 -> V_82 , F_52 , ( unsigned long ) V_7 ) ;
F_48 ( V_7 ) ;
F_81 ( & V_7 -> V_85 , F_56 ,
( unsigned long ) V_7 ) ;
F_55 ( V_7 ) ;
...
void F_82 ( struct V_67 * V_23 , struct V_68 * V_69 )
{
struct V_70 * V_71 = F_40 ( V_23 -> V_70 ) ;
struct V_6 * V_7 = F_40 (
V_71 -> V_72 [ V_69 -> type ] ) ;
F_77 () ;
F_74 ( V_71 -> V_72 [ V_69 -> type ] , NULL ) ;
F_83 ( & V_7 -> V_82 ) ;
F_83 ( & V_7 -> V_85 ) ;
F_42 ( & V_7 -> V_75 ) ;
F_45 ( V_7 , V_56 ) ;
...
int F_85 ( struct V_68 * V_69 )
{
V_69 -> V_27 . V_120 = F_63 ;
F_86 ( & V_69 -> V_27 ) ;
return 0 ;
}
void F_87 ( struct V_68 * V_69 )
{
F_88 ( & V_69 -> V_27 ) ;
}
