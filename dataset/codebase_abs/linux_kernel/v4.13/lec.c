...
int V_68 ;
char * V_69 ;
F_49 ( F_50 ( V_5 -> V_25 , & F_10 ( V_29 ) -> V_31 ) ) ;
...
break;
case V_77 :
F_52 ( V_10 , V_17 -> V_21 . V_22 . V_23 ) ;
break;
case V_78 :
F_53 ( & V_10 -> V_79 , V_56 ) ;
V_2 = F_54 ( V_10 , V_17 -> V_21 . V_22 . V_72 ) ;
F_55 ( V_10 , V_2 ) ;
F_56 ( & V_10 -> V_79 , V_56 ) ;
if ( V_17 -> V_21 . V_22 . V_80 )
break;
case V_81 :
F_57 ( V_10 , V_17 -> V_21 . V_22 . V_72 ,
V_17 -> V_21 . V_22 . V_75 ,
V_17 -> V_21 . V_22 . V_23 ,
V_17 -> V_21 . V_22 . V_82 ) ;
F_22 ( L_14 ) ;
...
V_10 -> V_96 = & V_96 ;
F_59 () ;
if ( F_60 ( V_7 , V_17 -> V_21 . V_86 . V_97 ) )
F_18 ( L_16 ,
...
static int F_84 ( struct V_28 * V_29 , void T_3 * V_126 )
{
struct V_64 * V_65 ;
int V_127 ;
struct V_128 V_129 ;
V_127 = F_85 ( & V_129 , V_126 , sizeof( struct V_128 ) ) ;
if ( V_127 != 0 )
F_18 ( L_29 , V_127 ) ;
if ( V_129 . V_130 < 0 || V_129 . V_130 >= V_131 ||
! V_132 [ V_129 . V_130 ] )
return - V_104 ;
V_65 = F_86 ( sizeof( struct V_64 ) , V_133 ) ;
if ( ! V_65 )
return - V_134 ;
V_65 -> V_66 = 0 ;
...
V_29 -> V_136 = V_65 ;
V_29 -> V_135 = F_81 ;
F_87 ( F_8 ( V_132 [ V_129 . V_130 ] ) ,
& V_129 , V_29 , V_29 -> V_137 ) ;
V_29 -> V_67 = V_132 [ V_129 . V_130 ] ;
V_29 -> V_137 = F_73 ;
return 0 ;
}
static int F_88 ( struct V_28 * V_29 , int V_126 )
{
if ( V_126 < 0 || V_126 >= V_131 || ! V_132 [ V_126 ] )
return - V_104 ;
V_29 -> V_67 = V_132 [ V_126 ] ;
return F_89 ( F_8 ( V_132 [ V_126 ] ) , V_29 ) ;
}
static int F_90 ( struct V_28 * V_29 , int V_126 )
{
int V_68 ;
struct V_9 * V_10 ;
if ( V_126 < 0 )
...
if ( ! V_156 -> V_176 ) {
V_156 -> V_176 = V_10 ;
F_53 ( & V_10 -> V_79 , V_156 -> V_56 ) ;
}
if ( ! F_103 ( V_156 , V_159 , V_10 ) && ! F_104 ( V_156 , V_159 , V_10 ) ) {
F_56 ( & V_10 -> V_79 , V_156 -> V_56 ) ;
V_156 -> V_176 = NULL ;
...
static int F_119 ( struct V_184 * V_13 , unsigned int V_185 , unsigned long V_126 )
{
...
switch ( V_185 ) {
case V_187 :
V_186 = F_90 ( V_29 , ( int ) V_126 ) ;
if ( V_186 >= 0 )
V_13 -> V_156 = V_193 ;
break;
case V_188 :
V_186 = F_88 ( V_29 , ( int ) V_126 ) ;
break;
case V_189 :
V_186 = F_84 ( V_29 , ( void T_3 * ) V_126 ) ;
break;
}
return V_186 ;
}
...
if ( V_83 == NULL )
V_203 = F_69 ( V_10 , V_204 , V_199 , NULL , NULL ) ;
else {
V_5 = F_7 ( * V_83 , V_18 ) ;
if ( V_5 == NULL )
return - 1 ;
V_5 -> V_19 = * V_83 ;
F_63 ( V_5 , * V_201 , * V_83 ) ;
V_203 = F_69 ( V_10 , V_204 , V_199 , NULL , V_5 ) ;
}
return V_203 ;
}
...
return 0 ;
F_5 ( V_10 -> V_201 ) ;
V_10 -> V_201 = F_132 ( V_201 , V_83 , V_133 ) ;
if ( V_10 -> V_201 == NULL )
return 0 ;
V_10 -> V_83 = V_83 ;
V_5 = F_7 ( V_83 , V_18 ) ;
...
V_5 -> V_19 = V_83 ;
F_63 ( V_5 , V_201 , V_83 ) ;
V_203 = F_69 ( V_10 , V_206 , NULL , NULL , V_5 ) ;
if ( V_203 != 0 )
F_18 ( L_50 ) ;
return 1 ;
}
static void F_58 ( struct V_6 * V_7 , const T_7 * V_72 ,
const T_7 * V_201 , T_8 V_83 )
{
#if 0
int i = 0;
...
static int
F_55 ( struct V_9 * V_10 , struct V_1 * V_214 )
{
struct V_1 * V_2 ;
int V_68 , V_215 = 1 ;
if ( ! V_214 )
...
static struct V_1 * F_54 ( struct V_9 * V_10 ,
...
V_2 -> V_42 = V_42 ;
if ( V_2 -> V_42 )
F_69 ( V_10 , V_234 , V_243 , NULL ,
NULL ) ;
else
F_69 ( V_10 , V_204 , V_243 , NULL , NULL ) ;
...
static int
F_51 ( struct V_9 * V_10 , const unsigned char * V_75 ,
unsigned long V_249 )
{
unsigned long V_56 ;
struct V_160 * V_165 ;
...
static void
F_57 ( struct V_9 * V_10 , const unsigned char * V_72 ,
...
V_2 -> V_148 = V_221 ;
F_69 ( V_10 , V_239 , V_2 -> V_72 , V_75 , NULL ) ;
}
F_22 ( L_82 ) ;
F_149 ( V_10 ) ;
V_61:
...
static void
F_87 ( struct V_9 * V_10 , const struct V_128 * V_129 ,
struct V_28 * V_29 ,
...
static void F_52 ( struct V_9 * V_10 , unsigned long V_253 )
{
unsigned long V_56 ;
struct V_1 * V_2 ;
int V_68 ;
