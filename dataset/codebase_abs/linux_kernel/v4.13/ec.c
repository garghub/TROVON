...
int V_46 = 0 ;
F_43 ( & V_2 -> V_38 , V_4 ) ;
if ( V_2 -> V_45 && ( V_2 -> V_45 -> V_4 & V_48 ) )
V_46 = 1 ;
F_44 ( & V_2 -> V_38 , V_4 ) ;
return V_46 ;
}
static inline void F_55 ( struct V_1 * V_2 , unsigned long V_32 )
{
V_2 -> V_45 -> V_4 |= V_32 ;
if ( V_2 -> V_45 -> V_19 == V_35 ) {
if ( V_42 == V_43 &&
V_32 == V_47 )
F_37 ( V_2 ) ;
if ( V_42 == V_44 &&
...
{
V_2 -> V_45 -> V_64 = V_2 -> V_45 -> V_57 = V_2 -> V_45 -> V_60 = 0 ;
V_2 -> V_45 -> V_4 = 0 ;
}
...
static void V_115 ( struct V_116 * V_37 )
{
struct V_112 * V_114 = F_98 ( V_37 , struct V_112 , V_37 ) ;
...
static void F_117 ( struct V_116 * V_37 )
{
unsigned long V_4 ;
struct V_1 * V_2 = F_98 ( V_37 , struct V_1 , V_37 ) ;
F_35 ( L_41 ) ;
F_43 ( & V_2 -> V_38 , V_4 ) ;
while ( V_2 -> V_36 ) {
F_44 ( & V_2 -> V_38 , V_4 ) ;
...
{
int V_46 ;
V_46 = F_132 ( V_2 , V_151 ) ;
if ( V_46 )
return V_46 ;
if ( ! V_40 ) {
V_40 = V_2 ;
F_141 ( V_40 -> V_94 , L_50 ) ;
}
F_141 ( V_2 -> V_94 ,
L_51 ,
...
F_120 ( V_2 ) ;
V_2 = V_136 ;
V_46 = F_142 ( V_2 , V_2 -> V_94 , true , false ) ;
} else
V_46 = F_140 ( V_2 , true ) ;
if ( V_46 )
goto V_169;
V_165 -> V_170 = V_2 ;
V_46 = ! ! F_151 ( V_2 -> V_16 , 1 , L_58 ) ;
F_152 ( ! V_46 , L_59 , V_2 -> V_16 ) ;
V_46 = ! ! F_151 ( V_2 -> V_10 , 1 , L_60 ) ;
F_152 ( ! V_46 , L_61 , V_2 -> V_10 ) ;
F_153 ( V_2 -> V_94 ) ;
F_150 ( V_2 -> V_94 , L_62 ) ;
return 0 ;
V_169:
...
V_46 = F_142 ( V_2 , V_2 -> V_94 , false , false ) ;
error:
if ( V_46 )
F_120 ( V_2 ) ;
return V_46 ;
...
static int F_160 ( const struct V_177 * V_163 )
{
F_68 ( L_63 ) ;
V_178 = 1 ;
return 0 ;
}
static int F_161 ( const struct V_177 * V_163 )
{
F_68 ( L_64 ) ;
V_149 = 1 ;
return 0 ;
...
if ( ! V_160 -> V_180 . V_85 || ! V_160 -> V_20 . V_85 ) {
V_46 = - V_81 ;
goto error;
}
if ( V_178 ) {
V_2 -> V_10 = V_160 -> V_20 . V_85 ;
V_2 -> V_16 = V_160 -> V_180 . V_85 ;
} else {
V_2 -> V_10 = V_160 -> V_180 . V_85 ;
V_2 -> V_16 = V_160 -> V_20 . V_85 ;
}
V_2 -> V_23 = V_160 -> V_23 ;
V_46 = F_142 ( V_2 , V_181 , false , true ) ;
error:
if ( V_46 )
F_120 ( V_2 ) ;
return V_46 ;
