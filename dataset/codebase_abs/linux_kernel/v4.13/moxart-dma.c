...
V_133 = F_51 ( V_129 , V_137 , 0 ) ;
V_134 = F_52 ( V_4 , V_133 ) ;
if ( F_53 ( V_134 ) )
return F_54 ( V_134 ) ;
F_55 ( V_84 -> V_86 . V_138 ) ;
F_56 ( V_139 , V_84 -> V_86 . V_138 ) ;
F_56 ( V_140 , V_84 -> V_86 . V_138 ) ;
F_44 ( & V_84 -> V_86 , V_4 ) ;
V_14 = & V_84 -> V_123 [ 0 ] ;
for ( V_65 = 0 ; V_65 < V_124 ; V_65 ++ , V_14 ++ ) {
V_14 -> V_87 = V_65 ;
V_14 -> V_21 = V_134 + V_65 * V_141 ;
V_14 -> V_88 = 0 ;
V_14 -> V_7 . V_142 = F_5 ;
...
{
struct V_83 * V_143 = F_64 ( V_129 ) ;
F_65 ( & V_129 -> V_4 , V_143 -> V_120 , V_143 ) ;
F_62 ( & V_143 -> V_86 ) ;
if ( V_129 -> V_4 . V_131 )
