...
V_14 -> V_5 = V_5 ;
* V_12 = V_13 ;
return F_13 ( V_2 -> V_6 , F_6 , V_14 ) ;
}
static int F_14 ( struct V_18 * V_19 )
{
struct V_10 * V_6 = & V_19 -> V_6 ;
struct V_1 * V_20 ;
int V_21 ;
int V_22 ;
struct V_23 V_24 ;
...
V_26 = & V_29 ;
V_20 = F_16 ( NULL , V_6 , V_26 ) ;
if ( ! V_20 )
return - V_16 ;
F_17 ( V_6 , V_20 ) ;
V_21 = F_18 ( V_6 -> V_28 , 0 , & V_24 ) ;
V_20 -> V_30 = F_19 ( V_6 , & V_24 ) ;
if ( F_20 ( V_20 -> V_30 ) )
return F_21 ( V_20 -> V_30 ) ;
V_22 = F_22 ( V_6 -> V_28 , 0 ) ;
V_21 = F_23 ( V_6 , V_22 , V_31 , 0 , V_32 , V_20 ) ;
if ( V_21 ) {
F_24 ( V_20 -> V_6 ,
L_2 ) ;
return - V_17 ;
