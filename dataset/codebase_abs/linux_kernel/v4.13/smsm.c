...
F_51 ( V_5 -> V_77 [ V_75 ] . V_31 ) ;
F_52 ( V_5 -> V_81 ) ;
return V_55 ;
}
static int F_53 ( struct V_70 * V_71 )
{
struct V_4 * V_5 = F_54 ( V_71 ) ;
unsigned V_75 ;
for ( V_75 = 0 ; V_75 < V_5 -> V_60 ; V_75 ++ )
if ( V_5 -> V_77 [ V_75 ] . V_31 )
F_51 ( V_5 -> V_77 [ V_75 ] . V_31 ) ;
