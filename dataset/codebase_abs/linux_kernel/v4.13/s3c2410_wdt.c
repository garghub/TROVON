...
int V_71 = 0 ;
int V_12 ;
V_10 = F_40 ( V_22 , sizeof( * V_10 ) , V_72 ) ;
if ( ! V_10 )
return - V_73 ;
V_10 -> V_22 = V_22 ;
F_41 ( & V_10 -> V_25 ) ;
V_10 -> V_47 = V_74 ;
V_10 -> V_14 = F_36 ( V_64 ) ;
if ( V_10 -> V_14 -> V_17 & V_75 ) {
V_10 -> V_19 = F_42 ( V_22 -> V_76 ,
L_9 ) ;
if ( F_43 ( V_10 -> V_19 ) ) {
F_7 ( V_22 , L_10 ) ;
...
V_70 = F_45 ( V_64 , V_77 , 0 ) ;
if ( V_70 == NULL ) {
F_7 ( V_22 , L_11 ) ;
V_12 = - V_78 ;
goto V_54;
}
V_69 = F_45 ( V_64 , V_79 , 0 ) ;
V_10 -> V_27 = F_46 ( V_22 , V_69 ) ;
if ( F_43 ( V_10 -> V_27 ) ) {
V_12 = F_44 ( V_10 -> V_27 ) ;
goto V_54;
}
...
V_12 = F_51 ( V_22 , V_70 -> V_85 , F_24 , 0 ,
V_64 -> V_86 , V_64 ) ;
if ( V_12 != 0 ) {
F_7 ( V_22 , L_18 , V_12 ) ;
goto V_87;
...
static int F_60 ( struct V_67 * V_22 )
{
int V_12 ;
struct V_6 * V_10 = F_61 ( V_22 ) ;
V_10 -> V_93 = F_14 ( V_10 -> V_27 + V_30 ) ;
V_10 -> V_94 = F_14 ( V_10 -> V_27 + V_36 ) ;
V_12 = F_5 ( V_10 , true ) ;
if ( V_12 < 0 )
return V_12 ;
F_15 ( & V_10 -> V_47 ) ;
...
static int F_62 ( struct V_67 * V_22 )
{
int V_12 ;
struct V_6 * V_10 = F_61 ( V_22 ) ;
F_11 ( V_10 -> V_94 , V_10 -> V_27 + V_36 ) ;
F_11 ( V_10 -> V_94 , V_10 -> V_27 + V_28 ) ;
F_11 ( V_10 -> V_93 , V_10 -> V_27 + V_30 ) ;
V_12 = F_5 ( V_10 , false ) ;
if ( V_12 < 0 )
return V_12 ;
F_26 ( V_22 , L_26 ,
( V_10 -> V_93 & V_31 ) ? L_24 : L_25 ) ;
return 0 ;
}
