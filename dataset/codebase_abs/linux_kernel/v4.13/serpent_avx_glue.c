...
int V_29 ;
V_29 = F_38 ( V_25 , V_26 , V_27 ) ;
if ( V_29 )
return V_29 ;
V_29 = F_29 ( & V_1 -> V_33 , V_26 , V_27 / 2 ) ;
if ( V_29 )
return V_29 ;
return F_29 ( & V_1 -> V_44 , V_26 + V_27 / 2 , V_27 / 2 ) ;
}
static int F_39 ( struct V_8 * V_9 , struct V_10 * V_2 ,
struct V_10 * V_3 , unsigned int V_11 )
{
struct V_43 * V_1 = F_32 ( V_9 -> V_25 ) ;
return F_40 ( & V_45 , V_9 , V_2 , V_3 , V_11 ,
F_41 ( F_4 ) ,
& V_1 -> V_44 , & V_1 -> V_33 ) ;
}
static int F_42 ( struct V_8 * V_9 , struct V_10 * V_2 ,
struct V_10 * V_3 , unsigned int V_11 )
{
struct V_43 * V_1 = F_32 ( V_9 -> V_25 ) ;
return F_40 ( & V_46 , V_9 , V_2 , V_3 , V_11 ,
F_41 ( F_4 ) ,
& V_1 -> V_44 , & V_1 -> V_33 ) ;
}
