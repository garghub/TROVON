...
V_41 -> V_42 &= ~ V_43 ;
V_41 -> V_44 = 0 ;
V_6 = F_29 ( V_13 -> V_22 , V_41 , V_15 -> V_21 ,
V_15 -> V_23 , V_17 -> V_4 , V_15 -> V_18 ) ;
if ( V_6 )
F_30 ( V_41 ) ;
return V_6 ;
}
int F_31 ( struct V_16 * V_17 , struct V_40 * V_41 )
{
int V_6 ;
V_6 = F_32 ( V_17 , V_17 -> V_4 , V_41 ) ;
if ( V_6 )
return V_6 ;
return F_28 ( V_17 , V_41 ) ;
}
int F_33 ( struct V_45 * V_46 , struct V_40 * V_41 )
{
struct V_16 * V_17 ;
int V_6 ;
V_6 = F_34 ( V_46 , V_41 ) ;
...
struct V_48 * F_35 ( struct V_16 * V_17 )
{
struct V_1 * V_15 = F_15 ( V_17 ) ;
struct V_12 * V_13 = V_17 -> V_3 -> V_14 ;
struct V_48 * V_49 ;
...
if ( ! V_49 )
return F_4 ( - V_9 ) ;
V_6 = F_36 ( V_13 -> V_22 , V_49 , V_15 -> V_21 ,
V_15 -> V_23 , V_17 -> V_4 ,
V_15 -> V_18 ) ;
if ( V_6 ) {
F_6 ( L_6 , V_6 ) ;
...
struct V_16 * F_37 ( struct V_2 * V_3 ,
...
V_55 = F_38 ( V_26 -> V_57 ) ;
F_39 (sg->sgl, s, sg->nents, i) {
if ( F_38 ( V_53 ) != V_55 ) {
F_6 ( L_7 ) ;
V_6 = - V_37 ;
goto V_24;
}
V_55 = F_38 ( V_53 ) + F_40 ( V_53 ) ;
}
V_15 -> V_23 = F_38 ( V_26 -> V_57 ) ;
V_15 -> V_26 = V_26 ;
return & V_15 -> V_10 ;
V_24:
F_7 ( V_15 ) ;
