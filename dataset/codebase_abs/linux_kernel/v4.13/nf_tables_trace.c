...
return;
V_53 = F_33 ( V_63 , V_64 ) ;
V_51 = F_34 ( V_3 , 0 , 0 , V_53 , sizeof( struct V_48 ) , 0 ) ;
if ( ! V_51 )
goto V_65;
V_49 = F_35 ( V_51 ) ;
...
V_49 -> V_69 = V_70 ;
V_49 -> V_71 = 0 ;
if ( F_5 ( V_3 , V_72 , F_17 ( F_36 ( V_31 ) ) ) )
goto V_65;
...
goto V_65;
if ( ! V_39 -> V_88 ) {
if ( F_16 ( V_3 , F_39 ( V_31 ) , F_40 ( V_31 ) ) )
goto V_65;
if ( F_19 ( V_3 , V_31 ) )
goto V_65;
V_39 -> V_88 = true ;
...
F_41 ( V_3 , V_51 ) ;
F_42 ( V_3 , F_28 ( V_31 ) , 0 , V_54 , 0 , V_62 ) ;
return;
V_65:
F_43 ( 1 ) ;
F_44 ( V_3 ) ;
}
void F_45 ( struct V_38 * V_39 , const struct V_30 * V_31 ,
