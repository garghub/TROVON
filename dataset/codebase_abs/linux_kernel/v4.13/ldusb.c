...
F_46 ( & V_2 -> V_31 ) ;
F_46 ( & V_2 -> V_32 ) ;
if ( ( F_47 ( V_81 -> V_86 . V_87 ) == V_88 ) &&
( ( F_47 ( V_81 -> V_86 . V_89 ) == V_90 ) ||
( F_47 ( V_81 -> V_86 . V_89 ) == V_91 ) ) &&
( F_47 ( V_81 -> V_86 . V_92 ) <= 0x103 ) ) {
V_60 = F_48 ( 256 , V_49 ) ;
if ( ! V_60 )
goto error;
...
if ( ! V_2 -> V_7 )
goto error;
V_2 -> V_48 = V_95 > V_2 -> V_46 -> V_96 ? V_95 : V_2 -> V_46 -> V_96 ;
if ( V_2 -> V_72 )
V_2 -> V_77 = V_97 > V_2 -> V_72 -> V_96 ? V_97 : V_2 -> V_72 -> V_96 ;
F_54 ( V_4 , V_2 ) ;
V_16 = F_55 ( V_4 , & V_98 ) ;
if ( V_16 ) {
F_11 ( & V_4 -> V_2 , L_16 ) ;
