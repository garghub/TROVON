...
V_51 -> V_30 = V_29 -> V_60 . V_61 ;
V_51 -> V_57 = V_29 -> V_60 . V_57 ;
}
static int F_45 ( struct V_44 * V_29 , struct V_62 * V_63 )
{
struct V_52 V_14 ;
int V_40 ;
if ( ( V_63 -> V_53 != V_54 ) && ( V_63 -> V_53 != V_55 ) )
return - V_56 ;
if ( ( V_63 -> V_30 == 0 ) || ( V_63 -> V_30 > V_41 ) )
return - V_56 ;
if ( V_63 -> V_30 & ( V_63 -> V_30 - 1 ) )
return - V_56 ;
if ( ( V_63 -> V_64 != V_65 ) && ( V_63 -> V_64 != V_66 ) )
return - V_56 ;
V_14 = V_29 -> V_67 ;
V_29 -> V_67 . V_53 = V_63 -> V_53 ;
V_29 -> V_67 . V_61 = V_63 -> V_30 ;
V_29 -> V_67 . V_68 = V_63 -> V_68 ;
V_29 -> V_67 . V_64 = V_63 -> V_64 ;
V_40 = F_43 ( V_29 ) ;
if ( V_40 < 0 ) {
V_29 -> V_67 = V_14 ;
return V_40 ;
...
static inline void F_46 ( struct V_44 * V_29 , struct V_62 * V_63 )
{
V_63 -> V_53 = V_29 -> V_67 . V_53 ;
V_63 -> V_30 = V_29 -> V_67 . V_61 ;
V_63 -> V_68 = V_29 -> V_67 . V_68 ;
V_63 -> V_64 = V_29 -> V_67 . V_64 ;
}
static T_1 F_47 ( struct V_69 * V_69 , char T_2 * V_17 , T_3 V_26 ,
T_4 * T_5 V_70 )
{
...
if ( V_26 == 0 )
return 0 ;
if ( ! F_48 ( V_26 , sizeof( V_72 ) ) )
return - V_56 ;
if ( V_26 > V_21 )
V_26 = V_21 ;
if ( V_2 -> V_22 >= V_2 -> V_29 -> V_60 . V_61 )
return - V_73 ;
...
static T_1 F_51 ( struct V_69 * V_69 , const char T_2 * V_17 , T_3 V_26 ,
T_4 * T_5 V_70 )
{
struct V_1 * V_2 = V_69 -> V_71 ;
struct V_3 * V_4 ;
T_1 V_40 ;
if ( ( V_26 == 0 ) || ! F_48 ( V_26 , sizeof( V_72 ) ) )
return - V_56 ;
if ( V_26 > V_21 )
V_26 = V_21 ;
if ( V_2 -> V_22 >= V_2 -> V_29 -> V_67 . V_61 )
return - V_73 ;
...
static long F_53 ( struct V_69 * V_69 , unsigned int V_78 , unsigned long V_79 )
{
struct V_1 * V_2 = V_69 -> V_71 ;
unsigned int V_80 ;
struct V_50 V_51 ;
...
break;
case V_82 :
if ( F_52 ( & V_80 , ( void T_2 * ) V_79 , sizeof( V_80 ) ) )
return - V_76 ;
if ( V_80 == V_83 ) {
if ( F_39 ( V_84 , & V_2 -> V_7 ) )
return - V_56 ;
V_40 = F_54 ( V_2 -> V_29 ) ;
} else if ( V_80 == V_85 ) {
if ( ! F_55 ( V_84 , & V_2 -> V_7 ) )
return - V_56 ;
V_40 = F_56 ( V_2 -> V_29 ) ;
} else {
V_40 = - V_56 ;
...
case V_87 :
if ( F_52 ( & V_51 , ( void T_2 * ) V_79 , sizeof( V_51 ) ) )
return - V_76 ;
return F_42 ( V_2 -> V_29 , & V_51 ) ;
case V_88 :
F_44 ( V_2 -> V_29 , & V_51 ) ;
if ( F_50 ( ( void T_2 * ) V_79 , & V_51 , sizeof( V_51 ) ) )
return - V_76 ;
break;
case V_89 :
if ( F_52 ( & V_63 , ( void T_2 * ) V_79 , sizeof( V_63 ) ) )
return - V_76 ;
return F_45 ( V_2 -> V_29 , & V_63 ) ;
case V_90 :
F_46 ( V_2 -> V_29 , & V_63 ) ;
if ( F_50 ( ( void T_2 * ) V_79 , & V_63 , sizeof( V_63 ) ) )
return - V_76 ;
break;
default:
return - V_91 ;
...
static int F_60 ( struct V_93 * V_93 , struct V_69 * V_69 )
{
struct V_27 * V_28 ;
struct V_1 * V_2 ;
int V_40 = 0 ;
F_61 ( L_1 , F_62 ( V_93 ) ) ;
V_28 = F_63 ( V_93 -> V_94 , struct V_27 , V_95 ) ;
F_64 ( & V_28 -> V_8 ) ;
V_2 = V_28 -> V_30 + ( F_62 ( V_93 ) & V_96 ) ;
if ( F_39 ( V_97 , & V_2 -> V_7 ) ) {
V_40 = - V_45 ;
goto V_10;
}
if ( V_28 -> V_92 == 0 ) {
...
static int F_67 ( struct V_93 * V_93 V_70 , struct V_69 * V_69 )
{
struct V_1 * V_2 = V_69 -> V_71 ;
...
{
const char V_100 [] = L_2 ;
struct V_27 * V_28 ;
struct V_1 * V_2 ;
struct V_44 * V_29 = F_73 ( V_99 ) ;
unsigned int V_101 ;
T_6 V_102 ;
int V_40 ;
int V_19 ;
...
V_101 = F_76 ( F_77 ( V_29 ) , F_78 ( V_29 ) ) ;
if ( ! V_103 ) {
V_40 = F_79 ( & V_102 , V_101 ,
V_41 , V_100 ) ;
if ( V_40 == 0 )
V_103 = F_80 ( V_102 ) ;
} else {
V_102 = F_81 ( V_103 , V_101 ) ;
V_40 = F_82 ( V_102 , V_41 , V_100 ) ;
}
if ( V_40 < 0 ) {
F_75 ( V_99 , L_4 ,
V_103 ? L_5 : L_6 , V_40 ) ;
...
F_83 ( & V_28 -> V_8 ) ;
F_84 ( V_29 , V_28 ) ;
F_85 ( & V_28 -> V_95 , & V_105 ) ;
V_28 -> V_95 . V_106 = V_107 ;
V_28 -> V_29 = V_29 ;
...
V_40 = F_86 ( & V_28 -> V_95 , V_102 , V_41 ) ;
if ( V_40 ) {
F_75 ( V_99 , L_7 , V_40 ) ;
goto V_108;
}
...
static int F_88 ( struct V_98 * V_99 )
{
struct V_44 * V_29 = F_73 ( V_99 ) ;
struct V_27 * V_28 = F_27 ( V_29 ) ;
T_6 V_102 = V_28 -> V_95 . V_99 ;
F_89 ( & V_28 -> V_95 ) ;
F_87 ( V_102 , V_41 ) ;
F_84 ( V_29 , NULL ) ;
F_10 ( V_28 ) ;
