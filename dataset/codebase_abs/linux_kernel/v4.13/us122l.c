...
struct V_41 * V_41 = F_2 ( V_2 ) ;
int V_26 = V_41 -> V_142 ;
if ( V_26 >= 0 && V_26 < V_143 )
V_144 [ V_26 ] = 0 ;
}
static int F_55 ( struct V_17 * V_145 ,
struct V_19 * V_146 ,
struct V_1 * * V_147 ,
unsigned long V_148 )
{
...
struct V_1 * V_2 ;
int V_29 ;
for ( V_18 = 0 ; V_18 < V_143 ; ++ V_18 )
if ( V_149 [ V_18 ] && ! V_144 [ V_18 ] )
break;
if ( V_18 >= V_143 )
return - V_150 ;
V_29 = F_56 ( & V_146 -> V_18 , V_26 [ V_18 ] , V_151 [ V_18 ] , V_152 ,
sizeof( struct V_41 ) , & V_2 ) ;
if ( V_29 < 0 )
return V_29 ;
V_144 [ F_2 ( V_2 ) -> V_142 = V_18 ] = 1 ;
V_2 -> V_153 = F_54 ;
F_2 ( V_2 ) -> V_18 = V_145 ;
F_57 ( & F_2 ( V_2 ) -> V_52 ) ;
F_58 ( & F_2 ( V_2 ) -> V_53 . V_89 ) ;
F_2 ( V_2 ) -> V_68 = V_148 & V_154 ;
F_59 ( & F_2 ( V_2 ) -> V_21 ) ;
strcpy ( V_2 -> V_155 , L_13 V_13 L_14 ) ;
sprintf ( V_2 -> V_156 , L_15 V_13 L_14 ) ;
sprintf ( V_2 -> V_157 , L_16 ,
V_2 -> V_156 ,
F_60 ( V_145 -> V_158 . V_159 ) ,
F_60 ( V_145 -> V_158 . V_160 ) ,
0 ,
...
static int F_61 ( struct V_19 * V_146 ,
const struct V_161 * V_162 ,
struct V_1 * * V_147 )
{
struct V_17 * V_145 = F_62 ( V_146 ) ;
struct V_1 * V_2 ;
int V_29 ;
V_29 = F_55 ( V_145 , V_146 , & V_2 , V_162 -> V_163 ) ;
if ( V_29 < 0 )
return V_29 ;
if ( ! F_51 ( V_2 ) ) {
F_63 ( V_2 ) ;
...
static int F_67 ( struct V_19 * V_146 ,
const struct V_161 * V_151 )
{
struct V_17 * V_145 = F_62 ( V_146 ) ;
struct V_1 * V_2 ;
int V_29 ;
if ( V_151 -> V_163 & V_154 &&
V_145 -> V_112 == V_113 ) {
F_29 ( V_107 L_17 ) ;
return - V_150 ;
}
F_12 ( V_38 L_18 ,
V_146 , V_146 -> V_164 -> V_165 . V_166 ) ;
if ( V_146 -> V_164 -> V_165 . V_166 != 1 )
return 0 ;
V_29 = F_61 ( F_65 ( V_146 ) , V_151 , & V_2 ) ;
if ( V_29 < 0 ) {
F_68 ( V_146 ) ;
return V_29 ;
}
...
static void F_70 ( struct V_19 * V_146 )
{
struct V_1 * V_2 ;
struct V_41 * V_41 ;
struct V_99 * V_100 ;
...
static int F_75 ( struct V_19 * V_146 , T_5 V_167 )
{
struct V_1 * V_2 ;
struct V_41 * V_41 ;
struct V_99 * V_100 ;
...
static int F_77 ( struct V_19 * V_146 )
{
struct V_1 * V_2 ;
struct V_41 * V_41 ;
struct V_99 * V_100 ;
