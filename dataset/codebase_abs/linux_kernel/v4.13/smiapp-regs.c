...
static int F_13 ( struct V_6 * V_7 , T_5 V_8 , T_5 * V_10 ,
bool V_36 )
{
int V_30 ;
* V_10 = 0 ;
V_30 = F_14 ( V_7 , V_37 , false , & V_8 , V_10 ) ;
if ( V_30 == - V_38 )
return 0 ;
if ( V_30 < 0 )
return V_30 ;
...
{
return F_13 ( V_7 , V_8 , V_10 , false ) ;
}
int F_16 ( struct V_6 * V_7 , T_5 V_8 , T_5 * V_10 )
{
return F_13 ( V_7 , V_8 , V_10 , true ) ;
}
int F_17 ( struct V_6 * V_7 , T_5 V_8 , T_5 V_10 )
{
struct V_1 * V_2 = F_4 ( & V_7 -> V_11 -> V_12 ) ;
struct V_13 V_14 ;
...
int F_20 ( struct V_6 * V_7 , T_5 V_8 , T_5 V_10 )
{
int V_30 ;
V_30 = F_14 ( V_7 , V_37 , true , & V_8 , & V_10 ) ;
if ( V_30 == - V_38 )
return 0 ;
if ( V_30 < 0 )
return V_30 ;
return F_17 ( V_7 , V_8 , V_10 ) ;
}
