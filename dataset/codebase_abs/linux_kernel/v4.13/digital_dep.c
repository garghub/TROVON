...
F_12 ( V_6 -> V_24 , V_26 -> V_9 , V_26 -> V_10 ) ;
F_10 ( V_26 ) ;
V_26 = NULL ;
if ( F_15 ( V_22 ) ) {
V_27 = F_14 ( V_6 , V_19 ) ;
...
if ( ! V_8 )
return - V_25 ;
F_29 ( V_8 , sizeof( * V_54 ) ) ;
V_54 = (struct V_53 * ) V_8 -> V_9 ;
V_54 -> V_36 = V_55 ;
V_54 -> V_38 = V_56 ;
V_54 -> V_57 = 0 ;
V_54 -> V_58 = ( 0x2 << 3 ) | 0x2 ;
V_3 = F_30 ( V_6 -> V_28 , V_6 -> V_21 ) ;
V_1 = F_3 ( V_3 ) ;
V_54 -> V_59 = F_31 ( V_1 ) ;
V_6 -> V_28 = V_3 ;
V_6 -> V_21 = V_3 ;
F_4 ( V_6 , V_8 ) ;
V_6 -> V_44 ( V_8 ) ;
V_27 = F_32 ( V_6 , V_8 , V_6 -> V_60 ,
F_20 , V_32 ) ;
if ( V_27 )
F_10 ( V_8 ) ;
return V_27 ;
}
static void F_33 ( struct V_5 * V_6 , void * V_30 ,
struct V_7 * V_26 )
{
struct V_31 * V_32 = V_30 ;
struct V_61 * V_62 ;
...
V_27 = F_36 ( V_6 -> V_47 , V_62 -> V_70 , V_63 ) ;
if ( V_27 )
goto exit;
if ( ( V_6 -> V_71 & V_72 ) &&
( V_6 -> V_11 != V_41 ) ) {
...
return - V_69 ;
F_47 ( V_6 -> V_92 ) ;
V_27 = F_32 ( V_6 , V_6 -> V_92 , V_6 -> V_60 ,
V_93 , V_19 ) ;
if ( V_27 )
F_10 ( V_6 -> V_92 ) ;
return V_27 ;
...
V_96 = F_55 ( V_26 -> V_9 [ 0 ] ) ;
if ( ! V_96 || V_96 > V_109 ) {
F_23 ( L_9 ) ;
V_27 = - V_15 ;
goto error;
}
V_27 = F_44 ( V_6 , V_19 , V_96 ) ;
if ( V_27 )
goto error;
goto V_108;
}
...
F_4 ( V_6 , V_112 ) ;
V_6 -> V_44 ( V_112 ) ;
V_6 -> V_92 = F_41 ( V_112 , V_29 ) ;
V_27 = F_32 ( V_6 , V_112 , V_6 -> V_60 ,
V_93 , V_19 ) ;
if ( V_27 ) {
if ( V_112 != V_8 )
F_10 ( V_112 ) ;
...
static void F_57 ( struct V_5 * V_6 , T_1 V_113 )
{
V_6 -> V_11 = V_113 ;
V_6 -> V_44 = V_114 ;
V_6 -> V_35 = V_115 ;
...
if ( V_6 -> V_57 ) {
V_99 -> V_22 |= V_119 ;
F_12 ( V_8 , & V_6 -> V_57 , sizeof( V_6 -> V_57 ) ) ;
}
V_6 -> V_51 =
F_51 ( V_6 -> V_51 + 1 ) ;
F_4 ( V_6 , V_8 ) ;
...
int F_64 ( struct V_5 * V_6 , struct V_7 * V_8 )
{
struct V_16 * V_99 ;
struct V_7 * V_24 , * V_112 ;
int V_27 ;
...
V_6 -> V_44 ( V_112 ) ;
V_6 -> V_92 = F_41 ( V_112 , V_29 ) ;
V_27 = F_60 ( V_6 , V_112 , 1500 , V_120 ,
NULL ) ;
if ( V_27 ) {
if ( V_112 != V_8 )
F_10 ( V_112 ) ;
...
F_57 ( V_6 , V_113 ) ;
F_67 ( V_6 , V_40 , V_113 ) ;
F_68 ( V_6 , 1500 , V_120 , NULL ) ;
F_27 ( V_26 ) ;
}
static int F_69 ( struct V_5 * V_6 , T_1 V_57 ,
T_1 V_113 )
{
struct V_33 * V_34 ;
struct V_7 * V_8 ;
...
V_6 -> V_44 ( V_8 ) ;
V_6 -> V_51 = 0 ;
V_27 = F_60 ( V_6 , V_8 , 0 , F_66 ,
( void * ) ( unsigned long ) V_113 ) ;
if ( V_27 )
F_10 ( V_8 ) ;
return V_27 ;
}
static void F_70 ( struct V_5 * V_6 , void * V_30 ,
struct V_7 * V_26 )
{
int V_27 ;
struct V_53 * V_54 ;
...
T_3 V_63 ;
int V_27 ;
V_70 = F_76 ( V_6 -> V_47 , & V_63 ) ;
if ( ! V_70 )
V_63 = 0 ;
V_8 = F_9 ( V_6 , sizeof( struct V_61 ) + V_63 ) ;
if ( ! V_8 )
return - V_25 ;
F_29 ( V_8 , sizeof( struct V_61 ) ) ;
...
V_6 -> V_44 ( V_8 ) ;
V_6 -> V_51 = 0 ;
V_27 = F_60 ( V_6 , V_8 , 999 ,
F_73 , NULL ) ;
if ( V_27 )
F_10 ( V_8 ) ;
return V_27 ;
}
void F_77 ( struct V_5 * V_6 , void * V_30 ,
struct V_7 * V_26 )
{
int V_27 ;
struct V_74 * V_75 ;
