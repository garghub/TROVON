...
V_34 -> V_222 . V_294 = & V_6 -> V_114 ;
V_34 -> V_222 . V_295 = & V_34 -> V_147 ;
...
if ( V_6 -> V_105 . V_160 != V_84 ) {
V_6 -> V_302 = F_123 ( V_303 ,
V_6 , L_40 ) ;
if ( F_124 ( V_6 -> V_302 ) ) {
V_146 = F_125 ( V_6 -> V_302 ) ;
F_103 ( L_41 ,
V_146 ) ;
}
}
...
static int F_136 ( struct V_223 * V_223 , T_4 V_305 )
{
struct V_33 * V_34 = F_131 ( V_223 ) ;
struct V_5 * V_6 = V_34 -> V_6 ;
unsigned long V_100 ;
