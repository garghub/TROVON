...
int V_143 = 0 ;
F_13 ( & V_2 -> V_19 ) ;
for ( V_15 = V_129 -> V_135 ; V_15 < V_2 -> V_84 ; V_15 ++ ) {
V_28 = & V_2 -> V_28 [ V_15 ] ;
if ( ! ( V_28 -> V_29 [ 0 ] & V_137 ) )
continue;
V_129 -> V_135 = V_15 ;
V_129 -> V_136 = V_15 ;
V_129 -> V_133 = 0 ;
if ( V_28 -> V_29 [ 2 ] & F_49 ( V_7 ) ) {
if ( V_28 -> V_29 [ 1 ] & F_49 ( V_7 ) )
V_129 -> V_133 |= V_134 ;
F_27 ( V_2 , V_7 , V_140 , & V_6 ) ;
if ( V_15 == ( V_6 & 0xFFFFF ) )
V_129 -> V_133 |= V_139 ;
V_143 = V_142 ( & V_129 -> V_144 ) ;
if ( V_143 )
break;
}
}
...
static void F_53 ( struct V_13 * V_14 , int V_7 ,
const struct V_145 * V_146 ,
struct V_130 * V_131 )
{
struct V_1 * V_2 = V_14 -> V_17 ;
...
T_1 V_6 ;
F_13 ( & V_2 -> V_148 ) ;
V_6 = V_146 -> V_15 << V_149 ;
V_6 |= ( ( V_146 -> V_3 [ 0 ] << 8 ) | V_146 -> V_3 [ 1 ] ) ;
F_6 ( V_2 , V_150 , V_6 ) ;
V_6 = ( ( V_146 -> V_3 [ 2 ] << 24 ) | ( V_146 -> V_3 [ 3 ] << 16 ) ) ;
V_6 |= ( ( V_146 -> V_3 [ 4 ] << 8 ) | V_146 -> V_3 [ 5 ] ) ;
F_6 ( V_2 , V_151 , V_6 ) ;
F_6 ( V_2 , V_34 , V_152 | V_153 ) ;
if ( F_20 ( V_2 , V_153 , 1000 ) < 0 ) {
F_15 ( V_2 -> V_2 , L_8 ) ;
goto exit;
}
F_18 ( V_14 , V_147 ) ;
...
if ( V_146 -> V_15 )
V_147 [ 1 ] |= V_155 ;
V_147 [ 2 ] = ( V_146 -> V_15 << V_156 ) ;
V_147 [ 2 ] |= ( ( V_146 -> V_3 [ 0 ] << 8 ) | V_146 -> V_3 [ 1 ] ) ;
V_147 [ 3 ] = ( ( V_146 -> V_3 [ 2 ] << 24 ) | ( V_146 -> V_3 [ 3 ] << 16 ) ) ;
V_147 [ 3 ] |= ( ( V_146 -> V_3 [ 4 ] << 8 ) | V_146 -> V_3 [ 5 ] ) ;
F_19 ( V_14 , V_147 ) ;
F_6 ( V_2 , V_34 , V_157 | V_153 ) ;
if ( F_20 ( V_2 , V_153 , 1000 ) < 0 )
F_15 ( V_2 -> V_2 , L_8 ) ;
exit:
F_16 ( & V_2 -> V_148 ) ;
...
F_6 ( V_2 , V_151 , V_6 ) ;
F_6 ( V_2 , V_34 , V_152 | V_153 ) ;
V_18 = F_20 ( V_2 , V_153 , 1000 ) ;
if ( V_18 < 0 ) {
F_15 ( V_2 -> V_2 , L_8 ) ;
goto exit;
}
F_5 ( V_2 , V_30 , & V_147 [ 0 ] ) ;
if ( V_147 [ 0 ] & V_154 ) {
F_5 ( V_2 , V_31 , & V_147 [ 1 ] ) ;
F_5 ( V_2 , V_32 , & V_147 [ 2 ] ) ;
F_5 ( V_2 , V_33 , & V_147 [ 3 ] ) ;
V_147 [ 2 ] &= ~ F_49 ( V_7 ) ;
if ( ( V_147 [ 2 ] & V_158 ) == 0 ) {
V_147 [ 0 ] = 0 ;
V_147 [ 1 ] = 0 ;
...
static void F_55 ( struct V_159 * V_160 , T_1 * V_147 )
{
V_160 -> V_161 = ! ! ( V_147 [ 0 ] & V_154 ) ;
V_160 -> V_162 = ! ! ( V_147 [ 0 ] & V_163 ) ;
V_160 -> V_164 = ! ! ( V_147 [ 0 ] & V_165 ) ;
V_160 -> V_166 = ( V_147 [ 0 ] >> V_167 ) &
V_168 ;
V_160 -> V_169 = V_147 [ 0 ] & V_170 ;
V_160 -> V_171 = ! ! ( V_147 [ 1 ] & V_172 ) ;
V_160 -> V_173 = ! ! ( V_147 [ 1 ] & V_155 ) ;
V_160 -> V_174 = V_147 [ 1 ] & V_158 ;
V_160 -> V_175 = ( V_147 [ 2 ] >> V_156 ) & V_176 ;
V_160 -> V_177 [ 0 ] = ( V_147 [ 2 ] >> 8 ) & 0xFF ;
V_160 -> V_177 [ 1 ] = V_147 [ 2 ] & 0xFF ;
V_160 -> V_177 [ 2 ] = ( V_147 [ 3 ] >> 24 ) & 0xFF ;
V_160 -> V_177 [ 3 ] = ( V_147 [ 3 ] >> 16 ) & 0xFF ;
V_160 -> V_177 [ 4 ] = ( V_147 [ 3 ] >> 8 ) & 0xFF ;
V_160 -> V_177 [ 5 ] = V_147 [ 3 ] & 0xFF ;
}
static int F_56 ( struct V_13 * V_14 , int V_7 ,
struct V_145 * V_146 ,
T_6 * V_142 )
{
struct V_1 * V_2 = V_14 -> V_17 ;
...
int V_10 ;
F_13 ( & V_2 -> V_148 ) ;
F_6 ( V_2 , V_34 , V_153 | V_178 ) ;
do {
V_10 = 1000 ;
do {
F_5 ( V_2 , V_34 , & V_6 ) ;
if ( ( V_6 & V_179 ) || ! ( V_6 & V_153 ) )
break;
F_11 ( 1 , 10 ) ;
} while ( V_10 -- > 0 );
if ( ! V_10 ) {
...
F_18 ( V_14 , V_147 ) ;
F_55 ( & V_160 , V_147 ) ;
if ( V_160 . V_174 & F_49 ( V_7 ) ) {
V_146 -> V_15 = V_160 . V_175 ;
if ( V_160 . V_161 )
V_146 -> V_180 = V_181 ;
else
V_146 -> V_180 = V_182 ;
F_57 ( V_146 -> V_3 , V_160 . V_177 ) ;
V_18 = V_142 ( & V_146 -> V_144 ) ;
if ( V_18 )
goto exit;
}
} while ( V_6 & V_153 );
...
int V_105 ;
T_1 V_186 , V_187 ;
V_186 = ( ( V_184 -> V_3 [ 0 ] << 8 ) | V_184 -> V_3 [ 1 ] ) ;
V_187 = ( ( V_184 -> V_3 [ 2 ] << 24 ) | ( V_184 -> V_3 [ 3 ] << 16 ) ) ;
V_187 |= ( ( V_184 -> V_3 [ 4 ] << 8 ) | V_184 -> V_3 [ 5 ] ) ;
F_13 ( & V_2 -> V_148 ) ;
for ( V_105 = 0 ; V_105 < V_2 -> V_188 ; V_105 ++ ) {
V_6 = ( V_105 << V_189 ) |
V_190 | V_191 ;
F_6 ( V_2 , V_35 , V_6 ) ;
if ( F_21 ( V_2 , V_191 , 1000 ) < 0 ) {
F_15 ( V_2 -> V_2 , L_11 ) ;
goto exit;
}
F_18 ( V_14 , V_185 ) ;
if ( V_185 [ 0 ] & V_154 ) {
if ( ( ( V_185 [ 2 ] >> V_156 ) == ( V_184 -> V_15 ) ) &&
( ( V_185 [ 2 ] & V_192 ) == V_186 ) &&
( V_185 [ 3 ] == V_187 ) ) {
break;
}
...
if ( V_184 -> V_15 )
V_185 [ 1 ] |= V_155 ;
V_185 [ 2 ] = ( V_184 -> V_15 << V_156 ) ;
V_185 [ 2 ] |= V_186 ;
V_185 [ 3 ] = V_187 ;
F_19 ( V_14 , V_185 ) ;
V_6 = ( V_105 << V_189 ) | V_191 ;
F_6 ( V_2 , V_35 , V_6 ) ;
if ( F_21 ( V_2 , V_191 , 1000 ) < 0 )
F_15 ( V_2 -> V_2 , L_11 ) ;
exit:
...
static int F_60 ( struct V_13 * V_14 , int V_7 ,
const struct V_183 * V_184 )
{
struct V_1 * V_2 = V_14 -> V_17 ;
T_1 V_185 [ 4 ] ;
...
static int F_61 ( struct V_13 * V_14 , int V_7 ,
struct V_183 * V_184 ,
T_6 * V_142 )
{
return 0 ;
}
static int F_62 ( struct V_13 * V_14 , int V_7 ,
struct V_194 * V_195 ,
bool V_196 )
{
struct V_1 * V_2 = V_14 -> V_17 ;
if ( V_196 )
F_7 ( V_2 , V_7 , V_197 , V_198 , true ) ;
else
F_7 ( V_2 , V_7 , V_197 , V_199 , true ) ;
F_7 ( V_2 , V_7 , V_197 , V_200 , false ) ;
F_7 ( V_2 , V_195 -> V_201 , V_197 ,
V_200 , true ) ;
F_1 ( V_2 , V_202 , V_203 , false ) ;
return 0 ;
}
static void F_63 ( struct V_13 * V_14 , int V_7 ,
struct V_194 * V_195 )
{
struct V_1 * V_2 = V_14 -> V_17 ;
T_2 V_6 ;
if ( V_195 -> V_196 )
F_7 ( V_2 , V_7 , V_197 , V_198 , false ) ;
else
F_7 ( V_2 , V_7 , V_197 , V_199 , false ) ;
F_25 ( V_2 , V_7 , V_197 , & V_6 ) ;
if ( ! ( V_6 & ( V_198 | V_199 ) ) )
F_7 ( V_2 , V_195 -> V_201 , V_197 ,
V_200 , false ) ;
}
...
for ( V_80 = 0 ; V_80 < F_66 ( V_207 ) ; V_80 ++ ) {
const struct V_208 * V_209 = & V_207 [ V_80 ] ;
if ( V_2 -> V_210 == V_209 -> V_210 ) {
V_2 -> V_211 = V_209 -> V_212 ;
V_2 -> V_84 = V_209 -> V_84 ;
V_2 -> V_213 = V_209 -> V_213 ;
V_2 -> V_188 = V_209 -> V_188 ;
V_2 -> V_82 = V_209 -> V_82 ;
V_2 -> V_83 = V_209 -> V_83 ;
break;
}
...
struct V_1 * F_67 ( struct V_215 * V_216 ,
const struct V_217 * V_205 ,
void * V_17 )
{
struct V_13 * V_14 ;
struct V_1 * V_218 ;
V_14 = F_68 ( V_216 , V_219 ) ;
if ( ! V_14 )
return NULL ;
V_218 = F_69 ( V_216 , sizeof( * V_218 ) , V_85 ) ;
if ( ! V_218 )
return NULL ;
V_14 -> V_17 = V_218 ;
V_218 -> V_2 = V_216 ;
