...
if ( F_145 ( V_108 ) )
return F_146 ( V_108 ) ;
V_31 = F_61 ( sizeof( struct V_30 ) , V_85 ) ;
if ( ! V_31 ) {
F_9 ( & V_33 -> V_34 , L_57 ) ;
return - V_86 ;
}
...
F_149 ( & V_31 -> V_96 ) ;
F_149 ( & V_31 -> V_93 ) ;
error = F_150 ( V_33 -> V_180 , NULL , F_46 ,
V_108 -> V_443 | V_444 ,
V_33 -> V_273 , V_31 ) ;
if ( error ) {
F_9 ( & V_33 -> V_34 , L_114 ) ;
...
if ( error )
goto V_445;
error = F_151 ( & V_33 -> V_34 . V_446 , & V_447 ) ;
if ( error ) {
F_9 ( & V_33 -> V_34 , L_115 ,
error ) ;
goto V_448;
...
F_66 ( V_31 ) ;
V_445:
F_152 ( V_33 -> V_180 , V_31 ) ;
V_294:
F_22 ( V_31 ) ;
return error ;
}
static int F_153 ( struct V_82 * V_33 )
{
struct V_30 * V_31 = F_154 ( V_33 ) ;
F_155 ( & V_33 -> V_34 . V_446 , & V_447 ) ;
F_152 ( V_31 -> V_180 , V_31 ) ;
F_64 ( V_31 ) ;
F_66 ( V_31 ) ;
F_22 ( V_31 ) ;
return 0 ;
}
static int T_8 F_156 ( struct V_39 * V_34 )
{
struct V_82 * V_33 = F_157 ( V_34 ) ;
struct V_30 * V_31 = F_154 ( V_33 ) ;
struct V_105 * V_105 = V_31 -> V_105 ;
if ( ! V_105 )
return 0 ;
...
static int T_8 F_160 ( struct V_39 * V_34 )
{
struct V_82 * V_33 = F_157 ( V_34 ) ;
struct V_30 * V_31 = F_154 ( V_33 ) ;
struct V_105 * V_105 = V_31 -> V_105 ;
