...
static int F_69 ( struct V_222 * V_132 )
{
struct V_129 * V_133 = V_132 -> V_133 ;
int V_144 = 0 ;
int V_135 ;
...
static int F_72 ( struct V_236 * V_149 ,
