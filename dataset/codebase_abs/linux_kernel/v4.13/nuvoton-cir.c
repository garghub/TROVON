...
static int F_58 ( struct V_30 * V_5 , unsigned * V_157 , unsigned V_158 )
{
struct V_2 * V_3 = V_5 -> V_35 ;
unsigned long V_36 ;
unsigned int V_37 ;
...
int V_60 ;
F_23 ( & V_3 -> V_38 , V_36 ) ;
V_60 = F_29 ( ( unsigned ) ( V_159 / sizeof( unsigned ) ) , V_158 ) ;
V_3 -> V_160 . V_161 = ( V_60 * sizeof( unsigned ) ) ;
memcpy ( V_3 -> V_160 . V_46 , V_157 , V_3 -> V_160 . V_161 ) ;
V_3 -> V_160 . V_162 = 0 ;
V_129 = F_17 ( V_3 , V_70 ) ;
F_16 ( V_3 , V_163 | V_164 , V_70 ) ;
V_3 -> V_160 . V_165 = V_166 ;
F_16 ( V_3 , V_167 |
V_125 , V_76 ) ;
for ( V_37 = 0 ; V_37 < 9 ; V_37 ++ )
F_16 ( V_3 , 0x01 , V_80 ) ;
F_26 ( & V_3 -> V_38 , V_36 ) ;
F_59 ( V_3 -> V_160 . V_168 , V_3 -> V_160 . V_165 == V_169 ) ;
F_23 ( & V_3 -> V_38 , V_36 ) ;
V_3 -> V_160 . V_165 = V_170 ;
F_26 ( & V_3 -> V_38 , V_36 ) ;
F_16 ( V_3 , V_129 , V_70 ) ;
return V_60 ;
}
...
{
int V_37 ;
F_61 ( V_171 L_56 , V_172 , V_3 -> V_173 ) ;
for ( V_37 = 0 ; ( V_37 < V_3 -> V_173 ) && ( V_37 < V_174 ) ; V_37 ++ )
F_61 ( V_175 L_57 , V_3 -> V_46 [ V_37 ] ) ;
F_61 ( V_175 L_4 ) ;
}
...
F_60 ( V_3 ) ;
F_64 ( L_59 , V_3 -> V_173 ) ;
for ( V_37 = 0 ; V_37 < V_3 -> V_173 ; V_37 ++ ) {
V_177 = V_3 -> V_46 [ V_37 ] ;
V_176 . V_156 = ( ( V_177 & V_65 ) != 0 ) ;
V_176 . V_48 = F_65 ( ( V_177 & V_54 )
* V_55 ) ;
F_45 ( L_60 ,
V_176 . V_156 ? L_61 : L_62 , V_176 . V_48 ) ;
F_66 ( V_3 -> V_4 , & V_176 ) ;
}
V_3 -> V_173 = 0 ;
F_45 ( L_63 ) ;
...
V_179 = F_17 ( V_3 , V_71 ) ;
F_45 ( L_66 , V_179 ) ;
for ( V_37 = 0 ; V_37 < V_179 ; V_37 ++ )
V_3 -> V_46 [ V_37 ] = F_17 ( V_3 , V_78 ) ;
V_3 -> V_173 = V_179 ;
F_45 ( L_67 , V_172 , V_3 -> V_173 ) ;
F_62 ( V_3 ) ;
}
static void F_71 ( T_1 V_180 , T_1 V_129 )
{
F_45 ( L_68 ,
V_180 , V_129 ,
V_180 & V_181 ? L_69 : L_70 ,
V_180 & V_182 ? L_71 : L_70 ,
V_180 & V_183 ? L_72 : L_70 ,
V_180 & V_184 ? L_73 : L_70 ,
V_180 & V_185 ? L_74 : L_70 ,
V_180 & V_186 ? L_75 : L_70 ,
V_180 & V_187 ? L_76 : L_70 ,
V_180 & V_188 ? L_77 : L_70 ,
V_180 & ~ ( V_181 | V_182 | V_183 |
V_184 | V_185 | V_186 |
V_187 | V_188 ) ? L_78 : L_70 ) ;
}
static bool F_72 ( struct V_2 * V_3 )
{
return V_3 -> V_160 . V_165 == V_170 ;
}
static T_6 F_73 ( int V_189 , void * V_153 )
{
...
F_48 ( V_3 ) ;
if ( V_180 & V_186 ) {
unsigned int V_192 , V_32 ;
T_1 V_13 ;
V_192 = V_3 -> V_160 . V_162 ;
V_32 = V_3 -> V_160 . V_161 ;
if ( V_192 < V_32 ) {
F_16 ( V_3 , V_3 -> V_160 . V_46 [ V_192 ] , V_80 ) ;
V_3 -> V_160 . V_162 ++ ;
} else {
V_13 = F_17 ( V_3 , V_70 ) ;
F_16 ( V_3 , V_13 & ~ V_164 , V_70 ) ;
}
}
if ( V_180 & V_187 ) {
if ( V_3 -> V_160 . V_165 == V_166 ) {
V_3 -> V_160 . V_165 = V_169 ;
F_76 ( & V_3 -> V_160 . V_168 ) ;
}
}
F_75 ( & V_3 -> V_38 ) ;
F_64 ( L_64 , V_172 ) ;
...
static int F_78 ( struct V_30 * V_5 )
{
struct V_2 * V_3 = V_5 -> V_35 ;
unsigned long V_36 ;
F_23 ( & V_3 -> V_38 , V_36 ) ;
...
static void F_79 ( struct V_30 * V_5 )
{
struct V_2 * V_3 = V_5 -> V_35 ;
F_77 ( V_3 ) ;
}
static int F_80 ( struct V_193 * V_194 , const struct V_195 * V_196 )
{
struct V_2 * V_3 ;
struct V_30 * V_4 ;
int V_60 ;
V_3 = F_81 ( & V_194 -> V_5 , sizeof( struct V_2 ) , V_61 ) ;
if ( ! V_3 )
return - V_62 ;
V_3 -> V_4 = F_82 ( & V_194 -> V_5 , V_197 ) ;
if ( ! V_3 -> V_4 )
return - V_62 ;
V_4 = V_3 -> V_4 ;
V_60 = F_83 ( V_194 ) ;
...
V_3 -> V_24 = F_87 ( V_194 , 0 ) ;
V_3 -> V_119 = F_88 ( V_194 , 0 ) ;
V_3 -> V_25 = F_87 ( V_194 , 1 ) ;
V_3 -> V_11 = V_199 ;
V_3 -> V_12 = V_200 ;
F_89 ( & V_3 -> V_38 ) ;
F_90 ( V_194 , V_3 ) ;
F_91 ( & V_3 -> V_160 . V_168 ) ;
V_60 = F_40 ( V_3 ) ;
if ( V_60 )
return V_60 ;
F_9 ( V_3 ) ;
...
V_4 -> V_211 = L_85 ;
V_4 -> V_212 = L_86 ;
V_4 -> V_213 . V_214 = V_215 ;
V_4 -> V_213 . V_216 = V_217 ;
V_4 -> V_213 . V_218 = V_3 -> V_100 ;
V_4 -> V_213 . V_219 = V_3 -> V_104 ;
V_4 -> V_220 = V_14 ;
V_4 -> V_221 = V_222 ;
V_4 -> V_223 = F_92 ( 100 ) ;
V_4 -> V_224 = F_65 ( V_225 ) ;
#if 0
rdev->min_timeout = XYZ;
rdev->max_timeout = XYZ;
rdev->tx_resolution = XYZ;
#endif
V_60 = F_93 ( & V_194 -> V_5 , V_4 ) ;
if ( V_60 )
return V_60 ;
if ( ! F_94 ( & V_194 -> V_5 , V_3 -> V_24 ,
V_198 , V_14 ) )
return - V_15 ;
V_60 = F_95 ( & V_194 -> V_5 , V_3 -> V_119 , F_73 ,
V_226 , V_14 , V_3 ) ;
if ( V_60 )
return V_60 ;
if ( ! F_94 ( & V_194 -> V_5 , V_3 -> V_25 ,
V_198 , V_14 L_87 ) )
return - V_15 ;
V_60 = F_96 ( & V_4 -> V_5 , & V_227 ) ;
if ( V_60 )
return V_60 ;
F_97 ( & V_194 -> V_5 , true ) ;
F_98 ( & V_194 -> V_5 , L_88 ) ;
...
static void F_99 ( struct V_193 * V_194 )
{
struct V_2 * V_3 = F_100 ( V_194 ) ;
F_101 ( & V_3 -> V_4 -> V_5 , & V_227 ) ;
F_77 ( V_3 ) ;
F_52 ( V_3 ) ;
}
static int F_102 ( struct V_193 * V_194 , T_7 V_228 )
{
struct V_2 * V_3 = F_100 ( V_194 ) ;
unsigned long V_36 ;
F_45 ( L_89 , V_172 ) ;
...
static int F_103 ( struct V_193 * V_194 )
{
struct V_2 * V_3 = F_100 ( V_194 ) ;
F_45 ( L_89 , V_172 ) ;
F_50 ( V_3 ) ;
...
static void F_104 ( struct V_193 * V_194 )
{
struct V_2 * V_3 = F_100 ( V_194 ) ;
F_52 ( V_3 ) ;
}
