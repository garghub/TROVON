...
{
T_1 V_36 = V_35 << 4 ;
T_1 V_37 = F_15 ( V_10 , 0x700000 + V_36 ) ;
T_1 V_38 = F_15 ( V_10 , 0x700004 + V_36 ) ;
T_1 V_39 = F_15 ( V_10 , 0x700008 + V_36 ) ;
T_1 V_40 = ( V_39 & 0xfffff000 ) | ( V_37 >> 20 ) ;
T_1 V_41 = V_38 + 1 ;
if ( ! ( V_37 & 0x00002000 ) )
return false ;
if ( V_34 == 0x0190 ) {
F_16 ( V_10 , 0x00b300 , 0x00010000 ,
( V_37 & 0x00030000 ) ? 0x00010000 : 0 ) ;
F_13 ( V_10 , 0x00b334 , V_40 ) ;
F_13 ( V_10 , 0x00b324 , V_41 ) ;
} else
if ( V_34 == 0x01a0 ) {
F_16 ( V_10 , 0x00b300 , 0x00020000 ,
( V_37 & 0x00030000 ) ? 0x00020000 : 0 ) ;
F_13 ( V_10 , 0x00b360 , V_40 ) ;
F_13 ( V_10 , 0x00b364 , V_41 ) ;
} else {
if ( V_37 & 0x00030000 )
return false ;
F_13 ( V_10 , 0x00b370 , V_40 ) ;
F_13 ( V_10 , 0x00b374 , V_41 ) ;
}
return true ;
}
static bool
F_17 ( struct V_14 * V_15 , T_1 V_34 , T_1 V_35 )
{
struct V_30 * V_10 = V_15 -> V_8 . V_9 . V_10 ;
switch ( V_34 ) {
case 0x190 :
case 0x1a0 :
case 0x1b0 :
return V_15 -> V_42 -> V_43 ( V_10 , V_34 , V_35 ) ;
default:
break;
}
return false ;
...
static void
F_18 ( struct V_26 * V_8 )
{
struct V_14 * V_15 = V_14 ( V_8 ) ;
struct V_44 * V_9 = & V_15 -> V_8 . V_9 ;
...
F_16 ( V_10 , 0x00b308 , 0x00000000 , 0x00000000 ) ;
V_46 &= ~ 0x01000000 ;
}
if ( type == 0x00000010 ) {
if ( F_17 ( V_15 , V_34 , V_35 ) )
V_46 &= ~ 0x01000000 ;
}
}
...
F_16 ( V_10 , 0x00b32c , 0x00000001 , 0x00000001 ) ;
...
int
F_23 ( const struct V_50 * V_42 , struct V_30 * V_10 ,
