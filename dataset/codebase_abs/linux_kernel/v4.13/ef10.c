...
struct V_933 * V_930 ;
unsigned int V_118 ;
V_763 -> V_934 = ! ! ( V_34 -> V_259 & V_935 ) ;
F_32 ( V_763 -> V_936 [ 0 ] . V_337 , V_34 -> V_937 ) ;
V_118 = 1 ;
F_336 (uc, net_dev) {
if ( V_118 >= V_938 ) {
V_763 -> V_934 = true ;
...
F_32 ( V_763 -> V_936 [ V_118 ] . V_337 , V_930 -> V_337 ) ;
V_118 ++ ;
}
V_763 -> V_929 = V_118 ;
}
static void F_337 ( struct V_6 * V_7 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
struct V_915 * V_34 = V_7 -> V_34 ;
struct V_933 * V_932 ;
unsigned int V_118 ;
V_763 -> V_939 = false ;
V_763 -> V_940 = ! ! ( V_34 -> V_259 & ( V_935 | V_941 ) ) ;
V_118 = 0 ;
F_338 (mc, net_dev) {
if ( V_118 >= V_942 ) {
V_763 -> V_940 = true ;
...
F_32 ( V_763 -> V_943 [ V_118 ] . V_337 , V_932 -> V_337 ) ;
V_118 ++ ;
}
V_763 -> V_931 = V_118 ;
}
...
V_948 = F_303 ( V_7 ) ? V_821 : 0 ;
for ( V_118 = 0 ; V_118 < V_952 ; V_118 ++ ) {
F_312 ( V_953 [ V_118 ] != V_2 ) ;
F_340 ( & V_753 , V_864 , V_948 , 0 ) ;
F_341 ( & V_753 , V_102 -> V_101 , V_946 [ V_118 ] . V_337 ) ;
...
static int F_343 ( struct V_6 * V_7 ,
struct V_903 * V_102 ,
enum V_767 V_768 ,
bool V_312 , bool V_944 )
{
...
static void F_348 ( struct V_6 * V_7 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
int V_976 = 0 ;
int V_977 = 0 ;
...
V_7 -> V_34 -> V_937 ) ;
if ( ! V_23 ) {
F_32 ( V_21 -> V_980 , V_7 -> V_34 -> V_937 ) ;
} else {
...
static void F_356 ( struct V_6 * V_7 ,
struct V_903 * V_102 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
struct V_20 * V_21 = V_7 -> V_21 ;
...
return;
if ( V_763 -> V_934 ) {
F_343 ( V_7 , V_102 , V_961 ,
false , false ) ;
F_339 ( V_7 , V_102 , false , false ) ;
} else {
if ( F_339 ( V_7 , V_102 , false , false ) )
F_343 ( V_7 , V_102 ,
V_961 ,
false , false ) ;
}
F_343 ( V_7 , V_102 , V_780 ,
false , false ) ;
F_343 ( V_7 , V_102 , V_780 |
V_775 ,
false , false ) ;
F_343 ( V_7 , V_102 , V_788 ,
false , false ) ;
F_343 ( V_7 , V_102 , V_788 |
V_775 ,
false , false ) ;
F_343 ( V_7 , V_102 , V_782 ,
false , false ) ;
F_343 ( V_7 , V_102 , V_782 |
V_775 ,
false , false ) ;
if ( V_21 -> V_642 &&
V_763 -> V_921 != V_763 -> V_940 )
F_348 ( V_7 ) ;
if ( V_763 -> V_940 ) {
if ( V_21 -> V_642 ) {
if ( F_343 ( V_7 , V_102 ,
...
static void F_357 ( struct V_6 * V_7 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
struct V_915 * V_34 = V_7 -> V_34 ;
struct V_903 * V_102 ;
...
static struct V_903 * F_361 ( struct V_6 * V_7 , T_2 V_101 )
{
struct V_762 * V_763 = V_7 -> V_112 ;
struct V_903 * V_102 ;
F_36 ( ! F_329 ( & V_7 -> V_114 ) ) ;
...
static int F_362 ( struct V_6 * V_7 )
{
F_12 ( V_81 , V_984 ) ;
struct V_20 * V_21 = V_7 -> V_21 ;
...
static int F_367 ( struct V_6 * V_7 , T_1 V_990 )
{
F_12 ( V_81 , V_991 ) ;
...
V_23 = F_367 ( V_7 , V_990 ) ;
if ( V_23 != 0 )
return V_23 ;
return F_368 ( V_7 ) ;
}
static int
F_370 ( struct V_6 * V_7 , struct V_1001 * V_1002 )
{
int V_23 , V_979 ;
F_371 ( V_7 , V_269 ) ;
...
if ( V_23 != 0 )
goto V_360;
V_1002 -> V_1004 = F_369 ( V_7 , V_1005 ) ? - 1 : 1 ;
V_1002 -> V_1006 = F_369 ( V_7 , V_1007 ) ? - 1 : 1 ;
V_23 = F_68 ( V_7 , V_269 ) ;
V_360:
if ( V_23 == - V_73 )
V_23 = 0 ;
V_979 = F_372 ( V_7 , V_269 , V_23 == 0 ) ;
return V_23 ? V_23 : V_979 ;
}
static int F_373 ( struct V_6 * V_7 ,
...
if ( V_1013 -> V_1018 != F_374 ( V_7 ) )
return - V_48 ;
V_23 = F_375 ( V_7 , type , & V_881 , & V_1014 , & V_1015 ) ;
if ( V_23 )
return V_23 ;
if ( V_1015 )
return - V_48 ;
...
F_322 ( V_22 , V_1042 ) )
return - V_12 ;
V_1035 = F_378 ( V_1036 , sizeof( * V_1035 ) , V_108 ) ;
if ( ! V_1035 )
return - V_107 ;
V_1037 = 0 ;
...
V_118 ) ;
V_23 = F_373 ( V_7 , & V_1035 [ V_1037 ] , type ) ;
if ( V_23 == 0 )
V_1037 ++ ;
else if ( V_23 != - V_48 )
goto V_178;
}
V_23 = F_379 ( V_7 , & V_1035 [ 0 ] . V_1027 , V_1037 , sizeof( * V_1035 ) ) ;
V_178:
if ( V_23 )
F_54 ( V_1035 ) ;
return V_23 ;
}
static void F_380 ( struct V_6 * V_7 , T_1 V_1043 )
{
F_64 ( V_7 , F_65 ( V_1043 ) , V_392 ) ;
}
static void F_381 ( struct V_6 * V_7 ,
T_1 V_1043 ) {}
static int F_382 ( struct V_166 * V_167 ,
bool V_1044 )
{
F_12 ( V_81 , V_1045 ) ;
int V_23 ;
...
static int F_383 ( struct V_166 * V_167 ,
bool V_1044 )
{
F_12 ( V_81 , V_1056 ) ;
int V_23 ;
...
static int F_384 ( struct V_6 * V_7 , bool V_1061 ,
bool V_1044 )
{
int (* F_385)( struct V_166 * V_167 , bool V_1044 );
struct V_166 * V_167 ;
F_385 = V_1061 ?
F_382 :
F_383 ;
F_89 (channel, efx) {
int V_23 = F_385 ( V_167 , V_1044 ) ;
if ( V_1061 && V_23 != 0 ) {
F_384 ( V_7 , false , V_1044 ) ;
return V_23 ;
}
}
return 0 ;
...
static int F_387 ( struct V_6 * V_7 ,
struct V_1062 * V_1063 )
{
int V_23 ;
switch ( V_1063 -> V_1064 ) {
case V_1065 :
F_384 ( V_7 , false , false ) ;
return F_388 ( V_7 ,
...
V_23 = F_388 ( V_7 , true , 0 ) ;
if ( ! V_23 )
V_23 = F_384 ( V_7 , true , false ) ;
if ( V_23 )
F_388 ( V_7 , false , 0 ) ;
return V_23 ;
default:
...
return - V_383 ;
V_1083 -> V_1084 = V_950 ;
memcpy ( V_1083 -> V_440 , V_21 -> V_147 , V_1083 -> V_1084 ) ;
return 0 ;
}
static int F_391 ( struct V_6 * V_7 , T_17 V_1085 , T_2 V_101 )
{
if ( V_1085 != F_275 ( V_1086 ) )
return - V_270 ;
return F_44 ( V_7 , V_101 ) ;
}
static int F_392 ( struct V_6 * V_7 , T_17 V_1085 , T_2 V_101 )
{
if ( V_1085 != F_275 ( V_1086 ) )
return - V_270 ;
return F_57 ( V_7 , V_101 ) ;
}
static int F_81 ( struct V_6 * V_7 , bool V_1087 )
{
struct V_20 * V_21 = V_7 -> V_21 ;
F_12 ( V_81 , V_1088 ) ;
F_12 ( V_18 , V_1089 ) ;
...
static struct V_1108 * F_398 ( struct V_6 * V_7 ,
T_17 V_1018 )
{
struct V_20 * V_21 = V_7 -> V_21 ;
T_4 V_118 ;
...
( 1 << V_691 ) ) )
return 0 ;
F_400 ( V_1109 . type , V_1111 , sizeof( V_1111 ) ) ;
F_24 ( V_7 , V_33 , V_7 -> V_34 , L_104 ,
V_1111 , F_178 ( V_1109 . V_1018 ) ) ;
F_45 ( & V_21 -> V_130 ) ;
F_351 ( V_7 ) ;
V_1110 = F_398 ( V_7 , V_1109 . V_1018 ) ;
if ( V_1110 != NULL ) {
if ( V_1110 -> type == V_1109 . type ) {
F_24 ( V_7 , V_33 , V_7 -> V_34 ,
L_105 ) ;
V_1110 -> V_880 ++ ;
V_23 = 0 ;
...
F_400 ( V_1110 -> type ,
V_1111 , sizeof( V_1111 ) ) ;
F_24 ( V_7 , V_33 , V_7 -> V_34 ,
L_106 ,
F_178 ( V_1109 . V_1018 ) , V_1111 ) ;
V_23 = - V_866 ;
goto V_1112;
}
for ( V_118 = 0 ; V_118 < F_209 ( V_21 -> V_151 ) ; ++ V_118 )
if ( ! V_21 -> V_151 [ V_118 ] . V_880 ) {
V_21 -> V_151 [ V_118 ] = V_1109 ;
...
static bool F_401 ( struct V_6 * V_7 , T_17 V_1018 )
{
struct V_20 * V_21 = V_7 -> V_21 ;
if ( ! ( V_21 -> V_35 &
( 1 << V_691 ) ) )
