...
char * V_8 )
{
struct V_77 * V_76 = F_70 ( V_7 ) ;
struct V_78 * V_79 = F_71 ( V_75 ) ;
if ( ! V_76 -> V_80 )
return - V_81 ;
return V_76 -> V_80 ( V_79 , V_76 , V_8 ) ;
}
...
if ( ! V_76 -> V_82 )
return - V_81 ;
return V_76 -> V_82 ( V_79 , V_76 , V_8 , V_50 ) ;
}
static T_1 F_73 ( struct V_78 * V_79 ,
struct V_77 * V_76 , char * V_8 )
{
struct V_83 * V_84 ;
T_3 V_85 ;
int V_86 , V_13 ;
...
static T_1 F_128 ( struct V_126 * V_79 ,
struct V_125 * V_76 ,
char * V_8 )
{
unsigned long V_127 ;
...
int F_184 ( struct V_189 * V_190 ,
const void * V_111 )
{
return F_185 ( & V_178 , V_190 , V_111 ) ;
}
void F_186 ( struct V_189 * V_190 ,
const void * V_111 )
{
