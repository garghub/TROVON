...
if ( ( V_48 + V_38 ) > V_49 )
continue;
if ( F_12 ( V_49 - V_38 , V_39 ) < V_48 )
continue;
V_48 = F_12 ( V_49 - V_38 , V_39 ) ;
if ( V_48 == 0x0 )
continue;
if ( V_48 > V_43 )
V_43 = V_48 ;
...
void F_14 ( T_2 * V_3 , unsigned long V_38 ,
unsigned long V_40 )
{
unsigned long V_42 ;
if ( ! V_38 )
...
static T_4 F_15 ( T_2 * V_3 , void * V_56 ,
T_3 * V_57 , void * * V_58 ,
T_7 * V_59 )
{
T_8 * V_60 , * V_61 = V_56 ;
...
T_10 V_63 = V_64 ;
unsigned long V_65 ;
V_16 = F_16 ( V_66 , V_67 , V_61 , & V_60 , V_57 ,
V_68 , ( T_7 ) 0 ) ;
if ( V_16 != V_22 ) {
F_3 ( V_3 , L_1 ) ;
F_4 ( V_3 , V_57 ) ;
...
static T_4 F_17 ( void * V_58 , unsigned long * V_38 , void * V_40 )
{
return F_16 ( V_66 , V_72 , V_58 , V_38 , V_40 ) ;
}
static T_4 F_18 ( void * V_58 )
{
return F_16 ( V_66 , V_73 , V_58 ) ;
}
T_4 F_19 ( char const * V_74 )
{
char * V_4 ;
V_4 = strstr ( V_74 , L_6 ) ;
...
while ( V_38 ) {
unsigned long V_95 ;
if ( F_23 ( V_96 ) && V_38 > V_75 )
V_95 = V_75 ;
else
V_95 = V_38 ;
V_16 = F_17 ( V_82 [ V_86 ] . V_58 ,
& V_95 ,
( void * ) V_40 ) ;
if ( V_16 != V_22 ) {
F_21 ( V_3 , L_13 ) ;
...
static int F_25 ( T_13 V_105 )
{
return 1 + ( V_105 >= 0x80 ) + ( V_105 >= 0x800 ) ;
}
static V_91 * F_26 ( V_91 * V_106 , const T_13 * V_107 , int V_108 )
{
unsigned int V_105 ;
while ( V_108 -- ) {
V_105 = * V_107 ++ ;
