...
struct V_72 * V_73 ;
struct V_43 * V_44 ;
V_73 = F_76 ( V_114 , struct V_72 , V_115 ) ;
V_44 = V_73 -> V_107 ;
F_67 ( V_73 ) ;
F_31 ( V_44 ) ;
}
static void F_77 ( struct V_72 * V_73 )
{
F_78 ( & V_73 -> V_115 , F_75 ) ;
F_79 ( & V_73 -> V_115 ) ;
}
void
...
if ( ! V_73 )
return;
F_81 ( & V_73 -> V_107 -> V_51 -> V_62 ) ;
F_3 ( L_21 , V_5 , V_73 ,
F_70 ( & V_73 -> V_106 ) ,
F_40 ( V_83 , & V_73 -> V_75 ) ) ;
if ( F_9 ( & V_73 -> V_106 ) ) {
struct V_43 * V_44 = V_73 -> V_107 ;
if ( F_40 ( V_83 , & V_73 -> V_75 ) )
return;
F_68 ( V_44 , V_73 ) ;
if ( ! F_71 ( V_44 , V_73 ) ) {
...
static bool
F_82 ( const struct V_86 * V_116 ,
const struct V_86 * V_117 )
{
T_4 V_118 = V_116 -> V_88 ;
T_4 V_119 = F_83 ( V_118 , V_116 -> V_89 ) ;
T_4 V_120 = V_117 -> V_88 ;
T_4 V_121 = F_83 ( V_120 , V_117 -> V_89 ) ;
...
static bool
F_86 ( const struct V_86 * V_127 ,
const struct V_86 * V_128 )
{
...
static bool
F_88 ( const struct V_72 * V_73 ,
const struct V_86 * V_128 ,
T_1 V_66 )
{
if ( V_66 != 0 && F_85 ( V_73 -> V_108 , V_66 ) )
return false ;
if ( V_128 == NULL )
return true ;
return F_86 ( & V_73 -> V_76 , V_128 ) ;
}
int
...
int V_132 = 0 ;
while ( ! F_26 ( V_131 ) ) {
V_44 = F_98 ( V_131 -> V_91 , struct V_43 ,
V_133 ) ;
F_3 ( L_27 , V_5 ,
V_44 -> V_51 -> V_136 ) ;
V_46 = V_44 -> V_51 ;
...
if ( V_153 -> args . V_156 > V_87 -> V_89 )
V_153 -> args . V_156 = V_87 -> V_89 ;
if ( V_87 -> V_65 == V_158 ) {
if ( V_87 -> V_88 >= V_154 )
V_153 -> args . V_156 = 0 ;
else if ( V_154 - V_87 -> V_88 < V_153 -> args . V_156 )
V_153 -> args . V_156 = V_154 - V_87 -> V_88 ;
}
V_153 -> args . V_159 = V_160 ;
F_113 ( & V_153 -> args . V_87 , V_87 ) ;
V_153 -> args . type = V_20 -> V_10 -> V_2 ;
V_153 -> args . V_46 = V_47 ;
V_153 -> args . V_150 = F_114 ( V_150 ) ;
F_106 ( & V_153 -> args . V_103 , V_103 ) ;
V_153 -> V_48 = V_48 ;
...
F_59 ( V_44 , & V_165 , V_87 , V_66 ) ;
F_51 ( V_44 , & V_165 , V_87 , V_66 ) ;
F_105 ( V_44 , V_103 , true ) ;
} else
F_49 ( V_44 , & V_165 ) ;
V_166:
F_41 ( V_44 ) ;
...
if ( V_103 != NULL ) {
F_106 ( V_103 , & V_44 -> V_146 ) ;
if ( V_44 -> V_71 != 0 )
V_103 -> V_109 = F_120 ( V_44 -> V_71 ) ;
}
if ( V_65 != NULL )
* V_65 = V_44 -> V_67 ;
F_38 ( V_44 ) ;
...
args -> V_87 . V_89 = V_90 ;
args -> V_59 = V_44 ;
F_106 ( & args -> V_103 , V_103 ) ;
}
static int
F_122 ( struct V_43 * V_44 , const T_3 * V_103 ,
...
F_121 ( & V_171 -> args , V_44 , V_103 , V_65 ) ;
...
enum V_64 V_65 ;
bool V_176 ;
V_176 = F_119 ( V_44 , & V_103 , & V_65 ) ;
F_7 ( & V_46 -> V_62 ) ;
if ( V_176 ) {
F_122 ( V_44 , & V_103 , V_65 , false ) ;
}
} else
F_7 ( & V_46 -> V_62 ) ;
}
...
F_24 ( V_47 ) -> V_10 -> V_179 ( V_44 , & V_87 ) ;
}
if ( ! F_40 ( V_69 , & V_44 -> V_70 ) ) {
F_7 ( & V_47 -> V_62 ) ;
F_3 ( L_32 , V_5 ) ;
...
V_176 = F_119 ( V_44 , & V_103 , NULL ) ;
F_7 ( & V_47 -> V_62 ) ;
if ( V_176 )
V_35 = F_122 ( V_44 , & V_103 , V_68 , true ) ;
V_178:
F_60 ( & V_122 ) ;
F_31 ( V_44 ) ;
V_4:
...
F_50 (lseg, next, &lo->plh_segs, pls_list) {
if ( V_188 && V_73 -> V_76 . V_65 == V_158 )
continue;
if ( ! F_47 ( V_82 , & V_73 -> V_75 ) )
continue;
F_36 ( V_74 , & V_73 -> V_75 ) ;
if ( ! F_84 ( V_73 , & V_44 -> V_112 ) )
continue;
F_35 ( V_44 , V_73 -> V_76 . V_65 , 0 ) ;
}
if ( ! F_40 ( V_69 , & V_44 -> V_70 ) )
goto V_190;
V_186 = F_119 ( V_44 , & V_103 , & V_65 ) ;
if ( ! V_186 || V_161 != V_44 -> V_55 )
goto V_190;
V_187 = V_186 ;
F_121 ( args , V_44 , & V_103 , V_65 ) ;
V_182 -> V_193 = 0 ;
V_186 = false ;
V_190:
F_7 ( & V_47 -> V_62 ) ;
...
F_136 ( & F_24 ( V_47 ) -> V_79 , V_198 , NULL ) ;
V_199 = true ;
}
F_7 ( & V_47 -> V_62 ) ;
return V_199 ;
...
static T_6
F_137 ( const struct V_86 * V_116 ,
const struct V_86 * V_117 )
{
T_6 V_200 ;
V_200 = V_116 -> V_88 - V_117 -> V_88 ;
if ( V_200 )
return V_200 ;
V_200 = V_117 -> V_89 - V_116 -> V_89 ;
if ( V_200 )
return V_200 ;
return ( int ) ( V_116 -> V_65 == V_158 ) - ( int ) ( V_117 -> V_65 == V_158 ) ;
}
static bool
F_138 ( const struct V_86 * V_116 ,
const struct V_86 * V_117 )
{
return F_137 ( V_116 , V_117 ) > 0 ;
}
static bool
F_139 ( struct V_72 * V_73 ,
struct V_72 * V_201 )
{
return false ;
}
...
struct V_72 * V_73 ,
bool (* F_141)( const struct V_86 * ,
const struct V_86 * ) ,
bool (* F_142)( struct V_72 * ,
struct V_72 * ) ,
struct V_80 * V_81 )
{
struct V_72 * V_202 , * V_37 ;
F_3 ( L_33 , V_5 ) ;
F_50 (lp, tmp, &lo->plh_segs, pls_list) {
if ( F_40 ( V_83 , & V_202 -> V_75 ) == 0 )
continue;
if ( F_142 ( V_73 , V_202 ) ) {
F_84 ( V_202 , V_81 ) ;
continue;
}
if ( F_141 ( & V_73 -> V_76 , & V_202 -> V_76 ) )
continue;
F_143 ( & V_73 -> V_104 , & V_202 -> V_104 ) ;
F_3 ( L_34
L_35
L_36 ,
V_5 , V_73 , V_73 -> V_76 . V_65 ,
V_73 -> V_76 . V_88 , V_73 -> V_76 . V_89 ,
V_202 , V_202 -> V_76 . V_65 , V_202 -> V_76 . V_88 ,
V_202 -> V_76 . V_89 ) ;
goto V_4;
}
F_143 ( & V_73 -> V_104 , & V_44 -> V_63 ) ;
F_3 ( L_34
L_37 ,
V_5 , V_73 , V_73 -> V_76 . V_65 ,
V_73 -> V_76 . V_88 , V_73 -> V_76 . V_89 ) ;
...
bool V_205 )
{
struct V_72 * V_73 , * V_132 = NULL ;
F_3 ( L_33 , V_5 ) ;
F_2 (lseg, &lo->plh_segs, pls_list) {
if ( F_40 ( V_83 , & V_73 -> V_75 ) &&
! F_40 ( V_74 , & V_73 -> V_75 ) &&
F_148 ( & V_73 -> V_76 , V_87 ,
V_205 ) ) {
V_132 = F_150 ( V_73 ) ;
break;
}
...
F_3 ( L_39 ,
V_5 , V_132 , V_132 ? F_70 ( & V_132 -> V_106 ) : 0 ) ;
return V_132 ;
}
...
{
F_99 ( V_44 -> V_51 , false ) ;
return ! F_153 ( & V_44 -> V_70 , V_77 ,
V_224 ,
V_177 ) ;
}
...
T_3 V_103 ;
long V_151 = 0 ;
unsigned long V_231 = V_98 + ( V_53 -> V_232 << 1 ) ;
bool V_233 ;
if ( ! F_156 ( F_24 ( V_47 ) ) ) {
F_157 ( V_47 , V_227 , V_228 , V_65 , V_44 , V_73 ,
V_234 ) ;
goto V_4;
}
...
V_230 = V_229 . V_88 & ~ V_248 ;
if ( V_230 ) {
V_229 . V_88 -= V_230 ;
V_229 . V_89 += V_230 ;
}
if ( V_229 . V_89 != V_90 )
V_229 . V_89 = F_162 ( V_229 . V_89 ) ;
V_73 = F_109 ( V_44 , V_150 , & V_103 , & V_229 , & V_151 , V_48 ) ;
F_157 ( V_47 , V_227 , V_228 , V_65 , V_44 , V_73 ,
V_249 ) ;
F_56 ( & V_44 -> V_110 ) ;
if ( F_163 ( V_73 ) ) {
...
if ( ! F_169 ( & V_182 -> V_87 ) )
return F_111 ( - V_36 ) ;
V_73 = F_24 ( V_47 ) -> V_10 -> V_38 ( V_44 , V_182 , V_153 -> V_48 ) ;
if ( F_168 ( V_73 ) ) {
if ( ! V_73 )
V_73 = F_111 ( - V_155 ) ;
F_3 ( L_54 ,
...
F_63 ( V_44 , V_73 , & V_182 -> V_87 , & V_182 -> V_103 ) ;
F_5 ( & V_47 -> V_62 ) ;
if ( F_108 ( V_44 ) ) {
F_3 ( L_55 , V_5 ) ;
goto V_255;
...
if ( ! F_72 ( V_44 ) ) {
F_105 ( V_44 , & V_182 -> V_103 , true ) ;
} else if ( F_118 ( & V_44 -> V_146 , & V_182 -> V_103 ) ) {
if ( F_107 ( V_44 , & V_182 -> V_103 ) ) {
F_3 ( L_56 , V_5 ) ;
goto V_255;
}
F_105 ( V_44 , & V_182 -> V_103 , false ) ;
} else {
F_49 ( V_44 , & V_81 ) ;
goto V_255;
}
F_150 ( V_73 ) ;
F_144 ( V_44 , V_73 , & V_81 ) ;
if ( V_182 -> V_256 )
F_36 ( V_82 , & V_73 -> V_75 ) ;
F_7 ( & V_47 -> V_62 ) ;
F_60 ( & V_81 ) ;
...
if ( ! F_171 ( V_44 , & V_44 -> V_112 , & V_87 , 0 ) ) {
T_3 V_103 ;
enum V_64 V_65 ;
V_257 = F_119 ( V_44 , & V_103 , & V_65 ) ;
F_7 ( & V_46 -> V_62 ) ;
if ( V_257 )
F_122 ( V_44 , & V_103 , V_65 , false ) ;
} else {
...
void
F_173 ( struct V_258 * V_259 )
{
if ( V_259 -> V_260 == NULL ||
F_40 ( V_83 , & V_259 -> V_260 -> V_75 ) )
return;
F_74 ( V_259 -> V_260 ) ;
V_259 -> V_260 = NULL ;
}
static void
F_174 ( struct V_258 * V_259 , struct V_261 * V_262 )
{
if ( V_259 -> V_260 && ! F_175 ( V_259 -> V_260 , V_262 ) ) {
F_74 ( V_259 -> V_260 ) ;
V_259 -> V_260 = NULL ;
}
}
void
F_176 ( struct V_258 * V_259 , struct V_261 * V_262 )
{
...
if ( V_259 -> V_260 == NULL ) {
if ( V_259 -> V_265 == NULL )
V_263 = F_112 ( V_259 -> V_266 ) - F_177 ( V_262 ) ;
else
V_263 = F_178 ( V_259 -> V_265 ) ;
V_259 -> V_260 = F_155 ( V_259 -> V_266 ,
V_262 -> V_267 ,
F_177 ( V_262 ) ,
V_263 ,
V_158 ,
false ,
V_268 ) ;
if ( F_163 ( V_259 -> V_260 ) ) {
V_259 -> V_269 = F_164 ( V_259 -> V_260 ) ;
V_259 -> V_260 = NULL ;
return;
}
}
...
T_7
F_183 ( struct V_258 * V_259 ,
struct V_261 * V_272 , struct V_261 * V_262 )
{
unsigned int V_211 ;
T_4 V_273 , V_274 , V_275 ;
V_211 = F_184 ( V_259 , V_272 , V_262 ) ;
if ( ! V_211 )
return 0 ;
if ( V_259 -> V_260 ) {
V_273 = F_83 ( V_259 -> V_260 -> V_76 . V_88 ,
V_259 -> V_260 -> V_76 . V_89 ) ;
V_274 = F_177 ( V_262 ) ;
if ( V_274 >= V_273 )
return 0 ;
V_275 = V_273 - V_274 ;
...
int F_185 ( struct V_276 * V_277 )
{
struct V_258 V_259 ;
F_186 ( & V_259 , V_277 -> V_46 , V_278 , true ,
V_277 -> V_279 ) ;
F_36 ( V_280 , & V_277 -> args . V_281 -> V_163 ) ;
return F_187 ( & V_259 , V_277 ) ;
}
static void F_188 ( struct V_276 * V_277 )
{
F_3 ( L_58 , V_277 -> V_282 ) ;
if ( F_24 ( V_277 -> V_46 ) -> V_10 -> V_163 &
V_283 ) {
F_189 ( V_277 -> V_46 ) ;
}
if ( ! F_52 ( V_284 , & V_277 -> V_163 ) )
V_277 -> V_198 . V_285 = F_185 ( V_277 ) ;
}
void F_190 ( struct V_276 * V_277 )
{
if ( F_191 ( ! V_277 -> V_282 ) ) {
F_192 ( V_277 -> V_46 , V_277 -> V_73 ,
V_277 -> V_286 + V_277 -> V_182 . V_228 ) ;
V_277 -> V_287 -> V_288 ( & V_277 -> V_198 , V_277 ) ;
}
F_193 ( V_277 , V_277 -> V_282 ) ;
if ( F_123 ( V_277 -> V_282 ) )
F_188 ( V_277 ) ;
V_277 -> V_287 -> V_289 ( V_277 ) ;
}
static void
F_194 ( struct V_258 * V_271 ,
struct V_276 * V_277 )
{
struct V_290 * V_291 = F_195 ( V_271 ) ;
if ( ! F_52 ( V_284 , & V_277 -> V_163 ) ) {
F_196 ( & V_277 -> V_292 , & V_291 -> V_293 ) ;
F_181 ( V_271 ) ;
V_291 -> V_294 = 1 ;
}
F_197 ( V_277 ) ;
...
static enum V_296
F_198 ( struct V_276 * V_277 ,
const struct V_297 * V_298 ,
struct V_72 * V_73 ,
int V_299 )
{
struct V_46 * V_46 = V_277 -> V_46 ;
enum V_296 V_300 ;
struct V_8 * V_9 = F_24 ( V_46 ) ;
V_277 -> V_287 = V_298 ;
F_3 ( L_59 , V_5 ,
V_46 -> V_136 , V_277 -> args . V_228 , V_277 -> args . V_88 , V_299 ) ;
V_300 = V_9 -> V_10 -> V_301 ( V_277 , V_299 ) ;
if ( V_300 != V_302 )
F_199 ( V_46 , V_303 ) ;
F_3 ( L_60 , V_5 , V_300 ) ;
return V_300 ;
...
struct V_276 * V_277 , int V_299 )
{
const struct V_297 * V_298 = V_271 -> V_304 ;
struct V_72 * V_73 = V_271 -> V_260 ;
enum V_296 V_300 ;
V_300 = F_198 ( V_277 , V_298 , V_73 , V_299 ) ;
switch ( V_300 ) {
case V_302 :
F_194 ( V_271 , V_277 ) ;
case V_305 :
...
if ( ! F_52 ( V_284 , & V_277 -> V_163 ) ) {
struct V_290 * V_291 = F_195 ( V_271 ) ;
F_201 ( & V_277 -> V_292 , & V_291 -> V_293 ) ;
V_291 -> V_294 = 1 ;
}
V_277 -> V_287 -> V_289 ( V_277 ) ;
}
}
static void F_202 ( struct V_276 * V_277 )
{
F_74 ( V_277 -> V_73 ) ;
F_203 ( V_277 ) ;
}
int
F_204 ( struct V_258 * V_271 )
{
struct V_276 * V_277 ;
int V_132 ;
V_277 = F_205 ( V_271 -> V_307 ) ;
if ( ! V_277 ) {
V_271 -> V_269 = - V_155 ;
return V_271 -> V_269 ;
}
F_206 ( V_271 , V_277 , F_202 ) ;
V_277 -> V_73 = F_150 ( V_271 -> V_260 ) ;
V_132 = F_207 ( V_271 , V_277 ) ;
if ( ! V_132 )
F_200 ( V_271 , V_277 , V_271 -> V_308 ) ;
return V_132 ;
}
int F_208 ( struct V_276 * V_277 )
{
struct V_258 V_259 ;
F_209 ( & V_259 , V_277 -> V_46 , true , V_277 -> V_279 ) ;
return F_187 ( & V_259 , V_277 ) ;
}
static void F_210 ( struct V_276 * V_277 )
{
F_3 ( L_61 , V_277 -> V_282 ) ;
if ( F_24 ( V_277 -> V_46 ) -> V_10 -> V_163 &
V_283 ) {
F_189 ( V_277 -> V_46 ) ;
}
if ( ! F_52 ( V_284 , & V_277 -> V_163 ) )
V_277 -> V_198 . V_285 = F_208 ( V_277 ) ;
}
void F_211 ( struct V_276 * V_277 )
{
if ( F_191 ( ! V_277 -> V_282 ) )
V_277 -> V_287 -> V_288 ( & V_277 -> V_198 , V_277 ) ;
F_212 ( V_277 , V_277 -> V_282 ) ;
if ( F_123 ( V_277 -> V_282 ) )
F_210 ( V_277 ) ;
V_277 -> V_287 -> V_289 ( V_277 ) ;
}
static void
F_213 ( struct V_258 * V_271 ,
struct V_276 * V_277 )
{
struct V_290 * V_291 = F_195 ( V_271 ) ;
if ( ! F_52 ( V_284 , & V_277 -> V_163 ) ) {
...
V_277 -> V_287 = V_298 ;
F_3 ( L_62 ,
V_5 , V_46 -> V_136 , V_277 -> args . V_228 , V_277 -> args . V_88 ) ;
V_300 = V_9 -> V_10 -> V_309 ( V_277 ) ;
if ( V_300 != V_302 )
F_199 ( V_46 , V_310 ) ;
F_3 ( L_60 , V_5 , V_300 ) ;
return V_300 ;
}
void F_215 ( struct V_276 * V_277 )
{
struct V_258 V_259 ;
if ( ! F_52 ( V_284 , & V_277 -> V_163 ) ) {
F_74 ( V_277 -> V_73 ) ;
V_277 -> V_73 = NULL ;
F_209 ( & V_259 , V_277 -> V_46 , false ,
V_277 -> V_279 ) ;
V_277 -> V_198 . V_285 = F_187 ( & V_259 , V_277 ) ;
}
}
static void
F_216 ( struct V_258 * V_271 , struct V_276 * V_277 )
{
const struct V_297 * V_298 = V_271 -> V_304 ;
struct V_72 * V_73 = V_271 -> V_260 ;
enum V_296 V_300 ;
V_300 = F_214 ( V_277 , V_298 , V_73 ) ;
switch ( V_300 ) {
case V_302 :
F_213 ( V_271 , V_277 ) ;
case V_305 :
...
static void F_217 ( struct V_276 * V_277 )
{
F_74 ( V_277 -> V_73 ) ;
F_203 ( V_277 ) ;
}
int
F_218 ( struct V_258 * V_271 )
{
struct V_276 * V_277 ;
int V_132 ;
V_277 = F_205 ( V_271 -> V_307 ) ;
...
static void F_219 ( struct V_46 * V_46 )
{
...
static void F_220 ( struct V_46 * V_46 , struct V_80 * V_312 )
{
struct V_72 * V_73 ;
F_2 (lseg, &NFS_I(inode)->layout->plh_segs, pls_list) {
if ( V_73 -> V_76 . V_65 == V_93 &&
F_47 ( V_84 , & V_73 -> V_75 ) )
F_19 ( & V_73 -> V_105 , V_312 ) ;
}
}
static void F_221 ( struct V_46 * V_46 , struct V_80 * V_312 )
{
struct V_72 * V_73 , * V_37 ;
...
void
F_192 ( struct V_46 * V_46 , struct V_72 * V_73 ,
T_5 V_313 )
{
struct V_57 * V_58 = F_30 ( V_46 ) ;
bool V_314 = false ;
...
V_58 -> V_59 -> V_315 = V_313 ;
V_314 = true ;
F_3 ( L_63 ,
V_5 , V_46 -> V_136 ) ;
} else if ( V_313 > V_58 -> V_59 -> V_315 )
V_58 -> V_59 -> V_315 = V_313 ;
...
F_7 ( & V_46 -> V_62 ) ;
F_3 ( L_64 ,
V_5 , V_73 , V_58 -> V_59 -> V_315 ) ;
if ( V_314 )
F_223 ( V_46 ) ;
}
void F_224 ( struct V_316 * V_317 )
{
struct V_8 * V_9 = F_24 ( V_317 -> args . V_46 ) ;
if ( V_9 -> V_10 -> V_318 )
V_9 -> V_10 -> V_318 ( V_317 ) ;
F_221 ( V_317 -> args . V_46 , & V_317 -> V_85 ) ;
}
int
F_99 ( struct V_46 * V_46 , bool V_169 )
{
struct V_1 * V_49 = F_24 ( V_46 ) -> V_10 ;
struct V_316 * V_317 ;
struct V_57 * V_58 = F_30 ( V_46 ) ;
...
V_35 = - V_134 ;
if ( F_52 ( V_311 , & V_58 -> V_163 ) ) {
if ( ! V_169 )
goto V_4;
V_35 = F_226 ( & V_58 -> V_163 ,
V_311 ,
V_224 ,
V_319 ) ;
if ( V_35 )
...
V_35 = - V_155 ;
V_317 = F_110 ( sizeof( * V_317 ) , V_172 ) ;
if ( ! V_317 )
goto V_320;
V_35 = 0 ;
F_5 ( & V_46 -> V_62 ) ;
...
goto V_166;
F_64 ( & V_317 -> V_85 ) ;
F_220 ( V_46 , & V_317 -> V_85 ) ;
V_313 = V_58 -> V_59 -> V_315 ;
F_106 ( & V_317 -> args . V_103 , & V_58 -> V_59 -> V_146 ) ;
F_7 ( & V_46 -> V_62 ) ;
V_317 -> args . V_46 = V_46 ;
V_317 -> V_161 = F_146 ( V_58 -> V_59 -> V_55 ) ;
F_227 ( & V_317 -> V_321 ) ;
V_317 -> args . V_322 = F_24 ( V_46 ) -> V_323 ;
V_317 -> V_182 . V_321 = & V_317 -> V_321 ;
if ( V_313 != 0 )
V_317 -> args . V_324 = V_313 - 1 ;
else
V_317 -> args . V_324 = V_325 ;
V_317 -> V_182 . V_20 = F_24 ( V_46 ) ;
if ( V_49 -> V_326 ) {
V_35 = V_49 -> V_326 ( & V_317 -> args ) ;
if ( V_35 ) {
F_28 ( V_317 -> V_161 ) ;
F_5 ( & V_46 -> V_62 ) ;
F_36 ( V_162 , & V_58 -> V_163 ) ;
if ( V_313 > V_58 -> V_59 -> V_315 )
V_58 -> V_59 -> V_315 = V_313 ;
goto V_166;
}
}
V_35 = F_228 ( V_317 , V_169 ) ;
V_4:
if ( V_35 )
F_223 ( V_46 ) ;
F_3 ( L_66 , V_5 , V_35 ) ;
...
int
F_230 ( struct V_46 * V_46 , bool V_327 )
{
return F_99 ( V_46 , true ) ;
}
struct V_207 * F_231 ( void )
{
struct V_207 * V_328 ;
V_328 = F_110 ( sizeof( * V_328 ) , V_172 ) ;
if ( ! V_328 ) {
F_3 ( L_67 , V_5 ) ;
return NULL ;
}
...
int
F_232 ( struct V_46 * V_46 , T_2 V_48 )
{
struct V_1 * V_49 = F_24 ( V_46 ) -> V_10 ;
...
struct V_43 * V_277 ;
int V_35 = 0 ;
if ( ! F_156 ( V_20 ) || ! V_49 -> V_330 )
goto V_4;
if ( ! F_233 ( V_46 , V_331 ) )
goto V_4;
if ( F_52 ( V_332 , & V_58 -> V_163 ) )
goto V_4;
F_5 ( & V_46 -> V_62 ) ;
if ( ! F_30 ( V_46 ) -> V_59 ) {
F_7 ( & V_46 -> V_62 ) ;
...
V_277 = F_30 ( V_46 ) -> V_59 ;
F_22 ( V_277 ) ;
F_7 ( & V_46 -> V_62 ) ;
V_317 = F_110 ( sizeof( * V_317 ) , V_48 ) ;
if ( ! V_317 ) {
V_35 = - V_155 ;
goto V_334;
}
V_317 -> args . V_335 = F_234 ( V_46 ) ;
V_317 -> args . V_46 = V_46 ;
V_35 = V_49 -> V_330 ( & V_317 -> args ) ;
if ( V_35 )
goto V_336;
V_35 = F_235 ( F_24 ( V_46 ) , V_317 ) ;
V_4:
F_3 ( L_68 , V_5 , V_35 ) ;
return V_35 ;
V_336:
