...
static void F_15 ( struct V_40 * V_41 , struct V_28 * V_28 )
{
struct V_7 * V_8 = V_28 -> V_29 ;
int V_26 ;
...
static T_1 F_18 ( struct V_28 * V_28 , T_1 V_51 , int V_52 )
{
F_19 ( V_52 ,
L_8 , V_53 ) ;
if ( V_51 == 0 )
...
static int F_20 ( struct V_28 * V_28 )
{
struct V_55 * V_37 ;
int V_15 ;
struct V_7 * V_8 ;
...
F_23 (rdev, mddev) {
V_8 -> V_37 = V_37 ;
F_24 ( V_28 -> V_58 , V_37 -> V_38 ,
V_37 -> V_59 << 9 ) ;
}
F_25 ( V_28 , F_18 ( V_28 , 0 , 0 ) ) ;
V_28 -> V_29 = V_8 ;
F_17 ( V_28 ) ;
return 0 ;
}
static void F_26 ( struct V_28 * V_28 , void * V_60 )
{
struct V_7 * V_8 = V_60 ;
F_27 ( V_8 ) ;
}
