...
V_2 -> V_21 . V_130 = F_71 ( V_6 ,
V_2 -> V_32 -> V_34 . V_35 -> V_178 ) ;
if ( V_2 -> V_21 . V_130 )
V_2 -> V_179 . V_180 = F_71 ( L_20 ,
V_2 -> V_21 . V_130 ) ;
F_75 ( V_2 ) ;
}
...
struct V_134 * V_135 ;
char V_6 [ 10 + V_177 ] ;
V_135 = V_2 -> V_21 . V_130 ;
if ( ! V_135 )
return;
sprintf ( V_6 , L_19 , V_2 -> T_9 ) ;
if ( ! F_81 ( V_135 -> V_181 , V_135 , V_135 -> V_181 , V_6 ) )
F_82 ( V_2 ,
L_21 ,
V_6 ) ;
}
