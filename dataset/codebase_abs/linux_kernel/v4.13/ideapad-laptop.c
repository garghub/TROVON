...
static T_3 F_29 ( struct V_54 * V_55 ,
struct V_56 * V_57 ,
char * V_58 )
{
struct V_24 * V_25 = F_25 ( V_55 ) ;
unsigned long V_5 ;
if ( F_7 ( V_25 -> V_28 -> V_1 , V_36 , & V_5 ) )
return sprintf ( V_58 , L_36 ) ;
return sprintf ( V_58 , L_37 , V_5 ) ;
}
static T_3 T_5 F_30 ( struct V_54 * V_55 ,
struct V_56 * V_57 ,
const char * V_58 , T_4 V_12 )
{
struct V_24 * V_25 = F_25 ( V_55 ) ;
...
if ( V_7 )
return V_7 ;
V_7 = F_11 ( V_25 -> V_28 -> V_1 , V_64 , V_59 ) ;
if ( V_7 < 0 )
return - V_61 ;
return V_12 ;
}
static T_6 F_32 ( struct V_65 * V_66 ,
struct V_67 * V_57 ,
int V_68 )
{
struct V_54 * V_55 = F_33 ( V_66 , struct V_54 , V_66 ) ;
struct V_24 * V_25 = F_25 ( V_55 ) ;
bool V_69 ;
if ( V_57 == & V_70 . V_57 )
V_69 = F_17 ( V_45 , & ( V_25 -> V_41 ) ) ;
else if ( V_57 == & V_71 . V_57 ) {
unsigned long V_15 ;
V_69 = ! F_7 ( V_25 -> V_28 -> V_1 , V_62 ,
& V_15 ) ;
} else
V_69 = true ;
return V_69 ? V_57 -> V_72 : 0 ;
}
static int F_34 ( void * V_16 , bool V_73 )
{
struct V_74 * V_25 = V_16 ;
int V_75 = V_76 [ V_25 -> V_55 ] . V_75 ;
return F_11 ( V_25 -> V_25 -> V_28 -> V_1 , V_75 , ! V_73 ) ;
}
...
int V_78 ;
if ( V_25 -> V_79 ) {
if ( F_7 ( V_25 -> V_28 -> V_1 , V_32 , & V_77 ) )
return;
V_77 = ! V_77 ;
}
for ( V_78 = 0 ; V_78 < V_80 ; V_78 ++ )
if ( V_25 -> V_81 [ V_78 ] )
F_36 ( V_25 -> V_81 [ V_78 ] , V_77 ) ;
}
static int F_37 ( struct V_24 * V_25 , int V_55 )
{
int V_7 ;
unsigned long V_82 ;
if ( V_83 &&
...
V_25 -> V_85 [ V_55 ] . V_55 = V_55 ;
V_25 -> V_85 [ V_55 ] . V_25 = V_25 ;
V_25 -> V_81 [ V_55 ] = F_38 ( V_76 [ V_55 ] . V_86 ,
& V_25 -> V_87 -> V_55 ,
V_76 [ V_55 ] . type ,
& V_88 ,
& V_25 -> V_85 [ V_55 ] ) ;
if ( ! V_25 -> V_81 [ V_55 ] )
return - V_53 ;
if ( F_7 ( V_25 -> V_28 -> V_1 , V_76 [ V_55 ] . V_75 - 1 ,
& V_82 ) ) {
F_39 ( V_25 -> V_81 [ V_55 ] , 0 ) ;
} else {
V_82 = ! V_82 ;
F_39 ( V_25 -> V_81 [ V_55 ] , V_82 ) ;
}
V_7 = F_40 ( V_25 -> V_81 [ V_55 ] ) ;
if ( V_7 ) {
F_41 ( V_25 -> V_81 [ V_55 ] ) ;
return V_7 ;
}
...
static void F_42 ( struct V_24 * V_25 , int V_55 )
{
if ( ! V_25 -> V_81 [ V_55 ] )
return;
F_43 ( V_25 -> V_81 [ V_55 ] ) ;
...
{
return F_45 ( & V_25 -> V_87 -> V_55 . V_66 ,
& V_89 ) ;
}
static void F_46 ( struct V_24 * V_25 )
{
F_47 ( & V_25 -> V_87 -> V_55 . V_66 ,
& V_89 ) ;
}
...
V_91 -> V_92 = L_40 ;
V_91 -> V_93 . V_94 = V_95 ;
V_91 -> V_55 . V_96 = & V_25 -> V_87 -> V_55 ;
error = F_50 ( V_91 , V_97 , NULL ) ;
if ( error ) {
F_10 ( L_41 ) ;
goto V_98;
}
...
if ( ! F_7 ( V_25 -> V_28 -> V_1 , V_36 , & V_15 ) ) {
unsigned char V_120 ;
F_74 ( & V_120 , V_15 ? V_121 :
V_122 ) ;
F_55 ( V_25 , V_15 ? 67 : 66 ) ;
}
}
static void F_75 ( T_1 V_1 , T_7 V_123 , void * V_16 )
{
...
static void F_76 ( T_7 V_15 , void * V_129 )
{
switch ( V_15 ) {
case 128 :
F_55 ( V_129 , V_15 ) ;
...
static int F_77 ( struct V_87 * V_130 )
{
int V_7 , V_78 ;
int V_41 ;
struct V_24 * V_25 ;
struct V_131 * V_28 ;
V_7 = F_78 ( F_79 ( & V_130 -> V_55 ) , & V_28 ) ;
if ( V_7 )
return - V_132 ;
if ( F_1 ( V_28 -> V_1 , L_47 , & V_41 ) )
return - V_132 ;
V_25 = F_80 ( & V_130 -> V_55 , sizeof( * V_25 ) , V_133 ) ;
if ( ! V_25 )
return - V_53 ;
F_81 ( & V_130 -> V_55 , V_25 ) ;
V_25 -> V_41 = V_41 ;
V_25 -> V_28 = V_28 ;
V_25 -> V_87 = V_130 ;
V_25 -> V_79 = ! F_82 ( V_134 ) ;
V_7 = F_44 ( V_25 ) ;
if ( V_7 )
return V_7 ;
V_7 = F_19 ( V_25 ) ;
...
for ( V_78 = 0 ; V_78 < V_80 ; V_78 ++ )
if ( F_17 ( V_76 [ V_78 ] . V_138 , & V_25 -> V_41 ) )
F_37 ( V_25 , V_78 ) ;
F_35 ( V_25 ) ;
F_73 ( V_25 ) ;
if ( F_83 () == V_139 ) {
...
goto V_142;
#if F_85 ( V_143 )
for ( V_78 = 0 ; V_78 < F_86 ( V_144 ) ; V_78 ++ ) {
V_7 = F_87 ( V_144 [ V_78 ] ,
F_76 , V_25 ) ;
if ( V_7 == V_17 ) {
V_25 -> V_145 = V_144 [ V_78 ] ;
break;
}
}
...
static int F_89 ( struct V_87 * V_130 )
{
...
F_22 ( V_25 ) ;
F_46 ( V_25 ) ;
F_81 ( & V_130 -> V_55 , NULL ) ;
return 0 ;
}
static int F_91 ( struct V_54 * V_54 )
{
struct V_24 * V_25 ;
if ( ! V_54 )
return - V_27 ;
