...
V_62 = F_41 ( ( void T_2 * ) ( V_65 ) V_60 . V_66 ,
V_60 . V_63 ) ;
if ( F_35 ( V_62 ) ) {
F_30 (
L_10 ) ;
...
return - V_47 ;
V_73 = V_72 . V_63 ;
V_72 . V_71 = F_45 ( V_6 -> V_14 ,
& V_73 , & V_62 ) ;
if ( V_72 . V_71 >= V_32 ) {
void T_2 * V_74 = ( void T_2 * ) ( V_65 ) V_72 . V_66 ;
V_27 = F_17 ( V_74 , V_62 , F_42 ( V_62 ) ) ;
F_10 ( V_62 ) ;
if ( V_27 != 0 )
return - V_47 ;
}
...
V_58 = F_37 ( V_6 -> V_14 ) ;
V_111 . V_71 = F_64 ( V_58 , V_111 . V_109 ,
V_111 . V_110 , V_108 ) ;
