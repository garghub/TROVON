...
int F_178 ( const char * V_182 , T_11 args )
{
int V_189 ;
...
int F_180 ( const char * V_182 , ... )
{
T_11 args ;
int V_189 ;
va_start ( args , V_182 ) ;
V_189 = F_178 ( V_182 , args ) ;
va_end ( args ) ;
return V_189 ;
}
int F_181 ( const char * V_248 )
{
return F_39 ( & V_249 , V_248 ) ;
}
bool F_182 ( unsigned long * V_250 ,
unsigned int V_251 )
{
...
if ( ! V_254 -> V_258 ) {
V_254 -> V_258 = 1 ;
F_185 ( & V_254 -> V_259 , & V_260 ) ;
V_18 = 0 ;
}
F_186 ( & V_257 , V_21 ) ;
return V_18 ;
}
int F_187 ( struct V_253 * V_254 )
{
unsigned long V_21 ;
int V_18 = - V_2 ;
F_184 ( & V_257 , V_21 ) ;
...
bool V_85 ;
F_80 ( V_21 ) ;
V_85 = F_194 ( V_254 , V_140 , line , V_42 , V_30 ) ;
F_81 ( V_21 ) ;
return V_85 ;
}
bool F_196 ( struct V_253 * V_254 , bool V_140 ,
...
void T_1 F_199 ( const char * V_182 , ... )
{
T_11 args ;
va_start ( args , V_182 ) ;
...
void F_200 ( const char * V_272 )
{
F_119 ( L_39 ,
V_272 , F_142 () , V_63 -> V_273 , V_63 -> V_64 ,
F_201 () , F_202 () -> V_274 ,
( int ) strcspn ( F_202 () -> V_275 , L_40 ) ,
F_202 () -> V_275 ) ;
if ( V_271 [ 0 ] != '\0' )
F_119 ( L_41 ,
V_272 , V_271 ) ;
...
void F_204 ( const char * V_272 )
{
F_200 ( V_272 ) ;
F_119 ( L_42 ,
V_272 , V_63 , F_205 ( V_63 ) ) ;
}
