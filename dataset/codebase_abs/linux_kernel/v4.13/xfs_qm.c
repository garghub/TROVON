...
goto V_232;
if ( ! F_58 ( V_4 ) ) {
F_141 ( V_189 , V_4 -> V_233 ,
V_2 -> V_8 -> V_125 ) ;
V_29 = F_142 ( V_2 -> V_184 , & V_189 , 1 , 0 , NULL ) ;
if ( ! V_29 ) {
error = - V_226 ;
goto V_232;
}
...
V_248:
F_65 ( & V_2 -> V_163 ) ;
V_246 = V_2 -> V_63 . V_129 ;
V_2 -> V_63 . V_129 = V_2 -> V_128 & V_249 ;
F_60 ( & V_2 -> V_163 ) ;
if ( V_246 != ( V_2 -> V_128 & V_249 ) ) {
if ( F_154 ( V_2 , false ) ) {
ASSERT ( ! ( F_38 ( V_2 ) ) ) ;
F_108 ( V_2 , L_10 ,
V_30 ) ;
...
ASSERT ( V_265 ) ;
ASSERT ( V_265 != V_264 ) ;
F_160 ( V_154 , V_265 , V_266 , - ( V_55 -> V_66 . V_195 ) ) ;
F_160 ( V_154 , V_265 , V_269 , - 1 ) ;
F_160 ( V_154 , V_264 , V_266 , V_55 -> V_66 . V_195 ) ;
F_160 ( V_154 , V_264 , V_269 , 1 ) ;
* V_263 = F_157 ( V_264 ) ;
return V_265 ;
}
int
...
error = F_162 ( NULL , V_55 -> V_60 ,
V_280 , V_281 , V_282 ,
( T_16 ) V_274 , 0 ,
V_41 | V_275 | V_276 ) ;
if ( error )
return error ;
F_162 ( NULL , V_55 -> V_60 ,
V_277 , V_278 , V_279 ,
- ( ( T_16 ) V_274 ) , 0 , V_275 ) ;
}
return 0 ;
...
V_55 -> V_65 = F_157 ( V_271 ) ;
F_160 ( V_154 , V_271 , V_269 , 1 ) ;
}
if ( V_272 && F_44 ( V_2 ) ) {
ASSERT ( V_55 -> V_70 == NULL ) ;
ASSERT ( V_55 -> V_66 . V_71 == F_7 ( V_272 -> V_20 . V_21 ) ) ;
V_55 -> V_70 = F_157 ( V_272 ) ;
F_160 ( V_154 , V_272 , V_269 , 1 ) ;
}
if ( V_273 && F_45 ( V_2 ) ) {
ASSERT ( V_55 -> V_72 == NULL ) ;
ASSERT ( F_46 ( V_55 ) == F_7 ( V_273 -> V_20 . V_21 ) ) ;
V_55 -> V_72 = F_157 ( V_273 ) ;
F_160 ( V_154 , V_273 , V_269 , 1 ) ;
}
}
