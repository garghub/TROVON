...
sprintf ( V_106 , L_23 ,
F_47 ( V_2 -> V_32 -> V_111 . V_112 ) ) ;
V_28 = F_48 ( & V_108 , V_106 , & V_2 -> V_32 -> V_91 ) ;
if ( V_28 < 0 )
return V_28 ;
F_49 ( L_24 ,
...
V_116 = F_50 ( V_109 , NULL , 10 ) ;
V_117 = F_50 ( V_109 + 4 , NULL , 10 ) ;
V_118 = F_50 ( V_109 + 8 , NULL , 10 ) ;
V_110 = ( V_116 << 12 )
+ ( V_117 << 8 )
+ ( ( V_118 / 10 ) << 4 )
+ ( V_118 % 10 ) ;
...
if ( V_2 -> V_32 -> V_111 . V_112 == F_51 ( V_110 ) ) {
...
V_2 -> V_126 = F_54 ( V_41 , & V_2 -> V_127 , V_122 ) ;
...
static int F_56 ( struct V_42 * V_41 )
{
struct V_1 * V_2 ;
int V_101 ;
F_10 (netdev != NULL, return -1;) ;
...
static int F_60 ( struct V_42 * V_91 , struct V_131 * V_132 , int V_133 )
{
unsigned long V_44 ;
...
V_145 = V_2 -> V_146 ;
F_64 ( & V_2 -> V_127 ) ;
V_2 -> V_127 . V_147 . V_148 = F_47 ( V_145 -> V_149 ) ;
...
V_173 = F_47 ( V_167 [ V_101 ] . V_145 . V_178 ) ;
if( V_172 == V_179 ) {
if( V_171 == V_180 ) {
V_2 -> V_70 = V_170 ;
} else {
...
int V_101 ;
F_49 ( L_47 ,
V_91 -> V_125 , F_47 ( V_91 -> V_111 . V_202 ) ,
F_47 ( V_91 -> V_111 . V_203 ) ) ;
