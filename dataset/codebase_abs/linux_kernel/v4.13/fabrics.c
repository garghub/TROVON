...
static int F_41 ( struct V_87 * V_19 ,
const char * V_16 )
{
T_2 args [ V_90 ] ;
char * V_91 , * V_92 , * V_93 ;
...
V_19 -> V_100 = F_42 () ;
V_19 -> V_101 = V_102 ;
V_91 = V_92 = F_43 ( V_16 , V_8 ) ;
if ( ! V_91 )
return - V_71 ;
F_44 ( & V_72 ) ;
while ( ( V_93 = F_45 ( & V_92 , L_21 ) ) != NULL ) {
if ( ! * V_93 )
continue;
V_94 = F_46 ( V_93 , V_103 , args ) ;
V_19 -> V_20 |= V_94 ;
switch ( V_94 ) {
case V_104 :
V_93 = F_47 ( args ) ;
...
static int F_54 ( struct V_87 * V_19 ,
unsigned int V_120 )
{
if ( ( V_19 -> V_20 & V_120 ) != V_120 ) {
int V_121 ;
for ( V_121 = 0 ; V_121 < F_55 ( V_103 ) ; V_121 ++ ) {
if ( ( V_103 [ V_121 ] . V_94 & V_120 ) &&
! ( V_103 [ V_121 ] . V_94 & V_19 -> V_20 ) ) {
F_51 ( L_32 ,
V_103 [ V_121 ] . V_122 ) ;
}
}
...
int V_121 ;
for ( V_121 = 0 ; V_121 < F_55 ( V_103 ) ; V_121 ++ ) {
if ( ( V_103 [ V_121 ] . V_94 & V_19 -> V_20 ) &&
( V_103 [ V_121 ] . V_94 & ~ V_123 ) ) {
F_51 ( L_33 ,
V_103 [ V_121 ] . V_122 ) ;
}
}
...
static struct V_14 *
F_58 ( struct V_43 * V_124 , const char * V_16 , T_3 V_125 )
{
struct V_87 * V_19 ;
struct V_80 * V_81 ;
struct V_14 * V_15 ;
...
V_33 = F_54 ( V_19 , V_81 -> V_120 ) ;
if ( V_33 )
goto V_7;
V_33 = F_56 ( V_19 , V_128 |
...
static T_5 F_64 ( struct V_131 * V_131 , const char T_6 * V_132 ,
T_3 V_125 , T_7 * V_133 )
{
...
static int F_66 ( struct V_134 * V_134 , void * V_138 )
{
struct V_14 * V_15 ;
int V_33 = 0 ;
F_4 ( & V_137 ) ;
...
static int F_68 ( struct V_141 * V_141 , struct V_131 * V_131 )
{
V_131 -> V_135 = NULL ;
return F_69 ( V_131 , F_66 , NULL ) ;
}
static int F_70 ( struct V_141 * V_141 , struct V_131 * V_131 )
{
struct V_134 * V_134 = V_131 -> V_135 ;
struct V_14 * V_15 = V_134 -> V_138 ;
if ( V_15 )
F_71 ( V_15 ) ;
return F_72 ( V_141 , V_131 ) ;
}
...
V_139 =
F_75 ( V_142 , NULL , F_76 ( 0 , 0 ) , NULL , L_39 ) ;
if ( F_61 ( V_139 ) ) {
F_48 ( L_40 ) ;
V_33 = F_62 ( V_139 ) ;
goto V_145;
...
F_79 ( V_142 ) ;
F_15 ( V_118 ) ;
F_82 ( sizeof( struct V_58 ) != 64 ) ;
F_82 ( sizeof( struct V_148 ) != 64 ) ;
F_82 ( sizeof( struct V_149 ) != 64 ) ;
F_82 ( sizeof( struct V_50 ) != 1024 ) ;
}
