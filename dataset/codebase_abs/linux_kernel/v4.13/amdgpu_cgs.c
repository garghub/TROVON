...
V_81 = V_165 -> V_81 ;
if ( V_81 ) {
V_81 -> V_245 = 0xffffffff ;
V_81 -> V_246 = V_24 -> clock . V_247 . V_248 ;
}
if ( V_24 -> V_81 . V_249 && V_24 -> V_81 . V_250 ) {
F_75 (crtc,
&ddev->mode_config.crtc_list, head) {
V_237 = F_76 ( V_241 ) ;
if ( V_241 -> V_251 ) {
V_165 -> V_252 |= ( 1 << V_237 -> V_253 ) ;
V_165 -> V_254 ++ ;
}
if ( V_81 != NULL &&
V_241 -> V_251 && V_237 -> V_251 &&
V_237 -> V_255 . clock ) {
V_242 = ( V_237 -> V_255 . V_256 * 1000 ) /
V_237 -> V_255 . clock ;
V_243 = V_237 -> V_255 . V_257 -
V_237 -> V_255 . V_258 +
( V_237 -> V_259 * 2 ) ;
V_81 -> V_245 = V_243 * V_242 ;
V_81 -> V_260 = F_77 ( & V_237 -> V_255 ) ;
V_81 -> V_246 = V_24 -> clock . V_247 . V_248 ;
V_81 = NULL ;
}
}
...
static int F_78 ( struct V_1 * V_1 , bool V_251 )
{
V_8 ;
V_24 -> V_149 . V_261 = V_251 ;
return 0 ;
}
