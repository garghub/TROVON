...
static int F_109 ( struct V_7 * V_8 , void * V_9 , const void * V_228 )
{
if ( ! F_39 ( V_9 ) )
return - V_14 ;
V_81 = V_228 ;
return F_110 ( V_8 , & V_229 ) ;
}
static void F_111 ( struct V_7 * V_8 , void * V_9 )
{
F_40 ( V_9 ) ;
F_112 ( V_8 ) ;
}
static int F_113 ( unsigned long V_1 , V_124 V_20 )
{
struct V_69 * V_70 ;
struct V_100 * V_100 ;
struct V_230 * V_231 ;
...
V_100 = V_70 -> V_100 ;
V_232 = F_114 ( & V_100 -> V_234 ) ;
V_231 = F_115 ( V_100 , V_20 ) ;
if ( ! V_231 ) {
F_116 ( & V_100 -> V_234 , V_232 ) ;
return - V_80 ;
}
F_117 ( & V_100 -> V_235 ) ;
if ( F_48 ( V_70 , V_20 ) )
goto V_29;
F_118 ( V_100 , V_231 , V_20 , V_236 ) ;
F_49 ( V_70 , V_20 ) ;
V_29:
F_119 ( & V_100 -> V_235 ) ;
F_116 ( & V_100 -> V_234 , V_232 ) ;
...
static int F_120 ( unsigned long V_1 , V_124 V_20 )
{
struct V_69 * V_70 ;
struct V_100 * V_100 ;
struct V_230 * V_231 ;
...
static void F_122 ( struct V_237 * V_238 , T_14 V_239 ,
const T_11 * V_147 , int V_240 ,
struct V_241 * V_22 )
{
struct V_69 * V_70 = F_65 ( V_22 ,
struct V_69 , V_242 ) ;
if ( F_48 ( V_70 , F_123 ( V_239 ) ) )
V_81 -> V_137 ( V_70 -> V_3 , V_239 ,
( void * ) V_147 , V_240 ) ;
}
static void F_124 ( struct V_100 * V_100 ,
struct V_230 * V_231 ,
struct V_241 * V_22 )
{
int V_46 ;
...
struct V_69 , V_242 ) ;
F_117 ( & V_100 -> V_235 ) ;
for ( V_46 = 0 ; V_46 < V_231 -> V_243 ; V_46 ++ ) {
V_20 = V_231 -> V_244 + V_46 ;
if ( F_48 ( V_70 , V_20 ) ) {
F_121 ( V_100 , V_231 , V_20 ,
V_236 ) ;
F_52 ( V_70 , V_20 ) ;
}
}
...
static bool F_125 ( struct V_2 * V_3 , struct V_100 * V_100 )
{
struct V_2 * V_26 ;
struct V_69 * V_70 ;
int V_180 ;
...
if ( ! V_100 || V_100 -> V_247 != V_248 -> V_247 ) {
F_55 ( L_23 ) ;
return - V_233 ;
}
if ( F_125 ( V_3 , V_100 ) )
return - V_246 ;
V_70 = F_127 ( sizeof( struct V_69 ) ) ;
if ( ! V_70 )
return - V_17 ;
...
F_41 ( V_70 ) ;
F_26 ( V_3 ) ;
V_70 -> V_242 . V_249 = F_122 ;
V_70 -> V_242 . V_250 = F_124 ;
F_129 ( V_100 , & V_70 -> V_242 ) ;
return 0 ;
}
static bool F_75 ( struct V_69 * V_70 )
{
F_130 ( V_70 -> V_100 , & V_70 -> V_242 ) ;
F_131 ( V_70 -> V_100 ) ;
F_43 ( V_70 ) ;
F_28 ( V_70 -> V_3 ) ;
F_132 ( V_70 ) ;
...
static int F_133 ( void * V_3 , unsigned long * V_1 )
{
return 0 ;
}
static void F_134 ( unsigned long V_1 )
{
}
static int F_135 ( unsigned long V_1 , T_6 V_251 , T_10 V_90 )
{
struct V_69 * V_70 ;
struct V_2 * V_3 ;
if ( ! F_1 ( V_1 ) )
...
V_70 = (struct V_69 * ) V_1 ;
V_3 = V_70 -> V_3 ;
if ( F_136 ( V_3 -> V_23 . V_171 , 1 ) == 1 )
return 0 ;
return - V_14 ;
}
static unsigned long F_137 ( unsigned long V_1 , unsigned long V_20 )
{
...
V_40 = F_138 ( V_8 , & V_20 , 1 , V_252 | V_253 , & V_4 ) ;
if ( V_40 != 1 ) {
F_55 ( L_24 ,
V_20 , V_40 ) ;
return V_32 ;
...
static int F_139 ( unsigned long V_1 , unsigned long V_239 ,
void * V_53 , unsigned long V_240 , bool V_254 )
{
struct V_69 * V_70 ;
struct V_100 * V_100 ;
int V_232 , V_25 ;
bool V_255 = V_248 -> V_247 == NULL ;
if ( ! F_1 ( V_1 ) )
return - V_233 ;
V_70 = (struct V_69 * ) V_1 ;
V_100 = V_70 -> V_100 ;
...
F_140 ( V_100 -> V_247 ) ;
V_232 = F_114 ( & V_100 -> V_234 ) ;
V_25 = V_254 ? F_141 ( V_100 , V_239 , V_53 , V_240 ) :
F_142 ( V_100 , V_239 , V_53 , V_240 ) ;
F_116 ( & V_100 -> V_234 , V_232 ) ;
if ( V_255 )
F_143 ( V_100 -> V_247 ) ;
return V_25 ;
}
static int F_144 ( unsigned long V_1 , unsigned long V_239 ,
void * V_53 , unsigned long V_240 )
{
return F_139 ( V_1 , V_239 , V_53 , V_240 , false ) ;
}
static int F_145 ( unsigned long V_1 , unsigned long V_239 ,
void * V_53 , unsigned long V_240 )
{
return F_139 ( V_1 , V_239 , V_53 , V_240 , true ) ;
}
static unsigned long F_146 ( void * V_251 )
{
return F_147 ( F_148 ( V_251 ) ) ;
}
static int T_15 F_149 ( void )
{
return 0 ;
}
static void T_16 F_150 ( void )
{
}
