...
T_4 * V_43 = & V_26 -> V_32 ;
int V_30 ;
V_30 = F_37 ( V_26 , V_27 , V_28 ) ;
if ( V_30 )
return V_30 ;
V_30 = F_28 ( & V_1 -> V_35 , V_27 , V_28 / 2 , V_43 ) ;
if ( V_30 )
return V_30 ;
return F_28 ( & V_1 -> V_46 , V_27 + V_28 / 2 , V_28 / 2 ,
V_43 ) ;
}
static int F_38 ( struct V_9 * V_10 , struct V_11 * V_2 ,
struct V_11 * V_3 , unsigned int V_12 )
{
struct V_45 * V_1 = F_31 ( V_10 -> V_26 ) ;
return F_39 ( & V_47 , V_10 , V_2 , V_3 , V_12 ,
F_40 ( V_5 ) ,
& V_1 -> V_46 , & V_1 -> V_35 ) ;
}
static int F_41 ( struct V_9 * V_10 , struct V_11 * V_2 ,
struct V_11 * V_3 , unsigned int V_12 )
{
struct V_45 * V_1 = F_31 ( V_10 -> V_26 ) ;
return F_39 ( & V_48 , V_10 , V_2 , V_3 , V_12 ,
F_40 ( V_5 ) ,
& V_1 -> V_46 , & V_1 -> V_35 ) ;
}
