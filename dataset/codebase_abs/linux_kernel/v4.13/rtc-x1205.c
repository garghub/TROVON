...
static int F_17 ( struct V_81 * V_16 , struct V_82 * V_83 )
{
int V_50 ;
...
static int F_19 ( struct V_81 * V_16 , struct V_82 * V_83 )
{
return F_7 ( F_18 ( V_16 ) ,
& V_83 -> time , V_90 , V_83 -> V_89 ) ;
}
static int F_20 ( struct V_81 * V_16 , struct V_3 * V_4 )
{
return F_1 ( F_18 ( V_16 ) ,
V_4 , V_19 ) ;
}
static int F_21 ( struct V_81 * V_16 , struct V_3 * V_4 )
{
return F_7 ( F_18 ( V_16 ) ,
V_4 , V_19 , 0 ) ;
}
static int F_22 ( struct V_81 * V_16 , struct V_91 * V_92 )
{
int V_50 , V_93 , V_94 ;
V_50 = F_12 ( F_18 ( V_16 ) , & V_93 ) ;
if ( ! V_50 )
F_23 ( V_92 , L_21 , V_93 ) ;
V_50 = F_13 ( F_18 ( V_16 ) , & V_94 ) ;
if ( ! V_50 )
F_23 ( V_92 , L_22 ,
V_94 / 1000 , V_94 % 1000 ) ;
return 0 ;
...
static T_3 F_25 ( struct V_81 * V_16 ,
struct V_95 * V_96 , char * V_7 )
{
int V_50 , V_93 ;
V_50 = F_12 ( F_18 ( V_16 ) , & V_93 ) ;
...
static int F_26 ( struct V_81 * V_16 )
{
int V_50 ;
V_50 = F_27 ( V_16 , & V_97 ) ;
if ( V_50 )
...
static void F_29 ( struct V_81 * V_16 )
{
F_28 ( V_16 , & V_97 ) ;
F_28 ( V_16 , & V_98 ) ;
}
...
if ( ! F_31 ( V_2 -> V_15 , V_103 ) )
return - V_75 ;
if ( F_15 ( V_2 ) < 0 )
return - V_75 ;
V_102 = F_32 ( & V_2 -> V_16 , V_104 . V_105 . V_106 ,
& V_107 , V_108 ) ;
if ( F_33 ( V_102 ) )
return F_34 ( V_102 ) ;
F_35 ( V_2 , V_102 ) ;
