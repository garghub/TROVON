...
V_78 | V_79 , 0 ) ;
{
struct V_68 * V_69 = V_50 -> V_74 ;
int V_62 , V_80 ;
for ( V_80 = 0 ; V_80 < V_30 ; V_80 ++ ) {
V_62 = V_3 -> V_17 + V_80 ;
F_29 ( V_62 , & V_69 -> V_3 , V_69 -> V_81 ) ;
F_30 ( V_62 , V_50 ) ;
F_31 ( V_62 , V_78 | V_79 ) ;
}
V_50 -> V_82 = V_62 - V_50 -> V_17 ;
}
return 0 ;
}
static int F_32 ( struct V_83 * V_20 )
{
int V_62 , V_35 ;
struct V_84 * V_85 ;
struct V_86 * V_87 ;
struct V_2 * V_3 ;
struct V_88 * V_89 ;
V_85 = * (struct V_84 * * ) F_33 ( & V_20 -> V_20 ) ;
V_87 = F_33 ( & V_85 -> V_20 ) ;
if ( V_87 == NULL )
F_34 ( & V_20 -> V_20 , L_4 ) ;
F_22 ( L_5 , V_87 ) ;
V_89 = F_35 ( V_20 , V_90 , 0 ) ;
V_3 = F_36 ( & V_20 -> V_20 , sizeof( * V_3 ) , V_91 ) ;
if ( ! V_3 )
return - V_73 ;
V_3 -> V_20 = & V_20 -> V_20 ;
V_3 -> V_71 = F_37 ( & V_20 -> V_20 , V_89 ) ;
if ( F_38 ( V_3 -> V_71 ) )
...
if ( V_35 )
return V_35 ;
V_35 = F_43 ( & V_20 -> V_20 , V_85 -> V_52 , F_23 ,
V_94 , V_70 , V_3 ) ;
if ( V_35 < 0 ) {
F_34 ( & V_20 -> V_20 , L_7 ,
- V_35 ) ;
