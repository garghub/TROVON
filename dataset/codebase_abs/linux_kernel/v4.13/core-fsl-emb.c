...
static void F_36 ( struct V_25 * V_26 , int V_38 )
{
struct V_36 * V_37 ;
...
F_11 ( V_26 ) ;
V_37 = & F_30 ( V_36 ) ;
F_37 ( V_26 != V_37 -> V_26 [ V_26 -> V_29 . V_4 ] ) ;
F_9 ( V_58 , 0 ) ;
F_10 ( V_58 , 0 ) ;
F_6 ( V_58 , 0 ) ;
V_37 -> V_26 [ V_58 ] = NULL ;
...
static void F_38 ( struct V_25 * V_26 , int V_67 )
{
unsigned long V_38 ;
unsigned long V_5 ;
T_1 V_63 ;
...
static void F_40 ( struct V_25 * V_26 , int V_67 )
{
unsigned long V_38 ;
if ( V_26 -> V_29 . V_4 < 0 || ! V_26 -> V_29 . V_62 )
return;
...
static int F_47 ( T_2 V_59 , T_2 * V_70 )
{
...
static void F_53 ( struct V_25 * V_26 , unsigned long V_5 ,
struct V_1 * V_2 )
{
...
if ( V_109 ) {
struct V_110 V_111 ;
F_54 ( & V_111 , 0 , V_26 -> V_29 . V_104 ) ;
if ( F_55 ( V_26 , & V_111 , V_2 ) )
F_40 ( V_26 , 0 ) ;
}
}
...
void F_62 ( int V_115 )
{
struct V_36 * V_37 = & F_63 ( V_36 , V_115 ) ;
memset ( V_37 , 0 , sizeof( * V_37 ) ) ;
}
int F_64 ( struct V_116 * V_35 )
{
if ( V_56 )
return - V_106 ;
V_56 = V_35 ;
