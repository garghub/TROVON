...
if ( F_16 ( V_181 ) )
return F_30 ( V_181 ) ;
V_208 = F_59 ( V_181 ) -> V_209 -> V_210 -> V_208 ;
if ( V_206 && ( V_208 -> V_211 ) )
V_100 = V_208 -> V_211 ( V_64 , V_206 , & V_200 ) ;
else if ( V_208 -> V_212 )
V_100 = V_208 -> V_212 ( V_64 , V_197 , V_183 , & V_200 ) ;
else {
F_61 ( V_181 ) ;
return - V_213 ;
}
...
V_100 = V_208 -> V_212 ( V_64 , V_197 , V_183 , & V_168 ) ;
if ( F_16 ( V_100 ) ) {
V_46 = F_30 ( V_100 ) ;
F_10 ( V_127 , L_44 , V_56 , V_46 ) ;
F_61 ( V_181 ) ;
...
V_46 = - V_213 ;
if ( ! V_46 ) {
V_46 = V_208 -> V_215 ( V_101 , V_168 , V_197 , V_183 , V_169 ) ;
