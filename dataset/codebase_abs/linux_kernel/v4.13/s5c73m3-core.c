...
struct V_30 * V_31 ;
int V_17 , V_100 ;
V_31 = F_106 ( V_66 , sizeof( * V_31 ) , V_236 ) ;
if ( ! V_31 )
return - V_237 ;
V_31 -> V_12 = V_13 ;
V_17 = F_94 ( V_31 ) ;
...
F_109 ( V_61 , V_31 ) ;
F_110 ( V_61 -> V_178 , L_48 , sizeof( V_61 -> V_178 ) ) ;
V_61 -> V_241 = & V_242 ;
V_61 -> V_25 |= V_243 ;
V_31 -> V_244 [ V_155 ] . V_25 = V_245 ;
V_31 -> V_244 [ V_139 ] . V_25 = V_245 ;
V_61 -> V_200 . V_246 = V_247 ;
V_17 = F_111 ( & V_61 -> V_200 , V_168 ,
V_31 -> V_244 ) ;
if ( V_17 < 0 )
return V_17 ;
F_112 ( V_193 , V_13 , & V_248 ) ;
