...
if ( V_21 < 0 )
V_21 = V_136 ;
else if ( V_21 >= F_63 ( V_135 ) || V_135 [ V_21 ] != NULL ) {
F_64 ( V_75 , L_6 , V_21 ) ;
V_21 = V_136 ;
}
return V_21 ;
}
static int F_65 ( struct V_158 * V_75 )
{
struct V_69 * V_159 = F_66 ( V_75 ) ;
if ( V_159 ) {
F_67 ( & V_160 , & V_159 -> V_2 ) ;
...
static int F_69 ( struct V_158 * V_162 )
{
struct V_163 * V_164 ;
struct V_1 * V_165 ;
struct V_166 * V_166 ;
...
int V_136 ;
int V_21 ;
for ( V_136 = 0 ; V_136 < F_63 ( V_135 ) ; V_136 ++ )
if ( V_135 [ V_136 ] == NULL )
break;
if ( V_136 == F_63 ( V_135 ) )
return - V_167 ;
V_136 = F_60 ( V_136 , & V_162 -> V_75 ) ;
V_135 [ V_136 ] = F_70 ( & V_162 -> V_75 ,
...
V_165 -> V_174 = & V_175 ;
V_165 -> V_71 = V_176 ;
V_166 = F_71 ( & V_162 -> V_75 , NULL ) ;
if ( ! F_72 ( V_166 ) )
V_165 -> V_88 = F_73 ( V_166 ) ;
V_164 = F_74 ( V_162 , V_177 , 0 ) ;
if ( ! V_164 ) {
F_30 ( & V_162 -> V_75 , L_7 ) ;
return - V_144 ;
}
V_165 -> V_178 = V_164 -> V_179 ;
V_165 -> V_4 = F_75 ( & V_162 -> V_75 , V_164 ) ;
if ( F_76 ( V_165 -> V_4 ) )
