...
static T_3 * F_24 ( char * V_34 , T_1 V_35 ,
unsigned int * V_36 )
{
char * V_37 , * V_38 , * V_39 ;
T_6 V_40 = 0 ;
...
memset ( V_5 , 0 , V_42 ) ;
V_39 = V_37 = V_34 + V_40 ;
while ( ( V_37 = strtok ( V_39 , L_5 ) ) != NULL && V_44 < V_42 ) {
V_39 = NULL ;
if ( ! strstr ( V_37 , L_11 ) )
continue;
V_38 = V_37 ;
while ( ( V_37 = strstr ( V_38 , L_12 ) ) )
V_38 = V_37 + 1 ;
V_37 = V_38 ;
do {
...
T_3 * V_58 ;
T_3 * V_5 = NULL ;
while ( ( V_53 = F_26 ( V_51 , V_52 , L_20 ) ) != - 1 ) {
switch ( V_53 ) {
case 'o' :
V_6 = 1 ;
break;
...
V_56 = F_17 ( V_55 , V_62 | V_63 | V_64 , V_65 ) ;
if ( V_56 < 0 ) {
fprintf ( V_60 , L_23 , V_55 ) ;
perror ( NULL ) ;
goto V_61;
}
V_58 = V_5 ;
do {
V_57 = F_28 ( V_56 , V_58 , V_4 ) ;
if ( V_57 < 0 ) {
fprintf ( V_60 , L_24 , V_55 ) ;
perror ( NULL ) ;
goto V_61;
}
V_4 -= V_57 ;
