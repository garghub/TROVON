...
V_117:
if ( V_19 -> V_22 . V_119 &&
F_73 ( V_112 , V_2 -> V_120 ) ) {
F_38 ( V_2 ) ;
V_2 -> V_120 = V_112 + F_64 ( V_116 ) ;
}
F_11 ( V_2 , V_121 ) ;
if ( V_122 && F_73 ( V_112 , V_2 -> V_111 ) )
F_63 ( V_2 ) ;
}
F_74 ( & V_2 -> V_55 ) ;
if ( V_122 )
...
static void F_78 ( int V_127 , struct V_45 * V_35 )
{
...
F_46 ( V_2 , V_66 ) ;
if ( F_80 ( & V_2 -> V_130 ) && F_41 ( & V_19 -> V_131 ) ) {
F_81 ( & V_19 -> V_132 ) ;
}
F_82 ( V_19 ) ;
}
...
unsigned int V_126 ;
V_126 = F_77 ( V_2 , V_42 , V_67 -> V_135 ,
...
V_126 = F_77 ( V_2 , V_42 , V_137 ,
V_40 , V_125 ) ;
if ( V_126 ) {
V_115 = F_86 ( V_40 , NULL , V_125 , V_126 ) ;
F_4 ( V_115 ) ;
F_9 ( V_2 , V_125 , V_126 ) ;
}
V_42 += V_137 ;
...
if ( V_145 ) {
V_115 = F_89 ( V_140 , NULL , V_141 , V_145 ) ;
F_4 ( V_115 ) ;
}
...
static int F_92 ( struct V_66 * V_66 )
{
int V_77 ;
V_77 = F_87 ( V_66 -> V_2 , V_66 -> V_134 ,
V_66 -> V_135 ,
( V_66 -> V_75 != V_155 ) ) ;
return V_77 ;
}
static int F_93 ( struct V_156 * V_67 ,
struct V_66 * V_66 ,
struct V_157 V_158 [] ,
struct V_74 * V_159 )
{
...
if ( V_134 )
F_95 ( V_134 ) ;
V_134 = F_96 ( V_42 [ V_43 / V_169 ] -> V_3 ) ;
}
V_10 = V_43 % V_169 ;
V_66 -> V_134 [ V_43 ] -> V_34 = V_134 [ V_10 ] . V_34 ;
V_167 = F_97 ( V_134 [ V_10 ] . V_167 ) ;
V_168 = F_97 ( V_134 [ V_10 ] . V_168 ) ;
...
V_129 = V_186 ;
F_79 ( V_2 , V_67 -> V_165 . V_176 . V_128 , V_67 -> V_75 , V_129 ) ;
F_82 ( V_19 ) ;
return V_89 ;
}
...
{
F_46 ( V_2 , V_66 ) ;
F_79 ( V_2 , V_67 -> V_165 . V_187 . V_128 , V_67 -> V_75 ,
V_185 ) ;
return - V_188 ;
}
...
static void F_105 ( struct V_66 * V_66 ,
T_7 error )
{
if ( V_66 -> V_75 == V_190 &&
error == V_191 ) {
F_42 ( L_27 ) ;
F_106 ( V_192 , V_66 -> V_2 -> V_19 -> V_91 , 0 ) ;
V_66 -> V_129 = V_185 ;
} else if ( V_66 -> V_75 == V_193 &&
error == V_191 ) {
F_42 ( L_28 ) ;
F_107 ( V_192 , V_66 -> V_2 -> V_19 -> V_91 , 0 ) ;
V_66 -> V_129 = V_185 ;
} else if ( error ) {
F_42 ( L_29
L_30 , error ) ;
...
static void F_108 ( struct V_195 * V_195 )
{
F_105 ( V_195 -> V_196 , V_195 -> V_197 ) ;
F_109 ( V_195 ) ;
}
static int
...
T_8 V_77 , V_200 ;
int V_201 = 0 ;
V_77 = V_199 -> V_202 . V_203 ;
V_200 = V_199 -> V_202 . V_204 -> V_205 ;
F_111 () ;
if ( F_112 ( & V_199 -> V_202 , V_200 ) ) {
V_77 = V_199 -> V_202 . V_206 ;
F_58 ( L_31 ,
V_200 , V_77 , V_200 - V_77 , V_2 -> V_19 -> V_22 . V_85 ) ;
return - V_78 ;
}
while ( V_77 != V_200 ) {
if ( F_113 ( & V_199 -> V_202 , V_77 ) )
break;
if ( F_67 () ) {
V_201 = 1 ;
break;
...
switch ( V_2 -> V_19 -> V_207 ) {
case V_208 :
memcpy ( & V_67 , F_114 ( & V_199 -> V_209 , V_77 ) , sizeof( V_67 ) ) ;
break;
case V_210 :
F_115 ( & V_67 , F_114 ( & V_199 -> V_211 , V_77 ) ) ;
break;
case V_212 :
F_116 ( & V_67 , F_114 ( & V_199 -> V_213 , V_77 ) ) ;
break;
default:
F_117 () ;
}
V_199 -> V_202 . V_203 = ++ V_77 ;
F_118 () ;
switch ( V_67 . V_75 ) {
case V_155 :
case V_214 :
...
V_222 = V_67 -> V_75 == V_215 ?
V_67 -> V_165 . V_166 . V_223 : V_67 -> V_75 ;
if ( ( V_67 -> V_75 == V_215 ) &&
( V_222 != V_155 ) &&
( V_222 != V_214 ) ) {
F_42 ( L_32 , V_222 ) ;
...
V_162 = V_67 -> V_75 == V_215 ?
V_67 -> V_165 . V_166 . V_227 : V_67 -> V_165 . V_228 . V_227 ;
if ( F_50 ( V_162 == 0 && V_219 != V_226 ) ||
F_50 ( ( V_67 -> V_75 != V_215 ) &&
( V_162 > V_41 ) ) ||
F_50 ( ( V_67 -> V_75 == V_215 ) &&
( V_162 > V_229 ) ) ) {
F_42 ( L_33 , V_162 ) ;
...
V_159 . V_81 = 0 ;
V_66 -> V_2 = V_2 ;
V_66 -> V_128 = V_67 -> V_165 . V_228 . V_128 ;
V_66 -> V_75 = V_222 ;
V_66 -> V_129 = V_173 ;
V_66 -> V_135 = V_162 ;
if ( V_67 -> V_75 != V_215 ) {
V_159 . V_84 = V_67 -> V_165 . V_228 . V_49 ;
V_159 . V_83 = V_67 -> V_165 . V_228 . V_83 ;
for ( V_10 = 0 ; V_10 < V_162 ; V_10 ++ ) {
V_42 [ V_10 ] -> V_34 = V_67 -> V_165 . V_228 . V_158 [ V_10 ] . V_34 ;
V_158 [ V_10 ] . V_171 = V_67 -> V_165 . V_228 . V_158 [ V_10 ] . V_168 -
V_67 -> V_165 . V_228 . V_158 [ V_10 ] . V_167 + 1 ;
V_158 [ V_10 ] . V_172 = ( V_67 -> V_165 . V_228 . V_158 [ V_10 ] . V_167 << 9 ) ;
if ( ( V_67 -> V_165 . V_228 . V_158 [ V_10 ] . V_168 >= ( V_170 >> 9 ) ) ||
( V_67 -> V_165 . V_228 . V_158 [ V_10 ] . V_168 <
V_67 -> V_165 . V_228 . V_158 [ V_10 ] . V_167 ) )
goto V_179;
...
V_158 [ V_10 ] . V_171 << 9 ,
V_158 [ V_10 ] . V_172 ) == 0 ) ) {
int V_231 = F_124 ( int , ( V_162 - V_10 ) , V_232 ) ;
V_195 = F_125 ( V_151 , V_231 ) ;
if ( F_50 ( V_195 == NULL ) )
goto V_233;
V_217 [ V_218 ++ ] = V_195 ;
V_195 -> V_234 = V_159 . V_86 ;
V_195 -> V_196 = V_66 ;
V_195 -> V_235 = F_108 ;
V_195 -> V_236 . V_237 = V_159 . V_83 ;
F_126 ( V_195 , V_75 , V_219 ) ;
}
...
V_2 -> V_239 += V_159 . V_81 ;
return 0 ;
V_230:
F_85 ( V_2 , V_66 -> V_134 ,
V_66 -> V_135 ) ;
V_179:
F_79 ( V_2 , V_67 -> V_165 . V_228 . V_128 , V_222 , V_186 ) ;
F_46 ( V_2 , V_66 ) ;
F_130 ( 1 ) ;
return - V_188 ;
V_233:
...
static void F_79 ( struct V_1 * V_2 , T_9 V_128 ,
unsigned short V_241 , int V_242 )
{
struct V_243 * V_244 ;
unsigned long V_4 ;
union V_198 * V_199 ;
...
switch ( V_2 -> V_19 -> V_207 ) {
case V_208 :
V_244 = F_131 ( & V_199 -> V_209 ,
V_199 -> V_209 . V_206 ) ;
break;
case V_210 :
V_244 = F_131 ( & V_199 -> V_211 ,
V_199 -> V_211 . V_206 ) ;
break;
case V_212 :
V_244 = F_131 ( & V_199 -> V_213 ,
V_199 -> V_213 . V_206 ) ;
break;
default:
F_117 () ;
