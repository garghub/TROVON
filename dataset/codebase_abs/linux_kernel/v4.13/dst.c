...
F_35 ( F_36 ( struct V_51 , V_17 ) != 0 ) ;
return ( T_1 * ) V_52 ;
}
void F_37 ( struct V_6 * V_7 , unsigned long V_50 )
{
unsigned long V_54 , V_55 ;
...
static int F_38 ( struct V_1 * V_1 , struct V_2 * V_3 , struct V_4 * V_5 )
{
F_39 ( 1 , L_2 ) ;
F_2 ( V_5 ) ;
return 0 ;
...
static void F_41 ( struct V_42 * V_60 ,
...
struct V_42 * F_42 ( T_2 V_62 , enum V_61 type ,
T_3 V_14 )
{
struct V_42 * V_60 ;
...
{
#ifdef F_43
F_44 ( & V_60 -> V_65 . V_66 . V_67 ) ;
#endif
F_33 ( V_60 ) ;
}
struct V_42 T_4 *
F_45 ( T_2 V_62 , enum V_61 type , T_3 V_14 )
{
int V_68 ;
struct V_42 T_4 * V_60 ;
V_60 = F_46 ( sizeof( struct V_42 ) + V_62 ,
F_47 ( struct V_42 ) , V_14 ) ;
if ( ! V_60 )
return NULL ;
F_48 (cpu)
F_41 ( F_49 ( V_60 , V_68 ) , type , V_62 ) ;
return V_60 ;
}
