...
static struct V_9 * T_2
F_18 ( struct V_42 * V_43 , const char * V_44 ,
const char * V_45 , unsigned long V_46 ,
bool V_13 ,
...
static void T_2 F_24 ( struct V_56 * V_57 )
{
struct V_9 * V_10 = F_21 ( - V_40 ) ;
const char * V_58 = V_57 -> V_44 ;
const char * V_45 ;
void T_3 * V_5 ;
void T_3 * V_17 ;
T_5 V_59 ;
T_5 V_60 ;
int V_61 ;
if ( F_25 ( V_57 , L_2 , & V_59 ) ) {
F_20 ( L_3 ,
V_62 , V_58 ) ;
return;
}
if ( F_25 ( V_57 , L_4 , & V_60 ) ) {
F_20 ( L_5 ,
V_62 , V_58 ) ;
return;
}
...
static struct V_9 * T_2
F_36 ( struct V_42 * V_43 , const char * V_44 ,
const char * V_45 , bool V_79 )
{
struct V_9 * V_10 ;
struct V_77 * V_78 ;
struct V_47 V_48 ;
...
const char * V_45 ;
V_45 = F_26 ( V_57 , 0 ) ;
V_10 = F_36 ( NULL , V_58 , V_45 , false ) ;
if ( ! F_28 ( V_10 ) )
F_29 ( V_57 , V_76 , V_10 ) ;
}
