...
V_194 -> V_34 )
V_214 = F_87 ( int , V_194 -> V_42 , V_211 ) ;
else
V_214 = V_211 ;
...
F_86 ( V_28 , V_194 ,
V_15 -> V_94 ) )
F_95 ( V_28 , V_194 , V_129 , V_32 ) ;
else
F_88 ( V_28 , V_194 , V_129 , V_32 ) ;
} else {
...
V_137 = F_68 ( V_111 ) ;
V_226 . V_229 = 0 ;
if ( F_104 ( V_28 , V_111 , & V_226 ) == - V_230 ) {
