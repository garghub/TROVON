...
V_147 -> V_148 . V_151 ) ) ;
F_44 ( & V_72 ) ;
V_105 -> V_119 = F_91 ( V_147 -> V_148 . V_121 . V_122 -
V_147 -> V_152 ) ;
V_105 -> V_120 = F_91 ( V_147 -> V_148 . V_121 . V_123 -
V_147 -> V_153 ) ;
F_46 ( & V_72 ) ;
F_93 (
( unsigned long long ) F_66 ( V_105 -> V_119 ) ,
( unsigned long long ) F_66 ( V_105 -> V_120 ) ,
F_92 ( & V_112 , V_147 -> V_148 . V_151 ) ) ;
}
int F_94 ( struct V_106 * V_106 )
{
struct V_1 * V_2 = V_106 -> V_149 ;
struct V_146 * V_147 = F_95 ( V_106 ) ;
struct V_12 * V_13 ;
struct V_11 * V_86 = F_29 ( V_2 ) -> V_39 [ V_106 -> V_151 . type ] ;
int V_17 ;
V_17 = F_96 ( V_86 , V_147 -> V_154 ,
& V_13 ) ;
if ( V_17 ) {
F_16 ( V_17 ) ;
goto V_101;
}
V_17 = F_10 ( V_86 , V_13 , F_90 , V_147 ) ;
if ( V_17 < 0 ) {
F_16 ( V_17 ) ;
goto V_101;
}
...
V_157 = F_103 ( V_2 , V_158 ) ;
if ( ! V_157 ) {
V_17 = - V_64 ;
F_16 ( V_17 ) ;
goto V_132;
}
F_104 ( F_18 ( V_86 ) , V_157 ) ;
...
V_76 -> V_65 = F_105 ( V_76 -> V_55 . V_160 ,
struct V_52 ,
V_55 ) -> V_65 + 1 ;
V_76 -> V_56 = V_13 ;
* V_155 = 0 ;
...
T_2 * V_16 ;
if ( F_79 ( & V_69 -> V_137 ) )
return F_99 ( V_2 , type , V_155 ) ;
V_76 = F_105 ( V_69 -> V_137 . V_160 ,
struct V_52 , V_55 ) ;
V_161 = V_69 -> V_74 -
F_4 ( V_2 , V_76 -> V_65 ) - 1 ;
if ( F_2 ( V_2 ) == V_161 )
...
int V_17 ;
T_3 V_162 ;
F_110 ( & F_26 ( V_86 ) -> V_163 ) ;
V_76 = F_97 ( V_2 , type , & V_155 ) ;
if ( ! V_76 ) {
V_76 = F_106 ( V_2 , type , & V_155 ) ;
if ( F_14 ( V_76 ) ) {
V_17 = F_15 ( V_76 ) ;
goto V_101;
}
...
V_101:
F_111 ( & F_26 ( V_86 ) -> V_163 ) ;
return V_17 ;
}
int F_112 ( T_2 * V_16 , struct V_106 * V_106 )
{
int V_17 ;
int type = V_106 -> V_151 . type ;
struct V_146 * V_147 = F_95 ( V_106 ) ;
