...
F_19 ( V_7 ) ;
F_19 ( V_7 ) ;
F_23 ( V_7 -> V_29 , V_31 , V_32 ,
V_32 , V_33 ) ;
F_24 ( V_7 -> V_29 ) ;
F_25 ( V_7 -> V_29 , V_7 -> V_23 -> V_34 ,
V_7 -> V_7 -> V_35 . V_36 ) ;
F_26 ( & V_7 -> V_37 , V_7 -> V_29 ) ;
V_7 -> V_29 = NULL ;
}
static void F_27 ( struct V_6 * V_7 )
{
struct V_19 * V_20 ;
while ( ( V_20 = F_28 ( & V_7 -> V_37 ) ) )
F_29 ( V_20 ) ;
}
static int F_30 ( struct V_6 * V_7 , T_1 V_38 )
{
struct V_39 * V_40 ;
if ( F_20 ( V_7 -> V_29 ) < sizeof( * V_40 ) )
return - 1 ;
V_40 = F_17 ( V_7 -> V_29 , sizeof( * V_40 ) ) ;
V_40 -> V_38 = V_38 ;
F_31 ( V_7 -> V_29 ) -> V_41 = V_38 ;
return 0 ;
}
...
if ( F_31 ( V_7 -> V_29 ) -> V_41 != V_2 -> type ) {
if ( F_31 ( V_7 -> V_29 ) -> V_41 &&
F_19 ( V_7 ) < 0 )
goto V_37;
...
int F_34 ( const struct V_58 * V_23 ,
const struct V_59 * V_60 ,
const void * V_3 , T_1 V_4 , T_1 type )
{
struct V_61 * V_62 = F_35 ( V_23 -> V_61 ) ;
struct V_6 * V_7 = F_35 ( V_62 -> V_63 [ V_60 -> type ] ) ;
struct V_1 * V_2 ;
F_36 ( & V_7 -> V_64 ) ;
...
void F_38 ( const struct V_58 * V_23 ,
const struct V_59 * V_60 ,
const void * V_3 , T_1 V_4 , T_1 type )
{
struct V_61 * V_62 = F_35 ( V_23 -> V_61 ) ;
...
static void F_39 ( struct V_6 * V_7 , enum V_48 V_43 )
{
struct V_8 * V_12 , * V_67 ;
struct V_1 * V_2 ;
for ( V_12 = F_40 ( & V_7 -> V_10 ) ;
V_67 = V_12 ? F_41 ( V_12 ) : NULL , V_12 != NULL ;
V_12 = V_67 ) {
...
{
unsigned long V_68 ;
V_68 = ( V_69 ) F_43 ( V_70 ) * F_44 () >> 32 ;
F_45 ( & V_7 -> V_71 , V_72 + V_68 ) ;
}
...
{
if ( ! F_50 ( V_20 , sizeof( T_1 ) ) )
return - 1 ;
if ( * V_20 -> V_3 == V_30 ) {
F_51 ( V_20 , sizeof( T_1 ) ) ;
return - 1 ;
}
return 0 ;
}
...
static int F_53 ( struct V_6 * V_7 , struct V_19 * V_20 )
{
const struct V_39 * V_40 ;
if ( ! F_50 ( V_20 , sizeof( * V_40 ) ) )
return - 1 ;
V_40 = (struct V_39 * ) V_20 -> V_3 ;
if ( V_40 -> V_38 == 0 )
return - 1 ;
F_51 ( V_20 , sizeof( * V_40 ) ) ;
while ( V_20 -> V_4 > 0 ) {
if ( F_52 ( V_7 , V_20 , V_40 -> V_38 ) < 0 )
return - 1 ;
if ( F_49 ( V_20 ) < 0 )
break;
}
...
static void F_54 ( const struct V_82 * V_35 , struct V_19 * V_20 ,
struct V_58 * V_23 )
{
...
if ( ! V_62 )
goto V_46;
V_7 = F_55 ( V_62 -> V_63 [ V_60 -> type ] ) ;
if ( ! V_7 )
goto V_46;
if ( ! F_50 ( V_20 , sizeof( * V_22 ) ) )
goto V_46;
V_22 = (struct V_21 * ) V_20 -> V_3 ;
if ( F_56 ( & V_22 -> V_26 ) != F_15 ( V_28 ) )
goto V_46;
F_51 ( V_20 , sizeof( * V_22 ) ) ;
F_47 ( & V_7 -> V_64 ) ;
while ( V_20 -> V_4 > 0 ) {
if ( F_53 ( V_7 , V_20 ) < 0 )
break;
...
static int F_58 ( struct V_58 * V_23 )
{
struct V_61 * V_62 ;
V_62 = F_59 ( sizeof( * V_62 ) , V_83 ) ;
if ( ! V_62 )
return - V_25 ;
F_60 ( V_23 -> V_61 , V_62 ) ;
return 0 ;
}
static void F_61 ( struct V_58 * V_23 )
{
struct V_61 * V_62 = F_35 ( V_23 -> V_61 ) ;
unsigned int V_84 ;
for ( V_84 = 0 ; V_84 <= V_85 ; V_84 ++ ) {
if ( F_35 ( V_62 -> V_63 [ V_84 ] ) )
return;
}
F_62 ( V_23 -> V_61 , NULL ) ;
F_63 ( V_62 , V_86 ) ;
}
int F_64 ( struct V_58 * V_23 , struct V_59 * V_60 )
{
struct V_6 * V_7 ;
int V_46 ;
F_65 () ;
...
V_46 = - V_25 ;
V_7 = F_59 ( sizeof( * V_7 ) , V_83 ) ;
if ( ! V_7 )
goto V_88;
V_46 = F_66 ( V_23 , V_60 -> V_35 . V_36 ) ;
if ( V_46 < 0 )
goto V_89;
V_7 -> V_23 = V_23 ;
V_7 -> V_7 = V_60 ;
...
F_67 ( & V_7 -> V_64 ) ;
F_68 ( & V_7 -> V_37 ) ;
F_60 ( V_23 -> V_61 -> V_63 [ V_60 -> type ] , V_7 ) ;
F_69 ( & V_7 -> V_71 , F_46 , ( unsigned long ) V_7 ) ;
F_42 ( V_7 ) ;
return 0 ;
V_89:
F_10 ( V_7 ) ;
...
void F_70 ( struct V_58 * V_23 , struct V_59 * V_60 )
{
struct V_61 * V_62 = F_35 ( V_23 -> V_61 ) ;
struct V_6 * V_7 = F_35 ( V_62 -> V_63 [ V_60 -> type ] ) ;
F_65 () ;
F_62 ( V_62 -> V_63 [ V_60 -> type ] , NULL ) ;
F_71 ( & V_7 -> V_71 ) ;
F_36 ( & V_7 -> V_64 ) ;
F_39 ( V_7 , V_73 ) ;
F_22 ( V_7 ) ;
...
V_60 -> V_35 . V_91 = F_54 ;
V_60 -> V_35 . V_3 = V_60 ;
return F_74 ( & V_60 -> V_35 ) ;
}
void F_75 ( struct V_59 * V_60 )
{
F_76 ( & V_60 -> V_35 ) ;
}
