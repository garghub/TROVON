...
static unsigned long F_62 ( T_6 V_63 )
{
unsigned long V_64 = F_63 ( V_63 ) ;
return F_64 ( V_64 ) ;
}
static unsigned long F_65 ( T_6 V_63 )
{
unsigned long V_65 = F_63 ( V_66 ) ;
unsigned long V_64 = F_63 ( V_63 ) ;
V_65 += V_64 - F_64 ( V_64 ) ;
return V_65 ;
}
static struct V_67 * F_66 ( struct V_5 * V_5 ,
struct V_68 * V_37 , struct V_67 * V_69 )
{
struct V_29 * V_30 = V_5 -> V_30 ;
...
if ( V_31 < V_66 )
return F_67 ( - V_24 ) ;
V_5 -> V_72 = F_50 ( V_30 -> V_72 ) ;
V_69 = NULL ;
} else if ( V_5 -> V_15 == V_17 ) {
V_5 -> V_72 = F_68 ( ( F_35 ( V_37 )
- V_31 ) / V_27 ) ;
if ( F_50 ( V_5 -> V_30 -> V_72 ) > V_5 -> V_72 )
F_69 ( & V_5 -> V_2 ,
L_24 ,
F_50 ( V_5 -> V_30 -> V_72 ) ,
V_5 -> V_72 ) ;
memcpy ( V_69 , & V_70 , sizeof( * V_69 ) ) ;
V_69 -> free = F_63 ( V_31 - V_66 ) ;
V_69 -> V_73 = 0 ;
} else
return F_67 ( - V_39 ) ;
return V_69 ;
...
V_76 = F_35 ( & V_36 -> V_37 ) ;
if ( F_73 ( V_38 , V_76 , V_79 ,
V_80 ) == V_81 ) {
V_38 = V_36 -> V_37 . V_38 ;
V_34 = F_74 ( V_38 ) - V_38 ;
}
V_38 = V_36 -> V_37 . V_38 ;
V_76 = F_74 ( V_38 + V_76 ) - V_38 ;
if ( F_73 ( V_38 , V_76 , V_79 ,
V_80 ) == V_81 ) {
V_76 = F_35 ( & V_36 -> V_37 ) ;
V_40 = V_38 + V_76 - F_72 ( V_38 + V_76 ) ;
}
if ( V_34 + V_40 )
F_69 ( & V_5 -> V_2 , L_26 ,
...
V_38 += V_34 ;
V_76 = F_35 ( & V_36 -> V_37 ) ;
V_72 = F_68 ( ( V_76 - V_34 - V_40 - V_66 )
/ V_27 ) ;
if ( V_5 -> V_15 == V_17 ) {
V_31 = F_75 ( V_38 + V_66 + 64 * V_72 + V_74 ,
F_76 ( V_5 -> V_25 , V_41 ) ) - V_38 ;
} else if ( V_5 -> V_15 == V_16 )
V_31 = F_75 ( V_38 + V_66 + V_74 ,
V_5 -> V_25 ) - V_38 ;
else
return - V_39 ;
if ( V_31 + V_34 + V_40 >= V_76 ) {
F_57 ( & V_5 -> V_2 , L_27 ,
F_27 ( & V_7 -> V_2 ) ) ;
return - V_39 ;
}
V_72 = ( V_76 - V_31 - V_34 - V_40 ) / V_51 ;
...
struct V_67 * F_80 ( struct V_5 * V_5 ,
struct V_68 * V_37 , struct V_67 * V_69 )
{
int V_19 ;
if ( ! V_5 -> V_10 || ! V_5 -> V_7 )
