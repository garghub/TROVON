...
int F_50 ( struct V_2 * V_2 , struct V_44 * V_45 ,
...
if ( ! V_70 )
return 0 ;
V_85 = F_51 ( V_70 -> V_86 - F_52 ( V_45 ) ) ;
if ( ( V_85 > 0 ) && F_53 ( V_45 , V_85 , 0 , V_55 ) ) {
F_54 ( V_45 ) ;
return 0 ;
}
F_55 ( V_45 ) ;
V_45 -> V_70 = V_70 ;
V_45 -> V_87 = F_45 ( V_74 ) ;
F_56 ( V_45 , V_70 , V_74 , V_37 -> V_22 ,
V_70 -> V_83 , V_45 -> V_13 ) ;
F_57 ( V_45 ) ;
return 0 ;
}
bool F_58 ( struct V_2 * V_2 , T_1 V_3 )
{
bool V_88 = false ;
struct V_1 * V_34 ;
F_13 () ;
...
int F_59 ( struct V_2 * V_2 , T_1 V_3 )
{
int V_80 = 0 ;
struct V_1 * V_34 ;
F_13 () ;
...
struct V_14 * V_37 )
{
struct V_89 * V_90 = F_60 ( V_45 ) ;
struct V_1 * V_34 ;
F_13 () ;
V_34 = F_1 ( V_2 , V_3 ) ;
if ( F_61 ( V_34 && ( F_62 ( 0 , & V_34 -> V_64 ) || F_63 ( V_90 ) ) ) )
V_34 -> V_57 -> V_91 ( V_2 , V_45 , V_34 , V_37 ) ;
else
F_54 ( V_45 ) ;
F_15 () ;
}
void F_64 ( struct V_2 * V_2 , T_1 V_3 ,
struct V_92 * V_93 ,
struct V_14 * V_94 )
{
struct V_1 * V_34 ;
...
F_68 (xmitq, skb, tmp) {
F_69 ( V_93 ) ;
if ( F_61 ( F_62 ( 0 , & V_34 -> V_64 ) || F_63 ( F_60 ( V_45 ) ) ) )
...
void F_70 ( struct V_2 * V_2 , T_1 V_3 ,
struct V_92 * V_93 )
{
struct V_4 * V_5 = V_4 ( V_2 ) ;
int V_96 = V_5 -> V_96 ;
...
V_34 = F_2 ( V_70 -> V_84 ) ? :
F_2 ( V_98 -> V_84 ) ;
if ( F_61 ( V_34 && F_62 ( 0 , & V_34 -> V_64 ) &&
( V_45 -> V_99 <= V_100 ) ) ) {
V_45 -> V_101 = NULL ;
F_73 ( F_74 ( V_34 -> V_73 . V_70 ) , V_45 , V_34 ) ;
F_15 () ;
return V_102 ;
}
F_15 () ;
...
static int F_75 ( struct V_104 * V_105 , unsigned long V_106 ,
void * V_107 )
{
struct V_69 * V_70 = F_76 ( V_107 ) ;
struct V_2 * V_2 = F_74 ( V_70 ) ;
struct V_1 * V_34 ;
V_34 = F_10 ( V_70 -> V_84 ) ;
if ( ! V_34 )
return V_108 ;
...
struct V_41 * V_122 ;
struct V_41 * V_123 ;
V_90 = F_84 ( V_119 -> V_45 , V_119 -> V_124 , V_119 -> V_125 , & V_126 ,
V_121 , V_127 ) ;
if ( ! V_90 )
return - V_128 ;
V_122 = F_85 ( V_119 -> V_45 , V_129 ) ;
if ( ! V_122 )
goto V_130;
if ( F_86 ( V_119 -> V_45 , V_131 , V_120 -> V_8 ) )
goto V_132;
V_123 = F_85 ( V_119 -> V_45 , V_133 ) ;
if ( ! V_123 )
goto V_134;
if ( F_87 ( V_119 -> V_45 , V_135 , V_120 -> V_40 ) )
goto V_134;
if ( F_87 ( V_119 -> V_45 , V_136 , V_120 -> V_60 ) )
goto V_134;
if ( F_87 ( V_119 -> V_45 , V_137 , V_120 -> V_61 ) )
goto V_134;
F_88 ( V_119 -> V_45 , V_123 ) ;
#ifdef F_89
...
#endif
F_88 ( V_119 -> V_45 , V_122 ) ;
F_91 ( V_119 -> V_45 , V_90 ) ;
return 0 ;
V_134:
F_92 ( V_119 -> V_45 , V_123 ) ;
V_132:
F_92 ( V_119 -> V_45 , V_122 ) ;
V_130:
F_93 ( V_119 -> V_45 , V_90 ) ;
return - V_128 ;
}
int F_94 ( struct V_44 * V_45 , struct V_139 * V_140 )
{
int V_141 ;
int V_9 = V_140 -> args [ 0 ] ;
struct V_1 * V_120 ;
struct V_118 V_119 ;
struct V_2 * V_2 = F_95 ( V_45 -> V_142 ) ;
struct V_4 * V_5 = F_9 ( V_2 , V_33 ) ;
if ( V_9 == V_35 )
return 0 ;
V_119 . V_45 = V_45 ;
V_119 . V_124 = F_96 ( V_140 -> V_45 ) . V_124 ;
...
int F_99 ( struct V_44 * V_45 , struct V_146 * V_147 )
{
int V_141 ;
char * V_8 ;
struct V_44 * V_148 ;
...
struct V_2 * V_2 = F_100 ( V_147 ) ;
if ( ! V_147 -> V_122 [ V_129 ] )
return - V_36 ;
V_141 = F_101 ( V_122 , V_149 ,
V_147 -> V_122 [ V_129 ] ,
V_150 , V_147 -> V_151 ) ;
if ( V_141 )
return V_141 ;
if ( ! V_122 [ V_131 ] )
return - V_36 ;
V_8 = F_102 ( V_122 [ V_131 ] ) ;
V_148 = F_103 ( V_152 , V_153 ) ;
if ( ! V_148 )
return - V_56 ;
V_119 . V_45 = V_148 ;
...
V_141 = F_83 ( & V_119 , V_120 , 0 ) ;
if ( V_141 )
goto V_156;
F_98 () ;
return F_104 ( V_148 , V_147 ) ;
V_156:
F_98 () ;
F_105 ( V_148 ) ;
return V_141 ;
...
int F_107 ( struct V_44 * V_45 , struct V_146 * V_147 )
{
int V_141 ;
char * V_120 ;
struct V_41 * V_122 [ V_149 + 1 ] ;
...
if ( ! V_122 [ V_131 ] )
return - V_36 ;
V_120 = F_102 ( V_122 [ V_131 ] ) ;
if ( V_122 [ V_158 ] )
V_62 = F_108 ( V_122 [ V_158 ] ) ;
if ( V_122 [ V_133 ] ) {
struct V_41 * V_159 [ V_160 + 1 ] ;
V_141 = F_109 ( V_122 [ V_133 ] ,
V_159 ) ;
if ( V_141 )
return V_141 ;
if ( V_159 [ V_135 ] )
V_157 = F_108 ( V_159 [ V_135 ] ) ;
}
F_97 () ;
...
int F_110 ( struct V_44 * V_45 , struct V_146 * V_147 )
{
int V_141 ;
char * V_8 ;
struct V_1 * V_34 ;
...
int F_112 ( struct V_44 * V_45 , struct V_146 * V_147 )
{
int V_141 ;
char * V_8 ;
struct V_1 * V_34 ;
...
if ( V_159 [ V_136 ] )
V_34 -> V_60 = F_108 ( V_159 [ V_136 ] ) ;
if ( V_159 [ V_135 ] )
V_34 -> V_40 = F_108 ( V_159 [ V_135 ] ) ;
if ( V_159 [ V_137 ] )
V_34 -> V_61 = F_108 ( V_159 [ V_137 ] ) ;
}
F_98 () ;
return 0 ;
}
...
if ( ! V_90 )
return - V_128 ;
V_122 = F_85 ( V_119 -> V_45 , V_163 ) ;
if ( ! V_122 )
goto V_130;
if ( F_86 ( V_119 -> V_45 , V_164 , V_57 -> V_8 ) )
goto V_132;
V_123 = F_85 ( V_119 -> V_45 , V_165 ) ;
if ( ! V_123 )
goto V_134;
if ( F_87 ( V_119 -> V_45 , V_135 , V_57 -> V_40 ) )
goto V_134;
if ( F_87 ( V_119 -> V_45 , V_136 , V_57 -> V_60 ) )
goto V_134;
if ( F_87 ( V_119 -> V_45 , V_137 , V_57 -> V_61 ) )
goto V_134;
F_88 ( V_119 -> V_45 , V_123 ) ;
F_88 ( V_119 -> V_45 , V_122 ) ;
F_91 ( V_119 -> V_45 , V_90 ) ;
...
int F_114 ( struct V_44 * V_45 , struct V_139 * V_140 )
{
int V_141 ;
int V_9 = V_140 -> args [ 0 ] ;
struct V_118 V_119 ;
...
int F_116 ( struct V_44 * V_45 , struct V_146 * V_147 )
{
int V_141 ;
char * V_8 ;
struct V_7 * V_18 ;
...
if ( V_159 [ V_136 ] )
V_18 -> V_60 = F_108 ( V_159 [ V_136 ] ) ;
if ( V_159 [ V_135 ] )
V_18 -> V_40 = F_108 ( V_159 [ V_135 ] ) ;
if ( V_159 [ V_137 ] )
V_18 -> V_61 = F_108 ( V_159 [ V_137 ] ) ;
}
F_98 () ;
return 0 ;
}
