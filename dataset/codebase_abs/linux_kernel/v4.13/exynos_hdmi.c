...
static void F_94 ( struct V_271 * V_272 )
{
struct V_1 * V_8 ;
V_8 = F_2 ( V_272 , struct V_1 , V_270 . V_272 ) ;
if ( V_8 -> V_86 )
F_95 ( V_8 -> V_86 ) ;
}
static T_3 F_96 ( int V_273 , void * V_274 )
{
struct V_1 * V_8 = V_274 ;
F_97 ( V_275 , & V_8 -> V_270 ,
F_98 ( V_276 ) ) ;
return V_277 ;
}
...
struct V_33 * V_30 = V_8 -> V_30 ;
int V_26 ;
for ( V_26 = 0 ; V_26 < V_279 -> V_29 ; ++ V_26 ) {
struct V_35 * V_35 = F_100 ( V_30 , V_279 -> V_31 [ V_26 ] ) ;
if ( F_101 ( V_35 ) ) {
int V_25 = F_102 ( V_35 ) ;
F_16 ( V_30 , L_22 ,
V_279 -> V_31 [ V_26 ] , V_25 ) ;
return V_25 ;
}
V_280 [ V_26 ] = V_35 ;
}
...
{
const struct V_281 * V_12 = V_8 -> V_12 ;
...
if ( ! V_29 )
return 0 ;
V_280 = F_104 ( V_30 , sizeof( * V_280 ) * V_29 , V_282 ) ;
if ( ! V_280 )
return - V_283 ;
V_8 -> V_28 = V_280 ;
V_8 -> V_34 = V_280 + V_12 -> V_28 . V_29 ;
V_25 = F_99 ( V_8 , & V_12 -> V_28 , V_8 -> V_28 ) ;
if ( V_25 )
return V_25 ;
return F_99 ( V_8 , & V_12 -> V_34 , V_8 -> V_34 ) ;
}
static void F_105 ( struct V_284 * V_35 , bool V_251 )
{
...
int V_26 , V_25 ;
F_39 ( L_24 ) ;
V_8 -> V_60 = F_112 ( V_30 , L_25 , V_291 ) ;
if ( F_101 ( V_8 -> V_60 ) ) {
F_48 ( L_26 ) ;
return F_102 ( V_8 -> V_60 ) ;
}
V_8 -> V_273 = F_113 ( V_8 -> V_60 ) ;
if ( V_8 -> V_273 < 0 ) {
F_48 ( L_27 ) ;
return V_8 -> V_273 ;
}
...
V_8 -> V_292 = F_115 ( V_30 , L_29 ) ;
if ( F_102 ( V_8 -> V_292 ) != - V_67 ) {
if ( F_101 ( V_8 -> V_292 ) )
return F_102 ( V_8 -> V_292 ) ;
V_25 = F_116 ( V_8 -> V_292 ) ;
if ( V_25 ) {
F_48 ( L_30 ) ;
return V_25 ;
}
...
static int F_117 ( struct V_33 * V_30 , struct V_33 * V_293 , void * V_31 )
{
...
if ( V_298 < 0 )
return V_298 ;
V_8 -> V_285 . V_251 = F_105 ;
V_297 = F_120 ( V_86 , V_298 ) ;
V_295 = F_121 ( V_297 ) ;
V_295 -> V_300 = & V_8 -> V_285 ;
V_4 -> V_301 = 1 << V_298 ;
F_39 ( L_31 , V_4 -> V_301 ) ;
F_122 ( V_86 , V_4 , & V_302 ,
V_303 , NULL ) ;
F_123 ( V_4 , & V_304 ) ;
V_25 = F_46 ( V_4 ) ;
if ( V_25 ) {
...
static void F_125 ( struct V_33 * V_30 , struct V_33 * V_293 , void * V_31 )
{
}
...
struct V_286 * V_288 ;
struct V_306 * V_307 ;
V_288 = F_127 ( NULL , NULL , V_305 ) ;
if ( V_288 )
V_288 = F_128 ( V_288 ) ;
else
V_288 = F_129 ( V_8 -> V_30 -> V_289 , L_34 , 0 ) ;
if ( ! V_288 ) {
F_48 ( L_35 ) ;
return - V_67 ;
}
...
V_288 = F_127 ( NULL , NULL , V_305 ) ;
if ( ! V_288 ) {
V_288 = F_129 ( V_8 -> V_30 -> V_289 , L_38 , 0 ) ;
if ( ! V_288 ) {
F_48 ( L_39 ) ;
return - V_67 ;
}
...
struct V_312 * V_313 ;
int V_25 ;
V_8 = F_104 ( V_30 , sizeof( struct V_1 ) , V_282 ) ;
if ( ! V_8 )
return - V_283 ;
V_8 -> V_12 = F_135 ( V_30 ) ;
F_136 ( V_311 , V_8 ) ;
...
V_313 = F_137 ( V_311 , V_314 , 0 ) ;
V_8 -> V_13 = F_138 ( V_30 , V_313 ) ;
if ( F_101 ( V_8 -> V_13 ) ) {
V_25 = F_102 ( V_8 -> V_13 ) ;
return V_25 ;
}
...
if ( V_25 )
goto V_315;
F_139 ( & V_8 -> V_270 , F_94 ) ;
V_25 = F_140 ( V_30 , V_8 -> V_273 , NULL ,
F_96 , V_316 |
V_317 | V_318 ,
L_43 , V_8 ) ;
if ( V_25 ) {
...
V_8 -> V_62 = F_142 ( & V_311 -> V_30 ) ;
if ( V_8 -> V_62 == NULL ) {
V_25 = - V_283 ;
goto V_319;
}
F_143 ( V_30 ) ;
V_25 = F_144 ( & V_311 -> V_30 , & V_321 ) ;
if ( V_25 )
goto V_322;
return V_25 ;
V_322:
...
{
struct V_1 * V_8 = F_150 ( V_311 ) ;
F_151 ( & V_8 -> V_270 ) ;
F_32 ( V_8 -> V_62 , V_63 ) ;
F_152 ( & V_311 -> V_30 , & V_321 ) ;
F_145 ( V_8 -> V_62 ) ;
F_146 ( & V_311 -> V_30 ) ;
if ( ! F_101 ( V_8 -> V_292 ) )
F_153 ( V_8 -> V_292 ) ;
...
static int T_4 F_154 ( struct V_33 * V_30 )
{
struct V_1 * V_8 = F_118 ( V_30 ) ;
F_18 ( V_8 ) ;
return 0 ;
}
static int T_4 F_155 ( struct V_33 * V_30 )
{
struct V_1 * V_8 = F_118 ( V_30 ) ;
int V_25 ;
V_25 = F_14 ( V_8 ) ;
