...
V_2 -> V_4 [ V_70 ] . V_93 . V_96 . V_97 . V_97 = F_37 ( V_73 ) ;
V_2 -> V_98 [ V_70 ] = & V_2 -> V_4 [ V_70 ] . V_93 ;
V_2 -> V_99 ++ ;
F_38 ( V_73 ) ;
return 0 ;
}
...
{
struct V_68 * V_100 = V_2 -> V_101 -> V_102 . V_103 ;
struct V_68 * V_104 , * V_105 ;
int V_70 = 0 ;
int V_42 ;
if ( ! V_2 -> V_106 )
return - V_43 ;
...
F_49 (parent, node) {
struct V_68 * V_69 ;
if ( F_45 ( V_104 -> V_90 , L_5 ) )
continue;
V_69 = F_35 ( V_104 , NULL ) ;
if ( ! V_69 )
continue;
...
V_105 = F_50 ( V_100 , L_6 ) ;
if ( ! V_105 )
goto V_107;
F_51 (ports, node) {
V_42 = F_34 ( V_2 , V_104 , V_70 ) ;
if ( V_42 < 0 ) {
F_38 ( V_104 ) ;
break;
}
...
static int F_58 ( struct V_1 * V_2 , struct V_115 * V_116 )
{
struct V_3 * V_17 ;
struct V_49 * V_50 ;
int V_42 ;
...
V_42 = F_57 ( & V_2 -> V_80 , V_17 ) ;
if ( ! V_42 ) {
if ( ! V_2 -> V_106 && V_116 -> V_101 )
V_2 -> V_106 = & V_116 -> V_101 -> V_102 ;
...
struct V_3 * V_17 )
{
struct V_68 * V_104 = V_101 -> V_102 . V_103 ;
int V_117 , V_42 ;
V_117 = V_104 ? F_53 ( V_104 ) : F_60 ( 0 , V_101 -> V_117 ) ;
...
static int F_61 ( struct V_1 * V_2 , struct V_124 * V_125 )
{
...
int V_127 )
{
struct V_128 * V_102 = & V_101 -> V_102 ;
int V_42 = - V_129 ;
void * V_130 ;
F_63 ( V_102 ) ;
if ( ! V_102 -> V_131 || ! F_64 ( V_102 -> V_131 -> V_132 ) )
goto V_133;
V_130 = F_65 ( V_102 ) ;
if ( V_130 ) {
switch ( V_127 ) {
...
F_66 ( V_102 -> V_131 -> V_132 ) ;
V_133:
F_67 ( V_102 ) ;
if ( V_42 == - V_129 )
F_68 ( & V_2 -> V_101 -> V_102 , L_13 ,
F_69 ( V_102 ) ) ;
else if ( V_42 < 0 )
F_70 ( & V_2 -> V_101 -> V_102 , L_14 ,
F_69 ( V_102 ) , V_42 ) ;
return V_42 ;
}
...
if ( ! V_101 )
continue;
if ( ! strcmp ( V_104 -> V_90 , V_134 ) )
V_127 = V_33 ;
else if ( ! strcmp ( V_104 -> V_90 , V_135 ) )
V_127 = V_39 ;
else if ( ! strcmp ( V_104 -> V_90 , V_136 ) )
V_127 = V_35 ;
else if ( ! strcmp ( V_104 -> V_90 , V_137 ) &&
! F_73 ( V_104 , L_15 ) )
V_127 = V_37 ;
if ( V_127 >= 0 )
V_42 = F_62 ( V_2 , V_101 ,
...
struct V_115 * V_102 = V_2 -> V_116 [ V_18 ] ;
if ( V_102 == NULL )
continue;
F_76 ( & V_102 -> V_119 . V_113 ) ;
V_102 -> V_119 . V_138 . V_139 = NULL ;
V_2 -> V_116 [ V_18 ] = NULL ;
}
for ( V_18 = 0 ; V_18 < V_111 ; V_18 ++ ) {
struct V_110 * V_102 = V_2 -> V_110 [ V_18 ] ;
if ( V_102 == NULL )
continue;
F_76 ( & V_102 -> V_113 ) ;
V_102 -> V_138 . V_139 = NULL ;
V_2 -> V_110 [ V_18 ] = NULL ;
}
for ( V_18 = 0 ; V_18 < V_121 ; V_18 ++ ) {
if ( V_2 -> V_123 [ V_18 ] . V_17 == NULL )
continue;
F_76 ( V_2 -> V_123 [ V_18 ] . V_17 ) ;
V_2 -> V_123 [ V_18 ] . V_17 = NULL ;
}
if ( V_2 -> V_124 )
F_76 ( & V_2 -> V_124 -> V_126 . V_113 ) ;
F_40 ( & V_2 -> V_80 , L_16 ) ;
}
...
V_42 = F_78 ( V_140 , V_22 , V_143 ,
V_147 , V_10 ) ;
if ( V_42 )
return V_42 ;
V_42 = F_79 ( V_143 , V_148 , & V_143 -> V_25 [ 0 ] ,
...
V_42 = F_78 ( V_140 , V_151 ,
V_143 , 0 , 0 ) ;
if ( V_42 )
break;
V_143 = & V_2 -> V_124 -> V_126 . V_113 . V_27 ;
V_42 = F_78 ( V_140 , V_152 ,
V_143 , 0 , 0 ) ;
if ( V_42 )
break;
}
...
continue;
F_85 ( V_2 -> V_166 [ V_18 ] . clock ) ;
V_2 -> V_166 [ V_18 ] . clock = F_86 ( - V_54 ) ;
}
...
{
struct V_128 * V_102 = & V_2 -> V_101 -> V_102 ;
char V_168 [ 32 ] ;
struct V_169 * clock ;
int V_18 , V_42 = 0 ;
...
V_2 -> V_166 [ V_18 ] . clock = F_86 ( - V_54 ) ;
for ( V_18 = 0 ; V_18 < V_165 ; V_18 ++ ) {
snprintf ( V_168 , sizeof( V_168 ) , L_23 , V_18 ) ;
clock = F_88 ( V_102 , V_168 ) ;
if ( F_18 ( clock ) ) {
F_70 ( V_102 , L_24 , V_168 ) ;
V_42 = F_89 ( clock ) ;
break;
}
...
if ( ! V_2 -> V_164 )
return 0 ;
V_2 -> V_51 [ V_170 ] = F_86 ( - V_54 ) ;
for ( V_18 = V_52 ; V_18 < V_167 ; V_18 ++ ) {
snprintf ( V_168 , sizeof( V_168 ) , L_25 , V_18 ) ;
clock = F_88 ( V_102 , V_168 ) ;
if ( F_18 ( clock ) ) {
F_43 ( & V_2 -> V_80 , L_24 ,
V_168 ) ;
...
static int F_90 ( struct V_15 * V_27 , bool V_171 )
{
struct V_172 * V_138 ;
struct V_13 * V_14 ;
struct V_173 * V_150 ;
...
static int F_93 ( struct V_15 * V_27 , bool V_171 ,
struct V_174 * V_175 )
{
struct V_15 * V_176 = V_27 ;
int V_42 ;
F_94 ( V_175 , V_27 ) ;
while ( ( V_27 = F_95 ( V_175 ) ) ) {
if ( ! F_96 ( V_27 ) )
continue;
V_42 = F_90 ( V_27 , V_171 ) ;
if ( V_42 < 0 )
goto V_177;
}
return 0 ;
...
static int F_97 ( struct V_178 * V_179 , unsigned int V_10 ,
unsigned int V_180 )
{
struct V_174 * V_175 =
& F_98 ( V_179 -> V_181 . V_182 , struct V_1 ,
V_183 ) -> V_184 ;
...
return V_42 ;
if ( ! ( V_10 & V_146 ) )
V_42 = F_93 ( V_143 , false , V_175 ) ;
#if 0
else
#endif
} else if ( V_180 == V_186 ) {
if ( V_179 -> V_10 & V_146 )
V_42 = F_93 ( V_143 , true , V_175 ) ;
F_100 ( V_175 ) ;
}
return V_42 ? - V_187 : 0 ;
}
static T_3 F_101 ( struct V_128 * V_102 ,
struct V_188 * V_189 , char * V_190 )
{
struct V_120 * V_101 = F_102 ( V_102 ) ;
struct V_1 * V_2 = F_103 ( V_101 ) ;
if ( V_2 -> V_58 )
return F_104 ( V_190 , L_26 , V_191 ) ;
return F_104 ( V_190 , L_27 , V_191 ) ;
}
static T_3 F_105 ( struct V_128 * V_102 ,
struct V_188 * V_189 ,
...
bool V_193 ;
int V_18 ;
if ( ! strcmp ( V_190 , L_28 ) )
V_193 = false ;
else if ( ! strcmp ( V_190 , L_29 ) )
V_193 = true ;
else
return V_192 ;
V_2 -> V_58 = V_193 ;
...
V_195 -> V_197 = F_107 ( V_102 ) ;
if ( F_18 ( V_195 -> V_197 ) )
return F_89 ( V_195 -> V_197 ) ;
V_195 -> V_198 = F_108 ( V_195 -> V_197 ,
V_199 ) ;
if ( F_18 ( V_195 -> V_198 ) )
return F_89 ( V_195 -> V_198 ) ;
V_195 -> V_200 = F_108 ( V_195 -> V_197 ,
V_201 ) ;
return 0 ;
}
static int F_109 ( struct V_202 * V_203 )
{
struct V_204 * V_166 = F_110 ( V_203 ) ;
int V_42 ;
if ( V_166 -> V_2 -> V_106 == NULL )
return - V_59 ;
V_42 = F_48 ( V_166 -> V_2 -> V_106 ) ;
return V_42 < 0 ? V_42 : 0 ;
}
static void F_111 ( struct V_202 * V_203 )
{
struct V_204 * V_166 = F_110 ( V_203 ) ;
if ( V_166 -> V_2 -> V_106 == NULL )
return;
F_112 ( V_166 -> V_2 -> V_106 ) ;
}
...
struct V_210 V_211 ;
const char * V_212 ;
V_42 = F_117 ( V_102 -> V_103 ,
L_30 , V_18 , & V_211 . V_90 ) ;
if ( V_42 < 0 )
break;
V_212 = F_118 ( V_2 -> V_166 [ V_18 ] . clock ) ;
V_211 . V_213 = & V_212 ;
V_211 . V_214 = 1 ;
V_211 . V_65 = & V_215 ;
V_211 . V_10 = V_216 ;
...
V_166 -> V_2 = V_2 ;
V_206 -> V_209 [ V_18 ] = F_119 ( NULL , & V_166 -> V_203 ) ;
if ( F_18 ( V_206 -> V_209 [ V_18 ] ) ) {
F_70 ( V_102 , L_31 ,
V_211 . V_90 , F_89 ( V_206 -> V_209 [ V_18 ] ) ) ;
V_42 = F_89 ( V_206 -> V_209 [ V_18 ] ) ;
goto V_177;
}
V_206 -> V_208 ++ ;
}
...
V_206 -> V_103 = V_102 -> V_103 ;
V_42 = F_121 ( V_102 -> V_103 , V_219 ,
& V_206 -> V_217 ) ;
if ( V_42 == 0 )
return 0 ;
V_177:
...
struct V_222 * V_93 )
{
struct V_1 * V_2 = F_123 ( V_221 ) ;
struct V_8 * V_142 = NULL ;
int V_18 ;
for ( V_18 = 0 ; V_18 < F_46 ( V_2 -> V_4 ) ; V_18 ++ )
if ( V_2 -> V_4 [ V_18 ] . V_93 . V_96 . V_97 . V_97 ==
F_37 ( V_113 -> V_102 -> V_103 ) )
V_142 = & V_2 -> V_4 [ V_18 ] ;
if ( V_142 == NULL )
return - V_54 ;
F_56 ( V_113 , & V_142 -> V_72 ) ;
...
struct V_1 * V_2 = F_123 ( V_221 ) ;
int V_42 ;
F_125 ( & V_2 -> V_183 . V_223 ) ;
V_42 = F_82 ( V_2 ) ;
if ( V_42 < 0 )
goto V_224;
V_42 = F_126 ( & V_2 -> V_80 ) ;
V_224:
F_127 ( & V_2 -> V_183 . V_223 ) ;
if ( V_42 < 0 )
return V_42 ;
return F_128 ( & V_2 -> V_183 ) ;
}
static int F_129 ( struct V_120 * V_101 )
{
struct V_128 * V_102 = & V_101 -> V_102 ;
struct V_225 * V_80 ;
struct V_1 * V_2 ;
int V_42 ;
V_2 = F_130 ( V_102 , sizeof( * V_2 ) , V_62 ) ;
if ( ! V_2 )
return - V_114 ;
F_131 ( & V_2 -> V_11 ) ;
F_132 ( & V_2 -> V_64 ) ;
V_2 -> V_101 = V_101 ;
F_104 ( V_2 -> V_183 . V_226 , L_34 ,
sizeof( V_2 -> V_183 . V_226 ) ) ;
V_2 -> V_183 . V_65 = & V_227 ;
V_2 -> V_183 . V_102 = V_102 ;
V_80 = & V_2 -> V_80 ;
V_80 -> V_182 = & V_2 -> V_183 ;
V_80 -> V_228 = V_229 ;
F_104 ( V_80 -> V_90 , L_35 , sizeof( V_80 -> V_90 ) ) ;
V_2 -> V_164 = F_133 ( V_102 -> V_103 ) ;
V_2 -> V_58 = true ;
F_134 ( & V_2 -> V_183 ) ;
V_42 = F_135 ( V_102 , & V_2 -> V_80 ) ;
if ( V_42 < 0 ) {
F_43 ( V_80 , L_36 , V_42 ) ;
return V_42 ;
}
...
if ( V_42 < 0 ) {
if ( V_42 != V_129 )
F_70 ( V_102 , L_37 , V_42 ) ;
goto V_231;
}
F_136 ( V_101 , V_2 ) ;
V_42 = F_71 ( V_2 , V_102 -> V_103 ) ;
if ( V_42 )
goto V_231;
V_42 = F_47 ( V_2 ) ;
if ( V_42 )
goto V_232;
V_42 = F_137 ( & V_101 -> V_102 , & V_233 ) ;
if ( V_42 )
goto V_232;
V_42 = F_116 ( V_2 ) ;
if ( V_42 < 0 ) {
...
if ( V_2 -> V_99 > 0 ) {
V_2 -> V_235 . V_20 = V_2 -> V_98 ;
V_2 -> V_235 . V_236 = V_2 -> V_99 ;
V_2 -> V_235 . V_237 = F_122 ;
V_2 -> V_235 . V_238 = F_124 ;
V_2 -> V_99 = 0 ;
V_42 = F_138 ( & V_2 -> V_80 ,
& V_2 -> V_235 ) ;
if ( V_42 )
...
static int F_142 ( struct V_120 * V_101 )
{
struct V_1 * V_2 = F_103 ( V_101 ) ;
if ( ! V_2 )
return 0 ;
