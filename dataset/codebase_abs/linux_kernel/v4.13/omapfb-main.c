...
V_218 = F_75 ( V_202 -> V_219 , V_80 , & V_220 ,
V_229 , V_221 ) ;
if ( V_218 == NULL ) {
F_76 ( V_202 -> V_219 , L_29 ) ;
return - V_230 ;
}
F_6 ( L_30 ,
...
static int F_78 ( struct V_1 * V_2 , unsigned long V_80 ,
unsigned long V_41 )
{
struct V_26 * V_27 = F_25 ( V_2 ) ;
struct V_201 * V_202 = V_27 -> V_202 ;
...
V_237 , V_238 ) ) {
F_76 ( V_202 -> V_219 , L_34 ) ;
memset ( & V_237 , 0 , sizeof( V_237 ) ) ;
memset ( & V_238 , 0 , sizeof( V_238 ) ) ;
}
for ( V_57 = 0 ; V_57 < V_202 -> V_224 ; V_57 ++ ) {
if ( V_57 == 0 || V_237 [ V_57 ] != 0 ) {
V_16 = F_78 ( V_202 -> V_225 [ V_57 ] ,
...
V_204 = F_63 ( V_202 , V_102 ) ;
F_94 ( & V_204 -> V_256 , F_90 ) ;
V_204 -> V_212 = true ;
F_90 ( & V_204 -> V_256 . V_251 ) ;
}
...
for ( V_57 = 0 ; V_57 < V_202 -> V_224 ; V_57 ++ )
F_100 ( V_202 -> V_225 [ V_57 ] ) ;
F_72 ( V_202 ) ;
for ( V_57 = 0 ; V_57 < V_202 -> V_224 ; V_57 ++ ) {
F_97 ( V_202 , V_202 -> V_225 [ V_57 ] ) ;
F_101 ( V_202 -> V_225 [ V_57 ] ) ;
}
...
F_6 ( L_48 ) ;
for ( V_57 = 0 ; V_57 < F_109 ( V_202 -> V_224 , V_202 -> V_105 ) ; V_57 ++ ) {
struct V_26 * V_27 = F_25 ( V_202 -> V_225 [ V_57 ] ) ;
...
static int F_111 ( const char * V_279 ,
struct V_101 * V_102 ,
...
V_7 = NULL ;
V_263 = NULL ;
V_2 = F_113 ( sizeof( * V_2 ) , V_229 ) ;
if ( V_2 == NULL ) {
V_16 = - V_230 ;
goto V_154;
}
V_7 = F_113 ( sizeof( * V_7 ) , V_229 ) ;
if ( V_7 == NULL ) {
V_16 = - V_230 ;
goto V_154;
}
V_263 = F_113 ( sizeof( * V_263 ) , V_229 ) ;
if ( V_263 == NULL ) {
V_16 = - V_230 ;
goto V_154;
}
V_2 -> V_263 = V_263 ;
V_16 = F_114 ( V_7 , V_2 , V_279 , NULL , 0 , NULL , 24 ) ;
if ( V_16 == 0 ) {
V_16 = - V_60 ;
goto V_154;
}
...
V_116 -> V_118 = F_115 ( V_7 -> V_117 ) * 1000 ;
...
struct V_203 * V_204 ;
V_16 = F_111 ( V_279 , V_102 , & V_116 , & V_280 ) ;
if ( V_16 )
return V_16 ;
V_204 = F_63 ( V_202 , V_102 ) ;
V_204 -> V_293 = V_280 ;
...
static int F_79 ( struct V_201 * V_202 ,
struct V_101 * V_252 )
{
struct V_203 * V_204 ;
F_118 ( V_252 -> V_109 -> V_296 == NULL ) ;
...
int V_16 = 0 ;
V_297 = F_120 ( V_300 , V_229 ) ;
if ( ! V_297 )
return - V_230 ;
V_298 = V_297 ;
while ( ! V_16 && ( V_299 = F_121 ( & V_298 , L_60 ) ) != NULL ) {
...
V_24 -> V_118 = F_115 ( V_59 -> V_117 ) * 1000 ;
...
return - V_309 ;
V_175 = 0x80 * 2 ;
V_306 = F_124 ( V_175 , V_229 ) ;
if ( V_306 == NULL )
return - V_230 ;
V_16 = V_102 -> V_109 -> V_308 ( V_102 , V_306 , V_175 ) ;
if ( V_16 < 0 )
goto V_310;
V_305 = F_113 ( sizeof( * V_305 ) , V_229 ) ;
if ( V_305 == NULL ) {
V_16 = - V_230 ;
goto V_310;
}
...
continue;
V_103 = F_133 ( V_252 -> V_219 -> V_325 , L_67 ) ;
if ( V_103 == 0 )
return V_252 ;
}
return V_202 -> V_270 [ 0 ] . V_252 ;
}
static int F_134 ( struct V_326 * V_327 )
{
...
return - V_329 ;
if ( V_327 -> V_330 != 0 ) {
F_76 ( & V_327 -> V_219 , L_69 ) ;
V_16 = - V_309 ;
goto V_331;
}
V_202 = F_136 ( & V_327 -> V_219 , sizeof( struct V_201 ) ,
V_229 ) ;
if ( V_202 == NULL ) {
V_16 = - V_230 ;
goto V_331;
...
if ( V_202 -> V_269 == 0 ) {
F_76 ( & V_327 -> V_219 , L_73 ) ;
V_16 = - V_329 ;
goto V_333;
}
V_202 -> V_105 = F_143 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_105 ; V_57 ++ )
V_202 -> V_106 [ V_57 ] = F_144 ( V_57 ) ;
V_202 -> V_334 = F_145 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_334 ; V_57 ++ )
V_202 -> V_335 [ V_57 ] = F_146 ( V_57 ) ;
V_328 = F_131 ( V_202 ) ;
if ( V_328 == NULL ) {
F_76 ( V_202 -> V_219 , L_74 ) ;
V_16 = - V_329 ;
goto V_333;
}
V_16 = F_129 ( V_202 , V_328 ) ;
if ( V_16 ) {
F_76 ( V_202 -> V_219 , L_75 ) ;
goto V_333;
}
if ( V_300 && strlen ( V_300 ) > 0 ) {
if ( F_119 ( V_202 ) )
F_128 ( & V_327 -> V_219 , L_76 ) ;
} else if ( V_328 && V_328 -> V_109 -> V_295 &&
V_328 -> V_109 -> V_294 ) {
struct V_115 V_24 ;
V_16 = F_123 ( V_328 , & V_24 ) ;
if ( V_16 == 0 )
...
if ( V_16 )
F_128 ( V_202 -> V_219 , L_77 ) ;
}
F_6 ( L_78 ) ;
if ( V_328 ) {
V_16 = F_127 ( V_202 , V_328 ) ;
if ( V_16 ) {
F_76 ( V_202 -> V_219 ,
L_79
L_80 ) ;
...
V_16 = F_147 ( V_202 ) ;
if ( V_16 ) {
F_76 ( V_202 -> V_219 , L_82 ) ;
goto V_333;
}
if ( V_328 ) {
T_2 V_20 , V_22 ;
V_328 -> V_109 -> V_231 ( V_328 , & V_20 , & V_22 ) ;
F_148 ( V_202 -> V_219 , L_83 ,
...
F_149 () ;
V_331:
F_76 ( & V_327 -> V_219 , L_84 ) ;
return V_16 ;
}
static int F_150 ( struct V_326 * V_327 )
{
struct V_201 * V_202 = F_151 ( V_327 ) ;
F_152 ( V_202 ) ;
F_99 ( V_202 ) ;
F_149 () ;
return 0 ;
