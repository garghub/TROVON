...
V_182 = F_68 ( V_157 -> V_195 , V_376 ,
F_2 ( V_376 ) ) ;
if ( V_182 != 0 )
F_69 ( & V_361 -> V_2 , L_20 , V_182 ) ;
F_30 ( V_157 -> V_195 , V_147 ,
V_377 , V_377 ) ;
if ( V_157 -> V_176 . V_378 )
