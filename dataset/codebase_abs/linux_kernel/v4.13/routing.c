...
struct V_98 * V_115 ;
T_2 * V_104 , * V_116 ;
struct V_3 * V_4 = NULL , * V_117 = NULL ;
int V_114 , V_62 = sizeof( * V_93 ) ;
enum V_118 V_119 ;
struct V_31 * V_31 ;
int V_38 = V_39 ;
...
if ( F_39 ( V_2 , V_93 -> V_95 ) ) {
V_116 = V_31 -> V_33 ;
V_117 = F_27 ( V_2 , V_116 ) ;
if ( V_117 ) {
V_121 = F_66 ( V_28 , V_117 ,
V_62 ) ;
F_32 ( V_117 ) ;
if ( V_121 ) {
F_9 ( V_122 , V_2 ,
...
if ( F_23 ( V_28 ) < 0 )
goto V_63;
V_128 = (struct V_127 * ) V_28 -> V_40 ;
V_129 = ( unsigned char * ) ( V_28 -> V_40 + V_62 ) ;
V_130 = F_72 ( V_128 -> V_131 ) ;
if ( V_130 > V_28 -> V_45 - V_62 )
goto V_63;
V_38 = F_73 ( V_2 , false , NULL ,
V_128 -> V_125 ,
V_128 -> V_48 ,
V_129 , V_130 ) ;
if ( V_38 != V_54 ) {
...
sizeof( * V_134 ) ) < 0 )
goto V_63;
V_134 = (struct V_133 * ) V_28 -> V_40 ;
V_132 = F_27 ( V_2 , V_134 -> V_16 ) ;
if ( ! V_132 )
goto V_63;
V_28 -> V_135 = V_134 -> V_135 + 256 ;
if ( ! F_39 ( V_2 , V_134 -> V_95 ) &&
F_75 ( V_28 , V_6 , V_132 ) ) {
V_28 = NULL ;
V_38 = V_54 ;
goto V_67;
...
goto V_63;
V_140 = (struct V_139 * ) V_28 -> V_40 ;
if ( F_39 ( V_2 , V_140 -> V_16 ) )
goto V_63;
if ( V_140 -> V_51 < 2 )
goto V_63;
V_4 = F_27 ( V_2 , V_140 -> V_16 ) ;
if ( ! V_4 )
goto V_63;
F_3 ( & V_4 -> V_143 ) ;
V_142 = F_79 ( V_140 -> V_142 ) ;
if ( F_80 ( V_4 -> V_144 , V_4 -> V_145 ,
V_142 ) )
goto V_146;
V_141 = V_142 - V_4 -> V_145 ;
if ( F_14 ( V_2 , V_141 ,
V_147 ,
& V_4 -> V_148 , NULL ) )
goto V_146;
if ( F_81 ( V_2 , V_4 -> V_144 , V_141 , 1 ) )
V_4 -> V_145 = V_142 ;
F_7 ( & V_4 -> V_143 ) ;
if ( F_82 ( V_2 , V_28 ) )
goto V_63;
F_51 ( V_28 , sizeof( struct V_139 ) ) ;
F_83 ( V_2 , V_28 , 1 , false ) ;
if ( F_66 ( V_28 , V_4 , V_62 ) )
goto V_63;
if ( F_68 ( V_2 , V_28 , V_62 ) )
goto V_126;
if ( F_69 ( V_2 , V_28 , V_62 ) )
goto V_126;
F_70 ( V_6 -> V_59 , V_28 , V_62 , V_4 ) ;
V_126:
V_38 = V_54 ;
goto V_18;
V_146:
