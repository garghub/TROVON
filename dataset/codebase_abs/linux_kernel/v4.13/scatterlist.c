...
void F_12 ( struct V_1 * V_10 , unsigned int V_5 )
{
...
void F_14 ( struct V_1 * V_2 , const void * V_13 , unsigned int V_14 )
{
F_12 ( V_2 , 1 ) ;
F_15 ( V_2 , V_13 , V_14 ) ;
}
static struct V_1 * F_16 ( unsigned int V_5 , T_2 V_15 )
{
if ( V_5 == V_16 ) {
void * V_17 = ( void * ) F_17 ( V_15 ) ;
F_18 ( V_17 , V_18 , 1 , V_15 ) ;
return V_17 ;
} else
return F_19 ( V_5 * sizeof( struct V_1 ) , V_15 ) ;
}
...
void F_24 ( struct V_19 * V_20 , unsigned int V_21 ,
bool V_22 , T_3 * V_23 )
{
...
{
F_24 ( V_20 , V_16 , false , F_20 ) ;
}
int F_26 ( struct V_19 * V_20 , unsigned int V_5 ,
...
T_6 F_55 ( struct V_1 * V_10 , unsigned int V_5 ,
const void * V_13 , T_6 V_14 )
{
return F_54 ( V_10 , V_5 , ( void * ) V_13 , V_14 , 0 , false ) ;
}
T_6 F_56 ( struct V_1 * V_10 , unsigned int V_5 ,
void * V_13 , T_6 V_14 )
{
