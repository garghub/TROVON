...
void F_8 ( struct V_14 * V_15 , unsigned long * V_26 )
{
unsigned long V_3 = ( unsigned long ) V_26 ;
if ( ! V_3 )
V_3 = V_15 ? V_15 -> V_27 . V_28 : F_9 () ;
F_7 ( L_3 ) ;
...
{
struct V_29 * V_12 = & V_29 ( V_9 -> V_12 ) ;
char * V_30 ;
V_30 = F_2 ( V_9 ) ? L_6 : L_7 ;
F_7 ( L_8 , V_30 , ( void * ) V_9 -> V_12 . V_31 , ( void * ) V_9 -> V_12 . V_13 ) ;
if ( ! F_2 ( V_9 ) )
F_13 ( L_9 , ( void * ) V_9 -> V_12 . V_13 ) ;
F_13 ( L_10 ) ;
F_7 ( L_11
L_12 , V_12 -> V_32 , V_12 -> V_33 , V_12 -> V_34 , V_12 -> V_35 ,
V_12 -> V_36 , V_12 -> V_37 , V_12 -> V_38 , V_12 -> V_39 , V_12 -> V_40 , V_12 -> V_41 , V_12 -> V_42 ) ;
F_13 ( L_13 , V_12 -> V_43 , V_12 -> V_44 ) ;
F_7 ( L_14 , V_30 ,
...
void F_17 ( struct V_8 * V_9 , const char * V_46 )
{
static int V_47 ;
F_18 () ;
F_19 () ;
...
F_13 ( L_19 ) ;
F_13 ( L_10 ) ;
F_27 ( V_50 , V_46 , V_9 , 0 , V_9 -> V_49 & 0xffff , V_51 ) ;
F_28 () ;
F_15 ( V_9 ) ;
F_23 ( 0 ) ;
F_29 ( V_52 , V_53 ) ;
