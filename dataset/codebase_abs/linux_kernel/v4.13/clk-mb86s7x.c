...
static void T_2 F_21 ( struct V_42 * V_43 )
{
struct V_28 * V_29 ;
...
static void F_24 ( struct V_1 * V_2 , unsigned long * V_17 , int V_44 )
{
struct V_45 * V_46 = F_25 ( V_2 ) ;
struct V_47 V_7 ;
int V_18 , V_8 ;
V_7 . V_9 = sizeof( V_7 ) ;
V_7 . V_48 = 0 ;
...
V_18 = V_53 ;
F_3 ( L_12 ,
V_14 , __LINE__ , V_7 . V_48 ,
V_7 . V_49 , V_7 . V_51 , V_7 . V_19 ) ;
V_8 = F_4 ( V_18 , & V_7 , sizeof( V_7 ) ) ;
if ( V_8 < 0 ) {
F_5 ( L_2 , V_14 , __LINE__ ) ;
return;
...
static unsigned long
F_26 ( struct V_1 * V_2 , unsigned long V_54 )
{
unsigned long V_17 ;
F_24 ( V_2 , & V_17 , 1 ) ;
return V_17 ;
...
F_24 ( V_2 , & V_55 , 0 ) ;
return ( V_55 == V_17 ) ? 0 : - V_13 ;
}
static struct V_1 * F_29 ( struct V_56 * V_57 )
{
struct V_30 V_31 ;
struct V_45 * V_46 ;
int V_8 ;
V_46 = F_17 ( sizeof( * V_46 ) , V_35 ) ;
if ( ! V_46 )
return F_13 ( - V_36 ) ;
V_46 -> V_2 . V_31 = & V_31 ;
V_46 -> V_50 = F_30 ( V_57 -> V_58 ) ;
V_31 . V_37 = F_31 ( V_57 ) ;
V_31 . V_39 = & V_59 ;
V_31 . V_41 = V_60 ;
V_31 . V_38 = 0 ;
V_8 = F_32 ( V_57 , & V_46 -> V_2 ) ;
if ( V_8 )
return F_13 ( V_8 ) ;
return & V_46 -> V_2 ;
}
...
struct V_42 * V_63 ;
struct V_1 * V_2 ;
V_63 = F_34 ( NULL , NULL , L_14 ) ;
if ( ! V_63 || ! F_35 ( V_63 ) )
goto exit;
F_36 (cpu) {
struct V_56 * V_57 = F_37 ( V_61 ) ;
if ( ! V_57 ) {
F_5 ( L_15 , V_61 ) ;
continue;
}
