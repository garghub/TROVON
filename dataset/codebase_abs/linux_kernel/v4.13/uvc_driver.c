...
static void F_72 ( struct V_213 * V_210 )
{
struct V_42 * V_43 = F_73 ( V_210 ) ;
...
struct V_42 * V_43 )
{
struct V_213 * V_210 = & V_43 -> V_210 ;
int V_116 ;
V_116 = F_81 ( & V_43 -> V_215 , V_43 -> type , ! V_216 ) ;
if ( V_116 )
return V_116 ;
V_116 = F_82 ( V_43 ) ;
if ( V_116 < 0 ) {
...
F_83 ( V_43 ) ;
V_210 -> V_218 = & V_35 -> V_210 ;
V_210 -> V_219 = & V_220 ;
V_210 -> V_221 = & V_222 ;
V_210 -> V_223 = F_72 ;
V_210 -> V_205 = & V_43 -> V_185 -> V_205 ;
if ( V_43 -> type == V_124 )
V_210 -> V_224 = V_225 ;
F_17 ( V_210 -> V_70 , V_35 -> V_70 , sizeof V_210 -> V_70 ) ;
F_84 ( V_210 , V_43 ) ;
V_116 = F_85 ( V_210 , V_226 , - 1 ) ;
if ( V_116 < 0 ) {
F_18 ( V_217 , L_94 ,
V_116 ) ;
return V_116 ;
...
if ( V_43 -> type == V_126 )
V_43 -> V_185 -> V_227 |= V_228 ;
else
V_43 -> V_185 -> V_227 |= V_229 ;
F_76 ( & V_35 -> V_214 ) ;
return 0 ;
}
...
V_43 -> V_185 = V_185 ;
V_116 = F_80 ( V_35 , V_43 ) ;
if ( V_116 < 0 )
return V_116 ;
V_158 -> V_210 = & V_43 -> V_210 ;
}
return 0 ;
}
...
const struct V_230 * V_36 )
{
struct V_147 * V_66 = F_90 ( V_53 ) ;
struct V_34 * V_35 ;
int V_231 ;
int V_116 ;
if ( V_36 -> V_151 && V_36 -> V_232 )
F_16 ( V_187 , L_98
L_99 , V_66 -> V_233 , V_36 -> V_151 ,
V_36 -> V_232 ) ;
else
F_16 ( V_187 , L_100 ,
V_66 -> V_233 ) ;
...
? V_36 -> V_237 : V_236 ;
if ( V_66 -> V_238 != NULL )
F_17 ( V_35 -> V_70 , V_66 -> V_238 , sizeof V_35 -> V_70 ) ;
else
snprintf ( V_35 -> V_70 , sizeof V_35 -> V_70 ,
L_101 ,
F_31 ( V_66 -> V_150 . V_151 ) ,
F_31 ( V_66 -> V_150 . V_232 ) ) ;
if ( V_53 -> V_239 && V_53 -> V_239 -> V_240 != 0 )
V_231 = V_53 -> V_239 -> V_240 ;
else
V_231 = V_53 -> V_54 -> V_7 . V_241 ;
if ( V_231 != 0 ) {
T_7 V_13 ;
F_19 ( V_35 -> V_70 , L_102 , sizeof( V_35 -> V_70 ) ) ;
V_13 = strlen ( V_35 -> V_70 ) ;
F_38 ( V_66 , V_231 , V_35 -> V_70 + V_13 ,
...
V_66 -> V_238 ? V_66 -> V_238 : L_106 ,
F_31 ( V_66 -> V_150 . V_151 ) ,
F_31 ( V_66 -> V_150 . V_232 ) ) ;
if ( V_35 -> V_74 != V_36 -> V_237 ) {
F_18 ( V_72 , L_107
L_108 , V_35 -> V_74 ) ;
F_18 ( V_72 , L_109
L_110 ) ;
...
#ifdef F_66
V_35 -> V_211 . V_35 = & V_53 -> V_35 ;
F_17 ( V_35 -> V_211 . V_242 , V_35 -> V_70 , sizeof( V_35 -> V_211 . V_242 ) ) ;
if ( V_66 -> V_243 )
F_17 ( V_35 -> V_211 . V_243 , V_66 -> V_243 ,
sizeof( V_35 -> V_211 . V_243 ) ) ;
strcpy ( V_35 -> V_211 . V_244 , V_66 -> V_233 ) ;
V_35 -> V_211 . V_245 = F_31 ( V_66 -> V_150 . V_246 ) ;
V_35 -> V_211 . V_247 = V_248 ;
F_93 ( & V_35 -> V_211 ) ;
V_35 -> V_210 . V_211 = & V_35 -> V_211 ;
#endif
if ( F_94 ( & V_53 -> V_35 , & V_35 -> V_210 ) < 0 )
goto error;
if ( F_95 ( V_35 ) < 0 )
goto error;
if ( F_59 ( V_35 ) < 0 )
...
goto error;
#ifdef F_66
if ( F_96 ( & V_35 -> V_211 ) < 0 )
goto error;
#endif
F_97 ( V_53 , V_35 ) ;
if ( ( V_116 = F_98 ( V_35 ) ) < 0 ) {
F_18 ( V_72 , L_111
L_112
L_113 , V_116 ) ;
}
...
static int F_102 ( struct V_52 * V_53 , T_8 V_250 )
{
struct V_34 * V_35 = F_101 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_251 , L_115 ,
...
static int F_107 ( struct V_52 * V_53 , int V_254 )
{
struct V_34 * V_35 = F_101 ( V_53 ) ;
struct V_42 * V_43 ;
int V_116 = 0 ;
...
F_103 ( & V_35 -> V_235 ) ;
if ( V_35 -> V_253 )
V_116 = F_109 ( V_35 , V_255 ) ;
F_105 ( & V_35 -> V_235 ) ;
return V_116 ;
}
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 ) {
V_116 = F_110 ( V_43 , V_254 ) ;
if ( V_116 < 0 )
F_111 ( & V_43 -> V_215 ,
V_43 -> V_215 . V_215 . type ) ;
return V_116 ;
}
}
F_16 ( V_251 , L_119
...
static int F_114 ( char * V_50 , struct V_256 * V_257 )
{
if ( V_258 == V_259 )
...
static int F_115 ( const char * V_260 , struct V_256 * V_257 )
{
if ( strncasecmp ( V_260 , L_122 , strlen ( L_122 ) ) == 0 )
V_260 += strlen ( L_122 ) ;
if ( strcasecmp ( V_260 , L_123 ) == 0 )
V_258 = V_259 ;
else if ( strcasecmp ( V_260 , L_124 ) == 0 )
V_258 = V_261 ;
else
return - V_69 ;
return 0 ;
