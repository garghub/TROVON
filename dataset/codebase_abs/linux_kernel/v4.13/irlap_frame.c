...
if ( ( V_61 = F_30 ( sizeof( T_2 ) , V_35 ) ) == NULL ) {
F_31 ( L_8 , V_26 ) ;
return;
}
...
F_8 ( L_9 , V_26 ,
V_61 -> V_47 . V_43 ) ;
V_79 = F_32 ( V_4 , sizeof( struct V_62 ) ) ;
...
return;
if ( V_36 == V_38 ) {
V_32 = F_14 ( V_30 , sizeof( struct V_128 ) ) ;
V_32 -> V_42 = F_15 ( V_2 -> V_42 ) ;
V_32 -> V_43 = F_15 ( V_43 ) ;
} else
V_32 = F_14 ( V_30 , V_129 + V_130 ) ;
V_32 -> V_36 = V_36 ;
V_32 -> V_39 = V_131 | V_41 ;
F_27 ( V_30 , V_127 -> V_47 , V_127 -> V_73 ) ;
F_58 ( V_2 , & V_2 -> V_116 ) ;
F_2 ( V_2 , V_30 ) ;
}
