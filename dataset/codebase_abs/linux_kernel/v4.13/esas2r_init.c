...
F_33 ( L_30 ) ;
F_24 ( V_2 ) ;
if ( F_51 ( V_53 , & V_2 -> V_45 ) )
F_52 ( V_2 ) ;
F_23 ( V_104 , & V_2 -> V_45 ) ;
if ( ! F_51 ( V_105 , & V_2 -> V_47 ) )
F_53 ( V_2 ) ;
F_33 ( L_31 ,
V_2 , V_2 -> V_89 ) ;
return 1 ;
...
if ( V_2 -> V_109 ) {
F_59 ( & V_2 -> V_55 -> V_110 . V_111 , & V_112 ) ;
V_2 -> V_109 = 0 ;
}
if ( V_2 -> V_113 ) {
F_59 ( & V_2 -> V_55 -> V_110 . V_111 , & V_114 ) ;
V_2 -> V_113 = 0 ;
}
if ( V_2 -> V_115 ) {
F_59 ( & V_2 -> V_55 -> V_110 . V_111 , & V_116 ) ;
V_2 -> V_115 = 0 ;
}
if ( V_2 -> V_117 ) {
F_59 ( & V_2 -> V_55 -> V_110 . V_111 , & V_118 ) ;
V_2 -> V_117 = 0 ;
}
if ( V_2 -> V_119 ) {
F_59 ( & V_2 -> V_55 -> V_110 . V_111 ,
& V_120 ) ;
V_2 -> V_119 = 0 ;
}
if ( V_2 -> V_121 ) {
...
& ( V_2 -> V_11 -> V_12 ) ,
L_33 , V_2 -> V_11 -> V_50 ) ;
F_60 ( V_2 -> V_11 -> V_50 , V_2 ) ;
F_33 ( L_34 ) ;
F_61 ( V_53 , & V_2 -> V_45 ) ;
}
if ( F_51 ( V_44 , & V_2 -> V_45 ) ) {
F_62 ( V_2 -> V_11 ) ;
F_61 ( V_44 , & V_2 -> V_45 ) ;
F_33 ( L_35 ) ;
}
...
if ( V_2 -> V_124 . V_8 )
F_6 ( V_2 , & V_2 -> V_124 ) ;
F_63 (memdesc, next, &a->free_sg_list_head,
next_desc) {
F_6 ( V_2 , V_21 ) ;
}
F_63 (memdesc, next, &a->vrq_mds_head, next_desc) {
F_6 ( V_2 , V_21 ) ;
F_64 ( & V_21 -> V_25 ) ;
F_8 ( V_21 ) ;
}
...
int F_73 ( struct V_56 * V_147 , T_4 V_148 )
{
struct V_54 * V_55 = F_74 ( V_147 ) ;
T_1 V_149 ;
...
bool F_84 ( struct V_1 * V_2 , char * V_155 )
{
F_23 ( V_105 , & V_2 -> V_47 ) ;
F_3 ( V_16 ,
L_64 , V_155 ) ;
...
{
int V_165 ;
V_165 = F_86 ( V_2 -> V_11 , V_166 ) ;
if ( V_165 ) {
V_159 V_167 ;
F_87 ( V_2 -> V_11 , V_165 + V_168 ,
& V_167 ) ;
if ( ( V_167 & V_169 ) >
V_170 ) {
F_3 ( V_49 ,
...
V_172 += sizeof( T_1 ) ;
if ( ! F_51 ( V_196 , & V_2 -> V_47 ) )
F_89 ( V_2 ) ;
* V_171 = ( void * ) V_172 ;
if ( F_51 ( V_92 , & V_2 -> V_47 ) ) {
F_90 ( V_2 ) ;
V_173 =
(struct V_163 * ) V_2 ->
V_123 .
...
T_2 V_205 ;
T_1 V_206 ;
if ( F_51 ( V_207 , & V_2 -> V_47 ) )
goto V_208;
F_93 ( V_2 , V_209 , V_210 ) ;
F_94 ( V_2 , V_209 ) ;
V_203 = F_95 ( V_211 ) ;
while ( true ) {
F_96 ( V_2 ) ;
V_204 = F_97 ( V_2 , V_212 ) ;
if ( V_204 == 0xFFFFFFFF ) {
if ( ( F_95 ( V_211 ) - V_203 ) > 2000 )
return F_84 ( V_2 ,
L_71 ) ;
} else if ( V_204 & V_213 ) {
...
F_98 ( F_99 ( 50 ) ) ;
if ( ( F_95 ( V_211 ) - V_203 ) > 3000 ) {
F_11 ( L_75 ) ;
break;
}
}
V_208:
V_206 = F_97 ( V_2 , V_221 ) ;
V_206 &= ~ V_222 ;
F_93 ( V_2 , V_221 , V_206 ) ;
V_206 = F_97 ( V_2 , V_223 ) ;
V_206 &= ~ V_224 ;
F_93 ( V_2 , V_223 , V_206 ) ;
V_205 = V_2 -> V_123 . V_9 ;
F_93 ( V_2 , V_225 ,
F_45 ( V_205 ) ) ;
F_93 ( V_2 , V_226 ,
...
F_23 ( V_233 , & V_2 -> V_47 ) ;
F_93 ( V_2 , V_234 , V_235 |
V_2 -> V_231 ) ;
F_93 ( V_2 , V_236 , V_237 |
V_2 -> V_231 ) ;
F_93 ( V_2 , V_238 , V_239 |
V_2 -> V_231 ) ;
F_93 ( V_2 , V_240 ,
V_241 | V_2 -> V_231 ) ;
V_206 = F_97 ( V_2 , V_242 ) ;
V_206 &= ~ ( V_243 | V_244 ) ;
F_93 ( V_2 , V_242 ,
( V_206 | V_245 | V_246 ) ) ;
V_206 = F_97 ( V_2 , V_247 ) ;
V_206 &= ~ ( V_248 | V_249 ) ;
F_93 ( V_2 , V_247 ,
( V_206 | V_250 |
V_251 ) ) ;
...
V_204 = F_97 ( V_2 , V_262 ) ;
if ( V_204 & V_263 )
F_23 ( V_264 , & V_2 -> V_45 ) ;
else
F_61 ( V_264 , & V_2 -> V_45 ) ;
F_93 ( V_2 , V_265 , V_266 ) ;
F_93 ( V_2 , V_267 , V_268 ) ;
return true ;
}
...
V_271 -> V_160 = F_91 ( V_160 ) ;
V_271 -> V_279 = F_91 ( V_274 . V_280 ) ;
V_20 -> V_47 |= V_281 ;
V_2 -> V_94 = V_282 ;
break;
}
...
sizeof( struct V_270 ) ,
NULL ) ;
V_20 -> V_28 -> V_276 . V_294 = F_108 (
struct V_295 ,
V_277 . V_296 ) ;
V_20 -> V_28 -> V_276 . V_277 . V_297 . V_298 =
F_91 ( sizeof( struct V_270 ) ) ;
V_20 -> V_28 -> V_276 . V_277 . V_297 . V_197 = F_109 (
V_20 -> V_27 -> V_9 +
sizeof( union V_22 ) ) ;
V_20 -> V_47 |= V_281 ;
V_2 -> V_94 = V_299 ;
...
bool F_50 ( struct V_1 * V_2 , bool V_307 )
{
bool V_308 = false ;
struct V_19 * V_20 ;
T_1 V_38 ;
...
( int ) F_105 ( F_119 ( V_2 -> V_288 ) ) ,
( int ) F_106 ( F_119 ( V_2 -> V_288 ) ) ) ;
F_11 ( L_84 , V_2 -> V_311 ) ;
if ( F_51 ( V_207 , & V_2 -> V_47 )
&& ( F_51 ( V_92 , & V_2 -> V_47 ) ) ) {
F_52 ( V_2 ) ;
...
if ( F_51 ( V_92 , & V_2 -> V_47 ) )
F_121 ( & V_2 -> V_89 ) ;
while ( F_51 ( V_91 , & V_2 -> V_47 ) ) {
F_98 ( F_99 ( 100 ) ) ;
V_315 = F_95 ( V_211 ) - V_312 ;
V_312 += V_315 ;
if ( ! F_51 ( V_90 , & V_2 -> V_47 ) )
F_122 ( V_2 ) ;
if ( V_314 <= V_315 ) {
V_314 += 100 ;
F_123 ( V_2 ) ;
...
bool F_83 ( struct V_1 * V_2 , bool V_307 )
{
bool V_335 ;
F_61 ( V_333 , & V_2 -> V_47 ) ;
F_85 ( V_2 ) ;
...
{
if ( F_51 ( V_336 , & V_2 -> V_47 ) )
return false ;
if ( F_97 ( V_2 , V_212 ) == 0xFFFFFFFF ) {
F_23 ( V_336 , & V_2 -> V_47 ) ;
return false ;
}
return true ;
...
const char * F_144 ( struct V_1 * V_2 )
{
switch ( V_2 -> V_11 -> V_183 ) {
case V_337 :
return L_96 ;
