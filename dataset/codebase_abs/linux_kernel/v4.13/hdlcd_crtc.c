...
if ( ! V_11 )
return;
V_94 = F_33 ( & V_82 -> V_13 -> V_96 ) ;
V_95 = F_34 ( V_11 , V_82 -> V_13 , 0 ) ;
V_4 = V_82 -> V_79 -> V_97 ;
F_3 ( V_4 , V_98 , V_11 -> V_99 [ 0 ] ) ;
F_3 ( V_4 , V_100 , V_11 -> V_99 [ 0 ] ) ;
F_3 ( V_4 , V_101 , V_94 - 1 ) ;
F_3 ( V_4 , V_102 , V_95 ) ;
}
...
static struct V_81 * F_38 ( struct V_103 * V_104 )
{
struct V_3 * V_4 = V_104 -> V_97 ;
struct V_81 * V_82 = NULL ;
T_2 V_105 [ F_9 ( V_18 ) ] , V_17 ;
int V_106 ;
V_82 = F_39 ( V_104 -> V_79 , sizeof( * V_82 ) , V_107 ) ;
if ( ! V_82 )
return F_40 ( - V_108 ) ;
for ( V_17 = 0 ; V_17 < F_9 ( V_18 ) ; V_17 ++ )
V_105 [ V_17 ] = V_18 [ V_17 ] . V_19 ;
V_106 = F_41 ( V_104 , V_82 , 0xff , & V_109 ,
V_105 , F_9 ( V_105 ) ,
V_110 , NULL ) ;
if ( V_106 ) {
return F_40 ( V_106 ) ;
...
if ( F_44 ( V_12 ) )
return F_45 ( V_12 ) ;
V_106 = F_46 ( V_104 , & V_4 -> V_2 , V_12 , NULL ,
& V_112 , NULL ) ;
if ( V_106 ) {
F_35 ( V_12 ) ;
return V_106 ;
