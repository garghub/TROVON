...
{
* ( V_44 * ) F_24 ( V_43 , V_45 ) = 0 ;
return 0 ;
}
static void F_25 ( void * V_46 , struct V_42 * V_43 ,
int V_9 )
{
...
static int F_37 ( struct V_14 * V_3 , struct V_52 * V_53 , T_2 V_19 )
{
struct V_3 * V_4 = V_3 -> V_4 ;
struct V_23 * V_24 = F_11 ( V_4 ) -> V_24 ;
struct V_42 * V_43 ;
...
if ( V_3 -> V_32 != V_33 )
return - V_56 ;
V_43 = F_38 ( V_24 , V_4 , V_53 -> V_57 , V_19 , & V_25 ) ;
if ( V_43 == NULL )
return V_25 ;
V_25 = F_39 ( F_40 ( V_43 , V_19 ) , V_53 , V_19 ) ;
if ( V_25 < 0 ) {
F_31 ( V_43 ) ;
return V_25 ;
}
...
static int F_42 ( struct V_14 * V_3 , struct V_52 * V_53 , T_2 V_19 ,
int V_20 )
{
int V_58 = V_20 & V_59 ;
struct V_3 * V_4 = V_3 -> V_4 ;
...
const struct V_31 * V_66 , int V_67 )
{
struct V_3 * V_4 ;
F_8 ( L_10 , V_3 ) ;
if ( ( V_3 -> type != V_68 ) && ( V_3 -> type != V_15 ) )
return - V_69 ;
if ( V_3 -> type == V_15 )
V_3 -> V_70 = & V_71 ;
else
V_3 -> V_70 = & V_72 ;
V_4 = F_52 ( V_65 , V_73 , V_74 , V_66 -> V_75 , V_67 ) ;
if ( ! V_4 )
return - V_76 ;
F_53 ( V_3 , V_4 ) ;
V_4 -> V_77 = V_66 -> V_78 ;
