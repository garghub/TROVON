...
{
struct V_40 * V_41 ;
V_41 = F_35 ( V_46 , V_68 , sizeof( * V_41 ) ) ;
if ( ! V_41 )
return - V_69 ;
V_41 -> V_51 = V_51 ;
V_41 -> V_4 = F_36 ( V_51 , V_70 ) ;
if ( F_37 ( V_41 -> V_4 ) ) {
int V_71 = F_38 ( V_41 -> V_4 ) ;
F_39 ( V_51 , V_46 ) ;
return V_71 ;
}
return 0 ;
...
{
struct V_1 * V_72 = V_46 -> V_73 ;
struct V_40 * V_41 = V_72 -> V_44 ;
if ( V_41 -> V_4 )
F_41 ( V_41 -> V_4 ) ;
