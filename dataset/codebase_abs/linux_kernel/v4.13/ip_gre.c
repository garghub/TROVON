...
struct V_10 * V_11 ;
struct V_134 * V_135 ;
V_11 = F_71 ( V_2 , V_15 -> V_116 + sizeof( * V_11 ) ) ;
...
V_30 = 0 ;
if ( V_44 [ V_168 ] )
V_30 |= F_92 ( V_44 [ V_168 ] ) ;
if ( V_44 [ V_169 ] )
V_30 |= F_92 ( V_44 [ V_169 ] ) ;
if ( V_30 & ( V_131 | V_132 ) )
return - V_112 ;
if ( V_44 [ V_170 ] &&
V_44 [ V_171 ] &&
F_93 ( V_44 [ V_171 ] ) != V_154 )
return - V_112 ;
return 0 ;
}
...
T_7 V_31 ;
if ( V_165 [ V_172 ] ) {
if ( F_95 ( V_165 [ V_172 ] ) != V_173 )
return - V_112 ;
if ( ! F_96 ( F_97 ( V_165 [ V_172 ] ) ) )
return - V_138 ;
}
if ( ! V_44 )
goto V_174;
if ( V_44 [ V_175 ] ) {
memcpy ( & V_31 , F_97 ( V_44 [ V_175 ] ) , 4 ) ;
if ( ! V_31 )
return - V_112 ;
}
V_174:
return F_91 ( V_165 , V_44 , V_167 ) ;
}
...
return 0 ;
if ( V_44 [ V_177 ] )
V_38 -> V_137 = F_99 ( V_44 [ V_177 ] ) ;
if ( V_44 [ V_168 ] )
V_38 -> V_130 = F_66 ( F_92 ( V_44 [ V_168 ] ) ) ;
if ( V_44 [ V_169 ] )
V_38 -> V_66 = F_66 ( F_92 ( V_44 [ V_169 ] ) ) ;
if ( V_44 [ V_178 ] )
V_38 -> V_179 = F_100 ( V_44 [ V_178 ] ) ;
if ( V_44 [ V_180 ] )
V_38 -> V_70 = F_100 ( V_44 [ V_180 ] ) ;
if ( V_44 [ V_181 ] )
V_38 -> V_11 . V_32 = F_101 ( V_44 [ V_181 ] ) ;
if ( V_44 [ V_175 ] )
V_38 -> V_11 . V_31 = F_101 ( V_44 [ V_175 ] ) ;
if ( V_44 [ V_182 ] )
V_38 -> V_11 . V_39 = F_102 ( V_44 [ V_182 ] ) ;
if ( V_44 [ V_183 ] )
V_38 -> V_11 . V_84 = F_102 ( V_44 [ V_183 ] ) ;
if ( ! V_44 [ V_184 ] || F_102 ( V_44 [ V_184 ] ) ) {
if ( V_15 -> V_185 )
return - V_112 ;
...
&& ( V_38 -> V_11 . V_129 & F_4 ( V_107 ) ) )
return - V_112 ;
V_15 -> V_185 = ! ! F_102 ( V_44 [ V_186 ] ) ;
}
if ( V_44 [ V_187 ] )
* V_176 = F_99 ( V_44 [ V_187 ] ) ;
return 0 ;
}
...
if ( V_44 [ V_171 ] ) {
V_190 = true ;
V_189 -> type = F_93 ( V_44 [ V_171 ] ) ;
}
if ( V_44 [ V_191 ] ) {
V_190 = true ;
V_189 -> V_30 = F_93 ( V_44 [ V_191 ] ) ;
}
if ( V_44 [ V_192 ] ) {
V_190 = true ;
V_189 -> V_193 = F_92 ( V_44 [ V_192 ] ) ;
}
if ( V_44 [ V_194 ] ) {
V_190 = true ;
V_189 -> V_195 = F_92 ( V_44 [ V_194 ] ) ;
}
return V_190 ;
}
...
static int F_107 ( struct V_6 * V_200 , struct V_64 * V_7 ,
...
if ( F_103 ( V_44 , & V_189 ) ) {
struct V_14 * V_15 = F_31 ( V_7 ) ;
V_95 = F_108 ( V_15 , & V_189 ) ;
if ( V_95 < 0 )
return V_95 ;
}
V_95 = F_98 ( V_7 , V_44 , V_165 , & V_122 , & V_176 ) ;
if ( V_95 < 0 )
return V_95 ;
return F_109 ( V_7 , V_165 , & V_122 , V_176 ) ;
}
...
if ( V_95 < 0 )
return V_95 ;
return F_111 ( V_7 , V_165 , & V_122 , V_176 ) ;
}
...
if ( F_115 ( V_2 , V_177 , V_122 -> V_137 ) ||
F_116 ( V_2 , V_168 ,
F_68 ( V_122 -> V_130 ) ) ||
F_116 ( V_2 , V_169 ,
F_68 ( V_122 -> V_66 ) ) ||
F_117 ( V_2 , V_178 , V_122 -> V_179 ) ||
F_117 ( V_2 , V_180 , V_122 -> V_70 ) ||
F_118 ( V_2 , V_181 , V_122 -> V_11 . V_32 ) ||
F_118 ( V_2 , V_175 , V_122 -> V_11 . V_31 ) ||
F_119 ( V_2 , V_182 , V_122 -> V_11 . V_39 ) ||
F_119 ( V_2 , V_183 , V_122 -> V_11 . V_84 ) ||
F_119 ( V_2 , V_184 ,
! ! ( V_122 -> V_11 . V_129 & F_4 ( V_107 ) ) ) ||
F_115 ( V_2 , V_187 , V_15 -> V_176 ) )
goto V_201;
if ( F_120 ( V_2 , V_171 ,
V_15 -> V_153 . type ) ||
F_116 ( V_2 , V_192 ,
...
struct V_64 * F_122 ( struct V_6 * V_6 , const char * V_203 ,
T_10 V_204 )
{
struct V_164 * V_165 [ V_205 + 1 ] ;
struct V_64 * V_7 ;
F_123 ( V_206 ) ;
struct V_14 * V_15 ;
int V_95 ;
memset ( & V_165 , 0 , sizeof( V_165 ) ) ;
V_7 = F_124 ( V_6 , V_203 , V_204 ,
& V_207 , V_165 ) ;
if ( F_46 ( V_7 ) )
return V_7 ;
V_15 = F_31 ( V_7 ) ;
V_15 -> V_55 = true ;
V_95 = F_107 ( V_6 , V_7 , V_165 , NULL , NULL ) ;
if ( V_95 < 0 ) {
F_125 ( V_7 ) ;
return F_126 ( V_95 ) ;
}
V_95 = F_127 ( V_7 , V_208 , false ) ;
if ( V_95 )
goto V_174;
V_95 = F_128 ( V_7 , NULL ) ;
if ( V_95 < 0 )
...
{
return F_88 ( V_6 , V_27 , & V_207 , L_1 ) ;
}
