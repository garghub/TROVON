...
static void F_118 ( struct V_1 * V_10 )
{
int V_231 ;
if ( V_10 == NULL )
return;
V_231 = V_10 -> V_12 ;
V_10 -> V_132 = V_158 [ 2 ] ;
if ( V_11 [ V_10 -> V_12 ] . V_232 ) {
V_10 -> V_233 =
V_11 [ V_10 -> V_12 ] . V_234 ;
} else {
V_10 -> V_233 = 0 ;
}
V_10 -> V_88 = V_11 [ V_231 ] . V_235 ;
V_10 -> V_74 = V_11 [ V_231 ] . V_76 ;
V_10 -> V_84 = 0 ;
V_10 -> V_99 = 87.5 * 16000 ;
V_10 -> V_100 = 400 * 16 ;
if ( V_11 [ V_231 ] . V_236 > 0 )
F_38 ( V_10 ) ;
F_119 ( V_10 ) ;
F_120 ( V_10 ) ;
}
static int F_121 ( struct V_222 * V_223 ,
const struct V_237 * V_238 )
{
struct V_207 * V_26 = F_122 ( F_123 ( V_223 ) ) ;
struct V_222 * V_239 ;
T_8 V_240 = V_223 -> V_241 -> V_159 . V_242 ;
const struct V_243 * V_244 ;
struct V_1 * V_10 = NULL ;
const struct V_245 * V_246 ;
int V_231 , V_151 , V_106 ;
F_23 ( V_211 , L_36 ,
F_124 ( V_26 -> V_247 . V_248 ) ,
F_124 ( V_26 -> V_247 . V_249 ) , V_240 ) ;
V_231 = V_238 -> V_250 ;
if ( V_231 < 0 || V_231 >= V_251 ) {
F_23 ( V_211 , L_37 , V_231 ) ;
V_106 = - V_252 ;
goto V_253;
}
F_42 ( V_48 L_38 , V_36 ,
V_11 [ V_231 ] . V_13 ) ;
if ( V_11 [ V_231 ] . V_244 >= 0 )
V_244 = & V_26 -> V_254 -> V_244 [ V_11 [ V_231 ] . V_244 ] -> V_241 [ 0 ] ;
else if ( V_240 < V_26 -> V_254 -> V_159 . V_255 )
V_244 = & V_26 -> V_254 -> V_244 [ V_240 ] -> V_241 [ 0 ] ;
else {
F_18 ( & V_223 -> V_26 , L_39 ,
V_240 , V_26 -> V_254 -> V_159 . V_255 - 1 ) ;
V_106 = - V_252 ;
goto V_253;
}
if ( V_244 -> V_159 . V_256 < 2 ) {
F_18 ( & V_223 -> V_26 , L_40 ,
V_240 , V_244 -> V_159 . V_256 ) ;
V_106 = - V_252 ;
goto V_253;
}
V_246 = & V_244 -> V_246 [ 1 ] . V_159 ;
if ( ! F_125 ( V_246 ) ) {
...
V_239 = V_26 -> V_254 -> V_244 [ 0 ] ;
V_10 -> V_263 = V_239 -> V_264 ;
F_23 ( V_211 , L_46 , V_10 -> V_263 ) ;
V_10 -> V_230 = F_127 ( 32 * V_10 -> V_263 , V_224 ) ;
if ( V_10 -> V_230 == NULL ) {
F_18 ( & V_223 -> V_26 , L_47 ) ;
V_106 = - V_212 ;
goto V_265;
}
for ( V_151 = 0 ; V_151 < V_10 -> V_263 ; V_151 ++ ) {
T_9 V_266 ;
if ( V_239 -> V_241 [ V_151 ] . V_159 . V_256 < 2 ) {
V_106 = - V_252 ;
goto V_265;
}
V_266 = F_124 ( V_239 -> V_241 [ V_151 ] . V_246 [ 1 ] . V_159 .
V_267 ) ;
V_10 -> V_230 [ V_151 ] =
...
F_129 ( & V_10 -> V_147 ) ;
F_129 ( & V_10 -> V_269 ) ;
V_10 -> V_59 = V_11 [ V_231 ] . V_79 ;
if ( V_10 -> V_59 )
V_10 -> V_270 = V_11 [ V_231 ] . V_270 ;
V_10 -> V_12 = V_231 ;
V_10 -> V_47 = 0 ;
V_10 -> V_205 = V_240 ;
V_10 -> V_204 = 0 ;
V_10 -> V_271 = V_246 -> V_272 ;
V_10 -> V_273 = 0 ;
V_10 -> V_274 = 0 ;
V_10 -> V_42 = 0 ;
V_10 -> V_20 = V_275 ;
