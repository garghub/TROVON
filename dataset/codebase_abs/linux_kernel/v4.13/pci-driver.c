...
F_53 ( V_75 , V_32 ) ;
if ( ! F_66 ( V_32 ) )
F_67 ( V_32 , V_59 , false ) ;
}
static void F_68 ( struct V_32 * V_32 )
{
if ( ! F_66 ( V_32 ) )
F_69 ( V_32 ) ;
}
...
if ( V_38 -> V_115 [ V_113 ] . V_116 & V_117 )
return & V_118 ;
}
return NULL ;
}
...
static int F_110 ( struct V_4 * V_38 , struct V_120 * V_121 )
{
struct V_32 * V_33 ;
if ( ! V_38 )
return - V_37 ;
V_33 = F_37 ( V_38 ) ;
if ( F_111 ( V_121 , L_9 , V_33 -> V_7 ) )
return - V_13 ;
if ( F_111 ( V_121 , L_10 , V_33 -> V_3 , V_33 -> V_4 ) )
return - V_13 ;
if ( F_111 ( V_121 , L_11 , V_33 -> V_34 ,
V_33 -> V_35 ) )
return - V_13 ;
if ( F_111 ( V_121 , L_12 , F_112 ( V_33 ) ) )
return - V_13 ;
if ( F_111 ( V_121 , L_13 ,
V_33 -> V_3 , V_33 -> V_4 ,
V_33 -> V_34 , V_33 -> V_35 ,
( V_122 ) ( V_33 -> V_7 >> 16 ) , ( V_122 ) ( V_33 -> V_7 >> 8 ) ,
( V_122 ) ( V_33 -> V_7 ) ) )
return - V_13 ;
return 0 ;
}
