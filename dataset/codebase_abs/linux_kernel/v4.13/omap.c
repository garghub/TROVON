...
if ( ! V_155 )
return;
if ( V_2 -> V_16 -> V_159 == NULL )
return;
F_20 ( & V_2 -> V_160 ,
V_34 + F_69 ( V_161 ) ) ;
}
static void F_70 ( void * V_162 )
{
...
static inline void F_71 ( struct V_8 * V_4 , struct V_29 * V_165 )
{
T_3 V_166 ;
...
static void
F_73 ( struct V_8 * V_4 , struct V_29 * V_165 )
{
...
F_74 (data->sg, sg, sg_len, i) {
if ( ( V_100 -> V_135 % V_173 ) != 0 ) {
V_172 = 0 ;
break;
}
}
...
F_110 ( & V_4 -> V_17 ) ;
V_4 -> V_22 = V_22 ;
V_4 -> V_248 = V_4 -> V_22 -> V_38 [ 0 ] . V_248 ;
V_4 -> V_42 = & V_239 -> V_42 ;
F_111 ( V_239 , V_4 ) ;
V_4 -> V_24 = V_239 -> V_24 ;
V_4 -> V_131 = V_131 ;
V_4 -> V_187 = V_145 -> V_249 ;
V_4 -> V_250 = F_112 ( & V_239 -> V_42 , L_35 ) ;
if ( F_106 ( V_4 -> V_250 ) )
return F_107 ( V_4 -> V_250 ) ;
F_6 ( V_4 -> V_250 ) ;
V_4 -> V_12 = F_112 ( & V_239 -> V_42 , L_36 ) ;
if ( F_106 ( V_4 -> V_12 ) ) {
V_243 = F_107 ( V_4 -> V_12 ) ;
goto V_251;
}
V_4 -> V_181 = - 1 ;
V_4 -> V_182 = - 1 ;
V_4 -> V_96 = F_113 ( & V_239 -> V_42 , L_37 ) ;
if ( F_106 ( V_4 -> V_96 ) ) {
V_243 = F_107 ( V_4 -> V_96 ) ;
if ( V_243 == - V_245 ) {
F_114 ( V_4 -> V_12 ) ;
goto V_251;
}
...
V_4 -> V_98 = F_113 ( & V_239 -> V_42 , L_39 ) ;
if ( F_106 ( V_4 -> V_98 ) ) {
V_243 = F_107 ( V_4 -> V_98 ) ;
if ( V_243 == - V_245 ) {
if ( V_4 -> V_96 )
F_116 ( V_4 -> V_96 ) ;
F_114 ( V_4 -> V_12 ) ;
...
V_243 = F_117 ( V_4 -> V_131 , F_58 , 0 , V_252 , V_4 ) ;
if ( V_243 )
goto V_253;
if ( V_22 -> V_254 != NULL ) {
V_243 = V_22 -> V_254 ( & V_239 -> V_42 ) ;
if ( V_243 < 0 )
goto V_255;
}
V_4 -> V_36 = V_22 -> V_36 ;
V_4 -> V_256 = ( F_118 () ? 1 : 2 ) ;
V_4 -> V_39 = F_119 ( L_41 , 0 , 0 ) ;
if ( ! V_4 -> V_39 ) {
V_243 = - V_217 ;
goto V_257;
}
...
{
struct V_8 * V_4 = F_123 ( V_239 ) ;
int V_33 ;
F_19 ( V_4 == NULL ) ;
for ( V_33 = 0 ; V_33 < V_4 -> V_36 ; V_33 ++ )
F_97 ( V_4 -> V_38 [ V_33 ] ) ;
if ( V_4 -> V_22 -> V_259 )
V_4 -> V_22 -> V_259 ( & V_239 -> V_42 ) ;
F_4 ( V_4 , 0 ) ;
F_121 ( V_4 -> V_131 , V_4 ) ;
F_114 ( V_4 -> V_12 ) ;
F_7 ( V_4 -> V_250 ) ;
