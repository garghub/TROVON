...
void * V_66 , unsigned int V_67 , T_2 V_68 )
{
switch ( V_75 ) {
case V_76 :
...
int F_66 ( struct V_1 * V_2 , struct V_90 * V_91 )
{
struct V_10 * V_11 ;
struct V_18 * V_33 ;
void * V_12 ;
...
V_33 = F_16 ( V_2 , V_11 , V_12 ) ;
V_91 -> V_92 = F_29 ( V_2 ) ;
V_91 -> V_93 = F_47 ( V_33 -> V_39 ) ;
V_91 -> V_94 = F_47 ( V_33 -> V_87 ) ;
F_39 ( V_12 ) ;
F_34 ( V_11 ) ;
V_36:
F_51 ( & F_2 ( V_2 ) -> V_35 ) ;
...
int F_67 ( struct V_95 * V_96 , T_2 V_97 ,
struct V_98 * V_99 , struct V_1 * * V_100 )
{
struct V_1 * V_2 ;
int V_101 ;
if ( V_97 > V_96 -> V_102 ) {
...
V_2 = F_68 ( V_96 , NULL , V_104 ) ;
if ( F_24 ( ! V_2 ) )
return - V_105 ;
if ( ! ( V_2 -> V_106 & V_107 ) )
goto V_70;
V_101 = F_69 ( V_2 , V_108 , 0 ) ;
if ( V_101 )
goto V_109;
F_70 ( V_2 , V_97 ,
sizeof( struct V_18 ) ) ;
