...
static void F_9 ( T_2 V_11 , T_2 T_3 * V_12 )
{
F_10 ( V_11 , V_12 ) ;
}
static T_2 F_11 ( T_2 T_3 * V_12 )
{
return F_12 ( V_12 ) ;
}
static void F_13 ( T_4 V_11 , T_4 T_3 * V_12 )
{
unsigned int V_13 = ( ( unsigned long ) ( V_12 ) & 0x3 ) << 3 ;
void T_3 * V_14 = ( void T_3 * ) ( ( unsigned long ) ( V_12 ) & ~ 0x3 ) ;
T_2 V_15 ;
V_15 = F_12 ( V_14 ) ;
V_15 &= ~ ( 0xffff << V_13 ) ;
V_15 |= V_11 << V_13 ;
...
static void F_15 ( T_5 V_11 , T_5 T_3 * V_12 )
{
unsigned int V_13 = ( ( unsigned long ) ( V_12 ) & 0x3 ) << 3 ;
void T_3 * V_14 = ( void T_3 * ) ( ( unsigned long ) ( V_12 ) & ~ 0x3 ) ;
T_2 V_15 ;
