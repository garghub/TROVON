...
if ( F_5 ( V_5 ) )
return - V_11 ;
if ( V_43 -> V_45 > V_5 -> V_46 - 1 )
return - V_11 ;
V_43 -> V_5 = V_5 ;
F_31 ( & V_43 -> V_2 , V_5 -> V_2 . V_47 ) ;
V_43 -> V_2 . V_48 = V_5 -> V_2 . V_48 ;
F_18 ( & V_5 -> V_18 , V_16 ) ;
F_32 ( & V_43 -> V_49 , & V_5 -> V_42 ) ;
F_19 ( & V_5 -> V_18 , V_16 ) ;
return 0 ;
}
void F_33 ( struct V_4 * V_5 , struct V_42 * V_43 )
{
unsigned long V_16 ;
if ( ! V_5 || F_5 ( V_5 ) )
return;
...
void F_41 ( struct V_1 * V_2 , struct V_4 * V_5 )
{
int V_51 ;
V_51 = F_42 ( V_2 , F_1 , F_3 ,
V_5 ) ;
F_43 ( V_2 , V_51 , L_1 ) ;
}
struct V_4 *
F_44 ( struct V_1 * V_2 , const struct V_52 * V_7 ,
struct V_53 * V_8 )
{
int V_10 ;
struct V_4 * V_5 ;
...
F_48 ( & V_5 -> V_42 ) ;
F_49 ( & V_5 -> V_2 ) ;
F_31 ( & V_5 -> V_2 , V_2 -> V_47 ) ;
V_5 -> V_2 . V_57 = V_14 ;
V_5 -> V_2 . V_48 = V_2 -> V_48 ;
V_5 -> V_7 = V_7 ;
V_10 = F_50 ( & V_5 -> V_2 , L_2 , F_11 ( V_2 ) ) ;
if ( V_10 )
goto V_58;
V_10 = F_51 ( & V_5 -> V_2 ) ;
if ( V_10 )
goto V_58;
V_5 -> V_50 = F_52 ( F_11 ( V_2 ) ) ;
return V_5 ;
V_58:
F_7 ( & V_5 -> V_2 ) ;
F_40 ( V_5 ) ;
...
struct V_4 *
F_53 ( struct V_1 * V_2 , const struct V_52 * V_7 ,
struct V_53 * V_8 )
{
struct V_4 * * V_59 , * V_5 ;
V_59 = F_54 ( F_1 , sizeof( * V_59 ) , V_55 ) ;
if ( ! V_59 )
return F_16 ( - V_56 ) ;
V_5 = F_44 ( V_2 , V_7 , V_8 ) ;
if ( ! F_5 ( V_5 ) ) {
* V_59 = V_5 ;
F_55 ( V_2 , V_59 ) ;
} else {
