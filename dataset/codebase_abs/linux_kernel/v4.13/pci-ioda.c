...
static void F_95 ( struct V_1 * V_2 , bool V_268 )
{
...
V_26 = V_44 -> V_63 ;
V_26 -> V_356 = 1 ;
sprintf ( V_95 , L_101 , V_44 -> V_45 ) ;
V_26 -> V_357 = F_243 ( V_95 , V_358 ) ;
if ( ! V_26 -> V_357 ) {
F_76 ( L_102 ,
V_43 , V_44 -> V_45 ) ;
continue;
...
V_388 = F_271 ( V_385 ) ;
F_18 ( L_111 , V_388 ) ;
V_26 = F_272 ( sizeof( struct V_25 ) , 0 ) ;
V_26 -> V_44 = V_44 = F_273 ( V_377 ) ;
if ( ! V_26 -> V_44 ) {
F_74 ( L_112 ,
V_377 -> V_94 ) ;
F_274 ( F_130 ( V_26 ) , sizeof( struct V_25 ) ) ;
return;
}
F_275 ( & V_26 -> V_391 ) ;
...
V_26 -> V_39 = V_388 ;
V_26 -> type = V_379 ;
F_276 ( & V_26 -> V_30 . V_183 ) ;
if ( F_277 ( V_377 , L_115 ) )
V_26 -> V_161 = V_394 ;
else if ( F_277 ( V_377 , L_116 ) )
V_26 -> V_161 = V_206 ;
else if ( F_277 ( V_377 , L_117 ) )
V_26 -> V_161 = V_234 ;
else if ( F_277 ( V_377 , L_118 ) )
V_26 -> V_161 = V_162 ;
else
V_26 -> V_161 = V_395 ;
...
V_26 -> V_355 = V_396 ;
V_26 -> V_354 = F_272 ( V_26 -> V_355 , 0 ) ;
F_278 ( V_44 , V_377 , ! V_44 -> V_45 ) ;
if ( ! F_279 ( V_377 , 0 , & V_28 ) ) {
V_26 -> V_210 = V_28 . V_29 ;
V_26 -> V_211 = F_280 ( V_28 . V_29 , F_50 ( & V_28 ) ) ;
if ( V_26 -> V_211 == NULL )
F_74 ( L_120 ) ;
}
V_26 -> V_30 . V_46 = 1 ;
...
for ( V_66 = 0 ; V_66 < F_281 ( V_26 -> V_30 . V_137 ) ; V_66 ++ )
...
void T_2 F_287 ( struct V_87 * V_377 )
{
struct V_87 * V_416 ;
const T_13 * V_385 ;
T_8 V_378 ;
F_10 ( L_128 , V_377 -> V_94 ) ;
