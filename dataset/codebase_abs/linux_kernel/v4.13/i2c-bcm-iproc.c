...
static T_4 F_22 ( struct V_64 * V_68 )
{
return V_69 | V_70 ;
}
...
V_4 -> V_40 = & V_77 -> V_80 ;
F_29 ( & V_4 -> V_26 ) ;
V_79 = F_30 ( V_77 , V_83 , 0 ) ;
V_4 -> V_6 = F_31 ( V_4 -> V_40 , V_79 ) ;
if ( F_32 ( V_4 -> V_6 ) )
return F_33 ( V_4 -> V_6 ) ;
V_49 = F_7 ( V_4 ) ;
if ( V_49 )
...
V_4 -> V_1 = V_1 ;
V_49 = F_35 ( V_4 -> V_40 , V_1 , F_1 , 0 ,
V_77 -> V_84 , V_4 ) ;
if ( V_49 < 0 ) {
F_19 ( V_4 -> V_40 , L_15 , V_1 ) ;
return V_49 ;
}
F_9 ( V_4 , true ) ;
V_68 = & V_4 -> V_65 ;
F_36 ( V_68 , V_4 ) ;
F_37 ( V_68 -> V_84 , L_16 , sizeof( V_68 -> V_84 ) ) ;
V_68 -> V_85 = & V_86 ;
V_68 -> V_87 = & V_88 ;
...
static int F_42 ( struct V_40 * V_80 )
{
struct V_76 * V_77 = F_43 ( V_80 ) ;
struct V_3 * V_4 = F_40 ( V_77 ) ;
F_5 ( 0 , V_4 -> V_6 + V_21 ) ;
F_2 ( V_4 -> V_6 + V_21 ) ;
F_18 ( V_4 -> V_1 ) ;
...
static int F_44 ( struct V_40 * V_80 )
{
struct V_76 * V_77 = F_43 ( V_80 ) ;
struct V_3 * V_4 = F_40 ( V_77 ) ;
int V_49 ;
