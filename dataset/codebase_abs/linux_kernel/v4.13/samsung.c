...
V_2 -> V_35 = V_35 ;
V_2 -> type = F_55 ( V_35 ) -> V_200 ;
F_50 ( V_31 ) ;
V_193 = F_56 ( V_35 , V_201 , 0 ) ;
if ( ! V_193 ) {
F_40 ( & V_35 -> V_34 , L_8 ) ;
return - V_202 ;
goto V_203;
}
V_2 -> V_204 = F_57 ( V_193 -> V_165 , F_58 ( V_193 ) ,
V_35 -> V_205 ) ;
if ( ! V_2 -> V_204 ) {
F_40 ( & V_35 -> V_34 , L_9 ) ;
V_151 = - V_206 ;
...
V_30 -> V_174 |= V_210 ;
if ( V_2 -> type != V_181 ) {
V_193 = F_56 ( V_35 , V_201 , 1 ) ;
if ( ! V_193 ) {
F_40 ( & V_35 -> V_34 , L_11 ) ;
V_151 = - V_202 ;
goto V_203;
}
V_2 -> V_211 = F_57 ( V_193 -> V_165 , F_58 ( V_193 ) ,
V_35 -> V_205 ) ;
if ( ! V_2 -> V_211 ) {
F_40 ( & V_35 -> V_34 , L_12 ) ;
V_151 = - V_206 ;
...
V_2 -> V_220 = F_57 ( V_193 -> V_165 , F_58 ( V_193 ) ,
V_35 -> V_205 ) ;
if ( ! V_2 -> V_220 ) {
F_40 ( & V_35 -> V_34 , L_15 ) ;
V_151 = - V_206 ;
...
V_2 -> V_158 = V_2 -> V_204 -> V_165 ;
F_41 = F_29 ;
V_193 = F_56 ( V_35 , V_222 , 0 ) ;
if ( V_193 ) {
F_60 ( & V_2 -> V_144 ) ;
F_41 = F_33 ;
