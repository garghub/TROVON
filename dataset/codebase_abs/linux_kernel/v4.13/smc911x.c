...
V_223 | V_224 ;
if ( V_13 -> V_141 == 10 )
V_219 -> V_225 . V_226 = V_227 ;
else if ( V_13 -> V_141 == 100 )
V_219 -> V_225 . V_226 = V_228 ;
V_219 -> V_225 . V_229 = V_230 ;
V_219 -> V_225 . V_231 = 0 ;
F_126 ( V_13 , V_13 -> V_135 . V_136 , V_66 ) ;
V_219 -> V_225 . V_232 =
( V_66 & ( V_233 | V_234 ) ) ?
V_235 : V_236 ;
F_127 (
V_219 -> V_237 . V_220 , V_220 ) ;
}
return 0 ;
}
static int
F_128 ( struct V_10 * V_11 ,
...
if ( V_13 -> V_123 != 0 ) {
F_11 ( & V_13 -> V_22 , V_18 ) ;
V_238 = F_129 ( & V_13 -> V_135 , V_219 ) ;
F_13 ( & V_13 -> V_22 , V_18 ) ;
} else {
if ( V_219 -> V_225 . V_229 != V_230 ||
V_219 -> V_225 . V_226 != V_227 ||
( V_219 -> V_225 . V_232 != V_236 &&
V_219 -> V_225 . V_232 != V_235 ) ||
( V_219 -> V_225 . V_231 != V_239 &&
V_219 -> V_225 . V_231 != V_240 ) )
return - V_241 ;
V_13 -> V_109 = V_219 -> V_225 . V_232 == V_235 ;
V_238 = 0 ;
}
return V_238 ;
}
static void
F_130 ( struct V_10 * V_11 , struct V_242 * V_243 )
{
F_131 ( V_243 -> V_244 , V_61 , sizeof( V_243 -> V_244 ) ) ;
F_131 ( V_243 -> V_124 , V_124 , sizeof( V_243 -> V_124 ) ) ;
F_131 ( V_243 -> V_245 , F_132 ( V_11 -> V_11 . V_246 ) ,
sizeof( V_243 -> V_245 ) ) ;
}
...
static void F_136 ( struct V_10 * V_11 , V_93 V_248 )
{
struct V_12 * V_13 = F_5 ( V_11 ) ;
V_13 -> V_247 = V_248 ;
}
...
{
return ( ( ( V_249 - V_250 ) / 4 + 1 ) +
( V_251 - V_252 ) + 1 + 32 ) * sizeof( V_93 ) ;
}
static void F_138 ( struct V_10 * V_11 ,
struct V_253 * V_254 , void * V_1 )
{
struct V_12 * V_13 = F_5 ( V_11 ) ;
unsigned long V_18 ;
V_93 V_14 , V_3 , V_255 = 0 ;
V_93 * V_69 = ( V_93 * ) V_1 ;
V_254 -> V_124 = V_13 -> V_124 ;
for( V_3 = V_250 ; V_3 <= V_249 ; V_3 += 4 ) {
V_69 [ V_255 ++ ] = F_139 ( V_13 , V_3 ) ;
}
for( V_3 = V_252 ; V_3 <= V_251 ; V_3 ++ ) {
F_11 ( & V_13 -> V_22 , V_18 ) ;
F_140 ( V_13 , V_3 , V_14 ) ;
F_13 ( & V_13 -> V_22 , V_18 ) ;
V_69 [ V_255 ++ ] = V_14 ;
...
int V_256 ;
V_256 = F_16 ( V_13 ) ;
for( V_15 = 10 ; ( V_256 & V_25 ) && V_15 ; V_15 -- ) {
if ( V_256 & V_257 ) {
F_10 ( V_11 , L_58 ,
V_20 ) ;
return - V_258 ;
...
struct V_260 * V_261 , T_3 * V_69 )
{
T_3 V_262 [ V_263 ] ;
int V_3 , V_238 ;
for( V_3 = 0 ; V_3 < V_263 ; V_3 ++ ) {
if ( ( V_238 = F_143 ( V_11 , V_264 , V_3 ) ) != 0 )
return V_238 ;
if ( ( V_238 = F_145 ( V_11 , & V_262 [ V_3 ] ) ) != 0 )
return V_238 ;
}
memcpy ( V_69 , V_262 + V_261 -> V_265 , V_261 -> V_91 ) ;
return 0 ;
}
...
{
int V_3 , V_238 ;
if ( ( V_238 = F_143 ( V_11 , V_266 , 0 ) ) != 0 )
return V_238 ;
for( V_3 = V_261 -> V_265 ; V_3 < ( V_261 -> V_265 + V_261 -> V_91 ) ; V_3 ++ ) {
if ( ( V_238 = F_143 ( V_11 , V_267 , V_3 ) ) != 0 )
return V_238 ;
if ( ( V_238 = F_147 ( V_11 , * V_69 ) ) != 0 )
return V_238 ;
if ( ( V_238 = F_143 ( V_11 , V_268 , V_3 ) ) != 0 )
return V_238 ;
}
return 0 ;
}
...
F_6 ( V_120 , V_11 , L_62 ,
V_61 , V_273 ) ;
for( V_3 = 0 ; V_282 [ V_3 ] . V_283 != 0 ; V_3 ++ ) {
if ( V_282 [ V_3 ] . V_283 == V_273 ) break;
}
if ( ! V_282 [ V_3 ] . V_283 ) {
F_157 ( V_11 , L_63 , V_273 ) ;
V_271 = - V_280 ;
goto V_281;
}
V_274 = V_282 [ V_3 ] . V_284 ;
V_58 = F_159 ( V_13 ) ;
F_6 ( V_120 , V_11 , L_64 , V_61 , V_58 ) ;
F_6 ( V_120 , V_11 , L_65 ,
V_61 , V_282 [ V_3 ] . V_284 ) ;
if ( ( V_26 < 2 ) || ( V_26 > 14 ) ) {
F_157 ( V_11 , L_66 ,
V_26 ) ;
V_271 = - V_241 ;
...
V_13 -> V_124 = V_282 [ V_3 ] . V_283 ;
V_13 -> V_58 = V_58 ;
V_13 -> V_26 = V_26 ;
V_13 -> V_285 = ( V_13 -> V_26 << 10 ) - 512 ;
V_13 -> V_286 = ( ( 0x4000 - 512 - V_13 -> V_285 ) / 16 ) * 15 ;
switch( V_13 -> V_26 ) {
case 2 :
...
L_68 , V_61 ,
V_13 -> V_285 , V_13 -> V_286 , V_13 -> V_29 ) ;
F_160 ( & V_13 -> V_22 ) ;
...
V_11 -> V_288 = & V_289 ;
V_11 -> V_290 = F_163 ( V_291 ) ;
V_11 -> V_292 = & V_293 ;
F_164 ( & V_13 -> V_150 , F_86 ) ;
V_13 -> V_135 . V_294 = 0x1f ;
V_13 -> V_135 . V_295 = 0x1f ;
V_13 -> V_135 . V_158 = 0 ;
V_13 -> V_135 . V_146 = 0 ;
V_13 -> V_135 . V_11 = V_11 ;
V_13 -> V_135 . V_296 = F_69 ;
V_13 -> V_135 . V_297 = F_71 ;
F_73 ( V_11 ) ;
V_13 -> V_247 = V_298 ;
V_13 -> V_109 = 1 ;
V_13 -> V_141 = 100 ;
#ifdef F_21
V_275 = V_13 -> V_32 . V_275 ;
#else
V_275 = V_299 | V_300 ;
#endif
V_271 = F_165 ( V_11 -> V_176 , F_96 ,
V_275 , V_11 -> V_284 , V_11 ) ;
if ( V_271 )
goto V_281;
#ifdef F_49
F_166 ( V_39 ) ;
...
V_13 -> V_305 =
F_168 ( V_39 , V_306 ,
& V_279 , & V_11 -> V_11 , L_70 ) ;
V_13 -> V_307 =
F_168 ( V_39 , V_306 ,
& V_279 , & V_11 -> V_11 , L_71 ) ;
V_13 -> V_82 = 0 ;
V_13 -> V_102 = 0 ;
memset ( & V_277 , 0 , sizeof( V_277 ) ) ;
V_277 . V_308 = V_309 ;
V_277 . V_310 = V_309 ;
V_277 . V_311 = V_13 -> V_312 + V_313 ;
V_277 . V_314 = V_13 -> V_312 + V_315 ;
V_277 . V_316 = 32 ;
V_277 . V_317 = 32 ;
V_271 = F_169 ( V_13 -> V_305 , & V_277 ) ;
if ( V_271 ) {
F_170 ( V_13 -> V_11 , L_72 ,
V_271 ) ;
goto V_281;
}
V_271 = F_169 ( V_13 -> V_307 , & V_277 ) ;
if ( V_271 ) {
...
static int F_174 ( struct V_320 * V_321 )
{
struct V_10 * V_322 ;
struct V_323 * V_324 ;
struct V_12 * V_13 ;
...
int V_238 ;
F_6 ( V_19 , L_3 , V_20 ) ;
V_324 = F_175 ( V_321 , V_325 , 0 ) ;
if ( ! V_324 ) {
V_238 = - V_280 ;
goto V_326;
}
if ( ! F_176 ( V_324 -> V_327 , V_328 , V_61 ) ) {
V_238 = - V_329 ;
goto V_326;
}
V_322 = F_177 ( sizeof( struct V_12 ) ) ;
if ( ! V_322 ) {
V_238 = - V_330 ;
goto V_331;
}
F_178 ( V_322 , & V_321 -> V_11 ) ;
V_322 -> V_332 = ( unsigned char ) - 1 ;
V_322 -> V_176 = F_179 ( V_321 , 0 ) ;
V_13 = F_5 ( V_322 ) ;
V_13 -> V_151 = V_322 ;
#ifdef F_21
{
struct V_333 * V_334 = F_180 ( & V_321 -> V_11 ) ;
if ( ! V_334 ) {
V_238 = - V_241 ;
goto V_335;
}
memcpy ( & V_13 -> V_32 , V_334 , sizeof( V_13 -> V_32 ) ) ;
}
#endif
V_217 = F_181 ( V_324 -> V_327 , V_328 ) ;
if ( ! V_217 ) {
V_238 = - V_330 ;
goto V_335;
}
...
F_184 ( V_322 ) ;
V_331:
F_185 ( V_324 -> V_327 , V_328 ) ;
V_326:
F_186 ( L_82 , V_61 , V_238 ) ;
}
#ifdef F_49
else {
V_13 -> V_312 = V_324 -> V_327 ;
V_13 -> V_11 = & V_321 -> V_11 ;
}
#endif
return V_238 ;
}
static int F_187 ( struct V_320 * V_321 )
{
struct V_10 * V_322 = F_188 ( V_321 ) ;
struct V_12 * V_13 = F_5 ( V_322 ) ;
struct V_323 * V_324 ;
F_6 ( V_19 , V_322 , L_3 , V_20 ) ;
F_189 ( V_322 ) ;
F_190 ( V_322 -> V_176 , V_322 ) ;
#ifdef F_49
{
if ( V_13 -> V_305 )
F_173 ( V_13 -> V_305 ) ;
...
static int F_191 ( struct V_320 * V_11 , T_6 V_336 )
{
struct V_10 * V_322 = F_188 ( V_11 ) ;
struct V_12 * V_13 = F_5 ( V_322 ) ;
F_6 ( V_19 , V_322 , L_3 , V_20 ) ;
if ( V_322 ) {
if ( F_192 ( V_322 ) ) {
...
static int F_194 ( struct V_320 * V_11 )
{
struct V_10 * V_322 = F_188 ( V_11 ) ;
F_6 ( V_19 , V_322 , L_3 , V_20 ) ;
if ( V_322 ) {
