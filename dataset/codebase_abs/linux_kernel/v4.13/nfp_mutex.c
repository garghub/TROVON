...
{
unsigned long V_19 = V_20 + V_21 * V_22 ;
unsigned long V_23 = V_20 + V_24 * V_22 ;
unsigned int V_25 = 1 ;
int V_12 ;
for (; ; ) {
V_12 = F_17 ( V_15 ) ;
...
if ( V_10 != V_15 -> V_10 )
return - V_30 ;
V_12 = F_12 ( V_15 -> V_9 , V_14 , V_15 -> V_4 , & V_29 ) ;
if ( V_12 < 0 )
return V_12 ;
if ( V_29 != F_1 ( V_1 ) )
return - V_31 ;
...
{
const T_1 V_11 = F_8 ( V_15 -> V_3 , 4 , 0 ) ;
const T_1 V_32 = F_8 ( V_15 -> V_3 , 5 , 3 ) ;
const T_1 V_14 = F_8 ( V_15 -> V_3 , 3 , 0 ) ;
struct V_8 * V_9 = V_15 -> V_9 ;
T_1 V_10 , V_29 , V_16 ;
int V_12 ;
...
return - V_30 ;
V_29 = F_1 ( F_9 ( V_9 ) ) ;
V_12 = F_12 ( V_9 , V_32 , V_15 -> V_4 , & V_16 ) ;
if ( V_12 < 0 )
return V_12 ;
if ( F_4 ( V_16 ) ) {
V_12 = F_10 ( V_9 , V_11 , V_15 -> V_4 , V_29 ) ;
if ( V_12 < 0 )
return V_12 ;
V_15 -> V_18 = 1 ;
return 0 ;
}
return F_3 ( V_16 ) ? - V_26 : - V_6 ;
}
