...
struct V_36 * V_43 ;
struct V_38 * V_39 ;
struct V_44 * V_45 = F_27 ( V_2 -> V_41 ) ;
int V_5 = 0 ;
if ( V_26 == V_29 ) {
V_43 = V_2 -> V_21 ;
V_39 = V_2 -> V_23 ;
...
V_5 = F_29 ( & V_43 [ V_19 ] , V_39 [ V_19 ] . V_48 ,
V_45 -> V_42 ) ;
if ( V_5 < 0 )
return V_5 ;
}
...
if ( V_5 < 0 )
goto V_58;
V_39 -> V_59 = 0x00000000ffffffffuLL ;
V_5 = F_40 ( V_37 , V_2 -> V_41 , V_26 , V_60 ) ;
if ( V_5 < 0 ) {
F_41 ( V_37 ) ;
F_42 ( V_39 ) ;
}
