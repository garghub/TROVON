...
int F_132 ( struct V_28 * V_28 , T_2 V_164 , T_2 V_165 ,
int V_166 )
{
struct V_6 * V_6 = V_28 -> V_167 -> V_127 ;
int V_168 ;
...
if ( V_168 )
return V_168 ;
return F_133 ( V_6 -> V_172 -> V_173 , V_153 , NULL ) ;
}
int F_134 ( unsigned V_174 , T_7 V_175 )
{
T_7 V_176 = V_175 - 1 ;
T_7 V_177 =
V_176 >> ( V_11 - V_174 ) ;
...
int F_135 ( struct V_28 * V_28 , T_2 V_164 , T_2 V_165 , int V_166 )
{
return 0 ;
}
void F_136 ( void * V_40 )
{
F_117 ( V_40 ) ;
}
static int F_137 ( struct V_120 * V_120 )
{
return 0 ;
}
struct V_6 * F_138 ( struct V_78 * V_79 )
{
static const struct V_179 V_180 = {
. F_81 = F_137 ,
} ;
struct V_6 * V_6 = F_139 ( V_79 ) ;
if ( ! V_6 )
return F_7 ( - V_31 ) ;
V_6 -> V_64 = F_140 () ;
V_6 -> V_9 -> V_181 = & V_180 ;
...
int
F_143 ( struct V_28 * V_65 , long V_187 , struct V_188 * * V_189 ,
void * * V_190 )
{
return - V_56 ;
}
const char * F_144 ( struct V_7 * V_7 , struct V_6 * V_6 ,
struct V_191 * V_192 )
{
return V_6 -> V_193 ;
}
static struct V_7 * F_145 ( struct V_6 * V_21 , struct V_7 * V_7 , unsigned int V_22 )
{
return F_7 ( - V_194 ) ;
}
static int F_146 ( const struct V_1 * V_1 , struct V_2 * V_3 ,
T_1 V_4 , unsigned int V_5 )
{
struct V_6 * V_6 = F_2 ( V_1 -> V_7 ) ;
F_3 ( V_6 , V_3 ) ;
...
static int F_147 ( struct V_7 * V_7 , struct V_116 * V_158 )
{
return - V_195 ;
}
static T_3 F_148 ( struct V_7 * V_7 , char * V_196 , T_5 V_150 )
{
return - V_197 ;
}
static T_2 F_149 ( struct V_28 * V_28 , T_2 V_53 , int V_54 )
{
return F_150 ( V_28 , V_53 , V_54 , 2 , 2 ) ;
}
static int F_151 ( struct V_28 * V_28 , struct V_59 * V_60 )
{
F_36 ( V_28 , V_60 ) ;
return 0 ;
}
void F_152 ( struct V_6 * V_6 )
{
F_84 ( V_6 , 2 ) ;
