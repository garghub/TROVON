...
V_15 = F_22 ( V_3 -> V_87 [ V_4 ] ) ;
V_84 = F_23 ( V_3 -> V_87 [ V_4 ] ) ;
F_2 ( ( V_84 << 6 ) | V_15 , V_2 -> V_6 + V_33 + V_4 ) ;
}
V_85 = F_24 ( V_3 -> V_87 [ 0 ] ) ;
...
static void F_27 ( struct V_1 * V_2 , int V_100 )
{
...
V_102 = 0xf0 ;
V_103 = F_29 ( V_2 , V_22 , V_94 , V_19 , V_102 ) ;
if ( V_103 )
return V_103 ;
F_27 ( V_2 , ( V_22 -> V_104 & 0x01 ) | ( ( V_22 -> V_104 & 0x10 ) >> 3 ) ) ;
return V_94 -> V_96 ;
}
...
unsigned int * V_19 )
{
unsigned int V_107 = F_22 ( V_94 -> V_95 ) ;
int V_4 ;
for ( V_4 = 0 ; V_4 < V_94 -> V_96 ; V_4 ++ ) {
...
V_24 = F_36 ( V_2 , sizeof( * V_24 ) ) ;
if ( ! V_24 )
return - V_117 ;
V_103 = F_37 ( V_2 ) ;
if ( V_103 < 0 )
return V_103 ;
V_2 -> V_6 = F_38 ( V_112 , 0 ) ;
if ( ! V_2 -> V_6 )
return - V_117 ;
if ( V_112 -> V_38 ) {
V_103 = F_39 ( V_112 -> V_38 , F_12 , V_118 ,
V_2 -> V_115 , V_2 ) ;
if ( V_103 == 0 )
V_2 -> V_38 = V_112 -> V_38 ;
}
...
static int F_42 ( struct V_111 * V_2 ,
const struct V_149 * V_150 )
{
return F_43 ( V_2 , & V_151 , V_150 -> V_152 ) ;
}
