...
F_19 ( V_13 , V_56 , 0x0100 , 0x0100 ) ;
F_19 ( V_13 , V_57 , 0x0100 , 0x0100 ) ;
F_19 ( V_13 , V_58 , 0x0100 , 0x0100 ) ;
F_19 ( V_13 , V_59 , 0x0100 , 0x0100 ) ;
F_19 ( V_13 , V_60 , 0x0100 , 0x0100 ) ;
F_19 ( V_13 , V_61 , 0x0100 , 0x0100 ) ;
F_19 ( V_13 , V_62 , 0x0100 , 0x0100 ) ;
F_19 ( V_13 , V_63 , 0x0100 , 0x0100 ) ;
return V_55 ;
}
...
struct V_66 * V_66 ;
int V_55 ;
V_15 = F_21 ( & V_65 -> V_67 , sizeof( struct V_14 ) ,
V_68 ) ;
if ( V_15 == NULL )
return - V_69 ;
V_66 = F_22 ( V_65 , & V_70 ) ;
...
struct V_66 * V_66 ;
int V_55 ;
V_15 = F_21 ( & V_74 -> V_67 , sizeof( struct V_14 ) ,
V_68 ) ;
if ( V_15 == NULL )
return - V_69 ;
F_30 ( V_74 , V_15 ) ;
...
static int F_32 ( struct V_73 * V_77 )
{
F_28 ( & V_77 -> V_67 ) ;
return 0 ;
}
