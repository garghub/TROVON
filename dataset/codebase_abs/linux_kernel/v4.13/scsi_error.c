...
goto V_204;
case V_205 :
return ( V_18 -> V_38 -> V_206 & V_207 ) ;
case V_208 :
return ( V_18 -> V_38 -> V_206 & V_209 ) ;
case V_210 :
if ( F_55 ( V_18 -> V_121 ) == V_124 &&
F_56 ( V_18 -> V_121 ) == V_131 )
return 0 ;
case V_211 :
return ( V_18 -> V_38 -> V_206 & V_212 ) ;
}
if ( F_56 ( V_18 -> V_121 ) != V_127 )
return 0 ;
V_204:
if ( V_18 -> V_38 -> V_206 & V_209 ||
F_27 ( V_18 -> V_38 ) )
return 1 ;
else
return 0 ;
...
static void F_108 ( struct V_38 * V_46 , T_1 V_227 )
{
F_109 ( V_46 -> V_228 , V_46 ) ;
}
static void F_110 ( struct V_20 * V_21 )
{
struct V_38 * V_46 ;
struct V_229 * V_230 ;
V_46 = F_111 ( V_21 -> V_194 , V_231 , V_232 ) ;
if ( F_112 ( V_46 ) )
return;
V_230 = F_113 ( V_46 ) ;
V_230 -> V_233 [ 0 ] = V_234 ;
...
V_230 -> V_233 [ 4 ] = V_235 ;
V_230 -> V_233 [ 5 ] = 0 ;
V_230 -> V_150 = F_72 ( V_230 -> V_233 [ 0 ] ) ;
V_46 -> V_236 |= V_237 ;
V_46 -> V_174 = 10 * V_37 ;
V_230 -> V_28 = 5 ;
F_114 ( V_46 -> V_228 , NULL , V_46 , 1 , F_108 ) ;
}
...
unsigned long V_7 ;
F_40 (sdev, shost) {
if ( F_37 ( V_21 ) && V_21 -> V_142 && V_21 -> V_238 ) {
F_110 ( V_21 ) ;
V_21 -> V_142 = 0 ;
}
}
...
F_94 ( & V_2 -> V_44 , & V_243 ) ;
F_10 ( V_2 -> V_8 , V_7 ) ;
F_5 ( 1 , F_39 ( V_2 , & V_243 ) ) ;
if ( ! F_85 ( & V_243 , & V_244 ) )
F_119 ( V_2 , & V_243 , & V_244 ) ;
F_8 ( V_2 -> V_8 , V_7 ) ;
if ( V_2 -> V_13 != - 1 )
V_2 -> V_12 = 0 ;
F_10 ( V_2 -> V_8 , V_7 ) ;
...
void F_132 ( struct V_1 * V_2 , int V_119 , int V_252 )
{
struct V_20 * V_21 ;
F_130 (sdev, shost) {
if ( V_119 == F_131 ( V_21 ) &&
...
static void
F_134 ( struct V_17 * V_18 )
{
}
int
F_135 ( struct V_20 * V_253 , int T_2 * V_254 )
{
struct V_17 * V_18 ;
struct V_1 * V_2 = V_253 -> V_24 ;
struct V_38 * V_230 ;
unsigned long V_7 ;
int error = 0 , V_23 , V_255 ;
if ( ! F_136 ( V_256 ) || ! F_136 ( V_257 ) )
return - V_258 ;
error = F_137 ( V_255 , V_254 ) ;
if ( error )
return error ;
if ( F_128 ( V_2 ) < 0 )
return - V_259 ;
error = - V_259 ;
V_230 = F_138 ( sizeof( struct V_38 ) + sizeof( struct V_17 ) +
V_2 -> V_25 -> V_260 , V_232 ) ;
if ( ! V_230 )
goto V_261;
F_139 ( NULL , V_230 ) ;
V_18 = (struct V_17 * ) ( V_230 + 1 ) ;
F_140 ( V_253 , V_18 ) ;
V_18 -> V_38 = V_230 ;
V_18 -> V_84 = F_113 ( V_230 ) -> V_233 ;
V_18 -> V_86 = F_134 ;
memset ( & V_18 -> V_153 , 0 , sizeof( V_18 -> V_153 ) ) ;
V_18 -> V_150 = 0 ;
V_18 -> V_152 = V_262 ;
...
bool F_47 ( const struct V_17 * V_233 ,
struct V_62 * V_63 )
{
return F_143 ( V_233 -> V_89 ,
V_161 , V_63 ) ;
}
bool F_144 ( const T_3 * V_89 , int V_270 ,
T_4 * V_271 )
{
const T_3 * V_272 ;
if ( V_270 < 7 )
...
case 0x72 :
case 0x73 :
V_272 = F_146 ( V_89 , V_270 ,
0 ) ;
if ( V_272 && ( 0xa == V_272 [ 1 ] ) ) {
* V_271 = F_147 ( & V_272 [ 4 ] ) ;
return true ;
}
return false ;
