...
static int F_40 ( struct V_37 * V_13 )
{
int V_72 ;
switch ( V_73 ) {
default:
...
static struct V_118 * F_104 ( struct V_180 * V_65 ,
struct V_120 * V_121 ,
struct V_189 * V_190 )
{
struct V_118 * V_119 ;
...
static int F_133 ( struct V_37 * V_13 )
{
int V_40 ;
if ( V_13 -> V_278 )
return 0 ;
V_40 = F_134 ( V_13 -> V_279 ) ;
if ( V_40 )
return V_40 ;
V_40 = F_134 ( V_13 -> V_280 ) ;
if ( V_40 ) {
F_135 ( V_13 -> V_279 ) ;
return V_40 ;
}
...
static void F_136 ( struct V_37 * V_13 )
{
if ( ! V_13 -> V_278 )
return;
F_135 ( V_13 -> V_280 ) ;
...
static int F_137 ( struct V_37 * V_13 )
{
unsigned long V_122 ;
int V_40 ;
V_40 = F_133 ( V_13 ) ;
...
static void F_138 ( struct V_37 * V_13 )
{
unsigned long V_122 ;
F_78 ( & V_13 -> V_14 , V_122 ) ;
V_13 -> V_65 . V_153 = V_154 ;
...
static T_9 F_139 ( int V_256 , void * V_257 )
{
struct V_37 * V_13 = V_257 ;
int V_283 ;
F_93 ( 10 ) ;
...
{
int V_40 ;
struct V_37 * V_13 = F_143 ( V_65 , struct V_37 , V_65 ) ;
unsigned long V_122 ;
F_78 ( & V_13 -> V_14 , V_122 ) ;
V_13 -> V_183 = 1 << V_188 ;
V_13 -> V_167 = V_167 ;
...
static int F_147 ( struct V_180 * V_65 )
{
struct V_37 * V_13 = F_143 ( V_65 , struct V_37 , V_65 ) ;
if ( F_47 ( V_13 -> V_83 ) )
F_146 ( F_145 ( V_13 -> V_83 ) ) ;
...
static void F_148 ( struct V_37 * V_13 , int V_85 )
{
F_149 ( V_13 -> V_289 , V_290 , V_291 ,
V_85 ? V_291 : 0 ) ;
}
static void F_150 ( struct V_37 * V_13 )
{
F_149 ( V_13 -> V_289 , V_290 , V_291 , 0 ) ;
F_149 ( V_13 -> V_289 , V_290 , V_291 ,
V_291 ) ;
}
static struct V_3 * F_151 ( struct V_292 * V_60 ,
struct V_37 * V_13 )
{
T_5 V_81 ;
const char * V_46 ;
...
V_298 = F_152 ( V_301 , V_295 ) ;
if ( ! V_298 )
return F_153 ( - V_131 ) ;
V_13 -> V_86 = V_298 -> V_39 ;
V_13 -> V_289 = F_154 ( L_67 ) ;
if ( F_34 ( V_13 -> V_289 ) )
V_13 -> V_289 = F_154 ( L_68 ) ;
if ( V_13 -> V_86 && F_34 ( V_13 -> V_289 ) )
return F_155 ( V_13 -> V_289 ) ;
V_13 -> V_270 = 0 ;
V_13 -> V_83 = F_156 ( V_295 , L_69 , 0 ,
& V_122 ) ;
V_13 -> V_84 = ( V_122 & V_302 ) ? 1 : 0 ;
if ( V_73 == 0 ) {
V_299 = NULL ;
while ( ( V_299 = F_157 ( V_295 , V_299 ) ) )
V_13 -> V_270 ++ ;
V_13 -> V_198 = 1 ;
} else {
V_13 -> V_270 = F_40 ( V_13 ) ;
}
V_300 = F_158 ( & V_60 -> V_61 , sizeof( struct V_3 ) * V_13 -> V_270 ,
V_11 ) ;
if ( ! V_300 )
return F_153 ( - V_12 ) ;
...
V_299 = NULL ;
V_38 = 0 ;
while ( ( V_299 = F_157 ( V_295 , V_299 ) ) && V_38 < V_13 -> V_270 ) {
V_4 = & V_300 [ V_38 ] ;
V_40 = F_159 ( V_299 , L_70 , & V_81 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_71 , V_40 ) ;
goto V_288;
}
V_4 -> V_126 = V_73 ? V_13 -> V_74 [ V_38 ] . V_304 : V_81 ;
V_40 = F_159 ( V_299 , L_72 , & V_81 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_73 , V_40 ) ;
goto V_288;
}
if ( V_73 ) {
if ( V_81 < V_13 -> V_74 [ V_38 ] . V_129 ) {
F_128 ( & V_60 -> V_61 ,
L_74 ) ;
V_4 -> V_129 = V_81 ;
} else {
V_4 -> V_129 = V_13 -> V_74 [ V_38 ] . V_129 ;
}
} else {
V_4 -> V_129 = V_81 ;
}
V_40 = F_159 ( V_299 , L_75 , & V_81 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_76 , V_40 ) ;
goto V_288;
}
if ( V_73 ) {
if ( V_81 < V_13 -> V_74 [ V_38 ] . V_192 ) {
F_128 ( & V_60 -> V_61 ,
L_77 ) ;
V_4 -> V_192 = V_81 ;
} else {
V_4 -> V_192 = V_13 -> V_74 [ V_38 ] . V_192 ;
}
} else {
V_4 -> V_192 = V_81 ;
}
V_4 -> V_53 = F_160 ( V_299 , L_78 ) ;
V_4 -> V_139 = F_160 ( V_299 , L_79 ) ;
V_40 = F_161 ( V_299 , L_80 , & V_46 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_81 , V_40 ) ;
goto V_288;
}
sprintf ( V_4 -> V_46 , L_82 , V_4 -> V_126 ) ;
V_4 -> V_4 . V_46 = V_4 -> V_46 ;
V_4 -> V_305 = V_13 -> V_43 + F_162 ( V_38 ) ;
V_4 -> V_306 = V_13 -> V_43 + F_163 ( V_38 ) ;
V_4 -> V_92 = V_13 -> V_92 + F_164 ( V_38 ) ;
V_4 -> V_4 . V_307 = & V_308 ;
F_108 ( & V_4 -> V_4 , V_4 -> V_129 ) ;
V_4 -> V_13 = V_13 ;
F_3 ( & V_4 -> V_17 ) ;
...
static struct V_3 * F_165 ( struct V_292 * V_60 ,
struct V_37 * V_13 )
{
struct V_317 * V_318 = F_166 ( & V_60 -> V_61 ) ;
struct V_3 * V_300 ;
int V_38 ;
if ( ! V_318 )
return F_153 ( - V_319 ) ;
V_300 = F_158 ( & V_60 -> V_61 , sizeof( struct V_3 ) * V_318 -> V_270 ,
V_11 ) ;
if ( ! V_300 )
return F_153 ( - V_12 ) ;
V_13 -> V_65 . V_71 = & V_300 [ 0 ] . V_4 ;
...
static int F_167 ( struct V_292 * V_60 )
{
struct V_63 * V_43 , * V_92 ;
struct V_320 * V_279 , * V_280 ;
struct V_37 * V_13 ;
int V_256 , V_40 , V_38 ;
V_13 = F_158 ( & V_60 -> V_61 , sizeof( * V_13 ) , V_11 ) ;
if ( ! V_13 )
return - V_12 ;
V_13 -> V_65 = V_321 ;
F_3 ( & V_13 -> V_65 . V_303 ) ;
...
if ( V_256 < 0 )
return V_256 ;
V_279 = F_169 ( & V_60 -> V_61 , L_84 ) ;
if ( F_34 ( V_279 ) )
return F_170 ( V_279 ) ;
V_280 = F_169 ( & V_60 -> V_61 , L_85 ) ;
if ( F_34 ( V_280 ) )
return F_170 ( V_280 ) ;
F_171 ( & V_13 -> V_14 ) ;
F_172 ( & V_13 -> V_284 ) ;
...
V_13 -> V_83 = - V_175 ;
V_40 = - V_12 ;
V_13 -> V_43 = F_173 ( & V_60 -> V_61 , V_43 -> V_323 , F_37 ( V_43 ) ) ;
if ( ! V_13 -> V_43 ) {
F_31 ( & V_60 -> V_61 , L_86 ) ;
return V_40 ;
}
...
V_13 -> V_92 = F_173 ( & V_60 -> V_61 , V_92 -> V_323 , F_37 ( V_92 ) ) ;
if ( ! V_13 -> V_92 ) {
F_31 ( & V_60 -> V_61 , L_88 ) ;
return V_40 ;
}
F_117 ( & V_60 -> V_61 , L_89 ,
...
F_135 ( V_279 ) ;
if ( V_60 -> V_61 . V_296 )
V_13 -> V_3 = F_151 ( V_60 , V_13 ) ;
else
V_13 -> V_3 = F_165 ( V_60 , V_13 ) ;
F_49 ( V_13 , 0 ) ;
if ( F_34 ( V_13 -> V_3 ) )
return F_170 ( V_13 -> V_3 ) ;
V_40 = F_175 ( & V_60 -> V_61 , V_256 , F_130 , 0 ,
L_91 , V_13 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_92 ,
V_256 , V_40 ) ;
...
V_13 -> V_256 = V_256 ;
if ( F_47 ( V_13 -> V_83 ) ) {
if ( ! F_176 ( & V_60 -> V_61 , V_13 -> V_83 , L_91 ) ) {
F_177 ( F_145 ( V_13 -> V_83 ) ,
V_324 ) ;
V_40 = F_178 ( & V_60 -> V_61 ,
F_145 ( V_13 -> V_83 ) , NULL ,
F_139 , V_325 ,
L_91 , V_13 ) ;
if ( V_40 ) {
V_13 -> V_83 = - V_175 ;
...
V_40 = F_179 ( & V_60 -> V_61 , & V_13 -> V_65 ) ;
if ( V_40 )
return V_40 ;
F_180 ( & V_60 -> V_61 , 1 ) ;
F_33 ( V_13 ) ;
...
static int F_181 ( struct V_292 * V_60 )
{
struct V_37 * V_13 ;
int V_38 ;
V_13 = F_182 ( V_60 ) ;
...
static int F_184 ( struct V_207 * V_61 )
{
struct V_37 * V_13 = F_185 ( V_61 ) ;
if ( ! V_13 -> V_167 )
return 0 ;
F_140 ( & V_13 -> V_284 ) ;
if ( ! F_186 ( V_61 ) ) {
...
if ( F_47 ( V_13 -> V_83 ) ) {
F_138 ( V_13 ) ;
F_187 ( F_145 ( V_13 -> V_83 ) ) ;
}
V_42:
F_141 ( & V_13 -> V_284 ) ;
return 0 ;
}
static int F_188 ( struct V_207 * V_61 )
{
struct V_37 * V_13 = F_185 ( V_61 ) ;
if ( ! V_13 -> V_167 )
return 0 ;
if ( F_186 ( V_61 ) && F_47 ( V_13 -> V_83 ) )
F_189 ( F_145 ( V_13 -> V_83 ) ) ;
F_140 ( & V_13 -> V_284 ) ;
V_13 -> V_285 = F_46 ( V_13 ) ;
if ( V_13 -> V_285 )
F_137 ( V_13 ) ;
