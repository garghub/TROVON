...
struct V_323 * V_324 ;
int V_281 ;
V_322 = F_177 ( V_320 -> V_188 . V_325 , L_122 , 0 ) ;
if ( ! V_322 ) {
...
if ( V_281 != 0 )
goto V_328;
V_281 = F_183 ( & V_329 , V_189 , 1 , V_330 ) ;
if ( V_281 != 0 ) {
F_31 ( V_12 ,
L_124 ) ;
goto V_328;
...
F_184 ( & V_331 , & V_332 ) ;
V_331 . V_333 = V_334 ;
V_281 = F_185 ( & V_331 , V_329 , 1 ) ;
if ( V_281 != 0 ) {
F_31 ( V_12 ,
L_125 ) ;
goto V_335;
}
V_336 = F_186 ( V_334 , V_330 ) ;
V_281 = F_187 ( V_336 ) ;
if ( F_174 ( V_336 ) )
goto V_337;
V_338 = F_188 ( V_336 , NULL ,
V_329 , NULL , L_126 ) ;
V_281 = F_187 ( V_338 ) ;
if ( F_174 ( V_338 ) )
goto V_339;
