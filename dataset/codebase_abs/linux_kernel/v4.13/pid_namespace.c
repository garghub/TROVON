...
static void F_70 ( struct V_103 * V_20 )
{
F_37 ( F_65 ( V_20 ) ) ;
}
static int F_71 ( struct V_104 * V_104 , struct V_103 * V_20 )
{
struct V_19 * V_106 = F_35 ( V_56 ) ;
struct V_19 * V_107 , * V_108 = F_65 ( V_20 ) ;
if ( ! F_60 ( V_108 -> V_25 , V_91 ) ||
! F_60 ( F_72 () , V_91 ) )
return - V_92 ;
...
return - V_57 ;
F_37 ( V_104 -> V_105 ) ;
V_104 -> V_105 = F_22 ( V_108 ) ;
return 0 ;
}
static struct V_103 * F_73 ( struct V_103 * V_20 )
{
struct V_19 * V_106 = F_35 ( V_56 ) ;
...
static struct V_23 * F_74 ( struct V_103 * V_20 )
{
return F_65 ( V_20 ) -> V_25 ;
}
static T_4 int F_75 ( void )
{
V_33 = F_76 ( V_19 , V_109 ) ;
#ifdef F_77
F_78 ( V_110 , V_111 ) ;
#endif
return 0 ;
