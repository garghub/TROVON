...
static T_3 F_41 ( int V_12 , void * V_17 )
{
struct V_1 * V_1 = V_17 ;
T_4 V_35 ;
int V_9 = 0 ;
...
struct V_51 * V_52 ;
int V_26 , V_9 = 0 ;
for ( V_26 = 0 ; V_26 < V_48 -> V_53 ; V_26 ++ ) {
V_50 = & V_48 -> V_54 [ V_26 ] ;
...
static void F_62 ( struct V_60 * V_61 , int V_14 )
{
const char * V_55 ;
switch ( V_14 ) {
case V_72 :
...
F_63 ( & V_61 -> V_3 , L_13 , V_55 , V_14 ) ;
}
static int F_64 ( struct V_60 * V_61 ,
const struct V_78 * V_56 )
{
struct V_47 * V_48 = F_65 ( & V_61 -> V_3 ) ;
struct V_1 * V_1 ;
int V_9 ;
int V_14 ;
...
NULL , 0 , V_1 -> V_13 ) ;
if ( V_9 < 0 ) {
F_42 ( & V_61 -> V_3 , L_18 , V_9 ) ;
goto V_84;
}
V_9 = F_53 ( V_1 , V_48 ) ;
if ( V_9 ) {
F_42 ( & V_61 -> V_3 , L_19 , V_9 ) ;
goto V_85;
}
if ( V_48 -> V_66 && ! V_86 ) {
V_68 = & V_61 -> V_3 ;
