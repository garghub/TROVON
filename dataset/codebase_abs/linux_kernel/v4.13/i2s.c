...
static struct V_1 * F_67 ( struct V_168 * V_40 , bool V_169 )
{
struct V_1 * V_2 ;
V_2 = F_68 ( & V_40 -> V_41 , sizeof( struct V_1 ) , V_170 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_40 = V_40 ;
V_2 -> V_3 = NULL ;
V_2 -> V_13 = NULL ;
V_2 -> V_171 . V_172 = 1 ;
V_2 -> V_171 . V_173 = F_64 ;
V_2 -> V_171 . remove = F_66 ;
V_2 -> V_171 . V_174 = & V_175 ;
V_2 -> V_171 . V_176 = F_60 ;
V_2 -> V_171 . V_177 = F_62 ;
V_2 -> V_171 . V_178 . V_179 = 1 ;
V_2 -> V_171 . V_178 . V_180 = 2 ;
V_2 -> V_171 . V_178 . V_181 = V_182 ;
V_2 -> V_171 . V_178 . V_183 = V_184 ;
if ( ! V_169 ) {
V_2 -> V_171 . V_147 . V_179 = 1 ;
V_2 -> V_171 . V_147 . V_180 = 2 ;
V_2 -> V_171 . V_147 . V_181 = V_182 ;
V_2 -> V_171 . V_147 . V_183 = V_184 ;
}
return V_2 ;
}
static int F_69 ( struct V_185 * V_41 )
{
struct V_1 * V_2 = F_70 ( V_41 ) ;
V_2 -> V_186 = F_3 ( V_2 -> V_5 + V_6 ) ;
V_2 -> V_187 = F_3 ( V_2 -> V_5 + V_10 ) ;
V_2 -> V_188 = F_3 ( V_2 -> V_5 + V_145 ) ;
if ( V_2 -> V_89 )
F_35 ( V_2 -> V_89 ) ;
F_35 ( V_2 -> V_189 ) ;
return 0 ;
}
static int F_71 ( struct V_185 * V_41 )
{
struct V_1 * V_2 = F_70 ( V_41 ) ;
F_41 ( V_2 -> V_189 ) ;
if ( V_2 -> V_89 )
F_41 ( V_2 -> V_89 ) ;
F_20 ( V_2 -> V_187 , V_2 -> V_5 + V_10 ) ;
F_20 ( V_2 -> V_186 , V_2 -> V_5 + V_6 ) ;
F_20 ( V_2 -> V_188 , V_2 -> V_5 + V_145 ) ;
return 0 ;
}
static void F_72 ( struct V_1 * V_2 )
{
int V_190 ;
for ( V_190 = 0 ; V_190 < V_2 -> V_191 . V_192 ; V_190 ++ ) {
if ( ! F_34 ( V_2 -> V_193 [ V_190 ] ) )
F_73 ( V_2 -> V_193 [ V_190 ] ) ;
}
}
static void F_74 ( struct V_168 * V_40 )
{
struct V_1 * V_2 = F_70 ( & V_40 -> V_41 ) ;
F_75 ( V_40 -> V_41 . V_194 ) ;
F_72 ( V_2 ) ;
}
static int F_76 ( struct V_168 * V_40 )
{
struct V_185 * V_41 = & V_40 -> V_41 ;
struct V_1 * V_2 = F_70 ( V_41 ) ;
const char * V_195 [ 2 ] = { L_5 , L_4 } ;
const char * V_196 [ 2 ] = { NULL } ;
const struct V_68 * V_197 = V_2 -> V_7 ;
struct V_189 * V_198 ;
int V_76 , V_190 ;
if ( ! F_77 ( V_41 -> V_194 , L_15 , NULL ) )
return 0 ;
for ( V_190 = 0 ; V_190 < F_78 ( V_196 ) ; V_190 ++ ) {
V_198 = F_38 ( V_41 , V_195 [ V_190 ] ) ;
if ( F_34 ( V_198 ) )
continue;
V_196 [ V_190 ] = F_79 ( V_198 ) ;
F_36 ( V_198 ) ;
}
if ( ! ( V_2 -> V_37 & V_88 ) ) {
T_1 V_63 = F_3 ( V_2 -> V_5 + V_145 ) ;
F_20 ( V_63 | V_144 , V_2 -> V_5 + V_145 ) ;
V_2 -> V_193 [ V_199 ] = F_80 ( V_41 ,
L_16 , V_196 , F_78 ( V_196 ) ,
V_200 | V_201 ,
V_2 -> V_5 + V_6 , V_197 -> V_73 ,
1 , 0 , V_2 -> V_77 ) ;
V_2 -> V_193 [ V_202 ] = F_81 ( V_41 ,
L_17 , L_16 ,
V_201 ,
...
F_82 ( V_41 -> V_194 ,
L_18 , 0 , & V_195 [ 0 ] ) ;
V_2 -> V_193 [ V_203 ] = F_83 ( V_41 , V_195 [ 0 ] ,
V_196 [ 0 ] , V_201 ,
V_2 -> V_5 + V_6 , V_197 -> V_71 ,
V_204 , V_2 -> V_77 ) ;
V_2 -> V_191 . V_192 += 1 ;
V_2 -> V_191 . V_205 = V_2 -> V_193 ;
V_76 = F_84 ( V_41 -> V_194 , V_206 ,
& V_2 -> V_191 ) ;
if ( V_76 < 0 ) {
F_23 ( V_41 , L_19 , V_76 ) ;
F_72 ( V_2 ) ;
...
struct V_207 * V_208 = V_40 -> V_41 . V_209 ;
struct V_210 * V_211 ;
T_1 V_212 , V_37 = 0 , V_213 = 0 ;
struct V_214 * V_215 = V_40 -> V_41 . V_194 ;
const struct V_216 * V_217 ;
int V_76 ;
if ( F_86 ( V_218 ) && V_40 -> V_41 . V_194 )
V_217 = F_87 ( & V_40 -> V_41 ) ;
else
V_217 = (struct V_216 * )
F_88 ( V_40 ) -> V_219 ;
V_3 = F_67 ( V_40 , false ) ;
...
V_3 -> V_125 . V_222 = V_208 -> V_125 ;
V_3 -> V_127 . V_222 = V_208 -> V_127 ;
V_3 -> V_223 = V_208 -> V_224 ;
V_37 = V_208 -> type . V_37 ;
V_213 = V_208 -> type . V_213 ;
} else {
V_37 = V_217 -> V_37 ;
if ( F_90 ( V_215 , L_22 ,
& V_213 ) ) {
...
V_211 = F_92 ( V_40 , V_225 , 0 ) ;
V_3 -> V_5 = F_93 ( & V_40 -> V_41 , V_211 ) ;
if ( F_34 ( V_3 -> V_5 ) )
return F_40 ( V_3 -> V_5 ) ;
V_212 = V_211 -> V_226 ;
V_3 -> V_189 = F_94 ( & V_40 -> V_41 , L_25 ) ;
if ( F_34 ( V_3 -> V_189 ) ) {
F_23 ( & V_40 -> V_41 , L_26 ) ;
return F_40 ( V_3 -> V_189 ) ;
}
V_76 = F_41 ( V_3 -> V_189 ) ;
if ( V_76 != 0 ) {
...
V_3 -> V_125 . V_5 = V_212 + V_227 ;
V_3 -> V_127 . V_5 = V_212 + V_228 ;
...
V_13 -> V_77 = & V_3 -> V_221 ;
V_13 -> V_7 = V_3 -> V_7 ;
V_13 -> V_125 . V_5 = V_212 + V_235 ;
V_13 -> V_125 . V_229 = L_31 ;
if ( ! V_215 ) {
V_13 -> V_125 . V_222 = V_208 -> V_236 ;
V_13 -> V_223 = V_208 -> V_224 ;
}
V_13 -> V_125 . V_126 = 4 ;
V_13 -> V_5 = V_3 -> V_5 ;
V_13 -> V_189 = V_3 -> V_189 ;
V_13 -> V_37 = V_37 ;
V_13 -> V_167 . V_5 = V_213 ;
V_13 -> V_3 = V_3 ;
V_3 -> V_13 = V_13 ;
V_76 = F_95 ( & V_40 -> V_41 ,
...
if ( V_208 && V_208 -> V_237 && V_208 -> V_237 ( V_40 ) ) {
F_23 ( & V_40 -> V_41 , L_32 ) ;
V_76 = - V_92 ;
goto V_232;
}
