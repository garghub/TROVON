...
{
int V_129 ;
V_129 = F_51 ( & V_127 -> V_45 , F_52 ( 32 ) ) ;
if ( V_129 ) {
F_53 ( & V_127 -> V_45 , L_10 ) ;
return V_129 ;
}
V_129 = F_54 ( & V_127 -> V_45 , F_52 ( 32 ) ) ;
if ( V_129 ) {
F_53 ( & V_127 -> V_45 , L_11 ) ;
return V_129 ;
}
return 0 ;
}
...
{
unsigned int V_132 = ( unsigned int ) V_131 -> V_133 ;
const struct V_134 * V_135 [] = { & V_136 [ V_132 ] , NULL } ;
struct V_76 * V_77 ;
void T_1 * V_128 ;
int V_129 , V_79 ;
F_56 ( & V_127 -> V_45 , V_137 ) ;
V_77 = F_57 ( & V_127 -> V_45 , V_135 , V_125 ) ;
if ( ! V_77 )
return - V_118 ;
V_129 = F_58 ( V_127 ) ;
if ( V_129 )
return V_129 ;
if ( ( F_59 ( V_127 , 4 ) & V_138 ) == 0 )
return - V_139 ;
V_129 = F_60 ( V_127 , 1 << V_123 , V_140 ) ;
if ( V_129 )
return V_129 ;
V_77 -> V_122 = F_61 ( V_127 ) ;
...
for ( V_79 = 0 ; V_79 < V_125 ; ++ V_79 ) {
struct V_3 * V_4 = V_77 -> V_81 [ V_79 ] ;
void T_1 * V_141 = F_62 ( V_128 , V_79 ) ;
unsigned int V_142 = V_141 - V_128 ;
F_43 ( & V_4 -> V_14 , V_141 ) ;
F_63 ( V_4 , V_123 , - 1 , L_12 ) ;
F_63 ( V_4 , V_123 , V_142 , L_13 ) ;
}
F_49 ( V_77 , V_132 ) ;
F_64 ( V_127 ) ;
return F_65 ( V_77 , V_127 -> V_99 , F_39 , V_143 ,
& V_144 ) ;
}
