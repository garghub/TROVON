...
static int
F_44 ( struct V_38 * V_39 , T_1 V_40 , T_1 V_22 ,
struct V_3 * V_4 ,
struct V_1 * V_20 ,
struct V_18 * V_19 ,
struct V_23 * V_24 ,
...
static int
F_47 ( struct V_38 * V_39 , T_1 V_40 , T_1 V_22 ,
struct V_3 * V_4 ,
struct V_1 * V_20 ,
...
static void
F_48 ( struct V_38 * V_39 , struct V_57 * V_58 ,
struct V_3 * V_4 ,
struct V_1 * V_20 )
{
struct V_65 * V_66 = V_4 -> V_67 ;
...
static int F_49 ( struct V_23 * V_86 ,
struct V_1 * V_87 ,
struct V_23 * V_88 ,
struct V_1 * V_89 )
{
...
static bool F_51 ( struct V_23 * V_86 ,
struct V_1 * V_87 ,
struct V_23 * V_88 ,
struct V_1 * V_89 )
{
...
{
F_53 ( & V_4 -> V_95 . V_96 , 50 ) ;
}
static T_2 F_54 ( struct V_3 * V_4 ,
char * V_97 , T_3 V_98 )
{
T_1 V_99 , V_100 ;
if ( ! F_55 ( V_4 -> V_5 , V_97 ,
L_7 ,
& V_100 ) )
return - V_101 ;
V_99 = F_56 ( & V_4 -> V_95 . V_96 ) ;
F_53 ( & V_4 -> V_95 . V_96 , V_100 ) ;
if ( V_99 != V_100 )
F_57 ( V_4 ) ;
return V_98 ;
}
static T_2 F_58 ( struct V_3 * V_4 , char * V_97 )
{
T_1 V_100 = F_56 ( & V_4 -> V_95 . V_96 ) ;
return sprintf ( V_97 , L_8 , V_100 / 10 , V_100 % 10 ) ;
}
static int F_59 ( struct V_102 * V_103 , T_1 * V_104 )
{
...
* V_104 = F_60 ( T_1 , * V_104 , V_103 -> V_107 ) ;
V_10 = 0 ;
V_11:
if ( V_106 )
F_43 ( V_106 ) ;
...
bool V_10 = false ;
V_94 = F_56 ( & V_4 -> V_95 . V_96 ) ;
V_108 = F_66 ( V_4 , V_111 ) ;
if ( ! V_108 ) {
V_10 = true ;
goto V_11;
}
if ( F_59 ( V_108 , & V_113 ) < 0 ) {
V_10 = true ;
goto V_11;
}
V_112 = F_66 ( V_4 , V_19 ) ;
...
static int F_72 ( struct V_38 * V_39 , T_1 V_40 , T_1 V_22 ,
struct V_3 * V_4 ,
struct V_102 * V_103 )
{
struct V_25 * V_105 = NULL ;
...
static void F_74 ( struct V_38 * V_39 , struct V_57 * V_58 ,
struct V_3 * V_4 )
{
int V_40 = F_39 ( V_58 -> V_62 ) . V_40 ;
struct V_102 * V_103 ;
...
if ( V_56 ++ < V_123 )
continue;
if ( F_72 ( V_39 , V_40 , V_58 -> V_63 -> V_64 ,
V_4 , V_103 ) ) {
V_123 = V_56 - 1 ;
goto V_124;
}
...
{
F_53 ( & V_2 -> V_14 . V_125 , 0 ) ;
F_53 ( & V_2 -> V_14 . V_126 , 500 ) ;
}
