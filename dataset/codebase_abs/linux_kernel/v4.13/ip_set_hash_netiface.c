...
static inline bool
F_44 ( const struct V_68 * V_2 ,
const struct V_68 * V_3 ,
T_1 * V_4 )
{
return F_45 ( & V_2 -> V_5 . V_69 , & V_3 -> V_5 . V_69 ) &&
V_2 -> V_6 == V_3 -> V_6 &&
( ++ * V_4 ) &&
V_2 -> V_7 == V_3 -> V_7 &&
strcmp ( V_2 -> V_8 , V_3 -> V_8 ) == 0 ;
...
static inline int
F_46 ( const struct V_68 * V_9 )
{
return V_9 -> V_10 ? - V_11 : 1 ;
}
static inline void
F_47 ( struct V_68 * V_9 , T_1 V_12 )
{
V_9 -> V_10 = ( V_12 >> 16 ) & V_13 ;
}
static inline void
F_48 ( struct V_68 * V_9 , T_2 * V_12 )
{
F_5 ( * V_12 , V_9 -> V_10 ) ;
}
static inline void
F_49 ( struct V_68 * V_9 , T_2 V_6 )
{
F_50 ( & V_9 -> V_5 , V_6 ) ;
V_9 -> V_6 = V_6 ;
}
...
if ( V_16 -> V_10 )
V_12 |= V_13 ;
if ( F_52 ( V_15 , V_18 , & V_16 -> V_5 . V_69 ) ||
F_10 ( V_15 , V_19 , V_16 -> V_6 ) ||
F_11 ( V_15 , V_20 , V_16 -> V_8 ) ||
( V_12 &&
F_12 ( V_15 , V_21 , F_13 ( V_12 ) ) ) )
...
static inline void
F_53 ( struct V_68 * V_23 ,
const struct V_68 * V_24 )
{
}
static int
F_54 ( struct V_28 * V_29 , const struct V_14 * V_15 ,
const struct V_30 * V_31 ,
enum V_32 V_33 , struct V_34 * V_35 )
{
...
if ( V_33 == V_45 )
V_40 . V_6 = V_42 ;
F_55 ( V_15 , V_35 -> V_12 & V_46 , & V_40 . V_5 . V_69 ) ;
F_50 ( & V_40 . V_5 , V_40 . V_6 ) ;
if ( V_35 -> V_47 & V_17 ) {
#if F_25 ( V_48 )
const char * V_49 = F_24 ? F_15 ( V_15 ) :
F_17 ( V_15 ) ;
...
static int
F_56 ( struct V_28 * V_29 , struct V_53 * V_54 [] ,
enum V_32 V_33 , T_1 * V_55 , T_1 V_12 , bool V_56 )
{
T_3 V_38 = V_29 -> V_39 -> V_33 [ V_33 ] ;
