...
int V_17 ;
F_104 ( & V_167 , V_163 , V_164 ) ;
F_104 ( & V_168 , V_12 -> V_162 , V_161 ) ;
while ( V_66 ) {
T_7 V_169 = F_105 ( V_164 , V_66 , ( T_7 ) V_161 ) ;
F_106 ( V_12 -> V_147 , & V_167 , & V_168 ,
V_169 , V_12 -> V_50 ) ;
V_17 = F_107 ( V_12 -> V_147 ) ;
switch ( V_17 ) {
case 0 :
break;
case - V_151 :
