...
struct V_3 * V_3 ;
int V_4 ;
V_3 = F_26 ( & V_83 -> V_2 , sizeof( struct V_3 ) , V_55 ) ;
if ( V_3 == NULL )
return - V_56 ;
F_41 ( V_83 , V_3 ) ;
V_3 -> V_2 = & V_83 -> V_2 ;
V_3 -> V_41 = V_83 -> V_41 ;
if ( V_83 -> V_2 . V_31 ) {
V_87 = F_42 ( V_88 , & V_83 -> V_2 ) ;
if ( V_87 )
V_3 -> type = (enum V_89 ) V_87 -> V_90 ;
} else {
V_3 -> type = V_85 -> V_91 ;
}
V_3 -> V_14 = F_43 ( V_83 , & V_92 ) ;
if ( F_44 ( V_3 -> V_14 ) ) {
V_4 = F_45 ( V_3 -> V_14 ) ;
F_4 ( V_3 -> V_2 , L_32 ,
V_4 ) ;
...
return F_21 ( V_3 , V_83 -> V_41 ) ;
}
static int F_46 ( struct V_82 * V_83 )
{
struct V_3 * V_3 = F_47 ( V_83 ) ;
F_38 ( V_3 ) ;
return 0 ;
}
