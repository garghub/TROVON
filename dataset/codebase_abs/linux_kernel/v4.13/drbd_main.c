...
F_192 ( & V_5 -> V_409 ) ;
F_192 ( & V_5 -> V_410 ) ;
F_192 ( & V_5 -> V_411 . V_412 ) ;
F_192 ( & V_5 -> V_413 . V_412 ) ;
F_192 ( & V_5 -> V_414 . V_415 . V_412 ) ;
F_192 ( & V_5 -> V_416 [ 0 ] ) ;
F_192 ( & V_5 -> V_416 [ 1 ] ) ;
F_192 ( & V_5 -> V_417 [ 0 ] ) ;
F_192 ( & V_5 -> V_417 [ 1 ] ) ;
V_5 -> V_411 . V_418 = V_419 ;
V_5 -> V_413 . V_418 = V_420 ;
V_5 -> V_414 . V_415 . V_418 = V_421 ;
F_193 ( & V_5 -> V_422 ) ;
F_193 ( & V_5 -> V_423 ) ;
F_193 ( & V_5 -> V_424 ) ;
F_193 ( & V_5 -> V_425 ) ;
...
void F_195 ( struct V_4 * V_5 )
{
int V_158 ;
if ( F_22 ( V_5 ) -> V_14 -> V_439 . V_52 != V_56 )
F_11 ( V_5 , L_27 ,
F_22 ( V_5 ) -> V_14 -> V_439 . V_52 ) ;
V_5 -> V_440 =
V_5 -> V_441 =
V_5 -> V_442 =
V_5 -> V_443 =
...
F_199 ( V_5 , V_5 -> V_128 ) ;
V_5 -> V_128 = NULL ;
F_167 ( V_454 , & V_5 -> V_44 ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_405 ) ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_406 ) ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_407 ) ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_408 ) ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_409 ) ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_410 ) ) ;
F_97 ( V_5 , F_200 ( & F_22 ( V_5 ) -> V_14 -> V_455 . V_183 ) ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_411 . V_412 ) ) ;
F_97 ( V_5 , F_200 ( & V_5 -> V_413 . V_412 ) ) ;
F_188 ( V_5 ) ;
}
...
while ( V_456 ) {
V_295 = V_456 ;
V_456 = (struct V_295 * ) F_202 ( V_295 ) ;
F_203 ( V_295 ) ;
V_457 -- ;
}
if ( V_458 )
...
{
struct V_295 * V_295 ;
const int V_466 = ( V_206 / V_316 ) * V_467 ;
int V_158 ;
V_461 = NULL ;
V_462 = NULL ;
V_463 = NULL ;
...
goto V_468;
V_464 = F_208 (
L_30 , sizeof( struct V_469 ) , 0 , 0 , NULL ) ;
if ( V_464 == NULL )
goto V_468;
V_465 = F_208 (
L_31 , sizeof( struct V_470 ) , 0 , 0 , NULL ) ;
if ( V_465 == NULL )
goto V_468;
V_458 = F_209 ( V_471 , 0 , V_472 ) ;
if ( V_458 == NULL )
goto V_468;
V_3 = F_209 ( V_473 , 0 ,
V_474 |
...
if ( V_461 == NULL )
goto V_468;
V_460 = F_211 ( V_466 , V_462 ) ;
if ( V_460 == NULL )
goto V_468;
F_33 ( & V_475 ) ;
for ( V_158 = 0 ; V_158 < V_466 ; V_158 ++ ) {
V_295 = F_212 ( V_476 ) ;
if ( ! V_295 )
goto V_468;
F_213 ( V_295 , ( unsigned long ) V_456 ) ;
V_456 = V_295 ;
}
V_457 = V_466 ;
return 0 ;
...
{
int V_478 ;
V_478 = F_215 ( V_5 , & V_5 -> V_405 ) ;
if ( V_478 )
F_11 ( V_5 , L_32 , V_478 ) ;
V_478 = F_215 ( V_5 , & V_5 -> V_406 ) ;
if ( V_478 )
F_11 ( V_5 , L_33 , V_478 ) ;
V_478 = F_215 ( V_5 , & V_5 -> V_408 ) ;
if ( V_478 )
F_11 ( V_5 , L_34 , V_478 ) ;
V_478 = F_215 ( V_5 , & V_5 -> V_407 ) ;
if ( V_478 )
F_11 ( V_5 , L_35 , V_478 ) ;
V_478 = F_215 ( V_5 , & V_5 -> V_409 ) ;
if ( V_478 )
F_11 ( V_5 , L_36 , V_478 ) ;
}
void F_216 ( struct V_58 * V_58 )
{
struct V_4 * V_5 = F_217 ( V_58 , struct V_4 , V_58 ) ;
...
if ( V_5 -> V_261 )
F_198 ( V_5 ) ;
F_203 ( V_5 -> V_399 . V_295 ) ;
F_221 ( V_5 -> V_483 ) ;
F_222 ( V_5 -> V_194 ) ;
F_55 ( V_5 -> V_484 ) ;
F_223 (peer_device, tmp_peer_device, device) {
...
static void F_224 ( struct V_485 * V_486 )
{
struct V_487 * V_488 = F_217 ( V_486 , struct V_487 , V_489 ) ;
F_225 ( V_490 ) ;
struct V_17 * V_19 , * V_237 ;
F_9 ( & V_488 -> V_491 ) ;
F_226 ( & V_488 -> V_490 , & V_490 ) ;
F_14 ( & V_488 -> V_491 ) ;
...
bool V_493 ;
V_493 =
F_135 ( F_227 ( & V_19 -> V_494 ) == 0 ) &&
F_135 ( V_19 -> V_25 & V_495 ) &&
F_135 ( ( V_19 -> V_25 & V_38 ) == 0 ||
( V_19 -> V_25 & V_496 ) != 0 ) ;
if ( ! V_493 )
F_11 ( V_5 , L_37 ,
V_19 , F_227 ( & V_19 -> V_494 ) ,
V_19 -> V_25 ) ;
...
void F_230 ( struct V_17 * V_19 )
{
unsigned long V_44 ;
F_24 ( & V_488 . V_491 , V_44 ) ;
F_231 ( & V_19 -> V_498 , & V_488 . V_490 ) ;
F_26 ( & V_488 . V_491 , V_44 ) ;
F_232 ( V_19 -> V_5 ) ;
F_233 ( V_488 . V_499 , & V_488 . V_489 ) ;
}
void V_60 ( struct V_58 * V_58 )
{
struct V_43 * V_22 =
F_217 ( V_58 , struct V_43 , V_58 ) ;
F_234 ( & V_22 -> V_500 ) ;
F_235 ( V_22 -> V_76 ) ;
F_55 ( V_22 -> V_48 ) ;
...
void F_236 ( struct V_43 * V_22 )
{
struct V_13 * V_14 , * V_237 ;
F_237 (connection, tmp, resource) {
F_238 ( & V_14 -> V_501 ) ;
F_239 ( V_14 ) ;
F_29 ( & V_14 -> V_58 , V_59 ) ;
}
...
F_244 () ;
F_245 () ;
F_246 (&drbd_devices, device, i)
F_247 ( V_5 ) ;
F_248 (resource, tmp, &drbd_resources) {
F_238 ( & V_22 -> V_503 ) ;
F_236 ( V_22 ) ;
}
F_201 () ;
...
static int F_251 ( void * V_506 , int V_507 )
{
...
static void F_254 ( struct V_514 * V_499 )
{
F_33 ( & V_499 -> V_515 ) ;
F_192 ( & V_499 -> V_183 ) ;
F_194 ( & V_499 -> V_516 ) ;
}
static int F_255 ( struct V_517 * V_415 , int V_518 )
{
struct V_519 * V_519 =
F_217 ( V_415 , struct V_519 , V_415 ) ;
F_256 ( & V_519 -> V_520 ) ;
return 0 ;
}
void F_257 ( struct V_514 * V_521 )
{
struct V_519 V_519 ;
V_519 . V_415 . V_418 = F_255 ;
F_37 ( & V_519 . V_520 ) ;
F_258 ( V_521 , & V_519 . V_415 ) ;
F_44 ( & V_519 . V_520 ) ;
}
struct V_43 * F_259 ( const char * V_48 )
{
struct V_43 * V_22 ;
if ( ! V_48 || ! V_48 [ 0 ] )
return NULL ;
...
struct V_13 * F_260 ( void * V_523 , int V_524 ,
...
static int F_262 ( struct V_102 * V_104 )
{
V_104 -> V_527 = ( void * ) F_263 ( V_80 ) ;
if ( ! V_104 -> V_527 )
return - V_477 ;
V_104 -> V_105 = ( void * ) F_263 ( V_80 ) ;
if ( ! V_104 -> V_105 )
return - V_477 ;
return 0 ;
}
static void F_264 ( struct V_102 * V_104 )
{
F_265 ( ( unsigned long ) V_104 -> V_105 ) ;
F_265 ( ( unsigned long ) V_104 -> V_527 ) ;
}
void F_266 ( struct V_13 * V_14 )
{
F_267 ( V_14 ) ;
F_268 ( V_14 -> V_528 ) ;
F_268 ( V_14 -> V_529 ) ;
...
int F_270 ( struct V_43 * V_22 , struct V_533 * V_533 )
{
struct V_13 * V_14 ;
T_2 V_534 ;
int V_110 ;
...
V_110 = F_272 ( V_533 -> V_76 , V_535 ,
F_273 ( V_534 ) , V_79 ) ;
if ( V_110 == - V_536 ) {
T_2 V_537 ;
if ( F_271 ( & V_537 , V_80 ) ) {
F_56 ( V_537 ) ;
F_274 ( V_534 , V_534 , V_537 ) ;
F_166 ( V_22 , L_40 ,
V_533 -> V_76 ,
...
if ( F_275 ( V_534 ) )
F_50 ( & V_534 ) ;
if ( ! F_276 ( V_22 -> V_76 , V_534 ) ) {
F_277 ( V_22 -> V_76 , V_534 ) ;
F_261 (connection, resource) {
V_14 -> V_439 . V_65 = 1 ;
V_14 -> V_289 . V_65 = 1 ;
V_14 -> V_489 . V_65 = 1 ;
...
struct V_43 * F_278 ( const char * V_48 )
{
struct V_43 * V_22 ;
V_22 = F_51 ( sizeof( struct V_43 ) , V_80 ) ;
if ( ! V_22 )
goto V_538;
V_22 -> V_48 = F_279 ( V_48 , V_80 ) ;
if ( ! V_22 -> V_48 )
goto V_539;
if ( ! F_271 ( & V_22 -> V_76 , V_80 ) )
goto V_540;
F_280 ( & V_22 -> V_58 ) ;
F_281 ( & V_22 -> V_500 ) ;
F_192 ( & V_22 -> V_501 ) ;
V_22 -> V_541 = V_542 ;
F_282 ( & V_22 -> V_503 , & V_543 ) ;
F_191 ( & V_22 -> V_544 ) ;
F_191 ( & V_22 -> V_545 ) ;
F_33 ( & V_22 -> V_23 ) ;
F_283 ( V_22 ) ;
...
struct V_13 * F_284 ( const char * V_48 , struct V_533 * V_533 )
{
struct V_43 * V_22 ;
struct V_13 * V_14 ;
...
F_281 ( & V_14 -> V_75 ) ;
F_254 ( & V_14 -> V_455 ) ;
F_191 ( & V_14 -> V_108 . V_106 ) ;
F_191 ( & V_14 -> V_114 . V_106 ) ;
F_31 ( V_22 , & V_14 -> V_439 , V_557 , L_44 ) ;
V_14 -> V_439 . V_14 = V_14 ;
...
{
struct V_13 * V_14 = F_217 ( V_58 , struct V_13 , V_58 ) ;
struct V_43 * V_22 = V_14 -> V_22 ;
if ( F_227 ( & V_14 -> V_546 -> V_561 ) != 0 )
F_11 ( V_14 , L_47 , F_227 ( & V_14 -> V_546 -> V_561 ) ) ;
F_55 ( V_14 -> V_546 ) ;
F_234 ( & V_14 -> V_75 ) ;
F_264 ( & V_14 -> V_114 ) ;
F_264 ( & V_14 -> V_108 ) ;
...
{
V_5 -> V_562 . V_499 =
F_287 ( L_48 , V_563 , V_5 -> V_74 ) ;
if ( ! V_5 -> V_562 . V_499 )
return - V_477 ;
F_288 ( & V_5 -> V_562 . V_489 , V_564 ) ;
F_192 ( & V_5 -> V_562 . V_490 ) ;
return 0 ;
}
enum V_565 F_289 ( struct V_566 * V_567 , unsigned int V_74 )
{
...
V_11 -> V_371 = V_5 ;
V_5 -> V_210 = F_294 ( F_295 ( V_504 , V_74 ) ) ;
V_5 -> V_210 -> V_580 = V_5 -> V_210 ;
V_183 -> V_512 -> V_581 = F_251 ;
V_183 -> V_512 -> V_506 = V_5 ;
F_296 ( V_183 , V_582 ) ;
F_297 ( V_183 , true , true ) ;
F_298 ( V_183 , V_437 >> 8 ) ;
V_183 -> V_583 = & V_22 -> V_23 ;
V_5 -> V_399 . V_295 = F_212 ( V_80 ) ;
if ( ! V_5 -> V_399 . V_295 )
goto V_584;
if ( F_299 ( V_5 ) )
goto V_585;
V_5 -> V_586 = V_587 ;
V_5 -> V_588 = V_587 ;
V_568 = F_300 ( & V_505 , V_5 , V_74 , V_74 + 1 , V_80 ) ;
if ( V_568 < 0 ) {
if ( V_568 == - V_589 )
V_110 = V_570 ;
goto V_590;
...
F_36 ( & V_5 -> V_58 ) ;
V_568 = F_300 ( & V_22 -> V_500 , V_5 , V_73 , V_73 + 1 , V_80 ) ;
if ( V_568 < 0 ) {
if ( V_568 == - V_589 )
V_110 = V_570 ;
goto V_591;
...
F_192 ( & V_5 -> V_75 ) ;
F_192 ( & V_5 -> V_592 ) ;
F_301 (connection, resource) {
V_72 = F_51 ( sizeof( struct V_71 ) , V_80 ) ;
if ( ! V_72 )
goto V_593;
V_72 -> V_14 = V_14 ;
V_72 -> V_5 = V_5 ;
F_302 ( & V_72 -> V_75 , & V_5 -> V_75 ) ;
F_36 ( & V_5 -> V_58 ) ;
V_568 = F_300 ( & V_14 -> V_75 , V_72 , V_73 , V_73 + 1 , V_80 ) ;
if ( V_568 < 0 ) {
if ( V_568 == - V_589 )
V_110 = V_594 ;
goto V_593;
...
F_303 ( V_11 ) ;
V_5 -> V_10 . V_32 = F_304 ( V_22 ) -> V_264 ;
if ( V_5 -> V_10 . V_32 == V_265 ) {
F_305 (peer_device, device)
F_306 ( V_72 ) ;
}
F_305 (peer_device, device)
F_307 ( V_72 ) ;
...
return V_598 ;
V_597:
F_309 ( & V_14 -> V_75 , V_73 ) ;
V_593:
F_301 (connection, resource) {
V_72 = F_309 ( & V_14 -> V_75 , V_73 ) ;
if ( V_72 )
F_29 ( & V_14 -> V_58 , V_59 ) ;
}
F_223 (peer_device, tmp_peer_device, device) {
...
F_312 ( V_5 ) ;
F_301 (connection, resource) {
F_309 ( & V_14 -> V_75 , V_5 -> V_73 ) ;
F_29 ( & V_5 -> V_58 , F_216 ) ;
}
F_309 ( & V_22 -> V_500 , V_5 -> V_73 ) ;
F_29 ( & V_5 -> V_58 , F_216 ) ;
F_309 ( & V_505 , F_48 ( V_5 ) ) ;
F_29 ( & V_5 -> V_58 , F_216 ) ;
F_313 ( V_5 -> V_483 ) ;
F_310 () ;
F_29 ( & V_5 -> V_58 , F_216 ) ;
}
static int T_7 F_314 ( void )
{
int V_110 ;
if ( V_467 < V_599 || V_467 > V_600 ) {
F_315 ( L_50 , V_467 ) ;
#ifdef F_316
return - V_601 ;
#else
...
goto V_538;
V_110 = - V_477 ;
V_502 = F_319 ( L_38 , V_605 | V_606 , NULL , & V_607 , NULL ) ;
if ( ! V_502 ) {
F_315 ( L_53 ) ;
goto V_538;
}
V_488 . V_499 = F_320 ( L_54 ) ;
if ( ! V_488 . V_499 ) {
F_315 ( L_55 ) ;
goto V_538;
}
F_288 ( & V_488 . V_489 , F_224 ) ;
F_33 ( & V_488 . V_491 ) ;
F_192 ( & V_488 . V_490 ) ;
if ( F_321 () )
F_322 ( L_56 ) ;
...
static void F_324 ( struct V_102 * V_612 )
{
struct V_104 * V_24 ;
F_71 ( & V_612 -> V_106 ) ;
V_24 = V_612 -> V_104 ;
...
void F_327 ( struct V_13 * V_14 )
{
struct V_71 * V_72 ;
int V_73 ;
F_46 () ;
F_246 (&connection->peer_devices, peer_device, vnr) {
struct V_4 * V_5 = V_72 -> V_5 ;
F_36 ( & V_5 -> V_58 ) ;
F_49 () ;
F_100 ( V_5 ) ;
...
void F_328 ( struct V_4 * V_5 , void * V_247 )
{
...
V_100 -> V_625 = F_64 ( V_5 -> V_436 ) ;
V_100 -> V_626 = F_64 ( V_5 -> V_128 -> V_160 . V_626 ) ;
V_100 -> V_627 = F_64 ( V_5 -> V_128 -> V_160 . V_627 ) ;
F_97 ( V_5 , F_329 ( V_5 -> V_128 ) == V_5 -> V_128 -> V_160 . V_628 ) ;
V_268 = V_5 -> V_128 -> V_160 . V_628 ;
if ( F_330 ( V_5 , V_5 -> V_128 , V_268 , V_629 ) ) {
F_11 ( V_5 , L_64 ) ;
F_331 ( V_5 , 1 , V_630 ) ;
}
}
...
F_332 ( & V_5 -> V_423 ) ;
if ( ! F_333 ( V_631 , & V_5 -> V_44 ) )
return;
if ( ! F_89 ( V_5 , V_632 ) )
return;
V_100 = F_334 ( V_5 , V_305 ) ;
if ( ! V_100 )
goto V_344;
F_328 ( V_5 , V_100 ) ;
...
static int F_336 ( struct V_4 * V_5 ,
struct V_614 * V_633 ,
struct V_634 * V_635 )
{
T_5 V_626 = F_337 ( V_633 -> V_626 ) ;
T_5 V_627 = F_337 ( V_633 -> V_627 ) ;
T_3 V_636 ;
if ( V_626 == 0 && V_627 == 0 ) {
V_626 = 1 ;
V_627 = V_637 / 8 ;
...
static int F_338 ( struct V_4 * V_5 , struct V_638 * V_368 )
{
...
goto V_110;
if ( V_639 - V_635 -> V_617 < F_339 ( V_368 ) )
goto V_110;
...
int F_340 ( struct V_4 * V_5 , struct V_638 * V_368 )
{
struct V_614 * V_100 ;
T_5 V_92 , V_44 ;
int V_158 , V_355 = V_598 ;
if ( V_5 -> V_10 . V_11 != V_387 )
return V_646 ;
V_100 = F_334 ( V_5 , V_305 ) ;
if ( ! V_100 )
return V_569 ;
V_368 -> V_160 . V_644 = V_368 -> V_120 -> V_644 ;
V_368 -> V_160 . V_628 = F_329 ( V_368 ) ;
V_368 -> V_160 . V_617 = 8 ;
if ( F_330 ( V_5 , V_368 , V_368 -> V_160 . V_628 ,
V_647 ) ) {
F_11 ( V_5 , L_69 ) ;
V_355 = V_648 ;
goto V_110;
}
V_92 = F_337 ( V_100 -> V_92 ) ;
V_44 = F_337 ( V_100 -> V_44 ) ;
if ( V_92 == V_616 ||
...
if ( F_337 ( V_100 -> V_621 ) != V_622 ) {
F_11 ( V_5 , L_73 ,
F_337 ( V_100 -> V_621 ) , V_622 ) ;
goto V_110;
}
V_368 -> V_160 . V_615 = F_341 ( V_100 -> V_615 ) ;
for ( V_158 = V_162 ; V_158 < V_163 ; V_158 ++ )
V_368 -> V_160 . V_164 [ V_158 ] = F_341 ( V_100 -> V_164 [ V_158 ] ) ;
V_368 -> V_160 . V_44 = F_337 ( V_100 -> V_44 ) ;
V_368 -> V_160 . V_623 = F_341 ( V_100 -> V_623 ) ;
V_368 -> V_160 . V_617 = F_337 ( V_100 -> V_617 ) ;
V_368 -> V_160 . V_618 = F_337 ( V_100 -> V_618 ) ;
V_368 -> V_160 . V_624 = F_337 ( V_100 -> V_624 ) ;
if ( F_336 ( V_5 , V_100 , & V_368 -> V_160 ) )
goto V_110;
if ( F_338 ( V_5 , V_368 ) )
goto V_110;
if ( F_337 ( V_100 -> V_624 ) != V_368 -> V_160 . V_624 ) {
F_11 ( V_5 , L_74 ,
F_337 ( V_100 -> V_624 ) , V_368 -> V_160 . V_624 ) ;
goto V_110;
}
if ( F_337 ( V_100 -> V_617 ) != V_368 -> V_160 . V_617 ) {
F_11 ( V_5 , L_75 ,
F_337 ( V_100 -> V_617 ) , V_368 -> V_160 . V_617 ) ;
goto V_110;
}
V_355 = V_598 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
...
unsigned int V_384 ;
V_384 = F_337 ( V_100 -> V_625 ) ;
V_384 = F_342 ( V_384 , V_437 ) ;
V_5 -> V_436 = V_384 ;
}
F_14 ( & V_5 -> V_22 -> V_23 ) ;
V_110:
...
void F_343 ( struct V_4 * V_5 , unsigned int line , const char * F_32 )
{
if ( ! F_344 ( V_631 , & V_5 -> V_44 ) ) {
F_345 ( & V_5 -> V_423 , V_654 + V_655 ) ;
V_5 -> V_656 . line = line ;
V_5 -> V_656 . F_32 = F_32 ;
}
}
...
{
if ( ! F_344 ( V_631 , & V_5 -> V_44 ) )
F_345 ( & V_5 -> V_423 , V_654 + 5 * V_655 ) ;
}
void F_347 ( struct V_4 * V_5 ) __must_hold( T_9 )
{
int V_158 ;
for ( V_158 = V_173 ; V_158 < V_174 ; V_158 ++ )
V_5 -> V_128 -> V_160 . V_164 [ V_158 + 1 ] = V_5 -> V_128 -> V_160 . V_164 [ V_158 ] ;
}
void F_348 ( struct V_4 * V_5 , int V_657 , T_3 V_217 ) __must_hold( T_9 )
{
if ( V_657 == V_162 ) {
if ( V_5 -> V_10 . V_373 == V_374 )
V_217 |= 1 ;
...
void F_351 ( struct V_4 * V_5 ) __must_hold( T_9 )
{
T_3 V_217 ;
...
F_348 ( V_5 , V_162 , V_217 ) ;
F_14 ( & V_5 -> V_128 -> V_160 . V_161 ) ;
F_95 ( V_5 , L_77 ) ;
F_100 ( V_5 ) ;
}
void F_352 ( struct V_4 * V_5 , T_3 V_217 ) __must_hold( T_9 )
{
unsigned long V_44 ;
...
int F_353 ( struct V_4 * V_5 ) __must_hold( T_9 )
{
int V_355 = - V_115 ;
F_354 ( V_5 , V_262 ) ;
F_100 ( V_5 ) ;
...
static int V_421 ( struct V_517 * V_415 , int V_659 )
{
struct V_4 * V_5 =
F_217 ( V_415 , struct V_4 , V_414 . V_415 ) ;
struct V_414 * V_660 = & V_5 -> V_414 ;
int V_355 = - V_115 ;
if ( V_660 -> V_44 != V_661 ) {
int V_662 = F_227 ( & V_5 -> V_390 ) ;
if ( V_662 )
F_11 ( V_5 , L_78 ,
V_662 , V_660 -> V_663 ) ;
}
if ( F_84 ( V_5 ) ) {
F_358 ( V_5 , V_660 -> V_663 , V_660 -> V_44 ) ;
V_355 = V_660 -> V_664 ( V_5 ) ;
F_359 ( V_5 ) ;
F_85 ( V_5 ) ;
}
F_360 ( V_665 , & V_5 -> V_44 ) ;
F_7 ( & V_5 -> V_12 ) ;
if ( V_660 -> V_520 )
...
F_97 ( V_5 , F_200 ( & V_5 -> V_414 . V_415 . V_412 ) ) ;
if ( V_5 -> V_414 . V_663 )
F_11 ( V_5 , L_79 ,
V_663 , V_5 -> V_414 . V_663 ) ;
V_5 -> V_414 . V_664 = V_664 ;
V_5 -> V_414 . V_520 = V_520 ;
V_5 -> V_414 . V_663 = V_663 ;
V_5 -> V_414 . V_44 = V_44 ;
F_9 ( & V_5 -> V_22 -> V_23 ) ;
F_159 ( V_665 , & V_5 -> V_44 ) ;
if ( V_44 == V_661 || F_227 ( & V_5 -> V_390 ) == 0 ) {
if ( ! F_344 ( V_666 , & V_5 -> V_44 ) )
F_258 ( & F_22 ( V_5 ) -> V_14 -> V_455 ,
& V_5 -> V_414 . V_415 ) ;
}
F_14 ( & V_5 -> V_22 -> V_23 ) ;
}
int F_362 ( struct V_4 * V_5 , int (* V_664)( struct V_4 * ) ,
char * V_663 , enum V_667 V_44 )
{
...
void F_354 ( struct V_4 * V_5 , int V_672 ) __must_hold( T_9 )
{
...
const char * F_366 ( enum V_89 V_90 )
{
...
int F_368 ( struct V_4 * V_5 , struct V_704 * V_158 )
{
struct V_118 * V_119 ;
F_369 ( V_67 ) ;
long V_705 ;
...
F_71 ( & V_604 ) ;
F_375 () ;
F_376 (resource, &drbd_resources)
F_377 ( & V_22 -> V_23 , V_158 ++ ) ;
}
void F_378 ( void )
{
struct V_43 * V_22 ;
...
return F_382 ( V_712 -> V_10 ) ;
}
static char *
F_383 ( unsigned int type ) {
static char * V_718 [] = {
[ V_719 ] = L_133 ,
[ V_720 ] = L_134 ,
[ V_721 ] = L_135 ,
...
unsigned int
F_384 ( struct V_4 * V_5 , unsigned int type )
{
static struct V_711 V_730 = { 0 , 0 } ;
unsigned int V_731 = (
( V_732 == 0 ||
( ( 1 << F_48 ( V_5 ) ) & V_732 ) != 0 ) &&
( ( ( F_381 ( & V_730 ) % 100 ) + 1 ) <= V_733 ) ) ;
if ( V_731 ) {
V_734 ++ ;
if ( F_385 ( & V_735 ) )
F_166 ( V_5 , L_144 ,
