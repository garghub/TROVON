...
if ( 0 != V_77 -> V_69 )
return - V_60 ;
strcpy ( V_77 -> V_70 , L_11 ) ;
V_77 -> V_78 = V_79 | V_80 ;
V_77 -> V_81 = V_82 ;
V_77 -> V_83 = V_84 ;
F_2 ( V_5 , L_19 , V_77 -> type ) ;
return 0 ;
}
...
sizeof( V_148 -> V_150 ) ) ;
sprintf ( V_148 -> V_153 , L_23 , F_48 ( V_4 -> V_154 ) ) ;
V_148 -> V_155 =
V_156 |
V_157 |
V_158 ;
...
if ( V_86 -> V_69 != 0 )
return - V_60 ;
F_47 ( V_86 -> V_163 , L_24 , sizeof( V_86 -> V_163 ) ) ;
V_86 -> V_164 = V_165 ;
return 0 ;
}
...
return NULL ;
* V_222 = * V_221 ;
snprintf ( V_222 -> V_70 , sizeof( V_222 -> V_70 ) , L_51 , V_4 -> V_70 ,
