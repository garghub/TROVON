...
static int F_21 ( struct V_70 * V_71 , unsigned V_51 )
{
...
static void F_25 ( struct V_70 * V_71 , unsigned V_51 ,
int V_78 )
{
struct V_3 * V_4 = F_22 ( V_71 ) ;
struct V_24 * V_24 = V_4 -> V_24 ;
...
V_79 = ! ! ( V_19 & V_75 ) ;
if ( V_78 )
V_19 = ( V_79 ) ? 0 : F_24 ( V_51 ) ;
else
V_19 = ( V_79 ) ? F_24 ( V_51 ) : 0 ;
V_21 = F_12 ( V_24 , V_77 ,
F_24 ( V_51 ) , V_19 ) ;
if ( V_21 < 0 )
F_13 ( V_4 -> V_22 ,
...
static int F_26 ( struct V_70 * V_71 , unsigned V_51 )
{
return F_27 ( V_71 -> V_80 + V_51 ) ;
}
static int F_28 ( struct V_70 * V_71 ,
unsigned V_51 , int V_78 )
{
F_25 ( V_71 , V_51 , V_78 ) ;
return F_29 ( V_71 -> V_80 + V_51 ) ;
}
static int F_30 ( struct V_70 * V_71 , unsigned V_51 )
{
struct V_3 * V_4 = F_22 ( V_71 ) ;
return F_31 ( V_4 -> V_24 , V_51 ) ;
}
static int F_32 ( struct V_81 * V_82 )
{
struct V_3 * V_4 ;
int V_21 ;
V_4 = F_33 ( & V_82 -> V_22 , sizeof( * V_4 ) , V_83 ) ;
if ( ! V_4 )
return - V_84 ;
V_4 -> V_22 = & V_82 -> V_22 ;
V_4 -> V_22 -> V_85 = V_82 -> V_22 . V_86 -> V_85 ;
V_4 -> V_24 = F_34 ( V_82 -> V_22 . V_86 ) ;
F_35 ( V_82 , V_4 ) ;
V_4 -> V_9 = V_87 ;
V_4 -> V_10 = F_36 ( V_87 ) ;
V_4 -> V_14 = V_88 ;
...
V_4 -> V_7 = V_89 ;
V_4 -> V_5 = F_36 ( V_89 ) ;
V_90 . V_8 = F_37 ( & V_82 -> V_22 ) ;
V_90 . V_9 = V_87 ;
V_90 . V_11 = F_36 ( V_87 ) ;
V_4 -> V_91 = F_38 ( & V_82 -> V_22 , & V_90 ,
V_4 ) ;
if ( F_39 ( V_4 -> V_91 ) ) {
F_13 ( & V_82 -> V_22 , L_11 ) ;
return F_40 ( V_4 -> V_91 ) ;
}
V_4 -> V_70 = V_92 ;
V_4 -> V_70 . V_86 = & V_82 -> V_22 ;
V_4 -> V_70 . V_85 = V_82 -> V_22 . V_86 -> V_85 ;
V_21 = F_41 ( & V_4 -> V_70 , V_4 ) ;
if ( V_21 < 0 ) {
F_13 ( & V_82 -> V_22 , L_12 , V_21 ) ;
return V_21 ;
}
V_21 = F_42 ( & V_4 -> V_70 , F_37 ( & V_82 -> V_22 ) ,
0 , 0 , V_93 ) ;
if ( V_21 < 0 ) {
