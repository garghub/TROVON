...
F_26 ( V_68 , V_70 ,
( L_5 ,
V_26 -> V_35 , V_2 -> V_61 [ 0 ] , V_2 -> V_61 [ 1 ] ,
V_2 -> V_61 [ 2 ] , V_2 -> V_61 [ 3 ] , V_2 -> V_61 [ 4 ] ,
V_2 -> V_61 [ 5 ] ) ) ;
V_26 -> V_35 -- ;
F_5 ( & V_2 -> V_9 ) ;
F_6 ( & V_2 -> V_10 ) ;
...
struct V_96 * V_97 ;
struct V_63 * V_98 ;
struct V_63 * V_99 = & V_73 -> V_100 . V_101 ;
V_56 = & V_2 -> V_59 [ V_27 ] ;
F_19 ( & V_56 -> V_60 ) ;
V_98 = & V_56 -> V_78 ;
F_17 ( & V_98 -> V_4 ) ;
...
V_2 -> V_111 = 0 ;
V_2 -> V_112 = 0 ;
V_26 -> V_38 &= ~ F_34 ( V_2 -> V_113 ) ;
V_26 -> V_39 &= ~ F_34 ( V_2 -> V_113 ) ;
if ( ( V_2 -> V_113 > 0 ) && ( V_26 -> V_114 [ V_2 -> V_113 - 1 ] == V_2 ) ) {
V_26 -> V_114 [ V_2 -> V_113 - 1 ] = NULL ;
V_2 -> V_113 = 0 ;
}
V_2 -> V_23 = 0 ;
#endif
...
void F_35 ( struct V_83 * V_73 )
{
struct V_52 * V_54 , * V_53 ;
T_2 V_57 ;
struct V_1 * V_2 = NULL ;
struct V_25 * V_26 = & V_73 -> V_48 ;
struct V_1 * V_115 = F_36 ( V_73 ) ;
if ( V_26 -> V_35 == 1 )
return;
F_17 ( & V_26 -> V_34 ) ;
for ( V_57 = 0 ; V_57 < V_29 ; V_57 ++ ) {
...
struct V_1 * F_37 ( struct V_25 * V_26 , V_3 * V_61 )
{
struct V_52 * V_54 , * V_53 ;
struct V_1 * V_2 = NULL ;
T_1 V_57 ;
V_3 * V_116 ;
V_3 V_117 [ V_67 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
if ( ! V_61 )
return NULL ;
if ( F_38 ( V_61 ) )
V_116 = V_117 ;
...
while ( V_53 != V_54 ) {
V_2 = F_18 ( V_54 , struct V_1 , V_6 ) ;
if ( ( ! memcmp ( V_2 -> V_61 , V_116 , V_67 ) ) == true ) {
break;
}
V_2 = NULL ;
V_54 = V_54 -> V_58 ;
...
T_1 F_39 ( struct V_83 * V_73 )
{
struct V_1 * V_2 ;
T_1 V_118 = V_47 ;
unsigned char V_119 [ V_67 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
struct V_25 * V_26 = & V_73 -> V_48 ;
V_2 = F_22 ( V_26 , V_119 ) ;
if ( ! V_2 ) {
V_118 = V_30 ;
...
struct V_1 * F_36 ( struct V_83 * V_73 )
{
struct V_25 * V_26 = & V_73 -> V_48 ;
V_3 V_117 [ V_67 ] = { 0xff , 0xff , 0xff , 0xff , 0xff , 0xff } ;
return F_37 ( V_26 , V_117 ) ;
}
V_3 F_40 ( struct V_83 * V_73 , V_3 * V_121 )
{
V_3 V_118 = true ;
#ifdef F_7
struct V_52 * V_54 , * V_53 ;
...
V_3 V_124 = false ;
struct V_25 * V_26 = & V_73 -> V_48 ;
struct V_125 * V_126 = & V_26 -> V_127 ;
struct V_63 * V_128 = & V_126 -> V_129 ;
F_17 ( & ( V_128 -> V_4 ) ) ;
V_53 = F_11 ( V_128 ) ;
V_54 = V_53 -> V_58 ;
while ( V_53 != V_54 ) {
V_123 = F_18 ( V_54 , struct V_122 , V_5 ) ;
V_54 = V_54 -> V_58 ;
if ( ! memcmp ( V_123 -> V_116 , V_121 , V_67 ) ) {
if ( V_123 -> V_130 ) {
V_124 = true ;
break;
}
...
F_20 ( & V_128 -> V_4 ) ;
if ( V_126 -> V_131 == 1 )
V_118 = ( V_124 ) ? false : true ;
else if ( V_126 -> V_131 == 2 )
V_118 = ( V_124 ) ? true : false ;
else
V_118 = true ;
#endif
return V_118 ;
