...
static int
F_85 ( struct V_205 * V_206 )
{
struct V_86 * V_88 =
F_86 ( V_206 , F_87 ( * V_88 ) , V_89 ) ;
struct V_2 * V_3 = & V_88 -> V_69 ;
struct V_7 * V_8 = V_7 ( V_3 -> V_9 ) ;
const struct V_207 * V_208 = V_206 -> V_209 ;
const char * V_114 = V_3 -> V_114 ;
struct V_76 * V_77 ;
if ( V_208 -> V_64 & V_210 ) {
F_4 ( V_8 , L_7 , V_114 ) ;
if ( ( V_77 = F_20 ( V_3 , V_101 ) ) )
F_88 ( V_77 -> V_197 . V_211 ) ;
} else {
bool V_212 = ( V_208 -> V_64 != V_213 ) ;
F_4 ( V_8 , L_8 , V_212 ? L_9 : L_10 , V_114 ) ;
if ( ( V_77 = F_20 ( V_3 , V_101 ) ) ) {
if ( ! V_212 )
F_89 ( V_77 -> V_197 . V_211 ) ;
}
F_90 ( V_3 -> V_9 ) ;
}
return V_214 ;
...
static T_3
F_91 ( struct V_215 * V_216 , struct V_217 * V_218 )
{
struct V_86 * V_88 =
F_86 ( V_216 , F_87 ( * V_88 ) , V_91 ) ;
struct V_76 * V_77 ;
struct V_219 * V_91 ;
V_179 V_220 = V_218 -> V_220 ;
int V_102 ;
V_77 = F_20 ( & V_88 -> V_69 , V_101 ) ;
if ( ! V_77 || ! ( V_91 = V_77 -> V_91 ) )
return - V_98 ;
if ( F_15 ( V_218 -> V_220 > 16 ) )
return - V_221 ;
V_102 = F_92 ( V_91 ) ;
if ( V_102 )
return V_102 ;
V_102 = F_93 ( V_91 , false , V_218 -> V_222 , V_218 -> V_223 ,
V_218 -> V_224 , & V_220 ) ;
F_94 ( V_91 ) ;
if ( V_102 >= 0 ) {
V_218 -> V_225 = V_102 ;
...
static int
F_95 ( enum V_226 V_85 )
{
switch ( V_85 ) {
case V_227 : return V_75 ;
case V_228 :
case V_229 :
case V_230 : return V_74 ;
case V_231 :
case V_232 :
case V_126 : return V_68 ;
case V_233 : return V_71 ;
case V_136 :
case V_178 : return V_54 ;
case V_234 :
case V_235 :
case V_236 : return V_73 ;
case V_99 : return V_55 ;
case V_237 :
case V_238 :
case V_239 : return V_72 ;
default:
break;
}
return V_240 ;
...
struct V_2 *
F_96 ( struct V_10 * V_9 , int V_241 )
{
const struct V_242 * V_159 = & V_243 ;
struct V_7 * V_8 = V_7 ( V_9 ) ;
struct V_31 * V_32 = V_31 ( V_9 ) ;
...
V_3 = & V_88 -> V_69 ;
V_88 -> V_241 = V_241 ;
V_88 -> V_85 = F_98 ( V_9 , V_241 ) ;
if ( V_88 -> V_85 ) {
T_4 V_246 = F_99 ( V_88 -> V_85 [ 0 ] ) ;
if ( F_100 ( V_9 ) [ 3 ] >= 4 )
V_246 |= ( T_4 ) F_99 ( V_88 -> V_85 [ 2 ] ) << 16 ;
...
if ( V_88 -> type == V_247 ) {
struct V_7 * V_8 = V_7 ( V_9 ) ;
struct V_248 * V_249 = & V_8 -> V_147 . V_85 ;
T_4 V_250 = 0 ;
int V_80 ;
for ( V_80 = 0 ; V_80 < V_249 -> V_251 ; V_80 ++ ) {
if ( V_249 -> V_246 [ V_80 ] . V_3 == V_88 -> V_241 )
V_250 |= ( 1 << V_249 -> V_246 [ V_80 ] . type ) ;
}
if ( V_250 & ( 1 << V_101 ) ) {
if ( V_250 & ( 1 << V_112 ) )
V_88 -> type = V_236 ;
