...
struct V_1 * F_37 ( const struct V_10 * V_31 ,
struct V_48 * V_49 ,
const int V_50 )
{
struct V_1 * V_2 ;
if ( F_38 ( & V_49 -> V_19 ) >= V_49 -> V_51 )
return NULL ;
V_2 = F_39 ( V_31 -> V_52 -> V_24 -> V_25 ,
V_53 ) ;
if ( V_2 ) {
const struct V_32 * V_33 = F_26 ( V_31 ) ;
F_40 ( V_2 , V_54 ) ;
...
void F_48 ( struct V_1 * V_2 , int V_80 , bool V_81 )
{
V_2 -> V_45 = V_80 <= 4 * V_82 ;
if ( ! V_81 ) {
F_49 ( F_50 ( & V_2 -> V_79 , V_83 + V_80 ) ) ;
F_51 ( & V_2 -> V_11 -> V_19 ) ;
} else {
F_52 ( & V_2 -> V_79 , V_83 + V_80 ) ;
}
}
void F_53 ( struct V_3 * V_4 , int V_84 )
{
struct V_1 * V_2 ;
struct V_10 * V_31 ;
struct V_85 * V_86 ;
...
struct V_36 * V_89 = & V_4 -> V_90 [ V_87 ] ;
V_91:
F_54 () ;
F_55 () ;
V_92:
...
F_38 ( & F_11 ( V_2 ) -> V_94 ) )
continue;
if ( F_58 ( ! F_59 ( & V_2 -> V_26 ) ) )
continue;
if ( F_58 ( ( V_2 -> V_70 != V_84 ) ||
F_38 ( & F_11 ( V_2 ) -> V_94 ) ) ) {
F_13 ( V_2 ) ;
goto V_92;
}
