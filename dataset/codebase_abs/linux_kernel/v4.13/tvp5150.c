...
#ifdef F_45
V_255 = F_64 ( V_251 , L_74 ) ;
if ( ! V_255 )
goto V_258;
F_65 (connectors, child) {
V_136 = F_66 ( V_256 , L_75 , & V_257 ) ;
if ( V_136 ) {
F_7 ( V_99 -> V_3 . V_12 ,
L_76 ,
V_256 -> V_239 ) ;
...
if ( V_233 )
return V_233 ;
V_244 = F_71 ( & V_10 -> V_12 , sizeof( * V_244 ) , V_274 ) ;
if ( ! V_244 )
return - V_275 ;
V_3 = & V_244 -> V_3 ;
if ( F_72 ( V_276 ) && V_251 ) {
