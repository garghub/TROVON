...
struct V_18 * V_19 ;
struct V_202 V_203 ;
if ( ! V_3 || ! V_45 -> V_48 . V_204 )
return - V_72 ;
V_3 -> V_112 = F_60 ( V_45 -> V_48 . V_204 , L_29 ) ;
if ( V_3 -> V_112 < 0 )
V_3 -> V_112 = 0 ;
V_3 -> V_186 = F_61 ( V_45 -> V_48 . V_204 , 0 ) ;
if ( V_3 -> V_186 <= 0 ) {
F_62 ( & V_45 -> V_48 , L_30 ) ;
return - V_72 ;
}
if ( F_63 ( V_45 -> V_48 . V_204 , 0 , & V_203 ) ) {
F_62 ( & V_45 -> V_48 , L_31 ) ;
return - V_72 ;
}
V_3 -> V_74 = F_64 ( & V_45 -> V_48 , V_203 . V_205 , F_65 ( & V_203 ) ) ;
if ( ! V_3 -> V_74 ) {
F_62 ( & V_45 -> V_48 , L_32 ) ;
return - V_206 ;
}
...
if ( ! V_19 )
return - V_208 ;
F_55 ( V_45 -> V_48 . V_204 , V_19 ) ;
V_3 -> V_19 = V_19 ;
V_3 -> V_53 = F_53 ( V_45 -> V_48 . V_204 ) ;
switch ( V_3 -> V_53 ) {
case V_133 :
V_3 -> V_51 = F_21 ;
V_3 -> V_68 = F_30 ;
...
V_3 -> V_53 != V_158 )
return 0 ;
if ( F_63 ( V_45 -> V_48 . V_204 , 1 , & V_203 ) ) {
F_62 ( & V_45 -> V_48 , L_34 ) ;
return - V_72 ;
}
V_3 -> V_89 = F_64 ( & V_45 -> V_48 , V_203 . V_205 ,
F_65 ( & V_203 ) ) ;
if ( ! V_3 -> V_89 ) {
F_62 ( & V_45 -> V_48 , L_32 ) ;
return - V_208 ;
...
goto V_211;
F_73 ( & V_3 -> V_183 , F_45 ) ;
V_3 -> V_49 = F_74 ( & V_45 -> V_48 , L_38 ) ;
if ( F_17 ( V_3 -> V_49 ) ) {
F_62 ( & V_45 -> V_48 , L_39 ) ;
V_46 = F_72 ( V_3 -> V_49 ) ;
goto V_211;
}
V_3 -> V_50 = F_74 ( & V_45 -> V_48 , L_40 ) ;
if ( F_17 ( V_3 -> V_50 ) ) {
if ( V_3 -> V_53 == V_88 ) {
F_62 ( & V_45 -> V_48 , L_41 ) ;
V_46 = F_72 ( V_3 -> V_50 ) ;
...
V_218 | V_219 , F_79 ( & V_45 -> V_48 ) , V_3 ) ;
if ( V_46 ) {
F_62 ( & V_45 -> V_48 , L_47 , V_3 -> V_186 ) ;
goto V_217;
}
F_20 ( V_45 , true ) ;
return 0 ;
