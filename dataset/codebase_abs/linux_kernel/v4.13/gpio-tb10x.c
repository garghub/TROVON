...
V_1 -> V_46 . V_42 = V_42 ;
V_1 -> V_46 . V_58 = false ;
V_40 = F_32 ( & V_33 -> V_38 , & V_1 -> V_46 , V_1 ) ;
if ( V_40 < 0 ) {
F_33 ( & V_33 -> V_38 , L_3 ) ;
return V_40 ;
}
...
V_46 -> V_68 = V_1 -> V_4 ;
V_46 -> V_69 [ 0 ] . type = V_22 ;
V_46 -> V_69 [ 0 ] . V_11 . V_70 = V_71 ;
V_46 -> V_69 [ 0 ] . V_11 . V_72 = V_73 ;
V_46 -> V_69 [ 0 ] . V_11 . V_74 = V_75 ;
V_46 -> V_69 [ 0 ] . V_11 . V_76 = F_16 ;
V_46 -> V_69 [ 0 ] . V_77 . V_78 = V_26 ;
V_46 -> V_69 [ 0 ] . V_77 . V_6 = V_28 ;
}
return 0 ;
}
static int F_41 ( struct V_32 * V_33 )
{
struct V_1 * V_1 = F_42 ( V_33 ) ;
if ( V_1 -> V_46 . V_60 ) {
F_43 ( V_1 -> V_18 -> V_46 -> V_46 [ 0 ] ,
