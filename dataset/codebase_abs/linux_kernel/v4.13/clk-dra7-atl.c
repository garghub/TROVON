...
V_26 = F_19 ( sizeof( char * ) , V_29 ) ;
if ( ! V_26 )
goto V_37;
V_26 [ 0 ] = F_22 ( V_23 , 0 ) ;
V_25 . V_26 = V_26 ;
V_27 = F_23 ( NULL , & V_6 -> V_7 , V_23 -> V_31 ) ;
if ( ! F_24 ( V_27 ) ) {
V_28 = F_25 ( NULL , V_27 , V_23 -> V_31 ) ;
if ( V_28 ) {
F_26 ( V_27 ) ;
goto V_37;
}
...
{
struct V_22 * V_23 = V_40 -> V_13 . V_41 ;
struct V_1 * V_2 ;
int V_42 ;
int V_28 = 0 ;
if ( ! V_23 )
return - V_43 ;
V_2 = F_30 ( & V_40 -> V_13 , sizeof( * V_2 ) , V_29 ) ;
if ( ! V_2 )
return - V_44 ;
V_2 -> V_5 = F_31 ( V_23 , 0 ) ;
V_2 -> V_13 = & V_40 -> V_13 ;
...
V_9 -> V_2 = V_2 ;
V_9 -> V_14 = V_42 ;
snprintf ( V_48 , sizeof( V_48 ) , L_7 , V_42 ) ;
F_39 ( V_23 ) ;
V_47 = F_40 ( V_23 , V_48 ) ;
if ( V_47 ) {
V_28 = F_41 ( V_47 , L_8 ,
