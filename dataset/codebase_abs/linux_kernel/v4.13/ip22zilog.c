...
static void F_43 ( struct V_99 * V_47 )
{
struct V_38 * V_39 = F_44 ( V_47 ) ;
struct V_1 * V_2 ;
if ( F_23 ( V_39 ) )
return;
V_2 = F_30 ( V_47 ) ;
...
static void F_45 ( struct V_99 * V_47 )
{
struct V_38 * V_39 =
F_40 ( V_47 , struct V_38 , V_47 ) ;
struct V_1 * V_2 = F_30 ( V_47 ) ;
...
static void F_46 ( struct V_99 * V_47 , int V_116 )
{
struct V_38 * V_39 =
F_40 ( V_47 , struct V_38 , V_47 ) ;
struct V_1 * V_2 = F_30 ( V_47 ) ;
...
static int F_51 ( struct V_99 * V_47 )
{
struct V_38 * V_39 = F_44 ( V_47 ) ;
unsigned long V_40 ;
if ( F_23 ( V_39 ) )
...
static void F_52 ( struct V_99 * V_47 )
{
struct V_38 * V_39 = F_44 ( V_47 ) ;
struct V_1 * V_2 ;
unsigned long V_40 ;
...
static void
F_53 ( struct V_38 * V_39 , unsigned int V_122 ,
...
if ( V_123 & ( V_153 | V_154 | V_155 ) )
V_39 -> V_47 . V_60 |= V_66 ;
V_39 -> V_47 . V_156 = 0 ;
if ( V_123 & V_157 )
V_39 -> V_47 . V_156 |= V_14 | V_12 ;
if ( V_123 & V_153 ) {
V_39 -> V_47 . V_156 |= V_66 ;
if ( V_123 & V_157 )
V_39 -> V_47 . V_156 |= V_13 ;
}
if ( ( V_122 & V_158 ) == 0 )
V_39 -> V_47 . V_156 = 0xff ;
}
static void
F_54 ( struct V_99 * V_47 , struct V_159 * V_160 ,
struct V_159 * V_161 )
{
struct V_38 * V_39 =
F_40 ( V_47 , struct V_38 , V_47 ) ;
unsigned long V_40 ;
int V_162 , V_124 ;
V_162 = F_55 ( V_47 , V_160 , V_161 , 1200 , 76800 ) ;
F_36 ( & V_39 -> V_47 . V_89 , V_40 ) ;
V_124 = F_56 ( V_162 , V_163 / V_164 ) ;
F_53 ( V_39 , V_160 -> V_165 , V_160 -> V_166 , V_124 ) ;
if ( F_57 ( & V_39 -> V_47 , V_160 -> V_165 ) )
V_39 -> V_40 |= V_167 ;
else
V_39 -> V_40 &= ~ V_167 ;
F_10 ( V_39 , F_30 ( V_47 ) ) ;
F_58 ( V_47 , V_160 -> V_165 , V_162 ) ;
F_37 ( & V_39 -> V_47 . V_89 , V_40 ) ;
}
static const char * F_59 ( struct V_99 * V_47 )
{
return L_1 ;
}
static void F_60 ( struct V_99 * V_47 )
{
}
static int F_61 ( struct V_99 * V_47 )
{
return 0 ;
}
static void F_62 ( struct V_99 * V_47 , int V_40 )
{
}
static int F_63 ( struct V_99 * V_47 , struct V_168 * V_169 )
{
return - V_170 ;
}
static void * T_3 F_64 ( unsigned long V_171 )
{
return F_65 ( V_171 , V_172 ) ;
}
static void T_3 F_66 ( void )
{
V_173 = (struct V_38 * )
F_64 ( V_174 * sizeof( struct V_38 ) ) ;
V_175 = (struct V_176 * * )
F_64 ( V_177 * sizeof( struct V_176 * ) ) ;
if ( V_173 == NULL || V_175 == NULL ) {
F_67 ( L_2 ) ;
}
}
static struct V_176 * T_3 F_68 ( int V_178 )
{
unsigned long V_179 ;
...
static void F_70 ( struct V_99 * V_47 , int V_43 )
{
struct V_1 * V_2 = F_30 ( V_47 ) ;
int V_184 = V_185 ;
do {
...
static void
F_71 ( struct V_187 * V_188 , const char * V_189 , unsigned int V_190 )
{
struct V_38 * V_39 = & V_173 [ V_188 -> V_191 ] ;
unsigned long V_40 ;
F_36 ( & V_39 -> V_47 . V_89 , V_40 ) ;
F_72 ( & V_39 -> V_47 , V_189 , V_190 , F_70 ) ;
F_9 ( 2 ) ;
F_37 ( & V_39 -> V_47 . V_89 , V_40 ) ;
}
static int T_3 F_73 ( struct V_187 * V_188 , char * V_192 )
{
struct V_38 * V_39 = & V_173 [ V_188 -> V_191 ] ;
unsigned long V_40 ;
...
int V_194 = 'n' ;
V_39 -> V_40 |= V_195 ;
F_74 ( V_196 L_4 , V_188 -> V_191 ) ;
F_36 ( & V_39 -> V_47 . V_89 , V_40 ) ;
V_39 -> V_42 [ V_35 ] |= V_65 ;
F_50 ( V_39 ) ;
F_37 ( & V_39 -> V_47 . V_89 , V_40 ) ;
if ( V_192 )
F_75 ( V_192 , & V_162 , & V_57 , & V_193 , & V_194 ) ;
return F_76 ( & V_39 -> V_47 , V_188 , V_162 , V_57 , V_193 , V_194 ) ;
}
...
{
int V_100 ;
F_74 ( V_196 L_5 , V_177 ) ;
F_77 () ;
if ( F_81 ( V_182 , F_29 , 0 ,
L_1 , V_198 ) ) {
F_67 ( L_6 ) ;
}
V_100 = F_82 ( & V_213 ) ;
