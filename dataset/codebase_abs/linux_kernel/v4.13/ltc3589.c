...
V_4 -> V_21 = V_21 ;
V_74 = V_4 -> V_31 ;
memcpy ( V_74 , V_80 , sizeof( V_80 ) ) ;
if ( V_4 -> V_77 == V_81 ) {
V_74 [ V_29 ] . V_8 . V_69 = 1800000 ;
V_74 [ V_82 ] . V_8 . V_83 = V_84 ;
} else {
V_74 [ V_29 ] . V_8 . V_69 = 2800000 ;
V_74 [ V_82 ] . V_8 . V_83 = V_85 ;
}
V_4 -> V_10 = F_32 ( V_71 , & V_86 ) ;
if ( F_33 ( V_4 -> V_10 ) ) {
V_25 = F_34 ( V_4 -> V_10 ) ;
F_11 ( V_21 , L_7 , V_25 ) ;
return V_25 ;
...
V_88 . V_79 = V_4 ;
V_88 . V_26 = F_17 ( V_24 ) ;
V_4 -> V_60 [ V_24 ] = F_35 ( V_21 , V_8 ,
& V_88 ) ;
if ( F_33 ( V_4 -> V_60 [ V_24 ] ) ) {
V_25 = F_34 ( V_4 -> V_60 [ V_24 ] ) ;
F_11 ( V_21 , L_8 ,
V_8 -> V_89 , V_25 ) ;
return V_25 ;
}
