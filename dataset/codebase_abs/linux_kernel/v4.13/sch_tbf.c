...
T_3 V_39 , V_41 ;
T_1 V_55 = 0 , V_56 = 0 ;
V_49 = F_39 ( V_50 , V_51 , V_48 , V_57 , NULL ) ;
if ( V_49 < 0 )
return V_49 ;
V_49 = - V_58 ;
if ( V_50 [ V_59 ] == NULL )
...
static int F_58 ( struct V_13 * V_14 , struct V_47 * V_48 )
{
struct V_16 * V_17 = F_9 ( V_14 ) ;
F_59 ( & V_17 -> V_44 , V_14 ) ;
V_17 -> V_27 = & V_71 ;
...
static int F_61 ( struct V_13 * V_14 , struct V_10 * V_11 )
{
struct V_16 * V_17 = F_9 ( V_14 ) ;
struct V_47 * V_74 ;
struct V_52 V_48 ;
...
goto V_76;
V_48 . V_72 = V_17 -> V_72 ;
F_63 ( & V_48 . V_43 , & V_17 -> V_43 ) ;
if ( F_24 ( V_17 ) )
F_63 ( & V_48 . V_63 , & V_17 -> V_32 ) ;
else
memset ( & V_48 . V_63 , 0 , sizeof( V_48 . V_63 ) ) ;
V_48 . V_41 = F_64 ( V_17 -> V_41 ) ;
V_48 . V_39 = F_64 ( V_17 -> V_39 ) ;
if ( F_65 ( V_11 , V_59 , sizeof( V_48 ) , & V_48 ) )
goto V_76;
if ( V_17 -> V_43 . V_5 >= ( 1ULL << 32 ) &&
F_66 ( V_11 , V_65 , V_17 -> V_43 . V_5 ,
V_77 ) )
goto V_76;
if ( F_24 ( V_17 ) &&
V_17 -> V_32 . V_5 >= ( 1ULL << 32 ) &&
F_66 ( V_11 , V_67 , V_17 -> V_32 . V_5 ,
V_77 ) )
goto V_76;
return F_67 ( V_11 , V_74 ) ;
V_76:
F_68 ( V_11 , V_74 ) ;
return - 1 ;
}
static int F_69 ( struct V_13 * V_14 , unsigned long V_78 ,
...
static int F_71 ( struct V_13 * V_14 , unsigned long V_84 , struct V_13 * V_85 ,
struct V_13 * * V_86 )
{
struct V_16 * V_17 = F_9 ( V_14 ) ;
if ( V_85 == NULL )
V_85 = & V_71 ;
* V_86 = F_72 ( V_14 , V_85 , & V_17 -> V_27 ) ;
return 0 ;
}
static struct V_13 * F_73 ( struct V_13 * V_14 , unsigned long V_84 )
{
struct V_16 * V_17 = F_9 ( V_14 ) ;
return V_17 -> V_27 ;
}
static unsigned long F_74 ( struct V_13 * V_14 , T_4 V_87 )
{
return 1 ;
}
static void F_75 ( struct V_13 * V_14 , unsigned long V_84 )
{
}
static void F_76 ( struct V_13 * V_14 , struct V_88 * V_89 )
{
if ( ! V_89 -> V_90 ) {
