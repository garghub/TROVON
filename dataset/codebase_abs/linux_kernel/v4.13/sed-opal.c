...
static T_3 F_10 ( const void * V_5 )
{
const struct V_15 * V_16 = V_5 ;
return F_11 ( V_16 -> V_17 ) ;
}
static T_3 F_12 ( const void * V_5 )
{
const struct V_18 * V_19 = V_5 ;
return F_11 ( V_19 -> V_17 ) ;
}
...
static int F_16 ( struct V_20 * V_21 , T_5 * V_36 )
{
int V_32 ;
V_32 = F_13 ( V_21 ) ;
if ( V_32 )
...
static void F_17 ( struct V_20 * V_21 , const void * V_5 )
{
...
static int F_21 ( struct V_20 * V_21 , void * V_5 )
{
int V_32 ;
...
static void F_22 ( int * V_70 , struct V_20 * V_25 , T_1 V_71 )
{
if ( * V_70 )
return;
if ( V_25 -> V_72 >= V_26 - 1 ) {
...
static void F_23 ( struct V_20 * V_25 , bool V_74 ,
bool V_75 , int V_76 )
{
T_1 V_77 ;
int V_70 = 0 ;
...
static void F_24 ( struct V_20 * V_25 , bool V_74 ,
bool V_75 , int V_76 )
{
T_1 V_82 ;
V_82 = V_83 ;
...
static void F_25 ( int * V_70 , struct V_20 * V_25 , T_6 V_87 )
{
T_4 V_76 ;
int V_88 ;
T_1 V_89 ;
...
F_23 ( V_25 , false , false , V_76 ) ;
while ( V_76 -- ) {
V_89 = V_87 >> ( V_76 * 8 ) ;
F_22 ( V_70 , V_25 , V_89 ) ;
}
}
static void F_28 ( int * V_70 , struct V_20 * V_25 ,
...
if ( V_92 )
F_23 ( V_25 , true , false , V_76 ) ;
else
F_24 ( V_25 , true , false , V_76 ) ;
memcpy ( & V_25 -> V_25 [ V_25 -> V_72 ] , V_74 , V_76 ) ;
V_25 -> V_72 += V_76 ;
}
static int F_29 ( T_1 * V_29 , T_4 V_3 , T_1 V_93 )
{
if ( V_3 > V_94 ) {
F_6 ( L_19 ) ;
return - V_73 ;
...
static int F_30 ( T_1 * V_29 , T_4 V_3 , T_1 V_93 )
{
if ( V_3 > V_94 ) {
F_6 ( L_20 ) ;
return - V_73 ;
...
static void F_31 ( struct V_20 * V_25 , T_3 V_23 )
{
...
static int F_32 ( struct V_20 * V_25 , T_2 V_100 , T_2 V_101 )
{
struct V_30 * V_31 ;
int V_70 = 0 ;
F_22 ( & V_70 , V_25 , V_102 ) ;
F_22 ( & V_70 , V_25 , V_103 ) ;
F_22 ( & V_70 , V_25 , 0 ) ;
F_22 ( & V_70 , V_25 , 0 ) ;
F_22 ( & V_70 , V_25 , 0 ) ;
F_22 ( & V_70 , V_25 , V_104 ) ;
if ( V_70 ) {
F_6 ( L_21 ) ;
return - V_55 ;
}
V_31 = (struct V_30 * ) V_25 -> V_25 ;
V_31 -> V_105 . V_101 = F_33 ( V_101 ) ;
V_31 -> V_105 . V_100 = F_33 ( V_100 ) ;
V_31 -> V_106 . V_3 = F_33 ( V_25 -> V_72 - sizeof( * V_31 ) ) ;
while ( V_25 -> V_72 % 4 ) {
if ( V_25 -> V_72 >= V_26 ) {
F_6 ( L_22 ) ;
return - V_73 ;
...
V_31 -> V_105 . V_3 = F_33 ( V_25 -> V_72 - sizeof( V_31 -> V_33 ) -
sizeof( V_31 -> V_105 ) ) ;
V_31 -> V_33 . V_3 = F_33 ( V_25 -> V_72 - sizeof( V_31 -> V_33 ) ) ;
return 0 ;
}
static const struct V_107 * F_34 (
...
static T_7 F_36 ( struct V_107 * V_71 ,
const T_1 * V_72 )
{
V_71 -> V_72 = V_72 ;
V_71 -> V_76 = 1 ;
...
static T_7 F_37 ( struct V_107 * V_71 ,
const T_1 * V_72 )
{
V_71 -> V_72 = V_72 ;
...
static int F_41 ( const T_1 * V_130 , T_4 V_3 ,
struct V_108 * V_27 )
{
...
V_72 = V_130 ;
V_72 += sizeof( * V_31 ) ;
V_135 = F_9 ( V_31 -> V_33 . V_3 ) ;
V_136 = F_9 ( V_31 -> V_105 . V_3 ) ;
V_137 = F_9 ( V_31 -> V_106 . V_3 ) ;
F_6 ( L_26 ,
V_135 , V_136 , V_137 ) ;
...
while ( V_133 > 0 ) {
if ( V_72 [ 0 ] <= V_138 )
V_134 = F_36 ( V_131 , V_72 ) ;
else if ( V_72 [ 0 ] <= V_139 )
V_134 = F_37 ( V_131 , V_72 ) ;
...
static T_4 F_42 ( const struct V_108 * V_27 , int V_89 ,
const char * * V_142 )
{
* V_142 = NULL ;
if ( ! V_27 ) {
...
static T_6 F_43 ( const struct V_108 * V_27 , int V_89 )
{
if ( ! V_27 ) {
F_6 ( L_29 ) ;
return 0 ;
...
static bool F_44 ( const struct V_107 * V_143 , T_1 V_144 )
{
if ( F_45 ( V_143 ) ||
V_143 -> type != V_128 ||
V_143 -> V_72 [ 0 ] != V_144 )
...
static T_1 F_46 ( const struct V_108 * V_27 )
{
const struct V_107 * V_71 ;
V_71 = F_34 ( V_27 , 0 ) ;
if ( F_44 ( V_71 , V_145 ) )
...
if ( V_27 -> V_109 < 5 )
return V_146 ;
V_71 = F_34 ( V_27 , V_27 -> V_109 - 5 ) ;
if ( ! F_44 ( V_71 , V_103 ) )
return V_146 ;
V_71 = F_34 ( V_27 , V_27 -> V_109 - 1 ) ;
if ( ! F_44 ( V_71 , V_104 ) )
return V_146 ;
return F_43 ( V_27 , V_27 -> V_109 - 4 ) ;
}
static int F_47 ( struct V_20 * V_21 )
{
int error ;
F_3 ( V_21 -> V_25 , V_21 -> V_72 ) ;
error = F_41 ( V_21 -> V_27 , V_26 , & V_21 -> V_147 ) ;
if ( error ) {
F_6 ( L_28 ) ;
return error ;
}
return F_46 ( & V_21 -> V_147 ) ;
}
...
if ( error )
return error ;
V_100 = F_43 ( & V_21 -> V_147 , 4 ) ;
V_101 = F_43 ( & V_21 -> V_147 , 5 ) ;
if ( V_100 == 0 && V_101 == 0 ) {
F_6 ( L_34 ) ;
return - V_148 ;
}
...
static int F_56 ( struct V_20 * V_21 , T_5 V_36 )
{
int V_32 ;
V_32 = F_32 ( V_21 , V_21 -> V_100 , V_21 -> V_101 ) ;
if ( V_32 ) {
F_6 ( L_35 , V_32 ) ;
return V_32 ;
}
F_3 ( V_21 -> V_25 , V_21 -> V_72 ) ;
return F_16 ( V_21 , V_36 ) ;
}
static int F_57 ( struct V_20 * V_21 , void * V_5 )
{
T_1 V_153 [ V_94 ] ;
int V_70 = 0 ;
F_48 ( V_21 ) ;
F_31 ( V_21 , V_21 -> V_23 ) ;
memcpy ( V_153 , V_21 -> V_154 , F_58 ( sizeof( V_153 ) , V_21 -> V_155 ) ) ;
F_53 ( V_21 -> V_154 ) ;
V_21 -> V_154 = NULL ;
F_22 ( & V_70 , V_21 , V_156 ) ;
F_28 ( & V_70 , V_21 , V_153 , V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_158 ] ,
V_94 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
if ( V_70 ) {
F_6 ( L_36 ) ;
return V_70 ;
}
return F_56 ( V_21 , F_47 ) ;
}
...
if ( error )
return error ;
V_160 = F_42 ( & V_21 -> V_147 , 4 , & V_159 ) ;
if ( ! V_159 ) {
F_6 ( L_37 ,
V_161 ) ;
return V_162 ;
}
V_21 -> V_154 = F_60 ( V_159 , V_160 , V_163 ) ;
if ( ! V_21 -> V_154 )
return - V_164 ;
V_21 -> V_155 = V_160 ;
return 0 ;
}
static int F_61 ( struct V_20 * V_21 , void * V_5 )
{
T_1 V_153 [ V_94 ] ;
int V_70 = 0 ;
T_1 * V_93 = V_5 ;
F_48 ( V_21 ) ;
F_31 ( V_21 , V_21 -> V_23 ) ;
V_70 = F_29 ( V_153 , sizeof( V_153 ) , * V_93 ) ;
if ( V_70 )
return V_70 ;
V_70 = 0 ;
F_22 ( & V_70 , V_21 , V_156 ) ;
F_28 ( & V_70 , V_21 , V_153 , V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_165 ] , V_94 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 3 ) ;
F_22 ( & V_70 , V_21 , 10 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 4 ) ;
F_22 ( & V_70 , V_21 , 10 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
...
F_22 ( & V_70 , V_21 , V_156 ) ;
F_28 ( & V_70 , V_21 , V_153 , V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_172 ] , V_94 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , V_173 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 5 ) ;
F_22 ( & V_70 , V_21 , V_168 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 6 ) ;
F_22 ( & V_70 , V_21 , V_169 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , V_174 ) ;
F_22 ( & V_70 , V_21 , V_170 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , V_175 ) ;
F_22 ( & V_70 , V_21 , V_171 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
...
static inline int F_63 ( struct V_20 * V_21 , T_1 * V_153 ,
struct V_176 * V_177 )
{
int V_70 ;
V_70 = F_62 ( V_21 , V_153 , ! ! V_177 -> V_178 , ! ! V_177 -> V_179 ,
0 , 0 ) ;
if ( V_70 )
F_6 ( L_39 ) ;
return V_70 ;
}
static int F_64 ( struct V_20 * V_21 , void * V_5 )
{
T_1 V_153 [ V_94 ] ;
...
return V_70 ;
if ( V_93 == 0 )
V_70 = F_63 ( V_21 , V_153 , V_177 ) ;
else {
F_22 ( & V_70 , V_21 , V_156 ) ;
F_28 ( & V_70 , V_21 , V_153 , V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_172 ] ,
V_94 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , V_173 ) ;
...
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 3 ) ;
F_25 ( & V_70 , V_21 , V_177 -> V_182 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 4 ) ;
F_25 ( & V_70 , V_21 , V_177 -> V_183 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 5 ) ;
F_25 ( & V_70 , V_21 , ! ! V_177 -> V_178 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 6 ) ;
F_25 ( & V_70 , V_21 , ! ! V_177 -> V_179 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
...
V_100 = V_190 ;
F_22 ( & V_70 , V_21 , V_156 ) ;
F_28 ( & V_70 , V_21 , V_95 [ V_191 ] ,
V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_192 ] ,
V_94 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_25 ( & V_70 , V_21 , V_100 ) ;
F_28 ( & V_70 , V_21 , V_95 [ V_186 ] , V_94 ) ;
F_22 ( & V_70 , V_21 , 1 ) ;
switch ( V_185 ) {
case V_189 :
F_22 ( & V_70 , V_21 , V_104 ) ;
...
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 0 ) ;
F_28 ( & V_70 , V_21 , V_187 , V_188 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 3 ) ;
F_28 ( & V_70 , V_21 , V_95 [ V_185 ] ,
V_94 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
break;
...
return F_56 ( V_21 , F_49 ) ;
}
static int F_66 ( struct V_20 * V_21 , void * V_5 )
{
return F_65 ( V_21 , V_189 ,
V_195 , NULL , 0 ) ;
}
static int F_67 ( struct V_20 * V_21 , void * V_5 )
{
int V_32 ;
const T_1 * V_187 = V_21 -> V_154 ;
if ( ! V_187 ) {
const struct V_181 * V_196 = V_5 ;
V_32 = F_65 ( V_21 , V_194 ,
V_195 ,
V_196 -> V_187 ,
V_196 -> V_188 ) ;
} else {
...
F_22 ( & V_70 , V_21 , V_103 ) ;
F_25 ( & V_70 , V_21 , V_100 ) ;
F_28 ( & V_70 , V_21 , V_95 [ V_197 ] ,
V_94 ) ;
F_22 ( & V_70 , V_21 , 1 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 0 ) ;
F_28 ( & V_70 , V_21 , V_187 , V_160 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , 3 ) ;
F_28 ( & V_70 , V_21 , V_199 , V_94 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
if ( V_70 ) {
F_6 ( L_43 ) ;
...
F_31 ( V_21 , V_21 -> V_23 ) ;
F_22 ( & V_70 , V_21 , V_156 ) ;
F_28 ( & V_70 , V_21 , V_95 [ V_195 ] ,
V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_202 ] ,
V_94 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
if ( V_70 ) {
...
F_48 ( V_21 ) ;
F_31 ( V_21 , V_21 -> V_23 ) ;
if ( F_29 ( V_153 , sizeof( V_153 ) , V_180 -> V_181 . V_93 ) < 0 )
return - V_73 ;
F_22 ( & V_70 , V_21 , V_156 ) ;
F_28 ( & V_70 , V_21 , V_153 , V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_204 ] ,
V_94 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
if ( V_70 ) {
...
static int F_75 ( T_1 * V_187 , T_4 V_188 , T_1 * V_208 ,
struct V_20 * V_21 )
{
int V_70 = 0 ;
F_48 ( V_21 ) ;
...
if ( F_75 ( V_209 -> V_181 . V_187 , V_209 -> V_181 . V_188 ,
V_208 , V_21 ) ) {
F_6 ( L_49 ) ;
return - V_73 ;
}
...
static int F_77 ( struct V_20 * V_21 , void * V_5 )
{
T_1 V_208 [ V_94 ] ;
struct V_181 * V_187 = V_5 ;
memcpy ( V_208 , V_95 [ V_211 ] , V_94 ) ;
if ( F_75 ( V_187 -> V_187 , V_187 -> V_188 , V_208 , V_21 ) ) {
F_6 ( L_50 ) ;
return - V_73 ;
}
return F_56 ( V_21 , F_47 ) ;
...
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , V_174 ) ;
F_22 ( & V_70 , V_21 , V_222 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , V_175 ) ;
F_22 ( & V_70 , V_21 , V_223 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
F_22 ( & V_70 , V_21 , V_167 ) ;
F_22 ( & V_70 , V_21 , V_104 ) ;
...
F_28 ( & V_70 , V_21 , V_95 [ V_197 ] ,
V_94 ) ;
F_28 ( & V_70 , V_21 , V_157 [ V_230 ] ,
V_94 ) ;
if ( V_227 -> V_12 ) {
V_70 = F_29 ( V_228 , sizeof( V_228 ) ,
V_227 -> V_93 [ 0 ] ) ;
if ( V_70 )
return V_70 ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_22 ( & V_70 , V_21 , V_166 ) ;
F_22 ( & V_70 , V_21 , V_229 ) ;
F_22 ( & V_70 , V_21 , 6 ) ;
F_22 ( & V_70 , V_21 , 0 ) ;
F_22 ( & V_70 , V_21 , 0 ) ;
F_22 ( & V_70 , V_21 , V_103 ) ;
F_28 ( & V_70 , V_21 , V_228 , V_94 ) ;
...
if ( error )
return error ;
strlen = F_42 ( & V_21 -> V_147 , 4 , & V_235 ) ;
if ( ! V_235 ) {
F_6 ( L_58 , V_161 ) ;
return V_162 ;
}
V_21 -> V_154 = F_60 ( V_235 , strlen , V_163 ) ;
if ( ! V_21 -> V_154 )
return - V_164 ;
V_21 -> V_155 = strlen ;
return 0 ;
...
return F_56 ( V_21 , F_84 ) ;
}
static int F_86 ( struct V_20 * V_21 , void * V_5 )
{
int V_70 = 0 ;
F_48 ( V_21 ) ;
F_31 ( V_21 , V_21 -> V_23 ) ;
F_22 ( & V_70 , V_21 , V_145 ) ;
if ( V_70 < 0 )
return V_70 ;
return F_56 ( V_21 , F_55 ) ;
}
...
static inline void F_87 ( struct V_20 * V_21 ,
...
{
struct V_149 * V_239 , * F_18 ;
F_89 ( & V_21 -> V_238 ) ;
F_92 (suspend, next, &dev->unlk_lst, node) {
F_52 ( & V_239 -> V_151 ) ;
F_53 ( V_239 ) ;
}
F_90 ( & V_21 -> V_238 ) ;
}
void F_93 ( struct V_20 * V_21 )
{
if ( ! V_21 )
return;
F_91 ( V_21 ) ;
...
struct V_20 * F_94 ( void * V_5 , T_8 * V_22 )
{
struct V_20 * V_21 ;
V_21 = F_95 ( sizeof( * V_21 ) , V_163 ) ;
if ( ! V_21 )
return NULL ;
F_96 ( & V_21 -> V_152 ) ;
F_97 ( & V_21 -> V_238 ) ;
...
static int F_101 ( struct V_20 * V_21 , struct V_214 * V_248 )
{
struct V_149 * V_239 ;
V_239 = F_102 ( sizeof( * V_239 ) , V_163 ) ;
if ( ! V_239 )
return - V_164 ;
V_239 -> V_249 = * V_248 ;
...
static int F_104 ( struct V_20 * V_21 , struct V_181 * V_252 )
{
...
static int F_107 ( struct V_20 * V_21 , struct V_226 * V_226 )
{
...
static int F_109 ( struct V_20 * V_21 , struct V_261 * V_262 )
{
...
F_89 ( & V_21 -> V_238 ) ;
F_87 ( V_21 , NULL ) ;
F_51 (suspend, &dev->unlk_lst, node) {
V_21 -> V_101 = 0 ;
V_21 -> V_100 = 0 ;
V_32 = F_105 ( V_21 , & V_239 -> V_249 ) ;
if ( V_32 ) {
F_6 ( L_65 ,
...
int F_112 ( struct V_20 * V_21 , unsigned int V_25 , void T_9 * V_267 )
{
void * V_268 ;
int V_32 = - V_269 ;
if ( ! F_113 ( V_270 ) )
...
break;
case V_283 :
V_32 = F_99 ( V_21 , V_268 ) ;
break;
case V_284 :
V_32 = F_98 ( V_21 , V_268 ) ;
break;
default:
break;
}
