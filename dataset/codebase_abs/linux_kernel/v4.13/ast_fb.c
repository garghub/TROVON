...
V_57 = & V_2 -> V_15 . V_16 ;
V_2 -> V_50 . V_57 = V_57 ;
strcpy ( V_35 -> V_65 . V_66 , L_3 ) ;
V_35 -> V_25 = V_67 | V_68 ;
V_35 -> V_69 = & V_70 ;
V_35 -> V_71 -> V_72 [ 0 ] . V_16 = F_28 ( V_49 -> V_73 , 0 ) ;
V_35 -> V_71 -> V_72 [ 0 ] . V_51 = F_29 ( V_49 -> V_73 , 0 ) ;
F_30 ( V_35 , V_57 -> V_32 [ 0 ] , V_57 -> V_17 -> V_74 ) ;
F_31 ( V_35 , & V_2 -> V_50 , V_55 -> V_75 , V_55 -> V_76 ) ;
V_35 -> V_77 = V_33 ;
V_35 -> V_78 = V_51 ;
V_35 -> V_79 . V_25 = V_80 ;
F_32 ( L_4 ,
...
static void F_34 ( struct V_81 * V_82 , T_2 V_83 , T_2 V_84 ,
T_2 V_85 , int V_86 )
{
struct V_87 * V_87 = F_35 ( V_82 ) ;
...
struct V_1 * V_2 ;
int V_19 ;
V_2 = F_44 ( sizeof( struct V_1 ) , V_95 ) ;
if ( ! V_2 )
return - V_63 ;
V_93 -> V_96 = V_2 ;
F_45 ( & V_2 -> V_26 ) ;
F_46 ( V_49 , & V_2 -> V_50 , & V_97 ) ;
V_19 = F_47 ( V_49 , & V_2 -> V_50 , 1 ) ;
if ( V_19 )
goto free;
V_19 = F_48 ( & V_2 -> V_50 ) ;
if ( V_19 )
...
void F_53 ( struct V_48 * V_49 , int V_99 )
{
struct V_92 * V_93 = V_49 -> V_94 ;
if ( ! V_93 -> V_96 )
return;
F_54 ( & V_93 -> V_96 -> V_50 , V_99 ) ;
}
void F_55 ( struct V_92 * V_93 , unsigned long V_100 )
{
V_93 -> V_96 -> V_50 . V_96 -> V_65 . V_101 =
V_93 -> V_96 -> V_50 . V_96 -> V_71 -> V_72 [ 0 ] . V_16 + V_100 ;
V_93 -> V_96 -> V_50 . V_96 -> V_65 . V_102 = V_93 -> V_103 - V_100 ;
}
