...
static int F_36 ( struct V_137 * V_138 ,
struct V_152 * V_153 ,
struct V_176 * V_158 )
{
struct V_1 * V_2 = F_22 ( V_138 ) ;
...
struct V_1 * V_2 = F_22 ( V_138 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
unsigned int V_168 = V_187 -> V_168 ;
if ( F_41 ( V_188 -> V_124 ) )
V_168 |= 2 << 16 ;
switch ( V_168 ) {
case V_70 | 2 << 16 :
...
if ( V_2 -> V_90 != V_191 )
return - V_192 ;
if ( V_188 -> V_124 == & V_4 -> V_193 . V_123 . V_124 )
V_2 -> V_90 = V_91 ;
else if ( V_188 -> V_124 == & V_4 -> V_194 . V_123 . V_124 )
V_2 -> V_90 = V_195 ;
break;
case V_71 :
if ( V_189 & V_190 ) {
...
struct V_186 * V_196 = V_2 -> V_196 ;
struct V_185 * V_197 = & V_138 -> V_124 ;
int V_139 ;
V_2 -> V_90 = V_191 ;
F_43 ( V_138 , & V_198 ) ;
V_138 -> V_199 = & V_200 ;
F_44 ( V_138 -> V_201 , L_4 , sizeof( V_138 -> V_201 ) ) ;
V_138 -> V_202 = F_45 ( 16 ) ;
F_46 ( V_138 , V_2 ) ;
V_138 -> V_189 |= V_203 ;
V_196 [ V_70 ] . V_189 = V_204 ;
V_196 [ V_71 ] . V_189 = V_205 ;
V_197 -> V_206 = & V_207 ;
V_139 = F_47 ( V_197 , V_208 , V_196 ) ;
if ( V_139 < 0 )
return V_139 ;
F_38 ( V_138 , NULL ) ;
V_2 -> V_80 . type = V_209 ;
V_2 -> V_80 . V_206 = & V_210 ;
V_2 -> V_80 . V_4 = F_2 ( V_2 ) ;
V_2 -> V_80 . V_211 = F_48 ( 4096 * 4096 ) * 3 ;
V_2 -> V_80 . V_212 = 32 ;
V_2 -> V_80 . V_213 = 1 ;
V_2 -> V_80 . V_214 = 0x1ffe0 ;
return F_49 ( & V_2 -> V_80 , L_5 ) ;
}
...
{
int V_139 ;
V_139 = F_54 ( V_216 , & V_2 -> V_123 ) ;
if ( V_139 < 0 )
goto error;
V_139 = F_55 ( & V_2 -> V_80 , V_216 ) ;
if ( V_139 < 0 )
goto error;
return 0 ;
error:
