...
int V_13 ;
V_5 -> V_18 = & V_28 -> V_18 ;
V_5 -> V_11 = F_16 ( V_5 -> V_18 , L_4 ) ;
if ( F_3 ( V_5 -> V_11 ) ) {
if ( F_17 ( V_5 -> V_11 ) != - V_30 ) {
if ( F_17 ( V_5 -> V_11 ) != - V_31 )
F_6 ( V_5 -> V_18 , L_5 ) ;
return F_17 ( V_5 -> V_11 ) ;
}
} else {
F_18 ( V_5 -> V_11 ,
V_5 -> V_32 , V_5 -> V_32 ) ;
}
V_13 = F_19 ( & V_5 -> V_2 , NULL , true ) ;
if ( V_13 ) {
F_6 ( V_5 -> V_18 , L_6 ) ;
return V_13 ;
}
V_13 = F_20 ( V_5 -> V_18 -> V_33 ,
& V_5 -> V_2 ) ;
if ( V_13 ) {
F_6 ( V_5 -> V_18 , L_7 ) ;
F_21 ( & V_5 -> V_2 ) ;
...
struct V_52 * V_18 = & V_28 -> V_18 ;
struct V_53 * V_54 , * V_55 ;
struct V_14 * V_14 ;
struct V_56 * V_57 ;
void T_2 * V_58 ;
int V_13 ;
V_54 = F_28 ( V_18 -> V_33 , L_8 ) ;
if ( ! V_54 ) {
F_6 ( V_18 , L_9 ) ;
return - V_59 ;
}
V_57 = F_29 ( V_28 , V_60 , 0 ) ;
V_58 = F_30 ( V_18 , V_57 ) ;
if ( F_3 ( V_58 ) )
return F_17 ( V_58 ) ;
V_14 = F_31 ( V_18 , V_58 , & V_44 ) ;
if ( F_3 ( V_14 ) ) {
V_13 = F_17 ( V_14 ) ;
F_6 ( V_18 , L_10 , V_13 ) ;
return V_13 ;
