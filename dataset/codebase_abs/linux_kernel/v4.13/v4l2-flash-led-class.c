...
V_11 -> V_58 = V_58 ;
V_86 -> V_87 = V_87 ;
V_86 -> V_106 = V_104 ? V_104 : F_43 ( V_20 -> V_87 ) ;
F_44 ( V_86 , & V_107 ) ;
V_86 -> V_108 = & V_109 ;
V_86 -> V_65 |= V_110 ;
F_45 ( V_86 -> V_111 , V_64 -> V_112 , sizeof( V_86 -> V_111 ) ) ;
V_23 = F_46 ( & V_86 -> V_113 , 0 , NULL ) ;
if ( V_23 < 0 )
return F_42 ( V_23 ) ;
V_86 -> V_113 . V_114 = V_115 ;
V_23 = F_21 ( V_11 , V_64 ) ;
if ( V_23 < 0 )
goto V_116;
F_47 ( V_86 -> V_106 ) ;
