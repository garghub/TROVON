...
bool F_186 ( const struct V_197 * V_51 )
{
struct V_26 * V_27 = F_187 ( V_51 ) ;
return ! V_27 -> V_30 ;
}
int F_188 ( struct V_26 * V_27 , unsigned long V_278 )
{
unsigned long V_238 ;
V_278 = ! ! V_278 ;
F_117 ( & V_27 -> V_50 ) ;
...
int F_191 ( struct V_26 * V_27 , unsigned long V_278 )
{
switch ( V_278 ) {
case 2 :
case 3 :
...
int F_192 ( struct V_26 * V_27 , unsigned long V_278 )
{
switch ( V_278 ) {
case 1 :
case 2 :
...
V_78 . V_85 = F_2 ( V_4 ) ;
V_275 = F_201 ( V_27 , & V_78 ) ;
V_280:
F_199 () ;
return V_275 ;
}
bool F_202 ( struct V_197 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_150 * V_60 ;
bool V_275 = false ;
...
static void F_203 ( struct V_207 T_8 * V_253 ,
...
switch ( V_4 ) {
case F_2 ( V_6 ) :
V_287 = F_130 ( F_18 ( V_29 ) -> V_89 ) - F_204 ( V_29 ) ;
switch ( type ) {
case V_268 :
...
if ( F_37 ( ! V_253 ) )
return;
F_203 ( V_253 , V_29 , type , V_286 ) ;
}
int F_206 ( struct V_26 * V_27 )
{
...
void F_207 ( struct V_26 * V_27 )
{
F_121 ( V_27 -> V_206 ) ;
}
static void F_208 ( T_9 * V_21 , T_9 * V_161 )
{
V_21 [ V_186 ] += V_161 [ V_186 ] ;
V_21 [ V_182 ] += V_161 [ V_182 ] ;
}
void F_209 ( const struct V_26 * V_27 ,
const struct V_150 * V_48 ,
struct V_301 * V_302 )
{
struct V_207 T_8 * V_253 ;
...
F_210 (i) {
struct V_207 * V_304 = F_211 ( V_253 , V_43 ) ;
struct V_301 V_305 ;
unsigned int V_306 ;
do {
V_306 = F_212 ( & V_304 -> V_256 ) ;
memcpy ( & V_305 , & V_304 -> V_257 , sizeof( V_305 ) ) ;
} while ( F_213 ( & V_304 -> V_256 , V_306 ) );
F_208 ( V_303 . V_293 , V_305 . V_293 ) ;
F_208 ( V_303 . V_294 , V_305 . V_294 ) ;
F_208 ( V_303 . V_291 , V_305 . V_291 ) ;
F_208 ( V_303 . V_295 , V_305 . V_295 ) ;
F_208 ( V_303 . V_288 , V_305 . V_288 ) ;
F_208 ( V_303 . V_289 , V_305 . V_289 ) ;
F_208 ( V_303 . V_290 , V_305 . V_290 ) ;
V_303 . V_258 += V_305 . V_258 ;
F_208 ( V_303 . V_299 , V_305 . V_299 ) ;
F_208 ( V_303 . V_298 , V_305 . V_298 ) ;
F_208 ( V_303 . V_300 , V_305 . V_300 ) ;
F_208 ( V_303 . V_296 , V_305 . V_296 ) ;
F_208 ( V_303 . V_297 , V_305 . V_297 ) ;
