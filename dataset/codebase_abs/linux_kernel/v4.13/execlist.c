...
int V_101 ;
V_108 = F_60 ( V_19 -> V_125 . V_126 ,
( T_1 ) ( ( V_17 -> V_127 + 1 ) << V_128 ) ) ;
if ( V_108 == V_129 ) {
F_13 ( L_22 , V_17 -> V_127 ) ;
return - V_4 ;
}
F_52 ( V_19 , V_108 +
F_51 ( V_130 . V_82 ) , & V_120 , 4 ) ;
F_52 ( V_19 , V_108 +
F_51 ( V_131 . V_82 ) , & V_121 , 4 ) ;
V_120 &= V_132 ;
V_121 &= V_133 ;
...
F_5 ( L_25 , V_1 ) ;
V_57 = F_61 ( V_19 -> V_59 , V_135 ) ;
if ( ! V_57 )
return - V_136 ;
F_52 ( V_19 , V_108 +
F_51 ( V_137 . V_82 ) , & V_122 , 4 ) ;
F_52 ( V_19 , V_108 +
F_51 ( V_138 . V_82 ) , & V_123 , 4 ) ;
F_52 ( V_19 , V_108 +
...
int F_66 ( struct V_18 * V_19 , int V_1 )
{
struct V_5 * V_6 = & V_19 -> V_6 [ V_1 ] ;
struct V_16 V_17 [ 2 ] ;
int V_111 , V_101 ;
...
static void F_67 ( struct V_18 * V_19 , int V_1 )
{
struct V_5 * V_6 = & V_19 -> V_6 [ V_1 ] ;
struct V_37 V_38 ;
T_1 V_40 ;
...
static void F_49 ( struct V_18 * V_19 , unsigned long V_153 )
{
struct V_154 * V_155 = V_19 -> V_23 -> V_155 ;
struct V_156 * V_75 ;
struct V_56 * V_157 , * V_158 ;
unsigned int V_159 ;
F_68 (engine, dev_priv, engine_mask, tmp) {
F_40 (pos, n,
...
int F_72 ( struct V_18 * V_19 )
{
enum V_161 V_111 ;
struct V_156 * V_75 ;
F_73 (engine, vgpu->gvt->dev_priv, i) {
F_67 ( V_19 , V_111 ) ;
