...
if ( ! F_40 ( V_27 ) ) {
V_48 = F_41 ( V_27 ) ;
V_50 = F_42 ( V_26 -> V_56 . V_57 , V_27 , V_48 ) ;
F_7 ( V_50 == 0 ) ;
} else {
V_50 = F_43 ( V_27 , V_7 ) ;
V_48 = V_7 ;
...
V_31 = F_44 ( F_45 () ) ;
if ( F_46 ( F_47 ( V_26 ) , V_31 ) )
V_12 |= V_58 ;
return F_48 ( V_50 , V_27 , V_15 , V_49 , V_48 , V_12 ) ;
}
T_4 F_49 ( struct V_25 * V_26 ,
...
static bool F_53 ( unsigned long V_1 , unsigned long V_64 ,
unsigned long V_65 )
{
unsigned long V_66 ;
unsigned int V_67 , V_61 ;
V_61 = V_60 [ V_68 ] . V_61 ;
V_67 = 1 << V_61 ;
V_1 = F_54 ( V_1 , V_67 ) ;
V_64 = F_55 ( V_64 , V_67 ) ;
...
F_56 ( L_3 ,
V_1 , V_64 , V_65 , V_67 ) ;
for ( V_66 = V_1 ; V_66 < V_64 ; V_66 += V_67 )
V_69 . V_70 ( V_65 , V_66 , V_68 ,
V_7 ) ;
return true ;
}
void F_57 ( void )
...
V_64 = ( unsigned long ) V_72 ;
F_7 ( ! F_53 ( V_1 , V_64 , V_73 ) ) ;
}
void F_58 ( void )
{
unsigned long V_1 , V_64 , V_74 ;
V_1 = ( unsigned long ) V_72 ;
V_64 = ( unsigned long ) V_75 ;
V_74 = F_59 ( F_3 ( V_5 ) ) ;
F_7 ( ! F_53 ( V_1 , V_64 , V_74 ) ) ;
}
