...
V_2 -> V_30 . V_101 = F_36 ;
V_2 -> V_30 . V_102 = F_62 ;
V_2 -> V_30 . V_103 = V_104 |
V_105 |
V_106 |
V_107 ;
if ( V_86 -> V_97 == V_87 )
V_2 -> V_30 . V_103 |= V_108 ;
break;
case V_89 :
V_2 -> V_30 . V_98 = F_19 ;
V_2 -> V_30 . V_99 = F_60 ;
...
V_105 ;
if ( V_86 -> V_97 == V_91 ) {
V_2 -> V_30 . V_103 |= V_113 ;
V_2 -> V_30 . V_114 = F_67 ( 256 , 128 , 128 ) ;
}
V_2 -> V_30 . V_31 = 2 ;
V_2 -> V_30 . V_115 = 2 ;
break;
...
V_2 -> V_30 . V_103 |= V_119 | V_120 ;
}
if ( V_86 -> V_97 < F_5 ( V_66 ) && V_66 [ V_86 -> V_97 ] )
V_2 -> V_30 . V_112 = V_66 [ V_86 -> V_97 ] ;
return 0 ;
}
