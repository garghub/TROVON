...
static void T_1
F_39 ( struct V_38 * V_39 , char * * V_40 )
{
#ifdef F_40
extern int V_41 ;
V_41 = 1 ;
...
static void F_41 ( enum V_42 V_43 , const char * V_44 )
{
if ( V_43 == V_45 ) {
F_42 ( 0x41000000 ) ;
} else {
...
static enum V_48 F_47 ( struct V_46 * V_47 )
{
struct V_50 * V_51 = F_46 ( V_47 ,
struct V_50 , V_47 ) ;
unsigned long V_14 ;
...
if ( ! F_38 () )
return - V_54 ;
for ( V_29 = 0 ; V_29 < F_49 ( V_55 ) ; V_29 ++ ) {
struct V_50 * V_51 ;
V_51 = F_50 ( sizeof( * V_51 ) , V_56 ) ;
if ( ! V_51 )
break;
V_51 -> V_47 . V_57 = V_55 [ V_29 ] . V_57 ;
V_51 -> V_47 . V_58 = F_45 ;
V_51 -> V_47 . V_59 = F_47 ;
V_51 -> V_47 . V_60 = V_55 [ V_29 ] . V_61 ;
if ( V_29 == 0 )
V_51 -> V_3 = V_62 ;
else
V_51 -> V_3 = V_18 ;
if ( F_51 ( NULL , & V_51 -> V_47 ) < 0 ) {
F_52 ( V_51 ) ;
break;
}
}
