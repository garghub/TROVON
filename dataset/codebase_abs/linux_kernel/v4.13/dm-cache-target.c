...
static T_4 F_103 ( struct V_47 * V_47 , struct V_26 * V_26 )
{
...
V_57 -> V_159 -> V_33 = V_57 -> V_13 . V_16 ;
else
V_57 -> V_159 -> V_33 = V_151 ;
F_24 ( V_57 -> V_159 ) ;
} else {
if ( V_160 )
F_77 ( V_47 , V_84 ) ;
...
static int F_182 ( struct V_47 * V_47 , T_6 V_84 )
{
...
static int F_186 ( struct V_47 * V_47 , T_6 V_84 ,
...
static bool F_191 ( struct V_47 * V_47 , struct V_26 * V_26 , T_4 V_103 )
{
return F_37 ( & V_47 -> V_50 ) &&
( F_94 ( V_47 , V_103 ) || F_190 ( V_47 , V_26 ) ) ;
}
static int F_192 ( struct V_47 * V_47 , struct V_26 * V_26 , T_4 V_103 ,
bool * V_179 )
{
int V_9 , V_180 ;
bool V_181 , V_182 ;
...
static T_2 V_30 ( void * V_111 )
{
struct V_47 * V_47 = V_111 ;
if ( F_198 ( V_47 -> V_121 ) )
return F_199 ( F_196 ( V_47 , false ) ) ;
return 0 ;
}
...
static void F_204 ( struct V_47 * V_47 )
{
struct V_26 * V_26 ;
struct V_27 V_28 ;
F_19 ( & V_28 ) ;
...
{
struct V_47 * V_47 = F_17 ( F_206 ( V_15 ) , struct V_47 , V_192 ) ;
F_207 ( V_47 -> V_86 , true ) ;
F_42 ( V_47 ) ;
F_31 ( & V_47 -> V_162 ) ;
F_208 ( V_47 -> V_18 , & V_47 -> V_192 , V_193 ) ;
}
...
for (; ; ) {
V_21 = F_187 ( V_47 ) ;
V_9 = F_210 ( V_47 -> V_86 , V_21 == V_174 , & V_126 ) ;
if ( V_9 == - V_167 )
break;
if ( V_9 ) {
F_128 ( L_22 ,
...
static void F_211 ( struct V_47 * V_47 )
{
unsigned V_194 ;
F_212 ( V_47 -> V_58 ) ;
if ( V_47 -> V_53 )
...
F_217 ( V_47 -> V_121 ) ;
if ( V_47 -> V_195 )
F_218 ( V_47 -> V_87 , V_47 -> V_195 ) ;
if ( V_47 -> V_99 )
F_218 ( V_47 -> V_87 , V_47 -> V_99 ) ;
if ( V_47 -> V_104 )
F_218 ( V_47 -> V_87 , V_47 -> V_104 ) ;
if ( V_47 -> V_86 )
F_219 ( V_47 -> V_86 ) ;
for ( V_194 = 0 ; V_194 < V_47 -> V_196 ; V_194 ++ )
F_220 ( V_47 -> V_197 [ V_194 ] ) ;
F_220 ( V_47 -> V_197 ) ;
F_220 ( V_47 ) ;
}
static void F_221 ( struct V_198 * V_87 )
{
struct V_47 * V_47 = V_87 -> V_199 ;
F_211 ( V_47 ) ;
}
static T_1 F_222 ( struct V_200 * V_66 )
{
return F_223 ( V_66 -> V_100 -> V_201 ) >> V_178 ;
}
static void F_224 ( struct V_202 * V_203 )
{
if ( V_203 -> V_195 )
F_218 ( V_203 -> V_87 , V_203 -> V_195 ) ;
if ( V_203 -> V_104 )
F_218 ( V_203 -> V_87 , V_203 -> V_104 ) ;
if ( V_203 -> V_99 )
F_218 ( V_203 -> V_87 , V_203 -> V_99 ) ;
F_220 ( V_203 ) ;
}
static bool F_225 ( struct V_204 * V_205 , char * * error )
{
if ( ! V_205 -> V_206 ) {
* error = L_23 ;
return false ;
...
static int F_226 ( struct V_202 * V_203 , struct V_204 * V_205 ,
char * * error )
{
int V_9 ;
T_1 V_207 ;
char V_21 [ V_208 ] ;
if ( ! F_225 ( V_205 , error ) )
return - V_188 ;
V_9 = F_227 ( V_203 -> V_87 , F_228 ( V_205 ) , V_209 | V_210 ,
& V_203 -> V_195 ) ;
if ( V_9 ) {
* error = L_24 ;
return V_9 ;
}
V_207 = F_222 ( V_203 -> V_195 ) ;
if ( V_207 > V_211 )
F_229 ( L_25 ,
F_230 ( V_203 -> V_195 -> V_100 , V_21 ) , V_212 ) ;
return 0 ;
}
...
static int F_233 ( struct V_202 * V_203 , struct V_204 * V_205 ,
char * * error )
{
unsigned long V_215 ;
if ( ! F_225 ( V_205 , error ) )
return - V_188 ;
if ( F_234 ( F_228 ( V_205 ) , 10 , & V_215 ) || ! V_215 ||
V_215 < V_216 ||
V_215 > V_217 ||
V_215 & ( V_216 - 1 ) ) {
* error = L_29 ;
...
static void F_235 ( struct V_41 * V_218 )
{
V_218 -> V_116 = V_123 ;
V_218 -> V_43 = V_45 ;
V_218 -> V_219 = 1 ;
}
static int F_236 ( struct V_202 * V_203 , struct V_204 * V_205 ,
char * * error )
{
...
F_235 ( V_218 ) ;
V_9 = F_237 ( V_221 , V_205 , & V_206 , error ) ;
if ( V_9 )
return - V_188 ;
while ( V_206 -- ) {
V_222 = F_228 ( V_205 ) ;
...
static int F_238 ( struct V_202 * V_203 , struct V_204 * V_205 ,
char * * error )
{
static struct V_220 V_221 [] = {
{ 0 , 1024 , L_37 } ,
...
if ( ! F_225 ( V_205 , error ) )
return - V_188 ;
V_203 -> V_223 = F_228 ( V_205 ) ;
V_9 = F_237 ( V_221 , V_205 , & V_203 -> V_224 , error ) ;
if ( V_9 )
return - V_188 ;
V_203 -> V_225 = ( const char * * ) V_205 -> V_226 ;
F_239 ( V_205 , V_203 -> V_224 ) ;
return 0 ;
}
static int F_240 ( struct V_202 * V_203 , int V_206 , char * * V_226 ,
char * * error )
{
int V_9 ;
struct V_204 V_205 ;
...
if ( V_9 )
return V_9 ;
V_9 = F_233 ( V_203 , & V_205 , error ) ;
if ( V_9 )
return V_9 ;
V_9 = F_236 ( V_203 , & V_205 , error ) ;
if ( V_9 )
return V_9 ;
V_9 = F_238 ( V_203 , & V_205 , error ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
...
static int F_242 ( struct V_47 * V_47 , const char * V_64 , const char * V_227 )
{
int V_9 = F_241 ( V_47 , V_64 , V_227 ) ;
if ( V_9 == V_228 )
V_9 = F_243 ( V_47 -> V_86 , V_64 , V_227 ) ;
if ( V_9 )
F_229 ( L_39 , V_64 , V_227 ) ;
return V_9 ;
}
static int F_244 ( struct V_47 * V_47 , int V_206 , const char * * V_226 )
{
int V_9 = 0 ;
if ( V_206 & 1 ) {
F_229 ( L_40 ) ;
...
while ( V_206 ) {
V_9 = F_242 ( V_47 , V_226 [ 0 ] , V_226 [ 1 ] ) ;
if ( V_9 )
break;
V_206 -= 2 ;
V_226 += 2 ;
...
static int F_245 ( struct V_47 * V_47 , struct V_202 * V_203 ,
char * * error )
{
struct V_229 * V_230 = F_246 ( V_203 -> V_223 ,
V_47 -> V_231 ,
V_47 -> V_214 ,
V_47 -> V_93 ) ;
if ( F_247 ( V_230 ) ) {
...
static bool F_249 ( T_1 V_92 ,
T_1 V_232 )
{
( void ) F_97 ( V_232 , V_92 ) ;
return V_232 > V_233 ;
}
static T_1 F_250 ( T_1 V_234 ,
T_1 V_232 )
{
T_1 V_92 = V_234 ;
if ( V_232 )
while ( F_249 ( V_92 , V_232 ) )
V_92 *= 2 ;
return V_92 ;
}
static void F_251 ( struct V_47 * V_47 , T_6 V_235 )
{
T_8 V_236 = F_72 ( V_235 ) ;
...
static int F_253 ( struct V_200 * V_66 , int V_237 )
{
struct V_238 * V_239 = F_254 ( V_66 -> V_100 ) ;
return F_255 ( V_239 -> V_240 , V_237 ) ;
}
static int F_256 ( struct V_241 * V_242 , int V_237 )
{
struct V_47 * V_47 = F_17 ( V_242 , struct V_47 , V_243 ) ;
return F_253 ( V_47 -> V_99 , V_237 ) ||
F_253 ( V_47 -> V_104 , V_237 ) ;
}
static int F_257 ( struct V_202 * V_203 , struct V_47 * * V_244 )
{
int V_9 = 0 ;
...
V_47 -> V_243 . V_255 = F_256 ;
F_259 ( V_87 -> V_88 , & V_47 -> V_243 ) ;
...
if ( F_260 ( V_87 , V_47 -> V_93 ) ) {
V_9 = - V_188 ;
goto V_256;
}
if ( V_203 -> V_215 & ( V_203 -> V_215 - 1 ) ) {
T_8 V_231 = V_203 -> V_213 ;
V_47 -> V_89 = - 1 ;
V_231 = F_83 ( V_231 , V_203 -> V_215 ) ;
F_251 ( V_47 , F_261 ( V_231 ) ) ;
} else {
V_47 -> V_89 = F_262 ( V_203 -> V_215 ) ;
F_251 ( V_47 , F_261 ( V_203 -> V_213 >> V_47 -> V_89 ) ) ;
}
V_9 = F_245 ( V_47 , V_203 , error ) ;
if ( V_9 )
goto V_256;
V_47 -> V_257 = V_203 -> V_224 ;
V_47 -> V_173 = V_258 ;
V_9 = F_244 ( V_47 , V_203 -> V_224 , V_203 -> V_225 ) ;
if ( V_9 ) {
* error = L_45 ;
goto V_256;
}
V_121 = F_263 ( V_47 -> V_195 -> V_100 ,
V_203 -> V_215 , V_247 ,
F_264 ( V_47 -> V_86 ) ,
V_203 -> V_50 . V_219 ) ;
if ( F_247 ( V_121 ) ) {
...
V_9 = - V_165 ;
F_133 ( & V_47 -> V_85 , 0 ) ;
V_47 -> V_83 = F_268 ( F_72 ( V_47 -> V_231 ) ) ;
if ( ! V_47 -> V_83 ) {
* error = L_50 ;
goto V_256;
}
F_269 ( V_47 -> V_83 , F_72 ( V_47 -> V_231 ) ) ;
V_47 -> V_92 =
F_250 ( V_47 -> V_93 ,
V_47 -> V_214 ) ;
V_47 -> V_94 = F_87 ( F_144 ( V_47 -> V_214 ,
V_47 -> V_92 ) ) ;
V_47 -> V_97 = F_268 ( F_89 ( V_47 -> V_94 ) ) ;
if ( ! V_47 -> V_97 ) {
* error = L_51 ;
goto V_256;
}
F_269 ( V_47 -> V_97 , F_89 ( V_47 -> V_94 ) ) ;
V_47 -> V_158 = F_270 ( & V_261 ) ;
if ( F_247 ( V_47 -> V_158 ) ) {
* error = L_52 ;
V_9 = F_248 ( V_47 -> V_158 ) ;
goto V_256;
}
V_47 -> V_18 = F_271 ( L_53 V_262 , V_263 , 0 ) ;
if ( ! V_47 -> V_18 ) {
* error = L_54 ;
goto V_256;
}
F_13 ( & V_47 -> V_48 , F_202 ) ;
F_13 ( & V_47 -> V_49 ,
F_203 ) ;
F_13 ( & V_47 -> V_51 , F_209 ) ;
F_272 ( & V_47 -> V_192 , F_205 ) ;
V_47 -> V_53 = F_273 ( V_47 -> V_18 ) ;
if ( ! V_47 -> V_53 ) {
* error = L_55 ;
goto V_256;
}
V_47 -> V_58 = F_274 ( V_264 ,
V_265 ) ;
if ( ! V_47 -> V_58 ) {
* error = L_56 ;
goto V_256;
...
static int F_276 ( struct V_47 * V_47 , int V_206 , const char * * V_226 )
{
unsigned V_194 ;
const char * * F_159 ;
F_159 = F_277 ( V_206 , sizeof( * F_159 ) , V_248 ) ;
if ( ! F_159 )
return - V_165 ;
for ( V_194 = 0 ; V_194 < V_206 ; V_194 ++ ) {
F_159 [ V_194 ] = F_278 ( V_226 [ V_194 ] , V_248 ) ;
if ( ! F_159 [ V_194 ] ) {
while ( V_194 -- )
F_220 ( F_159 [ V_194 ] ) ;
F_220 ( F_159 ) ;
...
static int F_279 ( struct V_198 * V_87 , unsigned V_206 , char * * V_226 )
{
int V_9 = - V_188 ;
struct V_202 * V_203 ;
struct V_47 * V_47 = NULL ;
V_203 = F_258 ( sizeof( * V_203 ) , V_248 ) ;
if ( ! V_203 ) {
V_87 -> error = L_57 ;
return - V_165 ;
}
V_203 -> V_87 = V_87 ;
V_9 = F_240 ( V_203 , V_206 , V_226 , & V_87 -> error ) ;
if ( V_9 )
goto V_275;
V_9 = F_257 ( V_203 , & V_47 ) ;
if ( V_9 )
goto V_275;
V_9 = F_276 ( V_47 , V_206 - 3 , ( const char * * ) V_226 + 3 ) ;
if ( V_9 ) {
F_211 ( V_47 ) ;
goto V_275;
}
...
static int F_280 ( struct V_198 * V_87 , struct V_26 * V_26 )
{
struct V_47 * V_47 = V_87 -> V_199 ;
int V_9 ;
bool V_179 ;
T_4 V_103 = F_103 ( V_47 , V_26 ) ;
T_5 V_105 = F_60 ( V_47 ) ;
F_64 ( V_26 , V_105 ) ;
...
static int F_281 ( struct V_198 * V_87 , struct V_26 * V_26 ,
T_2 * error )
{
struct V_47 * V_47 = V_87 -> V_199 ;
unsigned long V_10 ;
...
static int F_282 ( struct V_47 * V_47 )
{
int V_9 ;
if ( F_115 ( V_47 ) >= V_124 )
return - V_188 ;
V_9 = F_283 ( V_47 -> V_121 , F_72 ( V_47 -> V_231 ) , V_47 -> V_83 ) ;
if ( V_9 )
F_130 ( V_47 , L_58 , V_9 ) ;
return V_9 ;
}
static int F_284 ( struct V_47 * V_47 )
{
unsigned V_194 , V_9 ;
if ( F_115 ( V_47 ) >= V_124 )
return - V_188 ;
V_9 = F_285 ( V_47 -> V_121 , V_47 -> V_92 ,
V_47 -> V_94 ) ;
if ( V_9 ) {
...
V_9 = F_286 ( V_47 -> V_121 , F_87 ( V_194 ) ,
...
static int F_287 ( struct V_47 * V_47 )
{
int V_9 ;
if ( F_115 ( V_47 ) >= V_124 )
return - V_188 ;
V_9 = F_288 ( V_47 -> V_121 , V_47 -> V_86 ) ;
if ( V_9 ) {
F_130 ( V_47 , L_62 , V_9 ) ;
return V_9 ;
}
...
static bool F_289 ( struct V_47 * V_47 )
{
...
V_280 = F_196 ( V_47 , ! V_277 && ! V_278 && ! V_279 ) ;
if ( V_280 )
F_123 ( L_66 , F_116 ( V_47 ) ) ;
return ! V_277 && ! V_278 && ! V_279 && ! V_280 ;
}
static void F_290 ( struct V_198 * V_87 )
{
struct V_47 * V_47 = V_87 -> V_199 ;
F_145 ( V_47 ) ;
...
F_291 ( & V_47 -> V_192 ) ;
F_292 ( V_47 -> V_18 ) ;
F_293 ( V_47 -> V_110 . V_4 ) ;
F_204 ( V_47 ) ;
if ( F_115 ( V_47 ) == V_123 )
( void ) F_289 ( V_47 ) ;
}
static int F_294 ( void * V_111 , T_4 V_80 , T_6 V_84 ,
bool V_281 , T_9 V_282 , bool V_283 )
{
int V_9 ;
struct V_47 * V_47 = V_111 ;
if ( V_281 ) {
...
V_9 = F_295 ( V_47 -> V_86 , V_80 , V_84 , V_281 , V_282 , V_283 ) ;
if ( V_9 )
return V_9 ;
return 0 ;
}
static void F_296 ( struct V_47 * V_47 ,
struct V_284 * V_285 )
{
V_285 -> V_47 = V_47 ;
V_285 -> V_286 = V_285 -> V_287 = 0 ;
}
static void F_297 ( struct V_284 * V_285 )
{
T_1 V_21 , V_145 ;
if ( V_285 -> V_286 == V_285 -> V_287 )
return;
V_21 = V_285 -> V_286 * V_285 -> V_215 ;
V_145 = V_285 -> V_287 * V_285 -> V_215 ;
V_21 = F_144 ( V_21 , V_285 -> V_47 -> V_92 ) ;
F_97 ( V_145 , V_285 -> V_47 -> V_92 ) ;
if ( V_145 > F_89 ( V_285 -> V_47 -> V_94 ) )
V_145 = F_89 ( V_285 -> V_47 -> V_94 ) ;
for (; V_21 < V_145 ; V_21 ++ )
F_88 ( V_285 -> V_47 , F_87 ( V_21 ) ) ;
}
static int F_298 ( void * V_111 , T_1 V_92 ,
T_10 V_288 , bool V_289 )
{
struct V_284 * V_285 = V_111 ;
V_285 -> V_215 = V_92 ;
if ( V_289 ) {
if ( F_89 ( V_288 ) == V_285 -> V_287 )
V_285 -> V_287 = V_285 -> V_287 + 1ULL ;
else {
F_297 ( V_285 ) ;
V_285 -> V_286 = F_89 ( V_288 ) ;
V_285 -> V_287 = V_285 -> V_286 + 1ULL ;
}
} else {
F_297 ( V_285 ) ;
V_285 -> V_286 = V_285 -> V_287 = 0 ;
...
static T_6 F_299 ( struct V_47 * V_47 )
{
T_1 V_235 = F_222 ( V_47 -> V_104 ) ;
( void ) F_97 ( V_235 , V_47 -> V_93 ) ;
return F_261 ( V_235 ) ;
}
static bool F_300 ( struct V_47 * V_47 , T_6 V_290 )
{
if ( F_72 ( V_290 ) > F_72 ( V_47 -> V_231 ) )
return true ;
while ( F_72 ( V_290 ) < F_72 ( V_47 -> V_231 ) ) {
V_290 = F_261 ( F_72 ( V_290 ) + 1 ) ;
if ( F_70 ( V_47 , V_290 ) ) {
F_123 ( L_67 ,
F_116 ( V_47 ) ,
( unsigned long long ) F_72 ( V_290 ) ) ;
return false ;
}
}
return true ;
}
static int F_301 ( struct V_47 * V_47 , T_6 V_290 )
{
int V_9 ;
V_9 = F_302 ( V_47 -> V_121 , V_290 ) ;
if ( V_9 ) {
...
static int F_303 ( struct V_198 * V_87 )
{
int V_9 = 0 ;
struct V_47 * V_47 = V_87 -> V_199 ;
T_6 V_291 = F_299 ( V_47 ) ;
if ( ! V_47 -> V_266 ) {
V_9 = F_301 ( V_47 , V_291 ) ;
if ( V_9 )
return V_9 ;
V_47 -> V_266 = true ;
} else if ( V_291 != V_47 -> V_231 ) {
if ( ! F_300 ( V_47 , V_291 ) )
return - V_188 ;
V_9 = F_301 ( V_47 , V_291 ) ;
if ( V_9 )
...
if ( ! V_47 -> V_269 ) {
V_9 = F_304 ( V_47 -> V_121 , V_47 -> V_86 ,
F_294 , V_47 ) ;
if ( V_9 ) {
...
F_269 ( V_47 -> V_97 , F_89 ( V_47 -> V_94 ) ) ;
F_296 ( V_47 , & V_285 ) ;
V_9 = F_305 ( V_47 -> V_121 , F_298 , & V_285 ) ;
if ( V_9 ) {
...
static void F_306 ( struct V_198 * V_87 )
{
struct V_47 * V_47 = V_87 -> V_199 ;
V_47 -> V_106 = true ;
F_149 ( V_47 ) ;
F_205 ( & V_47 -> V_192 . V_292 ) ;
}
static void F_307 ( struct V_198 * V_87 , T_11 type ,
unsigned V_293 , char * V_244 , unsigned V_294 )
{
int V_9 = 0 ;
unsigned V_194 ;
T_12 V_295 = 0 ;
...
V_9 = F_311 ( V_47 -> V_121 , & V_297 ) ;
if ( V_9 ) {
F_123 ( L_76 ,
F_116 ( V_47 ) , V_9 ) ;
goto V_302;
}
V_299 = F_312 ( V_47 -> V_86 ) ;
F_308 ( L_77 ,
( unsigned ) V_303 ,
( unsigned long long ) ( V_297 - V_296 ) ,
( unsigned long long ) V_297 ,
( unsigned long long ) V_47 -> V_93 ,
( unsigned long long ) F_72 ( V_299 ) ,
...
F_308 ( L_84 , ( unsigned long long ) V_47 -> V_173 ) ;
F_308 ( L_85 , F_313 ( V_47 -> V_86 ) ) ;
if ( V_295 < V_294 ) {
V_9 = F_314 ( V_47 -> V_86 , V_244 , V_294 , & V_295 ) ;
if ( V_9 )
F_123 ( L_86 ,
F_116 ( V_47 ) , V_9 ) ;
}
...
break;
case V_304 :
F_315 ( V_298 , V_47 -> V_195 -> V_100 -> V_305 ) ;
F_308 ( L_85 , V_298 ) ;
F_315 ( V_298 , V_47 -> V_104 -> V_100 -> V_305 ) ;
F_308 ( L_85 , V_298 ) ;
F_315 ( V_298 , V_47 -> V_99 -> V_100 -> V_305 ) ;
F_308 ( L_91 , V_298 ) ;
for ( V_194 = 0 ; V_194 < V_47 -> V_196 - 1 ; V_194 ++ )
F_308 ( L_92 , V_47 -> V_197 [ V_194 ] ) ;
if ( V_47 -> V_196 )
F_308 ( L_92 , V_47 -> V_197 [ V_47 -> V_196 - 1 ] ) ;
}
return;
V_302:
F_308 ( L_93 ) ;
}
static int F_316 ( struct V_47 * V_47 , const char * V_306 ,
struct V_307 * V_244 )
{
char V_308 ;
T_13 V_21 , V_145 ;
int V_9 ;
V_9 = sscanf ( V_306 , L_94 , & V_21 , & V_145 , & V_308 ) ;
if ( V_9 < 0 )
return V_9 ;
if ( V_9 == 2 ) {
V_244 -> V_61 = F_261 ( V_21 ) ;
V_244 -> V_62 = F_261 ( V_145 ) ;
return 0 ;
}
V_9 = sscanf ( V_306 , L_95 , & V_21 , & V_308 ) ;
if ( V_9 < 0 )
return V_9 ;
if ( V_9 == 1 ) {
V_244 -> V_61 = F_261 ( V_21 ) ;
V_244 -> V_62 = F_261 ( F_72 ( V_244 -> V_61 ) + 1u ) ;
return 0 ;
}
F_123 ( L_96 , F_116 ( V_47 ) , V_306 ) ;
return - V_188 ;
}
static int F_317 ( struct V_47 * V_47 , struct V_307 * V_309 )
{
T_13 V_21 = F_72 ( V_309 -> V_61 ) ;
T_13 V_145 = F_72 ( V_309 -> V_62 ) ;
T_13 V_90 = F_72 ( V_47 -> V_231 ) ;
if ( V_21 >= V_90 ) {
F_123 ( L_97 ,
...
static inline T_6 F_318 ( T_6 V_21 )
{
return F_261 ( F_72 ( V_21 ) + 1 ) ;
}
static int F_319 ( struct V_47 * V_47 , struct V_307 * V_309 )
{
int V_9 = 0 ;
while ( V_309 -> V_61 != V_309 -> V_62 ) {
V_9 = F_182 ( V_47 , V_309 -> V_61 ) ;
if ( V_9 )
return V_9 ;
V_309 -> V_61 = F_318 ( V_309 -> V_61 ) ;
}
V_47 -> V_268 = true ;
return V_9 ;
}
static int F_320 ( struct V_47 * V_47 , unsigned V_157 ,
const char * * V_310 )
{
int V_9 = 0 ;
unsigned V_194 ;
...
V_9 = F_316 ( V_47 , V_310 [ V_194 ] , & V_309 ) ;
if ( V_9 )
break;
V_9 = F_317 ( V_47 , & V_309 ) ;
if ( V_9 )
break;
V_9 = F_319 ( V_47 , & V_309 ) ;
if ( V_9 )
break;
}
return V_9 ;
}
static int F_321 ( struct V_198 * V_87 , unsigned V_206 , char * * V_226 )
{
struct V_47 * V_47 = V_87 -> V_199 ;
if ( ! V_206 )
return - V_188 ;
...
return F_320 ( V_47 , V_206 - 1 , ( const char * * ) V_226 + 1 ) ;
if ( V_206 != 2 )
return - V_188 ;
return F_242 ( V_47 , V_226 [ 0 ] , V_226 [ 1 ] ) ;
}
static int F_322 ( struct V_198 * V_87 ,
T_14 F_12 , void * V_312 )
{
int V_9 = 0 ;
struct V_47 * V_47 = V_87 -> V_199 ;
V_9 = F_12 ( V_87 , V_47 -> V_104 , 0 , F_222 ( V_47 -> V_104 ) , V_312 ) ;
if ( ! V_9 )
V_9 = F_12 ( V_87 , V_47 -> V_99 , 0 , V_87 -> V_11 , V_312 ) ;
return V_9 ;
}
static void F_323 ( struct V_47 * V_47 , struct V_313 * V_314 )
{
V_314 -> V_315 = F_324 ( T_1 , V_47 -> V_92 * 1024 ,
V_47 -> V_214 ) ;
V_314 -> V_316 = V_47 -> V_92 << V_178 ;
}
static void F_325 ( struct V_198 * V_87 , struct V_313 * V_314 )
{
struct V_47 * V_47 = V_87 -> V_199 ;
T_13 V_317 = V_314 -> V_318 >> V_178 ;
if ( V_317 < V_47 -> V_93 ||
F_84 ( V_317 , V_47 -> V_93 ) ) {
F_326 ( V_314 , V_47 -> V_93 << V_178 ) ;
F_327 ( V_314 , V_47 -> V_93 << V_178 ) ;
}
F_323 ( V_47 , V_314 ) ;
}
