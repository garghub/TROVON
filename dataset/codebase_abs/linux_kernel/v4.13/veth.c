...
{
if ( V_98 [ V_101 ] ) {
if ( F_46 ( V_98 [ V_101 ] ) != V_102 )
return - V_103 ;
if ( ! F_47 ( F_48 ( V_98 [ V_101 ] ) ) )
return - V_104 ;
}
if ( V_98 [ V_105 ] ) {
if ( ! F_34 ( F_49 ( V_98 [ V_105 ] ) ) )
return - V_103 ;
}
return 0 ;
}
static int F_50 ( struct V_106 * V_107 , struct V_1 * V_2 ,
...
struct V_29 * V_30 ;
char V_109 [ V_110 ] ;
struct V_97 * V_111 [ V_112 + 1 ] , * * V_113 ;
unsigned char V_114 ;
struct V_115 * V_116 ;
struct V_106 * V_106 ;
if ( V_28 != NULL && V_28 [ V_117 ] != NULL ) {
struct V_97 * V_118 ;
V_118 = V_28 [ V_117 ] ;
V_116 = F_48 ( V_118 ) ;
V_108 = F_51 ( V_111 ,
F_48 ( V_118 ) + sizeof( struct V_115 ) ,
F_46 ( V_118 ) - sizeof( struct V_115 ) ,
NULL ) ;
if ( V_108 < 0 )
return V_108 ;
V_108 = F_45 ( V_111 , NULL , V_100 ) ;
if ( V_108 < 0 )
return V_108 ;
V_113 = V_111 ;
} else {
...
if ( V_116 && V_113 [ V_119 ] ) {
F_52 ( V_109 , V_113 [ V_119 ] , V_110 ) ;
V_114 = V_120 ;
} else {
snprintf ( V_109 , V_110 , V_17 L_1 ) ;
V_114 = V_121 ;
}
V_106 = F_53 ( V_107 , V_113 ) ;
if ( F_54 ( V_106 ) )
return F_55 ( V_106 ) ;
V_31 = F_56 ( V_106 , V_109 , V_114 ,
& V_122 , V_113 ) ;
if ( F_54 ( V_31 ) ) {
F_57 ( V_106 ) ;
return F_55 ( V_31 ) ;
...
goto V_124;
F_33 ( V_31 ) ;
V_108 = F_60 ( V_31 , V_116 ) ;
if ( V_108 < 0 )
goto V_125;
if ( V_98 [ V_101 ] == NULL )
F_58 ( V_2 ) ;
if ( V_98 [ V_119 ] )
F_52 ( V_2 -> V_126 , V_98 [ V_119 ] , V_110 ) ;
else
snprintf ( V_2 -> V_126 , V_110 , V_17 L_1 ) ;
V_108 = F_59 ( V_2 ) ;
if ( V_108 < 0 )
goto V_127;
F_33 ( V_2 ) ;
...
static void F_64 ( struct V_1 * V_2 , struct V_128 * V_129 )
{
struct V_29 * V_30 ;
struct V_1 * V_31 ;
V_30 = F_8 ( V_2 ) ;
...
static struct V_106 * F_67 ( const struct V_1 * V_2 )
{
struct V_29 * V_30 = F_8 ( V_2 ) ;
struct V_1 * V_31 = F_9 ( V_30 -> V_31 ) ;
