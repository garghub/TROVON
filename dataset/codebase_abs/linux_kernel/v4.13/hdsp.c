...
snprintf ( V_152 , sizeof( V_152 ) , L_22 , V_26 -> V_170 , V_138 + 1 ) ;
...
{
struct V_10 * V_10 = F_80 ( V_190 ) ;
V_195 -> V_196 . integer . V_196 [ 0 ] = F_155 ( V_10 ) ;
return 0 ;
}
...
if ( ! F_32 ( V_10 ) )
return - V_129 ;
V_21 = V_195 -> V_196 . integer . V_196 [ 0 ] ;
F_44 ( & V_10 -> V_49 ) ;
if ( V_21 != F_155 ( V_10 ) )
...
static int F_199 ( struct V_359 * V_159 ,
int V_361 , unsigned long V_364 ,
void T_6 * V_365 , unsigned long V_58 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
char * V_366 ;
if ( F_49 ( V_364 + V_58 > V_363 ) )
return - V_119 ;
V_366 = F_198 ( V_10 , V_159 -> V_367 -> V_360 , V_361 ) ;
if ( F_49 ( ! V_366 ) )
return - V_29 ;
if ( F_200 ( V_366 + V_364 , V_365 , V_58 ) )
return - V_368 ;
return 0 ;
}
static int F_201 ( struct V_359 * V_159 ,
int V_361 , unsigned long V_364 ,
void * V_365 , unsigned long V_58 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
char * V_366 ;
V_366 = F_198 ( V_10 , V_159 -> V_367 -> V_360 , V_361 ) ;
if ( F_49 ( ! V_366 ) )
return - V_29 ;
memcpy ( V_366 + V_364 , V_365 , V_58 ) ;
return 0 ;
}
static int F_202 ( struct V_359 * V_159 ,
int V_361 , unsigned long V_364 ,
void T_6 * V_369 , unsigned long V_58 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
char * V_366 ;
if ( F_49 ( V_364 + V_58 > V_363 ) )
...
if ( F_49 ( ! V_366 ) )
return - V_29 ;
if ( F_203 ( V_369 , V_366 + V_364 , V_58 ) )
return - V_368 ;
return 0 ;
}
static int F_204 ( struct V_359 * V_159 ,
int V_361 , unsigned long V_364 ,
void * V_369 , unsigned long V_58 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
char * V_366 ;
V_366 = F_198 ( V_10 , V_159 -> V_367 -> V_360 , V_361 ) ;
if ( F_49 ( ! V_366 ) )
return - V_29 ;
memcpy ( V_369 , V_366 + V_364 , V_58 ) ;
return 0 ;
}
static int F_205 ( struct V_359 * V_159 ,
int V_361 , unsigned long V_364 ,
unsigned long V_58 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
...
static int F_208 ( struct V_359 * V_159 ,
struct V_376 * V_377 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
int V_293 ;
...
if ( F_209 ( V_377 ) != V_10 -> V_118 ) {
F_46 ( & V_10 -> V_49 ) ;
F_210 ( V_377 , V_380 ) ;
return - V_129 ;
}
if ( F_211 ( V_377 ) != V_10 -> V_91 / 4 ) {
F_46 ( & V_10 -> V_49 ) ;
F_210 ( V_377 , V_381 ) ;
return - V_129 ;
}
...
F_44 ( & V_10 -> V_49 ) ;
if ( ! V_10 -> V_219 ) {
if ( ( V_293 = F_50 ( V_10 , F_209 ( V_377 ) , 0 ) ) < 0 ) {
F_46 ( & V_10 -> V_49 ) ;
F_210 ( V_377 , V_380 ) ;
return V_293 ;
}
...
F_46 ( & V_10 -> V_49 ) ;
if ( ( V_293 = F_43 ( V_10 , F_211 ( V_377 ) ) ) < 0 ) {
F_210 ( V_377 , V_381 ) ;
return V_293 ;
}
return 0 ;
}
static int F_212 ( struct V_359 * V_159 ,
struct V_382 * V_383 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
int V_362 ;
...
static int F_213 ( struct V_359 * V_159 ,
...
return F_206 ( V_159 ) ;
case V_387 :
return F_212 ( V_159 , V_339 ) ;
default:
break;
}
return F_214 ( V_159 , V_385 , V_339 ) ;
}
static int F_215 ( struct V_359 * V_159 , int V_385 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
struct V_359 * V_372 ;
int V_373 ;
...
static int F_220 ( struct V_359 * V_159 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
int V_391 = 0 ;
if ( F_12 ( V_10 ) )
...
static int F_221 ( struct V_376 * V_377 ,
struct V_392 * V_393 )
{
struct V_10 * V_10 = V_393 -> V_394 ;
struct V_395 * V_396 = F_222 ( V_377 , V_397 ) ;
if ( V_10 -> V_13 == V_18 ) {
unsigned int V_398 [ 3 ] ;
V_398 [ 0 ] = V_10 -> V_399 ;
V_398 [ 1 ] = V_10 -> V_400 ;
V_398 [ 2 ] = V_10 -> V_401 ;
return F_223 ( V_396 , 3 , V_398 , 0 ) ;
} else {
unsigned int V_398 [ 2 ] ;
V_398 [ 0 ] = V_10 -> V_400 ;
V_398 [ 1 ] = V_10 -> V_401 ;
return F_223 ( V_396 , 2 , V_398 , 0 ) ;
}
}
static int F_224 ( struct V_376 * V_377 ,
struct V_392 * V_393 )
{
unsigned int V_398 [ 3 ] ;
struct V_10 * V_10 = V_393 -> V_394 ;
...
struct V_10 * V_10 = V_393 -> V_394 ;
struct V_395 * V_396 = F_222 ( V_377 , V_397 ) ;
struct V_395 * V_405 = F_222 ( V_377 , V_380 ) ;
...
static int F_228 ( struct V_376 * V_377 ,
struct V_392 * V_393 )
{
struct V_10 * V_10 = V_393 -> V_394 ;
struct V_395 * V_396 = F_222 ( V_377 , V_397 ) ;
...
static int F_229 ( struct V_376 * V_377 ,
struct V_392 * V_393 )
{
struct V_10 * V_10 = V_393 -> V_394 ;
struct V_395 * V_396 = F_222 ( V_377 , V_397 ) ;
...
static int F_230 ( struct V_359 * V_159 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
struct V_370 * V_371 = V_159 -> V_371 ;
if ( F_12 ( V_10 ) )
...
static int F_237 ( struct V_359 * V_159 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
struct V_370 * V_371 = V_159 -> V_371 ;
if ( F_12 ( V_10 ) )
...
static int F_238 ( struct V_359 * V_159 )
{
struct V_10 * V_10 = F_197 ( V_159 ) ;
F_44 ( & V_10 -> V_49 ) ;
V_10 -> V_67 = - 1 ;
...
static inline int F_239 ( void T_6 * V_427 , void T_8 * V_365 )
{
T_2 V_21 = F_11 ( V_365 ) ;
return F_203 ( V_427 , & V_21 , 4 ) ;
}
static inline int F_240 ( void T_6 * V_427 , void T_8 * V_428 , void T_8 * V_429 )
{
T_2 V_430 , V_431 ;
T_4 V_432 ;
V_430 = F_11 ( V_428 ) ;
...
return F_203 ( V_427 , & V_432 , 8 ) ;
}
static inline int F_241 ( void T_6 * V_427 , void T_8 * V_428 , void T_8 * V_429 )
{
T_2 V_430 , V_431 ;
T_4 V_432 ;
...
continue;
V_438 = V_440 - V_436 * 4 ;
if ( F_239 ( & V_434 -> V_441 [ V_23 ] , V_10 -> V_22 + V_438 ) )
return - V_368 ;
V_438 -= V_437 * 4 ;
if ( F_239 ( & V_434 -> V_442 [ V_23 ] , V_10 -> V_22 + V_438 ) )
return - V_368 ;
V_438 -= V_437 * 4 ;
if ( F_239 ( & V_434 -> V_443 [ V_23 ] , V_10 -> V_22 + V_438 ) )
return - V_368 ;
V_438 = V_444 + V_436 * 8 ;
if ( F_241 ( & V_434 -> V_445 [ V_23 ] , V_10 -> V_22 + V_438 ,
V_10 -> V_22 + V_438 + 4 ) )
return - V_368 ;
V_438 += V_437 * 8 ;
if ( F_241 ( & V_434 -> V_446 [ V_23 ] , V_10 -> V_22 + V_438 ,
V_10 -> V_22 + V_438 + 4 ) )
return - V_368 ;
V_438 += V_437 * 8 ;
if ( F_241 ( & V_434 -> V_447 [ V_23 ] , V_10 -> V_22 + V_438 ,
V_10 -> V_22 + V_438 + 4 ) )
return - V_368 ;
V_436 ++ ;
}
...
static int F_243 ( struct V_10 * V_10 , struct V_433 T_6 * V_434 )
{
int V_23 , V_436 ;
...
if ( F_239 ( & V_434 -> V_441 [ V_23 ] , & V_449 -> V_451 [ V_436 ] ) )
return - V_368 ;
if ( F_239 ( & V_434 -> V_442 [ V_23 ] , & V_449 -> V_452 [ V_436 ] ) )
return - V_368 ;
if ( F_239 ( & V_434 -> V_443 [ V_23 ] , & V_449 -> V_453 [ V_436 ] ) )
return - V_368 ;
if ( F_240 ( & V_434 -> V_445 [ V_23 ] , & V_449 -> V_454 [ V_436 ] ,
& V_449 -> V_455 [ V_436 ] ) )
return - V_368 ;
if ( F_240 ( & V_434 -> V_446 [ V_23 ] , & V_449 -> V_456 [ V_436 ] ,
& V_449 -> V_457 [ V_436 ] ) )
return - V_368 ;
if ( F_240 ( & V_434 -> V_447 [ V_23 ] , & V_449 -> V_458 [ V_436 ] ,
& V_449 -> V_459 [ V_436 ] ) )
return - V_368 ;
...
static int F_244 ( struct V_10 * V_10 , struct V_433 T_6 * V_434 )
{
int V_23 ;
for ( V_23 = 0 ; V_23 < 26 ; V_23 ++ ) {
if ( F_239 ( & V_434 -> V_442 [ V_23 ] ,
V_10 -> V_22 + V_460 + V_23 * 4 ) )
return - V_368 ;
if ( F_239 ( & V_434 -> V_441 [ V_23 ] ,
V_10 -> V_22 + V_461 + V_23 * 4 ) )
return - V_368 ;
}
for ( V_23 = 0 ; V_23 < 28 ; V_23 ++ ) {
if ( F_239 ( & V_434 -> V_443 [ V_23 ] ,
V_10 -> V_22 + V_462 + V_23 * 4 ) )
return - V_368 ;
}
for ( V_23 = 0 ; V_23 < 26 ; ++ V_23 ) {
if ( F_240 ( & V_434 -> V_446 [ V_23 ] ,
V_10 -> V_22 + V_463 + V_23 * 8 + 4 ,
V_10 -> V_22 + V_463 + V_23 * 8 ) )
return - V_368 ;
if ( F_240 ( & V_434 -> V_445 [ V_23 ] ,
...
static int F_245 ( struct V_465 * V_407 , struct V_466 * V_466 , unsigned int V_385 , unsigned long V_339 )
{
...
case V_18 :
return F_243 ( V_10 , V_434 ) ;
default:
return F_244 ( V_10 , V_434 ) ;
}
}
case V_469 : {
struct V_470 V_383 ;
...
V_330 ) ;
F_24 ( & V_10 -> V_49 , V_32 ) ;
if ( F_203 ( V_467 , & V_383 , sizeof( V_383 ) ) )
return - V_368 ;
break;
}
case V_488 : {
...
if ( F_203 ( V_467 , & V_490 , sizeof( V_490 ) ) )
return - V_368 ;
break;
}
case V_494 : {
...
if ( ( V_293 = F_203 ( V_467 , & V_495 , sizeof( V_495 ) ) ) )
return - V_368 ;
break;
}
case V_497 : {
...
return V_293 ;
if ( ! ( V_10 -> V_27 & V_48 ) ) {
if ( ( V_293 = F_249 ( V_10 ) ) < 0 )
return V_293 ;
F_250 ( V_10 ) ;
F_251 ( V_10 ) ;
if ( ( V_293 = F_252 ( V_10 -> V_26 , V_10 ) ) < 0 ) {
F_15 ( V_10 -> V_26 -> V_6 ,
L_176 ) ;
return V_293 ;
}
...
if ( F_203 ( V_502 -> V_503 , V_10 -> V_63 , sizeof( unsigned short ) * V_62 ) )
return - V_368 ;
break;
}
default:
...
struct V_465 * V_407 ;
int V_293 ;
if ( ( V_293 = F_254 ( V_26 , L_177 , 0 , & V_407 ) ) < 0 )
return V_293 ;
V_10 -> V_504 = V_407 ;
V_407 -> V_163 = V_10 ;
strcpy ( V_407 -> V_171 , L_178 ) ;
V_407 -> V_505 . V_506 = F_245 ;
V_407 -> V_505 . V_507 = F_245 ;
return 0 ;
}
static int F_255 ( struct V_168 * V_26 , struct V_10 * V_10 )
{
struct V_508 * V_354 ;
int V_293 ;
if ( ( V_293 = F_256 ( V_26 , V_10 -> V_310 , 0 , 1 , 1 , & V_354 ) ) < 0 )
return V_293 ;
V_10 -> V_354 = V_354 ;
V_354 -> V_163 = V_10 ;
strcpy ( V_354 -> V_171 , V_10 -> V_310 ) ;
F_257 ( V_354 , V_358 , & V_509 ) ;
F_257 ( V_354 , V_356 , & V_510 ) ;
V_354 -> V_176 = V_511 ;
return 0 ;
}
...
static int F_252 ( struct V_168 * V_26 , struct V_10 * V_10 )
{
int V_293 ;
if ( ( V_293 = F_255 ( V_26 , V_10 ) ) < 0 ) {
F_15 ( V_26 -> V_6 ,
L_185 ) ;
return V_293 ;
}
...
if ( F_259 ( & V_530 , V_529 , & V_10 -> V_2 -> V_6 ) ) {
F_15 ( V_10 -> V_26 -> V_6 ,
L_199 , V_529 ) ;
return - V_531 ;
}
...
if ( ( V_293 = F_249 ( V_10 ) ) < 0 )
return V_293 ;
if ( ( V_293 = F_253 ( V_10 -> V_26 , V_10 ) ) < 0 ) {
F_15 ( V_10 -> V_26 -> V_6 ,
L_201 ) ;
return V_293 ;
}
...
static int F_261 ( struct V_168 * V_26 ,
struct V_10 * V_10 )
{
...
V_10 -> V_26 = V_26 ;
F_73 ( & V_10 -> V_49 ) ;
F_262 ( & V_10 -> V_164 , F_192 , ( unsigned long ) V_10 ) ;
F_263 ( V_10 -> V_2 , V_534 , & V_10 -> V_17 ) ;
V_10 -> V_17 &= 0xff ;
F_264 ( V_10 -> V_2 , V_535 , 0xFF ) ;
...
if ( ( V_293 = F_265 ( V_2 ) ) < 0 )
return V_293 ;
F_266 ( V_10 -> V_2 ) ;
if ( ( V_293 = F_267 ( V_2 , L_172 ) ) < 0 )
return V_293 ;
V_10 -> V_314 = F_268 ( V_2 , 0 ) ;
if ( ( V_10 -> V_22 = F_269 ( V_10 -> V_314 , V_538 ) ) == NULL ) {
F_15 ( V_10 -> V_26 -> V_6 , L_207 ,
V_10 -> V_314 , V_10 -> V_314 + V_538 - 1 ) ;
return - V_129 ;
}
if ( F_270 ( V_2 -> V_313 , F_193 , V_539 ,
V_540 , V_10 ) ) {
...
static void F_276 ( struct V_168 * V_26 )
{
...
V_293 = F_278 ( & V_2 -> V_6 , V_278 [ V_6 ] , V_138 [ V_6 ] , V_545 ,
