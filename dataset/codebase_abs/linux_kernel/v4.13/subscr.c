...
continue;
V_46 = F_1 ( V_4 -> V_19 . V_32 . V_46 , V_4 -> V_2 ) ;
if ( V_46 == V_47 || F_28 ( & V_4 -> V_48 ) ) {
F_12 ( V_4 ) ;
F_13 ( & V_4 -> V_37 ) ;
F_15 ( V_4 ) ;
}
...
static void F_36 ( struct V_42 * V_32 ,
struct V_14 * V_15 )
{
F_21 ( V_15 ) ;
F_26 ( V_15 , V_32 ) ;
...
static struct V_3 * F_37 ( struct V_12 * V_12 ,
struct V_42 * V_32 ,
int V_2 )
{
...
if ( F_38 ( & V_11 -> V_40 ) >= V_50 ) {
F_31 ( L_2 ,
V_50 ) ;
return NULL ;
}
V_4 = F_39 ( sizeof( * V_4 ) , V_49 ) ;
if ( ! V_4 ) {
F_31 ( L_3 ) ;
return NULL ;
}
...
static void F_41 ( struct V_12 * V_12 , struct V_42 * V_32 ,
struct V_14 * V_15 , int V_2 )
{
struct V_10 * V_11 = F_4 ( V_12 , V_13 ) ;
struct V_3 * V_4 = NULL ;
T_1 V_46 ;
V_4 = F_37 ( V_12 , V_32 , V_2 ) ;
if ( ! V_4 )
return F_42 ( V_11 -> V_24 , V_15 -> V_25 ) ;
F_11 ( & V_15 -> V_36 ) ;
F_43 ( & V_4 -> V_37 , & V_15 -> V_37 ) ;
V_4 -> V_15 = V_15 ;
F_44 ( V_4 ) ;
F_21 ( V_15 ) ;
F_14 ( & V_15 -> V_36 ) ;
F_45 ( & V_4 -> V_48 , F_10 , ( unsigned long ) V_4 ) ;
V_46 = F_1 ( V_4 -> V_19 . V_32 . V_46 , V_2 ) ;
if ( V_46 != V_47 )
F_46 ( & V_4 -> V_48 , V_52 + F_47 ( V_46 ) ) ;
}
static void F_48 ( int V_25 , void * V_53 )
{
F_35 ( (struct V_14 * ) V_53 ) ;
}
static void F_49 ( struct V_12 * V_12 , int V_25 ,
...
return F_36 ( V_32 , V_15 ) ;
}
F_41 ( V_12 , V_32 , V_15 , V_2 ) ;
}
static void * F_50 ( int V_25 )
{
return ( void * ) F_29 ( V_25 ) ;
}
int F_51 ( struct V_12 * V_12 )
{
struct V_10 * V_11 = F_4 ( V_12 , V_13 ) ;
const char V_59 [] = L_5 ;
struct V_60 * V_24 ;
struct V_54 * V_61 ;
V_61 = F_30 ( sizeof( * V_61 ) , V_49 ) ;
if ( ! V_61 )
return - V_62 ;
V_61 -> V_63 = V_64 ;
V_61 -> V_65 = V_66 ;
