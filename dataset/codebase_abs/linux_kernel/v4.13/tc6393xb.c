...
unsigned V_35 )
{
struct V_5 * V_5 = F_33 ( V_34 ) ;
return ! ! ( F_13 ( V_5 -> V_8 + F_34 ( V_35 / 8 ) )
& F_35 ( V_35 ) ) ;
}
static void F_36 ( struct V_33 * V_34 ,
unsigned V_35 , int V_36 )
{
struct V_5 * V_5 = F_33 ( V_34 ) ;
T_2 V_37 ;
V_37 = F_13 ( V_5 -> V_8 + F_34 ( V_35 / 8 ) ) ;
if ( V_36 )
V_37 |= F_35 ( V_35 ) ;
else
V_37 &= ~ F_35 ( V_35 ) ;
F_6 ( V_37 , V_5 -> V_8 + F_34 ( V_35 / 8 ) ) ;
}
...
T_2 V_38 ;
F_4 ( & V_5 -> V_7 , V_6 ) ;
V_38 = F_13 ( V_5 -> V_8 + F_39 ( V_35 / 8 ) ) ;
V_38 &= ~ F_35 ( V_35 ) ;
F_6 ( V_38 , V_5 -> V_8 + F_39 ( V_35 / 8 ) ) ;
F_8 ( & V_5 -> V_7 , V_6 ) ;
return 0 ;
}
...
static int F_41 ( struct V_5 * V_5 , int V_39 )
{
V_5 -> V_40 . V_41 = L_2 ;
V_5 -> V_40 . V_42 = V_39 ;
V_5 -> V_40 . V_43 = 16 ;
