...
V_4 -> V_2 . V_70 = F_57 ( V_116 ) ;
V_4 -> V_2 . V_129 = & V_130 ;
F_58 ( V_108 , V_4 ) ;
V_4 -> V_49 = F_59 ( & V_108 -> V_5 , 0 ) ;
if ( F_50 ( V_4 -> V_49 ) )
return F_51 ( V_4 -> V_49 ) ;
V_101 = F_60 ( & V_96 , & V_4 -> V_2 ) ;
if ( V_101 )
return V_101 ;
if ( ! F_61 ( & V_4 -> V_2 ) )
F_29 ( V_4 -> V_13 , V_57 , V_61 , 0 ) ;
V_4 -> V_6 = 1 ;
V_101 = F_62 ( & V_108 -> V_5 , V_4 -> V_2 . V_7 , F_13 , 0 ,
F_63 ( & V_108 -> V_5 ) , & V_4 -> V_2 ) ;
if ( V_101 ) {
F_64 ( & V_96 , & V_4 -> V_2 ) ;
return V_101 ;
}
V_101 = F_62 ( & V_108 -> V_5 , V_4 -> V_120 , F_6 , 0 ,
F_63 ( & V_108 -> V_5 ) , & V_4 -> V_2 ) ;
if ( V_101 )
F_64 ( & V_96 , & V_4 -> V_2 ) ;
return V_101 ;
...
{
struct V_3 * V_4 = F_66 ( V_108 ) ;
return F_64 ( & V_96 , & V_4 -> V_2 ) ;
}
