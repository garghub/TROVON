...
V_3 -> V_53 = V_5 ;
V_3 -> V_23 = & V_26 -> V_55 ;
F_33 ( L_6 , V_5 -> V_9 . V_92 , ( unsigned long ) V_5 -> V_96 ) ;
F_33 ( L_7 ,
...
static int F_38 ( struct V_111 * V_51 , struct V_25 * V_26 )
{
struct V_112 * V_55 = & V_26 -> V_55 ;
F_39 ( & V_26 -> V_83 ) ;
if ( V_55 -> V_24 ) {
F_2 ( V_55 -> V_24 ) ;
V_55 -> V_24 = NULL ;
...
struct V_25 * V_26 ;
int V_113 = 32 ;
V_26 = F_43 ( sizeof( struct V_25 ) , V_114 ) ;
if ( ! V_26 )
return - V_37 ;
V_26 -> V_3 = V_3 ;
V_3 -> V_115 . V_26 = V_26 ;
...
if ( ! V_3 -> V_115 . V_26 )
return;
F_38 ( & V_3 -> V_84 , V_3 -> V_115 . V_26 ) ;
F_35 ( V_3 -> V_115 . V_26 ) ;
V_3 -> V_115 . V_26 = NULL ;
}
void F_51 ( struct V_2 * V_3 , int V_121 )
{
if ( ! V_3 -> V_115 . V_26 )
return;
F_52 ( & V_3 -> V_115 . V_26 -> V_83 , V_121 ) ;
}
bool F_53 ( struct V_2 * V_3 , struct V_17 * V_122 )
{
if ( V_122 == F_3 ( V_3 -> V_115 . V_26 -> V_55 . V_24 ) )
return true ;
return false ;
}
