...
if ( F_15 ( V_3 , V_22 ) )
continue;
F_16 ( V_3 , V_24 , V_30 , V_22 , V_23 ) ;
V_20 [ LINE ( V_24 ) ] = 1 ;
}
for ( V_25 = 0 ; V_25 < V_21 ; V_25 ++ )
if ( V_20 [ V_25 ] )
F_17 ( & V_17 -> V_5 [ V_25 ] . V_4 . V_42 -> V_4 ) ;
}
...
static inline void F_25 ( struct V_1 * V_5 )
{
T_1 V_24 ;
...
static T_3 F_26 ( int V_57 , void * V_58 )
{
...
static void F_28 ( struct V_2 * V_3 , unsigned int V_64 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
T_1 V_10 ;
if ( V_5 -> V_4 . line == V_54 ) {
...
int V_73 ;
T_1 V_10 ;
V_72 = F_30 ( 1 , & V_17 -> V_72 ) ;
if ( V_72 != 1 )
return 0 ;
V_73 = F_31 ( V_5 -> V_4 . V_57 , F_26 ,
V_74 , L_1 , V_17 ) ;
if ( V_73 ) {
F_32 ( - 1 , & V_17 -> V_72 ) ;
F_33 ( V_75 L_2 , V_5 -> V_4 . V_57 ) ;
return V_73 ;
}
F_34 ( & V_5 -> V_4 . V_49 , V_71 ) ;
V_10 = F_3 ( V_5 , V_45 ) ;
V_10 |= V_60 | V_62 ;
F_5 ( V_5 , V_45 , V_10 ) ;
...
static void F_39 ( struct V_2 * V_3 , int V_77 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
unsigned long V_71 ;
unsigned short V_10 , V_11 = 1 << V_5 -> V_4 . line ;
...
static int F_40 ( unsigned int V_78 )
{
switch ( V_78 ) {
case 50 :
return V_79 ;
...
static void F_43 ( struct V_2 * V_3 , struct V_97 * V_98 ,
struct V_97 * V_99 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
unsigned long V_71 ;
...
if ( V_98 -> V_101 & V_115 )
V_13 |= V_116 ;
V_78 = F_44 ( V_3 , V_98 , V_99 , 50 , 9600 ) ;
V_100 = F_40 ( V_78 ) ;
if ( V_100 < 0 ) {
V_78 = F_44 ( V_3 , V_99 , NULL , 50 , 9600 ) ;
V_100 = F_40 ( V_78 ) ;
if ( V_100 < 0 ) {
V_78 = 9600 ;
V_100 = V_93 ;
...
static void F_47 ( struct V_2 * V_3 , unsigned int V_42 ,
unsigned int V_125 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
unsigned long V_71 ;
...
static const char * F_48 ( struct V_2 * V_3 )
{
return L_3 ;
}
...
F_50 ( V_3 -> V_8 ) ;
V_3 -> V_8 = NULL ;
V_126 = F_30 ( - 1 , & V_17 -> V_126 ) ;
if ( ! V_126 )
F_51 ( V_3 -> V_127 , V_128 ) ;
}
static int F_52 ( struct V_2 * V_3 )
{
if ( ! V_3 -> V_8 )
V_3 -> V_8 = F_53 ( V_3 -> V_127 ,
V_128 ) ;
if ( ! V_3 -> V_8 ) {
F_33 ( V_75 L_4 ) ;
return - V_129 ;
...
static void F_56 ( struct V_2 * V_3 , int V_71 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
if ( V_71 & V_131 ) {
if ( F_54 ( V_3 ) )
...
static int F_57 ( struct V_2 * V_3 , struct V_133 * V_134 )
{
int V_73 = 0 ;
...
static void F_59 ( struct V_2 * V_3 , int V_22 )
{
struct V_1 * V_5 = F_1 ( V_3 ) ;
unsigned long V_71 ;
...
F_63 ( ( char * ) V_160 ) ;
#endif
F_64 ( & V_5 -> V_4 , V_160 , V_161 , F_59 ) ;
}
static int T_4 F_65 ( struct V_158 * V_159 , char * V_163 )
{
struct V_1 * V_5 = & V_16 . V_5 [ V_159 -> V_162 ] ;
struct V_2 * V_3 = & V_5 -> V_4 ;
int V_78 = 9600 ;
...
F_47 ( V_3 , 0 , - 1 ) ;
if ( V_163 )
F_67 ( V_163 , & V_78 , & V_36 , & V_164 , & V_165 ) ;
return F_68 ( & V_5 -> V_4 , V_159 , V_78 , V_36 , V_164 , V_165 ) ;
}
...
if ( V_166 )
return - V_168 ;
F_33 ( L_6 , V_169 , V_170 ) ;
F_58 () ;
V_73 = F_72 ( & V_171 ) ;
if ( V_73 )
return V_73 ;
for ( V_25 = 0 ; V_25 < V_21 ; V_25 ++ )
F_73 ( & V_171 , & V_16 . V_5 [ V_25 ] . V_4 ) ;
return 0 ;
}
