...
V_2 -> V_43 = V_44 ;
V_2 -> V_45 = & V_46 ;
F_18 ( V_2 , V_10 -> V_25 [ 0 ] , V_10 -> V_47 -> V_48 ) ;
F_19 ( V_2 , & V_9 -> V_10 . V_11 , V_28 -> V_49 ,
V_28 -> V_50 ) ;
V_2 -> V_51 = V_13 -> V_39 . V_52 ;
V_2 -> V_53 = V_23 ;
F_20 ( & V_13 -> V_13 . V_54 -> V_55 , & V_13 -> V_13 . V_56 ) ;
V_2 -> V_41 . V_57 = 0 ;
V_2 -> V_41 . V_58 = V_23 ;
V_9 -> V_10 . V_59 = true ;
return 0 ;
...
{
struct V_60 * V_14 = & V_9 -> V_10 . V_14 ;
F_22 ( L_5 ) ;
F_23 ( & V_9 -> V_10 . V_11 ) ;
if ( V_14 -> V_15 ) {
F_24 ( V_14 -> V_15 ) ;
