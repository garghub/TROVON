...
static long F_55 ( struct V_120 * V_120 , unsigned int V_130 ,
unsigned long V_131 )
{
switch( V_130 ) {
#ifdef F_56
...
if ( ! F_32 ( V_135 ) )
return - V_136 ;
if ( F_58 ( & V_2 , ( void T_5 * ) V_131 , sizeof( V_2 ) ) != 0 )
return - V_129 ;
...
static void T_2 F_60 ( char * V_139 )
{
struct V_140 * V_141 ;
F_57 ( V_133 L_26 , V_139 ) ;
F_57 ( V_133 L_27 ) ;
F_61 (tmp_part, &nvram_partitions, partition) {
F_57 ( V_133 L_28 ,
...
static int T_2 F_62 ( struct V_140 * V_2 )
{
T_1 V_8 ;
int V_7 ;
struct V_145 V_146 ;
...
static unsigned char T_2 F_63 ( struct V_145 * V_21 )
{
...
static int F_64 ( struct V_140 * V_2 ,
...
int V_7 ;
F_61 (part, &nvram_partitions, partition) {
if ( ! F_64 ( V_2 , V_22 , V_75 , V_151 ) )
continue;
V_2 -> V_142 . V_143 = V_154 ;
memset ( V_2 -> V_142 . V_22 , 'w' , 12 ) ;
V_2 -> V_142 . V_144 = F_63 ( & V_2 -> V_142 ) ;
V_7 = F_62 ( V_2 ) ;
if ( V_7 <= 0 ) {
F_57 ( V_155 L_29 , V_7 ) ;
return V_7 ;
...
V_153 = NULL ;
F_65 (part, tmp, &nvram_partitions, partition) {
...
V_153 -> V_142 . V_144 = F_63 ( & V_153 -> V_142 ) ;
V_7 = F_62 ( V_153 ) ;
if ( V_7 <= 0 ) {
F_57 ( V_155 L_29 , V_7 ) ;
return V_7 ;
...
long V_13 = 0 ;
int V_7 ;
V_25 = F_67 ( V_25 , V_160 ) / V_160 ;
V_24 = F_67 ( V_24 , V_160 ) / V_160 ;
if ( V_24 == 0 )
V_24 = V_25 ;
if ( V_24 > V_25 )
return - V_136 ;
...
V_157 -> V_142 . V_144 = F_63 ( & V_157 -> V_142 ) ;
V_7 = F_62 ( V_157 ) ;
if ( V_7 <= 0 ) {
F_3 ( L_31 , V_18 , V_7 ) ;
F_27 ( V_157 ) ;
...
{
struct V_140 * V_21 ;
F_61 (p, &nvram_partitions, partition) {
