...
V_2 -> V_106 &= ~ V_108 ;
if ( ! V_2 -> V_106 ) {
if ( F_32 ( V_2 -> V_23 . V_109 || V_2 -> V_26 . V_109 ) )
return;
F_13 ( V_2 ) ;
F_5 ( V_2 ) ;
}
...
struct V_3 * V_4 ;
int V_89 ;
V_4 = F_43 ( & V_136 -> V_10 , sizeof( * V_4 ) , V_90 ) ;
if ( ! V_4 )
return - V_91 ;
V_5 = V_4 ;
V_4 -> V_10 = & V_136 -> V_10 ;
...
if ( V_89 )
return V_89 ;
memcpy ( & V_4 -> V_28 , V_138 -> V_142 , V_138 -> V_143 ) ;
F_45 ( V_138 ) ;
V_140 = F_46 ( V_136 , V_144 , 0 ) ;
if ( ! V_140 )
return - V_114 ;
V_141 = F_47 ( & V_136 -> V_10 , V_140 -> V_145 ,
F_48 ( V_140 ) , V_136 -> V_146 ) ;
if ( ! V_141 ) {
F_17 ( & V_136 -> V_10 , L_20 ) ;
return - V_65 ;
}
V_4 -> V_49 = F_49 ( & V_136 -> V_10 , V_140 -> V_145 , V_147 ) ;
if ( ! V_4 -> V_49 )
return - V_91 ;
V_4 -> V_53 = F_49 ( & V_136 -> V_10 , V_140 -> V_145 + V_148 ,
V_149 ) ;
if ( ! V_4 -> V_53 )
return - V_91 ;
V_4 -> V_57 = F_49 ( & V_136 -> V_10 , V_140 -> V_145 + V_150 ,
V_151 ) ;
if ( ! V_4 -> V_57 )
return - V_91 ;
V_4 -> V_7 = F_49 ( & V_136 -> V_10 , V_140 -> V_145 + V_152 ,
F_48 ( V_140 ) - V_152 ) ;
if ( ! V_4 -> V_7 )
return - V_91 ;
F_50 ( & V_136 -> V_10 , V_4 ) ;
V_89 = F_51 ( & V_136 -> V_10 , & V_153 ,
& V_154 , 1 ) ;
if ( V_89 < 0 )
return V_89 ;
V_89 = F_52 ( & V_136 -> V_10 , & V_155 ) ;
if ( V_89 < 0 )
return V_89 ;
F_53 ( & V_136 -> V_10 ) ;
return 0 ;
