...
struct V_55 * V_56 )
{
struct V_39 * V_42 [ V_57 + 1 ] ;
struct V_2 * V_58 ;
struct V_1 * V_19 ;
int V_11 ;
if ( V_52 != V_59 && V_52 != V_60 )
return - V_61 ;
V_11 = F_26 ( V_42 , V_57 , V_51 , V_62 , V_56 ) ;
if ( V_11 < 0 )
return V_11 ;
if ( ! V_42 [ V_63 ] && ! V_42 [ V_64 ] && ! V_42 [ V_65 ] )
return - V_18 ;
V_58 = F_33 ( sizeof( * V_19 ) ) ;
if ( ! V_58 )
return - V_34 ;
V_58 -> type = V_66 ;
V_19 = F_1 ( V_58 ) ;
...
if ( V_42 [ V_65 ] ) {
V_58 -> V_67 |= V_73 ;
V_11 = F_25 ( V_42 [ V_65 ] , & V_19 -> V_35 ,
V_74 ) ;
if ( V_11 < 0 )
goto V_70;
}
if ( V_42 [ V_75 ] ) {
T_1 V_76 = F_28 ( V_42 [ V_75 ] ) ;
if ( V_76 > V_77 ) {
V_11 = - V_78 ;
goto V_70;
}
...
return - V_80 ;
return F_37 ( V_6 , V_79 ) ;
}
static int F_38 ( struct V_5 * V_6 , struct V_2 * V_3 )
{
struct V_1 * V_19 = F_1 ( V_3 ) ;
if ( F_34 ( V_6 , V_63 , & V_19 -> V_21 ) < 0 ||
F_34 ( V_6 , V_64 , & V_19 -> V_24 ) < 0 ||
F_34 ( V_6 , V_65 , & V_19 -> V_35 ) < 0 )
return - V_80 ;
return 0 ;
}
static int F_39 ( struct V_2 * V_20 )
{
int V_81 = F_40 ( sizeof( struct V_39 ) ) +
F_40 ( V_82 ) +
0 ;
return V_81 +
V_81 +
...
static int F_41 ( struct V_7 * V_83 , struct V_7 * V_84 )
{
if ( ! V_83 -> V_15 && ! V_84 -> V_15 )
return 0 ;
if ( ! V_83 -> V_15 || ! V_84 -> V_15 )
return 1 ;
return strcmp ( V_83 -> V_15 , V_84 -> V_15 ) ;
}
static int F_42 ( struct V_2 * V_83 , struct V_2 * V_84 )
{
struct V_1 * V_85 = F_1 ( V_83 ) ;
struct V_1 * V_86 = F_1 ( V_84 ) ;
return F_41 ( & V_85 -> V_21 , & V_86 -> V_21 ) ||
F_41 ( & V_85 -> V_24 , & V_86 -> V_24 ) ||
F_41 ( & V_85 -> V_35 , & V_86 -> V_35 ) ;
}
static int T_2 F_43 ( void )
{
return F_44 ( & V_87 , V_66 ) ;
}
