...
{
struct V_322 V_323 ;
if ( F_117 ( & V_323 , V_255 , sizeof( * V_255 ) ) )
return - V_63 ;
V_321 -> type = V_323 . type ;
V_321 -> V_168 = V_323 . V_168 ;
V_321 -> V_121 = V_323 . V_121 ;
V_321 -> V_15 = V_323 . V_15 ;
V_321 -> V_258 = F_185 ( V_323 . V_258 ) ;
V_321 -> V_259 = V_323 . V_259 ;
V_321 -> V_109 = V_323 . V_109 ;
V_321 -> V_293 = V_323 . V_293 ;
V_321 -> V_107 = V_323 . V_107 ;
V_321 -> V_306 = V_323 . V_306 ;
V_321 -> V_120 = V_323 . V_120 ;
V_321 -> V_324 = F_185 ( V_323 . V_324 ) ;
return 0 ;
}
...
if ( F_171 ( F_191 ( V_304 ) , ( T_8 T_5 * ) V_211 ) )
return - V_63 ;
return 0 ;
}
...
int V_309 ;
F_63 ( & V_7 -> V_9 -> V_9 , L_33 , V_74 -> V_87 ) ;
V_309 = F_190 ( V_74 , ( void T_5 * T_5 * ) V_211 ) ;
F_33 ( V_74 ) ;
return V_309 ;
}
if ( F_176 ( V_153 ) )
...
static int F_197 ( struct V_6 * V_7 , struct V_326 * V_327 )
{
int V_20 ;
void * V_46 = NULL ;
int V_309 = 0 ;
...
if ( V_7 -> V_147 )
return - V_149 ;
V_20 = F_198 ( V_327 -> V_329 ) ;
if ( V_20 > 0 ) {
V_46 = F_96 ( V_20 , V_31 ) ;
if ( V_46 == NULL )
return - V_5 ;
if ( ( F_199 ( V_327 -> V_329 ) & V_330 ) ) {
...
struct V_338 V_339 ;
struct V_326 V_213 ;
if ( F_117 ( & V_339 , F_185 ( V_211 ) , sizeof( V_339 ) ) )
return - V_63 ;
V_213 . V_331 = V_339 . V_331 ;
V_213 . V_329 = V_339 . V_329 ;
V_213 . V_93 = F_185 ( V_339 . V_93 ) ;
return F_197 ( V_7 , & V_213 ) ;
}
...
if ( F_95 ( V_340 , ( unsigned T_5 * ) V_211 ) )
return - V_63 ;
return F_208 ( V_7 -> V_9 , V_340 , V_7 ) ;
}
...
return - V_55 ;
if ( V_140 -> V_9 . V_237 ) {
struct V_328 * V_237 = F_200 ( V_140 -> V_9 . V_237 ) ;
if ( V_7 -> V_147 )
return - V_149 ;
if ( ( V_352 . V_15 & V_353 ) &&
...
V_355 = F_212 ( V_140 , V_197 , V_196 , V_195 , V_31 ) ;
F_14 ( V_197 ) ;
return V_355 ;
}
...
F_68 ( V_7 ,
V_140 -> V_143 [ 0 ] . V_71 . V_144 ) ;
V_355 = F_214 ( V_140 , V_197 , V_196 , V_31 ) ;
F_14 ( V_197 ) ;
return V_355 ;
}
...
static long F_216 ( struct V_26 * V_26 , unsigned int V_356 ,
void T_5 * V_136 )
{
struct V_6 * V_7 = V_26 -> V_27 ;
...
F_30 ( V_9 ) ;
if ( V_30 >= 0 )
V_203 -> V_393 = F_219 ( V_203 ) ;
return V_30 ;
}
static long F_220 ( struct V_26 * V_26 , unsigned int V_356 ,
unsigned long V_211 )
{
int V_30 ;
V_30 = F_216 ( V_26 , V_356 , ( void T_5 * ) V_211 ) ;
return V_30 ;
}
...
{
int V_30 ;
V_30 = F_216 ( V_26 , V_356 , F_185 ( V_211 ) ) ;
return V_30 ;
}
