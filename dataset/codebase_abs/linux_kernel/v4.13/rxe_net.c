...
int F_70 ( struct V_1 * V_4 , struct V_69 * V_70 , struct V_65 * V_66 )
{
struct V_65 * V_137 ;
struct V_47 * V_48 ;
int V_14 ;
V_48 = F_64 ( V_70 ) ;
V_137 = F_71 ( V_66 , V_138 ) ;
if ( ! V_137 )
return - V_139 ;
V_137 -> V_140 = F_66 ;
V_137 -> V_43 = V_70 -> V_46 -> V_43 -> V_43 ;
if ( V_48 -> V_53 == V_54 ) {
V_14 = F_72 ( F_53 ( F_73 ( V_66 ) -> V_10 ) , V_137 -> V_43 , V_137 ) ;
} else if ( V_48 -> V_53 == V_59 ) {
V_14 = F_74 ( F_53 ( F_73 ( V_66 ) -> V_10 ) , V_137 -> V_43 , V_137 ) ;
} else {
F_21 ( L_6 , V_48 -> V_53 ) ;
F_32 ( V_137 ) ;
return - V_141 ;
...
static inline int F_80 ( struct V_1 * V_4 , struct V_47 * V_48 )
{
return V_4 -> V_81 . V_143 == V_48 -> V_128 . V_144 . V_145 . V_146 ;
}
struct V_65 * F_81 ( struct V_1 * V_4 , struct V_47 * V_48 ,
...
V_147 = V_148 + sizeof( struct V_67 ) +
sizeof( struct V_113 ) ;
V_66 = F_82 ( V_77 + V_147 + F_83 ( V_4 -> V_3 ) ,
V_138 ) ;
if ( F_19 ( ! V_66 ) )
return NULL ;
F_84 ( V_66 , V_147 + F_83 ( V_4 -> V_3 ) ) ;
V_66 -> V_10 = V_4 -> V_3 ;
if ( V_48 -> V_53 == V_54 )
...
V_70 -> V_4 = V_4 ;
V_70 -> V_72 = 1 ;
V_70 -> V_73 = F_85 ( V_66 , V_77 ) ;
V_70 -> V_75 |= V_76 ;
memset ( V_70 -> V_73 , 0 , V_77 ) ;
return V_66 ;
}
const char * F_86 ( struct V_1 * V_4 , unsigned int V_72 )
{
return V_4 -> V_3 -> V_7 ;
}
enum V_151 F_87 ( struct V_1 * V_4 , unsigned int V_72 )
{
return V_152 ;
}
struct V_1 * F_88 ( struct V_2 * V_3 )
{
int V_14 ;
struct V_1 * V_4 = NULL ;
V_4 = (struct V_1 * ) F_89 ( sizeof( * V_4 ) ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_3 = V_3 ;
V_14 = F_90 ( V_4 , V_3 -> V_153 ) ;
if ( V_14 ) {
F_91 ( & V_4 -> V_8 ) ;
return NULL ;
}
F_2 ( & V_6 ) ;
F_92 ( & V_4 -> V_154 , & V_155 ) ;
F_4 ( & V_6 ) ;
return V_4 ;
}
void F_93 ( void )
...
F_98 ( V_4 , V_167 ) ;
F_101 ( L_8 , V_4 -> V_8 . V_7 ) ;
}
void F_102 ( struct V_1 * V_4 )
{
struct V_161 * V_81 ;
V_81 = & V_4 -> V_81 ;
...
F_98 ( V_4 , V_170 ) ;
F_101 ( L_9 , V_4 -> V_8 . V_7 ) ;
}
static int F_103 ( struct V_171 * V_172 ,
unsigned long V_157 ,
void * V_173 )
{
struct V_2 * V_3 = F_104 ( V_173 ) ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
if ( ! V_4 )
goto V_174;
switch ( V_157 ) {
