...
F_8 ( L_3 , V_27 ,
V_25 -> V_13 . V_14 , V_25 -> V_13 . V_28 ,
( V_17 ? 1 : 0 ) ) ;
args [ 0 ] . type = V_29 ;
args [ 0 ] . integer . V_30 = V_25 -> V_13 . V_28 ;
args [ 1 ] . type = V_29 ;
args [ 1 ] . integer . V_30 = ( V_17 ) ? 1 : 0 ;
F_4 ( V_25 ) ;
V_23 = F_9 ( V_31 , L_4 , & V_20 , & V_24 ) ;
if ( F_10 ( V_23 ) ) {
F_7 ( L_5 , V_23 ) ;
return - V_26 ;
} else if ( ! V_24 ) {
