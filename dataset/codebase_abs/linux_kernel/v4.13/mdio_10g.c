...
V_66 . V_74 . V_75 ) ;
if ( V_70 == V_69 &&
V_65 -> V_67 . V_76 == V_66 . V_67 . V_76 &&
V_65 -> V_67 . V_77 == V_66 . V_67 . V_77 &&
V_65 -> V_67 . V_5 == V_66 . V_67 . V_5 &&
V_65 -> V_67 . V_78 == V_66 . V_67 . V_78 )
return 0 ;
if ( V_66 . V_67 . V_5 != V_79 || V_65 -> V_67 . V_5 != V_79 )
return - V_80 ;
if ( ! V_65 -> V_67 . V_78 ||
( V_70 | V_81 ) & ~ V_71 )
return - V_80 ;
...
{
int V_83 ;
F_27 ( ! ( V_13 -> V_48 . V_84 & V_45 ) ) ;
V_83 = V_85 | V_86 ;
if ( V_13 -> V_87 & V_88 )
V_83 |= V_89 ;
if ( V_13 -> V_87 & V_90 )
V_83 |= V_91 ;
F_4 ( V_13 , V_15 , V_92 , V_83 ) ;
V_13 -> V_72 -> V_93 ( V_13 , V_13 -> V_87 ) ;
V_83 = F_6 ( V_13 , V_15 , V_10 ) ;
V_83 |= V_94 | V_95 | V_96 ;
F_4 ( V_13 , V_15 , V_10 , V_83 ) ;
}
...
{
int V_26 ;
int V_102 = F_11 ( V_13 -> V_48 . V_84 ) ;
T_3 V_103 , V_104 ;
F_33 ( & V_13 -> V_105 ) ;
V_103 = F_6 ( V_13 , V_102 , V_106 ) ;
V_104 = F_6 ( V_13 , V_102 , V_107 ) ;
if ( ( V_103 == 0x0000 ) || ( V_103 == 0xffff ) ||
( V_104 == 0x0000 ) || ( V_104 == 0xffff ) ) {
F_8 ( V_13 , V_19 , V_13 -> V_20 ,
L_10 , V_13 -> V_48 . V_108 ) ;
V_26 = - V_80 ;
} else {
V_26 = F_10 ( V_13 , V_13 -> V_48 . V_84 ) ;
}
F_34 ( & V_13 -> V_105 ) ;
return V_26 ;
}
