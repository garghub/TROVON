...
void F_66 ( struct V_1 * V_2 , int V_30 )
{
...
if ( ! V_14 )
return;
F_5 ( V_2 , V_14 -> V_15 + V_80 , & V_107 ) ;
if ( ( V_107 & V_78 ) && ( V_107 & V_79 ) ) {
F_67 ( & V_2 -> V_2 , L_9 ,
V_104 , V_42 ) ;
return;
}
...
if ( V_42 -> V_54 & V_91 )
return;
F_68 ( V_2 -> V_6 , & V_106 , V_42 ) ;
V_108 = V_106 . V_55 ;
V_108 |= V_42 -> V_54 & ~ V_111 ;
V_109 = V_14 -> V_15 + V_94 + 4 * V_104 ;
F_49 ( V_2 , V_109 , V_108 ) ;
if ( V_42 -> V_54 & V_92 ) {
V_108 = V_106 . V_55 >> 16 >> 16 ;
F_49 ( V_2 , V_109 + 4 , V_108 ) ;
}
}
T_1 __weak F_69 ( struct V_1 * V_2 ,
int V_30 )
{
return F_15 ( V_2 , V_30 ) ;
}
T_1 F_70 ( struct V_1 * V_2 , int V_30 )
{
return F_69 ( V_2 , V_30 ) ;
}
...
int F_73 ( struct V_1 * V_2 , int V_12 )
{
F_74 () ;
if ( ! V_2 -> V_4 )
return - V_74 ;
...
if ( ! V_2 -> V_4 )
return 0 ;
F_5 ( V_2 , V_2 -> V_9 -> V_15 + V_46 , & V_115 ) ;
V_113 = F_78 ( V_2 -> V_45 , V_115 , NULL ) ;
while ( V_113 ) {
if ( V_113 -> V_50 && ( V_113 -> V_49 == V_2 ) &&
F_79 ( V_113 ) )
V_114 ++ ;
V_113 = F_78 ( V_2 -> V_45 , V_115 , V_113 ) ;
}
return V_114 ;
}
int F_80 ( struct V_1 * V_2 , T_3 V_116 )
{
if ( ! V_2 -> V_4 )
return - V_74 ;
