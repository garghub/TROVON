...
break;
case 1 :
V_48 = F_16 ( ( V_57 V_26 * ) V_9 -> V_19 ) ;
break;
case 2 :
V_48 = F_17 ( ( unsigned V_26 * ) V_9 -> V_19 ,
...
F_2 ( V_49 , V_9 ,
L_9 ) ;
if ( F_10 ( ! F_18 ( & V_42 -> V_66 . signal , V_67 ) &&
! F_18 ( & V_42 -> V_66 . signal , V_35 ) ) )
goto V_51;
return true ;
}
V_9 -> V_17 = V_48 ;
...
static const char * F_20 ( struct V_68 * V_69 )
{
return L_10 ;
}
struct V_68 * F_21 ( struct V_70 * V_71 )
{
#ifdef F_22
if ( ! V_71 || V_71 -> V_72 . V_73 )
return NULL ;
#endif
if ( V_2 == V_5 )
return NULL ;
...
int F_23 ( struct V_70 * V_71 , unsigned long V_20 )
{
struct V_68 * V_69 = F_21 ( V_71 ) ;
if ( ! V_69 )
return 0 ;
return ( V_20 >= V_69 -> V_75 ) && ( V_20 < V_69 -> V_76 ) ;
}
int F_24 ( unsigned long V_20 )
{
return V_2 != V_5 && ( V_20 & V_77 ) == V_22 ;
}
void T_1 F_25 ( void )
{
extern char V_78 ;
unsigned long V_79 = F_26 ( & V_78 ) ;
if ( V_2 != V_5 )
F_27 ( V_80 , V_79 ,
V_2 == V_4
? V_81
: V_82 ) ;
F_28 ( ( unsigned long ) F_29 ( V_80 ) !=
( unsigned long ) V_22 ) ;
}
