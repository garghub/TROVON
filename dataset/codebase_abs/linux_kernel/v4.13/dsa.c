...
int F_13 ( struct V_8 * V_28 )
{
struct V_5 * V_6 = V_28 -> V_6 ;
struct V_3 * V_29 ;
struct V_30 * V_31 ;
V_29 = V_28 -> V_32 ;
V_31 = F_14 ( V_6 -> V_4 , sizeof( * V_31 ) , V_33 ) ;
if ( ! V_31 )
return - V_34 ;
memcpy ( & V_28 -> V_30 , V_29 -> V_30 ,
sizeof( struct V_30 ) ) ;
V_28 -> V_35 = V_29 -> V_30 ;
memcpy ( V_31 , & V_28 -> V_30 ,
sizeof( struct V_30 ) ) ;
F_15 ( V_31 ) ;
V_29 -> V_30 = V_31 ;
return 0 ;
}
void F_16 ( struct V_8 * V_28 )
{
V_28 -> V_32 -> V_30 = V_28 -> V_35 ;
}
...
static int F_19 ( struct V_7 * V_4 , void * V_36 )
{
if ( V_4 -> V_36 != NULL && ! strcmp ( V_4 -> V_36 -> V_37 , V_36 ) )
return 1 ;
return 0 ;
}
static struct V_7 * F_20 ( struct V_7 * V_38 , char * V_36 )
{
if ( F_19 ( V_38 , V_36 ) ) {
F_21 ( V_38 ) ;
return V_38 ;
...
if ( ! V_2 )
return 0 ;
V_47 = V_45 -> V_49 ( V_2 , V_4 , V_42 , V_43 ) ;
if ( ! V_47 ) {
F_28 ( V_2 ) ;
return 0 ;
}
...
if ( ! F_34 ( V_6 , V_58 ) )
continue;
V_16 = F_35 ( V_6 -> V_60 [ V_58 ] . V_32 ) ;
if ( V_16 )
return V_16 ;
}
if ( V_6 -> V_20 -> V_61 )
V_16 = V_6 -> V_20 -> V_61 ( V_6 ) ;
return V_16 ;
}
