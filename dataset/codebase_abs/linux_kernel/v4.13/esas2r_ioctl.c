...
struct V_61 * V_62 =
(struct V_61 * ) V_40 ;
F_23 ( V_8 , V_2 , V_4 , V_4 -> V_63 -> V_55 . V_64 ) ;
F_24 ( V_2 , V_4 , V_8 -> V_50 , V_65 ) ;
if ( ! F_25 ( V_2 , V_4 , V_8 ) ) {
V_62 -> V_21 = V_66 ;
return false ;
}
...
static V_35 F_27 ( struct V_1 * V_2 , struct V_61 * V_62 )
{
struct V_40 V_45 ;
...
struct V_3 * V_4 )
{
V_4 -> V_69 = F_30 ( V_4 -> V_70 . V_71 . V_72 . V_69 ) ;
V_4 -> V_63 -> V_73 . V_74 |= F_31 ( V_4 -> V_70 . V_71 . V_72 . V_75 ) ;
(* V_4 -> V_76 )( V_2 , V_4 ) ;
}
...
if ( F_33 ( V_81 , & V_2 -> V_74 ) )
return false ;
F_23 ( V_8 , V_2 , V_4 , V_4 -> V_63 -> V_55 . V_64 ) ;
F_24 ( V_2 , V_4 , V_8 -> V_50 , V_82 ) ;
V_55 -> V_72 . V_79 = F_31 ( V_79 ) ;
V_55 -> V_72 . V_69 = F_34 ( V_69 ) ;
V_55 -> V_72 . V_75 = ( V_35 ) F_28 ( V_4 -> V_63 -> V_73 . V_74 ) ;
V_4 -> V_83 = V_78 ;
V_4 -> V_76 = V_4 -> V_36 ;
V_4 -> V_36 = F_29 ;
if ( ! F_25 ( V_2 , V_4 , V_8 ) )
...
static bool F_35 ( struct V_84 V_75 )
{
bool V_46 ;
V_46 = ( ( V_75 . V_84 [ 7 ] == 0 ) &&
( V_75 . V_84 [ 6 ] == 0 ) &&
...
if ( V_87 > 0 ) {
V_4 -> V_70 . V_71 . V_72 . V_104 = F_31 (
V_105 ) ;
return false ;
}
V_4 -> V_69 = V_88 ;
V_4 -> V_63 -> V_73 . V_74 |= F_31 ( V_75 ) ;
switch ( V_78 -> V_93 ) {
case V_106 :
{
struct V_107 * V_108 = & V_86 -> V_109 ;
strcpy ( V_108 -> V_110 , F_37 ( V_2 ) ) ;
V_108 -> V_111 = V_112 ;
V_108 -> V_113 = V_114 ;
break;
}
...
F_38 ( V_2 -> V_26 , V_122 ,
& V_117 -> V_123 ) ;
V_117 -> V_124 = F_39 ( V_2 -> V_26 -> V_125 ,
V_2 -> V_26 -> V_126 ) ;
V_117 -> V_127 = V_128 ;
V_117 -> V_129 = V_130 ;
V_117 -> V_131 = V_132 ;
V_117 -> V_133 . V_134 = V_2 -> V_26 -> V_135 -> V_136 ;
V_117 -> V_133 . V_137 = F_40 ( V_2 -> V_26 -> V_138 ) ;
V_117 -> V_133 . V_139 = F_41 ( V_2 -> V_26 -> V_138 ) ;
memset ( V_117 -> V_140 , 0 , sizeof( V_117 -> V_140 ) ) ;
V_117 -> V_141 = F_42 ( F_43 ( V_2 -> V_142 ) ) ;
V_117 -> V_143 = F_44 ( F_43 ( V_2 -> V_142 ) ) ;
V_117 -> V_144 = F_42 ( F_45 ( V_2 -> V_142 ) ) ;
V_117 -> V_145 = F_44 ( F_45 ( V_2 -> V_142 ) ) ;
V_117 -> V_146 = F_44 ( F_45 ( V_2 -> V_147 ) ) ;
V_117 -> V_148 = F_42 ( F_45 ( V_2 -> V_147 ) ) ;
V_117 -> V_149 = F_43 ( V_2 -> V_147 ) ;
if ( F_33 ( V_150 , & V_2 -> V_151 ) )
V_117 -> V_152 = V_153
| V_154 ;
else
V_117 -> V_152 = V_155
...
V_96 -> V_192 [ 1 ] = ( V_35 ) F_28 ( V_4 -> V_63 -> V_73 . V_74 ) ;
break;
}
case V_100 :
V_92 = V_2 -> V_197 + V_4 -> V_69 ;
...
V_4 -> V_70 . V_71 . V_72 . V_104 = F_31 ( V_89 ) ;
return false ;
}
...
{
struct V_189 * V_190 = & V_86 -> V_191 ;
if ( F_28 ( V_4 -> V_70 . V_71 . V_72 . V_104 ) ==
V_90 ) {
V_190 -> V_69 = V_4 -> V_69 ;
V_190 -> V_99 = 0 ;
}
...
V_78 -> V_21 = F_28 ( V_4 -> V_70 . V_71 . V_72 . V_104 ) ;
}
static V_35 F_51 ( struct V_1 * V_2 , struct V_85 * V_78 )
{
struct V_40 V_45 ;
memset ( & V_45 , 0 , sizeof( V_45 ) ) ;
V_45 . V_2 = V_2 ;
...
V_251 -> V_259 . V_268 = F_40 ( V_2 -> V_26 -> V_138 ) ;
V_251 -> V_259 . V_269 = F_41 ( V_2 -> V_26 -> V_138 ) ;
V_253 = F_56 ( V_2 -> V_26 , V_270 ) ;
if ( V_253 ) {
T_3 V_271 ;
T_1 V_272 ;
F_57 ( V_2 -> V_26 ,
...
strcpy ( V_251 -> V_309 , F_58 ( V_2 ) ) ;
strcpy ( V_251 -> V_310 , F_37 ( V_2 ) ) ;
V_251 -> V_311 = V_312 ;
V_251 -> V_313 = 1 ;
...
if ( V_212 -> V_69 >= V_312 || ! F_35 ( V_75 ) ) {
V_209 -> V_21 = V_343 ;
break;
}
F_23 ( V_8 , V_2 , V_4 , NULL ) ;
V_8 -> V_50 = V_209 -> V_355 ;
V_8 -> V_12 += F_60 ( struct V_208 , V_97 . V_367 )
+ sizeof( struct V_211 ) ;
V_4 -> V_69 = ( T_3 ) V_212 -> V_69 ;
V_4 -> V_63 -> V_73 . V_74 |= F_31 ( V_212 -> V_75 [ 1 ] ) ;
memcpy ( V_4 -> V_63 -> V_73 . V_368 , V_212 -> V_368 , 16 ) ;
V_4 -> V_63 -> V_73 . V_50 = F_31 ( V_209 -> V_355 ) ;
...
V_4 -> V_36 = F_53 ;
if ( V_212 -> V_74 & V_371 ) {
V_4 -> V_63 -> V_73 . V_74 |= F_31 ( V_372 ) ;
} else if ( V_212 -> V_74 & V_373 ) {
V_4 -> V_63 -> V_73 . V_74 |= F_31 ( V_374 ) ;
} else {
if ( V_8 -> V_50 ) {
V_209 -> V_21 = V_343 ;
break;
...
if ( F_33 ( V_396 , & V_2 -> V_74 ) )
V_390 -> V_397 = V_398 ;
else if ( F_33 ( V_399 , & V_2 -> V_74 ) )
V_390 -> V_397 = V_400 ;
else if ( F_33 ( V_401 , & V_2 -> V_74 ) )
V_390 -> V_397 = V_402 ;
else if ( F_33 ( V_403 , & V_2 -> V_74 ) )
V_390 -> V_397 = V_404 ;
else if ( F_33 ( V_81 , & V_2 -> V_74 ) )
V_390 -> V_397 = V_405 ;
else
V_390 -> V_397 = V_406 ;
break;
...
int F_66 ( void * V_421 , int V_422 , void T_4 * V_423 )
{
...
T_3 V_425 ;
int V_426 ;
F_20 ( V_427 , L_9 , V_421 , V_422 , V_423 ) ;
if ( ( V_423 == NULL )
|| ( V_422 < V_428 )
|| ( V_422 > V_429 ) )
return - V_430 ;
V_55 = F_67 ( V_423 , sizeof( struct V_424 ) ) ;
if ( F_68 ( V_55 ) ) {
F_20 ( V_431 ,
L_10
L_11 , V_422 ,
...
break;
case V_471 :
V_55 -> V_24 . V_435 = F_27 ( V_2 ,
& V_55 -> V_97 .
V_472 ) ;
break;
case V_473 :
V_55 -> V_24 . V_435 =
F_51 ( V_2 , & V_55 -> V_97 . V_72 ) ;
break;
case V_474 :
V_55 -> V_24 . V_435 = F_63 ( V_2 ,
& V_55 -> V_97 .
V_412 ) ;
break;
case V_475 :
...
V_426 = F_78 ( V_423 , V_55 , sizeof( struct V_424 ) ) ;
if ( V_426 != 0 ) {
F_20 ( V_431 ,
L_16
L_17 , V_426 ,
...
int F_79 ( struct V_489 * V_490 , int V_422 , void T_4 * V_423 )
{
return F_66 ( V_490 -> V_469 -> V_421 , V_422 , V_423 ) ;
}
...
static int F_81 ( struct V_1 * V_2 , T_1 V_50 )
{
F_80 ( V_2 ) ;
V_2 -> V_14 . V_16 = V_50 ;
...
int V_496 = F_83 ( int , V_493 , sizeof( V_2 -> V_14 . V_24 ) ) ;
F_84 () ;
...
int F_77 ( struct V_1 * V_2 , char * V_491 , long V_492 , int V_493 )
{
if ( ! V_2 -> V_509 )
return - V_457 ;
if ( V_492 == 0 ) {
...
int F_76 ( struct V_1 * V_2 , const char * V_491 , long V_492 ,
int V_493 )
{
if ( ! V_2 -> V_509 ) {
V_29 V_516 ;
...
static T_1 F_90 ( struct V_7 * V_8 , T_2 * V_9 )
{
struct V_1 * V_2 = (struct V_1 * ) V_8 -> V_10 ;
struct V_519 * V_520 =
...
T_1 V_50 = V_520 -> V_527 . V_50 + F_60 (
struct V_519 ,
V_97 ) ;
if ( V_520 -> V_527 . V_527 == V_528 )
V_50 = F_60 ( struct V_519 , V_97 ) ;
if ( V_493 < F_60 ( struct V_519 , V_97 ) )
return - V_485 ;
if ( V_2 -> V_521 ) {
if ( V_2 -> V_523 < V_50 ) {
F_12 ( & V_2 -> V_26 -> V_27 ,
