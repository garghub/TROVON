...
char V_43 [ V_13 + 1 ] ;
char * V_44 , * V_45 , * V_46 ;
while ( ( V_44 = strstr ( V_42 , L_18 ) ) &&
( V_45 = strchr ( V_44 + 2 , '}' ) ) ) {
* V_44 = * V_45 = 0 ;
V_46 = getenv ( V_44 + 2 ) ;
snprintf ( V_43 , sizeof V_43 , L_19 ,
V_42 , V_46 ? V_46 : L_20 , V_45 + 1 ) ;
strcpy ( V_42 , V_43 ) ;
}
return V_42 ;
}
...
L_21 ,
V_1 , V_28 , & V_7 , & V_8 , & V_9 , & V_45 ) ) {
fprintf ( V_15 , L_22 , line ) ;
goto V_16;
}
if ( V_45 && isgraph ( line [ V_45 ] ) ) {
int V_49 ;
int V_50 ;
V_47 = malloc ( strlen ( line ) ) ;
if ( ! V_47 ) {
fprintf ( V_15 , L_23 , V_48 ) ;
goto V_16;
}
V_48 = strlen ( V_1 ) + 1 ;
...
do {
V_50 = 0 ;
if ( sscanf ( line + V_45 , L_5 F_8 ( V_13 ) L_24 ,
V_1 , & V_50 ) < 1 )
break;
V_49 = strlen ( V_1 ) + 1 ;
