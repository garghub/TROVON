...
V_34 += strlen ( L_38 ) ;
V_34 = F_24 ( V_34 ) ;
if ( sscanf ( V_34 , L_39 , & V_114 ) == 0 ) {
F_13 ( V_8 , L_40 , 1 , 0 ) ;
return;
}
V_115 = F_83 ( V_114 , & V_116 ) ;
if ( ( V_115 == NULL ) || ( V_114 == 0 ) ) {
F_13 ( V_8 , L_41 , 1 , 0 ) ;
return;
}
F_74 ( V_8 , F_80 , V_115 ) ;
...
int V_70 ;
char V_41 [ V_118 ] ;
if ( F_85 ( L_42 , V_41 , sizeof( V_41 ) ) )
return - 1 ;
snprintf ( V_119 , sizeof( V_41 ) , L_43 , V_41 ) ;
V_117 = F_86 ( V_41 , sizeof( V_41 ) , 1 ) ;
if ( V_117 < 0 ) {
F_21 ( V_45 L_44 ) ;
return 1 ;
}
...
goto V_46;
F_87 ( & V_120 ) ;
V_70 = F_88 ( V_26 , V_117 , V_121 , F_10 ,
V_122 , L_42 , ( void * ) V_117 ) ;
if ( V_70 ) {
F_21 ( V_45 L_45 ) ;
goto V_46;
}
if ( V_123 != NULL ) {
V_123 = F_89 ( V_123 , V_48 ) ;
if ( V_123 != NULL )
F_90 ( V_123 , V_124 ,
V_119 ,
strlen ( V_119 ) + 1 ) ;
...
static T_5 F_92 ( struct V_41 * V_41 ,
const char T_6 * V_127 , V_105 V_128 , T_2 * V_50 )
{
char * V_40 ;
V_40 = F_93 ( V_127 , V_128 ) ;
if ( F_26 ( V_40 ) )
return F_27 ( V_40 ) ;
F_90 ( V_123 , V_129 , V_40 , V_128 ) ;
F_9 ( V_40 ) ;
return V_128 ;
}
...
if ( V_123 == NULL )
return 0 ;
V_131 = F_95 ( L_42 , 0200 , NULL , & V_132 ) ;
if ( V_131 == NULL ) {
F_21 ( V_125 L_49 ) ;
return 0 ;
}
...
static int F_98 ( char * V_67 )
{
if ( ! strncmp ( V_67 , V_134 , strlen ( V_134 ) ) ) {
V_67 += strlen ( V_134 ) ;
V_123 = V_67 ;
}
...
static int F_99 ( struct V_1 * V_135 , unsigned long V_136 ,
void * V_34 )
{
char * V_137 = V_34 ;
if ( V_123 == NULL )
return 0 ;
F_90 ( V_123 , V_138 , V_137 ,
strlen ( V_137 ) + 1 ) ;
return 0 ;
}
