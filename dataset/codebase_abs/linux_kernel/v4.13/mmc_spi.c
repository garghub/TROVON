...
V_12 = F_32 ( ( unsigned int ) ( V_12 / 1000 ) ) + 1 ;
...
static void F_43 ( struct V_117 * V_84 , struct V_50 * V_51 )
{
struct V_1 * V_2 = F_44 ( V_84 ) ;
int V_5 = - V_49 ;
int V_118 = 5 ;
struct V_20 V_119 ;
#ifdef F_45
...
static void F_54 ( struct V_117 * V_84 , struct V_133 * V_134 )
{
struct V_1 * V_2 = F_44 ( V_84 ) ;
...
static T_5
F_57 ( int V_144 , void * V_84 )
{
struct V_1 * V_2 = F_44 ( V_84 ) ;
T_4 V_145 = F_58 ( V_2 -> V_136 -> V_146 , ( T_4 ) 100 ) ;
F_59 ( V_84 , F_60 ( V_145 ) ) ;
return V_147 ;
}
static int F_61 ( struct V_82 * V_3 )
{
void * V_77 ;
struct V_117 * V_84 ;
struct V_1 * V_2 ;
...
V_5 = - V_153 ;
V_77 = F_62 ( V_154 , V_155 ) ;
if ( ! V_77 )
goto V_156;
memset ( V_77 , 0xff , V_154 ) ;
V_84 = F_63 ( sizeof( * V_2 ) , & V_3 -> V_48 ) ;
if ( ! V_84 )
goto V_156;
V_84 -> V_157 = & V_158 ;
V_84 -> V_159 = V_154 ;
...
F_65 ( & V_3 -> V_48 , V_84 ) ;
V_2 -> V_6 = F_62 ( sizeof( * V_2 -> V_6 ) , V_155 ) ;
if ( ! V_2 -> V_6 )
goto V_172;
if ( V_3 -> V_121 -> V_48 . V_173 -> V_174 ) {
struct V_94 * V_48 = V_3 -> V_121 -> V_48 . V_173 ;
V_2 -> V_8 = V_48 ;
V_2 -> V_78 = F_66 ( V_48 , V_77 ,
V_154 , V_72 ) ;
if ( F_35 ( V_48 , V_2 -> V_78 ) )
goto V_175;
V_2 -> V_9 = F_66 ( V_48 , V_2 -> V_6 ,
sizeof( * V_2 -> V_6 ) , V_67 ) ;
if ( F_35 ( V_48 , V_2 -> V_9 ) )
goto V_176;
F_7 ( V_2 -> V_8 ,
V_2 -> V_9 , sizeof( * V_2 -> V_6 ) ,
V_67 ) ;
...
V_5 = V_2 -> V_136 -> V_177 ( & V_3 -> V_48 , F_57 , V_84 ) ;
if ( V_5 != 0 )
goto V_178;
}
if ( V_2 -> V_136 ) {
...
V_178:
if ( V_2 -> V_8 )
F_74 ( V_2 -> V_8 , V_2 -> V_9 ,
sizeof( * V_2 -> V_6 ) , V_67 ) ;
V_176:
if ( V_2 -> V_8 )
F_74 ( V_2 -> V_8 , V_2 -> V_78 ,
V_154 , V_72 ) ;
V_175:
F_75 ( V_2 -> V_6 ) ;
V_172:
...
static int F_78 ( struct V_82 * V_3 )
{
struct V_117 * V_84 = F_79 ( & V_3 -> V_48 ) ;
struct V_1 * V_2 ;
if ( V_84 ) {
V_2 = F_44 ( V_84 ) ;
