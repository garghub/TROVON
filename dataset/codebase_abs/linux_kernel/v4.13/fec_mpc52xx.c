...
static V_13 F_74 ( struct V_1 * V_2 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
return V_4 -> V_188 ;
}
static void F_75 ( struct V_1 * V_2 , V_13 V_189 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_4 -> V_188 = V_189 ;
}
static int F_76 ( struct V_1 * V_2 , struct V_190 * V_191 , int V_192 )
{
struct V_41 * V_42 = V_2 -> V_42 ;
if ( ! V_42 )
return - V_193 ;
return F_77 ( V_42 , V_191 , V_192 ) ;
}
...
const V_13 * V_199 ;
int V_200 ;
struct V_201 * V_202 = V_195 -> V_2 . V_203 ;
const char * V_204 ;
T_4 V_205 ;
T_4 V_206 ;
V_58 = F_79 ( sizeof( struct V_3 ) ) ;
if ( ! V_58 )
return - V_207 ;
V_4 = F_2 ( V_58 ) ;
V_4 -> V_58 = V_58 ;
V_196 = F_80 ( V_202 , 0 , & V_198 ) ;
if ( V_196 ) {
F_81 ( L_19 ) ;
goto V_208;
}
if ( F_82 ( & V_198 ) < sizeof( struct V_10 ) ) {
F_81 ( L_20 ,
( unsigned long ) F_82 ( & V_198 ) ,
sizeof( struct V_10 ) ) ;
V_196 = - V_209 ;
goto V_208;
}
if ( ! F_83 ( V_198 . V_210 , sizeof( struct V_10 ) ,
V_63 ) ) {
V_196 = - V_56 ;
goto V_208;
}
...
V_58 -> V_213 = & V_214 ;
V_58 -> V_215 = V_216 ;
V_58 -> V_217 = V_198 . V_210 ;
F_84 ( V_58 , & V_195 -> V_2 ) ;
F_85 ( & V_4 -> V_6 ) ;
V_4 -> V_11 = F_86 ( V_198 . V_210 , sizeof( struct V_10 ) ) ;
if ( ! V_4 -> V_11 ) {
V_196 = - V_207 ;
goto V_218;
}
V_205 = V_58 -> V_217 + F_62 ( struct V_10 , V_219 ) ;
V_206 = V_58 -> V_217 + F_62 ( struct V_10 , V_220 ) ;
V_4 -> V_35 = F_87 ( V_221 , V_205 , V_37 ) ;
V_4 -> V_71 = F_88 ( V_222 , V_206 ) ;
if ( ! V_4 -> V_35 || ! V_4 -> V_71 ) {
F_81 ( L_21 ) ;
V_196 = - V_207 ;
goto V_223;
}
V_58 -> V_60 = F_89 ( V_202 , 0 ) ;
V_4 -> V_65 = F_90 ( V_4 -> V_35 ) ;
V_4 -> V_68 = F_90 ( V_4 -> V_71 ) ;
V_204 = F_91 ( V_202 ) ;
if ( V_204 ) {
memcpy ( V_58 -> V_20 , V_204 , V_224 ) ;
} else {
struct V_10 T_2 * V_11 = V_4 -> V_11 ;
...
V_4 -> V_188 = F_94 ( V_225 , V_226 ) ;
V_4 -> V_54 = 100 ;
V_4 -> V_46 = V_227 ;
V_4 -> V_167 = ( ( F_95 ( V_202 ) >> 20 ) / 5 ) << 1 ;
V_199 = F_96 ( V_202 , L_23 , & V_200 ) ;
if ( V_199 && ( V_200 >= sizeof( V_13 ) * 2 ) ) {
V_4 -> V_54 = V_199 [ 0 ] ;
V_4 -> V_46 = V_199 [ 1 ] ? V_53 : V_227 ;
}
V_4 -> V_57 = F_97 ( V_202 , L_24 , 0 ) ;
if ( F_98 ( V_202 , L_25 , NULL ) ) {
V_4 -> V_177 = 1 ;
F_99 ( & V_58 -> V_2 , L_26 ) ;
}
F_66 ( V_58 ) ;
...
F_101 ( V_195 , V_58 ) ;
F_102 ( V_58 , L_27 ,
V_195 -> V_2 . V_203 -> V_229 , V_58 -> V_20 ) ;
return 0 ;
V_228:
F_103 ( V_4 -> V_57 ) ;
F_104 ( V_58 -> V_60 ) ;
...
F_107 ( V_4 -> V_11 ) ;
V_218:
F_108 ( V_198 . V_210 , sizeof( struct V_10 ) ) ;
V_208:
F_109 ( V_58 ) ;
return V_196 ;
}
static int
F_110 ( struct V_194 * V_195 )
{
struct V_1 * V_58 ;
struct V_3 * V_4 ;
V_58 = F_111 ( V_195 ) ;
...
F_106 ( V_4 -> V_71 ) ;
F_107 ( V_4 -> V_11 ) ;
F_108 ( V_58 -> V_217 , sizeof( struct V_10 ) ) ;
F_109 ( V_58 ) ;
return 0 ;
}
static int F_113 ( struct V_194 * V_195 , T_5 V_230 )
{
struct V_1 * V_2 = F_111 ( V_195 ) ;
if ( F_114 ( V_2 ) )
F_40 ( V_2 ) ;
return 0 ;
}
static int F_115 ( struct V_194 * V_195 )
{
struct V_1 * V_2 = F_111 ( V_195 ) ;
F_66 ( V_2 ) ;
F_60 ( V_2 ) ;
...
F_116 ( void )
{
return F_117 ( V_231 , F_118 ( V_231 ) ) ;
}
static void T_7
F_119 ( void )
{
F_120 ( V_231 , F_118 ( V_231 ) ) ;
}
