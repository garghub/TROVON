...
static T_8 F_131 ( struct V_63 * V_65 , struct V_116 * V_117 , int V_36 )
{
struct V_66 * V_86 = F_132 ( V_65 , F_133 ( * V_86 ) , V_65 ) ;
struct V_2 * V_3 = F_91 ( V_86 ) ;
if ( V_117 == & V_118 . V_89 && ! V_3 -> V_91 )
return 0 ;
return V_117 -> V_119 ;
}
...
struct V_6 * V_120 )
{
struct V_6 * V_121 = V_3 -> V_8 ;
F_16 ( V_3 -> V_8 , V_120 ) ;
if ( V_121 ) {
F_16 ( V_121 -> V_23 , NULL ) ;
F_135 ( V_121 , V_122 ) ;
}
}
int F_136 ( struct V_2 * V_3 , int V_4 )
{
struct V_6 * V_121 = V_3 -> V_8 ;
struct V_6 * V_120 ;
int V_9 = V_121 ? V_121 -> V_9 : 0 ;
int V_22 , V_123 ;
T_5 V_124 ;
V_123 = V_4 + 1 ;
if ( V_123 < 0 )
return - V_125 ;
if ( F_112 ( V_3 ) && V_123 > F_112 ( V_3 ) )
return - V_125 ;
if ( V_123 <= V_9 )
return 0 ;
V_124 = sizeof( * V_120 ) + V_123 * sizeof( V_120 -> V_5 [ 0 ] ) ;
V_120 = F_137 ( V_124 , V_42 , V_3 -> V_126 ) ;
if ( ! V_120 )
return - V_43 ;
V_120 -> V_9 = V_123 ;
for ( V_22 = 0 ; V_22 < V_9 ; V_22 ++ )
F_16 ( V_120 -> V_5 [ V_22 ] , V_121 -> V_5 [ V_22 ] ) ;
F_134 ( V_3 , V_120 ) ;
return 0 ;
}
static void F_138 ( struct V_66 * V_86 )
{
struct V_2 * V_3 = F_91 ( V_86 ) ;
F_40 ( V_86 -> V_49 ) ;
F_139 ( V_3 ) ;
...
static char * F_142 ( struct V_66 * V_86 , T_8 * V_119 ,
T_9 * V_128 , T_10 * V_129 )
{
struct V_2 * V_3 = F_91 ( V_86 ) ;
if ( V_3 -> V_130 )
return V_3 -> V_130 ( V_3 , V_119 ) ;
return NULL ;
}
static int F_143 ( struct V_27 * V_28 , void * V_108 )
{
struct V_2 * V_131 = V_108 ;
struct V_10 V_11 ;
struct V_1 * V_132 ;
char V_58 [ V_98 ] ;
int V_133 ;
F_9 ( & V_11 , V_131 , V_16 ) ;
while ( ( V_132 = F_10 ( & V_11 ) ) ) {
V_133 = F_144 () ;
F_145 ( V_133 , V_132 ) ;
F_146 () ;
F_20 ( V_28 , L_25
L_26 ,
F_41 ( F_81 ( V_132 ) ) , F_43 ( F_81 ( V_132 ) ) ,
V_72 ( V_131 , V_132 -> V_4 , V_58 ) ,
F_147 ( V_132 , V_134 [ V_135 ] ) ,
F_147 ( V_132 , V_136 [ V_135 ] ) ,
F_147 ( V_132 , V_137 [ V_135 ] ) ,
F_148 ( F_147 ( V_132 , V_138 [ V_135 ] ) ) ,
F_147 ( V_132 , V_134 [ V_139 ] ) ,
F_147 ( V_132 , V_136 [ V_139 ] ) ,
F_147 ( V_132 , V_137 [ V_139 ] ) ,
F_148 ( F_147 ( V_132 , V_138 [ V_139 ] ) ) ,
F_149 ( V_132 ) ,
F_148 ( F_147 ( V_132 , V_140 ) ) ,
F_148 ( F_147 ( V_132 , V_141 ) )
) ;
}
F_13 ( & V_11 ) ;
return 0 ;
}
static int F_150 ( struct V_111 * V_111 , struct V_112 * V_112 )
{
return F_114 ( V_112 , & V_142 ) ;
}
static int T_6 F_151 ( void )
{
F_152 ( L_27 , 0 , NULL , & V_143 ) ;
F_152 ( L_28 , 0 , NULL , & V_144 ) ;
return 0 ;
}
T_3 F_153 ( const char * V_35 , int V_4 )
{
T_3 V_49 = F_34 ( 0 , 0 ) ;
struct V_93 V_94 ;
struct V_66 * V_86 ;
...
struct V_2 * F_154 ( int V_50 )
{
return F_155 ( V_50 , V_145 ) ;
}
struct V_2 * F_155 ( int V_50 , int V_126 )
{
struct V_2 * V_3 ;
V_3 = F_137 ( sizeof( struct V_2 ) , V_42 , V_126 ) ;
if ( V_3 ) {
if ( ! F_156 ( & V_3 -> V_24 ) ) {
F_27 ( V_3 ) ;
return NULL ;
...
if ( ! V_3 -> V_150 )
return NULL ;
V_149 = V_3 -> V_150 -> V_149 ;
if ( V_149 && ! F_162 ( V_149 ) )
return NULL ;
V_65 = F_163 ( & F_48 ( V_3 ) -> V_65 ) ;
if ( V_65 == NULL ) {
F_164 ( V_149 ) ;
return NULL ;
}
...
static void F_166 ( struct V_2 * V_151 , int V_152 )
{
char V_153 [] = L_29 ;
char * V_154 [] = { V_153 , NULL } ;
if ( ! V_152 )
V_153 [ 8 ] = '0' ;
F_167 ( & F_48 ( V_151 ) -> V_65 , V_155 , V_154 ) ;
}
void F_168 ( struct V_69 * V_70 , int V_156 )
{
V_70 -> V_157 -> V_158 = V_156 ;
}
void F_169 ( struct V_2 * V_3 , int V_156 )
{
struct V_10 V_11 ;
struct V_1 * V_5 ;
if ( V_3 -> V_24 . V_158 != V_156 ) {
F_166 ( V_3 , V_156 ) ;
V_3 -> V_24 . V_158 = V_156 ;
}
F_9 ( & V_11 , V_3 , V_19 ) ;
while ( ( V_5 = F_10 ( & V_11 ) ) )
V_5 -> V_158 = V_156 ;
...
int F_170 ( struct V_69 * V_70 )
{
if ( ! V_70 )
return 0 ;
return V_70 -> V_157 -> V_158 ;
}
...
if ( V_70 ) {
F_171 ( V_70 ) ;
V_159 = F_172 ( V_70 , true ) ;
F_173 ( V_70 ) ;
}
return V_159 ;
}
static unsigned long F_174 ( struct V_2 * V_3 )
{
struct V_160 * V_161 = V_3 -> V_161 ;
long V_162 = 0 ;
if ( V_161 -> V_163 >= 0 )
V_162 = V_161 -> V_163 ;
else if ( V_3 -> V_164 & ~ V_3 -> V_165 )
V_162 = V_166 ;
return F_175 ( V_162 ) ;
}
...
return;
F_19 ( & V_161 -> V_168 ) ;
F_177 ( & V_161 -> V_169 , V_12 ) ;
V_167 = ! V_161 -> V_170 ++ ;
F_178 ( & V_161 -> V_169 , V_12 ) ;
if ( V_167 )
F_179 ( & V_3 -> V_161 -> V_171 ) ;
F_21 ( & V_161 -> V_168 ) ;
}
static void F_180 ( struct V_2 * V_3 , bool V_172 )
{
struct V_160 * V_161 = V_3 -> V_161 ;
unsigned long V_173 ;
unsigned long V_12 ;
F_177 ( & V_161 -> V_169 , V_12 ) ;
if ( F_72 ( V_161 -> V_170 <= 0 ) )
goto V_174;
if ( -- V_161 -> V_170 )
goto V_174;
V_173 = F_174 ( V_3 ) ;
...
void F_183 ( struct V_2 * V_3 , unsigned int V_176 )
{
struct V_160 * V_161 = V_3 -> V_161 ;
if ( ! V_161 )
return;
...
unsigned int F_187 ( struct V_2 * V_3 , unsigned int V_176 )
{
const struct V_178 * V_179 = V_3 -> V_150 ;
struct V_160 * V_161 = V_3 -> V_161 ;
unsigned int V_180 ;
unsigned int V_177 = V_176 ;
if ( ! V_161 ) {
if ( ( V_176 & V_181 ) &&
V_179 -> V_182 && V_179 -> V_182 ( V_3 ) )
return V_181 ;
return 0 ;
}
F_176 ( V_3 ) ;
...
F_186 ( & V_161 -> V_169 ) ;
F_188 ( V_161 , & V_177 ) ;
F_180 ( V_3 , V_161 -> V_177 ? true : false ) ;
F_184 ( & V_161 -> V_169 ) ;
V_180 = V_161 -> V_180 & V_176 ;
V_161 -> V_180 &= ~ V_176 ;
F_186 ( & V_161 -> V_169 ) ;
F_72 ( V_177 & V_176 ) ;
return V_180 ;
}
static void F_189 ( struct V_183 * V_184 )
{
struct V_185 * V_171 = F_190 ( V_184 ) ;
struct V_160 * V_161 = F_132 ( V_171 , struct V_160 , V_171 ) ;
F_188 ( V_161 , & V_161 -> V_177 ) ;
}
static void F_188 ( struct V_160 * V_161 ,
unsigned int * V_186 )
{
struct V_2 * V_3 = V_161 -> V_3 ;
char * V_154 [ F_23 ( V_187 ) + 1 ] = { } ;
unsigned int V_177 = * V_186 ;
unsigned int V_164 ;
unsigned long V_173 ;
int V_188 = 0 , V_22 ;
V_164 = V_3 -> V_150 -> V_189 ( V_3 , V_177 ) ;
F_184 ( & V_161 -> V_169 ) ;
V_164 &= ~ V_161 -> V_180 ;
V_161 -> V_180 |= V_164 ;
* V_186 &= ~ V_177 ;
V_173 = F_174 ( V_3 ) ;
if ( ! V_161 -> V_170 && V_173 )
F_181 ( V_175 ,
& V_161 -> V_171 , V_173 ) ;
F_186 ( & V_161 -> V_169 ) ;
for ( V_22 = 0 ; V_22 < F_23 ( V_187 ) ; V_22 ++ )
if ( V_164 & V_3 -> V_164 & ( 1 << V_22 ) )
V_154 [ V_188 ++ ] = V_187 [ V_22 ] ;
if ( V_188 )
F_167 ( & F_48 ( V_3 ) -> V_65 , V_155 , V_154 ) ;
}
static T_4 F_191 ( unsigned int V_164 , char * V_58 )
{
const char * V_190 = L_13 ;
T_4 V_105 = 0 ;
int V_22 ;
for ( V_22 = 0 ; V_22 < F_23 ( V_191 ) ; V_22 ++ )
if ( V_164 & ( 1 << V_22 ) ) {
...
{
struct V_2 * V_3 = F_91 ( V_86 ) ;
return F_191 ( V_3 -> V_164 , V_58 ) ;
}
static T_4 F_193 ( struct V_66 * V_86 ,
struct V_88 * V_89 , char * V_58 )
{
struct V_2 * V_3 = F_91 ( V_86 ) ;
return F_191 ( V_3 -> V_165 , V_58 ) ;
}
static T_4 F_194 ( struct V_66 * V_86 ,
struct V_88 * V_89 ,
char * V_58 )
{
struct V_2 * V_3 = F_91 ( V_86 ) ;
return sprintf ( V_58 , L_32 , V_3 -> V_161 -> V_163 ) ;
}
static T_4 F_195 ( struct V_66 * V_86 ,
struct V_88 * V_89 ,
const char * V_58 , T_5 V_192 )
{
struct V_2 * V_3 = F_91 ( V_86 ) ;
long V_173 ;
if ( ! V_192 || ! sscanf ( V_58 , L_33 , & V_173 ) )
return - V_125 ;
if ( V_173 < 0 && V_173 != - 1 )
return - V_125 ;
F_176 ( V_3 ) ;
V_3 -> V_161 -> V_163 = V_173 ;
F_180 ( V_3 , true ) ;
return V_192 ;
}
static int F_196 ( const char * V_193 ,
const struct V_194 * V_195 )
{
struct V_160 * V_161 ;
int V_39 ;
V_39 = F_197 ( V_193 , V_195 ) ;
if ( V_39 < 0 )
return V_39 ;
F_19 ( & V_196 ) ;
F_198 (ev, &disk_events, node)
F_183 ( V_161 -> V_3 , 0 ) ;
F_21 ( & V_196 ) ;
return 0 ;
}
...
if ( ! V_3 -> V_161 )
return;
if ( F_205 ( & F_48 ( V_3 ) -> V_65 , V_198 ) < 0 )
F_200 ( L_35 ,
V_3 -> V_72 ) ;
F_19 ( & V_196 ) ;
F_206 ( & V_3 -> V_161 -> V_197 , & V_160 ) ;
F_21 ( & V_196 ) ;
F_180 ( V_3 , true ) ;
}
...
F_176 ( V_3 ) ;
F_19 ( & V_196 ) ;
F_207 ( & V_3 -> V_161 -> V_197 ) ;
F_21 ( & V_196 ) ;
F_208 ( & F_48 ( V_3 ) -> V_65 , V_198 ) ;
}
static void F_139 ( struct V_2 * V_3 )
{
F_72 ( V_3 -> V_161 && V_3 -> V_161 -> V_170 != 1 ) ;
F_27 ( V_3 -> V_161 ) ;
}
