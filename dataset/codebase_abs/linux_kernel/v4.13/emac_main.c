...
F_5 ( V_2 , V_96 , ~ 0 ) ;
F_5 ( V_2 , V_97 , ~ 0 ) ;
} else if ( V_7 -> V_105 & V_109 ) {
struct V_110 * V_111 ;
unsigned int V_112 [ 2 ] = { 0 , 0 } ;
int V_113 ;
F_49 (ha, ndev) {
V_113 = F_50 ( V_114 , V_111 -> V_51 ) >> 26 ;
V_112 [ V_113 >> 5 ] |= 1 << ( V_113 & 31 ) ;
}
F_5 ( V_2 , V_96 , V_112 [ 0 ] ) ;
F_5 ( V_2 , V_97 , V_112 [ 1 ] ) ;
} else {
F_5 ( V_2 , V_96 , 0 ) ;
F_5 ( V_2 , V_97 , 0 ) ;
}
...
static struct V_26 * F_57 ( struct V_6 * V_7 )
{
struct V_1 * V_2 = F_3 ( V_7 ) ;
struct V_26 * V_27 = & V_7 -> V_27 ;
...
static int F_58 ( struct V_33 * V_34 , struct V_6 * V_7 )
{
struct V_1 * V_2 = F_3 ( V_7 ) ;
...
if ( F_59 ( V_34 , V_122 ) )
return V_123 ;
V_49 = F_60 (unsigned int, ETH_ZLEN, skb->len) ;
if ( F_11 ( ! F_1 ( V_2 ) ) ) {
F_55 ( V_7 ) ;
F_22 ( V_7 , L_3 ) ;
return V_124 ;
...
V_126 = F_10 ( * ( T_4 * ) & V_7 -> V_128 [ 0 ] ) ;
V_127 = F_64 ( * ( V_129 * ) & V_7 -> V_128 [ 4 ] ) ;
F_5 ( V_2 , V_130 , V_126 ) ;
F_5 ( V_2 , V_131 , V_127 ) ;
}
static int F_65 ( struct V_6 * V_7 , void * V_132 )
{
struct V_133 * V_51 = V_132 ;
if ( F_66 ( V_7 ) )
return - V_134 ;
if ( ! F_67 ( V_51 -> V_135 ) )
return - V_136 ;
memcpy ( V_7 -> V_128 , V_51 -> V_135 , V_7 -> V_137 ) ;
F_63 ( V_7 ) ;
return 0 ;
}
int F_68 ( struct V_6 * V_7 , int V_138 )
{
struct V_139 * V_50 = V_7 -> V_50 . V_140 ;
struct V_141 V_142 ;
struct V_143 * V_144 ;
struct V_8 * V_10 = NULL ;
struct V_1 * V_2 ;
const char * V_145 ;
unsigned int V_146 , V_147 , V_75 ;
int V_148 ;
V_144 = F_69 ( V_50 -> V_149 , L_4 , 0 ) ;
if ( ! V_144 ) {
F_70 ( V_50 , L_5 ) ;
return - V_150 ;
}
V_148 = F_71 ( V_50 -> V_149 , 0 , & V_142 ) ;
if ( V_148 ) {
F_70 ( V_50 , L_6 ) ;
V_148 = - V_150 ;
goto V_151;
}
V_75 = F_72 ( V_50 -> V_149 , 0 ) ;
if ( ! V_75 ) {
F_70 ( V_50 , L_7 ) ;
V_148 = - V_150 ;
goto V_151;
...
V_2 = F_3 ( V_7 ) ;
V_2 -> V_50 = V_50 ;
V_2 -> V_158 = F_73 ( V_50 , & V_142 ) ;
if ( F_74 ( V_2 -> V_158 ) ) {
V_148 = F_75 ( V_2 -> V_158 ) ;
goto V_151;
}
F_76 ( V_50 , L_8 , V_2 -> V_158 ) ;
if ( V_2 -> V_159 ) {
V_148 = F_77 ( V_2 -> V_159 ) ;
if ( V_148 ) {
F_70 ( V_50 , L_9 ) ;
goto V_151;
}
V_147 = F_78 ( V_2 -> V_159 ) ;
} else {
if ( F_79 ( V_50 -> V_149 , L_10 ,
& V_147 ) ) {
F_70 ( V_50 , L_11 ) ;
V_148 = - V_160 ;
goto V_151;
...
F_70 ( V_50 , L_12 , V_146 ) ;
V_148 = - V_150 ;
goto V_162;
}
F_80 ( V_50 , L_13 , V_146 ) ;
F_5 ( V_2 , V_163 , V_147 / 1000000 ) ;
V_7 -> V_75 = V_75 ;
F_80 ( V_50 , L_14 , V_7 -> V_75 ) ;
V_148 = F_81 ( V_50 , V_7 -> V_75 , F_37 , 0 ,
V_7 -> V_164 , V_7 ) ;
if ( V_148 ) {
F_70 ( V_50 , L_15 ) ;
goto V_162;
}
V_145 = F_82 ( V_50 -> V_149 ) ;
if ( V_145 )
memcpy ( V_7 -> V_128 , V_145 , V_114 ) ;
else
F_83 ( V_7 ) ;
F_63 ( V_7 ) ;
F_80 ( V_50 , L_16 , V_7 -> V_128 ) ;
V_2 -> V_57 = F_84 ( V_50 , V_165 + V_95 ,
& V_2 -> V_99 , V_166 ) ;
if ( ! V_2 -> V_57 ) {
F_70 ( V_50 , L_17 ) ;
V_148 = - V_94 ;
