...
T_5 V_34 ;
F_33 ( V_12 , L_14 , V_50 -> V_64 . V_65 ) ;
F_33 ( V_12 , L_15
L_16
, L_17 , L_18 , L_19 , L_20 , L_21 , L_22
) ;
for ( V_34 = 0 ; V_34 < 32 ; V_34 ++ ) {
if ( V_50 -> V_66 [ V_34 ] . V_67 != 0 )
F_33 ( V_12 , L_23 V_68 L_24 V_69 L_25
L_16 , V_34
, V_50 -> V_66 [ V_34 ] . V_67
, F_44 ( V_50 -> V_66 [ V_34 ] . V_70 )
, F_45 ( V_50 -> V_66 [ V_34 ] . V_71 )
, ( V_50 -> V_66 [ V_34 ] . V_67 ) & 0x03
, F_46 ( ( ( V_50 -> V_66 [ V_34 ] . V_67 ) >> 2 ) & 0x07 )
) ;
}
return 0 ;
}
...
{
T_1 V_26 = ( T_1 ) F_14 ( V_25 ) ;
const struct V_27 * V_28 = V_72 + V_26 ;
...
T_1 (* F_18)( struct V_14 * , const char T_2 * , T_3 , T_4 * , void * ) = V_28 -> F_18 ;
if ( F_18 )
return F_18 ( V_14 , V_15 , V_16 , V_17 , ( (struct V_11 * ) V_14 -> V_73 ) -> V_43 ) ;
return - V_31 ;
}
...
return - V_24 ;
if ( V_15 && ! F_11 ( V_18 , V_15 , sizeof( V_18 ) ) ) {
int V_61 = sscanf ( V_18 , L_26 , & V_74 ) ;
if ( V_61 != 1 )
return V_16 ;
F_53 ( V_44 , V_74 ) ;
}
...
return - V_24 ;
if ( V_15 && ! F_11 ( V_18 , V_15 , sizeof( V_18 ) ) ) {
int V_61 = sscanf ( V_18 , L_27 , & V_75 ) ;
if ( V_61 != 1 )
return V_16 ;
F_57 ( V_44 , V_75 ) ;
}
...
return - V_24 ;
if ( V_15 && ! F_11 ( V_18 , V_15 , sizeof( V_18 ) ) ) {
int V_61 = sscanf ( V_18 , L_28 , & V_76 ) ;
if ( V_61 != 1 )
return V_16 ;
F_61 ( V_44 , V_76 ) ;
}
...
& V_77 , & V_78 , & V_79 , & V_80 , & V_81 , & V_82 ) ;
if ( V_61 != 6 )
return V_16 ;
F_65 ( V_45 , ( T_8 ) V_77 , V_78 , ( T_8 ) V_79 , ( bool ) V_80 , V_81 , V_82 ) ;
}
return V_16 ;
}
...
{
T_1 V_26 = ( T_1 ) F_14 ( V_25 ) ;
const struct V_27 * V_28 = V_83 + V_26 ;
return F_15 ( V_14 , V_28 -> V_30 , F_48 ( V_25 ) ) ;
}
...
V_84 = F_1 ( L_30 , V_44 -> V_85 , V_42 ) ;
if ( V_84 == NULL ) {
F_20 ( 1 ) ;
goto exit;
}
V_44 -> V_84 = V_84 ;
for ( V_34 = 0 ; V_34 < V_86 ; V_34 ++ ) {
V_5 = F_3 ( V_83 [ V_34 ] . V_2 , V_84 , & V_87 , ( void * ) V_34 ) ;
if ( ! V_5 ) {
F_20 ( 1 ) ;
goto exit;
}
...
for ( V_34 = 0 ; V_34 < V_86 ; V_34 ++ )
F_22 ( V_83 [ V_34 ] . V_2 , V_84 ) ;
F_22 ( L_30 , V_44 -> V_85 ) ;
V_44 -> V_84 = NULL ;
}
struct V_1 * F_70 ( struct V_41 * V_42 )
{
struct V_1 * V_88 = V_35 ;
...
V_5 = F_3 ( V_72 [ V_34 ] . V_2 , V_85 , & V_90 , ( void * ) V_34 ) ;
if ( ! V_5 ) {
F_20 ( 1 ) ;
goto exit;
}
