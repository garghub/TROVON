...
if ( V_26 == V_7 -> V_12 ) {
F_4 ( V_2 ) ;
if ( F_15 ( V_2 , V_4 , V_39 ) == 0 &&
F_16 ( V_2 , V_4 ) == 0 ) {
V_7 -> V_12 = ( V_7 -> V_12 + 1 ) % V_40 ;
V_31 = 1 ;
} else {
F_6 ( V_2 , V_32 ) ;
V_7 -> V_9 = 0x00 ;
...
if ( ( ( V_7 -> V_13 + V_44 ) % V_40 ) == V_7 -> V_12 ) {
V_7 -> V_9 &= ~ V_45 ;
F_3 ( V_2 ) ;
F_18 ( V_2 ) ;
} else {
...
static int F_22 ( struct V_1 * V_2 , struct V_3 * V_4 , int V_5 )
{
if ( V_5 == V_20 ) {
F_6 ( V_2 , V_21 ) ;
F_7 ( V_2 , 0 , V_4 -> V_23 [ 3 ] , V_4 -> V_23 [ 4 ] ) ;
...
if ( V_7 -> V_14 == V_47 )
return 0 ;
V_5 = F_24 ( V_4 , & V_26 , & V_27 , & V_28 , & V_29 , & V_30 ) ;
switch ( V_7 -> V_14 ) {
case V_48 :
