...
if ( V_92 -> V_94 & V_113 ) {
unsigned int V_114 = F_49 ( V_8 -> V_86 ) ;
if ( ! V_114 )
F_10 ( V_5 , L_26 ) ;
else
F_10 ( V_5 , L_27 , V_114 ) ;
...
V_112 = F_47 ( V_110 , V_116 ) ;
V_111 = ( unsigned long ) V_110 ;
F_10 ( V_5 , L_28 , V_111 , V_112 ) ;
} else
F_10 ( V_5 , L_29 , V_3 -> V_100 ) ;
return ! F_38 ( V_5 ) ;
}
...
static int F_52 ( unsigned long V_120 )
{
int V_121 = V_120 ? F_53 ( V_120 ) + 1 : 0 ;
return V_121 < sizeof( V_122 ) - 1 ? V_122 [ V_121 ] : '?' ;
}
struct V_42 * F_54 ( int type )
{
struct V_42 * V_44 ;
unsigned V_123 ;
V_123 = type & ( V_124 - 1 ) ;
F_55 (event, &event_hash[key], node) {
if ( V_44 -> type == type )
return V_44 ;
}
return NULL ;
...
if ( F_63 ( F_54 ( V_44 -> type ) ) )
goto V_67;
F_65 ( & V_44 -> V_126 , V_126 ) ;
} else if ( V_44 -> type > V_129 ) {
F_66 ( V_135 L_31 ) ;
F_63 ( 1 ) ;
goto V_67;
} else {
...
if ( V_44 -> V_133 -> V_136 == NULL )
V_44 -> V_133 -> V_136 = V_137 ;
if ( V_44 -> V_133 -> V_138 == NULL )
V_44 -> V_133 -> V_138 = V_137 ;
if ( V_44 -> V_133 -> V_139 == NULL )
V_44 -> V_133 -> V_139 = V_137 ;
if ( V_44 -> V_133 -> V_140 == NULL )
V_44 -> V_133 -> V_140 = V_137 ;
V_123 = V_44 -> type & ( V_124 - 1 ) ;
F_67 ( & V_44 -> V_141 , & V_142 [ V_123 ] ) ;
V_23 = V_44 -> type ;
V_67:
F_68 ( & V_132 ) ;
return V_23 ;
}
int F_69 ( struct V_42 * V_44 )
{
F_70 ( & V_44 -> V_141 ) ;
F_71 ( & V_44 -> V_126 ) ;
return 0 ;
}
int F_72 ( struct V_42 * V_44 )
{
F_62 ( & V_132 ) ;
F_69 ( V_44 ) ;
F_68 ( & V_132 ) ;
...
struct V_42 * V_44 )
{
F_10 ( & V_3 -> V_6 , L_32 , V_3 -> V_9 -> type ) ;
return F_4 ( & V_3 -> V_6 ) ;
}
...
int V_147 , V_148 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
V_148 = F_52 ( V_11 -> V_149 ) ;
V_147 = F_52 ( V_11 -> V_150 ) ;
F_42 ( V_11 -> V_151 , V_84 ) ;
F_10 ( & V_3 -> V_6 ,
L_35 ,
V_11 -> V_152 ,
V_11 -> V_153 ,
...
struct V_42 * V_44 )
{
return F_79 ( V_3 , L_36 ) ;
}
static enum V_1 F_81 ( struct V_2 * V_3 ,
int V_19 , struct V_42 * V_44 )
{
return F_79 ( V_3 , L_37 ) ;
}
static int F_82 ( struct V_2 * V_3 , char V_147 )
{
struct V_146 * V_11 ;
int V_148 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
...
static int F_85 ( struct V_2 * V_3 , char V_147 )
{
struct V_146 * V_11 ;
struct V_4 * V_5 = & V_3 -> V_6 ;
int V_148 ;
...
F_3 ( V_5 , L_39 ) ;
for ( V_17 = V_11 -> V_158 ; V_17 && * V_17 != V_159 && V_17 < V_157 ; V_17 ++ ) {
if ( F_38 ( V_5 ) )
break;
F_3 ( V_5 , L_40 ) ;
F_39 ( V_5 , * V_17 , V_19 ) ;
...
static enum V_1 F_90 ( struct V_2 * V_3 ,
int V_19 , struct V_42 * V_44 )
{
struct V_91 * V_92 = V_3 -> V_92 ;
struct V_160 * V_11 ;
...
struct V_162 * V_163 ;
F_91 () ;
V_163 = F_92 ( V_11 -> V_114 ) ;
if ( V_163 )
V_53 = F_93 ( V_163 ) ;
F_94 () ;
}
for ( V_24 = 0 ; V_24 < V_164 ; V_24 ++ ) {
unsigned long V_54 = V_11 -> V_158 [ V_24 ] ;
if ( V_54 == V_159 || F_38 ( V_5 ) )
break;
F_3 ( V_5 , L_40 ) ;
if ( ! V_54 ) {
F_3 ( V_5 , L_42 ) ;
...
static enum V_1 F_103 ( struct V_2 * V_3 ,
int V_19 , struct V_42 * V_44 )
{
struct V_16 * V_11 ;
struct V_4 * V_5 = & V_3 -> V_6 ;
...
struct V_16 * V_11 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
F_10 ( & V_3 -> V_6 , L_50 , V_11 -> V_54 , V_11 -> V_15 ) ;
return F_4 ( & V_3 -> V_6 ) ;
}
static enum V_1 F_105 ( struct V_2 * V_3 , int V_19 ,
struct V_42 * V_44 )
{
struct V_175 * V_11 ;
int V_24 ;
F_2 ( V_11 , V_3 -> V_9 ) ;
F_10 ( & V_3 -> V_6 , L_51 , V_11 -> V_176 ) ;
for ( V_24 = 0 ; V_24 < V_3 -> V_117 - F_106 ( struct V_175 , V_15 ) ; V_24 ++ )
F_10 ( & V_3 -> V_6 , L_52 ,
( unsigned char ) V_11 -> V_15 [ V_24 ] ) ;
F_11 ( & V_3 -> V_6 , '\n' ) ;
return F_4 ( & V_3 -> V_6 ) ;
}
T_3 static int F_107 ( void )
{
struct V_42 * V_44 ;
int V_24 , V_23 ;
for ( V_24 = 0 ; V_177 [ V_24 ] ; V_24 ++ ) {
V_44 = V_177 [ V_24 ] ;
V_23 = F_61 ( V_44 ) ;
if ( ! V_23 ) {
F_66 ( V_135 L_53 ,
