...
unsigned int V_42 [] , struct V_43 * V_44 [] )
{
...
void F_40 ( struct V_1 * V_2 , unsigned long V_78 )
{
enum V_79 V_34 ;
F_41 ( & V_2 -> V_80 ) ;
if ( V_2 -> V_11 . V_23 ) {
V_34 = V_2 -> V_8 ;
if ( V_34 != V_9 ) {
if ( ( V_78 & 0x100000 ) != 0x000000 )
goto V_81;
} else {
if ( ( V_78 & 0x100000 ) != 0x100000 )
goto V_81;
}
F_42 ( V_2 , & V_2 -> V_11 , V_82 ) ;
}
F_43 ( V_2 , & V_2 -> V_11 ) ;
V_81:
F_44 ( & V_2 -> V_80 ) ;
