...
struct V_46 * V_33 ;
struct V_161 * V_162 ;
V_162 = F_69 ( V_35 -> V_136 . V_163 , F_70 ( * V_162 ) , V_135 ) ;
F_64 ( & V_162 -> V_135 ) ;
V_33 = F_71 ( V_162 , F_70 ( * V_33 ) , V_134 ) ;
F_72 ( & V_33 -> V_164 ) ;
F_73 ( F_22 ( V_33 ) , L_33 ) ;
F_25 ( & V_35 -> V_81 ) ;
if ( F_74 ( V_138 , & V_33 -> V_51 ) )
V_74 -> V_84 -> V_119 ( V_33 , V_162 -> V_137 . V_55 ) ;
...
V_125 = true ;
F_23 ( V_101 -> V_166 ) ;
F_78 ( & V_101 -> V_167 , & V_165 ) ;
F_25 ( V_101 -> V_166 ) ;
F_5 ( L_34 ,
V_102 , F_79 ( & V_101 -> V_168 ) , V_101 -> V_169 ) ;
F_55 ( V_50 , & V_35 -> V_51 ) ;
F_62 ( V_101 , & V_165 ) ;
F_76 ( V_50 , & V_35 -> V_51 ) ;
if ( F_68 ( & V_165 ) )
goto V_160;
F_80 ( V_101 , & V_165 , & V_35 -> V_88 ) ;
if ( ! F_81 ( & V_165 , & V_35 -> V_88 ) )
F_82 ( V_101 , & V_165 , & V_35 -> V_88 ) ;
V_160:
F_67 ( V_101 ) ;
F_83 ( V_101 ) ;
F_84 ( & V_35 -> V_88 ) ;
...
goto V_125;
F_5 ( L_35 ,
V_102 , F_79 ( & V_101 -> V_168 ) ,
V_101 -> V_169 , V_131 ) ;
}
int F_85 ( struct V_171 * V_172 , int V_53 , void T_3 * V_173 )
{
struct V_46 * V_33 = F_86 ( V_172 ) ;
if ( F_22 ( V_33 ) )
return F_87 ( V_33 -> V_79 . V_80 , V_172 , V_53 , V_173 ) ;
return - V_174 ;
}
struct V_46 * F_88 ( struct V_175 * V_139 )
{
struct V_71 * V_101 = F_89 ( V_139 -> V_33 . V_176 ) ;
struct V_47 * V_35 = F_27 ( V_101 ) ;
struct V_46 * V_177 = NULL ;
int V_74 ;
unsigned long V_48 ;
F_10 ( & V_35 -> V_123 , V_48 ) ;
for ( V_74 = 0 ; V_74 < V_35 -> V_178 ; V_74 ++ ) {
struct V_97 * V_34 = V_35 -> V_179 [ V_74 ] ;
struct V_46 * V_33 ;
F_90 ( & V_34 -> V_180 ) ;
...
int F_93 ( struct V_182 * V_183 )
{
struct V_175 * V_139 = F_94 ( V_183 -> V_33 . V_176 ) ;
struct V_46 * V_177 = F_88 ( V_139 ) ;
if ( ! V_177 )
return - V_144 ;
F_72 ( & V_177 -> V_164 ) ;
V_183 -> V_184 = V_177 ;
...
int F_95 ( struct V_171 * V_185 )
{
struct V_46 * V_33 = F_86 ( V_185 ) ;
struct V_47 * V_87 ;
F_41 ( V_33 -> V_139 -> V_186 . V_187 != V_188 ) ;
if ( F_22 ( V_33 ) ) {
F_96 ( V_185 , V_33 -> V_79 . V_80 ) ;
return 0 ;
}
V_87 = V_33 -> V_34 -> V_35 ;
F_97 ( V_185 ) ;
...
int F_99 ( struct V_171 * V_172 , int V_192 )
{
struct V_46 * V_33 = F_86 ( V_172 ) ;
if ( F_22 ( V_33 ) )
return F_100 ( V_33 -> V_79 . V_80 , V_172 , V_192 ) ;
if ( ! V_172 -> V_189 )
V_192 = 1 ;
return F_98 ( V_172 , V_192 ) ;
}
int F_101 ( struct V_171 * V_185 ,
struct V_193 * V_194 ,
T_4 V_195 , int * V_196 )
{
V_196 [ 0 ] = 255 ;
...
if ( ! V_198 )
return;
if ( ! F_104 ( & V_198 -> V_200 ) )
return;
V_198 -> V_200 . V_201 ( V_198 -> V_200 . V_202 ) ;
return;
}
if ( F_22 ( V_4 -> V_33 ) ) {
F_105 ( V_4 ) ;
} else {
struct V_203 * V_204 = V_2 -> V_61 -> V_203 ;
unsigned long V_48 ;
F_10 ( V_204 -> V_205 , V_48 ) ;
F_106 ( V_2 -> V_206 ) ;
F_12 ( V_204 -> V_205 , V_48 ) ;
}
}
void F_107 ( struct V_182 * V_183 )
{
struct V_46 * V_177 = V_183 -> V_184 ;
if ( ! V_177 )
return;
V_183 -> V_184 = NULL ;
F_75 ( V_177 ) ;
}
static void F_108 ( T_5 * V_116 , const char * V_207 )
{
int V_74 ;
for ( V_74 = 0 ; V_74 < V_208 ; V_74 ++ ) {
T_5 V_209 , V_210 ;
if ( ! * V_207 )
break;
V_209 = isdigit ( * V_207 ) ? * V_207 - '0' : toupper ( * V_207 ) - 'A' + 10 ;
V_207 ++ ;
V_210 = isdigit ( * V_207 ) ? * V_207 - '0' : toupper ( * V_207 ) - 'A' + 10 ;
V_207 ++ ;
V_116 [ V_74 ] = ( V_209 << 4 ) | V_210 ;
}
}
int F_109 ( struct V_71 * V_101 , T_5 * V_211 )
{
int V_76 ;
const struct V_212 * V_213 ;
V_76 = F_110 ( & V_213 , L_38 , & V_101 -> V_214 ) ;
if ( V_76 )
return V_76 ;
