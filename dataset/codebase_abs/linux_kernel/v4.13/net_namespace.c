...
F_69 ( & V_13 ) ;
F_47 ( & V_131 ) ;
F_136 ( V_132 , V_41 , F_106 , NULL , NULL ) ;
F_136 ( V_132 , V_133 , F_124 , F_130 ,
NULL ) ;
return 0 ;
}
...
if ( V_19 -> V_10 ) {
V_134:
error = F_141 ( & V_135 , V_14 , V_19 -> V_10 ) ;
if ( error < 0 ) {
if ( error == - V_136 ) {
F_142 ( & V_135 , V_6 ) ;
goto V_134;
...
static struct V_77 * F_148 ( struct V_81 * V_140 )
{
struct V_9 * V_9 = NULL ;
struct V_84 * V_84 ;
F_99 ( V_140 ) ;
