...
struct V_247 * V_250 = F_63 ( V_248 , L_21 , 0 ) ;
struct V_251 * V_252 ;
struct V_253 * V_254 ;
char V_255 [] = L_22 ;
...
V_2 -> V_184 = F_88 ( & V_280 -> V_24 , L_29 ) ;
if ( F_64 ( V_2 -> V_184 ) )
return F_67 ( V_2 -> V_184 ) ;
V_2 -> V_185 = F_88 ( & V_280 -> V_24 , L_30 ) ;
if ( F_64 ( V_2 -> V_185 ) )
...
if ( V_21 )
goto V_294;
V_21 = F_90 ( & V_280 -> V_24 , V_66 , F_25 , 0 , L_31 ,
V_2 ) ;
if ( V_21 )
goto V_295;
V_2 -> V_66 = V_66 ;
...
V_227 [ V_64 ] = - V_15 ;
F_92 ( V_296 , V_2 -> V_276 . V_277 ) ;
F_92 ( V_297 , V_2 -> V_276 . V_277 ) ;
F_93 ( & V_2 -> V_276 . V_298 ) ;
for ( V_64 = 0 ; V_64 < V_265 ; V_64 ++ ) {
struct V_6 * V_7 = & V_2 -> V_11 [ V_64 ] ;
V_7 -> V_2 = V_2 ;
F_84 ( & V_7 -> V_175 ) ;
V_7 -> V_143 . V_299 = & V_2 -> V_276 ;
F_94 ( & V_7 -> V_143 ) ;
V_7 -> V_11 = V_64 ;
F_95 ( & V_7 -> V_71 , F_23 ,
( unsigned long ) V_7 ) ;
...
if ( V_21 )
F_97 ( & V_280 -> V_24 , L_32 ) ;
} else {
V_21 = F_98 ( V_248 , L_33 ,
& V_260 ) ;
if ( V_21 )
...
V_21 = F_71 ( V_2 , V_260 ) ;
if ( V_21 )
F_97 ( & V_280 -> V_24 , L_35 ) ;
}
}
V_2 -> V_276 . V_24 = & V_280 -> V_24 ;
V_2 -> V_276 . V_301 = F_45 ;
V_2 -> V_276 . V_302 = F_49 ;
V_2 -> V_276 . V_303 = F_55 ;
V_2 -> V_276 . V_304 = F_50 ;
V_2 -> V_276 . V_305 = F_53 ;
V_2 -> V_276 . V_306 = F_54 ;
V_2 -> V_276 . V_307 = F_34 ;
V_2 -> V_276 . V_308 = F_9 ( V_202 ) ;
V_2 -> V_276 . V_309 = F_9 ( V_202 ) ;
V_2 -> V_276 . V_310 = F_9 ( V_131 ) | F_9 ( V_311 ) ;
V_2 -> V_276 . V_312 = V_313 ;
V_2 -> V_276 . V_314 = F_57 ;
V_2 -> V_276 . V_24 -> V_315 = & V_2 -> V_315 ;
...
if ( V_21 ) {
F_12 ( & V_280 -> V_24 , L_37 ) ;
goto V_316;
}
V_284 = F_103 ( NULL , NULL , L_38 ) ;
V_21 = F_104 ( V_284 , 0 , & V_287 ) ;
if ( ! V_21 ) {
V_2 -> V_153 = V_287 . V_317 ;
V_2 -> V_154 = V_287 . V_318 ;
}
F_70 ( V_284 ) ;
}
return 0 ;
...
static int F_108 ( struct V_279 * V_280 )
{
struct V_1 * V_2 = F_109 ( V_280 ) ;
int V_64 ;
F_110 ( & V_280 -> V_24 , V_2 -> V_66 , V_2 ) ;
F_105 ( & V_2 -> V_276 ) ;
F_106 ( V_2 -> V_83 ) ;
F_107 ( V_2 -> V_185 ) ;
F_107 ( V_2 -> V_184 ) ;
