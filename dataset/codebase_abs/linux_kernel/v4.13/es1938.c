...
int V_95 , unsigned long V_96 ,
void T_3 * V_97 , unsigned long V_79 )
{
struct V_42 * V_43 = V_38 -> V_43 ;
struct V_1 * V_2 = F_27 ( V_38 ) ;
...
return - V_70 ;
if ( V_96 + V_79 < V_2 -> V_61 ) {
memcpy ( V_97 , V_43 -> V_98 + V_96 + 1 , V_79 ) ;
} else {
memcpy ( V_97 , V_43 -> V_98 + V_96 + 1 , V_79 - 1 ) ;
V_43 -> V_98 [ 0 ] = * ( ( unsigned char * ) V_97 + V_79 - 1 ) ;
}
return 0 ;
}
...
struct V_114 * V_115 ;
int V_102 ;
if ( ( V_102 = F_64 ( V_2 -> V_9 , L_10 , V_113 , 2 , 1 , & V_115 ) ) < 0 )
return V_102 ;
F_65 ( V_115 , V_116 , & V_117 ) ;
F_65 ( V_115 , V_118 , & V_119 ) ;
V_115 -> V_120 = V_2 ;
V_115 -> V_121 = 0 ;
strcpy ( V_115 -> V_122 , L_11 ) ;
F_66 ( V_115 , V_123 ,
F_67 ( V_2 -> V_124 ) , 64 * 1024 , 64 * 1024 ) ;
V_2 -> V_115 = V_115 ;
return 0 ;
}
...
static int F_80 ( struct V_1 * V_2 , unsigned char V_3 )
{
if ( V_3 < 0xa0 )
return F_7 ( V_2 , V_3 ) ;
else
...
V_12 <<= V_146 ;
V_4 <<= V_146 ;
return F_79 ( V_2 , V_3 , V_12 , V_4 ) != V_4 ;
}
...
V_152 = F_80 ( V_2 , V_148 ) ;
if ( V_148 != V_149 )
V_153 = F_80 ( V_2 , V_149 ) ;
else
V_153 = V_152 ;
...
if ( V_148 != V_149 ) {
V_136 = 0 ;
if ( F_79 ( V_2 , V_148 , V_156 , V_154 ) != V_154 )
V_136 = 1 ;
if ( F_79 ( V_2 , V_149 , V_157 , V_155 ) != V_155 )
V_136 = 1 ;
} else {
V_136 = ( F_79 ( V_2 , V_148 , V_156 | V_157 ,
...
static int F_96 ( struct V_113 * V_10 )
{
struct V_169 * V_124 = F_97 ( V_10 ) ;
struct V_163 * V_9 = F_92 ( V_10 ) ;
struct V_1 * V_2 = V_9 -> V_120 ;
unsigned char * V_164 , * V_165 ;
if ( F_98 ( V_124 -> V_168 , V_170 ,
V_171 , V_172 , V_2 ) ) {
F_11 ( V_10 , L_20 ,
V_124 -> V_168 ) ;
F_99 ( V_9 ) ;
...
F_102 ( V_176 , L_22 ) ;
F_103 ( V_176 , L_23 , F_104 ( V_2 -> V_124 ) ) ;
F_105 ( V_176 , & V_2 -> V_124 -> V_10 ) ;
...
static inline int F_100 ( struct V_1 * V_2 ) { return - V_180 ; }
...
static int F_113 ( struct V_183 * V_113 )
{
struct V_1 * V_2 = V_113 -> V_184 ;
return F_109 ( V_2 ) ;
}
static int F_114 ( struct V_163 * V_9 ,
struct V_169 * V_124 ,
struct V_1 * * V_185 )
{
struct V_1 * V_2 ;
...
* V_185 = NULL ;
if ( ( V_102 = F_115 ( V_124 ) ) < 0 )
return V_102 ;
if ( F_116 ( & V_124 -> V_10 , F_117 ( 24 ) ) < 0 ||
F_118 ( & V_124 -> V_10 , F_117 ( 24 ) ) < 0 ) {
F_11 ( V_9 -> V_10 ,
L_24 ) ;
F_111 ( V_124 ) ;
return - V_189 ;
}
V_2 = F_119 ( sizeof( * V_2 ) , V_190 ) ;
if ( V_2 == NULL ) {
F_111 ( V_124 ) ;
return - V_177 ;
}
...
V_2 -> V_124 = V_124 ;
V_2 -> V_168 = - 1 ;
if ( ( V_102 = F_121 ( V_124 , L_11 ) ) < 0 ) {
F_112 ( V_2 ) ;
F_111 ( V_124 ) ;
return V_102 ;
}
V_2 -> V_191 = F_122 ( V_124 , 0 ) ;
V_2 -> V_192 = F_122 ( V_124 , 1 ) ;
V_2 -> V_193 = F_122 ( V_124 , 2 ) ;
V_2 -> V_194 = F_122 ( V_124 , 3 ) ;
V_2 -> V_179 = F_122 ( V_124 , 4 ) ;
if ( F_98 ( V_124 -> V_168 , V_170 , V_171 ,
V_172 , V_2 ) ) {
...
F_87 ( V_2 ) ;
if ( ( V_102 = F_123 ( V_9 , V_196 , V_2 , & V_187 ) ) < 0 ) {
F_109 ( V_2 ) ;
return V_102 ;
}
* V_185 = V_2 ;
...
V_200 = 1 ;
F_125 ( V_2 -> V_9 , V_202 , & V_2 -> V_143 -> V_203 ) ;
F_125 ( V_2 -> V_9 , V_202 , & V_2 -> V_142 -> V_203 ) ;
if ( ! V_201 ) {
F_125 ( V_2 -> V_9 , V_202 ,
& V_2 -> V_141 -> V_203 ) ;
F_125 ( V_2 -> V_9 , V_202 ,
...
for ( V_204 = 0 ; V_204 < F_129 ( V_206 ) ; V_204 ++ ) {
struct V_125 * V_207 ;
V_207 = F_130 ( & V_206 [ V_204 ] , V_2 ) ;
switch ( V_204 ) {
case 0 :
V_2 -> V_140 = V_207 ;
V_207 -> V_208 = F_78 ;
...
if ( ( V_102 = F_131 ( V_9 , V_207 ) ) < 0 )
return V_102 ;
}
return 0 ;
}
static int F_132 ( struct V_169 * V_124 ,
...
V_102 = F_133 ( & V_124 -> V_10 , V_216 [ V_10 ] , V_203 [ V_10 ] , V_217 ,
0 , & V_9 ) ;
if ( V_102 < 0 )
return V_102 ;
for ( V_204 = 0 ; V_204 < 5 ; V_204 ++ ) {
if ( F_122 ( V_124 , V_204 ) == 0 ||
! ( F_134 ( V_124 , V_204 ) & V_218 ) ) {
F_135 ( V_9 ) ;
return - V_25 ;
}
}
if ( ( V_102 = F_114 ( V_9 , V_124 , & V_2 ) ) < 0 ) {
F_135 ( V_9 ) ;
return V_102 ;
}
V_9 -> V_120 = V_2 ;
...
if ( ( V_102 = F_137 ( V_212 , 0 , 1 ) ) < 0 ) {
F_135 ( V_9 ) ;
return V_102 ;
}
if ( ( V_102 = F_138 ( V_212 , 0 , 1 , NULL ) ) < 0 ) {
F_135 ( V_9 ) ;
return V_102 ;
}
}
if ( F_139 ( V_9 , 0 , V_226 ,
V_2 -> V_194 ,
V_227 | V_228 ,
- 1 , & V_2 -> V_181 ) < 0 ) {
F_11 ( V_9 -> V_10 , L_30 ) ;
...
static void F_142 ( struct V_169 * V_124 )
{
F_135 ( F_143 ( V_124 ) ) ;
}
