...
switch ( V_56 -> V_60 ) {
case V_61 :
V_59 = V_1 -> V_40 -> V_41 + V_56 -> V_4 - 8 ;
F_22 ( V_1 -> V_62 ,
V_1 -> V_62 -> V_63 ,
V_59 , V_1 -> V_62 -> V_64 , V_59 ) ;
break;
} ;
if ( F_23 ( & V_6 -> V_28 ) <= 0 )
return 0 ;
...
V_1 -> V_40 = V_86 ;
F_34 ( V_1 -> V_97 , V_86 -> V_98 ) ;
F_35 (
V_1 -> V_99 ,
V_100 [ V_86 -> V_98 ] . V_99 ) ;
F_22 (
V_1 -> V_101 , V_102 ,
V_103 - V_1 -> V_40 -> V_41 , 1 ,
V_1 -> V_40 -> V_104 - V_1 -> V_40 -> V_41 ) ;
V_96 =
V_100 [ V_86 -> V_98 ] . V_105
- V_1 -> V_40 -> V_39 ;
F_22 ( V_1 -> V_106 , V_96 ,
V_96 , 1 , V_96 ) ;
}
...
static int F_36 ( struct V_32 * V_7 , T_2 * V_107 )
{
* V_107 = V_108 ;
return 0 ;
}
...
V_98 = V_1 -> V_40 -> V_98 ;
V_109 = & V_100 [ V_98 ] . V_109 ;
V_11 = F_12 ( V_1 , V_109 ) ;
if ( V_11 ) {
F_38 ( & V_6 -> V_28 , L_4 , V_112 ) ;
return V_11 ;
}
V_109 = & V_1 -> V_40 -> V_109 ;
V_11 = F_12 ( V_1 , V_109 ) ;
if ( V_11 ) {
F_38 ( & V_6 -> V_28 , L_5 , V_112 ) ;
return V_11 ;
}
V_11 = F_39 ( V_1 -> V_7 . V_58 ) ;
if ( V_11 )
return V_11 ;
return F_7 ( V_1 , V_113 ,
V_48 ,
V_114 ) ;
}
...
static int F_41 ( struct V_32 * V_7 , int V_116 )
{
struct V_1 * V_1 = F_14 ( V_7 ) ;
...
static int T_5 F_44 ( struct V_120 * V_28 )
{
...
static int T_5 F_47 ( struct V_120 * V_28 )
{
struct V_5 * V_6 = F_45 ( V_28 ) ;
struct V_32 * V_7 = F_46 ( V_6 ) ;
struct V_1 * V_1 = F_14 ( V_7 ) ;
...
1 ,
V_133 - V_1 -> V_40 -> V_39 ) ;
V_1 -> V_106 -> V_16 |= V_130 ;
V_1 -> V_62 = F_53 (
V_124 , & V_126 ,
V_69 , V_134 ,
V_135 , V_136 ,
V_137 ) ;
F_53 ( V_124 , & V_126 , V_65 ,
V_138 , V_139 ,
V_140 , V_141 ) ;
F_53 ( V_124 , & V_126 , V_68 ,
V_142 , V_143 ,
V_144 , V_145 ) ;
F_54 ( V_124 , & V_126 ,
V_73 ,
...
if ( V_4 != 19200000 )
return - V_14 ;
V_1 = F_60 ( & V_6 -> V_28 , sizeof( * V_1 ) , V_149 ) ;
if ( ! V_1 )
return - V_150 ;
F_61 ( & V_1 -> V_7 , V_6 , & V_151 ) ;
V_11 = F_48 ( V_1 ) ;
if ( V_11 ) {
...
V_1 -> V_7 . V_152 = & V_153 ;
V_1 -> V_7 . V_16 |= V_154 ;
V_1 -> V_7 . V_155 . V_156 = & V_157 ;
V_1 -> V_7 . V_155 . V_158 = V_159 ;
V_1 -> V_37 . V_16 = V_160 ;
V_11 = F_62 ( & V_1 -> V_7 . V_155 , 1 , & V_1 -> V_37 ) ;
if ( V_11 ) {
F_38 ( & V_6 -> V_28 , L_10 , V_112 , V_11 ) ;
goto V_161;
}
V_11 = F_63 ( & V_1 -> V_7 ) ;
if ( V_11 < 0 )
