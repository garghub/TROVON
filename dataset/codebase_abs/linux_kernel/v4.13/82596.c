...
memcpy ( V_16 -> V_85 . V_86 , V_2 -> V_87 , V_88 ) ;
V_16 -> V_85 . V_27 . V_25 = V_89 ;
F_29 ( V_2 , & V_16 -> V_85 . V_27 ) ;
F_28 ( V_78 , F_7 ( V_79 L_21 , V_2 -> V_22 ) ) ;
V_16 -> V_90 . V_27 . V_25 = V_91 ;
F_29 ( V_2 , & V_16 -> V_90 . V_27 ) ;
F_30 ( & V_16 -> V_92 , V_69 ) ;
...
struct V_31 * V_32 ;
int V_95 = 0 ;
F_28 ( V_96 , F_7 ( V_79 L_27 ,
V_16 -> V_45 , V_16 -> V_47 ) ) ;
V_30 = V_16 -> V_45 ;
while ( ( V_30 -> V_20 ) & V_97 ) {
if ( V_30 -> V_32 == V_42 )
V_32 = V_42 ;
else if ( V_30 -> V_32 == V_16 -> V_47 -> V_62 )
V_32 = V_16 -> V_47 ;
else {
F_7 ( V_94 L_28 , V_2 -> V_22 ) ;
V_32 = V_42 ;
}
F_28 ( V_96 , F_7 ( V_79 L_29 ,
V_30 , V_30 -> V_32 , V_30 -> V_20 ) ) ;
if ( V_32 != V_42 && ( ( V_30 -> V_20 ) & V_98 ) ) {
int V_99 = V_32 -> V_46 & 0x3fff ;
struct V_59 * V_58 = V_32 -> V_58 ;
int V_100 = 0 ;
F_28 ( V_101 , F_33 ( V_32 -> V_63 , L_30 ) ) ;
V_95 ++ ;
if ( V_99 > V_102 ) {
struct V_59 * V_103 ;
V_103 = F_15 ( V_2 , V_60 ) ;
...
V_100 = 1 ;
V_32 -> V_58 = V_103 ;
V_32 -> V_63 = V_103 -> V_64 ;
V_32 -> V_48 = F_18 ( F_17 ( V_103 -> V_64 ) ) ;
#ifdef F_19
F_20 ( F_21 ( V_103 -> V_64 ) , V_60 ) ;
#endif
} else {
V_58 = F_15 ( V_2 , V_99 + 2 ) ;
}
V_104:
if ( V_58 == NULL ) {
V_2 -> V_105 . V_106 ++ ;
...
F_38 ( V_58 ) ;
V_2 -> V_105 . V_109 ++ ;
V_2 -> V_105 . V_110 += V_99 ;
}
}
else {
F_28 ( V_111 , F_7 ( V_79 L_31 ,
V_2 -> V_22 , V_30 -> V_20 ) ) ;
V_2 -> V_105 . V_112 ++ ;
if ( ( V_30 -> V_20 ) & 0x0001 )
V_2 -> V_105 . V_113 ++ ;
...
V_16 -> V_130 -> V_43 = F_43 ( F_17 ( & V_27 -> V_24 ) ) ;
} else {
V_16 -> V_41 = V_27 ;
F_8 ( V_2 , V_16 , 100 , L_38 ) ;
V_16 -> V_23 . V_27 = F_43 ( F_17 ( & V_27 -> V_24 ) ) ;
...
{
int V_136 = 0 ;
F_28 ( V_137 , F_7 ( V_79 L_40 , V_2 -> V_22 , V_2 -> V_50 ) ) ;
if ( F_45 ( V_2 -> V_50 , V_138 , 0 , L_41 , V_2 ) ) {
F_7 ( V_21 L_42 , V_2 -> V_22 , V_2 -> V_50 ) ;
return - V_139 ;
}
#ifdef F_2
if ( V_3 ) {
if ( F_45 ( 0x56 , F_11 , 0 , L_43 , V_2 ) ) {
V_136 = - V_139 ;
goto V_140;
}
}
...
static T_3 F_50 ( struct V_59 * V_58 , struct V_1 * V_2 )
{
struct V_15 * V_16 = V_2 -> V_28 ;
struct V_121 * V_121 ;
struct V_145 * V_146 ;
short V_147 = V_58 -> V_108 ;
...
#ifdef F_19
F_53 ( F_21 ( V_58 -> V_64 ) , V_147 ) ;
#endif
F_28 ( V_159 , F_33 ( V_58 -> V_64 , L_49 ) ) ;
F_29 ( V_2 , & V_121 -> V_27 ) ;
V_2 -> V_105 . V_144 ++ ;
V_2 -> V_105 . V_160 += V_147 ;
}
F_42 ( V_2 ) ;
return V_150 ;
}
...
memcpy ( V_86 , ( void * ) 0xfffc1f2c , V_88 ) ;
V_2 -> V_5 = V_170 ;
...
#ifdef F_19
F_53 ( F_21 ( ( void * ) ( V_2 -> V_178 ) ) , 4096 ) ;
F_20 ( F_21 ( ( void * ) ( V_2 -> V_178 ) ) , 4096 ) ;
F_59 ( ( void * ) ( V_2 -> V_178 ) , 4096 , V_188 ) ;
#endif
V_16 -> V_23 . V_25 = 0 ;
V_16 -> V_23 . V_27 = V_42 ;
V_16 -> V_23 . V_30 = V_42 ;
...
while ( ( V_16 -> V_41 != V_42 ) && ( V_16 -> V_41 -> V_24 & V_97 ) ) {
V_119 = V_16 -> V_41 ;
...
case V_91 :
{
unsigned short V_24 = ( (struct V_90 * ) V_119 ) -> V_24 ;
if ( V_24 & 0x8000 ) {
...
if ( ( V_16 -> V_41 != V_42 ) )
V_191 |= V_131 ;
V_16 -> V_23 . V_27 = F_43 ( F_17 ( & V_16 -> V_41 -> V_24 ) ) ;
}
...
if ( V_24 & 0x1000 ) {
if ( F_66 ( V_2 ) ) {
F_28 ( V_111 , F_7 ( V_21 L_72 , V_2 -> V_22 , V_24 ) ) ;
V_191 |= V_93 ;
V_2 -> V_105 . V_112 ++ ;
V_2 -> V_105 . V_116 ++ ;
F_23 ( V_2 ) ;
...
V_27 -> V_213 = V_204 * V_88 ;
V_211 = V_27 -> V_214 ;
F_73 (ha, dev) {
if ( ! V_204 -- )
break;
memcpy ( V_211 , V_210 -> V_215 , V_88 ) ;
if ( V_216 > 1 )
...
F_77 ( V_218 ) ;
#ifdef F_19
F_59 ( ( void * ) ( V_218 -> V_178 ) , 4096 ,
V_190 ) ;
#endif
F_62 ( ( T_1 ) ( V_218 -> V_178 ) ) ;
F_63 ( V_218 ) ;
}
