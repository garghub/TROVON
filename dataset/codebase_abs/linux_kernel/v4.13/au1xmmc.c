...
V_124 = F_77 ( V_4 -> V_115 ) ;
goto V_203;
}
V_124 = F_78 ( V_4 -> V_115 ) ;
if ( V_124 ) {
...
V_208 -> V_178 = F_82 ( V_17 ) ;
V_208 -> V_210 = V_211 ;
V_208 -> V_212 = F_82 ( V_17 ) ;
V_124 = F_83 ( F_29 ( V_17 ) , V_208 ) ;
if ( V_124 )
goto V_213;
}
#endif
...
static int F_95 ( struct V_170 * V_92 )
{
struct V_3 * V_4 = F_96 ( V_92 ) ;
if ( V_4 ) {
F_97 ( V_4 -> V_17 ) ;
#ifdef F_81
if ( V_4 -> V_15 && V_4 -> V_15 -> V_208 )
...
static int F_98 ( struct V_170 * V_92 , T_5 V_14 )
{
struct V_3 * V_4 = F_96 ( V_92 ) ;
F_6 ( 0 , F_9 ( V_4 ) ) ;
F_6 ( 0 , F_5 ( V_4 ) ) ;
...
static int F_99 ( struct V_170 * V_92 )
{
struct V_3 * V_4 = F_96 ( V_92 ) ;
F_53 ( V_4 ) ;
return 0 ;
