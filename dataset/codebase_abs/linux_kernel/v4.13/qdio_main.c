...
{
int V_87 ;
F_10 ( V_37 , V_11 -> V_25 , L_24 , V_11 -> V_21 , V_16 ) ;
if ( F_15 ( V_11 ) ) {
if ( ! V_11 -> V_64 . T_4 . V_70 ) {
...
F_57 ( V_11 ) ;
if ( F_28 ( V_11 ) == V_134 )
if ( ! F_32 ( V_11 ) && ! F_66 ( V_11 ) )
goto V_135;
if ( V_11 -> V_64 . T_3 . V_136 )
return;
if ( F_66 ( V_11 ) )
F_72 ( & V_11 -> V_64 . T_3 . V_137 ) ;
else
if ( ! F_73 ( & V_11 -> V_64 . T_3 . V_137 ) &&
F_60 ( V_11 -> V_25 -> V_14 == V_115 ) )
F_74 ( & V_11 -> V_64 . T_3 . V_137 , V_138 + 10 * V_139 ) ;
return;
V_135:
F_59 ( V_11 ) ;
}
...
void F_80 ( unsigned long V_123 )
{
struct V_10 * V_11 = (struct V_10 * ) V_123 ;
F_78 ( V_11 ) ;
}
static inline void F_81 ( struct V_48 * V_25 ,
enum V_140 V_14 )
{
...
static void F_83 ( struct V_48 * V_25 , struct V_141 * V_141 )
{
...
if ( F_66 ( V_11 ) )
continue;
if ( F_35 ( V_11 ) && F_87 ( V_11 ) )
F_26 ( V_11 ) ;
F_59 ( V_11 ) ;
}
}
static void F_88 ( struct V_155 * V_32 ,
...
static void F_91 ( struct V_155 * V_32 , int V_157 ,
int V_158 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
F_10 ( V_37 , V_25 , L_42 ) ;
...
void F_92 ( struct V_155 * V_32 , unsigned long V_156 ,
struct V_141 * V_141 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
struct V_171 V_1 ;
...
F_81 ( V_25 , V_170 ) ;
F_95 ( & V_32 -> V_159 -> V_174 ) ;
return;
}
F_83 ( V_25 , V_141 ) ;
V_157 = V_141 -> V_175 . V_176 . V_157 ;
V_158 = V_141 -> V_175 . V_176 . V_158 ;
switch ( V_25 -> V_14 ) {
case V_177 :
F_91 ( V_32 , V_157 , V_158 ) ;
break;
case V_178 :
F_81 ( V_25 , V_177 ) ;
break;
...
F_93 ( V_32 , & V_1 ) ;
F_97 ( L_46 , V_1 . V_146 ) ;
return F_98 ( NULL , & V_1 , V_123 ) ;
}
static void F_99 ( struct V_155 * V_32 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
struct V_10 * V_11 ;
int V_43 ;
...
int F_101 ( struct V_155 * V_32 , int V_182 )
{
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
struct V_171 V_1 ;
int V_18 ;
...
F_107 ( F_108 ( V_32 ) ) ;
if ( V_182 & V_185 )
V_18 = F_109 ( V_32 , V_186 ) ;
else
V_18 = F_110 ( V_32 , V_186 ) ;
if ( V_18 ) {
...
int F_116 ( struct V_191 * V_192 )
{
struct V_171 V_1 ;
struct V_48 * V_25 ;
F_93 ( V_192 -> V_32 , & V_1 ) ;
F_97 ( L_52 , V_1 . V_146 ) ;
if ( ( V_192 -> V_193 && ! V_192 -> V_194 ) ||
( V_192 -> V_195 && ! V_192 -> V_196 ) )
return - V_181 ;
if ( ( V_192 -> V_193 > V_197 ) ||
( V_192 -> V_195 > V_197 ) )
return - V_181 ;
if ( ( ! V_192 -> V_198 ) ||
( ! V_192 -> V_199 ) )
return - V_181 ;
V_25 = ( void * ) F_117 ( V_200 | V_201 ) ;
if ( ! V_25 )
goto V_202;
F_118 ( & V_25 -> V_184 ) ;
if ( F_119 ( V_192 , V_25 ) )
goto V_203;
V_25 -> V_204 = F_117 ( V_200 ) ;
if ( ! V_25 -> V_204 )
goto V_203;
V_25 -> V_205 = (struct V_205 * ) F_117 ( V_200 | V_201 ) ;
if ( ! V_25 -> V_205 )
goto V_203;
if ( F_120 ( V_25 , V_192 -> V_193 ,
V_192 -> V_195 ) )
goto V_203;
V_192 -> V_32 -> V_159 -> V_160 = V_25 ;
F_81 ( V_25 , V_177 ) ;
return 0 ;
V_203:
F_115 ( V_25 ) ;
...
static void F_121 ( struct V_48 * V_25 )
{
...
V_25 -> V_207 . V_208 = V_25 -> V_209 . V_176 ;
V_25 -> V_207 . V_107 = V_210 ;
V_25 -> V_207 . V_16 = V_25 -> V_209 . V_16 ;
V_25 -> V_207 . V_211 = ( V_54 ) ( ( V_212 ) V_25 -> V_205 ) ;
F_107 ( F_108 ( V_32 ) ) ;
F_127 ( V_32 , 0 ) ;
V_18 = F_128 ( V_32 , & V_25 -> V_207 , V_213 , 0 , 0 ) ;
F_111 ( F_108 ( V_32 ) ) ;
if ( V_18 ) {
...
V_25 -> V_207 . V_208 = V_25 -> V_214 . V_176 ;
V_25 -> V_207 . V_107 = V_210 ;
V_25 -> V_207 . V_16 = V_25 -> V_214 . V_16 ;
V_25 -> V_207 . V_211 = 0 ;
F_107 ( F_108 ( V_32 ) ) ;
F_133 ( V_32 , V_215 ) ;
V_18 = F_128 ( V_32 , & V_25 -> V_207 , V_216 ,
0 , V_217 ) ;
F_111 ( F_108 ( V_32 ) ) ;
if ( V_18 ) {
...
static inline int F_136 ( int V_40 , int V_15 , int V_16 )
{
...
static int F_137 ( struct V_10 * V_11 , unsigned int V_218 ,
int V_40 , int V_16 )
{
int V_219 ;
F_8 ( V_11 , V_220 ) ;
...
V_11 -> V_64 . T_4 . V_73 = 0 ;
goto V_86;
} else if ( F_136 ( V_11 -> V_64 . T_4 . V_72 , V_40 , V_16 ) ) {
if ( F_15 ( V_11 ) ) {
...
F_138 ( V_16 , & V_11 -> V_91 ) ;
if ( F_139 ( V_11 ) )
return F_30 ( V_11 ) ;
return 0 ;
}
static int F_140 ( struct V_10 * V_11 , unsigned int V_218 ,
int V_40 , int V_16 )
{
unsigned char V_14 = 0 ;
int V_221 , V_18 = 0 ;
...
if ( F_28 ( V_11 ) == V_63 ) {
unsigned long V_110 = 0 ;
F_13 ( V_16 > 1 && ! F_65 ( V_11 ) ) ;
V_110 = F_54 ( & V_11 -> V_64 . T_3 , V_40 ) ;
V_18 = F_68 ( V_11 , V_110 ) ;
} else if ( F_35 ( V_11 ) ) {
V_18 = F_26 ( V_11 ) ;
} else {
F_17 ( V_11 , F_142 ( V_40 ) , & V_14 , 0 ) ;
if ( V_14 != V_125 )
V_18 = F_68 ( V_11 , 0 ) ;
else
F_8 ( V_11 , V_226 ) ;
...
if ( ! F_73 ( & V_11 -> V_64 . T_3 . V_137 ) &&
F_60 ( V_11 -> V_25 -> V_14 == V_115 ) )
F_74 ( & V_11 -> V_64 . T_3 . V_137 , V_138 + V_139 ) ;
return V_18 ;
}
int F_143 ( struct V_155 * V_32 , unsigned int V_218 ,
...
return 0 ;
if ( V_218 & V_229 )
return F_137 ( V_25 -> V_161 [ V_228 ] ,
V_218 , V_40 , V_16 ) ;
else if ( V_218 & V_230 )
return F_140 ( V_25 -> V_163 [ V_228 ] ,
V_218 , V_40 , V_16 ) ;
return - V_181 ;
}
int F_144 ( struct V_155 * V_32 , int V_21 )
{
struct V_10 * V_11 ;
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
if ( ! V_25 )
...
F_145 ( V_25 ) ;
F_36 ( V_11 ) ;
F_146 ( V_149 , & V_11 -> V_64 . T_4 . V_150 ) ;
if ( F_147 ( V_25 ) )
goto V_231;
if ( ! F_51 ( V_11 ) )
goto V_231;
...
int F_148 ( struct V_155 * V_32 , int V_21 , int * V_40 ,
int * error )
{
struct V_10 * V_11 ;
int V_15 , V_114 ;
...
int F_149 ( struct V_155 * V_32 , int V_21 )
{
struct V_10 * V_11 ;
struct V_48 * V_25 = V_32 -> V_159 -> V_160 ;
if ( ! V_25 )
...
int F_150 ( struct V_171 V_1 ,
int V_232 , T_8 * V_233 ,
void (* F_151)( void * V_234 , enum V_235 type ,
void * V_236 ) ,
void * V_234 )
{
struct V_237 * V_238 ;
...
V_238 = (struct V_237 * ) F_117 ( V_200 ) ;
if ( V_238 == NULL )
return - V_206 ;
do {
V_18 = F_152 ( V_1 , V_238 , V_238 -> V_243 . V_244 , V_232 ) ;
