...
static struct V_95 * F_55 ( struct V_68 * V_18 )
{
struct V_96 * V_97 = V_18 -> V_98 ;
struct V_95 * V_10 ;
if ( ! V_97 )
return NULL ;
V_10 = F_56 ( V_18 , sizeof( * V_10 ) , V_99 ) ;
if ( ! V_10 )
return F_57 ( - V_100 ) ;
V_10 -> V_11 = F_58 ( V_97 , L_6 , 0 ) ;
if ( V_10 -> V_11 < 0 ) {
if ( V_10 -> V_11 != - V_101 )
F_13 ( V_18 , L_7 ) ;
return F_57 ( V_10 -> V_11 ) ;
}
V_10 -> V_13 = F_58 ( V_97 , L_8 , 0 ) ;
if ( V_10 -> V_13 < 0 ) {
if ( V_10 -> V_13 != - V_101 )
F_13 ( V_18 , L_9 ) ;
return F_57 ( V_10 -> V_13 ) ;
}
return V_10 ;
}
static inline struct V_95 * F_55 ( struct V_68 * V_18 )
{
return NULL ;
}
...
struct V_1 * V_2 ;
T_1 V_24 = 0 ;
V_2 = F_56 ( & V_78 -> V_18 , sizeof( * V_2 ) , V_99 ) ;
if ( ! V_2 )
return - V_100 ;
F_60 ( & V_2 -> V_43 , F_49 ) ;
F_60 ( & V_2 -> V_86 , F_52 ) ;
...
V_2 -> V_18 = & V_78 -> V_18 ;
F_63 ( & V_2 -> V_44 ) ;
V_2 -> V_10 = F_55 ( & V_78 -> V_18 ) ;
if ( F_64 ( V_2 -> V_10 ) )
return F_65 ( V_2 -> V_10 ) ;
if ( V_2 -> V_10 == NULL ) {
V_2 -> V_10 = F_66 ( & V_78 -> V_18 ) ;
if ( V_2 -> V_10 == NULL ) {
F_13 ( & V_78 -> V_18 , L_10 ) ;
return - V_75 ;
}
}
V_2 -> V_58 = V_2 -> V_10 -> V_102 * 1000 ;
if ( V_2 -> V_10 -> V_103 )
V_2 -> V_37 = true ;
if ( V_2 -> V_10 -> V_104 )
V_24 |= V_105 ;
...
V_21 = F_71 ( & V_78 -> V_18 , V_2 -> V_10 -> V_13 ,
V_109 , L_14 ) ;
if ( V_21 ) {
F_13 ( & V_78 -> V_18 , L_15 ) ;
goto V_110;
}
V_21 = F_72 ( & V_78 -> V_18 , V_2 -> V_10 -> V_11 ,
L_16 ) ;
if ( V_21 ) {
F_13 ( & V_78 -> V_18 , L_17 ) ;
goto V_110;
}
V_21 = F_73 ( & V_78 -> V_18 , F_28 ( V_2 -> V_10 -> V_11 ) ,
F_47 ,
V_111 ,
L_18 ,
V_2 ) ;
...
V_21 = F_74 ( & V_78 -> V_18 . V_112 , & V_113 ) ;
if ( V_21 ) {
F_13 ( & V_78 -> V_18 , L_20 ) ;
goto V_110;
}
V_2 -> V_114 = F_75 ( V_2 -> V_18 ) ;
if ( F_64 ( V_2 -> V_114 ) ) {
V_21 = F_65 ( V_2 -> V_114 ) ;
goto V_115;
}
return 0 ;
V_115:
F_76 ( & V_78 -> V_18 . V_112 , & V_113 ) ;
V_110:
if ( ! F_64 ( V_2 -> V_87 ) ) {
F_77 ( V_2 -> V_87 , & V_2 -> V_89 ) ;
F_70 ( V_2 -> V_87 ) ;
}
return V_21 ;
}
