...
&& ( V_32 == 0 ) ) {
F_7 ( V_7 , V_28 -> V_14 ) ;
} else if ( ( ( V_19 % sizeof( V_34 ) ) == 0 ) && ( V_33 == 0 ) ) {
F_9 ( V_7 , V_28 -> V_14 ) ;
} else {
F_11 ( V_7 , V_28 -> V_14 ) ;
}
...
static void F_13 ( T_1 * V_7 , struct V_35 * V_36 , int V_10 )
{
struct V_27 * V_28 ;
struct V_35 * V_37 ;
struct V_38 * V_39 ;
F_5 ( V_7 , V_10 ) ;
F_14 (tree->labels, l)
fprintf ( V_7 , L_4 , V_39 -> V_38 ) ;
if ( V_36 -> V_40 && ( * V_36 -> V_40 ) )
fprintf ( V_7 , L_28 , V_36 -> V_40 ) ;
else
fprintf ( V_7 , L_29 ) ;
F_15 (tree, prop) {
F_5 ( V_7 , V_10 + 1 ) ;
F_14 (prop->labels, l)
fprintf ( V_7 , L_4 , V_39 -> V_38 ) ;
fprintf ( V_7 , L_30 , V_28 -> V_40 ) ;
F_12 ( V_7 , V_28 ) ;
}
F_16 (tree, child) {
fprintf ( V_7 , L_31 ) ;
F_13 ( V_7 , V_37 , V_10 + 1 ) ;
}
F_5 ( V_7 , V_10 ) ;
fprintf ( V_7 , L_32 ) ;
}
void F_17 ( T_1 * V_7 , struct V_1 * V_41 )
{
struct V_42 * V_43 ;
fprintf ( V_7 , L_33 ) ;
for ( V_43 = V_41 -> V_44 ; V_43 ; V_43 = V_43 -> V_23 ) {
struct V_38 * V_39 ;
F_14 (re->labels, l)
fprintf ( V_7 , L_4 , V_39 -> V_38 ) ;
fprintf ( V_7 , L_34 ,
( unsigned long long ) V_43 -> V_45 ,
( unsigned long long ) V_43 -> V_46 ) ;
}
F_13 ( V_7 , V_41 -> V_47 , 0 ) ;
}
