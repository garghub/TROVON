...
unsigned int V_151 [] , struct V_152 * V_153 [] )
{
struct V_13 * V_14 = F_60 ( V_105 ) ;
struct V_71 * V_76 = F_25 ( V_14 , V_105 -> type ) ;
unsigned int V_154 = * V_149 ;
unsigned int V_155 = V_76 -> V_83 * V_76 -> V_78 . V_79 *
V_76 -> V_62 -> V_85 / V_76 -> V_62 -> V_86 ;
if ( V_154 < 2 )
* V_149 = V_154 = 2 ;
...
if ( * V_150 )
return V_151 [ 0 ] < V_155 ? - V_45 : 0 ;
* V_150 = 1 ;
V_151 [ 0 ] = V_155 ;
F_10 ( V_14 -> V_29 , L_12 , V_154 , V_155 ) ;
return 0 ;
}
...
{
struct V_214 * V_107 = F_112 ( V_200 ) ;
struct V_13 * V_14 = F_113 ( V_107 ,
struct V_13 , V_107 ) ;
F_114 ( & V_14 -> V_204 ) ;
F_108 ( & V_200 -> V_29 ) ;
F_109 ( V_14 -> V_47 ) ;
