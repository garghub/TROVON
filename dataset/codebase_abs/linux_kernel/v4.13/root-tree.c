...
V_23 = F_60 ( V_40 , V_18 -> V_26 [ 0 ] , V_36 ,
V_58 ) ;
if ( ! V_23 ) {
V_41 = - V_63 ;
goto V_25;
}
F_39 ( F_61 ( V_40 , V_57 , V_36 , V_58 ) ) ;
* V_56 = F_62 ( V_40 , V_60 ) ;
...
void F_67 ( struct V_4 * V_19 )
{
V_48 V_65 = F_68 ( & V_19 -> V_66 ) ;
if ( ! ( V_65 & V_67 ) ) {
V_65 |= V_67 ;
F_69 ( & V_19 -> V_66 , V_65 ) ;
F_70 ( V_19 , 0 ) ;
...
F_74 ( & V_14 -> V_70 ) ;
F_75 ( V_5 , V_33 -> V_71 ) ;
F_76 ( & V_5 -> ctime , V_69 . V_72 ) ;
F_77 ( & V_5 -> ctime , V_69 . V_73 ) ;
F_78 ( & V_14 -> V_70 ) ;
}
