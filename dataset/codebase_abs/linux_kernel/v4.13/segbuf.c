...
int F_19 ( struct V_1 * V_4 , unsigned int V_35 ,
T_2 ctime , T_1 V_36 )
{
int V_37 ;
...
V_84 -> V_94 = F_60 ( V_84 -> V_95 , V_84 -> V_91 ) ;
V_84 -> V_93 = V_84 -> V_92 ;
return 0 ;
V_89:
V_84 -> V_80 = NULL ;
...
static struct V_80 * F_61 ( struct V_17 * V_18 , T_4 V_93 ,
int V_94 )
{
struct V_80 * V_80 ;
V_80 = F_62 ( V_96 , V_94 ) ;
...
{
V_84 -> V_80 = NULL ;
V_84 -> V_91 = V_4 -> V_25 . V_26 ;
V_84 -> V_95 = V_102 ;
V_84 -> V_94 = F_60 ( V_84 -> V_95 , V_84 -> V_91 ) ;
V_84 -> V_93 = V_84 -> V_92 = 0 ;
V_84 -> V_103 = V_4 -> V_22 ;
}
...
V_105:
if ( ! V_84 -> V_80 ) {
V_84 -> V_80 = F_61 ( V_84 -> V_18 , V_84 -> V_103 + V_84 -> V_92 ,
V_84 -> V_94 ) ;
if ( F_3 ( ! V_84 -> V_80 ) )
return - V_33 ;
}
V_104 = F_67 ( V_84 -> V_80 , V_31 -> V_67 , V_31 -> V_66 , F_32 ( V_31 ) ) ;
if ( V_104 == V_31 -> V_66 ) {
V_84 -> V_92 ++ ;
return 0 ;
}
V_37 = F_54 ( V_4 , V_84 , V_85 , 0 ) ;
if ( F_63 ( ! V_37 ) )
goto V_105;
return V_37 ;
}
...
V_106 = F_65 ( V_4 , & V_84 , V_31 , V_107 ) ;
if ( F_3 ( V_106 ) )
goto V_108;
}
F_30 (bh, &segbuf->sb_payload_buffers, b_assoc_buffers) {
