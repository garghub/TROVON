...
struct V_25 * V_26 ;
int V_6 , type , V_39 ;
if ( ( V_26 = F_9 ( sizeof( * V_26 ) , V_40 ) ) == NULL ) {
F_3 ( V_12 L_8 ) ;
return NULL ;
}
V_26 -> V_32 . V_41 = F_10 ( V_36 , sizeof( struct V_42 ) , V_40 ) ;
if ( V_26 -> V_32 . V_41 == NULL ) {
F_3 ( V_12 L_8 ) ;
F_11 ( V_26 ) ;
return NULL ;
}
for ( V_6 = 0 ; V_6 < V_36 ; V_6 ++ )
V_26 -> V_32 . V_41 [ V_6 ] . V_43 = V_6 ;
V_26 -> V_32 . V_44 = V_26 ;
V_26 -> V_32 . V_36 = V_36 ;
V_26 -> V_2 = V_2 ;
...
struct V_42 * V_59 = V_33 -> V_32 . V_41 + V_6 ;
V_59 -> V_60 = ( ( V_33 -> V_52 >> V_6 ) & 1 ) ? 1 : 0 ;
}
}
int
V_24 ( struct V_61 * V_62 , int V_63 , void * V_44 ,
int V_64 , int V_65 )
{
struct V_25 * V_33 ;
V_33 = V_44 ;
...
static int
V_20 ( void * V_44 , struct V_74 * V_75 )
{
struct V_25 * V_26 ;
struct V_1 * V_2 ;
V_26 = V_44 ;
...
static int
V_22 ( void * V_44 , struct V_74 * V_75 )
{
struct V_25 * V_26 ;
struct V_1 * V_2 ;
V_26 = V_44 ;
...
if ( V_2 -> V_77 <= 0 )
return 0 ;
V_2 -> V_76 = F_10 ( V_2 -> V_77 , sizeof( struct V_78 * ) , V_40 ) ;
if ( V_2 -> V_76 == NULL )
return - V_28 ;
...
goto V_70;
V_81 = V_79 -> V_44 ;
sprintf ( V_79 -> V_11 , L_9 , V_2 -> V_11 ) ;
V_81 -> V_83 = V_84 ;
V_81 -> V_10 = V_2 -> V_10 ;
