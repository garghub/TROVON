...
V_32 -> V_37 = V_37 ;
V_32 -> V_38 = V_38 ;
memset ( V_32 -> V_60 , 0xff , sizeof( V_32 -> V_60 ) ) ;
F_14 ( & V_32 -> V_3 ) ;
F_13 ( & V_32 -> V_61 ) ;
F_13 ( & V_32 -> V_62 ) ;
F_38 ( & V_32 -> V_63 ) ;
V_32 -> V_64 = F_39 ( V_65 , V_32 , L_4 , V_39 ) ;
if ( F_40 ( V_32 -> V_64 ) ) {
F_16 ( L_5 , V_39 ) ;
V_42 = F_41 ( V_32 -> V_64 ) ;
F_42 ( V_32 ) ;
...
snprintf ( V_32 -> V_68 , sizeof( V_32 -> V_68 ) ,
L_7 , V_39 ) ;
snprintf ( V_32 -> V_69 , sizeof( V_32 -> V_69 ) ,
L_8 , V_39 ) ;
V_32 -> V_66 -> V_68 = V_32 -> V_68 ;
V_32 -> V_66 -> V_69 = V_32 -> V_69 ;
V_32 -> V_66 -> V_70 . V_71 = V_72 ;
V_32 -> V_66 -> V_70 . V_73 = 0 ;
V_32 -> V_66 -> V_70 . V_74 = 0 ;
V_32 -> V_66 -> V_70 . V_75 = 1 ;
V_32 -> V_66 -> V_76 = V_77 ;
V_32 -> V_66 -> V_78 = V_79 ;
V_32 -> V_66 -> V_38 = V_32 ;
V_32 -> V_66 -> V_80 = V_81 ;
V_32 -> V_66 -> V_82 = F_45 ( 100 ) ;
#endif
return V_32 ;
}
...
if ( F_31 ( ! V_83 ) )
return - V_44 ;
V_32 -> V_13 = V_83 -> V_84 -> V_13 ;
V_32 -> V_2 . V_6 . V_83 = V_83 ;
#ifdef F_34
if ( V_32 -> V_55 & V_43 ) {
V_32 -> V_66 -> V_6 . V_83 = V_83 ;
V_42 = F_48 ( V_32 -> V_66 ) ;
if ( V_42 ) {
F_16 ( L_9 ,
V_32 -> V_39 ) ;
...
if ( ! V_85 )
return 0 ;
V_32 -> V_86 = F_53 ( F_54 ( & V_32 -> V_2 . V_6 ) , V_85 ) ;
if ( F_47 ( V_32 -> V_86 ) ) {
F_55 ( L_10 , V_32 -> V_39 ) ;
return 0 ;
}
V_32 -> V_87 = F_56 ( & V_32 -> V_2 . V_6 ,
L_11 , V_32 -> V_86 , V_88 ) ;
if ( F_47 ( V_32 -> V_87 ) ) {
F_55 ( L_12 , V_32 -> V_39 ) ;
F_57 ( V_32 -> V_86 ) ;
