...
T_1 V_38 )
{
struct V_1 * V_6 = F_21 ( V_38 ) ;
if ( V_6 ) {
V_6 -> V_39 = V_40 ;
F_22 ( & V_6 -> V_34 , 2 ) ;
F_23 ( & V_37 -> V_41 ) ;
F_24 ( & V_6 -> V_42 , & V_37 -> V_19 ) ;
F_24 ( & V_6 -> V_43 , & V_37 -> V_44 ) ;
F_25 ( & V_37 -> V_41 ) ;
F_26 ( V_6 , V_45 ,
F_15 ( & V_6 -> V_34 ) ,
F_27 ( 0 ) ) ;
...
V_6 -> V_48 . V_49 = V_10 -> V_15 . V_50 ;
V_6 -> V_49 = V_10 -> V_15 . V_50 ;
V_6 -> V_51 = V_10 -> V_15 . V_52 ;
V_6 -> V_53 = 0 ;
if ( V_6 -> V_51 )
V_6 -> V_39 = V_54 ;
else
V_6 -> V_39 = V_55 ;
if ( V_10 -> V_15 . V_56 == V_57 &&
V_6 -> V_49 == V_47 -> V_58 . V_59 )
V_6 -> V_49 = V_47 -> V_58 . V_60 ;
F_9 ( V_6 -> V_48 . V_3 , V_6 ) ;
F_30 ( L_5 , V_6 -> V_26 , V_6 -> V_21 . V_16 ) ;
}
void F_31 ( struct V_1 * V_6 )
{
struct V_2 * V_3 = V_6 -> V_48 . V_3 ;
F_10 ( & V_3 -> V_18 ) ;
