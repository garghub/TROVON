...
F_4 ( L_3 , V_27 , V_25 ) ;
V_26 = F_7 ( V_27 , 0 , V_25 , & V_29 , NULL ) ;
if ( F_8 ( V_26 ) )
F_9 ( L_4 , V_26 ) ;
return F_8 ( V_26 ) ;
}
...
static T_3 F_28 ( struct V_33 * V_82 ,
T_6 V_83 , int * V_84 )
{
T_3 V_26 ;
union V_85 * V_86 ;
...
V_26 = F_7 ( V_39 , 0 ,
V_83 , & V_29 , NULL ) ;
if ( F_29 ( V_26 ) && V_84 != NULL ) {
V_86 = (union V_85 * ) V_87 . V_43 ;
if ( V_86 && V_86 -> type == V_89 )
* V_84 = ( T_6 ) V_86 -> integer . V_90 ;
}
return V_26 ;
}
...
args . V_91 = 3 ;
F_4 ( L_27 , args . V_91 , V_5 ) ;
V_26 = F_28 ( & args , V_94 , NULL ) ;
if ( F_8 ( V_26 ) )
F_9 ( L_28 ,
V_26 ) ;
return V_53 ;
...
{
if ( V_3 -> V_95 > 0 )
F_25 ( & V_51 -> V_51 . V_81 , & V_96 ) ;
}
static int F_34 ( struct V_65 * V_51 )
{
int V_9 ;
V_9 = F_23 ( & V_51 -> V_51 . V_81 , & V_96 ) ;
if ( V_9 )
F_33 ( V_51 ) ;
return V_9 ;
}
static T_4 F_35 ( struct V_50 * V_51 ,
struct V_19 * V_20 , char * V_5 )
{
T_3 V_26 ;
T_6 V_84 ;
...
static void F_36 ( struct V_65 * V_51 )
{
if ( V_3 -> V_98 > 0 )
F_25 ( & V_51 -> V_51 . V_81 , & V_99 ) ;
}
static int F_37 ( struct V_65 * V_51 )
{
int V_9 ;
V_9 = F_23 ( & V_51 -> V_51 . V_81 , & V_99 ) ;
if ( V_9 )
F_36 ( V_51 ) ;
return V_9 ;
}
static T_4 F_38 ( struct V_50 * V_51 ,
struct V_19 * V_20 , char * V_5 )
{
T_3 V_26 ;
T_6 V_84 ;
...
F_9 ( L_33 , V_26 ) ;
return F_16 ( V_5 , V_60 , L_34 ) ;
}
static T_4 F_39 ( struct V_50 * V_51 ,
struct V_19 * V_20 ,
const char * V_5 , T_5 V_53 )
{
T_3 V_26 ;
...
args . V_91 = 2 ;
F_4 ( L_37 , args . V_91 , V_5 ) ;
V_26 = F_28 ( & args , V_101 ,
NULL ) ;
if ( F_8 ( V_26 ) )
F_9 ( L_38 ,
V_26 ) ;
...
static void F_40 ( struct V_65 * V_51 )
{
if ( V_3 -> V_102 > 0 )
F_25 ( & V_51 -> V_51 . V_81 , & V_103 ) ;
}
static int F_41 ( struct V_65 * V_51 )
{
int V_9 ;
V_9 = F_23 ( & V_51 -> V_51 . V_81 , & V_103 ) ;
if ( V_9 )
F_40 ( V_51 ) ;
return V_9 ;
}
