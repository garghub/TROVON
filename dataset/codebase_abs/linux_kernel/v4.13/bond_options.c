...
struct V_65 * V_66 = F_35 ( V_29 -> V_64 ) ;
struct V_65 * V_67 = F_36 ( V_62 ) ;
F_37 ( ! V_67 ) ;
if ( V_67 == V_66 ) {
F_26 ( V_29 -> V_38 , L_16 ,
V_67 -> V_38 -> V_2 ) ;
...
V_29 -> V_78 = V_79 ;
F_42 ( & V_29 -> V_72 ) ;
F_43 ( V_29 -> V_74 , & V_29 -> V_73 , 0 ) ;
}
}
return 0 ;
}
static void F_49 ( struct V_28 * V_29 , int V_80 ,
T_3 V_81 ,
unsigned long V_82 )
{
...
static int F_51 ( struct V_28 * V_29 , T_3 V_81 )
{
T_3 * V_83 = V_29 -> V_31 . V_77 ;
int V_88 ;
if ( ! F_52 ( V_81 ) ) {
...
F_26 ( V_29 -> V_38 , L_36 , & V_81 ) ;
F_49 ( V_29 , V_88 , V_81 , V_89 ) ;
return 0 ;
}
static int F_54 ( struct V_28 * V_29 , T_3 V_81 )
{
return F_51 ( V_29 , V_81 ) ;
}
static int F_55 ( struct V_28 * V_29 , T_3 V_81 )
{
T_3 * V_83 = V_29 -> V_31 . V_77 ;
struct V_84 * V_85 ;
struct V_65 * V_65 ;
...
T_3 V_81 ;
if ( V_53 -> string ) {
if ( ! F_58 ( V_53 -> string + 1 , - 1 , ( V_91 * ) & V_81 , - 1 , NULL ) ) {
F_12 ( V_29 -> V_38 , L_41 ,
& V_81 ) ;
return V_21 ;
}
...
goto V_112;
* V_110 = '\0' ;
if ( sscanf ( ++ V_110 , L_56 , & V_111 ) != 1 )
goto V_112;
if ( ! F_79 ( V_53 -> string ) ||
V_111 > V_29 -> V_38 -> V_113 )
goto V_112;
V_109 = F_28 ( F_29 ( V_29 -> V_38 ) , V_53 -> string ) ;
if ( ! V_109 )
goto V_112;
V_108 = NULL ;
F_50 (bond, slave, iter) {
...
char * V_59 ;
int V_21 ;
sscanf ( V_53 -> string , L_58 , V_115 ) ;
V_59 = V_115 + 1 ;
if ( ( strlen ( V_115 ) <= 1 ) ||
! F_79 ( V_59 ) )
goto V_112;
V_38 = F_28 ( F_29 ( V_29 -> V_38 ) , V_59 ) ;
if ( ! V_38 ) {
F_26 ( V_29 -> V_38 , L_59 ,
V_59 ) ;
V_21 = - V_63 ;
...
if ( ! F_87 ( V_120 ) )
goto V_121;
F_26 ( V_29 -> V_38 , L_66 , V_120 ) ;
F_88 ( V_29 -> V_31 . V_122 , V_120 ) ;
F_85 ( V_29 ) ;
return 0 ;
V_121:
F_12 ( V_29 -> V_38 , L_67 ) ;
