...
V_268:
if ( V_105 ) {
if ( V_105 -> V_234 . V_276 != 0 )
F_67 ( & V_105 -> V_234 ) ;
F_45 ( V_105 -> V_136 ) ;
}
if ( V_24 == 0 )
F_68 ( V_277 , ( void * ) V_262 ) ;
return V_264 ;
}
...
static int F_73 ( struct V_278 * V_262 )
{
...
static int F_75 ( struct V_278 * V_262 )
{
struct V_51 * V_52 = F_74 ( V_262 ) ;
struct V_18 * V_105 ;
int V_19 ;
