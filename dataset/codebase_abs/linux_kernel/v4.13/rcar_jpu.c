...
unsigned int V_174 [] , struct V_175 * V_176 [] )
{
...
for ( V_20 = 0 ; V_20 < * V_173 ; V_20 ++ )
V_174 [ V_20 ] = V_147 -> V_152 . V_133 [ V_20 ] . V_134 ;
return 0 ;
}
static int F_65 ( struct V_178 * V_3 )
{
struct V_2 * V_179 = F_66 ( V_3 ) ;
struct V_11 * V_73 = F_64 ( V_3 -> V_144 ) ;
struct V_103 * V_147 ;
unsigned int V_20 ;
V_147 = F_38 ( V_73 , V_3 -> V_144 -> type ) ;
if ( F_39 ( V_3 -> V_144 -> type ) ) {
if ( V_179 -> V_125 == V_180 )
V_179 -> V_125 = V_126 ;
if ( V_179 -> V_125 != V_126 ) {
...
static void F_69 ( struct V_178 * V_3 )
{
struct V_2 * V_179 = F_66 ( V_3 ) ;
struct V_11 * V_73 = F_64 ( V_3 -> V_144 ) ;
if ( ! V_73 -> V_74 && F_39 ( V_3 -> V_144 -> type ) ) {
struct V_1 * V_181 = F_1 ( V_179 ) ;
struct V_103 * V_147 , V_182 ;
void * V_55 = F_70 ( V_3 , 0 ) ;
unsigned long V_183 = F_71 ( V_3 , 0 ) ;
...
if ( V_73 -> V_17 . V_142 )
F_72 ( V_73 -> V_17 . V_142 , V_179 ) ;
return;
V_187:
F_18 ( V_73 -> V_7 -> V_36 , L_10 ) ;
F_73 ( V_3 , V_188 ) ;
}
static void F_74 ( struct V_178 * V_3 )
{
struct V_2 * V_179 = F_66 ( V_3 ) ;
struct V_1 * V_181 = F_1 ( V_179 ) ;
struct V_11 * V_73 = F_64 ( V_3 -> V_144 ) ;
...
T_2 * V_55 ;
if ( V_3 -> V_189 == V_190 )
V_179 -> V_191 = F_38 ( V_73 , type ) -> V_191 ++ ;
...
static int F_76 ( struct V_144 * V_145 , unsigned V_197 )
{
struct V_11 * V_73 = F_64 ( V_145 ) ;
...
static int F_81 ( void * V_70 , struct V_144 * V_198 ,
struct V_144 * V_199 )
{
...
V_198 -> V_36 = V_73 -> V_7 -> V_149 . V_36 ;
V_148 = F_82 ( V_198 ) ;
if ( V_148 )
return V_148 ;
...
V_199 -> V_36 = V_73 -> V_7 -> V_149 . V_36 ;
return F_82 ( V_199 ) ;
}
static int F_83 ( struct V_69 * V_69 )
{
struct V_7 * V_7 = F_84 ( V_69 ) ;
struct V_212 * V_213 = F_85 ( V_69 ) ;
struct V_11 * V_73 ;
int V_148 ;
V_73 = F_86 ( sizeof( * V_73 ) , V_214 ) ;
if ( ! V_73 )
return - V_215 ;
F_87 ( & V_73 -> V_17 , V_213 ) ;
...
V_166 ) ;
V_73 -> V_17 . V_142 = F_89 ( V_7 -> V_218 , V_73 , F_81 ) ;
...
static void F_102 ( struct V_11 * V_73 , bool V_224 )
{
struct V_2 * V_225 , * V_226 ;
unsigned long V_154 ;
F_54 ( & V_73 -> V_7 -> V_155 , V_154 ) ;
V_225 = F_78 ( V_73 -> V_17 . V_142 ) ;
V_226 = F_79 ( V_73 -> V_17 . V_142 ) ;
F_80 ( V_225 , V_188 ) ;
F_80 ( V_226 , V_188 ) ;
if ( V_224 )
F_5 ( V_73 -> V_7 , V_35 , V_34 ) ;
F_55 ( & V_73 -> V_7 -> V_155 , V_154 ) ;
F_103 ( V_73 -> V_7 -> V_218 , V_73 -> V_17 . V_142 ) ;
}
...
F_54 ( & V_73 -> V_7 -> V_155 , V_154 ) ;
V_7 -> V_52 = V_73 ;
V_225 = F_105 ( V_73 -> V_17 . V_142 ) ;
V_226 = F_106 ( V_73 -> V_17 . V_142 ) ;
if ( V_73 -> V_74 ) {
V_181 = F_1 ( V_226 ) ;
V_147 = & V_73 -> V_105 ;
} else {
...
F_5 ( V_7 , V_237 | V_238 | V_230 |
V_239 , V_240 ) ;
F_5 ( V_7 , V_241 | V_231 , V_242 ) ;
F_5 ( V_7 , V_243 , V_244 ) ;
F_5 ( V_7 , V_245 , V_246 ) ;
F_5 ( V_7 , V_227 , V_247 ) ;
F_5 ( V_7 , V_228 , V_248 ) ;
F_5 ( V_7 , V_138 , V_249 ) ;
F_5 ( V_7 , ( V_107 >> 8 ) & V_250 , V_251 ) ;
F_5 ( V_7 , V_107 & V_250 , V_252 ) ;
F_5 ( V_7 , ( V_111 >> 8 ) & V_250 , V_253 ) ;
F_5 ( V_7 , V_111 & V_250 , V_254 ) ;
F_5 ( V_7 , V_107 , V_255 ) ;
F_5 ( V_7 , V_111 , V_256 ) ;
F_5 ( V_7 , V_229 + V_135 , V_257 ) ;
...
V_262 = V_261 + V_107 * V_111 ;
F_5 ( V_7 , V_263 | V_238 , V_240 ) ;
F_5 ( V_7 , V_241 , V_242 ) ;
F_5 ( V_7 , V_243 , V_244 ) ;
F_5 ( V_7 , V_245 | V_264 , V_246 ) ;
F_5 ( V_7 , V_260 , V_265 ) ;
F_5 ( V_7 , V_261 , V_266 ) ;
F_5 ( V_7 , V_262 , V_267 ) ;
F_5 ( V_7 , V_138 , V_268 ) ;
...
{
struct V_11 * V_73 = V_70 ;
if ( ! F_113 ( V_73 -> V_7 -> V_270 , ! V_73 -> V_7 -> V_52 ,
F_16 ( V_271 ) ) )
F_102 ( V_73 , true ) ;
}
static T_3 F_114 ( int V_272 , void * V_273 )
{
struct V_7 * V_7 = V_273 ;
struct V_11 * V_274 ;
struct V_2 * V_225 , * V_226 ;
unsigned int V_275 ;
V_275 = F_3 ( V_7 , V_276 ) ;
...
V_275 ) )
return V_280 ;
F_5 ( V_7 , ~ ( V_275 & V_281 ) , V_276 ) ;
if ( V_275 & ( V_279 | V_278 ) )
F_5 ( V_7 , V_282 , V_34 ) ;
F_115 ( & V_7 -> V_155 ) ;
if ( ( V_275 & V_278 ) &&
! ( V_275 & V_277 ) )
goto V_283;
V_274 = F_116 ( V_7 -> V_218 ) ;
if ( ! V_274 ) {
F_18 ( V_7 -> V_36 , L_11 ) ;
goto V_283;
}
V_225 = F_78 ( V_274 -> V_17 . V_142 ) ;
V_226 = F_79 ( V_274 -> V_17 . V_142 ) ;
if ( V_275 & V_277 ) {
if ( V_274 -> V_74 ) {
unsigned long V_284 = F_3 ( V_7 , V_285 ) << 16
| F_3 ( V_7 , V_286 ) << 8
| F_3 ( V_7 , V_287 ) ;
F_68 ( & V_226 -> V_232 , 0 ,
V_284 + V_135 ) ;
}
V_226 -> V_125 = V_225 -> V_125 ;
V_226 -> V_232 . V_288 = V_225 -> V_232 . V_288 ;
if ( V_225 -> V_154 & V_289 )
V_226 -> V_290 = V_225 -> V_290 ;
V_226 -> V_154 = V_225 -> V_154 &
( V_289 | V_291 |
V_292 | V_293 |
V_294 ) ;
F_80 ( V_225 , V_190 ) ;
...
unsigned char error = F_3 ( V_7 , V_295 ) & V_296 ;
...
F_5 ( V_7 , V_35 , V_34 ) ;
F_117 ( & V_7 -> V_155 ) ;
F_103 ( V_7 -> V_218 , V_274 -> V_17 . V_142 ) ;
F_118 ( & V_7 -> V_270 ) ;
return V_298 ;
V_283:
F_117 ( & V_7 -> V_155 ) ;
...
int V_148 ;
unsigned int V_20 ;
V_7 = F_120 ( & V_300 -> V_36 , sizeof( * V_7 ) , V_214 ) ;
if ( ! V_7 )
return - V_215 ;
F_121 ( & V_7 -> V_270 ) ;
F_122 ( & V_7 -> V_211 ) ;
F_123 ( & V_7 -> V_155 ) ;
V_7 -> V_36 = & V_300 -> V_36 ;
V_302 = F_124 ( V_300 , V_303 , 0 ) ;
V_7 -> V_9 = F_125 ( & V_300 -> V_36 , V_302 ) ;
if ( F_90 ( V_7 -> V_9 ) )
return F_91 ( V_7 -> V_9 ) ;
V_7 -> V_272 = V_148 = F_126 ( V_300 , 0 ) ;
if ( V_148 < 0 ) {
F_18 ( & V_300 -> V_36 , L_13 ) ;
return V_148 ;
}
V_148 = F_127 ( & V_300 -> V_36 , V_7 -> V_272 , F_114 , 0 ,
F_33 ( & V_300 -> V_36 ) , V_7 ) ;
if ( V_148 ) {
F_18 ( & V_300 -> V_36 , L_14 , V_7 -> V_272 ) ;
return V_148 ;
}
V_7 -> V_222 = F_128 ( & V_300 -> V_36 , NULL ) ;
if ( F_90 ( V_7 -> V_222 ) ) {
F_18 ( & V_300 -> V_36 , L_15 ) ;
return F_91 ( V_7 -> V_222 ) ;
}
V_148 = F_129 ( & V_300 -> V_36 , & V_7 -> V_149 ) ;
if ( V_148 ) {
F_18 ( & V_300 -> V_36 , L_16 ) ;
return V_148 ;
}
V_7 -> V_218 = F_130 ( & V_304 ) ;
if ( F_90 ( V_7 -> V_218 ) ) {
F_51 ( & V_7 -> V_149 , L_17 ) ;
V_148 = F_91 ( V_7 -> V_218 ) ;
goto V_305;
}
...
static int F_140 ( struct V_175 * V_36 )
{
struct V_7 * V_7 = F_141 ( V_36 ) ;
if ( V_7 -> V_221 == 0 )
return 0 ;
F_101 ( V_7 -> V_222 ) ;
return 0 ;
}
static int F_142 ( struct V_175 * V_36 )
{
struct V_7 * V_7 = F_141 ( V_36 ) ;
if ( V_7 -> V_221 == 0 )
return 0 ;
