...
struct V_91 * V_138 )
{
V_56 -> V_148 = V_138 -> V_148 ;
V_56 -> V_149 = V_150 ;
V_56 -> V_31 = V_138 -> V_3 . V_28 . V_31 ;
V_56 -> type = V_151 [ V_138 -> V_3 . V_28 . type ] ;
V_56 -> V_37 =
...
static void F_56 ( int V_60 , struct V_91 * V_155 )
{
struct V_100 * V_101 = & F_48 ( V_60 ) ;
unsigned long V_33 ;
int V_113 ;
V_33 = 1 + V_155 -> V_3 . V_28 . V_33 ;
V_113 = F_43 ( V_33 ) ;
V_155 -> V_148 = V_101 -> V_120 >> V_113 ;
}
static int F_57 ( unsigned int V_60 )
{
unsigned int V_61 , V_63 ;
struct V_139 * V_140 = F_47 ( V_60 ) ;
struct V_55 * V_56 = V_140 -> V_145 ;
struct V_91 V_155 = {} ;
for ( V_61 = 0 ; V_61 < V_140 -> V_154 ; V_61 ++ ) {
V_63 = F_36 ( V_61 , & V_155 ) ;
if ( V_63 )
return V_63 ;
F_56 ( V_60 , & V_155 ) ;
F_54 ( V_56 ++ , & V_155 ) ;
F_53 ( V_60 , V_61 , & V_155 ) ;
}
V_140 -> V_156 = true ;
return 0 ;
}
