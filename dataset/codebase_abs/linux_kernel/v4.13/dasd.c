...
if ( V_299 -> V_259 && ! ( V_299 -> V_82 & V_305 ) )
return;
...
V_98 = V_299 -> V_61 -> V_310 ( V_299 , V_36 , V_100 ) ;
if ( F_29 ( V_98 ) ) {
if ( F_104 ( V_98 ) == - V_210 )
break;
if ( F_104 ( V_98 ) == - V_4 )
...
V_202 = V_98 -> V_36 -> V_65 -> V_61 -> V_313 ( V_98 , V_100 ) ;
if ( V_202 < 0 )
error = F_219 ( V_202 ) ;
else if ( V_202 == 0 ) {
switch ( V_98 -> V_211 ) {
...
static void F_220 ( struct V_35 * V_36 ,
struct V_101 * V_266 )
{
struct V_101 * V_102 , * V_265 ;
struct V_97 * V_98 ;
...
static void F_222 ( struct V_97 * V_98 , void * V_19 )
{
F_63 ( V_98 -> V_36 ) ;
}
...
static void F_224 ( struct V_97 * V_98 , void * V_19 )
{
F_72 ( & V_237 ) ;
}
static int F_225 ( struct V_97 * V_98 )
{
...
static void F_227 ( struct V_302 * V_303 )
{
struct V_35 * V_36 ;
V_36 = V_303 -> V_320 ;
F_87 ( & V_36 -> V_40 ) ;
...
enum V_321 F_228 ( struct V_99 * V_100 )
{
struct V_97 * V_98 = V_100 -> V_311 ;
struct V_35 * V_36 = V_100 -> V_322 -> V_320 ;
struct V_1 * V_2 ;
int V_42 = 0 ;
if ( ! V_98 )
return V_323 ;
...
V_98 -> V_202 = V_270 ;
F_89 ( F_148 ( V_2 -> V_54 ) ) ;
} else if ( V_98 -> V_202 == V_326 ) {
struct V_97 * V_327 , * V_328 , * V_329 ;
...
V_327 -> V_199 = - 1 ;
V_327 -> V_211 = - V_218 ;
if ( V_327 -> V_202 >= V_225 ) {
F_89 ( F_148 ( V_2 -> V_54 ) ) ;
V_42 = F_202 ( V_327 ) ;
F_87 ( F_148 ( V_2 -> V_54 ) ) ;
} else if ( ( V_327 -> V_202 == V_285 ) ||
( V_327 -> V_202 == V_269 ) ) {
V_327 -> V_202 = V_270 ;
V_42 = 0 ;
} else if ( V_327 -> V_202 == V_326 ) {
continue;
}
break;
}
...
F_63 ( V_36 ) ;
F_89 ( & V_36 -> V_40 ) ;
return V_42 ? V_325 : V_323 ;
}
static int F_22 ( struct V_35 * V_36 )
{
V_36 -> V_302 = F_229 ( F_227 ,
& V_36 -> V_38 ) ;
if ( V_36 -> V_302 == NULL )
return - V_4 ;
V_36 -> V_302 -> V_320 = V_36 ;
return 0 ;
}
static void F_52 ( struct V_35 * V_36 )
{
struct V_302 * V_322 = V_36 -> V_302 ;
int V_330 ;
if ( V_36 -> V_65 -> V_82 & V_83 ) {
V_330 = 2048 ;
} else {
V_330 = V_36 -> V_65 -> V_61 -> V_331 << V_36 -> V_73 ;
}
F_230 ( V_332 , V_322 ) ;
V_322 -> V_333 . V_334 = V_330 ;
F_231 ( V_322 , V_36 -> V_76 ) ;
F_232 ( V_322 , V_330 ) ;
F_233 ( V_322 , V_335 ) ;
F_234 ( V_322 , V_9 ) ;
F_235 ( V_322 , V_9 - 1 ) ;
...
static int F_237 ( struct V_336 * V_84 , T_9 V_176 )
{
struct V_1 * V_65 ;
int V_42 ;
V_65 = F_238 ( V_84 -> V_85 ) ;
if ( ! V_65 )
return - V_207 ;
F_239 ( & V_65 -> V_36 -> V_37 ) ;
if ( F_140 ( V_262 , & V_65 -> V_193 ) ) {
V_42 = - V_207 ;
goto V_337;
}
if ( ! F_240 ( V_65 -> V_61 -> V_338 ) ) {
V_42 = - V_168 ;
goto V_337;
}
if ( V_95 ) {
F_241 ( & V_65 -> V_54 -> V_55 ,
L_95
L_96 ) ;
V_42 = - V_88 ;
goto V_71;
...
return 0 ;
V_71:
F_242 ( V_65 -> V_61 -> V_338 ) ;
V_337:
F_243 ( & V_65 -> V_36 -> V_37 ) ;
F_23 ( V_65 ) ;
return V_42 ;
}
static void F_244 ( struct V_63 * V_64 , T_9 V_176 )
{
struct V_1 * V_65 = F_238 ( V_64 ) ;
if ( V_65 ) {
F_243 ( & V_65 -> V_36 -> V_37 ) ;
F_242 ( V_65 -> V_61 -> V_338 ) ;
F_23 ( V_65 ) ;
...
static int F_245 ( struct V_336 * V_84 , struct V_342 * V_343 )
{
struct V_1 * V_65 ;
V_65 = F_238 ( V_84 -> V_85 ) ;
if ( ! V_65 )
...
V_65 -> V_61 -> V_344 ( V_65 -> V_36 , V_343 ) ;
V_343 -> V_345 = F_246 ( V_84 ) >> V_65 -> V_36 -> V_73 ;
F_23 ( V_65 ) ;
return 0 ;
}
static void
...
if ( ! V_352 )
return 0 ;
F_255 ( V_2 -> V_54 , & V_349 ) ;
memset ( & V_351 , 0 , sizeof( V_351 ) ) ;
V_351 . V_353 = V_349 . V_354 ;
V_351 . V_355 = sizeof( V_351 ) ;
V_42 = V_350 ( & V_351 ) ;
if ( V_42 == 0 || V_42 == 2 ) {
return V_351 . V_356 & 0x80 ;
} else {
F_117 ( V_58 , L_99 ,
V_349 . V_354 , V_42 ) ;
return 0 ;
...
static void F_256 ( void * V_19 , T_10 V_357 )
{
...
if ( V_358 )
F_258 ( L_100 ,
F_34 ( & V_54 -> V_55 ) , V_358 ) ;
}
int F_259 ( struct V_223 * V_54 ,
struct V_359 * V_61 )
{
int V_358 ;
V_358 = F_260 ( V_54 ) ;
...
V_54 -> V_360 = & F_160 ;
if ( ( F_261 ( V_54 , V_361 ) > 0 ) ||
( V_362 && F_262 ( F_34 ( & V_54 -> V_55 ) ) != 0 ) )
F_263 ( F_256 , V_54 ) ;
return 0 ;
}
...
if ( V_2 -> V_61 -> V_363 )
V_2 -> V_61 -> V_363 ( V_2 ) ;
F_242 ( V_2 -> V_61 -> V_338 ) ;
V_2 -> V_61 = NULL ;
}
if ( V_2 -> V_364 ) {
F_242 ( V_2 -> V_364 -> V_338 ) ;
V_2 -> V_364 = NULL ;
}
}
void F_265 ( struct V_223 * V_54 )
{
struct V_1 * V_2 ;
struct V_35 * V_36 ;
V_54 -> V_360 = NULL ;
...
if ( V_2 -> V_36 ) {
V_368 = V_2 -> V_36 -> V_84 ? 0 : - 1 ;
V_37 = F_276 ( & V_2 -> V_36 -> V_37 ) ;
if ( V_37 > V_368 ) {
if ( V_37 > 0 )
F_258 ( L_110 ,
F_34 ( & V_54 -> V_55 ) , V_37 ) ;
...
if ( F_278 ( V_370 , & V_2 -> V_193 ) &&
! F_268 ( V_271 , & V_2 -> V_193 ) ) {
F_128 ( F_148 ( V_54 ) , V_193 ) ;
if ( V_2 -> V_36 ) {
V_42 = F_279 ( V_2 -> V_36 -> V_84 ) ;
if ( V_42 != 0 )
goto V_371;
}
F_76 ( V_2 ) ;
...
{
struct V_97 * V_98 ;
F_280 ( & V_2 -> V_54 -> V_55 , L_112
L_113 ) ;
F_39 ( V_58 , V_2 , L_1 , L_114 ) ;
F_221 ( V_2 , NULL , V_372 ) ;
if ( V_2 -> V_28 < V_60 )
return 0 ;
...
int F_282 ( struct V_223 * V_54 , int V_373 )
{
struct V_1 * V_2 ;
int V_358 ;
V_2 = F_155 ( V_54 ) ;
...
void F_283 ( struct V_223 * V_54 , int * V_378 )
{
struct V_1 * V_2 ;
int V_379 , V_380 , V_381 , V_382 ;
V_2 = F_155 ( V_54 ) ;
if ( F_29 ( V_2 ) )
return;
V_380 = F_141 ( V_2 ) ;
for ( V_379 = 0 ; V_379 < 8 ; V_379 ++ ) {
if ( V_378 [ V_379 ] & V_383 ) {
F_284 ( V_2 , V_379 ) ;
}
if ( V_378 [ V_379 ] & V_384 ) {
F_285 ( V_2 , V_379 ) ;
F_76 ( V_2 ) ;
}
if ( V_378 [ V_379 ] & V_385 ) {
if ( ! F_286 ( V_2 , V_379 ) &&
! F_287 ( V_2 , V_379 ) ) {
F_285 ( V_2 , V_379 ) ;
F_76 ( V_2 ) ;
...
F_76 ( V_2 ) ;
F_290 ( V_2 ) ;
} else if ( ! F_141 ( V_2 ) && V_382 ) {
F_146 ( V_2 , V_382 ) ;
F_76 ( V_2 ) ;
}
if ( V_380 && ! F_141 ( V_2 ) && ! V_381 && ! V_382 ) {
F_280 ( & V_2 -> V_54 -> V_55 ,
L_119 ) ;
F_39 ( V_58 , V_2 ,
L_1 , L_120 ) ;
...
int F_291 ( struct V_1 * V_2 , T_11 V_217 )
{
if ( ! F_141 ( V_2 ) && V_217 ) {
F_292 ( V_2 , V_217 ) ;
F_281 ( V_2 ) ;
...
if ( V_98 -> V_36 )
F_173 ( & V_98 -> V_292 ) ;
V_98 -> V_36 -> V_65 -> V_61 -> V_313 (
V_98 , (struct V_99 * ) V_98 -> V_267 ) ;
}
if ( ! F_56 ( & V_388 ) ) {
F_181 ( F_148 ( V_2 -> V_54 ) ) ;
F_297 ( & V_388 , & V_2 -> V_15 ) ;
F_183 ( F_148 ( V_2 -> V_54 ) ) ;
}
F_72 ( & V_282 ) ;
return V_42 ;
...
{
struct V_1 * V_2 = F_266 ( V_54 ) ;
if ( F_29 ( V_2 ) )
return F_104 ( V_2 ) ;
F_124 ( V_390 , & V_2 -> V_193 ) ;
if ( V_2 -> V_61 -> V_391 )
V_2 -> V_61 -> V_391 ( V_2 ) ;
F_187 ( V_2 , V_392 ) ;
return F_294 ( V_2 ) ;
}
int F_299 ( struct V_223 * V_54 )
{
struct V_1 * V_2 = F_266 ( V_54 ) ;
int V_42 = 0 ;
if ( F_29 ( V_2 ) )
...
if ( V_2 -> V_36 )
F_63 ( V_2 -> V_36 ) ;
F_277 ( V_390 , & V_2 -> V_193 ) ;
F_23 ( V_2 ) ;
return 0 ;
}
static struct V_97 * F_300 ( struct V_1 * V_2 ,
void * V_393 ,
int V_394 ,
int V_187 )
{
...
V_195 = V_98 -> V_191 ;
V_195 -> V_396 = V_397 ;
if ( F_301 ( V_393 , V_394 ) ) {
V_395 = ( unsigned long * ) ( V_98 -> V_19 ) ;
V_195 -> V_398 = ( V_399 ) ( V_400 ) V_395 ;
V_195 -> V_193 = V_401 ;
V_395 = F_302 ( V_395 , V_393 , V_394 ) ;
} else {
V_195 -> V_398 = ( V_399 ) ( V_400 ) V_393 ;
V_195 -> V_193 = 0 ;
}
V_195 -> V_402 = V_394 ;
V_98 -> V_108 = V_2 ;
...
int F_303 ( struct V_1 * V_2 , int V_187 ,
void * V_393 , int V_394 )
{
int V_358 ;
struct V_97 * V_98 ;
V_98 = F_300 ( V_2 , V_393 , V_394 ,
V_187 ) ;
if ( F_29 ( V_98 ) )
return F_104 ( V_98 ) ;
V_358 = F_206 ( V_98 ) ;
F_131 ( V_98 , V_98 -> V_389 ) ;
return V_358 ;
}
...
char * V_236 = NULL ;
if ( F_304 ( & V_226 -> V_227 ) && ( V_226 -> V_227 . V_228 . V_404 == 0x01 ) ) {
if ( V_226 -> V_227 . V_228 . V_405 )
V_403 = F_305 ( (struct V_405 * ) ( unsigned long )
V_226 -> V_227 . V_228 . V_405 ) ;
if ( V_403 && V_403 -> V_406 == 64 && V_403 -> V_193 )
switch ( V_403 -> V_193 & 0x07 ) {
case 1 :
V_236 = V_403 -> V_407 . V_408 . V_236 ;
break;
case 2 :
V_236 = V_403 -> V_407 . V_409 . V_236 ;
break;
default:
break;
}
} else if ( V_226 -> V_252 . V_410 . V_411 . V_412 ) {
V_236 = V_226 -> V_413 ;
}
return V_236 ;
}
void F_306 ( struct V_223 * V_54 )
{
struct V_1 * V_2 ;
V_2 = F_266 ( V_54 ) ;
if ( F_29 ( V_2 ) )
...
F_308 ( & V_282 ) ;
F_308 ( & V_280 ) ;
V_347 = F_36 ( L_33 , 1 , 1 , 8 * sizeof( long ) ) ;
if ( V_347 == NULL ) {
V_42 = - V_4 ;
goto V_414;
}
