...
V_2 -> V_4 = F_7 ( V_8 -> V_10 , sizeof( long ) ) ;
} while ( ! F_8 ( V_2 -> V_4 , V_2 -> V_5 , V_8 ,
& V_2 -> V_11 ) );
return false ;
}
void F_9 ( struct V_1 * V_2 , struct V_12 * V_5 ,
struct V_13 * V_14 , unsigned long * V_15 )
{
memset ( V_2 , 0 , sizeof( * V_2 ) ) ;
V_2 -> V_5 = V_5 ;
V_2 -> V_4 = F_7 ( V_15 , sizeof( long ) ) ;
F_8 ( V_15 , V_2 -> V_5 , & V_2 -> V_7 ,
& V_2 -> V_11 ) ;
if ( ! F_2 ( V_2 ) &&
( ! F_10 ( & V_2 -> V_7 , V_15 , sizeof( long ) ) ||
! F_6 ( * V_15 ) ) )
F_5 ( V_2 ) ;
}
