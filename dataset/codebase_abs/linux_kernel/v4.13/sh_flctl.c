...
V_88 &= ~ V_93 ;
F_7 ( V_88 , F_8 ( V_15 ) ) ;
F_54 ( V_83 -> V_90 -> V_22 , V_86 , V_60 , V_79 ) ;
return V_37 ;
}
static void F_55 ( struct V_14 * V_15 , int V_9 )
{
unsigned long V_67 ;
...
static void F_58 ( struct V_14 * V_15 , int V_98 , int V_9 )
{
int V_64 , V_99 ;
unsigned long * V_77 = ( unsigned long * ) & V_15 -> V_71 [ V_9 ] ;
V_99 = ( V_98 + 3 ) / 4 ;
...
F_33 ( V_15 ) ;
V_77 [ V_64 ] = F_34 ( F_59 ( V_15 ) ) ;
}
V_100:
for ( V_64 = 0 ; V_64 < V_99 ; V_64 ++ )
V_77 [ V_64 ] = F_60 ( V_77 [ V_64 ] ) ;
}
static enum V_61 F_61
...
V_104 [ V_64 ] = F_34 ( F_62 ( V_15 ) ) ;
V_104 [ V_64 ] = F_60 ( V_104 [ V_64 ] ) ;
}
}
return V_103 ;
}
static void F_63 ( struct V_14 * V_15 , int V_98 ,
unsigned int V_9 )
{
int V_64 , V_99 ;
unsigned long * V_77 = ( unsigned long * ) & V_15 -> V_71 [ V_9 ] ;
...
for ( V_64 = 0 ; V_64 < V_99 ; V_64 ++ ) {
F_36 ( V_15 ) ;
F_7 ( F_64 ( V_77 [ V_64 ] ) , F_59 ( V_15 ) ) ;
}
}
static void F_65 ( struct V_14 * V_15 , int V_98 ,
unsigned int V_9 )
{
int V_64 , V_99 ;
unsigned long * V_77 = ( unsigned long * ) & V_15 -> V_71 [ V_9 ] ;
V_99 = ( V_98 + 3 ) / 4 ;
for ( V_64 = 0 ; V_64 < V_99 ; V_64 ++ )
V_77 [ V_64 ] = F_64 ( V_77 [ V_64 ] ) ;
if ( V_15 -> V_30 && V_98 >= 32 &&
F_44 ( V_15 , V_77 , V_98 , V_44 ) > 0 )
return;
for ( V_64 = 0 ; V_64 < V_99 ; V_64 ++ ) {
F_43 ( V_15 ) ;
F_7 ( V_77 [ V_64 ] , F_62 ( V_15 ) ) ;
}
}
static void F_66 ( struct V_1 * V_2 , T_1 V_105 , T_1 V_106 )
{
struct V_14 * V_15 = F_30 ( V_2 ) ;
...
static void F_72 ( struct V_1 * V_2 , int V_51 )
{
struct V_14 * V_15 = F_30 ( V_2 ) ;
int V_102 , V_137 ;
enum V_61 V_138 ;
...
F_66 ( V_2 , V_118 ,
( V_139 << 8 ) | V_118 ) ;
F_7 ( F_34 ( F_67 ( V_15 ) ) | V_140 | V_141 ,
F_67 ( V_15 ) ) ;
F_7 ( F_34 ( F_68 ( V_15 ) ) | V_137 , F_68 ( V_15 ) ) ;
F_7 ( V_51 << 2 , F_32 ( V_15 ) ) ;
F_6 ( V_15 ) ;
F_9 ( V_15 ) ;
for ( V_102 = 0 ; V_102 < V_137 ; V_102 ++ ) {
F_58 ( V_15 , 512 , 512 * V_102 ) ;
V_138 = F_61 ( V_15 ,
...
( V_123 << 8 ) | V_122 ) ;
F_6 ( V_15 ) ;
F_7 ( F_34 ( F_67 ( V_15 ) ) | V_140 , F_67 ( V_15 ) ) ;
F_7 ( F_34 ( F_68 ( V_15 ) ) | V_137 , F_68 ( V_15 ) ) ;
F_7 ( V_51 << 2 , F_32 ( V_15 ) ) ;
F_9 ( V_15 ) ;
for ( V_102 = 0 ; V_102 < V_137 ; V_102 ++ ) {
F_63 ( V_15 , 512 , 512 * V_102 ) ;
F_65 ( V_15 , 16 , V_2 -> V_133 + 16 * V_102 ) ;
}
F_14 ( V_15 ) ;
F_7 ( F_34 ( F_67 ( V_15 ) ) & ~ V_140 , F_67 ( V_15 ) ) ;
}
...
F_7 ( 16 , F_35 ( V_15 ) ) ;
F_9 ( V_15 ) ;
F_63 ( V_15 , 16 , 16 * V_102 ) ;
F_14 ( V_15 ) ;
}
}
static void F_77 ( struct V_1 * V_2 , unsigned int V_146 ,
int V_50 , int V_51 )
{
struct V_14 * V_15 = F_30 ( V_2 ) ;
T_1 V_147 = 0 ;
...
if ( V_15 -> V_55 )
F_66 ( V_2 , V_146 , ( V_139 << 8 )
| V_146 ) ;
else
F_66 ( V_2 , V_146 , V_146 ) ;
F_29 ( V_2 , 0 , V_51 ) ;
...
static void F_81 ( struct V_1 * V_2 , int V_159 )
{
struct V_14 * V_15 = F_30 ( V_2 ) ;
int V_37 ;
switch ( V_159 ) {
...
static void F_86 ( struct V_1 * V_2 , const T_4 * V_77 , int V_60 )
{
struct V_14 * V_15 = F_30 ( V_2 ) ;
...
static T_7 F_88 ( struct V_1 * V_2 )
{
struct V_14 * V_15 = F_30 ( V_2 ) ;
...
static void F_89 ( struct V_1 * V_2 , T_4 * V_77 , int V_60 )
{
struct V_14 * V_15 = F_30 ( V_2 ) ;
...
static T_8 F_92 ( int V_184 , void * V_185 )
{
...
static struct V_35 * F_93 ( struct V_90 * V_22 )
{
const struct V_187 * V_188 ;
struct V_189 * V_190 ;
struct V_35 * V_36 ;
V_188 = F_94 ( V_191 , V_22 ) ;
if ( V_188 )
...
V_36 = F_95 ( V_22 , sizeof( struct V_35 ) ,
V_192 ) ;
if ( ! V_36 )
return NULL ;
...
static int F_96 ( struct V_34 * V_21 )
{
struct V_195 * V_103 ;
struct V_14 * V_15 ;
struct V_1 * V_196 ;
...
int V_37 ;
int V_184 ;
V_15 = F_95 ( & V_21 -> V_22 , sizeof( struct V_14 ) , V_192 ) ;
if ( ! V_15 )
return - V_198 ;
V_103 = F_97 ( V_21 , V_199 , 0 ) ;
V_15 -> V_88 = F_98 ( & V_21 -> V_22 , V_103 ) ;
if ( F_99 ( V_15 -> V_88 ) )
return F_100 ( V_15 -> V_88 ) ;
...
V_37 = F_102 ( & V_21 -> V_22 , V_184 , F_92 , V_202 ,
L_15 , V_15 ) ;
if ( V_37 ) {
F_13 ( & V_21 -> V_22 , L_16 ) ;
return V_37 ;
...
V_197 = & V_15 -> V_7 ;
V_196 = F_104 ( V_197 ) ;
F_105 ( V_197 , V_21 -> V_22 . V_203 ) ;
V_196 -> V_22 . V_205 = & V_21 -> V_22 ;
V_15 -> V_21 = V_21 ;
V_15 -> V_150 = V_36 -> V_193 ;
V_15 -> V_164 = V_36 -> V_194 ;
V_15 -> V_108 = V_36 -> V_107 ;
V_15 -> V_16 = V_15 -> V_150 ? ( V_206 | V_207 ) : V_206 ;
V_197 -> V_208 = 20 ;
V_197 -> V_209 = F_87 ;
V_197 -> V_210 = F_88 ;
V_197 -> V_136 = F_86 ;
...
if ( V_37 )
goto V_216;
V_37 = F_110 ( V_196 , V_36 -> V_217 , V_36 -> V_218 ) ;
return 0 ;
V_216:
F_19 ( V_15 ) ;
F_111 ( & V_21 -> V_22 ) ;
...
static int F_112 ( struct V_34 * V_21 )
{
struct V_14 * V_15 = F_113 ( V_21 ) ;
F_19 ( V_15 ) ;
F_114 ( F_104 ( & V_15 -> V_7 ) ) ;
F_111 ( & V_21 -> V_22 ) ;
return 0 ;
}
