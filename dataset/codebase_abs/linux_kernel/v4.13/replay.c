...
int V_33 , int * V_49 , T_2 V_29 ,
T_2 V_27 )
{
struct V_19 * V_20 ;
F_18 ( V_30 , L_4 , V_10 , V_31 ) ;
if ( F_14 ( V_2 , V_30 ) >= V_2 -> V_50 )
V_2 -> V_50 = F_14 ( V_2 , V_30 ) ;
V_20 = F_39 ( sizeof( struct V_19 ) , V_51 ) ;
if ( ! V_20 )
return - V_52 ;
if ( ! V_33 )
* V_49 += F_40 ( V_32 , 8 ) ;
...
union V_23 * V_30 , const char * V_53 , int V_54 ,
unsigned long long V_34 , int V_33 , int * V_49 )
{
struct V_19 * V_20 ;
char * V_55 ;
F_18 ( V_30 , L_4 , V_10 , V_31 ) ;
...
{
int F_22 = F_47 ( V_2 , V_57 -> V_30 ) ;
int V_54 = F_48 ( V_57 -> V_54 ) ;
if ( F_49 ( V_57 -> V_58 . V_32 ) != V_54 + V_59 + 1 ||
V_57 -> type >= V_60 ||
V_54 > V_61 || V_57 -> V_53 [ V_54 ] != 0 ||
( F_22 == V_62 && F_50 ( V_57 -> V_53 , V_54 ) != V_54 ) ||
F_51 ( V_57 -> V_38 ) > V_63 ) {
F_52 ( V_2 , L_5 , F_22 == V_64 ?
L_6 : L_7 ) ;
return - V_65 ;
}
if ( F_22 != V_64 && F_22 != V_62 ) {
F_52 ( V_2 , L_8 , F_22 ) ;
return - V_65 ;
}
return 0 ;
}
static int F_53 ( struct V_1 * V_2 , struct V_66 * V_9 )
{
struct V_67 * V_68 = & V_2 -> V_16 [ V_9 -> V_17 ] ;
struct V_66 * V_69 ;
T_3 V_70 ;
int V_7 ;
if ( F_54 ( & V_9 -> V_46 , & V_68 -> V_71 ) )
return 1 ;
V_69 = F_29 ( V_9 -> V_46 . V_69 , struct V_66 , V_46 ) ;
if ( ! F_54 ( & V_69 -> V_46 , & V_68 -> V_71 ) )
return 0 ;
V_7 = F_55 ( V_2 , V_69 -> V_10 , ( char * ) & V_70 , V_69 -> V_12 , 4 , 1 ) ;
if ( V_7 )
return 0 ;
...
{
int V_72 = F_53 ( V_2 , V_4 -> V_9 ) ;
int V_7 = 0 , V_49 = 0 , V_10 = V_4 -> V_9 -> V_10 , V_31 = V_4 -> V_9 -> V_12 ;
struct V_73 * V_74 ;
struct V_75 * V_76 ;
F_6 ( L_9 ,
V_10 , V_4 -> V_9 -> V_17 , V_31 , V_72 ) ;
if ( V_2 -> V_40 && V_72 )
V_74 = F_57 ( V_2 , V_10 , V_31 , V_2 -> V_77 , V_4 -> V_9 -> V_17 ) ;
else
V_74 = F_58 ( V_2 , V_10 , V_31 , V_2 -> V_77 , 0 ) ;
if ( F_4 ( V_74 ) )
return F_5 ( V_74 ) ;
...
T_2 V_29 = F_51 ( V_93 -> V_29 ) ;
T_2 V_27 = F_51 ( V_93 -> V_27 ) ;
union V_23 V_30 ;
...
F_60 ( V_2 , & V_30 , F_49 ( V_93 -> V_38 ) ) ;
V_7 = F_38 ( V_2 , V_10 , V_76 -> V_31 , V_76 -> V_32 ,
& V_30 , V_76 -> V_34 , 1 , & V_49 ,
V_29 , V_27 ) ;
break;
}
default:
...
F_30 ( F_61 ( V_2 , V_10 ) ) ;
F_30 ( V_74 -> V_95 - V_31 >= V_49 ) ;
F_30 ( V_74 -> V_95 % V_2 -> V_96 == 0 ) ;
V_4 -> V_8 = V_74 -> V_95 - V_31 - V_49 ;
...
struct V_3 * V_4 ;
while ( ! F_66 ( & V_2 -> F_64 ) ) {
V_4 = F_29 ( V_2 -> F_64 . V_69 , struct V_3 , V_46 ) ;
F_37 ( & V_4 -> V_46 ) ;
F_35 ( V_4 ) ;
}
}
static int F_67 ( struct V_1 * V_2 , int V_10 , int V_31 , int V_17 ,
unsigned long long V_34 )
{
struct V_66 * V_9 ;
struct V_3 * V_4 ;
F_6 ( L_15 , V_10 , V_31 , V_17 ) ;
V_9 = F_44 ( sizeof( struct V_66 ) , V_51 ) ;
if ( ! V_9 )
return - V_52 ;
V_4 = F_44 ( sizeof( struct V_3 ) , V_51 ) ;
if ( ! V_4 ) {
F_35 ( V_9 ) ;
return - V_52 ;
}
...
V_4 -> V_9 = V_9 ;
V_4 -> V_34 = V_34 ;
F_42 ( & V_4 -> V_46 , & V_2 -> F_64 ) ;
return 0 ;
}
static int F_69 ( struct V_1 * V_2 , const struct V_98 * V_99 )
{
struct V_66 * V_9 ;
int V_10 = F_49 ( V_99 -> V_10 ) ;
unsigned int V_31 = F_49 ( V_99 -> V_31 ) ;
unsigned int V_17 = F_49 ( V_99 -> V_17 ) ;
...
return 1 ;
F_52 ( V_2 , L_16 , V_10 , V_31 ) ;
return - V_65 ;
}
return 0 ;
}
static int F_70 ( struct V_1 * V_2 , int V_10 , int V_31 , void * V_77 )
{
int V_7 ;
struct V_73 * V_74 ;
struct V_75 * V_76 ;
...
F_6 ( L_17 , V_10 , V_31 ) ;
V_74 = F_58 ( V_2 , V_10 , V_31 , V_77 , V_2 -> V_40 ) ;
if ( F_4 ( V_74 ) ) {
if ( F_5 ( V_74 ) != - V_104 || ! V_2 -> V_40 )
return F_5 ( V_74 ) ;
V_74 = F_71 ( V_2 , V_10 , V_31 , V_77 ) ;
if ( F_4 ( V_74 ) )
return F_5 ( V_74 ) ;
}
if ( V_74 -> V_105 == 0 ) {
...
if ( F_51 ( V_83 -> V_110 ) != V_2 -> V_110 ) {
F_52 ( V_2 , L_19 ,
V_10 , V_31 ,
( unsigned long long ) F_51 ( V_83 -> V_110 ) ,
V_2 -> V_110 ) ;
goto V_79;
}
V_2 -> V_108 = F_51 ( V_83 -> V_58 . V_34 ) ;
F_6 ( L_20 , V_2 -> V_108 ) ;
}
