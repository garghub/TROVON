...
F_56 ( * V_67 , V_19 , V_72 ,
- ( long ) V_69 . V_26 ) ;
error = F_42 ( V_67 , & V_41 , V_19 ) ;
if ( error ) {
F_44 ( & V_41 ) ;
break;
}
F_57 ( V_19 , & V_34 , & V_32 , & V_69 ) ;
}
...
F_41 ( & V_41 , & V_70 ) ;
V_77 = V_69 . V_26 ;
error = F_67 ( V_4 , V_19 , V_69 . V_35 , & V_77 , 0 , 1 ,
& V_70 , & V_41 ) ;
if ( error )
goto V_84;
if ( V_77 ) {
...
if ( error )
goto V_84;
error = F_69 ( V_4 -> V_85 , & V_41 , V_19 , & V_69 ) ;
if ( error )
goto V_84;
F_57 ( V_19 , & V_34 , & V_32 , & V_69 ) ;
error = F_42 ( & V_4 , & V_41 , V_19 ) ;
if ( error )
goto V_84;
V_83:
if ( ! F_29 ( V_30 , V_34 , & V_32 ) )
...
struct V_3 * V_4 ;
int error ;
if ( V_100 && V_98 <= F_81 ( F_82 ( V_89 ) ) && V_99 == 0 )
return 0 ;
error = F_37 ( V_2 , & F_38 ( V_2 ) -> V_90 , 0 , 0 , 0 , & V_4 ) ;
if ( error )
goto V_91;
...
while ( V_77 ) {
F_41 ( & V_41 , & V_70 ) ;
error = F_67 ( V_4 , V_19 , V_110 , & V_77 , 0 , 1 ,
& V_70 , & V_41 ) ;
if ( error )
goto V_84;
...
goto V_83;
F_95 ( V_19 , V_113 . V_35 ,
V_113 . V_26 , V_113 . V_25 ) ;
error = F_96 ( V_2 , & V_41 , & V_113 ) ;
if ( error )
goto V_84;
error = F_69 ( V_2 , & V_41 , V_19 , & V_113 ) ;
if ( error )
goto V_84;
F_56 ( V_4 , V_19 , V_72 ,
V_113 . V_26 ) ;
...
V_98 = F_98 ( T_8 , V_98 , V_111 ) ;
if ( V_98 > F_81 ( F_82 ( V_19 ) ) ) {
F_83 ( V_19 , V_98 ) ;
F_84 ( F_82 ( V_19 ) , V_98 ) ;
...
T_6 V_117 ;
while ( V_116 ) {
F_101 ( V_88 , V_115 , V_116 ,
V_89 , V_110 ) ;
V_44 = 1 ;
F_28 ( V_88 , V_53 ) ;
error = F_102 ( V_88 , V_115 , V_116 , & V_28 , & V_44 , 0 ) ;
F_30 ( V_88 , V_53 ) ;
if ( error )
goto V_118;
ASSERT ( V_44 == 1 ) ;
F_103 ( V_88 , V_115 , V_116 , V_66 ,
& V_28 ) ;
V_117 = V_28 . V_35 + V_28 . V_26 - V_115 ;
V_28 . V_35 += V_110 - V_115 ;
error = F_92 ( V_89 , & V_28 , V_110 ,
V_111 ) ;
if ( error )
goto V_118;
if ( F_104 ( V_119 ) ) {
...
bool V_100 )
{
struct V_126 * V_127 = F_107 ( V_122 ) ;
struct V_18 * V_88 = F_108 ( V_127 ) ;
struct V_126 * V_128 = F_107 ( V_124 ) ;
struct V_18 * V_89 = F_108 ( V_128 ) ;
struct V_1 * V_2 = V_88 -> V_24 ;
...
F_75 ( V_88 , V_89 , V_136 ) ;
V_133 = - V_137 ;
if ( F_111 ( V_88 ) || F_111 ( V_89 ) )
goto V_138;
if ( F_112 ( V_127 ) || F_112 ( V_128 ) )
goto V_138;
V_133 = F_113 ( V_127 , V_123 , V_128 , V_125 ,
& V_116 , V_100 ) ;
if ( V_133 <= 0 )
goto V_138;
F_114 ( V_88 , V_123 , V_116 , V_89 , V_125 ) ;
V_133 = F_74 ( V_88 , V_89 ) ;
if ( V_133 )
goto V_138;
V_131 = F_26 ( V_2 , V_125 ) ;
V_130 = F_26 ( V_2 , V_123 ) ;
V_132 = F_27 ( V_2 , V_116 ) ;
V_133 = F_100 ( V_88 , V_130 , V_89 , V_131 , V_132 ,
V_125 + V_116 ) ;
if ( V_133 )
goto V_138;
F_115 ( & V_128 -> V_139 , V_125 ,
F_116 ( V_125 + V_116 ) - 1 ) ;
V_99 = 0 ;
if ( V_123 == 0 && V_116 == F_81 ( V_127 ) &&
( V_88 -> V_93 . V_94 & V_103 ) &&
V_125 == 0 && V_116 >= F_81 ( V_128 ) &&
! ( V_89 -> V_93 . V_94 & V_103 ) )
V_99 = V_88 -> V_93 . V_102 ;
V_133 = F_80 ( V_89 , V_125 + V_116 , V_99 ,
V_100 ) ;
V_138:
F_30 ( V_88 , V_136 ) ;
if ( ! V_129 )
...
while ( V_140 - V_8 > 0 ) {
V_145 = 1 ;
error = F_102 ( V_19 , V_8 , V_140 - V_8 , V_144 , & V_145 , 0 ) ;
if ( error )
goto V_61;
if ( V_145 == 0 )
break;
...
break;
F_30 ( V_19 , V_53 ) ;
V_143 = F_97 ( V_2 , V_144 [ 1 ] . V_35 +
( V_142 - V_6 ) ) ;
V_9 = F_97 ( V_2 , V_77 ) ;
if ( V_143 + V_9 > V_141 )
V_9 = V_141 - V_143 ;
error = F_120 ( F_82 ( V_19 ) , V_143 , V_9 ,
& V_147 ) ;
F_28 ( V_19 , V_53 ) ;
if ( error )
goto V_61;
...
if ( ! F_8 ( V_19 ) )
return 0 ;
F_127 ( V_19 , V_49 , V_116 ) ;
F_128 ( F_82 ( V_19 ) ) ;
F_28 ( V_19 , V_53 ) ;
V_8 = F_26 ( V_2 , V_49 ) ;
V_141 = F_81 ( F_82 ( V_19 ) ) ;
V_140 = F_27 ( V_2 , V_49 + V_116 ) ;
error = F_119 ( V_19 , V_8 , V_140 , V_141 ) ;
if ( error )
goto V_138;
F_30 ( V_19 , V_53 ) ;
error = F_129 ( F_82 ( V_19 ) -> V_153 ) ;
if ( error )
goto V_61;
error = F_125 ( V_19 ) ;
if ( error )
