...
struct V_34 * V_35 = V_33 -> V_35 ;
T_1 V_68 ;
V_68 = F_11 ( V_69 , 0 , V_70 ) ;
if ( V_68 )
return 0 ;
V_66 = F_12 ( V_33 , F_13 ( V_69 , 0 , V_71 ) ,
...
V_77 -> V_80 = V_81 ;
V_77 -> V_77 . V_82 . V_83 = F_18 ( V_78 ) ;
V_77 -> V_77 . V_82 . V_84 = F_19 ( V_78 ) ;
...
int F_23 ( struct V_32 * V_33 , enum V_88 V_89 )
{
int V_66 = 0 ;
unsigned int V_100 = 0 ;
struct V_90 * V_91 = & V_33 -> V_92 ;
struct V_34 * V_35 = V_33 -> V_35 ;
V_100 = F_18 ( V_91 -> V_98 ) ;
F_14 ( V_69 , 0 , V_101 , V_100 ) ;
V_100 = F_19 ( V_91 -> V_98 ) ;
F_14 ( V_69 , 0 , V_102 , V_100 ) ;
V_100 = V_91 -> V_93 ;
F_14 ( V_69 , 0 , V_103 , V_100 ) ;
V_100 = V_89 ;
V_100 = V_100 << 16 ;
F_14 ( V_69 , 0 , V_104 , V_100 ) ;
F_15 ( 20 ) ;
V_66 = F_12 ( V_33 , F_13 ( V_69 , 0 , V_104 ) ,
...
V_108 = F_11 ( V_69 , 0 , V_113 ) ;
if ( ( V_108 % V_111 ) == 0 )
V_110 = V_91 -> V_99 ;
else
V_110 = V_91 -> V_99 + ( V_108 / V_112 ) ;
memset ( V_110 , 0 , sizeof( struct V_109 ) ) ;
V_110 -> V_114 = F_19 ( V_105 ) ;
V_110 -> V_115 = F_18 ( V_105 ) ;
V_110 -> V_116 = F_19 ( V_106 ) ;
V_110 -> V_117 = F_18 ( V_106 ) ;
V_110 -> V_118 = V_107 ;
V_108 = ( V_108 + V_112 ) % V_111 ;
F_14 ( V_69 , 0 , V_113 , V_108 ) ;
return 0 ;
}
static int
...
case V_9 :
* V_119 = 0x0 ;
* V_120 = F_13 ( V_123 , 0 , V_124 ) ;
* V_121 = F_13 ( V_123 , 0 , V_125 ) ;
break;
case V_11 :
* V_119 = 0x0 ;
* V_120 = F_13 ( V_123 , 0 , V_126 ) ;
* V_121 = F_13 ( V_123 , 0 , V_127 ) ;
break;
case V_13 :
* V_119 = 0x0 ;
* V_120 = F_13 ( V_123 , 0 , V_128 ) ;
* V_121 = F_13 ( V_123 , 0 , V_129 ) ;
break;
case V_15 :
* V_119 = 0x10000 ;
* V_120 = F_13 ( V_123 , 0 , V_130 ) ;
* V_121 = F_13 ( V_123 , 0 , V_131 ) ;
break;
case V_19 :
* V_119 = 0x10000 ;
* V_120 = F_13 ( V_123 , 0 , V_132 ) ;
* V_121 = F_13 ( V_123 , 0 , V_133 ) ;
break;
case V_22 :
* V_119 = 0x2000 ;
* V_120 = F_13 ( V_123 , 0 , V_134 ) ;
* V_121 = F_13 ( V_123 , 0 , V_135 ) ;
break;
case V_5 :
* V_119 = 0x0 ;
* V_120 = F_13 ( V_136 , 0 , V_137 ) ;
* V_121 = F_13 ( V_136 , 0 , V_138 ) ;
break;
#if 0
...
bool F_31 ( struct V_32 * V_33 )
{
struct V_34 * V_35 = V_33 -> V_35 ;
T_1 V_145 ;
V_145 = V_146 | 0x03b00000 ;
F_14 ( V_147 , 0 , V_148 , V_145 ) ;
V_145 = F_11 ( V_147 , 0 , V_149 ) ;
