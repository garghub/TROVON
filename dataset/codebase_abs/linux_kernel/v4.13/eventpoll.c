...
static struct V_14 * F_106 ( struct V_25 * V_26 , int V_118 , unsigned long V_119 )
{
struct V_84 * V_85 ;
struct V_14 * V_18 ;
for ( V_85 = F_80 ( & V_26 -> V_81 ) ; V_85 ; V_85 = F_81 ( V_85 ) ) {
V_18 = F_82 ( V_85 , struct V_14 , V_80 ) ;
if ( V_18 -> V_6 . V_7 == V_118 ) {
if ( V_119 == 0 )
return V_18 ;
else
V_119 -- ;
...
struct V_1 * F_107 ( struct V_1 * V_1 , int V_118 ,
unsigned long V_119 )
{
struct V_1 * V_120 ;
struct V_25 * V_26 ;
...
static int F_109 ( T_1 * V_13 , unsigned V_123 , int V_124 , void * V_125 )
{
int V_68 = 0 ;
unsigned long V_44 ;
...
F_27 ( & V_26 -> V_24 , V_44 ) ;
F_23 ( V_18 ) ;
if ( ! ( V_18 -> V_90 . V_52 & ~ V_127 ) )
goto V_49;
if ( V_125 && ! ( ( unsigned long ) V_125 & V_18 -> V_90 . V_52 ) )
goto V_49;
...
switch ( ( unsigned long ) V_125 & V_130 ) {
case V_54 :
if ( V_18 -> V_90 . V_52 & V_54 )
V_126 = 1 ;
break;
case V_131 :
if ( V_18 -> V_90 . V_52 & V_131 )
V_126 = 1 ;
break;
case 0 :
V_126 = 1 ;
...
struct V_12 * V_59 ;
if ( V_18 -> V_133 >= 0 && ( V_59 = F_111 ( V_62 , V_112 ) ) ) {
...
{
int V_114 ;
struct V_84 * * V_11 = & V_26 -> V_81 . V_84 , * V_134 = NULL ;
struct V_14 * V_135 ;
while ( * V_11 ) {
V_134 = * V_11 ;
V_135 = F_82 ( V_134 , struct V_14 , V_80 ) ;
V_114 = F_3 ( & V_18 -> V_6 , & V_135 -> V_6 ) ;
if ( V_114 > 0 )
V_11 = & V_134 -> V_116 ;
else
V_11 = & V_134 -> V_117 ;
}
F_116 ( & V_18 -> V_80 , V_134 , V_11 ) ;
F_117 ( & V_18 -> V_80 , & V_26 -> V_81 ) ;
}
static int F_118 ( int V_136 )
{
if ( V_136 == 0 )
return 0 ;
...
V_146 = V_18 -> V_6 . V_1 -> V_147 . V_148 -> V_149 . V_146 ;
V_64 = F_125 ( V_146 ) ;
if ( ! V_64 )
return - V_111 ;
...
static int F_130 ( struct V_25 * V_26 , struct V_150 * V_90 ,
struct V_1 * V_151 , int V_7 , int V_152 )
{
int error , V_153 , V_68 = 0 ;
unsigned long V_44 ;
long V_154 ;
struct V_14 * V_18 ;
struct V_16 V_155 ;
V_154 = F_131 ( & V_26 -> V_82 -> V_83 ) ;
if ( F_102 ( V_154 >= V_156 ) )
return - V_157 ;
...
F_12 ( & V_18 -> V_61 ) ;
V_18 -> V_26 = V_26 ;
F_2 ( & V_18 -> V_6 , V_151 , V_7 ) ;
V_18 -> V_90 = * V_90 ;
V_18 -> V_133 = 0 ;
V_18 -> V_71 = V_29 ;
if ( V_18 -> V_90 . V_52 & V_158 ) {
error = F_124 ( V_18 ) ;
if ( error )
goto V_159;
} else {
...
V_155 . V_18 = V_18 ;
F_90 ( & V_155 . V_17 , V_99 ) ;
V_153 = F_88 ( V_18 , & V_155 . V_17 ) ;
error = - V_111 ;
if ( V_18 -> V_133 < 0 )
goto V_160;
F_70 ( & V_151 -> V_78 ) ;
F_132 ( & V_18 -> V_79 , & V_151 -> V_142 ) ;
F_72 ( & V_151 -> V_78 ) ;
F_115 ( V_26 , V_18 ) ;
error = - V_121 ;
if ( V_152 && F_123 () )
...
F_27 ( & V_26 -> V_24 , V_44 ) ;
F_23 ( V_18 ) ;
if ( ( V_153 & V_90 -> V_52 ) && ! F_4 ( & V_18 -> V_72 ) ) {
F_62 ( & V_18 -> V_72 , & V_26 -> V_27 ) ;
F_51 ( V_18 ) ;
if ( F_65 ( & V_26 -> V_55 ) )
F_66 ( & V_26 -> V_55 ) ;
...
static int F_134 ( struct V_25 * V_26 , struct V_14 * V_18 , struct V_150 * V_90 )
{
int V_68 = 0 ;
unsigned int V_153 ;
T_2 V_17 ;
...
void * V_40 )
{
struct V_162 * V_163 = V_40 ;
int V_164 ;
unsigned int V_153 ;
struct V_14 * V_18 ;
struct V_150 T_5 * V_165 ;
struct V_63 * V_64 ;
T_2 V_17 ;
F_90 ( & V_17 , NULL ) ;
for ( V_164 = 0 , V_165 = V_163 -> V_52 ;
! F_5 ( V_75 ) && V_164 < V_163 -> V_166 ; ) {
...
V_153 = F_88 ( V_18 , & V_17 ) ;
if ( V_153 ) {
if ( F_139 ( V_153 , & V_165 -> V_52 ) ||
F_139 ( V_18 -> V_90 . V_104 , & V_165 -> V_104 ) ) {
F_29 ( & V_18 -> V_72 , V_75 ) ;
F_51 ( V_18 ) ;
return V_164 ? V_164 : - V_168 ;
}
V_164 ++ ;
V_165 ++ ;
if ( V_18 -> V_90 . V_52 & V_169 )
V_18 -> V_90 . V_52 &= V_127 ;
else if ( ! ( V_18 -> V_90 . V_52 & V_170 ) ) {
F_62 ( & V_18 -> V_72 , & V_26 -> V_27 ) ;
F_51 ( V_18 ) ;
}
}
...
struct V_150 T_5 * V_52 , int V_166 )
{
struct V_162 V_163 ;
V_163 . V_166 = V_166 ;
V_163 . V_52 = V_52 ;
return F_57 ( V_26 , F_138 , & V_163 , 0 , false ) ;
}
static inline struct V_171 F_141 ( long V_172 )
{
struct V_171 V_173 , V_174 = {
. V_175 = V_172 / V_176 ,
. V_177 = V_178 * ( V_172 % V_176 ) ,
} ;
F_142 ( & V_173 ) ;
return F_143 ( V_173 , V_174 ) ;
}
static int F_144 ( struct V_25 * V_26 , struct V_150 T_5 * V_52 ,
int V_166 , long V_179 )
{
int V_180 = 0 , V_181 , V_182 = 0 ;
unsigned long V_44 ;
T_6 V_183 = 0 ;
T_1 V_13 ;
T_7 V_184 , * V_185 = NULL ;
if ( V_179 > 0 ) {
struct V_171 V_186 = F_141 ( V_179 ) ;
V_183 = F_145 ( & V_186 ) ;
V_185 = & V_184 ;
* V_185 = F_146 ( V_186 ) ;
} else if ( V_179 == 0 ) {
...
F_30 ( & V_26 -> V_24 , V_44 ) ;
if ( ! V_180 && V_181 &&
! ( V_180 = F_140 ( V_26 , V_52 , V_166 ) ) && ! V_182 )
goto V_188;
return V_180 ;
}
...
V_26 -> V_194 = 1 ;
F_29 ( & V_26 -> V_195 , & V_196 ) ;
for ( V_85 = F_80 ( & V_26 -> V_81 ) ; V_85 ; V_85 = F_81 ( V_85 ) ) {
V_18 = F_82 ( V_85 , struct V_14 , V_80 ) ;
if ( F_102 ( F_1 ( V_18 -> V_6 . V_1 ) ) ) {
V_193 = V_18 -> V_6 . V_1 -> V_88 ;
if ( V_193 -> V_194 )
continue;
error = F_25 ( & V_143 , V_58 ,
F_155 , V_18 -> V_6 . V_1 ,
...
if ( F_5 ( & V_18 -> V_6 . V_1 -> V_197 ) )
F_29 ( & V_18 -> V_6 . V_1 -> V_197 ,
& V_198 ) ;
}
}
F_67 ( & V_26 -> V_65 ) ;
...
{
int V_199 ;
struct V_25 * V_200 , * V_201 ;
V_199 = F_25 ( & V_143 , V_58 ,
...
struct V_202 V_203 ;
F_159 ( & V_203 ) ;
V_156 = ( ( ( V_203 . V_204 - V_203 . V_205 ) / 25 ) << V_206 ) /
V_207 ;
F_160 ( V_156 < 0 ) ;
F_11 ( & V_143 ) ;
F_11 ( & V_57 ) ;
...
0 , V_208 | V_209 , NULL ) ;
V_62 = F_162 ( L_7 ,
sizeof( struct V_12 ) , 0 , V_209 , NULL ) ;
return 0 ;
}
