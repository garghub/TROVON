...
V_4 -> V_19 = V_5 ;
F_6 ( & V_4 -> V_20 ) ;
V_6 = V_4 -> V_19 + ( 16 * V_15 ) / sizeof( T_2 ) ;
for (; V_5 < V_6 ; V_5 ++ )
F_7 ( 0 , V_5 ) ;
}
...
for ( V_28 = 0 ; V_28 < V_29 ; V_28 ++ , V_31 = F_19 ( F_20 ( V_31 ) + 0x100 ) , V_30 ++ ) {
F_21 ( V_30 , V_4 -> V_36 ) ;
F_7 ( F_20 ( V_31 ) , & V_4 -> V_19 [ V_30 ] ) ;
}
F_13 ( ( L_7 , V_24 ) ) ;
return V_24 ;
}
static T_4 F_22 ( struct V_38 * V_16 , char * V_24 , unsigned long V_39 )
{
...
static void F_25 ( struct V_38 * V_16 , struct V_42 * V_43 , int V_44 )
{
struct V_3 * V_4 = V_16 -> V_17 . V_18 ;
unsigned long V_41 ;
F_23 ( & V_4 -> V_20 , V_41 ) ;
while ( V_44 != 0 ) {
-- V_44 ;
V_43 -> V_45 = F_12 ( V_4 , ( unsigned long ) F_26 ( V_43 ) , V_43 -> V_46 ) ;
V_43 -> V_47 = V_43 -> V_46 ;
V_43 = F_27 ( V_43 ) ;
}
F_24 ( & V_4 -> V_20 , V_41 ) ;
}
static void F_28 ( struct V_38 * V_16 , T_4 V_24 , unsigned long V_39 )
{
struct V_3 * V_4 = V_16 -> V_17 . V_18 ;
unsigned long V_41 ;
F_23 ( & V_4 -> V_20 , V_41 ) ;
...
static void F_30 ( struct V_38 * V_16 , struct V_42 * V_43 , int V_44 )
{
struct V_3 * V_4 = V_16 -> V_17 . V_18 ;
unsigned long V_41 ;
...
static int F_31 ( struct V_38 * V_16 , T_5 * V_48 , unsigned long V_49 , unsigned long V_50 , int V_39 )
{
struct V_3 * V_4 = V_16 -> V_17 . V_18 ;
...
V_58 = F_35 ( V_57 , V_50 ) ;
V_59 = F_36 ( V_58 , V_50 ) ;
F_37 ( V_59 , F_38 ( F_39 ( V_51 ) , V_53 ) ) ;
V_26 = ( ( V_50 - V_37 ) >> V_33 ) ;
V_31 = V_4 -> V_19 + V_26 ;
F_7 ( F_20 ( F_17 ( F_18 ( V_51 ) ) ) , V_31 ) ;
}
V_50 += V_15 ;
V_49 += V_15 ;
}
...
static void F_42 ( struct V_38 * V_16 , unsigned long V_50 , int V_39 )
{
}
void T_1 F_43 ( void )
{
