...
static int F_87 ( struct V_270 * V_271 ,
struct V_14 * V_15 )
{
struct V_3 * V_4 = NULL ;
int V_272 ;
...
V_4 = F_88 ( sizeof( struct V_3 ) , V_279 ) ;
if ( V_4 == NULL ) {
F_8 ( & V_271 -> V_2 ,
L_20 ) ;
V_6 = - V_261 ;
...
static int F_102 ( struct V_270 * V_271 , T_7 V_295 )
{
struct V_3 * V_4 = F_100 ( V_271 ) ;
if ( V_4 != NULL )
...
static int T_8 F_104 ( char * V_296 )
{
char * V_297 = NULL ;
int V_6 = 0 ;
F_105 ( L_29 , V_296 ) ;
if ( ! V_296 || ! * V_296 )
return 0 ;
while ( ! V_6 && ( V_297 = F_106 ( & V_296 , L_30 ) ) != NULL ) {
if ( ! strncmp ( V_297 , L_31 , 5 ) )
V_258 = 1 ;
else if ( ! strncmp ( V_297 , L_32 , 5 ) ) {
char * V_298 ;
unsigned long V_276 ;
V_276 = ( F_107 ( V_297 + 5 , & V_298 , 0 ) ) ;
switch ( V_298 [ 0 ] ) {
case '\0' :
break;
case 'm' :
...
V_18 = F_107 ( V_297 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_297 , L_35 , 6 ) )
V_19 = F_107 ( V_297 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_297 , L_36 , 7 ) )
V_260 = ( F_107 ( V_297 + 7 , NULL , 0 ) ) ;
else if ( ! strncmp ( V_297 , L_37 , 7 ) )
V_262 = ( F_107 ( V_297 + 7 , NULL , 0 ) ) ;
