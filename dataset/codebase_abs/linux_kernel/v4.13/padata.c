...
V_2 = F_20 ( V_22 -> V_2 ) ;
V_24 = - V_26 ;
if ( ! ( V_22 -> V_27 & V_28 ) || V_22 -> V_27 & V_29 )
goto V_30;
...
F_11 ( & V_25 -> V_15 . V_16 ) ;
F_25 ( & V_19 -> V_17 , & V_25 -> V_15 . V_17 ) ;
F_13 ( & V_25 -> V_15 . V_16 ) ;
F_26 ( V_5 , V_22 -> V_36 , & V_25 -> V_14 ) ;
V_30:
F_27 () ;
return V_24 ;
}
...
F_11 ( & V_48 -> V_50 . V_16 ) ;
F_25 ( & V_19 -> V_17 , & V_48 -> V_50 . V_17 ) ;
F_13 ( & V_48 -> V_50 . V_16 ) ;
F_26 ( V_23 , V_22 -> V_36 , & V_48 -> V_14 ) ;
}
F_36 ( & V_2 -> V_16 ) ;
if ( F_22 ( & V_2 -> V_44 )
&& ! ( V_22 -> V_27 & V_33 ) )
...
F_8 ( V_13 ) ;
F_9 () ;
V_48 = F_10 ( V_54 , struct V_47 , V_14 ) ;
V_2 = V_48 -> V_2 ;
F_11 ( & V_48 -> V_50 . V_16 ) ;
F_12 ( & V_48 -> V_50 . V_17 , & V_13 ) ;
F_13 ( & V_48 -> V_50 . V_16 ) ;
while ( ! F_14 ( & V_13 ) ) {
struct V_18 * V_19 ;
V_19 = F_15 ( V_13 . V_20 ,
...
static struct V_1 * F_55 ( struct V_21 * V_22 ,
const struct V_6 * V_55 ,
const struct V_6 * V_56 )
{
struct V_1 * V_2 ;
...
struct V_71 * V_72 )
{
return F_76 ( & V_22 -> V_70 ,
V_72 ) ;
}
int F_77 ( struct V_21 * V_22 ,
struct V_71 * V_72 )
{
return F_78 (
& V_22 -> V_70 ,
...
static bool F_79 ( struct V_21 * V_22 ,
...
F_67 ( V_22 ) ;
V_74:
V_2 = F_55 ( V_22 , V_55 , V_56 ) ;
if ( ! V_2 )
return - V_58 ;
F_82 ( V_22 -> V_6 . V_7 , V_55 ) ;
F_82 ( V_22 -> V_6 . V_31 , V_56 ) ;
F_71 ( V_22 , V_2 ) ;
if ( V_73 )
F_66 ( V_22 ) ;
return 0 ;
}
int F_83 ( struct V_21 * V_22 , int V_75 ,
T_1 V_6 )
{
...
static int F_88 ( struct V_21 * V_22 , int V_4 )
{
struct V_1 * V_2 ;
if ( F_21 ( V_4 , V_59 ) ) {
V_2 = F_55 ( V_22 , V_22 -> V_6 . V_7 ,
V_22 -> V_6 . V_31 ) ;
if ( ! V_2 )
return - V_58 ;
F_71 ( V_22 , V_2 ) ;
if ( F_79 ( V_22 , V_22 -> V_6 . V_7 ) &&
F_79 ( V_22 , V_22 -> V_6 . V_31 ) )
F_66 ( V_22 ) ;
}
return 0 ;
}
static int F_89 ( struct V_21 * V_22 , int V_4 )
{
struct V_1 * V_2 = NULL ;
if ( F_21 ( V_4 , V_59 ) ) {
if ( ! F_79 ( V_22 , V_22 -> V_6 . V_7 ) ||
...
int F_91 ( struct V_21 * V_22 , int V_4 , int V_78 )
{
int V_24 ;
if ( ! ( V_78 & ( V_69 | V_68 ) ) )
return - V_26 ;
...
F_69 () ;
if ( V_78 & V_69 )
F_90 ( V_4 , V_22 -> V_6 . V_31 ) ;
if ( V_78 & V_68 )
F_90 ( V_4 , V_22 -> V_6 . V_7 ) ;
V_24 = F_89 ( V_22 , V_4 ) ;
F_70 () ;
F_85 ( & V_22 -> V_16 ) ;
return V_24 ;
}
static inline int F_92 ( struct V_21 * V_22 , int V_4 )
{
return F_21 ( V_4 , V_22 -> V_6 . V_7 ) ||
F_21 ( V_4 , V_22 -> V_6 . V_31 ) ;
}
static int F_93 ( unsigned int V_4 , struct V_79 * V_80 )
{
struct V_21 * V_22 ;
int V_81 ;
V_22 = F_94 ( V_80 , struct V_21 , V_80 ) ;
if ( ! F_92 ( V_22 , V_4 ) )
return 0 ;
F_84 ( & V_22 -> V_16 ) ;
V_81 = F_88 ( V_22 , V_4 ) ;
...
{
struct V_21 * V_22 = F_100 ( V_84 ) ;
F_96 ( V_22 ) ;
}
static T_2 F_101 ( struct V_21 * V_22 ,
...
static T_2 F_103 ( struct V_21 * V_22 ,
struct V_85 * V_86 ,
...
V_97 = F_106 ( V_86 ) ;
if ( V_97 -> V_99 )
V_81 = V_97 -> V_100 ( V_22 , V_86 , V_87 , V_92 ) ;
return V_81 ;
}
static struct V_21 * F_108 ( struct V_101 * V_36 ,
const struct V_6 * V_55 ,
const struct V_6 * V_56 )
{
struct V_21 * V_22 ;
struct V_1 * V_2 = NULL ;
V_22 = F_56 ( sizeof( struct V_21 ) , V_57 ) ;
if ( ! V_22 )
goto V_24;
if ( ! F_44 ( & V_22 -> V_6 . V_7 , V_57 ) )
goto V_102;
if ( ! F_44 ( & V_22 -> V_6 . V_31 , V_57 ) ) {
F_46 ( V_22 -> V_6 . V_7 ) ;
goto V_102;
}
if ( ! F_79 ( V_22 , V_55 ) ||
...
V_22 -> V_27 = 0 ;
F_109 ( & V_22 -> V_70 ) ;
F_110 ( & V_22 -> V_84 , & V_104 ) ;
F_111 ( & V_22 -> V_16 ) ;
#ifdef F_97
F_112 ( V_82 , & V_22 -> V_80 ) ;
#endif
return V_22 ;
V_103:
F_46 ( V_22 -> V_6 . V_7 ) ;
...
struct V_21 * F_113 ( struct V_101 * V_36 )
{
F_114 () ;
return F_108 ( V_36 , V_105 , V_105 ) ;
}
void F_115 ( struct V_21 * V_22 )
{
F_116 ( & V_22 -> V_84 ) ;
}
static T_4 int F_117 ( void )
{
int V_81 ;
V_81 = F_118 ( V_106 , L_3 ,
F_93 ,
F_95 ) ;
if ( V_81 < 0 )
return V_81 ;
