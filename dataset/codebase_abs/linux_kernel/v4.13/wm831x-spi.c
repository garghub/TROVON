...
type = (enum V_11 ) V_9 -> V_16 ;
} else {
type = (enum V_11 ) V_7 -> V_17 ;
}
V_10 = F_6 ( & V_2 -> V_5 , sizeof( struct V_10 ) , V_18 ) ;
if ( V_10 == NULL )
return - V_19 ;
V_2 -> V_20 = V_21 ;
F_7 ( V_2 , V_10 ) ;
...
static int F_15 ( struct V_25 * V_5 )
{
struct V_10 * V_10 = F_16 ( V_5 ) ;
return F_17 ( V_10 ) ;
}
static int F_18 ( struct V_25 * V_5 )
{
struct V_10 * V_10 = F_16 ( V_5 ) ;
F_19 ( V_10 ) ;
return 0 ;
