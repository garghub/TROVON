...
static int F_48 ( struct V_110 * V_110 , struct V_111 * V_111 )
{
return F_49 ( V_111 , F_44 , V_110 -> V_112 ) ;
}
...
struct V_41 * V_42 ;
V_42 = V_40 -> V_43 ;
memcpy ( V_40 -> V_119 , V_19 -> V_86 . V_120 , V_121 ) ;
if ( ( V_19 -> V_86 . V_78 [ 0 ] == V_122 ) &&
( F_58 ( V_19 -> V_86 . V_123 ) == V_124 ) &&
( V_19 -> V_86 . V_125 == V_126 ) )
return;
V_6 = (struct V_5 * ) V_42 -> V_44 -> V_45 ;
F_27 (vdisk, devdata, scsidev) {
if ( F_28 ( & V_68 -> V_69 ) < V_70 ) {
...
static int F_59 ( unsigned char * V_127 ,
T_4 V_128 , bool V_129 )
{
if ( ! V_127 || V_128 < V_130 )
return - V_118 ;
memset ( V_127 , 0 , V_130 ) ;
V_127 [ 2 ] = V_131 ;
if ( V_129 ) {
V_127 [ 0 ] = V_132 ;
V_127 [ 3 ] = V_133 ;
...
V_42 = V_40 -> V_43 ;
if ( ( V_19 -> V_86 . V_78 [ 0 ] == V_122 ) &&
( V_19 -> V_86 . V_90 >= V_138 ) ) {
if ( V_19 -> V_86 . V_139 == 0 )
return;
V_127 = F_61 ( sizeof( char ) * 36 , V_29 ) ;
if ( ! V_127 )
return;
F_59 ( V_127 , ( T_4 ) V_19 -> V_86 . V_90 ,
V_42 -> V_55 == 0 ) ;
if ( F_38 ( V_40 ) == 0 ) {
memcpy ( F_39 ( V_40 ) , V_127 ,
V_19 -> V_86 . V_90 ) ;
F_43 ( V_127 ) ;
return;
}
...
V_136 = F_62 ( F_63 ( V_82 + V_80 ) ) ;
V_135 = ( void * ) ( ( unsigned long ) V_136 |
V_82 [ V_80 ] . V_140 ) ;
memcpy ( V_135 , V_127 + V_137 , V_82 [ V_80 ] . V_95 ) ;
F_64 ( V_136 ) ;
}
F_43 ( V_127 ) ;
} else {
...
const int V_143 = sizeof( * V_19 ) ;
V_19 = F_71 ( V_143 , V_144 ) ;
if ( ! V_19 )
return - V_145 ;
while ( 1 ) {
if ( F_72 () )
...
static int F_74 ( struct V_149 * V_58 ,
T_5 V_150 )
{
...
static int F_76 ( struct V_149 * V_58 ,
T_5 V_150 )
{
struct V_5 * V_6 ;
V_6 = F_75 ( & V_58 -> V_43 ) ;
...
if ( V_6 -> V_49 && ! V_6 -> V_50 )
V_6 -> V_50 = true ;
V_6 -> V_116 = F_1 ( F_70 , V_6 ,
L_19 ) ;
V_6 -> V_49 = false ;
V_6 -> V_50 = false ;
return 0 ;
}
static int F_77 ( struct V_149 * V_58 )
{
struct V_75 * V_79 ;
struct V_151 V_152 ;
struct V_5 * V_6 = NULL ;
...
if ( ! V_79 )
return - V_157 ;
V_154 = F_79 ( struct V_158 , V_159 . V_152 ) ;
V_153 = F_80 ( V_58 , V_154 , & V_152 ,
sizeof( struct V_151 ) ) ;
if ( V_153 < 0 )
goto V_160;
V_79 -> V_161 = ( unsigned int ) V_152 . V_161 ;
V_79 -> V_162 = ( unsigned int ) V_152 . V_162 ;
V_79 -> V_163 = ( unsigned int ) V_152 . V_163 ;
V_79 -> V_164 =
( unsigned short ) ( V_152 . V_165 >> 9 ) ;
V_79 -> V_166 =
( unsigned short ) ( V_152 . V_165 / V_167 ) ;
if ( V_79 -> V_166 > V_92 )
V_79 -> V_166 = V_92 ;
V_153 = F_81 ( V_79 , & V_58 -> V_43 ) ;
if ( V_153 < 0 )
goto V_160;
V_6 = (struct V_5 * ) V_79 -> V_45 ;
V_6 -> V_58 = V_58 ;
F_82 ( & V_58 -> V_43 , V_6 ) ;
V_6 -> V_168 = F_83 ( F_84 ( & V_58 -> V_43 ) ,
V_169 ) ;
if ( ! V_6 -> V_168 ) {
V_153 = - V_145 ;
goto V_170;
...
V_6 -> V_50 = false ;
V_6 -> V_79 = V_79 ;
V_154 = F_79 ( struct V_158 ,
V_174 . V_155 ) ;
V_153 = F_80 ( V_58 , V_154 , & V_155 , 8 ) ;
if ( V_153 )
goto V_175;
V_155 |= V_176 ;
V_153 = F_87 ( V_58 , V_154 , & V_155 , 8 ) ;
if ( V_153 )
goto V_175;
F_88 ( & V_6 -> V_24 ) ;
V_6 -> V_148 = 2 ;
...
static void F_94 ( struct V_149 * V_58 )
{
struct V_5 * V_6 = F_75 ( & V_58 -> V_43 ) ;
