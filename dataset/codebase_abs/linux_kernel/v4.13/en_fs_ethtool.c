...
struct V_108 * V_98 ;
int V_115 = 0 ;
V_114 = F_26 ( sizeof( * V_114 ) , V_116 ) ;
if ( ! V_114 )
return F_4 ( - V_117 ) ;
V_115 = F_15 ( V_114 -> V_107 , V_114 -> V_118 ,
V_8 ) ;
if ( V_115 )
goto free;
if ( V_8 -> V_119 == V_120 ) {
...
V_110 = F_27 ( sizeof( * V_110 ) , V_116 ) ;
if ( ! V_110 ) {
V_115 = - V_117 ;
goto free;
}
V_110 -> type = V_123 ;
V_110 -> V_124 = V_6 -> V_125 [ V_8 -> V_119 ] . V_126 ;
V_112 . V_121 = V_127 ;
}
V_114 -> V_128 = ( ! F_23 ( V_114 -> V_107 ) ) ;
V_112 . V_129 = V_130 ;
V_98 = F_28 ( V_4 , V_114 , & V_112 , V_110 , V_110 ? 1 : 0 ) ;
if ( F_10 ( V_98 ) ) {
V_115 = F_29 ( V_98 ) ;
F_30 ( V_6 -> V_131 , L_1 ,
V_132 , V_115 ) ;
...
if ( V_8 -> V_104 >= V_134 )
return - V_30 ;
if ( V_8 -> V_119 >= V_6 -> V_135 . V_136 . V_137 &&
V_8 -> V_119 != V_120 )
return - V_30 ;
switch ( V_8 -> V_16 & ~ ( V_17 | V_18 ) ) {
case V_26 :
...
case V_25 :
V_64 = & V_8 -> V_69 . V_83 ;
if ( V_64 -> V_139 || V_64 -> V_138 || V_64 -> V_140 ||
V_8 -> V_71 . V_83 . V_141 != V_142 )
return - V_30 ;
if ( V_64 -> V_72 ) {
if ( ! F_39 ( V_64 -> V_72 ) )
return - V_30 ;
...
int F_44 ( struct V_5 * V_6 , struct V_148 * V_149 ,
int V_104 )
{
struct V_97 * V_133 ;
...
V_149 -> V_8 = V_133 -> V_103 ;
return 0 ;
}
}
return - V_146 ;
}
int F_45 ( struct V_5 * V_6 , struct V_148 * V_149 ,
V_34 * V_150 )
{
int V_104 = 0 ;
int V_151 = 0 ;
int V_115 = 0 ;
V_149 -> V_152 = V_134 ;
while ( ( ! V_115 || V_115 == - V_146 ) && V_151 < V_149 -> V_153 ) {
V_115 = F_44 ( V_6 , V_149 , V_104 ) ;
if ( ! V_115 )
V_150 [ V_151 ++ ] = V_104 ;
V_104 ++ ;
}
