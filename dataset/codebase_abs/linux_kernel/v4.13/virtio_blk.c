...
if ( V_67 -> V_90 && F_38 ( V_32 -> V_61 [ V_57 ] . V_10 ) )
V_72 = true ;
F_26 ( & V_32 -> V_61 [ V_57 ] . V_62 , V_59 ) ;
if ( V_72 )
F_39 ( V_32 -> V_61 [ V_57 ] . V_10 ) ;
return V_5 ;
}
static int F_40 ( struct V_45 * V_46 , char * V_91 )
{
struct V_31 * V_32 = V_46 -> V_48 ;
struct V_92 * V_33 = V_32 -> V_46 -> V_63 ;
struct V_29 * V_30 ;
int V_71 ;
V_30 = F_41 ( V_33 , V_80 , V_93 ) ;
if ( F_42 ( V_30 ) )
return F_43 ( V_30 ) ;
V_71 = F_44 ( V_33 , V_30 , V_91 , V_94 , V_93 ) ;
if ( V_71 )
goto V_95;
F_45 ( V_32 -> V_46 -> V_63 , V_32 -> V_46 , V_30 , false ) ;
V_71 = F_46 ( F_1 ( F_7 ( V_30 ) ) ) ;
V_95:
F_47 ( V_30 ) ;
return V_71 ;
}
static int F_48 ( struct V_41 * V_67 , struct V_96 * V_97 )
{
struct V_31 * V_32 = V_67 -> V_47 -> V_48 ;
if ( F_10 ( V_32 -> V_24 , V_98 ) ) {
F_49 ( V_32 -> V_24 , struct V_99 ,
...
V_97 -> V_102 = 1 << 6 ;
V_97 -> V_103 = 1 << 5 ;
V_97 -> V_101 = F_50 ( V_67 -> V_47 ) >> 11 ;
}
return 0 ;
}
static int F_51 ( int V_58 )
{
return V_58 << V_104 ;
}
static int F_52 ( int V_105 )
{
return V_105 >> V_104 ;
}
static T_4 F_53 ( struct V_106 * V_107 ,
struct V_108 * V_109 , char * V_110 )
{
struct V_45 * V_46 = F_54 ( V_107 ) ;
int V_71 ;
F_55 ( V_111 < V_94 ) ;
V_110 [ V_94 ] = '\0' ;
V_71 = F_40 ( V_46 , V_110 ) ;
if ( ! V_71 )
return strlen ( V_110 ) ;
if ( V_71 == - V_52 )
return 0 ;
...
T_5 V_120 ;
F_49 ( V_24 , struct V_99 , V_120 , & V_120 ) ;
if ( ( V_121 ) V_120 != V_120 ) {
F_58 ( & V_24 -> V_107 , L_2 ,
( unsigned long long ) V_120 ) ;
V_120 = ( V_121 ) - 1 ;
}
V_119 = F_59 ( V_120 , F_60 ( V_33 ) >> 9 ) ;
F_61 ( V_119 , F_60 ( V_33 ) ,
...
V_117 ,
V_116 ) ;
F_63 ( V_32 -> V_46 , V_120 ) ;
F_64 ( V_32 -> V_46 ) ;
F_65 ( & F_66 ( V_32 -> V_46 ) -> V_124 , V_125 , V_118 ) ;
}
static void F_67 ( struct V_115 * V_24 )
{
struct V_31 * V_32 = V_24 -> V_55 ;
F_68 ( V_126 , & V_32 -> V_114 ) ;
}
...
V_71 = F_70 ( V_24 , V_133 ,
struct V_99 , V_134 ,
& V_130 ) ;
if ( V_71 )
V_130 = 1 ;
V_32 -> V_61 = F_71 ( V_130 , sizeof( * V_32 -> V_61 ) , V_93 ) ;
if ( ! V_32 -> V_61 )
return - V_87 ;
V_129 = F_71 ( V_130 , sizeof( * V_129 ) , V_93 ) ;
V_128 = F_71 ( V_130 , sizeof( * V_128 ) , V_93 ) ;
V_61 = F_71 ( V_130 , sizeof( * V_61 ) , V_93 ) ;
if ( ! V_129 || ! V_128 || ! V_61 ) {
V_71 = - V_87 ;
goto V_95;
}
...
V_71 = F_72 ( V_24 , V_130 , V_61 , V_128 , V_129 , & V_132 ) ;
if ( V_71 )
goto V_95;
for ( V_127 = 0 ; V_127 < V_130 ; V_127 ++ ) {
F_73 ( & V_32 -> V_61 [ V_127 ] . V_62 ) ;
...
static int F_75 ( char * V_137 , int V_58 , char * V_110 , int V_138 )
{
...
static int F_76 ( struct V_115 * V_24 )
{
T_7 V_145 ;
int V_71 ;
V_71 = F_70 ( V_24 , V_146 ,
struct V_99 , V_147 ,
& V_145 ) ;
if ( V_71 )
...
static void F_77 ( struct V_115 * V_24 )
{
T_7 V_145 = F_76 ( V_24 ) ;
struct V_31 * V_32 = V_24 -> V_55 ;
F_78 ( V_32 -> V_46 -> V_63 , V_145 , false ) ;
F_64 ( V_32 -> V_46 ) ;
}
static T_4
F_79 ( struct V_106 * V_107 , struct V_108 * V_109 ,
...
V_127 = F_80 ( V_150 , V_110 ) ;
if ( V_127 < 0 )
return V_127 ;
F_81 ( V_24 , F_82 ( struct V_99 , V_147 ) , V_127 ) ;
F_77 ( V_24 ) ;
return V_149 ;
}
static T_4
F_83 ( struct V_106 * V_107 , struct V_108 * V_109 ,
char * V_110 )
{
struct V_45 * V_46 = F_54 ( V_107 ) ;
struct V_31 * V_32 = V_46 -> V_48 ;
T_7 V_145 = F_76 ( V_32 -> V_24 ) ;
F_28 ( V_145 >= F_84 ( V_150 ) ) ;
return snprintf ( V_110 , 40 , L_5 , V_150 [ V_145 ] ) ;
}
static int F_85 ( struct V_151 * V_152 , struct V_29 * V_68 ,
...
#endif
F_87 ( V_2 -> V_84 , V_32 -> V_74 ) ;
return 0 ;
}
static int F_88 ( struct V_151 * V_152 )
{
struct V_31 * V_32 = V_152 -> V_155 ;
return F_89 ( V_152 , V_32 -> V_24 , 0 ) ;
}
static int F_90 ( struct V_115 * V_24 )
{
struct V_31 * V_32 ;
struct V_92 * V_33 ;
int V_71 , V_58 ;
...
V_71 = F_92 ( & V_166 , 0 , F_52 ( 1 << V_167 ) ,
V_93 ) ;
if ( V_71 < 0 )
goto V_95;
V_58 = V_71 ;
V_71 = F_70 ( V_24 , V_168 ,
struct V_99 , V_169 ,
& V_74 ) ;
if ( V_71 || ! V_74 )
V_74 = 1 ;
V_74 += 2 ;
V_24 -> V_55 = V_32 = F_93 ( sizeof( * V_32 ) , V_93 ) ;
if ( ! V_32 ) {
V_71 = - V_87 ;
goto V_170;
}
V_32 -> V_24 = V_24 ;
V_32 -> V_74 = V_74 ;
F_94 ( & V_32 -> V_114 , F_56 ) ;
V_71 = F_69 ( V_32 ) ;
if ( V_71 )
goto V_171;
V_32 -> V_46 = F_95 ( 1 << V_104 ) ;
if ( ! V_32 -> V_46 ) {
V_71 = - V_87 ;
goto V_172;
}
...
V_71 = F_96 ( & V_32 -> V_176 ) ;
if ( V_71 )
goto V_184;
V_33 = F_97 ( & V_32 -> V_176 ) ;
if ( F_42 ( V_33 ) ) {
V_71 = - V_87 ;
goto V_185;
}
V_32 -> V_46 -> V_63 = V_33 ;
V_33 -> V_34 = V_32 ;
F_75 ( L_7 , V_58 , V_32 -> V_46 -> V_186 , V_187 ) ;
V_32 -> V_46 -> V_188 = V_188 ;
V_32 -> V_46 -> V_189 = F_51 ( V_58 ) ;
V_32 -> V_46 -> V_48 = V_32 ;
...
if ( F_10 ( V_24 , V_193 ) )
F_98 ( V_32 -> V_46 , 1 ) ;
F_49 ( V_24 , struct V_99 , V_120 , & V_156 ) ;
if ( ( V_121 ) V_156 != V_156 ) {
F_58 ( & V_24 -> V_107 , L_2 ,
( unsigned long long ) V_156 ) ;
V_156 = ( V_121 ) - 1 ;
}
F_63 ( V_32 -> V_46 , V_156 ) ;
F_99 ( V_33 , V_32 -> V_74 - 2 ) ;
F_100 ( V_33 , - 1U ) ;
V_71 = F_70 ( V_24 , V_194 ,
struct V_99 , V_195 , & V_157 ) ;
if ( ! V_71 )
F_101 ( V_33 , V_157 ) ;
else
F_101 ( V_33 , - 1U ) ;
V_71 = F_70 ( V_24 , V_196 ,
struct V_99 , V_158 ,
& V_158 ) ;
if ( ! V_71 )
F_102 ( V_33 , V_158 ) ;
...
& V_162 ) ;
if ( ! V_71 && V_162 )
F_104 ( V_33 , V_158 * V_162 ) ;
V_71 = F_70 ( V_24 , V_197 ,
struct V_99 , V_160 ,
& V_160 ) ;
if ( ! V_71 && V_160 )
F_105 ( V_33 , V_158 * V_160 ) ;
V_71 = F_70 ( V_24 , V_197 ,
struct V_99 , V_159 ,
& V_159 ) ;
if ( ! V_71 && V_159 )
F_106 ( V_33 , V_158 * V_159 ) ;
F_107 ( V_24 ) ;
F_108 ( & V_24 -> V_107 , V_32 -> V_46 ) ;
V_71 = F_109 ( F_66 ( V_32 -> V_46 ) , & V_198 ) ;
if ( V_71 )
goto V_199;
if ( F_10 ( V_24 , V_146 ) )
V_71 = F_109 ( F_66 ( V_32 -> V_46 ) ,
& V_200 ) ;
else
V_71 = F_109 ( F_66 ( V_32 -> V_46 ) ,
& V_201 ) ;
...
static void F_115 ( struct V_115 * V_24 )
{
struct V_31 * V_32 = V_24 -> V_55 ;
int V_58 = V_32 -> V_58 ;
int V_203 ;
...
V_203 = F_117 ( & F_66 ( V_32 -> V_46 ) -> V_124 . V_205 ) ;
F_113 ( V_32 -> V_46 ) ;
V_24 -> V_163 -> V_202 ( V_24 ) ;
F_74 ( V_32 -> V_61 ) ;
F_74 ( V_32 ) ;
...
static int F_118 ( struct V_115 * V_24 )
{
struct V_31 * V_32 = V_24 -> V_55 ;
V_24 -> V_163 -> V_204 ( V_24 ) ;
F_116 ( & V_32 -> V_114 ) ;
F_119 ( V_32 -> V_46 -> V_63 ) ;
V_24 -> V_163 -> V_202 ( V_24 ) ;
return 0 ;
}
static int F_120 ( struct V_115 * V_24 )
{
struct V_31 * V_32 = V_24 -> V_55 ;
int V_206 ;
V_206 = F_69 ( V_24 -> V_55 ) ;
if ( V_206 )
return V_206 ;
F_107 ( V_24 ) ;
F_121 ( V_32 -> V_46 -> V_63 ) ;
return 0 ;
}
