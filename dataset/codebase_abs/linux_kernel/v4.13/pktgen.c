...
struct V_274 V_275 ;
struct V_196 * V_276 ;
V_276 = F_132 ( V_245 , sizeof( * V_276 ) ) ;
V_273 -= sizeof( * V_276 ) ;
if ( V_22 -> V_28 <= 0 ) {
F_133 ( V_245 , V_273 ) ;
} else {
...
V_71 = V_22 -> V_71 ;
V_22 -> V_142 = F_136 ( V_71 , V_281 | V_282 , 0 ) ;
if ( ! V_22 -> V_142 )
break;
}
F_137 ( V_22 -> V_142 ) ;
F_138 ( V_245 , V_60 , V_22 -> V_142 ) ;
F_139 ( V_245 ) -> V_277 [ V_60 ] . V_283 = 0 ;
if ( V_60 == ( V_277 - 1 ) )
F_140 ( & F_139 ( V_245 ) -> V_277 [ V_60 ] ,
( V_273 < V_280 ? V_273 : V_280 ) ) ;
else
F_140 ( & F_139 ( V_245 ) -> V_277 [ V_60 ] , V_278 ) ;
V_273 -= F_141 ( & F_139 ( V_245 ) -> V_277 [ V_60 ] ) ;
V_245 -> V_121 += F_141 ( & F_139 ( V_245 ) -> V_277 [ V_60 ] ) ;
V_245 -> V_284 += F_141 ( & F_139 ( V_245 ) -> V_277 [ V_60 ] ) ;
V_60 ++ ;
F_139 ( V_245 ) -> V_285 = V_60 ;
}
}
...
static struct V_244 * F_143 ( struct V_169 * V_170 ,
struct V_21 * V_22 )
{
unsigned int V_290 = F_144 ( V_170 ) ;
struct V_244 * V_245 = NULL ;
unsigned int V_291 ;
V_291 = V_22 -> V_135 + 64 + V_290 + V_22 -> V_197 ;
if ( V_22 -> V_37 & V_92 ) {
int V_71 = V_22 -> V_71 >= 0 ? V_22 -> V_71 : F_135 () ;
V_245 = F_145 ( V_292 + V_291 , V_293 , 0 , V_71 ) ;
if ( F_86 ( V_245 ) ) {
F_146 ( V_245 , V_292 ) ;
V_245 -> V_170 = V_170 ;
}
} else {
V_245 = F_147 ( V_170 , V_291 , V_293 ) ;
}
if ( F_86 ( V_245 ) )
F_146 ( V_245 , V_290 - 16 ) ;
return V_245 ;
}
static struct V_244 * F_148 ( struct V_169 * V_50 ,
struct V_21 * V_22 )
{
struct V_244 * V_245 = NULL ;
T_11 * V_262 ;
...
F_149 ( V_245 -> V_9 ) ;
F_146 ( V_245 , 16 ) ;
V_262 = F_124 ( V_245 , 14 ) ;
V_269 = F_132 ( V_245 , V_22 -> V_59 * sizeof( T_7 ) ) ;
if ( V_22 -> V_59 )
F_129 ( V_269 , V_22 ) ;
if ( V_22 -> V_62 != 0xffff ) {
if ( V_22 -> V_65 != 0xffff ) {
V_299 = F_132 ( V_245 , sizeof( T_10 ) ) ;
...
V_297 = F_132 ( V_245 , sizeof( T_10 ) ) ;
* V_297 = F_130 ( V_22 -> V_62 ,
V_22 -> V_64 ,
V_22 -> V_63 ) ;
V_298 = F_132 ( V_245 , sizeof( T_10 ) ) ;
* V_298 = F_126 ( V_296 ) ;
}
F_150 ( V_245 ) ;
F_151 ( V_245 , V_245 -> V_121 ) ;
V_263 = F_132 ( V_245 , sizeof( struct V_206 ) ) ;
F_152 ( V_245 , V_245 -> V_121 ) ;
V_294 = F_132 ( V_245 , sizeof( struct V_195 ) ) ;
F_153 ( V_245 , V_301 ) ;
...
V_245 -> V_317 = V_322 ;
V_245 -> V_323 = 0 ;
F_154 ( V_245 , V_263 -> V_311 , V_263 -> V_312 ) ;
} else {
T_13 V_323 = F_155 ( V_245 , F_156 ( V_245 ) , V_273 + 8 , 0 ) ;
V_294 -> V_307 = F_157 ( V_263 -> V_311 , V_263 -> V_312 ,
V_273 + 8 , V_310 , V_323 ) ;
if ( V_294 -> V_307 == 0 )
V_294 -> V_307 = V_324 ;
}
...
static struct V_244 * F_158 ( struct V_169 * V_50 ,
struct V_21 * V_22 )
{
struct V_244 * V_245 = NULL ;
T_11 * V_262 ;
...
F_150 ( V_245 ) ;
F_151 ( V_245 , V_245 -> V_121 ) ;
V_263 = F_132 ( V_245 , sizeof( struct V_194 ) ) ;
F_152 ( V_245 , V_245 -> V_121 ) ;
V_294 = F_132 ( V_245 , sizeof( struct V_195 ) ) ;
F_153 ( V_245 , V_301 ) ;
V_245 -> V_304 = V_22 -> V_36 ;
...
V_245 -> V_317 = V_322 ;
V_245 -> V_331 = F_160 ( V_245 ) - V_245 -> V_332 ;
V_245 -> V_333 = F_161 ( struct V_195 , V_307 ) ;
V_294 -> V_307 = ~ F_162 ( & V_263 -> V_311 , & V_263 -> V_312 , V_325 , V_310 , 0 ) ;
} else {
T_13 V_323 = F_155 ( V_245 , F_156 ( V_245 ) , V_325 , 0 ) ;
V_294 -> V_307 = F_162 ( & V_263 -> V_311 , & V_263 -> V_312 , V_325 , V_310 , V_323 ) ;
if ( V_294 -> V_307 == 0 )
V_294 -> V_307 = V_324 ;
}
return V_245 ;
}
static struct V_244 * F_163 ( struct V_169 * V_50 ,
struct V_21 * V_22 )
{
if ( V_22 -> V_37 & V_38 )
return F_158 ( V_50 , V_22 ) ;
else
...
static int F_166 ( const struct V_154 * V_155 )
{
const struct V_21 * V_22 ;
F_44 () ;
F_45 (pkt_dev, &t->if_list, list)
...
static void F_170 ( struct V_21 * V_22 , int V_285 )
{
T_14 V_339 , V_340 , V_341 ;
char * V_342 = V_22 -> V_111 ;
T_5 V_343 = F_91 ( V_22 -> V_94 ,
V_22 -> V_99 ) ;
T_5 V_25 = F_171 ( V_22 -> V_95 ) ;
...
{
int V_285 = V_22 -> V_245 ? F_139 ( V_22 -> V_245 ) -> V_285 : - 1 ;
if ( ! V_22 -> V_93 ) {
F_30 ( L_263 ,
V_22 -> V_31 ) ;
return - V_18 ;
...
static struct V_21 * F_174 ( struct V_154 * V_155 )
{
...
F_165 () ;
F_177 (q, n, &t->if_list) {
V_347 = F_178 ( V_346 , struct V_21 , V_348 ) ;
if ( ! V_347 -> V_164 )
continue;
F_128 ( V_347 -> V_245 ) ;
V_347 -> V_245 = NULL ;
...
static void F_181 ( struct V_154 * V_155 )
{
F_182 ( V_155 -> V_349 -> V_350 , V_155 -> V_184 -> V_172 ) ;
}
...
{
T_5 V_351 = F_18 () ;
while ( F_185 ( & ( V_22 -> V_245 -> V_352 ) ) != 1 ) {
if ( F_89 ( V_12 ) )
break;
if ( F_186 () )
F_183 ( V_22 ) ;
...
{
unsigned int V_70 = F_189 ( V_22 -> V_70 ) ;
struct V_169 * V_50 = V_22 -> V_50 ;
struct V_353 * V_354 ;
struct V_244 * V_245 ;
int V_156 ;
if ( F_134 ( ! F_71 ( V_50 ) || ! F_190 ( V_50 ) ) ) {
F_173 ( V_22 ) ;
return;
}
if ( F_134 ( V_22 -> V_29 == V_136 ) ) {
...
if ( V_22 -> V_72 == V_73 ) {
V_245 = V_22 -> V_245 ;
V_245 -> V_259 = F_191 ( V_245 , V_245 -> V_170 ) ;
F_192 ( V_70 , & V_245 -> V_352 ) ;
F_193 () ;
do {
V_156 = F_194 ( V_245 ) ;
if ( V_156 == V_358 )
...
V_22 -> V_97 ++ ;
V_22 -> V_100 ++ ;
if ( F_185 ( & V_245 -> V_352 ) != V_70 ) {
F_195 ( F_196 ( V_70 - 1 , & V_245 -> V_352 ) ) ;
break;
}
F_197 ( V_245 ) ;
} while ( -- V_70 > 0 );
...
F_193 () ;
F_198 ( & V_22 -> V_245 -> V_352 ) ;
V_156 = F_199 ( V_22 -> V_245 ) ;
switch ( V_156 ) {
case V_359 :
V_22 -> V_97 ++ ;
V_22 -> V_100 ++ ;
...
V_354 = F_200 ( V_50 , V_22 -> V_245 ) ;
F_193 () ;
F_201 ( V_50 , V_354 , F_104 () ) ;
if ( F_134 ( F_202 ( V_354 ) ) ) {
V_156 = V_362 ;
V_22 -> V_144 = 0 ;
goto V_363;
}
F_192 ( V_70 , & V_22 -> V_245 -> V_352 ) ;
V_364:
V_156 = F_203 ( V_22 -> V_245 , V_50 , V_354 , -- V_70 > 0 ) ;
switch ( V_156 ) {
case V_365 :
V_22 -> V_144 = 1 ;
V_22 -> V_97 ++ ;
...
V_22 -> V_98 ++ ;
case V_362 :
F_204 ( & ( V_22 -> V_245 -> V_352 ) ) ;
V_22 -> V_144 = 0 ;
}
if ( F_134 ( V_70 ) )
F_195 ( F_196 ( V_70 , & V_22 -> V_245 -> V_352 ) ) ;
V_363:
F_205 ( V_50 , V_354 ) ;
V_157:
F_206 () ;
...
F_209 ( & V_155 -> V_369 ) ;
F_210 ( & V_155 -> V_370 ) ;
F_32 ( L_266 , V_368 , F_211 ( V_12 ) ) ;
F_212 () ;
while ( ! F_213 () ) {
V_22 = F_174 ( V_155 ) ;
if ( F_134 ( ! V_22 && V_155 -> V_159 == 0 ) ) {
...
static int F_216 ( struct V_154 * V_155 ,
struct V_21 * V_22 )
{
int V_372 = 0 ;
F_60 ( V_155 ) ;
...
struct V_21 * V_22 ;
int V_185 ;
int V_71 = F_218 ( V_155 -> V_368 ) ;
V_22 = F_55 ( V_155 -> V_184 , V_161 , V_163 ) ;
if ( V_22 ) {
F_48 ( L_272 ) ;
return - V_374 ;
}
V_22 = F_219 ( sizeof( struct V_21 ) , V_281 , V_71 ) ;
if ( ! V_22 )
return - V_376 ;
strcpy ( V_22 -> V_31 , V_161 ) ;
V_22 -> V_225 = F_220 ( V_151 * sizeof( struct V_377 ) ,
V_71 ) ;
if ( V_22 -> V_225 == NULL ) {
F_221 ( V_22 ) ;
return - V_376 ;
...
static int T_15 F_224 ( int V_368 , struct V_10 * V_11 )
{
struct V_154 * V_155 ;
struct V_390 * V_391 ;
struct V_392 * V_342 ;
V_155 = F_219 ( sizeof( struct V_154 ) , V_281 ,
F_218 ( V_368 ) ) ;
if ( ! V_155 ) {
F_48 ( L_274 ) ;
return - V_376 ;
...
static void F_238 ( struct V_154 * V_155 ,
struct V_21 * V_22 )
{
struct V_345 * V_346 , * V_120 ;
struct V_21 * V_342 ;
F_60 ( V_155 ) ;
F_177 (q, n, &t->if_list) {
V_342 = F_178 ( V_346 , struct V_21 , V_348 ) ;
if ( V_342 == V_22 )
F_239 ( & V_342 -> V_348 ) ;
}
F_63 ( V_155 ) ;
}
static int F_179 ( struct V_154 * V_155 ,
struct V_21 * V_22 )
{
F_32 ( L_277 , V_22 ) ;
if ( V_22 -> V_93 ) {
...
static int T_15 F_241 ( struct V_184 * V_184 )
{
...
F_226 ( & V_11 -> V_394 ) ;
V_11 -> V_178 = false ;
V_11 -> V_172 = F_242 ( V_382 , V_11 -> V_184 -> V_397 ) ;
if ( ! V_11 -> V_172 ) {
F_30 ( L_279 , V_382 ) ;
return - V_186 ;
}
V_391 = F_243 ( V_398 , 0600 , V_11 -> V_172 , & V_399 ) ;
if ( V_391 == NULL ) {
F_48 ( L_280 , V_398 ) ;
V_156 = - V_18 ;
goto remove;
...
return 0 ;
V_400:
F_182 ( V_398 , V_11 -> V_172 ) ;
remove:
F_182 ( V_382 , V_11 -> V_184 -> V_397 ) ;
return V_156 ;
}
static void T_16 F_246 ( struct V_184 * V_184 )
{
struct V_10 * V_11 = F_4 ( V_184 , V_15 ) ;
struct V_154 * V_155 ;
struct V_345 * V_346 , * V_120 ;
...
V_11 -> V_178 = true ;
F_49 ( & V_158 ) ;
F_248 ( & V_11 -> V_394 , & V_348 ) ;
F_51 ( & V_158 ) ;
F_177 (q, n, &list) {
V_155 = F_178 ( V_346 , struct V_154 , V_393 ) ;
F_231 ( & V_155 -> V_393 ) ;
F_234 ( V_155 -> V_349 ) ;
F_249 ( V_155 -> V_349 ) ;
F_221 ( V_155 ) ;
