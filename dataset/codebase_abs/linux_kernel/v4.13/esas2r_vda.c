...
V_9 = V_4 -> V_38 ;
V_6 -> V_26 -> V_45 . V_46 =
F_5 ( V_4 -> V_32 . V_45 . V_46 ) ;
V_6 -> V_26 -> V_45 . V_39 = F_5 ( V_9 ) ;
...
V_6 -> V_26 -> V_52 . V_65 =
F_5 ( V_4 -> V_32 . V_52 . V_65 ) ;
F_9 ( V_6 -> V_26 -> V_52 . V_53 , & V_4 -> V_32 . V_52 . V_40 ) ;
break;
}
case V_66 :
if ( V_4 -> V_38
...
V_6 -> V_26 -> V_67 . V_39 = F_5 ( V_4 -> V_32 . V_67 . V_38 ) ;
if ( V_4 -> V_32 . V_67 . V_68 == V_70 ) {
memcpy ( & V_6 -> V_26 -> V_67 . V_40 ,
& V_4 -> V_32 . V_67 . V_40 ,
V_4 -> V_32 . V_67 . V_38 ) ;
F_10 ( V_6 -> V_26 -> V_67 . V_34 ,
& V_6 -> V_26 -> V_67 . V_40 ) ;
} else {
V_4 -> V_14 = V_19 ;
return false ;
...
F_12 ( V_6 -> V_78 . V_79 . V_77 ) ;
break;
case V_47 :
V_4 -> V_32 . V_52 . V_64 =
V_6 -> V_78 . V_80 . V_64 ;
V_4 -> V_32 . V_52 . V_65 = F_13 (
V_6 -> V_78 . V_80 . V_65 ) ;
if ( V_4 -> V_38 == 0 )
V_4 -> V_32 . V_52 . V_38 =
F_12 ( V_6 -> V_78 . V_80 . V_39 ) ;
F_9 ( V_6 -> V_26 -> V_52 . V_53 , & V_4 -> V_32 . V_52 . V_40 ) ;
break;
case V_66 :
if ( V_4 -> V_32 . V_67 . V_68 == V_70 ) {
...
V_26 -> V_39 = F_5 ( V_39 ) ;
if ( V_26 -> V_39 ) {
if ( F_3 ( V_103 , & V_2 -> V_23 ) ) {
V_26 -> V_99 = ( T_2 ) F_6 (
struct V_57 , V_43 ) ;
V_26 -> V_43 [ 0 ] . V_39 = F_5 ( V_104 | V_39 ) ;
V_26 -> V_43 [ 0 ] . V_105 = F_20 (
V_6 -> V_106 -> V_107 +
sizeof( union V_108 ) ) ;
} else {
V_26 -> V_99 = ( T_2 ) F_6 (
struct V_57 , V_109 ) ;
V_26 -> V_109 [ 0 ] . V_110 = F_5 ( V_39 ) ;
V_26 -> V_109 [ 0 ] . V_105 = F_20 (
V_6 -> V_106 -> V_107 +
sizeof( union V_108 ) ) ;
}
}
...
void F_21 ( struct V_1 * V_2 , struct V_5 * V_6 )
{
struct V_114 * V_26 = & V_6 -> V_26 -> V_115 ;
F_4 ( V_6 ) ;
V_6 -> V_26 -> V_27 . V_18 = V_116 ;
V_26 -> V_39 = F_5 ( sizeof( struct V_117 ) ) ;
if ( F_3 ( V_103 , & V_2 -> V_23 ) ) {
V_26 -> V_99 =
( T_2 ) F_6 ( struct V_114 , V_43 ) ;
V_26 -> V_43 [ 0 ] . V_39 = F_5 ( V_104 | V_26 -> V_39 ) ;
V_26 -> V_43 [ 0 ] . V_105 = F_20 (
V_6 -> V_106 -> V_107 +
sizeof( union V_108 ) ) ;
} else {
V_26 -> V_99 = ( T_2 ) F_6 ( struct V_114 ,
V_109 ) ;
V_26 -> V_109 [ 0 ] . V_110 = F_5 ( V_26 -> V_39 ) ;
V_26 -> V_109 [ 0 ] . V_105 = F_20 (
V_6 -> V_106 -> V_107 +
sizeof( union V_108 ) ) ;
}
...
V_26 -> V_39 = F_5 ( V_39 ) ;
V_26 -> V_46 = F_5 ( V_46 ) ;
V_26 -> V_99 = ( T_2 ) F_6 ( struct V_118 , V_43 ) ;
}
...
V_26 -> V_39 = F_5 ( V_39 ) ;
V_26 -> V_34 = V_34 ;
V_26 -> V_99 = ( T_2 ) F_6 ( struct V_119 , V_43 ) ;
}
