...
( 1U << F_2 ( V_142 ) ) - 1 ;
if ( F_28 ( F_72 ( V_143 ) < 2 ||
V_143 & ~ V_145 ) )
return - V_61 ;
V_141 =
F_64 ( V_23 , V_133 , L_33 ,
F_72 ( V_143 ) ) ;
if ( ! V_141 )
return - V_40 ;
for ( V_1 = 0 ; V_1 < F_2 ( V_142 ) ; V_1 ++ ) {
int V_31 ;
if ( ! ( F_73 ( V_1 ) & V_143 ) )
continue;
V_31 = F_69 ( V_141 , V_144 ++ ,
V_142 [ V_1 ] . type ,
V_142 [ V_1 ] . V_10 ) ;
if ( V_31 ) {
F_74 ( V_23 , V_141 ) ;
...
V_147 ,
F_2 ( V_147 ) ) ;
if ( V_23 -> V_30 . V_146 == NULL )
return - V_40 ;
return 0 ;
}
int F_76 ( struct V_22 * V_23 )
{
if ( V_23 -> V_30 . V_148 && V_23 -> V_30 . V_149 )
return 0 ;
V_23 -> V_30 . V_148 =
F_68 ( V_23 , V_109 , L_35 , 0 , 0xffffffff ) ;
V_23 -> V_30 . V_149 =
F_68 ( V_23 , V_109 , L_36 , 0 , 0xffffffff ) ;
if ( V_23 -> V_30 . V_148 == NULL ||
V_23 -> V_30 . V_149 == NULL )
return - V_40 ;
return 0 ;
}
...
snprintf ( V_152 , 256 , L_37 ,
V_5 -> V_68 -> V_64 , V_5 -> V_155 ,
V_5 -> V_156 , V_5 -> V_157 ,
V_5 -> V_158 , V_5 -> V_159 ,
V_5 -> V_160 , V_5 -> V_161 ) ;
V_31 = F_78 ( V_23 ,
...
{
struct V_22 * V_23 = V_5 -> V_23 ;
F_82 ( & V_23 -> V_30 . V_168 , NULL ) ;
V_5 -> V_71 -> V_167 = V_167 ;
F_83 ( & V_23 -> V_30 . V_168 ) ;
}
int F_84 ( struct V_169 * V_170 ,
struct V_106 * V_171 ,
T_3 V_172 )
{
int V_31 = - V_61 ;
struct V_4 * V_5 = F_85 ( V_170 ) ;
if ( V_171 == V_5 -> V_23 -> V_30 . V_54 ) {
V_31 = (* V_5 -> V_24 -> V_173 )( V_5 , ( int ) V_172 ) ;
} else if ( V_5 -> V_24 -> V_174 )
V_31 = V_5 -> V_24 -> V_174 ( V_5 , V_171 , V_172 ) ;
if ( ! V_31 )
F_86 ( & V_5 -> V_20 , V_171 , V_172 ) ;
return V_31 ;
}
int F_87 ( struct V_22 * V_23 ,
void * V_175 , struct V_176 * V_177 )
{
struct V_178 * V_179 = V_175 ;
struct V_180 V_181 = {
. V_172 = V_179 -> V_172 ,
. V_182 = V_179 -> V_182 ,
. V_183 = V_179 -> V_184 ,
...
return F_88 ( V_23 , & V_181 , V_177 ) ;
}
static struct V_59 * F_89 ( struct V_4 * V_5 )
{
if ( V_5 -> V_71 )
return V_5 -> V_71 -> V_186 ;
return V_5 -> V_60 ;
}
static bool F_90 ( const struct V_65 * V_7 ,
const struct V_176 * V_177 )
{
if ( ! V_177 -> V_187 && F_91 ( V_7 ) )
return false ;
return true ;
}
int F_92 ( struct V_22 * V_23 , void * V_175 ,
struct V_176 * V_177 )
{
struct V_188 * V_189 = V_175 ;
struct V_4 * V_5 ;
struct V_59 * V_60 ;
struct V_65 * V_7 ;
int V_190 = 0 ;
...
int V_1 ;
struct V_193 V_194 ;
struct V_193 T_4 * V_195 ;
T_5 T_4 * V_196 ;
if ( ! F_25 ( V_23 , V_197 ) )
return - V_61 ;
memset ( & V_194 , 0 , sizeof( struct V_193 ) ) ;
V_5 = F_93 ( V_23 , V_189 -> V_184 ) ;
if ( ! V_5 )
return - V_198 ;
for ( V_1 = 0 ; V_1 < V_62 ; V_1 ++ )
if ( V_5 -> V_63 [ V_1 ] != 0 )
V_191 ++ ;
if ( ( V_189 -> V_199 >= V_191 ) && V_191 ) {
V_192 = 0 ;
V_196 = ( T_5 T_4 * ) ( unsigned long ) ( V_189 -> V_200 ) ;
for ( V_1 = 0 ; V_1 < V_62 ; V_1 ++ ) {
if ( V_5 -> V_63 [ V_1 ] != 0 ) {
if ( F_94 ( V_5 -> V_63 [ V_1 ] ,
V_196 + V_192 ) ) {
V_31 = - V_201 ;
goto V_202;
}
...
V_189 -> V_207 = V_5 -> V_69 . V_208 ;
V_189 -> V_209 = V_5 -> V_69 . V_210 ;
V_189 -> V_211 = V_5 -> V_69 . V_97 ;
V_189 -> V_212 = V_5 -> V_46 ;
F_95 (mode, &connector->modes, head)
if ( F_90 ( V_7 , V_177 ) )
V_190 ++ ;
if ( ( V_189 -> V_203 >= V_190 ) && V_190 ) {
V_192 = 0 ;
V_195 = (struct V_193 T_4 * ) ( unsigned long ) V_189 -> V_213 ;
F_95 (mode, &connector->modes, head) {
if ( ! F_90 ( V_7 , V_177 ) )
continue;
F_96 ( & V_194 , V_7 ) ;
...
V_60 = F_89 ( V_5 ) ;
if ( V_60 )
V_189 -> V_214 = V_60 -> V_20 . V_64 ;
else
V_189 -> V_214 = 0 ;
V_31 = F_98 ( & V_5 -> V_20 , V_177 -> V_215 ,
( T_5 T_4 * ) ( unsigned long ) ( V_189 -> V_216 ) ,
( T_3 T_4 * ) ( unsigned long ) ( V_189 -> V_217 ) ,
& V_189 -> V_218 ) ;
F_83 ( & V_23 -> V_30 . V_168 ) ;
V_202:
F_58 ( V_5 ) ;
...
static void F_99 ( struct V_19 * V_19 )
{
struct V_219 * V_220 = F_13 ( V_19 , struct V_219 , V_21 ) ;
struct V_22 * V_23 = V_220 -> V_23 ;
F_39 ( & V_23 -> V_30 . V_221 ) ;
F_100 ( & V_23 -> V_30 . V_222 , V_220 -> V_64 ) ;
F_45 ( & V_23 -> V_30 . V_221 ) ;
F_36 ( V_220 ) ;
}
void F_34 ( struct V_22 * V_23 ,
struct V_219 * V_220 )
{
F_101 ( & V_220 -> V_21 , F_99 ) ;
}
struct V_219 * F_102 ( struct V_22 * V_23 ,
char V_223 [ 8 ] )
{
struct V_219 * V_220 ;
int V_64 ;
F_39 ( & V_23 -> V_30 . V_221 ) ;
F_103 (&dev->mode_config.tile_idr, tg, id) {
if ( ! memcmp ( V_220 -> V_224 , V_223 , 8 ) ) {
if ( ! F_56 ( & V_220 -> V_21 ) )
V_220 = NULL ;
F_45 ( & V_23 -> V_30 . V_221 ) ;
return V_220 ;
...
struct V_219 * F_104 ( struct V_22 * V_23 ,
char V_223 [ 8 ] )
{
struct V_219 * V_220 ;
int V_31 ;
V_220 = F_105 ( sizeof( * V_220 ) , V_35 ) ;
if ( ! V_220 )
return F_106 ( - V_40 ) ;
F_107 ( & V_220 -> V_21 ) ;
memcpy ( V_220 -> V_224 , V_223 , 8 ) ;
V_220 -> V_23 = V_23 ;
F_39 ( & V_23 -> V_30 . V_221 ) ;
V_31 = F_108 ( & V_23 -> V_30 . V_222 , V_220 , 1 , 0 , V_35 ) ;
if ( V_31 >= 0 ) {
V_220 -> V_64 = V_31 ;
} else {
F_36 ( V_220 ) ;
