...
F_34 ( & V_21 -> V_26 . V_78 ) ;
F_35 ( F_32 ( V_2 ) ) ;
V_23 = F_36 ( V_2 -> log . V_33 -> V_34 , true ) ;
if ( V_23 )
return V_23 ;
V_73 = F_37 ( V_2 -> log . V_33 -> V_34 , V_79 ) ;
if ( F_38 ( V_73 ) ) {
F_14 ( L_7 , V_23 ) ;
return F_39 ( V_73 ) ;
}
...
F_41 ( & V_2 -> log . V_30 . V_72 , F_29 ) ;
V_2 -> log . V_30 . V_83 = F_42 ( L_9 ,
V_84 | V_85 ) ;
...
return 0 ;
V_86:
F_43 ( V_2 -> log . V_30 . V_31 ) ;
V_82:
F_44 ( V_2 -> log . V_33 -> V_34 ) ;
...
int F_58 ( struct V_20 * V_21 , T_5 V_6 )
{
