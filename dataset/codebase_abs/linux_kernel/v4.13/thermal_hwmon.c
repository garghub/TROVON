...
{
int V_13 ;
return V_16 -> V_18 -> V_19 && ! V_16 -> V_18 -> V_19 ( V_16 , & V_13 ) ;
}
...
F_20 ( V_7 -> V_1 , V_7 ) ;
V_22 = F_21 ( V_7 -> V_1 , & V_29 ) ;
if ( V_22 )
goto V_28;
V_23:
V_13 = F_14 ( sizeof( * V_13 ) , V_24 ) ;
if ( ! V_13 ) {
V_22 = - V_25 ;
goto V_30;
}
...
V_22 = F_21 ( V_7 -> V_1 , & V_13 -> V_14 . V_4 ) ;
if ( V_22 )
goto V_35;
if ( F_12 ( V_16 ) ) {
