...
if ( V_15 == 0 )
return - V_51 ;
V_123 = F_90 ( sizeof( * V_123 ) , V_91 ) ;
if ( V_123 == NULL )
return - V_29 ;
V_123 -> V_15 = 1 << V_15 ;
V_123 -> V_20 = F_91 ( V_123 -> V_15 ,
sizeof( struct V_17 ) ,
V_91 ) ;
if ( V_123 -> V_20 == NULL ) {
F_6 ( V_123 ) ;
...
for ( V_19 = 0 ; V_19 < V_123 -> V_15 ; V_19 ++ )
F_23 ( & V_123 -> V_20 [ V_19 ] ) ;
F_17 ( & V_32 ) ;
F_25 ( V_14 , V_123 ) ;
F_19 ( & V_32 ) ;
F_92 ( & V_124 ) ;
...
struct V_5 * V_55 ;
V_132 = F_94 ( V_86 ) ;
V_55 = F_95 ( V_132 -> V_133 ,
& V_4 -> V_33 ) ;
if ( V_55 == NULL )
goto V_129;
V_127 -> V_134 . V_25 = F_7 ( V_55 ) -> V_25 ;
break;
}
#if F_2 ( V_8 )
case V_135 : {
...
struct V_9 * V_57 ;
V_137 = F_96 ( V_86 ) ;
V_57 = F_97 ( & V_137 -> V_133 ,
& V_4 -> V_37 ) ;
if ( V_57 == NULL )
goto V_129;
V_127 -> V_134 . V_25 = F_10 ( V_57 ) -> V_25 ;
break;
}
#endif
default:
