...
if ( V_50 )
* V_50 = NULL ;
V_2 = F_25 ( sizeof( * V_2 ) , V_56 ) ;
if ( ! V_2 )
return - V_57 ;
V_2 -> V_42 = F_26 ( V_4 , 8 , L_4 ) ;
V_2 -> V_43 = F_26 ( V_8 , 8 , L_5 ) ;
if ( ! V_2 -> V_42 || ! V_2 -> V_43 ) {
F_27 ( V_58 L_6 , V_4 , V_8 ) ;
F_19 ( V_2 ) ;
return - V_59 ;
}
V_2 -> V_38 = V_38 ;
...
V_52 = F_31 ( V_38 , V_61 , V_2 , & V_54 ) ;
if ( V_52 < 0 ) {
F_19 ( V_2 ) ;
return V_52 ;
}
V_52 = F_32 ( V_38 , V_4 , V_4 + 2 , V_2 -> V_27 , 1 , & V_51 ) ;
if ( V_52 < 0 ) {
F_33 ( V_38 , V_2 ) ;
return V_52 ;
}
