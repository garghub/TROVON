...
struct V_67 * V_68 )
{
struct V_10 * V_69 [ V_70 + 1 ] ;
struct V_5 * V_6 ;
struct V_2 * V_71 ;
int V_72 , V_73 ;
struct V_1 * V_52 ;
int V_32 ;
V_32 = F_58 ( V_69 , V_70 , V_11 ,
V_74 , V_68 ) ;
if ( V_32 < 0 )
return V_32 ;
if ( ! V_69 [ V_75 ] )
...
V_6 = F_6 ( V_69 [ V_75 ] ) ;
V_72 = F_59 ( V_69 [ V_75 ] ) ;
V_73 = sizeof( * V_6 ) + sizeof( struct V_24 ) +
sizeof( struct V_17 ) ;
if ( V_72 < V_73 )
return - V_56 ;
switch ( V_6 -> V_45 ) {
...
if ( ! F_60 ( V_6 -> V_47 , V_72 - sizeof( * V_6 ) ) )
return - V_56 ;
V_71 = F_61 ( V_72 + sizeof( * V_52 ) ) ;
if ( ! V_71 )
return - V_76 ;
V_52 = F_1 ( V_71 ) ;
V_32 = F_62 ( & V_52 -> V_53 , V_77 ) ;
if ( V_32 ) {
F_63 ( V_71 ) ;
return V_32 ;
}
memcpy ( & V_52 -> V_6 , V_6 , V_72 ) ;
V_71 -> type = V_78 ;
V_71 -> V_79 |= V_80 |
V_81 ;
V_71 -> V_82 = F_64 ( V_6 ) ;
...
static int F_70 ( struct V_2 * V_83 , struct V_2 * V_84 )
{
struct V_5 * V_85 = F_2 ( V_83 ) ;
struct V_5 * V_86 = F_2 ( V_84 ) ;
int V_12 = F_4 ( V_85 ) ;
if ( V_12 != F_4 ( V_86 ) )
return 1 ;
return memcmp ( V_85 , V_86 , V_12 ) ;
}
int T_1 F_71 ( void )
{
return F_72 ( & V_87 , V_78 ) ;
}
void F_73 ( void )
{
F_74 ( & V_87 , V_78 ) ;
