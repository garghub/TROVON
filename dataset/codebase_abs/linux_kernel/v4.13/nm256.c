...
int V_93 , unsigned long V_94 , unsigned long V_95 )
{
struct V_42 * V_43 = V_41 -> V_43 ;
struct V_38 * V_39 = V_43 -> V_81 ;
...
int V_93 , unsigned long V_94 ,
void T_5 * V_6 , unsigned long V_95 )
{
struct V_42 * V_43 = V_41 -> V_43 ;
struct V_38 * V_39 = V_43 -> V_81 ;
...
int V_93 , unsigned long V_94 ,
void * V_6 , unsigned long V_95 )
{
struct V_42 * V_43 = V_41 -> V_43 ;
struct V_38 * V_39 = V_43 -> V_81 ;
F_16 ( V_39 -> V_96 + V_94 , V_6 , V_95 ) ;
return 0 ;
}
static int
F_57 ( struct V_40 * V_41 ,
int V_93 , unsigned long V_94 ,
void T_5 * V_98 , unsigned long V_95 )
{
struct V_42 * V_43 = V_41 -> V_43 ;
struct V_38 * V_39 = V_43 -> V_81 ;
if ( F_58 ( V_98 , V_39 -> V_96 + V_94 , V_95 ) )
return - V_97 ;
return 0 ;
}
static int
...
int V_93 , unsigned long V_94 ,
void * V_98 , unsigned long V_95 )
{
struct V_42 * V_43 = V_41 -> V_43 ;
struct V_38 * V_39 = V_43 -> V_81 ;
F_60 ( V_98 , V_39 -> V_96 + V_94 , V_95 ) ;
return 0 ;
}
static void
F_61 ( struct V_1 * V_2 )
...
struct V_100 * V_101 )
{
V_41 -> V_43 -> V_102 = F_65 ( V_101 ) ;
return 0 ;
}
static void F_66 ( struct V_1 * V_2 , struct V_38 * V_39 ,
struct V_40 * V_41 ,
struct V_103 * V_104 )
{
struct V_42 * V_43 = V_41 -> V_43 ;
...
if ( F_26 ( V_2 ) < 0 )
return - V_59 ;
F_66 ( V_2 , & V_2 -> V_99 [ V_19 ] ,
V_41 , & V_115 ) ;
return 0 ;
}
static int
F_69 ( struct V_40 * V_41 )
{
struct V_1 * V_2 = F_40 ( V_41 ) ;
if ( F_26 ( V_2 ) < 0 )
return - V_59 ;
F_66 ( V_2 , & V_2 -> V_99 [ V_22 ] ,
V_41 , & V_116 ) ;
return 0 ;
}
static int
F_70 ( struct V_40 * V_41 )
{
struct V_1 * V_2 = F_40 ( V_41 ) ;
F_30 ( V_2 ) ;
return 0 ;
...
V_82 = F_73 ( V_2 -> V_10 , V_2 -> V_10 -> V_121 , V_117 ,
1 , 1 , & V_119 ) ;
if ( V_82 < 0 )
return V_82 ;
F_74 ( V_119 , V_19 , & V_122 ) ;
F_74 ( V_119 , V_22 , & V_123 ) ;
V_119 -> V_81 = V_2 ;
V_119 -> V_124 = 0 ;
V_2 -> V_119 = V_119 ;
return 0 ;
...
static int F_83 ( unsigned short V_61 )
{
int V_36 ;
...
F_84 ( struct V_146 * V_147 , unsigned short V_61 )
{
...
V_147 . V_168 = V_169 ;
V_157 -> V_170 = 1 ;
V_82 = F_90 ( V_157 , & V_147 , & V_2 -> V_147 ) ;
if ( V_82 < 0 )
return V_82 ;
...
T_3 V_176 ;
V_173 = F_92 ( V_2 -> V_120 + V_2 -> V_175 - 0x400 , 16 ) ;
if ( V_173 == NULL ) {
F_15 ( V_2 -> V_10 -> V_11 ,
L_9 ) ;
return - V_59 ;
...
static int F_95 ( struct V_117 * V_11 )
{
struct V_181 * V_10 = F_96 ( V_11 ) ;
...
static int F_100 ( struct V_117 * V_11 )
{
struct V_181 * V_10 = F_96 ( V_11 ) ;
struct V_1 * V_2 = V_10 -> V_81 ;
int V_36 ;
...
static int F_106 ( struct V_186 * V_117 )
{
struct V_1 * V_2 = V_117 -> V_187 ;
return F_102 ( V_2 ) ;
}
static int
F_107 ( struct V_181 * V_10 , struct V_188 * V_55 ,
struct V_1 * * V_189 )
{
struct V_1 * V_2 ;
int V_82 , V_190 ;
...
T_3 V_25 ;
* V_189 = NULL ;
if ( ( V_82 = F_108 ( V_55 ) ) < 0 )
return V_82 ;
V_2 = F_109 ( sizeof( * V_2 ) , V_164 ) ;
if ( V_2 == NULL ) {
F_104 ( V_55 ) ;
return - V_165 ;
}
...
V_2 -> V_120 = F_112 ( V_55 , 0 ) ;
V_2 -> V_195 = F_112 ( V_55 , 1 ) ;
V_2 -> V_184 = F_113 ( V_2 -> V_195 , V_196 ,
V_10 -> V_121 ) ;
if ( V_2 -> V_184 == NULL ) {
F_15 ( V_10 -> V_11 , L_12 ,
V_2 -> V_195 , V_196 ) ;
...
V_2 -> V_12 = F_92 ( V_2 -> V_120 , V_2 -> V_9 ) ;
if ( V_2 -> V_12 == NULL ) {
V_82 = - V_165 ;
F_15 ( V_10 -> V_11 , L_21 ,
V_2 -> V_120 ) ;
...
V_2 -> V_30 = 0 ;
F_75 ( V_2 ) ;
if ( ( V_82 = F_114 ( V_10 , V_210 , V_2 , & V_160 ) ) < 0 )
goto V_197;
* V_189 = V_2 ;
return 0 ;
V_197:
...
static int F_115 ( struct V_188 * V_55 ,
...
V_82 = F_118 ( & V_55 -> V_11 , V_219 , V_171 , V_220 , 0 , & V_10 ) ;
if ( V_82 < 0 )
return V_82 ;
switch ( V_55 -> V_117 ) {
case V_221 :
...
static void F_122 ( struct V_188 * V_55 )
{
F_119 ( F_123 ( V_55 ) ) ;
}
