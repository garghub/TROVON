...
{
int V_40 ;
V_40 = F_37 ( V_10 , V_30 * V_10 -> V_45 . V_73 ,
V_78 * 2 , & V_57 -> V_79 ) ;
if ( V_40 )
goto V_80;
V_40 = F_31 ( V_10 , V_57 -> V_79 . V_81 ,
V_57 -> V_79 . V_75 , & V_57 -> V_32 ) ;
if ( V_40 )
goto V_76;
V_40 = F_38 ( V_10 , & V_57 -> V_32 , & V_57 -> V_79 ) ;
if ( V_40 )
goto V_77;
return 0 ;
V_77:
...
{
F_39 ( V_10 , ( V_72 + 1 ) * V_10 -> V_45 . V_73 ,
& V_57 -> V_79 ) ;
}
struct V_3 * F_41 ( struct V_82 * V_83 ,
...
V_2 = F_43 ( sizeof( * V_2 ) , V_92 ) ;
if ( ! V_2 )
return F_42 ( - V_48 ) ;
if ( V_90 < V_93 )
V_90 = V_93 ;
V_90 = F_44 ( ( unsigned int ) V_90 ) ;
V_2 -> V_3 . V_72 = V_90 - 1 ;
F_45 ( & V_2 -> V_51 ) ;
if ( V_67 ) {
if ( F_46 ( & V_88 , V_87 , sizeof( V_88 ) ) ) {
F_4 ( V_18 , L_10 ) ;
V_40 = - V_94 ;
goto V_95;
}
...
V_40 = F_7 ( V_10 , V_90 , & V_2 -> V_79 . V_32 , V_59 ,
V_2 , V_35 ) ;
if ( V_40 ) {
F_4 ( V_18 , L_13 ) ;
goto V_77;
...
V_2 -> V_103 = V_90 ;
if ( V_67 ) {
if ( F_48 ( V_87 , & V_2 -> V_19 , sizeof( T_2 ) ) ) {
V_40 = - V_94 ;
goto V_104;
}
}
...
struct V_1 * V_2 = F_51 ( V_3 ) ;
int V_40 = 0 ;
if ( V_10 -> V_55 -> V_105 ) {
V_40 = V_10 -> V_55 -> V_105 ( V_3 ) ;
} else {
F_24 ( V_10 , V_2 ) ;
F_34 ( V_10 , & V_2 -> V_79 . V_32 ) ;
if ( V_3 -> V_106 )
...
void F_52 ( struct V_9 * V_10 , T_3 V_19 )
{
struct V_13 * V_18 = & V_10 -> V_17 -> V_18 ;
struct V_1 * V_23 ;
V_23 = F_53 ( & V_10 -> V_37 . V_52 ,
V_19 & ( V_10 -> V_45 . V_107 - 1 ) ) ;
if ( ! V_23 ) {
F_54 ( V_18 , L_14 , V_19 ) ;
return;
}
...
void F_55 ( struct V_9 * V_10 , T_3 V_19 , int V_8 )
{
struct V_36 * V_37 = & V_10 -> V_37 ;
struct V_13 * V_18 = & V_10 -> V_17 -> V_18 ;
struct V_1 * V_23 ;
...
struct V_36 * V_37 = & V_10 -> V_37 ;
F_45 ( & V_37 -> V_51 ) ;
F_58 ( & V_37 -> V_52 , V_108 ) ;
return F_59 ( & V_37 -> V_47 , V_10 -> V_45 . V_107 ,
V_10 -> V_45 . V_107 - 1 ,
V_10 -> V_45 . V_109 , 0 ) ;
}
