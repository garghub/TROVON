...
goto V_34;
F_19 ( V_2 ) ;
for ( V_23 = 512 * 1024 ; V_23 < V_35 ; V_23 += 512 * 1024 ) {
F_49 ( V_2 , V_32 + ( V_23 >> 1 ) ) ;
F_63 ( V_2 , V_36 ) ;
F_23 ( V_2 ) ;
F_47 ( V_2 , V_32 + ( V_23 >> 1 ) ) ;
F_65 ( V_2 ) ;
if ( F_65 ( V_2 ) != V_36 )
break;
F_19 ( V_2 ) ;
...
;
F_5 ( & V_2 -> V_7 , V_6 ) ;
F_1 ( ( V_2 ) , F_67 ( V_2 ) , F_68 ( 1 , ( 30 ) ) , 0x4828 ) ;
F_69 ( 0x3C , F_4 ( V_2 ) ) ;
F_69 ( 0 , F_70 ( V_2 ) ) ;
...
int
F_75 ( struct V_1 * V_2 , int V_12 , const void T_1 * V_48 , long V_49 )
{
struct V_50 V_51 ;
...
if ( V_49 < ( long ) sizeof( V_51 ) || F_77 ( & V_51 , V_48 , sizeof( V_51 ) ) )
return - V_56 ;
V_57 [ V_12 ] = V_51 ;
V_58 [ V_12 ] = 1 ;
return 0 ;
...
int
F_79 ( struct V_1 * V_2 , int V_12 , const void T_1 * V_48 , long V_49 )
{
struct V_66 V_51 ;
...
static int F_81 ( struct V_76 * V_77 , struct V_78 * V_79 )
{
V_79 -> type = V_80 ;
V_79 -> V_81 = 1 ;
...
static int F_82 ( struct V_76 * V_77 , struct V_85 * V_86 )
{
struct V_1 * V_2 = F_83 ( V_77 ) ;
V_86 -> V_82 . integer . V_82 [ 0 ] = V_77 -> V_87 ? V_2 -> V_45 : V_2 -> V_43 ;
return 0 ;
}
static int F_84 ( struct V_76 * V_77 , struct V_85 * V_86 )
{
struct V_1 * V_2 = F_83 ( V_77 ) ;
unsigned long V_6 ;
int V_88 ;
...
static int F_85 ( struct V_76 * V_77 , struct V_78 * V_79 )
{
V_79 -> type = V_80 ;
V_79 -> V_81 = 1 ;
V_79 -> V_82 . integer . V_83 = 0 ;
...
static int F_87 ( struct V_76 * V_77 , struct V_85 * V_86 )
{
struct V_1 * V_2 = F_83 ( V_77 ) ;
unsigned long V_6 ;
int V_88 ;
...
static int F_88 ( struct V_76 * V_77 , struct V_78 * V_79 )
{
V_79 -> type = V_80 ;
V_79 -> V_81 = 1 ;
V_79 -> V_82 . integer . V_83 = 0 ;
...
static int F_90 ( struct V_76 * V_77 , struct V_85 * V_86 )
{
struct V_1 * V_2 = F_83 ( V_77 ) ;
unsigned long V_6 ;
int V_88 ;
...
static int
F_91 ( struct V_91 * V_92 , struct V_1 * V_2 )
{
int V_24 , V_93 = 0 ;
if ( F_92 ( ! V_2 || ! V_92 ) )
return - V_55 ;
...
if ( ( V_93 = F_94 ( V_92 , V_2 -> V_94 [ V_24 ] = F_95 ( V_96 [ V_24 ] , V_2 ) ) ) < 0 )
goto V_97;
}
return 0 ;
V_97:
...
F_96 ( & V_92 -> V_98 ) ;
if ( V_2 -> V_94 [ V_24 ] )
F_97 ( V_92 , V_2 -> V_94 [ V_24 ] ) ;
F_98 ( & V_92 -> V_98 ) ;
}
return V_93 ;
}
static int F_99 ( struct V_1 * V_99 )
{
F_100 ( V_99 -> V_100 ) ;
F_100 ( V_99 -> V_101 ) ;
F_100 ( V_99 -> V_102 ) ;
...
int
F_103 ( struct V_91 * V_92 , int V_106 , long V_3 , int V_107 ,
struct V_108 * * V_109 )
{
struct V_108 * V_110 ;
struct V_1 * V_99 ;
...
if ( ! ( V_99 -> V_100 = F_105 ( V_99 -> V_20 , 4 , L_5 ) ) ||
! ( V_99 -> V_101 = F_105 ( V_99 -> V_116 , 4 , L_6 ) ) ||
! ( V_99 -> V_102 = F_105 ( V_99 -> V_117 , 4 , L_7 ) ) ) {
F_76 ( V_118 L_8 , V_99 -> V_20 , V_99 -> V_116 , V_99 -> V_117 ) ;
F_99 ( V_99 ) ;
return - V_119 ;
}
V_99 -> V_37 = 0 ;
...
F_71 ( V_99 ) ;
if ( ( V_93 = F_91 ( V_92 , V_99 ) ) < 0 ) {
F_99 ( V_99 ) ;
return V_93 ;
}
if ( ( V_93 = F_106 ( V_92 , V_120 , V_99 , & V_112 ) ) < 0 ) {
F_99 ( V_99 ) ;
return V_93 ;
}
#if F_107 ( V_121 )
if ( F_108 ( V_92 , V_106 , V_122 ,
sizeof( struct V_1 * ) , & V_110 ) >= 0 ) {
strcpy ( V_110 -> V_123 , L_9 ) ;
* (struct V_1 * * ) F_109 ( V_110 ) = V_99 ;
}
#else
V_110 = NULL ;
#endif
