...
break;
case V_63 :
if ( V_36 ( & V_32 -> V_64 ) != sizeof( T_7 )
|| V_36 ( & V_32 -> V_65 ) != sizeof( V_66 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
break;
case V_67 : {
T_8 * const V_68 = ( T_8 * ) V_32 ;
if ( V_36 ( & V_68 -> V_64 ) != sizeof( T_8 )
|| V_36 ( & V_68 -> V_65 ) != sizeof( V_69 ) ) {
fprintf ( V_10 ,
L_7 , V_6 ) ;
F_7 () ;
}
...
for ( V_17 = 1 ; V_17 < V_70 ; V_17 ++ ) {
char * V_73 = V_71 [ V_17 ] ;
int const V_74 = setjmp ( V_75 ) ;
switch ( V_74 ) {
default:
fprintf ( V_10 , L_9 , V_73 ) ;
exit ( 1 ) ;
break;
case V_76 :
V_5 = - 1 ;
