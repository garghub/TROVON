...
int
F_61 ( struct V_21 * V_22 , T_4 V_300 )
{
struct V_301 V_302 ;
...
int
F_62 ( struct V_21 * V_22 , T_1 V_144 ,
struct V_87 * V_88 ,
unsigned int V_304 )
{
struct V_305 V_306 ;
...
V_306 . V_144 = F_50 ( V_144 ) ;
if ( V_144 == V_35 ) {
V_306 . V_308 = V_88 -> V_63 ;
V_307 = F_63 ( V_309 ) ;
V_306 . V_308 |= ( V_307 << 2 ) ;
V_306 . V_86 =
F_64 ( V_88 -> V_310 ) ;
V_306 . V_304 = F_37 ( V_304 ) ;
}
if ( F_8 ( V_22 , V_311 ,
V_144 , 0 , & V_306 , true ) ) {
F_5 ( V_22 -> V_12 , ERROR ,
...
int
F_65 ( struct V_21 * V_22 ,
struct V_312 * log )
{
return F_8 ( V_22 , V_313 ,
V_158 , 0 , log , true ) ;
}
...
return F_8 ( V_22 , V_316 , V_144 , 0 , V_315 , true ) ;
}
int
F_67 ( struct V_21 * V_22 , T_4 V_327 ,
T_4 V_328 , T_4 V_329 )
{
struct V_314 V_315 ;
V_315 . type = V_327 ;
V_315 . V_330 = V_328 ;
V_315 . V_331 = V_329 ;
return F_66 ( V_22 , & V_315 , V_35 ) ;
}
int
F_68 ( struct V_21 * V_22 , T_4 V_327 ,
T_4 V_328 , T_4 * V_331 )
{
int V_24 ;
struct V_314 V_315 ;
...
int
F_69 ( struct V_21 * V_22 , T_1 V_330 , T_1 V_332 ,
T_2 * V_331 )
{
int V_24 ;
struct V_333 V_334 ;
...
V_158 , 0 , & V_334 , true ) ;
if ( ! V_24 )
memcpy ( V_331 , V_334 . V_331 , F_70 ( ( T_1 ) V_337 ,
V_334 . V_335 ) ) ;
return V_24 ;
}
static int
F_71 ( struct V_21 * V_22 , T_2 * V_231 ,
T_1 V_232 )
{
int V_24 = 0 ;
struct V_338 * V_339 ;
const T_2 V_340 [] = { 0x00 , 0x50 , 0xf2 , 0x01 } ;
const T_2 V_341 [] = { 0x00 , 0x50 , 0xf2 , 0x04 } ;
T_1 V_342 = V_232 ;
int V_343 = 0 ;
if ( ! V_232 ) {
V_22 -> V_344 = 0 ;
V_22 -> V_345 . V_346 = false ;
return 0 ;
} else if ( ! V_231 ) {
return - 1 ;
}
V_339 = (struct V_338 * ) V_231 ;
while ( V_339 ) {
if ( V_339 -> V_347 == V_235 ) {
if ( ! memcmp ( V_339 -> V_348 , V_340 ,
sizeof( V_340 ) ) ) {
V_343 = 1 ;
break;
}
if ( ! memcmp ( V_339 -> V_348 , V_341 ,
sizeof( V_341 ) ) ) {
V_22 -> V_345 . V_346 = true ;
F_5 ( V_22 -> V_12 , V_286 ,
L_40 ) ;
V_24 = F_54 ( V_22 ,
( T_2 * ) V_339 ,
...
if ( V_339 -> V_347 == V_237 ) {
V_343 = 1 ;
break;
}
if ( V_339 -> V_347 == V_241 ) {
V_24 = F_53 ( V_22 , ( T_2 * ) V_339 ,
V_342 ) ;
return V_24 ;
}
V_342 -= ( V_339 -> V_48 +
sizeof( struct V_349 ) ) ;
if ( V_342 <= sizeof( struct V_349 ) )
V_339 = NULL ;
else
V_339 = (struct V_338 * )
( ( ( T_2 * ) V_339 ) + V_339 -> V_48 +
sizeof( struct V_349 ) ) ;
}
if ( V_343 ) {
V_24 = F_52 ( V_22 , ( T_2 * ) V_339 ,
V_342 ) ;
V_22 -> V_345 . V_346 = false ;
return V_24 ;
}
if ( V_232 < ( sizeof( V_22 -> V_350 ) - V_22 -> V_344 ) ) {
memcpy ( V_22 -> V_350 + V_22 -> V_344 , V_231 ,
V_232 ) ;
V_22 -> V_344 += V_232 ;
} else {
V_24 = - 1 ;
...
case V_353 :
if ( V_144 == V_158 ) {
V_352 -> V_48 = V_22 -> V_234 ;
memcpy ( V_352 -> V_354 , V_22 -> V_233 , V_352 -> V_48 ) ;
} else {
F_71 ( V_22 , V_352 -> V_354 ,
( T_1 ) V_352 -> V_48 ) ;
}
break;
case V_355 :
memset ( V_12 -> V_356 , 0 , sizeof( V_12 -> V_356 ) ) ;
if ( V_352 -> V_48 > V_357 ) {
V_12 -> V_358 = 0 ;
F_5 ( V_12 , ERROR ,
L_41 ) ;
...
memcpy ( V_12 -> V_356 , V_352 -> V_354 ,
V_352 -> V_48 ) ;
V_12 -> V_358 = V_352 -> V_48 ;
}
break;
default:
F_5 ( V_12 , ERROR , L_42 ) ;
...
int
F_73 ( struct V_21 * V_22 , const T_2 * V_359 , int V_232 )
{
struct V_351 V_352 ;
if ( V_232 > V_360 )
return - V_361 ;
V_352 . type = V_353 ;
V_352 . V_48 = V_232 ;
memcpy ( V_352 . V_354 , V_359 , V_232 ) ;
if ( F_72 ( V_22 , & V_352 , V_35 ) )
return - V_361 ;
return 0 ;
}
int F_74 ( struct V_21 * V_22 , T_1 V_144 ,
int V_145 ,
struct V_362 * V_363 )
{
int V_15 = 0 ;
