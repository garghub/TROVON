...
V_50 = F_76 ( V_18 , 1 ) ;
V_50 -> V_81 = V_39 -> V_47 -> V_82 ;
V_50 -> V_78 . V_83 = V_67 << ( V_39 -> V_22 - 9 ) ;
V_50 -> V_84 = F_65 ;
V_50 -> V_51 = V_10 ;
F_77 ( V_50 , V_85 , 0 ) ;
V_71 = V_12 ;
...
static int F_80 ( struct V_90 * V_91 , struct V_10 * V_10 )
{
struct V_39 * V_39 = V_10 -> V_20 -> V_21 ;
struct V_50 * V_50 = NULL ;
int V_61 ;
int V_92 = V_57 >> V_39 -> V_22 ;
T_3 V_69 ;
T_3 V_67 ;
int V_64 ;
unsigned int V_41 ;
...
static int F_81 ( struct V_10 * V_10 , T_1 V_26 )
{
struct V_1 * V_2 ;
int V_94 = 1 ;
int V_12 ;
...
struct V_1 * F_84 ( struct V_39 * V_39 , unsigned long V_40 ,
...
if ( V_97 )
V_20 = F_67 ( V_39 -> V_47 ) -> V_104 -> V_105 ;
else {
...
void F_104 ( struct V_39 * V_113 , T_4 V_114 , int V_41 )
{
T_3 V_40 ;
int V_99 = V_73 - V_113 -> V_22 ;
int V_115 = 1 << V_99 ;
struct V_101 * V_20 =
F_67 ( V_113 -> V_47 ) -> V_104 -> V_105 ;
struct V_1 * V_2 ;
struct V_10 * V_10 ;
unsigned int V_12 ;
for ( V_40 = V_114 & ~ ( V_115 - 1 ) ; V_40 < V_114 + V_41 ;
V_40 += V_115 ) {
V_10 = F_105 ( V_20 , V_40 >> V_99 ) ;
if ( ! V_10 )
continue;
for ( V_12 = 0 ; V_12 < V_57 ; V_12 += V_58 ) {
V_2 = F_17 ( V_10 , V_12 ) ;
...
static int F_106 ( struct V_116 * V_117 , void * V_118 )
{
F_107 ( V_117 ,
L_23
L_24
...
static int F_108 ( struct V_39 * V_39 , struct V_90 * V_90 )
{
return F_109 ( V_90 , F_106 , NULL ) ;
}
