...
static void F_51 ( struct V_53 * V_135 )
{
struct V_31 * V_32 ;
int V_136 ;
for ( V_136 = 0 ; V_136 < V_112 ; V_136 ++ ) {
V_32 = V_135 -> V_113 [ V_136 ] . V_32 ;
if ( V_32 )
F_52 ( V_32 ) ;
V_32 = V_135 -> V_114 [ V_136 ] . V_32 ;
if ( V_32 )
F_52 ( V_32 ) ;
}
}
static void F_53 ( struct V_53 * V_6 )
{
F_51 ( V_6 ) ;
}
static int F_54 ( struct V_53 * V_6 )
{
struct V_7 * V_7 = V_6 -> V_6 . V_7 ;
struct V_137 * V_138 = V_7 -> V_6 ;
struct V_139 * V_140 = V_138 -> V_141 -> V_142 ;
struct V_1 * V_2 ;
int V_143 ;
int V_136 ;
int V_56 ;
V_143 = F_55 ( V_140 , L_2 ) ;
if ( V_143 < 0 )
return V_143 ;
for ( V_136 = 0 ; V_136 < V_143 ; V_136 ++ ) {
struct V_31 * V_32 ;
struct V_68 * V_144 ;
const char * V_145 ;
unsigned V_5 ;
unsigned int V_91 ;
V_56 = F_56 ( V_140 , L_2 , V_136 , & V_145 ) ;
if ( V_56 )
goto V_146;
if ( F_57 ( V_145 , L_3 ) )
V_5 = 1 ;
else if ( F_57 ( V_145 , L_4 ) )
V_5 = 0 ;
else {
F_58 ( V_138 , L_5 , V_145 ) ;
goto V_146;
}
V_56 = F_59 ( V_145 + 2 , 0 , & V_91 ) ;
if ( V_56 )
goto V_146;
V_56 = - V_147 ;
if ( V_91 > V_112 || ! V_91 )
...
struct V_109 *
F_67 ( struct V_7 * V_7 , void T_3 * V_151 )
{
struct V_53 * V_6 ;
int V_56 = 0 ;
if ( ! V_7 -> V_6 -> V_141 -> V_142 ) {
F_58 ( V_7 -> V_6 , L_7 ) ;
return NULL ;
}
V_6 = F_68 ( sizeof( * V_6 ) , V_152 ) ;
if ( ! V_6 )
goto V_153;
F_69 ( & V_6 -> V_58 , V_154 , V_86 ) ;
V_6 -> V_58 . V_155 = F_17 ;
F_60 ( & V_6 -> V_62 ) ;
V_6 -> V_6 . V_156 = F_39 ;
V_6 -> V_6 . V_157 = F_41 ;
