...
struct V_1 * V_143 ;
struct V_92 * V_81 ;
V_143 = F_42 ( V_138 , V_19 ) ;
V_81 = F_38 ( V_135 , V_19 ) ;
if ( ! V_143 )
continue;
V_143 -> V_57 = V_81 ;
V_137 = F_55 ( V_143 ) ;
