...
static void F_110 ( struct V_62 * V_63 )
{
struct V_58 * V_59 = F_41 ( V_63 ) ;
F_107 ( V_59 ) ;
F_111 ( & V_59 -> V_180 ) ;
...
struct V_62 * F_113 ( struct V_190 * V_191 ,
T_1 V_192 ,
enum V_193 type ,
const char * V_194 ,
unsigned char V_195 ,
void (* F_114)( struct V_62 * ) )
{
struct V_1 * V_2 = F_115 ( V_191 ) ;
struct V_58 * V_59 ;
struct V_62 * V_63 ;
struct V_196 * V_197 ;
...
V_63 = F_117 ( V_198 , V_194 , V_195 , F_114 ,
V_2 -> V_203 , V_204 ) ;
if ( ! V_63 )
return F_116 ( - V_34 ) ;
V_197 = F_118 ( V_63 ) ;
...
V_197 -> V_205 = F_110 ;
V_197 -> V_206 = F_109 ;
V_63 -> V_207 = V_208 | V_209 ;
V_63 -> V_210 = V_63 -> V_207 ;
V_63 -> V_211 = V_63 -> V_207 ;
V_63 -> V_212 = F_119 ( V_213 ) ;
V_63 -> V_214 = & V_215 ;
F_120 ( & V_59 -> V_180 ) ;
for ( V_64 = 0 ; V_64 < V_59 -> V_77 ; V_64 ++ ) {
struct V_149 * V_150 = & V_59 -> V_150 [ V_64 ] ;
...
V_150 -> V_59 = V_59 ;
V_150 -> V_63 = V_63 ;
F_121 ( V_63 , & V_150 -> V_163 , F_63 , 64 ) ;
}
V_154 = F_102 ( V_59 ) ;
if ( V_154 )
goto V_216;
