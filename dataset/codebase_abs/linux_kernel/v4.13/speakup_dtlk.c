...
static const char * F_20 ( struct V_11 * V_12 , const char * V_33 )
{
T_1 V_8 ;
while ( ( V_8 = ( T_1 ) * V_33 ) ) {
if ( F_4 () )
...
static struct V_35 * F_24 ( struct V_11 * V_12 )
{
T_1 * V_36 ;
