...
void F_44 ( const struct V_46 * V_47 , struct V_48 * V_49 )
{
...
static inline T_1 F_47 ( struct V_29 * V_70 [] , T_2 V_103 )
{
if ( V_70 [ V_104 ] )
V_103 = F_35 ( V_70 [ V_104 ] ) ;
return V_103 ;
}
static int F_48 ( struct V_105 * V_106 , struct V_71 * V_72 ,
struct V_107 * V_108 )
{
struct V_109 * V_109 = F_49 ( V_106 -> V_110 ) ;
struct V_111 * V_112 ;
struct V_35 * V_36 = F_50 ( V_72 ) ;
...
if ( ! F_52 ( V_109 , & V_56 ) )
return - V_38 ;
V_45 = F_53 ( V_72 , sizeof( * V_36 ) , V_70 , V_113 , V_116 ,
V_108 ) ;
if ( V_45 < 0 )
return V_45 ;
V_112 = F_54 ( F_47 ( V_70 , V_36 -> V_117 ) , 0 ) ;
if ( ! V_112 )
return - V_118 ;
return V_112 -> V_119 ( V_112 , V_36 , V_70 , V_72 , & F_55 ( V_106 ) ) ;
}
static int F_56 ( struct V_105 * V_106 , struct V_71 * V_72 ,
struct V_107 * V_108 )
{
struct V_109 * V_109 = F_49 ( V_106 -> V_110 ) ;
struct V_111 * V_112 ;
...
if ( V_45 < 0 )
return V_45 ;
V_112 = F_54 ( F_47 ( V_70 , V_36 -> V_117 ) , 1 ) ;
if ( ! V_112 )
return - V_80 ;
return V_112 -> V_120 ( V_112 , V_36 , V_70 , V_72 , & F_55 ( V_106 ) ) ;
}
static void F_57 ( int V_121 , int type , T_3 V_122 , int V_123 , struct V_124 * V_125 )
{
struct V_111 * V_112 ;
struct {
struct V_71 V_72 ;
...
{
F_57 ( V_150 , V_64 , V_125 -> V_132 , 16 , V_125 ) ;
#if 0
if (!(dev->flags&IFF_UP))
return;
#endif
...
F_61 () ;
F_62 (&init_net, dev) {
V_153 = F_63 ( V_52 -> V_68 ) ;
if ( V_153 == NULL )
continue;
for ( V_154 = F_63 ( V_153 -> V_155 ) ;
V_154 != NULL ;
V_154 = F_63 ( V_154 -> V_156 ) ) {
...
F_64 () ;
if ( V_151 == 0 ) {
F_57 ( V_157 , V_64 , V_125 -> V_132 , 16 , V_125 ) ;
if ( F_26 ( V_125 -> V_132 ) != V_64 ) {
if ( F_65 ( V_125 -> V_132 , NULL , 0 ) )
F_66 () ;
}
}
}
static void F_67 ( struct V_51 * V_52 , int V_158 )
{
if ( F_65 ( 0 , V_52 , V_158 ) )
F_66 () ;
F_68 ( 0 ) ;
F_69 ( & V_159 , V_52 ) ;
}
static int F_70 ( struct V_160 * V_161 , unsigned long V_162 , void * V_163 )
{
struct V_124 * V_125 = (struct V_124 * ) V_163 ;
switch ( V_162 ) {
case V_164 :
F_58 ( V_125 ) ;
F_71 ( V_125 -> V_135 -> V_52 ) ;
F_68 ( - 1 ) ;
break;
case V_165 :
F_59 ( V_125 ) ;
if ( V_125 -> V_135 && V_125 -> V_135 -> V_155 == NULL ) {
F_67 ( V_125 -> V_135 -> V_52 , 1 ) ;
} else {
F_68 ( - 1 ) ;
}
break;
...
static int F_65 ( T_3 V_167 , struct V_51 * V_52 , int V_158 )
{
int V_168 = 0 ;
int V_66 = V_92 ;
if ( V_158 )
...
F_78 () ;
F_79 ( & V_171 ) ;
F_80 ( V_172 , V_150 , F_56 , NULL , NULL ) ;
F_80 ( V_172 , V_157 , F_48 , NULL , NULL ) ;
}
