...
return V_121 ;
do {
V_118 = V_117 & V_4 -> V_18 ;
F_71 ( & V_14 -> V_122 ) ;
V_31 = F_72 ( V_14 , V_118 ) ;
if ( ! V_31 )
V_119 = 0 ;
...
if ( ! V_4 )
return - V_162 ;
V_4 -> V_10 |= ( unsigned long ) V_143 . V_16 ;
if ( V_141 == V_163 &&
...
F_69 ( V_4 , V_2 ) ;
V_110 = F_95 ( F_96 ( V_4 -> V_114 ) , F_97 ( V_4 -> V_18 ) ) ;
...
for ( V_49 = 0 ; V_49 < V_14 -> V_110 ; V_49 ++ ) {
struct V_28 * V_29 = V_14 -> V_83 [ V_49 ] ;
F_101 ( V_29 , V_146 , - 1 , L_70 ) ;
F_101 ( V_29 , V_146 ,
0x100 + V_29 -> V_53 * 0x80 , L_71 ) ;
if ( V_29 -> V_10 & V_182 )
V_29 -> V_183 = V_4 -> V_184 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_49 ) ) )
V_29 -> V_84 = & V_185 ;
}
F_47 ( V_14 ) ;
F_66 ( V_14 ) ;
V_31 = F_41 ( V_2 , V_4 -> V_114 & V_186 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
