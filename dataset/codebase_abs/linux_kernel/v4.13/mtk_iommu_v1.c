...
L_8 , 0 ) {
int V_102 = F_51 ( & V_98 , V_96 . args ,
V_103 ) ;
V_96 . V_88 = F_52 ( V_98 . V_104 ) ;
V_96 . V_86 = V_102 ;
F_37 ( V_26 , & V_96 ) ;
F_53 ( V_96 . V_88 ) ;
}
...
static struct V_99 * F_61 ( struct V_44 * V_26 )
{
struct V_9 * V_10 = V_26 -> V_50 -> V_65 ;
if ( ! V_10 )
return F_62 ( - V_66 ) ;
...
static int F_65 ( const struct V_9 * V_10 )
{
T_2 V_31 ;
int V_19 ;
V_19 = F_66 ( V_10 -> V_106 ) ;
if ( V_19 ) {
...
if ( F_68 ( V_10 -> V_26 , V_10 -> V_27 , F_12 , 0 ,
F_69 ( V_10 -> V_26 ) , ( void * ) V_10 ) ) {
...
static int F_71 ( struct V_81 * V_121 )
{
struct V_9 * V_10 ;
...
V_10 = F_72 ( V_26 , sizeof( * V_10 ) , V_61 ) ;
if ( ! V_10 )
return - V_62 ;
V_10 -> V_26 = V_26 ;
V_127 = F_72 ( V_26 , V_129 * 2 ,
V_61 | V_130 ) ;
if ( ! V_127 )
return - V_62 ;
V_10 -> V_117 = F_73 ( F_74 ( V_127 ) , V_129 ) ;
V_123 = F_75 ( V_121 , V_131 , 0 ) ;
V_10 -> V_13 = F_76 ( V_26 , V_123 ) ;
if ( F_45 ( V_10 -> V_13 ) )
return F_46 ( V_10 -> V_13 ) ;
V_10 -> V_27 = F_77 ( V_121 , 0 ) ;
if ( V_10 -> V_27 < 0 )
return V_10 -> V_27 ;
V_10 -> V_106 = F_78 ( V_26 , L_12 ) ;
if ( F_45 ( V_10 -> V_106 ) )
...
L_13 , NULL, 0 ) {
struct V_81 * V_132 ;
int V_102 = F_51 ( & V_98 , V_126 . args ,
V_103 ) ;
if ( V_102 )
continue;
V_126 . V_88 = F_52 ( V_98 . V_104 ) ;
if ( ! F_79 ( V_126 . V_88 ) )
continue;
...
if ( V_19 )
return V_19 ;
V_19 = F_83 ( & V_10 -> V_93 , & V_121 -> V_26 , NULL ,
F_69 ( & V_121 -> V_26 ) ) ;
if ( V_19 )
return V_19 ;
F_84 ( & V_10 -> V_93 , & V_90 ) ;
...
if ( ! F_86 ( & V_94 ) )
F_87 ( & V_94 , & V_90 ) ;
return F_88 ( V_26 , & V_137 , V_125 ) ;
}
static int F_89 ( struct V_81 * V_121 )
{
...
F_87 ( & V_94 , NULL ) ;
F_70 ( V_10 -> V_106 ) ;
F_92 ( & V_121 -> V_26 , V_10 -> V_27 , V_10 ) ;
F_93 ( & V_121 -> V_26 , & V_137 ) ;
return 0 ;
}
static int T_6 F_94 ( struct V_44 * V_26 )
{
struct V_9 * V_10 = F_95 ( V_26 ) ;
...
static int T_6 F_96 ( struct V_44 * V_26 )
{
struct V_9 * V_10 = F_95 ( V_26 ) ;
struct V_138 * V_139 = & V_10 -> V_139 ;
void T_7 * V_13 = V_10 -> V_13 ;
