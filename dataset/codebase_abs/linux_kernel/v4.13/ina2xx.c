...
enum V_54 V_55 ;
if ( V_49 -> V_18 . V_56 )
V_55 = (enum V_54 ) F_30 ( & V_49 -> V_18 ) ;
else
V_55 = V_51 -> V_57 ;
V_8 = F_31 ( V_18 , sizeof( * V_8 ) , V_58 ) ;
if ( ! V_8 )
return - V_59 ;
V_8 -> V_1 = & V_60 [ V_55 ] ;
if ( F_32 ( V_18 -> V_56 , L_6 , & V_9 ) < 0 ) {
struct V_61 * V_62 = F_33 ( V_18 ) ;
if ( V_62 )
V_9 = V_62 -> V_63 ;
else
V_9 = V_64 ;
...
return - V_24 ;
V_8 -> V_11 = V_9 ;
V_65 . V_66 = V_8 -> V_1 -> V_67 ;
V_8 -> V_12 = F_34 ( V_49 , & V_65 ) ;
if ( F_35 ( V_8 -> V_12 ) ) {
F_17 ( V_18 , L_7 ) ;
