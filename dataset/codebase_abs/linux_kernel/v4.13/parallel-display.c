...
T_2 V_34 = 0 ;
const char * V_54 ;
V_8 = F_31 ( V_11 , sizeof( * V_8 ) , V_55 ) ;
if ( ! V_8 )
return - V_56 ;
V_53 = F_32 ( V_10 , L_2 , & V_8 -> V_57 ) ;
if ( V_53 )
V_8 -> V_17 = F_33 ( V_53 , V_8 -> V_57 , V_55 ) ;
V_20 = F_34 ( V_10 , L_3 , & V_54 ) ;
if ( ! V_20 ) {
if ( ! strcmp ( V_54 , L_4 ) )
V_34 = V_58 ;
else if ( ! strcmp ( V_54 , L_5 ) )
V_34 = V_59 ;
else if ( ! strcmp ( V_54 , L_6 ) )
V_34 = V_60 ;
else if ( ! strcmp ( V_54 , L_7 ) )
V_34 = V_61 ;
}
V_8 -> V_34 = V_34 ;
V_20 = F_35 ( V_10 , 1 , 0 , & V_8 -> V_14 , & V_8 -> V_46 ) ;
if ( V_20 && V_20 != - V_62 )
return V_20 ;
V_8 -> V_11 = V_11 ;
V_20 = F_20 ( V_40 , V_8 ) ;
...
static void F_37 ( struct V_50 * V_11 , struct V_50 * V_51 ,
void * V_52 )
{
struct V_1 * V_8 = F_38 ( V_11 ) ;
if ( V_8 -> V_14 )
F_39 ( V_8 -> V_14 ) ;
F_40 ( V_8 -> V_17 ) ;
}
