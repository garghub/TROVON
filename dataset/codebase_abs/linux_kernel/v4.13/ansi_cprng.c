...
const unsigned char * V_21 , const unsigned char * V_19 )
{
int V_42 ;
...
static int F_24 ( struct V_48 * V_28 ,
const T_2 * V_49 , unsigned int V_50 ,
T_2 * V_51 , unsigned int V_52 )
{
struct V_13 * V_53 = F_25 ( V_28 ) ;
return F_9 ( V_51 , V_52 , V_53 , 0 ) ;
}
static int F_26 ( struct V_48 * V_28 ,
const T_2 * V_54 , unsigned int V_50 )
{
struct V_13 * V_53 = F_25 ( V_28 ) ;
const T_2 * V_40 = V_54 + V_17 ;
const T_2 * V_55 = NULL ;
if ( V_50 < V_45 + V_17 )
return - V_27 ;
if ( V_50 >= ( 2 * V_17 + V_45 ) )
V_55 = V_40 + V_45 ;
F_14 ( V_53 , V_40 , V_45 , V_54 , V_55 ) ;
if ( V_53 -> V_25 & V_26 )
return - V_27 ;
return 0 ;
}
static int F_27 ( struct V_48 * V_28 ,
const T_2 * V_49 , unsigned int V_50 ,
T_2 * V_51 , unsigned int V_52 )
{
struct V_13 * V_53 = F_25 ( V_28 ) ;
return F_9 ( V_51 , V_52 , V_53 , 1 ) ;
}
static int F_28 ( struct V_48 * V_28 ,
const T_2 * V_54 , unsigned int V_50 )
{
T_2 V_51 [ V_17 ] ;
const T_2 * V_40 = V_54 + V_17 ;
...
if ( V_50 < V_45 + V_17 )
return - V_27 ;
if ( ! memcmp ( V_54 , V_40 , V_45 ) )
return - V_27 ;
V_56 = F_26 ( V_28 , V_54 , V_50 ) ;
if ( ! V_56 )
goto V_10;
V_56 = F_9 ( V_51 , V_17 , V_53 , 0 ) ;
V_53 -> V_29 = V_17 ;
V_10:
return V_56 ;
}
