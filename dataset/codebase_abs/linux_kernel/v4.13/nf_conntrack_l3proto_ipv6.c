...
{
struct V_95 * V_96 = F_45 ( V_42 , V_97 ) ;
int V_98 = 0 ;
F_46 ( & V_99 ) ;
V_96 -> V_100 ++ ;
if ( V_96 -> V_100 > 1 )
...
static void F_51 ( struct V_42 * V_42 )
{
struct V_95 * V_96 = F_45 ( V_42 , V_97 ) ;
F_46 ( & V_99 ) ;
if ( V_96 -> V_100 && ( -- V_96 -> V_100 == 0 ) )
F_52 ( V_42 , V_102 ,
F_49 ( V_102 ) ) ;
F_50 ( & V_99 ) ;
}
...
{
int V_103 = 0 ;
V_103 = F_54 ( V_42 , V_104 ,
F_49 ( V_104 ) ) ;
if ( V_103 < 0 )
return V_103 ;
V_103 = F_55 ( V_42 , & V_105 ) ;
if ( V_103 < 0 ) {
F_56 ( L_7 ) ;
F_57 ( V_42 , V_104 ,
F_49 ( V_104 ) ) ;
