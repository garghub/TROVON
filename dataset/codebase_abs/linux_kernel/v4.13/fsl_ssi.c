...
if ( V_19 -> V_26 < 0 ) {
F_18 ( & V_196 -> V_2 , L_22 , V_196 -> V_219 ) ;
return V_19 -> V_26 ;
}
if ( ! F_82 ( V_199 , L_23 , NULL ) ) {
if ( ! F_5 ( V_19 ) )
V_19 -> V_98 . V_99 = 1 ;
V_19 -> V_98 . V_234 = 1 ;
V_19 -> V_98 . V_235 = 1 ;
}
V_216 = F_72 ( V_199 , L_24 , NULL ) ;
if ( V_216 )
