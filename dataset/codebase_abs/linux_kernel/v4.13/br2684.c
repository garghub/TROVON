...
enum V_162 V_49 ;
F_15 ( L_8 ) ;
if ( F_52 ( & V_161 , V_33 , sizeof V_161 ) )
return - V_89 ;
...
V_49 = V_50 ;
V_161 . V_163 &= 0xffff ;
if ( V_161 . V_163 != V_165 || V_161 . V_150 != 1500 )
return - V_137 ;
V_145 = F_85 ( sizeof( struct V_7 ) ,
V_161 . V_28 [ 0 ] ? V_161 . V_28 : L_13 ,
V_166 ,
( V_49 == V_57 ) ? F_83 : F_80 ) ;
if ( ! V_145 )
return - V_122 ;
...
static int F_88 ( struct V_167 * V_168 , unsigned int V_169 ,
unsigned long V_33 )
{
struct V_14 * V_15 = F_89 ( V_168 ) ;
void T_2 * V_170 = ( void T_2 * ) V_33 ;
T_4 V_171 ;
int V_85 ;
switch ( V_169 ) {
case V_172 :
case V_173 :
V_85 = F_90 ( V_171 , ( T_4 T_2 * ) V_170 ) ;
if ( V_85 )
return - V_89 ;
if ( V_171 != V_174 )
return - V_175 ;
...
if ( ! F_91 ( V_176 ) )
return - V_177 ;
V_85 = F_51 ( V_15 , V_170 ) ;
return V_85 ;
#endif
}
return - V_175 ;
}
static void * F_92 ( struct V_181 * V_182 , T_5 * V_183 )
__acquires( V_37 )
{
F_43 ( & V_37 ) ;
return F_93 ( & V_12 , * V_183 ) ;
}
static void * F_94 ( struct V_181 * V_182 , void * V_184 , T_5 * V_183 )
{
return F_95 ( V_184 , & V_12 , V_183 ) ;
}
static void F_96 ( struct V_181 * V_182 , void * V_184 )
__releases( V_37 )
{
F_48 ( & V_37 ) ;
}
static int F_97 ( struct V_181 * V_182 , void * V_184 )
{
const struct V_7 * V_45 = F_9 ( V_184 , struct V_7 ,
V_12 ) ;
...
V_35 -> V_15 -> V_185 , V_35 -> V_15 -> V_186 ,
...
static int F_99 ( struct V_187 * V_187 , struct V_188 * V_188 )
{
