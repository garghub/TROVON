...
const char * V_220 ;
T_2 V_221 ;
V_219 = F_39 ( V_2 -> V_31 , sizeof( * V_219 ) , V_222 ) ;
if ( ! V_219 ) {
F_7 ( V_2 -> V_31 , L_20 ) ;
return NULL ;
}
if ( F_40 ( V_31 , L_21 , & V_221 ) >= 0 )
V_219 -> V_223 = F_34 ( V_2 , V_221 ) ;
else
V_219 -> V_223 = V_205 ;
if ( F_40 ( V_31 , L_22 , & V_221 ) >= 0 )
V_219 -> V_224 = F_34 ( V_2 , V_221 ) ;
else
V_219 -> V_224 = V_205 ;
if ( ! F_41 ( V_31 , L_23 , & V_220 ) )
V_219 -> V_225 = F_35 ( V_2 , V_220 ) ;
else
V_219 -> V_225 = V_210 ;
if ( ! F_41 ( V_31 , L_24 , & V_220 ) )
V_219 -> V_226 =
F_36 ( V_2 , V_220 ) ;
else
V_219 -> V_226 = V_213 ;
if ( F_40 ( V_31 , L_25 , & V_221 ) >= 0 )
V_219 -> V_227 = F_37 ( V_2 , V_221 ) ;
else
V_219 -> V_227 = V_217 ;
return V_219 ;
}
...
F_5 ( V_2 , V_236 ,
V_242 , V_242 ) ;
V_33 -> V_219 = F_43 ( V_2 -> V_31 ) ;
if ( ! V_33 -> V_219 )
V_33 -> V_219 = F_38 ( V_2 ) ;
if ( V_33 -> V_219 ) {
struct V_218 * V_219 = V_33 -> V_219 ;
T_1 V_243 = 0 , V_244 = 0 ;
switch ( V_219 -> V_223 ) {
case V_204 :
case V_205 :
...
struct V_32 * V_33 ;
int V_57 ;
V_33 = F_39 ( & V_259 -> V_31 , sizeof( struct V_32 ) ,
V_222 ) ;
if ( ! V_33 )
return - V_262 ;
F_48 ( V_259 , V_33 ) ;
V_33 -> V_263 = F_49 ( V_259 , & V_264 ) ;
if ( F_45 ( V_33 -> V_263 ) ) {
V_57 = F_46 ( V_33 -> V_263 ) ;
F_25 ( & V_259 -> V_31 , L_27 , V_57 ) ;
return V_57 ;
}
V_57 = F_50 ( & V_259 -> V_31 ,
& V_265 , & V_266 , 1 ) ;
if ( V_57 < 0 ) {
F_25 ( & V_259 -> V_31 , L_28 ,
V_57 ) ;
}
return V_57 ;
}
static int F_51 ( struct V_258 * V_267 )
{
F_52 ( & V_267 -> V_31 ) ;
return 0 ;
}
