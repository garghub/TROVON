...
static T_1 F_46 ( struct V_29 * V_46 , const char T_3 * V_37 ,
T_2 V_38 , T_5 * V_47 )
{
struct V_5 V_41 ;
if ( ! F_40 ( V_67 ) )
return - V_68 ;
if ( ! F_47 ( V_74 ) || ! F_47 ( V_75 ) )
return - V_76 ;
if ( ( unsigned long ) V_38 > sizeof( struct V_5 ) )
V_38 = sizeof( struct V_5 ) ;
if ( F_48 ( & V_41 , V_37 , V_38 ) )
return - V_45 ;
if ( V_41 . V_77 >= F_49 () || ! F_50 ( V_41 . V_77 ) )
return - V_42 ;
F_51 ( 2 ) ;
F_52 ( & V_73 , 0 , & V_41 ) ;
return V_38 ;
