...
static int F_84 ( struct V_158 * V_159 , void * V_26 )
{
struct V_7 * V_8 = F_85 ( V_26 , struct V_7 , V_168 ) ;
const char * V_169 = F_86 ( & V_8 -> V_8 . V_146 , V_89 ) ;
struct V_18 * V_19 ;
F_81 ( V_159 , L_10 ,
V_8 -> V_130 . V_134 , V_8 -> V_130 . V_136 , V_8 -> V_130 . V_138 , V_8 -> V_130 . V_140 ) ;
F_81 ( V_159 , L_11 , V_8 -> V_145 ? V_8 -> V_145 : L_9 ) ;
F_81 ( V_159 , L_12 , V_8 -> V_170 ? V_8 -> V_170 : L_9 ) ;
F_81 ( V_159 , L_13 , V_169 ? V_169 : L_9 ) ;
F_81 ( V_159 , L_14 , V_8 -> V_171 ? V_8 -> V_171 : L_9 ) ;
F_87 ( V_159 , L_15 ) ;
F_43 (handle, &dev->h_list, d_node)
F_81 ( V_159 , L_16 , V_19 -> V_145 ) ;
F_83 ( V_159 , '\n' ) ;
F_80 ( V_159 , L_17 , V_8 -> V_172 , V_173 ) ;
F_80 ( V_159 , L_18 , V_8 -> V_10 , V_87 ) ;
if ( F_2 ( V_32 , V_8 -> V_10 ) )
F_80 ( V_159 , L_19 , V_8 -> V_36 , V_37 ) ;
if ( F_2 ( V_67 , V_8 -> V_10 ) )
F_80 ( V_159 , L_20 , V_8 -> V_68 , V_69 ) ;
if ( F_2 ( V_64 , V_8 -> V_10 ) )
F_80 ( V_159 , L_21 , V_8 -> V_65 , V_66 ) ;
if ( F_2 ( V_70 , V_8 -> V_10 ) )
F_80 ( V_159 , L_22 , V_8 -> V_71 , V_72 ) ;
if ( F_2 ( V_73 , V_8 -> V_10 ) )
F_80 ( V_159 , L_23 , V_8 -> V_74 , V_75 ) ;
if ( F_2 ( V_77 , V_8 -> V_10 ) )
F_80 ( V_159 , L_24 , V_8 -> V_78 , V_79 ) ;
if ( F_2 ( V_82 , V_8 -> V_10 ) )
F_80 ( V_159 , L_25 , V_8 -> V_141 , V_142 ) ;
if ( F_2 ( V_60 , V_8 -> V_10 ) )
F_80 ( V_159 , L_26 , V_8 -> V_61 , V_62 ) ;
F_83 ( V_159 , '\n' ) ;
F_88 ( V_169 ) ;
return 0 ;
}
...
{
struct V_23 * V_24 = F_85 ( V_26 , struct V_23 , V_168 ) ;
union V_161 * V_162 = (union V_161 * ) & V_159 -> V_163 ;
F_81 ( V_159 , L_27 , V_162 -> V_160 , V_24 -> V_145 ) ;
if ( V_24 -> V_27 )
F_87 ( V_159 , L_28 ) ;
if ( V_24 -> V_177 )
F_81 ( V_159 , L_29 , V_24 -> V_178 ) ;
F_83 ( V_159 , '\n' ) ;
return 0 ;
}
...
{
struct V_180 * V_181 ;
V_182 = F_96 ( L_30 , NULL ) ;
if ( ! V_182 )
return - V_183 ;
V_181 = F_97 ( L_31 , 0 , V_182 ,
& V_184 ) ;
if ( ! V_181 )
goto V_185;
...
goto V_187;
return 0 ;
V_187: F_98 ( L_31 , V_182 ) ;
V_185: F_98 ( L_30 , NULL ) ;
return - V_183 ;
}
...
{
int V_113 = 0 , V_124 ;
V_113 += snprintf ( V_147 , V_3 ( V_188 , 0 ) , L_33 , V_145 ) ;
for ( V_124 = V_189 ; V_124 < V_190 ; V_124 ++ )
if ( V_2 [ F_101 ( V_124 ) ] & F_102 ( V_124 ) )
V_113 += snprintf ( V_147 + V_113 , V_3 ( V_188 - V_113 , 0 ) , L_34 , V_124 ) ;
return V_113 ;
}
...
'w' , V_130 -> V_61 , 0 , V_62 ) ;
if ( V_191 )
V_113 += snprintf ( V_147 + V_113 , V_3 ( V_188 - V_113 , 0 ) , L_36 ) ;
return V_113 ;
}
...
if ( V_113 == 0 )
V_113 = snprintf ( V_147 , V_148 , L_37 , 0 ) ;
if ( V_191 )
V_113 += snprintf ( V_147 + V_113 , V_3 ( V_148 - V_113 , 0 ) , L_36 ) ;
return V_113 ;
}
...
if ( V_8 -> V_145 )
F_117 ( L_41 , V_8 -> V_145 ) ;
if ( V_8 -> V_170 )
F_117 ( L_42 , V_8 -> V_170 ) ;
if ( V_8 -> V_171 )
F_117 ( L_43 , V_8 -> V_171 ) ;
F_118 ( L_44 , V_8 -> V_172 , V_173 ) ;
F_118 ( L_45 , V_8 -> V_10 , V_87 ) ;
if ( F_2 ( V_32 , V_8 -> V_10 ) )
F_118 ( L_46 , V_8 -> V_36 , V_37 ) ;
if ( F_2 ( V_67 , V_8 -> V_10 ) )
F_118 ( L_47 , V_8 -> V_68 , V_69 ) ;
if ( F_2 ( V_64 , V_8 -> V_10 ) )
F_118 ( L_48 , V_8 -> V_65 , V_66 ) ;
if ( F_2 ( V_70 , V_8 -> V_10 ) )
F_118 ( L_49 , V_8 -> V_71 , V_72 ) ;
if ( F_2 ( V_73 , V_8 -> V_10 ) )
F_118 ( L_50 , V_8 -> V_74 , V_75 ) ;
if ( F_2 ( V_77 , V_8 -> V_10 ) )
F_118 ( L_51 , V_8 -> V_78 , V_79 ) ;
if ( F_2 ( V_82 , V_8 -> V_10 ) )
F_118 ( L_52 , V_8 -> V_141 , V_142 ) ;
if ( F_2 ( V_60 , V_8 -> V_10 ) )
F_118 ( L_53 , V_8 -> V_61 , V_62 ) ;
F_119 ( V_8 ) ;
return 0 ;
}
...
{
return F_128 ( V_89 , L_54 , F_129 ( V_8 ) ) ;
}
struct V_7 * F_130 ( void )
{
static T_6 V_205 = F_131 ( - 1 ) ;
struct V_7 * V_8 ;
V_8 = F_132 ( sizeof( * V_8 ) , V_89 ) ;
if ( V_8 ) {
V_8 -> V_8 . type = & V_206 ;
V_8 -> V_8 . V_207 = & V_208 ;
F_133 ( & V_8 -> V_8 ) ;
...
int F_176 ( struct V_23 * V_24 , void * V_15 ,
int (* F_177)( struct V_18 * , void * ) )
{
struct V_18 * V_19 ;
int V_97 = 0 ;
F_11 () ;
F_13 (handle, &handler->h_list, h_node) {
V_97 = F_177 ( V_19 , V_15 ) ;
if ( V_97 )
break;
}
F_14 () ;
...
int F_183 ( int V_240 , unsigned int V_241 ,
bool V_242 )
{
if ( V_240 >= 0 ) {
int V_178 = F_184 ( & V_243 ,
V_240 ,
V_240 + V_241 ,
V_89 ) ;
if ( V_178 >= 0 || ! V_242 )
