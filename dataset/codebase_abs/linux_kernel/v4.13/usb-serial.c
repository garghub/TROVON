...
static int F_96 ( struct V_1 * V_5 ,
struct V_122 * V_123 )
{
struct V_43 * type = V_5 -> V_4 -> type ;
struct V_100 * V_137 = V_5 -> V_4 -> V_15 ;
int V_138 ;
int V_12 ;
V_138 = F_97 ( int , type -> V_139 , F_98 ( V_123 ) ) ;
V_5 -> V_139 = V_138 ;
V_5 -> V_140 = V_123 -> V_141 ;
for ( V_12 = 0 ; V_12 < F_63 ( V_5 -> V_90 ) ; ++ V_12 ) {
F_99 ( V_12 , & V_5 -> V_142 ) ;
V_5 -> V_90 [ V_12 ] = F_100 ( 0 , V_18 ) ;
if ( ! V_5 -> V_90 [ V_12 ] )
return - V_143 ;
V_5 -> V_95 [ V_12 ] = F_101 ( V_138 , V_18 ) ;
if ( ! V_5 -> V_95 [ V_12 ] )
return - V_143 ;
F_102 ( V_5 -> V_90 [ V_12 ] , V_137 ,
F_103 ( V_137 , V_123 -> V_141 ) ,
V_5 -> V_95 [ V_12 ] , V_138 ,
type -> V_144 , V_5 ) ;
}
V_5 -> V_145 = V_5 -> V_90 [ 0 ] ;
V_5 -> V_146 = V_5 -> V_95 [ 0 ] ;
return 0 ;
}
...
V_138 = F_98 ( V_123 ) ;
V_5 -> V_148 = V_138 ;
V_5 -> V_149 = V_123 -> V_141 ;
for ( V_12 = 0 ; V_12 < F_63 ( V_5 -> V_91 ) ; ++ V_12 ) {
F_99 ( V_12 , & V_5 -> V_150 ) ;
V_5 -> V_91 [ V_12 ] = F_100 ( 0 , V_18 ) ;
if ( ! V_5 -> V_91 [ V_12 ] )
return - V_143 ;
V_5 -> V_96 [ V_12 ] = F_101 ( V_138 , V_18 ) ;
if ( ! V_5 -> V_96 [ V_12 ] )
return - V_143 ;
F_102 ( V_5 -> V_91 [ V_12 ] , V_137 ,
F_106 ( V_137 , V_123 -> V_141 ) ,
V_5 -> V_96 [ V_12 ] , V_138 ,
type -> V_151 , V_5 ) ;
}
V_5 -> V_152 = V_5 -> V_91 [ 0 ] ;
V_5 -> V_153 = V_5 -> V_96 [ 0 ] ;
return 0 ;
}
static int F_107 ( struct V_1 * V_5 ,
struct V_122 * V_123 )
{
struct V_43 * type = V_5 -> V_4 -> type ;
struct V_100 * V_137 = V_5 -> V_4 -> V_15 ;
int V_138 ;
V_5 -> V_92 = F_100 ( 0 , V_18 ) ;
if ( ! V_5 -> V_92 )
return - V_143 ;
V_138 = F_98 ( V_123 ) ;
V_5 -> V_154 = V_123 -> V_141 ;
V_5 -> V_98 = F_101 ( V_138 , V_18 ) ;
if ( ! V_5 -> V_98 )
return - V_143 ;
F_108 ( V_5 -> V_92 , V_137 ,
F_109 ( V_137 , V_123 -> V_141 ) ,
V_5 -> V_98 , V_138 ,
type -> V_155 , V_5 ,
V_123 -> V_156 ) ;
return 0 ;
}
static int F_110 ( struct V_1 * V_5 ,
struct V_122 * V_123 )
{
struct V_43 * type = V_5 -> V_4 -> type ;
struct V_100 * V_137 = V_5 -> V_4 -> V_15 ;
int V_138 ;
V_5 -> V_93 = F_100 ( 0 , V_18 ) ;
if ( ! V_5 -> V_93 )
return - V_143 ;
V_138 = F_98 ( V_123 ) ;
V_5 -> V_157 = V_138 ;
V_5 -> V_158 = V_123 -> V_141 ;
V_5 -> V_99 = F_101 ( V_138 , V_18 ) ;
if ( ! V_5 -> V_99 )
return - V_143 ;
F_108 ( V_5 -> V_93 , V_137 ,
F_111 ( V_137 , V_123 -> V_141 ) ,
V_5 -> V_99 , V_138 ,
type -> V_159 , V_5 ,
V_123 -> V_156 ) ;
return 0 ;
}
static int F_112 ( struct V_101 * V_14 ,
const struct V_102 * V_108 )
{
struct V_94 * V_160 = & V_14 -> V_15 ;
struct V_100 * V_15 = F_113 ( V_14 ) ;
struct V_3 * V_4 = NULL ;
struct V_1 * V_5 ;
struct V_118 * V_119 ;
...
F_116 ( V_160 , L_25 , type -> V_75 ) ;
V_161 = F_117 ( V_119 -> V_133 , V_119 -> V_134 ) ;
V_161 = F_117 ( V_161 , V_119 -> V_135 ) ;
V_161 = F_117 ( V_161 , V_119 -> V_136 ) ;
V_161 = F_117 ( V_161 , V_4 -> V_11 ) ;
V_4 -> V_23 = V_161 ;
F_7 ( V_160 , L_26 , V_161 ) ;
...
F_120 ( & V_5 -> V_88 , F_60 ) ;
V_4 -> V_5 [ V_12 ] = V_5 ;
V_5 -> V_15 . V_171 = & V_14 -> V_15 ;
V_5 -> V_15 . V_25 = NULL ;
V_5 -> V_15 . V_172 = & V_173 ;
V_5 -> V_15 . V_22 = & F_67 ;
V_5 -> V_15 . V_174 = V_175 ;
F_121 ( & V_5 -> V_15 ) ;
}
for ( V_12 = 0 ; V_12 < V_119 -> V_133 ; ++ V_12 ) {
V_30 = F_96 ( V_4 -> V_5 [ V_12 ] , V_119 -> V_124 [ V_12 ] ) ;
if ( V_30 )
goto V_166;
}
for ( V_12 = 0 ; V_12 < V_119 -> V_134 ; ++ V_12 ) {
V_30 = F_104 ( V_4 -> V_5 [ V_12 ] ,
V_119 -> V_126 [ V_12 ] ) ;
if ( V_30 )
goto V_166;
}
...
for ( V_12 = 0 ; V_12 < V_11 ; ++ V_12 ) {
V_5 = V_4 -> V_5 [ V_12 ] ;
F_123 ( & V_5 -> V_15 , L_30 , V_5 -> V_2 ) ;
F_7 ( V_160 , L_31 , F_124 ( & V_5 -> V_15 ) ) ;
F_125 ( & V_5 -> V_15 ) ;
V_30 = F_126 ( & V_5 -> V_15 ) ;
if ( V_30 )
F_114 ( V_160 , L_32 ) ;
...
static void F_128 ( struct V_101 * V_14 )
{
int V_12 ;
struct V_3 * V_4 = F_129 ( V_14 ) ;
...
int F_138 ( struct V_101 * V_103 , T_2 V_179 )
{
struct V_3 * V_4 = F_129 ( V_103 ) ;
int V_12 , V_180 = 0 ;
V_4 -> V_181 = 1 ;
if ( V_4 -> type -> V_182 ) {
...
static int F_142 ( struct V_101 * V_103 )
{
struct V_3 * V_4 = F_129 ( V_103 ) ;
int V_184 ;
F_139 ( V_4 ) ;
...
static void F_159 ( struct V_43 * V_94 )
{
F_160 ( V_94 , V_40 ) ;
F_160 ( V_94 , V_52 ) ;
F_160 ( V_94 , V_45 ) ;
...
static int F_161 ( struct V_43 * V_25 )
{
int V_30 ;
if ( F_162 () )
return - V_31 ;
...
F_159 ( V_25 ) ;
F_2 ( & V_6 ) ;
F_164 ( & V_25 -> V_219 , & V_220 ) ;
V_30 = F_165 ( V_25 ) ;
if ( V_30 ) {
F_146 ( L_42 , V_30 , V_25 -> V_75 ) ;
F_166 ( & V_25 -> V_219 ) ;
} else {
F_167 ( L_43 , V_25 -> V_75 ) ;
}
F_4 ( & V_6 ) ;
return V_30 ;
}
static void F_168 ( struct V_43 * V_94 )
{
F_167 ( L_44 , V_94 -> V_75 ) ;
F_2 ( & V_6 ) ;
F_166 ( & V_94 -> V_219 ) ;
F_4 ( & V_6 ) ;
F_169 ( V_94 ) ;
}
int F_170 ( struct V_43 * const V_221 [] ,
const char * V_193 ,
...
void F_172 ( struct V_43 * const V_221 [] )
{
