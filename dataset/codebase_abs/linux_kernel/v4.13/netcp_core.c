...
static int F_174 ( struct V_207 * V_36 , T_2 V_291 , T_2 V_292 ,
T_9 V_285 , struct V_293 * V_294 )
{
T_8 V_295 ;
int V_16 ;
F_175 () ;
if ( V_294 -> type != V_296 )
return - V_62 ;
V_294 -> V_297 -> V_298 = V_299 ;
V_295 = V_294 -> V_297 -> V_295 ;
if ( ( V_36 -> V_300 <= 1 ) ||
( V_36 -> V_300 < V_295 ) )
return - V_62 ;
if ( V_295 ) {
...
static void
F_179 ( struct V_207 * V_30 , struct V_301 * V_99 )
{
struct V_27 * V_28 = F_125 ( V_30 ) ;
struct V_97 * V_302 = & V_28 -> V_99 ;
T_11 V_303 , V_304 , V_305 , V_306 ;
unsigned int V_307 ;
do {
V_307 = F_180 ( & V_302 -> V_131 ) ;
V_303 = V_302 -> V_132 ;
V_304 = V_302 -> V_133 ;
} while ( F_181 ( & V_302 -> V_131 , V_307 ) );
do {
V_307 = F_180 ( & V_302 -> V_176 ) ;
V_305 = V_302 -> V_177 ;
V_306 = V_302 -> V_178 ;
} while ( F_181 ( & V_302 -> V_176 , V_307 ) );
V_99 -> V_132 = V_303 ;
V_99 -> V_133 = V_304 ;
V_99 -> V_177 = V_305 ;
V_99 -> V_178 = V_306 ;
V_99 -> V_103 = V_302 -> V_103 ;
V_99 -> V_104 = V_302 -> V_104 ;
V_99 -> V_210 = V_302 -> V_210 ;
}
...
V_30 -> V_315 |= V_316 ;
V_30 -> V_315 |= V_317 ;
V_30 -> V_318 = V_30 -> V_315 ;
V_30 -> V_319 |= V_316 ;
V_30 -> V_320 = V_321 ;
V_30 -> V_322 = V_323 - ( V_324 + V_123 ) ;
V_28 = F_125 ( V_30 ) ;
F_184 ( & V_28 -> V_81 ) ;
F_185 ( & V_28 -> V_59 ) ;
F_185 ( & V_28 -> V_325 ) ;
...
V_28 -> V_30 = V_30 ;
V_28 -> V_94 = & V_30 -> V_36 ;
V_28 -> V_327 = F_187 ( V_328 , V_329 ) ;
V_28 -> V_213 = V_330 ;
V_28 -> V_174 = V_28 -> V_213 ;
V_28 -> V_56 = V_56 ;
V_29 = F_188 ( V_56 , L_62 , & V_19 ) ;
if ( V_19 ) {
if ( F_189 ( V_25 , V_331 , & V_310 ) ) {
F_21 ( V_36 , L_63 ) ;
V_29 = - V_61 ;
goto V_332;
}
V_308 = F_190 ( & V_310 ) ;
if ( ! F_191 ( V_36 , V_310 . V_307 , V_308 ,
F_134 ( V_36 ) ) ) {
F_21 ( V_36 , L_64 ) ;
V_29 = - V_47 ;
goto V_332;
}
V_311 = F_192 ( V_36 , V_310 . V_307 , V_308 ) ;
if ( ! V_311 ) {
F_21 ( V_36 , L_65 ) ;
F_193 ( V_36 , V_310 . V_307 , V_308 ) ;
V_29 = - V_47 ;
goto V_332;
}
F_13 ( V_313 , V_311 , V_19 ) ;
if ( F_194 ( V_313 ) )
F_140 ( V_30 -> V_333 , V_313 ) ;
else
F_195 ( V_30 -> V_333 ) ;
F_196 ( V_36 , V_311 ) ;
F_193 ( V_36 , V_310 . V_307 , V_308 ) ;
...
F_199 ( V_30 , & V_28 -> V_160 , F_97 , V_335 ) ;
F_200 ( V_30 , & V_28 -> V_179 , F_110 , V_335 ) ;
V_30 -> V_336 = 0 ;
V_30 -> V_337 = V_338 ;
V_30 -> V_339 = & V_340 ;
F_201 ( V_30 , V_36 ) ;
F_26 ( & V_28 -> V_341 , & V_32 -> V_342 ) ;
return 0 ;
V_332:
F_202 ( V_30 ) ;
return V_29 ;
...
static int F_207 ( struct V_343 * V_344 )
{
struct V_24 * V_25 = V_344 -> V_36 . V_39 ;
struct V_27 * V_27 , * V_69 ;
struct V_24 * V_40 , * V_345 ;
struct V_32 * V_32 ;
struct V_35 * V_36 = & V_344 -> V_36 ;
int V_29 ;
if ( ! V_25 ) {
F_21 ( V_36 , L_82 ) ;
return - V_61 ;
...
static int F_213 ( struct V_343 * V_344 )
{
struct V_32 * V_32 = F_214 ( V_344 ) ;
struct V_27 * V_27 , * V_69 ;
...
inst_list) {
V_34 = V_42 -> V_33 ;
F_32 ( & V_344 -> V_36 , L_87 , V_34 -> V_26 ) ;
