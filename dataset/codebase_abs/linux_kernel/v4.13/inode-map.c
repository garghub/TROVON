...
V_82 -> V_94 = & V_5 -> V_95 ;
V_88 = V_82 -> V_96 ;
V_82 -> V_96 = F_52 ( V_5 , 10 ) ;
V_17 = F_53 ( V_3 , V_82 -> V_94 ,
V_82 -> V_96 ,
V_97 ) ;
if ( V_17 )
goto V_30;
F_54 ( V_5 , L_4 , V_82 -> V_98 ,
V_82 -> V_96 , 1 ) ;
V_28:
V_83 = F_55 ( V_3 , V_12 ) ;
if ( F_26 ( V_83 ) && ( F_56 ( V_83 ) != - V_99 || V_91 ) ) {
V_17 = F_56 ( V_83 ) ;
goto V_100;
}
if ( F_26 ( V_83 ) ) {
...
F_19 ( & V_3 -> V_37 ) ;
F_18 ( & V_7 -> V_54 ) ;
V_90 = sizeof( struct V_55 ) * V_7 -> V_72 ;
V_90 = F_42 ( V_90 , V_71 ) ;
V_90 += V_7 -> V_70 * V_71 ;
F_19 ( & V_7 -> V_54 ) ;
V_90 += 8 * V_71 ;
V_17 = F_63 ( V_83 , & V_87 , 0 , V_90 ) ;
if ( V_17 )
goto V_102;
V_17 = F_64 ( V_83 , V_82 , 0 , 0 , V_90 ,
V_90 , V_90 , & V_89 ) ;
if ( V_17 ) {
F_65 ( F_58 ( V_83 ) , V_90 ) ;
goto V_102;
...
int F_70 ( struct V_2 * V_3 , T_1 * V_24 )
{
struct V_11 * V_12 ;
int V_17 ;
struct V_13 * V_103 ;
...
V_104 . type = - 1 ;
V_104 . V_26 = ( T_1 ) - 1 ;
V_17 = F_5 ( NULL , V_3 , & V_104 , V_12 , 0 , 0 ) ;
if ( V_17 < 0 )
goto error;
F_37 ( V_17 == 0 ) ;
if ( V_12 -> V_32 [ 0 ] > 0 ) {
V_16 = V_12 -> V_32 [ 0 ] - 1 ;
V_103 = V_12 -> V_31 [ 0 ] ;
F_12 ( V_103 , & V_105 , V_16 ) ;
* V_24 = F_71 ( T_1 , V_105 . V_24 ,
V_25 - 1 ) ;
} else {
* V_24 = V_25 - 1 ;
}
