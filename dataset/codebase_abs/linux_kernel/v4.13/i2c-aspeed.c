...
static T_1 F_32 ( T_1 V_109 )
{
T_1 V_110 , V_111 , V_112 , V_113 ;
V_110 = V_109 > 33 ? F_33 ( ( V_109 - 1 ) / 32 ) + 1 : 0 ;
V_113 = V_109 / ( 1 << V_110 ) ;
V_111 = V_113 / 2 + V_113 % 2 ;
V_112 = V_113 - V_111 ;
V_111 -= 1 ;
V_112 -= 1 ;
return ( ( V_111 << V_114 )
...
{
T_1 V_109 , V_119 ;
V_109 = V_2 -> V_120 / V_2 -> V_121 ;
V_119 = F_32 ( V_109 ) ;
F_6 ( V_119 , V_2 -> V_8 + V_122 ) ;
F_6 ( V_123 , V_2 -> V_8 + V_124 ) ;
return 0 ;
}
...
if ( V_5 < 0 )
return V_5 ;
if ( ! F_36 ( V_126 -> V_13 . V_129 , L_19 ) )
V_127 |= V_130 ;
F_6 ( F_3 ( V_2 -> V_8 + V_105 ) | V_127 ,
V_2 -> V_8 + V_105 ) ;
#if F_25 ( V_91 )
if ( V_2 -> V_24 )
F_29 ( V_2 , V_2 -> V_24 -> V_54 ) ;
#endif
F_6 ( V_131 , V_2 -> V_8 + V_132 ) ;
return 0 ;
}
static int F_9 ( struct V_1 * V_2 )
{
struct V_125 * V_126 = F_37 ( V_2 -> V_13 ) ;
unsigned long V_4 ;
int V_5 ;
F_2 ( & V_2 -> V_7 , V_4 ) ;
F_6 ( 0 , V_2 -> V_8 + V_132 ) ;
...
struct V_135 * V_136 ;
int V_89 , V_5 ;
V_2 = F_39 ( & V_126 -> V_13 , sizeof( * V_2 ) , V_137 ) ;
if ( ! V_2 )
return - V_138 ;
V_136 = F_40 ( V_126 , V_139 , 0 ) ;
V_2 -> V_8 = F_41 ( & V_126 -> V_13 , V_136 ) ;
if ( F_42 ( V_2 -> V_8 ) )
return F_43 ( V_2 -> V_8 ) ;
V_134 = F_44 ( & V_126 -> V_13 , NULL ) ;
if ( F_42 ( V_134 ) )
return F_43 ( V_134 ) ;
V_2 -> V_120 = F_45 ( V_134 ) ;
F_46 ( & V_126 -> V_13 , V_134 ) ;
V_5 = F_47 ( V_126 -> V_13 . V_129 ,
L_20 , & V_2 -> V_121 ) ;
if ( V_5 < 0 ) {
F_12 ( & V_126 -> V_13 ,
L_21 ) ;
...
F_48 ( & V_2 -> V_7 ) ;
F_49 ( & V_2 -> V_14 ) ;
V_2 -> V_16 . V_140 = V_141 ;
V_2 -> V_16 . V_142 = 0 ;
V_2 -> V_16 . V_17 = 5 * V_143 ;
V_2 -> V_16 . V_144 = & V_145 ;
V_2 -> V_16 . V_13 . V_146 = & V_126 -> V_13 ;
V_2 -> V_16 . V_13 . V_129 = V_126 -> V_13 . V_129 ;
F_50 ( V_2 -> V_16 . V_147 , V_126 -> V_147 , sizeof( V_2 -> V_16 . V_147 ) ) ;
F_51 ( & V_2 -> V_16 , V_2 ) ;
V_2 -> V_13 = & V_126 -> V_13 ;
F_6 ( 0 , V_2 -> V_8 + V_132 ) ;
F_6 ( 0xffffffff , V_2 -> V_8 + V_27 ) ;
...
if ( V_5 < 0 )
return V_5 ;
V_89 = F_52 ( V_126 -> V_13 . V_129 , 0 ) ;
V_5 = F_53 ( & V_126 -> V_13 , V_89 , F_24 ,
0 , F_54 ( & V_126 -> V_13 ) , V_2 ) ;
if ( V_5 < 0 )
return V_5 ;
V_5 = F_55 ( & V_2 -> V_16 ) ;
if ( V_5 < 0 )
