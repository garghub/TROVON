...
V_2 -> V_23 = ( const void * ) V_127 -> V_130 ;
V_2 -> V_26 = ( const void * ) V_127 -> V_131 ;
...
if ( ! F_46 ( V_115 -> V_134 ) )
return - V_65 ;
F_47 ( V_115 -> V_134 , ! ( V_115 -> V_119 & V_135 ) ) ;
return 0 ;
}
...
static void F_49 ( struct V_1 * V_2 , struct V_136 * V_33 )
{
struct V_50 * V_32 = V_2 -> V_32 ;
T_5 V_137 ;
F_50 ( V_137 ) ;
F_51 ( V_138 , V_137 ) ;
V_32 -> V_56 = F_52 ( V_137 , NULL , NULL ,
V_33 , L_10 ) ;
if ( ! V_32 -> V_56 ) {
F_53 ( V_33 , L_11 ) ;
goto V_139;
}
V_32 -> V_57 = F_52 ( V_137 , NULL , NULL ,
V_33 , L_12 ) ;
if ( ! V_32 -> V_57 ) {
F_53 ( V_33 , L_13 ) ;
goto V_139;
...
V_108 = V_149 | V_150 | V_151 ;
F_2 ( V_108 , & V_2 -> V_5 -> V_152 ) ;
}
...
struct V_155 * V_156 ;
int V_55 ;
V_156 = F_60 ( V_154 , V_157 , 0 ) ;
V_2 -> V_5 = F_61 ( & V_154 -> V_33 , V_156 ) ;
if ( F_62 ( V_2 -> V_5 ) )
return F_63 ( V_2 -> V_5 ) ;
V_2 -> V_80 = V_156 -> V_158 ;
V_2 -> V_29 = F_64 ( V_154 , L_14 ) ;
if ( V_2 -> V_29 < 0 ) {
F_17 ( & V_154 -> V_33 , L_15 ) ;
return V_2 -> V_29 ;
}
V_2 -> V_30 = F_64 ( V_154 , L_16 ) ;
if ( V_2 -> V_30 < 0 ) {
F_17 ( & V_154 -> V_33 , L_17 ) ;
return V_2 -> V_30 ;
}
V_2 -> V_31 = F_64 ( V_154 , L_18 ) ;
if ( V_2 -> V_31 < 0 ) {
F_17 ( & V_154 -> V_33 , L_19 ) ;
return V_2 -> V_31 ;
}
V_2 -> V_9 = F_65 ( & V_154 -> V_33 , L_20 ) ;
if ( F_62 ( V_2 -> V_9 ) ) {
F_17 ( & V_154 -> V_33 , L_21 ) ;
V_55 = F_63 ( V_2 -> V_9 ) ;
goto V_159;
}
V_55 = F_66 ( V_2 -> V_9 ) ;
...
return 0 ;
V_159:
F_17 ( & V_154 -> V_33 , L_22 , V_160 , V_55 ) ;
return V_55 ;
}
static int F_67 ( struct V_153 * V_154 )
{
struct V_50 * V_32 ;
struct V_1 * V_2 ;
int V_55 ;
V_32 = F_68 ( & V_154 -> V_33 , sizeof( * V_2 ) ) ;
if ( ! V_32 )
return - V_161 ;
V_2 = F_36 ( V_32 ) ;
V_2 -> V_32 = V_32 ;
...
if ( V_55 )
goto V_162;
V_32 -> V_33 . V_163 = F_69 ( V_154 -> V_33 . V_163 ) ;
V_32 -> V_164 = V_165 | V_166 | V_135 ;
V_32 -> V_167 = 1 ;
V_32 -> V_118 = F_7 ( V_2 -> V_9 ) ;
V_32 -> V_168 = F_45 ;
V_32 -> V_169 = F_48 ;
V_32 -> V_112 = V_170 | V_171 ;
V_32 -> V_172 = F_70 ( 8 ) | F_70 ( 16 ) |
F_70 ( 32 ) ;
V_32 -> V_173 = F_39 ;
V_32 -> V_174 = F_37 ;
V_32 -> V_175 = F_43 ;
...
V_2 -> V_119 = - 1 ;
F_72 ( V_2 -> V_29 , V_179 ) ;
V_55 = F_73 ( & V_154 -> V_33 , V_2 -> V_29 ,
F_19 , V_180 ,
F_74 ( & V_154 -> V_33 ) , V_2 ) ;
if ( V_55 < 0 ) {
F_17 ( & V_154 -> V_33 , L_23 , V_2 -> V_30 ) ;
goto V_181;
}
F_72 ( V_2 -> V_30 , V_179 ) ;
V_55 = F_73 ( & V_154 -> V_33 , V_2 -> V_30 ,
F_20 , V_180 ,
F_74 ( & V_154 -> V_33 ) , V_2 ) ;
if ( V_55 < 0 ) {
F_17 ( & V_154 -> V_33 , L_24 , V_2 -> V_30 ) ;
goto V_181;
}
F_72 ( V_2 -> V_31 , V_179 ) ;
V_55 = F_73 ( & V_154 -> V_33 , V_2 -> V_31 ,
F_21 , V_180 ,
F_74 ( & V_154 -> V_33 ) , V_2 ) ;
if ( V_55 < 0 ) {
F_17 ( & V_154 -> V_33 , L_25 , V_2 -> V_31 ) ;
goto V_181;
}
V_55 = F_75 ( & V_154 -> V_33 , V_32 ) ;
if ( V_55 ) {
F_17 ( & V_32 -> V_33 , L_26 ) ;
goto V_181;
}
