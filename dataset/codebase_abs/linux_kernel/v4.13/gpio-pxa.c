...
static T_4 F_44 ( int V_75 , void * V_70 )
{
struct V_1 * V_14 = V_70 ;
if ( V_75 == V_14 -> V_83 ) {
F_42 ( F_43 ( 0 ) ) ;
...
static int F_48 ( struct V_69 * V_70 , unsigned int V_86 )
{
struct V_1 * V_14 = F_36 ( V_70 ) ;
unsigned int V_5 = F_37 ( V_70 ) ;
if ( V_14 -> V_87 )
...
{
const struct V_90 * V_91 = F_51 ( V_89 ) ;
...
static int F_52 ( struct V_101 * V_70 , unsigned int V_26 ,
T_5 V_102 )
{
F_53 ( V_26 , & V_103 ,
V_104 ) ;
F_54 ( V_26 , V_70 -> V_105 ) ;
F_55 ( V_26 ) ;
return 0 ;
}
...
V_106 = V_110 -> V_100 ;
V_42 = V_106 - 1 ;
V_113 = F_59 ( & V_89 -> V_49 , - 1 , 0 , V_106 , 0 ) ;
if ( V_113 < 0 ) {
F_58 ( & V_89 -> V_49 , L_8 ) ;
return V_113 ;
}
...
V_14 = F_61 ( & V_89 -> V_49 , sizeof( * V_14 ) , V_50 ) ;
if ( ! V_14 )
return - V_51 ;
V_14 -> V_49 = & V_89 -> V_49 ;
V_118 = F_62 ( & V_89 -> V_49 ) ;
if ( V_118 ) {
V_113 = V_118 -> V_113 ;
if ( V_113 <= 0 )
return - V_43 ;
...
V_113 = F_56 ( V_89 , V_14 ) ;
if ( V_113 < 0 )
return - V_43 ;
}
if ( ! V_42 )
return - V_43 ;
V_14 -> V_28 = F_63 ( V_89 -> V_49 . V_59 ,
V_42 + 1 , V_113 ,
0 , & V_123 , V_14 ) ;
if ( ! V_14 -> V_28 )
return - V_51 ;
V_83 = F_64 ( V_89 , L_9 ) ;
V_84 = F_64 ( V_89 , L_10 ) ;
V_120 = F_64 ( V_89 , L_11 ) ;
if ( ( V_83 > 0 && V_84 <= 0 ) || ( V_83 <= 0 && V_84 > 0 )
|| ( V_120 <= 0 ) )
return - V_43 ;
V_14 -> V_83 = V_83 ;
V_14 -> V_84 = V_84 ;
V_115 = F_65 ( V_89 , V_124 , 0 ) ;
V_119 = F_66 ( & V_89 -> V_49 , V_115 -> V_125 ,
F_67 ( V_115 ) ) ;
if ( ! V_119 )
return - V_43 ;
if ( V_83 > 0 )
V_121 = 2 ;
V_116 = F_68 ( & V_89 -> V_49 , NULL ) ;
if ( F_69 ( V_116 ) ) {
F_58 ( & V_89 -> V_49 , L_12 ,
F_70 ( V_116 ) ) ;
return F_70 ( V_116 ) ;
