...
T_8 F_71 ( struct V_1 * V_2 , unsigned long V_37 ,
unsigned long V_38 , unsigned long V_39 )
{
return F_59 ( V_2 , V_37 , V_38 , V_39 , false ) ;
}
T_8 F_72 ( struct V_1 * V_2 , unsigned long V_69 ,
unsigned long V_39 )
{
return F_59 ( V_2 , V_69 , 0 , V_39 , true ) ;
}
