...
static void F_36 ( struct V_27 * V_8 )
{
V_8 -> V_43 = & V_44 ;
F_37 ( V_8 ) ;
V_8 -> V_45 = V_46 ;
...
static T_2 F_40 ( struct V_6 * V_7 , struct V_27 * V_8 )
{
struct V_29 * V_30 = F_23 ( V_8 ) ;
struct V_2 * V_3 = V_30 -> V_31 + F_41 ( V_7 ) ;
F_8 ( & V_3 -> V_37 ) ;
V_3 -> V_38 ++ ;
V_3 -> V_39 += V_7 -> V_18 ;
F_9 ( & V_3 -> V_37 ) ;
...
static int F_46 ( struct V_27 * V_8 )
{
F_47 ( V_8 ) ;
return 0 ;
}
static int F_48 ( struct V_62 * V_63 [] , struct V_62 * V_64 [] ,
struct V_65 * V_66 )
{
if ( V_63 [ V_67 ] ) {
if ( F_49 ( V_63 [ V_67 ] ) != V_68 )
return - V_69 ;
if ( ! F_50 ( F_51 ( V_63 [ V_67 ] ) ) )
return - V_70 ;
}
return 0 ;
}
static int T_3 F_52 ( int V_71 )
{
struct V_27 * V_72 ;
int V_73 ;
V_72 = F_53 ( sizeof( struct V_29 ) , L_1 ,
V_74 , F_36 ) ;
if ( ! V_72 )
return - V_42 ;
V_72 -> V_75 = & V_76 ;
...
if ( V_73 < 0 )
goto V_77;
for ( V_35 = 0 ; V_35 < V_78 && ! V_73 ; V_35 ++ ) {
V_73 = F_52 ( V_35 ) ;
F_59 () ;
}
if ( V_73 )
