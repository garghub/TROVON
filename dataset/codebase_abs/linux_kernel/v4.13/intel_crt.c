...
void F_82 ( struct V_130 * V_3 )
{
struct V_10 * V_11 = F_6 ( V_3 -> V_9 ) ;
struct V_1 * V_12 = F_1 ( F_83 ( V_3 ) ) ;
if ( F_20 ( V_11 ) >= 5 ) {
T_1 V_36 ;
V_36 = F_8 ( V_12 -> V_16 ) ;
V_36 &= ~ V_131 ;
...
V_12 = F_85 ( sizeof( struct V_1 ) , V_136 ) ;
if ( ! V_12 )
return;
V_132 = F_86 () ;
if ( ! V_132 ) {
...
V_6 = & V_132 -> V_4 ;
V_12 -> V_6 = V_132 ;
F_87 ( & V_11 -> V_137 , & V_132 -> V_4 ,
& V_138 , V_139 ) ;
F_88 ( & V_11 -> V_137 , & V_12 -> V_4 . V_4 , & V_140 ,
V_141 , L_17 ) ;
F_89 ( V_132 , & V_12 -> V_4 ) ;
V_12 -> V_4 . type = V_82 ;
...
T_1 V_164 = V_165 |
V_166 ;
V_11 -> V_167 = F_8 ( F_92 ( V_168 ) ) & V_164 ;
}
F_82 ( & V_12 -> V_4 . V_4 ) ;
}
