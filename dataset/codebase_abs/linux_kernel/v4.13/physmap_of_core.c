...
V_30 = - V_46 ;
V_34 = F_30 ( & V_12 ) ;
V_4 -> V_7 [ V_5 ] . V_12 = F_31 ( V_12 . V_47 , V_34 ,
F_32 ( & V_2 -> V_2 ) ) ;
if ( ! V_4 -> V_7 [ V_5 ] . V_12 )
goto V_48;
V_30 = - V_45 ;
...
V_4 -> V_7 [ V_5 ] . V_10 . V_49 = V_36 ? : F_32 ( & V_2 -> V_2 ) ;
V_4 -> V_7 [ V_5 ] . V_10 . V_50 = V_12 . V_47 ;
V_4 -> V_7 [ V_5 ] . V_10 . V_51 = V_34 ;
V_4 -> V_7 [ V_5 ] . V_10 . V_52 = F_33 ( V_29 ) ;
...
return V_30 ;
V_30 = - V_43 ;
V_4 -> V_7 [ V_5 ] . V_10 . V_11 = F_36 ( V_4 -> V_7 [ V_5 ] . V_10 . V_50 ,
V_4 -> V_7 [ V_5 ] . V_10 . V_51 ) ;
if ( ! V_4 -> V_7 [ V_5 ] . V_10 . V_11 ) {
F_25 ( & V_2 -> V_2 , L_21
L_22 ) ;
goto V_48;
...
V_4 -> V_7 [ V_5 ] . V_8 -> V_2 . V_54 = & V_2 -> V_2 ;
}
V_30 = 0 ;
V_4 -> V_6 = NULL ;
if ( V_4 -> V_9 == 1 ) {
