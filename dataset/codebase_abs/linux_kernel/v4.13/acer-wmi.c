...
T_2 V_62 = 0 ;
T_3 V_23 ;
V_23 = F_9 ( V_63 , 0 , V_59 , & V_22 , & V_21 ) ;
if ( F_15 ( V_23 ) )
return V_23 ;
...
static int F_40 ( struct V_76 * V_115 )
{
return F_41 ( V_115 , & V_116 ) ;
}
...
{
int V_120 = V_119 -> V_121 . V_6 ;
if ( V_119 -> V_121 . V_122 != V_123 )
V_120 = 0 ;
if ( V_119 -> V_121 . V_124 != V_123 )
V_120 = 0 ;
F_37 ( V_120 , V_7 ) ;
return 0 ;
}
static int F_46 ( struct V_76 * V_115 )
{
struct V_125 V_121 ;
struct V_118 * V_119 ;
...
V_121 . type = V_126 ;
V_121 . V_45 = V_45 ;
V_119 = F_47 ( L_8 , V_115 , NULL , & V_127 ,
& V_121 ) ;
if ( F_48 ( V_119 ) ) {
F_49 ( L_9 ) ;
V_128 = NULL ;
...
struct V_20 V_85 ;
union V_50 V_129 ;
V_85 . V_24 = sizeof( V_129 ) ;
V_85 . V_25 = & V_129 ;
V_23 = F_55 ( V_130 , L_10 , NULL , & V_85 ) ;
if ( F_15 ( V_23 ) )
return - 1 ;
return 0 ;
}
static int F_56 ( struct V_131 * V_22 )
{
return F_54 () ;
}
...
V_85 . V_24 = sizeof( V_129 ) ;
V_85 . V_25 = V_129 ;
V_23 = F_55 ( V_130 , L_11 , NULL , & V_85 ) ;
if ( F_15 ( V_23 ) )
return - 1 ;
if ( V_129 -> V_133 . V_134 != 4 )
return - 1 ;
F_58 ( V_135 , V_136 ,
( V_137 ) V_129 -> V_133 . V_138 [ 0 ] . integer . V_28 ) ;
F_58 ( V_135 , V_139 ,
( V_137 ) V_129 -> V_133 . V_138 [ 1 ] . integer . V_28 ) ;
F_58 ( V_135 , V_140 ,
( V_137 ) V_129 -> V_133 . V_138 [ 2 ] . integer . V_28 ) ;
F_59 ( V_135 ) ;
return 0 ;
}
...
if ( F_7 ( V_34 ) ) {
V_23 = F_36 ( & V_143 , V_34 ) ;
if ( F_23 ( V_23 ) )
F_62 ( V_145 , ! V_143 ) ;
}
if ( F_7 ( V_69 ) && F_20 ( V_86 ) ) {
V_23 = F_36 ( & V_143 , V_91 ) ;
if ( F_23 ( V_23 ) )
F_62 ( V_146 , ! V_143 ) ;
}
F_63 ( & V_147 , F_64 ( V_148 ) ) ;
}
static int F_65 ( void * V_149 , bool V_150 )
{
T_3 V_23 ;
T_2 V_17 = ( unsigned long ) V_149 ;
if ( V_151 ) {
V_23 = F_37 ( ! V_150 , V_17 ) ;
if ( F_15 ( V_23 ) )
return - V_152 ;
}
return 0 ;
}
static struct V_153 * F_66 ( struct V_76 * V_115 ,
enum V_154 type ,
char * V_155 , T_2 V_17 )
{
int V_29 ;
...
T_2 V_143 ;
T_3 V_23 ;
V_156 = F_67 ( V_155 , V_115 , type ,
& V_157 ,
( void * ) ( unsigned long ) V_17 ) ;
if ( ! V_156 )
return F_68 ( - V_158 ) ;
V_23 = F_36 ( & V_143 , V_17 ) ;
V_29 = F_69 ( V_156 ) ;
if ( V_29 ) {
F_70 ( V_156 ) ;
return F_68 ( V_29 ) ;
...
static int F_71 ( struct V_76 * V_115 )
{
int V_29 ;
if ( F_7 ( V_32 ) ) {
V_144 = F_66 ( V_115 , V_159 ,
L_12 , V_32 ) ;
if ( F_48 ( V_144 ) ) {
V_29 = F_50 ( V_144 ) ;
goto V_160;
...
static void F_75 ( T_2 V_28 , void * V_167 )
{
struct V_20 V_168 = { V_49 , NULL } ;
union V_50 * V_51 ;
struct V_169 V_78 ;
T_3 V_23 ;
T_4 V_170 ;
...
T_2 V_173 ;
V_23 = F_76 ( V_28 , & V_168 ) ;
if ( V_23 != V_31 ) {
F_29 ( L_15 , V_23 ) ;
return;
}
V_51 = (union V_50 * ) V_168 . V_25 ;
if ( ! V_51 )
return;
if ( V_51 -> type != V_52 ) {
F_29 ( L_16 , V_51 -> type ) ;
...
V_78 = * ( (struct V_169 * ) V_51 -> V_53 . V_25 ) ;
F_16 ( V_51 ) ;
switch ( V_78 . V_174 ) {
case V_175 :
V_170 = V_78 . V_170 ;
...
default:
F_29 ( L_19 ,
V_78 . V_174 , V_78 . V_177 ) ;
break;
}
}
static T_3 T_1
F_80 ( struct V_186 * V_80 ,
struct V_187 * V_78 )
{
T_3 V_23 ;
union V_50 * V_51 ;
struct V_20 V_22 = { sizeof( struct V_186 ) , V_80 } ;
struct V_20 V_85 = { V_49 , NULL } ;
...
* V_78 = * ( (struct V_187 * ) V_51 -> V_53 . V_25 ) ;
F_16 ( V_51 ) ;
return V_23 ;
}
...
static T_3 T_1 F_84 ( T_5 V_191 , T_2 V_192 ,
void * V_193 , void * * V_194 )
{
struct V_195 * V_115 ;
if ( ! strcmp ( V_193 , L_24 ) ) {
if ( F_85 ( V_191 , & V_115 ) )
return V_31 ;
if ( strcmp ( V_196 , F_86 ( V_115 ) ) )
return V_31 ;
} else
return V_31 ;
* ( T_5 * ) V_194 = V_191 ;
...
static int T_1 F_87 ( const char * V_155 , const char * V_198 ,
T_5 * V_191 )
{
T_3 V_23 ;
T_5 V_199 ;
...
V_135 -> V_155 = L_25 ;
V_135 -> V_201 = L_26 ;
V_135 -> V_56 . V_202 = V_203 ;
V_135 -> V_204 [ 0 ] = F_92 ( V_205 ) ;
F_93 ( V_135 , V_136 , - 16384 , 16384 , 0 , 0 ) ;
F_93 ( V_135 , V_139 , - 16384 , 16384 , 0 , 0 ) ;
F_93 ( V_135 , V_140 , - 16384 , 16384 , 0 , 0 ) ;
V_29 = F_94 ( V_135 ) ;
if ( V_29 )
goto V_206;
return 0 ;
...
V_176 -> V_155 = L_27 ;
V_176 -> V_201 = L_28 ;
V_176 -> V_56 . V_202 = V_203 ;
V_29 = F_99 ( V_176 , V_207 , NULL ) ;
if ( V_29 )
goto V_206;
V_23 = F_100 ( V_166 ,
F_75 , NULL ) ;
...
static int F_104 ( struct V_210 * V_76 )
{
int V_29 ;
if ( F_7 ( V_5 ) ) {
V_29 = F_40 ( & V_76 -> V_115 ) ;
if ( V_29 )
goto V_211;
}
if ( F_7 ( V_7 ) ) {
V_29 = F_46 ( & V_76 -> V_115 ) ;
if ( V_29 )
goto V_212;
}
V_29 = F_71 ( & V_76 -> V_115 ) ;
if ( V_29 )
goto V_213;
return V_29 ;
V_213:
...
static int F_105 ( struct V_210 * V_76 )
{
if ( F_7 ( V_5 ) )
F_42 () ;
if ( F_7 ( V_7 ) )
...
static int F_106 ( struct V_76 * V_115 )
{
T_2 V_28 ;
struct V_214 * V_149 = & V_1 -> V_149 ;
if ( ! V_149 )
return - V_158 ;
if ( F_7 ( V_5 ) ) {
F_36 ( & V_28 , V_5 ) ;
...
static int F_107 ( struct V_76 * V_115 )
{
struct V_214 * V_149 = & V_1 -> V_149 ;
if ( ! V_149 )
return - V_158 ;
...
static void F_108 ( struct V_210 * V_76 )
{
struct V_214 * V_149 = & V_1 -> V_149 ;
if ( ! V_149 )
return;
...
{
F_110 ( V_1 -> V_215 . V_84 ) ;
F_110 ( V_1 -> V_215 . V_216 ) ;
}
static int T_1 F_111 ( void )
{
V_1 -> V_215 . V_216 = F_112 ( L_8 , NULL ) ;
if ( ! V_1 -> V_215 . V_216 ) {
F_49 ( L_29 ) ;
return - V_158 ;
}
V_1 -> V_215 . V_84 = F_113 ( L_30 , V_217 ,
V_1 -> V_215 . V_216 ,
& V_1 -> V_215 . V_218 ) ;
if ( ! V_1 -> V_215 . V_84 )
goto V_219;
