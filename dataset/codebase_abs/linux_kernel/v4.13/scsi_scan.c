...
V_13 -> V_183 = 1 ;
F_79 ( & V_13 -> V_57 ) ;
if ( V_13 -> V_38 -> V_66 -> V_184 ) {
V_26 = V_13 -> V_38 -> V_66 -> V_184 ( V_13 ) ;
if ( V_26 ) {
if ( V_26 != - V_69 ) {
F_16 ( V_89 , V_13 ,
L_21 ) ;
...
if ( V_13 -> V_95 >= V_150 )
F_80 ( V_13 ) ;
V_13 -> V_185 = V_13 -> V_186 ;
if ( ! V_134 && F_81 ( V_13 ) != 0 )
return V_137 ;
return V_187 ;
}
static unsigned char * F_82 ( unsigned char * V_188 , unsigned char * V_189 ,
unsigned V_190 , unsigned V_191 )
{
unsigned V_192 = 0 , V_193 ;
for ( V_193 = 0 ; V_193 + V_190 < V_191 && V_193 + V_190 < V_189 [ 4 ] + 5 ; V_193 ++ ) {
if ( V_189 [ V_193 + V_190 ] > ' ' ) {
V_188 [ V_193 ] = V_189 [ V_193 + V_190 ] ;
V_192 = V_193 + 1 ;
} else {
V_188 [ V_193 ] = ' ' ;
}
...
struct V_12 * V_13 ;
unsigned char * V_14 ;
int V_108 , V_198 = V_137 , V_107 = 256 ;
struct V_27 * V_5 = F_19 ( V_22 -> V_28 . V_29 ) ;
V_13 = F_84 ( V_22 , V_23 ) ;
if ( V_13 ) {
if ( V_197 != V_199 || ! F_85 ( V_13 ) ) {
F_63 ( 3 , F_16 ( V_10 , V_13 ,
L_22 ,
F_86 ( & V_13 -> V_57 ) ) ) ;
if ( V_195 )
...
V_198 = F_69 ( V_13 , V_14 , & V_108 , V_5 -> V_206 ) ;
if ( V_198 == V_187 ) {
if ( V_108 & V_207 ) {
V_13 -> V_148 = 0 ;
F_15 ( V_13 , V_14 ) ;
...
if ( V_108 & V_214 )
V_208 = F_67 ( 5U , V_208 ) ;
if ( V_95 < V_150 && ! ( V_108 & V_215 ) )
V_208 = F_67 ( 8U , V_208 ) ;
else
V_208 = F_67 ( 256U , V_208 ) ;
for ( V_23 = 1 ; V_23 < V_208 ; ++ V_23 )
if ( ( F_83 ( V_22 , V_23 , NULL , NULL , V_197 ,
NULL ) != V_187 ) &&
! V_209 )
return;
}
...
V_216 = ( 511 + 1 ) * sizeof( struct V_219 ) ;
V_99:
V_221 = F_3 ( V_216 , V_4 |
( V_13 -> V_38 -> V_200 ? V_201 : 0 ) ) ;
if ( ! V_221 ) {
F_9 ( V_71 , V_72 ) ;
goto V_33;
}
...
if ( F_93 ( V_221 -> V_219 ) +
sizeof( struct V_219 ) > V_216 ) {
V_216 = F_93 ( V_221 -> V_219 ) +
sizeof( struct V_219 ) ;
F_14 ( V_221 ) ;
goto V_99;
}
V_216 = F_93 ( V_221 -> V_219 ) ;
V_217 = ( V_216 / sizeof( struct V_219 ) ) ;
F_63 ( 3 , F_16 ( V_10 , V_13 ,
L_34 ) ) ;
for ( V_220 = & V_221 [ 1 ] ; V_220 <= & V_221 [ V_217 ] ; V_220 ++ ) {
V_23 = F_94 ( V_220 ) ;
if ( V_23 > V_13 -> V_38 -> V_211 ) {
F_16 ( V_143 , V_13 ,
L_35
L_36 , V_23 ) ;
} else {
...
{
struct V_12 * V_13 = F_96 ( - V_227 ) ;
struct V_73 * V_29 = & V_5 -> V_228 ;
struct V_21 * V_22 ;
if ( strncmp ( V_229 , L_40 , 4 ) == 0 )
return F_96 ( - V_227 ) ;
...
{
struct V_12 * V_13 =
F_95 ( V_38 , V_42 , V_232 , V_23 , NULL ) ;
if ( F_103 ( V_13 ) )
return F_104 ( V_13 ) ;
F_87 ( V_13 ) ;
return 0 ;
...
F_107 ( V_28 ) ;
F_80 ( V_13 ) ;
if ( V_13 -> V_233 && V_13 -> V_233 -> V_197 )
V_13 -> V_233 -> V_197 ( V_13 ) ;
if ( V_28 -> V_234 && F_108 ( V_28 -> V_234 -> V_235 ) ) {
struct V_236 * V_237 = F_109 ( V_28 -> V_234 ) ;
if ( V_237 -> V_197 )
V_237 -> V_197 ( V_28 ) ;
F_110 ( V_28 -> V_234 -> V_235 ) ;
}
F_111 ( V_28 ) ;
}
static void F_112 ( struct V_73 * V_29 , unsigned int V_42 ,
unsigned int V_41 , T_1 V_23 , enum V_196 V_197 )
{
struct V_27 * V_5 = F_19 ( V_29 ) ;
int V_108 = 0 ;
int V_198 ;
...
F_97 ( V_22 ) ;
if ( V_23 != V_239 ) {
F_83 ( V_22 , V_23 , NULL , NULL , V_197 , NULL ) ;
goto V_240;
}
V_198 = F_83 ( V_22 , 0 , & V_108 , NULL , V_197 , NULL ) ;
if ( V_198 == V_187 || V_198 == V_204 ) {
if ( F_91 ( V_22 , V_108 , V_197 ) != 0 )
F_89 ( V_22 , V_108 ,
V_22 -> V_95 , V_197 ) ;
}
V_240:
...
return;
if ( V_197 != V_241 &&
strncmp ( V_229 , L_41 , 6 ) == 0 )
return;
F_75 ( & V_5 -> V_231 ) ;
if ( ! V_5 -> V_206 )
F_1 () ;
if ( F_98 ( V_5 ) && F_99 ( V_5 ) == 0 ) {
F_112 ( V_29 , V_42 , V_41 , V_23 , V_197 ) ;
F_100 ( V_5 ) ;
}
F_77 ( & V_5 -> V_231 ) ;
}
...
T_2 V_242 ;
if ( V_41 == V_239 )
for ( V_41 = 0 ; V_41 < V_5 -> V_243 ; ++ V_41 ) {
if ( V_5 -> V_244 )
V_242 = V_5 -> V_243 - V_41 - 1 ;
else
V_242 = V_41 ;
F_112 ( & V_5 -> V_228 , V_42 ,
V_242 , V_23 , V_197 ) ;
}
else
F_112 ( & V_5 -> V_228 , V_42 ,
...
L_42 ,
V_72 , V_42 , V_41 , V_23 ) ) ;
if ( ( ( V_42 != V_239 ) && ( V_42 > V_5 -> V_245 ) ) ||
( ( V_41 != V_239 ) && ( V_41 >= V_5 -> V_243 ) ) ||
( ( V_23 != V_239 ) && ( V_23 >= V_5 -> V_211 ) ) )
return - V_246 ;
F_75 ( & V_5 -> V_231 ) ;
if ( ! V_5 -> V_206 )
F_1 () ;
if ( F_98 ( V_5 ) && F_99 ( V_5 ) == 0 ) {
if ( V_42 == V_239 )
for ( V_42 = 0 ; V_42 <= V_5 -> V_245 ;
V_42 ++ )
F_114 ( V_5 , V_42 , V_41 , V_23 ,
V_197 ) ;
else
F_114 ( V_5 , V_42 , V_41 , V_23 , V_197 ) ;
F_100 ( V_5 ) ;
}
F_77 ( & V_5 -> V_231 ) ;
return 0 ;
...
struct V_1 * V_2 ;
unsigned long V_74 ;
if ( strncmp ( V_229 , L_43 , 4 ) == 0 )
return NULL ;
if ( V_5 -> V_206 ) {
F_68 ( V_249 , V_5 , L_44 , V_72 ) ;
return NULL ;
}
V_2 = F_3 ( sizeof( * V_2 ) , V_4 ) ;
if ( ! V_2 )
...
if ( V_5 -> V_66 -> V_254 )
V_5 -> V_66 -> V_254 ( V_5 ) ;
while ( ! V_5 -> V_66 -> V_251 ( V_5 , V_253 - V_252 ) )
F_4 ( 10 ) ;
} else {
F_115 ( V_5 , V_239 , V_239 ,
V_239 , 0 ) ;
}
}
static void F_124 ( void * V_255 , T_3 V_256 )
{
...
if ( ! F_98 ( V_5 ) )
goto V_33;
V_22 = F_53 ( & V_5 -> V_228 , 0 , V_5 -> V_238 ) ;
if ( ! V_22 )
goto V_33;
V_13 = F_18 ( V_22 , 0 , NULL ) ;
if ( V_13 )
...
{
F_37 ( V_13 -> V_41 != V_13 -> V_38 -> V_238 ) ;
F_35 ( V_13 ) ;
}
