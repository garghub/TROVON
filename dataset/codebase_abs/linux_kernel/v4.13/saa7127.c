...
F_11 ( 1 , V_19 , V_3 , L_5 , 5 , V_14 -> V_20 ) ;
...
{
struct V_1 * V_14 = F_1 ( V_3 ) ;
memset ( V_69 -> V_70 , 0 , sizeof( V_69 -> V_70 ) ) ;
if ( V_14 -> V_18 )
V_69 -> V_70 [ 0 ] [ 16 ] = V_71 ;
if ( V_14 -> V_32 )
V_69 -> V_70 [ 0 ] [ 23 ] = V_72 ;
...
static int F_25 ( struct V_2 * V_3 , const struct V_76 * V_4 )
{
...
{
struct V_1 * V_14 = F_1 ( V_3 ) ;
F_27 ( V_3 , L_20 , ( V_14 -> V_38 & V_40 ) ? L_21 : L_22 ) ;
F_27 ( V_3 , L_23 , V_14 -> V_65 ? L_24 : L_25 ) ;
F_27 ( V_3 , L_26 , V_14 -> V_37 ?
V_59 [ V_14 -> V_61 ] : L_27 ) ;
F_27 ( V_3 , L_28 , V_14 -> V_32 ?
V_33 [ V_14 -> V_34 ] : L_27 ) ;
F_27 ( V_3 , L_29 , V_14 -> V_18 ? L_30 : L_27 ) ;
F_27 ( V_3 , L_31 , V_14 -> V_22 ? L_30 : L_27 ) ;
return 0 ;
}
...
struct V_1 * V_14 ;
struct V_2 * V_3 ;
struct V_12 V_79 = { 0 , 0 , 0 , 0 } ;
if ( ! F_29 ( V_6 -> V_80 , V_81 ) )
return - V_82 ;
F_30 ( 1 , V_19 , V_6 , L_32 ,
V_6 -> V_83 << 1 ) ;
V_14 = F_31 ( & V_6 -> V_84 , sizeof( * V_14 ) , V_85 ) ;
if ( V_14 == NULL )
return - V_86 ;
V_3 = & V_14 -> V_3 ;
F_32 ( V_3 , V_6 , & V_87 ) ;
...
V_90 = F_3 ( V_3 , V_91 ) ;
F_6 ( V_3 , V_91 , 0xaa ) ;
if ( F_3 ( V_3 , V_91 ) == 0xaa ) {
F_6 ( V_3 , V_91 ,
V_90 ) ;
V_14 -> V_43 = V_44 ;
F_33 ( V_6 -> V_92 , L_34 , V_93 ) ;
} else {
V_14 -> V_43 = V_94 ;
F_33 ( V_6 -> V_92 , L_35 , V_93 ) ;
}
}
F_27 ( V_3 , L_36 , V_6 -> V_92 ,
V_6 -> V_83 << 1 , V_6 -> V_80 -> V_92 ) ;
