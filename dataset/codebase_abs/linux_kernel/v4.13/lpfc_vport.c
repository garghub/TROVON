...
struct V_1 * * V_151 ;
int V_152 = 0 ;
V_151 = F_77 ( ( V_19 -> V_153 + 1 ) * sizeof( struct V_1 * ) ,
V_35 ) ;
if ( V_151 == NULL )
return NULL ;
F_3 ( & V_19 -> V_21 ) ;
...
void
F_78 ( struct V_18 * V_19 , struct V_1 * * V_151 )
{
int V_154 ;
if ( V_151 == NULL )
return;
for ( V_154 = 0 ; V_154 <= V_19 -> V_153 && V_151 [ V_154 ] != NULL ; V_154 ++ )
F_61 ( F_44 ( V_151 [ V_154 ] ) ) ;
F_17 ( V_151 ) ;
}
void
F_79 ( struct V_1 * V_2 )
