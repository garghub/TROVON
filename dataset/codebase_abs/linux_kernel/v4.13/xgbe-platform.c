...
V_3 -> V_76 = V_3 -> V_46 -> V_76 ;
V_3 -> V_77 = V_3 -> V_46 -> V_77 ;
F_36 ( V_3 ) ;
V_3 -> V_78 = 2 ;
V_11 = F_37 ( V_30 , 0 ) ;
if ( V_11 < 0 ) {
...
V_3 -> V_79 = V_11 ;
if ( V_3 -> V_63 ) {
unsigned int V_32 , V_80 = F_38 ( V_3 -> V_81 ) ;
for ( V_32 = 0 ; ( V_32 < V_80 ) && ( V_40 < V_41 ) ; V_32 ++ ) {
...
struct V_85 * V_82 = V_3 -> V_82 ;
int V_11 = 0 ;
F_50 ( L_23 ) ;
if ( F_51 ( V_82 ) )
V_11 = F_52 ( V_82 , V_86 ) ;
V_3 -> V_87 = F_53 ( V_3 , V_88 , V_89 ) ;
V_3 -> V_87 |= V_90 ;
F_54 ( V_3 , V_88 , V_89 , V_3 -> V_87 ) ;
F_50 ( L_24 ) ;
return V_11 ;
}
