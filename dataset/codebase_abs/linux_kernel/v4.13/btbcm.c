...
int F_21 ( struct V_1 * V_2 , char * V_37 , T_3 V_11 )
{
T_4 V_38 , V_39 ;
...
snprintf ( V_37 , V_11 , L_20 , V_40 ? : L_21 ) ;
break;
default:
return 0 ;
}
F_8 ( L_22 , V_2 -> V_10 ,
V_40 ? : L_21 , ( V_38 & 0xe000 ) >> 13 ,
...
if ( F_3 ( V_6 ) )
return F_4 ( V_6 ) ;
F_8 ( L_24 , V_2 -> V_10 , V_6 -> V_13 [ 1 ] ) ;
F_6 ( V_6 ) ;
V_6 = F_15 ( V_2 ) ;
if ( F_3 ( V_6 ) )
return F_4 ( V_6 ) ;
F_8 ( L_25 , V_2 -> V_10 , ( char * ) ( V_6 -> V_13 + 1 ) ) ;
F_6 ( V_6 ) ;
switch ( ( V_39 & 0xf000 ) >> 12 ) {
case 0 :
case 3 :
...
snprintf ( V_37 , sizeof( V_37 ) , L_20 ,
V_40 ? : L_21 ) ;
break;
case 1 :
case 2 :
...
if ( F_3 ( V_6 ) )
return F_4 ( V_6 ) ;
V_48 = F_24 ( V_6 -> V_13 + 1 ) ;
V_47 = F_24 ( V_6 -> V_13 + 3 ) ;
F_6 ( V_6 ) ;
