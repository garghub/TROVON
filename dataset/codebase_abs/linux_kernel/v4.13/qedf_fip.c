...
V_65 = V_47 -> V_23 ;
if ( ! V_2 -> V_68 ) {
V_62 = F_24 ( V_4 , sizeof( * V_62 ) - sizeof( * V_60 ) ) ;
...
F_25 ( V_75 , L_10 , V_76 , 16 , 1 ,
V_4 -> V_11 , V_4 -> V_77 , false ) ;
if ( V_63 == V_22 && V_65 == V_85 ) {
F_15 ( V_2 , V_4 ) ;
V_2 -> V_68 = 0 ;
F_14 ( V_4 ) ;
} else if ( V_63 == V_86 && V_65 == V_87 ) {
F_11 ( & ( V_2 -> V_38 ) , V_39 , L_13
L_14 ) ;
if ( V_2 -> V_58 . V_88 == NULL ) {
F_11 ( & ( V_2 -> V_38 ) , V_39 ,
L_15
L_16 ) ;
return;
...
void F_35 ( struct V_94 * V_35 , T_1 * V_95 )
{
