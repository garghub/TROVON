...
struct V_97 * V_98 )
{
struct V_99 * V_100 = V_98 -> V_101 -> V_100 ;
F_51 ( & V_100 -> V_102 ) ;
V_98 -> V_103 . V_14 = 0 ;
V_98 -> V_103 . V_15 = 0 ;
F_52 ( & V_98 -> V_103 . V_10 , & V_6 -> V_85 ) ;
F_10 ( V_6 ) ;
}
int F_53 ( struct V_5 * V_6 ,
struct V_104 * V_2 , T_6 V_105 ,
struct V_97 * V_98 )
{
unsigned long V_11 ;
struct V_106 * V_107 ;
...
if ( V_98 -> V_103 . V_112 > F_37 ( V_6 ) ) {
if ( F_16 ( V_6 ) )
goto V_110;
if ( V_6 -> V_32 -> V_11 & V_113 )
V_6 -> V_32 -> V_114 ( V_6 ,
V_6 -> V_16 / 2 ) ;
goto V_115;
}
V_77 = V_98 -> V_116 ;
F_32 ( V_6 , V_75 , ( T_2 ) V_98 -> V_103 . V_62 , V_77 , 0 ) ;
V_75 [ 0 ] |= V_117 ;
if ( V_98 -> V_103 . V_11 & V_118 )
V_75 [ 0 ] |= V_119 ;
V_109 = V_6 -> V_23 ;
V_58 = & V_6 -> V_59 [ V_109 ] . V_60 [ 0 ] ;
* V_58 ++ = F_55 ( V_75 [ 0 ] ) ;
* V_58 ++ = F_55 ( V_75 [ 1 ] ) ;
if ( ++ V_109 == V_6 -> V_16 ) {
V_109 = 0 ;
...
F_56 ( V_63 == 0 ) ;
V_120 = ( V_63 + 3 ) >> 2 ;
V_62 = F_57 ( & V_6 -> V_32 -> V_64 -> V_65 , V_107 -> V_123 ,
V_120 << 2 , V_66 ) ;
if ( F_58 ( & V_6 -> V_32 -> V_64 -> V_65 , V_62 ) )
goto V_124;
V_75 [ 0 ] = 0 ;
F_32 ( V_6 , V_75 , ( T_2 ) V_62 , V_120 , V_77 ) ;
if ( V_98 -> V_103 . V_11 & V_118 )
V_75 [ 0 ] |= V_119 ;
* V_58 ++ = F_55 ( V_75 [ 0 ] ) ;
* V_58 ++ = F_55 ( V_75 [ 1 ] ) ;
...
if ( -- V_2 -> V_125 )
* V_107 = * V_2 -> V_126 ++ ;
} else if ( V_107 -> V_121 == 0 && V_107 -> V_127 -> V_128 ) {
if ( ++ V_107 -> V_129 >= V_130 ) {
if ( ++ V_107 -> V_131 >= V_107 -> V_127 -> V_132 )
break;
V_107 -> V_129 = 0 ;
}
V_107 -> V_123 =
V_107 -> V_127 -> V_133 [ V_107 -> V_131 ] -> V_134 [ V_107 -> V_129 ] . V_123 ;
V_107 -> V_121 =
V_107 -> V_127 -> V_133 [ V_107 -> V_131 ] -> V_134 [ V_107 -> V_129 ] . V_121 ;
}
V_77 += V_120 ;
V_105 -= V_120 ;
}
...
V_58 -= 2 ;
V_58 [ 0 ] |= F_55 ( V_135 ) ;
if ( V_98 -> V_103 . V_11 & V_136 )
V_58 [ 0 ] |= F_55 ( V_137 ) ;
if ( V_98 -> V_103 . V_11 & V_138 )
V_58 [ 0 ] |= F_55 ( V_139 ) ;
V_100 = V_98 -> V_101 -> V_100 ;
F_51 ( & V_100 -> V_102 ) ;
V_98 -> V_103 . V_15 = V_109 ;
V_6 -> V_32 -> V_140 ( V_6 , V_109 ) ;
V_6 -> V_22 += V_98 -> V_103 . V_112 ;
F_52 ( & V_98 -> V_103 . V_10 , & V_6 -> V_85 ) ;
goto V_111;
V_124:
for (; ; ) {
...
F_60 ( & V_101 -> V_141 ) ;
F_60 ( & V_101 -> V_142 ) ;
if ( V_101 -> V_143 . V_144 == V_145 ) {
if ( V_146 [ V_101 -> V_147 ] & V_148 )
F_61 ( V_101 , V_149 ) ;
} else if ( V_101 -> V_150 )
F_62 ( V_101 , V_101 -> V_150 , V_149 ) ;
F_63 ( & V_101 -> V_142 ) ;
F_63 ( & V_101 -> V_141 ) ;
goto V_111;
V_115:
...
V_100 -> V_152 = V_98 ;
V_65 = & V_6 -> V_32 -> V_153 ;
F_60 ( & V_65 -> V_154 . V_155 ) ;
if ( F_34 ( & V_100 -> V_156 ) ) {
struct V_157 * V_158 ;
V_158 = & V_6 -> V_159 ;
V_158 -> V_160 . V_161 ++ ;
V_101 -> V_162 |= V_163 ;
F_52 ( & V_100 -> V_156 , & V_65 -> V_164 ) ;
}
F_63 ( & V_65 -> V_154 . V_155 ) ;
V_101 -> V_162 &= ~ V_165 ;
F_63 ( & V_101 -> V_142 ) ;
V_89 = - V_166 ;
} else {
...
T_2 V_62 ;
T_5 V_170 , V_76 , V_77 ;
T_5 V_57 , V_109 , V_171 ;
V_57 = V_6 -> V_24 ;
V_109 = V_6 -> V_23 ;
V_171 = F_37 ( V_6 ) ;
V_168 = V_6 -> V_59 ;
F_65 ( V_6 -> V_32 , V_6 -> V_172 ,
L_3 , V_57 ) ;
F_65 ( V_6 -> V_32 , V_6 -> V_172 ,
L_4 , V_109 ) ;
F_65 ( V_6 -> V_32 , V_6 -> V_172 ,
...
V_170 = ( V_61 [ 0 ] >> 30 ) & 3ULL ;
V_76 = ( V_61 [ 0 ] >> 14 ) & ( 0x7ffULL << 2 ) ;
V_77 = ( V_61 [ 0 ] & 0x7ffULL ) << 2 ;
F_65 ( V_6 -> V_32 , V_6 -> V_172 ,
L_6 ,
V_57 , V_11 , V_62 , V_170 , V_76 , V_77 ) ;
if ( ++ V_57 == V_6 -> V_16 )
V_57 = 0 ;
}
