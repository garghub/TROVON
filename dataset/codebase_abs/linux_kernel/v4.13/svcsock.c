...
struct V_14 * V_15 ;
F_101 ( & V_132 -> V_234 ) ;
F_128 (svsk, &serv->sv_permsocks, sk_xprt.xpt_list)
F_29 ( V_135 , & V_15 -> V_17 . V_104 ) ;
F_104 ( & V_132 -> V_234 ) ;
}
...
int V_134 = 0 ;
F_8 ( L_48 , V_2 ) ;
V_15 = F_129 ( sizeof( * V_15 ) , V_237 ) ;
if ( ! V_15 )
return F_130 ( - V_176 ) ;
V_235 = V_2 -> V_3 ;
if ( V_236 )
V_134 = F_131 ( V_132 , F_74 ( V_2 -> V_3 ) , V_235 -> V_4 ,
V_235 -> V_89 ,
F_132 ( F_24 ( V_235 ) -> V_238 ) ) ;
if ( V_134 < 0 ) {
F_133 ( V_15 ) ;
return F_130 ( V_134 ) ;
}
...
bool F_135 ( struct V_154 * V_154 , int V_240 )
{
int V_134 ;
struct V_1 * V_2 = F_136 ( V_240 , & V_134 ) ;
bool V_108 = false ;
if ( ! V_2 )
goto V_63;
...
int F_138 ( struct V_131 * V_132 , const int V_240 , char * V_241 ,
const T_1 V_60 )
{
int V_134 = 0 ;
struct V_1 * V_242 = F_136 ( V_240 , & V_134 ) ;
...
error = F_143 ( V_154 , V_254 , type , V_251 , & V_2 , 1 ) ;
if ( error < 0 )
return F_130 ( error ) ;
F_1 ( V_2 ) ;
V_255 = 1 ;
...
static void F_150 ( struct V_118 * V_119 )
{
if ( V_119 )
F_133 ( F_7 ( V_119 , struct V_14 , V_17 ) ) ;
}
