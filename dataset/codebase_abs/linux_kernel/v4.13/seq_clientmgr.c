...
struct V_112 * V_113 ;
V_113 = F_134 ( V_9 -> V_42 , V_141 -> V_233 , V_141 -> V_14 ) ;
if ( F_135 ( V_113 ) )
return F_136 ( V_113 ) ;
...
if ( F_143 ( V_141 -> V_102 , V_9 -> V_42 , V_141 -> V_233 ) < 0 )
return - V_124 ;
if ( V_141 -> V_233 )
...
int F_149 ( int V_9 , struct V_243 * V_244 )
{
if ( ! F_142 ( V_244 -> V_102 , V_9 ) )
return - V_124 ;
return F_150 ( V_244 -> V_102 , V_9 , V_244 ) ;
}
...
int V_51 ;
if ( V_141 -> V_259 >= 0 ) {
V_51 = F_144 ( V_141 -> V_102 , V_9 -> V_42 , V_141 -> V_259 ) ;
if ( V_51 < 0 )
return V_51 ;
}
...
V_267 = F_164 ( V_9 -> V_57 . V_50 . V_58 , V_141 -> V_265 ) ;
if ( V_267 < 0 )
return V_267 ;
...
if ( ( V_219 = F_73 ( V_222 , V_130 -> V_222 . V_89 ) ) == NULL )
goto V_229;
V_274 = F_168 ( & V_219 -> V_137 , & V_130 -> V_92 ) ;
if ( V_274 ) {
V_69 = 0 ;
* V_130 = V_274 -> V_141 ;
} else
...
V_278 = 0 ;
V_69 = - V_120 ;
F_170 (p, &group->list_head) {
if ( V_278 ++ == V_130 -> V_283 ) {
struct V_129 * V_284 ;
if ( V_130 -> type == V_280 ) {
V_284 = F_171 ( V_274 , struct V_129 , V_285 ) ;
V_130 -> V_146 = V_284 -> V_141 . V_92 ;
} else {
V_284 = F_171 ( V_274 , struct V_129 , V_286 ) ;
...
static long F_175 ( struct V_1 * V_1 , unsigned int V_287 ,
unsigned long V_183 )
{
struct V_8 * V_9 = V_1 -> V_61 ;
union {
...
int F_177 ( struct V_308 * V_25 , int V_34 ,
const char * V_309 , ... )
{
struct V_8 * V_9 ;
T_7 args ;
...
static int F_179 ( int V_9 , struct V_77 * V_153 ,
struct V_1 * V_1 , int V_163 ,
int V_96 , int V_97 )
{
struct V_8 * V_197 ;
...
int F_180 ( int V_9 , struct V_77 * V_153 ,
int V_96 , int V_97 )
{
return F_179 ( V_9 , V_153 , NULL , 0 , V_96 , V_97 ) ;
}
int F_181 ( int V_9 , struct V_77 * V_153 ,
struct V_1 * V_1 ,
int V_96 , int V_97 )
{
return F_179 ( V_9 , V_153 , V_1 , 1 , V_96 , V_97 ) ;
}
...
int F_183 ( int V_11 , unsigned int V_287 , void * V_183 )
{
const struct V_299 * V_300 ;
struct V_8 * V_9 ;
V_9 = F_4 ( V_11 ) ;
...
F_5 ( L_9 ,
V_287 , F_184 ( V_287 ) , F_185 ( V_287 ) ) ;
return - V_302 ;
}
int F_186 ( int V_11 , struct V_1 * V_1 , T_6 * V_177 )
{
struct V_8 * V_9 ;
V_9 = F_4 ( V_11 ) ;
if ( V_9 == NULL )
...
F_189 ( V_312 , L_12 , ( ( V_284 -> V_141 . V_14 & V_143 ) ? 'r' : 't' ) , V_284 -> V_141 . V_102 ) ;
if ( V_276 -> V_315 )
F_189 ( V_312 , L_13 ) ;
}
F_81 ( & V_276 -> V_139 ) ;
...
static void F_190 ( struct V_311 * V_312 ,
struct V_8 * V_9 )
{
struct V_88 * V_274 ;
F_33 ( & V_9 -> V_40 ) ;
...
F_193 ( V_274 -> V_90 ) ,
F_194 ( V_274 -> V_90 ) ) ;
F_187 ( V_312 , & V_274 -> V_137 , 1 , L_16 ) ;
F_187 ( V_312 , & V_274 -> V_216 , 0 , L_17 ) ;
}
F_36 ( & V_9 -> V_40 ) ;
}
void F_195 ( struct V_316 * V_317 ,
struct V_311 * V_312 )
{
int V_36 ;
struct V_8 * V_9 ;
F_189 ( V_312 , L_18 ) ;
F_189 ( V_312 , L_19 , V_46 . V_32 ) ;
F_189 ( V_312 , L_20 , V_46 . V_33 ) ;
F_189 ( V_312 , L_21 , V_12 ) ;
F_189 ( V_312 , L_14 ) ;
...
if ( F_2 ( V_9 ) ) {
F_189 ( V_312 , L_25 ) ;
F_196 ( V_312 , V_9 -> V_10 , L_26 ) ;
}
if ( V_9 -> type == V_44 && V_9 -> V_57 . V_50 . V_58 &&
V_9 -> V_57 . V_50 . V_58 -> V_10 ) {
F_189 ( V_312 , L_27 ) ;
F_196 ( V_312 , V_9 -> V_57 . V_50 . V_58 -> V_10 , L_26 ) ;
}
F_64 ( V_9 ) ;
}
}
