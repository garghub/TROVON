...
int V_68 ;
F_43 ( V_6 -> V_91 ) ;
V_68 = F_44 ( V_6 -> V_113 . V_114 , V_115 , V_116 , 1 ) ;
if ( V_68 && V_68 != - V_117 ) {
F_31 ( V_6 -> V_91 , L_5 ) ;
goto V_118;
}
...
return 0 ;
V_120:
F_44 ( V_6 -> V_113 . V_114 , V_115 , V_116 , 0 ) ;
V_118:
F_47 ( V_6 -> V_91 ) ;
F_45 ( & V_6 -> V_70 ) ;
V_6 -> V_36 = NULL ;
...
int V_68 = 0 ;
unsigned long V_78 ;
V_68 = F_44 ( V_6 -> V_113 . V_114 , V_115 , V_116 , 0 ) ;
if ( V_68 && V_68 != - V_117 )
F_31 ( V_6 -> V_91 , L_7 ) ;
F_45 ( & V_6 -> V_70 ) ;
V_6 -> V_36 = NULL ;
...
int V_68 ;
V_136 = F_55 ( V_6 , V_138 -> V_145 ) ;
if ( ! V_136 ) {
V_136 = V_6 -> V_134 [ V_6 -> V_132 - 1 ] ;
V_138 -> V_145 = V_136 -> V_12 ;
}
V_138 -> V_22 = F_57 ( V_138 -> V_22 , 0U , V_146 ) ;
V_138 -> V_25 = F_57 ( V_138 -> V_25 , 0U , V_147 ) ;
F_58 ( & V_142 . V_142 , V_138 , V_136 -> V_148 ) ;
V_68 = F_44 ( V_6 -> V_113 . V_114 , V_149 , V_150 ,
& V_140 , & V_142 ) ;
if ( V_68 < 0 )
return V_68 ;
F_59 ( V_138 , & V_142 . V_142 ) ;
V_138 -> V_46 = V_47 ;
V_138 -> V_151 = V_138 -> V_22 * V_136 -> V_152 ;
V_138 -> V_89 = V_138 -> V_151 * V_138 -> V_25 ;
if ( V_13 )
* V_13 = V_136 ;
return 0 ;
}
static int F_60 ( struct V_5 * V_6 , struct V_129 * V_135 )
{
struct V_141 V_142 = {
. V_143 = V_153 ,
} ;
...
if ( V_68 )
return V_68 ;
F_58 ( & V_142 . V_142 , & V_135 -> V_20 . V_21 ,
V_13 -> V_148 ) ;
V_68 = F_44 ( V_6 -> V_113 . V_114 , V_149 ,
V_150 , NULL , & V_142 ) ;
if ( V_68 < 0 )
return V_68 ;
V_6 -> V_20 = * V_135 ;
...
{
struct V_5 * V_6 = F_54 ( V_127 ) ;
if ( V_135 -> V_157 >= V_6 -> V_132 )
return - V_90 ;
V_135 -> V_145 = V_6 -> V_134 [ V_135 -> V_157 ] -> V_12 ;
return 0 ;
}
static int F_64 ( struct V_127 * V_127 , void * V_128 ,
struct V_158 * V_159 )
{
F_65 ( V_159 -> V_160 , L_10 , sizeof( V_159 -> V_160 ) ) ;
F_65 ( V_159 -> V_161 , L_11 , sizeof( V_159 -> V_161 ) ) ;
F_65 ( V_159 -> V_162 , L_12 , sizeof( V_159 -> V_162 ) ) ;
return 0 ;
}
static int F_66 ( struct V_127 * V_127 , void * V_128 ,
struct V_163 * V_133 )
{
if ( V_133 -> V_157 != 0 )
return - V_90 ;
V_133 -> type = V_164 ;
F_65 ( V_133 -> V_165 , L_13 , sizeof( V_133 -> V_165 ) ) ;
return 0 ;
}
...
static int F_68 ( struct V_127 * V_127 , void * V_128 , unsigned int V_133 )
{
if ( V_133 > 0 )
return - V_90 ;
return 0 ;
}
static int F_69 ( struct V_127 * V_127 , void * V_166 , struct V_167 * V_168 )
{
struct V_5 * V_6 = F_54 ( V_127 ) ;
if ( V_168 -> type != V_169 )
return - V_90 ;
V_168 -> V_170 . V_171 . V_172 = 2 ;
return F_44 ( V_6 -> V_113 . V_114 , V_115 , V_173 , V_168 ) ;
}
static int F_70 ( struct V_127 * V_127 , void * V_166 , struct V_167 * V_168 )
{
struct V_5 * V_6 = F_54 ( V_127 ) ;
if ( V_168 -> type != V_169 )
return - V_90 ;
V_168 -> V_170 . V_171 . V_172 = 2 ;
return F_44 ( V_6 -> V_113 . V_114 , V_115 , V_174 , V_168 ) ;
}
static int F_71 ( struct V_127 * V_127 , void * V_166 ,
struct V_175 * V_176 )
{
struct V_5 * V_6 = F_54 ( V_127 ) ;
const struct V_130 * V_136 ;
...
if ( ! V_136 )
return - V_90 ;
V_178 . V_180 = V_136 -> V_148 ;
V_68 = F_44 ( V_6 -> V_113 . V_114 , V_149 , V_181 ,
NULL , & V_178 ) ;
if ( V_68 )
return V_68 ;
V_176 -> type = V_182 ;
...
static int F_72 ( struct V_127 * V_127 , void * V_166 ,
struct V_186 * V_187 )
{
struct V_5 * V_6 = F_54 ( V_127 ) ;
const struct V_130 * V_136 ;
...
V_207 = F_75 ( V_207 , NULL ) ;
if ( ! V_207 ) {
F_31 ( & V_205 -> V_91 , L_14 ) ;
return - V_90 ;
}
V_211 = F_76 ( F_77 ( V_207 ) , & V_210 ) ;
F_78 ( V_207 ) ;
if ( V_211 ) {
...
static int F_79 ( struct V_127 * V_127 )
{
struct V_5 * V_6 = F_54 ( V_127 ) ;
...
if ( ! F_82 ( V_127 ) )
goto V_229;
V_68 = F_44 ( V_225 , V_230 , V_231 , 1 ) ;
if ( V_68 < 0 && V_68 != - V_117 )
goto V_229;
V_68 = F_60 ( V_6 , & V_6 -> V_20 ) ;
if ( V_68 )
F_44 ( V_225 , V_230 , V_231 , 0 ) ;
V_229:
if ( V_68 )
F_83 ( V_127 ) ;
V_228:
...
static int F_85 ( struct V_127 * V_127 )
{
struct V_5 * V_6 = F_54 ( V_127 ) ;
struct V_224 * V_225 = V_6 -> V_113 . V_114 ;
bool V_232 ;
...
{
const struct V_130 * V_235 [ F_90 ( V_236 ) ] ;
unsigned int V_237 = 0 , V_133 , V_238 ;
struct V_224 * V_114 = V_6 -> V_113 . V_114 ;
struct V_239 V_148 = {
. V_143 = V_153 ,
} ;
while ( ! F_44 ( V_114 , V_149 , V_240 ,
NULL , & V_148 ) ) {
for ( V_133 = 0 ; V_133 < F_90 ( V_236 ) ; V_133 ++ ) {
if ( V_236 [ V_133 ] . V_148 != V_148 . V_180 )
continue;
...
static void F_96 ( struct V_244 * V_245 ,
struct V_224 * V_225 ,
struct V_249 * V_250 )
{
struct V_5 * V_6 = F_93 ( V_245 ) ;
F_24 ( V_6 -> V_91 , L_22 , F_95 ( V_6 -> V_246 ) ) ;
F_97 ( V_6 -> V_246 ) ;
}
...
{
struct V_5 * V_6 = F_93 ( V_245 ) ;
F_24 ( V_6 -> V_91 , L_23 , V_114 -> V_165 ) ;
V_6 -> V_113 . V_114 = V_114 ;
return 0 ;
}
static int F_99 ( struct V_5 * V_6 , struct V_206 * V_112 )
{
struct V_206 * V_210 = NULL ;
struct V_206 * V_251 ;
while ( 1 ) {
V_210 = F_75 ( V_112 , V_210 ) ;
if ( ! V_210 )
return - V_90 ;
V_251 = F_100 ( V_210 ) ;
if ( ! V_251 ) {
...
V_6 -> V_113 . V_250 . V_254 . V_255 . V_255 = F_77 ( V_251 ) ;
return 0 ;
}
}
...
int V_68 ;
V_68 = F_99 ( V_6 , V_6 -> V_91 -> V_208 ) ;
if ( V_68 < 0 ) {
F_31 ( V_6 -> V_91 , L_24 ) ;
return V_68 ;
}
V_256 = F_102 ( V_6 -> V_91 , sizeof( * V_256 ) , V_242 ) ;
if ( V_256 == NULL ) {
F_78 ( V_6 -> V_113 . V_112 ) ;
return - V_243 ;
}
V_256 [ 0 ] = & V_6 -> V_113 . V_250 ;
V_6 -> V_245 . V_256 = V_256 ;
V_6 -> V_245 . V_257 = 1 ;
V_6 -> V_245 . V_258 = F_98 ;
V_6 -> V_245 . V_259 = F_96 ;
V_6 -> V_245 . F_15 = F_92 ;
V_68 = F_103 ( & V_6 -> V_260 , & V_6 -> V_245 ) ;
if ( V_68 < 0 ) {
F_31 ( V_6 -> V_91 , L_25 ) ;
F_78 ( V_6 -> V_113 . V_112 ) ;
return V_68 ;
...
struct V_262 * V_9 ;
int V_68 , V_133 ;
V_6 = F_102 ( & V_205 -> V_91 , sizeof( struct V_5 ) , V_242 ) ;
if ( ! V_6 ) {
F_31 ( & V_205 -> V_91 , L_26 ) ;
return - V_243 ;
}
V_6 -> V_263 = F_105 ( & V_205 -> V_91 , L_27 ) ;
if ( F_106 ( V_6 -> V_263 ) )
return F_107 ( V_6 -> V_263 ) ;
V_68 = F_74 ( V_6 , V_205 ) ;
if ( V_68 )
return V_68 ;
V_6 -> V_36 = NULL ;
...
F_28 ( & V_6 -> V_96 ) ;
V_261 = & V_6 -> V_154 ;
V_68 = F_110 ( & V_205 -> V_91 , & V_6 -> V_260 ) ;
if ( V_68 )
return V_68 ;
V_6 -> V_246 = F_111 () ;
if ( V_6 -> V_246 == NULL ) {
...
V_6 -> V_246 -> V_154 = & V_6 -> V_154 ;
F_65 ( V_6 -> V_246 -> V_165 , V_267 , sizeof( V_6 -> V_246 -> V_165 ) ) ;
...
V_9 = F_115 ( V_205 , V_295 , 0 ) ;
V_6 -> V_9 = F_116 ( & V_205 -> V_91 , V_9 ) ;
if ( F_106 ( V_6 -> V_9 ) ) {
V_68 = F_107 ( V_6 -> V_9 ) ;
goto V_296;
}
...
V_68 = F_118 ( & V_205 -> V_91 , V_63 , F_13 , 0 , L_30 , V_6 ) ;
if ( V_68 ) {
...
static int F_128 ( struct V_86 * V_91 )
{
struct V_5 * V_6 = F_129 ( V_91 ) ;
F_130 ( V_6 -> V_263 ) ;
return 0 ;
}
static int F_131 ( struct V_86 * V_91 )
{
struct V_5 * V_6 = F_129 ( V_91 ) ;
return F_132 ( V_6 -> V_263 ) ;
}
