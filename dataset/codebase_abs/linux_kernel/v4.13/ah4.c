...
F_33 ( V_48 , V_3 + V_51 ) ;
V_30 = F_34 ( V_32 , V_48 , 0 , V_32 -> V_5 ) ;
if ( F_35 ( V_30 < 0 ) )
goto V_58;
if ( V_35 -> V_54 . V_55 & V_56 ) {
...
F_37 ( V_12 , V_48 , V_11 , V_32 -> V_5 + V_49 ) ;
F_38 ( V_12 , 0 , F_16 , V_32 ) ;
F_20 ( V_32 ) -> V_9 = V_14 ;
V_30 = F_39 ( V_12 ) ;
if ( V_30 ) {
if ( V_30 == - V_73 )
...
static void F_40 ( struct V_28 * V_29 , int V_30 )
{
T_1 * V_42 ;
T_1 * V_11 ;
struct V_13 * V_76 ;
struct V_31 * V_32 = V_29 -> V_33 ;
struct V_34 * V_35 = F_41 ( V_32 ) ;
struct V_37 * V_38 = V_35 -> V_33 ;
struct V_40 * V_41 = V_40 ( V_32 ) ;
int V_18 = F_19 ( V_32 ) ;
...
V_30 = F_42 ( V_11 , V_42 , V_38 -> V_43 ) ? - V_78 : 0 ;
if ( V_30 )
goto V_53;
V_30 = V_41 -> V_59 ;
V_32 -> V_79 += V_77 ;
memcpy ( F_43 ( V_32 ) , V_76 , V_18 ) ;
F_44 ( V_32 , V_77 + V_18 ) ;
...
static int F_48 ( struct V_34 * V_35 , struct V_31 * V_32 )
{
int V_77 ;
int V_18 ;
int V_59 ;
...
static int F_51 ( struct V_31 * V_32 , T_3 V_87 )
{
struct V_88 * V_88 = F_52 ( V_32 -> V_89 ) ;
const struct V_13 * V_14 = ( const struct V_13 * ) V_32 -> V_33 ;
struct V_40 * V_41 = (struct V_40 * ) ( V_32 -> V_33 + ( V_14 -> V_18 << 2 ) ) ;
struct V_34 * V_35 ;
switch ( F_53 ( V_32 ) -> type ) {
case V_90 :
if ( F_53 ( V_32 ) -> V_91 != V_92 )
return 0 ;
case V_93 :
break;
default:
...
V_35 = F_54 ( V_88 , V_32 -> V_94 , ( const V_95 * ) & V_14 -> V_15 ,
V_41 -> V_66 , V_60 , V_96 ) ;
if ( ! V_35 )
return 0 ;
if ( F_53 ( V_32 ) -> type == V_90 )
F_55 ( V_32 , V_88 , V_87 , 0 , 0 , V_60 , 0 ) ;
else
F_56 ( V_32 , V_88 , 0 , 0 , V_60 , 0 ) ;
F_57 ( V_35 ) ;
return 0 ;
}
...
if ( V_35 -> V_100 )
goto error;
V_38 = F_59 ( sizeof( * V_38 ) , V_101 ) ;
if ( ! V_38 )
return - V_57 ;
V_2 = F_60 ( V_35 -> V_99 -> V_102 , 0 , 0 ) ;
if ( F_61 ( V_2 ) )
goto error;
V_38 -> V_2 = V_2 ;
if ( F_62 ( V_2 , V_35 -> V_99 -> V_103 ,
( V_35 -> V_99 -> V_104 + 7 ) / 8 ) )
goto error;
V_98 = F_63 ( V_35 -> V_99 -> V_102 , 0 ) ;
F_64 ( ! V_98 ) ;
...
static int F_68 ( struct V_31 * V_32 , int V_30 )
{
return 0 ;
}
...
{
if ( F_74 ( & V_113 , V_60 ) < 0 )
F_65 ( L_4 , V_108 ) ;
if ( F_72 ( & V_111 , V_96 ) < 0 )
F_65 ( L_5 , V_108 ) ;
}
