...
static void F_26 ( struct V_1 * V_1 , T_3 V_49 , T_3 V_50 )
{
struct V_11 * V_11 = (struct V_11 * ) V_1 ;
int V_51 = V_52 ;
T_1 V_12 [ 2 ] ;
if ( V_11 -> V_14 == V_15 && V_11 -> V_16 == 1 ) {
V_51 = ( V_49 * 9267 ) / 10000 + 300 ;
F_9 ( V_1 , 3 , V_51 >> 4 ) ;
F_9 ( V_1 , 4 , V_51 & 0x0f ) ;
} else if ( V_11 -> V_16 == 2 ) {
V_51 = V_49 ;
...
T_1 V_53 = ( 60 * V_49 + 7999 ) / 8000 ;
if ( V_53 < V_50 && V_1 -> V_35 . V_36 >= 320 )
V_53 = V_50 ;
else if ( V_53 < 2 )
V_53 = 2 ;
if ( V_11 -> V_14 == V_31 && V_53 < 4 )
V_53 = 4 ;
V_51 = ( 60 * 511 * V_49 ) / ( 8000 * V_53 ) ;
if ( V_51 > 511 )
V_51 = 511 ;
V_51 = 511 - V_51 ;
V_12 [ 0 ] = V_51 & 0xff ;
...
for ( V_54 = 0x0a ; V_54 < 0x11 ; V_54 += 2 ) {
F_9 ( V_1 , V_54 , V_45 >> 8 ) ;
F_9 ( V_1 , V_54 + 1 , V_45 & 0xff ) ;
}
else
F_9 ( V_1 , 0x10 , V_45 ) ;
}
...
{
struct V_1 * V_1 =
F_30 ( V_56 -> V_57 , struct V_1 , V_58 ) ;
struct V_11 * V_11 = (struct V_11 * ) V_1 ;
V_1 -> V_59 = 0 ;
if ( ! V_1 -> V_60 )
return 0 ;
...
break;
case V_63 :
F_26 ( V_1 , V_11 -> V_51 -> V_45 ,
V_11 -> V_50 ? V_11 -> V_50 -> V_45 : 0 ) ;
break;
case V_64 :
F_27 ( V_1 , V_56 -> V_45 ) ;
break;
...
{
struct V_11 * V_11 = (struct V_11 * ) V_1 ;
struct V_65 * V_66 = & V_1 -> V_58 ;
static const struct V_67 V_53 = {
. V_68 = & V_69 ,
. V_23 = V_70 ,
. type = V_71 ,
. V_72 = L_16 ,
...
1 , V_97 ) ;
if ( V_85 )
V_11 -> V_51 = F_33 ( V_66 , & V_69 ,
V_63 , V_98 ,
V_99 , 1 , V_52 ) ;
if ( V_86 )
V_11 -> V_50 = F_34 ( V_66 , & V_53 , NULL ) ;
if ( V_66 -> error ) {
F_4 ( L_17 ) ;
return V_66 -> error ;
}
...
struct V_11 * V_11 = (struct V_11 * ) V_1 ;
unsigned char * V_100 ;
V_100 = F_37 ( V_1 , & V_11 -> V_44 , V_8 , V_2 ) ;
if ( V_100 ) {
int V_101 ;
V_101 = V_100 - V_8 ;
if ( V_101 > sizeof F_38 )
V_101 -= sizeof F_38 ;
else
V_101 = 0 ;
F_39 ( V_1 , V_102 ,
...
F_39 ( V_1 , V_104 , V_8 , V_2 ) ;
}
static int F_40 ( struct V_105 * V_106 ,
const struct V_22 * V_23 )
{
return F_41 ( V_106 , V_23 , & V_107 , sizeof( struct V_11 ) ,
V_108 ) ;
}
