...
V_48 . V_51 = V_45 -> V_51 ;
V_48 . V_52 = & V_53 ;
V_48 . V_28 = V_45 -> V_28 | V_54 ;
V_48 . V_55 = ( V_45 -> V_56 ? & V_45 -> V_56 : NULL ) ;
V_48 . V_57 = ( V_45 -> V_56 ? 1 : 0 ) ;
V_17 -> V_12 . V_48 = & V_48 ;
V_17 -> V_19 = V_45 -> V_19 ;
...
V_17 -> V_35 = V_45 -> V_35 ;
V_17 -> V_36 = V_45 -> V_36 ;
V_43 = F_24 ( NULL , & V_17 -> V_12 ) ;
if ( F_25 ( F_26 ( V_43 ) ) )
F_27 ( V_17 ) ;
return V_43 ;
}
static void T_1 F_28 ( struct V_1 * V_58 )
{
void T_3 * V_46 ;
int V_27 , V_59 = F_4 ( V_60 ) ;
struct V_61 * V_4 ;
if ( ! V_58 ) {
F_29 ( L_1 ) ;
return;
...
if ( F_25 ( ! V_4 ) )
return;
V_4 -> V_62 = F_31 ( V_59 , sizeof( * V_4 -> V_62 ) , V_49 ) ;
if ( ! V_4 -> V_62 )
return;
for ( V_27 = 0 ; V_27 < V_59 ; V_27 ++ ) {
struct V_44 * V_45 = & V_60 [ V_27 ] ;
V_4 -> V_62 [ V_45 -> V_19 ] =
F_21 ( V_45 , V_46 , V_58 ) ;
}
V_4 -> V_63 = V_59 ;
