...
V_102:
return F_40 ( V_3 -> V_48 , V_70 , V_11 , false ) ;
}
static int F_41 ( struct V_7 * V_8 , void T_8 * V_108 )
{
int V_109 ;
struct V_1 * V_3 ;
struct V_110 V_111 ;
T_6 * V_112 ;
T_1 V_18 ;
V_109 = F_42 ( & V_111 , V_108 , sizeof( struct V_110 ) ) ;
if ( V_109 != 0 ) {
F_7 ( L_35 ,
V_109 ) ;
return - V_113 ;
...
static void F_43 ( struct V_7 * V_8 , struct V_10 * V_11 )
{
struct V_1 * V_3 ;
T_6 * V_112 ;
T_9 * V_123 ;
...
V_126 = F_48 ( V_70 , V_127 -> V_90 . V_136 ) ;
F_46 ( V_70 ) ;
if ( V_126 == NULL ) {
...
static int F_52 ( struct V_7 * V_8 , int V_108 )
{
struct V_1 * V_3 ;
struct V_143 * V_144 ;
int V_145 ;
...
V_8 -> V_11 = & V_153 ;
F_59 ( F_34 ( V_8 ) ) ;
F_60 ( V_154 , & V_8 -> V_155 ) ;
F_60 ( V_156 , & V_8 -> V_155 ) ;
if ( V_3 -> V_11 ) {
char V_157 [ V_158 ] ;
...
V_3 -> V_9 = NULL ;
if ( V_3 -> V_11 ) {
struct V_143 * V_144 = F_57 ( V_3 -> V_11 ) ;
...
V_3 -> V_81 -> V_166 ( V_3 ) ;
V_3 -> V_125 -> V_166 ( V_3 ) ;
while ( ( V_70 = F_64 ( & F_34 ( V_8 ) -> V_132 ) ) ) {
F_45 ( V_8 , V_70 -> V_93 ) ;
F_65 ( V_70 ) ;
}
F_7 ( L_55 ,
...
static int F_67 ( struct V_7 * V_8 , struct V_69 * V_70 )
{
struct V_1 * V_3 = F_2 ( V_8 ) ;
struct V_162 * V_163 = (struct V_162 * ) V_70 -> V_78 ;
F_68 ( F_69 ( V_70 -> V_93 , & F_34 ( V_8 ) -> V_95 ) ) ;
if ( V_3 == NULL ) {
F_7 ( L_57 ) ;
return 0 ;
}
...
case V_175 :
F_21 ( L_66 ) ;
F_78 ( V_163 , V_3 , V_176 ) ;
break;
case V_177 :
F_21 ( L_67 ) ;
F_78 ( V_163 , V_3 , V_177 ) ;
break;
case V_178 :
F_21 ( L_68 ) ;
...
int F_62 ( struct V_162 * V_163 , struct V_1 * V_3 )
{
struct V_69 * V_70 ;
struct V_130 * V_131 ;
if ( V_3 == NULL || ! V_3 -> V_9 ) {
...
V_70 = F_79 ( sizeof( struct V_162 ) , V_182 ) ;
if ( V_70 == NULL )
return - V_148 ;
F_80 ( V_70 , sizeof( struct V_162 ) ) ;
F_32 ( V_70 , V_163 , sizeof( * V_163 ) ) ;
F_81 ( V_3 -> V_9 , V_70 -> V_93 ) ;
V_131 = F_34 ( V_3 -> V_9 ) ;
F_44 ( & V_131 -> V_132 , V_70 ) ;
V_131 -> V_133 ( V_131 ) ;
return 0 ;
}
static int F_82 ( struct V_183 * V_147 ,
unsigned long V_184 , void * V_185 )
{
struct V_10 * V_11 = F_83 ( V_185 ) ;
struct V_1 * V_3 ;
struct V_143 * V_144 ;
if ( ! F_84 ( F_85 ( V_11 ) , & V_32 ) )
return V_186 ;
if ( strncmp ( V_11 -> V_30 , L_71 , 3 ) )
return V_186 ;
switch ( V_184 ) {
case V_187 :
V_144 = F_57 ( V_11 ) ;
...
static void F_88 ( struct V_162 * V_197 ,
struct V_1 * V_203 ,
T_6 * V_16 )
{
T_1 V_13 = V_197 -> V_179 . V_198 . V_119 ;
...
static void F_73 ( struct V_162 * V_197 , struct V_1 * V_3 )
{
...
static void F_47 ( struct V_7 * V_8 , T_9 * V_16 )
{
struct V_130 * V_131 ;
struct V_162 * V_218 ;
struct V_69 * V_70 ;
...
static void F_74 ( struct V_162 * V_197 , struct V_1 * V_3 )
{
T_9 * V_16 ;
F_19 ( L_6 , V_3 -> V_11 -> V_30 ) ;
...
static void F_76 ( struct V_162 * V_163 ,
struct V_1 * V_3 )
{
struct V_143 * V_144 ;
int V_101 , V_223 ;
...
static void F_77 ( struct V_162 * V_197 ,
struct V_1 * V_203 )
{
if ( V_203 -> V_61 )
F_9 ( V_203 -> V_66 ) ;
V_203 -> V_61 = 0 ;
V_203 -> V_66 = F_96 ( V_197 -> V_165 , V_64 , V_17 ) ;
if ( V_203 -> V_66 == NULL ) {
F_7 ( L_91 ) ;
return;
}
...
static void F_78 ( struct V_162 * V_197 , struct V_1 * V_3 , int V_229 )
{
T_9 * V_16 ;
V_197 -> type = V_230 ;
F_94 ( & V_3 -> V_34 ) ;
...
static int F_98 ( struct V_243 * V_130 , unsigned int V_244 ,
unsigned long V_108 )
{
int V_145 = 0 ;
struct V_7 * V_8 = F_99 ( V_130 ) ;
...
switch ( V_244 ) {
case V_245 :
V_145 = F_52 ( V_8 , ( int ) V_108 ) ;
if ( V_145 >= 0 )
V_130 -> V_250 = V_251 ;
break;
case V_246 :
V_145 = F_41 ( V_8 , ( void T_8 * ) V_108 ) ;
break;
default:
break;
}
