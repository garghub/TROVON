...
static inline int F_40 ( struct V_8 * V_10 )
{
return ( V_10 -> V_39 . V_40 ( V_10 ) & V_72 ) ? 0 : 1 ;
}
static unsigned int F_41 ( struct V_8 * V_10 )
{
int V_2 ;
unsigned char V_73 ;
...
static void F_42 ( struct V_8 * V_10 , unsigned int V_1 )
{
...
static inline unsigned char F_43 ( struct V_8 * V_10 ,
unsigned int V_1 )
{
return 0 ;
}
static int F_44 ( struct V_8 * V_10 , int type )
{
unsigned int V_30 ;
V_30 = V_10 -> V_39 . V_40 ( V_10 ) ;
...
static void F_45 ( struct V_20 * V_20 , unsigned char V_80 ,
unsigned char V_81 )
{
...
static int F_46 ( struct V_8 * V_10 )
{
...
#endif
if ( V_14 -> V_96 ) {
F_50 ( V_10 -> V_54 -> V_97 , L_2 ) ;
V_10 -> V_98 = 2 ;
V_10 -> V_99 = 2 ;
V_10 -> V_52 = F_48 ( sizeof( struct V_24 ) , V_93 ) ;
V_25 = V_10 -> V_52 ;
if ( ! V_25 )
return - V_67 ;
V_10 -> V_100 = 1 ;
V_63 = F_51 ( V_25 , & V_101 , NULL , V_10 ) ;
if ( V_63 < 0 )
return V_63 ;
}
V_10 -> V_102 = & V_103 ;
