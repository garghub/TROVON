...
static unsigned F_9 ( int V_12 , unsigned V_13 )
{
if ( V_13 & ( F_6 ( 3 ) - 1 ) ) {
switch ( V_8 . V_14 ) {
case V_15 :
...
union V_1 F_10 ( int V_12 , int V_19 , unsigned V_13 )
{
assert ( V_13 ) ;
...
if ( V_8 . V_28 & V_24 )
F_8 ( V_24 ) ;
return F_16 ( V_12 , V_21 - 1 + V_29 , V_13 ) ;
} else {
assert ( ( V_13 >> ( V_7 + 1 ) ) == 0 ) ;
assert ( V_13 & V_20 ) ;
return F_16 ( V_12 , V_19 + V_29 , V_13 & ~ V_20 ) ;
}
}
