...
struct V_53 * V_33 ;
T_2 V_54 ;
V_12 = F_24 ( & V_48 -> V_55 , sizeof( * V_12 ) , V_56 ) ;
if ( ! V_12 )
return - V_57 ;
V_51 = F_25 ( V_48 , V_58 , 0 ) ;
V_22 = F_26 ( & V_48 -> V_55 , V_51 ) ;
if ( F_27 ( V_22 ) )
return F_28 ( V_22 ) ;
V_12 -> V_22 = V_22 ;
V_49 = F_29 ( V_48 , 0 ) ;
if ( V_49 > 0 ) {
V_12 -> V_46 = F_30 ( V_49 ) -> V_13 ;
V_52 = F_30 ( V_49 ) -> V_40 ;
}
if ( ! V_52 ) {
F_14 ( & V_48 -> V_55 , L_2 ) ;
...
V_49 = F_31 ( & V_12 -> V_2 , & V_48 -> V_55 , 4 ,
V_22 + V_60 ,
V_22 + V_61 , NULL ,
V_22 + V_62 , NULL , 0 ) ;
if ( V_49 )
...
V_12 -> V_28 = V_54 ;
V_12 -> V_29 = V_66 ;
if ( ! F_32 ( & V_48 -> V_55 , V_67 , & V_54 ) )
V_12 -> V_29 = V_54 ;
V_12 -> V_2 . V_68 = V_69 ;
if ( ! F_32 ( & V_48 -> V_55 , V_70 , & V_54 ) )
V_12 -> V_2 . V_68 = V_54 ;
F_33 ( & V_48 -> V_55 , L_3 ,
...
V_49 = F_36 ( & V_48 -> V_55 , & V_12 -> V_2 , V_12 ) ;
if ( V_49 ) {
F_14 ( & V_48 -> V_55 ,
L_4 ) ;
F_37 ( V_12 -> V_37 ) ;
