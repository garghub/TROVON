...
V_1 = V_56 + V_9 ;
F_37 ( V_1 , V_36 ) ;
V_36 -> V_61 = F_38 ( V_57 , L_13 , V_11 -> V_24 ) ;
V_14 = F_39 ( V_1 , NULL , F_28 ,
V_62 | V_63 ,
V_36 -> V_61 ? : V_11 -> V_24 , NULL ) ;
F_40 ( V_55 , L_14 , V_11 -> V_24 ,
V_1 , V_38 , V_38 + V_13 - 1 ) ;
return V_14 < 0 ? V_14 : V_38 ;
}
int F_41 ( struct V_54 * V_55 , int V_64 )
{
...
V_68 = V_72 + V_73 ;
V_38 = F_42 ( - 1 , 0 , V_68 , 0 ) ;
if ( V_38 < 0 ) {
F_31 ( V_55 , L_15 ) ;
return V_38 ;
}
F_43 ( V_70 , V_68 , V_38 , 0 ,
& V_74 , NULL ) ;
V_67 = V_38 + V_73 ;
V_14 = F_7 ( V_75 ) ;
if ( V_14 < 0 )
...
V_14 = F_39 ( V_64 , NULL , F_1 ,
V_63 ,
L_19 , NULL ) ;
if ( V_14 < 0 ) {
F_31 ( V_55 , L_20 , V_64 , V_14 ) ;
goto V_81;
}
F_44 ( V_64 ) ;
return V_38 ;
