...
struct V_7 * V_8 = F_3 ( V_6 ) ;
int V_55 = - V_138 ;
if ( V_8 -> V_60 . V_61 -> V_139 )
V_55 = V_8 -> V_60 . V_61 -> V_139 ( V_6 , V_137 ) ;
return V_55 ;
}
static int F_32 ( struct V_140 * V_141 )
{
struct V_142 * V_60 = V_141 -> V_58 . V_143 ;
struct V_144 * V_58 = & V_141 -> V_58 ;
struct V_7 * V_8 ;
int V_145 , V_18 = 0 ;
int V_55 ;
F_17 ( V_58 , L_2 , V_59 ) ;
...
V_145 = V_60 -> V_146 + V_60 -> V_147 ;
if ( V_145 < 1 || ! V_60 -> V_61 || ! V_60 -> V_61 -> V_88 ||
! V_60 -> V_61 -> V_66 ) {
F_14 ( V_58 , L_8 , V_59 ) ;
return - V_44 ;
}
V_8 = F_33 ( V_58 , sizeof( * V_8 ) , V_148 ) ;
if ( ! V_8 )
return - V_149 ;
V_8 -> V_60 = * V_60 ;
F_34 ( & V_8 -> V_56 ) ;
V_8 -> V_150 = F_33 ( V_58 , V_145 * sizeof( * V_8 -> V_150 ) ,
V_148 ) ;
if ( ! V_8 -> V_150 )
return - V_149 ;
if ( V_60 -> V_146 ) {
V_8 -> V_150 [ V_18 ] = V_151 ;
V_8 -> V_150 [ V_18 ] . V_132 . V_133 =
V_60 -> V_152 ;
V_18 ++ ;
}
if ( V_60 -> V_147 )
V_8 -> V_150 [ V_18 ] = V_153 ;
V_55 = F_35 ( V_58 , & V_154 , V_8 -> V_150 ,
V_145 ) ;
if ( V_55 ) {
F_14 ( V_58 , L_9 ,
V_59 , V_55 ) ;
