...
struct V_1 * V_2 ;
struct V_8 * V_9 ;
V_2 = F_8 ( & V_29 -> V_30 , sizeof( * V_9 ) ) ;
if ( ! V_2 )
return - V_31 ;
V_9 = F_2 ( V_2 ) ;
F_9 ( V_29 , V_2 ) ;
V_2 -> V_32 = V_29 -> V_30 . V_33 -> V_32 ;
V_2 -> V_30 . V_34 = & V_29 -> V_30 ;
V_2 -> V_35 = V_36 ;
V_2 -> V_37 = F_10 ( V_36 ) ;
V_2 -> V_38 = & V_39 ;
V_2 -> V_40 = V_41 ;
V_13 = F_11 ( V_9 , V_2 , V_29 , & V_42 ) ;
if ( V_13 )
return V_13 ;
V_13 = F_12 ( V_9 , V_2 , NULL ) ;
if ( V_13 )
return V_13 ;
V_13 = F_13 ( V_9 ) ;
if ( V_13 )
