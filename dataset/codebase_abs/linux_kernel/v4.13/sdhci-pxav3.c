...
F_36 ( V_42 , V_42 -> V_94 . V_95 , V_91 ) ;
}
static struct V_48 * F_37 ( struct V_96 * V_9 )
{
struct V_48 * V_49 ;
struct V_24 * V_25 = V_9 -> V_26 ;
T_4 V_52 ;
V_49 = F_38 ( V_9 , sizeof( * V_49 ) , V_97 ) ;
if ( ! V_49 )
return NULL ;
if ( ! F_39 ( V_25 , L_11 ,
& V_52 ) )
...
static inline struct V_48 * F_37 ( struct V_96 * V_9 )
{
return NULL ;
}
...
struct V_27 * V_28 ;
struct V_48 * V_49 = V_2 -> V_9 . V_50 ;
struct V_96 * V_9 = & V_2 -> V_9 ;
struct V_24 * V_25 = V_2 -> V_9 . V_26 ;
struct V_22 * V_23 = NULL ;
struct V_29 * V_30 = NULL ;
const struct V_98 * V_99 ;
int V_100 ;
V_23 = F_41 ( V_2 , & V_101 , sizeof( * V_30 ) ) ;
if ( F_16 ( V_23 ) )
return F_17 ( V_23 ) ;
V_28 = F_11 ( V_23 ) ;
V_30 = F_12 ( V_28 ) ;
V_30 -> V_102 = F_42 ( V_9 , L_12 ) ;
if ( F_16 ( V_30 -> V_102 ) )
V_30 -> V_102 = F_42 ( V_9 , NULL ) ;
if ( F_16 ( V_30 -> V_102 ) ) {
F_2 ( V_9 , L_13 ) ;
V_100 = F_17 ( V_30 -> V_102 ) ;
goto V_103;
}
V_28 -> V_104 = V_30 -> V_102 ;
F_43 ( V_30 -> V_102 ) ;
V_30 -> V_105 = F_42 ( V_9 , L_14 ) ;
if ( ! F_16 ( V_30 -> V_105 ) )
F_43 ( V_30 -> V_105 ) ;
V_23 -> V_42 -> V_34 |= V_43 ;
if ( F_44 ( V_25 , L_15 ) ) {
...
V_99 = F_46 ( F_47 ( V_107 ) , & V_2 -> V_9 ) ;
if ( V_99 ) {
V_100 = F_48 ( V_23 -> V_42 ) ;
if ( V_100 )
goto V_108;
F_49 ( V_2 ) ;
V_49 = F_37 ( V_9 ) ;
...
if ( V_49 -> V_109 & V_110 )
V_23 -> V_42 -> V_34 |= V_111 ;
if ( V_49 -> V_109 & V_112 )
V_23 -> V_42 -> V_34 |= V_113 ;
if ( V_49 -> V_31 )
V_23 -> V_31 |= V_49 -> V_31 ;
if ( V_49 -> V_114 )
V_23 -> V_114 |= V_49 -> V_114 ;
if ( V_49 -> V_115 )
V_23 -> V_42 -> V_34 |= V_49 -> V_115 ;
if ( V_49 -> V_116 )
V_23 -> V_42 -> V_117 |= V_49 -> V_116 ;
if ( V_49 -> V_118 )
V_23 -> V_42 -> V_118 |= V_49 -> V_118 ;
if ( F_50 ( V_49 -> V_119 ) ) {
V_100 = F_51 ( V_23 -> V_42 , V_49 -> V_119 ,
0 ) ;
if ( V_100 ) {
F_2 ( F_22 ( V_23 -> V_42 ) ,
L_16 ) ;
...
static int F_69 ( struct V_96 * V_9 )
{
int V_100 ;
struct V_22 * V_23 = F_70 ( V_9 ) ;
F_67 ( V_9 ) ;
if ( V_23 -> V_124 != V_125 )
F_71 ( V_23 -> V_42 ) ;
V_100 = F_72 ( V_23 ) ;
...
static int F_74 ( struct V_96 * V_9 )
{
int V_100 ;
struct V_22 * V_23 = F_70 ( V_9 ) ;
F_67 ( V_9 ) ;
...
static int F_76 ( struct V_96 * V_9 )
{
struct V_22 * V_23 = F_70 ( V_9 ) ;
struct V_27 * V_28 = F_11 ( V_23 ) ;
struct V_29 * V_30 = F_12 ( V_28 ) ;
...
static int F_78 ( struct V_96 * V_9 )
{
struct V_22 * V_23 = F_70 ( V_9 ) ;
struct V_27 * V_28 = F_11 ( V_23 ) ;
struct V_29 * V_30 = F_12 ( V_28 ) ;
