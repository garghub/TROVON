...
V_36 = F_9 ( V_6 -> V_42 / 2 + 1 ,
sizeof( * V_36 ) , V_43 ) ;
if ( ! V_36 )
return - V_44 ;
for ( V_29 = 0 ; V_29 < V_6 -> V_42 ; ) {
F_6 ( V_6 -> V_18 ,
F_10 ( V_29 , V_6 -> V_42 ) ) ;
...
V_29 ++ ;
} else if ( V_29 == V_6 -> V_42 - 1 ) {
V_29 ++ ;
} else {
V_29 += F_12 ( 20 * V_6 -> V_42 , 360 ) ;
if ( V_29 >= V_6 -> V_42 )
V_29 = V_6 -> V_42 - 1 ;
}
V_31 = V_30 ;
...
if ( V_36 [ 0 ] . V_34 == 0 && V_36 [ 0 ] . V_35 == V_6 -> V_42 - 1 ) {
F_6 ( V_6 -> V_18 , V_6 -> V_19 ) ;
F_13 ( V_2 -> V_16 , L_4 ,
V_6 -> V_19 ) ;
goto free;
...
& V_6 -> V_19 ) )
V_6 -> V_19 = 0 ;
V_6 -> V_20 = F_19 ( V_2 -> V_16 , L_10 ) ;
if ( F_5 ( V_6 -> V_20 ) )
F_14 ( V_2 -> V_16 , L_11 ) ;
V_6 -> V_18 = F_19 ( V_2 -> V_16 , L_12 ) ;
if ( F_5 ( V_6 -> V_18 ) )
F_14 ( V_2 -> V_16 , L_13 ) ;
V_2 -> V_6 = V_6 ;
return 0 ;
