...
void F_34 ( void ) {}
void F_33 ( void ) {}
static int F_36 ( T_1 V_82 , T_4 * V_83 ,
int V_84 , int V_85 )
{
T_5 V_86 ;
union V_9 V_87 [ 2 ] , * V_10 ;
struct V_88 V_89 ;
struct V_68 V_13 = { V_90 , NULL } ;
V_89 . V_91 = 2 ;
V_89 . V_16 = & V_87 [ 0 ] ;
V_87 [ 0 ] . type = V_21 ;
V_87 [ 0 ] . integer . V_22 = V_84 ;
V_87 [ 1 ] . type = V_21 ;
V_87 [ 1 ] . integer . V_22 = V_85 ;
V_86 = F_37 ( V_82 , NULL , & V_89 , & V_13 ) ;
if ( F_38 ( V_86 ) ) {
F_30 ( L_14 ,
F_39 ( V_86 ) ) ;
return - V_24 ;
...
V_85 = F_40 ( V_85 , ( int ) V_10 -> V_13 . V_15 ) ;
memcpy ( V_83 + V_84 , V_10 -> V_13 . V_16 , V_85 ) ;
F_41 ( V_13 . V_16 ) ;
return V_85 ;
}
bool F_42 ( struct V_92 * V_52 )
{
T_5 V_86 ;
T_1 V_39 , V_82 ;
V_39 = F_22 ( V_52 ) ;
if ( ! V_39 )
return false ;
V_86 = F_43 ( V_39 , L_15 , & V_82 ) ;
if ( F_38 ( V_86 ) )
return false ;
V_1 . V_82 = V_82 ;
return true ;
}
int F_44 ( T_4 * V_83 , int V_84 , int V_85 )
{
return F_36 ( V_1 . V_82 , V_83 , V_84 , V_85 ) ;
}
void *
F_45 ( struct V_93 * V_52 , struct V_94 * V_95 )
{
struct V_49 * V_96 ;
T_1 V_4 ;
int type , V_20 ;
...
if ( V_20 )
return NULL ;
V_20 = F_47 ( V_96 , type , - 1 , & V_97 ) ;
if ( V_20 < 0 )
return NULL ;
return F_48 ( V_97 , V_102 , V_103 ) ;
}
