...
static struct V_101 * F_72 ( struct V_41 * V_42 )
{
struct V_101 * V_102 = F_71 ( - V_73 ) ;
int V_80 ;
if ( F_50 ( V_42 ) )
V_102 = F_68 ( F_51 ( V_42 ) ) ;
else if ( F_53 ( V_42 -> V_77 , L_22 , & V_80 ) )
V_102 = F_62 ( V_42 ) ;
return V_102 ;
}
...
static int F_79 ( struct V_2 * V_48 , T_4 V_109 )
{
struct V_1 * V_9 = F_1 ( V_48 ) ;
unsigned long V_31 ;
int V_29 ;
...
static T_4 F_83 ( struct V_2 * V_48 )
{
struct V_1 * V_9 = F_1 ( V_48 ) ;
return V_9 -> V_11 ;
}
