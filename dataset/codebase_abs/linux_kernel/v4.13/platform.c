...
struct V_41 * V_42 ;
int V_43 ;
V_2 = F_43 ( & V_6 -> V_6 , sizeof( * V_2 ) , V_44 ) ;
if ( ! V_2 )
return - V_45 ;
V_2 -> V_6 = & V_6 -> V_6 ;
if ( ! V_6 -> V_6 . V_46 )
V_6 -> V_6 . V_46 = & V_6 -> V_6 . V_47 ;
V_43 = F_44 ( & V_6 -> V_6 , F_45 ( 32 ) ) ;
if ( V_43 )
return V_43 ;
V_42 = F_46 ( V_6 , V_48 , 0 ) ;
V_2 -> V_49 = F_47 ( & V_6 -> V_6 , V_42 ) ;
if ( F_24 ( V_2 -> V_49 ) )
return F_25 ( V_2 -> V_49 ) ;
F_32 ( & V_6 -> V_6 , L_14 ,
( unsigned long ) V_42 -> V_50 , V_2 -> V_49 ) ;
V_43 = F_22 ( V_2 ) ;
if ( V_43 )
return V_43 ;
F_48 ( & V_2 -> V_51 ) ;
...
static int T_1 F_60 ( struct V_54 * V_6 )
{
struct V_1 * V_55 = F_61 ( V_6 ) ;
int V_16 = 0 ;
if ( F_62 ( V_55 ) )
F_63 ( V_55 ) ;
if ( V_55 -> V_24 )
...
static int T_1 F_64 ( struct V_54 * V_6 )
{
struct V_1 * V_55 = F_61 ( V_6 ) ;
int V_16 = 0 ;
if ( V_55 -> V_24 ) {
