...
static int F_96 ( struct V_36 * V_37 , int type )
{
struct V_31 * V_32 = F_11 ( V_37 , type ) -> V_34 ;
...
void F_97 ( struct V_140 * V_141 )
{
struct V_134 * V_135 = F_91 ( V_141 , struct V_134 ,
V_147 ) ;
struct V_148 * V_149 ;
struct V_150 * V_151 , * V_152 ;
V_149 = F_98 ( & V_135 -> V_153 ) ;
F_99 (odquot, next_odquot, list, list) {
F_100 ( & V_151 -> V_154 ) ;
}
}
...
struct V_134 * V_135 = F_60 ( V_1 -> V_33 ) ;
int V_81 = 0 ;
F_102 ( F_8 ( & V_27 , V_1 -> V_28 ) ,
V_1 -> V_28 . type ) ;
F_85 ( & V_1 -> V_155 ) ;
if ( F_103 ( & V_1 -> V_156 ) > 1 )
goto V_74;
if ( V_157 == V_135 -> V_158 ) {
F_104 ( V_1 ) ;
if ( F_105 ( & F_4 ( V_1 ) -> V_149 , & V_135 -> V_153 ) )
F_106 ( V_135 -> V_159 , & V_135 -> V_147 ) ;
goto V_74;
}
V_81 = F_45 ( V_32 , 1 ) ;
if ( V_81 < 0 )
...
static int F_115 ( struct V_36 * V_37 , struct V_164 * V_165 )
{
int type = V_165 -> type ;
struct V_31 * V_65 = F_11 ( V_37 , type ) -> V_34 ;
int V_81 = 0 ;
F_116 ( F_8 ( & V_27 , * V_165 ) , type ) ;
if ( ! F_117 ( V_37 , type ) ) {
V_81 = - V_166 ;
goto V_74;
}
...
if ( V_81 < 0 )
goto V_167;
V_81 = F_118 ( & V_65 -> V_35 , V_165 ) ;
F_63 ( V_65 , 0 ) ;
V_167:
F_53 ( V_65 , 0 ) ;
V_74:
if ( V_81 && V_81 != - V_168 && V_81 != - V_166 )
F_24 ( V_81 ) ;
return V_81 ;
}
static int F_119 ( struct V_1 * V_1 )
{
unsigned long V_169 = ( 1 << ( V_8 + V_9 ) ) |
( 1 << ( V_8 + V_15 ) ) |
( 1 << ( V_8 + V_13 ) ) |
( 1 << ( V_8 + V_18 ) ) |
( 1 << ( V_8 + V_20 ) ) |
