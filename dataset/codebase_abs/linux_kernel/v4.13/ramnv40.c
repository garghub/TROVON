...
F_10 ( 100 ) ;
if ( ! V_25 ( V_10 , 'M' , & V_26 ) )
F_14 ( V_7 , F_15 ( V_10 , V_26 . V_33 + 0x00 ) ) ;
for ( V_29 = 0 ; V_29 < 2 ; V_29 ++ ) {
if ( ! ( V_27 & ( 1 << V_29 ) ) )
continue;
F_11 (device, 2000 ,
...
int
F_17 ( struct V_34 * V_8 , enum V_35 type , T_3 V_36 ,
T_1 V_37 , struct V_1 * * V_38 )
{
struct V_4 * V_5 ;
if ( ! ( V_5 = F_18 ( sizeof( * V_5 ) , V_39 ) ) )
return - V_40 ;
* V_38 = & V_5 -> V_2 ;
return F_19 ( & V_41 , V_8 , type , V_36 , V_37 , & V_5 -> V_2 ) ;
}
int
F_20 ( struct V_34 * V_8 , struct V_1 * * V_38 )
{
struct V_24 * V_11 = V_8 -> V_7 . V_11 ;
T_1 V_42 = F_7 ( V_11 , 0x001218 ) ;
T_1 V_36 = F_7 ( V_11 , 0x10020c ) & 0xff000000 ;
T_1 V_37 = F_7 ( V_11 , 0x100320 ) ;
enum V_35 type = V_43 ;
int V_19 ;
switch ( V_42 & 0x00000300 ) {
case 0x00000000 : type = V_44 ; break;
case 0x00000100 : type = V_45 ; break;
case 0x00000200 : type = V_46 ; break;
case 0x00000300 : type = V_47 ; break;
}
V_19 = F_17 ( V_8 , type , V_36 , V_37 , V_38 ) ;
if ( V_19 )
return V_19 ;
( * V_38 ) -> V_48 = ( F_7 ( V_11 , 0x100200 ) & 0x00000003 ) + 1 ;
return 0 ;
}
