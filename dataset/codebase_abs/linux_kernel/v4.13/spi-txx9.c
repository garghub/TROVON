...
static int F_33 ( struct V_84 * V_18 )
{
struct V_83 * V_15 ;
struct V_1 * V_2 ;
struct V_85 * V_86 ;
...
V_2 -> V_58 = F_44 ( V_2 -> V_89 ) ;
V_15 -> V_90 = F_19 ( V_2 -> V_58 , V_60 + 1 ) ;
V_15 -> V_16 = V_2 -> V_58 / ( V_59 + 1 ) ;
V_86 = F_45 ( V_18 , V_91 , 0 ) ;
V_2 -> V_4 = F_46 ( & V_18 -> V_18 , V_86 ) ;
if ( F_41 ( V_2 -> V_4 ) )
goto V_92;
V_33 = F_1 ( V_2 , V_36 ) ;
V_33 &= ~ ( V_37 | V_40 | V_41 ) ;
...
if ( V_21 < 0 )
goto V_92;
V_87 = F_48 ( & V_18 -> V_18 , V_21 , F_14 , 0 ,
L_4 , V_2 ) ;
if ( V_87 )
goto exit;
V_2 -> V_12 = - 1 ;
F_49 ( & V_18 -> V_18 , L_5 ,
( unsigned long long ) V_86 -> V_93 , V_21 ,
( V_2 -> V_58 + 500000 ) / 1000000 ) ;
V_15 -> V_94 = V_11 | V_44 | V_46 ;
V_15 -> V_95 = V_18 -> V_96 ;
V_15 -> V_97 = F_8 ;
V_15 -> V_98 = F_30 ;
V_15 -> V_99 = ( V_69 ) V_100 ;
V_15 -> V_101 = F_50 ( 8 ) | F_50 ( 16 ) ;
V_87 = F_51 ( & V_18 -> V_18 , V_15 ) ;
if ( V_87 )
goto exit;
return 0 ;
V_92:
...
static int F_54 ( struct V_84 * V_18 )
{
struct V_83 * V_15 = F_55 ( V_18 ) ;
struct V_1 * V_2 = F_9 ( V_15 ) ;
F_56 ( & V_2 -> V_80 ) ;
F_52 ( V_2 -> V_89 ) ;
return 0 ;
