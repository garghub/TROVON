...
static int F_13 ( struct V_32 * V_8 , struct V_15 * V_16 )
{
struct V_1 * V_2 = F_14 ( V_8 ) ;
T_2 V_17 [ 6 ] ;
int V_4 ;
V_4 = F_12 ( V_2 -> V_5 , V_33 ) ;
if ( V_4 < 0 )
return V_4 ;
if ( ! ( V_4 & V_34 ) )
return - V_35 ;
V_4 = F_7 ( V_2 -> V_5 , V_33 , 6 , V_17 ) ;
if ( V_4 < 0 ) {
F_3 ( V_2 -> V_5 -> V_8 , L_8 ,
V_4 ) ;
return V_4 ;
}
V_16 -> V_19 = ( V_17 [ 5 ] & V_36 ) + 100 ;
V_16 -> V_21 = ( V_17 [ 4 ] & V_37 ) - 1 ;
V_16 -> V_23 = V_17 [ 3 ] & V_38 ;
V_16 -> V_25 = V_17 [ 2 ] & V_39 ;
V_16 -> V_27 = V_17 [ 1 ] & V_40 ;
V_16 -> V_29 = V_17 [ 0 ] & V_41 ;
return F_8 ( V_16 ) ;
}
static int F_15 ( struct V_32 * V_8 , struct V_15 * V_42 )
{
struct V_1 * V_2 ;
T_2 V_17 [ 6 ] ;
V_2 = F_14 ( V_8 ) ;
...
return F_10 ( V_2 -> V_5 , V_33 , 6 , V_17 ) ;
}
static int F_16 ( struct V_32 * V_8 , struct V_43 * V_44 )
{
int V_4 ;
...
static int F_17 ( struct V_32 * V_8 , struct V_43 * V_44 )
{
int V_4 ;
struct V_15 * V_42 = & V_44 -> time ;
struct V_1 * V_2 = F_14 ( V_8 ) ;
...
static int F_18 ( struct V_32 * V_8 , unsigned int V_45 )
{
struct V_1 * V_2 = F_14 ( V_8 ) ;
return F_1 ( V_2 , V_45 ) ;
}
...
static int F_30 ( struct V_32 * V_8 )
{
...
static int F_33 ( struct V_32 * V_8 )
{
struct V_57 * V_58 = F_31 ( V_8 ) ;
struct V_1 * V_2 = F_14 ( & V_58 -> V_8 ) ;
int V_4 ;
...
static int F_34 ( struct V_32 * V_8 )
{
struct V_57 * V_58 = F_31 ( V_8 ) ;
struct V_1 * V_2 = F_14 ( & V_58 -> V_8 ) ;
int V_4 ;
