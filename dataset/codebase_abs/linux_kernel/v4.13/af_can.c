...
int V_128 = V_13 -> V_12 ;
F_67 ( & V_129 ) ;
F_72 ( V_14 [ V_128 ] != V_13 ) ;
F_68 ( V_14 [ V_128 ] , NULL ) ;
F_69 ( & V_129 ) ;
F_73 () ;
F_70 ( V_13 -> V_15 ) ;
}
static int F_74 ( struct V_131 * V_132 , unsigned long V_133 ,
void * V_134 )
{
struct V_72 * V_44 = F_75 ( V_134 ) ;
struct V_71 * V_80 ;
if ( V_44 -> type != V_56 )
return V_135 ;
switch ( V_133 ) {
case V_136 :
V_80 = F_76 ( sizeof( * V_80 ) , V_30 ) ;
if ( ! V_80 )
return V_135 ;
F_72 ( V_44 -> V_74 ) ;
V_44 -> V_74 = V_80 ;
...
static int F_77 ( struct V_17 * V_17 )
{
F_78 ( & V_17 -> V_45 . V_104 ) ;
V_17 -> V_45 . V_73 =
F_76 ( sizeof( struct V_71 ) , V_30 ) ;
V_17 -> V_45 . V_43 = F_76 ( sizeof( struct V_42 ) , V_30 ) ;
V_17 -> V_45 . V_101 = F_76 ( sizeof( struct V_100 ) , V_30 ) ;
if ( F_79 ( V_139 ) ) {
if ( V_140 ) {
F_80 ( & V_17 -> V_45 . V_141 , V_142 ,
( unsigned long ) V_17 ) ;
F_81 ( & V_17 -> V_45 . V_141 ,
F_82 ( V_143 + V_144 ) ) ;
}
V_17 -> V_45 . V_43 -> V_145 = V_143 ;
F_83 ( V_17 ) ;
}
return 0 ;
}
...
static T_2 int F_88 ( void )
{
F_89 ( F_90 ( struct V_115 , V_146 ) !=
F_90 ( struct V_39 , V_46 ) ||
F_90 ( struct V_115 , V_41 ) !=
F_90 ( struct V_39 , V_41 ) ) ;
F_91 ( L_15 V_147 L_16 ) ;
V_103 = F_92 ( L_17 , sizeof( struct V_97 ) ,
0 , 0 , NULL ) ;
if ( ! V_103 )
return - V_31 ;
F_93 ( & V_148 ) ;
