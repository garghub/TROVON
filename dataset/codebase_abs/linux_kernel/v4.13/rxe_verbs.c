...
if ( V_142 -> V_206 . V_193 == V_207 )
F_92 ( & V_142 -> V_206 . V_202 , 1 ) ;
V_26:
return V_76 ;
}
static struct V_208 * F_96 ( struct V_1 * V_2 ,
...
if ( V_4 -> V_136 )
return F_24 ( - V_11 ) ;
V_76 = F_97 ( V_8 , NULL , V_4 -> V_212 , V_4 -> V_213 , V_68 ) ;
if ( V_76 )
goto V_26;
V_211 = F_23 ( & V_8 -> V_214 ) ;
if ( ! V_211 ) {
V_76 = - V_73 ;
goto V_26;
}
V_76 = F_98 ( V_8 , V_211 , V_4 -> V_212 , V_4 -> V_213 ,
V_47 , V_68 ) ;
if ( V_76 )
goto V_97;
return & V_211 -> V_215 ;
...
static int F_99 ( struct V_208 * V_215 )
{
struct V_210 * V_211 = F_100 ( V_215 ) ;
F_27 ( V_211 ) ;
return 0 ;
}
static int F_101 ( struct V_208 * V_215 , int V_212 , struct V_5 * V_68 )
{
int V_76 ;
struct V_210 * V_211 = F_100 ( V_215 ) ;
struct V_7 * V_8 = F_2 ( V_215 -> V_38 ) ;
V_76 = F_97 ( V_8 , V_211 , V_212 , 0 , V_68 ) ;
if ( V_76 )
goto V_26;
V_76 = F_102 ( V_211 , V_212 , V_68 ) ;
if ( V_76 )
goto V_26;
return 0 ;
V_26:
...
static int F_103 ( struct V_208 * V_215 , int V_216 , struct V_217 * V_218 )
{
int V_103 ;
struct V_210 * V_211 = F_100 ( V_215 ) ;
struct V_219 * V_212 ;
unsigned long V_136 ;
F_65 ( & V_211 -> V_220 , V_136 ) ;
for ( V_103 = 0 ; V_103 < V_216 ; V_103 ++ ) {
V_212 = F_104 ( V_211 -> V_108 ) ;
if ( ! V_212 )
break;
memcpy ( V_218 ++ , & V_212 -> V_221 , sizeof( * V_218 ) ) ;
F_105 ( V_211 -> V_108 ) ;
}
F_66 ( & V_211 -> V_220 , V_136 ) ;
return V_103 ;
}
static int F_106 ( struct V_208 * V_215 , int V_222 )
{
struct V_210 * V_211 = F_100 ( V_215 ) ;
int V_223 = F_91 ( V_211 -> V_108 ) ;
return ( V_223 > V_222 ) ? V_222 : V_223 ;
}
static int F_107 ( struct V_208 * V_215 , enum V_224 V_136 )
{
struct V_210 * V_211 = F_100 ( V_215 ) ;
unsigned long V_225 ;
int V_42 = 0 ;
F_65 ( & V_211 -> V_220 , V_225 ) ;
if ( V_211 -> V_226 != V_227 )
V_211 -> V_226 = V_136 & V_228 ;
if ( ( V_136 & V_229 ) && ! F_108 ( V_211 -> V_108 ) )
V_42 = 1 ;
F_66 ( & V_211 -> V_220 , V_225 ) ;
return V_42 ;
}
static struct V_230 * F_109 ( struct V_82 * V_86 , int V_185 )
{
struct V_7 * V_8 = F_2 ( V_86 -> V_38 ) ;
struct V_83 * V_84 = F_32 ( V_86 ) ;
struct V_231 * V_183 ;
int V_76 ;
V_183 = F_23 ( & V_8 -> V_232 ) ;
if ( ! V_183 ) {
V_76 = - V_73 ;
goto V_26;
}
...
static struct V_230 * F_111 ( struct V_82 * V_86 ,
T_4 V_234 ,
T_4 V_104 ,
T_4 V_195 ,
...
F_55 ( V_183 ) ;
F_42 ( V_84 ) ;
V_76 = F_112 ( V_8 , V_84 , V_234 , V_104 , V_195 ,
V_185 , V_68 , V_183 ) ;
if ( V_76 )
goto V_145;
return & V_183 -> V_233 ;
...
static int F_113 ( struct V_230 * V_233 )
{
struct V_231 * V_183 = F_114 ( V_233 ) ;
V_183 -> V_193 = V_235 ;
F_27 ( V_183 -> V_84 ) ;
F_57 ( V_183 ) ;
F_27 ( V_183 ) ;
...
static struct V_230 * F_115 ( struct V_82 * V_86 ,
enum V_236 V_237 ,
T_2 V_238 )
{
struct V_7 * V_8 = F_2 ( V_86 -> V_38 ) ;
...
F_55 ( V_183 ) ;
F_42 ( V_84 ) ;
V_76 = F_116 ( V_8 , V_84 , V_238 , V_183 ) ;
if ( V_76 )
goto V_97;
return & V_183 -> V_233 ;
V_97:
...
static int F_117 ( struct V_230 * V_233 , T_4 V_191 )
{
struct V_231 * V_183 = F_114 ( V_233 ) ;
struct V_240 * V_241 ;
struct V_242 * V_130 ;
if ( F_5 ( V_183 -> V_243 == V_183 -> V_244 ) )
return - V_73 ;
V_241 = V_183 -> V_241 [ V_183 -> V_243 / V_245 ] ;
V_130 = & V_241 -> V_130 [ V_183 -> V_243 % V_245 ] ;
V_130 -> V_191 = V_191 ;
V_130 -> V_246 = V_233 -> V_247 ;
V_183 -> V_243 ++ ;
return 0 ;
}
static int F_118 ( struct V_230 * V_233 , struct V_248 * V_249 ,
int V_250 , unsigned int * V_251 )
{
struct V_231 * V_183 = F_114 ( V_233 ) ;
int V_252 ;
V_183 -> V_243 = 0 ;
V_252 = F_119 ( V_233 , V_249 , V_250 , V_251 , F_117 ) ;
V_183 -> V_253 = V_233 -> V_195 ;
V_183 -> V_195 = V_233 -> V_195 ;
V_183 -> V_104 = V_233 -> V_104 ;
V_183 -> V_254 = F_120 ( V_233 -> V_247 ) ;
V_183 -> V_255 = V_233 -> V_247 - 1 ;
V_183 -> V_256 = V_183 -> V_195 & V_183 -> V_255 ;
return V_252 ;
}
static int F_121 ( struct V_139 * V_146 , union V_40 * V_257 , T_3 V_258 )
{
int V_76 ;
struct V_7 * V_8 = F_2 ( V_146 -> V_38 ) ;
struct V_141 * V_142 = F_71 ( V_146 ) ;
struct V_259 * V_260 ;
V_76 = F_122 ( V_8 , V_257 , & V_260 ) ;
if ( V_76 )
return V_76 ;
V_76 = F_123 ( V_8 , V_142 , V_260 ) ;
F_27 ( V_260 ) ;
return V_76 ;
}
static int F_124 ( struct V_139 * V_146 , union V_40 * V_257 , T_3 V_258 )
{
struct V_7 * V_8 = F_2 ( V_146 -> V_38 ) ;
struct V_141 * V_142 = F_71 ( V_146 ) ;
return F_125 ( V_8 , V_142 , V_257 ) ;
}
static T_5 F_126 ( struct V_38 * V_38 ,
struct V_261 * V_4 , char * V_130 )
{
...
V_2 -> V_269 = 0 ;
F_133 ( ( unsigned char * ) & V_2 -> V_270 ,
V_8 -> V_28 -> V_271 ) ;
V_2 -> V_2 . V_272 = & V_273 ;
F_134 ( & V_2 -> V_2 ,
F_135 ( V_2 -> V_2 . V_50 ) ) ;
V_2 -> V_274 = V_275 ;
V_2 -> V_276 = F_136 ( V_277 )
| F_136 ( V_278 )
| F_136 ( V_279 )
| F_136 ( V_280 )
| F_136 ( V_281 )
...
V_2 -> V_353 = V_354 ;
V_2 -> V_355 = V_356 ;
V_8 -> V_357 = F_137 ( L_9 , 0 , 0 ) ;
if ( F_138 ( V_8 -> V_357 ) ) {
F_36 ( L_10 ,
F_139 ( V_8 -> V_357 ) ) ;
return F_139 ( V_8 -> V_357 ) ;
}
V_76 = F_140 ( V_2 , NULL ) ;
if ( V_76 ) {
F_6 ( L_11 , V_76 ) ;
...
for ( V_103 = 0 ; V_103 < F_141 ( V_358 ) ; ++ V_103 ) {
V_76 = F_142 ( & V_2 -> V_2 , V_358 [ V_103 ] ) ;
if ( V_76 ) {
F_6 ( L_12 ,
V_103 , V_76 ) ;
goto V_97;
