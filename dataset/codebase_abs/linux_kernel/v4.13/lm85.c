...
static T_3 F_47 ( struct V_17 * V_18 , struct V_73 * V_74 ,
char * V_75 )
{
struct V_16 * V_19 = F_15 ( V_18 ) ;
...
V_19 -> V_12 = V_12 ;
if ( V_12 -> V_18 . V_130 )
V_19 -> type = (enum V_131 ) F_102 ( & V_12 -> V_18 ) ;
else
V_19 -> type = V_125 -> V_132 ;
F_103 ( & V_19 -> V_20 ) ;
switch ( V_19 -> type ) {
case V_25 :
case V_26 :
...
V_19 -> V_80 = F_104 () ;
F_93 ( V_12 ) ;
V_19 -> V_135 [ V_127 ++ ] = & V_136 ;
if ( V_19 -> type != V_48 ) {
V_19 -> V_135 [ V_127 ++ ] = & V_137 ;
V_19 -> V_135 [ V_127 ++ ] = & V_138 ;
}
...
if ( ! V_19 -> V_38 )
V_19 -> V_135 [ V_127 ++ ] = & V_139 ;
if ( V_19 -> type == V_44 )
V_19 -> V_135 [ V_127 ++ ] = & V_140 ;
V_126 = F_105 ( V_18 , V_12 -> V_141 ,
V_19 , V_19 -> V_135 ) ;
return F_106 ( V_126 ) ;
}
