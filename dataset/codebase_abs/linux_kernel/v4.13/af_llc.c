...
V_10 = - V_39 ;
V_9 = F_19 ( V_29 , V_40 , V_41 , & V_42 , V_31 ) ;
if ( V_9 ) {
V_10 = 0 ;
F_13 ( V_8 , V_9 ) ;
}
...
F_58 ( F_59 ( V_9 ) , & V_104 ) ;
while ( 1 ) {
if ( F_60 ( V_9 , & V_25 , V_9 -> V_80 == V_89 , & V_104 ) )
break;
V_10 = - V_106 ;
if ( F_55 ( V_92 ) )
break;
...
static bool F_53 ( struct V_8 * V_9 , long V_25 )
{
F_57 ( V_104 , V_105 ) ;
F_58 ( F_59 ( V_9 ) , & V_104 ) ;
while ( 1 ) {
if ( F_60 ( V_9 , & V_25 , V_9 -> V_80 != V_86 , & V_104 ) )
break;
if ( F_55 ( V_92 ) || ! V_25 )
break;
}
...
static int F_72 ( struct V_26 * V_8 , struct V_109 * V_110 , T_4 V_126 ,
int V_83 )
{
F_73 ( struct V_5 * , V_68 , V_110 -> V_127 ) ;
const int V_128 = V_83 & V_129 ;
...
V_136 = F_75 ( V_9 , V_83 & V_139 , V_126 ) ;
V_131 = 0 ;
do {
T_5 V_140 ;
if ( F_55 ( V_92 ) ) {
...
if ( V_131 >= V_136 && ! V_9 -> V_142 . V_143 )
break;
if ( V_131 ) {
if ( V_9 -> V_144 ||
V_9 -> V_80 == V_89 ||
...
F_63 ( V_9 , & V_90 , NULL ) ;
if ( ( V_83 & V_138 ) && V_132 != V_21 -> V_137 ) {
F_77 ( L_7 ,
V_92 -> V_146 ,
F_78 ( V_92 ) ) ;
V_132 = V_21 -> V_137 ;
...
V_141:
V_134 = V_18 -> V_126 ;
V_135 = V_18 -> V_126 - V_140 ;
if ( V_126 < V_135 )
V_135 = V_126 ;
if ( ! ( V_83 & V_147 ) ) {
int V_10 = F_79 ( V_18 , V_140 , V_110 , V_135 ) ;
if ( V_10 ) {
if ( ! V_131 )
V_131 = - V_148 ;
break;
...
goto V_149;
if ( ! ( V_83 & V_138 ) ) {
F_80 ( & V_9 -> V_124 . V_150 , V_130 ) ;
F_81 ( V_9 , V_18 ) ;
F_82 ( & V_9 -> V_124 . V_150 , V_130 ) ;
* V_133 = 0 ;
}
if ( V_135 + V_140 < V_134 )
continue;
} while ( V_126 > 0 );
V_43:
F_28 ( V_9 ) ;
...
memcpy ( V_68 , F_83 ( V_18 ) , sizeof( * V_68 ) ) ;
V_110 -> V_151 = sizeof( * V_68 ) ;
}
if ( F_7 ( V_9 ) -> V_111 )
F_64 ( V_110 , V_18 ) ;
if ( ! ( V_83 & V_138 ) ) {
...
static int F_84 ( struct V_26 * V_8 , struct V_109 * V_110 , T_4 V_126 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_20 * V_21 = F_7 ( V_9 ) ;
F_73 ( struct V_5 * , V_6 , V_110 -> V_127 ) ;
int V_83 = V_110 -> V_152 ;
int V_19 = V_83 & V_129 ;
struct V_17 * V_18 ;
T_4 V_153 = 0 ;
int V_10 = - V_58 , V_131 = 0 , V_154 ;
F_23 ( L_8 , V_44 ,
V_21 -> V_45 . V_46 , V_21 -> V_47 . V_46 ) ;
F_22 ( V_9 ) ;
if ( V_6 ) {
if ( V_110 -> V_151 < sizeof( * V_6 ) )
goto V_155;
} else {
if ( F_4 ( & V_21 -> V_6 ) )
goto V_155;
...
V_154 = V_21 -> V_50 -> V_156 + F_5 ( V_9 , V_6 ) ;
V_153 = V_154 + V_126 ;
if ( V_153 > V_21 -> V_50 -> V_157 )
V_153 = V_21 -> V_50 -> V_157 ;
V_131 = V_153 - V_154 ;
F_28 ( V_9 ) ;
V_18 = F_85 ( V_9 , V_153 , V_19 , & V_10 ) ;
F_22 ( V_9 ) ;
if ( ! V_18 )
goto V_155;
V_18 -> V_50 = V_21 -> V_50 ;
...
F_86 ( V_18 , V_154 ) ;
V_10 = F_87 ( F_88 ( V_18 , V_131 ) , V_110 , V_131 ) ;
if ( V_10 )
goto V_43;
if ( V_9 -> V_14 == V_38 || V_6 -> V_158 ) {
...
if ( V_6 -> V_13 ) {
F_91 ( V_21 -> V_1 , V_18 , V_6 -> V_73 ,
V_6 -> V_70 ) ;
goto V_43;
}
V_10 = - V_159 ;
if ( ! ( V_9 -> V_14 == V_15 && ! V_6 -> V_158 ) )
goto V_43;
...
static int F_92 ( struct V_26 * V_8 , struct V_67 * V_68 ,
int * V_160 , int V_161 )
{
struct V_5 V_162 ;
struct V_8 * V_9 = V_8 -> V_9 ;
...
goto V_43;
if( V_21 -> V_50 )
V_162 . V_61 = V_21 -> V_50 -> type ;
V_162 . V_70 = V_21 -> V_47 . V_46 ;
memcpy ( & V_162 . V_73 , & V_21 -> V_47 . V_64 , V_66 ) ;
} else {
V_10 = - V_58 ;
if ( ! V_21 -> V_1 )
goto V_43;
V_162 . V_70 = V_21 -> V_1 -> V_45 . V_46 ;
if ( V_21 -> V_50 ) {
V_162 . V_61 = V_21 -> V_50 -> type ;
memcpy ( & V_162 . V_73 , V_21 -> V_50 -> V_65 ,
V_66 ) ;
}
}
V_10 = 0 ;
V_162 . V_71 = V_72 ;
memcpy ( V_68 , & V_162 , sizeof( V_162 ) ) ;
V_43:
F_28 ( V_9 ) ;
return V_10 ;
}
static int F_93 ( struct V_26 * V_8 , unsigned int V_164 ,
unsigned long V_165 )
{
return - V_166 ;
}
static int F_94 ( struct V_26 * V_8 , int V_167 , int V_168 ,
char T_6 * V_169 , unsigned int V_170 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_20 * V_21 = F_7 ( V_9 ) ;
unsigned int V_171 ;
int V_10 = - V_58 ;
F_22 ( V_9 ) ;
if ( F_8 ( V_167 != V_119 || V_170 != sizeof( int ) ) )
goto V_43;
V_10 = F_95 ( V_171 , ( int T_6 * ) V_169 ) ;
if ( V_10 )
goto V_43;
V_10 = - V_58 ;
switch ( V_168 ) {
...
if ( V_171 > V_179 )
goto V_43;
V_21 -> V_180 . V_181 = V_171 * V_182 ;
break;
case V_183 :
if ( V_171 > V_184 )
goto V_43;
V_21 -> V_185 . V_181 = V_171 * V_182 ;
break;
case V_186 :
if ( V_171 > V_187 )
goto V_43;
V_21 -> V_188 . V_181 = V_171 * V_182 ;
break;
case V_189 :
if ( V_171 > V_190 )
goto V_43;
V_21 -> V_191 . V_181 = V_171 * V_182 ;
break;
case V_192 :
if ( V_171 > V_193 )
goto V_43;
...
static int F_96 ( struct V_26 * V_8 , int V_167 , int V_168 ,
char T_6 * V_169 , int T_6 * V_170 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_20 * V_21 = F_7 ( V_9 ) ;
int V_197 = 0 , V_126 = 0 , V_10 = - V_58 ;
F_22 ( V_9 ) ;
if ( F_8 ( V_167 != V_119 ) )
goto V_43;
V_10 = F_95 ( V_126 , V_170 ) ;
if ( V_10 )
goto V_43;
V_10 = - V_58 ;
if ( V_126 != sizeof( int ) )
...
switch ( V_168 ) {
case V_172 :
V_197 = V_21 -> V_174 ; break;
case V_175 :
V_197 = V_21 -> V_177 ; break;
case V_178 :
V_197 = V_21 -> V_180 . V_181 / V_182 ; break;
case V_183 :
V_197 = V_21 -> V_185 . V_181 / V_182 ; break;
case V_186 :
V_197 = V_21 -> V_188 . V_181 / V_182 ; break;
case V_189 :
V_197 = V_21 -> V_191 . V_181 / V_182 ; break;
case V_192 :
V_197 = V_21 -> V_194 ; break;
case V_195 :
V_197 = V_21 -> V_196 ; break;
case V_120 :
V_197 = ( V_21 -> V_111 & V_112 ) != 0 ;
break;
default:
V_10 = - V_159 ;
goto V_43;
...
V_10 = 0 ;
if ( F_97 ( V_126 , V_170 ) || F_98 ( V_169 , & V_197 , V_126 ) )
V_10 = - V_148 ;
V_43:
F_28 ( V_9 ) ;
return V_10 ;
