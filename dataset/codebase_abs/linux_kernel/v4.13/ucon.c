...
struct V_29 V_30 ;
bool V_31 = false ;
while ( ( V_1 = F_8 ( V_21 , V_22 , L_12 ) ) != - 1 ) {
switch ( V_1 ) {
case 's' :
V_31 = true ;
break;
...
V_25 . V_39 = 0 ;
F_6 ( L_16 , V_19 , V_20 ) ;
if ( F_10 ( V_1 , (struct V_40 * ) & V_25 , sizeof( struct V_24 ) ) == - 1 ) {
perror ( L_17 ) ;
F_11 ( V_1 ) ;
return - 1 ;
}
...
F_6 ( L_18 , V_41 , V_26 -> V_43 . V_44 , V_26 -> V_43 . V_45 ) ;
}
return 0 ;
}
V_30 . V_47 = V_1 ;
...
break;
memset ( V_8 , 0 , sizeof( V_8 ) ) ;
V_10 = F_13 ( V_1 , V_8 , sizeof( V_8 ) , 0 ) ;
if ( V_10 == - 1 ) {
perror ( L_19 ) ;
F_11 ( V_1 ) ;
return - 1 ;
