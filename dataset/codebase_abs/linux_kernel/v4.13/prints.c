...
void F_57 ( struct V_45 * V_46 , int V_59 , const char * V_37 , ... )
{
F_44 ( V_37 ) ;
if ( F_55 ( V_46 ) ) {
F_58 ( V_55 L_39 , V_46 -> V_50 ,
V_43 ) ;
}
if ( F_59 ( F_60 ( V_46 ) ) )
return;
...
static int F_61 ( struct V_27 * V_28 , int V_60 , int V_61 )
{
struct V_5 * V_2 ;
struct V_35 * V_36 ;
int V_62 ;
...
V_36 = F_64 ( V_28 , V_63 ) ;
F_47 ( L_42 , V_63 , V_36 ) ;
for ( V_62 = V_63 , V_2 = F_65 ( V_28 , V_63 ) , V_36 ++ ; V_62 < V_64 ;
V_62 ++ , V_2 ++ , V_36 ++ ) {
...
static int F_66 ( struct V_27 * V_28 , int V_65 , int V_60 ,
int V_61 )
{
struct V_66 * V_67 ;
struct V_16 * V_17 ;
...
F_45 ( L_62 , F_81 ( V_75 ) ) ;
V_77 = V_28 -> V_31 ;
V_78 = F_79 ( V_75 ) - V_77 - 1 - F_82 ( V_75 ) -
( ! F_77 ( V_75 ) ? F_83 ( V_75 ) +
1 : F_84 ( V_75 ) ) - F_81 ( V_75 ) ;
F_45
( L_63
L_64 , V_77 , F_82 ( V_75 ) ,
( ! F_77 ( V_75 ) ? ( F_83 ( V_75 ) + 1 ) :
F_84 ( V_75 ) ) , V_78 ) ;
F_45 ( L_65 , F_85 ( V_75 ) ) ;
F_45 ( L_66 , F_86 ( V_75 ) ) ;
F_45 ( L_67 , F_87 ( V_75 ) ) ;
...
{
struct V_80 * V_81 ;
if ( memcmp ( F_92 ( V_28 ) , V_82 , 8 ) )
return 1 ;
V_81 = (struct V_80 * ) ( V_28 -> V_76 ) ;
F_45 ( L_72 ,
( unsigned long long ) V_28 -> V_31 , F_93 ( V_81 ) ,
F_94 ( V_81 ) , F_95 ( V_81 ) ) ;
return 0 ;
}
void F_96 ( struct V_27 * V_28 , ... )
{
T_1 args ;
int V_83 , V_60 , V_61 ;
if ( ! V_28 ) {
...
if ( F_66 ( V_28 , V_83 , V_60 , V_61 ) )
if ( F_61 ( V_28 , V_60 , V_61 ) )
if ( F_74 ( V_28 ) )
if ( F_91 ( V_28 ) )
F_45
( L_74 ,
...
L_78 ,
F_98 ( V_85 -> V_90 ) -> V_91 ,
V_85 -> V_92 , F_99 ( V_85 -> V_93 ) ,
V_85 -> V_93 -> V_94 ) ;
for ( V_86 = 0 ; V_86 < F_100 ( V_85 -> V_95 ) ; V_86 ++ ) {
if ( F_101 ( V_85 -> V_93 , V_86 ) <=
V_85 -> V_93 -> V_96
&& F_101 ( V_85 -> V_93 ,
V_86 ) > V_97 ) {
V_87 = F_102 ( V_85 -> V_93 , V_86 ) ;
V_88 = F_103 ( V_85 -> V_93 , V_86 ) ;
} else {
V_87 = NULL ;
V_88 = NULL ;
}
...
F_106 ( NULL , L_88 , L_89 ,
V_28 ) ;
if ( F_107 ( V_67 ) > V_28 -> V_30 - V_117 - V_118 * V_68 )
F_106 ( NULL , L_90 , L_91 ,
V_28 ) ;
}
...
F_106 ( NULL , L_92 , L_93 , V_28 ) ;
if ( F_29 ( V_28 ) > ( V_28 -> V_30 - V_117 ) / V_118 )
F_106 ( NULL , L_94 , L_89 , V_28 ) ;
if ( F_30 ( V_28 ) !=
V_28 -> V_30 - V_117 - V_121 * F_29 ( V_28 ) -
V_122 * ( F_29 ( V_28 ) + 1 ) )
F_106 ( NULL , L_95 , L_91 , V_28 ) ;
}
...
F_109 ( V_17 , F_72 ( V_28 , V_17 ) ) ;
}
void F_63 ( struct V_27 * V_28 )
{
if ( ! V_28 )
return;
F_108 ( V_28 ) ;
}
void F_110 ( struct V_45 * V_52 )
{
}
