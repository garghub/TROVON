...
static void F_66 ( struct V_89 * V_117 )
{
struct V_100 * V_101 ;
while ( ( V_101 = F_67 ( V_117 ) ) != NULL ) {
switch ( F_68 ( V_101 ) ) {
case V_118 :
...
return V_36 ;
F_8 ( V_122 ) ;
V_123 = F_74 ( V_122 -> V_126 , 16 , V_25 ) ;
if ( ! V_123 )
goto V_127;
V_124 = F_74 ( V_122 -> V_128 , 16 , V_25 ) ;
if ( ! V_124 )
goto V_129;
V_125 = F_74 ( V_122 -> V_130 , 16 , V_25 ) ;
if ( ! V_125 )
goto V_131;
F_28 ( L_10 ,
V_123 , V_124 , V_125 ) ;
...
{
F_79 ( V_20 . V_149 , V_108 ) ;
F_80 ( V_20 . V_149 , 1 ) ;
F_81 ( V_20 . V_149 , 0x40000 ) ;
...
if ( V_36 )
goto V_159;
V_20 . V_149 = F_87 ( F_66 , & V_103 ) ;
if ( ! V_20 . V_149 ) {
V_36 = - V_26 ;
goto V_160;
}
F_88 ( V_20 . V_149 , V_161 ) ;
V_36 = F_78 () ;
if ( V_36 )
goto V_162;
...
static int F_93 ( struct V_151 * V_152 )
{
F_94 ( & V_93 ) ;
F_90 ( V_20 . V_149 ) ;
F_53 ( V_90 , & V_20 ) ;
