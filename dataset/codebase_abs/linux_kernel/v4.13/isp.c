...
static int F_190 ( struct V_304 * V_305 )
{
struct V_1 * V_2 = F_191 ( V_305 ) ;
F_192 ( & V_2 -> V_306 ) ;
F_143 ( V_2 ) ;
F_166 ( V_2 ) ;
F_30 ( V_2 ) ;
...
static int F_194 ( struct V_101 * V_24 , struct V_307 * V_308 ,
struct V_309 * V_310 )
{
...
unsigned int V_38 ;
int V_153 ;
V_153 = F_195 ( V_308 , & V_315 ) ;
if ( V_153 )
return V_153 ;
F_20 ( V_24 , L_70 ,
F_196 ( V_308 ) -> V_316 , V_315 . V_317 . V_318 ) ;
...
V_312 -> V_313 . V_333 . V_334 . V_26 . V_335 = V_315 . V_313 . V_336 . V_337 ;
V_312 -> V_313 . V_333 . V_334 . V_26 . V_338 =
V_315 . V_313 . V_336 . V_339 [ 0 ] ;
F_20 ( V_24 , L_71 ,
V_312 -> V_313 . V_333 . V_334 . V_26 . V_338 ,
V_312 -> V_313 . V_333 . V_334 . V_26 . V_335 ) ;
for ( V_38 = 0 ; V_38 < V_340 ; V_38 ++ ) {
V_312 -> V_313 . V_333 . V_334 . V_29 [ V_38 ] . V_335 =
V_315 . V_313 . V_336 . V_341 [ V_38 ] ;
V_312 -> V_313 . V_333 . V_334 . V_29 [ V_38 ] . V_338 =
V_315 . V_313 . V_336 . V_339 [ V_38 + 1 ] ;
F_20 ( V_24 , L_72 , V_38 ,
V_312 -> V_313 . V_333 . V_334 . V_29 [ V_38 ] . V_338 ,
V_312 -> V_313 . V_333 . V_334 . V_29 [ V_38 ] . V_335 ) ;
}
V_312 -> V_313 . V_333 . V_342 = 1 ;
break;
default:
F_122 ( V_24 , L_73 ,
F_196 ( V_308 ) -> V_316 , V_315 . V_317 . V_318 ) ;
...
static int F_197 ( struct V_101 * V_24 ,
struct V_343 * V_306 )
{
struct V_307 * V_308 = NULL ;
V_306 -> V_344 = F_198 (
V_24 , V_345 , sizeof( * V_306 -> V_344 ) , V_346 ) ;
if ( ! V_306 -> V_344 )
return - V_347 ;
while ( V_306 -> V_348 < V_345 &&
( V_308 = F_199 (
F_200 ( V_24 -> V_35 ) , V_308 ) ) ) {
struct V_309 * V_310 ;
V_310 = F_201 ( V_24 , sizeof( * V_310 ) , V_346 ) ;
if ( ! V_310 )
goto error;
V_306 -> V_344 [ V_306 -> V_348 ] = & V_310 -> V_349 ;
if ( F_194 ( V_24 , V_308 , V_310 ) )
goto error;
V_310 -> V_349 . V_350 . V_308 . V_308 =
F_202 ( V_308 ) ;
if ( ! V_310 -> V_349 . V_350 . V_308 . V_308 ) {
F_122 ( V_24 , L_74 ) ;
goto error;
}
V_310 -> V_349 . V_351 = V_352 ;
V_306 -> V_348 ++ ;
}
return V_306 -> V_348 ;
error:
...
static int F_204 ( struct V_343 * V_353 ,
struct V_152 * V_110 ,
struct V_354 * V_349 )
{
struct V_309 * V_310 =
F_205 ( V_349 , struct V_309 , V_349 ) ;
V_310 -> V_355 = V_110 ;
V_310 -> V_355 -> V_356 = & V_310 -> V_313 ;
return 0 ;
}
static int F_206 ( struct V_343 * V_353 )
{
struct V_1 * V_2 = F_205 ( V_353 , struct V_1 ,
V_306 ) ;
struct V_357 * V_258 = & V_2 -> V_258 ;
struct V_152 * V_355 ;
struct V_311 * V_313 ;
int V_153 ;
V_153 = F_207 ( & V_2 -> V_155 , & V_2 -> V_259 ) ;
if ( V_153 )
return V_153 ;
F_208 (sd, &v4l2_dev->subdevs, list) {
if ( V_355 -> V_356 ) {
V_313 = (struct V_311 * ) V_355 -> V_356 ;
V_153 = F_153 ( V_2 , & V_355 -> V_111 , V_313 -> V_261 ) ;
if ( V_153 < 0 )
return V_153 ;
}
}
V_153 = F_209 ( & V_2 -> V_258 ) ;
if ( V_153 < 0 )
return V_153 ;
return F_210 ( & V_2 -> V_259 ) ;
}
static int F_211 ( struct V_304 * V_305 )
{
struct V_1 * V_2 ;
struct V_358 * V_359 ;
int V_153 ;
int V_38 , V_360 ;
V_2 = F_201 ( & V_305 -> V_24 , sizeof( * V_2 ) , V_346 ) ;
if ( ! V_2 ) {
F_119 ( & V_305 -> V_24 , L_75 ) ;
return - V_347 ;
}
V_153 = F_212 ( F_200 ( V_305 -> V_24 . V_35 ) ,
L_76 , & V_2 -> V_361 ) ;
if ( V_153 )
return V_153 ;
V_2 -> V_362 = F_213 ( V_305 -> V_24 . V_35 ,
L_77 ) ;
if ( F_27 ( V_2 -> V_362 ) )
return F_28 ( V_2 -> V_362 ) ;
V_153 = F_214 ( V_305 -> V_24 . V_35 ,
L_77 , 1 , & V_2 -> V_363 ) ;
if ( V_153 )
return V_153 ;
V_153 = F_197 ( & V_305 -> V_24 , & V_2 -> V_306 ) ;
if ( V_153 < 0 )
return V_153 ;
V_2 -> V_69 = V_69 ;
F_215 ( & V_2 -> V_235 ) ;
...
V_2 -> V_24 = & V_305 -> V_24 ;
V_2 -> V_236 = 0 ;
V_153 = F_216 ( V_2 -> V_24 , F_217 ( 32 ) ) ;
if ( V_153 )
goto error;
F_218 ( V_305 , V_2 ) ;
V_2 -> V_365 . V_366 = F_219 ( & V_305 -> V_24 , L_78 ) ;
V_2 -> V_367 . V_366 = F_219 ( & V_305 -> V_24 , L_79 ) ;
for ( V_38 = 0 ; V_38 < 2 ; V_38 ++ ) {
unsigned int V_368 = V_38 ? V_369 : 0 ;
V_359 = F_220 ( V_305 , V_370 , V_38 ) ;
V_2 -> V_371 [ V_368 ] =
F_221 ( V_2 -> V_24 , V_359 ) ;
if ( F_27 ( V_2 -> V_371 [ V_368 ] ) )
return F_28 ( V_2 -> V_371 [ V_368 ] ) ;
}
V_153 = F_125 ( V_2 ) ;
if ( V_153 < 0 )
goto error;
V_153 = F_222 ( V_2 -> clock [ V_226 ] ) ;
if ( V_153 < 0 )
goto error;
V_2 -> V_65 = F_3 ( V_2 , V_3 , V_4 ) ;
F_73 ( V_2 -> V_24 , L_80 ,
( V_2 -> V_65 & 0xf0 ) >> 4 , V_2 -> V_65 & 0x0f ) ;
F_223 ( V_2 -> clock [ V_226 ] ) ;
...
if ( V_153 < 0 )
goto V_373;
for ( V_360 = 0 ; V_360 < F_22 ( V_374 ) ; V_360 ++ )
if ( V_2 -> V_65 == V_374 [ V_360 ] . V_375 )
break;
if ( V_360 == F_22 ( V_374 ) ) {
F_119 ( V_2 -> V_24 , L_81 ,
...
for ( V_38 = 1 ; V_38 < V_369 ; V_38 ++ )
V_2 -> V_371 [ V_38 ] =
V_2 -> V_371 [ 0 ] + V_374 [ V_360 ] . V_376 [ V_38 ] ;
for ( V_38 = V_377 ; V_38 < V_378 ; V_38 ++ )
V_2 -> V_371 [ V_38 ] =
V_2 -> V_371 [ V_369 ]
+ V_374 [ V_360 ] . V_376 [ V_38 ] ;
V_2 -> V_379 =
V_359 -> V_380 + V_374 [ V_360 ] . V_376 [ V_381 ] ;
V_153 = F_187 ( V_2 ) ;
if ( V_153 < 0 ) {
F_119 ( & V_305 -> V_24 , L_82 ) ;
goto V_373;
}
V_153 = F_224 ( V_305 , 0 ) ;
if ( V_153 <= 0 ) {
...
V_2 -> V_383 = V_153 ;
if ( F_225 ( V_2 -> V_24 , V_2 -> V_383 , F_46 , V_384 ,
L_84 , V_2 ) ) {
F_119 ( V_2 -> V_24 , L_85 ) ;
V_153 = - V_39 ;
goto V_382;
...
if ( V_153 < 0 )
goto V_386;
V_2 -> V_306 . V_387 = F_204 ;
V_2 -> V_306 . V_388 = F_206 ;
V_153 = F_226 ( & V_2 -> V_258 , & V_2 -> V_306 ) ;
if ( V_153 )
goto V_386;
F_35 ( V_2 , 1 ) ;
F_10 ( V_2 ) ;
