...
( V_2 -> V_47 != NULL ) - 1 ) ;
V_63 += V_61 * V_62 * V_64 ;
V_2 -> V_4 = & F_11 ( V_56 , V_63 , true ) -> V_76 ;
if ( F_12 ( V_2 -> V_4 ) )
return F_13 ( V_2 -> V_4 ) ;
F_14 ( & F_15 ( & V_2 -> V_4 -> V_76 ) -> V_77 ,
& V_14 -> V_78 ) ;
if ( args -> V_32 & V_67 ) {
F_1 ( V_2 , V_79 ) ;
F_3 ( V_2 , args -> V_80 [ 0 ] ) ;
...
for ( V_20 = V_58 ; V_20 <= V_60 ; V_20 ++ ) {
for ( V_19 = V_57 ; V_19 <= V_59 ; V_19 ++ ) {
bool V_26 = ( V_19 == V_57 && V_20 == V_58 ) ;
bool V_27 = ( V_19 == V_59 && V_20 == V_60 ) ;
F_9 ( V_14 , V_2 , V_19 , V_20 , V_26 , V_27 ) ;
}
}
F_16 ( V_2 -> V_6 != V_63 ) ;
V_14 -> V_85 = V_2 -> V_4 -> V_21 ;
V_14 -> V_86 = V_2 -> V_4 -> V_21 + V_2 -> V_6 ;
return 0 ;
}
...
{
struct V_28 * args = V_14 -> args ;
T_3 V_88 = F_7 ( V_14 -> args -> V_24 , 32 ) ;
if ( V_18 -> V_22 > V_87 -> V_76 . V_63 ) {
F_18 ( L_1 ,
V_18 -> V_22 , V_87 -> V_76 . V_63 ) ;
return - V_89 ;
}
if ( ( V_87 -> V_76 . V_63 - V_18 -> V_22 ) / V_23 <
V_88 * args -> V_60 + args -> V_59 ) {
F_18 ( L_2
L_3 ,
args -> V_59 , args -> V_60 ,
V_87 -> V_76 . V_63 ,
...
if ( V_18 -> V_90 == ~ 0 )
return 0 ;
* V_87 = F_20 ( V_14 , V_18 -> V_90 ) ;
if ( ! * V_87 )
return - V_89 ;
V_14 -> V_91 [ V_14 -> V_92 ++ ] = * V_87 ;
if ( V_18 -> V_22 & 0xf ) {
F_18 ( L_5 ) ;
return - V_89 ;
}
return F_17 ( V_14 , * V_87 , V_18 ) ;
}
...
bool V_93 )
{
T_5 V_94 = F_22 ( V_18 -> V_37 ,
V_95 ) ;
T_5 V_96 = F_22 ( V_18 -> V_37 ,
V_9 ) ;
...
if ( ! F_23 ( V_14 , * V_87 , V_18 -> V_22 , V_94 ,
V_14 -> args -> V_24 , V_14 -> args -> V_84 , V_99 ) ) {
return - V_89 ;
}
return 0 ;
}
...
if ( V_29 &&
( args -> V_59 > V_14 -> V_43 ||
args -> V_60 > V_14 -> V_119 ) ) {
F_18 ( L_19
L_20 ,
args -> V_59 , args -> V_60 ,
V_14 -> V_43 , V_14 -> V_119 ) ;
return - V_89 ;
}
V_100 = F_24 ( V_14 , & V_2 ,
& V_2 . V_48 ,
...
if ( V_100 )
return V_100 ;
V_100 = F_21 ( V_14 , & V_2 . V_31 , & args -> V_31 ,
false ) ;
if ( V_100 )
return V_100 ;
V_100 = F_21 ( V_14 , & V_2 . V_38 , & args -> V_38 ,
false ) ;
if ( V_100 )
return V_100 ;
V_100 = F_21 ( V_14 , & V_2 . V_47 , & args -> V_47 ,
true ) ;
if ( V_100 )
return V_100 ;
V_100 = F_19 ( V_14 , & V_2 . V_44 ,
& args -> V_44 ) ;
if ( V_100 )
return V_100 ;
V_100 = F_19 ( V_14 , & V_2 . V_46 ,
& args -> V_46 ) ;
if ( V_100 )
return V_100 ;
