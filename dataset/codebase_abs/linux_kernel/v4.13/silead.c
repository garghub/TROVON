...
static void F_45 ( void * V_79 )
{
struct V_1 * V_2 = V_79 ;
F_46 ( F_47 ( V_2 -> V_80 ) , V_2 -> V_80 ) ;
}
static int F_48 ( struct V_21 * V_5 ,
const struct V_74 * V_18 )
{
struct V_1 * V_2 ;
struct V_3 * V_4 = & V_5 -> V_4 ;
...
if ( V_5 -> V_71 <= 0 )
return - V_70 ;
V_2 -> V_80 [ 0 ] . V_87 = L_24 ;
V_2 -> V_80 [ 1 ] . V_87 = L_25 ;
error = F_52 ( V_4 , F_47 ( V_2 -> V_80 ) ,
V_2 -> V_80 ) ;
if ( error )
return error ;
error = F_53 ( F_47 ( V_2 -> V_80 ) ,
V_2 -> V_80 ) ;
if ( error )
return error ;
error = F_54 ( V_4 , F_45 , V_2 ) ;
if ( error )
return error ;
V_2 -> V_24 = F_55 ( V_4 , L_26 , V_88 ) ;
if ( F_56 ( V_2 -> V_24 ) ) {
if ( F_57 ( V_2 -> V_24 ) != - V_89 )
F_3 ( V_4 , L_27 ) ;
...
{
struct V_21 * V_5 = F_60 ( V_4 ) ;
F_61 ( V_5 -> V_71 ) ;
F_8 ( V_5 , V_67 ) ;
return 0 ;
}
static int T_5 F_62 ( struct V_3 * V_4 )
{
struct V_21 * V_5 = F_60 ( V_4 ) ;
int error , V_63 ;
F_8 ( V_5 , V_68 ) ;
