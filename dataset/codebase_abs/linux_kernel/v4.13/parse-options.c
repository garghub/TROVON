...
if ( V_84 && ! V_72 [ 0 ] ) {
char * V_85 = NULL ;
F_19 ( & V_85 , L_29 , V_86 . V_87 , V_19 [ 0 ] ) ;
...
if ( V_90 -> V_4 & V_25 )
return;
V_92 = fprintf ( V_6 , L_37 ) ;
if ( V_90 -> V_7 )
V_92 += fprintf ( V_6 , L_38 , V_90 -> V_7 ) ;
else
V_92 += fprintf ( V_6 , L_37 ) ;
if ( V_90 -> V_9 && V_90 -> V_7 )
V_92 += fprintf ( V_6 , L_39 ) ;
if ( V_90 -> V_9 )
V_92 += fprintf ( V_6 , L_40 , V_90 -> V_9 ) ;
switch ( V_90 -> type ) {
case V_37 :
break;
case V_42 :
...
V_92 += fprintf ( V_6 , L_46 , V_90 -> V_96 ) ;
} else {
if ( V_90 -> V_4 & V_48 )
if ( V_90 -> V_9 )
...
fprintf ( V_6 , L_50 , V_93 + V_98 , L_22 , V_90 -> V_94 ) ;
if ( V_90 -> V_4 & V_44 )
fprintf ( V_6 , L_51 ,
V_97 + V_98 , L_22 ,
V_90 -> V_47 ) ;
...
V_105 = V_103 - V_104 ;
if ( V_105 == 0 ) {
const char * V_106 = V_101 -> V_9 ? : L_22 ,
* V_107 = V_102 -> V_9 ? : L_22 ;
...
F_28 () ;
if ( V_89 ) {
fprintf ( V_6 , L_52 , V_89 ) ;
F_29 ( & V_89 ) ;
}
fprintf ( V_6 , L_53 , * V_72 ++ ) ;
while ( * V_72 && * * V_72 )
fprintf ( V_6 , L_54 , * V_72 ++ ) ;
while ( * V_72 ) {
fprintf ( V_6 , L_55 ,
* * V_72 ? L_37 : L_22 ,
* V_72 ) ;
