...
F_30 ( V_70 , V_30 ,
L_5 ,
V_71 , V_51 -> V_69 , V_51 -> V_75 ,
F_31 ( V_7 ) ) ;
break;
}
if ( V_7 & V_77 ) {
V_50 = F_32 ( V_50 , F_33 ( V_78 ) ,
V_7 & V_79 ) ;
if ( ! V_50 )
goto V_65;
}
F_34 ( V_50 ) ;
V_50 -> V_80 = F_35 ( V_50 , V_55 ) ;
F_36 ( V_30 , V_81 ) ;
F_37 ( V_30 , V_82 ,
V_50 -> V_83 + V_66 ) ;
F_38 ( V_50 ) ;
...
struct V_29 * V_30 ;
char V_86 [ 6 ] = { '\0' } ;
V_21 = F_5 ( V_85 , struct V_12 ,
V_87 ) ;
V_30 = V_21 -> V_30 ;
F_41 ( V_30 -> V_55 ,
L_6 ,
F_31 ( V_21 -> V_7 ) ) ;
snprintf ( V_86 , sizeof( V_86 ) , L_7 ,
F_31 ( V_21 -> V_7 ) ) ;
...
unsigned short V_7 , bool V_90 )
{
struct V_12 * V_91 ;
struct V_92 * V_93 ;
int V_94 ;
V_91 = F_22 ( V_30 , V_16 , V_7 ) ;
if ( V_91 )
return V_91 ;
F_30 ( V_70 , V_30 ,
L_8 , V_71 ,
V_16 , F_31 ( V_7 ) ) ;
V_91 = F_44 ( sizeof( * V_91 ) , V_95 ) ;
if ( ! V_91 )
return NULL ;
V_91 -> V_7 = V_7 ;
V_91 -> V_96 = V_97 ;
...
unsigned short V_7 )
{
if ( ! F_6 ( V_107 , V_51 -> V_75 ) )
return false ;
if ( ! F_6 ( V_51 -> V_75 , V_53 -> V_63 -> V_64 ) )
return true ;
F_30 ( V_70 , V_30 ,
L_17 ,
V_71 , F_31 ( V_7 ) , V_51 -> V_69 ) ;
F_59 ( V_30 , V_53 , V_7 ) ;
return true ;
}
...
static void F_86 ( struct V_84 * V_85 )
{
struct V_140 * V_140 ;
struct V_29 * V_30 ;
struct V_141 * V_142 ;
...
int V_43 ;
V_140 = F_87 ( V_85 ) ;
V_142 = F_5 ( V_140 , struct V_141 , V_85 ) ;
...
V_158 %= V_152 ;
V_91 = & V_30 -> V_32 . V_153 [ V_158 ] ;
if ( F_80 ( V_91 -> V_149 ,
V_151 ) )
break;
if ( V_91 -> V_27 != V_27 )
continue;
if ( F_6 ( V_91 -> V_16 , V_160 -> V_16 ) )
continue;
V_120 = true ;
goto V_65;
}
...
struct V_92 * V_93 , int V_162 )
{
struct V_12 * V_21 ;
unsigned short V_7 ;
if ( ! F_61 ( & V_93 -> V_30 -> V_138 ) )
return false ;
...
int F_110 ( struct V_169 * V_170 , void * V_171 )
{
...
static int
F_114 ( struct V_49 * V_176 , T_1 V_177 , T_1 V_170 ,
struct V_52 * V_53 ,
struct V_3 * V_4 )
{
...
void * V_178 ;
int V_120 = - V_179 ;
V_178 = F_115 ( V_176 , V_177 , V_170 , & V_180 ,
V_181 , V_182 ) ;
if ( ! V_178 ) {
V_120 = - V_183 ;
goto V_65;
...
F_14 ( & V_4 -> V_21 -> V_26 ) ;
if ( V_173 )
if ( F_116 ( V_176 , V_184 ) ) {
F_117 ( V_176 , V_178 ) ;
goto V_65;
}
if ( F_118 ( V_176 , V_185 , V_28 , V_4 -> V_6 ) ||
F_119 ( V_176 , V_186 , V_4 -> V_7 ) ||
F_118 ( V_176 , V_187 , V_28 ,
V_4 -> V_21 -> V_16 ) ||
F_119 ( V_176 , V_188 ,
V_108 ) ) {
F_117 ( V_176 , V_178 ) ;
...
static int
F_121 ( struct V_49 * V_176 , T_1 V_177 , T_1 V_170 ,
struct V_52 * V_53 ,
...
int F_122 ( struct V_49 * V_176 , struct V_192 * V_193 )
{
struct V_52 * V_53 = NULL ;
int V_177 = F_123 ( V_193 -> V_50 ) . V_177 ;
struct V_194 * V_194 = F_124 ( V_193 -> V_50 -> V_195 ) ;
struct V_54 * V_55 ;
struct V_31 * V_5 ;
struct V_29 * V_30 ;
...
int V_197 ;
int V_120 = 0 ;
V_197 = F_125 ( V_193 -> V_198 ,
V_199 ) ;
if ( ! V_197 )
return - V_179 ;
V_55 = F_126 ( V_194 , V_197 ) ;
if ( ! V_55 || ! F_127 ( V_55 ) ) {
V_120 = - V_200 ;
goto V_65;
}
...
int F_129 ( struct V_169 * V_170 , void * V_171 )
{
struct V_54 * V_63 = (struct V_54 * ) V_170 -> V_172 ;
struct V_29 * V_30 = F_85 ( V_63 ) ;
struct V_31 * V_5 = V_30 -> V_32 . V_39 ;
...
static int
F_131 ( struct V_49 * V_176 , T_1 V_177 , T_1 V_170 ,
struct V_52 * V_53 ,
struct V_12 * V_21 )
{
T_2 * V_174 = V_53 -> V_63 -> V_64 ;
...
V_108 = V_21 -> V_27 ;
F_14 ( & V_21 -> V_26 ) ;
V_206 = F_130 ( V_97 - V_21 -> V_96 ) ;
if ( V_173 )
if ( F_116 ( V_176 , V_184 ) ) {
F_117 ( V_176 , V_178 ) ;
goto V_65;
}
if ( F_118 ( V_176 , V_187 , V_28 ,
V_21 -> V_16 ) ||
F_119 ( V_176 , V_186 , V_21 -> V_7 ) ||
F_119 ( V_176 , V_188 ,
V_108 ) ||
F_132 ( V_176 , V_208 , V_206 ) ) {
F_117 ( V_176 , V_178 ) ;
goto V_65;
}
F_120 ( V_176 , V_178 ) ;
...
static int
F_133 ( struct V_49 * V_176 , T_1 V_177 , T_1 V_170 ,
struct V_52 * V_53 ,
struct V_34 * V_35 , int * V_189 )
{
struct V_12 * V_21 ;
...
int F_134 ( struct V_49 * V_176 , struct V_192 * V_193 )
{
struct V_52 * V_53 = NULL ;
int V_177 = F_123 ( V_193 -> V_50 ) . V_177 ;
struct V_194 * V_194 = F_124 ( V_193 -> V_50 -> V_195 ) ;
