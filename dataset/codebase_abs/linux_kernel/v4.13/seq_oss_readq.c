...
int
F_11 ( struct V_1 * V_5 , union V_7 * V_23 )
{
unsigned long V_24 ;
F_12 ( & V_5 -> V_12 , V_24 ) ;
...
int
F_14 ( struct V_1 * V_5 , union V_7 * V_19 )
{
if ( V_5 -> V_8 == 0 )
return - V_26 ;
...
unsigned int
F_18 ( struct V_1 * V_5 , struct V_27 * V_27 , T_1 * V_28 )
{
F_19 ( V_27 , & V_5 -> V_11 , V_28 ) ;
return V_5 -> V_8 ;
}
int
F_20 ( struct V_1 * V_5 , unsigned long V_29 , int V_30 )
{
if ( V_29 != V_5 -> V_15 ) {
union V_7 V_19 ;
memset ( & V_19 , 0 , sizeof( V_19 ) ) ;
...
void
F_21 ( struct V_1 * V_5 , struct V_40 * V_41 )
{
F_22 ( V_41 , L_1 ,
( F_23 ( & V_5 -> V_11 ) ? L_2 : L_3 ) ,
V_5 -> V_8 , V_5 -> V_15 ) ;
}
