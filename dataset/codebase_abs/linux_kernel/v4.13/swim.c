...
static T_2 F_27 ( struct V_52 * V_53 ,
int V_65 , int V_66 ,
unsigned char * V_61 )
{
struct V_1 T_1 * V_2 = V_53 -> V_55 -> V_2 ;
...
static int F_40 ( struct V_104 * V_105 , T_3 V_106 )
{
...
static int F_42 ( struct V_104 * V_105 , T_3 V_106 )
{
int V_56 ;
F_43 ( & V_121 ) ;
...
static void F_45 ( struct V_122 * V_79 , T_3 V_106 )
{
...
static int F_46 ( struct V_104 * V_105 , T_3 V_106 ,
...
static struct V_140 * F_52 ( T_4 V_141 , int * V_142 , void * V_143 )
{
...
F_61 ( V_55 -> V_78 [ V_144 ] . V_79 -> V_80 ,
V_151 ) ;
V_55 -> V_78 [ V_144 ] . V_79 -> V_80 -> V_82 = V_55 ;
V_55 -> V_78 [ V_144 ] . V_55 = V_55 ;
}
for ( V_144 = 0 ; V_144 < V_55 -> V_81 ; V_144 ++ ) {
V_55 -> V_78 [ V_144 ] . V_79 -> V_6 = V_152 ;
V_55 -> V_78 [ V_144 ] . V_79 -> V_153 = V_147 ;
V_55 -> V_78 [ V_144 ] . V_79 -> V_154 = V_144 ;
sprintf ( V_55 -> V_78 [ V_144 ] . V_79 -> V_155 , L_5 , V_144 ) ;
V_55 -> V_78 [ V_144 ] . V_79 -> V_156 = & V_157 ;
V_55 -> V_78 [ V_144 ] . V_79 -> V_86 = & V_55 -> V_78 [ V_144 ] ;
F_62 ( V_55 -> V_78 [ V_144 ] . V_79 , 2880 ) ;
F_63 ( V_55 -> V_78 [ V_144 ] . V_79 ) ;
}
F_64 ( F_65 ( V_147 , 0 ) , 256 , V_158 ,
F_52 , NULL , V_55 ) ;
return 0 ;
V_150:
F_66 ( V_147 , L_3 ) ;
...
static int F_67 ( struct V_159 * V_141 )
{
struct V_160 * V_161 ;
struct V_1 T_1 * V_162 ;
struct V_72 * V_55 ;
int V_56 ;
V_161 = F_68 ( V_141 , V_163 , 0 ) ;
if ( ! V_161 ) {
V_56 = - V_164 ;
goto V_116;
}
if ( ! F_69 ( V_161 -> V_165 , F_70 ( V_161 ) , V_166 ) ) {
V_56 = - V_110 ;
goto V_116;
}
V_162 = F_71 ( V_161 -> V_165 , F_70 ( V_161 ) ) ;
if ( ! V_162 ) {
V_56 = - V_149 ;
goto V_167;
}
...
V_55 = F_72 ( sizeof( struct V_72 ) , V_170 ) ;
if ( ! V_55 ) {
V_56 = - V_149 ;
goto V_169;
}
...
F_75 ( V_162 ) ;
V_167:
F_76 ( V_161 -> V_165 , F_70 ( V_161 ) ) ;
V_116:
return V_56 ;
}
static int F_77 ( struct V_159 * V_141 )
{
struct V_72 * V_55 = F_78 ( V_141 ) ;
int V_144 ;
struct V_160 * V_161 ;
F_79 ( F_65 ( V_147 , 0 ) , 256 ) ;
for ( V_144 = 0 ; V_144 < V_55 -> V_81 ; V_144 ++ ) {
F_80 ( V_55 -> V_78 [ V_144 ] . V_79 ) ;
F_81 ( V_55 -> V_78 [ V_144 ] . V_79 -> V_80 ) ;
F_60 ( V_55 -> V_78 [ V_144 ] . V_79 ) ;
}
F_66 ( V_147 , L_3 ) ;
for ( V_144 = 0 ; V_144 < V_55 -> V_81 ; V_144 ++ )
