...
if ( ! V_164 )
return NULL ;
if ( F_53 ( F_54 ( V_164 ) , & V_162 ) < 0 )
goto V_143;
V_32 = F_55 ( & V_78 -> V_80 , sizeof( * V_32 ) , V_170 ) ;
if ( ! V_32 )
goto V_143;
V_166 = F_56 ( V_164 , L_7 , NULL ) ;
if ( V_166 ) {
T_3 * V_115 ;
T_4 V_171 = V_166 -> V_172 / sizeof( * V_115 ) ;
V_115 = F_57 ( & V_78 -> V_80 , V_171 ,
sizeof( * V_115 ) , V_170 ) ;
if ( ! V_115 )
goto V_143;
if ( F_58 ( V_164 , L_7 ,
...
unsigned int V_144 ;
int V_11 ;
V_1 = F_55 ( & V_78 -> V_80 , sizeof( * V_1 ) , V_170 ) ;
if ( ! V_1 )
return - V_180 ;
V_1 -> V_7 = F_61 ( V_78 , & V_181 ) ;
if ( F_62 ( V_1 -> V_7 ) )
return F_63 ( V_1 -> V_7 ) ;
V_1 -> V_26 = F_64 ( & V_78 -> V_80 , NULL ) ;
if ( F_62 ( V_1 -> V_26 ) )
return F_63 ( V_1 -> V_26 ) ;
V_1 -> V_25 = F_65 ( & V_78 -> V_80 , L_8 ,
V_182 ) ;
if ( F_62 ( V_1 -> V_25 ) )
return F_63 ( V_1 -> V_25 ) ;
V_1 -> V_183 = F_65 ( & V_78 -> V_80 , L_9 ,
V_184 ) ;
if ( F_62 ( V_1 -> V_183 ) )
return F_63 ( V_1 -> V_183 ) ;
F_66 ( & V_1 -> V_141 ) ;
V_1 -> V_32 = V_32 ;
...
V_200 ) ;
V_1 -> V_119 = F_70 ( & V_1 -> V_37 ,
& V_187 , V_118 ,
F_47 ( V_201 ) - 1 , 0 , 0 ,
V_201 ) ;
V_1 -> V_124 = F_71 ( & V_1 -> V_37 ,
& V_202 , NULL ) ;
F_71 ( & V_1 -> V_37 ,
V_1 -> V_16 -> V_17 -> V_203 ,
NULL ) ;
for ( V_144 = 0 ; V_144 < F_47 ( V_186 ) ; ++ V_144 )
F_71 ( & V_1 -> V_37 , & V_186 [ V_144 ] ,
NULL ) ;
F_72 ( 2 , & V_1 -> V_119 ) ;
V_1 -> V_79 =
F_68 ( & V_1 -> V_37 , & V_187 ,
...
V_1 -> V_18 = V_197 ;
V_1 -> V_27 = V_208 ;
F_74 ( & V_1 -> V_4 , V_78 , & V_209 ) ;
V_1 -> V_4 . V_210 = & V_211 ;
V_1 -> V_4 . V_176 |= V_212 ;
V_1 -> V_41 . V_176 = V_213 ;
V_11 = F_75 ( & V_1 -> V_4 . V_214 , 1 , & V_1 -> V_41 ) ;
if ( V_11 < 0 )
goto V_207;
