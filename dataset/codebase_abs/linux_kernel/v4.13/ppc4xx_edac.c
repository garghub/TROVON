...
V_14 -> V_157 = V_158 ;
V_14 -> V_159 = V_160 ;
V_14 -> V_161 = V_142 -> V_162 ,
V_14 -> V_21 = V_139 -> V_163 ;
V_14 -> V_164 = F_21 ;
V_14 -> V_165 = NULL ;
V_8 = F_26 ( V_14 , V_79 ) ;
if ( V_8 )
...
V_166 = F_34 ( V_139 , V_168 ) ;
V_167 = F_34 ( V_139 , V_169 ) ;
if ( ! V_166 || ! V_167 ) {
F_15 ( V_126 , V_14 ,
L_26 ) ;
V_8 = - V_170 ;
...
V_25 -> V_173 . V_174 = V_166 ;
V_25 -> V_173 . V_175 = V_167 ;
return 0 ;
V_172:
F_36 ( V_167 , V_14 ) ;
V_171:
...
V_180 [ 1 ] . V_16 = V_188 ;
V_180 [ 1 ] . V_186 = false ;
V_14 = F_45 ( V_181 , F_46 ( V_180 ) , V_180 ,
sizeof( struct V_24 ) ) ;
if ( V_14 == NULL ) {
F_40 ( V_126 , L_41
L_42 ,
...
struct V_24 * V_25 = V_14 -> V_26 ;
if ( V_190 == V_191 ) {
F_36 ( V_25 -> V_173 . V_175 , V_14 ) ;
F_36 ( V_25 -> V_173 . V_174 , V_14 ) ;
}
F_52 ( V_25 -> V_1 , V_178 ) ;
F_48 ( V_14 -> V_143 ) ;
F_49 ( V_14 ) ;
