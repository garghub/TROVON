...
V_136 = 1 ;
V_74 = F_55 ( V_68 ) ;
} else if ( F_73 ( F_119 ( V_68 ) ) ) {
if ( F_122 ( V_68 , V_120 ) )
goto V_141;
}
F_91 ( F_119 ( V_68 ) , V_68 ) ;
if ( F_114 ( V_68 ) ) {
if ( ! F_125 ( V_68 , V_121 | V_145 ) ) {
V_135 ++ ;
goto V_139;
}
}
...
V_149:
V_131 ++ ;
F_131 ( & V_68 -> V_23 , & V_126 ) ;
continue;
V_139:
if ( F_76 ( V_68 ) && ( F_132 ( V_68 ) ||
F_133 ( V_68 ) ) )
F_134 ( V_68 ) ;
F_91 ( F_113 ( V_68 ) , V_68 ) ;
if ( ! F_133 ( V_68 ) ) {
...
unsigned long F_140 ( struct V_7 * V_7 ,
struct V_119 * V_120 )
{
struct V_1 V_2 = {
. V_64 = V_37 ,
...
F_109 ( V_156 ) ;
F_141 (page, next, page_list, lru) {
if ( F_83 ( V_68 ) && ! F_74 ( V_68 ) &&
! F_142 ( V_68 ) ) {
F_143 ( V_68 ) ;
F_144 ( & V_68 -> V_23 , & V_156 ) ;
}
}
V_60 = F_108 ( & V_156 , V_7 -> V_157 , & V_2 ,
V_158 , NULL , true ) ;
F_139 ( & V_156 , V_120 ) ;
F_145 ( V_7 -> V_157 , V_17 , - V_60 ) ;
return V_60 ;
}
int F_146 ( struct V_68 * V_68 , T_5 V_159 )
{
int V_60 = - V_160 ;
if ( ! F_92 ( V_68 ) )
return V_60 ;
...
static T_6 void F_150 ( struct V_21 * V_21 ,
...
if ( ! V_166 [ V_26 ] )
continue;
F_151 ( V_21 , V_23 , V_26 , - V_166 [ V_26 ] ) ;
#ifdef F_152
F_153 ( V_21 , V_23 , V_26 , - V_166 [ V_26 ] ) ;
#endif
}
}
static unsigned long F_154 ( unsigned long V_61 ,
...
struct V_68 * V_68 ;
V_68 = F_111 ( V_168 ) ;
F_155 ( V_68 , V_168 , V_34 ) ;
F_91 ( ! F_92 ( V_68 ) , V_68 ) ;
if ( F_156 ( V_68 ) > V_2 -> V_176 ) {
F_144 ( & V_68 -> V_23 , & V_175 ) ;
V_171 [ F_156 ( V_68 ) ] ++ ;
continue;
}
V_173 ++ ;
switch ( F_146 ( V_68 , V_159 ) ) {
case 0 :
V_174 = F_157 ( V_68 ) ;
V_170 += V_174 ;
V_166 [ F_156 ( V_68 ) ] += V_174 ;
F_144 ( & V_68 -> V_23 , V_167 ) ;
break;
case - V_162 :
F_144 ( & V_68 -> V_23 , V_168 ) ;
continue;
default:
F_158 () ;
}
...
if ( ! V_171 [ V_26 ] )
continue;
F_159 ( V_177 , V_26 , V_171 [ V_26 ] ) ;
V_172 += V_171 [ V_26 ] ;
}
}
* V_44 = V_48 ;
F_160 ( V_2 -> V_176 , V_2 -> V_178 , V_61 ,
V_48 , V_172 , V_170 , V_159 , V_23 ) ;
F_150 ( V_21 , V_23 , V_166 ) ;
return V_170 ;
}
...
int V_60 = - V_162 ;
F_91 ( ! F_48 ( V_68 ) , V_68 ) ;
F_161 ( F_162 ( V_68 ) , L_3 ) ;
if ( F_92 ( V_68 ) ) {
struct V_7 * V_7 = F_163 ( V_68 ) ;
struct V_21 * V_21 ;
F_164 ( F_165 ( V_7 ) ) ;
V_21 = F_166 ( V_68 , V_7 -> V_157 ) ;
if ( F_92 ( V_68 ) ) {
int V_23 = F_167 ( V_68 ) ;
F_168 ( V_68 ) ;
F_149 ( V_68 ) ;
F_169 ( V_68 , V_21 , V_23 ) ;
V_60 = 0 ;
}
F_170 ( F_165 ( V_7 ) ) ;
}
...
static int F_171 ( struct V_13 * V_14 , int V_179 ,
struct V_1 * V_2 )
{
...
static T_7 void
F_172 ( struct V_21 * V_21 , struct V_119 * V_120 )
{
...
V_21 = F_166 ( V_68 , V_14 ) ;
F_173 ( V_68 ) ;
V_23 = F_167 ( V_68 ) ;
F_174 ( V_68 , V_21 , V_23 ) ;
if ( F_175 ( V_23 ) ) {
int V_179 = F_176 ( V_23 ) ;
int V_185 = F_157 ( V_68 ) ;
...
struct V_13 * V_14 = F_14 ( V_21 ) ;
struct V_182 * V_122 = & V_21 -> V_122 ;
while ( F_73 ( F_171 ( V_14 , V_179 , V_2 ) ) ) {
F_185 ( V_189 , V_190 / 10 ) ;
if ( F_186 ( V_70 ) )
return V_65 ;
}
F_187 () ;
...
V_188 |= V_165 ;
F_164 ( & V_14 -> V_184 ) ;
V_170 = F_154 ( V_61 , V_21 , & V_120 ,
& V_44 , V_2 , V_188 , V_23 ) ;
F_188 ( V_14 , V_20 + V_179 , V_170 ) ;
V_122 -> V_191 [ V_179 ] += V_170 ;
if ( F_116 () ) {
if ( F_1 ( V_2 ) )
F_189 ( V_192 , V_44 ) ;
F_190 ( F_191 ( V_21 ) , V_192 ,
V_44 ) ;
} else {
if ( F_1 ( V_2 ) )
F_189 ( V_193 , V_44 ) ;
F_190 ( F_191 ( V_21 ) , V_193 ,
V_44 ) ;
}
F_170 ( & V_14 -> V_184 ) ;
if ( V_170 == 0 )
...
if ( F_1 ( V_2 ) )
F_189 ( V_194 , V_131 ) ;
F_190 ( F_191 ( V_21 ) , V_194 ,
V_131 ) ;
} else {
if ( F_1 ( V_2 ) )
F_189 ( V_195 , V_131 ) ;
F_190 ( F_191 ( V_21 ) , V_195 ,
V_131 ) ;
}
F_172 ( V_21 , & V_120 ) ;
F_188 ( V_14 , V_20 + V_179 , - V_170 ) ;
...
F_192 ( V_144 , & V_14 -> V_34 ) ;
if ( F_2 ( V_2 ) ) {
if ( V_123 . V_129 && V_123 . V_129 == V_123 . V_130 )
F_192 ( V_196 , & V_14 -> V_34 ) ;
if ( V_123 . V_128 == V_170 ) {
F_193 ( 0 , V_197 ) ;
F_192 ( V_146 , & V_14 -> V_34 ) ;
}
if ( V_123 . V_133 && F_182 () )
F_185 ( V_189 , V_190 / 10 ) ;
}
if ( ! V_2 -> V_198 && ! F_116 () &&
F_182 () )
F_194 ( V_14 , V_189 , V_190 / 10 ) ;
F_195 ( V_14 -> V_199 ,
V_44 , V_131 ,
...
static unsigned F_196 ( struct V_21 * V_21 ,
struct V_119 * V_40 ,
struct V_119 * V_183 ,
enum V_22 V_23 )
{
...
F_173 ( V_68 ) ;
V_174 = F_157 ( V_68 ) ;
F_197 ( V_21 , V_23 , F_156 ( V_68 ) , V_174 ) ;
F_144 ( & V_68 -> V_23 , & V_21 -> V_169 [ V_23 ] ) ;
if ( F_128 ( V_68 ) ) {
F_177 ( V_68 ) ;
F_178 ( V_68 ) ;
F_169 ( V_68 , V_21 , V_23 ) ;
...
if ( ! F_175 ( V_23 ) ) {
F_189 ( V_201 , V_200 ) ;
F_190 ( F_191 ( V_21 ) , V_201 ,
V_200 ) ;
}
return V_200 ;
}
static void F_198 ( unsigned long V_61 ,
struct V_21 * V_21 ,
struct V_1 * V_2 ,
enum V_22 V_23 )
{
...
V_188 |= V_165 ;
F_164 ( & V_14 -> V_184 ) ;
V_170 = F_154 ( V_61 , V_21 , & V_202 ,
& V_44 , V_2 , V_188 , V_23 ) ;
F_188 ( V_14 , V_20 + V_179 , V_170 ) ;
V_122 -> V_191 [ V_179 ] += V_170 ;
F_189 ( V_207 , V_44 ) ;
F_190 ( F_191 ( V_21 ) , V_207 , V_44 ) ;
F_170 ( & V_14 -> V_184 ) ;
while ( ! F_110 ( & V_202 ) ) {
F_33 () ;
V_68 = F_111 ( & V_202 ) ;
...
F_131 ( & V_68 -> V_23 , & V_203 ) ;
continue;
}
}
F_143 ( V_68 ) ;
F_131 ( & V_68 -> V_23 , & V_204 ) ;
}
F_164 ( & V_14 -> V_184 ) ;
V_122 -> V_186 [ V_179 ] += V_206 ;
V_152 = F_196 ( V_21 , & V_203 , & V_202 , V_23 ) ;
V_205 = F_196 ( V_21 , & V_204 , & V_202 , V_23 - V_209 ) ;
F_188 ( V_14 , V_20 + V_179 , - V_170 ) ;
F_170 ( & V_14 -> V_184 ) ;
F_136 ( & V_202 ) ;
F_138 ( & V_202 , true ) ;
F_199 ( V_14 -> V_199 , V_170 , V_152 ,
V_205 , V_206 , V_2 -> V_153 , V_179 ) ;
}
static bool F_200 ( struct V_21 * V_21 , bool V_179 ,
struct V_4 * V_5 ,
...
if ( V_217 )
V_215 = F_202 ( 10 * V_217 ) ;
else
V_215 = 1 ;
}
if ( V_210 )
F_203 ( V_14 -> V_199 , V_2 -> V_176 ,
F_10 ( V_21 , V_213 , V_28 ) , V_180 ,
F_10 ( V_21 , V_211 , V_28 ) , V_214 ,
V_215 , V_179 ) ;
return V_180 * V_215 < V_214 ;
}
static unsigned long F_204 ( enum V_22 V_23 , unsigned long V_61 ,
struct V_21 * V_21 , struct V_4 * V_5 ,
struct V_1 * V_2 )
{
if ( F_175 ( V_23 ) ) {
if ( F_200 ( V_21 , F_176 ( V_23 ) ,
V_5 , V_2 , true ) )
F_198 ( V_61 , V_21 , V_2 , V_23 ) ;
return 0 ;
}
return F_184 ( V_61 , V_21 , V_2 , V_23 ) ;
}
static void F_205 ( struct V_21 * V_21 , struct V_4 * V_5 ,
...
if ( ! F_200 ( V_21 , false , V_5 , V_2 , false ) &&
F_10 ( V_21 , V_239 , V_2 -> V_176 )
>> V_2 -> V_153 ) {
V_227 = V_240 ;
goto V_66;
}
...
if ( ! F_200 ( V_21 , true , V_5 , V_2 , false ) &&
F_10 ( V_21 , V_241 , V_2 -> V_176 ) >> V_2 -> V_153 ) {
V_227 = V_232 ;
goto V_66;
}
V_227 = V_242 ;
V_225 = V_222 ;
V_226 = 200 - V_225 ;
V_228 = F_10 ( V_21 , V_243 , V_28 ) +
F_10 ( V_21 , V_239 , V_28 ) ;
V_179 = F_10 ( V_21 , V_244 , V_28 ) +
F_10 ( V_21 , V_241 , V_28 ) ;
F_164 ( & V_14 -> V_184 ) ;
...
static void F_212 ( struct V_13 * V_14 , struct V_4 * V_5 ,
struct V_1 * V_2 , unsigned long * V_221 )
{
struct V_21 * V_21 = F_213 ( V_14 , V_5 ) ;
...
struct V_248 V_249 ;
bool V_250 ;
F_205 ( V_21 , V_5 , V_2 , V_8 , V_221 ) ;
memcpy ( V_246 , V_8 , sizeof( V_8 ) ) ;
V_250 = ( F_1 ( V_2 ) && ! F_116 () &&
V_2 -> V_153 == V_154 ) ;
F_214 ( & V_249 ) ;
while ( V_8 [ V_239 ] || V_8 [ V_244 ] ||
V_8 [ V_241 ] ) {
...
continue;
V_252 = V_8 [ V_241 ] + V_8 [ V_244 ] ;
V_251 = V_8 [ V_239 ] + V_8 [ V_243 ] ;
if ( ! V_252 || ! V_251 )
break;
if ( V_252 > V_251 ) {
unsigned long V_254 = V_246 [ V_239 ] +
V_246 [ V_243 ] + 1 ;
V_23 = V_255 ;
V_253 = V_251 * 100 / V_254 ;
} else {
unsigned long V_254 = V_246 [ V_241 ] +
V_246 [ V_244 ] + 1 ;
V_23 = V_212 ;
...
F_215 ( & V_249 ) ;
V_2 -> V_131 += V_131 ;
if ( F_200 ( V_21 , false , V_5 , V_2 , true ) )
F_198 ( V_65 , V_21 ,
V_2 , V_243 ) ;
}
static bool F_216 ( struct V_1 * V_2 )
{
if ( F_217 ( V_256 ) && V_2 -> V_178 &&
( V_2 -> V_178 > V_257 ||
V_2 -> V_153 < V_154 - 2 ) )
return true ;
return false ;
}
static inline bool F_218 ( struct V_13 * V_14 ,
unsigned long V_131 ,
unsigned long V_44 ,
struct V_1 * V_2 )
{
...
if ( ! F_15 ( V_7 ) )
continue;
switch ( F_220 ( V_7 , V_2 -> V_178 , 0 , V_2 -> V_176 ) ) {
case V_261 :
case V_262 :
return false ;
default:
...
static bool F_221 ( T_9 * V_14 , struct V_1 * V_2 )
{
...
V_95 = V_2 -> V_131 ;
V_55 = V_2 -> V_44 ;
F_212 ( V_14 , V_5 , V_2 , & V_221 ) ;
V_268 += V_221 ;
if ( V_5 )
F_37 ( V_2 -> V_64 , V_14 -> V_199 ,
V_5 , V_2 -> V_44 - V_55 ,
V_221 ) ;
F_224 ( V_2 -> V_64 , V_5 , false ,
V_2 -> V_44 - V_55 ,
V_2 -> V_131 - V_95 ) ;
if ( ! F_1 ( V_2 ) &&
V_2 -> V_131 >= V_2 -> V_247 ) {
...
F_224 ( V_2 -> V_64 , V_2 -> V_3 , true ,
V_2 -> V_44 - V_44 ,
V_2 -> V_131 - V_131 ) ;
if ( V_2 -> V_131 - V_131 )
V_264 = true ;
} while ( F_218 ( V_14 , V_2 -> V_131 - V_131 ,
V_2 -> V_44 - V_44 , V_2 ) );
if ( V_264 )
V_14 -> V_273 = 0 ;
return V_264 ;
}
static inline bool F_226 ( struct V_7 * V_7 , struct V_1 * V_2 )
{
unsigned long V_274 ;
enum V_275 V_276 ;
V_276 = F_220 ( V_7 , V_2 -> V_178 , 0 , V_2 -> V_176 ) ;
if ( V_276 == V_261 )
return true ;
if ( V_276 == V_277 )
return false ;
V_274 = F_209 ( V_7 ) + F_219 ( V_2 -> V_178 ) ;
return F_227 ( V_7 , 0 , V_274 , V_2 -> V_176 ) ;
}
static void F_228 ( struct V_278 * V_278 , struct V_1 * V_2 )
{
struct V_279 * V_236 ;
struct V_7 * V_7 ;
unsigned long V_280 ;
...
if ( V_208 ) {
V_2 -> V_64 |= V_284 ;
V_2 -> V_176 = F_229 ( V_2 -> V_64 ) ;
}
F_230 (zone, z, zonelist,
...
static void F_233 ( struct V_4 * V_286 , T_9 * V_14 )
{
struct V_4 * V_5 ;
...
static unsigned long F_234 ( struct V_278 * V_278 ,
struct V_1 * V_2 )
{
int V_287 = V_2 -> V_153 ;
T_9 * V_283 ;
...
F_235 () ;
if ( F_1 ( V_2 ) )
F_159 ( V_289 , V_2 -> V_176 , 1 ) ;
do {
F_236 ( V_2 -> V_64 , V_2 -> V_3 ,
V_2 -> V_153 ) ;
V_2 -> V_44 = 0 ;
F_228 ( V_278 , V_2 ) ;
...
V_283 = NULL ;
F_230 (zone, z, zonelist, sc->reclaim_idx,
sc->nodemask) {
if ( V_7 -> V_157 == V_283 )
continue;
V_283 = V_7 -> V_157 ;
F_233 ( V_2 -> V_3 , V_7 -> V_157 ) ;
}
F_237 () ;
if ( V_2 -> V_131 )
return V_2 -> V_131 ;
...
static bool F_242 ( T_2 V_64 , struct V_278 * V_278 ,
T_10 * V_298 )
{
struct V_279 * V_236 ;
struct V_7 * V_7 ;
...
unsigned long F_245 ( struct V_278 * V_278 , int V_178 ,
T_2 V_64 , T_10 * V_298 )
{
unsigned long V_131 ;
struct V_1 V_2 = {
...
if ( F_242 ( V_2 . V_64 , V_278 , V_298 ) )
return 1 ;
F_247 ( V_178 ,
V_2 . V_148 ,
V_2 . V_64 ,
V_2 . V_176 ) ;
V_131 = F_234 ( V_278 , & V_2 ) ;
F_248 ( V_131 ) ;
return V_131 ;
}
unsigned long F_249 ( struct V_4 * V_5 ,
T_2 V_64 , bool V_304 ,
T_9 * V_14 ,
unsigned long * V_44 )
{
...
unsigned long F_252 ( struct V_4 * V_5 ,
unsigned long V_174 ,
T_2 V_64 ,
bool V_231 )
{
...
unsigned int V_307 ;
struct V_1 V_2 = {
. V_247 = F_253 ( V_174 , V_65 ) ,
. V_64 = ( F_246 ( V_64 ) & V_305 ) |
( V_306 & ~ V_305 ) ,
. V_176 = V_28 - 1 ,
. V_3 = V_5 ,
. V_153 = V_154 ,
...
static bool F_261 ( T_9 * V_14 , int V_178 , int V_310 )
{
int V_291 ;
...
continue;
V_311 = F_209 ( V_7 ) ;
if ( F_227 ( V_7 , V_178 , V_311 , V_310 ) )
return true ;
}
if ( V_311 == - 1 )
return true ;
...
static void F_262 ( T_9 * V_14 )
{
F_263 ( V_196 , & V_14 -> V_34 ) ;
F_263 ( V_146 , & V_14 -> V_34 ) ;
F_263 ( V_144 , & V_14 -> V_34 ) ;
}
static bool F_264 ( T_9 * V_14 , int V_178 , int V_310 )
{
if ( F_240 ( & V_14 -> V_301 ) )
F_265 ( & V_14 -> V_301 ) ;
if ( V_14 -> V_273 >= V_293 )
return true ;
if ( F_261 ( V_14 , V_178 , V_310 ) ) {
F_262 ( V_14 ) ;
return true ;
}
return false ;
}
static bool F_266 ( T_9 * V_14 ,
struct V_1 * V_2 )
{
struct V_7 * V_7 ;
int V_236 ;
...
if ( ! F_15 ( V_7 ) )
continue;
V_2 -> V_247 += F_253 ( F_209 ( V_7 ) , V_65 ) ;
}
F_221 ( V_14 , V_2 ) ;
if ( V_2 -> V_178 && V_2 -> V_131 >= F_219 ( V_2 -> V_178 ) )
V_2 -> V_178 = 0 ;
return V_2 -> V_44 >= V_2 -> V_247 ;
}
static int F_267 ( T_9 * V_14 , int V_178 , int V_310 )
{
int V_291 ;
unsigned long V_280 ;
unsigned long V_281 ;
...
if ( V_14 -> V_296 == V_28 )
return V_310 ;
return F_253 ( V_14 -> V_296 , V_310 ) ;
}
static void F_270 ( T_9 * V_14 , int V_314 , int V_315 ,
unsigned int V_310 )
{
long V_316 = 0 ;
F_271 ( V_317 ) ;
if ( F_272 ( V_70 ) || F_269 () )
return;
F_273 ( & V_14 -> V_295 , & V_317 , V_318 ) ;
if ( F_264 ( V_14 , V_315 , V_310 ) ) {
F_274 ( V_14 ) ;
F_275 ( V_14 , V_314 , V_310 ) ;
V_316 = F_276 ( V_190 / 10 ) ;
if ( V_316 ) {
V_14 -> V_296 = V_296 ( V_14 , V_310 ) ;
V_14 -> V_319 = F_253 ( V_14 -> V_319 , V_315 ) ;
}
F_277 ( & V_14 -> V_295 , & V_317 ) ;
F_273 ( & V_14 -> V_295 , & V_317 , V_318 ) ;
}
if ( ! V_316 &&
F_264 ( V_14 , V_315 , V_310 ) ) {
F_278 ( V_14 -> V_199 ) ;
F_279 ( V_14 , V_320 ) ;
if ( ! F_269 () )
F_280 () ;
...
const struct V_327 * V_327 = F_282 ( V_14 -> V_199 ) ;
F_283 ( V_37 ) ;
if ( ! F_284 ( V_327 ) )
F_285 ( V_326 , V_327 ) ;
V_70 -> V_263 = & V_263 ;
...
if ( V_60 )
continue;
F_287 ( V_14 -> V_199 , V_310 ,
V_314 ) ;
V_315 = F_267 ( V_14 , V_314 , V_310 ) ;
if ( V_315 < V_314 )
goto V_330;
}
V_326 -> V_34 &= ~ ( V_328 | V_71 | V_329 ) ;
...
void F_289 ( struct V_7 * V_7 , int V_178 , enum V_297 V_310 )
{
T_9 * V_14 ;
if ( ! F_15 ( V_7 ) )
return;
if ( ! F_231 ( V_7 , V_37 | V_285 ) )
return;
V_14 = V_7 -> V_157 ;
V_14 -> V_296 = V_296 ( V_14 ,
V_310 ) ;
V_14 -> V_319 = F_253 ( V_14 -> V_319 , V_178 ) ;
if ( ! F_240 ( & V_14 -> V_295 ) )
return;
if ( V_14 -> V_273 >= V_293 )
return;
if ( F_261 ( V_14 , V_178 , V_310 ) )
return;
F_290 ( V_14 -> V_199 , V_310 , V_178 ) ;
F_241 ( & V_14 -> V_295 ) ;
}
unsigned long F_291 ( unsigned long V_247 )
{
struct V_263 V_263 ;
struct V_1 V_2 = {
. V_247 = V_247 ,
...
struct V_278 * V_278 = F_292 ( F_293 () , V_2 . V_64 ) ;
...
static int F_294 ( unsigned int V_331 )
{
int V_51 ;
F_295 (nid, N_MEMORY) {
T_9 * V_14 = F_255 ( V_51 ) ;
const struct V_327 * V_332 ;
V_332 = F_282 ( V_14 -> V_199 ) ;
if ( F_296 ( V_333 , V_332 ) < V_334 )
F_285 ( V_14 -> F_281 , V_332 ) ;
}
return 0 ;
}
int F_297 ( int V_51 )
...
if ( V_14 -> F_281 )
return 0 ;
V_14 -> F_281 = F_298 ( F_281 , V_14 , L_4 , V_51 ) ;
if ( F_299 ( V_14 -> F_281 ) ) {
F_69 ( V_335 < V_336 ) ;
F_30 ( L_5 , V_51 ) ;
V_60 = F_300 ( V_14 -> F_281 ) ;
V_14 -> F_281 = NULL ;
}
return V_60 ;
}
void F_301 ( int V_51 )
{
struct V_325 * F_281 = F_255 ( V_51 ) -> F_281 ;
if ( F_281 ) {
F_302 ( F_281 ) ;
F_255 ( V_51 ) -> F_281 = NULL ;
}
}
static int T_11 F_303 ( void )
{
int V_51 , V_60 ;
F_304 () ;
F_295 (nid, N_MEMORY)
...
static inline unsigned long F_307 ( struct V_13 * V_14 )
{
...
static unsigned long F_308 ( struct V_13 * V_14 )
{
unsigned long V_341 ;
...
static int F_309 ( struct V_13 * V_14 , T_2 V_64 , unsigned int V_178 )
{
...
int F_310 ( struct V_13 * V_14 , T_2 V_64 , unsigned int V_178 )
{
int V_60 ;
if ( F_308 ( V_14 ) <= V_14 -> V_348 &&
F_13 ( V_14 , V_349 ) <= V_14 -> V_350 )
return V_351 ;
if ( ! F_311 ( V_64 ) || ( V_70 -> V_34 & V_328 ) )
return V_352 ;
if ( F_312 ( V_14 -> V_199 , V_353 ) && V_14 -> V_199 != F_293 () )
return V_352 ;
if ( F_313 ( V_354 , & V_14 -> V_34 ) )
return V_352 ;
V_60 = F_309 ( V_14 , V_64 , V_178 ) ;
F_263 ( V_354 , & V_14 -> V_34 ) ;
if ( ! V_60 )
F_100 ( V_355 ) ;
return V_60 ;
}
...
{
return ! F_314 ( F_55 ( V_68 ) ) && ! F_133 ( V_68 ) ;
}
void F_315 ( struct V_68 * * V_356 , int V_174 )
{
struct V_21 * V_21 ;
...
continue;
if ( F_94 ( V_68 ) ) {
enum V_22 V_23 = F_317 ( V_68 ) ;
F_91 ( F_113 ( V_68 ) , V_68 ) ;
F_93 ( V_68 ) ;
F_169 ( V_68 , V_21 , V_360 ) ;
F_174 ( V_68 , V_21 , V_23 ) ;
V_358 ++ ;
}
}
