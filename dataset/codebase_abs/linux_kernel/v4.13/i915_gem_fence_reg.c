...
F_35 ( & V_2 -> V_41 , & V_2 -> V_9 -> V_42 . V_43 ) ;
}
return 0 ;
}
int
...
static struct V_1 * F_37 ( struct V_24 * V_25 )
{
struct V_1 * V_2 ;
F_38 (fence, &dev_priv->mm.fence_list, link) {
if ( V_2 -> V_44 )
continue;
return V_2 ;
}
...
{
struct V_1 * V_2 ;
struct V_3 * V_48 = F_42 ( V_4 -> V_15 ) ? V_4 : NULL ;
F_43 ( V_4 -> V_49 -> V_9 ) ;
if ( V_4 -> V_2 ) {
V_2 = V_4 -> V_2 ;
if ( ! V_2 -> V_34 ) {
...
V_2 = F_37 ( V_4 -> V_49 -> V_9 ) ;
if ( F_44 ( V_2 ) )
return F_45 ( V_2 ) ;
} else
return 0 ;
return F_28 ( V_2 , V_48 ) ;
}
...
void F_48 ( struct V_24 * V_25 )
{
int V_50 ;
for ( V_50 = 0 ; V_50 < V_25 -> V_52 ; V_50 ++ ) {
struct V_1 * V_32 = & V_25 -> V_53 [ V_50 ] ;
struct V_3 * V_4 = V_32 -> V_4 ;
if ( V_4 && ! F_42 ( V_4 -> V_15 ) ) {
F_8 ( ! V_32 -> V_34 ) ;
F_8 ( ! F_49 ( & V_4 -> V_15 -> V_54 ) ) ;
...
return;
V_50 = 0 ;
F_65 (page, sgt_iter, pages) {
char V_99 = F_66 ( V_90 ) >> 17 ;
if ( ( V_99 & 0x1 ) != ( F_67 ( V_50 , V_15 -> V_98 ) != 0 ) ) {
F_61 ( V_90 ) ;
F_68 ( V_90 ) ;
}
V_50 ++ ;
