...
{
struct V_30 * V_31 ;
struct V_6 * V_7 = F_30 ( - V_47 ) ;
struct V_6 * V_8 = F_30 ( - V_47 ) ;
struct V_26 * V_27 = F_30 ( - V_47 ) ;
struct V_26 * V_40 = F_30 ( - V_47 ) ;
struct V_32 * V_33 ;
unsigned long V_48 ;
int V_14 ;
V_31 = F_31 ( V_2 ) ;
...
if ( V_3 )
continue;
V_3 = F_50 ( & V_55 -> V_57 , sizeof( * V_3 ) , V_58 ) ;
if ( ! V_3 ) {
V_14 = - V_59 ;
goto V_60;
}
