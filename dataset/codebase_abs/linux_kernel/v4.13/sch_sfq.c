...
V_35 = & V_3 -> V_6 [ V_31 ] ;
V_44:
V_9 = V_3 -> V_45 ? F_16 ( V_35 ) : F_15 ( V_35 ) ;
V_43 = F_20 ( V_9 ) ;
V_35 -> V_46 -= V_43 ;
F_12 ( V_3 , V_31 ) ;
V_13 -> V_3 . V_36 -- ;
...
V_31 = V_3 -> V_47 -> V_37 ;
V_35 = & V_3 -> V_6 [ V_31 ] ;
V_3 -> V_47 -> V_37 = V_35 -> V_37 ;
V_3 -> V_48 [ V_35 -> V_49 ] = V_50 ;
goto V_44;
}
return 0 ;
}
...
{
return ( V_3 -> V_51 & ( V_52 | V_53 ) ) == V_52 ;
}
...
static int
F_27 ( struct V_8 * V_9 , struct V_12 * V_13 , struct V_8 * * V_54 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
unsigned int V_49 , V_55 ;
T_1 V_31 , V_36 ;
struct V_34 * V_35 ;
int V_56 ( V_57 ) ;
struct V_8 * V_58 ;
int V_59 ;
V_49 = F_4 ( V_9 , V_13 , & V_57 ) ;
if ( V_49 == 0 ) {
if ( V_57 & V_24 )
F_21 ( V_13 ) ;
F_23 ( V_9 ) ;
...
unsigned int V_49 = F_2 ( V_3 , V_9 ) ;
T_1 V_31 = V_3 -> V_48 [ V_49 ] ;
V_35 = & V_3 -> V_6 [ V_31 ] ;
if ( V_31 == V_50 ) {
V_31 = V_3 -> V_7 [ 0 ] . V_37 ;
if ( V_31 >= V_5 ) {
...
struct V_2 * V_3 = F_5 ( V_13 ) ;
T_2 * V_90 = F_47 ( F_48 ( V_13 ) ) ;
F_49 ( V_90 ) ;
V_3 -> V_10 = F_50 () ;
if ( ! V_3 -> V_22 && V_3 -> V_47 )
F_41 ( V_13 ) ;
F_51 ( V_90 ) ;
if ( V_3 -> V_91 )
F_52 ( & V_3 -> V_92 , V_93 + V_3 -> V_91 ) ;
}
static int F_53 ( struct V_12 * V_13 , struct V_94 * V_95 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
struct V_96 * V_97 = F_54 ( V_95 ) ;
struct V_98 * V_99 = NULL ;
unsigned int V_36 , V_55 = 0 ;
struct V_62 * V_32 = NULL ;
if ( V_95 -> V_100 < F_55 ( sizeof( * V_97 ) ) )
return - V_101 ;
if ( V_95 -> V_100 >= F_55 ( sizeof( * V_99 ) ) )
V_99 = F_54 ( V_95 ) ;
if ( V_97 -> V_11 &&
( ! F_56 ( V_97 -> V_11 ) || V_97 -> V_11 > 65536 ) )
return - V_101 ;
if ( V_99 && V_99 -> V_102 ) {
V_32 = F_57 ( sizeof( * V_32 ) , V_103 ) ;
if ( ! V_32 )
return - V_104 ;
}
F_58 ( V_13 ) ;
...
if ( V_97 -> V_107 )
V_3 -> V_88 = F_59 ( V_108 , V_97 -> V_107 , V_5 ) ;
if ( V_97 -> V_11 ) {
V_3 -> V_11 = V_97 -> V_11 ;
V_3 -> V_88 = F_59 ( V_108 , V_3 -> V_88 , V_3 -> V_11 ) ;
}
if ( V_99 ) {
if ( V_99 -> V_109 )
V_3 -> V_75 = F_59 ( V_108 , V_99 -> V_109 , V_110 ) ;
if ( V_32 ) {
F_60 ( V_3 -> V_62 , V_32 ) ;
F_61 ( V_3 -> V_62 ,
...
if ( V_97 -> V_80 ) {
V_3 -> V_80 = F_59 ( V_108 , V_97 -> V_80 , V_3 -> V_75 * V_3 -> V_88 ) ;
V_3 -> V_88 = F_59 ( V_108 , V_3 -> V_88 , V_3 -> V_80 ) ;
}
V_36 = V_13 -> V_3 . V_36 ;
...
static void * F_65 ( T_3 V_116 )
{
return F_66 ( V_116 , V_103 ) ;
}
static void F_67 ( void * V_117 )
{
F_68 ( V_117 ) ;
}
...
static int F_72 ( struct V_12 * V_13 , struct V_94 * V_95 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
int V_84 ;
int V_119 ;
...
V_3 -> V_11 = V_120 ;
V_3 -> V_88 = V_121 ;
V_3 -> V_105 = F_75 ( F_76 ( V_13 ) ) ;
V_3 -> V_79 = F_38 ( V_3 -> V_105 ) ;
V_3 -> V_91 = 0 ;
V_3 -> V_10 = F_50 () ;
if ( V_95 ) {
int V_119 = F_53 ( V_13 , V_95 ) ;
if ( V_119 )
return V_119 ;
}
V_3 -> V_48 = F_65 ( sizeof( V_3 -> V_48 [ 0 ] ) * V_3 -> V_11 ) ;
V_3 -> V_6 = F_65 ( sizeof( V_3 -> V_6 [ 0 ] ) * V_3 -> V_88 ) ;
if ( ! V_3 -> V_48 || ! V_3 -> V_6 ) {
return - V_104 ;
}
...
static int F_77 ( struct V_12 * V_13 , struct V_8 * V_9 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
unsigned char * V_123 = F_78 ( V_9 ) ;
struct V_98 V_95 ;
...
V_95 . V_51 = V_3 -> V_51 ;
if ( F_79 ( V_9 , V_125 , sizeof( V_95 ) , & V_95 ) )
goto V_126;
return V_9 -> V_43 ;
V_126:
F_80 ( V_9 , V_123 ) ;
...
static struct V_12 * F_81 ( struct V_12 * V_13 , unsigned long V_89 )
{
return NULL ;
}
static unsigned long F_82 ( struct V_12 * V_13 , V_108 V_30 )
{
return 0 ;
}
static unsigned long F_83 ( struct V_12 * V_13 , unsigned long V_127 ,
V_108 V_30 )
{
V_13 -> V_51 &= ~ V_122 ;
return 0 ;
}
static void F_84 ( struct V_12 * V_3 , unsigned long V_128 )
{
}
static struct V_129 * F_85 ( struct V_12 * V_13 , unsigned long V_128 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
if ( V_128 )
return NULL ;
...
static int F_86 ( struct V_12 * V_13 , unsigned long V_128 ,
...
V_136 . V_46 = V_35 -> V_46 ;
}
if ( F_88 ( V_39 , NULL , & V_136 , V_136 . V_36 ) < 0 )
return - 1 ;
return F_89 ( V_39 , & V_138 , sizeof( V_138 ) ) ;
}
static void F_90 ( struct V_12 * V_13 , struct V_140 * V_89 )
{
struct V_2 * V_3 = F_5 ( V_13 ) ;
unsigned int V_84 ;
if ( V_89 -> V_141 )
