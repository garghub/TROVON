...
struct V_5 * V_6 , * V_25 ;
unsigned long V_26 ;
F_19 (bridge, next, bridge_list, node) {
F_13 ( V_6 ) ;
F_20 ( & V_27 , V_26 ) ;
F_21 ( & V_6 -> V_28 ) ;
F_22 ( & V_27 , V_26 ) ;
...
int F_29 ( struct V_1 * V_2 , const char * V_32 ,
...
V_6 = F_31 ( sizeof( * V_6 ) , V_39 ) ;
if ( ! V_6 )
return - V_40 ;
V_37 = F_32 ( & V_41 , 0 , 0 , V_39 ) ;
if ( V_37 < 0 ) {
V_13 = V_37 ;
goto V_42;
}
...
V_6 -> V_2 . V_37 = V_37 ;
F_36 ( V_2 , V_6 ) ;
V_13 = F_37 ( & V_6 -> V_2 , L_9 , V_37 ) ;
if ( V_13 )
goto V_44;
V_13 = F_38 ( & V_6 -> V_2 ) ;
if ( V_13 )
goto V_44;
F_39 ( V_2 -> V_4 , NULL , NULL , V_2 ) ;
F_40 ( V_6 -> V_2 . V_19 , L_10 ,
V_6 -> V_32 ) ;
return 0 ;
V_44:
F_41 ( & V_41 , V_37 ) ;
