...
if ( V_2 & V_40 )
V_12 |= V_41 ;
return F_7 ( V_1 , V_1 -> V_23 [ V_42 ] , V_12 ,
V_4 ? 0 : V_12 ) ;
}
...
static int F_27 ( int V_43 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_28 ( V_45 ) ; V_44 ++ ) {
if ( V_45 [ V_44 ] >= V_43 )
return V_44 ;
}
return - V_36 ;
}
static int F_29 ( struct V_1 * V_1 , int V_46 )
{
int V_6 ;
if ( ! V_1 -> V_3 -> V_47 )
return - V_48 ;
...
V_6 = F_7 ( V_1 , V_1 -> V_23 [ V_42 ] ,
V_49 ,
V_43 ) ;
if ( V_6 < 0 )
return V_6 ;
return F_7 ( V_1 , V_1 -> V_23 [ V_42 ] ,
V_50 ,
V_50 ) ;
}
...
V_12 &= ~ V_55 ;
return F_7 ( V_1 , V_1 -> V_23 [ V_56 ] , V_12 ,
V_4 ? V_12 : 0 ) ;
}
static int F_32 ( struct V_1 * V_1 , enum V_19 V_20 )
{
switch ( V_20 ) {
case V_54 :
return 2 ;
...
V_61 = V_64 ;
V_6 = F_7 ( V_1 , V_1 -> V_23 [ V_56 ] ,
V_61 , V_61 ) ;
if ( V_6 < 0 )
return V_6 ;
F_35 ( 10 ) ;
V_43 = V_65 + F_36 ( 100 ) ;
while ( F_37 ( V_65 , V_43 ) ) {
V_6 = F_3 ( V_1 , V_1 -> V_23 [ V_56 ] ) ;
if ( V_6 < 0 )
return V_6 ;
if ( ! ( V_6 & V_61 ) )
return 0 ;
...
static int F_40 ( struct V_1 * V_1 , enum V_19 V_20 )
{
switch ( V_20 ) {
case V_69 :
return 2 ;
...
static T_4 F_41 ( int V_70 , void * V_71 )
{
struct V_1 * V_1 = V_71 ;
struct V_21 * V_3 = V_1 -> V_3 ;
int V_72 = F_21 ( V_3 -> V_73 , 8 ) ;
T_1 V_74 ;
T_1 V_75 [ 3 ] ;
int V_6 ;
int V_44 ;
...
V_74 = V_1 -> V_23 [ V_83 ] ;
V_6 = F_18 ( V_1 , V_74 , V_72 , V_75 ) ;
if ( V_6 < 0 )
return V_84 ;
for ( V_44 = 0 ; V_44 < V_72 ; V_44 ++ ) {
int V_85 = V_72 - V_44 - 1 ;
T_1 V_86 = V_75 [ V_44 ] ;
T_1 V_87 ;
V_86 &= V_1 -> V_88 [ V_85 ] ;
if ( ! V_86 )
...
while ( V_86 ) {
int V_89 = F_22 ( V_86 ) ;
int line = V_85 * 8 + V_89 ;
int V_90 = F_42 ( V_1 -> V_79 , line ) ;
F_43 ( V_90 ) ;
V_86 &= ~ ( 1 << V_89 ) ;
}
F_16 ( V_1 , V_74 + V_44 , V_87 ) ;
}
return V_80 ;
}
static void F_44 ( struct V_91 * V_71 )
{
struct V_1 * V_1 = F_45 ( V_71 ) ;
F_12 ( & V_1 -> V_92 ) ;
}
static void F_46 ( struct V_91 * V_71 )
{
struct V_1 * V_1 = F_45 ( V_71 ) ;
struct V_21 * V_3 = V_1 -> V_3 ;
int V_72 = F_21 ( V_3 -> V_73 , 8 ) ;
int V_44 ;
for ( V_44 = 0 ; V_44 < V_72 ; V_44 ++ ) {
T_1 V_93 = V_1 -> V_88 [ V_44 ] ;
T_1 V_94 = V_1 -> V_95 [ V_44 ] ;
if ( V_93 == V_94 )
continue;
V_1 -> V_95 [ V_44 ] = V_93 ;
F_16 ( V_1 , V_1 -> V_23 [ V_96 + V_44 ] , V_93 ) ;
}
F_13 ( & V_1 -> V_92 ) ;
}
static void F_47 ( struct V_91 * V_71 )
{
struct V_1 * V_1 = F_45 ( V_71 ) ;
int V_97 = V_71 -> V_98 ;
int V_34 = V_97 / 8 ;
...
static void F_48 ( struct V_91 * V_71 )
{
struct V_1 * V_1 = F_45 ( V_71 ) ;
int V_97 = V_71 -> V_98 ;
int V_34 = V_97 / 8 ;
...
static int F_49 ( struct V_99 * V_100 , unsigned int V_101 ,
T_5 V_98 )
{
struct V_1 * V_1 = V_100 -> V_102 ;
struct V_103 * V_104 = NULL ;
if ( V_1 -> V_3 -> V_60 != V_76 )
V_104 = & V_105 ;
F_50 ( V_101 , V_1 ) ;
F_51 ( V_101 , V_104 , V_106 ) ;
F_52 ( V_101 , 1 ) ;
F_53 ( V_101 ) ;
return 0 ;
}
static void F_54 ( struct V_99 * V_100 , unsigned int V_101 )
{
F_51 ( V_101 , NULL , NULL ) ;
F_50 ( V_101 , NULL ) ;
}
static int F_55 ( struct V_1 * V_1 , struct V_107 * V_108 )
{
int V_78 = 0 ;
int V_73 = V_1 -> V_3 -> V_73 ;
V_1 -> V_79 = F_56 ( V_108 , V_73 , V_78 ,
& V_109 , V_1 ) ;
if ( ! V_1 -> V_79 ) {
F_4 ( V_1 -> V_9 , L_12 ) ;
return - V_48 ;
...
if ( V_6 < 0 )
return V_6 ;
V_113 = ( V_71 [ 0 ] << 8 ) | V_71 [ 1 ] ;
if ( ( V_113 & V_3 -> V_115 ) != V_3 -> V_60 ) {
...
V_135 -> V_139 = V_135 -> V_140 = V_20 -> V_70 + V_130 ;
}
V_129 &= ~ V_20 -> V_20 ;
...
{
struct V_107 * V_142 ;
V_111 -> V_113 = F_64 ( V_108 , L_16 ) ;
if ( V_111 -> V_113 < 0 )
V_111 -> V_113 = - 1 ;
V_111 -> V_143 = F_65 ( V_108 , L_17 , 0 ,
& V_111 -> V_110 ) ;
if ( F_66 ( V_111 -> V_143 ) )
V_111 -> V_144 = 1 ;
else
...
V_111 -> V_2 |= V_54 ;
} else if ( ! strcmp ( V_142 -> V_116 , L_24 ) ) {
V_111 -> V_2 |= V_69 ;
}
}
}
int F_69 ( struct V_146 * V_7 , enum V_147 V_148 )
{
struct V_141 * V_111 ;
struct V_107 * V_108 = V_7 -> V_9 -> V_149 ;
struct V_1 * V_1 ;
int V_6 ;
V_111 = F_70 ( V_7 -> V_9 , sizeof( * V_111 ) , V_150 ) ;
if ( ! V_111 )
return - V_151 ;
F_63 ( V_111 , V_108 ) ;
if ( F_71 ( V_108 , L_25 , NULL ) == NULL )
V_7 -> V_70 = - 1 ;
V_1 = F_70 ( V_7 -> V_9 , sizeof( struct V_1 ) , V_150 ) ;
if ( ! V_1 )
return - V_151 ;
F_72 ( & V_1 -> V_92 ) ;
F_72 ( & V_1 -> V_17 ) ;
...
V_1 -> V_153 = F_73 ( V_7 -> V_9 , L_26 ) ;
if ( ! F_74 ( V_1 -> V_153 ) ) {
V_6 = F_75 ( V_1 -> V_153 ) ;
if ( V_6 )
F_62 ( V_7 -> V_9 , L_27 ) ;
}
V_1 -> V_154 = F_73 ( V_7 -> V_9 , L_28 ) ;
if ( ! F_74 ( V_1 -> V_154 ) ) {
V_6 = F_75 ( V_1 -> V_154 ) ;
if ( V_6 )
F_62 ( V_7 -> V_9 , L_29 ) ;
...
V_1 -> V_3 = V_157 [ V_1 -> V_148 ] ;
} else if ( V_111 -> V_110 == V_145 ) {
V_111 -> V_110 = F_79 ( V_1 -> V_70 ) ;
}
V_6 = F_57 ( V_1 ) ;
if ( V_6 )
return V_6 ;
...
if ( V_6 )
return V_6 ;
V_6 = F_80 ( V_7 -> V_9 , V_1 -> V_70 , NULL ,
F_41 , V_111 -> V_110 | V_159 ,
L_30 , V_1 ) ;
if ( V_6 ) {
F_4 ( V_1 -> V_9 , L_34 ,
V_6 ) ;
...
static int F_84 ( struct V_160 * V_9 )
{
struct V_1 * V_1 = F_85 ( V_9 ) ;
if ( V_1 -> V_70 >= 0 && F_86 ( V_9 ) )
F_87 ( V_1 -> V_70 ) ;
return 0 ;
}
static int F_88 ( struct V_160 * V_9 )
{
struct V_1 * V_1 = F_85 ( V_9 ) ;
if ( V_1 -> V_70 >= 0 && F_86 ( V_9 ) )
F_89 ( V_1 -> V_70 ) ;
