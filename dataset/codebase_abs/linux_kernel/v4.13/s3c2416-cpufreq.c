...
if ( ! V_32 )
goto V_30;
F_17 (pos, s3c_freq->freq_table) {
V_13 = & V_16 [ V_37 -> V_26 ] ;
V_35 = 0 ;
for ( V_34 = 0 ; V_34 < V_32 ; V_34 ++ ) {
V_33 = F_18 ( V_3 -> V_15 , V_34 ) ;
if ( V_33 >= V_13 -> V_17 )
V_35 = 1 ;
}
if ( ! V_35 ) {
...
V_3 -> V_5 = 0 ;
V_3 -> V_10 = F_23 ( NULL , L_24 ) ;
if ( F_24 ( V_3 -> V_10 ) ) {
V_9 = F_25 ( V_3 -> V_10 ) ;
F_5 ( L_25 , V_9 ) ;
return V_9 ;
}
V_3 -> V_14 = F_23 ( NULL , L_26 ) ;
if ( F_24 ( V_3 -> V_14 ) ) {
V_9 = F_25 ( V_3 -> V_14 ) ;
F_5 ( L_27 , V_9 ) ;
goto V_55;
