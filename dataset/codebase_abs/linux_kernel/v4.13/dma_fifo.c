static bool F_1 ( unsigned int V_1 , unsigned int V_2 , unsigned int V_3 )
{
...
int F_4 ( struct V_4 * V_5 , int V_7 , unsigned int V_8 ,
...
{
unsigned int V_34 , V_28 , V_29 , V_30 , V_35 ;
if ( ! V_5 -> V_15 )
return - V_31 ;
if ( V_5 -> V_23 )
return - V_32 ;
...
V_30 = V_5 -> V_12 - V_29 ;
V_35 = F_20 (unsigned int, l, fifo->tx_limit) ;
if ( V_28 > V_35 ) {
V_28 = V_35 ;
V_5 -> V_18 += V_35 ;
