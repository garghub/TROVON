...
static inline const struct V_29 *
...
if ( ! F_12 ( V_4 ) -> V_34 )
return true ;
return F_12 ( V_4 ) -> V_34 ( V_4 , V_31 , V_33 ) ;
}
...
struct V_32 * V_33 )
{
F_12 ( V_4 ) -> F_19 ( V_4 , V_31 , V_33 ) ;
}
enum V_37 F_20 ( struct V_28 * V_4 ,
struct V_38 * V_39 )
{
return F_12 ( V_4 ) -> F_21 ( V_4 , V_39 ) ;
}
