...
static int F_30 ( struct V_19 * V_49 )
{
struct V_1 * V_2 ;
if ( ! V_49 )
return - V_23 ;
...
V_2 = F_32 ( sizeof( struct V_1 ) , V_82 ) ;
if ( ! V_2 ) {
F_7 ( ( V_22 ,
L_14 ) ) ;
return - V_67 ;
}
V_2 -> V_37 = F_32 ( sizeof( T_4 ) * ( V_33 + 1 ) , V_82 ) ;
if ( ! V_2 -> V_37 ) {
V_62 = - V_67 ;
goto V_83;
}
...
V_2 -> V_33 = V_33 ;
V_19 -> V_84 = V_2 ;
strcpy ( F_33 ( V_19 ) , V_85 ) ;
strcpy ( F_34 ( V_19 ) , V_86 ) ;
V_62 = F_25 ( V_2 ) ;
if ( V_62 ) {
F_7 ( ( V_22 ,
L_15 ) ) ;
