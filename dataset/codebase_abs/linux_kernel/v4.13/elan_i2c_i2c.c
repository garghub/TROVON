...
static int F_22 ( struct V_1 * V_2 , T_1 * V_53 )
{
int error ;
T_2 V_4 [ 3 ] ;
...
static int F_28 ( struct V_1 * V_2 , enum V_71 * V_34 )
{
int error ;
T_1 V_72 ;
T_2 V_4 [ 3 ] ;
...
V_72 = F_13 ( ( T_3 * ) V_4 ) ;
F_29 ( & V_2 -> V_18 , L_24 , V_72 ) ;
* V_34 = ( V_72 & V_74 ) ? V_75 : V_76 ;
return 0 ;
}
...
const T_2 * V_82 , T_1 V_83 , int V_84 )
{
struct V_21 * V_18 = & V_2 -> V_18 ;
T_2 V_85 [ V_86 + 4 ] ;
T_2 V_4 [ 3 ] ;
...
V_85 [ 0 ] = V_88 ;
V_85 [ 1 ] = V_89 ;
memcpy ( & V_85 [ 2 ] , V_82 , V_86 ) ;
F_34 ( V_83 , & V_85 [ V_86 + 2 ] ) ;
V_13 = F_35 ( V_2 , V_85 , sizeof( V_85 ) ) ;
if ( V_13 != sizeof( V_85 ) ) {
error = V_13 < 0 ? V_13 : - V_15 ;
F_6 ( V_18 , L_30 , V_84 , error ) ;
return error ;
}
F_9 ( 20 ) ;
error = F_5 ( V_2 , V_73 , V_4 ) ;
...
static int F_43 ( struct V_1 * V_2 , T_2 * V_97 )
{
int V_5 ;
V_5 = F_10 ( V_2 , V_97 , V_94 ) ;
if ( V_5 < 0 ) {
