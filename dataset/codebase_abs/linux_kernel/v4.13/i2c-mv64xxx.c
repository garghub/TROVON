...
static int
F_41 ( struct V_136 * V_137 )
{
struct V_1 * V_2 ;
struct V_138 * V_139 = F_42 ( & V_137 -> V_65 ) ;
struct V_140 * V_141 ;
int V_62 ;
if ( ( ! V_139 && ! V_137 -> V_65 . V_128 ) )
return - V_131 ;
V_2 = F_43 ( & V_137 -> V_65 , sizeof( struct V_1 ) ,
V_142 ) ;
if ( ! V_2 )
return - V_143 ;
V_141 = F_44 ( V_137 , V_144 , 0 ) ;
V_2 -> V_17 = F_45 ( & V_137 -> V_65 , V_141 ) ;
if ( F_33 ( V_2 -> V_17 ) )
return F_38 ( V_2 -> V_17 ) ;
F_46 ( V_2 -> V_64 . V_145 , V_146 L_11 ,
sizeof( V_2 -> V_64 . V_145 ) ) ;
F_47 ( & V_2 -> V_75 ) ;
F_48 ( & V_2 -> V_87 ) ;
V_2 -> V_130 = F_49 ( & V_137 -> V_65 , NULL ) ;
if ( F_33 ( V_2 -> V_130 ) && F_38 ( V_2 -> V_130 ) == - V_147 )
return - V_147 ;
if ( ! F_33 ( V_2 -> V_130 ) )
F_50 ( V_2 -> V_130 ) ;
V_2 -> V_85 = F_51 ( V_137 , 0 ) ;
if ( V_139 ) {
V_2 -> V_24 = V_139 -> V_24 ;
V_2 -> V_25 = V_139 -> V_25 ;
V_2 -> V_64 . V_91 = F_52 ( V_139 -> V_91 ) ;
V_2 -> V_16 = false ;
memcpy ( & V_2 -> V_22 , & V_148 , sizeof( V_2 -> V_22 ) ) ;
} else if ( V_137 -> V_65 . V_128 ) {
V_62 = F_32 ( V_2 , & V_137 -> V_65 ) ;
if ( V_62 )
goto V_149;
}
if ( V_2 -> V_85 < 0 ) {
...
V_2 -> V_64 . V_65 . V_151 = & V_137 -> V_65 ;
V_2 -> V_64 . V_152 = & V_153 ;
V_2 -> V_64 . V_154 = V_155 ;
V_2 -> V_64 . V_156 = V_157 ;
V_2 -> V_64 . V_158 = V_137 -> V_159 ;
V_2 -> V_64 . V_65 . V_128 = V_137 -> V_65 . V_128 ;
F_53 ( V_137 , V_2 ) ;
F_54 ( & V_2 -> V_64 , V_2 ) ;
F_3 ( V_2 ) ;
V_62 = F_55 ( V_2 -> V_85 , F_17 , 0 ,
V_146 , V_2 ) ;
if ( V_62 ) {
F_8 ( & V_2 -> V_64 . V_65 ,
L_12 ,
...
static int F_63 ( struct V_124 * V_65 )
{
struct V_136 * V_161 = F_64 ( V_65 ) ;
struct V_1 * V_2 = F_61 ( V_161 ) ;
F_3 ( V_2 ) ;
return 0 ;
}
