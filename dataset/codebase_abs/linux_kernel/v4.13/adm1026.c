...
static T_2 F_30 ( struct V_7 * V_8 , struct V_73 * V_74 ,
char * V_75 )
{
struct V_76 * V_77 = F_16 ( V_74 ) ;
int V_78 = V_77 -> V_79 ;
struct V_6 * V_9 = F_5 ( V_8 ) ;
return sprintf ( V_75 , L_3 , F_31 ( V_9 -> V_20 [ V_78 ] ,
V_9 -> V_43 [ V_78 ] ) ) ;
}
...
int V_78 = V_77 -> V_79 ;
struct V_6 * V_9 = F_5 ( V_8 ) ;
return sprintf ( V_75 , L_3 , F_31 ( V_9 -> V_42 [ V_78 ] ,
V_9 -> V_43 [ V_78 ] ) ) ;
}
static T_2 F_33 ( struct V_7 * V_8 , struct V_73 * V_74 ,
const char * V_75 , T_3 V_80 )
{
struct V_76 * V_77 = F_16 ( V_74 ) ;
int V_78 = V_77 -> V_79 ;
...
return V_82 ;
F_7 ( & V_9 -> V_13 ) ;
V_9 -> V_42 [ V_78 ] = F_34 ( V_81 , V_9 -> V_43 [ V_78 ] ) ;
F_3 ( V_2 , F_11 ( V_78 ) ,
V_9 -> V_42 [ V_78 ] ) ;
F_14 ( & V_9 -> V_13 ) ;
return V_80 ;
}
static void F_35 ( struct V_7 * V_8 , int V_20 , int V_86 )
{
struct V_6 * V_9 = F_6 ( V_8 ) ;
struct V_1 * V_2 = V_9 -> V_2 ;
int V_87 ;
int V_88 = V_9 -> V_43 [ V_20 ] ;
if ( V_9 -> V_42 [ V_20 ] == 0 || V_9 -> V_42 [ V_20 ] == 0xff )
return;
V_87 = V_9 -> V_42 [ V_20 ] * V_86 / V_88 ;
V_87 = F_27 ( V_87 , 1 , 254 ) ;
V_9 -> V_42 [ V_20 ] = V_87 ;
F_3 ( V_2 , F_11 ( V_20 ) , V_87 ) ;
}
...
{
struct V_6 * V_9 = F_5 ( V_8 ) ;
return sprintf ( V_75 , L_3 , ( V_9 -> V_62 & V_92 ) >> 4 ) ;
}
...
static T_2 F_61 ( struct V_7 * V_8 ,
struct V_73 * V_74 , char * V_75 )
{
struct V_6 * V_9 = F_5 ( V_8 ) ;
int V_94 = ( V_9 -> V_12 >> 11 ) & 0x1f ;
F_9 ( V_8 , L_4 ) ;
return sprintf ( V_75 , L_3 , F_62 ( V_94 , V_9 -> V_95 ) ) ;
}
static T_2 F_63 ( struct V_7 * V_8 , struct V_73 * V_74 ,
char * V_75 )
{
struct V_6 * V_9 = F_6 ( V_8 ) ;
return sprintf ( V_75 , L_3 , V_9 -> V_95 ) ;
}
...
static T_2 F_65 ( struct V_7 * V_8 , struct V_73 * V_74 ,
char * V_75 )
{
struct V_6 * V_9 = F_5 ( V_8 ) ;
...
{
struct V_6 * V_9 = F_5 ( V_8 ) ;
int V_96 = F_16 ( V_74 ) -> V_79 ;
return sprintf ( V_75 , L_5 , ( V_9 -> V_11 >> V_96 ) & 1 ) ;
}
...
static T_2 F_68 ( struct V_7 * V_8 ,
struct V_73 * V_74 ,
const char * V_75 , T_3 V_80 )
{
struct V_6 * V_9 = F_6 ( V_8 ) ;
...
static T_2 F_71 ( struct V_7 * V_8 ,
struct V_73 * V_74 ,
char * V_75 )
{
struct V_6 * V_9 = F_5 ( V_8 ) ;
...
static T_2 F_72 ( struct V_7 * V_8 ,
struct V_73 * V_74 , const char * V_75 ,
T_3 V_80 )
{
struct V_6 * V_9 = F_6 ( V_8 ) ;
...
V_97 = V_9 -> V_61 ;
F_3 ( V_2 , V_60 , V_97 & 0xff ) ;
V_97 >>= 8 ;
F_3 ( V_2 , V_59 , V_97 & 0xff ) ;
V_97 = ( ( V_97 >> 1 ) & 0x80 ) | ( V_9 -> V_58 >> 24 & 0x7f ) ;
F_3 ( V_2 , V_57 , V_97 & 0xff ) ;
F_14 ( & V_9 -> V_13 ) ;
return V_80 ;
}
...
static T_2 F_82 ( struct V_7 * V_8 ,
struct V_73 * V_74 ,
const char * V_75 , T_3 V_80 )
{
struct V_6 * V_9 = F_6 ( V_8 ) ;
...
V_9 -> V_71 [ V_117 [ V_10 ] ] |= 0x01 ;
if ( V_117 [ V_10 ] >= 0 && V_117 [ V_10 ] <= 7 )
V_9 -> V_67 |= 1 << V_117 [ V_10 ] ;
}
for ( V_10 = 0 ; V_10 <= 16 ; ++ V_10 ) {
if ( V_118 [ V_10 ] >= 0 && V_118 [ V_10 ] <= 16 )
V_9 -> V_71 [ V_118 [ V_10 ] ] &= ~ 0x01 ;
if ( V_118 [ V_10 ] >= 0 && V_118 [ V_10 ] <= 7 )
V_9 -> V_67 |= 1 << V_118 [ V_10 ] ;
}
for ( V_10 = 0 ; V_10 <= 16 ; ++ V_10 ) {
if ( V_119 [ V_10 ] >= 0 && V_119 [ V_10 ] <= 16 )
V_9 -> V_71 [ V_119 [ V_10 ] ] &= ~ 0x02 ;
}
for ( V_10 = 0 ; V_10 <= 16 ; ++ V_10 ) {
if ( V_120 [ V_10 ] >= 0 && V_120 [ V_10 ] <= 16 )
V_9 -> V_71 [ V_120 [ V_10 ] ] |= 0x02 ;
}
for ( V_10 = 0 ; V_10 <= 7 ; ++ V_10 ) {
if ( V_121 [ V_10 ] >= 0 && V_121 [ V_10 ] <= 7 )
V_9 -> V_67 &= ~ ( 1 << V_121 [ V_10 ] ) ;
}
...
struct V_7 * V_130 ;
struct V_6 * V_9 ;
V_9 = F_93 ( V_8 , sizeof( struct V_6 ) , V_131 ) ;
if ( ! V_9 )
return - V_132 ;
F_94 ( V_2 , V_9 ) ;
V_9 -> V_2 = V_2 ;
