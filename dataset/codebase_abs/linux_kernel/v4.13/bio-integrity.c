...
static inline unsigned int F_20 ( struct V_39 * V_40 ,
unsigned int V_41 )
{
return V_41 >> ( V_40 -> V_42 - 9 ) ;
}
static inline unsigned int F_21 ( struct V_39 * V_40 ,
unsigned int V_41 )
{
return F_20 ( V_40 , V_41 ) * V_40 -> V_43 ;
}
static T_2 F_22 ( struct V_3 * V_3 ,
struct V_44 * V_45 , T_3 * V_46 )
{
struct V_39 * V_40 = F_23 ( V_3 -> V_37 ) ;
struct V_47 V_48 ;
struct V_44 V_49 ;
struct V_12 V_50 ;
struct V_2 * V_6 = F_12 ( V_3 ) ;
T_2 V_51 = V_52 ;
void * V_53 = F_14 ( V_6 -> V_16 -> V_28 ) +
V_6 -> V_16 -> V_29 ;
V_48 . V_54 = V_3 -> V_37 -> V_55 -> V_54 ;
V_48 . V_56 = 1 << V_40 -> V_42 ;
V_48 . V_57 = V_45 -> V_58 ;
V_48 . V_53 = V_53 ;
F_24 (bv, bio, bviter, *proc_iter) {
void * V_59 = F_25 ( V_50 . V_28 ) ;
V_48 . V_60 = V_59 + V_50 . V_29 ;
V_48 . V_61 = V_50 . V_38 ;
V_51 = V_46 ( & V_48 ) ;
if ( V_51 ) {
F_26 ( V_59 ) ;
...
V_40 = F_23 ( V_3 -> V_37 ) ;
V_63 = F_19 ( V_3 -> V_37 ) ;
if ( F_28 ( V_3 ) != V_72 && F_28 ( V_3 ) != V_73 )
return true ;
if ( ! F_29 ( V_3 ) )
return true ;
if ( F_12 ( V_3 ) )
...
{
struct V_2 * V_6 =
F_37 ( V_95 , struct V_2 , V_96 ) ;
struct V_3 * V_3 = V_6 -> V_22 ;
struct V_39 * V_40 = F_23 ( V_3 -> V_37 ) ;
struct V_44 V_48 = V_3 -> V_89 ;
if ( F_38 ( V_3 , & V_48 , V_48 . V_97 ) ) {
V_3 -> V_93 = F_22 ( V_3 , & V_48 ,
V_40 -> V_75 -> V_76 ) ;
} else {
V_3 -> V_93 = V_98 ;
}
...
bool F_39 ( struct V_3 * V_3 )
{
struct V_39 * V_40 = F_23 ( V_3 -> V_37 ) ;
struct V_2 * V_6 = F_12 ( V_3 ) ;
if ( F_28 ( V_3 ) == V_72 && ! V_3 -> V_93 &&
( V_6 -> V_26 & V_27 ) && V_40 -> V_75 -> V_76 ) {
F_40 ( & V_6 -> V_96 , F_36 ) ;
F_41 ( V_1 , & V_6 -> V_96 ) ;
return false ;
}
...
void F_42 ( struct V_3 * V_3 , unsigned int V_99 )
{
struct V_2 * V_6 = F_12 ( V_3 ) ;
struct V_39 * V_40 = F_23 ( V_3 -> V_37 ) ;
unsigned V_68 = F_21 ( V_40 , V_99 >> 9 ) ;
V_6 -> V_87 . V_58 += V_99 >> 9 ;
F_43 ( V_6 -> V_16 , & V_6 -> V_87 , V_68 ) ;
}
void F_44 ( struct V_3 * V_3 )
{
struct V_2 * V_6 = F_12 ( V_3 ) ;
struct V_39 * V_40 = F_23 ( V_3 -> V_37 ) ;
V_6 -> V_87 . V_88 = F_21 ( V_40 , F_29 ( V_3 ) ) ;
}
int F_45 ( struct V_3 * V_3 , struct V_3 * V_100 ,
T_1 V_4 )
{
...
int F_48 ( struct V_7 * V_8 , int V_102 )
{
if ( V_8 -> V_11 )
return 0 ;
V_8 -> V_11 = F_49 ( V_102 , V_20 ) ;
if ( ! V_8 -> V_11 )
return - 1 ;
V_8 -> V_17 = F_50 ( V_102 ) ;
if ( ! V_8 -> V_17 ) {
