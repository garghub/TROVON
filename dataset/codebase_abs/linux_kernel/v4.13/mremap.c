...
F_53 ( V_9 -> V_22 , V_34 , V_35 ) ;
return V_28 + V_15 - V_16 ;
}
static unsigned long F_54 ( struct V_8 * V_9 ,
...
if ( V_2 -> V_55 >= V_56 - 3 )
return - V_57 ;
V_54 = F_55 ( V_9 , V_15 , V_15 + V_41 ,
V_58 , & V_48 ) ;
if ( V_54 )
return V_54 ;
V_49 = V_9 -> V_59 + ( ( V_15 - V_9 -> V_60 ) >> V_61 ) ;
V_17 = F_56 ( & V_9 , V_19 , V_42 , V_49 ,
& V_20 ) ;
if ( ! V_17 )
return - V_57 ;
...
V_52 = V_2 -> V_52 ;
F_60 ( V_2 , V_9 -> V_48 , V_42 >> V_61 ) ;
if ( F_57 ( V_9 -> V_48 & V_66 ) )
F_61 ( V_9 ) ;
if ( F_62 ( V_2 , V_15 , V_41 , V_47 ) < 0 ) {
F_63 ( V_51 >> V_61 ) ;
V_51 = 0 ;
}
V_2 -> V_52 = V_52 ;
...
return F_66 ( - V_74 ) ;
if ( V_9 -> V_48 & ( V_75 | V_66 ) )
return F_66 ( - V_73 ) ;
if ( V_9 -> V_48 & V_68 ) {
unsigned long V_43 , V_76 ;
V_43 = V_2 -> V_69 << V_61 ;
V_76 = F_68 ( V_77 ) ;
V_43 += V_42 - V_41 ;
if ( V_43 > V_76 && ! F_69 ( V_78 ) )
return F_66 ( - V_79 ) ;
}
if ( ! F_70 ( V_2 , V_9 -> V_48 ,
( V_42 - V_41 ) >> V_61 ) )
return F_66 ( - V_57 ) ;
if ( V_9 -> V_48 & V_64 ) {
unsigned long V_80 = ( V_42 - V_41 ) >> V_61 ;
if ( F_71 ( V_2 , V_80 ) )
return F_66 ( - V_57 ) ;
* V_70 = V_80 ;
}
...
static unsigned long F_72 ( unsigned long V_3 , unsigned long V_41 ,
...
struct V_1 * V_2 = V_71 -> V_2 ;
struct V_8 * V_9 ;
unsigned long V_82 = - V_74 ;
unsigned long V_80 = 0 ;
unsigned long V_83 ;
if ( F_73 ( V_19 ) )
goto V_84;
if ( V_42 > V_85 || V_19 > V_85 - V_42 )
goto V_84;
if ( V_3 + V_41 > V_19 && V_19 + V_42 > V_3 )
goto V_84;
V_82 = F_62 ( V_2 , V_19 , V_42 , V_81 ) ;
if ( V_82 )
goto V_84;
if ( V_41 >= V_42 ) {
V_82 = F_62 ( V_2 , V_3 + V_42 , V_41 - V_42 , V_47 ) ;
if ( V_82 && V_41 != V_42 )
goto V_84;
V_41 = V_42 ;
}
V_9 = F_64 ( V_3 , V_41 , V_42 , & V_80 ) ;
if ( F_74 ( V_9 ) ) {
V_82 = F_75 ( V_9 ) ;
goto V_84;
}
...
if ( V_9 -> V_48 & V_87 )
V_83 |= V_88 ;
V_82 = F_76 ( V_9 -> V_10 , V_19 , V_42 , V_9 -> V_59 +
( ( V_3 - V_9 -> V_60 ) >> V_61 ) ,
V_83 ) ;
if ( F_73 ( V_82 ) )
goto V_89;
V_82 = F_54 ( V_9 , V_3 , V_41 , V_42 , V_19 , V_43 , V_45 ,
V_47 ) ;
if ( ! ( F_73 ( V_82 ) ) )
goto V_84;
V_89:
...
static int F_77 ( struct V_8 * V_9 , unsigned long V_90 )
{
unsigned long V_91 = V_9 -> V_65 + V_90 ;
if ( V_91 < V_9 -> V_65 )
return 0 ;
if ( V_9 -> V_67 && V_9 -> V_67 -> V_60 < V_91 )
return 0 ;
if ( F_76 ( NULL , V_9 -> V_60 , V_91 - V_9 -> V_60 ,
0 , V_86 ) & ~ V_92 )
return 0 ;
return 1 ;
}
