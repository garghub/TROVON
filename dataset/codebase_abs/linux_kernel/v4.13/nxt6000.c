...
V_20 = F_4 ( V_2 , V_79 ) ;
F_13 ( L_4 , V_20 & 0x01 ) ;
F_13 ( L_5 , ( V_20 >> 1 ) & 0x01 ) ;
V_20 = F_4 ( V_2 , V_80 ) ;
F_13 ( L_6 , ( V_20 >> 7 ) & 0x01 ) ;
switch ( ( V_20 >> 4 ) & 0x07 ) {
case 0x00 :
F_13 ( L_7 ) ;
break;
...
V_20 = F_4 ( V_2 , V_81 ) ;
F_13 ( L_13 , ( V_20 >> 7 ) & 0x01 ) ;
F_13 ( L_14 , ( V_20 >> 6 ) & 0x01 ) ;
F_13 ( L_15 , ( V_20 >> 5 ) & 0x01 ) ;
F_13 ( L_16 , ( V_20 >> 4 ) & 0x01 ) ;
switch ( V_20 & 0x0F ) {
case 0x00 :
F_13 ( L_17 ) ;
break;
...
V_20 = F_4 ( V_2 , V_82 ) ;
F_13 ( L_15 , ( V_20 >> 4 ) & 0x01 ) ;
F_13 ( L_25 , ( V_20 >> 2 ) & 0x01 ? L_26 : L_27 ) ;
switch ( ( V_20 >> 4 ) & 0x03 ) {
case 0x00 :
F_13 ( L_28 ) ;
break;
...
V_20 = F_4 ( V_2 , V_86 ) ;
V_20 = F_4 ( V_2 , V_86 ) ;
F_13 ( L_49 , ( V_20 >> 4 ) & 0x01 ) ;
F_13 ( L_50 ) ;
}
static int F_14 ( struct V_49 * V_50 , enum V_87 * V_88 )
{
T_1 V_89 ;
struct V_1 * V_2 = V_50 -> V_51 ;
* V_88 = 0 ;
...
static int F_20 ( struct V_49 * V_50 , T_3 * V_109 )
{
struct V_1 * V_2 = V_50 -> V_51 ;
* V_109 = F_4 ( V_2 , V_110 ) / 8 ;
return 0 ;
}
static int F_21 ( struct V_49 * V_50 , T_2 * V_111 )
{
struct V_1 * V_2 = V_50 -> V_51 ;
F_1 ( V_2 , V_112 , 0x18 ) ;
...
static int F_22 ( struct V_49 * V_50 , T_3 * V_115 )
{
struct V_1 * V_2 = V_50 -> V_51 ;
* V_115 = ( short ) ( 511 -
( F_4 ( V_2 , V_116 ) +
...
static int F_23 ( struct V_49 * V_50 , struct V_118 * V_119 )
{
V_119 -> V_120 = 500 ;
return 0 ;
}
static int F_24 ( struct V_49 * V_50 , int V_121 )
{
struct V_1 * V_2 = V_50 -> V_51 ;
if ( V_121 ) {
...
struct V_49 * F_25 ( const struct V_123 * V_9 ,
struct V_124 * V_14 )
{
struct V_1 * V_2 = NULL ;
