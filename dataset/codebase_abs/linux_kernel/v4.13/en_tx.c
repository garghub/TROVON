...
{
T_4 V_55 ;
V_66 -> V_79 = F_27 ( F_32 ( V_24 ) -> V_80 ) ;
if ( V_24 -> V_71 ) {
V_55 = F_33 ( V_24 ) + F_34 ( V_24 ) ;
V_11 -> V_74 . V_81 ++ ;
V_11 -> V_74 . V_82 += V_24 -> V_51 - V_55 ;
} else {
V_55 = F_19 ( V_24 ) + F_35 ( V_24 ) ;
V_11 -> V_74 . V_83 ++ ;
V_11 -> V_74 . V_84 += V_24 -> V_51 - V_55 ;
}
* V_78 = V_24 -> V_51 + ( F_32 ( V_24 ) -> V_85 - 1 ) * V_55 ;
return V_55 ;
}
static inline int
F_36 ( struct V_10 * V_11 , struct V_23 * V_24 ,
unsigned char * V_52 , T_4 V_86 ,
struct V_87 * V_88 )
{
T_1 V_89 = 0 ;
T_3 V_19 = 0 ;
int V_14 ;
if ( V_86 ) {
V_89 = F_37 ( V_11 -> V_2 , V_52 , V_86 ,
V_8 ) ;
if ( F_38 ( F_39 ( V_11 -> V_2 , V_89 ) ) )
return - V_90 ;
V_88 -> V_6 = F_40 ( V_89 ) ;
V_88 -> V_91 = V_11 -> V_92 ;
V_88 -> V_93 = F_41 ( V_86 ) ;
...
for ( V_14 = 0 ; V_14 < F_32 ( V_24 ) -> V_94 ; V_14 ++ ) {
struct V_95 * V_96 = & F_32 ( V_24 ) -> V_97 [ V_14 ] ;
int V_98 = F_42 ( V_96 ) ;
V_89 = F_43 ( V_11 -> V_2 , V_96 , 0 , V_98 ,
V_8 ) ;
if ( F_38 ( F_39 ( V_11 -> V_2 , V_89 ) ) )
return - V_90 ;
V_88 -> V_6 = F_40 ( V_89 ) ;
...
V_102 -> V_78 = V_78 ;
V_102 -> V_19 = V_19 ;
V_102 -> V_108 = F_45 ( V_100 , V_109 ) ;
V_102 -> V_24 = V_24 ;
V_104 -> V_110 = F_41 ( ( V_11 -> V_111 << 8 ) | V_99 ) ;
V_104 -> V_112 = F_41 ( ( V_11 -> V_113 << 8 ) | V_100 ) ;
F_46 ( V_11 -> V_114 , V_78 ) ;
if ( F_38 ( F_32 ( V_24 ) -> V_115 & V_116 ) )
F_32 ( V_24 ) -> V_115 |= V_117 ;
V_11 -> V_111 += V_102 -> V_108 ;
if ( F_38 ( ! F_47 ( V_106 , V_11 -> V_118 , V_11 -> V_111 , V_119 ) ) ) {
F_48 ( V_11 -> V_114 ) ;
V_11 -> V_74 . V_120 ++ ;
}
if ( ! V_24 -> V_121 || F_49 ( V_11 -> V_114 ) )
F_50 ( V_106 , V_11 -> V_111 , V_11 -> V_122 , V_104 ) ;
while ( ( V_107 = ( V_11 -> V_111 & V_106 -> V_123 ) ) > V_11 -> V_124 ) {
V_11 -> V_17 . V_125 [ V_107 ] . V_24 = NULL ;
F_51 ( V_106 , V_11 -> V_113 , & V_11 -> V_111 ) ;
V_11 -> V_74 . V_126 ++ ;
}
}
static T_6 F_52 ( struct V_10 * V_11 , struct V_23 * V_24 ,
struct V_127 * V_128 , T_4 V_107 )
{
...
if ( F_53 ( V_24 ) ) {
V_99 = V_132 ;
V_55 = F_31 ( V_11 , V_24 , V_66 , & V_78 ) ;
V_11 -> V_74 . V_133 += F_32 ( V_24 ) -> V_85 ;
} else {
...
if ( V_55 ) {
if ( F_11 ( V_24 ) ) {
F_26 ( V_66 -> V_137 . V_54 , V_24 , V_55 , & V_52 , & V_53 ) ;
V_55 += V_48 ;
} else {
memcpy ( V_66 -> V_137 . V_54 , V_52 , V_55 ) ;
F_25 ( & V_52 , & V_53 , V_55 ) ;
}
V_66 -> V_137 . V_138 = F_27 ( V_55 ) ;
V_100 += F_45 ( V_55 - sizeof( V_66 -> V_137 . V_54 ) , V_136 ) ;
} else if ( F_11 ( V_24 ) ) {
V_66 -> V_139 . type = F_27 ( V_140 ) ;
V_66 -> V_139 . V_32 = F_27 ( F_28 ( V_24 ) ) ;
}
V_86 = V_53 - V_24 -> V_141 ;
V_19 = F_36 ( V_11 , V_24 , V_52 , V_86 ,
(struct V_87 * ) V_104 + V_100 ) ;
if ( F_38 ( V_19 < 0 ) )
goto V_142;
F_44 ( V_11 , V_24 , V_99 , V_100 + V_19 ,
...
struct V_127 * V_128 = F_58 ( V_106 , V_107 ) ;
memset ( V_128 , 0 , sizeof( * V_128 ) ) ;
#ifdef F_59
if ( V_11 -> V_146 & F_60 ( V_147 ) ) {
V_24 = F_61 ( V_22 , V_128 , V_24 ) ;
if ( F_38 ( ! V_24 ) )
return V_143 ;
}
#endif
return F_52 ( V_11 , V_24 , V_128 , V_107 ) ;
}
bool F_62 ( struct V_148 * V_149 , int V_150 )
{
struct V_10 * V_11 ;
T_2 V_151 ;
T_2 V_152 ;
...
T_4 V_154 ;
int V_14 ;
V_11 = F_63 ( V_149 , struct V_10 , V_149 ) ;
if ( F_38 ( ! F_64 ( V_155 , & V_11 -> V_146 ) ) )
return false ;
V_153 = 0 ;
V_152 = 0 ;
V_154 = V_11 -> V_118 ;
...
int V_162 ;
V_160 = ( V_154 == V_159 ) ;
V_161 = V_154 & V_11 -> V_106 . V_123 ;
V_102 = & V_11 -> V_17 . V_125 [ V_161 ] ;
V_24 = V_102 -> V_24 ;
if ( F_38 ( ! V_24 ) ) {
V_154 ++ ;
continue;
}
if ( F_38 ( F_32 ( V_24 ) -> V_115 &
V_116 ) ) {
struct V_163 V_164 = {} ;
F_68 ( V_11 -> V_165 ,
F_69 ( V_158 ) , & V_164 ) ;
...
for ( V_162 = 0 ; V_162 < V_102 -> V_19 ; V_162 ++ ) {
struct V_3 * V_4 =
F_6 ( V_11 , V_151 ++ ) ;
F_1 ( V_11 -> V_2 , V_4 ) ;
}
...
V_11 -> V_151 = V_151 ;
V_11 -> V_118 = V_154 ;
F_74 ( V_11 -> V_114 , V_153 , V_152 ) ;
if ( F_75 ( V_11 -> V_114 ) &&
F_47 ( & V_11 -> V_106 , V_11 -> V_118 , V_11 -> V_111 , V_119 ) ) {
F_76 ( V_11 -> V_114 ) ;
V_11 -> V_74 . V_166 ++ ;
}
return ( V_14 == V_156 ) ;
...
V_161 = V_11 -> V_118 & V_11 -> V_106 . V_123 ;
V_102 = & V_11 -> V_17 . V_125 [ V_161 ] ;
V_24 = V_102 -> V_24 ;
if ( ! V_24 ) {
V_11 -> V_118 ++ ;
...
static inline void
F_78 ( struct V_167 * V_168 , T_2 V_169 , T_2 V_170 ,
struct V_171 * V_88 )
{
memcpy ( & V_88 -> V_168 , V_168 , sizeof( struct V_167 ) ) ;
V_88 -> V_168 . V_172 = F_41 ( V_169 | V_173 ) ;
V_88 -> V_168 . V_174 . V_175 . V_175 = F_41 ( V_170 ) ;
}
T_6 F_79 ( struct V_10 * V_11 , struct V_23 * V_24 ,
struct V_167 * V_168 , T_2 V_169 , T_2 V_170 )
{
struct V_105 * V_106 = & V_11 -> V_106 ;
T_4 V_107 = V_11 -> V_111 & V_106 -> V_123 ;
struct V_176 * V_128 = F_58 ( V_106 , V_107 ) ;
struct V_101 * V_102 = & V_11 -> V_17 . V_125 [ V_107 ] ;
struct V_103 * V_104 = & V_128 -> V_129 ;
struct V_171 * V_177 = & V_128 -> V_177 ;
struct V_65 * V_66 = & V_128 -> V_130 ;
unsigned char * V_52 = V_24 -> V_46 ;
unsigned int V_53 = V_24 -> V_51 ;
T_3 V_99 = V_131 ;
