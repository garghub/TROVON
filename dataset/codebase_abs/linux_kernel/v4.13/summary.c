...
V_78 -> V_90 = F_27 ( V_2 , V_62 , F_12 ( V_87 -> V_42 ) | V_85 ,
F_35 ( F_12 ( V_87 -> V_43 ) ) , V_73 ) ;
V_78 -> V_17 = NULL ;
V_78 -> V_32 = F_12 ( V_87 -> V_32 ) ;
V_78 -> V_27 = F_12 ( V_87 -> V_27 ) ;
V_78 -> V_91 = F_40 ( NULL , V_78 -> V_48 , V_88 ) ;
V_78 -> type = V_87 -> type ;
F_41 ( V_2 , V_78 , & V_73 -> V_92 ) ;
* V_76 += F_12 ( V_87 -> V_32 ) ;
V_79 += F_13 ( V_87 -> V_26 ) ;
break;
}
...
struct V_93 * V_94 ;
struct V_95 * V_96 ;
V_96 = (struct V_95 * ) V_79 ;
F_7 ( L_24 ,
V_62 -> V_42 + F_12 ( V_96 -> V_42 ) ,
V_62 -> V_42 + F_12 ( V_96 -> V_42 ) + F_12 ( V_96 -> V_43 ) ,
F_12 ( V_96 -> V_31 ) , F_12 ( V_96 -> V_32 ) ) ;
V_94 = F_42 ( V_2 , F_12 ( V_96 -> V_31 ) ,
F_12 ( V_96 -> V_32 ) ) ;
if ( F_43 ( V_94 ) )
return F_44 ( V_94 ) ;
if ( V_94 -> V_32 > F_12 ( V_96 -> V_32 ) ) {
struct V_70 * V_90
= F_27 ( V_2 , V_62 , F_12 ( V_96 -> V_42 ) | V_85 ,
F_35 ( F_12 ( V_96 -> V_43 ) ) , NULL ) ;
V_90 -> V_97 = V_94 -> V_60 -> V_97 ;
V_94 -> V_60 -> V_97 = V_90 ;
} else {
V_94 -> V_32 = F_12 ( V_96 -> V_32 ) ;
F_27 ( V_2 , V_62 , F_12 ( V_96 -> V_42 ) | V_85 ,
F_35 ( F_12 ( V_96 -> V_43 ) ) , ( void * ) V_94 ) ;
}
* V_76 += F_12 ( V_96 -> V_31 ) ;
V_79 += V_29 ;
break;
...
struct V_98 * V_99 ;
struct V_100 * V_101 ;
V_101 = (struct V_100 * ) V_79 ;
F_7 ( L_25 ,
V_62 -> V_42 + F_12 ( V_101 -> V_42 ) ,
V_62 -> V_42 + F_12 ( V_101 -> V_42 ) +
...
V_99 -> V_17 = V_2 -> V_102 ;
V_2 -> V_102 = V_99 ;
F_27 ( V_2 , V_62 , F_12 ( V_101 -> V_42 ) | V_85 ,
F_35 ( sizeof( struct V_52 ) ) , ( void * ) V_99 ) ;
* V_76 += V_99 -> V_60 -> V_103 ;
V_79 += V_34 ;
break;
}
#endif
...
V_39 = V_2 -> V_4 - V_110 ;
F_7 ( L_28 ,
V_62 -> V_42 , V_62 -> V_42 + V_39 , V_110 ) ;
V_112 . V_115 = F_48 ( V_116 ) ;
V_112 . V_18 = F_48 ( V_69 ) ;
V_112 . V_43 = V_6 -> V_43 ;
V_114 = F_49 ( 0 , & V_112 , sizeof( V_112 ) - 4 ) ;
if ( F_12 ( V_6 -> V_117 ) != V_114 ) {
F_7 ( L_29
L_30 ) ;
goto V_118;
}
if ( F_12 ( V_6 -> V_43 ) != V_110 ) {
F_7 ( L_31 ) ;
goto V_118;
}
V_114 = F_49 ( 0 , V_6 , sizeof( struct V_75 ) - 8 ) ;
if ( F_12 ( V_6 -> V_119 ) != V_114 ) {
F_7 ( L_32 ) ;
goto V_118;
}
V_114 = F_49 ( 0 , V_6 -> V_81 , V_110 - sizeof( struct V_75 ) ) ;
if ( F_12 ( V_6 -> V_120 ) != V_114 ) {
F_7 ( L_33 ) ;
goto V_118;
}
if ( F_12 ( V_6 -> V_121 ) ) {
F_7 ( L_34 ) ;
V_113 = F_32 ( V_2 , V_62 , 1 ) ;
if ( V_113 )
return V_113 ;
if ( F_12 ( V_6 -> V_121 ) != V_2 -> V_122 ) {
F_7 ( L_35 ,
F_12 ( V_6 -> V_121 ) , V_2 -> V_122 ) ;
if ( ( V_113 = F_28 ( V_2 , V_62 , F_35 ( F_12 ( V_6 -> V_121 ) ) ) ) )
return V_113 ;
} else if ( V_62 -> V_123 ) {
F_7 ( L_36
L_37 , V_62 -> V_42 ) ;
...
F_29 ( V_2 , V_62 , V_62 -> V_42 | V_124 ,
F_12 ( V_6 -> V_121 ) , NULL ) ;
}
}
V_113 = F_30 ( V_2 , V_62 , V_6 , V_76 ) ;
if ( V_113 == - V_109 )
return 0 ;
if ( V_113 )
return V_113 ;
V_113 = F_32 ( V_2 , V_62 , 2 ) ;
if ( V_113 )
return V_113 ;
F_27 ( V_2 , V_62 , V_39 | V_124 , V_110 , NULL ) ;
if ( F_50 ( V_62 -> V_74 ) ) {
F_4 ( L_38 ,
V_62 -> V_74 , V_62 -> V_42 ) ;
V_62 -> V_106 += V_62 -> V_74 ;
V_2 -> V_106 += V_62 -> V_74 ;
V_2 -> V_74 -= V_62 -> V_74 ;
V_62 -> V_74 = 0 ;
}
...
memset ( V_2 -> V_6 -> V_10 , 0xff , V_126 ) ;
memset ( & V_128 , 0 , sizeof( V_128 ) ) ;
V_128 . V_115 = F_48 ( V_116 ) ;
V_128 . V_18 = F_48 ( V_69 ) ;
V_128 . V_43 = F_17 ( V_125 ) ;
V_128 . V_117 = F_17 ( F_49 ( 0 , & V_128 , sizeof( struct V_111 ) - 4 ) ) ;
V_128 . V_135 = F_17 ( V_2 -> V_6 -> V_36 ) ;
V_128 . V_121 = F_17 ( V_2 -> V_122 ) ;
V_128 . V_21 = F_17 ( V_2 -> V_6 -> V_21 ) ;
V_133 = V_2 -> V_6 -> V_10 ;
while ( V_2 -> V_6 -> V_21 ) {
V_41 = V_2 -> V_6 -> V_14 ;
switch ( F_11 ( V_41 -> V_16 . V_18 ) ) {
case V_19 : {
struct V_83 * V_136 = V_133 ;
V_136 -> V_18 = V_41 -> V_22 . V_18 ;
V_136 -> V_23 = V_41 -> V_22 . V_23 ;
V_136 -> V_32 = V_41 -> V_22 . V_32 ;
V_136 -> V_42 = V_41 -> V_22 . V_42 ;
V_136 -> V_43 = V_41 -> V_22 . V_43 ;
V_133 += V_20 ;
break;
}
case V_24 : {
struct V_86 * V_137 = V_133 ;
V_137 -> V_18 = V_41 -> V_25 . V_18 ;
V_137 -> V_43 = V_41 -> V_25 . V_43 ;
V_137 -> V_42 = V_41 -> V_25 . V_42 ;
V_137 -> V_47 = V_41 -> V_25 . V_47 ;
V_137 -> V_32 = V_41 -> V_25 . V_32 ;
V_137 -> V_27 = V_41 -> V_25 . V_27 ;
V_137 -> V_26 = V_41 -> V_25 . V_26 ;
V_137 -> type = V_41 -> V_25 . type ;
memcpy ( V_137 -> V_48 , V_41 -> V_25 . V_48 ,
V_41 -> V_25 . V_26 ) ;
V_133 += F_13 ( V_41 -> V_25 . V_26 ) ;
break;
}
#ifdef F_14
case V_28 : {
struct V_95 * V_138 = V_133 ;
V_41 = V_2 -> V_6 -> V_14 ;
V_138 -> V_18 = V_41 -> V_30 . V_18 ;
V_138 -> V_31 = V_41 -> V_30 . V_31 ;
V_138 -> V_32 = V_41 -> V_30 . V_32 ;
V_138 -> V_42 = V_41 -> V_30 . V_42 ;
V_138 -> V_43 = V_41 -> V_30 . V_43 ;
V_133 += V_29 ;
break;
}
case V_33 : {
struct V_100 * V_139 = V_133 ;
V_41 = V_2 -> V_6 -> V_14 ;
V_139 -> V_18 = V_41 -> V_66 . V_18 ;
V_139 -> V_42 = V_41 -> V_66 . V_42 ;
V_133 += V_34 ;
break;
}
#endif
default : {
if ( ( F_11 ( V_41 -> V_16 . V_18 ) & V_104 )
== V_140 ) {
F_7 ( L_42 ,
F_11 ( V_41 -> V_16 . V_18 ) ) ;
F_9 ( V_2 -> V_6 ) ;
...
V_133 += V_127 ;
V_130 = V_133 ;
V_130 -> V_42 = F_17 ( V_2 -> V_4 - V_62 -> V_74 ) ;
V_130 -> V_115 = F_17 ( V_141 ) ;
V_128 . V_120 = F_17 ( F_49 ( 0 , V_2 -> V_6 -> V_10 , V_126 ) ) ;
V_128 . V_119 = F_17 ( F_49 ( 0 , & V_128 , sizeof( V_128 ) - 8 ) ) ;
V_131 [ 0 ] . V_63 = & V_128 ;
V_131 [ 0 ] . V_142 = sizeof( V_128 ) ;
V_131 [ 1 ] . V_63 = V_2 -> V_6 -> V_10 ;
V_131 [ 1 ] . V_142 = V_126 ;
V_132 = V_62 -> V_42 + V_2 -> V_4 - V_62 -> V_74 ;
F_7 ( L_43 , V_132 ) ;
V_113 = F_53 ( V_2 , V_131 , 2 , V_132 , & V_134 , 0 ) ;
if ( V_113 || ( V_134 != V_125 ) ) {
F_4 ( L_44 ,
V_125 , V_132 , V_113 , V_134 ) ;
if ( V_134 ) {
F_54 ( & V_2 -> V_143 ) ;
F_29 ( V_2 , V_62 , V_132 | V_144 , V_125 , NULL ) ;
F_55 ( & V_2 -> V_143 ) ;
}
V_2 -> V_6 -> V_3 = V_55 ;
return 0 ;
...
F_54 ( & V_2 -> V_143 ) ;
F_29 ( V_2 , V_62 , V_132 | V_124 , V_125 , NULL ) ;
F_55 ( & V_2 -> V_143 ) ;
return 0 ;
}
