...
F_20 ( 0x83 , 0xC0 , 0x01 ) ;
F_29 ( 0x89 , 0x85 , 36 ) ;
F_31 ( 0x48 , 0x8D , 0x84 , 0xD6 ,
F_27 ( struct V_40 , V_46 ) ) ;
F_20 ( 0x48 , 0x8B , 0x00 ) ;
F_23 ( 0x48 , 0x83 , 0xF8 , 0x00 ) ;
#define F_32 10
F_24 ( V_47 , F_32 ) ;
V_39 = V_34 ;
F_23 ( 0x48 , 0x8B , 0x40 ,
...
goto V_141;
case V_93 | V_142 | V_9 :
V_80 = F_44 ( V_71 , V_143 ) ;
goto V_141;
case V_93 | V_139 | V_10 :
V_80 = V_144 ;
goto V_141;
case V_93 | V_142 | V_10 :
V_80 = F_44 ( V_71 , V_144 ) ;
goto V_141;
case V_120 | V_145 :
if ( V_64 ) {
...
V_53 = F_50 ( V_33 -> V_3 * sizeof( * V_53 ) , V_153 ) ;
if ( ! V_53 ) {
V_33 = V_149 ;
goto V_154;
}
...
V_57 . V_99 = V_69 ;
for ( V_151 = 0 ; V_151 < 10 || V_54 ; V_151 ++ ) {
...
if ( V_152 > 1 )
F_53 ( V_33 -> V_3 , V_69 , V_151 + 1 , V_54 ) ;
if ( V_54 ) {
F_6 ( V_147 , V_54 + V_69 ) ;
F_54 ( V_147 ) ;
V_33 -> V_49 = ( void * ) V_54 ;
