...
V_12 -> V_51 . V_80 = V_63 << V_75 ;
V_58 -= V_63 ;
} else if ( V_53 == V_71 ) {
V_28 -> V_40 ( V_28 , & V_29 , & V_31 , & V_32 ) ;
F_52 ( V_12 , V_29 , V_62 , V_32 ) ;
V_63 = F_48 ( V_49 , V_65 , V_58 ) ;
V_12 -> V_51 . V_80 = V_63 << V_75 ;
V_32 = 0 ;
V_58 -= V_63 ;
...
V_28 -> V_40 ( V_28 , & V_29 , & V_31 , & V_32 ) ;
V_31 = F_53 ( V_31 , F_54 ( V_58 ) ) ;
if ( ! F_52 ( V_12 , V_29 , V_31 , V_32 ) )
break;
V_32 = 0 ;
V_58 -= F_55 ( V_31 ) ;
V_28 -> V_41 ( V_28 ) ;
...
static void F_57 ( int V_53 , int V_54 , unsigned int V_81 ,
struct V_55 * V_56 , struct V_27 * V_28 ,
struct V_13 * V_13 , int V_82 )
{
int V_83 ;
struct V_27 V_84 = * V_28 ;
F_58 ( V_81 > V_15 ) ;
if ( V_82 )
V_54 |= V_85 ;
for ( V_83 = 0 ; V_83 < V_81 ; V_83 ++ ) {
* V_28 = V_84 ;
if ( V_56 [ V_83 ] . V_24 || ( V_54 & V_86 ) )
F_44 ( V_53 , V_54 , V_83 , V_56 + V_83 , V_28 , V_13 ) ;
}
F_20 ( V_13 , 0 , 0 ) ;
}
static void F_59 ( unsigned long error , void * V_21 )
{
struct V_87 * V_88 = V_21 ;
V_88 -> V_18 = error ;
F_60 ( & V_88 -> V_89 ) ;
}
static int V_87 ( struct V_1 * V_2 , unsigned int V_81 ,
...
V_13 -> V_23 = V_28 -> V_23 ;
V_13 -> V_22 = V_28 -> V_22 ;
F_57 ( V_53 , V_54 , V_81 , V_56 , V_28 , V_13 , 1 ) ;
F_66 ( & V_88 . V_89 ) ;
if ( V_18 )
* V_18 = V_88 . V_18 ;
return V_88 . V_18 ? - V_90 : 0 ;
}
static int F_67 ( struct V_1 * V_2 , unsigned int V_81 ,
struct V_55 * V_56 , int V_53 , int V_54 ,
...
V_13 -> V_23 = V_28 -> V_23 ;
V_13 -> V_22 = V_28 -> V_22 ;
F_57 ( V_53 , V_54 , V_81 , V_56 , V_28 , V_13 , 0 ) ;
return 0 ;
}
static int F_68 ( struct V_91 * V_92 , struct V_27 * V_28 ,
unsigned long V_93 )
{
V_28 -> V_23 = NULL ;
V_28 -> V_22 = 0 ;
switch ( V_92 -> V_94 . type ) {
case V_95 :
F_29 ( V_28 , V_92 -> V_94 . V_96 . V_36 , V_92 -> V_94 . V_32 ) ;
break;
case V_97 :
F_34 ( V_28 , V_92 -> V_94 . V_96 . V_12 ) ;
break;
case V_98 :
F_69 ( V_92 -> V_94 . V_96 . V_99 , V_93 ) ;
if ( V_92 -> V_100 == V_101 ) {
V_28 -> V_23 = V_92 -> V_94 . V_96 . V_99 ;
V_28 -> V_22 = V_93 ;
}
F_38 ( V_28 , V_92 -> V_94 . V_96 . V_99 ) ;
break;
case V_102 :
F_43 ( V_28 , V_92 -> V_94 . V_96 . V_103 ) ;
break;
default:
return - V_104 ;
}
...
int F_70 ( struct V_91 * V_92 , unsigned V_81 ,
struct V_55 * V_56 , unsigned long * V_105 )
{
int V_106 ;
struct V_27 V_28 ;
V_106 = F_68 ( V_92 , & V_28 , ( unsigned long ) V_56 -> V_24 << V_75 ) ;
if ( V_106 )
return V_106 ;
if ( ! V_92 -> V_107 . V_19 )
return V_87 ( V_92 -> V_2 , V_81 , V_56 ,
V_92 -> V_100 , V_92 -> V_108 , & V_28 ,
V_105 ) ;
return F_67 ( V_92 -> V_2 , V_81 , V_56 , V_92 -> V_100 ,
V_92 -> V_108 , & V_28 , V_92 -> V_107 . V_19 ,
V_92 -> V_107 . V_21 ) ;
}
int T_3 F_71 ( void )
{
