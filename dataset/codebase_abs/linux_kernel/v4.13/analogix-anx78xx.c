...
static T_3 F_78 ( int V_211 , void * V_212 )
{
...
static int F_79 ( struct V_1 * V_1 , T_1 V_211 )
{
int V_12 ;
F_44 ( L_37 , V_211 ) ;
V_12 = F_15 ( V_1 -> V_8 [ V_50 ] , V_214 ,
V_211 ) ;
if ( V_12 )
return V_12 ;
if ( V_211 & V_124 ) {
...
static bool F_80 ( struct V_1 * V_1 , T_1 V_211 )
{
bool V_215 = false ;
int V_12 ;
F_44 ( L_39 , V_211 ) ;
...
static void F_82 ( struct V_1 * V_1 , T_1 V_211 )
{
unsigned int V_11 ;
int V_12 ;
F_44 ( L_43 , V_211 ) ;
V_12 = F_15 ( V_1 -> V_8 [ V_47 ] , V_217 ,
V_211 ) ;
if ( V_12 ) {
F_12 ( L_44 , V_12 ) ;
return;
}
if ( ( V_211 & V_126 ) || ( V_211 & V_127 ) ) {
F_44 ( L_45 ) ;
V_12 = F_8 ( V_1 -> V_8 [ V_47 ] ,
V_218 , & V_11 ) ;
if ( V_12 ) {
...
static T_3 F_83 ( int V_221 , void * V_212 )
{
struct V_1 * V_1 = V_212 ;
bool V_215 = false ;
unsigned int V_211 ;
...
if ( V_211 )
V_215 = F_80 ( V_1 , V_211 ) ;
if ( ! V_1 -> V_130 )
goto V_187;
V_12 = F_8 ( V_1 -> V_8 [ V_47 ] , V_217 ,
& V_211 ) ;
if ( V_12 ) {
F_12 ( L_52 , V_12 ) ;
goto V_187;
...
{
unsigned int V_222 ;
for ( V_222 = 0 ; V_222 < F_25 ( V_1 -> V_223 ) ; V_222 ++ )
if ( V_1 -> V_223 [ V_222 ] )
F_86 ( V_1 -> V_223 [ V_222 ] ) ;
}
static int F_87 ( struct V_224 * V_144 ,
const struct V_225 * V_226 )
{
struct V_1 * V_1 ;
struct V_128 * V_129 ;
unsigned int V_222 , V_227 , V_228 , V_229 ;
bool V_230 = false ;
int V_12 ;
V_1 = F_88 ( & V_144 -> V_143 , sizeof( * V_1 ) , V_231 ) ;
if ( ! V_1 )
return - V_232 ;
V_129 = & V_1 -> V_129 ;
F_89 ( & V_1 -> V_186 ) ;
#if F_90 ( V_233 )
V_1 -> V_6 . V_234 = V_144 -> V_143 . V_234 ;
#endif
V_1 -> V_144 = V_144 ;
F_91 ( V_144 , V_1 ) ;
V_12 = F_36 ( V_1 ) ;
...
V_129 -> V_235 = F_92 ( V_129 -> V_145 ) ;
if ( V_129 -> V_235 < 0 ) {
F_12 ( L_54 , V_129 -> V_235 ) ;
return - V_194 ;
}
V_129 -> V_236 = V_144 -> V_211 ;
if ( ! V_129 -> V_236 ) {
F_12 ( L_55 ) ;
return - V_194 ;
}
for ( V_222 = 0 ; V_222 < V_237 ; V_222 ++ ) {
V_1 -> V_223 [ V_222 ] = F_93 ( V_144 -> V_238 ,
V_239 [ V_222 ] >> 1 ) ;
if ( ! V_1 -> V_223 [ V_222 ] ) {
V_12 = - V_232 ;
F_12 ( L_56 ,
...
V_1 -> V_8 [ V_222 ] = F_94 ( V_1 -> V_223 [ V_222 ] ,
& V_241 ) ;
if ( F_38 ( V_1 -> V_8 [ V_222 ] ) ) {
V_12 = F_39 ( V_1 -> V_8 [ V_222 ] ) ;
F_12 ( L_57 ,
V_239 [ V_222 ] ) ;
goto V_240;
}
...
if ( V_12 )
goto V_141;
V_12 = F_8 ( V_1 -> V_8 [ V_50 ] , V_243 ,
& V_228 ) ;
if ( V_12 )
goto V_141;
V_1 -> V_244 = ( T_1 ) V_227 | ( ( T_1 ) V_228 << 8 ) ;
V_12 = F_8 ( V_1 -> V_8 [ V_50 ] , V_245 ,
& V_229 ) ;
if ( V_12 )
goto V_141;
for ( V_222 = 0 ; V_222 < F_25 ( V_246 ) ; V_222 ++ ) {
if ( V_1 -> V_244 == V_246 [ V_222 ] ) {
F_95 ( L_58 ,
V_1 -> V_244 , V_229 ) ;
V_230 = true ;
break;
...
V_12 = F_96 ( & V_144 -> V_143 , V_129 -> V_235 , NULL ,
F_78 ,
V_247 | V_248 ,
L_60 , V_1 ) ;
if ( V_12 ) {
...
V_12 = F_96 ( & V_144 -> V_143 , V_129 -> V_236 , NULL ,
F_83 ,
V_247 | V_248 ,
L_62 , V_1 ) ;
if ( V_12 ) {
...
static int F_98 ( struct V_224 * V_144 )
{
struct V_1 * V_1 = F_99 ( V_144 ) ;
F_100 ( & V_1 -> V_6 ) ;
F_85 ( V_1 ) ;
F_81 ( V_1 -> V_185 ) ;
return 0 ;
