...
struct V_165 * V_166 = V_159 -> V_25 . V_167 ;
struct V_168 * V_25 = & V_159 -> V_25 ;
struct V_1 * V_2 ;
struct V_169 * V_170 ;
struct V_32 * V_33 ;
struct V_171 * V_152 ;
int V_105 , V_31 = 0 ;
V_2 = F_56 ( V_25 , sizeof( * V_2 ) , V_172 ) ;
if ( ! V_2 )
return - V_150 ;
V_2 -> V_173 = F_57 ( V_25 -> V_167 ) ;
if ( ! V_2 -> V_173 || V_2 -> V_173 > V_174 )
return - V_175 ;
V_2 -> V_25 = V_25 ;
V_2 -> V_3 = F_58 ( V_25 ) ;
if ( ! V_2 -> V_3 )
return - V_175 ;
F_59 ( V_159 , V_2 ) ;
V_170 = F_60 ( V_159 , V_176 , L_12 ) ;
V_2 -> V_14 = F_61 ( V_25 , V_170 ) ;
if ( F_62 ( V_2 -> V_14 ) )
return F_63 ( V_2 -> V_14 ) ;
V_2 -> V_11 = F_64 ( V_166 , L_13 ) ;
V_170 = F_60 ( V_159 , V_176 ,
L_14 ) ;
if ( ! F_65 ( V_25 , V_170 -> V_177 , F_66 ( V_170 ) ,
V_170 -> V_178 ) ) {
F_23 ( V_25 , L_15 , V_170 ) ;
return - V_179 ;
}
V_2 -> V_84 = V_170 -> V_177 ;
...
V_33 -> V_188 = F_51 ;
V_33 -> V_189 = F_54 ;
V_105 = F_74 ( V_166 , L_22 ,
& V_2 -> V_142 ) ;
if ( V_105 < 0 )
goto V_190;
F_43 ( V_2 , V_33 ) ;
V_105 = F_75 ( V_33 , NULL , & V_161 ) ;
if ( V_105 )
goto V_190;
...
goto V_190;
if ( V_2 -> V_109 == 0 ) {
V_2 -> V_109 = V_152 -> V_191 ;
F_32 ( V_2 ) ;
}
if ( V_33 -> V_192 > V_2 -> V_3 -> V_193 )
V_33 -> V_192 = V_2 -> V_3 -> V_193 ;
V_31 ++ ;
}
V_105 = F_42 ( V_2 ) ;
if ( V_105 )
...
return 0 ;
V_194:
for ( V_31 = 0 ; V_31 < V_2 -> V_173 ; V_31 ++ ) {
if ( ! V_2 -> V_182 )
V_31 *= 2 ;
...
static int F_81 ( struct V_158 * V_159 , T_9 V_195 )
{
return 0 ;
}
