...
{
V_2 -> V_4 =
F_117 ( sizeof( struct V_212 ) , V_138 ) ;
if ( V_2 -> V_4 == NULL )
return ( V_139 ) ;
V_2 -> V_4 -> V_194 = V_213 ;
F_118 ( V_2 ) ;
...
F_120 ( V_2 -> V_4 -> V_194 , V_2 ) ;
if ( V_2 -> V_10 [ 0 ] == V_215
&& V_2 -> V_12 [ 0 ] . V_14 != 0 )
F_121 ( V_2 -> V_12 [ 0 ] . V_14 , 256 ) ;
if ( V_2 -> V_10 [ 1 ] == V_215
&& V_2 -> V_12 [ 1 ] . V_14 != 0 )
F_121 ( V_2 -> V_12 [ 1 ] . V_14 , 256 ) ;
if ( V_2 -> V_10 [ 0 ] == V_11
&& V_2 -> V_12 [ 0 ] . V_13 != NULL ) {
F_122 ( V_2 -> V_12 [ 0 ] . V_13 ) ;
F_123 ( V_2 -> V_4 -> V_216 ,
0x1000 ) ;
}
if ( V_2 -> V_4 -> V_5 )
...
F_125 ( V_2 , V_218 -> V_219 ) ;
if ( V_218 -> V_221 != V_222 )
F_126 ( V_2 , V_218 -> V_221 ) ;
if ( V_218 -> V_223 != V_224 )
F_127 ( V_2 , V_218 -> V_223 ) ;
}
}
void
F_128 ( struct V_1 * V_2 , struct V_3 * V_3 )
{
F_129 ( V_2 , F_4 ( V_2 , V_3 ) ,
F_3 ( V_2 , V_3 ) ,
F_5 ( V_3 ) , V_225 ,
V_226 , V_227 ) ;
}
void
F_130 ( struct V_1 * V_2 , struct V_71 * V_72 ,
...
int
F_129 ( struct V_1 * V_2 , int V_240 , char V_55 ,
int V_105 , T_6 V_241 , T_17 V_242 , T_3 V_243 )
{
return 0 ;
}
static T_6
F_131 ( struct V_1 * V_2 , struct V_49 * V_50 )
{
static int V_244 ;
T_6 V_10 ;
V_10 = 0 ;
if ( ( V_2 -> V_245 & V_50 -> V_246 ) != 0 ) {
...
T_18 * V_247 ;
V_247 = & V_158 [ V_2 -> V_202 ] ;
V_10 = V_247 -> V_160 [ V_50 -> V_248 ] ;
if ( V_10 > V_189 )
V_10 = V_189 ;
}
}
...
V_68 ) ;
V_10 = F_131 ( V_2 , & V_50 ) ;
if ( V_10 != 0 && V_72 -> V_249 != 0 ) {
F_130 ( V_2 , V_72 , & V_50 , V_235 ) ;
F_133 ( V_2 , V_50 . V_55 , V_50 . V_240 ,
V_50 . V_105 , V_250 ) ;
F_134 ( V_2 , & V_50 ) ;
F_2 ( L_47 , V_10 ) ;
} else {
F_130 ( V_2 , V_72 , & V_50 , V_233 ) ;
F_133 ( V_2 , V_50 . V_55 , V_50 . V_240 ,
V_50 . V_105 , V_250 ) ;
}
}
...
V_252 = F_136 ( V_25 -> V_37 -> V_57 ,
V_25 -> V_37 -> V_105 ) ;
}
if ( ( V_3 = F_72 ( V_2 , V_252 ) ) == NULL ) {
V_2 -> V_47 |= V_255 ;
F_53 ( V_2 , & V_47 ) ;
F_31 ( V_25 ) ;
return V_39 ;
...
V_3 -> V_102 -> V_107 = 0 ;
V_253 = F_137 ( V_2 , V_3 ) ;
if ( ( V_2 -> V_245 & V_253 ) != 0 )
V_102 -> V_103 |= V_257 ;
if ( ( V_52 -> V_112 . V_113 & V_114 ) != 0 )
V_3 -> V_47 |= V_115 ;
if ( ( V_54 -> V_258 & V_253 ) != 0 ) {
V_3 -> V_47 |= V_259 ;
...
memcpy ( V_102 -> V_264 . V_265 . V_266 , V_25 -> V_97 , V_102 -> V_106 ) ;
V_3 -> V_4 -> V_101 = 0 ;
F_73 ( V_3 , 0 ) ;
F_74 ( V_3 , 0 ) ;
V_3 -> V_100 = 0 ;
if ( V_254 > 0 ) {
void * V_267 = V_3 -> V_268 ;
struct V_269 * V_270 ;
int V_18 ;
V_3 -> V_4 -> V_101 = 0 ;
F_138 (cmd, cur_seg, nseg, i) {
T_9 V_271 ;
T_8 V_272 ;
V_271 = F_139 ( V_270 ) ;
V_272 = F_140 ( V_270 ) ;
V_3 -> V_4 -> V_101 += V_272 ;
V_267 = F_141 ( V_2 , V_3 , V_267 , V_271 , V_272 ,
V_18 == ( V_254 - 1 ) ) ;
}
}
...
T_19
F_142 ( int V_194 , void * V_273 )
{
struct V_1 * V_2 ;
T_14 V_47 ;
int V_274 ;
V_2 = (struct V_1 * ) V_273 ;
F_41 ( V_2 , & V_47 ) ;
V_274 = F_143 ( V_2 ) ;
F_53 ( V_2 , & V_47 ) ;
return F_144 ( V_274 ) ;
...
void
F_133 ( struct V_1 * V_2 , char V_55 ,
T_6 V_240 , T_6 V_105 , T_20 V_275 )
{
switch ( V_275 ) {
case V_250 :
{
...
V_52 = F_43 ( V_2 , V_55 , V_2 -> V_58 ,
V_240 , & V_54 ) ;
if ( V_52 -> V_112 . V_65 != V_52 -> V_278 . V_65
|| V_52 -> V_112 . V_21 != V_52 -> V_278 . V_21
|| V_52 -> V_112 . V_66 != V_52 -> V_278 . V_66
|| V_52 -> V_112 . V_113 != V_52 -> V_278 . V_113 )
if ( V_73 == 0 )
break;
V_43 = V_2 -> V_4 -> V_43 [ V_240 ] ;
if ( V_43 == NULL )
break;
V_276 =
( F_145 ( V_43 ) ? V_279 : 0 )
...
+ ( F_150 ( V_43 ) ? V_284 : 0 )
+ ( F_151 ( V_43 ) ? V_285 : 0 ) ;
if ( V_52 -> V_112 . V_65 == F_152 ( V_43 )
&& V_52 -> V_112 . V_21 == F_153 ( V_43 )
&& V_52 -> V_112 . V_66 == F_154 ( V_43 )
&& V_52 -> V_112 . V_113 == V_276 )
if ( V_73 == 0 )
break;
F_152 ( V_43 ) = V_52 -> V_112 . V_65 ;
F_153 ( V_43 ) = V_52 -> V_112 . V_21 ;
F_154 ( V_43 ) = V_52 -> V_112 . V_66 ;
F_145 ( V_43 ) = V_52 -> V_112 . V_113 & V_279 ? 1 : 0 ;
F_146 ( V_43 ) = V_52 -> V_112 . V_113 & V_280 ? 1 : 0 ;
F_147 ( V_43 ) = V_52 -> V_112 . V_113 & V_114 ? 1 : 0 ;
F_148 ( V_43 ) = V_52 -> V_112 . V_113 & V_281 ? 1 : 0 ;
F_149 ( V_43 ) = V_52 -> V_112 . V_113 & V_282 ? 1 : 0 ;
F_45 ( V_43 ) = V_52 -> V_112 . V_113 & V_283 ? 1 : 0 ;
F_150 ( V_43 ) = V_52 -> V_112 . V_113 & V_284 ? 1 : 0 ;
F_151 ( V_43 ) = V_52 -> V_112 . V_113 & V_285 ? 1 : 0 ;
F_155 ( V_43 ) ;
break;
}
case V_286 :
...
void
F_159 ( struct V_1 * V_2 , struct V_3 * V_3 )
{
struct V_24 * V_25 ;
struct V_35 * V_36 ;
if ( ( V_3 -> V_47 & V_111 ) == 0 ) {
...
} else if ( F_163 ( V_3 ) == V_297 ) {
F_168 ( V_2 , V_25 -> V_37 , V_3 ) ;
}
if ( V_36 -> V_74 == 1
&& F_163 ( V_3 ) == V_296
&& F_169 ( V_3 ) != V_298 )
...
struct V_24 * V_25 ;
V_25 = V_3 -> V_26 ;
if ( ( V_3 -> V_47 & ( V_306 | V_307 ) ) != 0 ) {
struct V_308 * V_309 ;
T_6 V_310 ;
T_6 V_311 ;
if ( V_3 -> V_47 & V_306 ) {
V_310 = F_173 ( sizeof( struct V_312 )
- F_174 ( V_3 ) ,
( T_14 ) V_313 ) ;
V_311 = 0 ;
} else {
...
F_2 ( L_55 ,
V_310 , V_311 ) ;
for ( V_18 = 0 ; V_18 < V_310 ; V_18 ++ ) {
if ( ( V_18 & 0xF ) == 0 )
F_2 ( L_5 ) ;
F_2 ( L_56 , V_25 -> V_289 [ V_18 ] ) ;
}
F_2 ( L_5 ) ;
}
#endif
...
static void
F_172 ( struct V_1 * V_2 , struct V_24 * V_25 )
{
int V_243 ;
int V_325 = V_326 ;
int V_327 = 0 ;
...
if ( V_327 ) {
F_2 ( L_59 ,
F_56 ( V_2 ) , V_243 , V_25 -> V_37 -> V_55 ,
V_25 -> V_37 -> V_57 , ( V_357 ) V_25 -> V_37 -> V_105 ) ;
}
F_182 ( V_25 , V_325 ) ;
V_25 -> F_35 ( V_25 ) ;
}
...
F_185 (pending_scb, &ahd->pending_scbs, pending_links) {
if ( V_358 -> V_26 == V_25 )
break;
}
if ( V_358 == NULL ) {
...
F_187 ( V_2 ) ;
V_93 = TRUE ;
if ( ( V_358 -> V_47 & V_111 ) == 0 ) {
F_71 ( V_76 , V_25 , L_62 ) ;
goto V_366;
}
F_2 ( L_63 ,
F_56 ( V_2 ) , V_363 ? L_64 : L_65 ) ;
F_161 ( V_2 ) ;
V_364 = TRUE ;
if ( F_188 ( V_2 , V_25 -> V_37 -> V_57 ,
V_25 -> V_37 -> V_55 + 'A' ,
V_25 -> V_37 -> V_105 ,
V_358 -> V_102 -> V_241 ,
V_68 , V_302 ,
...
V_365 = F_189 ( V_2 ) ;
F_190 ( V_2 , V_368 , V_368 ) ;
V_361 = F_8 ( V_2 , V_369 ) ;
V_359 = F_191 ( V_2 ) ;
V_360 = V_359 ;
if ( V_364 && ( F_8 ( V_2 , V_370 ) & V_371 ) == 0 ) {
struct V_3 * V_372 ;
V_372 = F_192 ( V_2 , V_360 ) ;
if ( V_372 == V_358 )
V_364 = FALSE ;
}
V_362 = F_8 ( V_2 , V_373 ) ;
if ( V_361 != V_374
&& F_160 ( V_358 ) == V_360 ) {
V_358 = F_192 ( V_2 , V_360 ) ;
V_358 -> V_47 |= V_110 | V_375 ;
F_12 ( V_2 , V_376 , V_377 ) ;
F_12 ( V_2 , V_378 , V_361 | V_379 ) ;
F_71 ( V_76 , V_25 , L_67 ) ;
V_94 = TRUE ;
} else if ( V_364 ) {
V_358 -> V_47 |= V_110 | V_375 ;
F_193 ( V_2 , F_160 ( V_358 ) ) ;
V_358 -> V_102 -> V_106 = 0 ;
V_358 -> V_102 -> V_380 = 0 ;
V_358 -> V_102 -> V_107 = V_381 ;
if ( ( V_358 -> V_47 & V_115 ) != 0 ) {
F_12 ( V_2 , V_382 ,
V_358 -> V_102 -> V_107 ) ;
} else {
V_358 -> V_102 -> V_103 |= V_116 | V_383 ;
F_12 ( V_2 , V_384 ,
F_8 ( V_2 , V_384 ) | V_116 ) ;
}
F_188 ( V_2 , V_25 -> V_37 -> V_57 ,
...
static void F_196 ( struct V_42 * V_43 , int V_21 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_49 V_50 ;
unsigned long V_47 ;
F_50 ( & V_50 , V_385 -> V_193 , V_43 -> V_57 , 0 ,
V_43 -> V_55 + 'A' , V_68 ) ;
F_41 ( V_2 , & V_47 ) ;
F_52 ( V_2 , & V_50 , V_21 , V_69 , FALSE ) ;
F_53 ( V_2 , & V_47 ) ;
}
static void F_197 ( struct V_42 * V_43 , int V_65 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
= F_43 ( V_2 ,
V_43 -> V_55 + 'A' ,
V_385 -> V_193 , V_43 -> V_57 , & V_54 ) ;
struct V_49 V_50 ;
unsigned int V_113 = V_52 -> V_278 . V_113 ;
unsigned int V_386 ;
unsigned long V_47 ;
unsigned long V_66 = V_52 -> V_278 . V_66 ;
#ifdef F_80
if ( ( V_124 & V_387 ) != 0 )
...
static void F_199 ( struct V_42 * V_43 , int V_66 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
unsigned int V_65 = 0 ;
unsigned int V_386 = V_113 & V_279 ;
unsigned long V_47 ;
#ifdef F_80
if ( ( V_124 & V_387 ) != 0 )
...
V_43 -> V_55 + 'A' , V_68 ) ;
if ( V_66 != 0 ) {
V_65 = V_52 -> V_278 . V_65 ;
V_113 = V_52 -> V_278 . V_113 ;
F_198 ( V_2 , & V_65 , & V_113 ,
V_386 ? V_389 : V_390 ) ;
}
F_41 ( V_2 , & V_47 ) ;
...
static void F_200 ( struct V_42 * V_43 , int V_386 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
unsigned int V_113 = V_52 -> V_278 . V_113
& ~ V_279 ;
unsigned int V_65 = V_52 -> V_278 . V_65 ;
unsigned int V_21 = V_52 -> V_278 . V_21 ;
unsigned long V_47 ;
#ifdef F_80
if ( ( V_124 & V_387 ) != 0 )
F_2 ( L_76 , F_56 ( V_2 ) ,
...
V_386 ? V_389 : V_390 ) ;
F_41 ( V_2 , & V_47 ) ;
F_51 ( V_2 , & V_50 , V_65 , V_52 -> V_278 . V_66 ,
V_113 , V_69 , FALSE ) ;
F_53 ( V_2 , & V_47 ) ;
}
static void F_201 ( struct V_42 * V_43 , int V_391 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_202 ( struct V_42 * V_43 , int V_392 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_203 ( struct V_42 * V_43 , int V_393 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_204 ( struct V_42 * V_43 , int V_394 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_205 ( struct V_42 * V_43 , int V_395 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_206 ( struct V_42 * V_43 , int V_396 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_207 ( struct V_42 * V_43 , int V_397 )
{
struct V_28 * V_385 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_385 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_208 ( struct V_28 * V_385 )
{
struct V_1 * V_2 = * (struct V_1 * * ) V_385 -> V_32 ;
unsigned long V_47 ;
V_357 V_398 ;
