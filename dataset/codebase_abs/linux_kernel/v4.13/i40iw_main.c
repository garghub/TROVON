...
static enum V_45 F_109 ( struct V_21 * V_22 ,
struct V_2 * V_3 )
{
struct V_307 * V_164 ;
struct V_308 * V_309 ;
...
F_27 ( V_22 ) ;
case V_329 :
F_120 ( & V_22 -> V_192 , V_193 , V_22 -> V_50 ) ;
case V_330 :
F_120 ( & V_22 -> V_192 , V_181 , V_22 -> V_50 ) ;
case V_331 :
F_31 ( V_22 ) ;
case V_198 :
...
case V_335 :
default:
F_28 ( L_31 , V_22 -> V_197 ) ;
break;
}
F_8 ( F_1 ( V_3 ) ) ;
F_23 ( V_22 -> V_4 ) ;
}
static enum V_45 F_123 ( struct V_1 * V_4 ,
struct V_2 * V_3 ,
struct V_336 * V_160 )
{
...
V_4 -> V_160 = V_160 ;
if ( ! V_3 -> V_281 )
V_22 -> V_342 = F_124 ( V_3 -> V_343 , 0 ) + V_344 ;
else
V_22 -> V_342 = F_124 ( V_3 -> V_343 , 0 ) + V_345 ;
V_46 = F_109 ( V_22 , V_3 ) ;
if ( V_46 )
goto exit;
...
{
V_22 -> V_351 = F_126 ( V_22 -> V_352 , V_22 -> V_353 , 0 ) ;
V_22 -> V_354 = F_126 ( V_22 -> V_355 , V_22 -> V_356 , 0 ) ;
V_22 -> V_357 = F_126 ( V_22 -> V_358 , V_22 -> V_359 , 0 ) ;
V_22 -> V_360 = F_126 ( V_22 -> V_361 , V_22 -> V_362 , 0 ) ;
}
static int F_127 ( struct V_2 * V_3 , struct V_336 * V_160 )
{
struct V_21 * V_22 ;
struct V_11 * V_12 ;
enum V_45 V_46 ;
...
V_46 = F_131 ( & V_22 -> V_25 , V_22 -> V_270 ) ;
if ( V_46 )
break;
V_22 -> V_197 = V_326 ;
V_22 -> V_367 = F_132 ( L_32 , V_368 ) ;
F_104 () ;
V_22 -> V_197 = V_325 ;
V_46 = F_95 ( V_22 ) ;
if ( V_46 )
...
V_22 -> V_322 = 1 ;
F_113 ( V_22 ) ;
V_22 -> V_320 = F_132 ( L_34 , V_368 ) ;
if( V_22 -> V_320 == NULL )
break;
F_81 ( L_35 ) ;
return 0 ;
} while ( 0 );
F_28 ( L_36 , V_46 , V_22 -> V_197 ) ;
F_111 ( V_22 ) ;
return - V_369 ;
}
static void F_134 ( struct V_370 * V_371 )
{
struct V_372 * V_373 =
F_135 ( V_371 , struct V_372 , V_371 ) ;
struct V_21 * V_22 = V_373 -> V_22 ;
F_136 ( & V_22 -> V_192 , & V_373 -> V_261 ) ;
F_137 ( & V_22 -> V_374 ) ;
F_23 ( V_371 ) ;
}
static void F_138 ( struct V_2 * V_3 , struct V_336 * V_160 ,
struct V_375 * V_287 )
{
struct V_1 * V_4 ;
struct V_260 * V_261 ;
...
if ( F_139 ( & V_22 -> V_374 ) )
return;
V_371 = F_100 ( sizeof( * V_371 ) , V_376 ) ;
if ( ! V_371 )
return;
F_71 ( & V_22 -> V_374 ) ;
V_371 -> V_22 = V_22 ;
...
F_140 ( & V_371 -> V_371 , F_134 ) ;
F_141 ( V_22 -> V_320 , & V_371 -> V_371 ) ;
}
static void F_142 ( struct V_2 * V_3 , struct V_336 * V_160 , bool V_50 )
{
struct V_21 * V_22 ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_3 ) ;
...
static void F_144 ( struct V_2 * V_3 , struct V_336 * V_160 , T_1 V_378 )
{
struct V_1 * V_4 ;
struct V_11 * V_12 ;
struct V_379 V_380 ;
...
F_33 ( V_12 , & V_384 -> V_70 , false , false ) ;
...
return true ;
F_153 ( & V_399 ) ;
F_154 ( & V_12 -> V_349 , & V_399 ) ;
if ( ! F_155 ( V_12 -> V_349 ,
( F_139 ( & V_22 -> V_398 ) == 0 ) ,
V_400 ) )
V_12 -> V_401 = false ;
F_156 ( & V_12 -> V_349 , & V_399 ) ;
return V_12 -> V_401 ;
}
