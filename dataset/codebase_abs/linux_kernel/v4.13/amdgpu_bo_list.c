...
static void F_16 ( struct V_20 * V_21 , int V_18 )
{
struct V_4 * V_5 ;
F_13 ( & V_21 -> V_25 ) ;
V_5 = F_17 ( & V_21 -> V_26 , V_18 ) ;
F_15 ( & V_21 -> V_25 ) ;
if ( V_5 )
F_18 ( & V_5 -> V_6 , F_1 ) ;
}
...
V_8 = F_19 ( V_7 , sizeof( struct V_27 ) , V_23 ) ;
if ( ! V_8 )
return - V_24 ;
...
struct V_4 *
F_29 ( struct V_20 * V_21 , int V_18 )
{
struct V_4 * V_63 ;
F_30 () ;
V_63 = F_31 ( & V_21 -> V_26 , V_18 ) ;
if ( V_63 ) {
if ( F_32 ( & V_63 -> V_6 ) ) {
F_33 () ;
F_13 ( & V_63 -> V_10 ) ;
...
const void T_2 * V_79 = ( const void * ) ( V_80 ) args -> V_77 . V_81 ;
struct V_16 * V_17 ;
struct V_4 * V_5 ;
int V_19 ;
V_17 = F_19 ( args -> V_77 . V_82 ,
sizeof( struct V_16 ) , V_23 ) ;
if ( ! V_17 )
return - V_24 ;
V_19 = - V_83 ;
if ( F_41 ( V_73 == args -> V_77 . V_84 ) ) {
unsigned long V_85 = args -> V_77 . V_82 *
args -> V_77 . V_84 ;
if ( F_42 ( V_17 , V_79 , V_85 ) )
goto V_47;
} else {
unsigned long V_85 = F_25 ( args -> V_77 . V_84 , V_73 ) ;
unsigned V_3 ;
memset ( V_17 , 0 , args -> V_77 . V_82 * V_73 ) ;
for ( V_3 = 0 ; V_3 < args -> V_77 . V_82 ; ++ V_3 ) {
if ( F_42 ( & V_17 [ V_3 ] , V_79 , V_85 ) )
goto V_47;
V_79 += args -> V_77 . V_84 ;
}
}
switch ( args -> V_77 . V_86 ) {
case V_87 :
V_19 = F_7 ( V_13 , V_15 , V_17 , args -> V_77 . V_82 ,
& V_76 ) ;
if ( V_19 )
goto V_47;
break;
