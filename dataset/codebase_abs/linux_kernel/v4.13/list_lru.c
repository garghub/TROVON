...
F_28 ( struct V_1 * V_2 , int V_18 , int V_22 ,
T_1 V_24 , void * V_25 ,
unsigned long * V_26 )
{
struct V_9 * V_10 = & V_2 -> V_6 [ V_18 ] ;
...
unsigned long
F_33 ( struct V_1 * V_2 , int V_18 , struct V_14 * V_15 ,
T_1 V_24 , void * V_25 ,
unsigned long * V_26 )
{
return F_28 ( V_2 , V_18 , F_12 ( V_15 ) ,
V_24 , V_25 , V_26 ) ;
}
unsigned long F_34 ( struct V_1 * V_2 , int V_18 ,
T_1 V_24 , void * V_25 ,
unsigned long * V_26 )
{
long V_28 = 0 ;
int V_22 ;
V_28 += F_28 ( V_2 , V_18 , - 1 , V_24 , V_25 ,
V_26 ) ;
if ( * V_26 > 0 && F_7 ( V_2 ) ) {
F_35 (memcg_idx) {
V_28 += F_28 ( V_2 , V_18 , V_22 ,
V_24 , V_25 , V_26 ) ;
if ( * V_26 <= 0 )
break;
}
...
return;
F_50 (i)
F_57 ( & V_2 -> V_6 [ V_40 ] , V_52 , V_53 ) ;
}
void F_60 ( int V_52 , int V_53 )
{
struct V_1 * V_2 ;
F_2 ( & V_3 ) ;
F_55 (lru, &list_lrus, list)
...
int F_61 ( struct V_1 * V_2 , bool V_50 ,
struct V_56 * V_57 )
{
int V_40 ;
T_2 V_44 = sizeof( * V_2 -> V_6 ) * V_58 ;
int V_59 = - V_43 ;
F_62 () ;
V_2 -> V_6 = F_63 ( V_44 , V_41 ) ;
if ( ! V_2 -> V_6 )
goto V_51;
F_50 (i) {
F_64 ( & V_2 -> V_6 [ V_40 ] . V_12 ) ;
if ( V_57 )
F_65 ( & V_2 -> V_6 [ V_40 ] . V_12 , V_57 ) ;
