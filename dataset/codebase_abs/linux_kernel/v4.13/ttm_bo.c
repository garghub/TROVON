...
static bool F_88 ( const struct V_1 * V_150 ,
unsigned V_30 ,
struct V_77 * V_28 ,
T_1 * V_151 )
{
...
const struct V_1 * V_152 = & V_150 [ V_26 ] ;
if ( V_28 -> V_44 && ( V_28 -> V_96 < V_152 -> V_129 ||
( V_152 -> V_130 != 0 && ( V_28 -> V_96 + V_28 -> V_29 ) > V_152 -> V_130 ) ) )
continue;
* V_151 = V_152 -> V_5 ;
if ( ( * V_151 & V_28 -> V_25 & V_85 ) &&
( * V_151 & V_28 -> V_25 & V_6 ) &&
( ! ( * V_151 & V_153 ) ||
( V_28 -> V_25 & V_153 ) ) )
return true ;
...
T_1 * V_151 )
{
if ( F_88 ( V_25 -> V_25 , V_25 -> V_30 ,
V_28 , V_151 ) )
return true ;
if ( ( V_25 -> V_148 != V_25 -> V_25 ||
V_25 -> V_126 > V_25 -> V_30 ) &&
F_88 ( V_25 -> V_148 ,
V_25 -> V_126 ,
V_28 , V_151 ) )
return true ;
...
T_1 V_151 ;
F_23 ( & V_23 -> V_49 -> V_54 . V_55 ) ;
if ( ! F_89 ( V_25 , & V_23 -> V_28 , & V_151 ) ) {
V_27 = F_87 ( V_23 , V_25 , V_79 ,
V_80 ) ;
if ( V_27 )
return V_27 ;
} else {
F_86 ( & V_23 -> V_28 . V_25 , V_151 ,
~ V_147 ) ;
}
...
int V_27 = 0 ;
unsigned long V_29 ;
struct V_159 * V_53 = V_9 -> V_37 -> V_53 ;
bool V_160 ;
...
{
int V_27 ;
V_27 = F_91 ( V_9 , V_23 , V_15 , type , V_25 ,
V_149 , V_79 ,
V_156 , V_42 ,
V_76 , V_49 , V_52 ) ;
if ( V_27 )
...
unsigned V_164 )
{
unsigned V_165 = ( F_105 ( V_163 ) ) >> V_72 ;
T_3 V_15 = 0 ;
V_15 += F_106 ( V_164 ) ;
V_15 += F_106 ( V_165 * sizeof( void * ) ) ;
V_15 += F_106 ( sizeof( struct V_166 ) ) ;
return V_15 ;
}
...
T_3 V_15 = 0 ;
V_15 += F_106 ( V_164 ) ;
V_15 += F_106 ( V_165 * ( 2 * sizeof( void * ) + sizeof( V_167 ) ) ) ;
V_15 += F_106 ( sizeof( struct V_168 ) ) ;
return V_15 ;
}
int F_108 ( struct V_8 * V_9 ,
unsigned long V_15 ,
enum V_154 type ,
struct V_24 * V_25 ,
T_1 V_149 ,
...
T_3 V_42 ;
int V_27 ;
V_23 = F_109 ( sizeof( * V_23 ) , V_169 ) ;
if ( F_3 ( V_23 == NULL ) )
return - V_74 ;
V_42 = F_104 ( V_9 , V_15 , sizeof( struct V_22 ) ) ;
V_27 = F_103 ( V_9 , V_23 , V_15 , type , V_25 , V_149 ,
V_79 , V_156 , V_42 ,
NULL , NULL , NULL ) ;
if ( F_102 ( V_27 == 0 ) )
* V_120 = V_23 ;
...
return F_110 ( V_9 , V_3 ) ;
}
int F_114 ( struct V_8 * V_9 , unsigned type ,
unsigned long V_172 )
{
int V_27 ;
struct V_10 * V_11 ;
...
F_115 ( & V_11 -> V_134 ) ;
F_95 ( & V_11 -> V_161 ) ;
V_27 = V_9 -> V_70 -> V_176 ( V_9 , type , V_11 ) ;
if ( V_27 )
return V_27 ;
V_11 -> V_9 = V_9 ;
if ( type != V_18 ) {
V_27 = (* V_11 -> V_19 -> V_177 )( V_11 , V_172 ) ;
if ( V_27 )
return V_27 ;
}
V_11 -> V_12 = true ;
...
static void F_116 ( struct V_31 * V_32 )
{
struct V_36 * V_37 =
F_8 ( V_32 , struct V_36 , V_32 ) ;
F_117 ( V_37 -> V_53 , & V_37 -> V_178 ) ;
F_118 ( V_37 -> V_73 ) ;
F_20 ( V_37 ) ;
}
void F_119 ( struct V_179 * V_180 )
{
struct V_36 * V_37 = V_180 -> V_181 ;
F_120 ( & V_37 -> V_32 ) ;
F_121 ( & V_37 -> V_32 ) ;
}
int F_122 ( struct V_179 * V_180 )
{
struct V_182 * V_183 =
F_8 ( V_180 , struct V_182 , V_180 ) ;
struct V_36 * V_37 = V_180 -> V_181 ;
int V_27 ;
unsigned V_26 ;
F_96 ( & V_37 -> V_184 ) ;
F_115 ( & V_37 -> V_62 ) ;
V_37 -> V_53 = V_183 -> V_53 ;
V_37 -> V_73 = F_123 ( V_185 | V_186 ) ;
...
F_95 ( & V_37 -> V_61 [ V_26 ] ) ;
F_95 ( & V_37 -> V_188 ) ;
F_124 ( & V_37 -> V_178 , V_189 ) ;
V_27 = F_125 ( V_37 -> V_53 , & V_37 -> V_178 ) ;
if ( F_3 ( V_27 != 0 ) ) {
F_5 ( L_23 ) ;
goto V_190;
}
...
V_27 = F_114 ( V_9 , V_18 , 0 ) ;
if ( F_3 ( V_27 != 0 ) )
goto V_196;
F_135 ( & V_9 -> V_118 , V_195 ,
0x10000000 ) ;
F_136 ( & V_9 -> V_106 , F_65 ) ;
F_95 ( & V_9 -> V_46 ) ;
V_9 -> V_197 = V_194 ;
V_9 -> V_37 = V_37 ;
V_9 -> V_65 = V_65 ;
F_129 ( & V_37 -> V_184 ) ;
F_24 ( & V_9 -> V_188 , & V_37 -> V_188 ) ;
F_131 ( & V_37 -> V_184 ) ;
return 0 ;
V_196:
return V_27 ;
...
bool V_79 , bool V_199 )
{
long V_200 = 15 * V_107 ;
if ( V_199 ) {
if ( F_139 ( V_23 -> V_49 , true ) )
return 0 ;
else
return - V_109 ;
}
V_200 = F_61 ( V_23 -> V_49 , true ,
V_79 , V_200 ) ;
if ( V_200 < 0 )
return V_200 ;
if ( V_200 == 0 )
...
int F_141 ( struct V_22 * V_23 , bool V_199 )
{
int V_27 = 0 ;
V_27 = F_142 ( V_23 , true , V_199 , NULL ) ;
if ( F_3 ( V_27 != 0 ) )
return V_27 ;
V_27 = F_57 ( V_23 , true , V_199 ) ;
if ( F_102 ( V_27 == 0 ) )
F_98 ( & V_23 -> V_43 ) ;
F_78 ( V_23 ) ;
return V_27 ;
...
static int V_189 ( struct V_201 * V_178 )
{
struct V_36 * V_37 =
F_8 ( V_178 , struct V_36 , V_178 ) ;
struct V_22 * V_23 ;
int V_27 = - V_109 ;
unsigned V_26 ;
F_32 ( & V_37 -> V_62 ) ;
...
F_33 ( & V_37 -> V_62 ) ;
if ( V_23 -> V_28 . V_3 != V_18 ||
V_23 -> V_47 -> V_202 != V_203 ) {
struct V_77 V_122 ;
V_122 = V_23 -> V_28 ;
V_122 . V_44 = NULL ;
V_122 . V_25 = V_162 | V_139 ;
V_122 . V_3 = V_18 ;
...
goto V_115;
F_138 ( V_23 ) ;
if ( V_23 -> V_9 -> V_70 -> V_204 )
V_23 -> V_9 -> V_70 -> V_204 ( V_23 ) ;
V_27 = F_144 ( V_23 -> V_47 , V_23 -> V_156 ) ;
V_115:
F_58 ( V_23 ) ;
F_30 ( & V_23 -> V_41 , F_11 ) ;
return V_27 ;
...
{
while ( V_189 ( & V_9 -> V_37 -> V_178 ) == 0 )
;
}
int F_146 ( struct V_22 * V_23 )
{
int V_27 ;
V_27 = F_147 ( & V_23 -> V_51 ) ;
if ( F_3 ( V_27 != 0 ) )
return - V_128 ;
