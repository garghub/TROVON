...
struct V_19 * V_20 ;
const T_2 * V_136 ;
struct V_110 * V_137 , * V_113 ;
char * V_138 ;
F_81 ( L_41 ) ;
V_20 = F_82 ( sizeof( * V_20 ) , V_139 ) ;
if ( ! V_20 )
return - V_140 ;
V_20 -> V_122 = - 1 ;
V_42 -> V_43 = V_20 ;
...
V_20 -> V_99 = 0 ;
V_20 -> V_142 = 1 ;
for ( V_113 = V_42 -> V_118 -> V_143 ; V_113 ; V_113 = V_113 -> V_144 ) {
...
if ( ( V_4 = F_74 ( V_42 ) ) < 0 )
return V_4 ;
V_137 = F_58 ( NULL , L_45 ) ;
if ( V_137 == NULL )
V_137 = F_58 ( NULL , L_46 ) ;
if ( V_137 == NULL )
return - V_24 ;
V_136 = F_60 ( V_137 , L_47 , NULL ) ;
if ( V_136 == NULL )
V_136 = F_60 ( V_137 , L_18 , NULL ) ;
if ( V_136 )
V_20 -> V_2 . V_14 = ( * V_136 ) >> 1 ;
else
V_20 -> V_2 . V_14 = V_145 ;
F_61 ( V_137 ) ;
...
return V_4 ;
sprintf ( V_42 -> V_88 -> V_146 , L_53 , V_138 ) ;
if ( V_42 -> V_51 == V_52 ) {
for ( V_56 = 0 ; V_56 < F_13 ( V_147 ) ; V_56 ++ ) {
if ( ( V_4 = F_84 ( V_42 -> V_88 , F_85 ( & V_147 [ V_56 ] , V_42 ) ) ) < 0 )
return V_4 ;
}
} else {
...
V_42 -> V_97 = F_85 ( & V_149 , V_42 ) ;
if ( ( V_4 = F_84 ( V_42 -> V_88 , V_42 -> V_97 ) ) < 0 )
return V_4 ;
V_42 -> V_101 = F_85 ( & V_150 , V_42 ) ;
if ( ( V_4 = F_84 ( V_42 -> V_88 , V_42 -> V_101 ) ) < 0 )
return V_4 ;
if ( V_20 -> V_75 . V_14 != 0 ) {
V_42 -> V_98 = F_85 ( & V_151 , V_42 ) ;
if ( ( V_4 = F_84 ( V_42 -> V_88 , V_42 -> V_98 ) ) < 0 )
return V_4 ;
}
V_42 -> V_103 = F_85 ( & V_152 , V_42 ) ;
