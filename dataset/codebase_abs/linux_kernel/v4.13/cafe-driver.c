...
V_7 -> V_89 = F_31 ;
V_7 -> V_3 = & V_57 -> V_3 ;
snprintf ( V_7 -> V_90 , sizeof( V_7 -> V_90 ) , L_8 , F_41 ( V_57 ) ) ;
V_7 -> V_91 = 45 ;
V_7 -> V_92 = 1 ;
V_7 -> V_93 = V_94 ;
V_38 = F_42 ( V_57 ) ;
...
F_43 ( V_57 ) ;
V_38 = - V_29 ;
V_7 -> V_96 = F_44 ( V_57 , 0 , 0 ) ;
if ( ! V_7 -> V_96 ) {
F_24 ( V_58 L_9 ) ;
goto V_97;
}
V_7 -> V_98 = F_45 ( V_57 , 0 ) ;
V_38 = F_46 ( V_57 -> V_77 , F_32 , V_99 , L_10 , V_14 ) ;
if ( V_38 )
goto V_100;
F_28 ( V_7 ) ;
F_30 ( V_7 ) ;
...
static void F_51 ( struct V_1 * V_14 )
{
F_52 ( & V_14 -> V_7 ) ;
F_26 ( V_14 ) ;
F_48 ( V_14 -> V_57 -> V_77 , V_14 ) ;
F_49 ( V_14 -> V_57 , V_14 -> V_7 . V_96 ) ;
}
static void F_53 ( struct V_82 * V_57 )
{
struct V_2 * V_6 = F_54 ( & V_57 -> V_3 ) ;
struct V_1 * V_14 = F_1 ( V_6 ) ;
if ( V_14 == NULL ) {
F_24 ( V_102 L_11 , V_57 ) ;
return;
}
F_51 ( V_14 ) ;
F_25 ( V_14 ) ;
}
static int F_55 ( struct V_82 * V_57 , T_5 V_103 )
{
struct V_2 * V_6 = F_54 ( & V_57 -> V_3 ) ;
struct V_1 * V_14 = F_1 ( V_6 ) ;
int V_38 ;
...
static int F_58 ( struct V_82 * V_57 )
{
struct V_2 * V_6 = F_54 ( & V_57 -> V_3 ) ;
struct V_1 * V_14 = F_1 ( V_6 ) ;
int V_38 = 0 ;
