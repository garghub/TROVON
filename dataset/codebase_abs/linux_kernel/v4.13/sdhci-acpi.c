...
F_39 ( V_16 ) ;
if ( ! F_23 ( V_31 , V_32 ) ) {
F_40 (child, &device->children, node)
if ( V_55 -> V_63 . V_64 && V_55 -> V_63 . V_65 )
F_39 ( V_55 ) ;
}
if ( F_15 ( V_17 ) )
return - V_66 ;
V_57 = F_41 ( V_43 , V_67 , 0 ) ;
if ( ! V_57 )
return - V_68 ;
V_58 = F_42 ( V_57 ) ;
if ( V_58 < 0x100 )
F_12 ( V_17 , L_8 ) ;
if ( ! F_43 ( V_17 , V_57 -> V_69 , V_58 , F_44 ( V_17 ) ) )
return - V_68 ;
V_7 = F_45 ( V_17 , sizeof( struct V_1 ) ) ;
if ( F_46 ( V_7 ) )
return F_47 ( V_7 ) ;
V_2 = F_48 ( V_7 ) ;
V_2 -> V_7 = V_7 ;
...
V_2 -> V_43 = V_43 ;
V_2 -> V_70 = F_1 ( V_2 , V_71 ) ;
F_49 ( V_43 , V_2 ) ;
V_7 -> V_72 = L_9 ;
V_7 -> V_73 = & V_74 ;
V_7 -> V_75 = F_50 ( V_43 , 0 ) ;
V_7 -> V_76 = F_51 ( V_17 , V_57 -> V_69 ,
F_42 ( V_57 ) ) ;
if ( V_7 -> V_76 == NULL ) {
V_59 = - V_68 ;
goto V_77;
...
if ( V_2 -> V_4 ) {
if ( V_2 -> V_4 -> V_78 ) {
V_59 = V_2 -> V_4 -> V_78 ( V_43 , V_31 , V_32 ) ;
if ( V_59 )
goto V_77;
}
if ( V_2 -> V_4 -> V_79 ) {
V_7 -> V_73 = V_2 -> V_4 -> V_79 -> V_73 ;
V_7 -> V_80 |= V_2 -> V_4 -> V_79 -> V_80 ;
V_7 -> V_81 |= V_2 -> V_4 -> V_79 -> V_81 ;
V_7 -> V_34 -> V_82 |= V_2 -> V_4 -> V_79 -> V_82 ;
V_7 -> V_34 -> V_83 |= V_2 -> V_4 -> V_79 -> V_83 ;
V_7 -> V_34 -> V_84 |= V_2 -> V_4 -> V_79 -> V_84 ;
}
V_7 -> V_80 |= V_2 -> V_4 -> V_80 ;
V_7 -> V_81 |= V_2 -> V_4 -> V_81 ;
V_7 -> V_34 -> V_82 |= V_2 -> V_4 -> V_82 ;
V_7 -> V_34 -> V_83 |= V_2 -> V_4 -> V_83 ;
V_7 -> V_34 -> V_84 |= V_2 -> V_4 -> V_84 ;
}
V_7 -> V_34 -> V_83 |= V_85 ;
if ( F_1 ( V_2 , V_86 ) ) {
bool V_87 = F_1 ( V_2 , V_88 ) ;
V_59 = F_52 ( V_7 -> V_34 , NULL , 0 , V_87 , 0 , NULL ) ;
if ( V_59 ) {
if ( V_59 == - V_66 )
goto V_77;
F_53 ( V_17 , L_10 ) ;
...
if ( V_2 -> V_4 && V_2 -> V_4 -> V_90 )
V_2 -> V_4 -> V_90 ( V_43 ) ;
V_89 = ( F_28 ( V_2 -> V_7 , V_91 ) == ~ 0 ) ;
F_66 ( V_2 -> V_7 , V_89 ) ;
F_61 ( V_2 -> V_7 ) ;
return 0 ;
}
