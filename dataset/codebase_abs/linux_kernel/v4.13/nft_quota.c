...
static int F_17 ( const struct V_34 * V_35 ,
...
{
struct V_1 * V_2 = F_6 ( V_18 ) ;
return F_18 ( V_4 , V_2 , V_36 ) ;
}
static void F_27 ( const struct V_40 * V_41 ,
struct V_10 * V_11 ,
const struct V_12 * V_13 )
{
...
static int F_29 ( const struct V_34 * V_35 ,
...
static int F_30 ( struct V_3 * V_4 , const struct V_40 * V_41 )
{
struct V_1 * V_2 = F_28 ( V_41 ) ;
