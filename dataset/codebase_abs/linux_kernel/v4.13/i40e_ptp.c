...
{
struct V_5 * V_6 = & V_2 -> V_6 ;
unsigned int V_37 , V_42 = 0 ;
if ( ! ( V_2 -> V_43 & V_44 ) || ! V_2 -> V_45 )
return;
F_24 ( & V_2 -> V_46 ) ;
F_21 ( V_2 ) ;
for ( V_37 = 0 ; V_37 < 4 ; V_37 ++ ) {
if ( ( V_2 -> V_39 & F_22 ( V_37 ) ) &&
F_25 ( V_2 -> V_40 [ V_37 ] + V_47 ) ) {
F_2 ( V_6 , F_26 ( V_37 ) ) ;
V_2 -> V_39 &= ~ F_22 ( V_37 ) ;
V_42 ++ ;
}
...
{
if ( ! ( V_2 -> V_43 & V_44 ) || ! V_2 -> V_51 )
return;
if ( ! F_30 ( V_52 , V_2 -> V_53 ) )
return;
if ( F_25 ( V_2 -> V_54 + V_47 ) ) {
F_31 ( V_2 -> V_55 ) ;
V_2 -> V_55 = NULL ;
F_32 ( V_52 , V_2 -> V_53 ) ;
V_2 -> V_56 ++ ;
...
void F_35 ( struct V_1 * V_2 , struct V_58 * V_59 , T_5 V_62 )
{
T_1 V_35 , V_7 , V_8 ;
struct V_5 * V_6 ;
T_2 V_9 ;
...
if ( ! ( V_2 -> V_43 & V_44 ) )
return - V_34 ;
return F_42 ( V_78 -> V_82 , V_80 , sizeof( * V_80 ) ) ?
- V_83 : 0 ;
}
...
int F_44 ( struct V_1 * V_2 , struct V_77 * V_78 )
{
struct V_79 V_80 ;
int V_120 ;
if ( ! ( V_2 -> V_43 & V_44 ) )
return - V_34 ;
if ( F_45 ( & V_80 , V_78 -> V_82 , sizeof( V_80 ) ) )
return - V_83 ;
V_120 = F_43 ( V_2 , & V_80 ) ;
if ( V_120 )
return V_120 ;
...
V_2 -> V_19 . V_132 = F_19 ;
V_2 -> V_19 . V_133 = F_20 ;
V_2 -> V_121 = F_48 ( & V_2 -> V_19 , & V_2 -> V_48 -> V_49 ) ;
if ( F_49 ( V_2 -> V_121 ) )
...
if ( V_120 ) {
V_2 -> V_121 = NULL ;
F_55 ( & V_2 -> V_48 -> V_49 , L_4 ,
V_141 ) ;
} else if ( V_2 -> V_121 ) {
struct V_3 V_4 ;
T_1 V_85 ;
if ( V_2 -> V_6 . V_142 & V_143 )
F_52 ( & V_2 -> V_48 -> V_49 , L_5 ) ;
V_2 -> V_43 |= V_44 ;
V_85 = F_2 ( V_6 , V_114 ) ;
V_85 |= V_144 ;
F_6 ( V_6 , V_114 , V_85 ) ;
