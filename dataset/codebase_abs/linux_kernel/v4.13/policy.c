...
if ( ! V_22 )
goto V_30;
if ( V_19 > V_20 || V_19 < V_22 -> V_31 -> V_32 ||
V_20 > V_22 -> V_31 -> V_33 ) {
V_24 = - V_34 ;
goto V_30;
}
...
if ( ! V_22 )
goto V_30;
if ( V_19 > V_35 || V_20 > V_35 || V_19 > V_20 ||
V_20 >= V_22 -> V_31 -> V_36 ) {
V_24 = - V_34 ;
goto V_30;
}
...
& V_44 ) ;
V_2 -> V_29 = V_29 ;
V_2 -> V_7 = V_29 -> V_22 -> V_31 -> V_32 ;
V_2 -> V_8 = V_29 -> V_22 -> V_31 -> V_33 ;
V_2 -> V_9 = 0 ;
V_2 -> V_10 = V_29 -> V_22 -> V_31 -> V_36 - 1 ;
return & V_2 -> V_11 ;
}
static void
...
static struct V_37 *
F_27 ( struct V_37 * V_11 , const char * V_38 )
{
struct V_37 * V_24 ;
struct V_21 * V_22 ;
char * V_46 , * V_23 ;
V_46 = F_28 ( V_42 , L_5 , V_38 ) ;
if ( ! V_46 )
return F_16 ( - V_43 ) ;
V_23 = strrchr ( V_46 , '.' ) ;
if ( ! V_23 ) {
...
static struct V_1 *
F_31 ( struct V_14 * V_29 , char * V_49 )
{
struct V_1 * V_2 , * V_24 ;
...
if ( F_32 ( V_51 ) )
return NULL ;
V_16 = F_33 ( V_51 -> V_55 , struct V_15 , V_56 ) ;
V_24 = F_6 ( V_16 ) ;
V_55:
for (; ; ) {
V_53 = F_34 ( & V_54 , L_6 ) ;
...
struct V_1 *
F_36 ( struct V_21 * V_22 , char * V_49 )
{
struct V_1 * V_2 = NULL ;
F_9 ( & V_27 . V_28 ) ;
F_9 ( & V_22 -> V_45 ) ;
if ( V_22 -> V_29 )
V_2 = F_31 ( V_22 -> V_29 , V_49 ) ;
F_10 ( & V_22 -> V_45 ) ;
if ( V_2 )
F_37 ( & V_2 -> V_11 . V_12 ) ;
F_10 ( & V_27 . V_28 ) ;
