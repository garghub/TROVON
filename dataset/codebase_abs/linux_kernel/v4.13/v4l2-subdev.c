...
if ( ! V_4 -> V_6 . V_7 )
return NULL ;
V_149 = F_49 ( V_4 -> V_6 . V_7 , sizeof( * V_149 ) ,
V_17 | V_150 ) ;
if ( ! V_149 )
return NULL ;
V_16 = F_33 ( V_4 , V_8 , V_151 , V_149 ) ;
if ( V_16 < 0 && V_16 != - V_56 ) {
F_50 ( V_149 ) ;
return NULL ;
}
...
void F_51 ( struct V_3 * V_4 , const struct V_152 * V_153 )
{
F_52 ( & V_4 -> V_154 ) ;
F_53 ( ! V_153 ) ;
V_4 -> V_153 = V_153 ;
...
{
F_55 ( V_4 -> V_163 , V_162 ) ;
F_56 ( V_4 , V_164 , ( void * ) V_162 ) ;
}
