...
goto V_87;
V_88:
V_35 = V_3 -> V_89 ( V_72 , V_79 , V_78 , V_7 ) ;
if ( ! V_35 ) {
V_35 = - V_90 ;
goto V_87;
} else if ( V_35 < 0 )
...
goto V_93;
V_92 = F_31 ( & V_60 , L_7 ) ;
if ( ! strlen ( V_92 ) || strcmp ( V_92 , L_9 ) != 0 )
goto V_54;
if ( ! V_60 )
goto V_54;
V_35 = F_69 ( V_7 -> V_94 , V_60 , false , & V_12 ) ;
if ( V_35 )
goto V_54;
V_93:
V_91 = F_70 ( V_2 -> V_12 ) ;
...
struct V_1 * F_74 ( const char * V_31 )
{
struct V_1 * V_2 ;
if ( ! V_31 )
return NULL ;
F_28 (data, &named_triggers, named_list) {
if ( V_2 -> V_95 )
continue;
if ( strcmp ( V_2 -> V_31 , V_31 ) == 0 )
return V_2 ;
}
return NULL ;
}
bool F_75 ( struct V_1 * V_73 )
{
struct V_1 * V_2 ;
F_28 (data, &named_triggers, named_list) {
if ( V_73 == V_2 )
...
int F_76 ( const char * V_31 , struct V_1 * V_2 )
{
V_2 -> V_31 = F_73 ( V_31 , V_84 ) ;
if ( ! V_2 -> V_31 )
return - V_83 ;
F_43 ( & V_2 -> V_85 , & V_96 ) ;
return 0 ;
...
static void F_79 ( struct V_1 * V_2 , bool V_97 )
{
struct V_1 * V_73 ;
F_28 (test, &named_triggers, named_list) {
if ( strcmp ( V_73 -> V_31 , V_2 -> V_31 ) == 0 ) {
if ( V_97 ) {
V_73 -> V_98 = V_73 -> V_14 ;
V_73 -> V_14 = true ;
} else {
...
static int
F_90 ( struct V_18 * V_19 , struct V_62 * V_15 ,
struct V_1 * V_2 )
{
...
static int
F_91 ( struct V_18 * V_19 , struct V_62 * V_15 ,
struct V_1 * V_2 )
{
...
static int
F_96 ( char * V_72 , struct V_62 * V_15 ,
struct V_1 * V_2 ,
struct V_6 * V_7 )
{
...
static int
F_98 ( struct V_18 * V_19 , struct V_62 * V_15 ,
struct V_1 * V_2 )
{
...
static struct V_62 *
F_99 ( char * V_56 , char * V_77 )
{
return V_77 ? & V_103 : & V_104 ;
}
...
static T_5 int F_100 ( void ) { return 0 ; }
static void
F_102 ( struct V_1 * V_2 , void * V_8 )
{
F_103 ( V_106 ) ;
}
static void
F_104 ( struct V_1 * V_2 , void * V_8 )
{
if ( ! V_2 -> V_61 )
return;
if ( V_2 -> V_61 != - 1 )
...
static int
F_105 ( struct V_18 * V_19 , struct V_62 * V_15 ,
struct V_1 * V_2 )
{
...
static struct V_62 *
F_106 ( char * V_56 , char * V_77 )
{
return V_77 ? & V_107 : & V_108 ;
}
static T_5 int F_107 ( void )
{
int V_35 ;
V_35 = F_42 ( & V_109 ) ;
F_101 ( V_35 < 0 ) ;
...
static T_5 int F_107 ( void ) { return 0 ; }
...
static void
F_109 ( struct V_1 * V_2 , void * V_8 )
{
struct V_112 * V_113 = V_2 -> V_43 ;
if ( V_113 -> V_114 )
F_56 ( V_115 , & V_113 -> V_7 -> V_67 ) ;
else
F_53 ( V_115 , & V_113 -> V_7 -> V_67 ) ;
}
static void
F_110 ( struct V_1 * V_2 , void * V_8 )
{
struct V_112 * V_113 = V_2 -> V_43 ;
if ( ! V_2 -> V_61 )
return;
if ( V_113 -> V_114 == ! ( V_113 -> V_7 -> V_67 & V_116 ) )
return;
if ( V_2 -> V_61 != - 1 )
( V_2 -> V_61 ) -- ;
F_109 ( V_2 , V_8 ) ;
...
F_25 ( V_19 , L_14 ,
V_113 -> V_117 ?
( V_113 -> V_114 ? V_118 : V_119 ) :
( V_113 -> V_114 ? V_120 : V_121 ) ,
V_113 -> V_7 -> V_94 -> V_122 -> system ,
F_112 ( V_113 -> V_7 -> V_94 ) ) ;
if ( V_2 -> V_61 == - 1 )
F_22 ( V_19 , L_4 ) ;
else
...
if ( ! V_2 -> V_63 ) {
F_54 ( V_113 -> V_7 , 0 , 1 ) ;
F_114 ( V_113 -> V_7 -> V_94 -> V_123 ) ;
F_1 ( V_2 ) ;
F_3 ( V_113 ) ;
}
}
int F_115 ( struct V_28 * V_3 ,
struct V_6 * V_7 ,
char * V_72 , char * V_56 , char * V_77 )
{
struct V_6 * V_124 ;
...
V_125 = F_31 ( & V_80 , L_8 ) ;
V_35 = - V_47 ;
V_124 = F_116 ( V_69 , system , V_125 ) ;
if ( ! V_124 )
goto V_54;
#ifdef F_117
V_117 = ( ( strcmp ( V_56 , V_118 ) == 0 ) ||
( strcmp ( V_56 , V_119 ) == 0 ) ) ;
V_114 = ( ( strcmp ( V_56 , V_120 ) == 0 ) ||
( strcmp ( V_56 , V_118 ) == 0 ) ) ;
#else
V_114 = strcmp ( V_56 , V_120 ) == 0 ;
#endif
...
void F_121 ( char * V_72 ,
struct V_62 * V_15 ,
struct V_1 * V_73 ,
struct V_6 * V_7 )
{
struct V_112 * V_128 = V_73 -> V_43 ;
struct V_112 * V_113 ;
struct V_1 * V_2 ;
bool V_76 = false ;
F_6 (data, &file->triggers, list) {
