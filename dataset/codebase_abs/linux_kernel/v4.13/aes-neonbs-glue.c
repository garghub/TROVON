...
if ( V_9 )
return V_9 ;
memcpy ( V_6 -> V_37 , V_8 . V_11 , sizeof( V_6 -> V_37 ) ) ;
...
V_9 = F_10 ( & V_18 , V_13 , true ) ;
F_4 () ;
F_26 ( V_18 . V_33 , V_18 . V_33 , V_6 -> V_37 ,
V_6 -> V_30 . V_10 , 1 , 1 ) ;
while ( V_18 . V_19 >= V_20 ) {
unsigned int V_16 = V_18 . V_19 / V_20 ;
if ( V_18 . V_19 < V_18 . V_21 )
...
{
return F_25 ( V_13 , V_38 ) ;
}
static int F_28 ( struct V_12 * V_13 )
{
return F_25 ( V_13 , V_39 ) ;
}
