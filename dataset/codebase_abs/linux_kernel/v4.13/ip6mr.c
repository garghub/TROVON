...
static int
F_148 ( struct V_1 * V_4 , T_6 V_202 , struct V_32 * V_33 )
{
bool V_222 = false ;
int V_7 ;
struct V_60 * V_163 ;
...
F_152 ( & V_163 -> V_95 . V_166 . V_167 , V_33 ) ;
V_7 = 0 ;
}
F_39 ( & V_68 ) ;
return V_7 ;
}
static int F_153 ( struct V_1 * V_4 , struct V_226 * V_64 ,
int V_227 )
{
int line ;
struct V_60 * V_163 , * V_49 ;
...
static int F_154 ( struct V_231 * V_232 ,
unsigned long V_233 , void * V_234 )
{
struct V_106 * V_82 = F_155 ( V_234 ) ;
struct V_2 * V_2 = F_63 ( V_82 ) ;
struct V_1 * V_4 ;
struct V_69 * V_79 ;
int V_66 ;
...
#ifdef F_157
V_7 = - V_46 ;
if ( ! F_158 ( L_13 , 0 , V_2 -> V_238 , & V_239 ) )
goto V_240;
if ( ! F_158 ( L_14 , 0 , V_2 -> V_238 , & V_241 ) )
goto V_242;
#endif
return 0 ;
#ifdef F_157
V_242:
F_159 ( L_13 , V_2 -> V_238 ) ;
V_240:
F_20 ( V_2 ) ;
#endif
V_237:
...
goto V_247;
#ifdef F_28
if ( F_165 ( & V_248 , V_120 ) < 0 ) {
F_166 ( L_16 , V_249 ) ;
V_7 = - V_31 ;
goto V_250;
}
#endif
F_167 ( V_251 , V_252 , NULL ,
V_253 , NULL ) ;
return 0 ;
#ifdef F_28
V_250:
...
V_163 -> V_257 |= V_258 ;
F_93 ( & V_65 ) ;
F_151 ( & V_163 -> V_50 , & V_4 -> V_55 [ line ] ) ;
F_94 ( & V_65 ) ;
V_222 = false ;
F_38 ( & V_68 ) ;
...
static int F_179 ( struct V_1 * V_4 , struct V_260 * V_261 )
{
int V_7 = 0 ;
struct V_2 * V_2 = F_180 ( V_261 ) ;
F_21 () ;
F_93 ( & V_65 ) ;
if ( F_181 ( V_4 -> V_221 == NULL ) ) {
V_4 -> V_221 = V_261 ;
...
struct V_260 * F_183 ( struct V_2 * V_2 , struct V_32 * V_33 )
{
struct V_1 * V_4 ;
struct V_5 V_108 = {
. V_109 = V_33 -> V_132 ? : V_133 ,
...
int F_184 ( struct V_260 * V_261 , int V_264 , char T_8 * V_265 , unsigned int V_266 )
{
int V_213 , V_227 = 0 ;
struct V_185 V_80 ;
struct V_226 V_64 ;
...
F_185 ( V_261 ) -> V_269 != V_270 )
return - V_271 ;
V_4 = F_1 ( V_2 , F_186 ( V_261 ) -> V_272 ? : V_45 ) ;
if ( ! V_4 )
return - V_77 ;
if ( V_264 != V_273 ) {
if ( V_261 != V_4 -> V_221 && ! F_187 ( V_2 -> V_274 , V_275 ) )
return - V_26 ;
}
switch ( V_264 ) {
case V_273 :
if ( V_266 < sizeof( int ) )
return - V_28 ;
return F_179 ( V_4 , V_261 ) ;
case V_276 :
return F_182 ( V_261 ) ;
case V_277 :
if ( V_266 < sizeof( V_80 ) )
return - V_28 ;
if ( F_188 ( & V_80 , V_265 , sizeof( V_80 ) ) )
return - V_278 ;
if ( V_80 . V_188 >= V_183 )
return - V_255 ;
F_21 () ;
...
if ( V_266 < sizeof( T_6 ) )
return - V_28 ;
if ( F_188 ( & V_202 , V_265 , sizeof( T_6 ) ) )
return - V_278 ;
F_21 () ;
...
return - V_28 ;
if ( F_188 ( & V_64 , V_265 , sizeof( V_64 ) ) )
return - V_278 ;
if ( V_227 == 0 )
V_227 = V_64 . V_254 ;
F_21 () ;
if ( V_264 == V_281 || V_264 == V_283 )
V_213 = F_153 ( V_4 , & V_64 , V_227 ) ;
else
V_213 = F_174 ( V_2 , V_4 , & V_64 ,
...
int F_190 ( struct V_260 * V_261 , int V_264 , char T_8 * V_265 ,
int T_8 * V_266 )
{
int V_292 ;
int V_293 ;
...
if ( F_189 ( V_292 , V_266 ) )
return - V_278 ;
V_292 = F_191 ( int , V_292 , sizeof( int ) ) ;
if ( V_292 < 0 )
return - V_28 ;
if ( F_192 ( V_292 , V_266 ) )
return - V_278 ;
if ( F_193 ( V_265 , & V_293 , V_292 ) )
return - V_278 ;
return 0 ;
}
int F_194 ( struct V_260 * V_261 , int V_295 , void T_8 * V_11 )
{
struct V_296 V_297 ;
struct V_298 V_299 ;
struct V_69 * V_80 ;
...
switch ( V_295 ) {
case V_300 :
if ( F_188 ( & V_299 , V_11 , sizeof( V_299 ) ) )
return - V_278 ;
...
F_37 ( & V_65 ) ;
if ( F_193 ( V_11 , & V_299 , sizeof( V_299 ) ) )
return - V_278 ;
return 0 ;
}
F_37 ( & V_65 ) ;
return - V_156 ;
case V_305 :
if ( F_188 ( & V_297 , V_11 , sizeof( V_297 ) ) )
return - V_278 ;
F_35 ( & V_65 ) ;
...
F_37 ( & V_65 ) ;
if ( F_193 ( V_11 , & V_297 , sizeof( V_297 ) ) )
return - V_278 ;
return 0 ;
}
F_37 ( & V_65 ) ;
...
int F_195 ( struct V_260 * V_261 , unsigned int V_295 , void T_8 * V_11 )
{
struct V_311 V_297 ;
struct V_312 V_299 ;
struct V_69 * V_80 ;
...
static inline int F_196 ( struct V_2 * V_2 , struct V_260 * V_261 , struct V_32 * V_33 )
{
F_197 ( V_2 , F_198 ( F_144 ( V_33 ) ) ,
V_313 ) ;
F_199 ( V_2 , F_198 ( F_144 ( V_33 ) ) ,
V_314 , V_33 -> V_121 ) ;
return F_200 ( V_2 , V_261 , V_33 ) ;
}
static int F_201 ( struct V_2 * V_2 , struct V_1 * V_4 ,
...
V_80 -> V_86 ++ ;
V_80 -> V_85 += V_33 -> V_121 ;
if ( F_205 ( V_33 , sizeof( * V_315 ) + F_206 ( V_82 ) ) )
goto V_318;
V_315 = F_67 ( V_33 ) ;
V_315 -> V_319 -- ;
F_207 ( V_33 ) -> V_13 |= V_320 ;
return F_208 ( V_321 , V_322 ,
...
static int F_209 ( struct V_1 * V_4 , struct V_106 * V_82 )
{
int V_66 ;
...
if ( V_323 != - 1 ) {
struct V_32 * V_330 = F_210 ( V_33 , V_208 ) ;
if ( V_330 )
F_201 ( V_2 , V_4 , V_330 , V_67 , V_323 ) ;
}
V_323 = V_66 ;
}
}
V_329:
if ( V_323 != - 1 ) {
F_201 ( V_2 , V_4 , V_33 , V_67 , V_323 ) ;
return;
}
V_328:
F_80 ( V_33 ) ;
}
int F_211 ( struct V_32 * V_33 )
{
struct V_60 * V_67 ;
struct V_2 * V_2 = F_63 ( V_33 -> V_82 ) ;
struct V_1 * V_4 ;
...
if ( ! V_67 ) {
int V_80 ;
V_80 = F_209 ( V_4 , V_33 -> V_82 ) ;
if ( V_80 >= 0 ) {
int V_7 = F_148 ( V_4 , V_80 , V_33 ) ;
F_37 ( & V_65 ) ;
return V_7 ;
}
F_37 ( & V_65 ) ;
...
F_216 ( V_33 , V_336 ) ;
V_184 = F_217 ( V_163 -> V_95 . V_9 . V_184 ) ;
V_184 = F_218 ( V_178 , V_184 ) ? V_178 - V_184 : 0 ;
V_335 . V_347 = V_163 -> V_95 . V_9 . V_96 ;
V_335 . V_348 = V_163 -> V_95 . V_9 . V_97 ;
V_335 . V_349 = V_163 -> V_95 . V_9 . V_98 ;
if ( F_219 ( V_33 , V_350 , sizeof( V_335 ) , & V_335 , V_351 ) ||
F_220 ( V_33 , V_352 , F_221 ( V_184 ) ,
V_351 ) )
return - V_210 ;
V_333 -> V_353 = V_354 ;
return 1 ;
}
int F_222 ( struct V_2 * V_2 , struct V_32 * V_33 , struct V_332 * V_333 ,
T_1 V_176 )
{
int V_7 ;
struct V_1 * V_4 ;
...
static int F_223 ( struct V_1 * V_4 , struct V_32 * V_33 ,
...
struct V_332 * V_333 ;
int V_7 ;
V_170 = F_224 ( V_33 , V_176 , V_75 , V_295 , sizeof( * V_333 ) , V_13 ) ;
if ( ! V_170 )
return - V_210 ;
V_333 = F_107 ( V_170 ) ;
V_333 -> V_367 = V_251 ;
...
V_333 -> V_376 = V_378 ;
V_333 -> V_339 = 0 ;
if ( F_225 ( V_33 , V_379 , & V_163 -> V_93 ) ||
F_225 ( V_33 , V_380 , & V_163 -> V_92 ) )
goto V_373;
...
static int F_228 ( bool V_167 , int V_72 )
{
T_9 V_121 =
F_229 ( sizeof( struct V_332 ) )
+ F_230 ( 4 )
+ F_230 ( sizeof( struct V_199 ) )
+ F_230 ( sizeof( struct V_199 ) )
;
if ( ! V_167 )
V_121 = V_121
+ F_230 ( 4 )
+ F_230 ( 0 )
+ V_72 * F_231 ( sizeof( struct V_337 ) )
+ F_232 ( sizeof( struct V_334 ) )
;
return V_121 ;
}
...
struct V_32 * V_33 ;
int V_7 = - V_191 ;
V_33 = F_233 ( F_228 ( V_64 -> V_94 >= V_183 , V_4 -> V_72 ) ,
V_208 ) ;
if ( ! V_33 )
goto V_381;
V_7 = F_223 ( V_4 , V_33 , 0 , 0 , V_64 , V_295 , 0 ) ;
if ( V_7 < 0 )
goto V_381;
F_234 ( V_33 , V_2 , 0 , V_382 , NULL , V_208 ) ;
return;
V_381:
F_80 ( V_33 ) ;
if ( V_7 < 0 )
...
static T_9 F_236 ( T_9 V_383 )
{
T_9 V_121 =
F_229 ( sizeof( struct V_384 ) )
+ F_230 ( 1 )
+ F_230 ( 4 )
+ F_230 ( sizeof( struct V_199 ) )
+ F_230 ( sizeof( struct V_199 ) )
...
static void F_145 ( struct V_1 * V_4 , struct V_32 * V_96 )
{
struct V_2 * V_2 = F_102 ( & V_4 -> V_2 ) ;
struct V_169 * V_170 ;
struct V_384 * V_385 ;
...
struct V_36 * V_386 ;
int V_383 ;
V_383 = V_96 -> V_121 - sizeof( struct V_211 ) ;
V_212 = (struct V_211 * ) F_65 ( V_96 ) ;
V_33 = F_233 ( F_236 ( V_383 ) , V_208 ) ;
if ( ! V_33 )
goto V_381;
V_170 = F_224 ( V_33 , 0 , 0 , V_387 ,
sizeof( struct V_384 ) , 0 ) ;
if ( ! V_170 )
goto V_381;
V_385 = F_107 ( V_170 ) ;
V_385 -> V_388 = V_251 ;
if ( F_237 ( V_33 , V_389 , V_212 -> V_216 ) ||
F_212 ( V_33 , V_390 , V_212 -> V_217 ) ||
F_225 ( V_33 , V_391 ,
& V_212 -> V_219 ) ||
F_225 ( V_33 , V_392 ,
& V_212 -> V_220 ) )
goto V_373;
V_386 = F_238 ( V_33 , V_393 , V_383 ) ;
if ( ! V_386 || F_239 ( V_96 , sizeof( struct V_211 ) ,
F_240 ( V_386 ) , V_383 ) )
goto V_373;
F_226 ( V_33 , V_170 ) ;
F_234 ( V_33 , V_2 , 0 , V_394 , NULL , V_208 ) ;
return;
V_373:
F_227 ( V_33 , V_170 ) ;
V_381:
F_80 ( V_33 ) ;
F_235 ( V_2 , V_394 , - V_191 ) ;
}
static int V_253 ( struct V_32 * V_33 , struct V_395 * V_396 )
{
struct V_2 * V_2 = F_180 ( V_33 -> V_261 ) ;
struct V_1 * V_4 ;
struct V_60 * V_64 ;
unsigned int V_397 = 0 , V_398 ;
unsigned int V_399 = 0 , V_400 ;
unsigned int V_401 = 0 , V_402 ;
V_398 = V_396 -> args [ 0 ] ;
V_400 = V_396 -> args [ 1 ] ;
V_402 = V_396 -> args [ 2 ] ;
F_35 ( & V_65 ) ;
...
if ( V_397 > V_398 )
V_400 = 0 ;
for ( V_399 = V_400 ; V_399 < V_54 ; V_399 ++ ) {
F_36 (mfc, &mrt->mfc6_cache_array[h], list) {
if ( V_401 < V_402 )
goto V_404;
if ( F_223 ( V_4 , V_33 ,
F_109 ( V_396 -> V_33 ) . V_176 ,
V_396 -> V_170 -> V_405 ,
V_64 , V_224 ,
V_406 ) < 0 )
goto V_407;
