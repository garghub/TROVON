...
V_40 = F_18 ( V_14 -> V_21 , V_5 -> V_22 , V_9 -> V_23 , V_24 ) ;
if ( V_40 < 0 )
return V_40 ;
F_19 ( & V_9 -> V_25 , V_14 -> V_17 . V_18 , V_45 ) ;
V_40 = F_18 ( V_14 -> V_21 , & V_9 -> V_25 , 1 , V_26 ) ;
if ( V_40 < 0 )
goto V_46;
V_40 = F_20 ( & V_14 -> V_17 , V_5 -> V_22 , V_9 -> V_23 ,
& V_9 -> V_25 , 1 , F_1 , V_3 ) ;
if ( V_40 )
goto V_47;
F_21 ( & V_14 -> V_17 ) ;
V_40 = F_22 ( V_3 , V_11 -> V_48 , 0 , 0 ) ;
if ( V_40 )
goto V_49;
return 0 ;
V_49:
...
static int F_24 ( struct V_4 * V_5 , void * V_53 )
{
struct V_6 * V_7 = F_3 ( V_5 ) ;
struct V_8 * V_9 = F_4 ( V_5 ) ;
unsigned long V_39 = V_9 -> V_39 ;
...
static int F_32 ( struct V_4 * V_5 , T_2 V_64 ,
...
F_29 ( ( V_58 * ) V_9 -> V_27 , ( const T_3 * ) V_59 ,
V_19 ) ;
V_9 -> V_69 = ( unsigned int ) ( V_64 & ( V_54 - 1 ) ) ;
return 0 ;
}
static int F_33 ( struct V_4 * V_5 , const void * V_70 )
{
struct V_8 * V_9 = F_4 ( V_5 ) ;
unsigned long V_39 = V_9 -> V_39 ;
bool V_65 = F_14 ( V_39 ) ;
...
V_40 = F_32 ( V_5 , V_59 -> V_57 , V_59 -> V_59 ,
V_59 -> V_60 , V_65 ) ;
} else if ( F_30 ( V_39 ) || F_31 ( V_39 ) ) {
...
if ( V_74 <= V_54 ) {
F_35 ( V_9 -> V_61 + V_9 -> V_69 , V_5 -> V_22 ,
0 , V_5 -> V_32 , 0 ) ;
V_9 -> V_69 += V_5 -> V_32 ;
return 0 ;
}
...
if ( V_9 -> V_69 ) {
F_39 ( V_9 -> V_73 , 2 ) ;
F_40 ( V_9 -> V_73 , V_9 -> V_77 , V_9 -> V_69 ) ;
F_41 ( V_9 -> V_73 , 2 , V_5 -> V_22 ) ;
V_5 -> V_22 = V_9 -> V_73 ;
}
V_5 -> V_32 = V_32 ;
V_9 -> V_69 = V_76 ;
...
V_9 -> V_33 = V_5 -> V_32 ;
memcpy ( V_9 -> V_77 , V_9 -> V_61 , V_9 -> V_69 ) ;
F_19 ( V_9 -> V_73 , V_9 -> V_77 , V_9 -> V_69 ) ;
V_5 -> V_22 = V_9 -> V_73 ;
V_5 -> V_32 = V_9 -> V_69 ;
return V_14 -> V_79 ( V_11 -> V_14 , & V_5 -> V_50 ) ;
}
...
static void F_44 ( struct V_2 * V_5 , int error )
{
...
static int F_46 ( struct V_6 * V_12 , const T_3 * V_83 ,
unsigned int V_84 )
{
...
static int F_62 ( struct V_99 * V_12 )
{
struct V_6 * V_7 = F_63 ( V_12 ) ;
struct V_37 * V_38 = F_13 ( V_12 ) ;
F_64 ( V_7 , sizeof( struct V_8 ) ) ;
memset ( V_38 , 0 , sizeof( * V_38 ) ) ;
return 0 ;
}
static int F_65 ( const struct V_100 * V_101 ,
struct V_13 * V_14 )
{
struct V_10 * V_11 ;
struct V_102 * V_103 ;
...
V_50 -> V_121 = F_62 ;
F_66 ( & V_50 -> V_122 ) ;
snprintf ( V_50 -> V_123 , V_124 , L_6 , V_101 -> V_125 ) ;
snprintf ( V_50 -> V_126 , V_124 , L_6 ,
V_101 -> V_127 ) ;
F_66 ( & V_11 -> V_128 ) ;
V_11 -> V_48 = V_89 ;
...
if ( V_40 ) {
F_59 ( V_11 ) ;
F_17 ( V_14 -> V_21 , L_7 , V_50 -> V_123 ) ;
return V_40 ;
}
F_68 ( & V_11 -> V_128 , & V_129 ) ;
F_8 ( V_14 -> V_21 , L_8 , V_50 -> V_123 ) ;
return 0 ;
}
