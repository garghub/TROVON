...
if ( V_96 < 0 )
return V_96 ;
return V_96 * V_86 -> V_98 * V_86 -> V_97 ;
}
...
static void F_72 ( struct V_14 * V_15 , struct V_46 * V_47 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
...
static int F_74 ( struct V_14 * V_15 , struct V_157 * V_158 ,
struct V_46 * V_47 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
int V_231 = 0 ;
...
unsigned int V_234 ;
V_231 |= F_75 ( & V_47 -> V_235 , V_223 | V_236 ) ;
V_234 = V_221 ;
if ( V_9 -> V_10 == V_11 )
V_234 |= V_237 ;
else
V_234 |= V_238 ;
V_231 |= F_75 ( & V_47 -> V_224 , V_234 ) ;
V_234 = V_221 ;
if ( V_9 -> V_10 == V_11 )
V_234 |= V_223 ;
else
V_234 |= V_236 ;
V_231 |= F_75 ( & V_47 -> V_220 , V_234 ) ;
V_231 |= F_75 ( & V_47 -> V_239 , V_240 ) ;
V_231 |= F_75 ( & V_47 -> V_241 ,
V_240 | V_236 | V_242 ) ;
if ( V_231 )
return 1 ;
V_231 |= F_76 ( V_47 -> V_235 ) ;
V_231 |= F_76 ( V_47 -> V_224 ) ;
V_231 |= F_76 ( V_47 -> V_220 ) ;
V_231 |= F_76 ( V_47 -> V_241 ) ;
...
V_231 |= F_78 ( & V_47 -> V_226 , 1 ) ;
V_231 |= F_77 ( & V_47 -> V_245 ,
V_47 -> V_226 ) ;
switch ( V_47 -> V_241 ) {
case V_236 :
break;
case V_240 :
V_231 |= F_78 ( & V_47 -> V_246 , 1 ) ;
break;
case V_242 :
V_231 |= F_77 ( & V_47 -> V_246 , 0 ) ;
break;
default:
break;
}
...
static inline unsigned int F_81 ( struct V_14 * V_15 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned int V_94 ;
...
static T_3 F_82 ( const struct V_14 * V_15 ,
const struct V_46 * V_47 )
{
...
static T_3 F_84 ( struct V_14 * V_15 ,
struct V_46 * V_47 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned int V_198 ;
...
unsigned long V_32 ;
F_25 ( & V_15 -> V_33 , V_32 ) ;
F_88 ( V_253 | V_254 | V_255 ,
V_30 -> V_34 + F_89 ( V_1 ) ) ;
F_27 ( & V_15 -> V_33 , V_32 ) ;
}
static void F_90 ( struct V_14 * V_15 , struct V_46 * V_47 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
T_3 V_256 = 0 , V_257 = 0 ;
...
F_86 ( V_15 , V_47 ) ;
if ( V_9 -> V_10 == V_11 ) {
V_256 = F_84 ( V_15 , V_47 ) ;
} else {
V_256 = F_82 ( V_15 , V_47 ) ;
V_257 = F_83 ( V_15 , V_47 ) ;
}
F_31 ( V_256 & 0xffff ,
V_30 -> V_44 + V_187 ) ;
F_31 ( ( V_256 >> 16 ) & 0xff ,
...
static int F_91 ( const struct V_46 * V_47 )
{
int V_115 ;
...
struct V_29 * V_30 = V_15 -> V_31 ;
if ( V_267 ) {
F_29 ( 0 , V_30 -> V_34 + V_269 ) ;
F_29 ( 0 , V_30 -> V_34 + V_270 ) ;
F_29 ( 0 , V_30 -> V_34 + V_271 ) ;
F_29 ( V_268 ,
V_30 -> V_34 + V_272 ) ;
} else {
F_29 ( 0 , V_30 -> V_34 + V_273 ) ;
F_29 ( 0 , V_30 -> V_34 + V_274 ) ;
F_29 ( 0 , V_30 -> V_34 + V_275 ) ;
F_29 ( V_268 ,
V_30 -> V_34 + V_276 ) ;
}
}
static int F_94 ( struct V_14 * V_15 , struct V_157 * V_158 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_277 * V_278 = V_158 -> V_278 ;
struct V_46 * V_47 = & V_278 -> V_47 ;
T_3 V_23 ;
unsigned int V_115 ;
unsigned long V_32 ;
int V_96 ;
...
V_23 |= V_287 ;
F_31 ( V_23 , V_30 -> V_44 + V_288 ) ;
}
F_25 ( & V_15 -> V_33 , V_32 ) ;
V_23 = V_289 | V_80 | V_81 ;
if ( V_47 -> V_32 & V_48 )
V_23 |= V_79 ;
if ( V_47 -> V_235 == V_236 ) {
V_23 |= V_290 ;
...
F_27 ( & V_15 -> V_33 , V_32 ) ;
if ( V_47 -> V_235 == V_223 )
F_31 ( 0 , V_30 -> V_44 + V_296 ) ;
return 0 ;
}
static void F_95 ( struct V_14 * V_15 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_297 ;
unsigned int V_115 ;
T_1 V_6 ;
int V_298 , V_299 , V_300 , V_301 ;
int V_94 ;
do {
V_299 = F_58 ( V_30 -> V_44 + V_302 ) &
0x7fff ;
V_301 = F_58 ( V_30 -> V_44 + V_164 ) &
0x7fff ;
V_6 = F_58 ( V_30 -> V_44 + V_303 ) ;
V_298 = F_13 ( V_6 ) ;
V_300 = F_14 ( V_6 ) ;
if ( V_298 != V_300 )
V_94 =
...
int V_308 =
F_58 ( V_30 -> V_44 + V_302 ) & 0x7fff ;
V_305 = F_96 ( V_158 , 100000 ) ;
for ( V_115 = 0 ; V_308 != V_307 && V_115 < V_305 ; ) {
unsigned short V_304 ;
V_306 = F_34 ( V_15 -> V_190 + V_132 ) ;
V_304 = V_306 & 0xffff ;
F_97 ( V_158 , & V_304 , 1 ) ;
V_115 ++ ;
if ( V_115 < V_305 ) {
V_304 = ( V_306 >> 16 ) & 0xffff ;
F_97 ( V_158 , & V_304 , 1 ) ;
V_115 ++ ;
}
V_308 = F_58 ( V_30 -> V_44 + V_302 ) &
0x7fff ;
}
}
...
static void F_100 ( struct V_14 * V_15 , unsigned int V_1 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_297 ;
...
int V_94 = 0 ;
void T_4 * V_311 ;
V_311 = V_30 -> V_34 + F_101 ( V_1 ) ;
for ( V_310 = 0 , V_309 = F_34 ( V_311 ) ;
( V_309 <
V_30 -> V_118 [ V_30 -> V_285 ] ||
V_309 >=
V_30 -> V_118 [ V_30 -> V_285 ] +
V_117 ) && V_310 < F_17 ( V_9 ) ; V_310 ++ ) {
V_94 = F_96 ( V_158 , F_81 ( V_15 ) ) ;
F_97 ( V_158 ,
V_30 -> V_116 [ V_30 -> V_285 ] ,
V_94 ) ;
V_30 -> V_285 = ( V_30 -> V_285 + 1 ) %
F_17 ( V_9 ) ;
}
}
...
F_25 ( & V_15 -> V_33 , V_32 ) ;
V_313 = F_103 ( V_30 -> V_34 + V_317 ) ;
if ( V_312 & V_318 ) {
F_88 ( ( V_313 & V_253 ) | V_255 ,
V_30 -> V_34 + V_317 ) ;
if ( V_313 & V_253 )
F_100 ( V_15 , 1 ) ;
}
...
if ( ( V_47 -> V_241 == V_240 &&
V_278 -> V_321 >= V_47 -> V_246 ) ||
( V_47 -> V_241 == V_236 && ( V_162 & V_322 ) ) )
V_278 -> V_315 |= V_323 ;
F_104 ( V_15 , V_158 ) ;
}
static inline unsigned int F_105 ( struct V_14 * V_15 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned int V_324 ;
if ( V_30 -> V_325 == 0 )
...
V_324 = F_105 ( V_15 ) ;
V_327 = F_103 ( V_30 -> V_34 + V_328 ) ;
if ( ( V_327 & V_329 ) == 0 )
return 0 ;
V_326 =
F_34 ( V_30 -> V_34 + V_274 ) ;
if ( V_326 != V_30 -> V_123 [ V_324 ] )
return 0 ;
return 1 ;
}
static inline int F_107 ( struct V_14 * V_15 ,
unsigned short V_327 )
{
if ( ( V_327 & V_329 ) == 0 ||
( V_327 & V_253 ) == 0 )
...
unsigned int V_333 )
{
unsigned int V_305 = F_110 ( V_158 , V_333 ) ;
unsigned int V_334 ;
V_305 = F_96 ( V_158 , V_305 ) ;
V_334 = F_111 ( V_158 , V_332 , V_305 ) ;
return F_110 ( V_158 , V_334 ) ;
}
static unsigned int F_112 ( struct V_14 * V_15 ,
const struct V_46 * V_47 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_260 ;
unsigned int V_324 = V_30 -> V_325 ;
unsigned int V_335 = F_105 ( V_15 ) ;
unsigned int V_305 ;
unsigned int V_336 ;
unsigned int V_337 ;
V_305 = F_109 ( V_15 , V_158 ,
V_30 -> V_122 [ V_324 ] ,
V_117 ) ;
if ( V_305 == 0 )
return 0 ;
V_336 = F_113 ( V_158 , V_305 ) ;
V_30 -> V_127 [ V_324 ] . V_134 = F_45 ( V_336 ) ;
V_337 = F_114 ( V_30 -> V_127 [ V_324 ] . V_135 ) ;
V_337 |= V_331 ;
V_30 -> V_127 [ V_324 ] . V_135 = F_45 ( V_337 ) ;
V_337 = F_114 ( V_30 -> V_127 [ V_335 ] . V_135 ) ;
V_337 &= ~ V_331 ;
V_30 -> V_127 [ V_335 ] . V_135 = F_45 ( V_337 ) ;
V_30 -> V_325 = ( V_324 + 1 ) % V_121 ;
return V_336 ;
}
static void F_115 ( struct V_14 * V_15 , const struct V_46 * V_47 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned int V_338 ;
unsigned int V_309 ;
void T_4 * V_311 = V_30 -> V_34 + V_274 ;
unsigned int V_324 ;
do {
V_324 = V_30 -> V_325 ;
V_309 = F_34 ( V_311 ) ;
...
V_117 )
return;
V_338 = F_112 ( V_15 , V_47 ) ;
} while ( V_338 >= V_117 );
}
static void F_116 ( struct V_14 * V_15 ,
unsigned short V_162 , unsigned int V_312 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_260 ;
struct V_277 * V_278 ;
...
static T_5 F_117 ( int V_342 , void * V_343 )
{
...
T_3 V_312 ;
T_3 V_344 ;
V_312 = F_34 ( V_30 -> V_34 + V_36 ) ;
V_162 = F_58 ( V_30 -> V_44 + V_163 ) ;
if ( ! V_15 -> V_345 )
return V_346 ;
F_102 ( V_15 , V_162 , V_312 ) ;
F_116 ( V_15 , V_162 , V_312 ) ;
if ( V_312 & V_347 ) {
...
static int F_118 ( struct V_14 * V_15 , struct V_157 * V_158 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned long V_32 ;
F_25 ( & V_15 -> V_33 , V_32 ) ;
...
static int F_119 ( struct V_14 * V_15 , struct V_157 * V_158 ,
struct V_159 * V_160 , unsigned int * V_152 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
...
static unsigned int F_123 ( unsigned int V_206 , unsigned int V_32 )
{
...
if ( V_47 -> V_224 != V_221 )
return;
V_198 = F_123 ( V_47 -> V_225 , V_47 -> V_32 ) ;
if ( V_198 > V_216 ) {
F_22 ( V_15 -> V_27 , L_14 ) ;
V_198 = V_216 ;
}
...
static int F_125 ( struct V_14 * V_15 , const struct V_46 * V_47 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_260 ;
unsigned int V_305 ;
...
int V_115 ;
F_31 ( 0 , V_30 -> V_44 + V_263 ) ;
F_31 ( 0 , V_30 -> V_44 + V_262 ) ;
V_305 = F_109 ( V_15 , V_158 ,
V_30 -> V_367 ,
V_368 ) ;
if ( V_305 == 0 )
return - 1 ;
for ( V_115 = 0 ; V_115 < V_305 ; V_115 ++ ) {
F_31 ( V_30 -> V_367 [ V_115 ] ,
V_30 -> V_44 + V_139 ) ;
}
if ( V_47 -> V_241 == V_240 &&
V_158 -> V_278 -> V_321 >= V_47 -> V_246 )
return 0 ;
V_336 = F_112 ( V_15 , V_47 ) ;
if ( V_336 == 0 )
return - 1 ;
F_115 ( V_15 , V_47 ) ;
F_87 ( V_15 , 0 ) ;
...
static inline int F_126 ( struct V_14 * V_15 ,
struct V_157 * V_158 ,
struct V_46 * V_47 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
...
{
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_46 * V_47 = & V_158 -> V_278 -> V_47 ;
int V_96 ;
if ( V_369 != V_47 -> V_243 )
return - V_193 ;
V_96 = F_125 ( V_15 , V_47 ) ;
if ( V_96 < 0 )
return - V_370 ;
F_120 ( V_15 , V_47 ) ;
if ( V_47 -> V_235 == V_371 )
F_31 ( 0 , V_30 -> V_44 + V_372 ) ;
V_158 -> V_278 -> V_373 = NULL ;
return 0 ;
}
...
F_122 ( V_15 , V_47 ) ;
F_124 ( V_15 , V_47 ) ;
F_93 ( V_15 , 0 , V_30 -> V_128 |
V_136 | V_137 ) ;
F_121 ( V_15 , V_47 ) ;
V_158 -> V_278 -> V_373 = F_127 ;
return 0 ;
}
...
int V_231 = 0 ;
unsigned int V_232 ;
V_231 |= F_75 ( & V_47 -> V_235 , V_371 | V_236 ) ;
V_231 |= F_75 ( & V_47 -> V_224 ,
V_221 | V_236 ) ;
V_231 |= F_75 ( & V_47 -> V_220 , V_223 ) ;
V_231 |= F_75 ( & V_47 -> V_239 , V_240 ) ;
V_231 |= F_75 ( & V_47 -> V_241 , V_242 ) ;
if ( V_231 )
return 1 ;
V_231 |= F_76 ( V_47 -> V_235 ) ;
V_231 |= F_76 ( V_47 -> V_224 ) ;
...
V_231 |= F_77 ( & V_47 -> V_243 , 0 ) ;
if ( V_47 -> V_224 == V_221 ) {
V_231 |= F_78 ( & V_47 -> V_225 ,
V_9 -> V_374 ) ;
if ( F_123 ( V_47 -> V_225 , V_47 -> V_32 ) >
V_216 ) {
V_47 -> V_225 = ( V_216 + 2 ) *
V_209 ;
V_231 |= - V_193 ;
...
return 4 ;
if ( V_47 -> V_228 && V_47 -> V_226 > 0 )
V_231 |= F_129 ( V_15 , V_158 , V_47 ) ;
if ( V_231 )
return 5 ;
return 0 ;
}
static int F_131 ( struct V_14 * V_15 , struct V_157 * V_158 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
F_31 ( 0x0 , V_30 -> V_44 + V_349 ) ;
F_24 ( V_15 , 0 ) ;
...
static int F_133 ( struct V_14 * V_15 , struct V_157 * V_158 ,
struct V_159 * V_160 , unsigned int * V_152 )
{
unsigned int V_23 ;
V_23 = F_103 ( V_15 -> V_190 + V_378 ) ;
V_23 &= 0xf ;
V_152 [ 1 ] = V_23 ;
V_152 [ 0 ] = 0 ;
return V_160 -> V_166 ;
...
unsigned int * V_152 )
{
if ( F_135 ( V_158 , V_152 ) )
F_88 ( V_158 -> V_140 , V_15 -> V_190 + V_379 ) ;
V_152 [ 1 ] = V_158 -> V_140 ;
return V_160 -> V_166 ;
}
...
{
int V_168 ;
V_168 = F_137 ( V_15 , V_158 , V_160 , V_152 , 0 ) ;
if ( V_168 )
return V_168 ;
F_88 ( V_158 -> V_380 , V_15 -> V_190 + V_381 ) ;
return V_160 -> V_166 ;
}
...
{
if ( F_135 ( V_158 , V_152 ) )
F_88 ( V_158 -> V_140 , V_15 -> V_190 + V_382 ) ;
V_152 [ 1 ] = F_103 ( V_15 -> V_190 + V_382 ) ;
return V_160 -> V_166 ;
}
static int F_139 ( struct V_14 * V_15 , unsigned int V_151 ,
T_2 V_383 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
...
case V_19 :
case V_18 :
F_139 ( V_15 , V_1 , V_383 ) ;
break;
case V_11 :
F_140 ( V_15 , V_1 , V_383 ) ;
break;
default:
break;
}
...
if ( V_160 -> V_166 ) {
unsigned int V_304 = V_152 [ V_160 -> V_166 - 1 ] ;
if ( V_158 -> V_351 [ V_230 ] != V_304 ) {
F_141 ( V_15 , V_230 , V_304 ) ;
V_158 -> V_351 [ V_230 ] = V_304 ;
}
}
return V_160 -> V_166 ;
}
static void F_143 ( struct V_14 * V_15 , unsigned int V_1 ,
unsigned int V_383 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
...
unsigned int V_304 = V_152 [ V_160 -> V_166 - 1 ] ;
if ( V_158 -> V_351 [ V_230 ] != V_304 ) {
F_143 ( V_15 , V_230 , V_304 ) ;
V_158 -> V_351 [ V_230 ] = V_304 ;
}
}
return V_160 -> V_166 ;
}
static T_1 F_145 ( struct V_14 * V_15 , T_2 V_151 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
static const int V_385 = 11 ;
...
struct V_159 * V_160 , unsigned int * V_152 )
{
V_152 [ 0 ] = F_145 ( V_15 , F_60 ( V_160 -> V_169 ) ) ;
return 1 ;
}
...
if ( V_9 -> V_440 ) {
if ( V_9 -> V_10 == V_11 ) {
V_168 = F_150 ( V_15 , V_158 , F_132 ,
V_441 ) ;
} else {
V_168 = F_151 ( V_15 , V_158 , NULL ,
V_442 ) ;
}
if ( V_168 )
return V_168 ;
...
return V_168 ;
for ( V_115 = 0 ; V_115 < V_158 -> V_417 ; V_115 ++ ) {
F_141 ( V_15 , V_115 , V_158 -> V_420 / 2 ) ;
...
return V_168 ;
for ( V_115 = 0 ; V_115 < V_158 -> V_417 ; V_115 ++ ) {
F_143 ( V_15 , V_115 , V_158 -> V_420 / 2 ) ;
V_158 -> V_351 [ V_115 ] = V_158 -> V_420 / 2 ;
}
} else {
V_158 -> type = V_435 ;
...
T_3 V_448 , V_449 ;
int V_96 ;
if ( V_161 < F_153 ( V_450 ) )
V_9 = & V_450 [ V_161 ] ;
if ( ! V_9 )
return - V_451 ;
V_15 -> V_17 = V_9 ;
V_30 = F_154 ( V_15 , sizeof( * V_30 ) ) ;
if ( ! V_30 )
return - V_120 ;
V_96 = F_155 ( V_15 ) ;
if ( V_96 )
...
V_30 -> V_454 = F_157 ( V_114 , 2 ) ;
V_30 -> V_455 = F_157 ( V_114 , 3 ) ;
V_30 -> V_34 = F_158 ( V_114 , 0 ) ;
V_30 -> V_44 = F_158 ( V_114 , 2 ) ;
V_15 -> V_190 = F_158 ( V_114 , 3 ) ;
if ( ! V_30 -> V_34 || ! V_30 -> V_44 || ! V_15 -> V_190 ) {
F_159 ( V_15 -> V_27 , L_17 ) ;
return - V_120 ;
}
...
F_33 ( V_15 ) ;
F_41 ( V_15 ) ;
V_96 = F_160 ( V_114 -> V_342 , F_117 , V_462 ,
V_15 -> V_452 , V_15 ) ;
if ( V_96 ) {
F_65 ( V_15 -> V_27 , L_19 ,
V_114 -> V_342 ) ;
...
static int F_165 ( struct V_113 * V_15 ,
const struct V_463 * V_202 )
{
return F_166 ( V_15 , & V_464 ,
V_202 -> V_465 ) ;
}
