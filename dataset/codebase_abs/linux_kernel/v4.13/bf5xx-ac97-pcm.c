...
int V_56 , unsigned long V_57 ,
void * V_58 , unsigned long V_3 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
unsigned int V_9 = V_10 [ V_5 -> V_11 - 1 ] ;
struct V_14 * V_59 ;
...
V_59 = (struct V_14 * ) V_5 -> V_18 +
F_32 ( V_5 , V_57 ) ;
V_3 = F_32 ( V_5 , V_3 ) ;
if ( V_2 -> V_12 == V_13 )
F_2 ( V_59 , V_58 , V_3 , V_9 ) ;
else
F_3 ( V_59 , V_58 , V_3 ) ;
return 0 ;
}
...
int V_56 , unsigned long V_57 ,
void T_3 * V_58 , unsigned long V_3 )
{
return F_31 ( V_2 , V_56 , V_57 , ( void * ) V_58 , V_3 ) ;
}
static int F_34 ( struct V_60 * V_25 , int V_12 )
{
struct V_43 * V_44 = V_25 -> V_8 ;
struct V_45 * V_46 = V_44 -> V_46 ;
struct V_6 * V_47 = F_26 ( V_46 ) ;
struct V_1 * V_2 = V_25 -> V_61 [ V_12 ] . V_2 ;
struct V_62 * V_58 = & V_2 -> V_63 ;
T_2 V_30 = V_31 . V_32
* sizeof( struct V_14 ) / 4 ;
V_58 -> V_64 . type = V_65 ;
V_58 -> V_64 . V_64 = V_25 -> V_66 -> V_64 ;
V_58 -> V_8 = NULL ;
V_58 -> V_67 = F_35 ( V_25 -> V_66 -> V_64 , V_30 ,
& V_58 -> V_68 , V_69 ) ;
if ( ! V_58 -> V_67 ) {
F_29 ( L_6 ) ;
F_29 ( L_7 ) ;
...
static void F_36 ( struct V_60 * V_25 )
{
struct V_1 * V_2 ;
struct V_62 * V_58 ;
int V_12 ;
...
V_2 = V_25 -> V_61 [ V_12 ] . V_2 ;
if ( ! V_2 )
continue;
V_58 = & V_2 -> V_63 ;
if ( ! V_58 -> V_67 )
continue;
F_37 ( NULL , V_58 -> V_71 , V_58 -> V_67 , 0 ) ;
V_58 -> V_67 = NULL ;
#if F_5 ( V_26 )
if ( V_2 -> V_12 == V_13 ) {
if ( V_47 -> V_15 )
...
{
struct V_76 * V_66 = V_44 -> V_66 -> V_76 ;
struct V_60 * V_25 = V_44 -> V_25 ;
int V_35 ;
F_17 ( L_1 , V_36 ) ;
V_35 = F_39 ( V_66 -> V_64 , F_40 ( 32 ) ) ;
if ( V_35 )
return V_35 ;
if ( V_25 -> V_61 [ V_13 ] . V_2 ) {
V_35 = F_34 ( V_25 ,
V_13 ) ;
if ( V_35 )
goto V_49;
}
if ( V_25 -> V_61 [ V_77 ] . V_2 ) {
V_35 = F_34 ( V_25 ,
V_77 ) ;
if ( V_35 )
goto V_49;
