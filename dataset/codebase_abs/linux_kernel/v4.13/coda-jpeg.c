...
static void F_10 ( T_3 * V_31 , int V_32 )
{
unsigned int V_33 ;
int V_8 ;
for ( V_8 = 0 ; V_8 < 64 ; V_8 ++ ) {
V_33 = F_11 ( ( unsigned int ) V_31 [ V_8 ] * V_32 , 100 ) ;
if ( V_33 <= 0 )
V_33 = 1 ;
if ( V_33 > 255 )
V_33 = 255 ;
...
void F_12 ( struct V_9 * V_10 , int V_34 )
{
unsigned int V_32 ;
V_10 -> V_21 . V_35 = V_34 ;
if ( V_34 > 100 )
...
F_10 ( V_10 -> V_21 . V_22 [ 0 ] , V_32 ) ;
}
if ( V_10 -> V_21 . V_22 [ 1 ] ) {
memcpy ( V_10 -> V_21 . V_22 [ 1 ] , V_37 , 64 ) ;
F_10 ( V_10 -> V_21 . V_22 [ 1 ] , V_32 ) ;
}
}
