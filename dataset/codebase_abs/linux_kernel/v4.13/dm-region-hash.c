...
void F_57 ( struct V_1 * V_2 , int V_67 )
{
...
static void F_61 ( struct V_1 * V_2 , T_1 V_5 )
{
struct V_10 * V_11 ;
F_48 ( & V_2 -> V_25 ) ;
V_11 = F_46 ( V_2 , V_5 ) ;
...
void F_66 ( struct V_1 * V_2 , struct V_15 * V_16 )
{
struct V_6 * V_6 ;
for ( V_6 = V_16 -> V_76 ; V_6 ; V_6 = V_6 -> V_77 ) {
if ( V_6 -> V_63 & V_64 || F_54 ( V_6 ) == V_65 )
continue;
F_61 ( V_2 , F_3 ( V_2 , V_6 ) ) ;
}
}
void F_67 ( struct V_1 * V_2 , T_1 V_5 )
{
unsigned long V_61 ;
struct V_10 * V_11 ;
int V_78 = 0 ;
...
struct V_10 * F_74 ( struct V_1 * V_2 )
{
struct V_10 * V_11 = NULL ;
F_62 ( & V_2 -> V_32 ) ;
if ( ! F_26 ( & V_2 -> V_36 ) ) {
V_11 = F_75 ( V_2 -> V_36 . V_68 ,
struct V_10 , V_55 ) ;
F_64 ( & V_11 -> V_55 ) ;
}
F_65 ( & V_2 -> V_32 ) ;
...
void F_76 ( struct V_10 * V_11 , int V_59 )
{
struct V_1 * V_2 = V_11 -> V_2 ;
F_62 ( & V_2 -> V_32 ) ;
if ( V_59 )
...
void F_79 ( struct V_1 * V_2 , struct V_6 * V_6 )
{
struct V_10 * V_11 ;
F_48 ( & V_2 -> V_25 ) ;
