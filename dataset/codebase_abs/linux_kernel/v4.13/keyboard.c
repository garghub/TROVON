...
int F_162 ( int V_172 , unsigned int V_259 )
{
struct V_162 * V_163 = V_170 + V_172 ;
int V_174 = 0 ;
unsigned long V_12 ;
...
int F_166 ( int V_239 , struct V_267 T_3 * V_268 ,
int V_241 )
{
struct V_267 V_269 ;
int V_270 = 0 ;
if ( F_167 ( & V_269 , V_268 , sizeof( struct V_267 ) ) )
return - V_250 ;
switch ( V_239 ) {
case V_271 :
...
unsigned long V_12 ;
if ( F_167 ( & V_269 , V_274 , sizeof( struct V_273 ) ) )
return - V_250 ;
if ( ! F_169 ( V_277 ) )
V_241 = 0 ;
switch ( V_239 ) {
...
if ( F_167 ( V_299 , V_298 , sizeof( struct V_297 ) ) ) {
V_174 = - V_250 ;
goto V_308;
}
