...
if ( ( V_2 -> V_6 -> V_297 ( V_2 ) & V_303 ) == 0 )
V_2 -> V_6 -> V_264 ( V_2 , false ) ;
V_2 -> V_6 -> V_304 ( V_2 , V_2 -> V_6 -> V_297 ( V_2 ) &
~ ( V_303 | V_298 ) ) ;
return V_94 ;
}
static void
...
if ( ! ( V_102 & V_317 ) )
return F_27 ( V_2 ) ;
V_6 -> V_103 ( V_2 , V_318 , & V_314 ) ;
V_314 >>= 32 ;
V_315 = ( V_36 ) ( V_314 & 0xfffc ) ;
V_316 = ( V_36 ) ( V_314 + 8 ) ;
if ( V_102 & V_105 ) {
V_255 . V_45 = 0 ;
V_255 . V_101 = 1 ;
}
V_6 -> V_73 ( V_2 , V_315 , & V_255 , 0 , V_96 ) ;
V_6 -> V_73 ( V_2 , V_316 , & V_40 , 0 , V_44 ) ;
* F_2 ( V_2 , V_192 ) = V_2 -> V_98 ;
if ( V_102 & V_105 ) {
#ifdef F_42
* F_2 ( V_2 , V_319 ) = V_2 -> V_193 ;
V_6 -> V_103 ( V_2 ,
V_2 -> V_41 == V_42 ?
V_320 : V_321 , & V_314 ) ;
V_2 -> V_98 = V_314 ;
V_6 -> V_103 ( V_2 , V_322 , & V_314 ) ;
V_2 -> V_193 &= ~ V_314 ;
V_2 -> V_193 |= V_259 ;
#endif
} else {
...
return V_223 ;
F_127 ( V_2 , & V_255 , & V_40 ) ;
V_6 -> V_103 ( V_2 , V_324 , & V_314 ) ;
if ( ( V_314 & 0xfffc ) == 0x0 )
return F_25 ( V_2 , 0 ) ;
V_2 -> V_193 &= ~ ( V_251 | V_129 ) ;
V_315 = ( V_36 ) V_314 & ~ V_325 ;
V_316 = V_315 + 8 ;
if ( V_102 & V_105 ) {
V_255 . V_45 = 0 ;
V_255 . V_101 = 1 ;
...
V_6 -> V_73 ( V_2 , V_315 , & V_255 , 0 , V_96 ) ;
V_6 -> V_73 ( V_2 , V_316 , & V_40 , 0 , V_44 ) ;
V_6 -> V_103 ( V_2 , V_326 , & V_314 ) ;
V_2 -> V_98 = ( V_102 & V_105 ) ? V_314 : ( V_37 ) V_314 ;
V_6 -> V_103 ( V_2 , V_327 , & V_314 ) ;
* F_2 ( V_2 , V_48 ) = ( V_102 & V_105 ) ? V_314 :
( V_37 ) V_314 ;
return V_94 ;
}
...
const struct V_200 * V_6 = V_2 -> V_6 ;
struct V_39 V_255 , V_40 ;
T_2 V_314 , V_328 , V_329 ;
int V_330 ;
V_36 V_315 = 0 , V_316 = 0 ;
if ( V_2 -> V_41 == V_93 ||
V_2 -> V_41 == V_218 )
return F_25 ( V_2 , 0 ) ;
F_127 ( V_2 , & V_255 , & V_40 ) ;
...
V_37 V_72 ;
int V_294 ;
V_36 V_332 , V_333 , V_334 , V_335 = V_187 & 0x7 ;
unsigned V_33 = ( 1 << V_228 ) - 1 ;
unsigned long V_336 ;
V_6 -> V_43 ( V_2 , & V_332 , & V_331 , & V_72 , V_220 ) ;
if ( ! V_331 . V_118 )
return false ;
if ( F_19 ( & V_331 ) < 103 )
return false ;
...
V_336 |= ( ( T_2 ) V_72 ) << 32 ;
#endif
V_294 = V_6 -> V_109 ( V_2 , V_336 + 102 , & V_333 , 2 , NULL ) ;
if ( V_294 != V_94 )
return false ;
if ( V_333 + V_187 / 8 > F_19 ( & V_331 ) )
return false ;
V_294 = V_6 -> V_109 ( V_2 , V_336 + V_333 + V_187 / 8 , & V_334 , 2 , NULL ) ;
if ( V_294 != V_94 )
return false ;
if ( ( V_334 >> V_335 ) & V_33 )
return false ;
...
struct V_338 * V_339 )
{
V_339 -> V_340 = V_2 -> V_98 ;
V_339 -> V_341 = V_2 -> V_193 ;
V_339 -> V_342 = F_1 ( V_2 , V_250 ) ;
V_339 -> V_343 = F_1 ( V_2 , V_192 ) ;
V_339 -> V_344 = F_1 ( V_2 , V_270 ) ;
V_339 -> V_162 = F_1 ( V_2 , V_163 ) ;
V_339 -> V_345 = F_1 ( V_2 , V_48 ) ;
V_339 -> V_164 = F_1 ( V_2 , V_152 ) ;
V_339 -> V_165 = F_1 ( V_2 , V_166 ) ;
V_339 -> V_167 = F_1 ( V_2 , V_168 ) ;
V_339 -> V_346 = F_31 ( V_2 , V_347 ) ;
V_339 -> V_255 = F_31 ( V_2 , V_96 ) ;
V_339 -> V_40 = F_31 ( V_2 , V_44 ) ;
V_339 -> V_348 = F_31 ( V_2 , V_159 ) ;
V_339 -> V_349 = F_31 ( V_2 , V_201 ) ;
}
...
int V_215 ;
V_35 V_204 ;
V_2 -> V_98 = V_339 -> V_340 ;
V_2 -> V_193 = V_339 -> V_341 | 2 ;
* F_2 ( V_2 , V_250 ) = V_339 -> V_342 ;
* F_2 ( V_2 , V_192 ) = V_339 -> V_343 ;
* F_2 ( V_2 , V_270 ) = V_339 -> V_344 ;
* F_2 ( V_2 , V_163 ) = V_339 -> V_162 ;
* F_2 ( V_2 , V_48 ) = V_339 -> V_345 ;
* F_2 ( V_2 , V_152 ) = V_339 -> V_164 ;
* F_2 ( V_2 , V_166 ) = V_339 -> V_165 ;
* F_2 ( V_2 , V_168 ) = V_339 -> V_167 ;
F_32 ( V_2 , V_339 -> V_349 , V_201 ) ;
F_32 ( V_2 , V_339 -> V_346 , V_347 ) ;
F_32 ( V_2 , V_339 -> V_255 , V_96 ) ;
F_32 ( V_2 , V_339 -> V_40 , V_44 ) ;
F_32 ( V_2 , V_339 -> V_348 , V_159 ) ;
V_204 = V_339 -> V_255 & 3 ;
V_215 = F_84 ( V_2 , V_339 -> V_349 , V_201 , V_204 ,
V_221 , NULL ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_84 ( V_2 , V_339 -> V_346 , V_347 , V_204 ,
V_221 , NULL ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_84 ( V_2 , V_339 -> V_255 , V_96 , V_204 ,
V_221 , NULL ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_84 ( V_2 , V_339 -> V_40 , V_44 , V_204 ,
V_221 , NULL ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_84 ( V_2 , V_339 -> V_348 , V_159 , V_204 ,
V_221 , NULL ) ;
if ( V_215 != V_94 )
return V_215 ;
return V_94 ;
...
V_36 V_350 , V_36 V_351 ,
T_1 V_352 , struct V_39 * V_265 )
{
const struct V_200 * V_6 = V_2 -> V_6 ;
struct V_338 V_353 ;
int V_215 ;
V_37 V_354 = F_80 ( V_265 ) ;
V_215 = V_6 -> V_109 ( V_2 , V_352 , & V_353 , sizeof V_353 ,
& V_2 -> V_57 ) ;
if ( V_215 != V_94 )
return V_215 ;
F_137 ( V_2 , & V_353 ) ;
V_215 = V_6 -> V_110 ( V_2 , V_352 , & V_353 , sizeof V_353 ,
& V_2 -> V_57 ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = V_6 -> V_109 ( V_2 , V_354 , & V_353 , sizeof V_353 ,
& V_2 -> V_57 ) ;
if ( V_215 != V_94 )
return V_215 ;
if ( V_351 != 0xffff ) {
V_353 . V_355 = V_351 ;
V_215 = V_6 -> V_110 ( V_2 , V_354 ,
& V_353 . V_355 ,
sizeof V_353 . V_355 ,
& V_2 -> V_57 ) ;
if ( V_215 != V_94 )
...
return F_138 ( V_2 , & V_353 ) ;
}
static void F_140 ( struct V_1 * V_2 ,
struct V_356 * V_339 )
{
V_339 -> V_31 = V_2 -> V_98 ;
V_339 -> V_193 = V_2 -> V_193 ;
V_339 -> V_273 = F_1 ( V_2 , V_250 ) ;
V_339 -> V_275 = F_1 ( V_2 , V_192 ) ;
V_339 -> V_276 = F_1 ( V_2 , V_270 ) ;
V_339 -> V_274 = F_1 ( V_2 , V_163 ) ;
V_339 -> V_357 = F_1 ( V_2 , V_48 ) ;
V_339 -> V_358 = F_1 ( V_2 , V_152 ) ;
V_339 -> V_359 = F_1 ( V_2 , V_166 ) ;
V_339 -> V_360 = F_1 ( V_2 , V_168 ) ;
V_339 -> V_346 = F_31 ( V_2 , V_347 ) ;
V_339 -> V_255 = F_31 ( V_2 , V_96 ) ;
V_339 -> V_40 = F_31 ( V_2 , V_44 ) ;
V_339 -> V_348 = F_31 ( V_2 , V_159 ) ;
V_339 -> V_361 = F_31 ( V_2 , V_53 ) ;
V_339 -> V_362 = F_31 ( V_2 , V_217 ) ;
}
...
int V_215 ;
V_35 V_204 ;
if ( V_2 -> V_6 -> V_284 ( V_2 , 3 , V_339 -> V_363 ) )
return F_25 ( V_2 , 0 ) ;
V_2 -> V_98 = V_339 -> V_31 ;
V_2 -> V_193 = V_339 -> V_193 | 2 ;
* F_2 ( V_2 , V_250 ) = V_339 -> V_273 ;
* F_2 ( V_2 , V_192 ) = V_339 -> V_275 ;
* F_2 ( V_2 , V_270 ) = V_339 -> V_276 ;
* F_2 ( V_2 , V_163 ) = V_339 -> V_274 ;
* F_2 ( V_2 , V_48 ) = V_339 -> V_357 ;
* F_2 ( V_2 , V_152 ) = V_339 -> V_358 ;
* F_2 ( V_2 , V_166 ) = V_339 -> V_359 ;
* F_2 ( V_2 , V_168 ) = V_339 -> V_360 ;
F_32 ( V_2 , V_339 -> V_364 , V_201 ) ;
F_32 ( V_2 , V_339 -> V_346 , V_347 ) ;
F_32 ( V_2 , V_339 -> V_255 , V_96 ) ;
F_32 ( V_2 , V_339 -> V_40 , V_44 ) ;
F_32 ( V_2 , V_339 -> V_348 , V_159 ) ;
F_32 ( V_2 , V_339 -> V_361 , V_53 ) ;
F_32 ( V_2 , V_339 -> V_362 , V_217 ) ;
if ( V_2 -> V_193 & V_251 ) {
V_2 -> V_41 = V_218 ;
V_204 = 3 ;
} else {
...
V_215 = F_84 ( V_2 , V_339 -> V_364 , V_201 ,
V_204 , V_221 , NULL ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_84 ( V_2 , V_339 -> V_346 , V_347 , V_204 ,
...
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_84 ( V_2 , V_339 -> V_361 , V_53 , V_204 ,
V_221 , NULL ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_84 ( V_2 , V_339 -> V_362 , V_217 , V_204 ,
V_221 , NULL ) ;
return V_215 ;
}
...
int V_215 ;
V_37 V_354 = F_80 ( V_265 ) ;
V_37 V_365 = F_143 ( struct V_356 , V_31 ) ;
V_37 V_366 = F_143 ( struct V_356 , V_364 ) ;
V_215 = V_6 -> V_109 ( V_2 , V_352 , & V_353 , sizeof V_353 ,
& V_2 -> V_57 ) ;
if ( V_215 != V_94 )
return V_215 ;
F_140 ( V_2 , & V_353 ) ;
V_215 = V_6 -> V_110 ( V_2 , V_352 + V_365 , & V_353 . V_31 ,
V_366 - V_365 , & V_2 -> V_57 ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = V_6 -> V_109 ( V_2 , V_354 , & V_353 , sizeof V_353 ,
& V_2 -> V_57 ) ;
...
return F_141 ( V_2 , & V_353 ) ;
}
static int F_144 ( struct V_1 * V_2 ,
V_36 V_350 , int V_367 , int V_368 ,
bool V_369 , V_37 V_59 )
{
const struct V_200 * V_6 = V_2 -> V_6 ;
struct V_39 V_370 , V_371 ;
int V_215 ;
V_36 V_351 = F_31 ( V_2 , V_220 ) ;
T_1 V_352 =
V_6 -> V_54 ( V_2 , V_220 ) ;
V_37 V_372 ;
T_1 V_214 , V_373 ;
V_215 = F_82 ( V_2 , V_350 , & V_371 , & V_214 ) ;
if ( V_215 != V_94 )
return V_215 ;
V_215 = F_82 ( V_2 , V_351 , & V_370 , & V_214 ) ;
if ( V_215 != V_94 )
return V_215 ;
if ( V_368 == V_374 ) {
if ( V_367 != - 1 ) {
struct V_39 V_375 ;
int V_209 ;
V_215 = F_78 ( V_2 , V_367 ,
& V_375 ) ;
if ( V_215 != V_94 )
return V_215 ;
V_209 = V_375 . V_209 ;
if ( ( V_350 & 3 ) > V_209 || V_6 -> V_204 ( V_2 ) > V_209 )
return F_25 ( V_2 , ( V_367 << 3 ) | 0x2 ) ;
}
}
V_372 = F_19 ( & V_371 ) ;
if ( ! V_371 . V_118 ||
( ( V_372 < 0x67 && ( V_371 . type & 8 ) ) ||
V_372 < 0x2b ) ) {
return F_28 ( V_2 , V_350 & 0xfffc ) ;
}
if ( V_368 == V_376 || V_368 == V_377 ) {
V_370 . type &= ~ ( 1 << 1 ) ;
F_83 ( V_2 , V_351 , & V_370 ) ;
}
if ( V_368 == V_376 )
V_2 -> V_193 = V_2 -> V_193 & ~ V_240 ;
if ( V_368 != V_378 && V_368 != V_374 )
V_351 = 0xffff ;
if ( V_371 . type & 8 )
V_215 = F_142 ( V_2 , V_350 , V_351 ,
V_352 , & V_371 ) ;
else
V_215 = F_139 ( V_2 , V_350 , V_351 ,
V_352 , & V_371 ) ;
if ( V_215 != V_94 )
return V_215 ;
if ( V_368 == V_378 || V_368 == V_374 )
...
if ( V_368 != V_376 ) {
V_371 . type |= ( 1 << 1 ) ;
F_83 ( V_2 , V_350 , & V_371 ) ;
}
V_6 -> V_284 ( V_2 , 0 , V_6 -> V_134 ( V_2 , 0 ) | V_135 ) ;
V_6 -> V_73 ( V_2 , V_350 , & V_371 , 0 , V_220 ) ;
if ( V_369 ) {
V_2 -> V_97 = V_2 -> V_29 = ( V_371 . type & 8 ) ? 4 : 2 ;
V_2 -> V_226 = 0 ;
V_2 -> V_22 . V_34 = ( unsigned long ) V_59 ;
V_215 = F_91 ( V_2 ) ;
}
V_6 -> V_379 ( V_2 , 7 , & V_373 ) ;
V_6 -> V_287 ( V_2 , 7 , V_373 & ~ ( V_380 | V_381 ) ) ;
return V_215 ;
}
...
V_2 -> V_98 = V_2 -> V_31 ;
V_2 -> V_25 . type = V_122 ;
V_95 = F_144 ( V_2 , V_350 , V_367 , V_368 ,
V_369 , V_59 ) ;
if ( V_95 == V_94 ) {
V_2 -> V_31 = V_2 -> V_98 ;
F_4 ( V_2 ) ;
}
return ( V_95 == V_223 ) ? V_382 : V_383 ;
}
static void F_146 ( struct V_1 * V_2 , int V_9 ,
struct V_130 * V_131 )
{
int V_384 = ( V_2 -> V_193 & V_194 ) ? - V_131 -> V_191 : V_131 -> V_191 ;
F_17 ( V_2 , V_9 , V_384 * V_131 -> V_27 ) ;
...
V_388 = V_2 -> V_193 & V_233 ;
V_385 = V_2 -> V_25 . V_34 ;
V_386 = V_385 ;
V_389 = V_388 ;
V_388 = false ;
V_387 = V_2 -> V_193 & V_235 ;
if ( ( V_385 & 0x0f ) > 9 || V_387 ) {
V_385 -= 6 ;
V_388 = V_389 | ( V_385 >= 250 ) ;
V_387 = true ;
} else {
V_387 = false ;
}
...
if ( V_2 -> V_22 . V_34 == 0 )
return F_29 ( V_2 ) ;
V_385 = V_2 -> V_25 . V_34 & 0xff ;
V_392 = V_385 / V_2 -> V_22 . V_34 ;
V_385 %= V_2 -> V_22 . V_34 ;
V_2 -> V_25 . V_34 = ( V_2 -> V_25 . V_34 & 0xffff0000 ) | V_385 | ( V_392 << 8 ) ;
V_2 -> V_22 . type = V_390 ;
V_2 -> V_22 . V_34 = 0 ;
V_2 -> V_22 . V_27 = 1 ;
F_53 ( V_2 , V_391 ) ;
...
{
V_35 V_385 = V_2 -> V_25 . V_34 & 0xff ;
V_35 V_392 = ( V_2 -> V_25 . V_34 >> 8 ) & 0xff ;
V_385 = ( V_385 + ( V_392 * V_2 -> V_22 . V_34 ) ) & 0xff ;
V_2 -> V_25 . V_34 = ( V_2 -> V_25 . V_34 & 0xffff0000 ) | V_385 ;
V_2 -> V_22 . type = V_390 ;
V_2 -> V_22 . V_34 = 0 ;
V_2 -> V_22 . V_27 = 1 ;
F_53 ( V_2 , V_391 ) ;
...
const struct V_200 * V_6 = V_2 -> V_6 ;
int V_204 = V_2 -> V_6 -> V_204 ( V_2 ) ;
enum V_86 V_394 = V_2 -> V_41 ;
V_267 = V_2 -> V_98 ;
V_6 -> V_43 ( V_2 , & V_393 , & V_208 , NULL , V_96 ) ;
memcpy ( & V_38 , V_2 -> V_22 . V_266 + V_2 -> V_97 , 2 ) ;
V_95 = F_84 ( V_2 , V_38 , V_96 , V_204 ,
V_222 , & V_265 ) ;
if ( V_95 != V_94 )
...
return V_95 ;
V_395:
V_6 -> V_73 ( V_2 , V_393 , & V_208 , 0 , V_96 ) ;
V_2 -> V_41 = V_394 ;
return V_95 ;
}
...
{
T_2 V_399 ;
if ( V_2 -> V_6 -> V_400 ( V_2 , F_1 ( V_2 , V_192 ) , & V_399 ) )
return F_25 ( V_2 , 0 ) ;
* F_2 ( V_2 , V_250 ) = ( V_37 ) V_399 ;
* F_2 ( V_2 , V_270 ) = V_399 >> 32 ;
return V_94 ;
}
...
V_36 V_401 ;
V_2 -> V_6 -> V_277 ( V_2 , & V_273 , & V_274 , & V_275 , & V_276 ) ;
if ( ! ( V_275 & F_161 ( V_402 ) ) )
return F_27 ( V_2 ) ;
switch ( V_2 -> V_97 ) {
case 2 :
V_401 = ( V_36 ) V_2 -> V_22 . V_34 ;
V_2 -> V_25 . V_34 &= ~ 0xffffUL ;
V_2 -> V_25 . V_34 |= ( unsigned long ) F_162 ( V_401 ) ;
break;
case 4 :
...
{
T_2 V_314 ;
V_314 = ( V_37 ) F_1 ( V_2 , V_250 )
| ( ( T_2 ) F_1 ( V_2 , V_270 ) << 32 ) ;
if ( V_2 -> V_6 -> V_296 ( V_2 , F_1 ( V_2 , V_192 ) , V_314 ) )
return F_25 ( V_2 , 0 ) ;
return V_94 ;
}
...
{
T_2 V_314 ;
if ( V_2 -> V_6 -> V_103 ( V_2 , F_1 ( V_2 , V_192 ) , & V_314 ) )
return F_25 ( V_2 , 0 ) ;
* F_2 ( V_2 , V_250 ) = ( V_37 ) V_314 ;
* F_2 ( V_2 , V_270 ) = V_314 >> 32 ;
return V_94 ;
}
...
static int F_180 ( struct V_1 * V_2 , bool V_405 )
{
struct V_197 V_197 ;
int V_95 ;
if ( V_2 -> V_41 == V_42 )
...
{
V_2 -> V_6 -> V_407 ( V_2 , V_2 -> V_22 . V_27 , V_2 -> V_25 . V_34 ,
& V_2 -> V_22 . V_34 , 1 ) ;
V_2 -> V_25 . type = V_122 ;
return V_94 ;
}
...
static T_6 F_198 ( int V_413 )
{
return F_143 ( struct V_414 , V_415 [ 0 ] ) + V_413 * 16 ;
}
static inline T_6 F_199 ( struct V_1 * V_2 )
{
bool V_416 ;
if ( V_2 -> V_41 == V_42 )
return F_198 ( 16 ) ;
V_416 = V_2 -> V_6 -> V_134 ( V_2 , 4 ) & V_417 ;
return F_198 ( V_416 ? 8 : 0 ) ;
}
...
return V_95 ;
V_2 -> V_6 -> V_132 ( V_2 ) ;
V_95 = F_201 ( L_2 , , [ V_419 ] L_3 ( V_418 ) ) ;
V_2 -> V_6 -> V_133 ( V_2 ) ;
if ( V_95 != V_94 )
return V_95 ;
return F_45 ( V_2 , V_2 -> V_174 . V_82 . V_173 , & V_418 ,
F_199 ( V_2 ) ) ;
}
...
V_95 = F_44 ( V_2 , V_2 -> V_174 . V_82 . V_173 , & V_418 , V_74 ) ;
if ( V_95 != V_94 )
goto V_420;
if ( V_418 . V_421 >> 16 ) {
V_95 = F_25 ( V_2 , 0 ) ;
...
if ( V_95 == V_94 )
V_95 = F_201 ( L_4 , : [ V_419 ] L_5 ( V_418 ) ) ;
V_420:
V_2 -> V_6 -> V_133 ( V_2 ) ;
return V_95 ;
}
static bool F_203 ( int V_3 )
{
switch ( V_3 ) {
case 0 :
case 2 ... 4 :
...
if ( ! F_203 ( V_423 ) )
return F_27 ( V_2 ) ;
if ( V_422 & V_424 [ V_423 ] )
return F_25 ( V_2 , 0 ) ;
switch ( V_423 ) {
case 0 : {
T_2 V_283 ;
if ( ( ( V_422 & V_300 ) && ! ( V_422 & V_299 ) ) ||
( ( V_422 & V_427 ) && ! ( V_422 & V_428 ) ) )
return F_25 ( V_2 , 0 ) ;
V_283 = V_2 -> V_6 -> V_134 ( V_2 , 4 ) ;
V_2 -> V_6 -> V_103 ( V_2 , V_104 , & V_102 ) ;
if ( ( V_422 & V_300 ) && ( V_102 & V_429 ) &&
! ( V_283 & V_301 ) )
return F_25 ( V_2 , 0 ) ;
break;
}
...
return F_27 ( V_2 ) ;
V_283 = V_2 -> V_6 -> V_134 ( V_2 , 4 ) ;
if ( ( V_283 & V_434 ) && ( V_433 == 4 || V_433 == 5 ) )
return F_27 ( V_2 ) ;
if ( F_206 ( V_2 ) ) {
T_1 V_435 ;
V_2 -> V_6 -> V_379 ( V_2 , 6 , & V_435 ) ;
V_435 &= ~ 15 ;
V_435 |= V_436 | V_437 ;
V_2 -> V_6 -> V_287 ( V_2 , 6 , V_435 ) ;
return F_24 ( V_2 ) ;
}
return V_94 ;
}
...
T_2 V_422 = V_2 -> V_22 . V_23 ;
int V_433 = V_2 -> V_19 ;
if ( ( V_433 == 6 || V_433 == 7 ) && ( V_422 & 0xffffffff00000000ULL ) )
return F_25 ( V_2 , 0 ) ;
return F_207 ( V_2 ) ;
}
...
if ( V_283 & V_440 && V_2 -> V_6 -> V_204 ( V_2 ) )
return F_27 ( V_2 ) ;
return V_94 ;
}
...
{
T_2 V_283 = V_2 -> V_6 -> V_134 ( V_2 , 4 ) ;
T_2 V_328 = F_1 ( V_2 , V_192 ) ;
if ( ( ! ( V_283 & V_441 ) && V_2 -> V_6 -> V_204 ( V_2 ) ) ||
V_2 -> V_6 -> V_442 ( V_2 , V_328 ) )
return F_25 ( V_2 , 0 ) ;
return V_94 ;
}
static int F_213 ( struct V_1 * V_2 )
{
V_2 -> V_25 . V_27 = F_214 ( V_2 -> V_25 . V_27 , 4u ) ;
...
{
V_2 -> V_22 . V_27 = F_214 ( V_2 -> V_22 . V_27 , 4u ) ;
if ( ! F_135 ( V_2 , V_2 -> V_25 . V_34 , V_2 -> V_22 . V_27 ) )
return F_25 ( V_2 , 0 ) ;
return V_94 ;
}
static unsigned F_216 ( struct V_1 * V_2 )
{
unsigned V_74 ;
...
static int F_218 ( struct V_1 * V_2 , struct V_130 * V_131 ,
unsigned V_45 )
{
int V_95 = V_94 ;
switch ( V_45 ) {
...
break;
case V_459 :
V_95 = F_217 ( V_2 , V_131 , F_216 ( V_2 ) , true ) ;
break;
case V_460 :
V_95 = F_217 ( V_2 , V_131 , V_2 -> V_97 , true ) ;
break;
case V_461 :
V_2 -> V_174 . V_27 = 1 ;
...
goto V_447;
case V_464 :
V_95 = F_217 ( V_2 , V_131 , 2 , false ) ;
break;
case V_465 :
V_95 = F_217 ( V_2 , V_131 , F_216 ( V_2 ) , false ) ;
break;
case V_466 :
V_131 -> type = V_161 ;
V_131 -> V_27 = ( V_2 -> V_45 & V_149 ) ? 1 : V_2 -> V_97 ;
V_131 -> V_82 . V_173 . V_91 =
F_15 ( V_2 , V_166 ) ;
V_131 -> V_82 . V_173 . V_52 = V_2 -> V_467 ;
V_131 -> V_34 = 0 ;
V_131 -> V_191 = 1 ;
break;
case V_468 :
...
F_219 ( V_131 -> V_266 , V_131 -> V_27 , V_2 ) ;
break;
case V_470 :
...
int F_220 ( struct V_1 * V_2 , void * V_478 , int V_479 )
{
int V_95 = V_94 ;
int V_41 = V_2 -> V_41 ;
...
V_2 -> V_85 . V_113 = V_2 -> V_85 . V_108 + V_479 ;
V_2 -> V_487 = 1 ;
if ( V_479 > 0 )
memcpy ( V_2 -> V_85 . V_108 , V_478 , V_479 ) ;
else {
V_95 = F_46 ( V_2 , 1 ) ;
if ( V_95 != V_94 )
return V_95 ;
...
case 0x3e :
V_485 = true ;
V_2 -> V_467 = ( V_2 -> V_140 >> 3 ) & 3 ;
break;
case 0x64 :
case 0x65 :
V_485 = true ;
V_2 -> V_467 = V_2 -> V_140 & 7 ;
break;
case 0x40 ... 0x4f :
if ( V_41 != V_42 )
goto V_488;
...
if ( V_2 -> V_120 & 8 )
V_2 -> V_97 = 8 ;
V_486 = V_489 [ V_2 -> V_140 ] ;
if ( V_2 -> V_140 == 0x0f ) {
V_2 -> V_487 = 2 ;
V_2 -> V_140 = F_69 ( V_35 , V_2 ) ;
V_486 = V_490 [ V_2 -> V_140 ] ;
if ( V_2 -> V_140 == 0x38 ) {
V_2 -> V_487 = 3 ;
V_2 -> V_140 = F_69 ( V_35 , V_2 ) ;
V_486 = V_491 [ V_2 -> V_140 ] ;
}
}
V_2 -> V_45 = V_486 . V_126 ;
if ( V_2 -> V_45 & V_139 )
V_2 -> V_158 = F_69 ( V_35 , V_2 ) ;
if ( V_2 -> V_487 == 1 && ( V_2 -> V_140 == 0xc5 || V_2 -> V_140 == 0xc4 ) &&
...
case V_508 :
if ( V_2 -> V_158 > 0xbf )
V_486 = V_486 . V_495 . V_509 -> V_510 [ V_2 -> V_158 - 0xc0 ] ;
else
V_486 = V_486 . V_495 . V_509 -> V_131 [ ( V_2 -> V_158 >> 3 ) & 7 ] ;
break;
case V_511 :
if ( ( V_2 -> V_158 >> 6 ) == 3 )
...
if ( F_47 ( V_2 -> V_518 ) && F_34 ( ! ( V_2 -> V_45 & V_519 ) ) )
return V_382 ;
if ( F_47 ( V_2 -> V_45 &
( V_492 | V_520 | V_521 | V_141 | V_145 | V_522 | V_523 | V_524 |
V_525 ) ) ) {
...
if ( ! V_485 )
V_2 -> V_467 = V_159 ;
V_2 -> V_174 . V_82 . V_173 . V_52 = V_2 -> V_467 ;
V_95 = F_218 ( V_2 , & V_2 -> V_22 , ( V_2 -> V_45 >> V_528 ) & V_529 ) ;
if ( V_95 != V_94 )
goto V_175;
V_95 = F_218 ( V_2 , & V_2 -> V_245 , ( V_2 -> V_45 >> V_530 ) & V_529 ) ;
if ( V_95 != V_94 )
goto V_175;
V_95 = F_218 ( V_2 , & V_2 -> V_25 , ( V_2 -> V_45 >> V_531 ) & V_529 ) ;
if ( V_2 -> V_172 && F_34 ( V_2 -> V_448 ) )
V_2 -> V_448 -> V_82 . V_173 . V_91 = F_14 ( V_2 ,
V_2 -> V_448 -> V_82 . V_173 . V_91 + V_2 -> V_98 ) ;
V_175:
return ( V_95 != V_94 ) ? V_382 : V_383 ;
}
bool F_221 ( struct V_1 * V_2 )
{
...
{
register void * T_7 V_536 ( V_537 ) ;
T_1 V_126 = ( V_2 -> V_193 & V_128 ) | V_129 ;
if ( ! ( V_2 -> V_45 & V_149 ) )
F_56 += F_225 ( V_2 -> V_25 . V_27 ) * V_538 ;
...
const struct V_200 * V_6 = V_2 -> V_6 ;
int V_95 = V_94 ;
int V_539 = V_2 -> V_25 . type ;
unsigned V_540 ;
V_2 -> V_181 . V_182 = 0 ;
if ( V_2 -> V_226 && ( ! ( V_2 -> V_45 & V_541 ) || V_2 -> V_25 . type != V_161 ) ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
if ( ( V_2 -> V_45 & V_542 ) == V_543 && V_2 -> V_22 . type != V_161 ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
V_540 = V_2 -> V_6 -> V_297 ( V_2 ) ;
if ( F_47 ( V_2 -> V_45 &
( V_544 | V_545 | V_141 | V_145 | V_522 | V_523 | V_546 | V_547 | String ) ) ) {
if ( ( V_2 -> V_41 == V_42 && ( V_2 -> V_45 & V_544 ) ) ||
( V_2 -> V_45 & V_545 ) ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
if ( ( ( V_2 -> V_45 & ( V_141 | V_145 ) ) && ( ( V_6 -> V_134 ( V_2 , 0 ) & V_136 ) ) )
|| ( ( V_2 -> V_45 & V_141 ) && ! ( V_6 -> V_134 ( V_2 , 4 ) & V_417 ) ) ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
...
if ( F_47 ( V_540 & V_549 ) && V_2 -> V_12 ) {
V_95 = F_7 ( V_2 , V_2 -> V_12 ,
V_550 ) ;
if ( V_95 != V_94 )
goto V_175;
}
if ( ( V_2 -> V_45 & V_547 ) && V_2 -> V_41 < V_100 ) {
V_95 = F_27 ( V_2 ) ;
goto V_175;
}
if ( ( V_2 -> V_45 & V_546 ) && V_6 -> V_204 ( V_2 ) ) {
if ( V_2 -> V_45 & V_551 )
V_95 = F_27 ( V_2 ) ;
else
V_95 = F_25 ( V_2 , 0 ) ;
...
if ( F_47 ( V_540 & V_549 ) && ( V_2 -> V_45 & V_522 ) ) {
V_95 = F_7 ( V_2 , V_2 -> V_12 ,
V_552 ) ;
if ( V_95 != V_94 )
goto V_175;
...
if ( ( V_2 -> V_22 . type == V_161 ) && ! ( V_2 -> V_45 & V_553 ) ) {
...
if ( ( V_2 -> V_45 & V_554 ) == V_555 )
goto V_556;
if ( ( V_2 -> V_25 . type == V_161 ) && ! ( V_2 -> V_45 & V_548 ) ) {
...
if ( V_2 -> V_517 ) {
if ( V_2 -> V_45 & V_561 ) {
void (* F_56)( struct F_53 * ) = ( void * ) V_2 -> V_517 ;
V_95 = F_53 ( V_2 , F_56 ) ;
if ( V_95 != V_94 )
goto V_175;
goto F_89;
...
F_89:
if ( V_2 -> V_45 & V_566 ) {
F_228 ( V_2 -> V_22 . type == V_161 || V_2 -> V_22 . type == V_195 ) ;
...
V_2 -> V_25 . type = V_539 ;
if ( ( V_2 -> V_45 & V_542 ) == V_567 )
F_146 ( V_2 , V_166 , & V_2 -> V_22 ) ;
if ( ( V_2 -> V_45 & V_554 ) == V_568 )
...
break;
case 0x21 :
V_6 -> V_379 ( V_2 , V_2 -> V_19 , & V_2 -> V_25 . V_34 ) ;
break;
case 0x40 ... 0x4f :
if ( F_55 ( V_2 -> V_140 , V_2 -> V_193 ) )
V_2 -> V_25 . V_34 = V_2 -> V_22 . V_34 ;
