...
F_78 ( V_165 ) = F_79 ( V_16 , V_172 , V_168 , V_38 ) ;
V_32 -> V_35 = V_170 ;
V_32 -> V_36 = V_171 ;
V_32 = V_170 ;
V_32 -> V_75 = F_78 ( V_165 ) ;
V_32 -> V_37 = V_168 ;
V_32 -> V_38 = V_38 ;
}
V_32 -> V_35 = NULL ;
...
static int F_80 ( struct V_173 * V_7 , const T_3 * V_117 ,
unsigned int V_118 )
{
struct V_56 * V_57 = F_81 ( V_7 ) ;
...
F_52 ( & V_57 -> V_52 ) ;
F_52 ( & V_57 -> V_79 ) ;
V_57 -> V_52 . V_108 = V_174 ;
V_57 -> V_79 . V_108 = V_174 ;
...
static int F_84 ( struct V_173 * V_7 , const T_3 * V_117 ,
unsigned int V_118 )
{
struct V_56 * V_57 = F_81 ( V_7 ) ;
if ( V_118 < V_177 )
return - V_155 ;
memcpy ( V_57 -> V_178 , V_117 + ( V_118 - V_177 ) ,
V_177 ) ;
V_118 -= V_177 ;
return F_80 ( V_7 , V_117 , V_118 ) ;
}
static int F_85 ( struct V_68 * V_42 , int V_52 )
{
struct V_173 * V_7 = F_86 ( V_42 ) ;
struct V_56 * V_57 = F_81 ( V_7 ) ;
unsigned V_179 = F_87 ( V_7 ) ;
struct V_106 * V_38 ;
struct V_1 * V_40 ;
unsigned int V_166 = V_42 -> V_166 ;
enum V_167 V_180 = V_181 ;
struct V_70 * V_46 = F_24 ( V_42 ) ;
struct V_31 V_182 ;
struct V_15 * V_16 = & V_17 -> V_16 ;
...
V_40 -> V_127 |= V_187 ;
V_46 -> V_54 = NULL ;
if ( ! F_74 ( V_16 , V_42 -> V_54 , V_166 , & V_186 ,
V_23 , V_188 ) )
goto V_189;
V_180 = V_190 ;
...
V_46 -> V_62 = NULL ;
if ( ! F_74 ( V_16 , V_42 -> V_62 , V_166 , & V_182 ,
V_23 , V_180 ) )
goto V_191;
...
static int F_90 ( struct V_68 * V_42 )
{
return F_85 ( V_42 , 1 ) ;
}
...
static int F_93 ( struct V_41 * V_42 , int V_52 ,
int V_196 , int V_197 , T_3 * V_185 )
{
struct V_47 * V_7 = F_20 ( V_42 ) ;
struct V_56 * V_57 = F_94 ( V_7 ) ;
unsigned V_179 = F_95 ( V_7 ) ;
...
static int F_96 ( struct V_47 * V_7 , unsigned int V_48 )
{
struct V_56 * V_57 = F_94 ( V_7 ) ;
T_2 * V_23 = & V_7 -> V_65 . V_148 ;
unsigned V_130 = F_97 ( V_7 ) ;
int V_86 ;
...
F_52 ( & V_57 -> V_52 ) ;
F_52 ( & V_57 -> V_79 ) ;
V_86 = F_72 ( & V_7 -> V_65 , 0 , V_57 -> V_202 , V_57 -> V_200 ) ;
if ( V_86 )
goto V_175;
V_86 = F_72 ( & V_7 -> V_65 , 1 , V_57 -> V_202 , V_57 -> V_200 ) ;
if ( V_86 )
goto V_175;
V_86 = F_69 ( & V_7 -> V_65 , 0 , V_48 , V_57 -> V_203 ,
V_57 -> V_201 , V_130 ) ;
if ( V_86 )
goto V_175;
V_86 = F_69 ( & V_7 -> V_65 , 1 , V_48 , V_57 -> V_203 ,
V_57 -> V_201 , V_130 ) ;
if ( V_86 )
goto V_175;
if ( * V_23 & V_161 ) {
...
{
int V_204 = F_97 ( V_7 ) >> 2 ;
if ( ( V_48 >> 2 ) < 1 || ( V_48 >> 2 ) > V_204 || ( V_48 & 3 ) )
return - V_155 ;
return F_96 ( V_7 , V_48 ) ;
}
static int F_99 ( struct V_47 * V_7 , const T_3 * V_117 ,
unsigned int V_205 )
{
struct V_56 * V_57 = F_94 ( V_7 ) ;
struct V_206 V_207 ;
if ( F_100 ( & V_207 , V_117 , V_205 ) != 0 )
goto V_208;
...
{
return F_93 ( V_42 , 1 , V_42 -> V_50 , V_42 -> V_51 , V_42 -> V_185 ) ;
}
static int F_103 ( struct V_41 * V_42 )
{
return F_93 ( V_42 , 0 , V_42 -> V_50 , V_42 -> V_51 , V_42 -> V_185 ) ;
}
static int T_5 F_104 ( void )
{
int V_211 = F_105 ( V_212 ) ;
int V_21 , V_101 ;
V_17 = F_106 ( & V_213 ) ;
if ( F_107 ( V_17 ) )
return F_108 ( V_17 ) ;
...
V_215 -> V_226 . V_227 = F_80 ;
if ( ! V_215 -> V_226 . V_52 )
V_215 -> V_226 . V_52 = F_90 ;
if ( ! V_215 -> V_226 . V_79 )
V_215 -> V_226 . V_79 = F_91 ;
V_215 -> V_228 = F_58 ;
...
for ( V_21 = 0 ; V_21 < F_105 ( V_236 ) ; V_21 ++ ) {
...
for ( V_21 = 0 ; V_21 < F_105 ( V_236 ) ; V_21 ++ ) {
if ( V_236 [ V_21 ] . V_235 )
F_114 ( & V_236 [ V_21 ] . V_10 ) ;
}
for ( V_21 = 0 ; V_21 < V_211 ; V_21 ++ ) {
if ( V_212 [ V_21 ] . V_235 )
F_115 ( & V_212 [ V_21 ] . V_10 ) ;
}
F_48 ( & V_17 -> V_16 ) ;
F_110 ( V_17 ) ;
}
