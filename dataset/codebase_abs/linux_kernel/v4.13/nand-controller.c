...
F_114 ( V_18 -> V_22 , V_75 -> V_79 , & V_75 -> V_183 ) ;
return 0 ;
}
...
( V_231 < 0 && V_231 != V_233 ) )
return - V_234 ;
return V_18 -> V_116 -> V_235 -> V_236 ( V_62 , V_231 , V_181 ) ;
}
...
V_3 -> V_243 = F_41 ;
V_3 -> V_244 = F_46 ;
if ( V_18 -> V_193 && V_18 -> V_116 -> V_235 -> V_236 )
V_3 -> V_236 = F_115 ;
V_3 -> V_245 = 40 ;
if ( V_18 -> V_54 )
V_3 -> V_67 |= V_246 ;
...
V_61 -> V_251 = F_127 ( V_18 -> V_34 , V_252 ,
...
struct V_263 V_264 ;
T_1 V_93 ;
V_29 = F_138 ( V_256 , 0 , & V_264 ) ;
if ( V_29 ) {
F_16 ( V_18 -> V_34 , L_31 ,
V_29 ) ;
return F_134 ( V_29 ) ;
}
V_29 = F_139 ( V_256 , L_25 , V_94 * V_257 ,
& V_93 ) ;
if ( V_29 ) {
F_16 ( V_18 -> V_34 , L_31 ,
V_29 ) ;
...
V_62 -> V_75 [ V_94 ] . V_64 . V_71 = V_264 . V_265 ;
V_62 -> V_75 [ V_94 ] . V_64 . V_65 = F_140 ( V_18 -> V_34 , & V_264 ) ;
if ( F_95 ( V_62 -> V_75 [ V_94 ] . V_64 . V_65 ) )
return F_137 ( V_62 -> V_75 [ V_94 ] . V_64 . V_65 ) ;
if ( ! F_93 ( V_256 , L_32 , & V_93 ) ) {
if ( V_93 > V_266 )
return F_134 ( - V_234 ) ;
...
{
int V_29 ;
if ( V_62 -> V_262 && F_45 ( V_62 -> V_262 ) ) {
F_143 ( V_18 -> V_34 , L_39 ) ;
return 0 ;
}
V_18 -> V_116 -> V_235 -> V_268 ( V_18 , V_62 ) ;
V_29 = F_120 ( V_62 ) ;
if ( V_29 )
return V_29 ;
V_29 = V_18 -> V_116 -> V_235 -> V_269 ( V_62 ) ;
if ( V_29 )
return V_29 ;
return F_126 ( V_62 ) ;
}
...
{
struct V_271 * V_34 = V_18 -> V_34 ;
struct V_272 * V_273 = F_147 ( V_34 ) ;
struct V_1 * V_62 ;
struct V_258 * V_74 ;
struct V_263 * V_264 ;
...
return - V_253 ;
V_62 -> V_76 = 1 ;
V_264 = F_148 ( V_273 , V_274 , 0 ) ;
V_62 -> V_75 [ 0 ] . V_64 . V_65 = F_140 ( V_34 , V_264 ) ;
if ( F_95 ( V_62 -> V_75 [ 0 ] . V_64 . V_65 ) )
return F_96 ( V_62 -> V_75 [ 0 ] . V_64 . V_65 ) ;
V_62 -> V_75 [ 0 ] . V_64 . V_71 = V_264 -> V_265 ;
V_62 -> V_75 [ 0 ] . V_79 = 3 ;
V_74 = F_149 ( V_34 , NULL , 0 , V_260 ) ;
if ( F_95 ( V_74 ) ) {
F_16 ( V_34 , L_35 ,
F_96 ( V_74 ) ) ;
return F_96 ( V_74 ) ;
...
V_74 = F_149 ( V_18 -> V_34 , NULL , 2 , V_260 ) ;
if ( F_95 ( V_74 ) ) {
F_16 ( V_34 ,
L_30 ,
F_96 ( V_74 ) ) ;
...
return F_146 ( V_18 ) ;
V_256 = V_34 -> V_156 ;
V_29 = F_93 ( V_256 , L_40 , & V_93 ) ;
if ( V_29 ) {
F_16 ( V_34 , L_41 ) ;
return V_29 ;
}
V_257 = V_93 ;
V_29 = F_93 ( V_256 , L_42 , & V_93 ) ;
if ( V_29 ) {
F_16 ( V_34 , L_41 ) ;
return V_29 ;
}
...
struct V_272 * V_273 ,
const struct V_276 * V_116 )
{
struct V_271 * V_34 = & V_273 -> V_34 ;
struct V_255 * V_256 = V_34 -> V_156 ;
int V_29 ;
F_156 ( & V_18 -> V_4 ) ;
F_157 ( & V_18 -> V_254 ) ;
V_18 -> V_34 = V_34 ;
...
F_160 ( V_279 ) ;
F_161 ( V_280 , V_279 ) ;
V_18 -> V_54 = F_162 ( V_279 , NULL , NULL ) ;
if ( ! V_18 -> V_54 )
F_16 ( V_18 -> V_34 , L_44 ) ;
}
if ( V_18 -> V_116 -> V_155 )
return 0 ;
V_18 -> V_193 = F_163 ( V_34 -> V_237 -> V_156 , 0 ) ;
if ( F_95 ( V_18 -> V_193 ) ) {
F_16 ( V_34 , L_45 ) ;
return F_96 ( V_18 -> V_193 ) ;
}
V_256 = F_164 ( V_34 -> V_237 -> V_156 , L_46 , 0 ) ;
if ( ! V_256 ) {
F_16 ( V_34 , L_47 ) ;
return - V_234 ;
}
V_18 -> V_22 = F_165 ( V_256 ) ;
F_166 ( V_256 ) ;
if ( F_95 ( V_18 -> V_22 ) ) {
V_29 = F_96 ( V_18 -> V_22 ) ;
F_16 ( V_34 , L_48 , V_29 ) ;
...
{
struct V_271 * V_34 = V_18 -> V_4 . V_34 ;
const struct V_281 * V_282 ;
struct V_255 * V_256 ;
int V_29 ;
if ( V_18 -> V_4 . V_116 -> V_155 )
return 0 ;
V_256 = F_164 ( V_34 -> V_237 -> V_156 , L_49 , 0 ) ;
if ( ! V_256 )
return 0 ;
V_282 = F_168 ( V_283 , V_256 ) ;
if ( ! V_282 ) {
F_166 ( V_256 ) ;
return 0 ;
}
V_18 -> V_248 = F_165 ( V_256 ) ;
F_166 ( V_256 ) ;
if ( F_95 ( V_18 -> V_248 ) ) {
V_29 = F_96 ( V_18 -> V_248 ) ;
F_16 ( V_34 , L_50 , V_29 ) ;
return V_29 ;
}
V_18 -> V_249 = ( unsigned int ) V_282 -> V_17 ;
if ( F_169 ( V_34 -> V_237 -> V_156 ,
L_51 ) )
V_18 -> V_249 += 4 ;
return 0 ;
}
...
struct V_271 * V_34 = V_18 -> V_4 . V_34 ;
struct V_255 * V_275 , * V_289 ;
void T_9 * V_290 ;
struct V_263 V_264 ;
int V_29 ;
V_275 = V_34 -> V_156 ;
V_289 = F_171 ( V_34 -> V_156 , NULL ,
L_52 ) ;
V_18 -> V_291 = F_163 ( V_289 , 0 ) ;
if ( F_95 ( V_18 -> V_291 ) ) {
V_29 = F_96 ( V_18 -> V_291 ) ;
F_16 ( V_34 , L_53 ,
V_29 ) ;
goto V_292;
}
V_29 = F_172 ( V_18 -> V_291 ) ;
if ( V_29 ) {
F_16 ( V_34 , L_54 ,
V_29 ) ;
goto V_292;
}
V_18 -> V_16 = F_173 ( V_275 , 0 ) ;
if ( V_18 -> V_16 < 0 ) {
V_29 = V_18 -> V_16 ;
if ( V_29 != - V_277 )
F_16 ( V_34 , L_55 ,
...
V_29 = F_138 ( V_289 , 0 , & V_264 ) ;
if ( V_29 ) {
F_16 ( V_34 , L_56 ,
V_29 ) ;
goto V_292;
}
V_290 = F_140 ( V_34 , & V_264 ) ;
if ( F_95 ( V_290 ) ) {
V_29 = F_96 ( V_290 ) ;
goto V_292;
}
V_285 . V_251 = L_57 ;
V_285 . V_293 = F_174 ( & V_264 ) - 4 ;
V_18 -> V_64 = F_175 ( V_34 , V_290 , & V_285 ) ;
if ( F_95 ( V_18 -> V_64 ) ) {
V_29 = F_96 ( V_18 -> V_64 ) ;
F_16 ( V_34 , L_58 ,
V_29 ) ;
...
V_285 . V_251 = L_60 ;
V_285 . V_293 = F_174 ( & V_264 ) - 4 ;
V_18 -> V_4 . V_22 = F_175 ( V_34 , V_290 , & V_285 ) ;
...
V_29 = F_138 ( V_289 , 2 , & V_264 ) ;
if ( V_29 ) {
F_16 ( V_34 , L_61 ,
V_29 ) ;
goto V_292;
}
V_18 -> V_120 . V_65 = F_140 ( V_34 , & V_264 ) ;
if ( F_95 ( V_18 -> V_120 . V_65 ) ) {
V_29 = F_96 ( V_18 -> V_120 . V_65 ) ;
goto V_292;
}
V_18 -> V_120 . V_71 = V_264 . V_265 ;
V_292:
F_166 ( V_289 ) ;
return V_29 ;
}
...
V_256 = F_164 ( V_34 -> V_156 , L_62 , 0 ) ;
if ( ! V_256 ) {
F_16 ( V_34 , L_63 ) ;
return - V_234 ;
}
V_18 -> V_64 = F_165 ( V_256 ) ;
F_166 ( V_256 ) ;
if ( F_95 ( V_18 -> V_64 ) ) {
V_29 = F_96 ( V_18 -> V_64 ) ;
F_16 ( V_34 , L_64 , V_29 ) ;
...
V_18 -> V_120 . V_294 = F_177 ( V_18 -> V_4 . V_34 -> V_156 ,
L_65 , 0 ) ;
if ( ! V_18 -> V_120 . V_294 ) {
F_16 ( V_18 -> V_4 . V_34 , L_66 ) ;
return - V_253 ;
}
V_18 -> V_120 . V_65 = F_178 ( V_18 -> V_120 . V_294 ,
V_295 ,
& V_18 -> V_120 . V_71 ) ;
if ( ! V_18 -> V_120 . V_65 ) {
F_16 ( V_18 -> V_4 . V_34 ,
...
if ( V_29 )
return V_29 ;
V_296 = F_2 ( V_18 , struct V_9 , V_4 ) ;
if ( V_296 -> V_120 . V_294 )
F_180 ( V_296 -> V_120 . V_294 ,
( unsigned long ) V_296 -> V_120 . V_65 ,
V_295 ) ;
if ( V_296 -> V_291 ) {
F_181 ( V_296 -> V_291 ) ;
F_154 ( V_296 -> V_291 ) ;
...
struct V_9 * V_18 ;
int V_29 ;
V_18 = F_135 ( V_34 , sizeof( * V_18 ) , V_252 ) ;
if ( ! V_18 )
return - V_253 ;
V_29 = F_155 ( & V_18 -> V_4 , V_273 , V_116 ) ;
if ( V_29 )
return V_29 ;
if ( V_116 -> V_155 )
V_29 = F_170 ( V_18 ) ;
...
static int F_186 ( struct V_272 * V_273 )
{
const struct V_276 * V_116 ;
if ( V_273 -> V_299 )
V_116 = ( void * ) V_273 -> V_299 -> V_300 ;
else
V_116 = F_187 ( & V_273 -> V_34 ) ;
if ( ! V_116 ) {
F_16 ( & V_273 -> V_34 , L_70 ) ;
return - V_234 ;
}
if ( V_116 -> V_155 ) {
T_1 V_117 = 21 ;
if ( F_171 ( V_273 -> V_34 . V_156 , NULL ,
L_52 ) )
V_116 = & V_301 ;
if ( ! V_116 -> V_278 &&
F_188 ( V_273 -> V_34 . V_156 ,
L_71 ) )
V_116 = & V_302 ;
F_93 ( V_273 -> V_34 . V_156 ,
L_72 , & V_117 ) ;
if ( V_117 != 21 )
V_116 = & V_303 ;
}
return V_116 -> V_235 -> V_304 ( V_273 , V_116 ) ;
}
static int F_189 ( struct V_272 * V_273 )
{
struct V_5 * V_18 = F_190 ( V_273 ) ;
return V_18 -> V_116 -> V_235 -> remove ( V_18 ) ;
}
static T_10 int F_191 ( struct V_271 * V_34 )
{
struct V_5 * V_18 = F_192 ( V_34 ) ;
struct V_1 * V_62 ;
F_193 (nand, &nc->chips, node) {
int V_94 ;
for ( V_94 = 0 ; V_94 < V_62 -> V_76 ; V_94 ++ )
F_194 ( & V_62 -> V_4 , V_94 ) ;
}
