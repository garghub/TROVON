...
static void F_5 ( struct V_12 * V_13 , int V_14 , int V_19 )
{
unsigned int V_15 = 0 ;
bool V_20 = true ;
switch ( V_14 ) {
...
if ( V_20 ) {
F_6 ( V_19 , V_13 -> V_5 + V_14 ) ;
} else {
struct V_24 * V_25 = V_13 -> V_26 ;
unsigned long V_27 ;
T_2 V_28 ;
F_7 ( & V_25 -> V_29 , V_27 ) ;
V_28 = F_4 ( V_13 -> V_5 + V_14 ) ;
V_28 &= ~ ( 0xff << V_15 ) ;
V_28 |= V_19 << V_15 ;
F_6 ( V_28 , V_13 -> V_5 + V_14 ) ;
F_8 ( & V_25 -> V_29 , V_27 ) ;
}
}
static int F_9 ( struct V_30 * V_31 )
{
return F_4 ( V_31 -> V_4 . V_5 + V_32 ) ;
}
static void F_10 ( struct V_30 * V_31 , int V_19 )
{
F_6 ( V_19 , V_31 -> V_4 . V_5 + V_32 ) ;
}
static int F_11 ( struct V_2 * V_33 , struct V_12 * V_4 ,
struct V_24 * V_25 )
{
int V_34 ;
T_2 V_35 ;
