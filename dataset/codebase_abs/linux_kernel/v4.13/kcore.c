...
if ( F_41 ( V_122 , V_128 ) )
return - V_131 ;
} else if ( V_11 -> type == V_132 ) {
F_42 ( V_125 , ( char * ) V_36 , V_128 ) ;
...
V_133 = F_39 ( V_122 , V_125 , V_128 ) ;
if ( V_133 ) {
if ( F_41 ( V_122 + V_128 - V_133 ,
V_133 ) )
return - V_131 ;
}
} else {
...
static int F_44 ( struct V_134 * V_134 , struct V_121 * V_135 )
{
if ( ! F_45 ( V_136 ) )
return - V_137 ;
V_135 -> V_126 = F_20 ( V_110 , V_30 ) ;
if ( ! V_135 -> V_126 )
return - V_31 ;
if ( V_24 )
F_19 () ;
if ( F_46 ( V_134 ) != V_27 -> V_4 ) {
F_47 ( V_134 ) ;
F_48 ( V_134 , V_27 -> V_4 ) ;
F_49 ( V_134 ) ;
}
...
static int F_50 ( struct V_134 * V_134 , struct V_121 * V_121 )
{
F_13 ( V_121 -> V_126 ) ;
return 0 ;
}
static int T_7 F_51 ( struct V_138 * V_139 ,
unsigned long V_140 , void * V_40 )
{
switch ( V_140 ) {
case V_141 :
case V_142 :
...
{
F_1 ( & V_144 , V_145 , V_146 - V_145 , V_108 ) ;
}
static void T_8 F_52 ( void )
{
}
...
{
if ( V_147 != V_43 && V_148 != V_149 ) {
F_1 ( & V_150 , ( void * ) V_147 ,
V_148 - V_147 , V_132 ) ;
}
}
static void T_8 F_53 ( void )
