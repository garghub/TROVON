...
static int F_22 ( struct V_5 * V_18 , int V_44 )
{
int V_32 ;
V_32 = F_23 ( V_18 , V_45 , 0 ) ;
if ( V_32 < 0 )
goto V_46;
F_24 ( 150 ) ;
V_32 = F_23 ( V_18 , V_47 , 0 ) ;
if ( V_32 < 0 )
goto V_46;
F_24 ( 150 ) ;
V_32 = F_23 ( V_18 , V_44 ? V_48 : V_45 ,
0 ) ;
if ( V_32 < 0 )
goto V_46;
return 0 ;
...
static int F_25 ( struct V_5 * V_18 , struct V_49 * V_50 )
{
int V_32 ;
T_2 V_51 [ V_52 ] ;
struct V_19 * V_6 ;
F_26 ( V_18 , V_50 ) ;
V_6 = F_27 ( sizeof( * V_6 ) , V_53 ) ;
if ( ! V_6 )
return - V_34 ;
V_18 -> V_20 = V_6 ;
V_32 = F_28 ( V_18 , V_54 , 0 , 0 , V_52 , V_51 , 0 ) ;
if ( V_32 < 0 ) {
...
V_18 -> V_7 -> V_56 = & V_57 ;
V_18 -> V_7 -> V_58 = & V_59 ;
V_32 = F_28 ( V_18 , V_60 , 0 , 0 , 1 , V_51 , 0 ) ;
if ( V_32 < 0 ) {
F_16 ( V_18 -> V_7 , L_9 ,
V_32 ) ;
goto free;
...
static int F_31 ( struct V_5 * V_18 )
{
struct V_19 * V_6 = V_18 -> V_20 ;
F_11 ( V_18 -> V_7 , L_14 ) ;
if ( V_6 -> V_14 ) {
...
static void F_34 ( struct V_5 * V_18 , struct V_49 * V_50 )
{
struct V_19 * V_6 = V_18 -> V_20 ;
F_20 ( V_18 ) ;
F_30 ( V_6 ) ;
}
static int F_35 ( struct V_5 * V_18 )
{
...
V_32 = F_38 ( V_18 , V_81 , 0 , 0 , V_52 ,
V_73 -> V_80 , 0 ) ;
if ( V_32 < 0 )
goto V_75;
V_32 = F_37 ( V_18 , V_82 , 0 ) ;
if ( V_32 < 0 )
goto V_75;
V_74 = F_36 ( V_18 , 0 ) ;
F_11 ( V_18 -> V_7 , L_19 ,
...
V_6 -> V_14 = F_40 ( V_18 -> V_7 , V_6 -> V_71 ,
& F_8 ,
V_84 ) ;
if ( F_41 ( V_6 -> V_14 ) ) {
F_16 ( V_18 -> V_7 , L_21 ,
...
static int F_45 ( struct V_5 * V_18 , struct V_85 * V_86 )
{
struct V_19 * V_87 = V_18 -> V_20 ;
struct V_88 * V_89 = & V_87 -> V_90 ;
return F_46 ( V_18 , V_86 , V_89 ) ;
}
