...
static int F_70 ( struct V_49 * V_50 , int V_122 ,
...
V_115 |= V_18 ;
if ( V_50 -> V_57 ) {
T_6 V_151 = V_50 -> V_152 / V_50 -> V_57 ;
if ( V_52 -> V_107 . V_64 == V_116 )
V_115 |= V_117 ;
V_8 -> V_75 = F_68 ( V_50 ) ;
if ( V_8 -> V_75 == 4 )
V_115 |= V_153 ;
V_115 |= F_76 ( F_77 ( V_151 ) - 6 ) ;
} else {
V_8 -> V_75 = 1 ;
}
F_16 ( V_115 , V_17 ) ;
...
static void F_88 ( struct V_49 * V_50 , unsigned V_186 ,
int V_101 , int V_102 )
{
struct V_52 * V_52 = F_39 ( V_50 ) ;
struct V_7 * V_8 = F_40 ( V_52 ) ;
...
case V_42 :
V_8 -> V_14 -> V_187 ( V_50 ) ;
V_8 -> V_14 -> V_188 ( V_8 , V_186 , false ) ;
break;
case V_189 :
V_8 -> V_83 = 0 ;
V_8 -> V_79 = true ;
V_8 -> V_14 -> V_188 ( V_8 , V_186 , true ) ;
...
int V_4 ;
if ( ! V_89 -> V_204 ||
! ( F_90 ( V_89 -> V_205 . V_206 )
& V_207 ) )
return - V_148 ;
V_8 -> V_83 = 0 ;
for ( V_4 = 0 ; V_4 < V_208 ; ++ V_4 )
V_89 -> V_209 ( V_50 , V_203 [ V_4 ] ) ;
F_7 ( V_8 -> V_60 , V_8 -> V_59 , V_50 -> V_57 ) ;
V_8 -> V_14 -> V_188 ( V_8 , V_210 , false ) ;
F_63 ( V_50 , V_44 , - 1 ) ;
V_8 -> V_14 -> V_193 ( V_50 , V_197 ) ;
return 0 ;
}
...
& V_207 ) )
return - V_148 ;
V_8 -> V_14 -> V_188 ( V_8 , V_211 , false ) ;
F_63 ( V_50 , V_44 , - 1 ) ;
V_8 -> V_14 -> V_193 ( V_50 , V_194 ) ;
F_1 ( V_8 -> V_59 , V_8 -> V_60 , 512 ) ;
V_8 -> V_83 = 0 ;
for ( V_4 = 0 ; V_4 < V_208 ; ++ V_4 )
* V_203 ++ = V_89 -> V_212 ( V_50 ) ;
return 0 ;
}
...
{
struct V_218 * V_219 = V_8 -> V_33 -> V_220 ;
const struct V_221 * V_222 =
F_98 ( V_223 , V_8 -> V_33 ) ;
if ( ! V_219 )
return 1 ;
V_8 -> V_14 = V_222 -> V_224 ;
return 0 ;
}
static int T_11 F_97 ( struct V_7 * V_8 )
{
...
struct V_227 * V_228 ;
int V_71 = 0 ;
V_8 = F_100 ( & V_226 -> V_33 , sizeof( struct V_7 ) ,
V_229 ) ;
if ( ! V_8 )
return - V_230 ;
V_8 -> V_59 = F_100 ( & V_226 -> V_33 , V_231 , V_229 ) ;
if ( ! V_8 -> V_59 )
return - V_230 ;
V_8 -> V_33 = & V_226 -> V_33 ;
V_93 = & V_8 -> V_232 ;
V_50 = F_101 ( V_93 ) ;
V_50 -> V_33 . V_233 = & V_226 -> V_33 ;
V_50 -> V_234 = V_235 ;
V_93 -> V_236 = 5 ;
F_102 ( V_93 , V_8 ) ;
F_103 ( V_93 , V_226 -> V_33 . V_220 ) ,
V_93 -> V_237 = F_47 ;
V_93 -> V_238 = F_88 ;
V_93 -> V_212 = F_53 ;
V_93 -> V_239 = F_54 ;
...
V_93 -> V_242 = F_89 ;
V_93 -> V_243 = F_91 ;
V_8 -> V_91 = F_104 ( & V_226 -> V_33 , NULL ) ;
if ( F_72 ( V_8 -> V_91 ) )
...
if ( V_71 < 0 )
return V_71 ;
V_93 -> V_250 = V_8 -> V_14 -> V_250 ;
if ( V_8 -> V_14 -> V_251 ) {
V_228 = F_107 ( V_226 , V_252 , 0 ) ;
V_8 -> V_253 = F_108 ( & V_226 -> V_33 , V_228 ) ;
if ( F_72 ( V_8 -> V_253 ) )
return F_105 ( V_8 -> V_253 ) ;
V_228 = F_107 ( V_226 , V_252 , 1 ) ;
} else {
V_228 = F_107 ( V_226 , V_252 , 0 ) ;
}
V_8 -> V_254 = F_108 ( & V_226 -> V_33 , V_228 ) ;
if ( F_72 ( V_8 -> V_254 ) )
return F_105 ( V_8 -> V_254 ) ;
V_8 -> V_60 = V_8 -> V_254 ;
if ( V_8 -> V_14 -> V_255 )
V_8 -> V_256 = V_8 -> V_254 + V_8 -> V_14 -> V_255 ;
V_8 -> V_97 = V_8 -> V_254 + V_8 -> V_14 -> V_257 ;
if ( V_8 -> V_14 -> V_258 )
V_8 -> V_259 = V_8 -> V_254 + V_8 -> V_14 -> V_258 ;
V_93 -> V_107 . V_112 = V_8 -> V_14 -> V_260 ;
V_8 -> V_75 = V_8 -> V_14 -> V_75 ;
V_93 -> V_261 = V_8 -> V_14 -> V_261 ;
V_93 -> V_107 . V_3 = 512 ;
F_109 ( V_50 , V_8 -> V_14 -> V_262 ) ;
if ( V_8 -> V_245 . V_263 ) {
V_93 -> V_107 . V_64 = V_116 ;
} else {
V_93 -> V_107 . V_64 = V_264 ;
V_93 -> V_107 . V_265 = V_266 ;
}
if ( V_8 -> V_245 . V_267 == 2 )
V_93 -> V_81 |= V_82 ;
if ( V_8 -> V_245 . V_268 )
V_93 -> V_269 |= V_270 ;
F_110 ( & V_8 -> V_27 ) ;
V_8 -> V_21 = F_111 ( V_226 , 0 ) ;
if ( V_8 -> V_21 < 0 )
return V_8 -> V_21 ;
V_8 -> V_14 -> F_19 ( V_8 , 0 ) ;
V_71 = F_112 ( & V_226 -> V_33 , V_8 -> V_21 , F_25 ,
0 , V_235 , V_8 ) ;
if ( V_71 )
return V_71 ;
V_71 = F_60 ( V_8 -> V_91 ) ;
...
F_114 ( & V_226 -> V_33 , ( void * ) V_8 -> V_59 ) ;
V_8 -> V_59 = F_100 ( & V_226 -> V_33 , V_50 -> V_57 + V_50 -> V_88 ,
V_229 ) ;
if ( ! V_8 -> V_59 ) {
V_71 = - V_230 ;
goto V_271;
...
{
struct V_7 * V_8 = F_119 ( V_226 ) ;
F_120 ( F_101 ( & V_8 -> V_232 ) ) ;
if ( V_8 -> V_90 )
F_59 ( V_8 -> V_91 ) ;
return 0 ;
}
