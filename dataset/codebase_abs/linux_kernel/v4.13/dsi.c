...
static void F_117 ( struct V_214 * V_215 )
{
...
struct V_214 * V_215 )
{
#define F_119 ( V_155 ) seq_printf(s, "%-35s %08x\n", #r, dsi_read_reg(dsidev, r))
if ( F_70 ( V_3 ) )
return;
F_95 ( V_3 ) ;
F_119 ( V_232 ) ;
...
V_155 = F_130 ( V_155 , V_273 + 1 , V_271 + 2 , V_271 ) ;
V_155 = F_130 ( V_155 , V_272 , V_271 + 3 , V_271 + 3 ) ;
}
for (; V_109 < V_16 -> V_274 ; ++ V_109 ) {
unsigned V_271 = V_262 [ V_109 ] ;
V_155 = F_130 ( V_155 , 0 , V_271 + 2 , V_271 ) ;
V_155 = F_130 ( V_155 , 0 , V_271 + 3 , V_271 + 3 ) ;
}
F_7 ( V_3 , V_235 , V_155 ) ;
return 0 ;
}
static inline unsigned F_131 ( struct V_2 * V_3 , unsigned V_277 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
unsigned long V_278 = V_16 -> V_175 . V_176 . V_180 / 4 ;
return ( V_277 * ( V_278 / 1000 / 1000 ) + 999 ) / 1000 ;
}
static inline unsigned F_132 ( struct V_2 * V_3 , unsigned V_279 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
unsigned long V_278 = V_16 -> V_175 . V_176 . V_180 / 4 ;
...
T_1 V_287 ;
V_280 = F_131 ( V_3 , 70 ) + 2 ;
V_281 = F_131 ( V_3 , 175 ) + 2 ;
V_282 = F_131 ( V_3 , 60 ) + 5 ;
V_283 = F_131 ( V_3 , 145 ) ;
V_284 = F_131 ( V_3 , 25 ) ;
V_285 = F_131 ( V_3 , 60 ) + 2 ;
V_287 = F_131 ( V_3 , 65 ) ;
V_286 = F_131 ( V_3 , 260 ) ;
F_71 ( L_44 ,
V_280 , F_132 ( V_3 , V_280 ) ,
V_281 , F_132 ( V_3 , V_281 ) ) ;
F_71 ( L_45 ,
V_282 , F_132 ( V_3 , V_282 ) ,
V_283 , F_132 ( V_3 , V_283 ) ) ;
F_71 ( L_46
L_47 ,
V_284 , F_132 ( V_3 , V_284 ) ,
V_285 , F_132 ( V_3 , V_285 ) ,
V_286 , F_132 ( V_3 , V_286 ) ) ;
F_71 ( L_48 ,
V_287 , F_132 ( V_3 , V_287 ) ) ;
V_155 = F_9 ( V_3 , V_252 ) ;
V_155 = F_130 ( V_155 , V_280 , 31 , 24 ) ;
V_155 = F_130 ( V_155 , V_281 , 23 , 16 ) ;
V_155 = F_130 ( V_155 , V_282 , 15 , 8 ) ;
V_155 = F_130 ( V_155 , V_283 , 7 , 0 ) ;
F_7 ( V_3 , V_252 , V_155 ) ;
V_155 = F_9 ( V_3 , V_253 ) ;
V_155 = F_130 ( V_155 , V_284 , 20 , 16 ) ;
V_155 = F_130 ( V_155 , V_285 , 15 , 8 ) ;
V_155 = F_130 ( V_155 , V_286 , 7 , 0 ) ;
if ( F_81 ( V_288 ) ) {
V_155 = F_130 ( V_155 , 0 , 21 , 21 ) ;
V_155 = F_130 ( V_155 , 1 , 22 , 22 ) ;
V_155 = F_130 ( V_155 , 1 , 23 , 23 ) ;
}
F_7 ( V_3 , V_253 , V_155 ) ;
V_155 = F_9 ( V_3 , V_254 ) ;
V_155 = F_130 ( V_155 , V_287 , 7 , 0 ) ;
F_7 ( V_3 , V_254 , V_155 ) ;
}
...
T_1 V_163 ;
F_71 ( L_51 ) ;
V_155 = F_139 ( V_16 -> V_181 , F_137 ( V_3 ) ) ;
if ( V_155 )
return V_155 ;
F_95 ( V_3 ) ;
F_9 ( V_3 , V_167 ) ;
...
goto V_300;
V_163 = F_9 ( V_3 , V_236 ) ;
V_163 = F_130 ( V_163 , 1 , 15 , 15 ) ;
V_163 = F_130 ( V_163 , 1 , 14 , 14 ) ;
V_163 = F_130 ( V_163 , 1 , 13 , 13 ) ;
V_163 = F_130 ( V_163 , 0x1fff , 12 , 0 ) ;
F_7 ( V_3 , V_236 , V_163 ) ;
if ( V_16 -> V_301 ) {
unsigned V_289 ;
int V_109 ;
...
V_318 = F_143 ( V_316 , 2 , 0 ) | F_143 ( V_319 , 7 , 4 ) ;
V_155 |= V_318 << ( 8 * V_109 ) ;
V_316 += V_319 ;
}
F_7 ( V_3 , V_242 , V_155 ) ;
...
static bool F_146 ( struct V_2 * V_3 , int V_75 )
{
return F_19 ( V_3 , F_120 ( V_75 ) , 0 , 0 ) ;
}
static void F_147 ( void * V_26 , T_1 V_27 )
{
struct V_321 * V_322 =
(struct V_321 * ) V_26 ;
...
if ( F_19 ( V_322 -> V_3 , F_121 ( V_75 ) , V_324 , V_324 ) == 0 )
F_17 ( V_322 -> V_28 ) ;
}
static int F_148 ( struct V_2 * V_3 , int V_75 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
F_149 ( V_28 ) ;
struct V_321 V_322 = {
...
V_155 = F_65 ( V_3 , V_75 , F_147 ,
& V_322 , V_76 ) ;
if ( V_155 )
goto V_209;
if ( F_19 ( V_3 , F_121 ( V_75 ) , V_324 , V_324 ) ) {
if ( F_150 ( & V_28 ,
F_20 ( 10 ) ) == 0 ) {
F_44 ( L_58 ) ;
V_155 = - V_174 ;
...
static void F_151 ( void * V_26 , T_1 V_27 )
{
struct V_321 * V_326 =
(struct V_321 * ) V_26 ;
struct V_1 * V_16 = F_1 ( V_326 -> V_3 ) ;
const int V_75 = V_16 -> V_323 ;
if ( F_19 ( V_326 -> V_3 , F_120 ( V_75 ) , 5 , 5 ) == 0 )
F_17 ( V_326 -> V_28 ) ;
}
...
int V_155 = 0 ;
V_155 = F_65 ( V_3 , V_75 , F_151 ,
& V_326 , V_76 ) ;
if ( V_155 )
goto V_209;
if ( F_19 ( V_3 , F_120 ( V_75 ) , 5 , 5 ) ) {
if ( F_150 ( & V_28 ,
F_20 ( 10 ) ) == 0 ) {
F_44 ( L_59 ) ;
V_155 = - V_174 ;
...
static int F_153 ( struct V_2 * V_3 , int V_75 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
F_73 ( ! F_15 ( V_3 ) ) ;
F_73 ( F_154 () ) ;
...
case V_328 :
return F_148 ( V_3 , V_75 ) ;
case V_329 :
return F_152 ( V_3 , V_75 ) ;
default:
F_26 () ;
return - V_153 ;
}
...
V_75 , V_172 ) ;
V_172 = V_172 ? 1 : 0 ;
F_84 ( V_3 , F_120 ( V_75 ) , V_172 , 0 , 0 ) ;
if ( F_18 ( V_3 , F_120 ( V_75 ) ,
0 , V_172 ) != V_172 ) {
F_44 ( L_61 , V_172 ) ;
return - V_174 ;
}
...
static void F_156 ( struct V_2 * V_3 , int V_75 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
T_1 V_155 ;
F_71 ( L_62 , V_75 ) ;
V_155 = F_9 ( V_3 , F_120 ( V_75 ) ) ;
if ( F_98 ( V_155 , 15 , 15 ) )
F_44 ( L_63 ,
V_75 ) ;
V_155 = F_130 ( V_155 , 0 , 1 , 1 ) ;
V_155 = F_130 ( V_155 , 0 , 2 , 2 ) ;
V_155 = F_130 ( V_155 , 0 , 3 , 3 ) ;
V_155 = F_130 ( V_155 , 0 , 4 , 4 ) ;
V_155 = F_130 ( V_155 , 1 , 7 , 7 ) ;
V_155 = F_130 ( V_155 , 1 , 8 , 8 ) ;
V_155 = F_130 ( V_155 , 0 , 9 , 9 ) ;
if ( F_81 ( V_330 ) )
V_155 = F_130 ( V_155 , 3 , 11 , 10 ) ;
V_155 = F_130 ( V_155 , 4 , 29 , 27 ) ;
V_155 = F_130 ( V_155 , 4 , 23 , 21 ) ;
F_7 ( V_3 , F_120 ( V_75 ) , V_155 ) ;
V_16 -> V_149 [ V_75 ] . V_327 = V_329 ;
}
static int F_157 ( struct V_2 * V_3 , int V_75 ,
enum V_331 V_327 )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
...
F_153 ( V_3 , V_75 ) ;
F_155 ( V_3 , V_75 , 0 ) ;
if ( F_18 ( V_3 , F_120 ( V_75 ) , 15 , 0 ) != 0 ) {
F_44 ( L_65 , V_75 ) ;
return - V_174 ;
}
F_84 ( V_3 , F_120 ( V_75 ) , V_327 , 1 , 1 ) ;
if ( F_81 ( V_332 ) ) {
bool V_172 = V_327 == V_328 ;
F_84 ( V_3 , F_120 ( V_75 ) , V_172 , 30 , 30 ) ;
}
F_155 ( V_3 , V_75 , 1 ) ;
V_16 -> V_149 [ V_75 ] . V_327 = V_327 ;
return 0 ;
}
static void F_158 ( struct V_5 * V_6 , int V_75 ,
bool V_172 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
...
static void F_160 ( struct V_2 * V_3 , int V_75 )
{
while ( F_19 ( V_3 , F_120 ( V_75 ) , 20 , 20 ) ) {
T_1 V_15 ;
V_15 = F_9 ( V_3 , F_124 ( V_75 ) ) ;
F_71 ( L_67 ,
( V_15 >> 0 ) & 0xff ,
( V_15 >> 8 ) & 0xff ,
( V_15 >> 16 ) & 0xff ,
...
static T_11 F_162 ( struct V_2 * V_3 ,
int V_75 )
{
while ( F_19 ( V_3 , F_120 ( V_75 ) , 20 , 20 ) ) {
T_1 V_15 ;
...
F_71 ( L_90 , V_75 ) ;
F_73 ( ! F_15 ( V_3 ) ) ;
if ( F_19 ( V_3 , F_120 ( V_75 ) , 20 , 20 ) ) {
F_44 ( L_91 ) ;
F_162 ( V_3 , V_75 ) ;
}
F_84 ( V_3 , F_120 ( V_75 ) , 1 , 6 , 6 ) ;
F_9 ( V_3 , F_120 ( V_75 ) ) ;
return 0 ;
}
static int F_164 ( struct V_5 * V_6 , int V_75 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
F_149 ( V_28 ) ;
int V_155 = 0 ;
...
V_15 = F_143 ( V_346 , 7 , 0 ) | F_143 ( V_344 , 23 , 8 ) |
F_143 ( V_345 , 31 , 24 ) ;
...
F_157 ( V_3 , V_75 , V_329 ) ;
F_165 ( V_3 , V_75 , V_343 , V_344 , V_345 ) ;
V_292 = V_26 ;
...
V_348 = * V_292 ++ ;
V_349 = * V_292 ++ ;
F_166 ( V_3 , V_75 , V_165 , V_166 , V_348 , V_349 ) ;
}
V_109 = V_344 % 4 ;
if ( V_109 ) {
...
F_166 ( V_3 , V_75 , V_165 , V_166 , V_348 , 0 ) ;
}
return V_155 ;
}
...
F_157 ( V_3 , V_75 , V_329 ) ;
if ( F_98 ( F_9 ( V_3 , F_120 ( V_75 ) ) , 16 , 16 ) ) {
F_44 ( L_99 ) ;
return - V_153 ;
}
V_346 = V_343 | V_16 -> V_149 [ V_75 ] . V_347 << 6 ;
V_155 = ( V_346 << 0 ) | ( V_26 << 8 ) | ( V_345 << 24 ) ;
F_7 ( V_3 , F_124 ( V_75 ) , V_155 ) ;
return 0 ;
}
static int F_159 ( struct V_5 * V_6 , int V_75 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
return F_167 ( V_3 , V_75 , V_350 , NULL ,
0 , 0 ) ;
}
...
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
return F_169 ( V_3 , V_75 , V_26 , V_344 ,
V_352 ) ;
}
...
struct V_2 * V_3 = F_3 ( V_6 ) ;
int V_155 ;
V_155 = F_169 ( V_3 , V_75 , V_26 , V_344 , type ) ;
if ( V_155 )
goto V_333;
V_155 = F_164 ( V_6 , V_75 ) ;
if ( V_155 )
goto V_333;
if ( F_19 ( V_3 , F_120 ( V_75 ) , 20 , 20 ) ) {
F_44 ( L_100 ) ;
...
int V_344 )
{
return F_172 ( V_6 , V_75 , V_26 , V_344 ,
V_352 ) ;
}
static int F_174 ( struct V_5 * V_6 , int V_75 , T_4 * V_26 ,
int V_344 )
{
return F_172 ( V_6 , V_75 , V_26 , V_344 ,
V_354 ) ;
...
F_71 ( L_102 ,
V_75 , V_361 ) ;
V_155 = F_168 ( V_3 , V_75 , V_362 , V_361 , 0 ) ;
if ( V_155 ) {
F_44 ( L_103
L_104 , V_75 , V_361 ) ;
return V_155 ;
...
V_155 = F_168 ( V_3 , V_75 , V_343 , V_26 , 0 ) ;
if ( V_155 ) {
F_44 ( L_106
L_104 , V_75 , V_364 ) ;
return V_155 ;
...
T_4 V_334 ;
int V_155 ;
if ( F_19 ( V_3 , F_120 ( V_75 ) , 20 , 20 ) == 0 ) {
F_44 ( L_107 ) ;
V_155 = - V_174 ;
goto V_333;
}
...
static int F_178 ( struct V_5 * V_6 , int V_75 , T_4 V_361 ,
T_4 * V_368 , int V_369 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
int V_155 ;
V_155 = F_175 ( V_3 , V_75 , V_361 ) ;
if ( V_155 )
goto V_333;
V_155 = F_164 ( V_6 , V_75 ) ;
if ( V_155 )
goto V_333;
V_155 = F_177 ( V_3 , V_75 , V_368 , V_369 ,
V_352 ) ;
if ( V_155 < 0 )
goto V_333;
if ( V_155 != V_369 ) {
...
struct V_2 * V_3 = F_3 ( V_6 ) ;
int V_155 ;
V_155 = F_176 ( V_3 , V_75 , V_363 , V_364 ) ;
if ( V_155 )
return V_155 ;
V_155 = F_164 ( V_6 , V_75 ) ;
if ( V_155 )
...
V_155 = F_9 ( V_3 , V_237 ) ;
V_155 = F_130 ( V_155 , 1 , 15 , 15 ) ;
V_155 = F_130 ( V_155 , V_380 ? 1 : 0 , 14 , 14 ) ;
V_155 = F_130 ( V_155 , V_379 ? 1 : 0 , 13 , 13 ) ;
V_155 = F_130 ( V_155 , V_378 , 12 , 0 ) ;
F_7 ( V_3 , V_237 , V_155 ) ;
...
static void F_183 ( struct V_2 * V_3 , unsigned V_378 ,
...
V_381 = F_88 ( V_3 ) ;
V_155 = F_9 ( V_3 , V_236 ) ;
V_155 = F_130 ( V_155 , 1 , 31 , 31 ) ;
V_155 = F_130 ( V_155 , V_380 ? 1 : 0 , 30 , 30 ) ;
V_155 = F_130 ( V_155 , V_383 ? 1 : 0 , 29 , 29 ) ;
V_155 = F_130 ( V_155 , V_378 , 28 , 16 ) ;
F_7 ( V_3 , V_236 , V_155 ) ;
...
V_155 = F_130 ( V_155 , 1 , 31 , 31 ) ;
V_155 = F_130 ( V_155 , V_380 ? 1 : 0 , 30 , 30 ) ;
V_155 = F_130 ( V_155 , V_379 ? 1 : 0 , 29 , 29 ) ;
V_155 = F_130 ( V_155 , V_378 , 28 , 16 ) ;
F_7 ( V_3 , V_237 , V_155 ) ;
V_382 = V_378 * ( V_380 ? 16 : 1 ) * ( V_379 ? 4 : 1 ) ;
F_71 ( L_127 ,
...
V_391 = false ;
V_155 = F_9 ( V_3 , V_173 ) ;
V_155 = F_130 ( V_155 , 1 , 9 , 9 ) ;
V_155 = F_130 ( V_155 , 1 , 10 , 10 ) ;
V_155 = F_130 ( V_155 , 1 , 11 , 11 ) ;
V_155 = F_130 ( V_155 , 1 , 15 , 15 ) ;
V_155 = F_130 ( V_155 , V_391 , 16 , 16 ) ;
V_155 = F_130 ( V_155 , 1 , 17 , 17 ) ;
V_155 = F_130 ( V_155 , V_391 , 18 , 18 ) ;
F_7 ( V_3 , V_173 , V_155 ) ;
}
...
T_1 V_155 ;
V_155 = F_9 ( V_3 , V_173 ) ;
V_155 = F_130 ( V_155 , V_394 , 20 , 20 ) ;
V_155 = F_130 ( V_155 , V_395 , 21 , 21 ) ;
V_155 = F_130 ( V_155 , V_396 , 22 , 22 ) ;
V_155 = F_130 ( V_155 , V_397 , 23 , 23 ) ;
F_7 ( V_3 , V_173 , V_155 ) ;
}
static int F_189 ( int V_398 , bool V_399 , int V_400 ,
int V_401 , int V_402 , int V_403 , int V_404 )
{
int V_405 ;
if ( V_399 ) {
V_405 = V_400 + V_401 + F_190 ( V_400 , 2 ) + 1 ;
} else {
int V_406 , V_407 ;
V_406 = V_403 + V_400 + V_401 + F_190 ( V_400 , 2 ) + 1 ;
V_407 = V_403 + V_400 + V_402 + V_404 + V_403 +
V_400 + 1 ;
V_405 = F_190 ( V_406 , V_407 ) ;
}
return V_398 > V_405 ? V_398 - V_405 : 0 ;
}
static int F_191 ( int V_398 , int V_400 , int V_401 ,
int V_189 , int V_408 )
{
int V_409 ;
int V_410 ;
...
V_433 ) ;
V_155 = F_9 ( V_3 , V_246 ) ;
V_155 = F_130 ( V_155 , V_426 , 23 , 16 ) ;
V_155 = F_130 ( V_155 , V_428 , 15 , 8 ) ;
V_155 = F_130 ( V_155 , V_430 , 7 , 0 ) ;
F_7 ( V_3 , V_246 , V_155 ) ;
V_155 = F_9 ( V_3 , V_248 ) ;
V_155 = F_130 ( V_155 , V_427 , 23 , 16 ) ;
V_155 = F_130 ( V_155 , V_429 , 15 , 8 ) ;
V_155 = F_130 ( V_155 , V_431 , 7 , 0 ) ;
F_7 ( V_3 , V_248 , V_155 ) ;
V_155 = F_9 ( V_3 , V_249 ) ;
V_155 = F_130 ( V_155 , V_432 , 31 , 15 ) ;
V_155 = F_130 ( V_155 , V_433 , 16 , 0 ) ;
F_7 ( V_3 , V_249 , V_155 ) ;
}
...
V_155 = F_9 ( V_3 , V_173 ) ;
V_155 = F_130 ( V_155 , 1 , 1 , 1 ) ;
V_155 = F_130 ( V_155 , 1 , 2 , 2 ) ;
V_155 = F_130 ( V_155 , 1 , 3 , 3 ) ;
V_155 = F_130 ( V_155 , 1 , 4 , 4 ) ;
V_155 = F_130 ( V_155 , V_434 , 7 , 6 ) ;
V_155 = F_130 ( V_155 , 0 , 8 , 8 ) ;
V_155 = F_130 ( V_155 , 1 , 14 , 14 ) ;
V_155 = F_130 ( V_155 , 1 , 19 , 19 ) ;
if ( ! F_81 ( V_332 ) ) {
V_155 = F_130 ( V_155 , 1 , 24 , 24 ) ;
V_155 = F_130 ( V_155 , 0 , 25 , 25 ) ;
}
F_7 ( V_3 , V_173 , V_155 ) ;
F_186 ( V_3 ) ;
if ( V_16 -> V_306 == V_307 ) {
...
V_155 = F_9 ( V_3 , V_241 ) ;
V_155 = F_130 ( V_155 , V_419 , 15 , 8 ) ;
V_155 = F_130 ( V_155 , V_420 , 7 , 0 ) ;
F_7 ( V_3 , V_241 , V_155 ) ;
F_71 ( L_130 ,
V_419 ,
V_420 ) ;
...
V_441 , V_388 -> V_448 ) ;
V_155 = F_9 ( V_3 , V_238 ) ;
V_155 = F_130 ( V_155 , V_416 , 11 , 0 ) ;
V_155 = F_130 ( V_155 , V_415 , 23 , 12 ) ;
V_155 = F_130 ( V_155 , V_445 ? V_414 : 0 , 31 , 24 ) ;
F_7 ( V_3 , V_238 , V_155 ) ;
V_155 = F_9 ( V_3 , V_239 ) ;
V_155 = F_130 ( V_155 , V_443 , 7 , 0 ) ;
V_155 = F_130 ( V_155 , V_442 , 15 , 8 ) ;
V_155 = F_130 ( V_155 , V_441 , 23 , 16 ) ;
V_155 = F_130 ( V_155 , V_444 , 27 , 24 ) ;
F_7 ( V_3 , V_239 , V_155 ) ;
V_155 = F_9 ( V_3 , V_240 ) ;
V_155 = F_130 ( V_155 , V_388 -> V_448 , 14 , 0 ) ;
V_155 = F_130 ( V_155 , V_446 , 31 , 16 ) ;
F_7 ( V_3 , V_240 , V_155 ) ;
}
}
...
static int F_196 ( struct V_5 * V_6 , int V_75 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
...
F_83 ( V_3 , false ) ;
F_155 ( V_3 , V_75 , false ) ;
F_84 ( V_3 , F_120 ( V_75 ) , 1 , 4 , 4 ) ;
V_463 = F_92 ( V_16 -> V_388 . V_390 * V_385 , 8 ) ;
F_165 ( V_3 , V_75 , V_343 ,
V_463 , 0 ) ;
F_155 ( V_3 , V_75 , true ) ;
F_83 ( V_3 , true ) ;
}
...
static void F_200 ( struct V_5 * V_6 , int V_75 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
struct V_459 * V_460 = V_16 -> V_461 . V_462 ;
...
if ( V_473 % V_475 )
V_474 += ( V_473 % V_475 ) + 1 ;
V_163 = F_143 ( V_474 , 23 , 0 ) ;
F_7 ( V_3 , F_121 ( V_75 ) , V_163 ) ;
F_165 ( V_3 , V_75 , V_360 ,
V_476 , 0 ) ;
if ( V_16 -> V_325 )
V_163 = F_130 ( V_163 , 1 , 30 , 30 ) ;
else
V_163 = F_130 ( V_163 , 1 , 31 , 31 ) ;
F_7 ( V_3 , F_121 ( V_75 ) , V_163 ) ;
F_203 () ;
F_29 ( V_3 ) ;
V_155 = F_204 ( & V_16 -> V_479 ,
F_20 ( 250 ) ) ;
F_61 ( V_155 == 0 ) ;
F_205 ( V_460 , & V_16 -> V_388 ) ;
F_206 ( V_460 ) ;
if ( V_16 -> V_325 ) {
F_84 ( V_3 , V_237 , 0 , 15 , 15 ) ;
F_163 ( V_3 , V_75 ) ;
#ifdef F_50
F_207 ( & V_16 -> V_141 , V_34 + F_20 ( 250 ) ) ;
#endif
}
}
static void F_208 ( unsigned long V_127 )
{
F_44 ( L_136 ) ;
}
static void F_209 ( struct V_2 * V_3 , int error )
{
struct V_1 * V_16 = F_1 ( V_3 ) ;
F_210 () ;
if ( V_16 -> V_325 ) {
...
static void F_211 ( struct V_482 * V_483 )
{
struct V_1 * V_16 = F_102 ( V_483 , struct V_1 ,
V_479 . V_483 ) ;
F_44 ( L_138 ) ;
F_209 ( V_16 -> V_157 , - V_484 ) ;
}
static void F_212 ( void * V_26 )
{
...
static int F_214 ( struct V_5 * V_6 , int V_75 ,
void (* F_215)( int , void * ) , void * V_26 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
T_11 V_485 , V_486 ;
...
struct V_1 * V_16 = F_1 ( V_3 ) ;
int V_155 ;
V_155 = F_226 ( & V_16 -> V_175 ) ;
if ( V_155 )
goto V_209;
V_155 = F_223 ( V_3 ) ;
if ( V_155 )
goto V_211;
F_227 ( V_16 -> V_181 , V_16 -> V_181 == 0 ?
V_226 :
V_227 ) ;
F_71 ( L_142 ) ;
V_155 = F_138 ( V_3 ) ;
...
F_153 ( V_3 , 2 ) ;
F_153 ( V_3 , 3 ) ;
F_229 ( V_3 , V_212 , V_511 ) ;
F_74 ( V_3 ) ;
F_232 ( & V_16 -> V_512 ) ;
}
static int F_234 ( struct V_5 * V_6 , bool V_172 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
V_16 -> V_325 = V_172 ;
...
static void F_235 ( const char * V_515 ,
const struct V_516 * V_33 )
{
unsigned long V_517 = V_33 -> V_518 / 4 ;
int V_519 , V_520 , V_521 , V_522 ;
V_520 = F_92 ( V_33 -> V_523 * V_33 -> V_524 , 8 ) ;
V_521 = F_92 ( V_520 + 6 , V_33 -> V_423 ) ;
V_519 = V_33 -> V_525 + V_33 -> V_414 + V_33 -> V_526 + V_33 -> V_416 + V_33 -> V_415 ;
V_522 = V_519 + V_521 ;
#define F_236 ( T_5 ) ((u32)div64_u64((u64)x * 1000000000llu, byteclk))
F_36 ( L_146
L_147 ,
V_515 ,
V_517 ,
...
static void F_237 ( const char * V_515 , const struct V_387 * V_33 )
{
...
V_522 = V_523 + V_519 ;
#define F_238 ( T_5 ) ((u32)div64_u64((u64)x * 1000000000llu, pck))
F_36 ( L_148
L_149 ,
V_515 ,
V_527 ,
...
static void F_239 ( const char * V_515 ,
const struct V_516 * V_33 )
{
...
V_527 = ( T_1 ) F_240 ( V_531 , V_33 -> V_524 ) ;
V_532 = F_92 ( F_92 ( V_33 -> V_523 * V_33 -> V_524 , 8 ) + 6 , V_33 -> V_423 ) ;
V_533 = V_33 -> V_525 + V_33 -> V_414 + V_33 -> V_526 + V_33 -> V_416 + V_532 + V_33 -> V_415 ;
V_530 . V_528 = V_527 ;
V_530 . V_529 = F_240 ( ( T_12 ) ( V_33 -> V_414 + V_33 -> V_526 ) * V_527 , V_517 ) ;
V_530 . V_416 = F_240 ( ( T_12 ) V_33 -> V_416 * V_527 , V_517 ) ;
V_530 . V_415 = F_240 ( ( T_12 ) V_33 -> V_415 * V_527 , V_517 ) ;
V_530 . V_390 = V_33 -> V_523 ;
F_237 ( V_515 , & V_530 ) ;
}
static bool F_241 ( int V_534 , int V_535 , unsigned long V_536 ,
...
static bool F_242 ( int V_542 , unsigned long V_543 ,
void * V_26 )
{
struct V_537 * V_538 = V_26 ;
V_538 -> V_544 . V_206 [ V_178 ] = V_542 ;
V_538 -> V_544 . V_177 [ V_178 ] = V_543 ;
return F_243 ( V_543 , V_538 -> V_545 , V_538 -> V_546 ,
F_241 , V_538 ) ;
}
static bool F_244 ( int V_222 , int V_223 , unsigned long V_221 ,
...
return F_245 ( V_538 -> V_175 , V_180 , V_538 -> V_545 ,
F_94 ( V_547 ) ,
F_242 , V_538 ) ;
}
static bool F_246 ( struct V_1 * V_16 ,
...
V_550 = F_190 ( V_549 -> V_555 * 4 , V_552 * 4 * 4 ) ;
V_551 = V_549 -> V_556 * 4 ;
return F_247 ( V_538 -> V_175 , V_220 ,
V_550 , V_551 ,
F_244 , V_538 ) ;
}
static bool F_248 ( struct V_537 * V_538 )
{
...
V_559 = V_558 + V_560 ;
V_532 = F_92 ( F_92 ( V_558 * V_524 , 8 ) + 6 , V_423 ) ;
...
V_533 = F_240 ( ( T_12 ) V_559 * V_517 , V_554 ) ;
if ( V_533 < V_525 + V_526 + V_532 )
return false ;
V_563 = V_533 - V_532 ;
V_561 = F_240 ( ( T_12 ) V_533 * V_557 , V_517 ) ;
...
V_414 = F_240 ( ( T_12 ) V_564 -> V_529 * V_517 , V_554 ) ;
V_414 = F_190 ( V_414 - V_526 , 1 ) ;
}
V_416 = F_240 ( ( T_12 ) V_564 -> V_416 * V_517 , V_554 ) ;
V_416 = F_190 ( V_416 , 1 ) ;
V_415 = V_563 - ( V_525 + V_414 + V_526 + V_416 ) ;
if ( V_415 < 1 ) {
int V_33 ;
V_33 = 1 - V_415 ;
V_416 = F_190 ( V_416 - V_33 , 1 ) ;
V_415 = V_563 - ( V_525 + V_414 + V_526 + V_416 ) ;
if ( V_415 < 1 && V_414 > 0 ) {
V_33 = 1 - V_415 ;
V_414 = F_190 ( V_414 - V_33 , 1 ) ;
V_415 = V_563 - ( V_525 + V_414 + V_526 + V_416 ) ;
}
}
if ( V_415 < 1 )
...
V_539 -> V_528 = V_557 ;
if ( V_549 -> V_392 == V_393 ) {
V_414 = F_240 ( ( T_12 ) V_564 -> V_529 * V_557 ,
V_554 ) ;
V_414 = F_190 ( V_414 , 1 ) ;
} else {
V_414 = 1 ;
}
V_416 = F_240 ( ( T_12 ) V_564 -> V_416 * V_557 , V_554 ) ;
V_416 = F_190 ( V_416 , 1 ) ;
...
static bool F_249 ( int V_534 , int V_535 , unsigned long V_536 ,
unsigned long V_527 , void * V_26 )
{
struct V_537 * V_538 = V_26 ;
V_538 -> V_488 . V_489 = V_534 ;
...
V_538 -> V_488 . V_536 = V_536 ;
V_538 -> V_488 . V_527 = V_527 ;
if ( F_248 ( V_538 ) == false )
return false ;
#ifdef F_250
F_237 ( L_150 , & V_538 -> V_539 ) ;
F_235 ( L_151 , & V_538 -> V_565 ) ;
F_237 ( L_152 , V_538 -> V_540 -> V_388 ) ;
F_239 ( L_153 , & V_538 -> V_565 ) ;
#endif
return true ;
}
static bool F_251 ( int V_542 , unsigned long V_543 ,
void * V_26 )
{
struct V_537 * V_538 = V_26 ;
unsigned long V_569 ;
...
V_569 = V_538 -> V_546 ;
return F_243 ( V_543 , V_538 -> V_545 , V_569 ,
F_249 , V_538 ) ;
}
static bool F_252 ( int V_222 , int V_223 , unsigned long V_221 ,
unsigned long V_180 , void * V_26 )
{
struct V_537 * V_538 = V_26 ;
V_538 -> V_544 . V_222 = V_222 ;
...
static bool F_253 ( struct V_1 * V_16 ,
const struct V_548 * V_549 ,
struct V_537 * V_538 )
{
...
V_570 = F_240 ( ( T_12 ) V_538 -> V_545 * V_524 , V_423 * 8 ) ;
V_550 = F_190 ( V_549 -> V_555 * 4 , V_570 * 4 * 4 ) ;
if ( V_549 -> V_392 == V_567 ) {
V_551 = V_549 -> V_556 * 4 ;
} else {
unsigned long V_571 ;
V_571 = F_240 ( ( T_12 ) V_538 -> V_546 * V_524 ,
V_423 * 8 ) ;
V_551 = V_571 * 4 * 4 ;
}
return F_247 ( V_538 -> V_175 , V_220 ,
...
V_299 = F_253 ( V_16 , V_540 , & V_538 ) ;
else
V_299 = F_246 ( V_16 , V_540 , & V_538 ) ;
if ( ! V_299 ) {
F_44 ( L_154 ) ;
V_155 = - V_153 ;
goto V_333;
...
F_100 ( & V_538 . V_544 ) ;
V_155 = F_91 ( V_538 . V_544 . V_177 [ V_179 ] ,
...
static enum V_572 F_255 ( int V_181 )
{
switch ( F_256 () ) {
case V_573 :
case V_574 :
...
static int F_258 ( struct V_5 * V_6 , int * V_75 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
int V_109 ;
...
static int F_259 ( struct V_5 * V_6 , int V_75 , int V_347 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
if ( V_347 < 0 || V_347 > 3 ) {
...
static void F_260 ( struct V_5 * V_6 , int V_75 )
{
struct V_2 * V_3 = F_3 ( V_6 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
if ( ( V_75 >= 0 && V_75 <= 3 ) &&
...
if ( V_155 )
return V_155 ;
V_460 = F_264 ( V_6 -> V_589 ) ;
if ( ! V_460 )
return - V_202 ;
V_155 = F_265 ( V_460 , V_6 ) ;
if ( V_155 )
return V_155 ;
V_155 = F_266 ( V_6 , V_588 ) ;
if ( V_155 ) {
F_44 ( L_165 ,
V_6 -> V_45 ) ;
F_267 ( V_460 , V_6 ) ;
...
static int F_274 ( struct V_2 * V_157 )
{
...
if ( ! V_602 )
return 0 ;
V_600 = F_276 ( V_602 , L_168 , & V_344 ) ;
if ( V_600 == NULL ) {
F_277 ( & V_157 -> V_4 , L_169 ) ;
V_155 = - V_153 ;
goto V_333;
}
...
V_451 > V_16 -> V_274 * 2 ) {
F_277 ( & V_157 -> V_4 , L_170 ) ;
V_155 = - V_153 ;
goto V_333;
}
V_155 = F_278 ( V_602 , L_168 , V_601 , V_451 ) ;
if ( V_155 ) {
F_277 ( & V_157 -> V_4 , L_171 ) ;
goto V_333;
}
V_450 . V_451 = V_451 ;
for ( V_109 = 0 ; V_109 < V_451 ; ++ V_109 )
V_450 . V_452 [ V_109 ] = ( int ) V_601 [ V_109 ] ;
V_155 = F_195 ( & V_16 -> V_461 , & V_450 ) ;
if ( V_155 ) {
F_277 ( & V_157 -> V_4 , L_172 ) ;
goto V_333;
}
F_279 ( V_602 ) ;
return 0 ;
...
static int F_282 ( struct V_610 * V_4 , struct V_610 * V_611 , void * V_26 )
{
...
struct V_613 * V_615 ;
struct V_613 V_616 ;
V_16 = F_283 ( & V_3 -> V_4 , sizeof( * V_16 ) , V_617 ) ;
if ( ! V_16 )
return - V_618 ;
V_16 -> V_157 = V_3 ;
F_284 ( & V_3 -> V_4 , V_16 ) ;
...
#ifdef F_50
F_290 ( & V_16 -> V_141 ) ;
V_16 -> V_141 . V_276 = F_208 ;
V_16 -> V_141 . V_26 = 0 ;
#endif
V_615 = F_291 ( V_3 , V_619 , L_177 ) ;
if ( ! V_615 ) {
V_615 = F_292 ( V_3 , V_619 , 0 ) ;
if ( ! V_615 ) {
F_44 ( L_178 ) ;
return - V_153 ;
}
...
V_614 = V_615 ;
V_16 -> V_19 = F_293 ( & V_3 -> V_4 , V_615 -> T_9 ,
F_294 ( V_615 ) ) ;
if ( ! V_16 -> V_19 ) {
F_44 ( L_179 ) ;
return - V_618 ;
}
V_615 = F_291 ( V_3 , V_619 , L_180 ) ;
if ( ! V_615 ) {
V_615 = F_292 ( V_3 , V_619 , 0 ) ;
if ( ! V_615 ) {
F_44 ( L_178 ) ;
...
V_16 -> V_21 = F_293 ( & V_3 -> V_4 , V_615 -> T_9 ,
F_294 ( V_615 ) ) ;
if ( ! V_16 -> V_21 ) {
F_44 ( L_181 ) ;
return - V_618 ;
}
V_615 = F_291 ( V_3 , V_619 , L_182 ) ;
if ( ! V_615 ) {
V_615 = F_292 ( V_3 , V_619 , 0 ) ;
if ( ! V_615 ) {
F_44 ( L_178 ) ;
...
V_16 -> V_23 = F_293 ( & V_3 -> V_4 , V_615 -> T_9 ,
F_294 ( V_615 ) ) ;
if ( ! V_16 -> V_23 ) {
F_44 ( L_183 ) ;
return - V_618 ;
}
V_16 -> V_133 = F_295 ( V_16 -> V_157 , 0 ) ;
if ( V_16 -> V_133 < 0 ) {
F_44 ( L_184 ) ;
return - V_202 ;
}
V_155 = F_296 ( & V_3 -> V_4 , V_16 -> V_133 , F_48 ,
V_625 , F_297 ( & V_3 -> V_4 ) , V_16 -> V_157 ) ;
if ( V_155 < 0 ) {
F_44 ( L_185 ) ;
return V_155 ;
}
...
V_627 = F_298 ( V_630 , V_3 -> V_4 . V_598 ) ;
if ( ! V_627 ) {
F_44 ( L_186 ) ;
return - V_202 ;
}
...
V_612 = F_9 ( V_3 , V_232 ) ;
F_300 ( & V_3 -> V_4 , L_187 ,
F_98 ( V_612 , 7 , 4 ) , F_98 ( V_612 , 3 , 0 ) ) ;
if ( F_81 ( V_260 ) )
V_16 -> V_274 = 1 + F_19 ( V_3 , V_261 , 11 , 9 ) ;
else
V_16 -> V_274 = 3 ;
V_16 -> V_389 = F_128 ( V_3 ) ;
F_270 ( V_3 ) ;
if ( V_3 -> V_4 . V_598 ) {
V_155 = F_274 ( V_3 ) ;
if ( V_155 ) {
...
V_155 = F_301 ( V_3 -> V_4 . V_598 , NULL , NULL ,
& V_3 -> V_4 ) ;
if ( V_155 )
F_44 ( L_189 , V_155 ) ;
}
...
static void F_304 ( struct V_610 * V_4 , struct V_610 * V_611 , void * V_26 )
{
struct V_2 * V_3 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_3 ) ;
F_305 ( & V_3 -> V_4 ) ;
...
{
return F_308 ( & V_157 -> V_4 , & V_634 ) ;
}
static int F_309 ( struct V_2 * V_157 )
{
F_310 ( & V_157 -> V_4 , & V_634 ) ;
return 0 ;
}
static int F_311 ( struct V_610 * V_4 )
{
...
static int F_315 ( struct V_610 * V_4 )
{
struct V_2 * V_157 = F_4 ( V_4 ) ;
struct V_1 * V_16 = F_1 ( V_157 ) ;
int V_155 ;
