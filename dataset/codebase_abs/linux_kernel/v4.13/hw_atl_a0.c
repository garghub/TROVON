...
V_132 &= ~ 0x18U ;
V_132 &= ~ 0x04U ;
F_137 ( V_128 , V_64 -> V_90 , V_64 -> V_74 , V_138 ) ;
if ( V_132 || V_131 -> type & 0x1000U ) {
V_64 -> V_139 = 1U ;
} else {
if ( V_2 -> V_24 -> V_34 ) {
T_3 V_140 = V_131 -> type & 0xFU ;
if ( V_140 && V_140 < 0x8U ) {
V_64 -> V_141 = ( V_140 == 0x4 ||
V_140 == 0x5 ) ;
V_64 -> V_142 = V_131 -> V_142 ;
}
}
if ( V_143 & V_131 -> V_135 ) {
...
V_64 -> V_144 = F_103 ( V_59 ,
V_59 -> V_126 ) ;
++ V_59 -> V_145 . V_146 . V_147 ;
}
}
}
return F_19 ( V_2 ) ;
}
static int F_138 ( struct V_1 * V_2 , V_109 V_148 )
{
F_139 ( V_2 , F_140 ( V_148 ) |
( 1U << V_57 ) ) ;
return F_19 ( V_2 ) ;
}
static int F_141 ( struct V_1 * V_2 , V_109 V_148 )
{
F_142 ( V_2 , F_140 ( V_148 ) ) ;
F_143 ( V_2 , F_140 ( V_148 ) ) ;
if ( ( 1U << 16 ) & F_144 ( V_2 ) )
F_145 ( & V_49 -> V_149 ) ;
return F_19 ( V_2 ) ;
}
static int F_146 ( struct V_1 * V_2 , V_109 * V_148 )
{
* V_148 = F_147 ( V_2 ) ;
return F_19 ( V_2 ) ;
}
...
{
unsigned int V_31 = 0U ;
F_149 ( V_2 , F_150 ( V_151 ) ) ;
F_151 ( V_2 , F_150 ( V_152 ) , 0 ) ;
F_152 ( V_2 , F_150 ( V_153 ) ) ;
V_2 -> V_24 -> V_154 =
F_150 ( V_152 ) ;
for ( V_31 = V_155 ; V_31 < V_42 ; ++ V_31 )
F_71 ( V_2 ,
( V_2 -> V_24 -> V_154 &&
( V_31 <= V_2 -> V_24 -> V_156 ) ) ?
1U : 0U , V_31 ) ;
...
for ( V_2 -> V_24 -> V_156 = 0U ;
V_2 -> V_24 -> V_156 < V_160 ;
++ V_2 -> V_24 -> V_156 ) {
T_1 V_31 = V_2 -> V_24 -> V_156 ;
T_1 V_44 = ( V_157 [ V_31 ] [ 0 ] << 8 ) | ( V_157 [ V_31 ] [ 1 ] ) ;
T_1 V_45 = ( V_157 [ V_31 ] [ 2 ] << 24 ) | ( V_157 [ V_31 ] [ 3 ] << 16 ) |
( V_157 [ V_31 ] [ 4 ] << 8 ) | V_157 [ V_31 ] [ 5 ] ;
F_71 ( V_2 , 0U , V_155 + V_31 ) ;
F_84 ( V_2 ,
V_45 , V_155 + V_31 ) ;
F_85 ( V_2 ,
V_44 , V_155 + V_31 ) ;
...
{
unsigned int V_31 = 0U ;
if ( V_162 && V_2 -> V_24 -> V_163 ) {
if ( V_2 -> V_24 -> V_163 != 0xFFFFU ) {
T_1 V_164 = ( V_2 -> V_24 -> V_163 >> 1 ) ;
V_164 = F_155 ( V_165 , V_164 ) ;
V_49 -> V_166 = 0x80000000U |
( V_164 << 0x10 ) ;
} else {
T_1 V_167 = 0xFFFFU & F_156 ( V_2 , 0x00002A00U ) ;
if ( V_167 < V_2 -> V_168 . V_169 ) {
V_49 -> V_166 = 0U ;
} else {
...
static int F_162 ( struct V_1 * V_2 , T_1 V_174 )
{
int V_16 = 0 ;
V_16 = F_163 ( V_2 , V_174 , V_51 ) ;
if ( V_16 < 0 )
goto V_13;
V_13:
return V_16 ;
}
struct V_9 * F_164 ( struct V_175 * V_176 )
{
bool V_177 = ( V_176 -> V_178 == V_179 ) ;
bool V_180 = ( ( V_176 -> V_127 == V_181 ) ||
( V_176 -> V_127 == V_182 ) ||
( V_176 -> V_127 == V_183 ) ||
( V_176 -> V_127 == V_184 ) ||
( V_176 -> V_127 == V_185 ) ) ;
bool V_186 = ( V_176 -> V_187 == 1U ) ;
return ( V_177 && V_180 && V_186 ) ? & V_188 : NULL ;
}
