...
static int F_43 ( const struct V_95 * V_73 )
{
struct V_74 * V_75 = V_73 -> V_76 ;
unsigned int V_9 ;
int V_96 ;
F_44 ( & V_4 , sizeof( V_4 ) ) ;
V_96 = F_45 ( V_73 -> V_34 , V_73 -> V_21 ) ;
if ( V_96 < 0 ) {
F_46 ( L_1
L_2 , V_73 -> V_21 ) ;
return V_96 ;
