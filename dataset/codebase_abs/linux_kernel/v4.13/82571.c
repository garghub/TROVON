...
static T_1 F_9 ( struct V_111 * V_64 )
{
...
case V_24 :
case V_25 :
V_5 = F_11 ( V_2 , V_131 , & V_130 ) ;
if ( V_5 )
return V_5 ;
V_4 -> V_36 = ( T_2 ) ( V_130 << 16 ) ;
F_12 ( 20 , 40 ) ;
V_5 = F_11 ( V_2 , V_132 , & V_130 ) ;
if ( V_5 )
return V_5 ;
V_4 -> V_36 |= ( T_2 ) ( V_130 ) ;
...
case V_19 :
case V_20 :
V_208 |= F_7 ( 23 ) | F_7 ( 24 ) | F_7 ( 25 ) | F_7 ( 26 ) ;
break;
case V_24 :
case V_25 :
V_208 |= F_7 ( 26 ) ;
...
case V_20 :
V_208 &= ~ ( F_7 ( 29 ) | F_7 ( 30 ) ) ;
V_208 |= F_7 ( 22 ) | F_7 ( 24 ) | F_7 ( 25 ) | F_7 ( 26 ) ;
if ( F_5 ( V_186 ) & V_209 )
V_208 &= ~ F_7 ( 28 ) ;
else
V_208 |= F_7 ( 28 ) ;
...
T_3 V_235 = 0 ;
T_1 V_5 ;
V_5 = F_11 ( V_2 , V_236 , & V_235 ) ;
if ( V_5 )
return false ;
if ( V_235 == V_237 ) {
V_5 = F_11 ( V_2 , V_238 , & V_234 ) ;
if ( V_5 )
return false ;
if ( ( V_234 & V_239 ) ==
V_239 )
