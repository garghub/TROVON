...
! V_2 -> V_115 ) ;
F_85 ( F_23 ( V_116 , V_2 -> V_26 ) &&
! V_2 -> V_117 ) ;
F_85 ( F_23 ( V_52 , V_2 -> V_26 ) &&
! V_2 -> V_118 ) ;
F_85 ( F_23 ( V_119 , V_2 -> V_26 ) &&
! V_2 -> V_120 ) ;
F_85 ( F_23 ( V_67 , V_2 -> V_26 ) &&
! V_2 -> V_121 ) ;
F_85 ( F_23 ( V_122 , V_2 -> V_26 ) &&
! V_2 -> V_123 ) ;
F_85 ( ! V_2 -> V_124 ) ;
F_85 ( ! V_2 -> V_58 ) ;
F_85 ( ! V_2 -> V_3 ) ;
...
V_6 -> V_126 = V_83 ++ ;
V_6 -> V_3 -> V_2 . V_127 = & V_128 ;
V_6 -> V_3 -> V_2 . V_129 = V_2 -> V_3 ;
V_6 -> V_3 -> V_6 = V_6 ;
V_6 -> V_3 -> V_19 = V_19 ;
V_6 -> V_3 -> V_21 = V_2 -> V_21 ;
F_98 ( V_19 ) ;
F_99 ( & V_6 -> V_3 -> V_2 , L_14 ,
V_2 -> V_21 , V_6 -> V_126 ) ;
...
static struct V_131 * F_106 ( int V_132 )
{
int V_133 = F_107 ( V_132 ) ;
switch ( V_133 ) {
case 0 ... 1 :
return & V_134 [ 0 ] ;
#if F_88 ( V_135 )
...
static void F_109 ( struct V_136 * V_136 )
{
...
F_110 ( V_3 , V_138 -> V_141 [ V_11 ] , V_138 -> V_142 ,
V_143 ) ;
V_139 += V_138 -> V_144 ;
for (; V_11 < V_139 ; V_11 ++ )
F_110 ( V_3 , V_138 -> V_141 [ V_11 ] , V_138 -> V_142 ,
...
V_139 = V_138 -> V_148 ;
F_111 ( V_138 , F_106 ( V_139 ) -> V_149 ) ;
}
void F_112 ( struct V_137 * V_138 )
{
if ( V_138 )
F_113 ( & V_138 -> V_136 , F_109 ) ;
}
static void F_114 ( void )
{
int V_11 ;
for ( V_11 = 0 ; V_11 < F_115 ( V_134 ) ; V_11 ++ ) {
struct V_131 * V_150 = & V_134 [ V_11 ] ;
F_116 ( V_150 -> V_149 ) ;
V_150 -> V_149 = NULL ;
F_117 ( V_150 -> V_151 ) ;
V_150 -> V_151 = NULL ;
...
V_150 -> V_151 = F_119 ( V_150 -> V_90 , V_152 , 0 ,
V_154 , NULL ) ;
if ( ! V_150 -> V_151 )
break;
V_150 -> V_149 = F_120 ( 1 , V_150 -> V_151 ) ;
if ( ! V_150 -> V_149 )
break;
}
if ( V_11 == F_115 ( V_134 ) )
...
struct V_137 *
F_121 ( struct V_2 * V_3 , int V_132 , T_8 V_155 )
{
struct V_137 * V_138 ;
V_138 = F_122 ( F_106 ( V_132 ) -> V_149 , V_155 ) ;
if ( ! V_138 )
return NULL ;
...
enum V_41
F_127 ( struct V_156 * V_157 )
{
unsigned long V_44 = V_45 + F_28 ( 5000 ) ;
if ( ! V_157 )
return V_159 ;
while ( V_157 -> V_42 == - V_87 ) {
if ( F_31 ( V_45 , V_44 ) ) {
F_32 ( V_157 -> V_6 -> V_2 -> V_3 ,
L_17 ,
V_46 ) ;
return V_47 ;
}
...
void F_128 ( struct V_156 * V_157 )
{
struct V_156 * V_160 = F_129 ( V_157 ) ;
struct V_156 * V_161 ;
struct V_1 * V_6 ;
if ( ! V_160 )
return;
