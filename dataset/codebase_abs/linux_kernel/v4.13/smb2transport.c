...
struct V_35 * V_36 )
{
unsigned int V_49 , V_84 = F_35 ( V_36 -> V_85 ) ;
V_36 -> V_86 = F_36 ( V_2 ) ;
...
* V_91 = F_38 ( V_36 , V_20 -> V_2 ) ;
if ( * V_91 == NULL )
return - V_11 ;
F_14 ( & V_110 ) ;
F_43 ( & ( * V_91 ) -> V_111 , & V_20 -> V_2 -> V_112 ) ;
F_15 ( & V_110 ) ;
return 0 ;
}
int
F_44 ( struct V_87 * V_91 , struct V_1 * V_2 ,
bool V_113 )
{
unsigned int V_114 = F_45 ( V_91 -> V_115 ) ;
struct V_32 V_33 [ 2 ] ;
...
V_33 [ 1 ] . V_54 = V_114 ;
F_46 ( V_91 -> V_115 , F_47 ( V_117 , 80 , V_114 ) ) ;
