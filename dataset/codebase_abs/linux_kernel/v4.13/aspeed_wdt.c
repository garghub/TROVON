...
struct V_21 * V_22 ;
int V_23 ;
V_4 = F_13 ( & V_20 -> V_24 , sizeof( * V_4 ) , V_25 ) ;
if ( ! V_4 )
return - V_26 ;
V_22 = F_14 ( V_20 , V_27 , 0 ) ;
V_4 -> V_8 = F_15 ( & V_20 -> V_24 , V_22 ) ;
if ( F_16 ( V_4 -> V_8 ) )
return F_17 ( V_4 -> V_8 ) ;
V_4 -> V_3 . V_28 = & V_29 ;
V_4 -> V_3 . V_30 = & V_31 ;
...
V_4 -> V_3 . V_13 = V_34 ;
F_18 ( & V_4 -> V_3 , 0 , & V_20 -> V_24 ) ;
V_4 -> V_6 = V_35 |
V_36 |
V_37 ;
if ( F_19 ( V_4 -> V_8 + V_9 ) & V_7 ) {
F_5 ( & V_4 -> V_3 ) ;
F_20 ( V_38 , & V_4 -> V_3 . V_39 ) ;
}
V_23 = F_21 ( & V_20 -> V_24 , & V_4 -> V_3 ) ;
if ( V_23 ) {
F_22 ( & V_20 -> V_24 , L_1 ) ;
return V_23 ;
}
