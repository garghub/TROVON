...
static int F_33 ( struct V_78 * V_78 , struct V_72 * V_72 )
{
F_34 ( & V_79 ) ;
return 0 ;
}
static void F_35 ( struct V_2 * V_3 , const char * V_85 )
{
const char * V_75 = V_85 ;
int V_73 = strlen ( V_85 ) ;
for (; V_73 -- > 0 ; V_75 ++ ) {
if ( ! F_2 () && ( ( ( V_73 + 1 ) & 0x1f ) == 0 ) )
F_28 () ;
F_26 ( V_3 , * V_75 ) ;
...
#endif
#else
F_35 ( V_3 , L_4 V_87 L_5 ) ;
#endif
V_6 -> V_84 = true ;
F_17 ( V_3 ) ;
return 0 ;
}
struct V_2 * F_41 ( unsigned int V_88 )
{
struct V_5 * V_6 ;
struct V_2 * V_3 ;
V_6 = F_42 ( sizeof( * V_6 ) + V_88 , V_89 ) ;
if ( ! V_6 )
return NULL ;
V_6 -> V_56 . V_69 = - 1 ;
V_3 = & V_6 -> V_3 ;
...
static int F_43 ( struct V_93 * V_94 , unsigned long V_95 ,
void * V_96 )
{
struct V_2 * V_3 = V_77 ;
switch ( V_95 ) {
