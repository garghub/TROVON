...
if ( V_22 )
return V_22 ;
return F_69 ( V_92 , F_70 ( V_94 ) ) ;
}
void F_71 ( struct V_95 * V_94 )
{
F_72 ( F_73 ( V_94 ) ) ;
F_74 ( V_93 ( V_94 ) ) ;
}
int F_75 ( struct V_96 * V_97 ,
struct V_98 * V_63 ,
struct V_95 * V_94 )
{
return F_76 ( & V_97 -> V_26 , & V_63 -> V_26 , V_94 ,
& V_69 ) ;
}
struct V_98 * F_77 ( struct V_99 * V_100 , T_3 type , T_3 V_40 )
{
struct V_71 * V_63 ;
V_63 = F_78 ( V_100 , & V_69 , type , V_40 ) ;
return F_79 ( V_63 ) ? F_80 ( V_63 ) : F_55 ( V_63 ) ;
}
