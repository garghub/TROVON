...
if ( ! F_157 ( V_39 ) )
return;
F_163 ( V_39 -> V_187 , V_13 ,
V_130 ) ;
F_164 ( & V_39 -> V_192 ) ;
}
static int F_165 ( void * V_193 )
{
T_1 * V_39 = ( T_1 * ) V_193 ;
struct V_194 * V_195 = V_51 ;
const struct V_196 * V_196 = F_166 ( V_39 -> V_187 ) ;
if ( ! F_167 ( V_196 ) )
F_168 ( V_195 , V_196 ) ;
F_169 () ;
V_39 -> V_184 = 0 ;
...
if ( V_39 -> F_165 )
return 0 ;
V_39 -> F_165 = F_173 ( F_165 , V_39 , L_1 , V_166 ) ;
if ( F_174 ( V_39 -> F_165 ) ) {
F_175 ( L_2 , V_166 ) ;
V_128 = F_176 ( V_39 -> F_165 ) ;
V_39 -> F_165 = NULL ;
}
return V_128 ;
}
void F_177 ( int V_166 )
{
struct V_194 * F_165 = F_142 ( V_166 ) -> F_165 ;
if ( F_165 ) {
F_178 ( F_165 ) ;
F_142 ( V_166 ) -> F_165 = NULL ;
}
}
static int F_179 ( unsigned int V_152 )
{
int V_166 ;
F_180 (nid, N_MEMORY) {
T_1 * V_39 = F_142 ( V_166 ) ;
const struct V_196 * V_197 ;
V_197 = F_166 ( V_39 -> V_187 ) ;
if ( F_181 ( V_198 , V_197 ) < V_199 )
F_168 ( V_39 -> F_165 , V_197 ) ;
}
return 0 ;
}
