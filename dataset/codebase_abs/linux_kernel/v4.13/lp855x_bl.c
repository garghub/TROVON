...
V_37 = F_27 ( V_9 , sizeof( * V_37 ) , V_86 ) ;
if ( ! V_37 )
return - V_87 ;
...
struct V_82 * V_90 ;
int V_34 = 0 ;
V_89 = F_27 ( V_9 , sizeof( * V_89 ) * V_85 , V_86 ) ;
if ( ! V_89 )
return - V_87 ;
F_32 (node, child) {
F_29 ( V_90 , L_12 , & V_89 [ V_34 ] . V_10 ) ;
F_29 ( V_90 , L_13 , & V_89 [ V_34 ] . V_33 ) ;
V_34 ++ ;
}
V_37 -> V_48 = V_85 ;
V_37 -> V_49 = & V_89 [ 0 ] ;
...
struct V_1 * V_2 ;
int V_7 ;
if ( ! F_34 ( V_92 -> V_95 , V_96 ) )
return - V_97 ;
V_2 = F_27 ( & V_92 -> V_9 , sizeof( struct V_1 ) , V_86 ) ;
if ( ! V_2 )
return - V_87 ;
V_2 -> V_5 = V_92 ;
V_2 -> V_9 = & V_92 -> V_9 ;
...
V_2 -> V_66 = V_69 ;
V_2 -> V_99 = F_36 ( V_2 -> V_9 , L_14 ) ;
if ( F_12 ( V_2 -> V_99 ) ) {
if ( F_21 ( V_2 -> V_99 ) == - V_100 )
return - V_100 ;
V_2 -> V_99 = NULL ;
}
V_2 -> V_101 = F_37 ( V_2 -> V_9 , L_15 ) ;
if ( F_12 ( V_2 -> V_101 ) ) {
V_7 = F_21 ( V_2 -> V_101 ) ;
if ( V_7 == - V_102 ) {
V_2 -> V_101 = NULL ;
...
V_7 = F_41 ( & V_2 -> V_9 -> V_103 , & V_104 ) ;
if ( V_7 ) {
F_5 ( V_2 -> V_9 , L_21 , V_7 ) ;
return V_7 ;
}
F_42 ( V_2 -> V_60 ) ;
return 0 ;
...
{
struct V_1 * V_2 = F_44 ( V_92 ) ;
V_2 -> V_60 -> V_62 . V_61 = 0 ;
F_42 ( V_2 -> V_60 ) ;
if ( V_2 -> V_99 )
F_45 ( V_2 -> V_99 ) ;
F_46 ( & V_2 -> V_9 -> V_103 , & V_104 ) ;
return 0 ;
}
