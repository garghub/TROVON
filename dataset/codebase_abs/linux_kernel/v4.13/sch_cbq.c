...
V_3 -> V_21 . V_44 = V_18 ;
V_3 -> V_21 . V_3 = F_69 ( V_18 -> V_160 , & V_161 ,
V_18 -> V_29 ) ;
if ( ! V_3 -> V_21 . V_3 )
V_3 -> V_21 . V_3 = & V_162 ;
else
...
V_3 -> V_21 . V_112 = V_3 -> V_21 . V_157 -> V_163 . V_163 ;
V_3 -> V_21 . V_66 = V_164 ;
...
F_51 ( & V_3 -> V_21 ) ;
if ( V_146 [ V_165 ] )
F_57 ( & V_3 -> V_21 , F_66 ( V_146 [ V_165 ] ) ) ;
F_59 ( V_3 , & V_3 -> V_21 ) ;
return 0 ;
V_158:
F_72 ( V_3 -> V_21 . V_157 ) ;
...
if ( F_75 ( V_10 , V_156 , sizeof( V_12 -> V_157 -> V_163 ) , & V_12 -> V_157 -> V_163 ) )
goto V_166;
return V_10 -> V_88 ;
V_166:
F_76 ( V_10 , V_72 ) ;
...
V_145 . V_127 = ~ 0 ;
if ( F_75 ( V_10 , V_165 , sizeof( V_145 ) , & V_145 ) )
goto V_166;
return V_10 -> V_88 ;
V_166:
F_76 ( V_10 , V_72 ) ;
...
V_145 . V_143 = ~ 0 ;
if ( F_75 ( V_10 , V_168 , sizeof( V_145 ) , & V_145 ) )
goto V_166;
}
return V_10 -> V_88 ;
V_166:
...
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_144 * V_169 ;
V_169 = F_82 ( V_10 , V_170 ) ;
if ( V_169 == NULL )
goto V_166;
if ( F_80 ( V_10 , & V_3 -> V_21 ) < 0 )
goto V_166;
return F_83 ( V_10 , V_169 ) ;
V_166:
F_84 ( V_10 , V_169 ) ;
return - 1 ;
}
static int
F_85 ( struct V_17 * V_18 , struct V_171 * V_172 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
V_3 -> V_21 . V_68 . V_65 = V_3 -> V_21 . V_65 ;
return F_86 ( V_172 , & V_3 -> V_21 . V_68 , sizeof( V_3 -> V_21 . V_68 ) ) ;
}
static int
F_87 ( struct V_17 * V_18 , unsigned long V_173 ,
struct V_9 * V_10 , struct V_174 * V_175 )
{
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
struct V_144 * V_169 ;
if ( V_12 -> V_13 )
V_175 -> V_176 = V_12 -> V_13 -> V_8 . V_4 ;
else
V_175 -> V_176 = V_177 ;
V_175 -> V_178 = V_12 -> V_8 . V_4 ;
V_175 -> V_179 = V_12 -> V_3 -> V_29 ;
V_169 = F_82 ( V_10 , V_170 ) ;
if ( V_169 == NULL )
goto V_166;
if ( F_80 ( V_10 , V_12 ) < 0 )
...
static int
F_88 ( struct V_17 * V_18 , unsigned long V_173 ,
struct V_171 * V_172 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
...
if ( F_89 ( F_90 ( V_18 ) ,
V_172 , NULL , & V_12 -> V_92 ) < 0 ||
F_91 ( V_172 , & V_12 -> V_180 ) < 0 ||
F_92 ( V_172 , NULL , & V_12 -> V_60 , V_12 -> V_3 -> V_3 . V_59 ) < 0 )
return - 1 ;
return F_86 ( V_172 , & V_12 -> V_68 , sizeof( V_12 -> V_68 ) ) ;
}
static int F_93 ( struct V_17 * V_18 , unsigned long V_173 , struct V_17 * V_14 ,
struct V_17 * * V_181 )
{
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
if ( V_14 == NULL ) {
V_14 = F_69 ( V_18 -> V_160 ,
& V_161 , V_12 -> V_8 . V_4 ) ;
if ( V_14 == NULL )
return - V_182 ;
}
* V_181 = F_94 ( V_18 , V_14 , & V_12 -> V_3 ) ;
return 0 ;
}
static struct V_17 * F_95 ( struct V_17 * V_18 , unsigned long V_173 )
{
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
return V_12 -> V_3 ;
}
static void F_96 ( struct V_17 * V_18 , unsigned long V_173 )
{
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
if ( V_12 -> V_3 -> V_3 . V_59 == 0 )
F_12 ( V_12 ) ;
}
...
static void F_106 ( struct V_17 * V_18 , unsigned long V_173 )
{
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
if ( -- V_12 -> V_159 == 0 ) {
#ifdef F_10
T_5 * V_187 = F_107 ( V_18 ) ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
F_108 ( V_187 ) ;
if ( V_3 -> V_58 == V_12 )
V_3 -> V_58 = NULL ;
...
static int
F_110 ( struct V_17 * V_18 , T_1 V_4 , T_1 V_188 , struct V_144 * * V_189 ,
unsigned long * V_173 )
{
int V_150 ;
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) * V_173 ;
struct V_144 * V_145 = V_189 [ V_170 ] ;
struct V_144 * V_146 [ V_147 + 1 ] ;
struct V_1 * V_123 ;
...
if ( V_150 < 0 )
return V_150 ;
if ( V_146 [ V_192 ] || V_146 [ V_193 ] )
return - V_194 ;
if ( V_12 ) {
if ( V_188 ) {
if ( V_12 -> V_13 &&
V_12 -> V_13 -> V_8 . V_4 != V_188 )
return - V_153 ;
if ( ! V_12 -> V_13 && V_188 != V_177 )
return - V_153 ;
}
if ( V_146 [ V_156 ] ) {
V_191 = F_67 ( F_66 ( V_146 [ V_156 ] ) ,
V_146 [ V_155 ] ) ;
if ( V_191 == NULL )
return - V_153 ;
}
if ( V_189 [ V_195 ] ) {
V_150 = F_111 ( & V_12 -> V_92 , NULL ,
& V_12 -> V_180 ,
NULL ,
F_90 ( V_18 ) ,
V_189 [ V_195 ] ) ;
...
if ( V_146 [ V_165 ] )
F_57 ( V_12 , F_66 ( V_146 [ V_165 ] ) ) ;
if ( V_146 [ V_167 ] ) {
F_58 ( V_3 , V_12 ) ;
F_60 ( V_12 , F_66 ( V_146 [ V_167 ] ) ) ;
}
if ( V_146 [ V_168 ] )
F_61 ( V_12 , F_66 ( V_146 [ V_168 ] ) ) ;
if ( V_12 -> V_3 -> V_3 . V_59 )
F_11 ( V_12 ) ;
F_113 ( V_18 ) ;
return 0 ;
...
if ( V_188 == V_177 )
return - V_153 ;
if ( V_146 [ V_167 ] == NULL || V_146 [ V_156 ] == NULL ||
V_146 [ V_165 ] == NULL )
return - V_153 ;
V_191 = F_67 ( F_66 ( V_146 [ V_156 ] ) , V_146 [ V_155 ] ) ;
if ( V_191 == NULL )
return - V_153 ;
if ( V_4 ) {
V_150 = - V_153 ;
...
V_150 = - V_182 ;
V_12 = F_115 ( sizeof( * V_12 ) , V_199 ) ;
if ( V_12 == NULL )
goto V_196;
V_150 = F_116 ( & V_12 -> V_184 , & V_12 -> V_33 ) ;
if ( V_150 ) {
F_102 ( V_12 ) ;
return V_150 ;
}
if ( V_189 [ V_195 ] ) {
V_150 = F_117 ( & V_12 -> V_92 , NULL , & V_12 -> V_180 ,
NULL ,
F_90 ( V_18 ) ,
V_189 [ V_195 ] ) ;
if ( V_150 ) {
...
V_191 = NULL ;
V_12 -> V_159 = 1 ;
V_12 -> V_3 = F_69 ( V_18 -> V_160 , & V_161 , V_4 ) ;
if ( ! V_12 -> V_3 )
V_12 -> V_3 = & V_162 ;
else
F_70 ( V_12 -> V_3 , true ) ;
...
V_12 -> V_112 = V_12 -> V_157 -> V_163 . V_163 ;
F_112 ( V_18 ) ;
F_51 ( V_12 ) ;
V_12 -> V_54 = V_12 -> V_13 ;
...
F_113 ( V_18 ) ;
F_118 ( V_18 , & V_3 -> V_7 ) ;
* V_173 = ( unsigned long ) V_12 ;
return 0 ;
V_196:
F_72 ( V_191 ) ;
return V_150 ;
}
static int F_119 ( struct V_17 * V_18 , unsigned long V_173 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
unsigned int V_59 , V_200 ;
if ( V_12 -> V_183 || V_12 -> V_107 || V_12 == & V_3 -> V_21 )
return - V_201 ;
F_112 ( V_18 ) ;
V_59 = V_12 -> V_3 -> V_3 . V_59 ;
V_200 = V_12 -> V_3 -> V_60 . V_200 ;
F_56 ( V_12 -> V_3 ) ;
F_120 ( V_12 -> V_3 , V_59 , V_200 ) ;
if ( V_12 -> V_48 )
F_12 ( V_12 ) ;
if ( V_3 -> V_98 == V_12 )
V_3 -> V_98 = V_3 -> V_87 ;
...
static struct V_202 * F_122 ( struct V_17 * V_18 , unsigned long V_173 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
if ( V_12 == NULL )
...
static unsigned long F_123 ( struct V_17 * V_18 , unsigned long V_123 ,
T_1 V_4 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_203 = (struct V_1 * ) V_123 ;
struct V_1 * V_12 = F_1 ( V_3 , V_4 ) ;
if ( V_12 ) {
if ( V_203 && V_203 -> V_37 <= V_12 -> V_37 )
return 0 ;
V_12 -> V_183 ++ ;
return ( unsigned long ) V_12 ;
}
...
static void F_124 ( struct V_17 * V_18 , unsigned long V_173 )
{
struct V_1 * V_12 = (struct V_1 * ) V_173 ;
V_12 -> V_183 -- ;
}
static void F_125 ( struct V_17 * V_18 , struct V_204 * V_173 )
{
struct V_2 * V_3 = F_6 ( V_18 ) ;
struct V_1 * V_12 ;
unsigned int V_109 ;
...
for ( V_109 = 0 ; V_109 < V_3 -> V_7 . V_111 ; V_109 ++ ) {
F_43 (cl, &q->clhash.hash[h], common.hnode) {
if ( V_173 -> V_206 < V_173 -> V_207 ) {
V_173 -> V_206 ++ ;
continue;
}
if ( V_173 -> V_208 ( V_18 , ( unsigned long ) V_12 , V_173 ) < 0 ) {
V_173 -> V_205 = 1 ;
return;
}
V_173 -> V_206 ++ ;
