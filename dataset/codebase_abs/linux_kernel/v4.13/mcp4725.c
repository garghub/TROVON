...
V_4 -> V_8 = V_8 ;
if ( V_8 -> V_2 . V_41 )
V_4 -> V_48 = (enum V_55 ) F_27 ( & V_8 -> V_2 ) ;
else
V_4 -> V_48 = V_48 -> V_56 ;
V_38 = F_28 ( & V_8 -> V_2 ) ;
if ( ! V_38 ) {
...
V_15 -> V_2 . V_61 = & V_8 -> V_2 ;
V_15 -> V_62 = V_48 -> V_62 ;
V_15 -> V_63 = & V_64 ;
V_15 -> V_65 = & V_66 [ V_48 -> V_56 ] ;
V_15 -> V_67 = 1 ;
V_15 -> V_68 = V_69 ;
V_53 = F_11 ( V_8 , V_50 , V_4 -> V_48 == V_57 ? 3 : 4 ) ;
if ( V_53 < 0 ) {
F_12 ( & V_8 -> V_2 , L_10 ) ;
goto V_70;
}
...
if ( V_4 -> V_48 == V_71 )
V_52 = ( V_50 [ 3 ] >> 3 ) & 0x3 ;
if ( V_4 -> V_48 == V_71 && V_52 != V_4 -> V_20 ) {
F_33 ( & V_8 -> V_2 ,
L_11 ,
...
static int F_36 ( struct V_46 * V_8 )
{
