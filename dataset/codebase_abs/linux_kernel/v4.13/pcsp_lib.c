...
V_8 -> V_29 = 0 ;
V_8 -> V_20 =
F_45 ( V_5 -> V_13 -> V_47 ) >> 3 ;
V_8 -> V_21 = F_46 ( V_5 -> V_13 -> V_47 ) ;
#if V_30
F_17 ( V_31 L_9
L_10 ,
F_14 ( V_5 ) ,
...
static int F_47 ( struct V_4 * V_5 , int V_49 )
{
struct V_7 * V_8 = F_38 ( V_5 ) ;
#if V_30
F_17 ( V_31 L_11 ) ;
...
{
int V_46 ;
V_46 = F_54 ( V_8 -> V_59 , L_14 , 0 , 1 , 0 , & V_8 -> V_60 ) ;
if ( V_46 < 0 )
return V_46 ;
F_55 ( V_8 -> V_60 , V_61 ,
& V_62 ) ;
