...
static inline int
F_90 ( struct V_100 * V_34 )
{
return V_34 -> V_105 [ 0 ] . V_87 + V_34 -> V_148 + V_34 -> V_149 [ 0 ] . V_87 ;
}
static void
F_91 ( struct V_100 * V_34 , int V_150 )
{
if ( V_34 -> V_148 == 0 ) {
V_34 -> V_105 [ 0 ] . V_87 -= V_150 ;
}
}
static int
F_92 ( struct V_92 * V_93 , struct V_100 * V_34 , T_3 V_120 , struct V_98 * V_127 )
{
T_3 V_151 , V_122 ;
int V_150 , V_152 , V_153 , V_154 ;
F_86 ( V_145 , & V_93 -> V_146 ) ;
V_151 = F_61 ( & V_34 -> V_105 [ 0 ] ) ;
if ( V_93 -> V_110 ) {
goto V_155;
}
V_153 = F_90 ( V_34 ) ;
...
V_150 = V_151 - V_34 -> V_4 ;
V_34 -> V_4 = V_152 ;
V_34 -> V_4 -= V_150 ;
V_154 = V_34 -> V_105 [ 0 ] . V_87 % 4 ;
if ( V_154 ) {
V_34 -> V_156 = V_157 ;
F_94 ( V_34 , V_154 ) ;
F_91 ( V_34 , V_150 ) ;
...
return V_172 ;
V_174 = F_61 ( V_84 ) ;
if ( V_174 > ( V_84 -> V_87 + V_93 -> V_104 . V_148 ) )
return V_108 ;
...
if ( F_87 ( V_238 , & V_144 , V_242 , V_143 ) )
F_88 () ;
if ( V_238 -> V_149 [ 0 ] . V_88 == NULL ) {
if ( V_238 -> V_105 [ 0 ] . V_87 + V_147 > V_91 )
goto V_243;
V_238 -> V_149 [ 0 ] . V_88 = V_238 -> V_105 [ 0 ] . V_88
+ V_238 -> V_105 [ 0 ] . V_87 ;
V_238 -> V_149 [ 0 ] . V_87 = 0 ;
}
V_89 = & V_238 -> V_149 [ 0 ] ;
...
return 0 ;
V_4 = V_90 ++ ;
V_154 = ( T_4 * ) V_90 - ( T_4 * ) V_238 -> V_105 [ 0 ] . V_88 ;
* V_90 ++ = F_71 ( V_96 -> V_114 ) ;
V_245 = V_238 -> V_175 ;
if ( V_238 -> V_149 [ 0 ] . V_88 ) {
F_14 ( V_238 -> V_149 [ 0 ] . V_88 >= V_238 -> V_105 [ 0 ] . V_88
+ V_91 ) ;
F_14 ( V_238 -> V_149 [ 0 ] . V_88 < V_238 -> V_105 [ 0 ] . V_88 ) ;
if ( V_238 -> V_149 [ 0 ] . V_87 + V_238 -> V_105 [ 0 ] . V_87
+ 2 * V_147 > V_91 )
return - V_22 ;
memmove ( V_238 -> V_149 [ 0 ] . V_88 + V_147 ,
V_238 -> V_149 [ 0 ] . V_88 ,
V_238 -> V_149 [ 0 ] . V_87 ) ;
V_238 -> V_149 [ 0 ] . V_88 += V_147 ;
}
if ( V_238 -> V_149 [ 0 ] . V_88 == NULL ) {
if ( V_238 -> V_105 [ 0 ] . V_87 + 2 * V_147 > V_91 )
return - V_22 ;
V_238 -> V_149 [ 0 ] . V_88 = V_238 -> V_105 [ 0 ] . V_88
+ V_238 -> V_105 [ 0 ] . V_87 + V_147 ;
V_238 -> V_149 [ 0 ] . V_87 = 0 ;
}
if ( F_136 ( V_239 -> V_47 -> V_49 , V_154 , V_238 , V_245 ) )
return - V_22 ;
* V_4 = F_71 ( V_238 -> V_4 - V_154 ) ;
V_150 = 3 - ( ( V_238 -> V_4 - V_154 - 1 ) & 3 ) ;
V_90 = ( T_5 * ) ( V_238 -> V_149 [ 0 ] . V_88 + V_238 -> V_149 [ 0 ] . V_87 ) ;
memset ( V_90 , 0 , V_150 ) ;
V_238 -> V_149 [ 0 ] . V_87 += V_150 ;
V_238 -> V_4 += V_150 ;
return 0 ;
}
static int
