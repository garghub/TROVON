...
{
if ( F_32 ( V_7 , V_64 , V_63 -> V_18 . V_15 . V_16 . V_19 ) ||
F_33 ( V_7 , V_65 , V_63 -> V_14 . V_15 . V_16 . type ) ||
F_33 ( V_7 , V_66 , V_63 -> V_14 . V_15 . V_16 . V_21 ) )
goto V_67;
return 0 ;
V_67:
return - 1 ;
...
! V_69 [ V_64 ] )
return - V_70 ;
V_10 -> V_14 . V_15 . V_16 . type = F_35 ( V_69 [ V_65 ] ) ;
V_10 -> V_14 . V_15 . V_16 . V_21 = F_35 ( V_69 [ V_66 ] ) ;
V_10 -> V_18 . V_15 . V_16 . V_19 = F_36 ( V_69 [ V_64 ] ) ;
...
static int
F_42 ( struct V_6 * V_7 , const void * V_73 )
{
const unsigned int * V_27 = V_73 ;
if ( F_43 ( V_7 , V_75 , F_44 ( * V_27 / V_76 ) ) )
goto V_67;
return 0 ;
V_67:
return - V_77 ;
...
static int F_48 ( struct V_2 * V_2 , T_3 V_84 )
{
struct V_1 * V_74 = F_1 ( V_2 ) ;
struct V_78 * V_79 = & V_74 -> V_79 ;
V_74 -> V_27 = V_85 ;
return F_45 ( V_79 , V_74 ) ;
}
static struct V_78 * F_49 ( struct V_2 * V_2 )
{
