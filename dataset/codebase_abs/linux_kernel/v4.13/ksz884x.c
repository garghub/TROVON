...
F_247 ( V_410 , 2 ) ;
F_248 ( V_410 , V_407 -> V_410 -> V_20 , V_458 ) ;
} while ( 0 );
...
static int F_291 ( struct V_419 * V_420 , struct V_546 * V_547 , int V_548 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
int V_549 = 0 ;
struct V_550 * V_20 = F_292 ( V_547 ) ;
if ( F_293 ( & V_422 -> V_551 ) )
return - V_552 ;
switch ( V_548 ) {
case V_553 :
V_20 -> V_554 = V_422 -> V_364 ;
case V_555 :
if ( V_20 -> V_554 != V_422 -> V_364 || V_20 -> V_556 >= 6 )
V_549 = - V_557 ;
else
F_119 ( V_2 , V_66 -> V_229 -> V_558 , V_20 -> V_556 ,
& V_20 -> V_559 ) ;
break;
case V_560 :
if ( ! F_294 ( V_561 ) )
V_549 = - V_562 ;
else if ( V_20 -> V_554 != V_422 -> V_364 || V_20 -> V_556 >= 6 )
V_549 = - V_557 ;
else
F_120 ( V_2 , V_66 -> V_229 -> V_558 , V_20 -> V_556 ,
V_20 -> V_563 ) ;
break;
default:
V_549 = - V_564 ;
...
static int F_296 ( struct V_419 * V_420 , int V_554 , int V_556 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
struct V_1 * V_2 = V_66 -> V_2 ;
T_3 V_559 ;
F_119 ( V_2 , V_66 -> V_229 -> V_558 , V_556 << 1 , & V_559 ) ;
return V_559 ;
}
static void F_297 ( struct V_419 * V_420 , int V_554 , int V_556 , int V_185 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_203 * V_66 = & V_422 -> V_66 ;
struct V_1 * V_2 = V_66 -> V_2 ;
...
F_120 ( V_2 , V_490 , V_556 << 1 , V_185 ) ;
}
static int F_298 ( struct V_419 * V_420 ,
struct V_565 * V_548 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_299 ( & V_259 -> V_566 ) ;
F_300 ( & V_422 -> V_567 , V_548 ) ;
F_301 ( V_548 , V_568 , V_569 ) ;
F_302 ( & V_259 -> V_566 ) ;
F_303 ( & V_422 -> V_568 ,
V_548 -> V_570 . V_568 ) ;
return 0 ;
...
const struct V_565 * V_548 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
struct V_565 V_571 ;
T_2 V_251 = V_548 -> V_572 . V_251 ;
T_2 V_568 ;
int V_294 ;
F_303 ( & V_568 ,
V_548 -> V_570 . V_568 ) ;
if ( V_548 -> V_572 . V_573 && V_422 -> V_568 == V_568 ) {
V_568 |= V_574 ;
if ( 10 == V_251 )
V_568 &=
~ ( V_575 |
...
~ ( V_577 |
V_578 ) ;
if ( 0 == V_548 -> V_572 . V_228 )
V_568 &=
~ ( V_575 |
V_577 ) ;
else if ( 1 == V_548 -> V_572 . V_228 )
V_568 &=
~ ( V_576 |
V_578 ) ;
}
F_299 ( & V_259 -> V_566 ) ;
if ( V_548 -> V_572 . V_573 &&
( V_568 & V_574 ) == V_574 ) {
V_66 -> V_228 = 0 ;
V_66 -> V_251 = 0 ;
V_66 -> V_219 = 0 ;
} else {
V_66 -> V_228 = V_548 -> V_572 . V_228 + 1 ;
if ( 1000 != V_251 )
V_66 -> V_251 = V_251 ;
if ( V_548 -> V_572 . V_573 )
V_66 -> V_219 = 0 ;
...
memcpy ( & V_571 , V_548 , sizeof( V_571 ) ) ;
F_305 ( V_571 . V_570 . V_568 ,
V_568 ) ;
V_294 = F_306 (
& V_422 -> V_567 ,
( const struct V_565 * ) & V_571 ) ;
F_302 ( & V_259 -> V_566 ) ;
return V_294 ;
}
static int F_307 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
int V_294 ;
F_299 ( & V_259 -> V_566 ) ;
V_294 = F_308 ( & V_422 -> V_567 ) ;
F_302 ( & V_259 -> V_566 ) ;
return V_294 ;
}
static T_2 F_309 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
int V_294 ;
V_294 = F_310 ( & V_422 -> V_567 ) ;
return V_294 ;
}
...
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
F_312 ( V_26 -> V_580 , V_581 , sizeof( V_26 -> V_580 ) ) ;
F_312 ( V_26 -> V_582 , V_583 , sizeof( V_26 -> V_582 ) ) ;
F_312 ( V_26 -> V_584 , F_313 ( V_259 -> V_261 ) ,
sizeof( V_26 -> V_584 ) ) ;
}
...
static void F_315 ( struct V_419 * V_420 , struct V_591 * V_592 ,
void * V_593 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static void F_317 ( struct V_419 * V_420 ,
struct V_594 * V_595 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static T_2 F_319 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
return V_422 -> V_602 ;
}
static void F_320 ( struct V_419 * V_420 , T_2 V_97 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
V_422 -> V_602 = V_97 ;
}
...
int V_153 ;
int V_33 ;
V_33 = ( V_605 -> V_89 + V_605 -> V_33 + 1 ) / 2 ;
for ( V_153 = V_605 -> V_89 / 2 ; V_153 < V_33 ; V_153 ++ )
V_607 [ V_153 ] = F_129 ( & V_259 -> V_2 , V_153 ) ;
V_605 -> V_608 = V_609 ;
memcpy ( V_20 , & V_606 [ V_605 -> V_89 ] , V_605 -> V_33 ) ;
return 0 ;
}
...
int V_153 ;
int V_33 ;
if ( V_605 -> V_608 != V_609 )
return - V_600 ;
V_33 = ( V_605 -> V_89 + V_605 -> V_33 + 1 ) / 2 ;
for ( V_153 = V_605 -> V_89 / 2 ; V_153 < V_33 ; V_153 ++ )
V_607 [ V_153 ] = F_129 ( & V_259 -> V_2 , V_153 ) ;
memcpy ( V_610 , V_607 , V_603 * 2 ) ;
memcpy ( & V_606 [ V_605 -> V_89 ] , V_20 , V_605 -> V_33 ) ;
for ( V_153 = 0 ; V_153 < V_603 ; V_153 ++ )
if ( V_610 [ V_153 ] != V_607 [ V_153 ] ) {
V_607 [ V_153 ] = V_610 [ V_153 ] ;
F_130 ( & V_259 -> V_2 , V_153 , V_607 [ V_153 ] ) ;
}
return 0 ;
}
...
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
V_612 -> V_573 = ( V_2 -> V_121 & V_218 ) ? 0 : 1 ;
if ( ! V_2 -> V_104 ) {
V_612 -> V_613 =
( V_2 -> V_209 & V_211 ) ? 1 : 0 ;
V_612 -> V_614 =
...
static int F_325 ( struct V_419 * V_420 ,
struct V_611 * V_612 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
F_132 ( V_2 , V_612 -> V_613 , V_612 -> V_614 ) ;
}
F_302 ( & V_259 -> V_566 ) ;
return 0 ;
}
...
struct V_1 * V_2 = & V_259 -> V_2 ;
V_27 -> V_617 = ( 1 << 9 ) ;
V_27 -> V_618 = V_2 -> V_347 . V_327 ;
V_27 -> V_619 = ( 1 << 9 ) ;
V_27 -> V_620 = V_2 -> V_400 . V_327 ;
}
static void F_327 ( struct V_419 * V_420 , T_2 V_621 , T_4 * V_24 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static int F_328 ( struct V_419 * V_420 , int V_625 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
static void F_329 ( struct V_419 * V_420 ,
struct V_626 * V_432 , T_5 * V_20 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
int V_627 = V_432 -> V_627 ;
int V_153 ;
int V_628 ;
int V_93 ;
int V_294 ;
...
if ( V_628 < V_383 )
F_330 ( & V_259 -> V_495 ) ;
if ( 1 == V_66 -> V_506 && V_628 < V_383 ) {
V_93 = V_628 ;
V_294 = F_331 (
V_259 -> V_85 [ V_93 ] . V_85 ,
2 == V_259 -> V_85 [ V_93 ] . V_629 ,
V_496 * 1 ) ;
} else
for ( V_153 = 0 , V_93 = V_628 ; V_153 < V_66 -> V_506 - V_628 ; V_153 ++ , V_93 ++ ) {
if ( 0 == V_153 ) {
V_294 = F_331 (
V_259 -> V_85 [ V_93 ] . V_85 ,
2 == V_259 -> V_85 [ V_93 ] . V_629 ,
...
V_628 = V_627 ;
V_627 -= V_628 ;
for ( V_153 = 0 ; V_153 < V_628 ; V_153 ++ )
* V_20 ++ = V_85 [ V_153 ] ;
}
static int F_332 ( struct V_419 * V_420 ,
T_9 V_225 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
...
static void F_333 ( struct V_419 * V_420 , struct V_421 * V_422 ,
struct V_203 * V_66 )
{
...
static void F_334 ( struct V_631 * V_632 )
{
struct V_258 * V_259 =
F_140 ( V_632 , struct V_258 , V_495 ) ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_80 * V_81 ;
int V_153 ;
V_507 = V_393 ;
for ( V_153 = 0 ; V_153 < V_2 -> V_506 ; V_153 ++ ) {
V_81 = & V_2 -> V_82 [ V_153 ] ;
if ( V_81 -> V_84 || 1 == V_259 -> V_85 [ V_153 ] . V_629 ) {
if ( F_31 ( V_2 , V_153 ) )
break;
V_259 -> V_85 [ V_153 ] . V_629 = 0 ;
if ( 0 == V_81 -> V_84 ) {
V_259 -> V_85 [ V_153 ] . V_629 = 2 ;
F_335 (
& V_259 -> V_85 [ V_153 ] . V_85 ) ;
}
} else if ( F_336 ( V_393 , V_259 -> V_85 [ V_153 ] . time ) ) {
if ( V_243 == V_81 -> V_161 )
V_259 -> V_85 [ V_153 ] . V_629 = 1 ;
...
static void F_337 ( unsigned long V_593 )
{
struct V_258 * V_259 = (struct V_258 * ) V_593 ;
F_334 ( & V_259 -> V_495 ) ;
if ( V_259 -> V_633 ) {
if ( F_338 ( V_259 -> V_633 ) ) {
F_142 ( & V_259 -> V_2 ) ;
V_259 -> V_633 = 0 ;
}
} else if ( F_139 ( & V_259 -> V_2 ) ) {
V_259 -> V_633 = V_393 + V_496 * 2 ;
}
F_195 ( & V_259 -> V_494 ) ;
}
static void F_339 ( unsigned long V_593 )
{
struct V_419 * V_420 = (struct V_419 * ) V_593 ;
struct V_421 * V_422 = F_216 ( V_420 ) ;
struct V_258 * V_259 = V_422 -> V_397 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
struct V_203 * V_66 = & V_422 -> V_66 ;
if ( ! ( V_2 -> V_225 & V_487 ) )
F_135 ( V_66 ) ;
F_333 ( V_420 , V_422 , V_66 ) ;
F_195 ( & V_422 -> V_491 ) ;
}
static int T_10 F_340 ( struct V_419 * V_420 )
{
struct V_421 * V_422 = F_216 ( V_420 ) ;
F_192 ( & V_422 -> V_491 , 500 * V_496 / 1000 ,
F_339 , V_420 ) ;
V_420 -> V_448 = V_496 / 2 ;
V_420 -> V_634 = V_635 | V_636 | V_630 ;
V_420 -> V_634 |= V_637 ;
V_420 -> V_225 |= V_420 -> V_634 ;
F_341 ( & V_422 -> V_551 , 1 ) ;
V_422 -> V_567 . V_638 = 0x1 ;
V_422 -> V_567 . V_639 = 0x7 ;
V_422 -> V_567 . V_420 = V_420 ;
V_422 -> V_567 . F_296 = F_296 ;
V_422 -> V_567 . F_297 = F_297 ;
V_422 -> V_567 . V_554 = V_422 -> V_66 . V_231 + 1 ;
V_422 -> V_602 = F_342 ( V_602 ,
( V_640 | V_641 | V_642 ) ) ;
return 0 ;
}
static void F_343 ( struct V_419 * V_420 )
{
if ( V_420 -> V_448 )
F_344 ( V_420 ) ;
F_345 ( V_420 ) ;
}
static void F_346 ( struct V_258 * V_259 , T_4 * V_643 , int V_66 )
{
int V_153 ;
int V_373 ;
int V_644 ;
int V_103 ;
V_153 = V_373 = V_103 = V_644 = 0 ;
while ( V_373 < V_280 ) {
if ( V_643 [ V_153 ] ) {
int V_645 ;
V_644 = 1 ;
V_645 = F_347 ( V_643 [ V_153 ] ) ;
if ( V_645 >= 0 )
V_103 = V_103 * 16 + V_645 ;
else if ( ':' == V_643 [ V_153 ] )
V_644 = 2 ;
else
break;
...
V_259 -> V_2 . V_104 -> V_647 [ V_373 ++ ] =
( T_4 ) V_103 ;
V_259 -> V_2 . V_104 -> V_647 [ 5 ] +=
V_259 -> V_2 . V_364 ;
}
V_103 = V_644 = 0 ;
}
...
V_20 [ V_153 ] = F_129 ( V_2 , V_153 + V_648 ) ;
if ( ( V_20 [ 0 ] || V_20 [ 1 ] || V_20 [ 2 ] ) && V_20 [ 0 ] != 0xffff ) {
V_21 -> V_647 [ 5 ] = ( T_4 ) V_20 [ 0 ] ;
V_21 -> V_647 [ 4 ] = ( T_4 ) ( V_20 [ 0 ] >> 8 ) ;
V_21 -> V_647 [ 3 ] = ( T_4 ) V_20 [ 1 ] ;
V_21 -> V_647 [ 2 ] = ( T_4 ) ( V_20 [ 1 ] >> 8 ) ;
V_21 -> V_647 [ 1 ] = ( T_4 ) V_20 [ 2 ] ;
V_21 -> V_647 [ 0 ] = ( T_4 ) ( V_20 [ 2 ] >> 8 ) ;
}
}
static int F_349 ( struct V_260 * V_261 , const struct V_649 * V_364 )
{
struct V_419 * V_420 ;
struct V_421 * V_422 ;
struct V_258 * V_259 ;
...
int V_654 ;
int V_549 ;
char V_655 [ sizeof( V_582 ) ] ;
struct V_104 * V_21 = NULL ;
V_549 = F_350 ( V_261 ) ;
if ( V_549 )
return V_549 ;
V_549 = - V_656 ;
if ( F_351 ( V_261 , F_352 ( 32 ) ) ||
F_353 ( V_261 , F_352 ( 32 ) ) )
return V_549 ;
V_651 = F_354 ( V_261 , 0 ) ;
V_652 = F_355 ( V_261 , 0 ) ;
if ( ( F_356 ( V_261 , 0 ) & V_657 ) != 0 )
return V_549 ;
if ( ! F_357 ( V_651 , V_652 , V_581 ) )
return V_549 ;
F_358 ( V_261 ) ;
V_549 = - V_462 ;
V_26 = F_197 ( sizeof( struct V_650 ) , V_396 ) ;
if ( ! V_26 )
goto V_658;
V_259 = & V_26 -> V_258 ;
V_259 -> V_261 = V_261 ;
V_2 = & V_259 -> V_2 ;
V_2 -> V_4 = F_359 ( V_651 , V_652 ) ;
if ( ! V_2 -> V_4 )
goto V_659;
V_67 = F_153 ( V_2 ) ;
if ( ! V_67 ) {
...
snprintf ( V_655 , sizeof( V_655 ) , L_9 , V_582 ) ;
V_655 [ 13 ] = V_67 + '0' ;
V_258 ( & V_259 -> V_261 -> V_420 , L_10 , V_655 ) ;
F_360 ( & V_259 -> V_261 -> V_420 , L_11 , V_2 -> V_4 , V_261 -> V_480 ) ;
V_2 -> V_384 = 1 ;
V_654 = 1 ;
V_653 = 1 ;
V_2 -> V_374 = 0 ;
...
V_2 -> V_663 = V_259 ;
V_259 -> V_411 = ( V_544 + 3 ) & ~ 3 ;
if ( F_208 ( V_259 ) )
goto V_664;
V_259 -> V_2 . V_364 = V_665 ;
F_361 ( & V_259 -> V_436 ) ;
F_362 ( & V_259 -> V_566 ) ;
for ( V_153 = 0 ; V_153 < V_106 ; V_153 ++ )
F_363 ( & V_259 -> V_85 [ V_153 ] . V_85 ) ;
if ( V_643 [ 0 ] != ':' )
F_346 ( V_259 , V_643 , V_646 ) ;
F_175 ( V_2 ) ;
if ( V_2 -> V_384 > 1 ) {
memcpy ( V_21 -> V_647 , V_2 -> V_281 , V_280 ) ;
F_348 ( V_2 ) ;
if ( V_666 [ 0 ] != ':' )
F_346 ( V_259 , V_666 , V_667 ) ;
}
F_155 ( V_2 ) ;
if ( V_2 -> V_104 )
F_187 ( V_2 ) ;
...
F_364 ( & V_259 -> V_495 , F_334 ) ;
F_192 ( & V_259 -> V_494 , 500 * V_496 / 1000 ,
F_337 , V_259 ) ;
for ( V_153 = 0 ; V_153 < V_2 -> V_384 ; V_153 ++ ) {
V_420 = F_365 ( sizeof( struct V_421 ) ) ;
if ( ! V_420 )
goto V_669;
F_366 ( V_420 , & V_261 -> V_420 ) ;
V_26 -> V_670 [ V_153 ] = V_420 ;
V_422 = F_216 ( V_420 ) ;
V_422 -> V_397 = V_259 ;
V_422 -> V_364 = V_665 ++ ;
V_66 = & V_422 -> V_66 ;
...
for ( V_67 = 0 , V_490 = V_153 ; V_67 < V_654 ; V_67 ++ , V_490 ++ ) {
V_2 -> V_233 [ V_490 ] . V_558 = V_490 ;
V_2 -> V_233 [ V_490 ] . V_261 = V_420 ;
V_2 -> V_233 [ V_490 ] . V_161 = V_244 ;
}
V_420 -> V_671 = ( unsigned long ) V_2 -> V_4 ;
V_420 -> V_672 = V_420 -> V_671 + V_652 - 1 ;
V_420 -> V_480 = V_261 -> V_480 ;
if ( V_646 == V_153 )
memcpy ( V_420 -> V_492 , V_259 -> V_2 . V_281 ,
V_280 ) ;
else {
memcpy ( V_420 -> V_492 , V_21 -> V_647 , V_280 ) ;
if ( F_179 ( V_21 -> V_647 , V_2 -> V_281 ) )
...
for ( V_153 = 0 ; V_153 < V_2 -> V_384 ; V_153 ++ ) {
if ( V_26 -> V_670 [ V_153 ] ) {
F_343 ( V_26 -> V_670 [ V_153 ] ) ;
V_26 -> V_670 [ V_153 ] = NULL ;
}
}
V_664:
F_213 ( V_259 ) ;
...
static void F_372 ( struct V_260 * V_261 )
{
int V_153 ;
struct V_650 * V_26 = F_373 ( V_261 ) ;
...
static int F_375 ( struct V_260 * V_261 )
{
int V_153 ;
struct V_650 * V_26 = F_373 ( V_261 ) ;
struct V_258 * V_259 = & V_26 -> V_258 ;
...
for ( V_153 = 0 ; V_153 < V_2 -> V_384 ; V_153 ++ ) {
if ( V_26 -> V_670 [ V_153 ] ) {
struct V_419 * V_420 = V_26 -> V_670 [ V_153 ] ;
if ( F_228 ( V_420 ) ) {
F_280 ( V_420 ) ;
F_379 ( V_420 ) ;
}
...
static int F_380 ( struct V_260 * V_261 , T_11 V_161 )
{
int V_153 ;
struct V_650 * V_26 = F_373 ( V_261 ) ;
struct V_258 * V_259 = & V_26 -> V_258 ;
...
F_382 ( V_261 ) ;
F_378 ( V_261 , F_383 ( V_261 , V_161 ) , 1 ) ;
F_376 ( V_261 , F_383 ( V_261 , V_161 ) ) ;
return 0 ;
}
