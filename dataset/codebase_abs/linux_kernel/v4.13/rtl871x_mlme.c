...
if ( ( V_68 -> V_70 != V_71 ) &&
( V_6 -> V_14 . V_72 == F_33 ( 0 ) ) )
V_66 = false ;
else if ( ( V_68 -> V_70 == V_71 ) &&
( V_6 -> V_14 . V_72 == F_33 ( 1 ) ) )
V_66 = false ;
else
V_66 = true ;
return V_66 ;
...
static void F_42 ( struct V_1 * V_65 ,
struct V_59 * V_6 )
{
unsigned long V_35 ;
...
static int F_43 ( struct V_1 * V_65 ,
struct V_5 * V_6 )
{
T_2 V_100 [ 512 ] ;
T_4 V_101 ;
...
void F_46 ( struct V_1 * V_65 , T_2 * V_4 )
{
unsigned long V_105 ;
T_3 V_106 ;
struct V_59 * V_6 ;
...
V_6 -> V_78 . V_79 = F_48 ( V_6 -> V_78 . V_79 ) ;
V_6 -> V_72 = F_48 ( V_6 -> V_72 ) ;
V_6 -> V_95 = F_48 ( V_6 -> V_95 ) ;
V_6 -> V_107 = F_48 ( V_6 -> V_107 ) ;
V_6 -> V_80 . V_108 =
F_48 ( V_6 -> V_80 . V_108 ) ;
V_6 -> V_80 . V_109 =
F_48 ( V_6 -> V_80 . V_109 ) ;
...
F_48 ( V_6 -> V_80 . V_110 . V_111 ) ;
V_6 -> V_80 . V_110 . V_112 =
F_48 ( V_6 -> V_80 . V_110 . V_112 ) ;
V_6 -> V_80 . V_110 . V_113 =
F_48 ( V_6 -> V_80 . V_110 . V_113 ) ;
V_6 -> V_80 . V_110 . V_99 =
F_48 ( V_6 -> V_80 . V_110 . V_99 ) ;
V_6 -> V_80 . V_99 =
F_48 ( V_6 -> V_80 . V_99 ) ;
V_6 -> V_15 =
F_48 ( V_6 -> V_15 ) ;
V_6 -> V_61 = F_48 ( V_6 -> V_61 ) ;
#endif
V_106 = F_24 ( V_6 ) ;
...
void F_49 ( struct V_1 * V_65 , T_2 * V_4 )
{
unsigned long V_35 ;
struct V_7 * V_8 = & V_65 -> V_9 ;
F_10 ( & V_8 -> V_18 , V_35 ) ;
...
V_2 -> V_123 . V_138 ) {
F_50 ( & V_8 -> V_140 ) ;
F_65 ( V_2 , V_2 -> V_123 . V_138 ,
V_2 -> V_123 . V_144 ) ;
}
}
void F_66 ( struct V_1 * V_65 , T_2 * V_4 )
{
...
V_6 = F_67 ( sizeof( struct V_5 ) , V_25 ) ;
if ( ! V_6 )
return;
...
#ifdef F_47
V_6 -> V_151 = F_48 ( V_6 -> V_151 ) ;
V_6 -> V_152 = F_48 ( V_6 -> V_152 ) ;
V_6 -> V_14 . V_99 = F_48 ( V_6 -> V_14 . V_99 ) ;
V_6 -> V_14 . V_78 . V_79 =
F_48 ( V_6 -> V_14 . V_78 . V_79 ) ;
V_6 -> V_14 . V_72 = F_48 ( V_6 -> V_14 . V_72 ) ;
V_6 -> V_14 . V_95 = F_48 ( V_6 -> V_14 . V_95 ) ;
V_6 -> V_14 . V_107 =
F_48 ( V_6 -> V_14 . V_107 ) ;
V_6 -> V_14 . V_80 . V_108 =
F_48 ( V_6 -> V_14 . V_80 . V_108 ) ;
V_6 -> V_14 . V_80 . V_109 =
F_48 ( V_6 -> V_14 . V_80 . V_109 ) ;
V_6 -> V_14 . V_80 . V_81 =
F_48 ( V_6 -> V_14 . V_80 . V_81 ) ;
V_6 -> V_14 . V_80 . V_110 . V_111 =
F_48 ( V_6 -> V_14 . V_80 . V_110 .
V_111 ) ;
V_6 -> V_14 . V_80 . V_110 . V_112 =
F_48 ( V_6 -> V_14 . V_80 .
V_110 . V_112 ) ;
V_6 -> V_14 . V_80 . V_110 . V_113 =
F_48 ( V_6 -> V_14 . V_80 . V_110 . V_113 ) ;
V_6 -> V_14 . V_80 . V_110 . V_99 =
F_48 ( V_6 -> V_14 . V_80 . V_110 . V_99 ) ;
V_6 -> V_14 . V_80 . V_99 =
F_48 ( V_6 -> V_14 . V_80 . V_99 ) ;
V_6 -> V_14 . V_15 =
F_48 ( V_6 -> V_14 . V_15 ) ;
V_6 -> V_14 . V_61 = F_48 ( V_6 -> V_14 . V_61 ) ;
#endif
...
if ( ! F_71 ( & V_65 -> V_175 , V_174 -> V_176 ) )
return;
V_132 = F_58 ( & V_65 -> V_127 , V_174 -> V_176 ) ;
if ( V_132 != NULL ) {
return;
}
V_132 = F_68 ( & V_65 -> V_127 , V_174 -> V_176 ) ;
if ( V_132 == NULL )
return;
V_132 -> V_155 = 0 ;
V_132 -> V_156 = F_48 ( V_174 -> V_177 ) ;
...
if ( F_22 ( V_8 , V_114 |
V_104 ) ) {
V_132 = F_58 ( & V_65 -> V_127 , V_179 -> V_176 ) ;
F_10 ( & V_126 -> V_133 , V_35 ) ;
F_59 ( V_65 , V_132 ) ;
F_13 ( & V_126 -> V_133 , V_35 ) ;
...
void F_76 ( struct V_1 * V_65 , T_2 * V_4 )
{
if ( ! V_65 -> V_69 . V_191 )
...
V_206:
return F_84 ( V_65 , V_6 ) ;
}
T_1 F_85 ( struct V_1 * V_65 ,
struct V_67 * V_68 )
{
struct V_209 * V_210 = & V_65 -> V_211 ;
struct V_212 * V_213 ;
struct V_214 * V_215 ;
V_213 = F_67 ( sizeof( * V_213 ) , V_25 ) ;
if ( ! V_213 )
return V_26 ;
V_215 = F_86 ( sizeof( * V_215 ) , V_25 ) ;
if ( ! V_215 ) {
F_28 ( V_213 ) ;
return V_26 ;
}
...
int F_89 ( struct V_1 * V_65 , T_2 * V_241 , T_2 * V_242 ,
T_4 V_243 , T_4 V_244 )
{
...
static int F_90 ( struct V_1 * V_247 , T_2 * V_248 )
{
...
T_1 F_91 ( struct V_1 * V_65 , T_2 * V_241 ,
T_2 * V_242 , T_4 V_243 )
{
T_2 V_253 = 0 , V_254 ;
...
V_122 -> V_80 . V_81 = V_195 -> V_295 ;
if ( V_13 -> V_14 . V_15 == V_171 )
V_122 -> V_80 . V_108 = 3 ;
V_122 -> V_15 = V_13 -> V_14 . V_15 ;
V_286 = F_95 ( V_195 ) ;
V_122 -> V_61 = V_286 ;
...
static void F_69 ( struct V_1 * V_2 , T_2 * V_325 , T_4 V_326 )
{
T_2 * V_305 , V_327 ;
int V_3 , V_106 ;
...
void F_103 ( struct V_1 * V_2 , int V_335 )
{
struct V_7 * V_8 = & V_2 -> V_9 ;
struct V_296 * V_297 = & V_8 -> V_298 ;
