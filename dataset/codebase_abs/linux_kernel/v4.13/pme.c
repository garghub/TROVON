...
static T_5 F_30 ( int V_34 , void * V_35 )
{
struct V_3 * V_18 ;
struct V_25 * V_26 ;
T_4 V_28 ;
unsigned long V_36 ;
V_18 = ( (struct V_37 * ) V_35 ) -> V_18 ;
V_26 = F_31 ( (struct V_37 * ) V_35 ) ;
F_32 ( & V_26 -> V_29 , V_36 ) ;
F_26 ( V_18 , V_31 , & V_28 ) ;
if ( ! ( V_28 & V_32 ) ) {
F_33 ( & V_26 -> V_29 , V_36 ) ;
...
static int F_35 ( struct V_3 * V_4 , void * V_40 )
{
F_36 ( & V_4 -> V_4 , true ) ;
return 0 ;
}
static void F_37 ( struct V_3 * V_18 )
{
F_35 ( V_18 , NULL ) ;
if ( V_18 -> V_12 )
F_38 ( V_18 -> V_12 , F_35 , NULL ) ;
}
static int F_39 ( struct V_37 * V_27 )
{
struct V_3 * V_18 ;
struct V_25 * V_26 ;
int V_10 ;
V_26 = F_40 ( sizeof( * V_26 ) , V_41 ) ;
if ( ! V_26 )
return - V_42 ;
F_41 ( & V_26 -> V_29 ) ;
F_42 ( & V_26 -> V_24 , F_23 ) ;
...
F_2 ( V_18 , false ) ;
F_27 ( V_18 ) ;
V_10 = F_44 ( V_27 -> V_34 , F_30 , V_43 , L_4 , V_27 ) ;
if ( V_10 ) {
F_45 ( V_26 ) ;
return V_10 ;
}
F_46 ( & V_18 -> V_4 , L_5 , V_27 -> V_34 ) ;
F_37 ( V_18 ) ;
F_2 ( V_18 , true ) ;
return 0 ;
}
...
static int F_49 ( struct V_37 * V_27 )
{
...
static int F_52 ( struct V_37 * V_27 )
{
struct V_25 * V_26 = F_31 ( V_27 ) ;
F_25 ( & V_26 -> V_29 ) ;
if ( V_26 -> V_30 ) {
...
static void F_54 ( struct V_37 * V_27 )
{
F_49 ( V_27 ) ;
F_55 ( V_27 -> V_34 , V_27 ) ;
F_45 ( F_31 ( V_27 ) ) ;
