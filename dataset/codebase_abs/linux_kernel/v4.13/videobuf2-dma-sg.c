...
V_2 -> V_5 = V_5 ;
V_2 -> V_28 = & V_2 -> V_20 ;
V_46 = F_28 ( V_25 , V_5 , V_2 -> V_19 == V_48 ) ;
if ( F_29 ( V_46 ) )
goto V_49;
V_2 -> V_46 = V_46 ;
V_2 -> V_7 = F_30 ( V_46 ) ;
...
static int F_41 ( void * V_43 , struct V_54 * V_55 )
{
struct V_1 * V_2 = V_43 ;
...
do {
int V_22 ;
V_22 = F_43 ( V_55 , V_56 , V_2 -> V_7 [ V_9 ++ ] ) ;
if ( V_22 ) {
F_42 ( V_60 L_5 , V_22 ) ;
return V_22 ;
}
...
static int F_44 ( struct V_65 * V_66 , struct V_15 * V_16 ,
struct V_67 * V_68 )
{
struct V_69 * V_70 ;
unsigned int V_9 ;
...
F_46 ( V_73 , F_47 ( V_72 ) , V_72 -> V_75 , V_72 -> V_26 ) ;
V_72 = F_48 ( V_72 ) ;
V_73 = F_48 ( V_73 ) ;
}
V_70 -> V_19 = V_76 ;
...
static void F_56 ( struct V_67 * V_44 ,
...
static void * F_58 ( struct V_65 * V_66 , unsigned long V_80 )
{
struct V_1 * V_2 = V_66 -> V_74 ;
...
struct V_54 * V_55 )
{
return F_41 ( V_66 -> V_74 , V_55 ) ;
}
static struct V_65 * F_61 ( void * V_43 , unsigned long V_81 )
{
struct V_1 * V_2 = V_43 ;
struct V_65 * V_66 ;
F_62 ( V_82 ) ;
...
if ( V_2 -> V_25 ) {
F_68 ( V_2 -> V_44 -> V_52 , V_2 -> V_25 ) ;
V_2 -> V_25 = NULL ;
}
F_69 ( V_2 -> V_44 , V_21 , V_2 -> V_19 ) ;
V_2 -> V_28 = NULL ;
}
static void F_70 ( void * V_85 )
{
struct V_1 * V_2 = V_85 ;
if ( F_7 ( V_2 -> V_28 ) )
F_67 ( V_2 ) ;
F_71 ( V_2 -> V_44 -> V_52 , V_2 -> V_44 ) ;
F_19 ( V_2 ) ;
}
static void * F_72 ( struct V_15 * V_16 , struct V_65 * V_66 ,
unsigned long V_5 , enum V_18 V_19 )
{
struct V_1 * V_2 ;
struct V_67 * V_86 ;
