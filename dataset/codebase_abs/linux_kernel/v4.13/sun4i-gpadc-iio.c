...
static int F_22 ( struct V_2 * V_3 , int V_4 ,
int * V_23 )
{
struct V_6 * V_7 = F_6 ( V_3 ) ;
...
static int F_25 ( struct V_2 * V_3 , int * V_23 )
{
struct V_6 * V_7 = F_6 ( V_3 ) ;
* V_23 = V_7 -> V_18 -> V_33 ;
return 0 ;
...
static T_2 F_27 ( int V_5 , void * V_44 )
{
struct V_6 * V_7 = V_44 ;
if ( F_28 ( & V_7 -> V_45 ) )
goto V_46;
...
V_3 -> V_76 = F_48 ( V_77 ) ;
V_3 -> V_78 = V_77 ;
V_71 = F_49 ( V_60 , V_79 , 0 ) ;
V_72 = F_50 ( & V_60 -> V_10 , V_71 ) ;
if ( F_51 ( V_72 ) )
return F_52 ( V_72 ) ;
V_7 -> V_13 = F_53 ( & V_60 -> V_10 , V_72 ,
& V_80 ) ;
if ( F_51 ( V_7 -> V_13 ) ) {
V_8 = F_52 ( V_7 -> V_13 ) ;
...
return 0 ;
V_7 -> V_82 = & V_60 -> V_10 ;
V_7 -> V_83 = F_55 ( V_7 -> V_82 , 0 ,
V_7 , & V_84 ) ;
if ( F_51 ( V_7 -> V_83 ) )
F_43 ( & V_60 -> V_10 , L_5 ,
F_52 ( V_7 -> V_83 ) ) ;
return F_56 ( V_7 -> V_83 ) ;
}
...
V_3 -> V_76 = F_48 ( V_85 ) ;
V_3 -> V_78 = V_85 ;
V_7 -> V_18 = (struct V_75 * ) F_58 ( V_60 ) -> V_86 ;
if ( F_54 ( V_81 ) ) {
V_7 -> V_82 = V_60 -> V_10 . V_11 ;
V_7 -> V_83 = F_55 ( V_7 -> V_82 ,
0 , V_7 ,
& V_84 ) ;
if ( F_51 ( V_7 -> V_83 ) ) {
F_43 ( & V_60 -> V_10 ,
...
return 0 ;
V_95:
if ( ! V_7 -> V_29 && F_54 ( V_81 ) )
F_71 ( V_3 ) ;
F_72 ( & V_60 -> V_10 ) ;
F_73 ( & V_60 -> V_10 ) ;
return V_8 ;
}
static int F_74 ( struct V_59 * V_60 )
{
struct V_2 * V_3 = F_75 ( V_60 ) ;
struct V_6 * V_7 = F_6 ( V_3 ) ;
F_72 ( & V_60 -> V_10 ) ;
F_73 ( & V_60 -> V_10 ) ;
if ( ! F_54 ( V_81 ) )
return 0 ;
F_76 ( V_7 -> V_82 , V_7 -> V_83 ) ;
if ( ! V_7 -> V_29 )
F_71 ( V_3 ) ;
return 0 ;
}
