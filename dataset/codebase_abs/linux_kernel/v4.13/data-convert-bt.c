...
return F_107 ( & V_107 -> V_156 , V_153 , V_154 ) ;
return 0 ;
}
...
int V_10 ;
if ( V_159 -> V_184 ) {
V_107 . V_102 . V_169 = V_185 ;
V_107 . V_102 . exit = V_186 ;
V_107 . V_102 . V_172 = V_187 ;
}
...
if ( F_67 ( V_13 , V_122 ) )
goto V_189;
if ( V_159 -> V_184 && F_69 ( V_13 , V_122 ) )
goto V_189;
if ( F_76 ( V_13 , V_122 ) )
goto V_189;
V_10 = F_112 ( V_122 ) ;
...
fprintf ( V_190 , L_87 V_11 L_88 , V_107 . V_191 ) ;
F_73 ( V_122 ) ;
F_113 ( V_122 ) ;
F_93 ( V_13 ) ;
return V_10 ;
