...
static int F_82 ( struct V_9 * V_10 , struct V_141 * V_142 ,
T_2 T_4 * V_165 )
{
struct V_12 * V_13 = F_3 ( V_10 ) ;
int V_166 = - V_40 ;
...
struct V_141 * V_169 )
{
int V_170 = F_81 ( V_149 ,
V_13 -> V_150 ) ;
int V_171 = F_81 ( V_164 ,
V_13 -> V_150 ) ;
...
if ( V_172 )
F_85 ( V_13 , V_180 , V_13 -> V_45 ,
L_5 ) ;
F_86 ( V_20 , F_42 ( 0 ) , V_173 ) ;
}
return 0 ;
}
static int F_87 ( struct V_9 * V_10 , struct V_141 * V_142 )
{
struct V_12 * V_13 = F_3 ( V_10 ) ;
int V_166 = - V_40 ;
switch ( V_142 -> V_142 ) {
case V_181 :
V_166 = F_83 ( V_13 , V_142 ) ;
break;
default:
break;
}
...
static int F_88 ( struct V_12 * V_13 , T_3 * V_11 )
{
struct V_37 * V_20 = & V_13 -> V_20 ;
struct V_182 * V_49 = & V_20 -> V_49 ;
T_2 V_183 , V_184 [ 6 ] ;
unsigned long V_185 ;
int V_107 = - V_91 ;
if ( V_20 -> V_21 . type != V_22 )
return 0 ;
for ( V_183 = F_46 ( V_186 ) ;
V_183 < F_46 ( 2 * V_187 ) ;
V_183 += V_183 ) {
F_89 ( V_184 , V_183 ) ;
F_90 ( V_13 ) ;
V_49 -> V_188 = V_189 ;
V_107 = V_49 -> V_190 . V_191 ( V_20 , V_49 , V_184 ) ;
F_91 ( V_13 ) ;
V_185 = V_192 + V_193 ;
do {
if ( V_107 < 0 )
...
V_194:
* V_11 = V_107 < 0 ? ( V_183 ) : ( V_107 > 0 ) ;
return V_107 ;
}
static void F_93 ( struct V_9 * V_10 ,
struct V_196 * V_197 , T_3 * V_11 )
{
struct V_12 * V_13 = F_3 ( V_10 ) ;
struct V_37 * V_20 = & V_13 -> V_20 ;
memset ( V_11 , 0 , sizeof( * V_11 ) * V_31 ) ;
if ( F_94 ( V_20 -> V_198 ) ) {
F_95 ( V_13 , V_180 , V_10 ,
L_6 ) ;
V_197 -> V_150 |= V_199 ;
return;
}
if ( F_88 ( V_13 , & V_11 [ V_200 ] ) )
V_197 -> V_150 |= V_199 ;
}
static T_2 F_96 ( struct V_9 * V_45 )
{
return 0 ;
}
static int F_97 ( struct V_9 * V_45 , T_2 V_201 )
{
if ( V_201 >= F_46 ( V_35 ) )
return - V_91 ;
return 0 ;
}
static T_2 F_98 ( struct V_9 T_4 * V_45 )
{
return V_202 * V_203 ;
}
void F_99 ( struct V_12 * V_13 , const T_2 * V_204 )
{
V_44 V_205 = V_13 -> V_206 [ V_207 ] . V_208 ;
struct V_37 * V_20 = & V_13 -> V_20 ;
T_2 V_209 [ 4 ] ;
int V_6 , V_57 ;
...
if ( V_204 )
V_211 = V_204 [ 4 * V_6 + V_57 ] ;
else
V_211 = F_100 ( 4 * V_6 + V_57 ,
V_205 ) ;
V_209 [ V_57 ] = V_211 ;
}
V_210 = V_209 [ 0 ] |
...
( V_209 [ 2 ] << 16 ) |
( V_209 [ 3 ] << 24 ) ;
if ( V_13 -> V_210 [ V_6 ] == V_210 )
continue;
V_13 -> V_210 [ V_6 ] = V_210 ;
F_86 ( V_20 , F_44 ( 0 , V_6 ) , V_210 ) ;
}
}
static int F_101 ( struct V_9 * V_45 , T_2 * V_204 )
{
struct V_12 * V_13 = F_3 ( V_45 ) ;
int V_6 ;
if ( ! V_204 )
return 0 ;
for ( V_6 = 0 ; V_6 < V_202 ; V_6 ++ , V_204 += 4 ) {
T_2 V_210 = V_13 -> V_210 [ V_6 ] ;
V_204 [ 0 ] = ( V_210 << 24 ) >> 24 ;
V_204 [ 1 ] = ( V_210 << 16 ) >> 24 ;
V_204 [ 2 ] = ( V_210 << 8 ) >> 24 ;
V_204 [ 3 ] = ( V_210 ) >> 24 ;
...
static int F_102 ( struct V_9 * V_45 , const T_2 * V_204 )
{
struct V_12 * V_13 = F_3 ( V_45 ) ;
int V_6 ;
V_44 V_205 ;
if ( ! V_204 )
return 0 ;
V_205 = V_13 -> V_206 [ V_207 ] . V_208 ;
for ( V_6 = F_98 ( V_45 ) ; V_6 -- ; ) {
if ( V_204 [ V_6 ] < V_205 )
continue;
return - V_91 ;
}
...
static T_2 F_103 ( struct V_9 T_4 * V_45 )
{
return V_212 * V_213 ;
}
static int F_104 ( struct V_9 * V_45 , T_2 * V_204 , T_1 * V_214 ,
T_1 * V_215 )
{
struct V_12 * V_13 = F_3 ( V_45 ) ;
int V_6 , V_107 ;
if ( V_215 )
* V_215 = V_216 ;
V_107 = F_101 ( V_45 , V_204 ) ;
if ( V_107 || ! V_214 )
return V_107 ;
for ( V_6 = 0 ; V_6 < V_212 ; V_6 ++ , V_214 += 4 )
* ( V_217 * ) V_214 = F_105 ( V_13 -> V_218 [ V_6 ] ) ;
return 0 ;
}
static int F_106 ( struct V_9 * V_45 , const T_2 * V_204 ,
...
return - V_40 ;
V_107 = F_102 ( V_45 , V_204 ) ;
if ( V_107 || ! V_214 )
return V_107 ;
for ( V_6 = 0 ; V_6 < V_212 ; V_6 ++ , V_214 += 4 ) {
T_2 V_218 = F_107 ( * ( V_217 * ) V_214 ) ;
if ( V_13 -> V_218 [ V_6 ] == V_218 )
continue;
V_13 -> V_218 [ V_6 ] = V_218 ;
F_86 ( V_20 , F_43 ( 0 , V_6 ) , V_218 ) ;
}
return 0 ;
}
static unsigned int F_108 ( struct V_9 * V_10 )
{
struct V_12 * V_13 = F_3 ( V_10 ) ;
unsigned int V_220 = V_13 -> V_20 . V_21 . V_25 ;
T_1 V_221 = F_109 ( V_10 ) ;
if ( V_221 > 1 )
V_220 = F_46 ( ( F_110 ( V_220 / V_221 ) - 1 ) ) ;
return V_220 ;
}
...
struct V_12 * V_13 = F_3 ( V_10 ) ;
struct V_37 * V_20 = & V_13 -> V_20 ;
V_223 -> V_220 = F_108 ( V_10 ) ;
V_223 -> V_224 = F_112 ( V_20 ) ;
V_223 -> V_225 = V_223 -> V_224 ;
V_223 -> V_226 = V_13 -> V_206 [ V_207 ] . V_208 ;
}
static int F_113 ( struct V_9 * V_10 ,
struct V_222 * V_223 )
{
struct V_12 * V_13 = F_3 ( V_10 ) ;
unsigned int V_117 = V_223 -> V_226 ;
struct V_37 * V_20 = & V_13 -> V_20 ;
if ( ! V_117 || V_223 -> V_227 || V_223 -> V_228 )
return - V_91 ;
if ( V_223 -> V_225 != F_112 ( V_20 ) )
return - V_91 ;
if ( V_117 > F_108 ( V_10 ) )
return - V_91 ;
V_13 -> V_206 [ V_207 ] . V_229 = V_117 ;
return F_114 ( V_10 , F_109 ( V_10 ) ) ;
}
