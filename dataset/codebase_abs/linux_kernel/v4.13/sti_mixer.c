...
void F_17 ( struct V_1 * V_2 , bool V_48 )
{
...
V_53 = F_20 ( * V_52 , 0 ) ;
V_55 = F_20 ( * V_52 , V_52 -> V_57 - 1 ) ;
V_54 = F_21 ( * V_52 , 0 ) ;
V_56 = F_21 ( * V_52 , V_52 -> V_58 - 1 ) ;
F_4 ( V_2 , V_31 , V_53 << 16 | V_54 ) ;
F_4 ( V_2 , V_32 , V_55 << 16 | V_56 ) ;
}
int F_22 ( struct V_1 * V_2 , struct V_59 * V_60 )
{
...
static T_1 F_28 ( struct V_59 * V_60 )
{
switch ( V_60 -> V_67 ) {
case V_76 :
return V_49 ;
...
struct V_1 * F_30 ( struct V_84 * V_74 ,
struct V_85 * V_86 ,
int V_3 ,
void T_2 * V_87 )
{
struct V_1 * V_2 = F_31 ( V_74 , sizeof( * V_2 ) , V_88 ) ;
F_26 ( V_74 , L_29 , V_89 ) ;
if ( ! V_2 ) {
F_23 ( L_30 ) ;
return NULL ;
