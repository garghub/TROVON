...
return - V_38 ;
if( ( V_45 -> V_105 &&
F_55 ( & V_45 -> V_106 ) >= V_45 -> V_47 &&
F_55 ( & V_45 -> V_66 ) >= 2 * V_45 -> V_47 ) ) {
F_22 ( L_20 ,
F_55 ( & V_45 -> V_106 ) ) ;
return - V_107 ;
}
...
V_103 = F_56 ( V_100 , V_108 | V_109 ) ;
if ( V_103 == NULL )
return - V_65 ;
if ( F_57 ( V_103 , V_99 , V_100 ) ) {
F_14 ( V_103 ) ;
return - V_110 ;
}
V_102 = V_100 ;
V_104 = V_103 ;
do {
V_40 = V_45 -> V_40 > V_111 ?
V_112 : V_45 -> V_40 ;
V_101 = F_58 ( T_3 , V_40 , V_102 ) ;
F_11 ( L_22 ,
V_101 , V_102 ) ;
V_50 = F_27 ( V_45 , V_113 ,
V_101 + V_114 ) ;
if ( V_50 == NULL ) {
F_14 ( V_103 ) ;
return - V_65 ;
...
int F_64 ( struct V_44 * V_45 , T_1 V_52 , T_1 V_51 ,
struct V_98 * V_99 , T_3 V_100 )
{
struct V_49 * V_50 ;
struct V_33 * V_34 ;
...
V_50 = F_24 ( V_50 , V_51 , V_52 , V_115 ) ;
if ( F_60 ( V_101 > 0 ) )
F_25 ( V_50 , V_104 , V_101 ) ;
F_30 ( & V_34 -> V_66 , V_50 ) ;
V_102 -= V_101 ;
...
struct V_49 * V_58 ;
struct V_33 * V_34 ;
F_11 ( L_24 , V_45 -> V_116 ) ;
V_34 = V_45 -> V_34 ;
if ( V_34 == NULL )
return - V_38 ;
V_58 = F_27 ( V_45 , V_117 , V_114 ) ;
if ( V_58 == NULL )
return - V_65 ;
F_59 ( V_58 , V_114 ) ;
V_58 -> V_118 [ 2 ] = V_45 -> V_116 ;
F_53 ( & V_34 -> V_66 , V_58 ) ;
return 0 ;
}
