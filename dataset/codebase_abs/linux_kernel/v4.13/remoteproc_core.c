...
V_95 = F_57 ( V_10 , V_92 ) ;
if ( V_95 ) {
memcpy ( V_95 , V_10 -> V_97 , V_96 ) ;
V_10 -> V_45 = V_95 ;
}
V_14 = V_10 -> V_24 -> V_98 ( V_10 ) ;
if ( V_14 ) {
F_4 ( V_6 , L_37 , V_10 -> V_67 , V_14 ) ;
return V_14 ;
}
V_14 = F_46 ( V_10 ) ;
if ( V_14 ) {
...
V_10 -> V_100 = V_101 ;
F_58 ( V_6 , L_39 , V_10 -> V_67 ) ;
return 0 ;
}
static int F_59 ( struct V_10 * V_10 , const struct V_91 * V_92 )
{
struct V_5 * V_6 = & V_10 -> V_6 ;
...
if ( V_14 )
return V_14 ;
F_58 ( V_6 , L_40 , V_67 , V_92 -> V_38 ) ;
V_14 = F_6 ( V_10 ) ;
if ( V_14 ) {
F_4 ( V_6 , L_41 , V_14 ) ;
return V_14 ;
}
V_10 -> V_102 = F_61 ( V_10 , V_92 ) ;
V_14 = - V_42 ;
V_94 = F_55 ( V_10 , V_92 , & V_96 ) ;
if ( ! V_94 ) {
F_4 ( V_6 , L_42 ) ;
...
V_10 -> V_97 = F_62 ( V_94 , V_96 , V_41 ) ;
if ( ! V_10 -> V_97 )
goto V_103;
V_10 -> V_45 = V_10 -> V_97 ;
V_10 -> V_44 = - 1 ;
V_14 = F_44 ( V_10 , V_96 , V_104 ) ;
if ( V_14 ) {
F_4 ( V_6 , L_43 , V_14 ) ;
goto V_105;
}
...
static void F_63 ( const struct V_91 * V_92 , void * V_106 )
{
struct V_10 * V_10 = V_106 ;
F_64 ( V_10 ) ;
F_65 ( V_92 ) ;
}
static int F_66 ( struct V_10 * V_10 )
{
int V_14 ;
V_14 = F_67 ( V_107 , V_108 ,
V_10 -> V_91 , & V_10 -> V_6 , V_41 ,
V_10 , F_63 ) ;
if ( V_14 < 0 )
F_4 ( & V_10 -> V_6 , L_44 , V_14 ) ;
return V_14 ;
}
...
F_69 ( & V_10 -> V_110 ) ;
V_10 -> V_100 = V_111 ;
F_58 ( V_6 , L_46 , V_10 -> V_67 ) ;
return 0 ;
}
int F_70 ( struct V_10 * V_10 )
{
const struct V_91 * V_112 ;
struct V_5 * V_6 = & V_10 -> V_6 ;
int V_14 ;
F_4 ( V_6 , L_47 , V_10 -> V_67 ) ;
F_71 ( & V_10 -> V_110 ) ;
V_14 = F_72 ( & V_10 -> V_113 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_68 ( V_10 ) ;
if ( V_14 )
goto V_114;
F_73 ( & V_10 -> V_110 ) ;
V_14 = F_74 ( & V_112 , V_10 -> V_91 , V_6 ) ;
if ( V_14 < 0 ) {
F_4 ( V_6 , L_48 , V_14 ) ;
goto V_114;
}
V_14 = F_54 ( V_10 , V_112 ) ;
F_65 ( V_112 ) ;
V_114:
F_75 ( & V_10 -> V_113 ) ;
return V_14 ;
...
{
struct V_10 * V_10 = F_26 ( V_116 , struct V_10 , V_117 ) ;
struct V_5 * V_6 = & V_10 -> V_6 ;
F_7 ( V_6 , L_49 , V_118 ) ;
F_77 ( & V_10 -> V_113 ) ;
if ( V_10 -> V_100 == V_109 || V_10 -> V_100 == V_111 ) {
F_75 ( & V_10 -> V_113 ) ;
return;
}
V_10 -> V_100 = V_109 ;
F_4 ( V_6 , L_50 , ++ V_10 -> V_119 ,
V_10 -> V_67 ) ;
F_75 ( & V_10 -> V_113 ) ;
if ( ! V_10 -> V_120 )
F_70 ( V_10 ) ;
}
static int F_78 ( struct V_10 * V_10 )
{
const struct V_91 * V_112 ;
struct V_5 * V_6 ;
int V_14 ;
...
V_14 = F_72 ( & V_10 -> V_113 ) ;
if ( V_14 ) {
F_4 ( V_6 , L_52 , V_10 -> V_67 , V_14 ) ;
return V_14 ;
}
if ( V_10 -> V_100 == V_121 ) {
V_14 = - V_122 ;
F_4 ( V_6 , L_53 , V_10 -> V_67 ) ;
goto V_114;
}
if ( F_80 ( & V_10 -> V_123 ) > 1 ) {
V_14 = 0 ;
goto V_114;
}
F_58 ( V_6 , L_54 , V_10 -> V_67 ) ;
V_14 = F_74 ( & V_112 , V_10 -> V_91 , V_6 ) ;
if ( V_14 < 0 ) {
F_4 ( V_6 , L_48 , V_14 ) ;
goto V_124;
}
V_14 = F_59 ( V_10 , V_112 ) ;
F_65 ( V_112 ) ;
V_124:
if ( V_14 )
F_81 ( & V_10 -> V_123 ) ;
...
int F_64 ( struct V_10 * V_10 )
{
return F_78 ( V_10 ) ;
}
void F_82 ( struct V_10 * V_10 )
{
struct V_5 * V_6 = & V_10 -> V_6 ;
int V_14 ;
V_14 = F_72 ( & V_10 -> V_113 ) ;
...
struct V_10 * F_85 ( T_5 T_5 )
{
struct V_10 * V_10 = NULL , * V_125 ;
struct V_126 * V_127 ;
V_127 = F_86 ( T_5 ) ;
if ( ! V_127 )
return NULL ;
...
if ( V_125 -> V_6 . V_13 && V_125 -> V_6 . V_13 -> V_129 == V_127 ) {
if ( ! F_87 ( V_125 -> V_6 . V_13 -> V_130 -> V_131 ) ) {
F_4 ( & V_125 -> V_6 , L_55 ) ;
break;
}
V_10 = V_125 ;
...
F_58 ( & V_10 -> V_6 , L_57 , V_10 -> V_67 ) ;
F_95 ( & V_10 -> V_43 ) ;
if ( V_10 -> V_134 >= 0 )
F_96 ( & V_135 , V_10 -> V_134 ) ;
F_35 ( V_10 -> V_91 ) ;
F_35 ( V_10 ) ;
}
struct V_10 * F_97 ( struct V_5 * V_6 , const char * V_67 ,
const struct V_136 * V_24 ,
const char * V_91 , int V_20 )
{
struct V_10 * V_10 ;
char * V_137 , * V_138 = L_58 ;
int V_139 ;
if ( ! V_6 || ! V_67 || ! V_24 )
return NULL ;
if ( ! V_91 ) {
V_139 = strlen ( V_67 ) + strlen ( V_138 ) - 2 + 1 ;
V_137 = F_98 ( V_139 , V_41 ) ;
if ( ! V_137 )
return NULL ;
snprintf ( V_137 , V_139 , V_138 , V_67 ) ;
} else {
V_137 = F_99 ( V_91 , V_41 ) ;
if ( ! V_137 )
return NULL ;
}
...
V_10 -> V_6 . V_13 = V_6 ;
V_10 -> V_6 . type = & V_140 ;
V_10 -> V_6 . V_141 = & V_142 ;
V_10 -> V_134 = F_101 ( & V_135 , 0 , 0 , V_41 ) ;
if ( V_10 -> V_134 < 0 ) {
F_4 ( V_6 , L_59 , V_10 -> V_134 ) ;
F_102 ( & V_10 -> V_6 ) ;
return NULL ;
}
F_103 ( & V_10 -> V_6 , L_60 , V_10 -> V_134 ) ;
F_104 ( & V_10 -> V_123 , 0 ) ;
V_10 -> V_143 = & V_144 ;
F_105 ( & V_10 -> V_113 ) ;
F_106 ( & V_10 -> V_43 ) ;
...
F_107 ( & V_10 -> V_62 ) ;
F_107 ( & V_10 -> V_145 ) ;
F_108 ( & V_10 -> V_117 , F_76 ) ;
F_71 ( & V_10 -> V_110 ) ;
V_10 -> V_100 = V_111 ;
return V_10 ;
}
void F_109 ( struct V_10 * V_10 )
{
F_102 ( & V_10 -> V_6 ) ;
}
void F_110 ( struct V_10 * V_10 )
{
F_111 ( V_10 -> V_6 . V_13 -> V_130 -> V_131 ) ;
F_102 ( & V_10 -> V_6 ) ;
}
int F_112 ( struct V_10 * V_10 )
{
if ( ! V_10 )
return - V_42 ;
if ( V_10 -> V_132 )
