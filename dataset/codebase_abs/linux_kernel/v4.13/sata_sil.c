...
V_47 -> V_109 |= V_110 ;
F_42 ( V_47 -> V_111 , V_107 , V_112 , sizeof( V_107 ) ) ;
for ( V_105 = 0 ; V_113 [ V_105 ] . V_114 ; V_105 ++ )
if ( ! strcmp ( V_113 [ V_105 ] . V_114 , V_107 ) ) {
V_106 = V_113 [ V_105 ] . V_115 ;
break;
}
if ( V_116 ||
( ( V_4 -> V_21 & V_117 ) &&
...
const struct V_129 * V_136 = F_51 ( V_130 ) ;
if ( V_136 ) {
unsigned long V_137 = ( unsigned long ) V_136 -> V_135 ;
return V_137 == F_52 ( V_39 -> V_138 ) ;
}
return false ;
}
static int F_53 ( struct V_38 * V_39 , const struct V_139 * V_140 )
{
int V_141 = V_140 -> V_135 ;
...
V_6 = F_55 ( & V_39 -> V_47 , V_145 , V_94 ) ;
if ( ! V_6 )
return - V_150 ;
V_50 = F_56 ( V_39 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_57 ( V_39 , 1 << V_8 , V_151 ) ;
if ( V_50 == - V_152 )
F_58 ( V_39 ) ;
if ( V_50 )
return V_50 ;
V_6 -> V_7 = F_59 ( V_39 ) ;
V_50 = F_60 ( & V_39 -> V_47 , V_153 ) ;
if ( V_50 )
return V_50 ;
V_50 = F_61 ( & V_39 -> V_47 , V_153 ) ;
if ( V_50 )
return V_50 ;
V_5 = V_6 -> V_7 [ V_8 ] ;
for ( V_92 = 0 ; V_92 < V_6 -> V_94 ; V_92 ++ ) {
struct V_3 * V_4 = V_6 -> V_95 [ V_92 ] ;
struct V_154 * V_13 = & V_4 -> V_13 ;
V_13 -> V_155 = V_5 + V_10 [ V_92 ] . V_19 ;
V_13 -> V_156 =
V_13 -> V_157 = V_5 + V_10 [ V_92 ] . V_158 ;
V_13 -> V_14 = V_5 + V_10 [ V_92 ] . V_12 ;
V_13 -> V_55 = V_5 + V_10 [ V_92 ] . V_159 ;
F_62 ( V_13 ) ;
F_63 ( V_4 , V_8 , - 1 , L_11 ) ;
...
F_44 ( V_6 ) ;
F_64 ( V_39 ) ;
return F_65 ( V_6 , V_39 -> V_88 , F_34 , V_160 ,
& V_161 ) ;
}
