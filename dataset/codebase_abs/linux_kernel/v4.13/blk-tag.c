...
V_31 -> V_4 = - 1 ;
V_31 -> V_36 = - 1 ;
if ( F_29 ( V_7 -> V_11 [ V_4 ] == NULL ) )
F_12 ( V_17 L_2 ,
V_18 , V_4 ) ;
V_7 -> V_11 [ V_4 ] = NULL ;
if ( F_29 ( ! F_30 ( V_4 , V_7 -> V_9 ) ) ) {
F_12 ( V_17 L_3 ,
V_18 , V_4 ) ;
return;
}
...
int F_32 ( struct V_2 * V_3 , struct V_1 * V_31 )
{
struct V_6 * V_7 = V_3 -> V_5 ;
unsigned V_10 ;
int V_4 ;
F_27 ( V_3 -> V_32 ) ;
if ( F_29 ( ( V_31 -> V_34 & V_35 ) ) ) {
F_12 ( V_17
L_4 ,
V_18 , V_31 ,
V_31 -> V_37 ? V_31 -> V_37 -> V_38 : L_5 , V_31 -> V_4 ) ;
F_33 () ;
}
V_10 = V_7 -> V_10 ;
if ( ! F_34 ( V_31 ) && V_10 > 1 ) {
...
if ( V_3 -> V_39 [ V_40 ] > V_10 )
return 1 ;
}
do {
if ( V_7 -> V_24 == V_41 ) {
V_4 = F_35 ( V_7 -> V_9 , V_10 ) ;
if ( V_4 >= V_10 )
return 1 ;
} else {
int V_42 = V_7 -> V_25 ;
int V_43 = F_36 ( int , V_7 -> V_10 , V_10 + V_42 ) ;
V_4 = F_37 ( V_7 -> V_9 , V_43 , V_42 ) ;
if ( V_4 >= V_43 && V_42 + V_43 > V_7 -> V_10 ) {
V_43 = V_42 + V_43 - V_7 -> V_10 ;
V_4 = F_35 ( V_7 -> V_9 , V_43 ) ;
}
if ( V_4 >= V_43 )
return 1 ;
}
} while ( F_38 ( V_4 , V_7 -> V_9 ) );
V_7 -> V_25 = ( V_4 + 1 ) % V_7 -> V_10 ;
V_31 -> V_34 |= V_35 ;
V_31 -> V_4 = V_4 ;
V_7 -> V_11 [ V_4 ] = V_31 ;
F_39 ( V_31 ) ;
F_40 ( & V_31 -> V_33 , & V_3 -> V_27 ) ;
return 0 ;
}
