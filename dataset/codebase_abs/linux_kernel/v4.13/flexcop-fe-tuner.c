...
static int T_2 F_6 ( struct V_1 * V_2 )
{
struct V_6 * V_7 = V_2 -> V_8 -> V_9 ;
if ( V_7 -> V_23 )
return V_7 -> V_23 ( V_2 ) ;
...
int V_38 , T_4 * V_39 , unsigned long V_40 )
{
int V_35 ;
F_7 ( V_2 , V_29 ) ;
F_12 ( 16 ) ;
...
{
static T_4 V_83 [] = { 0x89 , 0x18 , 0x2d } ;
static T_4 V_84 [] = { 0x50 , 0x80 } ;
static T_4 V_85 [] = { 0x8E , 0x40 } ;
static T_4 V_86 [] = { 0x67 , 0x28 , 0xa1 } ;
static T_4 V_87 [] = { 0x75 , 0x32 } ;
