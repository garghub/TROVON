...
F_56 ( V_2 -> V_116 ? V_2 -> V_116 : V_2 -> V_84 ) ;
}
}
...
if ( ! V_11 )
return - V_16 ;
V_170 = F_104 ( V_11 , sizeof( * V_170 ) ) ;
V_170 -> V_112 = V_172 ;
V_170 -> V_20 = sizeof( * V_112 ) + 1 ;
V_112 = F_104 ( V_11 , sizeof( * V_112 ) ) ;
V_112 -> V_173 = 0x01 ;
V_112 -> V_164 = F_105 ( V_164 ) ;
F_106 ( V_11 , 0x00 ) ;
F_8 ( V_11 ) = V_17 ;
return F_18 ( V_23 , V_11 ) ;
}
static int F_107 ( struct V_1 * V_2 , void * V_8 ,
int V_9 )
{
...
static void F_108 ( struct V_1 * V_2 , const void * V_175 ,
unsigned int V_13 )
{
...
static int F_112 ( struct V_32 * V_23 , struct V_10 * V_11 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
if ( F_24 ( V_174 , & V_2 -> V_3 ) ) {
...
switch ( V_11 -> V_2 [ 2 ] ) {
case 0x02 :
F_108 ( V_2 , V_175 , V_13 ) ;
break;
case 0x06 :
F_111 ( V_2 , V_175 , V_13 ) ;
break;
}
}
}
...
static int F_113 ( struct V_32 * V_23 , struct V_10 * V_11 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_31 * V_31 ;
F_23 ( L_4 , V_23 -> V_34 ) ;
...
static int F_114 ( struct V_32 * V_23 )
{
...
F_55 ( V_181 , & V_2 -> V_3 ) ;
V_12 = F_118 ( V_23 , 0x00 , 128 , V_143 -> V_2 ) ;
if ( V_12 < 0 ) {
F_25 ( L_54 ,
V_23 -> V_34 , V_12 ) ;
goto V_77;
}
V_12 = F_118 ( V_23 , 0x03 , 256 , V_143 -> V_2 + 128 ) ;
if ( V_12 < 0 ) {
F_25 ( L_55 ,
V_23 -> V_34 , V_12 ) ;
goto V_77;
}
V_12 = F_118 ( V_23 , 0x02 , 256 , V_143 -> V_2 + 388 ) ;
if ( V_12 < 0 ) {
F_25 ( L_56 ,
V_23 -> V_34 , V_12 ) ;
goto V_77;
...
if ( ! ( V_186 % 4 ) ) {
V_12 = F_118 ( V_23 , 0x01 , V_186 , V_155 ) ;
if ( V_12 < 0 ) {
F_25 ( L_57 ,
V_23 -> V_34 , V_12 ) ;
goto V_77;
...
V_189 = F_115 () ;
V_188 = F_121 ( V_189 , V_187 ) ;
V_190 = ( unsigned long long ) F_122 ( V_188 ) >> 10 ;
...
static int F_126 ( struct V_32 * V_23 )
{
struct V_10 * V_11 ;
struct V_1 * V_2 = F_22 ( V_23 ) ;
...
int V_145 ;
T_3 V_158 [ 5 ] ;
if ( F_127 ( V_76 -> V_211 , L_68 , & V_209 ) ||
F_127 ( V_76 -> V_211 , L_69 , & V_210 ) )
return 0 ;
V_164 = F_128 ( 0x3F , 0x59 ) ;
V_158 [ 0 ] = V_164 & 0xFF ;
V_158 [ 1 ] = V_164 >> 8 ;
V_158 [ 2 ] = 2 ;
V_158 [ 3 ] = V_209 ;
...
if ( ! V_11 ) {
F_129 ( V_23 , L_70 , V_212 ) ;
return - V_16 ;
}
F_11 ( V_11 , V_158 , sizeof( V_158 ) ) ;
F_8 ( V_11 ) = V_107 ;
V_145 = F_75 ( V_23 , V_11 ) ;
if ( V_145 ) {
F_129 ( V_23 , L_71 , V_212 ) ;
F_3 ( V_11 ) ;
return V_145 ;
}
return 0 ;
}
static int F_130 ( struct V_32 * V_23 ,
const T_8 * V_213 )
{
struct V_10 * V_11 ;
T_3 V_49 [ 8 ] ;
...
static int F_132 ( struct V_32 * V_23 , T_3 V_214 ,
void * V_2 , T_7 V_51 )
{
...
return - V_16 ;
V_50 = F_133 ( V_44 , 0 ) ;
V_12 = F_134 ( V_44 , V_50 , V_214 , V_217 | V_218 ,
0 , 0 , V_49 , V_51 , V_219 ) ;
if ( V_12 < 0 ) {
...
static int F_135 ( struct V_32 * V_23 ,
...
V_50 = F_66 ( V_44 , 0 ) ;
V_12 = F_134 ( V_44 , V_50 , V_223 , V_217 ,
0 , 0 , V_49 , V_51 , V_219 ) ;
if ( V_12 < 0 ) {
...
V_50 = F_69 ( V_44 , 0x02 ) ;
V_12 = F_136 ( V_44 , V_50 , V_49 , V_51 , & V_13 ,
V_224 ) ;
if ( V_12 < 0 ) {
F_25 ( L_76 ,
...
char V_144 [ 64 ] ;
int V_12 ;
V_230 = F_138 ( V_142 -> V_234 ) ;
V_231 = F_138 ( V_142 -> V_235 ) ;
...
V_12 = F_135 ( V_23 , V_143 , V_227 -> V_237 ) ;
V_77:
F_99 ( V_143 ) ;
return V_12 ;
}
...
F_93 ( L_86 , V_23 -> V_34 , V_144 ) ;
V_12 = F_135 ( V_23 , V_143 , V_227 -> V_238 ) ;
F_99 ( V_143 ) ;
return V_12 ;
}
static int F_140 ( struct V_32 * V_23 )
{
...
T_3 V_35 ;
int V_62 , V_12 ;
V_12 = F_132 ( V_23 , V_239 , & V_142 ,
sizeof( V_142 ) ) ;
if ( V_12 < 0 )
return V_12 ;
V_230 = F_138 ( V_142 . V_234 ) ;
for ( V_62 = 0 ; V_62 < F_141 ( V_240 ) ; V_62 ++ ) {
...
V_12 = F_132 ( V_23 , V_241 , & V_35 ,
sizeof( V_35 ) ) ;
if ( V_12 < 0 )
return V_12 ;
if ( ! ( V_35 & V_242 ) ) {
V_12 = F_137 ( V_23 , & V_142 , V_227 ) ;
if ( V_12 < 0 )
return V_12 ;
}
if ( ! ( V_35 & V_243 ) ) {
...
static inline int F_142 ( struct V_32 * V_23 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
...
struct V_117 * V_118 ;
V_118 = & V_84 -> V_120 -> V_123 [ V_62 ] . V_121 ;
if ( ! V_2 -> V_244 && F_143 ( V_118 ) ) {
V_2 -> V_244 = V_118 ;
continue;
}
if ( ! V_2 -> V_75 && F_144 ( V_118 ) ) {
V_2 -> V_75 = V_118 ;
continue;
}
}
...
static struct V_31 * F_145 ( struct V_32 * V_23 , bool V_245 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_10 * V_11 ;
struct V_31 * V_31 ;
...
F_106 ( V_11 , 0xf0 ) ;
F_106 ( V_11 , V_245 ) ;
V_50 = F_69 ( V_2 -> V_44 , V_2 -> V_244 -> V_54 ) ;
F_40 ( V_31 , V_2 -> V_44 , V_50 ,
V_11 -> V_2 , V_11 -> V_13 , F_48 , V_11 ) ;
V_11 -> V_76 = ( void * ) V_23 ;
return V_31 ;
}
static int F_146 ( struct V_32 * V_23 , bool V_245 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_31 * V_31 ;
if ( ! V_2 -> V_89 )
...
if ( ! F_24 ( V_37 , & V_23 -> V_3 ) )
return - V_246 ;
V_31 = F_145 ( V_23 , V_245 ) ;
if ( F_76 ( V_31 ) )
return F_77 ( V_31 ) ;
return F_73 ( V_23 , V_31 ) ;
}
static T_10 F_147 ( int V_247 , void * V_248 )
{
struct V_1 * V_2 = V_248 ;
F_148 ( & V_2 -> V_44 -> V_76 , 0 ) ;
F_149 () ;
if ( F_86 ( V_249 , & V_2 -> V_3 ) ) {
F_150 ( V_247 ) ;
F_151 ( V_247 ) ;
}
return V_250 ;
}
static int F_152 ( struct V_32 * V_23 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_208 * V_76 = & V_2 -> V_44 -> V_76 ;
int V_247 , V_145 ;
...
if ( ! F_153 ( V_251 , V_76 ) )
return 0 ;
V_247 = F_154 ( V_76 -> V_211 , L_89 ) ;
if ( V_247 <= 0 ) {
F_155 ( V_23 , L_90 , V_212 ) ;
return 0 ;
}
V_145 = F_156 ( & V_23 -> V_76 , V_247 , F_147 ,
0 , L_91 , V_2 ) ;
if ( V_145 ) {
F_129 ( V_23 , L_92 , V_212 ) ;
return V_145 ;
}
V_145 = F_157 ( V_76 , true ) ;
if ( V_145 ) {
F_129 ( V_23 , L_93 , V_212 ) ;
return V_145 ;
}
V_2 -> V_252 = V_247 ;
F_158 ( V_247 ) ;
F_159 ( V_23 , L_94 , V_247 ) ;
return 0 ;
}
static int F_160 ( struct V_115 * V_84 ,
...
struct V_216 * V_44 = F_162 ( V_84 ) ;
if ( F_32 ( V_44 -> V_263 . V_264 ) <= 0x0001 )
return - V_47 ;
}
V_2 = F_163 ( & V_84 -> V_76 , sizeof( * V_2 ) , V_87 ) ;
if ( ! V_2 )
return - V_16 ;
for ( V_62 = 0 ; V_62 < V_84 -> V_120 -> V_121 . V_122 ; V_62 ++ ) {
V_118 = & V_84 -> V_120 -> V_123 [ V_62 ] . V_121 ;
if ( ! V_2 -> V_52 && F_164 ( V_118 ) ) {
V_2 -> V_52 = V_118 ;
continue;
}
if ( ! V_2 -> V_103 && F_143 ( V_118 ) ) {
V_2 -> V_103 = V_118 ;
continue;
}
if ( ! V_2 -> V_61 && F_144 ( V_118 ) ) {
V_2 -> V_61 = V_118 ;
continue;
}
}
...
if ( V_12 )
goto V_278;
if ( V_254 -> V_257 & V_279 && V_2 -> V_252 ) {
V_12 = F_126 ( V_23 ) ;
if ( V_12 )
goto V_278;
}
...
V_23 -> V_283 = F_88 ;
#ifdef F_172
if ( V_254 -> V_257 & V_284 ) {
V_23 -> V_135 = 15 ;
V_23 -> V_283 = V_285 ;
V_23 -> V_286 = F_146 ;
V_23 -> V_287 = V_288 ;
V_2 -> V_89 = F_173 ( V_2 -> V_44 , V_255 + 2 ) ;
}
if ( V_254 -> V_257 & V_289 ) {
V_23 -> V_135 = 15 ;
V_23 -> V_283 = V_290 ;
V_23 -> V_286 = F_146 ;
V_2 -> V_89 = F_173 ( V_2 -> V_44 , V_255 + 2 ) ;
...
#endif
if ( V_254 -> V_257 & V_291 ) {
V_23 -> V_135 = 2 ;
V_23 -> V_283 = F_96 ;
V_23 -> V_292 = F_125 ;
V_23 -> V_286 = V_293 ;
V_23 -> V_287 = V_294 ;
F_55 ( V_295 , & V_23 -> V_138 ) ;
F_55 ( V_296 , & V_23 -> V_138 ) ;
F_55 ( V_297 , & V_23 -> V_138 ) ;
}
if ( V_254 -> V_257 & V_267 ) {
V_23 -> V_135 = 2 ;
V_23 -> V_276 = F_113 ;
...
if ( V_254 -> V_257 & V_279 )
V_23 -> V_287 = F_130 ;
if ( V_254 -> V_257 & V_301 ) {
F_55 ( V_302 , & V_23 -> V_138 ) ;
F_55 ( V_303 , & V_23 -> V_138 ) ;
}
if ( V_254 -> V_257 & V_304 ) {
V_23 -> V_135 = 2 ;
F_55 ( V_305 , & V_23 -> V_138 ) ;
}
if ( V_254 -> V_257 & V_262 ) {
V_23 -> V_287 = F_131 ;
F_55 ( V_296 , & V_23 -> V_138 ) ;
...
V_2 -> V_116 = F_173 ( V_2 -> V_44 , V_255 + 1 ) ;
}
if ( ! V_310 )
F_55 ( V_137 , & V_23 -> V_138 ) ;
if ( V_311 || V_254 -> V_257 & V_312 ) {
if ( ! V_313 )
F_55 ( V_314 , & V_23 -> V_138 ) ;
}
if ( V_254 -> V_257 & V_315 )
V_2 -> V_116 = NULL ;
...
T_7 V_264 = F_32 ( V_44 -> V_263 . V_264 ) ;
if ( V_264 < 0x117 )
F_55 ( V_137 , & V_23 -> V_138 ) ;
if ( V_264 <= 0x100 || V_264 == 0x134 )
V_23 -> V_283 = F_90 ;
F_55 ( V_296 , & V_23 -> V_138 ) ;
}
if ( V_254 -> V_257 & V_318 ) {
struct V_216 * V_44 = V_2 -> V_44 ;
if ( F_32 ( V_44 -> V_263 . V_264 ) > 0x997 )
F_55 ( V_305 , & V_23 -> V_138 ) ;
}
if ( V_254 -> V_257 & V_304 ) {
...
static void F_179 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_180 ( V_84 ) ;
struct V_32 * V_23 ;
F_23 ( L_97 , V_84 ) ;
if ( ! V_2 )
return;
...
F_177 ( V_2 -> V_84 , NULL ) ;
if ( V_2 -> V_116 )
F_177 ( V_2 -> V_116 , NULL ) ;
if ( V_2 -> V_89 )
F_177 ( V_2 -> V_89 , NULL ) ;
F_181 ( V_23 ) ;
if ( V_84 == V_2 -> V_84 ) {
if ( V_2 -> V_116 )
F_182 ( & V_319 , V_2 -> V_116 ) ;
if ( V_2 -> V_89 )
F_182 ( & V_319 , V_2 -> V_89 ) ;
} else if ( V_84 == V_2 -> V_116 ) {
if ( V_2 -> V_89 )
F_182 ( & V_319 , V_2 -> V_89 ) ;
F_182 ( & V_319 , V_2 -> V_84 ) ;
...
if ( V_2 -> V_252 )
F_157 ( & V_2 -> V_44 -> V_76 , false ) ;
F_178 ( V_23 ) ;
}
static int F_183 ( struct V_115 * V_84 , T_11 V_320 )
{
struct V_1 * V_2 = F_180 ( V_84 ) ;
F_23 ( L_97 , V_84 ) ;
if ( V_2 -> V_321 ++ )
...
F_58 ( V_2 ) ;
F_54 ( & V_2 -> V_93 ) ;
if ( V_2 -> V_252 && F_187 ( & V_2 -> V_44 -> V_76 ) ) {
F_55 ( V_249 , & V_2 -> V_3 ) ;
F_188 ( V_2 -> V_252 ) ;
F_189 ( V_2 -> V_252 ) ;
}
if ( F_24 ( V_309 , & V_2 -> V_3 ) &&
! F_187 ( & V_2 -> V_44 -> V_76 ) )
V_2 -> V_44 -> V_323 = 1 ;
return 0 ;
}
...
static int F_192 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_180 ( V_84 ) ;
struct V_32 * V_23 = V_2 -> V_23 ;
int V_12 = 0 ;
