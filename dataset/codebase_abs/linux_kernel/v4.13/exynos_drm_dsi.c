...
static int F_120 ( const struct V_254 * V_255 ,
const char * V_256 , T_1 * V_257 )
{
int V_213 = F_121 ( V_255 , V_256 , V_257 ) ;
if ( V_213 < 0 )
F_122 ( L_25 , V_255 -> V_258 ,
V_256 ) ;
return V_213 ;
}
static int F_123 ( struct V_1 * V_5 )
{
struct V_155 * V_13 = V_5 -> V_13 ;
struct V_254 * V_259 = V_13 -> V_223 ;
int V_213 ;
V_213 = F_120 ( V_259 , L_26 ,
& V_5 -> V_42 ) ;
if ( V_213 < 0 )
return V_213 ;
V_213 = F_120 ( V_259 , L_27 ,
& V_5 -> V_56 ) ;
if ( V_213 < 0 )
return V_213 ;
V_213 = F_120 ( V_259 , L_28 ,
& V_5 -> V_58 ) ;
if ( V_213 < 0 )
return V_213 ;
V_5 -> V_260 = F_124 ( V_259 , V_261 , 0 ) ;
return 0 ;
}
static int F_125 ( struct V_155 * V_13 , struct V_155 * V_262 ,
void * V_263 )
{
struct V_2 * V_4 = F_126 ( V_13 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
...
return V_213 ;
V_4 -> V_269 = 1 << V_213 ;
F_128 ( L_29 , V_4 -> V_269 ) ;
F_129 ( V_265 , V_4 , & V_270 ,
V_271 , NULL ) ;
F_130 ( V_4 , & V_272 ) ;
V_213 = F_114 ( V_4 ) ;
if ( V_213 ) {
...
if ( V_5 -> V_260 ) {
V_267 = F_132 ( V_5 -> V_260 ) ;
if ( V_267 )
F_133 ( V_4 , V_267 , NULL ) ;
}
return F_134 ( & V_5 -> V_273 ) ;
}
static void F_135 ( struct V_155 * V_13 , struct V_155 * V_262 ,
void * V_263 )
{
struct V_2 * V_4 = F_126 ( V_13 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
...
static int F_137 ( struct V_274 * V_275 )
{
struct V_155 * V_13 = & V_275 -> V_13 ;
struct V_276 * V_277 ;
struct V_1 * V_5 ;
int V_213 , V_278 ;
V_5 = F_138 ( V_13 , sizeof( * V_5 ) , V_279 ) ;
if ( ! V_5 )
return - V_280 ;
V_5 -> V_210 = - V_216 ;
F_67 ( & V_5 -> V_12 ) ;
...
if ( V_213 )
return V_213 ;
V_5 -> V_283 [ 0 ] . V_284 = L_31 ;
V_5 -> V_283 [ 1 ] . V_284 = L_32 ;
V_213 = F_142 ( V_13 , F_21 ( V_5 -> V_283 ) ,
V_5 -> V_283 ) ;
if ( V_213 ) {
F_143 ( V_13 , L_33 , V_213 ) ;
return - V_285 ;
}
V_5 -> V_286 = F_138 ( V_13 ,
sizeof( * V_5 -> V_286 ) * V_5 -> V_10 -> V_287 ,
V_279 ) ;
if ( ! V_5 -> V_286 )
return - V_280 ;
for ( V_278 = 0 ; V_278 < V_5 -> V_10 -> V_287 ; V_278 ++ ) {
V_5 -> V_286 [ V_278 ] = F_144 ( V_13 , V_288 [ V_278 ] ) ;
if ( F_145 ( V_5 -> V_286 [ V_278 ] ) ) {
if ( strcmp ( V_288 [ V_278 ] , L_34 ) == 0 ) {
strcpy ( V_288 [ V_278 ] , V_289 ) ;
V_278 -- ;
continue;
}
F_143 ( V_13 , L_35 ,
V_288 [ V_278 ] ) ;
return F_146 ( V_5 -> V_286 [ V_278 ] ) ;
}
}
V_277 = F_147 ( V_275 , V_290 , 0 ) ;
V_5 -> V_9 = F_148 ( V_13 , V_277 ) ;
if ( F_145 ( V_5 -> V_9 ) ) {
F_10 ( V_13 , L_36 ) ;
return F_146 ( V_5 -> V_9 ) ;
}
V_5 -> V_291 = F_149 ( V_13 , L_37 ) ;
if ( F_145 ( V_5 -> V_291 ) ) {
F_143 ( V_13 , L_38 ) ;
return F_146 ( V_5 -> V_291 ) ;
}
V_5 -> V_193 = F_150 ( V_275 , 0 ) ;
if ( V_5 -> V_193 < 0 ) {
F_10 ( V_13 , L_39 ) ;
return V_5 -> V_193 ;
}
F_84 ( V_5 -> V_193 , V_218 ) ;
V_213 = F_151 ( V_13 , V_5 -> V_193 , NULL ,
F_69 , V_292 ,
F_152 ( V_13 ) , V_5 ) ;
if ( V_213 ) {
F_10 ( V_13 , L_40 ) ;
...
F_153 ( V_275 , & V_5 -> V_4 ) ;
F_154 ( V_13 ) ;
return F_155 ( V_13 , & V_293 ) ;
}
static int F_156 ( struct V_274 * V_275 )
{
struct V_1 * V_5 = F_107 ( V_275 ) ;
F_157 ( V_5 -> V_260 ) ;
F_158 ( & V_275 -> V_13 ) ;
F_159 ( & V_275 -> V_13 , & V_293 ) ;
return 0 ;
}
static int T_7 F_160 ( struct V_155 * V_13 )
{
struct V_2 * V_4 = F_126 ( V_13 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
const struct V_23 * V_10 = V_5 -> V_10 ;
...
V_5 -> V_171 &= ~ V_172 ;
F_161 ( V_5 -> V_291 ) ;
for ( V_278 = V_10 -> V_287 - 1 ; V_278 > - 1 ; V_278 -- )
F_162 ( V_5 -> V_286 [ V_278 ] ) ;
V_213 = F_163 ( F_21 ( V_5 -> V_283 ) , V_5 -> V_283 ) ;
if ( V_213 < 0 )
F_10 ( V_5 -> V_13 , L_41 , V_213 ) ;
return 0 ;
}
static int T_7 F_164 ( struct V_155 * V_13 )
{
struct V_2 * V_4 = F_126 ( V_13 ) ;
struct V_1 * V_5 = F_1 ( V_4 ) ;
const struct V_23 * V_10 = V_5 -> V_10 ;
int V_213 , V_278 ;
V_213 = F_165 ( F_21 ( V_5 -> V_283 ) , V_5 -> V_283 ) ;
if ( V_213 < 0 ) {
F_10 ( V_5 -> V_13 , L_42 , V_213 ) ;
return V_213 ;
}
for ( V_278 = 0 ; V_278 < V_10 -> V_287 ; V_278 ++ ) {
V_213 = F_166 ( V_5 -> V_286 [ V_278 ] ) ;
if ( V_213 < 0 )
goto V_294;
}
V_213 = F_167 ( V_5 -> V_291 ) ;
if ( V_213 < 0 ) {
...
while ( -- V_278 > - 1 )
F_162 ( V_5 -> V_286 [ V_278 ] ) ;
F_163 ( F_21 ( V_5 -> V_283 ) , V_5 -> V_283 ) ;
return V_213 ;
}
