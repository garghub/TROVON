...
memcpy ( V_19 -> V_29 . V_23 ,
& ( V_21 -> V_24 . V_25 . V_26 [ 16 ] ) , 8 ) ;
memcpy ( V_19 -> V_30 . V_23 ,
& ( V_21 -> V_24 . V_25 . V_26 [ 24 ] ) , 8 ) ;
V_2 -> V_31 . V_32 = false ;
F_6 ( & V_2 -> V_31 . V_33 ,
V_34 + F_7 ( 50 ) ) ;
}
...
if ( ! F_34 ( V_6 , V_208 | V_209 ) )
return - V_217 ;
V_57 = F_16 ( & V_206 -> V_74 [ 12 ] , V_75 , & V_59 ,
V_206 -> V_76 - 12 ) ;
if ( V_57 && V_59 > 0 ) {
V_61 = true ;
V_55 = (struct V_54 * ) ( V_57 + 2 ) ;
...
&&
V_346 == V_356 )
V_349 = ( V_350 ) ? ( ( V_351 ) ? 300 : 270 ) :
( ( V_351 ) ? 144 : 130 ) ;
else
V_349 = ( V_350 ) ? ( ( V_351 ) ? 150 : 135 ) :
( ( V_351 ) ? 72 : 65 ) ;
V_349 *= 2 ;
}
