...
static int F_42 ( struct V_118 * V_119 , struct V_259 * V_260 )
{
V_119 -> V_261 . V_262 = F_43 ( V_260 ,
L_13 ) ;
V_119 -> V_261 . V_263 = F_43 ( V_260 ,
L_14 ) ;
return 0 ;
}
static int F_44 ( struct V_264 * V_265 ,
const struct V_266 * V_181 )
{
struct V_267 * V_261 = F_45 ( & V_265 -> V_2 ) ;
struct V_118 * V_119 ;
int V_230 ;
V_119 = F_46 ( & V_265 -> V_2 , sizeof( * V_119 ) ,
V_268 ) ;
if ( NULL == V_119 )
return - V_269 ;
F_47 ( V_265 , V_119 ) ;
if ( V_261 )
V_119 -> V_261 = * V_261 ;
else if ( V_265 -> V_2 . V_270 )
F_42 ( V_119 , V_265 -> V_2 . V_270 ) ;
V_119 -> V_123 = F_48 ( V_265 , & V_271 ) ;
if ( F_49 ( V_119 -> V_123 ) ) {
V_230 = F_50 ( V_119 -> V_123 ) ;
F_9 ( & V_265 -> V_2 , L_15 ,
V_230 ) ;
return V_230 ;
}
F_51 ( V_119 -> V_123 , V_19 , & V_230 ) ;
if ( V_230 != V_272 ) {
F_9 ( & V_265 -> V_2 ,
L_16 , V_230 ) ;
return - V_273 ;
...
V_230 = F_52 ( V_119 -> V_123 , V_274 ,
F_2 ( V_274 ) ) ;
if ( V_230 != 0 )
F_53 ( & V_265 -> V_2 , L_17 , V_230 ) ;
if ( V_119 -> V_261 . V_262 )
F_14 ( V_119 -> V_123 , V_24 ,
V_275 , V_275 ) ;
if ( V_119 -> V_261 . V_263 )
F_14 ( V_119 -> V_123 , V_90 ,
V_276 , V_277 ) ;
V_119 -> V_163 = 1 ;
V_230 = F_54 ( & V_265 -> V_2 , & V_278 ,
V_279 , F_2 ( V_279 ) ) ;
return V_230 ;
}
static int F_55 ( struct V_264 * V_265 )
{
F_56 ( & V_265 -> V_2 ) ;
return 0 ;
}
