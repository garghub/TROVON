...
if ( V_114 )
V_2 -> V_10 = V_114 -> V_29 ;
V_2 -> V_86 = F_59 ( & V_103 -> V_39 , V_2 -> V_10 -> V_11 ,
sizeof( * V_2 -> V_86 ) , V_117 ) ;
if ( ! V_2 -> V_86 )
return F_44 ( - V_118 ) ;
V_7 = 0 ;
do {
void T_3 * V_120 ;
V_116 = F_60 ( V_103 , V_121 , V_7 ) ;
if ( ! V_116 )
break;
V_120 = F_61 ( & V_103 -> V_39 , V_116 ) ;
if ( V_7 == 0 )
V_2 -> V_4 = V_120 ;
if ( F_25 ( V_120 ) )
return F_62 ( V_120 ) ;
...
V_2 -> V_124 = F_67 ( NULL , V_2 -> V_10 -> V_125 ) ;
if ( F_25 ( V_2 -> V_124 ) ) {
F_23 ( & V_103 -> V_39 , L_22 ) ;
V_57 = F_66 ( V_2 -> V_124 ) ;
goto V_126;
}
V_2 -> V_127 = F_67 ( NULL , V_2 -> V_10 -> V_128 ) ;
if ( F_25 ( V_2 -> V_127 ) ) {
...
static int F_81 ( struct V_154 * V_39 )
{
struct V_1 * V_2 = F_82 ( V_39 ) ;
int V_63 ;
V_63 = F_79 ( V_2 ) ;
F_5 ( V_2 , false ) ;
if ( F_6 ( V_2 , V_135 ) )
...
static int F_83 ( struct V_154 * V_39 )
{
struct V_1 * V_2 = F_82 ( V_39 ) ;
if ( F_6 ( V_2 , V_135 ) )
F_71 ( V_2 -> V_124 ) ;
