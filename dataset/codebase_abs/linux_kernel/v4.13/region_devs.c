...
{
unsigned int V_108 , V_30 ;
V_108 = F_98 () ;
if ( V_22 -> V_109 < V_110 ) {
struct V_111 * V_112 , * V_113 ;
V_30 = V_108 % V_22 -> V_109 ;
V_113 = F_99 ( V_22 -> V_30 , V_108 ) ;
V_112 = F_99 ( V_22 -> V_30 , V_30 ) ;
if ( V_113 -> V_114 ++ == 0 )
F_100 ( & V_112 -> V_98 ) ;
} else
V_30 = V_108 ;
...
unsigned int V_7 ;
int V_74 = 0 ;
for ( V_7 = 0 ; V_7 < V_116 -> V_121 ; V_7 ++ ) {
struct V_122 * V_26 = & V_116 -> V_26 [ V_7 ] ;
struct V_3 * V_3 = V_26 -> V_3 ;
if ( ( V_26 -> V_15 | V_26 -> V_51 ) % V_123 ) {
F_105 ( & V_100 -> V_2 , L_12 ,
V_119 , F_57 ( & V_3 -> V_2 ) , V_7 ) ;
return NULL ;
}
if ( F_33 ( V_124 , & V_3 -> V_44 ) )
V_74 = 1 ;
}
if ( V_118 == & V_34 ) {
struct V_125 * V_126 ;
...
if ( V_39 ) {
V_22 = & V_39 -> V_22 ;
V_39 -> F_96 = V_126 -> F_96 ;
V_39 -> V_127 = V_126 -> V_127 ;
}
V_120 = V_39 ;
} else {
...
if ( V_22 -> V_32 < 0 )
goto V_128;
V_22 -> V_30 = F_109 ( struct V_111 ) ;
if ( ! V_22 -> V_30 )
goto V_129;
for ( V_7 = 0 ; V_7 < V_110 ; V_7 ++ ) {
struct V_111 * V_130 ;
V_130 = F_99 ( V_22 -> V_30 , V_7 ) ;
F_110 ( & V_130 -> V_98 ) ;
V_130 -> V_114 = 0 ;
}
for ( V_7 = 0 ; V_7 < V_116 -> V_121 ; V_7 ++ ) {
...
F_111 ( & V_22 -> V_26 [ V_7 ] . V_131 ) ;
F_112 ( & V_22 -> V_26 [ V_7 ] . V_98 ) ;
F_113 ( & V_3 -> V_2 ) ;
}
V_22 -> V_24 = V_116 -> V_121 ;
V_22 -> V_38 = V_116 -> V_38 ;
V_22 -> V_57 = V_116 -> V_57 ;
V_22 -> V_109 = V_116 -> V_109 ;
V_22 -> V_44 = V_116 -> V_44 ;
V_22 -> V_74 = V_74 ;
V_22 -> V_132 = V_116 -> V_132 ;
F_114 ( & V_22 -> V_133 ) ;
F_114 ( & V_22 -> V_134 ) ;
F_114 ( & V_22 -> V_135 ) ;
F_114 ( & V_22 -> V_136 ) ;
...
V_2 -> V_103 = & V_100 -> V_2 ;
V_2 -> type = V_118 ;
V_2 -> V_137 = V_116 -> V_138 ;
V_22 -> V_52 = F_116 ( V_116 -> V_12 ) ;
V_22 -> V_76 = V_116 -> V_12 -> V_15 ;
F_117 ( V_2 ) ;
return V_22 ;
V_129:
F_20 ( & V_31 , V_22 -> V_32 ) ;
...
if ( V_116 -> V_121 > 1 )
return NULL ;
V_116 -> V_109 = F_120 ( V_116 -> V_109 , V_139 ) ;
return F_104 ( V_100 , V_116 , & V_34 ,
V_140 ) ;
}
...
int V_7 , V_141 ;
V_141 = F_122 ( V_142 ) ;
V_141 = F_123 ( V_142 , F_124 ( V_143 -> V_144 + V_141 , 8 ) ) ;
F_125 () ;
for ( V_7 = 0 ; V_7 < V_22 -> V_24 ; V_7 ++ )
if ( F_5 ( V_6 , V_7 , 0 ) )
F_126 ( 1 , F_5 ( V_6 , V_7 , V_141 ) ) ;
F_125 () ;
}
