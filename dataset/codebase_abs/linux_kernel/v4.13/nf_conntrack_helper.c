...
struct V_39 * V_42 = F_33 ( exp -> V_87 ) ;
if ( ( F_65 (
V_42 -> V_29 ,
F_66 ( & V_57 )
) == V_37 || exp -> V_29 == V_37 ) )
...
T_1 V_88 , T_1 V_89 , T_5 V_90 ,
const struct V_91 * V_92 ,
T_5 V_72 ,
int (* V_42)( struct V_64 * V_65 , unsigned int V_93 ,
struct V_40 * V_8 ,
enum V_94 V_95 ) ,
int (* F_70)( struct V_96 * V_97 ,
struct V_40 * V_8 ) ,
struct V_98 * V_98 )
{
V_29 -> V_18 . V_19 . V_20 = V_20 ;
V_29 -> V_18 . V_21 . V_22 = V_22 ;
V_29 -> V_18 . V_19 . V_25 . V_26 = F_10 ( V_89 ) ;
V_29 -> V_71 = V_92 ;
V_29 -> V_72 = V_72 ;
V_29 -> V_42 = V_42 ;
V_29 -> F_70 = F_70 ;
...
snprintf ( V_29 -> V_34 , sizeof( V_29 -> V_34 ) , L_11 , V_34 , V_90 ) ;
}
