...
struct V_143 * V_149 = F_95 ( V_144 , L_9 , V_39 ) ;
V_40 = F_96 ( V_149 , 0 , & V_142 ) ;
F_97 ( V_149 ) ;
if ( V_40 ) {
F_93 ( V_100 , L_10 ) ;
goto V_150;
...
V_148 = F_98 ( & V_142 ) ;
V_134 -> V_22 = F_99 ( V_100 , V_142 . V_151 , V_148 ) ;
if ( ! V_134 -> V_22 ) {
F_93 ( V_100 , L_11 ) ;
V_40 = - V_152 ;
goto V_150;
}
V_134 -> V_33 = V_134 -> V_22 + ( V_148 >> 1 ) ;
V_31 -> V_100 = V_100 ;
V_31 -> V_153 = F_16 ;
V_31 -> V_154 = F_18 ;
V_31 -> V_155 = true ;
...
V_125 . V_160 = F_41 ;
V_15 -> V_42 = V_161 ;
for ( V_39 = 0 ; V_39 < F_104 ( V_162 ) ; V_39 ++ )
F_105 ( V_162 [ V_39 ] ,
V_15 -> V_44 ) ;
}
V_40 = F_69 ( V_15 ) ;
