...
int vsnprintf ( char * string , T_1 V_32 , const char * V_33 , T_6 args )
{
T_4 V_6 ;
T_4 type ;
T_5 V_17 ;
...
int snprintf ( char * string , T_1 V_32 , const char * V_33 , ... )
{
T_6 args ;
int V_2 ;
va_start ( args , V_33 ) ;
V_2 = vsnprintf ( string , V_32 , V_33 , args ) ;
va_end ( args ) ;
return ( V_2 ) ;
}
int sprintf ( char * string , const char * V_33 , ... )
{
T_6 args ;
int V_2 ;
va_start ( args , V_33 ) ;
V_2 = vsnprintf ( string , V_39 , V_33 , args ) ;
va_end ( args ) ;
return ( V_2 ) ;
}
int vprintf ( const char * V_33 , T_6 args )
{
T_7 V_40 ;
int V_2 ;
V_40 = F_10 ( V_41 ) ;
...
( void ) fwrite ( V_42 , V_2 , 1 , V_43 ) ;
F_11 ( V_41 , V_40 ) ;
return ( V_2 ) ;
}
int printf ( const char * V_33 , ... )
{
T_6 args ;
int V_2 ;
va_start ( args , V_33 ) ;
V_2 = vprintf ( V_33 , args ) ;
va_end ( args ) ;
return ( V_2 ) ;
}
int vfprintf ( T_8 * V_44 , const char * V_33 , T_6 args )
{
T_7 V_40 ;
int V_2 ;
V_40 = F_10 ( V_41 ) ;
V_2 = vsnprintf ( V_42 ,
sizeof( V_42 ) , V_33 , args ) ;
( void ) fwrite ( V_42 , V_2 , 1 , V_44 ) ;
F_11 ( V_41 , V_40 ) ;
return ( V_2 ) ;
}
int fprintf ( T_8 * V_44 , const char * V_33 , ... )
{
T_6 args ;
int V_2 ;
va_start ( args , V_33 ) ;
V_2 = vfprintf ( V_44 , V_33 , args ) ;
va_end ( args ) ;
return ( V_2 ) ;
}
