...
goto V_50;
F_14 ( 2000 , 3000 ) ;
V_9 = F_3 ( V_5 , 0x01 , 0x1c ) ;
if ( V_9 < 0 )
goto V_50;
V_9 = F_5 ( V_5 , 0x00 , & V_7 ) ;
if ( V_9 < 0 )
goto V_50;
for ( V_51 = 0 ; V_51 < V_52 ;
V_51 ++ ) {
if ( V_7 == V_53 [ V_51 ] [ 0x00 ] )
break;
}
if ( V_51 >= V_52 )
goto V_50;
memcpy ( V_5 -> V_21 , V_53 [ V_51 ] , V_54 ) ;
F_14 ( 2000 , 3000 ) ;
V_5 -> V_21 [ 0x0c ] |= 0x40 ;
...
const struct V_57 * V_27 )
{
struct V_1 * V_5 ;
struct V_2 * V_4 ;
struct V_28 * V_24 ;
V_5 = F_19 ( sizeof( * V_5 ) , V_58 ) ;
if ( ! V_5 )
return - V_59 ;
V_5 -> V_10 = V_56 ;
V_4 = V_56 -> V_22 . V_60 ;
...
V_24 -> V_30 = V_5 ;
F_11 ( V_24 , V_4 ) ;
memcpy ( & V_24 -> V_61 . V_62 , & V_63 , sizeof( V_63 ) ) ;
F_20 ( V_56 , & V_5 -> V_4 ) ;
F_21 ( & V_56 -> V_22 , L_3 ) ;
return 0 ;
}
