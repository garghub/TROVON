...
V_38 = F_18 ( V_39 , V_34 -> V_24 . V_28 ) ;
if ( ! V_38 )
return - V_40 ;
V_2 = V_38 -> V_25 ;
V_31 = F_19 ( & V_34 -> V_24 , sizeof( * V_31 ) , V_41 ) ;
if ( ! V_31 )
return - V_42 ;
V_31 -> V_24 = & V_34 -> V_24 ;
V_36 = F_20 ( V_34 , V_43 , L_2 ) ;
V_31 -> V_17 = F_21 ( & V_34 -> V_24 , V_36 ) ;
if ( F_22 ( V_31 -> V_17 ) )
return F_23 ( V_31 -> V_17 ) ;
V_36 = F_20 ( V_34 , V_43 , L_3 ) ;
V_31 -> V_12 = F_21 ( & V_34 -> V_24 , V_36 ) ;
if ( F_22 ( V_31 -> V_12 ) )
return F_23 ( V_31 -> V_12 ) ;
F_24 ( & V_31 -> V_11 ) ;
V_31 -> V_2 = * V_2 ;
F_25 ( V_31 -> V_24 , V_31 ) ;
return 0 ;
