...
T_4 V_153 ;
F_64 ( V_2 , V_2 -> V_23 [ V_16 ] . V_151 , V_16 ) ;
V_153 = F_65 ( V_2 , V_140 , V_16 ) ;
if ( V_153 >= 0 )
memcpy ( V_2 -> V_23 [ V_16 ] . V_151 , V_140 ,
V_146 ) ;
else
memset ( V_2 -> V_23 [ V_16 ] . V_151 , 0 , V_146 ) ;
return V_153 ;
}
...
! F_83 ( V_2 -> V_23 [ V_16 ] . V_151 , V_174 ) ) {
F_82 ( V_119 ,
L_13
L_14 ,
V_16 ) ;
...
struct V_4 * V_5 = & V_2 -> V_5 ;
T_4 V_153 ;
V_153 = F_94 ( V_5 , V_78 , V_204 , V_16 ) ;
if ( V_153 ) {
F_95 ( L_20 ) ;
return V_153 ;
}
...
case V_206 :
V_153 = F_80 ( V_2 , V_78 , V_16 ) ;
break;
case V_207 :
V_153 = F_39 ( V_2 , V_78 , V_16 ) ;
break;
case V_208 :
V_153 = F_84 ( V_2 , V_78 , V_16 ) ;
break;
case V_209 :
V_153 = F_50 ( V_2 , V_78 , V_16 ) ;
break;
case V_210 :
V_153 = F_85 ( V_2 , V_78 , V_16 ) ;
break;
case V_211 :
V_153 = F_86 ( V_2 , V_78 , V_16 ) ;
break;
case V_212 :
V_153 = F_87 ( V_2 , V_78 , V_16 ) ;
break;
case V_213 :
V_153 = F_89 ( V_2 , V_78 , V_16 ) ;
break;
case V_214 :
V_153 = F_91 ( V_2 , V_78 , V_16 ) ;
break;
case V_215 :
V_153 = F_92 ( V_2 , V_78 , V_16 ) ;
break;
default:
...
V_153 = F_64 ( V_2 , V_223 , V_16 ) ;
if ( V_153 >= 0 ) {
V_2 -> V_23 [ V_16 ] . V_175 = false ;
memcpy ( V_223 , V_10 , V_146 ) ;
} else {
...
F_71 ( V_2 , V_16 , V_167 |
V_227 ) ;
V_2 -> V_23 [ V_16 ] . V_147 = V_224 ;
V_2 -> V_23 [ V_16 ] . V_148 = V_225 ;
F_106 ( & V_2 -> V_47 -> V_58 ,
...
V_5 -> V_10 . V_97 . V_150 ( V_5 , V_252 , V_16 ) ;
...
return - V_118 ;
V_261 -> V_16 = V_16 ;
memcpy ( & V_261 -> V_10 , V_2 -> V_23 [ V_16 ] . V_151 , V_146 ) ;
V_261 -> V_250 = V_2 -> V_23 [ V_16 ] . V_238 ;
V_261 -> V_249 = 0 ;
V_261 -> V_224 = V_2 -> V_23 [ V_16 ] . V_147 ;
V_261 -> V_225 = V_2 -> V_23 [ V_16 ] . V_148 ;
