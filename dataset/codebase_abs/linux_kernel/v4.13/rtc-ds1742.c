...
void T_1 * V_9 ;
int V_59 = 0 ;
V_8 = F_15 ( & V_6 -> V_2 , sizeof( * V_8 ) , V_60 ) ;
if ( ! V_8 )
return - V_61 ;
V_56 = F_16 ( V_6 , V_62 , 0 ) ;
V_9 = F_17 ( & V_6 -> V_2 , V_56 ) ;
if ( F_18 ( V_9 ) )
return F_19 ( V_9 ) ;
V_8 -> V_51 = V_9 ;
V_8 -> V_63 = F_20 ( V_56 ) - V_64 ;
V_8 -> V_10 = V_9 + V_8 -> V_63 ;
F_21 ( & V_8 -> V_65 ) ;
V_8 -> V_65 . V_66 . V_67 = L_1 ;
V_8 -> V_65 . V_66 . V_68 = V_69 | V_70 ;
V_8 -> V_65 . V_71 = F_11 ;
V_8 -> V_65 . V_72 = F_13 ;
V_8 -> V_65 . V_50 = V_8 -> V_63 ;
V_9 = V_8 -> V_10 ;
V_58 = F_8 ( V_9 + V_29 ) ;
if ( V_58 & V_73 ) {
V_58 &= V_28 ;
V_57 = F_8 ( V_9 + V_31 ) & V_30 ;
F_5 ( V_13 , V_9 + V_14 ) ;
F_5 ( V_58 , V_9 + V_29 ) ;
F_5 ( V_57 & V_30 , V_9 + V_14 ) ;
}
if ( ! ( F_8 ( V_9 + V_20 ) & V_74 ) )
F_22 ( & V_6 -> V_2 , L_2 ) ;
V_8 -> V_39 = V_40 ;
F_23 ( V_6 , V_8 ) ;
V_54 = F_24 ( & V_6 -> V_2 , V_6 -> V_67 ,
& V_75 , V_76 ) ;
if ( F_18 ( V_54 ) )
return F_19 ( V_54 ) ;
V_59 = F_25 ( & V_6 -> V_2 . V_45 , & V_8 -> V_65 ) ;
if ( V_59 )
F_26 ( & V_6 -> V_2 , L_3 ,
V_8 -> V_65 . V_66 . V_67 ) ;
return 0 ;
