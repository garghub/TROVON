...
V_53 -> V_96 = F_27 ;
F_34 ( & V_53 -> V_55 ) ;
F_43 ( & V_53 -> V_55 , & V_53 -> V_97 ) ;
if ( V_91 == V_92 )
V_53 -> V_44 = V_98 ;
F_44 ( & V_53 -> V_99 , & V_100 ) ;
F_13 ( V_90 L_20 , V_72 ,
...
V_53 -> V_158 = 1 ;
V_53 -> V_62 = V_65 ;
if ( V_53 -> V_94 && ( V_115 = V_53 -> V_94 ( V_53 ) ) != 0 ) {
V_53 -> V_158 = 0 ;
F_26 ( & V_53 -> V_55 ) ;
return V_115 ;
}
...
V_115 = V_53 -> V_96 ( V_53 , V_56 , V_57 , V_58 , V_37 , V_31 ) ;
#ifdef F_80
if ( V_115 )
F_79 ( L_40 , V_115 ) ;
#endif
...
V_53 -> V_192 -> V_154 . V_195 = V_53 -> V_92 ;
F_109 ( V_53 -> V_192 ) ;
}
F_81 ( F_98 ) ;
return 0 ;
