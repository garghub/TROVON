...
int V_21 ;
V_27 -> V_51 = V_52 ;
for ( V_21 = 0 ; V_21 < F_6 ( V_99 ) ; V_21 ++ )
F_10 ( V_6 , V_99 [ V_21 ] , 0x100 , 0x100 ) ;
return 0 ;
}
...
struct V_26 * V_27 ;
int V_44 ;
V_27 = F_30 ( & V_101 -> V_2 , sizeof( struct V_26 ) ,
V_104 ) ;
if ( V_27 == NULL )
return - V_105 ;
V_27 -> V_98 = F_31 ( V_101 , & V_106 ) ;
if ( F_32 ( V_27 -> V_98 ) ) {
V_44 = F_33 ( V_27 -> V_98 ) ;
F_34 ( & V_101 -> V_2 , L_14 , V_44 ) ;
return V_44 ;
}
F_35 ( V_101 , V_27 ) ;
V_44 = F_36 ( V_27 -> V_98 , V_4 , 0 ) ;
if ( V_44 != 0 ) {
F_34 ( & V_101 -> V_2 , L_15 , V_44 ) ;
return V_44 ;
}
V_44 = F_37 ( & V_101 -> V_2 ,
& V_107 , & V_108 , 1 ) ;
if ( V_44 != 0 ) {
F_34 ( & V_101 -> V_2 , L_16 , V_44 ) ;
return V_44 ;
}
return 0 ;
}
static int F_38 ( struct V_100 * V_109 )
{
F_39 ( & V_109 -> V_2 ) ;
return 0 ;
}
