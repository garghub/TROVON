...
F_26 ( V_53 , V_74 , V_52 ) ;
V_52 += V_75 ;
F_26 ( V_53 , V_76 , V_52 - 1 ) ;
V_32 -> V_55 [ V_32 -> V_77 ] = F_27 ( V_32 -> V_35 , V_53 ) ;
if ( F_18 ( V_32 -> V_55 [ V_32 -> V_77 ] ) )
goto V_19;
V_32 -> V_77 ++ ;
memset ( V_53 , 0 , V_49 ) ;
F_26 ( V_53 , V_74 , V_52 ) ;
...
return 0 ;
V_19:
V_19 = F_19 ( V_32 -> V_55 [ V_32 -> V_77 ] ) ;
V_32 -> V_55 [ V_32 -> V_77 ] = NULL ;
V_47:
F_20 ( V_53 ) ;
return V_19 ;
}
