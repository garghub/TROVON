...
V_38 . V_169 = V_169 ;
V_38 . V_285 = 0 ;
V_278 = V_273 -> V_286 . V_287 -> V_288 ;
V_38 . V_122 = F_83 ( V_278 ) ;
V_38 . V_78 = V_2 -> V_248 . V_42 ;
V_38 . V_289 = V_2 -> V_248 . V_250 ;
V_280 = V_273 -> V_18 ;
V_279 = V_273 -> V_290 & 0x0ffffffff ;
if ( V_2 -> V_291 > V_279 && V_281 ) {
if ( V_280 >
( ( V_2 -> V_291 - V_279 ) / V_281 ) ) {
V_280 -=
( V_2 -> V_291 - V_279 ) / V_281 ;
} else
V_280 = 0 ;
...
if ( V_280 <= 1 )
V_38 . V_292 = F_60 ( V_2 -> V_291 ) ;
else {
V_276 =
V_284 -> V_293 . V_294 * V_280 * V_295 ;
V_277 =
F_84 ( V_2 , V_276 ,
V_281 ) ;
V_38 . V_292 =
...
return F_42 ( V_2 , V_297 , sizeof( V_38 ) , & V_38 ) ;
}
static void
F_87 ( struct V_1 * V_2 , struct V_298 * V_299 ,
T_3 V_300 )
{
struct V_301 * V_302 = V_2 -> V_303 . V_32 ;
int V_304 = V_299 -> V_305 . V_39 ;
int V_306 = V_299 -> V_305 . V_306 ;
int V_4 = V_300 + V_307 + V_308 ;
T_8 V_309 ;
F_88 ( V_4 > 0xFFF || V_306 >= V_310 ) ;
V_309 = F_83 ( V_4 & 0xFFF ) ;
V_302 [ V_304 ] . V_311 [ V_306 ] = V_309 ;
if ( V_306 < V_312 )
V_302 [ V_304 ] . V_311 [ V_310 + V_306 ] =
V_309 ;
}
static int
F_31 ( struct V_1 * V_2 )
...
T_6 V_76 ;
T_6 V_313 ;
T_6 V_314 , V_315 , V_316 ;
T_2 V_317 ;
if ( F_63 ( V_318 , & V_2 -> V_237 ) &&
( V_2 -> V_319 . V_320 . V_321 & V_322 ) ) {
F_89 ( L_64 ) ;
V_314 = ( T_6 ) F_5 ( V_2 -> V_212 . V_323 [ 1 ] ) ;
V_315 = ( T_6 ) F_5 ( V_2 -> V_212 . V_324 [ 1 ] ) ;
V_316 = ( T_6 ) F_5 ( V_2 -> V_212 . V_325 [ 1 ] ) ;
V_317 = F_5 ( V_2 -> V_212 . V_326 [ 1 ] ) ;
} else {
F_89 ( L_65 ) ;
V_314 = ( T_6 ) F_5 ( V_2 -> V_212 . V_323 [ 0 ] ) ;
V_315 = ( T_6 ) F_5 ( V_2 -> V_212 . V_324 [ 0 ] ) ;
V_316 = ( T_6 ) F_5 ( V_2 -> V_212 . V_325 [ 0 ] ) ;
V_317 = F_5 ( V_2 -> V_212 . V_326 [ 0 ] ) ;
}
if ( ! F_63 ( V_318 , & V_2 -> V_237 ) )
V_313 = F_90 ( V_317 , 23 ) ;
else
V_313 = F_90 ( F_5
( V_2 -> V_319 . V_320 . V_327 . V_328 . V_76 ) ,
23 ) ;
F_89 ( L_66 , V_314 , V_315 , V_316 , V_313 ) ;
if ( V_316 == V_314 ) {
F_7 ( L_67 ) ;
return - 1 ;
}
V_76 = V_329 * ( V_313 - V_315 ) ;
V_76 /= ( V_316 - V_314 ) ;
V_76 =
( V_76 * 97 ) / 100 + V_330 ;
F_89 ( L_68 , V_76 ,
...
{
int V_331 ;
if ( ! F_63 ( V_332 , & V_2 -> V_237 ) ) {
F_89 ( L_69 ) ;
return 0 ;
}
V_331 = V_2 -> V_76 - V_2 -> V_333 ;
if ( V_331 < 0 ) {
F_92 ( L_70 , V_331 ) ;
V_331 = - V_331 ;
} else if ( V_331 == 0 )
...
V_2 -> V_76 = V_335 ;
F_95 ( V_318 , & V_2 -> V_237 ) ;
if ( ! V_2 -> V_336 &&
F_96 ( ! F_63 ( V_337 , & V_2 -> V_237 ) ) &&
F_91 ( V_2 ) )
F_32 ( V_2 -> V_77 , & V_2 -> V_338 ) ;
}
static T_3
F_97 ( T_4 V_339 , T_3 V_4 )
{
switch ( V_339 ) {
case V_267 :
...
static T_3
F_98 ( const struct V_341 * V_38 , T_4 * V_41 )
{
struct V_342 * V_343 = (struct V_342 * ) V_41 ;
V_343 -> V_344 = V_38 -> V_344 ;
memcpy ( & V_343 -> V_345 , & V_38 -> V_345 , sizeof( struct V_346 ) ) ;
memcpy ( & V_343 -> V_347 , & V_38 -> V_347 , sizeof( struct V_348 ) ) ;
V_343 -> V_349 = V_38 -> V_349 ;
V_343 -> V_350 = V_38 -> V_350 ;
V_343 -> V_351 = V_38 -> V_351 ;
V_343 -> V_352 = V_38 -> V_352 ;
V_343 -> V_353 = V_38 -> V_353 ;
V_343 -> V_354 = V_38 -> V_354 ;
V_343 -> V_355 = V_38 -> V_355 ;
V_343 -> V_356 = F_83 ( 0 ) ;
V_343 -> V_357 = F_83 ( 0 ) ;
return ( T_3 ) sizeof( struct V_342 ) ;
}
static void
F_99 ( struct V_1 * V_2 )
{
...
if ( V_2 -> V_361 -> V_362 )
V_2 -> V_361 -> V_362 ( V_2 ) ;
V_2 -> V_248 . V_363 = F_83 ( V_284 -> V_293 . V_364 ) ;
F_105 ( L_81 , V_284 -> V_293 . V_364 ,
V_284 -> V_293 . V_294 ) ;
if ( V_284 -> V_293 . V_365 )
V_2 -> V_248 . V_42 |= V_366 ;
else
V_2 -> V_248 . V_42 &= ~ V_366 ;
if ( V_2 -> V_248 . V_42 & V_367 ) {
if ( V_284 -> V_293 . V_368 )
V_2 -> V_248 . V_42 |= V_369 ;
else
V_2 -> V_248 . V_42 &= ~ V_369 ;
}
F_100 ( V_2 ) ;
F_105 ( L_82 , V_284 -> V_293 . V_364 ,
V_2 -> V_240 . V_268 ) ;
switch ( V_284 -> type ) {
case V_370 :
break;
...
F_59 ( L_84
L_80 ) ;
V_2 -> V_94 . V_375 = V_2 -> V_376 . V_377 ;
F_104 ( V_2 , & V_2 -> V_360 ) ;
if ( V_2 -> V_361 -> V_362 )
V_2 -> V_361 -> V_362 ( V_2 ) ;
V_2 -> V_248 . V_363 = 0 ;
