...
static inline int F_12 ( struct V_25 * V_32 , T_5 V_33 )
{
if ( V_32 -> V_34 [ 0 ] == 0x3d800000 + ( ( V_33 + 0x8000 ) >> 16 )
&& V_32 -> V_34 [ 1 ] == 0x398c0000 + ( V_33 & 0xffff ) )
return 1 ;
return 0 ;
}
static T_2 F_13 ( void * V_35 ,
T_5 V_33 ,
const T_4 * V_15 ,
struct V_26 * V_36 )
{
struct V_25 * V_32 ;
F_8 ( L_8 , V_33 , ( unsigned int ) V_35 ) ;
if ( V_35 >= V_36 -> V_37 . V_38
&& V_35 < V_36 -> V_37 . V_38 + V_36 -> V_37 . V_12 )
V_32 = ( void * ) V_15 [ V_36 -> V_28 . V_30 ] . V_39 ;
else
V_32 = ( void * ) V_15 [ V_36 -> V_28 . V_29 ] . V_39 ;
while ( V_32 -> V_34 [ 0 ] ) {
if ( F_12 ( V_32 , V_33 ) ) return ( T_2 ) V_32 ;
V_32 ++ ;
}
V_32 -> V_34 [ 0 ] = 0x3d800000 + ( ( V_33 + 0x8000 ) >> 16 ) ;
V_32 -> V_34 [ 1 ] = 0x398c0000 + ( V_33 & 0xffff ) ;
V_32 -> V_34 [ 2 ] = 0x7d8903a6 ;
V_32 -> V_34 [ 3 ] = 0x4e800420 ;
F_8 ( L_9 , V_33 , V_32 ) ;
return ( T_2 ) V_32 ;
}
int F_14 ( T_4 * V_15 ,
...
{
unsigned int V_3 ;
T_1 * V_1 = ( void * ) V_15 [ V_42 ] . V_39 ;
T_6 * V_43 ;
T_2 * V_35 ;
T_2 V_44 ;
F_8 ( L_10 , V_42 ,
V_15 [ V_42 ] . V_45 ) ;
for ( V_3 = 0 ; V_3 < V_15 [ V_42 ] . V_24 / sizeof( * V_1 ) ; V_3 ++ ) {
V_35 = ( void * ) V_15 [ V_15 [ V_42 ] . V_45 ] . V_39
+ V_1 [ V_3 ] . V_46 ;
V_43 = ( T_6 * ) V_15 [ V_41 ] . V_39
+ F_3 ( V_1 [ V_3 ] . V_4 ) ;
V_44 = V_43 -> V_47 + V_1 [ V_3 ] . V_5 ;
...
break;
case V_52 :
* ( V_50 * ) V_35 = ( V_44 + 0x8000 ) >> 16 ;
break;
case V_7 :
if ( ( int ) ( V_44 - ( T_2 ) V_35 ) < - 0x02000000
|| ( int ) ( V_44 - ( T_2 ) V_35 ) >= 0x02000000 )
V_44 = F_13 ( V_35 , V_44 ,
V_15 , V_26 ) ;
F_8 ( L_11 ,
V_44 , ( T_2 ) V_35 ) ;
...
int F_15 ( struct V_26 * V_26 , const T_7 * V_15 )
{
V_26 -> V_28 . V_55 = F_13 ( V_26 -> V_37 . V_38 ,
( unsigned long ) V_56 ,
V_15 , V_26 ) ;
if ( ! V_26 -> V_28 . V_55 )
return - V_57 ;
