...
static int F_36 ( struct V_15 * V_16 , unsigned V_20 )
{
return - V_21 ;
}
static int F_37 ( struct V_15 * V_22 ,
const struct V_23 * V_24 , T_1 * V_25 )
{
T_1 V_26 = V_24 -> args [ 0 ] ;
if ( ( V_26 >= F_38 ( V_27 ) ||
( V_22 != & V_27 [ V_26 ] . V_16 ) ) )
return - V_19 ;
if ( V_25 )
...
{
int V_30 ;
for ( V_30 = 0 ; V_30 < F_38 ( V_27 ) ; V_30 ++ ) {
if ( V_29 -> V_31 . V_32 ) {
V_27 [ V_30 ] . V_16 . V_33 = F_37 ;
V_27 [ V_30 ] . V_16 . V_34 = 3 ;
V_27 [ V_30 ] . V_16 . V_32 = V_29 -> V_31 . V_32 ;
}
F_40 ( & V_29 -> V_31 , & V_27 [ V_30 ] . V_16 ,
& V_27 [ V_30 ] ) ;
}
return 0 ;
}
