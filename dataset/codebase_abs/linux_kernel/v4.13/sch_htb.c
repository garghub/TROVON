...
V_14 = F_1 ( F_9 ( F_10 ( V_4 -> V_2 ) , V_6 -> V_33 ) , V_4 ) ;
if ( ! V_14 || V_14 -> V_22 )
return V_21 ;
return V_14 ;
}
...
struct V_1 * V_40 ;
V_39 = * V_38 ;
V_40 = F_12 ( V_39 , struct V_1 , V_41 [ V_36 ] ) ;
if ( V_14 -> V_10 . V_32 > V_40 -> V_10 . V_32 )
V_38 = & V_39 -> V_42 ;
else
V_38 = & V_39 -> V_43 ;
}
F_13 ( & V_14 -> V_41 [ V_36 ] , V_39 , V_38 ) ;
F_14 ( & V_14 -> V_41 [ V_36 ] , V_35 ) ;
}
...
struct V_1 * V_40 ;
V_39 = * V_38 ;
V_40 = F_12 ( V_39 , struct V_1 , V_50 ) ;
if ( V_14 -> V_47 >= V_40 -> V_47 )
V_38 = & V_39 -> V_42 ;
else
V_38 = & V_39 -> V_43 ;
}
F_13 ( & V_14 -> V_50 , V_39 , V_38 ) ;
F_14 ( & V_14 -> V_50 , & V_6 -> V_45 [ V_14 -> V_22 ] . V_46 ) ;
}
static inline void F_16 ( struct V_37 * * V_51 )
{
* V_51 = F_17 ( * V_51 ) ;
}
...
int V_36 = F_19 ( ~ V_52 ) ;
V_52 &= ~ ( 1 << V_36 ) ;
F_11 ( & V_6 -> V_45 [ V_14 -> V_22 ] . V_54 [ V_36 ] . V_55 , V_14 , V_36 ) ;
}
}
static void F_20 ( struct V_37 * V_56 , struct V_34 * V_35 )
{
if ( F_21 ( V_56 ) ) {
F_22 ( 1 ) ;
} else {
...
V_52 &= ~ ( 1 << V_36 ) ;
F_11 ( & V_38 -> V_64 . V_65 . V_66 [ V_36 ] . V_67 , V_14 , V_36 ) ;
}
V_38 -> V_61 |= V_52 ;
V_14 = V_38 ;
V_38 = V_14 -> V_39 ;
...
F_30 ( struct V_1 * V_14 , T_2 * V_75 )
{
T_2 V_76 ;
if ( ( V_76 = ( V_14 -> V_77 + * V_75 ) ) < F_28 ( V_14 ) ) {
* V_75 = - V_76 ;
return V_71 ;
}
if ( ( V_76 = ( V_14 -> V_78 + * V_75 ) ) >= F_29 ( V_14 ) )
return V_68 ;
* V_75 = - V_76 ;
return V_63 ;
}
static void
F_31 ( struct V_5 * V_6 , struct V_1 * V_14 , T_2 * V_75 )
{
enum V_74 V_79 = F_30 ( V_14 , V_75 ) ;
if ( V_79 == V_14 -> V_62 )
return;
if ( V_14 -> V_61 ) {
if ( V_14 -> V_62 != V_71 )
...
{
F_22 ( V_14 -> V_22 || ! V_14 -> V_64 . V_80 . V_6 || ! V_14 -> V_64 . V_80 . V_6 -> V_6 . V_81 ) ;
if ( ! V_14 -> V_61 ) {
V_14 -> V_61 = 1 << V_14 -> V_36 ;
F_26 ( V_6 , V_14 ) ;
F_33 ( & V_14 -> V_64 . V_80 . V_82 ,
V_6 -> V_83 + V_14 -> V_36 ) ;
}
}
...
int V_91 ( V_92 ) ;
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = F_5 ( V_12 , V_4 , & V_92 ) ;
if ( V_14 == V_21 ) {
if ( V_6 -> V_93 . V_81 < V_6 -> V_94 ) {
F_36 ( V_12 , V_4 , & V_6 -> V_93 ) ;
V_6 -> V_95 ++ ;
} else {
return F_38 ( V_12 , V_4 , V_90 ) ;
}
#ifdef F_8
} else if ( ! V_14 ) {
if ( V_92 & V_25 )
...
return V_92 ;
#endif
} else if ( ( V_92 = F_41 ( V_12 , V_14 -> V_64 . V_80 . V_6 ,
V_90 ) ) != V_24 ) {
if ( F_42 ( V_92 ) ) {
F_39 ( V_4 ) ;
V_14 -> V_83 ++ ;
...
static inline void F_44 ( struct V_1 * V_14 , int V_96 , T_2 V_75 )
{
T_2 V_76 = V_75 + V_14 -> V_78 ;
if ( V_76 > V_14 -> V_73 )
V_76 = V_14 -> V_73 ;
V_76 -= ( T_2 ) F_45 ( & V_14 -> V_97 , V_96 ) ;
if ( V_76 <= - V_14 -> V_98 )
V_76 = 1 - V_14 -> V_98 ;
V_14 -> V_78 = V_76 ;
}
static inline void F_46 ( struct V_1 * V_14 , int V_96 , T_2 V_75 )
{
T_2 V_76 = V_75 + V_14 -> V_77 ;
if ( V_76 > V_14 -> V_72 )
V_76 = V_14 -> V_72 ;
V_76 -= ( T_2 ) F_45 ( & V_14 -> ceil , V_96 ) ;
if ( V_76 <= - V_14 -> V_98 )
V_76 = 1 - V_14 -> V_98 ;
V_14 -> V_77 = V_76 ;
}
...
T_2 V_75 ;
while ( V_14 ) {
V_75 = F_49 ( T_2 , V_6 -> V_48 - V_14 -> V_100 , V_14 -> V_98 ) ;
if ( V_14 -> V_22 >= V_22 ) {
if ( V_14 -> V_22 == V_22 )
V_14 -> V_101 . V_102 ++ ;
F_44 ( V_14 , V_96 , V_75 ) ;
...
if ( V_99 != V_14 -> V_62 ) {
if ( V_99 != V_68 )
F_20 ( & V_14 -> V_50 , & V_6 -> V_45 [ V_14 -> V_22 ] . V_46 ) ;
if ( V_14 -> V_62 != V_68 )
F_15 ( V_6 , V_14 , V_75 ) ;
}
if ( V_14 -> V_22 )
F_50 ( & V_14 -> V_104 , V_12 ) ;
V_14 = V_14 -> V_39 ;
}
}
...
while ( F_52 ( V_107 , V_106 ) ) {
struct V_1 * V_14 ;
T_2 V_75 ;
struct V_37 * V_38 = F_53 ( V_46 ) ;
if ( ! V_38 )
return 0 ;
V_14 = F_12 ( V_38 , struct V_1 , V_50 ) ;
if ( V_14 -> V_47 > V_6 -> V_48 )
return V_14 -> V_47 ;
F_20 ( V_38 , V_46 ) ;
V_75 = F_49 ( T_2 , V_6 -> V_48 - V_14 -> V_100 , V_14 -> V_98 ) ;
...
static struct V_37 * F_55 ( int V_36 , struct V_37 * V_51 ,
T_1 V_110 )
{
struct V_37 * V_111 = NULL ;
while ( V_51 ) {
struct V_1 * V_14 =
F_12 ( V_51 , struct V_1 , V_41 [ V_36 ] ) ;
...
static struct V_1 * F_56 ( struct V_59 * V_54 , const int V_36 )
{
int V_112 ;
struct {
struct V_37 * V_35 ;
...
* V_117 -> V_113 =
F_55 ( V_36 , V_117 -> V_35 , * V_117 -> V_114 ) ;
}
* V_117 -> V_114 = 0 ;
if ( ! * V_117 -> V_113 ) {
...
struct V_1 * V_14 ;
struct V_59 * V_118 ;
V_14 = F_12 ( * V_117 -> V_113 , struct V_1 , V_41 [ V_36 ] ) ;
if ( ! V_14 -> V_22 )
return V_14 ;
...
static struct V_11 * F_58 ( struct V_5 * V_6 , const int V_36 ,
const int V_22 )
{
...
struct V_59 * V_54 = & V_45 -> V_54 [ V_36 ] ;
V_105 = V_14 = F_56 ( V_54 , V_36 ) ;
do {
V_88:
if ( F_59 ( ! V_14 ) )
return NULL ;
if ( F_59 ( V_14 -> V_64 . V_80 . V_6 -> V_6 . V_81 == 0 ) ) {
struct V_1 * V_88 ;
F_34 ( V_6 , V_14 ) ;
...
if ( F_60 ( V_12 != NULL ) )
break;
F_61 ( L_2 , V_14 -> V_64 . V_80 . V_6 ) ;
F_16 ( V_22 ? & V_14 -> V_39 -> V_64 . V_65 . V_66 [ V_36 ] . V_60 :
& V_6 -> V_45 [ 0 ] . V_54 [ V_36 ] . V_60 ) ;
V_14 = F_56 ( V_54 , V_36 ) ;
} while ( V_14 != V_105 );
if ( F_60 ( V_12 != NULL ) ) {
F_50 ( & V_14 -> V_104 , V_12 ) ;
V_14 -> V_64 . V_80 . V_120 [ V_22 ] -= F_48 ( V_12 ) ;
...
int V_36 = F_19 ( V_57 ) ;
V_57 |= 1 << V_36 ;
V_12 = F_58 ( V_6 , V_36 , V_22 ) ;
if ( F_60 ( V_12 != NULL ) )
goto V_124;
}
}
F_67 ( V_4 ) ;
if ( F_60 ( V_122 > V_6 -> V_48 ) )
F_68 ( & V_6 -> V_128 , V_122 ) ;
else
F_69 ( & V_6 -> V_129 ) ;
V_125:
return V_12 ;
...
F_72 ( V_14 -> V_64 . V_80 . V_6 ) ;
F_73 ( & V_14 -> V_64 . V_80 . V_82 ) ;
}
V_14 -> V_61 = 0 ;
V_14 -> V_62 = V_68 ;
}
...
static void F_76 ( struct V_134 * V_129 )
{
...
static int F_81 ( struct V_3 * V_4 , struct V_136 * V_137 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
...
if ( ! V_137 )
return - V_143 ;
V_142 = F_84 ( & V_6 -> V_144 , & V_6 -> V_23 ) ;
if ( V_142 )
return V_142 ;
V_142 = F_85 ( V_138 , V_139 , V_137 , V_145 , NULL ) ;
if ( V_142 < 0 )
return V_142 ;
if ( ! V_138 [ V_146 ] )
return - V_143 ;
V_141 = F_86 ( V_138 [ V_146 ] ) ;
...
F_88 ( & V_6 -> V_93 ) ;
if ( V_138 [ V_149 ] )
V_6 -> V_94 = F_89 ( V_138 [ V_149 ] ) ;
else
V_6 -> V_94 = F_90 ( V_4 ) -> V_150 ;
if ( ( V_6 -> V_151 = V_141 -> V_151 ) < 1 )
V_6 -> V_151 = 1 ;
V_6 -> V_33 = V_141 -> V_33 ;
return 0 ;
}
static int F_91 ( struct V_3 * V_4 , struct V_11 * V_12 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_136 * V_152 ;
struct V_140 V_141 ;
...
V_141 . V_33 = V_6 -> V_33 ;
V_141 . V_153 = 0 ;
V_152 = F_92 ( V_12 , V_154 ) ;
if ( V_152 == NULL )
goto V_155;
if ( F_93 ( V_12 , V_146 , sizeof( V_141 ) , & V_141 ) ||
F_94 ( V_12 , V_149 , V_6 -> V_94 ) )
goto V_155;
return F_95 ( V_12 , V_152 ) ;
V_155:
F_96 ( V_12 , V_152 ) ;
return - 1 ;
}
static int F_97 ( struct V_3 * V_4 , unsigned long V_156 ,
...
F_98 ( & V_137 . V_97 , & V_14 -> V_97 ) ;
V_137 . V_73 = F_99 ( V_14 -> V_73 ) ;
F_98 ( & V_137 . ceil , & V_14 -> ceil ) ;
V_137 . V_72 = F_99 ( V_14 -> V_72 ) ;
V_137 . V_121 = V_14 -> V_121 ;
V_137 . V_36 = V_14 -> V_36 ;
V_137 . V_22 = V_14 -> V_22 ;
if ( F_93 ( V_12 , V_164 , sizeof( V_137 ) , & V_137 ) )
goto V_155;
if ( ( V_14 -> V_97 . V_165 >= ( 1ULL << 32 ) ) &&
F_100 ( V_12 , V_166 , V_14 -> V_97 . V_165 ,
V_167 ) )
goto V_155;
if ( ( V_14 -> ceil . V_165 >= ( 1ULL << 32 ) ) &&
F_100 ( V_12 , V_168 , V_14 -> ceil . V_165 ,
V_167 ) )
goto V_155;
return F_95 ( V_12 , V_152 ) ;
V_155:
...
static int
F_101 ( struct V_3 * V_4 , unsigned long V_156 , struct V_169 * V_170 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
struct V_171 V_172 = {
. V_83 = V_14 -> V_83 ,
...
V_14 -> V_101 . V_78 = F_102 ( T_2 , F_99 ( V_14 -> V_78 ) ,
V_173 , V_174 ) ;
V_14 -> V_101 . V_77 = F_102 ( T_2 , F_99 ( V_14 -> V_77 ) ,
V_173 , V_174 ) ;
if ( F_103 ( F_104 ( V_4 ) ,
V_170 , NULL , & V_14 -> V_104 ) < 0 ||
F_105 ( V_170 , & V_14 -> V_175 ) < 0 ||
F_106 ( V_170 , NULL , & V_172 , V_81 ) < 0 )
return - 1 ;
return F_107 ( V_170 , & V_14 -> V_101 , sizeof( V_14 -> V_101 ) ) ;
}
static int F_108 ( struct V_3 * V_4 , unsigned long V_156 , struct V_3 * V_176 ,
struct V_3 * * V_177 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
if ( V_14 -> V_22 )
return - V_143 ;
if ( V_176 == NULL &&
( V_176 = F_109 ( V_4 -> V_178 , & V_179 ,
V_14 -> V_10 . V_32 ) ) == NULL )
return - V_180 ;
* V_177 = F_110 ( V_4 , V_176 , & V_14 -> V_64 . V_80 . V_6 ) ;
return 0 ;
}
static struct V_3 * F_111 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
return ! V_14 -> V_22 ? V_14 -> V_64 . V_80 . V_6 : NULL ;
}
static void F_112 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
if ( V_14 -> V_64 . V_80 . V_6 -> V_6 . V_81 == 0 )
F_34 ( F_2 ( V_4 ) , V_14 ) ;
}
static unsigned long F_113 ( struct V_3 * V_4 , T_1 V_32 )
{
...
F_22 ( V_14 -> V_22 || ! V_14 -> V_64 . V_80 . V_6 || V_14 -> V_61 ) ;
if ( V_39 -> V_62 != V_68 )
F_20 ( & V_39 -> V_50 ,
& V_6 -> V_45 [ V_39 -> V_22 ] . V_46 ) ;
V_39 -> V_22 = 0 ;
memset ( & V_39 -> V_64 . V_65 , 0 , sizeof( V_39 -> V_64 . V_65 ) ) ;
F_73 ( & V_39 -> V_64 . V_80 . V_82 ) ;
V_39 -> V_64 . V_80 . V_6 = V_183 ? V_183 : & V_184 ;
V_39 -> V_78 = V_39 -> V_73 ;
V_39 -> V_77 = V_39 -> V_72 ;
V_39 -> V_100 = F_66 () ;
V_39 -> V_62 = V_68 ;
...
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
struct V_3 * V_183 = NULL ;
int V_186 = 0 ;
if ( V_14 -> V_182 || V_14 -> V_187 )
return - V_188 ;
if ( ! V_14 -> V_22 && F_114 ( V_14 ) ) {
V_183 = F_109 ( V_4 -> V_178 , & V_179 ,
V_14 -> V_39 -> V_10 . V_32 ) ;
V_186 = 1 ;
}
F_126 ( V_4 ) ;
...
if ( V_186 )
F_115 ( V_6 , V_14 , V_183 ) ;
F_57 ( -- V_14 -> V_181 == 0 ) ;
F_129 ( V_4 ) ;
return 0 ;
}
static void F_130 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
if ( -- V_14 -> V_181 == 0 )
F_116 ( V_4 , V_14 ) ;
}
static int F_131 ( struct V_3 * V_4 , T_1 V_32 ,
T_1 V_189 , struct V_136 * * V_190 ,
unsigned long * V_156 )
{
int V_142 = - V_143 ;
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) * V_156 , * V_39 ;
struct V_136 * V_137 = V_190 [ V_154 ] ;
struct V_136 * V_138 [ V_139 + 1 ] ;
struct V_159 * V_191 ;
T_4 V_192 , V_193 ;
if ( ! V_137 )
...
if ( V_138 [ V_164 ] == NULL )
goto V_194;
V_39 = V_189 == V_161 ? NULL : F_1 ( V_189 , V_4 ) ;
V_191 = F_86 ( V_138 [ V_164 ] ) ;
if ( ! V_191 -> V_97 . V_97 || ! V_191 -> ceil . V_97 )
goto V_194;
if ( V_191 -> V_97 . V_195 == V_196 )
F_132 ( F_133 ( & V_191 -> V_97 , V_138 [ V_197 ] ) ) ;
if ( V_191 -> ceil . V_195 == V_196 )
F_132 ( F_133 ( & V_191 -> ceil , V_138 [ V_198 ] ) ) ;
if ( ! V_14 ) {
struct V_3 * V_183 ;
int V_36 ;
struct {
...
. V_199 = {
. V_202 = F_134 ( sizeof( V_201 . V_137 ) ) ,
. V_203 = V_204 ,
} ,
. V_137 = {
. V_205 = 2 ,
...
V_142 = - V_180 ;
V_14 = F_136 ( sizeof( * V_14 ) , V_207 ) ;
if ( ! V_14 )
goto V_194;
V_142 = F_84 ( & V_14 -> V_144 , & V_14 -> V_23 ) ;
if ( V_142 ) {
F_120 ( V_14 ) ;
goto V_194;
}
if ( V_208 || V_190 [ V_204 ] ) {
V_142 = F_137 ( & V_14 -> V_104 , NULL ,
& V_14 -> V_175 ,
NULL ,
F_104 ( V_4 ) ,
V_190 [ V_204 ] ? : & V_201 . V_199 ) ;
if ( V_142 ) {
F_119 ( V_14 -> V_144 ) ;
F_120 ( V_14 ) ;
goto V_194;
...
V_14 -> V_64 . V_80 . V_6 = V_183 ? V_183 : & V_184 ;
V_14 -> V_10 . V_32 = V_32 ;
V_14 -> V_39 = V_39 ;
V_14 -> V_78 = F_138 ( V_191 -> V_73 ) ;
V_14 -> V_77 = F_138 ( V_191 -> V_72 ) ;
...
if ( V_39 )
V_39 -> V_182 ++ ;
if ( V_14 -> V_64 . V_80 . V_6 != & V_184 )
F_140 ( V_14 -> V_64 . V_80 . V_6 , true ) ;
} else {
if ( V_190 [ V_204 ] ) {
V_142 = F_141 ( & V_14 -> V_104 , NULL ,
& V_14 -> V_175 ,
NULL ,
F_104 ( V_4 ) ,
V_190 [ V_204 ] ) ;
...
V_192 = V_138 [ V_166 ] ? F_142 ( V_138 [ V_166 ] ) : 0 ;
V_193 = V_138 [ V_168 ] ? F_142 ( V_138 [ V_168 ] ) : 0 ;
F_143 ( & V_14 -> V_97 , & V_191 -> V_97 , V_192 ) ;
F_143 ( & V_14 -> ceil , & V_191 -> ceil , V_193 ) ;
if ( ! V_14 -> V_22 ) {
T_4 V_121 = V_14 -> V_97 . V_165 ;
F_144 ( V_121 , V_6 -> V_151 ) ;
V_14 -> V_121 = F_49 ( T_4 , V_121 , V_174 ) ;
if ( ! V_191 -> V_121 && V_14 -> V_121 < 1000 ) {
F_54 ( L_4 ,
V_14 -> V_10 . V_32 ) ;
V_14 -> V_121 = 1000 ;
}
if ( ! V_191 -> V_121 && V_14 -> V_121 > 200000 ) {
F_54 ( L_5 ,
V_14 -> V_10 . V_32 ) ;
V_14 -> V_121 = 200000 ;
}
if ( V_191 -> V_121 )
V_14 -> V_121 = V_191 -> V_121 ;
if ( ( V_14 -> V_36 = V_191 -> V_36 ) >= V_133 )
V_14 -> V_36 = V_133 - 1 ;
}
V_14 -> V_73 = F_138 ( V_191 -> V_73 ) ;
V_14 -> V_72 = F_138 ( V_191 -> V_72 ) ;
F_129 ( V_4 ) ;
F_145 ( V_4 , & V_6 -> V_9 ) ;
...
static struct V_209 * F_146 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
return V_14 ? V_14 -> V_144 : V_6 -> V_144 ;
}
static unsigned long F_147 ( struct V_3 * V_4 , unsigned long V_39 ,
T_1 V_32 )
{
struct V_1 * V_14 = F_1 ( V_32 , V_4 ) ;
if ( V_14 )
...
static void F_148 ( struct V_3 * V_4 , unsigned long V_156 )
{
struct V_1 * V_14 = (struct V_1 * ) V_156 ;
if ( V_14 )
V_14 -> V_187 -- ;
}
static void F_149 ( struct V_3 * V_4 , struct V_210 * V_156 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 ;
unsigned int V_112 ;
...
for ( V_112 = 0 ; V_112 < V_6 -> V_9 . V_130 ; V_112 ++ ) {
F_71 (cl, &q->clhash.hash[i], common.hnode) {
if ( V_156 -> V_212 < V_156 -> V_213 ) {
V_156 -> V_212 ++ ;
continue;
}
if ( V_156 -> V_214 ( V_4 , ( unsigned long ) V_14 , V_156 ) < 0 ) {
V_156 -> V_211 = 1 ;
return;
}
V_156 -> V_212 ++ ;
