...
struct V_55 V_56 = {} ;
struct V_57 * V_58 ;
strncpy ( V_56 . type , type , sizeof( V_56 . type ) ) ;
V_56 . V_3 = V_3 ;
V_58 = F_20 ( V_2 , & V_56 ) ;
if ( ! V_58 )
F_4 ( & V_2 -> V_35 ,
...
bool V_59 )
{
struct V_50 * V_60 = F_22 ( V_11 ) ;
int V_12 ;
#define F_23 67
if ( F_24 ( V_60 , L_14 ) && ! V_59 ) {
union V_8 V_9 ;
...
struct V_50 * V_51 ,
T_4 V_3 , char * type , int V_61 )
{
char V_62 [ 16 ] ;
if ( F_27 ( V_51 , V_62 , sizeof( V_62 ) ) >= 0 ) {
snprintf ( type , V_61 , L_16 , V_62 ) ;
return true ;
}
if ( ! strcmp ( V_51 -> V_53 , L_11 ) ) {
if ( V_3 == 0x34 ) {
snprintf ( type , V_61 , L_17 ) ;
return true ;
} else if ( V_3 == 0x35 ) {
snprintf ( type , V_61 , L_18 ) ;
return true ;
}
}
F_4 ( & V_2 -> V_35 , L_19
...
struct V_50 * V_51 ;
bool V_59 = 0 ;
if ( ! strcmp ( V_2 -> V_35 . V_63 -> V_53 , L_21 ) )
return;
...
V_56 . type , sizeof( V_56 . type ) ) ) {
continue;
}
V_56 . V_3 = V_3 ;
V_56 . V_64 = F_31 ( V_51 , 0 ) ;
V_56 . V_63 = F_32 ( V_51 ) ;
V_58 = F_20 ( V_2 , & V_56 ) ;
if ( ! V_58 ) {
F_4 ( & V_2 -> V_35 , L_24
...
snprintf ( V_42 -> V_53 , sizeof( V_42 -> V_53 ) , L_28 , V_66 ,
F_40 ( V_11 ) ) ;
F_33 ( V_65 ) ;
F_41 ( V_35 , V_42 ) ;
V_42 -> V_70 = & V_71 ;
...
F_44 ( V_75 L_31 , V_42 -> V_53 ) ;
V_42 -> V_35 . V_63 = V_35 -> V_35 . V_63 ;
F_28 ( V_42 , V_11 ) ;
return 0 ;
}
