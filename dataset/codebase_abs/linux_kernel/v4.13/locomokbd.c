...
static int F_25 ( struct V_39 * V_38 )
{
struct V_8 * V_8 ;
struct V_37 * V_37 ;
int V_40 , V_41 ;
...
V_37 -> V_49 = V_8 -> V_49 ;
V_37 -> V_51 . V_52 = V_53 ;
V_37 -> V_51 . V_54 = 0x0001 ;
V_37 -> V_51 . V_55 = 0x0001 ;
V_37 -> V_51 . V_56 = 0x0100 ;
V_37 -> V_57 = F_22 ;
V_37 -> V_58 = F_24 ;
V_37 -> V_38 . V_59 = & V_38 -> V_38 ;
V_37 -> V_60 [ 0 ] = F_34 ( V_61 ) | F_34 ( V_62 ) |
F_34 ( V_30 ) ;
V_37 -> V_22 = V_8 -> V_22 ;
V_37 -> V_63 = sizeof( V_64 [ 0 ] ) ;
V_37 -> V_65 = F_35 ( V_64 ) ;
F_36 ( V_37 , V_8 ) ;
memcpy ( V_8 -> V_22 , V_64 , sizeof( V_8 -> V_22 ) ) ;
for ( V_40 = 0 ; V_40 < V_66 ; V_40 ++ )
F_37 ( V_8 -> V_22 [ V_40 ] , V_37 -> V_67 ) ;
F_38 ( 0 , V_37 -> V_67 ) ;
...
static int F_45 ( struct V_39 * V_38 )
{
