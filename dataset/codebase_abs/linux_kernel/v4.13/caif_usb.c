...
memset ( & V_34 -> V_16 , 0 , sizeof( V_34 -> V_16 ) ) ;
V_34 -> V_16 . V_7 = F_1 ;
V_34 -> V_16 . V_25 = F_3 ;
V_34 -> V_16 . V_29 = F_13 ;
snprintf ( V_34 -> V_16 . V_36 , V_37 , L_2 , V_28 ) ;
V_34 -> V_16 . V_30 = V_28 ;
F_18 ( & V_34 -> V_23 [ V_32 ] , V_33 ) ;
F_18 ( & V_34 -> V_23 [ V_32 ] , V_31 ) ;
V_34 -> V_23 [ 12 ] = F_19 ( V_38 ) & 0xff ;
V_34 -> V_23 [ 13 ] = ( F_19 ( V_38 ) >> 8 ) & 0xff ;
F_20 ( L_3 ,
...
strcmp ( V_44 -> V_44 . V_51 -> V_52 -> V_36 , L_4 ) == 0 ) )
return 0 ;
V_48 = F_23 ( V_44 ) ;
V_50 = V_48 -> V_53 ;
F_20 ( L_5 ,
F_24 ( V_50 -> V_54 . V_55 ) ,
F_24 ( V_50 -> V_54 . V_56 ) ) ;
if ( ! ( F_24 ( V_50 -> V_54 . V_55 ) == V_57 &&
F_24 ( V_50 -> V_54 . V_56 ) == V_58 ) )
return 0 ;
if ( V_41 == V_59 )
F_25 ( V_60 ) ;
if ( V_41 != V_61 )
