...
static int F_33 ( struct V_1 * V_85 )
{
struct V_14 * V_15 = F_34 ( V_85 ) ;
return F_19 ( V_15 ) ;
}
static void F_35 ( struct V_1 * V_85 )
{
struct V_14 * V_15 = F_34 ( V_85 ) ;
return F_29 ( V_15 ) ;
}
...
int V_96 ;
int V_97 ;
if ( ! F_39 ( V_90 , L_4 , & V_92 ) )
V_15 -> V_76 = V_92 ;
if ( ! F_39 ( V_90 , L_5 , & V_92 ) )
V_15 -> V_79 = V_92 ;
if ( F_40 ( V_90 , L_6 , NULL ) )
V_15 -> V_31 = true ;
if ( F_41 ( V_90 , L_7 ) ||
F_41 ( V_90 , L_8 ) )
V_15 -> V_56 = true ;
if ( ! F_42 ( V_90 , L_9 , & V_96 ) ) {
F_37 ( V_15 -> V_85 , L_10 ) ;
return - V_98 ;
}
V_86 = V_96 / sizeof( T_1 ) ;
if ( ! F_42 ( V_90 , L_11 , & V_96 ) ) {
F_37 ( V_15 -> V_85 , L_12 ) ;
return - V_98 ;
}
...
V_109 = F_45 ( V_110 , & V_102 -> V_85 ) ;
V_15 = F_46 ( & V_102 -> V_85 , sizeof( * V_15 ) , V_111 ) ;
if ( ! V_15 ) {
F_37 ( & V_102 -> V_85 , L_20 ) ;
return - V_112 ;
}
...
if ( V_15 -> V_48 < 0 ) {
F_37 ( & V_102 -> V_85 , L_21 ) ;
return - V_113 ;
}
V_15 -> V_35 = F_49 ( & V_102 -> V_85 ) ;
if ( ! V_15 -> V_35 ) {
F_37 ( & V_102 -> V_85 , L_22 ) ;
return - V_112 ;
}
F_50 ( & V_15 -> V_46 , F_11 , ( unsigned long ) V_15 ) ;
V_104 = F_51 ( V_102 , V_114 , 0 ) ;
V_15 -> V_22 = F_52 ( & V_102 -> V_85 , V_104 ) ;
if ( F_53 ( V_15 -> V_22 ) )
return F_54 ( V_15 -> V_22 ) ;
V_15 -> V_77 = F_55 ( & V_102 -> V_85 , NULL ) ;
if ( F_53 ( V_15 -> V_77 ) ) {
F_37 ( & V_102 -> V_85 , L_23 ) ;
return F_54 ( V_15 -> V_77 ) ;
}
V_15 -> V_78 = F_56 ( & V_102 -> V_85 , L_24 ) ;
if ( F_53 ( V_15 -> V_78 ) ) {
F_37 ( & V_102 -> V_85 , L_25 ) ;
...
V_15 -> V_28 , V_15 -> V_35 ) ;
if ( V_105 ) {
F_37 ( & V_102 -> V_85 , L_26 ) ;
return V_105 ;
}
F_59 ( V_126 , V_15 -> V_35 -> V_127 ) ;
F_60 ( V_15 -> V_35 , V_12 , V_13 ) ;
F_61 ( V_15 -> V_35 , V_15 ) ;
V_105 = F_62 ( & V_102 -> V_85 , V_15 -> V_48 , F_16 ,
V_128 , V_102 -> V_118 , V_15 ) ;
if ( V_105 ) {
F_37 ( & V_102 -> V_85 , L_27 ) ;
return V_105 ;
}
F_30 ( V_15 -> V_48 ) ;
V_105 = F_63 ( V_15 -> V_35 ) ;
if ( V_105 ) {
F_37 ( & V_102 -> V_85 , L_28 ) ;
return V_105 ;
}
F_64 ( V_102 , V_15 ) ;
F_65 ( & V_102 -> V_85 , V_15 -> V_56 ) ;
return 0 ;
}
...
static int F_67 ( struct V_130 * V_85 )
{
struct V_101 * V_102 = F_68 ( V_85 ) ;
...
static int F_75 ( struct V_130 * V_85 )
{
struct V_101 * V_102 = F_68 ( V_85 ) ;
struct V_14 * V_15 = F_69 ( V_102 ) ;
int V_105 = 0 ;
