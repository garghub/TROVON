...
int T_2 F_57 ( T_3 V_4 , T_3 V_5 )
{
return F_50 ( V_4 , V_5 , 0 , V_74 ) ;
}
void T_2 F_58 ( T_4 * V_59 ,
T_3 * V_75 ,
T_3 * V_76 )
{
...
void T_2 F_59 ( T_4 * V_59 , int V_18 , T_1 V_19 ,
struct V_11 * V_77 ,
struct V_11 * V_78 ,
T_3 * V_75 ,
T_3 * V_76 , int * V_79 )
...
if ( F_60 () && F_61 ( V_82 ) )
continue;
if ( ( V_19 & V_2 ) && ! F_62 ( V_82 ) )
continue;
if ( ! ( V_19 & V_74 ) && F_63 ( V_82 ) )
continue;
if ( ! V_78 ) {
if ( V_75 )
* V_75 = V_83 ;
...
void T_2 F_64 ( T_4 * V_59 , int V_18 , T_1 V_19 ,
struct V_11 * V_77 ,
struct V_11 * V_78 ,
T_3 * V_75 ,
T_3 * V_76 , int * V_79 )
...
void T_2 F_65 ( int * V_59 , int V_18 ,
unsigned long * V_89 ,
...
V_33 = & type -> V_14 [ * V_59 ] ;
if ( F_66 ( V_33 -> V_4 ) >= F_67 ( V_33 -> V_4 + V_33 -> V_5 ) )
continue;
...
* V_89 = F_66 ( V_33 -> V_4 ) ;
if ( V_90 )
* V_90 = F_67 ( V_33 -> V_4 + V_33 -> V_5 ) ;
if ( V_79 )
* V_79 = V_33 -> V_18 ;
}
unsigned long T_2 F_68 ( unsigned long V_91 ,
unsigned long V_92 )
{
struct V_11 * type = & V_26 . V_40 ;
unsigned int V_93 = type -> V_13 ;
unsigned int V_94 , V_95 = 0 ;
T_3 V_36 = F_69 ( V_91 + 1 ) ;
do {
V_94 = ( V_93 + V_95 ) / 2 ;
...
return F_3 ( F_70 ( type -> V_14 [ V_93 ] . V_4 ) , V_92 ) ;
}
int T_2 F_71 ( T_3 V_4 , T_3 V_5 ,
...
T_3 T_5 F_74 ( T_3 V_5 , T_3 V_17 ,
T_3 V_15 , T_3 V_16 ,
T_1 V_19 )
{
return F_72 ( V_5 , V_17 , V_15 , V_16 , V_32 ,
V_19 ) ;
}
static T_3 T_5 F_75 ( T_3 V_5 ,
T_3 V_17 , T_3 V_98 ,
int V_18 , T_1 V_19 )
{
return F_72 ( V_5 , V_17 , 0 , V_98 , V_18 , V_19 ) ;
}
T_3 T_5 F_76 ( T_3 V_5 , T_3 V_17 , int V_18 )
{
T_1 V_19 = F_1 () ;
T_3 V_24 ;
V_31:
V_24 = F_75 ( V_5 , V_17 , V_25 ,
V_18 , V_19 ) ;
if ( ! V_24 && ( V_19 & V_2 ) ) {
V_19 &= ~ V_2 ;
goto V_31;
...
{
return F_75 ( V_5 , V_17 , V_98 , V_32 ,
V_3 ) ;
}
T_3 T_5 F_78 ( T_3 V_5 , T_3 V_17 , T_3 V_98 )
{
T_3 V_99 ;
V_99 = F_77 ( V_5 , V_17 , V_98 ) ;
if ( V_99 == 0 )
F_79 ( L_9 ,
& V_5 , & V_98 ) ;
return V_99 ;
}
T_3 T_5 F_80 ( T_3 V_5 , T_3 V_17 )
{
return F_78 ( V_5 , V_17 , V_25 ) ;
}
T_3 T_5 F_81 ( T_3 V_5 , T_3 V_17 , int V_18 )
{
T_3 V_100 = F_76 ( V_5 , V_17 , V_18 ) ;
if ( V_100 )
return V_100 ;
return F_78 ( V_5 , V_17 , V_25 ) ;
}
static void * T_5 F_82 (
T_3 V_5 , T_3 V_17 ,
T_3 V_101 , T_3 V_98 ,
int V_18 )
{
...
void T_5 F_103 ( T_3 V_4 , T_3 V_5 )
{
int V_69 , V_70 ;
int V_12 , V_24 ;
if ( ! V_5 )
return;
V_24 = F_46 ( & V_26 . V_40 , V_4 , V_5 ,
& V_69 , & V_70 ) ;
if ( V_24 )
return;
for ( V_12 = V_26 . V_40 . V_13 - 1 ; V_12 >= V_70 ; V_12 -- )
if ( ! F_63 ( & V_26 . V_40 . V_14 [ V_12 ] ) )
F_21 ( & V_26 . V_40 , V_12 ) ;
for ( V_12 = V_69 - 1 ; V_12 >= 0 ; V_12 -- )
if ( ! F_63 ( & V_26 . V_40 . V_14 [ V_12 ] ) )
F_21 ( & V_26 . V_40 , V_12 ) ;
F_47 ( & V_26 . V_37 , 0 , V_4 ) ;
F_47 ( & V_26 . V_37 ,
V_4 + V_5 , ( T_3 ) V_6 ) ;
}
void T_5 F_104 ( T_3 V_112 )
{
T_3 V_98 ;
if ( ! V_112 )
return;
...
static int T_2 F_105 ( struct V_11 * type , T_3 V_36 )
{
...
bool T_5 F_106 ( T_3 V_36 )
{
return F_105 ( & V_26 . V_37 , V_36 ) != - 1 ;
}
bool T_2 F_107 ( T_3 V_36 )
{
return F_105 ( & V_26 . V_40 , V_36 ) != - 1 ;
}
int T_2 F_108 ( T_3 V_36 )
{
int V_12 = F_105 ( & V_26 . V_40 , V_36 ) ;
if ( V_12 == - 1 )
return false ;
return ! F_63 ( & V_26 . V_40 . V_14 [ V_12 ] ) ;
}
int T_2 F_109 ( unsigned long V_91 ,
unsigned long * V_110 , unsigned long * V_111 )
{
struct V_11 * type = & V_26 . V_40 ;
int V_94 = F_105 ( type , F_69 ( V_91 ) ) ;
if ( V_94 == - 1 )
return - 1 ;
* V_110 = F_67 ( type -> V_14 [ V_94 ] . V_4 ) ;
* V_111 = F_67 ( type -> V_14 [ V_94 ] . V_4 + type -> V_14 [ V_94 ] . V_5 ) ;
return type -> V_14 [ V_94 ] . V_18 ;
}
int T_2 F_110 ( T_3 V_4 , T_3 V_5 )
{
int V_59 = F_105 ( & V_26 . V_40 , V_4 ) ;
T_3 V_16 = V_4 + F_2 ( V_4 , & V_5 ) ;
if ( V_59 == - 1 )
return 0 ;
...
bool T_2 F_111 ( T_3 V_4 , T_3 V_5 )
{
F_2 ( V_4 , & V_5 ) ;
return F_5 ( & V_26 . V_37 , V_4 , V_5 ) ;
}
void T_2 F_112 ( T_3 V_17 )
{
...
static void T_2 F_115 ( struct V_11 * type )
{
T_3 V_4 , V_16 , V_5 ;
unsigned long V_19 ;
int V_59 ;
struct V_39 * V_60 ;
F_116 ( L_13 , type -> V_56 , type -> V_13 ) ;
F_42 (type, rgn) {
char V_115 [ 32 ] = L_14 ;
V_4 = V_60 -> V_4 ;
V_5 = V_60 -> V_5 ;
...
extern unsigned long T_2
F_117 ( T_3 V_116 , T_3 V_117 )
{
struct V_39 * V_60 ;
unsigned long V_5 = 0 ;
int V_59 ;
F_42 ((&memblock.reserved), rgn) {
T_3 V_15 , V_16 ;
if ( V_60 -> V_4 + V_60 -> V_5 < V_116 )
continue;
if ( V_60 -> V_4 > V_117 )
continue;
V_15 = V_60 -> V_4 ;
...
static int T_5 F_121 ( char * V_119 )
{
if ( V_119 && strstr ( V_119 , L_19 ) )
V_120 = 1 ;
return 0 ;
}
static int F_122 ( struct V_121 * V_82 , void * V_122 )
{
struct V_11 * type = V_82 -> V_122 ;
struct V_39 * V_123 ;
int V_12 ;
T_3 V_16 ;
for ( V_12 = 0 ; V_12 < type -> V_13 ; V_12 ++ ) {
V_123 = & type -> V_14 [ V_12 ] ;
V_16 = V_123 -> V_4 + V_123 -> V_5 - 1 ;
F_123 ( V_82 , L_20 , V_12 ) ;
F_123 ( V_82 , L_21 , & V_123 -> V_4 , & V_16 ) ;
}
return 0 ;
}
static int F_124 ( struct V_124 * V_124 , struct V_125 * V_125 )
{
return F_125 ( V_125 , F_122 , V_124 -> V_126 ) ;
}
static int T_5 F_126 ( void )
{
struct V_127 * V_128 = F_127 ( L_22 , NULL ) ;
if ( ! V_128 )
return - V_129 ;
F_128 ( L_23 , V_130 , V_128 , & V_26 . V_40 , & V_131 ) ;
F_128 ( L_24 , V_130 , V_128 , & V_26 . V_37 , & V_131 ) ;
#ifdef F_119
F_128 ( L_25 , V_130 , V_128 , & V_26 . V_118 , & V_131 ) ;
#endif
return 0 ;
}
