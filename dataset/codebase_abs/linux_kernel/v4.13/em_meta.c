...
static inline const struct V_35 * V_35 ( struct V_1 * V_2 )
{
return & V_36 [ F_3 ( V_2 ) ] ;
}
...
{
if ( V_45 ) {
const struct V_35 * V_55 = V_35 ( & V_45 -> V_49 ) ;
if ( V_55 && V_55 -> V_56 ) {
V_55 -> V_56 ( & V_45 -> V_49 ) ;
V_55 -> V_56 ( & V_45 -> V_50 ) ;
}
...
static int F_33 ( struct V_57 * V_57 , void * V_46 , int V_17 ,
struct V_42 * V_43 )
{
int V_39 ;
struct V_24 * V_58 [ V_59 + 1 ] ;
struct V_60 * V_3 ;
struct V_44 * V_45 = NULL ;
V_39 = F_34 ( V_58 , V_59 , V_46 , V_17 , V_61 , NULL ) ;
if ( V_39 < 0 )
goto V_62;
V_39 = - V_34 ;
if ( V_58 [ V_63 ] == NULL )
goto V_62;
V_3 = F_13 ( V_58 [ V_63 ] ) ;
if ( F_4 ( V_3 -> V_64 . V_4 ) != F_4 ( V_3 -> V_65 . V_4 ) ||
F_4 ( V_3 -> V_64 . V_4 ) > V_66 ||
F_2 ( V_3 -> V_64 . V_4 ) > V_67 ||
F_2 ( V_3 -> V_65 . V_4 ) > V_67 )
goto V_62;
...
memcpy ( & V_45 -> V_49 . V_3 , & V_3 -> V_64 , sizeof( V_3 -> V_64 ) ) ;
memcpy ( & V_45 -> V_50 . V_3 , & V_3 -> V_65 , sizeof( V_3 -> V_65 ) ) ;
if ( ! F_32 ( & V_45 -> V_49 ) ||
! F_32 ( & V_45 -> V_50 ) ) {
V_39 = - V_68 ;
goto V_62;
}
if ( F_30 ( & V_45 -> V_49 , V_58 [ V_69 ] ) < 0 ||
F_30 ( & V_45 -> V_50 , V_58 [ V_70 ] ) < 0 )
goto V_62;
V_43 -> V_71 = sizeof( * V_45 ) ;
...
static int F_37 ( struct V_29 * V_30 , struct V_42 * V_72 )
{
struct V_44 * V_45 = (struct V_44 * ) V_72 -> V_46 ;
struct V_60 V_3 ;
const struct V_35 * V_55 ;
memset ( & V_3 , 0 , sizeof( V_3 ) ) ;
memcpy ( & V_3 . V_64 , & V_45 -> V_49 . V_3 , sizeof( V_3 . V_64 ) ) ;
memcpy ( & V_3 . V_65 , & V_45 -> V_50 . V_3 , sizeof( V_3 . V_65 ) ) ;
if ( F_18 ( V_30 , V_63 , sizeof( V_3 ) , & V_3 ) )
goto V_32;
V_55 = V_35 ( & V_45 -> V_49 ) ;
if ( V_55 -> V_73 ( V_30 , & V_45 -> V_49 , V_69 ) < 0 ||
V_55 -> V_73 ( V_30 , & V_45 -> V_50 , V_70 ) < 0 )
goto V_32;
return 0 ;
V_32:
return - 1 ;
