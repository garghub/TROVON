...
T_9 V_101 ;
int V_96 = 0 ;
V_100 = ( V_95 -> V_97 -> V_98 & V_102 ) >> 32 ;
V_101 = V_95 -> V_97 -> V_98 & V_103 ;
V_95 -> V_97 -> V_98 &= V_104 ;
if ( V_100 != V_105 ) {
if ( V_100 >= V_106 || ! F_59 ( V_100 ) ) {
V_96 = - V_14 ;
goto V_8;
}
}
...
static long F_65 ( struct V_118 * V_119 , T_9 V_52 , unsigned long V_98 )
{
struct V_120 V_97 ;
struct V_70 * V_121 ;
struct V_2 * V_29 ;
...
V_96 = F_66 ( & V_97 , ( const void V_124 * ) V_98 ,
sizeof( struct V_120 ) ) ;
if ( V_96 != 0 ) {
V_96 = - V_125 ;
goto error;
...
if ( V_52 & V_127 ) {
V_96 = F_66 ( V_31 , ( const void V_124 * ) V_97 . V_126 , V_97 . V_5 ) ;
if ( V_96 != 0 ) {
V_96 = - V_125 ;
goto error;
}
...
if ( V_52 & V_136 ) {
V_96 = F_68 ( ( void V_124 * ) V_97 . V_126 , V_31 , V_97 . V_5 ) ;
if ( V_96 != 0 ) {
V_96 = - V_125 ;
goto error;
}
...
int F_72 ( struct V_144 * V_144 , struct V_118 * V_118 )
{
int V_4 ;
struct V_38 * V_145 ;
struct V_2 * V_6 ;
...
V_4 = F_73 ( V_118 , & V_146 ) ;
V_145 = V_118 -> V_147 ;
V_145 -> V_71 = V_6 ;
}
return V_4 ;
}
int F_74 ( struct V_144 * V_144 , struct V_118 * V_118 )
{
struct V_38 * V_145 = V_118 -> V_147 ;
F_6 ( V_145 -> V_71 ) ;
return F_75 ( V_144 , V_118 ) ;
}
int F_76 ( T_5 V_44 ,
T_5 * V_49 , T_5 * V_50 )
{
