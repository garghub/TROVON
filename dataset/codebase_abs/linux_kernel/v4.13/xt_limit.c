...
static void F_10 ( const struct V_28 * V_4 )
{
const struct V_5 * V_29 = V_4 -> V_7 ;
F_11 ( V_29 -> V_10 ) ;
}
static void F_12 ( void * V_30 , const void * V_31 )
{
...
static int F_13 ( void T_2 * V_30 , const void * V_31 )
{
...
return F_14 ( V_30 , & V_33 , sizeof( V_33 ) ) ? - V_35 : 0 ;
}
