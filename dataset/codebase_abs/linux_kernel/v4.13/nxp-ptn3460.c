...
V_3 -> V_29 ) ;
if ( V_6 -> V_21 )
F_32 ( V_6 -> V_21 , & V_6 -> V_5 ) ;
F_33 ( V_6 -> V_5 . V_33 ) ;
return V_10 ;
}
static int F_34 ( struct V_37 * V_11 ,
const struct V_38 * V_39 )
{
struct V_40 * V_33 = & V_11 -> V_33 ;
struct V_1 * V_6 ;
int V_10 ;
V_6 = F_35 ( V_33 , sizeof( * V_6 ) , V_26 ) ;
if ( ! V_6 ) {
return - V_41 ;
}
V_10 = F_36 ( V_33 -> V_42 , 0 , 0 , & V_6 -> V_21 , NULL ) ;
if ( V_10 )
return V_10 ;
V_6 -> V_11 = V_11 ;
V_6 -> V_19 = F_37 ( & V_11 -> V_33 , L_13 ,
V_43 ) ;
if ( F_38 ( V_6 -> V_19 ) ) {
V_10 = F_39 ( V_6 -> V_19 ) ;
F_40 ( V_33 , L_14 , V_10 ) ;
...
static int F_44 ( struct V_37 * V_11 )
{
struct V_1 * V_6 = F_45 ( V_11 ) ;
F_46 ( & V_6 -> V_3 ) ;
return 0 ;
}
