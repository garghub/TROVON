...
static int F_50 ( struct V_98 * V_99 , T_5 V_100 , void * V_101 )
{
T_4 * V_102 = V_101 ;
* V_102 = V_100 ;
return 0 ;
...
{
int V_113 = 0 ;
if ( ! F_58 ( V_105 ) && V_105 -> V_114 && V_37 -> V_59 &&
! V_37 -> V_115 )
...
int F_57 ( const struct V_104 * V_105 , struct V_36 * V_37 )
{ return 0 ; }
static const struct V_104 * F_59 ( struct V_36 * V_37 ,
struct V_1 * V_12 ,
T_4 V_103 )
{
...
F_61 ( - V_116 ) : NULL ;
V_106 = F_51 ( V_37 , V_103 , V_5 , V_105 ) ;
}
...
V_37 -> V_117 = F_63 ( 32 ) ;
if ( ! V_37 -> V_118 )
V_37 -> V_118 = & V_37 -> V_117 ;
}
const struct V_104 * F_64 ( struct V_36 * V_37 )
{
...
if ( ! V_12 )
return NULL ;
V_74 = F_34 ( V_12 , V_102 , & V_103 ,
V_119 ) ;
V_105 = F_59 ( V_37 , V_74 , V_103 ) ;
} else {
int V_30 = 0 ;
V_12 = F_18 ( V_40 ,
F_22 , V_37 ) ;
...
if ( V_113 )
V_105 = F_61 ( V_113 ) ;
if ( F_66 ( V_105 ) && ( F_67 ( V_105 ) != - V_116 ) ) {
F_68 ( V_37 , L_7 , F_67 ( V_105 ) ) ;
V_105 = NULL ;
}
return V_105 ;
}
static void T_6 F_69 ( int V_120 , const char * V_121 ,
int V_122 ,
struct V_123 * V_124 )
{
int V_125 = F_70 ( NULL , V_120 , V_122 ,
V_126 ) ;
if ( V_125 <= 0 ) {
F_33 ( L_8 , V_120 ,
V_121 ) ;
...
static int T_6 F_71 ( struct V_1 * V_12 )
{
struct V_130 * V_131 ;
int V_132 = 1 ;
V_131 = (struct V_130 * ) V_12 -> V_51 ;
if ( V_131 -> V_133 )
V_132 ++ ;
if ( V_131 -> V_134 )
V_132 ++ ;
...
static bool F_72 ( struct V_130 * V_131 )
{
if ( V_131 -> V_137 != V_138 )
return false ;
return V_131 -> V_133 == V_131 -> V_134 &&
V_131 -> V_133 == V_131 -> V_135 &&
V_131 -> V_133 == V_131 -> V_136 ;
}
static unsigned long F_73 ( struct V_130 * V_131 )
{
if ( V_131 -> V_137 == V_138 )
return V_139 ;
return V_140 ;
...
int V_132 = 0 ;
V_131 = (struct V_130 * ) V_12 -> V_51 ;
V_124 [ V_132 ] . V_127 = V_131 -> V_141 ;
V_124 [ V_132 ] . V_128 = V_131 -> V_141 +
F_73 ( V_131 ) - 1 ;
V_124 [ V_132 ] . V_65 = V_142 ;
V_132 ++ ;
if ( F_72 ( V_131 ) ) {
if ( V_131 -> V_133 )
F_69 ( V_131 -> V_133 , L_9 ,
V_143 ,
& V_124 [ V_132 ++ ] ) ;
} else {
if ( V_131 -> V_133 )
F_69 ( V_131 -> V_133 , L_10 ,
V_143 ,
& V_124 [ V_132 ++ ] ) ;
if ( V_131 -> V_134 )
F_69 ( V_131 -> V_134 , L_11 ,
V_143 ,
& V_124 [ V_132 ++ ] ) ;
if ( V_131 -> V_135 )
F_69 ( V_131 -> V_135 , L_12 ,
V_143 ,
& V_124 [ V_132 ++ ] ) ;
if ( V_131 -> V_136 )
F_69 ( V_131 -> V_136 , L_13 ,
V_143 ,
& V_124 [ V_132 ++ ] ) ;
}
}
...
struct V_130 * V_131 ;
V_131 = (struct V_130 * ) V_12 -> V_51 ;
return V_131 -> V_65 & V_144 ;
}
static int T_6 F_76 ( struct V_1 * V_12 )
{
struct V_145 * V_131 ;
V_131 = (struct V_145 * ) V_12 -> V_51 ;
return V_131 -> V_146 + 2 ;
}
static void T_6 F_77 ( struct V_123 * V_124 ,
struct V_1 * V_12 )
{
struct V_145 * V_131 ;
int V_30 , V_147 , V_122 , V_132 = 0 ;
T_7 * V_148 , * V_149 ;
V_131 = (struct V_145 * ) V_12 -> V_51 ;
V_124 [ V_132 ] . V_127 = V_131 -> V_141 ;
V_124 [ V_132 ] . V_128 = V_131 -> V_141 + V_131 -> V_150 - 1 ;
V_124 [ V_132 ] . V_65 = V_142 ;
V_132 ++ ;
V_149 = F_19 ( T_7 , V_12 , V_131 -> V_151 ) ;
V_147 = F_78 ( V_149 [ 0 ] ) ;
V_122 = F_79 ( V_149 [ 0 ] ) ;
F_69 ( V_147 , L_14 , V_122 ,
& V_124 [ V_132 ++ ] ) ;
V_148 = F_19 ( T_7 , V_12 , V_131 -> V_152 ) ;
for ( V_30 = 0 ; V_30 < V_131 -> V_146 ; V_30 ++ ) {
V_147 = F_78 ( V_148 [ V_30 ] ) ;
V_122 = F_79 ( V_148 [ V_30 ] ) ;
F_69 ( V_147 , L_15 , V_122 ,
& V_124 [ V_132 ++ ] ) ;
}
}
...
enum V_156 V_157 ;
int V_106 , V_158 ;
const struct V_159 * V_105 = F_82 ( V_12 ) ;
if ( ! V_105 )
return - V_86 ;
V_99 = F_83 ( V_105 -> V_121 , V_160 ) ;
if ( ! V_99 )
return - V_8 ;
V_158 = V_105 -> V_161 ( V_12 ) ;
V_155 = F_84 ( V_158 , sizeof( * V_155 ) , V_19 ) ;
if ( ! V_155 ) {
V_106 = - V_8 ;
goto V_162;
}
V_105 -> V_163 ( V_155 , V_12 ) ;
V_106 = F_85 ( V_99 , V_155 , V_158 ) ;
F_13 ( V_155 ) ;
if ( V_106 )
goto V_162;
...
if ( V_106 )
goto V_162;
V_99 -> V_37 . V_118 = & V_99 -> V_37 . V_117 ;
V_4 = F_8 ( V_12 ) ;
if ( ! V_4 ) {
V_106 = - V_86 ;
goto V_162;
...
V_99 -> V_37 . V_4 = V_4 ;
V_157 = V_105 -> V_164 ( V_12 ) ?
V_165 : V_166 ;
F_87 ( & V_99 -> V_37 , V_157 ) ;
V_106 = F_88 ( V_99 ) ;
if ( V_106 )
goto V_167;
return 0 ;
...
{
T_2 V_38 ;
V_38 = F_95 ( V_168 , 0 , & V_31 ) ;
if ( F_25 ( V_38 ) ) {
if ( V_38 != V_39 ) {
const char * V_169 = F_96 ( V_38 ) ;
F_33 ( L_17 , V_169 ) ;
}
return;
}
