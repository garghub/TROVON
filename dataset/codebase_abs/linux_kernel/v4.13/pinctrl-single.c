...
struct V_187 * V_17 ;
struct V_8 * V_9 ;
const struct V_87 * V_188 ;
int V_66 ;
V_188 = F_122 ( & V_178 -> V_23 ) ;
if ( F_123 ( ! V_188 ) )
return - V_40 ;
...
F_107 ( & V_9 -> V_147 ) ;
V_9 -> V_45 = V_188 -> V_45 ;
memcpy ( & V_9 -> V_89 , V_188 , sizeof( * V_188 ) ) ;
...
& V_9 -> V_39 ) ;
if ( ! V_66 ) {
V_9 -> V_189 = F_67 ( V_9 -> V_39 ) ;
V_9 -> V_190 = V_9 -> V_39 >> V_9 -> V_189 ;
} else {
V_9 -> V_39 = 0 ;
V_9 -> V_189 = 0 ;
V_9 -> V_190 = 0 ;
...
V_17 = F_127 ( V_178 , V_193 , 0 ) ;
if ( ! V_17 ) {
F_21 ( V_9 -> V_23 , L_41 ) ;
return - V_194 ;
}
V_9 -> V_17 = F_128 ( V_9 -> V_23 , V_17 -> V_18 ,
F_129 ( V_17 ) , V_19 ) ;
if ( ! V_9 -> V_17 ) {
F_21 ( V_9 -> V_23 , L_42 ) ;
return - V_195 ;
}
V_9 -> V_99 = F_129 ( V_9 -> V_17 ) ;
V_9 -> V_16 = F_130 ( V_9 -> V_23 , V_9 -> V_17 -> V_18 , V_9 -> V_99 ) ;
if ( ! V_9 -> V_16 ) {
F_21 ( V_9 -> V_23 , L_43 ) ;
return - V_194 ;
}
...
V_9 -> V_92 . V_41 = V_19 ;
V_9 -> V_92 . V_196 = & V_197 ;
V_9 -> V_92 . V_198 = & V_199 ;
if ( V_115 )
V_9 -> V_92 . V_200 = & V_201 ;
V_9 -> V_92 . V_202 = V_203 ;
V_66 = F_46 ( V_9 ) ;
if ( V_66 < 0 )
goto free;
V_66 = F_132 ( & V_9 -> V_92 , V_9 -> V_23 , V_9 , & V_9 -> V_106 ) ;
if ( V_66 ) {
F_21 ( V_9 -> V_23 , L_44 ) ;
goto free;
}
...
if ( V_66 < 0 )
goto free;
V_9 -> V_89 . V_138 = F_133 ( V_103 , 0 ) ;
if ( V_9 -> V_89 . V_138 )
V_9 -> V_45 |= V_204 ;
V_186 = F_134 ( & V_178 -> V_23 ) ;
if ( V_186 ) {
if ( V_186 -> V_151 )
V_9 -> V_89 . V_151 = V_186 -> V_151 ;
if ( V_186 -> V_138 ) {
V_9 -> V_89 . V_138 = V_186 -> V_138 ;
V_9 -> V_45 |= V_204 ;
}
}
if ( V_205 ) {
...
return F_136 ( V_9 -> V_106 ) ;
free:
F_74 ( V_9 ) ;
return V_66 ;
}
static int F_137 ( struct V_177 * V_178 )
{
