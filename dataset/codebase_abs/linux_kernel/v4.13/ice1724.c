...
{
return V_105 [ F_2 ( F_3 ( V_2 , V_3 ) ) & 15 ] ;
}
static void F_58 ( struct V_1 * V_2 , unsigned int V_106 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_59 ( V_105 ) ; V_44 ++ ) {
if ( V_105 [ V_44 ] == V_106 ) {
...
static int F_61 ( struct V_1 * V_2 , unsigned int V_106 ,
int V_112 )
{
unsigned long V_56 ;
unsigned char V_113 ;
unsigned int V_44 , V_114 ;
if ( V_106 > V_2 -> V_115 -> V_42 [ V_2 -> V_115 -> V_34 - 1 ] )
return - V_104 ;
F_38 ( & V_2 -> V_54 , V_56 ) ;
if ( ( F_2 ( F_3 ( V_2 , V_102 ) ) & V_116 ) ||
( F_2 ( F_3 ( V_2 , V_98 ) ) & V_117 ) ) {
F_39 ( & V_2 -> V_54 , V_56 ) ;
return ( ( V_106 == V_2 -> V_118 ) && ! V_112 ) ? 0 : - V_119 ;
}
if ( ! V_112 && F_4 ( V_2 ) ) {
F_39 ( & V_2 -> V_54 , V_56 ) ;
return ( V_106 == V_2 -> V_118 ) ? 0 : - V_119 ;
}
if ( V_112 || ! V_2 -> V_5 ( V_2 ) ) {
V_114 = V_2 -> V_120 ( V_2 ) ;
if ( V_112 || ( V_114 != V_106 ) )
V_2 -> V_121 ( V_2 , V_106 ) ;
else if ( V_106 == V_2 -> V_118 ) {
F_39 ( & V_2 -> V_54 , V_56 ) ;
return 0 ;
}
}
V_2 -> V_118 = V_106 ;
V_113 = V_2 -> V_122 ( V_2 , V_106 ) ;
F_39 ( & V_2 -> V_54 , V_56 ) ;
if ( V_113 && V_2 -> V_123 . V_124 )
V_2 -> V_123 . V_124 ( V_2 ) ;
if ( V_2 -> V_123 . V_125 )
V_2 -> V_123 . V_125 ( V_2 , V_106 ) ;
for ( V_44 = 0 ; V_44 < V_2 -> V_126 ; V_44 ++ ) {
if ( V_2 -> V_127 [ V_44 ] . V_128 . V_129 )
V_2 -> V_127 [ V_44 ] . V_128 . V_129 ( & V_2 -> V_127 [ V_44 ] , V_106 ) ;
}
if ( V_2 -> V_130 . V_128 . V_131 )
V_2 -> V_130 . V_128 . V_131 ( V_2 , V_106 ) ;
return 0 ;
}
...
if ( F_4 ( V_2 ) ) {
V_106 = V_2 -> V_120 ( V_2 ) ;
if ( V_106 >= V_94 -> V_155 . V_156
&& V_106 <= V_94 -> V_155 . V_157 ) {
V_94 -> V_155 . V_156 = V_106 ;
V_94 -> V_155 . V_157 = V_106 ;
}
}
}
...
static void F_95 ( struct V_1 * V_2 , unsigned int V_106 )
{
