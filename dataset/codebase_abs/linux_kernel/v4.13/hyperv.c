...
static void F_140 ( struct V_15 * V_18 , T_1 V_196 )
{
bool V_197 ;
V_197 = F_141 ( V_18 ) ;
if ( V_197 )
F_142 ( V_18 , V_198 , V_196 ) ;
else {
F_142 ( V_18 , V_199 , V_196 >> 32 ) ;
F_142 ( V_18 , V_198 , V_196 & 0xffffffff ) ;
}
}
static int F_143 ( struct V_15 * V_18 )
{
struct V_200 * V_201 = V_18 -> V_201 ;
F_140 ( V_18 , V_201 -> V_52 . V_54 . V_202 . V_196 ) ;
return 1 ;
}
int F_144 ( struct V_15 * V_18 )
{
T_1 V_203 , V_204 , V_205 , V_58 ;
T_7 V_206 , V_207 , V_208 , V_209 = V_210 , V_211 = 0 ;
bool V_212 , V_197 ;
if ( V_166 -> V_213 ( V_18 ) != 0 || ! F_145 ( V_18 ) ) {
F_146 ( V_18 , V_214 ) ;
return 1 ;
}
V_197 = F_141 ( V_18 ) ;
if ( ! V_197 ) {
V_203 = ( ( T_1 ) F_147 ( V_18 , V_199 ) << 32 ) |
( F_147 ( V_18 , V_198 ) & 0xffffffff ) ;
V_204 = ( ( T_1 ) F_147 ( V_18 , V_215 ) << 32 ) |
( F_147 ( V_18 , V_216 ) & 0xffffffff ) ;
V_205 = ( ( T_1 ) F_147 ( V_18 , V_217 ) << 32 ) |
( F_147 ( V_18 , V_218 ) & 0xffffffff ) ;
}
#ifdef F_148
else {
V_203 = F_147 ( V_18 , V_216 ) ;
V_204 = F_147 ( V_18 , V_199 ) ;
V_205 = F_147 ( V_18 , V_219 ) ;
}
#endif
V_206 = V_203 & 0xffff ;
V_212 = ( V_203 >> 16 ) & 0x1 ;
V_208 = ( V_203 >> 32 ) & 0xfff ;
V_207 = ( V_203 >> 48 ) & 0xfff ;
F_149 ( V_206 , V_212 , V_208 , V_207 , V_204 , V_205 ) ;
if ( V_208 || V_207 ) {
V_209 = V_220 ;
goto V_221;
}
...
V_18 -> V_201 -> V_225 = V_226 ;
V_18 -> V_201 -> V_52 . type = V_227 ;
V_18 -> V_201 -> V_52 . V_54 . V_202 . V_228 = V_203 ;
V_18 -> V_201 -> V_52 . V_54 . V_202 . V_229 [ 0 ] = V_204 ;
V_18 -> V_201 -> V_52 . V_54 . V_202 . V_229 [ 1 ] = V_205 ;
V_18 -> V_51 . V_230 =
F_143 ;
return 0 ;
default:
