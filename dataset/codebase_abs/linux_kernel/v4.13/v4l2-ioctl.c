...
default:
F_65 ( 1 , L_242 , V_59 -> V_40 ) ;
if ( V_59 -> V_41 [ 0 ] )
return;
V_39 = 0 ;
snprintf ( V_59 -> V_41 , V_334 , L_243 ,
( char ) ( V_59 -> V_40 & 0x7f ) ,
( char ) ( ( V_59 -> V_40 >> 8 ) & 0x7f ) ,
( char ) ( ( V_59 -> V_40 >> 16 ) & 0x7f ) ,
( char ) ( ( V_59 -> V_40 >> 24 ) & 0x7f ) ,
( V_59 -> V_40 & ( 1 << 31 ) ) ? L_244 : L_245 ) ;
break;
}
}
if ( V_6 )
...
switch ( V_19 -> type ) {
case V_57 :
if ( F_80 ( ! V_293 || ( ! V_284 && ! V_291 ) || ! V_282 -> V_495 ) )
break;
V_316 = V_282 -> V_495 ( V_277 , V_314 , V_16 ) ;
break;
case V_70 :
if ( F_80 ( ! V_293 || ! V_284 || ! V_282 -> V_496 ) )
break;
V_316 = V_282 -> V_496 ( V_277 , V_314 , V_16 ) ;
break;
case V_76 :
if ( F_80 ( ! V_293 || ! V_284 || ! V_282 -> V_497 ) )
break;
V_316 = V_282 -> V_497 ( V_277 , V_314 , V_16 ) ;
break;
case V_58 :
if ( F_80 ( ! V_296 || ! V_284 || ! V_282 -> V_498 ) )
break;
V_316 = V_282 -> V_498 ( V_277 , V_314 , V_16 ) ;
break;
case V_71 :
if ( F_80 ( ! V_296 || ! V_284 || ! V_282 -> V_499 ) )
break;
V_316 = V_282 -> V_499 ( V_277 , V_314 , V_16 ) ;
break;
case V_99 :
if ( F_80 ( ! V_293 || ! V_289 || ! V_282 -> V_500 ) )
break;
V_316 = V_282 -> V_500 ( V_277 , V_314 , V_16 ) ;
break;
case V_100 :
if ( F_80 ( ! V_296 || ! V_289 || ! V_282 -> V_501 ) )
break;
V_316 = V_282 -> V_501 ( V_277 , V_314 , V_16 ) ;
break;
case V_101 :
if ( F_80 ( ! V_293 || ! V_284 || ! V_282 -> V_502 ) )
break;
...
case V_76 :
case V_77 : {
struct V_503 T_3 * V_83 = V_19 -> V_59 . V_52 . V_83 ;
...
switch ( V_19 -> type ) {
case V_57 :
if ( F_80 ( ! V_293 || ( ! V_284 && ! V_291 ) || ! V_282 -> V_506 ) )
break;
F_84 ( V_19 , V_59 . V_44 ) ;
...
case V_76 :
if ( F_80 ( ! V_293 || ! V_284 || ! V_282 -> V_508 ) )
break;
F_84 ( V_19 , V_59 . V_52 ) ;
return V_282 -> V_508 ( V_277 , V_314 , V_16 ) ;
case V_86 :
if ( F_80 ( ! V_293 || V_284 || ! V_282 -> V_509 ) )
break;
F_84 ( V_19 , V_59 . V_48 ) ;
return V_282 -> V_509 ( V_277 , V_314 , V_16 ) ;
case V_94 :
if ( F_80 ( ! V_293 || V_284 || ! V_282 -> V_510 ) )
break;
F_84 ( V_19 , V_59 . V_50 ) ;
...
break;
F_84 ( V_19 , V_59 . V_44 ) ;
V_316 = V_282 -> V_511 ( V_277 , V_314 , V_16 ) ;
V_19 -> V_59 . V_44 . V_312 = V_313 ;
return V_316 ;
case V_71 :
...
case V_77 :
if ( F_80 ( ! V_296 || ! V_284 || ! V_282 -> V_513 ) )
break;
F_84 ( V_19 , V_59 . V_52 ) ;
return V_282 -> V_513 ( V_277 , V_314 , V_16 ) ;
case V_87 :
if ( F_80 ( ! V_296 || V_284 || ! V_282 -> V_514 ) )
break;
F_84 ( V_19 , V_59 . V_48 ) ;
...
case V_99 :
if ( F_80 ( ! V_293 || ! V_289 || ! V_282 -> V_516 ) )
break;
F_84 ( V_19 , V_59 . V_54 ) ;
return V_282 -> V_516 ( V_277 , V_314 , V_16 ) ;
case V_100 :
if ( F_80 ( ! V_296 || ! V_289 || ! V_282 -> V_517 ) )
break;
F_84 ( V_19 , V_59 . V_54 ) ;
...
switch ( V_19 -> type ) {
case V_57 :
if ( F_80 ( ! V_293 || ( ! V_284 && ! V_291 ) || ! V_282 -> V_519 ) )
break;
F_84 ( V_19 , V_59 . V_44 ) ;
V_316 = V_282 -> V_519 ( V_277 , V_314 , V_16 ) ;
V_19 -> V_59 . V_44 . V_312 = V_313 ;
return V_316 ;
case V_70 :
...
case V_76 :
if ( F_80 ( ! V_293 || ! V_284 || ! V_282 -> V_521 ) )
break;
F_84 ( V_19 , V_59 . V_52 ) ;
...
case V_94 :
if ( F_80 ( ! V_293 || V_284 || ! V_282 -> V_523 ) )
break;
F_84 ( V_19 , V_59 . V_50 ) ;
...
break;
F_84 ( V_19 , V_59 . V_44 ) ;
V_316 = V_282 -> V_524 ( V_277 , V_314 , V_16 ) ;
V_19 -> V_59 . V_44 . V_312 = V_313 ;
return V_316 ;
case V_71 :
...
case V_77 :
if ( F_80 ( ! V_296 || ! V_284 || ! V_282 -> V_526 ) )
break;
F_84 ( V_19 , V_59 . V_52 ) ;
return V_282 -> V_526 ( V_277 , V_314 , V_16 ) ;
case V_87 :
if ( F_80 ( ! V_296 || V_284 || ! V_282 -> V_527 ) )
break;
F_84 ( V_19 , V_59 . V_48 ) ;
...
case V_99 :
if ( F_80 ( ! V_293 || ! V_289 || ! V_282 -> V_529 ) )
break;
F_84 ( V_19 , V_59 . V_54 ) ;
return V_282 -> V_529 ( V_277 , V_314 , V_16 ) ;
case V_100 :
if ( F_80 ( ! V_296 || ! V_289 || ! V_282 -> V_530 ) )
break;
F_84 ( V_19 , V_59 . V_54 ) ;
return V_282 -> V_530 ( V_277 , V_314 , V_16 ) ;
case V_101 :
if ( F_80 ( ! V_293 || ! V_284 || ! V_282 -> V_531 ) )
break;
F_84 ( V_19 , V_59 . V_56 ) ;
...
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
return V_282 -> V_532 ( V_277 , V_314 , * ( unsigned int * ) V_16 ) ;
}
static int F_87 ( const struct V_281 * V_282 ,
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
return V_282 -> V_533 ( V_277 , V_314 , * ( unsigned int * ) V_16 ) ;
}
...
int V_534 ;
V_19 -> type = ( V_280 -> V_285 == V_535 ) ?
V_536 : V_537 ;
V_534 = V_282 -> V_538 ( V_277 , V_314 , V_19 ) ;
if ( ! V_534 )
V_19 -> V_35 |= V_539 ;
return V_534 ;
}
...
V_19 -> type = ( V_280 -> V_285 == V_535 ) ?
V_536 : V_537 ;
return V_282 -> V_540 ( V_277 , V_314 , V_19 ) ;
}
...
int V_534 ;
if ( V_280 -> V_285 == V_535 )
V_19 -> type = V_536 ;
V_534 = V_282 -> V_541 ( V_277 , V_314 , V_19 ) ;
if ( ! V_534 )
V_19 -> V_35 |= V_539 ;
return V_534 ;
}
...
if ( V_280 -> V_285 == V_535 )
V_19 -> type = V_536 ;
return V_282 -> V_542 ( V_277 , V_314 , V_19 ) ;
}
...
return V_316 ;
if ( V_280 -> V_285 == V_290 ) {
if ( V_19 -> type != V_543 && V_19 -> type != V_546 )
return - V_298 ;
} else {
type = ( V_280 -> V_285 == V_535 ) ?
V_536 : V_537 ;
if ( type != V_19 -> type )
return - V_298 ;
}
return V_282 -> V_547 ( V_277 , V_314 , V_19 ) ;
}
...
T_1 V_1 = V_280 -> V_548 , V_549 = 0 ;
unsigned int V_27 = V_19 -> V_27 , V_3 , V_550 = 0 ;
const char * V_6 = L_245 ;
if ( V_1 == 0 )
return - V_551 ;
for ( V_3 = 0 ; V_3 <= V_27 && V_1 ; V_3 ++ ) {
while ( ( V_1 & V_4 [ V_550 ] . V_5 ) != V_4 [ V_550 ] . V_5 )
V_550 ++ ;
V_549 = V_4 [ V_550 ] . V_5 ;
V_6 = V_4 [ V_550 ] . V_6 ;
V_550 ++ ;
...
{
struct V_279 * V_280 = F_61 ( V_277 ) ;
T_1 V_1 = * ( T_1 * ) V_16 , V_555 ;
int V_316 ;
V_316 = F_67 ( V_280 ) ;
if ( V_316 )
return V_316 ;
V_555 = V_1 & V_280 -> V_548 ;
if ( V_280 -> V_548 && ! V_555 )
return - V_298 ;
return V_282 -> V_556 ( V_277 , V_314 , V_555 ) ;
}
...
return V_316 ;
* V_19 = V_280 -> V_548 ;
return V_282 -> V_557 ( V_277 , V_314 , V_16 ) ;
}
...
if ( V_19 -> type != type )
return - V_298 ;
return V_282 -> V_558 ( V_277 , V_314 , V_19 ) ;
}
static int F_98 ( const struct V_281 * V_282 ,
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
return V_282 -> V_559 ( V_277 , V_314 , * ( unsigned int * ) V_16 ) ;
}
...
return V_316 ;
F_84 ( V_19 , V_121 ) ;
return V_282 -> V_560 ( V_277 , V_314 , V_19 ) ;
}
...
int V_316 = F_60 ( V_277 , V_19 -> type ) ;
return V_316 ? V_316 : V_282 -> V_561 ( V_277 , V_314 , V_19 ) ;
}
...
struct V_123 * V_19 = V_16 ;
int V_316 = F_60 ( V_277 , V_19 -> type ) ;
return V_316 ? V_316 : V_282 -> V_562 ( V_277 , V_314 , V_19 ) ;
}
...
struct V_123 * V_19 = V_16 ;
int V_316 = F_60 ( V_277 , V_19 -> type ) ;
return V_316 ? V_316 : V_282 -> V_563 ( V_277 , V_314 , V_19 ) ;
}
static int F_103 ( const struct V_281 * V_282 ,
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
struct V_147 * V_564 = V_16 ;
int V_316 = F_60 ( V_277 , V_564 -> V_148 . type ) ;
if ( V_316 )
return V_316 ;
F_84 ( V_564 , V_148 ) ;
F_62 ( & V_564 -> V_148 ) ;
V_316 = V_282 -> V_565 ( V_277 , V_314 , V_564 ) ;
if ( V_564 -> V_148 . type == V_57 ||
V_564 -> V_148 . type == V_58 )
V_564 -> V_148 . V_59 . V_44 . V_312 = V_313 ;
return V_316 ;
}
static int F_104 ( const struct V_281 * V_282 ,
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
struct V_123 * V_566 = V_16 ;
int V_316 = F_60 ( V_277 , V_566 -> type ) ;
return V_316 ? V_316 : V_282 -> V_567 ( V_277 , V_314 , V_566 ) ;
}
...
return V_316 ;
if ( V_282 -> V_568 )
return V_282 -> V_568 ( V_277 , V_314 , V_19 ) ;
if ( V_19 -> type != V_57 &&
V_19 -> type != V_70 )
return - V_298 ;
V_19 -> V_152 . V_153 . V_157 = 2 ;
V_316 = V_282 -> V_569 ( V_277 , V_314 , & V_5 ) ;
if ( V_316 == 0 )
...
struct V_149 * V_19 = V_16 ;
int V_316 = F_60 ( V_277 , V_19 -> type ) ;
return V_316 ? V_316 : V_282 -> V_570 ( V_277 , V_314 , V_19 ) ;
}
...
if ( V_325 && V_325 -> V_571 )
return V_162 ( V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return V_162 ( V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_572 )
...
F_72 ( V_326 , & V_280 -> V_39 ) ? V_314 : NULL ;
if ( V_325 && V_325 -> V_571 )
return V_167 ( V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return V_167 ( V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_573 )
return V_282 -> V_573 ( V_277 , V_314 , V_19 ) ;
return - V_327 ;
}
...
F_72 ( V_326 , & V_280 -> V_39 ) ? V_314 : NULL ;
if ( V_325 && V_325 -> V_571 )
return V_172 ( V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return V_172 ( V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_574 )
...
struct V_576 V_258 ;
if ( V_325 && V_325 -> V_571 )
return F_111 ( V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return F_111 ( V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_577 )
return V_282 -> V_577 ( V_277 , V_314 , V_19 ) ;
if ( V_282 -> V_578 == NULL )
return - V_327 ;
V_575 . V_176 = F_59 ( V_19 -> V_1 ) ;
V_575 . V_93 = 1 ;
V_575 . V_178 = & V_258 ;
V_258 . V_1 = V_19 -> V_1 ;
V_258 . V_174 = V_19 -> V_174 ;
if ( F_58 ( & V_575 , 1 ) ) {
int V_316 = V_282 -> V_578 ( V_277 , V_314 , & V_575 ) ;
if ( V_316 == 0 )
...
struct V_576 V_258 ;
if ( V_325 && V_325 -> V_571 )
return F_113 ( V_325 , V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return F_113 ( NULL , V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_579 )
return V_282 -> V_579 ( V_277 , V_314 , V_19 ) ;
if ( V_282 -> V_580 == NULL )
return - V_327 ;
V_575 . V_176 = F_59 ( V_19 -> V_1 ) ;
V_575 . V_93 = 1 ;
...
V_258 . V_174 = V_19 -> V_174 ;
if ( F_58 ( & V_575 , 1 ) )
return V_282 -> V_580 ( V_277 , V_314 , & V_575 ) ;
return - V_298 ;
}
...
if ( V_325 && V_325 -> V_571 )
return F_115 ( V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return F_115 ( V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_578 == NULL )
return - V_327 ;
...
V_19 -> V_177 = V_19 -> V_93 ;
if ( V_325 && V_325 -> V_571 )
return F_117 ( V_325 , V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return F_117 ( NULL , V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_580 == NULL )
return - V_327 ;
return F_58 ( V_19 , 0 ) ? V_282 -> V_580 ( V_277 , V_314 , V_19 ) :
- V_298 ;
}
...
V_19 -> V_177 = V_19 -> V_93 ;
if ( V_325 && V_325 -> V_571 )
return F_119 ( V_325 -> V_571 , V_19 ) ;
if ( V_280 -> V_571 )
return F_119 ( V_280 -> V_571 , V_19 ) ;
if ( V_282 -> V_581 == NULL )
return - V_327 ;
return F_58 ( V_19 , 0 ) ? V_282 -> V_581 ( V_277 , V_314 , V_19 ) :
- V_298 ;
}
...
V_19 -> type = V_58 ;
V_316 = V_282 -> V_583 ( V_277 , V_314 , V_19 ) ;
V_19 -> type = V_582 ;
return V_316 ;
}
...
V_19 -> type = V_58 ;
V_316 = V_282 -> V_584 ( V_277 , V_314 , V_19 ) ;
V_19 -> type = V_582 ;
return V_316 ;
}
...
int V_316 ;
if ( V_282 -> V_586 )
return V_282 -> V_586 ( V_277 , V_314 , V_19 ) ;
if ( F_123 ( V_19 -> type ) )
V_585 . V_186 = V_587 ;
else
V_585 . V_186 = V_588 ;
V_316 = F_120 ( V_282 , V_277 , V_314 , & V_585 ) ;
if ( ! V_316 )
V_19 -> V_151 = V_585 . V_187 ;
return V_316 ;
}
...
if ( V_282 -> V_589 )
return V_282 -> V_589 ( V_277 , V_314 , V_19 ) ;
if ( F_123 ( V_19 -> type ) )
V_585 . V_186 = V_587 ;
else
V_585 . V_186 = V_588 ;
return F_121 ( V_282 , V_277 , V_314 , & V_585 ) ;
}
static int F_125 ( const struct V_281 * V_282 ,
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
struct V_180 * V_19 = V_16 ;
struct V_185 V_585 = { . type = V_19 -> type } ;
int V_316 = 0 ;
V_19 -> V_183 . V_10 = 1 ;
V_19 -> V_183 . V_11 = 1 ;
if ( F_78 ( ! V_282 -> V_590 && ! V_282 -> V_583 ) )
return - V_327 ;
if ( V_282 -> V_590 )
V_316 = V_282 -> V_590 ( V_277 , V_314 , V_19 ) ;
if ( ! V_282 -> V_583 )
return V_316 ;
if ( V_316 && V_316 != - V_327 && V_316 != - V_591 )
return V_316 ;
if ( F_123 ( V_19 -> type ) )
V_585 . V_186 = V_592 ;
else
...
if ( ! F_129 ( V_601 ) )
return - V_602 ;
if ( V_19 -> V_206 . type == V_603 ) {
if ( V_280 -> V_596 == NULL )
return - V_298 ;
F_130 (sd, vfd->v4l2_dev)
if ( V_19 -> V_206 . V_208 == V_600 ++ )
return F_131 ( V_599 , V_604 , V_605 , V_19 ) ;
return - V_298 ;
}
if ( V_282 -> V_606 && V_19 -> V_206 . type == V_607 &&
( V_282 -> V_608 || V_19 -> V_206 . V_208 == 0 ) )
...
F_130 (sd, vfd->v4l2_dev)
if ( V_19 -> V_206 . V_208 == V_600 ++ )
return F_131 ( V_599 , V_604 , V_609 , V_19 ) ;
return - V_298 ;
}
if ( V_282 -> V_610 && V_19 -> V_206 . type == V_607 &&
( V_282 -> V_608 || V_19 -> V_206 . V_208 == 0 ) )
...
if ( V_282 -> V_606 )
V_19 -> V_39 |= V_612 ;
F_5 ( V_19 -> V_14 , V_280 -> V_596 -> V_14 , sizeof( V_19 -> V_14 ) ) ;
if ( V_282 -> V_608 )
return V_282 -> V_608 ( V_277 , V_314 , V_16 ) ;
if ( V_19 -> V_206 . V_208 )
return - V_298 ;
return 0 ;
case V_603 :
...
if ( V_19 -> V_206 . V_208 != V_600 ++ )
continue;
if ( V_599 -> V_282 -> V_604 && V_599 -> V_282 -> V_604 -> V_609 )
V_19 -> V_39 |= V_611 ;
if ( V_599 -> V_282 -> V_604 && V_599 -> V_282 -> V_604 -> V_605 )
V_19 -> V_39 |= V_612 ;
F_5 ( V_19 -> V_14 , V_599 -> V_14 , sizeof( V_19 -> V_14 ) ) ;
return 0 ;
}
break;
}
...
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
return F_135 ( V_314 , V_16 , V_277 -> V_613 & V_614 ) ;
}
static int F_136 ( const struct V_281 * V_282 ,
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
return V_282 -> V_615 ( V_314 , V_16 ) ;
}
static int F_137 ( const struct V_281 * V_282 ,
struct V_277 * V_277 , void * V_314 , void * V_16 )
{
return V_282 -> V_616 ( V_314 , V_16 ) ;
}
...
return V_282 -> V_617 ( V_277 , V_314 , V_19 ) ;
}
...
if ( V_282 -> V_618 ) {
V_534 = V_282 -> V_618 ( V_277 , V_314 , V_19 ) ;
if ( V_534 != - V_327 )
return V_534 ;
}
if ( F_75 ( V_280 , V_619 ) ) {
...
if ( V_19 -> V_27 )
return - V_298 ;
V_534 = V_282 -> V_538 ( V_277 , V_314 , & V_620 ) ;
if ( V_534 )
return V_534 ;
V_19 -> V_35 = V_620 . V_35 | V_539 ;
V_19 -> V_108 = V_620 . V_108 ;
V_19 -> V_109 = V_620 . V_109 ;
V_19 -> V_268 = ( type == V_536 ) ?
V_621 : V_622 ;
return 0 ;
}
if ( F_75 ( V_280 , V_623 ) ) {
...
if ( V_19 -> V_27 )
return - V_298 ;
V_534 = V_282 -> V_541 ( V_277 , V_314 , & V_133 ) ;
if ( V_534 )
return V_534 ;
V_19 -> V_35 = V_133 . V_35 | V_539 ;
...
{
if ( F_141 ( V_198 ) >= V_624 )
return false ;
return V_625 [ F_141 ( V_198 ) ] . V_626 == V_198 ;
}
struct V_627 * F_142 ( struct V_279 * V_628 , unsigned V_198 )
{
if ( F_141 ( V_198 ) >= V_624 )
return V_628 -> V_629 ;
if ( F_72 ( F_141 ( V_198 ) , V_628 -> V_630 ) )
return NULL ;
if ( V_628 -> V_631 && V_628 -> V_631 -> V_629 &&
( V_625 [ F_141 ( V_198 ) ] . V_39 & V_632 ) )
return V_628 -> V_631 -> V_629 ;
return V_628 -> V_629 ;
}
void F_143 ( const char * V_633 , unsigned int V_198 )
{
const char * V_634 , * type ;
if ( V_633 )
F_15 ( V_74 L_248 , V_633 ) ;
switch ( F_144 ( V_198 ) ) {
case 'd' :
type = L_249 ;
break;
...
F_7 ( L_251 , V_625 [ F_141 ( V_198 ) ] . V_14 ) ;
return;
default:
type = L_252 ;
break;
...
switch ( F_145 ( V_198 ) ) {
case V_635 : V_634 = L_253 ; break;
case V_636 : V_634 = L_254 ; break;
case V_637 : V_634 = L_255 ; break;
case V_636 | V_637 : V_634 = L_256 ; break;
default: V_634 = L_257 ; break;
}
F_7 ( L_258 ,
type , F_144 ( V_198 ) , V_634 , F_141 ( V_198 ) , V_198 ) ;
}
...
bool V_17 = false ;
struct V_638 V_639 ;
const struct V_638 * V_640 ;
void * V_314 = V_277 -> V_328 ;
struct V_324 * V_325 = NULL ;
int V_641 = V_280 -> V_641 ;
long V_316 = - V_327 ;
if ( V_282 == NULL ) {
F_147 ( L_259 ,
F_148 ( V_280 ) ) ;
...
V_325 = V_277 -> V_328 ;
if ( F_140 ( V_198 ) ) {
V_640 = & V_625 [ F_141 ( V_198 ) ] ;
if ( ! F_72 ( F_141 ( V_198 ) , V_280 -> V_642 ) &&
! ( ( V_640 -> V_39 & V_643 ) && V_325 && V_325 -> V_571 ) )
goto V_644;
if ( V_325 && ( V_640 -> V_39 & V_645 ) ) {
...
V_17 = F_145 ( V_198 ) == V_637 ;
if ( V_640 -> V_39 & V_647 ) {
typedef int (* F_150)( struct V_277 * V_277 , void * V_314 , void * V_19 );
const void * V_19 = V_280 -> V_283 ;
const F_150 * V_648 = V_19 + V_640 -> V_256 . V_89 ;
V_316 = (* V_648)( V_277 , V_314 , V_16 ) ;
} else if ( V_640 -> V_39 & V_649 ) {
V_316 = V_640 -> V_256 . V_650 ( V_282 , V_277 , V_314 , V_16 ) ;
} else if ( ! V_282 -> V_651 ) {
V_316 = - V_327 ;
} else {
V_316 = V_282 -> V_651 ( V_277 , V_314 ,
V_325 ? F_149 ( V_280 -> V_323 , V_325 -> V_323 ) >= 0 : 0 ,
V_198 , V_16 ) ;
}
V_644:
if ( V_641 & ( V_652 | V_653 ) ) {
if ( ! ( V_641 & V_654 ) &&
( V_198 == V_655 || V_198 == V_656 ) )
return V_316 ;
...
if ( ! ( V_641 & V_653 ) )
F_7 ( L_30 ) ;
else if ( F_145 ( V_198 ) == V_635 )
V_640 -> V_646 ( V_16 , V_17 ) ;
else {
F_7 ( L_261 ) ;
V_640 -> V_646 ( V_16 , V_17 ) ;
}
...
static int F_151 ( unsigned int V_198 , void * V_657 , T_4 * V_658 ,
void T_3 * * V_659 , void * * * V_660 )
{
int V_316 = 0 ;
switch ( V_198 ) {
case V_661 :
...
case V_655 :
case V_656 : {
struct V_123 * V_663 = V_657 ;
if ( F_26 ( V_663 -> type ) && V_663 -> V_135 > 0 ) {
if ( V_663 -> V_135 > V_664 ) {
V_316 = - V_298 ;
break;
}
* V_659 = ( void T_3 * ) V_663 -> V_133 . V_134 ;
* V_660 = ( void * * ) & V_663 -> V_133 . V_134 ;
* V_658 = sizeof( struct V_127 ) * V_663 -> V_135 ;
V_316 = 1 ;
}
break;
}
case V_665 :
case V_666 : {
struct V_269 * V_667 = V_657 ;
if ( V_667 -> V_272 ) {
if ( V_667 -> V_272 > 256 ) {
V_316 = - V_298 ;
break;
}
* V_659 = ( void T_3 * ) V_667 -> V_667 ;
* V_660 = ( void * * ) & V_667 -> V_667 ;
* V_658 = V_667 -> V_272 * 128 ;
V_316 = 1 ;
}
break;
}
...
case V_669 :
case V_670 : {
struct V_175 * V_575 = V_657 ;
if ( V_575 -> V_93 != 0 ) {
if ( V_575 -> V_93 > V_671 ) {
V_316 = - V_298 ;
break;
}
* V_659 = ( void T_3 * ) V_575 -> V_178 ;
* V_660 = ( void * * ) & V_575 -> V_178 ;
* V_658 = sizeof( struct V_576 )
* V_575 -> V_93 ;
V_316 = 1 ;
}
break;
...
void T_3 * V_659 = NULL ;
void * * V_660 = NULL ;
if ( F_145 ( V_198 ) != V_635 ) {
if ( F_153 ( V_198 ) <= sizeof( V_672 ) ) {
V_657 = V_672 ;
} else {
V_673 = F_154 ( F_153 ( V_198 ) , V_676 ) ;
if ( NULL == V_673 )
return - V_677 ;
V_657 = V_673 ;
}
V_534 = - V_678 ;
if ( F_145 ( V_198 ) & V_637 ) {
unsigned int V_679 = F_153 ( V_198 ) ;
if ( F_140 ( V_198 ) ) {
T_2 V_39 = V_625 [ F_141 ( V_198 ) ] . V_39 ;
if ( V_39 & V_680 )
V_679 = ( V_39 & V_680 ) >> 16 ;
V_675 = V_39 & V_681 ;
}
if ( F_155 ( V_657 , ( void T_3 * ) V_16 , V_679 ) )
goto V_682;
if ( V_679 < F_153 ( V_198 ) )
memset ( ( V_683 * ) V_657 + V_679 , 0 , F_153 ( V_198 ) - V_679 ) ;
} else {
memset ( V_657 , 0 , F_153 ( V_198 ) ) ;
}
}
V_534 = F_151 ( V_198 , V_657 , & V_658 , & V_659 , & V_660 ) ;
if ( V_534 < 0 )
goto V_682;
V_674 = V_534 ;
if ( V_674 ) {
V_673 = F_154 ( V_658 , V_676 ) ;
V_534 = - V_677 ;
if ( NULL == V_673 )
goto V_684;
V_534 = - V_678 ;
if ( F_155 ( V_673 , V_659 , V_658 ) )
goto V_684;
* V_660 = V_673 ;
}
V_534 = V_650 ( V_277 , V_198 , V_657 ) ;
if ( V_534 == - V_591 )
V_534 = - V_327 ;
if ( V_534 == 0 ) {
if ( V_198 == V_656 )
F_156 ( F_61 ( V_277 ) -> V_685 , V_657 ) ;
else if ( V_198 == V_655 )
F_157 ( F_61 ( V_277 ) -> V_685 , V_657 ) ;
}
if ( V_674 ) {
* V_660 = ( void V_686 * ) V_659 ;
if ( F_158 ( V_659 , V_673 , V_658 ) )
V_534 = - V_678 ;
goto V_684;
}
if ( V_534 < 0 && ! V_675 )
...
case V_636 :
case ( V_637 | V_636 ) :
if ( F_158 ( ( void T_3 * ) V_16 , V_657 , F_153 ( V_198 ) ) )
V_534 = - V_678 ;
break;
}
V_682:
