...
( V_43 & V_29 ) ) {
* V_8 ++ = V_26 ;
* V_8 ++ = V_4 -> V_27 ? : V_4 -> V_28 ;
* V_8 ++ = V_4 -> V_28 ? : V_4 -> V_27 ;
}
if ( ( V_4 -> V_31 || V_4 -> V_32 ) &&
( V_43 & V_33 ) ) {
* V_8 ++ = V_30 ;
* V_8 ++ = V_4 -> V_31 ? : V_4 -> V_32 ;
* V_8 ++ = V_4 -> V_32 ? : V_4 -> V_31 ;
}
if ( V_43 & ( V_39 | V_41 ) ) {
* V_8 ++ = V_24 ;
* V_8 ++ = V_44 ;
...
if ( V_53 . V_27 && V_53 . V_28 ) {
if ( V_53 . V_27 < V_52 -> V_27 ) {
F_7 ( V_47 , L_11 ) ;
V_48 -> V_27 = V_53 . V_27 ;
}
...
if ( V_53 . V_31 && V_53 . V_32 ) {
if ( V_53 . V_31 < V_52 -> V_31 ) {
F_7 ( V_47 , L_13 ) ;
V_48 -> V_31 = V_53 . V_31 ;
}
