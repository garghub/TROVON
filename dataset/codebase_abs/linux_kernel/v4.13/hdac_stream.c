...
void F_53 ( struct V_3 * V_4 , bool V_109 ,
unsigned int V_102 )
{
struct V_1 * V_2 = V_4 -> V_2 ;
int V_81 , V_110 , V_26 ;
...
int F_55 ( struct V_3 * V_4 , unsigned int V_112 ,
unsigned int V_113 , struct V_70 * V_114 )
{
struct V_1 * V_2 = V_4 -> V_2 ;
V_43 * V_44 ;
int V_89 ;
...
V_4 -> V_115 = true ;
F_29 ( & V_2 -> V_67 ) ;
V_89 = V_2 -> V_118 -> V_119 ( V_2 , V_120 ,
V_113 , V_114 ) ;
if ( V_89 < 0 )
goto V_121;
V_4 -> V_31 = NULL ;
...
V_89 = F_32 ( V_2 , V_114 , V_4 , & V_44 , 0 , V_113 , 0 ) ;
if ( V_89 < 0 )
goto error;
F_16 ( V_4 ) ;
F_57 ( V_4 ) ;
...
void F_58 ( struct V_3 * V_4 , bool V_109 )
{
if ( V_109 )
F_4 ( V_4 , true ) ;
else
