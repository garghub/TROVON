...
V_111 -> V_141 = F_58 ( V_56 ) ;
V_111 -> V_142 = F_59 ( V_56 ) ;
if ( F_43 ( V_56 ) )
V_115 |= V_143 ;
else
F_47 ( V_43 , V_56 ) ;
...
V_112 = 9600 ;
if ( V_43 -> V_50 -> V_25 )
V_114 = ( 923077 + V_112 / 2 ) / V_112 ;
else
V_114 = ( 461538 + V_112 / 2 ) / V_112 ;
if ( ( F_56 ( V_56 ) ) != V_138 )
F_61 ( V_56 , V_112 , V_112 ) ;
F_2 ( & V_41 -> V_6 ,
L_20 ,
V_13 , V_112 , V_114 , V_115 ,
V_111 -> V_120 , V_111 -> V_131 , V_111 -> V_135 ,
V_111 -> V_141 , V_111 -> V_142 , V_111 -> V_118 ) ;
V_111 -> V_145 = F_62 ( V_114 ) ;
V_111 -> V_146 = F_62 ( V_115 ) ;
V_12 = F_25 ( V_43 -> V_50 , V_147 ,
...
V_113 &= ~ V_152 ;
F_32 ( & V_43 -> V_44 , V_89 ) ;
return F_63 ( V_43 , V_113 ) ;
}
static void F_66 ( struct V_55 * V_56 , int V_164 )
{
struct V_40 * V_41 = V_56 -> V_95 ;
struct V_42 * V_43 = F_20 ( V_41 ) ;
int V_12 ;
F_2 ( & V_41 -> V_6 , L_24 , V_13 , V_164 ) ;
V_12 = F_67 ( V_41 , V_43 -> V_50 ,
V_43 -> V_45 + V_165 ,
V_166 , V_164 == - 1 ? V_166 : 0 ) ;
if ( V_12 )
F_2 ( & V_41 -> V_6 , L_25 , V_13 , V_12 ) ;
}
...
struct V_42 * V_43 ;
struct V_168 * V_6 = & V_57 -> V_6 -> V_6 ;
unsigned char * V_93 = V_57 -> V_169 ;
int V_170 = V_57 -> V_171 ;
int V_58 ;
int V_172 ;
int V_12 = V_57 -> V_12 ;
int V_173 ;
...
case - V_175 :
case - V_176 :
F_2 ( V_6 , L_26 , V_13 , V_12 ) ;
return;
default:
F_11 ( V_6 , L_27 , V_13 , V_12 ) ;
goto exit;
}
if ( V_170 != 2 ) {
F_2 ( V_6 , L_28 , V_13 , V_170 ) ;
goto exit;
}
if ( V_93 [ 0 ] == V_177 ) {
F_11 ( V_6 , L_29 , V_13 , V_93 [ 1 ] ) ;
goto exit;
}
V_58 = F_68 ( V_93 [ 0 ] ) ;
V_172 = F_69 ( V_93 [ 0 ] ) ;
F_2 ( V_6 , L_30 ,
V_13 , V_58 , V_172 , V_93 [ 1 ] ) ;
if ( V_58 >= V_2 -> V_38 ) {
F_11 ( V_6 , L_31 ,
V_13 , V_58 ) ;
goto exit;
...
if ( V_57 -> V_171 ) {
F_73 ( V_6 , V_13 , V_57 -> V_171 ,
V_57 -> V_169 ) ;
if ( ! V_43 -> V_87 )
F_2 ( V_6 , L_37 ,
V_13 ) ;
else
F_74 ( V_41 , V_57 -> V_169 , V_57 -> V_171 ) ;
F_75 ( & V_43 -> V_44 ) ;
V_41 -> V_182 . V_183 += V_57 -> V_171 ;
F_76 ( & V_43 -> V_44 ) ;
}
exit:
F_75 ( & V_43 -> V_44 ) ;
...
int V_186 ;
do {
V_186 = F_79 ( & V_41 -> V_41 , V_93 , V_170 ) ;
if ( V_186 < V_170 ) {
F_11 ( & V_41 -> V_6 , L_39 ,
V_13 , V_170 - V_186 ) ;
if ( V_186 == 0 )
...
F_83 ( V_41 -> V_2 -> V_6 ,
V_41 -> V_189 ) ,
V_41 -> V_82 -> V_169 , V_94 ,
F_77 , V_43 ) ;
V_148 = F_23 ( V_41 -> V_82 , V_180 ) ;
if ( V_148 ) {
F_78 ( V_41 , L_40 ,
V_13 , V_148 ) ;
V_43 -> V_90 = 0 ;
...
static int F_63 ( struct V_42 * V_43 , unsigned int V_113 )
{
unsigned long V_89 ;
int V_12 ;
V_12 = F_67 ( V_43 -> V_49 , V_43 -> V_50 ,
V_43 -> V_45 + V_191 ,
V_66 | V_67 | V_152 , V_113 ) ;
F_30 ( & V_43 -> V_44 , V_89 ) ;
if ( ! V_12 )
V_43 -> V_65 = V_113 ;
F_32 ( & V_43 -> V_44 , V_89 ) ;
...
V_93 = F_51 ( V_192 , V_20 ) ;
if ( ! V_93 )
return - V_21 ;
V_12 = F_85 ( V_4 , V_194 ,
( V_75 ) ( V_76 + V_58 ) , 0 , ( V_75 * ) V_93 , V_192 ) ;
if ( V_12 ) {
F_11 ( & V_41 -> V_6 ,
L_41 ,
V_13 , V_12 ) ;
...
F_2 ( & V_41 -> V_6 , L_42 , V_13 , V_93 -> V_196 ) ;
* V_99 = V_93 -> V_196 ;
V_195:
F_12 ( V_93 ) ;
return V_12 ;
...
struct V_104 V_198 ;
unsigned V_199 ;
V_199 = V_41 -> V_41 . V_48 ;
if ( V_199 != V_200 )
V_199 = F_86 ( V_199 ) / 10 ;
memset ( & V_198 , 0 , sizeof( V_198 ) ) ;
V_198 . type = V_201 ;
V_198 . line = V_41 -> V_202 ;
V_198 . V_41 = V_41 -> V_58 ;
V_198 . V_203 = F_87 ( & V_41 -> V_91 ) ;
V_198 . V_204 = V_43 -> V_50 -> V_25 ? 921600 : 460800 ;
V_198 . V_48 = V_199 ;
if ( F_88 ( V_197 , & V_198 , sizeof( * V_197 ) ) )
return - V_205 ;
return 0 ;
}
static int F_50 ( struct V_55 * V_56 , struct V_42 * V_43 ,
struct V_104 V_105 * V_206 )
{
struct V_104 V_207 ;
unsigned V_199 ;
if ( F_89 ( & V_207 , V_206 , sizeof( V_207 ) ) )
return - V_205 ;
V_199 = V_207 . V_48 ;
if ( V_199 != V_200 )
V_199 = F_17 ( 10 * V_207 . V_48 ) ;
V_43 -> V_49 -> V_41 . V_48 = V_199 ;
return 0 ;
}
static void F_71 ( struct V_42 * V_43 , T_2 V_149 )
{
struct V_208 * V_182 ;
struct V_55 * V_56 ;
unsigned long V_89 ;
F_2 ( & V_43 -> V_49 -> V_6 , L_43 , V_13 , V_149 ) ;
if ( V_149 & V_209 ) {
F_30 ( & V_43 -> V_44 , V_89 ) ;
V_182 = & V_43 -> V_49 -> V_182 ;
if ( V_149 & V_210 )
V_182 -> V_211 ++ ;
if ( V_149 & V_212 )
V_182 -> V_213 ++ ;
...
if ( V_149 & V_216 )
V_182 -> V_217 ++ ;
F_90 ( & V_43 -> V_49 -> V_41 . V_218 ) ;
F_32 ( & V_43 -> V_44 , V_89 ) ;
}
V_43 -> V_64 = V_149 & V_219 ;
...
static int F_25 ( struct V_3 * V_4 , V_75 V_220 ,
T_3 V_221 , T_3 V_222 , V_75 * V_93 , int V_192 )
{
int V_12 ;
V_12 = F_94 ( V_4 -> V_23 -> V_6 ,
F_95 ( V_4 -> V_23 -> V_6 , 0 ) , V_220 ,
( V_223 | V_224 | V_225 ) ,
V_222 , V_221 , V_93 , V_192 , 1000 ) ;
if ( V_12 < 0 )
return V_12 ;
return 0 ;
}
static int F_85 ( struct V_3 * V_4 , V_75 V_220 ,
T_3 V_221 , T_3 V_222 , V_75 * V_93 , int V_192 )
{
int V_12 ;
V_12 = F_94 ( V_4 -> V_23 -> V_6 ,
F_96 ( V_4 -> V_23 -> V_6 , 0 ) , V_220 ,
( V_223 | V_224 | V_226 ) ,
V_222 , V_221 , V_93 , V_192 , 1000 ) ;
if ( V_12 == V_192 )
V_12 = 0 ;
...
struct V_3 * V_4 , unsigned long V_228 ,
T_2 V_229 , T_2 V_230 )
{
int V_12 ;
unsigned int V_192 ;
struct V_231 * V_93 ;
F_2 ( & V_41 -> V_6 , L_44 , V_13 ,
V_228 , V_229 , V_230 ) ;
V_192 = sizeof( struct V_231 ) + 2 ;
V_93 = F_51 ( V_192 , V_20 ) ;
if ( ! V_93 )
return - V_21 ;
V_93 -> V_232 = V_233 ;
V_93 -> V_234 = V_235 ;
V_93 -> V_236 = 1 ;
V_93 -> V_237 = F_62 ( V_228 >> 16 ) ;
V_93 -> V_238 = F_62 ( V_228 ) ;
V_93 -> V_239 [ 0 ] = V_229 ;
V_93 -> V_239 [ 1 ] = V_230 ;
V_12 = F_25 ( V_4 , V_240 , V_241 , 0 ,
( V_75 * ) V_93 , V_192 ) ;
if ( V_12 < 0 )
F_11 ( & V_41 -> V_6 , L_45 , V_13 , V_12 ) ;
F_12 ( V_93 ) ;
return V_12 ;
}
...
int V_12 = 0 ;
int V_248 ;
for ( V_243 = sizeof( struct V_246 ) ; V_243 < V_192 ; V_243 ++ )
V_244 = ( T_2 ) ( V_244 + V_242 [ V_243 ] ) ;
V_247 = (struct V_246 * ) V_242 ;
V_247 -> V_249 = F_98 ( V_192 - sizeof( * V_247 ) ) ;
V_247 -> V_250 = V_244 ;
F_2 ( & V_6 -> V_6 , L_46 , V_13 ) ;
for ( V_243 = 0 ; V_243 < V_192 ; V_243 += V_245 ) {
V_248 = F_99 ( V_192 - V_243 , V_251 ) ;
V_12 = F_100 ( V_6 , V_83 , V_242 + V_243 , V_248 ,
& V_245 , 1000 ) ;
if ( V_12 )
break;
}
...
L_47 ,
F_3 ( V_6 -> V_14 . V_15 ) ) ;
V_12 = F_101 ( & V_254 , V_255 , & V_6 -> V_6 ) ;
goto V_256;
}
sprintf ( V_255 , L_48 ,
F_3 ( V_6 -> V_14 . V_26 ) ,
...
V_256:
if ( V_12 ) {
F_11 ( & V_6 -> V_6 , L_56 , V_13 ) ;
return - V_175 ;
}
if ( V_254 -> V_192 > V_264 ) {
F_11 ( & V_6 -> V_6 , L_57 , V_13 , V_254 -> V_192 ) ;
F_102 ( V_254 ) ;
return - V_175 ;
}
V_252 = V_264 + sizeof( struct V_246 ) ;
V_242 = F_51 ( V_252 , V_20 ) ;
if ( V_242 ) {
memcpy ( V_242 , V_254 -> V_93 , V_254 -> V_192 ) ;
memset ( V_242 + V_254 -> V_192 , 0xff , V_252 - V_254 -> V_192 ) ;
V_12 = F_97 ( V_6 , V_83 , V_242 , V_254 -> V_192 ) ;
F_12 ( V_242 ) ;
} else {
V_12 = - V_21 ;
}
