...
static unsigned int F_69 ( struct V_126 * V_127 ,
unsigned char * V_88 ,
unsigned int V_184 , int V_185 )
{
struct V_5 * V_6 = V_127 -> V_25 -> V_24 -> V_6 ;
void T_1 * V_12 = ( void T_1 * ) V_6 -> V_13 . V_14 ;
...
static int F_103 ( struct V_239 * V_240 )
{
struct V_229 * V_230 = F_104 ( V_240 ) ;
F_105 ( V_230 ) ;
F_100 ( V_253 ) ;
return 0 ;
}
static int F_106 ( struct V_239 * V_240 , T_4 V_258 )
{
struct V_229 * V_230 = F_104 ( V_240 ) ;
if ( V_230 )
return F_107 ( V_230 , V_258 ) ;
else
return 0 ;
}
