...
static int F_137 ( struct V_312 * V_57 , void * V_348 ,
struct V_349 * V_350 ,
struct V_351 * V_352 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
struct V_281 V_353 ;
unsigned int V_354 = V_352 -> V_355 . V_279 ;
F_23 ( V_8 -> V_57 , L_38 , V_191 ,
V_352 -> V_190 , V_352 -> V_356 , V_354 ) ;
if ( ! V_8 -> V_4 . V_310 )
return - V_301 ;
switch ( V_354 ) {
case 2 :
...
memcpy ( & V_353 . V_261 , V_352 ,
sizeof( V_353 . V_261 ) ) ;
F_80 ( V_8 , & V_353 ) ;
return 0 ;
}
static int F_138 ( struct V_312 * V_57 , void * V_348 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
...
static void F_139 ( struct V_312 * V_57 , void * V_348 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_42 , V_191 ) ;
F_79 ( V_8 ) ;
...
static int
F_140 ( struct V_312 * V_57 , void * V_348 , bool V_21 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
...
static int F_141 ( struct V_312 * V_57 , void * V_348 , T_5 * V_359 , T_6 V_46 )
{
struct V_1 * V_8 = F_110 ( V_57 ) ;
F_23 ( V_57 , L_42 , V_191 ) ;
memcpy ( V_359 , V_8 -> V_7 . V_360 , F_142 ( sizeof( V_8 -> V_7 . V_360 ) , V_46 ) ) ;
return 0 ;
}
...
struct V_312 * V_57 = & V_335 -> V_57 ;
int V_247 ;
V_8 = F_147 ( V_57 , sizeof( * V_8 ) , V_369 ) ;
if ( ! V_8 )
return - V_370 ;
V_8 -> V_57 = V_57 ;
