...
static int F_42 ( struct V_1 * V_2 , T_3 V_34 )
{
return V_49 . V_57 ( V_2 , V_34 ) ;
}
static int F_43 ( struct V_21 * V_22 , struct V_1 * V_2 ,
const char * V_58 , unsigned long V_18 )
{
V_22 -> V_18 = V_18 ;
F_26 ( V_22 -> V_11 = 0 ) ;
V_22 -> V_22 = F_44 ( V_58 , V_2 , V_18 ,
0 ,
0 ) ;
return V_22 -> V_22 ? 0 : - V_59 ;
}
int F_45 ( struct V_1 * V_2 , unsigned long V_60 ,
unsigned long V_61 ,
