...
F_23 ( V_6 , V_2 -> V_93 / 4 ) ;
F_25 ( V_5 , V_2 -> V_93 / 4 ) ;
F_26 (KERN_WARNING MPT3SAS_FMT L_27 \
L_28 \
L_29 , \
ioc->name, __func__,
...
F_23 ( V_6 , V_2 -> V_93 / 4 ) ;
F_25 ( V_5 , V_2 -> V_93 / 4 ) ;
F_27 ( V_97 , F_17 ( T_1 , V_37 . V_39 ,
V_40 ) / 4 ) ;
F_26 (KERN_WARNING MPT3SAS_FMT
L_27 \
L_33
L_34
L_29 ,
...
* V_5 , T_20 * V_48 , T_5 V_114 , T_5 V_115 )
{
T_3 V_6 ;
int V_38 ;
memset ( & V_6 , 0 , sizeof( T_3 ) ) ;
...
* V_5 , T_22 * V_48 , T_5 V_114 , T_5 V_115 )
{
T_3 V_6 ;
int V_38 ;
memset ( & V_6 , 0 , sizeof( T_3 ) ) ;
...
int
F_57 ( struct V_1 * V_2 , T_6
* V_5 , T_27 * V_48 , T_5 V_114 ,
T_5 V_136 )
{
T_3 V_6 ;
int V_38 ;
...
if ( V_66 != V_95 )
goto V_75;
for ( V_140 = 0 ; V_140 < V_48 -> V_146 ; V_140 ++ ) {
V_142 = F_5 ( V_48 ->
V_147 [ V_140 ] . V_148 ) &
V_149 ;
if ( V_142 ==
