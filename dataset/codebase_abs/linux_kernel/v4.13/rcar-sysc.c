...
V_12 = V_72 ;
V_67 = F_24 ( sizeof( * V_67 ) , V_81 ) ;
if ( ! V_67 ) {
error = - V_79 ;
goto V_80;
}
V_67 -> V_82 . V_67 = V_67 -> V_67 ;
V_67 -> V_82 . V_83 = F_25 ( V_67 -> V_67 ) ;
for ( V_73 = 0 , V_70 = 0 ; V_73 < V_63 -> V_84 ; V_73 ++ )
V_70 |= F_3 ( V_63 -> V_85 [ V_73 ] . V_19 ) ;
V_71 = F_2 ( V_72 + V_86 ) ;
V_71 |= V_70 ;
F_9 ( L_12 , V_69 -> V_78 , V_71 ) ;
F_5 ( V_71 , V_72 + V_86 ) ;
F_9 ( L_13 , V_69 -> V_78 , V_70 ) ;
F_5 ( V_70 , V_72 + V_87 ) ;
for ( V_73 = 0 ; V_73 < V_63 -> V_84 ; V_73 ++ ) {
const struct V_88 * V_89 = & V_63 -> V_85 [ V_73 ] ;
struct V_36 * V_40 ;
if ( ! V_89 -> V_42 ) {
continue;
}
V_40 = F_24 ( sizeof( * V_40 ) + strlen ( V_89 -> V_42 ) + 1 , V_81 ) ;
if ( ! V_40 ) {
error = - V_79 ;
goto V_80;
}
strcpy ( V_40 -> V_42 , V_89 -> V_42 ) ;
V_40 -> V_39 . V_42 = V_40 -> V_42 ;
V_40 -> V_43 . V_17 = V_89 -> V_17 ;
V_40 -> V_43 . V_16 = V_89 -> V_16 ;
V_40 -> V_43 . V_19 = V_89 -> V_19 ;
V_40 -> V_22 = V_89 -> V_22 ;
F_17 ( V_40 ) ;
if ( V_89 -> V_90 >= 0 )
F_26 ( V_67 -> V_67 [ V_89 -> V_90 ] ,
& V_40 -> V_39 ) ;
V_67 -> V_67 [ V_89 -> V_19 ] = & V_40 -> V_39 ;
}
error = F_27 ( V_69 , & V_67 -> V_82 ) ;
V_80:
F_28 ( V_69 ) ;
return error ;
}
void T_1 F_29 ( struct V_88 * V_85 ,
unsigned int V_84 , T_4 V_91 )
{
unsigned int V_73 ;
for ( V_73 = 0 ; V_73 < V_84 ; V_73 ++ )
if ( V_85 [ V_73 ] . V_19 == V_91 ) {
V_85 [ V_73 ] . V_42 = NULL ;
return;
}
}
