...
T_2 V_24 , const char * V_25 )
{
int V_15 ;
for ( V_15 = 0 ; V_15 < V_2 -> V_13 ; V_15 ++ )
if ( V_2 -> V_10 [ V_15 ] == V_24 )
return V_15 ;
if ( V_2 -> V_13 == V_2 -> V_9 ) {
V_15 = F_7 ( V_2 ) ;
if ( V_15 )
...
V_15 = V_2 -> V_13 ++ ;
V_2 -> V_10 [ V_15 ] = V_24 ;
V_2 -> V_11 [ V_15 ] = F_9 ( V_25 ) ;
return V_15 ;
}
int F_10 ( struct V_1 * V_2 ,
T_1 V_4 , T_1 V_5 ,
T_2 V_24 , const char * V_25 , T_2 V_6 )
{
int V_26 , V_27 ;
V_26 = F_6 ( V_2 , V_4 , V_5 ) ;
if ( V_26 < 0 )
return V_26 ;
V_27 = F_8 ( V_2 , V_24 , V_25 ) ;
if ( V_27 < 0 )
return V_27 ;
V_2 -> V_6 [ V_26 ] [ V_27 ] = V_6 ;
return 0 ;
}
static void F_11 ( T_3 * V_28 ,
struct V_1 * V_2 )
{
int V_15 , V_29 ;
int V_30 , V_31 ;
...
V_31 = 3 ;
V_30 = 3 ;
for ( V_29 = 0 ; V_29 < V_2 -> V_13 ; V_29 ++ )
V_32 [ V_29 ] = strlen ( V_2 -> V_11 [ V_29 ] ) ;
for ( V_15 = 0 ; V_15 < V_2 -> V_8 ; V_15 ++ ) {
int V_33 ;
...
V_31 = V_33 ;
for ( V_29 = 0 ; V_29 < V_2 -> V_13 ; V_29 ++ ) {
V_33 = snprintf ( NULL , 0 , L_9 V_34 , V_2 -> V_6 [ V_15 ] [ V_29 ] ) ;
if ( V_33 > V_32 [ V_29 ] )
V_32 [ V_29 ] = V_33 ;
}
}
fprintf ( V_28 , L_10 , V_30 , L_11 , V_31 , L_12 ) ;
for ( V_29 = 0 ; V_29 < V_2 -> V_13 ; V_29 ++ )
fprintf ( V_28 , L_13 , V_32 [ V_29 ] , V_2 -> V_11 [ V_29 ] ) ;
fprintf ( V_28 , L_14 ) ;
for ( V_15 = 0 ; V_15 < V_2 -> V_8 ; V_15 ++ ) {
fprintf ( V_28 , L_15 , V_30 , V_2 -> V_4 [ V_15 ] ,
V_31 , V_2 -> V_5 [ V_15 ] ) ;
for ( V_29 = 0 ; V_29 < V_2 -> V_13 ; V_29 ++ )
fprintf ( V_28 , L_16 V_34 ,
V_32 [ V_29 ] , V_2 -> V_6 [ V_15 ] [ V_29 ] ) ;
fprintf ( V_28 , L_14 ) ;
}
free ( V_32 ) ;
}
static void F_12 ( T_3 * V_28 ,
struct V_1 * V_2 )
{
...
for ( V_29 = 0 ; V_29 < V_2 -> V_13 ; V_29 ++ ) {
V_33 = strlen ( V_2 -> V_11 [ V_29 ] ) ;
if ( V_33 > V_35 )
V_35 = V_33 ;
V_33 = snprintf ( NULL , 0 , L_9 V_38 , V_2 -> V_10 [ V_29 ] ) ;
if ( V_33 > V_36 )
V_36 = V_33 ;
}
for ( V_15 = 0 ; V_15 < V_2 -> V_8 ; V_15 ++ ) {
...
for ( V_15 = 0 ; V_15 < V_2 -> V_8 ; V_15 ++ )
for ( V_29 = 0 ; V_29 < V_2 -> V_13 ; V_29 ++ )
fprintf ( V_28 , L_21 V_38 L_16 V_34 ,
V_30 , V_2 -> V_4 [ V_15 ] ,
V_31 , V_2 -> V_5 [ V_15 ] ,
V_35 , V_2 -> V_11 [ V_29 ] ,
V_36 , V_2 -> V_10 [ V_29 ] ,
V_37 , V_2 -> V_6 [ V_15 ] [ V_29 ] ) ;
}
void F_13 ( T_3 * V_28 , struct V_1 * V_2 , int V_39 )
{
if ( V_39 )
F_12 ( V_28 , V_2 ) ;
else
