...
static int F_22 ( struct V_1 * V_2 , T_1 V_39 , T_1 V_40 )
{
...
T_2 V_67 ;
#if F_33 ( V_137 )
if ( ! F_34 ( V_2 ) && ( V_2 -> V_14 & V_15 ) ) {
struct V_138 * V_139 = F_35 ( V_2 , V_140 ) ;
if ( ! V_139 && ! F_36 ( V_2 , V_140 , V_141 ) )
return V_142 ;
}
#endif
...
return V_110 ;
V_134 = V_58 ;
V_124 = F_37 ( V_57 , V_134 , sizeof( V_125 ) , & V_125 ) ;
F_38 ( ! V_124 ) ;
V_134 += V_124 -> V_145 * 4 ;
V_133 = V_131 - V_124 -> V_145 * 4 ;
V_127 = F_37 ( V_57 , V_134 , sizeof( V_128 ) , & V_128 ) ;
if ( ! V_127 ) {
F_4 ( L_18 ) ;
return V_110 ;
}
V_134 += sizeof( V_128 ) ;
V_133 -= sizeof( V_128 ) ;
if ( F_29 ( V_127 -> V_146 ) != V_147 ||
F_39 ( V_127 -> V_148 ) != V_149 ) {
F_4 ( L_19 ) ;
return V_110 ;
}
V_60 = F_37 ( V_57 , V_134 , sizeof( V_129 ) , & V_129 ) ;
if ( ! V_60 )
return V_110 ;
V_134 += sizeof( V_129 ) ;
V_133 -= sizeof( V_129 ) ;
...
if ( V_63 > sizeof( * V_62 ) )
V_63 = sizeof( * V_62 ) ;
V_62 = F_37 ( V_57 , V_134 , V_63 , & V_130 ) ;
if ( ! V_62 )
return V_110 ;
V_135 = V_66 -> V_74 ;
V_136 = V_66 -> V_88 ;
