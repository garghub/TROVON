...
if ( V_6 -> V_10 . V_150 & V_162 ) {
V_147 = F_62 ( V_6 , V_163 ,
F_61 ( V_163 ) ) ;
if ( V_147 < 0 )
return V_147 ;
}
for ( V_18 = 0 ; V_18 < F_61 ( V_164 ) ; ++ V_18 ) {
if ( ! ( V_6 -> V_10 . V_150 & V_164 [ V_18 ] . V_165 ) )
continue;
V_147 = F_62 ( V_6 , V_164 [ V_18 ] . V_116 ,
F_61 ( V_164 [ V_18 ] . V_116 ) ) ;
if ( V_147 < 0 )
return V_147 ;
}
if ( V_6 -> V_166 ) {
...
if ( V_6 -> V_168 ) {
V_147 = F_62 ( V_6 , V_169 ,
F_61 ( V_169 ) ) ;
if ( V_147 < 0 )
return V_147 ;
}
return V_6 -> V_10 . V_170 ? V_6 -> V_10 . V_170 ( V_6 ) : 0 ;
}
