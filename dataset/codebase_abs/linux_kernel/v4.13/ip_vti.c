...
V_45 -> V_112 = V_115 ;
if ( V_93 [ V_137 ] )
V_45 -> V_138 = F_74 ( V_93 [ V_137 ] ) ;
if ( V_93 [ V_139 ] )
V_45 -> V_46 = F_75 ( V_93 [ V_139 ] ) ;
if ( V_93 [ V_140 ] )
V_45 -> V_85 = F_75 ( V_93 [ V_140 ] ) ;
if ( V_93 [ V_141 ] )
V_45 -> V_9 . V_17 = F_76 ( V_93 [ V_141 ] ) ;
if ( V_93 [ V_142 ] )
V_45 -> V_9 . V_18 = F_76 ( V_93 [ V_142 ] ) ;
if ( V_93 [ V_143 ] )
* V_136 = F_74 ( V_93 [ V_143 ] ) ;
}
static int F_77 ( struct V_10 * V_144 , struct V_28 * V_11 ,
struct V_132 * V_133 [] , struct V_132 * V_93 [] ,
struct V_134 * V_135 )
{
struct V_59 V_45 ;
T_5 V_136 = 0 ;
F_73 ( V_93 , & V_45 , & V_136 ) ;
return F_78 ( V_11 , V_133 , & V_45 , V_136 ) ;
}
static int F_79 ( struct V_28 * V_11 , struct V_132 * V_133 [] ,
struct V_132 * V_93 [] ,
struct V_134 * V_135 )
{
struct V_6 * V_145 = F_29 ( V_11 ) ;
T_5 V_136 = V_145 -> V_136 ;
struct V_59 V_104 ;
F_73 ( V_93 , & V_104 , & V_136 ) ;
return F_80 ( V_11 , V_133 , & V_104 , V_136 ) ;
}
...
{
struct V_6 * V_145 = F_29 ( V_11 ) ;
struct V_59 * V_104 = & V_145 -> V_45 ;
if ( F_84 ( V_2 , V_137 , V_104 -> V_138 ) ||
F_85 ( V_2 , V_139 , V_104 -> V_46 ) ||
F_85 ( V_2 , V_140 , V_104 -> V_85 ) ||
F_86 ( V_2 , V_141 , V_104 -> V_9 . V_17 ) ||
F_86 ( V_2 , V_142 , V_104 -> V_9 . V_18 ) ||
F_84 ( V_2 , V_143 , V_145 -> V_136 ) )
return - V_146 ;
return 0 ;
}
...
goto V_156;
V_153 = L_4 ;
V_27 = F_95 ( & V_157 , V_94 ) ;
if ( V_27 < 0 )
goto V_158;
V_27 = F_95 ( & V_159 , V_96 ) ;
if ( V_27 < 0 )
goto V_160;
V_27 = F_95 ( & V_161 , V_97 ) ;
if ( V_27 < 0 )
goto V_162;
V_153 = L_5 ;
V_27 = F_96 ( & V_130 ) ;
