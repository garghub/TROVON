...
struct V_1 * * F_27 ( struct V_1 * * V_49 , struct V_1 * V_2 )
{
...
F_35 ( V_51 ) -> V_69 = false ;
V_5 = F_3 ( V_51 ) -> V_34 ;
V_56 |= ( V_33 - 1 ) >= V_5 ;
V_56 |= ( F_19 ( V_52 -> V_4 ) + F_33 ( V_51 ) ) ^ F_19 ( V_17 -> V_4 ) ;
if ( V_56 || F_36 ( V_49 , V_2 ) ) {
V_5 = 1 ;
goto V_61;
}
V_51 = * V_49 ;
V_52 = F_9 ( V_51 ) ;
F_34 ( V_52 ) |= V_53 & ( V_63 | V_64 ) ;
V_61:
V_56 = V_33 < V_5 ;
V_56 |= ( V_39 int ) ( V_53 & ( V_70 | V_64 |
V_71 | V_72 |
V_63 ) ) ;
if ( V_51 && ( ! F_35 ( V_2 ) -> V_58 || V_56 ) )
V_50 = V_49 ;
V_31:
F_35 ( V_2 ) -> V_56 |= ( V_56 != 0 ) ;
return V_50 ;
}
...
V_2 -> V_74 = F_38 ( struct V_11 , V_18 ) ;
V_2 -> V_13 = V_14 ;
F_3 ( V_2 ) -> V_36 = F_35 ( V_2 ) -> V_68 ;
if ( V_17 -> V_46 )
F_3 ( V_2 ) -> V_75 |= V_76 ;
return 0 ;
}
static struct V_1 * * F_39 ( struct V_1 * * V_49 , struct V_1 * V_2 )
{
if ( ! F_35 ( V_2 ) -> V_56 &&
F_40 ( V_2 , V_77 ,
V_78 ) ) {
...
return F_27 ( V_49 , V_2 ) ;
}
static int F_41 ( struct V_1 * V_2 , int V_79 )
{
const struct V_15 * V_16 = F_8 ( V_2 ) ;
struct V_11 * V_17 = F_9 ( V_2 ) ;
V_17 -> V_18 = ~ F_42 ( V_2 -> V_33 - V_79 , V_16 -> V_19 ,
V_16 -> V_20 , 0 ) ;
F_3 ( V_2 ) -> V_75 |= V_80 ;
if ( F_35 ( V_2 ) -> V_69 )
F_3 ( V_2 ) -> V_75 |= V_81 ;
