...
switch ( V_24 ) {
case 2 : {
T_1 V_38 [ V_39 ] , V_40 [ 3 ] ;
if ( 2 + V_23 [ 0 ] . V_7 != sizeof( V_40 ) ) {
F_12 ( L_1 ,
V_23 [ 0 ] . V_7 ) ;
V_9 = - V_37 ;
goto V_41;
}
if ( 2 + V_23 [ 1 ] . V_7 > sizeof( V_38 ) ) {
F_12 ( L_2 ,
V_23 [ 1 ] . V_7 ) ;
V_9 = - V_37 ;
goto V_41;
}
V_40 [ 0 ] = V_23 [ 0 ] . V_34 << 1 ;
V_40 [ 1 ] = V_23 [ 0 ] . V_7 ;
V_40 [ 2 ] = V_23 [ 0 ] . V_32 [ 0 ] ;
F_1 ( V_26 -> V_33 , 0xc2 , 0 , 0 ,
V_40 , V_23 [ 0 ] . V_7 + 2 , V_18 ) ;
F_1 ( V_26 -> V_33 , 0xc3 , 0xd1 , 0 ,
V_38 , V_23 [ 1 ] . V_7 + 2 , V_12 ) ;
memcpy ( V_23 [ 1 ] . V_32 , V_38 + 2 , V_23 [ 1 ] . V_7 ) ;
break;
}
case 1 :
switch ( V_23 [ 0 ] . V_34 ) {
...
V_40 [ 0 ] = V_23 [ 0 ] . V_34 << 1 ;
V_40 [ 1 ] = V_23 [ 0 ] . V_7 ;
memcpy ( V_40 + 2 , V_23 [ 0 ] . V_32 , V_23 [ 0 ] . V_7 ) ;
F_1 ( V_26 -> V_33 , 0xc2 , 0 , 0 ,
V_40 , V_23 [ 0 ] . V_7 + 2 , V_18 ) ;
break;
}
...
F_1 ( V_26 -> V_33 , 0xb8 , 0 , 0 ,
V_38 , 2 , V_12 ) ;
memcpy ( V_23 [ 0 ] . V_32 , V_38 , 2 ) ;
break;
}
case ( V_36 ) : {
T_1 V_40 [ 2 ] ;
V_40 [ 0 ] = 0x30 ;
V_40 [ 1 ] = V_23 [ 0 ] . V_32 [ 0 ] ;
F_1 ( V_26 -> V_33 , 0xb2 , 0 , 0 ,
V_40 , 2 , V_18 ) ;
break;
}
...
F_1 ( V_26 -> V_33 , 0xb8 , 0 , 0 ,
V_38 , 2 , V_12 ) ;
memcpy ( V_23 [ V_42 ] . V_32 , V_38 , 2 ) ;
break;
}
case ( V_36 ) : {
T_1 V_40 [ 2 ] ;
V_40 [ 0 ] = 0x30 ;
V_40 [ 1 ] = V_23 [ V_42 ] . V_32 [ 0 ] ;
F_1 ( V_26 -> V_33 , 0xb2 , 0 , 0 ,
V_40 , 2 , V_18 ) ;
break;
}
...
T_1 V_38 [ V_39 ] ;
if ( 2 + V_23 [ V_42 ] . V_7 > sizeof( V_38 ) ) {
F_12 ( L_2 ,
V_23 [ V_42 ] . V_7 ) ;
V_9 = - V_37 ;
goto V_41;
...
V_38 , V_23 [ V_42 ] . V_7 + 2 ,
V_12 ) ;
memcpy ( V_23 [ V_42 ] . V_32 , V_38 + 2 , V_23 [ V_42 ] . V_7 ) ;
F_15 ( 10 ) ;
...
( V_23 [ V_42 ] . V_34 == 0x55 ) ) ) {
T_1 V_40 [ 19 ] ;
V_40 [ 0 ] = V_23 [ V_42 ] . V_34 << 1 ;
V_40 [ 1 ] = ( V_23 [ V_42 ] . V_7 > 15 ? 17 : V_23 [ V_42 ] . V_7 ) ;
V_40 [ 2 ] = V_23 [ V_42 ] . V_32 [ 0 ] ;
V_7 = V_23 [ V_42 ] . V_7 - 1 ;
V_27 = 1 ;
do {
memcpy ( V_40 + 3 , V_23 [ V_42 ] . V_32 + V_27 ,
( V_7 > 16 ? 16 : V_7 ) ) ;
F_1 ( V_26 -> V_33 , 0xc2 , 0 , 0 ,
V_40 , ( V_7 > 16 ? 16 : V_7 ) + 3 ,
V_18 ) ;
V_27 += 16 ;
V_7 -= 16 ;
} while ( V_7 > 0 );
...
T_1 V_40 [ V_39 ] ;
if ( 2 + V_23 [ V_42 ] . V_7 > sizeof( V_40 ) ) {
F_12 ( L_3 ,
V_23 [ V_42 ] . V_7 ) ;
V_9 = - V_37 ;
goto V_41;
...
V_40 [ 0 ] = V_23 [ V_42 ] . V_34 << 1 ;
V_40 [ 1 ] = V_23 [ V_42 ] . V_7 ;
memcpy ( V_40 + 2 , V_23 [ V_42 ] . V_32 , V_23 [ V_42 ] . V_7 ) ;
F_1 ( V_26 -> V_33 , 0xc2 , 0 , 0 ,
V_40 , V_23 [ V_42 ] . V_7 + 2 ,
V_18 ) ;
}
break;
}
...
F_17 ( L_4 , V_27 , V_23 [ V_27 ] . V_34 ,
V_23 [ V_27 ] . V_8 == 0 ? L_5 : L_6 ) ;
...
F_1 ( V_26 -> V_33 , 0xb8 , 0 , 0 ,
V_38 , 5 , V_12 ) ;
memcpy ( V_23 [ V_42 ] . V_32 , V_38 + 3 , 2 ) ;
break;
}
case ( V_36 ) : {
T_1 V_40 [ 2 ] ;
V_40 [ 0 ] = 1 ;
V_40 [ 1 ] = V_23 [ V_42 ] . V_32 [ 1 ] ;
...
V_38 , V_23 [ V_42 ] . V_7 ,
V_12 ) ;
memcpy ( V_23 [ V_42 ] . V_32 , V_38 , V_23 [ V_42 ] . V_7 ) ;
break;
} else if ( ( V_23 [ V_42 ] . V_32 [ 0 ] == 0xb0 ) &&
( V_23 [ V_42 ] . V_34 == 0x68 ) ) {
T_1 V_40 [ 19 ] ;
V_40 [ 0 ] = ( V_23 [ V_42 ] . V_7 > 16 ?
18 : V_23 [ V_42 ] . V_7 + 1 ) ;
V_40 [ 1 ] = V_23 [ V_42 ] . V_34 << 1 ;
V_40 [ 2 ] = V_23 [ V_42 ] . V_32 [ 0 ] ;
V_7 = V_23 [ V_42 ] . V_7 - 1 ;
V_27 = 1 ;
do {
...
break;
default:
if ( 3 + V_23 [ 0 ] . V_7 > sizeof( V_48 -> V_6 ) ) {
F_12 ( L_3 ,
V_23 [ 0 ] . V_7 ) ;
V_24 = - V_37 ;
break;
...
break;
case 2 :
if ( 4 + V_23 [ 0 ] . V_7 > sizeof( V_48 -> V_6 ) ) {
F_12 ( L_2 ,
V_23 [ 0 ] . V_7 ) ;
V_24 = - V_37 ;
break;
}
if ( 1 + V_23 [ 1 ] . V_7 > sizeof( V_48 -> V_6 ) ) {
F_12 ( L_2 ,
V_23 [ 1 ] . V_7 ) ;
V_24 = - V_37 ;
break;
...
if ( F_1 ( V_26 -> V_33 , 0xb6 , 0xa0 , V_27 , V_38 , 2 , V_12 ) < 0 ) {
F_23 ( L_9 ) ;
return - 1 ;
} else {
V_56 [ V_27 % 16 ] = V_38 [ 0 ] ;
...
return - V_117 ;
V_26 -> V_93 [ 0 ] . V_70 -> V_98 . V_107 = F_34 ;
F_1 ( V_26 -> V_2 -> V_33 , 0x8a , 0 , 0 , V_40 , 2 , V_18 ) ;
F_30 ( L_22 ) ;
return 0 ;
}
