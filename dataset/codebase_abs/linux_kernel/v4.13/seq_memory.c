...
if ( F_15 ( ! V_2 ) )
return - V_11 ;
V_61 = F_36 ( sizeof( struct V_19 ) * V_2 -> V_26 ) ;
if ( ! V_61 )
return - V_50 ;
F_16 ( & V_2 -> V_37 , V_8 ) ;
if ( V_2 -> V_25 ) {
...
struct V_1 * F_41 ( int V_62 )
{
struct V_1 * V_2 ;
V_2 = F_42 ( sizeof( * V_2 ) , V_63 ) ;
if ( ! V_2 )
return NULL ;
F_43 ( & V_2 -> V_37 ) ;
V_2 -> V_25 = NULL ;
...
struct V_1 * V_2 , char * V_67 )
{
if ( V_2 == NULL )
return;
F_51 ( V_66 , L_2 , V_67 , V_2 -> V_3 ) ;
F_51 ( V_66 , L_3 , V_67 , F_2 ( & V_2 -> V_4 ) ) ;
F_51 ( V_66 , L_4 , V_67 , V_2 -> V_52 ) ;
F_51 ( V_66 , L_5 , V_67 , V_2 -> V_53 ) ;
F_51 ( V_66 , L_6 , V_67 , V_2 -> V_54 ) ;
}
