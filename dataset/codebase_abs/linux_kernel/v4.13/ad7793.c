...
static int F_35 ( struct V_90 * V_43 )
{
const struct V_14 * V_15 = V_43 -> V_48 . V_91 ;
struct V_1 * V_5 ;
struct V_36 * V_37 ;
int V_40 , V_38 = 0 ;
if ( ! V_15 ) {
...
V_37 = F_36 ( & V_43 -> V_48 , sizeof( * V_5 ) ) ;
if ( V_37 == NULL )
return - V_94 ;
V_5 = F_13 ( V_37 ) ;
F_37 ( & V_5 -> V_3 , V_37 , V_43 , & V_95 ) ;
if ( V_15 -> V_29 != V_96 ) {
V_5 -> V_97 = F_38 ( & V_43 -> V_48 , L_8 ) ;
if ( F_39 ( V_5 -> V_97 ) )
return F_40 ( V_5 -> V_97 ) ;
V_40 = F_41 ( V_5 -> V_97 ) ;
if ( V_40 )
return V_40 ;
V_38 = F_42 ( V_5 -> V_97 ) ;
...
V_5 -> V_23 =
& V_99 [ F_43 ( V_43 ) -> V_100 ] ;
F_44 ( V_43 , V_37 ) ;
V_37 -> V_48 . V_101 = & V_43 -> V_48 ;
V_37 -> V_48 . V_102 = V_43 -> V_48 . V_102 ;
V_37 -> V_103 = F_43 ( V_43 ) -> V_103 ;
V_37 -> V_104 = V_105 ;
V_37 -> V_63 = V_5 -> V_23 -> V_63 ;
V_37 -> V_106 = V_5 -> V_23 -> V_106 ;
V_37 -> V_107 = V_5 -> V_23 -> V_108 ;
V_40 = F_45 ( V_37 ) ;
if ( V_40 )
goto V_98;
...
static int F_49 ( struct V_90 * V_43 )
{
const struct V_14 * V_15 = V_43 -> V_48 . V_91 ;
struct V_36 * V_37 = F_50 ( V_43 ) ;
struct V_1 * V_5 = F_13 ( V_37 ) ;
F_51 ( V_37 ) ;
F_47 ( V_37 ) ;
if ( V_15 -> V_29 != V_96 )
