...
V_35 -> V_25 = V_72 | V_73 ;
V_35 -> V_74 = & V_75 ;
V_35 -> V_76 -> V_77 [ 0 ] . V_16 = V_58 -> V_50 -> V_78 . V_79 ;
V_35 -> V_76 -> V_77 [ 0 ] . V_52 = V_58 -> V_80 . V_81 ;
F_28 ( V_35 , V_61 -> V_32 [ 0 ] , V_61 -> V_17 -> V_82 ) ;
F_29 ( V_35 , & V_2 -> V_51 , V_56 -> V_83 ,
V_56 -> V_84 ) ;
V_35 -> V_85 = V_33 ;
V_35 -> V_86 = V_52 ;
V_35 -> V_87 . V_25 = V_88 ;
...
int V_19 ;
int V_90 = 32 ;
if ( F_39 ( V_58 ) && V_58 -> V_80 . V_81 < ( 2048 * 1024 ) )
V_90 = 16 ;
V_2 = F_40 ( V_58 -> V_50 -> V_50 , sizeof( struct V_1 ) , V_91 ) ;
if ( ! V_2 )
return - V_67 ;
V_58 -> V_2 = V_2 ;
F_41 ( & V_2 -> V_26 ) ;
F_42 ( V_58 -> V_50 , & V_2 -> V_51 , & V_92 ) ;
