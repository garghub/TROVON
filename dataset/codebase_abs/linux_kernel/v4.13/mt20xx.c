...
F_10 ( & V_6 -> V_37 , V_17 , 1 ) ;
F_5 ( L_26 , V_17 [ 0 ] ) ;
memcpy ( & V_2 -> V_53 . V_54 , & V_72 , sizeof( struct V_56 ) ) ;
return 0 ;
}
...
unsigned char V_17 [ 21 ] ;
int V_77 ;
V_6 = F_27 ( sizeof( struct V_5 ) , V_78 ) ;
if ( V_6 == NULL )
return NULL ;
V_2 -> V_3 = V_6 ;
V_6 -> V_37 . V_79 = V_75 ;
...
if ( V_69 )
F_5 ( L_29 , 21 , V_17 ) ;
V_77 = V_17 [ 0x11 ] << 8 | V_17 [ 0x12 ] ;
F_7 ( L_30 ,
V_77 , V_17 [ 0x13 ] , V_17 [ 0x14 ] ) ;
if ( V_17 [ 0x13 ] < F_28 ( V_81 ) &&
NULL != V_81 [ V_17 [ 0x13 ] ] )
V_76 = V_81 [ V_17 [ 0x13 ] ] ;
switch ( V_17 [ 0x13 ] ) {
case V_82 :
...
F_29 ( V_2 -> V_53 . V_54 . V_84 . V_76 , V_76 ,
sizeof( V_2 -> V_53 . V_54 . V_84 . V_76 ) ) ;
F_7 ( L_32 , V_76 ) ;
return V_2 ;
}
