...
static inline bool F_29 ( T_2 * V_36 , int V_37 )
{
int V_38 , V_39 ;
V_38 = F_30 ( V_36 ) ;
for (; ; ) {
if ( F_31 ( V_38 >= V_37 ) )
return false ;
V_39 = F_32 ( V_36 , V_38 , V_38 + 1 ) ;
if ( F_33 ( V_39 == V_38 ) )
return true ;
V_38 = V_39 ;
}
}
struct V_26 * F_34 ( struct V_9 * V_15 , T_1 V_27 ,
enum V_40 type )
{
...
int V_44 ;
V_43 = V_41 -> V_15 ;
V_44 = F_35 ( V_43 -> V_23 [ type ] ) ;
if ( ! F_29 ( & V_41 -> V_45 [ type ] , V_44 ) )
goto V_46;
}
return V_26 ;
V_46:
...
void F_37 ( struct V_26 * V_26 , enum V_40 type )
{
struct V_26 * V_41 ;
for ( V_41 = V_26 ; V_41 ; V_41 = V_41 -> V_15 -> V_26 ) {
int V_47 = F_38 ( & V_41 -> V_45 [ type ] ) ;
F_39 ( V_47 < 0 ) ;
}
F_25 ( V_26 ) ;
}
static T_3 int F_40 ( void )
{
#ifdef F_8
