...
int F_71 ( struct V_1 * V_2 , int V_114 )
{
int error ;
struct V_124 * V_103 ;
if ( ( error = F_72 ( V_2 -> V_117 , L_3 , V_114 , 1 , 1 , & V_103 ) ) )
return error ;
F_73 ( V_103 , V_56 , & V_125 ) ;
F_73 ( V_103 , V_57 , & V_126 ) ;
V_103 -> V_127 = V_2 ;
V_103 -> V_128 = ( V_2 -> V_66 == V_2 -> V_76 ) ? V_129 : 0 ;
strcpy ( V_103 -> V_130 , F_64 ( V_2 ) ) ;
F_53 ( V_2 ) ;
F_74 ( V_103 , V_131 ,
F_75 () ,
...
V_133 . V_134 = V_135 ;
V_133 . V_136 = V_137 ;
V_133 . V_117 = V_2 -> V_117 -> V_138 ;
V_133 . V_114 = V_114 ;
V_133 . V_139 = 0 ;
if ( ( error = F_77 ( V_2 -> V_117 , L_3 , & V_133 , & V_86 ) ) < 0 )
return error ;
strcpy ( V_86 -> V_130 , F_64 ( V_2 ) ) ;
V_86 -> V_127 = V_2 ;
V_2 -> V_86 = V_86 ;
V_86 -> V_93 = V_140 ;
return 0 ;
}
static int F_78 ( struct V_141 * V_142 , struct V_143 * V_144 )
{
static const char * const V_145 [ 8 ] = {
L_14 , L_15 , L_16 , L_17 , L_18 ,
L_19 , L_20 ,
} ;
return F_79 ( V_144 , 2 , 7 , V_145 ) ;
}
static int F_80 ( struct V_141 * V_142 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_81 ( V_142 ) ;
unsigned long V_28 ;
unsigned short V_148 ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_148 = F_10 ( V_2 , V_149 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
V_147 -> V_9 . V_150 . V_151 [ 0 ] = ( V_148 >> 12 ) & 7 ;
V_147 -> V_9 . V_150 . V_151 [ 1 ] = ( V_148 >> 4 ) & 7 ;
return 0 ;
}
static int F_82 ( struct V_141 * V_142 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_81 ( V_142 ) ;
unsigned long V_28 ;
unsigned short V_148 ;
int V_152 ;
if ( V_147 -> V_9 . V_150 . V_151 [ 0 ] > 6 ||
V_147 -> V_9 . V_150 . V_151 [ 1 ] > 6 )
return - V_53 ;
V_148 = ( V_147 -> V_9 . V_150 . V_151 [ 0 ] << 12 ) |
( V_147 -> V_9 . V_150 . V_151 [ 1 ] << 4 ) ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_152 = F_10 ( V_2 , V_149 ) != V_148 ;
F_11 ( V_2 , V_149 , V_148 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
return V_152 ;
}
static int F_83 ( struct V_141 * V_142 , struct V_143 * V_144 )
{
int V_10 = ( V_142 -> V_153 >> 16 ) & 0xff ;
V_144 -> type = V_10 == 1 ? V_154 : V_155 ;
V_144 -> V_156 = 1 ;
V_144 -> V_9 . integer . V_157 = 0 ;
V_144 -> V_9 . integer . V_158 = V_10 ;
return 0 ;
}
static int F_84 ( struct V_141 * V_142 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_81 ( V_142 ) ;
unsigned long V_28 ;
int V_8 = V_142 -> V_153 & 0xff ;
int V_159 = ( V_142 -> V_153 >> 8 ) & 0xff ;
int V_10 = ( V_142 -> V_153 >> 16 ) & 0xff ;
int V_160 = ( V_142 -> V_153 >> 24 ) & 0xff ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_147 -> V_9 . integer . V_9 [ 0 ] = ( F_10 ( V_2 , V_8 ) >> V_159 ) & V_10 ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
if ( V_160 )
V_147 -> V_9 . integer . V_9 [ 0 ] = V_10 - V_147 -> V_9 . integer . V_9 [ 0 ] ;
return 0 ;
}
static int F_85 ( struct V_141 * V_142 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_81 ( V_142 ) ;
unsigned long V_28 ;
int V_8 = V_142 -> V_153 & 0xff ;
...
int V_160 = ( V_142 -> V_153 >> 24 ) & 0xff ;
int V_152 ;
unsigned short V_161 , V_148 ;
V_148 = ( V_147 -> V_9 . integer . V_9 [ 0 ] & V_10 ) ;
if ( V_160 )
V_148 = V_10 - V_148 ;
V_148 <<= V_159 ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_161 = F_10 ( V_2 , V_8 ) ;
V_148 = ( V_161 & ~ ( V_10 << V_159 ) ) | V_148 ;
V_152 = V_148 != V_161 ;
F_11 ( V_2 , V_8 , V_148 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
return V_152 ;
}
static int F_86 ( struct V_141 * V_142 , struct V_143 * V_144 )
{
int V_10 = ( V_142 -> V_153 >> 16 ) & 0xff ;
V_144 -> type = V_10 == 1 ? V_154 : V_155 ;
V_144 -> V_156 = 2 ;
...
static int F_87 ( struct V_141 * V_142 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_81 ( V_142 ) ;
unsigned long V_28 ;
int V_8 = V_142 -> V_153 & 0xff ;
int V_162 = ( V_142 -> V_153 >> 8 ) & 0x0f ;
int V_163 = ( V_142 -> V_153 >> 12 ) & 0x0f ;
int V_10 = ( V_142 -> V_153 >> 16 ) & 0xff ;
int V_160 = ( V_142 -> V_153 >> 24 ) & 0xff ;
unsigned short V_148 ;
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_148 = F_10 ( V_2 , V_8 ) ;
V_147 -> V_9 . integer . V_9 [ 0 ] = ( V_148 >> V_162 ) & V_10 ;
V_147 -> V_9 . integer . V_9 [ 1 ] = ( V_148 >> V_163 ) & V_10 ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
if ( V_160 ) {
V_147 -> V_9 . integer . V_9 [ 0 ] = V_10 - V_147 -> V_9 . integer . V_9 [ 0 ] ;
V_147 -> V_9 . integer . V_9 [ 1 ] = V_10 - V_147 -> V_9 . integer . V_9 [ 1 ] ;
}
return 0 ;
}
static int F_88 ( struct V_141 * V_142 , struct V_146 * V_147 )
{
struct V_1 * V_2 = F_81 ( V_142 ) ;
unsigned long V_28 ;
int V_8 = V_142 -> V_153 & 0xff ;
...
int V_160 = ( V_142 -> V_153 >> 24 ) & 0xff ;
int V_152 ;
unsigned short V_161 , V_164 , V_165 ;
V_164 = V_147 -> V_9 . integer . V_9 [ 0 ] & V_10 ;
V_165 = V_147 -> V_9 . integer . V_9 [ 1 ] & V_10 ;
if ( V_160 ) {
V_164 = V_10 - V_164 ;
V_165 = V_10 - V_165 ;
}
...
F_15 ( & V_2 -> V_29 , V_28 ) ;
V_161 = F_10 ( V_2 , V_8 ) ;
V_164 = ( V_161 & ~ ( ( V_10 << V_162 ) | ( V_10 << V_163 ) ) ) | V_164 | V_165 ;
V_152 = V_164 != V_161 ;
F_11 ( V_2 , V_8 , V_164 ) ;
F_16 ( & V_2 -> V_29 , V_28 ) ;
return V_152 ;
...
return - V_53 ;
V_117 = V_2 -> V_117 ;
strcpy ( V_117 -> V_168 , F_64 ( V_2 ) ) ;
for ( V_166 = 0 ; V_166 < F_90 ( V_169 ) ; V_166 ++ ) {
if ( ( V_167 = F_91 ( V_117 , F_92 ( & V_169 [ V_166 ] , V_2 ) ) ) < 0 )
return V_167 ;
}
return 0 ;
}
