...
if ( V_75 -> V_158 . V_159 == V_160 )
memcpy ( V_44 -> V_154 . V_169 , V_9 -> V_154 . V_169 ,
16 ) ;
V_44 -> V_154 . V_170 = F_36 ( 0xFFFF ) ;
V_44 -> V_154 . V_171 = F_36 (
...
V_4 |= V_175 ;
if ( V_9 -> V_154 . V_176 &&
V_75 -> V_158 . V_159 != V_160 )
V_4 |= V_177 ;
V_4 |= V_178 [ V_9 -> V_21 ] ;
V_44 -> V_154 . V_179 = V_4 ;
V_44 -> V_154 . V_180 = V_9 -> V_154 . V_180 ;
V_4 = 0 ;
if ( V_9 -> V_154 . V_181 )
V_4 |= V_182 ;
if ( V_9 -> V_154 . V_183 )
...
V_191 ) ;
V_44 = V_14 -> V_44 ;
V_44 -> V_156 . V_83 = V_192 ;
V_44 -> V_187 . V_163 = V_75 -> V_167 ;
...
memcpy ( V_44 -> V_45 . V_202 . V_210 , V_9 -> V_45 . V_211 -> V_212 ,
V_9 -> V_45 . V_211 -> V_213 ) ;
...
int F_42 ( struct V_8 * V_9 , T_1 V_12 )
{
int V_20 = 0 ;
F_43 ( V_215 ) ;
struct V_8 * V_216 = V_9 ;
struct V_13 * V_14 = NULL , * V_186 ;
struct V_1 * V_2 = V_9 -> V_75 -> V_164 -> V_16 -> V_217 ;
unsigned long V_4 ;
V_20 = F_41 ( V_2 , 1 ) ;
if ( V_20 )
return V_20 ;
...
F_45 ( & V_215 , V_14 -> V_219 . V_220 , & V_14 -> V_219 ) ;
F_46 (a, &alist, list) {
V_186 -> V_43 = V_216 ;
V_216 -> V_15 = V_186 ;
break;
...
case V_143 :
case V_47 :
V_20 = F_34 ( V_186 , V_216 , V_12 ) ;
break;
case V_144 :
V_20 = F_37 ( V_186 , V_216 , V_12 ) ;
break;
case V_69 :
V_20 = F_39 ( V_186 , V_216 , V_12 ) ;
break;
default:
F_47 ( L_5 ,
V_216 -> V_33 ) ;
