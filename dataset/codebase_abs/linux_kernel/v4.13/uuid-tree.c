...
struct V_26 * V_22 , T_1 * V_1 , T_1 type ,
V_6 V_27 )
{
...
F_16 ( V_22 , V_12 , sizeof( V_28 ) ) ;
V_14 = V_12 -> V_20 [ 0 ] ;
V_15 = V_12 -> V_21 [ 0 ] ;
V_5 = F_8 ( V_14 , V_15 ) ;
V_5 += F_7 ( V_14 , V_15 ) - sizeof( V_28 ) ;
} else if ( V_10 < 0 ) {
F_10 ( V_22 ,
L_2 ,
...
V_10 = 0 ;
V_28 = F_17 ( V_27 ) ;
F_18 ( V_14 , & V_28 , V_5 , sizeof( V_28 ) ) ;
F_19 ( V_14 ) ;
V_18:
F_13 ( V_12 ) ;
return V_10 ;
...
while ( V_16 ) {
T_3 V_34 ;
F_11 ( V_14 , & V_34 , V_5 , sizeof( V_34 ) ) ;
if ( F_12 ( V_34 ) == V_9 )
break;
V_5 += sizeof( V_34 ) ;
V_16 -= sizeof( V_34 ) ;
...
V_31 = V_5 ;
V_32 = V_5 + sizeof( V_9 ) ;
V_33 = V_16 - ( V_32 - F_8 ( V_14 , V_15 ) ) ;
F_22 ( V_14 , V_31 , V_32 , V_33 ) ;
F_23 ( V_22 , V_12 , V_16 - sizeof( V_9 ) , 1 ) ;
V_18:
F_13 ( V_12 ) ;
return V_10 ;
}
...
V_10 = F_20 ( V_25 , V_8 -> V_22 , V_1 , type , V_9 ) ;
F_28 ( V_25 ) ;
V_18:
return V_10 ;
}
int F_29 ( struct V_26 * V_22 ,
int (* F_30)( struct V_26 * , T_1 * , T_1 ,
V_6 ) )
{
...
sizeof( V_28 ) ) ;
V_27 = F_12 ( V_28 ) ;
V_10 = F_30 ( V_22 , V_1 , V_3 . type , V_27 ) ;
if ( V_10 < 0 )
goto V_18;
if ( V_10 > 0 ) {
F_35 ( V_12 ) ;
