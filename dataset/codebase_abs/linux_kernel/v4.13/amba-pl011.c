...
T_11 V_7 ;
int V_243 ;
if ( ( strcmp ( V_322 , L_26 ) != 0 ) && ( strcmp ( V_322 , L_27 ) != 0 ) )
return - V_320 ;
if ( F_170 ( V_317 , & V_10 , & V_7 , & V_317 ) )
return - V_320 ;
if ( V_10 != V_324 && V_10 != V_11 )
return - V_320 ;
for ( V_243 = 0 ; V_243 < F_171 ( V_307 ) ; V_243 ++ ) {
struct V_127 * V_8 ;
if ( ! V_307 [ V_243 ] )
continue;
V_8 = & V_307 [ V_243 ] -> V_8 ;
...
{
while ( F_173 ( V_8 -> V_9 + V_326 ) & V_126 )
F_90 () ;
F_174 ( V_183 , V_8 -> V_9 + V_327 ) ;
while ( ! ( F_173 ( V_8 -> V_9 + V_326 ) & V_328 ) )
F_90 () ;
}
static void F_175 ( struct V_304 * V_329 , const char * V_306 , unsigned V_330 )
{
struct V_331 * V_2 = V_329 -> V_89 ;
F_161 ( & V_2 -> V_8 , V_306 , V_330 , F_172 ) ;
}
static void F_176 ( struct V_127 * V_8 , int V_183 )
{
while ( F_173 ( V_8 -> V_9 + V_326 ) & V_126 )
F_90 () ;
if ( V_8 -> V_10 == V_11 )
...
F_177 ( V_183 , V_8 -> V_9 + V_327 ) ;
while ( F_173 ( V_8 -> V_9 + V_326 ) & V_332 )
F_90 () ;
}
static void F_178 ( struct V_304 * V_329 , const char * V_306 , unsigned V_330 )
{
struct V_331 * V_2 = V_329 -> V_89 ;
F_161 ( & V_2 -> V_8 , V_306 , V_330 , F_176 ) ;
}
static int T_10 F_179 ( struct V_331 * V_46 ,
const char * V_333 )
{
if ( ! V_46 -> V_8 . V_9 )
return - V_320 ;
V_46 -> V_329 -> V_334 = F_178 ;
return 0 ;
}
static int T_10
F_180 ( struct V_331 * V_46 ,
const char * V_333 )
{
if ( ! V_46 -> V_8 . V_9 )
return - V_320 ;
V_46 -> V_329 -> V_334 = F_175 ;
return 0 ;
}
static int F_181 ( int V_308 , struct V_46 * V_2 )
{
struct V_335 * V_336 ;
static bool V_337 = false ;
...
if ( ! V_336 )
return V_125 ;
V_125 = F_183 ( V_336 , L_28 ) ;
if ( V_125 < 0 ) {
V_338 = true ;
V_125 = V_308 ;
} else {
V_337 = true ;
if ( V_125 >= F_171 ( V_307 ) || V_307 [ V_125 ] != NULL ) {
F_68 ( V_2 , L_29 , V_125 ) ;
V_125 = V_308 ;
}
}
...
static int F_187 ( struct V_46 * V_2 , struct V_3 * V_4 ,
struct V_342 * V_343 , int V_308 )
{
void T_1 * V_344 ;
V_344 = F_188 ( V_2 , V_343 ) ;
if ( F_30 ( V_344 ) )
return F_31 ( V_344 ) ;
V_308 = F_181 ( V_308 , V_2 ) ;
V_4 -> V_247 = 0 ;
V_4 -> V_8 . V_2 = V_2 ;
V_4 -> V_8 . V_55 = V_343 -> V_345 ;
V_4 -> V_8 . V_9 = V_344 ;
V_4 -> V_8 . V_61 = V_4 -> V_61 ;
V_4 -> V_8 . V_91 = V_346 ;
V_4 -> V_8 . line = V_308 ;
...
V_125 = F_191 ( & V_341 , & V_4 -> V_8 ) ;
if ( V_125 )
F_184 ( V_4 ) ;
return V_125 ;
}
static int F_192 ( struct V_1 * V_2 , const struct V_347 * V_348 )
{
struct V_3 * V_4 ;
struct V_349 * V_167 = V_348 -> V_89 ;
int V_350 , V_125 ;
V_350 = F_186 () ;
if ( V_350 < 0 )
return V_350 ;
V_4 = F_193 ( & V_2 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_4 -> V_239 = F_194 ( & V_2 -> V_2 , NULL ) ;
if ( F_30 ( V_4 -> V_239 ) )
return F_31 ( V_4 -> V_239 ) ;
V_4 -> V_6 = V_167 -> V_6 ;
V_4 -> V_167 = V_167 ;
V_4 -> V_61 = V_167 -> V_351 ( V_2 ) ;
V_4 -> V_8 . V_10 = V_167 -> V_352 ? V_11 : V_324 ;
V_4 -> V_8 . V_195 = V_2 -> V_195 [ 0 ] ;
V_4 -> V_8 . V_253 = & V_353 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_32 , F_2 ( V_2 ) ) ;
V_125 = F_187 ( & V_2 -> V_2 , V_4 , & V_2 -> V_354 , V_350 ) ;
if ( V_125 )
return V_125 ;
F_195 ( V_2 , V_4 ) ;
return F_189 ( V_4 ) ;
...
{
struct V_3 * V_4 = F_200 ( V_2 ) ;
if ( ! V_4 )
return - V_301 ;
return F_201 ( & V_341 , & V_4 -> V_8 ) ;
}
static int F_202 ( struct V_46 * V_2 )
{
struct V_3 * V_4 = F_200 ( V_2 ) ;
if ( ! V_4 )
return - V_301 ;
return F_203 ( & V_341 , & V_4 -> V_8 ) ;
}
static int F_204 ( struct V_355 * V_356 )
{
struct V_3 * V_4 ;
struct V_342 * V_357 ;
int V_350 , V_125 ;
int V_358 ;
if ( V_356 -> V_2 . V_87 ) {
struct V_335 * V_336 = V_356 -> V_2 . V_87 ;
V_125 = F_43 ( V_336 , L_33 , & V_358 ) ;
if ( V_125 )
return V_125 ;
} else {
V_358 = 115200 ;
...
if ( V_350 < 0 )
return V_350 ;
V_4 = F_193 ( & V_356 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_125 = F_205 ( V_356 , 0 ) ;
...
#endif
V_4 -> V_167 = & V_361 ;
V_4 -> V_6 = V_4 -> V_167 -> V_6 ;
V_4 -> V_61 = 32 ;
V_4 -> V_8 . V_10 = V_4 -> V_167 -> V_352 ? V_11 : V_324 ;
V_4 -> V_8 . V_253 = & V_362 ;
V_4 -> V_292 = V_358 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_36 ) ;
V_357 = F_207 ( V_356 , V_363 , 0 ) ;
V_125 = F_187 ( & V_356 -> V_2 , V_4 , V_357 , V_350 ) ;
if ( V_125 )
return V_125 ;
F_208 ( V_356 , V_4 ) ;
return F_189 ( V_4 ) ;
}
static int F_209 ( struct V_355 * V_356 )
{
struct V_3 * V_4 = F_210 ( V_356 ) ;
F_198 ( & V_341 , & V_4 -> V_8 ) ;
F_184 ( V_4 ) ;
return 0 ;
}
