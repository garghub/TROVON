...
F_114 ( V_99 , V_184 ) ;
F_78 ( V_99 ) -> V_185 = NULL ;
V_99 -> V_186 = F_65 ( V_98 ) -> V_127 ;
F_115 ( & V_99 -> V_187 ,
F_116 ( & F_65 ( V_98 ) -> V_188 ) ) ;
V_179 -> V_189 = 0 ;
V_179 -> V_190 = 0 ;
V_179 -> V_191 = 0 ;
...
const struct V_142 * V_197 = F_78 ( V_14 ) ;
sin -> V_215 = V_216 ;
...
static struct V_116 * F_151 ( struct V_13 * V_14 , struct V_230 * V_145 )
{
const struct V_142 * V_197 = F_78 ( V_14 ) ;
const struct V_122 * V_148 ;
T_1 V_231 = V_197 -> V_219 ;
struct V_117 * V_118 ;
struct V_124 * V_125 ;
F_79 () ;
V_148 = F_80 ( V_197 -> V_148 ) ;
if ( V_148 && V_148 -> V_123 . V_129 )
V_231 = V_148 -> V_123 . V_130 ;
V_118 = & V_145 -> V_146 . V_147 ;
V_125 = F_152 ( F_18 ( V_14 ) , V_118 , V_14 , V_231 ,
V_197 -> V_232 , V_197 -> V_181 ,
...
struct V_116 * F_154 ( struct V_13 * V_14 , T_3 V_233 )
{
struct V_116 * V_140 = F_155 ( V_14 , 0 ) ;
struct V_142 * V_197 = F_78 ( V_14 ) ;
if ( ! V_140 ) {
V_140 = F_151 ( V_14 , & V_197 -> V_144 . V_145 ) ;
if ( ! V_140 )
goto V_106;
}
V_140 -> V_234 -> V_235 ( V_140 , V_14 , NULL , V_233 ) ;
V_140 = F_155 ( V_14 , 0 ) ;
if ( ! V_140 )
V_140 = F_151 ( V_14 , & V_197 -> V_144 . V_145 ) ;
V_106:
