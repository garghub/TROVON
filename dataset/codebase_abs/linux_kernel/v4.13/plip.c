...
F_19 ( V_168 L_25 , V_175 ) ;
if ( V_2 -> V_3 != - 1 )
F_19 ( V_168 L_26
L_27 ,
V_2 -> V_56 , V_2 -> V_166 , V_2 -> V_3 ) ;
else
F_19 ( V_168 L_26
L_28 ,
V_2 -> V_56 , V_2 -> V_166 ) ;
...
{
struct V_179 * V_180 = V_178 -> V_2 . V_181 ;
int V_114 = strlen ( V_180 -> V_56 ) ;
if ( strncmp ( V_178 -> V_56 , V_180 -> V_56 , V_114 ) )
return - V_182 ;
return 0 ;
}
...
static int T_4 F_89 ( char * V_184 )
{
int V_185 [ 4 ] ;
V_184 = F_90 ( V_184 , F_91 ( V_185 ) , V_185 ) ;
if ( ! strncmp ( V_184 , L_29 , 7 ) ) {
int V_186 = F_92 ( V_184 + 7 , NULL , 10 ) ;
if ( V_187 < V_158 )
V_4 [ V_187 ++ ] = V_186 ;
else
F_19 ( V_168 L_30 ,
V_184 ) ;
} else if ( ! strcmp ( V_184 , L_31 ) ) {
V_163 = 1 ;
} else {
if ( V_185 [ 0 ] == 0 || V_185 [ 1 ] == 0 ) {
V_4 [ 0 ] = - 2 ;
} else {
F_19 ( V_55 L_32 ,
V_185 [ 1 ] ) ;
