...
void T_2 * V_113 ;
int V_114 , V_21 ;
V_2 = F_49 ( & V_108 -> V_99 , sizeof( * V_2 ) , V_115 ) ;
if ( ! V_2 )
return - V_116 ;
F_50 ( V_108 , V_2 ) ;
V_112 = F_51 ( V_108 , V_117 , 0 ) ;
V_113 = F_52 ( & V_108 -> V_99 , V_112 ) ;
if ( F_53 ( V_113 ) )
return F_54 ( V_113 ) ;
V_114 = F_55 ( V_108 , 0 ) ;
if ( V_114 < 0 ) {
...
V_110 = F_56 ( & V_108 -> V_99 ) ;
if ( ! V_110 ) {
F_43 ( & V_108 -> V_99 , L_4 ) ;
return - V_118 ;
}
V_2 -> V_105 = F_57 ( & V_108 -> V_99 , L_5 ) ;
if ( F_53 ( V_2 -> V_105 ) ) {
F_43 ( & V_108 -> V_99 , L_6 ) ;
return F_54 ( V_2 -> V_105 ) ;
}
V_2 -> V_24 = F_58 ( & V_108 -> V_99 , V_113 ,
& V_119 ) ;
if ( F_53 ( V_2 -> V_24 ) ) {
F_43 ( & V_108 -> V_99 , L_7 ) ;
return F_54 ( V_2 -> V_24 ) ;
}
V_2 -> V_22 = F_57 ( & V_108 -> V_99 , L_8 ) ;
if ( F_53 ( V_2 -> V_22 ) ) {
F_43 ( & V_108 -> V_99 , L_9 ) ;
return F_54 ( V_2 -> V_22 ) ;
}
if ( V_110 -> V_120 ) {
V_2 -> V_121 = F_59 ( & V_108 -> V_99 , NULL ) ;
if ( F_53 ( V_2 -> V_121 ) ) {
F_43 ( & V_108 -> V_99 , L_10 ) ;
return F_54 ( V_2 -> V_121 ) ;
}
}
if ( ! F_53 ( V_2 -> V_121 ) ) {
V_21 = F_60 ( V_2 -> V_121 ) ;
...
V_2 -> V_37 . V_122 = V_112 -> V_123 + V_101 ;
V_2 -> V_37 . V_124 = 8 ;
V_2 -> V_97 . V_122 = V_112 -> V_123 + V_102 ;
V_2 -> V_97 . V_124 = 8 ;
F_61 ( & V_108 -> V_99 ) ;
if ( ! F_62 ( & V_108 -> V_99 ) ) {
...
V_21 = F_63 ( & V_108 -> V_99 ,
& V_126 ,
& V_127 , 1 ) ;
if ( V_21 ) {
F_43 ( & V_108 -> V_99 , L_12 ) ;
goto V_128;
}
V_21 = F_64 ( & V_108 -> V_99 , NULL , 0 ) ;
if ( V_21 ) {
F_43 ( & V_108 -> V_99 , L_13 ) ;
goto V_128;
}
return 0 ;
V_128:
...
{
struct V_1 * V_2 = F_42 ( & V_108 -> V_99 ) ;
F_69 ( & V_108 -> V_99 ) ;
F_66 ( & V_108 -> V_99 ) ;
if ( ! F_65 ( & V_108 -> V_99 ) )
F_47 ( & V_108 -> V_99 ) ;
