...
return sprintf ( V_16 , L_18 , V_54 / 1000 , V_54 % 1000 ) ;
}
static T_2 F_27 ( struct V_12 * V_13 ,
struct V_14 * V_15 ,
char * V_16 )
{
return sprintf ( V_16 , L_16 , V_56 ) ;
}
...
union V_21 * V_66 ;
T_1 V_6 ;
V_6 = F_35 ( V_4 -> V_7 -> V_8 , L_19 , NULL ,
& V_64 ) ;
if ( F_4 ( V_6 ) ) {
F_5 ( ( V_9 , V_6 , L_20 ) ) ;
return - V_10 ;
...
struct V_63 V_105 = { sizeof( L_24 ) , L_24 } ;
union V_21 * V_66 ;
T_4 * V_103 ;
T_1 V_6 ;
V_6 = F_35 ( V_4 -> V_7 -> V_8 , L_25 , NULL ,
& V_64 ) ;
if ( F_4 ( V_6 ) ) {
F_5 ( ( V_9 , V_6 , L_26 ) ) ;
return - V_10 ;
