...
F_16 ( 0 , & V_32 ) ;
V_27 = F_17 ( V_24 , ( void * ) & V_32 , sizeof( V_32 ) ) ;
if ( V_27 < 0 ) {
F_9 ( L_9 ) ;
return - 1 ;
}
...
V_27 = F_19 ( V_24 , ( void * ) & V_34 , sizeof( V_34 ) ) ;
if ( V_27 < 0 ) {
F_9 ( L_11 ) ;
return - 1 ;
}
...
int V_11 = - 1 ;
for (; ; ) {
V_45 = F_24 ( V_40 , V_41 , L_19 , V_43 , NULL ) ;
if ( V_45 == - 1 )
break;
switch ( V_45 ) {
case 'r' :
