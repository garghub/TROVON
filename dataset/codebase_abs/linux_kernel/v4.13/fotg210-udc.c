...
T_1 V_3 = F_2 ( V_2 -> V_4 -> V_5 + V_67 ) ;
V_3 &= ~ V_68 ;
F_5 ( V_3 , V_2 -> V_4 -> V_5 + V_67 ) ;
}
}
...
static int F_68 ( struct V_30 * V_31 , int V_3 , int V_72 )
{
struct V_1 * V_2 ;
struct V_9 * V_4 ;
unsigned long V_35 ;
...
{
T_1 V_3 = F_2 ( V_4 -> V_5 + V_74 ) ;
V_3 &= ~ ( V_75 | V_76 | V_77
| V_78 ) ;
F_5 ( V_3 , V_4 -> V_5 + V_74 ) ;
}
static void F_73 ( struct V_9 * V_4 )
{
T_1 V_3 = F_2 ( V_4 -> V_5 + V_79 ) ;
V_3 &= ~ ( V_80 | V_81 | V_82
| V_83 ) ;
F_5 ( V_3 , V_4 -> V_5 + V_79 ) ;
}
...
for ( V_84 = ( V_61 >> 2 ) ; V_84 > 0 ; V_84 -- ) {
V_86 = F_2 ( V_4 -> V_5 + V_87 ) ;
* V_85 = V_86 & 0xFF ;
* ( V_85 + 1 ) = ( V_86 >> 8 ) & 0xFF ;
* ( V_85 + 2 ) = ( V_86 >> 16 ) & 0xFF ;
* ( V_85 + 3 ) = ( V_86 >> 24 ) & 0xFF ;
...
{
T_1 V_3 = F_2 ( V_4 -> V_5 + V_88 ) ;
V_3 |= V_89 ;
F_5 ( V_3 , V_4 -> V_5 + V_88 ) ;
}
static void F_76 ( struct V_9 * V_4 , T_1 V_90 )
{
T_1 V_3 = F_2 ( V_4 -> V_5 + V_88 ) ;
V_3 |= ( V_90 & 0x7F ) ;
F_5 ( V_3 , V_4 -> V_5 + V_88 ) ;
...
V_4 -> V_105 -> V_62 = & V_4 -> V_102 ;
V_4 -> V_105 -> V_61 = 2 ;
F_10 ( & V_4 -> V_20 ) ;
F_62 ( V_4 -> V_16 . V_106 , V_4 -> V_105 , V_107 ) ;
F_12 ( & V_4 -> V_20 ) ;
}
...
T_2 V_73 = 0 ;
F_74 ( V_4 , V_108 ) ;
V_4 -> V_2 [ 0 ] -> V_7 = V_93 -> V_95 & V_109 ;
if ( V_4 -> V_16 . V_17 == V_18 ) {
T_1 V_3 = F_2 ( V_4 -> V_5 + V_110 ) ;
V_4 -> V_16 . V_17 = V_3 & V_111 ?
V_112 : V_113 ;
}
if ( ( V_93 -> V_95 & V_114 ) == V_115 ) {
switch ( V_93 -> V_116 ) {
case V_117 :
F_84 ( V_4 , V_93 ) ;
break;
...
V_4 -> V_144 = V_144 ;
V_3 = F_2 ( V_4 -> V_5 + V_110 ) ;
V_3 |= V_163 ;
F_5 ( V_3 , V_4 -> V_5 + V_110 ) ;
return 0 ;
}
...
V_3 = F_2 ( V_4 -> V_5 + V_67 ) ;
V_3 |= V_168 ;
F_5 ( V_3 , V_4 -> V_5 + V_67 ) ;
}
...
V_73 = - V_178 ;
V_4 = F_44 ( sizeof( struct V_9 ) , V_107 ) ;
if ( V_4 == NULL )
goto V_179;
for ( V_84 = 0 ; V_84 < V_174 ; V_84 ++ ) {
V_31 [ V_84 ] = F_44 ( sizeof( struct V_1 ) , V_107 ) ;
if ( V_31 [ V_84 ] == NULL )
goto V_179;
V_4 -> V_2 [ V_84 ] = V_31 [ V_84 ] ;
}
...
V_4 -> V_16 . V_184 = V_112 ;
V_4 -> V_16 . V_185 . V_186 = & V_170 -> V_185 ;
V_4 -> V_16 . V_185 . V_187 = V_170 -> V_185 . V_187 ;
V_4 -> V_16 . V_188 = V_189 ;
F_45 ( & V_4 -> V_16 . V_190 ) ;
for ( V_84 = 0 ; V_84 < V_174 ; V_84 ++ ) {
struct V_1 * V_2 = V_4 -> V_2 [ V_84 ] ;
if ( V_84 ) {
F_45 ( & V_4 -> V_2 [ V_84 ] -> V_2 . V_190 ) ;
F_63 ( & V_4 -> V_2 [ V_84 ] -> V_2 . V_190 ,
& V_4 -> V_16 . V_190 ) ;
}
V_2 -> V_4 = V_4 ;
F_45 ( & V_2 -> V_15 ) ;
V_2 -> V_2 . V_188 = V_191 [ V_84 ] ;
V_2 -> V_2 . V_182 = & V_192 ;
F_114 ( & V_2 -> V_2 , ( unsigned short ) ~ 0 ) ;
if ( V_84 == 0 ) {
V_2 -> V_2 . V_193 . V_194 = true ;
} else {
V_2 -> V_2 . V_193 . V_195 = true ;
V_2 -> V_2 . V_193 . V_196 = true ;
V_2 -> V_2 . V_193 . V_197 = true ;
}
V_2 -> V_2 . V_193 . V_7 = true ;
V_2 -> V_2 . V_193 . V_198 = true ;
}
F_114 ( & V_4 -> V_2 [ 0 ] -> V_2 , 0x40 ) ;
V_4 -> V_16 . V_106 = & V_4 -> V_2 [ 0 ] -> V_2 ;
F_45 ( & V_4 -> V_16 . V_106 -> V_190 ) ;
V_4 -> V_105 = F_43 ( & V_4 -> V_2 [ 0 ] -> V_2 ,
V_107 ) ;
if ( V_4 -> V_105 == NULL )
goto V_199;
F_100 ( V_4 ) ;
F_97 ( V_4 ) ;
V_73 = F_115 ( V_173 -> V_180 , F_92 , V_200 ,
V_189 , V_4 ) ;
if ( V_73 < 0 ) {
F_58 ( L_17 , V_73 ) ;
goto V_199;
}
V_73 = F_116 ( & V_170 -> V_185 , & V_4 -> V_16 ) ;
if ( V_73 )
goto V_201;
F_117 ( & V_170 -> V_185 , L_18 , V_202 ) ;
return 0 ;
V_201:
