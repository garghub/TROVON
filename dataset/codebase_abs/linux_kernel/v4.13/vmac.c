...
F_33 ( & V_71 , sizeof( T_4 ) ) ;
memset ( & V_14 -> V_48 , 0 , sizeof( struct V_13 ) ) ;
V_14 -> V_69 = 0 ;
return 0 ;
}
static int F_34 ( struct V_73 * V_66 )
{
struct V_74 * V_75 ;
struct V_76 * V_77 = ( void * ) V_66 -> V_78 ;
struct V_79 * V_80 = F_35 ( V_77 ) ;
struct V_44 * V_14 = F_36 ( V_66 ) ;
V_75 = F_37 ( V_80 ) ;
if ( F_38 ( V_75 ) )
return F_39 ( V_75 ) ;
V_14 -> V_51 = V_75 ;
...
static void F_40 ( struct V_73 * V_66 )
{
struct V_44 * V_14 = F_36 ( V_66 ) ;
F_41 ( V_14 -> V_51 ) ;
}
...
V_77 -> V_87 . V_93 . V_99 = F_34 ;
V_77 -> V_87 . V_93 . V_100 = F_40 ;
