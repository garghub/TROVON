...
if ( V_10 >= V_12 ) {
do {
V_2 -> V_23 [ V_11 ] . V_25 . V_38 ( V_7 , V_20 , V_16 ,
( T_5 * ) V_6 -> V_30 ) ;
V_16 += V_24 ;
V_20 += V_24 ;
V_10 -= V_12 ;
...
static unsigned int F_21 ( const struct V_1 * V_2 ,
void * V_7 ,
struct V_39 * V_6 )
{
const unsigned int V_9 = 128 / 8 ;
unsigned int V_10 = V_6 -> V_10 ;
T_3 * V_16 = V_6 -> V_16 . V_17 . V_18 ;
T_3 * V_20 = V_6 -> V_20 . V_17 . V_18 ;
unsigned int V_24 , V_12 ;
unsigned int V_11 ;
for ( V_11 = 0 ; V_11 < V_2 -> V_22 ; V_11 ++ ) {
V_24 = V_2 -> V_23 [ V_11 ] . V_24 ;
...
struct V_3 * V_4 , struct V_28 * V_20 ,
struct V_28 * V_16 , unsigned int V_10 ,
void (* F_23)( void * V_7 , T_1 * V_20 , const T_1 * V_16 ) ,
void * V_40 , void * V_41 )
{
const unsigned int V_9 = 128 / 8 ;
bool V_13 = false ;
...
V_4 , V_13 ,
V_10 < V_9 ? V_9 : V_10 ) ;
F_23 ( V_40 , V_6 . V_30 , V_6 . V_30 ) ;
while ( V_10 ) {
V_10 = F_20 ( V_2 , V_41 , V_4 , & V_6 ) ;
V_14 = F_5 ( V_4 , & V_6 , V_10 ) ;
V_10 = V_6 . V_10 ;
}
F_6 ( V_13 ) ;
...
unsigned int V_10 ;
int V_14 ;
V_14 = F_25 ( & V_6 , V_43 , false ) ;
V_10 = V_6 . V_10 ;
if ( ! V_10 )
return V_14 ;
V_13 = F_26 ( V_9 , V_2 -> V_21 ,
& V_6 , V_13 ,
V_10 < V_9 ? V_9 : V_10 ) ;
F_23 ( V_40 , V_6 . V_30 , V_6 . V_30 ) ;
while ( V_10 ) {
V_10 = F_21 ( V_2 , V_41 , & V_6 ) ;
V_14 = F_27 ( & V_6 , V_10 ) ;
V_10 = V_6 . V_10 ;
}
F_6 ( V_13 ) ;
...
void F_28 ( void * V_7 , T_3 * V_20 , const T_3 * V_16 , T_5 * V_30 ,
T_2 V_29 )
{
T_5 V_44 = * V_30 ;
F_29 ( V_30 , & V_44 ) ;
F_10 ( V_20 , V_16 , ( T_3 * ) & V_44 ) ;
V_29 ( V_7 , ( T_1 * ) V_20 , ( T_1 * ) V_20 ) ;
F_10 ( V_20 , V_20 , ( T_3 * ) & V_44 ) ;
}
