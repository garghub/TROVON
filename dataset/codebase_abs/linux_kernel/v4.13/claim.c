...
if ( V_69 > 0 && V_69 / 512 ) {
V_69 /= 512 ;
F_47 ( & V_59 -> V_65 , V_61 , V_69 ) ;
}
F_48 ( V_59 -> V_67 + V_54 , V_55 ) ;
} else
V_62 = - V_66 ;
}
F_49 ( V_59 -> V_67 + V_54 , V_29 , V_55 ) ;
F_50 ( F_15 ( V_5 -> V_2 . V_15 ) ) ;
return V_62 ;
}
int F_51 ( struct V_1 * V_2 , struct V_58 * V_59 )
{
struct V_72 * V_70 = & V_59 -> V_70 ;
struct V_3 * V_5 = & V_59 -> V_73 ;
V_59 -> V_55 = F_52 ( V_70 ) ;
if ( ! F_53 ( V_2 , V_70 -> V_71 , F_52 ( V_70 ) ,
F_13 ( & V_5 -> V_2 ) ) ) {
F_54 ( V_2 , L_10 , V_70 ) ;
return - V_32 ;
}
V_5 -> V_74 = F_39 ;
if ( F_55 ( V_2 , & V_59 -> V_65 ) )
return - V_34 ;
F_56 ( F_15 ( V_5 -> V_2 . V_15 ) , & V_59 -> V_65 ,
& V_59 -> V_70 ) ;
V_59 -> V_67 = F_57 ( V_2 , V_70 -> V_71 , F_52 ( V_70 ) ,
V_75 ) ;
return F_58 ( V_59 -> V_67 ) ;
}
void F_59 ( struct V_1 * V_2 , struct V_58 * V_59 )
{
struct V_72 * V_70 = & V_59 -> V_70 ;
F_60 ( V_2 , V_59 -> V_67 ) ;
F_61 ( V_2 , & V_59 -> V_65 ) ;
F_62 ( V_2 , V_70 -> V_71 , F_52 ( V_70 ) ) ;
}
