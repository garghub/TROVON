...
V_59 = F_13 ( & V_16 -> V_22 ) ;
while ( V_59 ) {
V_60 = F_8 ( V_59 , struct V_3 , V_19 ) ;
V_59 = F_14 ( & V_60 -> V_19 ) ;
F_25 ( & V_60 -> V_19 , & V_16 -> V_22 ) ;
F_26 ( V_60 -> V_13 ) ;
F_26 ( V_60 -> V_11 ) ;
F_26 ( V_60 ) ;
}
...
if ( ! V_67 )
return - V_53 ;
if ( F_15 ( V_8 ) > F_15 ( V_4 -> V_8 ) ) {
V_66 = F_30 ( V_4 -> V_13 ,
F_15 ( V_8 ) * sizeof( * V_66 ) ,
V_52 ) ;
if ( ! V_66 ) {
F_26 ( V_67 ) ;
return - V_53 ;
}
memset ( V_66 + F_15 ( V_4 -> V_8 ) , 0 ,
( F_15 ( V_8 ) - F_15 ( V_4 -> V_8 ) )
* sizeof( * V_66 ) ) ;
} else {
V_66 = V_4 -> V_13 ;
}
...
static struct V_3 *
F_32 ( struct V_1 * V_2 , unsigned int V_14 )
{
struct V_3 * V_4 ;
const struct V_68 * V_69 ;
int V_50 ;
V_4 = F_33 ( sizeof( * V_4 ) , V_52 ) ;
if ( ! V_4 )
return NULL ;
if ( V_2 -> V_70 ) {
...
V_4 -> V_11 = F_35 ( V_4 -> V_8 , V_2 -> V_43 ,
V_52 ) ;
if ( ! V_4 -> V_11 )
goto V_75;
V_4 -> V_13 = F_36 ( F_15 ( V_4 -> V_8 ) ,
sizeof( * V_4 -> V_13 ) ,
V_52 ) ;
if ( ! V_4 -> V_13 )
goto V_76;
...
static int F_37 ( struct V_1 * V_2 , unsigned int V_79 ,
unsigned int V_80 )
{
struct V_15 * V_16 ;
struct V_18 * V_19 ;
...
continue;
if ( V_79 > V_7 )
V_85 = ( V_79 - V_7 ) / V_2 -> V_9 ;
else
V_85 = 0 ;
if ( V_80 < V_20 )
V_86 = ( V_80 - V_7 ) / V_2 -> V_9 + 1 ;
else
V_86 = V_4 -> V_8 ;
V_51 = F_38 ( V_2 , V_4 -> V_11 ,
V_4 -> V_13 ,
V_4 -> V_7 , V_85 , V_86 ) ;
if ( V_51 != 0 )
return V_51 ;
...
static int F_40 ( struct V_1 * V_2 , unsigned int V_79 ,
unsigned int V_80 )
{
struct V_15 * V_16 ;
struct V_3 * V_4 ;
