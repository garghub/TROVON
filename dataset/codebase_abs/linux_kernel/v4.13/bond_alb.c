...
static int F_73 ( struct V_117 * V_118 , void * V_119 )
{
struct V_120 * V_121 = V_119 ;
bool V_122 = V_121 -> V_122 ;
struct V_21 * V_22 = V_121 -> V_22 ;
struct V_18 * V_18 = V_121 -> V_18 ;
T_1 * V_106 = V_121 -> V_106 ;
struct V_123 * V_124 ;
...
F_68 ( V_18 , V_118 -> V_84 ,
F_76 ( V_118 ) ,
F_77 ( V_118 ) ) ;
}
}
if ( F_78 ( V_118 ) && ! V_122 ) {
V_124 = F_79 ( V_22 -> V_66 , V_118 , 0 ) ;
if ( F_80 ( V_124 ) )
F_81 () ;
F_68 ( V_18 , V_118 -> V_84 ,
...
int F_103 ( struct V_2 * V_3 , struct V_117 * V_160 )
{
...
int F_109 ( struct V_2 * V_3 , struct V_117 * V_160 )
{
struct V_21 * V_22 = F_104 ( V_160 ) ;
struct V_153 * V_154 ;
struct V_28 * V_29 = & ( F_7 ( V_22 ) ) ;
...
int F_130 ( struct V_117 * V_160 , void * V_71 )
{
struct V_21 * V_22 = F_104 ( V_160 ) ;
