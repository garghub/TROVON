...
unsigned long V_20 ;
F_87 ( V_94 ) ;
V_100 = & V_5 -> V_51 -> V_86 [ V_87 ] ;
V_5 -> V_94 [ 0 ] = (struct V_86 ) {
. V_102 = L_1 ,
. V_103 = 0 ,
. V_104 = ( F_69 ( V_100 ) >> 20 ) - 1 ,
. V_20 = V_105 | V_106 ,
} ;
V_100 = & V_5 -> V_51 -> V_86 [ V_92 ] ;
V_101 = F_88 ( V_100 -> V_104 ) ;
V_20 = V_100 -> V_20 & ~ V_107 ;
if ( ! V_101 )
V_20 &= ~ V_108 ;
...
V_99 = F_90 ( L_4 , V_5 -> V_4 . V_44 ) ;
if ( ! V_99 )
return - V_111 ;
V_5 -> V_43 = F_91 ( V_99 , & V_112 ,
V_113 ) ;
F_92 ( V_99 ) ;
if ( ! V_5 -> V_43 )
return - V_111 ;
F_93 ( & V_94 , & V_5 -> V_94 [ 0 ] ) ;
F_93 ( & V_94 , & V_5 -> V_94 [ 1 ] ) ;
F_93 ( & V_94 , & V_5 -> V_94 [ 2 ] ) ;
V_5 -> V_3 = F_94 ( & V_5 -> V_51 -> V_51 , 0 , & V_114 , V_97 ,
& V_94 ) ;
if ( ! V_5 -> V_3 ) {
F_95 ( & V_94 ) ;
F_96 ( V_5 -> V_43 ) ;
...
F_80 ( V_5 ) ;
F_64 ( V_5 ) ;
F_97 ( & V_5 -> V_3 -> V_51 , V_5 -> V_43 ) ;
F_98 ( V_5 -> V_3 ) ;
F_99 ( F_100 ( & V_5 -> V_51 -> V_51 . V_115 , & V_5 -> V_3 -> V_51 . V_115 ,
L_5 ) , L_6 ) ;
return 0 ;
}
...
struct V_12 * V_13 ;
int V_116 ;
V_116 = F_101 ( & V_7 -> V_53 ) ;
F_102 (vmdirq, &irqs->irq_list, node)
F_103 ( V_13 -> V_45 ) ;
F_104 ( & V_7 -> V_53 , V_116 ) ;
return V_117 ;
}
static int F_105 ( struct V_56 * V_51 , const struct V_118 * V_119 )
{
struct V_1 * V_5 ;
int V_37 , V_120 ;
if ( F_69 ( & V_51 -> V_86 [ V_87 ] ) < ( 1 << 20 ) )
return - V_50 ;
V_5 = F_106 ( & V_51 -> V_51 , sizeof( * V_5 ) , V_47 ) ;
if ( ! V_5 )
return - V_50 ;
V_5 -> V_51 = V_51 ;
V_120 = F_107 ( V_51 ) ;
if ( V_120 < 0 )
return V_120 ;
V_5 -> V_84 = F_108 ( V_51 , V_87 , 0 ) ;
if ( ! V_5 -> V_84 )
return - V_50 ;
F_109 ( V_51 ) ;
if ( F_110 ( & V_51 -> V_51 , F_111 ( 64 ) ) &&
F_110 ( & V_51 -> V_51 , F_111 ( 32 ) ) )
return - V_111 ;
V_5 -> V_41 = F_112 ( V_51 ) ;
if ( V_5 -> V_41 < 0 )
return - V_111 ;
V_5 -> V_41 = F_113 ( V_51 , 1 , V_5 -> V_41 ,
V_121 | V_122 ) ;
if ( V_5 -> V_41 < 0 )
return V_5 -> V_41 ;
V_5 -> V_7 = F_114 ( & V_51 -> V_51 , V_5 -> V_41 , sizeof( * V_5 -> V_7 ) ,
V_47 ) ;
if ( ! V_5 -> V_7 )
return - V_50 ;
for ( V_37 = 0 ; V_37 < V_5 -> V_41 ; V_37 ++ ) {
V_120 = F_115 ( & V_5 -> V_7 [ V_37 ] . V_53 ) ;
if ( V_120 )
return V_120 ;
F_20 ( & V_5 -> V_7 [ V_37 ] . V_24 ) ;
V_120 = F_116 ( & V_51 -> V_51 , F_21 ( V_51 , V_37 ) ,
V_12 , V_123 ,
L_7 , & V_5 -> V_7 [ V_37 ] ) ;
if ( V_120 )
return V_120 ;
...
if ( V_120 )
return V_120 ;
F_119 ( & V_5 -> V_51 -> V_51 , L_8 ,
V_5 -> V_4 . V_44 ) ;
return 0 ;
}
static void F_120 ( struct V_1 * V_5 )
{
int V_37 ;
for ( V_37 = 0 ; V_37 < V_5 -> V_41 ; V_37 ++ )
F_121 ( & V_5 -> V_7 [ V_37 ] . V_53 ) ;
}
static void F_122 ( struct V_56 * V_51 )
{
struct V_1 * V_5 = F_123 ( V_51 ) ;
F_81 ( V_5 ) ;
F_124 ( & V_5 -> V_51 -> V_51 . V_115 , L_5 ) ;
F_125 ( V_5 -> V_3 ) ;
F_126 ( V_5 -> V_3 ) ;
F_120 ( V_5 ) ;
F_62 ( V_5 ) ;
...
static int F_129 ( struct V_54 * V_51 )
{
struct V_56 * V_57 = F_28 ( V_51 ) ;
F_130 ( V_57 ) ;
return 0 ;
