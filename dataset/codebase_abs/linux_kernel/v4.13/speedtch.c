...
if ( V_2 -> V_13 . V_38 )
if ( ( V_8 = F_16 ( V_7 , V_37 , V_2 -> V_13 . V_38 ) ) < 0 ) {
F_14 ( V_5 , L_59 , V_12 , V_2 -> V_13 . V_38 , V_8 ) ;
V_2 -> V_13 . V_38 = 0 ;
}
if ( ! V_2 -> V_13 . V_38 && V_105 )
if ( ( V_8 = F_16 ( V_7 , V_37 , V_112 ) ) < 0 ) {
F_5 ( V_5 , L_59 , V_12 , V_112 , V_8 ) ;
V_105 = 0 ;
}
if ( V_105 ) {
...
F_5 ( V_5 , L_62 , V_12 , V_5 -> V_126 & V_130 ? L_63 : L_64 ) ;
if ( ! ( V_5 -> V_126 & V_130 ) )
if ( ( V_8 = F_69 ( V_7 ) ) < 0 ) {
F_14 ( V_5 , L_65 , V_12 , V_8 ) ;
goto V_125;
}
V_5 -> V_51 = V_2 ;
return 0 ;
