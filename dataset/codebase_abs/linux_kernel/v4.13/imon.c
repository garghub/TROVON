...
int V_205 ;
F_4 ( V_2 -> V_4 , L_79 ) ;
V_205 = F_116 ( & V_168 -> V_4 . V_279 , & V_280 ) ;
if ( V_205 )
F_83 ( V_2 -> V_4 , L_80 ,
V_205 ) ;
if ( V_2 -> V_62 == V_63 )
V_205 = F_117 ( V_168 , & V_281 ) ;
else
...
T_6 V_210 , V_64 ;
V_284 = F_106 ( F_107 ( V_12 ) ) ;
V_243 = V_12 -> V_273 ;
V_247 = V_243 -> V_248 . V_249 ;
V_210 = F_109 ( V_284 -> V_267 . V_268 ) ;
V_64 = F_109 ( V_284 -> V_267 . V_269 ) ;
F_4 ( V_4 , L_82 ,
...
F_122 ( & V_12 -> V_4 . V_279 , & V_280 ) ;
F_122 ( & V_12 -> V_4 . V_279 , & V_289 ) ;
F_120 ( V_12 , NULL ) ;
if ( V_2 -> V_44 . V_46 ) {
F_25 ( V_2 -> V_5 ) ;
F_40 ( & V_2 -> V_44 . V_45 ) ;
...
static int F_126 ( struct V_11 * V_168 , T_9 V_293 )
{
