...
struct V_124 * V_125 ;
int V_75 ;
V_16 = F_50 ( & V_123 -> V_64 , sizeof( * V_2 ) ) ;
if ( ! V_16 ) {
...
V_2 = F_8 ( V_16 ) ;
V_125 = F_53 ( V_123 , V_136 , 0 ) ;
V_2 -> V_4 = F_54 ( & V_123 -> V_64 , V_125 ) ;
if ( F_55 ( V_2 -> V_4 ) ) {
V_75 = F_56 ( V_2 -> V_4 ) ;
goto V_137;
}
V_2 -> V_97 = F_57 ( & V_123 -> V_64 , NULL ) ;
if ( F_55 ( V_2 -> V_97 ) ) {
V_75 = F_56 ( V_2 -> V_97 ) ;
F_30 ( & V_123 -> V_64 , L_17 , V_75 ) ;
goto V_137;
}
V_2 -> V_25 = F_58 ( V_123 , 0 ) ;
if ( V_2 -> V_25 <= 0 ) {
...
F_3 ( V_2 , V_8 ,
V_22 | V_23 ) ;
V_75 = F_60 ( & V_123 -> V_64 , V_2 -> V_25 , F_9 , 0 ,
F_61 ( & V_123 -> V_64 ) , V_16 ) ;
if ( V_75 ) {
F_30 ( & V_123 -> V_64 , L_19 , V_75 ) ;
goto V_139;
}
V_75 = F_62 ( & V_123 -> V_64 , V_16 ) ;
if ( V_75 ) {
