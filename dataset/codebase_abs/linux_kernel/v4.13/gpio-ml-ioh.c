...
V_74 = F_31 ( V_94 ) ;
if ( V_74 ) {
F_32 ( & V_94 -> V_35 , L_5 , V_56 ) ;
goto V_98;
}
V_74 = F_33 ( V_94 , V_99 ) ;
if ( V_74 ) {
F_32 ( & V_94 -> V_35 , L_6 , V_74 ) ;
goto V_100;
}
V_43 = F_34 ( V_94 , 1 , 0 ) ;
if ( ! V_43 ) {
F_32 ( & V_94 -> V_35 , L_7 , V_56 ) ;
V_74 = - V_83 ;
goto V_101;
}
V_97 = F_35 ( sizeof( * V_7 ) * 8 , V_102 ) ;
if ( V_97 == NULL ) {
F_32 ( & V_94 -> V_35 , L_8 , V_56 ) ;
V_74 = - V_83 ;
goto V_103;
}
V_7 = V_97 ;
...
V_7 = V_97 ;
V_74 = F_39 ( & V_94 -> V_35 , V_94 -> V_52 , F_24 ,
V_107 , V_99 , V_7 ) ;
if ( V_74 != 0 ) {
F_32 ( & V_94 -> V_35 ,
L_11 , V_56 ) ;
...
static int F_48 ( struct V_93 * V_94 , T_4 V_108 )
{
T_5 V_74 ;
struct V_6 * V_7 = F_47 ( V_94 ) ;
unsigned long V_8 ;
...
V_74 = F_49 ( V_94 ) ;
if ( V_74 ) {
F_32 ( & V_94 -> V_35 , L_13 , V_74 ) ;
return V_74 ;
}
F_45 ( V_94 ) ;
F_50 ( V_94 , V_109 ) ;
V_74 = F_51 ( V_94 , V_109 , 1 ) ;
if ( V_74 )
F_32 ( & V_94 -> V_35 , L_14 , V_74 ) ;
return 0 ;
}
...
struct V_6 * V_7 = F_47 ( V_94 ) ;
unsigned long V_8 ;
V_74 = F_51 ( V_94 , V_109 , 0 ) ;
F_50 ( V_94 , V_109 ) ;
V_74 = F_31 ( V_94 ) ;
if ( V_74 ) {
F_32 ( & V_94 -> V_35 , L_15 , V_74 ) ;
return V_74 ;
}
F_53 ( V_94 ) ;
F_3 ( & V_7 -> V_9 , V_8 ) ;
