...
static void
F_311 ( void * V_98 , enum V_762 V_763 )
{
struct V_760 * V_761 = V_98 ;
struct V_764 * V_214 =
...
static void
F_312 ( void * V_98 , enum V_762 V_763 )
{
struct V_760 * V_761 = V_98 ;
struct V_768 * V_214 =
...
void
F_314 ( struct V_760 * V_761 , struct V_1 * V_2 , void * V_552 ,
struct V_553 * V_554 , T_2 V_614 )
{
V_761 -> V_2 = V_2 ;
V_761 -> V_554 = V_554 ;
...
void
F_315 ( struct V_760 * V_761 , T_6 * V_277 , T_7 V_278 ,
T_2 V_614 )
{
if ( V_614 )
return;
...
T_4
F_316 ( struct V_760 * V_761 , void * V_218 , T_1 V_158 , T_1 V_376 ,
...
T_4
F_317 ( struct V_760 * V_761 , void * V_218 , T_1 V_158 , T_1 V_376 ,
T_19 V_18 , void * V_98 )
{
F_3 ( V_761 , V_774 ) ;
F_3 ( V_761 , V_158 ) ;
...
T_4
F_318 ( struct V_760 * V_761 , T_1 * V_775 )
{
if ( V_761 -> V_2 -> V_188 != V_269 )
return V_772 ;
if ( ! F_131 ( V_761 -> V_2 ) )
...
static void
F_321 ( void T_3 * V_785 , T_6 V_786 ,
...
static void
F_322 ( void T_3 * V_785 , T_1 V_795 )
{
union V_796 V_437 ;
...
static T_1
F_326 ( void T_3 * V_785 , T_1 V_376 , T_1 V_158 ,
char * V_218 )
{
int V_142 ;
...
return V_814 ;
F_322 ( V_785 , V_376 ) ;
F_321 ( V_785 , 0 , ( T_6 ) V_158 , 4 , V_815 ) ;
return 0 ;
}
static T_1
...
static void
F_328 ( void T_3 * V_785 , T_1 V_158 , char * V_218 )
{
T_1 V_61 ;
...
if ( V_823 > V_574 )
V_823 = V_574 ;
V_142 = F_326 ( V_785 , V_376 + V_136 , V_823 ,
& V_218 [ V_136 ] ) ;
if ( V_142 < 0 ) {
F_332 ( V_785 ) ;
return V_219 ;
