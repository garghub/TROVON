...
static void F_27 ( struct V_10 * V_11 , struct V_39 * V_39 )
{
T_3 * V_56 = V_39 -> V_63 ;
F_13 ( L_14 , ( T_4 ) V_56 [ 16 ] << 8 | V_56 [ 17 ] ) ;
V_11 -> V_61 = V_56 [ 18 ] ;
F_13 ( L_15 , V_11 -> V_61 ) ;
memcpy ( V_11 -> V_62 , V_56 + 19 , 6 ) ;
V_11 -> V_58 ++ ;
F_28 ( & V_11 -> V_57 ) ;
}
static void F_29 ( struct V_10 * V_11 , int V_64 )
{
...
static struct V_74 * * F_35 ( struct V_10 * V_11 ,
struct V_74 * * V_75 )
{
int V_76 = 0 ;
int V_64 ;
...
static T_5 F_36 ( int V_78 , void * V_79 )
{
...
static void F_38 ( unsigned long V_56 )
{
...
static T_5 F_40 ( int V_78 , void * V_79 )
{
struct V_10 * V_11 = V_79 ;
...
static int F_44 ( struct V_84 * V_60 , int V_64 ,
struct V_85 * V_86 )
{
struct V_10 * V_11 = F_45 ( V_60 ) ;
...
V_34 -> V_95 , V_35 , V_92 ) ;
F_2 ( & V_3 , V_2 ) ;
V_15 = F_51 ( & V_34 -> V_44 , V_87 , V_93 , V_89 ) ;
break;
case V_98 :
V_92 = F_52 ( V_35 , V_89 ) ;
if ( V_92 == 0 ) {
...
V_34 -> V_95 , V_35 , V_92 ) ;
F_2 ( & V_3 , V_2 ) ;
V_15 = F_53 ( & V_34 -> V_44 , V_87 , V_93 , V_89 ) ;
break;
default:
F_10 ( L_20 ,
V_34 -> V_95 , V_86 -> V_67 ) ;
...
static int F_54 ( struct V_84 * V_60 , int V_64 ,
struct V_39 * V_39 )
{
struct V_10 * V_11 = F_45 ( V_60 ) ;
struct V_33 * V_34 = V_11 -> V_65 + V_64 ;
...
static void F_55 ( struct V_84 * V_60 , int V_64 ,
void (* V_59)( struct V_84 * ,
...
V_39 = F_56 ( & V_11 -> V_60 , V_11 -> V_80 , NULL ) ;
if ( ! V_39 )
return;
V_39 -> V_47 = 5 ;
V_56 = V_39 -> V_63 ;
...
static int F_58 ( struct V_84 * V_60 , int V_64 )
{
struct V_10 * V_11 = F_45 ( V_60 ) ;
struct V_33 * V_34 = V_11 -> V_65 + V_64 ;
unsigned long V_2 ;
...
struct V_102 * V_103 ;
int V_78 ;
V_11 = F_63 ( & V_9 -> V_11 , sizeof( * V_11 ) , V_104 ) ;
if ( ! V_11 )
return - V_105 ;
V_11 -> V_80 = - 1 ;
F_64 ( V_9 , V_11 ) ;
V_100 = F_65 ( V_9 , V_106 , 0 ) ;
V_11 -> V_28 = F_66 ( & V_9 -> V_11 , V_100 ) ;
if ( F_67 ( V_11 -> V_28 ) )
return F_68 ( V_11 -> V_28 ) ;
V_78 = F_69 ( V_9 , 0 ) ;
if ( V_78 < 0 ) {
F_70 ( & V_9 -> V_11 , L_24 ) ;
return - V_32 ;
}
V_27 = F_71 ( & V_9 -> V_11 , V_78 , F_40 , 0 ,
L_25 , V_11 ) ;
if ( V_27 ) {
F_70 ( & V_9 -> V_11 , L_26 , V_78 ) ;
return V_27 ;
}
V_78 = F_69 ( V_9 , 1 ) ;
if ( V_78 < 0 ) {
...
V_27 = F_71 ( & V_9 -> V_11 , V_78 , F_36 , 0 ,
L_28 , V_11 ) ;
if ( V_27 ) {
F_70 ( & V_9 -> V_11 , L_29 , V_78 ) ;
return V_27 ;
}
F_72 ( & V_11 -> V_57 ) ;
V_11 -> V_58 = 0 ;
V_11 -> V_107 = F_73 ( & F_24 , ( void * ) V_11 ,
L_30 ) ;
if ( F_67 ( V_11 -> V_107 ) )
return F_68 ( V_11 -> V_107 ) ;
...
F_74 ( & V_34 -> V_55 ) ;
V_34 -> V_42 = false ;
snprintf ( V_34 -> V_95 , sizeof( V_34 -> V_95 ) , L_31 , V_101 * 2 + 2 ) ;
...
V_11 -> V_60 . V_122 = V_123 ;
V_11 -> V_60 . V_124 = V_11 -> V_95 ;
V_11 -> V_60 . V_125 = V_77 ;
V_11 -> V_60 . V_126 = V_11 -> V_110 ;
V_11 -> V_60 . V_127 = F_44 ;
V_11 -> V_60 . F_54 = F_54 ;
V_11 -> V_60 . F_58 = F_58 ;
V_11 -> V_60 . F_55 = F_55 ;
V_103 = F_75 ( & V_11 -> V_60 ) ;
if ( F_67 ( V_103 ) ) {
V_27 = F_68 ( V_103 ) ;
F_70 ( & V_9 -> V_11 , L_35 ) ;
goto V_128;
}
V_27 = F_76 ( & V_11 -> V_129 , V_103 ) ;
if ( V_27 )
goto V_130;
V_27 = F_11 ( V_9 ) ;
if ( V_27 ) {
