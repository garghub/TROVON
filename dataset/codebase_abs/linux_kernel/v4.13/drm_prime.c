...
static void F_32 ( struct V_3 * V_3 , void * V_48 )
{
struct V_26 * V_27 = V_3 -> V_28 ;
struct V_29 * V_30 = V_27 -> V_30 ;
...
struct V_3 * F_38 ( struct V_29 * V_30 ,
struct V_26 * V_27 ,
int V_56 )
{
struct V_45 V_46 = {
...
static struct V_3 * F_39 ( struct V_29 * V_30 ,
struct V_26 * V_27 ,
T_1 V_56 )
{
struct V_3 * V_41 ;
...
V_27 = V_30 -> V_33 -> V_82 ( V_30 , V_23 , V_36 ) ;
if ( F_21 ( V_27 ) ) {
V_71 = F_43 ( V_27 ) ;
goto V_85;
}
...
struct V_26 * F_52 ( struct V_29 * V_30 ,
struct V_3 * V_3 )
{
return F_46 ( V_30 , V_3 , V_30 -> V_30 ) ;
}
...
int F_57 ( struct V_29 * V_30 , void * V_89 ,
struct V_68 * V_69 )
{
struct V_90 * args = V_89 ;
if ( ! F_58 ( V_30 , V_91 ) )
return - V_42 ;
if ( ! V_30 -> V_33 -> V_92 )
return - V_55 ;
if ( args -> V_56 & ~ ( V_93 | V_94 ) )
return - V_42 ;
return V_30 -> V_33 -> V_92 ( V_30 , V_69 ,
args -> V_4 , args -> V_56 , & args -> V_95 ) ;
}
int F_59 ( struct V_29 * V_30 , void * V_89 ,
struct V_68 * V_69 )
{
struct V_90 * args = V_89 ;
if ( ! F_58 ( V_30 , V_91 ) )
...
if ( ! V_30 -> V_33 -> V_96 )
return - V_55 ;
return V_30 -> V_33 -> V_96 ( V_30 , V_69 ,
args -> V_95 , & args -> V_4 ) ;
}
struct V_35 * F_60 ( struct V_97 * * V_98 , unsigned int V_99 )
{
struct V_35 * V_100 = NULL ;
int V_71 ;
V_100 = F_2 ( sizeof( struct V_35 ) , V_10 ) ;
if ( ! V_100 ) {
V_71 = - V_11 ;
goto V_79;
}
V_71 = F_61 ( V_100 , V_98 , V_99 , 0 ,
V_99 << V_101 , V_10 ) ;
if ( V_71 )
goto V_79;
return V_100 ;
...
int F_62 ( struct V_35 * V_36 , struct V_97 * * V_98 ,
T_2 * V_102 , int V_103 )
{
unsigned V_104 ;
struct V_105 * V_100 ;
...
T_2 V_51 ;
V_107 = 0 ;
F_63 (sgt->sgl, sg, sgt->nents, count) {
V_106 = V_100 -> V_108 ;
V_97 = F_64 ( V_100 ) ;
V_51 = F_65 ( V_100 ) ;
while ( V_106 > 0 ) {
...
void F_66 ( struct V_26 * V_27 , struct V_35 * V_100 )
{
struct V_22 * V_23 ;
struct V_3 * V_3 ;
V_23 = V_27 -> V_77 ;
if ( V_100 )
F_50 ( V_23 , V_100 , V_83 ) ;
V_3 = V_23 -> V_41 ;
F_51 ( V_23 -> V_41 , V_23 ) ;
F_17 ( V_3 ) ;
}
