...
return V_32 ;
V_96 = & V_27 -> V_96 ;
V_96 -> V_107 = V_85 -> V_107 ;
V_32 = F_42 ( V_96 , NULL , 0 ) ;
if ( V_32 )
return V_32 ;
V_2 -> V_27 [ V_2 -> V_108 ] = V_27 ;
V_2 -> V_108 ++ ;
return 0 ;
}
...
{
int V_109 ;
for ( V_109 = 0 ; V_109 < V_2 -> V_108 ; V_109 ++ )
F_44 ( & V_2 -> V_27 [ V_109 ] -> V_96 ) ;
}
...
F_48 ( V_113 , V_2 ) ;
V_2 -> V_79 = V_79 ;
V_115 = F_49 ( V_113 , V_116 , L_8 ) ;
V_2 -> V_4 = F_50 ( V_79 , V_115 ) ;
if ( F_51 ( V_2 -> V_4 ) )
return F_52 ( V_2 -> V_4 ) ;
V_115 = F_49 ( V_113 , V_116 , L_9 ) ;
V_2 -> V_50 = F_50 ( V_79 , V_115 ) ;
if ( F_51 ( V_2 -> V_50 ) )
...
static int F_59 ( struct V_112 * V_113 )
{
