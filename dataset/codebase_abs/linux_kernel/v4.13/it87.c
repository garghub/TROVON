...
! ( V_118 -> V_175 ) )
V_118 -> V_195 = F_1 ( V_115 ,
V_196 ) ;
V_2 = F_1 ( V_115 , V_187 ) ;
V_194 = V_118 -> type == V_150 && ( V_2 & F_14 ( 2 ) ) ;
if ( ( V_118 -> type == V_134 || V_194 ) && ! ( V_2 & F_14 ( 1 ) ) ) {
V_2 |= F_14 ( 1 ) ;
F_4 ( V_115 , V_187 , V_2 ) ;
F_111 ( L_27 ) ;
}
...
{
struct V_117 * V_118 = F_115 ( & V_201 -> V_29 ) ;
struct V_9 * V_10 = F_116 ( V_201 ) ;
int V_95 , V_25 ;
T_1 V_202 ;
for ( V_25 = 0 ; V_25 < V_203 ; V_25 ++ ) {
V_10 -> V_22 [ V_25 ] = V_25 ;
V_10 -> V_23 [ V_25 ] = 0x7f ;
...
V_95 = F_25 ( V_10 , V_204 ) ;
if ( ( V_95 & 0xff ) == 0 ) {
F_28 ( V_10 , V_204 , 0xff ) ;
}
V_202 = 0x70 & ~ ( V_118 -> V_189 << 4 ) ;
V_10 -> V_63 = F_25 ( V_10 , V_64 ) ;
if ( ( V_10 -> V_63 & V_202 ) == 0 ) {
V_10 -> V_63 |= V_202 ;
F_28 ( V_10 , V_64 ,
V_10 -> V_63 ) ;
}
...
int V_25 ;
T_1 V_207 [ 3 ] ;
for ( V_25 = 0 ; V_25 < F_121 ( V_207 ) ; V_25 ++ )
V_207 [ V_25 ] = F_25 ( V_10 ,
V_21 [ V_25 ] ) ;
if ( ! ( ( V_207 [ 0 ] | V_207 [ 1 ] | V_207 [ 2 ] ) & 0x80 ) ) {
F_122 ( V_29 ,
L_33 ) ;
F_28 ( V_10 , V_66 ,
V_95 | 0x87 ) ;
...
struct V_9 * V_10 ;
struct V_208 * V_209 ;
struct V_28 * V_29 = & V_201 -> V_29 ;
struct V_117 * V_118 = F_115 ( V_29 ) ;
int V_210 ;
struct V_28 * V_211 ;
V_209 = F_124 ( V_201 , V_212 , 0 ) ;
if ( ! F_125 ( & V_201 -> V_29 , V_209 -> V_213 , V_214 ,
V_6 ) ) {
F_73 ( V_29 , L_37 ,
( unsigned long ) V_209 -> V_213 ,
( unsigned long ) ( V_209 -> V_213 + V_214 - 1 ) ) ;
return - V_7 ;
}
V_10 = F_126 ( & V_201 -> V_29 , sizeof( struct V_9 ) , V_215 ) ;
if ( ! V_10 )
return - V_216 ;
V_10 -> V_16 = V_209 -> V_213 ;
V_10 -> type = V_118 -> type ;
V_10 -> V_217 = V_122 [ V_118 -> type ] . V_217 ;
...
V_211 = F_131 ( V_29 ,
V_122 [ V_118 -> type ] . V_233 ,
V_10 , V_10 -> V_226 ) ;
return F_132 ( V_211 ) ;
}
static int T_6 F_133 ( int V_82 , unsigned short V_116 ,
const struct V_117 * V_118 )
{
struct V_200 * V_201 ;
struct V_208 V_209 = {
. V_213 = V_116 + V_234 ,
. V_235 = V_116 + V_234 + V_214 - 1 ,
. V_233 = V_6 ,
. V_236 = V_212 ,
} ;
int V_94 ;
...
if ( V_94 )
return V_94 ;
V_201 = F_135 ( V_6 , V_116 ) ;
if ( ! V_201 )
return - V_216 ;
V_94 = F_136 ( V_201 , & V_209 , 1 ) ;
if ( V_94 ) {
F_137 ( L_38 , V_94 ) ;
goto V_237;
}
V_94 = F_138 ( V_201 , V_118 ,
sizeof( struct V_117 ) ) ;
if ( V_94 ) {
F_137 ( L_39 ) ;
goto V_237;
...
{
int V_115 [ 2 ] = { V_239 , V_8 } ;
struct V_117 V_118 ;
unsigned short V_240 [ 2 ] ;
bool V_241 = false ;
int V_25 , V_94 ;
V_94 = F_142 ( & V_242 ) ;
if ( V_94 )
return V_94 ;
for ( V_25 = 0 ; V_25 < F_121 ( V_115 ) ; V_25 ++ ) {
memset ( & V_118 , 0 , sizeof( struct V_117 ) ) ;
V_240 [ V_25 ] = 0 ;
V_94 = F_104 ( V_115 [ V_25 ] , & V_240 [ V_25 ] , & V_118 ) ;
if ( V_94 || V_240 [ V_25 ] == 0 )
continue;
if ( V_25 && V_240 [ V_25 ] == V_240 [ 0 ] )
break;
V_94 = F_133 ( V_25 , V_240 [ V_25 ] , & V_118 ) ;
if ( V_94 )
goto V_243;
V_241 = true ;
if ( V_118 . type == V_127 )
