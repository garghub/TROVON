...
static unsigned int F_3 ( struct V_1 * V_2 , unsigned int V_4 )
{
F_2 ( V_4 , V_2 -> V_5 + V_6 ) ;
...
struct V_10 * V_11 ;
struct V_22 * V_23 ;
unsigned int V_73 = V_118 -> V_119 [ 1 ] ;
unsigned long V_13 ;
int V_102 ;
V_11 = F_37 ( V_2 , sizeof( * V_11 ) ) ;
if ( ! V_11 )
return - V_120 ;
V_102 = F_38 ( V_2 , V_118 -> V_119 [ 0 ] , 0x8 ) ;
if ( V_102 )
return V_102 ;
V_8 = F_35 ( V_2 ) ;
if ( ! V_8 )
...
V_2 -> V_122 = V_8 -> V_116 ;
if ( V_73 > 1 && V_73 <= 7 ) {
V_102 = F_39 ( V_73 , F_24 , 0 , V_2 -> V_122 ,
V_2 ) ;
if ( V_102 == 0 )
V_2 -> V_73 = V_73 ;
}
