...
void T_1 F_64 ( void )
{
V_18 = F_65 ( L_14 , sizeof( struct V_1 ) , 0 ,
V_61 | V_62 | V_63 , NULL ) ;
}
struct V_1 * F_66 ( struct V_21 * V_64 )
{
const struct V_1 * V_28 ;
struct V_1 * V_25 ;
V_25 = F_36 ( V_18 , V_26 ) ;
...
int F_67 ( struct V_1 * V_25 , T_2 V_68 )
{
return F_68 ( V_25 , V_68 ) ;
}
int F_69 ( struct V_1 * V_25 , const char * V_69 )
{
T_2 V_68 ;
int V_32 ;
V_32 = F_70 ( V_69 , strlen ( V_69 ) , & V_68 ) ;
if ( V_32 < 0 )
return V_32 ;
return F_67 ( V_25 , V_68 ) ;
}
int F_71 ( struct V_1 * V_25 , struct V_70 * V_70 )
{
if ( ! F_72 ( V_70 -> V_71 ) || ! F_73 ( V_70 -> V_72 ) )
return - V_73 ;
V_25 -> V_49 = V_70 -> V_71 ;
V_25 -> V_50 = V_70 -> V_72 ;
return F_74 ( V_25 , V_70 ) ;
}
...
#ifdef F_76
if ( F_77 () && V_1 -> V_29 ) {
if ( ( unsigned long ) V_1 -> V_29 < V_74 )
return true ;
if ( ( * ( T_2 * ) V_1 -> V_29 & 0xffffff00 ) ==
( V_75 << 24 | V_75 << 16 | V_75 << 8 ) )
return true ;
}
#endif
return false ;
}
static void F_78 ( const struct V_1 * V_1 , const char * V_76 ,
...
void F_82 ( const struct V_1 * V_1 , const char * V_78 , unsigned line )
{
F_79 ( V_77 L_27 ) ;
F_79 ( V_77 L_28 , V_78 , line ) ;
F_78 ( V_1 , L_29 , V_19 ) ;
F_83 () ;
}
void F_84 ( struct V_21 * V_22 ,
const char * V_78 , unsigned line )
{
if ( V_22 -> V_1 == V_22 -> V_20 ) {
if ( F_85 ( F_4 ( V_22 -> V_1 ) < 2 ||
F_75 ( V_22 -> V_1 ) ) )
goto V_79;
} else {
if ( F_85 ( F_4 ( V_22 -> V_20 ) < 1 ||
F_4 ( V_22 -> V_1 ) < 1 ||
F_75 ( V_22 -> V_20 ) ||
F_75 ( V_22 -> V_1 ) ) )
goto V_79;
...
F_79 ( V_77 L_30 ) ;
F_79 ( V_77 L_28 , V_78 , line ) ;
F_78 ( V_22 -> V_20 , L_31 , V_22 ) ;
if ( V_22 -> V_1 != V_22 -> V_20 )
F_78 ( V_22 -> V_1 , L_32 , V_22 ) ;
else
F_79 ( V_77 L_33 ) ;
F_83 () ;
}
