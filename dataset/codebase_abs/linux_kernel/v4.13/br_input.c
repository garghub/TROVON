...
V_10 = V_29 -> V_10 ;
if ( V_29 -> V_20 & V_70 )
F_34 ( V_10 , V_29 , F_35 ( V_5 ) -> V_71 , V_27 , false ) ;
V_63 = ! ! ( V_10 -> V_23 -> V_20 & V_21 ) ;
V_65 = F_35 ( V_5 ) -> V_72 ;
if ( F_36 ( V_65 ) ) {
if ( F_37 ( V_65 ) ) {
V_59 = V_73 ;
...
if ( V_80 != V_54 -> V_83 )
V_54 -> V_83 = V_80 ;
F_44 ( V_54 -> V_54 , V_5 , V_63 , false ) ;
} else {
if ( ! V_64 )
F_45 ( V_10 , V_5 , V_59 , V_63 , false ) ;
else
F_46 ( V_62 , V_5 , V_63 , false ) ;
}
if ( V_63 )
return F_4 ( V_5 ) ;
V_69:
...
struct V_28 * V_29 = F_30 ( V_5 -> V_23 ) ;
T_1 V_27 = 0 ;
if ( V_29 -> V_20 & V_70 && F_48 ( V_29 , V_5 , & V_27 ) )
F_34 ( V_29 -> V_10 , V_29 , F_35 ( V_5 ) -> V_71 , V_27 , false ) ;
}
...
struct V_28 * V_29 ;
struct V_4 * V_5 = * V_84 ;
const unsigned char * V_65 = F_35 ( V_5 ) -> V_72 ;
T_5 * V_85 ;
if ( F_51 ( V_5 -> V_59 == V_86 ) )
return V_87 ;
if ( ! F_52 ( F_35 ( V_5 ) -> V_71 ) )
goto V_68;
V_5 = F_53 ( V_5 , V_88 ) ;
if ( ! V_5 )
return V_89 ;
...
case V_75 :
if ( F_57 ( V_29 -> V_10 -> V_23 -> V_99 , V_65 ) )
V_5 -> V_59 = V_100 ;
F_16 ( V_25 , V_101 ,
