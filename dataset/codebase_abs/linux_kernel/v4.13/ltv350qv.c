...
if ( ! V_2 -> V_12 )
return - V_57 ;
V_53 = F_24 ( & V_16 -> V_55 , L_1 , & V_16 -> V_55 , V_2 ,
& V_59 ) ;
if ( F_25 ( V_53 ) )
return F_26 ( V_53 ) ;
V_2 -> V_53 = V_53 ;
...
static int F_28 ( struct V_54 * V_16 )
{
struct V_1 * V_2 = F_29 ( V_16 ) ;
F_17 ( V_2 , V_58 ) ;
return 0 ;
}
static int F_30 ( struct V_61 * V_55 )
{
struct V_1 * V_2 = F_31 ( V_55 ) ;
return F_17 ( V_2 , V_58 ) ;
}
static int F_32 ( struct V_61 * V_55 )
{
struct V_1 * V_2 = F_31 ( V_55 ) ;
