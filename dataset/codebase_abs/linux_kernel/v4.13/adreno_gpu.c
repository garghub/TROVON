...
V_96 . V_102 = V_103 ;
V_24 = F_46 ( V_89 , V_25 , & V_5 -> V_19 , & V_22 -> V_19 ,
V_5 -> V_7 -> V_28 , & V_96 ) ;
if ( V_24 )
return V_24 ;
F_47 ( & V_25 -> V_26 , V_104 ) ;
F_48 ( & V_25 -> V_26 ) ;
F_49 ( & V_25 -> V_26 ) ;
...
if ( V_2 -> V_31 && V_2 -> V_31 -> V_109 ) {
struct V_110 * V_109 = V_2 -> V_31 -> V_109 ;
V_24 = V_109 -> V_22 -> V_111 ( V_109 , V_112 ,
F_51 ( V_112 ) ) ;
if ( V_24 )
return V_24 ;
}
V_5 -> V_113 = F_52 ( V_89 , sizeof( * V_5 -> V_35 ) ,
V_114 ) ;
if ( F_53 ( V_5 -> V_113 ) ) {
V_24 = F_54 ( V_5 -> V_113 ) ;
V_5 -> V_113 = NULL ;
...
V_5 -> V_35 = F_55 ( V_5 -> V_113 ) ;
if ( F_53 ( V_5 -> V_35 ) ) {
F_8 ( V_89 -> V_26 , L_19 ) ;
return - V_115 ;
}
V_24 = F_7 ( V_5 -> V_113 , V_2 -> V_31 ,
& V_5 -> V_116 ) ;
if ( V_24 ) {
F_8 ( V_89 -> V_26 , L_20 , V_24 ) ;
return V_24 ;
}
return 0 ;
}
...
F_61 ( V_2 ) ;
if ( V_2 -> V_31 ) {
V_2 -> V_31 -> V_109 -> V_22 -> V_117 ( V_2 -> V_31 -> V_109 ,
V_112 , F_51 ( V_112 ) ) ;
F_62 ( V_2 -> V_31 ) ;
}
}
