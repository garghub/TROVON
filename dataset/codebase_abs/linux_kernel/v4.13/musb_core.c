...
V_1 -> V_48 . V_200 = F_11 ;
if ( V_1 -> V_271 -> V_282 )
V_1 -> V_48 . V_282 = V_1 -> V_271 -> V_282 ;
else
V_1 -> V_48 . V_282 = F_16 ;
if ( V_1 -> V_271 -> V_283 )
F_7 = V_1 -> V_271 -> V_283 ;
...
F_8 = V_1 -> V_271 -> V_284 ;
if ( V_1 -> V_271 -> V_285 )
F_83 = V_1 -> V_271 -> V_285 ;
if ( V_1 -> V_271 -> V_286 )
F_52 = V_1 -> V_271 -> V_286 ;
if ( V_1 -> V_271 -> V_287 )
V_273 = V_1 -> V_271 -> V_287 ;
if ( V_1 -> V_271 -> V_288 )
V_274 = V_1 -> V_271 -> V_288 ;
#ifndef F_167
if ( ! V_1 -> V_271 -> V_289 || ! V_1 -> V_271 -> V_290 ) {
F_77 ( V_3 , L_81 ) ;
V_183 = - V_221 ;
goto V_277;
}
V_291 = V_1 -> V_271 -> V_289 ;
V_292 = V_1 -> V_271 -> V_290 ;
#endif
if ( V_1 -> V_271 -> V_49 )
...
V_1 -> V_60 -> V_293 = & V_294 ;
}
if ( V_1 -> V_271 -> V_295 )
V_220 = V_1 -> V_271 -> V_295 ;
F_168 ( V_1 -> V_45 ) ;
F_169 ( V_1 -> V_45 , 500 ) ;
F_170 ( V_1 -> V_45 ) ;
F_6 ( V_1 -> V_45 ) ;
...
F_174 ( & V_1 -> V_90 , V_301 ) ;
V_183 = F_101 ( V_266 -> V_136 -> V_302
? V_196
: V_303 , V_1 ) ;
if ( V_183 < 0 )
goto V_304;
F_175 ( & V_1 -> V_113 , F_53 , ( unsigned long ) V_1 ) ;
if ( F_176 ( V_247 , V_1 -> V_276 , V_305 , F_177 ( V_3 ) , V_1 ) ) {
F_77 ( V_3 , L_82 , V_247 ) ;
V_183 = - V_221 ;
goto V_304;
}
...
if ( V_266 -> V_306 ) {
T_3 V_307 = F_180 ( V_1 -> V_53 ) ;
V_307 |= V_308 ;
F_181 ( V_1 -> V_53 , V_307 ) ;
}
if ( V_1 -> V_60 -> V_61 -> V_309 ) {
F_68 ( V_1 ) ;
V_1 -> V_60 -> V_61 -> V_62 = V_102 ;
} else {
F_61 ( V_1 ) ;
...
static int F_195 ( struct V_317 * V_318 )
{
struct V_2 * V_3 = & V_318 -> V_3 ;
int V_319 = F_196 ( V_318 , L_85 ) ;
struct V_320 * V_321 ;
void T_2 * V_322 ;
if ( V_319 <= 0 )
return - V_221 ;
V_321 = F_197 ( V_318 , V_323 , 0 ) ;
V_322 = F_198 ( V_3 , V_321 ) ;
if ( F_172 ( V_322 ) )
return F_173 ( V_322 ) ;
return F_163 ( V_3 , V_319 , V_322 ) ;
}
...
{
int V_19 ;
void T_2 * V_324 = V_1 -> V_53 ;
void T_2 * V_325 ;
V_1 -> V_326 . V_327 = F_83 ( V_324 , V_328 ) ;
V_1 -> V_326 . V_329 = F_7 ( V_324 , V_134 ) ;
V_1 -> V_326 . V_307 = F_180 ( V_1 -> V_53 ) ;
V_1 -> V_326 . V_21 = F_7 ( V_324 , V_24 ) ;
V_1 -> V_326 . V_330 = F_7 ( V_324 , V_121 ) ;
V_1 -> V_326 . V_46 = F_7 ( V_324 , V_38 ) ;
V_1 -> V_326 . V_78 = F_7 ( V_324 , V_98 ) ;
...
continue;
F_8 ( V_324 , V_38 , V_19 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_332 =
F_83 ( V_325 , V_333 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_334 =
F_83 ( V_325 , V_335 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_336 =
F_83 ( V_325 , V_337 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_338 =
F_83 ( V_325 , V_339 ) ;
if ( V_1 -> V_186 ) {
V_1 -> V_326 . V_331 [ V_19 ] . V_340 =
F_201 ( V_324 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_341 =
F_202 ( V_324 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_342 =
F_203 ( V_324 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_343 =
F_204 ( V_324 ) ;
}
V_1 -> V_326 . V_331 [ V_19 ] . V_344 =
F_7 ( V_325 , V_345 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_346 =
F_7 ( V_325 , V_347 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_348 =
F_7 ( V_325 , V_349 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_350 =
F_7 ( V_325 , V_351 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_352 =
F_205 ( V_1 , V_19 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_353 =
F_206 ( V_1 , V_19 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_354 =
F_207 ( V_1 , V_19 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_355 =
F_208 ( V_1 , V_19 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_356 =
F_209 ( V_1 , V_19 ) ;
V_1 -> V_326 . V_331 [ V_19 ] . V_357 =
F_210 ( V_1 , V_19 ) ;
}
}
...
void T_2 * V_325 ;
T_3 V_21 ;
F_52 ( V_324 , V_328 , V_1 -> V_326 . V_327 ) ;
F_8 ( V_324 , V_134 , V_1 -> V_326 . V_329 ) ;
F_181 ( V_1 -> V_53 , V_1 -> V_326 . V_307 ) ;
V_21 = F_7 ( V_324 , V_24 ) ;
V_21 &= V_25 | V_358 ;
V_1 -> V_326 . V_21 &= ~ ( V_25 | V_358 ) ;
V_21 |= V_1 -> V_326 . V_21 ;
F_8 ( V_324 , V_24 , V_21 ) ;
F_52 ( V_324 , V_118 , V_1 -> V_116 ) ;
F_52 ( V_324 , V_120 , V_1 -> V_119 ) ;
F_8 ( V_324 , V_121 , V_1 -> V_326 . V_330 ) ;
if ( V_1 -> V_326 . V_78 & V_99 )
F_8 ( V_324 , V_98 , V_1 -> V_326 . V_78 ) ;
for ( V_19 = 0 ; V_19 < V_1 -> V_136 -> V_178 ; ++ V_19 ) {
struct V_40 * V_41 ;
V_41 = & V_1 -> V_52 [ V_19 ] ;
if ( ! V_41 )
...
F_211 ( V_1 ) ;
V_78 = F_7 ( V_1 -> V_53 , V_98 ) ;
V_360 = V_97 | V_228 | V_126 ;
if ( ( V_78 & V_360 ) != ( V_1 -> V_326 . V_78 & V_360 ) )
V_1 -> V_75 = 0 ;
F_193 ( V_3 ) ;
F_222 ( V_3 ) ;
F_170 ( V_3 ) ;
