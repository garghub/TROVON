...
V_2 -> V_29 = V_182 . V_29 ;
F_2 ( L_52 ,
V_2 -> V_6 . V_12 , V_182 . V_183 ) ;
if( V_182 . V_183 == 64900 ) {
F_2 ( L_53 ,
V_2 -> V_6 . V_12 ,
...
if ( V_182 . V_183 == 61334 )
V_2 -> V_185 = 1 ;
}
static void F_55 ( struct V_186 * V_187 , T_2 V_188 )
{
struct V_1 * V_2 = V_187 -> V_189 ;
struct V_190 V_27 = V_2 -> V_44 ;
T_3 V_191 = 0 ;
V_191 |= ( V_188 & V_192 ) ? ( 1 << V_27 . V_48 ) : 0 ;
V_191 |= ( V_188 & V_193 ) ? ( 1 << V_27 . V_47 ) : 0 ;
V_191 |= ( V_188 & V_194 ) ? ( 1 << V_27 . V_45 ) : 0 ;
F_16 ( ( 1 << V_27 . V_48 ) | ( 1 << V_27 . V_47 ) | ( 1 << V_27 . V_45 ) , V_191 ) ;
if ( V_2 -> V_195 ) {
F_16 ( V_2 -> V_196 | V_2 -> V_197 , 0 ) ;
F_9 ( 5 ) ;
F_16 ( V_2 -> V_195 | V_2 -> V_196 | V_2 -> V_197 ,
V_2 -> V_195 | V_2 -> V_196 | V_2 -> V_197 ) ;
}
}
static T_2 F_56 ( struct V_186 * V_187 )
{
struct V_1 * V_2 = V_187 -> V_189 ;
struct V_190 V_27 = V_2 -> V_44 ;
T_2 V_198 = 0 ;
...
if ( V_191 & ( 1 << V_27 . V_48 ) )
V_198 |= V_192 ;
if ( V_191 & ( 1 << V_27 . V_46 ) )
V_198 |= V_199 ;
return V_198 ;
}
static void F_57 ( struct V_186 * V_187 , bool V_200 )
{
struct V_1 * V_2 = V_187 -> V_189 ;
struct V_190 V_27 = V_2 -> V_44 ;
T_1 V_201 = ( 1 << V_27 . V_47 ) | ( 1 << V_27 . V_45 ) | ( 1 << V_27 . V_48 ) |
( 1 << V_27 . V_46 ) ;
if ( V_200 )
F_8 ( V_201 , ( 1 << V_27 . V_48 ) | ( 1 << V_27 . V_47 ) |
( 1 << V_27 . V_45 ) ) ;
else
F_8 ( V_201 , ( 1 << V_27 . V_47 ) | ( 1 << V_27 . V_45 ) ) ;
}
static int F_13 ( struct V_1 * V_2 )
{
V_2 -> V_187 . V_189 = V_2 ;
V_2 -> V_187 . V_202 = & V_203 ;
if ( ! F_58 ( & V_2 -> V_187 ) ) {
F_2 ( L_54 , V_2 -> V_6 . V_12 ) ;
V_2 -> V_187 . V_204 = false ;
return 0 ;
}
V_2 -> V_43 = 0 ;
V_2 -> V_29 = 0 ;
...
static int F_59 ( struct V_1 * V_2 , const T_2 * V_206 , T_1 V_207 )
{
T_1 V_208 ;
T_2 V_209 ;
int V_4 ;
F_8 ( 0xffffff , V_210 | V_211 | V_212 ) ;
F_15 ( 0 ) ;
F_9 ( V_213 ) ;
F_15 ( V_212 ) ;
F_9 ( V_213 ) ;
...
int V_216 ;
V_216 = F_60 ( & V_215 , L_56 , & V_2 -> V_6 . V_7 -> V_217 ) ;
if ( V_216 != 0 ) {
F_47 ( L_57 , V_2 -> V_6 . V_12 ) ;
return V_216 ;
}
V_216 = F_59 ( V_2 , V_215 -> V_48 , V_215 -> V_218 ) ;
F_2 ( L_58 ,
V_2 -> V_6 . V_12 , ( V_216 < 0 ) ? L_59 : L_60 ) ;
F_61 ( V_215 ) ;
return V_216 ;
}
static void F_42 ( struct V_1 * V_2 , const T_2 V_219 [ 256 ] )
{
int V_4 ;
T_1 V_220 = 0 ;
int V_5 = - 1 ;
if ( V_2 -> V_6 . type == V_83 ) {
if ( ! strncmp ( V_219 , L_61 , 4 ) ) {
T_2 V_221 = 0 ;
...
V_220 *= 10 , V_220 += V_219 [ V_4 ] - '0' ;
}
} else {
unsigned short type ;
for ( V_4 = 4 * 16 ; V_4 < 8 * 16 ; V_4 += 16 ) {
T_3 V_221 = ( V_222 T_3 ) F_62 ( V_219 + V_4 , 16 ) ;
if ( ( V_221 & 0xff ) + ( V_221 >> 8 ) == 0xff )
break;
}
if ( V_4 >= 8 * 16 )
return;
V_219 += V_4 ;
type = F_63 ( ( V_223 * ) ( V_219 + 4 ) ) ;
switch( type ) {
case 0x0004 :
V_5 = V_105 ;
break;
...
V_220 = F_64 ( ( V_224 * ) ( V_219 + 6 ) ) ;
}
F_2 ( L_63 ,
V_2 -> V_6 . V_12 , V_5 ,
V_5 > 0 ? V_17 [ V_5 ] . V_13 : L_64 , V_220 ) ;
...
{
int V_225 , V_226 , V_227 , V_33 = 0 ;
V_225 = ( V_23 [ 0x41 ] & 0x7 ) ;
V_226 = ( V_23 [ 0x41 ] & 0x18 ) >> 3 ;
V_227 = ( V_23 [ 0x42 ] & 0xf0 ) >> 4 ;
...
{
if ( V_2 -> V_231 == V_232 ) {
if ( V_233 [ V_2 -> V_234 ] . V_235 & V_236 )
V_3 |= 0x10000 ;
else
V_3 &= ~ 0x10000 ;
}
...
static void F_31 ( struct V_1 * V_2 , int V_237 )
{
int V_201 = ( 1 << V_237 ) ;
F_8 ( V_201 , V_201 ) ;
F_16 ( V_201 , 0 ) ;
...
{
static int V_240 [] = { 0x08 , 0x09 , 0x0a , 0x0b , 0x0d , 0x0d , 0x01 , 0x02 ,
...
F_9 ( 10 ) ;
F_15 ( 1 << 2 ) ;
for ( V_4 = 0 ; V_4 < F_4 ( V_240 ) ; V_4 ++ ) {
V_241 = F_68 ( V_2 , 0x1E , 0 , V_240 [ V_4 ] , 1 ) ;
if ( V_241 != - 1 ) {
F_2 ( L_76 ,
V_240 [ V_4 ] , V_241 , F_12 ( V_2 , 0x1F , NULL ) ) ;
}
}
F_2 ( L_77 ) ;
}
...
F_2 ( L_78 ,
V_2 -> V_6 . V_12 ) ;
F_23 ( 0x00c3feff , V_248 ) ;
F_23 ( 0 + V_247 , V_249 ) ;
F_70 ( 1 ) ;
F_23 ( 0x10 + V_247 , V_249 ) ;
F_70 ( 10 ) ;
F_23 ( 0 + V_247 , V_249 ) ;
V_246 = F_69 ( V_249 ) ;
if ( ( ( ( V_246 >> 18 ) & 0x01 ) != 0 ) || ( ( ( V_246 >> 19 ) & 0x01 ) != 1 ) ) {
F_2 ( L_79 ,
V_2 -> V_6 . V_12 , V_246 ) ;
}
F_23 ( 0x4400 + V_247 , V_249 ) ;
F_70 ( 10 ) ;
F_23 ( 0x4410 + V_247 , V_249 ) ;
F_70 ( 1 ) ;
F_23 ( V_247 , V_249 ) ;
F_70 ( 1 ) ;
V_246 = F_69 ( V_249 ) ;
if ( ( ( ( V_246 >> 18 ) & 0x01 ) != 0 ) || ( ( ( V_246 >> 19 ) & 0x01 ) != 0 ) ) {
F_2 ( L_80 ,
V_2 -> V_6 . V_12 , V_246 ) ;
return;
}
...
{
int V_250 ;
if ( ( F_71 ( V_2 -> V_6 . V_7 -> V_251 ) & ~ 3 ) != 0xC ) {
F_47 ( L_82 ) ;
return;
}
if ( F_71 ( V_2 -> V_6 . V_7 -> V_251 ) != 0xD )
return;
F_23 ( 0x080002 , V_248 ) ;
V_250 = ( F_69 ( V_249 ) >> 21 ) & 7 ;
for (; ; ) {
switch ( V_250 ) {
case 1 :
case 5 :
...
{
static const T_2 V_252 [] = { 0x3 , 0x1 , 0x2 , 0x4 , 0xf , 0x7 , 0xe , 0x0 ,
0xd , 0xb , 0xc , 0x6 , 0x9 , 0x5 , 0x8 , 0xa } ;
F_16 ( 0x07f , V_252 [ V_59 ] ) ;
F_16 ( 0x200 , 0x200 ) ;
F_66 ( 1 ) ;
F_16 ( 0x200 , 0x000 ) ;
F_66 ( 1 ) ;
...
unsigned char V_48 ) {
unsigned int V_255 ;
V_255 = ( V_48 << 7 ) | ( ( V_254 & 3 ) << 4 ) | ( V_253 & 0xf ) ;
F_16 ( 0x1ff , V_255 ) ;
F_16 ( 0x1ff , V_255 | ( 1 << 8 ) ) ;
F_16 ( 0x1ff , V_255 ) ;
}
...
int V_253 , V_254 ;
struct V_1 * V_256 ;
static unsigned char V_257 [ 4 ] = { 3 , 0 , 2 , 1 } ;
V_256 = V_258 [ V_2 -> V_6 . V_12 ] ;
if ( V_256 == NULL ) {
return;
}
V_254 = ( V_2 -> V_6 . V_12 - V_256 -> V_6 . V_12 + 1 ) & 3 ;
V_254 = V_257 [ V_254 ] ;
V_253 = V_59 & 0xf ;
if ( V_256 -> V_259 [ V_254 ] != V_253 )
{
F_75 ( V_256 , V_256 -> V_259 [ V_254 ] , V_254 , 0 ) ;
V_256 -> V_259 [ V_254 ] = V_253 ;
F_75 ( V_256 , V_253 , V_254 , 1 ) ;
}
}
...
V_2 -> V_259 [ V_260 ] = V_260 ;
F_75 ( V_2 , V_260 , V_260 , 1 ) ;
}
if ( ( V_2 -> V_6 . V_12 < 1 ) || ( V_2 -> V_6 . V_12 > V_261 - 3 ) )
return;
V_258 [ V_2 -> V_6 . V_12 - 1 ] = V_2 ;
V_258 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_258 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_258 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
}
static void F_77 ( struct V_1 * V_2 , unsigned int V_59 )
{
static const int V_65 [] = {
V_262 , V_262 | V_263 , V_262 | V_264 , V_262 | V_263 | V_264 ,
V_265 , V_265 | V_263 , V_265 | V_264 , V_265 | V_263 | V_264 ,
V_266 , V_266 | V_267 , V_266 | V_268 , V_266 | V_267 | V_268 ,
V_269 , V_269 | V_267 , V_269 | V_268 , V_269 | V_267 | V_268 ,
} ;
F_15 ( V_65 [ V_59 % 16 ] ) ;
}
...
int V_271 = V_59 / 4 ;
F_79 ( L_89 ,
V_2 -> V_6 . V_12 , V_59 , V_271 , V_270 ) ;
F_68 ( V_2 , V_272 , 0x00 ,
( ( V_271 == 3 ) ? ( V_270 | V_270 << 2 ) : 0x00 ) , 1 ) ;
F_68 ( V_2 , V_273 , 0x00 ,
( ( V_271 == 0 ) ? ( V_270 | V_270 << 2 ) : 0x00 ) , 1 ) ;
F_68 ( V_2 , V_274 , 0x00 ,
( ( V_271 == 1 ) ? ( V_270 | V_270 << 2 ) : 0x00 ) , 1 ) ;
F_68 ( V_2 , V_275 , 0x00 ,
( ( V_271 == 2 ) ? ( V_270 | V_270 << 2 ) : 0x00 ) , 1 ) ;
F_68 ( V_2 , V_272 , 0x02 ,
( ( V_271 == 3 ) ? 0x03 : 0x00 ) , 1 ) ;
F_68 ( V_2 , V_273 , 0x02 ,
( ( V_271 == 0 ) ? 0x03 : 0x00 ) , 1 ) ;
...
long V_276 ;
int V_277 ;
unsigned char V_278 [ 2 ] ;
V_278 [ 0 ] = 0 ;
V_278 [ 1 ] = 0 ;
V_216 = F_68 ( V_2 , ( V_279 << 1 ) , V_278 [ 0 ] , V_278 [ 1 ] , 1 ) ;
if ( V_216 ) {
F_3 ( L_90 ,
V_2 -> V_6 . V_12 , V_216 ) ;
return;
}
V_216 = F_12 ( V_2 , ( V_279 << 1 ) , NULL ) ;
if ( ! ( V_216 & V_280 ) ) {
F_3 ( L_91 ,
V_2 -> V_6 . V_12 , V_216 ) ;
return;
...
V_277 = F_69 ( V_249 ) ;
if ( V_2 -> V_5 == V_281 )
V_277 = ( V_277 & ~ 0x280 ) | ( ( V_276 & 2 ) << 8 ) | ( ( V_276 & 1 ) << 7 ) ;
else
V_277 = ( V_277 & ~ 0x300 ) | ( ( V_276 & 3 ) << 8 ) ;
F_23 ( V_277 , V_249 ) ;
if ( V_2 -> V_5 == V_281 )
F_17 ( 2 << 5 , ~ V_282 , V_58 ) ;
else
F_20 ( ~ V_282 , V_58 ) ;
F_3 ( L_92 , V_2 -> V_6 . V_12 , ( int ) V_276 ) ;
}
static void F_82 ( struct V_1 * V_2 , unsigned int V_59 )
{
unsigned int V_276 = V_59 % 4 ;
if ( V_59 == V_2 -> V_137 )
V_276 = 0 ;
F_16 ( 0x3 , V_276 ) ;
}
...
unsigned char V_254 ,
unsigned char V_48 ) {
const T_1 V_283 = ( ( V_253 & 0xf ) | ( V_254 & 3 ) << 4 ) ;
const T_1 V_284 = 1 << 16 ;
const T_1 V_285 = 1 << 17 ;
const T_1 V_286 = V_48 << 18 ;
F_16 ( 0x1007f , V_283 | V_284 ) ;
F_16 ( 0x20000 , V_285 ) ;
F_16 ( 0x40000 , V_286 ) ;
F_16 ( 0x20000 , ~ V_285 ) ;
}
...
struct V_1 * V_256 ;
int V_253 , V_254 ;
static unsigned int V_257 [ 4 ] [ 4 ] = { { 0x0 , 0x4 , 0xa , 0x6 } ,
{ 0x1 , 0x5 , 0xb , 0x7 } ,
{ 0x2 , 0x8 , 0xc , 0xe } ,
{ 0x3 , 0x9 , 0xd , 0xf } } ;
V_59 = V_59 % 4 ;
...
V_254 = ( V_2 -> V_6 . V_12 - V_256 -> V_6 . V_12 ) & 3 ;
V_253 = V_257 [ V_254 ] [ V_59 ] & 0xf ;
if ( V_256 -> V_259 [ V_254 ] != V_253 ) {
F_83 ( V_256 , V_256 -> V_259 [ V_254 ] , V_254 , 0 ) ;
V_256 -> V_259 [ V_254 ] = V_253 ;
F_83 ( V_256 , V_253 , V_254 , 1 ) ;
}
}
...
for ( V_260 = 0 ; V_260 < 4 ; V_260 ++ ) {
V_2 -> V_259 [ V_260 ] = V_260 ;
F_83 ( V_2 , V_260 , V_260 , 1 ) ;
}
F_68 ( V_2 , 0x18 , 0x5 , 0x90 , 1 ) ;
if ( V_2 -> V_6 . V_12 > V_261 - 4 )
return;
V_258 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_258 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_258 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
V_258 [ V_2 -> V_6 . V_12 + 3 ] = V_2 ;
}
void T_5 F_85 ( void )
{
int V_287 = 0 ;
struct V_288 * V_217 = NULL ;
if ( V_289 & ( V_290 | V_291 ) )
V_287 = 1 ;
if ( V_289 & ( V_292 | V_293 | V_294 ) )
V_295 = 1 ;
if ( V_289 & V_296 )
V_297 = 1 ;
#ifdef F_86
...
if ( V_18 != V_298 )
F_2 ( L_98 , V_298 ) ;
while ( ( V_217 = F_87 ( V_300 ,
V_301 , V_217 ) ) ) {
unsigned char V_302 ;
F_88 ( V_217 , 0x53 , & V_302 ) ;
if ( V_70 )
F_2 ( L_99 ,
V_302 ) ;
}
...
{
unsigned char V_303 ;
if ( ! V_295 && ! V_297 && V_18 == V_298 )
return 0 ;
if ( V_239 ) {
if ( V_295 )
F_2 ( L_100 ,
V_2 -> V_6 . V_12 ) ;
if ( V_297 && V_2 -> V_11 >= 878 )
...
F_88 ( V_2 -> V_6 . V_7 , V_305 , & V_303 ) ;
if ( V_295 )
V_303 |= V_306 ;
if ( V_297 )
V_303 |= V_307 ;
F_90 ( V_2 -> V_6 . V_7 , V_305 , V_303 ) ;
}
if ( V_18 != V_298 )
F_90 ( V_2 -> V_6 . V_7 , V_308 , V_298 ) ;
return 0 ;
}
