...
V_32 -> V_6 = F_35 ( F_5 ( V_7 | V_9 | V_12 | V_8 ) ) ;
V_34 -> V_6 = F_35 ( F_5 ( V_7 | V_9 | V_12 | V_8 ) ) ;
...
static int F_86 ( struct V_97 * V_37 , const struct V_212 * V_213 )
{
...
if ( F_87 ( V_37 ) != 3 || F_88 ( V_37 ) != 3 ) {
F_26 ( V_218 L_19 ) ;
return - V_219 ;
}
V_217 = F_89 ( F_17 ( V_37 ) ,
L_20 , NULL ) ;
if ( V_217 == NULL ) {
V_217 = F_89 ( F_17 ( V_37 ) ,
L_21 , NULL ) ;
...
F_95 ( F_96 ( V_37 , 0 ) , F_97 ( V_37 , 0 ) ) ;
if ( V_26 -> V_29 == 0 )
goto V_224;
V_26 -> V_104 = F_98 ( V_37 , 0 ) ;
F_14 ( V_26 ) ;
F_11 ( V_26 , V_87 , V_109 ) ;
...
goto V_229;
V_31 -> V_50 = V_50 ;
V_31 -> V_35 = F_95 ( F_96 ( V_37 , 1 ) , F_97 ( V_37 , 1 ) ) ;
if ( ! V_31 -> V_35 )
goto V_229;
V_31 -> V_105 = F_98 ( V_37 , 1 ) ;
V_31 -> V_33 = F_95 ( F_96 ( V_37 , 2 ) , F_97 ( V_37 , 2 ) ) ;
if ( ! V_31 -> V_33 )
goto V_230;
V_31 -> V_106 = F_98 ( V_37 , 2 ) ;
V_31 -> V_131 = ( volatile struct V_14 * ) F_99 ( V_31 + 1 ) ;
V_31 -> V_139 = V_31 -> V_131 + V_112 + 1 ;
V_31 -> V_231 = (struct V_232 * ) ( V_31 -> V_139 + V_110 + 1 ) ;
F_100 ( V_31 -> V_231 ) ;
F_101 ( & V_31 -> V_103 ) ;
V_216 = F_102 ( V_26 -> V_104 , F_77 , 0 , L_25 , V_26 ) ;
if ( V_216 ) {
F_26 ( V_218 L_26 , V_26 -> V_104 ) ;
goto V_233;
}
V_216 = F_102 ( V_31 -> V_105 , F_60 , 0 , L_27 , V_26 ) ;
if ( V_216 ) {
F_26 ( V_218 L_26 , V_31 -> V_105 ) ;
goto V_234;
}
V_216 = F_102 ( V_31 -> V_106 , F_54 , 0 , L_28 , V_26 ) ;
if ( V_216 ) {
...
return 0 ;
V_236:
F_104 ( V_31 -> V_106 , V_26 ) ;
V_235:
F_104 ( V_31 -> V_105 , V_26 ) ;
V_234:
F_104 ( V_26 -> V_104 , V_26 ) ;
V_233:
F_105 ( V_31 -> V_33 ) ;
V_230:
F_105 ( V_31 -> V_35 ) ;
V_229:
F_105 ( ( void T_2 * ) V_26 -> V_29 ) ;
V_224:
F_106 ( V_37 ) ;
V_223:
F_16 ( V_36 , F_17 ( V_31 -> V_37 ) , 0 , 0 ) ;
...
static int
F_111 ( struct V_120 * V_121 , struct V_25 * V_26 )
{
struct V_30 * V_31 = F_15 ( V_26 ) ;
F_112 ( V_31 -> V_231 , V_121 ) ;
F_65 ( V_26 ) ;
return V_239 ;
}
...
static int F_114 ( struct V_97 * V_37 )
{
struct V_25 * V_26 = F_29 ( V_37 ) ;
struct V_30 * V_31 = F_15 ( V_26 ) ;
F_115 ( V_26 ) ;
