...
unsigned int F_83 ( unsigned int V_196 , T_5 V_197 , int V_198 )
{
struct V_187 * V_187 ;
if ( ! F_84 ( F_85 ( V_197 ) ) )
return V_196 ;
V_187 = F_86 ( V_197 ) ;
if ( ! F_87 ( V_199 , & V_187 -> V_200 ) && ! F_88 ( V_187 ) ) {
if ( V_198 == 0x400 ) {
F_89 ( V_187 ) ;
F_90 ( V_199 , & V_187 -> V_200 ) ;
} else
V_196 |= V_4 ;
}
return V_196 ;
}
static unsigned int F_91 ( unsigned long V_201 )
{
T_6 V_202 ;
unsigned char * V_203 ;
...
unsigned int F_91 ( unsigned long V_201 )
{
return F_92 () -> V_209 ;
}
void F_95 ( struct V_210 * V_211 , unsigned long V_201 )
{
if ( F_96 ( V_211 , V_201 ) == V_65 )
return;
F_97 ( V_211 , V_201 , 1 , V_65 ) ;
F_98 ( V_211 ) ;
if ( ( F_91 ( V_201 ) != V_65 ) && ( V_212 -> V_211 == V_211 ) ) {
F_99 ( V_211 ) ;
F_100 () ;
}
}
static int F_101 ( struct V_210 * V_211 , unsigned long V_213 )
{
...
static inline int F_101 ( struct V_210 * V_211 , unsigned long V_213 )
{
return 0 ;
}
void F_102 ( unsigned long V_213 , unsigned long V_227 ,
...
static void F_104 ( unsigned long V_213 , struct V_210 * V_211 ,
int V_25 , bool V_230 )
{
if ( V_230 ) {
if ( V_25 != F_91 ( V_213 ) ) {
...
int F_106 ( struct V_210 * V_211 , unsigned long V_213 ,
unsigned long V_227 , unsigned long V_198 ,
unsigned long V_200 )
{
bool V_232 ;
enum V_233 V_234 = F_107 () ;
T_8 * V_235 ;
unsigned long V_35 ;
T_5 * V_236 ;
unsigned V_237 ;
...
V_25 = F_96 ( V_211 , V_213 ) ;
V_26 = F_111 ( V_213 ) ;
V_35 = F_112 ( V_211 -> V_216 . V_242 , V_213 , V_26 ) ;
break;
case V_243 :
...
F_108 ( L_38 , V_211 , V_211 -> V_245 , V_35 ) ;
if ( ! V_35 ) {
F_108 ( L_39 ) ;
V_48 = 1 ;
goto V_241;
...
V_239 = F_113 ( F_114 () ) ;
if ( V_230 && F_115 ( F_116 ( V_211 ) , V_239 ) )
V_200 |= V_246 ;
#ifndef F_40
if ( V_25 != V_65 )
V_213 &= ~ ( ( 1ul << V_32 [ V_25 ] . V_30 ) - 1 ) ;
#endif
V_236 = F_117 ( V_235 , V_213 , & V_232 , & V_237 ) ;
if ( V_236 == NULL || ! F_118 ( * V_236 ) ) {
F_108 ( L_40 ) ;
V_48 = 1 ;
goto V_241;
}
V_227 |= V_247 ;
if ( ! F_119 ( V_227 , F_120 ( * V_236 ) ) ) {
F_108 ( L_41 ) ;
V_48 = 1 ;
goto V_241;
}
if ( V_237 ) {
if ( V_232 )
V_48 = F_121 ( V_213 , V_227 , V_35 , ( V_248 * ) V_236 ,
V_198 , V_200 , V_26 , V_25 ) ;
#ifdef F_37
else
V_48 = F_122 ( V_213 , V_227 , V_35 , V_236 , V_198 ,
...
F_104 ( V_213 , V_211 , V_25 , V_230 ) ;
goto V_241;
}
#ifndef F_40
F_108 ( L_42 , F_120 ( * V_236 ) ) ;
#else
F_108 ( L_43 , F_120 ( * V_236 ) ,
F_120 ( * ( V_236 + V_249 ) ) ) ;
#endif
#ifdef F_40
if ( ( F_120 ( * V_236 ) & V_250 ) && V_25 == V_66 ) {
F_95 ( V_211 , V_213 ) ;
V_25 = V_65 ;
}
if ( V_105 && V_25 == V_66 && F_123 ( * V_236 ) ) {
if ( V_230 ) {
F_95 ( V_211 , V_213 ) ;
V_25 = V_65 ;
} else if ( V_213 < V_244 ) {
...
#endif
{
int V_217 = F_101 ( V_211 , V_213 ) ;
if ( V_227 & V_217 )
V_48 = - 2 ;
else
V_48 = F_125 ( V_213 , V_227 , V_35 , V_236 , V_198 ,
V_200 , V_26 , V_217 ) ;
}
if ( V_48 == - 1 )
F_102 ( V_213 , V_227 , V_35 , V_198 , V_26 , V_25 ,
V_25 , F_120 ( * V_236 ) ) ;
#ifndef F_40
F_108 ( L_47 , F_120 ( * V_236 ) ) ;
#else
F_108 ( L_48 , F_120 ( * V_236 ) ,
F_120 ( * ( V_236 + V_249 ) ) ) ;
#endif
F_108 ( L_49 , V_48 ) ;
V_241:
...
int F_127 ( unsigned long V_213 , unsigned long V_227 , unsigned long V_198 ,
unsigned long V_252 )
{
unsigned long V_200 = 0 ;
struct V_210 * V_211 = V_212 -> V_211 ;
if ( F_110 ( V_213 ) == V_243 )
V_211 = & V_253 ;
if ( V_252 & V_254 )
V_200 |= V_255 ;
return F_106 ( V_211 , V_213 , V_227 , V_198 , V_200 ) ;
}
int F_128 ( unsigned long V_213 , unsigned long V_256 , unsigned long V_198 ,
unsigned long V_252 )
{
...
V_227 |= V_6 ;
V_227 |= V_5 ;
if ( ( V_256 & V_259 ) || ( F_110 ( V_213 ) == V_240 ) )
V_227 &= ~ V_5 ;
if ( V_198 == 0x400 )
V_227 |= V_3 ;
return F_106 ( V_211 , V_213 , V_227 , V_198 , V_200 ) ;
}
static bool F_129 ( struct V_210 * V_211 , unsigned long V_213 )
{
int V_25 = F_96 ( V_211 , V_213 ) ;
if ( F_130 ( V_25 != V_211 -> V_216 . V_260 ) )
return false ;
if ( F_130 ( ( V_25 == V_65 ) && F_101 ( V_211 , V_213 ) ) )
return false ;
return true ;
}
static bool F_129 ( struct V_210 * V_211 , unsigned long V_213 )
...
void F_131 ( struct V_210 * V_211 , unsigned long V_213 ,
unsigned long V_227 , unsigned long V_198 )
{
int V_261 ;
unsigned long V_35 ;
...
F_11 ( F_110 ( V_213 ) != V_240 ) ;
if ( ! F_129 ( V_211 , V_213 ) )
return;
F_108 ( L_50
...
return;
F_132 ( V_200 ) ;
V_236 = F_133 ( V_235 , V_213 , NULL , & V_261 ) ;
if ( ! V_236 )
goto V_263;
F_53 ( V_261 ) ;
#ifdef F_40
if ( ( F_120 ( * V_236 ) & V_250 ) || F_123 ( * V_236 ) )
goto V_263;
#endif
if ( F_115 ( F_116 ( V_211 ) , F_113 ( F_114 () ) ) )
V_262 |= V_246 ;
#ifdef F_40
...
#endif
V_48 = F_125 ( V_213 , V_227 , V_35 , V_236 , V_198 , V_262 ,
V_26 , F_101 ( V_211 , V_213 ) ) ;
if ( V_48 == - 1 )
F_102 ( V_213 , V_227 , V_35 , V_198 , V_26 ,
V_211 -> V_216 . V_260 ,
V_211 -> V_216 . V_260 ,
F_120 ( * V_236 ) ) ;
V_263:
...
static inline void F_135 ( int V_264 )
{
if ( V_264 && F_32 ( V_265 ) && V_212 -> V_266 . V_267 &&
F_136 ( V_212 -> V_266 . V_267 -> V_256 ) ) {
F_137 () ;
F_138 ( V_268 ) ;
}
}
...
void F_139 ( unsigned long V_36 , T_9 V_197 , int V_25 , int V_26 ,
unsigned long V_200 )
{
unsigned long V_33 , V_204 , V_30 , V_269 , V_270 ;
int V_264 = V_200 & V_246 ;
F_108 ( L_52 , V_36 ) ;
F_140 (pte, psize, vpn, index, shift) {
V_33 = F_10 ( V_36 , V_30 , V_26 ) ;
V_269 = F_141 ( V_197 , V_204 ) ;
if ( V_269 & V_271 )
V_33 = ~ V_33 ;
V_270 = ( V_33 & V_40 ) * V_41 ;
V_270 += V_269 & V_272 ;
F_108 ( L_53 , V_204 , V_270 , V_269 ) ;
V_42 . V_273 ( V_270 , V_36 , V_25 , V_25 ,
V_26 , V_264 ) ;
} F_142 () ;
F_135 ( V_264 ) ;
}
void F_143 ( unsigned long V_35 , unsigned long V_201 ,
...
V_277 = F_145 ( V_279 , V_275 ) ;
if ( ! V_277 )
continue;
V_269 = F_146 ( V_279 , V_275 ) ;
...
void F_147 ( unsigned long V_283 , int V_264 )
{
if ( V_42 . F_147 )
V_42 . F_147 ( V_283 , V_264 ) ;
else {
int V_275 ;
struct V_284 * V_285 =
F_148 ( & V_284 ) ;
for ( V_275 = 0 ; V_275 < V_283 ; V_275 ++ )
F_139 ( V_285 -> V_36 [ V_275 ] , V_285 -> V_197 [ V_275 ] ,
V_285 -> V_25 , V_285 -> V_26 , V_264 ) ;
}
}
void F_149 ( struct V_286 * V_267 , unsigned long V_287 , int V_48 )
{
enum V_233 V_234 = F_107 () ;
if ( F_150 ( V_267 ) ) {
#ifdef F_151
if ( V_48 == - 2 )
F_152 ( V_288 , V_267 , V_289 , V_287 ) ;
else
#endif
F_152 ( V_290 , V_267 , V_291 , V_287 ) ;
} else
F_153 ( V_267 , V_287 , V_290 ) ;
F_126 ( V_234 ) ;
}
long F_154 ( unsigned long V_33 , unsigned long V_36 ,
...
if ( ! V_35 )
return;
V_31 = F_154 ( V_33 , V_36 , F_50 ( V_27 ) , V_299 ,
V_44 ,
V_100 , V_120 ) ;
F_11 ( V_31 < 0 ) ;
F_157 ( & V_300 ) ;
...
static void F_159 ( unsigned long V_27 , unsigned long V_298 )
{
...
void F_160 ( struct V_187 * V_187 , int V_301 , int V_302 )
{
unsigned long V_200 , V_27 , V_298 ;
int V_275 ;
F_132 ( V_200 ) ;
for ( V_275 = 0 ; V_275 < V_301 ; V_275 ++ , V_187 ++ ) {
V_27 = ( unsigned long ) F_161 ( V_187 ) ;
...
void F_162 ( T_4 V_303 ,
T_4 V_304 )
{
F_11 ( V_303 != 0 ) ;
V_148 = F_163 ( T_6 , V_304 , 0x40000000 ) ;
F_71 ( V_148 ) ;
}
...
static int F_165 ( void * V_57 , T_6 V_305 )
{
if ( ! V_42 . V_115 )
return - V_50 ;
return V_42 . V_115 ( V_305 ) ;
}
static int T_1 F_166 ( void )
{
if ( ! F_167 ( L_54 , 0600 , V_306 ,
NULL , & V_307 ) ) {
F_22 ( L_55 ) ;
}
return 0 ;
