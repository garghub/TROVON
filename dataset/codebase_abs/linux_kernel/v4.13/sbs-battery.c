...
{
int V_87 ;
for ( V_87 = 0 ; V_87 < F_30 ( V_24 ) ; V_87 ++ )
...
static int F_32 ( struct V_61 * V_88 ,
enum V_31 V_32 ,
union V_33 * V_34 )
{
int V_6 = 0 ;
struct V_4 * V_5 = F_33 ( V_88 ) ;
...
static T_4 F_37 ( int V_102 , void * V_103 )
{
F_36 ( V_103 ) ;
return V_104 ;
}
static void F_38 ( struct V_1 * V_2 , enum V_105 V_106 ,
unsigned int V_107 )
{
F_36 ( F_2 ( V_2 ) ) ;
}
static void F_39 ( struct V_61 * V_88 )
{
struct V_4 * V_5 = F_33 ( V_88 ) ;
F_16 ( & V_5 -> V_60 ) ;
F_40 ( & V_5 -> V_60 , V_108 ) ;
...
static void F_41 ( struct V_110 * V_60 )
{
struct V_4 * V_5 ;
T_2 V_6 ;
V_5 = F_42 ( V_60 , struct V_4 , V_60 . V_60 ) ;
...
int V_121 ;
int V_102 ;
V_115 = F_44 ( & V_2 -> V_9 , & V_122 ,
sizeof( * V_115 ) , V_123 ) ;
if ( ! V_115 )
return - V_124 ;
V_115 -> V_125 = F_45 ( & V_2 -> V_9 , V_123 , L_9 ,
F_46 ( & V_2 -> V_9 ) ) ;
if ( ! V_115 -> V_125 )
return - V_124 ;
V_5 = F_47 ( & V_2 -> V_9 , sizeof( struct V_4 ) , V_123 ) ;
if ( ! V_5 )
return - V_124 ;
V_5 -> V_2 = V_2 ;
V_5 -> V_99 = false ;
...
V_5 -> V_59 = V_62 ;
F_48 ( & V_5 -> V_92 ) ;
V_121 = F_49 ( V_2 -> V_9 . V_126 , L_10 ,
& V_5 -> V_8 ) ;
if ( V_121 )
V_5 -> V_8 = 0 ;
V_121 = F_49 ( V_2 -> V_9 . V_126 , L_11 ,
& V_5 -> V_109 ) ;
if ( V_121 )
V_5 -> V_109 = 0 ;
if ( V_117 ) {
...
V_5 -> V_8 = V_5 -> V_8 + 1 ;
V_5 -> V_36 = F_50 ( & V_2 -> V_9 ,
L_12 , V_128 ) ;
if ( F_51 ( V_5 -> V_36 ) ) {
F_8 ( & V_2 -> V_9 , L_13 ,
F_52 ( V_5 -> V_36 ) ) ;
return F_52 ( V_5 -> V_36 ) ;
}
F_53 ( V_2 , V_5 ) ;
if ( ! V_5 -> V_36 )
goto V_129;
V_102 = F_54 ( V_5 -> V_36 ) ;
if ( V_102 <= 0 ) {
F_31 ( & V_2 -> V_9 , L_14 , V_102 ) ;
goto V_129;
}
V_121 = F_55 ( & V_2 -> V_9 , V_102 , NULL , F_37 ,
V_130 | V_131 | V_132 ,
F_46 ( & V_2 -> V_9 ) , V_5 ) ;
if ( V_121 ) {
F_31 ( & V_2 -> V_9 , L_15 , V_121 ) ;
goto V_129;
}
V_129:
if ( ! ( V_133 || V_5 -> V_36 ) ) {
...
static int F_60 ( struct V_135 * V_9 )
{
struct V_1 * V_2 = F_61 ( V_9 ) ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( V_5 -> V_58 > 0 )
F_16 ( & V_5 -> V_60 ) ;
F_10 ( V_2 , V_24 [ V_38 ] . V_26 ,
