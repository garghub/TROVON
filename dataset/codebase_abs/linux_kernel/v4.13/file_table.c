...
for (; V_66 ; V_66 = V_68 ) {
V_68 = F_52 ( V_66 ) ;
F_34 ( F_53 ( V_66 , struct V_3 , V_5 . V_69 ) ) ;
}
}
static void F_54 ( struct V_70 * V_71 )
{
F_34 ( F_2 ( V_71 , struct V_3 , V_5 . V_6 ) ) ;
}
void F_55 ( void )
{
F_50 ( NULL ) ;
...
if ( F_32 ( ! F_58 () && ! ( V_73 -> V_75 & V_76 ) ) ) {
F_59 ( & V_3 -> V_5 . V_6 , F_54 ) ;
if ( ! F_60 ( V_73 , & V_3 -> V_5 . V_6 , true ) )
return;
}
if ( F_61 ( & V_3 -> V_5 . V_69 , & V_67 ) )
F_62 ( & V_77 , 1 ) ;
}
}
...
void T_5 F_66 ( void )
{
V_8 = F_67 ( L_2 , sizeof( struct V_3 ) , 0 ,
V_78 | V_79 , NULL ) ;
F_68 ( & V_9 , 0 , V_23 ) ;
}
void T_5 F_69 ( void )
{
unsigned long V_80 ;
unsigned long V_81 = ( V_82 - F_70 () ) * 3 / 2 ;
V_81 = F_71 ( V_81 , V_82 - 1 ) ;
V_80 = ( ( V_82 - V_81 ) * ( V_83 / 1024 ) ) / 10 ;
V_10 . V_11 = F_72 (unsigned long, n, NR_FILE) ;
}
