...
static struct V_14 * F_40 ( struct V_32 * V_33 , int V_65 )
{
struct V_50 * V_51 ;
struct V_71 * V_72 ;
struct V_73 * V_74 ;
...
static struct V_14 * F_43 ( struct V_1 * V_2 )
{
struct V_50 * V_51 ;
struct V_14 * V_15 ;
T_2 V_93 ;
...
F_39 ( V_15 , V_94 , sizeof( V_94 ) ) ;
F_36 ( V_4 , F_37 ( V_15 , 4 ) ) ;
F_45 ( V_15 , V_97 ) ;
F_39 ( V_15 , F_3 ( V_2 ) -> V_10 , V_97 ) ;
F_42 ( V_15 ) ;
V_51 = F_25 ( V_15 , V_61 ) ;
V_51 -> V_28 = F_33 ( V_98 ) ;
if ( F_3 ( V_2 ) -> V_33 )
...
static struct V_14 * F_46 ( struct V_1 * V_2 )
{
struct V_50 * V_51 ;
struct V_14 * V_15 ;
if ( ! F_3 ( V_2 ) -> V_6 )
...
static struct V_14 * F_47 ( struct V_1 * V_2 , T_2 V_62 ,
T_2 V_28 , T_2 V_35 ,
const void * V_101 )
{
struct V_50 * V_51 ;
...
static void F_51 ( struct V_1 * V_107 )
{
struct V_1 * V_2 ;
F_21 ( & V_36 . V_37 ) ;
F_22 (sk, &hci_sk_list.head) {
...
static void F_52 ( struct V_32 * V_33 , int type , int V_108 , void * V_25 )
{
struct V_109 * V_51 ;
struct V_110 * V_111 ;
struct V_14 * V_15 ;
...
if ( ! V_15 )
return;
V_51 = F_37 ( V_15 , V_112 ) ;
V_51 -> V_113 = V_114 ;
V_51 -> V_115 = sizeof( * V_111 ) + V_108 ;
V_111 = F_37 ( V_15 , sizeof( * V_111 ) + V_108 ) ;
V_111 -> type = type ;
...
void F_53 ( struct V_32 * V_33 , int V_65 )
{
...
F_52 ( NULL , V_119 , sizeof( V_111 ) , & V_111 ) ;
}
if ( V_65 == V_82 ) {
struct V_1 * V_2 ;
F_21 ( & V_36 . V_37 ) ;
...
static struct V_124 * F_57 ( unsigned short V_5 )
{
struct V_124 * V_125 ;
F_49 (c, &mgmt_chan_list, list) {
if ( V_125 -> V_5 == V_5 )
return V_125 ;
}
return NULL ;
}
static struct V_124 * F_58 ( unsigned short V_5 )
{
struct V_124 * V_125 ;
F_59 ( & V_126 ) ;
V_125 = F_57 ( V_5 ) ;
...
F_62 ( & V_125 -> V_129 , & V_130 ) ;
F_60 ( & V_126 ) ;
return 0 ;
}
void F_63 ( struct V_124 * V_125 )
{
F_59 ( & V_126 ) ;
F_64 ( & V_125 -> V_129 ) ;
F_60 ( & V_126 ) ;
}
static int F_65 ( struct V_131 * V_1 )
{
...
static int F_74 ( struct V_32 * V_33 , void T_5 * V_136 )
{
T_6 V_79 ;
int V_137 ;
if ( F_75 ( & V_79 , V_136 , sizeof( V_79 ) ) )
return - V_138 ;
F_76 ( V_33 ) ;
V_137 = F_77 ( & V_33 -> V_139 , & V_79 , V_140 ) ;
F_78 ( V_33 ) ;
return V_137 ;
}
static int F_79 ( struct V_32 * V_33 , void T_5 * V_136 )
{
T_6 V_79 ;
int V_137 ;
if ( F_75 ( & V_79 , V_136 , sizeof( V_79 ) ) )
return - V_138 ;
F_76 ( V_33 ) ;
V_137 = F_80 ( & V_33 -> V_139 , & V_79 , V_140 ) ;
F_78 ( V_33 ) ;
return V_137 ;
}
static int F_81 ( struct V_1 * V_2 , unsigned int V_141 ,
unsigned long V_136 )
{
...
return - V_145 ;
case V_150 :
return F_83 ( V_33 , ( void T_5 * ) V_136 ) ;
case V_151 :
return F_84 ( V_33 , ( void T_5 * ) V_136 ) ;
case V_152 :
if ( ! F_82 ( V_148 ) )
return - V_149 ;
return F_74 ( V_33 , ( void T_5 * ) V_136 ) ;
case V_153 :
if ( ! F_82 ( V_148 ) )
return - V_149 ;
return F_79 ( V_33 , ( void T_5 * ) V_136 ) ;
}
return - V_154 ;
}
static int F_85 ( struct V_131 * V_1 , unsigned int V_141 ,
unsigned long V_136 )
{
...
if ( ! F_82 ( V_148 ) )
return - V_149 ;
return F_95 ( V_141 , V_155 ) ;
case V_172 :
return F_96 ( V_155 ) ;
}
F_86 ( V_2 ) ;
V_137 = F_81 ( V_2 , V_141 , V_136 ) ;
V_156:
F_87 ( V_2 ) ;
return V_137 ;
}
static int F_97 ( struct V_131 * V_1 , struct V_173 * V_12 ,
int V_174 )
{
struct V_175 V_176 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
V_35 = F_98 (unsigned int, sizeof(haddr), addr_len) ;
...
static int F_105 ( struct V_131 * V_1 , struct V_173 * V_12 ,
int * V_174 , int V_195 )
{
...
static void F_106 ( struct V_1 * V_2 , struct V_196 * V_197 ,
struct V_14 * V_15 )
{
V_13 V_198 = F_3 ( V_2 ) -> V_199 ;
if ( V_198 & V_200 ) {
int V_46 = F_23 ( V_15 ) -> V_46 ;
F_107 ( V_197 , V_201 , V_200 , sizeof( V_46 ) ,
& V_46 ) ;
}
if ( V_198 & V_202 ) {
#ifdef F_108
...
#endif
F_107 ( V_197 , V_201 , V_202 , V_35 , V_25 ) ;
}
}
static int F_110 ( struct V_131 * V_1 , struct V_196 * V_197 ,
T_7 V_35 , int V_4 )
{
int V_212 = V_4 & V_213 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
if ( V_2 -> V_39 == V_217 )
return 0 ;
V_15 = F_111 ( V_2 , V_4 , V_212 , & V_137 ) ;
if ( ! V_15 )
return V_137 ;
V_215 = V_15 -> V_35 ;
V_214 = V_15 -> V_35 ;
...
F_112 ( V_15 ) ;
V_137 = F_113 ( V_15 , 0 , V_197 , V_214 ) ;
switch ( F_3 ( V_2 ) -> V_5 ) {
case V_41 :
F_106 ( V_2 , V_197 , V_15 ) ;
break;
case V_45 :
case V_63 :
F_114 ( V_197 , V_2 , V_15 ) ;
break;
default:
if ( F_58 ( F_3 ( V_2 ) -> V_5 ) )
F_114 ( V_197 , V_2 , V_15 ) ;
...
static int F_116 ( struct V_124 * V_219 , struct V_1 * V_2 ,
...
return - V_127 ;
V_101 = F_117 ( V_220 , V_9 ) ;
if ( ! V_101 )
return - V_227 ;
if ( F_118 ( V_101 , V_197 , V_220 ) ) {
V_137 = - V_138 ;
goto V_156;
}
V_51 = V_101 ;
V_28 = F_119 ( V_51 -> V_28 ) ;
V_62 = F_119 ( V_51 -> V_62 ) ;
V_35 = F_119 ( V_51 -> V_35 ) ;
...
static int F_122 ( struct V_1 * V_2 , struct V_196 * V_197 , int V_35 )
{
struct V_50 * V_51 ;
struct V_14 * V_15 ;
struct V_32 * V_33 ;
...
return - V_127 ;
V_15 = F_123 ( V_2 , V_35 , V_197 -> V_208 & V_213 , & V_137 ) ;
if ( ! V_15 )
return V_137 ;
if ( F_118 ( F_37 ( V_15 , V_35 ) , V_197 , V_35 ) ) {
V_137 = - V_138 ;
goto V_240;
}
V_51 = ( void * ) V_15 -> V_25 ;
if ( F_119 ( V_51 -> V_35 ) != V_35 - sizeof( * V_51 ) ) {
V_137 = - V_127 ;
goto V_240;
}
if ( F_119 ( V_51 -> V_28 ) == 0x0000 ) {
...
static int F_124 ( struct V_131 * V_1 , struct V_196 * V_197 ,
T_7 V_35 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_124 * V_219 ;
...
goto V_156;
case V_188 :
V_137 = F_122 ( V_2 , V_197 , V_35 ) ;
goto V_156;
default:
F_59 ( & V_126 ) ;
V_219 = F_57 ( F_3 ( V_2 ) -> V_5 ) ;
if ( V_219 )
V_137 = F_116 ( V_219 , V_2 , V_197 , V_35 ) ;
else
V_137 = - V_127 ;
F_60 ( & V_126 ) ;
goto V_156;
...
F_126 ( & V_33 -> V_248 , V_15 ) ;
F_127 ( V_33 -> V_249 , & V_33 -> V_250 ) ;
} else if ( F_17 ( V_15 ) == V_42 ) {
T_2 V_28 = F_128 ( V_15 -> V_25 ) ;
T_2 V_251 = F_129 ( V_28 ) ;
T_2 V_252 = F_130 ( V_28 ) ;
if ( ( ( V_251 > V_253 ) ||
! F_15 ( V_252 & V_254 ,
& V_255 . V_256 [ V_251 ] ) ) &&
! F_82 ( V_185 ) ) {
...
F_126 ( & V_33 -> V_260 , V_15 ) ;
F_127 ( V_33 -> V_249 , & V_33 -> V_261 ) ;
}
} else {
if ( ! F_82 ( V_185 ) ) {
V_137 = - V_149 ;
...
V_35 = F_98 (unsigned int, len, sizeof(uf)) ;
if ( F_75 ( & V_266 , V_264 , V_35 ) ) {
V_137 = - V_138 ;
break;
}
if ( ! F_82 ( V_185 ) ) {
...
static int F_134 ( struct V_131 * V_1 , int V_262 , int V_263 ,
...
static int F_137 ( struct V_274 * V_274 , struct V_131 * V_1 , int V_275 ,
int V_276 )
{
struct V_1 * V_2 ;
F_20 ( L_12 , V_1 ) ;
...
return - V_278 ;
V_1 -> V_279 = & V_280 ;
V_2 = F_138 ( V_274 , V_281 , V_47 , & V_282 , V_276 ) ;
if ( ! V_2 )
return - V_227 ;
F_139 ( V_1 , V_2 ) ;
F_140 ( V_2 , V_283 ) ;
...
{
int V_137 ;
F_143 ( sizeof( struct V_175 ) > sizeof( struct V_173 ) ) ;
V_137 = F_144 ( & V_282 , 0 ) ;
if ( V_137 < 0 )
return V_137 ;
V_137 = F_145 ( V_287 , & V_288 ) ;
if ( V_137 < 0 ) {
F_146 ( L_13 ) ;
goto error;
}
V_137 = F_147 ( & V_289 , L_14 , & V_36 , NULL ) ;
if ( V_137 < 0 ) {
F_146 ( L_15 ) ;
F_148 ( V_287 ) ;
goto error;
