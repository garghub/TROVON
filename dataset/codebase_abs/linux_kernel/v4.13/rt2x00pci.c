...
V_16 = F_17 ( sizeof( struct V_1 ) , V_9 -> V_16 ) ;
if ( ! V_16 ) {
F_8 ( L_6 ) ;
V_17 = - V_13 ;
goto V_21;
...
void F_27 ( struct V_7 * V_7 )
{
struct V_15 * V_16 = F_28 ( V_7 ) ;
...
int F_30 ( struct V_7 * V_7 , T_2 V_31 )
{
struct V_15 * V_16 = F_28 ( V_7 ) ;
struct V_1 * V_2 = V_16 -> V_22 ;
int V_17 ;
...
F_32 ( V_7 ) ;
F_26 ( V_7 ) ;
return F_33 ( V_7 , F_34 ( V_7 , V_31 ) ) ;
}
int F_35 ( struct V_7 * V_7 )
{
struct V_15 * V_16 = F_28 ( V_7 ) ;
struct V_1 * V_2 = V_16 -> V_22 ;
if ( F_33 ( V_7 , V_32 ) ||
