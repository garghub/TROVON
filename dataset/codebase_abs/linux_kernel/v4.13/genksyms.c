...
{
fprintf ( V_37 , L_38 , V_76 ? : L_39 , V_77 ) ;
}
static void F_14 ( enum V_5 type , const char * V_14 )
{
if ( V_46 [ type ] . V_14 )
fprintf ( V_37 , L_40 , V_46 [ type ] . V_14 , V_14 ) ;
else
fprintf ( V_37 , L_41 , V_14 ) ;
}
void F_15 ( const char * V_78 , ... )
{
T_1 args ;
if ( V_79 ) {
F_13 () ;
va_start ( args , V_78 ) ;
vfprintf ( V_37 , V_78 , args ) ;
va_end ( args ) ;
putc ( '\n' , V_37 ) ;
V_73 ++ ;
}
...
while ( ( V_84 = F_31 ( V_80 , V_81 , L_77 ,
& V_86 [ 0 ] , NULL ) ) != V_62 )
#else
while ( ( V_84 = F_32 ( V_80 , V_81 , L_77 ) ) != V_62 )
#endif
switch ( V_84 ) {
case 's' :
V_75 = V_87 ;
...
putc ( V_46 [ V_19 -> type ] . V_53 , V_82 ) ;
putc ( '#' , V_82 ) ;
}
fputs ( V_19 -> V_14 , V_82 ) ;
putc ( ' ' , V_82 ) ;
if ( V_19 -> V_27 )
fputs ( L_15 , V_82 ) ;
F_16 ( V_82 , V_19 -> V_24 ) ;
