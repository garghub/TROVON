...
struct V_92 * V_93 = V_4 -> V_93 ;
int V_158 ;
V_158 = F_66 ( V_4 -> V_134 -> V_159 , V_157 ) ;
if ( V_158 )
return V_158 ;
V_4 -> V_118 = F_67 ( V_93 ,
F_68 ( & V_157 [ 0 ] -> V_154 ) ) ;
...
V_4 -> V_15 = F_70 ( V_4 -> V_134 , V_157 + 1 ,
3 , V_79 , V_162 ) ;
if ( V_4 -> V_15 < 0 )
return V_4 -> V_15 ;
V_4 -> V_98 = 1 ;
...
V_157 [ 0 ] = F_72 ( V_93 , V_4 -> V_107 ) ;
V_157 [ 1 ] = F_72 ( V_93 , V_4 -> V_96 ) ;
V_157 [ 2 ] = F_72 ( V_93 , V_4 -> V_97 ) ;
F_73 ( V_4 -> V_134 , V_157 , 3 , V_162 ) ;
}
static int F_74 ( struct V_151 * V_134 , const struct V_163 * V_164 )
{
int V_23 = - V_165 ;
...
F_81 ( V_134 , NULL ) ;
V_169:
F_64 ( V_93 , V_134 -> V_153 [ 0 ] . V_154 . V_155 , 0 ) ;
if ( V_70 )
F_84 ( V_70 ) ;
return V_23 ;
}
...
do {
F_87 ( & V_4 -> V_2 ) ;
V_158 = F_88 ( & V_4 -> V_119 , 5000 ) ;
if ( V_158 == 0 )
return - V_179 ;
V_158 = F_88 ( & V_4 -> V_122 , 500 ) ;
if ( V_158 == 0 )
return - V_179 ;
if ( F_89 ( V_178 , V_177 + 5 * V_180 ) )
return - V_179 ;
} while ( ! F_85 ( V_4 ) );
return 0 ;
}
...
static int F_96 ( struct V_151 * V_134 , T_3 V_182 )
{
struct V_69 * V_70 = F_91 ( V_134 ) ;
struct V_3 * V_4 = (struct V_3 * ) V_70 -> V_20 ;
if ( F_86 ( V_4 ) != 0 ) {
