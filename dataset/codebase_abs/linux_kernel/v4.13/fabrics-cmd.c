...
T_1 V_3 = 0 ;
V_45 = F_17 ( sizeof( * V_45 ) , V_46 ) ;
if ( ! V_45 ) {
V_3 = V_47 ;
goto V_48;
}
V_3 = F_18 ( V_2 , 0 , V_45 , sizeof( * V_45 ) ) ;
if ( V_3 )
goto V_49;
V_2 -> V_25 -> V_26 . V_50 = 0 ;
if ( V_37 -> V_51 != 0 ) {
F_13 ( L_3 ,
F_11 ( V_37 -> V_51 ) ) ;
V_3 = V_52 | V_14 ;
...
if ( F_19 ( V_45 -> V_53 != F_20 ( 0xffff ) ) ) {
F_13 ( L_4 ,
V_45 -> V_53 ) ;
V_3 = V_54 | V_14 ;
V_2 -> V_25 -> V_26 . V_50 = F_21 ( V_53 ) ;
goto V_49;
}
V_3 = F_22 ( V_45 -> V_55 , V_45 -> V_56 , V_2 ,
F_3 ( V_37 -> V_57 ) , & V_12 ) ;
if ( V_3 )
goto V_49;
V_3 = F_10 ( V_12 , V_2 ) ;
...
F_24 ( L_5 ,
V_12 -> V_53 , V_12 -> V_20 -> V_55 , V_12 -> V_56 ) ;
V_2 -> V_25 -> V_26 . T_1 = F_20 ( V_12 -> V_53 ) ;
V_49:
F_25 ( V_45 ) ;
V_48:
F_5 ( V_2 , V_3 ) ;
...
V_3 = F_27 ( V_45 -> V_55 , V_45 -> V_56 ,
F_11 ( V_45 -> V_53 ) ,
V_2 , & V_12 ) ;
if ( V_3 )
goto V_49;
if ( F_19 ( V_39 > V_12 -> V_20 -> V_58 ) ) {
F_13 ( L_6 , V_39 ) ;
V_3 = V_54 | V_14 ;
V_2 -> V_25 -> V_26 . V_50 = F_28 ( V_39 ) ;
goto V_59;
}
V_3 = F_10 ( V_12 , V_2 ) ;
if ( V_3 ) {
...
struct V_27 * V_4 = V_2 -> V_4 ;
V_2 -> V_28 = NULL ;
if ( V_4 -> V_60 . V_61 != V_62 ) {
F_9 ( L_8 ,
V_4 -> V_29 . V_61 ) ;
return V_35 | V_14 ;
}
if ( V_4 -> V_29 . V_30 != V_63 ) {
F_9 ( L_9 ,
V_4 -> V_29 . V_30 ) ;
return V_35 | V_14 ;
}
