...
static long F_12 ( unsigned char V_15 , unsigned char V_16 )
{
int V_1 ;
V_8 = V_17 ;
V_6 = V_18 ;
...
long F_13 ( unsigned char V_15 , unsigned char V_16 )
{
int V_1 ;
if ( ( V_15 > 31 ) || ( V_16 > 31 ) )
return - 1 ;
...
unsigned char F_16 ( unsigned char V_25 , unsigned char V_26 )
{
unsigned char V_13 ;
F_8 () ;
F_10 ( V_25 ) ;
