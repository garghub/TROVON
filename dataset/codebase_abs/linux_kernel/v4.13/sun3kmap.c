...
static inline void F_8 ( unsigned long V_1 , unsigned long V_2 ,
...
void T_2 * F_12 ( unsigned long V_1 , unsigned long V_11 ,
unsigned long type )
{
struct V_12 * V_13 ;
...
V_11 += V_14 ;
V_11 = F_13 ( V_11 ) ;
if( ( V_13 = F_14 ( V_11 , V_16 ) ) == NULL )
return NULL ;
#ifdef F_5
F_6 ( L_2 , V_13 -> V_17 , V_11 ,
V_13 -> V_11 ) ;
#endif
V_7 = V_11 / V_10 ;
