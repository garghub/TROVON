...
continue;
V_350 = F_24 ( exp -> V_248 ) ;
if ( ! strcmp ( V_350 -> V_42 -> V_46 , V_46 ) &&
F_222 ( & exp -> V_32 ) ) {
F_223 ( exp ,
F_106 ( V_2 ) . V_108 ,
F_128 ( V_110 ) ) ;
...
static int
F_225 ( struct V_308 * V_351 ,
const struct V_8 * const V_167 [] )
{
if ( V_167 [ V_330 ] ) {
if ( ! F_222 ( & V_351 -> V_32 ) )
return - V_252 ;
V_351 -> V_32 . V_317 = V_318 +
...
{
#ifdef F_74
struct V_8 * V_190 [ V_352 + 1 ] ;
struct V_3 V_319 = {} ;
int V_102 ;
V_102 = F_111 ( V_190 , V_352 , V_51 ,
V_353 , NULL ) ;
if ( V_102 < 0 )
return V_102 ;
...
V_102 = - V_209 ;
if ( V_110 -> V_211 & V_148 ) {
V_102 = F_230 ( V_141 , & V_24 , V_167 , V_208 ,
F_106 ( V_2 ) . V_108 ,
F_128 ( V_110 ) ) ;
}
return V_102 ;
...
static int
F_233 ( struct V_1 * V_2 , T_2 V_108 , T_2 V_90 , int V_220 ,
const struct V_271 * V_272 )
{
struct V_109 * V_110 ;
struct V_111 * V_112 ;
...
V_112 -> V_120 = V_121 ;
V_112 -> V_122 = F_14 ( V_220 ) ;
if ( F_16 ( V_2 , V_360 , F_17 ( V_272 -> V_361 ) ) ||
F_16 ( V_2 , V_362 , F_17 ( V_272 -> V_363 ) ) ||
F_16 ( V_2 , V_364 , F_17 ( V_272 -> V_365 ) ) )
goto V_12;
F_62 ( V_2 , V_110 ) ;
return V_2 -> V_77 ;
V_12:
...
#ifdef F_237
int V_7 ;
V_7 = F_238 ( V_141 , & V_366 ) ;
if ( V_7 < 0 ) {
F_239 ( L_5 ) ;
goto V_356;
}
V_7 = F_240 ( V_141 , & V_367 ) ;
if ( V_7 < 0 ) {
F_239 ( L_6 ) ;
goto V_368;
}
...
static void T_9 F_244 ( struct V_369 * V_370 )
{
struct V_141 * V_141 ;
