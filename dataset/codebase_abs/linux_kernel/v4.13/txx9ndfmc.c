...
if ( ! ( V_13 -> V_79 & ( 1 << V_68 ) ) )
continue;
V_7 = F_39 ( sizeof( struct V_6 ) ,
V_73 ) ;
if ( ! V_7 )
continue;
V_5 = & V_7 -> V_5 ;
V_3 = F_40 ( V_5 ) ;
V_3 -> V_8 . V_80 = & V_8 -> V_8 ;
V_5 -> V_81 = F_11 ;
V_5 -> V_82 = F_13 ;
V_5 -> V_83 = F_12 ;
V_5 -> V_84 = F_14 ;
...
if ( V_13 -> V_79 != 1 ) {
V_7 -> V_33 = V_68 ;
V_7 -> V_93 = F_42 ( V_73 , L_3 ,
F_43 ( & V_8 -> V_8 ) , V_68 ) ;
} else {
V_7 -> V_33 = - 1 ;
V_7 -> V_93 = F_44 ( F_43 ( & V_8 -> V_8 ) ,
V_73 ) ;
}
if ( ! V_7 -> V_93 ) {
F_45 ( V_7 ) ;
...
V_3 -> V_97 = V_7 -> V_93 ;
F_46 ( V_3 , NULL , NULL , NULL , 0 ) ;
V_11 -> V_98 [ V_68 ] = V_3 ;
}
return 0 ;
}
static int T_5 F_47 ( struct V_1 * V_8 )
{
struct V_10 * V_11 = F_5 ( V_8 ) ;
int V_68 ;
if ( ! V_11 )
