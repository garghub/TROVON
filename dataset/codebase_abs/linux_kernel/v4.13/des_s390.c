...
if ( V_36 &&
! ( F_19 ( V_3 , & V_3 [ V_35 ] , V_35 ) &&
F_19 ( & V_3 [ V_35 ] , & V_3 [ V_35 * 2 ] ,
V_35 ) &&
F_19 ( V_3 , & V_3 [ V_35 * 2 ] , V_35 ) ) ) {
V_2 -> V_9 |= V_11 ;
return - V_12 ;
}
memcpy ( V_6 -> V_3 , V_3 , V_4 ) ;
...
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
F_5 ( V_37 , V_6 -> V_3 , V_26 , V_29 , V_16 ) ;
}
...
struct V_21 V_22 ;
F_14 ( & V_22 , V_26 , V_29 , V_23 ) ;
return F_11 ( V_19 , V_38 | V_17 ,
& V_22 ) ;
}
static unsigned int F_26 ( T_1 * V_39 , T_1 * V_30 , unsigned int V_23 )
{
unsigned int V_40 , V_24 ;
V_24 = ( V_23 > V_41 ) ? V_41 : V_23 & ~ ( V_16 - 1 ) ;
memcpy ( V_39 , V_30 , V_16 ) ;
for ( V_40 = ( V_24 / V_16 ) - 1 ; V_40 > 0 ; V_40 -- ) {
memcpy ( V_39 + V_16 , V_39 , V_16 ) ;
F_27 ( V_39 + V_16 , V_16 ) ;
V_39 += V_16 ;
}
return V_24 ;
...
V_24 = V_16 ;
if ( V_23 >= 2 * V_16 && V_43 )
V_24 = F_26 ( V_45 , V_22 -> V_30 , V_23 ) ;
V_39 = ( V_24 > V_16 ) ? V_45 : V_22 -> V_30 ;
F_31 ( V_20 , V_6 -> V_3 , V_22 -> V_26 . V_27 . V_28 ,
V_22 -> V_29 . V_27 . V_28 , V_24 , V_39 ) ;
if ( V_39 == V_45 )
memcpy ( V_22 -> V_30 , V_39 + V_24 - V_16 ,
V_16 ) ;
F_27 ( V_22 -> V_30 , V_16 ) ;
V_25 = F_10 ( V_19 , V_22 , V_23 - V_24 ) ;
}
...
F_32 ( & V_44 ) ;
if ( V_23 ) {
F_31 ( V_20 , V_6 -> V_3 , V_42 , V_22 -> V_29 . V_27 . V_28 ,
V_16 , V_22 -> V_30 ) ;
memcpy ( V_22 -> V_26 . V_27 . V_28 , V_42 , V_23 ) ;
F_27 ( V_22 -> V_30 , V_16 ) ;
...
struct V_21 V_22 ;
F_14 ( & V_22 , V_26 , V_29 , V_23 ) ;
return F_28 ( V_19 , V_46 | V_17 , & V_22 ) ;
}
