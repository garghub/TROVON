...
struct V_109 * V_110 = F_4 ( V_108 ) ;
struct V_126 * V_127 = V_110 -> V_127 ;
int V_140 = V_139 -> V_140 . V_141 . V_142 [ 0 ] ;
if ( V_140 >= V_127 -> V_143 )
return - V_122 ;
V_110 -> V_132 = V_140 ;
F_9 ( V_108 ) ;
return 0 ;
...
struct V_107 * V_108 = F_11 ( V_137 ) ;
struct V_109 * V_110 = F_4 ( V_108 ) ;
V_139 -> V_140 . V_141 . V_142 [ 0 ] = V_110 -> V_132 ;
return 0 ;
}
...
struct V_107 * V_108 = F_11 ( V_137 ) ;
struct V_109 * V_110 = F_4 ( V_108 ) ;
V_139 -> V_140 . V_141 . V_142 [ 0 ] = V_110 -> V_148 ;
return 0 ;
}
...
struct V_107 * V_108 = F_11 ( V_137 ) ;
struct V_109 * V_110 = F_4 ( V_108 ) ;
unsigned int V_158 = V_139 -> V_140 . integer . V_140 [ 0 ] ;
if ( V_158 > 1 )
return - V_122 ;
V_110 -> V_158 = V_158 ;
return F_16 ( V_108 ) ;
...
F_7 ( V_108 -> V_2 , L_34 , V_127 -> V_143 ) ;
if ( V_127 -> V_143 ) {
struct V_336 V_337 =
...
if ( ! V_110 -> V_346 )
return;
for ( V_129 = 0 ; V_129 < V_127 -> V_143 ; V_129 ++ )
V_110 -> V_346 [ V_129 ] = V_127 -> V_131 [ V_129 ] . V_152 ;
V_110 -> V_345 . V_342 = V_127 -> V_143 ;
