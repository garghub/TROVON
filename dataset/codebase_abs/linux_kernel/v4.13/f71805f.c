...
if ( ! V_9 )
return - V_73 ;
V_70 = F_91 ( V_66 , V_74 , 0 ) ;
if ( ! F_92 ( & V_66 -> V_14 , V_70 -> V_75 + V_11 , 2 ,
V_76 ) ) {
F_93 ( & V_66 -> V_14 , L_11 ,
...
V_9 -> V_86 = F_98 ( & V_66 -> V_14 ) ;
if ( F_99 ( V_9 -> V_86 ) ) {
V_47 = F_100 ( V_9 -> V_86 ) ;
F_93 ( & V_66 -> V_14 , L_12 , V_47 ) ;
goto V_84;
}
return 0 ;
V_84:
F_101 ( & V_66 -> V_14 . V_53 , & V_82 ) ;
for ( V_62 = 0 ; V_62 < 4 ; V_62 ++ )
F_101 ( & V_66 -> V_14 . V_53 , & V_83 [ V_62 ] ) ;
F_101 ( & V_66 -> V_14 . V_53 , & V_87 ) ;
return V_47 ;
}
...
static int T_5 F_105 ( unsigned short V_88 ,
