...
if ( V_87 < 1 )
return - V_90 ;
V_42 = F_41 ( V_83 , sizeof( * V_42 ) * V_87 ,
V_110 ) ;
if ( ! V_42 )
return - V_111 ;
V_74 = F_42 ( V_109 , L_4 ,
...
{
struct V_82 * V_83 = & V_113 -> V_83 ;
struct V_108 * V_114 , * V_109 ;
struct V_48 * V_49 ;
void T_1 * V_4 ;
struct V_115 * V_116 ;
struct V_82 * V_117 ;
...
int V_74 ;
V_114 = V_83 -> V_118 ;
V_116 = F_44 ( V_113 , V_119 , 0 ) ;
if ( ! V_116 )
return - V_120 ;
V_4 = F_45 ( V_83 , V_116 ) ;
if ( F_46 ( V_4 ) )
return F_47 ( V_4 ) ;
V_49 = F_41 ( V_83 , sizeof( * V_49 ) , V_110 ) ;
if ( ! V_49 )
return - V_111 ;
V_49 -> V_5 = F_48 ( V_83 , NULL , ( V_121 void * ) V_4 ,
& V_122 ) ;
if ( F_46 ( V_49 -> V_5 ) )
