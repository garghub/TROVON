...
static int F_52 ( struct V_78 * V_78 , struct V_65 * V_79 )
{
struct V_1 * V_2 ;
int V_80 = 0 ;
...
static int F_58 ( struct V_78 * V_78 , struct V_65 * V_79 )
{
...
F_21 ( & V_2 -> V_31 ) ;
while ( ! F_59 ( & V_2 -> V_24 ) ) {
V_6 = F_60 ( V_2 -> V_24 . V_22 , struct V_5 , V_22 ) ;
F_22 ( & V_6 -> V_22 ) ;
F_16 ( NULL , V_6 ) ;
}
F_48 ( ! F_59 ( & V_2 -> V_82 ) ) ;
...
struct V_5 * V_6 ;
int V_19 ;
if ( F_63 ( & V_87 , V_86 , sizeof( V_87 ) ) != 0 )
return - V_88 ;
...
if ( ! V_6 )
return V_19 ;
if ( F_64 ( F_65 ( V_87 . V_9 , & V_25 ) > V_89 ) ) {
F_3 ( L_14 ) ;
F_16 ( NULL , V_6 ) ;
return V_19 ;
}
if ( F_63 ( V_6 -> V_11 , & V_86 -> V_90 ,
...
F_23 ( & V_2 -> V_31 ) ;
if ( F_66 ( V_86 , & V_87 , sizeof( V_87 ) ) != 0 )
return - V_88 ;
return 0 ;
}
...
V_99:
F_71 ( & V_49 -> V_50 -> V_96 ) ;
if ( V_94 == 0 && F_66 ( V_86 , & V_87 , sizeof( V_87 ) ) != 0 )
return - V_88 ;
return V_94 ;
}
static long F_72 ( struct V_1 * V_2 , void T_5 * V_86 )
{
struct V_100 V_87 ;
struct V_5 * V_6 ;
int V_101 ;
...
static int F_74 ( struct V_110 * V_111 , void T_5 * V_112 ,
...
unsigned long V_115 ;
int V_80 ;
V_80 = F_75 ( V_35 , 1 , V_113 , & V_68 ) ;
if ( V_80 < 0 )
return V_80 ;
V_111 -> V_10 [ V_111 -> V_116 ++ ] = V_68 ;
V_115 = F_76 ( V_68 ) + F_77 ( V_35 & ~ V_117 ) ;
* V_114 = F_78 ( V_115 ) ;
return 0 ;
}
...
F_80 ( V_111 -> V_10 [ V_17 ] ) ;
V_111 -> V_116 = 0 ;
}
static int F_81 ( struct V_110 * V_111 )
{
unsigned int V_17 ;
F_82 ( V_111 -> V_83 , V_111 -> V_118 ) ;
F_79 ( V_111 ) ;
...
if ( V_53 == V_120 )
continue;
if ( F_83 ( V_119 , V_111 -> V_53 [ V_17 ] ) )
return - V_88 ;
if ( V_119 != V_120 )
continue;
if ( F_84 ( V_53 , V_111 -> V_53 [ V_17 ] ) )
return - V_88 ;
}
V_111 -> V_118 = 0 ;
return 0 ;
...
V_80 = F_74 ( V_111 , V_112 , false , & V_114 ) ;
if ( V_80 < 0 )
return V_80 ;
...
V_132 = ( unsigned long ) V_112 & ~ V_134 ;
V_128 = F_47 ( V_128 , ( T_9 ) V_129 - V_132 ) ;
V_80 = F_74 ( V_111 , V_112 , true , & V_114 ) ;
if ( V_80 < 0 )
return V_80 ;
...
static long F_87 ( struct V_1 * V_2 , void T_5 * V_86 )
{
struct V_137 V_138 ;
struct V_110 V_111 ;
unsigned int V_17 ;
int V_80 = 0 ;
if ( F_63 ( & V_138 , V_86 , sizeof( V_138 ) ) )
return - V_88 ;
V_111 . V_118 = 0 ;
V_111 . V_116 = 0 ;
for ( V_17 = 0 ; V_17 < V_138 . V_9 ; V_17 ++ ) {
struct V_121 V_122 ;
if ( F_63 ( & V_122 , & V_138 . V_139 [ V_17 ] , sizeof( V_122 ) ) ) {
V_80 = - V_88 ;
goto V_140;
}
V_80 = F_85 ( & V_111 , & V_122 , & V_138 . V_139 [ V_17 ] . V_53 ) ;
if ( V_80 < 0 )
goto V_140;
F_88 () ;
}
...
static long F_89 ( struct V_65 * V_79 ,
...
switch ( V_141 ) {
case V_144 :
return F_62 ( V_2 , V_143 ) ;
case V_145 :
return F_67 ( V_2 , V_143 ) ;
case V_146 :
return F_68 ( V_2 , V_143 ) ;
case V_147 :
return F_72 ( V_2 , V_143 ) ;
case V_148 :
return F_87 ( V_2 , V_143 ) ;
default:
F_3 ( L_17 , V_2 , V_141 ) ;
return - V_149 ;
}
...
static int F_90 ( struct V_65 * V_79 , struct V_63 * V_38 )
{
struct V_1 * V_2 = V_79 -> V_67 ;
int V_8 = V_38 -> V_150 ;
int V_9 = F_91 ( V_38 ) ;
