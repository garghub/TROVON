...
F_59 ( V_111 -> V_118 -> V_119 ) ;
}
static void F_60 ( struct V_60 * V_111 )
{
struct V_120 * V_121 = V_111 -> V_118 ;
struct V_122 * V_123 = V_121 -> V_124 ;
int V_72 ;
if ( V_121 -> V_119 && ! F_61 ( V_121 -> V_119 ) )
return;
for ( V_72 = 0 ; V_72 < V_121 -> V_125 ; V_72 ++ )
F_62 ( V_123 , V_121 -> V_113 [ V_72 ] , V_121 -> V_126 ) ;
}
struct V_120 *
F_63 ( struct V_60 * V_111 ,
const struct V_127 * V_59 )
{
struct V_120 * V_121 ;
struct V_122 * V_123 ;
int V_72 ;
V_121 = F_32 ( V_111 -> V_71 , sizeof( * V_121 ) , V_83 ) ;
if ( ! V_121 )
return F_64 ( - V_84 ) ;
V_123 = F_65 () ;
if ( F_66 ( V_123 ) )
return F_67 ( V_123 ) ;
V_121 -> V_124 = V_123 ;
V_121 -> V_113 = V_59 -> V_113 ;
V_121 -> V_125 = V_59 -> V_125 ;
V_121 -> V_126 = V_59 -> V_126 ;
V_121 -> V_119 = V_59 -> V_119 ;
V_121 -> V_128 = F_58 ;
V_121 -> V_129 = F_60 ;
for ( V_72 = 0 ; V_72 < V_121 -> V_125 ; V_72 ++ )
F_62 ( V_123 , V_121 -> V_113 [ V_72 ] , V_121 -> V_126 ) ;
