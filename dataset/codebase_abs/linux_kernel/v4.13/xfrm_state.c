...
static inline int
F_80 ( struct V_4 * V_4 , T_5 V_12 , bool V_138 )
{
int V_39 , V_49 = 0 ;
...
static inline int
F_84 ( struct V_4 * V_4 , struct V_139 * V_140 , bool V_138 )
{
int V_39 , V_49 = 0 ;
for ( V_39 = 0 ; V_39 <= V_4 -> V_9 . V_10 ; V_39 ++ ) {
struct V_1 * V_2 ;
...
int F_85 ( struct V_4 * V_4 , T_5 V_12 , bool V_138 )
{
int V_39 , V_49 = 0 , V_143 = 0 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_49 = F_80 ( V_4 , V_12 , V_138 ) ;
if ( V_49 )
goto V_69;
V_49 = - V_136 ;
for ( V_39 = 0 ; V_39 <= V_4 -> V_9 . V_10 ; V_39 ++ ) {
...
int F_88 ( struct V_4 * V_4 , struct V_139 * V_140 , bool V_138 )
{
int V_39 , V_49 = 0 , V_143 = 0 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_49 = F_84 ( V_4 , V_140 , V_138 ) ;
if ( V_49 )
goto V_69;
V_49 = - V_136 ;
for ( V_39 = 0 ; V_39 <= V_4 -> V_9 . V_10 ; V_39 ++ ) {
...
void F_89 ( struct V_4 * V_4 , struct V_145 * V_146 )
{
F_17 ( & V_4 -> V_9 . V_40 ) ;
...
static void
F_90 ( struct V_1 * V_2 , const struct V_151 * V_152 ,
const struct V_153 * V_154 ,
const T_2 * V_5 , const T_2 * V_6 ,
unsigned short V_8 )
{
struct V_46 * V_47 = F_91 ( V_8 ) ;
if ( ! V_47 )
return;
V_47 -> V_155 ( & V_2 -> V_156 , V_152 ) ;
if ( V_8 != V_154 -> V_157 ) {
V_47 = F_91 ( V_154 -> V_157 ) ;
if ( ! V_47 )
return;
}
V_47 -> V_158 ( V_2 , V_154 , V_5 , V_6 ) ;
}
static struct V_1 * F_92 ( struct V_4 * V_4 , T_3 V_159 ,
const T_2 * V_5 ,
T_4 V_11 , T_5 V_12 ,
unsigned short V_8 )
{
...
struct V_1 * V_2 ;
F_93 (x, net->xfrm.state_byspi + h, byspi) {
if ( V_2 -> V_23 . V_8 != V_8 ||
V_2 -> V_22 . V_11 != V_11 ||
V_2 -> V_22 . V_12 != V_12 ||
! F_94 ( & V_2 -> V_22 . V_5 , V_5 , V_8 ) )
continue;
...
static struct V_1 * F_95 ( struct V_4 * V_4 , T_3 V_159 ,
const T_2 * V_5 ,
const T_2 * V_6 ,
...
struct V_1 * V_2 ;
F_93 (x, net->xfrm.state_bysrc + h, bysrc) {
if ( V_2 -> V_23 . V_8 != V_8 ||
V_2 -> V_22 . V_12 != V_12 ||
! F_94 ( & V_2 -> V_22 . V_5 , V_5 , V_8 ) ||
! F_94 ( & V_2 -> V_23 . V_6 , V_6 , V_8 ) )
continue;
if ( ( V_159 & V_2 -> V_159 . V_160 ) != V_2 -> V_159 . V_161 )
continue;
if ( ! F_1 ( V_2 ) )
...
F_96 ( struct V_1 * V_2 , int V_162 , int V_8 )
{
struct V_4 * V_4 = V_121 ( V_2 ) ;
T_3 V_159 = V_2 -> V_159 . V_161 & V_2 -> V_159 . V_160 ;
if ( V_162 )
return F_92 ( V_4 , V_159 , & V_2 -> V_22 . V_5 ,
V_2 -> V_22 . V_11 , V_2 -> V_22 . V_12 , V_8 ) ;
else
return F_95 ( V_4 , V_159 ,
& V_2 -> V_22 . V_5 ,
& V_2 -> V_23 . V_6 ,
V_2 -> V_22 . V_12 , V_8 ) ;
}
static void F_97 ( struct V_4 * V_4 , int V_163 )
{
if ( V_163 &&
...
static void F_98 ( struct V_164 * V_165 , struct V_1 * V_2 ,
...
if ( ( V_2 -> V_156 . V_8 &&
! F_99 ( & V_2 -> V_156 , V_152 , V_2 -> V_156 . V_8 ) ) ||
! F_100 ( V_2 , V_165 , V_152 ) )
return;
if ( ! * V_166 ||
...
V_2 -> V_98 . V_99 == V_101 ) {
if ( F_99 ( & V_2 -> V_156 , V_152 , V_2 -> V_156 . V_8 ) &&
F_100 ( V_2 , V_165 , V_152 ) )
* error = - V_136 ;
}
}
struct V_1 *
F_101 ( const T_2 * V_5 , const T_2 * V_6 ,
const struct V_151 * V_152 , struct V_153 * V_154 ,
struct V_164 * V_165 , int * V_49 ,
unsigned short V_8 )
{
static T_2 V_170 = { } ;
struct V_4 * V_4 = F_102 ( V_165 ) ;
...
if ( ! V_2 && ! error && ! V_174 ) {
if ( V_154 -> V_22 . V_11 &&
( V_172 = F_92 ( V_4 , V_159 , V_5 , V_154 -> V_22 . V_11 ,
...
F_90 ( V_2 , V_152 , V_154 , V_5 , V_6 , V_8 ) ;
memcpy ( & V_2 -> V_159 , & V_165 -> V_159 , sizeof( V_2 -> V_159 ) ) ;
error = F_107 ( V_2 , V_165 -> V_182 , V_152 -> V_183 ) ;
if ( error ) {
V_2 -> V_98 . V_99 = V_100 ;
V_173 = V_2 ;
V_2 = NULL ;
...
if ( F_108 ( V_2 , V_154 , V_165 ) == 0 ) {
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_2 -> V_98 . V_99 = V_118 ;
F_109 ( & V_2 -> V_98 . V_123 , & V_4 -> V_9 . V_184 ) ;
...
struct V_1 *
F_111 ( struct V_4 * V_4 , T_3 V_159 ,
T_2 * V_5 , T_2 * V_6 ,
...
struct V_1 * F_112 ( struct V_4 * V_4 , T_4 V_11 ,
unsigned short V_8 )
{
struct V_1 * V_2 ;
struct V_188 * V_189 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
F_113 (w, &net->xfrm.state_all, all) {
...
if ( V_2 -> V_132 )
F_115 ( & V_2 -> V_71 , V_190 + V_2 -> V_132 ) ;
V_4 -> V_9 . V_137 ++ ;
F_97 ( V_4 , V_2 -> V_24 . V_94 != NULL ) ;
}
static void F_116 ( struct V_1 * V_191 )
{
...
V_2 -> V_23 . V_7 == V_7 &&
( V_159 & V_2 -> V_159 . V_160 ) == V_2 -> V_159 . V_161 &&
F_94 ( & V_2 -> V_22 . V_5 , & V_191 -> V_22 . V_5 , V_8 ) &&
F_94 ( & V_2 -> V_23 . V_6 , & V_191 -> V_23 . V_6 , V_8 ) )
V_2 -> V_192 ++ ;
}
}
...
static struct V_1 * F_118 ( struct V_4 * V_4 ,
...
int V_49 ;
T_3 V_159 = V_2 -> V_159 . V_161 & V_2 -> V_159 . V_160 ;
int V_162 = F_82 ( V_2 -> V_22 . V_12 , V_202 ) ;
V_8 = V_2 -> V_23 . V_8 ;
V_173 = NULL ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_201 = F_96 ( V_2 , V_162 , V_8 ) ;
if ( V_201 ) {
V_173 = V_201 ;
V_201 = NULL ;
V_49 = - V_53 ;
...
V_201 = F_120 ( V_4 , V_159 , V_2 -> V_98 . V_203 ) ;
if ( V_201 && ( ( V_201 -> V_22 . V_12 != V_2 -> V_22 . V_12 ) ||
! F_94 ( & V_201 -> V_22 . V_5 , & V_2 -> V_22 . V_5 , V_8 ) ) ) {
V_173 = V_201 ;
V_201 = NULL ;
}
}
if ( V_162 && ! V_201 )
V_201 = F_118 ( V_4 , & V_2 -> V_159 , V_8 , V_2 -> V_23 . V_62 ,
...
static struct V_1 * F_121 ( struct V_1 * V_204 ,
struct V_205 * V_64 )
{
...
if ( V_204 -> V_73 ) {
V_2 -> V_73 = F_122 ( V_204 -> V_73 ) ;
if ( ! V_2 -> V_73 )
goto error;
}
V_2 -> V_23 . V_207 = V_204 -> V_23 . V_207 ;
if ( V_204 -> V_72 ) {
V_2 -> V_72 = F_123 ( V_204 -> V_72 ) ;
if ( ! V_2 -> V_72 )
goto error;
}
if ( V_204 -> V_74 ) {
V_2 -> V_74 = F_124 ( V_204 -> V_74 ) ;
if ( ! V_2 -> V_74 )
goto error;
}
V_2 -> V_23 . V_208 = V_204 -> V_23 . V_208 ;
if ( V_204 -> V_75 ) {
V_2 -> V_75 = F_124 ( V_204 -> V_75 ) ;
if ( ! V_2 -> V_75 )
goto error;
}
V_2 -> V_23 . V_209 = V_204 -> V_23 . V_209 ;
if ( V_64 || V_204 -> V_64 ) {
if ( V_64 )
V_2 -> V_64 = F_125 ( V_64 , sizeof( * V_2 -> V_64 ) ,
V_210 ) ;
else
V_2 -> V_64 = F_125 ( V_204 -> V_64 , sizeof( * V_2 -> V_64 ) ,
V_210 ) ;
if ( ! V_2 -> V_64 )
goto error;
}
if ( V_204 -> V_76 ) {
V_2 -> V_76 = F_125 ( V_204 -> V_76 , sizeof( * V_2 -> V_76 ) ,
V_210 ) ;
if ( ! V_2 -> V_76 )
goto error;
}
...
V_2 -> V_23 . V_211 = V_204 -> V_23 . V_211 ;
...
struct V_1 * F_128 ( struct V_215 * V_160 , struct V_4 * V_4 )
{
unsigned int V_21 ;
struct V_1 * V_2 = NULL ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
if ( V_160 -> V_7 ) {
V_21 = F_3 ( V_4 , & V_160 -> V_216 , & V_160 -> V_217 ,
V_160 -> V_7 , V_160 -> V_218 ) ;
F_81 (x, net->xfrm.state_bydst+h, bydst) {
...
continue;
if ( ! F_94 ( & V_2 -> V_22 . V_5 , & V_160 -> V_216 ,
V_160 -> V_218 ) ||
! F_94 ( & V_2 -> V_23 . V_6 , & V_160 -> V_217 ,
V_160 -> V_218 ) )
continue;
F_87 ( V_2 ) ;
break;
...
V_21 = F_5 ( V_4 , & V_160 -> V_216 , & V_160 -> V_217 ,
V_160 -> V_218 ) ;
...
struct V_1 * F_129 ( struct V_1 * V_2 ,
struct V_215 * V_160 ,
struct V_205 * V_64 )
{
struct V_1 * V_219 ;
V_219 = F_121 ( V_2 , V_64 ) ;
if ( ! V_219 )
return NULL ;
memcpy ( & V_219 -> V_22 . V_5 , & V_160 -> V_220 , sizeof( V_219 -> V_22 . V_5 ) ) ;
memcpy ( & V_219 -> V_23 . V_6 , & V_160 -> V_221 , sizeof( V_219 -> V_23 . V_6 ) ) ;
if ( F_94 ( & V_2 -> V_22 . V_5 , & V_160 -> V_220 , V_160 -> V_222 ) ) {
F_117 ( V_219 ) ;
} else {
if ( F_119 ( V_219 ) < 0 )
goto error;
...
V_173 = NULL ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_201 = F_96 ( V_2 , V_162 , V_2 -> V_23 . V_8 ) ;
V_49 = - V_136 ;
if ( ! V_201 )
goto V_69;
if ( F_86 ( V_201 ) ) {
...
if ( V_2 -> V_106 . V_223 >= V_2 -> V_103 . V_130 ||
V_2 -> V_106 . V_224 >= V_2 -> V_103 . V_131 ) {
V_2 -> V_98 . V_99 = V_101 ;
F_56 ( & V_2 -> V_70 , 0 , V_117 ) ;
return - V_66 ;
}
if ( ! V_2 -> V_98 . V_113 &&
( V_2 -> V_106 . V_223 >= V_2 -> V_103 . V_127 ||
V_2 -> V_106 . V_224 >= V_2 -> V_103 . V_129 ) ) {
V_2 -> V_98 . V_113 = 1 ;
F_55 ( V_2 , 0 , 0 ) ;
}
return 0 ;
...
struct V_1 *
F_133 ( struct V_4 * V_4 , T_3 V_159 , const T_2 * V_5 , T_4 V_11 ,
T_5 V_12 , unsigned short V_8 )
{
struct V_1 * V_2 ;
F_104 () ;
V_2 = F_92 ( V_4 , V_159 , V_5 , V_11 , V_12 , V_8 ) ;
F_28 () ;
return V_2 ;
}
struct V_1 *
F_134 ( struct V_4 * V_4 , T_3 V_159 ,
const T_2 * V_5 , const T_2 * V_6 ,
T_5 V_12 , unsigned short V_8 )
{
struct V_1 * V_2 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_2 = F_95 ( V_4 , V_159 , V_5 , V_6 , V_12 , V_8 ) ;
F_22 ( & V_4 -> V_9 . V_40 ) ;
return V_2 ;
}
struct V_1 *
F_135 ( struct V_4 * V_4 , const struct V_193 * V_159 , T_5 V_62 , T_3 V_7 ,
T_5 V_12 , const T_2 * V_5 ,
const T_2 * V_6 , int V_194 , unsigned short V_8 )
{
struct V_1 * V_2 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_2 = F_118 ( V_4 , V_159 , V_8 , V_62 , V_7 , V_12 , V_5 , V_6 , V_194 ) ;
F_22 ( & V_4 -> V_9 . V_40 ) ;
return V_2 ;
}
int
F_136 ( struct V_153 * * V_225 , struct V_153 * * V_226 , int V_227 ,
...
F_17 ( & V_4 -> V_9 . V_40 ) ;
if ( V_47 -> V_228 )
V_49 = V_47 -> V_228 ( V_225 , V_226 , V_227 ) ;
else
for ( V_39 = 0 ; V_39 < V_227 ; V_39 ++ )
V_225 [ V_39 ] = V_226 [ V_39 ] ;
F_22 ( & V_4 -> V_9 . V_40 ) ;
F_28 () ;
return V_49 ;
}
int
F_137 ( struct V_1 * * V_225 , struct V_1 * * V_226 , int V_227 ,
unsigned short V_8 )
{
int V_39 ;
int V_49 = 0 ;
struct V_46 * V_47 = F_25 ( V_8 ) ;
struct V_4 * V_4 = V_121 ( * V_226 ) ;
if ( ! V_47 )
return - V_50 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
if ( V_47 -> V_229 )
V_49 = V_47 -> V_229 ( V_225 , V_226 , V_227 ) ;
else
for ( V_39 = 0 ; V_39 < V_227 ; V_39 ++ )
V_225 [ V_39 ] = V_226 [ V_39 ] ;
F_22 ( & V_4 -> V_9 . V_40 ) ;
...
static struct V_1 * F_120 ( struct V_4 * V_4 , T_3 V_159 , T_3 V_203 )
{
int V_39 ;
for ( V_39 = 0 ; V_39 <= V_4 -> V_9 . V_10 ; V_39 ++ ) {
struct V_1 * V_2 ;
...
struct V_1 * F_138 ( struct V_4 * V_4 , T_3 V_159 , T_3 V_203 )
{
struct V_1 * V_2 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
V_2 = F_120 ( V_4 , V_159 , V_203 ) ;
F_22 ( & V_4 -> V_9 . V_40 ) ;
return V_2 ;
}
T_3 F_139 ( void )
...
int F_141 ( T_5 V_12 , T_3 V_232 , T_3 V_233 )
{
switch ( V_12 ) {
case V_234 :
case V_235 :
...
int F_142 ( struct V_1 * V_2 , T_3 V_237 , T_3 V_238 )
{
struct V_4 * V_4 = V_121 ( V_2 ) ;
unsigned int V_21 ;
struct V_1 * V_172 ;
int V_49 = - V_54 ;
T_4 V_239 = F_143 ( V_237 ) ;
T_4 V_240 = F_143 ( V_238 ) ;
T_3 V_159 = V_2 -> V_159 . V_161 & V_2 -> V_159 . V_160 ;
F_17 ( & V_2 -> V_97 ) ;
if ( V_2 -> V_98 . V_99 == V_100 )
goto V_241;
...
V_49 = - V_54 ;
if ( V_239 == V_240 ) {
V_172 = F_133 ( V_4 , V_159 , & V_2 -> V_22 . V_5 , V_239 , V_2 -> V_22 . V_12 , V_2 -> V_23 . V_8 ) ;
if ( V_172 ) {
F_78 ( V_172 ) ;
goto V_241;
}
...
T_3 V_11 = 0 ;
for ( V_21 = 0 ; V_21 < V_238 - V_237 + 1 ; V_21 ++ ) {
V_11 = V_237 + F_144 () % ( V_238 - V_237 + 1 ) ;
V_172 = F_133 ( V_4 , V_159 , & V_2 -> V_22 . V_5 , F_143 ( V_11 ) , V_2 -> V_22 . V_12 , V_2 -> V_23 . V_8 ) ;
if ( V_172 == NULL ) {
V_2 -> V_22 . V_11 = F_143 ( V_11 ) ;
break;
}
F_78 ( V_172 ) ;
}
...
if ( ( V_243 -> V_8 == V_195 ||
V_243 -> V_8 == V_199 ) &&
V_2 -> V_23 . V_8 != V_243 -> V_8 )
return false ;
return F_146 ( & V_2 -> V_23 . V_6 , & V_243 -> V_6 ,
V_243 -> V_244 ) &&
F_146 ( & V_2 -> V_22 . V_5 , & V_243 -> V_5 ,
V_243 -> V_245 ) ;
}
return true ;
}
int V_188 ( struct V_4 * V_4 , struct V_188 * V_246 ,
int (* F_147)( struct V_1 * , int , void * ) ,
void * V_247 )
{
struct V_1 * V_99 ;
struct V_188 * V_2 ;
int V_49 = 0 ;
if ( V_246 -> V_203 != 0 && F_148 ( & V_246 -> V_123 ) )
return 0 ;
F_17 ( & V_4 -> V_9 . V_40 ) ;
if ( F_148 ( & V_246 -> V_123 ) )
V_2 = F_149 ( & V_4 -> V_9 . V_184 , struct V_188 , V_123 ) ;
else
V_2 = F_149 ( & V_246 -> V_123 , struct V_188 , V_123 ) ;
F_150 (x, &net->xfrm.state_all, all) {
if ( V_2 -> V_99 == V_100 )
continue;
V_99 = F_14 ( V_2 , struct V_1 , V_98 ) ;
if ( ! F_82 ( V_99 -> V_22 . V_12 , V_246 -> V_12 ) )
continue;
if ( ! F_145 ( V_99 , V_246 -> V_243 ) )
continue;
V_49 = F_147 ( V_99 , V_246 -> V_203 , V_247 ) ;
if ( V_49 ) {
F_151 ( & V_246 -> V_123 , & V_2 -> V_123 ) ;
goto V_69;
}
V_246 -> V_203 ++ ;
}
...
void F_153 ( struct V_188 * V_246 , T_5 V_12 ,
struct V_242 * V_243 )
{
F_66 ( & V_246 -> V_123 ) ;
V_246 -> V_12 = V_12 ;
...
void F_154 ( struct V_188 * V_246 , struct V_4 * V_4 )
{
F_47 ( V_246 -> V_243 ) ;
if ( F_148 ( & V_246 -> V_123 ) )
return;
...
static void V_126 ( unsigned long V_247 )
{
struct V_1 * V_2 = (struct V_1 * ) V_247 ;
F_54 ( & V_2 -> V_97 ) ;
if ( V_2 -> V_98 . V_99 == V_168 ) {
if ( F_155 ( V_121 ( V_2 ) ) )
V_2 -> V_248 -> V_249 ( V_2 , V_250 ) ;
else
V_2 -> V_108 |= V_251 ;
}
F_60 ( & V_2 -> V_97 ) ;
}
void F_156 ( struct V_164 * V_252 , int V_253 , const struct V_176 * V_177 )
{
struct V_254 * V_98 ;
F_104 () ;
F_157 (km, &xfrm_km_list, list)
if ( V_98 -> V_255 )
V_98 -> V_255 ( V_252 , V_253 , V_177 ) ;
F_28 () ;
}
void F_158 ( struct V_1 * V_2 , const struct V_176 * V_177 )
{
struct V_254 * V_98 ;
F_104 () ;
F_157 (km, &xfrm_km_list, list)
if ( V_98 -> V_249 )
V_98 -> V_249 ( V_2 , V_177 ) ;
F_28 () ;
}
void F_55 ( struct V_1 * V_2 , int V_256 , T_3 V_257 )
{
struct V_176 V_177 ;
V_177 . V_247 . V_256 = V_256 ;
V_177 . V_257 = V_257 ;
V_177 . V_258 = V_259 ;
F_158 ( V_2 , & V_177 ) ;
}
int F_108 ( struct V_1 * V_2 , struct V_153 * V_260 , struct V_164 * V_165 )
{
int V_49 = - V_66 , V_261 ;
struct V_254 * V_98 ;
F_104 () ;
F_157 (km, &xfrm_km_list, list) {
V_261 = V_98 -> V_262 ( V_2 , V_260 , V_165 ) ;
if ( ! V_261 )
V_49 = V_261 ;
}
F_28 () ;
...
int F_159 ( struct V_1 * V_2 , T_2 * V_263 , T_7 V_264 )
{
int V_49 = - V_66 ;
struct V_254 * V_98 ;
F_104 () ;
F_157 (km, &xfrm_km_list, list) {
if ( V_98 -> V_265 )
V_49 = V_98 -> V_265 ( V_2 , V_263 , V_264 ) ;
if ( ! V_49 )
break;
}
F_28 () ;
...
void F_160 ( struct V_164 * V_165 , int V_253 , int V_256 , T_3 V_257 )
{
struct V_176 V_177 ;
V_177 . V_247 . V_256 = V_256 ;
V_177 . V_257 = V_257 ;
V_177 . V_258 = V_266 ;
F_156 ( V_165 , V_253 , & V_177 ) ;
}
int F_161 ( const struct V_267 * V_156 , T_5 V_253 , T_5 type ,
const struct V_215 * V_160 , int V_268 ,
const struct V_269 * V_270 ,
const struct V_205 * V_64 )
{
int V_49 = - V_66 ;
int V_271 ;
struct V_254 * V_98 ;
...
F_157 (km, &xfrm_km_list, list) {
if ( V_98 -> V_272 ) {
V_271 = V_98 -> V_272 ( V_156 , V_253 , type , V_160 , V_268 , V_270 ,
V_64 ) ;
if ( ! V_271 )
V_49 = V_271 ;
}
...
int F_162 ( struct V_4 * V_4 , T_5 V_12 , struct V_267 * V_156 , T_2 * V_273 )
{
int V_49 = - V_66 ;
int V_271 ;
struct V_254 * V_98 ;
...
F_157 (km, &xfrm_km_list, list) {
if ( V_98 -> V_274 ) {
V_271 = V_98 -> V_274 ( V_4 , V_12 , V_156 , V_273 ) ;
if ( ! V_271 )
V_49 = V_271 ;
}
}
...
bool F_106 ( const struct V_176 * V_177 )
{
struct V_254 * V_98 ;
bool V_275 = false ;
F_104 () ;
F_157 (km, &xfrm_km_list, list) {
if ( V_98 -> V_275 && V_98 -> V_275 ( V_177 ) ) {
V_275 = true ;
break;
}
}
...
int F_163 ( struct V_276 * V_277 , int V_278 , T_5 T_8 * V_279 , int V_280 )
{
int V_49 ;
T_5 * V_247 ;
struct V_254 * V_98 ;
struct V_164 * V_165 = NULL ;
if ( V_280 <= 0 || V_280 > V_281 )
return - V_282 ;
V_247 = F_164 ( V_279 , V_280 ) ;
if ( F_165 ( V_247 ) )
return F_166 ( V_247 ) ;
V_49 = - V_66 ;
F_104 () ;
F_157 (km, &xfrm_km_list, list) {
V_165 = V_98 -> V_283 ( V_277 , V_278 , V_247 ,
V_280 , & V_49 ) ;
if ( V_49 >= 0 )
break;
}
...
int F_169 ( struct V_254 * V_98 )
{
F_17 ( & V_284 ) ;
F_170 ( & V_98 -> V_14 , & V_285 ) ;
F_22 ( & V_284 ) ;
return 0 ;
}
int F_171 ( struct V_254 * V_98 )
{
F_17 ( & V_284 ) ;
F_172 ( & V_98 -> V_14 ) ;
F_22 ( & V_284 ) ;
...
int F_173 ( struct V_46 * V_47 )
{
int V_49 = 0 ;
if ( F_72 ( V_47 -> V_8 >= V_286 ) )
return - V_50 ;
F_17 ( & V_287 ) ;
...
if ( F_175 ( V_46 [ V_8 ] ) != V_47 )
V_49 = - V_66 ;
else
F_176 ( V_46 [ V_47 -> V_8 ] , NULL ) ;
}
F_22 ( & V_287 ) ;
F_23 () ;
return V_49 ;
}
struct V_46 * F_91 ( unsigned int V_8 )
{
if ( F_26 ( V_8 >= V_286 ) )
return NULL ;
return F_177 ( V_46 [ V_8 ] ) ;
}
...
{
if ( V_2 -> V_288 ) {
struct V_1 * V_260 = V_2 -> V_288 ;
if ( F_179 ( & V_260 -> V_122 ) == 2 )
F_79 ( V_260 ) ;
F_180 ( & V_260 -> V_122 ) ;
F_78 ( V_260 ) ;
V_2 -> V_288 = NULL ;
...
int F_181 ( struct V_1 * V_2 , int V_289 )
{
...
int F_182 ( struct V_1 * V_2 , bool V_292 )
{
struct V_46 * V_47 ;
struct V_61 * V_79 ;
...
void F_186 ( struct V_4 * V_4 )
{
unsigned int V_299 ;
F_187 ( & V_4 -> V_9 . V_29 ) ;
F_85 ( V_4 , V_202 , false ) ;
F_187 ( & V_135 ) ;
F_72 ( ! F_148 ( & V_4 -> V_9 . V_184 ) ) ;
V_299 = ( V_4 -> V_9 . V_10 + 1 ) * sizeof( struct V_13 ) ;
F_72 ( ! F_188 ( V_4 -> V_9 . V_44 ) ) ;
F_16 ( V_4 -> V_9 . V_44 , V_299 ) ;
F_72 ( ! F_188 ( V_4 -> V_9 . V_43 ) ) ;
F_16 ( V_4 -> V_9 . V_43 , V_299 ) ;
F_72 ( ! F_188 ( V_4 -> V_9 . V_42 ) ) ;
F_16 ( V_4 -> V_9 . V_42 , V_299 ) ;
}
...
F_191 ( V_304 , L_6 , V_11 , V_11 ) ;
}
static void F_192 ( struct V_311 * V_312 , T_10 V_8 ,
struct V_303 * V_304 )
{
...
void F_195 ( struct V_1 * V_2 , int V_318 , bool V_138 )
{
struct V_303 * V_304 ;
V_304 = F_196 ( L_8 ) ;
if ( V_304 == NULL )
...
if ( V_304 == NULL )
return;
F_192 ( V_312 , V_2 -> V_23 . V_8 , V_304 ) ;
V_11 = F_190 ( V_2 -> V_22 . V_11 ) ;
F_191 ( V_304 , L_6 , V_11 , V_11 ) ;
F_198 ( V_304 ) ;
}
...
V_11 = F_190 ( V_2 -> V_22 . V_11 ) ;
F_191 ( V_304 , L_13 ,
V_11 , V_11 , F_190 ( V_319 ) ) ;
F_198 ( V_304 ) ;
}
void F_201 ( struct V_311 * V_312 , T_10 V_8 )
{
struct V_303 * V_304 ;
V_304 = F_196 ( L_14 ) ;
if ( V_304 == NULL )
return;
F_192 ( V_312 , V_8 , V_304 ) ;
F_198 ( V_304 ) ;
}
void F_202 ( struct V_311 * V_312 , T_10 V_8 ,
T_4 V_320 , T_4 V_319 )
{
struct V_303 * V_304 ;
T_3 V_11 ;
...
return;
F_192 ( V_312 , V_2 -> V_23 . V_8 , V_304 ) ;
if ( F_204 ( V_312 , V_12 , & V_320 , & V_319 ) == 0 ) {
T_3 V_11 = F_190 ( V_320 ) ;
F_191 ( V_304 , L_13 ,
V_11 , V_11 , F_190 ( V_319 ) ) ;
}
F_198 ( V_304 ) ;
