...
static int F_76 ( struct V_1 * V_2 , T_6 * V_424 )
{
F_17 ( 1 , L_3 ) ;
* V_424 = 0 ;
switch ( V_2 -> V_3 ) {
case V_4 :
return F_75 ( V_2 , V_424 ) ;
case V_5 :
case V_7 :
...
static int F_77 ( struct V_1 * V_2 , bool V_458 )
{
int V_28 = - V_191 ;
F_17 ( 1 , L_3 ) ;
if ( V_2 -> V_148 == V_149 )
...
static int F_79 ( struct V_1 * V_2 , T_1 V_468 ,
T_4 V_245 , T_4 V_246 , T_1 V_247 )
{
T_4 V_248 = 0 ;
...
static int F_80 ( struct V_1 * V_2 , T_4 * V_475 )
{
T_4 V_27 = 0 ;
int V_28 ;
F_17 ( 1 , L_3 ) ;
...
static int F_83 ( struct V_1 * V_2 , bool V_404 )
{
T_4 V_501 = 0 ;
T_4 V_502 = 0 ;
T_4 V_141 = 0 ;
...
static int F_84 ( struct V_1 * V_2 , T_4 * V_558 )
{
int V_28 ;
F_17 ( 1 , L_3 ) ;
if ( V_558 == NULL )
...
static int F_88 ( struct V_1 * V_2 , bool * V_581 )
{
int V_28 ;
F_17 ( 1 , L_3 ) ;
if ( * V_581 ) {
...
if ( V_28 < 0 )
goto error;
V_28 = F_78 ( V_2 , & V_2 -> V_142 ) ;
if ( V_28 < 0 )
goto error;
V_28 = F_27 ( V_2 , V_320 , V_628 ) ;
if ( V_28 < 0 )
goto error;
V_28 = F_72 ( V_2 , & V_2 -> V_138 , true ) ;
if ( V_28 < 0 )
goto error;
V_28 = F_73 ( V_2 , & V_2 -> V_139 , true ) ;
if ( V_28 < 0 )
goto error;
...
if ( V_28 < 0 )
goto error;
V_28 = F_78 ( V_2 , & ( V_2 -> V_146 ) ) ;
if ( V_28 < 0 )
goto error;
V_28 = F_72 ( V_2 , & ( V_2 -> V_143 ) , true ) ;
if ( V_28 < 0 )
goto error;
V_28 = F_73 ( V_2 , & ( V_2 -> V_144 ) , true ) ;
if ( V_28 < 0 )
goto error;
V_28 = F_27 ( V_2 , V_320 , V_321 ) ;
error:
...
F_112 ( V_2 -> V_892 . V_893 . V_897 . V_898 , L_50 ,
sizeof( V_2 -> V_892 . V_893 . V_897 . V_898 ) ) ;
}
if ( V_2 -> V_103 ) {
V_2 -> V_892 . V_893 . V_894 [ V_866 ++ ] = V_899 ;
F_112 ( V_2 -> V_892 . V_893 . V_897 . V_898 , L_51 ,
sizeof( V_2 -> V_892 . V_893 . V_897 . V_898 ) ) ;
}
F_10 ( V_2 ) ;
}
...
static void F_113 ( const struct V_901 * V_883 ,
void * V_902 )
{
struct V_1 * V_2 = V_902 ;
F_17 ( 1 , L_52 , V_883 ? L_53 : L_54 ) ;
if ( ! V_883 ) {
F_19 ( L_55 ,
V_2 -> V_815 ) ;
F_36 ( L_56 ,
...
static void F_114 ( struct V_903 * V_904 )
{
...
static int F_117 ( struct V_903 * V_904 )
{
struct V_1 * V_2 = V_904 -> V_905 ;
F_17 ( 1 , L_3 ) ;
if ( V_2 -> V_148 == V_900 )
...
static int F_118 ( struct V_903 * V_904 , int V_263 )
{
struct V_1 * V_2 = V_904 -> V_905 ;
F_17 ( 1 , L_52 , V_263 ? L_24 : L_25 ) ;
if ( V_2 -> V_148 == V_900 )
return - V_906 ;
return F_77 ( V_2 , V_263 ? true : false ) ;
}
static int F_119 ( struct V_903 * V_904 )
{
...
static int F_120 ( struct V_1 * V_2 , T_2 * V_917 )
{
int V_28 ;
...
static int F_121 ( struct V_903 * V_904 )
{
...
if ( V_918 == V_720 )
V_2 -> V_944 |= 0x07 ;
F_120 ( V_2 , & V_10 -> V_917 . V_918 [ 0 ] . V_945 ) ;
...
static int F_122 ( struct V_903 * V_904 , enum V_944 * V_28 )
{
struct V_1 * V_2 = V_904 -> V_905 ;
int V_952 ;
F_17 ( 1 , L_3 ) ;
...
static int F_123 ( struct V_903 * V_904 ,
T_4 * V_917 )
{
struct V_1 * V_2 = V_904 -> V_905 ;
struct V_907 * V_10 = & V_904 -> V_908 ;
...
static int F_124 ( struct V_903 * V_904 , T_4 * V_953 )
{
struct V_1 * V_2 = V_904 -> V_905 ;
T_6 V_954 ;
F_17 ( 1 , L_3 ) ;
...
static int F_125 ( struct V_903 * V_904 , T_1 * V_955 )
{
struct V_1 * V_2 = V_904 -> V_905 ;
T_4 V_294 ;
F_17 ( 1 , L_3 ) ;
...
static int F_126 ( struct V_903 * V_904 ,
struct V_956 * V_957 )
{
struct V_1 * V_2 = V_904 -> V_905 ;
struct V_907 * V_289 = & V_904 -> V_908 ;
...
struct V_903 * F_127 ( const struct V_961 * V_962 ,
struct V_963 * V_16 )
{
struct V_907 * V_289 ;
struct V_1 * V_2 = NULL ;
...
int V_28 ;
F_17 ( 1 , L_3 ) ;
V_2 = F_128 ( sizeof( struct V_1 ) , V_964 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_16 = V_16 ;
V_2 -> V_35 = V_21 ;
