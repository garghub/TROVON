...
void T_3 F_5 ( unsigned long V_7 ,
unsigned int V_8 )
{
struct V_9 T_4 * V_5 ;
F_6 ( & V_3 . V_2 , F_7 ( V_8 ) ) ;
...
static void F_11 ( struct V_9 T_4 * V_5 )
{
F_9 ( V_10 , & V_5 -> V_11 ) ;
F_9 ( 0 , & V_5 -> V_12 ) ;
}
...
struct V_9 T_4 * V_5 = V_23 -> V_5 ;
F_11 ( V_5 ) ;
F_9 ( V_25 | V_15 , & V_5 -> V_16 ) ;
F_9 ( ( ( T_1 ) ( V_26 / V_27 ) * V_21 -> V_28 ) >> V_21 -> V_29 ,
& V_5 -> V_18 ) ;
F_9 ( V_10 | V_19 , & V_5 -> V_11 ) ;
return 0 ;
}
...
static T_5 F_17 ( int V_31 , void * V_32 )
{
...
void T_3 F_18 ( unsigned long V_7 , int V_31 ,
unsigned int V_8 )
{
...
V_24 -> V_37 = 0xffffffff >> ( 32 - V_36 ) ;
V_24 -> V_38 = F_20 ( 0xf , V_24 ) ;
V_24 -> V_39 = 0xf ;
V_24 -> V_31 = V_31 ;
V_24 -> V_40 = F_21 ( 0 ) ,
F_22 ( V_24 ) ;
...
void T_3 F_25 ( unsigned long V_7 )
{
struct V_9 T_4 * V_5 ;
V_5 = F_8 ( V_7 , sizeof( struct V_9 ) ) ;
F_9 ( V_43 | V_19 , & V_5 -> V_11 ) ;
F_9 ( V_43 , & V_5 -> V_11 ) ;
F_9 ( 0 , & V_5 -> V_12 ) ;
