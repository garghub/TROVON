...
static struct V_1 * F_55 ( struct V_3 * V_4 ,
const struct V_135 * V_87 ,
const struct V_64 * V_65 ,
int V_136 ,
const char * V_137 )
{
struct V_1 * V_2 ;
V_2 = F_56 ( & V_4 -> V_19 -> V_21 , sizeof( V_4 ) ) ;
if ( ! V_2 )
return F_57 ( - V_138 ) ;
F_1 ( V_2 , V_4 ) ;
V_2 -> V_21 . V_139 = & V_4 -> V_19 -> V_21 ;
V_2 -> V_140 = V_65 ;
V_2 -> V_136 = V_136 ;
V_2 -> V_137 = V_137 ;
V_2 -> V_141 = V_142 ;
...
static struct V_95 * F_58 ( struct V_3 * V_4 ,
struct V_1 * V_2 ,
const char * V_143 )
{
struct V_95 * V_96 ;
int V_16 ;
V_96 = F_59 ( & V_4 -> V_19 -> V_21 ,
L_19 ,
V_2 -> V_137 ,
V_143 ,
V_2 -> V_132 ) ;
...
static int F_62 ( struct V_146 * V_19 ,
const struct V_147 * V_132 )
{
int V_16 ;
struct V_3 * V_4 ;
const char * V_137 = NULL ;
V_4 = F_63 ( & V_19 -> V_21 , sizeof( * V_4 ) , V_148 ) ;
if ( ! V_4 )
return - V_138 ;
F_64 ( V_19 , V_4 ) ;
V_4 -> V_19 = V_19 ;
...
if ( V_132 )
V_137 = V_132 -> V_137 ;
else if ( F_66 ( & V_19 -> V_21 ) )
V_137 = F_52 ( & V_19 -> V_21 ) ;
else
return - V_149 ;
V_4 -> V_105 =
F_55 ( V_4 , & V_150 ,
...
V_137 ) ;
if ( F_67 ( V_4 -> V_152 ) )
return F_68 ( V_4 -> V_152 ) ;
V_16 = F_17 ( V_4 ) ;
if ( V_16 < 0 )
return V_16 ;
if ( V_19 -> V_103 > 0 ) {
V_16 = F_69 ( & V_19 -> V_21 , V_19 -> V_103 ,
F_46 ,
F_43 ,
V_155 ,
V_156 ,
...
static int F_79 ( struct V_146 * V_19 )
{
struct V_3 * V_4 = F_80 ( V_19 ) ;
F_76 ( V_4 -> V_105 ) ;
F_76 ( V_4 -> V_152 ) ;
F_81 ( & V_19 -> V_21 ) ;
F_82 ( & V_19 -> V_21 ) ;
...
static int F_83 ( struct V_14 * V_21 )
{
int V_16 ;
struct V_3 * V_4 = F_80 ( F_84 ( V_21 ) ) ;
F_30 ( & V_4 -> V_73 ) ;
V_16 = F_7 ( V_4 , V_29 , V_22 | V_24 ,
false ) ;
F_31 ( & V_4 -> V_73 ) ;
...
static int F_85 ( struct V_14 * V_21 )
{
T_1 V_166 = 0 ;
struct V_3 * V_4 = F_80 ( F_84 ( V_21 ) ) ;
if ( V_4 -> V_17 )
...
if ( V_4 -> V_18 )
V_166 |= V_25 ;
return F_7 ( V_4 , V_166 , V_22 | V_24 , true ) ;
}
static int F_86 ( struct V_14 * V_21 )
{
struct V_3 * V_4 = F_80 ( F_84 ( V_21 ) ) ;
int V_16 ;
F_30 ( & V_4 -> V_73 ) ;
...
static int F_87 ( struct V_14 * V_21 )
{
struct V_3 * V_4 = F_80 ( F_84 ( V_21 ) ) ;
T_1 V_166 = 0 ;
if ( ! V_4 -> V_59 )
