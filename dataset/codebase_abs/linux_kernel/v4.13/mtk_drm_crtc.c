...
{
struct V_1 * V_8 = F_1 ( V_9 ) ;
struct V_70 * V_71 = V_9 -> V_11 -> V_72 ;
unsigned int V_62 = 0 ;
int V_15 ;
if ( V_8 -> V_13 )
V_8 -> V_14 = true ;
...
struct V_1 * V_8 ,
struct V_55 * V_77 ,
struct V_55 * V_78 , unsigned int V_69 )
{
int V_34 ;
V_34 = F_74 ( V_61 , & V_8 -> V_4 , V_77 , V_78 ,
& V_79 , NULL ) ;
if ( V_34 )
goto V_80;
F_75 ( & V_8 -> V_4 , & V_81 ) ;
...
int F_77 ( struct V_60 * V_82 ,
const enum V_83 * V_84 , unsigned int V_85 )
{
struct V_70 * V_71 = V_82 -> V_72 ;
struct V_86 * V_11 = V_82 -> V_11 ;
struct V_1 * V_8 ;
enum V_87 type ;
unsigned int V_88 ;
int V_69 = V_71 -> V_89 ;
...
for ( V_88 = 0 ; V_88 < V_54 ; V_88 ++ ) {
type = ( V_88 == 0 ) ? V_99 :
( V_88 == 1 ) ? V_100 :
V_101 ;
V_34 = F_86 ( V_82 , & V_8 -> V_57 [ V_88 ] ,
F_69 ( V_69 ) , type ) ;
if ( V_34 )
goto V_98;
}
V_34 = F_73 ( V_82 , V_8 , & V_8 -> V_57 [ 0 ] ,
& V_8 -> V_57 [ 1 ] , V_69 ) ;
if ( V_34 < 0 )
goto V_98;
F_87 ( & V_8 -> V_4 , V_102 ) ;
