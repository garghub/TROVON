...
F_30 ( V_20 ) ;
V_20 -> V_39 = F_31 ( V_40 ) ;
if ( F_32 ( V_16 -> V_18 -> V_41 & V_42 ) )
goto V_43;
if ( F_33 ( V_16 -> V_23 ) )
goto V_43;
if ( F_32 ( ! F_34 ( V_16 -> V_18 ) ) ) {
V_38 = F_35 ( V_20 -> V_15 , 0 ) ;
V_36 = F_36 ( F_37 ( V_38 -> V_44 ) ) ;
if ( F_32 ( V_36 == 0 ) )
goto V_43;
V_35 = ( V_16 -> V_18 -> V_45 * V_46 ) / 100 ;
if ( F_32 ( V_36 < V_35 ) )
goto V_43;
}
F_24 ( & V_16 -> V_22 ) ;
...
static void F_46 ( struct V_14 * V_15 , int V_56 )
{
struct V_9 * V_16 ;
F_22 () ;
V_16 = F_16 ( V_15 ) ;
...
void F_47 ( struct V_14 * V_15 , struct V_57 * V_58 ,
struct V_31 * V_59 , int V_60 ,
struct V_31 * * V_26 ,
int (* * F_48)( struct V_19 * , struct V_14 * ,
struct V_50 * ,
struct V_14 * ) )
{
struct V_9 * V_16 ;
...
F_50 ( & V_8 -> V_68 ) ;
F_51 ( & V_16 -> V_69 , & V_8 -> V_69 ) ;
strncpy ( V_16 -> V_26 . V_70 , V_15 -> V_70 ,
sizeof( V_16 -> V_26 . V_70 ) - 1 ) ;
V_16 -> V_26 . V_70 [ sizeof( V_16 -> V_26 . V_70 ) - 1 ] = 0 ;
V_16 -> V_26 . F_26 = F_26 ;
F_52 ( V_6 ,
V_15 ,
& V_16 -> V_26 ,
...
static int F_54 ( struct V_72 * V_73 , unsigned long V_74 ,
void * V_75 )
{
struct V_14 * V_15 = F_55 ( V_75 ) ;
struct V_9 * V_16 = NULL ;
struct V_57 * V_58 ;
struct V_1 * V_6 ;
struct V_31 * V_26 , * V_59 ;
int V_60 = 0 ;
struct V_7 * V_8 ;
V_6 = F_1 ( F_17 ( V_15 ) ) ;
V_8 = F_3 ( F_17 ( V_15 ) ) ;
V_16 = F_16 ( V_15 ) ;
if ( V_16 == NULL && V_15 -> type != V_76 )
return 0 ;
switch ( V_74 ) {
case V_77 :
if ( V_16 != NULL )
...
{
struct V_9 * V_16 , * V_88 ;
struct V_7 * V_8 =
F_3 ( V_2 ) ;
struct V_1 * V_6 = F_1 ( V_2 ) ;
F_71 () ;
F_50 ( & V_8 -> V_68 ) ;
F_72 (caifd, tmp, &caifdevs->list, list) {
int V_12 = 0 ;
F_60 ( & V_16 -> V_69 ) ;
F_59 ( V_6 , & V_16 -> V_26 , false ) ;
while ( V_12 < 10 &&
