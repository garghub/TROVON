...
if ( V_28 )
return - V_108 ;
V_4 -> V_227 = F_91 ( V_225 . V_228 ) ;
V_4 -> V_229 = F_91 ( V_225 . V_230 ) ;
snprintf ( V_14 -> V_15 -> V_231 , sizeof( V_14 -> V_15 -> V_231 ) , L_17 ,
V_4 -> V_227 ,
V_4 -> V_229 ) ;
F_27 ( V_4 -> V_10 , L_18 ,
V_4 -> V_227 ,
...
if ( error != 0 )
goto V_237;
error = F_93 ( & V_2 -> V_238 , V_4 -> V_14 -> V_15 ,
F_28 ) ;
if ( error )
goto V_239;
V_57 = & V_2 -> V_238 ;
...
goto V_246;
if ( ! F_100 ( V_57 ) ) {
error = F_101 ( V_14 -> V_15 , V_57 -> V_247 ) ;
if ( error )
goto V_248;
}
error = F_102 ( V_4 -> V_12 ) ;
if ( error ) {
F_64 ( V_2 , L_23 ) ;
goto V_248;
}
...
V_4 -> V_47 ,
V_4 -> V_49 ) ;
F_103 ( V_4 -> V_12 , V_235 , sizeof( V_235 ) ) ;
F_104 ( V_14 -> V_15 , L_25 , V_235 ) ;
F_105 ( V_4 ) ;
F_106 ( V_4 ) ;
return 0 ;
V_248:
...
int F_107 ( struct V_250 * V_251 , struct V_252 * V_10 ,
T_1 V_26 , char * V_123 , T_2 V_27 )
{
struct V_13 * V_14 ;
struct V_3 * V_4 ;
int V_28 ;
V_14 = F_108 ( sizeof( struct V_3 ) , & V_253 ) ;
if ( ! V_14 )
return - V_125 ;
V_4 = V_14 -> V_4 ;
V_4 -> V_14 = V_14 ;
...
void F_113 ( struct V_250 * V_251 , bool V_256 )
{
if ( V_251 -> V_254 ) {
if ( V_256 )
V_251 -> V_254 -> V_12 -> V_128 |= V_257 ;
F_13 ( V_251 -> V_254 ) ;
F_111 ( V_251 -> V_254 ) ;
F_112 ( V_251 -> V_254 -> V_14 ) ;
}
}
void F_114 ( struct V_250 * V_251 )
{
F_115 ( V_251 -> V_254 , V_258 ) ;
}
int F_116 ( struct V_250 * V_251 )
{
struct V_3 * V_4 = V_251 -> V_254 ;
int V_28 ;
V_28 = F_5 ( V_4 ) ;
if ( V_28 )
return V_28 ;
