...
{
T_5 V_153 ;
if ( ! V_102 || ! V_102 [ V_248 ] )
return 0 ;
V_153 = F_146 ( V_102 [ V_248 ] ) ;
if ( ! F_133 ( V_153 ) )
return - V_79 ;
return 0 ;
}
...
return;
if ( V_102 [ V_249 ] )
V_13 -> V_17 = F_148 ( V_102 [ V_249 ] ) ;
if ( V_102 [ V_250 ] )
V_13 -> V_14 . V_15 = F_149 ( V_102 [ V_250 ] ) ;
if ( V_102 [ V_251 ] )
V_13 -> V_14 . V_16 = F_149 ( V_102 [ V_251 ] ) ;
if ( V_102 [ V_252 ] ) {
V_13 -> V_14 . V_117 = F_146 ( V_102 [ V_252 ] ) ;
if ( V_13 -> V_14 . V_117 )
V_13 -> V_14 . V_165 = F_73 ( V_220 ) ;
}
if ( V_102 [ V_253 ] )
V_13 -> V_14 . V_139 = F_146 ( V_102 [ V_253 ] ) ;
if ( ! V_102 [ V_254 ] || F_146 ( V_102 [ V_254 ] ) )
V_13 -> V_14 . V_165 = F_73 ( V_220 ) ;
if ( V_102 [ V_255 ] )
V_13 -> V_41 = F_150 ( V_102 [ V_255 ] ) ;
if ( V_102 [ V_248 ] )
V_13 -> V_14 . V_115 = F_146 ( V_102 [ V_248 ] ) ;
if ( V_102 [ V_256 ] )
* V_184 = F_148 ( V_102 [ V_256 ] ) ;
}
...
if ( V_102 [ V_258 ] ) {
V_67 = true ;
V_257 -> type = F_152 ( V_102 [ V_258 ] ) ;
}
if ( V_102 [ V_259 ] ) {
V_67 = true ;
V_257 -> V_19 = F_152 ( V_102 [ V_259 ] ) ;
}
if ( V_102 [ V_260 ] ) {
V_67 = true ;
V_257 -> V_261 = F_150 ( V_102 [ V_260 ] ) ;
}
if ( V_102 [ V_262 ] ) {
V_67 = true ;
V_257 -> V_263 = F_150 ( V_102 [ V_262 ] ) ;
}
return V_67 ;
}
...
static int F_155 ( struct V_2 * V_268 , struct V_3 * V_4 ,
...
int V_36 ;
V_49 = F_14 ( V_4 ) ;
if ( F_151 ( V_102 , & V_257 ) ) {
V_36 = F_156 ( V_49 , & V_257 ) ;
if ( V_36 < 0 )
return V_36 ;
}
...
{
struct V_1 * V_99 = F_14 ( V_4 ) ;
struct V_22 * V_269 = & V_99 -> V_13 ;
if ( F_161 ( V_88 , V_249 , V_269 -> V_17 ) ||
F_162 ( V_88 , V_250 , V_269 -> V_14 . V_15 ) ||
F_162 ( V_88 , V_251 , V_269 -> V_14 . V_16 ) ||
F_163 ( V_88 , V_252 , V_269 -> V_14 . V_117 ) ||
F_163 ( V_88 , V_253 , V_269 -> V_14 . V_139 ) ||
F_163 ( V_88 , V_254 ,
! ! ( V_269 -> V_14 . V_165 & F_73 ( V_220 ) ) ) ||
F_163 ( V_88 , V_248 , V_269 -> V_14 . V_115 ) ||
F_164 ( V_88 , V_255 , V_269 -> V_41 ) ||
F_161 ( V_88 , V_256 , V_99 -> V_184 ) )
goto V_270;
#ifdef F_13
if ( F_165 ( V_88 , V_264 ,
& V_99 -> V_30 . V_31 ) ||
...
static void F_167 ( struct V_3 * V_4 , struct V_273 * V_84 )
{
struct V_2 * V_2 = F_18 ( V_4 ) ;
struct V_10 * V_11 = F_3 ( V_2 , V_12 ) ;
if ( V_4 != V_11 -> V_29 )
...
V_11 -> V_25 [ 1 ] = V_11 -> V_276 ;
V_11 -> V_25 [ 2 ] = V_11 -> V_277 ;
V_11 -> V_25 [ 3 ] = V_11 -> V_278 ;
