...
V_107 = F_20 ( V_92 . V_17 ) ;
V_108 = F_20 ( V_23 ) ;
memcpy ( V_108 , V_107 + V_92 . V_109 , V_92 . V_42 ) ;
F_21 ( V_108 ) ;
F_21 ( V_107 ) ;
...
static int F_75 ( struct V_64 * V_65 , struct V_6 * V_6 ,
T_3 * error )
{
struct V_1 * V_2 = V_65 -> V_86 ;
struct V_85 * V_88 = F_68 ( V_6 , sizeof( struct V_85 ) ) ;
if ( F_70 ( V_6 ) == V_111 && V_88 -> V_13 ) {
...
static void F_77 ( struct V_64 * V_65 , T_4 type ,
unsigned V_113 , char * V_114 ,
unsigned V_115 )
{
unsigned V_116 = 0 ;
struct V_1 * V_2 = V_65 -> V_86 ;
...
break;
case V_118 :
F_78 ( L_20 , V_2 -> V_76 -> V_119 , V_2 -> V_31 -> V_119 ) ;
break;
}
}
static int F_79 ( struct V_64 * V_65 ,
struct V_120 * * V_32 , T_5 * V_121 )
{
struct V_1 * V_2 = V_65 -> V_86 ;
struct V_122 * V_76 = V_2 -> V_76 ;
* V_32 = V_76 -> V_32 ;
if ( V_65 -> V_123 != F_31 ( V_76 -> V_32 -> V_52 ) >> V_43 )
return 1 ;
return 0 ;
}
...
{
struct V_1 * V_2 = V_65 -> V_86 ;
return V_124 ( V_65 , V_2 -> V_76 , 0 , V_65 -> V_123 , V_18 ) ;
}
...
V_125 = F_57 ( V_2 , V_67 [ 1 ] ) ;
else
F_82 ( L_23 , V_67 [ 0 ] ) ;
return V_125 ;
}
static void F_83 ( struct V_64 * V_65 , struct V_126 * V_127 )
{
struct V_1 * V_2 = V_65 -> V_86 ;
struct V_128 * V_129 = F_84 ( V_2 -> V_76 -> V_32 ) ;
if ( ! V_129 || ! F_85 ( V_129 ) ) {
V_2 -> V_79 = false ;
V_127 -> V_130 = 1 << V_43 ;
V_127 -> V_131 = ( V_132 >> V_43 ) ;
}
}
static int T_7 F_86 ( void )
{
int V_125 = F_87 ( & V_133 ) ;
if ( V_125 < 0 )
F_8 ( L_24 , V_125 ) ;
return V_125 ;
}
