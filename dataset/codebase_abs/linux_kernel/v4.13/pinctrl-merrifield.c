...
unsigned int V_19 , unsigned long * V_43 )
{
const unsigned int * V_22 ;
unsigned int V_10 ;
int V_68 ;
V_68 = F_9 ( V_17 , V_19 , & V_22 , & V_10 ) ;
if ( V_68 )
return V_68 ;
V_68 = F_23 ( V_17 , V_22 [ 0 ] , V_43 ) ;
if ( V_68 )
return V_68 ;
return 0 ;
}
static int F_30 ( struct V_16 * V_17 ,
unsigned int V_19 , unsigned long * V_66 ,
unsigned int V_69 )
{
const unsigned int * V_22 ;
unsigned int V_10 ;
...
V_68 = F_28 ( V_17 , V_22 [ V_6 ] , V_66 , V_69 ) ;
if ( V_68 )
return V_68 ;
}
return 0 ;
...
T_4 V_7 ;
unsigned int V_6 ;
V_3 = F_32 ( & V_71 -> V_11 , sizeof( * V_3 ) , V_74 ) ;
if ( ! V_3 )
return - V_75 ;
V_3 -> V_11 = & V_71 -> V_11 ;
F_33 ( & V_3 -> V_39 ) ;
V_73 = F_34 ( V_71 , V_76 , 0 ) ;
V_14 = F_35 ( & V_71 -> V_11 , V_73 ) ;
if ( F_36 ( V_14 ) )
return F_37 ( V_14 ) ;
V_7 = F_38 ( V_77 ) ,
V_8 = F_39 ( & V_71 -> V_11 , V_77 ,
sizeof( V_77 ) ,
V_74 ) ;
if ( ! V_8 )
return - V_75 ;
...
V_3 -> V_18 = F_38 ( V_81 ) ;
V_3 -> V_82 = V_83 ;
V_3 -> V_82 . V_21 = F_40 ( & V_71 -> V_11 ) ;
V_3 -> V_82 . V_22 = V_84 ;
V_3 -> V_82 . V_10 = F_38 ( V_84 ) ;
V_3 -> V_17 = F_41 ( & V_71 -> V_11 , & V_3 -> V_82 , V_3 ) ;
if ( F_36 ( V_3 -> V_17 ) ) {
F_42 ( & V_71 -> V_11 , L_6 ) ;
return F_37 ( V_3 -> V_17 ) ;
}
F_43 ( V_71 , V_3 ) ;
return 0 ;
}
