...
struct V_59 * V_162 ;
struct V_163 * V_164 ;
struct V_165 * V_14 , * V_15 ;
int V_5 , V_79 ;
int V_166 ;
V_162 = V_1 -> V_4 ;
for ( V_5 = 0 ; V_5 < V_167 ; V_5 ++ )
V_1 -> V_12 [ V_5 ] . V_13 = - 1 ;
for ( V_79 = 0 ; V_79 < V_162 -> V_168 ; V_79 ++ ) {
V_164 = & V_162 -> V_169 [ V_79 ] ;
if ( V_164 -> V_154 . V_170 != V_171 ||
V_164 -> V_154 . V_172 != 1 )
if ( ! ( V_1 -> V_20 & V_173 ) )
continue;
...
return - V_85 ;
V_178 = V_1 -> V_12 [ V_12 ] . V_13 ;
if ( V_178 < 0 )
return - V_85 ;
V_177 = F_97 ( V_1 -> V_3 , V_1 -> V_9 , V_178 ) ;
if ( V_177 < 0 ) {
F_8 ( V_50 L_45 ,
V_178 , V_1 -> V_9 ) ;
return V_177 ;
...
static int F_103 ( struct V_59 * V_4 , T_6 V_180 )
{
struct V_1 * V_1 = F_24 ( V_4 ) ;
F_29 ( V_1 ) ;
#if 0
