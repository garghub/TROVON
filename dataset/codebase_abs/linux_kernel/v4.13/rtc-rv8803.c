...
static int F_30 ( void * V_76 , unsigned int V_77 , void * V_78 ,
T_5 V_79 )
{
int V_6 ;
V_6 = F_6 ( V_76 , V_80 , * ( T_1 * ) V_78 ) ;
if ( V_6 )
return V_6 ;
return 0 ;
}
static int F_31 ( void * V_76 , unsigned int V_77 ,
void * V_78 , T_5 V_79 )
{
int V_6 ;
V_6 = F_1 ( V_76 , V_80 ) ;
...
if ( V_16 -> type != V_84 )
return 0 ;
V_65 = F_2 ( V_16 -> V_2 , V_85 ) ;
if ( V_65 < 0 )
return V_65 ;
V_18 = ~ ( V_86 | V_87 ) & ( T_1 ) V_65 ;
if ( F_33 ( V_82 , L_8 ) )
V_18 |= V_86 ;
if ( F_33 ( V_82 , L_9 ) )
V_18 |= V_87 ;
return F_7 ( V_16 -> V_2 , V_85 ,
V_18 ) ;
}
static int F_34 ( struct V_1 * V_2 ,
const struct V_88 * V_89 )
{
struct V_90 * V_91 = F_35 ( V_2 -> V_9 . V_92 ) ;
struct V_15 * V_16 ;
int V_65 , V_18 ;
if ( ! F_36 ( V_91 , V_93 |
V_94 ) ) {
...
V_16 = F_37 ( & V_2 -> V_9 , sizeof( struct V_15 ) ,
V_95 ) ;
if ( ! V_16 )
return - V_96 ;
F_38 ( & V_16 -> V_19 ) ;
...
if ( V_18 & V_28 )
F_14 ( & V_2 -> V_9 , L_11 ) ;
V_16 -> V_34 = F_41 ( & V_2 -> V_9 ) ;
if ( F_42 ( V_16 -> V_34 ) ) {
return F_43 ( V_16 -> V_34 ) ;
}
if ( V_2 -> V_13 > 0 ) {
V_65 = F_44 ( & V_2 -> V_9 , V_2 -> V_13 ,
NULL , F_10 ,
V_99 | V_100 ,
L_12 , V_2 ) ;
if ( V_65 ) {
...
V_16 -> V_105 . V_106 = L_14 ,
V_16 -> V_105 . V_107 = 1 ,
V_16 -> V_105 . V_108 = 1 ,
V_16 -> V_105 . V_109 = 1 ,
V_16 -> V_105 . V_110 = F_31 ,
V_16 -> V_105 . V_111 = F_30 ,
V_16 -> V_105 . V_76 = V_2 ;
V_16 -> V_34 -> V_112 = & V_101 ;
V_16 -> V_34 -> V_113 = & V_16 -> V_105 ;
V_16 -> V_34 -> V_114 = true ;
V_65 = F_45 ( V_16 -> V_34 ) ;
if ( V_65 )
return V_65 ;
V_65 = F_6 ( V_16 -> V_2 , V_115 , V_116 ) ;
if ( V_65 )
return V_65 ;
V_65 = F_32 ( V_16 ) ;
if ( V_65 ) {
