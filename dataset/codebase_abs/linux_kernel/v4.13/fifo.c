...
F_66 ( V_9 , L_11 ,
V_23 -> V_91 , F_42 ( V_7 ) , V_2 -> V_20 , V_2 -> V_14 ) ;
F_65 ( V_7 , 1 ) ;
F_85 ( V_7 , V_23 ) ;
F_60 ( V_7 , V_2 -> V_84 ) ;
F_86 ( V_25 ) ;
...
if ( F_43 ( V_7 ) )
return 0 ;
if ( ( V_13 < F_47 ( V_6 , V_93 ) ) ||
F_88 ( V_7 , V_94 ) )
goto F_67;
if ( ! F_47 ( V_6 , V_95 ) && V_13 & 0x7 )
goto F_67;
V_92 = F_47 ( V_6 , V_95 ) ?
V_96 - 1 : 0x7 ;
