...
static int F_44 ( struct V_106 * V_62 )
{
struct V_12 * V_13 = F_45 ( V_62 ) ;
V_62 -> V_107 . V_108 = sizeof( struct V_67 ) ;
V_13 -> V_62 = V_62 ;
return 0 ;
}
static void F_46 ( struct V_106 * V_62 )
{
struct V_12 * V_13 = F_45 ( V_62 ) ;
if ( ! V_13 -> V_23 )
return;
...
{
struct V_67 * V_68 = F_41 ( V_70 ) ;
struct V_71 * V_72 = V_68 -> V_104 ;
int V_59 ;
V_59 = F_28 ( V_68 , V_70 , V_72 ) ;
if ( V_59 < 0 )
return V_59 ;
F_13 ( V_72 -> V_100 ) ;
return 0 ;
...
int V_27 )
{
F_49 ( V_68 -> V_104 -> V_105 , V_70 , V_27 ) ;
F_50 ( V_68 ) ;
}
int F_51 ( void )
{
