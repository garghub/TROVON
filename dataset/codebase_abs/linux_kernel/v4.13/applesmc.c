...
char V_99 [ 5 ] ;
T_1 V_13 [ 2 ] ;
F_53 ( V_99 , sizeof( V_99 ) , V_100 [ F_54 ( V_86 ) ] ,
F_50 ( V_86 ) ) ;
...
static T_5 F_55 ( struct V_71 * V_70 ,
struct V_85 * V_86 ,
...
char V_99 [ 5 ] ;
T_1 V_13 [ 2 ] ;
if ( F_56 ( V_90 , 10 , & V_98 ) < 0 || V_98 >= 0x4000 )
return - V_24 ;
F_53 ( V_99 , sizeof( V_99 ) , V_100 [ F_54 ( V_86 ) ] ,
F_50 ( V_86 ) ) ;
V_13 [ 0 ] = ( V_98 >> 6 ) & 0xff ;
...
char V_99 [ 5 ] ;
T_1 V_13 [ 17 ] ;
F_53 ( V_99 , sizeof( V_99 ) , V_104 , F_50 ( V_86 ) ) ;
...
static T_5 F_61 ( struct V_71 * V_70 ,
struct V_85 * V_86 , const char * V_90 , T_6 V_16 )
{
F_41 () ;
return V_16 ;
}
static void F_62 ( struct V_105 * V_106 )
{
F_26 ( V_65 , V_72 , 2 ) ;
}
...
int V_18 ;
V_72 [ 0 ] = V_42 ;
V_18 = F_64 ( V_110 , & V_111 ) ;
if ( V_112 && ( ! V_18 ) )
F_65 ( V_108 -> V_70 , L_23 ) ;
}
...
static T_5 F_72 ( struct V_71 * V_70 ,
struct V_85 * V_86 , const char * V_90 , T_6 V_16 )
{
unsigned long V_99 ;
if ( F_56 ( V_90 , 10 , & V_99 ) < 0
|| V_99 >= V_25 . V_39 )
return - V_24 ;
V_113 = V_99 ;
return V_16 ;
}
static void F_73 ( struct V_114 * V_115 )
{
struct V_114 * V_116 ;
struct V_117 * V_118 ;
for ( V_116 = V_115 ; V_116 -> V_119 ; V_116 ++ ) {
for ( V_118 = V_116 -> V_119 ; V_118 -> V_120 . V_121 . V_86 . V_122 ; V_118 ++ )
F_74 ( & V_123 -> V_70 . V_124 ,
& V_118 -> V_120 . V_121 . V_86 ) ;
F_34 ( V_116 -> V_119 ) ;
V_116 -> V_119 = NULL ;
}
}
static int F_75 ( struct V_114 * V_115 , int V_125 )
{
struct V_114 * V_116 ;
struct V_117 * V_118 ;
struct V_126 * V_86 ;
...
F_53 ( V_118 -> V_122 , sizeof( V_118 -> V_122 ) , V_116 -> V_127 ,
V_11 + 1 ) ;
...
V_18 = F_77 ( & V_123 -> V_70 . V_124 , V_86 ) ;
if ( V_18 ) {
V_86 -> V_122 = NULL ;
goto V_32;
}
...
static int F_94 ( const struct V_151 * V_140 )
{
return 1 ;
}
...
if ( V_18 )
goto V_160;
V_18 = F_75 ( V_161 , V_25 . V_62 ) ;
if ( V_18 )
goto V_162;
V_18 = F_75 ( V_163 , V_25 . V_56 ) ;
if ( V_18 )
goto V_164;
V_18 = F_78 () ;
if ( V_18 )
