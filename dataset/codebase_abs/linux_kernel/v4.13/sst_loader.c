void F_1 ( void T_1 * V_1 , const void * V_2 , int V_3 )
{
F_2 ( V_1 , V_2 , V_3 / 4 ) ;
}
void F_3 ( void * V_1 , const void T_1 * V_2 , int V_3 )
{
F_2 ( V_1 , V_2 , V_3 / 4 ) ;
}
...
union V_6 V_7 ;
F_5 ( V_5 -> V_8 , L_1 ) ;
V_7 . V_9 = F_6 ( V_5 -> V_10 , V_11 ) ;
F_5 ( V_5 -> V_8 , L_2 , V_7 . V_9 ) ;
V_7 . V_9 |= 0x7 ;
F_7 ( V_5 -> V_10 , V_11 , V_7 . V_9 ) ;
V_7 . V_9 = F_6 ( V_5 -> V_10 , V_11 ) ;
F_5 ( V_5 -> V_8 , L_2 , V_7 . V_9 ) ;
V_7 . V_9 &= ~ ( 0x1 ) ;
F_7 ( V_5 -> V_10 , V_11 , V_7 . V_9 ) ;
...
static int F_9 ( struct V_4 * V_14 , unsigned long V_15 ,
...
static int F_15 ( struct V_4 * V_14 , unsigned long V_15 ,
struct V_29 * V_54 )
{
struct V_16 * V_17 ;
T_2 V_3 , V_18 ;
int V_41 ;
V_41 = F_9 ( V_14 , V_15 , & V_17 , & V_18 ) ;
if ( V_41 )
return V_41 ;
for ( V_3 = 0 ; V_3 < V_18 ; V_3 ++ ) {
V_41 = F_14 ( V_14 , V_17 , V_54 ) ;
if ( V_41 )
return V_41 ;
...
{
struct V_33 * V_34 ;
F_17 (listnode, memcpy_list, memcpylist) {
if ( V_34 -> V_32 == true )
...
static int F_23 ( struct V_4 * V_56 ,
const struct V_57 * V_58 )
{
int V_59 = 0 ;
V_56 -> V_22 = F_12 ( V_58 -> V_15 , V_35 ) ;
if ( ! V_56 -> V_22 ) {
V_59 = - V_36 ;
goto V_60;
}
F_5 ( V_56 -> V_8 , L_12 , V_56 -> V_22 ) ;
F_5 ( V_56 -> V_8 , L_13 , ( unsigned long ) F_24 ( V_56 -> V_22 ) ) ;
memcpy ( V_56 -> V_22 , V_58 -> V_61 , V_58 -> V_15 ) ;
V_59 = F_15 ( V_56 , V_58 -> V_15 , & V_56 -> V_30 ) ;
if ( V_59 ) {
F_10 ( V_56 -> V_8 , L_14 ) ;
F_22 ( V_56 -> V_22 ) ;
V_56 -> V_22 = NULL ;
...
void F_26 ( const struct V_57 * V_58 , void * V_62 )
{
...
static int F_29 ( struct V_4 * V_56 )
{
int V_59 = 0 ;
const struct V_57 * V_58 ;
V_59 = F_30 ( & V_58 , V_56 -> V_66 , V_56 -> V_8 ) ;
if ( V_58 == NULL ) {
F_10 ( V_56 -> V_8 , L_17 ) ;
return - V_28 ;
}
if ( V_59 ) {
F_10 ( V_56 -> V_8 , L_18 , V_59 ) ;
return V_59 ;
}
F_27 ( & V_56 -> V_63 ) ;
V_59 = F_23 ( V_56 , V_58 ) ;
...
static void F_31 ( void T_1 * V_67 ,
unsigned int V_68 )
{
void T_1 * V_69 ;
T_2 V_70 = 0 ;
...
void F_32 ( struct V_4 * V_14 )
{
F_31 ( V_14 -> V_49 , V_14 -> V_68 ) ;
F_5 ( V_14 -> V_8 , L_19 ) ;
}
