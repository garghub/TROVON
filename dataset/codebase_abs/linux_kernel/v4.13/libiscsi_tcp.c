...
inline void
F_24 ( struct V_33 * V_19 , const void * V_34 ,
T_1 V_35 , unsigned char V_15 [ V_17 ] )
{
struct V_3 V_4 ;
F_17 ( & V_4 , V_34 , V_35 ) ;
F_18 ( V_19 , & V_4 , V_15 , V_35 ) ;
F_25 ( V_19 ) ;
}
static inline int
...
inline void
F_29 ( struct V_1 * V_2 , void * V_11 ,
T_1 V_7 , T_2 * V_36 ,
struct V_33 * V_19 )
{
F_27 ( V_2 , V_7 , V_36 , V_19 ) ;
V_2 -> V_11 = V_11 ;
V_2 -> V_7 = V_7 ;
}
inline int
...
return;
F_37 ( & V_56 -> V_61 ) ;
while ( F_38 ( & V_56 -> V_62 , ( void * ) & V_59 , sizeof( void * ) ) ) {
F_39 ( & V_56 -> V_63 . V_64 , ( void * ) & V_59 ,
sizeof( void * ) ) ;
F_14 ( V_54 -> V_46 , L_12 ) ;
}
V_59 = V_56 -> V_59 ;
...
static int F_41 ( struct V_23 * V_46 , struct V_53 * V_54 )
{
struct V_20 * V_21 = V_46 -> V_57 ;
struct V_55 * V_56 = V_54 -> V_57 ;
struct V_65 * V_66 = (struct V_65 * ) V_21 -> V_42 . V_34 ;
int V_67 = F_42 ( V_66 -> V_67 ) ;
unsigned V_68 = F_43 ( V_54 -> V_60 ) -> V_8 ;
if ( ! ( V_66 -> V_69 & V_70 ) )
F_44 ( V_46 -> V_24 , (struct V_71 * ) V_66 ) ;
if ( V_21 -> V_42 . V_49 == 0 )
return 0 ;
if ( V_56 -> V_72 != V_67 ) {
F_14 ( V_46 , L_13
...
static int F_45 ( struct V_23 * V_46 , struct V_53 * V_54 )
{
...
V_79 , V_24 -> V_87 ) ;
V_74 = F_42 ( V_66 -> V_74 ) ;
if ( V_74 + V_79 > F_47 ( V_54 -> V_60 ) -> V_8 ) {
F_46 ( V_80 , V_46 ,
L_23
L_24 , V_79 ,
V_74 , F_47 ( V_54 -> V_60 ) -> V_8 ) ;
return V_81 ;
}
F_48 ( & V_56 -> V_88 ) ;
V_47 = F_38 ( & V_56 -> V_63 . V_64 , ( void * ) & V_59 , sizeof( void * ) ) ;
if ( ! V_47 ) {
F_46 ( V_80 , V_46 , L_25
L_26
L_27 ) ;
...
V_59 -> V_93 = 0 ;
V_56 -> V_72 = V_78 + 1 ;
F_39 ( & V_56 -> V_62 , ( void * ) & V_59 , sizeof( void * ) ) ;
V_46 -> V_94 ++ ;
F_49 ( & V_56 -> V_88 ) ;
F_50 ( V_54 ) ;
return 0 ;
...
return V_48 ;
if ( V_34 -> V_69 & V_70 ) {
V_47 = F_34 ( V_46 , V_21 -> V_42 . V_34 , NULL , 0 ) ;
if ( V_47 )
return V_47 ;
}
F_32 ( V_21 ) ;
...
static int
F_52 ( struct V_23 * V_46 , struct V_44 * V_34 )
{
int V_47 = 0 , V_95 , V_96 ;
struct V_20 * V_21 = V_46 -> V_57 ;
struct V_53 * V_54 ;
V_21 -> V_42 . V_49 = F_53 ( V_34 -> V_97 ) ;
...
V_54 = F_55 ( V_46 , V_34 -> V_86 ) ;
if ( ! V_54 )
V_47 = V_103 ;
else
V_47 = F_41 ( V_46 , V_54 ) ;
if ( V_47 ) {
F_49 ( & V_46 -> V_24 -> V_102 ) ;
break;
}
if ( V_21 -> V_42 . V_49 ) {
struct V_55 * V_56 = V_54 -> V_57 ;
struct V_33 * V_50 = NULL ;
struct V_104 * V_105 = F_43 ( V_54 -> V_60 ) ;
if ( V_46 -> V_51 &&
! ( V_46 -> V_24 -> V_25 -> V_26 & V_52 ) )
V_50 = V_21 -> V_50 ;
F_14 ( V_46 , L_30
...
V_21 -> V_42 . V_34 = V_34 ;
return F_52 ( V_46 , V_34 ) ;
}
inline int F_57 ( struct V_20 * V_21 )
{
return V_21 -> V_42 . V_2 . V_36 == V_45 ;
}
int F_58 ( struct V_23 * V_46 , struct V_127 * V_128 ,
...
F_60 ( V_128 , V_5 , V_128 -> V_31 , & V_132 ) ;
while ( 1 ) {
unsigned int V_138 ;
const T_4 * V_30 ;
V_138 = F_61 ( V_133 , & V_30 , & V_132 ) ;
if ( V_138 == 0 ) {
F_14 ( V_46 , L_37 ,
V_133 ) ;
* V_130 = V_139 ;
...
static struct V_58 * F_66 ( struct V_53 * V_54 )
{
struct V_55 * V_56 = V_54 -> V_57 ;
...
if ( V_47 )
return V_47 ;
F_70 ( V_54 , V_59 , (struct V_155 * ) V_54 -> V_34 ) ;
F_14 ( V_46 , L_45 ,
...
struct V_157 *
F_71 ( struct V_158 * V_159 , int V_160 ,
T_5 V_161 )
{
struct V_23 * V_46 ;
struct V_157 * V_162 ;
...
void F_73 ( struct V_157 * V_162 )
{
F_74 ( V_162 ) ;
}
int F_75 ( struct V_76 * V_24 )
{
int V_39 ;
int V_163 ;
...
int F_82 ( struct V_23 * V_46 , char * V_170 )
{
struct V_76 * V_24 = V_46 -> V_24 ;
