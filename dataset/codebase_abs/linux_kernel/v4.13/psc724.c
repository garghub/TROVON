...
F_16 ( V_29 . V_38 , L_1 ,
sizeof( V_29 . V_38 ) ) ;
V_31 = F_17 ( V_9 -> V_39 , & V_29 ) ;
F_18 ( V_9 -> V_39 , V_40 , & V_31 -> V_41 ) ;
F_16 ( V_29 . V_38 , V_6 -> V_22 . V_42 [ V_43 ] . V_38 ,
sizeof( V_29 . V_38 ) ) ;
V_31 = F_17 ( V_9 -> V_39 , & V_29 ) ;
F_18 ( V_9 -> V_39 , V_40 , & V_31 -> V_41 ) ;
}
...
F_20 ( & V_6 -> V_46 , F_21 ( V_48 ) ) ;
if ( V_27 == V_6 -> V_27 )
return;
F_14 ( V_9 , V_27 ) ;
}
static void F_22 ( struct V_8 * V_9 , bool V_23 )
{
struct V_5 * V_6 = V_9 -> V_6 ;
if ( V_6 -> V_49 == V_23 )
return;
...
static int F_25 ( struct V_30 * V_50 ,
struct V_51 * V_52 )
{
struct V_8 * V_9 = F_26 ( V_50 ) ;
int V_53 = V_50 -> V_54 ;
V_52 -> V_55 . integer . V_55 [ 0 ] = V_56 [ V_53 ] . F_27 ( V_9 ) ;
return 0 ;
}
static int F_28 ( struct V_30 * V_50 ,
struct V_51 * V_52 )
{
struct V_8 * V_9 = F_26 ( V_50 ) ;
int V_53 = V_50 -> V_54 ;
V_56 [ V_53 ] . F_29 ( V_9 , V_52 -> V_55 . integer . V_55 [ 0 ] ) ;
return 0 ;
}
...
V_58 . V_36 = V_37 ;
for ( V_12 = 0 ; V_12 < F_33 ( V_56 ) ; V_12 ++ ) {
V_58 . V_54 = V_12 ;
...
if ( ! V_42 )
return - V_112 ;
V_59 = F_35 ( V_9 -> V_39 , V_42 ) ;
if ( V_59 < 0 )
return V_59 ;
}
return 0 ;
}
static void F_36 ( struct V_8 * V_9 , unsigned int V_113 )
{
struct V_5 * V_6 = V_9 -> V_6 ;
F_37 ( & V_6 -> V_22 ) ;
F_38 ( & V_6 -> V_7 ) ;
