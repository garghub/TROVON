...
static int F_32 ( struct V_1 * V_2 , T_1 V_118 , T_1 V_119 ,
struct V_16 * V_17 )
{
struct V_16 * V_77 = NULL ;
T_1 V_83 = V_2 -> V_120 [ V_118 ] . V_83 ;
int V_5 ;
F_18 ( L_7 , V_119 ) ;
switch ( V_119 ) {
case V_121 :
...
if ( V_4 -> V_126 == NULL )
return - V_127 ;
return V_4 -> V_126 ( V_4 -> V_13 , V_125 , V_2 -> V_128 ) ;
}
...
struct V_16 * V_23 ;
int V_5 ;
V_5 = F_8 ( V_2 , V_25 , V_131 ,
NULL , 0 , & V_23 ) ;
if ( V_5 == 0 ) {
if ( V_23 -> V_27 == 2 && V_23 -> V_29 [ 0 ] == 0x00 )
F_38 ( V_2 -> V_65 , V_129 ++ , V_132 ) ;
F_9 ( V_23 ) ;
}
V_5 = F_11 ( V_2 , V_133 ,
V_134 ,
& V_130 , 1 ) ;
if ( V_5 == 0 )
F_38 ( V_2 -> V_65 , V_129 ++ , V_135 ) ;
return ! V_129 ;
}
static int F_39 ( struct V_1 * V_2 , T_2 V_129 )
{
struct V_136 * V_137 ;
T_1 V_12 = V_138 ;
static struct V_139 {
...
struct V_139 * V_21 = V_139 ;
int V_22 = F_7 ( V_139 ) ;
struct V_16 * V_23 ;
int V_5 ;
V_137 = F_40 ( V_2 -> V_65 , V_129 ) ;
switch ( V_137 -> type ) {
case V_132 :
while ( V_22 -- ) {
V_5 = F_8 ( V_2 , V_25 ,
...
return F_10 ( V_2 , V_141 ,
V_142 , & V_12 , 1 ) ;
case V_135 :
return F_10 ( V_2 , V_133 ,
V_143 , & V_12 , 1 ) ;
default:
return - V_44 ;
}
}
static int F_41 ( struct V_1 * V_2 , T_2 V_129 )
{
struct V_136 * V_137 ;
T_1 V_15 = V_144 ;
V_137 = F_40 ( V_2 -> V_65 , V_129 ) ;
...
int F_42 ( void * V_13 , struct V_145 * V_11 , char * V_146 ,
int V_147 , int V_148 , int V_149 ,
T_5 V_126 , struct V_1 * * V_2 )
{
struct V_3 * V_4 ;
T_2 V_150 ;
struct V_151 V_152 ;
int V_5 ;
V_4 = F_43 ( sizeof( struct V_3 ) , V_153 ) ;
if ( ! V_4 ) {
V_5 = - V_154 ;
goto V_155;
}
...
V_4 -> V_7 = V_8 ;
F_44 ( & V_4 -> V_6 ) ;
V_152 . V_156 = F_7 ( V_157 ) ;
memcpy ( V_152 . V_158 , V_157 , sizeof( V_157 ) ) ;
strcpy ( V_152 . V_159 , L_9 ) ;
V_150 = V_61 |
V_60 |
V_62 |
V_59 |
