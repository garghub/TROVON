...
if ( V_5 )
return V_5 ;
return F_21 ( V_2 , V_101 -> V_46 , V_101 -> V_58 , & V_74 ) ;
}
static int F_25 ( struct V_22 * V_23 ,
struct V_102 * V_103 ,
struct V_104 * V_105 )
{
struct V_100 * V_101 = & V_105 -> V_105 ;
if ( V_105 -> V_106 )
return - V_38 ;
...
struct V_115 * V_58 )
{
if ( V_58 -> V_106 || V_58 -> V_116 >= F_18 ( V_117 ) )
return - V_38 ;
V_58 -> V_58 = V_117 [ V_58 -> V_116 ] ;
return 0 ;
}
...
case V_125 :
case V_126 :
V_119 -> V_120 . V_46 = V_92 ;
V_119 -> V_120 . V_47 = V_127 ;
return 0 ;
default:
return - V_38 ;
}
...
struct V_1 * V_2 = F_10 ( V_23 ) ;
struct V_43 * V_44 = F_14 ( V_2 ) ;
V_103 -> V_10 = V_143 | V_144 |
V_145 | V_146 |
V_147 ;
V_103 -> type = V_148 ;
V_103 -> V_10 = F_34 ( V_44 , V_103 ) ;
return 0 ;
}
...
V_28 = F_36 ( & V_2 -> V_16 , sizeof( struct V_27 ) , V_151 ) ;
if ( ! V_28 ) {
F_3 ( & V_2 -> V_16 ,
L_12 ) ;
return - V_152 ;
}
F_37 ( & V_28 -> V_31 , V_2 , & V_153 ) ;
F_38 ( & V_28 -> V_30 , 2 ) ;
F_39 ( & V_28 -> V_30 , & V_154 ,
V_33 , 0 , 1 , 1 , 0 ) ;
F_39 ( & V_28 -> V_30 , & V_154 ,
V_36 , 0 , 1 , 1 , 0 ) ;
V_28 -> V_31 . V_155 = & V_28 -> V_30 ;
if ( V_28 -> V_30 . error )
return V_28 -> V_30 . error ;
V_28 -> V_45 = F_40 ( & V_2 -> V_16 , L_13 ) ;
if ( F_41 ( V_28 -> V_45 ) ) {
V_5 = F_42 ( V_28 -> V_45 ) ;
goto V_156;
}
