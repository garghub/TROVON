...
static int F_33 ( struct V_84 * V_36 , unsigned V_85 )
{
int V_33 ;
struct V_30 * V_31 ;
V_31 = F_32 ( V_36 ) ;
...
static int F_34 ( struct V_90 * V_45 )
{
struct V_30 * V_31 = F_35 ( V_45 ) ;
struct V_91 * V_92 = F_36 ( & V_45 -> V_93 ) ;
if ( V_92 && V_92 -> V_94 ) {
...
if ( ! F_42 ( V_45 -> V_101 , V_102 ) )
return - V_89 ;
V_31 = F_43 ( & V_45 -> V_93 , sizeof( * V_31 ) , V_103 ) ;
if ( ! V_31 )
return - V_104 ;
F_44 ( & V_31 -> V_43 ) ;
F_45 ( & V_31 -> V_52 , F_19 ) ;
...
| F_11 ( V_45 , V_62 ) ) ;
F_19 ( & V_31 -> V_52 . V_52 ) ;
V_31 -> V_64 = F_51 ( V_27 , V_109 , NULL ,
V_31 , V_110 ) ;
...
V_31 -> V_36 . V_117 = F_33 ;
V_31 -> V_36 . V_111 = V_92 -> V_111 ;
V_31 -> V_36 . V_118 = 7 ;
V_31 -> V_36 . V_119 = 1 ;
V_76 = F_52 ( & V_31 -> V_36 , V_31 ) ;
if ( V_76 < 0 )
F_53 ( & V_45 -> V_93 , L_76 ,
V_76 ) ;
else if ( V_92 -> V_120 ) {
