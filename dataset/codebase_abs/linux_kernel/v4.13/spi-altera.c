...
struct V_41 * V_42 ;
int V_43 = - V_44 ;
V_4 = F_14 ( & V_39 -> V_36 , sizeof( struct V_1 ) ) ;
if ( ! V_4 )
return V_43 ;
V_4 -> V_45 = V_39 -> V_46 ;
V_4 -> V_47 = 16 ;
V_4 -> V_48 = V_9 ;
V_4 -> V_49 = F_15 ( 1 , 16 ) ;
V_4 -> V_36 . V_50 = V_39 -> V_36 . V_50 ;
V_7 = F_2 ( V_4 ) ;
F_16 ( V_39 , V_7 ) ;
V_7 -> V_51 . V_4 = V_4 ;
V_7 -> V_51 . V_52 = F_3 ;
V_7 -> V_51 . V_53 = F_6 ;
V_42 = F_17 ( V_39 , V_54 , 0 ) ;
V_7 -> V_12 = F_18 ( & V_39 -> V_36 , V_42 ) ;
if ( F_19 ( V_7 -> V_12 ) ) {
V_43 = F_20 ( V_7 -> V_12 ) ;
goto exit;
}
...
if ( V_7 -> V_28 >= 0 ) {
F_22 ( & V_7 -> V_31 ) ;
V_43 = F_23 ( & V_39 -> V_36 , V_7 -> V_28 , F_11 , 0 ,
V_39 -> V_55 , V_7 ) ;
if ( V_43 )
goto exit;
}
