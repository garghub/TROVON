...
static T_3 V_23 ( struct V_12 * V_14 )
{
...
F_12 ( & V_7 -> V_19 , V_18 ) ;
V_17 -> V_80 = V_101 ;
V_100 = F_56 ( & V_17 -> V_14 ) ;
F_57 ( & V_17 -> V_24 , & V_7 -> V_31 ) ;
F_16 ( & V_7 -> V_19 , V_18 ) ;
return V_100 ;
}
...
static enum V_80 F_60 ( struct V_9 * V_10 ,
T_3 V_100 , struct V_107 * V_108 )
{
struct V_6 * V_7 = F_7 ( V_10 ) ;
struct V_11 * V_17 ;
struct V_27 * V_28 ;
...
if ( F_66 ( V_7 , V_131 , & V_64 , & V_62 , & V_50 ,
& V_123 , & V_114 ) < 0 )
return NULL ;
F_69 ( & V_150 ) ;
V_66 = V_151 ;
...
V_66 |= F_65 ( V_7 , V_123 , V_114 , V_124 ) ;
V_17 -> V_112 += V_124 ;
V_28 -> V_60 . V_64 = V_64 ;
V_28 -> V_60 . V_68 = V_160 ;
V_28 -> V_60 . V_50 = V_50 ;
F_67 ( V_7 , & V_28 -> V_60 , V_124 ) ;
V_28 -> V_60 . V_62 = V_62 ;
V_28 -> V_60 . V_66 = V_66 ;
V_28 -> V_73 = false ;
V_28 -> V_79 = false ;
...
static struct V_12 * F_73 (
struct V_9 * V_10 , T_4 V_163 , T_5 V_164 ,
T_5 V_165 , enum V_130 V_131 ,
unsigned long V_18 )
{
struct V_6 * V_7 = F_7 ( V_10 ) ;
...
static struct V_9 * F_80 ( struct V_170 * V_171 ,
struct V_172 * V_173 )
{
...
V_181 = F_83 ( & V_177 -> V_16 ) ;
if ( ! V_181 ) {
F_27 ( & V_177 -> V_16 , L_27 ) ;
return - V_182 ;
}
V_2 = F_84 ( & V_177 -> V_16 , sizeof( * V_2 ) + V_181 -> V_183 *
...
V_2 -> V_46 = V_181 ;
F_85 ( V_177 , V_2 ) ;
V_179 = F_86 ( V_177 , V_186 , 0 ) ;
V_2 -> V_5 = F_87 ( & V_177 -> V_16 , V_179 ) ;
if ( F_88 ( V_2 -> V_5 ) )
return F_89 ( V_2 -> V_5 ) ;
V_2 -> V_187 = F_90 ( & V_177 -> V_16 , NULL ) ;
if ( F_88 ( V_2 -> V_187 ) ) {
F_27 ( & V_177 -> V_16 , L_28 ) ;
return F_89 ( V_2 -> V_187 ) ;
}
V_2 -> V_188 = F_91 ( & V_177 -> V_16 , L_29 ) ;
if ( F_88 ( V_2 -> V_188 ) ) {
F_27 ( & V_177 -> V_16 , L_30 ) ;
return F_89 ( V_2 -> V_188 ) ;
}
F_92 ( & V_2 -> V_40 ) ;
F_93 ( & V_177 -> V_16 ) ;
if ( ! F_94 ( & V_177 -> V_16 ) )
V_109 = F_95 ( & V_177 -> V_16 ) ;
else
V_109 = F_76 ( & V_177 -> V_16 ) ;
if ( V_109 < 0 ) {
F_96 ( & V_177 -> V_16 ) ;
return V_109 ;
}
...
V_109 = F_99 ( V_7 -> V_94 , F_53 , 0 , V_7 -> V_197 , V_7 ) ;
if ( V_109 ) {
F_27 ( & V_177 -> V_16 ,
L_33 ,
V_109 , V_147 ) ;
...
F_101 ( V_199 , V_2 -> V_175 . V_200 ) ;
F_101 ( V_201 , V_2 -> V_175 . V_200 ) ;
F_101 ( V_202 , V_2 -> V_175 . V_200 ) ;
V_2 -> V_41 = 0 ;
...
V_2 -> V_175 . V_204 =
F_77 ;
V_2 -> V_175 . V_205 = F_68 ;
V_2 -> V_175 . V_206 = F_73 ;
V_2 -> V_175 . V_207 = F_102 ( V_115 ) |
F_102 ( V_117 ) |
F_102 ( V_119 ) |
F_102 ( V_121 ) ;
V_2 -> V_175 . V_208 = F_102 ( V_115 ) |
F_102 ( V_117 ) |
F_102 ( V_119 ) |
F_102 ( V_121 ) ;
V_2 -> V_175 . V_209 = F_102 ( V_138 ) | F_102 ( V_133 ) ;
V_2 -> V_175 . V_210 = V_211 ;
V_2 -> V_175 . V_212 = F_26 ;
V_2 -> V_175 . V_213 = F_59 ;
V_2 -> V_175 . V_214 = F_60 ;
V_2 -> V_175 . V_215 = F_58 ;
V_109 = F_103 ( & V_2 -> V_175 ) ;
if ( V_109 < 0 ) {
F_27 ( & V_177 -> V_16 ,
L_34 , V_109 ) ;
goto V_195;
}
V_109 = F_104 ( V_177 -> V_16 . V_216 ,
F_80 , V_2 ) ;
if ( V_109 < 0 ) {
F_27 ( & V_177 -> V_16 ,
L_35 , V_109 ) ;
...
static int F_110 ( struct V_176 * V_177 )
{
struct V_1 * V_2 = F_111 ( V_177 ) ;
int V_147 ;
struct V_6 * V_7 ;
F_105 ( & V_2 -> V_175 ) ;
