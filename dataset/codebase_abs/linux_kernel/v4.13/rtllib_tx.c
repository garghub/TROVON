...
F_42 ( V_33 -> V_39 [ 0 ] , V_41 -> V_1 , V_41 -> V_31 ) ;
goto V_170;
}
if ( V_41 -> V_31 > 282 ) {
if ( V_148 == V_47 ) {
...
int F_54 ( struct V_15 * V_41 , struct V_140 * V_24 )
{
memset ( V_41 -> V_40 , 0 , sizeof( V_41 -> V_40 ) ) ;
