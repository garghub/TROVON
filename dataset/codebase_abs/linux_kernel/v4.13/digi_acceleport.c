...
V_168 = V_16 [ 0 ] ;
V_20 = V_16 [ 1 ] ;
if ( V_141 -> V_172 != V_20 + 2 ) {
F_18 ( & V_13 -> V_26 , L_24 ,
V_10 -> V_27 , V_168 , V_20 , V_141 -> V_172 ) ;
return - 1 ;
}
if ( V_168 == V_173 && V_20 < 1 ) {
F_18 ( & V_13 -> V_26 , L_25 ) ;
return - 1 ;
}
F_22 ( & V_10 -> V_15 ) ;
...
F_14 ( & V_13 -> V_26 , L_27 , V_38 , V_168 ) ;
return V_171 ? 1 : 0 ;
}
...
struct V_9 * V_10 = F_13 ( V_13 ) ;
unsigned char * V_16 = V_141 -> V_35 ;
int V_168 , line , V_145 , V_135 ;
int V_76 ;
unsigned int V_183 ;
if ( V_141 -> V_172 < 4 )
return - 1 ;
for ( V_76 = 0 ; V_76 < V_141 -> V_172 - 3 ; V_76 += 4 ) {
V_168 = V_16 [ V_76 ] ;
line = V_16 [ V_76 + 1 ] ;
V_145 = V_16 [ V_76 + 2 ] ;
V_135 = V_16 [ V_76 + 3 ] ;
F_14 ( & V_13 -> V_26 , L_28 ,
V_168 , line , V_145 , V_135 ) ;
