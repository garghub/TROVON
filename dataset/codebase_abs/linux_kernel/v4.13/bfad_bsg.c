...
{
struct V_500 * V_501 = V_499 -> V_502 ;
struct V_503 * V_504 = V_499 -> V_505 ;
T_2 V_506 = V_501 -> V_507 . V_508 . V_506 [ 0 ] ;
struct V_20 * V_21 = F_257 ( F_258 ( V_499 ) ) ;
struct V_1 * V_2 = V_21 -> V_2 ;
struct V_509 * V_510 = V_499 -> V_511 -> V_512 ;
void * V_513 ;
int V_112 = - V_116 ;
F_259 ( V_510 , 256 ) ;
V_513 = F_260 ( V_499 -> V_514 . V_62 , V_515 ) ;
if ( ! V_513 ) {
V_112 = - V_516 ;
goto V_67;
}
F_261 ( V_499 -> V_514 . V_517 ,
V_499 -> V_514 . V_518 , V_513 ,
V_499 -> V_514 . V_62 ) ;
V_112 = F_255 ( V_2 , V_506 , V_513 ,
V_499 -> V_514 . V_62 ) ;
if ( V_112 != V_11 )
goto error;
F_262 ( V_499 -> V_519 . V_517 ,
V_499 -> V_519 . V_518 ,
V_513 ,
V_499 -> V_519 . V_62 ) ;
F_263 ( V_513 ) ;
V_499 -> V_520 = V_499 -> V_519 . V_62 ;
V_504 -> V_521 = V_499 -> V_519 . V_62 ;
V_504 -> V_248 = V_112 ;
F_264 ( V_499 , V_504 -> V_248 ,
V_504 -> V_521 ) ;
return V_112 ;
error:
F_263 ( V_513 ) ;
V_67:
V_504 -> V_248 = V_112 ;
V_499 -> V_520 = sizeof( T_2 ) ;
V_504 -> V_521 = 0 ;
return V_112 ;
}
T_4
F_265 ( void * V_522 , int V_523 )
{
struct V_522 * V_524 = V_522 ;
struct V_525 * V_526 ;
T_4 V_527 ;
V_526 = V_524 -> V_528 + V_523 ;
V_527 = ( T_4 ) ( V_529 ) V_526 -> V_530 ;
return V_527 ;
}
T_3
F_266 ( void * V_522 , int V_523 )
{
struct V_522 * V_524 = V_522 ;
struct V_525 * V_526 ;
V_526 = V_524 -> V_528 + V_523 ;
...
T_4
F_267 ( void * V_522 , int V_523 )
{
struct V_522 * V_524 = V_522 ;
struct V_525 * V_526 ;
T_4 V_527 ;
V_526 = V_524 -> V_532 + V_523 ;
V_527 = ( T_4 ) ( V_529 ) V_526 -> V_530 ;
return V_527 ;
}
T_3
F_268 ( void * V_522 , int V_523 )
{
struct V_522 * V_524 = V_522 ;
struct V_525 * V_526 ;
V_526 = V_524 -> V_532 + V_523 ;
...
void
F_269 ( void * V_522 , struct V_533 * V_534 , void * V_535 ,
T_5 V_536 , T_3 V_537 , T_3 V_538 ,
struct V_539 * V_540 )
{
struct V_522 * V_524 = V_522 ;
V_524 -> V_536 = V_536 ;
...
struct V_542 *
F_271 ( struct V_1 * V_2 , void * V_513 ,
T_2 V_62 , T_2 * V_543 )
{
struct V_542 * V_544 , * V_545 ;
struct V_525 * V_546 ;
int V_547 = 1 ;
V_544 = F_260 ( ( sizeof( struct V_542 ) +
sizeof( struct V_525 ) ) * V_547 , V_515 ) ;
if ( ! V_544 )
return NULL ;
V_546 = (struct V_525 * ) ( ( ( V_548 * ) V_544 ) +
( sizeof( struct V_542 ) * V_547 ) ) ;
V_545 = V_544 ;
V_545 -> V_549 = V_62 ;
V_545 -> V_550 = F_272 ( & V_2 -> V_551 -> V_552 ,
V_545 -> V_549 , & V_545 -> V_553 ,
V_515 ) ;
if ( ! V_545 -> V_550 )
goto V_554;
memcpy ( V_545 -> V_550 , V_513 , V_545 -> V_549 ) ;
V_546 -> V_531 = V_545 -> V_549 ;
V_546 -> V_530 = ( void * ) ( V_529 ) V_545 -> V_553 ;
* V_543 = V_547 ;
return V_544 ;
V_554:
F_263 ( V_544 ) ;
...
void
F_273 ( struct V_1 * V_2 , struct V_542 * V_544 ,
T_2 V_543 )
{
int V_18 ;
struct V_542 * V_545 = V_544 ;
if ( V_544 ) {
for ( V_18 = 0 ; V_18 < V_543 ; V_545 ++ , V_18 ++ ) {
if ( V_545 -> V_550 != NULL )
F_274 ( & V_2 -> V_551 -> V_552 ,
V_545 -> V_549 , V_545 -> V_550 ,
V_545 -> V_553 ) ;
}
F_263 ( V_544 ) ;
}
...
int
F_275 ( struct V_498 * V_499 , struct V_522 * V_524 ,
T_6 * V_555 )
{
struct V_533 * V_556 ;
struct V_1 * V_2 = V_524 -> V_82 -> V_2 ;
unsigned long V_6 ;
V_548 V_136 ;
F_2 ( & V_2 -> V_7 , V_6 ) ;
V_556 = F_276 ( V_524 , & V_2 -> V_8 ,
V_524 -> V_557 ,
V_524 -> V_558 ,
F_265 ,
F_266 ,
...
V_524 -> V_541 = V_556 ;
V_136 = F_277 ( & V_2 -> V_8 , V_555 -> V_560 . V_561 ) ;
F_278 ( V_556 , V_524 -> V_170 , V_555 -> V_121 , V_136 ,
V_555 -> V_562 , V_555 -> cos ,
V_499 -> V_514 . V_62 ,
& V_555 -> V_560 , F_269 , V_2 ,
V_499 -> V_519 . V_62 , V_555 -> V_563 ) ;
F_4 ( & V_2 -> V_7 , V_6 ) ;
return V_11 ;
}
int
F_279 ( struct V_498 * V_499 )
{
struct V_564 * V_565 ;
struct V_20 * V_21 = F_257 ( F_258 ( V_499 ) ) ;
struct V_1 * V_2 = V_21 -> V_2 ;
...
struct V_500 * V_501 = V_499 -> V_502 ;
struct V_503 * V_504 = V_499 -> V_505 ;
T_2 V_566 = V_501 -> V_567 ;
unsigned long V_6 ;
struct V_542 * V_568 ;
void * V_569 = NULL , * V_570 = NULL ;
int V_112 = - V_116 ;
V_499 -> V_520 = sizeof( T_2 ) ;
V_504 -> V_521 = 0 ;
V_565 = (struct V_564 * ) ( ( ( char * ) V_501 ) +
sizeof( struct V_500 ) ) ;
if ( V_565 == NULL )
goto V_67;
V_555 = F_260 ( V_565 -> V_62 , V_515 ) ;
if ( ! V_555 ) {
V_112 = - V_516 ;
goto V_67;
}
if ( F_280 ( ( V_548 * ) V_555 ,
( void * ) ( unsigned long ) V_565 -> V_571 ,
V_565 -> V_62 ) ) {
F_263 ( V_555 ) ;
V_112 = - V_572 ;
goto V_67;
}
V_524 = F_260 ( sizeof( struct V_522 ) , V_515 ) ;
if ( V_524 == NULL ) {
F_263 ( V_555 ) ;
V_112 = - V_516 ;
goto V_67;
...
F_2 ( & V_2 -> V_7 , V_6 ) ;
V_119 = F_56 ( & V_2 -> V_87 , V_555 -> V_121 ,
V_555 -> V_212 ) ;
if ( V_119 == NULL ) {
V_555 -> V_10 = V_122 ;
F_4 ( & V_2 -> V_7 , V_6 ) ;
...
V_524 -> V_170 = V_144 -> V_170 ;
} else {
F_4 ( & V_2 -> V_7 , V_6 ) ;
goto V_554;
}
F_4 ( & V_2 -> V_7 , V_6 ) ;
V_569 = F_260 ( V_499 -> V_514 . V_62 , V_515 ) ;
if ( ! V_569 ) {
F_283 ( V_580 L_1 ,
V_2 -> V_42 ) ;
V_112 = - V_516 ;
...
V_570 = F_260 ( V_499 -> V_519 . V_62 , V_515 ) ;
if ( ! V_570 ) {
F_283 ( V_580 L_2 ,
V_2 -> V_42 ) ;
V_112 = - V_516 ;
...
F_261 ( V_499 -> V_514 . V_517 ,
V_499 -> V_514 . V_518 , V_569 ,
V_499 -> V_514 . V_62 ) ;
V_524 -> V_581 = F_271 ( V_2 , V_569 ,
V_499 -> V_514 . V_62 ,
& V_524 -> V_557 ) ;
if ( ! V_524 -> V_581 ) {
F_283 ( V_580 L_3 ,
...
V_524 -> V_528 = (struct V_525 * )
( ( ( V_548 * ) V_524 -> V_581 ) +
( sizeof( struct V_542 ) *
V_524 -> V_557 ) ) ;
V_524 -> V_582 = F_271 ( V_2 , V_570 ,
V_499 -> V_519 . V_62 ,
& V_524 -> V_558 ) ;
if ( ! V_524 -> V_582 ) {
F_283 ( V_580 L_4 ,
...
V_568 = (struct V_542 * ) V_524 -> V_582 ;
V_524 -> V_532 = (struct V_525 * )
( ( ( V_548 * ) V_524 -> V_582 ) +
( sizeof( struct V_542 ) *
V_524 -> V_558 ) ) ;
F_5 ( & V_524 -> V_80 ) ;
V_112 = F_275 ( V_499 , V_524 , V_555 ) ;
if ( V_112 == V_11 ) {
F_7 ( & V_524 -> V_80 ) ;
V_555 -> V_10 = V_524 -> V_536 ;
} else {
V_555 -> V_10 = V_112 ;
goto V_554;
}
if ( V_524 -> V_536 == V_11 ) {
V_499 -> V_520 = V_524 -> V_537 ;
V_504 -> V_521 = V_524 -> V_537 ;
V_504 -> V_583 . V_584 . V_10 = V_585 ;
} else {
V_504 -> V_521 =
sizeof( struct V_586 ) ;
V_499 -> V_520 = sizeof( T_2 ) ;
V_504 -> V_583 . V_584 . V_10 =
V_587 ;
}
F_262 ( V_499 -> V_519 . V_517 ,
V_499 -> V_519 . V_518 ,
...
V_499 -> V_519 . V_62 ) ;
V_554:
F_273 ( V_2 , V_524 -> V_582 ,
V_524 -> V_558 ) ;
F_273 ( V_2 , V_524 -> V_581 ,
V_524 -> V_557 ) ;
F_263 ( V_569 ) ;
F_263 ( V_570 ) ;
if ( F_284 ( ( void * ) ( unsigned long ) V_565 -> V_571 ,
( void * ) V_555 , V_565 -> V_62 ) )
V_112 = - V_572 ;
F_263 ( V_555 ) ;
F_263 ( V_524 ) ;
V_67:
