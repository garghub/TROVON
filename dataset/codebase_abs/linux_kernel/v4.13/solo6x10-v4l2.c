...
F_33 ( & V_1 -> V_43 ) ;
while ( ! F_34 ( & V_1 -> V_44 ) ) {
struct V_40 * V_66 = F_59 (
V_1 -> V_44 . V_67 ,
struct V_40 , V_45 ) ;
F_36 ( & V_66 -> V_45 ) ;
F_29 ( & V_66 -> V_25 . V_46 , V_38 ) ;
}
F_37 ( & V_1 -> V_43 ) ;
F_60 ( & V_1 -> V_44 ) ;
}
...
{
struct V_26 * V_27 = F_21 ( V_25 ) ;
struct V_57 * V_68 = V_25 -> V_57 ;
struct V_1 * V_1 = F_56 ( V_68 ) ;
struct V_40 * V_69 =
F_62 ( V_27 , struct V_40 , V_25 ) ;
F_33 ( & V_1 -> V_43 ) ;
F_63 ( & V_69 -> V_45 , & V_1 -> V_44 ) ;
F_37 ( & V_1 -> V_43 ) ;
F_64 ( & V_1 -> V_6 ) ;
}
static int F_65 ( struct V_70 * V_70 , void * V_71 ,
struct V_72 * V_73 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
strcpy ( V_73 -> V_74 , V_55 ) ;
strcpy ( V_73 -> V_75 , L_2 ) ;
snprintf ( V_73 -> V_76 , sizeof( V_73 -> V_76 ) , L_3 ,
F_67 ( V_1 -> V_77 ) ) ;
V_73 -> V_78 = V_79 |
V_80 | V_81 ;
V_73 -> V_82 = V_73 -> V_78 | V_83 ;
return 0 ;
}
static int F_68 ( struct V_1 * V_1 ,
struct V_84 * V_85 )
{
int V_86 = V_85 -> V_87 - V_1 -> V_13 ;
unsigned int V_88 , V_89 ;
if ( V_86 >= V_1 -> V_22 )
return - V_16 ;
V_88 = ( V_86 == 4 ) ? 16 : 4 ;
V_89 = ( V_86 & 3 ) << 2 ;
snprintf ( V_85 -> V_90 , sizeof( V_85 -> V_90 ) ,
L_4 ,
V_88 , V_89 + 1 , V_89 + V_88 ) ;
return 0 ;
}
static int F_69 ( struct V_70 * V_70 , void * V_71 ,
struct V_84 * V_85 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
if ( V_85 -> V_87 >= V_1 -> V_13 ) {
int V_53 = F_68 ( V_1 , V_85 ) ;
if ( V_53 < 0 )
return V_53 ;
} else {
snprintf ( V_85 -> V_90 , sizeof( V_85 -> V_90 ) , L_5 ,
V_85 -> V_87 + 1 ) ;
if ( ! F_70 ( V_1 , V_85 -> V_87 ) )
V_85 -> V_91 = V_92 ;
}
V_85 -> type = V_93 ;
V_85 -> V_94 = V_1 -> V_95 -> V_96 ;
return 0 ;
}
static int F_71 ( struct V_70 * V_70 , void * V_71 , unsigned int V_87 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
int V_53 = F_19 ( V_1 , V_87 ) ;
if ( ! V_53 ) {
while ( F_3 ( V_1 ) )
;
}
...
static int F_72 ( struct V_70 * V_70 , void * V_71 , unsigned int * V_87 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
* V_87 = V_1 -> V_23 ;
return 0 ;
}
static int F_73 ( struct V_70 * V_70 , void * V_71 ,
struct V_97 * V_98 )
{
if ( V_98 -> V_87 )
return - V_16 ;
V_98 -> V_99 = V_100 ;
F_74 ( V_98 -> V_101 , L_6 , sizeof( V_98 -> V_101 ) ) ;
return 0 ;
}
static int F_75 ( struct V_70 * V_70 , void * V_71 ,
struct V_102 * V_98 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
...
static int F_76 ( struct V_70 * V_70 , void * V_71 ,
struct V_102 * V_98 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
if ( F_77 ( & V_1 -> V_113 ) )
return - V_114 ;
return F_75 ( V_70 , V_71 , V_98 ) ;
}
static int F_78 ( struct V_70 * V_70 , void * V_71 ,
struct V_102 * V_98 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
struct V_103 * V_104 = & V_98 -> V_105 . V_104 ;
...
static int F_79 ( struct V_70 * V_70 , void * V_71 , T_3 * V_17 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
if ( V_1 -> V_116 == V_117 )
* V_17 = V_118 ;
...
int F_80 ( struct V_1 * V_1 , bool V_120 )
{
int V_17 ;
if ( F_77 ( & V_1 -> V_113 ) )
return - V_114 ;
for ( V_17 = 0 ; V_17 < V_1 -> V_13 ; V_17 ++ )
if ( F_77 ( & V_1 -> V_121 [ V_17 ] -> V_113 ) )
return - V_114 ;
...
static int F_85 ( struct V_70 * V_70 , void * V_71 , T_3 V_94 )
{
struct V_1 * V_1 = F_66 ( V_70 ) ;
return F_80 ( V_1 , V_94 & V_123 ) ;
}
static int F_86 ( struct V_124 * V_125 )
{
struct V_1 * V_1 =
F_62 ( V_125 -> V_126 , struct V_1 , V_127 ) ;
switch ( V_125 -> V_128 ) {
case V_129 :
if ( V_125 -> V_130 ) {
F_2 ( V_1 , V_131 ,
...
int F_90 ( struct V_1 * V_1 , unsigned V_135 )
{
int V_53 ;
int V_17 ;
F_91 ( & V_1 -> V_6 ) ;
...
V_1 -> V_113 . V_160 = & V_1 -> V_77 -> V_160 ;
V_53 = F_98 ( & V_1 -> V_113 ) ;
if ( V_53 < 0 )
goto V_142;
for ( V_17 = 0 ; V_17 < V_1 -> V_13 ; V_17 ++ ) {
...
while ( F_3 ( V_1 ) )
;
V_53 = F_99 ( V_1 -> V_95 , V_161 , V_135 ) ;
if ( V_53 < 0 )
goto V_142;
snprintf ( V_1 -> V_95 -> V_90 , sizeof( V_1 -> V_95 -> V_90 ) , L_7 ,
V_55 , V_1 -> V_95 -> V_162 ) ;
F_100 ( & V_1 -> V_77 -> V_160 , L_8 ,
V_1 -> V_95 -> V_162 ,
V_1 -> V_13 , V_1 -> V_22 ) ;
return 0 ;
V_142:
