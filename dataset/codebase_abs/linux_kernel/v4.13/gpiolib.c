...
F_146 ( V_97 , V_13 ) ;
F_147 ( V_97 , V_13 -> V_193 ) ;
F_148 ( V_97 , V_13 -> V_183 , V_13 -> V_194 ) ;
if ( V_13 -> V_189 )
F_149 ( V_97 , 1 ) ;
F_150 ( V_97 ) ;
if ( V_13 -> V_195 != V_196 )
F_151 ( V_97 , V_13 -> V_195 ) ;
return 0 ;
}
...
static int F_153 ( struct V_197 * V_2 )
{
...
static void F_158 ( struct V_197 * V_2 )
{
struct V_12 * V_13 = F_154 ( V_2 ) ;
...
type = V_196 ;
if ( F_167 ( V_179 -> V_163 ) && type != V_196 ) {
F_168 ( F_169 ( V_179 -> V_163 ) ,
L_26 , type ) ;
type = V_196 ;
}
V_179 -> V_183 = V_183 ;
...
unsigned long V_210 )
{
return F_178 ( V_13 -> V_15 -> V_9 + V_21 , V_210 ) ;
}
...
int F_183 ( struct V_12 * V_13 , const char * V_221 ,
...
enum V_231 V_232 )
{
unsigned long V_210 = { F_200 (mode, 0 ) } ;
return V_33 -> V_233 ? V_33 -> V_233 ( V_33 , V_21 , V_210 ) : - V_234 ;
}
static int F_201 ( struct V_1 * V_17 , int V_235 )
{
...
int F_204 ( struct V_1 * V_17 , int V_235 )
{
F_188 ( V_17 ) ;
return F_201 ( V_17 , V_235 ) ;
}
...
int F_205 ( struct V_1 * V_17 , unsigned V_242 )
{
struct V_12 * V_13 ;
unsigned long V_210 ;
F_188 ( V_17 ) ;
...
static void F_213 ( struct V_1 * V_17 , bool V_235 )
{
struct V_12 * V_13 ;
V_13 = V_17 -> V_6 -> V_13 ;
F_203 ( F_10 ( V_17 ) , 0 , V_235 ) ;
if ( F_80 ( V_70 , & V_17 -> V_7 ) )
F_211 ( V_17 , V_235 ) ;
else if ( F_80 ( V_72 , & V_17 -> V_7 ) )
F_212 ( V_17 , V_235 ) ;
...
if ( V_88 != 0 )
F_214 ( V_13 , V_244 , V_245 ) ;
}
}
void F_218 ( struct V_1 * V_17 , int V_235 )
{
F_219 ( V_17 ) ;
F_124 ( V_17 -> V_6 -> V_13 -> V_187 ) ;
F_213 ( V_17 , V_235 ) ;
}
void F_220 ( struct V_1 * V_17 , int V_235 )
{
F_219 ( V_17 ) ;
F_124 ( V_17 -> V_6 -> V_13 -> V_187 ) ;
if ( F_80 ( V_68 , & V_17 -> V_7 ) )
...
void F_229 ( struct V_1 * V_17 , int V_235 )
{
F_193 ( V_228 ) ;
F_219 ( V_17 ) ;
F_213 ( V_17 , V_235 ) ;
}
void F_230 ( struct V_1 * V_17 , int V_235 )
{
F_193 ( V_228 ) ;
F_219 ( V_17 ) ;
if ( F_80 ( V_68 , & V_17 -> V_7 ) )
...
void F_233 ( struct V_255 * V_256 )
{
F_234 ( & V_257 ) ;
F_22 ( & V_256 -> V_28 , & V_258 ) ;
F_63 ( & V_257 ) ;
}
void F_235 ( struct V_255 * V_256 )
{
F_234 ( & V_257 ) ;
F_88 ( & V_256 -> V_28 ) ;
F_63 ( & V_257 ) ;
}
static struct V_255 * F_236 ( struct V_150 * V_29 )
{
...
static struct V_1 * F_237 ( struct V_150 * V_29 , const char * V_261 ,
unsigned int V_262 ,
enum V_263 * V_7 )
{
...
static int F_238 ( struct V_150 * V_29 , const char * V_261 )
{
int V_57 ;
char V_268 [ 32 ] ;
unsigned int V_32 ;
for ( V_32 = 0 ; V_32 < F_239 ( V_269 ) ; V_32 ++ ) {
if ( V_261 )
snprintf ( V_268 , sizeof( V_268 ) , L_44 ,
V_261 , V_269 [ V_32 ] ) ;
else
snprintf ( V_268 , sizeof( V_268 ) , L_45 ,
V_269 [ V_32 ] ) ;
V_57 = F_240 ( V_29 -> V_164 , V_268 ) ;
if ( V_57 > 0 )
break;
}
return V_57 ? V_57 : - V_264 ;
}
static int F_241 ( struct V_150 * V_29 , const char * V_261 )
{
struct V_255 * V_256 ;
struct V_265 * V_98 ;
unsigned int V_88 = 0 ;
...
int F_242 ( struct V_150 * V_29 , const char * V_261 )
{
int V_88 = - V_264 ;
if ( F_243 ( V_270 ) && V_29 && V_29 -> V_164 )
V_88 = F_238 ( V_29 , V_261 ) ;
else if ( F_243 ( V_271 ) && V_29 && F_169 ( V_29 ) )
V_88 = F_244 ( V_29 , V_261 ) ;
if ( V_88 < 0 )
V_88 = F_241 ( V_29 , V_261 ) ;
return V_88 ;
}
struct V_1 * T_10 F_245 ( struct V_150 * V_29 , const char * V_261 ,
enum V_272 V_7 )
{
return F_246 ( V_29 , V_261 , 0 , V_7 ) ;
}
struct V_1 * T_10 F_247 ( struct V_150 * V_29 ,
const char * V_261 ,
enum V_272 V_7 )
{
return F_248 ( V_29 , V_261 , 0 , V_7 ) ;
}
int F_249 ( struct V_1 * V_17 , const char * V_261 ,
...
int V_22 ;
enum V_263 V_281 = 0 ;
F_48 ( V_29 , L_47 , V_261 ) ;
if ( V_29 ) {
if ( F_243 ( V_270 ) && V_29 -> V_164 ) {
F_48 ( V_29 , L_48 ) ;
V_17 = F_250 ( V_29 , V_261 , V_262 , & V_281 ) ;
} else if ( F_251 ( V_29 ) ) {
F_48 ( V_29 , L_49 ) ;
V_17 = F_252 ( V_29 , V_261 , V_262 , & V_7 , & V_281 ) ;
}
}
if ( ! V_17 || V_17 == F_9 ( - V_264 ) ) {
F_48 ( V_29 , L_50 ) ;
V_17 = F_237 ( V_29 , V_261 , V_262 , & V_281 ) ;
}
if ( F_51 ( V_17 ) ) {
F_48 ( V_29 , L_51 , V_261 ) ;
return V_17 ;
}
V_22 = F_45 ( V_17 , V_261 ) ;
if ( V_22 < 0 )
return F_9 ( V_22 ) ;
V_22 = F_249 ( V_17 , V_261 , V_281 , V_7 ) ;
if ( V_22 < 0 ) {
...
struct V_1 * F_254 ( struct V_282 * V_283 ,
const char * V_268 , int V_284 ,
enum V_272 V_273 ,
const char * V_3 )
{
...
struct V_292 V_293 ;
V_17 = F_259 ( V_283 , V_268 , V_284 , & V_293 ) ;
if ( ! F_51 ( V_17 ) ) {
V_285 = V_293 . V_294 == V_274 ;
V_57 = F_260 ( & V_273 , V_293 . V_7 ) ;
if ( V_57 )
F_14 ( L_53 ) ;
}
}
...
V_57 = F_249 ( V_17 , V_268 , V_64 , V_273 ) ;
if ( V_57 < 0 ) {
F_253 ( V_17 ) ;
return F_9 ( V_57 ) ;
}
...
{
struct V_1 * V_17 ;
V_17 = F_246 ( V_29 , V_261 , V_284 , V_7 ) ;
if ( F_51 ( V_17 ) ) {
if ( F_52 ( V_17 ) == - V_264 )
return NULL ;
}
...
V_22 = F_249 ( V_17 , V_31 , V_64 , V_273 ) ;
if ( V_22 < 0 ) {
F_15 ( L_55 ,
V_31 , V_13 -> V_3 , V_14 , V_22 ) ;
F_196 ( V_17 ) ;
...
F_262 ( L_56 ,
F_10 ( V_17 ) , V_31 ,
( V_273 & V_279 ) ? L_57 : L_58 ,
( V_273 & V_279 ) ?
( V_273 & V_280 ) ? L_59 : L_60 : L_61 ) ;
return 0 ;
}
...
struct V_296 * T_10 F_263 ( struct V_150 * V_29 ,
const char * V_261 ,
enum V_272 V_7 )
{
struct V_1 * V_17 ;
...
if ( ! V_11 )
return F_9 ( - V_60 ) ;
for ( V_11 -> V_297 = 0 ; V_11 -> V_297 < V_88 ; ) {
V_17 = F_246 ( V_29 , V_261 , V_11 -> V_297 , V_7 ) ;
if ( F_51 ( V_17 ) ) {
F_264 ( V_11 ) ;
return F_265 ( V_17 ) ;
}
V_11 -> V_17 [ V_11 -> V_297 ] = V_17 ;
V_11 -> V_297 ++ ;
}
return V_11 ;
}
struct V_296 * T_10 F_266 ( struct V_150 * V_29 ,
const char * V_261 ,
enum V_272 V_7 )
{
struct V_296 * V_11 ;
V_11 = F_263 ( V_29 , V_261 , V_7 ) ;
if ( F_51 ( V_11 ) && ( F_52 ( V_11 ) == - V_264 ) )
return NULL ;
return V_11 ;
}
void F_253 ( struct V_1 * V_17 )
{
F_38 ( V_17 ) ;
}
void F_264 ( struct V_296 * V_11 )
{
unsigned int V_32 ;
for ( V_32 = 0 ; V_32 < V_11 -> V_297 ; V_32 ++ )
F_253 ( V_11 -> V_17 [ V_32 ] ) ;
F_39 ( V_11 ) ;
}
...
static void F_271 ( struct V_299 * V_300 , struct V_5 * V_6 )
{
unsigned V_32 ;
struct V_12 * V_13 = V_6 -> V_13 ;
unsigned V_4 = V_6 -> V_9 ;
struct V_1 * V_301 = & V_6 -> V_11 [ 0 ] ;
int V_302 ;
int V_303 ;
for ( V_32 = 0 ; V_32 < V_6 -> V_10 ; V_32 ++ , V_4 ++ , V_301 ++ ) {
if ( ! F_80 ( V_136 , & V_301 -> V_7 ) ) {
if ( V_301 -> V_31 ) {
F_272 ( V_300 , L_65 ,
V_4 , V_301 -> V_31 ) ;
}
...
F_16 ( V_301 ) ;
V_302 = F_80 ( V_24 , & V_301 -> V_7 ) ;
V_303 = F_80 ( V_138 , & V_301 -> V_7 ) ;
F_272 ( V_300 , L_66 ,
V_4 , V_301 -> V_31 ? V_301 -> V_31 : L_61 , V_301 -> V_3 ,
V_302 ? L_67 : L_68 ,
V_13 -> V_229
? ( V_13 -> V_229 ( V_13 , V_32 ) ? L_69 : L_70 )
: L_71 ,
V_303 ? L_72 : L_73 ) ;
F_272 ( V_300 , L_74 ) ;
}
}
static void * F_273 ( struct V_299 * V_300 , T_6 * V_304 )
{
unsigned long V_7 ;
struct V_5 * V_6 = NULL ;
T_6 V_284 = * V_304 ;
...
static void * F_274 ( struct V_299 * V_300 , void * V_306 , T_6 * V_304 )
{
unsigned long V_7 ;
struct V_5 * V_6 = V_306 ;
void * V_57 = NULL ;
F_3 ( & V_8 , V_7 ) ;
...
static void F_276 ( struct V_299 * V_300 , void * V_306 )
{
}
static int F_277 ( struct V_299 * V_300 , void * V_306 )
{
struct V_5 * V_6 = V_306 ;
struct V_12 * V_13 = V_6 -> V_13 ;
struct V_150 * V_163 ;
if ( ! V_13 ) {
F_272 ( V_300 , L_75 , ( char * ) V_300 -> V_305 ,
F_79 ( & V_6 -> V_29 ) ) ;
return 0 ;
}
F_272 ( V_300 , L_76 , ( char * ) V_300 -> V_305 ,
F_79 ( & V_6 -> V_29 ) ,
V_6 -> V_9 , V_6 -> V_9 + V_6 -> V_10 - 1 ) ;
V_163 = V_13 -> V_163 ;
if ( V_163 )
...
F_79 ( V_163 ) ) ;
if ( V_13 -> V_3 )
F_272 ( V_300 , L_79 , V_13 -> V_3 ) ;
if ( V_13 -> V_187 )
F_272 ( V_300 , L_80 ) ;
F_272 ( V_300 , L_81 ) ;
if ( V_13 -> V_307 )
V_13 -> V_307 ( V_300 , V_13 ) ;
else
F_271 ( V_300 , V_6 ) ;
return 0 ;
}
...
{
return F_279 ( V_35 , & V_308 ) ;
}
static int T_11 F_280 ( void )
{
( void ) F_281 ( L_82 , V_309 | V_310 ,
NULL , NULL , & V_311 ) ;
return 0 ;
}
