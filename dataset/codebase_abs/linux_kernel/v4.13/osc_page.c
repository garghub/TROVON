...
static long F_98 ( struct V_37 * V_38 , unsigned long V_123 )
{
struct V_10 * V_11 ;
struct V_105 * V_106 = V_38 -> V_107 ;
int V_151 ;
...
static int F_46 ( const struct V_10 * V_11 , struct V_37 * V_38 ,
struct V_1 * V_2 )
{
...
unsigned long F_107 ( struct V_37 * V_38 , unsigned long V_123 )
{
unsigned long V_162 = 0 ;
unsigned long V_163 ;
unsigned long V_164 ;
V_163 = V_38 -> V_104 * V_38 -> V_57 ;
if ( V_123 > V_163 )
V_123 = V_163 ;
V_164 = F_54 ( V_38 -> V_113 ) ;
if ( V_164 < V_123 && F_98 ( V_38, V_123 ) > 0 )
V_164 = F_54 ( V_38 -> V_113 ) ;
while ( V_164 >= V_123 ) {
if ( V_164 == F_108 ( V_38 -> V_113 , V_164 , V_164 - V_123 ) ) {
V_162 = V_123 ;
break;
}
V_164 = F_54 ( V_38 -> V_113 ) ;
}
if ( F_54 ( V_38 -> V_113 ) < V_163 ) {
F_26 ( V_119 , L_20 ,
F_57 ( V_38 ) , F_54 ( V_38 -> V_113 ) ,
V_163 ) ;
( void ) F_59 ( V_38 -> V_120 ) ;
}
return V_162 ;
}
void F_109 ( struct V_37 * V_38 , unsigned long V_123 )
{
F_67 ( V_123 , V_38 -> V_113 ) ;
F_97 ( & V_128 ) ;
}
static inline void F_110 ( struct V_165 * V_166 ,
int V_167 )
{
int F_82 = V_166 -> V_168 ;
T_5 * V_169 = NULL ;
int V_118 = 0 ;
int V_131 ;
F_2 ( F_111 ( V_166 -> V_170 ) ) ;
for ( V_131 = 0 ; V_131 < F_82 ; V_131 ++ ) {
T_5 * V_171 = F_112 ( F_113 ( V_166 , V_131 ) . V_172 ) ;
if ( F_114 ( V_171 == V_169 ) ) {
++ V_118 ;
continue;
}
if ( V_118 > 0 ) {
...
if ( V_118 > 0 )
F_115 ( V_169 , V_173 , V_167 * V_118 ) ;
}
static inline void F_116 ( struct V_165 * V_166 )
{
F_110 ( V_166 , 1 ) ;
}
static inline void F_117 ( struct V_165 * V_166 )
{
F_110 ( V_166 , - 1 ) ;
}
void F_118 ( struct V_174 * V_175 )
{
struct V_37 * V_38 = & V_175 -> V_176 -> V_177 -> V_40 . V_38 ;
struct V_165 * V_166 = V_175 -> V_178 ;
int F_82 = V_166 -> V_168 ;
long V_179 ;
F_2 ( F_82 >= 0 ) ;
F_117 ( V_166 ) ;
...
F_2 ( V_179 >= 0 ) ;
if ( ! V_179 )
F_97 ( & V_38 -> V_107 -> V_182 ) ;
if ( F_68 ( & V_128 ) )
( void ) F_59 ( V_38 -> V_120 ) ;
}
void F_120 ( struct V_174 * V_175 )
{
struct V_37 * V_38 = & V_175 -> V_176 -> V_177 -> V_40 . V_38 ;
struct V_165 * V_166 = V_175 -> V_178 ;
long F_82 = V_166 -> V_168 ;
if ( ! V_38 -> V_107 || ! V_38 -> V_107 -> V_132 )
return;
F_116 ( V_166 ) ;
F_67 ( F_82 , & V_38 -> V_180 ) ;
F_67 ( F_82 , & V_38 -> V_107 -> V_181 ) ;
F_30 ( & V_175 -> V_183 ) ;
if ( F_96 ( V_175 -> V_184 ) ) {
F_32 ( & V_175 -> V_183 ) ;
F_118 ( V_175 ) ;
...
bool F_121 ( struct V_37 * V_38 )
{
long V_186 , V_187 ;
if ( ! V_38 -> V_107 || ! V_38 -> V_107 -> V_132 )
return false ;
V_187 = F_54 ( & V_38 -> V_180 ) ;
V_186 = F_54 ( & V_38 -> V_107 -> V_181 ) ;
F_26 ( V_119 ,
L_21 ,
F_57 ( V_38 ) , V_38 , V_186 , V_187 ) ;
return V_186 > V_38 -> V_107 -> V_111 >> 2 &&
V_187 > V_38 -> V_104 *
V_38 -> V_57 ;
}
unsigned long F_122 ( struct V_188 * V_189 ,
struct V_190 * V_191 )
{
struct V_37 * V_38 ;
...
V_192 += F_54 ( & V_38 -> V_109 ) ;
F_32 ( & V_193 ) ;
return ( V_192 * V_194 ) / 100 ;
}
unsigned long F_123 ( struct V_188 * V_189 ,
struct V_190 * V_191 )
{
struct V_37 * V_195 = NULL ;
struct V_37 * V_38 ;
struct V_10 * V_11 ;
long V_196 = 0 ;
T_4 V_152 ;
...
F_30 ( & V_193 ) ;
while ( ! F_18 ( & V_201 ) ) {
V_38 = F_89 ( V_201 . V_144 , struct V_37 ,
V_202 ) ;
if ( ! V_195 )
V_195 = V_38 ;
else if ( V_38 == V_195 )
break;
F_90 ( & V_38 -> V_202 , & V_201 ) ;
F_32 ( & V_193 ) ;
V_73 = F_58 ( V_11 , V_38 , ( V_191 -> V_197 - V_196 ) >
V_38 -> V_104 ?
V_38 -> V_104 :
V_191 -> V_197 - V_196 , true ) ;
if ( V_73 > 0 )
V_196 += V_73 ;
if ( V_196 >= V_191 -> V_197 )
goto V_153;
F_30 ( & V_193 ) ;
}
F_32 ( & V_193 ) ;
