...
struct V_1 * V_7 = V_4 ;
F_3 ( & V_4 -> V_8 ) ;
if ( F_4 ( V_9 , V_4 -> V_10 + V_11 / 4 ) || ! V_4 -> V_12 ) {
int V_13 ;
for ( V_13 = 0 ; V_13 < F_5 ( V_4 -> V_14 ) ; V_13 ++ ) {
int V_15 ;
V_15 = F_6 ( V_6 , V_13 ) ;
if ( F_7 ( V_15 < 0 ) ) {
F_8 ( V_3 ,
...
{
T_2 V_15 ;
V_15 = ( V_4 -> V_14 [ V_16 ] << 2 ) + ( V_4 -> V_14 [ V_16 + 1 ] >> 6 ) ;
switch ( V_16 ) {
case V_17 :
case V_18 :
V_15 = V_15 * 25 / 10 ;
...
if ( F_15 ( V_4 ) )
return F_16 ( V_4 ) ;
V_28 = V_4 -> V_14 [ V_29 ] & V_24 -> V_26 ;
if ( V_28 )
F_18 ( V_4 -> V_6 , V_29 , ~ V_28 ) ;
...
V_4 = F_22 ( V_3 , sizeof( * V_4 ) , V_38 ) ;
if ( ! V_4 )
return - V_39 ;
V_4 -> V_6 = V_6 ;
F_23 ( & V_4 -> V_8 ) ;
F_18 ( V_6 , V_29 , 0x00 ) ;
V_34 = F_24 ( V_3 , V_6 -> V_40 ,
V_4 ,
V_41 ) ;
return F_25 ( V_34 ) ;
}
