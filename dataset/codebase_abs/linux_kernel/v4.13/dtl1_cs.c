...
return - V_69 ;
F_31 ( V_60 , V_37 ) ;
F_32 ( V_19 , F_33 ( V_60 , V_19 -> V_4 ) , V_19 -> V_4 ) ;
if ( V_19 -> V_4 & 0x0001 )
F_19 ( V_60 , 0 ) ;
memcpy ( F_34 ( V_60 , V_37 ) , & V_28 , V_37 ) ;
F_35 ( & ( V_10 -> V_20 ) , V_60 ) ;
F_4 ( V_10 ) ;
F_12 ( V_19 ) ;
return 0 ;
...
{
struct V_9 * V_10 ;
V_10 = F_50 ( & V_90 -> V_73 , sizeof( * V_10 ) , V_91 ) ;
if ( ! V_10 )
return - V_69 ;
V_10 -> V_15 = V_90 ;
V_90 -> V_92 = V_10 ;
...
static int F_54 ( struct V_89 * V_15 , void * V_96 )
{
...
int V_100 ;
V_90 -> V_16 [ 0 ] -> V_97 = 8 ;
V_100 = F_56 ( V_90 , F_54 , NULL ) ;
if ( V_100 )
goto V_101;
V_100 = F_57 ( V_90 , F_22 ) ;
if ( V_100 )
goto V_101;
V_100 = F_58 ( V_90 ) ;
if ( V_100 )
