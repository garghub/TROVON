...
static int F_79 ( struct V_48 * V_49 , T_7 V_128 )
{
T_8 V_129 ;
if ( V_128 <= V_130 )
V_129 = V_49 -> V_131 ;
...
static T_1 F_80 ( struct V_17 * V_56 , const char T_2 * V_57 ,
T_3 V_58 , T_4 * V_59 )
{
...
if ( ! F_81 ( V_56 ) ) {
F_82 ( L_2 ,
F_83 ( V_135 ) , V_135 -> V_136 ) ;
return - V_137 ;
}
if ( V_58 < sizeof V_134 )
return - V_70 ;
if ( F_84 ( & V_134 , V_57 , sizeof V_134 ) )
return - V_73 ;
V_50 = F_24 ( & V_17 -> V_6 -> V_13 ) ;
V_49 = F_25 ( V_17 -> V_6 -> V_49 ,
& V_17 -> V_6 -> V_13 ) ;
...
if ( F_84 ( & V_150 , V_57 + sizeof( V_134 ) , sizeof( V_150 ) ) ) {
V_5 = - V_73 ;
goto V_138;
}
...
F_87 ( & V_152 , V_57 , ( unsigned long ) V_150 . V_159 ,
...
static int F_88 ( struct V_17 * V_56 , struct V_164 * V_165 )
{
struct V_18 * V_17 = V_56 -> V_74 ;
struct V_48 * V_49 ;
int V_5 = 0 ;
...
static int F_89 ( struct V_87 * V_87 , struct V_17 * V_56 )
{
struct V_11 * V_12 ;
struct V_18 * V_17 ;
struct V_48 * V_49 ;
...
V_56 -> V_74 = V_17 ;
F_94 ( & V_12 -> V_10 ) ;
F_54 ( & V_17 -> V_28 , & V_12 -> V_178 ) ;
F_46 ( & V_12 -> V_90 ) ;
F_27 ( & V_12 -> V_13 , V_50 ) ;
return F_95 ( V_87 , V_56 ) ;
V_173:
F_26 ( V_49 -> V_52 ) ;
V_172:
F_46 ( & V_12 -> V_90 ) ;
...
static int F_96 ( struct V_87 * V_87 , struct V_17 * V_56 )
{
struct V_18 * V_17 = V_56 -> V_74 ;
F_44 ( & V_17 -> V_177 ) ;
if ( V_17 -> V_142 ) {
...
V_209 -> V_55 -> V_92 . V_6 =
NULL ;
F_55 ( & V_209 -> V_26 . V_66 ) ;
F_56 ( & V_209 -> V_26 . V_86 , V_104 , V_105 ) ;
}
F_46 ( & V_188 -> V_90 ) ;
}
