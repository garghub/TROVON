...
if ( ! V_67 -> V_77 . V_78 )
return - V_79 ;
V_69 = F_32 ( V_80 , V_67 -> V_77 . V_78 ) ;
if ( ! V_69 )
return - V_79 ;
V_27 = F_33 ( & V_67 -> V_77 , sizeof( * V_27 ) , V_81 ) ;
if ( ! V_27 )
return - V_82 ;
V_75 = F_34 ( V_67 , V_83 , 0 ) ;
V_27 -> V_30 = F_35 ( & V_67 -> V_77 , V_75 ) ;
if ( F_36 ( V_27 -> V_30 ) )
return F_37 ( V_27 -> V_30 ) ;
V_71 . V_84 = F_38 ( V_67 -> V_77 . V_78 ) ;
if ( V_71 . V_84 < 1 || V_71 . V_84 > 2 )
return - V_50 ;
for ( V_76 = 0 ; V_76 < V_71 . V_84 ; V_76 ++ ) {
V_72 [ V_76 ] = F_39 ( V_67 -> V_77 . V_78 , V_76 ) ;
if ( ! V_72 [ V_76 ] )
return - V_50 ;
}
V_73 = V_67 -> V_77 . V_78 -> V_85 ;
F_40 ( V_67 -> V_77 . V_78 , L_1 ,
& V_73 ) ;
V_71 . V_85 = V_73 ;
V_71 . V_86 = & V_87 ;
V_71 . V_88 = V_89 | V_90 ;
...
F_20 ( V_27 , false ) ;
V_27 -> V_45 . V_71 = & V_71 ;
V_36 = F_41 ( & V_67 -> V_77 , & V_27 -> V_45 ) ;
if ( V_36 )
return V_36 ;
return F_42 ( V_67 -> V_77 . V_78 , V_91 ,
& V_27 -> V_45 ) ;
}
