...
V_102 -= V_104 ;
if ( V_103 )
return V_102 / sizeof( struct V_105 ) ;
return V_102 /
( 2 * sizeof( struct V_57 ) + sizeof( V_106 ) ) ;
}
void
F_55 (
struct V_66 * V_67 )
...
{
return F_59 ( V_67 , V_67 -> V_40 , V_109 ) ;
}
T_7
F_60 (
struct V_66 * V_67 ,
...
if ( ! F_39 ( & V_67 -> V_75 ) )
return 0 ;
error = F_62 ( V_67 , NULL , V_8 , 0 , & V_7 ) ;
if ( error )
return error ;
V_14 = F_4 ( V_7 ) ;
V_110 = F_5 ( V_14 -> V_114 ) ;
V_113 = F_5 ( V_14 -> V_35 ) ;
F_63 ( V_7 ) ;
* V_111 += F_64 ( V_110 / 100 , F_60 ( V_67 , V_110 ) ) ;
* V_112 += V_113 ;
return error ;
}
