...
goto V_41;
V_34 = V_39 ;
V_39 = F_44 ( & V_12 -> V_20 , V_30 ) ;
if ( V_39 )
goto V_42;
if ( V_2 -> V_31 -> V_43 ) {
V_39 = V_2 -> V_31 -> V_43 ( V_12 , V_30 ) ;
if ( V_39 )
goto V_44;
}
* V_38 = V_34 ;
...
V_51 = V_12 -> V_13 >> V_53 ;
V_49 = F_52 ( V_51 , sizeof( struct V_45 * ) , V_7 ) ;
if ( V_49 == NULL )
return F_53 ( - V_8 ) ;
...
void F_60 ( struct V_11 * V_12 , struct V_45 * * V_49 ,
bool V_56 , bool V_57 )
{
int V_50 , V_51 ;
F_27 ( ( V_12 -> V_13 & ( V_17 - 1 ) ) != 0 ) ;
...
struct V_11 *
F_63 ( struct V_21 * V_15 , T_2 V_34 )
{
struct V_11 * V_12 ;
F_33 ( & V_15 -> V_35 ) ;
V_12 = F_64 ( & V_15 -> V_36 , V_34 ) ;
if ( V_12 )
F_40 ( V_12 ) ;
F_35 ( & V_15 -> V_35 ) ;
return V_12 ;
...
return - V_60 ;
F_19 ( & V_2 -> V_5 ) ;
V_12 = F_64 ( & V_2 -> V_6 , ( int ) args -> V_25 ) ;
if ( V_12 ) {
F_40 ( V_12 ) ;
} else {
F_21 ( & V_2 -> V_5 ) ;
...
void
F_69 ( struct V_1 * V_2 , struct V_21 * V_66 )
{
F_70 ( & V_66 -> V_36 ,
& F_29 , V_66 ) ;
F_71 ( & V_66 -> V_36 ) ;
...
void
F_74 ( struct V_67 * V_67 )
{
struct V_11 * V_12 =
F_75 ( V_67 , struct V_11 , V_18 ) ;
struct V_1 * V_2 = V_12 -> V_2 ;
if ( V_2 -> V_31 -> V_68 ) {
V_2 -> V_31 -> V_68 ( V_12 ) ;
} else if ( V_2 -> V_31 -> V_69 ) {
F_27 ( ! F_39 ( & V_2 -> V_70 ) ) ;
V_2 -> V_31 -> V_69 ( V_12 ) ;
}
}
...
int F_82 ( struct V_11 * V_12 , unsigned long V_74 ,
struct V_71 * V_72 )
{
struct V_1 * V_2 = V_12 -> V_2 ;
...
V_72 -> V_83 = V_2 -> V_31 -> V_77 ;
V_72 -> V_73 = V_12 ;
V_72 -> V_84 = F_83 ( F_84 ( V_72 -> V_78 ) ) ;
F_40 ( V_12 ) ;
return 0 ;
}
int F_85 ( struct V_14 * V_15 , struct V_71 * V_72 )
{
...
F_89 ( V_72 ) ) ;
if ( F_90 ( V_89 ) ) {
V_12 = F_75 ( V_89 , struct V_11 , V_20 ) ;
if ( ! F_91 ( & V_12 -> V_18 ) )
V_12 = NULL ;
}
F_92 ( V_2 -> V_4 ) ;
