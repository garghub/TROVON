...
if ( ! V_2 )
return - V_232 ;
V_247 = F_206 ( V_2 , V_38 , V_260 , V_80 -> V_233 & V_234 , NULL ) ;
...
return;
V_273 = F_144 ( V_64 ) ;
if ( V_273 && F_218 ( V_273 ) )
F_219 ( V_273 , V_178 |
V_179 | V_274 ) ;
V_38 = F_220 ( V_64 , struct V_37 , V_64 ) ;
F_122 ( & V_38 -> V_120 , V_121 , V_275 ) ;
}
static int F_221 ( struct V_75 * V_171 , struct V_276 * V_277 , T_11 V_197 )
{
int V_247 ;
...
if ( ! V_2 )
return - V_232 ;
V_247 = F_165 ( V_2 , V_38 , V_277 -> V_192 , & V_277 -> V_278 ,
V_277 -> V_279 & V_280 ,
V_277 -> V_279 & V_281 ) ;
F_93 ( V_2 ) ;
return V_247 ;
}
static int F_222 ( struct V_75 * V_171 , struct V_276 * V_277 , T_11 V_197 ,
int V_3 )
{
struct V_37 * V_38 = F_220 ( V_171 , struct V_37 , V_75 ) ;
struct V_1 * V_2 = F_89 ( V_38 ) ;
...
if ( ! V_2 )
return - V_232 ;
if ( V_3 & ~ ( V_280 | V_282 | V_283 ) ) {
V_247 = - V_8 ;
goto V_85;
}
if ( V_3 & V_283 ) {
V_247 = F_223 ( V_171 -> V_64 , V_277 , V_197 ,
V_284 , V_285 ) ;
goto V_85;
}
V_247 = F_206 ( V_2 , V_38 , & V_277 -> V_278 , V_3 & V_280 ,
V_277 -> V_192 ) ;
if ( V_247 > ( T_12 ) V_197 ) {
V_277 -> V_279 |= V_282 ;
V_247 = V_3 & V_282 ? V_247 : V_197 ;
}
V_85:
F_93 ( V_2 ) ;
return V_247 ;
...
{
return V_2 -> V_3 & ( V_286 | V_71 | V_151 | V_161 ) ;
}
static T_12 F_227 ( struct V_287 * V_46 , struct V_288 * V_289 ,
char * V_290 )
{
struct V_1 * V_2 = F_41 ( F_228 ( V_46 ) ) ;
return sprintf ( V_290 , L_10 , F_226 ( V_2 ) ) ;
}
static T_12 F_229 ( struct V_287 * V_46 , struct V_288 * V_289 ,
char * V_290 )
{
struct V_1 * V_2 = F_41 ( F_228 ( V_46 ) ) ;
...
static T_12 F_232 ( struct V_287 * V_46 , struct V_288 * V_289 ,
char * V_290 )
{
struct V_1 * V_2 = F_41 ( F_228 ( V_46 ) ) ;
...
static int F_234 ( struct V_54 * V_54 , struct V_80 * V_80 , struct V_291 * V_292 )
{
struct V_1 * V_2 ;
struct V_37 * V_38 = V_80 -> V_82 ;
struct V_45 * V_46 ;
...
if ( V_38 -> V_41 )
return - V_8 ;
V_46 = F_235 ( V_54 , V_292 -> V_293 ) ;
if ( V_46 ) {
if ( V_292 -> V_294 & V_295 )
return - V_86 ;
if ( ( V_292 -> V_294 & V_151 ) && V_46 -> V_152 == & V_153 )
V_2 = F_41 ( V_46 ) ;
else if ( ( V_292 -> V_294 & V_161 ) && V_46 -> V_152 == & V_162 )
V_2 = F_41 ( V_46 ) ;
else
return - V_8 ;
if ( ! ! ( V_292 -> V_294 & V_87 ) !=
...
if ( V_83 < 0 )
return V_83 ;
V_83 = F_82 ( V_2 , V_80 , V_292 -> V_294 & V_297 ) ;
if ( V_83 < 0 )
return V_83 ;
if ( V_2 -> V_3 & V_87 &&
( V_2 -> V_40 + V_2 -> V_62 > 1 ) ) {
...
if ( V_83 < 0 )
return V_83 ;
if ( V_292 -> V_294 & V_151 ) {
V_3 |= V_151 ;
V_298 = L_13 ;
} else if ( V_292 -> V_294 & V_161 ) {
V_3 |= V_161 ;
V_298 = L_14 ;
} else
return - V_8 ;
if ( * V_292 -> V_293 )
V_298 = V_292 -> V_293 ;
V_46 = F_238 ( sizeof( struct V_1 ) , V_298 ,
V_300 , F_214 , V_299 ,
V_299 ) ;
if ( ! V_46 )
return - V_94 ;
...
V_2 -> V_132 = V_131 ;
V_2 -> V_90 = false ;
V_2 -> V_306 = V_38 -> V_75 . V_64 -> V_307 ;
V_2 -> V_189 = 0 ;
...
F_139 ( V_46 ) ;
F_134 ( V_2 ) ;
V_46 -> V_310 = V_311 | V_312 |
V_129 | V_313 |
V_314 ;
V_46 -> V_127 = V_46 -> V_310 | V_315 ;
V_46 -> V_316 = V_46 -> V_127 &
~ ( V_313 |
V_314 ) ;
F_243 ( & V_2 -> V_61 ) ;
...
F_245 ( V_2 -> V_46 ) ;
F_17 ( V_18 , V_2 , L_15 ) ;
V_2 -> V_3 = ( V_2 -> V_3 & ~ V_286 ) |
( V_292 -> V_294 & V_286 ) ;
if ( F_246 ( V_2 -> V_46 ) )
F_247 ( V_2 -> V_46 ) ;
strcpy ( V_292 -> V_293 , V_2 -> V_46 -> V_298 ) ;
return 0 ;
V_318:
F_78 ( V_46 ) ;
goto V_308;
...
return - V_8 ;
V_2 -> V_128 = V_127 ;
V_2 -> V_46 -> V_329 &= ~ V_129 ;
V_2 -> V_46 -> V_329 |= V_127 ;
F_251 ( V_2 -> V_46 ) ;
return 0 ;
}
...
for ( V_25 = 0 ; V_25 < V_2 -> V_40 ; V_25 ++ ) {
V_38 = F_66 ( V_2 -> V_70 [ V_25 ] ) ;
V_38 -> V_75 . V_64 -> V_307 = V_2 -> V_306 ;
}
}
static int F_256 ( struct V_80 * V_80 , struct V_291 * V_292 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
struct V_1 * V_2 ;
int V_247 = 0 ;
F_76 () ;
if ( V_292 -> V_294 & V_330 ) {
V_2 = V_38 -> V_41 ;
if ( ! V_2 ) {
V_247 = - V_8 ;
goto V_42;
...
static long F_258 ( struct V_80 * V_80 , unsigned int V_332 ,
unsigned long V_100 , int V_333 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
struct V_1 * V_2 ;
...
int V_334 ;
int V_247 ;
if ( V_332 == V_335 || V_332 == V_336 || F_259 ( V_332 ) == V_337 ) {
if ( F_99 ( & V_292 , V_5 , V_333 ) )
return - V_7 ;
} else {
memset ( & V_292 , 0 , sizeof( V_292 ) ) ;
}
if ( V_332 == V_338 ) {
return F_4 ( V_151 | V_161 | V_286 ,
( unsigned int T_1 * ) V_5 ) ;
} else if ( V_332 == V_336 )
return F_256 ( V_80 , & V_292 ) ;
V_247 = 0 ;
F_76 () ;
V_2 = F_89 ( V_38 ) ;
if ( V_332 == V_335 ) {
...
if ( V_2 )
goto V_42;
V_292 . V_293 [ V_340 - 1 ] = '\0' ;
V_247 = F_234 ( F_260 ( & V_38 -> V_64 ) , V_80 , & V_292 ) ;
if ( V_247 )
goto V_42;
if ( F_261 ( V_5 , & V_292 , V_333 ) )
V_247 = - V_7 ;
goto V_42;
}
if ( V_332 == V_341 ) {
...
if ( ! V_2 )
goto V_42;
F_17 ( V_18 , V_2 , L_17 , V_332 ) ;
V_247 = 0 ;
switch ( V_332 ) {
case V_342 :
F_249 ( V_254 -> V_343 -> V_344 , V_2 , & V_292 ) ;
if ( V_38 -> V_41 )
V_292 . V_294 |= V_331 ;
if ( ! V_38 -> V_75 . V_64 -> V_118 )
V_292 . V_294 |= V_297 ;
...
break;
case V_355 :
memcpy ( V_292 . V_356 . V_357 , V_2 -> V_46 -> V_358 , V_97 ) ;
V_292 . V_356 . V_359 = V_2 -> V_46 -> type ;
if ( F_261 ( V_5 , & V_292 , V_333 ) )
V_247 = - V_7 ;
break;
case V_360 :
F_17 ( V_361 , V_2 , L_26 ,
V_292 . V_356 . V_357 ) ;
V_247 = F_268 ( V_2 -> V_46 , & V_292 . V_356 ) ;
break;
case V_362 :
V_306 = V_38 -> V_75 . V_64 -> V_307 ;
if ( F_261 ( V_5 , & V_306 , sizeof( V_306 ) ) )
V_247 = - V_7 ;
break;
case V_363 :
if ( F_99 ( & V_306 , V_5 , sizeof( V_306 ) ) ) {
V_247 = - V_7 ;
break;
}
V_2 -> V_306 = V_306 ;
...
case V_366 :
V_334 = ! ! ( V_2 -> V_3 & V_9 ) ;
if ( F_4 ( V_334 , ( int T_1 * ) V_5 ) )
V_247 = - V_7 ;
break;
case V_367 :
if ( F_6 ( V_334 , ( int T_1 * ) V_5 ) ) {
V_247 = - V_7 ;
break;
}
if ( V_334 )
...
unsigned int V_332 , unsigned long V_100 )
{
return F_258 ( V_80 , V_332 , V_100 , sizeof ( struct V_291 ) ) ;
}
...
return F_258 ( V_80 , V_332 , V_100 , sizeof( struct V_374 ) ) ;
}
static int F_272 ( int V_375 , struct V_80 * V_80 , int V_376 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
int V_247 ;
if ( ( V_247 = F_273 ( V_375 , V_80 , V_376 , & V_38 -> V_120 ) ) < 0 )
goto V_85;
if ( V_376 ) {
F_274 ( V_80 , F_275 ( V_254 ) , V_377 , 0 ) ;
V_38 -> V_3 |= V_119 ;
} else
V_38 -> V_3 &= ~ V_119 ;
V_247 = 0 ;
...
static int F_276 ( struct V_378 * V_378 , struct V_80 * V_80 )
{
struct V_54 * V_54 = V_254 -> V_343 -> V_344 ;
struct V_37 * V_38 ;
F_277 ( V_18 , L_27 ) ;
V_38 = (struct V_37 * ) F_278 ( V_54 , V_379 , V_93 ,
& V_380 , 0 ) ;
if ( ! V_38 )
return - V_94 ;
F_69 ( V_38 -> V_2 , NULL ) ;
...
V_38 -> V_75 . V_80 = V_80 ;
V_38 -> V_75 . V_381 = & V_382 ;
F_280 ( & V_38 -> V_75 , & V_38 -> V_64 ) ;
V_38 -> V_64 . V_112 = F_216 ;
V_38 -> V_64 . V_307 = V_214 ;
V_80 -> V_82 = V_38 ;
F_243 ( & V_38 -> V_60 ) ;
F_281 ( & V_38 -> V_64 , V_383 ) ;
return 0 ;
}
static int F_282 ( struct V_378 * V_378 , struct V_80 * V_80 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
F_75 ( V_38 , true ) ;
return 0 ;
}
static void F_283 ( struct V_384 * V_277 , struct V_80 * V_385 )
{
struct V_1 * V_2 ;
struct V_291 V_292 ;
memset ( & V_292 , 0 , sizeof( V_292 ) ) ;
...
F_286 ( V_332 , V_387 ) ;
F_286 ( V_332 , V_388 ) ;
V_332 -> V_389 . V_390 = V_391 ;
V_332 -> V_389 . V_392 = V_393 ;
V_332 -> V_389 . V_394 = V_395 ;
V_332 -> V_389 . V_396 = 0 ;
V_332 -> V_389 . V_397 = V_398 ;
return 0 ;
}
static void F_287 ( struct V_45 * V_46 , struct V_399 * V_400 )
{
struct V_1 * V_2 = F_41 ( V_46 ) ;
F_288 ( V_400 -> V_401 , V_402 , sizeof( V_400 -> V_401 ) ) ;
F_288 ( V_400 -> V_403 , V_404 , sizeof( V_400 -> V_403 ) ) ;
switch ( V_2 -> V_3 & V_150 ) {
case V_151 :
F_288 ( V_400 -> V_405 , L_29 , sizeof( V_400 -> V_405 ) ) ;
break;
case V_161 :
F_288 ( V_400 -> V_405 , L_30 , sizeof( V_400 -> V_405 ) ) ;
break;
}
}
...
static void F_290 ( struct V_45 * V_46 , T_4 V_407 )
{
#ifdef F_267
struct V_1 * V_2 = F_41 ( V_46 ) ;
V_2 -> V_352 = V_407 ;
...
int V_247 , V_25 ;
V_413 = F_16 ( sizeof *V_413 * V_29 , V_93 ) ;
if ( ! V_413 )
return - V_94 ;
for ( V_25 = 0 ; V_25 < V_2 -> V_40 ; V_25 ++ ) {
V_38 = F_66 ( V_2 -> V_70 [ V_25 ] ) ;
V_413 [ V_25 ] = & V_38 -> V_63 ;
}
F_79 (tfile, &tun->disabled, next)
V_413 [ V_25 ++ ] = & V_38 -> V_63 ;
V_247 = F_294 ( V_413 , V_29 ,
V_46 -> V_92 , V_93 ) ;
F_105 ( V_413 ) ;
return V_247 ;
}
static int F_295 ( struct V_414 * V_415 ,
unsigned long V_416 , void * V_417 )
{
struct V_45 * V_46 = F_296 ( V_417 ) ;
struct V_1 * V_2 = F_41 ( V_46 ) ;
if ( V_46 -> V_301 != & V_302 )
return V_418 ;
switch ( V_416 ) {
...
struct V_412 * F_307 ( struct V_80 * V_80 )
{
struct V_37 * V_38 ;
if ( V_80 -> V_428 != & V_429 )
return F_150 ( - V_8 ) ;
