...
V_6 -> V_14 . V_184 = V_304 ;
V_6 -> V_14 . V_104 = V_104 ;
V_6 -> V_14 . line = V_290 -> V_305 ;
V_6 -> V_61 = V_229 ;
snprintf ( V_6 -> V_233 , V_306 ,
V_257 L_46 V_307 L_47 ,
V_6 -> V_14 . line ) ;
...
V_6 -> V_57 = 0 ;
if ( V_118 -> V_43 . V_308 )
F_134 ( V_118 -> V_43 . V_308 , L_48
, & V_28 ) ;
#ifdef F_135
V_279 [ V_290 -> V_305 ] = V_6 ;
#endif
V_10 = F_136 ( & V_309 , & V_6 -> V_14 ) ;
if ( V_10 < 0 )
goto V_297;
#ifdef F_127
snprintf ( V_291 , sizeof( V_291 ) , L_49 , V_290 -> V_305 ) ;
V_6 -> V_310 = F_137 ( V_291 , V_311 | V_312 ,
NULL , V_6 , & V_313 ) ;
#endif
return V_6 ;
V_297:
