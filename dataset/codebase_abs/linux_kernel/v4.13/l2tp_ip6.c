...
goto V_32;
if ( V_26 -> V_33 & V_34 ) {
V_27 = F_15 ( 32u , V_18 -> V_35 ) ;
if ( ! F_11 ( V_18 , V_27 ) )
goto V_32;
V_22 = V_21 = V_18 -> V_29 ;
V_21 += 4 ;
F_16 ( L_1 , V_26 -> V_36 ) ;
F_17 ( L_2 , V_37 , V_21 , V_27 ) ;
}
F_18 ( V_24 , V_18 , V_21 , V_22 , 0 , V_18 -> V_35 ,
V_26 -> V_38 ) ;
F_19 ( V_24 ) ;
return 0 ;
V_31:
...
struct V_39 * V_40 = F_22 ( V_18 ) ;
F_23 ( & V_41 ) ;
V_3 = F_2 ( V_4 , & V_40 -> V_42 , & V_40 -> V_43 ,
F_24 ( V_18 ) , V_9 ) ;
if ( ! V_3 ) {
F_25 ( & V_41 ) ;
goto V_28;
...
if ( ! F_26 ( V_3 , V_44 , V_18 ) )
goto V_45;
F_27 ( V_18 ) ;
return F_28 ( V_3 , V_18 , 1 ) ;
V_32:
if ( V_24 -> V_46 )
V_24 -> V_46 ( V_24 ) ;
F_19 ( V_24 ) ;
...
static void F_36 ( struct V_2 * V_3 , long V_50 )
{
F_33 ( & V_41 ) ;
F_37 ( & V_3 -> V_51 ) ;
F_38 ( V_3 ) ;
...
static int F_47 ( struct V_2 * V_3 , struct V_52 * V_53 , int V_54 )
{
struct V_55 * V_56 = F_32 ( V_3 ) ;
struct V_57 * V_58 = F_48 ( V_3 ) ;
...
goto V_80;
V_64 = - V_81 ;
V_19 = F_52 ( F_6 ( V_3 ) , V_62 ) ;
if ( ! V_19 )
goto V_80;
}
V_61 = V_82 ;
V_64 = - V_70 ;
if ( ! F_53 ( F_6 ( V_3 ) , & V_60 -> V_68 , V_19 , 0 ) )
goto V_80;
}
F_54 () ;
F_33 ( & V_41 ) ;
...
static int F_57 ( struct V_2 * V_3 , struct V_52 * V_53 ,
int V_54 )
{
...
static int F_60 ( struct V_2 * V_3 , int V_98 )
{
if ( F_50 ( V_3 , V_72 ) )
return 0 ;
return F_61 ( V_3 , V_98 ) ;
}
static int F_62 ( struct V_99 * V_2 , struct V_52 * V_53 ,
int * V_100 , int V_101 )
{
struct V_59 * V_89 = (struct V_59 * ) V_53 ;
...
if ( F_49 ( & V_89 -> V_68 ) & V_78 )
V_89 -> V_79 = V_3 -> V_14 ;
* V_100 = sizeof( * V_89 ) ;
return 0 ;
}
static int F_63 ( struct V_2 * V_3 , struct V_17 * V_18 )
{
int V_92 ;
V_92 = F_64 ( V_3 , V_18 ) ;
if ( V_92 < 0 )
...
if ( V_18 == NULL )
goto V_112;
V_110 = ( V_30 * ) F_68 ( V_18 ) ;
* V_110 = 0 ;
V_64 = F_69 ( V_3 ) ;
V_112:
return V_64 ;
}
static int F_70 ( struct V_2 * V_3 , struct V_113 * V_114 , T_2 V_35 )
{
struct V_115 V_116 ;
F_71 ( struct V_59 * , V_89 , V_114 -> V_117 ) ;
...
V_131 . V_121 = V_121 ;
V_64 = F_73 ( F_6 ( V_3 ) , V_3 , V_114 , & V_127 , & V_131 ,
& V_129 ) ;
if ( V_64 < 0 ) {
F_74 ( V_123 ) ;
return V_64 ;
...
if ( V_123 )
V_121 = F_76 ( & V_116 , V_123 , V_121 ) ;
V_121 = F_77 ( & V_116 , V_121 ) ;
V_131 . V_121 = V_121 ;
...
V_118 = F_78 ( & V_127 , V_121 , & V_119 ) ;
if ( ! V_127 . V_152 && F_79 ( & V_127 . V_42 ) )
...
V_127 . V_123 = F_82 ( V_131 . V_145 , V_127 . V_123 ) ;
V_125 = F_83 ( V_3 , & V_127 , V_118 ) ;
if ( F_84 ( V_125 ) ) {
V_64 = F_85 ( V_125 ) ;
goto V_112;
}
if ( V_131 . V_144 < 0 )
V_131 . V_144 = F_86 ( V_58 , & V_127 , V_125 ) ;
if ( V_131 . V_146 < 0 )
...
F_74 ( V_123 ) ;
F_89 ( V_120 ) ;
return V_64 < 0 ? V_64 : V_35 ;
V_164:
if ( V_114 -> V_137 & V_170 )
F_90 ( V_125 , & V_127 . V_42 ) ;
if ( ! ( V_114 -> V_137 & V_170 ) || V_35 )
goto V_165;
V_64 = 0 ;
goto V_169;
}
static int F_91 ( struct V_2 * V_3 , struct V_113 * V_114 , T_2 V_35 ,
...
* V_54 = sizeof( * V_89 ) ;
if ( V_98 & V_173 )
return F_92 ( V_3 , V_114 , V_35 , V_54 ) ;
V_18 = F_93 ( V_3 , V_98 , V_171 , & V_64 ) ;
if ( ! V_18 )
goto V_112;
V_172 = V_18 -> V_35 ;
if ( V_35 < V_172 ) {
