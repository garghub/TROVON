...
if ( V_30 -> V_138 . V_140 + V_30 -> V_138 . V_141 <=
V_30 -> V_138 . V_142 )
V_30 -> V_138 . V_143 = ( V_144 ) 0 ;
F_59 ( V_145 , & V_30 -> V_48 ) ;
}
static void F_129 ( struct V_30 * V_30 , T_2 V_137 )
{
if ( F_42 ( V_30 -> V_34 ) -> V_89 & V_146 ||
V_30 -> V_138 . V_139 >= V_137 )
V_30 -> V_138 . V_139 -= V_137 ;
else
V_30 -> V_138 . V_139 = 0 ;
if ( V_30 -> V_138 . V_139 <= V_30 -> V_138 . V_147 )
V_30 -> V_138 . V_148 = ( V_144 ) 0 ;
...
if ( V_30 -> V_138 . V_142 &&
V_192 > V_30 -> V_138 . V_142 &&
V_30 -> V_138 . V_143 &&
F_148 () >= V_30 -> V_138 . V_143 &&
! F_144 ( V_30 ) ) {
if ( ! V_191 )
...
V_30 -> V_138 . V_139 <= V_30 -> V_138 . V_147 ||
! F_147 ( V_30 -> V_34 , V_30 -> V_35 . type ) )
return V_177 ;
V_185 = V_30 -> V_138 . V_139 - V_184 ;
if ( V_185 <= V_30 -> V_138 . V_147 )
return V_170 ;
...
V_192 <= V_30 -> V_138 . V_142 )
return V_177 ;
if ( V_192 - V_190 <= V_30 -> V_138 . V_142 )
return V_172 ;
if ( V_192 >= V_30 -> V_138 . V_193 &&
V_192 - V_190 < V_30 -> V_138 . V_193 )
return V_171 ;
return V_177 ;
}
...
T_2 V_218 = 0 ;
T_2 V_219 = 1 ;
struct V_30 * V_220 [ V_27 ] = {} ;
int V_56 , V_51 = 0 ;
char V_221 [ V_27 ] = {} ;
struct V_156 V_222 [ V_27 ] ;
struct V_156 V_223 [ V_27 ] ;
struct V_156 V_224 [ V_27 ] ;
if ( F_110 ( V_118 ) )
return 0 ;
if ( V_118 -> V_119 -> V_49 -> V_225 ) {
V_51 = V_118 -> V_119 -> V_49 -> V_225 ( V_118 , & V_219 ) ;
if ( V_51 )
return V_51 ;
}
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ ) {
...
continue;
V_221 [ V_56 ] = 1 ;
V_220 [ V_56 ] = F_108 ( V_118 ) [ V_56 ] ;
V_51 = F_146 ( V_216 [ V_56 ] , V_219 , & V_222 [ V_56 ] ) ;
if ( V_51 )
goto V_226;
V_51 = F_149 ( V_216 [ V_56 ] , V_190 , 0 , & V_222 [ V_56 ] ) ;
if ( V_51 )
goto V_226;
}
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ ) {
...
if ( V_220 [ V_56 ] ) {
int V_214 ;
V_214 = F_150 ( V_220 [ V_56 ] , V_219 ) ;
if ( V_214 != V_177 )
F_140 ( & V_223 [ V_56 ] ,
V_220 [ V_56 ] , V_214 ) ;
V_214 = F_151 ( V_220 [ V_56 ] , V_190 ) ;
if ( V_214 != V_177 )
F_140 ( & V_224 [ V_56 ] ,
V_220 [ V_56 ] , V_214 ) ;
F_129 ( V_220 [ V_56 ] , V_219 ) ;
F_130 ( V_220 [ V_56 ] , V_217 ) ;
F_128 ( V_220 [ V_56 ] ,
V_218 ) ;
}
F_123 ( V_216 [ V_56 ] , V_219 ) ;
...
int F_185 ( struct V_118 * V_118 , struct V_227 * V_227 )
{
...
if ( ! F_152 ( V_118 ) )
return 0 ;
if ( V_227 -> V_228 & V_229 && ! F_133 ( V_227 -> V_230 , V_118 -> V_200 ) ) {
V_30 = F_104 ( V_2 , F_155 ( V_227 -> V_230 ) ) ;
if ( F_158 ( V_30 ) ) {
if ( F_159 ( V_30 ) != - V_114 ) {
V_51 = F_159 ( V_30 ) ;
goto V_203;
...
if ( V_227 -> V_228 & V_231 && ! F_186 ( V_227 -> V_232 , V_118 -> V_201 ) ) {
V_30 = F_104 ( V_2 , F_156 ( V_227 -> V_232 ) ) ;
if ( F_158 ( V_30 ) ) {
if ( F_159 ( V_30 ) != - V_114 ) {
V_51 = F_159 ( V_30 ) ;
goto V_203;
...
if ( ! F_77 ( V_2 , V_23 -> type ) )
return - V_114 ;
if ( ! V_61 -> V_64 [ V_23 -> type ] -> V_233 )
return - V_234 ;
F_34 ( & V_61 -> V_62 ) ;
V_55 = V_61 -> V_64 [ V_23 -> type ] -> V_233 ( V_2 , V_23 ) ;
F_35 ( & V_61 -> V_62 ) ;
return V_55 ;
}
int F_189 ( struct V_118 * V_118 , struct V_235 * V_235 )
{
int error ;
error = F_190 ( V_118 , V_235 ) ;
if ( ! error && ( V_235 -> V_236 & V_237 ) )
F_160 ( V_118 ) ;
return error ;
}
...
int V_56 , V_51 = 0 ;
struct V_60 * V_61 = F_42 ( V_2 ) ;
struct V_118 * V_238 [ V_27 ] ;
if ( F_72 ( F_192 ( & V_2 -> V_81 ) ) )
F_193 ( & V_2 -> V_81 ) ;
if ( ( V_89 & V_239 && ! ( V_89 & V_240 ) )
|| ( V_89 & V_241 && V_89 & ( V_240 |
V_239 ) ) )
return - V_113 ;
if ( ! F_153 ( V_2 ) )
return 0 ;
...
if ( F_194 ( V_2 , V_56 ) && ! ( V_89 & V_241 ) )
continue;
F_120 ( V_2 , V_56 ) ;
F_63 ( V_2 , V_56 ) ;
if ( F_54 ( & V_61 -> V_53 [ V_56 ] ) )
V_2 -> V_49 -> V_87 ( V_2 , V_56 ) ;
if ( V_61 -> V_64 [ V_56 ] -> V_242 )
V_61 -> V_64 [ V_56 ] -> V_242 ( V_2 , V_56 ) ;
F_11 ( V_61 -> V_53 [ V_56 ] . V_181 ) ;
V_238 [ V_56 ] = V_61 -> V_94 [ V_56 ] ;
if ( ! F_194 ( V_2 , V_56 ) )
V_61 -> V_94 [ V_56 ] = NULL ;
...
F_80 ( V_2 -> V_93 ) ;
for ( V_56 = 0 ; V_56 < V_27 ; V_56 ++ )
if ( V_238 [ V_56 ] && ! F_194 ( V_2 , V_56 ) ) {
F_81 ( V_238 [ V_56 ] ) ;
V_238 [ V_56 ] -> V_244 &= ~ V_245 ;
F_82 ( & V_238 [ V_56 ] -> V_95 , 0 ) ;
F_83 ( V_238 [ V_56 ] ) ;
F_197 ( V_238 [ V_56 ] ) ;
}
if ( V_2 -> V_93 )
...
static int F_200 ( struct V_118 * V_118 , int type , int V_248 ,
unsigned int V_89 )
{
...
V_61 -> V_94 [ V_56 ] = NULL ;
F_5 ( & V_115 ) ;
V_89 = V_61 -> V_89 & F_195 ( V_239 |
V_240 ,
V_56 ) ;
V_61 -> V_89 &= ~ F_195 ( V_261 , V_56 ) ;
F_6 ( & V_115 ) ;
...
int F_208 ( struct V_1 * V_2 , int type , int V_248 ,
const struct V_262 * V_262 )
{
int error = F_209 ( V_262 -> V_263 ) ;
if ( error )
return error ;
if ( V_262 -> V_263 -> V_264 != V_2 )
error = - V_265 ;
else
error = F_200 ( F_210 ( V_262 -> V_263 ) , type ,
V_248 , V_239 |
V_240 ) ;
return error ;
}
int F_211 ( struct V_118 * V_118 , int type , int V_248 ,
unsigned int V_89 )
{
struct V_1 * V_2 = V_118 -> V_119 ;
F_94 ( V_89 & V_241 ) ;
...
return F_200 ( V_118 , type , V_248 , V_89 ) ;
}
int F_213 ( struct V_1 * V_2 , char * V_266 ,
int V_248 , int type )
{
struct V_263 * V_263 ;
int error ;
V_263 = F_214 ( V_266 , V_2 -> V_267 , strlen ( V_266 ) ) ;
if ( F_158 ( V_263 ) )
return F_159 ( V_263 ) ;
if ( F_215 ( V_263 ) ) {
error = - V_268 ;
...
error = F_209 ( V_263 ) ;
if ( ! error )
error = F_200 ( F_210 ( V_263 ) , type , V_248 ,
V_239 | V_240 ) ;
V_83:
F_216 ( V_263 ) ;
return error ;
...
static void F_220 ( struct V_30 * V_30 , struct V_275 * V_276 )
{
struct V_277 * V_278 = & V_30 -> V_138 ;
memset ( V_276 , 0 , sizeof( * V_276 ) ) ;
F_5 ( & V_134 ) ;
V_276 -> V_279 = V_278 -> V_193 ;
V_276 -> V_280 = V_278 -> V_142 ;
V_276 -> V_281 = V_278 -> V_187 ;
V_276 -> V_282 = V_278 -> V_147 ;
V_276 -> V_283 = V_278 -> V_140 + V_278 -> V_141 ;
V_276 -> V_284 = V_278 -> V_139 ;
V_276 -> V_285 = V_278 -> V_143 ;
V_276 -> V_286 = V_278 -> V_148 ;
F_6 ( & V_134 ) ;
}
...
static int F_223 ( struct V_30 * V_30 , struct V_275 * V_276 )
{
struct V_277 * V_278 = & V_30 -> V_138 ;
int V_287 = 0 , V_288 = 0 ;
struct V_179 * V_289 = & F_42 ( V_30 -> V_34 ) -> V_53 [ V_30 -> V_35 . type ] ;
...
V_199 = F_223 ( V_30 , V_276 ) ;
F_45 ( V_30 ) ;
V_83:
return V_199 ;
}
int F_225 ( struct V_1 * V_2 , struct V_310 * V_311 )
{
struct V_179 * V_312 ;
struct V_313 * V_314 ;
struct V_60 * V_61 = F_42 ( V_2 ) ;
...
if ( F_147 ( V_2 , type ) )
V_314 -> V_89 |= V_319 ;
V_314 -> V_320 = V_312 -> V_194 ;
V_314 -> V_321 = V_312 -> V_189 ;
...
int F_226 ( struct V_1 * V_2 , int type , struct V_327 * V_328 )
{
struct V_179 * V_312 ;
int V_55 = 0 ;
...
if ( ( V_328 -> V_244 & V_318 &&
V_312 -> V_181 -> V_16 != V_182 ) )
return - V_113 ;
}
F_5 ( & V_134 ) ;
if ( V_328 -> V_329 & V_306 )
V_312 -> V_194 = V_328 -> V_333 ;
if ( V_328 -> V_329 & V_308 )
V_312 -> V_189 = V_328 -> V_334 ;
if ( V_328 -> V_329 & V_332 ) {
if ( V_328 -> V_244 & V_318 )
V_312 -> V_58 |= V_183 ;
else
...
NULL ) ;
V_344 = 0 ;
V_33 = (struct V_31 * ) F_233 ( V_352 , V_344 ) ;
if ( ! V_33 )
F_234 ( L_21 ) ;
for ( V_176 = 0 ; V_176 < V_353 ; V_176 ++ ) {
V_51 = F_235 ( & V_103 . V_104 [ V_176 ] , 0 , V_354 ) ;
if ( V_51 )
F_234 ( L_22 ) ;
}
