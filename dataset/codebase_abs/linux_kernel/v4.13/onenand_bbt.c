...
{
struct V_13 * V_14 = V_10 -> V_15 ;
return F_2 ( V_10 , V_14 -> V_47 , V_11 , - 1 ) ;
}
static int F_8 ( struct V_9 * V_10 , T_2 V_39 , int V_48 )
{
struct V_13 * V_14 = V_10 -> V_15 ;
struct V_16 * V_17 = V_14 -> V_17 ;
int V_49 ;
T_1 V_50 ;
V_49 = ( int ) ( F_9 ( V_14 , V_39 ) << 1 ) ;
V_50 = ( V_17 -> V_42 [ V_49 >> 3 ] >> ( V_49 & 0x06 ) ) & 0x03 ;
F_10 ( L_4 ,
( unsigned int ) V_39 , V_49 >> 1 , V_50 ) ;
switch ( ( int ) V_50 ) {
case 0x00 : return 0 ;
case 0x01 : return 1 ;
case 0x02 : return V_48 ? 0 : 1 ;
}
return 1 ;
}
static int F_11 ( struct V_9 * V_10 , struct V_4 * V_11 )
{
struct V_13 * V_14 = V_10 -> V_15 ;
struct V_16 * V_17 = V_14 -> V_17 ;
int V_2 , V_37 = 0 ;
V_2 = V_14 -> V_29 >> ( V_14 -> V_51 + 2 ) ;
V_17 -> V_42 = F_12 ( V_2 , V_52 ) ;
if ( ! V_17 -> V_42 )
return - V_53 ;
V_17 -> V_54 = V_55 ;
V_17 -> V_30 = V_14 -> V_51 ;
...
struct V_13 * V_14 = V_10 -> V_15 ;
struct V_16 * V_17 ;
V_14 -> V_17 = F_12 ( sizeof( struct V_16 ) , V_52 ) ;
if ( ! V_14 -> V_17 )
return - V_53 ;
V_17 = V_14 -> V_17 ;
if ( ! V_17 -> V_58 )
V_17 -> V_58 = & V_59 ;
return F_11 ( V_10 , V_17 -> V_58 ) ;
}
