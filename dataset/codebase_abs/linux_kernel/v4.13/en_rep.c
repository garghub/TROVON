...
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
if ( F_91 ( V_153 ) != F_91 ( V_157 ) )
return - V_63 ;
if ( V_76 -> V_158 ) {
struct V_19 * V_20 = V_18 -> V_21 -> V_18 . V_22 ;
struct V_1 * V_159 = F_92 ( V_20 ) ;
return V_159 -> V_160 -> V_161 ( V_159 , V_153 ,
V_154 ,
V_155 , V_76 ) ;
}
if ( V_154 )
...
switch ( V_76 -> type ) {
case V_162 :
switch ( V_76 -> V_163 -> V_164 ) {
case V_165 :
return F_93 ( V_18 , V_155 , V_76 -> V_163 ) ;
case V_166 :
return F_94 ( V_18 , V_76 -> V_163 ) ;
case V_167 :
return F_95 ( V_18 , V_76 -> V_163 ) ;
}
default:
return - V_63 ;
}
...
struct V_23 * V_24 = V_18 -> V_25 ;
struct V_26 * V_27 ;
if ( ! F_97 ( V_18 -> V_21 , V_168 ) )
return false ;
V_27 = V_24 -> V_27 ;
if ( V_20 -> V_66 == V_169 &&
V_27 && V_27 -> V_33 == V_170 )
return true ;
return false ;
}
...
struct V_23 * V_24 = V_18 -> V_25 ;
struct V_26 * V_27 = V_24 -> V_27 ;
if ( V_27 && V_27 -> V_33 != V_170 )
return true ;
return false ;
}
bool F_99 ( const struct V_1 * V_2 , int V_171 )
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
switch ( V_171 ) {
case V_172 :
...
{
struct V_17 * V_18 = F_10 ( V_2 ) ;
struct V_40 * V_173 = & V_18 -> V_34 . V_42 ;
V_34 -> V_36 = V_173 -> V_36 ;
V_34 -> V_38 = V_173 -> V_38 ;
V_34 -> V_37 = V_173 -> V_37 ;
V_34 -> V_39 = V_173 -> V_39 ;
V_34 -> V_174 = V_173 -> V_175 ;
return 0 ;
}
int F_101 ( int V_171 , const struct V_1 * V_2 ,
void * V_176 )
{
switch ( V_171 ) {
case V_172 :
return F_100 ( V_2 , V_176 ) ;
}
return - V_177 ;
}
static void
...
static void F_103 ( struct V_178 * V_21 ,
struct V_179 * V_55 )
{
T_5 V_180 = F_97 ( V_21 , V_181 ) ?
V_182 :
V_183 ;
V_55 -> V_184 = V_185 ;
V_55 -> V_186 = V_187 ;
V_55 -> V_188 = V_189 ;
V_55 -> V_190 = F_97 ( V_21 , V_191 ) ;
F_104 ( V_55 , V_180 ) ;
V_55 -> V_192 = F_105 ( V_21 ) ;
V_55 -> V_56 = 1 ;
V_55 -> V_193 = V_194 ;
F_106 ( V_21 , & V_55 -> V_195 ) ;
}
...
V_83 -> V_201 = & V_202 ;
#endif
V_83 -> V_203 |= V_204 | V_205 | V_206 ;
V_83 -> V_207 |= V_205 ;
F_109 ( V_83 ) ;
}
static void F_110 ( struct V_178 * V_21 ,
struct V_1 * V_83 ,
...
V_18 -> V_25 = V_25 ;
F_111 ( & V_18 -> V_59 ) ;
F_62 ( & V_18 -> V_210 , V_211 ) ;
V_18 -> V_48 . V_55 . V_212 = V_209 -> V_213 ( V_21 ) ;
V_18 -> V_214 = V_215 ;
...
static int F_128 ( struct V_178 * V_21 )
{
#define F_129 1
return F_129 ;
}
...
if ( ! V_24 )
return - V_78 ;
V_83 = F_133 ( V_20 -> V_2 , & V_225 , V_24 ) ;
if ( ! V_83 ) {
F_6 ( L_5 ,
V_27 -> V_33 ) ;
F_21 ( V_24 ) ;
...
{
struct V_178 * V_21 = V_18 -> V_21 ;
struct V_19 * V_20 = V_21 -> V_18 . V_22 ;
int V_229 = F_141 ( V_21 ) ;
int V_33 ;
T_5 V_230 [ V_73 ] ;
F_142 ( V_21 , 0 , V_230 ) ;
for ( V_33 = 1 ; V_33 < V_229 ; V_33 ++ ) {
struct V_26 V_27 ;
V_27 . V_231 = F_132 ;
V_27 . V_232 = F_138 ;
V_27 . V_33 = V_33 ;
F_17 ( V_27 . V_74 , V_230 ) ;
