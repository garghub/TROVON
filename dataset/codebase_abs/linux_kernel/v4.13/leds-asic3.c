...
{
struct V_30 * V_31 = F_10 ( & V_6 -> V_7 ) ;
int V_32 ;
V_32 = F_11 ( V_6 ) ;
if ( V_32 < 0 )
return V_32 ;
V_31 -> V_2 = F_12 ( & V_6 -> V_7 , sizeof( struct V_1 ) ,
V_33 ) ;
if ( ! V_31 -> V_2 ) {
V_32 = - V_34 ;
goto V_35;
}
V_31 -> V_2 -> V_36 = V_31 -> V_36 ;
V_31 -> V_2 -> V_37 = V_38 ;
V_31 -> V_2 -> F_1 = F_1 ;
V_31 -> V_2 -> F_6 = F_6 ;
V_31 -> V_2 -> V_39 = V_31 -> V_39 ;
V_32 = F_13 ( & V_6 -> V_7 , V_31 -> V_2 ) ;
if ( V_32 < 0 )
goto V_35;
return 0 ;
V_35:
...
static int F_17 ( struct V_40 * V_7 )
{
