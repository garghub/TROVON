...
V_6 -> V_104 = F_52 ( V_113 , sizeof( * V_6 -> V_104 ) , V_38 ) ;
if ( ! V_6 -> V_104 ) {
F_26 ( & V_3 -> V_77 ) ;
F_51 ( & V_3 -> V_126 ) ;
return - V_39 ;
...
V_6 -> V_102 = F_52 ( V_113 , sizeof( * V_6 -> V_102 ) , V_38 ) ;
if ( ! V_6 -> V_102 ) {
F_9 ( V_6 -> V_104 ) ;
F_26 ( & V_3 -> V_77 ) ;
F_51 ( & V_3 -> V_126 ) ;
...
V_139 = F_55 ( V_108 -> V_137 + ( V_113 << V_116 ) ,
sizeof( * V_108 -> V_141 ) ,
V_38 ) ;
if ( ! V_139 ) {
F_9 ( V_6 -> V_104 ) ;
...
void * V_82 , int * V_151 ,
int (* F_60)( void * , int , struct V_100 * ) )
{
struct V_107 * V_108 = V_3 -> V_108 ;
int V_93 ;
int V_113 ;
...
if ( * V_151 >= V_113 ) {
for ( V_93 = 0 , V_113 = 0 ; V_93 < V_123 + 1 ; V_93 ++ ) {
struct V_100 * V_152 = & V_108 -> V_127 [ V_93 ] ;
if ( V_152 -> V_103 ) {
if ( F_60 ( V_82 , V_113 , V_152 ) < 0 )
return - V_153 ;
F_10 ( L_23 ,
V_93 ,
...
static int F_62 ( void * V_82 , int V_113 , struct V_100 * V_152 )
{
struct V_156 * V_99 = V_82 ;
struct V_106 T_3 * V_157 = & V_99 -> V_36 [ V_113 ] ;
struct V_106 V_158 = { . V_113 = V_152 -> V_103 ,
. V_32 = V_152 -> V_128 ,
. V_154 = V_152 -> V_154 ,
. V_155 = V_152 -> V_155 } ;
return F_63 ( V_157 , & V_158 , F_64 ( struct V_106 , V_9 ) ) ;
}
int F_65 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
struct V_156 * V_99 = V_82 ;
return F_59 ( V_3 , V_82 , & V_99 -> V_113 , F_62 ) ;
}
...
int F_67 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
struct V_107 * V_108 = V_3 -> V_108 ;
struct V_159 * V_99 = V_82 ;
int V_93 ;
int V_92 ;
struct V_110 * V_111 ;
if ( ! F_30 ( V_3 , V_89 ) )
...
if ( F_68 ( & V_92 , & V_99 -> V_36 [ V_93 ] , sizeof( V_92 ) ) )
return - V_153 ;
...
int F_72 ( struct V_2 * V_3 , void * V_82 , int * V_151 ,
void T_3 * * V_158 ,
int (* F_60)( void * , int , unsigned long ,
struct V_110 * ) ,
struct V_83 * V_84 )
{
struct V_107 * V_108 = V_3 -> V_108 ;
...
V_73 = F_73 ( V_84 -> V_166 , 0 , V_5 -> V_32 ,
V_167 | V_168 ,
V_169 ,
V_163 ) ;
} else {
V_73 = F_73 ( V_84 -> V_166 , 0 , V_108 -> V_118 ,
V_167 | V_168 ,
V_169 , 0 ) ;
}
if ( V_73 > - 1024UL ) {
V_161 = ( signed long ) V_73 ;
goto V_165;
}
* V_158 = ( void T_3 * ) V_73 ;
for ( V_93 = 0 ; V_93 < V_108 -> V_103 ; V_93 ++ ) {
if ( F_60 ( V_82 , V_93 , V_73 , V_108 -> V_104 [ V_93 ] ) < 0 ) {
V_161 = - V_153 ;
goto V_165;
}
}
...
V_165:
* V_151 = V_108 -> V_103 ;
F_10 ( L_28 , * V_151 , V_161 ) ;
return V_161 ;
}
static int F_74 ( void * V_82 , int V_92 , unsigned long V_73 ,
struct V_110 * V_111 )
{
struct V_170 * V_99 = V_82 ;
unsigned long V_131 = V_73 + V_111 -> V_13 ;
if ( F_63 ( & V_99 -> V_36 [ V_92 ] . V_92 , & V_111 -> V_92 ,
sizeof( V_99 -> V_36 [ 0 ] . V_92 ) ) )
return - V_153 ;
if ( F_63 ( & V_99 -> V_36 [ V_92 ] . V_117 , & V_111 -> V_117 ,
sizeof( V_99 -> V_36 [ 0 ] . V_117 ) ) )
return - V_153 ;
if ( F_75 ( & V_99 -> V_36 [ V_92 ] . V_129 , sizeof( int ) ) )
return - V_153 ;
if ( F_63 ( & V_99 -> V_36 [ V_92 ] . V_131 , & V_131 ,
sizeof( V_131 ) ) )
return - V_153 ;
return 0 ;
}
int F_76 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
struct V_170 * V_99 = V_82 ;
return F_72 ( V_3 , V_82 , & V_99 -> V_113 ,
& V_99 -> V_73 , F_74 ,
V_84 ) ;
}
int F_77 ( struct V_2 * V_3 , void * V_82 ,
struct V_83 * V_84 )
{
if ( ! F_30 ( V_3 , V_89 ) )
return - V_27 ;
if ( V_3 -> V_136 -> V_171 )
return V_3 -> V_136 -> V_171 ( V_3 , V_82 , V_84 ) ;
else
return - V_27 ;
}
struct V_4 * F_78 ( struct V_2 * V_3 )
{
struct V_1 * V_6 ;
F_2 (entry, &dev->maplist, head) {
