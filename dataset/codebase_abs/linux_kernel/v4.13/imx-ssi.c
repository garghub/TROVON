...
if ( V_8 -> V_135 < 0 ) {
F_34 ( & V_125 -> V_99 , L_2 , V_8 -> V_135 ) ;
return V_8 -> V_135 ;
}
V_8 -> V_136 = F_35 ( & V_125 -> V_99 , NULL ) ;
if ( F_36 ( V_8 -> V_136 ) ) {
V_131 = F_37 ( V_8 -> V_136 ) ;
F_34 ( & V_125 -> V_99 , L_3 ,
V_131 ) ;
goto V_137;
}
