...
if ( V_14 != 0 )
return V_14 ;
V_12 = ( ( T_3 ) V_11 [ 5 ] << 40 ) | ( ( T_3 ) V_11 [ 4 ] << 32 ) |
( ( T_3 ) V_11 [ 3 ] << 24 ) | ( ( T_3 ) V_11 [ 2 ] << 16 ) |
( ( T_3 ) V_11 [ 1 ] << 8 ) | ( T_3 ) V_11 [ 0 ] ;
time = V_12 / ( T_3 ) ( V_13 * 2 ) ;
}
F_8 ( time , V_18 ) ;
return F_9 ( V_18 ) ;
}
...
if ( V_14 )
return V_14 ;
V_12 = ( ( T_3 ) V_11 [ 3 ] << 40 ) | ( ( T_3 ) V_11 [ 2 ] << 32 ) |
( ( T_3 ) V_11 [ 1 ] << 24 ) | ( ( T_3 ) V_11 [ 0 ] << 16 ) ;
time = V_12 / ( T_3 ) ( V_13 * 2 ) ;
F_8 ( time , & V_22 -> time ) ;
...
static int T_4 F_14 ( struct V_29 * V_30 )
{
int V_14 ;
T_2 V_31 ;
struct V_32 * V_33 ;
