...
V_117 = & F_121 ( V_116 ) ;
F_122 ( & V_117 -> V_121 , V_118 ) ;
if ( F_123 ( & V_117 -> V_122 , V_120 ) )
F_124 ( F_125 () , & V_117 -> V_123 ) ;
else
F_12 ( L_24 ,
V_20 ) ;
F_126 ( & V_117 -> V_121 , V_118 ) ;
F_127 ( V_116 ) ;
}
static void F_128 ( struct V_124 * V_123 )
{
struct V_116 * V_117 ;
...
for (; ; ) {
F_122 ( & V_117 -> V_121 , V_118 ) ;
V_125 = F_130 ( & V_117 -> V_122 , & V_120 ) ;
F_126 ( & V_117 -> V_121 , V_118 ) ;
if ( ! V_125 )
break;
if ( V_120 . V_21 & V_126 )
F_131 ( F_104 ( V_120 . V_20 ) , V_120 . V_21 ) ;
else
...
int V_127 ;
F_133 (cpu) {
V_117 = & F_134 ( V_116 , V_127 ) ;
F_135 ( & V_117 -> V_121 ) ;
F_136 ( V_117 -> V_122 ) ;
F_137 ( & V_117 -> V_123 , F_128 ) ;
}
return 0 ;
}
...
F_79 ( V_1 ) ;
F_110 ( V_1 ) ;
if ( V_128 && ! ( V_20 == F_141 ( 0 ) && F_85 ( V_2 ) == 1 ) )
F_110 ( V_1 ) ;
return 0 ;
}
static struct V_1 * F_142 ( struct V_1 * V_2 , unsigned long V_132 , int * * V_133 )
{
int V_134 = F_27 ( V_2 ) ;
return F_143 ( V_2 , V_134 , & V_135 [ V_136 ] ) ;
}
static int F_144 ( struct V_1 * V_2 , unsigned long V_20 , int V_21 )
{
int V_24 ;
if ( V_21 & V_104 )
return 1 ;
...
static int F_145 ( struct V_1 * V_1 , unsigned long V_20 , int V_21 )
{
int V_24 = F_144 ( V_1 , V_20 , V_21 ) ;
if ( V_24 == 1 && ! F_20 ( V_1 ) &&
! F_22 ( V_1 ) && ! F_146 ( V_1 ) ) {
F_110 ( V_1 ) ;
F_19 ( V_1 , 1 ) ;
V_24 = F_144 ( V_1 , V_20 , 0 ) ;
if ( V_24 == 1 && ! F_22 ( V_1 ) ) {
F_110 ( V_1 ) ;
F_18 ( L_35 ,
...
static int F_147 ( struct V_1 * V_1 , int V_21 )
{
int V_24 ;
...
F_79 ( V_78 ) ;
V_24 = F_148 ( V_78 , & V_138 ) ;
F_110 ( V_78 ) ;
if ( ! V_24 ) {
F_18 ( L_37 , V_20 ) ;
return - V_88 ;
}
V_24 = F_149 ( & V_138 , F_142 , NULL , V_139 ,
V_140 , V_141 ) ;
if ( V_24 ) {
F_18 ( L_38 ,
