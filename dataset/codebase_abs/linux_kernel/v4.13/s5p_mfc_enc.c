...
if ( V_150 -> type == V_117 ) {
V_124 = F_50 ( & V_18 -> V_125 , V_150 , V_75 -> V_160 & V_161 ) ;
} else if ( V_150 -> type == V_106 ) {
V_124 = F_50 ( & V_18 -> V_127 , V_150 , V_75 -> V_160 & V_161 ) ;
if ( V_124 == 0 && V_18 -> V_21 == V_162
&& F_6 ( & V_18 -> V_127 . V_163 ) )
F_51 ( & V_18 -> V_164 , & V_158 ) ;
} else {
V_124 = - V_101 ;
}
return V_124 ;
...
struct V_17 * V_18 = F_34 ( V_76 ) ;
if ( V_166 -> type == V_117 )
return F_53 ( & V_18 -> V_125 , V_166 ) ;
if ( V_166 -> type == V_106 )
return F_53 ( & V_18 -> V_127 , V_166 ) ;
return - V_101 ;
}
...
static inline int F_58 ( enum V_168 V_169 )
{
...
static inline int F_59 ( enum V_171 V_169 )
{
...
static inline int F_60 ( enum V_173 V_174 )
{
...
V_44 -> V_211 . V_212 . V_232 = F_58 ( V_177 -> V_180 ) ;
...
V_44 -> V_211 . V_234 . V_232 = F_59 ( V_177 -> V_180 ) ;
...
break;
case V_279 :
V_44 -> V_211 . V_212 . F_60 = F_60 ( V_177 -> V_180 ) ;
break;
case V_280 :
...
static int F_70 ( struct V_335 * V_164 ,
const struct V_336 * V_337 )
{
switch ( V_337 -> type ) {
case V_159 :
return F_71 ( V_164 , V_337 , 2 , NULL ) ;
default:
return - V_101 ;
}
}
static int F_72 ( struct V_1 * V_9 , struct V_338 * V_339 )
{
int V_5 ;
if ( ! V_9 )
return - V_101 ;
...
static int F_73 ( struct V_341 * V_342 ,
...
if ( F_18 ( V_34 ) ) {
V_347 [ 0 ] = V_18 -> V_34 -> V_351 [ V_352 ] ;
V_347 [ 1 ] = V_18 -> V_34 -> V_351 [ V_352 ] ;
} else {
V_347 [ 0 ] = V_18 -> V_34 -> V_351 [ V_354 ] ;
V_347 [ 1 ] = V_18 -> V_34 -> V_351 [ V_354 ] ;
}
} else {
...
static int F_74 ( struct V_338 * V_339 )
{
struct V_355 * V_356 = F_75 ( V_339 ) ;
struct V_341 * V_342 = V_339 -> V_341 ;
struct V_17 * V_18 = F_34 ( V_342 -> V_348 ) ;
unsigned int V_5 ;
int V_124 ;
if ( V_342 -> type == V_106 ) {
V_124 = F_72 ( V_18 -> V_111 , V_339 ) ;
if ( V_124 < 0 )
return V_124 ;
V_5 = V_339 -> V_99 ;
V_18 -> V_357 [ V_5 ] . V_39 = V_356 ;
V_18 -> V_357 [ V_5 ] . V_358 . V_359 =
F_12 ( V_339 , 0 ) ;
V_18 -> V_133 ++ ;
} else if ( V_342 -> type == V_117 ) {
V_124 = F_72 ( V_18 -> V_120 , V_339 ) ;
if ( V_124 < 0 )
return V_124 ;
V_5 = V_339 -> V_99 ;
V_18 -> V_360 [ V_5 ] . V_39 = V_356 ;
V_18 -> V_360 [ V_5 ] . V_358 . V_361 . V_362 =
F_12 ( V_339 , 0 ) ;
V_18 -> V_360 [ V_5 ] . V_358 . V_361 . V_363 =
F_12 ( V_339 , 1 ) ;
V_18 -> V_137 ++ ;
} else {
F_35 ( L_43 , V_342 -> type ) ;
...
static int F_76 ( struct V_338 * V_339 )
{
struct V_341 * V_342 = V_339 -> V_341 ;
struct V_17 * V_18 = F_34 ( V_342 -> V_348 ) ;
int V_124 ;
...
static int F_77 ( struct V_341 * V_364 , unsigned int V_144 )
{
struct V_17 * V_18 = F_34 ( V_364 -> V_348 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
if ( F_18 ( V_34 ) &&
( V_364 -> type == V_106 ) ) {
if ( ( V_18 -> V_21 == V_22 ) &&
( V_34 -> V_365 == V_18 -> V_366 ) && V_34 -> V_367 ) {
F_64 ( V_18 ,
V_318 ,
0 ) ;
}
...
static void F_78 ( struct V_341 * V_364 )
{
unsigned long V_67 ;
struct V_17 * V_18 = F_34 ( V_364 -> V_348 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
...
F_68 ( & V_34 -> V_332 , V_67 ) ;
if ( V_364 -> type == V_106 ) {
F_79 ( & V_18 -> V_38 , & V_18 -> V_127 ) ;
F_10 ( & V_18 -> V_38 ) ;
V_18 -> V_20 = 0 ;
}
if ( V_364 -> type == V_117 ) {
F_5 ( V_18 ) ;
F_79 ( & V_18 -> V_32 , & V_18 -> V_125 ) ;
F_10 ( & V_18 -> V_32 ) ;
V_18 -> V_19 = 0 ;
}
F_69 ( & V_34 -> V_332 , V_67 ) ;
}
static void F_80 ( struct V_338 * V_339 )
{
struct V_341 * V_342 = V_339 -> V_341 ;
struct V_17 * V_18 = F_34 ( V_342 -> V_348 ) ;
struct V_33 * V_34 = V_18 -> V_34 ;
...
if ( V_342 -> type == V_106 ) {
V_370 = & V_18 -> V_357 [ V_339 -> V_99 ] ;
V_370 -> V_67 &= ~ V_68 ;
F_68 ( & V_34 -> V_332 , V_67 ) ;
F_9 ( & V_370 -> V_30 , & V_18 -> V_38 ) ;
V_18 -> V_20 ++ ;
F_69 ( & V_34 -> V_332 , V_67 ) ;
} else if ( V_342 -> type == V_117 ) {
V_370 = & V_18 -> V_360 [ V_339 -> V_99 ] ;
V_370 -> V_67 &= ~ V_68 ;
F_68 ( & V_34 -> V_332 , V_67 ) ;
F_9 ( & V_370 -> V_30 , & V_18 -> V_32 ) ;
V_18 -> V_19 ++ ;
F_69 ( & V_34 -> V_332 , V_67 ) ;
} else {
...
const struct V_372 * F_81 ( void )
{
return & V_373 ;
}
struct V_374 * F_82 ( void )
{
return & V_375 ;
}
const struct V_376 * F_83 ( void )
{
return & V_377 ;
}
...
struct V_378 V_379 ;
int V_5 ;
F_85 ( & V_18 -> V_380 , V_381 ) ;
if ( V_18 -> V_380 . error ) {
F_35 ( L_51 ) ;
return V_18 -> V_380 . error ;
}
for ( V_5 = 0 ; V_5 < V_381 ; V_5 ++ ) {
if ( F_86 ( V_382 [ V_5 ] . V_12 ) ) {
memset ( & V_379 , 0 , sizeof( struct V_378 ) ) ;
V_379 . V_383 = & V_384 ;
V_379 . V_12 = V_382 [ V_5 ] . V_12 ;
V_379 . V_385 = V_382 [ V_5 ] . V_386 ;
V_379 . V_387 = V_382 [ V_5 ] . V_388 ;
V_379 . V_389 = V_382 [ V_5 ] . V_390 ;
V_379 . V_83 = V_382 [ V_5 ] . V_83 ;
V_379 . type = V_382 [ V_5 ] . type ;
V_379 . V_67 = 0 ;
if ( V_379 . type == V_391 ) {
V_379 . V_392 = 0 ;
V_379 . V_393 = V_379 . V_393 ;
V_379 . V_394 = F_2 ( V_379 . V_12 ) ;
} else {
V_379 . V_392 = V_382 [ V_5 ] . V_392 ;
V_379 . V_393 = 0 ;
}
V_18 -> V_395 [ V_5 ] = F_87 ( & V_18 -> V_380 ,
& V_379 , NULL ) ;
} else {
if ( ( V_382 [ V_5 ] . type == V_391 ) ||
( V_382 [ V_5 ] . type ==
V_396 ) ) {
V_18 -> V_395 [ V_5 ] = F_88 (
& V_18 -> V_380 ,
& V_384 , V_382 [ V_5 ] . V_12 ,
V_382 [ V_5 ] . V_388 , 0 ,
V_382 [ V_5 ] . V_390 ) ;
} else {
V_18 -> V_395 [ V_5 ] = F_89 (
...
& V_384 , V_382 [ V_5 ] . V_12 ,
V_382 [ V_5 ] . V_386 ,
V_382 [ V_5 ] . V_388 , V_382 [ V_5 ] . V_392 ,
V_382 [ V_5 ] . V_390 ) ;
}
}
if ( V_18 -> V_380 . error ) {
...
if ( V_382 [ V_5 ] . V_397 && V_18 -> V_395 [ V_5 ] )
V_18 -> V_395 [ V_5 ] -> V_67 |= V_398 ;
}
F_90 ( & V_18 -> V_380 ) ;
return 0 ;
}
