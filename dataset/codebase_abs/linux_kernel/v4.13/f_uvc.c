...
if ( V_120 -> V_124 &&
( V_120 -> V_123 % 1024 ) != 0 ) {
V_120 -> V_123 = F_34 ( V_120 -> V_123 , 1024 ) ;
F_6 ( V_28 , L_10 ,
V_120 -> V_123 ) ;
}
if ( V_120 -> V_123 <= 1024 ) {
...
V_8 -> V_147 -> V_151 = F_2 ;
V_8 -> V_147 -> V_9 = V_8 ;
if ( F_45 ( & V_28 -> V_46 -> V_152 , & V_8 -> V_57 ) ) {
F_46 ( V_153 L_13 ) ;
goto error;
}
V_43 = F_47 ( & V_8 -> V_40 ) ;
...
static void F_52 ( struct V_154 * V_21 )
{
struct V_119 * V_120 = F_31 ( V_21 ) ;
F_53 ( & V_120 -> V_66 ) ;
F_50 ( V_120 ) ;
}
static struct V_154 * F_54 ( void )
{
struct V_119 * V_120 ;
struct V_155 * V_156 ;
struct V_157 * V_158 ;
...
static struct V_20 * F_64 ( struct V_154 * V_121 )
{
struct V_7 * V_8 ;
struct V_119 * V_120 ;
struct V_76 * * V_199 ;
