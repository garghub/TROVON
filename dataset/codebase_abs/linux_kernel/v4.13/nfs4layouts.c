...
char * V_174 [ 8 ] ;
int error ;
F_90 ( (struct V_175 * ) & V_61 -> V_176 , V_170 , sizeof( V_170 ) ) ;
F_91 ( V_177
L_6
L_7 , V_170 ) ;
V_174 [ 0 ] = ( char * ) V_172 ;
...
return 1 ;
V_189 = F_95 () ;
V_188 = F_46 ( V_59 -> V_62 . V_63 -> V_194 , V_121 ) ;
