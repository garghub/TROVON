...
T_6 F_126 ( T_7 V_194 , void * V_181 , T_5 V_182 , T_6 V_40 ,
int V_27 , int V_38 )
{
T_2 V_100 ;
T_6 V_54 ;
...
F_114 ( V_90 . V_91 . V_92 ,
L_11 ,
V_194 , V_181 , V_182 , V_40 , V_27 , V_38 ) ;
if ( V_38 & ~ ( V_156 | V_37 ) )
return - V_188 ;
if ( ( V_38 & V_156 ) &&
( ( F_49 ( V_40 , V_8 ) != V_40 ) ||
...
int
F_127 ( T_7 V_194 , T_6 V_40 , T_5 V_182 )
{
struct V_1 * V_2 = (struct V_1 * ) V_194 ;
struct V_39 * V_42 = NULL ;
struct V_171 V_172 ;
