...
static struct V_1 * F_35 ( struct V_1 * V_1 ,
struct V_8 * V_9 ,
unsigned long V_2 ,
int V_42 )
{
...
int F_40 ( const struct V_11 * V_11 , int V_57 )
{
...
V_66 . V_67 . V_68 = V_15 -> V_69 ;
V_66 . V_67 . type = V_70 ;
V_1 = F_39 ( V_41 , V_9 , V_15 , 0 ) ;
if ( ! V_1 )
return - V_63 ;
V_66 . V_71 = V_1 -> V_72 . V_71 ;
memcpy ( V_66 . V_73 , V_1 -> V_72 . V_73 , V_66 . V_71 ) ;
V_66 . V_73 [ V_66 . V_71 ] = '\0' ;
F_17 ( V_1 ) ;
if ( F_46 ( V_65 , & V_66 , sizeof( struct V_64 ) ) )
V_30 = - V_74 ;
F_14 ( & V_15 -> V_46 ) ;
V_5 = F_2 ( V_1 ) ;
V_5 -> V_6 = V_7 ;
...
struct V_14 * V_15 , int V_75 )
{
struct V_1 * V_1 ;
int V_30 = - V_63 ;
if ( F_49 ( V_15 -> type ) )
V_1 = F_32 ( V_41 , V_9 , V_15 , V_75 ) ;
else
V_1 = F_39 ( V_41 , V_9 , V_15 , V_75 ) ;
if ( V_1 ) {
struct V_4 * V_5 = F_2 ( V_1 ) ;
const struct V_11 V_11 = { . V_9 = V_9 , . V_1 = V_1 } ;
V_30 = F_42 ( V_15 , & V_11 , V_76 ) ;
F_14 ( & V_15 -> V_46 ) ;
V_5 -> V_6 = V_7 ;
V_5 -> V_47 &= ~ ( V_51 | V_50 ) ;
F_47 ( & V_5 -> V_52 ) ;
