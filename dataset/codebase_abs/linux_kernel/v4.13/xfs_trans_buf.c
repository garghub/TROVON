...
ASSERT ( V_25 -> V_28 == V_3 ) ;
ASSERT ( V_27 != NULL ) ;
ASSERT ( V_69 <= V_70 && V_70 < F_42 ( V_25 -> V_23 ) ) ;
ASSERT ( V_25 -> V_71 == NULL ||
V_25 -> V_71 == V_72 ) ;
V_25 -> V_40 |= V_41 ;
ASSERT ( F_15 ( & V_27 -> V_38 ) > 0 ) ;
V_25 -> V_71 = V_72 ;
