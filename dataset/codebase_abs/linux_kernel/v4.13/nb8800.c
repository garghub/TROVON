...
V_156 = F_95 ( V_155 , F_96 ( V_2 -> V_159 ) ) ;
F_5 ( V_2 , V_160 , V_156 ) ;
F_5 ( V_2 , V_161 , V_154 ) ;
F_11 ( V_2 , V_162 , V_149 , V_153 ) ;
}
static void F_97 ( struct V_21 * V_22 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
struct V_163 * V_158 = V_22 -> V_158 ;
T_2 V_164 ;
if ( V_2 -> V_165 ) {
if ( ! V_158 || ! V_158 -> V_166 )
return;
V_2 -> V_167 = V_158 -> V_168 ;
V_2 -> V_169 = V_158 -> V_168 ^ V_158 -> V_170 ;
}
F_13 ( V_2 , V_28 , V_171 , V_2 -> V_167 ) ;
V_164 = F_3 ( V_2 , V_31 ) ;
if ( ! ! ( V_164 & V_172 ) == V_2 -> V_169 )
return;
if ( F_98 ( V_22 ) ) {
F_99 ( & V_2 -> V_34 ) ;
F_100 ( V_22 ) ;
F_101 ( V_22 ) ;
F_16 ( V_2 , V_31 , V_172 , V_2 -> V_169 ) ;
F_33 ( V_22 ) ;
F_102 ( V_22 ) ;
F_103 ( & V_2 -> V_34 ) ;
} else {
...
int V_173 = 0 ;
if ( V_158 -> V_166 ) {
if ( V_158 -> V_147 != V_2 -> V_147 ) {
V_2 -> V_147 = V_158 -> V_147 ;
V_173 = 1 ;
}
if ( V_158 -> V_157 != V_2 -> V_157 ) {
V_2 -> V_157 = V_158 -> V_157 ;
V_173 = 1 ;
}
if ( V_173 )
F_93 ( V_22 ) ;
...
if ( V_158 -> V_166 != V_2 -> V_166 ) {
V_2 -> V_166 = V_158 -> V_166 ;
V_173 = 1 ;
}
if ( V_173 )
F_105 ( V_158 ) ;
...
struct V_1 * V_2 = F_29 ( V_22 ) ;
int V_33 ;
for ( V_33 = 0 ; V_33 < V_174 ; V_33 ++ )
F_5 ( V_2 , F_107 ( V_33 ) , V_22 -> V_175 [ V_33 ] ) ;
for ( V_33 = 0 ; V_33 < V_174 ; V_33 ++ )
F_5 ( V_2 , F_108 ( V_33 ) , V_22 -> V_175 [ V_33 ] ) ;
}
static int F_109 ( struct V_21 * V_22 , void * V_176 )
{
struct V_177 * V_178 = V_176 ;
if ( F_98 ( V_22 ) )
return - V_179 ;
F_110 ( V_22 -> V_175 , V_178 -> V_180 ) ;
F_106 ( V_22 ) ;
return 0 ;
}
static void F_111 ( struct V_21 * V_22 , int V_5 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
F_5 ( V_2 , V_181 , V_5 ) ;
F_112 ( V_2 -> V_4 + V_181 , V_5 , ! V_5 ,
1 , 1000 ) ;
}
...
F_114 (ha, dev) {
for ( V_33 = 0 ; V_33 < V_174 ; V_33 ++ )
F_5 ( V_2 , F_115 ( V_33 ) , V_183 -> V_176 [ V_33 ] ) ;
F_111 ( V_22 , 0xff ) ;
}
}
...
if ( V_2 -> V_37 ) {
F_119 ( V_22 -> V_22 . V_187 , V_188 , V_2 -> V_37 ,
V_2 -> V_189 ) ;
V_2 -> V_37 = NULL ;
}
if ( V_2 -> V_112 ) {
F_119 ( V_22 -> V_22 . V_187 , V_190 , V_2 -> V_112 ,
V_2 -> V_191 ) ;
V_2 -> V_112 = NULL ;
}
}
...
unsigned int V_33 ;
for ( V_33 = 0 ; V_33 < V_78 ; V_33 ++ ) {
T_4 V_192 = V_2 -> V_189 + V_33 * sizeof( * V_36 ) ;
V_36 = & V_2 -> V_37 [ V_33 ] ;
V_36 -> V_49 . V_114 = V_192 + sizeof( * V_36 ) ;
V_36 -> V_49 . V_193 =
V_192 + F_75 ( struct V_35 , V_61 ) ;
V_36 -> V_49 . V_83 = V_2 -> V_194 ;
V_36 -> V_61 = 0 ;
}
V_36 -> V_49 . V_114 = V_2 -> V_189 ;
V_36 -> V_49 . V_83 |= V_84 ;
V_2 -> V_74 = V_78 - 1 ;
for ( V_33 = 0 ; V_33 < V_96 ; V_33 ++ ) {
...
V_99 = & V_2 -> V_112 [ V_33 ] ;
V_99 -> V_49 [ 0 ] . V_193 = V_195 ;
V_99 -> V_49 [ 1 ] . V_193 = V_195 ;
V_99 -> V_61 = 0 ;
}
V_2 -> V_111 = 0 ;
V_2 -> V_91 = 0 ;
V_2 -> V_126 = 0 ;
F_121 ( & V_2 -> V_103 , V_96 ) ;
F_9 ( V_2 , V_196 , V_2 -> V_189 ) ;
F_60 () ;
}
static int F_122 ( struct V_21 * V_22 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
unsigned int V_197 = V_78 ;
unsigned int V_198 = V_96 ;
unsigned int V_33 ;
int V_16 ;
V_2 -> V_37 = F_123 ( V_22 -> V_22 . V_187 , V_188 ,
& V_2 -> V_189 , V_199 ) ;
if ( ! V_2 -> V_37 )
goto V_200;
V_2 -> V_40 = F_124 ( V_197 , sizeof( * V_2 -> V_40 ) , V_199 ) ;
if ( ! V_2 -> V_40 )
goto V_200;
for ( V_33 = 0 ; V_33 < V_197 ; V_33 ++ ) {
V_16 = F_34 ( V_22 , V_33 , false ) ;
if ( V_16 )
goto V_200;
}
V_2 -> V_112 = F_123 ( V_22 -> V_22 . V_187 , V_190 ,
& V_2 -> V_191 , V_199 ) ;
if ( ! V_2 -> V_112 )
goto V_200;
V_2 -> V_90 = F_124 ( V_198 , sizeof( * V_2 -> V_90 ) , V_199 ) ;
if ( ! V_2 -> V_90 )
goto V_200;
for ( V_33 = 0 ; V_33 < V_198 ; V_33 ++ )
V_2 -> V_90 [ V_33 ] . V_94 =
V_2 -> V_191 + V_33 * sizeof( struct V_98 ) ;
F_120 ( V_22 ) ;
return 0 ;
V_200:
F_116 ( V_22 ) ;
...
F_32 ( V_22 , false ) ;
F_14 ( V_2 , V_162 , V_203 ) ;
do {
F_9 ( V_2 , V_93 , V_88 -> V_94 ) ;
F_60 () ;
F_9 ( V_2 , V_24 , V_202 | V_25 ) ;
V_16 = F_20 ( V_2 -> V_4 + V_31 ,
V_164 , ! ( V_164 & V_32 ) ,
1000 , 100000 ) ;
} while ( V_16 && -- V_201 );
F_32 ( V_22 , true ) ;
F_15 ( V_2 , V_162 , V_203 ) ;
F_120 ( V_22 ) ;
return V_201 ? 0 : - V_204 ;
}
...
if ( V_16 )
return V_16 ;
V_16 = F_127 ( V_22 -> V_130 , F_89 , 0 , F_128 ( & V_22 -> V_22 ) , V_22 ) ;
if ( V_16 )
goto V_210;
F_31 ( V_22 , true ) ;
F_28 ( V_22 , true ) ;
V_158 = F_129 ( V_22 , V_2 -> V_211 ,
F_104 , 0 ,
V_2 -> V_212 ) ;
if ( ! V_158 ) {
V_16 = - V_213 ;
...
static int F_137 ( struct V_21 * V_22 , struct V_215 * V_216 , int V_15 )
{
return F_138 ( V_22 -> V_158 , V_216 , V_15 ) ;
}
static void F_139 ( struct V_21 * V_22 ,
struct V_217 * V_218 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
V_218 -> V_219 = V_2 -> V_165 ;
V_218 -> V_220 = V_2 -> V_167 ;
V_218 -> V_221 = V_2 -> V_169 ;
}
...
struct V_1 * V_2 = F_29 ( V_22 ) ;
struct V_163 * V_158 = V_22 -> V_158 ;
V_2 -> V_165 = V_218 -> V_219 ;
V_2 -> V_167 = V_218 -> V_220 ;
V_2 -> V_169 = V_218 -> V_221 ;
F_125 ( V_22 ) ;
if ( ! V_2 -> V_165 )
F_97 ( V_22 ) ;
else if ( V_158 )
...
static int F_142 ( struct V_21 * V_22 , int V_222 )
{
if ( V_222 == V_223 )
return V_224 ;
return - V_225 ;
}
static void F_143 ( struct V_21 * V_22 , T_2 V_222 , T_1 * V_113 )
{
if ( V_222 == V_223 )
memcpy ( V_113 , & V_226 , sizeof( V_226 ) ) ;
}
static T_2 F_144 ( struct V_21 * V_22 , int V_227 )
{
struct V_1 * V_2 = F_29 ( V_22 ) ;
F_5 ( V_2 , V_228 , V_227 ) ;
return F_3 ( V_2 , V_229 ) ;
}
static void F_145 ( struct V_21 * V_22 ,
struct V_230 * V_231 , T_6 * V_232 )
{
unsigned int V_33 ;
T_2 V_233 , V_234 ;
for ( V_33 = 0 ; V_33 < V_224 / 2 ; V_33 ++ ) {
V_233 = F_144 ( V_22 , V_33 ) ;
V_234 = F_144 ( V_22 , V_33 | 0x80 ) ;
V_232 [ V_33 ] = V_233 ;
V_232 [ V_33 + V_224 / 2 ] = V_234 ;
}
}
...
V_5 |= F_150 ( 2 ) ;
F_9 ( V_2 , V_31 , V_5 ) ;
V_2 -> V_86 = F_96 ( V_2 -> V_159 ) / 20000 ;
V_2 -> V_143 = F_96 ( V_2 -> V_159 ) / 100 ;
F_9 ( V_2 , V_85 , V_2 -> V_86 ) ;
V_2 -> V_194 = V_42 | F_76 ( 2 ) | V_115 | V_116 ;
V_5 = 100000 / 512 ;
F_5 ( V_2 , V_254 , V_5 >> 8 ) ;
F_5 ( V_2 , V_255 , V_5 & 0xff ) ;
V_2 -> V_165 = true ;
V_2 -> V_167 = true ;
V_2 -> V_169 = true ;
F_111 ( V_22 , 0 ) ;
...
F_5 ( V_2 , V_268 , 1 ) ;
F_60 () ;
V_267 = F_95 ( F_96 ( V_2 -> V_159 ) , 2 * V_269 ) ;
F_7 ( V_2 , V_270 , V_267 ) ;
return 0 ;
}
...
int V_130 ;
int V_132 ;
V_275 = F_158 ( V_281 , & V_273 -> V_22 ) ;
if ( V_275 )
V_277 = V_275 -> V_46 ;
V_130 = F_159 ( V_273 , 0 ) ;
if ( V_130 <= 0 ) {
F_152 ( & V_273 -> V_22 , L_9 ) ;
return - V_265 ;
}
V_279 = F_160 ( V_273 , V_282 , 0 ) ;
V_4 = F_161 ( & V_273 -> V_22 , V_279 ) ;
if ( F_162 ( V_4 ) )
return F_163 ( V_4 ) ;
F_164 ( & V_273 -> V_22 , L_10 , & V_279 -> V_283 ) ;
V_22 = F_165 ( sizeof( * V_2 ) ) ;
if ( ! V_22 )
return - V_47 ;
F_166 ( V_273 , V_22 ) ;
F_167 ( V_22 , & V_273 -> V_22 ) ;
V_2 = F_29 ( V_22 ) ;
V_2 -> V_4 = V_4 ;
V_2 -> V_212 = F_168 ( V_273 -> V_22 . V_284 ) ;
if ( V_2 -> V_212 < 0 )
V_2 -> V_212 = V_260 ;
V_2 -> V_159 = F_169 ( & V_273 -> V_22 , NULL ) ;
if ( F_162 ( V_2 -> V_159 ) ) {
F_152 ( & V_273 -> V_22 , L_11 ) ;
V_132 = F_163 ( V_2 -> V_159 ) ;
goto V_285;
}
V_132 = F_170 ( V_2 -> V_159 ) ;
if ( V_132 )
goto V_285;
F_171 ( & V_2 -> V_97 ) ;
...
V_12 -> V_289 = F_23 ;
V_12 -> V_290 = F_26 ;
V_12 -> V_187 = & V_273 -> V_22 ;
snprintf ( V_12 -> V_291 , V_292 , L_13 ,
( unsigned long ) V_279 -> V_283 ) ;
V_12 -> V_2 = V_2 ;
V_132 = F_173 ( V_12 , V_273 -> V_22 . V_284 ) ;
if ( V_132 ) {
F_152 ( & V_273 -> V_22 , L_14 ) ;
goto V_287;
}
if ( F_174 ( V_273 -> V_22 . V_284 ) ) {
V_132 = F_175 ( V_273 -> V_22 . V_284 ) ;
if ( V_132 < 0 ) {
F_152 ( & V_273 -> V_22 , L_15 ) ;
goto V_293;
}
V_2 -> V_211 = F_176 ( V_273 -> V_22 . V_284 ) ;
}
if ( ! V_2 -> V_211 )
V_2 -> V_211 = F_177 ( V_273 -> V_22 . V_284 ,
L_16 , 0 ) ;
if ( ! V_2 -> V_211 ) {
F_152 ( & V_273 -> V_22 , L_17 ) ;
V_132 = - V_213 ;
goto V_293;
}
V_2 -> V_11 = V_12 ;
...
if ( V_132 )
goto V_294;
if ( V_277 && V_277 -> V_295 ) {
V_132 = V_277 -> V_295 ( V_22 ) ;
if ( V_132 )
goto V_294;
}
V_22 -> V_296 = & V_297 ;
...
V_22 -> V_184 |= V_300 ;
V_22 -> V_130 = V_130 ;
V_280 = F_178 ( V_273 -> V_22 . V_284 ) ;
if ( V_280 )
F_110 ( V_22 -> V_175 , V_280 ) ;
if ( ! F_179 ( V_22 -> V_175 ) )
F_180 ( V_22 ) ;
F_106 ( V_22 ) ;
F_181 ( V_22 ) ;
...
F_183 ( V_22 , & V_2 -> V_34 , F_56 , V_301 ) ;
F_184 ( V_22 , L_19 , V_22 -> V_175 ) ;
return 0 ;
V_210:
F_116 ( V_22 ) ;
V_294:
if ( F_174 ( V_273 -> V_22 . V_284 ) )
F_185 ( V_273 -> V_22 . V_284 ) ;
V_293:
F_186 ( V_2 -> V_211 ) ;
F_187 ( V_12 ) ;
V_287:
...
static int F_190 ( struct V_272 * V_273 )
{
struct V_21 * V_302 = F_191 ( V_273 ) ;
struct V_1 * V_2 = F_29 ( V_302 ) ;
F_192 ( V_302 ) ;
if ( F_174 ( V_273 -> V_22 . V_284 ) )
F_185 ( V_273 -> V_22 . V_284 ) ;
F_186 ( V_2 -> V_211 ) ;
