...
static int F_120 ( struct V_68 * V_4 , T_6 V_158 , T_6 V_159 ,
T_3 V_80 , struct V_160 * V_153 )
{
if ( V_153 -> type != V_161 )
return - V_105 ;
V_153 -> V_162 -> V_42 = V_163 ;
return F_111 ( V_4 , V_153 -> V_162 -> V_164 ) ;
}
...
if ( V_17 -> V_49 < 7 )
return F_124 ( - V_171 ) ;
V_5 = F_125 ( struct V_165 , V_172 [ 7 ] ) ;
V_166 = F_126 ( V_5 , V_14 ) ;
if ( ! V_166 )
return F_124 ( - V_15 ) ;
V_166 -> V_5 = 7 ;
V_166 -> V_170 = V_17 -> V_47 ;
F_121 ( V_17 , V_166 ) ;
} else if ( ( V_166 -> V_7 == V_173 ) ||
( V_166 -> V_7 == ( V_17 -> V_49 - 1 ) ) ) {
return F_124 ( - V_171 ) ;
} else if ( V_166 -> V_7 == V_166 -> V_5 ) {
V_168 = V_166 ;
V_5 = F_125 ( struct V_165 ,
V_172 [ ( V_166 -> V_5 * 2 ) + 1 ] ) ;
V_166 = F_126 ( V_5 , V_14 ) ;
if ( ! V_166 )
return F_124 ( - V_15 ) ;
...
F_125 ( struct V_165 ,
V_172 [ V_168 -> V_5 ] ) ) ;
V_166 -> V_5 = ( V_168 -> V_5 * 2 ) + 1 ;
F_121 ( V_17 , V_166 ) ;
F_127 ( V_168 , V_174 ) ;
}
for ( V_18 = 0 ; V_18 < V_166 -> V_5 ; V_18 ++ ) {
if ( ! V_166 -> V_172 [ V_18 ] )
break;
}
V_166 -> V_172 [ V_18 ] = V_167 ;
V_166 -> V_7 ++ ;
V_170 . V_175 = V_176 ;
V_170 . V_177 = 1 ;
V_170 . V_178 = F_128 ( V_17 -> V_179 [ V_180 ] . V_43 ) ;
V_170 . V_181 = F_128 ( V_17 -> V_179 [ V_182 ] . V_43 ) ;
V_170 . V_47 = V_17 -> V_47 ;
V_170 . V_183 = F_128 ( V_166 -> V_5 ) ;
V_42 -> V_44 . V_101 . V_184 ( V_42 , & V_170 ) ;
F_82 ( V_17 ) ;
V_47 = V_166 -> V_170 + 1 + V_18 ;
if ( F_75 ( V_17 ) ) {
V_42 -> V_44 . V_101 . V_141 ( V_42 , V_47 ,
V_138 ) ;
V_42 -> V_44 . V_101 . V_102 ( V_42 , V_47 , V_167 -> V_128 ,
0 , true , 0 ) ;
}
F_85 ( V_17 ) ;
return V_167 ;
}
static void F_129 ( struct V_68 * V_4 , void * V_185 )
{
struct V_16 * V_17 = F_45 ( V_4 ) ;
struct V_165 * V_166 = F_107 ( V_17 -> V_166 ) ;
struct V_169 V_170 = { 0 } ;
struct V_41 * V_42 = & V_17 -> V_42 ;
struct V_68 * V_167 = V_185 ;
int V_18 ;
T_1 V_47 ;
if ( ! V_166 )
return;
for ( V_18 = 0 ; V_18 < V_166 -> V_5 ; V_18 ++ ) {
if ( V_166 -> V_172 [ V_18 ] == V_167 )
break;
}
if ( V_18 == V_166 -> V_5 )
return;
...
T_9 V_186 )
{
if ( ! V_30 -> V_187 || F_131 ( V_30 ) )
return V_186 ;
return V_186 & ~ ( V_188 | V_189 ) ;
}
struct V_68 * F_132 ( const struct V_190 * V_191 )
{
T_9 V_192 ;
struct V_16 * V_17 ;
struct V_68 * V_4 ;
V_4 = F_133 ( sizeof( struct V_16 ) , V_193 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_194 = & V_195 ;
F_134 ( V_4 ) ;
V_17 = F_45 ( V_4 ) ;
V_17 -> V_196 = F_135 ( V_197 ) - 1 ;
V_4 -> V_186 |= V_198 |
V_199 |
V_200 |
V_201 |
