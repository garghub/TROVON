...
V_38 -> V_120 = F_93 ( V_65 -> V_135 , 0 , V_179 ) ;
if ( ! V_38 -> V_120 ) {
V_132 = - V_70 ;
goto V_178;
}
...
F_96 ( & V_38 -> V_98 ) ;
if ( ! V_103 -> V_159 ) {
V_38 -> V_51 = ~ F_34 ( ~ 0 , V_103 -> V_180 , sizeof( V_103 -> V_180 ) ) ;
V_38 -> V_111 = 512 ;
} else {
V_38 -> V_111 = F_97 ( V_103 -> V_181 ) ;
}
for ( V_13 = 0 ; V_13 < V_38 -> V_11 ; V_13 ++ ) {
struct V_37 * log = & V_38 -> V_94 [ V_13 ] ;
...
if ( V_132 )
goto V_178;
V_183 = F_99 ( V_60 -> V_116 ) ;
if ( F_4 ( V_184 , & V_183 -> V_185 ) )
V_173 = true ;
}
}
if ( V_173 )
...
V_103 -> V_161 == 0 && ! V_103 -> V_186 &&
V_38 -> V_156 > 0 &&
V_38 -> V_155 == 0 ) {
V_103 -> V_161 = V_162 ;
F_40 ( V_187 , & V_103 -> V_188 ) ;
...
int F_100 ( struct V_64 * V_65 , struct V_140 * V_60 , bool V_189 )
{
struct V_38 * V_38 = V_65 -> V_89 ;
struct V_37 * log ;
int V_132 = 0 ;
...
return - V_164 ;
F_3 ( L_36 ,
V_16 , V_60 -> V_153 , V_189 ? L_37 : L_38 ,
