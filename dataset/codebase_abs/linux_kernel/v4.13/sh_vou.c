...
V_125 . V_132 = V_16 -> V_20 ;
V_125 . V_134 = V_16 -> V_21 ;
V_198 . V_194 . V_20 = V_125 . V_139 . V_20 ;
V_198 . V_194 . V_21 = V_125 . V_139 . V_21 ;
F_29 ( & V_6 -> V_43 , 0 , V_167 ,
V_199 , NULL , & V_198 ) ;
...
static T_4 F_62 ( int V_200 , void * V_201 )
{
struct V_5 * V_6 = V_201 ;
static unsigned long V_202 ;
struct V_1 * V_4 ;
static int V_203 ;
T_1 V_204 = F_7 ( V_6 , V_68 ) , V_205 ;
T_1 V_206 = F_7 ( V_6 , V_66 ) ;
if ( ! ( V_204 & 0x300 ) ) {
if ( F_63 ( & V_202 , 500 ) )
...
V_205 = ~ ( 0x300 & V_204 ) & V_204 & 0x30304 ;
F_18 ( V_6 -> V_43 . V_44 ,
L_38 ,
V_204 , V_205 , V_206 , V_203 ) ;
V_203 ++ ;
F_3 ( V_6 , V_68 , V_205 ) ;
V_4 = V_6 -> V_63 ;
if ( F_67 ( & V_4 -> V_52 ) ) {
...
F_32 ( & V_4 -> V_52 ) ;
V_4 -> V_4 . V_15 . V_209 = F_68 () ;
V_4 -> V_4 . V_58 = V_6 -> V_58 ++ ;
V_4 -> V_4 . V_148 = V_149 ;
F_31 ( & V_4 -> V_4 . V_15 , V_210 ) ;
V_6 -> V_63 = F_33 ( V_6 -> V_53 . V_64 ,
struct V_1 , V_52 ) ;
if ( F_67 ( & V_6 -> V_53 ) ) {
F_12 ( V_6 , & V_6 -> V_63 -> V_4 ) ;
} else {
struct V_1 * V_211 = F_33 ( V_6 -> V_63 -> V_52 . V_64 ,
struct V_1 , V_52 ) ;
F_12 ( V_6 , & V_211 -> V_4 ) ;
}
F_66 ( & V_6 -> V_51 ) ;
...
{
struct V_212 * V_185 = V_6 -> V_185 ;
T_1 V_213 = F_54 ( V_185 -> V_178 ) << 29 ;
int V_130 = 100 ;
F_3 ( V_6 , V_68 , 0 ) ;
F_3 ( V_6 , V_187 , 0x101 ) ;
...
if ( V_185 -> V_50 & V_217 )
V_213 |= 1 << 26 ;
F_11 ( V_6 , V_184 , V_213 , 0xfc000000 ) ;
F_3 ( V_6 , V_67 , 4 ) ;
...
{
struct V_212 * V_226 = V_225 -> V_44 . V_227 ;
struct V_103 * V_104 ;
struct V_38 * V_16 ;
struct V_228 * V_229 ;
struct V_230 * V_175 ;
...
struct V_31 * V_235 ;
int V_200 , V_57 ;
V_232 = F_83 ( V_225 , V_236 , 0 ) ;
V_200 = F_84 ( V_225 , 0 ) ;
if ( ! V_226 || ! V_232 || V_200 <= 0 ) {
F_85 ( & V_225 -> V_44 , L_40 ) ;
return - V_237 ;
}
V_6 = F_86 ( & V_225 -> V_44 , sizeof( * V_6 ) , V_238 ) ;
if ( ! V_6 )
return - V_239 ;
F_87 ( & V_6 -> V_53 ) ;
F_88 ( & V_6 -> V_51 ) ;
...
V_16 -> V_150 = V_151 ;
V_6 -> V_9 = F_90 ( & V_225 -> V_44 , V_232 ) ;
if ( F_91 ( V_6 -> V_9 ) )
return F_92 ( V_6 -> V_9 ) ;
V_57 = F_93 ( & V_225 -> V_44 , V_200 , F_62 , 0 , L_41 , V_6 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_94 ( & V_225 -> V_44 , & V_6 -> V_43 ) ;
if ( V_57 < 0 ) {
F_85 ( & V_225 -> V_44 , L_42 ) ;
return V_57 ;
}
V_175 = & V_6 -> V_175 ;
* V_175 = V_241 ;
if ( V_226 -> V_178 == V_179 )
V_175 -> V_176 |= V_242 ;
V_175 -> V_43 = & V_6 -> V_43 ;
V_175 -> V_243 = V_244 ;
V_175 -> V_51 = & V_6 -> V_218 ;
F_95 ( V_175 , V_6 ) ;
V_235 = & V_6 -> V_165 ;
V_235 -> type = V_89 ;
V_235 -> V_245 = V_246 | V_247 | V_248 ;
V_235 -> V_249 = V_6 ;
V_235 -> V_250 = sizeof( struct V_1 ) ;
V_235 -> V_251 = & V_252 ;
V_235 -> V_253 = & V_254 ;
V_235 -> V_255 = V_256 ;
V_235 -> V_257 = 2 ;
V_235 -> V_51 = & V_6 -> V_218 ;
V_235 -> V_44 = & V_225 -> V_44 ;
V_57 = F_96 ( V_235 ) ;
if ( V_57 )
goto V_258;
V_175 -> V_165 = V_235 ;
...
if ( V_57 < 0 )
goto V_259;
V_234 = F_100 ( & V_6 -> V_43 , V_229 ,
V_226 -> V_260 , NULL ) ;
if ( ! V_234 ) {
V_57 = - V_239 ;
goto V_261;
}
V_57 = F_101 ( V_175 , V_262 , - 1 ) ;
if ( V_57 < 0 )
goto V_263;
return 0 ;
V_263:
...
static int F_105 ( struct V_224 * V_225 )
{
struct V_264 * V_43 = F_106 ( V_225 ) ;
struct V_5 * V_6 = F_2 ( V_43 ,
struct V_5 , V_43 ) ;
struct V_233 * V_265 = F_33 ( V_43 -> V_266 . V_64 ,
struct V_233 , V_52 ) ;
struct V_267 * V_268 = F_107 ( V_265 ) ;
F_103 ( & V_225 -> V_44 ) ;
F_108 ( & V_6 -> V_175 ) ;
F_102 ( V_268 -> V_269 ) ;
F_104 ( & V_6 -> V_43 ) ;
