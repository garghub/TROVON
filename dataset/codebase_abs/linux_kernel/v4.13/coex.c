...
{
struct V_113 * V_114 = F_27 ( V_112 ) ;
struct V_146 * V_82 = ( void * ) V_114 -> V_71 ;
T_2 V_147 = F_5 ( V_82 -> V_148 ) ;
struct V_149 V_50 = {} ;
T_3 T_5 V_150 , V_151 ;
T_3 V_152 ;
if ( ! F_11 ( V_3 ) )
...
if ( V_147 == V_3 -> V_153 )
return;
for ( V_152 = 0 ; V_152 < F_46 ( V_154 ) - 1 ; V_152 ++ )
if ( V_147 < V_154 [ V_152 + 1 ] . V_155 )
break;
V_150 = V_154 [ V_152 ] . V_155 ;
if ( V_152 < F_46 ( V_154 ) - 1 )
V_151 = V_154 [ V_152 + 1 ] . V_155 ;
else
V_151 = V_154 [ V_152 ] . V_155 ;
F_16 ( V_3 , L_16 ,
V_147 , V_150 , V_151 , V_152 ) ;
V_3 -> V_153 = V_147 ;
if ( V_3 -> V_156 == V_152 )
return;
V_3 -> V_156 = V_152 ;
memcpy ( & V_50 . V_157 , V_154 [ V_152 ] . V_158 ,
sizeof( V_50 . V_157 ) ) ;
memcpy ( & V_50 . V_159 , V_154 [ V_152 ] . V_158 ,
sizeof( V_50 . V_159 ) ) ;
if ( F_13 ( V_3 , V_160 , 0 ,
sizeof( V_50 ) , & V_50 ) )
F_23 ( V_3 ,
