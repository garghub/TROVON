...
static void
F_24 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
T_1 V_61 [ 16 ] ;
T_1 * V_2 = V_61 ;
int V_62 ;
...
static int
F_27 ( struct V_10 * V_17 , T_1 V_71 , int * V_74 ) {
int V_75 = 1 ;
while ( * V_74 != - 1 ) {
if ( ( * V_74 & 0xff ) == V_71 ) {
if ( V_71 & 0x80 )
...
static int
F_28 ( struct V_10 * V_17 , struct V_56 * V_57 , int * V_74 )
{
int * V_76 = V_74 ;
T_1 V_55 ;
T_1 * V_2 , V_71 ;
...
static int
F_29 ( struct V_10 * V_17 , int V_55 , void * V_32 )
{
switch ( V_55 ) {
case V_93 :
case V_94 :
...
static void
F_30 ( struct V_10 * V_17 , int V_75 ) {
if ( V_17 -> V_86 & V_87 )
...
T_1 * V_2 ;
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , V_117 , 0 ) ) ) {
V_2 ++ ;
if ( * V_2 != 1 ) {
if ( V_17 -> V_86 & V_116 )
...
static int
F_33 ( struct V_10 * V_17 , struct V_56 * V_57 ) {
T_1 V_62 , V_4 = 0 ;
T_1 * V_2 ;
V_2 = V_57 -> V_40 ;
V_17 -> V_66 . V_60 = 31 ;
V_17 -> V_66 . V_118 = 0 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , V_63 , 0 ) ) ) {
V_2 ++ ;
V_62 = * V_2 ++ ;
if ( V_62 > 30 )
return ( 1 ) ;
...
static void
F_34 ( struct V_10 * V_17 , T_1 V_120 )
{
struct V_56 * V_57 ;
T_1 V_61 [ 16 + 40 ] ;
T_1 * V_2 = V_61 ;
...
static void
F_35 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
F_36 ( V_17 ) ;
F_37 ( V_17 , 19 ) ;
if ( ! V_17 -> V_5 . V_6 . V_16 [ 0 ] )
...
F_34 ( V_17 , V_102 ) ;
F_38 ( & V_17 -> V_25 , V_122 , V_123 ) ;
}
static void
F_39 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
struct V_56 * V_57 = V_32 ;
int V_75 ;
if ( ( V_75 = F_33 ( V_17 , V_57 ) ) > 0 ) {
if ( V_17 -> V_86 & V_116 )
...
{
T_1 * V_2 ;
if ( ( V_2 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , 0x7c , 0 ) ) ) {
switch ( V_2 [ 4 ] & 0x0f ) {
case 0x01 :
if ( V_2 [ 1 ] == 0x04 )
return F_43 ( 160 , V_2 [ 5 ] ) ;
else if ( V_2 [ 1 ] == 0x06 )
return F_42 ( 192 , V_2 ) ;
break;
case 0x08 :
if ( V_2 [ 1 ] > 3 )
return F_43 ( 176 , V_2 [ 5 ] ) ;
break;
}
}
return 0 ;
...
static void
F_45 ( struct V_10 * V_17 , T_1 V_64 ,
void * V_32 )
{
struct V_56 * V_57 ;
T_1 V_61 [ 128 ] ;
...
* V_2 ++ = 0x90 ;
* V_2 ++ = 0x21 ;
* V_2 ++ = F_41 ( V_17 -> V_66 . V_137 . V_127 - 160 , 0x80 ) ;
...
* V_2 ++ = 0x90 ;
* V_2 ++ = 0x28 ;
* V_2 ++ = F_41 ( V_17 -> V_66 . V_137 . V_127 - 176 , 0 ) ;
* V_2 ++ = 0x82 ;
...
* V_2 ++ = 0x90 ;
* V_2 ++ = 0x21 ;
V_2 = F_40 ( V_2 , V_17 -> V_66 . V_137 . V_127 - 192 ) ;
#ifndef F_49
} else {
switch ( V_17 -> V_66 . V_137 . V_139 ) {
case 1 :
...
if ( ( V_2 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , V_160 , 0 ) ) )
F_13 ( V_17 -> V_11 , V_17 , V_17 -> V_19 , V_2 ) ;
V_75 = F_28 ( V_17 , V_57 , V_161 ) ;
if ( V_89 == V_75 )
V_60 = 96 ;
...
static void
F_55 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
T_1 * V_2 ;
int V_168 = 0 ;
char V_61 [ 80 ] ;
...
int V_169 = 0 ;
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , 0x04 , 0 ) ) ) {
if ( ( V_2 [ 1 ] < 2 ) || ( V_2 [ 1 ] > 11 ) )
V_169 = 1 ;
else {
...
#ifdef F_48
V_17 -> V_66 . V_137 . V_127 = F_44 ( V_57 ) ;
#endif
break;
case 0x09 :
...
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , 0x70 , 0 ) ) )
F_56 ( V_17 -> V_66 . V_137 . V_142 , V_2 , 1 ) ;
else
V_17 -> V_66 . V_137 . V_142 [ 0 ] = 0 ;
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , 0x71 , 0 ) ) ) {
...
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , 0x6c , 0 ) ) ) {
V_17 -> V_66 . V_137 . V_172 = V_2 [ 2 ] ;
if ( V_2 [ 2 ] & 0x80 ) {
F_56 ( V_17 -> V_66 . V_137 . V_138 , V_2 , 1 ) ;
V_17 -> V_66 . V_137 . V_132 = 0 ;
} else {
F_56 ( V_17 -> V_66 . V_137 . V_138 , V_2 , 2 ) ;
...
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , 0x6d , 0 ) ) ) {
if ( ( V_2 [ 1 ] >= 2 ) && ( V_2 [ 2 ] == 0x80 ) && ( V_2 [ 3 ] == 0x50 ) ) {
V_61 [ 0 ] = '.' ;
F_56 ( & V_61 [ 1 ] , V_2 , 2 ) ;
...
static void
F_58 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
struct V_56 * V_57 ;
T_1 V_61 [ 16 + 40 ] ;
T_1 * V_2 = V_61 ;
...
F_37 ( V_17 , 11 ) ;
F_20 ( V_17 -> V_11 , V_58 | V_59 , V_57 ) ;
F_38 ( & V_17 -> V_25 , V_173 , V_174 ) ;
}
static void
F_59 ( struct V_10 * V_17 , T_1 V_64 ,
void * V_32 )
{
if ( ! V_17 -> V_66 . V_151 )
{ if ( V_17 -> V_86 & V_116 )
...
static void
F_62 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
struct V_56 * V_57 = V_32 ;
T_1 * V_2 ;
int V_75 , V_60 = 0 ;
...
static void
F_65 ( struct V_10 * V_17 , T_1 V_64 ,
void * V_32 )
{
F_37 ( V_17 , 25 ) ;
F_9 ( & V_17 -> V_25 ) ;
F_38 ( & V_17 -> V_25 , V_181 , V_182 ) ;
F_16 ( V_17 , V_104 ) ;
}
static void
F_66 ( struct V_10 * V_17 , int V_64 , T_1 * V_183 )
{ T_1 V_73 ;
T_2 V_22 ;
struct V_23 * V_24 ;
char * V_2 ;
...
int V_169 = 0 ;
T_1 * V_2 ;
if ( ( V_2 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , V_188 , 0 ) ) ) {
if ( V_2 [ 1 ] != 2 ) {
V_169 = 1 ;
V_17 -> V_66 . V_60 = 100 ;
} else if ( ! ( V_2 [ 2 ] & 0x70 ) ) {
...
int V_169 = 0 ;
T_1 * V_2 ;
if ( ( V_2 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , V_191 , 0 ) ) ) {
if ( V_2 [ 1 ] != 1 ) {
V_169 = 1 ;
V_17 -> V_66 . V_60 = 100 ;
} else {
...
int V_75 ;
struct V_56 * V_57 = V_32 ;
V_75 = F_28 ( V_17 , V_57 , V_194 ) ;
F_30 ( V_17 , V_75 ) ;
V_17 -> V_66 . V_60 = 30 ;
F_23 ( V_17 , V_64 , NULL ) ;
}
static void
F_70 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
int V_75 ;
struct V_56 * V_57 = V_32 ;
T_1 * V_2 ;
char V_61 [ 32 ] ;
V_75 = F_28 ( V_17 , V_57 , V_195 ) ;
if ( V_75 )
F_30 ( V_17 , V_75 ) ;
if ( V_17 -> V_68 == 25 ) {
F_9 ( & V_17 -> V_25 ) ;
...
static void F_72 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
F_64 ( V_17 , V_64 , V_32 ) ;
F_71 ( V_17 , V_64 , V_32 ) ;
}
static int F_73 ( struct V_1 * V_11 , T_2 * V_22 )
{ T_1 V_9 ;
T_1 V_199 [ 265 ] ;
T_1 * V_2 = V_199 ;
int V_4 , V_62 , V_200 ;
...
F_22 ( V_57 , V_199 , V_62 ) ;
if ( V_17 )
{ V_17 -> V_5 . V_6 . V_14 = V_9 ;
F_38 ( & V_17 -> V_25 , V_22 -> V_34 . V_35 . V_38 , V_202 | V_59 ) ;
}
...
int V_204 = 0 ;
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , V_67 , 0 ) ) ) {
V_2 ++ ;
if ( 1 == * V_2 ++ )
V_204 = * V_2 ;
}
...
if ( ( V_2 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , V_67 , 0 ) ) ) {
V_2 ++ ;
if ( 1 == * V_2 ++ ) {
V_204 = * V_2 ;
if ( ! F_27 ( V_17 , * V_2 , V_214 ) )
V_60 = 100 ;
} else
V_60 = 100 ;
} else
...
F_9 ( & V_17 -> V_25 ) ;
V_2 = V_57 -> V_40 ;
if ( ( V_2 = F_32 ( V_2 , V_57 -> V_73 , V_232 , 0 ) ) ) {
V_229 = V_2 [ 2 ] ;
...
{
F_9 ( & V_17 -> V_25 ) ;
F_38 ( & V_17 -> V_25 , V_236 , V_237 ) ;
F_20 ( V_17 -> V_11 , V_238 | V_59 , NULL ) ;
}
static void
F_100 ( struct V_10 * V_17 , T_1 V_64 , void * V_32 )
{
F_9 ( & V_17 -> V_25 ) ;
V_17 -> V_66 . V_60 = 0x1F ;
F_23 ( V_17 , 0 , NULL ) ;
...
V_240 [ V_4 ] . F_103 ( V_13 , V_55 , V_57 ) ;
}
}
static void
F_104 ( struct V_1 * V_11 , int V_64 , void * V_32 )
{
...
if ( ( V_243 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , V_63 , 0 ) ) != NULL ) {
V_243 ++ ;
if ( * V_243 ++ == 2 )
V_243 ++ ;
}
V_204 = 0 ;
if ( ( V_243 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , V_67 , 0 ) ) != NULL ) {
V_243 ++ ;
if ( * V_243 ++ == 2 )
V_243 ++ ;
V_204 = * V_243 ;
...
if ( F_29 ( V_13 , V_55 , V_57 ) ) {
F_105 ( V_57 ) ;
return;
}
if ( ( V_2 = F_32 ( V_57 -> V_40 , V_57 -> V_73 , V_184 , 0 ) ) != NULL )
F_66 ( V_13 , V_64 , V_2 ) ;
for ( V_4 = 0 ; V_4 < F_102 ( V_248 ) ; V_4 ++ )
...
V_248 [ V_4 ] . F_103 ( V_13 , V_64 , V_57 ) ;
}
F_105 ( V_57 ) ;
return;
}
static void
F_108 ( struct V_1 * V_11 , int V_64 , void * V_32 )
{
int V_4 , V_12 ;
struct V_10 * V_13 ;
struct V_249 * V_185 ;
...
V_251 [ V_4 ] . F_103 ( V_13 , V_64 , V_32 ) ;
}
}
static void
F_110 ( struct V_1 * V_11 , int V_64 , void * V_32 )
{
int V_4 ;
...
V_252 [ V_4 ] . F_103 ( V_13 , V_64 , V_32 ) ;
}
}
void
F_111 ( struct V_1 * V_11 )
{
char V_61 [ 64 ] ;
int V_4 ;
V_11 -> V_233 . V_234 = F_108 ;
V_11 -> V_233 . V_253 = F_73 ;
V_11 -> V_254 . V_255 = F_104 ;
V_11 -> V_18 . V_256 = F_110 ;
V_11 -> V_18 . V_207 = 1 ;
V_11 -> V_5 . V_6 . V_7 = 0 ;
...
if ( ! ( V_11 -> V_18 . V_239 = F_112 ( sizeof( struct V_10 ) , V_257 ) ) ) {
F_25 ( V_70 L_102 ) ;
} else {
...
F_113 ( V_11 -> V_18 . V_239 , & V_11 -> V_18 . V_239 -> V_25 ) ;
}
strcpy ( V_61 , V_258 ) ;
F_25 ( V_259 L_103 , F_114 ( V_61 ) ) ;
}
