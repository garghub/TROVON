...
static void F_25 ( struct V_1 * V_2 , enum V_39 V_40 )
__releases( V_2 -> V_41 )
__acquires( V_2 -> V_41 )
{
int V_42 ;
...
V_2 -> V_91 = F_62 ( V_5 , sizeof( * V_2 -> V_91 ) ,
V_109 ) ;
if ( ! V_2 -> V_91 )
goto V_111;
V_2 -> V_90 = F_63 ( L_16 , F_16 ( V_2 ) ,
sizeof( struct V_112 ) , 16 , 0 ) ;
if ( ! V_2 -> V_90 ) {
F_41 ( F_16 ( V_2 ) , L_17 ) ;
goto V_113;
}
V_2 -> V_89 = F_63 ( L_18 , F_16 ( V_2 ) ,
...
for ( V_85 = 0 ; V_85 < V_87 ; V_85 ++ ) {
V_2 -> V_6 [ V_85 ] = F_65 ( V_2 , NULL , NULL ) ;
if ( ! V_2 -> V_6 [ V_85 ] ) {
F_41 ( F_16 ( V_2 ) , L_21 ) ;
goto V_117;
}
...
V_2 -> V_121 -> V_120 = F_66 ( V_2 ) ;
V_2 -> V_122 -> V_120 = F_3 ( V_2 , V_2 -> V_122 ) ;
F_67 ( V_2 , V_2 -> V_88 , 0 , F_68 ( 0 ) |
( 0x7f << V_123 ) | V_124 , 0 ) ;
V_2 -> V_88 -> V_120 = F_66 ( V_2 ) ;
...
static void F_70 ( struct V_68 * V_69 )
{
struct V_1 * V_2 = F_38 ( V_69 ) ;
F_30 ( & V_2 -> V_41 ) ;
if ( F_71 ( V_69 ) && ! V_2 -> V_19 )
F_8 ( V_2 ) ;
F_32 ( V_2 ) ;
F_28 ( & V_2 -> V_41 ) ;
F_72 ( V_69 -> V_126 ) ;
...
if ( F_83 () )
return - V_140 ;
F_84 ( V_141 L_25 V_142 L_26 ,
V_38 ? L_27 : L_7 ) ;
F_31 ( V_143 , & V_144 ) ;
#ifdef F_85
V_80 = F_86 ( V_81 , V_109 ) ;
if ( ! V_80 )
goto V_145;
V_106 = F_87 ( L_28 , V_146 ) ;
if ( ! V_106 )
goto V_147;
#endif
V_148 = F_88 ( L_29 ,
