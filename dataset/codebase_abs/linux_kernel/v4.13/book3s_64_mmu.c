...
if ( V_46 -> V_65 && ! ( V_34 & V_94 ) ) {
char V_79 * V_95 = ( char V_79 * ) ( V_48 + ( V_7 + 1 ) * sizeof( T_2 ) ) ;
V_34 |= V_94 ;
F_28 ( V_34 >> 8 , V_95 + 6 ) ;
}
if ( V_47 && V_46 -> V_66 && ! ( V_34 & V_96 ) ) {
char V_79 * V_95 = ( char V_79 * ) ( V_48 + ( V_7 + 1 ) * sizeof( T_2 ) ) ;
V_34 |= V_96 ;
F_28 ( V_34 , V_95 + 7 ) ;
}
...
static void F_30 ( struct V_1 * V_2 , T_2 V_100 , T_2 V_101 )
{
T_2 V_8 , V_9 ;
int V_10 ;
struct V_5 * V_17 ;
...
V_17 -> V_16 = ( V_100 & V_102 ) ? 1 : 0 ;
V_17 -> V_14 = ( V_100 & V_71 ) ? 1 : 0 ;
V_17 -> V_8 = V_17 -> V_14 ? V_9 : V_8 ;
V_17 -> V_15 = ( V_100 & ~ V_74 ) >> ( F_7 ( V_17 ) - 16 ) ;
V_17 -> V_13 = ( V_101 & V_103 ) ? 1 : 0 ;
V_17 -> V_82 = ( V_100 & V_104 ) ? 1 : 0 ;
V_17 -> V_81 = ( V_100 & V_105 ) ? 1 : 0 ;
V_17 -> V_106 = ( V_100 & V_107 ) ? 1 : 0 ;
V_17 -> V_108 = ( V_100 & V_109 ) ? 1 : 0 ;
V_17 -> V_25 = V_68 ;
if ( V_17 -> V_16 ) {
...
static void F_34 ( struct V_1 * V_2 , T_2 V_116 )
{
struct V_5 * V_17 ;
T_2 V_117 ;
F_6 ( L_9 , V_116 ) ;
...
if ( ! V_17 )
return;
F_6 ( L_10 , V_116 , V_17 -> V_8 ) ;
V_17 -> V_13 = false ;
V_17 -> V_113 = 0 ;
V_17 -> V_115 = 0 ;
V_117 = 1ull << F_7 ( V_17 ) ;
F_35 ( V_2 , V_116 & ~ ( V_117 - 1 ) , V_117 ) ;
}
...
static void F_39 ( struct V_1 * V_2 , T_3 V_119 ,
T_6 V_120 )
{
T_2 V_101 = 0 , V_100 = 0 ;
F_6 ( L_12 , V_119 , V_120 ) ;
V_101 |= ( V_119 & 0xf ) << 28 ;
V_101 |= 1 << 27 ;
V_101 |= V_119 ;
V_100 |= ( V_120 & 0xfffffff ) << 12 ;
V_100 |= ( ( V_120 >> 28 ) & 0x7 ) << 9 ;
F_30 ( V_2 , V_100 , V_101 ) ;
}
static void F_40 ( struct V_1 * V_2 , T_6 V_121 ,
bool V_16 )
{
T_2 V_122 = 0xFFFFFFFFFULL ;
long V_7 ;
struct V_1 * V_49 ;
F_6 ( L_13 , V_121 ) ;
if ( V_2 -> V_3 . V_85 & V_123 ) {
if ( V_121 & 1 ) {
if ( ( V_121 & 0xf000 ) == 0x1000 )
V_122 = 0xFFFFFFFF0ULL ;
else
V_122 = 0xFFFFFF000ULL ;
}
} else {
if ( V_16 )
V_122 = 0xFFFFFF000ULL ;
...
if ( V_12 -> V_14 ) {
V_124 <<= V_18 - V_19 ;
V_124 |= V_8 & ( ( 1ul << ( V_18 - V_19 ) ) - 1 ) ;
V_124 |= V_128 ;
}
}
}
switch ( V_126 & ( V_127 | V_118 ) ) {
case 0 :
V_124 = V_129 | V_8 ;
break;
case V_118 :
...
{
return ( F_15 ( V_2 ) -> V_137 [ 5 ] & 0x80 ) ;
}
void F_48 ( struct V_1 * V_2 )
{
struct V_138 * V_139 = & V_2 -> V_3 . V_139 ;
V_139 -> V_140 = NULL ;
V_139 -> V_141 = F_39 ;
V_139 -> V_142 = F_30 ;
V_139 -> V_143 = F_32 ;
