...
if ( F_9 ( V_15 ) )
return V_9 ;
V_16 = F_10 ( V_8 , & V_15 , V_19 , V_3 , 1 ) ;
if ( V_16 >= 0 ) {
V_13 = V_15 ;
V_14 = F_11 ( & V_13 -> V_14 ) & 0xfffff ;
for ( V_18 = 0 ; V_18 < V_14 && ! V_1 ; V_18 += V_17 ) {
if ( V_18 >= ( V_19 - F_12 ( struct V_12 , V_20 ) ) ) {
F_6 () ;
break;
}
V_17 = - 1 ;
