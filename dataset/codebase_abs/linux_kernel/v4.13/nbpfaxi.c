...
struct V_6 * V_101 ,
struct V_146 * V_148 , unsigned int V_154 ,
struct V_146 * V_147 , unsigned int V_155 ,
unsigned long V_40 )
{
struct V_1 * V_2 = F_35 ( V_101 ) ;
if ( V_154 != V_155 )
return NULL ;
return F_71 ( V_2 , V_147 , V_148 , V_155 ,
V_58 , V_40 ) ;
}
static struct V_117 * F_78 (
struct V_6 * V_101 , struct V_146 * V_156 , unsigned int V_157 ,
enum V_52 V_53 , unsigned long V_40 , void * V_158 )
{
struct V_1 * V_2 = F_35 ( V_101 ) ;
struct V_146 V_159 ;
F_3 ( V_101 -> V_7 -> V_8 , L_6 , V_9 ) ;
...
switch ( V_53 ) {
case V_59 :
F_72 ( & V_159 ) = V_2 -> V_140 ;
return F_71 ( V_2 , V_156 , & V_159 , V_157 ,
V_53 , V_40 ) ;
case V_60 :
F_72 ( & V_159 ) = V_2 -> V_143 ;
return F_71 ( V_2 , & V_159 , V_156 , V_157 ,
V_53 , V_40 ) ;
default:
return NULL ;
}
}
static int F_79 ( struct V_6 * V_101 )
{
struct V_1 * V_2 = F_35 ( V_101 ) ;
int V_135 ;
F_53 ( & V_2 -> free ) ;
...
static void F_80 ( struct V_6 * V_101 )
{
struct V_1 * V_2 = F_35 ( V_101 ) ;
...
V_19 < F_50 ( V_120 -> V_26 ) ;
V_19 ++ , V_26 ++ )
F_81 ( V_101 -> V_7 -> V_8 , V_26 -> V_30 ,
sizeof( * V_26 -> V_34 ) , V_97 ) ;
F_82 ( ( unsigned long ) V_120 ) ;
}
}
static struct V_6 * F_83 ( struct V_160 * V_161 ,
struct V_162 * V_163 )
{
struct V_10 * V_11 = V_163 -> V_164 ;
struct V_6 * V_101 ;
struct V_1 * V_2 ;
if ( V_161 -> V_165 != 2 )
return NULL ;
V_101 = F_84 ( & V_11 -> V_12 ) ;
if ( ! V_101 )
return NULL ;
F_3 ( V_101 -> V_7 -> V_8 , L_16 , V_9 ,
V_161 -> V_166 -> V_167 ) ;
V_2 = F_35 ( V_101 ) ;
V_2 -> V_48 = V_161 -> args [ 0 ] ;
V_2 -> V_40 = V_161 -> args [ 1 ] ;
F_20 ( V_2 ) ;
F_22 ( V_2 ) ;
return V_101 ;
}
static void F_85 ( unsigned long V_4 )
{
struct V_1 * V_2 = (struct V_1 * ) V_4 ;
struct V_23 * V_24 , * V_131 ;
struct V_168 V_169 ;
while ( ! F_37 ( & V_2 -> V_137 ) ) {
bool V_114 = false , V_170 , V_171 = false ;
F_54 ( & V_2 -> V_102 ) ;
F_59 (desc, tmp, &chan->done, node) {
if ( ! V_24 -> V_132 ) {
V_114 = true ;
...
static T_5 F_89 ( int V_172 , void * V_8 )
{
struct V_1 * V_2 = V_8 ;
bool V_137 = F_9 ( V_2 ) ;
struct V_23 * V_24 ;
...
static T_5 F_94 ( int V_172 , void * V_8 )
{
struct V_10 * V_11 = V_8 ;
T_1 error = F_12 ( V_11 ) ;
F_95 ( V_11 -> V_12 . V_8 , L_18 , V_172 ) ;
if ( ! error )
return V_174 ;
do {
...
static int F_96 ( struct V_10 * V_11 , int V_177 )
{
struct V_178 * V_12 = & V_11 -> V_12 ;
struct V_1 * V_2 = V_11 -> V_2 + V_177 ;
int V_135 ;
V_2 -> V_11 = V_11 ;
V_2 -> V_5 = V_11 -> V_5 + V_179 + V_180 * V_177 ;
F_53 ( & V_2 -> V_130 ) ;
F_97 ( & V_2 -> V_102 ) ;
V_2 -> V_6 . V_7 = V_12 ;
F_98 ( & V_2 -> V_6 ) ;
F_21 ( V_2 ) ;
F_3 ( V_12 -> V_8 , L_19 , V_9 , V_177 , V_2 -> V_5 ) ;
snprintf ( V_2 -> V_167 , sizeof( V_2 -> V_167 ) , L_20 , V_177 ) ;
F_99 ( & V_2 -> V_176 , F_85 , ( unsigned long ) V_2 ) ;
V_135 = F_100 ( V_12 -> V_8 , V_2 -> V_172 ,
F_89 , V_181 ,
V_2 -> V_167 , V_2 ) ;
if ( V_135 < 0 )
return V_135 ;
...
static int F_101 ( struct V_184 * V_185 )
{
struct V_7 * V_8 = & V_185 -> V_8 ;
const struct V_186 * V_187 = F_102 ( V_188 , V_8 ) ;
struct V_182 * V_166 = V_8 -> V_189 ;
struct V_10 * V_11 ;
struct V_178 * V_12 ;
struct V_190 * V_191 , * V_192 ;
const struct F_70 * V_193 ;
int V_194 ;
int V_135 , V_172 , V_195 , V_19 ;
int V_196 [ 9 ] ;
unsigned int V_197 = 0 ;
F_103 ( sizeof( struct V_119 ) > V_198 ) ;
if ( ! V_166 || ! V_187 || ! V_187 -> V_4 )
return - V_199 ;
V_193 = V_187 -> V_4 ;
V_194 = V_193 -> V_194 ;
V_11 = F_104 ( V_8 , sizeof( * V_11 ) + V_194 *
sizeof( V_11 -> V_2 [ 0 ] ) , V_121 ) ;
if ( ! V_11 )
return - V_125 ;
V_12 = & V_11 -> V_12 ;
V_12 -> V_8 = V_8 ;
V_191 = F_105 ( V_185 , V_200 , 0 ) ;
V_11 -> V_5 = F_106 ( V_8 , V_191 ) ;
if ( F_107 ( V_11 -> V_5 ) )
return F_108 ( V_11 -> V_5 ) ;
V_11 -> V_201 = F_109 ( V_8 , NULL ) ;
if ( F_107 ( V_11 -> V_201 ) )
return F_108 ( V_11 -> V_201 ) ;
F_110 ( V_166 , L_21 ,
& V_11 -> V_56 ) ;
F_110 ( V_166 , L_22 ,
& V_11 -> V_57 ) ;
V_11 -> V_35 = V_193 ;
for ( V_19 = 0 ; V_197 < F_50 ( V_196 ) ; V_19 ++ ) {
V_192 = F_105 ( V_185 , V_202 , V_19 ) ;
if ( ! V_192 )
break;
for ( V_172 = V_192 -> V_203 ; V_172 <= V_192 -> V_204 ;
V_172 ++ , V_197 ++ )
V_196 [ V_197 ] = V_172 ;
}
if ( V_197 != 1 && V_197 != 2 && V_197 != V_194 + 1 )
return - V_205 ;
if ( V_197 == 1 ) {
V_195 = V_196 [ 0 ] ;
for ( V_19 = 0 ; V_19 <= V_194 ; V_19 ++ )
V_11 -> V_2 [ V_19 ] . V_172 = V_196 [ 0 ] ;
} else {
V_195 = F_111 ( V_185 , L_23 ) ;
if ( V_195 < 0 )
return V_195 ;
if ( V_197 == V_194 + 1 ) {
struct V_1 * V_2 ;
for ( V_19 = 0 , V_2 = V_11 -> V_2 ; V_19 <= V_194 ;
V_19 ++ , V_2 ++ ) {
if ( V_196 [ V_19 ] == V_195 )
V_19 ++ ;
V_2 -> V_172 = V_196 [ V_19 ] ;
}
if ( V_2 != V_11 -> V_2 + V_194 )
return - V_95 ;
} else {
if ( V_196 [ 0 ] == V_195 )
V_172 = V_196 [ 1 ] ;
...
V_172 = V_196 [ 0 ] ;
for ( V_19 = 0 ; V_19 <= V_194 ; V_19 ++ )
V_11 -> V_2 [ V_19 ] . V_172 = V_172 ;
}
}
V_135 = F_100 ( V_8 , V_195 , F_94 ,
V_181 , L_24 , V_11 ) ;
if ( V_135 < 0 )
return V_135 ;
V_11 -> V_195 = V_195 ;
F_53 ( & V_12 -> V_183 ) ;
for ( V_19 = 0 ; V_19 < V_194 ; V_19 ++ ) {
V_135 = F_96 ( V_11 , V_19 ) ;
if ( V_135 < 0 )
return V_135 ;
}
F_112 ( V_206 , V_12 -> V_207 ) ;
F_112 ( V_208 , V_12 -> V_207 ) ;
F_112 ( V_209 , V_12 -> V_207 ) ;
F_112 ( V_210 , V_12 -> V_207 ) ;
V_12 -> V_211
= F_79 ;
V_12 -> V_212 = F_80 ;
V_12 -> V_213 = F_77 ;
...
V_12 -> V_221 = V_222 ;
V_12 -> V_223 = V_222 ;
V_12 -> V_224 = F_10 ( V_60 ) | F_10 ( V_59 ) ;
F_113 ( V_185 , V_11 ) ;
V_135 = F_114 ( V_11 -> V_201 ) ;
if ( V_135 < 0 )
return V_135 ;
F_33 ( V_11 ) ;
V_135 = F_115 ( V_12 ) ;
...
{
struct V_10 * V_11 = F_120 ( V_185 ) ;
int V_19 ;
F_121 ( & V_185 -> V_8 , V_11 -> V_195 , V_11 ) ;
for ( V_19 = 0 ; V_19 < V_11 -> V_35 -> V_194 ; V_19 ++ ) {
struct V_1 * V_2 = V_11 -> V_2 + V_19 ;
F_121 ( & V_185 -> V_8 , V_2 -> V_172 , V_2 ) ;
F_122 ( & V_2 -> V_176 ) ;
}
F_123 ( V_185 -> V_8 . V_189 ) ;
F_117 ( & V_11 -> V_12 ) ;
F_118 ( V_11 -> V_201 ) ;
return 0 ;
}
...
{
struct V_10 * V_11 = F_120 ( F_125 ( V_8 ) ) ;
F_118 ( V_11 -> V_201 ) ;
return 0 ;
}
