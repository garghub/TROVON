...
int F_74 ( struct V_4 * V_15 , struct V_103 * V_104 )
{
unsigned int V_25 ;
unsigned long V_105 ;
struct V_1 * V_2 ;
if ( F_10 ( V_21 * 8 ) !=
F_10 ( V_104 -> V_106 - V_104 -> V_107 ) ) {
F_75 ( L_8 ) ;
return - V_60 ;
}
V_25 = V_104 -> V_108 ;
...
V_105 = F_76 ( V_2 -> V_3 ) ;
V_105 >>= V_59 ;
V_104 -> V_109 |= V_110 | V_111 | V_112 | V_113
| V_114 | V_115 ;
F_6 ( L_10 ) ;
F_6 ( L_11 , V_104 -> V_107 ) ;
F_6 ( L_12 , V_104 -> V_106 ) ;
F_6 ( L_13 , V_105 ) ;
F_6 ( L_14 , V_104 -> V_109 ) ;
F_6 ( L_15 ,
V_104 -> V_106 - V_104 -> V_107 ) ;
V_2 -> V_42 = ( T_1 T_5 * ) V_104 -> V_107 ;
return F_77 ( V_104 , V_104 -> V_107 , V_105 ,
V_104 -> V_106 - V_104 -> V_107 , V_104 -> V_116 ) ;
}
...
void F_84 ( struct V_125 * V_126 , unsigned int V_67 ,
unsigned long V_127 , bool V_128 ,
bool V_129 )
{
struct V_82 V_86 ;
struct V_103 * V_104 ;
...
F_85 ( & V_15 -> V_130 -> V_131 ) ;
V_104 = F_86 ( V_15 -> V_130 , V_127 ) ;
V_86 . V_132 = V_126 -> V_31 ;
V_86 . V_133 = V_127 ;
V_86 . V_134 . V_135 = 1 ;
V_86 . V_134 . V_136 = 0 ;
V_86 . V_134 . V_137 = 0 ;
if ( V_104 ) {
if ( V_104 -> V_107 > V_127 ) {
V_86 . V_134 . V_135 = 1 ;
V_86 . V_134 . V_136 = 0 ;
V_86 . V_134 . V_137 = 0 ;
} else {
V_86 . V_134 . V_135 = 0 ;
if ( V_128 && ! ( V_104 -> V_109 & V_138 ) )
V_86 . V_134 . V_137 = 1 ;
else
V_86 . V_134 . V_137 = 0 ;
if ( V_129 && ! ( V_104 -> V_109 & V_139 ) )
V_86 . V_134 . V_136 = 1 ;
else
V_86 . V_134 . V_136 = 0 ;
}
}
F_87 ( & V_15 -> V_130 -> V_131 ) ;
F_43 ( & V_15 -> V_43 ) ;
F_78 ( V_15 , V_85 ,
& V_86 ) ;
F_45 ( & V_15 -> V_43 ) ;
