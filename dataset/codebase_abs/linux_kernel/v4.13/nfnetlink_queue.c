...
if ( V_109 == NULL )
return NULL ;
if ( V_114 -> V_243 ( V_228 [ V_171 ] , V_109 ) < 0 )
return NULL ;
if ( V_228 [ V_244 ] )
V_114 -> V_245 ( V_228 [ V_244 ] , V_109 ,
...
int V_14 ;
V_14 = F_135 ( V_246 , V_247 , V_228 [ V_85 ] ,
V_248 , NULL ) ;
if ( V_14 < 0 )
return V_14 ;
...
V_50 = F_122 ( F_131 ( V_228 [ V_260 ] ) ) ;
V_255 = F_122 ( F_131 ( V_228 [ V_261 ] ) ) ;
if ( V_50 >= V_262 )
return - V_263 ;
#if ! F_45 ( V_73 )
if ( V_50 & V_255 & V_132 )
...
struct V_268 * V_269 =
F_73 ( V_228 [ V_267 ] ) ;
F_109 ( V_35 , V_269 -> V_25 ,
F_122 ( V_269 -> V_23 ) ) ;
}
if ( V_228 [ V_270 ] ) {
T_6 * V_21 = F_73 ( V_228 [ V_270 ] ) ;
F_29 ( & V_35 -> V_27 ) ;
...
static struct V_222 * F_145 ( struct V_271 * V_272 )
{
...
if ( ! F_147 ( & V_7 -> V_11 [ V_274 -> V_276 ] ) )
return V_7 -> V_11 [ V_274 -> V_276 ] . V_277 ;
}
return NULL ;
}
static struct V_222 * F_148 ( struct V_271 * V_272 , struct V_222 * V_13 )
{
struct V_273 * V_274 = V_272 -> V_275 ;
struct V_2 * V_2 = F_146 ( V_272 ) ;
V_13 = V_13 -> V_44 ;
while ( ! V_13 ) {
struct V_1 * V_7 ;
if ( ++ V_274 -> V_276 >= V_5 )
...
static struct V_222 * F_149 ( struct V_271 * V_272 , T_9 V_278 )
{
struct V_222 * V_9 ;
V_9 = F_145 ( V_272 ) ;
if ( V_9 )
while ( V_278 && ( V_9 = F_148 ( V_272 , V_9 ) ) )
V_278 -- ;
return V_278 ? NULL : V_9 ;
}
static void * F_150 ( struct V_271 * V_279 , T_9 * V_278 )
__acquires( nfnl_queue_pernet( seq_file_net( V_279 )
static void * F_151 ( struct V_271 * V_279 , void * V_280 , T_9 * V_278 )
{
( * V_278 ) ++ ;
return F_148 ( V_279 , V_280 ) ;
}
static void F_152 ( struct V_271 * V_279 , void * V_280 )
__releases( nfnl_queue_pernet( seq_file_net( V_279 )
static int F_153 ( struct V_271 * V_279 , void * V_280 )
{
...
static int F_155 ( struct V_281 * V_281 , struct V_63 * V_63 )
{
return F_156 ( V_281 , V_63 , & V_282 ,
sizeof( struct V_273 ) ) ;
}
...
F_163 ( V_2 ) ;
#ifdef F_159
F_164 ( L_7 , V_2 -> V_283 . V_284 ) ;
#endif
}
static void F_165 ( struct V_287 * V_288 )
{
F_166 () ;
}
