...
static int
F_32 ( struct V_60 * V_60 , struct V_20 * V_21 , struct V_36 * V_37 [] ,
T_1 V_13 )
{
struct V_1 * V_9 ;
...
V_21 -> V_10 = F_36 ( V_21 , V_37 , 0 , 0 ) ;
V_9 = F_31 ( sizeof( * V_9 ) + V_55 * V_21 -> V_10 ) ;
if ( ! V_9 )
return - V_69 ;
V_9 -> V_56 = F_37 ( 0 , V_55 - 1 ) ;
V_21 -> V_30 = & V_1 ;
