...
V_106 = F_46 ( V_85 -> V_93 , V_6 , & V_3 ) ;
V_107 = ( V_3 & 0xFF ) << 12 ;
V_106 = F_46 ( V_85 -> V_93 , V_115 , & V_3 ) ;
V_107 |= ( V_3 & 0xFF ) << 4 ;
V_106 = F_46 ( V_85 -> V_93 , V_7 , & V_3 ) ;
V_107 |= ( V_3 & 0xF0 ) >> 4 ;
if ( V_107 != V_116 ) {
V_106 = - V_117 ;
F_16 ( & V_103 -> V_2 ,
...
static int F_49 ( struct V_103 * V_120 )
{
F_50 ( & V_120 -> V_2 ) ;
return 0 ;
}
