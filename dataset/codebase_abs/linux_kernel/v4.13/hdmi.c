...
V_1 -> V_10 = F_43 ( V_19 -> V_24 . V_25 , 0 ) ;
if ( V_1 -> V_10 < 0 ) {
V_34 = V_1 -> V_10 ;
F_19 ( V_24 -> V_24 , L_20 , V_34 ) ;
goto V_37;
}
V_34 = F_44 ( & V_19 -> V_24 , V_1 -> V_10 ,
F_6 , V_69 | V_70 ,
L_21 , V_1 ) ;
if ( V_34 < 0 ) {
F_19 ( V_24 -> V_24 , L_22 ,
...
static int F_46 ( struct V_22 * V_25 , const char * V_77 )
{
int V_78 ;
V_78 = F_47 ( V_25 , V_77 , 0 ) ;
if ( V_78 < 0 ) {
char V_79 [ 32 ] ;
snprintf ( V_79 , sizeof( V_79 ) , L_23 , V_77 ) ;
V_78 = F_47 ( V_25 , V_79 , 0 ) ;
if ( V_78 < 0 ) {
char V_80 [ 32 ] ;
if ( sscanf ( V_79 , L_24 , V_80 ) )
V_78 = F_47 ( V_25 , V_80 , 0 ) ;
}
if ( V_78 < 0 ) {
F_5 ( L_25 , V_77 , V_78 ) ;
V_78 = - 1 ;
...
static int F_48 ( struct V_81 * V_24 , void * V_82 ,
struct V_83 * V_84 ,
struct V_85 * V_86 )
{
struct V_1 * V_1 = F_49 ( V_24 ) ;
unsigned int V_87 ;
unsigned int V_88 = 0 ;
unsigned int V_89 ;
unsigned int V_90 = 0 ;
bool V_91 = false ;
F_50 ( V_24 , L_26 , V_86 -> V_92 ,
...
F_51 ( V_1 , V_89 ) ;
F_52 ( V_1 , 1 , V_87 , V_88 ,
V_90 , V_91 ) ;
return 0 ;
}
static void F_53 ( struct V_81 * V_24 , void * V_82 )
{
struct V_1 * V_1 = F_49 ( V_24 ) ;
F_52 ( V_1 , 0 , 0 , 0 , 0 , 0 ) ;
}
static int F_54 ( struct V_1 * V_1 , struct V_81 * V_24 )
{
V_1 -> V_108 = F_55 ( V_24 ,
V_109 ,
V_110 ,
& V_111 ,
sizeof( V_111 ) ) ;
return F_56 ( V_1 -> V_108 ) ;
}
static int F_57 ( struct V_81 * V_24 , struct V_81 * V_112 , void * V_82 )
{
struct V_60 * V_113 = F_49 ( V_112 ) ;
...
V_114 -> V_117 [ V_33 ] . V_118 = F_46 ( V_25 ,
V_119 [ V_33 ] . V_77 ) ;
...
static void F_61 ( struct V_81 * V_24 , struct V_81 * V_112 ,
void * V_82 )
{
struct V_60 * V_113 = F_49 ( V_112 ) ;
struct V_63 * V_64 = V_113 -> V_65 ;
...
static int F_63 ( struct V_20 * V_19 )
{
return F_64 ( & V_19 -> V_24 , & V_123 ) ;
}
static int F_65 ( struct V_20 * V_19 )
{
F_66 ( & V_19 -> V_24 , & V_123 ) ;
return 0 ;
}
void T_3 F_67 ( void )
{
