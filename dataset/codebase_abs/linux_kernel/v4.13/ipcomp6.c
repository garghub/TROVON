...
F_8 ( V_2 , V_8 , V_7 , 0 , 0 , F_7 ( V_8 , NULL ) ) ;
F_9 ( V_17 ) ;
return 0 ;
}
static struct V_16 * F_10 ( struct V_16 * V_17 )
{
struct V_8 * V_8 = F_11 ( V_17 ) ;
struct V_16 * V_27 = NULL ;
V_27 = F_12 ( V_8 ) ;
if ( ! V_27 )
goto V_28;
V_27 -> V_29 . V_30 = V_31 ;
V_27 -> V_29 . V_10 = F_13 ( V_8 , ( V_22 * ) & V_17 -> V_32 . V_33 ) ;
if ( ! V_27 -> V_29 . V_10 )
goto error;
...
V_10 = F_17 ( V_8 , ( V_22 * ) & V_17 -> V_32 . V_33 ) ;
if ( V_10 )
...
static int F_23 ( struct V_1 * V_2 , int V_43 )
{
return 0 ;
}
