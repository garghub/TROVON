...
struct V_374 * V_375 )
{
struct V_376 * V_377 = & V_375 -> V_377 ;
struct V_70 * V_71 = V_79 -> V_71 ;
struct V_207 V_208 ;
T_1 * V_378 = NULL ;
int V_21 , V_284 = 0 ;
...
if ( V_377 -> V_379 ) {
V_208 . V_177 = V_262 ;
V_378 = V_377 -> V_380 [ 0 ] . V_378 ;
V_284 = V_377 -> V_380 [ 0 ] . V_269 ;
} else {
V_208 . V_177 = V_211 ;
}
if ( V_284 ) {
memcpy ( V_208 . V_244 , V_378 , V_284 ) ;
V_208 . V_243 = V_284 ;
}
V_208 . V_180 = F_38 ( V_71 -> V_213 ) ;
V_208 . V_181 = F_38 ( V_71 -> V_214 ) ;
...
static int F_124 ( struct V_345 * V_79 , T_2 V_381 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
F_13 ( V_313 , L_148 ,
V_37 , V_79 -> V_382 . V_383 . V_384 -> V_358 ) ;
F_39 ( V_313 , V_71 -> V_209 , V_75 , L_149 ) ;
F_84 ( & V_71 -> V_279 ) ;
V_71 -> V_210 = V_79 -> V_382 . V_383 . V_384 -> V_358 ;
if ( F_101 ( V_71 -> V_209 ) )
F_99 ( V_71 ) ;
else
F_63 ( V_71 ) ;
...
if ( ! ( V_381 & V_386 ) )
return;
F_39 ( V_313 , V_382 -> V_209 , V_75 , L_149 ) ;
F_84 ( & V_71 -> V_279 ) ;
memcpy ( V_71 -> V_209 , V_382 -> V_209 , V_75 ) ;
if ( F_101 ( V_71 -> V_209 ) )
F_99 ( V_71 ) ;
F_85 ( & V_71 -> V_279 ) ;
}
...
{
int V_21 = 0 ;
struct V_141 * V_391 = & V_71 -> V_116 . V_53 . V_392 ;
...
V_391 -> V_143 = V_71 -> V_247 ;
V_391 -> V_144 = V_71 -> V_248 ;
memcpy ( V_391 -> V_153 , V_71 -> V_271 ,
sizeof( V_71 -> V_271 ) ) ;
V_21 = F_45 ( V_71 , & V_71 -> V_116 ) ;
if ( V_21 < 0 )
F_30 ( V_71 -> V_79 -> V_80 ,
...
static int F_128 ( struct V_345 * V_79 , enum V_393 V_85 ,
struct V_366 * V_367 , struct V_394 * V_395 ,
struct V_396 * V_397 )
{
struct V_70 * V_71 = V_79 -> V_71 ;
int V_73 ;
F_13 ( V_313 , L_153
L_154 ,
V_37 , V_85 , V_397 -> V_398 , V_397 -> V_399 , V_397 -> V_400 ) ;
if ( ( V_397 -> V_398 != V_401 ) &&
( V_397 -> V_398 != V_402 ) )
return - V_370 ;
V_397 -> V_403 = V_397 -> V_399 ;
F_84 ( & V_71 -> V_279 ) ;
switch ( V_85 ) {
case V_404 :
memcpy ( V_71 -> V_271 [ V_397 -> V_399 ] , V_397 -> V_397 , V_397 -> V_400 ) ;
V_71 -> V_249 [ V_397 -> V_399 ] = V_397 -> V_400 ;
V_71 -> V_248 = V_397 -> V_399 ;
break;
case V_405 :
default:
V_71 -> V_249 [ V_397 -> V_399 ] = 0 ;
break;
}
V_71 -> V_247 = 0 ;
for ( V_73 = 0 ; V_73 < V_152 ; V_73 ++ ) {
...
struct V_345 * V_79 ;
struct V_70 * V_71 ;
V_79 = F_130 ( sizeof( struct V_70 ) , & V_406 ) ;
if ( ! V_79 ) {
...
struct V_408 * V_409 )
{
struct V_410 * V_411 , * V_412 , * V_413 ;
int V_73 ;
int V_414 ;
struct V_415 * V_416 ;
F_13 ( V_417 , L_157 , V_37 ) ;
F_13 ( V_299 , L_158 , V_37 ,
V_409 -> V_418 [ 0 ] . V_419 . V_420 ) ;
V_412 = NULL ;
V_413 = NULL ;
V_416 = V_409 -> V_421 ;
for ( V_73 = 0 ; V_73 < V_416 -> V_419 . V_420 ; V_73 ++ ) {
V_411 = & V_416 -> V_411 [ V_73 ] . V_419 ;
F_13 ( V_299 , L_159 ,
V_37 , V_73 , V_411 -> V_422 ,
V_411 -> V_423 ) ;
if ( ! V_412 && F_137 ( V_411 ) )
V_412 = V_411 ;
if ( ! V_413 && F_138 ( V_411 ) )
V_413 = V_411 ;
}
if ( ! V_412 || ! V_413 ) {
F_14 ( & V_409 -> V_38 , L_160 ) ;
return - V_424 ;
}
V_71 -> V_226 = F_139 ( V_71 -> V_10 , V_412 -> V_422 ) ;
V_71 -> V_362 = F_140 ( V_71 -> V_10 , V_413 -> V_422 ) ;
V_71 -> V_223 = F_141 ( 0 , V_40 ) ;
V_71 -> V_354 = F_141 ( 0 , V_40 ) ;
if ( ! V_71 -> V_223 || ! V_71 -> V_354 ) {
F_14 ( & V_409 -> V_38 , L_161 ) ;
return - V_41 ;
}
V_414 = sizeof( struct V_348 ) + V_425 ;
V_71 -> V_350 = F_15 ( V_414 , V_40 ) ;
if ( ! V_71 -> V_350 )
return - V_41 ;
F_13 ( V_417 , L_162 , V_37 ) ;
return 0 ;
}
...
int V_21 ;
F_13 ( V_229 , L_163 ,
V_409 -> V_421 -> V_419 . V_420 ) ;
V_21 = F_136 ( V_71 , V_409 ) ;
if ( V_21 < 0 )
goto exit;
V_21 = F_29 ( V_71 ) ;
if ( V_21 < 0 ) {
F_14 ( & V_409 -> V_38 , L_164 ) ;
goto exit;
}
V_71 -> V_426 = F_31 ( V_71 -> V_76 ) ;
V_71 -> V_210 = V_427 ;
V_71 -> V_245 = V_369 ;
V_71 -> V_130 = V_428 ;
V_71 -> V_128 = V_429 ;
...
V_71 -> V_278 = 0 ;
V_80 = V_71 -> V_79 -> V_80 ;
V_71 -> V_79 -> V_80 -> V_434 = 1 ;
V_71 -> V_79 -> V_80 -> V_435 = 0 ;
V_71 -> V_79 -> V_80 -> V_436 = F_143 ( V_368 ) ;
V_71 -> V_79 -> V_80 -> V_437 [ V_294 ] = & V_438 ;
F_144 ( V_71 -> V_79 , V_439 ) ;
F_144 ( V_71 -> V_79 , V_440 ) ;
V_71 -> V_79 -> V_441 = 100 ;
F_145 ( V_71 -> V_79 , & V_409 -> V_38 ) ;
F_146 ( V_71 -> V_79 , V_71 -> V_74 ) ;
...
F_149 ( & V_409 -> V_38 ) , V_71 -> V_74 ,
V_71 -> V_324 . V_325 , V_71 -> V_324 . V_326 ,
V_71 -> V_324 . V_327 , V_71 -> V_324 . V_328 ) ;
F_47 ( V_71 -> V_79 -> V_80 , L_168 ,
V_71 -> V_76 , V_71 -> V_426 -> V_446 ) ;
exit:
return V_21 ;
}
...
int V_1 = ( int ) V_448 -> V_452 ;
V_10 = F_158 ( F_159 ( V_409 ) ) ;
V_451 = F_15 ( sizeof( * V_451 ) , V_40 ) ;
if ( ! V_451 ) {
V_21 = - V_41 ;
goto exit;
}
...
|| ( V_64 == V_455 ) ) {
V_21 = F_33 ( V_10 , V_456 , V_451 , sizeof( * V_451 ) ) ;
if ( V_21 < 0 || ( V_451 -> V_325 | V_451 -> V_326 ) == 0 )
V_449 = 1 ;
} else
V_449 = 1 ;
if ( V_449 ) {
...
F_160 ( V_409 , V_71 ) ;
memcpy ( & V_71 -> V_324 , V_451 , sizeof( struct V_450 ) ) ;
V_71 -> V_1 = V_1 ;
V_21 = F_142 ( V_71 , V_409 ) ;
if ( V_21 < 0 )
F_150 ( V_71 ) ;
exit:
F_18 ( V_451 ) ;
