...
static int F_114 ( unsigned int V_277 )
{
struct V_9 * V_10 = & F_115 ( V_9 , V_277 ) ;
if ( V_17 ) {
...
F_45 ( L_13 ,
V_67 -> V_142 ) ;
V_278 . V_279 = V_17 -> V_279 ;
#ifdef V_47
if ( F_117 () & V_47 )
V_48 = V_49 ;
#endif
F_118 ( & V_278 , L_14 , V_249 ) ;
F_119 ( V_280 , L_15 ,
F_114 , NULL ) ;
return 0 ;
}
