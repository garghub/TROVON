...
static int F_12 ( struct V_1 * V_2 , struct V_52 * V_53 )
{
unsigned int V_34 ;
for ( V_34 = 0 ; V_34 < F_13 ( V_54 ) ; V_34 ++ )
V_54 [ V_34 ] . V_43 = V_2 ;
return F_14 ( V_54 ,
F_13 ( V_54 ) ,
V_53 -> V_55 , V_53 ) ;
}
static void F_15 ( struct V_56 * V_57 )
{
...
{
struct V_1 * V_2 = V_57 -> V_58 ;
struct V_74 * V_75 = F_20 ( V_2 -> V_76 -> V_77 ) ;
...
V_80 = F_22 ( V_2 -> V_63 , V_78 ) ;
if ( V_80 < 0 ) {
F_2 ( L_10 , V_78 ) ;
return;
}
V_80 = F_22 ( V_2 -> V_64 , V_78 ) ;
if ( V_80 < 0 ) {
F_2 ( L_11 , V_78 ) ;
return;
}
...
static enum V_98
F_28 ( struct V_86 * V_87 , bool V_99 )
{
struct V_88 * V_89
= F_25 ( V_87 ) ;
struct V_1 * V_2 = V_89 -> V_2 ;
...
= F_25 ( V_87 ) ;
struct V_1 * V_2 = V_89 -> V_2 ;
if ( F_12 ( V_2 , V_2 -> V_103 -> V_104 ) ) {
F_2 ( L_14 ) ;
return - V_31 ;
}
return 0 ;
}
static struct V_105 * F_32 ( struct V_106 * V_107 )
{
struct V_105 * V_76 ;
F_33 (encoder, &dev->mode_config.encoder_list, head) {
if ( V_76 -> V_108 == V_109 )
return V_76 ;
}
return NULL ;
}
static int F_34 ( struct V_110 * V_107 , struct V_110 * V_111 , void * V_43 )
{
struct V_1 * V_2 = F_35 ( V_107 ) ;
...
if ( ! V_76 )
return - V_113 ;
V_87 = F_36 ( V_107 , sizeof( * V_87 ) , V_114 ) ;
if ( ! V_87 )
return - V_113 ;
V_87 -> V_2 = V_2 ;
V_57 = F_36 ( V_107 , sizeof( * V_57 ) , V_114 ) ;
if ( ! V_57 )
return - V_113 ;
V_57 -> V_58 = V_2 ;
V_57 -> V_61 = & V_115 ;
...
static void F_43 ( struct V_110 * V_107 ,
...
F_45 ( L_18 , V_129 ) ;
V_2 = F_36 ( V_107 , sizeof( * V_2 ) , V_114 ) ;
if ( ! V_2 ) {
F_2 ( L_19 ) ;
return - V_113 ;
}
V_2 -> V_107 = V_124 -> V_107 ;
V_126 = F_46 ( V_124 , V_130 , L_20 ) ;
if ( ! V_126 ) {
F_2 ( L_21 ) ;
return - V_113 ;
}
V_2 -> V_35 = F_47 ( V_107 , V_126 -> V_131 ,
F_48 ( V_126 ) ) ;
if ( ! V_2 -> V_35 )
return - V_113 ;
V_2 -> V_63 = F_49 ( V_107 , L_22 ) ;
if ( F_50 ( V_2 -> V_63 ) ) {
F_2 ( L_23 ) ;
return F_51 ( V_2 -> V_63 ) ;
}
V_2 -> V_64 = F_49 ( V_107 , L_24 ) ;
if ( F_50 ( V_2 -> V_64 ) ) {
F_2 ( L_25 ) ;
return F_51 ( V_2 -> V_64 ) ;
}
V_2 -> V_83 = F_49 ( V_107 , L_26 ) ;
if ( F_50 ( V_2 -> V_83 ) ) {
F_4 ( L_27 ) ;
V_2 -> V_83 = NULL ;
}
V_2 -> V_84 = F_49 ( V_107 , L_28 ) ;
if ( F_50 ( V_2 -> V_84 ) ) {
F_4 ( L_29 ) ;
V_2 -> V_84 = NULL ;
}
V_2 -> V_100 = F_52 ( V_128 , L_30 , 0 ) ;
if ( ! V_2 -> V_100 )
F_2 ( L_31 ) ;
F_53 ( V_2 -> V_100 ) ;
F_54 ( V_124 , V_2 ) ;
return F_55 ( & V_124 -> V_107 , & V_132 ) ;
}
static int F_56 ( struct V_123 * V_124 )
{
F_57 ( & V_124 -> V_107 , & V_132 ) ;
return 0 ;
}
