...
static int F_30 ( struct V_57 * V_58 , void * V_59 )
{
F_31 ( V_58 , L_6 , V_60 ) ;
return 0 ;
}
static T_1 F_32 ( struct V_61 * V_61 , const char T_2 * V_62 ,
T_3 V_63 , T_4 * V_64 )
{
unsigned long V_65 ;
int V_17 = F_33 ( V_62 , V_63 , 0 , & V_65 ) ;
if ( V_17 )
return V_17 ;
V_60 = V_65 ;
return V_63 ;
}
static int F_34 ( struct V_66 * V_66 , struct V_61 * V_61 )
{
return F_35 ( V_61 , F_30 , NULL ) ;
}
int T_5 F_36 ( void )
{
struct V_67 * V_68 ;
V_60 = V_69 ;
V_70 = F_37 ( V_71 , V_72 . V_73 ) ;
if ( V_70 == NULL ) {
F_12 ( L_7 V_71
L_8 ) ;
return - V_74 ;
}
V_68 = F_38 ( L_9 , V_75 | V_76 ,
V_70 , & V_77 ) ;
if ( ! V_68 ) {
F_39 ( V_71 , V_72 . V_73 ) ;
V_70 = NULL ;
