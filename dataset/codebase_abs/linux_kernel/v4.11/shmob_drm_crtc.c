...
int V_3 ;
V_2 -> V_7 . V_126 = V_139 ;
V_3 = F_41 ( V_2 -> V_83 , V_7 , & V_151 ) ;
if ( V_3 < 0 )
return V_3 ;
F_42 ( V_7 , & V_152 ) ;
return 0 ;
}
static void F_43 ( struct V_153 * V_154 , int V_15 )
{
struct V_155 * V_156 = F_44 ( V_154 ) ;
struct V_1 * V_2 = V_154 -> V_8 -> V_9 ;
...
static bool F_46 ( struct V_153 * V_154 ,
const struct V_14 * V_15 ,
struct V_14 * V_140 )
{
struct V_82 * V_8 = V_154 -> V_8 ;
struct V_1 * V_2 = V_8 -> V_9 ;
struct V_160 * V_159 = & V_2 -> V_159 . V_159 ;
const struct V_14 * V_161 ;
if ( F_47 ( & V_159 -> V_162 ) ) {
F_28 ( V_8 -> V_8 , L_2 ) ;
return false ;
}
V_161 = F_48 ( & V_159 -> V_162 ,
struct V_14 , V_163 ) ;
F_49 ( V_140 , V_161 ) ;
return true ;
}
...
static void F_52 ( struct V_153 * V_154 )
{
}
...
{
struct V_153 * V_154 = & V_2 -> V_154 . V_154 ;
int V_3 ;
V_2 -> V_154 . V_126 = V_139 ;
V_154 -> V_164 = 1 ;
V_3 = F_56 ( V_2 -> V_83 , V_154 , & V_165 ,
V_166 , NULL ) ;
if ( V_3 < 0 )
return V_3 ;
F_57 ( V_154 , & V_167 ) ;
...
void F_58 ( struct V_1 * V_2 , bool V_168 )
{
unsigned long V_18 ;
T_1 V_169 ;
F_34 ( & V_2 -> V_170 , V_18 ) ;
V_169 = F_8 ( V_2 , V_91 ) | V_171 ;
if ( V_168 )
V_169 |= V_172 ;
else
V_169 &= ~ V_172 ;
...
static int F_59 ( struct V_160 * V_159 )
{
...
if ( V_15 == NULL )
return 0 ;
V_15 -> type = V_173 | V_174 ;
V_15 -> clock = V_2 -> V_12 -> V_175 . V_15 . clock ;
V_15 -> V_60 = V_2 -> V_12 -> V_175 . V_15 . V_60 ;
V_15 -> V_64 = V_2 -> V_12 -> V_175 . V_15 . V_64 ;
V_15 -> V_63 = V_2 -> V_12 -> V_175 . V_15 . V_63 ;
V_15 -> V_61 = V_2 -> V_12 -> V_175 . V_15 . V_61 ;
V_15 -> V_67 = V_2 -> V_12 -> V_175 . V_15 . V_67 ;
V_15 -> V_71 = V_2 -> V_12 -> V_175 . V_15 . V_71 ;
V_15 -> V_70 = V_2 -> V_12 -> V_175 . V_15 . V_70 ;
V_15 -> V_68 = V_2 -> V_12 -> V_175 . V_15 . V_68 ;
V_15 -> V_18 = V_2 -> V_12 -> V_175 . V_15 . V_18 ;
F_61 ( V_15 ) ;
F_62 ( V_159 , V_15 ) ;
V_159 -> V_176 . V_177 = V_2 -> V_12 -> V_175 . V_177 ;
V_159 -> V_176 . V_178 = V_2 -> V_12 -> V_175 . V_178 ;
return 1 ;
}
static struct V_153 *
F_63 ( struct V_160 * V_159 )
{
struct V_157 * V_158 = F_64 ( V_159 ) ;
return V_158 -> V_154 ;
}
static void F_65 ( struct V_160 * V_159 )
{
struct V_157 * V_158 = F_64 ( V_159 ) ;
F_66 ( V_158 ) ;
F_67 ( V_159 ) ;
...
struct V_160 * V_159 = & V_2 -> V_159 . V_159 ;
int V_3 ;
V_2 -> V_159 . V_154 = V_154 ;
V_159 -> V_176 . V_177 = V_2 -> V_12 -> V_175 . V_177 ;
V_159 -> V_176 . V_178 = V_2 -> V_12 -> V_175 . V_178 ;
V_3 = F_70 ( V_2 -> V_83 , V_159 , & V_179 ,
V_180 ) ;
if ( V_3 < 0 )
return V_3 ;
F_71 ( V_159 , & V_181 ) ;
...
if ( V_3 < 0 )
goto V_183;
V_3 = F_74 ( V_159 , V_154 ) ;
if ( V_3 < 0 )
goto V_184;
F_75 ( V_159 , V_139 ) ;
F_76 ( & V_159 -> V_185 ,
V_2 -> V_83 -> V_186 . V_187 , V_139 ) ;
return 0 ;
V_184:
F_66 ( & V_2 -> V_159 ) ;
V_183:
