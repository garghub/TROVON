...
void F_60 ( struct V_32 * log , T_1 V_82 )
{
struct V_1 * V_75 ;
int V_77 = V_82 % 2 ;
F_25 ( & log -> V_79 [ V_77 ] ) ;
...
while ( ! F_30 ( & V_2 -> V_45 ) ) {
V_87 = V_2 -> V_45 . V_88 ;
V_61 = F_65 ( V_87 , struct V_60 , V_45 ) ;
F_66 ( & V_61 -> V_45 ) ;
F_67 ( V_61 ) ;
}
F_68 ( V_34 , V_2 ) ;
...
{
struct V_1 * V_75 ;
V_75 = F_76 ( V_96 , struct V_1 , V_97 ) ;
F_77 ( V_75 -> V_13 , V_75 , 1 ) ;
F_78 ( & V_75 -> V_48 ) ;
}
int F_79 ( struct V_32 * V_7 , int V_98 ,
...
int F_91 ( struct V_16 * V_17 , int V_98 ,
const T_1 V_99 , const T_1 V_100 )
{
struct V_32 * V_7 ;
struct V_72 V_101 ;
...
V_26 = F_97 ( V_13 , V_28 , V_113 ) ;
if ( V_26 )
return V_26 ;
V_112 = F_98 ( V_13 -> V_83 , V_28 , V_113 ) ;
V_74 = V_113 ;
while ( 1 ) {
V_75 = F_99 ( V_13 , V_74 ) ;
if ( ! V_75 )
...
V_117 = F_107 ( T_1 , V_15 , V_118 ) ;
if ( V_75 && V_75 -> V_121 > V_117 )
V_117 = F_107 ( T_1 , V_75 -> V_121 , V_118 ) ;
...
int F_108 ( struct V_13 * V_13 , T_1 V_15 , T_1 V_123 ,
T_3 * V_61 , int V_4 )
{
struct V_60 * V_124 ;
struct V_1 * V_75 ;
...
unsigned long V_125 ;
unsigned long V_126 ;
T_3 V_127 = F_106 ( V_13 ) ;
int V_77 = 0 ;
V_75 = F_100 ( V_13 , V_15 ) ;
if ( ! V_75 )
return 0 ;
F_25 ( & V_25 -> V_51 ) ;
...
V_125 = V_124 -> V_4 >>
V_13 -> V_18 -> V_129 ;
V_125 = F_107 ( int , V_4 - V_77 , V_125 - V_126 ) ;
