...
if ( V_104 == NULL )
return - V_113 ;
V_112 = F_58 ( V_106 , V_107 , V_104 , V_114 ) ;
if ( V_112 < 0 )
return V_112 ;
if ( V_106 [ V_115 ] ) {
...
V_103 -> V_91 . V_132 = F_47 ;
V_103 -> V_91 . V_133 = ( unsigned long ) V_103 ;
F_70 ( & V_103 -> V_91 ) ;
...
V_103 -> V_78 = V_78 ;
if ( V_106 [ V_134 ] )
V_103 -> V_81 = F_59 ( V_106 [ V_134 ] ) ;
if ( V_106 [ V_135 ] )
V_103 -> V_82 = F_59 ( V_106 [ V_135 ] ) ;
if ( V_106 [ V_136 ] )
V_103 -> V_83 = F_59 ( V_106 [ V_136 ] ) ;
if ( V_106 [ V_137 ] )
V_103 -> V_84 = F_59 ( V_106 [ V_137 ] ) ;
if ( V_106 [ V_138 ] )
V_103 -> V_85 = F_59 ( V_106 [ V_138 ] ) ;
if ( V_87 )
V_103 -> V_87 = V_87 ;
V_103 -> V_90 = V_90 ;
if ( V_90 )
...
if ( * V_89 == 0 )
F_75 ( & V_103 -> V_139 , & V_65 -> V_140 ) ;
else
F_76 ( & V_102 -> V_139 , & V_103 -> V_139 ) ;
...
static int F_78 ( struct V_60 * V_61 , unsigned long V_89 )
{
struct V_67 * V_68 = (struct V_67 * ) V_89 ;
F_79 ( & V_68 -> V_139 ) ;
F_77 ( & V_68 -> V_94 , F_50 ) ;
...
static bool F_83 ( struct V_60 * V_61 , bool V_141 )
{
struct V_64 * V_65 = F_57 ( V_61 -> V_66 ) ;
struct V_67 * V_68 , * V_142 ;
if ( ! V_141 && ! F_84 ( & V_65 -> V_140 ) )
return false ;
...
static int F_89 ( struct V_95 * V_95 , struct V_60 * V_61 , unsigned long V_143 ,
struct V_4 * V_5 , struct V_144 * V_111 )
{
struct V_67 * V_68 = (struct V_67 * ) V_143 ;
struct V_99 * V_145 ;
if ( V_68 == NULL )
return V_5 -> V_146 ;
V_111 -> V_147 = V_68 -> V_98 ;
V_145 = F_90 ( V_5 , V_105 ) ;
if ( V_145 == NULL )
goto V_148;
...
if ( F_91 ( V_5 , V_134 , V_68 -> V_81 ) ||
F_91 ( V_5 , V_135 , V_68 -> V_82 ) )
goto V_148;
}
if ( V_68 -> V_83 &&
F_91 ( V_5 , V_136 , V_68 -> V_83 ) )
goto V_148;
if ( V_68 -> V_84 &&
F_91 ( V_5 , V_137 , V_68 -> V_84 ) )
goto V_148;
if ( V_68 -> V_85 &&
F_91 ( V_5 , V_138 , V_68 -> V_85 ) )
goto V_148;
if ( V_68 -> V_87 &&
...
static void F_98 ( struct V_60 * V_61 , struct V_151 * V_89 )
{
struct V_64 * V_65 = F_57 ( V_61 -> V_66 ) ;
struct V_67 * V_68 ;
F_88 (f, &head->filters, list) {
if ( V_89 -> V_152 < V_89 -> V_153 )
goto V_153;
if ( V_89 -> V_154 ( V_61 , ( unsigned long ) V_68 , V_89 ) < 0 ) {
V_89 -> V_155 = 1 ;
break;
}
V_153:
