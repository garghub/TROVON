...
return V_14 ;
V_124 = V_91 ;
V_14 = F_54 ( & V_124 , V_76 ) ;
if ( V_14 )
return V_14 ;
return F_58 ( & V_124 , & V_91 ) ;
}
if ( F_64 () ) {
...
F_47 ( & V_47 -> V_48 ) ;
F_84 ( & V_47 -> V_48 ) ;
V_156 = F_92 ( L_55 , NULL ) ;
if ( V_156 != NULL )
F_93 ( L_56 , 0444 , V_156 , NULL ,
& V_157 ) ;
if ( F_94 () != V_158 )
return 0 ;
V_67 = F_40 ( V_68 ) ;
...
if ( V_148 ) {
struct V_159 V_70 ;
memset ( & V_70 , 0 , sizeof( struct V_159 ) ) ;
V_70 . type = V_160 ;
V_70 . V_146 = V_148 ;
V_161 = F_95 ( L_57 ,
& V_47 -> V_48 ,
