...
F_37 ( V_2 , V_4 , V_41 , & V_43 , F_27 ( V_41 -> V_47 ) ) ;
return V_83 ;
}
return V_93 ;
}
static unsigned int F_48 ( void * V_94 ,
struct V_3 * V_4 ,
...
return V_101 ;
V_12 = F_20 ( V_4 ) -> V_12 ;
V_82 = F_52 ( V_4 , sizeof( struct V_1 ) , & V_12 ,
& V_100 ) ;
if ( V_82 < 0 )
return V_101 ;
...
if ( V_41 == NULL )
return V_83 ;
V_66 = & V_97 -> V_102 . V_103 ;
switch ( V_66 -> V_66 ) {
case V_104 :
if ( V_41 -> V_87 && ! F_53 ( V_105 , & V_97 -> V_106 ) ) {
F_54 ( V_97 , V_18 , V_99 -> V_107 -
F_27 ( V_41 -> V_47 ) + 1 ) ;
break;
}
...
F_27 ( V_41 -> V_47 ) + 1 ) )
F_39 ( V_60 -> V_71 -> V_111 ) ;
return V_83 ;
}
V_99 -> V_107 = F_27 ( V_41 -> V_48 ) ;
if ( V_43 . V_51 & V_75 )
V_99 -> V_112 = V_43 . V_113 ;
break;
case V_114 :
if ( ! V_41 -> V_84 || ! V_41 -> V_85 )
break;
...
return V_83 ;
if ( V_43 . V_51 & V_75 )
V_99 -> V_108 = V_43 . V_115 - V_99 -> V_112 ;
V_43 . V_51 &= ~ ( V_74 |
V_91 |
V_92 ) ;
F_56 ( V_43 . V_115 , V_43 . V_113 ) ;
F_33 ( V_2 , V_66 , V_4 , V_41 , & V_43 ) ;
F_54 ( V_97 , V_18 , V_99 -> V_107 - F_27 ( V_41 -> V_47 ) ) ;
F_56 ( V_43 . V_115 , V_43 . V_113 ) ;
...
F_58 ( V_4 , V_82 , V_41 , V_97 , V_18 , V_99 ) ;
return V_101 ;
}
static int F_59 ( const struct V_117 * V_77 )
{
const struct V_118 * V_119 = V_77 -> V_120 ;
if ( ! ( V_119 -> V_10 . V_121 & V_122 ) ||
V_119 -> V_10 . V_102 != V_13 ||
V_119 -> V_10 . V_123 & V_124 )
return - V_125 ;
return F_60 ( V_77 -> V_2 , V_77 -> V_126 ) ;
}
static void F_61 ( const struct V_127 * V_77 )
{
F_62 ( V_77 -> V_2 , V_77 -> V_126 ) ;
}
