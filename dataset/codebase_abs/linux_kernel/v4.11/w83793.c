...
int V_24 = V_17 -> V_18 & 0x07 ;
T_2 V_1 ;
if ( V_23 == V_25 ) {
V_1 = ( V_9 -> V_26 [ V_18 ] >> ( V_24 ) ) & 1 ;
} else {
V_1 = ( V_9 -> V_27 [ V_18 ] >> ( V_24 ) ) & 1 ;
}
...
const char * V_14 , T_5 V_20 )
{
struct V_28 * V_29 = F_21 ( V_11 ) ;
struct V_8 * V_9 = F_22 ( V_29 ) ;
struct V_16 * V_17 =
F_15 ( V_13 ) ;
int V_18 = V_17 -> V_18 >> 3 ;
int V_30 = V_17 -> V_18 & 0x07 ;
T_2 V_31 = 1 << V_30 ;
unsigned long V_1 ;
int V_21 ;
V_21 = F_18 ( V_14 , 10 , & V_1 ) ;
...
return - V_22 ;
F_23 ( & V_9 -> V_32 ) ;
V_9 -> V_27 [ V_18 ] = F_24 ( V_29 , F_25 ( V_18 ) ) ;
V_9 -> V_27 [ V_18 ] &= ~ V_31 ;
V_9 -> V_27 [ V_18 ] |= V_1 << V_30 ;
F_26 ( V_29 , F_25 ( V_18 ) , V_9 -> V_27 [ V_18 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
static T_4
...
return - V_22 ;
F_23 ( & V_9 -> V_32 ) ;
V_9 -> V_33 = F_24 ( V_29 , V_34 )
& 0xfd ;
V_9 -> V_33 |= V_1 << 1 ;
F_26 ( V_29 , V_34 , V_9 -> V_33 ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
static T_4
...
F_26 ( V_29 , F_33 ( V_18 ) ,
( V_1 >> 8 ) & 0xff ) ;
F_26 ( V_29 , F_33 ( V_18 ) + 1 , V_1 & 0xff ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
static T_4
...
V_9 -> V_42 [ V_18 ] [ V_23 ] =
F_24 ( V_29 , F_37 ( V_18 , V_23 ) ) & 0xc0 ;
V_9 -> V_42 [ V_18 ] [ V_23 ] |= V_1 ;
F_26 ( V_29 , F_37 ( V_18 , V_23 ) ,
V_9 -> V_42 [ V_18 ] [ V_23 ] ) ;
}
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
...
int V_18 = V_17 -> V_18 ;
struct V_8 * V_9 = F_14 ( V_11 ) ;
long V_43 = F_6 ( V_9 -> V_43 [ V_18 ] [ V_23 ] ) ;
if ( V_23 == V_44 && V_18 < 4 ) {
...
return V_21 ;
F_23 ( & V_9 -> V_32 ) ;
V_9 -> V_43 [ V_18 ] [ V_23 ] = F_7 ( V_47 , - 128 , 127 ) ;
F_26 ( V_29 , V_48 [ V_18 ] [ V_23 ] ,
V_9 -> V_43 [ V_18 ] [ V_23 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
...
T_2 V_30 = ( V_18 < 4 ) ? ( 2 * V_18 ) : ( V_18 - 4 ) ;
T_2 V_47 ;
V_18 = ( V_18 < 4 ) ? 0 : 1 ;
V_47 = ( V_9 -> V_50 [ V_18 ] >> V_30 ) & V_49 ;
if ( V_47 == 1 )
V_47 = V_18 == 0 ? 3 : 4 ;
else
V_47 = V_51 [ V_47 ] ;
...
V_9 -> V_50 [ V_18 ] =
F_24 ( V_29 , V_52 [ V_18 ] ) ;
V_9 -> V_50 [ V_18 ] &= ~ ( V_49 << V_30 ) ;
V_9 -> V_50 [ V_18 ] |= V_1 << V_30 ;
F_26 ( V_29 , V_52 [ V_18 ] ,
V_9 -> V_50 [ V_18 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
...
int V_73 = V_18 >> 1 ;
T_2 V_30 = ( V_18 & 0x01 ) ? 4 : 0 ;
V_9 -> V_71 [ V_73 ] =
F_24 ( V_29 , F_49 ( V_73 ) ) ;
V_9 -> V_71 [ V_73 ] &= ~ ( 0x0f << V_30 ) ;
V_9 -> V_71 [ V_73 ] |= F_7 ( V_1 , 0 , 0x0f ) << V_30 ;
F_26 ( V_29 , F_49 ( V_73 ) ,
V_9 -> V_71 [ V_73 ] ) ;
}
F_27 ( & V_9 -> V_32 ) ;
...
int V_18 = V_17 -> V_18 ;
struct V_8 * V_9 = F_14 ( V_11 ) ;
return sprintf ( V_14 , L_1 , ( V_9 -> V_74 [ V_18 ] [ V_23 ] & 0x3f ) << 2 ) ;
}
static T_4
...
F_23 ( & V_9 -> V_32 ) ;
V_9 -> V_74 [ V_18 ] [ V_23 ] =
F_24 ( V_29 , F_52 ( V_18 , V_23 ) ) & 0xc0 ;
V_9 -> V_74 [ V_18 ] [ V_23 ] |= V_1 ;
F_26 ( V_29 , F_52 ( V_18 , V_23 ) ,
V_9 -> V_74 [ V_18 ] [ V_23 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
...
F_23 ( & V_9 -> V_32 ) ;
V_9 -> V_75 [ V_18 ] [ V_23 ] =
F_24 ( V_29 , F_55 ( V_18 , V_23 ) ) & 0x80 ;
V_9 -> V_75 [ V_18 ] [ V_23 ] |= V_1 ;
F_26 ( V_29 , F_55 ( V_18 , V_23 ) ,
V_9 -> V_75 [ V_18 ] [ V_23 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
...
int V_18 = V_17 -> V_18 ;
struct V_8 * V_9 = F_14 ( V_11 ) ;
T_1 V_1 = V_9 -> V_76 [ V_18 ] [ V_23 ] ;
if ( V_18 < 3 ) {
V_1 <<= 2 ;
V_1 += ( V_9 -> V_77 [ V_23 ] >> ( V_18 * 2 ) ) & 0x3 ;
}
...
V_9 -> V_77 [ V_23 ] =
F_24 ( V_29 , V_80 [ V_23 ] ) ;
V_9 -> V_77 [ V_23 ] &= ~ ( 0x03 << ( 2 * V_18 ) ) ;
V_9 -> V_77 [ V_23 ] |= ( V_1 & 0x03 ) << ( 2 * V_18 ) ;
F_26 ( V_29 , V_80 [ V_23 ] ,
V_9 -> V_77 [ V_23 ] ) ;
V_1 >>= 2 ;
}
V_9 -> V_76 [ V_18 ] [ V_23 ] = V_1 ;
F_26 ( V_29 , V_81 [ V_18 ] [ V_23 ] ,
V_9 -> V_76 [ V_18 ] [ V_23 ] ) ;
F_27 ( & V_9 -> V_32 ) ;
return V_20 ;
}
...
V_86 = F_80 ( V_1 , ( int T_7 * ) V_110 ) ;
break;
case V_122 :
V_86 = F_80 ( 0 , ( int T_7 * ) V_110 ) ;
break;
case V_123 :
V_86 = F_62 ( V_9 ) ;
break;
...
static int
F_91 ( struct V_28 * V_29 )
{
int V_73 , V_149 , V_21 ;
int V_150 = V_29 -> V_151 ;
T_2 V_47 ;
struct V_152 * V_153 = V_29 -> V_153 ;
struct V_8 * V_9 = F_22 ( V_29 ) ;
V_149 = F_92 ( V_153 ) ;
...
struct V_152 * V_153 = V_29 -> V_153 ;
unsigned short V_150 = V_29 -> V_151 ;
if ( ! F_96 ( V_153 , V_162 ) )
return - V_88 ;
V_160 = F_97 ( V_29 , V_163 ) ;
V_47 = V_160 & 0x80 ? 0x5c : 0xa3 ;
if ( V_47 != F_97 ( V_29 , V_164 ) ) {
F_98 ( L_13 ) ;
return - V_88 ;
}
if ( ( V_160 & 0x07 ) == 0
...
continue;
V_9 -> V_39 [ V_73 ] =
F_24 ( V_29 , F_33 ( V_73 ) ) << 8 ;
V_9 -> V_39 [ V_73 ] |=
F_24 ( V_29 , F_33 ( V_73 ) + 1 ) ;
}
...
V_9 -> V_43 [ V_73 ] [ V_185 ] =
F_24 ( V_29 , V_48 [ V_73 ] [ V_185 ] ) ;
}
V_9 -> V_70 [ V_73 ] =
F_24 ( V_29 , F_48 ( V_73 ) ) ;
for ( V_185 = 0 ; V_185 < 7 ; V_185 ++ ) {
V_9 -> V_74 [ V_73 ] [ V_185 ] =
F_24 ( V_29 , F_52 ( V_73 , V_185 ) ) ;
V_9 -> V_75 [ V_73 ] [ V_185 ] =
F_24 ( V_29 ,
F_55 ( V_73 , V_185 ) ) ;
}
...
continue;
V_9 -> V_42 [ V_73 ] [ V_196 ] =
F_24 ( V_29 , F_37 ( V_73 , V_196 ) ) ;
V_9 -> V_42 [ V_73 ] [ V_197 ] =
F_24 ( V_29 , F_37 ( V_73 , V_197 ) ) ;
V_9 -> V_41 [ V_73 ] =
F_24 ( V_29 , F_36 ( V_73 ) ) ;
}
V_9 -> V_54 = F_24 ( V_29 , V_61 ) ;
V_9 -> V_68 = F_24 ( V_29 , V_72 ) ;
V_9 -> V_56 = F_24 ( V_29 , V_62 ) ;
V_9 -> V_58 = F_24 ( V_29 , V_63 ) ;
V_9 -> V_60 =
F_24 ( V_29 , V_64 ) ;
V_9 -> V_33 = F_24 ( V_29 , V_34 ) ;
for ( V_73 = 0 ; V_73 < F_88 ( V_9 -> V_27 ) ; V_73 ++ )
V_9 -> V_27 [ V_73 ] = F_24 ( V_29 , F_25 ( V_73 ) ) ;
V_9 -> V_194 = V_193 ;
}
...
V_9 -> V_76 [ V_73 ] [ V_200 ] =
F_24 ( V_29 , V_81 [ V_73 ] [ V_200 ] ) ;
V_9 -> V_77 [ V_200 ] =
F_24 ( V_29 , V_80 [ V_200 ] ) ;
for ( V_73 = 0 ; V_73 < F_88 ( V_9 -> V_38 ) ; V_73 ++ ) {
if ( ! ( V_9 -> V_177 & ( 1 << V_73 ) ) )
continue;
V_9 -> V_38 [ V_73 ] =
F_24 ( V_29 , F_117 ( V_73 ) ) << 8 ;
V_9 -> V_38 [ V_73 ] |=
F_24 ( V_29 , F_117 ( V_73 ) + 1 ) ;
}
for ( V_73 = 0 ; V_73 < F_88 ( V_9 -> V_43 ) ; V_73 ++ ) {
if ( ! ( V_9 -> V_183 & ( 1 << V_73 ) ) )
continue;
V_9 -> V_43 [ V_73 ] [ V_44 ] =
F_24 ( V_29 , V_48 [ V_73 ] [ V_44 ] ) ;
}
V_9 -> V_46 =
F_24 ( V_29 , V_201 ) ;
for ( V_73 = 0 ; V_73 < F_88 ( V_9 -> V_42 ) ; V_73 ++ ) {
...
V_9 -> V_26 [ V_73 ] =
F_24 ( V_29 , F_118 ( V_73 ) ) ;
if ( V_9 -> V_181 & 0x01 )
V_9 -> V_19 [ 0 ] = F_24 ( V_29 , V_203 ) ;
if ( V_9 -> V_181 & 0x02 )
V_9 -> V_19 [ 1 ] = F_24 ( V_29 , V_204 ) ;
F_115 ( V_11 ) ;
V_9 -> V_198 = V_193 ;
V_9 -> V_36 = 1 ;
V_199:
...
static T_2 F_24 ( struct V_28 * V_29 , T_1 V_3 )
{
struct V_8 * V_9 = F_22 ( V_29 ) ;
T_2 V_205 = 0xff ;
T_2 V_206 = V_3 >> 8 ;
...
V_205 = F_97 ( V_29 , V_3 & 0xff ) ;
V_199:
return V_205 ;
}
static int F_26 ( struct V_28 * V_29 , T_1 V_3 , T_2 V_207 )
{
struct V_8 * V_9 = F_22 ( V_29 ) ;
int V_205 ;
T_2 V_206 = V_3 >> 8 ;
...
V_205 = F_119 ( V_29 , V_3 & 0xff , V_207 ) ;
V_199:
return V_205 ;
}
