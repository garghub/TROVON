...
static inline bool F_22 ( unsigned V_52 )
{
return ( V_52 & V_53 ) && ( V_52 & V_54 ) ;
}
...
if ( ! V_7 . V_18 )
return;
V_3 -> V_52 = V_56 -> V_57 . V_58 . V_59 ;
if ( F_22 ( V_3 -> V_52 ) && V_56 -> V_49 -> V_51 ) {
V_40 = V_56 -> V_49 -> V_51 ;
V_40 -> V_43 ++ ;
}
F_24 ( V_56 -> V_49 -> V_60 ) ;
if ( ! V_3 -> V_61 ++ && ! V_56 -> V_62 )
F_8 () ;
}
void F_25 ( struct V_55 * V_56 )
{
struct V_2 * V_3 = F_2 ( & V_2 ) ;
struct V_39 * V_40 ;
if ( ! V_7 . V_18 )
...
T_4 V_143 [ V_144 ] ;
int V_145 = 0 ;
V_141 = F_39 ( V_64 ) ? V_98 : V_53 ;
V_142 = F_39 ( V_63 ) ? V_98 : V_53 ;
if ( V_63 == 0 || V_64 == 0 )
return V_139 ;
if ( abort )
return V_110 | V_141 ;
...
if ( type != V_139 && ( V_52 & V_163 ) ) {
if ( V_3 -> V_67 [ V_17 ] . V_70 )
type |= V_112 ;
else
type |= V_114 ;
}
if ( type == V_139 || ( V_52 & type ) != type ) {
