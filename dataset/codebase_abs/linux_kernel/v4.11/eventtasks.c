...
{
if ( F_11 ( V_4 -> V_15 , V_16 ) )
return F_12 ( V_2 , & ( V_4 -> V_17 ) ) ;
return 0 ;
}
...
int F_41 ( struct V_1 * V_2 , const struct V_20 * V_21 )
{
return 0 ;
}
...
int F_56 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
return 0 ;
}
...
int F_66 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
return 0 ;
}
...
int F_74 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_30 * V_31 ;
int V_32 ;
...
if ( V_31 -> V_37 . V_38 & V_4 -> V_39 ) {
V_4 -> V_9 = V_31 ;
return 0 ;
}
V_31 = (struct V_30 * ) ( ( unsigned long ) V_31 + V_5 -> V_40 ) ;
}
switch ( V_4 -> V_39 ) {
case V_41 :
case V_42 :
...
return - V_6 ;
if ( F_5 ( V_2 -> V_11 -> V_12 , V_49 ) )
return F_76 ( V_2 -> V_5 , & V_44 ) ;
return 0 ;
}
