...
V_167 ) ;
F_81 ( 1800 , 2500 ) ;
V_10 = F_27 ( V_2 -> V_8 , V_168 , & V_20 ) ;
if ( V_10 < 0 ) {
F_6 ( V_7 , L_19 ) ;
return V_10 ;
}
F_4 ( V_7 , L_20 , V_20 ) ;
for ( V_9 = 0 ; V_9 < F_3 ( V_169 ) ; V_9 ++ ) {
if ( V_169 [ V_9 ] . V_170 == V_20 ) {
V_2 -> V_55 = & V_169 [ V_9 ] ;
break;
}
}
...
V_10 = F_1 ( V_2 , V_172 , 0 ) ;
if ( V_10 < 0 )
return V_10 ;
V_10 = F_7 ( V_2 , V_173 , 0 ) ;
if ( V_10 < 0 )
return V_10 ;
...
int F_82 ( struct V_6 * V_7 , struct V_8 * V_8 , int V_112 ,
const char * V_152 , bool V_177 )
{
struct V_1 * V_2 ;
struct V_39 * V_40 ;
int V_10 ;
V_40 = F_83 ( V_7 , sizeof( * V_2 ) ) ;
if ( ! V_40 )
return - V_154 ;
V_2 = F_35 ( V_40 ) ;
F_84 ( V_7 , V_40 ) ;
...
F_85 ( & V_2 -> V_62 ) ;
V_40 -> V_7 . V_155 = V_7 ;
V_40 -> V_178 = V_2 -> V_55 -> V_178 ;
V_40 -> V_179 = V_2 -> V_55 -> V_179 ;
