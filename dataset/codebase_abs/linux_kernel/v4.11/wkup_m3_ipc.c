...
struct V_54 * V_55 ;
struct V_1 * V_2 ;
V_2 = F_37 ( V_14 , sizeof( * V_2 ) , V_56 ) ;
if ( ! V_2 )
return - V_57 ;
V_53 = F_38 ( V_49 , V_58 , 0 ) ;
V_2 -> V_4 = F_39 ( V_14 , V_53 ) ;
if ( F_40 ( V_2 -> V_4 ) ) {
F_15 ( V_14 , L_10 ) ;
return F_41 ( V_2 -> V_4 ) ;
}
...
V_2 -> V_60 . V_64 = false ;
V_2 -> V_60 . V_65 = false ;
V_2 -> V_28 = F_44 ( & V_2 -> V_60 , 0 ) ;
if ( F_40 ( V_2 -> V_28 ) ) {
F_15 ( V_14 , L_14 ,
F_41 ( V_2 -> V_28 ) ) ;
return F_41 ( V_2 -> V_28 ) ;
}
if ( F_45 ( V_14 -> V_66 , L_15 , & V_50 ) ) {
F_15 ( & V_49 -> V_14 , L_16 ) ;
V_27 = - V_37 ;
goto V_67;
}
