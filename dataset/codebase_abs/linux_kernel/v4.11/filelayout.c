...
if ( V_205 -> V_213 == NULL )
goto V_226;
F_117 ( & V_192 , V_205 -> V_220 , V_205 -> V_227 ) ;
...
static T_2 F_119 ( struct V_1 * V_141 , T_2 V_125 )
{
if ( V_141 -> V_13 == V_14 )
...
V_159 = F_119 ( V_141 , V_125 ) ;
F_122 ( V_208 , V_12 , V_192 , V_159 ) ;
}
}
static T_2 F_123 ( struct V_11 * V_12 , T_2 V_159 )
{
struct V_1 * V_2 = F_5 ( V_12 ) ;
if ( V_2 -> V_13 == V_14 )
return V_159 ;
...
static struct V_127 *
F_124 ( struct V_11 * V_12 , T_2 V_159 )
{
struct V_1 * V_2 = F_5 ( V_12 ) ;
if ( V_2 -> V_13 == V_14 ) {
if ( V_2 -> V_152 == 1 )
...
static int F_125 ( struct V_115 * V_101 , int V_228 )
{
...
V_128 = F_124 ( V_12 , V_101 -> V_229 ) ;
if ( V_128 )
V_101 -> args . V_128 = V_128 ;
return F_126 ( V_124 , V_101 , F_69 ( V_101 -> V_24 ) ,
& V_231 , V_228 ,
V_137 ) ;
V_176:
F_53 ( V_101 ) ;
...
static int
F_130 ( struct V_24 * V_24 , struct V_237 * V_238 ,
int V_228 , struct V_191 * V_192 )
{
return F_131 ( V_24 , V_238 , V_228 , V_192 ,
F_125 ) ;
}
static struct V_39 *
F_132 ( struct V_37 * V_239 ,
struct V_240 * V_241 , T_4 V_142 )
{
struct V_144 * V_6 ;
V_6 = F_133 ( V_239 , V_241 , V_142 ) ;
if ( ! V_6 )
return NULL ;
return & V_6 -> V_149 ;
}
static void
F_134 ( struct V_39 * V_143 )
{
F_135 ( F_73 ( V_143 , struct V_144 , V_149 ) ) ;
}
static struct V_33 *
F_136 ( struct V_24 * V_24 , T_4 V_142 )
{
struct V_187 * V_161 ;
