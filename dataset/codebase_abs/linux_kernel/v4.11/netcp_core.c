...
V_111 . V_126 = V_5 -> V_126 ;
V_111 . V_127 = ( T_2 V_128 * ) V_5 -> V_127 ;
memset ( V_111 . V_126 , 0 , V_196 * sizeof( T_3 ) ) ;
F_30 (tx_hook, &netcp->txhook_list_head, list) {
V_29 = V_194 -> V_75 ( V_194 -> V_74 , V_194 -> V_76 ,
& V_111 ) ;
if ( F_53 ( V_29 != 0 ) ) {
F_21 ( V_28 -> V_94 , L_30 ,
V_194 -> V_74 , V_29 ) ;
V_29 = ( V_29 < 0 ) ? V_29 : V_197 ;
goto V_198;
}
}
V_193 = V_111 . V_193 ;
...
int F_130 ( struct V_192 * V_193 )
{
struct V_35 * V_36 = V_193 -> V_32 -> V_35 ;
struct V_215 V_216 ;
int V_29 = 0 ;
T_8 V_26 [ 16 ] ;
...
snprintf ( V_26 , sizeof( V_26 ) , L_36 , F_132 ( V_36 ) ) ;
V_193 -> V_206 = F_133 ( V_26 , V_193 -> V_227 ,
V_228 ) ;
if ( F_134 ( V_193 -> V_206 ) ) {
F_21 ( V_36 , L_37 ,
V_26 , V_29 ) ;
V_29 = F_135 ( V_193 -> V_206 ) ;
goto V_226;
}
F_32 ( V_36 , L_38 , V_26 ) ;
return 0 ;
...
if ( F_79 ( V_28 -> V_164 ) ) {
F_21 ( V_28 -> V_94 , L_44 ) ;
V_29 = F_135 ( V_28 -> V_164 ) ;
goto V_67;
}
snprintf ( V_26 , sizeof( V_26 ) , L_45 , V_30 -> V_26 ) ;
V_28 -> V_169 = F_133 ( V_26 , V_28 -> V_190 , 0 ) ;
if ( F_134 ( V_28 -> V_169 ) ) {
V_29 = F_135 ( V_28 -> V_169 ) ;
goto V_67;
}
V_28 -> V_190 = F_159 ( V_28 -> V_169 ) ;
V_254 . V_259 = F_112 ;
V_254 . V_260 = V_28 ;
...
V_28 -> V_101 = F_133 ( V_26 , V_28 -> V_153 , 0 ) ;
if ( F_134 ( V_28 -> V_101 ) ) {
V_29 = F_135 ( V_28 -> V_101 ) ;
goto V_67;
}
...
V_28 -> V_137 [ V_16 ] = F_133 ( V_26 , V_262 , 0 ) ;
if ( F_134 ( V_28 -> V_137 [ V_16 ] ) ) {
V_29 = F_135 ( V_28 -> V_137 [ V_16 ] ) ;
goto V_67;
}
}
memset ( & V_216 , 0 , sizeof( V_216 ) ) ;
...
static int F_174 ( struct V_207 * V_36 , T_2 V_291 , T_9 V_285 ,
struct V_292 * V_293 )
{
int V_16 ;
F_175 () ;
...
return - V_62 ;
if ( ( V_36 -> V_295 <= 1 ) ||
( V_36 -> V_295 < V_293 -> V_293 ) )
return - V_62 ;
if ( V_293 -> V_293 ) {
F_176 ( V_36 , V_293 -> V_293 ) ;
for ( V_16 = 0 ; V_16 < V_293 -> V_293 ; V_16 ++ )
...
static void
F_179 ( struct V_207 * V_30 , struct V_296 * V_99 )
{
struct V_27 * V_28 = F_125 ( V_30 ) ;
struct V_97 * V_297 = & V_28 -> V_99 ;
T_11 V_298 , V_299 , V_300 , V_301 ;
unsigned int V_302 ;
do {
V_302 = F_180 ( & V_297 -> V_131 ) ;
V_298 = V_297 -> V_132 ;
V_299 = V_297 -> V_133 ;
} while ( F_181 ( & V_297 -> V_131 , V_302 ) );
do {
V_302 = F_180 ( & V_297 -> V_176 ) ;
V_300 = V_297 -> V_177 ;
V_301 = V_297 -> V_178 ;
} while ( F_181 ( & V_297 -> V_176 , V_302 ) );
V_99 -> V_132 = V_298 ;
V_99 -> V_133 = V_299 ;
V_99 -> V_177 = V_300 ;
V_99 -> V_178 = V_301 ;
V_99 -> V_103 = V_297 -> V_103 ;
V_99 -> V_104 = V_297 -> V_104 ;
V_99 -> V_210 = V_297 -> V_210 ;
}
...
V_30 -> V_310 |= V_311 ;
V_30 -> V_310 |= V_312 ;
V_30 -> V_313 = V_30 -> V_310 ;
V_30 -> V_314 |= V_311 ;
V_30 -> V_315 = V_316 ;
V_30 -> V_317 = V_318 - ( V_319 + V_123 ) ;
V_28 = F_125 ( V_30 ) ;
F_184 ( & V_28 -> V_81 ) ;
F_185 ( & V_28 -> V_59 ) ;
F_185 ( & V_28 -> V_320 ) ;
...
V_28 -> V_30 = V_30 ;
V_28 -> V_94 = & V_30 -> V_36 ;
V_28 -> V_322 = F_187 ( V_323 , V_324 ) ;
V_28 -> V_213 = V_325 ;
V_28 -> V_174 = V_28 -> V_213 ;
V_28 -> V_56 = V_56 ;
V_29 = F_188 ( V_56 , L_62 , & V_19 ) ;
if ( V_19 ) {
if ( F_189 ( V_25 , V_326 , & V_305 ) ) {
F_21 ( V_36 , L_63 ) ;
V_29 = - V_61 ;
goto V_327;
}
V_303 = F_190 ( & V_305 ) ;
if ( ! F_191 ( V_36 , V_305 . V_302 , V_303 ,
F_132 ( V_36 ) ) ) {
F_21 ( V_36 , L_64 ) ;
V_29 = - V_47 ;
goto V_327;
}
V_306 = F_192 ( V_36 , V_305 . V_302 , V_303 ) ;
if ( ! V_306 ) {
F_21 ( V_36 , L_65 ) ;
F_193 ( V_36 , V_305 . V_302 , V_303 ) ;
V_29 = - V_47 ;
goto V_327;
}
F_13 ( V_308 , V_306 , V_19 ) ;
if ( F_194 ( V_308 ) )
F_140 ( V_30 -> V_328 , V_308 ) ;
else
F_195 ( V_30 -> V_328 ) ;
F_196 ( V_36 , V_306 ) ;
F_193 ( V_36 , V_305 . V_302 , V_303 ) ;
...
F_199 ( V_30 , & V_28 -> V_160 , F_97 , V_330 ) ;
F_200 ( V_30 , & V_28 -> V_179 , F_110 , V_330 ) ;
V_30 -> V_331 = 0 ;
V_30 -> V_332 = V_333 ;
V_30 -> V_334 = & V_335 ;
F_201 ( V_30 , V_36 ) ;
F_26 ( & V_28 -> V_336 , & V_32 -> V_337 ) ;
return 0 ;
V_327:
F_202 ( V_30 ) ;
return V_29 ;
...
static int F_207 ( struct V_338 * V_339 )
{
struct V_24 * V_25 = V_339 -> V_36 . V_39 ;
struct V_27 * V_27 , * V_69 ;
struct V_24 * V_40 , * V_340 ;
struct V_32 * V_32 ;
struct V_35 * V_36 = & V_339 -> V_36 ;
int V_29 ;
if ( ! V_25 ) {
F_21 ( V_36 , L_82 ) ;
return - V_61 ;
...
static int F_213 ( struct V_338 * V_339 )
{
struct V_32 * V_32 = F_214 ( V_339 ) ;
struct V_27 * V_27 , * V_69 ;
...
inst_list) {
V_34 = V_42 -> V_33 ;
F_32 ( & V_339 -> V_36 , L_87 , V_34 -> V_26 ) ;
