...
bool
F_34 ( struct V_3 * V_4 , struct V_5 * V_27 )
{
unsigned long V_13 ;
bool V_8 ;
F_16 ( V_4 -> V_9 , V_13 ) ;
...
static void
F_35 ( struct V_3 * V_4 , struct V_5 * V_27 )
{
struct V_31 * V_20 =
F_22 ( V_27 , struct V_31 , V_32 ) ;
F_36 ( V_20 -> V_33 , V_34 ) ;
}
signed long
F_37 ( struct V_3 * V_4 , bool V_17 , signed long V_18 )
{
struct V_31 V_27 ;
unsigned long V_13 ;
...
V_8 = F_41 ( V_8 ) ;
F_16 ( V_4 -> V_9 , V_13 ) ;
if ( V_8 > 0 && V_17 && F_38 ( V_35 ) )
V_8 = - V_36 ;
}
if ( ! F_24 ( & V_27 . V_32 . V_14 ) )
F_42 ( & V_27 . V_32 . V_14 ) ;
F_40 ( V_40 ) ;
V_37:
F_17 ( V_4 -> V_9 , V_13 ) ;
...
static bool
F_43 ( struct V_3 * * V_41 , T_3 V_42 ,
T_3 * V_43 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < V_42 ; ++ V_44 ) {
struct V_3 * V_4 = V_41 [ V_44 ] ;
if ( F_15 ( V_12 , & V_4 -> V_13 ) ) {
if ( V_43 )
* V_43 = V_44 ;
return true ;
...
signed long
F_44 ( struct V_3 * * V_41 , T_3 V_42 ,
bool V_17 , signed long V_18 , T_3 * V_43 )
{
struct V_31 * V_27 ;
signed long V_8 = V_18 ;
unsigned V_44 ;
if ( F_6 ( ! V_41 || ! V_42 || V_18 < 0 ) )
return - V_10 ;
if ( V_18 == 0 ) {
for ( V_44 = 0 ; V_44 < V_42 ; ++ V_44 )
if ( F_45 ( V_41 [ V_44 ] ) ) {
...
V_27 = F_46 ( V_42 , sizeof( struct V_31 ) , V_45 ) ;
if ( V_27 == NULL ) {
V_8 = - V_46 ;
goto V_47;
}
for ( V_44 = 0 ; V_44 < V_42 ; ++ V_44 ) {
struct V_3 * V_4 = V_41 [ V_44 ] ;
if ( V_4 -> V_19 -> V_20 != F_37 ) {
V_8 = - V_10 ;
goto V_48;
}
V_27 [ V_44 ] . V_33 = V_35 ;
if ( F_29 ( V_4 , & V_27 [ V_44 ] . V_32 ,
F_35 ) ) {
if ( V_43 )
* V_43 = V_44 ;
goto V_48;
...
V_48:
while ( V_44 -- > 0 )
F_34 ( V_41 [ V_44 ] , & V_27 [ V_44 ] . V_32 ) ;
V_47:
F_48 ( V_27 ) ;
return V_8 ;
}
void
F_49 ( struct V_3 * V_4 , const struct V_49 * V_19 ,
T_4 * V_9 , T_1 V_50 , unsigned V_51 )
{
F_2 ( ! V_9 ) ;
