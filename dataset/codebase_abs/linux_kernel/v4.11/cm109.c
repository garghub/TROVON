...
V_76 ,
F_14 , V_31 , V_101 -> V_111 ) ;
V_31 -> V_68 -> V_112 = V_31 -> V_91 ;
V_31 -> V_68 -> V_113 |= V_114 ;
V_31 -> V_68 -> V_31 = V_70 ;
V_31 -> V_71 -> V_73 = V_115 | V_116 |
V_117 ;
V_31 -> V_71 -> V_72 = V_118 ;
V_31 -> V_71 -> V_74 = F_60 ( 0x200 ) ;
V_31 -> V_71 -> V_75 = F_60 ( V_93 -> V_106 . V_119 ) ;
V_31 -> V_71 -> V_120 = F_60 ( V_76 ) ;
F_61 ( V_31 -> V_48 , V_70 , F_24 ( V_70 , 0 ) ,
( void * ) V_31 -> V_71 , V_31 -> V_45 , V_76 ,
F_20 , V_31 ) ;
V_31 -> V_48 -> V_112 = V_31 -> V_90 ;
V_31 -> V_48 -> V_113 |= V_114 ;
V_31 -> V_48 -> V_31 = V_70 ;
F_62 ( V_70 , V_31 -> V_121 , sizeof( V_31 -> V_121 ) ) ;
F_63 ( V_31 -> V_121 , L_10 , sizeof( V_31 -> V_121 ) ) ;
V_33 -> V_122 = V_98 -> V_122 ;
V_33 -> V_121 = V_31 -> V_121 ;
F_64 ( V_70 , & V_33 -> V_95 ) ;
V_33 -> V_31 . V_123 = & V_50 -> V_31 ;
F_65 ( V_33 , V_31 ) ;
V_33 -> V_79 = F_30 ;
V_33 -> V_124 = F_36 ;
V_33 -> V_125 = F_37 ;
V_33 -> V_41 = V_31 -> V_43 ;
V_33 -> V_126 = sizeof( unsigned char ) ;
V_33 -> V_127 = F_66 ( V_31 -> V_43 ) ;
V_33 -> V_128 [ 0 ] = F_67 ( V_129 ) | F_67 ( V_85 ) ;
V_33 -> V_130 [ 0 ] = F_67 ( V_88 ) | F_67 ( V_87 ) ;
for ( V_42 = 0 ; V_42 < V_131 ; V_42 ++ ) {
unsigned short V_132 = V_43 ( V_42 ) ;
V_31 -> V_43 [ V_42 ] = V_132 ;
F_68 ( V_132 , V_33 -> V_56 ) ;
}
F_69 ( V_10 , V_33 -> V_56 ) ;
...
static int F_72 ( struct V_92 * V_50 , T_2 V_133 )
{
struct V_30 * V_31 = F_43 ( V_50 ) ;
F_73 ( & V_50 -> V_31 , L_11 , V_133 . V_125 ) ;
F_33 ( & V_31 -> V_80 ) ;
F_26 ( V_31 ) ;
F_34 ( & V_31 -> V_80 ) ;
return 0 ;
...
{
if ( ! strcasecmp ( V_134 , L_13 ) ) {
V_43 = F_2 ;
F_78 (KERN_INFO KBUILD_MODNAME L_14
L_15 ) ;
} else if ( ! strcasecmp ( V_134 , L_16 ) ) {
V_43 = F_3 ;
F_78 (KERN_INFO KBUILD_MODNAME L_14
L_17 ) ;
} else if ( ! strcasecmp ( V_134 , L_18 ) ) {
V_43 = F_4 ;
F_78 (KERN_INFO KBUILD_MODNAME L_14
L_19 ) ;
} else if ( ! strcasecmp ( V_134 , L_20 ) ) {
V_43 = F_5 ;
F_78 (KERN_INFO KBUILD_MODNAME L_14
L_21 ) ;
} else {
