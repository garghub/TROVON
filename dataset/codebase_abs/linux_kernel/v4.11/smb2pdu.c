...
enum V_181
F_48 ( struct V_19 * V_9 , enum V_181 V_182 )
{
switch ( V_182 ) {
case V_183 :
case V_184 :
...
static int
F_49 ( struct V_191 * V_192 )
{
int V_39 ;
struct V_42 * V_3 = V_192 -> V_3 ;
struct V_193 * V_117 ;
struct V_19 * V_9 = V_3 -> V_9 ;
V_39 = F_27 ( V_194 , NULL , ( void * * ) & V_117 ) ;
if ( V_39 )
return V_39 ;
V_117 -> V_97 . V_86 . V_33 = 0 ;
V_117 -> V_195 = V_192 -> V_196 ;
V_117 -> V_36 = 0 ;
...
V_117 -> V_144 = 0 ;
V_117 -> V_197 = 0 ;
V_192 -> V_125 [ 0 ] . V_151 = ( char * ) V_117 ;
V_192 -> V_125 [ 0 ] . V_152 = F_37 ( V_117 ) + 4 - 1 ;
V_192 -> V_198 = V_199 ;
return 0 ;
}
static void
F_50 ( struct V_191 * V_192 )
{
F_45 ( V_192 -> V_198 , V_192 -> V_125 [ 0 ] . V_151 ) ;
V_192 -> V_198 = V_200 ;
}
static int
F_51 ( struct V_191 * V_192 )
{
int V_39 ;
struct V_193 * V_117 = V_192 -> V_125 [ 0 ] . V_151 ;
struct V_124 V_126 = { NULL , 0 } ;
V_117 -> V_201 =
F_3 ( sizeof( struct V_193 ) -
1 - 4 ) ;
V_117 -> V_202 = F_3 ( V_192 -> V_125 [ 1 ] . V_152 ) ;
F_34 ( V_117 , V_192 -> V_125 [ 1 ] . V_152 - 1 ) ;
V_39 = F_38 ( V_192 -> V_121 , V_192 -> V_3 ,
V_192 -> V_125 , 2 ,
& V_192 -> V_198 ,
V_203 | V_132 , & V_126 ) ;
F_39 ( V_192 -> V_125 [ 0 ] . V_151 ) ;
memcpy ( & V_192 -> V_125 [ 0 ] , & V_126 , sizeof( struct V_124 ) ) ;
return V_39 ;
}
static int
F_52 ( struct V_191 * V_192 )
{
int V_39 = 0 ;
struct V_42 * V_3 = V_192 -> V_3 ;
F_12 ( & V_3 -> V_9 -> V_204 ) ;
if ( V_3 -> V_9 -> V_205 -> V_206 ) {
V_39 = V_3 -> V_9 -> V_205 -> V_206 ( V_3 ) ;
if ( V_39 ) {
F_9 ( V_49 ,
L_19 ) ;
F_15 ( & V_3 -> V_9 -> V_204 ) ;
...
static void
F_53 ( struct V_191 * V_192 )
{
int V_39 ;
struct V_42 * V_3 = V_192 -> V_3 ;
struct V_211 * V_212 ;
struct V_213 * V_214 = NULL ;
struct V_215 * V_123 = NULL ;
V_39 = F_49 ( V_192 ) ;
if ( V_39 )
goto V_28;
V_214 = F_54 ( V_3 ) ;
...
V_3 -> V_222 . V_223 = F_57 ( V_212 -> V_217 , V_212 -> V_224 ,
V_225 ) ;
if ( ! V_3 -> V_222 . V_223 ) {
F_9 ( V_158 ,
L_22 ,
...
V_3 -> V_222 . V_226 = V_212 -> V_224 ;
V_192 -> V_125 [ 1 ] . V_151 = V_212 -> V_217 + V_212 -> V_224 ;
V_192 -> V_125 [ 1 ] . V_152 = V_212 -> V_227 ;
V_39 = F_51 ( V_192 ) ;
if ( V_39 )
goto V_221;
V_123 = (struct V_215 * ) V_192 -> V_125 [ 0 ] . V_151 ;
V_3 -> V_34 = V_123 -> V_97 . V_86 . V_33 ;
V_3 -> V_4 = F_22 ( V_123 -> V_228 ) ;
V_39 = F_52 ( V_192 ) ;
V_221:
F_58 ( V_214 ) ;
F_59 ( V_214 ) ;
...
bool V_233 = false ;
T_4 V_129 = 0 ;
V_3 -> V_234 = F_61 ( sizeof( struct V_235 ) , V_225 ) ;
if ( ! V_3 -> V_234 ) {
V_39 = - V_89 ;
goto V_236;
}
V_3 -> V_234 -> V_237 = true ;
V_39 = F_49 ( V_192 ) ;
if ( V_39 )
goto V_236;
V_232 = F_61 ( sizeof( struct V_238 ) ,
V_225 ) ;
if ( V_232 == NULL ) {
V_39 = - V_89 ;
goto V_28;
...
V_192 -> V_125 [ 1 ] . V_151 = V_232 ;
V_192 -> V_125 [ 1 ] . V_152 = V_129 ;
V_39 = F_51 ( V_192 ) ;
V_123 = (struct V_215 * ) V_192 -> V_125 [ 0 ] . V_151 ;
if ( V_192 -> V_198 != V_200 &&
V_123 -> V_97 . V_86 . V_239 == V_240 )
V_39 = 0 ;
if ( V_39 )
goto V_28;
if ( F_63 ( struct V_215 , V_241 ) - 4 !=
F_22 ( V_123 -> V_201 ) ) {
F_9 ( V_158 , L_25 ,
F_22 ( V_123 -> V_201 ) ) ;
V_39 = - V_52 ;
...
V_39 = F_64 ( V_123 -> V_241 ,
F_22 ( V_123 -> V_202 ) , V_3 ) ;
if ( V_39 )
goto V_28;
F_9 ( V_49 , L_26 ) ;
V_3 -> V_34 = V_123 -> V_97 . V_86 . V_33 ;
...
static void
V_242 ( struct V_191 * V_192 )
{
int V_39 ;
struct V_42 * V_3 = V_192 -> V_3 ;
struct V_193 * V_117 ;
struct V_215 * V_123 = NULL ;
unsigned char * V_232 = NULL ;
bool V_233 = false ;
T_4 V_129 = 0 ;
V_39 = F_49 ( V_192 ) ;
if ( V_39 )
goto V_28;
V_117 = (struct V_193 * ) V_192 -> V_125 [ 0 ] . V_151 ;
V_117 -> V_97 . V_86 . V_33 = V_3 -> V_34 ;
V_39 = F_66 ( & V_232 , & V_129 , V_3 ,
V_192 -> V_243 ) ;
if ( V_39 ) {
F_9 ( V_49 , L_27 , V_39 ) ;
goto V_28;
...
static int
F_67 ( struct V_42 * V_3 , struct V_191 * V_192 )
{
int type ;
type = F_48 ( V_3 -> V_9 , V_3 -> V_244 ) ;
F_9 ( V_49 , L_28 , type ) ;
if ( type == V_186 ) {
F_9 ( V_158 ,
L_29 ) ;
...
V_192 = F_69 ( sizeof( struct V_191 ) , V_225 ) ;
if ( ! V_192 )
return - V_89 ;
V_39 = F_67 ( V_3 , V_192 ) ;
if ( V_39 )
...
if ( V_3 -> V_63 )
goto V_247;
V_39 = F_27 ( V_248 , NULL , ( void * * ) & V_117 ) ;
if ( V_39 )
return V_39 ;
V_117 -> V_97 . V_86 . V_33 = V_3 -> V_34 ;
if ( V_3 -> V_4 & V_5 )
...
static inline void F_72 ( struct V_1 * V_2 , T_2 V_250 )
{
F_26 ( & V_2 -> V_91 . V_92 . V_251 [ V_250 ] ) ;
}
...
int
F_17 ( const unsigned int V_121 , struct V_42 * V_3 , const char * V_255 ,
struct V_1 * V_2 , const struct V_40 * V_256 )
{
struct V_257 * V_117 ;
struct V_258 * V_123 = NULL ;
...
return - V_52 ;
V_260 = F_61 ( V_261 * 2 , V_225 ) ;
if ( V_260 == NULL )
return - V_89 ;
V_259 = F_74 ( V_260 , V_255 , strlen ( V_255 ) , V_256 ) + 1 ;
V_259 *= 2 ;
if ( V_259 < 2 ) {
F_65 ( V_260 ) ;
return - V_245 ;
...
V_117 -> V_262 = F_3 ( sizeof( struct V_257 )
- 1 - 4 ) ;
V_117 -> V_263 = F_3 ( V_259 - 2 ) ;
V_125 [ 1 ] . V_151 = V_260 ;
V_125 [ 1 ] . V_152 = V_259 ;
F_34 ( V_117 , V_259 - 1 ) ;
V_39 = F_38 ( V_121 , V_3 , V_125 , 2 , & V_127 , V_131 , & V_126 ) ;
F_39 ( V_117 ) ;
V_123 = (struct V_258 * ) V_126 . V_151 ;
if ( V_39 != 0 ) {
if ( V_2 ) {
F_72 ( V_2 , V_264 ) ;
V_2 -> V_63 = true ;
...
if ( V_2 == NULL ) {
V_3 -> V_266 = V_123 -> V_97 . V_86 . V_31 ;
goto V_267;
}
if ( V_123 -> V_268 & V_269 )
F_9 ( V_49 , L_34 ) ;
else if ( V_123 -> V_268 & V_270 ) {
V_2 -> V_271 = true ;
F_9 ( V_49 , L_35 ) ;
} else if ( V_123 -> V_268 & V_272 ) {
V_2 -> V_273 = true ;
F_9 ( V_49 , L_36 ) ;
} else {
F_9 ( V_158 , L_37 , V_123 -> V_268 ) ;
V_39 = - V_231 ;
goto V_265;
}
...
F_75 ( V_2 -> V_67 , V_255 , sizeof( V_2 -> V_67 ) ) ;
...
F_9 ( V_158 , L_39 ) ;
F_73 ( V_2 ) ;
if ( V_2 -> V_3 -> V_9 -> V_205 -> V_279 )
V_39 = V_2 -> V_3 -> V_9 -> V_205 -> V_279 ( V_121 , V_2 ) ;
V_267:
F_45 ( V_127 , V_123 ) ;
F_65 ( V_260 ) ;
return V_39 ;
V_265:
if ( V_123 -> V_97 . V_86 . V_239 == V_280 ) {
F_9 ( V_158 , L_40 , V_255 ) ;
}
goto V_267;
}
int
...
{
struct V_283 * V_80 ;
V_80 = F_69 ( sizeof( struct V_283 ) , V_225 ) ;
if ( ! V_80 )
return NULL ;
...
return V_9 -> V_205 -> V_307 ( V_301 , V_298 ) ;
...
V_125 [ V_312 ] . V_151 = V_9 -> V_205 -> V_313 ( V_310 + 1 , * V_310 ) ;
...
{
struct V_317 * V_80 ;
V_80 = F_69 ( sizeof( struct V_317 ) , V_225 ) ;
if ( ! V_80 )
return NULL ;
V_80 -> V_284 . V_285 = F_3 ( F_63
( struct V_317 , V_319 ) ) ;
...
* V_329 = F_69 ( * V_330 , V_225 ) ;
if ( ! * V_329 )
return - V_89 ;
V_256 = F_11 () ;
F_74 ( * V_329 , V_332 , V_334 , V_256 ) ;
F_91 ( * V_329 , V_336 ) ;
F_91 ( * V_329 , V_333 ) ;
F_20 ( V_256 ) ;
return 0 ;
...
F_9 ( V_49 , L_45 ,
V_117 -> V_97 . V_86 . V_31 , V_3 -> V_266 ) ;
V_117 -> V_97 . V_86 . V_31 = V_3 -> V_266 ;
}
if ( F_1 ( V_2 ) )
V_131 |= V_249 ;
...
. V_498 = V_489 -> V_499 } ;
F_9 ( V_49 , L_59 ,
V_133 , V_439 -> V_439 , V_439 -> V_444 , V_489 -> V_229 ,
V_489 -> V_500 ) ;
switch ( V_439 -> V_444 ) {
case V_445 :
...
case V_445 :
V_443 = F_22 ( V_123 -> V_97 . V_86 . V_23 ) ;
V_523 -> V_229 = F_133 ( V_439 , V_2 -> V_3 -> V_9 , 0 ) ;
if ( V_523 -> V_229 != 0 )
break;
...
V_226 = F_41 ( V_539 -> V_540 ) ;
if ( ( char * ) V_539 + V_226 + V_536 > V_419 ) {
F_9 ( V_158 , L_67 ,
V_419 ) ;
break;
}
...
V_544 -> V_566 = ( char * ) V_123 ;
V_544 -> V_568 = V_544 -> V_569 = 4 +
( char * ) & V_123 -> V_97 + F_22 ( V_123 -> V_433 ) ;
V_417 = F_37 ( V_123 ) + 4 + ( char * ) & V_123 -> V_97 ;
V_544 -> V_570 =
F_137 ( V_544 -> V_568 , V_417 ,
& V_544 -> V_569 , V_551 ) ;
V_544 -> V_571 += V_544 -> V_570 ;
F_9 ( V_49 , L_69 ,
V_544 -> V_570 , V_544 -> V_571 ,
V_544 -> V_568 , V_544 -> V_569 ) ;
if ( V_127 == V_521 )
V_544 -> V_567 = false ;
else if ( V_127 == V_199 )
V_544 -> V_567 = true ;
...
unsigned int V_312 , void * * V_217 , unsigned int * V_536 )
{
struct V_572 * V_117 ;
struct V_573 * V_123 = NULL ;
struct V_124 * V_125 ;
struct V_124 V_126 ;
int V_39 = 0 ;
int V_127 ;
...
if ( ! V_312 )
return - V_245 ;
V_125 = F_61 ( sizeof( struct V_124 ) * V_312 , V_225 ) ;
if ( ! V_125 )
return - V_89 ;
...
V_117 -> V_295 = V_296 ;
V_117 -> V_575 =
F_3 ( sizeof( struct V_572 ) - 1 - 4 ) ;
V_117 -> V_576 = F_7 ( * V_536 ) ;
F_34 ( V_117 , * V_536 - 1 ) ;
memcpy ( V_117 -> V_241 , * V_217 , * V_536 ) ;
V_125 [ 0 ] . V_151 = ( char * ) V_117 ;
V_125 [ 0 ] . V_152 = F_37 ( V_117 ) + 4 ;
for ( V_574 = 1 ; V_574 < V_312 ; V_574 ++ ) {
F_34 ( V_117 , V_536 [ V_574 ] ) ;
F_81 ( & V_117 -> V_576 , V_536 [ V_574 ] ) ;
V_125 [ V_574 ] . V_151 = ( char * ) V_217 [ V_574 ] ;
V_125 [ V_574 ] . V_152 = V_536 [ V_574 ] ;
}
V_39 = F_38 ( V_121 , V_3 , V_125 , V_312 , & V_127 , V_131 , & V_126 ) ;
F_39 ( V_117 ) ;
V_123 = (struct V_573 * ) V_126 . V_151 ;
if ( V_39 != 0 )
F_72 ( V_2 , V_577 ) ;
F_45 ( V_127 , V_123 ) ;
F_65 ( V_125 ) ;
...
T_7 V_294 , T_7 V_296 , T_1 * V_578 )
{
struct V_579 V_580 ;
void * * V_217 ;
unsigned int V_536 [ 2 ] ;
int V_39 ;
int V_226 = ( 2 * F_89 ( ( V_337 * ) V_578 , V_338 ) ) ;
V_217 = F_61 ( sizeof( void * ) * 2 , V_225 ) ;
if ( ! V_217 )
return - V_89 ;
V_580 . V_581 = 1 ;
V_580 . V_582 = 0 ;
V_580 . V_540 = F_7 ( V_226 ) ;
V_217 [ 0 ] = & V_580 ;
V_536 [ 0 ] = sizeof( struct V_579 ) ;
V_217 [ 1 ] = V_578 ;
V_536 [ 1 ] = V_226 + 2 ;
V_39 = F_140 ( V_121 , V_2 , V_294 , V_296 ,
V_26 -> V_27 , V_583 , 2 , V_217 ,
V_536 ) ;
F_65 ( V_217 ) ;
return V_39 ;
}
...
V_580 . V_540 = F_7 ( V_226 ) ;
V_217 [ 0 ] = & V_580 ;
V_536 [ 0 ] = sizeof( struct V_586 ) ;
V_217 [ 1 ] = V_578 ;
V_536 [ 1 ] = V_226 + 2 ;
V_39 = F_140 ( V_121 , V_2 , V_294 , V_296 ,
V_26 -> V_27 , V_587 , 2 , V_217 , V_536 ) ;
F_65 ( V_217 ) ;
return V_39 ;
}
int
F_144 ( const unsigned int V_121 , struct V_1 * V_2 , T_7 V_294 ,
T_7 V_296 , T_3 V_475 , T_10 * V_588 , bool V_589 )
{
struct V_590 V_580 ;
void * V_217 ;
unsigned int V_536 ;
V_580 . V_375 = * V_588 ;
V_217 = & V_580 ;
V_536 = sizeof( struct V_590 ) ;
if ( V_589 )
return F_140 ( V_121 , V_2 , V_294 , V_296 ,
V_475 , V_591 , 1 , & V_217 , & V_536 ) ;
else
return F_140 ( V_121 , V_2 , V_294 , V_296 ,
V_475 , V_592 , 1 , & V_217 , & V_536 ) ;
}
int
...
static void
F_147 ( struct V_600 * V_601 ,
struct V_602 * V_603 )
{
V_603 -> V_604 = F_41 ( V_601 -> V_605 ) *
F_41 ( V_601 -> V_606 ) ;
V_603 -> V_607 = F_148 ( V_601 -> V_608 ) ;
V_603 -> V_609 = F_148 ( V_601 -> V_610 ) ;
V_603 -> V_611 = F_148 ( V_601 -> V_612 ) ;
return;
}
static int
F_149 ( struct V_124 * V_125 , struct V_1 * V_2 , int V_613 ,
int V_614 , T_7 V_294 , T_7 V_296 )
{
int V_39 ;
struct V_424 * V_117 ;
F_9 ( V_49 , L_73 , V_613 ) ;
...
T_7 V_294 , T_7 V_296 , struct V_602 * V_616 )
{
struct V_425 * V_123 = NULL ;
struct V_124 V_125 ;
struct V_124 V_126 ;
...
int V_127 ;
struct V_42 * V_3 = V_2 -> V_3 ;
struct V_600 * V_580 = NULL ;
int V_131 = 0 ;
V_39 = F_149 ( & V_125 , V_2 , V_617 ,
sizeof( struct V_600 ) ,
V_294 , V_296 ) ;
if ( V_39 )
return V_39 ;
...
T_7 V_294 , T_7 V_296 , int V_613 )
{
struct V_425 * V_123 = NULL ;
struct V_124 V_125 ;
struct V_124 V_126 ;
int V_39 = 0 ;
int V_127 , V_619 , V_423 ;
struct V_42 * V_3 = V_2 -> V_3 ;
unsigned int V_620 , V_412 ;
int V_131 = 0 ;
if ( V_613 == V_621 ) {
V_619 = sizeof( V_622 ) ;
V_423 = sizeof( V_622 ) ;
...
V_619 = sizeof( struct V_627 ) ;
V_423 = sizeof( struct V_627 ) ;
} else {
F_9 ( V_49 , L_74 , V_613 ) ;
return - V_245 ;
}
V_39 = F_149 ( & V_125 , V_2 , V_613 , V_619 ,
V_294 , V_296 ) ;
if ( V_39 )
return V_39 ;
if ( F_1 ( V_2 ) )
...
V_123 = (struct V_425 * ) V_126 . V_151 ;
V_620 = F_41 ( V_123 -> V_430 ) ;
V_412 = F_22 ( V_123 -> V_433 ) ;
V_39 = F_95 ( V_412 , V_620 , & V_123 -> V_97 , V_423 ) ;
if ( V_39 )
goto V_628;
if ( V_613 == V_623 )
...
memcpy ( & V_2 -> V_630 , 4 + V_412
+ ( char * ) & V_123 -> V_97 , sizeof( V_622 ) ) ;
else if ( V_613 == V_626 ) {
struct V_627 * V_631 = (struct V_627 * )
( 4 + V_412 + ( char * ) & V_123 -> V_97 ) ;
V_2 -> V_632 = F_41 ( V_631 -> V_36 ) ;
V_2 -> V_633 =
F_41 ( V_631 -> V_634 ) ;
}
V_628:
...
const T_14 V_635 , const T_14 V_296 , const T_6 V_475 ,
const T_6 V_636 , struct V_637 * V_80 )
{
int V_39 = 0 ;
struct V_638 * V_117 = NULL ;
struct V_124 V_125 [ 2 ] ;
struct V_124 V_126 ;
int V_639 ;
unsigned int V_640 ;
...
V_131 |= V_249 ;
V_117 -> V_97 . V_86 . V_24 = F_7 ( V_475 ) ;
V_117 -> V_642 = F_3 ( V_636 ) ;
V_117 -> V_293 = V_635 ;
V_117 -> V_295 = V_296 ;
V_640 = V_636 * sizeof( struct V_637 ) ;
F_34 ( V_117 , V_640 - sizeof( struct V_637 ) ) ;
V_125 [ 0 ] . V_151 = ( char * ) V_117 ;
V_125 [ 0 ] . V_152 = F_37 ( V_117 ) + 4 - V_640 ;
V_125 [ 1 ] . V_151 = ( char * ) V_80 ;
V_125 [ 1 ] . V_152 = V_640 ;
F_26 ( & V_2 -> V_91 . V_643 . V_644 ) ;
V_39 = F_38 ( V_121 , V_2 -> V_3 , V_125 , 2 , & V_639 , V_131 ,
& V_126 ) ;
F_39 ( V_117 ) ;
if ( V_39 ) {
F_9 ( V_49 , L_76 , V_39 ) ;
...
const T_14 V_635 , const T_14 V_296 , const T_6 V_475 ,
const T_14 V_480 , const T_14 V_412 , const T_6 V_646 ,
const bool V_647 )
{
struct V_637 V_648 ;
V_648 . V_481 = F_118 ( V_412 ) ;
V_648 . V_479 = F_118 ( V_480 ) ;
V_648 . V_36 = F_7 ( V_646 ) ;
if ( ! V_647 && V_646 != V_649 )
V_648 . V_36 |= F_7 ( V_650 ) ;
return F_152 ( V_121 , V_2 , V_635 , V_296 , V_475 , 1 , & V_648 ) ;
}
int
F_154 ( const unsigned int V_121 , struct V_1 * V_2 ,
T_5 * V_651 , const T_15 V_652 )
{
int V_39 ;
struct V_653 * V_117 = NULL ;
int V_131 = V_596 ;
F_9 ( V_49 , L_77 ) ;
V_39 = F_27 ( V_57 , V_2 , ( void * * ) & V_117 ) ;
if ( V_39 )
