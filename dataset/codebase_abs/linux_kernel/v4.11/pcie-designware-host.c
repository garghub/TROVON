...
V_79 = F_39 ( V_54 , V_83 , L_1 ) ;
if ( V_79 ) {
V_2 -> V_84 = F_40 ( V_79 ) / 2 ;
V_2 -> V_85 = F_40 ( V_79 ) / 2 ;
V_2 -> V_86 = V_79 -> V_87 ;
V_2 -> V_88 = V_79 -> V_87 + V_2 -> V_84 ;
} else if ( ! V_2 -> V_89 ) {
F_41 ( V_60 , L_2 ) ;
}
V_15 = F_42 ( V_73 , 0 , 0xff , & V_26 , & V_2 -> V_90 ) ;
if ( V_15 )
return V_15 ;
V_15 = F_43 ( V_60 , & V_26 ) ;
if ( V_15 )
goto error;
F_44 (win, tmp, &res) {
switch ( F_45 ( V_81 -> V_26 ) ) {
case V_91 :
V_15 = F_46 ( V_81 -> V_26 , V_2 -> V_90 ) ;
if ( V_15 ) {
F_47 ( V_60 , L_3 ,
V_15 , V_81 -> V_26 ) ;
F_48 ( V_81 ) ;
...
V_2 -> V_92 = V_81 -> V_26 ;
V_2 -> V_92 -> V_93 = L_4 ;
V_2 -> V_94 = F_40 ( V_2 -> V_92 ) ;
V_2 -> V_95 = V_2 -> V_92 -> V_87 - V_81 -> V_96 ;
}
break;
case V_83 :
V_2 -> V_97 = V_81 -> V_26 ;
V_2 -> V_97 -> V_93 = L_5 ;
V_2 -> V_98 = F_40 ( V_2 -> V_97 ) ;
V_2 -> V_99 = V_2 -> V_97 -> V_87 - V_81 -> V_96 ;
break;
case 0 :
V_2 -> V_100 = V_81 -> V_26 ;
V_2 -> V_84 = F_40 ( V_2 -> V_100 ) / 2 ;
V_2 -> V_85 = F_40 ( V_2 -> V_100 ) / 2 ;
V_2 -> V_86 = V_2 -> V_100 -> V_87 ;
V_2 -> V_88 = V_2 -> V_100 -> V_87 + V_2 -> V_84 ;
break;
case V_101 :
V_2 -> V_102 = V_81 -> V_26 ;
break;
...
if ( ! V_7 -> V_10 ) {
V_7 -> V_10 = F_49 ( V_60 , V_2 -> V_100 -> V_87 ,
F_40 ( V_2 -> V_100 ) ) ;
if ( ! V_7 -> V_10 ) {
F_41 ( V_60 , L_6 ) ;
V_15 = - V_103 ;
...
V_2 -> V_104 = V_2 -> V_97 -> V_87 ;
if ( ! V_2 -> V_89 ) {
V_2 -> V_89 = F_49 ( V_60 , V_2 -> V_86 ,
V_2 -> V_84 ) ;
if ( ! V_2 -> V_89 ) {
F_41 ( V_60 , L_7 ) ;
V_15 = - V_103 ;
...
if ( V_2 -> V_8 -> V_111 )
V_2 -> V_8 -> V_111 ( V_2 ) ;
V_2 -> V_112 = V_2 -> V_102 -> V_87 ;
if ( F_51 ( F_26 ) ) {
V_55 = F_54 ( V_60 , V_2 -> V_112 ,
& V_113 , V_2 , & V_26 ,
& V_109 ) ;
V_109 . V_60 = V_60 ;
} else
V_55 = F_55 ( V_60 , V_2 -> V_112 , & V_113 ,
V_2 , & V_26 ) ;
if ( ! V_55 ) {
V_15 = - V_103 ;
goto error;
...
static int F_64 ( struct V_1 * V_2 , struct V_76 * V_55 ,
T_1 V_117 , int V_3 , int V_4 , T_1 * V_5 )
{
int V_15 , type ;
T_1 V_118 , V_119 ;
T_3 V_120 ;
...
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_2 -> V_8 -> V_122 )
return V_2 -> V_8 -> V_122 ( V_2 , V_55 , V_117 , V_3 , V_4 , V_5 ) ;
V_118 = F_65 ( V_55 -> V_123 ) | F_66 ( F_67 ( V_117 ) ) |
F_68 ( F_69 ( V_117 ) ) ;
if ( V_55 -> V_124 -> V_123 == V_2 -> V_112 ) {
type = V_125 ;
V_120 = V_2 -> V_86 ;
V_119 = V_2 -> V_84 ;
V_121 = V_2 -> V_89 ;
...
static int F_71 ( struct V_1 * V_2 , struct V_76 * V_55 ,
T_1 V_117 , int V_3 , int V_4 , T_1 V_5 )
{
int V_15 , type ;
T_1 V_118 , V_119 ;
...
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_2 -> V_8 -> V_129 )
return V_2 -> V_8 -> V_129 ( V_2 , V_55 , V_117 , V_3 , V_4 , V_5 ) ;
V_118 = F_65 ( V_55 -> V_123 ) | F_66 ( F_67 ( V_117 ) ) |
F_68 ( F_69 ( V_117 ) ) ;
if ( V_55 -> V_124 -> V_123 == V_2 -> V_112 ) {
type = V_125 ;
...
static int F_72 ( struct V_1 * V_2 , struct V_76 * V_55 ,
int V_60 )
{
struct V_6 * V_7 = F_2 ( V_2 ) ;
if ( V_55 -> V_123 != V_2 -> V_112 ) {
if ( ! F_73 ( V_7 ) )
return 0 ;
}
if ( V_55 -> V_123 == V_2 -> V_112 && V_60 > 0 )
return 0 ;
return 1 ;
}
static int F_74 ( struct V_76 * V_55 , T_1 V_117 , int V_3 ,
int V_4 , T_1 * V_5 )
{
struct V_1 * V_2 = V_55 -> V_56 ;
if ( ! F_72 ( V_2 , V_55 , F_67 ( V_117 ) ) ) {
* V_5 = 0xffffffff ;
return V_130 ;
}
if ( V_55 -> V_123 == V_2 -> V_112 )
return F_1 ( V_2 , V_3 , V_4 , V_5 ) ;
return F_64 ( V_2 , V_55 , V_117 , V_3 , V_4 , V_5 ) ;
}
static int F_75 ( struct V_76 * V_55 , T_1 V_117 ,
...
return F_71 ( V_2 , V_55 , V_117 , V_3 , V_4 , V_5 ) ;
}
static T_6 F_76 ( struct V_6 * V_7 )
{
T_1 V_5 ;
V_5 = F_77 ( V_7 , V_131 ) ;
if ( V_5 == 0xffffffff )
...
struct V_6 * V_7 = F_2 ( V_2 ) ;
F_79 ( V_7 ) ;
F_80 ( V_7 , V_132 , 0x00000004 ) ;
F_80 ( V_7 , V_133 , 0x00000000 ) ;
V_5 = F_77 ( V_7 , V_134 ) ;
V_5 &= 0xffff00ff ;
V_5 |= 0x00000100 ;
F_80 ( V_7 , V_134 , V_5 ) ;
