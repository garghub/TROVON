...
V_20 -> V_10 = V_6 -> V_10 ;
V_20 -> V_9 = V_6 -> V_9 ;
V_20 -> V_27 = V_6 -> V_76 -> V_27 ;
V_20 -> V_26 = V_6 -> V_76 -> V_40 [ 0 ] * 8 ;
...
{
int V_21 ;
if ( F_49 ( V_6 -> V_13 != V_13 || ! V_6 -> V_76 ) )
return - V_36 ;
F_30 ( & V_6 -> V_65 ) ;
V_6 -> V_59 = V_59 ;
V_21 = F_50 ( V_13 , & V_6 -> V_62 , V_102 ,
false , F_46 ) ;
if ( V_21 )
goto V_103;
...
int F_65 ( int V_9 ,
const struct V_5 * V_6 , int V_113 )
{
if ( V_113 >= V_6 -> V_76 -> V_39 )
return 0 ;
if ( V_113 == 0 )
return V_9 ;
return V_9 / V_6 -> V_76 -> V_37 ;
}
int F_66 ( int V_10 ,
const struct V_5 * V_6 , int V_113 )
{
