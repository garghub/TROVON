...
+ V_114 -> V_61 ;
V_114 -> V_127 . V_129 = V_114 -> V_87 . V_129 ;
...
V_58 -> V_87 = V_131 ;
V_88 = & V_58 -> V_87 ;
V_88 -> V_129 = V_36 -> V_61 + V_58 -> V_61 ;
...
static const struct V_135 *
F_67 ( struct V_3 * V_136 ,
struct V_110 * V_111 )
{
int V_128 ;
struct V_37 * V_137 = V_111 -> V_12 . V_107 ;
struct V_37 * V_38 ;
const struct V_138 * V_139 ;
const struct V_135 * V_140 ;
struct V_57 * V_58 ;
struct V_141 * V_142 ;
void T_2 * V_143 [ V_144 ] ;
int V_35 ;
V_128 = F_68 ( V_137 , L_13 ) ;
if ( V_128 < 0 ) {
F_18 ( & V_111 -> V_12 , L_14 ) ;
return F_52 ( - V_145 ) ;
}
V_140 = F_69 ( & V_111 -> V_12 ) ;
V_140 += V_128 ;
V_136 -> V_146 = V_140 -> V_146 ;
V_136 -> V_147 = V_140 -> V_147 ;
V_136 -> V_125 = V_140 -> V_125 ;
V_136 -> V_60 = F_70 ( & V_111 -> V_12 , V_136 -> V_125 ,
sizeof( * V_136 -> V_60 ) , V_21 ) ;
if ( ! V_136 -> V_60 )
return F_52 ( - V_22 ) ;
if ( V_140 -> V_148 + 1 > V_144 )
return F_52 ( - V_46 ) ;
for ( V_35 = 0 ; V_35 < V_140 -> V_148 + 1 ; V_35 ++ ) {
V_142 = F_71 ( V_111 , V_149 , V_35 ) ;
if ( ! V_142 ) {
F_18 ( & V_111 -> V_12 , L_15 , V_35 ) ;
return F_52 ( - V_46 ) ;
}
V_143 [ V_35 ] = F_72 ( & V_111 -> V_12 , V_142 -> V_150 ,
F_73 ( V_142 ) ) ;
if ( ! V_143 [ V_35 ] ) {
F_18 ( & V_111 -> V_12 , L_16 , V_142 ) ;
return F_52 ( - V_151 ) ;
}
}
V_58 = V_136 -> V_60 ;
V_139 = V_140 -> V_60 ;
for ( V_35 = 0 ; V_35 < V_140 -> V_125 ; ++ V_35 , ++ V_139 , ++ V_58 ) {
V_58 -> type = V_139 -> type ;
V_58 -> V_64 = V_139 -> V_64 ;
V_58 -> V_62 = V_139 -> V_62 ;
V_58 -> V_152 = V_139 -> V_152 ;
V_58 -> V_153 = V_139 -> V_153 ;
V_58 -> V_154 = V_139 -> V_154 ;
V_58 -> V_155 = V_139 -> V_155 ;
V_58 -> V_8 = V_139 -> V_8 ;
F_74 ( & V_58 -> V_76 ) ;
V_58 -> V_36 = V_136 ;
V_58 -> V_61 = V_136 -> V_62 ;
V_136 -> V_62 += V_58 -> V_62 ;
V_58 -> V_156 = V_143 [ 0 ] ;
V_58 -> V_63 = V_143 [ V_139 -> V_157 ] ;
}
F_23 (node, np) {
if ( ! F_56 ( V_38 , L_17 , NULL ) )
continue;
V_58 = V_136 -> V_60 ;
for ( V_35 = 0 ; V_35 < V_136 -> V_125 ; ++ V_35 , ++ V_58 ) {
...
if ( ! V_36 )
return - V_22 ;
V_140 = F_67 ( V_36 , V_111 ) ;
if ( F_58 ( V_140 ) ) {
F_18 ( & V_111 -> V_12 , L_18 ) ;
return F_59 ( V_140 ) ;
}
V_36 -> V_12 = V_12 ;
V_142 = F_71 ( V_111 , V_158 , 0 ) ;
if ( V_142 )
V_36 -> V_159 = V_142 -> V_150 ;
if ( V_140 -> V_160 ) {
V_36 -> V_161 = V_140 -> V_160 -> V_162 ( V_36 ,
V_140 -> V_160 ) ;
if ( F_58 ( V_36 -> V_161 ) )
return F_59 ( V_36 -> V_161 ) ;
}
V_39 = F_63 ( V_111 , V_36 ) ;
if ( V_39 )
return V_39 ;
...
const T_4 * V_165 = V_58 -> type -> V_77 ;
const T_4 * V_166 = V_58 -> type -> V_74 ;
enum V_80 type ;
if ( ! V_166 [ V_167 ] )
continue;
for ( type = 0 ; type < V_85 ; type ++ )
if ( V_166 [ type ] )
V_58 -> V_168 [ type ] = F_30 ( V_55 + V_165 [ type ] ) ;
if ( V_166 [ V_75 ] * V_58 -> V_62 > 32 ) {
V_58 -> V_168 [ V_85 ] =
F_30 ( V_55 + V_165 [ V_75 ] + 4 ) ;
F_79 ( L_19 ,
V_58 -> V_8 , V_55 ,
V_58 -> V_168 [ V_75 ] ,
V_58 -> V_168 [ V_85 ] ) ;
...
F_79 ( L_20 , V_58 -> V_8 ,
V_55 , V_58 -> V_168 [ V_75 ] ) ;
}
}
if ( V_36 -> V_146 )
V_36 -> V_146 ( V_36 ) ;
if ( V_36 -> V_161 && V_36 -> V_161 -> V_169 )
V_36 -> V_161 -> V_169 ( V_36 ) ;
return 0 ;
}
...
F_79 ( L_21 ,
V_58 -> V_8 , V_55 ,
F_30 ( V_55 + V_165 [ V_75 ] ) ,
F_30 ( V_55 + V_165 [ V_75 ] + 4 ) ,
V_58 -> V_168 [ V_75 ] ,
V_58 -> V_168 [ V_85 ] ) ;
F_31 ( V_58 -> V_168 [ V_85 ] ,
V_55 + V_165 [ V_75 ] + 4 ) ;
} else {
F_79 ( L_22 , V_58 -> V_8 ,
V_55 , F_30 ( V_55 + V_165 [ V_75 ] ) ,
V_58 -> V_168 [ V_75 ] ) ;
}
for ( type = 0 ; type < V_85 ; type ++ )
if ( V_166 [ type ] )
F_31 ( V_58 -> V_168 [ type ] , V_55 + V_165 [ type ] ) ;
}
if ( V_36 -> V_161 && V_36 -> V_161 -> V_170 )
V_36 -> V_161 -> V_170 ( V_36 ) ;
return 0 ;
}
