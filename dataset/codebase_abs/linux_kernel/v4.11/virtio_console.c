...
if ( ! V_1 )
return - V_125 ;
V_68 = F_89 ( V_27 , V_83 , V_53 ) ;
if ( ! V_68 )
return - V_91 ;
F_35 ( V_32 , V_68 , V_83 ) ;
V_52 = F_51 ( V_1 , V_32 , 1 , V_83 , V_68 , false ) ;
F_18 ( V_68 ) ;
return V_52 ;
}
static int F_90 ( T_1 V_2 , char * V_27 , int V_83 )
{
struct V_1 * V_1 ;
if ( F_79 ( V_124 ) )
return 0 ;
...
if ( ! F_12 ( V_21 ) &&
F_93 ( V_21 , V_126 ) )
F_94 ( V_1 -> V_4 . V_19 , V_1 -> V_4 . V_127 ) ;
}
static int F_95 ( struct V_128 * V_129 , int V_68 )
{
struct V_1 * V_1 ;
V_1 = F_1 ( V_129 -> V_2 ) ;
if ( ! V_1 )
...
static void F_96 ( struct V_128 * V_129 , int V_68 )
{
V_129 -> V_130 = 0 ;
}
int T_8 F_97 ( int (* F_88)( T_1 , const char * , int ) )
{
V_124 = F_88 ;
return F_98 ( 0 , 0 , & V_131 ) ;
}
static int F_99 ( struct V_1 * V_1 )
{
int V_52 ;
V_1 -> V_4 . V_2 = V_132 . V_133 ;
V_1 -> V_4 . V_19 = F_100 ( V_1 -> V_4 . V_2 , 0 , & V_131 , V_104 ) ;
if ( F_101 ( V_1 -> V_4 . V_19 ) ) {
V_52 = F_102 ( V_1 -> V_4 . V_19 ) ;
F_103 ( V_1 -> V_10 ,
L_3 , V_52 ) ;
V_1 -> V_4 . V_19 = NULL ;
return V_52 ;
...
static T_4 F_104 ( struct V_23 * V_10 ,
...
static T_4 F_106 ( struct V_80 * V_81 , char T_5 * V_82 ,
T_3 V_83 , T_6 * V_84 )
{
struct V_1 * V_1 ;
char * V_27 ;
...
V_139 += snprintf ( V_27 + V_139 , V_74 - V_139 ,
L_16 , V_1 -> V_4 . V_2 ) ;
V_52 = F_107 ( V_82 , V_83 , V_84 , V_27 , V_139 ) ;
F_18 ( V_27 ) ;
return V_52 ;
}
static void F_108 ( struct V_1 * V_1 , T_9 V_140 , T_9 V_141 )
{
if ( ! V_1 || ! F_11 ( V_1 ) )
return;
...
static unsigned int F_109 ( struct V_15 * V_16 , T_10 * V_144 )
{
struct V_26 * V_27 ;
unsigned int V_145 ;
int V_52 ;
...
F_111 ( & V_1 -> V_123 , V_146 , V_147 ) ;
}
static int F_112 ( struct V_8 * V_9 , T_1 V_14 )
{
char V_148 [ 16 ] ;
struct V_1 * V_1 ;
struct V_26 * V_27 ;
...
V_1 -> V_12 = F_114 () ;
if ( ! V_1 -> V_12 ) {
F_103 ( & V_1 -> V_9 -> V_21 -> V_10 , L_17 ) ;
V_55 = - V_91 ;
goto V_153;
}
V_1 -> V_12 -> V_154 = & V_155 ;
V_149 = F_115 ( V_9 -> V_156 , V_14 ) ;
V_55 = F_116 ( V_1 -> V_12 , V_149 , 1 ) ;
if ( V_55 < 0 ) {
F_103 ( & V_1 -> V_9 -> V_21 -> V_10 ,
L_18 , V_55 , V_14 ) ;
goto V_157;
}
V_1 -> V_10 = F_117 ( V_132 . V_158 , & V_1 -> V_9 -> V_21 -> V_10 ,
V_149 , V_1 , L_19 ,
...
return 0 ;
V_161:
while ( ( V_27 = F_121 ( V_1 -> V_17 ) ) )
F_15 ( V_27 , true ) ;
V_160:
F_122 ( V_132 . V_158 , V_1 -> V_10 -> V_149 ) ;
V_157:
F_123 ( V_1 -> V_12 ) ;
V_153:
F_18 ( V_1 ) ;
...
V_1 = F_9 ( V_9 , F_131 ( V_21 , V_63 -> V_14 ) ) ;
if ( ! V_1 &&
...
if ( F_131 ( V_21 , V_63 -> V_14 ) >=
V_9 -> V_171 ) {
F_39 ( & V_9 -> V_21 -> V_10 ,
L_24
L_25 ,
V_63 -> V_14 , V_9 -> V_171 - 1 ) ;
break;
}
F_112 ( V_9 , F_131 ( V_21 , V_63 -> V_14 ) ) ;
break;
case V_172 :
F_125 ( V_1 ) ;
break;
...
sizeof( V_36 ) ) ;
F_108 ( V_1 , V_36 . V_140 , V_36 . V_141 ) ;
V_1 -> V_4 . V_19 -> V_130 = 1 ;
F_92 ( V_1 ) ;
break;
}
case V_116 :
V_1 -> V_79 = F_133 ( V_21 , V_63 -> V_60 ) ;
F_126 ( & V_1 -> V_90 ) ;
F_57 ( & V_1 -> V_70 ) ;
F_50 ( V_1 ) ;
F_58 ( & V_1 -> V_70 ) ;
...
struct V_26 * V_27 ;
unsigned int V_47 ;
V_9 = F_4 ( V_179 , struct V_8 , V_180 ) ;
V_16 = V_9 -> V_181 ;
F_42 ( & V_9 -> V_182 ) ;
...
V_27 -> V_47 = V_47 ;
V_27 -> V_48 = 0 ;
F_130 ( V_16 -> V_21 , V_9 , V_27 ) ;
F_42 ( & V_9 -> V_182 ) ;
if ( F_34 ( V_9 -> V_181 , V_27 ) < 0 ) {
F_39 ( & V_9 -> V_21 -> V_10 ,
L_28 ) ;
F_15 ( V_27 , false ) ;
}
...
F_5 ( & V_1 -> V_57 , V_5 ) ;
F_126 ( & V_1 -> V_90 ) ;
if ( F_11 ( V_1 ) && F_140 ( V_1 -> V_4 . V_19 ) )
F_141 () ;
}
...
static void F_144 ( struct V_20 * V_21 )
{
struct V_8 * V_9 ;
V_9 = V_21 -> V_183 ;
if ( ! F_13 ( V_9 ) )
...
static void F_145 ( struct V_178 * V_179 )
{
struct V_8 * V_9 ;
V_9 = F_4 ( V_179 , struct V_8 , V_184 ) ;
if ( ! F_13 ( V_9 ) ) {
struct V_20 * V_21 ;
struct V_1 * V_1 ;
T_9 V_140 , V_141 ;
V_21 = V_9 -> V_21 ;
F_146 ( V_21 , struct V_185 , V_141 , & V_141 ) ;
F_146 ( V_21 , struct V_185 , V_140 , & V_140 ) ;
V_1 = F_9 ( V_9 , 0 ) ;
F_108 ( V_1 , V_140 , V_141 ) ;
F_92 ( V_1 ) ;
}
}
...
char * * V_187 ;
struct V_15 * * V_188 ;
T_1 V_29 , V_189 , V_190 , V_191 ;
int V_55 ;
V_190 = V_9 -> V_171 ;
V_191 = F_13 ( V_9 ) ? ( V_190 + 1 ) * 2 : 2 ;
V_188 = F_29 ( V_191 * sizeof( struct V_15 * ) , V_44 ) ;
V_186 = F_29 ( V_191 * sizeof( T_12 * ) , V_44 ) ;
V_187 = F_29 ( V_191 * sizeof( char * ) , V_44 ) ;
V_9 -> V_151 = F_29 ( V_190 * sizeof( struct V_15 * ) ,
V_44 ) ;
V_9 -> V_152 = F_29 ( V_190 * sizeof( struct V_15 * ) ,
V_44 ) ;
if ( ! V_188 || ! V_186 || ! V_187 || ! V_9 -> V_151 ||
! V_9 -> V_152 ) {
V_55 = - V_91 ;
goto free;
}
...
V_55 = V_9 -> V_21 -> V_192 -> V_193 ( V_9 -> V_21 , V_191 , V_188 ,
V_186 ,
...
V_189 += 2 ;
if ( F_13 ( V_9 ) ) {
V_9 -> V_181 = V_188 [ V_189 ] ;
V_9 -> V_61 = V_188 [ V_189 + 1 ] ;
for ( V_29 = 1 ; V_29 < V_190 ; V_29 ++ ) {
V_189 += 2 ;
V_9 -> V_151 [ V_29 ] = V_188 [ V_189 ] ;
V_9 -> V_152 [ V_29 ] = V_188 [ V_189 + 1 ] ;
}
}
F_18 ( V_187 ) ;
F_18 ( V_186 ) ;
...
if ( ! F_13 ( V_9 ) )
return;
while ( ( V_27 = F_33 ( V_9 -> V_181 , & V_47 ) ) )
F_15 ( V_27 , true ) ;
while ( ( V_27 = F_121 ( V_9 -> V_181 ) ) )
F_15 ( V_27 , true ) ;
}
...
V_55 = F_147 ( V_9 ) ;
if ( V_55 < 0 ) {
F_103 ( & V_21 -> V_10 , L_36 , V_55 ) ;
goto V_200;
}
F_118 ( & V_9 -> V_11 ) ;
F_154 ( & V_9 -> V_162 ) ;
F_155 ( V_9 -> V_21 ) ;
F_156 ( & V_9 -> V_184 , & F_145 ) ;
F_156 ( & V_9 -> V_180 , & F_137 ) ;
if ( V_195 ) {
unsigned int V_145 ;
F_118 ( & V_9 -> V_182 ) ;
F_118 ( & V_9 -> V_62 ) ;
V_145 = F_109 ( V_9 -> V_181 ,
& V_9 -> V_182 ) ;
if ( ! V_145 ) {
F_103 ( & V_21 -> V_10 ,
L_37 ) ;
...
F_155 ( V_9 -> V_21 ) ;
if ( F_13 ( V_9 ) )
F_109 ( V_9 -> V_181 , & V_9 -> V_182 ) ;
F_3 (port, &portdev->ports, list) {
V_1 -> V_17 = V_9 -> V_151 [ V_1 -> V_14 ] ;
V_1 -> V_18 = V_9 -> V_152 [ V_1 -> V_14 ] ;
F_109 ( V_1 -> V_17 , & V_1 -> V_57 ) ;
F_49 ( V_1 , V_163 , 1 ) ;
if ( V_1 -> V_78 )
F_49 ( V_1 , V_116 , 1 ) ;
}
...
{
int V_55 ;
V_132 . V_158 = F_165 ( V_207 , L_38 ) ;
if ( F_101 ( V_132 . V_158 ) ) {
V_55 = F_102 ( V_132 . V_158 ) ;
F_166 ( L_39 , V_55 ) ;
return V_55 ;
}
V_132 . V_164 = F_167 ( L_38 , NULL ) ;
if ( ! V_132 . V_164 )
F_168 ( L_40 ) ;
F_154 ( & V_132 . V_134 ) ;
F_154 ( & V_132 . V_202 ) ;
