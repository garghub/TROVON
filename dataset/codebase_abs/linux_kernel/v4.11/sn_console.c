...
static void F_22 ( struct V_7 * V_8 , int V_18 )
{
}
...
static void
F_24 ( struct V_7 * V_8 , struct V_19 * V_20 ,
struct V_19 * V_21 )
{
}
...
static void F_26 ( struct V_7 * V_8 , int V_22 )
{
}
static int F_27 ( const char * V_23 , ... )
{
...
static void
F_29 ( struct V_28 * V_8 , unsigned long V_22 )
{
...
V_36 = 0 ;
if ( V_1 && F_32 ( V_39 , V_37 ) ) {
F_33 ( & V_8 -> V_32 . V_40 , V_22 ) ;
F_34 ( V_1 ) ;
F_35 ( & V_8 -> V_32 . V_40 , V_22 ) ;
continue;
}
}
if ( V_1 == * V_41 ) {
...
static void F_38 ( struct V_28 * V_8 , int V_46 )
{
...
static void F_48 ( unsigned long V_68 )
{
...
static void T_3 F_50 ( struct V_28 * V_8 )
{
unsigned long V_22 ;
if ( ! V_8 )
return;
...
F_49 ( & V_8 -> V_70 , V_39 + V_8 -> V_71 ) ;
V_8 -> V_56 = 1 ;
F_33 ( & V_8 -> V_32 . V_40 , V_22 ) ;
}
static void T_3 F_53 ( struct V_28 * V_8 )
{
unsigned long V_22 ;
if ( V_8 ) {
F_44 ( L_8 ) ;
...
static void F_63 ( int (* F_64) ( const char * V_5 , int V_6 ) ,
...
static void
F_65 ( struct V_103 * V_104 , const char * V_5 , unsigned V_101 )
{
...
F_39 ( ! V_8 -> V_56 ) ;
if ( ! V_8 -> V_32 . V_33 ) {
F_63 ( V_8 -> V_15 -> V_27 , V_5 , V_101 ) ;
return;
}
if ( F_66 ( & V_8 -> V_32 . V_40 ) ) {
int V_106 = V_8 -> V_32 . V_33 -> V_55 . V_49 ;
int V_107 = V_8 -> V_32 . V_33 -> V_55 . V_48 ;
int V_108 , V_109 = 0 ;
for ( V_108 = 0 ; V_108 < 150 ; F_67 ( 125 ) , V_108 ++ ) {
if ( ! F_66 ( & V_8 -> V_32 . V_40 )
|| V_105 ) {
if ( ! V_105 ) {
F_35 ( & V_8 -> V_32 . V_40 ,
...
static int F_68 ( struct V_103 * V_104 , char * V_110 )
{
return 0 ;
}
static void T_3
F_69 ( struct V_103 * V_104 , const char * V_5 , unsigned V_101 )
{
F_63 ( V_14 . V_15 -> V_27 , V_5 , V_101 ) ;
}
int T_3 F_70 ( void )
{
if ( ! F_58 ( L_11 ) )
