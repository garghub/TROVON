...
return - V_121 ;
if ( F_2 ( V_5 -> V_12 ) & V_122 )
return 0 ;
return 1 ;
}
static inline T_2 F_15 ( void * V_123 , T_3 V_124 )
{
struct V_4 * V_5 = (struct V_4 * ) V_123 ;
T_2 V_125 ;
V_125 = F_2 ( V_5 -> V_126 ) ;
V_125 += F_2 ( V_5 -> V_43 ) * 1000000000ULL ;
return V_125 ;
}
static int F_16 ( void * V_123 )
{
struct V_4 * V_5 = (struct V_4 * ) V_123 ;
T_3 V_127 , V_128 ;
int V_10 = 1 ;
V_127 = V_5 -> V_12 & V_49 ;
V_128 = ( ( V_5 -> V_12 & V_129 )
>> V_130 ) ;
if ( F_4 ( ! V_127 && V_128 ) ) {
if ( ( V_5 -> V_126 == 0xffffffff ) && ( V_5 -> V_43 == 0xffffffff ) )
V_10 = - V_121 ;
else
V_10 = 0 ;
}
...
static int F_17 ( void * V_123 , T_3 V_124 )
{
struct V_4 * V_5 = (struct V_4 * ) V_123 ;
int V_10 = - V_121 ;
...
int V_148 , int V_149 , bool V_143 ,
bool V_144 , unsigned int V_150 ,
unsigned int V_151 )
{
unsigned int V_9 = F_2 ( V_5 -> V_12 ) ;
if ( V_148 )
V_5 -> V_45 |= F_9 ( ( V_148 & V_114 ) ) ;
if ( V_149 )
V_5 -> V_45 |= F_9 ( ( V_149 << V_152 )
& V_153 ) ;
if ( V_140 ) {
V_9 |= V_145 |
V_154 |
...
static void F_25 ( void * V_159 , unsigned int V_160 , bool V_161 )
{
struct V_4 * V_5 = (struct V_4 * ) V_159 ;
int V_133 ;
F_26 ( L_1 , V_161 ? L_2 : L_3 ) ;
for ( V_133 = 0 ; V_133 < V_160 ; V_133 ++ ) {
F_26 ( L_4 ,
V_133 , ( unsigned int ) F_27 ( V_5 ) ,
F_2 ( V_5 -> V_126 ) , F_2 ( V_5 -> V_43 ) ,
F_2 ( V_5 -> V_45 ) , F_2 ( V_5 -> V_12 ) ) ;
V_5 ++ ;
}
}
static void F_28 ( struct V_4 * V_5 , unsigned int V_162 )
{
V_5 -> V_126 = 0 ;
V_5 -> V_43 = 0 ;
V_5 -> V_45 = F_9 ( V_162 ) ;
V_5 -> V_12 = F_9 ( V_120 | V_163 ) ;
}
