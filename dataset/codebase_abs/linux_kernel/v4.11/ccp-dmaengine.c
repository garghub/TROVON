...
struct V_23 * V_23 , struct V_51 * V_52 ,
unsigned int V_53 , struct V_51 * V_54 ,
unsigned int V_55 , unsigned long V_26 )
{
struct V_24 * V_25 = F_9 ( V_23 , struct V_24 ,
V_23 ) ;
struct V_17 * V_18 ;
F_10 ( V_25 -> V_2 -> V_9 ,
L_13 ,
V_27 , V_54 , V_55 , V_52 , V_53 , V_26 ) ;
V_18 = F_42 ( V_23 , V_52 , V_53 , V_54 , V_55 ,
V_26 ) ;
if ( ! V_18 )
return NULL ;
return & V_18 -> V_31 ;
}
static struct V_38 * F_50 (
...
static void F_51 ( struct V_23 * V_23 )
{
struct V_24 * V_25 = F_9 ( V_23 , struct V_24 ,
V_23 ) ;
struct V_17 * V_18 ;
unsigned long V_26 ;
F_10 ( V_25 -> V_2 -> V_9 , L_14 , V_27 ) ;
F_11 ( & V_25 -> V_28 , V_26 ) ;
V_18 = F_29 ( V_25 ) ;
F_12 ( & V_25 -> V_28 , V_26 ) ;
if ( V_18 )
...
static enum V_80 F_52 ( struct V_23 * V_23 ,
T_1 V_34 ,
struct V_81 * V_82 )
{
struct V_24 * V_25 = F_9 ( V_23 , struct V_24 ,
...
V_33 = F_53 ( V_23 , V_34 , V_82 ) ;
if ( V_33 == V_41 ) {
F_11 ( & V_25 -> V_28 , V_26 ) ;
F_54 (desc, &chan->complete, entry) {
...
V_83:
F_10 ( V_25 -> V_2 -> V_9 , L_15 , V_27 , V_33 ) ;
return V_33 ;
}
...
static int F_57 ( struct V_23 * V_23 )
{
struct V_24 * V_25 = F_9 ( V_23 , struct V_24 ,
V_23 ) ;
unsigned long V_26 ;
...
unsigned int V_88 ;
int V_33 ;
V_2 -> V_24 = F_59 ( V_2 -> V_9 , V_2 -> V_89 ,
sizeof( * ( V_2 -> V_24 ) ) ,
V_90 ) ;
if ( ! V_2 -> V_24 )
return - V_91 ;
V_86 = F_60 ( V_2 -> V_9 , V_90 ,
L_16 ,
V_2 -> V_92 ) ;
if ( ! V_86 )
return - V_91 ;
...
V_85 -> V_9 = V_2 -> V_9 ;
V_85 -> V_95 = F_62 ( F_63 ( V_2 -> V_9 ) ) ;
V_85 -> V_96 = F_62 ( F_63 ( V_2 -> V_9 ) ) ;
V_85 -> V_97 = V_98 ;
V_85 -> V_99 = V_100 ;
F_64 ( V_101 , V_85 -> V_102 ) ;
F_64 ( V_103 , V_85 -> V_102 ) ;
F_64 ( V_104 , V_85 -> V_102 ) ;
if ( F_1 ( V_2 ) == V_7 )
F_64 ( V_7 , V_85 -> V_102 ) ;
F_41 ( & V_85 -> V_105 ) ;
