...
F_64 ( V_7 ) ;
F_59 ( V_7 ) ;
} else if ( F_65 ( V_98 & V_101 ) ) {
F_55 ( V_7 ) ;
F_43 ( V_7 , 0 ) ;
F_16 ( & V_11 -> V_16 , L_12 ,
V_98 , V_7 -> V_100 ) ;
} else if ( F_65 ( V_98 & V_102 ) ) {
F_57 ( V_7 ) ;
F_16 ( & V_11 -> V_16 , L_13 ,
V_98 , V_7 -> V_100 ) ;
} else if ( F_65 ( V_98 & V_103 ) ) {
F_58 ( V_7 ) ;
F_16 ( & V_11 -> V_16 , L_14 ,
V_98 , V_7 -> V_100 ) ;
} else if ( F_65 ( V_98 & V_104 ) ) {
F_60 ( V_7 ) ;
F_16 ( & V_11 -> V_16 , L_15 ,
V_98 , V_7 -> V_100 ) ;
} else {
...
static inline struct V_4 * F_66 ( struct V_9 * V_7 ,
int V_8 )
{
struct V_2 * V_106 ;
if ( F_65 ( V_8 >= V_7 -> V_15 ) )
return NULL ;
V_106 = (struct V_2 * ) V_7 -> V_19 ;
return & V_106 -> V_6 [ V_8 ] ;
}
static inline T_1 F_67 ( struct V_9 * V_7 )
{
union V_107 V_108 ;
V_108 . V_70 = F_40 ( V_7 -> V_71 , F_68 ( 0 , 0 ) ) ;
return V_108 . V_72 . V_90 ;
}
static inline void F_69 ( struct V_9 * V_7 ,
T_1 V_109 )
{
union V_110 V_111 ;
...
F_42 ( V_7 -> V_71 , F_70 ( 0 , 0 ) ,
V_111 . V_70 ) ;
}
static T_4 F_71 ( int V_96 , void * V_97 )
{
struct V_9 * V_7 = (struct V_9 * ) V_97 ;
struct V_10 * V_11 = V_7 -> V_11 ;
T_1 V_98 = F_67 ( V_7 ) ;
...
static void F_73 ( struct V_9 * V_7 , int V_65 )
{
struct V_10 * V_11 = V_7 -> V_11 ;
int V_115 ;
if ( ! F_74 ( & V_7 -> V_66 [ V_65 ] ,
V_13 ) ) {
F_16 ( & V_11 -> V_16 , L_18 ,
V_7 -> V_100 ) ;
return;
}
V_115 = V_7 -> V_100 % F_75 () ;
F_76 ( F_77 ( V_115 , V_7 -> V_40 ) ,
V_7 -> V_66 [ V_65 ] ) ;
F_36 ( F_37 ( V_11 , V_65 ) ,
V_7 -> V_66 [ V_65 ] ) ;
}
static void F_78 ( struct V_9 * V_7 , V_18 V_67 )
{
union V_116 V_117 ;
V_117 . V_70 = V_67 ;
F_42 ( V_7 -> V_71 , F_79 ( 0 , 0 ) , V_117 . V_70 ) ;
}
void F_80 ( struct V_9 * V_7 )
{
V_18 V_118 = 0 ;
F_39 ( V_7 , 0 ) ;
F_43 ( V_7 , 0 ) ;
...
static int F_81 ( struct V_10 * V_11 , const struct V_122 * V_123 )
{
struct V_124 * V_16 = & V_11 -> V_16 ;
struct V_9 * V_7 ;
int V_125 ;
V_7 = F_82 ( V_16 , sizeof( * V_7 ) , V_13 ) ;
if ( ! V_7 )
return - V_14 ;
F_83 ( V_11 , V_7 ) ;
V_7 -> V_11 = V_11 ;
...
V_125 = F_85 ( V_11 , V_126 ) ;
if ( V_125 ) {
F_16 ( V_16 , L_20 , V_125 ) ;
goto V_127;
}
V_7 -> V_120 |= V_128 ;
V_125 = F_86 ( V_11 , F_87 ( 48 ) ) ;
if ( V_125 ) {
F_16 ( V_16 , L_21 ) ;
goto V_129;
}
V_125 = F_88 ( V_11 , F_87 ( 48 ) ) ;
if ( V_125 ) {
F_16 ( V_16 , L_22 ) ;
goto V_129;
}
V_7 -> V_71 = F_89 ( V_11 , 0 , 0 ) ;
if ( ! V_7 -> V_71 ) {
F_16 ( V_16 , L_23 ) ;
V_125 = - V_14 ;
goto V_129;
}
V_7 -> V_40 = F_90 ( & V_11 -> V_16 ) ;
V_125 = F_91 ( V_11 , V_130 ,
V_130 , V_131 ) ;
if ( V_125 < 0 ) {
F_16 ( V_16 , L_24 ,
V_130 ) ;
