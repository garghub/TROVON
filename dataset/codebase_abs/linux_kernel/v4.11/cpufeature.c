...
{
for (; V_131 -> V_129 ; V_131 ++ )
if ( V_131 -> V_133 && F_46 ( V_131 -> V_132 ) )
F_50 ( V_131 -> V_133 , NULL , V_134 ) ;
}
...
bool F_66 ( unsigned int V_117 )
{
const struct V_98 * V_131 ;
if ( F_25 ( F_26 () ) )
return false ;
for ( V_131 = V_136 ; V_131 -> V_107 ; V_131 ++ )
...
static bool T_6
F_71 ( const struct V_98 * V_99 , int V_108 )
{
return ( F_72 ( V_142 ) && ! F_72 ( V_143 ) ) ;
}
static inline bool T_7 F_73 ( T_1 V_1 )
{
return ( F_74 ( V_1 ) == 0x3 &&
F_75 ( V_1 ) == 0x0 &&
F_76 ( V_1 ) == 0x0 &&
( F_77 ( V_1 ) == 0 ||
( ( F_77 ( V_1 ) >= 4 ) && ( F_77 ( V_1 ) <= 7 ) ) ) ) ;
}
static inline int F_78 ( T_1 V_1 , T_2 * V_144 )
{
switch ( V_1 ) {
case V_145 :
* V_144 = F_31 () ;
...
static int F_79 ( T_1 V_1 , T_2 * V_144 )
{
struct V_5 * V_2 ;
if ( ! F_73 ( V_1 ) )
return - V_149 ;
if ( F_77 ( V_1 ) == 0 )
return F_78 ( V_1 , V_144 ) ;
V_2 = F_2 ( V_1 ) ;
if ( V_2 )
* V_144 = F_80 ( V_2 ) ;
else
...
static int F_81 ( struct V_150 * V_151 , T_1 V_152 )
{
int V_126 ;
T_1 V_21 , V_153 ;
T_2 V_22 ;
V_21 = ( T_1 ) F_82 ( V_154 , V_152 ) << 5 ;
V_126 = F_79 ( V_21 , & V_22 ) ;
if ( ! V_126 ) {
V_153 = F_83 ( V_155 , V_152 ) ;
F_84 ( V_151 , V_153 , V_22 ) ;
V_151 -> V_156 += 4 ;
}
return V_126 ;
}
