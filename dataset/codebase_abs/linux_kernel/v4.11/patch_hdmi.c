...
F_26 ( V_2 , V_293 , 0 ,
V_62 , V_61 ) ;
if ( F_29 ( V_2 , V_293 ) & V_57 )
F_26 ( V_2 , V_293 , 0 , V_58 ,
V_59 ) ;
F_202 ( V_2 , V_293 ) ;
return 0 ;
}
...
V_315 = V_173 -> V_175 -> V_112 ;
V_316 = 0x2 ;
if ( V_2 -> V_318 && ( V_234 -> V_319 & V_320 ) )
F_26 ( V_2 ,
V_311 ,
0 ,
V_321 ,
V_234 -> V_319 & ~ V_320 & 0xff ) ;
F_26 ( V_2 , V_311 , 0 ,
V_312 , ( V_155 << 4 ) | 0x0 ) ;
F_26 ( V_2 , V_311 , 0 ,
V_314 , V_156 ) ;
...
{
struct V_3 * V_4 ;
int V_45 = F_213 ( V_2 , V_311 ,
V_323 ) ;
if ( V_45 < 0 )
return V_45 ;
V_2 -> V_258 . V_259 = F_204 ;
V_4 = V_2 -> V_4 ;
V_4 -> V_292 . V_179 = V_324 ;
V_4 -> V_292 . V_181 = V_325 ;
V_4 -> V_292 . V_180 = V_326 ;
return 0 ;
}
...
case 0x10de0005 :
case 0x10de0006 :
V_111 -> V_329 = ( 1U << 2 ) | ( 1U << 8 ) ;
break;
case 0x10de0007 :
V_111 -> V_329 = ( 1U << 2 ) | ( 1U << 6 ) | ( 1U << 8 ) ;
}
return 0 ;
}
...
V_2 -> V_258 . V_331 = F_218 ;
V_2 -> V_258 . V_332 = F_219 ;
F_214 ( V_2 , 8 ) ;
return 0 ;
}
static int F_222 ( struct V_110 * V_111 ,
struct V_333 * V_334 , int V_112 )
{
if ( V_334 -> V_335 == 0x00 && V_112 == 2 )
return V_336 ;
if ( V_334 -> V_112 != V_112 )
return - 1 ;
return V_337 ;
}
static int F_223 ( struct V_110 * V_111 ,
int V_96 , int V_315 , unsigned char * V_338 )
{
if ( V_96 == 0x00 && ( V_338 [ 0 ] != V_339 || V_338 [ 1 ] != V_340 ) )
return - V_12 ;
return 0 ;
}
...
V_4 = V_2 -> V_4 ;
V_4 -> V_60 = true ;
V_4 -> V_111 . V_117 . V_341 =
F_222 ;
V_4 -> V_111 . V_117 . V_342 = F_223 ;
return 0 ;
}
static void F_225 ( struct V_1 * V_2 , unsigned int V_156 )
{
unsigned int V_38 ;
V_38 = F_24 ( V_2 , V_343 , 0 ,
V_344 , 0 ) ;
V_38 = ( V_38 >> 24 ) & 0xff ;
F_26 ( V_2 , V_343 , 0 ,
V_345 ,
...
static struct V_193 * F_228 ( struct V_1 * V_2 , int type )
{
struct V_3 * V_4 = V_2 -> V_4 ;
unsigned int V_19 ;
for ( V_19 = 0 ; V_19 < V_4 -> V_11 ; V_19 ++ ) {
...
if ( V_45 < 0 )
return V_45 ;
V_18 = F_228 ( V_2 , V_245 ) ;
if ( ! V_18 )
return - V_186 ;
V_17 = & V_18 -> V_17 [ V_247 ] ;
V_17 -> V_117 . V_351 = F_226 ;
V_17 -> V_117 . V_352 = F_227 ;
return 0 ;
}
...
if ( V_45 )
return V_45 ;
V_2 -> V_258 . V_331 = F_229 ;
return 0 ;
}
static int F_231 ( struct V_1 * V_2 , T_1 V_120 ,
unsigned char * V_353 , int * V_35 )
{
return F_232 ( V_2 , V_120 , V_353 , V_35 ,
F_233 ( V_2 ) ) ;
}
static void F_234 ( struct V_1 * V_2 , T_1 V_6 , int V_96 ,
int V_97 , int V_98 )
{
F_26 ( V_2 , V_6 , 0 , V_354 , V_96 ) ;
}
static int F_235 ( int V_355 )
{
switch ( V_355 ) {
case 2 : return 3 ;
case 3 : return 2 ;
...
static int F_236 ( struct V_110 * V_111 ,
int V_96 , int V_315 , unsigned char * V_338 )
{
struct V_333 * V_334 ;
int V_19 , V_86 ;
V_334 = F_237 ( V_96 ) ;
for ( V_19 = 0 ; V_19 < V_315 ; ++ V_19 ) {
int V_356 = F_238 ( V_338 [ V_19 ] ) ;
bool V_357 = false ;
bool V_358 = false ;
if ( ! V_356 )
continue;
for ( V_86 = 0 + V_19 % 2 ; V_86 < 8 ; V_86 += 2 ) {
int V_359 = 7 - F_235 ( V_86 ) ;
if ( V_334 -> V_360 [ V_359 ] == V_356 ) {
V_357 = true ;
if ( V_19 % 2 == 0 && V_19 + 1 < V_315 ) {
int V_361 = 7 - F_235 ( V_86 + 1 ) ;
int V_362 = F_238 ( V_338 [ V_19 + 1 ] ) ;
int V_363 = V_334 -> V_360 [ V_361 ] ;
if ( V_362 == V_363 )
V_358 = true ;
else
return - V_12 ;
...
static int F_239 ( struct V_240 * V_241 ,
T_1 V_6 , int V_364 , int V_365 )
{
struct V_1 * V_2 = F_117 ( V_241 , struct V_1 , V_113 ) ;
int V_366 ;
int V_367 = 0 ;
...
if ( ! F_240 ( V_2 ) ) {
V_364 = F_235 ( V_364 ) ;
if ( V_364 % 2 != 0 && V_365 == 0xf )
return 0 ;
V_364 -= V_364 % 2 ;
if ( V_365 != 0xf )
V_365 -= V_365 % 2 ;
}
V_366 = V_368 + V_364 / 2 + ( V_364 % 2 ) * 0x00e ;
if ( V_365 != 0xf )
V_367 = ( V_365 << 4 ) | V_369 ;
return F_26 ( V_2 , V_6 , 0 , V_366 , V_367 ) ;
}
...
V_366 = V_373 + V_372 / 2 + ( V_372 % 2 ) * 0x00e ;
V_367 = F_24 ( V_2 , V_6 , 0 , V_366 , 0 ) ;
if ( ! ( V_367 & V_369 ) )
return 0xf ;
return ( ( V_367 & 0xf0 ) >> 4 ) + ! ! V_371 ;
}
static int F_242 (
struct V_110 * V_111 ,
struct V_333 * V_334 ,
...
if ( V_334 -> V_360 [ V_73 ] || V_334 -> V_360 [ V_73 + 1 ] )
V_374 ++ ;
}
if ( V_374 * 2 != V_112 )
return - 1 ;
...
static void F_243 ( struct V_110 * V_376 ,
struct V_333 * V_334 ,
...
int V_308 = 7 - F_235 ( 7 - V_73 ) ;
int V_377 = V_334 -> V_360 [ V_308 ] ;
if ( ! V_377 ) {
if ( V_334 -> V_360 [ V_308 + ( V_308 % 2 ? - 1 : 1 ) ] )
V_111 [ V_32 ++ ] = V_378 ;
continue;
}
V_111 [ V_32 ++ ] = F_244 ( V_377 ) ;
}
F_132 ( V_32 != V_112 ) ;
}
static int F_245 ( struct V_1 * V_2 , T_1 V_6 ,
bool V_147 )
{
int V_379 , V_380 ;
V_379 = F_24 ( V_2 , V_6 , 0 , V_381 , 0 ) ;
if ( V_379 >= 0 && ( V_379 & V_382 ) ) {
if ( V_147 )
V_380 = V_379 | V_383 ;
else
V_380 = V_379 & ~ V_383 ;
...
static int F_246 ( struct V_1 * V_2 , T_1 V_20 ,
T_1 V_6 , T_3 V_155 , int V_156 )
{
if ( F_233 ( V_2 ) ) {
int V_385 = 180 ;
...
if ( V_45 )
return V_45 ;
V_2 -> V_258 . V_259 = F_247 ;
V_4 = V_2 -> V_4 ;
V_4 -> V_117 . V_209 = F_231 ;
V_4 -> V_117 . V_119 = F_234 ;
V_4 -> V_117 . V_157 = F_245 ;
V_4 -> V_117 . V_239 = F_246 ;
V_4 -> V_111 . V_117 . V_391 = F_241 ;
V_4 -> V_111 . V_117 . V_392 = F_239 ;
if ( ! F_240 ( V_2 ) ) {
V_4 -> V_111 . V_117 . V_341 =
F_242 ;
V_4 -> V_111 . V_117 . V_393 =
F_243 ;
V_4 -> V_111 . V_117 . V_342 = F_236 ;
}
for ( V_21 = 0 ; V_21 < V_4 -> V_22 ; V_21 ++ ) {
V_160 = F_11 ( V_4 , V_21 ) ;
V_160 -> V_178 = F_249 ( V_160 -> V_178 , 8u ) ;
V_160 -> V_179 |= V_324 ;
V_160 -> V_180 |= V_326 ;
V_160 -> V_181 = F_249 ( V_160 -> V_181 , 24u ) ;
}
V_4 -> V_111 . V_178 = F_249 ( V_4 -> V_111 . V_178 , 8u ) ;
return 0 ;
}
static int F_250 ( struct V_1 * V_2 )
{
return F_213 ( V_2 , V_394 , V_395 ) ;
}
