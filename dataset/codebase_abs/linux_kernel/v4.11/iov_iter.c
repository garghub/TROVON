...
void F_53 ( struct V_4 * V_5 , T_1 V_57 )
{
if ( ! V_57 )
return;
V_5 -> V_15 += V_57 ;
...
T_1 V_37 = V_5 -> V_16 ;
while ( 1 ) {
T_1 V_54 = V_37 - V_24 -> V_33 [ V_25 ] . V_2 ;
if ( V_57 < V_54 ) {
V_37 -= V_57 ;
break;
}
V_57 -= V_54 ;
if ( ! V_57 && V_25 == V_5 -> V_58 ) {
V_37 = 0 ;
break;
}
if ( ! V_25 -- )
...
void F_55 ( struct V_4 * V_5 , int V_44 ,
...
void F_58 ( struct V_4 * V_5 , int V_44 ,
struct V_23 * V_24 ,
T_1 V_15 )
{
F_56 ( V_44 != V_56 ) ;
...
unsigned long F_60 ( const struct V_4 * V_5 )
{
unsigned long V_62 = 0 ;
T_1 V_52 = V_5 -> V_15 ;
if ( F_2 ( V_5 -> type & V_56 ) ) {
...
( V_52 != V_41 . V_61 ? V_52 : 0 ) ) ,
( V_62 |= ( ! V_62 ? 0 : ( unsigned long ) V_41 . V_17 ) |
( V_52 != V_41 . V_18 ? V_52 : 0 ) )
) ;
return V_62 ;
}
static inline T_1 F_61 ( struct V_4 * V_5 ,
T_1 V_64 ,
struct V_1 * * V_65 ,
int V_25 ,
T_1 * V_66 )
...
static T_3 F_62 ( struct V_4 * V_5 ,
...
return F_61 ( V_5 , F_3 ( V_64 , V_70 ) , V_65 , V_25 , V_66 ) ;
}
T_3 F_63 ( struct V_4 * V_5 ,
struct V_1 * * V_65 , T_1 V_64 , unsigned V_68 ,
T_1 * V_66 )
{
if ( V_64 > V_5 -> V_15 )
V_64 = V_5 -> V_15 ;
if ( F_2 ( V_5 -> type & V_56 ) )
return F_62 ( V_5 , V_65 , V_64 , V_68 , V_66 ) ;
F_41 (i, maxsize, v, ({
...
static struct V_1 * * F_64 ( T_1 V_54 )
{
struct V_1 * * V_30 = F_65 ( V_54 * sizeof( struct V_1 * ) , V_71 ) ;
if ( ! V_30 )
V_30 = F_66 ( V_54 * sizeof( struct V_1 * ) ) ;
return V_30 ;
}
...
V_69 = F_68 ( V_64 + * V_66 , V_51 ) ;
V_30 = F_64 ( V_69 ) ;
if ( ! V_30 )
return - V_72 ;
V_54 = F_61 ( V_5 , V_64 , V_30 , V_25 , V_66 ) ;
if ( V_54 > 0 )
* V_65 = V_30 ;
else
F_69 ( V_30 ) ;
...
V_64 = V_5 -> V_15 ;
if ( F_2 ( V_5 -> type & V_56 ) )
return F_67 ( V_5 , V_65 , V_64 , V_66 ) ;
F_41 (i, maxsize, v, ({
unsigned long addr = (unsigned long)v.iov_base;
size_t len = v.iov_len + (*start = addr & (PAGE_SIZE - 1));
int n;
...
T_1 F_71 ( void * V_47 , T_1 V_3 , T_4 * V_73 ,
struct V_4 * V_5 )
{
char * V_22 = V_47 ;
T_4 V_74 , V_26 ;
...
bool F_72 ( void * V_47 , T_1 V_3 , T_4 * V_73 ,
struct V_4 * V_5 )
{
char * V_22 = V_47 ;
T_4 V_74 , V_26 ;
...
T_1 F_73 ( const void * V_47 , T_1 V_3 , T_4 * V_73 ,
struct V_4 * V_5 )
{
const char * V_14 = V_47 ;
T_4 V_74 , V_26 ;
...
int F_74 ( const struct V_4 * V_5 , int V_68 )
{
T_1 V_52 = V_5 -> V_15 ;
int V_69 = 0 ;
if ( ! V_52 )
...
const void * F_75 ( struct V_4 * V_75 , struct V_4 * V_76 , T_5 V_77 )
{
* V_75 = * V_76 ;
...
if ( V_75 -> type & V_42 )
return V_75 -> V_60 = F_76 ( V_75 -> V_60 ,
V_75 -> V_21 * sizeof( struct V_59 ) ,
V_77 ) ;
else
return V_75 -> V_11 = F_76 ( V_75 -> V_11 ,
V_75 -> V_21 * sizeof( struct V_10 ) ,
V_77 ) ;
}
int F_77 ( int type , const struct V_10 T_2 * V_78 ,
unsigned V_21 , unsigned V_79 ,
struct V_10 * * V_11 , struct V_4 * V_5 )
{
T_3 V_54 ;
struct V_10 * V_30 ;
V_54 = F_78 ( type , V_78 , V_21 , V_79 ,
* V_11 , & V_30 ) ;
if ( V_54 < 0 ) {
if ( V_30 != * V_11 )
F_79 ( V_30 ) ;
...
int F_80 ( int type , const struct V_80 T_2 * V_78 ,
unsigned V_21 , unsigned V_79 ,
struct V_10 * * V_11 , struct V_4 * V_5 )
{
T_3 V_54 ;
struct V_10 * V_30 ;
V_54 = F_81 ( type , V_78 , V_21 , V_79 ,
* V_11 , & V_30 ) ;
if ( V_54 < 0 ) {
if ( V_30 != * V_11 )
F_79 ( V_30 ) ;
...
int F_82 ( int V_81 , void T_2 * V_12 , T_1 V_34 ,
struct V_10 * V_11 , struct V_4 * V_5 )
{
if ( V_34 > V_82 )
V_34 = V_82 ;
if ( F_2 ( ! F_83 ( ! V_81 , V_12 , V_34 ) ) )
return - V_67 ;
V_11 -> V_17 = V_12 ;
V_11 -> V_18 = V_34 ;
