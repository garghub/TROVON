...
struct V_267 * V_57 = & V_257 -> V_268 [ V_15 ] ;
if ( F_131 ( V_259 , V_260 ,
F_132 ( F_133 ( V_57 -> V_269 ) ) ,
V_49 , V_270 ) ) {
V_44 = - V_195 ;
goto V_237;
}
...
static unsigned int F_135 ( struct V_32 * V_32 , T_4 * V_274 )
{
unsigned int V_67 = 0 ;
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
...
V_275 = V_22 ;
if ( V_22 && V_22 -> V_43 ) {
F_137 ( V_32 , & V_22 -> V_43 -> V_78 , V_274 ) ;
...
static T_1 F_140 ( struct V_32 * V_32 , const char T_3 * V_57 ,
T_2 V_281 , T_5 * V_282 )
{
struct V_21 * V_22 ;
struct V_42 * V_43 ;
...
V_287 = V_43 -> V_148 ;
V_288 = F_147 ( V_154 , V_43 -> V_53 - V_287 ) ;
V_289 = V_154 - V_288 ;
V_283 = F_77 ( V_43 -> V_294 + V_287 , V_57 , V_288 ) ;
if ( V_283 )
V_283 += V_289 ;
else if ( V_289 )
V_283 = F_77 ( V_43 -> V_294 , V_57 + V_288 , V_289 ) ;
if ( V_283 ) {
V_154 -= V_283 ;
V_44 = - V_87 ;
}
...
static T_1 F_149 ( struct V_32 * V_32 , char T_3 * V_57 , T_2 V_281 ,
T_5 * V_282 )
{
struct V_21 * V_22 ;
struct V_42 * V_43 ;
...
V_297 = V_43 -> V_150 ;
V_288 = F_147 ( V_154 , V_43 -> V_53 - V_297 ) ;
V_289 = V_154 - V_288 ;
V_283 = F_81 ( V_57 , V_43 -> V_294 + V_297 , V_288 ) ;
if ( V_283 )
V_283 += V_289 ;
else if ( V_289 )
V_283 = F_81 ( V_57 + V_288 , V_43 -> V_294 , V_289 ) ;
if ( V_283 ) {
V_154 -= V_283 ;
V_44 = - V_87 ;
}
...
static int F_150 ( struct V_298 * V_298 , struct V_32 * V_32 )
{
...
static int F_153 ( int V_300 , struct V_32 * V_32 , int V_301 )
{
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
return F_154 ( V_300 , V_32 , V_301 , & V_2 -> V_302 ) ;
}
static int F_155 ( struct V_298 * V_298 , struct V_32 * V_32 )
{
struct V_33 * V_34 = V_32 -> V_35 ;
struct V_1 * V_2 = V_34 -> V_2 ;
...
void F_156 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_42 * V_43 = V_22 -> V_43 ;
unsigned int V_304 ;
int V_305 = 0 ;
...
F_57 ( & V_22 -> V_69 , V_68 ) ;
if ( V_305 )
F_158 ( & V_2 -> V_302 , V_309 , V_305 ) ;
}
struct V_1 * F_159 ( struct V_26 * V_310 )
{
struct V_1 * V_2 ;
struct V_26 * V_54 ;
unsigned int V_15 ;
...
V_2 -> V_7 = V_15 ;
V_54 = F_162 ( V_19 , V_310 ,
F_24 ( V_20 , V_15 ) , NULL , L_40 , V_15 ) ;
if ( ! F_110 ( V_54 ) )
V_2 -> V_9 = F_163 ( V_54 ) ;
return V_2 ;
}
void F_164 ( struct V_26 * V_310 )
{
int V_7 ;
struct V_1 * V_2 ;
...
V_44 = F_171 ( F_24 ( V_20 , 0 ) ,
V_313 , L_46 ) ;
if ( V_44 )
return - V_198 ;
F_172 ( & V_315 , & V_316 ) ;
V_315 . V_317 = V_318 ;
V_44 = F_173 ( & V_315 . V_319 , L_46 ) ;
if ( V_44 ) {
F_174 ( F_24 ( V_20 , 0 ) ,
V_313 ) ;
return V_44 ;
}
if ( F_175 ( & V_315 , F_24 ( V_20 , 0 ) , V_313 ) ) {
F_174 ( F_24 ( V_20 , 0 ) ,
V_313 ) ;
return - V_198 ;
}
V_19 = F_176 ( V_318 , L_46 ) ;
if ( F_110 ( V_19 ) ) {
F_170 ( L_47 ) ;
F_177 ( & V_315 ) ;
F_174 ( F_24 ( V_20 , 0 ) ,
