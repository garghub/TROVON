...
F_4 ( & V_6 -> V_9 , L_14 , V_54 -> V_58 , V_54 -> V_60 . V_4 ) ;
return 0 ;
}
...
struct V_5 * V_6 = F_2 ( & V_2 -> V_7 ) ;
int V_10 ;
F_4 ( & V_6 -> V_9 , L_15 , V_54 -> V_58 , V_54 -> V_4 ) ;
switch ( V_54 -> V_58 ) {
case V_68 :
if ( V_2 -> V_22 )
return - V_69 ;
...
return 0 ;
V_8 = F_18 ( V_2 , 0 ) ;
F_4 ( & V_6 -> V_9 , L_29 , V_8 < 0 ? L_30 : L_3 ) ;
return V_8 ;
}
...
return 0 ;
V_8 = F_18 ( V_2 , 1 ) ;
F_4 ( & V_6 -> V_9 , L_31 , V_8 < 0 ? L_2 : L_3 ) ;
return V_8 ;
}
