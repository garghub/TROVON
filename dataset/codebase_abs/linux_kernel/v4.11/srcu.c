...
static bool F_29 ( struct V_9 * V_10 , int V_27 , int V_34 )
{
for (; ; ) {
if ( F_19 ( V_10 , V_27 ) )
return true ;
...
{
F_32 ( V_10 -> V_11 , V_10 -> V_11 + 1 ) ;
F_20 () ;
}
void F_33 ( struct V_9 * V_10 , struct V_5 * V_3 ,
T_1 V_36 )
{
unsigned long V_37 ;
V_3 -> V_6 = NULL ;
...
if ( ! V_10 -> V_13 ) {
V_10 -> V_13 = true ;
F_36 ( V_38 , & V_10 -> V_18 , 0 ) ;
}
F_37 ( & V_10 -> V_12 , V_37 ) ;
}
static void F_38 ( struct V_9 * V_10 , int V_34 )
{
struct V_39 V_40 ;
...
static void F_45 ( struct V_9 * V_10 , int V_34 )
{
int V_27 = 1 ^ ( V_10 -> V_11 & 1 ) ;
if ( F_3 ( & V_10 -> V_15 ) &&
F_3 ( & V_10 -> V_16 ) )
return;
if ( ! F_29 ( V_10 , V_27 , V_34 ) )
return;
