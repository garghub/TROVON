...
F_145 () ;
#endif
if ( F_146 ( & V_179 -> F_49 ) != 1 ) {
struct V_178 * V_207 ;
V_207 = F_147 ( V_208 , V_45 ) ;
if ( ! V_207 )
return - V_46 ;
F_148 ( & V_207 -> F_49 , 1 ) ;
...
char * F_155 ( char * V_157 , struct V_169 * V_170 )
{
F_112 ( V_170 ) ;
...
void F_156 ( struct V_169 * V_170 , const char * V_157 , bool V_116 )
{
F_112 ( V_170 ) ;
F_157 ( V_170 , V_157 ) ;
F_158 ( V_170 -> V_210 , V_157 , sizeof( V_170 -> V_210 ) ) ;
F_115 ( V_170 ) ;
F_159 ( V_170 , V_116 ) ;
}
...
void F_164 ( struct V_16 * V_17 , struct V_128 * V_128 )
{
struct V_221 * V_221 = F_81 ( V_128 ) ;
if ( F_165 ( V_221 , V_222 ) < 0 ) {
struct V_223 * V_224 , * V_225 ;
V_17 -> V_226 |= V_227 ;
V_225 = V_224 = V_17 -> V_20 -> V_225 ;
while ( ( V_225 != & V_228 ) &&
! F_166 ( V_225 , V_221 ) )
V_225 = V_225 -> V_206 ;
if ( V_224 != V_225 ) {
V_17 -> V_20 -> V_225 = F_167 ( V_225 ) ;
F_168 ( V_224 ) ;
}
}
}
...
{
F_170 ( V_21 -> V_20 ) ;
V_21 -> V_229 = V_21 -> V_230 = 0 ;
if ( F_171 ( F_172 () , F_173 () ) && F_174 ( F_175 () , F_176 () ) )
F_177 ( V_21 -> V_20 , V_231 ) ;
else
F_177 ( V_21 -> V_20 , V_232 ) ;
F_178 () ;
F_156 ( V_21 , F_179 ( V_17 -> V_130 ) , true ) ;
V_21 -> V_20 -> V_233 = V_234 ;
if ( ! F_171 ( V_17 -> V_235 -> V_236 , F_172 () ) ||
! F_174 ( V_17 -> V_235 -> V_237 , F_175 () ) ) {
V_21 -> V_238 = 0 ;
} else {
if ( V_17 -> V_226 & V_227 )
F_177 ( V_21 -> V_20 , V_232 ) ;
...
{
if ( F_182 ( & V_21 -> signal -> V_240 ) )
return - V_241 ;
V_17 -> V_235 = F_183 () ;
if ( F_131 ( V_17 -> V_235 ) )
return 0 ;
F_184 ( & V_21 -> signal -> V_240 ) ;
return - V_46 ;
}
static void F_185 ( struct V_16 * V_17 )
{
F_22 ( V_17 ) ;
if ( V_17 -> V_235 ) {
F_184 ( & V_21 -> signal -> V_240 ) ;
...
if ( V_17 -> V_242 != V_17 -> V_130 )
F_187 ( V_17 -> V_242 ) ;
F_187 ( V_17 ) ;
}
int F_188 ( char * V_242 , struct V_16 * V_17 )
{
if ( V_17 -> V_242 != V_17 -> V_130 )
F_187 ( V_17 -> V_242 ) ;
V_17 -> V_242 = F_189 ( V_242 , V_45 ) ;
if ( ! V_17 -> V_242 )
return - V_46 ;
return 0 ;
}
void F_190 ( struct V_16 * V_17 )
{
F_191 ( V_17 ) ;
F_192 ( V_17 -> V_235 ) ;
V_17 -> V_235 = NULL ;
if ( F_193 ( V_21 -> V_20 ) != V_231 )
F_194 ( V_21 ) ;
F_195 ( V_17 ) ;
F_184 ( & V_21 -> signal -> V_240 ) ;
}
...
V_243 = V_60 ;
V_244 = 1 ;
F_149 ( & V_60 -> V_248 -> V_181 ) ;
F_198 () ;
F_199 (p, t) {
if ( V_243 -> V_248 == V_60 -> V_248 )
V_244 ++ ;
}
F_200 () ;
if ( V_60 -> V_248 -> V_249 > V_244 )
V_17 -> V_245 |= V_250 ;
else
V_60 -> V_248 -> V_251 = 1 ;
F_151 ( & V_60 -> V_248 -> V_181 ) ;
}
...
T_8 V_236 ;
T_9 V_237 ;
V_17 -> V_235 -> V_253 = F_172 () ;
V_17 -> V_235 -> V_254 = F_175 () ;
if ( ! F_202 ( V_17 -> V_128 -> V_151 . V_10 ) )
return;
if ( F_197 ( V_21 ) )
return;
V_221 = V_17 -> V_128 -> V_151 . V_255 -> V_256 ;
V_252 = F_203 ( V_221 -> V_150 ) ;
...
V_237 = V_221 -> V_260 ;
F_205 ( V_221 ) ;
if ( ! F_206 ( V_17 -> V_235 -> V_225 , V_236 ) ||
! F_207 ( V_17 -> V_235 -> V_225 , V_237 ) )
return;
if ( V_252 & V_257 ) {
V_17 -> V_219 |= V_261 ;
V_17 -> V_235 -> V_253 = V_236 ;
}
if ( ( V_252 & ( V_258 | V_262 ) ) == ( V_258 | V_262 ) ) {
V_17 -> V_219 |= V_261 ;
V_17 -> V_235 -> V_254 = V_237 ;
}
}
...
return V_211 ;
V_17 -> V_263 = 1 ;
memset ( V_17 -> V_157 , 0 , V_264 ) ;
return F_89 ( V_17 -> V_128 , 0 , V_17 -> V_157 , V_264 ) ;
}
...
F_154 ( & V_5 ) ;
if ( V_265 ) {
if ( F_219 ( V_17 -> V_157 [ 0 ] ) && F_219 ( V_17 -> V_157 [ 1 ] ) &&
F_219 ( V_17 -> V_157 [ 2 ] ) && F_219 ( V_17 -> V_157 [ 3 ] ) )
return V_211 ;
if ( F_220 ( L_1 , * ( V_273 * ) ( V_17 -> V_157 + 2 ) ) < 0 )
return V_211 ;
V_265 = false ;
goto V_270;
}
...
V_274 = V_21 -> V_195 ;
F_198 () ;
V_275 = F_222 ( V_21 , F_223 ( V_21 -> V_206 ) ) ;
F_200 () ;
V_28 = F_213 ( V_17 ) ;
if ( V_28 >= 0 ) {
F_224 ( V_17 ) ;
F_225 ( V_21 , V_274 , V_17 ) ;
F_226 ( V_276 , V_275 ) ;
F_227 ( V_21 ) ;
}
return V_28 ;
}
static int F_228 ( int V_129 , struct V_130 * V_130 ,
struct V_67 V_68 ,
struct V_67 V_277 ,
int V_132 )
{
...
if ( V_130 -> V_131 [ 0 ] == '\0' )
V_278 = F_233 ( V_288 , L_2 , V_129 ) ;
else
V_278 = F_233 ( V_288 , L_3 ,
V_129 , V_130 -> V_131 ) ;
if ( ! V_278 ) {
V_211 = - V_46 ;
goto V_287;
}
if ( F_234 ( V_129 , F_235 ( V_21 -> V_220 -> V_289 ) ) )
V_17 -> V_226 |= V_290 ;
V_17 -> V_130 = V_278 ;
}
V_17 -> V_242 = V_17 -> V_130 ;
V_211 = F_40 ( V_17 ) ;
if ( V_211 )
goto V_287;
V_17 -> V_78 = F_49 ( V_68 , V_291 ) ;
if ( ( V_211 = V_17 -> V_78 ) < 0 )
goto V_83;
V_17 -> V_292 = F_49 ( V_277 , V_291 ) ;
if ( ( V_211 = V_17 -> V_292 ) < 0 )
goto V_83;
V_211 = F_208 ( V_17 ) ;
if ( V_211 < 0 )
goto V_83;
...
V_211 = F_53 ( V_17 -> V_292 , V_277 , V_17 ) ;
if ( V_211 < 0 )
goto V_83;
V_211 = F_53 ( V_17 -> V_78 , V_68 , V_17 ) ;
if ( V_211 < 0 )
goto V_83;
F_164 ( V_17 , V_17 -> V_128 ) ;
V_211 = F_221 ( V_17 ) ;
if ( V_211 < 0 )
goto V_83;
V_21 -> V_248 -> V_251 = 0 ;
...
int F_240 ( struct V_130 * V_130 ,
const char T_1 * const T_1 * V_87 ,
const char T_1 * const T_1 * V_293 )
{
struct V_67 V_68 = { . V_73 . V_70 = V_87 } ;
struct V_67 V_277 = { . V_73 . V_70 = V_293 } ;
return F_228 ( V_153 , V_130 , V_68 , V_277 , 0 ) ;
}
int F_241 ( int V_129 , struct V_130 * V_130 ,
const char T_1 * const T_1 * V_87 ,
const char T_1 * const T_1 * V_293 ,
int V_132 )
{
struct V_67 V_68 = { . V_73 . V_70 = V_87 } ;
struct V_67 V_277 = { . V_73 . V_70 = V_293 } ;
return F_228 ( V_129 , V_130 , V_68 , V_277 , V_132 ) ;
}
static int F_242 ( struct V_130 * V_130 ,
const T_2 T_1 * V_87 ,
const T_2 T_1 * V_293 )
{
struct V_67 V_68 = {
...
static int F_243 ( int V_129 , struct V_130 * V_130 ,
const T_2 T_1 * V_87 ,
const T_2 T_1 * V_293 ,
int V_132 )
{
...
void F_177 ( struct V_19 * V_20 , int V_296 )
{
unsigned long V_224 , V_294 ;
if ( F_3 ( ( unsigned ) V_296 > V_297 ) )
return;
do {
V_224 = F_19 ( V_20 -> V_132 ) ;
V_294 = ( V_224 & ~ V_298 ) | V_296 ;
} while ( F_246 ( & V_20 -> V_132 , V_224 , V_294 ) != V_224 );
}
