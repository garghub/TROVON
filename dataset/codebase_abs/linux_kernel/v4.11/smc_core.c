...
static int F_62 ( struct V_86 * V_87 , unsigned short * V_35 )
{
struct V_88 * V_89 = F_63 ( V_87 -> V_17 ) ;
int V_39 = 0 ;
* V_35 = 0 ;
if ( ! V_89 ) {
V_39 = - V_90 ;
...
int V_40 ;
if ( ! V_8 -> V_35 ) {
V_37 -> V_97 = V_37 -> V_32 -> V_97 [ V_37 -> V_33 - 1 ] ;
return 0 ;
}
for ( V_40 = 0 ; V_40 < V_37 -> V_32 -> V_63 [ V_37 -> V_33 - 1 ] . V_98 ;
V_40 ++ ) {
if ( F_68 ( V_37 -> V_32 -> V_99 , V_37 -> V_33 , V_40 , & V_97 ,
& V_95 ) )
continue;
if ( V_95 . V_100 &&
( F_65 ( V_95 . V_100 ) == V_8 -> V_35 ) ) {
V_37 -> V_97 = V_97 ;
return 0 ;
}
}
...
F_15 ( & V_8 -> V_21 ) ;
if ( ! memcmp ( V_8 -> V_34 , V_102 -> V_108 ,
V_50 ) &&
! memcmp ( V_8 -> V_37 [ V_61 ] . V_109 , & V_102 -> V_97 ,
V_110 ) &&
! memcmp ( V_8 -> V_37 [ V_61 ] . V_111 , V_102 -> V_112 ,
sizeof( V_102 -> V_112 ) ) &&
! V_8 -> V_48 &&
( V_8 -> V_44 == V_44 ) &&
( V_8 -> V_35 == V_35 ) &&
...
V_2 -> V_116 . V_117 . type = V_118 ;
V_2 -> V_116 . V_119 = sizeof( struct V_120 ) ;
#ifndef F_71
F_72 ( & V_2 -> V_121 ) ;
#endif
V_43:
return V_39 ? V_39 : V_105 ;
}
static inline
...
{
return F_77 ( int , V_78 / 10 , V_125 / 2 ) ;
}
...
struct V_80 * V_74 ;
int V_39 ;
for ( V_127 = F_79 ( V_15 -> V_17 . V_128 / 2 ) ;
V_127 >= 0 ; V_127 -- ) {
V_126 = F_56 ( V_127 ) ;
V_74 = F_73 ( V_8 , V_127 ) ;
if ( V_74 ) {
memset ( V_74 -> V_83 , 0 , V_126 ) ;
break;
}
V_74 = F_28 ( sizeof( * V_74 ) , V_41 ) ;
if ( ! V_74 )
break;
V_74 -> V_83 = F_28 ( V_126 ,
V_41 | V_129 |
V_130 |
V_131 ) ;
if ( ! V_74 -> V_83 ) {
...
V_2 -> V_74 = V_74 ;
V_2 -> V_76 = V_126 ;
V_15 -> V_17 . V_128 = V_126 * 2 ;
F_81 ( & V_2 -> V_132 , V_126 ) ;
return 0 ;
} else {
return - V_42 ;
}
...
struct V_80 * V_77 ;
int V_39 ;
for ( V_127 = F_79 ( V_15 -> V_17 . V_133 / 2 ) ;
V_127 >= 0 ; V_127 -- ) {
V_126 = F_56 ( V_127 ) ;
V_77 = F_75 ( V_8 , V_127 ) ;
if ( V_77 ) {
memset ( V_77 -> V_83 , 0 , V_126 ) ;
break;
}
V_77 = F_28 ( sizeof( * V_77 ) , V_41 ) ;
if ( ! V_77 )
break;
V_77 -> V_83 = F_28 ( V_126 ,
V_41 | V_129 |
V_130 |
V_131 ) ;
if ( ! V_77 -> V_83 ) {
...
V_2 -> V_78 = V_126 ;
V_2 -> V_138 = V_127 ;
V_15 -> V_17 . V_133 = V_126 * 2 ;
F_81 ( & V_2 -> V_139 , 0 ) ;
V_2 -> V_140 = F_76 ( V_126 ) ;
return 0 ;
} else {
return - V_42 ;
}
}
static inline int F_84 ( struct V_19 * V_8 )
{
int V_40 ;
F_85 (i, lgr->rtokens_used_mask, SMC_RMBS_PER_LGR_MAX) {
if ( ! F_86 ( V_40 , V_8 -> V_141 ) )
return V_40 ;
}
return - V_142 ;
}
...
struct V_143 * V_144 )
{
T_5 V_145 = F_88 ( V_144 -> V_146 ) ;
struct V_19 * V_8 = V_2 -> V_8 ;
T_1 V_147 = F_89 ( V_144 -> V_148 ) ;
int V_40 ;
for ( V_40 = 0 ; V_40 < V_113 ; V_40 ++ ) {
if ( ( V_8 -> V_149 [ V_40 ] [ V_61 ] . V_147 == V_147 ) &&
F_90 ( V_40 , V_8 -> V_141 ) ) {
V_2 -> V_150 = V_40 ;
return 0 ;
}
...
if ( V_2 -> V_150 < 0 )
return V_2 -> V_150 ;
V_8 -> V_149 [ V_2 -> V_150 ] [ V_61 ] . V_147 = V_147 ;
V_8 -> V_149 [ V_2 -> V_150 ] [ V_61 ] . V_145 = V_145 ;
return 0 ;
}
