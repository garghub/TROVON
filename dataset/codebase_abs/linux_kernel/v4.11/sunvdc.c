...
static int F_94 ( struct V_199 * V_186 , const struct V_200 * V_201 )
{
struct V_202 * V_203 ;
struct V_1 * V_4 ;
int V_38 ;
...
V_203 = F_95 () ;
V_38 = - V_177 ;
if ( ( V_186 -> V_187 << V_182 ) & ~ ( T_5 ) V_205 ) {
...
snprintf ( V_4 -> V_188 , sizeof( V_4 -> V_188 ) ,
V_207 L_28 , 'a' + ( ( int ) V_186 -> V_187 % 26 ) ) ;
V_4 -> V_63 = - 1 ;
V_204 = F_96 ( V_203 , V_186 -> V_208 , L_29 , NULL ) ;
V_4 -> V_204 = V_204 ? * V_204 : 0 ;
F_97 ( & V_4 -> V_42 , V_209 ,
( unsigned long ) V_4 ) ;
F_98 ( & V_4 -> V_101 , V_210 ) ;
V_38 = F_99 ( & V_4 -> V_3 , V_186 , V_211 ,
V_212 , F_100 ( V_212 ) ,
& V_213 , V_4 -> V_188 ) ;
if ( V_38 )
goto V_214;
...
static int F_104 ( struct V_199 * V_186 )
{
struct V_1 * V_4 = F_105 ( & V_186 -> V_195 ) ;
if ( V_4 ) {
unsigned long V_32 ;
F_37 ( & V_4 -> V_3 . V_98 , V_32 ) ;
F_62 ( V_4 -> V_16 -> V_37 ) ;
...
struct V_8 * V_9 = & V_4 -> V_3 . V_35 [ V_36 ] ;
T_2 V_219 ;
for ( V_219 = V_9 -> V_88 ; V_219 != V_9 -> V_111 ; V_219 = F_32 ( V_9 , V_219 ) ) {
struct V_72 * V_73 = F_29 ( V_9 , V_219 ) ;
struct V_77 * V_78 = & V_4 -> V_79 [ V_219 ] ;
struct V_80 * V_81 ;
F_31 ( V_4 -> V_3 . V_47 , V_73 -> V_85 , V_73 -> V_86 ) ;
V_73 -> V_82 . V_83 = V_87 ;
V_9 -> V_88 = F_32 ( V_9 , V_219 ) ;
V_81 = V_78 -> V_81 ;
if ( V_81 == NULL ) {
F_27 ( V_4 , V_73 ) ;
continue;
...
{
struct V_80 * V_81 ;
while ( ( V_81 = F_112 ( V_4 -> V_16 -> V_37 ) ) != NULL )
F_113 ( V_81 , - V_89 ) ;
}
static void V_209 ( unsigned long V_220 )
{
struct V_1 * V_4 = (struct V_1 * ) V_220 ;
struct V_2 * V_3 = & V_4 -> V_3 ;
unsigned long V_32 ;
F_37 ( & V_3 -> V_98 , V_32 ) ;
if ( ! ( V_4 -> V_3 . V_221 & V_222 ) ) {
F_40 ( V_27 L_30 ,
V_4 -> V_188 , V_4 -> V_204 ) ;
F_111 ( V_4 ) ;
F_12 ( V_4 ) ;
...
static void V_210 ( struct V_223 * V_224 )
{
struct V_1 * V_4 ;
struct V_2 * V_3 ;
unsigned long V_32 ;
V_4 = F_2 ( V_224 , struct V_1 , V_101 ) ;
V_3 = & V_4 -> V_3 ;
F_37 ( & V_3 -> V_98 , V_32 ) ;
F_49 ( V_4 ) ;
F_46 ( & V_3 -> V_98 , V_32 ) ;
...
int V_38 ;
F_114 ( & V_4 -> V_3 . V_98 ) ;
F_40 ( V_27 L_31 , V_4 -> V_188 ) ;
F_62 ( V_4 -> V_16 -> V_37 ) ;
F_110 ( V_4 ) ;
F_77 ( V_4 ) ;
V_38 = F_101 ( & V_4 -> V_3 , & V_215 , V_4 ) ;
if ( V_38 ) {
F_115 ( V_27 L_32 , V_4 -> V_188 , V_38 ) ;
return;
}
V_38 = F_69 ( V_4 ) ;
if ( V_38 ) {
F_115 ( V_27 L_33 , V_4 -> V_188 , V_38 ) ;
goto V_225;
}
if ( V_4 -> V_204 )
F_116 ( & V_4 -> V_42 ,
F_117 ( V_226 + V_227 * V_4 -> V_204 ) ) ;
F_116 ( & V_4 -> V_3 . V_218 , F_117 ( V_226 + V_227 ) ) ;
return;
V_225:
F_79 ( & V_4 -> V_3 ) ;
}
