...
V_134:
V_129 -> V_136 . V_130 = V_130 ;
V_129 -> V_136 . V_132 = V_132 ;
}
static T_1 F_74 ( T_5 V_107 )
{
if ( V_107 & ( V_109 |
V_111 |
V_112 |
...
T_5 V_145 ;
T_5 V_146 ;
T_5 V_125 , V_147 , V_148 ;
int V_34 ;
F_76 ( V_142 , V_23 -> V_13 , 0 ) ;
V_34 = F_21 ( V_25 -> V_30 , F_19 ( V_149 ) , V_142 ) ;
if ( V_34 ) {
F_77 ( V_59 , L_3 ) ;
return V_34 ;
}
...
V_129 -> V_136 . V_152 = F_74 ( V_146 ) ;
V_148 = F_72 ( V_146 ) ;
F_80 ( V_129 -> V_153 . V_125 ,
V_125 ) ;
F_80 ( V_129 -> V_153 . V_147 ,
V_147 ) ;
F_80 ( V_129 -> V_153 . V_148 ,
V_148 ) ;
return 0 ;
}
static T_5 F_81 ( T_5 V_147 )
{
T_5 V_154 = 0 ;
int V_76 ;
for ( V_76 = 0 ; V_76 < V_122 ; V_76 ++ ) {
if ( V_147 & V_123 [ V_76 ] . V_126 )
...
bool V_24 ;
int V_34 ;
V_130 = V_129 -> V_136 . V_130 ;
F_85 ( & V_147 ,
V_129 -> V_153 . V_147 ) ;
V_156 = V_129 -> V_136 . V_157 == V_158 ?
F_81 ( V_147 ) :
F_82 ( V_130 ) ;
F_76 ( V_142 , V_23 -> V_13 , 0 ) ;
V_34 = F_21 ( V_25 -> V_30 , F_19 ( V_149 ) , V_142 ) ;
...
if ( V_156 == V_145 )
return 0 ;
F_76 ( V_142 , V_23 -> V_13 ,
V_156 ) ;
V_34 = F_18 ( V_25 -> V_30 , F_19 ( V_149 ) , V_142 ) ;
if ( V_34 ) {
F_77 ( V_59 , L_5 ) ;
return V_34 ;
}
...
struct V_25 * V_25 = V_23 -> V_25 ;
char V_142 [ V_143 ] ;
F_98 ( V_142 , V_23 -> V_13 , V_130 ,
V_183 ) ;
return F_18 ( V_25 -> V_30 , F_19 ( V_149 ) , V_142 ) ;
}
static int
