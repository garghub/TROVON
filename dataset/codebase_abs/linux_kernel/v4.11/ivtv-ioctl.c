...
static T_8 void F_122 ( const char * V_295 )
{
F_123 ( L_61 ,
V_295 ) ;
}
static int F_124 ( struct V_88 * V_383 , unsigned int V_66 , void * V_384 )
{
...
if ( args -> V_392 == NULL )
return 0 ;
return F_127 ( V_23 , args ) ;
}
case V_394 :
F_105 ( L_63 ) ;
if ( ! ( V_23 -> V_63 & V_64 ) )
return - V_65 ;
return F_128 ( V_23 , * ( int * ) V_384 != 0 ) ;
#ifdef F_125
case V_395 : {
T_9 * V_81 = V_384 ;
T_9 V_396 ;
...
if ( V_388 > V_425 )
return - V_65 ;
return F_130 ( V_23 -> V_426 , V_388 + 1 ) ;
case V_427 :
F_122 ( L_77 ) ;
if ( V_388 > V_425 )
return - V_65 ;
return F_130 ( V_23 -> V_428 , V_388 + 1 ) ;
#endif
default:
return - V_65 ;
}
...
static long F_131 ( struct V_88 * V_88 , void * V_89 , bool V_429 ,
...
case V_427 :
#endif
return F_124 ( V_88 , V_66 , ( void * ) V_384 ) ;
default:
return - V_271 ;
}
return 0 ;
}
void F_133 ( struct V_434 * V_258 )
{
V_258 -> V_435 = & V_436 ;
}
