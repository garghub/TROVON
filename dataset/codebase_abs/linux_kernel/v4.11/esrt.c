...
V_33 = F_24 ( V_29 . V_23 , V_38 ) ;
if ( ! V_33 ) {
F_23 ( L_7 , ( void * ) V_29 . V_23 ,
V_38 ) ;
return;
}
...
if ( ! F_15 () )
return 0 ;
for ( V_49 = 0 ; V_49 < F_29 ( V_23 -> V_44 ) ; V_49 ++ ) {
void * V_14 = NULL ;
if ( V_23 -> V_24 == 1 ) {
V_14 = & V_37 [ V_49 ] ;
} else {
...
{
struct V_1 * V_9 , * V_51 ;
F_31 (entry, next, &entry_list, list) {
F_32 ( & V_9 -> V_3 ) ;
}
}
...
error = F_36 ( V_54 , & V_57 ) ;
if ( error ) {
F_23 ( L_19 ,
error ) ;
goto V_58;
}
V_22 = F_37 ( L_20 , NULL , V_54 ) ;
if ( ! V_22 ) {
F_23 ( L_21 ) ;
error = - V_20 ;
goto V_59;
