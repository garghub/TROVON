...
V_79:
F_62 (ndd, res) {
if ( strncmp ( V_54 -> V_80 , L_12 , 4 ) != 0 )
continue;
if ( ( V_54 -> V_77 >= V_71 && V_54 -> V_77 < V_70 )
|| ( V_54 -> V_81 >= V_71
&& V_54 -> V_81 <= V_70 ) ) {
V_72 = F_63 ( V_71 , F_14 ( V_70 + 1 , V_54 -> V_81 + 1 ) ) ;
if ( V_72 != V_71 ) {
V_71 = V_72 ;
goto V_79;
}
...
if ( V_74 -> V_54 -> V_77 > V_74 -> V_54 -> V_81 )
V_74 -> V_54 -> V_81 = V_74 -> V_54 -> V_77 - 1 ;
return 1 ;
}
V_74 -> V_82 -= V_71 - V_50 -> V_77 ;
return 0 ;
}
T_4 F_64 ( struct V_49 * V_49 )
{
...
if ( ! V_11 )
return 0 ;
F_65 ( & V_18 -> V_2 , & V_74 , F_59 ) ;
F_62 (ndd, res) {
if ( strncmp ( V_54 -> V_80 , L_13 , 3 ) != 0 )
continue;
V_74 . V_82 -= F_66 ( V_54 ) ;
}
return V_74 . V_82 ;
}
T_4 F_67 ( struct V_49 * V_49 ,
...
V_71 = F_14 ( V_71 ,
F_63 ( V_84 , V_54 -> V_77 ) ) ;
else if ( V_54 -> V_81 > V_70 ) {
V_85 = L_14 ;
goto V_86;
} else
V_61 += F_66 ( V_54 ) ;
} else if ( V_54 -> V_81 >= V_84 && V_54 -> V_81 <= V_70 ) {
if ( strncmp ( V_54 -> V_80 , L_13 , 3 ) == 0 ) {
V_71 = V_84 ;
} else
V_61 += F_66 ( V_54 ) ;
} else if ( V_84 > V_54 -> V_77 && V_84 < V_54 -> V_81 ) {
V_61 += V_50 -> V_78 ;
V_71 = V_84 ;
}
}
...
F_25 ( ! F_26 ( V_11 -> V_2 ) ) ;
F_15 ( V_54 -> V_80 ) ;
F_69 ( & V_11 -> V_87 , V_54 -> V_77 , F_66 ( V_54 ) ) ;
}
struct V_53 * F_70 ( struct V_10 * V_11 ,
struct V_88 * V_89 , T_4 V_77 ,
T_4 V_90 )
{
char * V_80 = F_71 ( V_89 , sizeof( * V_89 ) , V_31 ) ;
struct V_53 * V_54 ;
if ( ! V_80 )
return NULL ;
F_25 ( ! F_26 ( V_11 -> V_2 ) ) ;
V_54 = F_72 ( & V_11 -> V_87 , V_77 , V_90 , V_80 , 0 ) ;
if ( ! V_54 )
F_15 ( V_80 ) ;
return V_54 ;
}
T_4 F_73 ( struct V_10 * V_11 ,
struct V_88 * V_89 )
{
T_4 V_91 = 0 ;
struct V_53 * V_54 ;
F_62 (ndd, res)
if ( strcmp ( V_54 -> V_80 , V_89 -> V_45 ) == 0 )
V_91 += F_66 ( V_54 ) ;
return V_91 ;
}
static int F_74 ( struct V_1 * V_2 , void * V_92 )
{
int * V_93 = V_92 ;
if ( F_20 ( V_2 ) )
( * V_93 ) ++ ;
...
int F_75 ( struct V_18 * V_18 , int V_94 )
{
int V_93 = 0 ;
F_76 () ;
F_65 ( & V_18 -> V_2 , & V_93 , F_74 ) ;
