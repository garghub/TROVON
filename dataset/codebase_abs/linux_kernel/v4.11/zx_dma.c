...
V_8 -> V_52 . V_178 = F_64 ;
V_8 -> V_52 . V_179 = F_65 ;
V_8 -> V_52 . V_180 = V_181 ;
V_8 -> V_52 . V_182 = V_183 ;
V_8 -> V_52 . V_184 = V_183 ;
V_8 -> V_52 . V_185 = F_13 ( V_112 ) | F_13 ( V_115 )
| F_13 ( V_121 ) ;
V_8 -> V_52 . V_186 = V_187 ;
V_8 -> V_188 = F_73 ( & V_155 -> V_53 ,
V_8 -> V_152 * sizeof( struct V_1 ) , V_159 ) ;
if ( ! V_8 -> V_188 )
return - V_160 ;
for ( V_68 = 0 ; V_68 < V_8 -> V_152 ; V_68 ++ ) {
struct V_1 * V_35 = & V_8 -> V_188 [ V_68 ] ;
V_35 -> V_81 = V_189 ;
F_82 ( & V_35 -> V_42 ) ;
V_35 -> V_4 . V_190 = F_66 ;
