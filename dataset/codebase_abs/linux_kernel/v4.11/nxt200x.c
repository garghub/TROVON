...
static int F_20 ( struct V_35 * V_36 , enum V_56 * V_57 )
{
struct V_1 * V_2 = V_36 -> V_39 ;
T_1 V_58 ;
F_6 ( V_2 , 0x31 , & V_58 , 1 ) ;
...
static int F_21 ( struct V_35 * V_36 , T_3 * V_64 )
{
struct V_1 * V_2 = V_36 -> V_39 ;
T_1 V_65 [ 3 ] ;
...
static int F_24 ( struct V_35 * V_36 , T_3 * V_71 )
{
struct V_1 * V_2 = V_36 -> V_39 ;
T_1 V_65 [ 3 ] ;
F_10 ( V_2 , 0xE6 , V_65 , 3 ) ;
...
static int F_34 ( struct V_35 * V_36 , struct V_78 * V_79 )
{
V_79 -> V_80 = 500 ;
V_79 -> V_81 = 0 ;
V_79 -> V_82 = 0 ;
...
struct V_35 * F_37 ( const struct V_83 * V_17 ,
struct V_84 * V_10 )
{
struct V_1 * V_2 = NULL ;
T_1 V_4 [] = { 0 , 0 , 0 , 0 , 0 } ;
V_2 = F_38 ( sizeof( struct V_1 ) , V_85 ) ;
if ( V_2 == NULL )
goto error;
V_2 -> V_17 = V_17 ;
V_2 -> V_10 = V_10 ;
...
memcpy ( & V_2 -> V_86 . V_53 , & V_87 , sizeof( struct V_88 ) ) ;
V_2 -> V_86 . V_39 = V_2 ;
return & V_2 -> V_86 ;
error:
F_36 ( V_2 ) ;
