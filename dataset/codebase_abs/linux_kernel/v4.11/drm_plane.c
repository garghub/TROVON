...
goto V_98;
V_6 -> V_53 = V_6 -> V_52 ;
V_17 = V_6 -> V_9 -> V_103 ( V_6 , V_55 , V_52 ,
V_90 , V_91 , V_92 , V_93 ,
V_94 , V_95 , V_96 , V_97 ) ;
if ( ! V_17 ) {
V_6 -> V_55 = V_55 ;
...
struct V_64 * V_65 )
{
struct V_104 * V_105 = V_63 ;
struct V_4 * V_6 ;
struct V_88 * V_55 = NULL ;
struct V_89 * V_52 = NULL ;
if ( ! F_14 ( V_2 , V_71 ) )
return - V_59 ;
V_6 = F_33 ( V_2 , V_105 -> V_79 ) ;
if ( ! V_6 ) {
F_7 ( L_7 ,
V_105 -> V_79 ) ;
return - V_80 ;
...
if ( V_105 -> V_82 ) {
V_52 = F_46 ( V_2 , V_105 -> V_82 ) ;
if ( ! V_52 ) {
F_7 ( L_8 ,
V_105 -> V_82 ) ;
return - V_80 ;
}
V_55 = F_47 ( V_2 , V_105 -> V_81 ) ;
if ( ! V_55 ) {
F_7 ( L_9 ,
V_105 -> V_81 ) ;
return - V_80 ;
...
V_105 -> V_90 , V_105 -> V_91 ,
V_105 -> V_92 , V_105 -> V_93 ,
V_105 -> V_94 , V_105 -> V_95 ,
V_105 -> V_96 , V_105 -> V_97 ) ;
}
...
if ( V_107 -> V_116 ) {
V_52 = F_49 ( V_2 , & V_109 , V_65 ) ;
if ( F_50 ( V_52 ) ) {
F_7 ( L_10 ) ;
return F_51 ( V_52 ) ;
}
V_52 -> V_120 = V_107 -> V_120 ;
V_52 -> V_121 = V_107 -> V_121 ;
} else {
V_52 = NULL ;
}
} else {
...
V_90 , V_91 , V_92 , V_93 ,
0 , 0 , V_96 , V_97 ) ;
if ( V_17 == 0 && V_107 -> V_118 & V_122 ) {
V_55 -> V_125 = V_107 -> V_123 ;
V_55 -> V_126 = V_107 -> V_124 ;
}
return V_17 ;
}
...
if ( ! F_14 ( V_2 , V_71 ) )
return - V_59 ;
if ( ! V_107 -> V_118 || ( ~ V_127 & V_107 -> V_118 ) )
return - V_59 ;
V_55 = F_47 ( V_2 , V_107 -> V_81 ) ;
if ( ! V_55 ) {
F_7 ( L_11 , V_107 -> V_81 ) ;
return - V_80 ;
}
...
if ( V_55 -> V_9 -> V_129 )
V_17 = V_55 -> V_9 -> V_129 ( V_55 , V_65 , V_107 -> V_116 ,
V_107 -> V_110 , V_107 -> V_111 , V_107 -> V_120 , V_107 -> V_121 ) ;
else
V_17 = V_55 -> V_9 -> V_128 ( V_55 , V_65 , V_107 -> V_116 ,
V_107 -> V_110 , V_107 -> V_111 ) ;
}
if ( V_107 -> V_118 & V_122 ) {
if ( V_55 -> V_9 -> V_131 ) {
V_17 = V_55 -> V_9 -> V_131 ( V_55 , V_107 -> V_123 , V_107 -> V_124 ) ;
} else {
V_17 = - V_76 ;
goto V_98;
}
...
{
struct V_132 * V_107 = V_63 ;
struct V_106 V_133 ;
memcpy ( & V_133 , V_107 , sizeof( struct V_132 ) ) ;
...
if ( V_17 )
goto V_98;
if ( V_55 -> V_149 -> V_52 -> V_86 != V_52 -> V_86 ) {
F_7 ( L_16 ) ;
V_17 = - V_59 ;
goto V_98;
}
