...
F_102 ( V_2 ) ;
F_142 ( V_2 ) ;
F_143 (connector, &dev->mode_config.connector_list, head) {
F_144 ( V_243 , V_245 ) ;
}
F_145 ( V_2 ) ;
F_143 (crtc, &dev->mode_config.crtc_list, head) {
struct V_246 * V_246 = F_146 ( V_241 ) ;
struct V_247 * V_248 = F_147 ( V_241 -> V_249 -> V_250 ) ;
struct V_251 * V_252 ;
if ( V_246 -> V_253 ) {
struct V_251 * V_252 = F_148 ( V_246 -> V_253 ) ;
...
F_180 ( & V_4 -> V_270 ) ;
F_152 ( V_4 ) ;
V_268 = F_181 ( & V_4 -> V_271 . V_272 ) ;
F_153 ( V_4 ) ;
F_154 ( V_4 ) ;
for ( V_28 = 0 ; V_28 < V_180 ; ++ V_28 ) {
V_265 [ V_28 ] = F_182 ( V_4 , & V_4 -> V_181 [ V_28 ] ,
& V_266 [ V_28 ] ) ;
if ( V_265 [ V_28 ] ) {
V_267 = true ;
F_43 ( V_4 -> V_2 , L_44
