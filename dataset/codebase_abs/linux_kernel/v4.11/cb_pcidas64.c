...
unsigned long V_32 ;
F_25 ( & V_15 -> V_33 , V_32 ) ;
F_87 ( V_253 | V_254 | V_255 ,
V_30 -> V_34 + F_88 ( V_1 ) ) ;
F_27 ( & V_15 -> V_33 , V_32 ) ;
}
static void F_89 ( struct V_14 * V_15 , struct V_46 * V_47 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
T_3 V_256 = 0 , V_257 = 0 ;
...
F_85 ( V_15 , V_47 ) ;
if ( V_9 -> V_10 == V_11 ) {
V_256 = F_83 ( V_15 , V_47 ) ;
} else {
V_256 = F_81 ( V_15 , V_47 ) ;
...
static int F_90 ( const struct V_46 * V_47 )
{
int V_115 ;
...
static int F_93 ( struct V_14 * V_15 , struct V_157 * V_158 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
...
static void F_99 ( struct V_14 * V_15 , unsigned int V_1 )
{
const struct V_8 * V_9 = V_15 -> V_17 ;
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_297 ;
...
F_25 ( & V_15 -> V_33 , V_32 ) ;
V_313 = F_102 ( V_30 -> V_34 + V_317 ) ;
if ( V_312 & V_318 ) {
F_87 ( ( V_313 & V_253 ) | V_255 ,
V_30 -> V_34 + V_317 ) ;
if ( V_313 & V_253 )
F_99 ( V_15 , 1 ) ;
}
...
static inline unsigned int F_104 ( struct V_14 * V_15 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned int V_324 ;
if ( V_30 -> V_325 == 0 )
...
static inline int F_106 ( struct V_14 * V_15 ,
unsigned short V_327 )
{
if ( ( V_327 & V_329 ) == 0 ||
( V_327 & V_253 ) == 0 )
...
unsigned int V_333 )
{
unsigned int V_305 = F_109 ( V_158 , V_333 ) ;
unsigned int V_334 ;
V_305 = F_95 ( V_158 , V_305 ) ;
V_334 = F_110 ( V_158 , V_332 , V_305 ) ;
return F_109 ( V_158 , V_334 ) ;
}
static unsigned int F_111 ( struct V_14 * V_15 ,
const struct V_46 * V_47 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_260 ;
unsigned int V_324 = V_30 -> V_325 ;
unsigned int V_335 = F_104 ( V_15 ) ;
unsigned int V_305 ;
unsigned int V_336 ;
unsigned int V_337 ;
V_305 = F_108 ( V_15 , V_158 ,
V_30 -> V_122 [ V_324 ] ,
V_117 ) ;
if ( V_305 == 0 )
return 0 ;
V_336 = F_112 ( V_158 , V_305 ) ;
V_30 -> V_127 [ V_324 ] . V_134 = F_45 ( V_336 ) ;
V_337 = F_113 ( V_30 -> V_127 [ V_324 ] . V_135 ) ;
V_337 |= V_331 ;
V_30 -> V_127 [ V_324 ] . V_135 = F_45 ( V_337 ) ;
V_337 = F_113 ( V_30 -> V_127 [ V_335 ] . V_135 ) ;
V_337 &= ~ V_331 ;
V_30 -> V_127 [ V_335 ] . V_135 = F_45 ( V_337 ) ;
V_30 -> V_325 = ( V_324 + 1 ) % V_121 ;
return V_336 ;
}
static void F_114 ( struct V_14 * V_15 , const struct V_46 * V_47 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned int V_338 ;
unsigned int V_309 ;
...
static T_5 F_116 ( int V_342 , void * V_343 )
{
...
if ( ! V_15 -> V_345 )
return V_346 ;
F_101 ( V_15 , V_162 , V_312 ) ;
F_115 ( V_15 , V_162 , V_312 ) ;
if ( V_312 & V_347 ) {
...
static int F_117 ( struct V_14 * V_15 , struct V_157 * V_158 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
unsigned long V_32 ;
F_25 ( & V_15 -> V_33 , V_32 ) ;
...
static unsigned int F_122 ( unsigned int V_206 , unsigned int V_32 )
{
...
if ( V_47 -> V_224 != V_221 )
return;
V_198 = F_122 ( V_47 -> V_225 , V_47 -> V_32 ) ;
if ( V_198 > V_216 ) {
F_22 ( V_15 -> V_27 , L_14 ) ;
V_198 = V_216 ;
}
...
static int F_124 ( struct V_14 * V_15 , const struct V_46 * V_47 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
struct V_157 * V_158 = V_15 -> V_260 ;
unsigned int V_305 ;
...
F_121 ( V_15 , V_47 ) ;
F_123 ( V_15 , V_47 ) ;
F_92 ( V_15 , 0 , V_30 -> V_128 |
V_136 | V_137 ) ;
F_120 ( V_15 , V_47 ) ;
V_158 -> V_278 -> V_373 = F_126 ;
return 0 ;
}
...
static int F_132 ( struct V_14 * V_15 , struct V_157 * V_158 ,
struct V_159 * V_160 , unsigned int * V_152 )
{
unsigned int V_23 ;
V_23 = F_102 ( V_15 -> V_190 + V_378 ) ;
V_23 &= 0xf ;
V_152 [ 1 ] = V_23 ;
V_152 [ 0 ] = 0 ;
return V_160 -> V_166 ;
...
{
int V_168 ;
V_168 = F_136 ( V_15 , V_158 , V_160 , V_152 , 0 ) ;
if ( V_168 )
return V_168 ;
...
V_152 [ 1 ] = F_102 ( V_15 -> V_190 + V_382 ) ;
return V_160 -> V_166 ;
}
static int F_138 ( struct V_14 * V_15 , unsigned int V_151 ,
T_2 V_383 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
...
F_140 ( V_15 , V_230 , V_304 ) ;
V_158 -> V_351 [ V_230 ] = V_304 ;
}
}
return V_160 -> V_166 ;
}
static void F_142 ( struct V_14 * V_15 , unsigned int V_1 ,
unsigned int V_383 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
...
unsigned int V_304 = V_152 [ V_160 -> V_166 - 1 ] ;
if ( V_158 -> V_351 [ V_230 ] != V_304 ) {
F_142 ( V_15 , V_230 , V_304 ) ;
V_158 -> V_351 [ V_230 ] = V_304 ;
}
}
return V_160 -> V_166 ;
}
static T_1 F_144 ( struct V_14 * V_15 , T_2 V_151 )
{
struct V_29 * V_30 = V_15 -> V_31 ;
static const int V_385 = 11 ;
...
struct V_159 * V_160 , unsigned int * V_152 )
{
V_152 [ 0 ] = F_144 ( V_15 , F_60 ( V_160 -> V_169 ) ) ;
return 1 ;
}
...
if ( V_9 -> V_440 ) {
if ( V_9 -> V_10 == V_11 ) {
V_168 = F_149 ( V_15 , V_158 , F_131 ,
V_441 ) ;
} else {
V_168 = F_150 ( V_15 , V_158 , NULL ,
V_442 ) ;
}
if ( V_168 )
return V_168 ;
...
return V_168 ;
for ( V_115 = 0 ; V_115 < V_158 -> V_417 ; V_115 ++ ) {
F_142 ( V_15 , V_115 , V_158 -> V_420 / 2 ) ;
V_158 -> V_351 [ V_115 ] = V_158 -> V_420 / 2 ;
}
} else {
V_158 -> type = V_435 ;
...
static int F_151 ( struct V_14 * V_15 ,
unsigned long V_161 )
{
struct V_113 * V_114 = F_43 ( V_15 ) ;
...
T_3 V_448 , V_449 ;
int V_96 ;
if ( V_161 < F_152 ( V_450 ) )
V_9 = & V_450 [ V_161 ] ;
if ( ! V_9 )
return - V_451 ;
V_15 -> V_17 = V_9 ;
V_30 = F_153 ( V_15 , sizeof( * V_30 ) ) ;
if ( ! V_30 )
return - V_120 ;
V_96 = F_154 ( V_15 ) ;
if ( V_96 )
...
V_30 -> V_454 = F_156 ( V_114 , 2 ) ;
V_30 -> V_455 = F_156 ( V_114 , 3 ) ;
V_30 -> V_34 = F_157 ( V_114 , 0 ) ;
V_30 -> V_44 = F_157 ( V_114 , 2 ) ;
V_15 -> V_190 = F_157 ( V_114 , 3 ) ;
if ( ! V_30 -> V_34 || ! V_30 -> V_44 || ! V_15 -> V_190 ) {
F_158 ( V_15 -> V_27 , L_17 ) ;
return - V_120 ;
}
...
F_33 ( V_15 ) ;
F_41 ( V_15 ) ;
V_96 = F_159 ( V_114 -> V_342 , F_116 , V_462 ,
V_15 -> V_452 , V_15 ) ;
if ( V_96 ) {
F_65 ( V_15 -> V_27 , L_19 ,
V_114 -> V_342 ) ;
...
static int F_164 ( struct V_113 * V_15 ,
const struct V_463 * V_202 )
{
return F_165 ( V_15 , & V_464 ,
V_202 -> V_465 ) ;
}
