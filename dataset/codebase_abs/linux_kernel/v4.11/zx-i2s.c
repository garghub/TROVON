...
static int F_26 ( struct V_50 * V_51 , int V_73 ,
struct V_14 * V_15 )
{
struct V_16 * V_17 = F_8 ( V_15 -> V_18 ) ;
int V_74 = ( V_51 -> V_75 == V_76 ) ;
int V_60 = 0 ;
switch ( V_73 ) {
case V_77 :
if ( V_74 )
...
if ( ! V_17 )
return - V_89 ;
V_17 -> V_71 = F_33 ( & V_85 -> V_18 , L_5 ) ;
if ( F_34 ( V_17 -> V_71 ) ) {
F_13 ( & V_85 -> V_18 , L_6 ) ;
return F_35 ( V_17 -> V_71 ) ;
}
V_17 -> V_83 = F_33 ( & V_85 -> V_18 , L_7 ) ;
if ( F_34 ( V_17 -> V_83 ) ) {
F_13 ( & V_85 -> V_18 , L_8 ) ;
return F_35 ( V_17 -> V_83 ) ;
}
...
& V_93 , 1 ) ;
if ( V_60 ) {
F_13 ( & V_85 -> V_18 , L_10 , V_60 ) ;
return V_60 ;
}
V_60 = F_40 ( & V_85 -> V_18 , NULL , 0 ) ;
if ( V_60 )
F_13 ( & V_85 -> V_18 , L_11 , V_60 ) ;
return V_60 ;
}
