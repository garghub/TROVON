...
{
struct V_11 * V_12 = V_213 -> V_49 ;
struct V_214 * V_21 ;
F_8 (component, &rtd->card->component_dev_list,
card_list) {
if ( V_21 -> V_215 )
V_21 -> V_215 ( V_213 ) ;
}
}
int F_119 ( struct V_11 * V_12 , int V_216 )
{
struct V_83 * V_84 = V_12 -> V_84 ;
struct V_1 * V_69 ;
struct V_1 * V_13 = V_12 -> V_13 ;
...
if ( V_12 -> V_24 -> V_97 ) {
snprintf ( V_217 , sizeof( V_217 ) , L_102 ,
V_12 -> V_24 -> V_106 ) ;
V_50 = F_120 ( V_12 -> V_112 -> V_222 , V_217 , V_216 ,
V_8 , V_9 , & V_213 ) ;
} else {
if ( V_12 -> V_24 -> V_96 )
snprintf ( V_217 , sizeof( V_217 ) , L_103 ,
V_12 -> V_24 -> V_106 ) ;
else
snprintf ( V_217 , sizeof( V_217 ) , L_104 ,
V_12 -> V_24 -> V_106 ,
( V_12 -> V_17 > 1 ) ?
L_12 : V_12 -> V_69 -> V_47 , V_216 ) ;
V_50 = F_121 ( V_12 -> V_112 -> V_222 , V_217 , V_216 , V_8 ,
V_9 , & V_213 ) ;
}
if ( V_50 < 0 ) {
...
F_9 ( V_12 -> V_112 -> V_46 , L_106 , V_216 , V_217 ) ;
F_122 ( & V_12 -> V_105 , F_41 ) ;
V_213 -> V_223 = V_12 -> V_24 -> V_223 ;
V_12 -> V_213 = V_213 ;
V_213 -> V_49 = V_12 ;
if ( V_12 -> V_24 -> V_97 ) {
if ( V_8 )
V_213 -> V_224 [ V_6 ] . V_27 -> V_49 = V_12 ;
if ( V_9 )
V_213 -> V_224 [ V_110 ] . V_27 -> V_49 = V_12 ;
goto V_89;
}
if ( V_12 -> V_24 -> V_96 ) {
...
V_12 -> V_87 . V_228 = V_84 -> V_7 -> V_87 -> V_228 ;
V_12 -> V_87 . V_229 = V_84 -> V_7 -> V_87 -> V_229 ;
}
if ( V_8 )
F_123 ( V_213 , V_6 , & V_12 -> V_87 ) ;
if ( V_9 )
F_123 ( V_213 , V_110 , & V_12 -> V_87 ) ;
F_8 (component, &rtd->card->component_dev_list, card_list) {
if ( V_21 -> V_230 ) {
V_50 = V_21 -> V_230 ( V_12 ) ;
if ( V_50 < 0 ) {
F_13 ( V_21 -> V_46 ,
L_107 ,
V_50 ) ;
...
{
return V_45 -> V_213 -> V_224 [ V_3 ] . V_27 ;
}
enum V_232
...
static const char * F_128 ( enum V_232 V_131 )
{
switch ( V_131 ) {
case V_172 :
return L_109 ;
...
struct V_43 * V_44 ;
T_4 V_125 = 0 ;
V_125 += snprintf ( V_233 + V_125 , V_234 - V_125 ,
L_120 , V_40 -> V_24 -> V_47 ,
V_3 ? L_121 : L_122 ) ;
V_125 += snprintf ( V_233 + V_125 , V_234 - V_125 , L_123 ,
...
F_16 ( V_61 ) ,
F_15 ( V_61 ) ) ;
V_125 += snprintf ( V_233 + V_125 , V_234 - V_125 , L_126 ) ;
if ( F_106 ( & V_40 -> V_44 [ V_3 ] . V_134 ) ) {
V_125 += snprintf ( V_233 + V_125 , V_234 - V_125 ,
L_127 ) ;
goto V_89;
...
static T_4 F_131 ( struct V_235 * V_235 , char T_6 * V_236 ,
T_5 V_170 , T_7 * V_237 )
{
struct V_11 * V_40 = V_235 -> V_49 ;
T_4 V_238 = V_239 , V_125 = 0 , V_50 = 0 ;
char * V_233 ;
V_233 = F_132 ( V_238 , V_129 ) ;
if ( ! V_233 )
return - V_130 ;
if ( V_40 -> V_13 -> V_7 -> V_8 . V_81 )
V_125 += F_129 ( V_40 , V_6 ,
V_233 + V_125 , V_238 - V_125 ) ;
if ( V_40 -> V_13 -> V_7 -> V_9 . V_81 )
V_125 += F_129 ( V_40 , V_110 ,
V_233 + V_125 , V_238 - V_125 ) ;
V_50 = F_133 ( V_236 , V_170 , V_237 , V_233 , V_125 ) ;
F_69 ( V_233 ) ;
return V_50 ;
}
