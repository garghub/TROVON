...
F_74 ( V_2 , V_18 ) ;
F_75 ( & V_18 -> V_112 ) ;
V_18 -> V_21 = V_194 -> V_200 ;
if ( V_18 -> V_21 == V_201 ) {
if ( ! F_52 ( V_4 , V_160 ) )
V_2 -> V_6 &= ~ V_7 ;
}
V_18 -> V_81 = V_202 [ V_18 -> V_21 ] . V_81 ;
V_18 -> V_6 = V_202 [ V_18 -> V_21 ] . V_6 ;
V_18 -> V_203 . V_204 = & V_205 ;
V_18 -> V_203 . V_145 = V_18 -> V_145 ;
V_18 -> V_145 [ 0 ] = & V_206 ;
V_18 -> V_145 [ 1 ] = & V_18 -> V_207 ;
V_145 = & V_18 -> V_207 ;
V_145 -> type = V_143 ;
V_145 -> V_20 = V_18 -> V_208 ;
V_18 -> V_208 [ 0 ] = V_209 | V_210 | V_211 |
V_212 | V_213 | V_214 |
V_215 | V_216 ;
V_18 -> V_208 [ 1 ] = V_209 | V_210 | V_211 |
V_212 | V_213 | V_214 |
V_215 | V_216 | V_217 ;
if ( V_18 -> V_6 & V_49 )
V_18 -> V_208 [ 1 ] |= V_218 ;
...
V_18 -> V_70 = V_202 [ V_18 -> V_21 ] . V_70 ;
V_18 -> V_29 = V_202 [ V_18 -> V_21 ] . V_29 ;
V_11 = F_56 ( V_2 , V_18 ) ;
if ( V_11 < 0 ) {
F_72 ( V_32 , L_29 ) ;
return V_11 ;
