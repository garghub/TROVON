...
static T_1 void F_53 ( void * V_101 , const void * V_102 , T_4 V_103 )
{
unsigned long V_64 ;
long V_104 ;
T_5 V_105 ;
...
if ( V_28 >= V_109 )
return;
F_53 ( ( void * ) V_109 , ( void * ) V_28 , V_29 ) ;
V_28 = V_109 ;
#endif
}
...
V_111 = V_21 + V_14 ;
V_110 = V_21 + V_14 + 1 ;
V_81 = F_58 ( V_110 , V_112 - V_14 - 1 ) ;
if ( V_81 ) {
if ( * V_110 == '=' )
memmove ( V_21 , V_110 + 1 , V_81 ) ;
else
* V_111 = ' ' ;
}
}
static inline int F_59 ( const char * V_95 )
{
int V_5 ;
for ( V_5 = 0 ; V_95 [ V_5 ] ; V_5 ++ )
if ( V_95 [ V_5 ] & 0x80 )
return 1 ;
return 0 ;
}
