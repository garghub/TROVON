...
{
struct V_6 * V_24 = V_31 -> V_32 -> V_33 -> V_34 ;
struct V_7 * V_7 ;
if ( V_31 -> V_35 >= F_1 ( V_24 -> V_28 ) )
return V_36 ;
V_7 = V_24 -> V_29 [ V_31 -> V_35 ] ;
F_16 ( V_7 ) ;
V_31 -> V_7 = V_7 ;
return 0 ;
}
static int F_17 ( struct V_37 * V_37 , struct V_38 * V_32 )
{
V_32 -> V_39 = & V_40 ;
return 0 ;
}
static int F_18 ( struct V_41 * V_41 , struct V_37 * V_42 )
{
struct V_6 * V_24 = V_42 -> V_34 ;
F_19 ( & V_24 -> V_43 ) ;
F_20 ( V_24 -> V_44 ) ;
F_4 (
