...
T_3 V_77 = 0 , V_18 = 0 ;
long V_21 = V_78 ;
if ( F_48 ( V_69 ) == V_29 && V_42 >= F_49 ( V_5 ) )
return 0 ;
if ( ( V_42 & ~ V_79 ) || ( V_76 & ~ V_79 ) )
return - V_80 ;
F_50 ( V_81 , L_1 V_82 L_2 ,
F_51 ( F_52 ( V_5 ) ) , V_5 , V_76 , V_78 ,
V_42 , V_42 , V_76 >> V_27 ,
V_78 >> V_27 ) ;
if ( F_53 ( V_69 ) & ~ V_79 )
return - V_80 ;
...
struct V_1 * * V_22 ;
T_2 V_86 ;
V_76 = F_55 ( T_2 , F_47 ( V_69 ) , V_21 ) ;
if ( F_48 ( V_69 ) == V_29 ) {
if ( V_42 >= F_49 ( V_5 ) )
break;
if ( V_42 + V_76 > F_49 ( V_5 ) )
V_76 = F_49 ( V_5 ) - V_42 ;
}
V_18 = F_56 ( V_69 , & V_22 , V_76 , & V_86 ) ;
if ( F_38 ( V_18 > 0 ) ) {
int V_87 = F_57 ( V_18 + V_86 , V_11 ) ;
V_18 = F_45 ( V_7 , V_34 , F_48 ( V_69 ) ,
V_5 , V_72 -> V_74 ,
V_18 , V_42 , V_22 ,
V_87 ) ;
F_22 ( V_22 , V_87 , F_48 ( V_69 ) == V_29 ) ;
}
if ( F_20 ( V_18 <= 0 ) ) {
if ( V_18 == - V_24 &&
...
int V_18 = 0 ;
F_50 ( V_81 , L_4 , V_110 , V_111 , V_105 ) ;
V_71 = F_54 ( V_72 ) ;
if ( ! V_71 ) {
V_34 = NULL ;
V_18 = - V_83 ;
