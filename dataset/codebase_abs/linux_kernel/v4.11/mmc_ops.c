...
int F_24 ( struct V_1 * V_2 , T_2 * * V_67 )
{
int V_4 ;
T_2 * V_68 ;
if ( ! V_2 || ! V_67 )
...
int F_38 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_95 , T_2 V_96 ,
...
int F_42 ( struct V_1 * V_2 , T_2 V_94 , T_2 V_95 , T_2 V_96 ,
unsigned int V_82 )
{
...
static int
F_45 ( struct V_1 * V_2 , struct V_18 * V_9 , T_2 V_7 ,
T_2 V_44 )
{
struct V_45 V_46 = {} ;
struct V_5 V_6 = {} ;
...
T_2 * V_128 ;
int V_31 , V_4 ;
static T_2 V_129 [ 8 ] = { 0x55 , 0xaa , 0 , 0 , 0 , 0 , 0 , 0 } ;
static T_2 V_130 [ 4 ] = { 0x5a , 0 , 0 , 0 } ;
...
int F_47 ( struct V_1 * V_2 , T_2 V_119 )
{
int V_134 ;
if ( V_119 == V_120 )
V_134 = 8 ;
