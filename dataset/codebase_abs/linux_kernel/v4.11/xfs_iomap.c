...
error = F_28 ( V_7 , & F_29 ( V_7 ) -> V_70 , V_52 , V_53 ,
V_57 , & V_48 ) ;
if ( error )
return error ;
V_54 = V_71 ;
F_30 ( V_2 , V_54 ) ;
error = F_31 ( V_48 , V_2 , V_51 , 0 , V_46 ) ;
if ( error )
goto V_72;
F_32 ( V_48 , V_2 , 0 ) ;
F_33 ( & V_50 , & V_43 ) ;
V_45 = 1 ;
error = F_34 ( V_48 , V_2 , V_40 , V_41 ,
V_55 , & V_43 , V_52 , V_5 ,
& V_45 , & V_50 ) ;
if ( error )
goto V_73;
error = F_35 ( & V_48 , & V_50 , NULL ) ;
if ( error )
goto V_73;
error = F_36 ( V_48 ) ;
if ( error )
...
V_73:
F_37 ( & V_50 ) ;
F_38 ( V_48 , V_2 , ( long ) V_51 , 0 , V_46 ) ;
V_72:
F_39 ( V_48 ) ;
goto V_62;
}
...
T_9 V_75 )
{
struct V_76 * V_77 = F_41 ( V_2 , type ) ;
if ( ! V_77 || ! F_42 ( V_2 -> V_8 , type ) )
return false ;
if ( ! V_77 -> V_78 )
return false ;
...
if ( F_40 ( V_2 , V_104 , V_75 ) )
F_43 ( V_2 , V_104 , & V_51 , & V_81 ,
& V_83 ) ;
if ( F_40 ( V_2 , V_105 , V_75 ) )
F_43 ( V_2 , V_105 , & V_51 , & V_81 ,
& V_83 ) ;
if ( F_40 ( V_2 , V_106 , V_75 ) )
F_43 ( V_2 , V_106 , & V_51 , & V_81 ,
& V_83 ) ;
V_75 = F_20 ( V_75 , V_51 ) ;
V_84 = F_49 ( V_84 , V_81 ) ;
if ( V_84 )
...
V_33 = ! F_59 ( V_2 , V_91 , V_40 , & V_89 , & V_113 ) ;
if ( ! V_33 && V_113 . V_21 <= V_40 ) {
if ( F_60 ( V_2 ) ) {
bool V_122 ;
V_112 = F_61 ( F_18 ( V_7 , V_20 + V_38 ) ,
V_109 ) ;
F_62 ( & V_113 , V_40 , V_112 - V_40 ) ;
error = F_63 ( V_2 , & V_113 , & V_122 ) ;
if ( error )
goto V_62;
}
F_64 ( V_2 , V_20 , V_38 , 0 , & V_113 ) ;
goto V_123;
}
error = F_65 ( V_2 , 0 ) ;
if ( error )
goto V_62;
V_38 = F_66 ( T_13 , V_38 , 1024 * V_124 ) ;
V_112 = F_61 ( F_18 ( V_7 , V_20 + V_38 ) , V_109 ) ;
if ( V_33 ) {
V_114 = F_44 ( V_2 , V_20 , V_38 , V_89 ) ;
if ( V_114 ) {
T_1 V_26 ;
T_5 V_125 ;
T_2 V_126 ;
V_125 = F_67 ( V_7 , V_20 + V_38 - 1 ) ;
V_126 = F_17 ( V_7 , V_125 ) +
V_114 ;
V_26 = F_6 ( V_2 , 0 ) ;
if ( V_26 )
V_126 = F_9 ( V_126 , V_26 ) ;
V_126 = F_61 ( V_126 , V_109 ) ;
ASSERT ( V_126 > V_40 ) ;
V_114 = V_126 - V_112 ;
}
}
...
while ( V_45 == 0 ) {
V_135 = F_74 ( V_7 , V_34 ) ;
error = F_28 ( V_7 , & F_29 ( V_7 ) -> V_70 , 0 ,
0 , V_69 , & V_48 ) ;
if ( error )
return error ;
F_30 ( V_2 , V_71 ) ;
...
V_52 = F_23 ( V_7 , 0 ) << 1 ;
do {
error = F_28 ( V_7 , & F_29 ( V_7 ) -> V_70 , V_52 , 0 ,
V_69 | V_145 , & V_48 ) ;
if ( error )
return error ;
F_30 ( V_2 , V_71 ) ;
...
static inline bool F_81 ( struct V_107 * V_107 ,
...
static inline bool F_82 ( struct V_1 * V_2 , unsigned V_108 )
{
if ( F_60 ( V_2 ) && ( V_108 & ( V_150 | V_151 ) ) )
return true ;
...
! F_26 ( V_107 ) && ! F_15 ( V_2 ) ) {
return F_52 ( V_107 , V_20 , V_22 , V_108 ,
V_3 ) ;
}
if ( F_82 ( V_2 , V_108 ) ) {
V_54 = V_71 ;
...
error = F_86 ( V_2 , V_40 , V_112 - V_40 , & V_5 ,
& V_45 , 0 ) ;
if ( error )
goto V_62;
if ( V_108 & V_155 ) {
...
if ( ( V_108 & ( V_150 | V_151 ) ) && F_60 ( V_2 ) ) {
if ( V_108 & V_152 ) {
error = F_88 ( V_2 , & V_5 , & V_122 ,
& V_54 ) ;
if ( error )
goto V_62;
} else {
error = F_63 ( V_2 , & V_5 , & V_122 ) ;
if ( error )
goto V_62;
}
...
if ( ( V_108 & V_150 ) && F_81 ( V_107 , & V_5 , V_45 ) ) {
V_22 = F_66 ( T_13 , V_22 , 1024 * V_124 ) ;
if ( V_54 == V_71 )
F_89 ( V_2 , V_54 ) ;
...
V_158 = F_18 ( V_7 , V_20 + V_157 ) ;
V_112 = F_18 ( V_7 , V_20 + V_22 ) ;
if ( ( V_3 -> V_108 & V_129 ) && V_158 < V_112 ) {
F_92 ( F_5 ( V_2 ) , F_3 ( V_7 , V_158 ) ,
F_3 ( V_7 , V_112 ) - 1 ) ;
F_30 ( V_2 , V_71 ) ;
error = F_93 ( V_2 , V_158 ,
V_112 - V_158 ) ;
F_24 ( V_2 , V_71 ) ;
if ( error && ! F_84 ( V_7 ) ) {
F_94 ( V_7 , L_4 ,
...
return - V_154 ;
V_54 = F_85 ( V_2 ) ;
if ( F_97 ( V_2 ) || ! V_2 -> V_147 . V_159 ) {
error = - V_160 ;
goto V_62;
}
ASSERT ( V_2 -> V_147 . V_161 != V_162 ) ;
error = F_86 ( V_2 , V_40 , V_112 - V_40 , & V_5 ,
& V_45 , V_163 | V_164 ) ;
V_62:
F_24 ( V_2 , V_54 ) ;
