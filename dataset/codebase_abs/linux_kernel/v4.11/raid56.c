...
static void F_72 ( struct V_23 * V_24 , int V_85 )
{
struct V_86 * V_7 = F_73 ( & V_24 -> V_41 ) ;
struct V_86 * V_52 ;
if ( V_24 -> V_43 )
...
static void F_76 ( struct V_86 * V_86 )
{
...
static unsigned long F_82 ( unsigned long V_64 , int V_98 )
{
return F_83 ( V_64 , V_31 ) * V_98 ;
}
...
F_12 ( F_79 ( V_24 , V_70 , V_93 , 0 ) ) ;
}
for ( V_70 = 0 ; V_70 < V_24 -> V_73 ; V_70 ++ ) {
for ( V_93 = 0 ; V_93 < V_24 -> V_72 ; V_93 ++ ) {
struct V_39 * V_39 ;
if ( V_70 < V_24 -> V_63 ) {
V_39 = F_79 ( V_24 , V_70 , V_93 , 1 ) ;
if ( ! V_39 )
continue;
} else {
...
V_138:
F_86 ( & V_24 -> V_91 , F_102 ( & V_41 ) ) ;
F_31 ( F_67 ( & V_24 -> V_91 ) == 0 ) ;
while ( 1 ) {
V_86 = F_103 ( & V_41 ) ;
if ( ! V_86 )
break;
...
static int F_91 ( struct V_23 * V_24 , int V_144 )
{
unsigned long V_33 ;
int V_27 = 0 ;
F_35 ( & V_24 -> V_48 , V_33 ) ;
...
struct V_86 * V_86 )
{
int V_144 = F_106 ( V_24 , V_86 ) ;
if ( V_144 < 0 )
return - V_92 ;
return F_91 ( V_24 , V_144 ) ;
}
static void F_108 ( struct V_86 * V_86 )
{
struct V_127 * V_128 ;
int V_11 ;
F_100 (bvec, bio, i)
...
static void F_109 ( struct V_86 * V_86 )
{
struct V_23 * V_24 = V_86 -> V_89 ;
if ( V_86 -> V_88 )
F_77 ( V_24 , V_86 ) ;
...
if ( ! F_68 ( & V_24 -> V_91 ) )
return;
if ( F_67 ( & V_24 -> error ) > V_24 -> V_35 -> V_90 )
goto V_137;
F_95 ( V_24 ) ;
return;
V_137:
...
{
F_110 ( & V_24 -> V_145 , V_146 , V_147 , NULL , NULL ) ;
F_111 ( V_24 -> V_47 -> V_148 , & V_24 -> V_145 ) ;
}
static void F_61 ( struct V_23 * V_24 )
{
F_110 ( & V_24 -> V_145 , V_146 ,
V_149 , NULL , NULL ) ;
F_111 ( V_24 -> V_47 -> V_148 , & V_24 -> V_145 ) ;
}
...
static int F_117 ( void * V_154 , struct V_80 * V_155 , struct V_80 * V_156 )
{
struct V_23 * V_157 = F_118 ( V_155 , struct V_23 ,
V_51 ) ;
...
static void F_119 ( struct V_161 * V_162 )
{
struct V_23 * V_7 ;
struct V_23 * V_65 = NULL ;
F_120 ( NULL , & V_162 -> V_163 , F_117 ) ;
...
static void F_121 ( struct V_164 * V_145 )
{
struct V_161 * V_162 ;
V_162 = F_118 ( V_145 , struct V_161 , V_145 ) ;
F_119 ( V_162 ) ;
}
static void F_122 ( struct V_165 * V_166 , bool V_167 )
{
struct V_161 * V_162 ;
V_162 = F_118 ( V_166 , struct V_161 , V_166 ) ;
if ( V_167 ) {
F_110 ( & V_162 -> V_145 , V_146 ,
F_121 , NULL , NULL ) ;
F_111 ( V_162 -> V_2 -> V_148 ,
& V_162 -> V_145 ) ;
return;
}
F_119 ( V_162 ) ;
}
int F_123 ( struct V_1 * V_47 , struct V_86 * V_86 ,
...
V_166 = F_128 ( F_122 , V_47 , sizeof( * V_162 ) ) ;
if ( V_166 ) {
V_162 = F_118 ( V_166 , struct V_161 , V_166 ) ;
if ( ! V_162 -> V_2 ) {
V_162 -> V_2 = V_47 ;
...
int V_85 ;
int V_11 ;
V_132 = F_130 ( V_24 -> V_73 , sizeof( void * ) , V_104 ) ;
if ( ! V_132 ) {
V_85 = - V_17 ;
goto V_168;
}
...
static void F_134 ( struct V_86 * V_86 )
{
struct V_23 * V_24 = V_86 -> V_89 ;
if ( V_86 -> V_88 )
F_77 ( V_24 , V_86 ) ;
...
int F_135 ( struct V_1 * V_47 , struct V_86 * V_86 ,
struct V_99 * V_35 , T_1 V_64 ,
int V_173 , int V_174 )
{
struct V_23 * V_24 ;
...
{
struct V_23 * V_24 ;
V_24 = F_118 ( V_145 , struct V_23 , V_145 ) ;
F_112 ( V_24 ) ;
}
...
struct V_23 *
F_138 ( struct V_1 * V_47 , struct V_86 * V_86 ,
struct V_99 * V_35 , T_1 V_64 ,
struct V_176 * V_177 ,
...
V_186 = 1 ;
F_139 ( V_183 , V_24 -> V_107 , V_24 -> V_72 ) ;
}
F_60 ( V_32 , & V_24 -> V_33 ) ;
if ( ! V_182 )
goto V_187;
V_184 = F_88 ( V_104 | V_111 ) ;
if ( ! V_184 )
goto V_137;
F_13 ( V_184 ) ;
if ( V_134 != - 1 ) {
V_185 = F_88 ( V_104 | V_111 ) ;
if ( ! V_185 ) {
F_20 ( V_184 ) ;
goto V_137;
}
...
if ( V_24 -> V_105 >= 0 || V_24 -> V_106 >= 0 ) {
int V_190 = 0 , V_191 = - 1 ;
if ( F_145 ( V_24 , V_24 -> V_105 ) )
V_190 ++ ;
else if ( F_147 ( V_24 -> V_105 ) )
V_191 = V_24 -> V_105 ;
...
static void F_150 ( struct V_164 * V_145 )
{
struct V_23 * V_24 ;
V_24 = F_118 ( V_145 , struct V_23 , V_145 ) ;
F_149 ( V_24 ) ;
...
struct V_23 *
F_152 ( struct V_1 * V_47 , struct V_86 * V_86 ,
struct V_99 * V_35 , T_1 V_192 )
{
struct V_23 * V_24 ;
V_24 = F_84 ( V_47 , V_35 , V_192 ) ;
if ( F_124 ( V_24 ) )
return NULL ;
V_24 -> V_67 = V_69 ;
F_94 ( & V_24 -> V_41 , V_86 ) ;
...
static void F_153 ( struct V_164 * V_145 )
{
struct V_23 * V_24 ;
V_24 = F_118 ( V_145 , struct V_23 , V_145 ) ;
F_96 ( V_24 ) ;
