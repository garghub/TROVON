...
struct V_1 * V_1 )
{
int V_54 = F_53 ( V_3 , V_1 ) ;
if ( V_87 -> V_61 + V_54 > F_15 ( V_3 ) )
goto V_88;
if ( F_54 ( V_3 , V_87 , V_1 ) == false )
goto V_88;
V_87 -> V_61 += V_54 ;
return 1 ;
V_88:
...
if ( ! F_31 ( V_87 -> V_89 , V_48 ) )
F_30 ( V_3 , V_87 -> V_89 ) ;
if ( ! F_31 ( V_1 , V_48 ) )
F_30 ( V_3 , V_1 ) ;
return F_52 ( V_3 , V_87 , V_1 ) ;
}
...
int V_93 ;
unsigned int V_29 =
V_87 -> V_89 -> V_41 + V_92 -> V_1 -> V_31 ;
if ( F_66 ( V_87 ) || F_66 ( V_92 ) )
return 0 ;
if ( F_57 ( V_87 , V_92 -> V_1 ) )
return 0 ;
if ( ( F_60 ( V_87 ) + F_60 ( V_92 ) ) >
F_61 ( V_87 , F_62 ( V_87 ) ) )
return 0 ;
V_93 = V_87 -> V_61 + V_92 -> V_61 ;
if ( F_33 ( V_3 , V_87 -> V_89 , V_92 -> V_1 ) ) {
if ( V_87 -> V_61 == 1 )
V_87 -> V_1 -> V_31 = V_29 ;
if ( V_92 -> V_61 == 1 )
V_92 -> V_89 -> V_41 = V_29 ;
...
{
unsigned int V_94 = V_58 -> V_95 & V_96 ;
struct V_1 * V_1 ;
if ( V_58 -> V_76 & V_97 )
return;
...
static struct V_57 * F_79 ( struct V_2 * V_3 ,
struct V_57 * V_87 , struct V_57 * V_92 )
{
if ( ! F_80 ( V_87 ) || ! F_80 ( V_92 ) )
return NULL ;
if ( F_47 ( V_87 ) != F_47 ( V_92 ) )
return NULL ;
if ( F_62 ( V_87 ) + F_60 ( V_87 ) != F_62 ( V_92 ) )
return NULL ;
if ( F_76 ( V_87 ) != F_76 ( V_92 )
|| V_87 -> V_101 != V_92 -> V_101
|| F_66 ( V_92 ) )
return NULL ;
if ( F_47 ( V_87 ) == V_47 &&
! F_81 ( V_87 -> V_1 , V_92 -> V_1 ) )
return NULL ;
if ( ! F_67 ( V_3 , V_87 , V_92 ) )
return NULL ;
if ( ( ( V_87 -> V_76 | V_92 -> V_76 ) & V_97 ) ||
( V_87 -> V_95 & V_96 ) !=
( V_92 -> V_95 & V_96 ) ) {
F_69 ( V_87 ) ;
F_69 ( V_92 ) ;
}
if ( F_82 ( V_87 -> V_102 , V_92 -> V_102 ) )
V_87 -> V_102 = V_92 -> V_102 ;
V_87 -> V_89 -> V_66 = V_92 -> V_1 ;
V_87 -> V_89 = V_92 -> V_89 ;
V_87 -> V_103 += F_45 ( V_92 ) ;
F_83 ( V_3 , V_87 , V_92 ) ;
F_71 ( V_92 ) ;
V_87 -> V_104 = F_84 ( V_87 -> V_104 , V_92 -> V_104 ) ;
if ( F_85 ( V_92 ) )
V_87 -> V_100 = V_92 -> V_100 ;
V_92 -> V_1 = NULL ;
return V_92 ;
}
struct V_57 * F_86 ( struct V_2 * V_3 , struct V_57 * V_58 )
{
struct V_57 * V_92 = F_87 ( V_3 , V_58 ) ;
if ( V_92 )
return F_79 ( V_3 , V_58 , V_92 ) ;
return NULL ;
}
struct V_57 * F_88 ( struct V_2 * V_3 , struct V_57 * V_58 )
{
struct V_57 * V_53 = F_89 ( V_3 , V_58 ) ;
if ( V_53 )
return F_79 ( V_3 , V_53 , V_58 ) ;
return NULL ;
}
int F_90 ( struct V_2 * V_3 , struct V_57 * V_58 ,
struct V_57 * V_92 )
{
struct V_105 * V_106 = V_3 -> V_107 ;
struct V_57 * free ;
if ( ! V_106 -> V_108 && V_106 -> type -> V_109 . V_110 . V_111 )
if ( ! V_106 -> type -> V_109 . V_110 . V_111 ( V_3 , V_58 , V_92 ) )
return 0 ;
free = F_79 ( V_3 , V_58 , V_92 ) ;
if ( free ) {
F_91 ( V_3 , free ) ;
return 1 ;
}
...
return false ;
if ( V_58 -> V_101 != V_1 -> V_112 -> V_113 || F_66 ( V_58 ) )
return false ;
if ( F_54 ( V_58 -> V_3 , V_58 , V_1 ) == false )
return false ;
if ( F_47 ( V_58 ) == V_47 &&
! F_81 ( V_58 -> V_1 , V_1 ) )
return false ;
...
enum V_114 F_95 ( struct V_57 * V_58 , struct V_1 * V_1 )
{
if ( F_47 ( V_58 ) == V_43 &&
F_96 ( V_58 -> V_3 ) > 1 )
return V_115 ;
else if ( F_62 ( V_58 ) + F_60 ( V_58 ) == V_1 -> V_16 . V_17 )
return V_116 ;
