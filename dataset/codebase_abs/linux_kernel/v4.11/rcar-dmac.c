...
V_2 -> V_94 = F_139 ( & V_188 -> V_23 , V_2 -> V_58 ,
sizeof( * V_2 -> V_94 ) , V_134 ) ;
if ( ! V_2 -> V_94 )
return - V_74 ;
V_85 = F_140 ( V_188 , V_207 , 0 ) ;
V_2 -> V_6 = F_141 ( & V_188 -> V_23 , V_85 ) ;
if ( F_142 ( V_2 -> V_6 ) )
...
if ( ! V_190 )
return - V_74 ;
V_82 = F_144 ( & V_188 -> V_23 , V_173 , F_111 , 0 ,
V_190 , V_2 ) ;
if ( V_82 ) {
...
V_82 = F_146 ( V_188 -> V_23 . V_182 , F_114 ,
NULL ) ;
if ( V_82 < 0 )
goto error;
V_192 = & V_2 -> V_192 ;
...
V_192 -> V_211 = V_195 ;
V_192 -> V_212 = V_195 ;
V_192 -> V_213 = F_147 ( V_110 ) | F_147 ( V_105 ) ;
V_192 -> V_214 = V_215 ;
V_192 -> V_216 = F_66 ;
V_192 -> V_217 = F_68 ;
V_192 -> V_218 = F_76 ;
...
return 0 ;
error:
F_149 ( V_188 -> V_23 . V_182 ) ;
F_150 ( & V_188 -> V_23 ) ;
return V_82 ;
}
static int F_151 ( struct V_187 * V_188 )
{
struct V_1 * V_2 = F_152 ( V_188 ) ;
F_149 ( V_188 -> V_23 . V_182 ) ;
F_153 ( & V_2 -> V_192 ) ;
F_150 ( & V_188 -> V_23 ) ;
return 0 ;
}
static void F_154 ( struct V_187 * V_188 )
{
struct V_1 * V_2 = F_152 ( V_188 ) ;
F_54 ( V_2 ) ;
}
