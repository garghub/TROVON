...
struct V_1 * V_2 ,
unsigned int V_29 , const char * * V_41 ,
enum V_30 * V_42 ,
enum V_43 * V_44 )
{
struct V_18 * V_45 ;
...
V_14 = F_20 ( V_9 , L_6 , V_29 * V_47 + V_33 ,
& V_5 . args [ V_33 ] ) ;
if ( V_14 )
return F_5 ( V_14 ) ;
}
...
continue;
for ( V_33 = 0 ; ; V_33 ++ ) {
V_21 = F_18 ( V_9 , V_2 , V_33 , & V_41 , & V_42 ,
& V_44 ) ;
if ( F_10 ( V_21 ) )
break;
V_14 = F_26 ( V_21 , V_41 , V_42 , V_44 ) ;
if ( V_14 < 0 ) {
F_12 ( V_9 ) ;
return V_14 ;
}
...
if ( F_28 ( V_5 -> V_16 < V_51 -> V_15 ) )
return - V_17 ;
if ( V_5 -> args [ 0 ] >= V_51 -> V_52 )
return - V_17 ;
if ( V_13 )
* V_13 = V_5 -> args [ 1 ] ;
return V_5 -> args [ 0 ] ;
...
{
int V_14 = - V_55 ;
struct V_1 * V_51 = & V_54 -> V_51 ;
V_51 -> V_56 = F_30 ( V_9 -> V_23 , V_57 ) ;
if ( ! V_51 -> V_56 )
goto V_58;
V_54 -> V_59 = F_31 ( V_9 , 0 ) ;
if ( ! V_54 -> V_59 )
goto V_60;
V_51 -> V_61 = - 1 ;
if ( V_54 -> V_62 )
...
int V_20 = 0 , V_14 ;
const char * V_41 ;
static const char V_67 [] = L_14 ;
struct V_68 * V_69 ;
if ( ! V_9 )
return 0 ;
V_69 = F_39 ( V_9 , V_67 , NULL ) ;
for (; ; V_20 ++ ) {
