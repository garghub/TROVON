...
if ( V_21 )
return V_21 ;
memcpy ( & V_7 -> V_77 , & V_78 , sizeof( V_7 -> V_77 ) ) ;
V_7 -> V_77 . V_79 = V_7 -> V_11 -> V_80 ;
V_21 = F_16 ( V_7 ) ;
if ( V_21 )
return V_21 ;
F_36 ( & V_7 -> V_77 . V_81 ) ;
V_21 = F_37 ( & V_27 -> V_40 . V_35 , & V_7 -> V_77 ) ;
if ( V_21 ) {
F_23 ( & V_27 -> V_40 , L_10 ,
V_21 ) ;
return V_21 ;
...
F_38 ( & V_27 -> V_40 , L_11 ,
V_7 -> V_11 -> V_82 , V_7 -> V_11 -> V_52 , V_7 -> V_53 ) ;
return 0 ;
}
static int F_39 ( struct V_63 * V_27 )
{
struct V_6 * V_7 = F_40 ( V_27 ) ;
F_41 ( & V_27 -> V_40 . V_35 , & V_7 -> V_77 ) ;
if ( V_7 -> V_60 && F_30 ( V_7 -> V_60 -> V_61 ) )
