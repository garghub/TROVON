...
static int F_57 ( struct V_7 * V_8 , unsigned int V_16 )
{
int V_34 ;
T_1 * V_14 ;
V_14 = F_29 ( 5 , V_12 ) ;
...
static T_7 F_58 ( struct V_88 * V_25 ,
struct V_158 * V_159 , char * V_14 )
{
struct V_7 * V_8 = F_59 ( V_25 ) ;
struct V_9 * V_10 = F_9 ( V_8 ) ;
return sprintf ( V_14 , L_33 , V_10 -> V_16 ) ;
}
static T_7 F_60 ( struct V_88 * V_25 ,
struct V_158 * V_159 , const char * V_14 , T_8 V_53 )
{
struct V_7 * V_8 = F_59 ( V_25 ) ;
struct V_9 * V_10 = F_9 ( V_8 ) ;
unsigned long V_160 ;
if ( F_61 ( V_14 , 10 , & V_160 ) ) {
F_56 ( V_25 , L_34 ,
V_26 , V_14 ) ;
goto V_161;
}
