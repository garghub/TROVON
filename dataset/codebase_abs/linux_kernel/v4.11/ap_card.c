...
V_20 += V_19 -> V_21 ;
F_9 ( & V_15 ) ;
return snprintf ( V_5 , V_8 , L_1 , V_20 ) ;
}
...
V_22 += V_19 -> V_23 ;
F_9 ( & V_15 ) ;
return snprintf ( V_5 , V_8 , L_1 , V_22 ) ;
}
static T_1 F_15 ( struct V_1 * V_2 ,
struct V_3 * V_4 , char * V_5 )
{
return sprintf ( V_5 , L_3 , F_16 ( V_2 ) -> V_10 ) ;
}
static void F_17 ( struct V_1 * V_2 )
{
F_18 ( F_2 ( V_2 ) ) ;
}
struct V_6 * F_19 ( int V_24 , int V_12 , int V_10 ,
unsigned int V_13 )
{
struct V_6 * V_7 ;
V_7 = F_20 ( sizeof( * V_7 ) , V_25 ) ;
if ( ! V_7 )
return NULL ;
F_21 ( & V_7 -> V_26 ) ;
V_7 -> V_9 . V_1 . V_27 = F_17 ;
V_7 -> V_9 . V_1 . type = & V_28 ;
V_7 -> V_9 . V_10 = V_10 ;
if ( V_10 == V_29 )
V_7 -> V_9 . V_10 = V_30 ;
V_7 -> V_11 = V_10 ;
