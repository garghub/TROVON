...
F_18 ( V_40 ) -> type = V_46 ;
F_19 ( V_40 ) -> V_47 = 5 ;
F_19 ( V_40 ) -> V_48 [ 0 ] = V_49 ;
* ( int * ) & F_19 ( V_40 ) -> V_48 [ 1 ] = V_2 ;
V_40 -> V_50 = V_35 -> V_43 ;
if ( F_20 ( V_37 , NULL , V_40 , 0 ) )
V_41 = V_40 -> V_51 ;
F_21 ( V_40 ) ;
return V_41 ;
}
T_4 F_22 ( T_1 * V_1 , struct V_39 * V_40 )
{
int V_10 , ( * V_52 ) ( T_1 * , int ) = V_40 -> V_50 ;
V_10 = V_52 ( V_1 , * ( int * ) & F_19 ( V_40 ) -> V_48 [ 1 ] ) ;
if ( V_10 )
V_40 -> V_51 = V_10 ;
F_23 ( V_1 , V_10 , F_24 ( V_40 ) ) ;
return V_53 ;
}
