...
char * V_92 ;
T_1 V_16 = V_17 ;
V_89 = F_29 ( V_88 , L_7 , V_93 ) ;
if ( ! V_89 ) {
return ( F_1 ( V_7 ) ) ;
}
while ( ( V_92 = F_30 ( V_89 ) ) ) {
V_16 =
F_31 ( V_92 , V_90 , & V_20 ) ;
if ( F_4 ( V_16 ) ) {
continue;
...
static T_1
F_31 ( char * V_92 , char * V_19 , T_3 * V_20 )
{
if ( strlen ( V_92 ) < V_91 ) {
return ( V_85 ) ;
}
