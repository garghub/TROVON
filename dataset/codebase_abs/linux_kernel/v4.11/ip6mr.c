...
static int F_91 ( struct V_1 * V_4 , int V_151 , int V_152 ,
struct V_153 * V_154 )
{
struct V_69 * V_79 ;
struct V_106 * V_82 ;
...
if ( V_151 + 1 == V_4 -> V_72 ) {
int V_158 ;
for ( V_158 = V_151 - 1 ; V_158 >= 0 ; V_158 -- ) {
if ( F_41 ( V_4 , V_158 ) )
break;
}
V_4 -> V_72 = V_158 + 1 ;
...
if ( ( V_79 -> V_13 & V_162 ) && ! V_152 )
F_97 ( V_82 , V_154 ) ;
F_79 ( V_82 ) ;
return 0 ;
}
static inline void F_98 ( struct V_60 * V_163 )
{
F_99 ( V_164 , V_163 ) ;
}
static void F_100 ( struct V_1 * V_4 , struct V_60 * V_163 )
{
struct V_2 * V_2 = F_101 ( & V_4 -> V_2 ) ;
struct V_32 * V_33 ;
F_102 ( & V_4 -> V_165 ) ;
while ( ( V_33 = F_103 ( & V_163 -> V_95 . V_166 . V_167 ) ) != NULL ) {
if ( F_67 ( V_33 ) -> V_168 == 0 ) {
struct V_169 * V_170 = (struct V_169 * ) F_74 ( V_33 , sizeof( struct V_104 ) ) ;
V_170 -> V_171 = V_172 ;
V_170 -> V_173 = F_104 ( sizeof( struct V_174 ) ) ;
F_105 ( V_33 , V_170 -> V_173 ) ;
( (struct V_174 * ) F_106 ( V_170 ) ) -> error = - V_175 ;
F_107 ( V_33 , V_2 , F_108 ( V_33 ) . V_176 ) ;
} else
F_80 ( V_33 ) ;
}
F_98 ( V_163 ) ;
...
if ( F_110 ( V_163 -> V_95 . V_166 . V_179 , V_177 ) ) {
...
F_23 ( & V_163 -> V_50 ) ;
F_111 ( V_4 , V_163 , V_182 ) ;
F_100 ( V_4 , V_163 ) ;
}
if ( ! F_56 ( & V_4 -> V_56 ) )
F_112 ( & V_4 -> V_57 , V_178 + V_179 ) ;
}
static void V_58 ( unsigned long V_11 )
{
struct V_1 * V_4 = (struct V_1 * ) V_11 ;
if ( ! F_113 ( & V_68 ) ) {
F_112 ( & V_4 -> V_57 , V_178 + 1 ) ;
return;
}
if ( ! F_56 ( & V_4 -> V_56 ) )
F_109 ( V_4 ) ;
...
{
int line = F_120 ( V_201 , V_200 ) ;
struct V_60 * V_163 ;
F_36 (c, &mrt->mfc6_cache_array[line], list) {
if ( F_121 ( & V_163 -> V_93 , V_200 ) &&
F_121 ( & V_163 -> V_92 , V_201 ) )
return V_163 ;
}
return NULL ;
}
...
V_205:
return F_122 ( V_4 , V_202 ) ;
}
static struct V_60 * F_125 ( void )
{
struct V_60 * V_163 = F_126 ( V_164 , V_53 ) ;
if ( ! V_163 )
return NULL ;
...
{
struct V_60 * V_163 = F_126 ( V_164 , V_208 ) ;
if ( ! V_163 )
return NULL ;
F_128 ( & V_163 -> V_95 . V_166 . V_167 ) ;
...
{
struct V_32 * V_33 ;
while ( ( V_33 = F_130 ( & V_209 -> V_95 . V_166 . V_167 ) ) ) {
if ( F_67 ( V_33 ) -> V_168 == 0 ) {
struct V_169 * V_170 = (struct V_169 * ) F_74 ( V_33 , sizeof( struct V_104 ) ) ;
if ( F_131 ( V_4 , V_33 , V_163 , F_106 ( V_170 ) ) > 0 ) {
V_170 -> V_173 = F_132 ( V_33 ) - ( V_125 * ) V_170 ;
} else {
V_170 -> V_171 = V_172 ;
V_170 -> V_173 = F_104 ( sizeof( struct V_174 ) ) ;
F_105 ( V_33 , V_170 -> V_173 ) ;
( (struct V_174 * ) F_106 ( V_170 ) ) -> error = - V_210 ;
}
F_107 ( V_33 , V_2 , F_108 ( V_33 ) . V_176 ) ;
} else
F_133 ( V_2 , V_4 , V_33 , V_163 ) ;
}
}
...
#endif
V_33 = F_136 ( sizeof( struct V_104 ) + sizeof( * V_212 ) , V_208 ) ;
if ( ! V_33 )
return - V_191 ;
V_33 -> V_129 = V_214 ;
#ifdef F_28
...
static int
F_146 ( struct V_1 * V_4 , T_6 V_202 , struct V_32 * V_33 )
{
bool V_222 = false ;
int V_7 ;
struct V_60 * V_163 ;
...
if ( F_121 ( & V_163 -> V_92 , & F_67 ( V_33 ) -> V_119 ) &&
F_121 ( & V_163 -> V_93 , & F_67 ( V_33 ) -> V_118 ) ) {
V_222 = true ;
break;
}
}
...
F_148 ( & V_4 -> V_165 ) ;
F_149 ( & V_163 -> V_50 , & V_4 -> V_56 ) ;
F_111 ( V_4 , V_163 , V_224 ) ;
F_109 ( V_4 ) ;
}
...
F_150 ( & V_163 -> V_95 . V_166 . V_167 , V_33 ) ;
V_7 = 0 ;
}
F_39 ( & V_68 ) ;
return V_7 ;
}
static int F_151 ( struct V_1 * V_4 , struct V_226 * V_64 ,
int V_227 )
{
int line ;
struct V_60 * V_163 , * V_49 ;
line = F_120 ( & V_64 -> V_228 . V_229 , & V_64 -> V_230 . V_229 ) ;
F_22 (c, next, &mrt->mfc6_cache_array[line], list) {
if ( F_121 ( & V_163 -> V_93 , & V_64 -> V_230 . V_229 ) &&
F_121 ( & V_163 -> V_92 ,
& V_64 -> V_228 . V_229 ) &&
...
#ifdef F_155
V_7 = - V_46 ;
if ( ! F_156 ( L_13 , 0 , V_2 -> V_238 , & V_239 ) )
goto V_240;
if ( ! F_156 ( L_14 , 0 , V_2 -> V_238 , & V_241 ) )
goto V_242;
#endif
return 0 ;
#ifdef F_155
V_242:
F_157 ( L_13 , V_2 -> V_238 ) ;
V_240:
F_20 ( V_2 ) ;
#endif
V_237:
...
goto V_247;
#ifdef F_28
if ( F_163 ( & V_248 , V_120 ) < 0 ) {
F_164 ( L_16 , V_249 ) ;
V_7 = - V_31 ;
goto V_250;
}
#endif
F_165 ( V_251 , V_252 , NULL ,
V_253 , NULL ) ;
return 0 ;
#ifdef F_28
V_250:
...
static int F_172 ( struct V_2 * V_2 , struct V_1 * V_4 ,
...
V_163 -> V_257 |= V_258 ;
F_92 ( & V_65 ) ;
F_149 ( & V_163 -> V_50 , & V_4 -> V_55 [ line ] ) ;
F_93 ( & V_65 ) ;
V_222 = false ;
F_38 ( & V_68 ) ;
F_36 (uc, &mrt->mfc6_unres_queue, list) {
if ( F_121 ( & V_209 -> V_93 , & V_163 -> V_93 ) &&
F_121 ( & V_209 -> V_92 , & V_163 -> V_92 ) ) {
F_23 ( & V_209 -> V_50 ) ;
F_102 ( & V_4 -> V_165 ) ;
V_222 = true ;
break;
...
static int F_177 ( struct V_1 * V_4 , struct V_260 * V_261 )
{
int V_7 = 0 ;
struct V_2 * V_2 = F_178 ( V_261 ) ;
F_21 () ;
F_92 ( & V_65 ) ;
if ( F_179 ( V_4 -> V_221 == NULL ) ) {
V_4 -> V_221 = V_261 ;
V_2 -> V_15 . V_262 -> V_160 ++ ;
} else {
V_7 = - V_189 ;
}
F_93 ( & V_65 ) ;
...
struct V_260 * F_181 ( struct V_2 * V_2 , struct V_32 * V_33 )
{
struct V_1 * V_4 ;
struct V_5 V_108 = {
. V_109 = V_33 -> V_132 ? : V_133 ,
...
int F_182 ( struct V_260 * V_261 , int V_264 , char T_8 * V_265 , unsigned int V_266 )
{
int V_213 , V_227 = 0 ;
struct V_185 V_80 ;
struct V_226 V_64 ;
...
F_183 ( V_261 ) -> V_269 != V_270 )
return - V_271 ;
V_4 = F_1 ( V_2 , F_184 ( V_261 ) -> V_272 ? : V_45 ) ;
if ( ! V_4 )
return - V_77 ;
if ( V_264 != V_273 ) {
if ( V_261 != V_4 -> V_221 && ! F_185 ( V_2 -> V_274 , V_275 ) )
return - V_26 ;
}
switch ( V_264 ) {
case V_273 :
if ( V_266 < sizeof( int ) )
return - V_28 ;
return F_177 ( V_4 , V_261 ) ;
case V_276 :
return F_180 ( V_261 ) ;
case V_277 :
if ( V_266 < sizeof( V_80 ) )
return - V_28 ;
if ( F_186 ( & V_80 , V_265 , sizeof( V_80 ) ) )
return - V_278 ;
if ( V_80 . V_188 >= V_183 )
return - V_255 ;
F_21 () ;
V_213 = F_116 ( V_2 , V_4 , & V_80 , V_261 == V_4 -> V_221 ) ;
F_24 () ;
return V_213 ;
case V_279 :
if ( V_266 < sizeof( T_6 ) )
return - V_28 ;
if ( F_186 ( & V_202 , V_265 , sizeof( T_6 ) ) )
return - V_278 ;
F_21 () ;
V_213 = F_91 ( V_4 , V_202 , 0 , NULL ) ;
F_24 () ;
return V_213 ;
case V_280 :
case V_281 :
...
return - V_28 ;
if ( F_186 ( & V_64 , V_265 , sizeof( V_64 ) ) )
return - V_278 ;
if ( V_227 == 0 )
V_227 = V_64 . V_254 ;
F_21 () ;
if ( V_264 == V_281 || V_264 == V_283 )
V_213 = F_151 ( V_4 , & V_64 , V_227 ) ;
else
V_213 = F_172 ( V_2 , V_4 , & V_64 ,
...
int F_188 ( struct V_260 * V_261 , int V_264 , char T_8 * V_265 ,
int T_8 * V_266 )
{
int V_292 ;
int V_293 ;
...
if ( F_187 ( V_292 , V_266 ) )
return - V_278 ;
V_292 = F_189 ( int , V_292 , sizeof( int ) ) ;
if ( V_292 < 0 )
return - V_28 ;
if ( F_190 ( V_292 , V_266 ) )
return - V_278 ;
if ( F_191 ( V_265 , & V_293 , V_292 ) )
return - V_278 ;
return 0 ;
}
int F_192 ( struct V_260 * V_261 , int V_295 , void T_8 * V_11 )
{
struct V_296 V_297 ;
struct V_298 V_299 ;
struct V_69 * V_80 ;
...
switch ( V_295 ) {
case V_300 :
if ( F_186 ( & V_299 , V_11 , sizeof( V_299 ) ) )
return - V_278 ;
...
F_37 ( & V_65 ) ;
if ( F_191 ( V_11 , & V_299 , sizeof( V_299 ) ) )
return - V_278 ;
return 0 ;
}
F_37 ( & V_65 ) ;
...
return - V_278 ;
F_35 ( & V_65 ) ;
V_163 = F_119 ( V_4 , & V_297 . V_306 . V_229 , & V_297 . V_307 . V_229 ) ;
if ( V_163 ) {
...
int F_193 ( struct V_260 * V_261 , unsigned int V_295 , void T_8 * V_11 )
{
struct V_311 V_297 ;
struct V_312 V_299 ;
struct V_69 * V_80 ;
...
static inline int F_194 ( struct V_2 * V_2 , struct V_260 * V_261 , struct V_32 * V_33 )
{
F_195 ( V_2 , F_196 ( F_143 ( V_33 ) ) ,
V_313 ) ;
F_197 ( V_2 , F_196 ( F_143 ( V_33 ) ) ,
V_314 , V_33 -> V_121 ) ;
return F_198 ( V_2 , V_261 , V_33 ) ;
}
static int F_199 ( struct V_2 * V_2 , struct V_1 * V_4 ,
struct V_32 * V_33 , struct V_60 * V_163 , int V_151 )
{
struct V_104 * V_315 ;
...
V_80 -> V_86 ++ ;
V_80 -> V_85 += V_33 -> V_121 ;
if ( F_203 ( V_33 , sizeof( * V_315 ) + F_204 ( V_82 ) ) )
goto V_318;
V_315 = F_67 ( V_33 ) ;
V_315 -> V_319 -- ;
F_205 ( V_33 ) -> V_13 |= V_320 ;
return F_206 ( V_321 , V_322 ,
...
int V_323 = - 1 ;
int V_80 , V_66 ;
int V_324 = F_207 ( V_4 , V_33 -> V_82 ) ;
V_80 = V_67 -> V_94 ;
V_67 -> V_95 . V_9 . V_96 ++ ;
V_67 -> V_95 . V_9 . V_97 += V_33 -> V_121 ;
V_67 -> V_95 . V_9 . V_184 = V_178 ;
if ( F_123 ( & V_67 -> V_93 ) && V_324 >= 0 ) {
struct V_60 * V_325 ;
V_325 = F_122 ( V_4 , V_80 ) ;
if ( V_325 &&
...
if ( ( ! F_123 ( & V_67 -> V_93 ) || V_66 != V_324 ) &&
F_67 ( V_33 ) -> V_319 > V_67 -> V_95 . V_9 . V_100 [ V_66 ] ) {
if ( V_323 != - 1 ) {
struct V_32 * V_330 = F_208 ( V_33 , V_208 ) ;
if ( V_330 )
F_199 ( V_2 , V_4 , V_330 , V_67 , V_323 ) ;
}
V_323 = V_66 ;
}
}
...
F_214 ( V_33 , V_336 ) ;
V_184 = F_215 ( V_163 -> V_95 . V_9 . V_184 ) ;
V_184 = F_216 ( V_178 , V_184 ) ? V_178 - V_184 : 0 ;
V_335 . V_347 = V_163 -> V_95 . V_9 . V_96 ;
V_335 . V_348 = V_163 -> V_95 . V_9 . V_97 ;
V_335 . V_349 = V_163 -> V_95 . V_9 . V_98 ;
if ( F_217 ( V_33 , V_350 , sizeof( V_335 ) , & V_335 , V_351 ) ||
F_218 ( V_33 , V_352 , F_219 ( V_184 ) ,
V_351 ) )
return - V_210 ;
V_333 -> V_353 = V_354 ;
return 1 ;
}
int F_220 ( struct V_2 * V_2 , struct V_32 * V_33 , struct V_332 * V_333 ,
T_1 V_176 )
{
int V_7 ;
struct V_1 * V_4 ;
struct V_60 * V_67 ;
struct V_355 * V_356 = (struct V_355 * ) F_143 ( V_33 ) ;
V_4 = F_1 ( V_2 , V_45 ) ;
if ( ! V_4 )
return - V_77 ;
F_35 ( & V_65 ) ;
V_67 = F_119 ( V_4 , & V_356 -> V_357 . V_358 , & V_356 -> V_359 . V_358 ) ;
if ( ! V_67 && V_33 -> V_82 ) {
int V_80 = F_207 ( V_4 , V_33 -> V_82 ) ;
if ( V_80 >= 0 )
V_67 = F_124 ( V_4 , & V_356 -> V_359 . V_358 ,
V_80 ) ;
}
if ( ! V_67 ) {
struct V_32 * V_330 ;
...
V_330 = F_136 ( sizeof( struct V_104 ) , V_208 ) ;
if ( ! V_330 ) {
F_37 ( & V_65 ) ;
return - V_46 ;
}
F_108 ( V_330 ) . V_176 = V_176 ;
F_138 ( V_330 ) ;
F_139 ( V_330 , sizeof( struct V_104 ) ) ;
F_75 ( V_330 ) ;
V_360 = F_67 ( V_330 ) ;
V_360 -> V_168 = 0 ;
V_360 -> V_361 = 0 ;
...
V_7 = F_146 ( V_4 , V_80 , V_330 ) ;
F_37 ( & V_65 ) ;
return V_7 ;
}
if ( V_333 -> V_339 & V_365 )
V_67 -> V_257 |= V_366 ;
V_7 = F_131 ( V_4 , V_33 , V_67 , V_333 ) ;
F_37 ( & V_65 ) ;
return V_7 ;
}
...
struct V_332 * V_333 ;
int V_7 ;
V_170 = F_222 ( V_33 , V_176 , V_75 , V_295 , sizeof( * V_333 ) , V_13 ) ;
if ( ! V_170 )
return - V_210 ;
V_333 = F_106 ( V_170 ) ;
V_333 -> V_367 = V_251 ;
...
V_333 -> V_376 = V_378 ;
V_333 -> V_339 = 0 ;
if ( F_223 ( V_33 , V_379 , & V_163 -> V_93 ) ||
F_223 ( V_33 , V_380 , & V_163 -> V_92 ) )
goto V_373;
V_7 = F_131 ( V_4 , V_33 , V_163 , V_333 ) ;
if ( V_7 < 0 && V_7 != - V_77 )
goto V_373;
F_224 ( V_33 , V_170 ) ;
return 0 ;
...
static int F_226 ( bool V_167 , int V_72 )
{
T_9 V_121 =
F_227 ( sizeof( struct V_332 ) )
+ F_228 ( 4 )
+ F_228 ( sizeof( struct V_199 ) )
+ F_228 ( sizeof( struct V_199 ) )
;
if ( ! V_167 )
V_121 = V_121
+ F_228 ( 4 )
+ F_228 ( 0 )
+ V_72 * F_229 ( sizeof( struct V_337 ) )
+ F_230 ( sizeof( struct V_334 ) )
;
return V_121 ;
}
...
struct V_32 * V_33 ;
int V_7 = - V_191 ;
V_33 = F_231 ( F_226 ( V_64 -> V_94 >= V_183 , V_4 -> V_72 ) ,
V_208 ) ;
if ( ! V_33 )
goto V_381;
V_7 = F_221 ( V_4 , V_33 , 0 , 0 , V_64 , V_295 , 0 ) ;
if ( V_7 < 0 )
goto V_381;
F_232 ( V_33 , V_2 , 0 , V_382 , NULL , V_208 ) ;
return;
V_381:
F_80 ( V_33 ) ;
if ( V_7 < 0 )
...
{
struct V_2 * V_2 = F_178 ( V_33 -> V_261 ) ;
struct V_1 * V_4 ;
struct V_60 * V_64 ;
