...
{
V_2 -> V_6 = F_4 ( V_2 -> V_3 , V_2 -> V_7 , true ) ;
V_2 -> V_7 ++ ;
if ( V_2 -> V_6 == NULL ) {
V_2 -> V_7 = 0 ;
F_1 ( V_2 ) ;
...
const struct V_36 * V_37 = F_17 ( V_3 -> V_30 ) ;
F_14 ( V_9 , L_2 ,
& V_37 -> V_38 , & V_3 -> V_30 -> V_39 ) ;
} else
#endif
F_14 ( V_9 , L_3 ,
& V_32 -> V_40 , & V_32 -> V_41 ) ;
...
F_21 ( V_9 , V_2 -> V_6 ) ;
if ( V_2 -> V_6 -> V_79 )
V_2 -> V_6 -> V_79 ( V_2 -> V_6 ) ;
F_25 ( V_2 -> V_6 ) ;
}
V_13:
return 0 ;
}
static int F_26 ( struct V_80 * V_80 , struct V_81 * V_81 )
{
struct V_1 * V_2 ;
struct V_8 * V_82 ;
int V_83 = - V_84 ;
V_2 = F_27 ( sizeof( * V_2 ) , V_85 ) ;
if ( V_2 == NULL )
goto V_13;
V_2 -> V_4 = F_28 ( V_86 -> V_87 ) ;
if ( F_29 ( V_2 -> V_4 ) ) {
V_83 = F_30 ( V_2 -> V_4 ) ;
goto V_88;
}
...
V_93 = F_38 ( L_40 , 0600 , V_92 , NULL , & V_94 ) ;
if ( V_93 == NULL )
V_83 = - V_95 ;
F_39 ( L_41 ) ;
V_13:
