...
F_16 ( V_21 , L_23 ,
V_58 , V_99 ) ;
return F_19 ( V_21 , V_58 , V_99 ,
V_54 , V_100 , V_50 ) ;
}
static int
F_35 ( struct V_20 * V_21 , unsigned char * V_101 ) {
unsigned char * V_36 = V_21 -> V_41 ;
unsigned char * V_100 = V_21 -> V_41 ;
int V_42 , V_8 ;
memset ( V_36 , 0 , 12 ) ;
V_36 [ 0 ] = 0xED ;
V_36 [ 1 ] = V_43 ;
...
struct V_6 * V_105 ;
unsigned char V_101 [ 4 ] ;
char V_106 [ 256 ] ;
int V_42 ;
F_16 ( V_21 , L_31 ) ;
V_42 = F_35 ( V_21 , V_101 ) ;
if ( V_42 ) {
F_16 ( V_21 , L_32 , V_42 ) ;
F_32 ( V_95 L_33 ) ;
return NULL ;
}
sprintf ( V_106 , L_34 , V_101 ) ;
...
F_29 ( V_62 -> V_81 ) ;
F_29 ( V_62 -> V_87 ) ;
V_62 -> V_81 = F_27 ( V_108 * sizeof( int ) , V_79 ) ;
V_62 -> V_87 = F_27 ( V_108 * sizeof( int ) , V_79 ) ;
...
if ( V_62 -> V_87 [ V_8 + V_11 ] != V_114 ) {
if ( V_119 >= 1000 )
V_62 -> V_87 [ V_8 + V_11 ] = V_120 ;
else
V_119 ++ ;
}
}
...
static int F_46 ( struct V_127 * V_82 , struct V_20 * V_21 )
{
int V_128 ;
F_16 ( V_21 , L_63 , ( V_129 ) V_82 -> V_130 -> V_131 ) ;
switch ( V_82 -> V_130 -> V_131 ) {
case 0 :
V_128 = F_47 ( V_82 , V_21 ) ;
break;
case 1 :
V_82 -> V_130 -> V_131 = 0 ;
V_128 = F_48 ( V_82 , V_21 ) ;
V_82 -> V_130 -> V_131 = 1 ;
break;
default:
F_16 ( V_21 , L_64 , ( V_129 ) V_82 -> V_130 -> V_131 ) ;
V_128 = V_132 ;
break;
}
return V_128 ;
}
static int F_48 ( struct V_127 * V_82 , struct V_20 * V_21 )
{
static unsigned char V_133 = 0 , V_134 = 0 ;
static unsigned char V_135 = 0 ;
int V_42 , V_8 ;
unsigned char * V_88 = V_21 -> V_41 ;
unsigned long V_76 ;
unsigned int V_68 , V_69 ;
struct V_61 * V_62 ;
static unsigned char V_136 [ 8 ] = {
0x00 , 0x80 , 0x00 , 0x02 , 0x1F , 0x00 , 0x00 , 0x00
} ;
static unsigned char V_137 [ 19 ] = {
0x00 , 0x0F , 0x00 , 0x0 , 0x0 , 0x0 , 0x00 ,
0x01 , 0x0A ,
0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00
} ;
V_62 = (struct V_61 * ) V_21 -> V_63 ;
if ( V_82 -> V_138 [ 0 ] == V_139 && V_135 ) {
memset ( V_88 , 0 , 18 ) ;
V_88 [ 0 ] = 0x70 ;
V_88 [ 2 ] = V_133 ;
V_88 [ 7 ] = 11 ;
...
V_135 = 1 ;
if ( V_82 -> V_138 [ 0 ] == V_141 ) {
memcpy ( V_88 , V_136 , 8 ) ;
F_50 ( V_21 , V_88 , 36 ) ;
return V_140 ;
}
if ( V_82 -> V_138 [ 0 ] == V_142 ) {
struct V_6 * V_105 ;
F_36 ( V_21 , V_62 ) ;
...
( ( V_145 * ) V_88 ) [ 0 ] = F_51 ( V_76 ) ;
( ( V_145 * ) V_88 ) [ 1 ] = F_51 ( V_62 -> V_78 ) ;
F_49 ( V_88 , 8 , V_82 ) ;
return V_140 ;
}
if ( V_82 -> V_138 [ 0 ] == V_146 ) {
int V_147 = ( V_82 -> V_138 [ 2 ] & 0x3F ) ;
if ( V_147 == 0x01 || V_147 == 0x3F ) {
F_16 ( V_21 , L_65 ,
V_147 ) ;
memcpy ( V_88 , V_137 , sizeof( V_137 ) ) ;
( ( V_148 * ) V_88 ) [ 0 ] = F_52 ( sizeof( V_137 ) - 2 ) ;
V_88 [ 3 ] = ( V_62 -> V_103 & V_104 ) ? 0x80 : 0 ;
F_49 ( V_88 , sizeof( V_137 ) , V_82 ) ;
return V_140 ;
}
V_133 = 0x05 ;
V_134 = 0x24 ;
...
if ( V_82 -> V_138 [ 0 ] == V_149 )
return V_140 ;
V_135 = 0 ;
if ( V_82 -> V_138 [ 0 ] == V_150 ) {
V_68 = F_40 ( V_82 -> V_138 [ 3 ] , V_82 -> V_138 [ 2 ] ) ;
V_68 <<= 16 ;
V_68 |= F_40 ( V_82 -> V_138 [ 5 ] , V_82 -> V_138 [ 4 ] ) ;
V_69 = F_40 ( V_82 -> V_138 [ 8 ] , V_82 -> V_138 [ 7 ] ) ;
F_16 ( V_21 , L_66 ,
V_68 , V_69 ) ;
...
for (; V_82 -> V_153 < 12 ; V_82 -> V_153 ++ )
V_82 -> V_138 [ V_82 -> V_153 ] = 0 ;
V_82 -> V_138 [ 1 ] = V_43 ;
V_88 [ 0 ] = 0 ;
for ( V_8 = 0 ; V_8 < 12 ; V_8 ++ )
sprintf ( V_88 + strlen ( V_88 ) , L_68 , V_82 -> V_138 [ V_8 ] ) ;
F_16 ( V_21 , L_69 , V_88 ) ;
V_42 = F_10 ( V_21 , V_82 -> V_138 , 12 ) ;
if ( V_42 ) {
F_16 ( V_21 , L_70 ,
V_42 ) ;
return V_132 ;
...
if ( V_82 -> V_154 == V_155 ||
V_82 -> V_154 == V_156 ) {
unsigned int V_26 = ( V_82 -> V_154 == V_155 )
? V_21 -> V_57 : V_21 -> V_44 ;
F_16 ( V_21 , L_71 ,
( V_82 -> V_154 == V_155 ) ?
L_72 : L_73 ,
...
const struct V_159 * V_7 )
{
struct V_20 * V_21 ;
int V_42 ;
V_42 = F_57 ( & V_21 , V_158 , V_7 ,
( V_7 - V_160 ) + V_161 ,
& V_162 ) ;
if ( V_42 )
return V_42 ;
