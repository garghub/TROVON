...
struct V_25 * V_26 ;
unsigned V_27 ;
V_26 = V_4 -> V_5 . V_28 ? & V_4 -> V_5 . V_28 -> V_29 : V_4 -> V_30 ;
...
int F_18 ( struct V_3 * V_4 , struct V_31 * V_8 ,
...
if ( ! V_26 )
return - V_18 ;
V_24 = F_19 ( & V_4 -> V_5 , & V_8 -> V_6 , V_33 , V_34 ) ;
if ( V_24 )
return V_24 ;
V_4 -> V_34 = V_34 ;
V_4 -> V_35 = V_33 -> V_36 ;
...
static struct V_25 * F_22 ( struct V_1 * V_37 )
{
struct V_3 * V_4 = F_23 ( V_37 ) ;
struct V_15 * V_16 = V_4 -> V_16 ;
struct V_25 * V_30 = F_24 ( & V_4 -> V_23 ) ;
if ( V_30 == NULL && V_16 && ! V_4 -> V_38 ) {
struct V_31 * V_8 = V_4 -> V_8 ;
int V_24 ;
...
static struct V_25 * F_26 ( struct V_1 * V_37 )
{
struct V_25 * V_30 = NULL ;
struct V_3 * V_4 ;
int V_24 ;
if ( ! V_37 ) {
F_3 ( L_3 ) ;
...
F_29 ( V_4 ) ;
V_24 = F_30 ( V_4 -> V_8 , V_4 -> V_14 , V_4 -> V_22 , V_4 , & V_30 ) ;
if ( V_24 )
F_3 ( L_4 , V_24 ) ;
F_15 ( V_4 -> V_30 ) ;
V_4 -> V_30 = F_20 ( V_30 ) ;
