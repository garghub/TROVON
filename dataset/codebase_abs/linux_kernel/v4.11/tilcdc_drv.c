...
static T_2 F_81 ( int V_82 , void * V_83 )
{
struct V_9 * V_10 = V_83 ;
struct V_15 * V_16 = V_10 -> V_17 ;
return F_82 ( V_16 -> V_27 ) ;
}
static int F_83 ( struct V_9 * V_10 , unsigned int V_84 )
{
return 0 ;
}
static void F_84 ( struct V_9 * V_10 , unsigned int V_84 )
{
return;
}
static int F_85 ( struct V_85 * V_86 , void * V_83 )
{
struct V_87 * V_49 = (struct V_87 * ) V_86 -> V_88 ;
struct V_9 * V_10 = V_49 -> V_89 -> V_10 ;
struct V_15 * V_16 = V_10 -> V_17 ;
unsigned V_90 ;
F_62 ( V_10 -> V_10 ) ;
F_86 ( V_86 , L_29 , V_16 -> V_69 ) ;
for ( V_90 = 0 ; V_90 < F_66 ( V_91 ) ; V_90 ++ )
if ( V_16 -> V_69 >= V_91 [ V_90 ] . V_69 )
F_86 ( V_86 , L_30 , V_91 [ V_90 ] . V_3 ,
F_63 ( V_10 , V_91 [ V_90 ] . V_92 ) ) ;
F_65 ( V_10 -> V_10 ) ;
return 0 ;
}
static int F_87 ( struct V_85 * V_86 , void * V_83 )
{
struct V_87 * V_49 = (struct V_87 * ) V_86 -> V_88 ;
struct V_9 * V_10 = V_49 -> V_89 -> V_10 ;
struct V_93 V_94 = F_88 ( V_86 ) ;
F_89 ( & V_10 -> V_95 -> V_96 , & V_94 ) ;
return 0 ;
}
static int F_90 ( struct V_97 * V_89 )
{
struct V_9 * V_10 = V_89 -> V_10 ;
struct V_1 * V_2 ;
int V_21 ;
V_21 = F_91 ( V_98 ,
F_66 ( V_98 ) ,
...
static int F_92 ( struct V_44 * V_10 )
{
struct V_9 * V_45 = F_93 ( V_10 ) ;
struct V_15 * V_16 = V_45 -> V_17 ;
V_16 -> V_101 = F_94 ( V_45 ) ;
F_95 ( V_10 ) ;
return 0 ;
}
static int F_96 ( struct V_44 * V_10 )
{
struct V_9 * V_45 = F_93 ( V_10 ) ;
struct V_15 * V_16 = V_45 -> V_17 ;
int V_21 = 0 ;
F_97 ( V_10 ) ;
if ( V_16 -> V_101 )
V_21 = F_98 ( V_45 , V_16 -> V_101 ) ;
return V_21 ;
}
static int F_99 ( struct V_44 * V_10 )
{
return F_44 ( & V_102 , V_10 ) ;
}
static void F_100 ( struct V_44 * V_10 )
{
struct V_9 * V_45 = F_93 ( V_10 ) ;
if ( ! V_45 -> V_17 )
return;
...
return F_102 ( & V_47 -> V_10 ,
& V_105 ,
V_104 ) ;
}
static int F_103 ( struct V_46 * V_47 )
{
int V_21 ;
