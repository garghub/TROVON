...
static int F_33 ( struct V_9 * V_10 , struct V_14 * V_15 )
{
int V_39 = F_30 ( V_10 , V_15 ) ;
if ( ! V_39 && ( V_10 -> V_18 -> V_88 [ 0 ] & 0x02 ) )
F_34 ( V_10 -> V_18 ) ;
return V_39 ;
}
static int F_35 ( struct V_9 * V_10 , struct V_89 * V_90 )
{
if ( V_90 -> V_36 < V_91 || ! ( V_90 -> V_13 [ 0 ] & 0x02 ) )
return 1 ;
F_36 ( V_90 ) ;
F_37 ( F_38 ( V_90 ) -> V_92 , V_10 -> V_18 -> V_88 ) ;
return 1 ;
}
static void F_39 ( struct V_9 * V_10 , struct V_78 * V_78 )
{
struct V_73 * V_79 ;
if ( V_78 -> V_80 < sizeof( * V_79 ) )
return;
