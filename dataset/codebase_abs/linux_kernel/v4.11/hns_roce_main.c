...
{
struct V_32 * V_30 = F_14 ( V_43 ) ;
struct V_44 * V_12 = NULL ;
struct V_1 * V_2 = NULL ;
T_1 V_3 = 0 ;
int V_45 = 0 ;
V_2 = F_15 ( V_42 , struct V_1 , V_12 . V_46 ) ;
V_12 = & V_2 -> V_12 ;
...
static int F_17 ( struct V_15 * V_50 ,
struct V_51 * V_52 ,
struct V_53 * V_54 )
{
...
static struct V_32 * F_18 ( struct V_15 * V_50 ,
T_1 V_17 )
{
struct V_1 * V_2 = F_4 ( V_50 ) ;
struct V_32 * V_89 ;
...
static int F_22 ( struct V_15 * V_50 , T_1 V_17 ,
struct V_90 * V_52 )
{
struct V_1 * V_2 = F_4 ( V_50 ) ;
struct V_16 * V_30 = & V_2 -> V_31 -> V_30 ;
...
V_93 = F_23 ( V_91 -> V_93 ) ;
V_52 -> V_107 = V_93 ? F_24 ( V_52 -> V_49 , V_93 ) : V_108 ;
V_52 -> V_109 = ( F_25 ( V_91 ) && F_26 ( V_91 ) ) ?
V_110 : V_111 ;
V_52 -> V_112 = ( V_52 -> V_109 == V_110 ) ? 5 : 3 ;
F_6 ( & V_2 -> V_12 . V_26 , V_24 ) ;
return 0 ;
}
static enum V_113 F_27 ( struct V_15 * V_16 ,
T_1 V_17 )
{
return V_114 ;
}
static int F_28 ( struct V_15 * V_50 , T_1 V_17 , int V_18 ,
union V_19 * V_20 )
{
return 0 ;
}
static int F_29 ( struct V_15 * V_50 , T_1 V_3 , T_3 V_18 ,
T_3 * V_115 )
{
* V_115 = V_116 ;
return 0 ;
}
static int F_30 ( struct V_15 * V_50 , int V_117 ,
struct V_118 * V_52 )
{
unsigned long V_24 ;
if ( V_117 & ~ V_119 )
...
static int F_31 ( struct V_15 * V_50 , T_1 V_17 , int V_117 ,
struct V_124 * V_52 )
{
return 0 ;
}
static struct V_125 * F_32 ( struct V_15 * V_50 ,
struct V_53 * V_126 )
{
int V_45 = 0 ;
struct V_127 * V_23 ;
...
V_23 = F_33 ( sizeof( * V_23 ) , V_131 ) ;
if ( ! V_23 )
return F_34 ( - V_132 ) ;
V_45 = F_35 ( V_2 , & V_23 -> V_133 ) ;
if ( V_45 )
goto V_134;
V_45 = F_36 ( V_126 , & V_129 , sizeof( V_129 ) ) ;
if ( V_45 )
goto V_135;
return & V_23 -> V_136 ;
V_135:
...
static int F_39 ( struct V_125 * V_137 )
{
struct V_127 * V_23 = F_40 ( V_137 ) ;
F_37 ( F_4 ( V_137 -> V_16 ) , & V_23 -> V_133 ) ;
F_38 ( V_23 ) ;
return 0 ;
}
static int F_41 ( struct V_125 * V_23 ,
struct V_138 * V_139 )
{
...
return - V_25 ;
if ( V_139 -> V_143 == 0 ) {
V_139 -> V_144 = F_42 ( V_139 -> V_144 ) ;
if ( F_43 ( V_139 , V_139 -> V_141 ,
F_40 ( V_23 ) -> V_133 . V_145 ,
V_142 , V_139 -> V_144 ) )
return - V_146 ;
...
static int F_44 ( struct V_15 * V_50 , T_1 V_17 ,
struct V_151 * V_152 )
{
struct V_90 V_22 ;
int V_45 ;
V_152 -> V_153 = V_154 ;
V_45 = F_45 ( V_50 , V_17 , & V_22 ) ;
if ( V_45 )
return V_45 ;
...
static int F_55 ( struct V_16 * V_30 , void * V_231 )
{
return V_30 -> V_231 == V_231 ;
}
static struct
V_232 * F_56 ( struct V_233 * V_231 )
{
struct V_16 * V_30 ;
V_30 = F_57 ( & V_234 , NULL ,
V_231 , F_55 ) ;
return V_30 ? F_58 ( V_30 ) : NULL ;
}
...
} else if ( F_62 ( V_30 -> V_231 ) ) {
const struct V_247 * V_248 ;
V_248 = F_63 ( V_249 , V_30 ) ;
if ( ! V_248 ) {
F_9 ( V_30 , L_8 ) ;
return - V_244 ;
}
...
V_239 = F_64 ( V_2 -> V_31 , V_251 , 0 ) ;
if ( ! V_239 ) {
F_9 ( V_30 , L_12 ) ;
return - V_25 ;
}
V_2 -> V_252 = F_65 ( V_30 , V_239 ) ;
if ( F_66 ( V_2 -> V_252 ) )
return F_67 ( V_2 -> V_252 ) ;
V_45 = F_68 ( V_30 , L_13 ,
( T_1 * ) & V_2 -> V_50 . V_253 ,
V_254 ) ;
if ( V_45 ) {
...
struct V_256 args ;
struct V_233 * V_231 ;
V_45 = F_71 ( V_30 -> V_231 ,
L_15 ,
V_9 , & args ) ;
if ( V_45 )
continue;
V_231 = F_72 ( args . V_257 ) ;
V_31 = F_56 ( V_231 ) ;
} else {
F_9 ( V_30 , L_16 ) ;
return - V_244 ;
...
V_2 -> V_262 [ V_9 ] = F_75 ( V_2 -> V_31 , V_9 ) ;
if ( V_2 -> V_262 [ V_9 ] <= 0 ) {
F_9 ( V_30 , L_21 , V_9 ) ;
return - V_25 ;
}
...
return 0 ;
V_284:
F_78 ( V_2 , & V_2 -> V_272 . V_276 ) ;
V_279:
F_78 ( V_2 , & V_2 -> V_272 . V_272 ) ;
V_275:
F_78 ( V_2 , & V_2 -> V_263 . V_268 ) ;
V_271:
F_78 ( V_2 , & V_2 -> V_263 . V_264 ) ;
return V_45 ;
}
...
static int F_89 ( struct V_232 * V_31 )
{
int V_45 ;
struct V_1 * V_2 ;
...
V_2 -> V_31 = V_31 ;
F_91 ( V_31 , V_2 ) ;
if ( F_92 ( V_30 , F_93 ( 64ULL ) ) &&
F_92 ( V_30 , F_93 ( 32ULL ) ) ) {
F_9 ( V_30 , L_33 ) ;
V_45 = - V_292 ;
goto V_293;
}
...
static int F_103 ( struct V_232 * V_31 )
{
struct V_1 * V_2 = F_73 ( V_31 ) ;
F_46 ( V_2 ) ;
V_2 -> V_13 -> V_304 ( V_2 ) ;
F_97 ( V_2 ) ;
F_98 ( V_2 ) ;
