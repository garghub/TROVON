...
static struct V_22 * F_334 ( struct V_292 * V_293 )
{
struct V_294 * V_295 = F_167 ( V_293 , struct V_294 , V_293 ) ;
return V_295 -> V_23 ;
}
static T_10 F_335 ( struct V_292 * V_293 , struct V_296 * V_297 ,
char * V_298 )
{
struct V_22 * V_23 = F_334 ( V_293 ) ;
return F_336 ( V_298 , V_299 , L_40 , ( bool ) ! ( V_23 -> V_33 & V_70 ) ) ;
}
static T_10 F_337 ( struct V_292 * V_293 ,
struct V_296 * V_297 , char * V_298 )
{
struct V_22 * V_23 = F_334 ( V_293 ) ;
return F_336 ( V_298 , V_299 , L_40 , V_23 -> V_190 ) ;
}
...
F_297 () ;
F_245 (node) {
V_303 += F_336 ( V_298 + V_303 , V_299 - V_303 ,
L_42 , V_302 , V_24 ,
F_22 ( V_23 , V_24 ) -> V_14 -> V_20 ) ;
V_302 = L_43 ;
}
V_303 += F_336 ( V_298 + V_303 , V_299 - V_303 , L_18 ) ;
F_299 () ;
return V_303 ;
}
static T_10 F_340 ( struct V_292 * V_293 , struct V_296 * V_297 ,
char * V_298 )
{
struct V_22 * V_23 = F_334 ( V_293 ) ;
int V_303 ;
F_133 ( & V_23 -> V_180 ) ;
V_303 = F_336 ( V_298 , V_299 , L_40 , V_23 -> V_218 -> V_134 ) ;
F_135 ( & V_23 -> V_180 ) ;
return V_303 ;
}
static struct V_204 * F_341 ( struct V_22 * V_23 )
{
struct V_204 * V_125 ;
F_20 ( & V_16 ) ;
V_125 = F_216 ( V_19 ) ;
...
static T_10 F_342 ( struct V_292 * V_293 , struct V_296 * V_297 ,
...
static T_10 F_343 ( struct V_292 * V_293 ,
struct V_296 * V_297 , char * V_298 )
{
struct V_22 * V_23 = F_334 ( V_293 ) ;
int V_303 ;
F_133 ( & V_23 -> V_180 ) ;
V_303 = F_336 ( V_298 , V_299 , L_44 ,
F_344 ( V_23 -> V_218 -> V_126 ) ) ;
F_135 ( & V_23 -> V_180 ) ;
return V_303 ;
}
static T_10 F_345 ( struct V_292 * V_293 ,
struct V_296 * V_297 ,
const char * V_298 , T_7 V_300 )
{
struct V_22 * V_23 = F_334 ( V_293 ) ;
...
static T_10 F_347 ( struct V_292 * V_293 , struct V_296 * V_297 ,
char * V_298 )
{
struct V_22 * V_23 = F_334 ( V_293 ) ;
int V_303 ;
F_133 ( & V_23 -> V_180 ) ;
V_303 = F_336 ( V_298 , V_299 , L_40 ,
! V_23 -> V_218 -> V_209 ) ;
F_135 ( & V_23 -> V_180 ) ;
return V_303 ;
}
...
static T_10 F_349 ( struct V_292 * V_293 ,
struct V_296 * V_297 , char * V_298 )
{
int V_303 ;
F_133 ( & V_16 ) ;
...
{
int V_307 ;
V_307 = F_352 ( & V_308 , NULL ) ;
if ( V_307 )
return V_307 ;
return F_353 ( V_308 . V_309 , & V_310 ) ;
}
static void F_354 ( struct V_292 * V_293 )
{
struct V_294 * V_295 = F_167 ( V_293 , struct V_294 , V_293 ) ;
F_145 ( V_295 ) ;
}
...
if ( F_116 ( V_23 -> V_33 & V_242 ) )
return - V_241 ;
V_23 -> V_295 = V_295 = F_217 ( sizeof( * V_295 ) , V_19 ) ;
if ( ! V_295 )
return - V_200 ;
V_295 -> V_23 = V_23 ;
V_295 -> V_293 . V_311 = & V_308 ;
V_295 -> V_293 . V_312 = F_354 ;
F_355 ( & V_295 -> V_293 , L_15 , V_23 -> V_107 ) ;
F_356 ( & V_295 -> V_293 , true ) ;
V_15 = F_357 ( & V_295 -> V_293 ) ;
if ( V_15 ) {
F_145 ( V_295 ) ;
V_23 -> V_295 = NULL ;
return V_15 ;
...
F_356 ( & V_295 -> V_293 , false ) ;
F_359 ( & V_295 -> V_293 . V_314 , V_315 ) ;
return 0 ;
}
...
V_316 = V_73 ;
F_279 (cpu)
F_280 ( V_317 , V_56 ) = V_73 ;
}
static void F_361 ( unsigned long V_32 )
{
unsigned long V_318 = F_362 ( V_319 ) * V_320 ;
bool V_321 = false ;
struct V_13 * V_14 ;
int V_280 ;
if ( ! V_318 )
...
if ( F_51 ( & V_14 -> V_44 ) )
continue;
V_322 = F_362 ( V_14 -> V_72 ) ;
V_323 = F_362 ( V_316 ) ;
if ( F_364 ( V_322 , V_323 ) )
V_324 = V_322 ;
else
V_324 = V_323 ;
if ( V_14 -> V_56 >= 0 ) {
...
F_362 ( F_280 ( V_317 ,
V_14 -> V_56 ) ) ;
if ( F_364 ( V_325 , V_324 ) )
V_324 = V_325 ;
}
if ( F_364 ( V_73 , V_324 + V_318 ) ) {
V_321 = true ;
F_365 ( L_45 ) ;
F_307 ( V_14 ) ;
F_306 ( L_46 ,
F_315 ( V_73 - V_322 ) / 1000 ) ;
}
}
F_366 () ;
if ( V_321 )
...
static void F_368 ( unsigned long V_318 )
{
V_319 = 0 ;
F_199 ( & V_326 ) ;
if ( V_318 ) {
V_319 = V_318 ;
F_360 () ;
F_127 ( & V_326 , V_73 + V_318 * V_320 ) ;
}
}
static int F_369 ( const char * V_301 ,
const struct V_327 * V_328 )
{
unsigned long V_318 ;
int V_15 ;
V_15 = F_370 ( V_301 , 0 , & V_318 ) ;
if ( V_15 )
return V_15 ;
if ( V_329 )
F_368 ( V_318 ) ;
...
static inline void F_371 ( void ) { }
static void T_11 F_372 ( void )
{
T_9 * V_330 ;
int V_24 , V_56 ;
if ( F_373 () <= 1 )
...
V_246 = F_216 ( V_19 ) ;
F_257 ( ! V_246 ) ;
V_330 = F_217 ( V_239 * sizeof( V_330 [ 0 ] ) , V_19 ) ;
F_257 ( ! V_330 ) ;
F_245 (node)
F_257 ( ! F_374 ( & V_330 [ V_24 ] , V_19 ,
F_375 ( V_24 ) ? V_24 : V_25 ) ) ;
F_279 (cpu) {
V_24 = F_113 ( V_56 ) ;
if ( F_116 ( V_24 == V_25 ) ) {
F_104 ( L_48 , V_56 ) ;
...
int V_268 , V_56 ;
F_116 ( F_378 ( struct V_21 ) < F_378 (long long) ) ;
F_257 ( ! F_218 ( & V_96 , V_19 ) ) ;
F_219 ( V_96 , V_206 ) ;
V_223 = F_379 ( V_21 , V_335 ) ;
F_279 (cpu) {
struct V_13 * V_14 ;
V_268 = 0 ;
F_317 (pool, cpu) {
F_257 ( F_228 ( V_14 ) ) ;
V_14 -> V_56 = V_56 ;
F_219 ( V_14 -> V_125 -> V_126 , F_380 ( V_56 ) ) ;
...
V_329 = F_381 ( L_49 , 0 , 0 ) ;
V_285 = F_381 ( L_50 , V_249 , 0 ) ;
V_336 = F_381 ( L_51 , 0 , 0 ) ;
V_337 = F_381 ( L_52 , V_70 ,
V_255 ) ;
V_338 = F_381 ( L_53 ,
V_228 , 0 ) ;
V_339 = F_381 ( L_54 ,
