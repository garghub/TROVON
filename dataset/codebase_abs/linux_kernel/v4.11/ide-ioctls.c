...
F_16 ( V_51 ) ;
F_17 ( V_51 ) -> type = V_55 ;
V_10 = F_18 ( V_1 -> V_52 , NULL , V_51 , 0 ) ;
F_19 ( V_51 ) ;
return V_10 ;
}
...
V_49 -> V_60 = V_61 ;
V_49 -> V_62 = V_63 ;
V_4 . V_64 . V_33 . V_49 = V_65 ;
V_4 . V_64 . V_66 . V_49 = V_67 ;
} else {
V_49 -> V_58 = args [ 1 ] ;
V_4 . V_64 . V_33 . V_49 = V_68 | V_67 ;
V_4 . V_64 . V_66 . V_49 = V_67 ;
}
V_49 -> V_69 = args [ 0 ] ;
V_4 . V_70 = args [ 3 ] ? V_71 : V_72 ;
if ( args [ 3 ] ) {
V_4 . V_73 |= V_74 ;
V_45 = V_75 * args [ 3 ] ;
V_44 = F_21 ( V_45 , V_34 ) ;
...
return - V_36 ;
memset ( & V_4 , 0 , sizeof( V_4 ) ) ;
memcpy ( & V_4 . V_49 . V_56 , & args [ 1 ] , 6 ) ;
V_4 . V_49 . V_69 = args [ 0 ] ;
V_4 . V_64 . V_33 . V_49 = V_65 | V_82 ;
V_4 . V_64 . V_66 . V_49 = V_83 | V_82 ;
V_10 = F_25 ( V_1 , & V_4 ) ;
args [ 0 ] = V_4 . V_49 . V_69 ;
memcpy ( & args [ 1 ] , & V_4 . V_49 . V_56 , 6 ) ;
if ( F_10 ( V_81 , args , 7 ) )
V_10 = - V_36 ;
return V_10 ;
}
...
F_17 ( V_51 ) -> type = V_85 ;
F_27 ( V_51 ) -> V_86 = 1 ;
F_27 ( V_51 ) -> V_4 [ 0 ] = V_87 ;
if ( F_18 ( V_1 -> V_52 , NULL , V_51 , 1 ) )
V_84 = V_51 -> V_88 ;
F_19 ( V_51 ) ;
return V_84 ;
}
int F_28 ( T_1 * V_1 , struct V_2 * V_3 ,
unsigned int V_4 , unsigned long V_5 )
{
int V_10 ;
V_10 = F_1 ( V_1 , V_3 , V_4 , V_5 , V_89 ) ;
if ( V_10 != - V_11 )
return V_10 ;
switch ( V_4 ) {
case V_90 :
