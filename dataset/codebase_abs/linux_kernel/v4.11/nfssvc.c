...
V_116 -> V_154 = V_141 -> V_155 ;
V_149 = V_141 -> V_156 ;
if ( V_149 && ! V_149 ( V_116 , ( T_2 * ) V_116 -> V_146 . V_157 [ 0 ] . V_158 ,
V_116 -> V_159 ) ) {
F_26 ( L_12 ) ;
* V_148 = V_153 ;
return 1 ;
...
V_150 = V_116 -> V_163 . V_157 [ 0 ] . V_158
+ V_116 -> V_163 . V_157 [ 0 ] . V_164 ;
V_116 -> V_163 . V_157 [ 0 ] . V_164 += sizeof( T_2 ) ;
V_135 = V_141 -> V_165 ( V_116 , V_116 -> V_159 , V_116 -> V_166 ) ;
V_135 = F_76 ( V_116 -> V_144 , V_135 ) ;
if ( V_135 == V_137 || F_81 ( V_167 , & V_116 -> V_168 ) ) {
F_26 ( L_13 ) ;
F_82 ( V_116 , V_169 , NULL ) ;
return 0 ;
}
if ( V_116 -> V_151 != 0 )
* V_150 ++ = V_135 ;
...
F_82 ( V_116 , V_116 -> V_154 , V_148 + 1 ) ;
return 1 ;
}
int F_83 ( struct V_172 * V_172 , struct V_173 * V_173 )
{
int V_34 ;
struct V_23 * V_24 = F_6 ( V_172 -> V_174 -> V_175 , V_25 ) ;
F_7 ( & V_26 ) ;
if ( V_24 -> V_27 == NULL ) {
F_8 ( & V_26 ) ;
return - V_176 ;
...
F_48 ( V_24 -> V_27 ) ;
V_34 = F_84 ( V_24 -> V_27 , V_173 ) ;
F_8 ( & V_26 ) ;
return V_34 ;
}
int F_85 ( struct V_172 * V_172 , struct V_173 * V_173 )
{
int V_34 = F_86 ( V_172 , V_173 ) ;
struct V_21 * V_21 = V_172 -> V_174 -> V_175 ;
F_7 ( & V_26 ) ;
F_58 ( V_21 ) ;
F_8 ( & V_26 ) ;
return V_34 ;
