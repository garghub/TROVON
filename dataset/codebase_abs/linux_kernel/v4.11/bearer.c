...
V_147 = F_104 ( V_150 , V_151 ) ;
if ( ! V_147 )
return - V_56 ;
V_119 . V_45 = V_147 ;
V_119 . V_124 = V_146 -> V_152 ;
V_119 . V_125 = V_146 -> V_153 ;
F_98 () ;
V_120 = F_8 ( V_2 , V_8 ) ;
if ( ! V_120 ) {
V_115 = - V_36 ;
...
if ( V_122 [ V_156 ] )
V_62 = F_109 ( V_122 [ V_156 ] ) ;
if ( V_122 [ V_133 ] ) {
struct V_41 * V_157 [ V_158 + 1 ] ;
V_115 = F_110 ( V_122 [ V_133 ] ,
V_157 ) ;
if ( V_115 )
return V_115 ;
if ( V_157 [ V_135 ] )
V_155 = F_109 ( V_157 [ V_135 ] ) ;
}
F_98 () ;
V_115 = F_18 ( V_2 , V_120 , V_62 , V_155 , V_122 ) ;
if ( V_115 ) {
F_99 () ;
return V_115 ;
}
...
if ( V_157 [ V_136 ] )
V_34 -> V_60 = F_109 ( V_157 [ V_136 ] ) ;
if ( V_157 [ V_135 ] )
V_34 -> V_40 = F_109 ( V_157 [ V_135 ] ) ;
if ( V_157 [ V_137 ] )
V_34 -> V_61 = F_109 ( V_157 [ V_137 ] ) ;
}
F_99 () ;
return 0 ;
}
...
if ( ! V_87 )
return - V_128 ;
V_122 = F_86 ( V_119 -> V_45 , V_161 ) ;
if ( ! V_122 )
goto V_130;
if ( F_87 ( V_119 -> V_45 , V_162 , V_57 -> V_8 ) )
goto V_132;
V_123 = F_86 ( V_119 -> V_45 , V_163 ) ;
if ( ! V_123 )
goto V_134;
...
struct V_44 * V_147 ;
struct V_41 * V_122 [ V_148 + 1 ] ;
if ( ! V_146 -> V_122 [ V_161 ] )
return - V_36 ;
V_115 = F_102 ( V_122 , V_165 ,
V_146 -> V_122 [ V_161 ] ,
V_166 ) ;
if ( V_115 )
return V_115 ;
...
if ( V_157 [ V_136 ] )
V_18 -> V_60 = F_109 ( V_157 [ V_136 ] ) ;
if ( V_157 [ V_135 ] )
V_18 -> V_40 = F_109 ( V_157 [ V_135 ] ) ;
if ( V_157 [ V_137 ] )
V_18 -> V_61 = F_109 ( V_157 [ V_137 ] ) ;
}
F_99 () ;
return 0 ;
}
