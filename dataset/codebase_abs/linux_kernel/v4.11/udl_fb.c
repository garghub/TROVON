...
V_39 -> V_108 = V_59 -> V_61 . V_26 -> V_27 ;
V_39 -> V_51 . V_52 = V_44 ;
V_39 -> V_51 . V_53 = ( unsigned long ) V_59 -> V_61 . V_26 -> V_27 ;
V_39 -> V_79 = V_109 | V_110 ;
V_39 -> V_74 = & V_111 ;
F_45 ( V_39 , V_2 -> V_32 [ 0 ] , V_2 -> V_23 -> V_112 ) ;
F_46 ( V_39 , & V_59 -> V_96 , V_98 -> V_113 , V_98 -> V_114 ) ;
F_47 ( L_7 ,
V_2 -> V_5 , V_2 -> V_6 ,
V_59 -> V_61 . V_26 -> V_27 ) ;
return V_14 ;
...
struct V_58 * V_59 ;
int V_14 ;
V_59 = F_54 ( sizeof( struct V_58 ) , V_68 ) ;
if ( ! V_59 )
return - V_28 ;
V_11 -> V_117 = V_59 ;
F_55 ( V_8 , & V_59 -> V_96 , & V_118 ) ;
V_14 = F_56 ( V_8 , & V_59 -> V_96 , 1 ) ;
if ( V_14 )
goto free;
V_14 = F_57 ( & V_59 -> V_96 ) ;
if ( V_14 )
...
V_61 = F_54 ( sizeof( * V_61 ) , V_68 ) ;
if ( V_61 == NULL )
return F_65 ( - V_28 ) ;
V_14 = F_34 ( V_8 , V_61 , V_92 , F_66 ( V_26 ) ) ;
if ( V_14 ) {
F_23 ( V_61 ) ;
return F_65 ( - V_29 ) ;
}
