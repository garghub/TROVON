...
int V_7 ;
V_7 = F_15 ( V_2 , & V_28 -> V_13 ) ;
if ( V_7 ) {
F_16 ( V_2 , L_1 , V_7 ) ;
return V_7 ;
}
V_7 = F_17 ( V_2 , & V_28 -> V_11 . V_29 ) ;
if ( V_7 ) {
F_16 ( V_2 , L_2 , V_7 ) ;
goto V_30;
}
...
F_18 ( & V_2 -> V_10 . V_11 . V_12 ) ;
return 0 ;
V_31:
F_19 ( V_2 , V_28 -> V_11 . V_29 ) ;
V_30:
F_20 ( V_2 , V_28 -> V_13 ) ;
return V_7 ;
}
...
return - V_18 ;
if ( V_32 )
F_11 ( V_33 , V_5 , V_34 . V_35 ,
V_36 ) ;
F_11 ( V_33 , V_5 , V_37 . V_38 , 1 ) ;
F_24 (tir, &mdev->mlx5e_res.td.tirs_list, list) {
V_7 = F_25 ( V_2 , V_4 -> V_8 , V_5 , V_6 ) ;
if ( V_7 )
goto V_39;
}
V_39:
