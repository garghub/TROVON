...
struct V_1 * V_2 ;
int V_11 ;
F_68 ( V_10 , L_2 , V_10 -> V_36 . V_120 ) ;
V_2 = F_69 ( sizeof( * V_2 ) , V_121 ) ;
if ( ! V_2 )
return - V_18 ;
F_70 ( & V_2 -> V_6 ) ;
V_10 -> V_2 = V_2 ;
...
switch ( V_10 -> V_36 . V_140 >> 16 ) {
case 0x103c :
V_2 -> V_6 . V_141 = 1 ;
break;
}
F_21 ( V_10 , V_45 ) ;
V_11 = F_72 ( V_10 , & V_2 -> V_6 . V_53 , NULL ,
V_2 -> V_66 ) ;
if ( V_11 < 0 )
goto error;
V_11 = F_73 ( V_10 , & V_2 -> V_6 . V_53 ) ;
if ( V_11 < 0 )
goto error;
if ( ! V_10 -> V_142 -> V_36 . V_143 ) {
F_68 ( V_10 ,
L_3 ) ;
V_10 -> V_142 -> V_36 . V_143 = 1 ;
V_10 -> V_142 -> V_144 = 1 ;
}
F_21 ( V_10 , V_68 ) ;
return 0 ;
