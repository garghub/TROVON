...
int V_50 ;
int V_7 ;
V_5 = F_21 ( & V_15 -> V_51 , sizeof( * V_5 ) , V_52 ) ;
if ( ! V_5 )
return - V_53 ;
F_22 ( V_15 , V_5 ) ;
V_5 -> V_15 = V_15 ;
V_50 = F_23 ( V_15 -> V_51 . V_54 , L_1 ) ;
if ( V_50 < 0 )
V_50 = 0 ;
V_5 -> V_39 = F_24 ( & V_15 -> V_51 , ( V_50 / 2 ) + 1 ,
sizeof( * V_5 -> V_39 ) , V_52 ) ;
if ( ! V_5 -> V_39 )
return - V_53 ;
V_7 = F_25 ( V_15 -> V_51 . V_54 , L_1 ,
( T_1 * ) V_5 -> V_39 , V_50 ) ;
if ( V_7 && V_50 )
return V_7 ;
V_5 -> V_39 [ V_50 / 2 ] . V_6 = V_5 -> V_39 [ V_50 / 2 ] . V_9 = 0 ;
V_5 -> V_32 = V_46 = F_26 ( & V_15 -> V_51 , L_2 ) ;
if ( F_27 ( V_46 ) )
return F_28 ( V_46 ) ;
V_5 -> V_33 = V_46 = F_26 ( & V_15 -> V_51 , L_3 ) ;
if ( F_27 ( V_46 ) )
return F_28 ( V_46 ) ;
V_5 -> V_35 = V_48 = F_29 ( & V_15 -> V_51 , L_4 ) ;
if ( F_27 ( V_48 ) )
return F_28 ( V_48 ) ;
V_5 -> V_37 = V_48 = F_29 ( & V_15 -> V_51 , L_5 ) ;
if ( F_27 ( V_48 ) )
return F_28 ( V_48 ) ;
V_5 -> V_42 = V_42 = F_30 ( & V_15 -> V_51 , L_6 ) ;
if ( F_27 ( V_42 ) ) {
if ( F_28 ( V_42 ) == - V_55 )
return F_28 ( V_42 ) ;
V_5 -> V_42 = NULL ;
}
V_5 -> V_1 = F_31 ( & V_15 -> V_51 , V_15 -> V_51 . V_54 ,
& V_56 ) ;
if ( F_27 ( V_5 -> V_1 ) )
return F_28 ( V_5 -> V_1 ) ;
V_5 -> V_8 = F_32 ( & V_15 -> V_51 , 0 ) ;
if ( F_27 ( V_5 -> V_8 ) ) {
if ( F_28 ( V_5 -> V_8 ) != - V_57 )
return F_28 ( V_5 -> V_8 ) ;
V_5 -> V_8 = NULL ;
}
V_5 -> V_27 . V_58 = F_6 ;
F_33 ( V_5 -> V_1 , V_5 ) ;
V_45 = F_34 ( & V_15 -> V_51 , V_59 ) ;
return F_35 ( V_45 ) ;
}
