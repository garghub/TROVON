...
{
struct V_33 * V_34 = F_41 ( V_86 ) ;
struct V_41 V_42 ;
struct V_29 * V_32 ;
int V_87 = 0 ;
if ( ! F_42 ( F_43 ( V_34 ) , & V_88 ) )
return V_89 ;
if ( ( V_85 != V_90 ) && ( V_85 != V_91 ) )
return V_89 ;
V_32 = F_30 ( V_84 , struct V_29 , V_92 ) ;
V_42 = V_32 -> V_42 ;
switch ( V_85 ) {
case V_90 :
V_87 = F_33 ( V_32 , & V_42 , V_34 ,
V_86 ) ;
break;
case V_91 :
V_87 = F_38 ( V_32 , & V_42 ,
...
struct V_33 * V_38 )
{
unsigned int V_94 = F_50 ( V_2 -> V_95 -> V_96 ) ;
if ( V_94 >= V_36 )
return;
F_18 ( & V_56 ) ;
V_32 -> V_37 [ V_94 ] . V_2 = V_2 ;
V_32 -> V_37 [ V_94 ] . V_38 = V_38 ;
V_32 -> V_42 . V_47 [ V_94 ] . V_49 = 0 ;
V_32 -> V_42 . V_47 [ V_94 ] . V_48 = 0 ;
V_2 -> V_30 . V_31 = V_32 ;
F_19 ( & V_56 ) ;
}
...
F_49 ( V_32 , V_2 , V_38 ) ;
if ( ! V_32 -> V_92 . V_101 ) {
V_32 -> V_92 . V_101 = F_40 ;
if ( F_55 ( & V_32 -> V_92 ) ) {
V_32 -> V_92 . V_101 = NULL ;
F_15 ( V_2 , L_6 ) ;
}
}
}
...
bool F_62 ( struct V_104 * V_105 , struct V_106 * V_30 )
{
