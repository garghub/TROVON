...
V_131 = F_111 ( V_161 ) ;
if ( V_131 < 0 ) {
F_12 ( V_10 , L_119 , V_131 ) ;
goto V_261;
}
V_10 -> V_254 = 1 ;
V_257 = F_105 ( V_161 , 0 ) ;
V_258 = F_106 ( V_161 , 0 ) ;
if ( ! F_112 ( V_257 , V_258 , V_163 ) ) {
F_12 ( V_10 , L_120 ) ;
V_131 = - V_30 ;
goto V_261;
}
V_10 -> V_253 = 1 ;
V_259 = F_113 ( V_257 , V_258 ) ;
if ( V_259 == NULL ) {
F_12 ( V_10 , L_121 ) ;
V_131 = - V_266 ;
goto V_261;
...
F_92 ( V_10 , L_122 V_164 L_123 , F_65 () ) ;
F_92 ( V_10 , L_124 , V_161 -> V_234 , V_259 ) ;
F_81 ( V_10 ) ;
F_80 ( V_10 ) ;
if ( F_115 ( V_161 -> V_234 , F_90 , V_267 ,
V_163 , V_10 ) != 0 ) {
F_12 ( V_10 , L_125 , V_161 -> V_234 ) ;
V_131 = - V_30 ;
goto V_261;
}
V_10 -> V_252 = 1 ;
...
F_116 ( V_161 ) ;
#ifdef F_100
F_117 ( V_251 , 0 , NULL , & V_268 , V_10 ) ;
#endif
V_131 = F_118 ( & V_161 -> V_10 , & V_10 -> V_20 ,
F_94 ) ;
if ( V_131 )
goto V_261;
return 0 ;
