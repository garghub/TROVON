...
{
struct V_3 * V_4 = V_419 -> V_420 -> V_421 ;
struct V_15 * V_16 ;
if ( V_4 == NULL )
return V_422 ;
V_16 = V_4 -> V_16 ;
V_419 -> V_423 = F_271 ( V_16 -> V_111 ) ;
F_272 ( V_419 -> V_423 ) ;
return 0 ;
}
...
return - V_81 ;
V_426 = V_425 -> V_429 - V_425 -> V_430 ;
if ( V_426 != F_273 ( sizeof( struct V_350 ) ) )
return - V_81 ;
V_425 -> V_431 = & V_432 ;
V_425 -> V_421 = V_4 ;
V_425 -> V_427 |= V_433 | V_434 ;
return 0 ;
}
...
return - V_81 ;
V_426 = V_425 -> V_429 - V_425 -> V_430 ;
if ( V_426 != F_273 ( sizeof( struct V_351 ) ) )
return - V_81 ;
V_425 -> V_431 = & V_435 ;
V_425 -> V_421 = V_4 ;
V_425 -> V_427 |= V_433 | V_434 ;
...
F_275 ( struct V_3 * V_4 , unsigned long V_436 )
{
void * V_437 = V_4 -> V_16 -> V_438 + V_436 ;
return F_271 ( V_437 ) ;
}
...
return V_422 ;
V_16 = V_4 -> V_16 ;
V_402 = V_419 -> V_439 << V_440 ;
V_327 = F_273 ( V_16 -> V_327 ) ;
if ( V_402 > V_327 - V_441 )
return V_422 ;
if ( V_4 -> V_35 -> V_423 )
V_423 = V_4 -> V_35 -> V_423 ( V_4 , V_402 ) ;
else
V_423 = F_275 ( V_4 , V_402 ) ;
if ( ! V_423 )
return V_422 ;
F_272 ( V_423 ) ;
V_419 -> V_423 = V_423 ;
...
V_425 -> V_427 |= V_433 | V_434 ;
#ifdef F_278
if ( V_4 -> V_51 . V_52 . type == V_442 ) {
V_425 -> V_443 = F_279 ( V_425 -> V_443 ) ;
return F_280 ( V_425 , V_425 -> V_430 ,
V_4 -> V_51 . V_444 >> V_440 ,
V_425 -> V_429 - V_425 -> V_430 , V_425 -> V_443 ) ;
}
#endif
#ifndef F_281
if ( ! V_4 -> V_35 -> V_423 &&
...
{
struct V_15 * V_16 = V_4 -> V_16 ; ;
V_425 -> V_443 = F_284 ( V_425 -> V_443 ) ;
return F_285 ( V_425 , V_16 -> V_445 , V_16 -> V_327 ) ;
}
...
return - V_81 ;
V_426 = V_425 -> V_429 - V_425 -> V_430 ;
V_402 = V_425 -> V_448 << V_440 ;
V_327 = F_273 ( V_16 -> V_327 ) ;
if ( ( T_8 ) V_426 > V_327 )
return - V_81 ;
if ( V_402 > V_327 - V_426 )
return - V_81 ;
V_425 -> V_431 = & V_449 ;
V_425 -> V_421 = V_4 ;
if ( V_4 -> V_35 -> V_50 )
V_39 = V_4 -> V_35 -> V_50 ( V_4 , V_425 ) ;
else
V_39 = F_277 ( V_4 , V_425 ) ;
if ( ! V_39 )
F_287 ( & V_4 -> V_124 ) ;
return V_39 ;
}
static int F_288 ( struct V_251 * V_251 , struct V_424 * V_425 )
{
struct V_278 * V_279 ;
struct V_3 * V_4 ;
unsigned long V_402 ;
...
if ( V_279 -> V_451 )
return - V_117 ;
return V_350 ( V_4 , V_251 , V_425 ) ;
case V_452 :
if ( V_279 -> V_451 )
return - V_117 ;
return V_351 ( V_4 , V_251 , V_425 ) ;
default:
return F_286 ( V_4 , V_251 , V_425 ) ;
}
return 0 ;
}
static int F_289 ( int V_277 , struct V_251 * V_251 , int V_453 )
{
struct V_278 * V_279 ;
struct V_3 * V_4 ;
struct V_15 * V_16 ;
...
return - V_117 ;
V_16 = V_4 -> V_16 ;
return F_290 ( V_277 , V_251 , V_453 , & V_16 -> V_454 ) ;
}
...
V_55 -> V_12 = V_456 -> V_12 ;
for ( V_59 = 0 ; V_59 < F_292 ( V_456 -> V_457 ) ; V_59 ++ )
V_55 -> V_457 [ V_59 ] . V_83 [ 0 ] = V_456 -> V_457 [ V_59 ] ;
memcpy ( V_55 -> V_458 , V_456 -> V_458 , sizeof( V_456 -> V_458 ) ) ;
V_55 -> V_73 = F_293 ( V_456 -> V_73 ) ;
V_55 -> V_84 = F_293 ( V_456 -> V_84 ) ;
V_55 -> V_14 = V_456 -> V_14 ;
V_55 -> V_75 = V_456 -> V_75 ;
V_55 -> V_77 = V_456 -> V_77 ;
V_55 -> V_78 = V_456 -> V_78 ;
V_55 -> V_72 = V_456 -> V_72 ;
}
static void F_294 ( struct V_455 * V_456 ,
struct V_54 * V_55 )
{
unsigned int V_59 ;
memset ( V_456 , 0 , sizeof( * V_456 ) ) ;
V_456 -> V_12 = V_55 -> V_12 ;
for ( V_59 = 0 ; V_59 < F_292 ( V_456 -> V_457 ) ; V_59 ++ )
V_456 -> V_457 [ V_59 ] = V_55 -> V_457 [ V_59 ] . V_83 [ 0 ] ;
memcpy ( V_456 -> V_458 , V_55 -> V_458 , sizeof( V_456 -> V_458 ) ) ;
V_456 -> V_73 = F_295 ( V_55 -> V_73 ) ;
V_456 -> V_84 = F_295 ( V_55 -> V_84 ) ;
V_456 -> V_14 = V_55 -> V_14 ;
V_456 -> V_75 = V_55 -> V_75 ;
V_456 -> V_77 = V_55 -> V_77 ;
V_456 -> V_78 = V_55 -> V_78 ;
V_456 -> V_72 = V_55 -> V_72 ;
}
static int F_246 ( struct V_3 * V_4 ,
struct V_455 T_2 * V_459 )
{
struct V_54 * V_55 ;
...
V_39 = F_35 ( V_4 , V_55 ) ;
F_294 ( V_456 , V_55 ) ;
if ( F_31 ( V_459 , V_456 , sizeof( * V_456 ) ) ) {
if ( ! V_39 )
V_39 = - V_42 ;
}
F_32 ( V_456 ) ;
...
struct V_15 * V_16 = V_4 -> V_16 ;
unsigned long V_402 = V_439 << V_440 ;
switch ( V_402 ) {
case V_450 :
...
default:
return ( unsigned long ) V_16 -> V_438 + V_402 ;
}
}
