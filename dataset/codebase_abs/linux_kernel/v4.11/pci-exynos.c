...
static T_2 F_48 ( struct V_5 * V_6 , T_2 V_26 )
{
struct V_3 * V_4 = F_49 ( V_6 ) ;
T_2 V_25 ;
F_19 ( V_4 , true ) ;
V_25 = F_17 ( V_6 -> V_92 + V_26 ) ;
F_19 ( V_4 , false ) ;
return V_25 ;
}
static void F_50 ( struct V_5 * V_6 , T_2 V_26 , T_2 V_25 )
{
struct V_3 * V_4 = F_49 ( V_6 ) ;
F_18 ( V_4 , true ) ;
F_15 ( V_25 , V_6 -> V_92 + V_26 ) ;
F_18 ( V_4 , false ) ;
}
static int F_51 ( struct V_73 * V_74 , int V_93 , int V_94 ,
T_2 * V_25 )
{
struct V_5 * V_6 = F_52 ( V_74 ) ;
struct V_3 * V_4 = F_49 ( V_6 ) ;
int V_22 ;
F_19 ( V_4 , true ) ;
V_22 = F_53 ( V_6 -> V_92 + V_93 , V_94 , V_25 ) ;
F_19 ( V_4 , false ) ;
return V_22 ;
}
static int F_54 ( struct V_73 * V_74 , int V_93 , int V_94 ,
T_2 V_25 )
{
struct V_5 * V_6 = F_52 ( V_74 ) ;
struct V_3 * V_4 = F_49 ( V_6 ) ;
int V_22 ;
F_18 ( V_4 , true ) ;
V_22 = F_55 ( V_6 -> V_92 + V_93 , V_94 , V_25 ) ;
F_18 ( V_4 , false ) ;
return V_22 ;
}
...
static int T_4 F_58 ( struct V_3 * V_4 ,
struct V_1 * V_2 )
{
struct V_5 * V_6 = V_4 -> V_6 ;
struct V_73 * V_74 = & V_6 -> V_74 ;
...
if ( F_47 ( V_91 ) ) {
V_74 -> V_98 = F_59 ( V_2 , 0 ) ;
if ( ! V_74 -> V_98 ) {
F_9 ( V_8 , L_13 ) ;
return - V_96 ;
}
V_22 = F_60 ( V_8 , V_74 -> V_98 ,
F_42 ,
V_97 | V_99 ,
L_11 , V_4 ) ;
if ( V_22 ) {
...
V_6 -> V_101 = & V_106 ;
V_4 -> V_6 = V_6 ;
V_4 -> V_101 = ( const struct V_107 * )
F_63 ( V_8 ) ;
V_4 -> V_71 = F_64 ( V_104 , L_16 , 0 ) ;
V_4 -> V_16 = false ;
V_4 -> V_75 = F_65 ( V_8 , V_104 , NULL ) ;
if ( F_5 ( V_4 -> V_75 ) ) {
if ( F_6 ( V_4 -> V_75 ) == - V_108 )
return F_6 ( V_4 -> V_75 ) ;
F_66 ( V_8 , L_17 ) ;
} else
V_4 -> V_16 = true ;
if ( V_4 -> V_101 && V_4 -> V_101 -> V_109 ) {
V_22 = V_4 -> V_101 -> V_109 ( V_2 , V_4 ) ;
if ( V_22 )
return V_22 ;
}
if ( V_4 -> V_101 && V_4 -> V_101 -> V_110 ) {
V_22 = V_4 -> V_101 -> V_110 ( V_4 ) ;
if ( V_22 )
return V_22 ;
V_22 = V_4 -> V_101 -> V_111 ( V_4 ) ;
if ( V_22 )
return V_22 ;
}
F_67 ( V_2 , V_4 ) ;
...
if ( V_4 -> V_16 )
F_68 ( V_4 -> V_75 ) ;
if ( V_4 -> V_101 && V_4 -> V_101 -> V_113 )
V_4 -> V_101 -> V_113 ( V_4 ) ;
return V_22 ;
}
static int T_5 F_69 ( struct V_1 * V_2 )
{
