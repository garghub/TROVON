...
V_65 *
F_83 ( unsigned int V_8 , const char V_43 [] , ... )
{
struct V_65 * V_66 ;
T_1 args ;
va_start ( args , V_43 ) ;
V_66 = F_84 ( - 1 , V_8 , V_43 , args ) ;
va_end ( args ) ;
return V_66 ;
}
struct V_65 *
F_85 ( int V_50 , unsigned int V_8 ,
const char V_43 [] , ... )
{
struct V_65 * V_66 ;
T_1 args ;
va_start ( args , V_43 ) ;
V_66 = F_84 ( V_50 , V_8 , V_43 , args ) ;
va_end ( args ) ;
return V_66 ;
}
static inline bool F_86 ( struct V_65 * V_66 ,
struct V_74 * V_75 )
{
F_87 ( & V_66 -> V_70 ) ;
...
F_91 ( & V_75 -> V_39 , V_82 ) ;
V_75 -> V_66 = V_66 ;
if ( ! V_66 -> V_78 && F_92 ( V_66 -> V_14 ) )
F_54 ( V_66 -> V_14 ) ;
}
bool F_93 ( struct V_65 * V_66 ,
struct V_74 * V_75 )
{
bool V_26 = false ;
unsigned long V_8 ;
...
F_88 ( V_66 , V_75 ) ;
F_98 ( & V_75 -> V_39 , & V_66 -> V_72 ) ;
V_75 -> V_66 = V_66 ;
V_88 -> V_90 = V_91 + V_86 ;
F_99 ( V_88 ) ;
}
bool F_100 ( struct V_65 * V_66 ,
struct V_84 * V_85 ,
unsigned long V_86 )
{
struct V_74 * V_75 = & V_85 -> V_75 ;
...
{
struct V_92 * V_93 =
F_102 ( V_75 , struct V_92 , V_75 ) ;
F_20 ( & V_93 -> V_25 ) ;
}
void V_92 ( struct V_74 * V_75 )
{
struct V_92 V_93 = {
F_103 ( V_93 . V_75 , F_101 ) ,
F_104 ( V_93 . V_25 ) ,
} ;
struct V_65 * V_66 ;
bool V_94 = false ;
...
F_89 ( V_75 -> V_66 != V_66 ) ;
if ( ! F_68 ( & V_75 -> V_39 ) )
F_90 ( V_66 , & V_93 . V_75 , V_75 -> V_39 . V_63 ) ;
...
static bool F_105 ( struct V_74 * V_75 , bool V_95 ,
unsigned long * V_8 )
{
if ( V_95 ) {
struct V_84 * V_85 =
F_102 ( V_75 , struct V_84 , V_75 ) ;
struct V_65 * V_66 = V_75 -> V_66 ;
V_75 -> V_80 ++ ;
F_95 ( & V_66 -> V_70 , * V_8 ) ;
F_106 ( & V_85 -> V_88 ) ;
...
static bool F_108 ( struct V_74 * V_75 , bool V_95 )
{
struct V_65 * V_66 = V_75 -> V_66 ;
unsigned long V_8 ;
int V_26 = false ;
...
bool F_109 ( struct V_74 * V_75 )
{
return F_108 ( V_75 , false ) ;
}
bool F_110 ( struct V_84 * V_85 )
{
return F_108 ( & V_85 -> V_75 , true ) ;
}
