...
V_164 -> V_91 . V_170 &
V_101 ) ;
V_83 = F_81 ( V_13 -> V_100 , V_25 , V_48 ) ;
V_96 -> V_170 &= ~ V_102 ;
V_96 -> V_170 |=
F_82 ( V_13 -> V_100 ) &
V_102 ;
...
static int F_83 ( struct V_163 * V_164 ,
...
{
struct V_174 * V_175 = F_86 ( V_70 -> V_70 ) ;
...
static int F_88 ( struct V_174 * V_70 ,
unsigned V_122 , bool V_80 )
{
struct V_123 * V_124 =
F_74 ( F_89 ( V_70 ) ) ;
struct V_165 * V_13 = F_37 ( V_124 ) ;
F_90 ( V_125 , V_13 -> V_100 ) ;
int V_83 ;
F_91 ( V_125 , V_13 -> V_100 ) ;
F_92 ( V_125 , V_70 -> V_91 . V_126 , NULL , NULL ) ;
F_93 ( V_125 , V_70 -> V_21 , V_70 -> V_20 ,
V_70 -> V_52 , V_70 -> V_176 ) ;
V_83 = V_80 ? F_94 ( V_125 ) :
F_95 ( V_125 ) ;
F_96 ( V_125 ) ;
return V_83 ;
}
static int F_97 ( struct V_174 * V_70 , unsigned V_122 ,
bool V_80 )
{
struct V_2 * V_3 = V_70 -> V_91 . V_96 -> V_173 ;
struct V_6 * V_7 = F_1 ( V_3 ) -> V_7 ;
struct V_69 * V_156 = F_98 ( V_70 ) ;
unsigned long V_126 ;
int V_83 = - V_90 ;
V_156 -> V_70 = & V_70 -> V_91 ;
V_156 -> V_80 = V_80 ;
...
static int F_99 ( struct V_123 * V_96 )
{
struct V_165 * V_13 = F_37 ( V_96 ) ;
...
static void F_102 ( struct V_123 * V_96 )
{
struct V_165 * V_13 = F_37 ( V_96 ) ;
F_103 ( V_13 -> V_100 ) ;
}
static int F_104 ( struct V_174 * V_70 )
{
struct V_163 * V_164 = F_89 ( V_70 ) ;
struct V_123 * V_96 = F_74 ( V_164 ) ;
struct V_1 * V_3 = F_1 ( V_96 -> V_173 ) ;
return F_97 ( V_70 , V_3 -> type , 1 ) ;
}
static int F_105 ( struct V_174 * V_70 )
{
struct V_163 * V_164 = F_89 ( V_70 ) ;
struct V_123 * V_96 = F_74 ( V_164 ) ;
struct V_1 * V_3 = F_1 ( V_96 -> V_173 ) ;
return F_97 ( V_70 , V_3 -> type , 0 ) ;
}
static inline int F_106 ( struct V_6 * V_7 )
{
...
static T_6 F_109 ( int V_196 , void * V_60 )
{
...
static void F_110 ( unsigned long V_128 )
{
...
static void F_111 ( unsigned long V_128 )
{
struct V_6 * V_7 = (struct V_6 * ) V_128 ;
...
F_112 ( V_185 ) ;
F_59 ( & V_7 -> V_158 , V_126 ) ;
F_113 ( & V_7 -> V_185 , & V_185 ) ;
F_53 ( V_7 ) ;
if ( V_7 -> V_153 )
F_52 ( & V_7 -> V_148 , V_149 + V_150 ) ;
F_60 ( & V_7 -> V_158 , V_126 ) ;
F_114 (req, tmp, &completed, list) {
F_115 ( & V_70 -> V_154 ) ;
V_70 -> V_127 ( V_70 ) ;
}
}
static int F_116 ( struct V_202 * V_60 )
{
struct V_203 * V_204 = F_117 ( V_60 ) ;
struct V_6 * V_7 = F_118 ( V_204 ) ;
F_119 ( V_7 -> V_205 ) ;
return 0 ;
}
static int F_120 ( struct V_202 * V_60 )
{
struct V_203 * V_204 = F_117 ( V_60 ) ;
struct V_6 * V_7 = F_118 ( V_204 ) ;
return F_121 ( V_7 -> V_205 ) ;
}
static inline struct V_6 * F_122 ( struct V_202 * V_60 )
{
return V_60 ? F_118 ( F_117 ( V_60 ) ) : NULL ;
}
static T_7 F_123 ( struct V_202 * V_60 ,
struct V_206 * V_207 ,
char * V_208 )
{
struct V_6 * V_7 = F_122 ( V_60 ) ;
return snprintf ( V_208 , V_209 , L_7 , V_7 -> V_210 ) ;
}
static T_7 F_124 ( struct V_202 * V_60 ,
struct V_206 * V_207 ,
const char * V_208 , T_4 V_48 )
{
struct V_6 * V_7 = F_122 ( V_60 ) ;
unsigned long V_211 ;
if ( F_125 ( V_208 , 0 , & V_211 ) )
return - V_114 ;
V_211 = F_126 ( V_211 , 1UL , V_7 -> V_41 - 1 ) ;
V_7 -> V_210 = V_211 ;
F_8 ( V_7 -> V_210 << V_212 ,
V_7 -> V_9 + V_213 ) ;
return V_48 ;
...
{
int V_58 , V_83 , V_214 = - V_114 ;
struct V_215 * V_216 , * V_196 ;
struct V_217 * V_218 = V_204 -> V_60 . V_219 ;
struct V_6 * V_7 = F_128 ( & V_204 -> V_60 , sizeof( * V_7 ) ,
V_220 ) ;
if ( ! V_7 )
return - V_90 ;
if ( F_129 ( V_218 , L_8 ) ) {
...
V_7 -> V_41 = V_225 ;
V_7 -> V_226 = V_227 ;
V_7 -> V_228 = F_130 ( V_227 ) ;
V_7 -> V_229 = V_230 ;
V_7 -> V_231 = F_130 ( V_230 ) ;
} else if ( F_129 ( V_218 , L_9 ) ) {
V_7 -> V_221 = V_232 ;
V_7 -> V_17 = V_233 ;
V_7 -> V_19 = V_234 ;
V_7 -> V_41 = V_235 ;
V_7 -> V_226 = V_236 ;
V_7 -> V_228 = F_130 ( V_236 ) ;
} else {
return - V_114 ;
}
V_7 -> V_237 = F_131 ( & V_204 -> V_60 ) ;
V_216 = F_132 ( V_204 , V_238 , 0 ) ;
V_7 -> V_9 = F_133 ( & V_204 -> V_60 , V_216 ) ;
if ( F_66 ( V_7 -> V_9 ) )
return F_67 ( V_7 -> V_9 ) ;
V_196 = F_132 ( V_204 , V_239 , 0 ) ;
if ( ! V_196 ) {
F_14 ( & V_204 -> V_60 , L_10 ) ;
return - V_240 ;
}
if ( F_134 ( & V_204 -> V_60 , V_196 -> V_241 , F_109 , 0 ,
V_7 -> V_237 , V_7 ) ) {
F_14 ( V_7 -> V_60 , L_11 ) ;
return - V_157 ;
}
V_7 -> V_60 = & V_204 -> V_60 ;
V_7 -> V_16 = V_7 -> V_9 + V_242 ;
V_7 -> V_18 = V_7 -> V_9 + V_243 ;
V_7 -> V_63 = F_135 ( V_7 -> V_237 , V_7 -> V_60 ,
V_61 * sizeof( struct V_45 ) , 8 , V_244 ) ;
if ( ! V_7 -> V_63 )
return - V_90 ;
F_136 ( & V_7 -> V_158 ) ;
V_7 -> V_205 = F_137 ( & V_204 -> V_60 , L_12 ) ;
if ( F_66 ( V_7 -> V_205 ) ) {
F_138 ( & V_204 -> V_60 , L_13 ) ;
F_139 ( & V_204 -> V_60 , & V_245 ) ;
return F_67 ( V_7 -> V_205 ) ;
}
if ( F_140 ( V_7 -> V_205 ) ) {
F_138 ( & V_204 -> V_60 , L_14 ) ;
F_141 ( V_7 -> V_205 ) ;
return - V_195 ;
}
V_83 = F_142 ( & V_204 -> V_60 , & V_245 ) ;
if ( V_83 ) {
F_143 ( V_7 -> V_205 ) ;
F_141 ( V_7 -> V_205 ) ;
return V_83 ;
...
F_8 ( V_246 | V_247 ,
V_7 -> V_9 + V_248 ) ;
F_144 ( & V_7 -> V_148 , F_110 ,
( unsigned long ) V_7 ) ;
F_145 ( & V_7 -> V_152 ) ;
F_145 ( & V_7 -> V_185 ) ;
F_145 ( & V_7 -> V_155 ) ;
V_7 -> V_153 = 0 ;
F_146 ( & V_7 -> V_127 , F_111 ,
( unsigned long ) V_7 ) ;
F_147 ( V_204 , V_7 ) ;
F_145 ( & V_7 -> V_249 ) ;
for ( V_58 = 0 ; V_58 < V_7 -> V_228 ; ++ V_58 ) {
V_7 -> V_226 [ V_58 ] . V_7 = V_7 ;
V_83 = F_148 ( & V_7 -> V_226 [ V_58 ] . V_3 ) ;
if ( ! V_83 ) {
F_61 ( & V_7 -> V_226 [ V_58 ] . V_250 ,
& V_7 -> V_249 ) ;
V_214 = 0 ;
}
if ( V_83 )
F_14 ( V_7 -> V_60 , L_15 ,
V_7 -> V_226 [ V_58 ] . V_3 . V_161 ) ;
else
F_149 ( V_7 -> V_60 , L_16 ,
V_7 -> V_226 [ V_58 ] . V_3 . V_161 ) ;
}
F_145 ( & V_7 -> V_251 ) ;
for ( V_58 = 0 ; V_58 < V_7 -> V_231 ; ++ V_58 ) {
V_7 -> V_229 [ V_58 ] . V_7 = V_7 ;
V_83 = F_150 ( & V_7 -> V_229 [ V_58 ] . V_3 ) ;
if ( ! V_83 ) {
F_61 ( & V_7 -> V_229 [ V_58 ] . V_250 ,
& V_7 -> V_251 ) ;
V_214 = 0 ;
}
if ( V_83 )
F_14 ( V_7 -> V_60 , L_15 ,
V_7 -> V_229 [ V_58 ] . V_3 . V_91 . V_161 ) ;
else
F_149 ( V_7 -> V_60 , L_16 ,
V_7 -> V_229 [ V_58 ] . V_3 . V_91 . V_161 ) ;
}
...
{
struct V_4 * V_68 , * V_252 ;
struct V_1 * V_3 , * V_253 ;
struct V_6 * V_7 = F_118 ( V_204 ) ;
F_152 ( & V_7 -> V_148 ) ;
F_139 ( & V_204 -> V_60 , & V_245 ) ;
F_114 (aead, an, &engine->registered_aeads, entry) {
F_115 ( & V_68 -> V_250 ) ;
F_153 ( & V_68 -> V_3 ) ;
}
F_114 (alg, next, &engine->registered_algs, entry) {
F_115 ( & V_3 -> V_250 ) ;
F_154 ( & V_3 -> V_3 ) ;
}
F_143 ( V_7 -> V_205 ) ;
