...
V_71 . V_80 =
F_8 ( V_41 -> V_81 -> V_82 [ V_75 ] -> V_83 ) ;
V_71 . V_84 = 1 ;
V_71 . V_85 = F_8 ( V_41 -> V_86 ) ;
V_71 . V_87 = F_14 ( V_73 -> V_88 , V_73 -> V_89 ) ;
V_71 . V_90 = V_41 -> V_91 ;
V_71 . V_92 =
F_15 ( ( V_93 ) V_41 -> V_81 -> V_94 [ V_75 ] ) ;
F_13 ( V_71 . V_95 , V_73 -> V_96 ) ;
...
int F_16 ( struct V_1 * V_97 , int V_98 )
{
struct V_70 * V_41 = & V_97 -> V_41 ;
struct V_33 V_99 ;
struct V_72 * V_73 ;
struct V_12 V_13 ;
struct V_15 V_16 ;
...
memcpy ( V_99 . V_47 . V_34 , V_35 , sizeof( V_35 ) ) ;
V_99 . V_47 . type = V_100 ;
V_99 . V_47 . V_31 = F_7 ( sizeof( V_99 ) ) ;
V_99 . V_47 . V_48 = V_49 ;
if ( V_98 )
V_99 . V_47 . V_50 = 1 ;
memcpy ( V_99 . V_61 . V_51 , V_52 , sizeof( V_52 ) ) ;
memcpy ( & V_99 . V_61 . V_62 , & V_73 -> V_55 -> V_62 [ V_73 -> V_56 - 1 ] ,
V_63 ) ;
memcpy ( & V_99 . V_61 . V_64 , V_73 -> V_55 -> V_64 [ V_73 -> V_56 - 1 ] , V_65 ) ;
F_13 ( V_99 . V_77 , V_73 -> V_78 -> V_79 ) ;
V_99 . V_80 =
F_8 ( V_41 -> V_81 -> V_82 [ V_75 ] -> V_83 ) ;
V_99 . V_84 = 1 ;
V_99 . V_85 = F_8 ( V_41 -> V_86 ) ;
V_99 . V_87 = V_73 -> V_88 ;
V_99 . V_90 = V_41 -> V_91 ,
V_99 . V_92 =
F_15 ( ( V_93 ) V_41 -> V_81 -> V_94 [ V_75 ] ) ;
F_13 ( V_99 . V_95 , V_73 -> V_96 ) ;
memcpy ( V_99 . V_53 . V_34 , V_35 , sizeof( V_35 ) ) ;
memset ( & V_13 , 0 , sizeof( V_13 ) ) ;
V_16 . V_20 = & V_99 ;
