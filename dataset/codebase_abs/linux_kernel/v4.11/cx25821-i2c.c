...
int F_20 ( struct V_3 * V_4 , T_2 V_22 , int * V_56 )
{
struct V_48 * V_57 = & V_4 -> V_48 ;
int V_58 = 0 ;
T_3 V_16 [ 2 ] = { 0 , 0 } ;
T_3 V_26 [ 4 ] = { 0 , 0 , 0 , 0 } ;
struct V_12 V_35 [ 2 ] = {
...
V_35 [ 0 ] . V_16 = 0x44 ;
V_35 [ 1 ] . V_16 = 0x44 ;
F_12 ( V_57 -> V_54 , V_35 , 2 ) ;
V_58 = ( V_26 [ 3 ] << 24 ) | ( V_26 [ 2 ] << 16 ) | ( V_26 [ 1 ] << 8 ) | V_26 [ 0 ] ;
* V_56 = V_58 ;
return V_58 ;
}
int F_21 ( struct V_3 * V_4 , T_2 V_22 , int V_56 )
{
struct V_48 * V_57 = & V_4 -> V_48 ;
int V_18 = 0 ;
