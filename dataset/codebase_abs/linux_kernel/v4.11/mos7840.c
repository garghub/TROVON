...
V_117 -> V_190 . V_191 , F_81 ( V_117 -> V_190 . V_192 ) ) ;
...
switch ( V_227 ) {
case V_229 :
F_2 ( & V_2 -> V_6 , L_81 , V_20 ) ;
return F_82 ( V_117 , V_228 ) ;
case V_230 :
F_2 ( & V_2 -> V_6 , L_82 , V_20 ) ;
return F_84 ( V_25 , V_228 ) ;
case V_231 :
F_2 ( & V_2 -> V_6 , L_83 , V_20 ) ;
break;
default:
break;
}
...
static int F_87 ( struct V_92 * V_7 ,
const struct V_238 * V_239 )
{
T_5 V_240 = F_88 ( V_7 -> V_6 -> V_241 . V_242 ) ;
T_2 * V_12 ;
int V_243 ;
if ( V_240 == V_244 ||
V_240 == V_245 ) {
...
F_8 ( V_12 ) ;
V_19:
F_90 ( V_7 , ( void * ) ( unsigned long ) V_243 ) ;
return 0 ;
}
static int F_91 ( struct V_92 * V_7 )
{
int V_243 = ( unsigned long ) F_92 ( V_7 ) ;
int V_247 ;
V_247 = ( V_243 >> 4 ) & 0x000F ;
return V_247 ;
}
static int F_93 ( struct V_92 * V_7 )
{
if ( V_7 -> V_248 < V_7 -> V_21 ||
V_7 -> V_249 < V_7 -> V_21 ||
V_7 -> V_250 < 1 ) {
F_35 ( & V_7 -> V_251 -> V_6 , L_84 ) ;
return - V_121 ;
}
return 0 ;
}
...
T_1 V_93 ;
V_252 = V_2 -> V_22 ;
F_2 ( & V_2 -> V_6 , L_85 , V_252 ) ;
V_25 = F_89 ( sizeof( struct V_24 ) , V_14 ) ;
if ( ! V_25 )
return - V_15 ;
V_25 -> V_2 = V_2 ;
F_12 ( V_2 , V_25 ) ;
F_95 ( & V_25 -> V_112 ) ;
V_25 -> V_61 = V_252 + 1 ;
F_2 ( & V_2 -> V_6 , L_86 , V_2 -> V_139 ) ;
F_2 ( & V_2 -> V_6 , L_87 , V_25 -> V_61 ) ;
if ( V_25 -> V_61 == 1 ) {
V_25 -> V_26 = 0x0 ;
V_25 -> V_27 = 0x1 ;
V_25 -> V_28 = 0x4 ;
...
F_2 ( & V_2 -> V_6 , L_101 , V_54 ) ;
V_93 = 0x00 ;
V_54 = F_9 ( V_2 , V_255 , V_93 ) ;
if ( V_54 < 0 ) {
F_2 ( & V_2 -> V_6 , L_102 , V_54 ) ;
goto V_19;
} else
F_2 ( & V_2 -> V_6 , L_103 , V_54 ) ;
...
if ( V_54 < 0 ) {
F_2 ( & V_2 -> V_6 , L_105 , V_252 + 2 , V_54 ) ;
goto V_19;
} else
F_2 ( & V_2 -> V_6 , L_106 , V_252 + 2 , V_54 ) ;
} else {
V_93 = 0xff ;
V_54 = F_1 ( V_2 ,
( T_1 ) ( V_256 +
...
if ( V_54 < 0 ) {
F_2 ( & V_2 -> V_6 , L_105 , V_252 + 1 , V_54 ) ;
goto V_19;
} else
F_2 ( & V_2 -> V_6 , L_106 , V_252 + 1 , V_54 ) ;
}
