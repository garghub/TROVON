...
return - V_20 ;
V_81 = & V_6 -> V_82 ;
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_43 , V_81 -> V_83 ) ;
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_44 , V_81 -> V_84 ) ;
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_45 ) ;
for ( V_76 = 0 ; V_76 < 4 ; V_76 ++ )
V_14 += F_3 ( V_16 + V_14 , V_15 - V_14 , L_46 , V_85 [ V_76 ] , V_6 -> V_86 [ V_76 ] ) ;
if ( V_14 < V_15 )
V_16 [ V_14 ++ ] = '\n' ;
V_17 = F_8 ( V_2 , V_3 , V_4 , V_16 , V_14 ) ;
F_9 ( V_16 ) ;
...
void F_25 ( struct V_87 * V_51 ,
struct V_88 * V_89 ,
struct V_49 * V_21 ,
struct V_90 * V_91 )
{
struct V_5 * V_6 = (struct V_5 * ) V_21 -> V_53 ;
F_26 ( L_47 , V_92 , V_91 , V_6 , & V_93 ) ;
F_26 ( L_48 , V_92 , V_91 , V_6 , & V_94 ) ;
F_26 ( L_49 , V_92 , V_91 , V_6 , & V_95 ) ;
}
