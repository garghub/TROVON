...
static int F_12 ( struct V_25 * V_26 , enum V_16 type , T_1 V_17 )
{
...
static int F_14 ( struct V_25 * V_26 , struct V_18 * V_28 )
{
int V_14 = 0 ;
enum V_29 V_30 ;
switch ( V_28 -> type ) {
...
break;
case V_33 :
V_14 = F_16 ( & V_26 -> V_32 , V_28 -> V_22 , & V_30 ) ;
break;
}
return V_14 ;
}
...
static int F_20 ( int V_35 , int V_36 )
{
...
{
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
F_24 ( V_26 ) ;
}
...
static int F_26 ( struct V_37 * V_38 , T_1 * V_39 )
{
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
...
static int F_27 ( struct V_37 * V_38 , T_1 V_17 ,
T_3 * V_23 )
{
int V_14 ;
unsigned V_44 ;
...
static int F_31 ( struct V_37 * V_38 , T_1 V_17 ,
T_3 V_39 )
{
int V_14 , V_36 ;
enum V_29 V_30 ;
...
F_17 ( V_26 ) ;
V_14 = F_32 ( & V_26 -> V_32 , V_17 , V_39 , & V_30 ) ;
V_36 = F_19 ( V_26 ) ;
return F_20 ( V_14 , V_36 ) ;
}
...
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
if ( F_21 ( V_26 ) )
V_14 = F_12 ( V_26 , V_33 , V_17 ) ;
else {
F_17 ( V_26 ) ;
V_14 = F_16 ( & V_26 -> V_32 , V_17 , & V_30 ) ;
V_36 = F_19 ( V_26 ) ;
}
return F_20 ( V_14 , V_36 ) ;
}
static int F_35 ( struct V_37 * V_38 , T_1 * V_17 )
{
int V_14 , V_36 = 0 ;
enum V_29 V_30 ;
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
V_14 = F_36 ( & V_26 -> V_41 , V_26 -> V_11 , V_26 -> V_41 . V_40 , V_17 ) ;
if ( V_14 )
return V_14 ;
V_26 -> V_11 = * V_17 + 1 ;
if ( F_21 ( V_26 ) )
...
static int F_37 ( struct V_37 * V_38 , T_1 * V_17 )
{
T_1 V_39 ;
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
int V_14 = F_35 ( V_38 , V_17 ) ;
if ( V_14 ) {
F_38 ( L_5 ) ;
return V_14 ;
}
...
static int F_42 ( struct V_37 * V_38 , T_4 * V_23 )
{
* V_23 = sizeof( struct V_48 ) ;
return 0 ;
}
static int F_43 ( struct V_37 * V_38 , void * V_49 , T_4 V_50 )
{
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
struct V_48 V_51 ;
V_51 . V_40 = F_44 ( V_26 -> V_32 . V_40 ) ;
V_51 . V_42 = F_44 ( V_26 -> V_32 . V_42 ) ;
V_51 . V_52 = F_44 ( V_26 -> V_32 . V_52 ) ;
V_51 . V_53 = F_44 ( V_26 -> V_32 . V_53 ) ;
if ( V_50 < sizeof( V_51 ) )
return - V_54 ;
...
static int F_46 ( struct V_37 * V_38 , T_1 V_55 )
{
F_13 ( L_7 ) ;
return - V_47 ;
}
...
static int F_48 ( struct V_37 * V_38 , T_1 * V_39 )
{
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
* V_39 = V_26 -> V_32 . V_40 - V_26 -> V_11 ;
return 0 ;
}
static int F_49 ( struct V_37 * V_38 , T_1 V_17 ,
T_3 * V_23 )
{
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
...
{
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
return F_12 ( V_26 , V_31 , V_17 ) ;
}
static int F_54 ( struct V_37 * V_38 , T_1 V_17 )
{
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
return F_12 ( V_26 , V_33 , V_17 ) ;
}
static int F_55 ( struct V_37 * V_38 )
{
return 0 ;
}
static int F_56 ( struct V_37 * V_38 , T_4 * V_23 )
{
F_13 ( L_9 ) ;
return - V_47 ;
}
static int F_57 ( struct V_37 * V_38 , void * V_56 ,
T_4 V_50 )
{
F_13 ( L_10 ) ;
return - V_47 ;
}
static int F_58 ( struct V_37 * V_38 , T_1 V_55 )
{
int V_14 , V_44 ;
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
...
V_14 = F_59 ( & V_26 -> V_32 , V_55 ) ;
if ( V_14 )
goto F_19;
do {
for ( V_44 = V_57 ; ! V_14 && V_44 < V_26 -> V_11 ; V_44 ++ )
V_14 = F_12 ( V_26 , V_31 , V_44 ) ;
if ( V_14 )
goto F_19;
V_57 = V_26 -> V_11 ;
V_14 = F_18 ( V_26 ) ;
...
struct V_37 * F_60 ( void )
{
struct V_25 * V_26 ;
V_26 = F_61 ( sizeof( * V_26 ) , V_61 ) ;
if ( ! V_26 )
return F_62 ( - V_21 ) ;
...
V_14 = F_64 ( & V_26 -> V_32 , V_63 ) ;
if ( ! V_14 ) {
if ( V_40 > V_65 )
V_40 = V_65 ;
V_14 = F_59 ( & V_26 -> V_32 , V_40 ) ;
}
memcpy ( & V_26 -> V_38 , & V_60 , sizeof( V_26 -> V_38 ) ) ;
if ( V_14 )
return V_14 ;
...
int V_14 ;
struct V_25 * V_26 = F_23 ( V_38 , struct V_25 , V_38 ) ;
V_14 = F_66 ( & V_26 -> V_32 , V_63 , V_51 , V_66 ) ;
if ( V_14 )
return V_14 ;
V_26 -> V_11 = 0 ;
V_26 -> V_34 = 0 ;
