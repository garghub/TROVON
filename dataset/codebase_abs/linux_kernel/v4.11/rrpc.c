...
V_152 = F_57 ( V_1 , V_32 , V_26 , V_160 ) ;
switch ( V_152 ) {
case V_145 :
return V_159 ;
case V_148 :
...
static int F_124 ( T_2 V_18 , T_5 V_170 , T_6 * V_171 , void * V_135 )
{
struct V_1 * V_1 = (struct V_1 * ) V_135 ;
struct V_4 * V_5 = V_1 -> V_5 ;
struct V_2 * V_10 = V_1 -> V_22 + V_18 ;
struct V_84 * V_172 = V_1 -> V_17 ;
struct V_39 * V_40 ;
struct V_6 * V_7 ;
T_2 V_20 ;
for ( V_20 = 0 ; V_20 < V_170 ; V_20 ++ ) {
struct V_42 V_173 ;
T_2 V_174 = F_125 ( V_171 [ V_20 ] ) ;
unsigned int V_175 ;
if ( F_80 ( V_174 >= V_5 -> V_176 && V_174 != V_177 ) ) {
F_20 ( L_20 ) ;
F_20 ( L_21 ) ;
return - V_178 ;
}
if ( ! V_174 )
continue;
F_4 ( V_174 , V_1 -> V_115 , & V_175 ) ;
V_173 = F_126 ( V_5 , V_174 ) ;
V_40 = F_82 ( V_1 , V_173 ) ;
if ( ! V_40 ) {
F_20 ( L_22 ,
V_18 + V_20 ) ;
...
V_7 = & V_40 -> V_123 [ V_173 . V_45 . V_49 ] ;
if ( ! V_7 -> V_56 ) {
F_30 ( & V_7 -> V_54 , & V_40 -> V_55 ) ;
V_7 -> V_56 = V_57 ;
V_40 -> V_58 -- ;
}
V_10 [ V_20 ] . V_10 = V_174 ;
V_10 [ V_20 ] . V_7 = V_7 ;
V_172 [ V_175 ] . V_10 = V_18 + V_20 ;
}
return 0 ;
}
...
V_179 = F_130 ( V_5 , V_1 -> V_180 , V_1 -> V_115 ,
F_124 , V_1 ) ;
if ( V_179 ) {
F_20 ( L_23 ) ;
return - V_178 ;
...
if ( ! V_1 -> V_102 )
return - V_31 ;
V_1 -> V_29 = F_137 ( 64 , V_183 ) ;
if ( ! V_1 -> V_29 )
return - V_31 ;
F_138 ( & V_1 -> V_185 . V_12 ) ;
F_139 ( & V_1 -> V_185 . V_186 ) ;
return 0 ;
}
...
int V_20 ;
int V_179 ;
if ( ! V_5 -> V_138 -> V_190 -> V_191 )
return 0 ;
V_189 = V_13 -> V_111 * V_13 -> V_192 ;
V_188 = F_145 ( V_189 , V_147 ) ;
if ( ! V_188 )
return - V_31 ;
V_44 . V_44 = 0 ;
V_44 . V_45 . V_46 = V_40 -> V_47 . V_45 . V_46 ;
V_44 . V_45 . V_48 = V_40 -> V_47 . V_45 . V_48 ;
V_179 = F_146 ( V_5 , V_44 , V_188 ) ;
if ( V_179 ) {
F_20 ( L_26 ) ;
goto V_53;
}
V_189 = F_147 ( V_5 -> V_138 , V_188 , V_189 ) ;
if ( V_189 < 0 )
return V_189 ;
for ( V_20 = 0 ; V_20 < V_189 ; V_20 ++ ) {
if ( V_188 [ V_20 ] == V_193 )
continue;
V_7 = & V_40 -> V_123 [ V_20 ] ;
F_30 ( & V_7 -> V_54 , & V_40 -> V_66 ) ;
...
struct V_187 * V_13 = & V_5 -> V_13 ;
struct V_39 * V_40 ;
int V_20 , V_194 , V_179 = - V_178 ;
if ( V_13 -> V_14 > V_195 * V_196 ) {
F_20 ( L_27 ) ;
return - V_178 ;
}
F_138 ( & V_1 -> V_9 ) ;
...
F_139 ( & V_40 -> V_55 ) ;
F_139 ( & V_40 -> V_66 ) ;
for ( V_194 = 0 ; V_194 < V_13 -> V_111 ; V_194 ++ ) {
struct V_6 * V_7 = & V_40 -> V_123 [ V_194 ] ;
V_7 -> V_41 = V_194 ;
V_7 -> V_40 = V_40 ;
V_7 -> V_56 = V_193 ;
F_139 ( & V_7 -> V_104 ) ;
...
static int F_151 ( struct V_1 * V_1 , T_1 * V_197 )
{
struct V_4 * V_5 = V_1 -> V_5 ;
T_1 V_198 = V_1 -> V_115 * V_5 -> V_13 . V_153 ;
int V_179 ;
V_198 >>= 9 ;
V_179 = F_152 ( V_5 , V_197 , V_198 ) ;
if ( ! V_179 )
* V_197 >>= ( F_153 ( V_5 -> V_13 . V_153 ) - 9 ) ;
return V_179 ;
}
static void F_154 ( struct V_1 * V_1 )
{
struct V_4 * V_5 = V_1 -> V_5 ;
T_1 V_197 = V_1 -> V_180 << ( F_153 ( V_5 -> V_13 . V_153 ) - 9 ) ;
F_155 ( V_5 , V_197 ) ;
}
...
static T_1 F_160 ( void * V_135 )
{
struct V_1 * V_1 = V_135 ;
struct V_4 * V_5 = V_1 -> V_5 ;
T_1 V_199 , V_200 ;
V_199 = V_1 -> V_67 * V_5 -> V_13 . V_14 * 4 ;
V_200 = V_1 -> V_115 - V_199 ;
if ( V_199 > V_1 -> V_115 ) {
F_20 ( L_28 ) ;
return 0 ;
}
...
int V_201 ;
struct V_2 * V_24 ;
T_2 V_202 , V_43 , V_203 ;
V_202 = F_23 ( V_1 , V_7 ) ;
for ( V_201 = 0 ; V_201 < V_5 -> V_13 . V_14 ; V_201 ++ ) {
V_43 = V_202 + V_201 ;
V_203 = V_1 -> V_17 [ V_43 ] . V_10 ;
if ( V_203 == V_11 )
continue;
V_24 = & V_1 -> V_22 [ V_203 ] ;
if ( V_43 == V_24 -> V_10 ) {
...
struct V_6 * V_7 ;
int V_204 , V_205 ;
for ( V_204 = 0 ; V_204 < V_1 -> V_67 ; V_204 ++ ) {
V_40 = & V_1 -> V_68 [ V_204 ] ;
for ( V_205 = 0 ; V_205 < V_5 -> V_13 . V_111 ;
V_205 ++ ) {
V_7 = & V_40 -> V_123 [ V_205 ] ;
F_162 ( V_1 , V_7 ) ;
}
}
return 0 ;
...
static void * F_166 ( struct V_4 * V_5 , struct V_206 * V_207 )
{
struct V_82 * V_208 = V_5 -> V_83 ;
struct V_82 * V_209 = V_207 -> V_167 ;
struct V_187 * V_13 = & V_5 -> V_13 ;
struct V_1 * V_1 ;
T_1 V_180 ;
int V_179 ;
if ( ! ( V_5 -> V_210 . V_211 & V_212 ) ) {
F_20 ( L_29 ,
V_5 -> V_210 . V_211 ) ;
return F_11 ( - V_178 ) ;
}
V_1 = F_167 ( sizeof( struct V_1 ) , V_147 ) ;
if ( ! V_1 )
return F_11 ( - V_31 ) ;
V_1 -> V_5 = V_5 ;
V_1 -> V_166 = V_207 ;
...
V_1 -> V_67 = V_13 -> V_67 ;
V_1 -> V_115 = ( unsigned long long ) V_13 -> V_213 * V_1 -> V_67 ;
F_33 ( & V_1 -> V_72 , - 1 ) ;
V_179 = F_151 ( V_1 , & V_180 ) ;
if ( V_179 < 0 ) {
F_20 ( L_30 ) ;
return F_11 ( V_179 ) ;
}
V_1 -> V_180 = V_180 ;
V_179 = F_149 ( V_1 , V_5 -> V_68 ) ;
if ( V_179 ) {
F_20 ( L_31 ) ;
goto V_152;
}
...
F_168 ( V_209 , F_169 ( V_208 ) ) ;
F_170 ( V_209 , F_171 ( V_208 ) ) ;
F_172 ( L_37 ,
