...
V_138 -> V_143 = 16 ;
if ( V_154 ) {
V_15 = F_69 ( V_4 , 1 , V_138 , NULL , & V_162 ) ;
...
F_87 ( & V_2 -> V_16 . V_17 , V_175 ) ;
}
}
void F_88 ( struct V_3 * V_4 )
{
struct V_1 * V_2 = V_4 -> V_2 ;
bool V_176 = ! F_23 ( & V_2 -> V_16 . V_17 ) ;
if ( V_176 ) {
if ( V_2 -> V_171 . V_172 ) {
F_83 ( V_2 , true ) ;
} else {
...
{
F_87 ( & V_4 -> V_2 -> V_16 . V_17 , V_175 ) ;
}
int F_90 ( struct V_3 * V_4 , long V_179 )
{
struct V_86 * V_87 ;
long V_15 ;
