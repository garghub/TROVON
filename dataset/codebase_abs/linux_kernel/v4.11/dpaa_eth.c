...
static int F_222 ( struct V_6 * V_7 , struct V_421 * V_422 , int V_318 )
{
if ( ! V_7 -> V_54 )
return - V_77 ;
return F_223 ( V_7 -> V_54 , V_422 , V_318 ) ;
}
...
F_4 (cpu) {
V_17 = F_5 ( V_12 -> V_17 , V_142 ) ;
F_227 ( & V_17 -> V_396 . V_393 ) ;
}
}
static inline void F_228 ( const struct V_91 * V_103 ,
struct V_106 * V_107 )
{
T_6 V_22 = F_229 ( V_107 ) ;
F_124 ( V_103 -> V_14 , V_22 , V_103 -> V_96 , V_263 ) ;
F_152 ( F_122 ( V_22 ) ) ;
}
static struct V_91 * F_230 ( struct V_13 * V_14 )
{
struct V_91 * V_91 ;
...
return F_25 ( - V_135 ) ;
V_91 -> V_92 = V_99 ;
V_91 -> V_327 = F_231 ( V_14 , * V_91 -> V_327 ) ;
V_91 -> V_97 = V_331 ;
V_91 -> V_101 = F_144 ;
V_91 -> V_108 = F_228 ;
return V_91 ;
}
static int F_232 ( struct V_11 * V_12 )
{
struct V_151 V_152 ;
T_4 V_153 ;
int V_19 ;
...
static inline T_3 F_233 ( struct V_227 * V_425 )
{
T_3 V_426 ;
V_426 = ( T_3 ) ( V_425 -> V_233 + V_427 +
V_428 + V_429 ) ;
return V_238 ? F_234 ( V_426 ,
V_238 ) :
V_426 ;
}
static int F_235 ( struct V_66 * V_67 )
{
...
V_7 -> V_435 = F_91 ( F_6 () , V_436 ) ;
F_242 ( V_7 , L_47 ,
V_7 -> V_435 ) ;
V_12 -> V_228 [ V_252 ] . V_233 = V_437 ;
V_12 -> V_228 [ V_254 ] . V_233 = V_355 ;
F_243 ( V_14 , 0 , 0 , NULL , false ) ;
V_19 = F_244 ( V_14 , F_245 ( 40 ) ) ;
if ( V_19 ) {
F_10 ( V_14 , L_48 ) ;
goto V_438;
}
for ( V_5 = 0 ; V_5 < V_109 ; V_5 ++ ) {
int V_19 ;
V_110 [ V_5 ] = F_230 ( V_14 ) ;
if ( F_240 ( V_110 [ V_5 ] ) )
return F_241 ( V_110 [ V_5 ] ) ;
V_110 [ V_5 ] -> V_322 = F_1 ( V_5 , V_109 ) ;
V_110 [ V_5 ] -> V_96 = F_246 ( V_110 [ V_5 ] -> V_322 ) ;
V_110 [ V_5 ] -> V_14 = V_14 ;
V_19 = F_39 ( V_110 [ V_5 ] ) ;
if ( V_19 < 0 ) {
F_48 ( V_12 ) ;
...
V_19 = F_54 ( V_14 , & V_12 -> V_440 , & V_128 ) ;
if ( V_19 < 0 ) {
F_10 ( V_14 , L_49 ) ;
goto V_441;
}
...
V_12 -> V_48 = F_233 ( & V_12 -> V_228 [ V_254 ] ) ;
V_12 -> V_340 = F_233 ( & V_12 -> V_228 [ V_252 ] ) ;
F_110 ( V_21 , V_110 , V_109 , & V_128 ,
& V_12 -> V_228 [ 0 ] , V_14 ) ;
V_12 -> V_17 = F_231 ( V_14 , * V_12 -> V_17 ) ;
if ( ! V_12 -> V_17 ) {
F_10 ( V_14 , L_53 ) ;
V_19 = - V_135 ;
goto V_445;
...
F_226 ( V_7 ) ;
V_445:
F_103 ( V_14 , & V_12 -> V_440 ) ;
V_129:
F_250 ( & V_12 -> V_216 ) ;
F_76 ( V_12 -> V_216 . V_154 ) ;
V_444:
F_250 ( & V_12 -> V_147 . V_145 ) ;
F_76 ( V_12 -> V_147 . V_145 . V_154 ) ;
V_443:
V_442:
F_48 ( V_12 ) ;
...
if ( F_252 ( & V_110 [ V_5 ] -> V_95 ) == 0 )
F_253 ( V_14 , V_110 [ V_5 ] ) ;
}
return V_19 ;
}
static int F_254 ( struct V_66 * V_67 )
{
struct V_6 * V_7 ;
struct V_11 * V_12 ;
struct V_13 * V_14 ;
