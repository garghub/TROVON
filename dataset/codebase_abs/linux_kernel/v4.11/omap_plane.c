...
struct V_54 * V_55 )
{
struct V_56 * V_44 = V_6 -> V_44 ;
struct V_57 * V_58 = V_44 -> V_59 ;
if ( V_58 -> V_60 ) {
if ( ! V_6 -> V_61 )
F_27 ( V_6 ,
V_45 ,
...
V_63 | V_64 |
V_65 | V_66 ) ;
if ( V_6 -> V_61 && V_55 != & V_6 -> V_4 )
F_28 ( V_55 , V_6 -> V_61 ,
V_45 ) ;
}
F_28 ( V_55 , V_58 -> V_67 , 0 ) ;
}
static struct V_2 *
F_29 ( struct V_5 * V_6 )
{
...
T_1 V_72 )
{
struct V_57 * V_58 = V_6 -> V_44 -> V_59 ;
struct V_1 * V_11 = F_1 ( V_3 ) ;
if ( V_71 == V_58 -> V_67 )
V_11 -> V_25 = V_72 ;
else
...
struct V_5 * F_38 ( struct V_56 * V_44 ,
int V_43 , enum V_73 type ,
T_2 V_74 )
{
struct V_5 * V_6 ;
struct V_10 * V_10 ;
int V_16 ;
F_9 ( L_6 , V_75 [ V_43 ] , type ) ;
V_10 = F_35 ( sizeof( * V_10 ) , V_69 ) ;
if ( ! V_10 )
return F_39 ( - V_76 ) ;
V_10 -> V_77 = F_40 (
V_10 -> V_78 , F_41 ( V_10 -> V_78 ) ,
F_42 ( V_43 ) ) ;
V_10 -> V_43 = V_43 ;
V_10 -> V_17 = V_75 [ V_43 ] ;
V_6 = & V_10 -> V_4 ;
V_16 = F_43 ( V_44 , V_6 , V_74 ,
& V_79 , V_10 -> V_78 ,
V_10 -> V_77 , type , NULL ) ;
if ( V_16 < 0 )
goto error;
