...
( (struct V_243 * ) V_211 -> V_243 ) -> V_242 ) ;
type = L_39 ;
for ( V_48 = 0 ; V_48 < V_211 -> V_34 ; V_48 ++ ) {
struct V_28 * V_244 = & V_211 -> V_29 [ V_48 ] ;
if ( V_244 -> type == V_39 &&
( V_244 -> V_23 & V_245 ) == V_141 &&
( V_244 -> V_23 & 0xffff ) < F_80 ( V_227 ) ) {
type = V_227 [ V_244 -> V_23 & 0xffff ] ;
break;
}
}
switch ( V_211 -> V_213 ) {
...
V_104 = F_81 ( & V_211 -> V_103 , & V_248 ) ;
if ( V_104 )
F_21 ( V_211 ,
L_57 , V_104 ) ;
F_82 ( V_211 , L_58 ,
V_152 , V_213 , V_211 -> V_249 >> 8 , V_211 -> V_249 & 0xff ,
type , V_211 -> V_184 , V_211 -> V_250 ) ;
return 0 ;
}
void F_83 ( struct V_2 * V_211 )
{
F_84 ( & V_211 -> V_103 , & V_248 ) ;
if ( V_211 -> V_185 & V_186 )
F_85 ( V_211 ) ;
if ( V_211 -> V_185 & V_187 )
V_211 -> V_251 ( V_211 ) ;
...
static T_5 F_87 ( struct V_252 * V_253 , const char * V_152 ,
T_7 V_95 )
{
struct V_180 * V_181 = F_88 ( V_253 ) ;
struct V_254 * V_255 ;
V_53 V_213 , V_136 , V_138 ;
unsigned long V_256 = 0 ;
int V_104 ;
V_104 = sscanf ( V_152 , L_59 ,
& V_213 , & V_136 , & V_138 , & V_256 ) ;
if ( V_104 < 3 )
return - V_33 ;
V_255 = F_2 ( sizeof( * V_255 ) , V_10 ) ;
if ( ! V_255 )
return - V_36 ;
V_255 -> V_4 . V_213 = V_213 ;
V_255 -> V_4 . V_130 = V_215 ;
V_255 -> V_4 . V_136 = V_136 ;
V_255 -> V_4 . V_138 = V_138 ;
V_255 -> V_4 . V_256 = V_256 ;
F_89 ( & V_181 -> V_257 ) ;
F_3 ( & V_255 -> V_13 , & V_181 -> V_258 ) ;
F_90 ( & V_181 -> V_257 ) ;
...
if ( F_71 ( V_211 , & V_255 -> V_4 ) ) {
F_90 ( & V_181 -> V_257 ) ;
return & V_255 -> V_4 ;
}
}
F_90 ( & V_181 -> V_257 ) ;
return F_72 ( V_211 , V_181 -> V_259 ) ;
}
static int F_97 ( struct V_3 * V_103 , struct V_252 * V_253 )
{
struct V_180 * V_181 = F_88 ( V_253 ) ;
struct V_2 * V_211 = F_28 ( V_103 ) ;
...
V_211 -> V_169 = V_181 ;
if ( V_181 -> V_264 ) {
V_104 = V_181 -> V_264 ( V_211 , V_4 ) ;
} else {
V_104 = F_40 ( V_211 ) ;
if ( ! V_104 )
V_104 = F_100 ( V_211 , V_265 ) ;
}
if ( V_104 ) {
F_25 ( V_211 ) ;
V_211 -> V_169 = NULL ;
...
return F_105 ( V_152 , V_266 , L_60 ,
V_211 -> V_213 , V_211 -> V_130 , V_211 -> V_136 , V_211 -> V_138 ) ;
}
static int F_106 ( struct V_3 * V_103 , struct V_267 * V_268 )
{
struct V_2 * V_211 = F_28 ( V_103 ) ;
if ( F_107 ( V_268 , L_61 ,
V_211 -> V_213 , V_211 -> V_136 , V_211 -> V_138 ) )
return - V_36 ;
if ( F_107 ( V_268 , L_62 , V_211 -> V_184 ) )
return - V_36 ;
if ( F_107 ( V_268 , L_63 , V_211 -> V_250 ) )
return - V_36 ;
if ( F_107 ( V_268 , L_64 , V_211 -> V_269 ) )
return - V_36 ;
if ( F_107 ( V_268 , L_65 ,
V_211 -> V_213 , V_211 -> V_130 , V_211 -> V_136 , V_211 -> V_138 ) )
return - V_36 ;
...
{
if ( V_211 -> V_228 & V_270 )
return false ;
if ( V_211 -> V_228 & V_271 )
return true ;
switch ( V_211 -> V_136 ) {
case V_272 :
if ( V_211 -> V_138 >= V_273 &&
V_211 -> V_138 <= V_274 )
return true ;
break;
case V_275 :
if ( V_211 -> V_138 >= V_276 &&
V_211 -> V_138 <= V_277 )
return true ;
if ( V_211 -> V_138 == V_278 &&
! strcmp ( V_211 -> V_184 , L_66 ) )
return true ;
break;
case V_279 :
if ( V_211 -> V_138 >= V_280 &&
V_211 -> V_138 <= V_281 )
return true ;
break;
case V_282 :
if ( V_211 -> V_138 >= V_283 &&
V_211 -> V_138 <= V_284 )
return true ;
break;
case V_285 :
if ( V_211 -> V_138 == V_286 &&
V_211 -> type == V_287 )
return true ;
break;
case V_288 :
if ( ( V_211 -> V_138 >= V_289 &&
V_211 -> V_138 <= V_290 ) ||
( V_211 -> V_138 >= V_291 &&
V_211 -> V_138 <= V_292 ) )
return true ;
...
F_72 ( V_211 , V_296 ) )
return true ;
return ! ! F_72 ( V_211 , V_297 ) ;
}
int F_109 ( struct V_2 * V_211 )
{
static T_8 V_4 = F_110 ( 0 ) ;
int V_104 ;
if ( F_48 ( V_211 -> V_116 & V_298 ) )
return - V_208 ;
if ( F_108 ( V_211 ) )
return - V_206 ;
...
return F_117 ( V_104 ) ;
F_118 ( & V_211 -> V_103 ) ;
V_211 -> V_103 . V_302 = F_27 ;
V_211 -> V_103 . V_213 = & V_303 ;
F_119 ( & V_211 -> V_103 ) ;
F_25 ( V_211 ) ;
F_120 ( & V_211 -> V_304 ) ;
F_26 ( & V_211 -> V_182 ) ;
...
int F_127 ( struct V_180 * V_181 , struct V_306 * V_307 ,
const char * V_308 )
{
int V_104 ;
V_181 -> V_169 . V_184 = V_181 -> V_184 ;
V_181 -> V_169 . V_213 = & V_303 ;
V_181 -> V_169 . V_307 = V_307 ;
...
for ( V_48 = 0 ; V_48 < F_134 ( V_312 ) ; V_48 ++ )
if ( V_311 -> V_313 -> V_314 [ V_48 ] )
return 1 ;
}
return 0 ;
}
