...
if ( ( V_34 -> V_10 -> V_38 != V_36 -> V_38 ) && V_36 -> V_38 ) {
struct V_39 * V_40 = F_30 ( V_36 -> V_38 , 0 ) ;
struct V_41 * V_42 = F_31 ( V_40 ) ;
struct V_43 * V_44 = F_32 ( V_42 -> V_45 ) ;
F_33 ( V_36 , V_44 ) ;
}
}
...
F_34 ( V_10 , true ) ;
if ( F_35 ( V_10 ) -> V_10 )
V_2 -> V_24 -> V_27 -> V_46 ( V_2 -> V_24 , V_10 ) ;
F_36 ( V_10 ) ;
if ( V_32 ) {
F_37 ( V_2 -> V_47 , & V_11 -> V_14 ) ;
return 0 ;
}
F_15 ( V_11 , false ) ;
return 0 ;
...
struct V_9 * F_38 ( struct V_17 * V_13 )
{
struct V_48 * V_10 = F_9 ( sizeof( * V_10 ) , V_12 ) ;
if ( ! V_10 || F_39 ( V_13 , & V_10 -> V_49 ) < 0 ) {
F_12 ( V_10 ) ;
return NULL ;
}
return & V_10 -> V_49 ;
}
void F_40 ( struct V_9 * V_50 )
{
struct V_48 * V_10 = F_35 ( V_50 ) ;
F_41 ( & V_10 -> V_49 ) ;
F_12 ( V_10 -> V_10 ) ;
V_10 -> V_10 = NULL ;
}
