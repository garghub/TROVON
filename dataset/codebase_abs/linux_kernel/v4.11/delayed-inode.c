...
V_5 -> V_46 ++ ;
F_13 ( & V_5 -> V_7 -> V_45 -> V_40 -> V_66 ) ;
return 0 ;
}
static int F_61 ( struct V_2 * V_25 ,
struct V_16 * V_48 )
{
...
static void F_63 ( struct V_32 * V_40 )
{
int V_67 = F_64 ( & V_40 -> V_68 ) ;
if ( ( F_65 ( & V_40 -> V_66 ) <
V_69 || V_67 % V_70 == 0 ) &&
F_66 ( & V_40 -> V_71 ) )
F_67 ( & V_40 -> V_71 ) ;
}
static void F_68 ( struct V_16 * V_56 )
{
struct V_51 * V_7 ;
struct V_32 * V_40 ;
...
static void F_70 ( struct V_16 * V_48 )
{
if ( V_48 ) {
F_68 ( V_48 ) ;
if ( F_43 ( & V_48 -> V_9 ) )
...
static void F_80 ( struct V_74 * V_45 ,
struct V_16 * V_48 )
{
struct V_75 * V_81 ;
if ( ! V_48 -> V_50 )
...
static void F_85 ( struct V_74 * V_45 ,
struct V_2 * V_25 )
{
struct V_75 * V_81 ;
if ( ! V_25 -> V_50 )
...
F_88 ( V_91 ) ;
V_99 = F_89 ( V_103 , sizeof( struct V_52 ) , V_30 ) ;
if ( ! V_99 ) {
V_28 = - V_4 ;
goto V_43;
}
V_100 = F_89 ( V_103 , sizeof( T_3 ) , V_30 ) ;
if ( ! V_100 ) {
V_28 = - V_4 ;
goto error;
}
...
F_91 ( V_91 , NULL , 0 ) ;
F_92 ( V_7 , V_91 , V_99 , V_100 ,
V_94 , V_95 , V_103 ) ;
V_102 = V_91 -> V_107 [ 0 ] ;
F_93 (curr, next, &head, tree_list) {
V_98 = F_94 ( V_97 , V_102 , char ) ;
F_95 ( V_97 , & V_92 -> V_108 ,
( unsigned long ) V_98 ,
V_92 -> V_47 ) ;
V_102 ++ ;
F_80 ( V_45 , V_92 ) ;
...
static int F_97 ( struct V_72 * V_73 ,
struct V_6 * V_7 ,
struct V_90 * V_91 ,
struct V_16 * V_56 )
{
...
char * V_109 ;
int V_28 ;
V_28 = F_98 ( V_73 , V_7 , V_91 , & V_56 -> V_19 ,
V_56 -> V_47 ) ;
if ( V_28 < 0 && V_28 != - V_31 )
return V_28 ;
V_97 = V_91 -> V_39 [ 0 ] ;
V_109 = F_94 ( V_97 , V_91 -> V_107 [ 0 ] , char ) ;
F_95 ( V_97 , V_56 -> V_108 , ( unsigned long ) V_109 ,
V_56 -> V_47 ) ;
F_99 ( V_97 ) ;
F_80 ( V_45 , V_56 ) ;
return 0 ;
}
static int F_100 ( struct V_72 * V_73 ,
struct V_90 * V_91 ,
struct V_6 * V_7 ,
struct V_2 * V_25 )
{
...
static int F_102 ( struct V_72 * V_73 ,
struct V_6 * V_7 ,
struct V_90 * V_91 ,
struct V_16 * V_48 )
{
...
if ( ! V_103 )
return 0 ;
V_28 = F_105 ( V_73 , V_7 , V_91 , V_91 -> V_107 [ 0 ] , V_103 ) ;
if ( V_28 )
goto V_43;
F_93 (curr, next, &head, tree_list) {
F_80 ( V_45 , V_92 ) ;
...
if ( ! V_92 )
goto V_114;
V_28 = F_107 ( V_73 , V_7 , & V_92 -> V_19 , V_91 , - 1 , 1 ) ;
if ( V_28 < 0 )
goto V_114;
else if ( V_28 > 0 ) {
V_53 = V_92 ;
...
static void F_108 ( struct V_2 * V_5 )
{
struct V_32 * V_40 ;
if ( V_5 &&
F_27 ( V_115 , & V_5 -> V_36 ) ) {
...
V_33 = 1 ;
V_28 = F_111 ( V_73 , V_7 , V_91 , & V_19 , V_33 ) ;
if ( V_28 > 0 ) {
F_101 ( V_91 ) ;
return - V_113 ;
} else if ( V_28 < 0 ) {
...
V_97 = V_91 -> V_39 [ 0 ] ;
V_118 = F_94 ( V_97 , V_91 -> V_107 [ 0 ] ,
struct V_117 ) ;
F_95 ( V_97 , & V_25 -> V_118 , ( unsigned long ) V_118 ,
sizeof( struct V_117 ) ) ;
F_99 ( V_97 ) ;
if ( ! F_27 ( V_116 , & V_25 -> V_36 ) )
goto V_120;
V_91 -> V_107 [ 0 ] ++ ;
if ( V_91 -> V_107 [ 0 ] >= F_103 ( V_97 ) )
goto V_121;
V_29:
F_104 ( V_97 , & V_19 , V_91 -> V_107 [ 0 ] ) ;
...
V_19 . type = V_123 ;
V_19 . V_22 = - 1 ;
V_28 = F_107 ( V_73 , V_7 , & V_19 , V_91 , - 1 , 1 ) ;
if ( V_28 < 0 )
goto V_124;
ASSERT ( V_28 ) ;
V_28 = 0 ;
...
static inline int F_113 ( struct V_72 * V_73 ,
struct V_6 * V_7 ,
struct V_90 * V_91 ,
struct V_2 * V_25 )
{
...
{
int V_28 ;
V_28 = F_100 ( V_73 , V_91 , V_25 -> V_7 , V_25 ) ;
if ( V_28 )
return V_28 ;
V_28 = F_106 ( V_73 , V_91 , V_25 -> V_7 , V_25 ) ;
if ( V_28 )
return V_28 ;
V_28 = F_113 ( V_73 , V_25 -> V_7 , V_91 , V_25 ) ;
return V_28 ;
}
static int F_115 ( struct V_72 * V_73 ,
...
struct V_74 * V_45 )
{
return F_115 ( V_73 , V_45 , - 1 ) ;
}
int F_120 ( struct V_72 * V_73 ,
struct V_74 * V_45 , int V_125 )
{
return F_115 ( V_73 , V_45 , V_125 ) ;
}
...
V_28 = F_114 ( V_73 , V_91 , V_5 ) ;
F_46 ( V_5 ) ;
F_118 ( V_91 ) ;
V_73 -> V_79 = V_79 ;
return V_28 ;
}
int F_122 ( struct V_23 * V_82 )
{
struct V_74 * V_45 = F_123 ( V_82 -> V_130 . V_131 ) ;
struct V_72 * V_73 ;
struct V_2 * V_5 = F_10 ( V_82 ) ;
struct V_90 * V_91 ;
struct V_75 * V_79 ;
...
struct V_75 * V_79 ;
int V_137 = 0 ;
V_136 = F_131 ( V_134 , struct V_135 , V_134 ) ;
V_40 = V_136 -> V_40 ;
V_91 = F_116 () ;
if ( ! V_91 )
goto V_43;
V_29:
if ( F_44 ( & V_40 -> V_66 ) < V_69 / 2 )
goto V_138;
V_5 = F_47 ( V_40 ) ;
if ( ! V_5 )
goto V_138;
...
static int F_133 ( struct V_32 * V_40 ,
struct V_74 * V_45 , int V_125 )
{
struct V_135 * V_136 ;
if ( F_44 ( & V_40 -> V_66 ) < V_69 ||
F_134 ( V_45 -> V_141 ) )
return 0 ;
...
return - V_4 ;
V_136 -> V_40 = V_40 ;
F_135 ( & V_136 -> V_134 , V_142 ,
F_130 , NULL , NULL ) ;
V_136 -> V_125 = V_125 ;
F_136 ( V_45 -> V_141 , & V_136 -> V_134 ) ;
return 0 ;
}
void F_137 ( struct V_74 * V_45 )
{
F_138 ( F_36 ( V_45 -> V_40 ) ) ;
}
static int F_139 ( struct V_32 * V_40 , int V_67 )
{
int V_143 = F_44 ( & V_40 -> V_68 ) ;
...
void F_140 ( struct V_74 * V_45 )
{
struct V_32 * V_40 = V_45 -> V_40 ;
if ( F_44 ( & V_40 -> V_66 ) < V_69 )
return;
if ( F_44 ( & V_40 -> V_66 ) >= V_140 ) {
int V_67 ;
int V_28 ;
V_67 = F_44 ( & V_40 -> V_68 ) ;
V_28 = F_133 ( V_40 , V_45 , 0 ) ;
if ( V_28 )
return;
F_141 ( V_40 -> V_71 ,
F_139 ( V_40 , V_67 ) ) ;
...
V_151 -> V_153 = * V_148 ;
F_143 ( V_151 , V_73 -> V_154 ) ;
F_144 ( V_151 , 0 ) ;
F_145 ( V_151 , V_145 ) ;
F_146 ( V_151 , type ) ;
memcpy ( ( char * ) ( V_151 + 1 ) , V_144 , V_145 ) ;
V_28 = F_76 ( V_73 , V_45 , V_56 ) ;
F_16 ( V_28 ) ;
F_41 ( & V_5 -> V_13 ) ;
V_28 = F_61 ( V_5 , V_56 ) ;
if ( F_147 ( V_28 ) ) {
...
static int F_149 ( struct V_74 * V_45 ,
struct V_2 * V_25 ,
struct V_52 * V_19 )
{
struct V_16 * V_48 ;
...
F_160 ( & V_153 , & V_164 -> V_153 ) ;
V_165 = ! F_161 ( V_163 , V_144 , V_145 ,
V_153 . V_21 , V_166 ) ;
if ( F_43 ( & V_92 -> V_9 ) )
F_71 ( V_92 ) ;
if ( V_165 )
...
static void F_162 ( struct V_72 * V_73 ,
struct V_117 * V_118 ,
struct V_82 * V_82 )
{
F_163 ( V_118 , F_164 ( V_82 ) ) ;
F_165 ( V_118 , F_166 ( V_82 ) ) ;
F_167 ( V_118 , F_153 ( V_82 ) -> V_169 ) ;
F_168 ( V_118 , V_82 -> V_170 ) ;
F_169 ( V_118 , V_82 -> V_171 ) ;
F_170 ( V_118 , F_171 ( V_82 ) ) ;
F_172 ( V_118 ,
F_153 ( V_82 ) -> V_172 ) ;
F_173 ( V_118 , V_82 -> V_173 ) ;
F_174 ( V_118 , V_73 -> V_154 ) ;
F_175 ( V_118 , V_82 -> V_174 ) ;
F_176 ( V_118 , F_153 ( V_82 ) -> V_36 ) ;
F_177 ( V_118 , 0 ) ;
F_178 ( & V_118 -> V_175 ,
V_82 -> V_176 . V_177 ) ;
F_179 ( & V_118 -> V_175 ,
...
V_82 -> V_181 . V_178 ) ;
F_178 ( & V_118 -> V_182 ,
F_153 ( V_82 ) -> V_183 . V_177 ) ;
F_179 ( & V_118 -> V_182 ,
F_153 ( V_82 ) -> V_183 . V_178 ) ;
}
int F_180 ( struct V_82 * V_82 , T_3 * V_184 )
{
struct V_2 * V_5 ;
struct V_117 * V_118 ;
V_5 = F_10 ( F_153 ( V_82 ) ) ;
...
V_118 = & V_5 -> V_118 ;
F_181 ( V_82 , F_182 ( V_118 ) ) ;
F_183 ( V_82 , F_184 ( V_118 ) ) ;
F_185 ( F_153 ( V_82 ) , F_186 ( V_118 ) ) ;
V_82 -> V_170 = F_187 ( V_118 ) ;
F_188 ( V_82 , F_189 ( V_118 ) ) ;
F_190 ( V_82 , F_191 ( V_118 ) ) ;
F_153 ( V_82 ) -> V_172 = F_192 ( V_118 ) ;
F_153 ( V_82 ) -> V_185 = F_193 ( V_118 ) ;
V_82 -> V_173 = F_194 ( V_118 ) ;
V_82 -> V_174 = 0 ;
* V_184 = F_195 ( V_118 ) ;
F_153 ( V_82 ) -> V_36 = F_196 ( V_118 ) ;
V_82 -> V_176 . V_177 = F_197 ( & V_118 -> V_175 ) ;
V_82 -> V_176 . V_178 = F_198 ( & V_118 -> V_175 ) ;
V_82 -> V_180 . V_177 = F_197 ( & V_118 -> V_179 ) ;
V_82 -> V_180 . V_178 = F_198 ( & V_118 -> V_179 ) ;
V_82 -> V_181 . V_177 = F_197 ( & V_118 -> ctime ) ;
V_82 -> V_181 . V_178 = F_198 ( & V_118 -> ctime ) ;
F_153 ( V_82 ) -> V_183 . V_177 =
F_197 ( & V_118 -> V_182 ) ;
F_153 ( V_82 ) -> V_183 . V_178 =
F_198 ( & V_118 -> V_182 ) ;
V_82 -> V_186 = F_153 ( V_82 ) -> V_172 ;
F_153 ( V_82 ) -> V_65 = ( T_2 ) - 1 ;
F_42 ( & V_5 -> V_13 ) ;
F_46 ( V_5 ) ;
return 0 ;
}
int F_199 ( struct V_72 * V_73 ,
...
F_41 ( & V_5 -> V_13 ) ;
if ( F_27 ( V_115 , & V_5 -> V_36 ) ) {
F_162 ( V_73 , & V_5 -> V_118 , V_82 ) ;
goto V_152;
}
V_28 = F_82 ( V_73 , V_7 , F_153 ( V_82 ) ,
V_5 ) ;
if ( V_28 )
goto V_152;
F_162 ( V_73 , & V_5 -> V_118 , V_82 ) ;
F_31 ( V_115 , & V_5 -> V_36 ) ;
V_5 -> V_46 ++ ;
F_13 ( & V_7 -> V_45 -> V_40 -> V_66 ) ;
V_152:
F_42 ( & V_5 -> V_13 ) ;
F_46 ( V_5 ) ;
return V_28 ;
}
int F_200 ( struct V_23 * V_82 )
{
struct V_74 * V_45 = F_123 ( V_82 -> V_130 . V_131 ) ;
struct V_2 * V_5 ;
