...
int F_41 ( struct V_141 * V_142 , struct V_31 * V_32 )
{
struct V_38 * V_73 = V_32 -> V_42 ;
T_1 V_143 = V_142 -> V_144 ;
if ( V_73 -> V_52 ) {
F_42 ( V_142 , L_50 ) ;
F_43 ( V_142 , V_73 -> V_52 , L_51 ) ;
F_44 ( V_142 , ',' ) ;
}
if ( V_73 -> V_53 )
F_42 ( V_142 , L_52 ) ;
if ( V_73 -> V_61 & V_116 )
F_45 ( V_142 , L_53 , & V_73 -> V_34 ) ;
if ( V_73 -> V_61 & V_127 )
F_42 ( V_142 , L_54 ) ;
if ( V_73 -> V_61 & V_130 )
F_42 ( V_142 , L_55 ) ;
...
if ( V_73 -> V_103 != V_104 )
F_45 ( V_142 , L_62 ,
F_46 ( V_73 -> V_103 ) / 1000 ) ;
if ( V_142 -> V_144 != V_143 )
V_142 -> V_144 -- ;
return 0 ;
}
struct V_145 * F_47 ( struct V_31 * V_32 )
{
return & V_32 -> V_50 . V_146 . V_147 ;
}
T_4 F_48 ( struct V_31 * V_32 )
{
return V_32 -> V_58 . V_148 -> V_149 ;
}
...
V_151 ;
if ( F_52 ( V_32 , V_161 ) )
V_152 = & V_32 -> V_42 -> V_113 ;
F_53 ( & V_32 -> V_50 , V_152 ) ;
V_70 = F_54 ( & V_32 -> V_58 , V_32 ) ;
if ( V_70 < 0 )
goto V_162;
V_70 = F_55 ( & V_32 -> V_163 , V_32 ) ;
if ( V_70 < 0 )
goto V_164;
return V_32 ;
V_164:
...
{
return V_32 -> V_58 . V_59 && V_32 -> V_58 . V_59 -> V_166 &&
V_32 -> V_163 . V_167 && V_32 -> V_163 . V_167 -> V_166 ;
}
int F_63 ( struct V_31 * V_32 , unsigned long V_168 )
{
unsigned long V_169 = V_32 -> V_42 -> V_99 ;
long V_70 ;
V_70 = F_64 ( & V_32 -> V_58 ) ;
if ( V_70 < 0 )
return V_70 ;
...
return - V_171 ;
F_17 ( L_65 ) ;
V_70 = F_66 ( V_32 -> V_154 ,
F_62 ( V_32 ) || ( V_32 -> V_155 < 0 ) ,
F_67 ( V_169 ) ) ;
if ( V_70 < 0 )
return V_70 ;
if ( V_32 -> V_155 < 0 )
