...
V_4 = F_45 ( V_2 , V_83 & V_87 ) ;
F_46 ( F_5 ( V_2 ) , & V_5 ) ;
while ( ! ( V_85 = F_40 ( V_2 , V_79 ) ) ) {
F_6 ( V_8 ) ;
if ( ! V_4 ) {
V_25 = - V_88 ;
break;
...
static int F_47 ( struct V_12 * V_1 , struct V_13 * V_90 ,
int * V_24 , int V_91 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
F_48 ( struct V_22 * , V_23 , V_90 ) ;
...
static unsigned int F_51 ( struct V_97 * V_97 , struct V_12 * V_1 ,
T_3 * V_5 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
unsigned int V_98 = 0 ;
F_3 ( L_13 , V_2 ) ;
F_52 ( V_97 , F_5 ( V_2 ) , V_5 ) ;
if ( V_2 -> V_9 == V_51 )
return F_49 ( V_2 ) ;
if ( V_2 -> V_99 || ! F_53 ( & V_2 -> V_100 ) )
V_98 |= V_101 |
( F_54 ( V_2 , V_102 ) ? V_103 : 0 ) ;
if ( ! F_53 ( & V_2 -> V_104 ) )
V_98 |= V_95 | V_96 ;
if ( V_2 -> V_9 == V_30 )
V_98 |= V_105 ;
...
static int F_68 ( struct V_12 * V_1 , struct V_130 * V_131 ,
T_4 V_24 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
...
F_9 ( V_2 ) ;
return F_70 ( V_17 , V_131 , V_24 ) ;
}
static int F_71 ( struct V_12 * V_1 , struct V_130 * V_131 ,
T_4 V_24 , int V_83 )
{
...
V_146 = V_145 ;
if ( F_74 ( V_146 , 0 , V_131 , V_142 ) ) {
if ( ! ( V_83 & V_147 ) )
F_75 ( & V_2 -> V_104 , V_145 ) ;
return - V_61 ;
}
F_76 ( V_131 , V_2 , V_145 ) ;
if ( V_2 -> V_135 == V_136 && V_131 -> V_137 ) {
struct V_148 * V_149 = F_77 ( V_145 ) ;
F_48 ( struct V_22 * , V_13 ,
V_131 -> V_137 ) ;
V_131 -> V_138 = sizeof( struct V_22 ) ;
F_3 ( L_20 , V_149 -> V_29 , V_149 -> V_39 ) ;
memset ( V_13 , 0 , sizeof( * V_13 ) ) ;
V_13 -> V_26 = V_27 ;
V_13 -> V_35 = V_150 ;
V_13 -> V_29 = V_149 -> V_29 ;
V_13 -> V_39 = V_149 -> V_39 ;
}
if ( ! ( V_83 & V_147 ) ) {
if ( V_2 -> V_135 == V_48 ||
V_2 -> V_135 == V_136 ||
...
struct V_1 * F_83 ( struct V_12 * V_1 , int type , T_5 V_154 , int V_84 )
{
struct V_1 * V_2 ;
struct V_16 * V_17 ;
V_2 = F_84 ( & V_155 , V_156 , V_154 , & V_157 , V_84 ) ;
if ( ! V_2 )
return NULL ;
V_17 = V_16 ( V_2 ) ;
F_85 ( V_1 , V_2 ) ;
...
static int F_91 ( struct V_169 * V_169 , struct V_12 * V_1 ,
const struct V_35 * V_170 , int V_84 )
{
struct V_1 * V_2 ;
F_3 ( L_13 , V_1 ) ;
if ( V_1 -> type != V_48 &&
...
V_1 -> V_172 = & V_174 ;
V_2 = F_83 ( V_1 , V_1 -> type , V_175 , V_84 ) ;
if ( V_2 == NULL )
return - V_125 ;
return 0 ;
}
