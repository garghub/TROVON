...
T_5 V_102 ;
int V_5 ;
F_4 ( L_8 , V_97 -> V_103 , F_49 ( V_42 -> V_104 ) ) ;
ASSERT ( V_42 -> type != NULL ) ;
ASSERT ( V_42 -> type -> V_51 != NULL ) ;
F_18 ( L_9 ,
V_42 , V_42 -> type -> V_51 , F_50 ( V_42 -> V_105 ) ,
F_19 ( & V_36 ) ) ;
V_42 -> V_98 = V_98 ;
...
V_3 . V_22 = sizeof( V_3 . V_23 . sin ) ;
V_3 . V_23 . sin . V_24 = V_25 ;
V_3 . V_23 . sin . V_26 = V_42 -> V_104 ;
memcpy ( & V_3 . V_23 . sin . V_28 , V_97 , 4 ) ;
V_52 = F_51 ( V_34 , & V_3 , V_42 -> V_105 ,
...
V_42 -> V_52 = V_52 ;
V_101 [ 0 ] . V_110 = V_42 -> V_54 ;
V_101 [ 0 ] . V_111 = V_42 -> V_60 ;
V_66 . V_112 = NULL ;
V_66 . V_113 = 0 ;
F_54 ( & V_66 . V_87 , V_88 | V_114 , V_101 , 1 ,
V_42 -> V_60 ) ;
V_66 . V_115 = NULL ;
V_66 . V_116 = 0 ;
V_66 . V_80 = ( V_42 -> V_117 ? V_81 : 0 ) ;
if ( ! V_42 -> V_117 )
V_42 -> V_94 = V_95 ;
V_5 = F_46 ( V_34 , V_52 ,
& V_66 , V_42 -> V_60 ) ;
...
F_60 ( V_143 , V_144 ) ;
F_4 ( L_1 ) ;
F_61 ( & V_42 -> V_47 , & V_143 ) ;
for (; ; ) {
F_62 ( V_145 ) ;
if ( V_42 -> V_94 < V_120 && V_42 -> V_146 ) {
V_42 -> V_146 = false ;
F_63 ( V_147 ) ;
F_58 ( V_42 ) ;
continue;
...
static void V_108 ( struct V_149 * V_15 , struct V_99 * V_52 ,
unsigned long V_150 )
{
struct V_39 * V_42 = (struct V_39 * ) V_150 ;
V_42 -> V_146 = true ;
F_66 ( & V_42 -> V_47 ) ;
}
static void V_107 ( struct V_149 * V_15 , struct V_99 * V_52 ,
unsigned long V_150 )
{
struct V_39 * V_42 = (struct V_39 * ) V_150 ;
int V_56 ;
...
static void F_69 ( struct V_152 * V_58 )
{
...
static void V_46 ( struct V_152 * V_58 )
{
struct V_39 * V_42 = F_70 ( V_58 , struct V_39 , V_45 ) ;
F_4 ( L_1 ) ;
if ( V_42 -> V_94 < V_120 && V_42 -> V_146 ) {
...
static void F_71 ( struct V_99 * V_52 , unsigned long V_155 )
{
struct V_39 * V_42 = (struct V_39 * ) V_155 ;
V_42 -> V_52 = V_52 ;
}
static void F_11 ( struct V_152 * V_58 )
{
struct V_39 * V_42 = V_35 ;
for (; ; ) {
if ( ! V_42 ) {
V_42 = F_22 ( & V_156 , V_157 ) ;
if ( ! V_42 )
break;
V_42 -> V_98 = true ;
V_42 -> V_94 = V_124 ;
...
static void V_31 ( struct V_149 * V_15 , struct V_99 * V_52 ,
unsigned long V_155 )
{
F_37 ( V_59 , & V_158 ) ;
}
...
F_4 ( L_18 , V_42 -> V_71 ) ;
F_31 ( V_42 -> V_71 , < , 4 ) ;
V_5 = F_74 ( V_42 , & V_42 -> V_159 , 4 , true ) ;
if ( V_5 < 0 )
return V_5 ;
V_42 -> V_160 = F_75 ( V_42 -> V_159 ) ;
V_42 -> V_94 = V_125 ;
V_42 -> V_71 = 0 ;
if ( ! F_76 ( V_42 ) )
return - V_135 ;
F_77 ( V_42 ) ;
return V_42 -> type -> V_129 ( V_42 ) ;
}
...
V_66 . V_112 = NULL ;
V_66 . V_113 = 0 ;
F_54 ( & V_66 . V_87 , V_88 | V_114 , NULL , 0 , 0 ) ;
V_66 . V_115 = NULL ;
V_66 . V_116 = 0 ;
V_66 . V_80 = 0 ;
V_42 -> V_94 = V_126 ;
...
void F_79 ( struct V_39 * V_42 , const void * V_161 , T_3 V_162 )
{
struct V_65 V_66 ;
struct V_100 V_101 [ 1 ] ;
int V_49 ;
F_4 ( L_1 ) ;
V_101 [ 0 ] . V_110 = ( void * ) V_161 ;
V_101 [ 0 ] . V_111 = V_162 ;
V_66 . V_112 = NULL ;
V_66 . V_113 = 0 ;
F_54 ( & V_66 . V_87 , V_88 | V_114 , V_101 , 1 , V_162 ) ;
V_66 . V_115 = NULL ;
V_66 . V_116 = 0 ;
V_66 . V_80 = 0 ;
V_42 -> V_94 = V_126 ;
V_49 = F_46 ( V_34 , V_42 -> V_52 , & V_66 , V_162 ) ;
if ( V_49 >= 0 ) {
F_12 ( L_19 ) ;
return;
}
...
int F_74 ( struct V_39 * V_42 , void * V_161 , T_3 V_92 ,
bool V_163 )
{
int V_5 ;
F_4 ( L_23 ,
V_42 -> type -> V_51 , V_42 -> V_71 , V_92 , V_163 ) ;
F_31 ( V_42 -> V_71 , <= , V_92 ) ;
V_5 = F_57 ( V_34 , V_42 -> V_52 ,
V_161 , V_92 , & V_42 -> V_71 ,
V_163 , & V_42 -> V_102 ) ;
F_59 ( V_42 , V_92 , V_42 -> V_71 , V_163 , V_5 ) ;
if ( V_5 == 0 || V_5 == - V_127 )
return V_5 ;
if ( V_5 == 1 ) {
switch ( V_42 -> V_94 ) {
...
if ( V_5 == - V_121 )
V_42 -> error = V_42 -> type -> V_123 ( V_42 -> V_102 ) ;
else
V_42 -> error = V_5 ;
V_42 -> V_94 = V_120 ;
return V_5 ;
