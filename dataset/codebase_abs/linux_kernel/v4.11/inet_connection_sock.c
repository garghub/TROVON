...
V_99 -> V_184 = V_185 ;
F_114 ( V_99 , V_186 ) ;
V_99 -> V_187 = F_65 ( V_98 ) -> V_127 ;
F_115 ( & V_99 -> V_188 ,
F_116 ( & F_65 ( V_98 ) -> V_189 ) ) ;
V_179 -> V_190 = 0 ;
V_179 -> V_191 = 0 ;
V_179 -> V_192 = 0 ;
...
{
F_36 ( V_14 -> V_39 != V_193 ) ;
F_36 ( ! F_119 ( V_14 , V_194 ) ) ;
F_36 ( ! F_120 ( V_14 ) ) ;
F_36 ( F_78 ( V_14 ) -> V_182 && ! F_34 ( V_14 ) -> V_82 ) ;
V_14 -> V_48 -> V_195 ( V_14 ) ;
F_121 ( V_14 ) ;
F_122 ( V_14 ) ;
F_123 ( V_14 ) ;
F_124 ( V_14 -> V_48 -> V_196 ) ;
F_125 ( V_14 ) ;
}
void F_126 ( struct V_13 * V_14 )
__releases( &sk->sk_lock.slock
int F_127 ( struct V_13 * V_14 , int V_197 )
{
struct V_84 * V_85 = F_34 ( V_14 ) ;
struct V_142 * V_198 = F_78 ( V_14 ) ;
int V_87 = - V_199 ;
F_128 ( & V_85 -> V_89 ) ;
V_14 -> V_171 = V_197 ;
V_14 -> V_200 = 0 ;
F_129 ( V_14 ) ;
F_130 ( V_14 , V_40 ) ;
if ( ! V_14 -> V_48 -> V_201 ( V_14 , V_198 -> V_182 ) ) {
V_198 -> V_183 = F_70 ( V_198 -> V_182 ) ;
F_131 ( V_14 ) ;
V_87 = V_14 -> V_48 -> V_202 ( V_14 ) ;
if ( F_19 ( ! V_87 ) )
return 0 ;
}
V_14 -> V_39 = V_193 ;
...
struct V_13 * V_203 )
{
V_14 -> V_48 -> V_204 ( V_203 , V_101 ) ;
F_133 ( V_203 ) ;
F_134 ( V_14 -> V_48 -> V_196 ) ;
if ( V_14 -> V_102 == V_103 && F_52 ( V_98 ) -> V_104 ) {
F_135 ( F_136 ( V_203 ) -> V_205 != V_98 ) ;
F_135 ( V_14 != V_98 -> V_165 ) ;
F_136 ( V_203 ) -> V_205 = NULL ;
}
F_118 ( V_203 ) ;
F_53 ( V_98 ) ;
}
...
struct V_13 * F_139 ( struct V_13 * V_14 , struct V_13 * V_203 ,
struct V_97 * V_98 , bool V_210 )
{
if ( V_210 ) {
F_93 ( V_14 , V_98 ) ;
F_94 ( & F_34 ( V_14 ) -> V_89 , V_98 ) ;
if ( F_137 ( V_14 , V_98 , V_203 ) )
return V_203 ;
}
F_140 ( V_203 ) ;
F_125 ( V_203 ) ;
...
struct V_84 * V_85 = F_34 ( V_14 ) ;
struct V_95 * V_96 = & V_85 -> V_89 ;
struct V_97 * V_211 , * V_98 ;
while ( ( V_98 = F_51 ( V_96 , V_14 ) ) != NULL ) {
struct V_13 * V_203 = V_98 -> V_14 ;
F_142 () ;
F_143 ( V_203 ) ;
F_36 ( F_144 ( V_203 ) ) ;
F_145 ( V_203 ) ;
...
if ( V_96 -> V_105 . V_212 ) {
F_24 ( & V_96 -> V_105 . V_27 ) ;
V_98 = V_96 -> V_105 . V_212 ;
V_96 -> V_105 . V_212 = NULL ;
F_28 ( & V_96 -> V_105 . V_27 ) ;
while ( V_98 != NULL ) {
V_211 = V_98 -> V_207 ;
F_53 ( V_98 ) ;
...
void F_148 ( struct V_13 * V_14 , struct V_213 * V_214 )
{
struct V_215 * sin = (struct V_215 * ) V_214 ;
const struct V_142 * V_198 = F_78 ( V_14 ) ;
sin -> V_216 = V_217 ;
sin -> V_218 . V_219 = V_198 -> V_220 ;
sin -> V_221 = V_198 -> V_181 ;
}
int F_149 ( struct V_13 * V_14 , int V_222 , int V_223 ,
char T_7 * V_224 , int T_7 * V_225 )
{
const struct V_84 * V_85 = F_34 ( V_14 ) ;
if ( V_85 -> V_226 -> V_227 )
return V_85 -> V_226 -> V_227 ( V_14 , V_222 , V_223 ,
V_224 , V_225 ) ;
return V_85 -> V_226 -> V_228 ( V_14 , V_222 , V_223 ,
V_224 , V_225 ) ;
}
int F_150 ( struct V_13 * V_14 , int V_222 , int V_223 ,
char T_7 * V_224 , unsigned int V_225 )
{
const struct V_84 * V_85 = F_34 ( V_14 ) ;
if ( V_85 -> V_226 -> V_229 )
return V_85 -> V_226 -> V_229 ( V_14 , V_222 , V_223 ,
V_224 , V_225 ) ;
return V_85 -> V_226 -> V_230 ( V_14 , V_222 , V_223 ,
V_224 , V_225 ) ;
}
static struct V_116 * F_151 ( struct V_13 * V_14 , struct V_231 * V_145 )
{
const struct V_142 * V_198 = F_78 ( V_14 ) ;
const struct V_122 * V_148 ;
T_1 V_232 = V_198 -> V_220 ;
struct V_117 * V_118 ;
struct V_124 * V_125 ;
F_79 () ;
V_148 = F_80 ( V_198 -> V_148 ) ;
if ( V_148 && V_148 -> V_123 . V_129 )
V_232 = V_148 -> V_123 . V_130 ;
V_118 = & V_145 -> V_146 . V_147 ;
V_125 = F_152 ( F_18 ( V_14 ) , V_118 , V_14 , V_232 ,
V_198 -> V_233 , V_198 -> V_181 ,
V_198 -> V_183 , V_14 -> V_102 ,
F_68 ( V_14 ) , V_14 -> V_38 ) ;
if ( F_74 ( V_125 ) )
V_125 = NULL ;
if ( V_125 )
...
struct V_116 * F_154 ( struct V_13 * V_14 , T_3 V_234 )
{
struct V_116 * V_140 = F_155 ( V_14 , 0 ) ;
struct V_142 * V_198 = F_78 ( V_14 ) ;
if ( ! V_140 ) {
V_140 = F_151 ( V_14 , & V_198 -> V_144 . V_145 ) ;
if ( ! V_140 )
goto V_106;
}
