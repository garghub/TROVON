...
static void F_30 ( struct V_42 * V_43 , struct V_15 * V_15 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
int V_3 ;
F_31 ( V_43 , L_3 , V_2 -> V_5 ,
V_2 -> V_5 - V_15 -> V_44 ) ;
F_2 () ;
for ( V_3 = 0 ; V_3 < V_2 -> V_5 ; V_3 ++ ) {
struct V_6 * V_7 = F_3 ( V_2 -> V_8 [ V_3 ] . V_7 ) ;
F_31 ( V_43 , L_4 , V_7 && F_4 ( V_9 , & V_7 -> V_10 ) ? L_5 : L_6 ) ;
}
F_6 () ;
F_31 ( V_43 , L_7 ) ;
}
static int F_32 ( struct V_15 * V_15 , int V_45 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
int V_3 , V_46 = 0 ;
F_2 () ;
...
struct V_47 * V_48 = F_33 ( V_7 -> V_31 ) ;
V_46 |= F_34 ( V_48 -> V_49 , V_45 ) ;
break;
}
}
F_6 () ;
...
static void F_35 ( struct V_15 * V_15 , struct V_6 * V_7 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
char V_29 [ V_30 ] ;
...
F_41 ( L_13 , V_2 -> V_5 - V_2 -> V_15 -> V_44 ,
V_2 -> V_5 ) ;
for ( V_3 = 0 ; V_3 < V_2 -> V_5 ; V_3 ++ ) {
char V_29 [ V_30 ] ;
V_52 = V_2 -> V_8 + V_3 ;
...
static int F_48 ( struct V_15 * V_15 , struct V_6 * V_7 )
{
struct V_1 * V_2 = V_15 -> V_16 ;
int V_20 = 0 ;
int V_61 = V_7 -> V_57 ;
...
static void F_52 ( struct V_64 * V_19 )
{
...
if ( F_54 ( V_66 ) )
break;
V_14 = F_55 ( V_66 -> V_67 , struct V_13 , V_18 ) ;
F_56 ( V_66 -> V_67 ) ;
F_11 ( & V_2 -> V_17 , V_10 ) ;
V_21 = & V_14 -> V_21 ;
...
static T_1 F_57 ( struct V_15 * V_15 , T_1 V_69 , int V_5 )
{
F_58 ( V_69 || V_5 ,
L_18 , V_70 ) ;
return V_15 -> V_71 ;
...
V_2 = F_62 ( sizeof( struct V_1 ) , V_79 ) ;
V_15 -> V_16 = V_2 ;
if ( ! V_2 )
goto V_78;
V_2 -> V_8 = F_62 ( sizeof( struct V_34 ) * V_15 -> V_5 ,
V_79 ) ;
if ( ! V_2 -> V_8 )
goto V_80;
V_74 = 0 ;
...
if ( V_2 -> V_24 == NULL )
goto V_80;
V_15 -> V_19 = F_67 ( F_52 , V_15 ,
L_21 ) ;
if ( ! V_15 -> V_19 )
goto V_80;
F_18 ( L_22 ,
F_61 ( V_15 ) , V_2 -> V_5 - V_15 -> V_44 ,
V_15 -> V_5 ) ;
F_68 ( V_15 , F_57 ( V_15 , 0 , 0 ) ) ;
if ( F_51 ( V_15 ) )
goto V_80;
return 0 ;
V_80:
...
static void F_71 ( struct V_15 * V_15 , void * V_82 )
{
struct V_1 * V_2 = V_82 ;
F_69 ( V_2 -> V_24 ) ;
F_70 ( V_2 -> V_8 ) ;
