...
F_24 ( V_2 ) ;
return ( F_25 ( V_83 ) > V_83 -> V_86 * 2 ) ;
}
static void F_26 ( struct V_1 * V_16 , struct V_87 * V_88 ,
struct V_43 * V_44 , T_5 V_89 )
{
struct V_23 * V_26 = (struct V_23 * ) V_16 ;
struct V_1 * V_24 = V_26 -> V_29 ;
V_24 -> V_83 -> V_90 ( V_24 , V_88 , V_44 , V_89 ) ;
}
static void F_27 ( struct V_1 * V_16 , struct V_87 * V_88 ,
struct V_43 * V_44 )
{
struct V_23 * V_26 = (struct V_23 * ) V_16 ;
struct V_1 * V_24 = V_26 -> V_29 ;
V_24 -> V_83 -> V_91 ( V_24 , V_88 , V_44 ) ;
}
...
V_94 = V_97 ;
if ( ! F_34 ( V_2 , & V_98 ) ) {
V_94 = F_35 ( V_94 , sizeof( V_97 ) , V_99 ) ;
if ( ! V_94 )
goto V_100;
V_94 [ 0 ] . V_60 = & V_2 -> V_84 . V_85 . V_86 ;
}
V_96 = F_36 ( V_2 , L_1 , V_94 ) ;
if ( ! V_96 )
goto V_101;
V_2 -> V_102 . V_103 = V_96 ;
return 0 ;
V_101:
if ( ! F_34 ( V_2 , & V_98 ) )
F_37 ( V_94 ) ;
...
if ( ! V_2 -> V_102 . V_103 )
return;
V_94 = V_2 -> V_102 . V_103 -> V_105 ;
F_39 ( V_2 -> V_102 . V_103 ) ;
if ( ! F_34 ( V_2 , & V_98 ) )
F_37 ( V_94 ) ;
}
...
{
int V_106 ;
memcpy ( & V_2 -> V_84 . V_85 , & V_107 ,
sizeof( V_107 ) ) ;
V_106 = F_41 ( & V_2 -> V_84 . V_85 ) ;
if ( V_106 )
return V_106 ;
V_106 = F_33 ( V_2 ) ;
if ( V_106 )
