...
V_293 [ V_294 ] . V_288 = V_9 -> V_296 . V_288 [ V_294 ] >> 8 ;
V_293 [ V_294 ] . V_289 = V_9 -> V_296 . V_289 [ V_294 ] >> 8 ;
V_293 [ V_294 ] . V_290 = V_9 -> V_296 . V_290 [ V_294 ] >> 8 ;
}
...
V_9 -> V_296 . V_288 [ V_294 ] = V_288 [ V_294 ] ;
V_9 -> V_296 . V_289 [ V_294 ] = V_289 [ V_294 ] ;
V_9 -> V_296 . V_290 [ V_294 ] = V_290 [ V_294 ] ;
}
...
F_56 ( struct V_1 * V_2 ,
struct V_75 * V_298 ,
int V_263 , int V_264 , bool V_299 )
{
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_10 * V_6 = V_2 -> V_6 ;
struct V_23 * V_24 = V_23 ( V_6 ) ;
...
V_9 -> V_76 . V_63 = V_76 -> V_259 -> V_303 . V_63 ;
if ( V_9 -> V_296 . V_240 != V_300 -> V_239 -> V_240 ) {
V_9 -> V_296 . V_240 = V_300 -> V_239 -> V_240 ;
F_52 ( V_2 ) ;
}
V_11 -> V_7 [ V_238 ] &= ~ 3 ;
V_11 -> V_7 [ V_238 ] |= ( V_300 -> V_239 -> V_240 + 1 ) / 8 ;
V_11 -> V_242 &= ~ V_246 ;
if ( V_300 -> V_239 -> V_240 == 16 )
V_11 -> V_242 |= V_246 ;
F_1 ( V_2 , V_11 , V_238 ) ;
...
V_11 -> V_7 [ V_160 ] =
F_24 ( V_300 -> V_155 [ 0 ] >> 3 , 8 , V_161 ) ;
V_11 -> V_7 [ V_162 ] =
F_24 ( V_300 -> V_155 [ 0 ] / 8 , 11 , V_163 ) ;
F_1 ( V_2 , V_11 , V_160 ) ;
F_1 ( V_2 , V_11 , V_154 ) ;
F_1 ( V_2 , V_11 , V_162 ) ;
V_11 -> V_305 = V_9 -> V_76 . V_63 & ~ 3 ;
V_11 -> V_305 += ( V_264 * V_300 -> V_155 [ 0 ] ) + ( V_263 * V_300 -> V_239 -> V_306 [ 0 ] ) ;
F_57 ( V_6 , V_9 -> V_5 , V_11 -> V_305 ) ;
F_58 ( V_6 , V_2 -> V_21 . clock , V_300 -> V_239 -> V_306 [ 0 ] * 8 ,
& V_301 , & V_302 ) ;
V_11 -> V_7 [ V_307 ] = V_301 ;
V_11 -> V_7 [ V_308 ] = V_302 & 0xff ;
F_1 ( V_2 , V_11 , V_307 ) ;
F_1 ( V_2 , V_11 , V_308 ) ;
if ( V_24 -> V_27 . V_28 . V_41 . V_51 >= V_309 ) {
...
F_59 ( struct V_1 * V_2 ,
struct V_75 * V_76 ,
int V_263 , int V_264 , enum V_311 V_32 )
{
...
T_2 V_317 ;
int V_294 , V_318 ;
for ( V_294 = 0 ; V_294 < V_316 ; V_294 ++ ) {
for ( V_318 = 0 ; V_318 < V_316 ; V_318 ++ ) {
V_317 = F_64 ( V_314 , V_294 * 64 + V_318 ) ;
F_65 ( V_315 , V_294 * V_316 + V_318 , ( V_317 & 0x80000000 ) >> 16
| ( V_317 & 0xf80000 ) >> 9
| ( V_317 & 0xf800 ) >> 6
| ( V_317 & 0xf8 ) >> 3 ) ;
}
...
struct V_10 * V_6 = V_24 -> V_6 ;
struct F_3 * V_9 = F_3 ( V_2 ) ;
struct V_313 * V_61 = NULL ;
struct V_324 * V_325 ;
int V_258 = 0 ;
if ( ! V_322 ) {
V_9 -> V_61 . V_326 ( V_9 , true ) ;
return 0 ;
}
if ( V_316 != 64 || V_323 != 64 )
return - V_327 ;
V_325 = F_69 ( V_321 , V_322 ) ;
if ( ! V_325 )
return - V_328 ;
V_61 = F_70 ( V_325 ) ;
V_258 = F_71 ( V_61 ) ;
...
F_50 ( V_61 ) ;
V_9 -> V_61 . V_63 = V_9 -> V_61 . V_259 -> V_303 . V_63 ;
V_9 -> V_61 . V_62 ( V_9 , V_9 -> V_61 . V_63 ) ;
...
{
struct F_3 * V_9 = F_3 ( V_2 ) ;
V_9 -> V_61 . V_331 ( V_9 , V_263 , V_264 ) ;
return 0 ;
}
int
...
return - V_340 ;
for ( V_294 = 0 ; V_294 < 256 ; V_294 ++ ) {
V_9 -> V_296 . V_288 [ V_294 ] = V_294 << 8 ;
V_9 -> V_296 . V_289 [ V_294 ] = V_294 << 8 ;
V_9 -> V_296 . V_290 [ V_294 ] = V_294 << 8 ;
}
V_9 -> V_296 . V_240 = 0 ;
V_9 -> V_5 = V_338 ;
V_9 -> V_67 = V_274 ;
V_9 -> V_341 = F_35 ;
V_9 -> V_342 = F_37 ;
F_81 ( V_6 , & V_9 -> V_286 , & V_343 ) ;
F_82 ( & V_9 -> V_286 , & V_344 ) ;
F_83 ( & V_9 -> V_286 , 256 ) ;
V_258 = F_84 ( & V_23 ( V_6 ) -> V_27 , 64 * 64 * 4 , 0x100 ,
