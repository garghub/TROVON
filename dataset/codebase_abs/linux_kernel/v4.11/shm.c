...
if ( V_162 < 0 )
goto V_128;
else if ( ( V_69 = ( T_7 ) V_185 ) ) {
if ( V_69 & ( V_187 - 1 ) ) {
if ( ( V_93 & V_193 ) && V_69 >= V_187 )
V_69 &= ~ ( V_187 - 1 ) ;
else
#ifndef F_112
if ( V_69 & ~ V_194 )
...
V_190 = V_14 -> V_45 -> V_208 ;
F_115 ( & V_190 ) ;
V_14 -> V_16 ++ ;
V_95 = F_41 ( F_116 ( V_190 . V_209 ) ) ;
F_83 ( & V_14 -> V_15 ) ;
F_84 () ;
V_44 = - V_102 ;
...
V_69 = F_124 ( V_37 , V_69 , V_95 , V_188 , V_88 , 0 , & V_192 , NULL ) ;
* V_186 = V_69 ;
V_44 = 0 ;
if ( F_125 ( V_69 ) )
V_44 = ( long ) V_69 ;
