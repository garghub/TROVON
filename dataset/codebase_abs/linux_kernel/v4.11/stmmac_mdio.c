...
return - V_49 ;
if ( V_35 -> V_50 )
memcpy ( V_46 -> V_51 , V_35 -> V_50 , sizeof( V_46 -> V_51 ) ) ;
#ifdef F_9
if ( V_7 -> V_36 -> V_37 )
V_35 -> V_38 = - 1 ;
#endif
...
V_46 -> V_54 = & F_6 ;
V_46 -> V_55 = & F_7 ;
snprintf ( V_46 -> V_56 , V_57 , L_7 ,
V_46 -> V_52 , V_7 -> V_25 -> V_58 ) ;
V_46 -> V_7 = V_6 ;
V_46 -> V_59 = V_35 -> V_59 ;
V_46 -> V_60 = V_7 -> V_36 ;
if ( V_47 )
...
if ( V_7 -> V_25 -> V_62 || V_47 )
goto V_63;
V_48 = 0 ;
for ( V_12 = 0 ; V_12 < V_64 ; V_12 ++ ) {
struct V_65 * V_66 = F_24 ( V_46 , V_12 ) ;
int V_67 = 0 ;
char V_68 [ 4 ] ;
char * V_69 ;
if ( ! V_66 )
...
if ( ! V_35 -> V_50 &&
( V_35 -> V_70 > 0 ) ) {
V_46 -> V_51 [ V_12 ] = V_35 -> V_70 ;
V_66 -> V_51 = V_35 -> V_70 ;
}
if ( V_7 -> V_25 -> V_71 == - 1 )
V_7 -> V_25 -> V_71 = V_12 ;
V_67 = ( V_7 -> V_25 -> V_71 == V_12 ) ;
switch ( V_66 -> V_51 ) {
case V_72 :
V_69 = L_9 ;
break;
...
break;
default:
sprintf ( V_68 , L_11 , V_66 -> V_51 ) ;
V_69 = V_68 ;
break;
}
F_25 ( V_6 , L_12 ,
V_66 -> V_74 , V_12 , V_69 , F_26 ( V_66 ) ,
V_67 ? L_13 : L_14 ) ;
V_48 = 1 ;
}
if ( ! V_48 && ! V_47 ) {
