...
V_14 = F_50 ( 0 , V_49 | V_17 ) ;
V_54 = F_51 ( & V_26 -> V_44 , V_27 ,
F_52 ( V_14 ) , V_14 ) ;
F_48 () ;
if ( V_54 ) {
F_33 ( & V_26 -> V_42 ) ;
...
int F_115 ( struct V_67 * V_68 )
{
struct V_128 * V_128 = V_68 -> V_90 -> V_129 ;
...
while ( F_136 ( V_142 ) ) {
V_62 = F_137 ( V_112 , V_137 , F_136 ( V_142 ) , V_78 , V_159 ,
V_142 , F_124 ) ;
if ( V_62 <= 0 )
break;
V_137 += V_62 ;
...
static int F_139 ( struct V_67 * V_68 ,
const struct V_158 * V_159 )
{
struct V_25 * V_26 = V_68 -> V_90 -> V_129 -> V_130 ;
struct V_112 * V_112 = V_26 -> V_82 ;
unsigned long V_75 = V_68 -> V_91 ;
...
return V_164 ;
if ( ( V_68 -> V_78 & V_81 ) && ! V_68 -> V_168 )
V_78 |= V_163 ;
error = V_159 -> V_169 ( V_112 , V_137 , V_22 , V_78 , & V_136 ) ;
if ( error )
return F_138 ( error ) ;
...
if ( V_136 . V_78 & V_148 ) {
F_142 ( V_174 ) ;
F_143 ( V_68 -> V_90 -> V_103 , V_174 ) ;
V_166 = V_175 ;
}
error = F_113 ( V_26 , V_136 . V_5 , V_23 ,
V_22 , & V_14 , V_68 -> V_90 , V_68 ) ;
if ( error == - V_176 )
error = 0 ;
break;
case V_146 :
...
if ( V_167 & V_179 )
V_178 = 0 ;
V_159 -> V_177 ( V_112 , V_137 , V_22 , V_178 , V_78 , & V_136 ) ;
}
return V_167 ;
}
static int F_144 ( struct V_67 * V_68 , struct V_136 * V_136 ,
T_10 V_137 , void * * V_127 )
{
struct V_25 * V_26 = V_68 -> V_90 -> V_129 -> V_130 ;
...
goto V_180;
* V_127 = V_62 ;
F_146 ( V_112 , V_68 , V_132 , V_7 . V_95 , V_62 ) ;
return F_147 ( V_68 -> V_90 , V_68 -> V_91 , V_68 -> V_104 ,
V_7 . V_95 , V_68 -> V_78 & V_81 ) ;
V_181:
F_8 ( V_5 , & V_7 ) ;
V_180:
F_148 ( V_112 , V_68 , V_132 ,
V_7 . V_95 , V_62 ) ;
return V_183 ;
}
static int F_149 ( struct V_67 * V_68 , struct V_136 * V_136 ,
void * * V_127 )
{
struct V_25 * V_26 = V_68 -> V_90 -> V_129 -> V_130 ;
unsigned long V_184 = V_68 -> V_91 & V_55 ;
struct V_112 * V_112 = V_26 -> V_82 ;
struct V_18 * V_185 ;
void * V_62 = NULL ;
T_9 * V_99 ;
T_8 V_186 ;
V_185 = F_150 ( V_68 -> V_90 -> V_103 ) ;
if ( F_55 ( ! V_185 ) )
goto V_180;
...
goto V_180;
* V_127 = V_62 ;
V_99 = F_151 ( V_68 -> V_90 -> V_103 , V_68 -> V_104 ) ;
if ( ! F_152 ( * ( V_68 -> V_104 ) ) ) {
F_92 ( V_99 ) ;
goto V_180;
}
V_186 = F_153 ( V_185 , V_68 -> V_90 -> V_187 ) ;
V_186 = F_154 ( V_186 ) ;
F_91 ( V_68 -> V_90 -> V_103 , V_184 , V_68 -> V_104 , V_186 ) ;
F_92 ( V_99 ) ;
F_155 ( V_112 , V_68 , V_185 , V_62 ) ;
return V_73 ;
V_180:
F_156 ( V_112 , V_68 , V_185 , V_62 ) ;
return V_183 ;
}
static int F_157 ( struct V_67 * V_68 ,
const struct V_158 * V_159 )
{
struct V_89 * V_90 = V_68 -> V_90 ;
struct V_25 * V_26 = V_90 -> V_129 -> V_130 ;
unsigned long V_184 = V_68 -> V_91 & V_55 ;
bool V_188 = V_68 -> V_78 & V_81 ;
unsigned int V_189 = ( V_188 ? V_163 : 0 ) | V_165 ;
struct V_112 * V_112 = V_26 -> V_82 ;
int V_190 = V_183 ;
struct V_136 V_136 = { 0 } ;
T_4 V_191 , V_69 ;
...
T_10 V_137 ;
int error ;
V_69 = F_158 ( V_90 , V_184 ) ;
V_191 = ( F_127 ( V_112 ) - 1 ) >> V_32 ;
F_159 ( V_112 , V_68 , V_191 , 0 ) ;
if ( V_188 && ! ( V_90 -> V_101 & V_102 ) )
goto V_180;
if ( V_184 < V_90 -> V_92 )
goto V_180;
if ( ( V_184 + V_56 ) > V_90 -> V_94 )
goto V_180;
if ( V_69 > V_191 ) {
V_190 = V_164 ;
goto V_64;
...
error = V_159 -> V_169 ( V_112 , V_137 , V_56 , V_189 , & V_136 ) ;
if ( error )
goto V_180;
...
switch ( V_136 . type ) {
case V_147 :
V_190 = F_144 ( V_68 , & V_136 , V_137 , & V_14 ) ;
break;
case V_146 :
case V_145 :
if ( F_38 ( V_188 ) )
goto V_173;
V_190 = F_149 ( V_68 , & V_136 , & V_14 ) ;
break;
default:
F_38 ( 1 ) ;
break;
...
if ( V_190 == V_183 )
V_178 = 0 ;
V_159 -> V_177 ( V_112 , V_137 , V_56 , V_178 , V_189 ,
& V_136 ) ;
}
V_180:
if ( V_190 == V_183 ) {
F_160 ( V_90 , V_68 -> V_104 , V_68 -> V_91 ) ;
F_142 ( V_192 ) ;
}
V_64:
F_161 ( V_112 , V_68 , V_191 , V_190 ) ;
return V_190 ;
}
static int F_157 ( struct V_67 * V_68 ,
const struct V_158 * V_159 )
...
int F_162 ( struct V_67 * V_68 , enum V_193 V_194 ,
const struct V_158 * V_159 )
{
switch ( V_194 ) {
case V_195 :
return F_139 ( V_68 , V_159 ) ;
case V_196 :
return F_157 ( V_68 , V_159 ) ;
default:
return V_183 ;
}
}
