...
V_2 -> V_9 . V_10 == V_92 ) {
memcpy ( V_2 -> V_9 . V_93 , & V_90 -> V_94 , V_95 ) ;
...
if ( F_34
( V_140 . V_140 , V_80 -> V_152 , V_80 -> V_86 ) ) {
V_140 . V_81 = 0 ;
return - V_153 ;
}
V_2 -> V_9 . V_139 [ V_141 ] . V_85 = V_140 . V_81 ;
for ( V_102 = 0 ; V_102 < ( V_2 -> V_9 . V_139 [ V_141 ] . V_85 ) ; V_102 ++ )
V_2 -> V_9 . V_139 [ V_141 ] . V_154 [ V_102 ] = V_140 . V_140 [ V_102 ] ;
V_2 -> V_73 |= ( V_26 << V_141 ) ;
V_2 -> V_9 . V_144 = V_141 ;
V_2 -> V_73 |= V_24 ;
}
...
if ( V_80 -> V_82 & V_155 ) {
V_2 -> V_9 . V_139 [ 0 ] . V_85 = 0 ;
V_2 -> V_9 . V_139 [ 1 ] . V_85 = 0 ;
V_2 -> V_9 . V_139 [ 2 ] . V_85 = 0 ;
V_2 -> V_9 . V_139 [ 3 ] . V_85 = 0 ;
V_2 -> V_9 . V_147 = 0x00 ;
...
if ( ( V_141 >= 0 ) && ( V_141 < 4 ) )
V_80 -> V_86 = V_2 -> V_9 . V_139 [ V_141 ] . V_85 ;
if ( V_80 -> V_86 > 16 )
V_80 -> V_86 = 0 ;
#if 1
if ( V_80 -> V_86 ) {
if ( ( V_141 >= 0 ) && ( V_141 < 4 ) )
memcpy ( V_52 , V_2 -> V_9 . V_139 [ V_141 ] . V_154 ,
V_80 -> V_86 ) ;
} else
...
V_249 . V_258 = V_272 ;
if ( V_250 & V_273 )
V_249 . V_259 . V_235 . V_82 = V_274 | V_151 ;
else
...
struct V_1 * V_2 =
(struct V_1 * ) F_13 ( V_48 ) ;
int V_141 = ( V_101 -> V_82 & V_284 ) ;
int V_104 = V_101 -> V_104 ;
F_2 ( 2 , L_22 , V_141 , V_104 ) ;
if ( V_2 -> V_53 == V_54 )
return - V_55 ;
switch ( V_141 ) {
case V_285 :
...
break;
case V_312 :
if ( ( V_104 && ! V_2 -> V_9 . V_147 ) ||
( ! V_104 && V_2 -> V_9 . V_147 ) ) {
V_2 -> V_9 . V_147 = V_104 ? 0x01 : 0x00 ;
V_2 -> V_73 |= V_34 ;
}
break;
case V_313 :
...
V_141 -- ;
if ( V_80 -> V_82 & V_155 )
V_2 -> V_287 . V_140 [ V_141 ] . V_321 = 0 ;
if ( V_318 ) {
V_2 -> V_287 . V_140 [ V_141 ] . V_320 = V_318 -> V_320 ;
if ( V_318 -> V_320 & V_322 ) {
V_2 -> V_287 . V_323 = V_141 ;
V_319 |= V_24 ;
} else if ( V_318 -> V_320 & V_324 ) {
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] . V_325 [ 0 ] ,
V_318 -> V_325 , V_326 ) ;
}
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] . V_327 . V_94 [ 0 ] ,
...
if ( V_318 -> V_321 ) {
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] . V_332 [ 0 ] ,
& V_318 -> V_140 [ 0 ] , V_318 -> V_321 ) ;
V_2 -> V_287 . V_140 [ V_141 ] . V_321 = V_318 -> V_321 ;
V_319 |= ( V_26 << V_141 ) ;
}
break;
case V_333 :
...
if ( V_318 -> V_321 == 32 ) {
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] . V_332 [ 0 ] ,
& V_318 -> V_140 [ 0 ] , V_318 -> V_321 - 16 ) ;
V_2 -> V_287 . V_140 [ V_141 ] . V_321 =
V_318 -> V_321 - 16 ;
if ( V_2 -> V_287 . V_304 == 4 ) {
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] .
V_334 [ 0 ] , & V_318 -> V_140 [ 16 ] , 8 ) ;
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] .
V_335 [ 0 ] , & V_318 -> V_140 [ 16 ] , 8 ) ;
} else {
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] .
V_334 [ 0 ] , & V_318 -> V_140 [ 16 ] , 8 ) ;
memcpy ( & V_2 -> V_287 . V_140 [ V_141 ] .
V_335 [ 0 ] , & V_318 -> V_140 [ 24 ] , 8 ) ;
}
V_319 |= ( V_26 << V_141 ) ;
}
break;
...
V_2 -> V_287 . V_140 [ V_141 ] . V_328 = V_318 -> V_328 ;
} else
return - V_71 ;
if ( V_319 ) {
if ( V_319 & V_24 )
