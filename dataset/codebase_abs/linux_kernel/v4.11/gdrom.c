...
static void F_42 ( struct V_83 * V_84 , T_1 V_80 )
{
F_39 ( & V_82 ) ;
F_43 ( V_20 . V_21 , V_80 ) ;
F_41 ( & V_82 ) ;
...
if ( F_55 ( & V_102 ) )
return;
V_96 = F_17 ( sizeof( struct V_23 ) , V_25 ) ;
if ( ! V_96 )
return;
V_96 -> V_13 [ 0 ] = 0x30 ;
V_96 -> V_13 [ 1 ] = 0x20 ;
...
V_101 = F_58 ( V_98 , struct V_100 , V_104 ) ;
F_59 ( & V_103 ) ;
V_94 = F_60 ( V_101 ) / V_105 + V_42 ;
V_95 = F_61 ( V_101 ) / V_105 ;
F_33 ( F_62 ( F_63 ( V_101 -> V_106 ) ) , V_107 ) ;
F_33 ( V_95 * V_108 , V_109 ) ;
F_33 ( 1 , V_110 ) ;
F_33 ( 1 , V_111 ) ;
V_96 -> V_13 [ 2 ] = ( V_94 >> 16 ) & 0xFF ;
V_96 -> V_13 [ 3 ] = ( V_94 >> 8 ) & 0xFF ;
V_96 -> V_13 [ 4 ] = V_94 & 0xFF ;
V_96 -> V_13 [ 8 ] = ( V_95 >> 16 ) & 0xFF ;
V_96 -> V_13 [ 9 ] = ( V_95 >> 8 ) & 0xFF ;
V_96 -> V_13 [ 10 ] = V_95 & 0xFF ;
F_10 ( 1 , V_18 ) ;
F_10 ( 0 , V_17 ) ;
F_10 ( 0 , V_14 ) ;
F_10 ( 0 , V_15 ) ;
...
static void F_66 ( struct V_89 * V_115 )
{
struct V_100 * V_101 ;
while ( ( V_101 = F_67 ( V_115 ) ) != NULL ) {
switch ( F_68 ( V_101 ) ) {
case V_116 :
F_69 ( & V_101 -> V_104 , & V_102 ) ;
F_70 ( & V_93 ) ;
break;
case V_117 :
F_71 ( L_8 ) ;
...
{
struct V_119 * V_120 ;
char * V_121 , * V_122 , * V_123 ;
int V_36 = - V_26 ;
V_120 = F_17 ( sizeof( struct V_119 ) , V_25 ) ;
if ( ! V_120 )
return V_36 ;
F_8 ( V_120 ) ;
V_121 = F_74 ( V_120 -> V_124 , 16 , V_25 ) ;
if ( ! V_121 )
goto V_125;
V_122 = F_74 ( V_120 -> V_126 , 16 , V_25 ) ;
if ( ! V_122 )
goto V_127;
V_123 = F_74 ( V_120 -> V_128 , 16 , V_25 ) ;
if ( ! V_123 )
goto V_129;
F_28 ( L_10 ,
V_121 , V_122 , V_123 ) ;
...
if ( ! F_7 () )
return - V_37 ;
F_33 ( 0x8843407F , V_130 ) ;
F_33 ( 9 , V_131 ) ;
return 0 ;
}
static void F_76 ( void )
{
V_20 . V_21 -> V_132 = & V_133 ;
V_20 . V_21 -> V_134 = 1 ;
strcpy ( V_20 . V_21 -> V_135 , V_136 ) ;
V_20 . V_21 -> V_137 = V_138 | V_139 | V_140 |
V_141 ;
}
static void F_77 ( void )
{
V_20 . V_84 -> V_142 = V_143 ;
V_20 . V_84 -> V_144 = 1 ;
V_20 . V_84 -> V_145 = 1 ;
strcpy ( V_20 . V_84 -> V_146 , V_136 ) ;
}
static int F_78 ( void )
{
F_79 ( V_20 . V_147 , V_108 ) ;
F_80 ( V_20 . V_147 , 1 ) ;
F_81 ( V_20 . V_147 , 0x40000 ) ;
V_20 . V_84 -> V_148 = V_20 . V_147 ;
return F_75 () ;
}
static int F_82 ( struct V_149 * V_150 )
{
int V_36 ;
if ( F_14 () != 1 ) {
F_83 ( L_11 ) ;
...
V_20 . V_84 -> V_155 = & V_156 ;
V_36 = F_51 () ;
if ( V_36 )
goto V_157;
V_20 . V_147 = F_87 ( F_66 , & V_103 ) ;
if ( ! V_20 . V_147 ) {
V_36 = - V_26 ;
goto V_158;
}
