...
if ( F_7 ( V_13 ) ) {
T_3 V_21 ;
bool V_22 = V_8 && F_8 ( V_13 ) ;
if ( V_8 ) {
struct V_23 * V_23 ;
V_23 = F_9 ( V_2 , V_4 , V_13 ) ;
if ( ! V_23 || F_10 ( V_23 ) )
continue;
if ( F_11 ( V_13 ) )
continue;
...
static inline unsigned long F_30 ( struct V_1 * V_2 ,
...
if ( F_33 ( * V_3 ) || F_34 ( * V_3 ) ) {
if ( V_30 - V_4 != V_34 ) {
F_37 ( V_2 , V_3 , V_4 , false , NULL ) ;
} else {
int V_35 = F_38 ( V_2 , V_3 , V_4 ,
V_6 , V_8 ) ;
if ( V_35 ) {
if ( V_35 == V_36 ) {
V_15 += V_36 ;
...
if ( F_44 ( V_29 ) )
continue;
V_15 += F_30 ( V_2 , V_29 , V_4 , V_30 , V_6 ,
V_7 , V_8 ) ;
...
if ( F_48 ( V_38 ) )
continue;
V_15 += F_41 ( V_2 , V_38 , V_4 , V_30 , V_6 ,
V_7 , V_8 ) ;
...
if ( F_55 ( V_39 ) )
continue;
V_15 += F_45 ( V_2 , V_39 , V_4 , V_30 , V_6 ,
V_7 , V_8 ) ;
...
unsigned long V_15 ;
if ( F_59 ( V_2 ) )
V_15 = F_60 ( V_2 , V_40 , V_5 , V_6 ) ;
else
V_15 = F_49 ( V_2 , V_40 , V_5 , V_6 , V_7 , V_8 ) ;
return V_15 ;
}
int
...
* V_41 = F_64 ( V_10 , * V_41 , V_40 , V_5 , V_42 ,
V_2 -> V_55 , V_2 -> V_56 , V_47 , F_65 ( V_2 ) ,
V_2 -> V_57 ) ;
if ( * V_41 ) {
V_2 = * V_41 ;
F_66 ( ( V_2 -> V_18 ^ V_42 ) & ~ V_24 ) ;
goto V_58;
}
* V_41 = V_2 ;
if ( V_40 != V_2 -> V_54 ) {
error = F_67 ( V_10 , V_2 , V_40 , 1 ) ;
if ( error )
goto V_59;
}
if ( V_5 != V_2 -> V_60 ) {
error = F_67 ( V_10 , V_2 , V_5 , 0 ) ;
if ( error )
goto V_59;
}
V_58:
V_2 -> V_18 = V_42 ;
V_7 = F_68 ( V_2 , V_2 -> V_61 ) ;
F_69 ( V_2 ) ;
F_58 ( V_2 , V_40 , V_5 , V_2 -> V_61 ,
V_7 , 0 ) ;
if ( ( V_43 & ( V_48 | V_19 | V_62 ) ) == V_62 &&
( V_42 & V_48 ) ) {
F_70 ( V_2 , V_40 , V_5 , NULL ) ;
}
F_71 ( V_10 , V_43 , - V_44 ) ;
F_71 ( V_10 , V_42 , V_44 ) ;
F_72 ( V_2 ) ;
...
static int F_74 ( unsigned long V_40 , T_10 V_63 ,
...
return - V_70 ;
V_68 = V_64 ;
if ( F_77 ( & V_75 -> V_10 -> V_80 ) )
return - V_81 ;
error = - V_70 ;
if ( ( V_65 != - 1 ) && ! F_78 ( V_75 -> V_10 , V_65 ) )
goto V_82;
V_2 = F_79 ( V_75 -> V_10 , V_40 ) ;
error = - V_49 ;
if ( ! V_2 )
goto V_82;
V_69 = V_2 -> V_83 ;
