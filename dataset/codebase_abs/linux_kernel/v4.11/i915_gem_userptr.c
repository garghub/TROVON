...
V_15 -> V_22 = NULL ;
F_55 ( V_58 -> V_63 ,
& V_15 -> V_64 , ( unsigned long ) V_15 -> V_15 ) ;
} else
F_56 ( & V_15 -> V_62 ) ;
V_6 -> V_13 . V_15 = V_15 ;
V_61:
...
static int
F_64 ( struct V_65 * * V_66 , struct V_67 * * V_68 , int V_69 )
{
struct V_70 * V_71 ;
int V_36 , V_72 ;
* V_66 = F_29 ( sizeof( * * V_66 ) , V_37 ) ;
if ( * V_66 == NULL )
return - V_38 ;
if ( F_65 () ) {
V_36 = F_66 ( * V_66 , V_69 , V_37 ) ;
if ( V_36 )
goto V_73;
F_67 ((*st)->sgl, sg, num_pages, n)
F_68 ( V_71 , V_68 [ V_72 ] , V_74 , 0 ) ;
} else {
V_36 = F_69 ( * V_66 , V_68 , V_69 ,
0 , V_69 << V_75 ,
V_37 ) ;
if ( V_36 )
goto V_73;
...
static void
F_76 ( struct V_1 * V_79 )
{
struct V_80 * V_2 = F_2 ( V_79 , F_3 ( * V_2 ) , V_2 ) ;
struct V_5 * V_6 = V_2 -> V_6 ;
const int V_81 = V_6 -> V_9 . V_55 >> V_75 ;
struct V_67 * * V_68 ;
int V_82 , V_36 ;
V_36 = - V_38 ;
V_82 = 0 ;
V_68 = F_77 ( V_81 , sizeof( struct V_67 * ) , V_83 ) ;
if ( V_68 != NULL ) {
...
struct V_65 * V_16 = F_30 ( V_36 ) ;
if ( V_82 == V_81 ) {
V_16 = F_70 ( V_6 , V_68 , V_81 ) ;
if ( ! F_39 ( V_16 ) ) {
F_83 ( V_6 , V_16 ) ;
V_82 = 0 ;
V_16 = NULL ;
...
F_91 ( struct V_5 * V_6 )
{
const int V_69 = V_6 -> V_9 . V_55 >> V_75 ;
struct V_67 * * V_68 ;
struct V_65 * V_16 ;
int V_82 , V_36 ;
bool V_88 ;
...
V_68 = F_77 ( V_69 , sizeof( struct V_67 * ) ,
V_83 ) ;
if ( V_68 == NULL ) {
F_73 ( V_6 , false ) ;
return F_30 ( - V_38 ) ;
}
V_82 = F_92 ( V_6 -> V_13 . V_53 , V_69 ,
! V_6 -> V_13 . V_84 , V_68 ) ;
}
V_88 = false ;
if ( V_82 < 0 )
V_16 = F_30 ( V_82 ) , V_82 = 0 ;
else if ( V_82 < V_69 )
V_16 = F_88 ( V_6 , & V_88 ) ;
else
V_16 = F_70 ( V_6 , V_68 , V_69 ) ;
if ( F_39 ( V_16 ) ) {
F_73 ( V_6 , V_88 ) ;
F_85 ( V_68 , V_82 , 0 ) ;
}
...
int
F_102 ( struct V_7 * V_8 , void * V_93 , struct V_94 * V_95 )
{
struct V_57 * V_58 = F_52 ( V_8 ) ;
struct V_96 * args = V_93 ;
struct V_5 * V_6 ;
int V_36 ;
T_1 V_97 ;
...
V_49 ) )
return - V_52 ;
if ( F_105 ( args -> V_99 | args -> V_100 ) )
return - V_52 ;
if ( ! F_106 ( args -> V_48 & V_98 ? V_101 : V_102 ,
( char V_103 * ) ( unsigned long ) args -> V_99 , args -> V_100 ) )
return - V_86 ;
if ( args -> V_48 & V_98 ) {
return - V_56 ;
}
...
if ( V_6 == NULL )
return - V_38 ;
F_108 ( V_8 , & V_6 -> V_9 , args -> V_100 ) ;
F_109 ( V_6 , & V_104 ) ;
V_6 -> V_105 = V_106 ;
V_6 -> V_9 . V_107 = V_108 ;
V_6 -> V_9 . V_109 = V_108 ;
V_6 -> V_13 . V_53 = args -> V_99 ;
V_6 -> V_13 . V_84 = ! ! ( args -> V_48 & V_98 ) ;
V_36 = F_51 ( V_6 ) ;
if ( V_36 == 0 )
V_36 = F_41 ( V_6 , args -> V_48 ) ;
if ( V_36 == 0 )
V_36 = F_110 ( V_95 , & V_6 -> V_9 , & V_97 ) ;
F_10 ( V_6 ) ;
if ( V_36 )
return V_36 ;
args -> V_97 = V_97 ;
