...
static T_1
F_39 ( struct V_8 * V_9 , const char * V_2 , T_2 V_3 )
{
unsigned long V_20 ,
V_31 = F_40 ( V_9 ) >> 1 ,
V_32 = 1 << ( V_19 - 10 ) ;
...
static T_1 F_47 ( struct V_8 * V_9 , char * V_2 )
{
return F_1 ( ( F_48 ( V_9 ) << 1 ) |
F_49 ( V_9 ) , V_2 ) ;
}
...
{
bool V_42 = F_54 ( V_43 , & V_9 -> V_44 ) ;
bool V_45 = F_54 ( V_46 , & V_9 -> V_44 ) ;
return F_1 ( V_42 << V_45 , V_2 ) ;
}
static T_1
F_55 ( struct V_8 * V_9 , const char * V_2 , T_2 V_3 )
{
T_1 V_12 = - V_7 ;
#ifdef F_56
unsigned long V_47 ;
...
static T_1 F_57 ( struct V_8 * V_9 , char * V_2 )
{
int V_47 ;
if ( V_9 -> V_48 == - 1 )
V_47 = - 1 ;
...
static T_1 F_58 ( struct V_8 * V_9 , const char * V_2 ,
T_2 V_3 )
{
int V_4 , V_47 ;
if ( ! V_9 -> V_14 || ! V_9 -> V_14 -> V_49 )
return - V_7 ;
V_4 = F_59 ( V_2 , 10 , & V_47 ) ;
if ( V_4 < 0 )
return V_4 ;
if ( V_47 == - 1 )
V_9 -> V_48 = - 1 ;
...
{
return F_1 ( F_54 ( V_50 , & V_9 -> V_44 ) , V_2 ) ;
}
static T_1 F_61 ( struct V_8 * V_9 , const char * V_2 ,
T_2 V_3 )
{
unsigned long V_51 ;
T_1 V_12 ;
...
static T_1 F_62 ( struct V_8 * V_9 , char * V_2 )
{
if ( ! V_9 -> V_52 )
return - V_7 ;
return sprintf ( V_2 , L_2 , F_63 ( V_9 -> V_52 -> V_53 , 1000 ) ) ;
}
static T_1 F_64 ( struct V_8 * V_9 , const char * V_2 ,
T_2 V_3 )
{
struct V_52 * V_54 ;
T_1 V_12 ;
...
{
if ( F_54 ( V_58 , & V_9 -> V_44 ) )
return sprintf ( V_2 , L_7 ) ;
return sprintf ( V_2 , L_8 ) ;
}
static T_1 F_69 ( struct V_8 * V_9 , const char * V_2 ,
T_2 V_3 )
{
int V_42 = - 1 ;
...
static T_1 F_70 ( struct V_8 * V_9 , char * V_2 )
{
return F_1 ( F_71 ( V_9 ) , V_2 ) ;
}
static T_1 F_72 ( char * V_2 , struct V_59 * V_60 , const char * V_61 )
{
...
static T_1 F_73 ( struct V_8 * V_9 , char * V_2 )
{
struct V_59 V_60 [ 2 ] ;
T_1 V_12 ;
F_74 ( V_9 , V_60 ) ;
V_12 = F_72 ( V_2 , & V_60 [ V_66 ] , L_13 ) ;
V_12 += F_72 ( V_2 + V_12 , & V_60 [ V_67 ] , L_14 ) ;
return V_12 ;
}
static T_1
F_75 ( struct V_68 * V_69 , struct V_70 * V_71 , char * V_2 )
{
struct V_72 * V_73 = F_76 ( V_71 ) ;
struct V_8 * V_9 =
F_77 ( V_69 , struct V_8 , V_69 ) ;
T_1 V_74 ;
if ( ! V_73 -> V_75 )
return - V_76 ;
F_78 ( & V_9 -> V_77 ) ;
...
static T_1
F_81 ( struct V_68 * V_69 , struct V_70 * V_71 ,
...
static void F_82 ( struct V_81 * V_81 )
{
struct V_8 * V_9 = F_77 ( V_81 , struct V_8 ,
V_81 ) ;
F_83 ( V_82 , V_9 ) ;
}
static void F_84 ( struct V_68 * V_69 )
{
struct V_8 * V_9 =
F_77 ( V_69 , struct V_8 , V_69 ) ;
F_85 ( V_9 ) ;
...
int F_102 ( struct V_92 * V_93 )
{
int V_12 ;
struct V_94 * V_95 = F_103 ( V_93 ) ;
struct V_8 * V_9 = V_93 -> V_96 ;
if ( F_104 ( ! V_9 ) )
return - V_97 ;
if ( ! F_105 ( V_9 ) ) {
F_106 ( V_98 , V_9 ) ;
...
F_110 ( V_95 , V_9 ) ;
F_78 ( & V_9 -> V_77 ) ;
V_12 = F_111 ( & V_9 -> V_69 , F_112 ( & V_95 -> V_69 ) , L_15 , L_16 ) ;
if ( V_12 < 0 ) {
F_113 ( V_95 ) ;
goto V_100;
}
F_114 ( & V_9 -> V_69 , V_101 ) ;
F_99 ( V_9 ) ;
if ( V_9 -> V_13 || ( V_9 -> V_14 && V_9 -> V_83 ) ) {
V_12 = F_115 ( V_9 ) ;
if ( V_12 ) {
F_114 ( & V_9 -> V_69 , V_102 ) ;
F_116 ( & V_9 -> V_69 ) ;
F_113 ( V_95 ) ;
F_117 ( & V_95 -> V_69 ) ;
goto V_100;
...
void F_118 ( struct V_92 * V_93 )
{
struct V_8 * V_9 = V_93 -> V_96 ;
if ( F_104 ( ! V_9 ) )
return;
if ( V_9 -> V_14 )
F_119 ( F_103 ( V_93 ) , V_9 ) ;
if ( V_9 -> V_13 || ( V_9 -> V_14 && V_9 -> V_83 ) )
F_120 ( V_9 ) ;
F_114 ( & V_9 -> V_69 , V_102 ) ;
F_116 ( & V_9 -> V_69 ) ;
F_113 ( F_103 ( V_93 ) ) ;
F_117 ( & F_103 ( V_93 ) -> V_69 ) ;
}
