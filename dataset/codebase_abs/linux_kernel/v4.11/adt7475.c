...
T_2 V_104 , V_105 ;
V_2 = F_70 ( & V_16 -> V_23 , sizeof( * V_2 ) , V_106 ) ;
if ( V_2 == NULL )
return - V_107 ;
F_71 ( & V_2 -> V_36 ) ;
F_72 ( V_16 , V_2 ) ;
...
int V_19 ;
F_21 ( & V_2 -> V_36 ) ;
if ( F_81 ( V_126 , V_2 -> V_127 + V_128 * 2 ) ||
! V_2 -> V_129 ) {
V_2 -> V_31 = F_27 ( V_130 ) << 8 ;
V_2 -> V_31 |= F_27 ( V_131 ) ;
V_125 = ( F_27 ( V_132 ) << 8 ) |
F_27 ( V_133 ) ;
...
( ( V_125 >> ( ( V_19 + 5 ) * 2 ) ) & 3 ) ;
if ( V_2 -> V_89 & ( 1 << 5 ) ) {
V_2 -> V_31 |= F_27 ( V_135 ) << 24 ;
V_125 = F_27 ( V_136 ) ;
V_2 -> V_33 [ V_59 ] [ 5 ] = F_27 ( V_137 ) << 2 |
( ( V_125 >> 4 ) & 3 ) ;
}
...
if ( F_81 ( V_126 , V_2 -> V_139 + V_128 * 60 ) ||
! V_2 -> V_129 ) {
V_2 -> V_63 = F_27 ( V_65 ) ;
V_2 -> V_5 = F_27 ( V_49 ) ;
for ( V_19 = 0 ; V_19 < V_37 ; V_19 ++ ) {
