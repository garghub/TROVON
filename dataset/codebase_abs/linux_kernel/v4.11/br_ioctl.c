...
struct V_13 * V_75 ;
F_2 () ;
if ( ( V_75 = F_28 ( V_11 , args [ 2 ] ) ) == NULL ) {
F_4 () ;
return - V_31 ;
}
memset ( & V_14 , 0 , sizeof( struct V_74 ) ) ;
memcpy ( & V_14 . V_42 , & V_75 -> V_42 , 8 ) ;
memcpy ( & V_14 . V_76 , & V_75 -> V_76 , 8 ) ;
V_14 . V_77 = V_75 -> V_77 ;
V_14 . V_78 = V_75 -> V_78 ;
V_14 . V_79 = V_75 -> V_79 ;
V_14 . V_80 = V_75 -> V_80 ;
...
V_14 . V_82 = V_75 -> V_83 ;
V_14 . V_84 = V_75 -> V_84 ;
V_14 . V_85 = F_22 ( & V_75 -> V_86 ) ;
V_14 . V_87 = F_22 ( & V_75 -> V_88 ) ;
V_14 . V_89 = F_22 ( & V_75 -> V_90 ) ;
F_4 () ;
...
static int F_37 ( struct V_1 * V_1 , void T_1 * V_98 )
{
unsigned long args [ 3 ] ;
if ( F_20 ( args , V_98 , sizeof( args ) ) )
return - V_25 ;
switch ( args [ 0 ] ) {
case V_99 :
return V_100 ;
...
if ( args [ 2 ] >= 2048 )
return - V_24 ;
V_2 = F_23 ( args [ 2 ] , sizeof( int ) , V_68 ) ;
if ( V_2 == NULL )
return - V_24 ;
...
if ( ! F_14 ( V_1 -> V_28 , V_29 ) )
return - V_30 ;
if ( F_20 ( V_19 , ( void T_1 * ) args [ 1 ] , V_104 ) )
return - V_25 ;
V_19 [ V_104 - 1 ] = 0 ;
if ( args [ 0 ] == V_102 )
...
int F_40 ( struct V_1 * V_1 , unsigned int V_34 , void T_1 * V_98 )
{
switch ( V_34 ) {
case V_105 :
case V_106 :
return F_37 ( V_1 , V_98 ) ;
case V_107 :
case V_108 :
{
char V_19 [ V_104 ] ;
...
case V_110 :
case V_111 :
return F_12 ( V_11 , V_33 -> V_112 , V_34 == V_110 ) ;
}
F_42 ( V_11 , L_1 , V_34 ) ;
return - V_35 ;
}
