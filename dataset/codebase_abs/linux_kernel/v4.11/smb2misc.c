...
F_34 ( char * V_134 )
{
struct V_113 * V_114 = (struct V_113 * ) V_134 ;
struct V_31 * V_32 , * V_135 , * V_136 ;
struct V_15 * V_118 ;
struct V_29 * V_30 ;
struct V_111 * V_112 ;
struct V_104 * V_105 ;
V_105 = F_35 ( sizeof( struct V_104 ) , V_137 ) ;
if ( ! V_105 )
return false ;
...
V_118 = F_10 ( V_32 , struct V_15 , V_138 ) ;
F_9 (tmp1, &server->smb_ses_list) {
V_30 = F_10 ( V_135 , struct V_29 , V_34 ) ;
F_9 (tmp2, &ses->tcon_list) {
V_112 = F_10 ( V_136 , struct V_111 ,
V_139 ) ;
F_8 ( & V_112 -> V_140 ) ;
F_37 (
& V_112 -> V_141 . V_142 . V_143 ) ;
...
bool
F_38 ( char * V_134 , struct V_15 * V_118 )
{
struct V_144 * V_114 = (struct V_144 * ) V_134 ;
struct V_31 * V_32 , * V_135 , * V_136 ;
struct V_29 * V_30 ;
struct V_111 * V_112 ;
struct V_96 * V_97 ;
...
F_3 ( V_24 , L_31 , V_114 -> V_146 ) ;
F_8 ( & V_33 ) ;
F_9 (tmp, &server->smb_ses_list) {
V_30 = F_10 ( V_32 , struct V_29 , V_34 ) ;
F_9 (tmp1, &ses->tcon_list) {
V_112 = F_10 ( V_135 , struct V_111 , V_139 ) ;
F_37 ( & V_112 -> V_141 . V_142 . V_143 ) ;
F_8 ( & V_112 -> V_140 ) ;
F_9 (tmp2, &tcon->openFileList) {
V_117 = F_10 ( V_136 , struct V_116 ,
V_124 ) ;
if ( V_114 -> V_147 !=
V_117 -> V_148 . V_149 ||
V_114 -> V_150 !=
...
{
struct V_157 * V_158 = F_23 ( V_103 ,
struct V_157 , V_103 ) ;
F_3 ( V_12 , L_35 ) ;
F_42 ( 0 , V_158 -> V_112 , V_158 -> V_148 . V_149 ,
V_158 -> V_148 . V_151 ) ;
F_43 ( V_158 -> V_112 ) ;
F_27 ( V_158 ) ;
}
int
F_44 ( char * V_134 , struct V_15 * V_118 )
{
struct V_1 * V_145 = F_6 ( V_134 ) ;
struct V_60 * V_114 = (struct V_60 * ) V_134 ;
struct V_111 * V_112 ;
struct V_157 * V_158 ;
if ( V_145 -> V_10 != V_59 ||
V_145 -> V_37 != V_159 )
return 0 ;
V_158 = F_45 ( sizeof( * V_158 ) , V_137 ) ;
if ( ! V_158 )
return - V_160 ;
V_112 = F_46 ( V_118 , V_145 -> V_36 ,
V_145 -> V_161 ) ;
if ( ! V_112 ) {
F_27 ( V_158 ) ;
return - V_162 ;
}
V_158 -> V_148 . V_149 = V_114 -> V_163 ;
V_158 -> V_148 . V_151 = V_114 -> V_164 ;
V_158 -> V_112 = V_112 ;
F_36 ( & V_158 -> V_103 , F_41 ) ;
F_31 ( V_131 , & V_158 -> V_103 ) ;
return 0 ;
}
