...
{
struct V_49 * V_50 , * V_60 , * V_7 ;
int V_2 ;
V_60 = F_20 ( sizeof( struct V_49 ) , V_61 ) ;
if ( ! V_60 )
return F_21 ( - V_62 ) ;
F_22 ( & V_63 ) ;
V_50 = NULL ;
V_2 = F_1 ( V_1 ) ;
F_23 (tmp, &dasd_hashlists[hash], list)
...
if ( ! V_50 ) {
V_60 -> V_64 = V_65 ++ ;
strncpy ( V_60 -> V_1 , V_1 , V_4 ) ;
V_60 -> V_24 = V_24 ;
V_60 -> V_66 = NULL ;
F_24 ( & V_60 -> V_67 , & V_68 [ V_2 ] ) ;
V_50 = V_60 ;
V_60 = NULL ;
}
F_25 ( & V_63 ) ;
...
F_23 (tmp, &dasd_hashlists[i], list)
if ( V_7 -> V_64 == V_64 ) {
V_50 = V_7 ;
break;
}
...
static T_3 F_60 ( struct V_66 * V_75 , struct V_83 * V_84 ,
char * V_85 )
{
struct V_49 * V_50 ;
int V_86 ;
...
static T_3 F_61 ( struct V_66 * V_75 , struct V_83 * V_84 ,
const char * V_85 , T_2 V_87 )
{
unsigned int V_14 ;
int V_26 ;
...
V_50 = F_27 ( F_36 ( V_75 ) ) ;
if ( ! F_17 ( V_50 ) )
V_88 = ( V_50 -> V_24 & V_28 ) != 0 ;
else
V_88 = ( V_27 & V_28 ) != 0 ;
return snprintf ( V_85 , V_41 , V_88 ? L_32 : L_33 ) ;
}
static T_3
F_65 ( struct V_66 * V_75 , struct V_83 * V_84 ,
const char * V_85 , T_2 V_87 )
{
...
V_50 = F_27 ( F_36 ( V_75 ) ) ;
if ( ! F_17 ( V_50 ) )
V_94 = ( V_50 -> V_24 & V_31 ) != 0 ;
else
V_94 = ( V_27 & V_31 ) != 0 ;
return snprintf ( V_85 , V_41 , V_94 ? L_32 : L_33 ) ;
}
static T_3
...
V_50 = F_27 ( F_36 ( V_75 ) ) ;
if ( ! F_17 ( V_50 ) )
V_95 = ( V_50 -> V_24 & V_29 ) != 0 ;
else
V_95 = ( V_27 & V_29 ) != 0 ;
return sprintf ( V_85 , V_95 ? L_32 : L_33 ) ;
}
static T_3
...
V_50 = F_27 ( F_36 ( V_75 ) ) ;
if ( ! F_17 ( V_50 ) )
V_97 = ( V_50 -> V_24 & V_30 ) != 0 ;
else
V_97 = ( V_27 & V_30 ) != 0 ;
return sprintf ( V_85 , V_97 ? L_32 : L_33 ) ;
}
static T_3
...
if ( ! V_66 -> V_100 )
V_87 = - V_69 ;
else if ( ! V_66 -> V_100 -> V_101 )
V_87 = - V_102 ;
else
V_87 = V_66 -> V_100 -> V_101 ( V_66 ) ;
F_47 ( V_66 ) ;
if ( V_87 < 0 )
return V_87 ;
...
static T_3 F_83 ( struct V_66 * V_75 ,
...
if ( V_66 -> V_100 && V_66 -> V_100 -> V_113 &&
! V_66 -> V_100 -> V_113 ( V_66 , & V_112 ) ) {
if ( V_112 . type == V_114 ||
V_112 . type == V_115 ) {
F_47 ( V_66 ) ;
...
static T_3 F_84 ( struct V_66 * V_75 ,
struct V_83 * V_84 , char * V_85 )
{
struct V_72 * V_66 ;
struct V_111 V_112 ;
...
V_117 [ 0 ] = 0 ;
if ( F_17 ( V_66 ) )
return snprintf ( V_85 , V_41 , L_35 , V_117 ) ;
if ( V_66 -> V_100 && V_66 -> V_100 -> V_113 &&
! V_66 -> V_100 -> V_113 ( V_66 , & V_112 ) ) {
switch ( V_112 . type ) {
case V_120 :
snprintf ( V_119 , sizeof( V_119 ) , L_46 ,
V_112 . V_121 ) ;
break;
case V_114 :
snprintf ( V_119 , sizeof( V_119 ) , L_46 ,
...
break;
case V_115 :
snprintf ( V_119 , sizeof( V_119 ) , L_47 ) ;
break;
default:
snprintf ( V_119 , sizeof( V_119 ) , L_46 ,
V_112 . V_121 ) ;
...
if ( strlen ( V_112 . V_123 ) > 0 )
snprintf ( V_117 , sizeof( V_117 ) ,
L_48 ,
V_112 . V_116 , V_112 . V_124 , V_112 . V_23 , V_119 ,
V_112 . V_123 ) ;
else
snprintf ( V_117 , sizeof( V_117 ) ,
L_49 ,
...
V_125 = F_87 ( V_50 -> V_66 ) ;
else
V_125 = 0 ;
return snprintf ( V_85 , V_41 , V_125 ? L_32 : L_33 ) ;
}
static T_3
...
if ( F_17 ( V_66 ) )
return - V_69 ;
V_25 = snprintf ( V_85 , V_41 , L_50 , V_66 -> V_126 ) ;
F_47 ( V_66 ) ;
return V_25 ;
}
static T_3
...
if ( F_17 ( V_66 ) )
return - V_69 ;
V_25 = snprintf ( V_85 , V_41 , L_50 , V_66 -> V_128 ) ;
F_47 ( V_66 ) ;
return V_25 ;
}
static T_3
...
if ( F_17 ( V_66 ) )
return - V_69 ;
V_25 = snprintf ( V_85 , V_41 , L_50 , V_66 -> V_130 ) ;
F_47 ( V_66 ) ;
return V_25 ;
}
static T_3
...
V_132 = V_66 -> V_90 -> V_131 ;
if ( ! V_132 ) {
F_47 ( V_66 ) ;
return - V_69 ;
}
F_42 ( & V_66 -> V_90 -> V_135 , V_76 ) ;
if ( ! V_14 )
F_97 ( V_132 , NULL ) ;
else
F_97 ( V_132 , V_136 ) ;
V_66 -> V_130 = V_14 ;
F_98 ( V_132 , V_66 -> V_130 * V_134 ) ;
F_45 ( & V_66 -> V_90 -> V_135 , V_76 ) ;
F_47 ( V_66 ) ;
return V_87 ;
}
static T_3
...
V_14 = 0 ;
if ( V_66 -> V_100 && V_66 -> V_100 -> V_137 )
V_66 -> V_100 -> V_137 ( V_66 , ( V_138 ) V_14 ) ;
F_47 ( V_66 ) ;
return V_87 ;
}
static T_3 F_100 ( struct V_66 * V_75 , struct V_83 * V_84 ,
char * V_85 )
{
struct V_72 * V_66 ;
int V_139 ;
...
if ( F_17 ( V_66 ) )
return - V_69 ;
if ( ! V_66 -> V_100 || ! V_66 -> V_100 -> V_140 ) {
F_47 ( V_66 ) ;
return snprintf ( V_85 , V_41 , L_34 , V_39 ) ;
}
V_139 = V_66 -> V_100 -> V_140 ( V_66 ) ;
F_47 ( V_66 ) ;
return snprintf ( V_85 , V_41 , L_34 , V_139 ) ;
}
static T_3 F_101 ( struct V_66 * V_75 ,
struct V_83 * V_84 ,
char * V_85 )
{
struct V_49 * V_50 ;
...
static T_3 F_102 ( struct V_66 * V_75 ,
struct V_83 * V_84 ,
const char * V_85 , T_2 V_87 )
{
struct V_73 * V_74 = F_63 ( V_75 ) ;
int V_26 ;
if ( F_103 ( L_53 , V_85 ) )
V_26 = F_62 ( V_74 , V_141 , 0 ) ;
else if ( F_103 ( L_54 , V_85 ) )
V_26 = F_62 ( V_74 , V_141 , 1 ) ;
else
V_26 = - V_19 ;
return V_26 ? : V_87 ;
}
static T_3 F_104 ( struct V_66 * V_75 ,
struct V_83 * V_84 ,
char * V_85 )
{
struct V_72 * V_66 ;
...
if ( F_66 ( V_142 , & V_66 -> V_76 ) )
V_26 = snprintf ( V_85 , V_41 , L_55 ) ;
else if ( F_66 ( V_143 , & V_66 -> V_76 ) )
...
static T_3 F_105 ( struct V_66 * V_75 ,
struct V_83 * V_84 ,
const char * V_85 , T_2 V_87 )
{
struct V_72 * V_66 ;
...
static T_3 F_107 ( struct V_66 * V_75 ,
struct V_83 * V_84 , char * V_85 )
{
struct V_72 * V_66 ;
T_4 V_144 , V_145 , V_146 , V_147 , V_148 , V_149 ;
V_66 = F_57 ( F_63 ( V_75 ) ) ;
if ( F_17 ( V_66 ) )
return sprintf ( V_85 , L_33 ) ;
V_144 = F_108 ( V_66 ) ;
...
V_149 = F_113 ( V_66 ) ;
F_47 ( V_66 ) ;
return sprintf ( V_85 , L_58 , V_144 , V_145 ,
...
if ( F_17 ( V_66 ) )
return - V_69 ;
V_25 = snprintf ( V_85 , V_41 , L_50 , V_66 -> V_150 ) ;
F_47 ( V_66 ) ;
return V_25 ;
}
static T_3
...
if ( F_17 ( V_66 ) )
return - V_69 ;
if ( F_76 ( V_85 , 10 , & V_14 ) != 0 || V_14 > V_151 ) {
F_47 ( V_66 ) ;
return - V_19 ;
}
...
if ( F_17 ( V_66 ) )
return - V_69 ;
V_25 = snprintf ( V_85 , V_41 , L_50 , V_66 -> V_152 ) ;
F_47 ( V_66 ) ;
return V_25 ;
}
static T_3
...
int
F_118 ( struct V_73 * V_74 , int V_154 )
{
struct V_49 * V_50 ;
V_50 = F_27 ( F_36 ( & V_74 -> V_75 ) ) ;
if ( F_17 ( V_50 ) )
return F_18 ( V_50 ) ;
return ( ( V_50 -> V_24 & V_154 ) != 0 ) ;
}
int
F_62 ( struct V_73 * V_74 , int V_154 , int V_155 )
{
struct V_49 * V_50 ;
V_50 = F_35 ( V_74 ) ;
if ( F_17 ( V_50 ) )
...
{
return F_120 ( & V_74 -> V_75 . V_156 , & V_157 ) ;
}
void
F_121 ( struct V_73 * V_74 )
{
F_122 ( & V_74 -> V_75 . V_156 , & V_157 ) ;
}
int
F_123 ( void )
{
