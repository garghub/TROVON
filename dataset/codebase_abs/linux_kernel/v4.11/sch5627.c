...
static int F_13 ( T_1 V_36 )
{
return ( V_36 * 625 ) / 10 - 64000 ;
}
static int F_14 ( T_2 V_36 )
{
return ( V_36 - 64 ) * 1000 ;
}
static int F_15 ( T_1 V_36 )
{
if ( V_36 == 0 )
return - V_37 ;
if ( V_36 == 0xffff )
...
static T_3 F_16 ( struct V_2 * V_3 , struct V_38 * V_39 ,
char * V_40 )
{
return snprintf ( V_40 , V_41 , L_1 , V_42 ) ;
}
static T_3 F_17 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
...
static T_3 F_21 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
...
static T_3 F_22 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
struct V_1 * V_4 = F_2 ( V_3 ) ;
...
static T_3 F_23 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
struct V_1 * V_4 = F_2 ( V_3 ) ;
...
static T_3 F_24 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
...
static T_3 F_25 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
...
static T_3 F_26 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
struct V_1 * V_4 = F_2 ( V_3 ) ;
...
static T_3 F_27 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
...
static T_3 F_29 ( struct V_2 * V_3 , struct V_38
* V_39 , char * V_40 )
{
struct V_43 * V_44 = F_18 ( V_39 ) ;
...
V_4 = F_36 ( & V_49 -> V_3 , sizeof( struct V_1 ) ,
V_58 ) ;
if ( ! V_4 )
return - V_59 ;
V_4 -> V_12 = F_37 ( V_49 , V_60 , 0 ) -> V_61 ;
F_38 ( & V_4 -> V_8 ) ;
F_39 ( V_49 , V_4 ) ;
...
if ( V_54 )
goto error;
F_41 ( L_8 , V_42 , V_4 -> V_12 ) ;
F_41 ( L_9 ,
V_55 , V_56 , V_57 ) ;
V_54 = F_42 ( & V_49 -> V_3 . V_52 , & V_53 ) ;
if ( V_54 )
goto error;
V_4 -> V_51 = F_43 ( & V_49 -> V_3 ) ;
if ( F_19 ( V_4 -> V_51 ) ) {
V_54 = F_20 ( V_4 -> V_51 ) ;
V_4 -> V_51 = NULL ;
goto error;
}
V_4 -> V_50 = F_44 ( & V_49 -> V_3 , V_4 -> V_12 ,
( V_55 << 24 ) | ( V_56 << 8 ) | V_57 ,
& V_4 -> V_8 , 1 ) ;
return 0 ;
error:
