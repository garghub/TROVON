...
if ( V_9 -> V_20 == V_49 || V_9 -> V_20 == V_50 )
...
static inline T_1 F_84 ( struct V_1 * V_2 ,
struct V_3 * V_4 ,
char * V_5 )
{
struct V_130 * V_131 = F_85 ( V_4 ) ;
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = F_3 ( V_7 ) ;
T_2 V_93 ;
int V_37 ;
...
int F_92 ( struct V_1 * V_2 , struct V_135 * V_14 ,
const char * V_136 )
{
struct V_8 * V_9 ;
struct V_6 * V_109 ;
