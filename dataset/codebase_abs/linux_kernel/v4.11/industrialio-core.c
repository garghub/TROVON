...
V_166 = V_25 ;
else if ( F_50 ( V_13 , L_45 ) )
V_166 = V_26 ;
else if ( F_50 ( V_13 , L_46 ) )
V_166 = V_27 ;
else if ( F_50 ( V_13 , L_47 ) )
V_166 = V_28 ;
else if ( F_50 ( V_13 , L_48 ) )
V_166 = V_29 ;
else
return - V_52 ;
...
if ( V_3 -> V_179 & ( V_180 | V_181 ) )
F_98 ( V_3 ) ;
F_99 ( V_3 ) ;
F_96 ( V_3 ) ;
F_100 ( V_3 -> V_182 ) ;
F_101 ( & V_183 , V_3 -> V_184 ) ;
F_78 ( V_3 ) ;
}
struct V_2 * F_102 ( int V_185 )
{
struct V_2 * V_10 ;
T_7 V_186 ;
V_186 = sizeof( struct V_2 ) ;
if ( V_185 ) {
V_186 = F_103 ( V_186 , V_187 ) ;
V_186 += V_185 ;
}
V_186 += V_187 - 1 ;
V_10 = F_81 ( V_186 , V_125 ) ;
if ( V_10 ) {
V_10 -> V_10 . V_177 = V_10 -> V_177 ;
V_10 -> V_10 . type = & V_188 ;
V_10 -> V_10 . V_189 = & V_32 ;
F_104 ( & V_10 -> V_10 ) ;
F_105 ( & V_10 -> V_10 , ( void * ) V_10 ) ;
F_106 ( & V_10 -> V_19 ) ;
F_106 ( & V_10 -> V_190 ) ;
F_107 ( & V_10 -> V_153 ) ;
V_10 -> V_184 = F_108 ( & V_183 , 0 , 0 , V_125 ) ;
if ( V_10 -> V_184 < 0 ) {
F_23 ( L_49 ) ;
F_78 ( V_10 ) ;
return NULL ;
}
F_109 ( & V_10 -> V_10 , L_50 , V_10 -> V_184 ) ;
F_107 ( & V_10 -> V_191 ) ;
}
return V_10 ;
}
void F_110 ( struct V_2 * V_10 )
{
if ( V_10 )
F_111 ( & V_10 -> V_10 ) ;
}
static void F_112 ( struct V_9 * V_10 , void * V_192 )
{
F_110 ( * (struct V_2 * * ) V_192 ) ;
}
int F_113 ( struct V_9 * V_10 , void * V_192 , void * V_193 )
{
struct V_2 * * V_194 = V_192 ;
if ( ! V_194 || ! * V_194 ) {
F_114 ( ! V_194 || ! * V_194 ) ;
return 0 ;
}
...
struct V_2 * F_115 ( struct V_9 * V_10 , int V_185 )
{
struct V_2 * * V_195 , * V_2 ;
V_195 = F_116 ( F_112 , sizeof( * V_195 ) ,
V_125 ) ;
if ( ! V_195 )
return NULL ;
V_2 = F_102 ( V_185 ) ;
...
void F_119 ( struct V_9 * V_10 , struct V_2 * V_2 )
{
int V_196 ;
V_196 = F_120 ( V_10 , F_112 ,
F_113 , V_2 ) ;
F_114 ( V_196 ) ;
}
static int F_121 ( struct V_197 * V_197 , struct V_38 * V_198 )
{
struct V_2 * V_3 = F_122 ( V_197 -> V_199 ,
struct V_2 , V_200 ) ;
if ( F_123 ( V_201 , & V_3 -> V_202 ) )
return - V_20 ;
F_124 ( V_3 ) ;
V_198 -> V_42 = V_3 ;
return 0 ;
}
static int F_125 ( struct V_197 * V_197 , struct V_38 * V_198 )
{
struct V_2 * V_3 = F_122 ( V_197 -> V_199 ,
struct V_2 , V_200 ) ;
F_126 ( V_201 , & V_3 -> V_202 ) ;
F_127 ( V_3 ) ;
return 0 ;
}
static long F_128 ( struct V_38 * V_198 , unsigned int V_203 , unsigned long V_204 )
{
struct V_2 * V_3 = V_198 -> V_42 ;
int T_6 * V_205 = ( int T_6 * ) V_204 ;
int V_206 ;
if ( ! V_3 -> V_45 )
return - V_207 ;
if ( V_203 == V_208 ) {
...
if ( V_206 < 0 )
return V_206 ;
if ( F_130 ( V_205 , & V_206 , sizeof( V_206 ) ) )
return - V_51 ;
return 0 ;
}
return - V_52 ;
...
if ( V_7 [ V_5 ] . V_8 < 0 )
continue;
for ( V_209 = V_5 + 1 ; V_209 < V_3 -> V_6 ; V_209 ++ )
if ( V_7 [ V_5 ] . V_8 == V_7 [ V_209 ] . V_8 ) {
F_31 ( & V_3 -> V_10 ,
L_51 ,
V_7 [ V_5 ] . V_8 ) ;
return - V_52 ;
...
if ( V_15 < 0 )
return V_15 ;
V_3 -> V_10 . V_211 = F_133 ( F_134 ( V_34 ) , V_3 -> V_184 ) ;
V_15 = F_38 ( V_3 ) ;
if ( V_15 ) {
F_31 ( V_3 -> V_10 . V_48 ,
L_52 ) ;
...
V_3 -> V_215 == NULL )
V_3 -> V_215 = & V_216 ;
F_138 ( & V_3 -> V_200 , & V_217 ) ;
V_3 -> V_200 . V_218 = V_3 -> V_45 -> V_219 ;
V_3 -> V_200 . V_220 . V_48 = & V_3 -> V_10 . V_220 ;
V_15 = F_139 ( & V_3 -> V_200 , V_3 -> V_10 . V_211 , 1 ) ;
if ( V_15 < 0 )
goto V_221;
V_15 = F_140 ( & V_3 -> V_10 ) ;
if ( V_15 < 0 )
...
static void F_149 ( struct V_9 * V_10 , void * V_192 )
{
F_143 ( * (struct V_2 * * ) V_192 ) ;
}
int F_150 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
struct V_2 * * V_195 ;
int V_15 ;
V_195 = F_116 ( F_149 , sizeof( * V_195 ) , V_125 ) ;
if ( ! V_195 )
return - V_57 ;
* V_195 = V_3 ;
V_15 = F_132 ( V_3 ) ;
...
void F_151 ( struct V_9 * V_10 , struct V_2 * V_3 )
{
int V_196 ;
V_196 = F_120 ( V_10 , F_149 ,
F_113 , V_3 ) ;
F_114 ( V_196 ) ;
}
