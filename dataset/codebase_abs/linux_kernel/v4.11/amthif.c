...
V_2 -> V_3 = false ;
F_14 ( V_2 -> V_2 , L_2 ) ;
V_19 = F_15 ( & V_2 -> V_24 , F_16 ( * V_19 ) , V_25 ) ;
if ( ! V_19 ) {
V_2 -> V_4 = V_5 ;
V_11 -> V_17 = NULL ;
return 0 ;
...
int F_34 ( struct V_1 * V_2 , struct V_16 * V_17 )
{
struct V_10 * V_11 = V_17 -> V_30 ;
if ( V_2 -> V_7 > 0 )
V_2 -> V_7 -- ;
if ( V_11 -> V_17 == V_17 && V_2 -> V_4 != V_5 ) {
F_14 ( V_2 -> V_2 , L_6 ,
V_2 -> V_4 ) ;
V_2 -> V_3 = true ;
}
