...
F_15 ( L_3 ,
V_4 -> V_14 , V_4 -> V_15 - V_4 -> V_14 ) ;
V_84 = F_33 ( sizeof( * V_84 ) , V_85 ) ;
if ( V_84 ) {
V_84 -> V_4 = V_4 ;
V_84 -> V_86 = V_87 -> V_86 ;
F_34 ( & V_84 -> V_52 , & V_28 -> V_88 ) ;
}
}
...
static int F_38 ( struct V_89 * V_90 , struct V_3 * V_4 )
{
...
static int F_46 ( struct V_89 * V_90 , struct V_3 * V_4 )
{
struct V_23 * V_24 = V_90 -> V_26 ;
struct V_27 * V_28 = V_24 -> V_29 -> V_28 ;
struct V_1 * V_2 = NULL ;
...
return F_38 ( V_90 , V_4 ) ;
if ( F_10 ( & V_28 -> V_37 , V_4 -> V_38 , & V_33 ) ) {
F_48 ( L_6 ) ;
return - V_92 ;
}
V_2 = F_11 ( V_33 , struct V_30 , V_33 ) -> V_2 ;
if ( ! V_2 || ( ( V_2 -> V_11 & V_111 ) && ! F_39 ( V_93 ) ) )
return - V_112 ;
if ( V_2 -> V_73 < V_4 -> V_15 - V_4 -> V_14 )
return - V_92 ;
if ( ! F_39 ( V_93 ) && ( V_2 -> V_11 & V_113 ) ) {
V_4 -> V_6 &= ~ ( V_95 | V_96 ) ;
#if F_3 ( V_7 ) || F_3 ( V_8 )
F_40 ( V_4 -> V_97 ) &= ~ V_98 ;
#else
...
int F_52 ( struct V_89 * V_90 , struct V_3 * V_4 )
{
struct V_23 * V_24 = V_90 -> V_26 ;
struct V_27 * V_28 = V_24 -> V_29 -> V_28 ;
int V_118 ;
