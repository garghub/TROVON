...
V_2 = & V_49 -> V_32 . V_10 ;
V_49 -> V_63 . V_2 = V_2 ;
strcpy ( V_51 -> V_96 . V_97 , L_4 ) ;
V_51 -> V_20 = V_98 ;
V_51 -> V_99 = & V_100 ;
V_51 -> V_101 . V_20 = V_102 ;
V_51 -> V_103 = V_22 -> V_104 ;
V_51 -> V_105 = V_22 -> V_94 . V_70 ;
F_37 ( V_51 , V_2 -> V_30 [ 0 ] , V_2 -> V_16 -> V_106 ) ;
F_38 ( V_51 , & V_49 -> V_63 ,
V_65 -> V_107 , V_65 -> V_108 ) ;
V_51 -> V_96 . V_109 = 0 ;
V_51 -> V_96 . V_110 = 0 ;
return 0 ;
V_95:
...
int V_112 = 32 ;
int V_71 ;
V_111 = F_47 ( sizeof( struct V_48 ) , V_113 ) ;
if ( ! V_111 )
return - V_114 ;
V_111 -> V_12 = V_12 ;
V_12 -> V_111 = V_111 ;
F_48 ( & V_111 -> V_46 , F_13 ) ;
F_49 ( V_12 -> V_115 , & V_111 -> V_63 ,
& V_116 ) ;
V_71 = F_50 ( V_12 -> V_115 , & V_111 -> V_63 ,
V_117 ) ;
if ( V_71 ) {
F_51 ( V_111 ) ;
return V_71 ;
