...
V_2 -> V_4 = F_25 ( V_42 , V_40 ) ;
if ( F_26 ( V_2 -> V_4 ) )
return F_27 ( V_2 -> V_4 ) ;
V_40 = F_39 ( V_71 , V_48 , L_7 ) ;
V_2 -> V_18 = F_25 ( V_42 , V_40 ) ;
if ( F_26 ( V_2 -> V_18 ) )
...
static void F_49 ( struct V_1 * V_2 , T_1 V_93 ,
T_4 V_94 , T_4 V_30 )
{
...
static int F_50 ( T_6 * V_96 , T_4 V_30 )
{
...
F_49 ( V_2 , V_93 , V_75 , ~ ( V_30 - 1 ) ) ;
}
static int F_52 ( struct V_116 * V_117 ,
struct V_118 * V_51 )
{
const int V_119 = 3 , V_120 = 2 ;
int V_121 ;
V_117 -> V_51 = V_51 ;
V_117 -> V_122 = F_53 ( V_51 ) ;
V_117 -> V_123 = V_117 -> V_122 + V_119 + V_120 ;
V_117 -> V_102 = F_54 ( V_51 , L_12 , & V_121 ) ;
if ( ! V_117 -> V_102 )
return - V_124 ;
...
if ( V_47 )
return V_47 ;
V_47 = F_64 ( V_131 , 0 , 0xff , & V_40 , & V_133 ) ;
if ( V_47 )
return V_47 ;
V_47 = F_65 ( V_42 , & V_40 ) ;
if ( V_47 )
goto error;
V_47 = F_58 ( V_2 , & V_40 , V_133 ) ;
if ( V_47 )
goto error;
V_10 = F_66 ( V_42 , 0 , & V_136 , V_2 , & V_40 ) ;
if ( ! V_10 ) {
V_47 = - V_56 ;
goto error;
}
