...
* ( ( T_5 * ) ( V_5 + 12 ) ) = V_72 ;
if ( F_98 ( V_41 -> V_36 ) &&
( ! F_99 ( F_100 ( V_41 -> V_36 ) ) ||
V_41 -> V_36 -> V_79 + V_41 -> V_36 -> V_80 <= V_81 ) &&
F_98 ( V_41 -> V_35 ) &&
( ! F_99 ( F_100 ( V_41 -> V_35 ) ) ||
V_41 -> V_35 -> V_79 + V_41 -> V_35 -> V_80 <= V_81 ) ) {
V_70 = 1 ;
F_101 ( & V_75 , V_41 -> V_36 ) ;
V_71 = F_102 ( & V_75 ) ;
V_36 = V_71 + V_41 -> V_78 ;
V_35 = V_36 ;
if ( F_97 ( V_41 -> V_36 != V_41 -> V_35 ) ) {
F_101 ( & V_76 , V_41 -> V_35 ) ;
V_35 = F_102 ( & V_76 ) + V_41 -> V_78 ;
}
} else {
V_71 = F_103 ( V_41 -> V_82 + V_10 + V_41 -> V_78 ,
V_83 ) ;
if ( F_97 ( ! V_71 ) )
return - V_84 ;
F_104 ( V_71 , V_41 -> V_36 , 0 ,
V_41 -> V_78 + V_41 -> V_82 , 0 ) ;
V_36 = V_71 + V_41 -> V_78 ;
V_35 = V_36 ;
}
F_21 () ;
F_105 ( V_12 , V_35 , V_36 , V_41 -> V_82 , V_5 ,
V_1 -> V_6 , V_71 , V_41 -> V_78 - 8 ,
V_35 + V_41 -> V_82 , V_10 ) ;
F_23 () ;
if ( V_70 ) {
if ( F_97 ( V_41 -> V_36 != V_41 -> V_35 ) ) {
F_106 ( V_35 - V_41 -> V_78 ) ;
F_107 ( & V_76 , V_41 -> V_35 -> V_80 ) ;
F_108 ( & V_76 , 1 , 0 ) ;
}
F_106 ( V_71 ) ;
F_107 ( & V_75 , V_41 -> V_36 -> V_80 ) ;
F_108 ( & V_75 , V_41 -> V_36 == V_41 -> V_35 , 0 ) ;
} else {
F_104 ( V_35 , V_41 -> V_35 , V_41 -> V_78 ,
V_41 -> V_82 + V_10 , 1 ) ;
F_109 ( V_71 ) ;
}
return 0 ;
}
static int F_110 ( struct V_69 * V_41 )
{
T_1 V_70 = 0 ;
T_1 * V_36 , * V_35 , * V_71 ;
...
V_71 = F_103 ( V_41 -> V_82 + V_41 -> V_78 , V_83 ) ;
if ( ! V_71 )
return - V_84 ;
F_104 ( V_71 , V_41 -> V_36 , 0 ,
V_41 -> V_78 + V_41 -> V_82 , 0 ) ;
...
F_21 () ;
F_111 ( V_12 , V_35 , V_36 , V_85 , V_5 ,
V_1 -> V_6 , V_71 , V_41 -> V_78 - 8 ,
V_87 , V_10 ) ;
F_23 () ;
V_86 = F_112 ( V_36 + V_85 , V_87 , V_10 ) ?
- V_88 : 0 ;
if ( V_70 ) {
if ( F_97 ( V_41 -> V_36 != V_41 -> V_35 ) ) {
F_106 ( V_35 - V_41 -> V_78 ) ;
...
static int F_113 ( struct V_69 * V_41 )
{
struct V_19 * V_20 = F_94 ( V_41 ) ;
...
static int F_119 ( struct V_69 * V_41 )
{
struct V_19 * V_20 = F_94 ( V_41 ) ;
struct V_57 * * V_1 = F_16 ( V_20 ) ;
struct V_57 * V_58 = * V_1 ;
...
{
int V_77 ;
for ( V_77 = 0 ; V_77 < F_122 ( V_89 ) &&
V_89 [ V_77 ] ; V_77 ++ )
F_123 ( V_89 [ V_77 ] ) ;
for ( V_77 = 0 ; V_77 < F_122 ( V_90 ) ; V_77 ++ )
if ( V_90 [ V_77 ] . V_91 )
F_123 ( V_90 [ V_77 ] . V_91 ) ;
}
...
V_109:
F_121 () ;
F_136 ( V_105 , F_122 ( V_105 ) ) ;
V_106:
F_137 ( V_103 ,
F_122 ( V_103 ) ) ;
V_104:
F_138 ( V_101 , F_122 ( V_101 ) ) ;
V_102:
F_139 () ;
return V_30 ;
}
