...
( ( V_8 & V_19 ) == 0 ) )
V_8 |= V_20 ;
V_9 = F_15 ( V_4 , V_2 , V_2 -> V_13 , V_8 ) ;
if ( V_9 ) {
F_16 ( & V_2 -> V_13 -> V_2 , L_1 ) ;
goto V_21;
}
V_9 = F_17 ( V_4 ) ;
if ( V_9 )
F_16 ( & V_2 -> V_13 -> V_2 , L_2 ) ;
if ( ! V_9 ) {
V_10 = F_18 ( V_4 ) ;
if ( V_10 )
F_19 ( & V_2 -> V_13 -> V_2 ,
...
static int F_31 ( struct V_1 * V_2 , void * V_28 , struct V_22 * V_29 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
if ( F_44 ( V_36 , ( char * ) V_25 , V_37 ) ) {
F_33 ( L_14 , V_56 , __LINE__ ) ;
return - V_57 ;
}
return 0 ;
}
...
int F_48 ( struct V_1 * V_2 , struct V_22 * V_169 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
int V_9 ;
V_169 -> V_170 = NULL ;
...
V_9 = F_51 ( V_4 -> V_176 . V_177 , false ) ;
if ( V_9 ) {
F_52 ( V_4 , V_174 ) ;
F_10 ( V_172 ) ;
goto V_175;
}
V_174 -> V_178 = F_53 ( V_4 , V_174 ,
V_4 -> V_176 . V_177 ) ;
V_9 = F_54 ( V_4 , V_174 -> V_178 ,
V_179 ,
V_180 |
V_181 ) ;
if ( V_9 ) {
...
if ( ! V_9 ) {
if ( V_174 -> V_178 )
F_56 ( V_4 , V_174 -> V_178 ) ;
F_57 ( V_4 -> V_176 . V_177 ) ;
}
F_52 ( V_4 , V_174 ) ;
}
F_10 ( V_172 ) ;
