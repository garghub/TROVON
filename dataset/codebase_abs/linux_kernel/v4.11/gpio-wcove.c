...
struct V_11 * V_12 = F_7 ( V_22 ) ;
int V_1 , V_55 , V_68 , V_28 = 0 ;
for ( V_1 = 0 ; V_1 < V_69 ; V_1 ++ ) {
V_68 = V_1 < V_14 ? 0 : 1 ;
V_28 += F_11 ( V_12 -> V_18 , F_1 ( V_1 , V_23 ) , & V_64 ) ;
V_28 += F_11 ( V_12 -> V_18 , F_1 ( V_1 , V_8 ) , & V_65 ) ;
V_28 += F_11 ( V_12 -> V_18 , V_15 + V_68 ,
& V_66 ) ;
V_28 += F_11 ( V_12 -> V_18 , V_57 + V_68 ,
& V_67 ) ;
if ( V_28 ) {
F_31 ( L_3 ) ;
break;
...
V_55 = V_1 % 8 ;
F_32 ( V_63 , L_4 ,
V_1 , V_64 & V_29 ? L_5 : L_6 ,
V_65 & 0x1 ? L_7 : L_8 ,
V_65 & V_45 ? L_9 : L_10 ,
V_65 & V_43 ? L_11 : L_10 ,
V_64 ,
V_66 & F_3 ( V_55 ) ? L_12 : L_13 ,
V_67 & F_3 ( V_55 ) ? L_14 : L_15 ) ;
}
}
...
return V_52 ;
V_58 = & V_71 -> V_58 ;
V_12 = F_36 ( V_58 , sizeof( * V_12 ) , V_77 ) ;
if ( ! V_12 )
return - V_78 ;
V_12 -> V_79 = V_73 -> V_80 ;
F_37 ( V_71 , V_12 ) ;
...
V_28 = F_40 ( & V_12 -> V_22 , & V_94 , 0 ,
V_95 , V_39 ) ;
if ( V_28 ) {
F_26 ( V_58 , L_17 , V_28 ) ;
return V_28 ;
}
V_54 = F_41 ( V_12 -> V_79 , V_52 ) ;
if ( V_54 < 0 ) {
F_26 ( V_58 , L_18 , V_52 ) ;
return V_54 ;
}
V_28 = F_42 ( V_58 , V_54 , NULL ,
F_24 , V_96 , V_71 -> V_97 , V_12 ) ;
if ( V_28 ) {
F_26 ( V_58 , L_19 , V_54 ) ;
return V_28 ;
}
F_43 ( & V_12 -> V_22 , & V_94 , V_54 ) ;
return 0 ;
}
