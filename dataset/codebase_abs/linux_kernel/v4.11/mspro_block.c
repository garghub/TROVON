...
static void F_65 ( struct V_165 * V_151 )
{
struct V_99 * V_13 = V_151 -> V_166 ;
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_167 * V_168 = NULL ;
if ( V_8 -> V_162 )
return;
if ( V_8 -> V_169 ) {
while ( ( V_168 = F_54 ( V_151 ) ) != NULL )
F_66 ( V_168 , - V_170 ) ;
return;
}
V_8 -> V_162 = 1 ;
...
static int F_67 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
V_13 -> V_103 = F_26 ;
V_8 -> V_104 = F_33 ;
...
static int F_68 ( struct V_99 * V_13 ,
unsigned char V_171 )
{
struct V_172 * V_156 = V_13 -> V_156 ;
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_139 V_140 = {
. system = V_171 ,
. V_141 = 0 ,
...
V_8 -> system = V_174 ;
V_156 -> V_176 ( V_156 , V_177 , V_178 ) ;
F_70 ( V_179 L_64 ,
F_71 ( & V_13 -> V_42 ) ) ;
if ( V_8 -> V_123 & V_180 ) {
V_10 = F_68 ( V_13 , V_181 ) ;
if ( ! V_10 ) {
V_8 -> system = V_181 ;
V_156 -> V_176 ( V_156 , V_177 ,
V_182 ) ;
F_70 ( V_179
L_65 ,
F_71 ( & V_13 -> V_42 ) ) ;
...
F_71 ( & V_13 -> V_42 ) ) ;
V_8 -> system = V_183 ;
V_156 -> V_176 ( V_156 , V_184 , V_185 ) ;
F_72 ( 10 ) ;
V_156 -> V_176 ( V_156 , V_184 , V_186 ) ;
V_156 -> V_176 ( V_156 , V_177 , V_187 ) ;
V_10 = F_73 ( V_13 ) ;
if ( ! V_10 )
V_10 = F_68 ( V_13 , V_8 -> system ) ;
if ( ! V_10 ) {
F_72 ( 150 ) ;
V_10 = F_67 ( V_13 ) ;
if ( V_10 )
...
static int F_74 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_188 * V_29 = NULL ;
struct V_27 * V_44 = NULL ;
unsigned char * V_43 = NULL ;
int V_45 , V_10 , V_189 ;
unsigned int V_190 , V_191 = 0 , V_192 = V_8 -> V_59 ;
V_29 = F_75 ( V_8 -> V_59 , V_193 ) ;
if ( ! V_29 )
return - V_152 ;
F_76 ( & V_8 -> V_128 [ 0 ] , V_29 , V_8 -> V_59 ) ;
V_8 -> V_131 = 1 ;
V_8 -> V_129 = 0 ;
V_8 -> V_127 = 0 ;
V_8 -> V_135 = V_136 ;
V_8 -> V_119 = V_194 ;
V_8 -> V_153 ( V_13 , V_191 , V_192 ) ;
F_53 ( V_13 -> V_156 ) ;
F_62 ( & V_13 -> V_164 ) ;
if ( V_13 -> V_102 . error ) {
V_10 = V_13 -> V_102 . error ;
...
if ( F_18 ( V_29 -> V_196 ) != V_197 ) {
F_70 ( V_198 L_68 ,
F_71 ( & V_13 -> V_42 ) , F_18 ( V_29 -> V_196 ) ) ;
V_10 = - V_170 ;
goto V_195;
}
if ( V_29 -> V_148 > V_199 ) {
...
V_189 = V_29 -> V_148 ;
V_8 -> V_200 . V_201 = F_77 ( V_189 + 1 ,
sizeof( * V_8 -> V_200 . V_201 ) ,
V_193 ) ;
if ( ! V_8 -> V_200 . V_201 ) {
V_10 = - V_152 ;
goto V_195;
...
V_8 -> V_200 . V_91 = L_70 ;
V_43 = F_78 ( V_29 , V_192 , V_193 ) ;
if ( ! V_43 ) {
V_10 = - V_152 ;
goto V_195;
}
for ( V_45 = 0 ; V_45 < V_189 ; ++ V_45 ) {
V_44 = F_79 ( sizeof( struct V_27 ) , V_193 ) ;
if ( ! V_44 ) {
V_10 = - V_152 ;
goto V_202;
}
V_8 -> V_200 . V_201 [ V_45 ] = & V_44 -> V_31 . V_29 ;
V_190 = F_20 ( V_29 -> V_203 [ V_45 ] . V_204 ) ;
V_44 -> V_46 = F_20 ( V_29 -> V_203 [ V_45 ] . V_46 ) ;
F_34 ( & V_13 -> V_42 , L_71
L_72 , V_45 , V_29 -> V_203 [ V_45 ] . V_205 , V_190 ,
V_44 -> V_46 ) ;
V_44 -> V_205 = V_29 -> V_203 [ V_45 ] . V_205 ;
if ( F_14 ( V_44 -> V_205 ) )
snprintf ( V_44 -> V_91 , sizeof( V_44 -> V_91 ) , L_35 ,
F_14 ( V_29 -> V_203 [ V_45 ] . V_205 ) ) ;
else
snprintf ( V_44 -> V_91 , sizeof( V_44 -> V_91 ) ,
L_73 , V_29 -> V_203 [ V_45 ] . V_205 ) ;
F_80 ( & V_44 -> V_31 . V_29 ) ;
V_44 -> V_31 . V_29 . V_91 = V_44 -> V_91 ;
V_44 -> V_31 . V_29 . V_3 = V_206 ;
V_44 -> V_31 . V_207 = F_25 ( V_44 -> V_205 ) ;
if ( ! V_44 -> V_46 )
continue;
V_44 -> V_48 = F_75 ( V_44 -> V_46 , V_193 ) ;
if ( ! V_44 -> V_48 ) {
V_10 = - V_152 ;
goto V_202;
}
if ( ( ( V_190 / V_8 -> V_59 ) == ( V_191 / V_8 -> V_59 ) )
&& ( ( ( V_190 + V_44 -> V_46 - 1 ) / V_8 -> V_59 )
== ( V_191 / V_8 -> V_59 ) ) ) {
memcpy ( V_44 -> V_48 , V_43 + V_190 % V_8 -> V_59 ,
V_44 -> V_46 ) ;
continue;
}
V_191 = ( V_190 / V_8 -> V_59 ) * V_8 -> V_59 ;
if ( ( V_191 + V_192 ) < ( V_190 + V_44 -> V_46 ) ) {
F_7 ( V_43 ) ;
V_192 = ( ( ( V_190 + V_44 -> V_46 ) / V_8 -> V_59 )
+ 1 ) * V_8 -> V_59 - V_191 ;
V_43 = F_75 ( V_192 , V_193 ) ;
if ( ! V_43 ) {
V_10 = - V_152 ;
goto V_195;
}
}
F_76 ( & V_8 -> V_128 [ 0 ] , V_43 , V_192 ) ;
V_8 -> V_131 = 1 ;
V_8 -> V_129 = 0 ;
V_8 -> V_127 = 0 ;
V_8 -> V_135 = V_136 ;
...
V_8 -> system = V_183 ;
V_8 -> V_153 = F_43 ;
V_13 -> V_208 . V_209 = F_32 ( struct V_210 , V_211 ) ;
V_13 -> V_208 . V_212 = sizeof( struct V_105 ) ;
V_13 -> V_208 . V_213 = F_32 ( struct V_210 , V_140 ) ;
V_13 -> V_208 . V_214 = sizeof( struct V_139 ) ;
if ( F_73 ( V_13 ) )
return - V_215 ;
...
V_13 -> V_103 = F_26 ;
V_8 -> V_104 = F_31 ;
F_36 ( & V_13 -> V_102 , V_216 , NULL ,
sizeof( struct V_105 ) ) ;
F_53 ( V_13 -> V_156 ) ;
F_62 ( & V_13 -> V_164 ) ;
if ( V_13 -> V_102 . error )
return V_13 -> V_102 . error ;
F_34 ( & V_13 -> V_42 , L_76 , V_8 -> V_16 ? 0 : 1 ) ;
V_8 -> V_59 = 512 ;
V_10 = F_74 ( V_13 ) ;
if ( V_10 )
return V_10 ;
...
struct V_7 * V_8 = F_27 ( V_13 ) ;
struct V_172 * V_156 = V_13 -> V_156 ;
struct V_95 * V_217 = NULL ;
struct V_50 * V_218 = NULL ;
struct V_27 * V_44 = NULL ;
int V_10 , V_18 ;
T_5 V_219 = V_220 ;
unsigned long V_221 ;
if ( V_156 -> V_42 . V_222 && * ( V_156 -> V_42 . V_222 ) )
V_219 = * ( V_156 -> V_42 . V_222 ) ;
for ( V_10 = 0 ; V_8 -> V_200 . V_201 [ V_10 ] ; ++ V_10 ) {
V_44 = F_12 ( V_8 -> V_200 . V_201 [ V_10 ] ) ;
if ( V_44 -> V_205 == V_40 )
V_217 = V_44 -> V_48 ;
else if ( V_44 -> V_205 == V_33 )
V_218 = V_44 -> V_48 ;
}
if ( ! V_217 || ! V_218 )
return - V_170 ;
V_8 -> V_26 = F_18 ( V_217 -> V_26 ) ;
V_8 -> V_23 = F_18 ( V_217 -> V_23 ) ;
V_8 -> V_25 = F_18 ( V_217 -> V_25 ) ;
V_8 -> V_59 = F_18 ( V_218 -> V_71 ) ;
F_2 ( & V_12 ) ;
V_18 = F_83 ( & V_20 , V_13 , 0 , 256 , V_193 ) ;
F_3 ( & V_12 ) ;
if ( V_18 < 0 )
return V_18 ;
V_8 -> V_5 = F_84 ( 1 << V_19 ) ;
...
V_8 -> V_157 = F_85 ( F_65 , & V_8 -> V_161 ) ;
if ( ! V_8 -> V_157 ) {
V_10 = - V_152 ;
goto V_224;
}
V_8 -> V_157 -> V_166 = V_13 ;
F_86 ( V_8 -> V_157 , V_219 ) ;
F_87 ( V_8 -> V_157 , V_225 ) ;
F_88 ( V_8 -> V_157 , V_226 ) ;
F_89 ( V_8 -> V_157 ,
V_225 * V_8 -> V_59 ) ;
V_8 -> V_5 -> V_227 = V_227 ;
V_8 -> V_5 -> V_228 = V_18 << V_19 ;
V_8 -> V_5 -> V_229 = & V_230 ;
V_8 -> V_14 = 1 ;
V_8 -> V_5 -> V_9 = V_8 ;
V_8 -> V_5 -> V_157 = V_8 -> V_157 ;
sprintf ( V_8 -> V_5 -> V_231 , L_78 , V_18 ) ;
F_90 ( V_8 -> V_157 , V_8 -> V_59 ) ;
V_221 = F_18 ( V_218 -> V_58 ) ;
V_221 *= F_18 ( V_218 -> V_56 ) ;
V_221 *= V_8 -> V_59 >> 9 ;
F_91 ( V_8 -> V_5 , V_221 ) ;
F_34 ( & V_13 -> V_42 , L_79 , V_221 ) ;
F_92 ( & V_13 -> V_42 , V_8 -> V_5 ) ;
V_8 -> V_232 = 1 ;
return 0 ;
V_224:
F_9 ( V_8 -> V_5 ) ;
...
struct V_27 * V_44 ;
if ( V_8 -> V_200 . V_201 ) {
for ( V_45 = 0 ; V_8 -> V_200 . V_201 [ V_45 ] ; ++ V_45 ) {
V_44 = F_12 ( V_8 -> V_200
. V_201 [ V_45 ] ) ;
F_7 ( V_44 -> V_48 ) ;
F_7 ( V_44 ) ;
...
static int F_94 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
return ( V_8 -> V_232 == 1 ) ;
}
...
struct V_7 * V_8 ;
int V_10 = 0 ;
V_8 = F_79 ( sizeof( struct V_7 ) , V_193 ) ;
if ( ! V_8 )
return - V_152 ;
F_96 ( V_13 , V_8 ) ;
V_8 -> V_13 = V_13 ;
...
if ( V_10 )
goto V_233;
V_10 = F_98 ( & V_13 -> V_42 . V_234 , & V_8 -> V_200 ) ;
if ( V_10 )
goto V_233;
V_10 = F_82 ( V_13 ) ;
if ( ! V_10 ) {
...
F_99 ( & V_13 -> V_42 . V_234 , & V_8 -> V_200 ) ;
V_233:
F_96 ( V_13 , NULL ) ;
F_93 ( V_8 ) ;
F_7 ( V_8 ) ;
...
static void F_100 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
static int F_103 ( struct V_99 * V_13 , T_6 V_238 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
F_55 ( & V_8 -> V_161 , V_160 ) ;
...
static int F_104 ( struct V_99 * V_13 )
{
struct V_7 * V_8 = F_27 ( V_13 ) ;
unsigned long V_160 ;
int V_10 = 0 ;
...
struct V_7 * V_239 ;
struct V_172 * V_156 = V_13 -> V_156 ;
struct V_27 * V_44 , * V_240 ;
unsigned char V_45 ;
F_2 ( & V_156 -> V_241 ) ;
V_239 = F_79 ( sizeof( struct V_7 ) , V_193 ) ;
if ( ! V_239 ) {
V_10 = - V_152 ;
goto V_242;
}
...
if ( F_81 ( V_13 ) )
goto V_233;
for ( V_45 = 0 ; V_239 -> V_200 . V_201 [ V_45 ]
&& V_8 -> V_200 . V_201 [ V_45 ] ; ++ V_45 ) {
V_44 = F_12 ( V_239 -> V_200 . V_201 [ V_45 ] ) ;
V_240 = F_12 ( V_8 -> V_200 . V_201 [ V_45 ] ) ;
if ( V_44 -> V_205 == V_33
&& V_240 -> V_205 == V_44 -> V_205 ) {
if ( memcmp ( V_44 -> V_48 , V_240 -> V_48 , V_44 -> V_46 ) )
break;
V_8 -> V_232 = 1 ;
break;
}
...
{
int V_10 = - V_152 ;
V_10 = F_107 ( V_227 , V_243 ) ;
if ( V_10 < 0 ) {
F_70 (KERN_ERR DRIVER_NAME L_81
L_82 , major, rc) ;
return V_10 ;
}
if ( ! V_227 )
