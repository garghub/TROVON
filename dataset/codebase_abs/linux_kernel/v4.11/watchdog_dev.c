...
static T_1 F_32 ( struct V_58 * V_59 , struct V_60 * V_61 ,
char * V_62 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
return sprintf ( V_62 , L_2 , ! ! F_22 ( V_31 , & V_2 -> V_26 ) ) ;
}
static T_1 F_34 ( struct V_58 * V_59 , struct V_60 * V_61 ,
char * V_62 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
struct V_7 * V_8 = V_2 -> V_8 ;
...
static T_1 F_35 ( struct V_58 * V_59 ,
struct V_60 * V_61 , char * V_62 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
return sprintf ( V_62 , L_4 , V_2 -> V_36 ) ;
}
static T_1 F_36 ( struct V_58 * V_59 , struct V_60 * V_61 ,
char * V_62 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
struct V_7 * V_8 = V_2 -> V_8 ;
...
static T_1 F_38 ( struct V_58 * V_59 ,
struct V_60 * V_61 , char * V_62 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
return sprintf ( V_62 , L_4 , V_2 -> V_53 ) ;
}
static T_1 F_39 ( struct V_58 * V_59 , struct V_60 * V_61 ,
char * V_62 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
...
static T_1 F_41 ( struct V_58 * V_59 ,
struct V_60 * V_61 , char * V_62 )
{
return F_42 ( V_62 ) ;
}
static T_1 F_43 ( struct V_58 * V_59 ,
struct V_60 * V_61 ,
char * V_62 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
...
static T_1 F_45 ( struct V_58 * V_59 ,
struct V_60 * V_61 ,
const char * V_62 , T_2 V_65 )
{
struct V_1 * V_2 = F_33 ( V_59 ) ;
int V_66 = F_46 ( V_2 , V_62 ) ;
if ( ! V_66 )
V_66 = V_65 ;
return V_66 ;
}
static T_3 F_47 ( struct V_67 * V_68 , struct V_69 * V_61 ,
int V_70 )
{
struct V_58 * V_59 = F_16 ( V_68 , struct V_58 , V_68 ) ;
struct V_1 * V_2 = F_33 ( V_59 ) ;
T_3 V_71 = V_61 -> V_71 ;
...
static int F_49 ( struct V_1 * V_2 , unsigned int V_77 ,
unsigned long V_78 )
{
if ( ! V_2 -> V_22 -> V_79 )
return - V_80 ;
...
static T_1 F_50 ( struct V_81 * V_81 , const char T_4 * V_82 ,
T_2 V_83 , T_5 * V_84 )
{
...
static long F_52 ( struct V_81 * V_81 , unsigned int V_77 ,
unsigned long V_78 )
{
struct V_7 * V_8 = V_81 -> V_85 ;
...
V_21 = F_49 ( V_2 , V_77 , V_78 ) ;
if ( V_21 != - V_80 )
goto V_92;
switch ( V_77 ) {
case V_93 :
V_21 = F_53 ( V_90 , V_2 -> V_47 ,
...
static int F_55 ( struct V_107 * V_107 , struct V_81 * V_81 )
{
struct V_7 * V_8 ;
struct V_1 * V_2 ;
int V_21 ;
...
V_8 = F_16 ( V_107 -> V_110 , struct V_7 ,
V_111 ) ;
if ( F_57 ( V_112 , & V_8 -> V_26 ) )
return - V_33 ;
V_2 = V_8 -> V_2 ;
if ( ! F_3 ( V_2 ) && ! F_58 ( V_2 -> V_22 -> V_113 ) ) {
V_21 = - V_33 ;
goto V_114;
}
V_21 = F_20 ( V_2 ) ;
...
if ( ! F_3 ( V_2 ) )
F_59 ( & V_8 -> V_116 ) ;
return F_60 ( V_107 , V_81 ) ;
V_115:
F_61 ( V_8 -> V_2 -> V_22 -> V_113 ) ;
V_114:
F_24 ( V_112 , & V_8 -> V_26 ) ;
return V_21 ;
}
static void F_62 ( struct V_116 * V_116 )
{
struct V_7 * V_8 ;
V_8 = F_16 ( V_116 , struct V_7 , V_116 ) ;
F_63 ( V_8 ) ;
}
static int F_64 ( struct V_107 * V_107 , struct V_81 * V_81 )
{
struct V_7 * V_8 = V_81 -> V_85 ;
struct V_1 * V_2 ;
int V_21 = - V_33 ;
...
F_19 ( & V_8 -> V_28 ) ;
if ( ! V_117 ) {
F_61 ( V_8 -> V_111 . V_113 ) ;
F_66 ( & V_8 -> V_116 , F_62 ) ;
}
return 0 ;
}
static int F_67 ( struct V_1 * V_2 , T_6 V_119 )
{
struct V_7 * V_8 ;
int V_21 ;
V_8 = F_68 ( sizeof( struct V_7 ) , V_120 ) ;
if ( ! V_8 )
return - V_121 ;
F_69 ( & V_8 -> V_116 ) ;
F_70 ( & V_8 -> V_28 ) ;
...
F_74 ( & V_8 -> V_111 , & V_125 ) ;
V_8 -> V_111 . V_113 = V_2 -> V_22 -> V_113 ;
V_21 = F_75 ( & V_8 -> V_111 , V_119 , 1 ) ;
if ( V_21 ) {
F_73 ( L_11 ,
V_2 -> V_32 , F_76 ( V_126 ) , V_2 -> V_32 ) ;
if ( V_2 -> V_32 == 0 ) {
F_77 ( & V_122 ) ;
V_109 = NULL ;
F_66 ( & V_8 -> V_116 , F_62 ) ;
...
T_6 V_119 ;
int V_66 ;
V_119 = F_84 ( F_76 ( V_126 ) , V_2 -> V_32 ) ;
V_66 = F_67 ( V_2 , V_119 ) ;
if ( V_66 )
return V_66 ;
V_59 = F_85 ( & V_128 , V_2 -> V_123 ,
V_119 , V_2 , V_2 -> V_129 ,
L_12 , V_2 -> V_32 ) ;
if ( F_86 ( V_59 ) ) {
F_80 ( V_2 ) ;
