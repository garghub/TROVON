...
V_43 = F_39 ( & V_2 -> V_66 , F_9 ( V_2 -> V_31 ) ,
0 , V_2 -> V_7 -> V_69 ,
V_2 -> V_66 . V_82 ) ;
if ( V_43 ) {
F_38 ( V_2 -> V_31 , L_9 ) ;
...
static struct V_87 * F_41 ( struct V_1 * V_2 ,
struct V_88 * V_89 , char * V_25 )
{
struct V_90 V_91 ;
void T_2 * V_68 ;
int V_6 ;
V_6 = F_42 ( V_89 , L_10 , V_25 ) ;
if ( F_43 ( V_89 , V_6 , & V_91 ) )
return F_44 ( - V_92 ) ;
V_68 = F_45 ( V_2 -> V_31 , & V_91 ) ;
if ( F_46 ( V_68 ) )
return F_47 ( V_68 ) ;
V_93 . V_94 = F_48 ( & V_91 ) - 4 ;
V_93 . V_25 = F_49 ( V_2 -> V_31 , V_95 ,
L_11 , V_89 -> V_25 ,
V_25 ) ;
if ( ! V_93 . V_25 )
return F_44 ( - V_96 ) ;
return F_50 ( V_2 -> V_31 , V_68 , & V_93 ) ;
}
...
V_2 -> V_84 = V_98 ;
V_2 -> V_37 = F_41 ( V_2 , V_98 , L_15 ) ;
if ( F_46 ( V_2 -> V_37 ) ) {
F_38 ( V_2 -> V_31 , L_16 ) ;
return F_54 ( V_2 -> V_37 ) ;
}
V_2 -> V_53 = F_41 ( V_2 , V_98 , L_17 ) ;
if ( F_46 ( V_2 -> V_53 ) ) {
F_38 ( V_2 -> V_31 , L_18 ) ;
return F_54 ( V_2 -> V_53 ) ;
}
V_2 -> V_56 = F_41 ( V_2 , V_98 , L_19 ) ;
if ( F_46 ( V_2 -> V_56 ) )
V_2 -> V_56 = V_2 -> V_53 ;
V_2 -> V_71 = F_41 ( V_2 , V_98 , L_20 ) ;
if ( F_46 ( V_2 -> V_71 ) ) {
F_38 ( V_2 -> V_31 , L_21 ) ;
return F_54 ( V_2 -> V_71 ) ;
}
return 0 ;
}
...
struct V_1 * V_2 ;
int V_43 ;
V_2 = F_56 ( V_31 , sizeof( struct V_1 ) , V_95 ) ;
if ( ! V_2 )
return - V_96 ;
V_2 -> V_31 = V_31 ;
V_102 = F_57 ( V_104 , V_100 -> V_31 . V_84 ) ;
V_2 -> V_7 = (struct V_105 * ) V_102 -> V_7 ;
V_43 = F_51 ( V_2 , V_100 -> V_31 . V_84 ) ;
if ( V_43 )
return V_43 ;
V_2 -> V_18 . V_25 = L_22 ;
...
V_2 -> V_21 = F_58 ( V_2 -> V_31 , & V_2 -> V_18 , V_2 ) ;
if ( F_46 ( V_2 -> V_21 ) ) {
F_38 ( V_2 -> V_31 , L_23 ) ;
return F_54 ( V_2 -> V_21 ) ;
}
return F_36 ( V_2 ) ;
}
