...
int V_27 ;
if ( V_16 -> V_28 . V_29 . V_30 [ 0 ] >= V_19 -> V_31 )
return - V_32 ;
switch ( V_16 -> V_28 . V_29 . V_30 [ 0 ] ) {
case 0 :
V_25 = 0 ;
V_9 -> V_33 [ V_23 ] = false ;
break;
...
V_22 . V_25 = V_25 ;
F_13 ( V_8 , V_4 ,
V_16 -> V_28 . V_29 . V_30 [ 0 ] , V_19 , & V_22 ) ;
}
return V_26 ;
}
...
V_27 = V_37 ;
V_39 = F_15 ( V_9 -> V_11 , V_27 , & V_25 ) ;
if ( V_39 )
return V_39 ;
if ( V_25 != 0 )
V_25 = 1 ;
V_16 -> V_28 . V_29 . V_30 [ 0 ] = V_25 ;
return 0 ;
}
...
return - V_32 ;
V_39 = F_18 ( V_47 , V_48 , V_9 -> V_10 ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_6 ( V_9 -> V_11 , V_14 ,
V_9 -> V_10 , F_7 ( V_9 -> V_10 ) ) ;
if ( V_39 )
return V_39 ;
V_9 -> V_49 = V_48 ;
...
V_71 , div ) ;
if ( F_16 ( V_9 ) ) {
F_27 ( V_9 -> V_11 , V_72 , div ) ;
F_27 ( V_9 -> V_11 , V_73 , V_69 ) ;
}
if ( V_9 -> V_74 ) {
V_39 = F_28 ( V_9 , F_24 ( V_63 ) ) ;
if ( V_39 < 0 )
return V_39 ;
}
if ( V_9 -> V_75 != V_76 )
...
if ( V_85 )
V_83 |= V_104 ;
F_27 ( V_9 -> V_11 , V_105 , V_83 ) ;
F_27 ( V_9 -> V_11 , V_80 , V_84 ) ;
V_9 -> V_75 = V_82 & V_91 ;
return 0 ;
}
...
return F_27 ( V_9 -> V_11 , V_133 , V_130 << 2 ) ;
}
bool F_37 ( struct V_134 * V_135 , unsigned int V_27 )
{
if ( V_27 < 0x400 )
return true ;
return false ;
}
bool F_38 ( struct V_134 * V_135 , unsigned int V_27 )
{
if ( V_27 < 0x400 )
return true ;
switch ( V_27 ) {
...
bool F_39 ( struct V_134 * V_135 , unsigned int V_27 )
{
if ( V_27 < 0x4000 )
return true ;
switch ( V_27 ) {
...
int V_39 ;
int V_150 ;
V_39 = F_15 ( V_9 -> V_11 , V_73 , & V_150 ) ;
if ( V_39 )
return V_39 ;
F_27 ( V_9 -> V_11 , V_147 , 1 ) ;
F_27 ( V_9 -> V_11 , V_73 , 0xf ) ;
V_39 = F_40 ( V_9 -> V_74 , V_149 ) ;
if ( V_39 ) {
F_27 ( V_9 -> V_11 , V_147 , 0 ) ;
return V_39 ;
}
F_27 ( V_9 -> V_11 , V_73 , V_150 ) ;
return 0 ;
}
...
int F_49 ( struct V_134 * V_135 , struct V_11 * V_11 ,
...
V_9 -> V_59 = V_56 ;
V_39 = F_18 ( F_25 ( V_9 -> V_57 ) , 48000 * 1024 ,
V_9 -> V_10 ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_54 ( V_9 -> V_57 ) ;
