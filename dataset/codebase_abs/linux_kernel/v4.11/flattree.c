...
V_85 = V_93 ;
if ( V_94 > 0 )
V_85 = F_33 ( F_19 ( V_61 . V_75 ) + V_85 , V_94 )
- F_19 ( V_61 . V_75 ) ;
if ( V_85 > 0 ) {
int V_95 = F_19 ( V_61 . V_75 ) ;
V_95 += V_85 ;
V_61 . V_75 = F_32 ( V_95 ) ;
}
...
int V_6 ;
V_97 = V_31 . V_2 ;
while ( V_97 < ( V_31 . V_2 + V_31 . V_6 ) ) {
V_6 = strlen ( V_97 ) ;
fprintf ( V_14 , L_21 , V_97 ) ;
V_97 += V_6 + 1 ;
}
}
...
F_42 ( V_14 , L_44 ,
( unsigned int ) ( V_53 -> V_53 . V_99 & 0xffffffff ) ) ;
F_42 ( V_14 , L_44 , ( unsigned int ) ( V_53 -> V_53 . V_100 >> 32 ) ) ;
F_42 ( V_14 , L_44 , ( unsigned int ) ( V_53 -> V_53 . V_100 & 0xffffffff ) ) ;
}
...
fprintf ( V_14 , L_45 ) ;
F_12 ( V_14 , V_98 , L_46 ) ;
F_26 ( V_82 -> V_87 , & V_101 , V_14 , & V_31 , V_33 ) ;
fprintf ( V_14 , L_47 ) ;
F_14 ( V_14 , V_89 ) ;
F_12 ( V_14 , V_98 , L_48 ) ;
F_12 ( V_14 , V_98 , L_49 ) ;
...
static void F_43 ( struct V_102 * V_103 , void * V_104 , void * V_105 )
{
V_103 -> V_104 = V_104 ;
V_103 -> V_105 = V_105 ;
V_103 -> V_106 = V_103 -> V_104 ;
}
static void F_44 ( struct V_102 * V_103 , void * V_97 , int V_6 )
{
if ( ( V_103 -> V_106 + V_6 ) > V_103 -> V_105 )
F_36 ( L_55 ) ;
memcpy ( V_97 , V_103 -> V_106 , V_6 ) ;
V_103 -> V_106 += V_6 ;
}
static V_23 F_45 ( struct V_102 * V_103 )
{
V_23 V_2 ;
assert ( ( ( V_103 -> V_106 - V_103 -> V_104 ) % sizeof( V_2 ) ) == 0 ) ;
F_44 ( V_103 , & V_2 , sizeof( V_2 ) ) ;
return F_19 ( V_2 ) ;
}
static void F_46 ( struct V_102 * V_103 , int V_44 )
{
int V_18 = V_103 -> V_106 - V_103 -> V_104 ;
V_103 -> V_106 = V_103 -> V_104 + F_33 ( V_18 , V_44 ) ;
if ( V_103 -> V_106 > V_103 -> V_105 )
F_36 ( L_55 ) ;
}
static char * F_47 ( struct V_102 * V_103 )
{
int V_6 = 0 ;
const char * V_97 = V_103 -> V_106 ;
char * V_5 ;
do {
if ( V_97 >= V_103 -> V_105 )
F_36 ( L_55 ) ;
...
V_5 = F_48 ( V_103 -> V_106 ) ;
V_103 -> V_106 += V_6 ;
F_46 ( V_103 , sizeof( V_23 ) ) ;
return V_5 ;
}
static struct V_3 F_49 ( struct V_102 * V_103 , int V_6 )
{
struct V_3 V_8 = V_54 ;
if ( V_6 == 0 )
return V_54 ;
V_8 = F_50 ( V_8 , V_6 ) ;
V_8 . V_6 = V_6 ;
F_44 ( V_103 , V_8 . V_2 , V_6 ) ;
F_46 ( V_103 , sizeof( V_23 ) ) ;
return V_8 ;
}
static char * F_51 ( struct V_102 * V_103 , int V_16 )
{
const char * V_97 ;
V_97 = V_103 -> V_104 + V_16 ;
while ( 1 ) {
if ( V_97 >= V_103 -> V_105 || V_97 < V_103 -> V_104 )
F_36 ( L_56 ,
V_16 ) ;
if ( * V_97 == '\0' )
break;
...
return F_48 ( V_103 -> V_104 + V_16 ) ;
}
static struct V_34 * F_52 ( struct V_102 * V_4 ,
struct V_102 * V_31 , int V_40 )
{
V_23 V_107 , V_108 ;
char * V_43 ;
struct V_3 V_2 ;
V_107 = F_45 ( V_4 ) ;
V_108 = F_45 ( V_4 ) ;
V_43 = F_51 ( V_31 , V_108 ) ;
if ( ( V_40 & V_47 ) && ( V_107 >= 8 ) )
F_46 ( V_4 , 8 ) ;
V_2 = F_49 ( V_4 , V_107 ) ;
return F_53 ( V_43 , V_2 ) ;
}
static struct V_51 * F_54 ( struct V_102 * V_103 )
{
struct V_51 * V_52 = NULL ;
struct V_51 * V_109 ;
struct V_55 V_53 ;
while ( 1 ) {
F_44 ( V_103 , & V_53 , sizeof( V_53 ) ) ;
V_53 . V_99 = F_55 ( V_53 . V_99 ) ;
V_53 . V_100 = F_55 ( V_53 . V_100 ) ;
if ( V_53 . V_100 == 0 )
break;
V_109 = F_56 ( V_53 . V_99 , V_53 . V_100 ) ;
V_52 = F_57 ( V_52 , V_109 ) ;
}
return V_52 ;
}
static char * F_58 ( const char * V_110 , const char * V_111 )
{
int V_112 ;
V_112 = strlen ( V_110 ) ;
if ( ! F_59 ( V_110 , V_111 , V_112 ) )
F_36 ( L_57 ,
V_111 , V_110 ) ;
if ( ! F_25 ( V_110 , L_58 ) )
V_112 ++ ;
return F_48 ( V_111 + V_112 ) ;
}
static struct V_26 * F_60 ( struct V_102 * V_4 ,
struct V_102 * V_31 ,
const char * V_113 , int V_40 )
{
struct V_26 * V_26 ;
char * V_114 ;
V_23 V_2 ;
...
struct V_81 * F_64 ( const char * V_118 )
{
T_2 * V_14 ;
V_23 V_67 , V_75 , V_69 , V_119 , V_65 ;
V_23 V_120 , V_121 , V_72 ;
int V_122 ;
char * V_83 ;
struct V_60 * V_61 ;
char * V_97 ;
struct V_102 V_4 , V_31 ;
struct V_102 V_123 ;
int V_124 ;
struct V_51 * V_52 ;
struct V_26 * V_27 ;
V_23 V_2 ;
int V_40 = 0 ;
V_14 = F_65 ( V_118 , NULL ) ;
V_122 = fread ( & V_67 , sizeof( V_67 ) , 1 , V_14 ) ;
if ( ferror ( V_14 ) )
F_36 ( L_65 ,
strerror ( V_96 ) ) ;
if ( V_122 < 1 ) {
...
if ( V_67 != V_68 )
F_36 ( L_68 ) ;
V_122 = fread ( & V_75 , sizeof( V_75 ) , 1 , V_14 ) ;
if ( ferror ( V_14 ) )
F_36 ( L_69 , strerror ( V_96 ) ) ;
if ( V_122 < 1 ) {
if ( feof ( V_14 ) )
F_36 ( L_70 ) ;
else
...
V_61 -> V_67 = F_32 ( V_67 ) ;
V_61 -> V_75 = F_32 ( V_75 ) ;
V_124 = V_75 - sizeof( V_67 ) - sizeof( V_75 ) ;
V_97 = V_83 + sizeof( V_67 ) + sizeof( V_75 ) ;
while ( V_124 ) {
if ( feof ( V_14 ) )
F_36 ( L_73 ,
V_75 ) ;
V_122 = fread ( V_97 , 1 , V_124 , V_14 ) ;
if ( ferror ( V_14 ) )
F_36 ( L_74 ,
strerror ( V_96 ) ) ;
V_124 -= V_122 ;
...
F_36 ( L_77 ) ;
if ( V_69 >= 3 ) {
V_23 V_126 = F_19 ( V_61 -> V_78 ) ;
if ( ( V_121 + V_126 < V_121 ) || ( V_121 + V_126 > V_75 ) )
F_36 ( L_78 ) ;
F_43 ( & V_31 , V_83 + V_121 , V_83 + V_121 + V_126 ) ;
} else {
F_43 ( & V_31 , V_83 + V_121 , V_83 + V_75 ) ;
}
if ( V_69 >= 17 ) {
V_119 = F_19 ( V_61 -> V_80 ) ;
if ( ( V_120 + V_119 < V_120 ) || ( V_120 + V_119 > V_75 ) )
F_36 ( L_79 ) ;
}
if ( V_69 < 16 ) {
V_40 |= V_41 | V_48 | V_47 ;
...
free ( V_83 ) ;
fclose ( V_14 ) ;
return F_66 ( V_127 , V_52 , V_27 , V_65 ) ;
}
