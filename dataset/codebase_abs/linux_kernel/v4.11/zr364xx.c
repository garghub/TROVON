...
int V_162 ;
V_81 = V_83 -> V_163 ;
F_9 ( L_29 , V_30 , V_83 , V_83 -> V_8 ) ;
if ( V_81 == NULL ) {
F_28 (KERN_ERR KBUILD_MODNAME L_30 ) ;
return;
}
V_21 = V_81 -> V_21 ;
if ( V_21 == NULL ) {
...
V_81 -> V_103 ,
F_64 , V_81 ) ;
F_15 ( L_38 , V_81 -> V_167 ) ;
V_169 = F_67 ( V_81 -> V_167 , V_10 ) ;
if ( V_169 ) {
F_28 (KERN_ERR KBUILD_MODNAME L_39 ) ;
return V_169 ;
}
return 0 ;
}
...
struct V_80 * V_81 ;
if ( V_21 == NULL ) {
F_28 (KERN_ERR KBUILD_MODNAME L_40 ) ;
return;
}
F_15 ( L_41 ) ;
V_81 = V_21 -> V_162 ;
...
F_15 ( L_45 , V_21 -> V_63 . V_64 [ V_79 ] . V_65 ) ;
...
F_28 (KERN_INFO KBUILD_MODNAME L_52 ) ;
break;
}
}
if ( V_79 == 0 ) {
F_28 (KERN_INFO KBUILD_MODNAME L_53 ) ;
F_6 ( V_21 -> V_162 -> V_9 ) ;
V_21 -> V_162 -> V_9 = NULL ;
return - V_12 ;
} else
...
int V_79 ;
F_15 ( L_55 ) ;
F_40 ( & V_184 -> V_11 , V_111 L_56 ) ;
F_40 ( & V_184 -> V_11 , L_57 ,
...
V_101 [ 440 ] = V_21 -> V_23 % 256 ;
V_21 -> V_105 = 0 ;
F_15 ( L_64 , V_21 , V_21 -> V_2 , V_184 ) ;
V_187 = V_184 -> V_200 ;
F_15 ( L_65 , V_187 -> V_201 . V_202 ) ;
