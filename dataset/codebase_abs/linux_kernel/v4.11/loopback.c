...
F_37 ( V_60 ) ;
V_74 = F_85 ( V_113 , & V_89 , sizeof( V_89 ) ) ;
if ( V_74 > 0 ) {
F_86 ( V_112 , L_16 , V_89 ) ;
V_74 = 0 ;
}
F_41 ( V_60 ) ;
V_71:
...
struct V_121 * V_123 )
{
struct V_1 * V_124 = F_91 ( V_122 , struct V_1 , V_52 ) ;
struct V_1 * V_125 = F_91 ( V_123 , struct V_1 , V_52 ) ;
...
if ( ! V_2 )
return - V_43 ;
V_41 = F_95 ( V_45 , F_96 ( V_137 -> V_57 ) ,
F_67 ) ;
if ( F_97 ( V_41 ) ) {
V_74 = F_98 ( V_41 ) ;
goto V_144;
...
F_104 ( & V_41 -> V_45 -> V_14 ) ) ;
V_2 -> V_118 = F_105 ( V_138 , V_148 | 0444 , V_6 . V_149 , V_2 ,
& V_150 ) ;
V_2 -> V_57 = F_106 ( & V_151 , 0 , 0 , V_42 ) ;
if ( V_2 -> V_57 < 0 ) {
V_74 = V_2 -> V_57 ;
goto V_152;
}
...
if ( F_110 ( & V_2 -> V_16 , V_12 * sizeof( struct V_31 ) * 2 ,
V_42 ) ) {
V_74 = - V_43 ;
goto V_158;
}
...
static void F_120 ( struct V_107 * V_45 )
{
