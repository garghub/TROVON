...
static bool F_141 ( struct V_112 * V_51 ,
...
if ( F_147 ( V_154 ) && F_134 ( V_154 ) ) {
struct V_211 * V_212 = & V_124 -> V_212 ;
F_148 ( V_124 , V_228 , V_154 -> V_55 ,
L_8
L_9
L_10
L_11
...
if ( F_13 ( V_115 && F_152 ( V_154 -> V_55 ) &&
( F_72 ( V_154 ) >= F_151 ) ) ) {
F_107 () ;
if ( F_153 ( V_154 -> V_55 ,
V_154 -> V_92 ) &&
...
static void F_155 ( struct V_230 * V_231 )
{
unsigned int V_232 , V_119 , V_233 ;
if ( ! F_156 ( V_231 -> V_234 ) )
goto V_235;
V_119 = V_231 -> V_115 ;
if ( ! V_119 )
goto V_235;
...
static void F_158 ( struct V_112 * V_51 )
{
T_6 V_234 = V_238 ;
F_155 ( & V_51 -> V_224 ) ;
F_155 ( & V_51 -> V_121 ) ;
...
static int F_159 ( struct V_241 * V_52 , int V_113 )
{
struct V_112 * V_51 =
F_160 ( V_52 , struct V_112 , V_52 ) ;
struct V_7 * V_54 ;
int V_242 , V_243 = 0 ;
bool V_244 = true ;
F_161 (ring, q_vector->tx) {
if ( ! F_141 ( V_51 , V_54 , V_113 ) )
V_244 = false ;
}
if ( V_113 <= 0 )
return V_113 ;
if ( V_51 -> V_121 . V_25 > 1 )
V_242 = F_162 ( V_113 / V_51 -> V_121 . V_25 , 1 ) ;
else
V_242 = V_113 ;
...
F_163 ( V_52 , V_243 ) ;
F_158 ( V_51 ) ;
return F_164 ( V_243 , V_113 - 1 ) ;
}
static bool F_165 ( struct V_123 * V_124 )
{
...
V_204 -> V_251 = V_248 ;
V_204 -> V_252 = F_52 ( F_167 ( V_248 - 1 ) ) - 1 ;
V_247 = V_124 -> V_212 . V_253 . V_254 / V_248 ;
V_247 = F_52 ( F_167 ( V_247 ) - 1 ) ;
V_204 = & V_124 -> V_249 [ V_255 ] ;
V_247 = F_168 ( T_4 , V_247 , V_204 -> V_256 ) ;
V_204 -> V_251 = V_247 ;
V_204 -> V_252 = F_52 ( F_167 ( V_247 - 1 ) ) - 1 ;
for ( V_22 = 0 ; V_22 < V_248 ; V_22 ++ )
F_169 ( V_15 , V_22 , V_247 , V_247 * V_22 ) ;
V_124 -> V_257 = V_247 * V_248 ;
V_124 -> V_258 = V_247 * V_248 ;
return true ;
}
static bool F_170 ( struct V_123 * V_124 )
{
struct V_246 * V_204 ;
T_4 V_247 ;
V_204 = & V_124 -> V_249 [ V_255 ] ;
V_247 = F_168 ( T_4 , V_124 -> V_212 . V_253 . V_254 , V_204 -> V_256 ) ;
V_204 -> V_251 = V_247 ;
V_204 -> V_252 = F_52 ( F_167 ( V_247 - 1 ) ) - 1 ;
V_124 -> V_257 = V_247 ;
V_124 -> V_258 = V_247 ;
...
static int F_173 ( struct V_123 * V_124 ,
...
V_51 = F_174 ( V_37 , V_267 ) ;
if ( ! V_51 )
return - V_268 ;
F_175 ( V_124 -> V_55 , & V_51 -> V_52 ,
F_159 , V_269 ) ;
...
static void F_178 ( struct V_123 * V_124 , int V_261 )
{
...
int V_282 = F_183 ( V_278 , V_277 - V_261 ) ;
int V_283 = F_183 ( V_279 , V_277 - V_261 ) ;
V_280 = F_173 ( V_124 , V_277 , V_261 ,
V_283 , V_263 ,
V_282 , V_265 ) ;
if ( V_280 )
...
struct V_211 * V_212 = & V_124 -> V_212 ;
int V_285 , V_286 ;
V_285 = F_162 ( V_124 -> V_257 , V_124 -> V_258 ) ;
V_285 = F_168 ( T_4 , V_285 , F_189 () ) ;
V_285 += F_190 ( V_212 ) ;
V_285 = F_168 ( int , V_285 , V_212 -> V_253 . V_287 ) ;
V_124 -> V_284 = F_191 ( V_285 , sizeof( struct V_288 ) ,
V_267 ) ;
if ( ! V_124 -> V_284 )
return - V_268 ;
for ( V_286 = 0 ; V_286 < V_285 ; V_286 ++ )
V_124 -> V_284 [ V_286 ] . V_289 = V_286 ;
V_285 = F_192 ( V_124 -> V_272 ,
V_124 -> V_284 ,
F_193 ( V_212 ) ,
V_285 ) ;
if ( V_285 < 0 ) {
...
V_124 -> V_259 = V_285 - F_190 ( V_212 ) ;
return 0 ;
}
static bool F_194 ( struct V_123 * V_124 )
{
struct V_77 * V_15 = V_124 -> V_55 ;
int V_290 , V_291 , V_247 , V_22 , V_292 ;
T_4 V_293 = V_124 -> V_249 [ V_250 ] . V_252 + 1 ;
T_10 V_294 = F_166 ( V_15 ) ;
if ( V_294 <= 1 )
return false ;
...
static void F_195 ( struct V_123 * V_124 )
{
int V_22 ;
