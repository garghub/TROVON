...
F_3 ( & V_74 -> V_6 , L_12 , V_68 ) ;
V_78 = V_74 -> V_89 ;
if ( V_78 -> V_87 . V_90 < 3 ) {
F_4 ( V_5 ) ;
return - V_85 ;
}
V_3 = F_18 ( sizeof( struct V_2 ) , V_40 ) ;
if ( ! V_3 ) {
F_4 ( V_5 ) ;
return - V_91 ;
}
...
V_3 -> V_15 = V_15 ;
V_15 -> V_35 = V_3 ;
V_15 -> V_96 = V_97 | V_98 | V_99 | V_100 | V_101 ;
F_37 ( V_15 , 7 , 0x00 , V_40 ) ;
F_37 ( V_15 , 6 , 0x30 , V_40 ) ;
F_37 ( V_15 , 2 , 0x0c , V_40 ) ;
F_34 ( V_15 , 0 , & V_19 , V_40 ) ;
F_3 ( & V_74 -> V_6 , L_14 , V_3 -> V_19 ) ;
V_80 = & V_78 -> V_80 [ 2 ] ;
F_3 ( & V_74 -> V_6 , L_15 ,
V_80 -> V_87 . V_102 , V_80 -> V_87 . V_103 ) ;
F_74 ( V_15 ) ;
F_75 ( V_74 , V_15 ) ;
return 0 ;
V_95:
...
if ( V_104 )
goto V_106;
F_36 (KERN_INFO KBUILD_MODNAME L_19 DRIVER_VERSION L_20
DRIVER_DESC L_21 ) ;
F_36 (KERN_INFO KBUILD_MODNAME L_22
L_23 ) ;
F_36 (KERN_INFO KBUILD_MODNAME L_24
L_25 ) ;
F_36 (KERN_INFO KBUILD_MODNAME L_26
L_27 ) ;
V_106:
return V_104 ;
}
