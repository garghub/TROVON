...
static void
F_35 ( struct V_24 * V_25 , struct V_9 * V_10 )
{
V_10 -> V_40 = V_41 ;
F_36 ( & V_10 -> V_17 , & V_25 -> V_34 ) ;
}
static long
...
F_42 ( struct V_46 * V_47 , struct V_48 * V_49 )
{
return F_39 ( & V_23 ) ;
}
static unsigned long
F_43 ( struct V_46 * V_47 , struct V_48 * V_49 )
{
return F_41 () ;
}
static T_3
...
V_61 ) ;
T_4 V_62 = F_45 ( V_56 -> V_39 [ 0 ] . V_22 , V_59 ) ;
V_54 = F_46 ( V_58 , V_62 , 0 ) ;
V_59 -= V_62 ;
V_52 = V_56 -> V_63 / V_64 ;
V_53 = V_56 -> V_63 & ~ V_65 ;
while ( V_59 ) {
V_58 = F_47 ( V_56 -> V_66 [ V_52 ] ) + V_53 ;
V_62 = F_3 ( T_4 , V_64 - V_53 , V_59 ) ;
V_54 = F_46 ( V_58 , V_62 , V_54 ) ;
V_59 -= V_62 ;
V_53 = 0 ;
++ V_52 ;
}
...
static bool
F_48 ( struct V_50 * V_51 , T_3 V_54 , struct V_9 * V_10 )
{
...
! F_49 ( F_50 ( V_51 ) , (struct V_78 * ) & V_10 -> V_79 ) ||
F_51 ( F_50 ( V_51 ) ) != F_51 ( (struct V_78 * ) & V_10 -> V_79 ) )
return false ;
return true ;
}
static struct V_9 *
F_52 ( struct V_24 * V_25 , struct V_50 * V_51 ,
T_3 V_54 )
{
...
V_10 -> V_68 = V_7 ;
V_10 -> V_72 = V_88 ;
F_58 ( (struct V_78 * ) & V_10 -> V_79 , F_50 ( V_51 ) ) ;
F_59 ( (struct V_78 * ) & V_10 -> V_79 , F_51 ( F_50 ( V_51 ) ) ) ;
V_10 -> V_74 = V_86 ;
V_10 -> V_76 = V_87 ;
...
goto V_98;
V_92 = V_93 ;
if ( ! F_60 ( V_103 , & V_51 -> V_104 ) && V_10 -> V_105 )
goto V_98;
switch ( V_10 -> V_15 ) {
case V_16 :
break;
case V_106 :
F_61 ( & V_51 -> V_107 . V_39 [ 0 ] , V_10 -> V_108 ) ;
V_92 = V_109 ;
break;
case V_18 :
if ( ! F_62 ( V_51 , & V_10 -> V_19 ) )
goto V_98;
V_92 = V_109 ;
break;
default:
F_28 ( V_110 L_4 , V_10 -> V_15 ) ;
F_12 ( V_10 ) ;
}
goto V_98;
}
void
F_63 ( struct V_50 * V_51 , int V_111 , T_2 * V_112 )
{
...
V_21 += V_116 ;
F_35 ( V_25 , V_10 ) ;
V_10 -> V_105 = F_60 ( V_103 , & V_51 -> V_104 ) ;
V_10 -> V_15 = V_111 ;
V_10 -> V_13 = V_117 ;
F_19 ( & V_25 -> V_26 ) ;
return;
...
static int
F_62 ( struct V_50 * V_51 , struct V_113 * V_118 )
{
...
F_66 ( V_121 , L_8 ,
F_39 ( & V_23 ) ) ;
F_66 ( V_121 , L_9 , 1 << V_8 ) ;
F_66 ( V_121 , L_10 , V_21 ) ;
F_66 ( V_121 , L_11 , V_95 . V_100 ) ;
F_66 ( V_121 , L_12 , V_95 . V_99 ) ;
F_66 ( V_121 , L_13 , V_95 . V_96 ) ;
F_66 ( V_121 , L_14 , V_70 ) ;
F_66 ( V_121 , L_15 , V_83 ) ;
F_66 ( V_121 , L_16 , V_84 ) ;
return 0 ;
}
