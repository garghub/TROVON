...
int F_23 ( struct V_1 * V_2 , T_2 * V_45 )
{
int V_6 = F_15 ( V_27 ) ;
T_3 * V_5 ;
int V_28 ;
...
int F_24 ( struct V_1 * V_2 , T_2 V_45 )
{
int V_22 = F_15 ( V_24 ) ;
void * V_7 ;
int V_28 ;
...
if ( ! V_7 )
return - V_42 ;
F_3 ( V_24 , V_7 , V_39 . V_45 , 1 ) ;
F_3 ( V_24 , V_7 , V_29 . V_45 , V_45 ) ;
V_28 = F_10 ( V_2 , V_7 , V_22 ) ;
F_20 ( V_7 ) ;
return V_28 ;
}
int F_25 ( struct V_1 * V_46 ,
T_3 V_4 ,
enum V_47 V_48 ,
T_1 V_49 [] [ V_50 ] ,
int * V_51 )
...
F_3 ( V_20 , V_7 , V_9 ,
V_21 ) ;
F_3 ( V_20 , V_7 , V_61 , V_48 ) ;
F_3 ( V_20 , V_7 , V_12 , V_4 ) ;
if ( V_4 )
F_3 ( V_20 , V_7 , V_13 , 1 ) ;
V_28 = F_4 ( V_46 , V_7 , sizeof( V_7 ) , V_5 , V_54 ) ;
if ( V_28 )
goto V_5;
V_38 = F_16 ( V_27 , V_5 ,
V_29 ) ;
...
V_28 = F_4 ( V_46 , V_7 , V_65 , V_5 , sizeof( V_5 ) ) ;
F_28 ( V_7 ) ;
return V_28 ;
}
int F_30 ( struct V_1 * V_46 ,
T_3 V_4 ,
T_2 V_69 [] ,
int * V_70 )
{
...
V_38 ,
V_64 [ V_55 ] ) ;
V_69 [ V_55 ] = F_6 ( V_72 , V_74 , V_75 ) ;
}
V_5:
F_28 ( V_5 ) ;
return V_28 ;
}
int F_31 ( struct V_1 * V_46 ,
T_2 V_69 [] ,
int V_51 )
{
T_3 V_5 [ F_2 ( V_23 ) ] ;
...
int F_39 ( struct V_1 * V_46 , T_1 V_13 ,
...
V_28 = F_4 ( V_46 , V_7 , V_65 , V_5 , V_54 ) ;
if ( V_28 )
goto V_5;
V_93 = V_5 + F_15 ( V_91 ) ;
...
int F_42 ( struct V_1 * V_46 , T_1 V_13 ,
...
for ( V_55 = 0 ; V_55 < V_95 ; V_55 ++ , V_104 ++ , V_107 += F_15 ( V_104 ) )
...
int F_47 ( struct V_1 * V_46 ,
T_4 * V_141 )
{
struct V_110 * V_111 ;
int V_28 ;
V_111 = F_27 ( sizeof( * V_111 ) , V_60 ) ;
if ( ! V_111 )
return - V_42 ;
V_28 = F_45 ( V_46 , 0 , 1 , 0 , V_111 ) ;
if ( ! V_28 )
* V_141 = V_111 -> V_141 ;
F_28 ( V_111 ) ;
return V_28 ;
}
int F_48 ( struct V_1 * V_46 ,
T_4 * V_77 )
{
struct V_110 * V_111 ;
int V_28 ;
...
F_3 ( V_24 , V_7 , V_39 . V_147 , 1 ) ;
F_3 ( V_24 , V_7 , V_29 . V_147 ,
V_15 ) ;
V_28 = F_10 ( V_2 , V_7 , V_22 ) ;
F_20 ( V_7 ) ;
return V_28 ;
...
{
return F_52 ( V_2 , V_148 ) ;
}
int F_54 ( struct V_1 * V_2 )
{
return F_52 ( V_2 , V_149 ) ;
}
int F_55 ( struct V_1 * V_46 , T_1 V_13 ,
int V_150 , T_1 V_85 , void * V_5 ,
T_5 V_54 )
{
int V_65 = F_15 ( V_151 ) ;
int V_92 ;
...
if ( V_13 ) {
if ( V_92 ) {
F_3 ( V_151 , V_7 , V_13 , 1 ) ;
F_3 ( V_151 , V_7 , V_12 , V_150 + 1 ) ;
} else {
V_28 = - V_98 ;
goto free;
}
...
if ( F_26 ( V_46 , V_99 ) == 2 )
F_3 ( V_151 , V_7 , V_85 , V_85 ) ;
V_28 = F_4 ( V_46 , V_7 , V_65 , V_5 , V_54 ) ;
free:
F_20 ( V_7 ) ;
return V_28 ;
}
int F_56 ( struct V_1 * V_46 ,
T_1 V_13 , T_1 V_85 ,
int V_150 ,
struct V_110 * V_153 )
{
...
return - V_42 ;
memset ( V_5 , 0 , sizeof( V_5 ) ) ;
F_3 ( V_154 , V_7 , V_9 , V_156 ) ;
if ( V_13 ) {
if ( V_92 ) {
F_3 ( V_154 , V_7 , V_13 , 1 ) ;
F_3 ( V_154 , V_7 , V_12 , V_150 ) ;
} else {
V_28 = - V_98 ;
goto V_116;
}
...
if ( F_26 ( V_46 , V_99 ) > 1 )
F_3 ( V_154 , V_7 , V_85 , V_85 ) ;
V_114 = F_16 ( V_154 , V_7 , V_117 ) ;
F_3 ( V_117 , V_114 , V_39 , V_153 -> V_39 ) ;
F_3 ( V_117 , V_114 , V_118 , V_153 -> V_118 ) ;
F_3 ( V_117 , V_114 , V_119 , V_153 -> V_119 ) ;
F_3 ( V_117 , V_114 , V_120 , V_153 -> V_120 ) ;
F_3 ( V_117 , V_114 , V_122 , V_153 -> V_121 ) ;
F_3 ( V_117 , V_114 , V_124 , V_153 -> V_123 ) ;
F_3 ( V_117 , V_114 , V_125 , V_153 -> V_125 ) ;
F_37 ( V_117 , V_114 , V_126 , V_153 -> V_126 ) ;
F_37 ( V_117 , V_114 , V_77 , V_153 -> V_77 ) ;
F_3 ( V_117 , V_114 , V_127 , V_153 -> V_127 ) ;
F_3 ( V_117 , V_114 , V_129 , V_153 -> V_128 ) ;
F_3 ( V_117 , V_114 , V_130 , V_153 -> V_130 ) ;
F_3 ( V_117 , V_114 , V_132 , V_153 -> V_131 ) ;
F_3 ( V_117 , V_114 , V_133 , V_153 -> V_133 ) ;
F_3 ( V_117 , V_114 , V_134 , V_153 -> V_134 ) ;
F_3 ( V_117 , V_114 , V_135 , V_153 -> V_135 ) ;
F_3 ( V_117 , V_114 , V_136 , V_153 -> V_136 ) ;
F_3 ( V_117 , V_114 , V_137 , V_153 -> V_137 ) ;
F_3 ( V_117 , V_114 , V_138 , V_153 -> V_138 ) ;
F_3 ( V_117 , V_114 , V_84 , V_153 -> V_84 ) ;
F_3 ( V_117 , V_114 , V_139 , V_153 -> V_139 ) ;
V_28 = F_4 ( V_46 , V_7 , V_65 , V_5 , sizeof( V_5 ) ) ;
V_116:
F_28 ( V_7 ) ;
return V_28 ;
