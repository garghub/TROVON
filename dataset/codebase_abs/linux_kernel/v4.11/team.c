...
F_8 ( V_5 ) ;
V_147:
F_141 ( V_6 , V_5 -> V_13 . V_165 ) ;
V_166:
F_20 ( V_5 ) ;
return V_34 ;
}
static int F_157 ( struct V_14 * V_14 , struct V_2 * V_6 )
{
struct V_2 * V_3 = V_14 -> V_3 ;
struct V_1 * V_5 ;
char * V_157 = V_6 -> V_27 ;
...
static int F_160 ( struct V_14 * V_14 , struct V_52 * V_53 )
{
...
F_79 ( V_14 ) ;
F_85 ( V_14 ) ;
V_34 = F_36 ( V_14 , V_185 , F_186 ( V_185 ) ) ;
if ( V_34 )
goto V_186;
F_187 ( V_3 ) ;
F_188 ( V_3 ) ;
...
static T_7 F_195 ( struct V_71 * V_72 , struct V_2 * V_3 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
bool V_187 ;
...
static T_3 F_196 ( struct V_2 * V_3 , struct V_71 * V_72 ,
void * V_192 , T_8 V_193 )
{
T_3 V_194 = F_197 ( V_72 ) ? F_198 ( V_72 ) : 0 ;
F_199 ( V_72 ) -> V_195 = V_72 -> V_120 ;
if ( F_200 ( V_194 >= V_3 -> V_181 ) ) {
do {
V_194 -= V_3 -> V_181 ;
...
static void F_201 ( struct V_2 * V_3 , int V_196 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
int V_197 ;
...
static int F_207 ( struct V_2 * V_3 , void * V_200 )
{
struct V_8 * V_9 = V_200 ;
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
if ( V_3 -> type == V_201 && ! F_208 ( V_9 -> V_10 ) )
return - V_202 ;
...
static int F_209 ( struct V_2 * V_3 , int V_204 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
int V_34 ;
...
return 0 ;
V_206:
F_210 (port, &team->port_list, list)
F_141 ( V_5 -> V_3 , V_3 -> V_165 ) ;
V_14 -> V_205 = false ;
F_123 ( & V_14 -> V_145 ) ;
return V_34 ;
}
static void
F_211 ( struct V_2 * V_3 , struct V_207 * V_208 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_101 * V_200 ;
...
int V_33 ;
F_212 (i) {
V_200 = F_213 ( V_14 -> V_102 , V_33 ) ;
do {
V_209 = F_214 ( & V_200 -> V_103 ) ;
V_104 = V_200 -> V_104 ;
V_105 = V_200 -> V_105 ;
V_109 = V_200 -> V_109 ;
V_188 = V_200 -> V_188 ;
V_189 = V_200 -> V_189 ;
} while ( F_215 ( & V_200 -> V_103 , V_209 ) );
V_208 -> V_104 += V_104 ;
V_208 -> V_105 += V_105 ;
V_208 -> V_210 += V_109 ;
V_208 -> V_188 += V_188 ;
...
static int F_216 ( struct V_2 * V_3 , T_10 V_211 , T_3 V_212 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
int V_34 ;
F_122 ( & V_14 -> V_145 ) ;
F_17 (port, &team->port_list, list) {
V_34 = F_217 ( V_5 -> V_3 , V_211 , V_212 ) ;
if ( V_34 )
goto V_206;
}
F_123 ( & V_14 -> V_145 ) ;
...
V_206:
F_210 (port, &team->port_list, list)
F_218 ( V_5 -> V_3 , V_211 , V_212 ) ;
F_123 ( & V_14 -> V_145 ) ;
return V_34 ;
}
static int F_219 ( struct V_2 * V_3 , T_10 V_211 , T_3 V_212 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
struct V_1 * V_5 ;
F_122 ( & V_14 -> V_145 ) ;
...
static void F_221 ( struct V_14 * V_14 )
{
struct V_1 * V_5 ;
F_17 (port, &team->port_list, list)
F_131 ( V_5 ) ;
...
static T_5 F_226 ( struct V_2 * V_3 ,
T_5 V_160 )
{
struct V_1 * V_5 ;
struct V_14 * V_14 = F_182 ( V_3 ) ;
...
F_205 () ;
V_160 = F_227 ( V_160 , V_215 ) ;
return V_160 ;
}
static int F_228 ( struct V_2 * V_3 , bool V_217 )
{
struct V_14 * V_14 = F_182 ( V_3 ) ;
V_14 -> V_75 = true ;
if ( V_217 )
...
struct V_218 * V_219 )
{
F_231 ( V_219 -> V_220 , V_221 , sizeof( V_219 -> V_220 ) ) ;
F_231 ( V_219 -> V_222 , V_223 , sizeof( V_219 -> V_222 ) ) ;
}
...
V_3 -> V_232 = & V_233 ;
V_3 -> V_234 = F_191 ;
V_3 -> V_142 &= ~ ( V_139 | V_235 ) ;
V_3 -> V_142 |= V_236 ;
V_3 -> V_142 |= V_237 ;
V_3 -> V_142 |= V_238 | V_239 ;
V_3 -> V_160 |= V_240 ;
V_3 -> V_160 |= V_241 ;
V_3 -> V_160 |= V_242 ;
V_3 -> V_243 = V_132 |
...
static int F_239 ( struct V_247 * V_248 , struct V_2 * V_3 ,
struct V_249 * V_250 [] , struct V_249 * V_176 [] )
{
if ( V_250 [ V_251 ] == NULL )
F_240 ( V_3 ) ;
return F_241 ( V_3 ) ;
}
static int F_242 ( struct V_249 * V_250 [] , struct V_249 * V_176 [] )
{
if ( V_250 [ V_251 ] ) {
if ( F_243 ( V_250 [ V_251 ] ) != V_252 )
return - V_66 ;
if ( ! F_208 ( F_244 ( V_250 [ V_251 ] ) ) )
return - V_202 ;
}
return 0 ;
}
...
static int F_247 ( struct V_71 * V_72 , struct V_255 * V_16 )
{
struct V_71 * V_256 ;
void * V_257 ;
int V_34 ;
V_256 = F_248 ( V_258 , V_35 ) ;
if ( ! V_256 )
return - V_36 ;
V_257 = F_249 ( V_256 , V_16 -> V_259 , V_16 -> V_260 ,
& V_261 , 0 , V_262 ) ;
if ( ! V_257 ) {
V_34 = - V_263 ;
goto V_264;
...
F_250 ( V_256 , V_257 ) ;
return F_251 ( F_252 ( V_16 ) , V_256 , V_16 -> V_259 ) ;
V_264:
F_253 ( V_256 ) ;
return V_34 ;
}
static struct V_14 * F_254 ( struct V_255 * V_16 )
{
struct V_247 * V_247 = F_252 ( V_16 ) ;
int V_265 ;
struct V_2 * V_3 ;
struct V_14 * V_14 ;
if ( ! V_16 -> V_266 [ V_267 ] )
return NULL ;
V_265 = F_255 ( V_16 -> V_266 [ V_267 ] ) ;
V_3 = F_256 ( V_247 , V_265 ) ;
if ( ! V_3 || V_3 -> V_230 != & V_231 ) {
if ( V_3 )
F_127 ( V_3 ) ;
return NULL ;
}
...
static void F_257 ( struct V_14 * V_14 )
{
F_123 ( & V_14 -> V_145 ) ;
F_127 ( V_14 -> V_3 ) ;
}
static int F_258 ( struct V_71 * V_72 , struct V_14 * V_14 , T_4 V_268 )
{
return F_251 ( F_259 ( V_14 -> V_3 ) , V_72 , V_268 ) ;
}
static int F_260 ( struct V_71 * V_72 , struct V_14 * V_14 ,
struct V_28 * V_29 )
{
struct V_249 * V_269 ;
...
if ( V_34 )
return V_34 ;
V_269 = F_261 ( V_72 , V_270 ) ;
if ( ! V_269 )
return - V_263 ;
if ( F_262 ( V_72 , V_271 , V_26 -> V_27 ) )
goto V_272;
if ( V_58 -> V_5 &&
F_263 ( V_72 , V_273 ,
V_58 -> V_5 -> V_3 -> V_265 ) )
...
switch ( V_26 -> type ) {
case V_275 :
if ( F_264 ( V_72 , V_276 , V_277 ) )
goto V_272;
if ( F_263 ( V_72 , V_278 , V_53 . V_176 . V_178 ) )
goto V_272;
break;
case V_279 :
if ( F_264 ( V_72 , V_276 , V_280 ) )
goto V_272;
if ( F_262 ( V_72 , V_278 ,
V_53 . V_176 . V_177 ) )
goto V_272;
break;
case V_281 :
if ( F_264 ( V_72 , V_276 , V_282 ) )
goto V_272;
if ( F_265 ( V_72 , V_278 , V_53 . V_176 . V_283 . V_106 ,
V_53 . V_176 . V_283 . V_284 ) )
goto V_272;
break;
case V_285 :
if ( F_264 ( V_72 , V_276 , V_286 ) )
goto V_272;
if ( V_53 . V_176 . V_179 &&
F_266 ( V_72 , V_278 ) )
goto V_272;
break;
case V_287 :
if ( F_264 ( V_72 , V_276 , V_288 ) )
goto V_272;
if ( F_267 ( V_72 , V_278 , V_53 . V_176 . V_180 ) )
goto V_272;
break;
default:
F_268 () ;
}
if ( V_29 -> V_39 && F_266 ( V_72 , V_289 ) )
goto V_272;
if ( V_29 -> V_38 ) {
if ( F_266 ( V_72 , V_290 ) )
goto V_272;
...
static int F_271 ( struct V_71 * * V_96 ,
struct V_14 * V_14 , T_4 V_268 ,
T_11 * V_291 )
{
int V_34 ;
if ( * V_96 ) {
V_34 = V_291 ( * V_96 , V_14 , V_268 ) ;
if ( V_34 )
return V_34 ;
}
* V_96 = F_272 ( V_292 , V_35 ) ;
if ( ! * V_96 )
return - V_36 ;
return 0 ;
}
static int F_273 ( struct V_14 * V_14 , T_4 V_268 , T_4 V_293 ,
int V_158 , T_11 * V_291 ,
struct V_112 * V_294 )
{
struct V_249 * V_50 ;
struct V_295 * V_296 ;
...
struct V_28 , V_298 ) ;
V_299:
V_34 = F_271 ( & V_72 , V_14 , V_268 , V_291 ) ;
if ( V_34 )
return V_34 ;
V_257 = F_249 ( V_72 , V_268 , V_293 , & V_261 , V_158 | V_300 ,
V_301 ) ;
if ( ! V_257 ) {
F_253 ( V_72 ) ;
return - V_263 ;
}
if ( F_263 ( V_72 , V_267 , V_14 -> V_3 -> V_265 ) )
goto V_302;
V_50 = F_261 ( V_72 , V_303 ) ;
if ( ! V_50 )
goto V_302;
V_33 = 0 ;
V_297 = false ;
F_275 (opt_inst, sel_opt_inst_list, tmp_list) {
V_34 = F_260 ( V_72 , V_14 , V_29 ) ;
if ( V_34 ) {
if ( V_34 == - V_263 ) {
if ( ! V_33 )
goto V_304;
...
goto V_299;
V_305:
V_296 = F_276 ( V_72 , V_268 , V_293 , V_306 , 0 , V_158 | V_300 ) ;
if ( ! V_296 ) {
V_34 = F_271 ( & V_72 , V_14 , V_268 , V_291 ) ;
if ( V_34 )
goto V_304;
...
static int F_278 ( struct V_71 * V_72 , struct V_255 * V_16 )
{
struct V_14 * V_14 ;
struct V_28 * V_29 ;
int V_34 ;
...
return - V_66 ;
F_17 (opt_inst, &team->option_inst_list, list)
F_25 ( & V_29 -> V_298 , & V_294 ) ;
V_34 = F_273 ( V_14 , V_16 -> V_259 , V_16 -> V_260 ,
V_307 , F_258 ,
& V_294 ) ;
F_257 ( V_14 ) ;
return V_34 ;
}
static int F_280 ( struct V_71 * V_72 , struct V_255 * V_16 )
{
struct V_14 * V_14 ;
int V_34 = 0 ;
int V_33 ;
...
F_282 (nl_option, info->attrs[TEAM_ATTR_LIST_OPTION], i) {
struct V_249 * V_311 [ V_312 + 1 ] ;
struct V_249 * V_313 ;
struct V_249 * V_314 ;
enum V_315 V_316 ;
int V_317 = 0 ;
...
char * V_25 ;
bool V_320 = false ;
if ( F_283 ( V_308 ) != V_270 ) {
V_34 = - V_66 ;
goto V_310;
}
V_34 = F_284 ( V_311 , V_312 ,
V_308 , V_321 ) ;
if ( V_34 )
goto V_310;
if ( ! V_311 [ V_271 ] ||
...
V_314 = V_311 [ V_278 ] ;
if ( V_316 != V_285 && ! V_314 ) {
V_34 = - V_66 ;
goto V_310;
}
V_25 = F_244 ( V_311 [ V_271 ] ) ;
V_313 = V_311 [ V_273 ] ;
if ( V_313 )
V_317 = F_255 ( V_313 ) ;
V_313 = V_311 [ V_274 ] ;
...
switch ( V_316 ) {
case V_275 :
V_53 . V_176 . V_178 = F_255 ( V_314 ) ;
break;
case V_279 :
if ( F_243 ( V_314 ) > V_323 ) {
V_34 = - V_66 ;
goto V_310;
}
V_53 . V_176 . V_177 = F_244 ( V_314 ) ;
break;
case V_281 :
V_53 . V_176 . V_283 . V_106 = F_243 ( V_314 ) ;
V_53 . V_176 . V_283 . V_284 = F_244 ( V_314 ) ;
break;
case V_285 :
V_53 . V_176 . V_179 = V_314 ? true : false ;
break;
case V_287 :
V_53 . V_176 . V_180 = F_286 ( V_314 ) ;
break;
default:
F_268 () ;
}
...
static int F_289 ( struct V_71 * V_72 ,
struct V_1 * V_5 )
{
struct V_249 * V_324 ;
V_324 = F_261 ( V_72 , V_325 ) ;
if ( ! V_324 )
goto V_272;
if ( F_263 ( V_72 , V_326 , V_5 -> V_3 -> V_265 ) )
goto V_272;
if ( V_5 -> V_38 ) {
if ( F_266 ( V_72 , V_327 ) )
goto V_272;
...
( V_5 -> V_23 . V_18 &&
F_266 ( V_72 , V_329 ) ) ||
F_263 ( V_72 , V_330 , V_5 -> V_23 . V_331 ) ||
F_264 ( V_72 , V_332 , V_5 -> V_23 . V_333 ) )
goto V_272;
F_269 ( V_72 , V_324 ) ;
return 0 ;
V_272:
...
static int F_290 ( struct V_14 * V_14 , T_4 V_268 , T_4 V_293 ,
int V_158 , T_11 * V_291 ,
struct V_1 * V_334 )
{
struct V_249 * V_83 ;
...
if ( F_263 ( V_72 , V_267 , V_14 -> V_3 -> V_265 ) )
goto V_302;
V_83 = F_261 ( V_72 , V_336 ) ;
if ( ! V_83 )
goto V_302;
V_33 = 0 ;
V_297 = false ;
if ( V_334 ) {
V_34 = F_289 ( V_72 , V_334 ) ;
if ( V_34 )
goto V_304;
} else if ( V_5 ) {
F_275 (port, &team->port_list, list) {
V_34 = F_289 ( V_72 , V_5 ) ;
if ( V_34 ) {
if ( V_34 == - V_263 ) {
if ( ! V_33 )
...
static int F_292 ( struct V_71 * V_72 ,
struct V_255 * V_16 )
{
struct V_14 * V_14 ;
int V_34 ;
...
if ( ! V_14 )
return - V_66 ;
V_34 = F_290 ( V_14 , V_16 -> V_259 , V_16 -> V_260 ,
V_307 , F_258 , NULL ) ;
F_257 ( V_14 ) ;
return V_34 ;
}
...
struct V_14 * V_14 , T_4 V_268 )
{
return F_294 ( & V_261 , F_259 ( V_14 -> V_3 ) ,
V_72 , 0 , 0 , V_35 ) ;
}
static int F_288 ( struct V_14 * V_14 ,
struct V_112 * V_294 )
{
return F_273 ( V_14 , 0 , 0 , 0 , F_293 ,
V_294 ) ;
}
static int F_295 ( struct V_14 * V_14 ,
struct V_1 * V_5 )
{
return F_290 ( V_14 , 0 , 0 , 0 , F_293 ,
V_5 ) ;
}
static int T_12 F_296 ( void )
{
return F_297 ( & V_261 ) ;
}
...
V_34 = F_288 ( V_14 , & V_294 ) ;
if ( V_34 && V_34 != - V_337 )
F_300 ( V_14 -> V_3 , L_29 ,
V_34 ) ;
}
static void F_301 ( struct V_1 * V_5 , bool V_18 )
{
int V_34 ;
V_5 -> V_38 = true ;
V_5 -> V_23 . V_18 = V_18 ;
...
if ( V_18 ) {
struct V_338 V_339 ;
V_34 = F_302 ( V_5 -> V_3 , & V_339 ) ;
if ( ! V_34 ) {
V_5 -> V_23 . V_331 = V_339 . V_340 . V_331 ;
V_5 -> V_23 . V_333 = V_339 . V_340 . V_333 ;
goto V_341;
}
}
V_5 -> V_23 . V_331 = 0 ;
V_5 -> V_23 . V_333 = 0 ;
V_341:
V_34 = F_295 ( V_5 -> V_14 , V_5 ) ;
if ( V_34 && V_34 != - V_337 )
F_300 ( V_5 -> V_14 -> V_3 , L_30 ,
V_5 -> V_3 -> V_27 , V_34 ) ;
}
static void F_174 ( struct V_14 * V_14 )
{
struct V_1 * V_5 ;
bool V_342 ;
if ( V_14 -> V_75 )
...
static void F_303 ( struct V_1 * V_5 , bool V_18 )
{
if ( V_5 -> V_23 . V_18 != V_18 )
F_301 ( V_5 , V_18 ) ;
F_174 ( V_5 -> V_14 ) ;
}
static void F_150 ( struct V_1 * V_5 , bool V_18 )
{
F_301 ( V_5 , V_18 ) ;
F_174 ( V_5 -> V_14 ) ;
}
...
static int F_305 ( struct V_343 * V_344 ,
unsigned long V_345 , void * V_284 )
{
struct V_2 * V_3 = F_306 ( V_284 ) ;
struct V_1 * V_5 ;
V_5 = F_3 ( V_3 ) ;
if ( ! V_5 )
return V_346 ;
