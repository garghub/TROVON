...
int F_68 ( struct V_59 * V_59 , const char * V_11 )
{
struct V_1 * V_2 ;
int V_60 ;
V_2 = F_69 ( sizeof( struct V_14 ) , V_11 , V_61 ,
V_62 ) ;
if ( ! V_2 )
return - V_51 ;
F_70 ( V_2 , V_59 ) ;
...
int F_73 ( struct V_59 * V_59 , const char * V_11 )
{
struct V_1 * V_2 ;
int V_65 = 0 ;
F_74 () ;
...
const struct V_12 * V_13 ;
F_18 (p, &br->port_list, list) {
V_74 = F_81 ( V_74 , V_13 -> V_2 -> V_74 ) ;
V_76 = F_81 ( V_76 , V_13 -> V_2 -> V_76 ) ;
}
V_15 -> V_2 -> V_74 = V_74 ;
V_15 -> V_2 -> V_76 = V_76 ;
}
...
if ( V_22 )
goto V_97;
V_22 = F_92 ( & V_13 -> V_31 , & V_98 , & ( V_2 -> V_2 . V_31 ) ,
V_99 ) ;
if ( V_22 )
goto V_100;
V_22 = F_93 ( V_13 ) ;
...
void F_108 ( struct V_12 * V_13 , unsigned long V_79 )
{
struct V_14 * V_15 = V_13 -> V_15 ;
if ( V_79 & V_111 )
F_20 ( V_15 ) ;
