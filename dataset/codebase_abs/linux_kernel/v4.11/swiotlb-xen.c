...
T_2 F_48 ( struct V_1 * V_2 , struct V_62 * V_62 ,
...
void F_62 ( struct V_1 * V_53 , T_2 V_58 ,
T_4 V_22 , enum V_63 V_64 ,
unsigned long V_55 )
{
...
void
F_73 ( struct V_1 * V_53 , struct V_78 * V_79 ,
int V_80 , enum V_63 V_64 ,
unsigned long V_55 )
{
struct V_78 * V_81 ;
...
F_50 ( V_64 == V_66 ) ;
F_70 (sgl, sg, nelems, i)
F_58 ( V_53 , V_81 -> V_82 , F_74 ( V_81 ) , V_64 , V_55 ) ;
}
static void
...
int
F_80 ( struct V_1 * V_2 , struct V_85 * V_86 ,
void * V_87 , T_2 V_23 , T_4 V_22 ,
unsigned long V_55 )
{
#if F_81 ( V_88 ) || F_81 ( V_89 )
if ( F_82 ( V_2 ) -> V_90 )
return F_82 ( V_2 ) -> V_90 ( V_2 , V_86 , V_87 ,
V_23 , V_22 , V_55 ) ;
#endif
return F_83 ( V_2 , V_86 , V_87 , V_23 , V_22 ) ;
}
int
F_84 ( struct V_1 * V_2 , struct V_91 * V_92 ,
void * V_87 , T_2 V_93 , T_4 V_22 ,
unsigned long V_55 )
{
#if F_81 ( V_88 ) || F_81 ( V_89 )
if ( F_82 ( V_2 ) -> V_94 ) {
...
#endif
return F_82 ( V_2 ) -> V_94 ( V_2 , V_92 , V_87 ,
V_93 , V_22 , V_55 ) ;
}
#endif
return F_85 ( V_2 , V_92 , V_87 , V_93 , V_22 ) ;
}
