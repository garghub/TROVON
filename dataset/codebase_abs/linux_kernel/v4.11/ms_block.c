...
static void F_118 ( struct V_266 * V_267 )
{
struct V_43 * V_44 = V_267 -> V_268 ;
struct V_22 * V_23 = F_39 ( V_44 ) ;
...
static int F_120 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
return ( V_23 -> V_270 == 0 ) ;
}
static void F_121 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
unsigned long V_164 ;
F_40 ( L_94 ) ;
...
if ( V_23 -> V_46 ) {
F_100 ( & V_23 -> V_250 , V_164 ) ;
F_124 ( V_23 -> V_251 , V_23 -> V_46 ) ;
V_23 -> V_46 = NULL ;
F_101 ( & V_23 -> V_250 , V_164 ) ;
}
}
static void F_125 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
unsigned long V_164 ;
F_40 ( L_95 ) ;
...
T_8 V_273 = V_274 ;
unsigned long V_275 ;
if ( V_52 -> V_276 . V_277 && * ( V_52 -> V_276 . V_277 ) )
V_273 = * ( V_52 -> V_276 . V_277 ) ;
F_110 ( & V_260 ) ;
V_23 -> V_263 = F_128 ( & V_262 , V_44 , 0 , 256 , V_201 ) ;
F_111 ( & V_260 ) ;
if ( V_23 -> V_263 < 0 )
return V_23 -> V_263 ;
V_23 -> V_257 = F_129 ( 0 ) ;
...
V_23 -> V_251 = F_130 ( F_118 , & V_23 -> V_250 ) ;
if ( ! V_23 -> V_251 ) {
V_272 = - V_202 ;
goto V_279;
}
V_23 -> V_251 -> V_268 = V_44 ;
F_131 ( V_23 -> V_251 , V_273 ) ;
F_132 ( V_23 -> V_251 , V_280 ) ;
F_133 ( V_23 -> V_251 , V_281 ) ;
F_134 ( V_23 -> V_251 ,
V_280 * V_23 -> V_102 ) ;
F_135 ( V_23 -> V_251 , V_23 -> V_102 ) ;
sprintf ( V_23 -> V_257 -> V_282 , L_96 , V_23 -> V_263 ) ;
V_23 -> V_257 -> V_283 = & V_284 ;
V_23 -> V_257 -> V_259 = V_23 ;
V_23 -> V_257 -> V_251 = V_23 -> V_251 ;
V_23 -> V_257 -> V_164 |= V_285 ;
V_275 = V_23 -> V_116 * V_23 -> V_172 ;
V_275 *= ( V_23 -> V_102 / 512 ) ;
F_136 ( V_23 -> V_257 , V_275 ) ;
F_40 ( L_97 , V_275 ) ;
V_23 -> V_261 = 1 ;
V_23 -> V_219 = F_137 ( L_98 , V_286 ) ;
F_138 ( & V_23 -> V_220 , F_98 ) ;
F_41 ( V_23 -> V_249 , V_281 + 1 ) ;
if ( V_23 -> V_31 )
F_139 ( V_23 -> V_257 , 1 ) ;
F_125 ( V_44 ) ;
F_140 ( & V_44 -> V_276 , V_23 -> V_257 ) ;
F_40 ( L_99 ) ;
return 0 ;
V_279:
F_115 ( V_23 -> V_257 ) ;
...
static int F_141 ( struct V_43 * V_44 )
{
struct V_22 * V_23 ;
int V_272 = 0 ;
...
static void F_144 ( struct V_43 * V_44 )
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
unsigned long V_164 ;
if ( ! V_23 -> V_271 )
...
static int F_147 ( struct V_43 * V_44 , T_9 V_47 )
{
F_121 ( V_44 ) ;
return 0 ;
}
...
{
struct V_22 * V_23 = F_39 ( V_44 ) ;
struct V_22 * V_291 = NULL ;
bool V_270 = true ;
#ifndef F_149
V_23 -> V_270 = true ;
return 0 ;
#endif
F_110 ( & V_44 -> V_52 -> V_292 ) ;
V_291 = F_77 ( sizeof( struct V_22 ) , V_201 ) ;
if ( ! V_291 )
goto V_9;
V_291 -> V_44 = V_44 ;
F_142 ( V_44 , V_291 ) ;
...
if ( F_95 ( V_44 ) )
goto V_9;
if ( V_23 -> V_170 != V_291 -> V_170 )
goto V_9;
if ( memcmp ( V_23 -> V_200 , V_291 -> V_200 ,
sizeof( struct V_181 ) ) )
goto V_9;
if ( V_23 -> V_172 != V_291 -> V_172 ||
memcmp ( V_23 -> V_179 , V_291 -> V_179 ,
V_23 -> V_172 ) )
goto V_9;
if ( V_23 -> V_29 != V_291 -> V_29 ||
memcmp ( V_23 -> V_30 , V_291 -> V_30 ,
V_23 -> V_29 / 8 ) )
goto V_9;
V_270 = false ;
V_9:
...
F_125 ( V_44 ) ;
F_111 ( & V_44 -> V_52 -> V_292 ) ;
return 0 ;
}
static int T_10 F_150 ( void )
{
int V_272 = F_151 ( & V_293 ) ;
if ( V_272 )
F_17 ( L_102 , V_272 ) ;
return V_272 ;
}
