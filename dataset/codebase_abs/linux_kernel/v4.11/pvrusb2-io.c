...
if ( V_43 ) {
V_46 = F_26 ( V_21 -> V_47 , V_43 * sizeof( * V_46 ) ,
V_40 ) ;
if ( ! V_46 ) return - V_41 ;
}
F_24 ( V_21 -> V_47 ) ;
...
V_51 = F_29 ( V_50 , struct V_7 , V_30 ) ;
F_14 ( V_51 ) ;
...
F_28 ( V_21 ) ;
F_22 ( V_21 , 0 ) ;
} while ( 0 ); F_35 ( & V_21 -> V_53 ) ;
}
static void F_36 ( struct V_54 * V_54 )
{
...
struct V_20 * F_37 ( void )
{
struct V_20 * V_21 ;
V_21 = F_38 ( sizeof( * V_21 ) , V_40 ) ;
if ( ! V_21 ) return V_21 ;
F_3 ( V_68 , L_22 , V_21 ) ;
F_30 ( V_21 ) ;
return V_21 ;
...
int F_44 ( struct V_20 * V_21 , unsigned int V_17 )
{
int V_42 ;
...
return F_29 ( V_50 , struct V_7 , V_30 ) ;
}
struct V_7 * F_46 ( struct V_20 * V_21 )
{
struct V_49 * V_50 = V_21 -> V_35 . V_52 ;
if ( V_50 == & V_21 -> V_35 ) return NULL ;
return F_29 ( V_50 , struct V_7 , V_30 ) ;
}
struct V_7 * F_47 ( struct V_20 * V_21 , int V_12 )
{
...
int F_54 ( struct V_7 * V_8 , void * V_86 , unsigned int V_17 )
{
int V_42 = 0 ;
unsigned long V_32 ;
struct V_20 * V_21 ;
...
unsigned int F_55 ( struct V_7 * V_8 )
{
return V_8 -> V_29 ;
}
