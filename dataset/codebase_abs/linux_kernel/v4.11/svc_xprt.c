...
int V_142 ;
int V_143 ;
V_142 = ( V_34 -> V_144 + V_145 ) / V_145 ;
F_95 ( V_142 >= V_146 ) ;
if ( V_142 >= V_146 )
V_142 = V_146 - 1 ;
for ( V_143 = 0 ; V_143 < V_142 ; V_143 ++ )
while ( V_81 -> V_147 [ V_143 ] == NULL ) {
struct V_148 * V_149 = F_96 ( V_150 ) ;
if ( ! V_149 ) {
F_97 ( V_151 ) ;
if ( F_98 () || F_99 () ) {
F_97 ( V_152 ) ;
...
V_81 -> V_147 [ V_143 ] = V_149 ;
}
V_81 -> V_154 = & V_81 -> V_147 [ V_143 ] ;
V_81 -> V_147 [ V_143 ++ ] = NULL ;
V_141 = & V_81 -> V_155 ;
V_141 -> V_118 [ 0 ] . V_156 = F_102 ( V_81 -> V_147 [ 0 ] ) ;
V_141 -> V_118 [ 0 ] . V_119 = V_145 ;
V_141 -> V_142 = V_81 -> V_147 + 1 ;
V_141 -> V_125 = 0 ;
V_141 -> V_124 = ( V_142 - 2 ) * V_145 ;
V_141 -> V_14 = ( V_142 - 1 ) * V_145 ;
V_141 -> V_157 [ 0 ] . V_119 = 0 ;
return 0 ;
}
static bool
F_103 ( struct V_80 * V_81 )
{
struct V_102 * V_103 = V_81 -> V_158 ;
...
static struct V_18 * F_105 ( struct V_80 * V_81 , long V_160 )
{
struct V_18 * V_19 ;
struct V_102 * V_103 = V_81 -> V_158 ;
long V_161 = 0 ;
F_95 ( V_81 -> V_96 ) ;
V_81 -> V_162 . V_163 = 5 * V_164 ;
V_19 = F_74 ( V_103 ) ;
if ( V_19 ) {
V_81 -> V_96 = V_19 ;
V_81 -> V_162 . V_163 = 1 * V_164 ;
...
return V_19 ;
if ( ! V_161 )
F_67 ( & V_103 -> V_106 . V_165 ) ;
if ( F_98 () || F_99 () )
return F_32 ( - V_153 ) ;
return F_32 ( - V_166 ) ;
}
static void F_109 ( struct V_33 * V_34 , struct V_18 * V_167 )
{
F_39 ( & V_34 -> V_73 ) ;
F_25 ( V_72 , & V_167 -> V_26 ) ;
F_40 ( & V_167 -> V_37 , & V_34 -> V_136 ) ;
V_34 -> V_135 ++ ;
if ( V_34 -> V_168 . V_169 == NULL ) {
F_110 ( & V_34 -> V_168 , V_170 ,
( unsigned long ) V_34 ) ;
F_111 ( & V_34 -> V_168 ,
V_171 + V_172 * V_164 ) ;
}
...
static int F_112 ( struct V_80 * V_81 , struct V_18 * V_19 )
{
struct V_33 * V_34 = V_81 -> V_139 ;
int V_14 = 0 ;
if ( F_13 ( V_98 , & V_19 -> V_26 ) ) {
F_2 ( L_17 ) ;
if ( F_58 ( V_173 , & V_19 -> V_26 ) )
V_19 -> V_30 -> V_174 ( V_19 ) ;
F_113 ( V_19 ) ;
goto V_9;
}
if ( F_13 ( V_175 , & V_19 -> V_26 ) ) {
struct V_18 * V_167 ;
F_114 ( V_19 -> V_23 -> V_24 ) ;
F_91 ( V_19 -> V_36 ) ;
V_167 = V_19 -> V_30 -> V_176 ( V_19 ) ;
if ( V_167 )
F_109 ( V_34 , V_167 ) ;
else
F_18 ( V_19 -> V_23 -> V_24 ) ;
...
F_2 ( L_18 ,
V_81 , V_81 -> V_158 -> V_177 , V_19 ,
F_78 ( & V_19 -> V_20 ) ) ;
V_81 -> V_123 = F_115 ( V_19 ) ;
if ( V_81 -> V_123 )
V_14 = F_116 ( V_81 ) ;
else
V_14 = V_19 -> V_30 -> V_178 ( V_81 ) ;
F_2 ( L_19 , V_14 ) ;
V_81 -> V_120 = V_34 -> V_144 ;
F_117 ( V_81 -> V_120 , & V_19 -> V_121 ) ;
}
F_33 ( V_19 ) ;
V_9:
F_118 ( V_19 , V_14 ) ;
...
int F_119 ( struct V_80 * V_81 , long V_160 )
{
struct V_18 * V_19 = NULL ;
struct V_33 * V_34 = V_81 -> V_139 ;
int V_14 , V_78 ;
...
if ( F_98 () || F_99 () )
goto V_9;
V_19 = F_105 ( V_81 , V_160 ) ;
if ( F_44 ( V_19 ) ) {
V_78 = F_45 ( V_19 ) ;
goto V_9;
}
V_14 = F_112 ( V_81 , V_19 ) ;
V_78 = - V_166 ;
if ( V_14 <= 0 )
goto V_179;
F_37 ( V_180 , & V_19 -> V_26 ) ;
if ( V_19 -> V_30 -> V_181 ( V_81 ) )
F_25 ( V_182 , & V_81 -> V_95 ) ;
else
F_37 ( V_182 , & V_81 -> V_95 ) ;
V_81 -> V_162 . V_183 = V_184 ;
V_81 -> V_185 = F_121 ( & V_81 -> V_155 . V_118 [ 0 ] ) ;
if ( V_34 -> V_186 )
V_34 -> V_186 -> V_187 ++ ;
F_122 ( V_81 , V_14 ) ;
return V_14 ;
...
void F_123 ( struct V_80 * V_81 )
{
F_124 ( V_81 ) ;
F_2 ( L_22 , V_81 -> V_96 ) ;
F_82 ( V_81 ) ;
}
int F_125 ( struct V_80 * V_81 )
{
struct V_18 * V_19 ;
int V_14 = - V_188 ;
struct V_140 * V_189 ;
...
V_81 -> V_96 -> V_30 -> V_122 ( V_81 ) ;
V_189 = & V_81 -> V_117 ;
V_189 -> V_14 = V_189 -> V_118 [ 0 ] . V_119 +
V_189 -> V_124 +
V_189 -> V_157 [ 0 ] . V_119 ;
F_126 ( & V_19 -> V_41 ) ;
if ( F_13 ( V_190 , & V_19 -> V_26 )
|| F_13 ( V_98 , & V_19 -> V_26 ) )
V_14 = - V_191 ;
else
V_14 = V_19 -> V_30 -> V_192 ( V_81 ) ;
F_127 ( & V_19 -> V_41 ) ;
F_128 ( & V_19 -> V_44 ) ;
F_82 ( V_81 ) ;
if ( V_14 == - V_193 || V_14 == - V_191 || V_14 == - V_166 )
V_14 = 0 ;
V_9:
F_129 ( V_81 , V_14 ) ;
return V_14 ;
}
static void V_170 ( unsigned long V_194 )
{
struct V_33 * V_34 = (struct V_33 * ) V_194 ;
struct V_18 * V_19 ;
struct V_195 * V_196 , * V_197 ;
F_2 ( L_23 ) ;
if ( ! F_130 ( & V_34 -> V_73 ) ) {
F_2 ( L_24 ) ;
F_111 ( & V_34 -> V_168 , V_171 + V_164 ) ;
return;
}
F_131 (le, next, &serv->sv_tempsocks) {
V_19 = F_93 ( V_196 , struct V_18 , V_37 ) ;
if ( ! F_64 ( V_180 , & V_19 -> V_26 ) )
continue;
if ( F_78 ( & V_19 -> V_20 ) > 1 ||
F_13 ( V_43 , & V_19 -> V_26 ) )
continue;
...
F_41 ( & V_34 -> V_73 ) ;
F_111 ( & V_34 -> V_168 , V_171 + V_172 * V_164 ) ;
}
void F_132 ( struct V_33 * V_34 , struct V_63 * V_198 )
{
struct V_18 * V_19 ;
struct V_195 * V_196 , * V_197 ;
F_133 ( V_199 ) ;
...
static int F_140 ( struct V_33 * V_34 , struct V_195 * V_207 , struct V_32 * V_32 )
{
struct V_18 * V_19 ;
int V_208 = 0 ;
F_4 ( & V_34 -> V_73 ) ;
...
static struct V_18 * F_141 ( struct V_33 * V_34 , struct V_32 * V_32 )
{
struct V_102 * V_103 ;
struct V_18 * V_19 ;
struct V_18 * V_209 ;
int V_143 ;
for ( V_143 = 0 ; V_143 < V_34 -> V_210 ; V_143 ++ ) {
V_103 = & V_34 -> V_127 [ V_143 ] ;
F_39 ( & V_103 -> V_113 ) ;
F_142 (xprt, tmp, &pool->sp_sockets, xpt_ready) {
if ( V_19 -> V_27 != V_32 )
continue;
F_9 ( & V_19 -> V_38 ) ;
F_41 ( & V_103 -> V_113 ) ;
...
static void F_143 ( struct V_33 * V_34 , struct V_32 * V_32 )
{
struct V_18 * V_19 ;
while ( ( V_19 = F_141 ( V_34 , V_32 ) ) ) {
F_25 ( V_98 , & V_19 -> V_26 ) ;
F_113 ( V_19 ) ;
}
}
void F_144 ( struct V_33 * V_34 , struct V_32 * V_32 )
{
int V_211 = 0 ;
while ( F_140 ( V_34 , & V_34 -> V_74 , V_32 ) +
F_140 ( V_34 , & V_34 -> V_136 , V_32 ) ) {
F_143 ( V_34 , V_32 ) ;
F_145 ( V_211 ++ ) ;
}
}
static void F_146 ( struct V_212 * V_213 , int V_214 )
{
struct V_204 * V_205 =
...
static struct V_212 * V_184 ( struct V_217 * V_218 )
{
struct V_80 * V_81 = F_12 ( V_218 , struct V_80 , V_162 ) ;
struct V_204 * V_205 ;
if ( V_81 -> V_155 . V_124 || ! F_13 ( V_219 , & V_81 -> V_95 ) )
return NULL ;
if ( V_81 -> V_123 ) {
V_205 = V_81 -> V_123 ;
V_81 -> V_123 = NULL ;
...
T_1 V_220 ;
T_1 V_221 ;
V_221 = sizeof( struct V_204 ) + V_81 -> V_155 . V_14 ;
V_205 = F_148 ( V_221 , V_150 ) ;
if ( V_205 == NULL )
return NULL ;
V_205 -> V_215 . V_22 = V_81 -> V_139 ;
V_205 -> V_222 = V_81 -> V_223 ;
memcpy ( & V_205 -> V_224 , & V_81 -> V_82 , V_81 -> V_85 ) ;
V_205 -> V_225 = V_81 -> V_85 ;
V_205 -> V_226 = V_81 -> V_86 ;
V_205 -> V_227 = V_81 -> V_155 . V_14 >> 2 ;
V_205 -> V_228 = V_81 -> V_229 ;
V_220 = V_81 -> V_155 . V_14 - V_81 -> V_155 . V_118 [ 0 ] . V_119 ;
memcpy ( V_205 -> args , V_81 -> V_155 . V_118 [ 0 ] . V_156 - V_220 ,
V_205 -> V_227 << 2 ) ;
}
F_35 ( V_81 -> V_96 ) ;
V_205 -> V_19 = V_81 -> V_96 ;
F_25 ( V_230 , & V_81 -> V_95 ) ;
V_205 -> V_215 . V_231 = F_146 ;
F_149 ( V_81 ) ;
return & V_205 -> V_215 ;
}
static int F_116 ( struct V_80 * V_81 )
{
struct V_204 * V_205 = V_81 -> V_123 ;
V_81 -> V_155 . V_118 [ 0 ] . V_156 = V_205 -> args + ( V_205 -> V_228 >> 2 ) ;
V_81 -> V_155 . V_118 [ 0 ] . V_119 = ( V_205 -> V_227 << 2 ) - V_205 -> V_228 ;
V_81 -> V_155 . V_124 = 0 ;
V_81 -> V_155 . V_14 = V_205 -> V_227 << 2 ;
...
V_81 -> V_232 = V_81 -> V_147 ;
return ( V_205 -> V_227 << 2 ) - V_205 -> V_228 ;
}
static struct V_204 * F_115 ( struct V_18 * V_19 )
{
...
struct V_18 * F_151 ( struct V_33 * V_34 , const char * V_6 ,
...
static int F_152 ( const struct V_18 * V_19 ,
...
int F_153 ( struct V_33 * V_34 , char * V_11 , const int V_240 )
{
struct V_18 * V_19 ;
int V_14 , V_241 ;
char * V_237 ;
...
V_241 = 0 ;
F_5 (xprt, &serv->sv_permsocks, xpt_list) {
V_14 = F_152 ( V_19 , V_237 , V_240 - V_241 ) ;
if ( V_14 < 0 ) {
* V_11 = '\0' ;
V_241 = V_14 ;
}
...
static void * F_154 ( struct V_242 * V_243 , T_3 * V_237 )
{
...
if ( ! V_244 )
return V_246 ;
return ( V_244 > V_34 -> V_210 ? NULL : & V_34 -> V_127 [ V_244 - 1 ] ) ;
}
static void * F_155 ( struct V_242 * V_243 , void * V_149 , T_3 * V_237 )
{
struct V_102 * V_103 = V_149 ;
struct V_33 * V_34 = V_243 -> V_245 ;
F_2 ( L_33 , * V_237 ) ;
if ( V_149 == V_246 ) {
V_103 = & V_34 -> V_127 [ 0 ] ;
} else {
unsigned int V_244 = ( V_103 - & V_34 -> V_127 [ 0 ] ) ;
if ( V_244 < V_34 -> V_210 - 1 )
V_103 = & V_34 -> V_127 [ V_244 + 1 ] ;
else
V_103 = NULL ;
}
++ * V_237 ;
...
static void F_156 ( struct V_242 * V_243 , void * V_149 )
{
}
static int F_157 ( struct V_242 * V_243 , void * V_149 )
{
struct V_102 * V_103 = V_149 ;
if ( V_149 == V_246 ) {
F_158 ( V_243 , L_34 ) ;
...
F_159 ( V_243 , L_35 ,
V_103 -> V_177 ,
( unsigned long ) F_160 ( & V_103 -> V_106 . V_107 ) ,
V_103 -> V_106 . V_115 ,
( unsigned long ) F_160 ( & V_103 -> V_106 . V_111 ) ,
( unsigned long ) F_160 ( & V_103 -> V_106 . V_165 ) ) ;
return 0 ;
}
int F_161 ( struct V_33 * V_34 , struct V_247 * V_247 )
{
int V_78 ;
V_78 = F_162 ( V_247 , & V_248 ) ;
if ( ! V_78 )
