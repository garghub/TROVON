...
int
F_40 ( const struct V_81 * V_73 , struct V_6 * V_7 ,
...
T_3 V_88 , V_30 = 0 ;
enum V_89 type = F_41 ( V_22 ) ;
bool V_90 = true ;
int V_41 , V_13 ;
F_42 ( V_11 , L_7 , F_4 ( V_10 , 0x100800 ) ) ;
F_42 ( V_11 , L_8 , V_85 , V_86 ) ;
...
F_42 ( V_11 , L_9 , V_13 , ( T_1 ) ( V_88 >> 20 ) ) ;
V_30 += V_88 ;
}
V_41 = F_43 ( V_73 , V_7 , type , V_30 , 0 , V_5 ) ;
if ( V_41 )
return V_41 ;
F_44 ( & V_5 -> V_62 ) ;
if ( V_90 ) {
V_41 = F_45 ( & V_5 -> V_62 , V_83 >> V_69 ,
( V_30 - V_83 - V_84 ) >>
V_69 , 1 ) ;
if ( V_41 )
return V_41 ;
...
if ( V_41 )
return V_41 ;
V_41 = F_45 ( & V_5 -> V_62 , ( 0x0200000000ULL + V_87 ) >>
V_69 ,
( V_30 - ( V_87 * V_85 ) - V_84 ) >>
V_69 , 1 ) ;
if ( V_41 )
...
int
F_46 ( struct V_6 * V_7 , struct V_16 * * V_92 )
{
struct V_18 * V_11 = & V_7 -> V_11 ;
...
return - V_71 ;
* V_92 = & V_5 -> V_8 ;
V_41 = F_40 ( & V_93 , V_7 , 0x022554 , & V_5 -> V_8 ) ;
if ( V_41 )
return V_41 ;
V_41 = F_47 ( V_22 , 0x0c , & V_5 -> V_45 ) ;
if ( V_41 ) {
F_9 ( V_11 , L_10 ) ;
return V_41 ;
}
V_41 = F_47 ( V_22 , 0x04 , & V_5 -> V_46 ) ;
if ( V_41 ) {
F_9 ( V_11 , L_11 ) ;
return V_41 ;
}
V_5 -> V_2 . V_94 = F_48 ( 0x10fe20 ) ;
V_5 -> V_2 . V_95 = F_48 ( 0x10fe24 ) ;
V_5 -> V_2 . V_96 = F_48 ( 0x137320 ) ;
V_5 -> V_2 . V_97 = F_48 ( 0x137330 ) ;
V_5 -> V_2 . V_98 = F_48 ( 0x132000 ) ;
V_5 -> V_2 . V_99 = F_48 ( 0x132004 ) ;
V_5 -> V_2 . V_100 = F_48 ( 0x132100 ) ;
V_5 -> V_2 . V_101 = F_48 ( 0x137390 ) ;
V_5 -> V_2 . V_102 = F_48 ( 0x10f290 ) ;
V_5 -> V_2 . V_103 = F_48 ( 0x10f294 ) ;
V_5 -> V_2 . V_104 = F_48 ( 0x10f298 ) ;
V_5 -> V_2 . V_105 = F_48 ( 0x10f29c ) ;
V_5 -> V_2 . V_106 = F_48 ( 0x10f2a0 ) ;
V_5 -> V_2 . V_107 = F_48 ( 0x10f300 ) ;
V_5 -> V_2 . V_108 = F_48 ( 0x10f338 ) ;
V_5 -> V_2 . V_109 = F_48 ( 0x10f340 ) ;
V_5 -> V_2 . V_110 = F_48 ( 0x10f344 ) ;
V_5 -> V_2 . V_111 = F_48 ( 0x10f348 ) ;
V_5 -> V_2 . V_112 = F_48 ( 0x10f910 ) ;
V_5 -> V_2 . V_113 = F_48 ( 0x10f914 ) ;
V_5 -> V_2 . V_114 = F_48 ( 0x100b0c ) ;
V_5 -> V_2 . V_115 = F_48 ( 0x10f050 ) ;
V_5 -> V_2 . V_116 = F_48 ( 0x10f090 ) ;
V_5 -> V_2 . V_117 = F_48 ( 0x10f200 ) ;
V_5 -> V_2 . V_118 = F_48 ( 0x10f210 ) ;
V_5 -> V_2 . V_119 = F_48 ( 0x10f310 ) ;
V_5 -> V_2 . V_120 = F_48 ( 0x10f314 ) ;
V_5 -> V_2 . V_121 = F_48 ( 0x10f610 ) ;
V_5 -> V_2 . V_122 = F_48 ( 0x10f614 ) ;
V_5 -> V_2 . V_123 = F_48 ( 0x10f800 ) ;
V_5 -> V_2 . V_124 = F_48 ( 0x10f808 ) ;
V_5 -> V_2 . V_125 = F_48 ( 0x10f824 ) ;
V_5 -> V_2 . V_126 = F_48 ( 0x10f830 ) ;
V_5 -> V_2 . V_127 = F_48 ( 0x10f988 ) ;
V_5 -> V_2 . V_128 = F_48 ( 0x10f98c ) ;
V_5 -> V_2 . V_129 = F_48 ( 0x10f990 ) ;
V_5 -> V_2 . V_130 = F_48 ( 0x10f998 ) ;
V_5 -> V_2 . V_131 = F_48 ( 0x10f9b0 ) ;
V_5 -> V_2 . V_132 = F_48 ( 0x10f9b4 ) ;
V_5 -> V_2 . V_133 = F_48 ( 0x10fb04 ) ;
V_5 -> V_2 . V_134 = F_48 ( 0x10fb08 ) ;
V_5 -> V_2 . V_135 = F_48 ( 0x137300 ) ;
V_5 -> V_2 . V_135 = F_48 ( 0x137310 ) ;
V_5 -> V_2 . V_136 = F_48 ( 0x137360 ) ;
V_5 -> V_2 . V_137 = F_48 ( 0x1373ec ) ;
V_5 -> V_2 . V_138 = F_48 ( 0x1373f0 ) ;
V_5 -> V_2 . V_139 = F_48 ( 0x1373f8 ) ;
V_5 -> V_2 . V_140 = F_48 ( 0x61c140 ) ;
V_5 -> V_2 . V_141 = F_48 ( 0x611200 ) ;
V_5 -> V_2 . V_142 = F_48 ( 0x13d8f4 ) ;
return 0 ;
}
