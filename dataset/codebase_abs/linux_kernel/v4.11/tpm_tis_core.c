...
static int F_25 ( struct V_1 * V_2 , T_1 * V_33 , T_3 V_34 )
{
struct V_4 * V_5 = F_2 ( & V_2 -> V_6 ) ;
int V_35 = 0 ;
int V_40 , V_27 ;
...
V_29 = F_22 ( int , V_29 , V_46 - V_34 - 1 ) ;
...
V_10 = F_9 ( V_5 , F_24 ( V_5 -> V_15 ) , V_33 [ V_34 ] ) ;
if ( V_10 < 0 )
goto V_50;
if ( F_20 ( V_2 , V_37 , V_2 -> V_38 ,
& V_5 -> V_23 , false ) < 0 ) {
