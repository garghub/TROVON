...
V_125 = F_191 ( & V_342 , & V_4 -> V_8 ) ;
if ( V_125 )
F_184 ( V_4 ) ;
return V_125 ;
}
static int F_192 ( struct V_1 * V_2 , const struct V_348 * V_349 )
{
struct V_3 * V_4 ;
...
V_125 = F_187 ( & V_2 -> V_2 , V_4 , & V_2 -> V_355 , V_351 ) ;
if ( V_125 )
return V_125 ;
F_195 ( V_2 , V_4 ) ;
return F_189 ( V_4 ) ;
...
if ( ! V_4 )
return - V_301 ;
return F_203 ( & V_342 , & V_4 -> V_8 ) ;
}
static int F_204 ( struct V_356 * V_357 )
{
struct V_3 * V_4 ;
struct V_343 * V_358 ;
int V_351 , V_125 ;
...
if ( V_351 < 0 )
return V_351 ;
V_4 = F_193 ( & V_357 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_125 = F_205 ( V_357 , 0 ) ;
...
V_358 = F_206 ( V_357 , V_363 , 0 ) ;
V_125 = F_187 ( & V_357 -> V_2 , V_4 , V_358 , V_351 ) ;
if ( V_125 )
return V_125 ;
F_207 ( V_357 , V_4 ) ;
return F_189 ( V_4 ) ;
}
static int F_208 ( struct V_356 * V_357 )
{
struct V_3 * V_4 = F_209 ( V_357 ) ;
F_198 ( & V_342 , & V_4 -> V_8 ) ;
F_184 ( V_4 ) ;
return 0 ;
}
