...
if ( V_2 -> V_3 . V_85 && V_56 == V_86 &&
V_7 -> V_87 == V_88 ) {
if ( V_59 -> V_89 != F_24 ( V_7 , V_8 ) ) {
V_83 = L_30 ;
goto V_84;
}
V_7 -> V_87 = V_90 ;
...
V_84:
if ( F_25 ( V_2 , V_91 ) )
F_26 ( V_2 , V_55 , 0 , V_7 , NULL , NULL , NULL , L_31 , V_83 ) ;
return - V_80 ;
}
static int F_27 ( struct V_6 * V_7 , struct V_92 * V_93 ,
struct V_23 * V_3 )
{
struct V_92 * V_94 ;
F_18 ( & V_3 -> V_65 ) ;
V_94 = F_28 ( V_7 , V_95 | V_96 ) ;
if ( ! V_94 )
goto V_97;
if ( F_29 ( V_7 , V_98 , V_3 -> V_25 . V_5 . V_26 ) ||
F_30 ( V_7 , V_99 ,
...
static int F_32 ( struct V_92 * V_101 [] , struct V_23 * V_3 )
{
struct V_92 * V_102 = V_101 [ V_95 ] ;
struct V_92 * V_103 [ V_104 + 1 ] ;
int V_105 ;
if ( ! V_102 )
return 0 ;
V_105 = F_33 ( V_103 ,
...
return - V_107 ;
F_18 ( & V_3 -> V_65 ) ;
V_3 -> V_25 . V_5 . V_26 = F_34 ( V_103 [ V_98 ] ) ;
V_3 -> V_25 . V_5 . V_63 [ V_81 ] =
F_35 ( V_103 [ V_99 ] ) ;
V_3 -> V_25 . V_5 . V_63 [ V_75 ] =
F_35 ( V_103 [ V_100 ] ) ;
...
static int F_39 ( struct V_92 * V_103 [] ,
struct V_2 * V_2 , void * V_108 )
{
unsigned int * V_52 = V_108 ;
struct V_1 * V_109 = F_1 ( V_2 ) ;
int V_44 ;
for ( V_44 = 0 ; V_44 < V_69 ; V_44 ++ )
V_52 [ V_44 ] = V_109 -> V_52 [ V_44 ] ;
for ( V_44 = V_110 + 1 ; V_44 < V_111 + 1 ; V_44 ++ ) {
if ( V_103 [ V_44 ] ) {
V_52 [ V_44 ] = F_40 ( F_35 ( V_103 [ V_44 ] ) ) * V_112 ;
}
}
return 0 ;
}
static int
F_41 ( struct V_6 * V_7 , const void * V_108 )
{
const unsigned int * V_52 = V_108 ;
int V_44 ;
for ( V_44 = V_110 + 1 ; V_44 < V_111 + 1 ; V_44 ++ ) {
if ( F_30 ( V_7 , V_44 , F_42 ( V_52 [ V_44 ] / V_112 ) ) )
goto V_97;
}
return 0 ;
V_97:
...
if ( V_115 -> V_116 )
return 0 ;
V_115 -> V_116 = F_45 ( V_117 ,
sizeof( V_117 ) ,
V_118 ) ;
if ( ! V_115 -> V_116 )
return - V_119 ;
V_115 -> V_116 [ 0 ] . V_108 = & V_109 -> V_52 [ V_120 ] ;
V_115 -> V_116 [ 1 ] . V_108 = & V_109 -> V_52 [ V_121 ] ;
V_115 -> V_116 [ 2 ] . V_108 = & V_109 -> V_52 [ V_74 ] ;
V_115 -> V_116 [ 3 ] . V_108 = & V_109 -> V_52 [ V_76 ] ;
V_115 -> V_116 [ 4 ] . V_108 = & V_109 -> V_52 [ V_122 ] ;
V_115 -> V_116 [ 5 ] . V_108 = & V_109 -> V_52 [ V_123 ] ;
V_115 -> V_116 [ 6 ] . V_108 = & V_109 -> V_52 [ V_124 ] ;
V_115 -> V_116 [ 7 ] . V_108 = & V_109 -> V_52 [ V_125 ] ;
V_115 -> V_116 [ 8 ] . V_108 = & V_109 -> V_52 [ V_126 ] ;
#endif
return 0 ;
}
static int F_46 ( struct V_2 * V_2 , T_6 V_25 )
{
struct V_1 * V_109 = F_1 ( V_2 ) ;
...
int V_44 ;
for ( V_44 = 0 ; V_44 < V_69 ; V_44 ++ )
V_109 -> V_52 [ V_44 ] = V_128 [ V_44 ] ;
}
return F_43 ( V_115 , V_109 ) ;
}
