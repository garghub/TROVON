...
int F_57 ( struct V_88 * V_89 , struct V_90 * V_91 )
{
int V_9 ;
int V_92 ;
for ( V_9 = 0 ; V_9 < 8 ; V_9 ++ ) {
...
V_103 = F_59 ( V_2 ) ;
F_22 ( & V_98 ) ;
if ( ! F_64 ( V_101 . V_104 , V_103 ) )
V_59 = V_105 ;
else if ( F_64 ( V_101 . V_106 , V_103 ) )
V_59 = V_107 ;
else if ( F_64 ( V_101 . V_108 , V_103 ) )
V_59 = V_109 ;
else
V_59 = V_110 ;
F_23 ( & V_98 ) ;
...
static enum V_111 F_65 ( struct V_1 V_2 )
{
return V_112 [ V_2 . V_16 ] [ V_2 . V_10 ] ;
}
static void F_66 ( struct V_1 V_2 , enum V_111 V_113 )
{
V_112 [ V_2 . V_16 ] [ V_2 . V_10 ] = V_113 ;
}
static enum V_111 F_67 ( struct V_1 * V_2 )
{
enum V_111 V_114 = V_115 ;
F_68 (chpid) {
V_114 = F_65 ( * V_2 ) ;
if ( V_114 != V_115 )
break;
...
void F_28 ( struct V_1 V_2 , int V_123 )
{
F_47 ( 2 , L_24 , V_2 . V_16 , V_2 . V_10 ,
V_123 ) ;
F_70 ( & V_118 ) ;
F_66 ( V_2 , V_123 ? V_119 : V_120 ) ;
F_71 ( & V_118 ) ;
F_75 ( & V_122 ) ;
}
