...
if ( V_12 < V_112 )
return NULL ;
V_6 = F_79 ( sizeof( * V_6 ) + V_12 * sizeof( struct V_1 ) ) ;
if ( ! V_6 )
return NULL ;
V_6 -> V_26 = V_26 ;
V_6 -> V_12 = V_12 ;
...
static inline void * F_83 ( struct V_113 * V_114 , T_5 V_115 )
{
struct V_5 * V_6 = V_114 -> V_116 ;
return V_115 >= V_6 -> V_12 ? NULL : & V_6 -> V_57 [ V_115 ] ;
}
static void * F_84 ( struct V_113 * V_114 , T_5 * V_115 )
{
return * V_115 ? F_83 ( V_114 , * V_115 - 1 ) : V_117 ;
}
static void * F_85 ( struct V_113 * V_114 , void * V_118 , T_5 * V_115 )
{
V_118 = F_83 ( V_114 , * V_115 ) ;
if ( V_118 )
++ * V_115 ;
return V_118 ;
}
static void F_86 ( struct V_113 * V_114 , void * V_118 )
{
}
...
static int F_88 ( struct V_113 * V_114 , void * V_118 )
{
if ( V_118 == V_117 )
F_89 ( V_114 , L_2
L_3 ) ;
...
sprintf ( V_119 , V_2 -> V_16 ? L_4 : L_5 , V_2 -> V_14 ) ;
F_90 ( V_114 , L_6 ,
V_2 -> V_25 + V_6 -> V_26 , V_119 , V_2 -> V_43 ,
V_2 -> V_3 & V_120 , F_1 ( V_2 ) , V_2 -> V_39 ,
F_87 ( V_2 ) , F_43 ( & V_2 -> V_7 ) ,
V_2 -> V_19 ? V_2 -> V_19 -> V_40 -> V_121 : L_7 ) ;
F_40 ( & V_2 -> V_58 ) ;
}
return 0 ;
}
static int F_91 ( struct V_122 * V_122 , struct V_123 * V_123 )
{
int V_124 = F_92 ( V_123 , & V_125 ) ;
if ( ! V_124 ) {
struct V_20 * V_21 = V_122 -> V_126 ;
struct V_113 * V_114 = V_123 -> V_127 ;
V_114 -> V_116 = V_21 -> V_23 ;
}
return V_124 ;
}
