...
static struct V_46 * F_31 ( struct V_21 * V_30 )
{
unsigned long V_47 ;
struct V_48 * V_49 ;
struct V_46 * V_50 ;
V_47 = F_32 ( F_33 ( V_30 -> V_26 ) ) ;
V_49 = F_34 ( V_47 ) ;
V_50 = F_35 ( V_49 ) ;
return V_50 ;
}
...
static bool F_44 ( struct V_21 * V_30 )
{
int V_25 , V_61 ;
int V_62 = 1 ;
...
V_52 = F_1 () ;
V_55 = F_39 ( V_30 -> V_26 ) ;
F_40 ( V_55 , V_30 -> V_26 , V_52 ) ;
F_41 ( V_30 -> V_26 , V_52 ) ;
F_30 ( V_30 ) ;
return 0 ;
}
static int F_51 ( T_2 V_67 ,
struct V_11 * V_12 )
{
struct V_21 * V_22 ;
int V_68 = 0 ;
...
F_52 ( L_17 , V_22 [ V_25 ] . V_26 ) ;
return V_62 ;
}
static int F_56 ( T_2 V_27 , struct V_11 * V_12 )
{
struct V_21 * V_22 ;
T_2 V_23 , * V_24 ;
int V_71 ;
...
F_52 ( L_22 , V_22 [ V_25 ] . V_26 ) ;
return V_62 ;
}
static int F_57 ( T_2 V_67 , T_2 V_27 ,
struct V_11 * V_12 )
{
struct V_21 * V_22 ;
T_2 V_23 , * V_24 ;
...
static inline int F_58 ( struct V_77 * V_78 )
{
return - V_76 ;
}
static int F_48 ( struct V_21 * V_30 )
...
static int F_59 ( struct V_21 * V_30 )
{
struct V_46 * V_50 ;
int V_62 ;
V_50 = F_31 ( V_30 ) ;
...
static int F_53 ( struct V_21 * V_30 )
{
unsigned long V_52 ;
int V_55 , V_62 ;
if ( V_30 -> V_28 & V_45 )
...
static int F_62 ( T_2 V_79 , struct V_11 * V_12 )
{
struct V_21 * V_22 ;
T_2 V_23 , * V_24 ;
int V_69 = 0 ;
...
static int F_64 ( T_2 V_27 , struct V_11 * V_12 )
{
struct V_21 * V_22 ;
T_2 V_23 , * V_24 ;
int V_25 , V_71 ;
...
static int F_65 ( T_2 V_79 , T_2 V_27 ,
struct V_11 * V_12 )
{
struct V_21 * V_22 ;
T_2 V_23 , * V_24 ;
...
if ( ( F_17 ( V_97 [ V_25 ] . V_28 ) & V_45 ) &&
( ! ( F_17 ( V_96 [ V_25 ] . V_28 ) & V_45 ) ) ) {
V_62 = F_36 (
F_18 ( V_97 [ V_25 ] . V_26 ) ,
V_3 ) ;
break;
} else if ( ( ! ( F_17 ( V_97 [ V_25 ] . V_28 ) &
V_45 ) ) &&
( F_17 ( V_96 [ V_25 ] . V_28 ) &
V_45 ) ) {
V_62 = F_68 ( F_18 ( V_97 [ V_25 ] . V_26 ) ,
V_3 ) ;
V_62 = ( V_62 < 0 ) ? - V_44 : 0 ;
break;
}
