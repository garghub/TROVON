...
static int F_11 ( enum V_17 V_18 , T_1 V_16 ,
struct V_12 * V_60 , unsigned int V_61 )
{
int V_62 ;
struct V_12 * V_63 = V_60 ;
if ( V_18 == V_51 ) {
V_62 = F_12 ( & V_63 , V_61 , & V_64 [ 0 ] , 0 , 0 ) ;
if ( V_62 < 0 )
return V_62 ;
V_62 = F_12 ( & V_63 , V_61 - ( V_63 - V_60 ) ,
& V_64 [ 1 ] ,
V_35 , ( 1 << 3 ) ) ;
if ( V_62 < 0 )
return V_62 ;
