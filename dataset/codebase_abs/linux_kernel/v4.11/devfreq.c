...
static int F_56 ( struct V_2 * V_3 , void * V_83 , void * V_69 )
{
struct V_1 * * V_84 = V_83 ;
if ( F_57 ( ! V_84 || ! * V_84 ) )
return 0 ;
return * V_84 == V_69 ;
}
static void F_58 ( struct V_2 * V_3 , void * V_83 )
{
F_55 ( * (struct V_1 * * ) V_83 ) ;
}
...
{
struct V_1 * * V_85 , * V_1 ;
V_85 = F_60 ( F_58 , sizeof( * V_85 ) , V_20 ) ;
if ( ! V_85 )
return F_4 ( - V_72 ) ;
...
struct V_1 * F_63 ( struct V_2 * V_3 , int V_86 )
{
struct V_87 * V_65 ;
struct V_1 * V_1 ;
if ( ! V_3 )
...
if ( ! V_3 -> V_88 )
return F_4 ( - V_6 ) ;
V_65 = F_64 ( V_3 -> V_88 , L_12 , V_86 ) ;
if ( ! V_65 )
return F_4 ( - V_9 ) ;
F_24 ( & V_7 ) ;
F_7 (devfreq, &devfreq_list, node) {
if ( V_1 -> V_3 . V_8
&& V_1 -> V_3 . V_8 -> V_88 == V_65 ) {
F_27 ( & V_7 ) ;
F_65 ( V_65 ) ;
return V_1 ;
}
...
if ( ! F_38 ( V_3 ) -> V_45 )
return - V_6 ;
return sprintf ( V_96 , L_20 , F_38 ( V_3 ) -> V_45 -> V_32 ) ;
}
static T_3 F_73 ( struct V_2 * V_3 , struct V_94 * V_95 ,
const char * V_96 , T_4 V_19 )
{
struct V_1 * V_97 = F_38 ( V_3 ) ;
int V_22 ;
char V_98 [ V_34 + 1 ] ;
struct V_31 * V_45 ;
V_22 = sscanf ( V_96 , L_21 F_74 ( V_34 ) L_22 , V_98 ) ;
if ( V_22 != 1 )
return - V_6 ;
F_24 ( & V_7 ) ;
V_45 = F_17 ( V_98 ) ;
...
V_22 = 0 ;
goto V_26;
} else if ( V_97 -> V_45 -> V_99 || V_45 -> V_99 ) {
V_22 = - V_6 ;
goto V_26;
}
if ( V_97 -> V_45 ) {
V_22 = V_97 -> V_45 -> V_66 ( V_97 , V_67 , NULL ) ;
if ( V_22 ) {
F_39 ( V_3 , L_23 ,
V_5 , V_97 -> V_45 -> V_32 , V_22 ) ;
goto V_26;
}
}
V_97 -> V_45 = V_45 ;
strncpy ( V_97 -> V_68 , V_45 -> V_32 , V_34 ) ;
V_22 = V_97 -> V_45 -> V_66 ( V_97 , V_82 , NULL ) ;
if ( V_22 )
F_39 ( V_3 , L_24 ,
V_5 , V_97 -> V_45 -> V_32 , V_22 ) ;
V_26:
...
static T_3 F_75 ( struct V_2 * V_100 ,
struct V_94 * V_95 ,
char * V_96 )
{
struct V_1 * V_97 = F_38 ( V_100 ) ;
T_3 V_19 = 0 ;
F_24 ( & V_7 ) ;
if ( V_97 -> V_45 -> V_99 ) {
V_19 = F_76 ( & V_96 [ V_19 ] , V_34 ,
L_25 , V_97 -> V_68 ) ;
} else {
struct V_31 * V_45 ;
...
if ( V_45 -> V_99 )
continue;
V_19 += F_76 ( & V_96 [ V_19 ] , ( V_101 - V_19 - 2 ) ,
L_25 , V_45 -> V_32 ) ;
}
}
F_27 ( & V_7 ) ;
if ( V_19 )
V_19 -- ;
V_19 += sprintf ( & V_96 [ V_19 ] , L_26 ) ;
return V_19 ;
}
static T_3 F_77 ( struct V_2 * V_3 , struct V_94 * V_95 ,
char * V_96 )
{
unsigned long V_10 ;
struct V_1 * V_1 = F_38 ( V_3 ) ;
if ( V_1 -> V_12 -> V_50 &&
! V_1 -> V_12 -> V_50 ( V_1 -> V_3 . V_8 , & V_10 ) )
return sprintf ( V_96 , L_27 , V_10 ) ;
return sprintf ( V_96 , L_27 , V_1 -> V_25 ) ;
}
static T_3 F_78 ( struct V_2 * V_3 ,
struct V_94 * V_95 , char * V_96 )
{
return sprintf ( V_96 , L_27 , F_38 ( V_3 ) -> V_25 ) ;
}
static T_3 F_79 ( struct V_2 * V_3 ,
struct V_94 * V_95 , char * V_96 )
{
return sprintf ( V_96 , L_28 , F_38 ( V_3 ) -> V_12 -> V_57 ) ;
}
...
if ( ! V_97 -> V_45 )
return - V_6 ;
V_22 = sscanf ( V_96 , L_29 , & V_102 ) ;
if ( V_22 != 1 )
return - V_6 ;
V_97 -> V_45 -> V_66 ( V_97 , V_103 , & V_102 ) ;
V_22 = V_19 ;
return V_22 ;
}
static T_3 F_81 ( struct V_2 * V_3 , struct V_94 * V_95 ,
const char * V_96 , T_4 V_19 )
{
struct V_1 * V_97 = F_38 ( V_3 ) ;
unsigned long V_102 ;
int V_22 ;
unsigned long V_104 ;
V_22 = sscanf ( V_96 , L_30 , & V_102 ) ;
if ( V_22 != 1 )
return - V_6 ;
F_24 ( & V_97 -> V_44 ) ;
V_104 = V_97 -> V_49 ;
if ( V_102 && V_104 && V_102 > V_104 ) {
V_22 = - V_6 ;
goto V_105;
}
V_97 -> V_47 = V_102 ;
...
static T_3 F_82 ( struct V_2 * V_3 , struct V_94 * V_95 ,
const char * V_96 , T_4 V_19 )
{
struct V_1 * V_97 = F_38 ( V_3 ) ;
unsigned long V_102 ;
...
static T_3 F_83 ( struct V_2 * V_100 ,
struct V_94 * V_95 ,
char * V_96 )
{
struct V_1 * V_97 = F_38 ( V_100 ) ;
struct V_2 * V_3 = V_97 -> V_3 . V_8 ;
struct V_16 * V_17 ;
T_3 V_19 = 0 ;
...
return 0 ;
if ( V_13 == 0 )
return sprintf ( V_96 , L_32 ) ;
V_107 = sprintf ( V_96 , L_33 ) ;
V_107 += sprintf ( V_96 + V_107 , L_34 ) ;
for ( V_18 = 0 ; V_18 < V_13 ; V_18 ++ )
V_107 += sprintf ( V_96 + V_107 , L_35 ,
V_1 -> V_12 -> V_14 [ V_18 ] ) ;
V_107 += sprintf ( V_96 + V_107 , L_36 ) ;
for ( V_18 = 0 ; V_18 < V_13 ; V_18 ++ ) {
if ( V_1 -> V_12 -> V_14 [ V_18 ]
== V_1 -> V_25 ) {
V_107 += sprintf ( V_96 + V_107 , L_37 ) ;
} else {
V_107 += sprintf ( V_96 + V_107 , L_38 ) ;
}
V_107 += sprintf ( V_96 + V_107 , L_39 ,
V_1 -> V_12 -> V_14 [ V_18 ] ) ;
for ( V_108 = 0 ; V_108 < V_13 ; V_108 ++ )
V_107 += sprintf ( V_96 + V_107 , L_40 ,
V_1 -> V_29 [ ( V_18 * V_13 ) + V_108 ] ) ;
V_107 += sprintf ( V_96 + V_107 , L_41 ,
F_85 ( V_1 -> V_27 [ V_18 ] ) ) ;
}
V_107 += sprintf ( V_96 + V_107 , L_42 ,
V_1 -> V_30 ) ;
return V_107 ;
}
static int T_5 F_86 ( void )
{
V_74 = F_87 ( V_109 , L_12 ) ;
if ( F_13 ( V_74 ) ) {
F_3 ( L_43 , __FILE__ ) ;
return F_53 ( V_74 ) ;
}
...
static void F_96 ( struct V_2 * V_3 , void * V_83 )
{
F_94 ( V_3 , * (struct V_1 * * ) V_83 ) ;
}
...
struct V_1 * * V_85 ;
int V_22 ;
V_85 = F_60 ( F_96 , sizeof( * V_85 ) , V_20 ) ;
if ( ! V_85 )
return - V_72 ;
V_22 = F_92 ( V_3 , V_1 ) ;
if ( V_22 ) {
...
static void F_103 ( struct V_2 * V_3 , void * V_83 )
{
struct V_115 * V_116 = V_83 ;
F_101 ( V_116 -> V_1 , V_116 -> V_63 , V_116 -> V_113 ) ;
}
...
struct V_115 * V_85 ;
int V_22 ;
V_85 = F_60 ( F_103 , sizeof( * V_85 ) ,
V_20 ) ;
if ( ! V_85 )
return - V_72 ;
V_22 = F_99 ( V_1 , V_63 , V_113 ) ;
if ( V_22 ) {
F_61 ( V_85 ) ;
return V_22 ;
}
