...
card_aux_list) {
if ( V_206 -> V_10 -> V_186 == V_144 ) {
V_14 = F_99 ( V_50 , V_206 ) ;
if ( V_14 < 0 ) {
F_78 ( V_50 -> V_23 ,
L_63 ,
V_206 -> V_53 , V_14 ) ;
...
int F_135 ( struct V_63 * V_50 , const char * V_217 )
{
...
V_14 = F_139 ( V_50 -> V_23 , V_235 , V_236 ,
...
static int F_149 ( struct V_247 * V_248 )
{
struct V_63 * V_50 = F_150 ( V_248 ) ;
if ( ! V_50 )
return - V_15 ;
F_26 ( & V_248 -> V_23 ,
L_73 ,
...
static int F_153 ( struct V_247 * V_248 )
{
struct V_63 * V_50 = F_150 ( V_248 ) ;
F_154 ( V_50 ) ;
return 0 ;
...
struct V_249 * F_157 ( const struct V_250 * V_251 ,
...
V_145 = F_160 ( V_50 , F_157 ( V_257 , V_252 ,
V_257 -> V_53 , V_253 ) ) ;
if ( V_145 < 0 ) {
F_78 ( V_23 , L_75 ,
V_257 -> V_53 , V_145 ) ;
...
struct V_249 * F_161 ( struct V_63 * V_258 ,
const char * V_53 )
{
...
int F_144 ( struct V_63 * V_258 ,
const struct V_250 * V_173 , int V_174 )
{
struct V_88 * V_50 = V_258 -> V_88 ;
return F_159 ( V_50 , V_258 -> V_23 , V_173 , V_174 ,
NULL , V_258 ) ;
}
...
int F_166 ( struct V_59 * V_60 , int V_260 ,
...
int F_167 ( struct V_4 * V_5 , int V_260 ,
...
int F_169 ( struct V_59 * V_60 , int V_266 , int V_192 ,
...
int F_170 ( struct V_4 * V_5 , int V_266 , int V_192 ,
unsigned int V_267 , unsigned int V_268 )
{
if ( V_5 -> V_10 -> V_269 )
...
int F_171 ( struct V_59 * V_60 , unsigned int V_270 )
{
...
static int F_172 ( unsigned int V_274 ,
unsigned int * V_275 ,
unsigned int * V_276 )
{
if ( * V_275 || * V_276 )
...
int F_175 ( struct V_59 * V_60 , int V_285 )
{
...
int F_176 ( struct V_59 * V_60 , int V_287 ,
int V_288 )
{
if ( ! V_60 -> V_10 )
return - V_210 ;
...
snprintf ( V_207 , V_294 , L_80 , V_23 -> V_10 -> V_53 , V_53 ) ;
F_179 ( V_53 , V_207 , V_294 ) ;
} else
* V_129 = 0 ;
}
...
return F_180 ( V_297 -> V_53 , V_40 ) ;
}
static void F_182 ( struct V_48 * V_49 )
{
struct V_59 * V_60 , * V_298 ;
...
return NULL ;
if ( V_299 &&
( V_297 -> V_129 == 0 || V_297 -> V_53 == NULL ) ) {
V_60 -> V_53 = F_178 ( V_23 , & V_60 -> V_129 ) ;
} else {
V_60 -> V_53 = F_181 ( V_23 , V_297 ) ;
if ( V_297 -> V_129 )
V_60 -> V_129 = V_297 -> V_129 ;
else
V_60 -> V_129 = V_49 -> V_300 ;
}
if ( V_60 -> V_53 == NULL ) {
F_16 ( V_60 ) ;
return NULL ;
...
V_60 -> V_10 = V_297 ;
if ( ! V_60 -> V_10 -> V_94 )
V_60 -> V_10 -> V_94 = & V_301 ;
F_106 ( & V_60 -> V_80 , & V_49 -> V_302 ) ;
V_49 -> V_300 ++ ;
F_49 ( V_23 , L_84 , V_60 -> V_53 ) ;
return V_60 ;
}
static int F_184 ( struct V_48 * V_49 ,
struct V_92 * V_297 , T_1 V_16 ,
bool V_299 )
{
struct V_22 * V_23 = V_49 -> V_23 ;
struct V_59 * V_60 ;
...
struct V_59 * V_60 ;
int V_14 ;
if ( V_297 -> V_151 . type != V_303 ) {
F_78 ( V_49 -> V_23 , L_86 ,
V_297 -> V_151 . type ) ;
return - V_15 ;
}
F_80 ( & V_58 ) ;
V_60 = F_183 ( V_49 , V_297 , false ) ;
if ( ! V_60 )
return - V_41 ;
V_14 = F_102 ( V_105 , V_60 ) ;
if ( V_14 != 0 ) {
...
enum V_304 type , int V_305 )
{
struct V_48 * V_49 = V_105 -> V_49 ;
V_49 -> V_10 -> V_306 ( V_49 , type , V_305 ) ;
}
static int F_187 ( struct V_106 * V_105 ,
int V_307 )
{
struct V_48 * V_49 = V_105 -> V_49 ;
return V_49 -> V_10 -> V_308 ( V_49 , V_307 ) ;
}
static int F_188 ( struct V_48 * V_49 ,
const struct V_309 * V_10 , struct V_22 * V_23 )
{
struct V_106 * V_105 ;
...
V_14 = F_188 ( V_317 , V_316 , V_23 ) ;
if ( V_14 )
goto V_318;
V_317 -> V_319 = true ;
V_317 -> V_320 = true ;
V_14 = F_184 ( V_317 , V_297 , V_300 , true ) ;
if ( V_14 < 0 ) {
F_78 ( V_23 , L_89 , V_14 ) ;
goto V_321;
}
...
static void F_206 ( struct V_323 * V_74 )
{
struct V_26 * V_27 = V_74 -> V_39 ;
struct V_61 * V_62 = V_27 -> V_62 ;
if ( V_62 -> V_10 -> V_310 )
V_62 -> V_10 -> V_310 ( V_74 ) ;
}
...
if ( V_325 -> V_310 )
V_62 -> V_49 . V_310 = F_206 ;
#ifdef F_123
V_62 -> V_49 . V_52 = L_90 ;
#endif
F_35 ( & V_58 ) ;
F_194 ( & V_62 -> V_49 ) ;
F_106 ( & V_62 -> V_80 , & V_327 ) ;
F_37 ( & V_58 ) ;
F_49 ( V_23 , L_91 ,
V_62 -> V_49 . V_53 ) ;
return 0 ;
...
static void F_212 ( struct V_328 * V_72 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < F_145 ( V_329 ) ; V_3 ++ )
if ( V_72 -> V_330 & V_329 [ V_3 ] )
V_72 -> V_330 |= V_329 [ V_3 ] ;
}
...
return V_5 -> V_10 -> V_333 ( V_5 , V_332 ) ;
}
...
if ( V_335 -> V_313 )
V_5 -> V_49 . V_313 = F_217 ;
if ( V_335 -> V_314 )
V_5 -> V_49 . V_314 = F_218 ;
V_5 -> V_49 . V_319 = V_335 -> V_319 ;
V_105 = F_222 ( V_5 ) ;
V_105 -> V_109 = V_335 -> V_109 ;
V_105 -> V_336 = V_335 -> V_336 ;
if ( V_335 -> V_306 )
V_105 -> V_306 = V_335 -> V_306 ;
if ( V_335 -> V_333 )
V_105 -> V_333 = F_219 ;
V_5 -> V_23 = V_23 ;
V_5 -> V_10 = V_335 ;
V_5 -> V_49 . V_312 = V_335 -> V_13 ;
#ifdef F_123
V_5 -> V_49 . V_55 = F_31 ;
V_5 -> V_49 . V_52 = L_95 ;
#endif
if ( V_335 -> V_337 )
V_5 -> V_49 . V_111 = V_335 -> V_337 ( V_23 ) ;
for ( V_3 = 0 ; V_3 < V_300 ; V_3 ++ ) {
F_212 ( & V_297 [ V_3 ] . V_338 ) ;
F_212 ( & V_297 [ V_3 ] . V_339 ) ;
}
V_14 = F_184 ( & V_5 -> V_49 , V_297 , V_300 , false ) ;
if ( V_14 < 0 ) {
F_78 ( V_23 , L_89 , V_14 ) ;
goto V_321;
}
...
V_342 = V_50 -> V_23 -> V_123 ;
V_14 = F_227 ( V_342 , V_341 , 0 , & V_50 -> V_53 ) ;
if ( V_14 < 0 && V_14 != - V_15 ) {
F_78 ( V_50 -> V_23 ,
L_99 ,
V_341 , V_14 ) ;
...
const char * V_341 )
{
struct V_122 * V_342 = V_50 -> V_23 -> V_123 ;
struct V_190 * V_344 ;
const char * V_254 , * V_345 ;
int V_3 , V_119 , V_346 , V_14 ;
V_346 = F_229 ( V_342 , V_341 ) ;
if ( V_346 < 0 ) {
F_78 ( V_50 -> V_23 ,
L_100 , V_341 ) ;
return - V_15 ;
...
V_344 = F_230 ( V_50 -> V_23 , V_346 , sizeof( * V_344 ) ,
V_40 ) ;
if ( ! V_344 ) {
F_78 ( V_50 -> V_23 ,
L_103 ) ;
...
for ( V_119 = 0 ; V_119 < F_145 ( V_347 ) ; V_119 ++ ) {
if ( ! strncmp ( V_254 , V_347 [ V_119 ] . V_53 ,
strlen ( V_347 [ V_119 ] . V_53 ) ) ) {
V_344 [ V_3 ] = V_347 [ V_119 ] ;
break;
}
}
if ( V_119 >= F_145 ( V_347 ) ) {
F_78 ( V_50 -> V_23 ,
L_105 ,
V_254 ) ;
return - V_15 ;
...
V_344 [ V_3 ] . V_53 = V_345 ;
}
V_50 -> V_237 = V_344 ;
V_50 -> V_238 = V_346 ;
return 0 ;
}
static int F_231 ( struct V_122 * V_342 ,
const char * V_348 ,
unsigned int * V_349 )
{
T_6 V_1 ;
const T_7 * V_350 = F_232 ( V_342 , V_348 , & V_1 ) ;
int V_3 ;
if ( ! V_350 )
return 0 ;
V_1 /= sizeof( T_6 ) ;
...
int V_14 ;
if ( V_275 )
F_231 ( V_342 , L_106 , V_275 ) ;
if ( V_276 )
F_231 ( V_342 , L_107 , V_276 ) ;
if ( F_235 ( V_342 , L_108 ) ) {
V_14 = F_236 ( V_342 , L_108 , & V_1 ) ;
if ( V_14 )
return V_14 ;
if ( V_274 )
* V_274 = V_1 ;
}
if ( F_235 ( V_342 , L_109 ) ) {
V_14 = F_236 ( V_342 , L_109 , & V_1 ) ;
if ( V_14 )
return V_14 ;
if ( V_277 )
* V_277 = V_1 ;
...
V_354 = F_94 ( V_50 -> V_23 , V_352 * sizeof( * V_354 ) ,
V_40 ) ;
if ( ! V_354 ) {
F_78 ( V_50 -> V_23 ,
L_111 ) ;
...
unsigned int F_240 ( struct V_122 * V_342 ,
const char * V_253 ,
struct V_122 * * V_355 ,
struct V_122 * * V_356 )
{
...
if ( ! V_253 )
V_253 = L_122 ;
snprintf ( V_357 , sizeof( V_357 ) , L_123 , V_253 ) ;
V_14 = F_238 ( V_342 , V_357 , & V_351 ) ;
if ( V_14 == 0 ) {
for ( V_3 = 0 ; V_3 < F_145 ( V_361 ) ; V_3 ++ ) {
if ( strcmp ( V_351 , V_361 [ V_3 ] . V_53 ) == 0 ) {
V_358 |= V_361 [ V_3 ] . V_1 ;
break;
}
}
}
snprintf ( V_357 , sizeof( V_357 ) , L_124 , V_253 ) ;
if ( F_235 ( V_342 , V_357 ) )
V_358 |= V_371 ;
else
V_358 |= V_372 ;
snprintf ( V_357 , sizeof( V_357 ) , L_125 , V_253 ) ;
V_359 = ! ! F_232 ( V_342 , V_357 , NULL ) ;
snprintf ( V_357 , sizeof( V_357 ) , L_126 , V_253 ) ;
V_360 = ! ! F_232 ( V_342 , V_357 , NULL ) ;
switch ( ( V_359 << 4 ) + V_360 ) {
case 0x11 :
V_358 |= V_373 ;
break;
case 0x10 :
...
snprintf ( V_357 , sizeof( V_357 ) , L_127 , V_253 ) ;
V_359 = ! ! F_232 ( V_342 , V_357 , NULL ) ;
if ( V_359 && V_355 )
* V_355 = F_241 ( V_342 , V_357 , 0 ) ;
snprintf ( V_357 , sizeof( V_357 ) , L_128 , V_253 ) ;
V_360 = ! ! F_232 ( V_342 , V_357 , NULL ) ;
if ( V_360 && V_356 )
* V_356 = F_241 ( V_342 , V_357 , 0 ) ;
switch ( ( V_359 << 4 ) + V_360 ) {
case 0x11 :
V_358 |= V_213 ;
break;
...
if ( V_129 < 0 || V_129 >= V_17 -> V_300 ) {
V_14 = - V_15 ;
continue;
}
V_14 = 0 ;
* V_128 = V_17 -> V_297 [ V_129 ] . V_53 ;
if ( ! * V_128 )
* V_128 = V_17 -> V_53 ;
}
break;
