...
long F_141 ( struct V_129 * V_137 , struct V_129 T_8 * V_130 ,
...
F_94 ( & V_122 . V_3 , F_144 ( * V_137 ) , V_138 ) ;
if ( F_130 ( & V_122 , V_40 ) )
goto V_135;
if ( V_40 == V_98 ) {
V_90 = - V_140 ;
...
int V_141 ;
for ( V_141 = 0 ; V_141 < V_95 ; V_141 ++ ) {
V_7 -> V_23 [ V_141 ] . V_7 = V_7 ;
F_146 ( & V_7 -> V_23 [ V_141 ] . V_43 ) ;
}
V_7 -> V_63 = V_63 ;
F_65 ( V_7 ) ;
return 0 ;
}
static void F_147 ( struct V_1 * V_142 ,
struct V_1 * V_9 )
{
struct V_2 * V_3 ;
struct V_46 * V_48 ;
while ( ( V_48 = F_51 ( & V_142 -> V_43 ) ) ) {
V_3 = F_52 ( V_48 , struct V_2 , V_48 ) ;
F_121 ( F_16 ( V_3 ) ) ;
F_47 ( V_3 ) ;
F_87 ( V_3 , V_142 , V_75 , 0 ) ;
V_3 -> V_5 = V_9 ;
F_85 ( V_3 , V_9 ) ;
}
}
int F_148 ( unsigned int V_143 )
{
struct V_14 * V_142 , * V_9 ;
int V_141 ;
F_121 ( F_149 ( V_143 ) ) ;
F_150 ( V_143 ) ;
F_151 () ;
V_142 = & F_11 ( V_17 , V_143 ) ;
V_9 = F_14 ( & V_17 ) ;
F_18 ( & V_9 -> V_8 ) ;
F_152 ( & V_142 -> V_8 , V_144 ) ;
for ( V_141 = 0 ; V_141 < V_95 ; V_141 ++ ) {
F_147 ( & V_142 -> V_23 [ V_141 ] ,
& V_9 -> V_23 [ V_141 ] ) ;
}
F_17 ( & V_142 -> V_8 ) ;
F_17 ( & V_9 -> V_8 ) ;
