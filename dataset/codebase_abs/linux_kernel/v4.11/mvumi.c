...
static int F_174 ( struct V_10 * V_20 , const struct V_432 * V_308 )
{
struct V_393 * V_129 ;
struct V_7 * V_8 ;
int V_124 ;
F_12 ( & V_20 -> V_11 , L_86 ,
V_20 -> V_433 , V_20 -> V_128 , V_20 -> V_434 ,
V_20 -> V_435 ) ;
V_124 = F_83 ( V_20 ) ;
if ( V_124 )
return V_124 ;
...
V_8 -> V_20 = V_20 ;
V_8 -> V_139 = V_129 ;
V_8 -> V_423 = V_20 -> V_439 -> V_440 << 8 | V_20 -> V_441 ;
V_124 = F_167 ( V_8 ) ;
if ( V_124 )
goto V_442;
V_124 = F_178 ( V_8 -> V_20 -> V_358 , F_149 , V_443 ,
L_88 , V_8 ) ;
if ( V_124 ) {
F_11 ( & V_20 -> V_11 , L_89 ) ;
goto V_444;
...
static int T_7 F_186 ( struct V_10 * V_20 , T_8 V_448 )
{
struct V_7 * V_8 = NULL ;
V_8 = F_183 ( V_20 ) ;
F_94 ( V_8 ) ;
