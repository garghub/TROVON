...
int V_59 ;
int V_23 ;
V_55 = F_22 ( V_60 , & V_12 -> V_18 ) ;
if ( ! V_55 )
return - V_38 ;
if ( F_17 ( V_12 -> V_18 . V_19 , L_14 , NULL ) )
return - V_61 ;
V_14 = F_23 ( sizeof( * V_14 ) , V_62 ) ;
if ( V_14 == NULL )
return - V_63 ;
V_59 = ( unsigned long ) V_55 -> V_64 ;
memset ( & V_57 , 0 , sizeof( V_57 ) ) ;
V_23 = F_3 ( V_12 , V_59 , & V_57 . V_10 , V_14 ) ;
if ( V_23 )
goto V_25;
if ( V_57 . V_10 . V_31 )
V_57 . V_65 = V_66 ;
...
& V_58 ) == 0 ) &&
( V_58 < V_57 . V_10 . V_31 ) )
V_57 . V_67 = V_57 . V_10 . V_31 - V_58 ;
if ( F_24 ( V_12 -> V_18 . V_19 , L_16 ) )
V_57 . V_65 |= V_68 ;
V_23 = F_25 ( & V_57 ) ;
if ( V_23 < 0 )
goto V_25;
...
static int F_32 ( struct V_69 * V_18 )
{
struct V_13 * V_14 = F_33 ( V_18 ) ;
struct V_56 * V_57 = F_34 ( V_14 -> line ) ;
struct V_1 * V_10 = & V_57 -> V_10 ;
F_35 ( V_14 -> line ) ;
if ( V_14 -> V_20 && ( ! F_36 ( V_10 ) || V_70 ) )
F_20 ( V_14 -> V_20 ) ;
return 0 ;
}
static int F_37 ( struct V_69 * V_18 )
{
struct V_13 * V_14 = F_33 ( V_18 ) ;
struct V_56 * V_57 = F_34 ( V_14 -> line ) ;
struct V_1 * V_10 = & V_57 -> V_10 ;
