...
return - V_60 ;
V_375 = F_116 ( V_475 -> V_477 , V_475 -> V_72 ) ;
if ( F_117 ( V_375 ) ) {
return F_118 ( V_375 ) ;
}
if ( V_475 -> V_72 < sizeof( struct V_476 ) +
V_375 -> V_478 * sizeof( struct V_479 ) ) {
V_89 = - V_60 ;
goto V_480;
}
...
static int F_119 ( struct V_2 * V_3 , T_2 * V_482 ,
T_5 V_38 )
{
...
if ( V_48 != 0 )
return - V_60 ;
V_500 = F_124 ( V_6 -> V_104 , V_112 , 0 , & V_54 ) ;
if ( V_500 == NULL ) {
if ( V_6 -> V_22 == V_79 ) {
V_48 = 0 ;
V_54 = & V_6 -> V_57 . V_54 [ V_48 ] ;
...
V_500 = F_124 ( V_6 -> V_104 , V_375 -> V_518 , 0 ,
& V_54 ) ;
if ( V_500 == NULL ) {
V_375 -> V_150 . V_54 . V_516 = V_521 ;
return - V_60 ;
...
int V_529 ;
V_529 = V_515 - V_530 ;
if ( V_529 < 0 || V_529 < V_375 -> V_150 . V_464 . V_38 )
return - V_60 ;
...
struct V_50 * V_110 , char * V_47 )
{
return F_119 ( V_3 , V_47 , V_110 -> V_72 ) ;
}
...
switch ( V_533 -> V_248 ) {
case V_536 :
return F_136 ( V_6 , V_533 -> V_112 . V_136 ,
V_537 ,
( T_2 * ) & V_534 , 2 ) ;
case V_538 :
return F_136 ( V_6 , V_533 -> V_112 . V_136 ,
...
static int F_139 ( T_1 * V_6 , struct V_50 * V_475 )
{
struct V_514 * V_375 ;
int V_89 = 0 ;
int V_542 = 0 ;
if ( V_475 -> V_72 < sizeof( struct V_514 ) ||
V_475 -> V_72 > V_543 || ! V_475 -> V_477 )
return - V_60 ;
V_375 = F_116 ( V_475 -> V_477 , V_475 -> V_72 ) ;
if ( F_117 ( V_375 ) ) {
return F_118 ( V_375 ) ;
...
break;
case V_547 :
V_89 = F_130 ( V_6 , V_375 , V_475 -> V_72 ) ;
break;
case V_548 :
V_89 = F_131 ( V_6 , V_375 , V_475 -> V_72 ) ;
break;
case V_549 :
...
break;
case V_550 :
V_89 = F_137 ( V_6 , V_375 ) ;
break;
case V_551 :
V_89 = F_138 ( V_6 , V_375 ) ;
break;
default:
V_89 = F_140 ( V_6 -> V_104 , V_375 ) ;
V_542 = 1 ;
break;
}
if ( V_89 == 1 || ! V_542 ) {
if ( F_141 ( V_475 -> V_477 , V_375 , V_475 -> V_72 ) ) {
V_89 = - V_552 ;
goto V_480;
} else if ( V_542 )
V_89 = 0 ;
...
V_5 = F_2 ( V_3 ) ;
V_6 = V_5 -> V_6 ;
F_143 ( V_45 -> V_554 , L_92 , sizeof( V_45 -> V_554 ) ) ;
snprintf ( V_45 -> V_555 , sizeof( V_45 -> V_555 ) ,
L_93 , ( V_6 -> V_212 >> 16 ) & 0xff ,
( V_6 -> V_212 >> 8 ) & 0xff ,
V_6 -> V_212 & 0xff ) ;
}
int F_144 ( struct V_2 * V_3 , struct V_556 * V_557 , int V_248 )
{
...
case V_564 :
if ( ! F_145 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_146 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 ) ;
break;
case V_565 :
if ( ! F_145 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_147 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 , 0 ) ;
break;
case V_566 :
if ( ! F_145 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_110 ( V_3 ,
...
case V_568 :
if ( ! F_145 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_149 ( & V_6 -> V_104 -> V_466 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
case V_569 :
if ( ! F_145 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_150 ( & V_6 -> V_104 -> V_466 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
case V_570 :
if ( ! F_145 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_151 ( V_6 -> V_104 , V_6 -> V_3 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
#endif
#ifdef F_152
...
case V_572 :
if ( ! F_145 ( V_560 ) ) V_89 = - V_561 ;
else V_89 = F_139 ( V_6 , & V_257 -> V_150 . V_110 ) ;
break;
default:
V_89 = - V_71 ;
break;
