...
static int F_80 ( struct V_22 * V_23 , unsigned V_16 ,
unsigned long V_97 )
{
T_1 V_181 ;
if ( F_22 ( V_97 ) != V_198 )
...
static int F_82 ( struct V_157 * V_158 , unsigned int V_207 )
{
struct V_2 * V_3 = F_63 ( V_158 ) ;
int V_51 = V_158 -> V_159 & 0x1f ;
int V_163 = V_158 -> V_159 >> 5 ;
if ( V_207 )
V_3 -> V_208 [ V_163 ] |= F_5 ( V_51 ) ;
else
V_3 -> V_208 [ V_163 ] &= ~ F_5 ( V_51 ) ;
return 0 ;
}
static void F_83 ( const struct V_167 * V_23 ,
void T_2 * V_165 , T_1 * V_209 )
{
int V_175 ;
void T_2 * V_163 ;
for ( V_175 = 0 ; V_175 < V_23 -> V_210 ; V_175 ++ ) {
V_163 = V_165 + ( V_175 << 2 ) ;
F_84 ( ~ V_209 [ V_175 ] , V_163 + V_23 -> V_178 ) ;
F_84 ( V_209 [ V_175 ] , V_163 + V_23 -> V_179 ) ;
}
}
static void F_85 ( const struct V_167 * V_23 ,
void T_2 * V_165 , T_1 * V_209 )
{
int V_175 ;
void T_2 * V_163 ;
...
V_209 [ V_175 ] = ~ F_86 ( V_163 ) ;
}
}
static int F_87 ( struct V_211 * V_211 )
{
void T_2 * V_163 ;
struct V_2 * V_3 = F_77 ( V_211 ) ;
const struct V_167 * V_168 =
& V_3 -> V_5 -> V_168 ;
V_163 = V_3 -> V_165 ;
F_85 ( V_168 , V_163 , V_3 -> V_212 ) ;
F_83 ( V_168 , V_163 , V_3 -> V_208 ) ;
return 0 ;
}
static int F_88 ( struct V_211 * V_211 )
{
struct V_2 * V_3 = F_77 ( V_211 ) ;
const struct V_167 * V_168 =
& V_3 -> V_5 -> V_168 ;
...
static void F_89 ( struct V_157 * V_158 )
{
struct V_2 * V_3 = F_63 ( V_158 ) ;
const struct V_167 * V_168 =
& V_3 -> V_5 -> V_168 ;
...
const struct V_167 * V_168 =
& V_3 -> V_5 -> V_168 ;
void T_2 * V_163 = V_3 -> V_165 + V_168 -> V_214 ;
unsigned int V_40 ;
...
static inline void
F_91 ( struct V_2 * V_3 , int V_215 )
{
unsigned int V_188 , V_216 ;
unsigned int V_19 , V_190 ;
const struct V_167 * V_168 =
& V_3 -> V_5 -> V_168 ;
V_216 = ( V_215 / 4 ) * 4 + V_168 -> V_217 ;
V_190 = F_70 ( V_3 -> V_165 + V_216 ) ;
V_19 = V_196 << ( ( V_215 % 4 ) * 8 ) ;
if ( ( V_19 & V_190 ) > 0 ) {
V_216 = ( V_215 / 4 ) * 4 + V_168 -> V_192 ;
V_188 = V_197 << ( ( V_215 % 4 ) * 8 ) ;
F_73 ( V_188 , V_3 -> V_165 + V_216 ) ;
}
}
static void F_92 ( struct V_218 * V_149 )
{
struct V_219 * V_23 = F_93 ( V_149 ) ;
struct V_2 * V_3 = F_94 ( V_149 ) ;
unsigned int V_220 , V_146 ;
int V_16 , V_215 , V_183 ;
const struct V_167 * V_168 =
& V_3 -> V_5 -> V_168 ;
void T_2 * V_163 = F_68 ( V_3 , 0 , V_168 -> V_221 ) ;
int V_222 , V_172 , V_173 ;
const struct V_107 * V_4 ;
F_95 ( V_23 , V_149 ) ;
for ( V_146 = 0 ;
V_146 < V_3 -> V_5 -> V_164 ;
...
V_16 = F_96 ( V_220 ) ;
V_215 = V_146 + V_16 ;
V_183 = F_61 ( V_3 -> V_156 , V_215 ) ;
V_220 &= ~ F_5 ( V_16 ) ;
V_222 = V_3 -> V_180 [ V_215 ] ;
if ( V_222 ) {
F_73 ( F_5 ( V_16 ) , V_163 - V_168 -> V_221 +
V_168 -> V_223 ) ;
V_4 = F_49 ( V_3 , V_215 ) ;
V_172 = F_59 ( V_3 -> V_23 ,
V_4 -> V_4 . V_113 ) ;
...
F_97 ( V_183 ) ;
if ( V_222 ) {
V_173 = F_72 ( V_3 , V_215 ) ;
if ( V_172 != V_173 )
F_73 ( F_5 ( V_16 ) , V_163 -
V_168 -> V_221 +
V_168 -> V_224 ) ;
}
if ( V_215 < V_3 -> V_5 -> V_171 )
F_91 ( V_3 , V_215 ) ;
}
}
F_98 ( V_23 , V_149 ) ;
...
{
struct V_2 * V_3 = F_100 ( V_226 ) ;
int V_40 ;
V_3 -> V_103 = V_3 -> V_5 -> V_54 ;
V_3 -> V_98 = F_101 ( & V_226 -> V_87 , V_3 -> V_103 ,
sizeof( * V_3 -> V_98 ) , V_227 ) ;
if ( ! V_3 -> V_98 )
return - V_228 ;
V_3 -> V_140 = F_101 ( & V_226 -> V_87 , V_3 -> V_103 ,
sizeof( * V_3 -> V_140 ) , V_227 ) ;
if ( ! V_3 -> V_140 )
return - V_228 ;
for ( V_40 = 0 ; V_40 < V_3 -> V_5 -> V_54 ; V_40 ++ ) {
const struct V_107 * V_4 = V_3 -> V_5 -> V_108 + V_40 ;
...
int F_102 ( struct V_225 * V_226 ,
const struct V_229 * V_120 ,
struct V_1 * V_1 )
{
struct V_230 * V_108 ;
struct V_2 * V_3 ;
struct V_124 * V_137 = V_226 -> V_87 . V_231 , * V_125 ;
struct V_126 * V_232 ;
struct V_233 * V_234 ;
int V_40 , V_85 , V_154 , V_235 ;
V_3 = F_103 ( & V_226 -> V_87 , sizeof( * V_3 ) , V_227 ) ;
if ( ! V_3 )
return - V_228 ;
F_104 ( V_226 , V_3 ) ;
V_232 = F_29 ( V_137 , L_12 , NULL ) ;
if ( ! V_232 ) {
F_18 ( & V_226 -> V_87 , L_13 ) ;
return - V_32 ;
}
V_125 = F_105 ( V_137 , L_14 , 0 ) ;
if ( V_125 ) {
V_3 -> V_9 = F_106 ( V_125 ) ;
if ( F_107 ( V_3 -> V_9 ) )
return F_108 ( V_3 -> V_9 ) ;
} else if ( V_1 ) {
V_3 -> V_9 = V_1 ;
} else {
F_18 ( & V_226 -> V_87 , L_15 ) ;
return - V_32 ;
}
V_125 = F_105 ( V_137 , L_14 , 1 ) ;
if ( V_125 ) {
V_3 -> V_8 = F_106 ( V_125 ) ;
if ( F_107 ( V_3 -> V_8 ) )
return F_108 ( V_3 -> V_8 ) ;
}
V_3 -> V_5 = V_120 ;
V_85 = F_99 ( V_226 ) ;
if ( V_85 ) {
F_18 ( & V_226 -> V_87 , L_16 , V_85 ) ;
return - V_32 ;
}
V_108 = F_101 ( & V_226 -> V_87 , V_3 -> V_5 -> V_54 , sizeof( * V_108 ) ,
V_227 ) ;
if ( ! V_108 )
return - V_228 ;
for ( V_40 = 0 ; V_40 < V_3 -> V_5 -> V_54 ; V_40 ++ )
V_108 [ V_40 ] = V_3 -> V_5 -> V_108 [ V_40 ] . V_4 ;
V_3 -> V_236 . V_111 = F_109 ( & V_226 -> V_87 ) ;
V_3 -> V_236 . V_237 = V_238 ;
V_3 -> V_236 . V_108 = V_108 ;
V_3 -> V_236 . V_54 = V_3 -> V_5 -> V_54 ;
V_3 -> V_236 . V_239 = & V_240 ;
V_3 -> V_236 . V_241 = & V_242 ;
V_3 -> V_236 . V_243 = & V_244 ;
V_3 -> V_87 = & V_226 -> V_87 ;
V_3 -> V_160 = F_110 ( & V_226 -> V_87 , & V_3 -> V_236 ,
V_3 ) ;
if ( F_107 ( V_3 -> V_160 ) ) {
F_18 ( & V_226 -> V_87 , L_17 ) ;
return F_108 ( V_3 -> V_160 ) ;
}
V_3 -> V_23 = F_103 ( & V_226 -> V_87 , sizeof( * V_3 -> V_23 ) , V_227 ) ;
if ( ! V_3 -> V_23 )
return - V_228 ;
* V_3 -> V_23 = V_245 ;
V_3 -> V_23 -> V_246 = V_3 -> V_5 -> V_54 ;
V_3 -> V_23 -> V_247 = F_109 ( & V_226 -> V_87 ) ;
V_3 -> V_23 -> V_182 = & V_226 -> V_87 ;
V_3 -> V_23 -> V_151 = - 1 ;
V_85 = F_111 ( V_3 -> V_23 , V_3 ) ;
if ( V_85 )
return - V_32 ;
V_85 = F_112 ( V_3 -> V_23 , F_109 ( & V_226 -> V_87 ) ,
0 , 0 , V_3 -> V_5 -> V_54 ) ;
if ( V_85 ) {
V_85 = - V_32 ;
goto V_248;
...
if ( ! F_113 ( V_137 , L_18 ) )
return 0 ;
V_234 = F_114 ( V_226 , V_249 , 0 ) ;
if ( ! V_234 ) {
F_18 ( & V_226 -> V_87 , L_19 ) ;
V_85 = - V_32 ;
goto V_248;
}
V_3 -> V_165 = F_115 ( & V_226 -> V_87 , V_234 ) ;
if ( F_107 ( V_3 -> V_165 ) ) {
V_85 = - V_32 ;
goto V_248;
}
V_235 = V_3 -> V_5 -> V_168 . V_210 ;
V_3 -> V_208 = F_101 ( & V_226 -> V_87 , V_235 ,
sizeof( * V_3 -> V_208 ) , V_227 ) ;
if ( ! V_3 -> V_208 ) {
V_85 = - V_228 ;
goto V_248;
}
V_3 -> V_212 = F_101 ( & V_226 -> V_87 , V_235 ,
sizeof( * V_3 -> V_212 ) , V_227 ) ;
if ( ! V_3 -> V_212 ) {
V_85 = - V_228 ;
goto V_248;
}
V_3 -> V_180 = F_101 ( & V_226 -> V_87 , V_3 -> V_5 -> V_164 ,
sizeof( int ) , V_227 ) ;
if ( ! V_3 -> V_180 ) {
V_85 = - V_228 ;
goto V_248;
...
V_154 = F_116 ( V_137 , 0 ) ;
if ( ! V_154 ) {
F_18 ( & V_226 -> V_87 , L_20 ) ;
V_85 = - V_32 ;
goto V_248;
}
V_3 -> V_156 = F_117 ( V_137 ,
V_3 -> V_5 -> V_164 , & V_250 , NULL ) ;
if ( ! V_3 -> V_156 ) {
F_18 ( & V_226 -> V_87 , L_21 ) ;
V_85 = - V_228 ;
goto V_248;
}
F_90 ( V_3 ) ;
for ( V_40 = 0 ; V_40 < V_3 -> V_5 -> V_164 ; V_40 ++ ) {
int V_183 = F_118 ( V_3 -> V_156 , V_40 ) ;
F_119 ( V_183 , & V_251 ,
V_252 ) ;
F_120 ( V_183 , V_3 ) ;
}
F_121 ( V_154 , F_92 , V_3 ) ;
return 0 ;
V_248:
F_122 ( V_3 -> V_23 ) ;
return V_85 ;
