...
V_42 -> V_46 = V_44 [ 0 ] & 0xff ;
V_42 -> V_47 = V_44 [ 1 ] & 0xfffffff ;
V_42 -> V_48 = V_44 [ 2 ] & 0xff ;
V_42 -> V_49 = ( V_44 [ 2 ] >> 8 ) & 0xff ;
...
static int F_20 ( void * V_50 )
{
struct V_1 * V_2 = (struct V_1 * ) V_50 ;
F_21 ( V_2 ) ;
return 0 ;
}
static int F_22 ( void * V_50 )
{
int V_51 ;
struct V_1 * V_2 = (struct V_1 * ) V_50 ;
V_51 = F_23 ( V_2 , 64 * 1024 , false ) ;
if ( V_51 )
return V_51 ;
return F_24 ( V_2 ) ;
}
static int F_25 ( void * V_50 )
{
struct V_1 * V_2 = (struct V_1 * ) V_50 ;
F_26 ( V_2 ) ;
F_27 ( V_2 ) ;
...
static int F_28 ( void * V_50 )
{
struct V_1 * V_2 = (struct V_1 * ) V_50 ;
return F_5 ( V_2 ) ;
}
static int F_29 ( void * V_50 )
{
struct V_1 * V_2 = (struct V_1 * ) V_50 ;
F_13 ( V_2 ) ;
return 0 ;
...
static int F_33 ( void * V_50 )
{
unsigned V_54 ;
struct V_1 * V_2 = (struct V_1 * ) V_50 ;
for ( V_54 = 0 ; V_54 < V_2 -> V_55 ; V_54 ++ ) {
if ( F_32 ( V_50 ) )
return 0 ;
F_34 ( 1 ) ;
}
