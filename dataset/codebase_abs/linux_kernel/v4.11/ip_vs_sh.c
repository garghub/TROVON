...
case V_47 :
case V_48 :
V_44 = F_27 ( V_40 , V_42 -> V_49 , sizeof( V_43 ) ,
& V_43 ) ;
if ( F_28 ( ! V_44 ) )
return 0 ;
if ( F_29 ( ! F_30 ( V_42 ) ) )
...
static struct V_1 *
F_31 ( struct V_16 * V_17 , const struct V_39 * V_40 ,
struct V_41 * V_42 )
{
struct V_1 * V_2 ;
struct V_18 * V_19 ;
T_1 V_9 = 0 ;
const union V_7 * V_50 ;
V_50 = F_30 ( V_42 ) ? & V_42 -> V_51 : & V_42 -> V_52 ;
F_22 ( 6 , L_8 ) ;
if ( V_17 -> V_4 & V_53 )
V_9 = F_26 ( V_40 , V_42 ) ;
V_19 = (struct V_18 * ) V_17 -> V_37 ;
if ( V_17 -> V_4 & V_54 )
V_2 = F_9 ( V_17 , V_19 , V_50 , V_9 ) ;
else
V_2 = F_7 ( V_17 , V_19 , V_50 , V_9 ) ;
if ( ! V_2 ) {
F_32 ( V_17 , L_9 ) ;
return NULL ;
}
