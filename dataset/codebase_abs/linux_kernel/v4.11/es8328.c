...
{
struct V_102 * V_102 = F_26 ( V_2 -> V_13 , NULL ) ;
struct V_3 * V_4 ;
int V_21 ;
V_4 = F_2 ( V_2 ) ;
V_21 = F_27 ( V_4 -> V_100 ) ;
...
int F_36 ( struct V_104 * V_13 , struct V_102 * V_102 )
{
struct V_3 * V_4 ;
int V_21 ;
int V_6 ;
if ( F_33 ( V_102 ) )
return F_34 ( V_102 ) ;
V_4 = F_37 ( V_13 , sizeof( * V_4 ) , V_105 ) ;
if ( V_4 == NULL )
return - V_106 ;
V_4 -> V_102 = V_102 ;
for ( V_6 = 0 ; V_6 < F_3 ( V_4 -> V_101 ) ; V_6 ++ )
V_4 -> V_101 [ V_6 ] . V_107 = V_108 [ V_6 ] ;
V_21 = F_38 ( V_13 , F_3 ( V_4 -> V_101 ) ,
V_4 -> V_101 ) ;
if ( V_21 ) {
F_13 ( V_13 , L_10 ) ;
return V_21 ;
