...
V_3 -> V_73 . V_74 =
F_24 ( ( int ) V_63 -> V_37 , 512 ) ;
V_3 -> V_73 . V_75 =
F_24 ( V_63 -> V_76 -> V_77 , F_25 ( V_66 ) ) ;
...
{
struct V_2 * V_3 = F_2 ( V_109 , struct V_2 , V_108 ) ;
struct V_1 * V_64 = F_1 ( V_3 ) ;
F_9 ( V_64 ) ;
}
...
static void F_43 ( struct V_110 * V_111 , struct V_112 * V_113 ,
unsigned char * V_114 )
{
struct V_1 * V_64 = F_1 ( V_111 -> V_115 ) ;
struct V_27 * V_63 = V_64 -> V_67 ;
int V_116 ;
struct V_117 * V_118 = V_111 -> V_119 ;
unsigned char * V_29 ;
if ( ! V_118 )
return;
V_29 = & V_118 -> V_120 [ 0 ] ;
...
if ( ! V_111 -> V_122 )
goto V_123;
if ( ( ( V_29 [ 0 ] == V_34 ) || ( V_29 [ 0 ] == V_124 ) ) &&
( F_44 ( V_116 ) << 1 ) == V_125 ) {
bool V_126 = F_45 ( V_111 ) ;
if ( V_126 ) {
unsigned char * V_31 ;
V_31 = F_46 ( V_111 ) ;
if ( ! V_31 )
...
V_127:
if ( V_114 && ( F_44 ( V_116 ) & V_132 ) ) {
memcpy ( V_114 , V_118 -> V_133 , V_134 ) ;
V_111 -> V_135 |= V_136 ;
}
}
...
V_141 = F_50 ( V_137 , V_9 ) ;
if ( ! V_141 )
return - V_10 ;
V_139 = V_141 ;
while ( ( V_140 = F_51 ( & V_141 , L_43 ) ) != NULL ) {
if ( ! * V_140 )
continue;
V_144 = F_52 ( V_140 , V_145 , args ) ;
switch ( V_144 ) {
case V_146 :
if ( V_8 -> V_12 == V_26 ) {
F_5 ( L_44
...
static T_3 F_54 ( struct V_2 * V_3 , char * V_150 )
{
struct V_7 * V_8 = V_3 -> V_4 -> V_14 ;
struct V_1 * V_64 = F_1 ( V_3 ) ;
struct V_27 * V_63 = V_64 -> V_67 ;
...
static void F_55 ( struct V_154 * V_154 )
{
F_56 ( V_154 ) ;
}
static inline struct V_154 * F_57 ( int V_155 )
{
struct V_154 * V_154 ;
V_154 = F_58 ( V_9 , V_155 ) ;
if ( ! V_154 ) {
F_5 ( L_64 ) ;
return NULL ;
}
...
static T_5
F_59 ( struct V_110 * V_111 , struct V_112 * V_157 , T_1 V_158 ,
struct V_159 * V_160 )
{
struct V_1 * V_64 = F_1 ( V_111 -> V_115 ) ;
...
struct V_137 * V_137 ;
struct V_112 * V_113 ;
T_1 V_161 = V_111 -> V_122 , V_152 , V_162 , V_163 , V_56 ;
int V_164 = ( V_111 -> V_122 + V_157 [ 0 ] . V_165 +
V_166 - 1 ) >> V_167 ;
int V_155 = 0 , V_168 ;
int V_169 = ( V_111 -> V_170 == V_171 ) ;
F_60 ( ! V_111 -> V_122 ) ;
F_6 ( L_65 , V_164 ) ;
...
goto V_173;
if ( V_162 > 0 && V_161 > 0 ) {
V_163 = F_63 (unsigned int, len, PAGE_SIZE - off) ;
V_163 = F_64 ( V_163 , V_161 ) ;
if ( ! V_154 ) {
V_155 = F_63 ( int , V_174 , V_164 ) ;
V_164 -= V_155 ;
V_154 = F_57 ( V_155 ) ;
if ( ! V_154 )
goto V_173;
...
F_6 ( L_67
L_68 , V_154 ,
( V_169 ) ? L_69 : L_70 , V_155 ) ;
}
F_6 ( L_71
L_72 , V_152 , V_154 ,
V_137 , V_162 , V_56 ) ;
V_168 = F_66 ( V_64 -> V_67 -> V_65 ,
V_154 , V_137 , V_163 , V_56 ) ;
F_6 ( L_73 ,
F_67 ( V_154 ) , V_155 ) ;
if ( V_168 != V_163 ) {
F_6 ( L_74
L_75
L_76 , V_154 -> V_176 , V_152 , V_154 ) ;
V_168 = F_68 ( V_160 , V_154 ) ;
if ( V_168 ) {
F_5 ( L_77 ) ;
goto V_173;
}
...
static T_5
F_69 ( struct V_110 * V_111 )
{
if ( V_111 -> V_135 & V_178 )
return V_179 ;
return F_70 ( V_111 , V_180 ) ;
}
static T_5
V_180 ( struct V_110 * V_111 )
{
struct V_112 * V_157 = V_111 -> V_181 ;
T_1 V_158 = V_111 -> V_182 ;
struct V_1 * V_64 = F_1 ( V_111 -> V_115 ) ;
struct V_117 * V_118 ;
struct V_159 * V_160 ;
T_5 V_32 ;
V_118 = F_4 ( sizeof( * V_118 ) + F_71 ( V_111 -> V_183 ) , V_9 ) ;
if ( ! V_118 ) {
return V_177 ;
}
V_111 -> V_119 = V_118 ;
memcpy ( V_118 -> V_120 , V_111 -> V_183 ,
F_71 ( V_111 -> V_183 ) ) ;
V_160 = F_72 ( V_64 -> V_67 -> V_65 ,
V_111 -> V_170 == V_171 ?
V_184 : V_185 ,
V_9 ) ;
if ( F_31 ( V_160 ) ) {
...
F_73 ( V_160 ) ;
if ( V_157 ) {
V_32 = F_59 ( V_111 , V_157 , V_158 , V_160 ) ;
if ( V_32 )
goto V_186;
}
V_160 -> V_187 = V_188 ;
V_160 -> V_189 = V_111 ;
F_74 ( V_160 ) -> V_190 = F_71 ( V_118 -> V_120 ) ;
F_74 ( V_160 ) -> V_111 = & V_118 -> V_120 [ 0 ] ;
if ( V_64 -> V_67 -> type == V_107 )
V_160 -> V_191 = V_192 ;
else
V_160 -> V_191 = V_193 ;
V_160 -> V_194 = V_195 ;
F_75 ( V_64 -> V_67 -> V_65 , NULL , V_160 ,
( V_111 -> V_196 == V_197 ) ,
V_188 ) ;
return 0 ;
V_186:
...
struct V_1 * V_64 = F_1 ( V_3 ) ;
struct V_27 * V_63 = V_64 -> V_67 ;
return ( V_63 ) ? V_63 -> type : V_198 ;
}
static T_6 F_78 ( struct V_2 * V_3 )
{
struct V_1 * V_64 = F_1 ( V_3 ) ;
if ( V_64 -> V_89 && V_64 -> V_89 -> V_199 )
return V_64 -> V_89 -> V_199 -> V_200 ;
return 0 ;
}
static void V_188 ( struct V_159 * V_160 , int V_201 )
{
struct V_110 * V_111 = V_160 -> V_189 ;
struct V_117 * V_118 = V_111 -> V_119 ;
V_118 -> V_121 = V_160 -> V_202 ;
V_118 -> V_203 = F_74 ( V_160 ) -> V_204 ;
V_111 -> V_205 = F_44 ( V_118 -> V_121 ) << 1 ;
if ( V_111 -> V_205 ) {
F_6 ( L_79
L_80 , V_111 , V_118 -> V_120 [ 0 ] ,
V_118 -> V_121 ) ;
}
switch ( F_79 ( V_118 -> V_121 ) ) {
case V_206 :
F_80 ( V_111 , V_111 -> V_205 ) ;
break;
default:
F_6 ( L_81
L_80 , V_111 , V_118 -> V_120 [ 0 ] ,
...
memcpy ( V_118 -> V_133 , F_74 ( V_160 ) -> V_208 , V_134 ) ;
F_81 ( V_160 -> V_66 , V_160 ) ;
F_9 ( V_118 ) ;
}
