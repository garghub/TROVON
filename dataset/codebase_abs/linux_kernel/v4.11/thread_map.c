...
struct V_4 * F_21 ( const char * V_50 )
{
struct V_4 * V_10 = NULL , * V_35 ;
int V_51 = 0 ;
T_2 V_16 , V_52 = V_39 ;
...
{
unsigned V_14 ;
V_10 -> V_7 = ( int ) V_59 -> V_7 ;
for ( V_14 = 0 ; V_14 < V_59 -> V_7 ; V_14 ++ ) {
F_7 ( V_10 , V_14 , ( T_2 ) V_59 -> V_60 [ V_14 ] . V_9 ) ;
V_10 -> V_5 [ V_14 ] . V_55 = F_43 ( V_59 -> V_60 [ V_14 ] . V_55 , 16 ) ;
}
F_8 ( & V_10 -> V_15 , 1 ) ;
}
struct V_4 * F_44 ( struct V_58 * V_59 )
{
struct V_4 * V_10 ;
V_10 = F_6 ( V_59 -> V_7 ) ;
if ( V_10 )
...
int F_46 ( struct V_4 * V_10 , int V_61 )
{
int V_14 ;
if ( V_10 -> V_7 < 1 )
return - V_62 ;
if ( V_61 >= V_10 -> V_7 )
return - V_62 ;
free ( V_10 -> V_5 [ V_61 ] . V_55 ) ;
for ( V_14 = V_61 ; V_14 < V_10 -> V_7 - 1 ; V_14 ++ )
