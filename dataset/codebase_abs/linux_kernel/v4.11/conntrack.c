...
return NULL ;
return F_52 ( V_114 , V_46 , & V_52 ) ;
}
static enum V_9
F_53 ( const struct V_133 * V_134 )
{
const struct V_22 * V_23 = F_54 ( V_134 ) ;
if ( F_55 ( V_134 ) == V_135 )
return V_13 ;
if ( F_39 ( V_136 , & V_23 -> V_69 ) )
return V_16 ;
...
static struct V_22 *
F_56 ( struct V_114 * V_114 , const struct V_45 * V_46 ,
T_2 V_138 , struct V_61 * V_62 , bool V_139 )
{
struct V_140 * V_141 ;
struct V_142 * V_143 ;
struct V_32 V_52 ;
...
T_2 V_37 ;
V_141 = F_57 ( V_138 ) ;
if ( V_141 -> V_145 ( V_62 , F_51 ( V_62 ) , & V_144 ,
& V_37 ) <= 0 ) {
F_37 ( L_3 ) ;
return NULL ;
}
V_143 = F_58 ( V_138 , V_37 ) ;
if ( ! F_59 ( V_62 , F_51 ( V_62 ) , V_144 , V_138 ,
V_37 , V_114 , & V_52 , V_141 , V_143 ) ) {
F_37 ( L_4 ) ;
return NULL ;
}
if ( V_139 ) {
struct V_32 V_146 ;
if ( ! F_60 ( & V_146 , & V_52 , V_141 , V_143 ) ) {
F_37 ( L_5 ) ;
return NULL ;
}
V_52 = V_146 ;
}
V_134 = F_61 ( V_114 , V_46 , & V_52 ) ;
if ( ! V_134 )
return NULL ;
V_23 = F_54 ( V_134 ) ;
if ( V_139 )
V_134 = & V_23 -> V_50 [ ! V_134 -> V_52 . V_36 . V_147 ] ;
F_62 ( V_62 , V_23 , F_53 ( V_134 ) ) ;
return V_23 ;
}
static bool F_63 ( struct V_114 * V_114 ,
...
V_23 = F_56 ( V_114 , & V_64 -> V_46 , V_64 -> V_148 , V_62 ,
! ! ( V_2 -> V_11
& V_68 ) ) ;
if ( V_23 )
F_14 ( V_62 , & V_10 ) ;
...
if ( ! V_23 )
return false ;
if ( ! F_64 ( V_114 , F_65 ( & V_23 -> V_149 ) ) )
return false ;
if ( ! F_66 ( V_64 -> V_23 , F_16 ( V_23 ) ) )
return false ;
if ( V_64 -> V_103 ) {
struct V_104 * V_105 ;
V_105 = F_67 ( V_23 , V_150 ) ;
if ( V_105 && F_68 ( V_105 -> V_103 ) != V_64 -> V_103 )
return false ;
}
if ( V_64 -> V_151 && F_69 ( V_10 ) != V_51 ) {
if ( F_15 ( V_23 ) )
F_70 ( V_23 , 0 , 0 ) ;
F_71 ( & V_23 -> V_152 ) ;
F_62 ( V_62 , NULL , 0 ) ;
...
struct V_61 * V_62 )
{
bool V_187 = F_63 ( V_114 , V_2 , V_64 , V_62 ) ;
enum V_9 V_10 ;
struct V_22 * V_23 ;
if ( ! V_187 ) {
...
F_71 ( F_91 ( V_62 ) ) ;
F_92 ( & V_188 -> V_152 ) ;
F_62 ( V_62 , V_188 , V_20 ) ;
}
V_100 = F_93 ( V_114 , V_64 -> V_148 ,
V_189 , V_62 ) ;
if ( V_100 != V_107 )
return - V_190 ;
V_2 -> V_11 = 0 ;
...
{
struct V_132 * exp ;
exp = F_49 ( V_114 , & V_64 -> V_46 , V_64 -> V_148 , V_62 ) ;
if ( exp ) {
T_2 V_44 ;
V_44 = V_12 | V_21 | V_19 ;
...
return 0 ;
if ( V_64 -> V_25 . V_89 ) {
V_100 = F_23 ( V_23 , V_2 , V_64 -> V_25 . V_193 ,
V_64 -> V_25 . V_89 ) ;
if ( V_100 )
return V_100 ;
}
if ( ! F_15 ( V_23 ) ) {
V_100 = F_27 ( V_23 , V_2 , & V_64 -> V_27 . V_193 ,
& V_64 -> V_27 . V_89 ) ;
if ( V_100 )
return V_100 ;
} else if ( F_28 ( & V_64 -> V_27 . V_89 ) ) {
V_100 = F_29 ( V_23 , V_2 , & V_64 -> V_27 . V_193 ,
& V_64 -> V_27 . V_89 ) ;
if ( V_100 )
return V_100 ;
}
...
F_81 ( V_62 , V_194 ) ;
F_82 ( V_62 , V_62 -> V_170 , V_194 ) ;
if ( V_100 )
F_47 ( V_62 ) ;
return V_100 ;
}
static int F_100 ( struct V_63 * V_64 , const char * V_195 ,
const struct V_1 * V_2 , bool log )
{
struct V_102 * V_103 ;
struct V_104 * V_105 ;
V_103 = F_101 ( V_195 , V_64 -> V_148 ,
V_2 -> V_56 . V_101 ) ;
if ( ! V_103 ) {
F_102 ( log , L_6 , V_195 ) ;
return - V_191 ;
}
V_105 = F_103 ( V_64 -> V_23 , V_103 , V_196 ) ;
if ( ! V_105 ) {
F_104 ( V_103 -> V_197 ) ;
return - V_198 ;
}
...
static int F_106 ( const struct V_199 * V_200 ,
...
bool V_203 = false ;
bool V_204 = false ;
bool V_205 = ( V_64 -> V_148 == V_7 ) ;
F_107 (a, attr, rem) {
static const int V_206 [ V_207 + 1 ] [ 2 ] = {
[ V_208 ] = { 0 , 0 } ,
[ V_209 ] = { 0 , 0 } ,
[ V_210 ] = { sizeof( struct V_211 ) ,
sizeof(struct V_212 ) } ,
[ V_213 ] = { sizeof( struct V_211 ) ,
sizeof(struct V_212 ) } ,
[ V_214 ] = { sizeof( T_1 ) , sizeof( T_1 ) } ,
[ V_215 ] = { sizeof( T_1 ) , sizeof( T_1 ) } ,
[ V_216 ] = { 0 , 0 } ,
[ V_217 ] = { 0 , 0 } ,
[ V_218 ] = { 0 , 0 } ,
} ;
int type = F_108 ( V_201 ) ;
if ( type > V_207 ) {
F_102 ( log ,
L_7 ,
type , V_207 ) ;
...
if ( F_109 ( V_201 ) != V_206 [ type ] [ V_205 ] ) {
F_102 ( log ,
L_8 ,
type , F_109 ( V_201 ) ,
V_206 [ type ] [ V_205 ] ) ;
...
V_64 -> V_180 |= V_181 ;
V_64 -> V_180 |= ( ( type == V_208 )
? V_185 : V_186 ) ;
break;
case V_210 :
F_110 ( & V_64 -> V_154 . V_220 , V_201 ,
sizeof( V_64 -> V_154 . V_220 ) ) ;
V_64 -> V_154 . V_168 |= V_169 ;
break;
case V_213 :
V_203 = true ;
F_110 ( & V_64 -> V_154 . V_221 , V_201 ,
sizeof( V_64 -> V_154 . V_221 ) ) ;
V_64 -> V_154 . V_168 |= V_169 ;
break;
case V_214 :
V_64 -> V_154 . V_222 . V_43 = F_9 ( F_111 ( V_201 ) ) ;
V_64 -> V_154 . V_168 |= V_223 ;
break;
case V_215 :
V_204 = true ;
V_64 -> V_154 . V_224 . V_43 = F_9 ( F_111 ( V_201 ) ) ;
V_64 -> V_154 . V_168 |= V_223 ;
break;
case V_216 :
V_64 -> V_154 . V_168 |= V_225 ;
break;
case V_217 :
V_64 -> V_154 . V_168 |= V_226 ;
break;
case V_218 :
...
if ( V_64 -> V_154 . V_168 & V_169 && ! V_203 ) {
memcpy ( & V_64 -> V_154 . V_221 , & V_64 -> V_154 . V_220 ,
sizeof( V_64 -> V_154 . V_221 ) ) ;
}
if ( V_64 -> V_154 . V_168 & V_223 &&
! V_204 ) {
V_64 -> V_154 . V_224 . V_43 = V_64 -> V_154 . V_222 . V_43 ;
}
return 0 ;
}
static int F_112 ( const struct V_199 * V_200 , struct V_63 * V_64 ,
...
F_107 (a, attr, rem) {
int type = F_108 ( V_201 ) ;
int V_228 = V_229 [ type ] . V_228 ;
int V_230 = V_229 [ type ] . V_230 ;
if ( type > V_231 ) {
F_102 ( log ,
L_14 ,
type , V_231 ) ;
...
if ( F_109 ( V_201 ) < V_230 || F_109 ( V_201 ) > V_228 ) {
F_102 ( log ,
L_15 ,
type , F_109 ( V_201 ) , V_228 ) ;
return - V_191 ;
}
switch ( type ) {
case V_232 :
...
#ifdef V_79
case V_234 :
V_64 -> V_46 . V_48 = F_111 ( V_201 ) ;
break;
#endif
#ifdef V_24
case V_235 : {
struct V_236 * V_25 = F_113 ( V_201 ) ;
if ( ! V_25 -> V_89 ) {
F_102 ( log , L_16 ) ;
return - V_191 ;
}
...
#ifdef F_114
case V_240 : {
int V_100 = F_106 ( V_201 , V_64 , log ) ;
if ( V_100 )
return V_100 ;
break;
}
...
#endif
if ( V_202 > 0 ) {
F_102 ( log , L_22 , V_202 ) ;
return - V_191 ;
}
return 0 ;
}
bool F_115 ( struct V_114 * V_114 , enum V_241 V_200 )
{
if ( V_200 == V_77 )
return true ;
if ( F_5 ( V_79 ) &&
...
if ( F_5 ( V_82 ) &&
V_200 == V_83 ) {
struct V_242 * V_242 = F_116 ( V_114 , V_243 ) ;
return V_242 -> V_244 ;
}
return false ;
}
int F_117 ( struct V_114 * V_114 , const struct V_199 * V_200 ,
const struct V_1 * V_2 ,
struct V_245 * * V_246 , bool log )
{
struct V_63 V_247 ;
...
V_247 . V_148 = V_148 ;
F_118 ( & V_247 . V_46 , V_248 ,
V_249 , 0 ) ;
V_100 = F_112 ( V_200 , & V_247 , & V_103 , log ) ;
if ( V_100 )
return V_100 ;
V_247 . V_23 = F_119 ( V_114 , & V_247 . V_46 , V_196 ) ;
if ( ! V_247 . V_23 ) {
F_102 ( log , L_24 ) ;
return - V_198 ;
}
F_120 ( V_250 , & V_247 . V_23 -> V_69 ) ;
F_92 ( & V_247 . V_23 -> V_152 ) ;
if ( V_103 ) {
V_100 = F_100 ( & V_247 , V_103 , V_2 , log ) ;
if ( V_100 )
goto V_251;
}
V_100 = F_121 ( V_246 , V_252 , & V_247 ,
sizeof( V_247 ) , log ) ;
if ( V_100 )
goto V_251;
return 0 ;
...
static bool F_123 ( const struct V_63 * V_64 ,
struct V_61 * V_62 )
{
struct V_199 * V_253 ;
V_253 = F_124 ( V_62 , V_240 ) ;
if ( ! V_253 )
return false ;
if ( V_64 -> V_180 & V_185 ) {
if ( F_125 ( V_62 , V_208 ) )
...
V_64 -> V_148 == V_5 ) {
if ( F_126 ( V_62 , V_210 ,
V_64 -> V_154 . V_220 . V_56 ) ||
( V_64 -> V_154 . V_221 . V_56
!= V_64 -> V_154 . V_220 . V_56 &&
( F_126 ( V_62 , V_213 ,
V_64 -> V_154 . V_221 . V_56 ) ) ) )
return false ;
...
V_64 -> V_148 == V_7 ) {
if ( F_127 ( V_62 , V_210 ,
& V_64 -> V_154 . V_220 . V_59 ) ||
( memcmp ( & V_64 -> V_154 . V_221 . V_59 ,
& V_64 -> V_154 . V_220 . V_59 ,
sizeof( V_64 -> V_154 . V_221 . V_59 ) ) &&
( F_127 ( V_62 , V_213 ,
& V_64 -> V_154 . V_221 . V_59 ) ) ) )
return false ;
} else {
return false ;
}
...
if ( V_64 -> V_154 . V_168 & V_223 &&
( F_20 ( V_62 , V_214 ,
F_2 ( V_64 -> V_154 . V_222 . V_43 ) ) ||
( V_64 -> V_154 . V_224 . V_43 != V_64 -> V_154 . V_222 . V_43 &&
F_20 ( V_62 , V_215 ,
F_2 ( V_64 -> V_154 . V_224 . V_43 ) ) ) ) )
return false ;
if ( V_64 -> V_154 . V_168 & V_225 &&
F_125 ( V_62 , V_216 ) )
return false ;
if ( V_64 -> V_154 . V_168 & V_226 &&
F_125 ( V_62 , V_217 ) )
return false ;
...
int F_129 ( const struct V_63 * V_247 ,
struct V_61 * V_62 )
{
struct V_199 * V_253 ;
V_253 = F_124 ( V_62 , V_252 ) ;
if ( ! V_253 )
return - V_78 ;
if ( V_247 -> V_183 && F_125 ( V_62 , V_247 -> V_151
? V_232
: V_233 ) )
return - V_78 ;
if ( F_5 ( V_79 ) &&
F_20 ( V_62 , V_234 , V_247 -> V_46 . V_48 ) )
return - V_78 ;
if ( F_5 ( V_24 ) && V_247 -> V_25 . V_89 &&
F_21 ( V_62 , V_235 , sizeof( V_247 -> V_25 ) ,
& V_247 -> V_25 ) )
return - V_78 ;
if ( F_5 ( V_82 ) &&
F_28 ( & V_247 -> V_27 . V_89 ) &&
F_21 ( V_62 , V_237 , sizeof( V_247 -> V_27 ) ,
& V_247 -> V_27 ) )
return - V_78 ;
if ( V_247 -> V_103 ) {
if ( F_130 ( V_62 , V_239 ,
...
#ifdef F_114
if ( V_247 -> V_180 && ! F_123 ( V_247 , V_62 ) )
return - V_78 ;
#endif
F_128 ( V_62 , V_253 ) ;
return 0 ;
}
void F_131 ( const struct V_199 * V_201 )
{
struct V_63 * V_247 = F_113 ( V_201 ) ;
F_122 ( V_247 ) ;
}
static void F_122 ( struct V_63 * V_247 )
{
if ( V_247 -> V_103 )
F_104 ( V_247 -> V_103 -> V_197 ) ;
if ( V_247 -> V_23 )
F_132 ( V_247 -> V_23 ) ;
}
void F_133 ( struct V_114 * V_114 )
{
unsigned int V_255 = sizeof( struct V_26 ) * V_256 ;
struct V_242 * V_242 = F_116 ( V_114 , V_243 ) ;
if ( F_134 ( V_114 , V_255 - 1 ) ) {
V_242 -> V_244 = false ;
F_102 ( true , L_25 ) ;
} else {
V_242 -> V_244 = true ;
