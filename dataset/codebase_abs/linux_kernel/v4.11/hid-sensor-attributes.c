...
T_3 V_41 )
{
return V_16 -> V_42 * V_41 ;
}
static
int F_19 ( struct V_43 * V_17 ,
T_1 V_33 ,
struct V_15 * V_16 )
{
F_20 ( V_17 ,
...
V_53 ,
& V_46 ) ;
if ( V_46 . V_20 >= 0 && V_46 . V_19 ) {
int V_28 , V_10 ;
F_16 ( V_53 ,
& V_46 , & V_28 , & V_10 ) ;
V_16 -> V_42 = V_28 ;
} else
V_16 -> V_42 = 1000000000 ;
F_22 ( V_17 -> V_54 , L_1 ,
V_16 -> V_18 . V_20 , V_16 -> V_18 . V_19 ,
V_16 -> V_48 . V_20 , V_16 -> V_48 . V_19 ,
V_16 -> V_50 . V_20 , V_16 -> V_50 . V_19 ,
V_16 -> V_26 . V_20 , V_16 -> V_26 . V_19 ,
V_46 . V_20 , V_46 . V_19 ) ;
V_3 = F_9 ( V_17 ,
V_16 -> V_50 . V_19 ,
V_16 -> V_50 . V_20 , sizeof( V_12 ) , & V_12 ) ;
if ( V_3 < 0 )
return V_3 ;
if ( V_12 < 0 )
return - V_21 ;
