...
if ( ! F_5 ( V_2 , V_12 ) )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( ! F_1 ( V_2 , sizeof( V_206 ) ) )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( V_207 ==
F_99 ( & V_12 -> V_44 . V_208 , & V_2 -> V_209 ) )
return F_86 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
...
if ( ! F_37 ( V_2 , V_12 ) )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( ! F_1 ( V_2 , sizeof( V_210 ) ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
F_104 (err, chunk->chunk_hdr) {
if ( V_211 == V_189 -> V_167 )
...
V_212 = F_106 ( * ( V_220 * ) ( ( V_221 * ) V_189 + sizeof( V_166 ) ) ) ;
V_212 = ( V_212 * 2 ) / 1000 ;
V_213 . V_57 . type = V_222 ;
V_213 . V_57 . V_6 = F_72 ( sizeof( V_213 ) ) ;
V_213 . V_223 = F_107 ( V_212 ) ;
V_215 = (struct V_214 * ) & V_12 -> V_44 . V_208 ;
V_112 = F_108 ( V_12 , V_215 , V_20 , sizeof( V_213 ) ) ;
if ( ! V_112 )
goto V_59;
F_32 ( V_112 , sizeof( V_213 ) , & V_213 ) ;
F_10 ( V_14 , V_224 , F_16 () ) ;
F_10 ( V_14 , V_193 , F_16 () ) ;
F_10 ( V_14 , V_225 , F_16 () ) ;
F_10 ( V_14 , V_226 , F_16 () ) ;
F_10 ( V_14 , V_227 ,
F_56 ( V_12 -> V_96 . V_228 ) ) ;
F_10 ( V_14 , V_229 , F_16 () ) ;
F_10 ( V_14 , V_22 ,
F_12 ( V_75 ) ) ;
F_10 ( V_14 , V_25 ,
F_13 ( V_178 ) ) ;
...
if ( V_37 >= sizeof( struct V_230 ) + sizeof( struct V_158 ) ) {
V_166 * V_189 ;
F_104 ( V_189 , V_2 -> V_5 ) ;
if ( ( void * ) V_189 != ( void * ) V_2 -> V_231 )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
error = ( ( V_166 * ) V_2 -> V_55 -> V_56 ) -> V_167 ;
}
F_10 ( V_14 , V_116 , F_58 ( V_232 ) ) ;
...
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_236 = ( T_14 * ) V_2 -> V_55 -> V_56 ;
F_25 ( V_2 -> V_55 , sizeof( T_14 ) ) ;
V_2 -> V_52 . V_239 = V_236 ;
V_237 = F_106 ( V_236 -> V_240 ) ;
if ( F_114 ( V_237 , V_12 -> V_241 ) ) {
F_69 ( L_6 , V_141 , V_237 ,
V_12 -> V_241 ) ;
return V_136 ;
}
if ( ! F_114 ( V_237 , V_12 -> V_242 ) )
...
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_248 = ( T_16 * ) V_2 -> V_55 -> V_56 ;
F_25 ( V_2 -> V_55 , sizeof( T_16 ) ) ;
V_249 = F_106 ( V_248 -> V_249 ) ;
if ( F_123 ( V_12 -> V_251 , V_249 ) ) {
F_10 ( V_14 ,
V_252 ,
F_124 ( V_249 ) ) ;
}
...
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_253 = ( T_17 * ) V_2 -> V_55 -> V_56 ;
F_25 ( V_2 -> V_55 , sizeof( T_17 ) ) ;
F_10 ( V_14 , V_254 ,
F_124 ( F_106 ( V_253 -> V_249 ) ) ) ;
return V_50 ;
}
...
( V_221 * ) V_2 -> V_52 . V_267 , sizeof( V_268 ) ) ;
default:
F_130 () ;
}
...
if ( V_2 -> V_271 )
F_10 ( V_14 , V_272 , V_255 ) ;
return V_50 ;
V_264:
if ( V_2 -> V_271 )
F_10 ( V_14 , V_272 , F_131 () ) ;
return V_136 ;
V_261:
if ( V_2 -> V_271 )
F_10 ( V_14 , V_272 , V_255 ) ;
...
if ( ! F_37 ( V_2 , V_12 ) )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( ! F_1 ( V_2 , sizeof( V_275 ) ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_274 = F_134 ( V_2 ) ;
if ( ! V_274 )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
V_2 -> V_52 . V_276 = V_274 ;
V_237 = F_106 ( V_274 -> V_240 ) ;
if ( F_114 ( V_237 , V_12 -> V_241 ) ) {
F_69 ( L_6 , V_141 , V_237 ,
V_12 -> V_241 ) ;
return V_136 ;
...
V_281 = ( V_18 * ) V_2 -> V_5 ;
do {
if ( F_2 ( V_281 -> V_6 ) < sizeof( V_18 ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_282 = ( ( V_47 * ) V_281 ) + F_143 ( F_2 ( V_281 -> V_6 ) ) ;
if ( V_282 > F_144 ( V_55 ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
if ( V_285 == V_281 -> type )
...
if ( F_138 ( V_288 ) )
V_35 -> V_42 = F_106 ( V_2 -> V_41 -> V_42 ) ;
V_288 -> V_55 -> V_45 = V_10 -> V_44 . V_45 ;
F_139 ( V_35 , V_288 ) ;
F_10 ( V_14 , V_48 ,
F_24 ( V_35 ) ) ;
F_14 ( V_8 , V_49 ) ;
...
if ( ! V_2 -> V_297 )
F_149 ( V_12 ) ;
V_289 = F_150 ( (struct V_11 * )
V_12 , V_2 ) ;
if ( ! V_289 )
return V_51 ;
} else if ( V_293 < V_12 -> V_96 . V_296 + 1 ) {
V_289 = F_151 ( V_12 , V_292 -> V_293 ) ;
if ( ! V_289 )
return V_136 ;
V_289 -> V_70 = NULL ;
} else {
...
V_289 -> V_209 = V_2 -> V_298 ;
F_10 ( V_14 , V_62 , F_34 ( V_289 ) ) ;
if ( V_12 -> V_299 ) {
...
if ( ! V_8 -> V_38 . V_294 && ! V_289 -> V_93 )
return F_86 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( ! F_1 ( V_289 , sizeof( V_295 ) ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_302 = ( T_20 * ) V_289 -> V_55 -> V_56 ;
V_304 = F_106 ( V_302 -> V_293 ) ;
if ( ! F_148 ( V_12 , V_289 , false , & V_291 ) )
return F_63 ( V_8 , V_10 , V_12 , type , V_13 ,
( void * ) V_291 , V_14 ) ;
if ( V_300 ) {
V_302 = ( T_20 * ) V_300 -> V_52 . V_302 ;
...
if ( ! V_12 -> V_96 . V_320 )
return F_162 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( ! F_1 ( V_2 , sizeof( struct V_321 ) ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_316 = (struct V_315 * ) V_2 -> V_55 -> V_56 ;
V_2 -> V_52 . V_316 = V_316 ;
V_37 = F_2 ( V_2 -> V_5 -> V_6 ) ;
V_37 -= sizeof( struct V_230 ) ;
F_25 ( V_2 -> V_55 , V_37 ) ;
V_319 = F_106 ( V_316 -> V_322 ) ;
F_69 ( L_7 , V_141 , V_319 ) ;
if ( F_163 ( & V_12 -> V_96 . V_323 , V_319 ) < 0 )
goto V_261;
F_164 (skip, chunk) {
if ( F_2 ( V_318 -> V_324 ) >= V_12 -> V_324 -> V_325 )
goto V_261;
}
F_10 ( V_14 , V_326 , F_124 ( V_319 ) ) ;
if ( V_37 > sizeof( struct V_315 ) )
F_10 ( V_14 , V_327 ,
F_34 ( V_2 ) ) ;
if ( V_12 -> V_108 [ V_109 ] ) {
F_10 ( V_14 , V_247 ,
...
V_47 * V_335 ;
V_47 * V_336 ;
V_330 = (struct V_329 * ) V_2 -> V_55 -> V_56 ;
V_2 -> V_52 . V_330 = V_330 ;
F_25 ( V_2 -> V_55 , sizeof( struct V_329 ) ) ;
if ( ! F_166 ( V_12 , V_330 -> V_337 ) )
return V_338 ;
V_334 = F_2 ( V_330 -> V_339 ) ;
if ( V_334 != V_12 -> V_340 && ! F_167 ( V_12 , V_334 ) )
return V_341 ;
V_333 = F_2 ( V_2 -> V_5 -> V_6 ) - sizeof( V_342 ) ;
V_332 = F_168 ( F_2 ( V_330 -> V_337 ) ) ;
if ( V_333 != V_332 -> V_343 )
return V_266 ;
V_336 = V_330 -> V_332 ;
F_25 ( V_2 -> V_55 , V_333 ) ;
V_335 = F_169 ( V_336 , V_333 , V_20 ) ;
if ( ! V_335 )
goto V_59;
memset ( V_336 , 0 , V_333 ) ;
F_170 ( V_12 , V_2 -> V_55 ,
(struct V_344 * ) V_2 -> V_5 ,
V_20 ) ;
if ( memcmp ( V_335 , V_336 , V_333 ) ) {
F_171 ( V_335 ) ;
return V_89 ;
}
F_171 ( V_335 ) ;
...
if ( ! F_1 ( V_2 , sizeof( struct V_344 ) ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
V_330 = (struct V_329 * ) V_2 -> V_55 -> V_56 ;
...
if ( V_12 -> V_340 != F_2 ( V_330 -> V_339 ) ) {
struct V_15 * V_16 ;
V_16 = F_173 ( V_12 , F_2 ( V_330 -> V_339 ) ,
V_346 , V_20 ) ;
if ( ! V_16 )
return - V_347 ;
F_10 ( V_14 , V_21 ,
...
T_4 * V_14 )
{
struct V_1 * V_348 = V_13 ;
struct V_1 * V_33 ;
V_18 * V_292 ;
F_69 ( L_8 , V_141 , type . V_2 ) ;
if ( ! F_37 ( V_348 , V_12 ) )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( ! F_1 ( V_348 , sizeof( V_18 ) ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
switch ( type . V_2 & V_349 ) {
case V_350 :
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
case V_351 :
V_292 = V_348 -> V_5 ;
V_33 = F_90 ( V_12 , V_348 ,
V_352 , V_292 ,
F_143 ( F_2 ( V_292 -> V_6 ) ) ,
0 ) ;
if ( V_33 ) {
...
if ( F_38 ( V_67 , V_12 ) )
goto V_358;
abort = F_175 ( V_12 , V_2 , V_357 , V_127 ) ;
if ( ! abort )
goto V_59;
if ( V_12 ) {
if ( V_2 -> V_5 -> type == V_359 &&
! V_12 -> V_96 . V_360 . V_361 ) {
V_64 * V_362 ;
V_362 = ( V_64 * ) V_2 -> V_5 ;
if ( ! F_1 ( V_2 ,
sizeof( V_64 ) ) )
abort -> V_5 -> V_269 |= V_363 ;
else {
unsigned int V_364 ;
V_364 = F_106 ( V_362 -> V_53 . V_361 ) ;
F_10 ( V_14 , V_365 ,
F_124 ( V_364 ) ) ;
}
}
...
T_4 * V_14 )
{
static const char V_368 [] = L_10 ;
return F_129 ( V_8 , V_10 , V_12 , V_13 , V_14 , V_368 ,
sizeof( V_368 ) ) ;
}
static T_2 F_63 (
struct V_8 * V_8 ,
...
const struct V_11 * V_12 ,
const T_3 type ,
void * V_13 , void * V_369 ,
T_4 * V_14 )
{
struct V_1 * V_2 = V_13 ;
struct V_290 * V_311 = V_369 ;
struct V_1 * abort = NULL ;
if ( F_38 ( V_67 , V_12 ) )
goto V_358;
abort = F_176 ( V_12 , V_2 , V_311 ) ;
if ( ! abort )
goto V_59;
F_10 ( V_14 , V_62 , F_34 ( abort ) ) ;
F_14 ( V_8 , V_49 ) ;
...
T_4 * V_14 )
{
static const char V_368 [] = L_12 ;
if ( ! V_12 )
return F_174 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
return F_129 ( V_8 , V_10 , V_12 , V_13 , V_14 , V_368 ,
sizeof( V_368 ) ) ;
}
T_2 F_177 ( struct V_8 * V_8 ,
const struct V_9 * V_10 ,
const struct V_11 * V_12 ,
const T_3 type ,
void * V_13 ,
...
F_10 ( V_14 , V_25 ,
F_13 ( V_178 ) ) ;
V_31 = F_108 ( V_12 , & V_12 -> V_44 . V_208 , V_20 , 0 ) ;
if ( ! V_31 )
goto V_59;
F_10 ( V_14 , V_371 ,
F_34 ( V_31 ) ) ;
V_370 = (struct V_11 * ) V_12 ;
F_10 ( V_14 , V_61 , F_33 ( V_370 ) ) ;
F_10 ( V_14 , V_74 ,
F_12 ( V_73 ) ) ;
F_10 ( V_14 , V_62 , F_34 ( V_31 ) ) ;
return V_50 ;
...
T_4 * V_14 )
{
struct V_372 * V_373 = V_13 ;
F_10 ( V_14 , V_374 , F_179 ( V_373 ) ) ;
return V_50 ;
}
T_2 F_180 (
struct V_8 * V_8 ,
...
T_4 * V_14 )
{
F_10 ( V_14 , V_377 , F_58 ( - V_378 ) ) ;
return V_50 ;
}
T_2 F_183 ( struct V_8 * V_8 ,
const struct V_9 * V_10 ,
const struct V_11 * V_12 ,
const T_3 type ,
void * V_13 ,
...
void * V_13 , T_4 * V_14 )
{
return F_184 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
}
T_2 F_186 (
struct V_8 * V_8 ,
const struct V_9 * V_10 ,
...
T_4 * V_14 )
{
return F_186 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
}
T_2 F_188 (
struct V_8 * V_8 ,
const struct V_9 * V_10 ,
...
F_10 ( V_14 , V_22 ,
F_12 ( V_24 ) ) ;
return F_181 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
}
T_2 F_189 (
struct V_8 * V_8 ,
const struct V_9 * V_10 ,
...
T_4 * V_14 )
{
return F_189 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
}
T_2 F_191 (
struct V_8 * V_8 ,
const struct V_9 * V_10 ,
...
{
struct V_15 * V_382 ;
V_382 = F_196 ( V_12 , V_20 ) ;
if ( ! V_382 )
return V_51 ;
F_10 ( V_14 , V_21 , F_11 ( V_382 ) ) ;
return V_50 ;
}
T_2 F_92 (
struct V_8 * V_8 ,
...
if ( ! F_37 ( V_2 , V_12 ) )
return F_6 ( V_8 , V_10 , V_12 , type , V_13 , V_14 ) ;
if ( ! F_1 ( V_2 , sizeof( struct V_238 ) ) )
return F_8 ( V_8 , V_10 , V_12 , type , V_13 ,
V_14 ) ;
}
V_112 = F_121 ( V_12 , V_2 ) ;
...
F_10 ( V_14 , V_126 , F_56 ( V_70 ) ) ;
F_10 ( V_14 , V_389 , F_56 ( V_70 ) ) ;
return V_50 ;
}
T_2 F_200 ( struct V_8 * V_8 ,
const struct V_9 * V_10 ,
const struct V_11 * V_12 ,
const T_3 type ,
void * V_13 ,
...
static struct V_403 * F_134 ( struct V_1 * V_2 )
{
struct V_403 * V_404 ;
unsigned int V_37 ;
T_1 V_405 ;
T_1 V_406 ;
V_404 = (struct V_403 * ) V_2 -> V_55 -> V_56 ;
V_405 = F_2 ( V_404 -> V_407 ) ;
V_406 = F_2 ( V_404 -> V_406 ) ;
V_37 = sizeof( struct V_403 ) ;
V_37 += ( V_405 + V_406 ) * sizeof( T_15 ) ;
...
T_1 V_409 ;
T_15 V_42 ;
V_408 = F_2 ( V_2 -> V_41 -> V_209 ) ;
V_409 = F_2 ( V_2 -> V_41 -> V_298 ) ;
if ( V_12 ) {
switch ( V_2 -> V_5 -> type ) {
case V_359 :
{
V_64 * V_362 ;
V_362 = ( V_64 * ) V_2 -> V_5 ;
V_42 = F_106 ( V_362 -> V_53 . V_361 ) ;
break;
}
default:
V_42 = V_12 -> V_96 . V_360 . V_361 ;
break;
}
} else {
switch ( V_2 -> V_5 -> type ) {
...
V_70 = F_211 ( V_8 , F_29 ( V_2 ) , V_20 ) ;
if ( ! V_70 )
goto V_59;
F_212 ( V_70 , (union V_131 * ) & V_2 -> V_209 ,
F_18 ( V_8 -> V_38 . V_39 ) ) ;
V_35 = & V_70 -> V_35 ;
F_213 ( V_35 , V_70 , V_408 , V_409 ) ;
F_214 ( V_35 , V_42 , 0 ) ;
return V_35 ;
V_59:
return NULL ;
...
int V_414 ;
T_15 V_319 ;
struct V_415 * V_416 = (struct V_415 * ) & V_12 -> V_96 . V_323 ;
struct V_82 * V_45 = V_12 -> V_44 . V_45 ;
struct V_8 * V_8 = F_77 ( V_45 ) ;
T_22 V_417 ;
T_22 V_418 ;
V_221 V_419 = 0 ;
V_267 = V_2 -> V_52 . V_267 = ( V_268 * ) V_2 -> V_55 -> V_56 ;
F_25 ( V_2 -> V_55 , sizeof( V_268 ) ) ;
V_319 = F_106 ( V_267 -> V_319 ) ;
F_69 ( L_7 , V_141 , V_319 ) ;
if ( V_12 -> V_96 . V_420 && ! V_2 -> V_421 ) {
struct V_161 * V_162 = F_216 ( V_2 -> V_55 ) -> V_162 ;
V_2 -> V_421 = 1 ;
if ( V_162 -> V_422 ( F_217 ( V_2 -> V_55 ) ) ) {
F_10 ( V_14 , V_423 ,
F_124 ( V_319 ) ) ;
}
}
V_414 = F_163 ( & V_12 -> V_96 . V_323 , V_319 ) ;
if ( V_414 < 0 ) {
if ( V_2 -> V_12 )
V_2 -> V_12 -> V_424 . V_425 ++ ;
return V_258 ;
} else if ( V_414 > 0 ) {
F_10 ( V_14 , V_426 , F_124 ( V_319 ) ) ;
return V_262 ;
}
V_412 = F_2 ( V_2 -> V_5 -> V_6 ) ;
V_412 -= sizeof( V_257 ) ;
V_413 = V_427 ;
if ( ( V_412 >= V_12 -> V_183 ) && ( ! V_12 -> V_428 . V_429 ) ) {
F_10 ( V_14 , V_430 , F_16 () ) ;
}
if ( ( ! V_2 -> V_431 ) && ( ! V_12 -> V_183 || V_12 -> V_432 ||
( V_412 > V_12 -> V_183 + V_12 -> V_433 ) ) ) {
if ( F_218 ( V_416 ) &&
( F_219 ( V_416 ) + 1 ) == V_319 ) {
F_69 ( L_22 , V_141 , V_319 ) ;
V_413 = V_434 ;
} else {
F_69 ( L_23 ,
V_141 , V_319 , V_412 , V_12 -> V_183 ) ;
return V_263 ;
}
}
if ( * V_45 -> V_435 -> V_436 ) {
...
V_2 -> V_431 = 1 ;
if ( V_2 -> V_5 -> V_269 & V_438 ) {
F_14 ( V_8 , V_439 ) ;
if ( V_2 -> V_12 )
V_2 -> V_12 -> V_424 . V_440 ++ ;
} else {
F_14 ( V_8 , V_441 ) ;
if ( V_2 -> V_12 )
V_2 -> V_12 -> V_424 . V_442 ++ ;
V_419 = 1 ;
}
V_418 = F_2 ( V_267 -> V_324 ) ;
if ( V_418 >= V_12 -> V_324 -> V_325 ) {
F_10 ( V_14 , V_443 , F_124 ( V_319 ) ) ;
V_189 = F_90 ( V_12 , V_2 , V_444 ,
& V_267 -> V_324 ,
sizeof( V_267 -> V_324 ) ,
sizeof( T_22 ) ) ;
if ( V_189 )
...
V_417 = F_2 ( V_267 -> V_417 ) ;
if ( V_419 && F_221 ( V_417 , F_222 ( V_12 -> V_324 , V_445 , V_418 ) ) )
return V_266 ;
F_10 ( V_14 , V_413 , F_34 ( V_2 ) ) ;
return V_98 ;
}
