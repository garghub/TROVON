...
static int F_84 ( char * V_131 , const struct V_128 * V_129 )
{
if ( ! F_85 ( NULL ) )
return - V_130 ;
if ( ! V_126 )
return - V_107 ;
return F_86 ( V_131 , V_129 ) ;
}
...
static int F_88 ( char * V_131 , const struct V_128 * V_129 )
{
if ( ! F_85 ( NULL ) )
return - V_130 ;
if ( ! V_126 )
...
static int F_91 ( char * V_131 , const struct V_128 * V_129 )
{
if ( ! F_85 ( NULL ) )
return - V_130 ;
if ( ! V_126 )
return - V_107 ;
return F_92 ( V_131 , V_129 ) ;
}
static int F_93 ( char * V_131 , struct V_128 * V_129 )
{
if ( ! F_85 ( NULL ) )
return - V_130 ;
if ( ! V_126 )
return - V_107 ;
return sprintf ( V_131 , L_9 , V_132 [ V_133 ] ) ;
}
...
static int F_95 ( char * V_131 , struct V_128 * V_129 )
{
if ( ! F_85 ( NULL ) )
return - V_130 ;
if ( ! V_126 )
return - V_107 ;
return sprintf ( V_131 , L_9 , V_136 [ V_137 ] ) ;
}
...
if ( ! V_127 )
return - V_107 ;
for ( V_134 = 0 ; V_134 < V_138 ; V_134 ++ ) {
if ( strcmp ( V_127 , V_136 [ V_134 ] ) == 0 ) {
V_137 = V_134 ;
return 0 ;
}
}
...
{
struct V_1 * V_1 = (struct V_1 * ) V_13 -> V_139 ;
struct V_3 * V_4 ;
V_4 = F_5 ( V_79 ) ;
if ( ! V_4 )
return - V_5 ;
V_4 -> V_21 = F_98 ( V_140 -> F_16 ) ;
F_3 ( V_1 ) = V_4 ;
return 0 ;
}
...
F_100 (i) {
F_101 (j) {
F_74 ( F_102 ( V_142 , V_134 ) . V_143 [ V_141 ] ) ;
F_102 ( V_142 , V_134 ) . V_143 [ V_141 ] = NULL ;
}
}
}
...
F_101 (j) {
char * V_131 ;
if ( F_104 ( V_134 ) > F_105 () )
V_131 = F_68 ( V_144 , V_79 ) ;
else
V_131 = F_106 ( V_144 , V_79 ,
F_104 ( V_134 ) ) ;
if ( ! V_131 ) {
F_99 () ;
return - V_5 ;
}
F_102 ( V_142 , V_134 ) . V_143 [ V_141 ] = V_131 ;
}
}
return 0 ;
}
static int F_107 ( struct V_145 * V_146 , int V_147 ,
void T_9 * V_131 , T_7 * V_148 , T_10 * V_149 )
{
if ( ! F_82 ( NULL ) )
return - V_130 ;
if ( ! V_126 )
return - V_107 ;
return F_108 ( V_146 , V_147 , V_131 , V_148 , V_149 ) ;
}
