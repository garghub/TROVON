...
if ( V_3 -> V_12 [ V_157 ] )
V_42 . V_158 = F_53 ( V_3 -> V_12 [ V_157 ] ) ;
if ( V_3 -> V_12 [ V_159 ] )
...
F_61 ( V_10 , V_10 -> V_9 -> V_89 ) ;
}
if ( V_3 -> V_12 [ V_155 ] )
V_10 -> V_156 = F_20 ( V_3 -> V_12 [ V_155 ] ) ;
if ( V_3 -> V_12 [ V_157 ] )
V_10 -> V_158 = F_53 ( V_3 -> V_12 [ V_157 ] ) ;
if ( V_3 -> V_12 [ V_159 ] )
...
goto V_90;
if ( ( V_10 -> V_7 [ 0 ] &&
F_62 ( V_17 , V_13 , V_10 -> V_7 ) ) ||
( V_10 -> V_144 &&
F_63 ( V_17 , V_143 , V_10 -> V_144 ,
& V_10 -> V_145 [ 0 ] ) ) ||
( V_10 -> V_147 &&
F_63 ( V_17 , V_146 , V_10 -> V_147 ,
& V_10 -> V_148 [ 0 ] ) ) ||
...
static int F_66 ( struct V_16 * V_17 , struct V_2 * V_3 )
{
struct V_1 * V_10 ;
struct V_16 * V_18 ;
int V_20 ;
...
static int F_67 ( struct V_16 * V_17 , struct V_121 * V_122 )
{
struct V_11 * V_11 = F_47 ( V_17 -> V_84 ) ;
struct V_1 * V_10 ;
struct V_8 * V_9 = NULL ;
...
int F_69 ( enum V_186 V_132 , const struct V_163 * V_187 )
{
int V_20 ;
V_20 = - V_43 ;
if ( V_132 >= V_133 )
