...
if ( V_11 -> type == V_25 || V_11 -> type == V_108 )
V_62 -> V_99 = F_24 ( V_11 -> V_3 ) ;
else
V_62 -> V_99 = ( V_109 ) - 1 ;
...
V_60 . V_114 = 'R' ;
V_60 . V_115 = 0 ;
strcpy ( V_60 . V_116 , L_1 ) ;
F_34 ( V_60 . V_117 , V_118 , sizeof( V_60 . V_117 ) ) ;
...
static T_4
F_35 ( struct V_121 * V_121 , char T_5 * V_122 , T_1 V_123 , T_6 * V_124 )
{
char * V_125 = V_121 -> V_126 ;
T_4 V_127 = 0 ;
T_1 V_4 , V_128 ;
T_1 V_9 ;
int V_8 ;
...
F_33 ( V_129 , V_8 , V_9 ) ;
F_37 ( & V_5 ) ;
if ( F_39 ( V_122 , V_129 + * V_124 , V_128 ) ) {
F_13 ( V_129 ) ;
return - V_131 ;
}
F_13 ( V_129 ) ;
...
F_37 ( & V_5 ) ;
V_36 = F_40 ( * V_124 - V_9 ) ;
if ( ( V_128 = ( V_110 - ( V_36 & ~ V_39 ) ) ) > V_123 )
V_128 = V_123 ;
while ( V_123 ) {
struct V_1 * V_11 ;
F_36 ( & V_5 ) ;
...
F_43 ( V_125 , ( char * ) V_36 , V_128 ) ;
if ( F_39 ( V_122 , V_125 , V_128 ) )
return - V_131 ;
} else {
if ( F_44 ( V_36 ) ) {
unsigned long V_132 ;
memcpy ( V_125 , ( char * ) V_36 , V_128 ) ;
V_132 = F_39 ( V_122 , V_125 , V_128 ) ;
if ( V_132 ) {
if ( F_41 ( V_122 + V_128 - V_132 ,
V_132 ) )
return - V_131 ;
}
} else {
...
V_127 += V_128 ;
V_36 += V_128 ;
V_128 = ( V_123 > V_110 ? V_110 : V_123 ) ;
}
return V_127 ;
}
static int F_45 ( struct V_133 * V_133 , struct V_121 * V_134 )
{
if ( ! F_46 ( V_135 ) )
return - V_136 ;
V_134 -> V_126 = F_20 ( V_110 , V_30 ) ;
if ( ! V_134 -> V_126 )
return - V_31 ;
if ( V_24 )
F_19 () ;
if ( F_47 ( V_133 ) != V_27 -> V_4 ) {
F_48 ( V_133 ) ;
F_49 ( V_133 , V_27 -> V_4 ) ;
F_50 ( V_133 ) ;
}
...
static int F_51 ( struct V_133 * V_133 , struct V_121 * V_121 )
{
F_13 ( V_121 -> V_126 ) ;
return 0 ;
}
static int T_7 F_52 ( struct V_137 * V_138 ,
unsigned long V_139 , void * V_40 )
{
switch ( V_139 ) {
case V_140 :
case V_141 :
...
{
F_1 ( & V_143 , V_144 , V_145 - V_144 , V_108 ) ;
}
static void T_8 F_53 ( void )
{
}
...
{
if ( V_146 != V_43 && V_147 != V_148 ) {
F_1 ( & V_149 , ( void * ) V_146 ,
V_147 - V_146 , V_150 ) ;
}
}
static void T_8 F_54 ( void )
