...
V_61 = V_66 ;
F_16 ( V_1 , V_60 ,
V_58 + 2 , V_1 -> V_63 . V_67 ) ;
F_16 ( V_1 , V_61 ,
V_58 + V_1 -> V_63 . V_67 + 5 ,
V_1 -> V_63 . V_67 ) ;
}
static int F_17 ( struct V_68 * V_69 )
{
struct V_1 * V_1 =
F_18 ( V_69 -> V_70 , struct V_1 , V_71 ) ;
V_1 -> V_72 = 0 ;
if ( ! V_1 -> V_73 )
return 0 ;
switch ( V_69 -> V_21 ) {
...
{
struct V_76 * V_77 = & V_1 -> V_71 ;
V_1 -> V_78 . V_71 = V_77 ;
F_20 ( V_77 , 2 ) ;
F_21 ( V_77 , & V_79 ,
V_74 , 0 , 0x18f , 1 , 0x18f ) ;
F_21 ( V_77 , & V_79 ,
V_75 , 0 , 0x7ff , 1 , 0x100 ) ;
if ( V_77 -> error ) {
F_22 ( L_1 ) ;
return V_77 -> error ;
}
...
const struct V_20 * V_21 )
{
return F_24 ( V_81 , V_21 , & V_82 , sizeof( struct V_43 ) ,
V_83 ) ;
}
