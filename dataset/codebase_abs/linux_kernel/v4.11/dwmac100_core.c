...
static void F_18 ( struct V_1 * V_2 , unsigned long V_45 )
{
return;
}
struct V_1 * F_19 ( void T_1 * V_4 , int * V_46 )
{
struct V_1 * V_47 ;
V_47 = F_20 ( sizeof( const struct V_1 ) , V_48 ) ;
if ( ! V_47 )
return NULL ;
F_21 ( L_1 ) ;
V_47 -> V_5 = V_4 ;
...
V_47 -> V_57 . V_59 = V_60 ;
V_47 -> V_57 . V_61 = 11 ;
V_47 -> V_57 . V_62 = 0x0000F800 ;
V_47 -> V_57 . V_63 = 6 ;
V_47 -> V_57 . V_64 = 0x000007C0 ;
V_47 -> V_57 . V_65 = 2 ;
V_47 -> V_57 . V_66 = F_22 ( 5 , 2 ) ;
* V_46 = 0 ;
return V_47 ;
}
