...
V_148 = F_43 ( V_131 -> V_148 >> 16 , 0 , V_155 ) ;
...
V_157 = V_10 -> V_126 ;
if ( V_157 )
F_45 ( V_10 -> V_105 , V_157 ) ;
V_159 = F_46 ( V_10 -> V_105 , V_158 ) ;
if ( V_159 < 0 ) {
F_24 ( L_55 ,
V_158 ) ;
return - V_79 ;
...
if ( ! V_27 || ! V_134 )
return;
if ( ( V_161 -> V_134 == V_131 -> V_134 ) &&
( V_161 -> V_149 == V_131 -> V_149 ) &&
( V_161 -> V_150 == V_131 -> V_150 ) &&
( V_161 -> V_151 == V_131 -> V_151 ) &&
( V_161 -> V_153 == V_131 -> V_153 ) &&
( V_161 -> V_145 == V_131 -> V_145 ) &&
( V_161 -> V_146 == V_131 -> V_146 ) &&
( V_161 -> V_147 == V_131 -> V_147 ) &&
( V_161 -> V_148 == V_131 -> V_148 ) ) {
F_26 ( L_58 ) ;
V_25 -> V_106 = V_173 ;
return;
}
if ( ! V_10 -> V_103 ) {
struct V_174 * V_175 = F_49 ( V_10 -> V_117 ) ;
struct V_137 * V_138 = F_16 ( V_27 ) ;
V_10 -> V_103 = V_175 -> V_103 [ V_138 -> V_49 ] ;
...
V_15 -> V_61 &= ~ V_18 ;
V_163 = F_44 ( V_134 , 0 ) ;
F_26 ( L_60 , V_134 -> V_11 . V_49 ,
( char * ) & V_134 -> V_6 -> V_6 ,
( unsigned long ) V_163 -> V_178 ) ;
V_168 = V_134 -> V_6 -> V_179 [ 0 ] ;
V_15 -> V_55 = ( T_2 ) V_163 -> V_178 + V_134 -> V_180 [ 0 ] ;
V_15 -> V_55 += V_145 * V_168 ;
V_15 -> V_55 += V_146 * V_134 -> V_181 [ 0 ] ;
V_143 = F_37 ( V_10 -> V_117 , V_143 , V_147 ) ;
V_144 = F_37 ( V_10 -> V_117 , V_144 , V_148 ) ;
V_169 = F_52 ( * V_140 , V_142 ) ;
V_171 = F_52 ( * V_140 , V_142 + V_144 - 1 ) ;
V_170 = F_53 ( * V_140 , V_141 ) ;
V_172 = F_53 ( * V_140 , V_141 + V_143 - 1 ) ;
V_15 -> V_53 = ( V_169 << 16 ) | V_170 ;
V_15 -> V_54 = ( V_171 << 16 ) | V_172 ;
V_147 = V_143 ;
V_15 -> V_56 = V_134 -> V_181 [ 0 ] ;
V_15 -> V_57 = V_148 << 16 | V_147 ;
memcpy ( V_17 , V_15 , sizeof( * V_17 ) ) ;
V_15 -> V_58 = V_164 -> V_16 ;
V_17 -> V_58 = V_164 -> V_14 ;
...
if ( V_140 -> V_182 & V_183 ) {
if ( V_10 -> V_113 ) {
V_165 -> V_17 -> V_58 = V_166 ;
} else {
F_54 ( V_166 ,
V_10 -> V_28 + V_41 ) ;
}
} else {
F_54 ( V_166 , V_10 -> V_28 + V_41 ) ;
}
V_102:
...
F_26 ( L_56 ,
V_161 -> V_27 -> V_11 . V_49 ,
F_15 ( F_16 ( V_161 -> V_27 ) ) ,
V_24 -> V_11 . V_49 , F_12 ( V_25 ) ) ;
V_25 -> V_106 = V_185 ;
}
...
struct V_24 * F_61 ( struct V_187 * V_188 ,
...
F_32 ( V_10 ) ;
V_159 = F_63 ( V_188 , & V_10 -> V_25 . V_24 ,
V_190 ,
& V_193 ,
V_194 ,
F_3 ( V_194 ) ,
