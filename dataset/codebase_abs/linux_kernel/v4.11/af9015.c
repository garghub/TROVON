...
V_6 -> V_185 = F_56 ( V_12 [ 12 ] ,
V_12 [ 14 ] ) ;
V_184 = V_186 ;
} else {
V_6 -> V_185 = F_57 ( V_12 [ 12 ] << 8 |
V_12 [ 13 ] ,
V_12 [ 14 ] ) ;
V_184 = V_187 ;
}
} else {
V_6 -> V_185 = F_58 ( V_12 [ 12 ] << 24 |
V_12 [ 13 ] << 16 |
V_12 [ 14 ] << 8 |
V_12 [ 15 ] ) ;
V_184 = V_188 ;
}
F_59 ( V_2 -> V_182 , V_184 , V_6 -> V_185 , 0 ) ;
} else {
...
static int F_61 ( struct V_1 * V_2 , struct V_190 * V_191 )
{
struct V_5 * V_6 = F_4 ( V_2 ) ;
T_2 V_192 = F_30 ( V_2 -> V_31 -> V_113 . V_114 ) ;
if ( V_6 -> V_80 == V_193 )
return 0 ;
if ( ! V_191 -> V_194 )
V_191 -> V_194 = F_54 ( V_195 ,
V_196 ) ;
if ( ! V_191 -> V_194 )
V_191 -> V_194 = F_54 ( V_6 -> V_75 ,
V_197 ) ;
if ( ! V_191 -> V_194 && V_192 == V_198 ) {
char V_199 [ 10 ] ;
memset ( V_199 , 0 , sizeof( V_199 ) ) ;
F_62 ( V_2 -> V_31 , V_2 -> V_31 -> V_113 . V_200 ,
V_199 , sizeof( V_199 ) ) ;
if ( ! strcmp ( L_44 , V_199 ) ) {
V_191 -> V_194 = F_54 (
V_201 ,
V_196 ) ;
}
...
if ( ! V_191 -> V_194 )
V_191 -> V_194 = V_202 ;
V_191 -> V_203 = V_204 | V_205 | V_206 ;
V_191 -> V_207 = F_55 ;
V_191 -> V_208 = 500 ;
return 0 ;
}
static int F_63 ( struct V_209 * V_210 ,
const struct V_211 * V_124 )
{
struct V_212 * V_31 = F_64 ( V_210 ) ;
char V_199 [ sizeof( L_45 ) ] ;
memset ( V_199 , 0 , sizeof( V_199 ) ) ;
F_62 ( V_31 , V_31 -> V_113 . V_200 ,
V_199 , sizeof( V_199 ) ) ;
if ( ( F_30 ( V_31 -> V_113 . V_114 ) == V_213 ) &&
( F_30 ( V_31 -> V_113 . V_116 ) == 0x0099 ) ) {
if ( ! strcmp ( L_45 , V_199 ) ) {
F_23 ( & V_31 -> V_32 , L_46 , V_62 ) ;
return - V_111 ;
}
}
return F_65 ( V_210 , V_124 ) ;
}
