...
static int F_205 ( void * V_366 )
{
F_206 ( V_367 ) ;
struct V_154 * V_155 = V_366 ;
struct V_21 * V_22 = NULL ;
int V_368 = V_155 -> V_368 ;
F_43 ( F_104 () != V_368 ) ;
F_207 ( & V_155 -> V_369 ) ;
F_208 ( & V_155 -> V_370 ) ;
F_32 ( L_266 , V_368 , F_209 ( V_12 ) ) ;
F_210 () ;
while ( ! F_211 () ) {
V_22 = F_173 ( V_155 ) ;
...
V_22 -> V_225 = F_218 ( V_151 * sizeof( struct V_377 ) ,
V_71 ) ;
if ( V_22 -> V_225 == NULL ) {
F_219 ( V_22 ) ;
return - V_376 ;
...
V_22 -> V_233 = V_247 ;
V_22 -> V_234 = V_384 ;
V_22 -> V_385 . V_386 = V_230 ;
V_22 -> V_250 . V_170 = V_22 -> V_50 ;
F_220 ( & V_22 -> V_250 , V_387 , false ) ;
V_22 -> V_250 . V_388 = & V_22 -> V_250 ;
V_22 -> V_250 . V_389 = & V_22 -> V_385 ;
#endif
...
static int T_15 F_222 ( int V_368 , struct V_10 * V_11 )
{
struct V_154 * V_155 ;
struct V_390 * V_391 ;
struct V_392 * V_342 ;
...
F_231 ( V_342 , V_368 ) ;
V_155 -> V_349 = V_342 ;
V_391 = F_62 ( V_155 -> V_349 -> V_350 , 0600 , V_11 -> V_172 ,
& V_395 , V_155 ) ;
if ( ! V_391 ) {
F_48 ( L_273 ,
V_382 , V_155 -> V_349 -> V_350 ) ;
F_232 ( V_342 ) ;
F_229 ( & V_155 -> V_393 ) ;
F_219 ( V_155 ) ;
return - V_18 ;
...
F_224 ( & V_11 -> V_394 ) ;
V_11 -> V_178 = false ;
V_11 -> V_172 = F_240 ( V_382 , V_11 -> V_184 -> V_397 ) ;
if ( ! V_11 -> V_172 ) {
F_30 ( L_279 , V_382 ) ;
return - V_186 ;
}
V_391 = F_241 ( V_398 , 0600 , V_11 -> V_172 , & V_399 ) ;
if ( V_391 == NULL ) {
F_48 ( L_280 , V_398 ) ;
V_156 = - V_18 ;
goto remove;
...
return 0 ;
V_400:
F_181 ( V_398 , V_11 -> V_172 ) ;
remove:
F_181 ( V_382 , V_11 -> V_184 -> V_397 ) ;
return V_156 ;
}
...
V_11 -> V_178 = true ;
F_49 ( & V_158 ) ;
F_246 ( & V_11 -> V_394 , & V_348 ) ;
F_51 ( & V_158 ) ;
F_176 (q, n, &list) {
V_155 = F_177 ( V_346 , struct V_154 , V_393 ) ;
F_229 ( & V_155 -> V_393 ) ;
F_232 ( V_155 -> V_349 ) ;
F_247 ( V_155 -> V_349 ) ;
F_219 ( V_155 ) ;
