...
F_35 ( ( unsigned int ) V_16 -> V_124 -> V_127 ) ,
& V_16 -> V_128 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_17 ) ;
goto V_129;
...
V_16 -> V_99 . V_145 = F_51 ( V_16 -> V_99 . V_85 , sizeof( V_146 ) ,
V_147 ) ;
V_16 -> V_84 . V_145 = F_51 ( V_16 -> V_84 . V_85 , sizeof( V_146 ) ,
V_147 ) ;
if ( ! V_16 -> V_99 . V_145 || ! V_16 -> V_84 . V_145 ) {
V_60 = - V_142 ;
goto V_148;
}
}
...
F_30 ( V_2 , V_3 , 1 ) ;
V_148:
F_53 ( V_16 -> V_99 . V_145 ) ;
F_53 ( V_16 -> V_84 . V_145 ) ;
V_130:
F_54 ( V_2 , & V_16 -> V_128 ) ;
V_129:
if ( V_110 -> V_121 )
...
struct V_18 * F_57 ( struct V_110 * V_151 ,
struct V_111 * V_112 ,
struct V_113 * V_114 )
{
struct V_1 * V_2 = F_58 ( V_151 -> V_7 ) ;
struct V_7 * V_8 = & V_2 -> V_9 -> V_8 ;
struct V_152 * V_153 ;
struct V_10 * V_16 ;
int V_60 ;
switch ( V_112 -> V_70 ) {
case V_154 : {
V_16 = F_59 ( sizeof( * V_16 ) , V_147 ) ;
if ( ! V_16 )
return F_60 ( - V_142 ) ;
V_60 = F_39 ( V_2 , V_151 , V_112 , V_114 , 0 ,
V_16 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_26 ) ;
F_53 ( V_16 ) ;
...
V_153 = F_59 ( sizeof( * V_153 ) , V_147 ) ;
if ( ! V_153 )
return F_60 ( - V_142 ) ;
V_16 = & V_153 -> V_16 ;
V_16 -> V_156 = V_112 -> V_157 - 1 ;
V_16 -> V_158 = V_2 -> V_159 . V_158 [ V_16 -> V_156 ] ;
V_16 -> V_19 . V_155 = V_160 +
V_2 -> V_159 . V_158 [ V_16 -> V_156 ] ;
V_60 = F_39 ( V_2 , V_151 , V_112 , V_114 ,
V_16 -> V_19 . V_155 , V_16 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_28 ) ;
F_53 ( V_153 ) ;
return F_60 ( V_60 ) ;
...
int F_62 ( struct V_18 * V_19 , struct V_167 * V_168 ,
int V_169 , struct V_113 * V_114 )
{
struct V_1 * V_2 = F_58 ( V_19 -> V_7 ) ;
struct V_10 * V_16 = F_63 ( V_19 ) ;
enum V_45 V_170 , V_171 ;
struct V_7 * V_8 = & V_2 -> V_9 -> V_8 ;
int V_60 = - V_61 ;
int V_172 ;
enum V_173 V_174 ;
F_64 ( & V_16 -> V_116 ) ;
V_170 = V_169 & V_175 ?
V_168 -> V_176 : (enum V_45 ) V_16 -> V_46 ;
V_171 = V_169 & V_177 ?
V_168 -> V_178 : V_170 ;
if ( ! F_65 ( V_170 , V_171 , V_19 -> V_70 , V_169 ,
V_179 ) ) {
F_18 ( V_8 , L_30 ) ;
goto V_180;
}
if ( ( V_169 & V_181 ) &&
( V_168 -> V_157 == 0 || V_168 -> V_157 > V_2 -> V_63 . V_182 ) ) {
F_18 ( V_8 , L_31 ,
V_168 -> V_157 ) ;
goto V_180;
}
if ( V_169 & V_183 ) {
V_172 = V_169 & V_181 ? ( V_168 -> V_157 - 1 ) : V_16 -> V_156 ;
if ( V_168 -> V_184 >= V_2 -> V_63 . V_185 [ V_172 ] ) {
F_18 ( V_8 , L_32 ,
V_168 -> V_184 ) ;
goto V_180;
}
...
if ( V_169 & V_186 ) {
V_172 = V_169 & V_181 ? ( V_168 -> V_157 - 1 ) : V_16 -> V_156 ;
V_174 = F_66 ( V_2 -> V_159 . V_187 [ V_172 ] -> V_188 ) ;
if ( V_168 -> V_189 > V_190 ||
V_168 -> V_189 < V_191 ||
V_168 -> V_189 > V_174 ) {
F_18 ( V_8 , L_33 ,
V_168 -> V_189 ) ;
...
if ( V_169 & V_192 &&
V_168 -> V_193 > V_2 -> V_63 . V_194 ) {
F_18 ( V_8 , L_34 ,
V_168 -> V_193 ) ;
goto V_180;
}
if ( V_169 & V_195 &&
V_168 -> V_196 > V_2 -> V_63 . V_197 ) {
F_18 ( V_8 , L_35 ,
V_168 -> V_196 ) ;
goto V_180;
}
if ( V_170 == V_171 && V_170 == V_47 ) {
V_60 = - V_198 ;
F_18 ( V_8 , L_36 , V_170 ,
V_171 ) ;
goto V_180;
}
V_60 = V_2 -> V_199 -> V_200 ( V_19 , V_168 , V_169 , V_170 ,
V_171 ) ;
V_180:
F_67 ( & V_16 -> V_116 ) ;
return V_60 ;
}
void F_68 ( struct V_201 * V_202 , struct V_201 * V_203 )
__acquires( &send_cq->lock
void F_69 ( struct V_201 * V_202 ,
struct V_201 * V_203 ) __releases( &send_cq->lock
T_3 F_70 ( struct V_204 * V_205 )
{
switch ( V_205 -> V_206 ) {
case V_207 :
case V_208 :
return F_71 ( V_205 -> V_209 . V_210 ) ;
case V_211 :
return F_71 ( V_205 -> V_209 . V_212 ) ;
default:
return 0 ;
}
}
...
void * F_74 ( struct V_10 * V_16 , int V_213 )
{
return F_72 ( V_16 , V_16 -> V_84 . V_102 + ( V_213 << V_16 -> V_84 . V_88 ) ) ;
}
void * F_75 ( struct V_10 * V_16 , int V_213 )
{
return F_72 ( V_16 , V_16 -> V_99 . V_102 + ( V_213 << V_16 -> V_99 . V_88 ) ) ;
}
bool F_76 ( struct V_214 * V_215 , int V_216 ,
struct V_217 * V_217 )
{
struct V_201 * V_218 ;
T_1 V_219 ;
V_219 = V_215 -> V_220 - V_215 -> V_221 ;
if ( F_77 ( V_219 + V_216 < V_215 -> V_90 ) )
return 0 ;
V_218 = F_78 ( V_217 ) ;
F_2 ( & V_218 -> V_12 ) ;
V_219 = V_215 -> V_220 - V_215 -> V_221 ;
F_5 ( & V_218 -> V_12 ) ;
return V_219 + V_216 >= V_215 -> V_90 ;
}
