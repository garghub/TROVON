...
if ( V_204 ) {
memcpy ( V_44 -> V_149 , V_204 -> V_214 , V_215 ) ;
V_61 -> V_126 = V_204 -> V_126 ;
} else {
const void * V_95 ;
V_95 = F_102 ( V_198 -> V_2 . V_213 ) ;
if ( V_95 )
memcpy ( V_44 -> V_149 , V_95 , V_215 ) ;
V_61 -> V_126 = - 1 ;
}
if ( ! F_68 ( V_44 -> V_149 ) )
...
F_66 ( V_44 ) ;
if ( ! V_205 ) {
struct V_216 * V_216 = F_104 ( & V_198 -> V_2 , NULL ) ;
if ( ! F_105 ( V_216 ) ) {
V_61 -> V_216 = V_216 ;
F_106 ( V_216 ) ;
V_205 = F_107 ( V_216 ) ;
...
if ( V_205 ) {
T_1 V_217 = F_108 ( V_205 / 2500000 + 1 ) ;
if ( ! V_217 )
V_217 = 2 ;
F_33 ( & V_198 -> V_2 , L_27 , V_217 ) ;
F_4 ( V_61 , V_218 ,
...
snprintf ( V_61 -> V_127 -> V_221 , V_222 , L_29 ,
V_61 -> V_127 -> V_137 , V_198 -> V_221 ) ;
V_61 -> V_127 -> V_223 = F_39 ;
V_61 -> V_127 -> V_224 = F_42 ;
...
static int F_123 ( struct V_197 * V_198 , T_7 V_233 )
{
return - V_171 ;
}
