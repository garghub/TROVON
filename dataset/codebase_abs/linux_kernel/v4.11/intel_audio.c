...
F_51 ( V_22 , NULL , V_39 , V_45 , 0 , false , 0 ) ;
}
...
V_22 -> V_75 . V_76 = F_42 ;
V_22 -> V_75 . V_85 = F_32 ;
} else if ( F_55 ( V_22 ) || F_56 ( V_22 ) -> V_86 >= 8 ) {
V_22 -> V_75 . V_76 = F_29 ;
V_22 -> V_75 . V_85 = F_22 ;
} else if ( F_57 ( V_22 ) ) {
V_22 -> V_75 . V_76 = F_42 ;
...
static void F_63 ( struct V_87 * V_88 ,
bool V_90 )
{
struct V_21 * V_22 = F_60 ( V_88 ) ;
T_1 V_25 ;
if ( ! F_64 ( V_22 ) && ! F_65 ( V_22 ) )
return;
F_58 ( V_88 ) ;
V_25 = F_8 ( V_91 ) ;
V_25 &= ~ V_92 ;
...
static struct V_26 * F_70 ( struct V_21 * V_22 ,
int V_39 , int V_45 )
{
struct V_26 * V_27 ;
if ( F_34 ( V_45 >= V_95 ) )
...
static int F_72 ( struct V_87 * V_88 , int V_39 ,
int V_45 , int V_3 )
{
struct V_21 * V_22 = F_60 ( V_88 ) ;
struct V_26 * V_26 ;
...
static int F_73 ( struct V_87 * V_88 , int V_39 ,
int V_45 , bool * V_98 ,
...
static int F_74 ( struct V_87 * V_103 ,
struct V_87 * V_104 , void * V_105 )
{
...
static void F_78 ( struct V_87 * V_103 ,
struct V_87 * V_104 , void * V_105 )
{
struct V_40 * V_41 = V_105 ;
struct V_21 * V_22 = F_60 ( V_103 ) ;
...
return;
V_101 = F_80 ( V_22 -> V_108 . V_23 , & V_113 ) ;
if ( V_101 < 0 ) {
F_81 ( L_16 , V_101 ) ;
return;
}
