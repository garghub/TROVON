...
struct V_201 * V_126 ;
int error ;
error = F_94 ( V_135 , & F_92 ( V_135 ) -> V_253 , 0 , 0 , 0 , & V_126 ) ;
if ( error ) {
ASSERT ( F_55 ( V_135 ) ) ;
return error ;
}
...
struct V_201 * V_126 ;
int error ;
if ( F_116 ( V_135 -> V_257 ) ) {
error = F_94 ( V_135 , & F_92 ( V_135 ) -> V_258 ,
F_141 ( V_135 ) , 0 , V_259 ,
& V_126 ) ;
} else {
error = F_94 ( V_135 , & F_92 ( V_135 ) -> V_258 , 0 , 0 , 0 , & V_126 ) ;
}
if ( error ) {
if ( error == - V_195 ) {
F_142 ( V_135 ,
...
ASSERT ( V_2 -> V_20 . V_264 == 0 ) ;
return;
}
V_135 = V_2 -> V_7 ;
ASSERT ( ! F_136 ( V_2 , V_265 ) ) ;
if ( V_135 -> V_222 & V_247 )
return;
if ( F_10 ( V_2 ) -> V_199 != 0 ) {
if ( F_135 ( V_2 , true ) ) {
...
error = F_152 ( V_135 , V_126 , F_153 ( V_135 , V_2 -> V_74 ) , & V_269 ) ;
if ( error )
return error ;
V_267 = F_154 ( V_269 ) ;
V_271 = F_155 ( V_135 , V_2 -> V_74 ) ;
ASSERT ( V_271 != 0 ) ;
V_272 = V_271 % V_274 ;
ASSERT ( V_267 -> V_275 [ V_272 ] ) ;
ASSERT ( F_156 ( V_267 -> V_275 [ V_272 ] ) != V_271 ) ;
if ( V_267 -> V_275 [ V_272 ] != F_157 ( V_276 ) ) {
error = F_158 ( V_135 , V_126 , & V_2 -> V_277 , & V_268 , & V_270 ,
0 , 0 ) ;
if ( error )
return error ;
ASSERT ( V_268 -> V_278 == F_157 ( V_276 ) ) ;
V_268 -> V_278 = V_267 -> V_275 [ V_272 ] ;
V_273 = V_2 -> V_277 . V_279 +
F_159 ( T_21 , V_278 ) ;
F_160 ( V_135 , V_268 ) ;
F_161 ( V_126 , V_270 ) ;
F_162 ( V_126 , V_270 , V_273 ,
( V_273 + sizeof( T_22 ) - 1 ) ) ;
F_163 ( V_135 , V_270 ) ;
}
ASSERT ( V_271 != 0 ) ;
V_267 -> V_275 [ V_272 ] = F_157 ( V_271 ) ;
V_273 = F_159 ( T_20 , V_275 ) +
( sizeof( T_22 ) * V_272 ) ;
F_162 ( V_126 , V_269 , V_273 ,
( V_273 + sizeof( T_22 ) - 1 ) ) ;
return 0 ;
}
STATIC int
...
int error ;
V_135 = V_126 -> V_136 ;
V_281 = F_153 ( V_135 , V_2 -> V_74 ) ;
error = F_152 ( V_135 , V_126 , V_281 , & V_269 ) ;
if ( error )
return error ;
V_267 = F_154 ( V_269 ) ;
V_271 = F_155 ( V_135 , V_2 -> V_74 ) ;
ASSERT ( V_271 != 0 ) ;
V_272 = V_271 % V_274 ;
ASSERT ( V_267 -> V_275 [ V_272 ] != F_157 ( V_276 ) ) ;
ASSERT ( V_267 -> V_275 [ V_272 ] ) ;
if ( F_156 ( V_267 -> V_275 [ V_272 ] ) == V_271 ) {
error = F_158 ( V_135 , V_126 , & V_2 -> V_277 , & V_268 , & V_270 ,
0 , 0 ) ;
if ( error ) {
F_164 ( V_135 , L_6 ,
...
V_282 = F_156 ( V_268 -> V_278 ) ;
ASSERT ( V_282 != 0 ) ;
if ( V_282 != V_276 ) {
V_268 -> V_278 = F_157 ( V_276 ) ;
V_273 = V_2 -> V_277 . V_279 +
F_159 ( T_21 , V_278 ) ;
F_160 ( V_135 , V_268 ) ;
F_161 ( V_126 , V_270 ) ;
...
ASSERT ( V_282 != 0 ) ;
ASSERT ( V_282 != V_271 ) ;
V_267 -> V_275 [ V_272 ] = F_157 ( V_282 ) ;
V_273 = F_159 ( T_20 , V_275 ) +
( sizeof( T_22 ) * V_272 ) ;
F_162 ( V_126 , V_269 , V_273 ,
( V_273 + sizeof( T_22 ) - 1 ) ) ;
} else {
V_282 = F_156 ( V_267 -> V_275 [ V_272 ] ) ;
V_283 = NULL ;
while ( V_282 != V_271 ) {
struct V_286 V_287 ;
if ( V_283 )
F_165 ( V_126 , V_283 ) ;
V_287 . V_288 = 0 ;
V_280 = F_166 ( V_135 , V_281 , V_282 ) ;
error = V_286 ( V_135 , V_126 , V_280 , & V_287 , 0 ) ;
if ( error ) {
F_164 ( V_135 ,
L_7 ,
V_260 , error ) ;
...
error = F_158 ( V_135 , V_126 , & V_287 , & V_284 ,
& V_283 , 0 , 0 ) ;
if ( error ) {
F_164 ( V_135 ,
L_6 ,
...
V_284 -> V_278 = F_157 ( V_282 ) ;
ASSERT ( V_282 != 0 ) ;
V_273 = V_285 + F_159 ( T_21 , V_278 ) ;
F_160 ( V_135 , V_284 ) ;
F_161 ( V_126 , V_283 ) ;
F_162 ( V_126 , V_283 , V_273 ,
( V_273 + sizeof( T_22 ) - 1 ) ) ;
F_163 ( V_135 , V_283 ) ;
}
return 0 ;
...
T_8 V_122 ;
V_122 = V_291 -> V_302 ;
V_301 = F_168 ( V_135 , F_153 ( V_135 , V_122 ) ) ;
V_292 = F_169 ( V_135 ) ;
V_293 = V_292 << V_135 -> V_8 . V_303 ;
V_294 = V_135 -> V_304 / V_292 ;
for ( V_59 = 0 ; V_59 < V_294 ; V_59 ++ , V_122 += V_293 ) {
V_295 = V_122 - V_291 -> V_302 ;
if ( ( V_291 -> V_305 & F_170 ( V_295 ) ) == 0 ) {
ASSERT ( F_171 ( V_295 , V_293 ) == 0 ) ;
continue;
}
V_296 = F_172 ( V_135 , F_153 ( V_135 , V_122 ) ,
F_173 ( V_135 , V_122 ) ) ;
V_297 = F_174 ( V_126 , V_135 -> V_306 , V_296 ,
V_135 -> V_307 * V_292 ,
V_308 ) ;
if ( ! V_297 )
return - V_309 ;
...
V_298 = ( T_25 * ) V_299 ;
ASSERT ( V_298 -> V_315 == 1 ) ;
V_299 -> V_316 = V_317 ;
F_175 ( V_135 -> V_318 ,
& V_298 -> V_319 ,
& V_298 -> V_320 . V_321 ) ;
F_138 ( V_298 -> V_322 , V_323 ) ;
}
V_299 = V_299 -> V_324 ;
}
for ( V_58 = 0 ; V_58 < V_293 ; V_58 ++ ) {
V_325:
F_176 () ;
V_2 = F_177 ( & V_301 -> V_326 ,
...
V_298 -> V_328 = V_298 -> V_329 ;
V_298 -> V_329 = 0 ;
V_298 -> V_330 = 0 ;
V_298 -> V_315 = 1 ;
F_175 ( V_135 -> V_318 , & V_298 -> V_319 ,
& V_298 -> V_320 . V_321 ) ;
F_185 ( V_297 , V_317 ,
& V_298 -> V_320 ) ;
if ( V_2 != V_289 )
...
if ( error )
return error ;
error = F_189 ( V_126 , V_2 -> V_74 , V_203 , & V_291 ) ;
if ( error )
return error ;
F_10 ( V_2 ) -> V_144 = 0 ;
V_2 -> V_3 . V_4 = 0 ;
...
F_191 ( V_2 , V_27 ) ;
F_192 ( V_2 -> V_7 , V_2 -> V_63 -> V_333 , 0 ) ;
}
static void
F_193 (
struct V_1 * V_2 )
{
T_5 * V_75 = F_43 ( & V_2 -> V_76 , V_334 ) ;
F_44 ( V_78 , & V_2 -> V_76 , V_334 ) ;
F_190 ( V_2 ) ;
do {
...
goto V_230;
V_212 = F_199 ( V_135 ) ;
error = F_94 ( V_135 , & F_92 ( V_135 ) -> V_335 , V_212 , 0 , 0 , & V_126 ) ;
if ( error == - V_195 ) {
V_212 = 0 ;
error = F_94 ( V_135 , & F_92 ( V_135 ) -> V_335 , 0 , 0 , 0 ,
& V_126 ) ;
}
if ( error ) {
ASSERT ( error != - V_195 ) ;
...
int V_58 , V_59 ;
ASSERT ( * V_343 == V_344 ) ;
memset ( V_342 , 0 , * V_343 * sizeof( struct V_1 * ) ) ;
V_58 = 0 ;
V_342 [ V_58 ++ ] = V_338 ;
V_342 [ V_58 ++ ] = V_339 ;
V_342 [ V_58 ++ ] = V_72 ;
...
for ( V_59 = 1 ; V_59 < * V_343 ; V_59 ++ ) {
if ( V_342 [ V_59 ] -> V_74 < V_342 [ V_59 - 1 ] -> V_74 ) {
struct V_1 * V_73 = V_342 [ V_59 ] ;
V_342 [ V_59 ] = V_342 [ V_59 - 1 ] ;
V_342 [ V_59 - 1 ] = V_73 ;
}
}
}
...
if ( V_338 != V_339 ) {
V_350 = V_220 | V_198 ;
if ( F_68 ( F_10 ( V_340 ) -> V_144 ) ) {
error = F_207 ( V_126 , V_340 , & V_352 ,
V_338 -> V_74 , V_204 ,
V_203 , V_347 ) ;
if ( error )
goto V_351;
...
if ( F_68 ( F_10 ( V_72 ) -> V_144 ) ) {
error = F_207 ( V_126 , V_72 , & V_352 ,
V_339 -> V_74 , V_204 ,
V_203 , V_347 ) ;
if ( error )
goto V_351;
if ( ! F_68 ( F_10 ( V_340 ) -> V_144 ) ) {
error = F_81 ( V_126 , V_338 ) ;
if ( error )
goto V_351;
...
if ( V_348 ) {
F_82 ( V_126 , V_72 , V_348 ) ;
F_74 ( V_126 , V_72 , V_164 ) ;
}
if ( V_349 ) {
F_82 ( V_126 , V_340 , V_349 ) ;
F_74 ( V_126 , V_340 , V_164 ) ;
}
if ( V_350 ) {
F_82 ( V_126 , V_339 , V_350 ) ;
F_74 ( V_126 , V_339 , V_164 ) ;
}
F_82 ( V_126 , V_338 , V_220 | V_198 ) ;
F_74 ( V_126 , V_338 , V_164 ) ;
...
struct V_1 * tmpfile ;
int error ;
error = F_111 ( V_117 , NULL , V_167 | V_353 , & tmpfile ) ;
if ( error )
return error ;
F_83 ( F_10 ( tmpfile ) ) ;
F_209 ( tmpfile ) ;
F_109 ( tmpfile ) ;
F_10 ( tmpfile ) -> V_354 |= V_355 ;
* V_341 = tmpfile ;
return 0 ;
}
int
...
unsigned int V_81 )
{
struct V_134 * V_135 = V_356 -> V_7 ;
struct V_201 * V_126 ;
struct V_202 V_203 ;
T_15 V_204 ;
struct V_1 * V_341 = NULL ;
struct V_1 * V_56 [ V_344 ] ;
int V_343 = V_344 ;
bool V_361 = ( V_356 != V_359 ) ;
bool V_362 = F_68 ( F_10 ( V_358 ) -> V_144 ) ;
int V_347 ;
int error ;
F_211 ( V_356 , V_359 , V_357 , V_229 ) ;
if ( ( V_81 & V_363 ) && ! V_360 )
return - V_364 ;
if ( V_81 & V_365 ) {
ASSERT ( ! ( V_81 & ( V_366 | V_363 ) ) ) ;
error = F_208 ( V_359 , & V_341 ) ;
if ( error )
return error ;
V_357 -> type = V_367 ;
}
F_204 ( V_356 , V_359 , V_358 , V_360 , V_341 ,
V_56 , & V_343 ) ;
V_347 = F_212 ( V_135 , V_229 -> V_215 ) ;
error = F_94 ( V_135 , & F_92 ( V_135 ) -> V_368 , V_347 , 0 , 0 , & V_126 ) ;
if ( error == - V_195 ) {
V_347 = 0 ;
error = F_94 ( V_135 , & F_92 ( V_135 ) -> V_368 , 0 , 0 , 0 ,
& V_126 ) ;
}
if ( error )
goto V_369;
...
if ( error )
goto V_219;
F_38 ( V_56 , V_343 , V_23 ) ;
F_73 ( V_126 , V_356 , V_23 ) ;
if ( V_361 )
F_73 ( V_126 , V_359 , V_23 ) ;
F_73 ( V_126 , V_358 , V_23 ) ;
if ( V_360 )
F_73 ( V_126 , V_360 , V_23 ) ;
if ( V_341 )
F_73 ( V_126 , V_341 , V_23 ) ;
if ( F_116 ( ( V_359 -> V_3 . V_4 & V_99 ) &&
( F_117 ( V_359 ) != F_117 ( V_358 ) ) ) ) {
error = - V_232 ;
goto V_219;
}
F_96 ( & V_203 , & V_204 ) ;
if ( V_81 & V_363 )
return F_206 ( V_126 , V_356 , V_357 , V_358 ,
V_359 , V_229 , V_360 ,
& V_203 , & V_204 , V_347 ) ;
if ( V_360 == NULL ) {
if ( ! V_347 ) {
error = F_98 ( V_126 , V_359 , V_229 ) ;
if ( error )
goto V_219;
}
error = F_99 ( V_126 , V_359 , V_229 ,
V_358 -> V_74 , & V_204 ,
& V_203 , V_347 ) ;
if ( error )
goto V_221;
...
V_220 | V_198 ) ;
if ( V_361 && V_362 ) {
error = F_85 ( V_126 , V_359 ) ;
if ( error )
goto V_221;
}
} else {
if ( F_68 ( F_10 ( V_360 ) -> V_144 ) ) {
if ( ! ( F_200 ( V_360 ) ) ||
( F_10 ( V_360 ) -> V_199 > 2 ) ) {
error = - V_370 ;
goto V_219;
...
F_82 ( V_126 , V_358 , V_198 ) ;
F_74 ( V_126 , V_358 , V_164 ) ;
if ( V_362 && ( V_361 || V_360 != NULL ) ) {
error = F_81 ( V_126 , V_356 ) ;
if ( error )
goto V_221;
}
if ( V_341 ) {
error = F_207 ( V_126 , V_356 , V_357 , V_341 -> V_74 ,
& V_204 , & V_203 , V_347 ) ;
} else
error = F_201 ( V_126 , V_356 , V_357 , V_358 -> V_74 ,
& V_204 , & V_203 , V_347 ) ;
if ( error )
goto V_221;
if ( V_341 ) {
ASSERT ( F_10 ( V_341 ) -> V_199 == 0 ) ;
error = F_85 ( V_126 , V_341 ) ;
if ( error )
goto V_221;
error = F_118 ( V_126 , V_341 ) ;
if ( error )
goto V_221;
F_74 ( V_126 , V_341 , V_164 ) ;
F_10 ( V_341 ) -> V_354 &= ~ V_355 ;
}
F_82 ( V_126 , V_356 , V_220 | V_198 ) ;
F_74 ( V_126 , V_356 , V_164 ) ;
if ( V_361 )
...
int V_379 ;
int V_58 ;
V_301 = F_168 ( V_135 , F_153 ( V_135 , V_2 -> V_74 ) ) ;
V_293 = V_135 -> V_380 >> V_135 -> V_8 . V_381 ;
V_374 = V_293 * sizeof( T_3 * ) ;
V_375 = F_215 ( V_374 , V_382 | V_383 ) ;
if ( ! V_375 )
goto V_384;
V_373 = ~ ( ( ( V_135 -> V_380 >> V_135 -> V_8 . V_381 ) ) - 1 ) ;
V_372 = F_155 ( V_135 , V_2 -> V_74 ) & V_373 ;
F_176 () ;
V_377 = F_216 ( & V_301 -> V_326 , ( void * * ) V_375 ,
V_372 , V_293 ) ;
if ( V_377 == 0 )
goto V_385;
for ( V_58 = 0 ; V_58 < V_377 ; V_58 ++ ) {
V_376 = V_375 [ V_58 ] ;
if ( V_376 == V_2 )
continue;
F_179 ( & V_376 -> V_327 ) ;
...
if ( ( F_155 ( V_135 , V_376 -> V_74 ) & V_373 ) != V_372 ) {
F_181 ( & V_376 -> V_327 ) ;
break;
}
F_181 ( & V_376 -> V_327 ) ;
if ( F_183 ( V_376 ) && F_195 ( V_376 ) == 0 )
continue;
if ( ! F_17 ( V_376 , V_17 ) )
continue;
if ( ! F_48 ( V_376 ) ) {
...
error = F_158 ( V_135 , NULL , & V_2 -> V_277 , & V_268 , & V_297 , V_399 ,
0 ) ;
if ( error == - V_400 ) {
F_184 ( V_2 ) ;
return error ;
...
if ( error )
goto V_401;
error = F_217 ( V_2 , V_297 ) ;
if ( error )
goto V_401;
if ( F_226 ( V_297 ) )
F_227 ( V_135 , 0 ) ;
error = F_214 ( V_2 , V_297 ) ;
if ( error )
goto V_386;
* V_395 = V_297 ;
return 0 ;
...
ASSERT ( V_2 -> V_3 . V_18 != V_19 ||
V_2 -> V_3 . V_150 > F_225 ( V_2 , V_254 ) ) ;
ASSERT ( V_298 != NULL && V_298 -> V_329 != 0 ) ;
ASSERT ( V_2 -> V_3 . V_143 > 1 ) ;
V_268 = F_228 ( V_297 , V_2 -> V_277 . V_279 ) ;
if ( F_229 ( V_268 -> V_403 != F_230 ( V_404 ) ,
V_135 , V_405 , V_406 ) ) {
F_231 ( V_135 , V_407 ,
L_9 ,
V_260 , V_2 -> V_74 , F_232 ( V_268 -> V_403 ) , V_268 ) ;
goto V_401;
}
if ( F_72 ( F_10 ( V_2 ) -> V_144 ) ) {
if ( F_229 (
...
if ( F_229 ( V_2 -> V_3 . V_266 > V_135 -> V_8 . V_415 ,
V_135 , V_416 , V_417 ) ) {
F_231 ( V_135 , V_407 ,
L_14 ,
V_260 , V_2 -> V_74 , V_2 -> V_3 . V_266 , V_2 ) ;
goto V_401;
}
if ( V_2 -> V_3 . V_143 < 3 )
V_2 -> V_3 . V_418 ++ ;
if ( F_68 ( F_10 ( V_2 ) -> V_144 ) &&
V_2 -> V_3 . V_18 == V_410 &&
F_233 ( V_2 ) )
goto V_401;
F_234 ( V_2 , V_268 , V_298 -> V_320 . V_321 ) ;
if ( V_2 -> V_3 . V_418 == V_419 )
V_2 -> V_3 . V_418 = 0 ;
F_235 ( V_2 , V_268 , V_298 , V_254 ) ;
if ( F_52 ( V_2 ) )
F_235 ( V_2 , V_268 , V_298 , V_420 ) ;
F_163 ( V_135 , V_297 ) ;
V_298 -> V_328 = V_298 -> V_329 ;
V_298 -> V_329 = 0 ;
V_298 -> V_330 = 0 ;
...
F_175 ( V_135 -> V_318 , & V_298 -> V_319 ,
& V_298 -> V_320 . V_321 ) ;
F_185 ( V_297 , V_421 , & V_298 -> V_320 ) ;
F_160 ( V_135 , V_268 ) ;
ASSERT ( V_297 -> V_312 != NULL ) ;
ASSERT ( V_297 -> V_392 != NULL ) ;
return 0 ;
V_401:
return - V_394 ;
}
