...
if ( V_16 & ( V_188 | V_56 ) )
F_75 ( V_4 , - V_191 , V_183 ) ;
else if ( V_16 & ( V_189 | V_192 | V_193 | V_190 |
V_194 ) )
...
static int
F_101 ( struct V_3 * V_4 , struct V_158 * V_221 )
{
int V_7 ;
...
struct V_155 * V_255 = F_62 ( V_4 , V_129 ) ;
F_70 ( V_255 -> V_1 -> V_2 , V_129 -> V_170 , V_129 -> V_171 ,
F_61 ( V_4 , V_129 ) ) ;
V_129 -> V_172 = 0 ;
}
}
static void F_103 ( struct V_6 * V_5 , struct V_158 * V_138 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
...
if ( V_4 -> V_51 ) {
struct V_155 * V_255 = F_62 ( V_4 , V_138 -> V_129 ) ;
if ( F_90 ( V_4 , V_138 -> V_129 ,
& V_4 -> V_218 , V_255 ) )
V_138 -> V_129 -> V_172 = 0 ;
}
}
static void F_104 ( struct V_6 * V_5 , struct V_158 * V_221 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
int V_182 ;
F_94 ( V_4 -> V_150 ) ;
...
V_221 -> V_47 -> error = - V_256 ;
if ( V_221 -> V_129 )
V_221 -> V_129 -> error = - V_256 ;
V_221 -> V_47 -> V_257 = 0 ;
F_64 ( V_5 , V_221 ) ;
return;
} else if ( V_4 -> V_211 )
V_4 -> V_211 = 0 ;
F_105 ( V_4 -> V_138 != NULL ) ;
V_4 -> V_138 = V_221 ;
V_4 -> V_250 = F_41 ( V_4 -> V_65 ) ;
V_182 = F_101 ( V_4 , V_221 ) ;
if ( V_182 ) {
...
static void F_108 ( struct V_6 * V_5 , struct V_264 * V_265 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
if ( F_16 ( V_4 ) -> V_266 )
F_16 ( V_4 ) -> V_266 ( V_265 ) ;
}
static void F_109 ( struct V_6 * V_5 , int V_267 )
{
struct V_3 * V_4 = F_6 ( V_5 ) ;
T_1 V_48 , V_86 ;
unsigned long V_50 ;
...
{
int V_7 ;
if ( ! V_4 -> V_2 -> V_32 || ! V_4 -> V_270 )
return - V_31 ;
V_7 = F_111 ( V_4 -> V_2 , V_4 -> V_270 ) ;
if ( V_7 ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_59 ) ;
goto V_182;
}
if ( V_4 -> V_36 -> V_102 & V_271 ) {
struct V_272 * V_273 = F_112 ( V_4 -> V_2 ) ;
if ( ! V_273 ) {
V_7 = - V_31 ;
goto V_274;
}
if ( F_22 ( F_113 ( V_273 , V_275 ) ) ) {
F_84 ( V_4 -> V_2 , L_60 ) ;
F_114 ( V_273 ) ;
V_7 = - V_220 ;
goto V_274;
}
if ( F_22 ( F_113 ( V_273 , V_276 ) ) ) {
F_84 ( V_4 -> V_2 , L_61 ) ;
F_114 ( V_273 ) ;
V_7 = - V_220 ;
goto V_274;
...
V_277 = F_33 ( V_4 -> V_43 , V_84 ) & ~ V_278 ;
F_32 ( V_4 -> V_43 , V_84 , V_277 | V_98 ) ;
V_277 = F_33 ( V_4 -> V_43 , V_82 ) ;
F_32 ( V_4 -> V_43 , V_82 , V_277 | V_99 ) ;
F_79 ( V_4 ) ;
}
...
static int F_118 ( struct V_281 * V_282 , void * V_129 )
{
struct V_6 * V_5 = V_282 -> V_283 ;
struct V_3 * V_4 = F_6 ( V_5 ) ;
F_119 ( V_282 , L_63 , V_5 -> V_284 ) ;
F_119 ( V_282 , L_64 ,
...
static int F_124 ( struct V_286 * V_286 , struct V_287 * V_287 )
{
return F_125 ( V_287 , F_118 , V_286 -> V_288 ) ;
}
static void F_126 ( struct V_6 * V_5 )
{
if ( V_5 -> V_289 )
F_127 ( L_79 , V_290 , V_5 -> V_289 ,
V_5 , & V_291 ) ;
}
static void F_126 ( struct V_6 * V_5 )
{
}
static struct V_35 * F_128 ( struct V_1 * V_2 )
{
struct V_35 * V_36 , * V_292 ;
struct V_293 * V_294 = V_2 -> V_32 ;
V_36 = F_129 ( V_2 , sizeof( * V_36 ) , V_295 ) ;
if ( ! V_36 )
return F_130 ( - V_296 ) ;
V_292 = F_131 ( V_2 ) ;
if ( V_292 && V_292 -> V_127 )
V_36 -> V_127 = V_292 -> V_127 ;
if ( F_132 ( V_294 , L_80 , NULL ) )
V_36 -> V_102 |= V_103 ;
V_36 -> V_40 = - V_220 ;
V_36 -> V_37 = - V_220 ;
V_36 -> V_42 = - V_220 ;
if ( F_132 ( V_294 , L_81 , NULL ) ) {
V_36 -> V_297 = true ;
V_36 -> V_34 = true ;
}
if ( F_132 ( V_294 , L_82 , NULL ) )
V_36 -> V_77 |= V_180 ;
if ( F_132 ( V_294 , L_83 , NULL ) )
V_36 -> V_77 |= V_78 ;
return V_36 ;
}
...
static int F_133 ( struct V_298 * V_299 )
{
struct V_35 * V_36 = V_299 -> V_2 . V_300 ;
struct V_6 * V_5 ;
struct V_3 * V_4 = NULL ;
struct V_301 * V_174 ;
int V_7 , V_117 ;
const struct V_302 * V_303 ;
const struct V_304 * V_129 ;
void T_6 * V_43 ;
V_303 = F_134 ( F_135 ( V_305 ) , & V_299 -> V_2 ) ;
if ( V_303 ) {
V_36 = F_128 ( & V_299 -> V_2 ) ;
if ( F_22 ( V_36 ) )
return F_23 ( V_36 ) ;
if ( V_303 -> V_129 ) {
V_129 = V_303 -> V_129 ;
V_36 -> V_306 = V_129 -> V_306 ;
...
V_174 = F_136 ( V_299 , V_308 , 0 ) ;
V_117 = F_137 ( V_299 , 0 ) ;
if ( V_174 == NULL || V_117 < 0 )
return - V_307 ;
V_43 = F_138 ( & V_299 -> V_2 , V_174 ) ;
if ( F_22 ( V_43 ) )
return F_23 ( V_43 ) ;
V_5 = F_139 ( sizeof( struct V_3 ) , & V_299 -> V_2 ) ;
if ( ! V_5 ) {
V_7 = - V_296 ;
goto V_182;
}
...
V_4 -> V_159 = - 1 ;
V_4 -> V_117 = V_117 ;
V_4 -> V_227 = V_174 -> V_310 + V_36 -> V_306 ;
V_4 -> V_43 = V_43 + V_36 -> V_306 ;
V_4 -> V_104 = V_105 ;
V_4 -> V_218 . V_219 = 1 ;
V_4 -> V_23 = 0 ;
V_4 -> V_14 = 0 ;
...
F_141 ( V_299 , V_4 ) ;
if ( V_299 -> V_2 . V_32 )
V_4 -> V_270 = F_142 ( V_299 -> V_2 . V_32 , 1 ) ;
V_5 -> V_312 = & V_313 ;
V_5 -> V_314 = V_315 ;
if ( V_36 -> V_316 > 0 )
V_5 -> V_317 = V_36 -> V_316 ;
else if ( V_5 -> V_317 == 0 )
V_5 -> V_317 = V_318 ;
F_143 ( & V_4 -> V_57 ) ;
V_4 -> V_65 = F_144 ( & V_299 -> V_2 , L_85 ) ;
if ( F_22 ( V_4 -> V_65 ) ) {
V_7 = F_23 ( V_4 -> V_65 ) ;
V_4 -> V_65 = NULL ;
goto V_309;
}
if ( V_4 -> V_36 -> V_102 & V_319 ) {
F_84 ( & V_299 -> V_2 , L_86 ) ;
V_313 . V_320 = F_117 ;
}
F_145 ( & V_299 -> V_2 , true ) ;
F_146 ( V_4 -> V_2 ) ;
F_120 ( V_4 -> V_2 ) ;
F_147 ( V_4 -> V_2 , V_321 ) ;
F_148 ( V_4 -> V_2 ) ;
F_50 ( V_4 ) ;
V_4 -> V_209 = F_144 ( & V_299 -> V_2 , L_87 ) ;
if ( F_22 ( V_4 -> V_209 ) ) {
V_4 -> V_209 = NULL ;
...
V_5 -> V_323 = 512 ;
V_5 -> V_324 = 0xFFFF ;
V_5 -> V_325 = V_5 -> V_323 * V_5 -> V_324 ;
V_5 -> V_326 = V_5 -> V_325 ;
V_5 -> V_111 |= V_327 | V_328 |
V_329 | V_330 ;
...
if ( F_16 ( V_4 ) -> V_297 )
V_5 -> V_111 |= V_333 ;
V_5 -> V_334 |= F_16 ( V_4 ) -> V_334 ;
F_116 ( V_4 ) ;
V_4 -> V_157 = F_149 ( & V_299 -> V_2 , L_89 ) ;
if ( F_22 ( V_4 -> V_157 ) ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_90 ) ;
V_7 = F_23 ( V_4 -> V_157 ) ;
goto V_335;
}
V_4 -> V_156 = F_149 ( & V_299 -> V_2 , L_91 ) ;
if ( F_22 ( V_4 -> V_156 ) ) {
F_9 ( F_10 ( V_4 -> V_5 ) , L_92 ) ;
V_7 = F_23 ( V_4 -> V_156 ) ;
goto V_335;
}
V_7 = F_150 ( & V_299 -> V_2 , V_4 -> V_117 , F_77 , 0 ,
F_59 ( V_5 ) , V_4 ) ;
if ( V_7 ) {
...
static int F_160 ( struct V_298 * V_299 )
{
struct V_3 * V_4 = F_161 ( V_299 ) ;
F_120 ( V_4 -> V_2 ) ;
F_153 ( V_4 -> V_5 ) ;
F_155 ( V_4 -> V_156 ) ;
F_155 ( V_4 -> V_157 ) ;
...
F_32 ( V_4 -> V_43 , V_60 , 0 ) ;
F_32 ( V_4 -> V_43 , V_63 , 0 ) ;
if ( ! ( F_33 ( V_4 -> V_43 , V_285 ) & F_166 ( 1 ) ) ) {
F_24 ( V_2 , L_95 ) ;
F_32 ( V_4 -> V_43 , V_58 , V_59 ) ;
