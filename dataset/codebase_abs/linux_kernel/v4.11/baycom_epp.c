...
{
struct V_3 * V_4 = F_21 ( V_59 ) ;
struct V_63 * V_64 = F_40 ( V_59 -> V_126 ) ;
...
static int F_52 ( struct V_3 * V_4 , const char * V_140 )
{
const char * V_80 ;
...
static int F_54 ( struct V_79 * V_59 , struct V_141 * V_142 , int V_143 )
{
struct V_3 * V_4 = F_21 ( V_59 ) ;
struct V_144 V_145 ;
if ( V_143 != V_146 )
return - V_147 ;
if ( F_55 ( & V_145 , V_142 -> V_148 , sizeof( V_145 ) ) )
return - V_149 ;
switch ( V_145 . V_143 ) {
default:
return - V_147 ;
...
break;
case V_177 :
if ( ! F_56 ( V_152 ) || F_57 ( V_59 ) )
return - V_153 ;
V_145 . V_31 . V_176 [ sizeof( V_145 . V_31 . V_176 ) - 1 ] = '\0' ;
return F_52 ( V_4 , V_145 . V_31 . V_176 ) ;
case V_178 :
...
if ( F_58 ( V_142 -> V_148 , & V_145 , sizeof( V_145 ) ) )
return - V_149 ;
return 0 ;
}
...
if ( V_201 && F_52 ( F_21 ( V_59 ) , V_207 [ V_66 ] ) )
V_201 = 0 ;
V_208 [ V_66 ] = V_59 ;
V_200 ++ ;
}
...
static int T_3 F_67 ( char * V_210 )
{
static unsigned T_5 V_211 = 0 ;
int V_212 [ 2 ] ;
if ( V_211 >= V_203 )
return 0 ;
V_210 = F_68 ( V_210 , 2 , V_212 ) ;
if ( V_212 [ 0 ] < 1 )
return 0 ;
V_207 [ V_211 ] = V_210 ;
V_156 [ V_211 ] = V_212 [ 1 ] ;
