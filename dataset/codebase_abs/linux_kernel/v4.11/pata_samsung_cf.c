...
static unsigned int F_24 ( struct V_78 * V_79 ,
unsigned char * V_80 , unsigned int V_81 , int V_82 )
{
struct V_20 * V_21 = V_79 -> V_83 -> V_84 -> V_21 ;
struct V_9 * V_10 = V_21 -> V_24 -> V_25 ;
void T_1 * V_85 = V_21 -> V_46 . V_85 ;
unsigned int V_86 = V_81 >> 1 , V_87 ;
T_5 * V_88 = ( T_5 * ) V_80 ;
if ( V_82 == V_89 )
for ( V_87 = 0 ; V_87 < V_86 ; V_87 ++ , V_88 ++ ) {
F_10 ( V_10 ) ;
( void ) F_25 ( V_85 ) ;
F_10 ( V_10 ) ;
* V_88 = F_25 ( V_10 -> V_29
...
if ( V_70 != 0 )
V_90 |= V_92 ;
F_13 ( V_21 -> V_24 , V_90 , V_21 -> V_46 . V_71 ) ;
F_21 ( V_21 ) ;
}
...
static int F_30 ( struct V_93 * V_84 ,
unsigned long V_94 )
{
int V_95 ;
F_31 ( V_84 -> V_21 , V_96 ) ;
...
F_34 ( 20 ) ;
F_13 ( V_21 -> V_24 , V_21 -> V_50 | V_97 , V_46 -> V_52 ) ;
F_34 ( 20 ) ;
F_13 ( V_21 -> V_24 , V_21 -> V_50 , V_46 -> V_52 ) ;
V_21 -> V_51 = V_21 -> V_50 ;
return F_30 ( & V_21 -> V_84 , V_94 ) ;
}
static int F_35 ( struct V_93 * V_84 , unsigned int * V_98 ,
unsigned long V_94 )
{
struct V_20 * V_21 = V_84 -> V_21 ;
unsigned int V_99 = 0 ;
int V_95 ;
T_2 V_100 ;
if ( F_29 ( V_21 , 0 ) )
...
static void F_39 ( void T_1 * V_1 , bool V_102 )
{
T_3 V_41 = F_2 ( V_1 + V_103 ) ;
V_41 = V_102 ? ( V_41 | 1 ) : ( V_41 & ~ 1 ) ;
F_3 ( V_41 , V_1 + V_103 ) ;
}
static T_6 F_40 ( int V_104 , void * V_105 )
{
struct V_39 * V_24 = V_105 ;
struct V_9 * V_10 = V_24 -> V_25 ;
T_3 V_3 ;
V_3 = F_2 ( V_10 -> V_29 + V_106 ) ;
F_3 ( V_3 , V_10 -> V_29 + V_106 ) ;
return F_41 ( V_104 , V_105 ) ;
}
...
F_39 ( V_10 -> V_29 , true ) ;
F_43 ( 100 ) ;
F_3 ( 0x1f , V_10 -> V_29 + V_106 ) ;
F_3 ( 0x1b , V_10 -> V_29 + V_112 ) ;
break;
case V_113 :
F_1 ( V_10 -> V_29 , 0 ) ;
F_39 ( V_10 -> V_29 , true ) ;
F_43 ( 100 ) ;
F_3 ( 0x3f , V_10 -> V_29 + V_106 ) ;
F_3 ( 0x3f , V_10 -> V_29 + V_112 ) ;
break;
default:
F_44 () ;
}
}
static int T_7 F_45 ( struct V_114 * V_115 )
{
struct V_107 * V_108 = F_46 ( & V_115 -> V_83 ) ;
struct V_70 * V_83 = & V_115 -> V_83 ;
struct V_9 * V_10 ;
struct V_116 * V_117 ;
struct V_20 * V_21 ;
struct V_39 * V_24 ;
enum V_118 V_109 ;
int V_119 ;
V_109 = F_47 ( V_115 ) -> V_120 ;
V_10 = F_48 ( V_83 , sizeof( * V_10 ) , V_121 ) ;
if ( ! V_10 ) {
F_27 ( V_83 , L_3 ) ;
return - V_122 ;
}
V_10 -> V_104 = F_49 ( V_115 , 0 ) ;
V_117 = F_50 ( V_115 , V_123 , 0 ) ;
V_10 -> V_29 = F_51 ( V_83 , V_117 ) ;
if ( F_52 ( V_10 -> V_29 ) )
return F_53 ( V_10 -> V_29 ) ;
V_10 -> V_31 = F_54 ( & V_115 -> V_83 , L_4 ) ;
if ( F_52 ( V_10 -> V_31 ) ) {
F_27 ( V_83 , L_5 ) ;
V_119 = F_53 ( V_10 -> V_31 ) ;
V_10 -> V_31 = NULL ;
return V_119 ;
}
F_55 ( V_10 -> V_31 ) ;
...
V_21 -> V_46 . V_132 = V_10 -> V_29 + V_133 ;
V_21 -> V_46 . V_85 = V_10 -> V_29 + V_134 ;
V_21 -> V_46 . V_72 = V_10 -> V_29 + V_135 ;
V_21 -> V_46 . V_55 = V_10 -> V_29 + V_135 ;
V_21 -> V_46 . V_57 = V_10 -> V_29 + V_136 ;
V_21 -> V_46 . V_59 = V_10 -> V_29 + V_137 ;
V_21 -> V_46 . V_61 = V_10 -> V_29 + V_138 ;
V_21 -> V_46 . V_63 = V_10 -> V_29 + V_139 ;
V_21 -> V_46 . V_71 = V_10 -> V_29 + V_140 ;
V_21 -> V_46 . V_76 = V_10 -> V_29 + V_141 ;
V_21 -> V_46 . V_75 = V_10 -> V_29 + V_141 ;
V_21 -> V_46 . V_77 = V_10 -> V_29 + V_142 ;
V_21 -> V_46 . V_52 = V_10 -> V_29 + V_142 ;
F_57 ( V_21 , L_8 ,
( unsigned long long ) V_117 -> V_143 ) ;
V_24 -> V_25 = V_10 ;
if ( V_108 && V_108 -> V_144 )
V_108 -> V_144 () ;
F_42 ( V_10 , V_108 ) ;
F_58 ( V_115 , V_24 ) ;
V_119 = F_59 ( V_24 , V_10 -> V_104 ,
V_10 -> V_104 ? F_40 : NULL ,
0 , & V_145 ) ;
if ( V_119 )
goto V_124;
return 0 ;
...
static int T_8 F_61 ( struct V_114 * V_115 )
{
struct V_39 * V_24 = F_62 ( V_115 ) ;
struct V_9 * V_10 = V_24 -> V_25 ;
F_63 ( V_24 ) ;
F_60 ( V_10 -> V_31 ) ;
return 0 ;
}
static int F_64 ( struct V_70 * V_83 )
{
struct V_114 * V_115 = F_65 ( V_83 ) ;
struct V_39 * V_24 = F_62 ( V_115 ) ;
return F_66 ( V_24 , V_146 ) ;
}
static int F_67 ( struct V_70 * V_83 )
{
struct V_114 * V_115 = F_65 ( V_83 ) ;
struct V_39 * V_24 = F_62 ( V_115 ) ;
struct V_107 * V_108 = F_46 ( & V_115 -> V_83 ) ;
