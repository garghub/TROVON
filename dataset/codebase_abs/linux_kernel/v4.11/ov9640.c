...
if ( ! V_5 )
V_5 = F_1 ( V_2 , V_137 , & V_132 ) ;
if ( ! V_5 )
V_5 = F_1 ( V_2 , V_138 , & V_133 ) ;
if ( V_5 )
goto V_139;
switch ( F_30 ( V_130 , V_131 ) ) {
case V_140 :
V_134 = L_8 ;
V_28 -> V_141 = 2 ;
break;
...
break;
default:
F_3 ( & V_2 -> V_16 , L_9 , V_130 , V_131 ) ;
V_5 = - V_143 ;
goto V_139;
}
F_31 ( & V_2 -> V_16 , L_10 ,
V_134 , V_130 , V_131 , V_132 , V_133 ) ;
V_5 = F_32 ( & V_28 -> V_30 ) ;
V_139:
F_13 ( & V_28 -> V_31 , 0 ) ;
return V_5 ;
...
struct V_1 * V_2 = F_10 ( V_23 ) ;
struct V_43 * V_44 = F_14 ( V_2 ) ;
V_108 -> V_10 = V_145 | V_146 |
V_147 | V_148 |
V_149 ;
V_108 -> type = V_150 ;
V_108 -> V_10 = F_34 ( V_44 , V_108 ) ;
return 0 ;
}
...
V_28 = F_36 ( & V_2 -> V_16 , sizeof( struct V_27 ) , V_153 ) ;
if ( ! V_28 ) {
F_3 ( & V_2 -> V_16 ,
L_12 ) ;
return - V_154 ;
}
F_37 ( & V_28 -> V_31 , V_2 , & V_155 ) ;
F_38 ( & V_28 -> V_30 , 2 ) ;
F_39 ( & V_28 -> V_30 , & V_156 ,
V_33 , 0 , 1 , 1 , 0 ) ;
F_39 ( & V_28 -> V_30 , & V_156 ,
V_36 , 0 , 1 , 1 , 0 ) ;
V_28 -> V_31 . V_157 = & V_28 -> V_30 ;
if ( V_28 -> V_30 . error )
