...
static int F_49 ( struct V_10 * V_10 , T_1 V_66 )
{
struct V_3 * V_4 = F_17 ( V_10 -> V_29 -> V_30 ) ;
enum V_27 V_67 ;
switch ( V_66 ) {
...
static T_4 F_53 ( T_1 V_79 )
{
return ( V_79 * 4 ) ;
}
static T_4 F_54 ( T_1 V_79 , T_5 V_80 )
{
F_55 ( V_80 != 0 ,
L_3 ) ;
return 0x80 ;
}
static T_4 F_56 ( T_1 V_79 , T_5 V_80 )
{
return V_81 + V_80 ;
}
static T_1 F_57 ( const void T_3 * V_82 , unsigned V_80 )
{
struct V_3 * V_4 ;
if ( V_82 == V_49 -> V_13 ) {
switch ( V_80 ) {
...
static void F_58 ( void T_3 * V_82 , unsigned V_80 , T_1 V_106 )
{
if ( V_82 == V_49 -> V_13 ) {
switch ( V_80 ) {
case V_36 :
...
static T_5 F_60 ( const void T_3 * V_82 , unsigned V_80 )
{
if ( V_82 == V_49 -> V_13 ) {
switch ( V_80 ) {
case V_107 :
...
static void F_61 ( void T_3 * V_82 , unsigned V_80 , T_5 V_106 )
{
if ( V_82 == V_49 -> V_13 ) {
switch ( V_80 ) {
case V_107 :
...
int V_48 ;
if ( ! V_127 ) {
F_50 ( & V_121 -> V_58 , L_13 ) ;
return - V_74 ;
}
V_4 = F_63 ( & V_121 -> V_58 , sizeof( * V_4 ) , V_129 ) ;
if ( ! V_4 )
return - V_130 ;
memset ( & V_123 , 0 , sizeof( V_123 ) ) ;
switch ( F_64 ( & V_121 -> V_58 ) ) {
...
V_4 -> V_51 = F_67 ( & V_121 -> V_58 , NULL ) ;
if ( F_68 ( V_4 -> V_51 ) ) {
F_50 ( & V_121 -> V_58 , L_19 ,
F_69 ( V_4 -> V_51 ) ) ;
return F_69 ( V_4 -> V_51 ) ;
}
if ( F_3 ( V_53 , & V_4 -> V_8 ) ) {
V_4 -> V_54 = F_70 ( & V_121 -> V_58 , NULL ) ;
if ( F_68 ( V_4 -> V_54 ) ) {
if ( F_69 ( V_4 -> V_54 ) == - V_146 )
return - V_146 ;
F_50 ( & V_121 -> V_58 , L_20 ,
F_69 ( V_4 -> V_54 ) ) ;
return F_69 ( V_4 -> V_54 ) ;
}
}
V_4 -> V_59 = F_71 ( & V_121 -> V_58 , 0 ) ;
if ( F_68 ( V_4 -> V_59 ) ) {
if ( F_69 ( V_4 -> V_59 ) == - V_146 )
return - V_146 ;
F_50 ( & V_121 -> V_58 , L_21 ) ;
return F_69 ( V_4 -> V_59 ) ;
}
V_4 -> V_25 = F_72 ( & V_121 -> V_58 , L_22 ) ;
if ( F_68 ( V_4 -> V_25 ) ) {
if ( F_69 ( V_4 -> V_25 ) == - V_146 )
return - V_146 ;
F_50 ( & V_121 -> V_58 , L_23 ,
F_69 ( V_4 -> V_25 ) ) ;
return F_69 ( V_4 -> V_25 ) ;
}
V_4 -> V_147 = F_73 () ;
if ( F_68 ( V_4 -> V_147 ) ) {
F_50 ( & V_121 -> V_58 , L_24 ,
F_69 ( V_4 -> V_147 ) ) ;
return F_69 ( V_4 -> V_147 ) ;
}
V_4 -> V_17 = F_74 ( & V_121 -> V_58 , V_148 ) ;
if ( F_68 ( V_4 -> V_17 ) ) {
V_48 = F_69 ( V_4 -> V_17 ) ;
F_50 ( & V_121 -> V_58 , L_25 , V_48 ) ;
goto V_149;
}
F_75 ( V_121 , V_4 ) ;
...
V_4 -> V_158 = F_76 ( & V_125 ) ;
if ( F_68 ( V_4 -> V_158 ) ) {
V_48 = F_69 ( V_4 -> V_158 ) ;
F_50 ( & V_121 -> V_58 , L_27 , V_48 ) ;
goto V_149;
}
return 0 ;
V_149:
