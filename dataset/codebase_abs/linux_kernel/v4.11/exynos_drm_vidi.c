...
static int F_44 ( struct V_28 * V_29 , struct V_28 * V_67 , void * V_41 )
{
struct V_1 * V_7 = F_20 ( V_29 ) ;
...
V_70 . V_76 = V_71 ;
V_70 . type = V_77 [ V_71 ] ;
V_36 = F_46 ( V_22 , & V_7 -> V_78 [ V_71 ] , V_71 ,
1 << V_7 -> V_26 , & V_70 ) ;
if ( V_36 )
return V_36 ;
}
V_68 = & V_7 -> V_78 [ V_79 ] ;
V_7 -> V_6 = F_47 ( V_22 , & V_68 -> V_17 ,
V_7 -> V_26 , V_80 ,
& V_81 , V_7 ) ;
if ( F_48 ( V_7 -> V_6 ) ) {
F_37 ( L_13 ) ;
...
static void F_54 ( struct V_28 * V_29 , struct V_28 * V_67 , void * V_41 )
{
struct V_1 * V_7 = F_20 ( V_29 ) ;
F_55 ( & V_7 -> V_10 ) ;
}
...
struct V_1 * V_7 ;
int V_36 ;
V_7 = F_57 ( & V_87 -> V_29 , sizeof( * V_7 ) , V_58 ) ;
if ( ! V_7 )
return - V_47 ;
V_7 -> V_87 = V_87 ;
F_58 ( & V_7 -> V_10 , F_17 , ( unsigned long ) V_7 ) ;
F_59 ( & V_7 -> V_20 ) ;
F_60 ( V_87 , V_7 ) ;
V_36 = F_61 ( & V_87 -> V_29 , & V_88 ) ;
if ( V_36 < 0 ) {
F_37 ( L_16 ) ;
return V_36 ;
}
V_36 = F_62 ( & V_87 -> V_29 , & V_89 ) ;
if ( V_36 )
goto V_90;
return V_36 ;
V_90:
