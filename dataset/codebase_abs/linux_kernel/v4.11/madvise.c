...
if ( ! F_80 ( V_7 ) )
return - V_26 ;
if ( ! F_81 ( V_7 , V_9 , V_10 ) ) {
* V_8 = NULL ;
F_82 ( & V_74 -> V_12 -> V_82 ) ;
V_7 = F_83 ( V_74 -> V_12 , V_9 ) ;
if ( ! V_7 )
return - V_34 ;
if ( V_9 < V_7 -> V_39 ) {
return - V_34 ;
...
static int F_91 ( int V_91 , unsigned long V_9 , unsigned long V_10 )
{
struct V_57 * V_92 ;
if ( ! F_92 ( V_93 ) )
return - V_94 ;
...
static long
F_101 ( struct V_6 * V_7 , struct V_6 * * V_8 ,
unsigned long V_9 , unsigned long V_10 , int V_1 )
{
switch ( V_1 ) {
case V_2 :
