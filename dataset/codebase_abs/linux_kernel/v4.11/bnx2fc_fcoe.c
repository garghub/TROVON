...
if ( F_271 ( V_7 ) )
V_205 = F_272 ( V_7 ) ;
if ( V_205 -> V_213 && V_205 -> V_213 -> V_443 ) {
memset ( & V_440 , 0 , sizeof( V_440 ) ) ;
V_205 -> V_213 -> V_443 ( V_205 , & V_440 ) ;
if ( strncmp ( V_440 . V_444 , L_93 , strlen ( L_93 ) ) ) {
...
V_37 -> V_326 -> V_454 ( V_37 -> V_326 , V_420 ) ;
F_200 ( V_37 ) ;
}
...
static void F_283 ( unsigned int V_455 )
{
struct V_149 * V_150 ;
struct V_456 * V_457 ;
V_150 = & F_284 ( V_458 , V_455 ) ;
V_457 = F_285 ( F_93 ,
( void * ) V_150 , F_286 ( V_455 ) ,
L_106 , V_455 ) ;
if ( F_287 ( ! F_288 ( V_457 ) ) ) {
F_289 ( V_457 , V_455 ) ;
V_150 -> V_459 = V_457 ;
F_71 ( V_457 ) ;
}
}
static void F_290 ( unsigned int V_455 )
{
struct V_149 * V_150 ;
struct V_456 * V_457 ;
struct V_151 * V_152 , * V_153 ;
...
static int F_292 ( unsigned int V_455 )
{
F_65 ( V_394 L_108 , V_455 ) ;
F_283 ( V_455 ) ;
return 0 ;
}
static int F_293 ( unsigned int V_455 )
{
F_65 ( V_394 L_109 , V_455 ) ;
F_290 ( V_455 ) ;
return 0 ;
}
static int F_294 ( struct V_460 * V_461 )
{
if ( ! V_462 )
return 0 ;
F_295 ( V_461 , V_462 ) ;
...
static T_9
F_311 ( struct V_187 * V_99 , struct V_475 * V_476 ,
char * V_294 )
{
...
struct V_5 * V_34 = F_2 ( V_3 ) ;
struct V_4 * V_35 = V_34 -> V_6 ;
sprintf ( V_294 , L_118 , V_35 -> V_448 ) ;
return strlen ( V_294 ) ;
}
static T_9
F_313 ( struct V_187 * V_99 ,
struct V_475 * V_476 , const char * V_294 , T_10 V_426 )
{
struct V_158 * V_159 = F_312 ( V_99 ) ;
struct V_2 * V_3 = F_102 ( V_159 ) ;
struct V_5 * V_34 = F_2 ( V_3 ) ;
struct V_4 * V_35 = V_34 -> V_6 ;
int V_477 , V_478 ;
V_477 = F_314 ( V_294 , 10 , & V_478 ) ;
if ( V_477 )
return V_477 ;
if ( V_478 > 255 )
return - V_479 ;
V_35 -> V_448 = ( T_1 ) V_478 ;
return strlen ( V_294 ) ;
}
