...
F_39 ( V_67 ) ;
V_28:
error = F_40 ( V_15 , & V_21 , V_97 , V_45 , V_18 ,
V_51 ? V_51 -> V_34 . V_59 : NULL ,
V_23 . V_98 , V_71 , error ) ;
V_79:
F_10 ( V_51 ) ;
F_10 ( V_15 ) ;
F_41 ( V_68 ) ;
...
struct V_66 * V_99 = F_31 ( V_65 -> V_73 ) ;
if ( ( V_99 -> V_15 == V_15 ) ||
( F_7 ( V_99 -> V_15 ) ) )
return;
V_11 -> V_100 = 0 ;
...
static char * F_47 ( const char * V_101 , const char * V_102 )
{
char * V_18 = F_48 ( strlen ( V_101 ) + strlen ( V_102 ) + 3 , V_103 ) ;
if ( V_18 )
sprintf ( V_18 , L_8 , V_101 , V_102 ) ;
return V_18 ;
}
...
int F_59 ( const char * V_47 , bool V_78 ,
bool V_107 , bool V_119 )
{
const struct V_73 * V_73 ;
struct V_6 * V_15 , * V_110 = NULL ;
struct V_14 V_21 = {} ;
const char * V_71 = NULL , * V_120 ;
int error = 0 ;
T_1 V_19 ;
if ( ! V_47 || ! * V_47 ) {
F_38 ( L_13 ) ;
...
V_110 = F_60 ( V_15 , V_47 , strlen ( V_47 ) ) ;
if ( ! V_110 ) {
V_71 = L_5 ;
error = - V_115 ;
if ( V_107 || ! F_36 ( V_15 ) )
goto V_28;
V_110 = F_37 ( V_15 , false , V_47 ,
V_103 ) ;
if ( ! V_110 ) {
V_71 = L_10 ;
error = - V_87 ;
...
V_21 = F_11 ( V_15 , V_110 -> V_17 , V_110 -> V_34 . V_59 ,
V_19 , V_15 -> V_31 . V_20 ) ;
if ( ! ( V_21 . V_25 & V_19 ) ) {
error = - V_85 ;
goto V_28;
...
V_28:
if ( ! V_107 )
error = F_40 ( V_15 , & V_21 , V_120 , V_19 , NULL ,
V_47 , V_118 , V_71 , error ) ;
F_10 ( V_110 ) ;
F_58 ( V_73 ) ;
return error ;
}
