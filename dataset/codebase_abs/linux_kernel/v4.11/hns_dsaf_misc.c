...
int F_41 ( struct V_8 * V_9 , int * V_99 )
{
union V_36 * V_37 ;
union V_36 V_38 , V_39 ;
V_38 . integer . type = V_40 ;
...
if ( ! V_37 || V_37 -> type != V_40 )
return - V_100 ;
* V_99 = V_37 -> integer . V_14 ;
F_18 ( V_37 ) ;
return 0 ;
}
static int F_42 ( struct V_8 * V_9 , bool V_103 )
{
const T_3 V_104 [] = {
0 ,
1 ,
...
#define F_43 ( T_5 , V_3 ) ((0x4080 + (reg) * 0x0002 + (lane) * 0x0200) * 2)
T_6 V_105 = F_43 ( V_104 [ V_9 -> V_17 ] , 0 ) ;
int V_99 ;
...
V_108 = F_5 ( V_9 -> V_107 , V_105 ) ;
F_11 ( V_108 , 1ull << 10 , 10 , V_103 ) ;
F_2 ( V_9 -> V_107 , V_105 , V_108 ) ;
} else {
T_3 * V_109 = ( T_3 * ) V_9 -> V_110 +
( V_9 -> V_17 <= 3 ? 0x00280000 : 0x00200000 ) ;
F_46 ( V_109 , V_105 , 1ull << 10 , 10 , V_103 ) ;
}
return 0 ;
}
static int
F_47 ( struct V_8 * V_9 , bool V_103 )
{
union V_36 * V_37 ;
union V_36 V_38 [ 3 ] , V_39 ;
V_38 [ 0 ] . integer . type = V_40 ;
...
struct V_113 * F_48 ( struct V_1 * V_2 )
{
struct V_113 * V_114 ;
V_114 = F_49 ( V_2 -> V_16 , sizeof( * V_114 ) , V_115 ) ;
if ( ! V_114 )
return NULL ;
if ( F_35 ( V_2 -> V_16 ) ) {
V_114 -> V_116 = F_7 ;
...
F_51 ( V_2 -> V_16 , ( void * ) V_114 ) ;
V_114 = NULL ;
}
return ( void * ) V_114 ;
}
static int F_52 ( struct V_127 * V_16 , void * V_126 )
{
return V_16 -> V_126 == V_126 ;
}
struct
V_128 * F_53 ( struct V_129 * V_126 )
{
struct V_127 * V_16 ;
V_16 = F_54 ( & V_130 , NULL ,
V_126 , F_52 ) ;
return V_16 ? F_55 ( V_16 ) : NULL ;
}
