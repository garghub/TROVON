...
V_180 = F_145 ( L_71 ) ;
if ( V_180 ) {
V_231 = F_146 ( V_180 , L_72 , NULL ) ;
if ( V_231 ) {
V_180 = F_145 ( V_231 ) ;
if ( V_180 ) {
V_231 = F_146 ( V_180 , L_42 , NULL ) ;
V_11 = F_138 ( V_231 ) ;
if ( V_11 )
V_11 -> V_73 |= V_232 ;
}
...
if ( ! V_11 )
return - V_15 ;
F_150 ( & V_11 -> V_203 , V_73 ) ;
V_159 = F_87 ( V_11 ) ;
F_151 ( & V_11 -> V_203 , V_73 ) ;
return V_159 ;
}
...
int F_154 ( struct V_10 * V_11 , unsigned long V_73 )
{
int V_75 = 0 ;
if ( V_73 & V_233 )
V_75 += F_50 ( V_11 ) ;
...
int F_155 ( struct V_10 * V_11 , struct V_236 * V_182 )
{
struct V_1 * V_83 ;
struct V_2 * V_3 ;
int V_4 , V_118 , V_237 , V_238 , V_239 ;
int V_159 = 0 ;
V_237 = F_50 ( V_11 ) ;
for ( V_4 = 0 ; V_4 < V_237 ; V_4 ++ ) {
unsigned int V_105 ;
if ( V_11 -> V_240 )
V_105 = V_11 -> V_240 ( ( V_11 -> V_104 + V_4 ) -> V_105 ) ;
else
V_105 = ( V_11 -> V_104 + V_4 ) -> V_105 ;
( V_182 + V_159 ) -> V_14 = ( V_11 -> V_104 + V_4 ) -> V_14 ;
( V_182 + V_159 ) -> V_241 = V_105 ;
( V_182 + V_159 ) -> V_242 = V_105 ;
...
( V_182 + V_159 ) -> V_241 = ( V_11 -> V_108 + V_4 ) -> V_109 ;
( V_182 + V_159 ) -> V_242 = ( V_11 -> V_108 + V_4 ) -> V_109 ;
( V_182 + V_159 ) -> V_73 = V_234 ;
V_159 ++ ;
}
V_3 = V_11 -> V_84 . V_9 ;
V_4 = 0 ;
...
V_83 = F_1 ( & V_3 , & V_4 ) ;
V_239 = F_52 ( V_83 ) ;
for ( V_118 = 0 ; V_118 < V_239 ; V_118 ++ ) {
( V_182 + V_159 ) -> V_14 = ( V_83 -> V_112 + V_118 ) -> V_14 ;
( V_182 + V_159 ) -> V_241 = ( V_83 -> V_112 + V_118 ) -> V_113 ;
( V_182 + V_159 ) -> V_242 = ( V_83 -> V_112 + V_118 ) -> V_114 ;
( V_182 + V_159 ) -> V_73 = V_235 ;
V_159 ++ ;
}
}
return V_159 ;
}
int F_156 ( struct V_10 * V_11 , struct V_236 * V_182 )
{
int V_4 , V_238 ;
int V_159 = 0 ;
V_238 = F_51 ( V_11 ) ;
...
int F_157 ( struct V_10 * V_11 , unsigned int type ,
const char * V_14 , struct V_236 * V_243 )
{
int V_159 ;
...
struct V_244 * F_158 ( struct V_10 * V_11 )
{
struct V_67 * V_43 ;
struct V_1 * V_5 ;
struct V_65 * V_68 ;
...
void T_4 * F_159 ( struct V_10 * V_11 )
{
if ( ! V_11 )
return NULL ;
if ( V_11 -> V_20 & V_99 )
...
int F_162 ( struct V_10 * V_11 , const char * V_14 )
{
int V_75 ;
unsigned long V_73 ;
if ( ! V_11 )
...
int F_163 ( struct V_10 * V_11 , const char * V_14 )
{
int V_75 ;
unsigned long V_73 ;
if ( ! V_11 )
...
V_78 , V_245 ) ;
F_63 (temp_oh, &omap_hwmod_list, node) {
if ( ! strcmp ( V_136 -> V_12 -> V_14 , V_245 ) ) {
F_18 ( L_74 ,
V_78 , V_136 -> V_14 ) ;
...
int F_165 ( struct V_10 * V_11 , T_2 V_246 )
{
int V_75 ;
unsigned long V_73 ;
if ( ! V_11 )
...
const char * F_178 ( struct V_10 * V_11 )
{
if ( ! V_11 )
return NULL ;
return V_11 -> V_81 ;
