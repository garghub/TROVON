...
void F_106 ( int V_314 , long V_120 )
{
struct V_50 * V_51 = V_94 ;
struct V_1 * V_175 ;
if ( V_314 )
...
static inline void F_107 ( const struct V_315 * V_315 )
{
#ifdef F_14
struct V_1 * V_175 ;
struct V_30 * V_31 ;
...
if ( V_315 && F_2 ( ! F_108 ( & V_315 -> V_316 ) ) ) {
struct V_28 * V_29 ;
V_29 = F_109 ( V_315 ) ;
if ( V_29 ) {
...
F_136 ( V_204 ) ;
F_72 ( V_204 , L_55 ,
V_358 , V_60 , V_360 ? F_137 ( V_360 ) : L_56 ,
V_357 , V_93 , ! V_47 ) ;
F_138 ( V_360 ) ;
F_77 ( V_204 ) ;
}
...
const struct V_349 * V_253 )
{
struct V_1 * V_175 = V_94 -> V_1 ;
struct V_349 * V_31 = & V_175 -> V_249 . V_253 ;
if ( V_253 )
memcpy ( V_31 , V_253 , sizeof( struct V_349 ) ) ;
else
...
{
struct V_1 * V_175 = V_94 -> V_1 ;
V_175 -> V_296 = F_28 ( V_350 ) ;
V_175 -> V_297 = F_140 ( V_350 ) ;
V_175 -> V_298 = F_134 ( V_350 ) ;
V_175 -> V_299 = F_34 ( V_350 ) ;
F_39 ( V_350 , & V_175 -> V_300 ) ;
memcpy ( V_175 -> V_301 , V_350 -> V_202 , V_376 ) ;
}
int F_154 ( int V_377 , struct V_50 * V_350 )
{
struct V_294 * V_378 ;
struct V_50 * V_51 = V_94 ;
struct V_1 * V_2 = V_51 -> V_1 ;
T_2 V_43 = F_155 () , V_379 = F_134 ( V_350 ) ;
if ( F_50 ( V_350 ) &&
...
V_2 -> V_297 = F_140 ( V_350 ) ;
V_2 -> V_298 = V_379 ;
V_2 -> V_299 = F_34 ( V_350 ) ;
F_39 ( V_350 , & V_2 -> V_300 ) ;
memcpy ( V_2 -> V_301 , V_350 -> V_202 , V_376 ) ;
return 0 ;
}
...
V_391 -> V_317 . V_36 = V_175 -> V_193 ;
V_175 -> V_193 = ( void * ) V_391 ;
F_158 ( V_369 -> V_343 -> V_344 . V_190 , & V_393 ) ;
