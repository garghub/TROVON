...
& V_104 , sizeof( V_104 ) ) < 0 )
return - V_109 ;
V_85 = F_30 ( V_104 ) ;
F_9 ( L_15 , V_6 -> V_30 . V_25 , V_85 ) ;
V_2 -> V_95 = V_96 ;
F_13 ( V_2 , V_110 ,
V_85 , V_106 ) ;
return - V_106 ;
case V_111 :
return V_2 -> V_112 -> V_113 ( V_2 , V_4 ,
V_103 ) ;
case V_114 :
V_93 = V_2 -> V_112 -> V_115 ( V_2 , V_4 , V_103 ) ;
if ( V_93 < 0 )
return V_93 ;
V_93 = V_2 -> V_112 -> V_116 ( V_2 ) ;
if ( V_93 < 0 )
return V_93 ;
V_93 = V_2 -> V_112 -> V_117 ( V_2 ) ;
if ( V_93 < 0 )
return V_93 ;
F_14 ( & V_2 -> V_89 ) ;
F_14 ( & V_2 -> V_94 ) ;
...
void F_33 ( struct V_126 * V_127 )
{
struct V_1 * V_2 =
F_34 ( V_127 , struct V_1 , V_128 ) ;
struct V_3 * V_4 ;
T_4 V_85 = V_129 ;
int V_93 ;
F_35 ( V_2 ) ;
if ( F_36 ( V_130 , & V_2 -> V_131 ) )
F_31 ( V_2 ) ;
while ( ( V_4 = F_37 ( & V_2 -> V_132 ) ) ) {
F_38 ( V_4 , V_133 ) ;
