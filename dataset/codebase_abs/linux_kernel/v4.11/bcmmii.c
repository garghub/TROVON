...
{
struct V_9 * V_8 = F_2 ( V_7 ) ;
struct V_88 * V_89 = V_8 -> V_65 -> V_7 . V_90 ;
struct V_23 * V_24 ;
T_1 V_91 ;
int V_5 ;
V_91 = V_8 -> V_92 ;
...
struct V_6 * V_7 = V_2 -> V_8 ;
struct V_9 * V_8 = F_2 ( V_7 ) ;
struct V_88 * V_99 = V_8 -> V_100 ;
struct V_88 * V_101 = NULL ;
T_1 V_102 = 0 ;
int V_103 = 0 ;
if ( ! V_99 ) {
V_102 = 1 << V_8 -> V_104 ;
...
if ( V_102 & 1 << V_103 ) {
F_36 ( & V_7 -> V_7 , L_10 , V_103 ) ;
F_37 ( V_2 , V_103 , V_106 ) ;
}
}
return 0 ;
}
...
V_2 -> V_8 = V_8 -> V_7 ;
V_2 -> V_108 = L_12 ;
V_2 -> V_109 = & V_8 -> V_65 -> V_7 ;
V_2 -> V_110 = F_1 ;
V_2 -> V_111 = F_6 ;
V_2 -> V_112 = F_33 ;
snprintf ( V_2 -> V_113 , V_114 , L_13 ,
V_8 -> V_65 -> V_108 , V_8 -> V_65 -> V_113 ) ;
return 0 ;
}
static int F_40 ( struct V_9 * V_8 )
{
struct V_88 * V_89 = V_8 -> V_65 -> V_7 . V_90 ;
struct V_63 * V_64 = & V_8 -> V_65 -> V_7 ;
...
int V_117 ;
int V_5 ;
V_116 = F_41 ( V_118 , L_14 , V_8 -> V_119 ) ;
if ( ! V_116 )
return - V_107 ;
V_8 -> V_100 = F_42 ( V_89 , NULL , V_116 ) ;
F_43 ( V_116 ) ;
if ( ! V_8 -> V_100 ) {
F_26 ( V_64 , L_15 ) ;
return - V_94 ;
}
V_5 = F_44 ( V_8 -> V_1 , V_8 -> V_100 ) ;
if ( V_5 ) {
F_26 ( V_64 , L_16 ) ;
return V_5 ;
}
V_8 -> V_93 = F_45 ( V_89 , L_17 , 0 ) ;
if ( ! V_8 -> V_93 && F_46 ( V_89 ) ) {
V_5 = F_47 ( V_89 ) ;
if ( V_5 )
return V_5 ;
V_8 -> V_93 = F_48 ( V_89 ) ;
...
V_8 -> V_71 = V_117 ;
if ( V_117 < 0 ) {
V_5 = F_50 ( V_89 , L_18 , & V_115 ) ;
if ( V_5 < 0 ) {
F_26 ( V_64 , L_19 ) ;
return V_5 ;
}
V_8 -> V_71 = V_73 ;
if ( ! strcasecmp ( V_115 , L_20 ) )
V_8 -> V_70 = true ;
}
if ( V_117 == V_72 ) {
V_24 = F_51 ( V_89 ) ;
...
struct V_23 * V_24 ;
int V_5 ;
if ( V_122 -> V_71 != V_72 && V_122 -> V_124 ) {
if ( V_122 -> V_125 >= 0 && V_122 -> V_125 < V_105 )
