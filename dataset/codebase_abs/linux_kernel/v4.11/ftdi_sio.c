...
V_87 . V_37 = V_11 -> V_37 ;
V_87 . V_36 = V_11 -> V_36 ;
if ( F_25 ( V_86 , & V_87 , sizeof( * V_86 ) ) )
return - V_88 ;
return 0 ;
}
static int F_26 ( struct V_29 * V_30 ,
struct V_6 * V_7 , struct V_85 T_3 * V_89 )
{
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_85 V_90 ;
struct V_10 V_91 ;
if ( F_27 ( & V_90 , V_89 , sizeof( V_90 ) ) )
return - V_88 ;
F_28 ( & V_11 -> V_92 ) ;
V_91 = * V_11 ;
if ( ! F_29 ( V_93 ) ) {
...
V_11 -> V_33 = ( ( V_11 -> V_33 & ~ V_94 ) |
( V_90 . V_33 & V_94 ) ) ;
V_11 -> V_36 = V_90 . V_36 ;
goto V_96;
}
if ( V_90 . V_37 != V_11 -> V_37 ) {
F_30 ( & V_11 -> V_92 ) ;
return - V_97 ;
}
...
unsigned int T_3 * V_86 )
{
struct V_10 * V_11 = F_8 ( V_7 ) ;
unsigned int V_104 = 0 ;
if ( V_11 -> V_105 )
V_104 = V_106 ;
if ( F_25 ( V_86 , & V_104 , sizeof( unsigned int ) ) )
return - V_88 ;
return 0 ;
}
...
{
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_121 * V_26 = V_7 -> V_23 -> V_26 ;
struct V_122 * V_123 ;
unsigned V_124 ;
unsigned V_125 ;
V_124 = V_26 -> V_126 -> V_112 . V_127 ;
if ( ! V_124 )
return;
for ( V_125 = 0 ; V_125 < V_124 ; V_125 ++ ) {
V_123 = & V_26 -> V_126 -> V_128 [ V_125 ] . V_112 ;
if ( ! V_123 -> V_129 ) {
V_123 -> V_129 = F_35 ( 0x40 ) ;
F_36 ( & V_7 -> V_13 , L_18 ,
F_37 ( V_123 ) ) ;
}
}
V_11 -> V_130 = F_38 ( V_123 ) ;
}
static T_4 F_39 ( struct V_12 * V_13 ,
struct V_131 * V_132 , char * V_79 )
{
...
struct V_131 * V_132 , const char * V_133 , T_5 V_134 )
{
struct V_6 * V_7 = F_40 ( V_13 ) ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_72 * V_73 = V_7 -> V_23 -> V_13 ;
...
static int F_48 ( struct V_107 * V_23 ,
...
static int F_57 ( struct V_107 * V_23 )
{
struct V_72 * V_73 = V_23 -> V_13 ;
int V_75 = V_151 ;
if ( V_75 == 0 )
...
static int F_58 ( struct V_107 * V_23 )
{
struct V_72 * V_73 = V_23 -> V_13 ;
struct V_121 * V_26 = V_23 -> V_26 ;
...
int V_125 , V_164 , V_165 ;
V_134 = 0 ;
F_69 ( & V_7 -> V_166 , V_33 ) ;
for ( V_125 = 0 ; V_125 < V_162 - 1 ; V_125 += V_11 -> V_130 ) {
V_164 = F_70 ( int , V_162 - V_125 , V_11 -> V_130 ) - 1 ;
V_165 = F_71 ( & V_7 -> V_167 , & V_163 [ V_125 + 1 ] , V_164 ) ;
if ( ! V_165 )
break;
V_7 -> V_168 . V_169 += V_165 ;
V_163 [ V_125 ] = ( V_165 << 2 ) + 1 ;
V_134 += V_165 + 1 ;
}
F_72 ( & V_7 -> V_166 , V_33 ) ;
} else {
V_134 = F_73 ( & V_7 -> V_167 , V_161 , V_162 ,
& V_7 -> V_166 ) ;
V_7 -> V_168 . V_169 += V_134 ;
}
return V_134 ;
}
...
V_7 -> V_168 . V_191 ++ ;
F_79 ( V_7 ) ;
} else if ( V_170 [ 1 ] & V_192 ) {
V_172 = V_193 ;
V_7 -> V_168 . V_194 ++ ;
} else if ( V_170 [ 1 ] & V_195 ) {
V_172 = V_196 ;
V_7 -> V_168 . V_197 ++ ;
}
if ( V_170 [ 1 ] & V_198 ) {
V_7 -> V_168 . V_199 ++ ;
F_80 ( & V_7 -> V_7 , 0 , V_200 ) ;
}
}
V_7 -> V_168 . V_201 += V_164 ;
V_173 = V_170 + 2 ;
if ( V_7 -> V_7 . V_202 && V_7 -> V_203 ) {
for ( V_125 = 0 ; V_125 < V_164 ; V_125 ++ , V_173 ++ ) {
if ( ! F_81 ( V_7 , * V_173 ) )
...
int V_164 ;
int V_134 = 0 ;
for ( V_125 = 0 ; V_125 < V_204 -> V_208 ; V_125 += V_11 -> V_130 ) {
V_164 = F_70 ( int , V_204 -> V_208 - V_125 , V_11 -> V_130 ) ;
V_134 += F_74 ( V_7 , V_11 , & V_206 [ V_125 ] , V_164 ) ;
}
if ( V_134 )
F_84 ( & V_7 -> V_7 ) ;
}
...
{
struct V_6 * V_7 = V_30 -> V_210 ;
void T_3 * V_268 = ( void T_3 * ) V_267 ;
switch ( V_266 ) {
case V_269 :
return F_24 ( V_7 , V_268 ) ;
case V_270 :
return F_26 ( V_30 , V_7 , V_268 ) ;
case V_271 :
return F_31 ( V_7 , V_268 ) ;
default:
break;
}
return - V_272 ;
