...
struct V_43 * V_46 = (struct V_43 * ) ( V_124 + V_127 ) ;
if ( ! ( V_103 & ( 1 << V_69 ) ) )
continue;
...
static struct V_109 * F_67 ( const struct V_1 * V_88 )
{
unsigned int V_178 ;
struct V_109 * V_114 ;
...
const struct V_49 * V_56 ;
V_46 = (struct V_43 * ) ( V_183 + V_181 ) ;
if ( F_71 ( V_180 + V_181 , V_46 , sizeof( * V_46 ) ) ) {
V_12 = - V_184 ;
goto V_185;
}
if ( F_71 ( V_180 + V_181
+ F_72 ( struct V_43 , V_114 ) ,
& V_114 [ V_182 ] ,
...
if ( F_73 ( V_138 , V_180 + V_181 + V_170 ) ) {
V_12 = - V_184 ;
goto V_185;
}
}
V_56 = F_11 ( V_46 ) ;
if ( F_74 ( V_56 , V_180 + V_181 + V_46 -> V_48 ) ) {
V_12 = - V_184 ;
goto V_185;
}
}
...
static void F_76 ( void * V_21 , const void * V_17 )
{
int V_118 = * ( V_186 * ) V_17 ;
if ( V_118 > 0 )
V_118 += F_77 ( V_82 , V_118 ) ;
memcpy ( V_21 , & V_118 , sizeof( V_118 ) ) ;
}
static int F_78 ( void T_3 * V_21 , const void * V_17 )
{
V_186 V_187 = * ( int * ) V_17 ;
if ( V_187 > 0 )
V_187 -= F_77 ( V_82 , V_187 ) ;
return F_71 ( V_21 , & V_187 , sizeof( V_187 ) ) ? - V_184 : 0 ;
}
static int F_79 ( const struct V_43 * V_46 ,
...
F_30 (ematch, e)
V_181 += F_80 ( V_108 -> V_58 . V_59 . V_112 ) ;
V_56 = F_11 ( V_46 ) ;
V_181 += F_81 ( V_56 -> V_58 . V_59 . V_57 ) ;
V_123 -> V_133 -= V_181 ;
V_12 = F_82 ( V_82 , V_188 , V_181 ) ;
if ( V_12 )
return V_12 ;
for ( V_170 = 0 ; V_170 < V_126 ; V_170 ++ ) {
if ( V_2 -> V_79 [ V_170 ] &&
...
static int F_83 ( const struct V_74 * V_2 ,
struct V_74 * V_123 )
{
struct V_43 * V_77 ;
const void * V_183 ;
...
if ( ! V_123 || ! V_2 )
return - V_165 ;
memcpy ( V_123 , V_2 , F_72 ( struct V_74 , V_78 ) ) ;
V_123 -> V_190 = 0 ;
V_183 = V_2 -> V_78 ;
F_84 ( V_82 , V_2 -> V_137 ) ;
F_15 (iter, loc_cpu_entry, info->size) {
V_12 = F_79 ( V_77 , V_2 , V_183 , V_123 ) ;
if ( V_12 != 0 )
return V_12 ;
}
return 0 ;
}
static int F_85 ( struct V_68 * V_68 , void T_3 * V_131 ,
...
return - V_165 ;
if ( F_86 ( V_60 , V_131 , sizeof( V_60 ) ) != 0 )
return - V_184 ;
V_60 [ V_192 - 1 ] = '\0' ;
#ifdef F_87
if ( V_191 )
...
static int
F_94 ( struct V_68 * V_68 , struct V_195 T_3 * V_196 ,
const int * V_115 )
{
int V_12 ;
struct V_195 V_197 ;
...
static int
F_95 ( struct V_68 * V_68 , const char * V_60 , unsigned int V_103 ,
...
struct V_43 * V_77 ;
V_12 = 0 ;
V_114 = F_68 ( V_200 * sizeof( struct V_109 ) ) ;
if ( ! V_114 ) {
V_12 = - V_158 ;
goto V_72;
}
...
V_202 = F_96 ( V_56 , V_200 , V_123 , & V_12 ) ;
if ( ! V_202 )
goto V_204;
...
static int
F_99 ( struct V_68 * V_68 , const void T_3 * V_131 , unsigned int V_115 )
{
int V_12 ;
struct V_168 V_175 ;
struct V_74 * V_123 ;
void * V_183 ;
struct V_43 * V_77 ;
if ( F_86 ( & V_175 , V_131 , sizeof( V_175 ) ) != 0 )
return - V_184 ;
...
V_123 = F_100 ( V_175 . V_133 ) ;
if ( ! V_123 )
return - V_158 ;
V_183 = V_123 -> V_78 ;
if ( F_86 ( V_183 , V_131 + sizeof( V_175 ) ,
V_175 . V_133 ) != 0 ) {
V_12 = - V_184 ;
goto V_206;
}
...
if ( V_12 != 0 )
goto V_206;
V_12 = F_95 ( V_68 , V_175 . V_60 , V_175 . V_103 , V_123 ,
...
static int
F_101 ( struct V_68 * V_68 , const void T_3 * V_131 ,
...
struct V_43 * V_77 ;
unsigned int V_97 ;
V_209 = F_102 ( V_131 , V_115 , & V_175 , V_191 ) ;
if ( F_45 ( V_209 ) )
return F_46 ( V_209 ) ;
V_56 = F_90 ( V_68 , V_82 , V_175 . V_60 ) ;
if ( ! V_56 ) {
V_12 = - V_194 ;
goto free;
}
...
static int
F_103 ( struct V_43 * V_46 , void T_3 * * V_211 ,
...
int V_12 = 0 ;
V_213 = * V_133 ;
V_212 = (struct V_189 T_3 * ) * V_211 ;
if ( F_71 ( V_212 , V_46 , sizeof( struct V_43 ) ) != 0 ||
F_71 ( & V_212 -> V_114 , & V_114 [ V_170 ] ,
sizeof( V_114 [ V_170 ] ) ) != 0 )
return - V_184 ;
* V_211 += sizeof( struct V_189 ) ;
* V_133 -= sizeof( struct V_43 ) - sizeof( struct V_189 ) ;
F_30 (ematch, e) {
V_12 = F_104 ( V_108 , V_211 , V_133 ) ;
if ( V_12 != 0 )
return V_12 ;
}
V_48 = V_46 -> V_48 - ( V_213 - * V_133 ) ;
V_56 = F_12 ( V_46 ) ;
V_12 = F_105 ( V_56 , V_211 , V_133 ) ;
if ( V_12 )
return V_12 ;
V_85 = V_46 -> V_85 - ( V_213 - * V_133 ) ;
if ( F_106 ( V_48 , & V_212 -> V_48 ) != 0 ||
F_106 ( V_85 , & V_212 -> V_85 ) != 0 )
return - V_184 ;
return 0 ;
}
static int
F_107 ( struct V_107 * V_138 ,
...
static void F_108 ( struct V_189 * V_46 )
{
struct V_49 * V_56 ;
struct V_107 * V_108 ;
F_30 (ematch, e)
...
V_156 = 0 ;
F_30 (ematch, e) {
V_12 = F_107 ( V_108 , & V_46 -> V_6 , & V_181 ) ;
if ( V_12 != 0 )
goto V_215;
++ V_156 ;
}
...
static void
F_112 ( struct V_189 * V_46 , void * * V_211 ,
unsigned int * V_133 ,
...
* V_133 += sizeof( struct V_43 ) - sizeof( struct V_189 ) ;
F_30 (ematch, e)
F_113 ( V_108 , V_211 , V_133 ) ;
V_216 -> V_48 = V_46 -> V_48 - ( V_213 - * V_133 ) ;
V_56 = F_109 ( V_46 ) ;
V_57 = V_56 -> V_58 . V_59 . V_57 ;
F_114 ( V_56 , V_211 , V_133 ) ;
...
V_156 = 0 ;
F_88 ( V_82 ) ;
F_84 ( V_82 , V_220 -> V_171 ) ;
F_15 (iter0, entry0, compatr->size) {
V_12 = F_110 ( V_222 , V_2 , & V_133 ,
V_124 ,
V_124 + V_220 -> V_133 ) ;
if ( V_12 != 0 )
goto V_223;
...
static int
F_116 ( struct V_68 * V_68 , void T_3 * V_131 , unsigned int V_115 )
{
int V_12 ;
struct V_219 V_175 ;
struct V_74 * V_123 ;
...
V_12 = F_115 ( V_68 , & V_123 , & V_183 , & V_175 ) ;
if ( V_12 != 0 )
goto V_206;
V_12 = F_95 ( V_68 , V_175 . V_60 , V_175 . V_103 , V_123 ,
V_175 . V_200 , F_117 ( V_175 . V_114 ) ) ;
if ( V_12 )
goto V_207;
return 0 ;
V_207:
...
static int
F_118 ( struct V_224 * V_225 , int V_226 , void T_3 * V_131 ,
unsigned int V_115 )
{
int V_12 ;
if ( ! F_119 ( F_120 ( V_225 ) -> V_227 , V_228 ) )
return - V_229 ;
switch ( V_226 ) {
case V_230 :
V_12 = F_116 ( F_120 ( V_225 ) , V_131 , V_115 ) ;
break;
case V_231 :
V_12 = F_101 ( F_120 ( V_225 ) , V_131 , V_115 , 1 ) ;
break;
default:
V_12 = - V_165 ;
}
...
static int
F_121 ( unsigned int V_179 , struct V_1 * V_88 ,
void T_3 * V_180 )
{
struct V_109 * V_114 ;
const struct V_74 * V_75 = V_88 -> V_75 ;
...
static int
F_122 ( struct V_68 * V_68 , struct V_232 T_3 * V_196 ,
int * V_115 )
{
int V_12 ;
struct V_232 V_197 ;
...
static int
F_123 ( struct V_224 * V_225 , int V_226 , void T_3 * V_131 , int * V_115 )
{
int V_12 ;
if ( ! F_119 ( F_120 ( V_225 ) -> V_227 , V_228 ) )
return - V_229 ;
switch ( V_226 ) {
case V_233 :
V_12 = F_85 ( F_120 ( V_225 ) , V_131 , V_115 , 1 ) ;
break;
case V_234 :
V_12 = F_122 ( F_120 ( V_225 ) , V_131 , V_115 ) ;
break;
default:
V_12 = F_124 ( V_225 , V_226 , V_131 , V_115 ) ;
}
return V_12 ;
}
static int
F_125 ( struct V_224 * V_225 , int V_226 , void T_3 * V_131 , unsigned int V_115 )
{
int V_12 ;
if ( ! F_119 ( F_120 ( V_225 ) -> V_227 , V_228 ) )
return - V_229 ;
switch ( V_226 ) {
case V_230 :
V_12 = F_99 ( F_120 ( V_225 ) , V_131 , V_115 ) ;
break;
case V_231 :
V_12 = F_101 ( F_120 ( V_225 ) , V_131 , V_115 , 0 ) ;
break;
default:
V_12 = - V_165 ;
}
...
switch ( V_226 ) {
case V_233 :
V_12 = F_85 ( F_120 ( V_225 ) , V_131 , V_115 , 0 ) ;
break;
case V_234 :
V_12 = F_94 ( F_120 ( V_225 ) , V_131 , V_115 ) ;
break;
case V_235 :
case V_236 : {
struct V_237 V_238 ;
...
if ( F_86 ( & V_238 , V_131 , sizeof( V_238 ) ) != 0 ) {
V_12 = - V_184 ;
break;
}
...
if ( V_12 != 0 )
goto V_172;
V_245 = F_130 ( V_68 , V_88 , & V_244 , V_123 ) ;
if ( F_45 ( V_245 ) ) {
V_12 = F_46 ( V_245 ) ;
goto V_172;
}
F_131 ( * V_243 , V_245 ) ;
V_12 = F_132 ( V_68 , V_242 , F_133 ( V_88 -> V_103 ) ) ;
if ( V_12 != 0 ) {
F_127 ( V_68 , V_245 ) ;
* V_243 = NULL ;
}
...
{
F_135 ( V_68 , V_242 , F_133 ( V_88 -> V_103 ) ) ;
F_127 ( V_68 , V_88 ) ;
}
static inline bool
F_136 ( T_6 V_246 , T_6 V_247 , T_6 V_248 ,
T_6 type , T_6 V_249 ,
bool V_250 )
{
return ( ( V_246 == 0xFF ) ||
...
if ( V_40 -> V_98 != 0 )
return false ;
V_252 = F_138 ( V_38 , V_40 -> V_101 , sizeof( V_253 ) , & V_253 ) ;
if ( V_252 == NULL ) {
V_40 -> V_102 = true ;
return false ;
}
return F_136 ( V_255 -> type ,
V_255 -> V_249 [ 0 ] ,
V_255 -> V_249 [ 1 ] ,
V_252 -> type , V_252 -> V_249 ,
! ! ( V_255 -> V_35 & V_256 ) ) ;
}
static int F_139 ( const struct V_144 * V_40 )
{
const struct V_254 * V_255 = V_40 -> V_113 ;
...
if ( V_12 < 0 )
goto V_258;
V_12 = F_146 ( V_259 , F_147 ( V_259 ) ) ;
if ( V_12 < 0 )
goto V_260;
V_12 = F_148 ( V_261 , F_147 ( V_261 ) ) ;
if ( V_12 < 0 )
goto V_262;
V_12 = F_149 ( & V_263 ) ;
if ( V_12 < 0 )
...
return 0 ;
V_264:
F_151 ( V_261 , F_147 ( V_261 ) ) ;
V_262:
F_152 ( V_259 , F_147 ( V_259 ) ) ;
V_260:
F_153 ( & V_257 ) ;
V_258:
return V_12 ;
