...
static int F_23 ( struct V_1 * V_16 )
{
struct V_27 * V_28 = F_24 ( V_16 ) ;
...
static int F_34 ( struct V_32 * V_33 , struct V_34 * * V_35 )
{
struct V_27 * V_28 ;
struct V_36 * V_37 ;
struct V_29 * V_30 ;
...
~ V_42 )
return - V_43 ;
V_28 = F_36 ( sizeof( * V_28 ) + sizeof( * V_30 ) , V_44 ) ;
if ( ! V_28 )
return - V_45 ;
V_39 = F_37 ( V_35 , V_46 |
( V_37 -> type & V_42 ) ,
...
goto V_48;
V_30 = F_25 ( V_28 ) ;
V_9 = F_38 ( V_30 , V_39 , F_39 ( V_28 ) ,
V_47 ) ;
F_40 ( V_39 ) ;
if ( V_9 )
goto V_48;
V_9 = F_41 ( F_39 ( V_28 ) , L_1 , V_39 ) ;
if ( V_9 )
goto V_49;
