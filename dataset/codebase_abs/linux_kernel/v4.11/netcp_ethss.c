...
static inline int F_97 ( struct V_13 * V_13 , struct V_199 * V_245 )
{
return - V_203 ;
}
static inline int F_101 ( struct V_13 * V_13 , struct V_199 * V_245 )
{
return - V_203 ;
}
static int F_109 ( void * V_166 , struct V_199 * V_245 , int V_56 )
{
struct V_13 * V_13 = V_166 ;
...
switch ( V_56 ) {
case V_248 :
return F_97 ( V_13 , V_245 ) ;
case V_249 :
return F_101 ( V_13 , V_245 ) ;
}
}
if ( V_58 )
return F_110 ( V_58 , V_245 , V_56 ) ;
return - V_203 ;
}
static void F_111 ( unsigned long V_250 )
{
...
static int F_116 ( int V_255 , void * V_17 , struct V_180 * V_181 )
{
...
F_63 ( V_19 -> V_149 , L_6 ,
F_119 ( V_257 ) , F_120 ( V_257 ) ,
F_121 ( V_257 ) , F_122 ( V_257 ) ) ;
...
F_15 ( V_19 -> V_268 , F_14 ( V_19 , V_39 ,
V_40 ) ) ;
V_60 = F_58 ( V_13 ) ;
if ( V_60 )
goto V_269;
F_123 ( V_10 , V_270 , F_116 , V_13 ) ;
F_124 ( V_10 , V_271 , F_117 , V_13 ) ;
V_61 -> V_115 = true ;
F_37 ( V_19 , V_61 , V_2 ) ;
F_105 ( V_19 ) ;
return 0 ;
...
F_107 ( V_19 ) ;
F_51 ( V_13 ) ;
F_126 ( V_10 , V_271 , F_117 , V_13 ) ;
F_127 ( V_10 , V_270 , F_116 , V_13 ) ;
V_13 -> V_61 -> V_115 = false ;
F_128 ( & V_13 -> V_61 -> V_124 , V_272 ) ;
return 0 ;
}
...
V_61 -> V_97 = V_19 -> V_39 + V_278 +
( V_280 * V_277 ) ;
V_61 -> V_110 = V_19 -> V_39 + V_279 +
( V_281 * V_61 -> V_101 ) ;
if ( V_19 -> V_53 == V_54 ) {
...
bool V_295 = false ;
F_138 (node, port) {
V_61 = F_139 ( V_149 , sizeof( * V_61 ) , V_296 ) ;
if ( ! V_61 ) {
F_62 ( V_149 ,
L_14 ,
V_62 -> V_297 ) ;
...
F_141 ( & V_61 -> V_298 , & V_19 -> V_299 ) ;
V_19 -> V_300 ++ ;
if ( ( V_61 -> V_116 == V_117 ) ||
( V_61 -> V_116 == V_118 ) )
V_295 = true ;
V_61 -> V_115 = true ;
if ( V_19 -> V_300 >= V_19 -> V_301 ) {
F_142 ( V_62 ) ;
break;
}
}
if ( ! V_295 )
return;
V_19 -> V_302 = F_143 ( sizeof( V_19 ) , L_16 ,
V_303 , V_304 ) ;
if ( ! V_19 -> V_302 ) {
F_62 ( V_149 ,
L_17 ) ;
...
V_307 = F_151 ( V_19 -> V_149 , & V_306 ) ;
if ( F_152 ( V_307 ) ) {
F_62 ( V_19 -> V_149 , L_20 ) ;
return F_153 ( V_307 ) ;
}
V_19 -> V_136 = V_307 ;
V_60 = F_150 ( V_276 , V_309 , & V_306 ) ;
if ( V_60 ) {
F_62 ( V_19 -> V_149 ,
L_21 ,
V_276 -> V_297 , V_309 ) ;
...
V_19 -> V_311 = V_307 ;
V_19 -> V_312 = V_19 -> V_313 ;
V_19 -> V_23 = V_314 ;
V_19 -> V_22 = F_154 ( V_314 ) ;
V_19 -> V_33 = F_139 ( V_19 -> V_149 ,
V_19 -> V_22 * sizeof( V_315 ) ,
V_296 ) ;
if ( ! V_19 -> V_33 ) {
...
V_19 -> V_53 = V_135 ;
V_19 -> V_317 = V_19 -> V_136 +
V_318 ;
V_19 -> V_153 = V_19 -> V_136 + V_319 ;
for ( V_20 = 0 ; V_20 < V_19 -> V_313 ; V_20 ++ )
V_19 -> V_30 [ V_20 ] = V_19 -> V_39 +
V_320 + ( V_321 * V_20 ) ;
V_19 -> V_322 = V_19 -> V_39 + V_323 ;
V_19 -> V_324 = V_19 -> V_39 + V_325 ;
V_19 -> V_159 = V_19 -> V_313 ;
V_19 -> V_102 = V_326 ;
V_19 -> V_327 = V_328 ;
V_19 -> V_268 = ( 1 << ( V_19 -> V_313 ) ) - 1 ;
...
F_136 ( V_19 , V_39 , V_329 ) ;
F_136 ( V_19 , V_153 , V_291 ) ;
...
V_19 -> V_39 = V_307 ;
V_19 -> V_312 = V_19 -> V_301 ;
V_19 -> V_23 = V_334 ;
V_19 -> V_22 = F_154 ( V_334 ) ;
V_19 -> V_33 = F_139 ( V_19 -> V_149 ,
V_19 -> V_22 * sizeof( V_315 ) ,
V_296 ) ;
if ( ! V_19 -> V_33 ) {
...
V_19 -> V_317 = V_19 -> V_136 + V_335 ;
V_19 -> V_153 = V_19 -> V_39 + V_336 ;
for ( V_20 = 0 ; V_20 < V_19 -> V_301 ; V_20 ++ ) {
V_19 -> V_30 [ V_20 ] =
V_19 -> V_39 + V_337 +
( V_321 * ( V_20 & 0x1 ) ) ;
}
V_19 -> V_324 = V_19 -> V_39 + V_338 ;
V_19 -> V_322 = V_19 -> V_39 + V_339 ;
V_19 -> V_159 = V_19 -> V_313 ;
V_19 -> V_102 = V_340 ;
V_19 -> V_327 = V_341 ;
V_19 -> V_268 = V_342 ;
F_134 ( V_19 , V_136 , V_258 ) ;
F_134 ( V_19 , V_39 , V_258 ) ;
F_134 ( V_19 , V_39 , V_137 ) ;
F_134 ( V_19 , V_39 , V_127 ) ;
F_134 ( V_19 , V_39 , V_40 ) ;
F_134 ( V_19 , V_39 , V_263 ) ;
F_134 ( V_19 , V_39 , V_329 ) ;
F_134 ( V_19 , V_153 , V_291 ) ;
...
V_19 -> V_39 = V_307 ;
V_19 -> V_317 = V_19 -> V_136 + V_347 ;
V_19 -> V_332 = V_19 -> V_317 +
( 2 * V_348 ) ;
V_19 -> V_153 = V_19 -> V_39 + V_349 ;
for ( V_20 = 0 ; V_20 < ( V_19 -> V_313 ) ; V_20 ++ )
V_19 -> V_30 [ V_20 ] = V_19 -> V_39 +
V_350 + ( V_351 * V_20 ) ;
V_19 -> V_324 = V_19 -> V_39 + V_352 ;
V_19 -> V_322 = V_19 -> V_39 + V_353 ;
V_19 -> V_159 = V_19 -> V_313 ;
V_19 -> V_102 = V_354 ;
V_19 -> V_268 = ( 1 << ( V_19 -> V_313 ) ) - 1 ;
...
F_135 ( V_19 , V_153 , V_291 ) ;
F_135 ( V_19 , V_153 , V_138 ) ;
F_135 ( V_19 , V_153 , V_154 ) ;
return 0 ;
}
static int F_158 ( struct V_355 * V_355 , struct V_294 * V_149 ,
struct V_275 * V_276 , void * * V_356 )
{
struct V_275 * V_357 , * V_358 ;
struct V_275 * V_359 ;
struct V_360 V_361 ;
struct V_18 * V_19 ;
T_1 V_101 ;
...
V_19 = F_139 ( V_149 , sizeof( struct V_18 ) , V_296 ) ;
if ( ! V_19 )
return - V_316 ;
if ( F_159 ( V_276 , L_35 ) ||
F_159 ( V_276 , L_36 ) ) {
V_19 -> V_301 = 4 ;
} else if ( F_159 ( V_276 , L_37 ) ) {
V_19 -> V_301 = 8 ;
} else if ( F_159 ( V_276 , L_38 ) ) {
V_19 -> V_301 = 1 ;
} else if ( F_159 ( V_276 , L_39 ) ) {
V_19 -> V_301 = 2 ;
} else {
F_62 ( V_149 , L_40 ) ;
return - V_27 ;
}
V_19 -> V_313 = V_19 -> V_301 + 1 ;
V_19 -> V_149 = V_149 ;
V_19 -> V_355 = V_355 ;
V_19 -> V_144 = V_134 ;
F_160 ( & V_19 -> V_52 ) ;
if ( F_161 ( V_276 , L_41 , NULL ) ) {
V_19 -> V_155 = true ;
F_162 ( V_149 , L_42 ) ;
} else {
V_19 -> V_155 = false ;
...
V_60 = F_131 ( V_276 , L_44 ,
& V_19 -> V_362 ) ;
if ( V_60 < 0 ) {
F_62 ( V_149 , L_45 ) ;
V_19 -> V_362 = V_363 ;
}
V_60 = F_163 ( V_276 , L_46 ,
& V_19 -> V_261 ) ;
if ( V_60 < 0 ) {
F_62 ( V_149 , L_47 ) ;
return - V_27 ;
}
if ( ! strcmp ( V_276 -> V_297 , L_48 ) ) {
V_60 = F_155 ( V_19 , V_276 ) ;
if ( V_60 )
return V_60 ;
F_63 ( V_149 , L_49 , V_19 -> V_53 ) ;
if ( V_19 -> V_53 == V_54 )
V_60 = F_156 ( V_19 , V_276 ) ;
else if ( F_48 ( V_19 ) )
V_60 = F_157 ( V_19 , V_276 ) ;
else
V_60 = - V_150 ;
} else if ( ! strcmp ( V_276 -> V_297 , L_50 ) ) {
V_60 = F_149 ( V_19 , V_276 ) ;
if ( V_60 )
return V_60 ;
V_60 = F_164 ( V_19 -> V_311 ,
V_19 -> V_136 ) ;
} else {
F_62 ( V_149 , L_51 , V_276 -> V_297 ) ;
V_60 = - V_150 ;
}
if ( V_60 )
return V_60 ;
V_357 = F_165 ( V_276 , L_52 ) ;
if ( ! V_357 )
F_62 ( V_149 , L_53 ) ;
V_60 = F_166 ( & V_19 -> V_256 , V_355 ,
V_19 -> V_261 , V_19 -> V_362 ) ;
if ( V_60 )
return V_60 ;
V_60 = F_167 ( & V_19 -> V_256 ) ;
if ( V_60 )
return V_60 ;
F_168 ( & V_19 -> V_364 ) ;
F_138 (interfaces, interface) {
V_60 = F_131 ( V_358 , L_8 , & V_101 ) ;
if ( V_60 ) {
F_62 ( V_149 , L_54 ,
V_358 -> V_297 ) ;
continue;
...
if ( ! V_19 -> V_300 )
F_132 ( V_149 , L_55 ) ;
V_359 = F_165 ( V_276 , L_56 ) ;
F_168 ( & V_19 -> V_299 ) ;
if ( V_359 && ( V_19 -> V_300 < V_19 -> V_301 ) )
F_137 ( V_19 , V_359 ) ;
F_142 ( V_359 ) ;
if ( ! V_19 -> V_300 ) {
F_62 ( V_149 ,
...
V_361 . V_149 = V_19 -> V_149 ;
V_361 . V_366 = V_19 -> V_322 ;
V_361 . V_367 = V_368 ;
V_361 . V_327 = V_19 -> V_327 ;
V_361 . V_159 = V_19 -> V_159 ;
if ( F_48 ( V_19 ) ) {
V_361 . V_369 = 0x7 ;
V_361 . V_370 = true ;
}
V_19 -> V_111 = F_169 ( & V_361 ) ;
if ( ! V_19 -> V_111 ) {
...
V_19 -> V_79 = F_170 ( V_19 -> V_149 , V_19 -> V_324 , V_276 ) ;
if ( F_171 ( V_371 ) && F_152 ( V_19 -> V_79 ) ) {
...
static int F_173 ( void * V_356 , struct V_1 * V_2 ,
struct V_275 * V_276 , void * * V_166 )
{
struct V_18 * V_19 = V_356 ;
struct V_13 * V_13 ;
int V_60 ;
if ( ! V_276 ) {
...
V_13 = F_139 ( V_19 -> V_149 , sizeof( * V_13 ) , V_296 ) ;
if ( ! V_13 )
return - V_316 ;
V_13 -> V_2 = V_2 ;
...
if ( F_130 ( V_19 , V_13 -> V_61 , V_276 ) ) {
V_60 = - V_150 ;
goto V_269;
}
V_13 -> V_256 = V_19 -> V_256 ;
V_2 -> V_373 = & V_374 ;
F_141 ( & V_13 -> V_375 , & V_19 -> V_364 ) ;
* V_166 = V_13 ;
return 0 ;
V_269:
if ( V_13 -> V_61 )
...
static int F_175 ( struct V_355 * V_355 , void * V_356 )
{
struct V_18 * V_19 = V_356 ;
F_176 ( & V_19 -> V_251 ) ;
F_177 ( V_19 -> V_79 ) ;
