...
if ( V_291 ) {
if ( V_290 -> V_124 <= 45 ) {
long V_324 = F_119 ( V_290 ) ;
T_10 V_325 = F_124 ( V_290 -> V_4 + V_324 ,
V_290 -> V_124 - V_324 , 0 ) ;
* ( ( V_326 * ) ( V_290 -> V_4 + V_324
+ V_290 -> V_317 ) ) = F_125 ( V_325 ) ;
V_291 = false ;
} else {
T_2 V_327 = F_118 ( V_290 ) ;
F_126 ( V_290 , 4 ) ;
F_8 ( & V_327 ) ;
memcpy ( V_290 -> V_4 , & V_327 , 4 ) ;
}
}
F_126 ( V_290 , 4 ) ;
...
F_126 ( V_290 , 4 ) ;
V_321 = ( T_2 ) ( V_290 -> V_124 - 8 ) | V_329 |
V_330 ;
F_8 ( & V_321 ) ;
memcpy ( V_290 -> V_4 , & V_321 , 4 ) ;
return V_290 ;
}
static int F_127 ( struct V_1 * V_2 , int V_331 )
{
struct V_53 * V_54 = (struct V_53 * ) ( V_2 -> V_4 [ 0 ] ) ;
V_2 -> V_219 -> V_332 = V_331 ;
if ( V_54 -> V_111 & V_227 )
return 0 ;
F_101 ( V_2 -> V_14 , L_92 ) ;
if ( V_331 )
