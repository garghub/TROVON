...
return;
default:
F_18 ( & V_180 -> V_2 -> V_2 , L_75 , V_12 , V_8 ) ;
}
if ( V_8 == - V_197 )
goto exit;
if ( V_8 ) {
F_18 ( & V_180 -> V_2 -> V_2 , L_76 , V_12 ) ;
return;
}
V_22 = V_152 -> V_20 -> V_22 ;
if ( V_180 -> V_184 > 0 && V_152 -> V_193 ) {
V_152 -> V_193 = 0 ;
F_4 ( V_2 , L_77 ,
V_12 , V_22 , V_152 -> V_194 , * V_6 ) ;
F_56 ( V_152 , 1 , V_152 -> V_194 , * V_6 ) ;
-- V_180 -> V_184 ;
++ V_6 ;
}
if ( V_180 -> V_184 ) {
...
F_57 ( V_152 -> V_20 , V_6 ,
V_180 -> V_184 ) ;
V_152 -> V_20 -> V_155 . V_199 += V_180 -> V_184 ;
}
exit:
F_64 ( & V_152 -> V_200 ) ;
if ( V_152 -> V_201 == V_202 )
V_186 = F_62 ( V_180 , V_196 ) ;
else if ( V_152 -> V_201 == V_203 )
V_152 -> V_201 = V_204 ;
F_65 ( & V_152 -> V_200 ) ;
if ( V_186 )
F_18 ( V_2 , L_74 , V_12 , V_186 ) ;
}
static void F_57 ( struct V_19 * V_20 , unsigned char * V_6 ,
int V_27 )
{
int V_205 ;
V_205 = F_66 ( & V_20 -> V_20 , V_6 , V_27 ) ;
if ( V_205 < V_27 )
F_18 ( & V_20 -> V_2 , L_79 ,
V_12 , V_27 - V_205 ) ;
F_67 ( & V_20 -> V_20 ) ;
...
V_212 |
( V_208 << 2 ) ) ;
F_4 ( & V_20 -> V_2 , L_83 , V_12 ) ;
V_8 = F_7 ( V_2 , V_213 ,
( T_3 ) ( V_25 + V_22 ) , V_207 , NULL , 0 ) ;
if ( V_8 ) {
F_18 ( & V_20 -> V_2 , L_84 ,
V_12 , V_8 ) ;
return V_8 ;
...
F_4 ( & V_20 -> V_2 , L_88 , V_152 -> V_167 ) ;
V_152 -> V_218 = V_148 | V_146 ;
F_4 ( & V_20 -> V_2 , L_89 , V_152 -> V_218 ) ;
V_181 = V_152 -> V_181 ;
if ( F_74 ( & V_181 -> V_219 ) )
return - V_220 ;
if ( V_181 -> V_221 == 0 ) {
V_180 = V_181 -> V_23 -> V_20 [ 0 ] -> V_222 ;
if ( ! V_180 ) {
F_18 ( & V_20 -> V_2 ,
L_90 ,
V_12 ) ;
...
F_75 ( V_2 , V_20 -> V_224 -> V_225 ) ;
F_75 ( V_2 , V_20 -> V_226 -> V_225 ) ;
V_180 = V_20 -> V_226 ;
if ( ! V_180 ) {
F_18 ( & V_20 -> V_2 , L_92 ,
V_12 ) ;
...
goto V_223;
V_227:
if ( V_152 -> V_181 -> V_221 == 0 )
F_76 ( V_20 -> V_23 -> V_20 [ 0 ] -> V_222 ) ;
V_223:
F_77 ( & V_181 -> V_219 ) ;
return V_8 ;
}
...
F_76 ( V_20 -> V_224 ) ;
V_152 -> V_206 = 0 ;
F_80 ( & V_152 -> V_200 , V_228 ) ;
F_81 ( & V_20 -> V_229 ) ;
F_82 ( & V_152 -> V_200 , V_228 ) ;
...
if ( V_152 -> V_198 == 1 )
return - V_60 ;
V_231 = F_85 ( & V_20 -> V_229 , V_6 , V_231 ,
& V_152 -> V_200 ) ;
F_70 ( V_20 , V_157 ) ;
return V_231 ;
}
...
V_152 -> V_206 = 1 ;
F_82 ( & V_152 -> V_200 , V_228 ) ;
F_11 ( & V_20 -> V_2 , V_12 , V_231 , V_20 -> V_224 -> V_183 ) ;
V_20 -> V_224 -> V_234 = V_231 ;
V_232 = F_62 ( V_20 -> V_224 , V_196 ) ;
if ( V_232 ) {
F_69 ( V_20 ,
L_96 ,
V_12 , V_232 ) ;
...
V_152 -> V_20 -> V_155 . V_235 += V_231 ;
if ( V_157 )
F_54 ( V_157 ) ;
}
static int F_87 ( struct V_156 * V_157 )
{
struct V_19 * V_20 = V_157 -> V_236 ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
int V_237 = 0 ;
unsigned long V_228 ;
if ( V_152 == NULL )
...
return 0 ;
F_80 ( & V_152 -> V_200 , V_228 ) ;
V_237 = F_88 ( & V_20 -> V_229 ) ;
F_82 ( & V_152 -> V_200 , V_228 ) ;
F_4 ( & V_20 -> V_2 , L_97 , V_12 , V_237 ) ;
return V_237 ;
}
...
return 0 ;
F_80 ( & V_152 -> V_200 , V_228 ) ;
V_238 = F_90 ( & V_20 -> V_229 ) ;
F_82 ( & V_152 -> V_200 , V_228 ) ;
F_4 ( & V_20 -> V_2 , L_97 , V_12 , V_238 ) ;
return V_238 ;
}
...
return;
if ( F_93 ( V_157 ) ) {
unsigned char V_240 = F_94 ( V_157 ) ;
...
return;
if ( F_93 ( V_157 ) ) {
unsigned char V_241 = F_97 ( V_157 ) ;
V_8 = F_84 ( V_157 , V_20 , & V_241 , 1 ) ;
if ( V_8 <= 0 ) {
F_18 ( & V_20 -> V_2 , L_99 , V_12 , V_8 ) ;
}
}
if ( F_53 ( V_157 ) ) {
V_8 = F_98 ( V_152 ) ;
...
unsigned long V_228 ;
F_80 ( & V_152 -> V_200 , V_228 ) ;
if ( V_152 -> V_201 == V_204 ) {
V_180 = V_152 -> V_20 -> V_226 ;
V_8 = F_62 ( V_180 , V_196 ) ;
}
V_152 -> V_201 = V_202 ;
V_152 -> V_218 |= V_148 ;
F_82 ( & V_152 -> V_200 , V_228 ) ;
...
struct V_45 * V_152 , struct V_242 * V_243 )
{
struct V_42 * V_2 = & V_152 -> V_20 -> V_2 ;
struct V_244 * V_56 ;
int V_245 ;
...
V_246 = V_157 -> V_209 . V_247 ;
V_56 -> V_248 = 0 ;
V_56 -> V_248 |= V_249 ;
V_56 -> V_248 |= V_250 ;
V_56 -> V_251 = ( T_1 ) ( V_152 -> V_251 ) ;
switch ( V_246 & V_252 ) {
case V_253 :
V_56 -> V_254 = V_255 ;
F_4 ( V_2 , L_101 , V_12 ) ;
...
V_56 -> V_276 = F_97 ( V_157 ) ;
V_56 -> V_277 = F_94 ( V_157 ) ;
if ( F_93 ( V_157 ) ) {
V_56 -> V_248 |= V_278 ;
F_4 ( V_2 , L_112 ,
V_12 , V_56 -> V_276 , V_56 -> V_277 ) ;
} else
F_4 ( V_2 , L_113 , V_12 ) ;
if ( F_100 ( V_157 ) ) {
V_56 -> V_248 |= V_279 ;
...
F_4 ( V_2 , L_115 , V_12 ) ;
V_157 -> V_209 . V_247 &= ~ V_280 ;
V_245 = F_101 ( V_157 ) ;
if ( ! V_245 ) {
V_245 = 9600 ;
} else
F_102 ( V_157 , V_245 , V_245 ) ;
V_152 -> V_281 = V_245 ;
V_56 -> V_282 = ( T_2 ) ( ( 461550L + V_245 / 2 ) / V_245 ) ;
F_4 ( V_2 , L_116 , V_12 , V_245 , V_56 -> V_282 ) ;
F_4 ( V_2 , L_117 , ( int ) ( 461550L / V_56 -> V_282 ) ) ;
F_4 ( V_2 , L_118 , V_56 -> V_248 ) ;
F_4 ( V_2 , L_119 , V_56 -> V_254 ) ;
F_4 ( V_2 , L_120 , V_56 -> V_265 ) ;
F_4 ( V_2 , L_121 , V_56 -> V_270 ) ;
F_4 ( V_2 , L_122 , V_56 -> V_276 ) ;
F_4 ( V_2 , L_123 , V_56 -> V_277 ) ;
F_4 ( V_2 , L_124 , V_56 -> V_251 ) ;
F_103 ( & V_56 -> V_248 ) ;
F_103 ( & V_56 -> V_282 ) ;
V_8 = F_7 ( V_152 -> V_20 -> V_23 -> V_2 , V_283 ,
( T_1 ) ( V_25 + V_22 ) ,
...
struct V_19 * V_20 , struct V_242 * V_243 )
{
struct V_45 * V_152 = F_61 ( V_20 ) ;
unsigned int V_246 ;
V_246 = V_157 -> V_209 . V_247 ;
F_4 ( & V_20 -> V_2 , L_126 , V_12 ,
V_157 -> V_209 . V_247 , V_157 -> V_209 . V_284 ) ;
F_4 ( & V_20 -> V_2 , L_127 , V_12 ,
V_243 -> V_247 , V_243 -> V_284 ) ;
if ( V_152 == NULL )
return;
F_99 ( V_157 , V_152 , V_243 ) ;
}
...
V_153 = V_152 -> V_167 ;
V_144 = V_152 -> V_218 ;
V_232 = ( ( V_144 & V_146 ) ? V_288 : 0 )
| ( ( V_144 & V_148 ) ? V_287 : 0 )
| ( ( V_153 & V_168 ) ? V_290 : 0 )
| ( ( V_153 & V_291 ) ? V_292 : 0 )
| ( ( V_153 & V_293 ) ? V_294 : 0 )
| ( ( V_153 & V_295 ) ? V_296 : 0 ) ;
F_4 ( & V_20 -> V_2 , L_128 , V_12 , V_232 ) ;
F_82 ( & V_152 -> V_200 , V_228 ) ;
return V_232 ;
}
static int F_106 ( struct V_45 * V_152 ,
struct V_297 T_7 * V_298 )
{
struct V_297 V_299 ;
unsigned V_300 ;
V_300 = V_152 -> V_20 -> V_20 . V_301 ;
if ( V_300 != V_302 )
V_300 = F_107 ( V_300 ) / 10 ;
memset ( & V_299 , 0 , sizeof( V_299 ) ) ;
V_299 . type = V_303 ;
V_299 . line = V_152 -> V_20 -> V_304 ;
V_299 . V_20 = V_152 -> V_20 -> V_22 ;
V_299 . V_305 = 0 ;
V_299 . V_306 = V_152 -> V_20 -> V_233 ;
V_299 . V_307 = 9600 ;
V_299 . V_308 = 5 * V_309 ;
V_299 . V_301 = V_300 ;
if ( F_108 ( V_298 , & V_299 , sizeof( * V_298 ) ) )
return - V_310 ;
return 0 ;
}
...
switch ( V_311 ) {
case V_313 :
F_4 ( & V_20 -> V_2 , L_129 , V_12 ) ;
return F_106 ( V_152 ,
(struct V_297 T_7 * ) V_312 ) ;
}
return - V_314 ;
}
static void F_110 ( struct V_156 * V_157 , int V_315 )
{
struct V_19 * V_20 = V_157 -> V_236 ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
int V_8 ;
...
static void F_113 ( struct V_321 * V_322 )
{
struct V_34 * V_23 ;
struct V_67 * V_68 ;
V_23 = F_114 ( V_322 , struct V_34 ,
V_319 . V_322 ) ;
V_68 = F_15 ( sizeof( * V_68 ) , V_39 ) ;
...
if ( V_23 -> V_324 < V_23 -> V_190 ||
V_23 -> V_325 < V_23 -> V_190 )
return - V_60 ;
}
...
return 1 ;
V_323 = F_24 (
V_181 -> V_23 -> V_2 -> V_137 . V_326 ) ;
if ( V_181 -> V_121 > V_327 ) {
if ( V_323 == V_328 ||
V_323 == V_329 ) {
V_181 -> V_318 = true ;
}
...
if ( V_239 )
goto V_335;
V_20 -> V_20 . V_301 = F_127 ( V_301 * 10 ) ;
V_20 -> V_20 . V_336 = 1 ;
return 0 ;
V_335:
F_16 ( V_152 ) ;
...
struct V_337 * V_338 , char * V_339 )
{
struct V_19 * V_20 = F_131 ( V_2 ) ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
return sprintf ( V_339 , L_64 , V_152 -> V_251 ) ;
}
static T_8 F_132 ( struct V_42 * V_2 ,
struct V_337 * V_338 , const char * V_340 , T_9 V_231 )
{
struct V_19 * V_20 = F_131 ( V_2 ) ;
struct V_45 * V_152 = F_61 ( V_20 ) ;
unsigned int V_341 = F_133 ( V_340 , NULL , 0 ) ;
F_4 ( V_2 , L_134 , V_12 , V_341 ) ;
if ( V_341 < 256 )
V_152 -> V_251 = V_341 ;
else
F_18 ( V_2 , L_135 , V_12 , V_341 ) ;
return V_231 ;
}
static int F_126 ( struct V_19 * V_20 )
{
return F_134 ( & V_20 -> V_2 , & V_342 ) ;
}
static int F_129 ( struct V_19 * V_20 )
{
F_135 ( & V_20 -> V_2 , & V_342 ) ;
return 0 ;
}
static int F_136 ( struct V_107 * V_23 , T_10 V_343 )
{
struct V_34 * V_181 = F_79 ( V_23 ) ;
F_121 ( & V_181 -> V_319 ) ;
return 0 ;
