...
static int T_2 F_24 ( unsigned long * V_63 ,
unsigned long * V_64 )
{
...
V_72 = F_29 ( V_10 , V_73 ) ;
F_11 ( ! V_72 ) ;
memcpy ( V_72 , V_4 , V_10 ) ;
V_4 = V_72 ;
V_10 = F_28 ( struct V_11 , V_8 ) + sizeof( struct V_6 ) * V_60 -> V_5 ;
V_72 = F_29 ( V_10 , V_73 ) ;
F_11 ( ! V_72 ) ;
memcpy ( V_72 , V_60 , V_10 ) ;
V_60 = V_72 ;
}
void T_2 F_30 ( T_1 V_74 , T_3 V_75 )
{
int V_76 ;
struct V_6 * V_77 ;
struct V_78 * V_79 ;
...
void T_2 F_33 ( unsigned long V_82 )
{
int V_3 ;
unsigned long V_83 = 0 ;
for ( V_3 = 0 ; V_3 < V_4 -> V_5 ; V_3 ++ ) {
struct V_6 * V_7 = & V_4 -> V_8 [ V_3 ] ;
if ( V_83 < F_34 ( V_7 -> V_9 ) )
F_35 ( V_83 , F_34 ( V_7 -> V_9 ) ) ;
V_83 = F_36 ( V_7 -> V_9 + V_7 -> V_10 ) ;
if ( V_7 -> type != V_15 && V_7 -> type != V_16 )
F_35 ( F_34 ( V_7 -> V_9 ) , V_83 ) ;
if ( V_83 >= V_82 )
break;
}
}
...
T_1 T_2 F_39 ( T_1 V_10 , T_1 V_84 )
{
T_1 V_9 ;
V_9 = F_40 ( V_10 , V_84 , V_85 ) ;
if ( V_9 ) {
...
static unsigned long T_2 F_41 ( unsigned long V_82 , unsigned type )
{
int V_3 ;
...
{
return F_41 ( V_88 , V_15 ) ;
}
unsigned long T_2 F_43 ( void )
{
return F_41 ( 1UL << ( 32 - V_70 ) , V_15 ) ;
}
static void T_2 F_44 ( char * V_91 )
{
F_45 ( V_91 ) ;
F_46 ( V_91 ) ;
}
...
if ( V_93 == 0 )
return - V_94 ;
F_21 ( V_93 , V_55 - V_93 , V_15 , 1 ) ;
return 0 ;
}
static int T_2 F_51 ( char * V_92 )
{
char * V_98 ;
T_1 V_99 , V_93 ;
if ( ! V_92 )
...
static int T_2 F_53 ( char * V_101 )
{
while ( V_101 ) {
...
static const char * T_2 F_55 ( int V_103 )
{
switch ( V_103 ) {
case V_16 :
...
static unsigned long T_2 F_56 ( int V_103 )
{
switch ( V_103 ) {
case V_16 :
case V_15 :
...
static unsigned long T_2 F_57 ( int V_103 )
{
switch ( V_103 ) {
case V_19 :
return V_106 ;
...
static bool T_2 F_58 ( T_3 type , struct V_111 * V_112 )
{
...
struct V_111 * V_112 ;
T_1 V_2 ;
V_112 = F_60 ( sizeof( struct V_111 ) * V_4 -> V_5 ) ;
V_113 = V_112 ;
for ( V_3 = 0 ; V_3 < V_4 -> V_5 ; V_3 ++ ) {
...
V_112 -> V_115 = F_55 ( V_4 -> V_8 [ V_3 ] . type ) ;
V_112 -> V_1 = V_4 -> V_8 [ V_3 ] . V_9 ;
V_112 -> V_2 = V_2 ;
V_112 -> V_116 = F_56 ( V_4 -> V_8 [ V_3 ] . type ) ;
V_112 -> V_117 = F_57 ( V_4 -> V_8 [ V_3 ] . type ) ;
if ( F_58 ( V_4 -> V_8 [ V_3 ] . type , V_112 ) ) {
V_112 -> V_116 |= V_118 ;
F_61 ( & V_119 , V_112 ) ;
}
V_112 ++ ;
...
static unsigned long T_2 F_63 ( V_114 V_121 )
{
...
& V_50 ) ;
V_125 . V_126 = V_50 ;
if ( F_15 ( V_125 . V_127 , V_125 . V_126 )
< 0 ) {
T_1 V_93 ;
if ( V_125 . V_128
< V_125 . V_129 . V_130 ) {
...
V_89 = F_18 ( V_89 , V_139 ) ;
V_90 = F_18 ( V_90 , V_139 ) ;
V_136 += V_90 - V_89 ;
}
F_78 (u, NUMA_NO_NODE, MEMBLOCK_NONE, &start, &end,
NULL) {
V_89 = F_79 (unsigned long, PFN_UP(start), MAX_DMA_PFN) ;
V_90 = F_79 (unsigned long, PFN_DOWN(end), MAX_DMA_PFN) ;
if ( V_89 < V_90 )
V_137 += V_90 - V_89 ;
}
F_80 ( V_136 - V_137 ) ;
