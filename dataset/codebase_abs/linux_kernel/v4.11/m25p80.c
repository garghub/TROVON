...
int V_11 ;
V_49 = F_20 ( & V_10 -> V_12 ) ;
V_7 = F_21 ( & V_10 -> V_12 , sizeof( * V_7 ) , V_54 ) ;
if ( ! V_7 )
return - V_55 ;
V_2 = & V_7 -> V_1 ;
V_2 -> V_56 = F_13 ;
...
V_53 = V_10 -> V_65 ;
V_11 = F_24 ( V_2 , V_53 , V_51 ) ;
if ( V_11 )
return V_11 ;
return F_25 ( & V_2 -> V_64 , V_49 ? V_49 -> V_66 : NULL ,
V_49 ? V_49 -> V_67 : 0 ) ;
}
static int F_26 ( struct V_9 * V_10 )
{
struct V_6 * V_7 = F_27 ( V_10 ) ;
return F_28 ( & V_7 -> V_1 . V_64 ) ;
}
