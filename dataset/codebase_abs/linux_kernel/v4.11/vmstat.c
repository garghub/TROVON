...
static int F_159 ( unsigned int V_2 )
{
...
F_166 ( L_46 , V_157 , NULL , & V_160 ) ;
F_166 ( L_47 , V_157 , NULL , & V_161 ) ;
#endif
}
...
F_89 ( V_79 , L_48 , V_162 / 1000 , V_162 % 1000 ) ;
}
F_90 ( V_79 , '\n' ) ;
}
