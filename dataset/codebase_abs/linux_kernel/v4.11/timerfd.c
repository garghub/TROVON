...
static long F_50 ( struct V_48 * V_48 , unsigned int V_67 , unsigned long V_68 )
{
struct V_1 * V_2 = V_48 -> V_49 ;
int V_69 = 0 ;
switch ( V_67 ) {
case V_70 : {
T_7 V_10 ;
if ( F_51 ( & V_10 , ( T_7 T_4 * ) V_68 , sizeof( V_10 ) ) )
return - V_62 ;
if ( ! V_10 )
return - V_58 ;
F_40 ( & V_2 -> V_7 . V_8 ) ;
...
static int F_52 ( int V_72 , struct V_72 * V_73 )
{
struct V_72 V_74 = F_53 ( V_72 ) ;
if ( ! V_74 . V_48 )
return - V_75 ;
...
static int F_55 ( int V_78 , int V_6 ,
...
V_80 -> V_38 = F_48 ( F_22 ( V_2 ) ) ;
V_80 -> V_40 = F_48 ( V_2 -> V_39 ) ;
V_69 = F_25 ( V_2 , V_6 , V_79 ) ;
F_45 ( & V_2 -> V_7 . V_8 ) ;
F_54 ( V_74 ) ;
return V_69 ;
}
static int F_61 ( int V_78 , struct V_31 * V_14 )
{
struct V_72 V_74 ;
struct V_1 * V_2 ;
int V_69 = F_52 ( V_78 , & V_74 ) ;
if ( V_69 )
return V_69 ;
V_2 = V_74 . V_48 -> V_49 ;
F_40 ( & V_2 -> V_7 . V_8 ) ;
