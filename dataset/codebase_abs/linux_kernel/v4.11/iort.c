...
V_137 = F_70 ( V_140 , sizeof( * V_137 ) , V_19 ) ;
if ( ! V_137 ) {
V_100 = - V_8 ;
goto V_144;
}
V_99 -> V_145 ( V_137 , V_12 ) ;
V_100 = F_71 ( V_94 , V_137 , V_140 ) ;
F_13 ( V_137 ) ;
if ( V_100 )
goto V_144;
V_100 = F_72 ( V_94 , & V_12 , sizeof( V_12 ) ) ;
if ( V_100 )
goto V_144;
...
{
T_2 V_39 ;
V_39 = F_81 ( V_152 , 0 , & V_31 ) ;
if ( F_27 ( V_39 ) ) {
if ( V_39 != V_48 ) {
const char * V_153 = F_82 ( V_39 ) ;
F_35 ( L_14 , V_153 ) ;
}
return;
}
