...
F_102 (kdev, qmgr) {
V_169 = F_122 ( V_41 -> V_42 , V_14 -> V_17 ) ;
...
void T_4 * V_140 ;
int V_19 ;
V_19 = F_131 ( V_125 , V_110 , & V_184 ) ;
if ( V_19 ) {
F_77 ( V_24 -> V_25 , L_47 ,
V_125 -> V_38 , V_110 ) ;
return F_27 ( V_19 ) ;
}
V_140 = F_132 ( V_24 -> V_25 , & V_184 ) ;
if ( F_133 ( V_140 ) )
F_77 ( V_24 -> V_25 , L_48 ,
V_110 , V_125 -> V_38 ) ;
return V_140 ;
...
F_130 ( V_24 , V_157 ,
V_192 ) ;
if ( F_133 ( V_41 -> V_45 ) || F_133 ( V_41 -> V_187 ) ||
F_133 ( V_41 -> V_165 ) || F_133 ( V_41 -> V_150 ) ||
F_133 ( V_41 -> V_43 ) || F_133 ( V_41 -> V_44 ) ) {
F_77 ( V_25 , L_53 ) ;
if ( ! F_133 ( V_41 -> V_45 ) )
F_136 ( V_25 , V_41 -> V_45 ) ;
if ( ! F_133 ( V_41 -> V_187 ) )
F_136 ( V_25 , V_41 -> V_187 ) ;
if ( ! F_133 ( V_41 -> V_165 ) )
F_136 ( V_25 , V_41 -> V_165 ) ;
if ( ! F_133 ( V_41 -> V_150 ) )
F_136 ( V_25 , V_41 -> V_150 ) ;
if ( ! F_133 ( V_41 -> V_43 ) )
...
F_130 ( V_24 , V_157 ,
V_202 ) ;
if ( F_133 ( V_195 -> V_201 ) || F_133 ( V_195 -> V_196 ) ||
F_133 ( V_195 -> V_140 ) || F_133 ( V_195 -> V_199 ) ) {
F_77 ( V_25 , L_56 ,
V_195 -> V_38 ) ;
if ( ! F_133 ( V_195 -> V_201 ) )
F_136 ( V_25 , V_195 -> V_201 ) ;
if ( ! F_133 ( V_195 -> V_196 ) )
F_136 ( V_25 , V_195 -> V_196 ) ;
if ( ! F_133 ( V_195 -> V_140 ) )
F_136 ( V_25 , V_195 -> V_140 ) ;
if ( ! F_133 ( V_195 -> V_199 ) )
F_136 ( V_25 , V_195 -> V_199 ) ;
F_29 ( V_25 , V_195 ) ;
continue;
}
...
bool V_211 = false ;
T_3 * V_212 ;
for ( V_107 = 0 ; V_107 < F_140 ( V_213 ) ; V_107 ++ ) {
if ( V_213 [ V_107 ] ) {
V_19 = F_141 ( & V_210 ,
V_213 [ V_107 ] ,
V_24 -> V_25 ) ;
...
F_60 ( F_142 ( V_212 [ V_107 ] ) , V_195 -> V_196 + V_107 ) ;
F_143 ( V_210 ) ;
return 0 ;
}
...
F_145 ( V_24 ) ;
F_146 (kdev, pdsp) {
V_19 = F_139 ( V_24 , V_195 ) ;
if ( ! V_19 )
V_195 -> V_206 = true ;
}
F_146 (kdev, pdsp) {
if ( V_195 -> V_206 ) {
V_19 = F_144 ( V_24 , V_195 ) ;
if ( ! V_19 )
V_195 -> V_207 = true ;
}
}
...
static inline struct V_141 * F_148 ( unsigned V_16 )
{
struct V_141 * V_41 ;
F_102 (kdev, qmgr) {
if ( ( V_16 >= V_41 -> V_42 ) &&
...
V_24 -> V_36 = V_158 [ 0 ] ;
V_24 -> V_37 = V_158 [ 1 ] ;
V_185 = F_159 ( V_125 , L_68 ) ;
if ( ! V_185 ) {
F_77 ( V_25 , L_69 ) ;
V_19 = - V_51 ;
goto V_128;
}
V_19 = F_134 ( V_24 , V_185 ) ;
F_160 ( V_185 ) ;
if ( V_19 )
goto V_128;
V_193 = F_159 ( V_125 , L_70 ) ;
if ( V_193 ) {
V_19 = F_137 ( V_24 , V_193 ) ;
if ( V_19 )
goto V_128;
V_19 = F_147 ( V_24 ) ;
if ( V_19 )
...
F_160 ( V_193 ) ;
V_181 = F_159 ( V_125 , L_71 ) ;
if ( ! V_181 ) {
F_77 ( V_25 , L_72 ) ;
V_19 = - V_51 ;
goto V_128;
}
V_19 = F_123 ( V_24 , V_181 ) ;
F_160 ( V_181 ) ;
if ( V_19 )
goto V_128;
...
F_161 ( L_79 , V_223 | V_224 , NULL , NULL ,
& V_225 ) ;
return 0 ;
V_128:
F_145 ( V_24 ) ;
