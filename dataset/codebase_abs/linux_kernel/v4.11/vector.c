...
static void T_1 F_94 ( int V_101 )
{
int V_63 ;
F_95 ( V_102 ) ;
for ( V_63 = 0 ; V_63 < 8 ; V_63 ++ )
F_96 ( L_2 , F_84 ( V_101 + V_63 * 0x10 ) ) ;
F_96 ( L_3 ) ;
}
static void T_1 F_97 ( void * V_103 )
{
...
F_80 () , F_99 () ) ;
V_104 = F_84 ( V_108 ) ;
F_100 ( L_5 , V_104 , F_101 () ) ;
V_104 = F_84 ( V_109 ) ;
F_100 ( L_6 , V_104 ) ;
V_105 = F_102 ( V_104 ) ;
V_106 = F_103 () ;
V_104 = F_84 ( V_110 ) ;
F_98 ( L_7 , V_104 , V_104 & V_111 ) ;
if ( F_104 ( V_105 ) ) {
if ( ! F_105 ( V_105 ) ) {
V_104 = F_84 ( V_112 ) ;
F_98 ( L_8 ,
...
V_107 = F_108 () ;
F_98 ( L_18 , ( V_122 ) V_107 ) ;
F_98 ( L_19 , ( V_122 ) ( V_107 >> 32 ) ) ;
V_104 = F_84 ( V_123 ) ;
F_98 ( L_20 , V_104 ) ;
if ( V_106 > 3 ) {
V_104 = F_84 ( V_124 ) ;
...
V_104 = F_84 ( F_110 ( V_63 ) ) ;
F_98 ( L_30 , V_63 , V_104 ) ;
}
}
F_96 ( L_3 ) ;
}
static void T_1 F_111 ( int V_134 )
{
int V_23 ;
if ( ! V_134 )
return;
...
if ( V_23 >= V_134 )
break;
F_114 ( V_23 , F_97 , NULL , 1 ) ;
}
F_115 () ;
}
static void T_1 F_116 ( void )
{
unsigned int V_104 ;
unsigned long V_48 ;
if ( ! F_44 () )
...
F_98 ( L_31 ) ;
F_32 ( & V_135 , V_48 ) ;
V_104 = F_117 ( 0xa1 ) << 8 | F_117 ( 0x21 ) ;
F_98 ( L_32 , V_104 ) ;
V_104 = F_117 ( 0xa0 ) << 8 | F_117 ( 0x20 ) ;
F_98 ( L_33 , V_104 ) ;
F_118 ( 0x0b , 0xa0 ) ;
F_118 ( 0x0b , 0x20 ) ;
V_104 = F_117 ( 0xa0 ) << 8 | F_117 ( 0x20 ) ;
...
F_33 ( & V_135 , V_48 ) ;
F_98 ( L_34 , V_104 ) ;
V_104 = F_117 ( 0x4d1 ) << 8 | F_117 ( 0x4d0 ) ;
F_98 ( L_35 , V_104 ) ;
}
static T_1 int F_119 ( char * V_66 )
{
int V_136 = - 1 ;
