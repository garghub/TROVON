...
T_3 V_48 )
{
struct V_49 T_2 * V_50 = V_22 -> V_24 ;
struct V_42 * V_46 ;
T_3 V_51 , V_8 ;
int V_52 ;
if ( V_45 >= F_3 ( & V_50 -> V_53 ) )
return F_43 ( - V_54 ) ;
F_9 ( V_45 , & V_50 -> V_55 ) ;
V_51 = F_3 ( & V_50 -> V_56 ) ;
if ( ! V_51 || F_3 ( & V_50 -> V_57 ) )
return F_43 ( - V_54 ) ;
if ( V_51 & ( V_51 - 1 ) ) {
F_44 ( & V_22 -> V_6 -> V_7 , L_10 , V_51 ) ;
return F_43 ( - V_28 ) ;
}
V_8 = F_3 ( & V_50 -> V_58 ) ;
V_44 -> V_59 = V_48 ;
V_46 = F_45 ( V_45 , V_51 ,
V_60 , & V_22 -> V_20 ,
true , true , V_61 , F_42 , V_47 ) ;
if ( ! V_46 )
return F_43 ( - V_62 ) ;
F_9 ( F_46 ( V_46 ) , & V_50 -> V_56 ) ;
F_13 ( F_47 ( V_46 ) ,
& V_50 -> V_63 , & V_50 -> V_64 ) ;
F_13 ( F_48 ( V_46 ) ,
& V_50 -> V_65 , & V_50 -> V_66 ) ;
...
V_46 -> V_73 = ( void V_74 * ) V_22 -> V_69 +
V_8 * V_22 -> V_70 ;
} else {
V_46 -> V_73 = ( void V_74 * ) F_14 ( V_22 -> V_6 ,
V_22 -> V_75 , 2 , 2 ,
V_8 * V_22 -> V_70 , 2 ,
NULL ) ;
}
...
V_79:
if ( ! V_22 -> V_69 )
F_50 ( V_22 -> V_6 , ( void T_2 V_74 * ) V_46 -> V_73 ) ;
V_72:
F_51 ( V_46 ) ;
return F_43 ( V_52 ) ;
}
static int F_52 ( struct V_19 * V_20 , unsigned V_80 ,
struct V_42 * V_81 [] , T_9 * V_82 [] ,
const char * const V_83 [] , struct V_84 * V_85 )
{
struct V_21 * V_22 = F_22 ( V_20 ) ;
struct V_42 * V_46 ;
int V_86 = F_53 ( V_20 , V_80 , V_81 , V_82 , V_83 , V_85 ) ;
if ( V_86 )
return V_86 ;
F_54 (vq, &vdev->vqs, list) {
F_9 ( V_46 -> V_45 , & V_22 -> V_24 -> V_55 ) ;
F_9 ( 1 , & V_22 -> V_24 -> V_57 ) ;
}
return 0 ;
}
...
if ( ! V_22 -> V_69 )
F_50 ( V_22 -> V_6 , ( void V_74 T_2 * ) V_46 -> V_73 ) ;
F_51 ( V_46 ) ;
}
static inline int F_56 ( struct V_6 * V_7 , T_1 V_88 ,
T_5 V_89 , int * V_90 )
{
int V_91 ;
for ( V_91 = F_57 ( V_7 , V_92 ) ;
V_91 > 0 ;
V_91 = F_58 ( V_7 , V_91 , V_92 ) ) {
T_1 type , V_14 ;
F_15 ( V_7 , V_91 + F_16 ( struct V_18 ,
V_88 ) ,
& type ) ;
F_15 ( V_7 , V_91 + F_16 ( struct V_18 ,
V_14 ) ,
...
{
F_61 ( V_93 !=
F_16 ( struct V_18 , V_94 ) ) ;
F_61 ( V_95 !=
F_16 ( struct V_18 , V_96 ) ) ;
F_61 ( V_97 !=
F_16 ( struct V_18 , V_98 ) ) ;
F_61 ( V_99 !=
F_16 ( struct V_18 , V_88 ) ) ;
F_61 ( V_100 !=
...
V_25 ) ) ;
F_61 ( V_107 !=
F_16 ( struct V_49 , V_26 ) ) ;
F_61 ( V_108 !=
F_16 ( struct V_49 ,
V_29 ) ) ;
F_61 ( V_109 !=
F_16 ( struct V_49 , V_30 ) ) ;
F_61 ( V_110 !=
F_16 ( struct V_49 , V_41 ) ) ;
F_61 ( V_111 !=
F_16 ( struct V_49 , V_53 ) ) ;
F_61 ( V_112 !=
F_16 ( struct V_49 , V_38 ) ) ;
F_61 ( V_113 !=
F_16 ( struct V_49 , V_37 ) ) ;
F_61 ( V_114 !=
F_16 ( struct V_49 , V_55 ) ) ;
F_61 ( V_115 !=
F_16 ( struct V_49 , V_56 ) ) ;
F_61 ( V_116 !=
F_16 ( struct V_49 , V_77 ) ) ;
F_61 ( V_117 !=
F_16 ( struct V_49 , V_57 ) ) ;
F_61 ( V_118 !=
F_16 ( struct V_49 , V_58 ) ) ;
F_61 ( V_119 !=
F_16 ( struct V_49 , V_63 ) ) ;
F_61 ( V_120 !=
F_16 ( struct V_49 , V_64 ) ) ;
F_61 ( V_121 !=
F_16 ( struct V_49 , V_65 ) ) ;
F_61 ( V_122 !=
F_16 ( struct V_49 , V_66 ) ) ;
F_61 ( V_123 !=
F_16 ( struct V_49 , V_67 ) ) ;
F_61 ( V_124 !=
F_16 ( struct V_49 , V_68 ) ) ;
}
int F_62 ( struct V_21 * V_22 )
{
struct V_6 * V_6 = V_22 -> V_6 ;
int V_52 , V_24 , V_125 , V_126 , V_36 ;
T_5 V_127 ;
T_5 V_128 ;
F_60 () ;
...
return - V_129 ;
if ( V_6 -> V_36 < 0x1040 ) {
V_22 -> V_20 . V_130 . V_36 = V_6 -> V_131 ;
} else {
V_22 -> V_20 . V_130 . V_36 = V_6 -> V_36 - 0x1040 ;
}
V_22 -> V_20 . V_130 . V_132 = V_6 -> V_133 ;
V_24 = F_56 ( V_6 , V_134 ,
V_135 | V_136 ,
& V_22 -> V_137 ) ;
if ( ! V_24 ) {
...
V_135 | V_136 ,
& V_22 -> V_137 ) ;
V_52 = F_66 ( V_6 , V_22 -> V_137 ,
L_16 ) ;
if ( V_52 )
return V_52 ;
V_52 = - V_28 ;
V_22 -> V_24 = F_14 ( V_6 , V_24 ,
sizeof( struct V_49 ) , 4 ,
0 , sizeof( struct V_49 ) ,
NULL ) ;
if ( ! V_22 -> V_24 )
goto V_141;
V_22 -> V_125 = F_14 ( V_6 , V_125 , sizeof( T_1 ) , 1 ,
0 , 1 ,
NULL ) ;
if ( ! V_22 -> V_125 )
goto V_142;
F_17 ( V_6 ,
V_126 + F_16 ( struct V_104 ,
V_105 ) ,
& V_22 -> V_70 ) ;
F_17 ( V_6 ,
V_126 + F_16 ( struct V_104 ,
...
V_143 . V_15 ) ,
& V_128 ) ;
if ( ( T_7 ) V_127 + ( V_128 % V_144 ) <= V_144 ) {
V_22 -> V_69 = F_14 ( V_6 , V_126 , 2 , 2 ,
0 , V_127 ,
& V_22 -> V_71 ) ;
if ( ! V_22 -> V_69 )
goto V_72;
...
if ( ! V_22 -> V_36 )
goto V_145;
V_22 -> V_20 . V_146 = & V_147 ;
} else {
V_22 -> V_20 . V_146 = & V_148 ;
}
V_22 -> V_149 = F_40 ;
V_22 -> F_41 = F_41 ;
V_22 -> F_55 = F_55 ;
