...
{
struct V_8 * V_8 = V_21 ;
F_130 ( ! F_131 ( 0 ) || ! F_115 ( 0 ) ) ;
V_8 -> V_158 = V_160 ;
V_8 -> V_29 = (struct V_29 * ) ( unsigned long ) F_132 () ;
V_38 . V_50 = V_51 [ 0 ] ;
F_87 ( 0 , V_161 ) ;
}
void T_1 F_133 ( unsigned int V_179 )
{
}
void T_1 F_134 ( void )
{
...
int F_135 ( unsigned int V_182 )
{
return 0 ;
}
static T_10 F_136 ( struct V_183 * V_184 ,
...
static T_10 F_139 ( struct V_183 * V_184 ,
struct V_185 * V_186 ,
...
if ( V_8 -> V_158 != V_160 )
break;
V_172 = F_140 ( V_8 -> V_10 >> V_86 ) ;
if ( V_172 )
break;
for ( V_151 = 0 ; V_151 <= V_84 ; V_151 ++ ) {
if ( V_20 + V_151 >= V_155 || ! F_131 ( V_20 + V_151 ) )
continue;
...
static T_10 F_143 ( struct V_183 * V_184 ,
struct V_185 * V_186 , char * V_187 )
{
return sprintf ( V_187 , L_6 , V_21 [ V_184 -> V_190 ] . V_10 ) ;
}
static int F_144 ( unsigned int V_20 )
{
struct V_183 * V_1 = & F_145 ( V_194 , V_20 ) -> V_184 ;
return F_146 ( & V_1 -> V_195 , & V_196 ) ;
}
static int F_147 ( unsigned int V_20 )
{
struct V_183 * V_1 = & F_145 ( V_194 , V_20 ) -> V_184 ;
F_148 ( & V_1 -> V_195 , & V_196 ) ;
return 0 ;
}
...
struct V_20 * V_197 ;
int V_172 ;
V_197 = F_149 ( sizeof( * V_197 ) , V_31 ) ;
if ( ! V_197 )
return - V_46 ;
F_145 ( V_194 , V_20 ) = V_197 ;
V_1 = & V_197 -> V_184 ;
V_197 -> V_198 = 1 ;
V_172 = F_150 ( V_197 , V_20 ) ;
if ( V_172 )
goto V_35;
V_172 = F_146 ( & V_1 -> V_195 , & V_199 ) ;
if ( V_172 )
goto V_200;
V_172 = F_151 ( V_197 ) ;
if ( V_172 )
...
static T_10 T_8 F_157 ( struct V_183 * V_184 ,
struct V_185 * V_186 ,
const char * V_187 ,
T_11 V_188 )
{
