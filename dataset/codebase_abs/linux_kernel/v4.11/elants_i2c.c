...
if ( ! V_2 -> V_7 . V_187 )
F_87 ( & V_2 -> V_7 , true ) ;
error = F_88 ( & V_2 -> V_7 . V_152 , & V_153 ) ;
if ( error ) {
F_3 ( & V_2 -> V_7 , L_79 ,
error ) ;
return error ;
...
static int T_6 F_89 ( struct V_139 * V_7 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
struct V_29 * V_30 = F_53 ( V_2 ) ;
...
static int T_6 F_92 ( struct V_139 * V_7 )
{
struct V_1 * V_2 = F_52 ( V_7 ) ;
struct V_29 * V_30 = F_53 ( V_2 ) ;
