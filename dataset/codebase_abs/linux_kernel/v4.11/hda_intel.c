...
V_2 -> V_79 = V_79 [ V_9 ] ;
V_145 = F_149 ( V_2 , V_210 [ V_9 ] , & V_211 ) ;
if ( V_145 < 0 ) {
F_127 ( V_68 ) ;
F_123 ( V_25 ) ;
return V_145 ;
...
V_145 = F_150 ( V_33 , V_214 , V_2 , & V_197 ) ;
if ( V_145 < 0 ) {
F_54 ( V_33 -> V_9 , L_31 ) ;
F_113 ( V_2 ) ;
return V_145 ;
...
F_158 ( V_25 ) ;
F_159 ( V_51 -> V_90 ) ;
V_215 = F_90 ( V_2 , V_227 ) ;
F_16 ( V_33 -> V_9 , L_35 , V_215 ) ;
...
if ( ! ( V_215 & V_230 ) )
V_216 = 32 ;
if ( ! F_161 ( & V_25 -> V_9 , F_162 ( V_216 ) ) ) {
F_163 ( & V_25 -> V_9 , F_162 ( V_216 ) ) ;
} else {
F_161 ( & V_25 -> V_9 , F_162 ( 32 ) ) ;
F_163 ( & V_25 -> V_9 , F_162 ( 32 ) ) ;
}
V_2 -> V_234 = ( V_215 >> 8 ) & 0x0f ;
V_2 -> V_235 = ( V_215 >> 12 ) & 0x0f ;
...
V_2 -> V_245 = 0 ;
V_2 -> V_246 = V_2 -> V_234 ;
V_2 -> V_247 = V_2 -> V_235 + V_2 -> V_234 ;
if ( V_2 -> V_247 > 15 &&
( V_2 -> V_31 & V_248 ) == 0 ) {
F_103 ( V_2 -> V_33 -> V_9 , L_37
L_38 , V_2 -> V_247 ) ;
V_2 -> V_31 |= V_248 ;
}
V_145 = F_164 ( V_2 ) ;
...
strcpy ( V_33 -> V_251 , L_40 ) ;
F_166 ( V_33 -> V_252 , V_253 [ V_2 -> V_14 ] ,
sizeof( V_33 -> V_252 ) ) ;
snprintf ( V_33 -> V_254 , sizeof( V_33 -> V_254 ) ,
L_41 ,
V_33 -> V_252 , V_51 -> V_131 , V_51 -> V_90 ) ;
return 0 ;
}
static void F_167 ( const struct V_255 * V_152 , void * V_256 )
{
struct V_117 * V_33 = V_256 ;
struct V_1 * V_2 = V_33 -> V_13 ;
struct V_24 * V_25 = V_2 -> V_25 ;
if ( ! V_152 ) {
F_54 ( V_33 -> V_9 , L_42 ) ;
...
{
#ifdef F_156
struct V_259 * V_260 = F_193 ( V_22 ) ;
struct V_1 * V_2 = V_260 -> V_2 ;
if ( ! F_2 ( V_2 ) && V_2 -> V_14 != V_15 )
V_7 -> V_261 = F_194 ( V_7 -> V_261 ) ;
#endif
}
...
V_145 = F_196 ( & V_25 -> V_9 , V_267 [ V_9 ] , V_268 [ V_9 ] , V_269 ,
0 , & V_33 ) ;
if ( V_145 < 0 ) {
F_54 ( & V_25 -> V_9 , L_43 ) ;
return V_145 ;
}
V_145 = F_142 ( V_33 , V_25 , V_9 , V_263 -> V_270 , & V_2 ) ;
if ( V_145 < 0 )
goto V_271;
V_33 -> V_13 = V_2 ;
V_68 = F_35 ( V_2 , struct V_67 , V_2 ) ;
...
F_32 ( V_33 -> V_9 , L_47 ,
V_272 [ V_9 ] ) ;
V_145 = F_197 ( V_269 , true , V_272 [ V_9 ] ,
& V_25 -> V_9 , V_200 , V_33 ,
F_167 ) ;
if ( V_145 < 0 )
goto V_271;
...
V_2 -> V_275 = V_275 [ V_9 ] ;
#endif
V_145 = F_202 ( V_2 , V_276 [ V_2 -> V_14 ] ) ;
if ( V_145 < 0 )
goto V_271;
#ifdef F_124
if ( V_2 -> V_152 ) {
V_145 = F_203 ( & V_2 -> V_51 , V_2 -> V_152 -> V_257 ,
V_2 -> V_152 -> V_29 ) ;
if ( V_145 < 0 )
goto V_271;
#ifndef F_204
