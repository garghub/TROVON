...
V_110 = ( unsigned char * ) V_45 -> V_56 ;
F_38 ( V_158 ) ;
while ( V_109 == V_110 && ! V_45 -> V_221 ) {
if ( V_112 -> V_217 & V_218 )
return - V_222 ;
F_59 ( V_45 -> V_68 ,
! ( V_109 == V_110 && ! V_45 -> V_221 ) ) ;
if ( F_56 ( V_212 ) )
return - V_220 ;
F_37 ( V_158 ) ;
V_109 = ( unsigned char * ) V_45 -> V_54 ;
...
V_45 -> V_51 -= 2 ;
* V_45 -> V_223 = * ( unsigned short * ) V_45 -> V_52 ;
V_45 -> V_52 += 2 ;
if ( V_45 -> V_52 >= V_45 -> V_53 + V_150 )
V_45 -> V_52 = V_45 -> V_53 ;
break;
...
V_45 -> V_51 -= 3 ;
* V_45 -> V_223 = * ( unsigned int * ) V_45 -> V_52 ;
V_45 -> V_52 += 3 ;
if ( V_45 -> V_52 >= V_45 -> V_53 + V_150 )
V_45 -> V_52 = V_45 -> V_53 ;
break;
...
static void F_51 ( struct V_44 * V_45 , const char * V_224 , int V_210 )
{
V_45 -> V_50 = 1 ;
V_45 -> V_225 . V_226 = 0 ;
V_45 -> V_225 . V_227 = 0 ;
V_45 -> V_225 . V_65 = V_66 | V_228 ;
V_45 -> V_225 . V_229 = V_210 ;
V_45 -> V_225 . V_209 = F_61 ( V_224 ) ;
V_45 -> V_225 . V_230 = 0 ;
* V_45 -> V_231 = F_61 ( & V_45 -> V_225 ) ;
* V_45 -> V_232 = F_9 ( V_233 , V_155 , V_109 ) ;
F_62 ( F_4 ( V_46 L_40 ,
( unsigned long ) V_224 , V_210 ) ) ;
}
...
V_209 = F_61 ( V_45 -> V_235 ) ;
for ( V_234 = 0 ; V_234 < V_64 ; V_234 ++ ) {
V_45 -> V_62 [ V_234 ] . V_229 = V_45 -> V_59 ;
V_45 -> V_62 [ V_234 ] . V_65 = V_236 ;
V_45 -> V_62 [ V_234 ] . V_227 = F_61 ( & V_45 -> V_62 [ V_234 + 1 ] ) ;
V_45 -> V_62 [ V_234 ] . V_209 = V_209 ;
V_45 -> V_62 [ V_234 ] . V_226 = 0 ;
V_45 -> V_62 [ V_234 ] . V_230 = 0 ;
V_45 -> V_62 [ V_234 ] . V_237 = 0 ;
V_209 += V_45 -> V_59 ;
F_63 ( & V_45 -> V_62 [ V_234 ] ) ;
}
V_45 -> V_62 [ V_234 - 1 ] . V_227 = F_61 ( & V_45 -> V_62 [ 0 ] ) ;
V_45 -> V_62 [ V_234 - 1 ] . V_65 |= V_66 ;
V_45 -> V_61 = & V_45 -> V_62 [ 0 ] ;
V_45 -> V_63 = & V_45 -> V_62 [ V_64 - 1 ] ;
* V_45 -> V_238 = F_61 ( V_45 -> V_61 ) ;
* V_45 -> V_239 = F_9 ( V_233 , V_155 , V_109 ) ;
}
static T_6 V_121 ( int V_240 , void * V_241 )
{
...
int V_247 = 0 ;
int V_234 ;
for ( V_234 = 0 ; V_234 < V_117 ; V_234 ++ ) {
struct V_44 * V_45 = & V_1 [ V_234 ] ;
if ( ! V_45 -> V_2 || ! V_45 -> V_22 )
continue;
if ( ! ( V_242 & ( 1 << V_45 -> V_248 ) ) )
continue;
V_247 = 1 ;
* V_45 -> V_249 =
...
static T_6 V_122 ( int V_240 , void * V_241 )
{
unsigned long V_242 = * V_243 ;
int V_234 ;
int V_247 = 0 ;
...
V_45 -> V_61 -> V_227 ) ;
F_64 ( & V_45 -> V_68 ) ;
* V_45 -> V_239 = F_9 ( V_254 ,
V_155 , V_255 ) ;
* V_45 -> V_256 = F_9 (R_DMA_CH0_CLR_INTR,
clr_descr, do) ;
}
}
return F_65 ( V_247 ) ;
}
static T_6 V_136 ( int V_240 , void * V_241 )
{
int V_234 ;
int V_247 = 0 ;
for ( V_234 = 0 ; V_234 < V_117 ; V_234 ++ ) {
...
if ( ! V_45 -> V_2 || V_45 -> V_22 )
continue;
if ( * V_257 & ( 1 << V_45 -> V_145 ) ) {
V_247 = 1 ;
switch ( V_45 -> V_69 &
F_67 ( V_70 , V_89 ) ) {
case F_9 ( V_70 , V_89 , V_90 ) :
* V_45 -> V_56 ++ =
* ( volatile char * ) V_45 -> V_258 ;
break;
case F_9 ( V_70 , V_89 , V_179 ) :
{
int V_224 = * ( unsigned short * ) V_45 -> V_258 ;
* V_45 -> V_56 = ( V_224 & 0x0ff0 ) >> 4 ;
* ( V_45 -> V_56 + 1 ) = V_224 & 0x0f ;
V_45 -> V_56 += 2 ;
break;
}
case F_9 ( V_70 , V_89 , V_181 ) :
* ( unsigned short * ) V_45 -> V_56 =
* ( volatile unsigned short * ) V_45 -> V_258 ;
V_45 -> V_56 += 2 ;
break;
case F_9 ( V_70 , V_89 , V_183 ) :
* ( unsigned int * ) V_45 -> V_56 = * V_45 -> V_258 ;
V_45 -> V_56 += 3 ;
break;
