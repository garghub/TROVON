...
while ( V_110 < 0 &&
( V_37 = F_70 ( V_40 , V_79 , & V_105 ) ) != NULL ) {
F_82 ( V_114 , V_37 , 1 ) ;
V_110 ++ ;
}
return error ;
...
static int F_85 ( struct V_43 * V_43 , const T_1 V_117 ,
const T_1 V_118 ,
...
error = F_88 ( V_43 , V_117 , V_118 ,
( const struct V_134 * ) & sin , V_128 ) ;
if ( error == - V_135 )
error = F_89 ( V_43 , V_117 , V_118 , V_119 , V_120 ) ;
return error ;
}
...
static int F_91 ( struct V_43 * V_43 , const char * V_146 ,
...
int F_93 ( const struct V_39 * V_40 , struct V_43 * V_43 ,
...
continue;
error = F_91 ( V_43 , V_45 -> V_62 , V_45 -> V_154 ,
...
static void F_94 ( struct V_43 * V_43 , const T_1 V_117 , const T_1 V_118 ,
const char * V_146 )
{
int error ;
error = F_88 ( V_43 , V_117 , V_118 , NULL , L_14 ) ;
if ( error == - V_135 )
error = F_89 ( V_43 , V_117 , V_118 , 0 , 0 ) ;
F_42 ( L_17 ,
...
F_42 ( L_18 ,
V_45 -> V_62 , V_46 ) ;
F_94 ( V_43 , V_45 -> V_154 , V_46 , V_45 -> V_62 ) ;
}
}
F_96 ( & V_160 -> V_161 -> V_162 , V_158 ) ;
F_97 () ;
F_98 ( & V_160 -> V_161 -> V_162 , V_158 ) ;
}
int
F_99 ( struct V_39 * V_40 , struct V_163 * V_164 ,
struct V_86 * V_87 )
{
...
F_100 ( V_166 ) ;
F_101 ( V_166 ) ;
V_172 = F_102 ( V_87 , V_166 , V_169 ) ;
F_103 ( & V_164 -> V_173 -> V_187 ) ;
if ( ! V_172 ) {
F_104 ( V_164 ) ;
return 0 ;
}
...
T_1 F_108 ( const struct V_86 * V_87 )
{
