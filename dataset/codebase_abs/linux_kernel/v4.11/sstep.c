...
static unsigned long T_1 F_9 ( unsigned int V_4 ,
struct V_5 * V_6 )
{
int V_14 , V_16 ;
unsigned long V_11 ;
...
static inline unsigned long F_10 ( unsigned long V_17 )
{
V_17 |= sizeof( unsigned long ) ;
return V_17 & - V_17 ;
}
static inline unsigned long F_11 ( unsigned long V_17 )
{
return ( ( V_17 >> 8 ) & 0xff ) | ( ( V_17 & 0xff ) << 8 ) ;
}
static inline unsigned long F_12 ( unsigned long V_17 )
{
return ( ( V_17 >> 24 ) & 0xff ) | ( ( V_17 >> 8 ) & 0xff00 ) |
( ( V_17 & 0xff00 ) << 8 ) | ( ( V_17 & 0xff ) << 24 ) ;
}
static inline unsigned long F_13 ( unsigned long V_17 )
{
return ( F_12 ( V_17 ) << 32 ) | F_12 ( V_17 >> 32 ) ;
}
static int T_1 F_14 ( unsigned long * V_18 , unsigned long V_11 ,
int V_12 )
{
int V_19 = 0 ;
...
static int T_1 F_16 ( unsigned long * V_18 , unsigned long V_11 ,
...
static int T_1 F_19 ( unsigned long * V_18 , unsigned long V_11 , int V_12 ,
struct V_5 * V_6 )
{
...
static int T_1 F_24 ( int V_25 , int (* F_25)( int , unsigned long ) ,
...
static int T_1 F_26 ( int V_25 , int (* F_25)( int , unsigned long ) ,
unsigned long V_11 , int V_12 ,
struct V_5 * V_6 )
{
int V_19 ;
...
static int T_1 F_27 ( int V_25 , int (* F_25)( int , unsigned long ) ,
...
static int T_1 F_28 ( int V_25 , int (* F_25)( int , unsigned long ) ,
unsigned long V_11 , struct V_5 * V_6 )
{
if ( ! F_4 ( V_6 , V_11 & ~ 0xfUL , 16 ) )
return - V_24 ;
...
static int T_1 F_29 ( int V_25 , int (* F_25)( int , unsigned long ) ,
unsigned long V_11 , struct V_5 * V_6 )
{
int V_19 ;
unsigned long V_2 [ 2 ] ;
...
static int T_1 F_30 ( int V_25 , int (* F_25)( int , unsigned long ) ,
unsigned long V_11 , struct V_5 * V_6 )
{
int V_19 ;
unsigned long V_2 [ 2 ] ;
...
static void T_1 F_31 ( struct V_5 * V_6 , int V_33 )
{
...
static void T_1 F_32 ( struct V_5 * V_6 , int V_33 ,
...
static void T_1 F_33 ( struct V_5 * V_6 , long V_39 , long V_40 ,
int V_41 )
{
...
static void T_1 F_34 ( struct V_5 * V_6 , unsigned long V_39 ,
...
static int T_1 F_35 ( long V_39 , long V_40 )
{
int V_44 = 0 ;
if ( V_39 < V_40 )
V_44 |= 0x10 ;
...
int T_1 F_36 ( struct V_45 * V_46 , struct V_5 * V_6 ,
unsigned int V_4 )
{
...
int T_1 F_59 ( struct V_5 * V_6 , unsigned int V_4 )
{
struct V_45 V_46 ;
