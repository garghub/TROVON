...
unsigned long V_307 , void * V_75 )
{
struct V_8 * V_8 = F_207 ( V_314 , struct V_8 , V_315 ) ;
struct V_305 * V_306 ;
V_306 = F_5 ( sizeof( * V_306 ) , V_316 ) ;
if ( F_212 ( ! V_306 ) )
return V_317 ;
F_213 ( & V_306 -> V_304 , F_206 ) ;
V_306 -> V_8 = V_8 ;
V_306 -> V_307 = V_307 ;
switch ( V_307 ) {
case V_308 :
...
F_214 ( V_306 -> V_249 . V_309 ) ;
break;
}
F_215 ( V_8 -> V_318 , & V_306 -> V_304 ) ;
return V_319 ;
}
static int F_216 ( struct V_116 * V_18 ,
struct V_167 * V_168 )
{
struct V_11 * V_11 = F_171 ( V_18 ) ;
return F_136 ( V_11 , V_168 ) ;
}
static int F_217 ( struct V_116 * V_18 ,
struct V_167 * V_168 )
{
struct V_11 * V_11 = F_171 ( V_18 ) ;
return F_139 ( V_11 , V_168 ) ;
}
static void F_218 ( struct V_116 * V_18 ,
struct V_320 * V_321 )
{
F_219 ( V_321 -> V_322 , V_47 , sizeof( V_321 -> V_322 ) ) ;
F_219 ( V_321 -> V_323 , V_324 , sizeof( V_321 -> V_323 ) ) ;
}
static void F_220 ( struct V_116 * V_325 , T_1 V_326 ,
T_10 * V_91 )
{
T_10 * V_278 = V_91 ;
int V_26 ;
switch ( V_326 ) {
case V_327 :
for ( V_26 = 0 ; V_26 < F_221 ( V_328 ) ; V_26 ++ ) {
memcpy ( V_278 , V_328 [ V_26 ] . V_198 , V_329 ) ;
V_278 += V_329 ;
}
break;
}
...
{
const struct V_117 * V_118 [ V_169 + 1 ] ;
const struct V_117 * V_333 [ V_334 + 1 ] ;
const struct V_117 * V_335 ;
T_1 V_135 ;
T_2 * V_91 = V_161 ;
int V_26 ;
F_83 ( V_118 , V_169 , V_53 ) ;
...
if ( ! V_333 [ V_332 ] )
return - V_19 ;
V_135 = F_102 ( V_333 [ V_332 ] ) ;
if ( V_135 != V_11 -> V_135 )
return - V_19 ;
for ( V_26 = 0 ; V_26 < F_221 ( V_328 ) ; V_26 ++ ) {
V_335 = V_333 [ V_328 [ V_26 ] . type ] ;
if ( ! V_335 )
continue;
V_91 [ V_26 ] = F_80 ( V_335 ) ;
}
return 0 ;
}
static int F_224 ( struct V_11 * V_11 ,
void * V_161 )
{
return F_114 ( V_11 , false ,
F_222 , NULL ,
...
static void F_225 ( struct V_116 * V_18 ,
struct V_336 * V_276 , T_2 * V_91 )
{
struct V_11 * V_11 = F_171 ( V_18 ) ;
if ( F_224 ( V_11 , V_91 ) != 0 ) {
int V_26 ;
for ( V_26 = 0 ; V_26 < F_221 ( V_328 ) ; ++ V_26 )
V_91 [ V_26 ] = 0 ;
}
}
static int F_226 ( struct V_116 * V_325 , int V_337 )
{
switch ( V_337 ) {
case V_327 :
return V_338 ;
...
static struct V_11 * F_227 ( struct V_339 * V_340 )
{
return F_207 ( V_340 , struct V_11 , V_153 ) ;
}
static int F_228 ( struct V_339 * V_340 , int V_341 )
{
struct V_11 * V_11 = F_227 ( V_340 ) ;
const struct V_8 * V_8 = V_11 -> V_8 ;
const struct V_52 * V_53 ;
T_1 V_83 = 0 ;
int V_30 ;
...
V_107 = F_38 ( V_53 ) ;
if ( V_30 == 0 ) {
V_11 -> V_18 -> V_276 . V_342 ++ ;
V_11 -> V_18 -> V_276 . V_343 += V_107 -> V_119 ;
} else {
...
if ( V_83 && F_229 ( V_11 -> V_18 ) )
F_230 ( V_11 -> V_18 ) ;
F_231 ( V_340 ) ;
F_46 ( V_8 , & V_11 -> V_123 , V_83 ) ;
return 0 ;
}
static int F_232 ( const struct V_8 * V_8 ,
...
return - V_66 ;
if ( V_118 [ V_348 ] )
V_346 = F_81 ( V_118 [ V_348 ] ) ;
F_79 ( V_8 , V_118 ) ;
V_345 = F_81 ( V_118 [ V_347 ] ) ;
F_233 ( V_107 , V_345 ) ;
V_107 -> V_349 = F_234 ( V_107 , V_11 -> V_18 ) ;
if ( V_346 & V_350 )
V_107 -> V_351 = 1 ;
V_11 -> V_18 -> V_276 . V_352 ++ ;
V_11 -> V_18 -> V_276 . V_353 += V_107 -> V_119 ;
F_235 ( V_107 ) ;
return F_76 ( V_11 , V_53 ) ;
}
static struct V_11 * F_236 ( struct V_339 * V_340 )
{
return F_207 ( V_340 , struct V_11 , V_154 ) ;
}
static int F_237 ( struct V_339 * V_340 , int V_341 )
{
struct V_11 * V_11 = F_236 ( V_340 ) ;
const struct V_8 * V_8 = V_11 -> V_8 ;
struct V_52 * V_53 ;
T_1 V_83 = 0 ;
int V_30 ;
...
static void F_239 ( const struct V_11 * V_11 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
T_2 V_355 = F_23 ( V_8 , V_356 ) ;
bool V_137 ;
V_137 = V_355 & ( 1 << V_11 -> V_135 ) ;
if ( V_137 )
F_96 ( V_11 -> V_18 ) ;
else
F_99 ( V_11 -> V_18 ) ;
}
static void F_240 ( struct V_8 * V_8 )
{
struct V_11 * V_11 ;
int V_26 ;
...
static void F_243 ( struct V_11 * V_11 )
{
const struct V_8 * V_8 = V_11 -> V_8 ;
const struct V_13 * V_14 = V_8 -> V_14 ;
int V_30 ;
...
V_11 -> V_18 -> V_282 ) ;
if ( V_30 ) {
F_244 ( & V_14 -> V_18 , L_35 ) ;
F_245 ( V_11 -> V_18 ) ;
}
}
static int F_246 ( struct V_8 * V_8 , unsigned int V_12 )
{
struct V_13 * V_14 = V_8 -> V_14 ;
struct V_11 * V_11 ;
struct V_116 * V_18 ;
int V_30 ;
V_18 = F_247 ( sizeof( struct V_11 ) ) ;
if ( ! V_18 )
return - V_33 ;
F_248 ( V_18 , & V_14 -> V_18 ) ;
V_11 = F_171 ( V_18 ) ;
V_11 -> V_18 = V_18 ;
V_11 -> V_8 = V_8 ;
V_11 -> V_12 = V_12 ;
...
V_18 -> V_360 = & V_361 ;
V_18 -> V_362 = & V_363 ;
F_249 ( V_18 , & V_11 -> V_153 , F_228 ,
V_364 ) ;
F_250 ( V_18 , & V_11 -> V_154 , F_237 ,
V_364 ) ;
F_239 ( V_11 ) ;
V_18 -> V_365 |= V_366 | V_367 ;
V_18 -> V_368 = V_369 ;
V_18 -> V_370 = V_371 ;
V_30 = F_147 ( V_11 ) ;
if ( V_30 ) {
...
static int F_252 ( struct V_8 * V_8 )
{
int V_26 ;
T_4 V_375 ;
int V_30 ;
V_375 = sizeof( struct V_11 * ) * V_8 -> V_140 ;
V_8 -> V_141 = F_5 ( V_375 , V_5 ) ;
if ( ! V_8 -> V_141 )
return - V_33 ;
for ( V_26 = 0 ; V_26 < V_8 -> V_140 ; V_26 ++ ) {
V_30 = F_246 ( V_8 , V_26 ) ;
...
V_8 -> V_10 [ V_26 ] . V_378 = V_26 ;
V_30 = F_257 ( V_14 , V_8 -> V_10 , V_10 ) ;
if ( V_30 < 0 )
goto V_379;
return 0 ;
V_379:
...
static void F_258 ( const struct V_8 * V_8 )
{
F_259 ( V_8 -> V_14 ) ;
F_7 ( V_8 -> V_10 ) ;
}
static int F_260 ( struct V_13 * V_14 , const struct V_380 * V_289 )
{
struct V_8 * V_8 ;
int V_30 ;
...
V_30 = F_262 ( V_14 , V_47 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_41 ) ;
goto V_382;
}
V_30 = F_263 ( V_14 , F_264 ( 64 ) ) ;
if ( ! V_30 ) {
V_30 = F_265 ( V_14 , F_264 ( 64 ) ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_42 ) ;
goto V_383;
}
} else {
V_30 = F_263 ( V_14 , F_264 ( 32 ) ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_43 ) ;
goto V_383;
}
}
if ( F_266 ( V_14 , 0 ) < V_384 ) {
F_21 ( & V_14 -> V_18 , L_44 ) ;
V_30 = - V_66 ;
goto V_385;
}
V_8 -> V_386 = F_267 ( F_268 ( V_14 , 0 ) ,
F_266 ( V_14 , 0 ) ) ;
if ( ! V_8 -> V_386 ) {
F_21 ( & V_14 -> V_18 , L_45 ) ;
V_30 = - V_19 ;
...
F_19 ( V_8 , V_391 , V_392 ) ;
V_30 = F_69 ( V_8 ) ;
if ( V_30 )
goto V_393;
V_30 = F_33 ( F_12 ( V_8 , V_394 ) ,
F_92 , 0 ,
V_47 , V_8 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_48 ) ;
...
V_8 -> V_318 = F_271 ( V_47 ,
V_398 ) ;
if ( ! V_8 -> V_318 ) {
V_30 = - V_33 ;
goto V_399;
}
V_8 -> V_315 . V_400 = F_211 ;
V_30 = F_272 ( & V_8 -> V_315 , NULL ) ;
if ( V_30 )
goto V_401;
V_8 -> V_294 . V_289 = F_23 ( V_8 , V_402 ) ;
V_30 = F_252 ( V_8 ) ;
if ( V_30 ) {
F_21 ( & V_14 -> V_18 , L_50 ) ;
goto V_403;
}
F_273 ( & V_14 -> V_18 , L_51 ,
...
F_275 ( V_8 -> V_318 ) ;
V_399:
V_49 ( F_12 ( V_8 , V_396 ) , V_8 ) ;
V_397:
V_49 ( F_12 ( V_8 , V_394 ) , V_8 ) ;
V_395:
F_71 ( V_8 ) ;
V_393:
V_390:
...
static void F_279 ( struct V_13 * V_14 )
{
struct V_8 * V_8 = F_280 ( V_14 ) ;
F_240 ( V_8 ) ;
F_274 ( & V_8 -> V_315 ) ;
F_19 ( V_8 , V_391 , V_392 ) ;
F_275 ( V_8 -> V_318 ) ;
...
static bool F_281 ( const struct V_116 * V_18 )
{
return V_18 -> V_358 == & V_359 ;
}
static bool F_282 ( const struct V_116 * V_18 ,
struct V_8 * V_8 )
{
struct V_11 * V_11 ;
if ( ! F_281 ( V_18 ) )
...
static int F_283 ( struct V_116 * V_404 , void * V_405 )
{
struct V_406 * V_91 = V_405 ;
int V_407 = 0 ;
if ( F_282 ( V_404 , V_91 -> V_8 ) ) {
V_91 -> V_183 = F_171 ( V_404 ) ;
V_407 = 1 ;
}
return V_407 ;
}
struct V_11 * F_284 ( struct V_116 * V_18 ,
struct V_8 * V_8 )
{
struct V_406 V_91 ;
if ( F_282 ( V_18 , V_8 ) )
...
V_91 . V_8 = V_8 ;
V_91 . V_183 = NULL ;
F_285 ( V_18 , F_283 , & V_91 ) ;
return V_91 . V_183 ;
}
static int F_286 ( struct V_313 * V_408 ,
unsigned long V_307 , void * V_75 )
{
struct V_116 * V_18 = F_287 ( V_75 ) ;
struct V_409 * V_77 ;
struct V_11 * V_11 ;
int V_30 ;
if ( ! F_281 ( V_18 ) )
...
static int F_288 ( struct V_313 * V_408 ,
unsigned long V_307 , void * V_75 )
{
struct V_11 * V_11 ;
struct V_116 * V_18 ;
