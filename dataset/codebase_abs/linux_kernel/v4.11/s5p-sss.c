...
{
F_24 ( V_5 -> V_5 , V_5 -> V_34 , 1 , V_35 ) ;
}
static void F_25 ( struct V_12 * V_5 )
{
F_24 ( V_5 -> V_5 , V_5 -> V_36 , 1 , V_37 ) ;
}
static int F_26 ( struct V_12 * V_5 , struct V_13 * V_38 ,
struct V_13 * * V_28 )
{
void * V_39 ;
int V_19 ;
* V_28 = F_27 ( sizeof( * * V_28 ) , V_40 ) ;
if ( ! * V_28 )
return - V_41 ;
V_19 = F_11 ( V_5 -> V_20 -> V_21 , V_22 ) ;
V_39 = ( void * ) F_28 ( V_40 , F_14 ( V_19 ) ) ;
if ( ! V_39 ) {
F_15 ( * V_28 ) ;
* V_28 = NULL ;
return - V_41 ;
...
F_25 ( V_5 ) ;
if ( ! F_35 ( V_5 -> V_36 ) ) {
V_44 = F_33 ( V_5 , F_36 ( V_5 -> V_36 ) ) ;
if ( ! V_44 )
V_44 = 1 ;
}
return V_44 ;
}
static T_1 F_38 ( int V_45 , void * V_46 )
{
struct V_2 * V_3 = V_46 ;
...
F_85 ( V_3 , V_119 ) ;
V_111 = V_119 ;
F_86 ( & V_119 -> V_57 , F_54 , ( unsigned long ) V_119 ) ;
