...
V_14 = F_330 ( V_95 , V_205 , V_362 , V_33 ) ;
if ( V_14 && F_313 ( V_95 ) &&
...
V_258 = V_282 -> V_284 - V_282 -> V_283 + 1 ;
V_395 -> V_397 = F_367 ( V_282 -> V_283 , V_258 , V_252 ,
V_398 ) ;
if ( ! V_395 -> V_397 )
goto V_399;
V_395 -> V_106 = F_368 ( ( void * ) ( V_282 + 1 ) ,
( ( void * ) V_282 ) + V_282 -> V_392 . V_258 ,
& V_395 -> V_377 ) ;
if ( V_395 -> V_377 && V_395 -> V_106 == NULL )
goto V_400;
F_241 ( & V_395 -> V_401 , & V_402 ) ;
return 0 ;
V_400:
F_176 ( V_395 -> V_397 ) ;
V_399:
...
static struct V_403 * F_369 ( struct V_404 * V_405 )
{
struct V_403 * V_406 ;
struct V_404 * V_98 ;
F_370 (atsru, &dmar_atsr_units, list) {
V_98 = (struct V_404 * ) V_406 -> V_396 ;
if ( V_405 -> V_102 != V_98 -> V_102 )
continue;
if ( V_405 -> V_392 . V_258 != V_98 -> V_392 . V_258 )
continue;
if ( memcmp ( V_405 , V_98 , V_405 -> V_392 . V_258 ) == 0 )
return V_406 ;
}
return NULL ;
}
int F_371 ( struct V_391 * V_396 , void * V_393 )
{
struct V_404 * V_405 ;
struct V_403 * V_406 ;
if ( V_407 != V_408 && ! V_409 )
return 0 ;
V_405 = F_46 ( V_396 , struct V_404 , V_392 ) ;
V_406 = F_369 ( V_405 ) ;
if ( V_406 )
return 0 ;
V_406 = F_52 ( sizeof( * V_406 ) + V_396 -> V_258 , V_198 ) ;
if ( ! V_406 )
return - V_139 ;
V_406 -> V_396 = ( void * ) ( V_406 + 1 ) ;
memcpy ( V_406 -> V_396 , V_396 , V_396 -> V_258 ) ;
V_406 -> V_112 = V_405 -> V_33 & 0x1 ;
if ( ! V_406 -> V_112 ) {
V_406 -> V_106 = F_368 ( ( void * ) ( V_405 + 1 ) ,
( void * ) V_405 + V_405 -> V_392 . V_258 ,
& V_406 -> V_377 ) ;
if ( V_406 -> V_377 && V_406 -> V_106 == NULL ) {
F_176 ( V_406 ) ;
return - V_139 ;
}
}
F_372 ( & V_406 -> V_401 , & V_410 ) ;
return 0 ;
}
static void F_373 ( struct V_403 * V_406 )
{
F_374 ( & V_406 -> V_106 , & V_406 -> V_377 ) ;
F_176 ( V_406 ) ;
}
int F_375 ( struct V_391 * V_396 , void * V_393 )
{
struct V_404 * V_405 ;
struct V_403 * V_406 ;
V_405 = F_46 ( V_396 , struct V_404 , V_392 ) ;
...
int F_378 ( struct V_391 * V_396 , void * V_393 )
{
int V_79 ;
struct V_94 * V_95 ;
struct V_404 * V_405 ;
...
if ( ! V_406 )
return 0 ;
if ( ! V_406 -> V_112 && V_406 -> V_106 && V_406 -> V_377 ) {
...
static int F_379 ( struct V_76 * V_411 )
{
int V_412 , V_83 = 0 ;
struct V_31 * V_32 = V_411 -> V_32 ;
if ( V_75 [ V_32 -> V_187 ] )
return 0 ;
...
V_412 = F_84 ( V_32 ) - 1 ;
if ( V_412 >= 0 && ! ( F_85 ( V_32 -> V_71 ) & ( 1 << V_412 ) ) ) {
F_250 ( L_72 ,
V_32 -> V_138 ) ;
return - V_413 ;
}
...
int F_380 ( struct V_76 * V_411 , bool V_415 )
{
int V_83 = 0 ;
struct V_31 * V_32 = V_411 -> V_32 ;
if ( ! V_409 )
...
{
struct V_281 * V_395 , * V_416 ;
struct V_403 * V_406 , * V_417 ;
F_179 (rmrru, rmrr_n, &dmar_rmrr_units, list) {
F_233 ( & V_395 -> V_401 ) ;
F_374 ( & V_395 -> V_106 , & V_395 -> V_377 ) ;
F_176 ( V_395 -> V_397 ) ;
F_176 ( V_395 ) ;
}
...
F_275 ( V_419 ) == V_295 )
return 0 ;
if ( F_275 ( V_419 ) == V_421 )
break;
}
F_79 () ;
F_370 (atsru, &dmar_atsr_units, list) {
V_405 = F_46 ( V_406 -> V_396 , struct V_404 , V_392 ) ;
if ( V_405 -> V_102 != F_98 ( V_95 -> V_87 ) )
continue;
...
struct V_404 * V_405 ;
struct V_394 * V_282 ;
if ( ! V_409 && V_407 != V_408 )
return 0 ;
F_146 (rmrru, &dmar_rmrr_units, list) {
V_282 = F_46 ( V_395 -> V_396 ,
struct V_394 , V_392 ) ;
if ( V_170 -> V_423 == V_424 ) {
V_83 = F_384 ( V_170 , ( void * ) ( V_282 + 1 ) ,
( ( void * ) V_282 ) + V_282 -> V_392 . V_258 ,
V_282 -> V_102 , V_395 -> V_106 ,
V_395 -> V_377 ) ;
if( V_83 < 0 )
return V_83 ;
} else if ( V_170 -> V_423 == V_425 ) {
F_385 ( V_170 , V_282 -> V_102 ,
...
V_405 = F_46 ( V_406 -> V_396 , struct V_404 , V_392 ) ;
if ( V_170 -> V_423 == V_424 ) {
V_83 = F_384 ( V_170 , ( void * ) ( V_405 + 1 ) ,
( void * ) V_405 + V_405 -> V_392 . V_258 ,
V_405 -> V_102 , V_406 -> V_106 ,
V_406 -> V_377 ) ;
if ( V_83 > 0 )
break;
else if( V_83 < 0 )
...
if ( F_385 ( V_170 , V_405 -> V_102 ,
V_406 -> V_106 , V_406 -> V_377 ) )
break;
}
}
return 0 ;
}
static int F_386 ( struct V_426 * V_427 ,
unsigned long V_428 , void * V_239 )
{
...
return 0 ;
F_243 ( V_42 , V_95 ) ;
if ( ! F_67 ( V_42 ) && F_387 ( & V_42 -> V_106 ) )
F_181 ( V_42 ) ;
return 0 ;
}
static int F_388 ( struct V_426 * V_427 ,
unsigned long V_29 , void * V_429 )
{
struct V_430 * V_431 = V_429 ;
unsigned long long V_220 , V_111 ;
unsigned long V_369 , V_275 ;
switch ( V_29 ) {
case V_432 :
V_220 = V_431 -> V_128 << V_11 ;
V_111 = ( ( V_431 -> V_128 + V_431 -> V_251 ) << V_11 ) - 1 ;
...
case V_434 :
case V_435 :
V_369 = F_13 ( V_431 -> V_128 ) ;
V_275 = F_13 ( V_431 -> V_128 + V_431 -> V_251 - 1 ) ;
while ( V_369 <= V_275 ) {
struct V_207 * V_207 ;
struct V_76 * V_77 ;
struct V_31 * V_32 ;
struct V_14 * V_135 ;
V_207 = F_389 ( & V_276 -> V_221 , V_369 ) ;
if ( V_207 == NULL ) {
F_143 ( L_74 ,
V_369 ) ;
break;
}
V_207 = F_390 ( & V_276 -> V_221 , V_207 ,
V_369 , V_275 ) ;
if ( V_207 == NULL ) {
F_250 ( L_75 ,
V_369 , V_275 ) ;
...
V_135 = F_120 ( V_276 , V_207 -> V_436 ,
V_207 -> V_437 ) ;
F_79 () ;
F_80 (iommu, drhd)
F_161 ( V_32 , V_276 ,
V_207 -> V_436 , F_391 ( V_207 ) ,
! V_135 , 0 ) ;
F_81 () ;
F_121 ( V_135 ) ;
V_369 = V_207 -> V_437 + 1 ;
...
static void F_393 ( unsigned int V_225 )
{
int V_79 ;
for ( V_79 = 0 ; V_79 < V_74 ; V_79 ++ ) {
struct V_31 * V_32 = V_75 [ V_79 ] ;
...
if ( ! V_42 )
continue;
F_394 ( V_225 , & V_42 -> V_221 ) ;
}
}
}
static int F_395 ( unsigned int V_225 )
{
F_393 ( V_225 ) ;
F_205 ( V_225 ) ;
return 0 ;
}
static inline struct V_31 * F_396 ( struct V_94 * V_95 )
{
return F_46 ( V_95 , struct V_31 , V_32 . V_95 ) ;
}
...
T_2 V_442 = F_44 ( V_32 -> V_36 + V_443 ) ;
return sprintf ( V_441 , L_76 ,
F_398 ( V_442 ) , F_399 ( V_442 ) ) ;
}
...
{
struct V_31 * V_32 = F_396 ( V_95 ) ;
return sprintf ( V_441 , L_77 , V_32 -> V_444 ) ;
}
...
{
struct V_31 * V_32 = F_396 ( V_95 ) ;
return sprintf ( V_441 , L_77 , V_32 -> V_71 ) ;
}
...
{
struct V_31 * V_32 = F_396 ( V_95 ) ;
return sprintf ( V_441 , L_77 , V_32 -> V_81 ) ;
}
...
{
struct V_31 * V_32 = F_396 ( V_95 ) ;
return sprintf ( V_441 , L_78 , F_171 ( V_32 -> V_71 ) ) ;
}
static T_9 F_404 ( struct V_94 * V_95 ,
struct V_439 * V_440 ,
char * V_441 )
{
struct V_31 * V_32 = F_396 ( V_95 ) ;
return sprintf ( V_441 , L_79 , F_405 ( V_32 -> V_197 ,
F_171 ( V_32 -> V_71 ) ) ) ;
}
int T_3 F_406 ( void )
{
...
static int F_420 ( struct V_99 * V_101 , T_4 V_236 , void * V_237 )
{
struct V_31 * V_32 = V_237 ;
F_231 ( V_32 , F_214 ( V_236 ) , V_236 & 0xff ) ;
return 0 ;
}
static void F_421 ( struct V_31 * V_32 , struct V_94 * V_95 )
{
if ( ! V_32 || ! V_95 || ! F_95 ( V_95 ) )
return;
F_216 ( F_96 ( V_95 ) , & F_420 , V_32 ) ;
}
...
V_42 = & V_39 -> V_42 ;
V_42 -> V_460 . V_461 = 0 ;
V_42 -> V_460 . V_462 = F_423 ( V_39 -> V_134 ) ;
V_42 -> V_460 . V_463 = true ;
return V_42 ;
}
...
if ( V_39 -> V_458 > ( 1LL << V_67 ) ) {
F_123 ( L_94
L_95 ,
V_466 , V_67 , V_39 -> V_458 ) ;
return - V_287 ;
}
V_39 -> V_134 = V_67 ;
...
if ( V_468 & V_470 )
V_252 |= V_125 ;
if ( ( V_468 & V_471 ) && V_39 -> V_85 )
V_252 |= V_257 ;
V_458 = V_207 + V_58 ;
if ( V_39 -> V_458 < V_458 ) {
V_24 V_111 ;
V_111 = F_423 ( V_39 -> V_134 ) + 1 ;
if ( V_111 < V_458 ) {
F_123 ( L_94
L_95 ,
V_466 , V_39 -> V_134 , V_458 ) ;
return - V_287 ;
}
V_39 -> V_458 = V_458 ;
}
V_58 = F_219 ( V_467 , V_58 ) ;
V_83 = F_230 ( V_39 , V_207 >> V_12 ,
V_467 >> V_12 , V_58 , V_252 ) ;
return V_83 ;
}
...
static bool F_431 ( enum V_474 V_71 )
{
if ( V_71 == V_475 )
return F_82 ( NULL ) == 1 ;
if ( V_71 == V_476 )
...
static int F_432 ( struct V_94 * V_95 )
{
struct V_31 * V_32 ;
struct V_478 * V_479 ;
T_6 V_87 , V_88 ;
...
static void F_438 ( struct V_94 * V_95 )
{
struct V_31 * V_32 ;
T_6 V_87 , V_88 ;
V_32 = F_94 ( V_95 , & V_87 , & V_88 ) ;
...
return;
F_439 ( V_95 ) ;
F_440 ( & V_32 -> V_32 , V_95 ) ;
}
static void F_441 ( struct V_94 * V_94 ,
struct V_480 * V_481 )
{
struct V_482 * V_36 ;
struct V_281 * V_282 ;
...
if ( ! V_36 )
return;
F_442 ( & V_36 -> V_401 , V_481 ) ;
}
static void F_443 ( struct V_94 * V_95 ,
struct V_480 * V_481 )
{
struct V_482 * V_91 , * V_133 ;
...
{
if ( F_445 ( V_32 -> V_81 ) < 5 )
return 0 ;
return F_446 ( ( unsigned long * ) & V_32 -> V_485 ,
V_486 ) - 5 ;
}
int F_447 ( struct V_31 * V_32 , struct V_487 * V_488 )
{
struct V_169 * V_170 ;
struct V_22 * V_23 ;
struct V_39 * V_42 ;
...
V_24 V_489 ;
int V_83 ;
V_42 = F_312 ( V_488 -> V_95 ) ;
if ( ! V_42 )
return - V_44 ;
F_105 ( & V_171 , V_33 ) ;
F_211 ( & V_32 -> V_114 ) ;
V_83 = - V_44 ;
V_170 = V_488 -> V_95 -> V_96 . V_32 ;
...
goto V_107;
V_489 = V_23 [ 0 ] . V_19 ;
V_488 -> V_55 = V_42 -> V_186 [ V_32 -> V_187 ] ;
V_488 -> V_181 = F_448 ( V_170 -> V_87 , V_170 -> V_88 ) ;
if ( ! ( V_489 & V_490 ) ) {
V_23 [ 1 ] . V_21 = ( V_24 ) F_92 ( V_32 -> V_491 ) ;
V_23 [ 1 ] . V_19 = ( V_24 ) F_92 ( V_32 -> V_492 ) |
F_444 ( V_32 ) ;
F_449 () ;
if ( ( V_489 & V_493 ) == ( V_229 << 2 ) ) {
V_489 &= ~ V_493 ;
if ( V_170 -> V_173 )
V_489 |= V_494 << 2 ;
else
...
V_23 [ 0 ] . V_19 = V_489 ;
F_449 () ;
V_32 -> V_188 . V_232 ( V_32 , V_488 -> V_55 , V_488 -> V_181 ,
V_233 ,
V_157 ) ;
}
if ( ! V_170 -> V_177 )
...
if ( V_170 -> V_175 ) {
V_488 -> V_498 = 1 ;
V_488 -> V_182 = V_170 -> V_180 ;
if ( V_488 -> V_182 >= V_499 )
V_488 -> V_182 = 0 ;
}
V_83 = 0 ;
V_107:
...
struct V_31 * F_450 ( struct V_94 * V_95 )
{
struct V_31 * V_32 ;
T_6 V_87 , V_88 ;
if ( F_93 ( V_95 ) ) {
...
static void F_451 ( struct V_99 * V_95 )
{
F_48 ( L_99 ) ;
V_46 = 0 ;
}
static void F_452 ( struct V_99 * V_95 )
{
F_48 ( L_100 ) ;
V_150 = 1 ;
}
static void F_453 ( struct V_99 * V_95 )
{
unsigned short V_500 ;
if ( F_454 ( V_95 , V_501 , & V_500 ) )
return;
if ( ! ( V_500 & V_502 ) ) {
F_48 ( L_101 ) ;
V_46 = 0 ;
...
struct V_99 * V_101 ;
T_10 V_503 ;
V_101 = F_455 ( V_504 , 0x3a3e , NULL ) ;
if ( ! V_101 )
return;
F_257 ( V_101 ) ;
V_101 = F_455 ( V_504 , 0x342e , NULL ) ;
if ( ! V_101 )
return;
if ( F_456 ( V_101 , 0x188 , & V_503 ) ) {
F_257 ( V_101 ) ;
return;
}
F_257 ( V_101 ) ;
