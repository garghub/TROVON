...
static struct V_74 * F_24 ( struct V_75 * V_15 )
{
struct V_24 * V_70 = F_25 ( V_15 ) ;
return V_70 -> V_27 . V_26 -> V_74 ;
}
static int F_26 ( struct V_76 * V_77 )
{
struct V_26 * V_26 = F_25 ( V_77 -> V_15 . V_78 ) ;
struct V_24 * V_25 ;
int V_79 , V_73 ;
V_25 = F_27 ( & V_77 -> V_15 , sizeof( struct V_24 ) ,
V_80 ) ;
if ( ! V_25 )
return - V_81 ;
F_28 ( V_77 , V_25 ) ;
V_25 -> V_27 . V_26 = V_26 ;
V_25 -> V_27 . V_82 = 3 ;
for ( V_79 = 0 ; V_79 < F_29 ( V_25 -> V_66 ) ; V_79 ++ )
V_25 -> V_66 [ V_79 ] . V_83 = 1 ;
F_30 ( V_26 , 1 , V_84 - 1 ,
V_85 , V_86 ,
& V_25 -> V_66 [ 0 ] ) ;
F_30 ( V_26 , 2 , V_87 - 1 ,
V_88 , V_89 ,
& V_25 -> V_66 [ 1 ] ) ;
for ( V_79 = 0 ; V_79 < F_29 ( V_90 ) ; V_79 ++ )
F_31 ( & V_25 -> V_27 , V_79 ) ;
for ( V_79 = 0 ; V_79 < F_29 ( V_91 ) ; V_79 ++ )
F_32 ( V_26 -> V_74 , V_91 [ V_79 ] ,
V_92 , V_92 ) ;
F_33 ( & V_77 -> V_15 ) ;
F_34 ( & V_77 -> V_15 ) ;
V_73 = F_35 ( V_26 ) ;
if ( V_73 < 0 )
return V_73 ;
V_73 = F_36 ( & V_77 -> V_15 , & V_93 ,
V_90 , F_29 ( V_90 ) ) ;
if ( V_73 < 0 ) {
F_6 ( & V_77 -> V_15 , L_6 , V_73 ) ;
goto V_94;
}
return V_73 ;
V_94:
