...
V_98 -> V_7 == & V_13 )
continue;
if ( ! F_135 ( & V_98 -> V_7 -> V_32 . V_27 . V_174 ) ) {
F_11 ( & V_9 ) ;
F_136 ( 10 ) ;
V_22 = F_137 () ;
goto V_134;
...
static int T_6 F_149 ( char * V_178 )
{
struct V_97 * V_98 ;
char * V_149 ;
int V_99 ;
while ( ( V_149 = F_124 ( & V_178 , L_12 ) ) != NULL ) {
if ( ! * V_149 )
continue;
if ( ! strcmp ( V_149 , L_14 ) ) {
V_2 = V_154 ;
...
static T_4 F_152 ( struct V_88 * V_89 ,
struct V_90 * V_91 )
{
return F_56 ( V_89 -> V_11 ) ;
}
static T_4 F_153 ( struct V_88 * V_89 ,
struct V_90 * V_91 )
{
return ( T_4 ) ( unsigned long ) V_58 -> V_180 ;
}
...
T_4 V_28 ;
F_101 () ;
V_28 = F_57 ( & F_155 ( V_58 ) -> V_59 ) ;
F_104 () ;
return V_28 ;
}
static int F_156 ( struct V_66 * V_87 , void * V_77 )
{
struct V_17 * V_18 ;
struct V_181 * V_25 ;
char * V_182 ;
V_182 = F_30 ( V_183 + 1 , V_30 ) ;
if ( ! V_182 )
return - V_64 ;
F_6 ( & V_14 ) ;
F_101 () ;
V_25 = F_102 ( V_58 -> V_180 ) ;
F_16 (link, &cset->cgrp_links, cgrp_link) {
struct V_11 * V_160 = V_18 -> V_32 ;
F_157 ( V_160 , V_182 , V_183 + 1 ) ;
F_70 ( V_87 , L_25 ,
V_160 -> V_7 -> V_101 , V_182 ) ;
}
F_104 () ;
F_8 ( & V_14 ) ;
F_45 ( V_182 ) ;
...
static T_4 F_159 ( struct V_88 * V_89 , struct V_90 * V_91 )
{
return ( ! F_107 ( V_89 -> V_11 ) &&
! F_108 ( & V_89 -> V_11 -> V_27 ) ) ;
}
