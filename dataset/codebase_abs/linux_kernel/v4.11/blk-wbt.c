...
static void F_36 ( struct V_1 * V_2 , const char * V_57 )
{
struct V_13 * V_50 = V_2 -> V_12 -> V_13 ;
F_37 ( V_50 , V_57 , V_2 -> V_41 , V_2 -> V_52 ,
...
static void F_40 ( struct V_1 * V_2 , bool V_60 )
{
if ( V_2 -> V_39 == 1 )
return;
if ( V_2 -> V_41 < 0 && V_60 )
...
unsigned long V_61 ;
if ( V_2 -> V_41 > 0 ) {
V_2 -> V_52 = F_42 ( V_2 -> V_62 << 4 ,
F_43 ( ( V_2 -> V_41 + 1 ) << 8 ) ) ;
} else {
V_2 -> V_52 = V_2 -> V_62 ;
}
V_61 = V_9 + F_44 ( V_2 -> V_52 ) ;
F_45 ( & V_2 -> V_63 , V_61 ) ;
}
static void F_46 ( unsigned long V_64 )
{
struct V_1 * V_2 = (struct V_1 * ) V_64 ;
unsigned int V_24 = F_32 ( V_2 ) ;
int V_65 ;
V_65 = F_34 ( V_2 ) ;
F_47 ( V_2 -> V_12 -> V_13 , V_65 , V_2 -> V_41 ,
V_24 ) ;
switch ( V_65 ) {
case V_53 :
F_40 ( V_2 , true ) ;
...
static inline unsigned int F_50 ( struct V_1 * V_2 , unsigned long V_68 )
{
unsigned int V_25 ;
if ( ( V_68 & V_69 ) || F_6 ( V_2 ) || F_51 () )
V_25 = V_2 -> V_39 ;
else if ( ( V_68 & V_70 ) || F_49 ( V_2 ) ) {
V_25 = V_2 -> V_30 ;
} else
V_25 = V_2 -> V_3 ;
return V_25 ;
}
static inline bool F_52 ( struct V_1 * V_2 , struct V_16 * V_20 ,
...
return false ;
return F_2 ( & V_20 -> V_24 , F_50 ( V_2 , V_68 ) ) ;
}
static void F_54 ( struct V_1 * V_2 , unsigned long V_68 , T_4 * V_73 )
__releases( V_73 )
__acquires( V_73 )
{
struct V_16 * V_20 = F_8 ( V_2 , F_51 () ) ;
F_55 ( V_21 ) ;
if ( F_52 ( V_2 , V_20 , & V_21 , V_68 ) )
return;
do {
F_56 ( & V_20 -> V_21 , & V_21 ,
V_74 ) ;
...
static inline bool F_61 ( struct V_1 * V_2 , struct V_75 * V_75 )
{
const int V_76 = F_62 ( V_75 ) ;
if ( V_76 != V_77 )
return false ;
...
enum V_22 F_63 ( struct V_1 * V_2 , struct V_75 * V_75 , T_4 * V_73 )
{
unsigned int V_37 = 0 ;
if ( ! F_1 ( V_2 ) )
return 0 ;
...
void F_65 ( struct V_1 * V_2 , struct V_31 * V_32 )
{
if ( ! F_1 ( V_2 ) )
return;
...
void F_67 ( struct V_1 * V_2 , struct V_31 * V_32 )
{
if ( ! F_1 ( V_2 ) )
return;
if ( V_32 == V_2 -> V_33 ) {
...
void F_68 ( struct V_1 * V_2 , unsigned int V_36 )
{
if ( V_2 ) {
V_2 -> V_40 = V_36 ;
F_48 ( V_2 ) ;
...
void F_69 ( struct V_1 * V_2 , bool V_83 )
{
if ( V_2 )
V_2 -> V_28 = V_83 ;
}
void F_70 ( struct V_84 * V_85 )
{
...
int F_74 ( struct V_84 * V_85 )
{
struct V_1 * V_2 ;
int V_18 ;
F_75 ( V_88 > V_89 ) ;
F_75 ( V_90 > V_91 ) ;
V_2 = F_76 ( sizeof( * V_2 ) , V_92 ) ;
if ( ! V_2 )
return - V_93 ;
for ( V_18 = 0 ; V_18 < V_19 ; V_18 ++ ) {
F_77 ( & V_2 -> V_16 [ V_18 ] . V_24 , 0 ) ;
F_78 ( & V_2 -> V_16 [ V_18 ] . V_21 ) ;
}
F_79 ( & V_2 -> V_63 , F_46 , ( unsigned long ) V_2 ) ;
V_2 -> V_28 = 1 ;
V_2 -> V_40 = V_94 ;
...
V_2 -> V_38 = F_72 ( V_85 ) ;
F_68 ( V_2 , F_81 ( V_85 ) ) ;
F_69 ( V_2 , F_82 ( V_95 , & V_85 -> V_96 ) ) ;
return 0 ;
}
void F_83 ( struct V_84 * V_85 )
{
struct V_1 * V_2 = V_85 -> V_1 ;
if ( V_2 ) {
F_71 ( & V_2 -> V_63 ) ;
