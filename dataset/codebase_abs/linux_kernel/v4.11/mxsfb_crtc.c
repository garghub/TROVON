...
{
struct V_50 * V_51 = & V_2 -> V_9 . V_8 . V_15 -> V_52 ;
const T_1 V_53 = V_2 -> V_32 . V_33 . V_53 ;
T_1 V_54 , V_55 , V_56 ;
int V_57 ;
F_13 ( V_2 ) ;
F_8 ( V_58 , V_2 -> V_21 + V_22 + V_45 ) ;
V_57 = F_2 ( V_2 ) ;
if ( V_57 )
return;
F_19 ( V_2 -> V_43 , V_51 -> V_59 * 1000 ) ;
F_8 ( F_20 ( V_51 -> V_60 ) |
F_21 ( V_51 -> V_61 ) ,
V_2 -> V_21 + V_2 -> V_4 -> V_62 ) ;
V_55 = V_51 -> V_63 - V_51 -> V_64 ;
V_54 = V_65 |
V_66 |
V_67 |
F_22 ( V_55 ) ;
...
if ( V_53 & V_75 )
V_54 |= V_76 ;
F_8 ( V_54 , V_2 -> V_21 + V_77 ) ;
F_9 ( V_2 ) ;
F_8 ( V_51 -> V_78 , V_2 -> V_21 + V_79 ) ;
V_56 = V_51 -> V_80 - V_51 -> V_81 ;
F_8 ( F_1 ( V_2 , V_56 ) |
F_23 ( V_51 -> V_82 ) ,
V_2 -> V_21 + V_83 ) ;
F_8 ( F_24 ( V_51 -> V_82 - V_51 -> V_81 ) |
F_25 ( V_51 -> V_78 - V_51 -> V_64 ) ,
V_2 -> V_21 + V_84 ) ;
F_8 ( F_26 ( V_51 -> V_85 ) ,
V_2 -> V_21 + V_46 ) ;
F_16 ( V_2 ) ;
...
struct V_86 * V_15 )
{
struct V_87 * V_9 = & V_2 -> V_9 ;
struct V_7 * V_8 = & V_9 -> V_8 ;
struct V_88 * V_16 = V_9 -> V_89 . V_15 -> V_16 ;
struct V_90 * V_91 ;
struct V_92 * V_93 ;
if ( ! V_8 )
return;
...
V_93 = F_35 ( V_16 , 0 ) ;
F_13 ( V_2 ) ;
F_8 ( V_93 -> V_95 , V_2 -> V_21 + V_2 -> V_4 -> V_96 ) ;
F_16 ( V_2 ) ;
}
