...
V_101 = 0 ;
F_35 ( V_67 , L_9 , F_73 ( V_100 , V_89 -> V_85 ) , V_101 ) ;
for ( V_31 = 0 ; V_31 < V_101 ; V_31 ++ )
F_35 ( V_67 , L_10 , F_74 ( V_100 , V_89 -> V_90 -> V_96 [ V_31 ] ) ) ;
F_35 ( V_67 , L_11 ) ;
return 0 ;
}
...
static struct V_88 * F_71 ( struct V_32 * V_33 , T_2 V_85 )
{
struct V_88 V_89 ;
struct V_14 * V_69 ;
V_89 . V_85 = V_85 ;
...
static struct V_105 * F_83 ( T_2 V_85 , struct V_106 * V_107 )
{
struct V_88 * V_89 ;
struct V_105 * V_90 ;
int V_108 ;
...
V_72 ) ;
V_89 = F_71 ( V_71 -> V_104 , V_85 ) ;
if ( ! V_89 )
return F_84 ( - V_110 ) ;
V_108 = F_85 ( V_71 -> V_104 , & V_89 -> V_5 , & V_107 -> V_111 ) ;
switch ( V_108 ) {
case - V_64 :
return F_84 ( - V_64 ) ;
case - V_112 :
...
if ( V_74 == NULL )
return V_126 ;
switch ( F_85 ( V_71 -> V_73 , & V_74 -> V_5 , & V_107 -> V_111 ) ) {
default:
F_89 () ;
case - V_112 :
return V_127 ;
...
static int
F_90 ( struct V_106 * V_107 , T_4 * V_131 )
{
...
if ( F_91 ( V_133 ) != F_93 ( V_141 ) || F_91 ( V_133 ) != 0 ) {
F_92 ( L_13 ) ;
* V_131 = V_142 ;
return V_126 ;
}
...
static int
F_96 ( struct V_106 * V_107 , T_4 * V_131 )
{
struct V_132 * V_133 = & V_107 -> V_134 . V_135 [ 0 ] ;
struct V_132 * V_136 = & V_107 -> V_137 . V_135 [ 0 ] ;
struct V_115 * V_116 = & V_107 -> V_117 ;
...
F_91 ( V_133 ) ;
F_91 ( V_133 ) ;
V_147 = F_97 ( F_98 ( V_133 ) ) ;
if ( V_147 > 64 || ( V_41 -= ( V_147 + 3 ) * 4 ) < 0 )
goto V_148;
V_133 -> V_149 = ( void * ) ( ( T_4 * ) V_133 -> V_149 + V_147 ) ;
V_133 -> V_138 -= V_147 * 4 ;
V_116 -> V_129 = F_67 ( & V_86 , F_98 ( V_133 ) ) ;
V_116 -> V_144 = F_69 ( & V_86 , F_98 ( V_133 ) ) ;
V_147 = F_98 ( V_133 ) ;
if ( V_147 > V_150 || ( V_41 -= ( V_147 + 2 ) * 4 ) < 0 )
goto V_148;
V_116 -> V_130 = F_68 ( V_147 ) ;
if ( V_116 -> V_130 == NULL )
return V_127 ;
for ( V_31 = 0 ; V_31 < V_147 ; V_31 ++ ) {
T_3 V_97 = F_69 ( & V_86 , F_98 ( V_133 ) ) ;
V_116 -> V_130 -> V_96 [ V_31 ] = V_97 ;
}
if ( F_91 ( V_133 ) != F_93 ( V_141 ) || F_91 ( V_133 ) != 0 ) {
* V_131 = V_142 ;
return V_126 ;
