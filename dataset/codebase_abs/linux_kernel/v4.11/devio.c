...
if ( V_78 == 1 || V_78 > V_7 -> V_9 -> V_281 -> V_282 )
V_78 = 0 ;
if ( V_97 -> V_190 )
V_267 = V_255 -> V_267 ;
break;
...
V_78 * sizeof( struct V_286 ) ;
V_30 = F_1 ( V_251 ) ;
if ( V_30 )
goto error;
V_74 -> V_82 = V_251 ;
if ( V_78 ) {
V_74 -> V_75 -> V_79 = F_96 ( V_78 * sizeof( struct V_286 ) ,
V_31 ) ;
if ( ! V_74 -> V_75 -> V_79 ) {
V_30 = - V_5 ;
goto error;
...
V_7 -> V_9 -> V_244 >= V_296 )
V_74 -> V_75 -> V_297 = 1 <<
F_29 ( 15 , V_97 -> V_71 . V_294 - 1 ) ;
else
V_74 -> V_75 -> V_297 = V_97 -> V_71 . V_294 ;
}
V_74 -> V_75 -> V_116 = V_74 ;
V_74 -> V_75 -> V_298 = V_85 ;
for ( V_264 = V_251 = 0 ; V_251 < V_107 ; V_251 ++ ) {
V_74 -> V_75 -> V_261 [ V_251 ] . V_299 = V_264 ;
...
if ( V_74 -> V_13 ) {
unsigned long V_257 = ( unsigned long ) V_255 -> V_258 ;
V_74 -> V_75 -> V_128 |= V_300 ;
V_74 -> V_75 -> V_301 = V_74 -> V_13 -> V_22 +
( V_257 - V_74 -> V_13 -> V_29 ) ;
...
goto V_305;
if ( F_171 ( V_75 -> V_306 , & V_87 -> V_306 ) )
goto V_305;
...
if ( F_171 ( V_304 , ( void T_5 * T_5 * ) V_211 ) )
return - V_63 ;
return 0 ;
V_305:
return - V_63 ;
...
V_309 = F_170 ( V_74 , ( void T_5 * T_5 * ) V_211 ) ;
F_33 ( V_74 ) ;
return V_309 ;
}
if ( F_176 ( V_153 ) )
...
V_309 = ( F_7 ( V_7 ) ? - V_38 : - V_53 ) ;
}
return V_309 ;
}
static int F_182 ( struct V_6 * V_7 ,
struct V_311 T_5 * V_312 )
{
struct V_212 T_5 * V_136 ;
T_10 V_313 ;
V_136 = F_183 ( sizeof( * V_136 ) ) ;
if ( F_184 ( V_136 , V_312 , ( sizeof( * V_312 ) - sizeof( V_314 ) ) ) ||
F_95 ( V_313 , & V_312 -> V_93 ) ||
F_171 ( F_185 ( V_313 ) , & V_136 -> V_93 ) )
return - V_63 ;
return F_116 ( V_7 , V_136 ) ;
}
static int F_186 ( struct V_6 * V_7 ,
struct V_315 T_5 * V_312 )
{
struct V_227 T_5 * V_136 ;
T_11 V_316 ;
V_314 V_304 ;
V_136 = F_183 ( sizeof( * V_136 ) ) ;
if ( F_95 ( V_316 , & V_312 -> V_97 ) || F_171 ( V_316 , & V_136 -> V_97 ) ||
F_95 ( V_316 , & V_312 -> V_50 ) || F_171 ( V_316 , & V_136 -> V_50 ) ||
F_95 ( V_316 , & V_312 -> V_223 ) || F_171 ( V_316 , & V_136 -> V_223 ) ||
F_95 ( V_304 , & V_312 -> V_93 ) || F_171 ( F_185 ( V_304 ) , & V_136 -> V_93 ) )
return - V_63 ;
...
{
struct V_317 V_318 ;
if ( F_117 ( & V_318 , V_211 , sizeof( V_318 ) ) )
return - V_63 ;
V_7 -> V_319 = V_318 . V_120 ;
V_7 -> V_320 = F_185 ( V_318 . V_116 ) ;
return 0 ;
}
static int F_188 ( struct V_254 * V_321 ,
struct V_322 T_5 * V_255 )
{
T_10 V_323 ;
if ( ! F_119 ( V_285 , V_255 , sizeof( * V_255 ) ) ||
F_189 ( V_321 -> type , & V_255 -> type ) ||
F_189 ( V_321 -> V_168 , & V_255 -> V_168 ) ||
F_189 ( V_321 -> V_121 , & V_255 -> V_121 ) ||
F_189 ( V_321 -> V_15 , & V_255 -> V_15 ) ||
F_189 ( V_321 -> V_259 , & V_255 -> V_259 ) ||
F_189 ( V_321 -> V_109 , & V_255 -> V_109 ) ||
F_189 ( V_321 -> V_293 , & V_255 -> V_293 ) ||
F_189 ( V_321 -> V_107 , & V_255 -> V_107 ) ||
F_189 ( V_321 -> V_306 , & V_255 -> V_306 ) ||
F_189 ( V_321 -> V_120 , & V_255 -> V_120 ) )
return - V_63 ;
...
static int F_190 ( struct V_6 * V_7 , void T_5 * V_211 )
{
struct V_254 V_255 ;
if ( F_188 ( & V_255 , (struct V_322 T_5 * ) V_211 ) )
return - V_63 ;
return F_149 ( V_7 , & V_255 ,
( (struct V_322 T_5 * ) V_211 ) -> V_261 ,
V_211 ) ;
}
static int F_191 ( struct V_72 * V_74 , void T_5 * T_5 * V_211 )
{
struct V_75 * V_75 = V_74 -> V_75 ;
struct V_322 T_5 * V_87 = V_74 -> V_87 ;
void T_5 * V_304 = V_74 -> V_87 ;
unsigned int V_52 ;
if ( V_74 -> V_106 && V_75 -> V_109 ) {
if ( F_53 ( V_74 -> V_106 , V_75 ) )
...
if ( F_171 ( F_192 ( V_304 ) , ( T_8 T_5 * ) V_211 ) )
return - V_63 ;
return 0 ;
}
...
int V_309 ;
F_63 ( & V_7 -> V_9 -> V_9 , L_33 , V_74 -> V_87 ) ;
V_309 = F_191 ( V_74 , ( void T_5 * T_5 * ) V_211 ) ;
F_33 ( V_74 ) ;
return V_309 ;
}
if ( F_176 ( V_153 ) )
...
static int F_197 ( struct V_6 * V_7 , void T_5 * V_211 )
{
unsigned int V_135 ;
int V_30 ;
if ( F_95 ( V_135 , ( unsigned int T_5 * ) V_211 ) )
...
static int F_198 ( struct V_6 * V_7 , struct V_326 * V_327 )
{
int V_20 ;
void * V_46 = NULL ;
int V_309 = 0 ;
...
if ( V_7 -> V_147 )
return - V_149 ;
V_20 = F_199 ( V_327 -> V_329 ) ;
if ( V_20 > 0 ) {
V_46 = F_96 ( V_20 , V_31 ) ;
if ( V_46 == NULL )
return - V_5 ;
if ( ( F_200 ( V_327 -> V_329 ) & V_330 ) ) {
if ( F_117 ( V_46 , V_327 -> V_93 , V_20 ) ) {
F_14 ( V_46 ) ;
return - V_63 ;
}
} else {
...
if ( V_7 -> V_9 -> V_10 != V_151 )
V_309 = - V_152 ;
else if ( ! ( V_140 = F_82 ( V_7 -> V_9 , V_327 -> V_331 ) ) )
V_309 = - V_55 ;
else switch ( V_327 -> V_329 ) {
case V_332 :
if ( V_140 -> V_9 . V_237 ) {
V_237 = F_201 ( V_140 -> V_9 . V_237 ) ;
F_202 ( & V_140 -> V_9 , L_34 ) ;
F_87 ( V_237 , V_140 ) ;
} else
V_309 = - V_238 ;
break;
...
V_309 = V_237 -> V_334 ( V_140 , V_327 -> V_329 , V_46 ) ;
if ( V_309 == - V_336 )
V_309 = - V_335 ;
}
}
...
&& V_20 > 0
&& F_27 ( V_327 -> V_93 , V_46 , V_20 ) != 0 )
V_309 = - V_63 ;
F_14 ( V_46 ) ;
return V_309 ;
}
static int F_204 ( struct V_6 * V_7 , void T_5 * V_211 )
{
struct V_326 V_213 ;
if ( F_117 ( & V_213 , V_211 , sizeof( V_213 ) ) )
return - V_63 ;
return F_198 ( V_7 , & V_213 ) ;
}
static int F_205 ( struct V_6 * V_7 , T_12 V_211 )
{
struct V_338 T_5 * V_339 ;
struct V_326 V_213 ;
T_8 V_313 ;
V_339 = F_185 ( ( long ) V_211 ) ;
if ( ! F_119 ( V_285 , V_339 , sizeof( * V_339 ) ) ||
F_189 ( V_213 . V_331 , & V_339 -> V_331 ) ||
F_189 ( V_213 . V_329 , & V_339 -> V_329 ) ||
F_189 ( V_313 , & V_339 -> V_93 ) )
return - V_63 ;
V_213 . V_93 = F_185 ( V_313 ) ;
return F_198 ( V_7 , & V_213 ) ;
}
static int F_206 ( struct V_6 * V_7 , void T_5 * V_211 )
{
unsigned V_340 ;
int V_341 ;
if ( F_95 ( V_340 , ( unsigned T_5 * ) V_211 ) )
return - V_63 ;
V_341 = F_207 ( V_7 -> V_9 , V_340 , V_7 ) ;
if ( V_341 == 0 )
F_63 ( & V_7 -> V_9 -> V_9 , L_35 ,
V_340 , F_89 ( V_153 ) , V_153 -> V_154 ) ;
return V_341 ;
}
static int F_208 ( struct V_6 * V_7 , void T_5 * V_211 )
{
unsigned V_340 ;
if ( F_95 ( V_340 , ( unsigned T_5 * ) V_211 ) )
return - V_63 ;
return F_209 ( V_7 -> V_9 , V_340 , V_7 ) ;
}
...
V_345 | V_346 |
V_347 ;
if ( ! V_7 -> V_9 -> V_281 -> V_348 )
V_342 |= V_349 ;
if ( V_7 -> V_9 -> V_281 -> V_282 )
V_342 |= V_350 ;
if ( F_171 ( V_342 , ( T_10 T_5 * ) V_211 ) )
return - V_63 ;
return 0 ;
}
...
struct V_351 V_352 ;
struct V_139 * V_140 ;
if ( F_117 ( & V_352 , V_211 , sizeof( V_352 ) ) )
return - V_63 ;
V_140 = F_82 ( V_7 -> V_9 , V_352 . V_165 ) ;
if ( ! V_140 )
return - V_55 ;
if ( V_140 -> V_9 . V_237 ) {
struct V_328 * V_237 = F_201 ( V_140 -> V_9 . V_237 ) ;
if ( V_7 -> V_147 )
return - V_149 ;
if ( ( V_352 . V_15 & V_353 ) &&
strncmp ( V_352 . V_237 , V_140 -> V_9 . V_237 -> V_239 ,
...
return F_80 ( V_7 , V_352 . V_165 ) ;
}
static int F_212 ( struct V_6 * V_7 , void T_5 * V_211 )
{
unsigned V_195 , V_196 ;
struct V_184 * * V_197 ;
struct V_139 * V_140 ;
int V_355 ;
V_355 = F_94 ( V_7 , V_211 , & V_195 , & V_196 ,
& V_197 , & V_140 ) ;
if ( V_355 )
return V_355 ;
F_68 ( V_7 ,
V_140 -> V_143 [ 0 ] . V_71 . V_144 ) ;
V_355 = F_213 ( V_140 , V_197 , V_196 , V_195 , V_31 ) ;
F_14 ( V_197 ) ;
return V_355 ;
}
static int F_214 ( struct V_6 * V_7 , void T_5 * V_211 )
{
unsigned V_196 ;
struct V_184 * * V_197 ;
struct V_139 * V_140 ;
int V_355 ;
V_355 = F_94 ( V_7 , V_211 , NULL , & V_196 , & V_197 , & V_140 ) ;
if ( V_355 )
return V_355 ;
F_68 ( V_7 ,
V_140 -> V_143 [ 0 ] . V_71 . V_144 ) ;
V_355 = F_215 ( V_140 , V_197 , V_196 , V_31 ) ;
F_14 ( V_197 ) ;
return V_355 ;
}
static int F_216 ( struct V_6 * V_7 , void T_5 * V_211 )
{
T_8 V_93 ;
...
static long F_217 ( struct V_26 * V_26 , unsigned int V_356 ,
void T_5 * V_136 )
{
struct V_6 * V_7 = V_26 -> V_27 ;
struct V_203 * V_203 = F_218 ( V_26 ) ;
struct V_49 * V_9 = V_7 -> V_9 ;
int V_30 = - V_335 ;
if ( ! ( V_26 -> V_357 & V_358 ) )
return - V_359 ;
...
V_30 = F_190 ( V_7 , V_136 ) ;
if ( V_30 >= 0 )
V_203 -> V_365 = F_220 ( V_203 ) ;
break;
case V_379 :
F_63 ( & V_9 -> V_9 , L_54 , V_182 ) ;
V_30 = F_205 ( V_7 , F_192 ( V_136 ) ) ;
break;
#endif
case V_380 :
...
V_30 = F_197 ( V_7 , V_136 ) ;
break;
case V_384 :
F_63 ( & V_9 -> V_9 , L_59 , V_182 ) ;
V_30 = F_204 ( V_7 , V_136 ) ;
break;
case V_385 :
F_63 ( & V_9 -> V_9 , L_60 , V_182 ) ;
V_30 = F_206 ( V_7 , V_136 ) ;
break;
case V_386 :
F_63 ( & V_9 -> V_9 , L_61 , V_182 ) ;
V_30 = F_208 ( V_7 , V_136 ) ;
break;
case V_387 :
...
break;
case V_389 :
V_30 = F_212 ( V_7 , V_136 ) ;
break;
case V_390 :
V_30 = F_214 ( V_7 , V_136 ) ;
break;
case V_391 :
V_30 = F_216 ( V_7 , V_136 ) ;
break;
}
V_222:
F_30 ( V_9 ) ;
if ( V_30 >= 0 )
V_203 -> V_392 = F_220 ( V_203 ) ;
return V_30 ;
}
static long F_221 ( struct V_26 * V_26 , unsigned int V_356 ,
unsigned long V_211 )
{
int V_30 ;
V_30 = F_217 ( V_26 , V_356 , ( void T_5 * ) V_211 ) ;
return V_30 ;
}
static long F_222 ( struct V_26 * V_26 , unsigned int V_356 ,
unsigned long V_211 )
{
int V_30 ;
V_30 = F_217 ( V_26 , V_356 , F_185 ( V_211 ) ) ;
return V_30 ;
}
static unsigned int F_223 ( struct V_26 * V_26 ,
struct V_393 * V_133 )
{
struct V_6 * V_7 = V_26 -> V_27 ;
unsigned int V_394 = 0 ;
F_224 ( V_26 , & V_7 -> V_133 , V_133 ) ;
if ( V_26 -> V_357 & V_358 && ! F_8 ( & V_7 -> V_85 ) )
V_394 |= V_395 | V_396 ;
if ( ! F_7 ( V_7 ) )
V_394 |= V_397 ;
if ( F_8 ( & V_7 -> V_8 ) )
...
static void F_225 ( struct V_49 * V_88 )
{
struct V_6 * V_7 ;
struct V_117 V_118 ;
...
if ( V_7 -> V_319 ) {
memset ( & V_118 , 0 , sizeof( V_118 ) ) ;
V_118 . V_122 = V_7 -> V_319 ;
V_118 . V_123 = V_226 ;
V_118 . V_124 = V_125 ;
V_118 . V_126 = V_7 -> V_320 ;
F_64 ( V_7 -> V_319 , & V_118 ,
V_7 -> V_209 , V_7 -> V_77 , V_7 -> V_119 ) ;
}
}
}
static int F_227 ( struct V_399 * V_400 ,
unsigned long V_401 , void * V_9 )
{
switch ( V_401 ) {
case V_402 :
break;
