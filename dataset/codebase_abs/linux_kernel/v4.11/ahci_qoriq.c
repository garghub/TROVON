...
if ( ! V_72 )
return - V_76 ;
V_20 = F_18 ( V_69 , sizeof( * V_20 ) , V_77 ) ;
if ( ! V_20 )
return - V_78 ;
V_20 -> type = (enum V_79 ) V_72 -> V_80 ;
V_74 = F_19 ( V_66 , V_81 ,
L_3 ) ;
if ( V_74 ) {
V_20 -> V_41 = F_20 ( V_69 , V_74 ) ;
if ( F_15 ( V_20 -> V_41 ) )
...
static int F_25 ( struct V_33 * V_69 )
{
struct V_85 * V_18 = F_26 ( V_69 ) ;
