...
F_16 ( V_7 ) ;
F_17 ( V_39 , L_1 ) ;
V_40 -> V_42 . V_9 -> V_8 = V_8 ;
return 0 ;
}
static int F_18 ( struct V_6 * V_7 )
{
struct V_29 * V_40 = F_9 ( V_7 ) ;
V_40 -> V_42 . V_9 -> V_8 = NULL ;
return 0 ;
}
static struct V_12 * F_19 ( struct V_43 * V_10 )
{
struct V_29 * V_40 = F_3 ( V_10 ) ;
return V_40 -> V_42 . V_9 -> V_12 ;
}
static int F_20 ( struct V_44 * V_45 )
{
struct V_9 * V_9 = F_3 ( V_45 -> V_10 . V_11 ) ;
struct V_29 * V_30 ;
int V_15 , V_41 ;
V_30 = F_21 ( & V_45 -> V_10 , sizeof( struct V_29 ) ,
V_46 ) ;
if ( V_30 == NULL )
return - V_47 ;
F_22 ( V_45 , V_30 ) ;
...
if ( V_41 < 0 )
return V_41 ;
V_41 = F_30 ( & V_45 -> V_10 , & V_63 ,
V_60 , F_4 ( V_60 ) ) ;
if ( V_41 < 0 ) {
F_31 ( & V_45 -> V_10 , L_2 , V_41 ) ;
goto V_64;
}
V_64:
F_32 ( V_9 ) ;
...
{
struct V_29 * V_30 = F_34 ( V_45 ) ;
struct V_9 * V_9 = V_30 -> V_42 . V_9 ;
F_35 ( & V_45 -> V_10 ) ;
F_36 ( & V_45 -> V_10 ) ;
F_32 ( V_9 ) ;
return 0 ;
