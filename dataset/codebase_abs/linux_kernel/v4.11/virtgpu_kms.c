...
F_47 (cache_ent, tmp, &vgdev->cap_cache, head) {
F_29 ( V_79 -> V_81 ) ;
F_29 ( V_79 ) ;
}
}
...
int F_51 ( struct V_35 * V_36 , struct V_82 * V_83 )
{
struct V_3 * V_4 = V_36 -> V_49 ;
struct V_84 * V_85 ;
T_2 V_17 ;
...
return 0 ;
F_52 ( V_87 , V_89 ) ;
snprintf ( V_86 , sizeof( V_86 ) , L_16 , V_87 ) ;
V_86 [ 63 ] = 0 ;
...
void F_53 ( struct V_35 * V_36 , struct V_82 * V_83 )
{
struct V_3 * V_4 = V_36 -> V_49 ;
struct V_84 * V_85 ;
if ( ! V_4 -> V_63 )
