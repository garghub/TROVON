...
int F_115 ( struct V_1 * T_1 , struct V_293 * V_228 ,
struct V_290 * V_227 )
{
...
T_1 -> V_22 . V_158 = 0 ;
if ( V_310 >= 2 ) {
fprintf ( V_311 , L_49 , V_312 ) ;
fprintf ( V_311 , L_50 ) ;
F_110 ( V_311 , & T_1 -> V_22 , V_313 , NULL ) ;
fprintf ( V_311 , L_49 , V_312 ) ;
}
...
V_314 = F_103 ( T_1 , V_219 , V_220 ) ;
V_315:
F_118 ( L_51 ,
V_296 , V_228 -> V_316 [ V_219 ] , V_314 , V_294 ) ;
V_218 = F_119 ( & T_1 -> V_22 , V_296 , V_228 -> V_316 [ V_219 ] ,
V_314 , V_294 ) ;
...
return 0 ;
V_317:
if ( V_53 == - V_322 && V_300 < V_299 ) {
struct V_323 V_324 ;
int V_325 = V_246 ;
if ( F_120 ( V_326 , & V_324 ) == 0 ) {
if ( V_300 == V_297 )
V_324 . V_327 = V_324 . V_328 ;
else {
V_324 . V_327 = V_324 . V_328 + 1000 ;
V_324 . V_328 = V_324 . V_327 ;
}
if ( F_121 ( V_326 , & V_324 ) == 0 ) {
V_300 ++ ;
V_246 = V_325 ;
goto V_315;
}
...
V_159 . V_148 = true ;
goto V_321;
} else if ( ! V_159 . V_305 && T_1 -> V_22 . V_210 ) {
V_159 . V_305 = true ;
goto V_304;
} else if ( ! V_159 . V_209 && T_1 -> V_22 . V_210 ) {
V_159 . V_209 = true ;
goto V_304;
} else if ( ! V_159 . V_307 && ( V_294 & V_295 ) ) {
V_159 . V_307 = true ;
goto V_304;
...
void F_122 ( struct V_1 * T_1 , int V_215 , int V_216 )
{
if ( T_1 -> V_218 == NULL )
return;
...
struct V_293 * V_228 )
{
return F_115 ( T_1 , V_228 , NULL ) ;
}
int F_124 ( struct V_1 * T_1 ,
struct V_290 * V_227 )
{
return F_115 ( T_1 , NULL , V_227 ) ;
}
...
V_337 . V_339 = * V_333 ;
if ( V_334 ) {
V_337 . V_339 = F_126 ( V_337 . V_339 ) ;
V_337 . V_340 [ 0 ] = F_127 ( V_337 . V_340 [ 0 ] ) ;
}
...
V_337 . V_339 = F_126 ( V_337 . V_339 ) ;
V_337 . V_340 [ 0 ] = F_127 ( V_337 . V_340 [ 0 ] ) ;
V_337 . V_340 [ 1 ] = F_127 ( V_337 . V_340 [ 1 ] ) ;
}
...
static inline bool F_128 ( const void * V_343 , T_12 V_344 , const void * V_345 ,
T_3 V_6 )
{
return V_6 > V_344 || V_345 + V_6 > V_343 ;
}
int F_129 ( struct V_1 * T_1 , union V_329 * V_330 ,
struct V_331 * V_346 )
{
T_3 type = T_1 -> V_22 . V_8 ;
bool V_334 = T_1 -> V_335 ;
...
if ( F_132 ( V_346 -> V_377 . V_6 > V_347 ,
L_56 ) )
return - V_352 ;
}
}
...
T_2 F_134 ( const struct V_331 * V_332 , T_3 type ,
T_3 V_30 )
{
...
V_87 += sizeof( T_3 ) ;
V_347 = F_133 ( V_332 -> V_373 . V_9 ) * sizeof( T_3 ) ;
V_87 += V_347 ;
} else {
V_87 += sizeof( T_3 ) ;
}
...
V_87 += sizeof( T_3 ) ;
V_347 = F_133 ( V_332 -> V_385 . V_9 ) * sizeof( T_3 ) ;
V_87 += V_347 ;
} else {
V_87 += sizeof( T_3 ) ;
}
...
int F_135 ( union V_329 * V_330 , T_3 type ,
T_3 V_30 ,
...
struct V_389 * F_136 ( struct V_1 * T_1 , const char * V_32 )
{
return F_137 ( T_1 -> V_58 , V_32 ) ;
}
void * F_138 ( struct V_1 * T_1 , struct V_331 * V_332 ,
const char * V_32 )
{
struct V_389 * V_390 = F_136 ( T_1 , V_32 ) ;
int V_345 ;
if ( ! V_390 )
return NULL ;
V_345 = V_390 -> V_345 ;
...
T_3 F_139 ( struct V_389 * V_390 , struct V_331 * V_332 ,
bool V_335 )
{
T_3 V_249 ;
...
T_3 F_141 ( struct V_1 * T_1 , struct V_331 * V_332 ,
const char * V_32 )
{
struct V_389 * V_390 = F_136 ( T_1 , V_32 ) ;
if ( ! V_390 )
return 0 ;
return V_390 ? F_139 ( V_390 , V_332 , T_1 -> V_335 ) : 0 ;
}
bool F_142 ( struct V_1 * T_1 , int V_53 ,
...
int F_144 ( struct V_1 * T_1 , struct V_155 * V_155 ,
...
L_69
L_70 ,
V_155 -> V_217 ? L_71 : L_1 ,
F_143 () ) ;
case V_396 :
return F_37 ( V_393 , V_6 , L_72 ,
F_49 ( T_1 ) ) ;
case V_322 :
...
return F_37 ( V_393 , V_6 , L_89 ) ;
if ( V_159 . V_209 )
return F_37 ( V_393 , V_6 , L_90 ) ;
if ( V_159 . V_305 )
return F_37 ( V_393 , V_6 , L_91 , V_209 ) ;
break;
default:
break;
}
...
L_93
L_94 ,
V_53 , F_148 ( V_53 , V_402 , sizeof( V_402 ) ) ,
F_49 ( T_1 ) ) ;
}
