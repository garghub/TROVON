...
V_140 -> V_28 . V_23 |= V_218 ;
if ( ! V_152 && ( F_130 () & V_219 ) ) {
V_140 -> V_163 . V_23 |= V_202 ;
break;
}
default:
if ( V_152 || V_140 -> V_163 . V_29 > V_40 )
V_140 -> V_163 . V_23 |= V_218 ;
}
if ( V_140 -> V_163 . V_23 & V_202 )
V_140 -> V_163 . V_23 &= ~ V_218 ;
switch ( F_34 () ) {
case V_196 :
V_140 -> V_28 . V_23 |= V_190 ;
...
V_222 [ V_140 -> V_28 . V_33 ] , V_140 -> V_28 . V_160 ) ;
F_131 ( L_8 ,
V_123 >> 10 , V_222 [ V_140 -> V_163 . V_33 ] ,
( V_140 -> V_163 . V_23 & V_202 ) ? L_9 : L_7 ,
( V_140 -> V_163 . V_23 & V_218 ) ?
L_10 : L_11 ,
V_140 -> V_163 . V_160 ) ;
}
...
{
struct V_139 * V_140 = & V_27 ;
unsigned int V_223 , V_154 ;
if ( F_34 () != V_81 )
return;
V_223 = F_133 () ;
if ( ( V_154 = ( ( V_223 >> 20 ) & 15 ) ) )
V_140 -> V_224 . V_160 = 2 << V_154 ;
else
V_140 -> V_224 . V_160 = V_154 ;
V_140 -> V_224 . V_187 = 64 << ( ( V_223 >> 24 ) & 15 ) ;
V_140 -> V_224 . V_33 = 1 + ( ( V_223 >> 16 ) & 15 ) ;
V_225 = V_140 -> V_224 . V_187 * V_140 -> V_224 . V_33 * V_140 -> V_224 . V_160 ;
V_140 -> V_224 . V_31 = 0 ;
V_140 -> V_224 . V_29 = V_225 / V_140 -> V_224 . V_33 ;
F_134 ( L_12 ,
V_225 >> 10 , V_222 [ V_140 -> V_224 . V_33 ] , V_140 -> V_224 . V_160 ) ;
}
static int F_135 ( void )
{
unsigned long V_23 , V_4 , V_226 , V_26 , V_227 ;
unsigned int V_150 = F_124 () ;
struct V_139 * V_140 = & V_27 ;
if ( V_150 & V_195 )
return 0 ;
V_226 = ( unsigned long ) & V_228 ;
V_226 &= ~ ( ( 4 * 1024 * 1024 ) - 1 ) ;
V_26 = V_226 + ( 4 * 1024 * 1024 ) ;
F_24 ( V_23 ) ;
V_227 = ( 64 * 1024 ) ;
for ( V_4 = V_226 ; V_4 < V_26 ; V_4 = ( V_226 + V_227 ) ) {
unsigned long * V_229 = ( unsigned long * ) V_4 ;
...
F_136 ( V_232 , V_226 ) ;
V_227 = ( 128 * 1024 ) ;
for ( V_4 = V_226 + ( 128 * 1024 ) ; V_4 < V_26 ; V_4 = V_226 + V_227 ) {
F_136 ( V_233 , V_4 ) ;
__asm__ __volatile__("nop; nop; nop; nop;");
if ( ! F_137 () )
break;
...
V_4 -= V_226 ;
V_65 = V_4 ;
V_140 -> V_234 . V_160 = 16 << ( ( V_150 & V_235 ) >> 22 ) ;
V_140 -> V_234 . V_33 = 1 ;
V_140 -> V_234 . V_31 = 0 ;
return 1 ;
}
...
struct V_139 * V_140 = & V_27 ;
V_65 = 512 * 1024 ;
V_140 -> V_234 . V_160 = 32 ;
V_140 -> V_234 . V_33 = 4 ;
V_140 -> V_234 . V_31 = 0 ;
V_140 -> V_234 . V_29 = V_65 / ( V_140 -> V_234 . V_33 ) ;
V_140 -> V_234 . V_187 = V_65 / ( V_140 -> V_234 . V_160 * V_140 -> V_234 . V_33 ) ;
F_134 ( L_13 ,
V_65 >> 10 , V_222 [ V_140 -> V_234 . V_33 ] , V_140 -> V_234 . V_160 ) ;
V_140 -> V_165 |= V_236 ;
}
...
V_154 = ( V_223 >> 4 ) & 15 ;
if ( V_154 )
V_140 -> V_234 . V_160 = 2 << V_154 ;
else
V_140 -> V_234 . V_160 = 0 ;
V_140 -> V_234 . V_187 = 64 << ( ( V_223 >> 8 ) & 15 ) ;
V_140 -> V_234 . V_33 = 1 + ( V_223 & 15 ) ;
V_65 = V_140 -> V_234 . V_187 *
V_140 -> V_234 . V_33 *
V_140 -> V_234 . V_160 ;
V_65 *= 4 ;
V_140 -> V_234 . V_31 = 0 ;
...
case V_88 :
case V_89 :
V_65 = 0x80000 << ( ( V_150 & V_239 ) >> 16 ) ;
V_140 -> V_234 . V_160 = 64 << ( ( V_150 >> 13 ) & 1 ) ;
V_140 -> V_234 . V_33 = 2 ;
V_140 -> V_234 . V_31 = 0 ;
V_237 = 1 ;
break;
...
return;
default:
if ( V_140 -> V_241 & ( V_242 | V_243 |
V_244 | V_245 |
V_246 | V_247 ) ) {
#ifdef F_146
if ( F_147 () ) {
V_65 = V_140 -> V_234 . V_33 * V_140 -> V_234 . V_187 * V_140 -> V_234 . V_160 ;
F_131 ( L_14 ,
V_65 >> 10 ,
V_222 [ V_140 -> V_234 . V_33 ] , V_140 -> V_234 . V_160 ) ;
}
#else
if ( ! ( V_140 -> V_234 . V_23 & V_248 ) )
F_129 ( L_15 ) ;
#endif
return;
}
...
static int T_6 F_152 ( char * V_252 )
{
F_153 ( & V_252 , & V_253 ) ;
return 0 ;
}
...
break;
default:
F_159 ( 0x100 , & V_257 , 0x80 ) ;
break;
}
}
static int F_160 ( struct V_259 * V_260 , unsigned long V_261 ,
void * V_262 )
{
switch ( V_261 ) {
case V_263 :
