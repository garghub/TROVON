...
static void F_94 ( struct V_1 * V_2 , T_8 V_18 )
{
V_2 -> V_18 = V_18 ;
V_2 -> V_17 = F_9 ( V_2 -> V_16 , F_10 ( V_18 , 0 ) ) ;
}
static int F_95 ( void * V_141 )
{
struct V_1 * V_2 = & V_31 . V_1 ;
...
int F_98 ( struct V_40 * clock )
{
struct V_1 * V_2 = & V_31 . V_1 ;
if ( V_2 -> V_3 . clock == clock )
return 0 ;
F_99 ( F_95 , clock , NULL ) ;
F_100 () ;
...
void __weak F_104 ( struct V_68 * V_10 )
{
V_10 -> V_11 = 0 ;
V_10 -> V_12 = 0 ;
}
void __weak F_105 ( struct V_9 * V_140 )
{
struct V_68 V_10 ;
F_104 ( & V_10 ) ;
* V_140 = F_92 ( V_10 ) ;
}
void __weak F_106 ( struct V_9 * V_10 )
{
V_10 -> V_11 = 0 ;
V_10 -> V_12 = 0 ;
}
...
V_2 -> V_3 . V_34 ) ;
V_58 = F_119 ( V_155 , clock -> V_47 , clock -> V_7 ) ;
V_138 = F_120 ( V_58 ) ;
V_152 = true ;
...
static T_3 void F_130 ( struct V_1 * V_2 ,
T_5 V_21 ,
bool V_160 ,
int V_161 )
{
...
V_163 -= V_2 -> V_48 ;
V_2 -> V_56 = F_132 () ;
V_166 = F_132 () >> V_2 -> V_54 ;
V_166 -= ( V_163 + V_2 -> V_50 ) ;
if ( F_133 ( ( V_166 >= 0 ) && ( V_166 <= V_41 ) ) )
return;
V_160 = ( V_166 < 0 ) ;
...
F_130 ( V_2 , V_21 , V_160 , V_161 ) ;
}
static void F_134 ( struct V_1 * V_2 , T_5 V_21 )
{
F_131 ( V_2 , V_21 ) ;
...
static inline unsigned int F_136 ( struct V_1 * V_2 )
{
...
F_5 ( V_2 ,
F_87 ( V_2 -> V_15 , V_10 ) ) ;
F_94 ( V_2 , V_2 -> V_18 - V_171 ) ;
V_170 = V_86 ;
}
}
return V_170 ;
}
static V_5 F_138 ( struct V_1 * V_2 , V_5 V_21 ,
...
goto V_139;
F_12 ( V_174 , V_21 ) ;
V_7 = F_141 ( V_21 ) - F_141 ( V_2 -> V_48 ) ;
V_7 = V_35 ( 0 , V_7 ) ;
V_175 = ( 64 - ( F_141 ( F_132 () ) + 1 ) ) - 1 ;
V_7 = F_142 ( V_7 , V_175 ) ;
while ( V_21 >= V_2 -> V_48 ) {
V_21 = F_138 ( V_2 , V_21 , V_7 ,
& V_170 ) ;
...
unsigned long F_146 ( void )
{
struct V_1 * V_2 = & V_31 . V_1 ;
return V_2 -> V_8 ;
}
struct V_68 F_147 ( void )
{
struct V_1 * V_2 = & V_31 . V_1 ;
return F_37 ( F_2 ( V_2 ) ) ;
}
struct V_9 F_148 ( void )
{
struct V_1 * V_2 = & V_31 . V_1 ;
struct V_9 V_32 ;
unsigned long V_36 ;
...
void F_150 ( unsigned long V_178 )
{
V_179 += V_178 ;
F_151 ( V_178 ) ;
}
T_1 F_152 ( unsigned int * V_180 , T_1 * V_16 ,
T_1 * V_20 , T_1 * V_17 )
{
struct V_1 * V_2 = & V_31 . V_1 ;
unsigned int V_36 ;
...
void F_157 ( const struct V_9 * V_188 , const struct V_9 * V_189 )
{
unsigned long V_76 ;
F_43 ( & V_78 , V_76 ) ;
F_85 ( & V_31 . V_36 ) ;
...
void F_159 ( unsigned long V_178 )
{
F_160 ( & V_190 ) ;
F_150 ( V_178 ) ;
F_161 ( & V_190 ) ;
