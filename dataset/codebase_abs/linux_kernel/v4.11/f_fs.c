...
static int F_137 ( struct V_6 * V_7 , struct V_220 * V_221 )
{
struct V_222 * * V_223 ;
int V_224 ;
F_20 () ;
if ( F_68 ( V_7 -> V_45 != V_50
|| F_138 ( V_225 , & V_7 -> V_199 ) ) )
return - V_55 ;
V_224 = F_139 ( V_221 , V_7 -> V_218 ) ;
if ( F_12 ( V_224 < 0 ) )
return V_224 ;
...
F_20 () ;
V_64 = V_7 -> V_209 ;
V_208 = F_142 ( V_64 , sizeof( * V_208 ) , V_68 ) ;
if ( ! V_208 )
return - V_69 ;
V_108 = V_208 ;
...
static void F_127 ( struct V_107 * V_208 , unsigned V_64 )
{
struct V_107 * V_108 = V_208 ;
F_20 () ;
for (; V_64 ; -- V_64 , ++ V_108 ) {
...
if ( F_39 ( ! V_20 ) ) {
V_108 -> V_12 = V_12 ;
V_108 -> V_114 = F_151 ( V_236 ) ;
V_108 -> V_115 = F_152 ( V_236 ) ;
} else {
break;
}
F_153 ( & V_108 -> V_82 ) ;
...
goto V_254;
F_158 ( V_255 , V_236 -> V_256 ) ;
if ( V_236 -> V_257 )
F_158 ( STRING , V_236 -> V_257 ) ;
}
break;
case V_258 : {
...
if ( ! V_17 )
return V_276 - V_18 ;
V_20 = F_154 ( V_17 , V_18 , V_243 , V_244 ) ;
if ( F_12 ( V_20 < 0 ) ) {
...
static int F_160 ( enum V_278 type ,
...
static int F_161 ( enum V_287 * V_288 ,
struct V_289 * V_141 )
{
...
static int F_165 ( enum V_287 type ,
...
return - V_48 ;
V_28 = F_164 ( V_282 -> V_309 ) ;
if ( V_18 < V_28 )
return - V_48 ;
type = F_164 ( V_282 -> V_310 ) ;
if ( type < V_311 ||
type > V_312 ) {
F_16 ( L_43 ,
type ) ;
...
V_306 = F_164 ( * ( T_12 * ) ( ( T_8 * ) V_17 + 10 + V_307 ) ) ;
...
V_281 . V_219 = 0 ;
V_281 . V_209 = 0 ;
V_20 = F_159 ( V_318 [ V_61 ] , V_17 , V_18 ,
F_160 , & V_281 ) ;
if ( V_20 < 0 )
goto error;
...
unsigned V_61 = 0 ;
F_168 ( V_282 ) ;
F_169 ( V_282 , struct V_222 * , V_212 ,
V_332 + 1 ) ;
F_169 ( V_282 , struct V_222 , V_334 , V_332 ) ;
F_169 ( V_282 , struct V_226 , V_228 ,
V_332 * ( V_331 + 1 ) ) ;
char * V_335 = F_40 ( F_170 ( V_282 ) , V_68 ) ;
if ( F_12 ( ! V_335 ) ) {
F_33 ( V_174 ) ;
return - V_69 ;
}
V_212 = F_171 ( V_335 , V_282 , V_212 ) ;
V_198 = F_171 ( V_335 , V_282 , V_334 ) ;
V_61 = V_332 ;
do {
* V_212 ++ = V_198 ++ ;
} while ( -- V_61 );
...
{
unsigned long V_199 ;
F_146 ( & V_7 -> V_22 . V_25 . V_26 , V_199 ) ;
F_174 ( V_7 , type ) ;
F_148 ( & V_7 -> V_22 . V_25 . V_26 , V_199 ) ;
}
static int F_177 ( struct V_6 * V_7 , T_8 V_350 )
{
int V_61 ;
...
static int F_178 ( enum V_278 type , T_8 * V_279 ,
struct V_245 * V_141 ,
void * V_244 )
{
...
return 0 ;
V_353 = F_177 ( V_77 -> V_7 , V_236 -> V_261 ) - 1 ;
if ( V_353 < 0 )
return V_353 ;
...
F_179 ( L_55 , V_236 , V_236 -> V_146 ) ;
return 0 ;
}
static int F_181 ( enum V_278 type , T_8 * V_279 ,
struct V_245 * V_141 ,
void * V_244 )
{
struct V_1 * V_77 = V_244 ;
...
int V_229 = F_182 ( V_77 -> V_364 , & V_77 -> V_4 ) ;
if ( F_12 ( V_229 < 0 ) )
return V_229 ;
...
static int F_183 ( enum V_287 type ,
struct V_289 * V_297 , void * V_17 ,
unsigned V_18 , void * V_244 )
{
struct V_1 * V_77 = V_244 ;
...
V_373 -> type = F_164 ( V_141 -> V_310 ) ;
V_373 -> V_377 = F_8 ( V_141 -> V_313 ) ;
V_373 -> V_91 = F_164 ( * ( T_12 * )
F_184 ( V_17 , V_373 -> V_377 ) ) ;
...
++ V_198 -> V_368 -> V_383 ;
F_187 ( & V_373 -> V_384 , & V_198 -> V_368 -> V_373 ) ;
}
break;
default:
F_16 ( L_35 , type ) ;
...
static inline struct V_385 * F_188 ( struct V_2 * V_3 ,
struct V_386 * V_387 )
{
...
if ( ! V_388 -> V_394 ) {
V_20 = F_137 ( V_77 -> V_7 , V_387 -> V_221 ) ;
if ( V_20 )
return F_105 ( V_20 ) ;
}
V_388 -> V_394 ++ ;
...
static int F_191 ( struct V_386 * V_387 ,
struct V_2 * V_3 )
{
struct V_1 * V_77 = F_1 ( V_3 ) ;
struct V_6 * V_7 = V_77 -> V_7 ;
const int V_395 = ! ! V_77 -> V_7 -> V_215 ;
const int V_396 = F_192 ( V_77 -> V_29 ) &&
V_77 -> V_7 -> V_216 ;
const int V_397 = F_193 ( V_77 -> V_29 ) &&
V_77 -> V_7 -> V_217 ;
int V_398 , V_399 , V_400 , V_20 , V_61 ;
struct V_89 * V_401 ;
F_168 ( V_282 ) ;
F_194 ( V_282 , struct V_89 , V_235 , V_7 -> V_209 ) ;
F_194 ( V_282 , struct V_245 * , V_402 ,
V_395 ? V_7 -> V_215 + 1 : 0 ) ;
F_194 ( V_282 , struct V_245 * , V_403 ,
V_396 ? V_7 -> V_216 + 1 : 0 ) ;
F_194 ( V_282 , struct V_245 * , V_404 ,
V_397 ? V_7 -> V_217 + 1 : 0 ) ;
F_194 ( V_282 , short , V_405 , V_7 -> V_219 ) ;
F_194 ( V_282 , struct V_365 , V_366 ,
V_387 -> V_221 -> V_406 ? V_7 -> V_219 : 0 ) ;
F_194 ( V_282 , char [ 16 ] , V_407 ,
V_387 -> V_221 -> V_406 ? V_7 -> V_219 : 0 ) ;
F_194 ( V_282 , struct V_408 , V_368 ,
V_387 -> V_221 -> V_406 ? V_7 -> V_219 : 0 ) ;
F_194 ( V_282 , struct V_372 , V_373 ,
V_7 -> V_314 ) ;
F_194 ( V_282 , char , V_374 ,
V_7 -> V_315 ) ;
F_194 ( V_282 , char , V_375 ,
V_7 -> V_316 ) ;
F_194 ( V_282 , char , V_213 , V_7 -> V_214 ) ;
char * V_335 ;
F_20 () ;
if ( F_12 ( ! ( V_395 | V_396 | V_397 ) ) )
return - V_360 ;
V_335 = F_129 ( F_170 ( V_282 ) , V_68 ) ;
if ( F_12 ( ! V_335 ) )
return - V_69 ;
V_7 -> V_376 = F_171 ( V_335 , V_282 , V_373 ) ;
V_7 -> V_378 =
F_171 ( V_335 , V_282 , V_374 ) ;
V_7 -> V_379 =
F_171 ( V_335 , V_282 , V_375 ) ;
memcpy ( F_171 ( V_335 , V_282 , V_213 ) , V_7 -> V_213 ,
V_7 -> V_214 ) ;
memset ( F_171 ( V_335 , V_282 , V_405 ) , 0xff , V_409 ) ;
V_401 = F_171 ( V_335 , V_282 , V_235 ) ;
for ( V_61 = 0 ; V_61 < V_7 -> V_209 ; V_61 ++ )
V_401 [ V_61 ] . V_137 = - 1 ;
V_77 -> V_235 = F_171 ( V_335 , V_282 , V_235 ) ;
V_77 -> V_363 = F_171 ( V_335 , V_282 , V_405 ) ;
if ( F_39 ( V_395 ) ) {
V_77 -> V_4 . V_357 = F_171 ( V_335 , V_282 , V_402 ) ;
V_398 = F_159 ( V_7 -> V_215 ,
F_171 ( V_335 , V_282 , V_213 ) ,
V_410 ,
F_178 , V_77 ) ;
if ( F_12 ( V_398 < 0 ) ) {
V_20 = V_398 ;
...
if ( F_39 ( V_396 ) ) {
V_77 -> V_4 . V_356 = F_171 ( V_335 , V_282 , V_403 ) ;
V_399 = F_159 ( V_7 -> V_216 ,
F_171 ( V_335 , V_282 , V_213 ) + V_398 ,
V_410 - V_398 ,
F_178 , V_77 ) ;
if ( F_12 ( V_399 < 0 ) ) {
V_20 = V_399 ;
...
if ( F_39 ( V_397 ) ) {
V_77 -> V_4 . V_355 = F_171 ( V_335 , V_282 , V_404 ) ;
V_400 = F_159 ( V_7 -> V_217 ,
F_171 ( V_335 , V_282 , V_213 ) + V_398 + V_399 ,
V_410 - V_398 - V_399 ,
F_178 , V_77 ) ;
if ( F_12 ( V_400 < 0 ) ) {
V_20 = V_400 ;
...
V_20 = F_159 ( V_7 -> V_215 +
( V_396 ? V_7 -> V_216 : 0 ) +
( V_397 ? V_7 -> V_217 : 0 ) ,
F_171 ( V_335 , V_282 , V_213 ) , V_410 ,
F_181 , V_77 ) ;
if ( F_12 ( V_20 < 0 ) )
goto error;
V_77 -> V_4 . V_366 = F_171 ( V_335 , V_282 , V_366 ) ;
if ( V_387 -> V_221 -> V_406 ) {
for ( V_61 = 0 ; V_61 < V_7 -> V_219 ; ++ V_61 ) {
struct V_408 * V_141 ;
V_141 = V_77 -> V_4 . V_366 [ V_61 ] . V_368 =
F_171 ( V_335 , V_282 , V_368 ) +
V_61 * sizeof( struct V_408 ) ;
V_141 -> V_369 =
F_171 ( V_335 , V_282 , V_407 ) + V_61 * 16 ;
F_195 ( & V_141 -> V_373 ) ;
}
V_20 = F_163 ( V_7 -> V_329 ,
F_171 ( V_335 , V_282 , V_213 ) +
V_398 + V_399 + V_400 ,
V_410 - V_398 - V_399 -
V_400 ,
...
static int F_196 ( struct V_386 * V_387 ,
struct V_2 * V_3 )
{
struct V_385 * V_388 = F_188 ( V_3 , V_387 ) ;
struct V_1 * V_77 = F_1 ( V_3 ) ;
int V_20 ;
if ( F_23 ( V_388 ) )
return F_24 ( V_388 ) ;
V_20 = F_191 ( V_387 , V_3 ) ;
if ( V_20 && ! -- V_388 -> V_394 )
F_140 ( V_77 -> V_7 ) ;
return V_20 ;
}
...
break;
case V_421 :
V_20 = F_201 ( V_77 , F_8 ( V_416 -> V_293 ) ) ;
if ( F_12 ( V_20 < 0 ) )
return V_20 ;
if ( V_77 -> V_7 -> V_231 & V_232 )
...
F_146 ( & V_7 -> V_22 . V_25 . V_26 , V_199 ) ;
V_7 -> V_22 . V_23 = * V_416 ;
V_7 -> V_22 . V_23 . V_293 = F_202 ( V_20 ) ;
F_174 ( V_7 , V_62 ) ;
F_148 ( & V_7 -> V_22 . V_25 . V_26 , V_199 ) ;
return 0 ;
}
...
{
F_20 () ;
F_176 ( F_1 ( V_3 ) -> V_7 , V_344 ) ;
}
static void F_205 ( struct V_2 * V_3 )
{
F_20 () ;
F_176 ( F_1 ( V_3 ) -> V_7 , V_343 ) ;
}
...
static struct V_204 * F_206 ( const char * V_170 )
{
struct V_204 * V_392 ;
F_207 (dev, &ffs_devices, entry) {
if ( ! V_392 -> V_170 || ! V_170 )
continue;
...
static struct V_204 * F_208 ( void )
{
struct V_204 * V_392 ;
if ( F_209 ( & V_426 ) ) {
V_392 = F_210 ( & V_426 , struct V_204 , V_384 ) ;
if ( V_392 -> V_427 )
return V_392 ;
}
return NULL ;
}
static struct V_204 * F_211 ( const char * V_170 )
{
struct V_204 * V_392 ;
V_392 = F_208 () ;
if ( V_392 )
...
static inline struct V_385 * F_212 ( struct V_428 * V_429 )
{
return F_2 ( F_213 ( V_429 ) , struct V_385 ,
V_390 . V_430 ) ;
}
static void F_214 ( struct V_428 * V_429 )
{
struct V_385 * V_190 = F_212 ( V_429 ) ;
F_215 ( & V_190 -> V_390 ) ;
}
static void F_216 ( struct V_431 * V_3 )
{
struct V_385 * V_190 ;
V_190 = F_217 ( V_3 ) ;
F_189 () ;
...
static int F_219 ( struct V_431 * V_389 , const char * V_170 )
{
struct V_385 * V_190 ;
char * V_39 ;
const char * V_432 ;
int V_377 , V_20 ;
V_377 = strlen ( V_170 ) + 1 ;
if ( V_377 > V_433 )
return - V_434 ;
V_39 = F_220 ( V_170 , V_377 , V_68 ) ;
if ( ! V_39 )
return - V_69 ;
V_190 = F_217 ( V_389 ) ;
V_432 = NULL ;
F_189 () ;
V_432 = V_190 -> V_392 -> V_435 ? V_190 -> V_392 -> V_170 : NULL ;
V_20 = F_221 ( V_190 -> V_392 , V_39 ) ;
if ( V_20 ) {
F_33 ( V_39 ) ;
F_190 () ;
return V_20 ;
}
V_190 -> V_392 -> V_435 = true ;
F_190 () ;
F_33 ( V_432 ) ;
return 0 ;
}
static struct V_431 * F_222 ( void )
{
struct V_385 * V_190 ;
struct V_204 * V_392 ;
V_190 = F_129 ( sizeof( * V_190 ) , V_68 ) ;
if ( ! V_190 )
return F_105 ( - V_69 ) ;
V_190 -> V_390 . V_436 = F_219 ;
V_190 -> V_390 . V_437 = F_216 ;
F_189 () ;
V_392 = F_223 () ;
F_190 () ;
if ( F_23 ( V_392 ) ) {
...
static void F_226 ( struct V_386 * V_387 ,
struct V_2 * V_3 )
{
struct V_1 * V_77 = F_1 ( V_3 ) ;
struct V_6 * V_7 = V_77 -> V_7 ;
...
static struct V_2 * F_227 ( struct V_431 * V_389 )
{
struct V_1 * V_77 ;
F_20 () ;
...
return F_105 ( - V_69 ) ;
V_77 -> V_4 . V_170 = L_63 ;
V_77 -> V_4 . V_439 = F_196 ;
V_77 -> V_4 . V_440 = F_226 ;
V_77 -> V_4 . V_441 = F_198 ;
V_77 -> V_4 . V_442 = F_199 ;
V_77 -> V_4 . V_23 = F_200 ;
V_77 -> V_4 . V_443 = F_203 ;
V_77 -> V_4 . V_444 = F_204 ;
V_77 -> V_4 . V_445 = F_205 ;
V_77 -> V_4 . V_446 = F_225 ;
return & V_77 -> V_4 ;
}
static struct V_204 * F_223 ( void )
{
struct V_204 * V_392 ;
int V_20 ;
if ( F_208 () )
return F_105 ( - V_72 ) ;
V_392 = F_129 ( sizeof( * V_392 ) , V_68 ) ;
if ( ! V_392 )
return F_105 ( - V_69 ) ;
if ( F_228 ( & V_426 ) ) {
V_20 = F_115 () ;
...
F_229 ( & V_392 -> V_384 , & V_426 ) ;
return V_392 ;
}
static int F_221 ( struct V_204 * V_392 , const char * V_170 )
{
struct V_204 * V_447 ;
V_447 = F_206 ( V_170 ) ;
if ( V_447 )
...
int F_230 ( struct V_204 * V_392 , const char * V_170 )
{
int V_20 ;
F_189 () ;
V_20 = F_221 ( V_392 , V_170 ) ;
F_190 () ;
return V_20 ;
}
int F_231 ( struct V_204 * V_392 )
{
int V_20 ;
V_20 = 0 ;
F_189 () ;
...
static void F_218 ( struct V_204 * V_392 )
{
F_232 ( & V_392 -> V_384 ) ;
if ( V_392 -> V_435 )
F_33 ( V_392 -> V_170 ) ;
...
V_451 -> V_6 = V_7 ;
if ( V_451 -> V_452 ) {
V_20 = V_451 -> V_452 ( V_7 ) ;
if ( V_20 )
goto V_123;
}
F_233 ( V_453 , & V_7 -> V_199 ) ;
V_123:
F_190 () ;
return V_20 ;
}
...
goto V_123;
if ( V_190 -> V_391 || ! V_190 -> V_390 . V_430 . V_456 . V_457
|| ! F_235 ( & V_190 -> V_390 . V_430 . V_456 . V_458 ) )
goto V_123;
V_454 = V_190 -> V_390 . V_430 . V_456 . V_457 -> V_457 ;
F_190 () ;
F_236 ( V_454 ) ;
return;
V_123:
...
static int F_21 ( struct V_42 * V_42 , unsigned V_459 )
{
return V_459
