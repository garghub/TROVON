...
static unsigned int F_7 ( struct V_14 * V_15 ,
unsigned char * V_16 , unsigned int V_17 , int V_18 )
{
struct V_19 * V_20 = V_15 -> V_21 -> V_2 -> V_20 ;
if ( V_18 == V_22 )
F_8 ( V_20 -> V_23 . V_24 , V_16 , V_17 ) ;
else
F_9 ( V_20 -> V_23 . V_24 , V_16 , V_17 ) ;
return V_17 ;
}
...
int V_25 ;
struct V_19 * V_20 ;
if ( V_15 == NULL || V_15 -> V_26 == V_27 )
return;
V_20 = V_15 -> V_20 ;
for ( V_25 = 0 ; ( V_20 -> V_28 -> V_29 ( V_20 ) & V_30 )
&& V_25 ++ < 65536 ; )
F_11 ( V_20 -> V_23 . V_24 ) ;
if ( V_25 )
F_12 ( V_20 , L_2 , V_25 ) ;
...
goto V_64;
V_44 = - V_45 ;
V_49 = F_18 ( & V_32 -> V_21 , V_47 , 8 ) ;
V_50 = F_18 ( & V_32 -> V_21 , V_48 , 1 ) ;
if ( ! V_49 || ! V_50 )
goto V_64;
F_19 ( 0x02 , V_50 ) ;
if ( V_34 )
...
V_20 -> V_69 = V_70 ;
V_20 -> V_36 |= V_71 ;
V_20 -> V_23 . V_72 = V_49 + 0x10 * V_46 ;
V_20 -> V_23 . V_73 = V_50 + 0x10 * V_46 ;
V_20 -> V_23 . V_50 = V_50 + 0x10 * V_46 ;
F_22 ( & V_20 -> V_23 ) ;
F_23 ( V_20 , L_3 , V_47 , V_48 ) ;
}
