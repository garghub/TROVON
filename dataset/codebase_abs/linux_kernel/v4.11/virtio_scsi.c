...
static int F_110 ( struct V_1 * V_84 )
{
struct V_9 * V_10 = F_28 ( V_84 ) ;
return F_111 ( & V_84 -> V_168 , V_10 -> V_3 , 2 ) ;
}
...
const char * * V_173 ;
struct V_55 * * V_174 ;
struct V_175 V_176 = { . V_177 = 2 } ;
V_64 = V_10 -> V_65 + V_60 ;
V_174 = F_105 ( V_64 * sizeof( struct V_55 * ) , V_166 ) ;
V_172 = F_105 ( V_64 * sizeof( T_5 * ) , V_166 ) ;
V_173 = F_105 ( V_64 * sizeof( char * ) , V_166 ) ;
if ( ! V_172 || ! V_174 || ! V_173 ) {
V_70 = - V_167 ;
goto V_104;
}
V_172 [ 0 ] = F_32 ;
...
V_70 = V_3 -> V_169 -> V_178 ( V_3 , V_64 , V_174 , V_172 , V_173 ,
& V_176 ) ;
if ( V_70 )
goto V_104;
F_112 ( & V_10 -> V_67 , V_174 [ 0 ] ) ;
F_112 ( & V_10 -> V_77 , V_174 [ 1 ] ) ;
for ( V_63 = V_60 ; V_63 < V_64 ; V_63 ++ )
F_112 ( & V_10 -> V_62 [ V_63 - V_60 ] ,
V_174 [ V_63 ] ) ;
F_116 ( V_3 , V_179 , V_137 ) ;
F_116 ( V_3 , V_180 , V_45 ) ;
V_70 = 0 ;
V_104:
F_109 ( V_173 ) ;
F_109 ( V_172 ) ;
...
struct V_183 * V_184 ;
if ( ! V_3 -> V_169 -> V_185 ) {
F_118 ( & V_3 -> V_164 , L_12 ,
V_186 ) ;
return - V_187 ;
}
V_65 = F_119 ( V_3 , V_65 ) ? : 1 ;
V_182 = F_119 ( V_3 , V_188 ) + 1 ;
if ( V_65 == 1 )
V_184 = & V_189 ;
else
V_184 = & V_190 ;
...
if ( V_70 )
goto V_192;
V_161 = F_119 ( V_3 , V_161 ) ? : 1 ;
V_84 -> V_161 = F_15 ( T_1 , V_161 , V_84 -> V_193 ) ;
V_84 -> V_194 = F_119 ( V_3 , V_194 ) ? : 0xFFFF ;
V_84 -> V_195 = F_119 ( V_3 , V_195 ) + 1 + 0x4000 ;
V_84 -> V_196 = V_182 ;
V_84 -> V_197 = 0 ;
V_84 -> V_198 = V_137 ;
V_84 -> V_199 = V_65 ;
