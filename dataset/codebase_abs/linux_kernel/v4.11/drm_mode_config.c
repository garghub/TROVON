...
struct V_19 * V_20 , * V_107 ;
struct V_13 * V_14 , * V_108 ;
struct V_51 * V_109 , * V_110 ;
struct V_111 * V_112 , * V_113 ;
struct V_47 * V_48 , * V_114 ;
F_42 (encoder, enct, &dev->mode_config.encoder_list,
head) {
V_20 -> V_49 -> V_115 ( V_20 ) ;
}
F_20 ( V_2 , & V_27 ) ;
F_21 (connector, &conn_iter) {
F_43 ( V_16 ) ;
...
F_22 ( & V_27 ) ;
if ( F_44 ( ! F_45 ( & V_2 -> V_37 . V_91 ) ) ) {
F_20 ( V_2 , & V_27 ) ;
F_21 (connector, &conn_iter)
F_46 ( L_21 , V_16 -> V_116 ) ;
F_22 ( & V_27 ) ;
}
