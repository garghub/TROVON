...
V_28 -> V_59 = V_13 -> V_60 -> V_61 ;
V_28 -> V_62 = F_16 ( & V_2 -> V_46 ) +
V_23 ;
V_25 = F_20 ( V_28 ) ;
}
if ( V_13 -> V_49 & V_63 )
...
F_26 ( V_2 -> V_22 -> V_67 != V_13 -> V_60 -> V_61 ) ;
( void ) F_4 ( V_2 ) ;
}
...
int F_35 ( struct V_72 * V_73 , struct V_19 * V_13 ,
struct V_21 * V_22 )
{
struct V_74 * V_40 ;
struct V_1 * V_2 ;
...
V_5 = V_40 -> V_76 ( V_2 , V_73 ) ;
if ( F_9 ( V_5 != 0 ) )
goto V_78;
V_13 -> V_79 = & V_80 ;
V_13 -> V_20 = V_2 ;
V_13 -> V_49 |= V_63 ;
V_13 -> V_49 |= V_81 | V_82 | V_83 ;
return 0 ;
V_78:
F_8 ( & V_2 ) ;
return V_5 ;
}
int F_36 ( struct V_19 * V_13 , struct V_1 * V_2 )
{
if ( V_13 -> V_45 != 0 )
return - V_84 ;
V_13 -> V_79 = & V_80 ;
