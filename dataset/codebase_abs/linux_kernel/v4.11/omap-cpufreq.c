...
if ( V_19 && ( V_13 > V_12 ) ) {
V_4 = F_11 ( V_19 , V_9 - V_11 , V_9 + V_11 ) ;
if ( V_4 < 0 ) {
F_3 ( V_18 , L_4 ,
V_20 ) ;
return V_4 ;
...
V_5 = F_12 ( V_2 -> V_17 , V_13 * 1000 ) ;
if ( V_19 && ( V_13 < V_12 ) ) {
V_4 = F_11 ( V_19 , V_9 - V_11 , V_9 + V_11 ) ;
if ( V_4 < 0 ) {
F_3 ( V_18 , L_5 ,
V_20 ) ;
F_12 ( V_2 -> V_17 , V_12 * 1000 ) ;
return V_4 ;
}
}
return V_5 ;
...
{
int V_24 ;
V_2 -> V_17 = F_17 ( NULL , L_6 ) ;
if ( F_5 ( V_2 -> V_17 ) )
return F_18 ( V_2 -> V_17 ) ;
if ( ! V_15 ) {
V_24 = F_19 ( V_18 , & V_15 ) ;
if ( V_24 ) {
F_6 ( V_18 ,
