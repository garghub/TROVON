...
static int F_97 ( T_3 * V_167 , struct V_119 * V_3 )
{
int V_170 ;
...
static int F_99 ( unsigned int * V_211 , unsigned int V_157 )
{
int V_212 , V_213 ;
V_213 = 500 ;
switch ( V_157 & V_214 ) {
...
static int F_109 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_34 * V_35 = V_2 -> V_36 ;
T_3 V_167 [ 16 ] ;
struct V_119 * V_3 = & V_22 -> V_120 -> V_3 ;
...
break;
case V_133 :
V_218 = F_99 ( & V_3 -> V_127 , V_3 -> V_157 ) ;
F_102 ( V_2 , 5 , V_218 ) ;
F_66 ( V_2 , 5 , V_134 ) ;
break;
case V_124 :
...
break;
case V_133 :
V_218 = F_99 ( & V_3 -> V_132 , V_3 -> V_157 ) ;
F_102 ( V_2 , 4 , V_218 ) ;
F_66 ( V_2 , 4 , V_142 ) ;
break;
case V_124 :
...
V_133 | V_124 | V_189 ) ;
V_225 |= F_111 ( & V_3 -> V_227 , V_149 ) ;
V_225 |= F_111 ( & V_3 -> V_148 , V_149 | V_228 ) ;
if ( V_225 )
return 1 ;
V_225 |= F_112 ( V_3 -> V_123 ) ;
V_225 |= F_112 ( V_3 -> V_126 ) ;
V_225 |= F_112 ( V_3 -> V_129 ) ;
V_225 |= F_112 ( V_3 -> V_148 ) ;
if ( V_225 )
return 2 ;
switch ( V_3 -> V_123 ) {
case V_189 :
case V_224 :
V_225 |= F_113 ( & V_3 -> V_122 , 0 ) ;
break;
case V_124 :
V_225 |= F_114 ( & V_3 -> V_122 , 39 ) ;
break;
}
if ( V_3 -> V_126 == V_124 )
V_225 |= F_114 ( & V_3 -> V_127 , 39 ) ;
if ( V_3 -> V_129 == V_124 )
V_225 |= F_114 ( & V_3 -> V_132 , 39 ) ;
#define F_115 200000
#define F_116 2000000000
if ( V_3 -> V_126 == V_133 ) {
V_225 |= F_117 ( & V_3 -> V_127 ,
F_115 ) ;
V_225 |= F_114 ( & V_3 -> V_127 ,
F_116 ) ;
} else {
}
if ( V_3 -> V_129 == V_133 ) {
V_225 |= F_117 ( & V_3 -> V_132 ,
F_115 ) ;
V_225 |= F_114 ( & V_3 -> V_132 ,
F_116 ) ;
} else {
}
V_225 |= F_113 ( & V_3 -> V_229 ,
V_3 -> V_131 ) ;
if ( V_3 -> V_148 == V_149 )
V_225 |= F_117 ( & V_3 -> V_151 , 1 ) ;
else
V_225 |= F_113 ( & V_3 -> V_151 , 0 ) ;
if ( V_225 )
return 3 ;
if ( V_3 -> V_126 == V_133 ) {
V_226 = V_3 -> V_127 ;
F_99 ( & V_226 , V_3 -> V_157 ) ;
V_225 |= F_113 ( & V_3 -> V_127 , V_226 ) ;
}
if ( V_3 -> V_129 == V_133 ) {
V_226 = V_3 -> V_132 ;
F_99 ( & V_226 , V_3 -> V_157 ) ;
V_225 |= F_113 ( & V_3 -> V_132 , V_226 ) ;
if ( V_3 -> V_126 == V_133 ) {
...
static int F_118 ( struct V_1 * V_2 , struct V_21 * V_22 )
{
struct V_34 * V_35 = V_2 -> V_36 ;
F_4 ( V_2 , V_125 , V_42 ) ;
F_3 ( 0 , V_2 -> V_6 + V_163 ) ;
...
if ( F_123 ( V_22 , V_111 ) )
F_11 ( V_2 , F_121 ( V_112 ) , V_22 -> V_231 ) ;
V_111 [ 1 ] = F_10 ( V_2 , F_124 ( V_112 ) ) ;
return V_24 -> V_170 ;
}
...
unsigned long V_112 = ( unsigned long ) V_22 -> V_36 ;
int V_30 ;
V_30 = F_126 ( V_2 , V_22 , V_24 , V_111 , 0 ) ;
if ( V_30 )
return V_30 ;
F_11 ( V_2 , F_121 ( V_112 ) , V_22 -> V_232 ) ;
return V_24 -> V_170 ;
}
...
static void F_130 ( struct V_1 * V_2 , T_1 V_237 )
{
...
{
struct V_242 * V_243 = F_133 ( V_2 ) ;
struct V_34 * V_35 = V_2 -> V_36 ;
void * V_14 ;
T_6 V_244 ;
V_14 = F_134 ( V_243 , V_245 , & V_244 ) ;
if ( ! V_14 )
return - V_246 ;
...
struct V_21 * V_22 ;
int V_30 ;
V_35 = F_139 ( V_2 , sizeof( * V_35 ) ) ;
if ( ! V_35 )
return - V_246 ;
V_30 = F_140 ( V_2 ) ;
if ( V_30 )
return V_30 ;
V_2 -> V_6 = F_141 ( V_243 , 0 ) ;
if ( ! V_2 -> V_6 )
return - V_246 ;
F_3 ( 0 , V_2 -> V_6 + V_163 ) ;
...
return V_30 ;
if ( V_243 -> V_155 ) {
V_30 = F_142 ( V_243 -> V_155 , F_87 , V_282 ,
V_2 -> V_283 , V_2 ) ;
if ( V_30 == 0 )
...
static int F_147 ( struct V_242 * V_2 ,
const struct V_313 * V_314 )
{
return F_148 ( V_2 , & V_315 , V_314 -> V_316 ) ;
}
