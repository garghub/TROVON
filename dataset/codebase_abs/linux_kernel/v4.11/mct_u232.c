...
F_27 ( & V_66 -> V_71 , V_73 ) ;
V_66 -> V_75 = V_75 ;
F_19 ( V_13 , & V_66 -> V_33 , V_66 -> V_75 ) ;
F_29 ( & V_66 -> V_71 , V_73 ) ;
V_72 = F_30 ( V_66 -> V_69 , V_20 ) ;
if ( V_72 ) {
F_9 ( & V_13 -> V_5 ,
L_14 ,
V_13 -> V_69 -> V_80 , V_72 ) ;
...
static void F_32 ( struct V_12 * V_13 , int V_81 )
{
unsigned int V_33 ;
struct V_65 * V_66 = F_25 ( V_13 ) ;
F_33 ( & V_66 -> V_71 ) ;
...
static void F_37 ( struct V_82 * V_82 )
{
...
F_38 ( & V_13 -> V_5 , V_89 , V_82 -> V_90 , V_83 ) ;
if ( V_82 -> V_91 > 2 ) {
if ( V_82 -> V_90 ) {
F_39 ( & V_13 -> V_13 , V_83 ,
V_82 -> V_90 ) ;
...
F_11 ( & V_13 -> V_5 , L_19 , V_89 ) ;
V_33 |= V_36 | V_38 ;
F_15 ( V_13 , V_33 ) ;
}
F_3 ( V_11 , V_2 , V_13 , F_43 ( V_11 ) ) ;
if ( ( V_98 & V_101 ) == V_102 ) {
F_11 ( & V_13 -> V_5 , L_20 , V_89 ) ;
V_33 &= ~ ( V_36 | V_38 ) ;
F_15 ( V_13 , V_33 ) ;
}
if ( V_98 & V_103 )
...
static void F_44 ( struct V_10 * V_11 , int V_118 )
{
