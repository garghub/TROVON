...
static int F_106 ( struct V_208 * V_209 , struct V_1 * V_2 )
{
struct V_34 * V_35 ;
struct V_210 * V_211 , * V_212 ;
struct V_213 * V_214 = V_209 -> V_10 . V_215 ;
struct V_216 * V_217 ;
int V_218 , V_4 , V_219 ;
T_1 V_32 , V_220 [ 3 ] ;
V_35 = F_107 ( & V_209 -> V_10 , sizeof( * V_35 ) , V_221 ) ;
if ( ! V_35 )
return - V_222 ;
V_2 -> V_35 = V_35 ;
V_35 -> V_64 = (enum V_223 ) F_108 ( & V_209 -> V_10 ) ;
if ( ! V_35 -> V_64 )
return 1 ;
V_2 -> V_51 = F_109 ( & V_209 -> V_10 , L_54 ) ;
if ( F_36 ( V_2 -> V_51 ) )
return F_110 ( V_2 -> V_51 ) ;
V_2 -> V_52 = F_109 ( & V_209 -> V_10 , L_55 ) ;
if ( F_36 ( V_2 -> V_52 ) )
V_2 -> V_52 = NULL ;
V_35 -> V_73 = F_111 ( & V_209 -> V_10 ) ;
if ( V_35 -> V_73 == V_192 )
V_35 -> V_73 = V_74 ;
V_35 -> V_70 = V_71 ;
if ( ! F_112 ( V_214 , L_56 , & V_32 ) )
if ( V_32 == V_102 )
V_35 -> V_70 = V_32 ;
if ( ! F_112 ( V_214 , L_57 , & V_32 ) && V_32 < 2 )
V_2 -> V_53 = V_32 ;
V_2 -> V_6 [ V_89 ] = V_224 ;
V_2 -> V_6 [ V_7 ] = V_225 ;
V_2 -> V_6 [ V_8 ] = V_226 ;
if ( F_113 ( V_214 , L_58 , & V_218 ) &&
V_218 == sizeof( V_220 ) ) {
F_114 ( V_214 , L_58 ,
V_220 , V_218 / sizeof( * V_220 ) ) ;
V_2 -> V_6 [ V_89 ] = V_220 [ V_89 ] ;
V_2 -> V_6 [ V_7 ] = V_220 [ V_7 ] ;
V_2 -> V_6 [ V_8 ] = V_220 [ V_8 ] ;
}
V_2 -> V_44 = F_115 ( V_214 , L_59 ) ;
V_2 -> V_205 = F_116 ( & V_209 -> V_10 , L_60 ,
V_227 ) ;
if ( F_36 ( V_2 -> V_205 ) )
return F_110 ( V_2 -> V_205 ) ;
V_211 = F_117 ( - V_124 ) ;
V_212 = F_117 ( - V_124 ) ;
if ( F_115 ( V_214 , L_61 ) ) {
V_212 = F_118 ( & V_209 -> V_10 , 0 ) ;
if ( F_36 ( V_212 ) && F_110 ( V_212 ) != - V_124 )
return F_110 ( V_212 ) ;
V_211 = F_118 ( & V_209 -> V_10 , 1 ) ;
if ( F_36 ( V_211 ) && F_110 ( V_211 ) != - V_124 )
return F_110 ( V_211 ) ;
}
if ( ! F_36 ( V_212 ) ) {
V_2 -> V_204 . V_228 = V_212 ;
V_2 -> V_204 . V_200 . V_229 = F_103 ;
V_4 = F_119 ( & V_209 -> V_10 , V_212 ,
V_230 , & V_2 -> V_204 . V_200 ) ;
if ( V_4 < 0 ) {
F_3 ( & V_209 -> V_10 , L_62 ) ;
return V_4 ;
}
V_4 = F_120 ( V_212 , V_230 ) ;
if ( V_4 )
F_55 ( V_164 , & V_2 -> V_162 ) ;
else
F_49 ( V_164 , & V_2 -> V_162 ) ;
...
if ( ! F_36 ( V_211 ) ) {
V_2 -> V_207 . V_228 = V_211 ;
V_2 -> V_207 . V_200 . V_229 = F_105 ;
V_4 = F_119 ( & V_209 -> V_10 , V_211 ,
V_231 , & V_2 -> V_207 . V_200 ) ;
if ( V_4 < 0 ) {
F_3 ( & V_209 -> V_10 , L_63 ) ;
return V_4 ;
}
V_4 = F_120 ( V_211 , V_231 ) ;
if ( V_4 )
F_49 ( V_161 , & V_2 -> V_162 ) ;
else
F_55 ( V_161 , & V_2 -> V_162 ) ;
}
V_217 = F_121 ( V_214 , L_64 , & V_218 ) ;
if ( ! V_217 || ! V_218 )
return 0 ;
V_219 = V_218 / sizeof( T_1 ) ;
if ( V_219 >= V_40 ) {
F_122 ( & V_209 -> V_10 , L_65 , V_219 ) ;
return 0 ;
}
V_35 -> V_37 = F_107 ( & V_209 -> V_10 , V_218 , V_221 ) ;
if ( ! V_35 -> V_37 )
return 0 ;
V_4 = F_114 ( V_214 , L_64 ,
V_35 -> V_37 , V_219 ) ;
if ( ! V_4 )
V_35 -> V_41 = V_219 ;
return 0 ;
}
static int F_123 ( struct V_199 * V_232 ,
unsigned long V_233 , void * V_177 )
{
struct V_1 * V_2 = F_12 ( V_232 , struct V_1 , V_234 ) ;
F_104 ( V_2 -> V_205 , 0 ) ;
return V_206 ;
}
static int F_124 ( struct V_208 * V_209 )
{
struct V_235 V_236 [ 3 ] ;
int V_4 = 0 ;
struct V_213 * V_237 = V_209 -> V_10 . V_215 ;
struct V_34 * V_35 ;
struct V_238 * V_239 ;
struct V_1 * V_2 ;
struct V_24 * V_9 ;
void T_2 * V_240 ;
V_2 = F_107 ( & V_209 -> V_10 , sizeof( struct V_1 ) , V_221 ) ;
if ( ! V_2 )
return - V_222 ;
V_2 -> V_9 . V_93 = F_107 ( & V_209 -> V_10 , sizeof( struct V_123 ) ,
V_221 ) ;
if ( ! V_2 -> V_9 . V_93 )
return - V_222 ;
V_9 = & V_2 -> V_9 ;
V_9 -> V_10 = & V_209 -> V_10 ;
V_2 -> V_105 = F_125 ( & V_209 -> V_10 , V_237 ? L_66 : L_67 ) ;
if ( F_36 ( V_2 -> V_105 ) ) {
F_3 ( & V_209 -> V_10 , L_68 ) ;
return F_110 ( V_2 -> V_105 ) ;
}
V_2 -> V_104 = F_125 ( & V_209 -> V_10 , V_237 ? L_69 : L_70 ) ;
if ( F_36 ( V_2 -> V_104 ) ) {
F_3 ( & V_209 -> V_10 , L_71 ) ;
return F_110 ( V_2 -> V_104 ) ;
}
V_2 -> V_68 = F_125 ( & V_209 -> V_10 ,
V_237 ? L_72 : L_73 ) ;
V_239 = F_126 ( V_209 , V_241 , 0 ) ;
if ( ! V_239 )
return - V_193 ;
V_2 -> V_236 = F_127 ( & V_209 -> V_10 , V_239 -> V_242 , F_128 ( V_239 ) ) ;
if ( ! V_2 -> V_236 )
return - V_222 ;
V_35 = F_129 ( & V_209 -> V_10 ) ;
if ( ! V_35 ) {
if ( ! V_237 )
return - V_243 ;
V_4 = F_106 ( V_209 , V_2 ) ;
...
if ( V_2 -> V_53 ) {
V_240 = F_130 ( & V_209 -> V_10 , V_244 , 4 ) ;
if ( ! V_240 )
return - V_222 ;
F_13 ( 0x1 , V_240 ) ;
}
F_52 ( & V_209 -> V_10 , L_74 , V_2 -> V_236 ) ;
V_2 -> V_96 = F_131 ( V_209 , 0 ) ;
if ( V_2 -> V_96 < 0 ) {
F_3 ( & V_209 -> V_10 , L_75 ) ;
V_4 = V_2 -> V_96 ;
return V_2 -> V_96 ;
...
V_236 [ 1 ] . V_245 = L_77 ;
V_236 [ 2 ] . V_245 = L_78 ;
V_4 = F_132 ( V_2 -> V_9 . V_10 , F_133 ( V_236 ) , V_236 ) ;
if ( V_4 )
return V_4 ;
V_2 -> V_5 = V_236 [ 0 ] . V_246 ;
V_2 -> V_12 = V_236 [ 1 ] . V_246 ;
V_2 -> V_15 = V_236 [ 2 ] . V_246 ;
F_134 ( V_2 -> V_105 , 60000000 ) ;
F_37 ( V_2 -> V_105 ) ;
F_37 ( V_2 -> V_104 ) ;
if ( ! F_36 ( V_2 -> V_68 ) )
F_37 ( V_2 -> V_68 ) ;
...
F_13 ( 0 , V_250 ) ;
F_13 ( 0 , V_72 ) ;
F_135 ( & V_2 -> V_126 , F_83 ) ;
F_136 ( & V_2 -> V_137 , F_80 ) ;
V_4 = F_137 ( & V_209 -> V_10 , V_2 -> V_96 , F_87 , V_119 ,
L_52 , V_2 ) ;
if ( V_4 ) {
F_3 ( & V_209 -> V_10 , L_82 ) ;
goto V_249;
...
static int F_144 ( struct V_208 * V_209 )
{
struct V_1 * V_2 = F_145 ( V_209 ) ;
struct V_24 * V_9 = & V_2 -> V_9 ;
int V_26 = 0 ;
...
static int F_152 ( struct V_258 * V_10 )
{
struct V_1 * V_2 = F_153 ( V_10 ) ;
struct V_123 * V_93 = V_2 -> V_9 . V_93 ;
F_59 ( V_10 , L_85 ) ;
if ( V_93 -> V_125 != V_122 )
F_154 ( V_10 , 1000 ) ;
...
static int F_155 ( struct V_258 * V_10 )
{
struct V_1 * V_2 = F_153 ( V_10 ) ;
F_59 ( V_10 , L_86 ) ;
return F_43 ( V_2 ) ;
}
static int F_156 ( struct V_258 * V_10 )
{
struct V_1 * V_2 = F_153 ( V_10 ) ;
F_59 ( V_10 , L_87 ) ;
return F_53 ( V_2 ) ;
}
static int F_157 ( struct V_258 * V_10 )
{
struct V_1 * V_2 = F_153 ( V_10 ) ;
F_59 ( V_10 , L_88 ) ;
return F_43 ( V_2 ) ;
}
static int F_158 ( struct V_258 * V_10 )
{
struct V_1 * V_2 = F_153 ( V_10 ) ;
int V_4 ;
F_59 ( V_10 , L_89 ) ;
