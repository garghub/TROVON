...
V_45 = V_46 + 2 * V_47 ;
while ( ( F_3 ( V_14 , V_49 ) & ( 1 << V_11 -> V_26 ) ) &&
F_24 ( V_46 , V_45 ) )
F_25 ( 10 , 100 ) ;
F_18 ( V_14 -> V_21 ) ;
}
...
if ( V_52 -> V_19 . V_55 )
return F_27 ( & V_52 -> V_19 ) ;
V_54 = F_28 ( V_52 ) ;
return (struct V_50 * ) V_54 -> V_56 ;
}
...
if ( ! V_57 )
return - V_60 ;
V_14 = F_30 ( & V_52 -> V_19 , sizeof( * V_14 ) , V_61 ) ;
if ( ! V_14 )
return - V_62 ;
V_59 = F_31 ( V_52 , V_63 , 0 ) ;
V_14 -> V_5 = F_32 ( & V_52 -> V_19 , V_59 ) ;
if ( F_33 ( V_14 -> V_5 ) )
return F_34 ( V_14 -> V_5 ) ;
V_14 -> V_21 = F_35 ( & V_52 -> V_19 , NULL ) ;
if ( F_33 ( V_14 -> V_21 ) )
