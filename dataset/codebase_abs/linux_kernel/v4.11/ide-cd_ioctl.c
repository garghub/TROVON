...
F_22 ( V_81 ) -> type = V_85 ;
V_81 -> V_86 = V_87 ;
V_69 = F_23 ( V_4 -> V_82 , V_35 -> V_88 , V_81 , 0 ) ;
F_24 ( V_81 ) ;
if ( V_4 -> V_7 & V_43 )
( void ) F_9 ( V_4 , 1 , & V_13 ) ;
return V_69 ;
}
static int F_25 ( T_1 * V_4 , int V_89 ,
struct V_90 * * V_91 )
{
struct V_34 * V_68 = V_4 -> V_36 ;
...
if ( ( V_4 -> V_7 & V_8 ) == 0 )
return - V_16 ;
V_92 = V_67 -> V_93 . V_94 - V_67 -> V_93 . V_95 + 1 ;
if ( V_67 -> V_93 . V_95 == V_96 )
V_92 = 0 ;
if ( V_89 == V_96 )
* V_91 = & V_67 -> V_91 [ V_92 ] ;
else if ( V_89 < V_67 -> V_93 . V_95 || V_89 > V_67 -> V_93 . V_94 )
return - V_16 ;
else
* V_91 = & V_67 -> V_91 [ V_89 - V_67 -> V_93 . V_95 ] ;
return 0 ;
}
static int F_26 ( T_1 * V_4 , void * V_97 )
{
struct V_98 * V_99 = V_97 ;
struct V_90 * V_100 , * V_101 ;
unsigned long V_102 , V_103 ;
int V_14 ;
struct V_12 V_13 ;
unsigned char V_39 [ V_40 ] ;
V_14 = F_25 ( V_4 , V_99 -> V_104 , & V_100 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_25 ( V_4 , V_99 -> V_105 , & V_101 ) ;
if ( V_14 )
return V_14 ;
if ( V_99 -> V_105 != V_96 )
++ V_101 ;
V_102 = V_100 -> V_70 . V_71 ;
V_103 = V_101 -> V_70 . V_71 ;
if ( V_103 <= V_102 )
return - V_16 ;
memset ( V_39 , 0 , V_40 ) ;
V_39 [ 0 ] = V_106 ;
F_27 ( V_102 , & V_39 [ 3 ] , & V_39 [ 4 ] , & V_39 [ 5 ] ) ;
F_27 ( V_103 - 1 , & V_39 [ 6 ] , & V_39 [ 7 ] , & V_39 [ 8 ] ) ;
return F_8 ( V_4 , V_39 , 0 , NULL , NULL , & V_13 , 0 , 0 ) ;
}
static int F_28 ( T_1 * V_4 , void * V_97 )
{
struct V_34 * V_35 = V_4 -> V_36 ;
...
return V_14 ;
V_67 = V_35 -> V_67 ;
V_108 -> V_109 = V_67 -> V_93 . V_95 ;
V_108 -> V_110 = V_67 -> V_93 . V_94 ;
return 0 ;
}
static int F_29 ( T_1 * V_4 , void * V_97 )
{
struct V_111 * V_112 = V_97 ;
struct V_90 * V_113 ;
int V_14 ;
V_14 = F_25 ( V_4 , V_112 -> V_114 , & V_113 ) ;
if ( V_14 )
return V_14 ;
V_112 -> V_115 = V_113 -> V_116 ;
V_112 -> V_117 = V_113 -> V_118 ;
if ( V_112 -> V_119 == V_120 ) {
F_27 ( V_113 -> V_70 . V_71 ,
& V_112 -> V_121 . V_122 . V_123 ,
& V_112 -> V_121 . V_122 . V_124 ,
& V_112 -> V_121 . V_122 . V_125 ) ;
} else
V_112 -> V_121 . V_71 = V_113 -> V_70 . V_71 ;
return 0 ;
}
int F_30 ( struct V_1 * V_2 ,
unsigned int V_39 , void * V_97 )
{
T_1 * V_4 = V_2 -> V_5 ;
switch ( V_39 ) {
case V_126 :
return F_26 ( V_4 , V_97 ) ;
case V_127 :
return F_28 ( V_4 , V_97 ) ;
case V_128 :
return F_29 ( V_4 , V_97 ) ;
default:
return - V_16 ;
}
}
...
T_1 * V_4 = V_2 -> V_5 ;
T_3 V_131 = 0 ;
unsigned V_77 = V_130 -> V_132 ;
if ( V_130 -> V_133 <= 0 )
V_130 -> V_133 = V_134 ;
if ( V_130 -> V_13 )
memset ( V_130 -> V_13 , 0 , sizeof( struct V_12 ) ) ;
if ( V_130 -> V_135 )
V_131 |= V_87 ;
V_130 -> V_14 = F_8 ( V_4 , V_130 -> V_39 ,
V_130 -> V_136 == V_137 ,
V_130 -> V_138 , & V_77 ,
V_130 -> V_13 , V_130 -> V_133 , V_131 ) ;
if ( ! V_130 -> V_14 )
V_130 -> V_132 -= V_77 ;
return V_130 -> V_14 ;
}
