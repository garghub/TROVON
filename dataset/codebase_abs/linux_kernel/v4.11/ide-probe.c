...
F_102 ( & V_42 -> V_227 ) ;
F_103 ( & V_42 -> V_228 ) ;
V_42 -> V_228 . V_229 = & V_230 ;
V_42 -> V_228 . V_160 = ( unsigned long ) V_42 ;
F_100 ( & V_42 -> V_104 ) ;
V_42 -> V_45 = & V_231 ;
F_98 ( V_42 ) ;
}
static void F_104 ( T_4 * V_42 , struct V_232 * V_233 )
{
memcpy ( & V_42 -> V_58 , & V_233 -> V_58 , sizeof( V_42 -> V_58 ) ) ;
V_42 -> V_118 = V_233 -> V_118 ;
V_42 -> V_102 = V_233 -> V_102 ;
V_42 -> V_103 . V_106 = V_233 -> V_106 ? V_233 -> V_106 : V_233 -> V_102 ;
V_42 -> V_234 = V_233 -> V_235 ;
}
static int F_105 ( const struct V_194 * V_195 )
{
int V_236 = - V_237 ;
T_3 V_238 = ( V_195 && ( V_195 -> V_69 & V_239 ) ) ? 0 : 1 ;
T_3 V_111 = ( V_195 && ( V_195 -> V_69 & V_240 ) ) ? 1 : 0 ;
F_67 ( & V_147 ) ;
if ( V_238 ) {
if ( ( V_241 | V_111 ) != ( 1 << V_242 ) - 1 )
V_236 = F_106 ( V_241 | V_111 ) ;
} else {
if ( ( V_241 | 3 ) != ( 1 << V_242 ) - 1 )
V_236 = F_106 ( V_241 | 3 ) ;
else if ( ( V_241 & 3 ) != 3 )
V_236 = F_106 ( V_241 ) ;
}
...
static int F_110 ( T_4 * V_42 , int V_243 )
{
T_1 * V_1 ;
int V_111 ;
for ( V_111 = 0 ; V_111 < V_174 ; V_111 ++ ) {
V_1 = F_111 ( sizeof( * V_1 ) , V_137 , V_243 ) ;
if ( V_1 == NULL )
goto V_244;
V_1 -> V_2 = F_111 ( V_47 , V_137 , V_243 ) ;
if ( V_1 -> V_2 == NULL )
goto V_245;
...
struct V_232 * * V_248 , unsigned int V_249 )
{
struct V_148 * V_149 ;
struct V_92 * V_102 = V_248 [ 0 ] ? V_248 [ 0 ] -> V_102 : NULL ;
int V_243 = V_102 ? F_113 ( V_102 ) : - 1 ;
int V_111 ;
V_149 = F_111 ( sizeof( * V_149 ) , V_137 , V_243 ) ;
if ( V_149 == NULL )
return NULL ;
for ( V_111 = 0 ; V_111 < V_249 ; V_111 ++ ) {
T_4 * V_42 ;
int V_236 ;
if ( V_248 [ V_111 ] == NULL )
continue;
V_42 = F_111 ( sizeof( * V_42 ) , V_137 , V_243 ) ;
if ( V_42 == NULL )
continue;
if ( F_110 ( V_42 , V_243 ) < 0 ) {
F_109 ( V_42 ) ;
continue;
}
V_236 = F_105 ( V_195 ) ;
...
for ( V_111 = 0 ; V_111 < V_253 ; V_111 ++ ) {
if ( V_149 -> V_250 [ V_111 ] == V_42 ) {
V_149 -> V_250 [ V_111 ] = NULL ;
V_149 -> V_249 -- ;
}
}
F_114 ( V_42 ) ;
...
F_104 ( V_42 , V_248 [ V_111 ] ) ;
F_117 ( V_42 ) ;
if ( ( V_111 & 1 ) && V_254 ) {
V_42 -> V_254 = V_254 ;
V_254 -> V_254 = V_42 ;
}
V_254 = ( V_111 & 1 ) ? NULL : V_42 ;
...
V_42 -> V_93 = 1 ;
V_42 -> V_255 &= ~ V_256 ;
if ( ( V_42 -> V_69 & V_257 ) == 0 ||
V_42 -> V_254 == NULL || V_42 -> V_254 -> V_93 == 0 ) {
if ( F_32 ( V_42 ) ) {
F_115 ( V_42 ) ;
continue;
}
...
int F_123 ( const struct V_194 * V_195 , struct V_232 * * V_248 ,
unsigned int V_249 , struct V_148 * * V_258 )
{
struct V_148 * V_149 ;
int V_61 ;
V_149 = F_112 ( V_195 , V_248 , V_249 ) ;
if ( V_149 == NULL )
return - V_247 ;
V_61 = F_116 ( V_149 , V_195 , V_248 ) ;
if ( V_61 ) {
F_124 ( V_149 ) ;
return V_61 ;
}
