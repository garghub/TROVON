...
if ( V_71 < 0 )
continue;
V_2 -> V_5 [ V_71 ] . V_11 . V_41 += V_68 [ V_4 ] . V_23 ;
...
static void
F_26 ( enum V_104 V_105 ,
struct V_6 * V_106 ,
struct V_107 * V_22 ,
struct V_108 * V_109 )
{
int V_110 = ! ! ( V_22 -> V_72 & V_111 ) ;
int V_112 = F_27 ( V_109 ) ;
V_106 -> V_10 = F_28 ( V_105 , 1200 ,
F_29 ( V_22 -> V_113 , 1 << V_112 ) , V_110 , 1 ,
V_112 ) ;
V_106 -> V_114 = F_28 ( V_105 , 10 ,
F_29 ( V_22 -> V_113 , 1 << V_112 ) , V_110 , 1 ,
V_112 ) ;
}
static void
F_30 ( struct V_1 * V_2 )
{
unsigned int V_4 , V_115 , V_116 ;
T_1 V_117 [ 8 ] ;
V_2 -> V_86 = 0 ;
V_2 -> V_85 = 0 ;
memset ( V_2 -> V_118 , 0xff , V_87 * V_2 -> V_54 ) ;
for ( V_115 = 0 ; V_115 < V_87 ; V_115 ++ ) {
F_31 ( V_117 , sizeof( V_117 ) ) ;
for ( V_4 = 0 ; V_4 < V_2 -> V_54 ; V_4 ++ ) {
V_116 = ( V_4 + V_117 [ V_4 & 7 ] ) % V_2 -> V_54 ;
while ( F_22 ( V_2 , V_116 , V_115 ) != 0xff )
V_116 = ( V_116 + 1 ) % V_2 -> V_54 ;
F_22 ( V_2 , V_116 , V_115 ) = V_4 ;
}
}
}
static void
...
struct V_29 * V_30 = V_60 ;
struct V_107 * V_119 ;
unsigned int V_4 , V_120 = 0 ;
unsigned int V_121 = 9 ;
T_2 V_122 ;
V_2 -> V_38 = V_38 ;
V_2 -> V_36 = F_33 ( V_62 , V_38 ) ;
V_119 = & V_62 -> V_123 [ V_2 -> V_36 ] ;
V_2 -> V_124 = F_28 ( V_62 -> V_105 , 10 ,
V_119 -> V_113 ,
! ! ( V_119 -> V_72 & V_111 ) , 1 ,
F_27 ( V_109 ) ) ;
V_122 = F_34 ( & V_30 -> V_33 -> V_125 . V_109 ) ;
memset ( V_2 -> V_32 , 0 , sizeof( V_2 -> V_32 ) ) ;
V_2 -> V_35 = 0 ;
for ( V_4 = 0 ; V_4 < V_62 -> V_126 ; V_4 ++ ) {
struct V_6 * V_7 = & V_2 -> V_5 [ V_120 ] ;
struct V_14 * V_39 = & V_2 -> V_5 [ V_120 ] . V_11 ;
unsigned int V_127 = 0 , V_128 = 0 , V_129 = 0 ;
unsigned int V_130 ;
unsigned int V_131 = V_30 -> V_132 ;
int V_112 ;
if ( ! F_35 ( V_38 , V_62 -> V_105 , V_4 ) )
continue;
if ( ( V_122 & V_62 -> V_123 [ V_4 ] . V_72 ) != V_122 )
continue;
V_120 ++ ;
...
V_7 -> V_3 = V_4 ;
V_112 = F_27 ( V_109 ) ;
V_7 -> V_113 = F_29 ( V_62 -> V_123 [ V_4 ] . V_113 ,
( 1 << V_112 ) * 5 ) ;
F_26 ( V_62 -> V_105 , V_7 , & V_62 -> V_123 [ V_4 ] ,
V_109 ) ;
V_7 -> V_56 = - 1 ;
V_39 -> V_55 = 1 ;
V_7 -> V_26 = 1 ;
V_39 -> V_28 = 1 ;
V_127 = V_7 -> V_10 + V_2 -> V_124 ;
do {
V_130 = V_7 -> V_114 + V_7 -> V_10 ;
V_130 += ( V_121 * V_131 ) >> 1 ;
V_131 = F_20 ( ( V_131 << 1 ) | 1 , V_30 -> V_133 ) ;
V_127 += V_130 ;
V_128 += V_130 + V_2 -> V_124 ;
V_129 += V_130 + 2 * V_2 -> V_124 ;
if ( ( V_128 < V_30 -> V_134 ) &&
( V_7 -> V_26 < V_30 -> V_37 ) )
V_7 -> V_26 ++ ;
if ( ( V_129 < V_30 -> V_134 ) &&
( V_39 -> V_28 < V_30 -> V_37 ) )
V_39 -> V_28 ++ ;
} while ( ( V_127 < V_30 -> V_134 ) &&
( ++ V_7 -> V_11 . V_55 < V_30 -> V_37 ) );
V_7 -> V_24 = V_39 -> V_55 ;
if ( ! ( V_62 -> V_123 [ V_4 ] . V_72 & V_111 ) )
V_7 -> V_26 = V_39 -> V_55 ;
}
for ( V_4 = V_120 ; V_4 < V_62 -> V_126 ; V_4 ++ ) {
struct V_6 * V_7 = & V_2 -> V_5 [ V_4 ] ;
V_7 -> V_3 = - 1 ;
}
V_2 -> V_54 = V_120 ;
...
static void *
F_36 ( void * V_60 , struct V_63 * V_38 , T_3 V_135 )
{
struct V_61 * V_62 ;
struct V_1 * V_2 ;
struct V_29 * V_30 = V_60 ;
struct V_136 * V_33 = V_30 -> V_33 ;
int V_34 = 0 ;
int V_4 ;
V_2 = F_8 ( sizeof( struct V_1 ) , V_135 ) ;
if ( ! V_2 )
return NULL ;
for ( V_4 = 0 ; V_4 < V_137 ; V_4 ++ ) {
V_62 = V_33 -> V_138 -> V_139 [ V_4 ] ;
if ( V_62 && V_62 -> V_126 > V_34 )
V_34 = V_62 -> V_126 ;
}
V_2 -> V_5 = F_8 ( sizeof( struct V_6 ) * V_34 , V_135 ) ;
if ( ! V_2 -> V_5 )
goto error;
V_2 -> V_118 = F_37 ( V_87 * V_34 , V_135 ) ;
if ( ! V_2 -> V_118 )
goto V_140;
V_2 -> V_58 = V_59 ;
return V_2 ;
...
{
static const int V_123 [ 4 ] = { 10 , 20 , 55 , 110 } ;
struct V_61 * V_62 ;
T_2 V_122 = F_34 ( & V_30 -> V_33 -> V_125 . V_109 ) ;
int V_4 , V_13 ;
V_62 = V_30 -> V_33 -> V_138 -> V_139 [ V_141 ] ;
if ( ! V_62 )
return;
for ( V_4 = 0 , V_13 = 0 ; V_4 < V_62 -> V_126 ; V_4 ++ ) {
struct V_107 * V_22 = & V_62 -> V_123 [ V_4 ] ;
if ( V_22 -> V_72 & V_111 )
continue;
if ( ( V_122 & V_62 -> V_123 [ V_4 ] . V_72 ) != V_122 )
continue;
for ( V_13 = 0 ; V_13 < F_41 ( V_123 ) ; V_13 ++ ) {
if ( V_22 -> V_113 != V_123 [ V_13 ] )
continue;
V_30 -> V_142 [ V_13 ] = V_4 ;
break;
}
...
static void *
F_42 ( struct V_136 * V_33 , struct V_143 * V_144 )
{
struct V_29 * V_30 ;
