...
F_47 ( V_28 , V_29 ) ;
F_48 () ;
F_49 ( NULL , F_5 ( V_28 ) , V_29 ) ;
F_33 ( V_17 ) ;
F_50 ( V_16 , V_24 -> V_40 && V_24 -> V_40 -> V_44 ,
L_4 , V_43 ) ;
}
struct V_38 * F_51 ( T_2 V_45 )
{
struct V_37 * V_37 ;
F_52 ( ! F_53 () ) ;
V_37 = F_54 ( & V_35 , V_45 >> V_36 ) ;
return V_37 ? & V_37 -> V_24 : NULL ;
}
void * F_55 ( struct V_15 * V_16 , struct V_26 * V_17 ,
...
if ( V_51 ) {
F_58 ( V_16 , L_6 ,
V_43 , V_17 , F_59 ( V_51 -> V_16 ) ) ;
error = - V_52 ;
break;
}
error = F_60 ( & V_35 , V_27 >> V_36 ,
V_37 ) ;
if ( error ) {
F_58 ( V_16 , L_7 , V_43 , error ) ;
break;
}
}
F_38 ( & V_33 ) ;
...
if ( V_49 < 0 )
V_49 = F_61 () ;
error = F_62 ( NULL , & V_47 , F_5 ( V_28 ) , 0 ,
V_29 ) ;
if ( error )
goto V_54;
F_46 () ;
error = F_63 ( V_49 , V_28 , V_29 , true ) ;
F_48 () ;
if ( error )
goto V_55;
F_64 (pfn, page_map) {
...
void F_66 ( struct V_39 * V_40 , unsigned long V_58 )
{
V_40 -> V_44 -= V_58 ;
}
struct V_39 * F_67 ( unsigned long V_59 )
{
struct V_23 * V_23 = (struct V_23 * ) V_59 ;
struct V_38 * V_24 ;
F_56 () ;
V_24 = F_51 ( F_68 ( F_69 ( V_23 ) ) ) ;
F_57 () ;
