...
V_39 -> V_52 [ 6 ] = V_35 -> V_36 . V_110 ;
}
return 0 ;
}
static int F_28 ( struct V_85 * V_86 , T_9 * V_87 ,
struct V_38 * V_39 )
{
T_12 V_111 ;
T_13 T_3 * V_89 ;
...
F_29 ( & V_89 -> V_113 . V_121 , V_39 -> V_52 [ 15 ] ) ||
...
V_39 -> V_52 [ 5 ] = V_35 -> V_36 . V_110 ;
return 0 ;
}
void F_30 ( struct V_85 * V_86 , T_9 * V_124 ,
struct V_38 * V_39 )
{
int V_125 ;
if ( V_86 -> V_77 . V_80 . V_81 & V_126 )
V_125 = F_28 ( V_86 , V_124 , V_39 ) ;
else
V_125 = F_27 ( V_86 , V_124 , V_39 ) ;
F_31 ( V_125 , V_86 , F_32 ( V_127 ) ) ;
}
