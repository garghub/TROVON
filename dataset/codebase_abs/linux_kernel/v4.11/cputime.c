...
static T_1 F_71 ( struct V_11 * V_52 )
{
unsigned long V_81 = F_72 ( V_82 ) ;
if ( F_73 ( V_81 , ( unsigned long ) V_52 -> V_83 ) )
return 0 ;
return F_74 ( V_81 - V_52 -> V_83 ) ;
}
static T_1 F_75 ( struct V_11 * V_52 )
{
unsigned long V_81 = F_72 ( V_82 ) ;
T_1 V_3 , V_64 ;
V_3 = F_74 ( V_81 - V_52 -> V_83 ) ;
V_64 = F_35 ( V_3 ) ;
F_36 ( V_52 -> V_84 == V_85 ) ;
V_52 -> V_83 = V_81 ;
return V_3 - V_64 ;
}
static void F_76 ( struct V_11 * V_52 )
{
F_25 ( V_52 , F_26 () , F_75 ( V_52 ) ) ;
}
...
void F_83 ( struct V_11 * V_46 , int V_14 )
{
unsigned long V_33 ;
F_84 ( V_33 ) ;
F_77 ( & V_46 -> V_86 ) ;
...
V_57 = F_88 ( & V_46 -> V_86 ) ;
V_28 = V_46 -> V_28 ;
if ( V_46 -> V_84 == V_87 && V_46 -> V_33 & V_34 )
V_28 += F_71 ( V_46 ) ;
} while ( F_89 ( & V_46 -> V_86 , V_57 ) );
return V_28 ;
}
...
* V_25 = V_46 -> V_25 ;
* V_31 = V_46 -> V_31 ;
if ( V_46 -> V_84 == V_85 || F_53 ( V_46 ) )
continue;
V_3 = F_71 ( V_46 ) ;
if ( V_46 -> V_84 == V_88 || V_46 -> V_33 & V_34 )
* V_25 += V_3 ;
else if ( V_46 -> V_84 == V_87 )
* V_31 += V_3 ;
} while ( F_89 ( & V_46 -> V_86 , V_57 ) );
}
