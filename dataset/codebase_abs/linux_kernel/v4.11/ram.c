...
T_7 * V_91 , T_4 V_92 ,
T_3 V_43 ,
unsigned int * V_93 , T_8 V_94 , T_8 V_60 )
{
int V_95 = - V_46 ;
int V_19 ;
T_4 V_96 ;
...
if ( V_95 )
goto V_129;
V_4 -> V_66 = ( V_4 -> V_60 & V_61 )
? V_130
: 1 ;
V_95 = F_30 ( L_29 , V_90 , V_4 , & V_4 -> V_62 , & V_91 ,
V_4 -> V_122 , - 1 ,
& V_4 -> V_66 , V_131 ,
( V_4 -> V_60 & V_61 )
? V_132 : 0 ) ;
...
V_4 -> V_135 . V_60 = V_139 ;
if ( V_4 -> V_121 )
V_4 -> V_135 . V_60 |= V_140 ;
if ( V_4 -> V_122 )
V_4 -> V_135 . V_60 |= V_141 ;
if ( V_4 -> V_123 )
V_4 -> V_135 . V_60 |= V_142 ;
V_95 = F_52 ( & V_4 -> V_135 ) ;
if ( V_95 ) {
F_48 ( L_32 ) ;
goto V_143;
