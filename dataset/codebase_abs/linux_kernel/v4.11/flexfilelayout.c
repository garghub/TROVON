...
static void F_134 ( struct V_74 * V_83 ,
...
V_12 = F_135 ( F_9 ( V_83 -> V_116 ) ,
V_43 , V_64 , V_65 , V_191 , V_272 ,
V_154 ) ;
F_136 ( V_83 -> V_116 -> V_46 , V_83 ) ;
...
{
int V_12 ;
F_138 ( V_198 , V_151 -> V_207 ) ;
if ( V_151 -> V_207 < 0 )
F_134 ( V_198 -> V_83 , V_198 -> V_281 ,
...
static bool
F_141 ( struct V_74 * V_83 )
{
return ! ( F_72 ( V_83 ) -> V_112 & V_288 ) ;
}
static void
F_142 ( struct V_2 * V_2 ,
struct V_74 * V_83 ,
T_10 V_289 )
{
if ( ! F_141 ( V_83 ) )
return;
F_143 ( V_2 , V_83 , V_289 ) ;
F_13 ( L_23 , V_23 , V_2 -> V_290 ,
( unsigned long long ) F_123 ( V_2 ) -> V_49 -> V_291 ) ;
}
static bool
F_144 ( struct V_74 * V_83 , int V_170 )
{
struct V_214 * V_292 = F_116 ( V_83 , V_170 ) ;
return F_145 ( V_292 ) ;
}
static void F_146 ( struct V_150 * V_151 ,
struct V_197 * V_198 )
{
...
static void F_139 ( struct V_150 * V_151 ,
struct V_197 * V_198 )
{
if ( ! F_147 ( V_293 , & V_198 -> V_112 ) )
return;
F_87 ( V_151 ,
F_101 ( V_198 -> V_83 , V_198 -> V_281 ) ,
V_198 -> args . V_203 ,
...
if ( F_144 ( V_198 -> V_83 , V_198 -> V_281 ) ) {
F_149 ( V_151 , - V_248 ) ;
return - V_257 ;
}
F_146 ( V_151 , V_198 ) ;
...
static void F_150 ( struct V_150 * V_151 , void * V_22 )
{
struct V_197 * V_198 = V_22 ;
if ( F_148 ( V_151 , V_198 ) )
return;
F_151 ( V_151 ) ;
}
static void F_152 ( struct V_150 * V_151 , void * V_22 )
{
struct V_197 * V_198 = V_22 ;
if ( F_153 ( V_198 -> V_286 ,
& V_198 -> args . V_295 ,
& V_198 -> V_282 . V_296 ,
V_151 ) )
return;
if ( F_148 ( V_151 , V_198 ) )
return;
if ( F_154 ( & V_198 -> args . V_17 , V_198 -> args . V_285 ,
V_198 -> args . V_297 , V_298 ) == - V_99 )
F_149 ( V_151 , - V_99 ) ;
}
static void F_155 ( struct V_150 * V_151 , void * V_22 )
{
struct V_197 * V_198 = V_22 ;
F_13 ( L_24 , V_23 , V_151 -> V_207 ) ;
if ( F_45 ( V_206 , & V_198 -> V_112 ) &&
V_151 -> V_207 == 0 ) {
F_156 ( V_151 , & V_198 -> V_282 . V_296 ) ;
return;
}
V_198 -> V_299 -> V_300 ( V_151 , V_198 ) ;
}
static void F_157 ( struct V_150 * V_151 , void * V_22 )
{
struct V_197 * V_198 = V_22 ;
F_139 ( V_151 , V_198 ) ;
F_158 ( V_151 ,
& F_159 ( V_198 -> V_2 ) -> V_301 [ V_302 ] ) ;
}
static void F_160 ( void * V_22 )
{
struct V_197 * V_198 = V_22 ;
F_139 ( & V_198 -> V_151 , V_198 ) ;
F_161 ( V_22 ) ;
}
static int F_162 ( struct V_150 * V_151 ,
struct V_197 * V_198 )
{
T_10 V_303 = 0 ;
int V_12 ;
F_163 ( V_198 , V_151 -> V_207 ) ;
if ( V_151 -> V_207 < 0 )
F_134 ( V_198 -> V_83 , V_198 -> V_281 ,
V_198 -> args . V_64 , V_198 -> args . V_203 ,
...
F_142 ( V_198 -> V_2 , V_198 -> V_83 , V_303 ) ;
V_198 -> V_309 . V_310 = 0 ;
if ( V_151 -> V_207 >= 0 )
F_164 ( V_198 ) ;
return 0 ;
}
static int F_165 ( struct V_150 * V_151 ,
struct V_311 * V_22 )
{
int V_12 ;
F_166 ( V_22 , V_151 -> V_207 ) ;
if ( V_151 -> V_207 < 0 )
F_134 ( V_22 -> V_83 , V_22 -> V_312 ,
...
F_142 ( V_22 -> V_2 , V_22 -> V_83 , V_22 -> V_314 ) ;
return 0 ;
}
static void F_168 ( struct V_150 * V_151 ,
struct V_197 * V_198 )
{
if ( F_110 ( V_293 , & V_198 -> V_112 ) )
return;
...
static int F_170 ( struct V_150 * V_151 ,
struct V_197 * V_198 )
{
if ( F_12 ( F_45 ( V_294 , & V_198 -> args . V_285 -> V_112 ) ) ) {
F_149 ( V_151 , - V_99 ) ;
...
static void F_171 ( struct V_150 * V_151 , void * V_22 )
{
struct V_197 * V_198 = V_22 ;
if ( F_170 ( V_151 , V_198 ) )
return;
F_151 ( V_151 ) ;
}
...
F_169 ( V_151 , V_198 ) ;
F_158 ( V_151 ,
& F_159 ( V_198 -> V_2 ) -> V_301 [ V_316 ] ) ;
}
static void F_175 ( void * V_22 )
{
struct V_197 * V_198 = V_22 ;
F_169 ( & V_198 -> V_151 , V_198 ) ;
F_161 ( V_22 ) ;
}
static void F_176 ( struct V_150 * V_151 ,
struct V_311 * V_317 )
{
if ( F_110 ( V_293 , & V_317 -> V_112 ) )
return;
F_88 ( V_317 -> V_2 ,
F_101 ( V_317 -> V_83 , V_317 -> V_312 ) ,
0 , V_151 -> V_152 ) ;
}
...
static void F_179 ( struct V_150 * V_151 , void * V_22 )
{
F_178 ( V_151 , V_22 ) ;
F_151 ( V_151 ) ;
}
...
static void F_183 ( struct V_150 * V_151 , void * V_22 )
{
struct V_311 * V_317 = V_22 ;
F_177 ( V_151 , V_317 ) ;
F_158 ( V_151 ,
& F_159 ( V_317 -> V_2 ) -> V_301 [ V_320 ] ) ;
}
static void F_184 ( void * V_22 )
{
struct V_311 * V_317 = V_22 ;
F_177 ( & V_317 -> V_151 , V_317 ) ;
F_185 ( V_22 ) ;
}
static enum V_321
F_186 ( struct V_197 * V_198 )
{
...
if ( ! V_161 )
goto V_327;
V_323 = F_187 ( V_83 , V_170 , V_161 -> V_286 ,
V_198 -> V_2 ) ;
if ( F_64 ( V_323 ) )
goto V_327;
V_324 = F_188 ( V_83 , V_170 , V_198 -> V_52 ) ;
if ( ! V_324 )
goto V_327;
V_268 = F_189 ( V_83 , V_170 ) ;
F_13 ( L_26 , V_23 ,
V_161 -> V_328 , F_190 ( & V_161 -> V_286 -> V_329 ) , V_268 ) ;
V_198 -> V_330 = F_137 ;
F_191 ( & V_161 -> V_286 -> V_329 ) ;
V_198 -> V_286 = V_161 -> V_286 ;
V_28 = F_192 ( V_83 , V_170 ) ;
if ( V_28 )
V_198 -> args . V_28 = V_28 ;
V_198 -> args . V_64 = V_64 ;
V_198 -> V_308 = V_64 ;
F_193 ( V_323 , V_198 , V_324 , V_161 -> V_286 -> V_331 ,
V_268 == 3 ? & V_332 :
& V_333 ,
0 , V_334 ) ;
F_35 ( V_324 ) ;
...
static enum V_321
F_194 ( struct V_197 * V_198 , int V_338 )
{
struct V_74 * V_83 = V_198 -> V_83 ;
struct V_166 * V_161 ;
struct V_322 * V_323 ;
...
V_64 , V_161 -> V_328 , F_190 ( & V_161 -> V_286 -> V_329 ) ,
V_268 ) ;
V_198 -> V_330 = F_162 ;
F_191 ( & V_161 -> V_286 -> V_329 ) ;
V_198 -> V_286 = V_161 -> V_286 ;
...
static T_4 F_195 ( struct V_74 * V_83 , T_4 V_38 )
{
return V_38 ;
}
static struct V_27 *
F_196 ( struct V_74 * V_83 , T_4 V_38 )
{
struct V_56 * V_342 = F_72 ( V_83 ) ;
return & V_342 -> V_58 [ V_38 ] -> V_42 [ 0 ] ;
}
static int F_197 ( struct V_311 * V_22 , int V_343 )
{
...
if ( F_64 ( V_323 ) )
goto V_344;
V_324 = F_188 ( V_83 , V_170 , V_22 -> V_52 ) ;
if ( ! V_324 )
goto V_344;
V_268 = F_189 ( V_83 , V_170 ) ;
F_13 ( L_28 , V_23 ,
V_22 -> V_2 -> V_290 , V_343 , F_190 ( & V_161 -> V_286 -> V_329 ) ,
V_268 ) ;
V_22 -> V_345 = F_165 ;
V_22 -> V_52 = V_324 ;
F_191 ( & V_161 -> V_286 -> V_329 ) ;
V_22 -> V_286 = V_161 -> V_286 ;
V_28 = F_196 ( V_83 , V_22 -> V_312 ) ;
if ( V_28 )
V_22 -> args . V_28 = V_28 ;
V_62 = F_198 ( V_323 , V_22 , V_161 -> V_286 -> V_331 ,
V_268 == 3 ? & V_346 :
& V_347 ,
V_343 , V_334 ) ;
F_35 ( V_324 ) ;
...
static int
F_199 ( struct V_2 * V_2 , struct V_84 * V_348 ,
int V_343 , struct V_158 * V_159 )
{
return F_200 ( V_2 , V_348 , V_343 , V_159 ,
F_197 ) ;
}
static struct V_349 *
F_201 ( struct V_2 * V_2 )
{
...
static void
F_202 ( struct V_214 * V_350 )
{
F_203 ( F_204 ( V_350 , struct V_351 ,
V_352 ) ) ;
}
static int F_205 ( struct V_15 * V_16 ,
...
if ( F_12 ( ! V_125 ) )
return - V_356 ;
* V_125 = F_207 ( V_355 -> V_357 ) ;
return F_208 ( V_16 , & V_355 -> V_358 ) ;
}
static void
F_209 ( struct V_15 * V_16 , const void * V_90 , V_326 V_33 )
{
F_78 ( F_210 ( V_16 , V_90 , V_33 ) < 0 ) ;
}
static void
F_211 ( struct V_15 * V_16 ,
const T_2 * V_17 ,
const struct V_359 * V_360 )
{
T_3 * V_18 ;
V_18 = F_206 ( V_16 , 8 + 8 ) ;
V_18 = F_212 ( V_18 , V_360 -> V_64 ) ;
V_18 = F_212 ( V_18 , V_360 -> V_65 ) ;
F_209 ( V_16 , V_17 -> V_22 , V_19 ) ;
V_18 = F_206 ( V_16 , 4 * 8 ) ;
V_18 = F_212 ( V_18 , V_360 -> V_361 ) ;
V_18 = F_212 ( V_18 , V_360 -> V_362 ) ;
V_18 = F_212 ( V_18 , V_360 -> V_363 ) ;
V_18 = F_212 ( V_18 , V_360 -> V_364 ) ;
F_209 ( V_16 , V_360 -> V_365 . V_22 , V_26 ) ;
}
static void
F_213 ( struct V_15 * V_16 ,
const T_2 * V_17 ,
const struct V_359 * V_360 )
{
F_211 ( V_16 , V_17 , V_360 ) ;
F_214 ( V_16 , V_360 ,
V_360 -> V_366 . V_22 ) ;
}
...
static struct V_214 *
F_217 ( struct V_212 * V_371 ,
struct V_372 * V_373 , T_1 V_3 )
{
struct V_351 * V_374 ;
V_374 = F_218 ( V_371 , V_373 , V_3 ) ;
if ( ! V_374 )
return NULL ;
return & V_374 -> V_352 ;
}
static void
F_219 ( struct V_15 * V_16 ,
const void * V_375 ,
...
T_3 * V_125 ;
F_13 ( L_29 , V_23 ) ;
F_220 ( & V_382 , & V_378 , NULL ) ;
F_205 ( & V_382 , args , V_355 ) ;
F_215 ( & V_382 , args , V_355 ) ;
V_125 = F_206 ( V_16 , 4 ) ;
* V_125 = F_207 ( V_378 . V_33 ) ;
F_221 ( V_16 , V_355 -> V_97 , 0 , V_378 . V_33 ) ;
F_13 ( L_30 , V_23 ) ;
}
static void
F_222 ( struct V_376 * args )
{
struct V_354 * V_355 ;
if ( ! args -> V_22 )
return;
...
args -> V_22 = NULL ;
F_223 ( & V_355 -> V_358 ) ;
F_216 ( V_355 -> V_360 , V_355 -> V_367 ) ;
F_224 ( V_355 -> V_97 [ 0 ] ) ;
F_8 ( V_355 ) ;
}
static int
F_225 ( struct V_353 * args )
{
struct V_354 * V_355 ;
struct V_4 * V_44 = F_9 ( args -> V_49 ) ;
V_355 = F_226 ( sizeof( * V_355 ) , V_149 ) ;
if ( ! V_355 )
goto V_383;
...
goto V_384;
F_3 ( & V_355 -> V_358 ) ;
V_355 -> V_357 = F_227 ( args -> V_49 ,
& args -> V_63 , & V_355 -> V_358 ,
V_385 ) ;
F_24 ( & args -> V_2 -> V_47 ) ;
V_355 -> V_367 = F_228 ( & V_44 -> V_9 ,
& V_355 -> V_360 [ 0 ] , F_229 ( V_355 -> V_360 ) ) ;
F_27 ( & args -> V_2 -> V_47 ) ;
...
static int
F_230 ( const struct V_387 * V_388 , char * V_90 , const V_326 V_381 )
{
const struct V_389 * sin = (struct V_389 * ) V_388 ;
return snprintf ( V_90 , V_381 , L_31 , & sin -> V_390 ) ;
}
static V_326
F_231 ( const struct V_387 * V_388 , char * V_90 ,
const int V_381 )
{
...
static void
F_235 ( struct V_15 * V_16 , struct V_397 * V_398 )
{
...
switch ( V_388 -> V_407 ) {
case V_408 :
if ( F_230 ( V_388 , V_402 , sizeof( V_402 ) ) == 0 )
return;
V_405 = F_236 ( ( (struct V_389 * ) V_388 ) -> V_409 ) ;
V_404 = L_36 ;
V_406 = 3 ;
break;
case V_410 :
...
return;
V_405 = F_236 ( ( (struct V_391 * ) V_388 ) -> V_411 ) ;
V_404 = L_37 ;
V_406 = 4 ;
break;
default:
...
V_33 = F_237 ( V_402 , V_400 , sizeof( V_402 ) ) ;
V_18 = F_206 ( V_16 , 4 + V_406 ) ;
F_238 ( V_18 , V_404 , V_406 ) ;
V_18 = F_206 ( V_16 , 4 + V_33 ) ;
F_238 ( V_18 , V_402 , V_33 ) ;
}
static void
F_239 ( struct V_15 * V_16 ,
T_7 V_412 )
{
struct V_413 V_414 ;
T_3 * V_18 ;
V_18 = F_206 ( V_16 , 12 ) ;
V_414 = F_240 ( V_412 ) ;
V_18 = F_212 ( V_18 , V_414 . V_415 ) ;
* V_18 ++ = F_207 ( V_414 . V_416 ) ;
}
static void
F_241 ( struct V_15 * V_16 ,
struct V_132 * V_417 )
{
T_3 * V_18 ;
V_18 = F_206 ( V_16 , 5 * 8 ) ;
V_18 = F_212 ( V_18 , V_417 -> V_135 ) ;
V_18 = F_212 ( V_18 , V_417 -> V_136 ) ;
V_18 = F_212 ( V_18 , V_417 -> V_141 ) ;
V_18 = F_212 ( V_18 , V_417 -> V_142 ) ;
V_18 = F_212 ( V_18 , V_417 -> V_143 ) ;
F_239 ( V_16 , V_417 -> V_144 ) ;
F_239 ( V_16 , V_417 -> V_145 ) ;
}
static void
...
T_3 * V_18 ;
V_398 = F_242 ( & V_161 -> V_418 , struct V_397 , V_419 ) ;
F_13 ( L_39 ,
V_23 , V_161 -> V_328 , V_398 -> V_420 ) ;
F_235 ( V_16 , V_398 ) ;
V_18 = F_206 ( V_16 , 4 + V_28 -> V_29 ) ;
F_238 ( V_18 , V_28 -> V_22 , V_28 -> V_29 ) ;
F_24 ( & V_43 -> V_50 ) ;
F_241 ( V_16 , & V_43 -> V_147 . V_134 ) ;
F_241 ( V_16 , & V_43 -> V_153 . V_134 ) ;
F_27 ( & V_43 -> V_50 ) ;
F_239 ( V_16 , F_79 ( F_4 () , V_43 -> V_124 ) ) ;
V_18 = F_206 ( V_16 , 4 ) ;
* V_18 = F_207 ( false ) ;
}
static void
F_243 ( struct V_15 * V_16 , const void * args ,
const struct V_376 * V_421 )
{
struct V_359 * V_360 = F_204 ( V_421 ,
struct V_359 , V_366 ) ;
T_3 * V_125 ;
V_125 = F_206 ( V_16 , 4 ) ;
F_214 ( V_16 , V_360 , V_421 -> V_22 ) ;
* V_125 = F_207 ( ( V_16 -> V_18 - V_125 - 1 ) * 4 ) ;
}
static void
F_244 ( struct V_376 * V_421 )
{
struct V_35 * V_43 = V_421 -> V_22 ;
F_37 ( V_43 ) ;
}
static int
F_228 ( struct V_1 * V_10 ,
struct V_359 * V_360 ,
int V_422 )
{
struct V_4 * V_44 = F_9 ( V_10 ) ;
...
static int
F_246 ( struct V_427 * args )
{
struct V_4 * V_44 ;
const int V_428 = V_429 ;
args -> V_360 = F_247 ( V_428 , sizeof( * args -> V_360 ) , V_154 ) ;
if ( ! args -> V_360 )
return - V_95 ;
F_24 ( & args -> V_2 -> V_47 ) ;
V_44 = F_9 ( F_123 ( args -> V_2 ) -> V_49 ) ;
args -> V_367 = F_228 ( & V_44 -> V_9 ,
& args -> V_360 [ 0 ] , V_428 ) ;
F_27 ( & args -> V_2 -> V_47 ) ;
if ( ! args -> V_367 ) {
F_8 ( args -> V_360 ) ;
