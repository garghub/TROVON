...
int T_3 F_26 ( struct V_1 * V_1 , struct V_32 * V_33 )
{
unsigned int V_19 , V_7 ;
int V_34 = F_27 ( - 1 , 0 , V_8 ,
F_28 () ) ;
if ( V_34 < 0 )
return V_34 ;
for ( V_7 = 0 ; V_7 < V_31 ; V_7 ++ )
...
F_33 ( V_1 -> V_39 , F_20 , V_1 ) ;
F_33 ( V_1 -> V_40 , F_20 , V_1 ) ;
V_1 -> V_34 = V_34 ;
return 0 ;
}
void F_34 ( struct V_1 * V_1 , struct V_32 * V_33 )
{
unsigned int V_19 , V_34 ;
V_34 = V_1 -> V_34 ;
F_33 ( V_1 -> V_39 , NULL , NULL ) ;
F_33 ( V_1 -> V_40 , NULL , NULL ) ;
for ( V_19 = V_34 ; V_19 < V_34 + V_8 ; V_19 ++ ) {
F_35 ( V_19 , V_37 ) ;
F_29 ( V_19 , NULL ) ;
F_30 ( V_19 , NULL ) ;
}
