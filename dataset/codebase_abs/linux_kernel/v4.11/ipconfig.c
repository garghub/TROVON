...
strcpy ( V_52 . V_56 . V_57 , V_35 -> V_2 -> V_6 ) ;
F_21 ( sin , V_58 , 0 ) ;
...
static void T_1
F_60 ( T_4 * V_116 , struct V_9 * V_10 )
{
T_4 V_117 = ( ( V_80 == V_68 )
? V_118 : V_119 ) ;
T_4 * V_120 = V_116 ;
int V_121 ;
F_12 ( L_18 , V_117 , V_10 -> V_2 -> V_6 ) ;
...
if ( V_77 ) {
* V_120 ++ = 12 ;
V_121 = strlen ( F_61 () -> V_78 ) ;
* V_120 ++ = V_121 ;
memcpy ( V_120 , F_61 () -> V_78 , V_121 ) ;
V_120 += V_121 ;
}
if ( * V_124 ) {
F_18 ( L_19 ,
...
static void T_1 F_62 ( T_4 * V_120 )
{
memcpy ( V_120 , V_122 , 4 ) ;
V_120 += 4 ;
* V_120 ++ = 1 ;
...
static void T_1 F_65 ( struct V_9 * V_10 , unsigned long V_127 )
{
struct V_1 * V_2 = V_10 -> V_2 ;
struct V_85 * V_86 ;
struct V_128 * V_129 ;
...
int V_132 = F_66 ( V_2 ) ;
int V_133 = V_2 -> V_134 ;
V_86 = F_67 ( sizeof( struct V_128 ) + V_132 + V_133 + 15 ,
V_23 ) ;
if ( ! V_86 )
return;
F_68 ( V_86 , V_132 ) ;
V_129 = (struct V_128 * ) F_69 ( V_86 , sizeof( struct V_128 ) ) ;
...
V_131 -> V_145 = F_72 ( ( unsigned char * ) V_131 , V_131 -> V_136 ) ;
...
#ifdef F_73
if ( V_22 & V_157 )
F_60 ( V_129 -> V_158 , V_10 ) ;
else
#endif
F_62 ( V_129 -> V_158 ) ;
V_86 -> V_2 = V_2 ;
V_86 -> V_141 = F_52 ( V_105 ) ;
if ( F_74 ( V_86 , V_2 , F_51 ( V_86 -> V_141 ) ,
...
goto V_96;
if ( F_72 ( ( char * ) V_131 , V_131 -> V_136 ) )
goto V_96;
...
V_129 -> V_26 != V_10 -> V_26 ) {
F_82 ( L_26 ,
V_10 -> V_2 -> V_6 , V_129 -> V_149 , V_129 -> V_26 ) ;
goto V_108;
}
if ( V_169 >= 4 &&
! memcmp ( V_129 -> V_158 , V_122 , 4 ) ) {
T_4 * V_175 = ( T_4 * ) V_129 + F_51 ( V_129 -> V_173 . V_137 ) ;
T_4 * V_162 ;
#ifdef F_73
if ( V_22 & V_157 ) {
V_27 V_176 = V_68 ;
...
V_58 = V_129 -> V_179 ;
V_80 = V_129 -> V_181 ;
V_110 = V_129 -> V_173 . V_180 ;
if ( V_67 == V_68 && V_129 -> V_184 )
V_67 = V_129 -> V_184 ;
if ( V_115 [ 0 ] == V_68 )
V_115 [ 0 ] = V_80 ;
V_107 = V_19 ;
...
F_40 ( L_32 ,
V_189
? ( ( V_22 & V_157 ) ? L_33 : L_34 ) : L_35 ,
( V_189 && V_190 ) ? L_36 : L_35 ,
V_190 ? L_37 : L_35 ) ;
V_186 = V_30 ;
V_10 = V_15 ;
V_185 = V_191 ;
...
F_18 ( L_42 ,
( ( V_107 & V_21 ) ? L_37
: ( V_22 & V_157 ) ? L_33 : L_34 ) ,
& V_110 , & V_58 ) ;
return 0 ;
}
static int F_88 ( struct V_196 * V_197 , void * V_198 )
{
int V_113 ;
if ( V_199 & V_200 )
F_89 ( V_197 , L_43 ,
( V_199 & V_21 ) ? L_37
: ( V_199 & V_157 ) ? L_33 : L_34 ) ;
else
F_90 ( V_197 , L_44 ) ;
if ( V_166 [ 0 ] )
F_89 ( V_197 ,
...
static int F_91 ( struct V_201 * V_202 , struct V_203 * V_203 )
{
return F_92 ( V_203 , F_88 , NULL ) ;
}
...
V_205 = V_206 = V_6 ;
while ( V_204 < 4 ) {
while ( * V_205 >= '0' && * V_205 <= '9' )
V_205 ++ ;
if ( V_205 == V_206 || V_205 - V_206 > 3 )
break;
if ( * V_205 == '.' || V_204 == 3 )
V_204 ++ ;
if ( V_204 < 4 )
...
if ( V_204 == 4 && ( * V_205 == ':' || * V_205 == '\0' ) ) {
if ( * V_205 == ':' )
* V_205 ++ = '\0' ;
V_37 = F_94 ( V_6 ) ;
memmove ( V_6 , V_205 , strlen ( V_205 ) + 1 ) ;
} else
V_37 = V_68 ;
return V_37 ;
}
...
unsigned int V_113 ;
#ifdef F_99
F_100 ( L_48 , V_210 , V_49 . V_211 , & V_212 ) ;
#endif
if ( ! V_213 )
return 0 ;
F_12 ( L_49 ) ;
...
return - 1 ;
#ifdef F_98
V_199 = V_107 | ( V_22 & V_157 ) ;
#endif
#ifndef F_102
F_18 ( L_53 ) ;
F_18 ( L_54 ,
V_35 -> V_2 -> V_6 , V_35 -> V_2 -> V_100 , V_35 -> V_2 -> V_109 ,
& V_58 , & V_60 , & V_67 ) ;
F_18 ( L_55 ,
F_61 () -> V_78 , V_166 , F_61 () -> V_168 ) ;
F_18 ( L_56 ,
& V_80 , & V_79 , V_167 ) ;
if ( V_63 )
F_87 ( L_57 , V_63 ) ;
...
{
if ( ! strcmp ( V_6 , L_60 ) || ! strcmp ( V_6 , L_61 ) ) {
return 1 ;
}
...
#ifdef F_104
else if ( ! strncmp ( V_6 , L_64 , 4 ) ) {
char * V_218 ;
V_22 &= ~ V_21 ;
V_218 = strstr ( V_6 , L_65 ) ;
if ( V_218 ) {
char * V_198 ;
V_218 = V_218 + 5 ;
V_198 = strchr ( V_218 , ',' ) ;
...
return 1 ;
* V_198 = 0 ;
if ( F_105 ( V_218 , 0 , V_125 ) )
F_12 ( L_66 ) ;
strncpy ( V_125 + 1 , V_198 + 1 , 251 ) ;
* V_198 = ',' ;
}
return 1 ;
}
...
V_220 = V_219 ;
while ( V_220 && * V_220 ) {
if ( ( V_205 = strchr ( V_220 , ':' ) ) )
* V_205 ++ = '\0' ;
if ( strlen ( V_220 ) > 0 ) {
F_12 ( L_70 , V_222 , V_220 ) ;
switch ( V_222 ) {
case 0 :
if ( ( V_58 = F_94 ( V_220 ) ) == V_224 )
V_58 = V_68 ;
break;
case 1 :
if ( ( V_80 = F_94 ( V_220 ) ) == V_224 )
V_80 = V_68 ;
break;
case 2 :
if ( ( V_67 = F_94 ( V_220 ) ) == V_224 )
V_67 = V_68 ;
break;
case 3 :
if ( ( V_60 = F_94 ( V_220 ) ) == V_224 )
V_60 = V_68 ;
break;
case 4 :
if ( ( V_221 = strchr ( V_220 , '.' ) ) ) {
* V_221 ++ = '\0' ;
F_109 ( F_61 () -> V_168 , V_221 ,
sizeof( F_61 () -> V_168 ) ) ;
}
F_109 ( F_61 () -> V_78 , V_220 ,
sizeof( F_61 () -> V_78 ) ) ;
V_77 = 1 ;
break;
case 5 :
