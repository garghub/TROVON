...
static void F_31 ( struct V_10 * V_11 , T_2 * V_69 , T_2 * V_82 , T_2 * V_83 )
{
T_6 V_84 ;
int V_85 , V_86 ;
T_2 V_87 ;
...
static inline void F_39 ( T_2 * V_9 , T_2 * V_69 , int V_99 )
{
V_9 [ 0 ] = V_69 [ 5 ] ;
V_9 [ 1 ] = V_69 [ 4 ] ;
V_9 [ 2 ] = 0 ;
...
return 0 ;
V_70 += V_105 ;
F_31 ( V_11 , V_69 , V_82 , V_83 ) ;
return F_42 ( V_4 -> V_54 . V_106 . V_107 , V_82 , V_83 , V_70 , V_18 ,
...
if ( F_48 ( V_11 , V_11 -> V_18 - V_100 ) )
return V_51 ;
memmove ( V_11 -> V_3 + V_105 , V_11 -> V_3 , V_7 ) ;
F_30 ( V_11 , V_105 ) ;
return V_39 ;
}
static void F_49 ( struct V_10 * V_11 , T_2 * V_69 , T_2 * V_114 , T_2 * V_83 )
{
T_6 V_84 ;
T_2 V_87 ;
struct V_8 * V_9 = (struct V_8 * ) V_11 -> V_3 ;
...
static inline void F_50 ( T_2 * V_9 , const T_2 * V_69 , int V_99 )
{
V_9 [ 0 ] = V_69 [ 5 ] ;
V_9 [ 1 ] = V_69 [ 4 ] ;
V_9 [ 2 ] = 0 ;
...
return 0 ;
V_70 += V_118 ;
F_49 ( V_11 , V_69 , V_114 , V_83 ) ;
return F_55 ( V_4 -> V_54 . V_119 . V_107 , V_114 , V_83 , V_70 , V_18 ,
F_10 ( V_11 , V_117 ) ) ;
}
T_1
F_56 ( struct V_1 * V_2 )
...
F_60 ( V_11 , V_120 , 0 , V_67 ) ) )
return V_21 ;
V_7 = F_4 ( V_9 -> V_19 ) ;
V_70 = F_20 ( V_11 , V_120 ) ;
memmove ( V_70 , V_70 + V_120 , V_7 ) ;
return V_20 ;
}
static inline int F_61 ( T_2 * V_121 , T_2 * V_122 , int V_18 )
{
int V_123 ;
...
if ( F_61 ( V_126 , V_111 , V_125 -> V_131 ) <= 0 )
return V_51 ;
memcpy ( V_111 , V_126 , V_125 -> V_131 ) ;
if ( F_48 ( V_36 -> V_11 , V_36 -> V_11 -> V_18 - V_125 -> V_100 ) )
return V_51 ;
memmove ( V_36 -> V_11 -> V_3 + V_125 -> V_128 , V_36 -> V_11 -> V_3 , V_7 ) ;
F_30 ( V_36 -> V_11 , V_125 -> V_128 ) ;
return V_39 ;
}
static void F_63 ( struct V_10 * V_11 , T_2 * V_83 )
{
T_6 V_84 ;
struct V_8 * V_9 = (struct V_8 * ) V_11 -> V_3 ;
V_84 = V_9 -> V_19 ;
V_84 &= ~ F_33 ( V_89 | V_90 |
V_91 ) ;
F_38 ( V_84 , ( T_6 * ) & V_83 [ 0 ] ) ;
memcpy ( V_83 + 2 , & V_9 -> V_64 , 3 * V_94 ) ;
}
static inline void F_64 ( T_2 * V_132 , T_5 V_69 )
{
* V_132 ++ = V_69 ;
* V_132 ++ = V_69 >> 8 ;
* V_132 ++ = V_69 >> 16 ;
...
static inline void F_65 ( T_2 * V_132 , const T_2 * V_133 )
{
* V_132 ++ = V_133 [ 5 ] ;
* V_132 ++ = V_133 [ 4 ] ;
* V_132 ++ = V_133 [ 3 ] ;
...
T_2 V_83 [ 20 ] ;
T_5 V_101 ;
if ( F_19 ( F_67 ( & V_2 -> V_136 ) != 1 ) )
return V_21 ;
V_11 = F_68 ( & V_2 -> V_136 ) ;
V_13 = F_2 ( V_11 ) ;
if ( V_13 -> V_24 . V_25 )
return V_20 ;
if ( F_19 ( F_8 ( V_11 ) < sizeof( * V_135 ) ) )
return V_21 ;
V_135 = (struct V_134 * ) F_10 ( V_11 , sizeof( * V_135 ) ) ;
V_135 -> V_137 = V_138 ;
V_135 -> V_139 = sizeof( * V_135 ) - 2 ;
V_135 -> V_99 = F_33 ( V_4 -> V_15 . V_50 ) ;
V_101 = F_21 ( & V_4 -> V_15 . V_73 ) ;
F_64 ( V_135 -> V_140 , V_101 ) ;
F_63 ( V_11 , V_83 ) ;
F_69 ( V_4 -> V_54 . V_141 . V_107 , V_83 ,
...
F_64 ( V_135 -> V_140 , V_101 ) ;
F_63 ( V_11 , V_83 ) ;
F_71 ( V_4 -> V_54 . V_141 . V_107 , V_83 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 , V_135 -> V_5 ) ;
return V_20 ;
}
T_4
...
if ( memcmp ( V_5 , V_135 -> V_5 , sizeof( V_135 -> V_5 ) ) != 0 ) {
V_4 -> V_54 . V_141 . V_144 ++ ;
return V_51 ;
}
}
memcpy ( V_4 -> V_54 . V_141 . V_111 , V_143 , 6 ) ;
F_15 ( V_11 , V_11 -> V_18 - sizeof( * V_135 ) ) ;
return V_39 ;
}
T_4
...
F_65 ( V_146 + V_94 , V_135 -> V_140 ) ;
if ( F_75 ( V_4 -> V_54 . V_148 . V_107 , V_83 , V_146 ,
...
V_5 ) < 0 ||
memcmp ( V_5 , V_135 -> V_5 , sizeof( V_135 -> V_5 ) ) != 0 ) {
