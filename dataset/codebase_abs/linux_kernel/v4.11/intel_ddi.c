...
bool F_152 ( struct V_15 * V_16 ,
struct V_82 * V_82 )
{
T_1 V_83 ;
if ( F_153 ( V_16 , V_307 ) ) {
V_83 = F_33 ( V_314 ) ;
if ( V_83 & F_154 ( V_82 -> V_116 ) )
return true ;
}
return false ;
}
...
V_163 -> V_306 =
F_152 ( V_16 , V_82 ) ;
if ( V_3 -> type == V_8 && V_16 -> V_18 . V_19 . V_322 &&
V_163 -> V_170 > V_16 -> V_18 . V_19 . V_322 ) {
F_52 ( L_18 ,
V_163 -> V_170 , V_16 -> V_18 . V_19 . V_322 ) ;
V_16 -> V_18 . V_19 . V_322 = V_163 -> V_170 ;
}
F_80 ( V_3 , V_163 ) ;
if ( F_17 ( V_16 ) )
V_163 -> V_309 =
...
V_163 -> V_212 = V_229 ;
if ( type == V_9 )
V_114 = F_159 ( V_3 , V_163 , V_298 ) ;
else
V_114 = F_160 ( V_3 , V_163 , V_298 ) ;
if ( F_17 ( V_16 ) && V_114 )
V_163 -> V_309 =
F_161 ( V_3 ,
V_163 -> V_113 ) ;
...
if ( ! V_122 )
return NULL ;
V_110 -> V_323 . V_324 = F_31 ( V_1 ) ;
if ( ! F_164 ( V_110 , V_122 ) ) {
F_165 ( V_122 ) ;
return NULL ;
}
return V_122 ;
...
if ( ! V_122 )
return NULL ;
V_110 -> V_325 . V_326 = F_31 ( V_1 ) ;
F_167 ( V_110 , V_122 ) ;
return V_122 ;
}
struct V_63 *
F_168 ( struct V_108 * V_108 , int clock )
{
struct V_246 * V_122 = V_108 -> V_327 ;
struct V_2 * V_3 = V_122 -> V_3 ;
struct V_15 * V_16 = F_23 ( V_3 -> V_5 . V_42 ) ;
struct V_109 * V_328 = F_115 ( V_108 ) ;
struct V_63 * V_64 = NULL ;
struct V_329 V_330 ;
enum V_190 V_331 ;
if ( F_17 ( V_16 ) ) {
V_331 = (enum V_190 ) V_328 -> V_1 ;
V_64 = & V_16 -> V_193 [ V_331 ] ;
if ( F_24 ( V_64 -> V_332 ) ) {
F_34 ( L_20 ,
V_64 -> V_332 ) ;
return NULL ;
...
V_64 = F_170 ( V_16 , clock ) ;
} else if ( F_20 ( V_16 ) || F_19 ( V_16 ) ) {
V_64 = F_171 ( V_3 , clock ) ;
}
return V_64 ;
}
void F_172 ( struct V_15 * V_16 , enum V_1 V_1 )
{
struct V_109 * V_110 ;
struct V_2 * V_2 ;
struct V_300 * V_3 ;
bool V_333 , V_334 , V_335 = false ;
int V_270 ;
if ( F_33 ( F_31 ( V_13 ) ) & V_336 ) {
switch ( V_1 ) {
case V_13 :
V_270 = 4 ;
break;
...
V_333 = ( V_16 -> V_18 . V_37 [ V_1 ] . V_337 ||
V_16 -> V_18 . V_37 [ V_1 ] . V_338 ) ;
V_334 = V_16 -> V_18 . V_37 [ V_1 ] . V_339 ;
if ( F_173 ( V_16 , V_1 ) ) {
V_334 = true ;
V_335 = true ;
V_333 = false ;
...
V_110 = F_174 ( sizeof( * V_110 ) , V_340 ) ;
if ( ! V_110 )
return;
V_2 = & V_110 -> V_5 ;
V_3 = & V_2 -> V_5 ;
F_175 ( & V_16 -> V_341 , V_3 , & V_342 ,
V_343 , L_24 , F_35 ( V_1 ) ) ;
V_2 -> V_344 = F_158 ;
V_2 -> V_278 = F_137 ;
if ( F_17 ( V_16 ) )
