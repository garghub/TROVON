...
char V_114 ;
if ( ! V_113 ||
( sscanf ( V_113 , L_26 , V_111 , & V_114 ) != 1 ) ||
( * V_111 < V_108 -> V_115 ) ||
( * V_111 > V_108 -> V_116 ) ||
...
unsigned V_128 = 0 , V_129 = 0 ;
struct V_21 * V_44 ;
struct V_38 * V_39 ;
struct V_35 * V_32 = F_76 ( V_7 ) ;
unsigned V_130 = F_77 ( V_7 -> V_30 ) ;
if ( V_7 -> type != V_34 ) {
if ( V_7 -> type == V_120 )
return 0 ;
F_39 ( V_7 -> type == V_121 ) ;
...
if ( F_80 ( V_32 ) ) {
int V_132 ;
struct V_6 * V_133 = F_81 ( V_7 -> V_30 , & V_132 ) ;
if ( V_133 ) {
V_7 -> type = V_133 -> type ;
V_7 -> V_134 = V_133 -> V_134 ;
}
F_82 ( V_7 -> V_30 , V_132 ) ;
return 0 ;
}
...
struct V_136 * F_85 ( struct V_6 * V_7 )
{
return V_7 -> V_103 ;
}
struct V_21 * F_86 ( struct V_6 * V_7 )
{
if ( V_7 -> V_28 > 1 ||
...
{
return F_69 ( F_84 ( V_7 ) ) ;
}
bool F_90 ( struct V_6 * V_7 )
{
return F_70 ( F_84 ( V_7 ) ) ;
}
...
for ( V_43 = 0 ; V_43 < V_7 -> V_28 ; V_43 ++ ) {
V_44 = V_7 -> V_26 + V_43 ;
V_137 = V_116 ( V_137 , V_44 -> V_137 ) ;
}
V_7 -> V_46 = F_93 ( V_30 , type , V_7 -> V_138 , V_137 ) ;
if ( ! V_7 -> V_46 )
return - V_23 ;
return 0 ;
}
...
struct V_139 * F_95 ( struct V_6 * V_7 )
{
return V_7 -> V_46 ;
}
...
V_141 = ( T_1 * ) F_7 ( V_140 , ( unsigned long ) V_142 ) ;
if ( ! V_141 )
return - V_23 ;
for ( V_43 = V_7 -> V_11 - 2 ; V_43 >= 0 ; V_43 -- ) {
V_7 -> V_9 [ V_43 ] = V_141 ;
V_141 += ( V_10 * V_7 -> V_12 [ V_43 ] ) ;
F_6 ( V_43 , V_7 ) ;
}
return 0 ;
}
...
int V_69 = 0 ;
unsigned int V_143 ;
V_143 = F_2 ( V_7 -> V_28 , V_10 ) ;
V_7 -> V_11 = 1 + F_1 ( V_143 , V_5 ) ;
V_7 -> V_12 [ V_7 -> V_11 - 1 ] = V_143 ;
V_7 -> V_9 [ V_7 -> V_11 - 1 ] = V_7 -> V_24 ;
if ( V_7 -> V_11 >= 2 )
V_69 = F_96 ( V_7 ) ;
return V_69 ;
}
static bool F_98 ( struct V_144 * V_145 )
{
return ! ! F_99 ( V_145 ) ;
}
static struct V_144 * F_100 ( struct V_6 * V_7 )
{
struct V_35 * V_32 = F_76 ( V_7 ) ;
struct V_38 * V_39 = NULL ;
struct V_144 * V_146 = NULL , * V_147 = NULL ;
F_26 (dd, devices, list) {
V_147 = V_39 -> V_41 -> V_48 -> V_148 ;
if ( ! F_98 ( V_147 ) )
goto V_149;
else if ( V_146 &&
F_101 ( V_146 , V_147 ) < 0 )
...
V_69 = F_92 ( V_7 , V_7 -> V_30 ) ;
if ( V_69 )
F_59 ( L_41 ) ;
return V_69 ;
}
void F_106 ( struct V_6 * V_7 ,
void (* F_107)( void * ) , void * V_151 )
{
F_108 ( & V_152 ) ;
V_7 -> V_153 = F_107 ;
V_7 -> V_154 = V_151 ;
...
struct V_21 * F_113 ( struct V_6 * V_7 , T_1 V_155 )
{
...
static int F_114 ( struct V_21 * V_50 , struct V_41 * V_47 ,
T_1 V_51 , T_1 V_52 , void * V_53 )
{
unsigned * V_156 = V_53 ;
( * V_156 ) ++ ;
...
bool F_115 ( struct V_6 * V_67 )
{
struct V_21 * V_73 ( V_50 ) ;
unsigned V_43 = 0 , V_156 = 0 ;
while ( V_43 < F_55 ( V_67 ) ) {
V_50 = F_56 ( V_67 , V_43 ++ ) ;
if ( ! V_50 -> type -> V_97 )
return false ;
V_50 -> type -> V_97 ( V_50 , F_114 , & V_156 ) ;
if ( V_156 )
return false ;
}
return true ;
}
int F_116 ( struct V_6 * V_67 ,
struct V_56 * V_57 )
{
struct V_21 * V_73 ( V_50 ) ;
struct V_56 V_96 ;
...
& V_96 ) ;
if ( V_50 -> type -> V_158 )
V_50 -> type -> V_158 ( V_50 , & V_96 ) ;
if ( V_50 -> type -> V_97 ( V_50 , F_27 ,
& V_96 ) )
return - V_98 ;
V_157:
if ( F_117 ( V_57 , & V_96 , 0 ) < 0 )
F_19 ( L_42
L_43
L_44 ,
F_20 ( V_67 -> V_30 ) ,
...
V_147 = F_100 ( V_7 ) ;
if ( V_147 &&
F_101 ( F_103 ( V_7 -> V_30 ) , V_147 ) >= 0 )
return;
}
if ( F_98 ( F_103 ( V_7 -> V_30 ) ) ) {
F_19 ( L_45 ,
F_20 ( V_7 -> V_30 ) ) ;
F_119 ( F_103 ( V_7 -> V_30 ) ) ;
}
}
static int F_120 ( struct V_21 * V_50 , struct V_41 * V_47 ,
T_1 V_51 , T_1 V_52 , void * V_53 )
{
unsigned long V_159 = ( unsigned long ) V_53 ;
struct V_54 * V_55 = F_29 ( V_47 -> V_48 ) ;
return V_55 && ( V_55 -> V_160 & V_159 ) ;
}
static bool F_121 ( struct V_6 * V_7 , unsigned long V_159 )
{
struct V_21 * V_50 ;
unsigned V_43 = 0 ;
while ( V_43 < F_55 ( V_7 ) ) {
...
return true ;
if ( V_50 -> type -> V_97 &&
V_50 -> type -> V_97 ( V_50 , F_120 , ( void * ) V_159 ) )
return true ;
}
return false ;
}
...
{
struct V_54 * V_55 = F_29 ( V_47 -> V_48 ) ;
return V_55 && ! F_126 ( V_55 ) ;
}
static int F_127 ( struct V_21 * V_50 , struct V_41 * V_47 ,
T_1 V_51 , T_1 V_52 , void * V_53 )
{
struct V_54 * V_55 = F_29 ( V_47 -> V_48 ) ;
return V_55 && ! F_128 ( V_164 , & V_55 -> V_160 ) ;
}
...
V_50 = F_56 ( V_7 , V_43 ++ ) ;
if ( ! V_50 -> type -> V_97 ||
! V_50 -> type -> V_97 ( V_50 , V_165 , NULL ) )
return false ;
}
return true ;
}
...
{
struct V_54 * V_55 = F_29 ( V_47 -> V_48 ) ;
return V_55 && ! V_55 -> V_57 . V_166 ;
}
static bool F_131 ( struct V_6 * V_7 )
{
struct V_21 * V_50 ;
unsigned V_43 = 0 ;
while ( V_43 < F_55 ( V_7 ) ) {
...
static int F_132 ( struct V_21 * V_50 , struct V_41 * V_47 ,
T_1 V_51 , T_1 V_52 , void * V_53 )
{
struct V_54 * V_55 = F_29 ( V_47 -> V_48 ) ;
return V_55 && F_133 ( V_55 ) ;
}
...
return true ;
if ( V_50 -> type -> V_97 &&
V_50 -> type -> V_97 ( V_50 , F_132 , NULL ) )
return true ;
}
return false ;
}
void F_135 ( struct V_6 * V_7 , struct V_54 * V_55 ,
struct V_56 * V_57 )
{
bool V_168 = false , V_169 = false ;
V_55 -> V_57 = * V_57 ;
if ( ! F_134 ( V_7 ) )
F_136 ( V_170 , V_55 ) ;
else
F_137 ( V_170 , V_55 ) ;
if ( F_121 ( V_7 , ( 1UL << V_171 ) ) ) {
V_168 = true ;
if ( F_121 ( V_7 , ( 1UL << V_172 ) ) )
V_169 = true ;
}
F_138 ( V_55 , V_168 , V_169 ) ;
if ( ! F_122 ( V_7 ) )
V_55 -> V_57 . V_173 = 0 ;
if ( F_129 ( V_7 , F_123 ) )
F_137 ( V_174 , V_55 ) ;
...
T_2 F_140 ( struct V_6 * V_7 )
{
return V_7 -> V_27 ;
}
static void F_141 ( struct V_6 * V_7 , enum V_177 V_27 )
{
int V_43 = V_7 -> V_28 ;
...
case V_178 :
if ( V_50 -> type -> V_179 )
V_50 -> type -> V_179 ( V_50 ) ;
break;
case V_180 :
if ( V_50 -> type -> V_181 )
V_50 -> type -> V_181 ( V_50 ) ;
break;
case V_182 :
if ( V_50 -> type -> V_183 )
V_50 -> type -> V_183 ( V_50 ) ;
break;
}
V_50 ++ ;
}
...
struct V_21 * V_50 = V_7 -> V_26 + V_43 ;
if ( V_50 -> type -> V_185 )
V_50 -> type -> V_185 ( V_50 ) ;
}
return 0 ;
}
void F_146 ( struct V_6 * V_7 , struct V_186 * V_187 )
{
F_42 ( & V_187 -> V_40 , & V_7 -> V_33 ) ;
}
int F_147 ( struct V_6 * V_7 , int V_188 )
{
struct V_38 * V_39 ;
struct V_35 * V_32 = F_76 ( V_7 ) ;
struct V_186 * V_187 ;
...
if ( V_187 -> V_190 )
V_69 |= V_187 -> V_190 ( V_187 , V_188 ) ;
return V_69 ;
}
struct V_29 * F_151 ( struct V_6 * V_7 )
{
return V_7 -> V_30 ;
}
void F_152 ( struct V_6 * V_7 )
{
struct V_29 * V_30 ;
struct V_54 * V_191 ;
unsigned long V_192 ;
...
F_155 ( V_191 -> V_193 , V_192 ) ;
F_156 ( V_191 ) ;
F_157 ( V_191 -> V_193 , V_192 ) ;
}
}
}
