...
if ( V_169 && V_169 -> V_21 & V_228 )
V_227 = V_169 ;
if ( V_229 < 0 || V_227 || ! V_169 )
V_229 = V_201 ;
if ( V_229 < 0 ) {
if ( V_226 -> V_200 < 0 )
V_226 -> V_200 = 0 ;
...
if ( ! ( V_226 -> V_21 & V_171 ) )
return;
if ( V_227 && ( ( V_226 -> V_21 & ( V_231 | V_228 ) ) == V_231 ) )
V_226 -> V_21 &= ~ V_233 ;
F_130 () ;
...
F_160 () ;
F_74 ( L_33 ,
( V_226 -> V_21 & V_228 ) ? L_34 : L_35 ,
V_226 -> V_195 , V_226 -> V_200 ) ;
if ( V_227 &&
( ( V_226 -> V_21 & ( V_231 | V_228 ) ) == V_231 ) &&
! V_225 ) {
F_101 (bcon)
if ( V_227 -> V_21 & V_228 )
F_161 ( V_227 ) ;
...
int V_85 ;
F_101 (con) {
if ( ! V_225 && V_168 -> V_21 & V_228 ) {
if ( F_164 ( V_168 , sizeof( * V_168 ) ) )
F_161 ( V_168 ) ;
}
}
V_85 = F_165 ( V_237 , L_37 , NULL ,
F_134 ) ;
F_166 ( V_85 < 0 ) ;
V_85 = F_165 ( V_238 , L_38 ,
F_134 , NULL ) ;
F_166 ( V_85 < 0 ) ;
return 0 ;
}
static void F_167 ( struct V_239 * V_239 )
{
int V_240 = F_168 ( V_241 , 0 ) ;
if ( V_240 & V_242 ) {
if ( F_112 () )
F_113 () ;
}
...
int F_178 ( const char * V_245 )
{
return F_39 ( & V_246 , V_245 ) ;
}
bool F_179 ( unsigned long * V_247 ,
unsigned int V_248 )
{
unsigned long V_249 = V_136 - * V_247 ;
if ( * V_247 && V_249 <= F_88 ( V_248 ) )
return false ;
* V_247 = V_136 ;
return true ;
}
int F_180 ( struct V_250 * V_251 )
{
unsigned long V_21 ;
int V_18 = - V_252 ;
if ( ! V_251 -> V_253 )
...
if ( ! V_251 -> V_255 ) {
V_251 -> V_255 = 1 ;
F_182 ( & V_251 -> V_256 , & V_257 ) ;
V_18 = 0 ;
}
F_183 ( & V_254 , V_21 ) ;
return V_18 ;
}
int F_184 ( struct V_250 * V_251 )
{
unsigned long V_21 ;
int V_18 = - V_2 ;
F_181 ( & V_254 , V_21 ) ;
...
return;
F_188 () ;
F_189 (dumper, &dump_list, list) {
if ( V_251 -> V_262 && V_259 > V_251 -> V_262 )
continue;
V_251 -> V_263 = true ;
F_80 ( V_21 ) ;
V_251 -> V_264 = V_37 ;
...
V_251 -> V_266 = V_33 ;
F_81 ( V_21 ) ;
V_251 -> V_253 ( V_251 , V_259 ) ;
V_251 -> V_263 = false ;
}
F_190 () ;
}
bool F_191 ( struct V_250 * V_251 , bool V_140 ,
...
if ( V_251 -> V_264 >= V_36 )
goto V_98;
V_27 = F_17 ( V_251 -> V_265 ) ;
V_267 = F_94 ( V_27 , V_140 , line , V_42 ) ;
V_251 -> V_265 = F_18 ( V_251 -> V_265 ) ;
V_251 -> V_264 ++ ;
V_85 = true ;
V_98:
if ( V_30 )
...
bool F_192 ( struct V_250 * V_251 , bool V_140 ,
char * line , T_3 V_42 , T_3 * V_30 )
{
unsigned long V_21 ;
bool V_85 ;
F_80 ( V_21 ) ;
V_85 = F_191 ( V_251 , V_140 , line , V_42 , V_30 ) ;
F_81 ( V_21 ) ;
return V_85 ;
}
bool F_193 ( struct V_250 * V_251 , bool V_140 ,
...
if ( V_251 -> V_264 >= V_251 -> V_151 ) {
F_81 ( V_21 ) ;
goto V_98;
}
V_70 = V_251 -> V_264 ;
V_29 = V_251 -> V_265 ;
while ( V_70 < V_251 -> V_151 ) {
struct V_26 * V_27 = F_17 ( V_29 ) ;
V_267 += F_94 ( V_27 , true , NULL , 0 ) ;
V_29 = F_18 ( V_29 ) ;
V_70 ++ ;
}
V_70 = V_251 -> V_264 ;
V_29 = V_251 -> V_265 ;
while ( V_267 > V_42 && V_70 < V_251 -> V_151 ) {
struct V_26 * V_27 = F_17 ( V_29 ) ;
V_267 -= F_94 ( V_27 , true , NULL , 0 ) ;
V_29 = F_18 ( V_29 ) ;
V_70 ++ ;
...
while ( V_70 < V_251 -> V_151 ) {
struct V_26 * V_27 = F_17 ( V_29 ) ;
V_267 += F_94 ( V_27 , V_140 , V_69 + V_267 , V_42 - V_267 ) ;
V_29 = F_18 ( V_29 ) ;
V_70 ++ ;
}
V_251 -> V_151 = V_151 ;
...
void T_1 F_196 ( const char * V_182 , ... )
{
T_11 args ;
va_start ( args , V_182 ) ;
vsnprintf ( V_268 , sizeof( V_268 ) ,
V_182 , args ) ;
va_end ( args ) ;
}
void F_197 ( const char * V_269 )
{
F_119 ( L_39 ,
V_269 , F_142 () , V_63 -> V_270 , V_63 -> V_64 ,
F_198 () , F_199 () -> V_271 ,
( int ) strcspn ( F_199 () -> V_272 , L_40 ) ,
F_199 () -> V_272 ) ;
if ( V_268 [ 0 ] != '\0' )
F_119 ( L_41 ,
V_269 , V_268 ) ;
...
void F_201 ( const char * V_269 )
{
F_197 ( V_269 ) ;
F_119 ( L_42 ,
V_269 , V_63 , F_202 ( V_63 ) ) ;
}
