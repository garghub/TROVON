...
int V_97 ;
V_20 -> V_98 = F_82 ( & V_30 -> V_20 ) ;
V_96 = F_83 ( V_30 -> V_20 . V_99 -> V_100 , & V_30 -> V_20 ) ;
if ( V_96 )
V_93 = ( const struct V_92 * ) V_96 -> V_101 ;
V_97 = F_84 ( F_85 ( & V_30 -> V_20 ) ,
V_93 ) ;
if ( V_97 )
return V_97 ;
V_20 -> V_23 = F_86 ( & V_30 -> V_20 , NULL ) ;
V_20 -> V_26 = F_87 ( & V_30 -> V_20 ,
L_21 ,
V_102 ) ;
if ( F_4 ( V_20 -> V_26 ) )
return F_5 ( V_20 -> V_26 ) ;
V_20 -> V_25 = F_87 ( & V_30 -> V_20 , L_22 ,
V_102 ) ;
if ( F_4 ( V_20 -> V_25 ) )
return F_5 ( V_20 -> V_25 ) ;
V_20 -> V_27 = F_88 ( V_30 , 0 ) ;
if ( V_20 -> V_27 <= 0 ) {
struct V_103 * V_75 ;
V_75 = F_87 ( & V_30 -> V_20 , L_23 ,
V_104 ) ;
if ( F_4 ( V_75 ) )
return F_5 ( V_75 ) ;
V_20 -> V_27 = F_89 ( V_75 ) ;
}
F_90 ( & V_30 -> V_20 , L_24 , V_20 -> V_27 ) ;
if ( ( ! V_20 -> V_26 && ! V_20 -> V_25 ) || ! V_20 -> V_98 ) {
F_91 ( & V_30 -> V_20 , L_25 ) ;
return - V_105 ;
}
V_97 = F_92 ( F_85 ( & V_20 -> V_30 -> V_20 ) ,
& V_89 , F_79 , V_20 ) ;
if ( V_97 < 0 )
return V_97 ;
F_93 ( & V_89 ) ;
...
static int F_96 ( struct V_88 * V_30 )
{
struct V_16 * V_20 ;
int V_97 ;
V_20 = F_97 ( & V_30 -> V_20 , sizeof( * V_20 ) , V_49 ) ;
if ( ! V_20 )
return - V_50 ;
V_20 -> V_30 = V_30 ;
V_97 = F_80 ( V_20 ) ;
...
return V_97 ;
F_98 ( V_30 , V_20 ) ;
F_90 ( & V_30 -> V_20 , L_27 , V_20 -> V_98 ) ;
F_22 ( & V_34 ) ;
F_99 ( & V_20 -> V_21 , & V_109 ) ;
F_29 ( & V_34 ) ;
F_13 ( V_20 , false ) ;
return 0 ;
}
static int F_100 ( struct V_88 * V_30 )
{
struct V_16 * V_20 = F_68 ( V_30 ) ;
F_22 ( & V_34 ) ;
F_101 ( & V_20 -> V_21 ) ;
F_29 ( & V_34 ) ;
F_102 ( F_85 ( & V_30 -> V_20 ) ) ;
F_90 ( & V_30 -> V_20 , L_28 , V_20 -> V_98 ) ;
return 0 ;
}
int T_2 F_103 ( void )
{
