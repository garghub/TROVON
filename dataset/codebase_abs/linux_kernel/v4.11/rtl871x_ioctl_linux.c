...
V_55 = (struct V_54 * ) ( V_57 + 2 ) ;
memcpy ( & V_62 , V_55 -> V_77 , 2 ) ;
V_350 = ( F_81 ( V_55 -> V_352 ) &
V_353 ) ? 1 : 0 ;
V_351 = ( F_81 ( V_55 -> V_352 ) &
( V_354 |
V_355 ) ) ? 1 : 0 ;
}
...
static int F_91 ( struct V_131 * V_132 ,
struct V_46 * V_47 ,
union V_3 * V_4 , char * V_204 )
{
...
T_3 V_404 ;
T_3 V_405 ;
F_95 ( V_404 , ( T_3 V_406 * ) V_4 -> V_69 . V_282 ) ;
V_405 = F_96 ( V_2 , V_404 ) ;
F_97 ( V_405 , ( T_3 V_406 * ) V_4 -> V_69 . V_282 ) ;
...
static int F_113 ( struct V_131 * V_132 , T_5 V_80 , T_3 V_108 )
{
struct V_1 * V_2 = F_27 ( V_132 ) ;
switch ( V_80 ) {
case V_446 :
...
static int F_114 ( struct V_131 * V_132 , T_3 V_453 , T_3 V_454 )
{
struct V_1 * V_2 = F_27 ( V_132 ) ;
switch ( V_453 ) {
case V_455 :
