...
static void F_64 ( T_3 V_96 , T_3 * V_197 , T_3 * V_198 )
{
V_96 /= V_99 ;
if ( V_96 ) {
* V_197 = V_199 + ( V_96 - 1 ) * V_193 ;
* V_198 = * V_197 + V_193 ;
} else {
* V_197 = 0 ;
* V_198 = V_199 ;
...
if ( ( V_179 . V_93 & V_203 ) == V_204 ) {
F_54 ( V_3 , V_96 ) ;
continue;
}
if ( V_179 . V_95 != V_83 ) {
if ( ( V_179 . V_95 < V_197 ) || ( V_198 <= V_179 . V_95 ) ) {
F_54 ( V_3 , V_96 ) ;
continue;
}
V_201 = F_58 ( V_37 , V_179 . V_95 ) ;
if ( V_201 != V_83 ) {
if ( V_179 . V_95 == 0 ) {
F_24 ( V_3 , V_179 . V_95 , V_96 ) ;
if ( F_49 ( V_3 , V_200 ) ) {
F_24 ( V_3 , V_179 . V_95 , V_201 ) ;
continue;
}
}
F_55 ( V_3 , V_201 , 0 , & V_179 ) ;
if ( ( V_179 . V_91 & V_205 ) == V_206 ) {
F_54 ( V_3 , V_96 ) ;
continue;
} else {
F_54 ( V_3 , V_201 ) ;
...
V_8 -> V_69 [ 0 ] = 0xF1 ;
V_8 -> V_69 [ 1 ] = 0x02 ;
V_8 -> V_69 [ 5 ] = ( unsigned char ) ( V_208 ) ;
V_8 -> V_69 [ 4 ] = ( unsigned char ) ( V_208 >> 8 ) ;
V_8 -> V_69 [ 3 ] = ( unsigned char ) ( V_208 >> 16 ) ;
V_8 -> V_69 [ 2 ] = ( unsigned char ) ( V_208 >> 24 ) ;
...
V_213 = F_73 ( & V_216 , V_214 , & V_3 -> V_228 -> V_229 ) ;
if ( V_213 ) {
F_4 ( V_3 , L_22 , V_214 ) ;
goto V_227;
}
V_5 = F_74 ( V_216 -> V_230 , V_216 -> V_231 , V_82 ) ;
if ( V_5 == NULL )
goto V_227;
memset ( V_8 , 0 , sizeof( struct V_7 ) ) ;
V_8 -> V_65 = F_21 ( V_66 ) ;
V_8 -> V_17 = V_216 -> V_231 ;
V_8 -> V_67 = 0x00 ;
V_8 -> V_69 [ 0 ] = 0xEF ;
V_12 = F_2 ( V_3 , V_70 , V_5 , 0 ) ;
V_37 -> V_217 = V_212 ;
...
switch ( F_35 ( V_3 , V_232 , 0 , ( T_2 * ) V_233 , & V_179 ) ) {
case V_161 :
break;
case V_186 :
break;
...
if ( ( V_179 . V_91 & V_183 ) == V_239 )
continue;
if ( ( ( V_179 . V_93 & V_240 ) == V_241 ) ||
...
if ( V_179 . V_89 & ( V_249 | V_250 | V_251 ) )
V_236 = 1 ;
}
if ( V_200 == V_83 ) {
V_12 = V_164 ;
...
V_12 = V_164 ;
if ( V_236 == 0 )
V_12 = F_37 ( V_3 , V_200 , V_234 ) ;
if ( V_12 && ( V_235 != V_83 ) )
V_12 = F_37 ( V_3 , V_235 , V_233 ) ;
if ( V_12 ) {
V_12 = V_164 ;
goto exit;
}
for ( V_232 = 0 ; V_232 < V_200 ; V_232 ++ )
V_37 -> V_73 . V_76 [ V_232 ] = V_79 ;
V_37 -> V_73 . V_76 [ V_200 ] = V_80 ;
if ( V_235 != V_83 ) {
for ( V_232 = V_200 + 1 ; V_232 < V_235 ; V_232 ++ )
V_37 -> V_73 . V_76 [ V_232 ] = V_79 ;
V_37 -> V_73 . V_76 [ V_235 ] = V_80 ;
}
V_12 = F_66 ( V_3 , V_200 ) ;
if ( V_12 )
goto exit;
for ( V_232 = V_99 ;
V_232 < V_37 -> V_73 . V_75 ;
V_232 += V_99 ) {
if ( F_34 ( V_3 , V_232 ) == 0 ) {
F_39 ( V_37 , V_254 ) ;
break;
...
V_37 -> V_194 = * (struct V_258 * ) & V_5 [ 0 ] ;
if ( V_37 -> V_194 . V_39 && V_37 -> V_194 . V_40 ) {
F_77 ( V_237 L_28 , V_37 -> V_194 . V_39 ) ;
F_77 ( V_237 L_29 , V_37 -> V_194 . V_40 ) ;
F_77 ( V_237 L_30 , V_37 -> V_194 . V_195 ) ;
F_77 ( V_237 L_31 , V_37 -> V_194 . V_259 ) ;
F_77 ( V_237 L_32 , V_37 -> V_194 . V_44 ) ;
if ( V_37 -> V_194 . V_195 ) {
V_255 = ( V_5 [ 6 ] << 8 ) | V_5 [ 7 ] ;
V_256 = ( V_5 [ 10 ] << 8 ) | V_5 [ 11 ] ;
V_37 -> V_196 = V_255 * V_256 ;
} else {
F_76 ( V_3 ) ;
}
F_4 ( V_3 , L_33 ) ;
...
V_37 -> V_38 = * (struct V_260 * ) & V_5 [ 0 ] ;
if ( V_37 -> V_38 . V_39 && V_37 -> V_38 . V_40 ) {
struct V_260 * V_261 = & V_37 -> V_38 ;
F_72 ( V_3 , ( unsigned char * ) & V_5 ) ;
F_4 ( V_3 , L_28 , V_261 -> V_39 ) ;
F_4 ( V_3 , L_29 , V_261 -> V_40 ) ;
F_4 ( V_3 , L_39 , V_261 -> V_51 ) ;
F_4 ( V_3 , L_40 , V_261 -> V_50 ) ;
F_4 ( V_3 , L_41 , V_261 -> V_262 ) ;
F_4 ( V_3 , L_42 , V_261 -> V_44 ) ;
} else {
F_4 ( V_3 , L_43 , V_5 [ 0 ] ) ;
return V_21 ;
}
...
struct V_36 * V_37 = (struct V_36 * ) ( V_3 -> V_1 ) ;
F_9 ( V_25 , 0 ) ;
if ( F_82 ( ! ( V_37 -> V_38 . V_40 || V_37 -> V_194 . V_40 ) ) ) {
V_12 = F_78 ( V_3 ) ;
} else {
if ( V_37 -> V_38 . V_40 )
V_12 = F_79 ( V_3 , V_25 ) ;
...
F_91 ( & V_3 -> V_289 ) ;
V_37 -> V_292 = true ;
V_37 -> V_38 = * (struct V_260 * ) & V_288 ;
V_37 -> V_194 = * (struct V_258 * ) & V_288 ;
