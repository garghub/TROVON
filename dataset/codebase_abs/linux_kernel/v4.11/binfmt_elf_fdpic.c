...
struct V_280 V_281 ;
F_83 ( V_114 , & V_281 ) ;
V_264 -> V_282 = F_84 ( V_281 . V_283 ) ;
V_264 -> V_284 = F_84 ( V_281 . V_285 ) ;
} else {
T_9 V_283 , V_285 ;
V_280 ( V_114 , & V_283 , & V_285 ) ;
V_264 -> V_282 = F_84 ( V_283 ) ;
V_264 -> V_284 = F_84 ( V_285 ) ;
}
V_264 -> V_286 = F_84 ( V_114 -> signal -> V_287 ) ;
V_264 -> V_288 = F_84 ( V_114 -> signal -> V_289 ) ;
