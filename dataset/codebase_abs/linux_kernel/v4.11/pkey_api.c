...
static int F_7 ( T_3 * V_3 , int V_4 )
{
...
static long F_45 ( struct V_151 * V_152 , unsigned int V_153 ,
unsigned long V_154 )
{
int V_41 ;
switch ( V_153 ) {
case V_155 : {
struct V_156 T_9 * V_157 = ( void T_9 * ) V_154 ;
struct V_156 V_158 ;
if ( F_46 ( & V_158 , V_157 , sizeof( V_158 ) ) )
return - V_159 ;
V_41 = F_19 ( V_158 . V_31 , V_158 . V_44 ,
V_158 . V_45 , & V_158 . V_47 ) ;
F_44 ( L_34 , V_41 ) ;
if ( V_41 )
break;
if ( F_47 ( V_157 , & V_158 , sizeof( V_158 ) ) )
return - V_159 ;
break;
}
case V_160 : {
struct V_161 T_9 * V_162 = ( void T_9 * ) V_154 ;
struct V_161 V_163 ;
if ( F_46 ( & V_163 , V_162 , sizeof( V_163 ) ) )
return - V_159 ;
V_41 = F_20 ( V_163 . V_31 , V_163 . V_44 , V_163 . V_45 ,
& V_163 . V_83 , & V_163 . V_47 ) ;
F_44 ( L_35 , V_41 ) ;
if ( V_41 )
break;
if ( F_47 ( V_162 , & V_163 , sizeof( V_163 ) ) )
return - V_159 ;
F_12 ( & V_163 , sizeof( V_163 ) ) ;
break;
}
case V_164 : {
struct V_165 T_9 * V_166 = ( void T_9 * ) V_154 ;
struct V_165 V_167 ;
if ( F_46 ( & V_167 , V_166 , sizeof( V_167 ) ) )
return - V_159 ;
V_41 = F_21 ( V_167 . V_31 , V_167 . V_44 ,
& V_167 . V_47 , & V_167 . V_89 ) ;
F_44 ( L_36 , V_41 ) ;
if ( V_41 )
break;
if ( F_47 ( V_166 , & V_167 , sizeof( V_167 ) ) )
return - V_159 ;
break;
}
case V_168 : {
struct V_169 T_9 * V_170 = ( void T_9 * ) V_154 ;
struct V_169 V_171 ;
if ( F_46 ( & V_171 , V_170 , sizeof( V_171 ) ) )
return - V_159 ;
V_41 = F_23 ( V_171 . V_45 ,
& V_171 . V_83 , & V_171 . V_89 ) ;
F_44 ( L_37 , V_41 ) ;
if ( V_41 )
break;
if ( F_47 ( V_170 , & V_171 , sizeof( V_171 ) ) )
return - V_159 ;
F_12 ( & V_171 , sizeof( V_171 ) ) ;
break;
}
case V_172 : {
struct F_39 T_9 * V_173 = ( void T_9 * ) V_154 ;
struct F_39 V_174 ;
if ( F_46 ( & V_174 , V_173 , sizeof( V_174 ) ) )
return - V_159 ;
V_41 = F_39 ( & V_174 . V_47 ,
& V_174 . V_31 , & V_174 . V_44 , 1 ) ;
F_44 ( L_38 , V_41 ) ;
if ( V_41 )
break;
if ( F_47 ( V_173 , & V_174 , sizeof( V_174 ) ) )
return - V_159 ;
break;
}
case V_175 : {
struct F_43 T_9 * V_166 = ( void T_9 * ) V_154 ;
struct F_43 V_167 ;
if ( F_46 ( & V_167 , V_166 , sizeof( V_167 ) ) )
return - V_159 ;
V_41 = F_43 ( & V_167 . V_47 , & V_167 . V_89 ) ;
F_44 ( L_39 , V_41 ) ;
if ( V_41 )
break;
if ( F_47 ( V_166 , & V_167 , sizeof( V_167 ) ) )
