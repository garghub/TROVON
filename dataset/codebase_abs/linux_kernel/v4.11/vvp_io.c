...
const struct V_4 * V_62 )
{
bool V_161 = V_62 -> V_77 -> V_80 ;
struct V_10 * V_10 = F_10 ( V_62 -> V_71 ) ;
F_36 ( V_3 , V_62 ) ;
if ( V_161 && ! V_62 -> V_77 -> V_80 ) {
F_77 ( V_162 , & ( F_6 ( V_10 ) ) -> V_85 ) ;
}
}
...
struct V_10 * V_10 = F_10 ( V_23 ) ;
struct V_11 * V_12 = F_6 ( V_10 ) ;
struct V_163 * V_163 = V_6 -> V_50 -> V_72 ;
int V_31 ;
T_1 V_29 = V_9 -> V_63 . V_132 . V_131 . V_133 ;
long V_164 = V_9 -> V_63 . V_132 . V_131 . V_126 ;
long V_165 = V_6 -> V_124 ;
int V_26 = 0 ;
F_26 ( V_3 , V_23 , F_27 ( V_23 ) ) ;
F_22 ( V_37 , L_7 , V_29 , V_29 + V_164 ) ;
F_47 ( & V_12 -> V_160 ) ;
if ( ! F_5 ( V_3 , V_9 , V_10 ) )
return 0 ;
V_31 = F_16 ( V_3 , V_23 , V_9 , V_29 , V_165 , & V_26 ) ;
if ( V_31 != 0 )
return V_31 ;
else if ( V_26 != 0 )
goto V_166;
F_79 ( V_167 , V_3 , & V_23 -> V_39 ,
L_8 ,
V_10 -> V_168 , V_164 , V_29 , F_20 ( V_10 ) ) ;
V_6 -> V_50 -> V_72 -> V_169 . V_170 = 0 ;
if ( ! V_6 -> V_171 ) {
V_6 -> V_171 = true ;
V_6 -> V_172 = F_30 ( V_23 , V_29 ) ;
V_6 -> V_173 = F_30 ( V_23 , V_165 + V_69 - 1 ) ;
F_80 ( V_163 ) ;
}
F_81 ( V_163 ) ;
F_3 ( V_6 -> V_174 -> V_175 == V_29 ) ;
V_31 = F_82 ( V_6 -> V_174 , V_6 -> V_111 ) ;
V_166:
if ( V_31 >= 0 ) {
if ( V_31 < V_164 )
V_9 -> V_20 = 0 ;
V_9 -> V_176 += V_31 ;
F_83 ( F_84 ( V_10 ) , V_102 -> V_177 ,
V_6 -> V_50 , V_29 , V_31 , V_178 ) ;
V_31 = 0 ;
}
return V_31 ;
}
static int F_85 ( const struct V_2 * V_3 , struct V_8 * V_9 ,
struct V_179 * V_180 , int V_181 , int V_182 )
{
struct V_183 * V_184 = & V_9 -> V_185 ;
struct V_86 * V_87 ;
unsigned int V_186 = 0 ;
int V_13 = 0 ;
if ( V_180 -> V_70 == 0 )
return 0 ;
if ( V_181 > 0 || V_182 != V_69 ) {
V_87 = F_86 ( V_180 ) ;
if ( V_180 -> V_70 == 1 ) {
F_87 ( V_3 , V_87 , V_181 , V_182 ) ;
} else {
if ( V_181 > 0 )
F_87 ( V_3 , V_87 , V_181 , V_69 ) ;
if ( V_182 != V_69 ) {
V_87 = F_88 ( V_180 ) ;
F_87 ( V_3 , V_87 , 0 , V_182 ) ;
}
}
}
F_89 ( V_184 ) ;
F_90 ( V_180 , & V_184 -> V_187 ) ;
V_13 = F_91 ( V_3 , V_9 , V_188 , V_184 , 0 ) ;
F_90 ( & V_184 -> V_187 , V_180 ) ;
F_90 ( & V_184 -> V_189 , V_180 ) ;
F_92 ( V_3 , V_184 ) ;
if ( V_13 == 0 ) {
V_186 = V_180 -> V_70 << V_35 ;
V_186 -= V_181 + V_69 - V_182 ;
while ( V_180 -> V_70 > 0 ) {
V_87 = F_86 ( V_180 ) ;
F_93 ( V_3 , V_180 , V_87 ) ;
F_87 ( V_3 , V_87 , 0 , V_69 ) ;
F_94 ( F_95 ( V_87 ) ) ;
F_96 ( V_3 , V_9 , V_87 ) ;
...
return V_186 > 0 ? V_186 : V_13 ;
}
static void F_97 ( const struct V_2 * V_3 , struct V_8 * V_9 ,
struct V_86 * V_87 )
{
struct V_87 * V_190 = V_87 -> V_191 ;
F_94 ( V_190 ) ;
F_98 ( V_190 ) ;
F_96 ( V_3 , V_9 , V_87 ) ;
F_41 ( & V_87 -> V_90 , L_9 , F_99 ( V_9 ) ) ;
F_42 ( V_3 , V_87 ) ;
}
...
T_4 V_192 = V_193 ;
F_101 (page, plist) {
struct V_194 * V_195 = F_102 ( V_23 , V_87 ) ;
if ( V_192 == V_193 ) {
V_192 = F_103 ( V_195 ) ;
continue;
}
++ V_192 ;
if ( V_192 == F_103 ( V_195 ) )
continue;
return false ;
}
return true ;
...
struct V_10 * V_10 = F_10 ( V_23 ) ;
struct V_1 * V_6 = F_4 ( V_3 ) ;
struct V_179 * V_184 = & V_6 -> V_63 . V_64 . V_65 ;
struct V_86 * V_87 ;
int V_13 = 0 ;
int V_186 = 0 ;
unsigned int V_196 = V_6 -> V_63 . V_64 . V_65 . V_70 ;
if ( V_196 == 0 )
return 0 ;
F_22 ( V_37 , L_10 ,
V_196 , V_6 -> V_63 . V_64 . V_67 , V_6 -> V_63 . V_64 . V_68 ) ;
F_3 ( F_100 ( V_23 , V_184 ) ) ;
V_13 = F_105 ( V_3 , V_9 , V_184 ,
V_6 -> V_63 . V_64 . V_67 , V_6 -> V_63 . V_64 . V_68 ,
F_97 ) ;
V_196 -= V_184 -> V_70 ;
if ( V_196 > 0 ) {
V_186 = V_196 << V_35 ;
V_186 -= V_6 -> V_63 . V_64 . V_67 ;
if ( V_184 -> V_70 == 0 )
V_186 -= V_69 - V_6 -> V_63 . V_64 . V_68 ;
F_106 ( V_186 > 0 , L_11 , V_186 , V_196 ) ;
V_6 -> V_63 . V_64 . V_66 += V_186 ;
F_22 ( V_37 , L_12 ,
V_196 , V_186 , V_6 -> V_63 . V_64 . V_66 ) ;
V_6 -> V_63 . V_64 . V_67 = 0 ;
}
F_3 ( F_100 ( V_23 , V_184 ) ) ;
F_3 ( F_107 ( V_13 == 0 , V_184 -> V_70 == 0 ) ) ;
if ( V_13 == - V_197 && ! F_108 ( V_9 ) ) {
V_13 = F_85 ( V_3 , V_9 , V_184 ,
V_6 -> V_63 . V_64 . V_67 ,
V_6 -> V_63 . V_64 . V_68 ) ;
if ( V_13 > 0 ) {
...
T_2 V_164 = V_9 -> V_63 . V_136 . V_138 . V_126 ;
F_47 ( & V_12 -> V_160 ) ;
if ( ! F_5 ( V_3 , V_9 , V_10 ) )
return 0 ;
if ( F_114 ( V_9 ) ) {
...
V_6 -> V_174 -> V_175 = V_29 ;
} else {
F_3 ( V_6 -> V_174 -> V_175 == V_29 ) ;
}
F_22 ( V_37 , L_13 , V_29 , V_29 + ( long long ) V_164 ) ;
if ( V_29 + V_164 > F_115 ( V_10 ) ) {
F_22 ( V_167 ,
L_14 V_38 L_15 ,
F_116 ( V_10 -> V_198 , NULL , 0 ) ,
F_23 ( F_117 ( V_10 ) ) , V_29 + V_164 ,
F_115 ( V_10 ) ) ;
return - V_199 ;
}
if ( ! V_6 -> V_111 ) {
...
bool V_200 = ! F_118 ( V_10 ) ;
if ( V_200 )
F_71 ( V_10 ) ;
V_31 = F_119 ( V_6 -> V_174 ,
V_6 -> V_111 ) ;
if ( V_200 )
F_74 ( V_10 ) ;
if ( V_31 > 0 || V_31 == - V_201 )
V_31 = F_120 ( V_6 -> V_174 , V_31 ) ;
}
if ( V_31 > 0 ) {
V_31 = F_104 ( V_3 , V_9 ) ;
...
static int F_122 ( struct V_203 * V_204 )
{
struct V_205 * V_206 = V_204 -> V_207 ;
V_204 -> V_208 = F_123 ( V_206 ) ;
V_204 -> V_209 = 1 ;
if ( V_206 -> V_87 ) {
F_22 ( V_210 ,
L_17 ,
V_206 -> V_87 , V_206 -> V_87 -> V_211 , V_206 -> V_87 -> V_192 ,
( long ) V_206 -> V_87 -> V_117 , F_124 ( V_206 -> V_87 ) ,
F_125 ( V_206 -> V_87 ) , ( void * ) V_206 -> V_212 ) ;
if ( F_126 ( ! ( V_204 -> V_208 & V_213 ) ) ) {
F_127 ( V_206 -> V_87 ) ;
V_204 -> V_208 |= V_213 ;
}
V_204 -> V_214 = V_206 -> V_87 ;
return 0 ;
}
if ( V_204 -> V_208 & ( V_215 | V_216 ) ) {
F_22 ( V_210 , L_18 , ( void * ) V_206 -> V_212 ) ;
return - V_217 ;
}
if ( V_204 -> V_208 & V_218 ) {
F_22 ( V_210 , L_19 , ( void * ) V_206 -> V_212 ) ;
return - V_219 ;
}
if ( V_204 -> V_208 & V_220 )
return - V_221 ;
F_128 ( L_20 , V_204 -> V_208 ) ;
return - V_119 ;
}
...
struct V_10 * V_10 = F_10 ( V_23 ) ;
struct V_11 * V_12 = F_6 ( V_10 ) ;
struct V_222 * V_223 = & V_9 -> V_63 . V_88 ;
struct V_203 * V_204 = & V_6 -> V_63 . V_73 ;
T_1 V_224 ;
int V_31 = 0 ;
struct V_87 * V_190 = NULL ;
struct V_86 * V_87 ;
T_1 V_33 ;
T_4 V_225 ;
F_47 ( & V_12 -> V_160 ) ;
V_224 = F_131 ( V_23 , V_223 -> V_135 + 1 ) - 1 ;
F_3 ( F_30 ( V_23 , V_224 ) == V_223 -> V_135 ) ;
V_31 = F_16 ( V_3 , V_23 , V_9 , 0 , V_224 + 1 , NULL ) ;
if ( V_31 != 0 )
return V_31 ;
if ( V_223 -> V_226 ) {
F_3 ( V_204 -> V_214 ) ;
...
F_134 ( V_190 ) ;
V_33 = F_20 ( V_10 ) ;
if ( F_126 ( ( V_190 -> V_211 != V_10 -> V_228 ) ||
( F_135 ( V_190 ) > V_33 ) ) ) {
F_22 ( V_210 , L_21 ) ;
V_31 = 1 ;
goto V_166;
}
V_225 = F_30 ( V_23 , V_33 - 1 ) ;
if ( V_223 -> V_226 ) {
if ( V_225 < V_223 -> V_135 ) {
F_22 ( V_210 ,
L_22 ,
V_190 -> V_211 , V_223 -> V_135 , V_225 ) ;
V_31 = - V_229 ;
goto V_166;
}
}
V_87 = F_136 ( V_3 , V_23 , V_223 -> V_135 , V_190 , V_230 ) ;
if ( F_137 ( V_87 ) ) {
V_31 = F_138 ( V_87 ) ;
goto V_166;
}
...
F_139 ( V_190 ) ;
if ( ! F_110 ( V_190 ) ) {
struct V_179 * V_180 = & V_9 -> V_185 . V_187 ;
struct V_194 * V_195 = F_102 ( V_23 , V_87 ) ;
int V_182 = V_69 ;
F_140 ( V_3 , V_9 , V_87 ) ;
F_32 ( V_180 ) ;
F_141 ( V_180 , V_87 ) ;
if ( V_225 == F_103 ( V_195 ) )
V_182 = V_33 & ~ V_114 ;
V_31 = F_105 ( V_3 , V_9 , V_180 , 0 , V_182 ,
F_129 ) ;
F_3 ( F_142 ( V_87 , V_9 ) ) ;
F_112 ( V_3 , V_180 ) ;
V_190 = NULL ;
...
F_3 ( ! V_223 -> V_226 || V_223 -> V_135 <= V_225 ) ;
if ( V_223 -> V_135 == V_225 )
V_223 -> V_232 = V_33 - F_131 ( V_23 , V_223 -> V_135 ) ;
else
V_223 -> V_232 = F_143 ( V_23 ) ;
