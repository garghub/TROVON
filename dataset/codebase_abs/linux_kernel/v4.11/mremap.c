...
if ( F_34 ( * V_23 ) )
continue;
V_13 = F_35 ( V_2 , V_15 , V_23 ) ;
if ( F_24 ( V_13 ) && F_36 ( V_13 ) )
V_27 = true ;
V_13 = F_37 ( V_13 , V_17 -> V_31 , V_15 , V_19 ) ;
V_13 = F_22 ( V_13 ) ;
F_38 ( V_2 , V_19 , V_24 , V_13 ) ;
}
F_39 () ;
if ( V_26 != V_25 )
F_40 ( V_26 ) ;
...
unsigned long F_44 ( struct V_8 * V_9 ,
...
if ( V_21 )
F_42 ( V_9 , V_16 - V_28 , V_15 ) ;
F_52 ( V_9 -> V_22 , V_34 , V_35 ) ;
return V_28 + V_15 - V_16 ;
}
static unsigned long F_53 ( struct V_8 * V_9 ,
...
if ( V_2 -> V_55 >= V_56 - 3 )
return - V_57 ;
V_54 = F_54 ( V_9 , V_15 , V_15 + V_41 ,
V_58 , & V_48 ) ;
if ( V_54 )
return V_54 ;
V_49 = V_9 -> V_59 + ( ( V_15 - V_9 -> V_60 ) >> V_61 ) ;
V_17 = F_55 ( & V_9 , V_19 , V_42 , V_49 ,
& V_20 ) ;
if ( ! V_17 )
return - V_57 ;
V_50 = F_44 ( V_9 , V_15 , V_17 , V_19 , V_41 ,
V_20 ) ;
if ( V_50 < V_41 ) {
V_54 = - V_57 ;
...
V_52 = V_2 -> V_52 ;
F_59 ( V_2 , V_9 -> V_48 , V_42 >> V_61 ) ;
if ( F_56 ( V_9 -> V_48 & V_66 ) )
F_60 ( V_9 ) ;
if ( F_61 ( V_2 , V_15 , V_41 , V_47 ) < 0 ) {
F_62 ( V_51 >> V_61 ) ;
V_51 = 0 ;
}
V_2 -> V_52 = V_52 ;
...
V_76 = F_67 ( V_77 ) ;
V_43 += V_42 - V_41 ;
if ( V_43 > V_76 && ! F_68 ( V_78 ) )
return F_65 ( - V_79 ) ;
}
if ( ! F_69 ( V_2 , V_9 -> V_48 ,
( V_42 - V_41 ) >> V_61 ) )
return F_65 ( - V_57 ) ;
if ( V_9 -> V_48 & V_64 ) {
...
static unsigned long F_71 ( unsigned long V_3 , unsigned long V_41 ,
...
if ( F_72 ( V_19 ) )
goto V_83;
if ( V_42 > V_84 || V_19 > V_84 - V_42 )
goto V_83;
if ( V_3 + V_41 > V_19 && V_19 + V_42 > V_3 )
goto V_83;
V_81 = F_61 ( V_2 , V_19 , V_42 , NULL ) ;
if ( V_81 )
goto V_83;
if ( V_41 >= V_42 ) {
V_81 = F_61 ( V_2 , V_3 + V_42 , V_41 - V_42 , V_47 ) ;
if ( V_81 && V_41 != V_42 )
goto V_83;
V_41 = V_42 ;
}
V_9 = F_63 ( V_3 , V_41 , V_42 , & V_80 ) ;
if ( F_73 ( V_9 ) ) {
V_81 = F_74 ( V_9 ) ;
goto V_83;
}
...
if ( V_9 -> V_48 & V_86 )
V_82 |= V_87 ;
V_81 = F_75 ( V_9 -> V_10 , V_19 , V_42 , V_9 -> V_59 +
( ( V_3 - V_9 -> V_60 ) >> V_61 ) ,
V_82 ) ;
if ( F_72 ( V_81 ) )
goto V_88;
V_81 = F_53 ( V_9 , V_3 , V_41 , V_42 , V_19 , V_43 , V_45 ,
V_47 ) ;
if ( ! ( F_72 ( V_81 ) ) )
goto V_83;
V_88:
...
static int F_76 ( struct V_8 * V_9 , unsigned long V_89 )
{
unsigned long V_90 = V_9 -> V_65 + V_89 ;
if ( V_90 < V_9 -> V_65 )
return 0 ;
if ( V_9 -> V_67 && V_9 -> V_67 -> V_60 < V_90 )
return 0 ;
if ( F_75 ( NULL , V_9 -> V_60 , V_90 - V_9 -> V_60 ,
0 , V_85 ) & ~ V_91 )
return 0 ;
return 1 ;
}
