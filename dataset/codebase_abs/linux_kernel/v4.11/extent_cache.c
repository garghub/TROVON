...
V_51 = F_35 ( V_9 ) ;
* V_47 = F_54 ( V_51 , struct V_1 , V_8 ) ;
V_51 = V_9 ;
if ( V_9 && V_31 < V_11 -> V_7 . V_31 )
V_51 = F_55 ( V_9 ) ;
* V_46 = F_54 ( V_51 , struct V_1 , V_8 ) ;
return NULL ;
V_52:
if ( V_31 == V_11 -> V_7 . V_31 ) {
V_51 = F_55 ( & V_11 -> V_8 ) ;
...
static struct V_1 * F_56 ( struct V_20 * V_20 ,
struct V_4 * V_5 , struct V_6 * V_7 ,
struct V_1 * V_46 ,
struct V_1 * V_47 )
{
...
if ( V_46 && F_57 ( V_7 , & V_46 -> V_7 ) ) {
V_46 -> V_7 . V_34 += V_7 -> V_34 ;
V_7 = & V_46 -> V_7 ;
V_11 = V_46 ;
}
if ( V_47 && F_58 ( V_7 , & V_47 -> V_7 ) ) {
...
static struct V_1 * F_60 ( struct V_20 * V_20 ,
struct V_4 * V_5 , struct V_6 * V_7 ,
struct V_8 * * V_48 ,
struct V_8 * V_49 )
{
...
static void F_61 ( struct V_20 * V_20 ,
...
if ( V_55 ) {
F_64 ( & V_7 , V_31 , V_55 , V_34 ) ;
if ( ! F_56 ( V_20 , V_5 , & V_7 , V_57 , V_58 ) )
F_60 ( V_20 , V_5 , & V_7 ,
V_48 , V_49 ) ;
if ( V_59 . V_34 >= 1 &&
V_60 . V_34 < V_66 &&
