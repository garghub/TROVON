...
F_41 ( & V_7 -> V_58 ) ;
F_42 ( & V_7 -> V_9 ) ;
F_36 ( V_54 -> V_50 && ! V_7 -> V_50 ) ;
}
int
F_43 ( const struct V_5 * V_6 ,
const struct V_53 * V_54 , void * V_20 , T_2 V_21 ,
struct V_1 * * V_51 )
{
if ( V_21 == 0 ) {
if ( ! ( * V_51 = F_44 ( sizeof( * * V_51 ) , V_59 ) ) )
return - V_60 ;
F_39 ( V_6 , V_54 , * V_51 ) ;
return 0 ;
}
...
int
F_45 ( const struct V_53 * V_54 , void * V_20 , T_2 V_21 ,
struct V_1 * * V_51 )
{
const struct V_5 * V_6 =
V_54 -> V_55 . V_6 ? V_54 -> V_55 . V_6 : & V_5 ;
return F_43 ( V_6 , V_54 , V_20 , V_21 , V_51 ) ;
}
