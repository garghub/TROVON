...
if ( V_2 -> V_97 == V_337 )
V_326 = 1 ;
if ( V_326 * V_323 > ( F_79 ( V_330 ) << 9 ) )
V_326 = ( F_79 ( V_330 ) << 9 ) / V_323 ;
V_223 = V_326 * V_323 ;
V_332 = F_80 ( V_330 , V_338 , V_198 ) ;
if ( F_81 ( V_332 ) ) {
V_21 = F_82 ( V_332 ) ;
break;
}
V_334 = F_83 ( V_332 ) ;
F_84 ( V_332 ) ;
V_21 = F_85 ( V_330 , V_332 , NULL , V_324 , V_223 , V_198 ) ;
if ( V_21 ) {
F_86 ( V_332 ) ;
break;
}
...
V_332 -> V_14 = 60 * V_15 ;
V_335 = V_332 -> V_335 ;
if ( F_87 ( V_330 , V_2 -> V_96 , V_332 , 0 ) ) {
struct V_340 * V_267 = V_334 -> V_5 ;
V_21 = - V_10 ;
V_2 -> V_327 = V_267 -> V_6 ;
}
if ( F_88 ( V_335 ) )
...
static int F_89 ( struct V_1 * V_2 , T_9 T_10 * V_324 ,
int V_218 , int V_325 )
{
int V_21 ;
if ( V_2 -> V_97 == V_99 )
...
return - V_347 ;
if ( F_91 ( & V_344 , V_342 , sizeof( V_344 ) ) )
return - V_328 ;
V_345 = V_344 . V_348 ;
if ( V_345 != V_155 && V_345 != V_217 )
return - V_62 ;
V_344 . V_348 = V_217 ;
V_21 = V_2 -> V_16 -> V_77 ( V_2 , & V_344 ) ;
if ( V_21 )
return V_21 ;
F_61 ( & V_344 . V_215 , & V_344 . V_348 , V_345 ) ;
if ( F_77 ( V_342 , & V_344 , sizeof( V_344 ) ) )
return - V_328 ;
F_18 ( V_346 , L_73 ) ;
return 0 ;
}
...
if ( ! F_21 ( V_68 ) )
return - V_347 ;
if ( ! F_21 ( V_69 ) || V_349 == V_162 )
return V_67 ( V_2 , 1 ) ;
if ( ( unsigned int ) V_349 >= V_2 -> V_192 )
return - V_62 ;
V_196 = F_52 ( sizeof( * V_196 ) , V_198 ) ;
if ( ! V_196 )
return - V_199 ;
...
if ( ! F_21 ( V_76 ) )
return - V_347 ;
return V_2 -> V_16 -> V_75 ( V_2 , V_349 ) ;
}
...
if ( ! F_21 ( V_69 ) )
return - V_347 ;
if ( V_349 != V_162 && V_349 != V_205 ) {
if ( ( int ) V_349 >= V_2 -> V_192 )
return - V_62 ;
}
if ( V_2 -> V_16 -> V_350 )
return V_2 -> V_16 -> V_350 ( V_2 , V_349 ) ;
F_18 ( V_197 , L_82 ) ;
return F_56 ( V_2 , V_349 ) ;
}
...
unsigned long V_349 )
{
F_18 ( V_346 , L_84 , V_349 ? L_85 : L_86 ) ;
if ( ! F_21 ( V_74 ) )
return - V_204 ;
V_2 -> V_179 = V_349 ? 1 : 0 ;
if ( V_2 -> V_172 != 1 && ! V_349 && ! F_101 ( V_351 ) )
return - V_206 ;
return V_2 -> V_16 -> V_73 ( V_2 , V_349 ) ;
}
static int F_104 ( struct V_1 * V_2 ,
unsigned long V_349 )
{
F_18 ( V_346 , L_87 , V_349 ? L_88 : L_89 ) ;
if ( ! F_101 ( V_351 ) )
return - V_352 ;
V_353 = V_349 ? 1 : 0 ;
return V_353 ;
...
if ( V_21 )
return V_21 ;
if ( F_77 ( V_342 , & V_306 , sizeof( V_306 ) ) )
return - V_328 ;
F_18 ( V_346 , L_92 ) ;
return 0 ;
}
...
return - V_347 ;
if ( ! F_21 ( V_69 ) ||
( V_349 == V_162 || V_349 == V_205 ) )
return V_2 -> V_16 -> V_64 ( V_2 , V_162 ) ;
if ( ( ( int ) V_349 >= V_2 -> V_192 ) )
return - V_62 ;
return F_51 ( V_2 , V_349 ) ;
}
...
T_11 V_216 , V_360 ;
int V_21 ;
if ( F_91 ( & V_330 , V_342 , sizeof( V_330 ) ) )
return - V_328 ;
V_216 = V_330 . V_308 ;
if ( V_216 != V_155 && V_216 != V_217 )
return - V_62 ;
V_330 . V_308 = V_155 ;
V_21 = V_2 -> V_16 -> V_149 ( V_2 , V_361 , & V_330 ) ;
if ( V_21 )
return V_21 ;
V_360 = V_330 . V_308 ;
F_61 ( & V_330 . V_313 , & V_360 , V_216 ) ;
F_61 ( & V_330 . V_314 , & V_330 . V_308 , V_216 ) ;
if ( F_77 ( V_342 , & V_330 , sizeof( V_330 ) ) )
return - V_328 ;
return 0 ;
}
...
struct V_140 V_141 ;
int V_21 ;
if ( F_91 ( & V_141 , V_342 , sizeof( V_141 ) ) )
return - V_328 ;
V_21 = V_2 -> V_16 -> V_149 ( V_2 , V_150 , & V_141 ) ;
if ( V_21 )
return V_21 ;
if ( F_77 ( V_342 , & V_141 , sizeof( V_141 ) ) )
return - V_328 ;
return 0 ;
}
...
T_11 V_345 ;
int V_21 ;
if ( F_91 ( & V_143 , V_342 , sizeof( V_143 ) ) )
return - V_328 ;
V_345 = V_143 . V_154 ;
if ( V_345 != V_155 && V_345 != V_217 )
return - V_62 ;
...
if ( V_21 )
return V_21 ;
F_61 ( & V_143 . V_362 , & V_143 . V_154 , V_345 ) ;
if ( F_77 ( V_342 , & V_143 , sizeof( V_143 ) ) )
return - V_328 ;
return 0 ;
}
...
if ( ! F_21 ( V_364 ) )
return - V_347 ;
if ( F_91 ( & V_219 , V_342 , sizeof( V_219 ) ) )
return - V_328 ;
return V_2 -> V_16 -> V_149 ( V_2 , V_365 , & V_219 ) ;
}
...
if ( ! F_21 ( V_364 ) )
return - V_347 ;
if ( F_91 ( & V_367 , V_342 , sizeof( V_367 ) ) )
return - V_328 ;
V_21 = F_48 ( V_2 , V_2 -> V_16 ) ;
if ( V_21 )
return V_21 ;
return V_2 -> V_16 -> V_149 ( V_2 , V_368 , & V_367 ) ;
}
...
if ( ! F_21 ( V_364 ) )
return - V_347 ;
if ( F_91 ( & V_370 , V_342 , sizeof( V_370 ) ) )
return - V_328 ;
return V_2 -> V_16 -> V_149 ( V_2 , V_371 , & V_370 ) ;
}
...
if ( ! F_21 ( V_364 ) )
return - V_347 ;
V_21 = V_2 -> V_16 -> V_149 ( V_2 , V_372 , & V_370 ) ;
if ( V_21 )
return V_21 ;
if ( F_77 ( V_342 , & V_370 , sizeof( V_370 ) ) )
return - V_328 ;
return 0 ;
}
...
static int F_118 ( struct V_1 * V_2 , int V_51 )
{
const struct V_19 * V_20 = V_2 -> V_16 ;
struct V_3 V_4 ;
struct V_373 V_374 ;
...
V_374 . V_375 = 0x08 ;
V_374 . V_376 = ( V_51 >> 8 ) & 0xff ;
V_374 . V_377 = V_51 & 0xff ;
memset ( & V_4 , 0 , sizeof( V_4 ) ) ;
V_4 . V_12 [ 0 ] = 0x15 ;
V_4 . V_12 [ 1 ] = 1 << 4 ;
V_4 . V_12 [ 4 ] = 12 ;
V_4 . V_22 = sizeof( V_374 ) ;
V_4 . V_27 = ( char * ) & V_374 ;
V_4 . V_224 = V_39 ;
V_374 . V_375 = 0x08 ;
V_374 . V_376 = ( V_51 >> 8 ) & 0xff ;
...
T_12 V_378 , T_9 type , T_13 * V_367 )
{
const struct V_19 * V_20 = V_2 -> V_16 ;
struct V_3 V_4 ;
int V_21 , V_22 ;
F_3 ( & V_4 , V_367 , 8 , V_23 ) ;
V_4 . V_12 [ 0 ] = V_379 ;
V_4 . V_12 [ 1 ] = type & 3 ;
V_4 . V_12 [ 4 ] = ( V_378 & 0xff00 ) >> 8 ;
V_4 . V_12 [ 5 ] = V_378 & 0xff ;
V_4 . V_12 [ 8 ] = 8 ;
V_4 . V_25 = 1 ;
V_21 = V_20 -> V_17 ( V_2 , & V_4 ) ;
if ( V_21 )
return V_21 ;
V_22 = F_5 ( V_367 -> V_380 ) +
sizeof( V_367 -> V_380 ) ;
if ( V_22 > sizeof( T_13 ) )
V_22 = sizeof( T_13 ) ;
V_4 . V_12 [ 8 ] = V_4 . V_22 = V_22 ;
...
int F_120 ( struct V_1 * V_2 , long * V_381 )
{
struct V_142 V_382 ;
T_1 V_18 ;
T_13 V_367 ;
...
goto V_385;
V_21 = F_4 ( V_2 , & V_18 ) ;
if ( V_21 < ( int ) ( F_13 ( F_14 ( V_18 ) , V_386 )
+ sizeof( V_18 . V_386 ) ) )
goto V_385;
V_383 = ( V_18 . V_387 << 8 ) | V_18 . V_386 ;
V_384 = F_119 ( V_2 , V_383 , 1 , & V_367 ) ;
if ( V_384 < ( int ) F_13 ( F_14 ( V_367 ) , V_388 ) )
goto V_385;
if ( V_367 . V_389 ) {
if ( V_383 == 1 )
goto V_385;
...
if ( V_384 < ( int ) ( F_13 ( F_14 ( V_367 ) , V_390 )
+ sizeof( V_367 . V_390 ) ) )
goto V_385;
if ( V_367 . V_391 && V_384 >= ( int ) ( F_13 ( F_14 ( V_367 ) , V_392 )
+ sizeof( V_367 . V_392 ) ) ) {
* V_381 = F_121 ( V_367 . V_392 ) ;
} else {
* V_381 = F_121 ( V_367 . V_388 ) +
F_121 ( V_367 . V_390 ) ;
if ( V_367 . V_393 )
* V_381 -= ( F_121 ( V_367 . V_393 ) + 7 ) ;
}
return 0 ;
V_385:
V_382 . V_154 = V_155 ;
V_382 . V_158 = V_394 ;
if ( ( V_21 = V_2 -> V_16 -> V_149 ( V_2 , V_159 , & V_382 ) ) )
return V_21 ;
F_61 ( & V_382 . V_362 , & V_382 . V_154 , V_217 ) ;
* V_381 = V_382 . V_362 . V_218 ;
return 0 ;
}
...
goto V_396;
V_21 = F_4 ( V_2 , & V_18 ) ;
if ( V_21 < 0 || V_21 < F_13 ( F_14 ( V_18 ) , V_386 )
+ sizeof( V_18 . V_386 ) )
goto V_396;
V_383 = ( V_18 . V_387 << 8 ) | V_18 . V_386 ;
V_384 = F_119 ( V_2 , V_383 , 1 , & V_367 ) ;
if ( V_384 < 0 || V_384 < F_13 ( F_14 ( V_367 ) , V_388 ) )
goto V_396;
if ( V_367 . V_389 ) {
if ( V_383 == 1 )
goto V_396;
...
if ( V_367 . V_397 && V_384 >= F_13 ( F_14 ( V_367 ) , V_395 )
+ sizeof( V_367 . V_395 ) ) {
* V_395 = F_121 ( V_367 . V_395 ) ;
return 0 ;
}
V_396:
V_21 = F_120 ( V_2 , V_395 ) ;
if ( V_21 ) {
* V_395 = 0 ;
return V_21 ;
} else {
...
if ( F_91 ( & V_219 , (struct V_363 T_10 * ) V_349 , sizeof( V_219 ) ) )
return - V_328 ;
V_218 = F_124 ( V_219 . V_402 , V_219 . V_403 , V_219 . V_404 ) ;
if ( V_218 < 0 )
return - V_62 ;
V_4 -> V_27 = F_125 ( V_315 , V_198 ) ;
if ( V_4 -> V_27 == NULL )
return - V_199 ;
...
if ( ! V_21 && F_77 ( V_349 , V_4 -> V_27 , V_315 ) )
V_21 = - V_328 ;
V_293:
F_53 ( V_4 -> V_27 ) ;
return V_21 ;
...
struct V_405 V_406 ;
int V_218 ;
if ( F_91 ( & V_406 , (struct V_405 T_10 * ) V_349 ,
sizeof( V_406 ) ) )
return - V_328 ;
if ( V_406 . V_348 == V_155 )
V_218 = F_124 ( V_406 . V_215 . V_219 . V_222 ,
V_406 . V_215 . V_219 . V_221 ,
V_406 . V_215 . V_219 . V_220 ) ;
else if ( V_406 . V_348 == V_217 )
V_218 = V_406 . V_215 . V_218 ;
else
return - V_62 ;
if ( V_218 < 0 || V_406 . V_325 <= 0 || V_406 . V_325 > V_407 )
return - V_62 ;
return F_89 ( V_2 , V_406 . V_182 , V_218 , V_406 . V_325 ) ;
}
...
struct V_304 V_330 ;
T_5 V_216 , V_360 ;
if ( F_91 ( & V_330 , (struct V_304 T_10 * ) V_349 , sizeof( V_330 ) ) )
return - V_328 ;
V_216 = V_330 . V_308 ;
if ( ! ( ( V_216 == V_155 ) ||
( V_216 == V_217 ) ) )
...
F_61 ( & V_330 . V_313 , & V_360 , V_216 ) ;
F_61 ( & V_330 . V_314 , & V_330 . V_308 , V_216 ) ;
if ( F_77 ( (struct V_304 T_10 * ) V_349 , & V_330 , sizeof( V_330 ) ) )
return - V_328 ;
return 0 ;
}
...
return - V_328 ;
V_4 -> V_12 [ 0 ] = V_408 ;
V_4 -> V_12 [ 3 ] = V_219 . V_402 ;
V_4 -> V_12 [ 4 ] = V_219 . V_403 ;
V_4 -> V_12 [ 5 ] = V_219 . V_404 ;
V_4 -> V_12 [ 6 ] = V_219 . V_409 ;
V_4 -> V_12 [ 7 ] = V_219 . V_410 ;
V_4 -> V_12 [ 8 ] = V_219 . V_411 ;
V_4 -> V_224 = V_11 ;
return V_20 -> V_17 ( V_2 , V_4 ) ;
}
...
struct V_412 V_413 ;
F_18 ( V_346 , L_102 ) ;
if ( F_91 ( & V_413 , (struct V_412 T_10 * ) V_349 , sizeof( V_413 ) ) )
return - V_328 ;
V_4 -> V_12 [ 0 ] = V_414 ;
V_4 -> V_12 [ 2 ] = ( V_413 . V_415 >> 24 ) & 0xff ;
V_4 -> V_12 [ 3 ] = ( V_413 . V_415 >> 16 ) & 0xff ;
V_4 -> V_12 [ 4 ] = ( V_413 . V_415 >> 8 ) & 0xff ;
V_4 -> V_12 [ 5 ] = V_413 . V_415 & 0xff ;
V_4 -> V_12 [ 7 ] = ( V_413 . V_223 >> 8 ) & 0xff ;
V_4 -> V_12 [ 8 ] = V_413 . V_223 & 0xff ;
V_4 -> V_224 = V_11 ;
return V_20 -> V_17 ( V_2 , V_4 ) ;
}
...
int V_21 ;
F_18 ( V_346 , L_103 ) ;
if ( F_91 ( & V_416 , (struct V_369 T_10 * ) V_349 ,
sizeof( V_416 ) ) )
return - V_328 ;
V_4 -> V_27 = V_27 ;
V_4 -> V_22 = 24 ;
V_21 = F_7 ( V_2 , V_4 , V_417 , 0 ) ;
if ( V_21 )
return V_21 ;
...
if ( ( V_27 [ V_50 ] & 0x3f ) != V_417 ||
V_27 [ V_50 + 1 ] < 14 )
return - V_62 ;
if ( V_12 == V_372 ) {
V_416 . V_419 = V_27 [ V_50 + 9 ] ;
V_416 . V_420 = V_27 [ V_50 + 11 ] ;
V_416 . V_421 = V_27 [ V_50 + 13 ] ;
V_416 . V_422 = V_27 [ V_50 + 15 ] ;
if ( F_77 ( (struct V_369 T_10 * ) V_349 , & V_416 ,
sizeof( V_416 ) ) )
return - V_328 ;
return 0 ;
}
V_4 -> V_27 = V_130 ;
V_21 = F_7 ( V_2 , V_4 , V_417 , 1 ) ;
if ( V_21 )
return V_21 ;
V_27 [ V_50 + 9 ] = V_416 . V_419 & V_130 [ V_50 + 9 ] ;
V_27 [ V_50 + 11 ] = V_416 . V_420 & V_130 [ V_50 + 11 ] ;
V_27 [ V_50 + 13 ] = V_416 . V_421 & V_130 [ V_50 + 13 ] ;
V_27 [ V_50 + 15 ] = V_416 . V_422 & V_130 [ V_50 + 15 ] ;
...
return - V_347 ;
F_18 ( V_346 , L_107 ) ;
if ( F_91 ( & V_229 , ( T_6 T_10 * ) V_349 , sizeof( V_229 ) ) )
return - V_328 ;
V_21 = F_64 ( V_2 , & V_229 ) ;
if ( V_21 )
return V_21 ;
if ( F_77 ( ( T_6 T_10 * ) V_349 , & V_229 , sizeof( V_229 ) ) )
return - V_328 ;
return 0 ;
}
...
long V_427 = 0 ;
F_18 ( V_346 , L_108 ) ;
V_21 = F_122 ( V_2 , & V_427 ) ;
if ( V_21 )
return V_21 ;
if ( F_77 ( ( long T_10 * ) V_349 , & V_427 , sizeof( V_427 ) ) )
return - V_328 ;
return 0 ;
}
...
long V_428 = 0 ;
F_18 ( V_346 , L_109 ) ;
V_21 = F_120 ( V_2 , & V_428 ) ;
if ( V_21 )
return V_21 ;
if ( F_77 ( ( long T_10 * ) V_349 , & V_428 , sizeof( V_428 ) ) )
return - V_328 ;
return 0 ;
}
static int F_138 ( struct V_1 * V_2 , unsigned int V_12 ,
unsigned long V_349 )
{
struct V_3 V_4 ;
void T_10 * V_429 = ( void T_10 * ) V_349 ;
memset ( & V_4 , 0 , sizeof( V_4 ) ) ;
switch ( V_12 ) {
case V_398 :
case V_399 :
case V_401 :
return F_123 ( V_2 , V_429 , & V_4 , V_12 ) ;
case V_430 :
return F_126 ( V_2 , V_429 ) ;
case V_361 :
return F_127 ( V_2 , V_429 ) ;
case V_365 :
return F_128 ( V_2 , V_429 , & V_4 ) ;
case V_431 :
return F_129 ( V_2 , V_429 , & V_4 ) ;
case V_371 :
case V_372 :
return F_130 ( V_2 , V_429 , & V_4 , V_12 ) ;
case V_424 :
case V_432 :
return F_131 ( V_2 , & V_4 , V_12 ) ;
case V_433 :
case V_426 :
return F_132 ( V_2 , & V_4 , V_12 ) ;
case V_434 :
return F_133 ( V_2 , V_429 , & V_4 ) ;
case V_435 :
return F_135 ( V_2 , V_429 ) ;
case V_436 :
return F_136 ( V_2 , V_429 ) ;
case V_437 :
return F_137 ( V_2 , V_429 ) ;
}
return - V_266 ;
}
int F_139 ( struct V_1 * V_2 , struct V_169 * V_170 ,
T_4 V_171 , unsigned int V_12 , unsigned long V_349 )
{
void T_10 * V_342 = ( void T_10 * ) V_349 ;
int V_21 ;
V_21 = F_140 ( V_170 , V_171 , V_12 , V_342 ) ;
if ( V_21 != - V_266 )
return V_21 ;
switch ( V_12 ) {
case V_438 :
return F_90 ( V_2 , V_342 ) ;
case V_439 :
return F_92 ( V_2 ) ;
case V_440 :
return F_93 ( V_2 ) ;
case V_441 :
return F_94 ( V_2 , V_349 ) ;
case V_442 :
return F_95 ( V_2 , V_349 ) ;
case V_443 :
...
case V_446 :
return F_99 ( V_2 , V_349 ) ;
case V_447 :
return F_100 ( V_2 , V_170 ) ;
case V_448 :
return F_103 ( V_2 , V_349 ) ;
case V_449 :
return F_104 ( V_2 , V_349 ) ;
case V_450 :
return F_105 ( V_2 ) ;
case V_451 :
return F_106 ( V_2 , V_342 ) ;
case V_452 :
return F_107 ( V_2 , V_349 ) ;
case V_453 :
return F_108 ( V_2 ) ;
case V_454 :
return F_109 ( V_2 ) ;
...
case V_150 :
return F_111 ( V_2 , V_342 ) ;
case V_159 :
return F_112 ( V_2 , V_342 ) ;
case V_365 :
return F_113 ( V_2 , V_342 ) ;
case V_368 :
return F_114 ( V_2 , V_342 ) ;
case V_371 :
return F_115 ( V_2 , V_342 ) ;
case V_372 :
return F_116 ( V_2 , V_342 ) ;
case V_424 :
case V_432 :
case V_433 :
case V_426 :
return F_117 ( V_2 , V_12 ) ;
}
return - V_347 ;
}
static int F_141 ( const char * V_141 , int V_455 , char * V_196 ,
int * V_456 , enum V_457 V_458 )
{
const int V_459 = sizeof( V_460 . V_196 ) ;
struct V_1 * V_2 ;
int V_21 ;
V_21 = F_142 ( V_196 + * V_456 , V_459 - * V_456 , V_141 ) ;
if ( ! V_21 )
return 1 ;
* V_456 += V_21 ;
F_143 (cdi, &cdrom_list, list) {
switch ( V_458 ) {
case V_461 :
V_21 = F_142 ( V_196 + * V_456 , V_459 - * V_456 ,
L_110 , V_2 -> V_54 ) ;
break;
case V_462 :
V_21 = F_142 ( V_196 + * V_456 , V_459 - * V_456 ,
...
static int F_144 ( struct V_466 * V_467 , int V_31 ,
void T_10 * V_27 , T_16 * V_468 , T_17 * V_469 )
{
int V_456 ;
char * V_196 = V_460 . V_196 ;
const int V_459 = sizeof( V_460 . V_196 ) ;
if ( ! * V_468 || ( * V_469 && ! V_31 ) ) {
* V_468 = 0 ;
return 0 ;
...
F_23 ( & V_101 ) ;
V_456 = sprintf ( V_196 , L_113 V_470 L_9 ) ;
if ( F_141 ( L_114 , 0 , V_196 , & V_456 , V_461 ) )
goto V_471;
if ( F_141 ( L_115 , 0 , V_196 , & V_456 , V_462 ) )
goto V_471;
if ( F_141 ( L_116 , 0 , V_196 , & V_456 , V_464 ) )
goto V_471;
if ( F_141 ( L_117 ,
V_71 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_118 ,
V_72 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_119 ,
V_74 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_120 ,
V_76 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_121 ,
V_69 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_122 ,
V_78 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_123 ,
V_80 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_124 ,
V_68 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_125 ,
V_364 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_126 ,
V_134 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_127 ,
V_135 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_128 ,
V_136 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_129 ,
V_137 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_130 ,
V_133 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_131 ,
V_131 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_132 ,
V_95 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( F_141 ( L_133 ,
V_132 , V_196 , & V_456 , V_465 ) )
goto V_471;
if ( ! F_142 ( V_196 + V_456 , V_459 - V_456 , L_134 ) )
goto V_471;
V_472:
F_25 ( & V_101 ) ;
return F_145 ( V_467 , V_31 , V_27 , V_468 , V_469 ) ;
V_471:
F_10 ( L_135 ) ;
goto V_472;
}
...
static int F_147 ( struct V_466 * V_467 , int V_31 ,
void T_10 * V_27 , T_16 * V_468 , T_17 * V_469 )
{
int V_21 ;
V_21 = F_148 ( V_467 , V_31 , V_27 , V_468 , V_469 ) ;
if ( V_31 ) {
V_87 = ! ! V_460 . V_87 ;
V_89 = ! ! V_460 . V_89 ;
V_353 = ! ! V_460 . V_353 ;
...
static int T_18 F_152 ( void )
{
F_19 () ;
return 0 ;
}
static void T_19 F_153 ( void )
{
F_10 ( L_136 ) ;
F_150 () ;
}
