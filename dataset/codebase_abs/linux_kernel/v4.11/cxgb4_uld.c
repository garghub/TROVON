...
static void F_69 ( struct V_1 * V_2 , struct V_122 * V_130 )
{
int V_51 ;
...
V_130 -> V_140 = F_70 ( F_71 ( V_2 , V_141 ) ) ;
V_130 -> V_142 = F_71 ( V_2 , V_143 ) ;
V_130 -> V_144 = F_71 ( V_2 , V_145 ) ;
V_130 -> V_146 = F_71 ( V_2 , V_147 ) ;
...
V_130 -> V_163 = V_2 -> V_164 + F_44 ( V_104 ) ;
V_130 -> V_165 = V_2 -> V_164 + F_44 ( V_166 ) ;
...
V_130 -> V_180 = F_72 ( V_2 -> V_97 ) ;
V_130 -> V_181 = V_2 -> V_55 . V_181 ;
}
static void F_73 ( struct V_1 * V_2 , unsigned int V_14 )
{
void * V_30 ;
struct V_122 V_123 ;
F_69 ( V_2 , & V_123 ) ;
F_65 ( V_2 , V_14 , & V_123 ) ;
V_30 = V_2 -> V_14 [ V_14 ] . F_74 ( & V_123 ) ;
if ( F_75 ( V_30 ) ) {
F_33 ( V_2 -> V_97 ,
L_3 ,
V_2 -> V_14 [ V_14 ] . V_98 , F_76 ( V_30 ) ) ;
return;
}
V_2 -> V_14 [ V_14 ] . V_30 = V_30 ;
F_77 () ;
if ( V_2 -> V_6 & V_72 )
V_2 -> V_14 [ V_14 ] . F_78 ( V_30 , V_182 ) ;
}
int F_79 ( enum V_183 type ,
...
return - V_186 ;
F_80 ( & V_187 ) ;
F_81 (adap, &adapter_list, list_node) {
if ( ( type == V_188 && ! F_82 ( V_2 ) ) ||
( type != V_188 && ! F_83 ( V_2 ) ) )
continue;
if ( type == V_189 && F_84 ( V_2 -> V_55 . V_150 ) )
continue;
...
if ( V_2 -> V_6 & V_72 )
F_49 ( V_2 , type ) ;
if ( V_2 -> V_14 [ type ] . F_74 ) {
V_23 = - V_193 ;
goto F_38;
}
V_23 = F_62 ( V_2 , type , V_184 ) ;
if ( V_23 )
goto F_38;
V_2 -> V_14 [ type ] = * V_184 ;
F_73 ( V_2 , type ) ;
