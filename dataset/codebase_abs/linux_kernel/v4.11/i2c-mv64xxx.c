...
struct V_124 * V_65 )
{
const struct V_125 * V_124 ;
struct V_126 * V_127 = V_65 -> V_128 ;
T_1 V_129 , V_115 ;
int V_62 = 0 ;
if ( F_33 ( V_2 -> V_130 ) ) {
V_62 = - V_131 ;
...
V_115 = F_34 ( V_2 -> V_130 ) ;
if ( F_35 ( V_127 , L_6 , & V_129 ) )
V_129 = 100000 ;
if ( F_36 ( V_127 , L_7 ) ||
F_36 ( V_127 , L_8 ) )
V_2 -> V_118 = true ;
if ( ! F_31 ( V_2 , V_129 , V_115 ) ) {
V_62 = - V_132 ;
goto V_83;
}
V_2 -> V_85 = F_37 ( V_127 , 0 ) ;
V_2 -> V_133 = F_38 ( V_65 , NULL ) ;
if ( F_33 ( V_2 -> V_133 ) ) {
if ( F_39 ( V_2 -> V_133 ) == - V_134 ) {
V_62 = - V_134 ;
goto V_83;
}
} else {
...
static int
F_42 ( struct V_137 * V_138 )
{
struct V_1 * V_2 ;
struct V_139 * V_140 = F_43 ( & V_138 -> V_65 ) ;
struct V_141 * V_142 ;
int V_62 ;
if ( ( ! V_140 && ! V_138 -> V_65 . V_128 ) )
return - V_131 ;
V_2 = F_44 ( & V_138 -> V_65 , sizeof( struct V_1 ) ,
V_143 ) ;
if ( ! V_2 )
return - V_144 ;
V_142 = F_45 ( V_138 , V_145 , 0 ) ;
V_2 -> V_17 = F_46 ( & V_138 -> V_65 , V_142 ) ;
if ( F_33 ( V_2 -> V_17 ) )
return F_39 ( V_2 -> V_17 ) ;
F_47 ( V_2 -> V_64 . V_146 , V_147 L_11 ,
sizeof( V_2 -> V_64 . V_146 ) ) ;
F_48 ( & V_2 -> V_75 ) ;
F_49 ( & V_2 -> V_87 ) ;
V_2 -> V_130 = F_50 ( & V_138 -> V_65 , NULL ) ;
if ( F_33 ( V_2 -> V_130 ) && F_39 ( V_2 -> V_130 ) == - V_134 )
return - V_134 ;
if ( ! F_33 ( V_2 -> V_130 ) )
F_51 ( V_2 -> V_130 ) ;
if ( V_140 ) {
V_2 -> V_24 = V_140 -> V_24 ;
V_2 -> V_25 = V_140 -> V_25 ;
V_2 -> V_85 = F_52 ( V_138 , 0 ) ;
V_2 -> V_64 . V_91 = F_53 ( V_140 -> V_91 ) ;
V_2 -> V_16 = false ;
memcpy ( & V_2 -> V_22 , & V_148 , sizeof( V_2 -> V_22 ) ) ;
} else if ( V_138 -> V_65 . V_128 ) {
V_62 = F_32 ( V_2 , & V_138 -> V_65 ) ;
if ( V_62 )
goto V_149;
}
if ( V_2 -> V_85 < 0 ) {
...
V_2 -> V_64 . V_65 . V_151 = & V_138 -> V_65 ;
V_2 -> V_64 . V_152 = & V_153 ;
V_2 -> V_64 . V_154 = V_155 ;
V_2 -> V_64 . V_156 = V_157 ;
V_2 -> V_64 . V_158 = V_138 -> V_159 ;
V_2 -> V_64 . V_65 . V_128 = V_138 -> V_65 . V_128 ;
F_54 ( V_138 , V_2 ) ;
F_55 ( & V_2 -> V_64 , V_2 ) ;
F_3 ( V_2 ) ;
V_62 = F_56 ( V_2 -> V_85 , F_17 , 0 ,
V_147 , V_2 ) ;
if ( V_62 ) {
F_8 ( & V_2 -> V_64 . V_65 ,
L_12 ,
...
static int
F_62 ( struct V_137 * V_65 )
{
struct V_1 * V_2 = F_63 ( V_65 ) ;
F_64 ( & V_2 -> V_64 ) ;
F_58 ( V_2 -> V_85 , V_2 ) ;
if ( ! F_59 ( V_2 -> V_133 ) )
F_60 ( V_2 -> V_133 ) ;
...
static int F_65 ( struct V_124 * V_65 )
{
struct V_137 * V_161 = F_66 ( V_65 ) ;
struct V_1 * V_2 = F_63 ( V_161 ) ;
F_3 ( V_2 ) ;
return 0 ;
}
