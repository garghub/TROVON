...
V_6 = F_30 ( V_5 -> V_20 , V_2 & V_25 ) ;
if ( V_6 && V_5 -> V_26 )
V_7 = V_5 -> V_26 ( V_6 , V_25 , V_2 , V_11 , V_5 ) ;
if ( V_7 )
break;
...
static int F_31 ( unsigned long V_27 , unsigned long V_3 ,
struct V_4 * V_5 )
{
struct V_24 * V_13 = V_5 -> V_13 ;
if ( V_5 -> V_28 )
return V_5 -> V_28 ( V_27 , V_3 , V_5 ) ;
if ( V_13 -> V_29 & V_30 ) {
int V_7 = 1 ;
if ( V_5 -> V_14 )
V_7 = V_5 -> V_14 ( V_27 , V_3 , V_5 ) ;
return V_7 ? V_7 : 1 ;
}
return 0 ;
}
static int F_32 ( unsigned long V_27 , unsigned long V_3 ,
struct V_4 * V_5 )
{
int V_7 = 0 ;
struct V_24 * V_13 = V_5 -> V_13 ;
if ( V_13 && F_33 ( V_13 ) ) {
if ( V_5 -> V_26 )
V_7 = F_28 ( V_27 , V_3 , V_5 ) ;
} else
V_7 = F_21 ( V_27 , V_3 , V_5 ) ;
return V_7 ;
}
int F_34 ( unsigned long V_27 , unsigned long V_3 ,
struct V_4 * V_5 )
{
int V_7 = 0 ;
unsigned long V_11 ;
...
if ( ! V_5 -> V_20 )
return - V_31 ;
F_35 ( ! F_36 ( & V_5 -> V_20 -> V_32 ) , V_5 -> V_20 ) ;
V_13 = F_37 ( V_5 -> V_20 , V_27 ) ;
do {
if ( ! V_13 ) {
V_5 -> V_13 = NULL ;
V_11 = V_3 ;
} else if ( V_27 < V_13 -> V_33 ) {
V_5 -> V_13 = NULL ;
V_11 = F_38 ( V_3 , V_13 -> V_33 ) ;
} else {
V_5 -> V_13 = V_13 ;
V_11 = F_38 ( V_3 , V_13 -> V_34 ) ;
V_13 = V_13 -> V_35 ;
V_7 = F_31 ( V_27 , V_11 , V_5 ) ;
if ( V_7 > 0 ) {
V_7 = 0 ;
continue;
}
...
V_7 = F_32 ( V_27 , V_11 , V_5 ) ;
if ( V_7 )
break;
} while ( V_27 = V_11 , V_27 < V_3 );
return V_7 ;
}
...
if ( ! V_5 -> V_20 )
return - V_31 ;
F_40 ( ! F_36 ( & V_5 -> V_20 -> V_32 ) ) ;
F_40 ( ! V_13 ) ;
V_5 -> V_13 = V_13 ;
V_7 = F_31 ( V_13 -> V_33 , V_13 -> V_34 , V_5 ) ;
if ( V_7 > 0 )
return 0 ;
if ( V_7 < 0 )
return V_7 ;
return F_32 ( V_13 -> V_33 , V_13 -> V_34 , V_5 ) ;
}
