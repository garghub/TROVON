...
static void F_71 ( unsigned long V_145 )
{
struct V_3 * V_4 ;
T_3 V_16 = 0 ;
struct V_1 * V_2 ;
...
return;
F_40 ( & V_4 -> V_7 -> V_11 ) ;
if ( F_72 ( V_118 , V_4 -> V_7 -> V_108 . V_148 ) ) {
F_11 ( V_4 -> V_2 ,
L_5 ,
...
static inline void F_76 ( struct V_3 * V_4 , T_2 V_159 )
{
V_4 -> V_7 -> V_108 . V_148 = V_118 + F_77 ( V_159 ) ;
V_4 -> V_7 -> V_108 . V_145 = ( unsigned long ) V_4 ;
V_4 -> V_7 -> V_108 . V_160 = F_71 ;
V_4 -> V_7 -> V_153 = V_159 ;
F_78 ( & V_4 -> V_7 -> V_108 ) ;
}
...
V_4 -> V_7 -> V_12 = V_151 ;
F_76 ( V_4 , V_2 -> V_6 . V_7 . V_8 . V_163 ) ;
F_41 ( & V_4 -> V_7 -> V_11 ) ;
F_11 ( V_2 ,
L_9 ,
V_4 -> V_4 . V_44 ) ;
...
V_15 = F_92 ( F_93 ( V_110 -> V_184 ) ) ;
if ( V_177 == V_98 ||
( V_177 == V_97 && V_75 == 8 ) )
V_14 = F_92 ( F_94 ( V_110 -> V_184 ) ) ;
F_8 () ;
V_4 = F_65 ( V_2 , V_71 -> V_92 ) ;
if ( V_177 == V_101 &&
! F_1 ( V_2 , V_4 ) ) {
F_11 ( V_2 , L_20 ,
V_71 -> V_92 ) ;
...
V_165 = F_88 ( V_2 , V_4 , V_110 , V_177 , V_14 , V_15 ) ;
if ( V_165 == V_172 ) {
F_10 () ;
V_4 = F_64 ( V_2 , V_71 -> V_92 , V_110 ) ;
if ( ! V_4 ) {
F_11 ( V_2 , L_21 ) ;
goto V_188;
}
...
if ( ! V_4 -> V_7 -> V_15 )
V_4 -> V_7 -> V_15 = V_15 ;
V_4 -> V_7 -> V_99 = F_92 ( F_95 ( V_71 ) ) ;
}
V_28 |= F_87 ( V_2 , V_4 , V_165 ) ;
V_188:
F_10 () ;
if ( V_28 )
F_70 ( V_2 , V_28 ) ;
...
F_98 ( V_193 , V_189 - V_192 , true , & V_110 ) ;
F_91 ( V_2 , V_71 , & V_110 ) ;
}
