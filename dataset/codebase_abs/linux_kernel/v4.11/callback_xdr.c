...
static T_1 F_23 ( struct V_8 * V_9 , unsigned int * V_40 )
{
T_1 * V_6 ;
V_6 = F_7 ( V_9 , 4 ) ;
if ( F_9 ( V_6 == NULL ) )
...
static T_1 F_24 ( struct V_1 * V_2 , struct V_8 * V_9 , struct V_42 * args )
{
T_1 V_30 ;
V_30 = F_14 ( V_9 , & args -> V_18 ) ;
if ( F_9 ( V_30 != 0 ) )
goto V_43;
V_30 = F_16 ( V_9 , args -> V_23 ) ;
V_43:
F_22 ( L_5 , V_37 , F_15 ( V_30 ) ) ;
return V_30 ;
}
static T_1 F_25 ( struct V_1 * V_2 , struct V_8 * V_9 , struct V_44 * args )
{
T_1 * V_6 ;
T_1 V_30 ;
...
static T_1 F_26 ( struct V_8 * V_9 , T_5 * V_25 )
{
V_25 -> type = V_46 ;
return F_18 ( V_9 , V_25 ) ;
}
...
if ( args -> V_52 == V_53 ) {
args -> V_54 . V_48 = V_48 ;
V_30 = F_14 ( V_9 , & args -> V_55 ) ;
if ( F_9 ( V_30 != 0 ) )
goto V_43;
V_6 = F_7 ( V_9 , 2 * sizeof( V_56 ) ) ;
if ( F_9 ( V_6 == NULL ) ) {
V_30 = F_2 ( V_49 ) ;
goto V_43;
}
V_6 = F_28 ( V_6 , & args -> V_54 . V_57 ) ;
V_6 = F_28 ( V_6 , & args -> V_54 . V_58 ) ;
V_30 = F_26 ( V_9 , & args -> V_59 ) ;
if ( F_9 ( V_30 != 0 ) )
goto V_43;
} else if ( args -> V_52 == V_60 ) {
V_6 = F_7 ( V_9 , 2 * sizeof( V_56 ) ) ;
if ( F_9 ( V_6 == NULL ) ) {
V_30 = F_2 ( V_49 ) ;
goto V_43;
}
V_6 = F_28 ( V_6 , & args -> V_61 . V_62 ) ;
V_6 = F_28 ( V_6 , & args -> V_61 . V_63 ) ;
} else if ( args -> V_52 != V_64 ) {
V_30 = F_2 ( V_49 ) ;
goto V_43;
}
F_22 ( L_6 ,
...
if ( V_67 <= 0 )
goto V_43;
if ( V_67 > V_70 / sizeof( * args -> V_71 ) ) {
V_30 = F_2 ( V_49 ) ;
goto V_43;
}
args -> V_71 = F_30 ( V_67 , sizeof( * args -> V_71 ) , V_72 ) ;
if ( ! args -> V_71 ) {
V_30 = F_2 ( V_73 ) ;
goto V_43;
}
for ( V_68 = 0 ; V_68 < V_67 ; V_68 ++ ) {
struct V_74 * V_75 = & args -> V_71 [ V_68 ] ;
...
if ( F_9 ( V_6 == NULL ) )
goto V_43;
V_88 -> V_91 = F_30 ( V_88 -> V_90 ,
sizeof( * V_88 -> V_91 ) ,
V_72 ) ;
if ( F_9 ( V_88 -> V_91 == NULL ) )
goto V_43;
for ( V_68 = 0 ; V_68 < V_88 -> V_90 ; V_68 ++ ) {
V_88 -> V_91 [ V_68 ] . V_92 = F_15 ( * V_6 ++ ) ;
V_88 -> V_91 [ V_68 ] . V_93 = F_15 ( * V_6 ++ ) ;
}
}
V_30 = 0 ;
V_43:
...
args -> V_102 = NULL ;
if ( args -> V_101 ) {
args -> V_102 = F_30 ( args -> V_101 ,
sizeof( * args -> V_102 ) ,
V_72 ) ;
if ( F_9 ( args -> V_102 == NULL ) )
goto V_43;
for ( V_68 = 0 ; V_68 < args -> V_101 ; V_68 ++ ) {
V_30 = F_34 ( V_9 , & args -> V_102 [ V_68 ] ) ;
if ( V_30 ) {
args -> V_101 = V_68 ;
goto V_103;
}
...
static T_1 F_46 ( struct V_8 * V_9 , const T_4 * V_23 , V_56 V_120 )
{
T_1 * V_6 ;
if ( ! ( V_23 [ 0 ] & V_121 ) )
return 0 ;
...
static T_1 F_48 ( struct V_8 * V_9 , const T_4 * V_23 , V_56 V_19 )
{
T_1 * V_6 ;
if ( ! ( V_23 [ 0 ] & V_122 ) )
return 0 ;
...
static T_1
F_64 ( int V_140 , unsigned int V_141 , struct V_142 * * V_40 )
{
...
static T_1
F_65 ( unsigned int V_141 , struct V_142 * * V_40 )
{
switch ( V_141 ) {
case V_146 :
case V_147 :
...
static T_1 F_66 ( int V_140 , struct V_1 * V_2 ,
...
T_1 V_129 ;
F_22 ( L_11 , V_37 ) ;
V_30 = F_23 ( V_174 , & V_141 ) ;
if ( F_9 ( V_30 ) )
return V_30 ;
F_22 ( L_12 ,
V_37 , V_170 -> V_34 , V_140 , V_141 ) ;
switch ( V_170 -> V_34 ) {
case 0 :
V_30 = F_65 ( V_141 , & V_40 ) ;
break;
case 1 :
V_30 = F_57 ( V_140 , V_141 , & V_40 ) ;
break;
case 2 :
V_30 = F_64 ( V_140 , V_141 , & V_40 ) ;
break;
default:
V_30 = F_2 ( V_38 ) ;
}
...
F_22 ( L_13 , V_37 , F_15 ( V_30 ) ) ;
return V_30 ;
}
static T_1 F_67 ( struct V_1 * V_2 , void * V_3 , void * V_4 )
{
struct V_28 V_183 = { 0 } ;
...
unsigned int V_39 = 0 ;
F_22 ( L_11 , V_37 ) ;
F_69 ( & V_174 , & V_2 -> V_186 , V_2 -> V_186 . V_187 [ 0 ] . V_188 ) ;
V_6 = ( T_1 * ) ( ( char * ) V_2 -> V_189 . V_187 [ 0 ] . V_188 + V_2 -> V_189 . V_187 [ 0 ] . V_190 ) ;
F_70 ( & V_175 , & V_2 -> V_189 , V_6 ) ;
V_30 = F_20 ( & V_174 , & V_183 ) ;
if ( V_30 == F_2 ( V_16 ) )
return V_191 ;
if ( V_183 . V_34 == 0 ) {
V_170 . V_171 = F_71 ( F_68 ( V_2 ) , V_183 . V_36 ) ;
if ( ! V_170 . V_171 || ! F_72 ( V_170 . V_171 , V_2 ) )
goto V_192;
}
