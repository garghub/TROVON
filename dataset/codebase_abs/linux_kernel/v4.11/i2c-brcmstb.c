...
if ( V_50 < ( V_78 - 1 ) && ( V_77 [ V_50 + 1 ] . V_52 & V_86 ) )
V_82 = ~ V_29 ;
else
V_82 = V_73 | V_74 ;
F_16 ( V_2 , V_82 ) ;
...
static T_2 F_27 ( struct V_75 * V_89 )
{
...
{
int V_50 = 0 , V_95 = F_29 ( V_96 ) ;
T_2 V_97 = V_2 -> V_97 ;
for ( V_50 = 0 ; V_50 < V_95 ; V_50 ++ ) {
if ( V_96 [ V_50 ] . V_98 == V_97 ) {
V_2 -> V_6 -> V_7 &= ~ ( V_99
| V_100 ) ;
V_2 -> V_6 -> V_7 |= ( V_96 [ V_50 ] . V_101 |
V_96 [ V_50 ] . V_102 ) ;
F_5 ( V_2 , V_2 -> V_6 -> V_7 , V_7 ) ;
break;
}
...
struct V_107 * V_108 ;
const char * V_109 ;
V_2 = F_33 ( & V_106 -> V_2 , sizeof( * V_2 ) , V_110 ) ;
if ( ! V_2 )
return - V_111 ;
V_2 -> V_6 = F_33 ( & V_106 -> V_2 , sizeof( * V_2 -> V_6 ) , V_110 ) ;
if ( ! V_2 -> V_6 )
return - V_111 ;
F_34 ( V_106 , V_2 ) ;
V_2 -> V_14 = & V_106 -> V_2 ;
F_35 ( & V_2 -> V_17 ) ;
V_108 = F_36 ( V_106 , V_112 , 0 ) ;
V_2 -> V_113 = F_37 ( V_2 -> V_14 , V_108 ) ;
if ( F_38 ( V_2 -> V_113 ) ) {
V_32 = - V_111 ;
goto V_114;
}
V_32 = F_39 ( V_2 -> V_14 -> V_115 , L_9 ,
& V_109 ) ;
if ( V_32 < 0 )
V_109 = NULL ;
V_2 -> V_9 = F_40 ( V_106 , 0 ) ;
F_3 ( V_2 , V_16 ) ;
V_32 = F_41 ( & V_106 -> V_2 , V_2 -> V_9 , F_6 ,
V_116 ,
V_109 ? V_109 : V_106 -> V_117 ,
V_2 ) ;
if ( V_32 ) {
F_8 ( V_2 -> V_14 , L_10 ) ;
V_2 -> V_9 = - 1 ;
}
if ( F_42 ( V_2 -> V_14 -> V_115 ,
L_11 , & V_2 -> V_97 ) ) {
F_30 ( V_2 -> V_14 , L_12 ,
V_96 [ 0 ] . V_98 ) ;
V_2 -> V_97 = V_96 [ 0 ] . V_98 ;
}
if ( F_43 ( V_2 -> V_14 -> V_115 ,
L_13 ) )
V_2 -> V_4 = sizeof( T_3 ) ;
else
V_2 -> V_4 = sizeof( T_2 ) ;
...
F_44 ( V_89 , V_2 ) ;
V_89 -> V_118 = V_119 ;
F_45 ( V_89 -> V_117 , L_14 , sizeof( V_89 -> V_117 ) ) ;
if ( V_109 )
F_46 ( V_89 -> V_117 , V_109 , sizeof( V_89 -> V_117 ) ) ;
V_89 -> V_120 = & V_121 ;
V_89 -> V_2 . V_122 = & V_106 -> V_2 ;
V_89 -> V_2 . V_115 = V_106 -> V_2 . V_115 ;
V_32 = F_47 ( V_89 ) ;
if ( V_32 )
goto V_114;
F_48 ( V_2 -> V_14 , L_15 ,
V_109 ? V_109 : L_16 , V_2 -> V_97 ,
( V_2 -> V_9 >= 0 ) ? L_17 : L_18 ) ;
return 0 ;
V_114:
return V_32 ;
...
{
struct V_1 * V_2 = F_50 ( V_106 ) ;
F_51 ( & V_2 -> V_76 ) ;
return 0 ;
}
static int F_52 ( struct V_14 * V_2 )
{
struct V_1 * V_123 = F_53 ( V_2 ) ;
F_54 ( & V_123 -> V_76 ) ;
V_123 -> V_84 = true ;
F_55 ( & V_123 -> V_76 ) ;
return 0 ;
