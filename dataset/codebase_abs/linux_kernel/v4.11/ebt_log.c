...
F_9 ( V_13 ) -> V_41 , F_9 ( V_13 ) -> V_42 ,
F_5 ( F_9 ( V_13 ) -> V_43 ) ) ;
if ( V_33 -> type == V_44 )
V_6 = V_33 -> V_38 . log . V_45 ;
else
V_6 = V_46 ;
if ( ( V_6 & V_47 ) && F_9 ( V_13 ) -> V_43 ==
F_10 ( V_48 ) ) {
...
V_60 = V_50 -> V_60 ;
V_62 = F_12 ( V_13 , sizeof( V_51 ) , & V_60 , & V_61 ) ;
if ( V_62 == - 1 )
goto V_31;
F_2 ( V_13 , V_60 , V_62 ) ;
goto V_31;
...
#endif
if ( ( V_6 & V_64 ) &&
( ( F_9 ( V_13 ) -> V_43 == F_10 ( V_65 ) ) ||
( F_9 ( V_13 ) -> V_43 == F_10 ( V_66 ) ) ) ) {
...
F_4 ( L_12 ,
V_78 -> V_80 , V_78 -> V_81 , V_78 -> V_82 , V_78 -> V_83 ) ;
}
}
V_31:
F_4 ( L_13 ) ;
...
static unsigned int
F_14 ( struct V_12 * V_13 , const struct V_84 * V_2 )
{
...
if ( V_4 -> V_6 & V_86 )
F_16 ( V_26 , V_87 , F_17 ( V_2 ) , V_13 ,
F_18 ( V_2 ) , F_19 ( V_2 ) , & V_85 , L_14 ,
V_4 -> V_10 ) ;
else
F_6 ( V_26 , V_87 , F_17 ( V_2 ) , V_13 ,
F_18 ( V_2 ) , F_19 ( V_2 ) , & V_85 , V_4 -> V_10 ) ;
return V_88 ;
}
