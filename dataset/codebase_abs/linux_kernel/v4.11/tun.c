...
static void F_215 ( struct V_45 * V_46 )
{
struct V_1 * V_2 = F_41 ( V_46 ) ;
V_2 -> V_55 = V_262 ;
V_2 -> V_57 = V_263 ;
...
static int F_216 ( struct V_268 * V_269 [] , struct V_268 * V_30 [] )
{
return - V_8 ;
}
static void F_217 ( struct V_171 * V_64 )
{
struct V_37 * V_38 ;
T_14 * V_270 ;
if ( ! F_146 ( V_64 ) )
return;
if ( ! F_218 ( V_176 , & V_64 -> V_177 -> V_3 ) )
return;
V_270 = F_144 ( V_64 ) ;
if ( V_270 && F_219 ( V_270 ) )
F_220 ( V_270 , V_178 |
V_179 | V_271 ) ;
V_38 = F_221 ( V_64 , struct V_37 , V_64 ) ;
F_122 ( & V_38 -> V_120 , V_121 , V_272 ) ;
}
static int F_222 ( struct V_75 * V_171 , struct V_273 * V_274 , T_11 V_197 )
{
int V_247 ;
struct V_37 * V_38 = F_221 ( V_171 , struct V_37 , V_75 ) ;
struct V_1 * V_2 = F_89 ( V_38 ) ;
if ( ! V_2 )
return - V_232 ;
V_247 = F_165 ( V_2 , V_38 , V_274 -> V_192 , & V_274 -> V_275 ,
V_274 -> V_276 & V_277 ,
V_274 -> V_276 & V_278 ) ;
F_93 ( V_2 ) ;
return V_247 ;
}
static int F_223 ( struct V_75 * V_171 , struct V_273 * V_274 , T_11 V_197 ,
int V_3 )
{
struct V_37 * V_38 = F_221 ( V_171 , struct V_37 , V_75 ) ;
struct V_1 * V_2 = F_89 ( V_38 ) ;
...
if ( ! V_2 )
return - V_232 ;
if ( V_3 & ~ ( V_277 | V_279 | V_280 ) ) {
V_247 = - V_8 ;
goto V_85;
}
if ( V_3 & V_280 ) {
V_247 = F_224 ( V_171 -> V_64 , V_274 , V_197 ,
V_281 , V_282 ) ;
goto V_85;
}
V_247 = F_206 ( V_2 , V_38 , & V_274 -> V_275 , V_3 & V_277 ) ;
if ( V_247 > ( T_12 ) V_197 ) {
V_274 -> V_276 |= V_279 ;
V_247 = V_3 & V_279 ? V_247 : V_197 ;
}
V_85:
F_93 ( V_2 ) ;
return V_247 ;
}
static int F_225 ( struct V_75 * V_171 )
{
struct V_37 * V_38 = F_221 ( V_171 , struct V_37 , V_75 ) ;
struct V_1 * V_2 ;
int V_247 = 0 ;
...
if ( ! V_2 )
return 0 ;
V_247 = F_226 ( & V_38 -> V_63 ) ;
F_93 ( V_2 ) ;
return V_247 ;
}
static int F_227 ( struct V_1 * V_2 )
{
return V_2 -> V_3 & ( V_283 | V_71 | V_151 | V_161 ) ;
}
static T_12 F_228 ( struct V_284 * V_46 , struct V_285 * V_286 ,
char * V_287 )
{
struct V_1 * V_2 = F_41 ( F_229 ( V_46 ) ) ;
return sprintf ( V_287 , L_10 , F_227 ( V_2 ) ) ;
}
static T_12 F_230 ( struct V_284 * V_46 , struct V_285 * V_286 ,
char * V_287 )
{
struct V_1 * V_2 = F_41 ( F_229 ( V_46 ) ) ;
return F_49 ( V_2 -> V_55 ) ?
sprintf ( V_287 , L_11 ,
F_231 ( F_232 () , V_2 -> V_55 ) ) :
sprintf ( V_287 , L_12 ) ;
}
static T_12 F_233 ( struct V_284 * V_46 , struct V_285 * V_286 ,
char * V_287 )
{
struct V_1 * V_2 = F_41 ( F_229 ( V_46 ) ) ;
return F_51 ( V_2 -> V_57 ) ?
sprintf ( V_287 , L_11 ,
F_234 ( F_232 () , V_2 -> V_57 ) ) :
sprintf ( V_287 , L_12 ) ;
}
static int F_235 ( struct V_54 * V_54 , struct V_80 * V_80 , struct V_288 * V_289 )
{
struct V_1 * V_2 ;
struct V_37 * V_38 = V_80 -> V_82 ;
struct V_45 * V_46 ;
...
if ( V_38 -> V_41 )
return - V_8 ;
V_46 = F_236 ( V_54 , V_289 -> V_290 ) ;
if ( V_46 ) {
if ( V_289 -> V_291 & V_292 )
return - V_86 ;
if ( ( V_289 -> V_291 & V_151 ) && V_46 -> V_152 == & V_153 )
V_2 = F_41 ( V_46 ) ;
else if ( ( V_289 -> V_291 & V_161 ) && V_46 -> V_152 == & V_162 )
V_2 = F_41 ( V_46 ) ;
else
return - V_8 ;
if ( ! ! ( V_289 -> V_291 & V_87 ) !=
...
if ( V_83 < 0 )
return V_83 ;
V_83 = F_82 ( V_2 , V_80 , V_289 -> V_291 & V_294 ) ;
if ( V_83 < 0 )
return V_83 ;
if ( V_2 -> V_3 & V_87 &&
( V_2 -> V_40 + V_2 -> V_62 > 1 ) ) {
...
if ( V_83 < 0 )
return V_83 ;
if ( V_289 -> V_291 & V_151 ) {
V_3 |= V_151 ;
V_295 = L_13 ;
} else if ( V_289 -> V_291 & V_161 ) {
V_3 |= V_161 ;
V_295 = L_14 ;
} else
return - V_8 ;
if ( * V_289 -> V_290 )
V_295 = V_289 -> V_290 ;
V_46 = F_239 ( sizeof( struct V_1 ) , V_295 ,
V_297 , F_215 , V_296 ,
V_296 ) ;
if ( ! V_46 )
return - V_94 ;
...
V_2 -> V_132 = V_131 ;
V_2 -> V_90 = false ;
V_2 -> V_303 = V_38 -> V_75 . V_64 -> V_304 ;
V_2 -> V_189 = 0 ;
V_2 -> V_124 = F_241 ( struct V_137 ) ;
if ( ! V_2 -> V_124 ) {
V_83 = - V_94 ;
goto V_305;
}
...
V_129 | V_310 |
V_311 ;
V_46 -> V_127 = V_46 -> V_307 | V_312 ;
V_46 -> V_313 = V_46 -> V_127 &
~ ( V_310 |
V_311 ) ;
F_244 ( & V_2 -> V_61 ) ;
...
return - V_8 ;
V_2 -> V_128 = V_127 ;
V_2 -> V_46 -> V_326 &= ~ V_129 ;
V_2 -> V_46 -> V_326 |= V_127 ;
F_251 ( V_2 -> V_46 ) ;
return 0 ;
}
...
for ( V_25 = 0 ; V_25 < V_2 -> V_40 ; V_25 ++ ) {
V_38 = F_66 ( V_2 -> V_70 [ V_25 ] ) ;
V_38 -> V_75 . V_64 -> V_304 = V_2 -> V_303 ;
}
}
static int F_256 ( struct V_80 * V_80 , struct V_288 * V_289 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
struct V_1 * V_2 ;
int V_247 = 0 ;
F_76 () ;
if ( V_289 -> V_291 & V_327 ) {
V_2 = V_38 -> V_41 ;
if ( ! V_2 ) {
V_247 = - V_8 ;
goto V_42;
...
static long F_258 ( struct V_80 * V_80 , unsigned int V_329 ,
unsigned long V_100 , int V_330 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
struct V_1 * V_2 ;
...
int V_331 ;
int V_247 ;
if ( V_329 == V_332 || V_329 == V_333 || F_259 ( V_329 ) == V_334 ) {
if ( F_99 ( & V_289 , V_5 , V_330 ) )
return - V_7 ;
} else {
memset ( & V_289 , 0 , sizeof( V_289 ) ) ;
}
if ( V_329 == V_335 ) {
return F_4 ( V_151 | V_161 | V_283 ,
( unsigned int T_1 * ) V_5 ) ;
} else if ( V_329 == V_333 )
return F_256 ( V_80 , & V_289 ) ;
V_247 = 0 ;
F_76 () ;
V_2 = F_89 ( V_38 ) ;
if ( V_329 == V_332 ) {
...
if ( V_2 )
goto V_42;
V_289 . V_290 [ V_337 - 1 ] = '\0' ;
V_247 = F_235 ( F_260 ( & V_38 -> V_64 ) , V_80 , & V_289 ) ;
if ( V_247 )
goto V_42;
if ( F_261 ( V_5 , & V_289 , V_330 ) )
V_247 = - V_7 ;
goto V_42;
}
if ( V_329 == V_338 ) {
...
goto V_42;
V_247 = - V_7 ;
if ( F_99 ( & V_300 , V_5 , sizeof( V_300 ) ) )
goto V_42;
V_247 = 0 ;
V_38 -> V_300 = V_300 ;
goto V_42;
...
if ( ! V_2 )
goto V_42;
F_17 ( V_18 , V_2 , L_17 , V_329 ) ;
V_247 = 0 ;
switch ( V_329 ) {
case V_339 :
F_249 ( V_254 -> V_340 -> V_341 , V_2 , & V_289 ) ;
if ( V_38 -> V_41 )
V_289 . V_291 |= V_328 ;
if ( ! V_38 -> V_75 . V_64 -> V_118 )
V_289 . V_291 |= V_294 ;
...
V_2 -> V_55 = V_55 ;
F_17 ( V_18 , V_2 , L_22 ,
F_264 ( & V_345 , V_2 -> V_55 ) ) ;
break;
case V_346 :
V_57 = F_265 ( F_232 () , V_100 ) ;
if ( ! F_51 ( V_57 ) ) {
V_247 = - V_8 ;
break;
}
...
break;
case V_352 :
memcpy ( V_289 . V_353 . V_354 , V_2 -> V_46 -> V_355 , V_97 ) ;
V_289 . V_353 . V_356 = V_2 -> V_46 -> type ;
if ( F_261 ( V_5 , & V_289 , V_330 ) )
V_247 = - V_7 ;
break;
case V_357 :
F_17 ( V_358 , V_2 , L_26 ,
V_289 . V_353 . V_354 ) ;
V_247 = F_268 ( V_2 -> V_46 , & V_289 . V_353 ) ;
break;
case V_359 :
V_303 = V_38 -> V_75 . V_64 -> V_304 ;
if ( F_261 ( V_5 , & V_303 , sizeof( V_303 ) ) )
V_247 = - V_7 ;
break;
case V_360 :
if ( F_99 ( & V_303 , V_5 , sizeof( V_303 ) ) ) {
V_247 = - V_7 ;
break;
}
V_2 -> V_303 = V_303 ;
...
case V_363 :
V_331 = ! ! ( V_2 -> V_3 & V_9 ) ;
if ( F_4 ( V_331 , ( int T_1 * ) V_5 ) )
V_247 = - V_7 ;
break;
case V_364 :
if ( F_6 ( V_331 , ( int T_1 * ) V_5 ) ) {
V_247 = - V_7 ;
break;
}
if ( V_331 )
...
unsigned int V_329 , unsigned long V_100 )
{
return F_258 ( V_80 , V_329 , V_100 , sizeof ( struct V_288 ) ) ;
}
...
return F_258 ( V_80 , V_329 , V_100 , sizeof( struct V_371 ) ) ;
}
static int F_272 ( int V_372 , struct V_80 * V_80 , int V_373 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
int V_247 ;
if ( ( V_247 = F_273 ( V_372 , V_80 , V_373 , & V_38 -> V_120 ) ) < 0 )
goto V_85;
if ( V_373 ) {
F_274 ( V_80 , F_275 ( V_254 ) , V_374 , 0 ) ;
V_38 -> V_3 |= V_119 ;
} else
V_38 -> V_3 &= ~ V_119 ;
V_247 = 0 ;
...
static int F_276 ( struct V_375 * V_375 , struct V_80 * V_80 )
{
struct V_54 * V_54 = V_254 -> V_340 -> V_341 ;
struct V_37 * V_38 ;
F_277 ( V_18 , L_27 ) ;
V_38 = (struct V_37 * ) F_278 ( V_54 , V_376 , V_93 ,
& V_377 , 0 ) ;
if ( ! V_38 )
return - V_94 ;
F_69 ( V_38 -> V_2 , NULL ) ;
...
V_38 -> V_75 . V_80 = V_80 ;
V_38 -> V_75 . V_378 = & V_379 ;
F_280 ( & V_38 -> V_75 , & V_38 -> V_64 ) ;
V_38 -> V_64 . V_112 = F_217 ;
V_38 -> V_64 . V_304 = V_214 ;
V_80 -> V_82 = V_38 ;
F_244 ( & V_38 -> V_60 ) ;
F_281 ( & V_38 -> V_64 , V_380 ) ;
return 0 ;
}
static int F_282 ( struct V_375 * V_375 , struct V_80 * V_80 )
{
struct V_37 * V_38 = V_80 -> V_82 ;
F_75 ( V_38 , true ) ;
return 0 ;
}
static void F_283 ( struct V_381 * V_274 , struct V_80 * V_382 )
{
struct V_1 * V_2 ;
struct V_288 V_289 ;
memset ( & V_289 , 0 , sizeof( V_289 ) ) ;
...
if ( V_2 )
F_93 ( V_2 ) ;
F_284 ( V_274 , L_28 , V_289 . V_290 ) ;
}
static int F_285 ( struct V_45 * V_46 , struct V_383 * V_329 )
{
V_329 -> V_384 = 0 ;
V_329 -> V_385 = 0 ;
F_286 ( V_329 , V_386 ) ;
...
static void F_287 ( struct V_45 * V_46 , struct V_398 * V_399 )
{
struct V_1 * V_2 = F_41 ( V_46 ) ;
F_288 ( V_399 -> V_400 , V_401 , sizeof( V_399 -> V_400 ) ) ;
F_288 ( V_399 -> V_402 , V_403 , sizeof( V_399 -> V_402 ) ) ;
switch ( V_2 -> V_3 & V_150 ) {
case V_151 :
F_288 ( V_399 -> V_404 , L_29 , sizeof( V_399 -> V_404 ) ) ;
break;
case V_161 :
F_288 ( V_399 -> V_404 , L_30 , sizeof( V_399 -> V_404 ) ) ;
break;
}
}
...
static void F_290 ( struct V_45 * V_46 , T_4 V_406 )
{
#ifdef F_267
struct V_1 * V_2 = F_41 ( V_46 ) ;
V_2 -> V_349 = V_406 ;
...
int V_247 , V_25 ;
V_412 = F_16 ( sizeof *V_412 * V_29 , V_93 ) ;
if ( ! V_412 )
return - V_94 ;
for ( V_25 = 0 ; V_25 < V_2 -> V_40 ; V_25 ++ ) {
V_38 = F_66 ( V_2 -> V_70 [ V_25 ] ) ;
V_412 [ V_25 ] = & V_38 -> V_63 ;
}
F_79 (tfile, &tun->disabled, next)
V_412 [ V_25 ++ ] = & V_38 -> V_63 ;
V_247 = F_294 ( V_412 , V_29 ,
V_46 -> V_92 , V_93 ) ;
F_105 ( V_412 ) ;
return V_247 ;
}
static int F_295 ( struct V_413 * V_414 ,
unsigned long V_415 , void * V_416 )
{
struct V_45 * V_46 = F_296 ( V_416 ) ;
struct V_1 * V_2 = F_41 ( V_46 ) ;
if ( V_46 -> V_298 != & V_299 )
return V_417 ;
switch ( V_415 ) {
