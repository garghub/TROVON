...
static void
F_68 ( struct V_117 * V_118 )
{
struct V_8 * V_9 = F_40 ( V_118 , F_69 ( * V_9 ) , V_119 ) ;
int V_16 = F_70 ( V_9 -> V_120 ) ;
if ( V_16 == V_17 )
F_23 ( V_9 -> V_11 -> V_11 ) ;
F_29 () ;
if ( V_16 == V_17 )
F_27 ( V_9 -> V_11 ) ;
F_71 ( & V_9 -> V_6 -> V_10 , V_16 ) ;
if ( V_16 != V_17 )
F_26 ( V_9 -> V_11 ) ;
F_30 () ;
if ( V_16 == V_17 ) {
...
void
F_74 ( struct V_34 * V_11 , int V_16 )
{
struct V_8 * V_9 = V_8 ( V_11 ) ;
if ( ! V_9 -> V_6 )
return;
...
return 0 ;
V_6 = F_77 ( sizeof( struct V_5 ) , V_126 ) ;
if ( ! V_6 )
return - V_127 ;
V_9 -> V_6 = V_6 ;
F_78 ( & V_9 -> V_119 , F_68 ) ;
F_79 ( V_11 , & V_6 -> V_10 , & V_128 ) ;
V_15 = F_80 ( V_11 , & V_6 -> V_10 , 4 ) ;
if ( V_15 )
goto free;
V_15 = F_81 ( & V_6 -> V_10 ) ;
if ( V_15 )
