...
F_35 ( V_2 , V_46 -> V_31 [ 0 ] , V_46 -> V_59 -> V_60 ) ;
V_2 -> V_61 = V_62 | V_63 ;
V_2 -> V_64 = & V_65 ;
V_47 = F_36 ( V_21 ) - V_8 -> V_66 . V_67 ;
V_2 -> V_57 . V_68 = V_8 -> V_66 . V_69 + V_47 ;
V_2 -> V_57 . V_70 = F_34 ( V_21 ) ;
V_2 -> V_71 = V_21 -> V_56 ;
V_2 -> V_72 = F_34 ( V_21 ) ;
F_37 ( V_2 , & V_5 -> V_42 , V_44 -> V_73 , V_44 -> V_74 ) ;
V_2 -> V_75 -> V_76 [ 0 ] . V_55 = V_8 -> V_10 -> V_77 . V_78 ;
V_2 -> V_75 -> V_76 [ 0 ] . V_28 = V_8 -> V_66 . V_79 ;
if ( V_2 -> V_71 == NULL ) {
V_9 = - V_80 ;
goto V_54;
}
F_38 ( L_6 , V_2 -> V_57 . V_68 ) ;
F_38 ( L_7 , ( unsigned long ) V_8 -> V_66 . V_69 ) ;
F_38 ( L_8 , ( unsigned long ) F_34 ( V_21 ) ) ;
F_38 ( L_9 , V_46 -> V_59 -> V_60 ) ;
F_38 ( L_10 , V_46 -> V_31 [ 0 ] ) ;
F_39 ( V_8 -> V_10 -> V_81 , V_2 ) ;
return 0 ;
V_54:
F_40 ( V_42 ) ;
V_40:
...
{
if ( V_8 -> V_82 . V_5 )
F_45 ( & V_8 -> V_82 . V_5 -> V_42 ) ;
}
static int F_46 ( struct V_83 * V_11 , struct V_4 * V_5 )
{
struct V_84 * V_53 = & V_5 -> V_53 ;
F_47 ( & V_5 -> V_42 ) ;
F_40 ( & V_5 -> V_42 ) ;
if ( V_53 -> V_85 ) {
F_7 ( V_53 -> V_85 ) ;
...
T_2 V_90 , int V_91 )
{
struct V_92 * V_92 = F_50 ( V_87 ) ;
V_92 -> V_93 [ V_91 ] = V_88 >> 6 ;
V_92 -> V_94 [ V_91 ] = V_89 >> 6 ;
V_92 -> V_95 [ V_91 ] = V_90 >> 6 ;
}
static void F_51 ( struct V_86 * V_87 , T_2 * V_88 , T_2 * V_89 ,
T_2 * V_90 , int V_91 )
{
struct V_92 * V_92 = F_50 ( V_87 ) ;
...
if ( ! V_8 -> V_82 . V_97 )
return 0 ;
if ( F_53 ( & V_8 -> V_10 -> V_77 . V_98 ) )
return 0 ;
if ( V_8 -> V_66 . V_99 <= ( 32 * 1024 * 1024 ) )
V_96 = 8 ;
V_5 = F_54 ( sizeof( struct V_4 ) , V_100 ) ;
if ( ! V_5 )
return - V_37 ;
V_5 -> V_8 = V_8 ;
V_8 -> V_82 . V_5 = V_5 ;
...
if ( ! V_8 -> V_82 . V_5 )
return 0 ;
V_104 = F_8 ( V_8 -> V_82 . V_5 -> V_53 . V_85 ) ;
V_28 += F_34 ( V_104 ) ;
return V_28 ;
}
...
if ( ! V_8 -> V_82 . V_5 )
return false ;
if ( V_104 == F_8 ( V_8 -> V_82 . V_5 -> V_53 . V_85 ) )
return true ;
return false ;
}
void F_65 ( struct V_7 * V_8 )
{
struct V_4 * V_105 = V_8 -> V_82 . V_5 ;
struct V_41 * V_106 ;
int V_9 ;
if ( ! V_105 )
return;
