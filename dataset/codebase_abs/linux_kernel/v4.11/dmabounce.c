...
static T_3 F_31 ( struct V_1 * V_2 , struct V_46 * V_46 ,
unsigned long V_47 , T_2 V_18 , enum V_19 V_20 ,
unsigned long V_40 )
{
T_3 V_34 ;
int V_48 ;
F_3 ( V_2 , L_13 ,
V_24 , V_46 , V_47 , V_18 , V_20 ) ;
V_34 = F_32 ( V_2 , F_33 ( V_46 ) ) + V_47 ;
V_48 = F_24 ( V_2 , V_34 , V_18 ) ;
if ( V_48 < 0 )
return V_41 ;
if ( V_48 == 0 ) {
V_49 . V_50 ( V_2 , V_34 , V_18 , V_20 ) ;
return V_34 ;
}
if ( F_34 ( V_46 ) ) {
F_23 ( V_2 , L_14 ) ;
...
return F_25 ( V_2 , F_35 ( V_46 ) + V_47 , V_18 , V_20 , V_40 ) ;
}
static void F_36 ( struct V_1 * V_2 , T_3 V_34 , T_2 V_18 ,
enum V_19 V_20 , unsigned long V_40 )
{
struct V_16 * V_5 ;
F_3 ( V_2 , L_15 ,
V_24 , V_34 , V_18 , V_20 ) ;
...
if ( ! V_5 ) {
V_49 . V_51 ( V_2 , V_34 , V_18 , V_20 ) ;
return;
}
F_28 ( V_2 , V_5 , V_18 , V_20 , V_40 ) ;
}
static int F_37 ( struct V_1 * V_2 , T_3 V_52 ,
T_2 V_53 , enum V_19 V_20 )
{
struct V_16 * V_5 ;
unsigned long V_54 ;
F_3 ( V_2 , L_16 ,
V_24 , V_52 , V_53 , V_20 ) ;
V_5 = F_21 ( V_2 , V_52 , V_24 ) ;
if ( ! V_5 )
return 1 ;
V_54 = V_52 - V_5 -> V_28 ;
F_29 ( V_5 -> V_26 != V_20 ) ;
F_3 ( V_2 , L_17 ,
V_24 , V_5 -> V_17 , F_27 ( V_2 , V_5 -> V_17 ) , V_54 ,
V_5 -> V_27 , V_5 -> V_28 ) ;
F_26 ( V_2 -> V_8 . V_9 -> V_15 ++ ) ;
if ( V_20 == V_45 || V_20 == V_43 ) {
F_3 ( V_2 , L_12 ,
V_24 , V_5 -> V_27 + V_54 , V_5 -> V_17 + V_54 , V_53 ) ;
memcpy ( V_5 -> V_17 + V_54 , V_5 -> V_27 + V_54 , V_53 ) ;
}
return 0 ;
}
static void F_38 ( struct V_1 * V_2 ,
T_3 V_55 , T_2 V_18 , enum V_19 V_20 )
{
if ( ! F_37 ( V_2 , V_55 , V_18 , V_20 ) )
return;
V_49 . V_51 ( V_2 , V_55 , V_18 , V_20 ) ;
}
static int F_39 ( struct V_1 * V_2 , T_3 V_52 ,
T_2 V_53 , enum V_19 V_20 )
{
struct V_16 * V_5 ;
unsigned long V_54 ;
...
if ( V_20 == V_42 || V_20 == V_43 ) {
F_3 ( V_2 , L_18 ,
V_24 , V_5 -> V_17 + V_54 , V_5 -> V_27 + V_54 , V_53 ) ;
memcpy ( V_5 -> V_27 + V_54 , V_5 -> V_17 + V_54 , V_53 ) ;
}
return 0 ;
}
...
T_3 V_55 , T_2 V_18 , enum V_19 V_20 )
{
if ( ! F_39 ( V_2 , V_55 , V_18 , V_20 ) )
return;
V_49 . V_50 ( V_2 , V_55 , V_18 , V_20 ) ;
}
static int F_41 ( struct V_1 * V_2 , T_4 V_36 )
{
if ( V_2 -> V_8 . V_9 )
return 0 ;
return V_49 . V_56 ( V_2 , V_36 ) ;
}
static int F_42 ( struct V_21 * V_22 , struct V_1 * V_2 ,
const char * V_57 , unsigned long V_18 )
{
V_22 -> V_18 = V_18 ;
F_26 ( V_22 -> V_11 = 0 ) ;
V_22 -> V_22 = F_43 ( V_57 , V_2 , V_18 ,
0 ,
0 ) ;
return V_22 -> V_22 ? 0 : - V_58 ;
}
int F_44 ( struct V_1 * V_2 , unsigned long V_59 ,
unsigned long V_60 ,
