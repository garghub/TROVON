...
struct V_46 V_47 ;
int V_12 ;
V_45 = F_36 ( V_5 -> V_7 -> V_48 , L_15 , 0 ) ;
if ( ! V_45 ) {
F_7 ( V_5 -> V_7 , L_16 ) ;
return - V_49 ;
}
V_12 = F_37 ( V_45 , 0 , & V_47 ) ;
if ( V_12 )
return V_12 ;
V_5 -> V_10 = V_5 -> V_29 = V_47 . V_50 ;
V_5 -> V_11 = F_38 ( & V_47 ) ;
V_5 -> V_9 = F_39 ( V_5 -> V_7 , V_5 -> V_10 , V_5 -> V_11 ) ;
if ( ! V_5 -> V_9 ) {
F_7 ( V_5 -> V_7 , L_17 ,
& V_47 . V_50 , V_5 -> V_11 ) ;
return - V_51 ;
...
if ( ! F_42 () )
return - V_37 ;
V_1 = F_43 ( & V_40 -> V_7 , V_40 -> V_41 , & V_54 ,
...
if ( V_12 )
goto V_59;
V_12 = F_32 ( V_5 , V_40 , L_19 , F_17 ) ;
if ( V_12 < 0 )
goto V_59;
V_5 -> V_60 = V_12 ;
V_12 = F_32 ( V_5 , V_40 , L_20 , F_19 ) ;
if ( V_12 < 0 )
goto V_59;
V_5 -> V_61 = V_12 ;
V_12 = F_32 ( V_5 , V_40 , L_21 , F_22 ) ;
if ( V_12 < 0 )
goto V_59;
V_5 -> V_62 = V_12 ;
V_12 = F_32 ( V_5 , V_40 , L_22 , F_23 ) ;
if ( V_12 < 0 )
goto V_59;
V_5 -> V_63 = V_12 ;
V_12 = F_32 ( V_5 , V_40 , L_23 , F_25 ) ;
if ( V_12 < 0 )
goto V_59;
V_5 -> V_64 = V_12 ;
V_5 -> V_23 = F_46 ( & V_40 -> V_7 , L_24 ,
& V_5 -> V_24 ) ;
if ( F_21 ( V_5 -> V_23 ) ) {
V_12 = F_28 ( V_5 -> V_23 ) ;
goto V_59;
...
{
struct V_4 * V_5 = F_51 ( V_40 ) ;
F_52 ( V_5 -> V_23 ) ;
F_53 ( V_5 -> V_1 ) ;
F_54 ( V_5 -> V_1 , & V_5 -> V_65 ) ;
F_49 ( V_5 -> V_1 ) ;
return 0 ;
}
