...
{
struct V_274 * V_275 = F_163 ( V_186 -> V_14 . V_7 ) ;
struct V_276 * V_277 = F_164 ( V_275 ) ;
struct V_1 * V_2 ;
const char * V_278 ;
T_2 V_32 ;
int V_3 ;
...
if ( V_74 & ( V_54 | V_284 ) )
V_2 -> V_7 -> V_126 = 1 ;
if ( ! ( V_2 -> V_7 -> V_126 && F_160 () ) ) {
V_3 = F_85 ( V_2 ) ;
if ( V_3 )
goto V_285;
}
V_278 = F_166 ( V_286 ) ;
if ( V_278 && ! strcmp ( V_278 , L_56 ) )
F_167 ( V_232 ) ;
if ( V_2 -> V_7 -> V_84 -> V_287 )
F_167 ( V_232 ) ;
if ( V_2 -> V_7 -> V_84 -> V_288 )
F_167 ( V_289 ) ;
...
if ( V_277 -> V_291 && ! F_175 ( V_277 -> V_291 ) ) {
F_51 ( L_59 ) ;
return - V_42 ;
}
if ( V_277 -> V_295 ) {
V_114 = V_277 -> V_295 ( V_186 ) ;
if ( V_114 )
return V_114 ;
}
return F_162 ( V_186 ) ;
}
int T_9 F_176 ( struct V_276 * V_7 )
{
struct V_274 * V_274 ;
struct V_16 * V_16 ;
if ( V_296 )
...
V_274 = & V_7 -> V_274 ;
V_274 -> remove = F_170 ;
V_274 -> V_7 . V_297 = V_7 -> V_297 ;
V_274 -> V_7 . V_6 = V_7 -> V_6 ;
V_274 -> V_7 . V_298 = & V_299 ;
V_16 = F_177 ( V_274 ,
F_174 ,
NULL , 0 , NULL , 0 ) ;
if ( F_115 ( V_16 ) )
