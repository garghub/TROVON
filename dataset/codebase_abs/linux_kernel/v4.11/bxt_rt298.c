...
static int F_25 ( struct V_56 * V_11 )
{
...
int V_57 , V_58 = 0 ;
char V_59 [ V_60 ] ;
F_26 (pcm, &ctx->hdmi_pcm_list, head) {
V_9 = V_22 -> V_20 -> V_9 ;
...
if ( ! V_9 )
return - V_63 ;
return F_28 ( V_9 , & V_11 -> V_4 ) ;
}
static int F_29 ( struct V_64 * V_65 )
{
struct V_16 * V_17 ;
V_17 = F_10 ( & V_65 -> V_23 , sizeof( * V_17 ) , V_66 ) ;
if ( ! V_17 )
return - V_25 ;
F_30 ( & V_17 -> V_30 ) ;
V_67 . V_23 = & V_65 -> V_23 ;
F_31 ( & V_67 , V_17 ) ;
return F_32 ( & V_65 -> V_23 , & V_67 ) ;
}
