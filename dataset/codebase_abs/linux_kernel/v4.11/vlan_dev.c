...
V_140 | V_141 |
V_142 ;
V_4 -> V_143 |= V_27 -> V_144 | V_145 |
V_139 ;
V_4 -> V_146 = V_27 -> V_146 ;
V_4 -> V_147 = V_27 -> V_147 ;
if ( V_4 -> V_143 & V_148 )
F_71 ( V_27 , L_1 ) ;
V_4 -> V_144 = V_27 -> V_144 & ~ V_142 ;
...
struct V_3 * V_27 = V_8 ( V_4 ) -> V_27 ;
T_5 V_164 = V_143 ;
V_143 = F_81 ( V_143 , V_27 -> V_144 ) ;
V_143 |= V_165 ;
V_143 = F_81 ( V_143 , V_27 -> V_143 ) ;
V_143 |= V_164 & ( V_166 | V_139 ) ;
V_143 |= V_145 ;
return V_143 ;
}
...
struct V_168 * V_169 )
{
F_85 ( V_169 -> V_170 , V_171 , sizeof( V_169 -> V_170 ) ) ;
F_85 ( V_169 -> V_172 , V_173 , sizeof( V_169 -> V_172 ) ) ;
F_85 ( V_169 -> V_174 , L_2 , sizeof( V_169 -> V_174 ) ) ;
}
static int F_86 ( struct V_3 * V_4 ,
struct V_175 * V_169 )
{
const struct V_8 * V_9 = V_8 ( V_4 ) ;
const struct V_176 * V_91 = V_9 -> V_27 -> V_176 ;
if ( V_91 -> V_177 ) {
return V_91 -> V_177 ( V_9 -> V_27 , V_169 ) ;
} else {
V_169 -> V_178 = V_179 |
V_180 ;
V_169 -> V_181 = - 1 ;
...
int V_163 ;
F_88 (i) {
T_4 V_184 , V_185 , V_186 , V_187 , V_188 ;
unsigned int V_189 ;
V_82 = F_89 ( V_8 ( V_4 ) -> V_37 , V_163 ) ;
do {
V_189 = F_90 ( & V_82 -> V_39 ) ;
V_184 = V_82 -> V_190 ;
V_185 = V_82 -> V_191 ;
V_186 = V_82 -> V_192 ;
V_187 = V_82 -> V_40 ;
V_188 = V_82 -> V_41 ;
} while ( F_91 ( & V_82 -> V_39 , V_189 ) );
V_38 -> V_190 += V_184 ;
V_38 -> V_191 += V_185 ;
V_38 -> V_193 += V_186 ;
V_38 -> V_40 += V_187 ;
...
static int F_93 ( struct V_3 * V_4 , struct V_194 * V_195 )
{
struct V_8 * V_9 = V_8 ( V_4 ) ;
struct V_3 * V_27 = V_9 -> V_27 ;
struct V_28 * V_28 ;
