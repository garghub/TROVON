...
static int F_10 ( struct V_13 * V_14 , unsigned int V_15 )
{
...
static int T_2 F_11 ( struct V_13 * V_14 )
{
unsigned int V_3 = V_14 -> V_3 ;
unsigned long V_5 = F_4 ( V_3 ) / 1000 ;
struct V_18 * V_19 =
...
struct V_40 * V_41 ;
V_1 = - V_42 ;
V_41 = F_15 ( sizeof( * V_41 ) , V_43 ) ;
if ( ! V_41 )
goto V_44;
V_20 = F_15 ( ( V_45 * sizeof( * V_20 ) ) ,
V_43 ) ;
if ( ! V_20 )
goto V_44;
V_41 -> V_46 = F_11 ;
