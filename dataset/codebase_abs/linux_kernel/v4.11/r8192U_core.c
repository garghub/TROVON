...
int V_188 ;
unsigned long V_157 ;
struct V_189 * V_190 = (struct V_189 * ) ( V_141 -> V_148 + V_191 ) ;
T_1 V_111 = V_190 -> V_111 ;
F_92 ( V_111 != V_192 ) ;
F_93 ( & V_7 -> V_193 , V_157 ) ;
* (struct V_35 * * ) ( V_141 -> V_148 ) = V_36 ;
V_190 -> V_194 = 1 ;
F_94 ( V_141 , V_7 -> V_12 -> V_195 ) ;
V_188 = F_95 ( V_36 , V_141 ) ;
F_96 ( & V_7 -> V_193 , V_157 ) ;
}
...
static void F_99 ( struct V_138 * V_197 )
{
struct V_140 * V_141 = (struct V_140 * ) V_197 -> V_178 ;
struct V_35 * V_36 ;
struct V_6 * V_7 = NULL ;
struct V_189 * V_190 ;
T_1 V_111 ;
...
V_190 = (struct V_189 * ) ( V_141 -> V_148 + V_191 ) ;
V_111 = V_190 -> V_111 ;
V_7 = F_19 ( V_36 ) ;
...
( ! ( V_7 -> V_12 -> V_206 ) ) ) {
V_141 = F_103 ( & ( V_7 -> V_12 -> V_205 [ V_111 ] ) ) ;
if ( V_141 )
...
static void F_104 ( struct V_35 * V_36 , T_3 * V_208 )
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
struct V_58 * V_209 ;
T_1 V_1 = 0 , V_210 = 0 ;
...
static void F_105 ( struct V_35 * V_36 , T_3 V_240 )
{
T_2 V_241 = 0 ;
struct V_6 * V_7 = F_19 ( V_36 ) ;
...
void F_107 ( struct V_35 * V_36 , T_3 V_270 )
{
}
...
V_271 = 0x04 ;
F_67 ( V_197 , V_7 -> V_45 ,
F_110 ( V_7 -> V_45 , V_271 ) ,
V_141 -> V_40 , V_141 -> V_202 , F_99 , V_141 ) ;
V_43 = F_71 ( V_197 , V_185 ) ;
if ( ! V_43 )
return 0 ;
F_111 ( L_51 , V_43 ) ;
return - 1 ;
}
static T_1 F_112 ( T_1 V_282 )
{
T_1 V_283 = 0x0 ;
switch ( V_282 ) {
case V_284 :
...
static T_1 F_114 ( T_1 V_343 , T_1 V_344 , struct V_189 * V_190 )
{
T_1 V_345 ;
V_345 = ( V_343 == 1 ) ?
( ( V_190 -> V_346 ) ? 1 : 0 ) :
...
static void F_115 ( struct V_138 * V_197 )
{
}
...
struct V_6 * V_7 = F_19 ( V_36 ) ;
struct V_189 * V_190 = (struct V_189 * ) ( V_141 -> V_148 + V_191 ) ;
T_5 * V_348 = ( T_5 * ) V_141 -> V_40 ;
T_6 * V_349 =
( T_6 * ) ( V_141 -> V_40 + V_196 ) ;
struct V_44 * V_45 = V_7 -> V_45 ;
int V_350 ;
int V_43 ;
...
memset ( V_349 , 0 , sizeof( T_6 ) ) ;
V_349 -> V_343 = ( V_190 -> V_352 & 0x80 ) ? 1 : 0 ;
V_349 -> V_344 = F_113 ( V_190 -> V_352 ) ;
V_349 -> V_353 = V_190 -> V_194 ;
V_349 -> Short = F_114 ( V_349 -> V_343 , V_349 -> V_344 ,
V_190 ) ;
if ( V_190 -> V_354 ) {
V_349 -> V_355 = 1 ;
...
V_349 -> V_368 = F_113 ( ( T_1 ) V_190 -> V_367 ) ;
...
memset ( V_348 , 0 , sizeof( T_5 ) ) ;
V_348 -> V_280 = 0 ;
V_348 -> V_275 = 1 ;
V_348 -> V_382 = sizeof( T_6 ) + 8 ;
...
V_348 -> V_283 = F_112 ( V_190 -> V_111 ) ;
V_348 -> V_397 = sizeof( T_6 ) ;
...
V_271 = 0x5 ;
F_67 ( V_197 , V_45 ,
F_110 ( V_45 , V_271 ) , V_141 -> V_40 ,
V_141 -> V_202 , F_99 , V_141 ) ;
V_43 = F_71 ( V_197 , V_185 ) ;
if ( ! V_43 ) {
bool V_402 = false ;
T_1 V_403 = 0 ;
...
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
V_7 -> V_406 = F_118 ( sizeof( struct V_138 * ) * ( V_145 + 1 ) ,
V_47 ) ;
if ( ! V_7 -> V_406 )
return - V_48 ;
#ifndef F_119
...
V_7 -> V_406 [ 16 ] -> V_184 = V_410 ;
}
#endif
memset ( V_7 -> V_406 , 0 , sizeof( struct V_138 * ) * V_145 ) ;
V_7 -> V_411 = F_121 ( V_145 , sizeof( struct V_140 * ) ,
V_47 ) ;
if ( ! V_7 -> V_411 ) {
F_23 ( V_7 -> V_406 ) ;
V_7 -> V_411 = NULL ;
...
static void F_126 ( struct V_414 * V_415 )
{
struct V_6 * V_7 = F_127 ( V_415 , struct V_6 ,
V_416 . V_415 ) ;
...
V_426 <<= V_437 ;
V_428 = ( T_2 ) F_131 ( V_423 -> V_438 [ V_1 ] ) ;
V_428 <<= V_439 ;
V_429 = ( T_2 ) F_131 ( V_423 -> V_429 [ V_1 ] ) ;
V_429 <<= V_440 ;
V_430 = ( T_2 ) F_131 ( V_423 -> V_430 [ V_1 ] ) ;
V_430 <<= V_441 ;
...
( 0 == strcmp ( V_475 -> V_480 -> V_106 , L_62 ) ) ) ;
if ( V_476 && ( V_61 == 0 ) ) {
return false ;
} else if ( ( V_61 != 0 ) ) {
...
static void F_142 ( struct V_35 * V_36 , T_1 V_494 )
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
T_1 V_495 = F_141 ( V_36 ) ;
if ( V_494 == V_496 ||
( V_494 & V_495 ) == 0 ) {
if ( V_495 & V_485 ) {
V_494 = V_485 ;
...
V_7 -> V_12 -> V_549 = F_137 ;
V_7 -> V_12 -> V_550 = F_134 ;
V_7 -> V_12 -> V_551 = F_138 ;
V_7 -> V_12 -> V_552 =
F_139 ;
V_7 -> V_12 -> V_553 = F_142 ;
...
F_146 ( & V_7 -> V_12 -> V_205 [ V_1 ] ) ;
for ( V_1 = 0 ; V_1 < V_577 ; V_1 ++ )
F_146 ( & V_7 -> V_12 -> V_578 [ V_1 ] ) ;
for ( V_1 = 0 ; V_1 < V_577 ; V_1 ++ )
F_146 ( & V_7 -> V_12 -> V_579 [ V_1 ] ) ;
V_7 -> V_132 = V_580 ;
}
...
V_602 = true ;
if ( V_602 ) {
V_603 = F_157 ( V_36 , V_605 >> 1 ) ;
V_188 = F_157 ( V_36 , V_605 >> 1 ) ;
if ( V_188 < 0 )
return V_188 ;
V_603 = ( T_3 ) V_188 ;
V_7 -> V_606 = F_155 ( & V_603 ) ;
V_188 = F_157 ( V_36 , V_607 >> 1 ) ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_608 = ( T_3 ) V_188 ;
V_188 = F_157 ( V_36 , V_609 >> 1 ) ;
if ( V_188 < 0 )
return V_188 ;
V_603 = ( T_3 ) V_188 ;
V_7 -> V_610 = ( V_603 & 0xff00 ) >> 8 ;
V_7 -> V_611 = true ;
V_188 = F_157 ( V_36 , ( V_612 >> 1 ) ) >> 8 ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_613 = ( T_3 ) V_188 ;
} else {
...
V_188 = F_157 ( V_36 , ( T_3 ) ( ( V_616 + V_1 ) >> 1 ) ) ;
if ( V_188 < 0 )
return V_188 ;
* ( T_3 * ) ( & V_36 -> V_617 [ V_1 ] ) = ( T_3 ) V_188 ;
}
} else {
memcpy ( V_36 -> V_617 , V_601 , 6 ) ;
}
F_9 ( V_594 , L_71 , V_36 -> V_617 ) ;
V_7 -> V_467 = V_618 ;
V_7 -> V_24 = V_26 ;
if ( V_7 -> V_614 == ( T_1 ) V_619 ) {
if ( V_602 ) {
V_188 = F_157 ( V_36 , ( V_620 >> 1 ) ) ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_621 = ( ( T_3 ) V_188 & 0xff00 ) >> 8 ;
} else
V_7 -> V_621 = V_622 ;
F_9 ( V_594 , L_72 , V_7 -> V_621 ) ;
if ( V_602 ) {
V_188 = F_157 ( V_36 , ( V_623 >> 1 ) ) ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_624 = ( T_1 ) ( ( T_3 ) V_188 & 0x00ff ) ;
} else
V_7 -> V_624 = V_625 ;
F_9 ( V_594 , L_73 , V_7 -> V_624 ) ;
V_7 -> V_626 = V_7 -> V_624 * 100 ;
if ( V_602 ) {
V_188 = F_157 ( V_36 , ( V_627 >> 1 ) ) ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_628 = ( ( T_3 ) V_188 & 0x0f00 ) >> 8 ;
} else
V_7 -> V_628 = V_629 ;
F_9 ( V_594 , L_74 , V_7 -> V_628 ) ;
if ( V_602 ) {
V_188 = F_157 ( V_36 , ( V_630 >> 1 ) ) ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_631 = ( T_3 ) V_188 & 0x0f ;
} else
V_7 -> V_631 = V_632 ;
F_9 ( V_594 , L_75 , V_7 -> V_631 ) ;
if ( V_602 ) {
V_188 = F_157 ( V_36 , ( V_633 >> 1 ) ) ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_634 = ( ( T_3 ) V_188 & 0xff00 ) >> 8 ;
} else
V_7 -> V_634 = 1 ;
F_9 ( V_594 , L_76 , V_7 -> V_634 ) ;
if ( V_7 -> V_634 == 0 ) {
int V_1 ;
if ( V_602 ) {
V_188 = F_157 ( V_36 , ( V_635 >> 1 ) ) ;
if ( V_188 < 0 )
return V_188 ;
V_7 -> V_636 = ( ( T_3 ) V_188 & 0xff ) >> 8 ;
} else
V_7 -> V_636 = 0x10 ;
F_9 ( V_594 , L_77 , V_7 -> V_636 ) ;
for ( V_1 = 0 ; V_1 < 3 ; V_1 ++ ) {
if ( V_602 ) {
V_188 = F_157 ( V_36 , ( V_637 + V_1 ) >> 1 ) ;
if ( V_188 < 0 )
return V_188 ;
if ( ( ( V_637 + V_1 ) % 2 ) == 0 )
V_603 = ( T_3 ) V_188 & 0x00ff ;
else
V_603 = ( ( T_3 ) V_188 & 0xff00 ) >> 8 ;
} else {
V_603 = 0x10 ;
}
V_7 -> V_638 [ V_1 ] = ( T_1 ) V_603 ;
F_9 ( V_594 , L_78 , V_1 , V_7 -> V_636 ) ;
}
} else if ( V_7 -> V_634 == 1 ) {
if ( V_602 ) {
V_188 = F_157 ( V_36 , V_639 >> 1 ) ;
if ( V_188 < 0 )
return V_188 ;
V_603 = ( ( T_3 ) V_188 & 0xff00 ) >> 8 ;
} else {
...
V_7 -> V_680 = V_681 ;
F_177 ( V_36 ) ;
F_178 ( V_36 , V_733 , V_734 , 0x1 ) ;
F_178 ( V_36 , V_733 , V_735 , 0x1 ) ;
if ( V_7 -> V_517 == V_518 ) {
T_1 V_736 ;
...
static struct V_758 * F_181 ( struct V_35 * V_36 )
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
...
static T_7 F_183 ( struct V_35 * V_36 )
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
T_1 V_282 ;
bool V_763 = false ;
...
static T_7 F_185 ( struct V_35 * V_36 )
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
bool V_774 = false ;
if ( V_7 -> V_516 > 1 )
...
static T_7 F_186 ( struct V_35 * V_36 )
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
T_7 V_775 = V_518 ;
T_7 V_776 = V_518 ;
...
V_780 = V_781 [ V_779 ] ;
F_188 ( V_36 , V_779 , V_779 ,
V_7 -> V_12 -> V_391 ,
V_780 , 0 , NULL ) ;
}
} else if ( V_7 -> V_12 -> V_391 == V_394 ) {
if ( V_7 -> V_12 -> V_120 == V_124 )
F_188 ( V_36 , 4 , 0 , V_7 -> V_12 -> V_391 ,
...
static void F_202 ( struct V_6 * V_7 , T_2 * V_798 ,
T_2 * V_799 )
{
T_3 V_800 ;
T_1 V_1 ;
...
{
struct V_806 * V_807 = F_203 ( V_415 ) ;
struct V_6 * V_7 = F_127 ( V_807 ,
struct V_6 , V_584 ) ;
struct V_35 * V_36 = V_7 -> V_12 -> V_36 ;
struct V_10 * V_11 = V_7 -> V_12 ;
T_7 V_808 = V_518 ;
...
static int F_222 ( struct V_35 * V_36 , void * V_819 )
{
struct V_6 * V_7 = F_19 ( V_36 ) ;
struct V_820 * V_39 = V_819 ;
F_130 ( & V_7 -> V_582 ) ;
F_223 ( V_36 -> V_617 , V_39 -> V_821 ) ;
F_57 ( & V_7 -> V_114 ) ;
F_132 ( & V_7 -> V_582 ) ;
return 0 ;
}
static int F_224 ( struct V_35 * V_36 , struct V_822 * V_823 , int V_173 )
{
struct V_6 * V_7 = (struct V_6 * ) F_19 ( V_36 ) ;
...
V_832 = F_225 ( V_829 -> V_834 , V_829 -> V_833 ) ;
if ( F_226 ( V_832 ) ) {
V_188 = F_227 ( V_832 ) ;
goto V_836;
}
...
if ( strcmp ( V_832 -> V_830 . V_475 . V_840 , L_122 ) == 0 ) {
V_11 -> V_391 = V_395 ;
} else if ( strcmp ( V_832 -> V_830 . V_475 . V_840 , L_123 ) == 0 ) {
V_11 -> V_391 = V_394 ;
} else if ( strcmp ( V_832 -> V_830 . V_475 . V_840 , L_62 ) == 0 ) {
...
F_125 ( V_36 ) ;
F_188 ( V_36 , 4 , V_832 -> V_830 . V_475 . V_842 ,
V_11 -> V_391 ,
( T_1 * ) V_11 -> V_843 ,
0 , V_826 ) ;
if ( V_11 -> V_844 != 2 )
F_188 ( V_36 , V_832 -> V_830 . V_475 . V_842 ,
...
static T_1 F_229 ( bool V_846 , T_1 V_187 )
{
T_1 V_847 = 0xff ;
if ( ! V_846 ) {
switch ( V_187 ) {
...
static void F_232 ( struct V_6 * V_7 , T_1 * V_856 ,
struct V_133 * V_857 ,
struct V_133 * V_858 )
{
bool V_859 = false ;
...
V_7 -> V_67 . V_883 = F_231 ( ( T_1 ) V_862 ) ;
...
static inline bool F_239 ( struct V_913 * V_914 )
{
if ( V_914 -> V_915 )
return false ;
switch ( V_914 -> V_916 ) {
...
V_134 -> V_882 =
V_917 -> V_882 =
( T_1 ) ( F_238 ( ( long ) V_933 ) ) ;
} else {
if ( V_937 != 0 ) {
V_134 -> V_882 =
V_917 -> V_882 =
( T_1 ) ( F_238 ( ( long ) ( V_935 /= V_937 ) ) ) ;
}
}
}
static void F_241 (
...
V_959 = F_131 ( V_873 -> V_962 ) ;
type = F_243 ( V_959 ) ;
V_961 = V_873 -> V_963 ;
V_918 = ( V_964 != type ) &&
( F_244 ( V_7 -> V_12 -> V_211 . V_260 , ( V_959 & V_965 ) ? V_873 -> V_963 : ( V_959 & V_966 ) ? V_873 -> V_967 : V_873 -> V_968 ) )
&& ( ! V_134 -> V_969 ) && ( ! V_134 -> V_970 ) && ( ! V_134 -> V_971 ) ;
V_919 = V_918 &
( F_244 ( V_961 , V_7 -> V_12 -> V_36 -> V_617 ) ) ;
if ( F_245 ( V_959 ) == V_972 )
V_897 = true ;
if ( F_245 ( V_959 ) == V_973 ) {
if ( ( F_244 ( V_961 , V_36 -> V_617 ) ) )
V_886 = true ;
}
if ( V_918 )
V_7 -> V_67 . V_974 ++ ;
if ( V_919 )
V_7 -> V_67 . V_975 ++ ;
F_232 ( V_7 , V_960 , & V_958 , V_134 ) ;
F_240 ( V_7 , V_134 , V_914 , & V_958 ,
V_918 , V_919 ,
V_897 , V_886 ) ;
F_241 ( V_134 , & V_958 ) ;
}
...
F_250 ( V_141 , V_141 -> V_202 - 4 ) ;
V_1001 = V_141 -> V_202 ;
V_1003 = (struct V_1002 * ) V_141 -> V_40 ;
V_1004 = false ;
if ( F_251 ( V_1003 -> V_963 ) ) {
} else if ( F_252 ( V_1003 -> V_963 ) ) {
} else {
V_1004 = true ;
}
...
static int F_262 ( struct V_1020 * V_1021 ,
const struct V_1022 * V_1023 )
{
struct V_35 * V_36 = NULL ;
struct V_6 * V_7 = NULL ;
struct V_44 * V_45 = F_263 ( V_1021 ) ;
int V_188 ;
F_9 ( V_95 , L_133 ) ;
...
static void F_271 ( struct V_1020 * V_1021 )
{
struct V_35 * V_36 = F_272 ( V_1021 ) ;
struct V_6 * V_7 = F_19 ( V_36 ) ;
if ( V_36 ) {
F_273 ( V_36 ) ;
F_9 ( V_817 ,
...
F_282 ( L_149 ) ;
F_9 ( V_95 , L_150 ) ;
F_9 ( V_95 , L_151 , V_1034 ) ;
F_43 () ;
return F_283 ( & V_1035 ) ;
}
static void T_14 F_284 ( void )
{
F_285 ( & V_1035 ) ;
F_9 ( V_817 , L_152 ) ;
}
...
V_11 -> V_1038 = 1 ;
if ( ( V_11 -> V_251 -> V_1039 & V_1040 ) || ! V_1041 ) {
V_11 -> V_1038 = 0 ;
V_679 &= ~ V_716 ;
}
F_9 ( V_783 , L_153 ,
V_28 , V_11 -> V_1038 , V_11 -> V_391 ,
V_679 ) ;
F_27 ( V_36 , V_718 , V_679 ) ;
}
void F_188 ( struct V_35 * V_36 , T_1 V_1042 , T_1 V_1043 , T_3 V_1044 ,
T_1 * V_780 , T_1 V_1045 , T_2 * V_1046 )
{
T_2 V_1047 = 0 ;
T_2 V_1048 = 0 ;
T_3 V_1049 = 0 ;
...
F_9 ( V_783 ,
L_155 ,
V_36 , V_1042 , V_1043 , V_1044 , V_780 ) ;
if ( V_1045 )
V_1049 |= F_13 ( 15 ) | ( V_1044 << 2 ) ;
else
V_1049 |= F_13 ( 15 ) | ( V_1044 << 2 ) | V_1043 ;
for ( V_1 = 0 ; V_1 < V_1051 ; V_1 ++ ) {
V_1047 = V_1 + V_1051 * V_1042 ;
V_1047 |= F_13 ( 31 ) | F_13 ( 16 ) ;
if ( V_1 == 0 ) {
V_1048 = ( T_2 ) ( * ( V_780 + 0 ) ) << 16 |
( T_2 ) ( * ( V_780 + 1 ) ) << 24 |
( T_2 ) V_1049 ;
F_14 ( V_36 , V_41 , V_1048 ) ;
F_14 ( V_36 , V_38 , V_1047 ) ;
} else if ( V_1 == 1 ) {
V_1048 = ( T_2 ) ( * ( V_780 + 2 ) ) |
( T_2 ) ( * ( V_780 + 3 ) ) << 8 |
( T_2 ) ( * ( V_780 + 4 ) ) << 16 |
