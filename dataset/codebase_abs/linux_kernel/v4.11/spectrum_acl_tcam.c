...
struct V_26 * V_27 )
{
struct V_101 * V_101 = & V_27 -> V_102 . V_101 ;
struct V_103 * V_103 = & V_27 -> V_102 . V_103 ;
struct V_90 * V_91 ;
int V_9 ;
F_71 ( V_27 -> V_104 , V_101 ,
V_105 ) ;
V_9 = F_72 ( V_27 -> V_104 , V_101 , V_103 ) ;
if ( V_9 )
goto V_106;
V_91 = F_73 ( V_1 -> V_107 ) ;
if ( F_74 ( V_91 ) ) {
...
struct V_101 * V_101 = & V_27 -> V_102 . V_101 ;
struct V_103 * V_103 = & V_27 -> V_102 . V_103 ;
struct V_90 * V_91 = V_27 -> V_102 . V_91 ;
F_69 ( V_1 , V_27 ,
V_103 -> V_110 ) ;
F_78 ( V_91 ) ;
F_79 ( V_27 -> V_104 , V_101 , V_103 ) ;
...
F_82 ( struct V_1 * V_1 ,
struct V_26 * V_27 ,
T_3 V_112 , T_3 V_113 , T_3 V_114 )
{
char V_115 [ V_116 ] ;
F_83 ( V_115 , V_117 ,
V_27 -> V_80 , V_112 ,
V_27 -> V_80 , V_113 , V_114 ) ;
F_19 ( V_1 -> V_10 , F_20 ( V_118 ) , V_115 ) ;
}
static int F_84 ( void * V_2 ,
unsigned long V_119 )
{
struct V_26 * V_27 = V_2 ;
struct V_1 * V_1 = V_27 -> V_1 ;
T_1 V_120 ;
V_120 = F_2 ( V_1 -> V_10 , V_121 ) ;
if ( V_119 > V_120 )
return - V_46 ;
return F_58 ( V_1 , V_27 , V_119 ) ;
}
static void F_85 ( void * V_2 ,
unsigned long V_122 ,
unsigned long V_123 ,
unsigned long V_124 )
{
...
struct V_63 * V_64 )
{
struct V_125 * V_126 = F_87 ( V_1 -> V_107 ) ;
struct V_26 * V_27 ;
int V_9 ;
...
F_22 ( & V_27 -> V_56 ) ;
V_27 -> V_1 = V_1 ;
V_27 -> V_104 = F_89 ( & V_127 ,
V_27 ) ;
if ( ! V_27 -> V_104 ) {
V_9 = - V_15 ;
goto V_128;
}
V_27 -> V_68 = F_90 ( V_126 , V_64 ) ;
if ( F_74 ( V_27 -> V_68 ) ) {
V_9 = F_75 ( V_27 -> V_68 ) ;
goto V_129;
}
...
V_55 -> V_25 = V_25 ;
V_55 -> V_139 = 1 ;
V_9 = F_94 ( V_1 , V_25 , V_58 ,
V_64 , V_55 ) ;
if ( V_9 )
goto V_140;
F_71 ( V_55 -> V_27 -> V_104 , & V_55 -> V_101 , V_58 ) ;
V_9 = F_97 ( & V_25 -> V_37 , & V_55 -> V_141 ,
V_38 ) ;
if ( V_9 )
goto V_142;
return V_55 ;
...
struct V_26 * V_27 ;
int V_9 ;
V_55 = F_100 ( V_1 , V_25 , V_91 -> V_58 ,
& V_91 -> V_98 . V_64 ) ;
if ( F_74 ( V_55 ) )
return F_75 ( V_55 ) ;
V_27 = V_55 -> V_27 ;
V_9 = F_72 ( V_27 -> V_104 , & V_55 -> V_101 ,
& V_144 -> V_103 ) ;
if ( V_9 )
goto V_106;
V_9 = F_62 ( V_1 , V_27 ,
...
struct V_3 * V_4 = V_2 ;
return F_21 ( V_1 , V_4 , & V_147 -> V_25 ,
V_148 ,
V_149 ) ;
}
static void
...
void * V_145 , void * V_150 ,
struct V_90 * V_91 )
{
struct V_146 * V_147 = V_145 ;
struct V_151 * V_152 = V_150 ;
return F_103 ( V_1 , & V_147 -> V_25 ,
& V_152 -> V_144 , V_91 ) ;
}
static void
F_110 ( struct V_1 * V_1 , void * V_150 )
{
struct V_151 * V_152 = V_150 ;
F_104 ( V_1 , & V_152 -> V_144 ) ;
}
