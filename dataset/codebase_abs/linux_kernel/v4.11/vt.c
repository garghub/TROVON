...
{
V_5 -> V_60 = F_25 ( V_5 , V_5 -> V_61 , V_5 -> V_62 ,
V_5 -> V_63 , V_5 -> V_64 ,
V_5 -> V_65 ^ V_5 -> V_66 , V_5 -> V_67 ) ;
V_5 -> V_36 = ( F_25 ( V_5 , V_5 -> V_61 , 1 , V_5 -> V_63 , 0 , V_5 -> V_66 , 0 ) << 8 ) | ' ' ;
}
...
{
static int V_70 = - 1 ;
static unsigned short V_71 ;
static unsigned short V_72 , V_73 ;
F_22 () ;
if ( V_70 != - 1 && V_70 >= 0 &&
V_70 < V_5 -> V_74 ) {
F_28 ( V_71 , F_11 ( V_5 , V_70 , 1 ) ) ;
if ( F_9 ( V_5 ) )
V_5 -> V_19 -> V_75 ( V_5 , V_71 , V_73 , V_72 ) ;
F_7 ( V_5 ) ;
}
V_70 = V_15 ;
if ( V_15 != - 1 && V_15 >= 0 &&
...
F_28 ( V_76 , V_17 ) ;
if ( F_9 ( V_5 ) ) {
V_72 = ( V_15 >> 1 ) % V_5 -> V_35 ;
V_73 = ( V_15 >> 1 ) / V_5 -> V_35 ;
V_5 -> V_19 -> V_75 ( V_5 , V_76 , V_73 , V_72 ) ;
}
F_7 ( V_5 ) ;
}
}
...
{
unsigned short * V_17 = ( unsigned short * ) V_5 -> V_78 ;
F_17 ( V_17 + V_28 , V_17 , ( V_5 -> V_35 - V_5 -> V_79 - V_28 ) * 2 ) ;
...
{
unsigned short * V_17 = ( unsigned short * ) V_5 -> V_78 ;
F_32 ( V_17 , V_17 + V_28 , ( V_5 -> V_35 - V_5 -> V_79 - V_28 ) * 2 ) ;
F_18 ( V_17 + V_5 -> V_35 - V_5 -> V_79 - V_28 , V_5 -> V_36 ,
V_28 * 2 ) ;
V_5 -> V_80 = 0 ;
if ( F_9 ( V_5 ) )
F_19 ( V_5 , ( unsigned long ) V_17 ,
...
F_28 ( V_81 , ( T_1 * ) V_5 -> V_78 ) ;
if ( F_9 ( V_5 ) )
V_5 -> V_19 -> V_75 ( V_5 , V_81 , V_5 -> V_84 , V_5 -> V_79 ) ;
}
static void F_34 ( struct V_4 * V_5 )
{
if ( V_83 != - 1 ) {
F_28 ( V_83 , ( T_1 * ) V_5 -> V_78 ) ;
if ( F_9 ( V_5 ) )
V_5 -> V_19 -> V_75 ( V_5 , V_83 ,
V_5 -> V_84 , V_5 -> V_79 ) ;
V_83 = - 1 ;
}
}
...
if ( V_5 == V_85 )
F_35 () ;
V_5 -> V_19 -> V_86 ( V_5 , V_87 ) ;
F_34 ( V_5 ) ;
}
static void F_24 ( struct V_4 * V_5 )
{
if ( ! F_8 ( V_5 ) || V_14 || V_5 -> V_88 == V_89 )
return;
if ( V_5 -> V_90 ) {
if ( V_5 == V_85 )
F_35 () ;
...
! V_5 -> V_19 -> V_92 ||
! V_5 -> V_19 -> V_92 ( V_5 ) )
V_5 -> V_18 = ( unsigned long ) V_5 -> V_93 ;
V_5 -> V_21 = V_5 -> V_18 ;
V_5 -> V_94 = V_5 -> V_18 + V_5 -> V_74 ;
V_5 -> V_78 = V_5 -> V_18 + V_5 -> V_33 * V_5 -> V_84 + 2 * V_5 -> V_79 ;
}
...
int V_38 = V_5 -> V_74 / 2 ;
int V_97 = V_5 -> V_59 | 0xff ;
for (; V_38 > 0 ; V_38 -- , V_17 ++ ) {
F_28 ( ( F_20 ( V_17 ) & V_97 ) | ( V_5 -> V_36 & ~ V_97 ) , V_17 ) ;
}
}
void F_40 ( struct V_4 * V_5 , int V_98 )
{
int V_99 = 0 ;
F_22 () ;
if ( ! V_5 ) {
...
if ( V_98 ) {
struct V_4 * V_100 = V_101 [ V_13 ] . V_30 ;
if ( V_100 == V_5 )
return;
if ( ! F_10 ( V_5 ) )
V_99 = 1 ;
...
if ( ( V_105 && V_5 -> V_88 != V_89 ) ||
F_43 ( V_5 ) )
F_19 ( V_5 , V_5 -> V_18 , V_5 -> V_74 / 2 ) ;
}
F_24 ( V_5 ) ;
if ( V_98 ) {
F_44 () ;
...
int F_46 ( unsigned int V_81 )
{
return ( V_81 < V_108 && V_101 [ V_81 ] . V_30 ) ;
}
...
if ( ! V_5 -> V_77 )
V_5 -> V_77 = V_5 -> V_56 ? 0x7700 : 0x0800 ;
V_5 -> V_121 = V_5 -> V_77 ;
V_5 -> V_33 = V_5 -> V_35 << 1 ;
V_5 -> V_74 = V_5 -> V_32 * V_5 -> V_33 ;
}
...
if ( ! V_5 )
return - V_125 ;
V_101 [ V_122 ] . V_30 = V_5 ;
F_54 ( & V_5 -> V_126 ) ;
F_55 ( & V_101 [ V_122 ] . V_127 , V_128 ) ;
F_47 ( V_5 , V_122 , 1 ) ;
if ( ! * V_5 -> V_115 )
F_56 ( V_5 ) ;
V_5 -> V_93 = F_57 ( V_5 -> V_74 , V_124 ) ;
if ( ! V_5 -> V_93 )
goto V_129;
if ( V_130 == - 1 )
V_130 = 1 ;
...
{
int V_135 = 0 ;
if ( V_5 -> V_88 != V_89 && V_5 -> V_19 -> V_136 )
...
return - V_156 ;
V_148 = ( V_139 ? V_139 : V_5 -> V_35 ) ;
V_149 = ( V_22 ? V_22 : V_5 -> V_32 ) ;
V_150 = V_148 << 1 ;
V_151 = V_150 * V_149 ;
if ( V_148 == V_5 -> V_35 && V_149 == V_5 -> V_32 )
return 0 ;
if ( V_151 > ( 4 << 20 ) )
return - V_156 ;
...
V_142 = V_141 + V_151 ;
if ( V_5 -> V_84 > V_149 ) {
if ( V_146 - V_5 -> V_84 < V_149 ) {
V_140 += ( V_146 - V_149 ) * V_147 ;
} else {
V_140 += ( V_5 -> V_84 - V_149 / 2 ) * V_147 ;
}
}
...
if ( V_144 )
F_18 ( ( void * ) ( V_141 + V_143 ) ,
V_5 -> V_36 , V_144 ) ;
V_140 += V_147 ;
V_141 += V_150 ;
}
if ( V_142 > V_141 )
F_18 ( ( void * ) V_141 , V_5 -> V_36 ,
V_142 - V_141 ) ;
F_60 ( V_5 -> V_93 ) ;
V_5 -> V_93 = V_152 ;
V_5 -> V_74 = V_151 ;
...
V_5 -> V_158 = 0 ;
V_5 -> V_159 = V_5 -> V_32 ;
F_64 ( V_5 , V_5 -> V_79 , V_5 -> V_84 ) ;
F_65 ( V_5 ) ;
if ( V_138 ) {
struct V_160 V_161 ;
memset ( & V_161 , 0 , sizeof( V_161 ) ) ;
V_161 . V_162 = V_5 -> V_32 ;
V_161 . V_163 = V_5 -> V_35 ;
V_161 . V_164 = V_5 -> V_165 ;
F_66 ( V_138 , & V_161 ) ;
}
if ( F_10 ( V_5 ) )
F_67 ( V_5 ) ;
F_68 ( V_166 , V_5 -> V_12 , V_5 -> V_12 ) ;
return V_135 ;
}
...
V_5 -> V_84 = V_174 ;
V_5 -> V_78 = V_5 -> V_18 + V_5 -> V_84 * V_5 -> V_33 + ( V_5 -> V_79 << 1 ) ;
V_5 -> V_80 = 0 ;
}
...
{
if ( V_5 -> V_84 + 1 == V_5 -> V_159 )
F_15 ( V_5 , V_5 -> V_158 , V_5 -> V_159 , V_34 , 1 ) ;
else if ( V_5 -> V_84 < V_5 -> V_32 - 1 ) {
V_5 -> V_84 ++ ;
V_5 -> V_78 += V_5 -> V_33 ;
}
V_5 -> V_80 = 0 ;
...
{
if ( V_5 -> V_84 == V_5 -> V_158 )
F_15 ( V_5 , V_5 -> V_158 , V_5 -> V_159 , V_178 , 1 ) ;
else if ( V_5 -> V_84 > 0 ) {
V_5 -> V_84 -- ;
V_5 -> V_78 -= V_5 -> V_33 ;
}
...
static void F_84 ( struct V_4 * V_5 , int V_179 )
{
unsigned int V_38 ;
unsigned short * V_37 ;
switch ( V_179 ) {
case 0 :
V_38 = ( V_5 -> V_94 - V_5 -> V_78 ) >> 1 ;
V_37 = ( unsigned short * ) V_5 -> V_78 ;
break;
case 1 :
V_38 = ( ( V_5 -> V_78 - V_5 -> V_18 ) >> 1 ) + 1 ;
V_37 = ( unsigned short * ) V_5 -> V_18 ;
break;
case 3 :
F_18 ( V_5 -> V_93 , V_5 -> V_36 ,
V_5 -> V_74 ) ;
F_38 ( V_5 ) ;
F_36 ( V_5 ) ;
if ( F_10 ( V_5 ) )
...
switch ( V_179 ) {
case 0 :
V_38 = V_5 -> V_35 - V_5 -> V_79 ;
V_37 = ( unsigned short * ) V_5 -> V_78 ;
break;
case 1 :
V_37 = ( unsigned short * ) ( V_5 -> V_78 - ( V_5 -> V_79 << 1 ) ) ;
V_38 = V_5 -> V_79 + 1 ;
break;
case 2 :
V_37 = ( unsigned short * ) ( V_5 -> V_78 - ( V_5 -> V_79 << 1 ) ) ;
...
if ( ! V_179 )
V_179 ++ ;
V_38 = ( V_179 > V_5 -> V_35 - V_5 -> V_79 ) ? ( V_5 -> V_35 - V_5 -> V_79 ) : V_179 ;
F_18 ( ( unsigned short * ) V_5 -> V_78 , V_5 -> V_36 , 2 * V_38 ) ;
if ( F_9 ( V_5 ) )
V_5 -> V_19 -> V_180 ( V_5 , V_5 -> V_84 , V_5 -> V_79 , 1 , V_38 ) ;
V_5 -> V_80 = 0 ;
}
...
static void F_88 ( int V_81 , struct V_182 * V_9 )
{
if ( V_81 < 8 ) {
V_9 -> V_183 = V_81 & 1 ? 0xaa : 0x00 ;
V_9 -> V_184 = V_81 & 2 ? 0xaa : 0x00 ;
V_9 -> V_26 = V_81 & 4 ? 0xaa : 0x00 ;
} else if ( V_81 < 16 ) {
V_9 -> V_183 = V_81 & 1 ? 0xff : 0x55 ;
V_9 -> V_184 = V_81 & 2 ? 0xff : 0x55 ;
V_9 -> V_26 = V_81 & 4 ? 0xff : 0x55 ;
} else if ( V_81 < 232 ) {
V_9 -> V_183 = ( V_81 - 16 ) / 36 * 85 / 2 ;
V_9 -> V_184 = ( V_81 - 16 ) / 6 % 6 * 85 / 2 ;
V_9 -> V_26 = ( V_81 - 16 ) % 6 * 85 / 2 ;
} else
V_9 -> V_183 = V_9 -> V_184 = V_9 -> V_26 = V_81 * 10 - 2312 ;
}
static void F_89 ( struct V_4 * V_5 , const struct V_182 * V_9 )
{
T_2 V_185 = 0 , V_186 = F_90 ( V_9 -> V_183 , V_9 -> V_184 , V_9 -> V_26 ) ;
if ( V_9 -> V_183 > V_186 / 2 )
V_185 |= 4 ;
if ( V_9 -> V_184 > V_186 / 2 )
V_185 |= 2 ;
if ( V_9 -> V_26 > V_186 / 2 )
V_185 |= 1 ;
if ( V_185 == 7 && V_186 <= 0x55 ) {
V_185 = 0 ;
V_5 -> V_62 = 2 ;
} else if ( V_186 > 0xaa )
V_5 -> V_62 = 2 ;
...
V_5 -> V_62 = 1 ;
V_5 -> V_61 = ( V_5 -> V_61 & 0xf0 ) | V_185 ;
}
static void F_91 ( struct V_4 * V_5 , const struct V_182 * V_9 )
{
V_5 -> V_61 = ( V_5 -> V_61 & 0x0f )
| ( V_9 -> V_183 & 0x80 ) >> 1 | ( V_9 -> V_184 & 0x80 ) >> 2 | ( V_9 -> V_26 & 0x80 ) >> 3 ;
}
static int F_92 ( struct V_4 * V_5 , int V_81 ,
void (* F_93)( struct V_4 * V_5 , const struct V_182 * V_9 ) )
{
struct V_182 V_9 ;
V_81 ++ ;
if ( V_81 > V_5 -> V_187 )
return V_81 ;
if ( V_5 -> V_188 [ V_81 ] == 5 && V_81 + 1 <= V_5 -> V_187 ) {
V_81 ++ ;
F_88 ( V_5 -> V_188 [ V_81 ] , & V_9 ) ;
} else if ( V_5 -> V_188 [ V_81 ] == 2 && V_81 + 3 <= V_5 -> V_187 ) {
V_9 . V_183 = V_5 -> V_188 [ V_81 + 1 ] ;
V_9 . V_184 = V_5 -> V_188 [ V_81 + 2 ] ;
V_9 . V_26 = V_5 -> V_188 [ V_81 + 3 ] ;
V_81 += 3 ;
} else
return V_81 ;
F_93 ( V_5 , & V_9 ) ;
...
{
int V_81 ;
for ( V_81 = 0 ; V_81 <= V_5 -> V_187 ; V_81 ++ )
switch ( V_5 -> V_188 [ V_81 ] ) {
case 0 :
F_87 ( V_5 ) ;
break;
case 1 :
...
break;
case 38 :
V_81 = F_92 ( V_5 , V_81 , F_89 ) ;
break;
case 48 :
V_81 = F_92 ( V_5 , V_81 , F_91 ) ;
break;
case 39 :
V_5 -> V_61 = ( V_5 -> V_181 & 0x0f ) |
( V_5 -> V_61 & 0xf0 ) ;
break;
case 49 :
V_5 -> V_61 = ( V_5 -> V_181 & 0xf0 ) |
( V_5 -> V_61 & 0x0f ) ;
break;
default:
if ( V_5 -> V_188 [ V_81 ] >= 90 && V_5 -> V_188 [ V_81 ] <= 107 ) {
if ( V_5 -> V_188 [ V_81 ] < 100 )
V_5 -> V_62 = 2 ;
V_5 -> V_188 [ V_81 ] -= 60 ;
}
if ( V_5 -> V_188 [ V_81 ] >= 30 && V_5 -> V_188 [ V_81 ] <= 37 )
V_5 -> V_61 = V_196 [ V_5 -> V_188 [ V_81 ] - 30 ]
| ( V_5 -> V_61 & 0xf0 ) ;
else if ( V_5 -> V_188 [ V_81 ] >= 40 && V_5 -> V_188 [ V_81 ] <= 47 )
V_5 -> V_61 = ( V_196 [ V_5 -> V_188 [ V_81 ] - 40 ] << 4 )
| ( V_5 -> V_61 & 0x0f ) ;
break;
}
F_26 ( V_5 ) ;
}
static void F_96 ( const char * V_17 , struct V_197 * V_126 )
{
while ( * V_17 ) {
F_97 ( V_126 , * V_17 , 0 ) ;
V_17 ++ ;
...
static void F_99 ( struct V_4 * V_5 , struct V_137 * V_138 )
{
char V_198 [ 40 ] ;
sprintf ( V_198 , L_2 , V_5 -> V_84 + ( V_5 -> V_177 ? V_5 -> V_158 + 1 : 1 ) , V_5 -> V_79 + 1 ) ;
F_96 ( V_198 , V_138 -> V_126 ) ;
}
static inline void F_100 ( struct V_137 * V_138 )
{
F_96 ( L_3 , V_138 -> V_126 ) ;
}
static inline void F_101 ( struct V_137 * V_138 )
{
F_96 ( V_199 , V_138 -> V_126 ) ;
}
void F_102 ( struct V_137 * V_138 , int V_200 , int V_201 , int V_202 )
{
char V_198 [ 8 ] ;
sprintf ( V_198 , L_4 , ( char ) ( ' ' + V_200 ) , ( char ) ( '!' + V_201 ) ,
( char ) ( '!' + V_202 ) ) ;
F_96 ( V_198 , V_138 -> V_126 ) ;
}
int F_103 ( void )
{
return V_101 [ V_13 ] . V_30 -> V_203 ;
}
static void F_104 ( struct V_4 * V_5 , int V_204 )
{
int V_81 ;
for ( V_81 = 0 ; V_81 <= V_5 -> V_187 ; V_81 ++ )
if ( V_5 -> V_205 ) {
...
break;
case 9 :
V_212 = ( ( V_5 -> V_188 [ 1 ] < 60 ) ? V_5 -> V_188 [ 1 ] : 60 ) * 60 ;
F_108 () ;
break;
case 10 :
if ( V_5 -> V_187 >= 1 )
V_5 -> V_213 = V_5 -> V_188 [ 1 ] ;
else
V_5 -> V_213 = V_214 ;
break;
case 11 :
if ( V_5 -> V_187 >= 1 )
V_5 -> V_215 = ( V_5 -> V_188 [ 1 ] < 2000 ) ?
F_109 ( V_5 -> V_188 [ 1 ] ) : 0 ;
else
V_5 -> V_215 = V_216 ;
break;
case 12 :
if ( V_5 -> V_188 [ 1 ] >= 1 && F_46 ( V_5 -> V_188 [ 1 ] - 1 ) )
F_110 ( V_5 -> V_188 [ 1 ] - 1 ) ;
break;
case 13 :
F_108 () ;
break;
case 14 :
V_217 = ( ( V_5 -> V_188 [ 1 ] < 60 ) ? V_5 -> V_188 [ 1 ] : 60 ) * 60 * V_218 ;
break;
case 15 :
F_110 ( V_219 ) ;
break;
case 16 :
if ( V_5 -> V_187 >= 1 && V_5 -> V_188 [ 1 ] >= 50 &&
V_5 -> V_188 [ 1 ] <= V_220 )
V_5 -> V_118 = V_5 -> V_188 [ 1 ] ;
else
V_5 -> V_118 = V_119 ;
break;
}
...
{
if ( V_28 > V_5 -> V_35 - V_5 -> V_79 )
V_28 = V_5 -> V_35 - V_5 -> V_79 ;
else if ( ! V_28 )
V_28 = 1 ;
F_30 ( V_5 , V_28 ) ;
}
...
{
if ( V_28 > V_5 -> V_32 - V_5 -> V_84 )
V_28 = V_5 -> V_32 - V_5 -> V_84 ;
else if ( ! V_28 )
V_28 = 1 ;
F_15 ( V_5 , V_5 -> V_84 , V_5 -> V_159 , V_178 , V_28 ) ;
V_5 -> V_80 = 0 ;
}
...
V_28 = 1 ;
F_15 ( V_5 , V_5 -> V_84 , V_5 -> V_159 , V_34 , V_28 ) ;
V_5 -> V_80 = 0 ;
}
...
V_5 -> V_191 = V_5 -> V_230 ;
V_5 -> V_192 = V_5 -> V_231 ;
V_5 -> V_189 = F_95 ( V_5 -> V_190 ? V_5 -> V_192 : V_5 -> V_191 , V_5 ) ;
F_26 ( V_5 ) ;
V_5 -> V_80 = 0 ;
}
...
static void F_118 ( struct V_137 * V_138 , struct V_4 * V_5 , int V_9 )
{
...
case 9 :
V_5 -> V_78 -= ( V_5 -> V_79 << 1 ) ;
while ( V_5 -> V_79 < V_5 -> V_35 - 1 ) {
V_5 -> V_79 ++ ;
if ( V_5 -> V_241 [ V_5 -> V_79 >> 5 ] & ( 1 << ( V_5 -> V_79 & 31 ) ) )
break;
}
V_5 -> V_78 += ( V_5 -> V_79 << 1 ) ;
F_5 ( V_5 , '\t' ) ;
...
case 14 :
V_5 -> V_190 = 1 ;
V_5 -> V_189 = F_95 ( V_5 -> V_192 , V_5 ) ;
V_5 -> V_193 = 1 ;
return;
case 15 :
V_5 -> V_190 = 0 ;
V_5 -> V_189 = F_95 ( V_5 -> V_191 , V_5 ) ;
V_5 -> V_193 = 0 ;
return;
case 24 : case 26 :
V_5 -> V_233 = V_234 ;
...
return;
case 'H' :
V_5 -> V_241 [ V_5 -> V_79 >> 5 ] |= ( 1 << ( V_5 -> V_79 & 31 ) ) ;
return;
case 'Z' :
F_101 ( V_138 ) ;
return;
...
case V_245 :
if ( V_9 == 'P' ) {
for ( V_5 -> V_187 = 0 ; V_5 -> V_187 < V_251 ; V_5 -> V_187 ++ )
V_5 -> V_188 [ V_5 -> V_187 ] = 0 ;
V_5 -> V_187 = 0 ;
V_5 -> V_233 = V_252 ;
return;
} else if ( V_9 == 'R' ) {
...
case V_252 :
if ( isxdigit ( V_9 ) ) {
V_5 -> V_188 [ V_5 -> V_187 ++ ] = F_122 ( V_9 ) ;
if ( V_5 -> V_187 == 7 ) {
int V_81 = V_5 -> V_188 [ 0 ] * 3 , V_253 = 1 ;
V_5 -> V_254 [ V_81 ] = 16 * V_5 -> V_188 [ V_253 ++ ] ;
V_5 -> V_254 [ V_81 ++ ] += V_5 -> V_188 [ V_253 ++ ] ;
V_5 -> V_254 [ V_81 ] = 16 * V_5 -> V_188 [ V_253 ++ ] ;
V_5 -> V_254 [ V_81 ++ ] += V_5 -> V_188 [ V_253 ++ ] ;
V_5 -> V_254 [ V_81 ] = 16 * V_5 -> V_188 [ V_253 ++ ] ;
V_5 -> V_254 [ V_81 ] += V_5 -> V_188 [ V_253 ] ;
...
return;
case V_255 :
if ( V_9 == ';' && V_5 -> V_187 < V_251 - 1 ) {
V_5 -> V_187 ++ ;
return;
} else if ( V_9 >= '0' && V_9 <= '9' ) {
V_5 -> V_188 [ V_5 -> V_187 ] *= 10 ;
V_5 -> V_188 [ V_5 -> V_187 ] += V_9 - '0' ;
return;
}
V_5 -> V_233 = V_234 ;
switch( V_9 ) {
...
if ( V_5 -> V_205 ) {
if ( V_5 -> V_188 [ 0 ] )
V_5 -> V_82 = V_5 -> V_188 [ 0 ] | ( V_5 -> V_188 [ 1 ] << 8 ) | ( V_5 -> V_188 [ 2 ] << 16 ) ;
else
V_5 -> V_82 = V_240 ;
return;
}
...
F_35 () ;
if ( V_5 -> V_188 [ 0 ] )
V_5 -> V_77 = V_5 -> V_188 [ 0 ] << 8 | V_5 -> V_188 [ 1 ] ;
else
V_5 -> V_77 = V_5 -> V_121 ;
return;
}
...
if ( V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] -- ;
F_64 ( V_5 , V_5 -> V_188 [ 0 ] , V_5 -> V_84 ) ;
return;
case 'A' :
if ( ! V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] ++ ;
F_64 ( V_5 , V_5 -> V_79 , V_5 -> V_84 - V_5 -> V_188 [ 0 ] ) ;
return;
case 'B' : case 'e' :
if ( ! V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] ++ ;
...
if ( ! V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] ++ ;
F_64 ( V_5 , V_5 -> V_79 + V_5 -> V_188 [ 0 ] , V_5 -> V_84 ) ;
return;
case 'D' :
if ( ! V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] ++ ;
...
if ( ! V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] ++ ;
F_64 ( V_5 , 0 , V_5 -> V_84 + V_5 -> V_188 [ 0 ] ) ;
return;
case 'F' :
if ( ! V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] ++ ;
...
if ( V_5 -> V_188 [ 1 ] )
V_5 -> V_188 [ 1 ] -- ;
F_76 ( V_5 , V_5 -> V_188 [ 1 ] , V_5 -> V_188 [ 0 ] ) ;
return;
case 'J' :
F_84 ( V_5 , V_5 -> V_188 [ 0 ] ) ;
return;
case 'K' :
F_85 ( V_5 , V_5 -> V_188 [ 0 ] ) ;
return;
case 'L' :
F_112 ( V_5 , V_5 -> V_188 [ 0 ] ) ;
return;
case 'M' :
F_114 ( V_5 , V_5 -> V_188 [ 0 ] ) ;
return;
case 'P' :
F_113 ( V_5 , V_5 -> V_188 [ 0 ] ) ;
return;
case 'c' :
if ( ! V_5 -> V_188 [ 0 ] )
F_101 ( V_138 ) ;
...
if ( V_5 -> V_188 [ 0 ] < 4 )
F_123 ( V_5 -> V_12 ,
( V_5 -> V_188 [ 0 ] < 3 ) ? V_5 -> V_188 [ 0 ] : 4 ) ;
return;
case 'r' :
if ( ! V_5 -> V_188 [ 0 ] )
V_5 -> V_188 [ 0 ] ++ ;
if ( ! V_5 -> V_188 [ 1 ] )
V_5 -> V_188 [ 1 ] = V_5 -> V_32 ;
if ( V_5 -> V_188 [ 0 ] < V_5 -> V_188 [ 1 ] &&
V_5 -> V_188 [ 1 ] <= V_5 -> V_32 ) {
V_5 -> V_158 = V_5 -> V_188 [ 0 ] - 1 ;
V_5 -> V_159 = V_5 -> V_188 [ 1 ] ;
F_76 ( V_5 , 0 , 0 ) ;
}
return;
case 's' :
...
return;
case 'X' :
F_86 ( V_5 , V_5 -> V_188 [ 0 ] ) ;
return;
case '@' :
F_111 ( V_5 , V_5 -> V_188 [ 0 ] ) ;
return;
case ']' :
F_107 ( V_5 ) ;
return;
...
static int F_124 ( T_4 V_258 , const struct V_259 * V_260 , int V_186 )
{
int F_63 = 0 ;
int V_261 ;
if ( V_258 < V_260 [ 0 ] . V_262 || V_258 > V_260 [ V_186 ] . V_263 )
return 0 ;
while ( V_186 >= F_63 ) {
V_261 = ( F_63 + V_186 ) / 2 ;
...
( T_1 * ) V_266 - ( T_1 * ) V_265 , V_5 -> V_84 , * V_267 ) ;
* V_267 = - 1 ;
}
static int F_128 ( struct V_137 * V_138 , const unsigned char * V_198 , int V_38 )
{
...
if ( ( ! ( V_5 -> V_237 && ! V_5 -> V_193 ) || V_9 < 128 ) && ! ( V_9 & ~ V_274 ) ) {
V_268 = V_9 ;
} else {
...
V_60 = ( ( V_5 -> V_60 ) & 0x11 ) | ( ( ( V_5 -> V_60 ) & 0xe0 ) >> 4 ) | ( ( ( V_5 -> V_60 ) & 0x0e ) << 4 ) ;
} else {
V_60 = ( ( V_5 -> V_60 ) & 0x88 ) | ( ( ( V_5 -> V_60 ) & 0x70 ) >> 4 ) | ( ( ( V_5 -> V_60 ) & 0x07 ) << 4 ) ;
}
F_127 ( V_5 , V_265 , V_266 , & V_267 ) ;
}
while ( 1 ) {
if ( V_5 -> V_80 || V_5 -> V_209 )
...
F_30 ( V_5 , 1 ) ;
F_28 ( V_273 ?
( ( V_60 << 8 ) & ~ V_273 ) + ( ( V_268 & 0x100 ) ? V_273 : 0 ) + ( V_268 & 0xff ) :
( V_60 << 8 ) + V_268 ,
( T_1 * ) V_5 -> V_78 ) ;
if ( F_9 ( V_5 ) && V_267 < 0 ) {
V_267 = V_5 -> V_79 ;
...
if ( V_287 != V_13 &&
F_46 ( V_287 ) ) {
F_23 ( V_101 [ V_13 ] . V_30 ) ;
F_136 ( V_101 [ V_287 ] . V_30 ) ;
}
V_287 = - 1 ;
}
if ( V_288 ) {
...
if ( V_23 ) {
struct V_4 * V_5 = V_101 [ V_13 ] . V_30 ;
F_35 () ;
if ( V_5 -> V_88 == V_289 && V_5 -> V_19 -> V_290 )
...
struct V_4 * V_5 = V_101 [ V_13 ] . V_30 ;
if ( ! F_46 ( V_28 ) || V_292 ||
( V_5 -> V_293 . V_294 == V_295 && V_5 -> V_88 == V_89 ) ) {
return - V_156 ;
}
V_287 = V_28 ;
F_13 () ;
...
V_5 = V_101 [ V_301 - 1 ] . V_30 ;
V_300 = V_5 -> V_79 ;
if ( ! F_46 ( V_13 ) ) {
goto V_303;
}
if ( V_5 -> V_88 != V_289 && ! F_43 ( V_5 ) )
goto V_303;
if ( F_8 ( V_5 ) )
F_23 ( V_5 ) ;
V_37 = ( T_6 * ) V_5 -> V_78 ;
while ( V_38 -- ) {
V_9 = * V_26 ++ ;
if ( V_9 == 10 || V_9 == 13 || V_9 == 8 || V_5 -> V_80 ) {
if ( V_69 > 0 ) {
if ( F_10 ( V_5 ) )
V_5 -> V_19 -> V_47 ( V_5 , V_37 , V_69 , V_5 -> V_84 , V_5 -> V_79 ) ;
V_5 -> V_79 += V_69 ;
if ( V_5 -> V_80 )
V_5 -> V_79 -- ;
V_69 = 0 ;
...
F_28 ( ( V_5 -> V_60 << 8 ) + V_9 , ( unsigned short * ) V_5 -> V_78 ) ;
F_5 ( V_5 , V_9 ) ;
V_69 ++ ;
if ( V_300 == V_5 -> V_35 - 1 ) {
V_5 -> V_80 = 1 ;
...
int F_146 ( struct V_137 * V_138 , unsigned long V_307 )
{
char type , V_308 ;
char T_7 * V_17 = ( char T_7 * ) V_307 ;
int V_22 ;
int V_169 ;
if ( V_309 -> signal -> V_138 != V_138 && ! F_147 ( V_310 ) )
return - V_311 ;
if ( F_148 ( type , V_17 ) )
return - V_312 ;
V_169 = 0 ;
...
case V_313 :
F_71 () ;
V_169 = F_149 ( (struct V_314 T_7 * ) ( V_17 + 1 ) , V_138 ) ;
F_72 () ;
break;
case V_315 :
V_169 = F_150 ( V_138 ) ;
...
static int F_156 ( struct V_137 * V_138 , const unsigned char * V_198 , int V_38 )
{
int V_329 ;
V_329 = F_128 ( V_138 , V_198 , V_38 ) ;
F_157 ( V_138 ) ;
return V_329 ;
}
static int F_158 ( struct V_137 * V_138 , unsigned char V_330 )
{
if ( F_129 () )
return 0 ;
return F_128 ( V_138 , & V_330 , 1 ) ;
}
...
static int F_160 ( struct V_137 * V_138 )
{
return 0 ;
}
...
static void F_162 ( struct V_137 * V_138 )
{
struct V_4 * V_5 = V_138 -> V_168 ;
F_163 ( & V_5 -> V_331 ) ;
}
static void F_164 ( struct V_137 * V_138 )
{
int V_332 ;
if ( ! V_138 )
return;
...
static void F_166 ( struct V_137 * V_138 )
{
int V_332 ;
if ( ! V_138 )
return;
...
static int F_168 ( struct V_304 * V_333 , struct V_137 * V_138 )
{
...
if ( V_169 )
goto V_334;
V_5 = V_101 [ V_122 ] . V_30 ;
if ( V_5 -> V_126 . V_138 ) {
V_169 = - V_335 ;
goto V_334;
}
V_169 = F_169 ( & V_5 -> V_126 , V_333 , V_138 ) ;
if ( V_169 )
goto V_334;
V_138 -> V_168 = V_5 ;
V_5 -> V_126 . V_138 = V_138 ;
if ( ! V_138 -> V_160 . V_162 && ! V_138 -> V_160 . V_163 ) {
V_138 -> V_160 . V_162 = V_101 [ V_122 ] . V_30 -> V_32 ;
V_138 -> V_160 . V_163 = V_101 [ V_122 ] . V_30 -> V_35 ;
}
if ( V_5 -> V_237 )
...
static int F_170 ( struct V_137 * V_138 , struct V_339 * V_340 )
{
return 0 ;
}
static void F_171 ( struct V_137 * V_138 , struct V_339 * V_340 )
{
}
static void F_172 ( struct V_137 * V_138 )
{
struct V_4 * V_5 = V_138 -> V_168 ;
F_173 ( V_5 == NULL ) ;
F_71 () ;
...
for ( V_81 = 0 ; V_81 < V_350 ; V_81 ++ ) {
struct V_351 * V_351 = & V_352 [ V_81 ] ;
if ( V_351 -> V_353 == NULL ) {
V_351 -> V_353 = V_112 ;
V_351 -> V_354 = V_348 ;
V_351 -> V_355 = V_356 ;
...
V_101 [ V_122 ] . V_30 = V_5 = F_53 ( sizeof( struct V_4 ) , V_362 ) ;
F_55 ( & V_101 [ V_122 ] . V_127 , V_128 ) ;
F_54 ( & V_5 -> V_126 ) ;
F_47 ( V_5 , V_122 , 1 ) ;
V_5 -> V_93 = F_53 ( V_5 -> V_74 , V_362 ) ;
F_58 ( V_5 , V_5 -> V_32 , V_5 -> V_35 ,
V_122 || ! V_5 -> V_19 -> V_95 ) ;
}
V_122 = V_13 = 0 ;
V_114 = V_5 = V_101 [ V_122 ] . V_30 ;
F_36 ( V_5 ) ;
F_37 ( V_5 ) ;
F_64 ( V_5 , V_5 -> V_79 , V_5 -> V_84 ) ;
F_84 ( V_5 , 0 ) ;
...
struct V_366 * V_367 , char * V_198 )
{
return sprintf ( V_198 , L_10 , V_13 + 1 ) ;
}
...
struct V_351 * V_351 ;
int V_81 , V_253 = - 1 , V_341 = - 1 , V_329 = - V_389 ;
if ( ! F_198 ( V_111 ) )
return - V_389 ;
F_22 () ;
for ( V_81 = 0 ; V_81 < V_350 ; V_81 ++ ) {
...
V_262 = V_186 ( V_262 , V_351 -> V_262 ) ;
V_263 = F_63 ( V_263 , V_351 -> V_263 ) ;
for ( V_81 = V_262 ; V_81 <= V_263 ; V_81 ++ ) {
int V_106 ;
struct V_4 * V_5 = V_101 [ V_81 ] . V_30 ;
if ( V_113 [ V_81 ] )
F_48 ( V_113 [ V_81 ] -> V_111 ) ;
F_50 ( V_111 ) ;
V_113 [ V_81 ] = V_386 ;
if ( ! V_5 || ! V_5 -> V_19 )
continue;
...
if ( V_253 >= 0 ) {
struct V_4 * V_5 = V_101 [ V_253 ] . V_30 ;
F_131 ( V_390 L_19 ,
V_5 -> V_56 ? L_8 : L_9 ,
V_354 , V_5 -> V_35 , V_5 -> V_32 ) ;
if ( V_341 >= 0 ) {
V_5 = V_101 [ V_341 ] . V_30 ;
F_67 ( V_5 ) ;
}
} else
...
if ( ! F_200 ( V_391 ) ) {
const struct V_385 * V_394 = V_112 ;
V_391 -> V_349 () ;
V_392 -> V_355 |= V_356 ;
V_112 = V_394 ;
}
...
int V_81 , V_395 = 1 , V_262 = - 1 , V_263 = - 1 , V_387 = 0 ;
if ( ! V_353 -> V_353 || ! ( V_353 -> V_355 & V_393 ) )
goto V_135;
V_386 = V_353 -> V_353 ;
for ( V_81 = 0 ; V_81 < V_350 ; V_81 ++ ) {
struct V_351 * V_353 = & V_352 [ V_81 ] ;
if ( V_353 -> V_353 && ! ( V_353 -> V_355 & V_393 ) ) {
V_391 = V_353 -> V_353 ;
break;
}
...
while ( V_395 ) {
V_395 = 0 ;
for ( V_81 = V_353 -> V_262 ; V_81 <= V_353 -> V_263 ; V_81 ++ ) {
if ( V_113 [ V_81 ] == V_391 ) {
if ( V_262 == - 1 )
V_262 = V_81 ;
V_263 = V_81 ;
...
V_387 = 1 ;
if ( V_262 != - 1 ) {
V_169 = F_199 ( V_386 , V_262 , V_263 , V_387 ) ;
if ( V_169 != 0 )
return V_169 ;
}
V_262 = - 1 ;
...
const char * V_198 , T_10 V_38 )
{
struct V_351 * V_353 = F_204 ( V_365 ) ;
int V_396 = F_205 ( V_198 , NULL , 0 ) ;
F_71 () ;
if ( V_396 )
F_201 ( V_353 ) ;
else
...
return snprintf ( V_198 , V_397 , L_21 , V_396 ) ;
}
static T_9 F_207 ( struct V_364 * V_365 , struct V_366 * V_367 ,
char * V_198 )
{
struct V_351 * V_353 = F_204 ( V_365 ) ;
return snprintf ( V_198 , V_397 , L_22 ,
...
snprintf ( V_139 , 4 , L_27 , V_5 -> V_35 ) ;
F_213 ( 2 , V_407 ) ;
}
}
#endif
...
V_287 = V_402 ;
V_14 = V_404 ;
V_101 [ V_13 ] . V_30 -> V_88 = V_403 ;
V_5 = V_101 [ V_13 ] . V_30 ;
if ( V_5 -> V_19 -> F_214 )
V_169 = V_5 -> V_19 -> F_214 ( V_5 ) ;
return V_169 ;
}
...
V_291 = 0 ;
F_37 ( V_5 ) ;
V_81 = V_5 -> V_19 -> V_421 ( V_5 , V_217 ? 1 : ( V_417 + 1 ) , 0 ) ;
V_14 = V_13 + 1 ;
if ( V_81 )
F_36 ( V_5 ) ;
if ( V_422 && V_422 ( 1 ) )
...
F_229 ( & V_359 ) ;
V_291 = 0 ;
if ( V_327 || ! V_101 [ V_13 ] . V_30 || V_101 [ V_13 ] . V_30 -> V_88 == V_89 )
return;
if ( V_14 )
F_151 () ;
else if ( V_212 ) {
...
{
F_22 () ;
if ( V_5 -> V_88 != V_89 && V_5 -> V_19 -> V_428 )
V_5 -> V_19 -> V_428 ( V_5 , V_196 ) ;
}
int F_230 ( unsigned char T_7 * V_307 )
{
int V_81 , V_253 , V_341 ;
unsigned char V_429 [ 3 * 16 ] ;
if ( F_231 ( V_429 , V_307 , sizeof( V_429 ) ) )
return - V_312 ;
F_71 () ;
for ( V_81 = V_341 = 0 ; V_81 < 16 ; V_81 ++ ) {
V_342 [ V_81 ] = V_429 [ V_341 ++ ] ;
V_343 [ V_81 ] = V_429 [ V_341 ++ ] ;
V_344 [ V_81 ] = V_429 [ V_341 ++ ] ;
}
for ( V_81 = 0 ; V_81 < V_108 ; V_81 ++ ) {
if ( ! F_46 ( V_81 ) )
continue;
for ( V_253 = V_341 = 0 ; V_253 < 16 ; V_253 ++ ) {
V_101 [ V_81 ] . V_30 -> V_254 [ V_341 ++ ] = V_342 [ V_253 ] ;
V_101 [ V_81 ] . V_30 -> V_254 [ V_341 ++ ] = V_343 [ V_253 ] ;
V_101 [ V_81 ] . V_30 -> V_254 [ V_341 ++ ] = V_344 [ V_253 ] ;
}
F_42 ( V_101 [ V_81 ] . V_30 ) ;
}
F_72 () ;
return 0 ;
}
...
F_71 () ;
for ( V_81 = V_341 = 0 ; V_81 < 16 ; V_81 ++ ) {
V_429 [ V_341 ++ ] = V_342 [ V_81 ] ;
V_429 [ V_341 ++ ] = V_343 [ V_81 ] ;
V_429 [ V_341 ++ ] = V_344 [ V_81 ] ;
}
F_72 () ;
...
for ( V_81 = 0 ; V_81 < V_431 -> V_438 ; V_81 ++ ) {
if ( F_148 ( V_445 , & V_444 [ 32 * V_81 + V_443 - 1 ] ) )
return - V_312 ;
if ( V_445 )
goto V_446;
}
...
{
if ( ( unsigned long ) V_455 == V_5 -> V_78 && V_83 != - 1 )
return V_83 ;
return F_20 ( V_455 ) ;
}
...
{
F_28 ( V_456 , V_455 ) ;
if ( ( unsigned long ) V_455 == V_5 -> V_78 ) {
V_83 = - 1 ;
F_33 ( V_5 ) ;
}
}
...
T_11 V_460 = ( void * ) V_9 -> V_94 - V_458 ;
