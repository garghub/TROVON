...
void F_28 ( struct V_1 * V_2 , T_4 V_96 )
{
struct V_97 * V_98 ;
struct V_91 * V_92 ;
unsigned long V_99 ;
...
static void F_35 ( struct V_1 * V_2 , struct V_4 * V_5 )
{
struct V_15 * V_16 ;
struct V_97 * V_98 ;
unsigned long V_99 ;
...
break;
if ( V_16 -> V_92 ) {
F_36 ( V_2 -> V_61 , V_16 -> V_69 -> V_76 ,
V_16 -> V_92 -> V_105 , V_106 ) ;
V_98 = F_32 ( V_16 -> V_92 ) ;
if ( ! ( V_98 -> V_99 & V_107 ) ) {
F_37 ( V_2 -> V_103 , V_16 -> V_92 ) ;
}
F_38 ( & V_16 -> V_25 ) ;
if ( V_2 -> V_108 ) {
V_2 -> V_108 = false ;
...
static T_5 F_40 ( int V_109 , void * V_61 )
{
...
static T_5 F_41 ( int V_109 , void * V_61 )
{
struct V_1 * V_2 = (struct V_1 * ) V_61 ;
F_42 ( V_2 -> V_120 ) ;
F_43 ( V_2 ) ;
...
{
int V_29 ;
V_29 = F_46 ( V_2 -> V_121 , F_40 ,
V_122 , L_9 , V_2 ) ;
if ( V_29 ) {
F_15 ( L_10 ) ;
goto V_56;
}
V_29 = F_46 ( V_2 -> V_120 , F_41 , V_122 ,
L_11 , V_2 ) ;
if ( V_29 ) {
F_15 ( L_12 ) ;
goto V_123;
...
{
if ( V_2 -> V_130 . V_86 )
F_53 ( V_2 -> V_61 , V_2 -> V_130 . V_83 *
V_38 ,
V_2 -> V_130 . V_86 ,
V_2 -> V_130 . V_85 ) ;
if ( V_2 -> V_132 . V_86 ) {
F_53 ( V_2 -> V_61 , V_2 -> V_132 . V_83 *
V_37 ,
V_2 -> V_132 . V_86 ,
V_2 -> V_132 . V_85 ) ;
}
