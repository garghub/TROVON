...
void F_49 ( struct V_31 * V_31 , T_1 type , T_1 V_4 ,
T_1 V_5 , T_1 V_78 ,
struct V_79 * V_80 )
{
...
struct V_3 * F_51 ( struct V_31 * V_31 , T_1 type , T_1 V_4 ,
...
int F_55 ( struct V_31 * V_31 , T_1 type , T_1 V_4 , T_1 V_12 ,
T_1 V_9 )
{
struct V_3 * V_10 ;
...
T_1 type = F_60 ( V_34 -> V_54 . V_34 . V_55 . type , V_34 -> V_56 ) ;
int V_65 = F_1 ( type ) ;
struct V_16 * V_55 ;
struct V_52 V_53 ;
F_33 ( & V_61 -> V_84 ) ;
...
static void F_64 ( struct V_31 * V_31 , struct V_16 * V_55 )
{
...
V_101 = F_43 ( & V_20 -> V_37 -> V_43 , struct V_3 ,
V_43 ) ;
}
F_69 (p, &sseq->info->zone_list, zone_list) {
* V_97 = V_101 -> V_9 ;
V_98 = F_70 ( V_96 -> V_87 , V_96 -> V_103 , V_96 -> V_55 ,
& V_104 , V_105 ,
V_106 ) ;
if ( ! V_98 )
return - V_107 ;
V_100 = F_71 ( V_96 -> V_87 , V_108 ) ;
if ( ! V_100 )
goto V_109;
V_10 = F_71 ( V_96 -> V_87 , V_110 ) ;
if ( ! V_10 )
goto V_111;
if ( F_72 ( V_96 -> V_87 , V_112 , V_55 -> type ) )
goto V_113;
if ( F_72 ( V_96 -> V_87 , V_114 , V_20 -> V_4 ) )
goto V_113;
if ( F_72 ( V_96 -> V_87 , V_115 , V_20 -> V_5 ) )
goto V_113;
if ( F_72 ( V_96 -> V_87 , V_116 , V_101 -> V_6 ) )
goto V_113;
if ( F_72 ( V_96 -> V_87 , V_117 , V_101 -> V_7 ) )
goto V_113;
if ( F_72 ( V_96 -> V_87 , V_118 , V_101 -> V_12 ) )
goto V_113;
if ( F_72 ( V_96 -> V_87 , V_119 , V_101 -> V_9 ) )
goto V_113;
F_73 ( V_96 -> V_87 , V_10 ) ;
F_73 ( V_96 -> V_87 , V_100 ) ;
F_74 ( V_96 -> V_87 , V_98 ) ;
}
* V_97 = 0 ;
return 0 ;
...
static int F_77 ( struct V_95 * V_96 , struct V_16 * V_55 ,
T_1 * V_120 , T_1 * V_97 )
{
struct V_14 * V_20 ;
struct V_14 * V_121 ;
...
V_122 = F_68 ( V_96 , V_55 , V_20 , V_97 ) ;
if ( V_122 ) {
* V_120 = V_20 -> V_4 ;
return V_122 ;
}
...
static int F_78 ( struct V_31 * V_31 , struct V_95 * V_96 ,
...
int F_80 ( struct V_82 * V_87 , struct V_124 * V_125 )
{
int V_122 ;
...
struct V_31 * V_31 = F_81 ( V_87 -> V_127 ) ;
struct V_95 V_96 ;
if ( V_126 )
return 0 ;
V_96 . V_87 = V_87 ;
V_96 . V_103 = F_82 ( V_125 -> V_87 ) . V_103 ;
V_96 . V_55 = V_125 -> V_128 -> V_129 ;
F_40 () ;
V_122 = F_78 ( V_31 , & V_96 , & V_123 , & V_120 , & V_97 ) ;
if ( ! V_122 ) {
V_126 = 1 ;
} else if ( V_122 != - V_107 ) {
V_125 -> V_130 = 1 ;
...
bool F_83 ( struct V_74 * V_132 , T_1 V_133 )
{
struct V_134 * V_135 ;
F_16 (item, l, list) {
...
bool F_48 ( struct V_74 * V_132 , T_1 V_133 )
{
struct V_134 * V_135 ;
F_16 (item, l, list) {
if ( V_135 -> V_133 == V_133 )
...
T_1 F_85 ( struct V_74 * V_132 )
{
struct V_134 * V_135 ;
T_1 V_133 = 0 ;
if ( F_24 ( V_132 ) )
return 0 ;
V_135 = F_43 ( V_132 , F_86 ( * V_135 ) , V_136 ) ;
V_133 = V_135 -> V_133 ;
F_23 ( & V_135 -> V_136 ) ;
F_9 ( V_135 ) ;
return V_133 ;
}
bool F_87 ( struct V_74 * V_132 , T_1 V_133 )
{
