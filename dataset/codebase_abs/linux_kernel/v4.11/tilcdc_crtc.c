...
struct V_11 * V_12 ;
int V_35 ;
V_4 = F_87 ( V_7 -> V_7 , sizeof( * V_4 ) , V_197 ) ;
if ( ! V_4 ) {
F_20 ( V_7 -> V_7 , L_25 ) ;
return - V_198 ;
}
F_88 ( & V_4 -> V_36 ) ;
V_4 -> V_199 = F_89 ( V_7 -> V_7 ,
V_40 ,
& V_4 -> V_37 ,
V_197 | V_200 ) ;
if ( ! V_4 -> V_199 )
...
if ( V_16 -> V_205 ) {
struct V_206 * V_207 =
F_98 ( V_7 -> V_7 -> V_208 , L_28 ) ;
if ( V_207 ) {
V_12 -> V_153 = F_98 ( V_207 , L_29 ) ;
F_62 ( V_207 ) ;
} else {
V_12 -> V_153 =
F_98 ( V_7 -> V_7 -> V_208 , L_29 ) ;
}
if ( ! V_12 -> V_153 ) {
F_20 ( V_7 -> V_7 , L_30 ,
V_7 -> V_7 -> V_208 -> V_209 ) ;
