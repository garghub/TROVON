...
if ( ! V_121 )
return - 1 ;
if ( V_122 >= V_121 -> V_126 )
return - 1 ;
V_125 = V_121 -> V_127 [ V_122 ] . V_125 ;
if ( ! V_125 )
return - 1 ;
for ( V_76 = 0 ; V_76 < V_119 -> V_128 ; V_76 ++ ) {
V_124 = & V_119 -> V_124 [ V_76 ] ;
if ( ! strcmp ( V_124 -> V_129 , V_125 ) )
return V_76 ;
}
return - 1 ;
}
...
{
struct V_120 * V_121 =
& V_119 -> V_130 [ V_9 -> V_57 ] ;
struct V_123 * V_124 = NULL ;
struct V_131 * V_52 = NULL ;
T_2 V_132 = 0 , V_133 = 0 ;
int V_134 ;
int V_46 ;
V_134 = F_44 ( V_119 , V_121 , V_85 ) ;
if ( V_134 >= 0 ) {
V_52 = V_74 . V_52 [ V_134 ] ;
V_124 = & V_119 -> V_124 [ V_134 ] ;
} else {
return 0 ;
}
if ( V_52 && V_119 -> V_135 ) {
V_46 = V_119 -> V_135 ( V_9 -> V_57 ,
V_124 -> V_129 ) ;
if ( V_46 < 0 ) {
F_6 ( 1 , V_13 , L_15 \
L_16 ,
...
if ( V_52 ) {
V_132 = V_121 -> V_127 [ V_85 ] . V_136 ;
V_133 = V_121 -> V_127 [ V_85 ] . V_137 ;
V_46 = F_19 ( V_52 , V_53 , V_138 ,
V_132 , V_133 , 0 ) ;
if ( V_46 < 0 && V_46 != - V_55 ) {
F_6 ( 1 , V_13 , L_17 ) ;
return V_46 ;
...
V_9 -> V_139 = V_85 ;
V_9 -> V_52 = V_52 ;
V_9 -> V_44 . V_102 = V_121 -> V_140 ;
V_9 -> V_141 . V_142 = V_121 -> V_127 [ V_85 ] . V_132 . V_143 ;
return 0 ;
}
...
int V_46 ;
F_6 ( 2 , V_13 , L_18 ) ;
V_46 = F_19 ( V_9 -> V_52 , V_53 , V_149 , V_146 ) ;
...
struct V_151 V_132 ;
F_6 ( 2 , V_13 , L_20 ) ;
if ( ! V_82 -> V_130 [ V_9 -> V_57 ] . V_127 )
return - V_150 ;
V_121 = & V_82 -> V_130 [ V_9 -> V_57 ] ;
V_132 = V_121 -> V_127 [ V_9 -> V_139 ] . V_132 ;
...
V_46 = F_19 ( V_9 -> V_52 , V_53 , V_156 , V_146 ) ;
if ( V_46 && V_46 != - V_55 && V_46 != - V_56 ) {
F_6 ( 1 , V_13 , L_23 ) ;
return V_46 ;
}
...
struct V_120 * V_121 ;
V_121 = & V_82 -> V_130 [ V_9 -> V_57 ] ;
if ( V_132 -> V_85 >= V_121 -> V_126 )
return - V_18 ;
memcpy ( V_132 , & V_121 -> V_127 [ V_132 -> V_85 ] . V_132 ,
sizeof( * V_132 ) ) ;
return 0 ;
}
static int F_54 ( struct V_144 * V_144 , void * V_145 , unsigned int * V_85 )
{
struct V_147 * V_148 = F_47 ( V_144 ) ;
struct V_8 * V_9 = F_48 ( V_148 ) ;
* V_85 = V_9 -> V_139 ;
...
static int F_55 ( struct V_144 * V_144 , void * V_145 , unsigned int V_85 )
{
struct V_38 * V_82 = V_40 -> V_41 ;
struct V_147 * V_148 = F_47 ( V_144 ) ;
struct V_8 * V_9 = F_48 ( V_148 ) ;
...
{
int V_76 ;
for ( V_76 = 0 ; V_76 < V_74 . V_82 -> V_128 ; V_76 ++ )
if ( ! strcmp ( V_74 . V_82 -> V_124 [ V_76 ] . V_129 ,
V_219 -> V_129 ) ) {
...
int V_76 , V_51 ;
if ( ! V_250 -> V_73 . V_41 ) {
F_87 ( & V_250 -> V_73 , L_36 ) ;
return - V_18 ;
}
V_40 = & V_250 -> V_73 ;
V_51 = F_71 () ;
if ( V_51 ) {
F_88 ( V_40 -> V_169 , L_37 ) ;
return V_51 ;
}
V_51 = F_89 ( V_40 , & V_74 . V_208 ) ;
if ( V_51 ) {
F_88 ( V_40 -> V_169 , L_38 ) ;
return V_51 ;
}
while ( ( V_255 = F_90 ( V_250 , V_257 , V_256 ) ) ) {
V_51 = F_91 ( & V_250 -> V_73 , V_255 -> V_258 , F_39 ,
V_259 , V_170 ,
...
V_128 = V_74 . V_82 -> V_128 ;
V_74 . V_52 = F_92 ( V_128 , sizeof( * V_74 . V_52 ) , V_214 ) ;
if ( ! V_74 . V_52 ) {
V_51 = - V_215 ;
goto V_260;
}
if ( ! V_74 . V_82 -> V_261 ) {
int V_262 = V_74 . V_82 -> V_263 ;
V_253 = F_93 ( V_262 ) ;
F_94 ( ! V_253 ) ;
...
V_74 . V_218 . V_266 = V_74 . V_82 -> V_221 ;
V_74 . V_218 . V_267 = V_74 . V_82 -> V_261 [ 0 ] ;
V_74 . V_218 . V_268 = F_74 ;
V_74 . V_218 . V_269 = F_85 ;
V_51 = F_96 ( & V_74 . V_208 ,
& V_74 . V_218 ) ;
if ( V_51 ) {
F_52 ( L_41 ) ;
V_51 = - V_18 ;
...
static int F_97 ( struct V_249 * V_28 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
...
static int F_98 ( struct V_28 * V_73 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
...
static int F_102 ( struct V_28 * V_73 )
{
struct V_10 * V_11 ;
struct V_8 * V_9 ;
int V_76 ;
