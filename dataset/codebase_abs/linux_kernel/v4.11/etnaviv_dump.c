...
F_3 ( & V_2 , V_13 ) ;
F_6 ( & V_2 , V_13 , V_19 ) ;
F_8 ( & V_2 , V_46 , V_13 -> V_35 -> V_47 ,
V_13 -> V_35 -> V_23 ,
F_15 ( V_13 -> V_35 ) ) ;
F_12 (cmd, &gpu->active_cmd_list, node)
F_8 ( & V_2 , V_48 , V_30 -> V_47 ,
V_30 -> V_23 , F_15 ( V_30 ) ) ;
if ( V_32 ) {
V_34 = V_33 = V_2 . V_9 ;
...
for ( V_53 = 0 ; V_53 < V_28 -> V_38 . V_23 > > V_39 ; V_53 ++ )
* V_33 ++ = F_9 ( F_19 ( * V_51 ++ ) ) ;
}
V_2 . V_5 -> V_24 = F_9 ( V_26 -> V_24 ) ;
V_47 = F_20 ( & V_28 -> V_38 ) ;
if ( V_47 )
memcpy ( V_2 . V_9 , V_47 , V_28 -> V_38 . V_23 ) ;
F_1 ( & V_2 , V_54 , V_2 . V_9 +
V_28 -> V_38 . V_23 ) ;
}
F_1 ( & V_2 , V_55 , V_2 . V_9 ) ;
F_21 ( V_13 -> V_45 , V_2 . V_10 , V_2 . V_9 - V_2 . V_10 , V_40 ) ;
}
