...
static T_4
V_71 ( struct V_88 * V_89 , struct V_90 * V_90 )
{
struct V_3 * V_4 ;
struct V_91 V_92 ;
struct V_93 V_94 ;
...
void * * V_112 , T_6 * V_113 , long V_114 )
{
struct V_3 * V_4 ;
...
if ( ! V_4 )
return - V_77 ;
V_116 = V_4 -> V_20 - V_4 -> V_23 + 1 ;
V_115 = V_111 * 512 ;
* V_112 = ( void * ) V_4 -> V_23 + V_115 ;
* V_113 = F_75 ( F_76 ( V_4 -> V_23 + V_115 ) , V_117 ) ;
return V_116 - V_115 ;
}
static void
F_77 ( void )
...
V_26 = F_93 ( V_57 , & V_127 ) ;
if ( V_26 )
goto V_128;
V_26 = F_93 ( V_57 , & V_129 ) ;
if ( V_26 )
goto V_128;
V_26 = F_94 ( 0 , V_124 ) ;
if ( V_26 < 0 )
