...
V_4 = F_33 ( V_6 -> V_12 , V_7 , V_17 ) ;
F_27 ( V_6 , V_7 , V_7 + V_19 ) ;
return V_4 ;
}
T_3 F_34 ( struct V_5 * V_6 , unsigned long V_7 ,
T_3 * V_20 )
{
T_3 V_3 ;
F_25 ( V_7 & ~ V_21 ) ;
F_25 ( ! F_35 ( * V_20 ) && ! F_36 ( * V_20 ) ) ;
V_3 = F_37 ( V_6 -> V_12 , V_7 , V_20 ) ;
F_38 ( V_6 , V_7 , V_7 + V_22 ) ;
return V_3 ;
}
void F_39 ( struct V_14 * V_15 , T_4 * V_17 ,
T_6 V_23 )
{
F_40 ( F_41 ( V_15 , V_17 ) ) ;
if ( ! F_42 ( V_15 , V_17 ) )
...
F_44 ( & V_23 -> V_24 , & F_42 ( V_15 , V_17 ) -> V_24 ) ;
F_42 ( V_15 , V_17 ) = V_23 ;
}
T_6 F_45 ( struct V_14 * V_15 , T_4 * V_17 )
{
T_6 V_23 ;
F_40 ( F_41 ( V_15 , V_17 ) ) ;
V_23 = F_42 ( V_15 , V_17 ) ;
F_42 ( V_15 , V_17 ) = F_46 ( & V_23 -> V_24 ,
struct V_25 , V_24 ) ;
if ( F_42 ( V_15 , V_17 ) )
F_47 ( & V_23 -> V_24 ) ;
return V_23 ;
}
void F_48 ( struct V_5 * V_6 , unsigned long V_7 ,
T_4 * V_17 )
{
T_4 V_9 = * V_17 ;
F_26 ( V_6 -> V_12 , V_7 , V_17 , F_49 ( V_9 ) ) ;
F_27 ( V_6 , V_7 , V_7 + V_19 ) ;
}
T_4 F_50 ( struct V_5 * V_6 , unsigned long V_7 ,
T_4 * V_17 )
{
T_4 V_4 ;
F_25 ( V_7 & ~ V_18 ) ;
