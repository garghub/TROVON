...
static unsigned int F_12 ( struct V_31 * V_32 ,
unsigned char * V_33 , unsigned int V_34 , int V_35 )
{
struct V_14 * V_16 = V_32 -> V_16 ;
struct V_24 * V_25 = V_16 -> V_13 -> V_25 ;
int V_36 = V_34 & 3 ;
if ( F_13 ( V_16 -> V_37 ) && ( V_36 == 0 || V_36 == 3 )
&& ( V_25 -> V_38 & V_39 ) ) {
unsigned long V_22 ;
F_7 ( V_22 ) ;
F_14 ( V_25 -> V_40 . V_41 ) ;
...
F_14 ( V_25 -> V_40 . V_41 ) ;
if ( V_35 == V_42 )
F_15 ( V_25 -> V_40 . V_43 , V_33 , V_34 >> 2 ) ;
else
F_16 ( V_25 -> V_40 . V_43 , V_33 , V_34 >> 2 ) ;
if ( F_17 ( V_36 ) ) {
T_2 V_44 ;
if ( V_35 == V_42 ) {
V_44 = F_18 ( F_19 ( V_25 -> V_40 . V_43 ) ) ;
memcpy ( V_33 + V_34 - V_36 , & V_44 , V_36 ) ;
} else {
memcpy ( & V_44 , V_33 + V_34 - V_36 , V_36 ) ;
F_20 ( F_21 ( V_44 ) , V_25 -> V_40 . V_43 ) ;
}
V_34 += 4 - V_36 ;
}
F_10 ( V_22 ) ;
} else
V_34 = F_22 ( V_32 , V_33 , V_34 , V_35 ) ;
return V_34 ;
}
...
T_1 V_45 , V_46 ;
struct V_47 V_48 ;
F_24 ( V_26 , V_26 -> V_17 , & V_48 , 20000 , 1000 ) ;
V_45 = F_25 ( V_48 . V_45 , 2 , 15 ) ;
V_46 = F_25 ( V_48 . V_46 , 4 , 15 ) ;
F_8 ( 0x3E6 ) ;
F_8 ( 0x3E6 ) ;
F_8 ( 0x3E6 ) ;
F_8 ( 0x3E6 ) ;
F_26 ( V_46 << 4 | V_45 , V_25 -> V_40 . V_49 ) ;
F_14 ( V_25 -> V_40 . V_50 ) ;
}
...
T_1 V_45 , V_46 , V_56 ;
struct V_47 V_48 ;
struct V_14 * V_57 = F_30 ( V_26 ) ;
int clock ;
int V_58 [ 4 ] = { 50000 , 40000 , 33000 , 25000 } ;
T_1 V_59 ;
F_31 ( V_25 -> V_40 . V_60 ) ;
F_31 ( V_25 -> V_40 . V_60 ) ;
F_26 ( 3 , V_25 -> V_40 . V_41 ) ;
clock = 1000000000 / V_58 [ F_14 ( V_25 -> V_40 . V_61 ) & 0x03 ] ;
F_24 ( V_26 , V_26 -> V_17 , & V_48 , clock , 1000 ) ;
if ( V_57 ) {
struct V_47 V_62 ;
F_24 ( V_57 , V_57 -> V_17 , & V_62 , clock , 1000 ) ;
F_32 ( & V_48 , & V_62 , & V_48 , V_63 ) ;
}
V_45 = F_25 ( V_48 . V_45 , 2 , 17 ) - 2 ;
V_46 = F_25 ( V_48 . V_46 , 1 , 16 ) - 1 ;
V_56 = F_25 ( V_48 . V_56 , 1 , 4 ) - 1 ;
V_59 = F_14 ( V_25 -> V_40 . V_64 ) ;
V_59 &= 0x7F ;
V_59 |= ( V_26 -> V_30 << 7 ) ;
F_26 ( V_59 , V_25 -> V_40 . V_64 ) ;
F_26 ( V_45 << 4 | V_46 , V_25 -> V_40 . V_60 ) ;
V_59 = F_14 ( V_25 -> V_40 . V_49 ) ;
V_59 &= 0xC0 ;
V_59 |= V_26 -> V_30 ;
V_59 |= ( V_56 << 4 ) | 0x04 ;
F_26 ( V_59 , V_25 -> V_40 . V_49 ) ;
F_26 ( V_45 << 4 | V_46 , V_25 -> V_40 . V_43 ) ;
V_59 = F_14 ( V_25 -> V_40 . V_64 ) ;
V_59 &= 0x73 ;
V_59 |= 0x84 ;
F_26 ( V_59 , V_25 -> V_40 . V_64 ) ;
F_26 ( 0x83 , V_25 -> V_40 . V_41 ) ;
}
...
T_1 V_59 ;
T_1 V_65 ;
V_65 = ( F_28 ( 0xAC ) & 0xC0 ) >> 6 ;
F_31 ( V_25 -> V_40 . V_60 ) ;
F_31 ( V_25 -> V_40 . V_60 ) ;
F_26 ( 3 , V_25 -> V_40 . V_41 ) ;
clock = 1000000000 / V_58 [ V_65 ] ;
F_24 ( V_26 , V_26 -> V_17 , & V_48 , clock , 1000 ) ;
if ( V_57 ) {
struct V_47 V_62 ;
F_24 ( V_57 , V_57 -> V_17 , & V_62 , clock , 1000 ) ;
...
static unsigned int F_34 ( struct V_31 * V_32 )
{
struct V_24 * V_25 = V_32 -> V_25 ;
struct V_14 * V_26 = V_32 -> V_16 ;
if ( V_25 -> V_66 -> V_67 != V_25 -> V_66
&& V_25 -> V_66 -> V_67 != NULL )
F_33 ( V_25 , V_26 ) ;
return F_35 ( V_32 ) ;
}
...
{
struct V_47 V_48 ;
struct V_68 * V_69 = V_25 -> V_66 -> V_67 ;
int V_45 , V_70 ;
T_1 V_71 ;
F_24 ( V_26 , V_26 -> V_17 , & V_48 , 30303 , 1000 ) ;
if ( V_69 -> V_72 ) {
V_45 = 8 - F_25 ( V_48 . V_45 , 1 , 8 ) ;
V_70 = 18 - F_25 ( V_48 . V_46 , 3 , 18 ) ;
} else {
V_45 = 9 - F_25 ( V_48 . V_45 , 2 , 9 ) ;
V_70 = 15 - F_25 ( V_48 . V_46 , 0 , 15 ) ;
}
V_71 = ( V_70 << 4 ) | V_45 | 0x08 ;
V_69 -> clock [ V_26 -> V_30 ] = V_71 ;
if ( V_69 -> type == V_73 )
F_9 ( V_71 , V_69 -> V_71 + 2 * V_26 -> V_30 ) ;
else
F_9 ( V_71 , V_69 -> V_71 + 2 * V_25 -> V_74 ) ;
if ( V_69 -> type != V_75 && V_26 -> V_51 != V_52 )
F_9 ( 0x5F , ( V_69 -> V_71 & 0xFFF0 ) + 3 ) ;
}
static unsigned int F_37 ( struct V_31 * V_32 )
{
struct V_24 * V_25 = V_32 -> V_25 ;
struct V_14 * V_26 = V_32 -> V_16 ;
struct V_68 * V_69 = V_25 -> V_66 -> V_67 ;
...
static unsigned int F_38 ( struct V_31 * V_32 ,
unsigned char * V_33 ,
...
int V_36 = V_34 & 3 ;
if ( F_13 ( V_26 -> V_37 ) && ( V_36 == 0 || V_36 == 3 )
&& ( V_25 -> V_38 & V_39 ) ) {
if ( V_35 == V_77 )
F_16 ( V_25 -> V_40 . V_43 , V_33 , V_34 >> 2 ) ;
else
...
return F_39 ( V_32 , V_33 , V_34 , V_35 ) ;
}
...
static void F_42 ( unsigned long V_1 , T_1 V_54 , T_1 V_81 )
{
unsigned long V_22 ;
F_43 ( & V_82 , V_22 ) ;
F_9 ( V_54 , V_1 + 0x01 ) ;
...
static T_1 F_45 ( unsigned long V_1 , T_1 V_54 )
{
T_1 V_81 ;
unsigned long V_22 ;
F_43 ( & V_82 , V_22 ) ;
...
{
struct V_47 V_48 ;
struct V_68 * V_83 = V_25 -> V_66 -> V_67 ;
int V_45 , V_70 ;
T_1 V_54 ;
int V_71 = 0x88 + ( V_25 -> V_74 * 4 ) + ( V_26 -> V_30 * 2 ) ;
V_54 = F_45 ( V_83 -> V_71 , 0x81 ) ;
if ( V_54 & 0x40 )
F_24 ( V_26 , V_26 -> V_17 , & V_48 , 20000 , 1000 ) ;
else
F_24 ( V_26 , V_26 -> V_17 , & V_48 , 30303 , 1000 ) ;
V_45 = ( F_25 ( V_48 . V_45 , 3 , 17 ) - 1 ) & 0x0F ;
V_70 = ( F_25 ( V_48 . V_46 , 1 , 15 ) + 1 ) & 0x0F ;
V_71 = ( V_45 << 4 ) | V_70 ;
F_42 ( V_83 -> V_71 , V_71 , V_54 ) ;
V_54 = 0x35 ;
if ( V_26 -> V_51 != V_52 )
V_54 |= 0x08 ;
if ( ! F_47 ( V_26 ) )
V_54 |= 0x02 ;
V_54 |= ( F_25 ( V_48 . V_56 , 0 , 3 ) << 6 ) ;
F_42 ( V_83 -> V_71 , V_71 + 1 , V_54 ) ;
}
...
V_79 -> type = V_84 -> type ;
if ( V_3 -> V_56 )
if ( V_3 -> V_56 ( V_110 , V_84 , V_79 ) < 0 )
goto V_118;
V_66 = F_55 ( & V_110 -> V_16 , 1 ) ;
if ( ! V_66 )
goto V_118;
V_25 = V_66 -> V_120 [ 0 ] ;
V_25 -> V_108 = V_108 ;
...
V_25 -> V_38 |= V_3 -> V_38 ;
V_25 -> V_40 . V_122 = V_111 ;
V_25 -> V_40 . V_123 = V_112 ;
V_25 -> V_40 . V_124 = V_112 ;
F_56 ( & V_25 -> V_40 ) ;
V_25 -> V_66 -> V_67 = V_79 ;
F_57 ( V_25 , L_10 , V_106 , V_106 + 0x0206 ) ;
V_116 = F_58 ( V_66 , V_84 -> V_2 , V_125 , 0 ,
& V_126 ) ;
if ( V_116 )
goto V_118;
F_59 () ;
...
static T_3 void F_66 ( T_1 V_55 , T_1 V_139 , unsigned long V_1 )
{
static const unsigned long V_140 [ 2 ] = { 0x170 , 0x1F0 } ;
if ( ( V_55 & 0xF0 ) == 0xC0 ) {
if ( V_55 & 8 )
return;
F_1 ( V_140 [ V_55 & 0x01 ] , 14 + ( V_55 & 0x01 ) ,
V_75 , V_1 ) ;
}
if ( ( ( V_55 & 0xF0 ) == 0xA0 ) || ( V_55 & 0xF0 ) == 0x50 ) {
...
if ( F_72 ( V_131 , V_55 ) == 0x1f0 )
V_132 = 1 ;
if ( F_72 ( V_131 , V_55 ) == 0x170 )
V_133 = 1 ;
}
