...
int F_40 ( struct V_102 * V_103 , struct V_25 * V_26 )
{
unsigned long V_104 = F_41 ( V_26 ) ;
#if F_13 ( V_38 ) || F_13 ( V_39 )
unsigned long V_105 ;
unsigned long V_106 ;
#endif
...
if ( ! V_115 -> V_9 )
return;
V_116 = V_115 -> V_55 & 0x7UL ;
F_35 ( V_77 [ V_116 ] , V_115 -> V_9 ) ;
V_115 -> V_9 = NULL ;
V_115 -> V_55 = 0UL ;
}
...
F_11 ( & V_117 , V_28 ) ;
if ( F_45 ( V_26 -> V_29 ) ) {
unsigned long V_118 = F_46 ( V_26 -> V_29 ) ;
V_119 [ V_118 >> 6 ] &= ~ ( 1UL << ( V_118 & 63 ) ) ;
}
F_14 ( & V_117 , V_28 ) ;
}
