...
switch ( F_48 ( V_69 ) ) {
case V_89 :
F_22 ( V_51 , V_52 , V_85 , V_10 , V_12 , V_90 ,
& F_32 ) ;
if ( V_57 )
goto V_63;
break;
case V_91 :
F_22 ( V_51 , V_52 , V_85 , V_10 , V_12 , V_92 ,
& F_37 ) ;
if ( V_57 )
goto V_63;
if ( F_31 () ) {
...
static int F_50 ( struct V_95 * V_96 , struct V_97 * V_98 )
{
struct V_50 * V_51 = V_96 -> V_99 -> V_70 ;
V_98 -> V_100 = V_51 -> V_10 ;
V_98 -> V_101 = V_51 -> V_11 ;
V_98 -> V_102 = V_51 -> V_12 ;
return 0 ;
}
static T_2 F_51 ( int V_103 , void * V_104 )
{
void (* F_52)( void ) = V_80 ;
F_53 ( V_81 -> V_82 ) ;
V_80 = NULL ;
...
struct V_111 * V_51 = F_62 ( 64 ) ;
struct V_50 * V_112 = & V_9 [ V_48 ] ;
if ( ! V_51 )
goto V_113;
V_51 -> V_114 = V_106 ;
V_51 -> V_115 = V_48 << 6 ;
...
V_51 -> V_70 = V_112 ;
F_63 ( V_51 , V_112 -> V_10 * V_112 -> V_11 * V_112 -> V_12 ) ;
V_51 -> V_118 = V_81 ;
V_112 -> V_58 = V_48 ;
V_119 [ V_48 ] = V_51 ;
F_14 ( L_46 ,
V_51 -> V_24 , ( unsigned long ) F_46 ( V_51 ) / 2048 ,
V_112 -> V_12 , V_112 -> V_10 , V_112 -> V_11 ) ;
}
if ( F_64 ( V_120 , F_51 , 0 , L_42 , NULL ) ) {
F_14 ( L_47 ,
V_120 ) ;
goto V_121;
}
if ( ! F_65 ( V_60 , 8 , L_42 ) ) {
F_14 ( V_122 L_48 , V_60 ) ;
goto V_123;
}
if ( ! F_65 ( V_59 , 1 , L_49 ) ) {
F_14 ( V_122 L_48 , V_59 ) ;
goto V_124;
}
for ( V_48 = 0 ; V_48 < V_16 ; V_48 ++ )
F_66 ( V_119 [ V_48 ] ) ;
