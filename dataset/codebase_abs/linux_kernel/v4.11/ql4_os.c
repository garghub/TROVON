...
F_3 ( F_4 ( V_25 , V_10 ,
L_204 ,
V_26 , V_1233 -> V_923 , V_1234 -> V_923 ) ) ;
...
break;
case V_215 :
V_315 = sprintf ( V_273 , L_232 , V_1291 -> V_923 ) ;
break;
case V_216 :
...
F_3 ( F_113 ( L_248
L_249 , V_26 ) ) ;
sprintf ( V_273 , L_250 , V_10 -> V_576 ) ;
...
V_10 -> V_1139 = F_400 ( L_252 , V_1385 , 1 ,
V_10 -> V_576 ) ;
if ( ! V_10 -> V_1139 ) {
F_4 ( V_38 , V_10 , L_253 ) ;
V_277 = - V_1339 ;
...
static int F_429 ( struct V_9 * V_10 )
{
...
static int F_431 ( struct V_628 * V_955 )
{
...
F_4 ( V_25 , V_10 ,
L_269 ,
V_10 -> V_576 , V_1421 , V_1422 , ( V_277 == V_1416 ) ? L_270 : L_271 ) ;
return V_277 ;
}
static int F_434 ( struct V_628 * V_955 )
{
struct V_9 * V_10 = F_2 ( V_955 -> V_295 -> V_574 ) ;
struct V_301 * V_301 = V_955 -> V_295 -> V_963 ;
...
V_1425 = F_436 ( V_10 , V_301 , V_955 -> V_295 -> V_1422 ) ;
if ( V_1425 != V_41 ) {
F_4 ( V_25 , V_10 , L_275 , V_1425 ) ;
goto V_1430;
}
if ( F_430 ( V_10 , F_65 ( V_955 -> V_295 ) ,
V_955 -> V_295 ) ) {
F_4 ( V_25 , V_10 ,
L_276
L_277 ) ;
...
if ( F_437 ( V_10 , V_301 , V_955 -> V_295 -> V_1422 ,
V_1431 ) != V_41 )
goto V_1430;
F_4 ( V_25 , V_10 ,
L_278 ,
...
static int F_438 ( struct V_628 * V_955 )
{
struct V_9 * V_10 = F_2 ( V_955 -> V_295 -> V_574 ) ;
struct V_301 * V_301 = V_955 -> V_295 -> V_963 ;
int V_1425 , V_277 ;
...
static int F_442 ( struct V_628 * V_955 )
{
int V_1435 = V_1424 ;
struct V_9 * V_10 ;
...
if ( F_429 ( V_10 ) != V_41 ) {
F_3 ( F_113 ( L_288
L_289 , V_10 -> V_576 , V_955 -> V_295 -> V_1426 ,
V_26 ) ) ;
return V_1424 ;
}
if ( ! F_55 ( V_974 , & V_10 -> V_972 ) ) {
...
& V_1438 , V_251 ) ;
if ( ! V_698 ) {
F_4 ( V_252 , V_10 , L_291 ,
V_26 ) ;
V_18 = - V_278 ;
goto V_1439;
}
memset ( V_698 , 0 , V_1437 ) ;
V_18 = F_444 ( V_10 , V_1438 , V_1440 , V_1437 ) ;
if ( V_18 != V_41 ) {
V_18 = - V_336 ;
goto V_1441;
}
...
V_698 , V_1438 ) ;
V_1439:
F_3 ( F_4 ( V_25 , V_10 , L_292 , V_26 ,
V_18 == V_41 ? L_146 : L_145 ) ) ;
return V_18 ;
}
static int F_445 ( struct V_1 * V_2 , int V_1442 )
{
struct V_9 * V_10 = F_2 ( V_2 ) ;
int V_18 = V_41 ;
T_1 V_1039 ;
if ( V_1046 ) {
F_3 ( F_4 ( V_25 , V_10 , L_293 ,
V_26 ) ) ;
V_18 = - V_1314 ;
goto V_1443;
}
...
static T_10
F_447 ( struct V_1144 * V_249 , T_11 V_633 )
{
...
static T_1 F_450 ( struct V_9 * V_10 )
{
T_1 V_18 = V_261 ;
int V_1395 ;
struct V_1144 * V_1394 = NULL ;
F_4 ( V_38 , V_10 , L_296 , V_10 -> V_576 , V_26 ) ;
F_202 ( V_973 , & V_10 -> V_972 ) ;
if ( F_55 ( V_977 , & V_10 -> V_289 ) ) {
F_115 ( V_977 , & V_10 -> V_289 ) ;
F_115 ( V_652 , & V_10 -> V_289 ) ;
...
V_1459:
F_4 ( V_38 , V_10 , L_310
L_309 , V_10 -> V_576 , V_26 , V_277 ) ;
return V_277 ;
}
static void
F_456 ( struct V_1144 * V_249 )
{
struct V_9 * V_10 = F_413 ( V_249 ) ;
int V_277 ;
F_4 ( V_38 , V_10 , L_311 ,
...
static int T_12 F_458 ( void )
{
int V_277 ;
if ( V_1460 )
V_1343 . V_1461 = 1 ;
V_1015 = F_459 ( L_314 , sizeof( struct V_954 ) , 0 ,
V_1462 , NULL ) ;
if ( V_1015 == NULL ) {
F_113 ( V_252
L_315
