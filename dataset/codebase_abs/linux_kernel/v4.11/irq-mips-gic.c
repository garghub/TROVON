...
static void T_5 F_114 ( struct V_165 * V_166 ,
unsigned int V_59 )
{
unsigned int V_185 ;
struct V_176 V_186 = {
...
static void T_5 F_117 ( struct V_165 * V_166 )
{
F_114 ( V_166 , V_137 ) ;
F_114 ( V_166 , V_139 ) ;
F_114 ( V_166 , V_50 ) ;
...
static void T_5 F_118 ( unsigned long V_189 ,
unsigned long V_190 ,
unsigned int V_191 , unsigned int V_192 ,
struct V_165 * V_166 )
{
unsigned int V_42 , V_38 ;
unsigned int V_193 [ 2 ] ;
V_76 = V_189 ;
V_2 = F_119 ( V_189 , V_190 ) ;
V_42 = F_5 ( F_13 ( V_8 , V_30 ) ) ;
V_93 = ( V_42 & V_194 ) >>
V_195 ;
V_93 = ( ( V_93 + 1 ) * 8 ) ;
...
V_206 -> V_168 = V_183 ;
if ( V_166 &&
! F_126 ( V_166 , L_8 , V_193 , 2 ) ) {
F_98 ( V_161 , V_193 [ 0 ] , V_193 [ 1 ] ) ;
} else {
F_98 ( V_161 ,
V_93 - 2 * V_119 ,
2 * V_119 ) ;
...
void T_5 F_127 ( unsigned long V_189 ,
unsigned long V_190 ,
unsigned int V_191 , unsigned int V_192 )
{
F_118 ( V_189 , V_190 , V_191 , V_192 , NULL ) ;
}
static int T_5 F_128 ( struct V_165 * V_166 ,
struct V_165 * V_209 )
{
struct V_72 V_210 ;
unsigned int V_191 , V_81 = 0 , V_211 = 0 ;
T_6 V_2 ;
T_7 V_212 ;
while ( ! F_129 ( V_166 , L_9 ,
V_81 ++ , & V_191 ) )
V_211 |= F_130 ( V_191 ) ;
for ( V_191 = 2 ; V_191 < 8 ; V_191 ++ ) {
if ( ! ( V_211 & F_130 ( V_191 ) ) )
break;
}
if ( V_191 == 8 ) {
F_87 ( L_10 ) ;
