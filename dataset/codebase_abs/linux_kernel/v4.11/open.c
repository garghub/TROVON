...
struct V_4 * F_83 ( struct V_142 * V_143 , int V_120 , T_3 V_49 )
{
struct V_121 V_122 ;
int V_144 = F_81 ( V_120 , V_49 , & V_122 ) ;
return V_144 ? F_79 ( V_144 ) : F_84 ( V_33 , V_143 , & V_122 ) ;
}
struct V_4 * F_85 ( const char * V_142 , int V_120 , T_3 V_49 )
{
struct V_142 * V_143 = F_86 ( V_142 ) ;
struct V_4 * V_4 = F_87 ( V_143 ) ;
if ( ! F_14 ( V_143 ) ) {
V_4 = F_83 ( V_143 , V_120 , V_49 ) ;
F_88 ( V_143 ) ;
}
return V_4 ;
}
struct V_4 * F_89 ( struct V_1 * V_1 , struct V_145 * V_22 ,
...
if ( V_144 )
return F_79 ( V_144 ) ;
return F_90 ( V_1 , V_22 , V_142 , & V_122 ) ;
}
struct V_4 * F_91 ( struct V_4 * V_146 )
{
struct V_4 * V_4 ;
int V_147 ;
V_4 = F_77 () ;
...
return V_4 ;
V_4 -> V_39 = V_146 -> V_39 ;
V_147 = F_74 ( & V_146 -> V_41 , V_4 , V_146 -> V_148 ) ;
if ( V_147 ) {
F_80 ( V_4 ) ;
return F_79 ( V_147 ) ;
}
...
long F_92 ( int V_149 , const char T_2 * V_142 , int V_120 , T_3 V_49 )
{
struct V_121 V_122 ;
...
V_35 = F_94 ( V_120 ) ;
if ( V_35 >= 0 ) {
struct V_4 * V_37 = F_84 ( V_149 , V_150 , & V_122 ) ;
if ( F_14 ( V_37 ) ) {
F_95 ( V_35 ) ;
V_35 = F_13 ( V_37 ) ;
} else {
...
int F_98 ( struct V_4 * V_5 , T_8 V_151 )
{
int V_147 = 0 ;
if ( ! F_99 ( V_5 ) ) {
F_100 ( V_152 L_1 ) ;
