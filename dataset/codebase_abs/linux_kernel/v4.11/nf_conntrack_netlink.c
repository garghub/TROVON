...
F_8 () ;
V_42 = F_25 ( V_40 -> V_42 ) ;
if ( V_42 && ! strcmp ( V_42 -> V_46 , V_242 ) )
V_141 = 0 ;
F_11 () ;
}
return V_141 ;
...
static int
F_189 ( struct V_28 * V_29 , const struct V_8 * const V_166 [] )
{
unsigned int V_31 = F_88 ( F_89 ( V_166 [ V_30 ] ) ) ;
unsigned long V_230 = V_29 -> V_31 ^ V_31 ;
if ( V_230 & V_234 && ! ( V_31 & V_234 ) )
return - V_233 ;
if ( V_230 & V_235 && ! ( V_31 & V_235 ) )
return - V_233 ;
V_29 -> V_31 = ( V_31 & ~ V_297 ) |
( V_29 -> V_31 & V_297 ) ;
return 0 ;
}
static int
F_190 ( const struct V_8 * V_166 [] , struct V_28 * V_29 )
{
int V_141 ;
if ( V_166 [ V_34 ] ) {
V_141 = F_154 ( V_29 , V_166 ) ;
...
static int
F_191 ( const struct V_8 * V_51 , struct V_28 * V_29 )
{
struct V_8 * V_166 [ V_299 + 1 ] ;
int V_7 ;
V_7 = F_109 ( V_166 , V_299 , V_51 , V_300 ) ;
if ( V_7 < 0 )
return V_7 ;
F_136 ( & V_244 ) ;
V_7 = F_190 ( ( const struct V_8 * * ) V_166 , V_29 ) ;
F_137 ( & V_244 ) ;
return V_7 ;
}
static int F_192 ( const struct V_8 * const * V_166 ,
const struct V_28 * V_29 ,
struct V_3 * V_4 ,
struct V_3 * V_171 )
{
int V_141 ;
V_141 = F_118 ( V_166 , V_4 , V_301 ,
F_21 ( V_29 ) , NULL ) ;
if ( V_141 < 0 )
return V_141 ;
return F_118 ( V_166 , V_171 , V_302 ,
F_21 ( V_29 ) , NULL ) ;
}
static int
F_193 ( const struct V_8 * V_51 , struct V_28 * V_29 ,
T_2 V_106 , T_2 V_151 )
{
struct V_8 * V_166 [ V_303 + 1 ] ;
struct V_3 V_4 , V_171 ;
struct V_41 * V_42 = NULL ;
struct V_304 * exp ;
int V_141 ;
V_141 = F_109 ( V_166 , V_303 , V_51 , V_305 ) ;
if ( V_141 < 0 )
return V_141 ;
V_141 = F_192 ( ( const struct V_8 * const * ) V_166 ,
V_29 , & V_4 , & V_171 ) ;
if ( V_141 < 0 )
return V_141 ;
if ( V_166 [ V_306 ] ) {
const char * V_242 = F_120 ( V_166 [ V_306 ] ) ;
V_42 = F_153 ( V_242 , F_21 ( V_29 ) ,
F_22 ( V_29 ) ) ;
if ( V_42 == NULL )
return - V_173 ;
}
exp = F_194 ( ( const struct V_8 * const * ) V_166 , V_29 ,
V_42 , & V_4 , & V_171 ) ;
if ( F_122 ( exp ) )
return F_123 ( exp ) ;
V_141 = F_195 ( exp , V_106 , V_151 ) ;
F_196 ( exp ) ;
return V_141 ;
}
static void F_197 ( struct V_1 * V_2 , struct V_28 * V_29 ,
enum V_292 V_293 , int V_307 )
{
if ( ! ( V_29 -> V_31 & V_237 ) )
return;
F_198 ( V_2 , V_29 , V_293 , V_307 ) ;
}
...
memcpy ( & V_310 . V_20 . V_205 , & V_171 -> V_20 . V_205 , sizeof( V_310 . V_20 . V_205 ) ) ;
V_310 . V_20 . V_311 . V_312 = V_171 -> V_20 . V_311 . V_312 ;
...
const struct V_304 * exp )
{
struct V_28 * V_243 = exp -> V_243 ;
long V_32 = ( ( long ) exp -> V_32 . V_313 - ( long ) V_314 ) / V_33 ;
struct V_39 * V_40 ;
#ifdef F_71
struct V_8 * V_9 ;
struct V_3 V_315 = {} ;
...
if ( V_32 < 0 )
V_32 = 0 ;
if ( F_199 ( V_2 , & exp -> V_4 , V_301 ) < 0 )
goto V_12;
if ( F_200 ( V_2 , & exp -> V_4 , & exp -> V_171 ) < 0 )
goto V_12;
if ( F_199 ( V_2 ,
& V_243 -> V_318 [ V_64 ] . V_4 ,
V_319 ) < 0 )
goto V_12;
#ifdef F_71
if ( ! F_203 ( & exp -> V_320 , & V_321 ) ||
exp -> V_322 . V_312 ) {
V_9 = F_2 ( V_2 , V_323 | V_11 ) ;
if ( ! V_9 )
goto V_12;
if ( F_16 ( V_2 , V_324 , F_17 ( exp -> V_25 ) ) )
goto V_12;
V_315 . V_20 . V_21 = F_21 ( V_243 ) ;
V_315 . V_20 . V_205 = exp -> V_320 ;
V_315 . V_14 . V_15 = F_22 ( V_243 ) ;
V_315 . V_20 . V_311 = exp -> V_322 ;
if ( F_199 ( V_2 , & V_315 ,
V_325 ) < 0 )
goto V_12;
F_5 ( V_2 , V_9 ) ;
...
#endif
if ( F_16 ( V_2 , V_326 , F_17 ( V_32 ) ) ||
F_16 ( V_2 , V_327 , F_17 ( ( unsigned long ) exp ) ) ||
F_16 ( V_2 , V_328 , F_17 ( exp -> V_111 ) ) ||
F_16 ( V_2 , V_329 , F_17 ( exp -> V_330 ) ) )
goto V_12;
V_40 = F_24 ( V_243 ) ;
if ( V_40 ) {
struct V_41 * V_42 ;
V_42 = F_25 ( V_40 -> V_42 ) ;
if ( V_42 &&
F_26 ( V_2 , V_306 , V_42 -> V_46 ) )
goto V_12;
}
V_317 = F_204 ( exp -> V_331 ) ;
if ( V_317 != NULL &&
F_26 ( V_2 , V_332 , V_317 -> V_46 ) )
goto V_12;
return 0 ;
V_12:
return - 1 ;
...
static int
F_205 ( struct V_1 * V_2 , T_2 V_106 , T_2 V_90 ,
int V_113 , const struct V_304 * exp )
{
struct V_107 * V_108 ;
struct V_109 * V_110 ;
...
static int
F_206 ( unsigned int V_136 , struct V_334 * V_138 )
{
struct V_304 * exp = V_138 -> exp ;
struct V_139 * V_139 = F_207 ( exp ) ;
struct V_107 * V_108 ;
struct V_109 * V_110 ;
struct V_1 * V_2 ;
...
static int F_208 ( struct V_162 * V_163 )
{
if ( V_163 -> args [ 1 ] )
F_196 ( (struct V_304 * ) V_163 -> args [ 1 ] ) ;
return 0 ;
}
static int
F_209 ( struct V_1 * V_2 , struct V_162 * V_163 )
{
struct V_139 * V_139 = F_92 ( V_2 -> V_174 ) ;
struct V_304 * exp , * V_175 ;
struct V_109 * V_110 = F_56 ( V_163 -> V_108 ) ;
V_132 V_18 = V_110 -> V_117 ;
F_8 () ;
V_175 = (struct V_304 * ) V_163 -> args [ 1 ] ;
for (; V_163 -> args [ 0 ] < V_341 ; V_163 -> args [ 0 ] ++ ) {
V_184:
F_210 (exp, &nf_ct_expect_hash[cb->args[0]],
hnode) {
...
static int
F_211 ( struct V_1 * V_2 , struct V_162 * V_163 )
{
struct V_304 * exp , * V_175 ;
struct V_109 * V_110 = F_56 ( V_163 -> V_108 ) ;
...
V_175 = (struct V_304 * ) V_163 -> args [ 1 ] ;
V_184:
F_210 (exp, &help->expectations, lnode) {
if ( V_18 && exp -> V_4 . V_20 . V_21 != V_18 )
continue;
if ( V_163 -> args [ 1 ] ) {
if ( exp != V_175 )
...
if ( F_205 ( V_2 , F_104 ( V_163 -> V_2 ) . V_106 ,
V_163 -> V_108 -> V_187 ,
V_339 ,
exp ) < 0 ) {
if ( ! F_102 ( & exp -> V_105 ) )
...
V_141 = F_118 ( V_166 , & V_4 , V_319 ,
V_205 , NULL ) ;
if ( V_141 < 0 )
return V_141 ;
V_141 = F_113 ( V_166 [ V_342 ] , & V_24 ) ;
if ( V_141 < 0 )
return V_141 ;
V_177 = F_127 ( V_139 , & V_24 , & V_4 ) ;
if ( ! V_177 )
...
static int F_213 ( struct V_139 * V_139 , struct V_203 * V_204 ,
struct V_1 * V_2 , const struct V_107 * V_108 ,
const struct V_8 * const V_166 [] )
{
struct V_3 V_4 ;
...
if ( V_108 -> V_208 & V_209 ) {
if ( V_166 [ V_319 ] )
return F_212 ( V_139 , V_204 , V_2 , V_108 , V_166 ) ;
else {
struct V_210 V_211 = {
. V_212 = F_209 ,
. V_213 = F_208 ,
...
if ( V_141 < 0 )
return V_141 ;
exp = F_214 ( V_139 , & V_24 , & V_4 ) ;
if ( ! exp )
return - V_206 ;
if ( V_166 [ V_327 ] ) {
T_7 V_26 = F_89 ( V_166 [ V_327 ] ) ;
...
F_8 () ;
V_141 = F_205 ( V_207 , F_104 ( V_2 ) . V_106 ,
V_108 -> V_187 , V_339 , exp ) ;
F_11 () ;
F_196 ( exp ) ;
if ( V_141 <= 0 )
goto free;
...
static int F_215 ( struct V_139 * V_139 , struct V_203 * V_204 ,
struct V_1 * V_2 , const struct V_107 * V_108 ,
const struct V_8 * const V_166 [] )
{
struct V_304 * exp ;
...
char * V_46 = F_120 ( V_166 [ V_306 ] ) ;
struct V_39 * V_345 ;
F_136 ( & V_244 ) ;
for ( V_85 = 0 ; V_85 < V_341 ; V_85 ++ ) {
F_218 (exp, next,
&nf_ct_expect_hash[i],
hnode) {
if ( ! F_103 ( F_207 ( exp ) , V_139 ) )
continue;
V_345 = F_24 ( exp -> V_243 ) ;
if ( ! strcmp ( V_345 -> V_42 -> V_46 , V_46 ) &&
F_216 ( & exp -> V_32 ) ) {
F_217 ( exp ,
F_104 ( V_2 ) . V_106 ,
F_126 ( V_108 ) ) ;
...
static int
F_219 ( struct V_304 * V_346 ,
const struct V_8 * const V_166 [] )
{
if ( V_166 [ V_326 ] ) {
if ( ! F_216 ( & V_346 -> V_32 ) )
return - V_248 ;
V_346 -> V_32 . V_313 = V_314 +
F_88 ( F_89 ( V_166 [ V_326 ] ) ) * V_33 ;
F_220 ( & V_346 -> V_32 ) ;
}
return 0 ;
}
static int
F_221 ( const struct V_8 * V_51 ,
struct V_304 * exp ,
V_132 V_205 )
{
#ifdef F_71
struct V_8 * V_189 [ V_347 + 1 ] ;
struct V_3 V_315 = {} ;
int V_141 ;
V_141 = F_109 ( V_189 , V_347 , V_51 , V_348 ) ;
if ( V_141 < 0 )
return V_141 ;
if ( ! V_189 [ V_324 ] || ! V_189 [ V_325 ] )
return - V_195 ;
...
if ( V_141 < 0 )
return V_141 ;
exp -> V_320 = V_315 . V_20 . V_205 ;
exp -> V_322 = V_315 . V_20 . V_311 ;
exp -> V_25 = F_88 ( F_89 ( V_189 [ V_324 ] ) ) ;
return 0 ;
#else
return - V_173 ;
#endif
...
static struct V_304 *
F_194 ( const struct V_8 * const V_166 [] , struct V_28 * V_29 ,
struct V_41 * V_42 ,
struct V_3 * V_4 ,
struct V_3 * V_171 )
{
...
exp -> V_32 . V_313 =
V_314 + F_88 ( F_89 ( V_166 [ V_326 ] ) ) * V_33 ;
exp -> V_111 = V_351 ;
if ( V_166 [ V_328 ] ) {
exp -> V_111 |=
F_88 ( F_89 ( V_166 [ V_328 ] ) ) ;
}
} else {
if ( V_166 [ V_328 ] ) {
exp -> V_111 = F_88 ( F_89 ( V_166 [ V_328 ] ) ) ;
exp -> V_111 &= ~ V_351 ;
} else
exp -> V_111 = 0 ;
}
if ( V_166 [ V_332 ] ) {
const char * V_46 = F_120 ( V_166 [ V_332 ] ) ;
struct V_316 * V_317 ;
V_317 = F_223 ( V_46 ) ;
if ( V_317 == NULL ) {
V_141 = - V_195 ;
...
exp -> V_171 . V_20 . V_311 . V_312 = V_171 -> V_20 . V_311 . V_312 ;
if ( V_166 [ V_323 ] ) {
V_141 = F_221 ( V_166 [ V_323 ] ,
exp , F_21 ( V_29 ) ) ;
if ( V_141 < 0 )
goto V_350;
}
...
if ( V_141 < 0 )
return V_141 ;
V_141 = F_118 ( V_166 , & V_171 , V_302 ,
V_205 , NULL ) ;
if ( V_141 < 0 )
return V_141 ;
V_141 = F_118 ( V_166 , & F_47 , V_319 ,
V_205 , NULL ) ;
if ( V_141 < 0 )
return V_141 ;
...
exp = F_194 ( V_166 , V_29 , V_42 , & V_4 , & V_171 ) ;
if ( F_122 ( exp ) ) {
V_141 = F_123 ( exp ) ;
goto V_353;
}
...
static int F_225 ( struct V_139 * V_139 , struct V_203 * V_204 ,
struct V_1 * V_2 , const struct V_107 * V_108 ,
const struct V_8 * const V_166 [] )
{
struct V_3 V_4 ;
...
return V_141 ;
F_136 ( & V_244 ) ;
exp = F_226 ( V_139 , & V_24 , & V_4 ) ;
if ( ! exp ) {
F_137 ( & V_244 ) ;
V_141 = - V_206 ;
if ( V_108 -> V_208 & V_147 ) {
V_141 = F_224 ( V_139 , & V_24 , V_166 , V_205 ,
F_104 ( V_2 ) . V_106 ,
F_126 ( V_108 ) ) ;
}
return V_141 ;
...
V_141 = - V_265 ;
if ( ! ( V_108 -> V_208 & V_148 ) )
V_141 = F_219 ( exp , V_166 ) ;
F_137 ( & V_244 ) ;
return V_141 ;
}
static int
F_227 ( struct V_1 * V_2 , T_2 V_106 , T_2 V_90 , int V_217 ,
const struct V_266 * V_267 )
{
struct V_107 * V_108 ;
struct V_109 * V_110 ;
...
V_110 -> V_118 = V_119 ;
V_110 -> V_120 = F_14 ( V_217 ) ;
if ( F_16 ( V_2 , V_355 , F_17 ( V_267 -> V_356 ) ) ||
F_16 ( V_2 , V_357 , F_17 ( V_267 -> V_358 ) ) ||
F_16 ( V_2 , V_359 , F_17 ( V_267 -> V_360 ) ) )
goto V_12;
F_59 ( V_2 , V_108 ) ;
return V_2 -> V_77 ;
V_12:
...
static int
F_228 ( struct V_1 * V_2 , struct V_162 * V_163 )
{
int V_217 ;
struct V_139 * V_139 = F_92 ( V_2 -> V_174 ) ;
if ( V_163 -> args [ 0 ] == V_220 )
...
continue;
V_267 = F_135 ( V_139 -> V_29 . V_287 , V_217 ) ;
if ( F_227 ( V_2 , F_104 ( V_163 -> V_2 ) . V_106 ,
V_163 -> V_108 -> V_187 ,
V_217 , V_267 ) < 0 )
break;
}
...
static int F_229 ( struct V_139 * V_139 , struct V_203 * V_204 ,
struct V_1 * V_2 ,
const struct V_107 * V_108 ,
const struct V_8 * const V_166 [] )
{
...
static int T_8 F_230 ( struct V_139 * V_139 )
{
#ifdef F_231
int V_7 ;
V_7 = F_232 ( V_139 , & V_361 ) ;
if ( V_7 < 0 ) {
F_233 ( L_5 ) ;
goto V_350;
}
V_7 = F_234 ( V_139 , & V_362 ) ;
if ( V_7 < 0 ) {
F_233 ( L_6 ) ;
goto V_363;
}
...
static void F_236 ( struct V_139 * V_139 )
{
#ifdef F_231
F_237 ( V_139 , & V_362 ) ;
F_235 ( V_139 , & V_361 ) ;
...
static void T_9 F_238 ( struct V_364 * V_365 )
{
struct V_139 * V_139 ;
F_239 (net, net_exit_list, exit_list)
F_236 ( V_139 ) ;
}
