...
V_10 -> V_22 ,
V_29 ) ;
V_10 -> V_30 = F_9 ( F_4 ( V_10 ) , sizeof( V_31 ) , V_17 ) ;
if ( ! V_10 -> V_30 ) {
...
return 0 ;
V_16 -> V_35 = 4 * V_2 ;
V_16 -> V_34 = F_15 ( V_16 -> V_35 , V_36 | V_25 ) ;
if ( ! V_16 -> V_34 )
return - V_26 ;
...
static void F_19 ( struct V_15 * V_16 , V_31 V_39 )
{
V_31 V_40 ;
unsigned long V_17 ;
F_17 ( & V_16 -> V_38 , V_17 ) ;
V_40 = F_20 ( V_16 -> V_41 + V_42 ) ;
if ( V_40 & V_43 ) {
F_18 ( & V_16 -> V_38 , V_17 ) ;
return;
}
F_21 ( V_16 -> V_37 , V_16 -> V_41 + V_44 ) ;
V_40 &= ~ V_45 ;
V_40 |= V_39 | V_43 ;
F_22 ( V_16 -> V_28 , L_1 ) ;
F_21 ( V_40 , V_16 -> V_41 + V_42 ) ;
F_18 ( & V_16 -> V_38 , V_17 ) ;
}
...
static void F_24 ( struct V_15 * V_16 , struct V_9 * V_10 ,
int V_46 )
{
struct V_47 * V_48 ;
T_1 V_49 , V_50 , V_4 ;
...
int F_34 ( struct V_15 * V_16 , struct V_9 * V_10 ,
T_3 V_33 )
{
int V_62 ;
if ( V_10 -> V_63 ) {
...
void F_35 ( struct V_15 * V_16 , struct V_9 * V_10 )
{
unsigned long V_17 ;
F_12 ( V_16 , V_10 ) ;
F_17 ( & V_16 -> V_38 , V_17 ) ;
...
static T_2 F_36 ( struct V_9 * V_10 , T_1 V_70 )
{
if ( V_10 -> V_13 == V_6 )
...
V_10 -> V_52 = F_37 ( V_16 , V_10 ,
& V_71 ) ;
V_73 = F_1 ( V_10 -> V_52 ) ;
}
V_10 -> V_75 = V_10 -> V_76 = F_36 ( V_10 , V_73 ) ;
return V_71 ;
}
...
V_79 = V_10 -> V_13 == V_6 ?
V_100 : V_101 ;
F_47 (qtd, &qh->qtd_list, qtd_list_entry) {
if ( V_78 -> V_102 &&
V_78 -> V_85 ==
V_78 -> V_83 -> V_94 )
continue;
...
struct V_47 * V_48 = V_10 -> V_51 ;
int V_96 = 0 ;
F_22 ( V_16 -> V_28 , L_8 , V_119 , V_10 ,
( unsigned long ) V_48 -> V_118 , V_48 -> V_107 ) ;
F_47 (qtd, &qh->qtd_list, qtd_list_entry) {
F_22 ( V_16 -> V_28 , L_9 , V_78 ) ;
if ( V_96 ) {
...
void F_50 ( struct V_15 * V_16 , struct V_9 * V_10 )
{
struct V_47 * V_48 = V_10 -> V_51 ;
T_1 V_71 = 0 ;
switch ( V_48 -> V_11 ) {
...
F_54 ( V_16 , V_78 , V_139 ) ;
}
F_55 ( V_16 , V_78 , V_10 ) ;
}
return;
}
F_57 (qtd, qtd_tmp, &qh->qtd_list, qtd_list_entry) {
if ( ! V_78 -> V_102 )
break;
if ( V_3 != V_78 -> V_103 ) {
F_22 ( V_16 -> V_28 ,
...
struct V_77 * V_142 ;
T_1 V_98 ;
V_125 = F_52 ( V_16 , V_48 , V_78 , V_10 ,
V_3 ) ;
if ( V_125 < 0 )
return;
...
V_112 ;
F_22 ( V_16 -> V_28 , L_17 , V_124 , V_83 ) ;
if ( V_131 == V_137 ) {
F_26 ( V_16 -> V_28 , L_18 ) ;
V_83 -> V_90 = - V_140 ;
return 1 ;
...
V_155 = F_59 ( V_16 , V_48 , V_78 , V_80 ,
V_131 , V_30 ,
V_146 ) ;
if ( V_155 || ( * V_146 && V_83 -> V_90 != - V_156 ) ) {
F_54 ( V_16 , V_78 , V_83 -> V_90 ) ;
F_55 ( V_16 , V_78 , V_10 ) ;
F_22 ( V_16 -> V_28 , L_27 ,
V_155 , * V_146 ) ;
return V_155 ;
...
F_63 (qtd_item, qtd_tmp, &qh->qtd_list) {
int V_49 ;
int V_159 ;
V_78 = F_64 ( V_158 , struct V_77 , V_145 ) ;
V_146 = 0 ;
V_159 = V_78 -> V_96 ;
for ( V_49 = 0 ; V_49 < V_159 ; V_49 ++ ) {
if ( F_60 ( V_16 , V_48 , V_153 , V_78 ,
V_154 , V_131 ,
& V_146 ) ) {
V_78 = NULL ;
goto V_143;
