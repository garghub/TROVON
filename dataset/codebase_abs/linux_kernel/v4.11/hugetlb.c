...
unsigned long F_377 ( struct V_18 * V_19 ,
...
long F_382 ( struct V_16 * V_16 , long V_255 , long V_256 ,
long V_350 )
{
struct V_7 * V_8 = F_30 ( V_16 ) ;
...
static unsigned long F_383 ( struct V_18 * V_351 ,
struct V_18 * V_19 ,
...
if ( F_384 ( V_147 ) != F_384 ( V_352 ) ||
V_62 != V_358 ||
V_353 < V_351 -> V_51 || V_351 -> V_258 < V_355 )
return 0 ;
return V_352 ;
}
static bool F_385 ( struct V_18 * V_19 , unsigned long V_147 )
{
...
T_9 * F_386 ( struct V_250 * V_251 , unsigned long V_147 , T_15 * V_360 )
{
struct V_18 * V_19 = F_387 ( V_251 , V_147 ) ;
struct V_64 * V_65 = V_19 -> V_20 -> V_66 ;
...
T_11 * V_286 ;
if ( ! F_385 ( V_19 , V_147 ) )
return ( T_9 * ) F_388 ( V_251 , V_360 , V_147 ) ;
F_331 ( V_65 ) ;
F_332 (svma, &mapping->i_mmap, idx, idx) {
if ( V_351 == V_19 )
continue;
V_352 = F_383 ( V_351 , V_19 , V_147 , V_164 ) ;
if ( V_352 ) {
...
F_2 ( V_286 ) ;
V_45:
V_265 = ( T_9 * ) F_388 ( V_251 , V_360 , V_147 ) ;
F_333 ( V_65 ) ;
return V_265 ;
}
int F_316 ( struct V_250 * V_251 , unsigned long * V_147 , T_9 * V_264 )
{
T_16 * V_364 = F_392 ( V_251 , * V_147 ) ;
T_17 * V_365 = F_393 ( V_364 , * V_147 ) ;
T_15 * V_360 = F_394 ( V_365 , * V_147 ) ;
...
T_15 * V_360 ;
T_9 * V_265 = NULL ;
V_364 = F_392 ( V_251 , V_147 ) ;
V_365 = F_393 ( V_364 , V_147 ) ;
V_360 = F_397 ( V_251 , V_365 , V_147 ) ;
if ( V_360 ) {
if ( V_273 == V_356 ) {
V_265 = ( T_9 * ) V_360 ;
} else {
F_10 ( V_273 != V_367 ) ;
if ( F_398 () && F_389 ( * V_360 ) )
V_265 = F_386 ( V_251 , V_147 , V_360 ) ;
else
V_265 = ( T_9 * ) F_388 ( V_251 , V_360 , V_147 ) ;
}
}
F_10 ( V_265 && F_288 ( * V_265 ) && ! F_399 ( * V_265 ) ) ;
return V_265 ;
}
...
if ( ! F_401 ( * V_365 ) )
return NULL ;
V_360 = F_394 ( V_365 , V_147 ) ;
if ( ! F_402 ( * V_360 ) )
return NULL ;
if ( F_403 ( * V_360 ) )
return ( T_9 * ) V_360 ;
V_368 = F_404 ( V_360 , V_147 ) ;
return ( T_9 * ) V_368 ;
}
struct V_74 * __weak
F_405 ( struct V_250 * V_251 , unsigned long V_50 ,
int V_242 )
{
return F_182 ( - V_202 ) ;
}
...
T_9 V_265 ;
V_42:
V_286 = F_407 ( V_251 , V_368 ) ;
F_9 ( V_286 ) ;
if ( ! F_408 ( * V_368 ) )
goto V_45;
V_265 = F_283 ( ( T_9 * ) V_368 ) ;
if ( F_288 ( V_265 ) ) {
V_74 = F_409 ( * V_368 ) + ( ( V_50 & ~ V_369 ) >> V_184 ) ;
if ( V_70 & V_370 )
F_308 ( V_74 ) ;
} else {
if ( F_286 ( V_265 ) ) {
F_2 ( V_286 ) ;
F_410 ( V_251 , ( T_9 * ) V_368 , V_286 ) ;
goto V_42;
}
}
V_45:
...
struct V_74 * __weak
F_411 ( struct V_250 * V_251 , unsigned long V_50 ,
T_15 * V_360 , int V_70 )
{
if ( V_70 & V_370 )
return NULL ;
...
bool F_414 ( struct V_74 * V_74 , struct V_25 * V_181 )
{
bool V_13 = true ;
F_115 ( ! F_123 ( V_74 ) , V_74 ) ;
F_9 ( & V_126 ) ;
if ( ! F_122 ( V_74 ) || ! F_415 ( V_74 ) ) {
V_13 = false ;
goto V_372;
}
F_127 ( V_74 ) ;
F_416 ( & V_74 -> V_76 , V_181 ) ;
V_372:
F_2 ( & V_126 ) ;
return V_13 ;
}
void F_417 ( struct V_74 * V_74 )
{
F_115 ( ! F_123 ( V_74 ) , V_74 ) ;
F_9 ( & V_126 ) ;
F_125 ( V_74 ) ;
F_416 ( & V_74 -> V_76 , & ( F_130 ( V_74 ) ) -> V_80 ) ;
F_2 ( & V_126 ) ;
F_138 ( V_74 ) ;
}
