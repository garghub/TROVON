...
F_62 ( V_462 , & V_5 -> V_7 -> V_9 ) ;
F_202 ( V_5 -> V_7 , V_429 ) ;
F_203 ( V_5 -> V_7 , 4096 ) ;
F_204 ( V_5 -> V_7 , 0xffff ) ;
F_205 ( V_5 -> V_7 , 0x400000 ) ;
F_206 ( V_5 -> V_7 , 4096 ) ;
F_207 ( V_5 -> V_7 , V_5 -> V_2 -> V_463 ) ;
if ( V_5 -> V_182 == true ) {
F_4 ( V_464 , & V_5 -> V_7 -> V_9 ) ;
V_5 -> V_7 -> V_465 . V_466 = 4096 ;
F_208 ( V_5 -> V_7 ,
V_211 * V_212 ) ;
V_5 -> V_7 -> V_465 . V_467 = 0 ;
}
if ( ! ( F_90 ( V_5 , & V_407 ) ) ) {
F_5 ( & V_5 -> V_2 -> V_10 ,
L_128 ) ;
...
static void F_223 ( struct V_13 * V_14 , void * V_107 , bool V_473 )
{
struct V_4 * V_5 = (struct V_4 * ) V_107 ;
struct V_12 * V_16 ;
if ( F_45 ( ! V_473 ) )
...
static void F_230 ( int V_474 )
{
V_475 [ V_474 ] -- ;
}
static int F_231 ( int V_476 )
{
int V_474 , V_477 , V_478 ;
...
{
if ( V_2 -> V_491 && V_2 -> V_491 -> V_492 ) {
if ( V_2 -> V_491 -> V_492 -> V_488 == V_493 &&
( ( V_2 -> V_491 -> V_492 -> V_192 & 0xff00 ) == 0x5a00 ) ) {
F_237 ( V_5 , V_2 -> V_491 -> V_492 ) ;
} else {
struct V_1 * V_494 = V_2 -> V_491 -> V_492 ;
if ( V_494 -> V_491 &&
V_494 -> V_491 -> V_495 &&
V_494 -> V_491 -> V_495 -> V_492 &&
V_494 -> V_491 -> V_495 -> V_492 -> V_488 ==
V_493 &&
( V_494 -> V_491 -> V_495 -> V_492 -> V_192 &
0xff00 ) == 0x5a00 ) {
F_237 ( V_5 ,
V_494 -> V_491 -> V_495 -> V_492 ) ;
}
...
char V_498 [ 256 ] ;
const struct V_479 * V_480 ;
int V_474 , V_43 = 0 , V_499 = 0 ;
int V_500 = V_501 ;
unsigned long V_86 ;
V_500 = F_242 ( V_2 -> V_491 ) ;
if ( V_500 != V_501 ) {
if ( ! F_243 ( V_500 ) )
V_500 = F_235 () ;
} else {
...
F_47 ( & V_2 -> V_10 , L_137 ,
V_500 , F_242 ( V_2 -> V_491 ) , F_244 ( & V_2 -> V_10 ) ,
F_245 ( F_246 () ) , F_246 () ) ;
V_5 = F_159 ( sizeof( struct V_4 ) , V_143 , V_500 ) ;
if ( V_5 == NULL ) {
F_37 ( & V_2 -> V_10 ,
L_138 ) ;
return - V_214 ;
...
F_253 ( & V_5 -> V_505 ) ;
F_253 ( & V_5 -> V_506 ) ;
memset ( V_5 -> V_507 , 0 , 32 ) ;
snprintf ( V_5 -> V_507 , 31 , L_142 , V_5 -> V_123 ) ;
V_5 -> V_119 = F_254 ( V_5 -> V_507 ) ;
if ( ! V_5 -> V_119 ) {
...
V_480 = F_232 ( V_5 -> V_373 ) ;
if ( ! F_255 ( V_480 ) ) {
F_234 (cpu, node_mask)
{
snprintf ( & V_498 [ V_499 ] , 256 - V_499 , L_144 , V_474 ) ;
V_499 = strlen ( V_498 ) ;
}
F_47 ( & V_2 -> V_10 , L_145 ,
V_5 -> V_373 ,
...
F_258 (cpu) {
memset ( V_498 , 0 , sizeof( V_498 ) ) ;
for ( V_43 = 0 , V_499 = 0 ; V_43 < V_116 ; V_43 ++ ) {
if ( V_5 -> V_117 [ V_43 ] . V_118 == V_474 ) {
snprintf ( & V_498 [ V_499 ] , 256 - V_499 , L_144 , V_43 ) ;
V_499 = strlen ( V_498 ) ;
}
}
if ( V_499 )
F_47 ( & V_2 -> V_10 , L_148 , V_474 , V_498 ) ;
}
F_259 ( & V_5 -> V_117 [ 0 ] . V_117 , V_509 ) ;
F_259 ( & V_5 -> V_117 [ 1 ] . V_117 , V_510 ) ;
F_259 ( & V_5 -> V_117 [ 2 ] . V_117 , V_511 ) ;
F_259 ( & V_5 -> V_117 [ 3 ] . V_117 , V_512 ) ;
F_259 ( & V_5 -> V_117 [ 4 ] . V_117 , V_513 ) ;
F_259 ( & V_5 -> V_117 [ 5 ] . V_117 , V_514 ) ;
F_259 ( & V_5 -> V_117 [ 6 ] . V_117 , V_515 ) ;
F_259 ( & V_5 -> V_117 [ 7 ] . V_117 , V_516 ) ;
F_260 ( V_2 ) ;
V_61 = F_261 ( V_2 ) ;
if ( V_61 ) {
F_5 ( & V_2 -> V_10 ,
...
static int F_272 ( struct V_1 * V_2 , T_15 V_520 )
{
int V_61 = 0 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( ! V_5 ) {
