...
if ( ! F_26 ( V_35 ) )
return - V_45 ;
if ( F_27 ( & V_39 , V_33 , sizeof( V_39 ) ) )
return - V_46 ;
if ( V_39 . V_4 >= F_28 ( V_2 , V_2 -> V_47 . V_48 ) ||
V_39 . V_6 > F_28 ( V_2 , V_2 -> V_49 ) ||
V_39 . V_50 < V_2 -> V_47 . V_51 )
return - V_52 ;
V_4 = F_29 ( V_39 . V_4 ) ;
V_5 = V_4 + F_30 ( V_39 . V_50 ) - 1 ;
V_6 = F_29 ( F_31 ( V_53 , V_36 , V_39 . V_6 ) ) ;
...
if ( V_42 )
return V_42 ;
V_39 . V_50 = F_28 ( V_2 , V_7 ) ;
if ( F_33 ( V_33 , & V_39 , sizeof( V_39 ) ) )
return - V_46 ;
return 0 ;
}
