...
int V_17 ;
for ( V_17 = 0 ; V_17 < V_2 -> V_55 ; V_17 ++ )
V_29 |= F_36 ( V_2 -> V_23 [ V_17 ] ) ;
return V_29 ;
}
int F_37 ( struct V_22 * V_8 )
{
struct V_1 * V_2 ;
T_1 V_29 = 0 ;
V_2 = F_28 ( V_8 ) ;
if ( V_2 -> V_55 )
V_29 = F_38 ( V_2 -> V_23 [ 0 ] ) ;
return V_29 ;
}
...
V_2 -> V_55 = V_28 ;
V_23 = F_46 ( V_58 , sizeof( struct V_15 * ) * V_28 , V_31 ) ;
if ( ! V_23 )
goto V_61;
V_2 -> V_23 = V_23 ;
V_2 -> V_8 = V_8 ;
...
V_57 = F_16 ( sizeof( struct V_38 ) * V_59 , V_31 ) ;
if ( ! V_57 )
goto V_66;
if ( ! V_8 -> V_37 ) {
F_2 ( & V_8 -> V_9 , L_13 ,
...
F_44 ( V_2 , & V_57 [ V_8 -> V_37 ] ) ;
}
V_29 = F_47 ( V_8 , V_57 , V_59 ) ;
F_24 ( V_57 ) ;
if ( V_29 )
goto V_66;
V_65:
...
if ( ! V_16 )
return F_48 ( - V_33 ) ;
return F_50 ( V_68 , V_69 , V_58 , 1 , V_70 ,
V_71 ) ;
}
struct V_22 T_2 * F_50 ( const char * V_68 ,
int V_69 ,
struct V_15 * * V_58 ,
int V_28 , void * V_70 ,
int V_71 )
...
if ( V_8 -> V_73 != - 1 )
F_52 ( & V_8 -> V_9 , L_16 , V_8 -> V_39 , V_8 -> V_73 ) ;
else
F_52 ( & V_8 -> V_9 , L_17 , V_8 -> V_39 ) ;
V_2 = F_19 ( V_8 , V_58 , V_28 ) ;
if ( F_5 ( V_2 ) )
goto V_74;
V_29 = F_53 ( V_8 , V_70 , V_71 ) ;
if ( V_29 )
goto V_75;
V_29 = F_54 ( V_8 ) ;
if ( V_29 )
...
static int F_57 ( struct V_76 * V_9 )
{
struct V_22 * V_8 = F_26 ( V_9 ) ;
int V_29 ;
V_29 = F_58 ( V_9 ) ;
...
static int F_59 ( struct V_76 * V_9 )
{
struct V_22 * V_8 = F_26 ( V_9 ) ;
int V_29 ;
V_29 = F_22 ( V_8 ) ;
...
static int F_61 ( struct V_76 * V_9 )
{
F_62 ( V_9 , L_20 , V_67 ) ;
return - V_13 ;
}
...
static int F_67 ( struct V_76 * V_9 )
{
struct V_22 * V_8 = F_26 ( V_9 ) ;
struct V_1 * V_2 = F_28 ( V_8 ) ;
if ( V_2 -> V_35 & V_78 ) {
...
struct V_76 * F_75 ( const char * V_27 )
{
struct V_15 * V_16 ;
if ( ! V_27 ) {
F_68 ( 1 , L_24 , V_67 ) ;
...
static int T_2 F_78 ( struct V_76 * V_9 , void * V_82 )
{
struct V_22 * V_8 = F_26 ( V_9 ) ;
struct V_1 * V_2 = F_28 ( V_8 ) ;
int V_17 ;
