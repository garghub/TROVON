...
void F_51 ( struct V_42 * V_43 ,
struct V_59 * V_60 )
{
struct V_1 * V_2 = V_43 -> V_48 -> V_2 ;
struct V_61 * V_62 = F_52 ( V_43 -> V_37 ) ;
struct V_63 * V_64 = F_53 ( V_43 -> V_37 ) ;
unsigned int V_65 , V_66 ;
T_2 V_67 , V_68 , V_69 ;
T_2 V_70 = V_64 -> V_11 ;
bool V_71 ;
F_54 ( V_43 ) ;
F_55 ( V_43 -> V_37 , V_2 -> V_72 ) ;
V_64 -> V_11 &= ~ V_73 ;
V_65 = F_56 ( V_43 -> V_37 ) ;
if ( F_57 ( V_2 , V_74 ) )
F_58 ( V_43 -> V_37 , V_65 ) ;
...
if ( ! ( V_70 & V_104 ) ) {
if ( F_57 ( V_2 , V_105 ) )
F_62 ( V_2 -> V_28 , V_43 -> V_37 ) ;
else
F_63 ( V_2 -> V_28 , V_43 -> V_37 ) ;
} else
F_64 ( V_43 -> V_37 ) ;
V_43 -> V_37 = NULL ;
V_43 -> V_11 = 0 ;
...
F_39 ( V_43 , V_107 ) ;
F_46 ( & V_43 -> V_48 -> V_108 ) ;
if ( ! F_65 ( V_43 -> V_48 ) )
F_66 ( V_43 -> V_48 ) ;
F_48 ( & V_43 -> V_48 -> V_108 ) ;
}
...
static T_2 * F_69 ( T_2 * V_18 , unsigned int V_109 , T_2 V_110 )
{
...
{
struct V_1 * V_2 =
F_23 ( V_26 , struct V_1 , V_118 ) ;
if ( ! F_3 ( V_31 , & V_2 -> V_11 ) )
return;
if ( ! F_3 ( V_33 , & V_2 -> V_11 ) )
F_71 ( V_2 , & V_2 -> V_28 -> V_119 ,
V_120 ) ;
}
...
continue;
#undef F_74
if ( ! F_75 ( V_123 -> V_127 , V_43 -> V_128 ) )
continue;
if ( ! F_75 ( V_123 -> V_128 , V_43 -> V_127 ) )
continue;
F_46 ( & V_2 -> V_55 ) ;
V_43 -> V_56 = 1 ;
F_48 ( & V_2 -> V_55 ) ;
...
return;
V_2 -> V_140 = V_141 ;
V_133 = F_69 ( V_37 -> V_18 , V_37 -> V_109 - V_125 , V_142 ) ;
if ( ! V_133 )
return;
...
V_135 = F_78 ( V_132 , V_134 , V_2 -> V_139 ) ;
V_135 |= ( V_132 -> V_143 & 0x01 ) ;
if ( ! V_135 && ! F_3 ( V_33 , & V_2 -> V_11 ) )
F_79 ( V_2 -> V_144 , & V_2 -> V_118 ) ;
}
...
signal = F_81 ( V_122 -> V_150 , signal ) ;
V_146 = & V_2 -> V_154 [ V_2 -> V_155 ] ;
for ( V_66 = 0 ; V_66 < V_146 -> V_156 ; V_66 ++ ) {
V_148 = F_82 ( V_146 -> V_157 [ V_66 ] . V_158 ) ;
if ( ( ( type == V_159 ) &&
( V_148 -> V_160 == signal ) ) ||
( ( type == V_161 ) &&
( V_148 -> V_162 == signal ) ) ||
...
void F_84 ( struct V_42 * V_43 , T_5 V_166 )
{
struct V_1 * V_2 = V_43 -> V_48 -> V_2 ;
struct V_121 V_122 ;
struct V_36 * V_37 ;
...
( V_122 . V_137 & V_176 ) )
F_58 ( V_43 -> V_37 , V_65 ) ;
F_89 ( V_43 -> V_37 , V_122 . V_124 ) ;
V_67 = F_80 ( V_2 , & V_122 ) ;
if ( V_122 . V_150 == V_164 ||
V_122 . V_150 == V_165 )
V_122 . V_11 |= V_177 ;
F_76 ( V_2 , V_43 -> V_37 , & V_122 ) ;
F_72 ( V_2 , V_43 -> V_37 , & V_122 ) ;
F_90 ( V_2 , V_43 -> V_37 , & V_122 ) ;
F_91 ( V_2 , & V_122 ) ;
F_61 ( V_2 , V_178 , V_43 ) ;
V_168 = F_92 ( V_43 -> V_37 ) ;
...
static void F_94 ( struct V_190 * V_43 ,
const int V_191 , const int V_192 ,
const int V_193 )
{
V_43 -> V_181 = V_191 <= 14 ? V_194 : V_195 ;
V_43 -> V_196 = F_95 ( V_191 ,
V_43 -> V_181 ) ;
V_43 -> V_158 = V_193 ;
V_43 -> V_197 = V_192 ;
V_43 -> V_198 = 0xff ;
}
static void F_96 ( struct V_199 * V_43 ,
...
void F_97 ( struct V_1 * V_2 , T_2 * V_204 )
{
const char * V_205 ;
V_205 = F_98 ( V_2 -> V_206 -> V_207 ) ;
if ( V_205 )
F_99 ( V_204 , V_205 ) ;
if ( ! F_100 ( V_204 ) ) {
F_101 ( V_204 ) ;
...
V_212 += 8 ;
V_211 = F_104 ( V_209 -> V_216 , sizeof( * V_211 ) , V_217 ) ;
if ( ! V_211 )
return - V_218 ;
V_88 = F_104 ( V_212 , sizeof( * V_88 ) , V_217 ) ;
if ( ! V_88 )
goto V_219;
for ( V_66 = 0 ; V_66 < V_212 ; V_66 ++ )
F_96 ( & V_88 [ V_66 ] , V_66 , F_82 ( V_66 ) ) ;
...
F_107 ( V_2 -> V_28 ) ;
if ( F_42 ( V_2 -> V_28 -> V_224 -> V_154 [ V_194 ] ) ) {
F_105 ( V_2 -> V_28 -> V_224 -> V_154 [ V_194 ] -> V_211 ) ;
F_105 ( V_2 -> V_28 -> V_224 -> V_154 [ V_194 ] -> V_157 ) ;
V_2 -> V_28 -> V_224 -> V_154 [ V_194 ] = NULL ;
V_2 -> V_28 -> V_224 -> V_154 [ V_195 ] = NULL ;
}
F_105 ( V_2 -> V_209 . V_220 ) ;
}
...
V_2 -> V_28 -> V_72 =
F_109 (unsigned int, IEEE80211_TX_STATUS_HEADROOM,
rt2x00dev->extra_tx_headroom) ;
if ( F_57 ( V_2 , V_74 ) )
V_2 -> V_28 -> V_72 += V_231 ;
else if ( F_57 ( V_2 , V_232 ) )
V_2 -> V_28 -> V_72 += V_233 ;
...
V_255 -> V_260 = F_124 ( V_38 ) ;
#ifdef F_125
V_255 -> V_260 |= F_124 ( V_40 ) ;
#endif
...
static unsigned int F_126 ( struct V_1 * V_2 )
{
if ( F_32 ( ! V_2 -> V_238 ) )
return 0 ;
if ( F_33 ( V_2 ) )
...
F_129 ( & V_2 -> V_55 ) ;
F_7 ( V_31 , & V_2 -> V_11 ) ;
V_2 -> V_28 -> V_277 = sizeof( struct V_20 ) ;
V_2 -> V_28 -> V_224 -> V_278 [ V_279 - 1 ] =
( V_2 -> V_7 -> V_8 - 1 ) ;
V_2 -> V_144 =
F_132 ( L_6 , 0 , F_133 ( V_2 -> V_28 -> V_224 ) ) ;
if ( ! V_2 -> V_144 ) {
V_250 = - V_218 ;
goto exit;
}
F_134 ( & V_2 -> V_27 , F_22 ) ;
F_135 ( & V_2 -> V_30 , F_25 ) ;
F_134 ( & V_2 -> V_118 , F_70 ) ;
V_250 = V_2 -> V_7 -> V_12 -> V_280 ( V_2 ) ;
if ( V_250 ) {
F_26 ( V_2 , L_7 ) ;
goto exit;
}
...
goto exit;
V_2 -> V_72 = F_126 ( V_2 ) ;
V_2 -> V_28 -> V_224 -> V_281 = F_124 ( V_282 ) ;
if ( V_2 -> V_283 -> V_239 > 0 )
V_2 -> V_28 -> V_224 -> V_281 |=
F_124 ( V_39 ) |
#ifdef F_125
F_124 ( V_40 ) |
#endif
...
int F_151 ( struct V_1 * V_2 , T_8 V_285 )
{
F_152 ( V_2 , L_9 ) ;
...
F_153 ( V_2 ) ;
F_147 ( V_2 ) ;
if ( V_2 -> V_7 -> V_12 -> V_13 ( V_2 , V_286 ) )
F_83 ( V_2 , L_10 ) ;
return 0 ;
}
