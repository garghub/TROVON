...
F_36 ( & V_2 -> V_5 , V_44 , F_12 ( V_11 ) ) ;
}
static struct V_10 * F_37 ( struct V_48 * V_48 ,
...
struct V_8 * V_54 = F_38 ( V_49 ) -> V_55 ;
if ( V_49 == V_50 )
V_44 = NULL ;
else
V_44 = V_49 -> V_56 ;
...
return V_63 ;
V_71:
V_63 = F_37 ( F_45 ( V_2 -> V_4 -> V_28 . V_22 ) ,
& V_2 -> V_5 , V_61 , V_44 ) ;
if ( V_63 )
V_63 -> V_19 |= V_20 ;
goto V_72;
...
static struct V_10 * F_49 ( struct V_1 * V_2 )
{
struct V_8 * V_44 , * V_73 , * V_61 ;
struct V_10 * V_45 ;
T_2 V_47 , V_62 ;
...
if ( V_83 > V_82 )
break;
if ( V_83 == V_82 && F_56 ( V_86 , V_84 ) )
break;
}
F_36 ( & V_2 -> V_6 , V_44 , F_12 ( V_11 ) ) ;
}
...
if ( V_83 < V_82 )
continue;
if ( ! F_56 ( V_84 , F_53 ( V_81 , V_87 , V_83 ) ) )
break;
F_21 ( V_44 , V_6 ) ;
if ( ! V_11 )
V_11 = F_5 ( V_44 ) ;
...
V_83 = V_45 -> V_81 ;
V_84 = V_45 -> V_86 ;
if ( V_83 == V_82 && V_84 == F_53 ( V_81 , V_87 , V_83 ) ) {
F_54 ( V_81 , V_87 , V_83 ) ;
F_21 ( V_44 , V_6 ) ;
F_11 ( & V_16 , V_44 ) ;
V_11 = F_5 ( V_44 ) ;
...
void F_58 ( struct V_1 * V_2 , T_5 V_82 , T_5 V_86 )
{
struct V_80 * V_81 ;
V_81 = V_2 -> V_4 -> V_81 ;
if ( F_56 ( V_86 , F_53 ( V_81 , V_87 , V_82 ) ) )
return;
F_59 ( V_81 , V_87 , V_82 , V_86 ) ;
F_57 ( V_2 , V_82 ) ;
}
...
while ( ( V_9 = F_33 ( V_54 ) ) != NULL ) {
V_11 = F_5 ( V_9 ) ;
V_46 = V_11 -> V_46 ;
if ( F_48 ( V_46 , F_47 ( V_94 ) ) )
break;
V_90 += F_61 ( V_9 ) ;
V_92 = F_38 ( V_9 ) -> V_55 ;
...
{
return F_60 ( V_2 , & V_2 -> V_6 , V_89 ) ;
}
static T_5 F_64 ( struct V_1 * V_2 , T_5 V_89 )
{
return F_60 ( V_2 , & V_2 -> V_5 , V_89 ) ;
}
...
if ( V_2 -> V_7 )
return;
V_9 = F_66 ( & V_4 -> V_2 . V_5 ) ;
if ( V_9 != NULL ) {
V_47 = F_5 ( V_9 ) -> V_46 ;
if ( ! F_48 ( V_47 , F_47 ( & V_4 -> V_76 . V_77 ) ) )
return;
}
...
void F_67 ( struct V_1 * V_2 , struct V_12 * V_13 ,
T_1 V_14 )
{
struct V_3 * V_4 ;
T_5 V_89 , V_90 ;
...
void F_70 ( struct V_1 * V_2 , T_1 V_14 )
{
