...
static int F_100 ( struct V_137 * V_138 , struct V_1 * V_2 ,
unsigned int V_186 )
{
enum V_195 V_196 ;
T_1 V_206 ;
...
int V_207 , V_52 ;
if ( V_186 == V_208 )
V_206 = V_2 -> V_7 . V_44 & 0x1f0000ull ;
else
V_206 = V_189 ;
V_207 = F_101 ( V_2 , V_209 , & V_47 ) ;
if ( V_207 != V_198 )
return V_144 ;
if ( F_2 ( V_2 ) & V_82 ) {
#ifdef F_44
...
F_4 ( V_2 ) , V_47 ) ;
#endif
if ( ( V_47 & 0xff0007ff ) != ( V_133 & 0xfffffff7 ) ) {
F_83 ( V_2 , V_206 ) ;
return V_144 ;
}
}
...
int F_105 ( struct V_137 * V_138 , struct V_1 * V_2 ,
unsigned int V_186 )
{
int V_52 = V_176 ;
int V_217 ;
...
T_5 V_223 ;
V_14 = F_8 ( V_2 ) ;
V_223 = V_14 -> V_223 [ F_4 ( V_2 ) >> V_160 ] ;
F_10 ( V_14 ) ;
if ( V_223 == V_224 ) {
F_50 ( V_2 , F_4 ( V_2 ) ) ;
V_52 = V_144 ;
...
if ( V_46 & ( V_169 | V_170 ) ) {
int V_225 = F_108 ( & V_2 -> V_54 -> V_226 ) ;
V_52 = F_70 ( V_138 , V_2 , V_228 , V_186 ) ;
F_109 ( & V_2 -> V_54 -> V_226 , V_225 ) ;
} else {
F_71 ( V_2 , V_228 ) ;
F_73 ( V_2 , V_46 ) ;
...
int V_57 ;
#ifdef F_7
if ( F_111 ( V_2 , V_247 ) == V_198 ) {
V_52 = V_144 ;
break;
}
#endif
V_138 -> V_248 . V_249 = V_247 ;
for ( V_57 = 0 ; V_57 < 9 ; ++ V_57 ) {
T_1 V_33 = F_110 ( V_2 , 4 + V_57 ) ;
V_138 -> V_248 . args [ V_57 ] = V_33 ;
}
V_138 -> V_214 = V_250 ;
V_2 -> V_7 . V_251 = 1 ;
V_52 = V_176 ;
...
V_52 = F_51 ( V_2 , V_186 , V_263 ) ;
break;
}
case V_264 :
{
T_5 V_47 ;
int V_207 = F_101 ( V_2 , V_209 , & V_47 ) ;
if ( V_207 == V_198 ) {
T_5 V_168 ;
T_4 V_228 ;
V_168 = F_114 ( V_2 , V_47 ) ;
...
if ( V_2 -> V_7 . V_8 & V_105 ) {
for ( V_57 = 0 ; V_57 < 64 ; V_57 ++ ) {
V_2 -> V_7 . V_112 . V_284 ( V_2 , V_270 -> V_273 . V_217 . V_275 . V_15 [ V_57 ] . V_278 ,
V_270 -> V_273 . V_217 . V_275 . V_15 [ V_57 ] . V_276 ) ;
}
} else {
for ( V_57 = 0 ; V_57 < 16 ; V_57 ++ ) {
V_2 -> V_7 . V_112 . V_285 ( V_2 , V_57 , V_270 -> V_273 . V_217 . V_280 . V_223 [ V_57 ] ) ;
}
for ( V_57 = 0 ; V_57 < 8 ; V_57 ++ ) {
...
break;
case V_291 :
* V_288 = F_124 ( V_286 , F_9 ( V_2 ) -> V_107 ) ;
break;
case V_292 :
...
switch ( V_286 ) {
case V_291 :
F_9 ( V_2 ) -> V_107 = F_127 ( V_286 , * V_288 ) ;
F_9 ( V_2 ) -> V_106 = true ;
break;
case V_292 :
...
F_144 ( ( unsigned long ) V_2 -> V_7 . V_310 & V_131 ) ;
F_138 ( V_2 ) ;
#ifdef F_131
F_139 ( V_2 -> V_7 . V_27 ) ;
#endif
...
static int F_145 ( struct V_137 * V_137 , struct V_1 * V_2 )
{
int V_316 ;
#ifdef F_80
...
unsigned long V_327 ;
F_149 ( & V_54 -> V_328 ) ;
V_52 = F_150 ( V_54 , log , & V_326 ) ;
if ( V_52 )
goto V_43;
if ( V_326 ) {
V_59 = V_58 ( V_54 ) ;
V_61 = F_151 ( V_59 , log -> V_329 ) ;
V_324 = V_61 -> V_330 << V_68 ;
V_325 = V_324 + ( V_61 -> V_67 << V_68 ) ;
F_34 (n, vcpu, kvm)
F_35 ( V_2 , V_324 , V_325 ) ;
V_327 = F_152 ( V_61 ) ;
memset ( V_61 -> V_331 , 0 , V_327 ) ;
}
V_52 = 0 ;
V_43:
F_153 ( & V_54 -> V_328 ) ;
...
static int F_158 ( struct V_60 * V_329 ,
unsigned long V_67 )
{
return 0 ;
}
...
V_338 -> V_206 = 0 ;
V_338 -> V_339 = 64 ;
V_338 -> V_340 [ 0 ] . V_341 = 12 ;
V_338 -> V_340 [ 0 ] . V_342 = 0 ;
V_338 -> V_340 [ 0 ] . V_343 [ 0 ] . V_341 = 12 ;
V_338 -> V_340 [ 0 ] . V_343 [ 0 ] . V_344 = 0 ;
V_57 = 1 ;
V_2 = F_160 ( V_54 , 0 ) ;
if ( V_2 && ( V_2 -> V_7 . V_8 & V_122 ) ) {
V_338 -> V_206 = V_345 ;
V_338 -> V_340 [ V_57 ] . V_341 = 16 ;
V_338 -> V_340 [ V_57 ] . V_342 = V_346 | V_347 ;
V_338 -> V_340 [ V_57 ] . V_343 [ 0 ] . V_341 = 16 ;
V_338 -> V_340 [ V_57 ] . V_343 [ 0 ] . V_344 = 1 ;
++ V_57 ;
}
V_338 -> V_340 [ V_57 ] . V_341 = 24 ;
V_338 -> V_340 [ V_57 ] . V_342 = V_346 ;
V_338 -> V_340 [ V_57 ] . V_343 [ 0 ] . V_341 = 24 ;
V_338 -> V_340 [ V_57 ] . V_343 [ 0 ] . V_344 = 0 ;
return 0 ;
}
static int F_159 ( struct V_54 * V_54 ,
struct V_337 * V_338 )
...
static long F_174 ( struct V_355 * V_356 ,
unsigned int V_357 , unsigned long V_358 )
{
return - V_359 ;
}
int F_175 ( void )
