...
static T_2 int F_15 ( struct V_17 * V_18 )
{
struct V_4 * V_19 = F_16 ( V_18 ) ;
unsigned long V_6 ;
unsigned int V_20 ;
...
static T_2 int F_17 ( struct V_17 * V_18 )
{
struct V_4 * V_19 = F_16 ( V_18 ) ;
unsigned long V_6 ;
unsigned int V_20 ;
...
V_19 -> V_9 = F_21 ( & V_25 -> V_18 , V_27 -> V_33 ,
F_22 ( V_27 ) ) ;
if ( ! V_19 -> V_9 ) {
V_28 = - V_30 ;
goto V_28;
...
V_19 -> V_5 . V_40 = F_1 ;
V_19 -> V_5 . V_41 = F_9 ;
V_19 -> V_5 . V_42 = F_24 ( & V_25 -> V_18 ) ;
V_19 -> V_5 . V_9 = - 1 ;
F_25 ( V_25 , V_19 ) ;
V_28 = F_26 ( & V_25 -> V_18 , & V_19 -> V_5 , V_19 ) ;
if ( V_28 ) {
F_27 ( & V_25 -> V_18 ,
L_1 ) ;
goto V_28;
