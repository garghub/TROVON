...
} else if ( V_8 -> V_20 == 0x08 && V_8 -> V_18 == 0x26 ) {
return true ;
}
return false ;
}
...
V_8 = F_70 ( V_13 , sizeof( struct V_7 ) , V_81 ) ;
if ( ! V_8 )
return - V_83 ;
F_71 ( V_12 , V_8 ) ;
V_8 -> V_14 = V_171 ;
...
if ( error )
return error ;
V_172 = V_13 -> V_183 ? 0 : V_184 ;
error = F_78 ( V_13 , V_12 -> V_69 , NULL , F_55 ,
V_172 | V_185 ,
V_12 -> V_147 , V_8 ) ;
if ( error ) {
F_4 ( V_13 , L_46 , V_12 -> V_69 ) ;
return error ;
}
error = F_79 ( & V_13 -> V_167 , V_168 ) ;
if ( error ) {
F_4 ( V_13 , L_47 , error ) ;
return error ;
}
