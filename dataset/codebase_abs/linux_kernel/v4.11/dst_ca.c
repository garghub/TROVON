...
memmove ( & V_9 -> V_24 [ 4 ] , & V_9 -> V_24 [ 7 ] , 5 ) ;
V_9 -> V_24 [ 9 ] = V_23 ;
memmove ( & V_9 -> V_24 [ 10 ] , & V_9 -> V_24 [ 12 ] , V_23 ) ;
return 0 ;
}
...
{
F_5 ( V_6 , V_7 , 1 , L_76 , V_77 ) ;
return 0 ;
}
static int F_39 ( struct V_93 * V_93 , struct V_77 * V_77 )
{
F_5 ( V_6 , V_7 , 1 , L_77 ) ;
return 0 ;
}
static T_4 F_40 ( struct V_77 * V_77 , char T_2 * V_94 , T_5 V_4 , T_6 * V_64 )
{
F_5 ( V_6 , V_7 , 1 , L_78 ) ;
return 0 ;
}
static T_4 F_41 ( struct V_77 * V_77 , const char T_2 * V_94 , T_5 V_4 , T_6 * V_64 )
{
F_5 ( V_6 , V_7 , 1 , L_79 ) ;
return 0 ;
}
struct V_80 * F_42 ( struct V_8 * V_95 , struct V_96 * V_96 )
{
struct V_80 * V_81 ;
F_5 ( V_6 , V_16 , 1 , L_80 ) ;
if ( F_43 ( V_96 , & V_81 , & V_97 , V_95 ,
V_98 , 0 ) == 0 ) {
V_95 -> V_99 = V_81 ;
return V_95 -> V_99 ;
}
