...
if ( ! V_150 )
return - V_63 ;
F_152 ( V_160 , sizeof( V_160 ) , V_150 * V_119 ) ;
F_153 ( L_6 ,
V_160 , V_150 ) ;
}
if ( V_150 > V_151 )
...
int F_154 ( unsigned int * V_161 , const char * V_153 )
{
unsigned long V_151 = V_152 ;
long V_150 ;
if ( V_151 > V_162 / V_119 )
V_151 = V_162 / V_119 ;
...
int F_156 ( const struct V_163 * V_164 , const char * V_153 ,
int T_13 V_81 )
{
return F_154 ( V_164 -> V_110 , V_153 ) ;
}
int F_157 ( struct V_1 * V_2 , unsigned int V_150 ,
...
return - V_44 ;
V_2 -> V_131 = V_131 ;
V_2 -> V_167 = F_147 ( V_150 ) ;
F_158 ( L_8 , V_2 -> V_167 ) ;
T_6 . V_121 = V_2 -> V_167 - V_119 - 1 ;
F_127 ( & T_6 . V_138 , V_2 -> V_167 ,
T_10 , T_11 ) ;
F_16 (evlist, evsel) {
if ( ( V_20 -> V_41 . V_97 & V_98 ) &&
V_20 -> V_168 == NULL &&
F_159 ( V_20 , F_69 ( V_4 ) , V_6 -> V_169 ) < 0 )
return - V_44 ;
}
if ( F_71 ( V_4 ) )
...
int F_160 ( struct V_1 * V_2 , unsigned int V_150 ,
bool V_131 )
{
return F_157 ( V_2 , V_150 , V_131 , 0 , false ) ;
}
int F_161 ( struct V_1 * V_2 , struct V_170 * V_170 )
{
struct V_3 * V_4 ;
struct V_5 * V_6 ;
V_6 = F_162 ( V_170 -> V_13 , V_170 -> V_101 , V_170 -> V_171 ) ;
if ( ! V_6 )
return - 1 ;
if ( F_163 ( V_170 ) )
V_4 = F_164 () ;
else
V_4 = F_165 ( V_170 -> V_172 ) ;
if ( ! V_4 )
goto V_173;
V_2 -> V_28 = ! ! V_170 -> V_172 ;
F_4 ( V_2 , V_4 , V_6 ) ;
return 0 ;
V_173:
F_28 ( V_6 ) ;
...
int F_170 ( struct V_1 * V_2 , struct V_16 * * V_176 )
{
struct V_16 * V_20 ;
int V_64 = 0 ;
const int V_177 = F_69 ( V_2 -> V_4 ) ,
V_178 = F_58 ( V_2 -> V_6 ) ;
F_16 (evlist, evsel) {
if ( V_20 -> V_179 == NULL )
continue;
V_64 = F_171 ( V_20 , V_177 , V_178 , V_20 -> V_179 ) ;
if ( V_64 ) {
* V_176 = V_20 ;
break;
}
...
int F_172 ( struct V_1 * V_2 , const char * V_179 )
{
struct V_16 * V_20 ;
int V_64 = 0 ;
F_16 (evlist, evsel) {
if ( V_20 -> V_41 . type != V_54 )
continue;
V_64 = F_173 ( V_20 , V_179 ) ;
if ( V_64 )
break;
}
return V_64 ;
}
int F_174 ( struct V_1 * V_2 , T_1 V_180 , T_14 * V_181 )
{
char * V_179 ;
int V_91 = - 1 ;
T_1 V_7 ;
...
if ( V_7 == 0 ) {
if ( F_175 ( & V_179 , L_9 , V_181 [ V_7 ] ) < 0 )
return - 1 ;
} else {
char * V_182 ;
if ( F_175 ( & V_182 , L_10 , V_179 , V_181 [ V_7 ] ) < 0 )
goto V_183;
free ( V_179 ) ;
V_179 = V_182 ;
}
}
V_91 = F_172 ( V_2 , V_179 ) ;
V_183:
free ( V_179 ) ;
return V_91 ;
}
int F_176 ( struct V_1 * V_2 , T_14 V_13 )
{
return F_174 ( V_2 , 1 , & V_13 ) ;
}
...
{
struct V_16 * V_20 ;
int V_177 = F_69 ( V_2 -> V_4 ) ;
int V_178 = F_58 ( V_2 -> V_6 ) ;
F_186 (evlist, evsel) {
int V_22 = V_20 -> V_4 ? V_20 -> V_4 -> V_169 : V_177 ;
F_187 ( V_20 , V_22 , V_178 ) ;
}
}
...
F_15 ( V_2 ) ;
F_16 (evlist, evsel) {
V_64 = F_191 ( V_20 , V_20 -> V_4 , V_20 -> V_6 ) ;
if ( V_64 < 0 )
goto V_200;
}
return 0 ;
...
int F_192 ( struct V_1 * V_2 , struct V_170 * V_170 ,
const char * V_201 [] , bool V_202 ,
void (* F_193)( int V_203 , T_16 * V_204 , void * V_205 ) )
{
int V_206 [ 2 ] , V_207 [ 2 ] ;
char V_208 ;
if ( F_194 ( V_206 ) < 0 ) {
...
F_44 ( V_206 [ 0 ] ) ;
F_44 ( V_207 [ 1 ] ) ;
F_77 ( V_207 [ 0 ] , V_213 , V_214 ) ;
F_44 ( V_206 [ 1 ] ) ;
V_91 = F_92 ( V_207 [ 0 ] , & V_208 , 1 ) ;
if ( V_91 != 1 ) {
if ( V_91 == - 1 )
perror ( L_14 ) ;
exit ( V_91 ) ;
}
F_197 ( V_201 [ 0 ] , ( char * * ) V_201 ) ;
if ( F_193 ) {
union V_215 V_154 ;
V_154 . V_216 = V_94 ;
if ( F_198 ( F_199 () , V_217 , V_154 ) )
perror ( V_201 [ 0 ] ) ;
} else
perror ( V_201 [ 0 ] ) ;
exit ( - 1 ) ;
...
F_201 ( V_2 -> V_6 , 0 , V_2 -> V_12 . V_13 ) ;
}
F_44 ( V_206 [ 1 ] ) ;
F_44 ( V_207 [ 0 ] ) ;
if ( F_92 ( V_206 [ 0 ] , & V_208 , 1 ) == - 1 ) {
perror ( L_14 ) ;
goto V_210;
}
F_77 ( V_207 [ 1 ] , V_213 , V_214 ) ;
V_2 -> V_12 . V_224 = V_207 [ 1 ] ;
F_44 ( V_206 [ 0 ] ) ;
return 0 ;
V_210:
F_44 ( V_207 [ 0 ] ) ;
...
char V_208 = 0 ;
int V_91 ;
V_91 = F_203 ( V_2 -> V_12 . V_224 , & V_208 , 1 ) ;
if ( V_91 < 0 )
perror ( L_16 ) ;
F_44 ( V_2 -> V_12 . V_224 ) ;
return V_91 ;
...
int F_204 ( struct V_1 * V_2 , union V_103 * V_104 ,
struct V_189 * V_106 )
{
struct V_16 * V_20 = F_101 ( V_2 , V_104 ) ;
if ( ! V_20 )
return - V_225 ;
return F_205 ( V_20 , V_104 , V_106 ) ;
}
T_1 F_206 ( struct V_1 * V_2 , T_17 * V_226 )
{
struct V_16 * V_20 ;
T_1 V_227 = 0 ;
F_16 (evlist, evsel) {
V_227 += fprintf ( V_226 , L_17 , V_20 -> V_30 ? L_18 : L_19 ,
F_207 ( V_20 ) ) ;
}
return V_227 + fprintf ( V_226 , L_20 ) ;
}
int F_208 ( struct V_1 * V_2 ,
int V_64 , char * V_160 , T_1 V_48 )
{
int V_227 , V_110 ;
char V_228 [ V_229 ] , * V_230 = F_209 ( V_64 , V_228 , sizeof( V_228 ) ) ;
switch ( V_64 ) {
case V_231 :
case V_232 :
V_227 = F_210 ( V_160 , V_48 ,
L_21
L_22 , V_230 ) ;
V_110 = F_211 () ;
V_227 += F_210 ( V_160 + V_227 , V_48 - V_227 , L_23 ) ;
if ( V_110 >= 2 ) {
V_227 += F_210 ( V_160 + V_227 , V_48 - V_227 ,
L_24 ) ;
}
V_227 += F_210 ( V_160 + V_227 , V_48 - V_227 ,
L_25 ) ;
...
default:
V_234:
F_210 ( V_160 , V_48 , L_32 , V_230 ) ;
break;
}
return 0 ;
}
int F_212 ( struct V_1 * V_2 , int V_64 , char * V_160 , T_1 V_48 )
{
char V_228 [ V_229 ] , * V_230 = F_209 ( V_64 , V_228 , sizeof( V_228 ) ) ;
int V_237 = V_2 -> V_167 / 1024 , V_238 , V_227 = 0 ;
switch ( V_64 ) {
case V_232 :
F_144 ( L_5 , & V_238 ) ;
V_227 += F_210 ( V_160 + V_227 , V_48 - V_227 ,
...
F_214 ( & V_20 -> V_23 , & V_240 ) ;
}
F_215 ( & V_240 , & V_2 -> V_10 ) ;
}
