...
V_113 = ( char * ) ( (struct V_11 * ) V_112 -> V_116 -> V_117 ) -> V_13 + V_36 ;
V_112 -> V_118 = F_62 ( V_113 ) ;
F_63 ( V_112 -> V_118 ) ;
return 0 ;
}
static int F_64 ( struct V_107 * V_100 , struct V_108 * V_119 , struct V_109 * V_110 )
{
unsigned long V_120 = ( unsigned long ) ( V_110 -> V_121 - V_110 -> V_122 ) ;
struct V_11 * V_12 = V_100 -> V_81 ;
if ( ! ( V_12 -> V_97 & V_123 ) )
return - V_99 ;
if ( V_120 > F_65 ( sizeof( struct V_30 ) ) ) {
F_66 ( L_19 , V_120 , ( unsigned long ) sizeof( struct V_30 ) ) ;
return - V_69 ;
}
if ( ! V_12 -> V_13 ) {
return - V_124 ;
...
V_110 -> V_125 = & V_126 ;
V_110 -> V_127 |= V_128 | V_129 ;
V_110 -> V_117 = V_100 -> V_81 ;
return 0 ;
}
static void F_67 ( struct V_107 * V_130 )
{
struct V_11 * V_12 = V_130 -> V_81 ;
if ( NULL != V_12 -> V_13 )
...
if ( 1 != F_4 () )
return 0 ;
if ( ( V_51 = F_70 ( V_105 , V_133 , 1 , & V_100 ) ) < 0 )
return V_51 ;
V_100 -> V_134 = V_135 ;
V_100 -> V_81 = V_12 ( V_105 ) ;
V_100 -> V_136 = F_67 ;
V_100 -> V_137 . V_138 = F_57 ;
V_100 -> V_137 . V_139 = F_58 ;
V_100 -> V_137 . V_140 = F_64 ;
V_100 -> V_141 = 1 ;
sprintf ( V_100 -> V_142 , L_20 , V_57 -> V_143 -> V_144 , V_57 -> V_145 ) ;
V_51 = F_71 ( V_105 , V_146 L_21 , 2 , 1 , 1 , & V_132 ) ;
if ( V_51 < 0 ) {
return V_51 ;
}
F_72 ( V_132 , V_61 , & V_147 ) ;
F_72 ( V_132 , V_60 , & V_147 ) ;
V_132 -> V_81 = V_12 ( V_105 ) -> V_2 ;
V_132 -> V_148 = 0 ;
sprintf ( V_132 -> V_142 , V_146 L_21 ) ;
if ( 0 > ( V_51 = F_73 ( V_132 -> V_149 [ V_61 ] . V_80 ,
V_150 ,
F_74 ( V_71 ) ,
64 * 1024 , 128 * 1024 ) ) ||
0 > ( V_51 = F_73 ( V_132 -> V_149 [ V_60 ] . V_80 ,
V_150 ,
F_74 ( V_71 ) ,
64 * 1024 , 128 * 1024 ) ) ) {
return V_51 ;
