...
F_148 ( & V_7 -> V_297 ) ;
F_129 ( & V_7 -> V_299 ) ;
F_178 ( & V_7 -> V_294 , & V_353 ) ;
V_7 -> V_294 . V_354 = V_355 ;
V_13 = F_179 ( & V_7 -> V_294 , F_180 ( F_181 ( V_356 ) , V_6 -> V_241 ) , 1 ) ;
if ( V_13 < 0 ) {
F_18 ( V_7 ) ;
F_24 ( L_72 , V_13 ) ;
return NULL ;
}
V_7 -> V_68 . V_357 = V_7 -> V_294 . V_68 ;
V_7 -> V_68 . V_358 = V_359 ;
V_7 -> V_68 . V_168 = & V_6 -> V_68 ;
V_7 -> V_68 . V_258 = F_176 ;
F_125 ( & V_7 -> V_68 , V_360 L_73 , V_6 -> V_241 ) ;
F_182 ( & V_7 -> V_296 , 1 ) ;
V_13 = F_183 ( & V_7 -> V_68 ) ;
if ( V_13 ) {
F_24 ( L_74 ,
...
F_117 ( V_237 L_75 ,
V_6 -> V_249 , F_181 ( V_356 ) , V_6 -> V_241 ) ;
F_20 ( & V_373 ) ;
F_17 ( & V_7 -> V_39 , & V_374 ) ;
F_22 ( & V_373 ) ;
F_117 ( V_237 L_76 ,
...
static void F_187 ( struct V_23 * V_7 )
{
#ifdef F_147
struct V_1 * V_375 ;
...
static int F_189 ( struct V_23 * V_7 )
{
...
F_21 (client, &md->file_list, list) {
if ( V_375 -> V_304 )
F_190 ( & V_375 -> V_304 , V_377 , V_378 ) ;
V_376 ++ ;
}
F_22 ( & V_7 -> V_297 ) ;
return V_376 ;
}
static void F_191 ( struct V_23 * V_7 )
{
struct V_29 * V_30 , * V_48 ;
F_13 ( EXIT , L_77 , V_7 -> V_6 -> V_249 ) ;
F_182 ( & V_7 -> V_296 , 0 ) ;
F_187 ( V_7 ) ;
...
static int F_194 ( struct V_67 * V_68 ,
struct V_379 * V_380 )
{
struct V_5 * V_6 = NULL ;
...
{
int V_13 ;
V_359 = F_198 ( V_355 , V_191 ) ;
if ( F_60 ( V_359 ) ) {
F_24 ( L_80 V_191 L_81 ) ;
return F_61 ( V_359 ) ;
}
V_13 = F_199 ( & V_356 , 0 , V_292 , V_191 ) ;
if ( V_13 < 0 )
goto V_381;
F_13 ( V_295 , L_82 , F_181 ( V_356 ) ) ;
V_13 = F_200 ( & V_382 ) ;
if ( V_13 ) {
F_24 ( L_83 , V_13 ) ;
goto V_383;
