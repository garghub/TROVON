...
V_149 = F_7 ( unsigned , V_151 ,
V_7 -> V_12 -> V_23 . V_152 ) ;
V_92 -> V_153 = F_10 ( V_148 , V_149 ) ;
}
...
if ( V_92 -> V_132 != V_154 )
return;
( void ) F_81 ( V_119 -> V_121 , & V_175 , ~ 0 , & V_94 ) ;
F_11 ( L_25 , V_175 . V_176 , V_119 -> V_121 -> V_177 ) ;
if ( V_172 ) {
T_1 V_168 = * ( T_1 * ) V_172 ;
V_92 -> V_178 = ! ( V_168 & V_171 ) ;
}
F_11 ( L_26 ,
V_92 , V_92 -> V_178 ? L_27 : L_28 ) ;
V_92 -> V_132 = V_144 ;
F_82 ( & V_92 -> V_179 ) ;
}
...
static int F_86 ( struct V_122 * V_119 , struct V_181 * V_4 )
{
struct V_92 * V_92 ;
int V_14 = 0 ;
V_92 = (struct V_92 * ) V_119 -> V_3 ;
...
break;
case V_185 :
F_80 ( V_119 , V_4 -> V_186 . V_187 . V_172 ) ;
break;
case V_188 :
F_11 ( L_31 ,
F_88 ( V_119 , V_4 -> V_182 ) ) ;
case V_189 :
case V_190 :
case V_191 :
case V_192 :
...
int V_90 = 0 ;
F_51 ( & V_92 -> V_138 ) ;
sprintf ( V_92 -> V_8 , L_33 , V_204 ) ;
F_11 ( L_34 , V_92 -> V_8 ) ;
V_34 -> V_7 = NULL ;
V_92 -> V_132 = V_154 ;
V_34 -> V_119 = F_93 ( & V_206 , F_86 ,
( void * ) V_92 ,
V_207 , V_111 ) ;
if ( F_13 ( V_34 -> V_119 ) ) {
...
V_90 = F_94 ( V_34 -> V_119 , V_203 , V_204 , 1000 ) ;
if ( V_90 ) {
F_2 ( L_36 , V_90 ) ;
goto V_209;
}
...
V_216 . V_231 = NULL ;
V_34 -> V_198 ++ ;
V_218 = F_97 ( V_34 -> V_121 , & V_216 , & V_217 ) ;
if ( V_218 ) {
F_2 ( L_37 , V_218 ) ;
V_34 -> V_198 -- ;
}
...
int F_98 ( struct V_92 * V_92 , int V_232 )
{
struct V_34 * V_34 = & V_92 -> V_34 ;
unsigned int V_233 = V_92 -> V_234 ;
struct V_235 * V_236 ;
struct V_215 * V_216 , * V_217 ;
int V_15 , V_218 ;
for ( V_216 = V_34 -> V_237 , V_15 = 0 ; V_15 < V_232 ; V_15 ++ , V_216 ++ ) {
V_236 = & V_92 -> V_141 [ V_233 ] ;
V_236 -> V_226 . V_200 = V_238 ;
V_216 -> V_228 = & V_236 -> V_226 ;
V_216 -> V_229 = & V_236 -> V_239 ;
V_216 -> V_230 = 1 ;
V_216 -> V_231 = V_216 + 1 ;
V_233 = ( V_233 + 1 ) & V_92 -> V_240 ;
}
V_216 -- ;
V_216 -> V_231 = NULL ;
V_34 -> V_198 += V_232 ;
V_218 = F_97 ( V_34 -> V_121 , V_34 -> V_237 , & V_217 ) ;
if ( V_218 ) {
F_2 ( L_37 , V_218 ) ;
V_34 -> V_198 -= V_232 ;
} else
...
int F_99 ( struct V_34 * V_34 , struct V_241 * V_242 ,
bool signal )
{
...
V_218 = F_102 ( V_34 -> V_121 , & V_242 -> V_253 [ 0 ] . V_254 , & V_244 ) ;
if ( V_218 )
F_2 ( L_38 ,
V_218 , V_244 -> V_249 ) ;
return V_218 ;
...
struct V_92 * V_92 = F_49 ( V_280 -> V_121 -> V_100 ) ;
F_2 ( L_42 , type ,
