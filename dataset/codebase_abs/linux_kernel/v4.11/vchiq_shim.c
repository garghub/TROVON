...
T_6
F_56 ( const void * V_81 )
{
const unsigned char * V_82 = V_81 ;
return V_82 [ 0 ] | ( V_82 [ 1 ] << 8 ) | ( V_82 [ 2 ] << 16 ) | ( V_82 [ 3 ] << 24 ) ;
}
void
F_57 ( void * V_81 , T_6 V_74 )
{
unsigned char * V_82 = V_81 ;
V_82 [ 0 ] = ( unsigned char ) ( ( V_74 >> 0 ) & 0xFF ) ;
V_82 [ 1 ] = ( unsigned char ) ( ( V_74 >> 8 ) & 0xFF ) ;
V_82 [ 2 ] = ( unsigned char ) ( ( V_74 >> 16 ) & 0xFF ) ;
V_82 [ 3 ] = ( unsigned char ) ( ( V_74 >> 24 ) & 0xFF ) ;
}
T_23
F_58 ( const void * V_81 )
{
const unsigned char * V_82 = V_81 ;
return V_82 [ 0 ] | ( V_82 [ 1 ] << 8 ) ;
}
void
F_59 ( void * V_81 , T_23 V_74 )
{
unsigned char * V_82 = V_81 ;
V_82 [ 0 ] = ( V_74 >> 0 ) & 0xFF ;
V_82 [ 1 ] = ( V_74 >> 8 ) & 0xFF ;
}
T_4 F_60 ( const T_5 V_3 )
{
T_4 V_72 = - 1 ;
T_8 * V_7 = ( T_8 * ) V_3 ;
if ( V_7 )
V_72 = F_15 ( F_61 ( V_7 -> V_3 ) ) ;
return V_72 ;
}
T_4 F_62 ( const T_5 V_3 )
{
T_4 V_72 = - 1 ;
T_8 * V_7 = ( T_8 * ) V_3 ;
if ( V_7 )
