...
static struct V_45 * F_45 ( struct V_46 * V_47 , int V_26 ,
const char * V_48 , void * V_49 )
{
return F_46 ( V_47 ,
L_10 ,
& V_50 ,
...
static struct V_52 * F_47 ( void )
{
struct V_52 * V_52 ;
int V_27 ;
V_27 = F_48 ( & V_53 , & V_54 , & V_55 ) ;
if ( V_27 < 0 ) {
F_24 ( L_11 , V_27 ) ;
return F_35 ( V_27 ) ;
}
...
static void F_51 ( struct V_52 * V_52 )
{
if ( V_52 ) {
F_52 ( V_52 ) ;
F_50 ( & V_54 , & V_55 ) ;
...
V_38 = F_62 ( V_2 , V_59 ? V_48 ( V_59 ) : V_58 -> V_78 ) ;
if ( V_38 )
goto V_79;
return 0 ;
V_79:
...
struct V_18 * F_69 ( struct V_57 * V_58 ,
struct V_1 * V_59 )
{
struct V_18 * V_2 ;
int V_38 ;
...
static void F_70 ( struct V_81 * V_60 )
{
struct V_18 * V_2 = F_71 ( V_60 , struct V_18 , V_60 ) ;
if ( V_2 -> V_58 -> V_82 ) {
V_2 -> V_58 -> V_82 ( V_2 ) ;
} else {
F_67 ( V_2 ) ;
...
static int F_74 ( struct V_18 * V_2 )
{
struct V_17 * V_25 ;
char * V_78 ;
int V_38 ;
...
if ( ! V_25 )
return 0 ;
V_78 = F_75 ( V_28 , L_14 , V_25 -> V_34 + 64 ) ;
if ( ! V_78 )
return - V_29 ;
V_38 = F_76 ( V_25 -> V_35 -> V_84 . V_59 ,
& V_25 -> V_35 -> V_84 ,
V_78 ) ;
F_18 ( V_78 ) ;
return V_38 ;
}
static void F_77 ( struct V_18 * V_2 )
{
struct V_17 * V_25 ;
char * V_78 ;
if ( ! F_58 ( V_2 , V_83 ) )
...
if ( ! V_25 )
return;
V_78 = F_75 ( V_28 , L_14 , V_25 -> V_34 ) ;
if ( ! V_78 )
return;
F_78 ( V_25 -> V_35 -> V_84 . V_59 , V_78 ) ;
F_18 ( V_78 ) ;
}
int F_79 ( struct V_18 * V_2 , unsigned long V_26 )
{
...
V_38 = 0 ;
F_81 ( L_15 ,
V_58 -> V_78 , V_58 -> V_87 , V_58 -> V_25 ,
V_58 -> V_88 , V_58 -> V_89 ,
V_2 -> V_2 ? V_48 ( V_2 -> V_2 ) : L_16 ,
V_2 -> V_20 -> V_34 ) ;
goto V_90;
V_74:
F_77 ( V_2 ) ;
...
int F_62 ( struct V_18 * V_2 , const char * V_78 )
{
F_18 ( V_2 -> V_80 ) ;
V_2 -> V_80 = F_87 ( V_78 , V_28 ) ;
return V_2 -> V_80 ? 0 : - V_29 ;
}
static int F_88 ( struct V_52 * V_52 , struct V_97 * V_98 )
{
...
V_100 = F_90 ( V_25 -> V_2 -> V_58 -> V_102 ) ;
if ( ! V_100 ) {
V_101 = - V_42 ;
goto V_103;
}
F_91 ( V_98 , V_100 ) ;
if ( V_98 -> V_104 -> V_105 )
V_101 = V_98 -> V_104 -> V_105 ( V_52 , V_98 ) ;
else
V_101 = 0 ;
V_103:
F_38 ( V_25 ) ;
