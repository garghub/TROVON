...
F_34 ( V_49 , & V_48 -> V_3 ) ;
F_36 ( V_38 , L_2 ,
V_48 -> V_48 . V_55 , V_56 [ V_48 -> type ] ,
V_51 -> V_57 , V_49 ) ;
F_37 ( V_48 -> V_48 . V_55 , & V_48 -> V_3 ) ;
V_2 = & V_34 -> V_43 ;
F_34 ( V_49 , & V_2 -> V_3 ) ;
F_34 ( V_49 , & V_2 -> V_4 ) ;
...
V_63 -> V_66 = V_48 -> V_48 . V_55 ;
V_63 -> V_63 = F_39 ;
V_63 -> V_67 = F_41 ;
if ( F_43 ( V_63 -> V_66 , V_63 ) )
F_44 ( L_3 ,
V_63 -> V_66 ) ;
}
...
break;
case V_74 :
V_71 = (struct V_70 * ) V_48 -> V_52 ;
if ( V_71 -> V_75 == V_76 )
V_49 = F_7 ( & V_34 -> V_45 ) ;
else
V_2 = & V_34 -> V_44 ;
F_48 ( V_72 , 64 , L_6 , V_71 -> V_75 ) ;
break;
default:
...
F_37 ( V_48 -> V_48 . V_55 , NULL ) ;
F_2 ( & V_48 -> V_3 ) ;
F_21 ( & V_10 . V_35 ) ;
}
static void F_56 ( T_3 V_78 , T_2 V_79 ,
struct V_80 * V_81 )
{
int V_6 , V_7 , V_8 ;
T_3 V_82 = V_10 . V_23 /
...
int V_49 = - 1 , V_68 , V_8 ;
struct V_33 * V_34 ;
T_2 V_69 , V_79 , V_83 , V_84 ;
const struct V_40 * V_85 ,
* V_86 = & V_87 -> V_88 ;
struct V_80 * V_81 = & V_10 ;
struct V_1 * V_2 = & V_81 -> V_19 ;
if ( F_5 ( V_86 ) == 1 ) {
F_59 ( V_89 , L_9 ,
V_87 -> V_90 , V_87 -> V_91 ,
F_60 ( V_86 ) ) ;
...
V_34 = F_27 ( V_13 ) ;
if ( V_34 ) {
F_4 ( V_84 , ( V_34 -> V_43 . V_5 ?
& V_34 -> V_43 . V_3 :
& V_34 -> V_43 . V_4 ) ) ;
F_61 ( V_84 , V_84 , ( V_34 -> V_44 . V_5 ?
& V_34 -> V_44 . V_3 :
& V_34 -> V_44 . V_4 ) ) ;
F_61 ( V_84 , V_84 , & V_34 -> V_45 ) ;
}
F_59 ( V_89 , L_11 ,
F_60 ( V_84 ) ) ;
F_4 ( V_79 , & V_2 -> V_3 ) ;
if ( V_81 -> V_20 > 0 ) {
for ( V_8 = 0 ; V_8 < V_81 -> V_20 ; V_8 ++ ) {
F_56 ( V_8 , V_79 , V_81 ) ;
F_50 ( V_69 , V_79 , & V_2 -> V_4 ) ;
if ( ! F_55 ( V_69 ) )
break;
}
}
