...
static int F_21 ( struct V_57 * V_58 , T_3 * V_99 )
{
struct V_1 * V_2 = V_58 -> V_59 ;
T_3 V_100 ;
T_2 V_28 ;
F_2 ( L_3 , V_19 ) ;
F_5 ( V_2 , 1 ) ;
F_4 ( V_2 , V_101 + 1 , & V_28 ) ;
V_100 = V_28 & 0x7F ;
V_100 <<= 8 ;
F_4 ( V_2 , V_101 , & V_28 ) ;
V_100 |= V_28 ;
F_5 ( V_2 , 0 ) ;
* V_99 = V_100 * 100 / 32767 ;
F_2 ( L_8 , V_19 , * V_99 ) ;
return 0 ;
}
...
F_2 ( L_9 , V_102 ) ;
V_102 = 0x400 - V_102 ;
* signal = V_102 * 0x10000 / 0x400 ;
return 0 ;
}
static int F_23 ( struct V_57 * V_58 , T_1 * V_104 )
{
F_2 ( L_3 , V_19 ) ;
* V_104 = 0 ;
return 0 ;
}
static int F_24 ( struct V_57 * V_58 , T_3 * V_105 )
{
F_2 ( L_3 , V_19 ) ;
* V_105 = 0 ;
return 0 ;
}
static int F_25 ( struct V_57 * V_58 , int V_106 )
{
struct V_1 * V_2 = V_58 -> V_59 ;
return F_1 ( V_2 , V_107 , V_106 ? 1 : 0 ) ;
}
...
V_2 -> V_15 = V_15 ;
V_2 -> V_20 = V_20 ;
if ( F_4 ( V_2 , V_111 , & V_4 ) != 0 ) {
F_2 ( L_11 ,
V_19 , V_2 -> V_15 -> V_16 ) ;
goto V_110;
}
F_2 ( L_12 , V_4 ) ;
memcpy ( & V_2 -> V_112 . V_66 , & V_113 ,
sizeof( struct V_114 ) ) ;
V_2 -> V_112 . V_59 = V_2 ;
F_13 ( & V_2 -> V_112 ) ;
F_25 ( & V_2 -> V_112 , 1 ) ;
