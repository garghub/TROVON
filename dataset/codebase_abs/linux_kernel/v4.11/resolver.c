...
* ( V_32 * ) ( V_12 -> V_15 + V_24 ) = F_14 ( T_1 ) ;
}
V_30:
F_18 ( V_15 ) ;
return V_26 ;
}
static int F_19 ( const struct V_1 * V_33 ,
const struct V_1 * V_34 )
{
const char * V_35 = strrchr ( V_33 -> V_3 , '/' ) ? : L_3 ;
const char * V_36 = strrchr ( V_34 -> V_3 , '/' ) ? : L_3 ;
return F_2 ( V_35 , V_36 ) ;
}
static int F_20 ( struct V_1 * V_37 ,
struct V_1 * V_9 , int V_10 )
{
struct V_1 * V_4 , * V_38 ;
struct V_11 * V_39 , * V_12 ;
int V_26 , V_40 , V_41 ;
unsigned int V_42 ;
T_1 T_1 ;
if ( ! V_37 )
...
if ( ! F_12 ( V_39 -> V_13 , L_4 ) ||
! F_12 ( V_39 -> V_13 , L_1 ) ||
! F_12 ( V_39 -> V_13 , L_2 ) )
continue;
if ( ( V_39 -> V_14 % 4 ) != 0 || V_39 -> V_14 == 0 )
return - V_29 ;
V_41 = V_39 -> V_14 / sizeof( V_32 ) ;
F_11 (overlay, prop) {
if ( ! F_12 ( V_12 -> V_13 , V_39 -> V_13 ) )
break;
}
if ( ! V_12 )
return - V_29 ;
for ( V_40 = 0 ; V_40 < V_41 ; V_40 ++ ) {
V_42 = F_21 ( ( ( V_32 * ) V_39 -> V_15 ) [ V_40 ] ) ;
if ( ( V_42 + 4 ) > V_12 -> V_14 )
return - V_29 ;
T_1 = F_21 ( * ( V_32 * ) ( V_12 -> V_15 + V_42 ) ) ;
T_1 += V_10 ;
* ( V_32 * ) ( V_12 -> V_15 + V_42 ) = F_14 ( T_1 ) ;
}
}
...
if ( ! F_2 ( V_37 -> V_13 , L_7 ) )
break;
V_26 = F_20 ( V_37 , V_9 , V_10 ) ;
if ( V_26 )
goto V_46;
V_44 = NULL ;
F_4 (overlay, child) {
