...
{
const struct V_90 * V_91 = F_41 ( & V_73 -> V_74 ) ;
struct V_13 * V_14 ;
struct V_92 * V_93 ;
struct V_92 * V_94 = V_73 -> V_74 . V_95 ;
struct V_1 * V_2 ;
struct V_96 * V_97 ;
int V_98 , V_15 , V_25 ;
struct V_99 * V_100 ;
V_97 = F_42 ( V_73 , V_101 , 0 ) ;
if ( ! V_97 )
return - V_41 ;
V_14 = F_43 ( & V_73 -> V_74 , sizeof( struct V_13 ) , V_102 ) ;
if ( ! V_14 )
return - V_103 ;
V_93 = & V_14 -> V_93 ;
V_100 = & V_14 -> V_100 ;
...
if ( V_91 ) {
V_93 -> V_27 |= V_91 -> V_106 ;
V_93 -> V_107 = V_91 -> V_108 ;
V_93 -> V_109 |= V_91 -> V_109 ;
V_93 -> V_110 |= V_91 -> V_110 ;
V_93 -> V_111 = V_91 -> V_111 ;
V_100 -> V_112 = V_91 -> V_112 ;
V_2 -> V_45 = V_91 -> V_45 ;
}
V_2 -> V_113 = V_100 ;
V_2 -> V_114 = F_37 ;
...
const struct V_135 * V_67 = V_91 -> V_67 ;
bool V_136 = false ;
V_2 -> V_12 -> V_131 |= V_137 ;
for ( V_25 = 0 ; V_25 < V_91 -> V_138 ; V_25 ++ ) {
if ( V_67 [ V_25 ] . V_139 == 0 ||
V_67 [ V_25 ] . V_139 == V_2 -> V_12 -> V_18 ) {
V_2 -> V_56 = V_67 -> V_58 ;
V_136 = true ;
break;
}
...
V_14 -> V_44 = V_2 -> V_140 + V_91 -> V_130 ;
V_2 -> V_141 = F_27 ;
V_2 -> V_142 = F_29 ;
V_2 -> V_143 = F_30 ;
V_2 -> V_144 = F_32 ;
...
break;
V_25 ++ ;
V_15 = F_53 ( & V_73 -> V_74 , V_98 , V_146 , 0 ,
F_54 ( & V_73 -> V_74 ) , V_2 ) ;
if ( V_15 )
goto V_147;
}
...
static int F_59 ( struct V_89 * V_73 )
{
