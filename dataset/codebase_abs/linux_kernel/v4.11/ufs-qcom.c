...
F_29 ( V_22 -> V_2 , V_246 ,
V_246 , V_42 ) ;
F_29 ( V_22 -> V_2 , V_247 , V_247 , V_42 ) ;
} else {
F_29 ( V_22 -> V_2 , V_246 , 0 , V_42 ) ;
F_29 ( V_22 -> V_2 , V_247 , 0 , V_42 ) ;
}
}
static void F_106 ( struct V_21 * V_22 )
{
V_22 -> V_248 . V_249 = V_250 ;
V_22 -> V_248 . V_251 = 37 ;
}
static bool F_121 ( struct V_21 * V_22 )
{
if ( V_22 -> V_248 . V_249 >= V_252 ) {
F_7 ( V_22 -> V_2 -> V_15 ,
L_63 ,
V_16 , V_22 -> V_248 . V_249 ) ;
return false ;
}
return true ;
}
...
F_29 ( V_22 -> V_2 , V_271 ,
( T_1 ) V_22 -> V_248 . V_249 << 19 ,
V_42 ) ;
F_29 ( V_22 -> V_2 , V_253 ,
( T_1 ) V_22 -> V_248 . V_251 << V_3 ,
V_232 ) ;
F_120 ( V_22 ) ;
F_31 () ;
F_124 ( V_22 -> V_2 ) ;
...
{
F_1 ( V_2 , V_272 , 1 , L_64 ) ;
}
static void F_127 ( struct V_1 * V_2 )
{
struct V_21 * V_22 = F_19 ( V_2 ) ;
T_1 * V_248 = NULL ;
int V_273 , V_274 = 256 , V_275 = V_274 * sizeof( T_1 ) ;
V_248 = F_128 ( V_275 , V_213 ) ;
if ( ! V_248 )
return;
V_22 -> V_248 . V_249 = V_250 ;
for ( V_273 = 0 ; V_273 < V_274 ; V_273 ++ ) {
V_22 -> V_248 . V_251 = V_273 ;
F_107 ( V_22 ) ;
V_248 [ V_273 ] = F_40 ( V_2 , V_272 ) ;
}
F_2 ( V_6 , L_65 , V_7 ,
16 , 4 , V_248 , V_275 , false ) ;
F_129 ( V_248 ) ;
}
...
V_13 = F_132 ( V_148 , & V_276 ) ;
if ( V_13 )
F_7 ( V_15 , L_67 , V_13 ) ;
return V_13 ;
}
static int F_133 ( struct V_147 * V_148 )
{
struct V_1 * V_2 = F_134 ( V_148 ) ;
F_122 ( & ( V_148 ) -> V_15 ) ;
F_135 ( V_2 ) ;
return 0 ;
}
