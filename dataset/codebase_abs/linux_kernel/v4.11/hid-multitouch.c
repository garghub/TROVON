...
if ( ! V_21 -> V_117 )
continue;
for ( V_195 = 0 ; V_195 < V_21 -> V_117 ; V_195 ++ )
if ( V_21 -> V_31 [ V_195 ] -> V_196 >= 1 )
F_56 ( V_21 -> V_31 [ V_195 ] , V_33 ) ;
}
}
static int F_59 ( struct V_11 * V_12 , const struct V_197 * V_27 )
{
int V_22 , V_195 ;
struct V_1 * V_2 ;
struct V_67 * V_13 = V_198 ;
for ( V_195 = 0 ; V_198 [ V_195 ] . V_95 ; V_195 ++ ) {
if ( V_27 -> V_199 == V_198 [ V_195 ] . V_95 ) {
V_13 = & ( V_198 [ V_195 ] ) ;
break;
}
}
...
if ( V_27 -> V_202 == V_203 && V_27 -> V_204 == V_203 )
V_2 -> V_168 = true ;
V_2 -> V_24 = V_12 -> V_14 ;
V_12 -> V_14 |= V_205 ;
V_12 -> V_14 |= V_206 ;
...
if ( V_13 -> V_14 & V_208 )
F_57 ( V_12 , V_101 ) ;
V_22 = F_62 ( V_12 , V_209 ) ;
if ( V_22 )
return V_22 ;
V_22 = F_63 ( & V_12 -> V_7 . V_210 , & V_211 ) ;
if ( V_22 )
F_11 ( & V_12 -> V_7 , L_19 ,
V_12 -> V_95 ) ;
F_53 ( V_12 ) ;
...
int V_195 ;
if ( V_135 ) {
for ( V_195 = 0 ; V_195 < V_135 -> V_212 ; V_195 ++ ) {
V_137 ( V_49 , V_195 ) ;
F_32 ( V_49 ,
V_143 ,
false ) ;
