...
V_16 = V_3 -> V_33 -> V_77 ( V_3 -> V_31 , V_55 , V_11 ) ;
if ( V_16 <= 0 ) {
if ( V_16 == - V_58 ) {
F_6 ( & V_3 -> V_6 , V_4 ) ;
F_48 ( V_38 ) ;
...
int V_16 ;
char V_90 ;
V_16 = V_3 -> V_33 -> V_77 ( V_3 -> V_31 , & V_90 , 1 ) ;
if ( V_16 <= 0 )
return V_91 ;
return V_90 ;
}
static void F_71 ( struct V_23 * V_39 , int line , char V_90 )
{
struct V_37 * V_38 = V_39 -> V_89 [ 0 ] ;
struct V_1 * V_3 = V_38 -> V_41 ;
int V_16 ;
