...
if ( V_14 -> V_15 )
V_8 -> V_22 += V_14 -> V_17 ;
else if ( V_41 && ! F_49 ( V_14 , V_8 -> V_4 ) ) {
V_8 -> V_20 ++ ;
V_14 -> V_57 = true ;
V_14 -> V_17 = 1 ;
} else
...
static void F_52 ( struct V_1 * V_8 , bool V_41 )
{
V_8 -> V_20 = 0 ;
V_8 -> V_22 = 0 ;
F_50 ( V_8 , V_41 ) ;
...
static void F_53 ( struct V_1 * V_8 , bool V_41 )
{
if ( ! V_8 -> V_69 )
return;
F_48 ( V_8 -> V_69 , V_8 , V_41 ) ;
V_8 -> V_24 . V_18 = F_8 ( V_8 ) ;
}
static void F_54 ( struct V_23 * V_8 )
{
F_55 ( V_8 , 4 ,
L_2
L_3
...
static int F_56 ( struct V_1 * V_8 , char * V_76 , T_3 V_77 )
{
return V_8 -> V_78 ? V_8 -> V_78 ( V_8 , V_76 , V_77 ) : 0 ;
}
int F_57 ( struct V_1 * V_8 , const char * V_79 )
{
int V_80 ;
char V_78 [ 160 ] ;
...
V_8 -> V_24 . V_18 = F_8 ( V_8 ) ;
F_56 ( V_8 , V_78 , sizeof( V_78 ) ) ;
if ( F_58 ( & V_8 -> V_24 , V_78 , L_6 , V_79 ) < 0 )
return - 1 ;
while ( 1 ) {
V_80 = F_59 ( & V_8 -> V_24 , V_83 ) ;
switch ( V_80 ) {
case V_85 : {
T_4 V_18 ;
V_82 -> V_86 ( V_82 -> V_87 ) ;
...
int V_101 , V_35 ;
char V_48 = F_21 ( V_47 ) ;
bool V_102 = V_8 -> V_103 && V_47 -> V_71 . V_104 && F_66 ( V_47 -> V_71 . V_104 ) -> V_105 ;
V_101 = V_106 ;
V_35 = V_8 -> V_24 . V_35 - ( V_99 + 2 ) ;
if ( F_67 ( & V_8 -> V_24 , V_36 ) ) {
V_8 -> V_72 = & V_47 -> V_71 ;
V_101 = V_107 ;
V_87 -> V_108 = true ;
}
F_68 ( & V_8 -> V_24 , V_101 ) ;
F_14 ( V_8 , V_36 , 0 ) ;
F_69 ( & V_8 -> V_24 , L_8 , V_99 ) ;
F_70 ( & V_8 -> V_24 , L_9 , V_48 ) ;
F_71 ( & V_8 -> V_24 , V_102 ? V_109 : ' ' ) ;
F_69 ( & V_8 -> V_24 , V_98 , V_35 ) ;
}
static void F_72 ( struct V_1 * V_24 V_49 ,
struct V_39 * V_47 ,
const char * V_98 , int V_99 ,
...
static bool F_73 ( struct V_1 * V_8 ,
unsigned short V_36 )
{
return V_8 -> V_24 . V_31 == V_36 ;
}
static bool F_74 ( struct V_1 * V_8 V_49 ,
unsigned short V_36 V_49 )
{
return false ;
}
...
V_115 = NULL ;
V_117 = NULL ;
V_98 = F_76 ( V_47 , V_76 , sizeof( V_76 ) ,
V_8 -> V_103 ) ;
if ( V_5 . V_118 ) {
if ( V_113 )
F_77 ( V_43 , V_47 , NULL ,
...
F_77 ( NULL , V_47 , NULL ,
V_116 , sizeof( V_116 ) ) ;
if ( F_78 ( & V_117 , L_11 , V_98 , V_116 ) < 0 )
V_98 = L_12 ;
else
V_98 = V_117 ;
}
if ( V_113 ) {
F_79 ( V_43 , V_116 , sizeof( V_116 ) ,
V_112 ) ;
if ( F_78 ( & V_115 , L_13 , V_116 , V_98 ) < 0 )
V_98 = L_12 ;
else
V_98 = V_115 ;
}
...
static bool F_80 ( struct V_9 * V_43 , T_4 V_119 )
{
struct V_42 * V_46 ;
if ( V_43 == NULL )
return false ;
...
static char * F_83 ( struct V_1 * V_8 ,
struct V_39 * V_47 ,
...
V_8 -> V_103 ) ;
if ( V_126 ) {
if ( F_78 ( & V_127 , L_14 , V_126 ,
V_5 . V_128 ? : L_15 , V_98 ) < 0 )
V_127 = NULL ;
} else {
if ( V_125 ) {
if ( F_78 ( & V_127 , L_13 , V_125 , V_98 ) < 0 )
V_127 = NULL ;
} else {
if ( F_78 ( & V_127 , L_6 , V_98 ) < 0 )
V_127 = NULL ;
}
}
return V_127 ;
...
if ( V_113 ) {
char V_116 [ 64 ] ;
F_79 ( V_46 , V_116 , sizeof( V_116 ) , V_112 ) ;
if ( F_78 ( & V_125 , L_6 , V_116 ) < 0 ) {
V_125 = ( char * ) L_16 ;
goto V_133;
}
V_130 = V_125 ;
...
static int F_86 ( struct V_1 * V_8 ,
...
int F_88 ( struct V_144 * V_145 , const char * V_146 , ... )
{
...
va_end ( args ) ;
F_89 ( V_87 -> V_24 , V_59 , V_87 -> V_151 ) ;
V_149 = F_90 ( V_145 -> V_116 , V_145 -> V_77 , V_146 , V_150 , V_59 ) ;
F_70 ( V_87 -> V_24 , L_6 , V_145 -> V_116 ) ;
return V_149 ;
}
void F_91 ( void )
{
...
F_95 ( V_139 , & V_145 , V_146 , V_149 ) ;
F_70 ( & V_8 -> V_24 , L_6 , V_167 + V_149 ) ;
} else {
F_95 ( V_139 , & V_145 , V_146 , V_146 -> V_139 ( V_146 , & V_145 , V_139 ) ) ;
F_70 ( & V_8 -> V_24 , L_6 , V_167 ) ;
}
V_35 -= V_145 . V_116 - V_167 ;
}
if ( ! V_8 -> V_24 . V_169 )
V_35 += 1 ;
F_69 ( & V_8 -> V_24 , L_19 , V_35 ) ;
++ V_36 ;
++ V_110 ;
} else
-- V_95 ;
...
F_68 ( & V_8 -> V_24 , V_106 ) ;
F_69 ( & V_8 -> V_24 , L_19 , V_134 * V_174 ) ;
V_35 -= V_134 * V_174 ;
V_171 = F_97 ( & V_139 -> V_3 -> V_176 ,
struct V_170 , V_62 ) ;
F_98 (&fmt_node->hpp, fmt) {
char V_167 [ 2048 ] ;
struct V_144 V_145 = {
. V_116 = V_167 ,
. V_77 = sizeof( V_167 ) ,
...
F_98 (entry->hpp_list, fmt) {
if ( V_61 ) {
F_70 ( & V_8 -> V_24 , L_17 , V_48 ) ;
V_61 = false ;
} else {
F_69 ( & V_8 -> V_24 , L_19 , 2 ) ;
}
V_35 -= 2 ;
if ( V_146 -> V_101 ) {
...
F_69 ( & V_8 -> V_24 , L_19 , V_134 * V_174 ) ;
V_35 -= V_134 * V_174 ;
V_171 = F_97 ( & V_8 -> V_3 -> V_176 ,
struct V_170 , V_62 ) ;
F_98 (&fmt_node->hpp, fmt) {
if ( F_94 ( V_146 , V_8 -> V_3 ) ||
V_37 ++ < V_8 -> V_24 . V_168 )
continue;
...
F_69 ( & V_8 -> V_24 , L_19 , V_149 ) ;
V_35 -= V_149 ;
}
F_69 ( & V_8 -> V_24 , L_19 , V_179 * V_174 ) ;
V_35 -= V_179 * V_174 ;
if ( V_37 >= V_8 -> V_24 . V_168 ) {
char V_116 [ 32 ] ;
V_149 = snprintf ( V_116 , sizeof( V_116 ) , L_20 , V_8 -> V_4 ) ;
F_70 ( & V_8 -> V_24 , L_21 , V_116 ) ;
V_35 -= V_149 + 2 ;
}
if ( ! V_8 -> V_24 . V_169 )
V_35 += 1 ;
...
static int F_101 ( struct V_144 * V_145 , int V_180 )
{
F_102 ( V_145 , V_180 ) ;
return V_145 -> V_77 <= 0 ;
}
static int
F_103 ( struct V_1 * V_8 , char * V_116 ,
T_3 V_77 , int line )
{
struct V_3 * V_3 = V_8 -> V_3 ;
struct V_144 V_181 = {
...
int V_182 = 0 ;
if ( V_5 . V_166 ) {
V_149 = F_90 ( V_116 , V_77 , L_18 ) ;
if ( F_101 ( & V_181 , V_149 ) )
return V_149 ;
}
F_93 (browser->hists, fmt) {
if ( F_94 ( V_146 , V_3 ) || V_37 ++ < V_8 -> V_24 . V_168 )
continue;
...
if ( V_182 )
continue;
V_149 = F_90 ( V_181 . V_116 , V_181 . V_77 , L_18 ) ;
if ( F_101 ( & V_181 , V_149 ) )
break;
}
return V_149 ;
}
static int F_104 ( struct V_1 * V_8 , char * V_116 , T_3 V_77 )
{
struct V_3 * V_3 = V_8 -> V_3 ;
struct V_144 V_181 = {
. V_116 = V_116 ,
...
if ( ! V_184 ) {
V_149 = F_90 ( V_181 . V_116 , V_181 . V_77 , L_22 ,
V_179 * V_174 , L_19 ) ;
if ( F_101 ( & V_181 , V_149 ) )
return V_149 ;
}
V_184 = true ;
F_105 (fmt_node, &hists->hpp_formats, list) {
if ( ! V_184 ) {
V_149 = F_90 ( V_181 . V_116 , V_181 . V_77 , L_23 ) ;
if ( F_101 ( & V_181 , V_149 ) )
break;
}
V_184 = false ;
...
continue;
if ( ! V_185 ) {
V_149 = F_90 ( V_181 . V_116 , V_181 . V_77 , L_24 ) ;
if ( F_101 ( & V_181 , V_149 ) )
break;
}
V_185 = false ;
...
F_15 ( & V_8 -> V_24 , 0 , 0 ) ;
F_68 ( & V_8 -> V_24 , V_188 ) ;
F_69 ( & V_8 -> V_24 , V_187 , V_8 -> V_24 . V_35 + 1 ) ;
}
...
static void F_110 ( struct V_23 * V_8 )
{
if ( V_8 -> V_94 == NULL ) {
struct V_1 * V_2 ;
...
static unsigned int F_111 ( struct V_23 * V_8 )
{
unsigned V_36 = 0 ;
T_2 V_27 = 0 ;
struct V_9 * V_10 ;
...
continue;
if ( V_5 . V_19 ) {
V_36 += F_96 ( V_2 , V_93 , V_36 ,
V_93 -> V_74 ) ;
if ( V_36 == V_8 -> V_31 )
break;
if ( V_93 -> V_57 ) {
F_100 ( V_2 , V_36 , V_93 -> V_74 + 1 ) ;
V_36 ++ ;
}
} else {
V_36 += F_92 ( V_2 , V_93 , V_36 ) ;
}
if ( V_36 == V_8 -> V_31 )
break;
}
...
static struct V_9 * F_112 ( struct V_9 * V_10 ,
float V_4 )
{
while ( V_10 != NULL ) {
struct V_13 * V_93 = F_7 ( V_10 , struct V_13 , V_9 ) ;
...
static void F_114 ( struct V_23 * V_8 ,
T_8 V_99 , int V_189 )
{
struct V_13 * V_93 ;
struct V_9 * V_10 ;
...
goto V_192;
case V_193 :
V_10 = F_115 ( F_116 ( V_8 -> V_12 ) ) ;
V_10 = F_112 ( V_10 , V_2 -> V_4 ) ;
V_61 = false ;
break;
default:
return;
...
F_93 (browser->hists, fmt) {
if ( F_94 ( V_146 , V_14 -> V_3 ) )
continue;
if ( ! V_61 ) {
V_149 = F_90 ( V_145 . V_116 , V_145 . V_77 , L_18 ) ;
F_102 ( & V_145 , V_149 ) ;
} else
V_61 = false ;
V_149 = V_146 -> V_139 ( V_146 , & V_145 , V_14 ) ;
V_149 = F_95 ( V_14 , & V_145 , V_146 , V_149 ) ;
F_102 ( & V_145 , V_149 ) ;
}
V_110 += fprintf ( V_111 , L_25 , V_167 ) ;
if ( V_48 == '-' )
V_110 += F_117 ( V_8 , V_14 , V_111 , 1 ) ;
return V_110 ;
}
...
V_149 = F_90 ( V_145 . V_116 , V_145 . V_77 , L_22 , V_172 , L_19 ) ;
F_102 ( & V_145 , V_149 ) ;
...
V_110 += fprintf ( V_111 , L_25 , F_120 ( V_167 ) ) ;
if ( V_14 -> V_15 && V_48 == '-' ) {
V_110 += F_117 ( V_8 , V_14 , V_111 ,
V_14 -> V_74 + 1 ) ;
}
return V_110 ;
}
static int F_121 ( struct V_1 * V_8 , T_9 * V_111 )
{
...
T_9 * V_111 ;
while ( 1 ) {
F_90 ( V_195 , sizeof( V_195 ) , L_26 , V_8 -> V_196 ) ;
if ( F_123 ( V_195 , V_197 ) )
break;
if ( ++ V_8 -> V_196 == 8192 ) {
F_63 ( L_27 ) ;
return - 1 ;
...
if ( V_111 == NULL ) {
char V_76 [ 64 ] ;
const char * V_198 = F_124 ( V_199 , V_76 , sizeof( V_76 ) ) ;
F_63 ( L_29 , V_195 , V_198 ) ;
return - 1 ;
}
++ V_8 -> V_196 ;
F_121 ( V_8 , V_111 ) ;
...
struct V_1 * F_127 ( struct V_3 * V_3 )
{
struct V_1 * V_8 = F_128 ( sizeof( * V_8 ) ) ;
if ( V_8 )
F_125 ( V_8 , V_3 ) ;
return V_8 ;
}
static struct V_1 *
F_129 ( struct V_205 * V_206 ,
struct V_81 * V_82 ,
struct V_207 * V_208 )
{
struct V_1 * V_8 = F_127 ( F_130 ( V_206 ) ) ;
if ( V_8 ) {
V_8 -> V_82 = V_82 ;
V_8 -> V_208 = V_208 ;
V_8 -> V_78 = V_209 ;
...
void F_131 ( struct V_1 * V_8 )
{
free ( V_8 ) ;
}
static struct V_13 * F_132 ( struct V_1 * V_8 )
{
return V_8 -> V_69 ;
}
static struct V_210 * F_133 ( struct V_1 * V_8 )
{
return V_8 -> V_69 -> V_210 ;
}
static inline bool F_134 ( void * V_86 )
{
return V_86 == NULL ;
}
...
struct V_205 * V_206 = F_135 ( V_3 ) ;
const char * V_220 = F_136 ( V_206 ) ;
char V_116 [ 512 ] ;
...
if ( F_137 ( V_206 ) ) {
struct V_205 * V_227 ;
F_138 ( V_206 , V_116 , V_221 ) ;
V_220 = V_116 ;
F_139 (pos, evsel) {
struct V_3 * V_228 = F_130 ( V_227 ) ;
if ( V_5 . V_224 ) {
...
strstr ( V_220 , L_32 ) )
V_223 = true ;
V_217 = F_140 ( V_217 , & V_211 ) ;
V_110 = F_90 ( V_76 , V_77 ,
L_33 V_230 ,
...
if ( V_210 ) {
if ( F_141 ( V_3 , V_210 ) ) {
V_110 += F_90 ( V_76 + V_110 , V_77 - V_110 ,
L_35 ,
( V_210 -> V_232 ? F_142 ( V_210 ) : L_19 ) ,
V_210 -> V_233 ) ;
} else {
V_110 += F_90 ( V_76 + V_110 , V_77 - V_110 ,
L_36 ,
...
if ( V_94 -> V_236 )
V_110 += F_90 ( V_76 + V_110 , V_77 - V_110 , L_39 ) ;
}
return V_110 ;
}
static inline void F_143 ( char * * V_237 , int V_44 )
{
int V_177 ;
...
goto V_254;
if ( F_148 ( V_248 ) ) {
V_237 [ V_242 ] = F_149 ( V_249 ) ;
if ( ! V_237 [ V_242 ] )
goto V_254;
V_239 [ V_242 ] = F_149 ( V_246 ) ;
if ( ! V_239 [ V_242 ] ) {
F_144 ( & V_237 [ V_242 ] ) ;
F_150 ( L_43 ) ;
fclose ( V_251 ) ;
...
F_151 ( V_241 ) ;
if ( V_242 ) {
V_243 = F_152 ( V_242 , V_237 ) ;
if ( V_243 < V_242 && V_243 >= 0 ) {
V_240 = F_149 ( V_239 [ V_243 ] ) ;
if ( V_240 ) {
if ( V_255 )
free ( ( void * ) V_256 ) ;
V_256 = V_240 ;
...
static int
F_153 ( struct V_1 * V_8 , struct V_257 * V_258 )
{
struct V_205 * V_206 ;
struct V_259 * V_260 ;
struct V_13 * V_14 ;
int V_198 ;
if ( ! V_261 && F_154 ( V_8 -> V_208 ) )
return 0 ;
V_260 = F_66 ( V_258 -> V_71 . V_104 ) ;
if ( ! V_260 -> V_105 )
return 0 ;
V_206 = F_135 ( V_8 -> V_3 ) ;
V_198 = F_155 ( & V_258 -> V_71 , V_206 , V_8 -> V_82 ) ;
V_14 = F_132 ( V_8 ) ;
if ( ( V_198 == 'q' || V_198 == F_156 ( 'c' ) ) && V_14 -> V_262 )
return 1 ;
F_60 ( & V_8 -> V_24 , V_8 -> V_3 -> V_18 ) ;
if ( V_198 )
F_157 ( & V_8 -> V_24 ) ;
return 0 ;
}
static int
F_158 ( struct V_1 * V_8 V_49 ,
struct V_257 * V_258 , char * * V_263 ,
struct V_264 * V_264 , struct V_265 * V_104 )
{
if ( V_104 == NULL || V_264 -> V_212 -> V_266 )
return 0 ;
if ( F_78 ( V_263 , L_47 , V_104 -> V_249 ) < 0 )
return 0 ;
...
static int
F_159 ( struct V_1 * V_8 , struct V_257 * V_258 )
{
struct V_210 * V_210 = V_258 -> V_210 ;
if ( ( ! F_141 ( V_8 -> V_3 , V_210 ) &&
! F_141 ( V_8 -> V_3 , V_268 ) ) || V_210 == NULL )
return 0 ;
if ( V_8 -> V_3 -> V_214 ) {
F_160 ( V_8 -> V_269 , & V_8 -> V_3 -> V_214 ) ;
F_161 ( V_270 , false ) ;
F_162 ( V_8 -> V_3 -> V_214 ) ;
F_62 () ;
} else {
...
V_8 -> V_3 -> V_214 = F_163 ( V_210 ) ;
F_161 ( V_270 , false ) ;
F_164 ( V_8 -> V_269 , & V_8 -> V_3 -> V_214 ) ;
}
F_165 ( V_8 -> V_3 ) ;
F_16 ( V_8 ) ;
return 0 ;
...
static int
F_166 ( struct V_1 * V_8 , struct V_257 * V_258 ,
...
return 0 ;
if ( F_141 ( V_8 -> V_3 , V_210 ) ) {
V_149 = F_78 ( V_263 , L_50 ,
V_8 -> V_3 -> V_214 ? L_51 : L_52 ,
V_210 -> V_232 ? F_142 ( V_210 ) : L_19 ,
V_210 -> V_233 ) ;
} else {
V_149 = F_78 ( V_263 , L_53 ,
V_8 -> V_3 -> V_214 ? L_51 : L_52 ,
V_210 -> V_232 ? F_142 ( V_210 ) : L_19 ) ;
}
if ( V_149 < 0 )
...
static int
F_167 ( struct V_1 * V_8 , struct V_257 * V_258 )
{
struct V_264 * V_264 = V_258 -> V_71 . V_264 ;
if ( ! F_141 ( V_8 -> V_3 , V_212 ) || V_264 == NULL )
return 0 ;
if ( V_8 -> V_3 -> V_213 ) {
F_160 ( V_8 -> V_269 , & V_8 -> V_3 -> V_213 ) ;
F_161 ( V_271 , false ) ;
V_8 -> V_3 -> V_213 = NULL ;
F_62 () ;
} else {
F_63 ( L_54 ,
F_168 ( V_264 ) ? L_55 : V_264 -> V_212 -> V_234 ) ;
V_8 -> V_3 -> V_213 = V_264 -> V_212 ;
F_161 ( V_271 , true ) ;
F_164 ( V_8 -> V_269 , & V_8 -> V_3 -> V_213 ) ;
}
F_169 ( V_8 -> V_3 ) ;
F_16 ( V_8 ) ;
return 0 ;
...
static int
F_170 ( struct V_1 * V_8 , struct V_257 * V_258 ,
...
F_168 ( V_264 ) ? L_55 : V_264 -> V_212 -> V_234 ) < 0 )
return 0 ;
V_258 -> V_71 . V_264 = V_264 ;
V_258 -> V_267 = F_167 ;
return 1 ;
...
static int
F_171 ( struct V_1 * V_8 V_49 ,
struct V_257 * V_258 )
{
F_172 ( V_258 -> V_71 . V_264 ) ;
return 0 ;
}
static int
F_173 ( struct V_1 * V_8 ,
struct V_257 * V_258 , char * * V_263 , struct V_264 * V_264 )
{
if ( ! F_141 ( V_8 -> V_3 , V_212 ) || V_264 == NULL )
return 0 ;
if ( F_78 ( V_263 , L_57 ) < 0 )
return 0 ;
V_258 -> V_71 . V_264 = V_264 ;
V_258 -> V_267 = F_171 ;
return 1 ;
...
if ( V_258 -> V_210 ) {
F_90 ( V_272 , sizeof( V_272 ) , L_58 ,
F_142 ( V_258 -> V_210 ) ) ;
} else if ( V_258 -> V_71 . V_104 ) {
F_90 ( V_272 , sizeof( V_272 ) , L_59 ,
...
static int
F_178 ( struct V_1 * V_8 ,
struct V_257 * V_258 , char * * V_263 )
{
if ( ! F_134 ( V_8 -> V_82 ) )
return 0 ;
if ( F_78 ( V_263 , L_65 ) < 0 )
return 0 ;
V_258 -> V_267 = F_177 ;
return 1 ;
}
static int
F_179 ( struct V_1 * V_8 V_49 ,
struct V_257 * V_258 V_49 )
{
return 0 ;
}
static int
F_180 ( struct V_1 * V_8 V_49 ,
struct V_257 * V_258 , char * * V_263 )
{
if ( F_78 ( V_263 , L_66 ) < 0 )
return 0 ;
V_258 -> V_267 = F_179 ;
return 1 ;
}
...
{
if ( ! F_141 ( V_8 -> V_3 , V_274 ) || V_258 -> V_274 < 0 )
return 0 ;
if ( V_8 -> V_3 -> V_216 > - 1 ) {
F_160 ( V_8 -> V_269 , & V_8 -> V_3 -> V_216 ) ;
V_8 -> V_3 -> V_216 = - 1 ;
F_161 ( V_275 , false ) ;
} else {
V_8 -> V_3 -> V_216 = V_258 -> V_274 ;
F_161 ( V_275 , true ) ;
F_164 ( V_8 -> V_269 , & V_8 -> V_3 -> V_216 ) ;
}
F_182 ( V_8 -> V_3 ) ;
F_16 ( V_8 ) ;
return 0 ;
...
static int
F_183 ( struct V_1 * V_8 , struct V_257 * V_258 ,
char * * V_263 , int V_215 )
{
if ( ! F_141 ( V_8 -> V_3 , V_274 ) || V_215 < 0 )
return 0 ;
if ( F_78 ( V_263 , L_67 ,
...
static int F_185 ( struct V_205 * V_206 , int V_90 ,
const char * V_280 ,
bool V_281 ,
struct V_81 * V_82 ,
float V_4 ,
struct V_207 * V_208 )
{
struct V_3 * V_3 = F_130 ( V_206 ) ;
struct V_1 * V_8 = F_129 ( V_206 , V_82 , V_208 ) ;
struct V_262 * V_282 ;
#define F_186 16
char * V_237 [ F_186 ] ;
struct V_257 V_283 [ F_186 ] ;
int V_242 = 0 ;
int V_80 = - 1 ;
char V_116 [ 64 ] ;
int V_83 = V_82 ? V_82 -> V_84 : 0 ;
...
if ( ! F_141 ( V_3 , V_104 ) || V_8 -> V_72 == NULL )
goto V_302;
if ( V_303 == V_304 ) {
...
V_302:
V_242 += F_166 ( V_8 , & V_283 [ V_242 ] ,
& V_237 [ V_242 ] , V_210 ) ;
V_242 += F_170 ( V_8 , & V_283 [ V_242 ] ,
& V_237 [ V_242 ] , V_264 ) ;
V_242 += F_173 ( V_8 , & V_283 [ V_242 ] ,
& V_237 [ V_242 ] ,
V_8 -> V_72 ?
V_8 -> V_72 -> V_264 : NULL ) ;
V_242 += F_183 ( V_8 , & V_283 [ V_242 ] ,
& V_237 [ V_242 ] ,
V_287 ) ;
if ( ! F_134 ( V_82 ) )
goto V_307;
if ( V_8 -> V_69 ) {
if ( F_141 ( V_3 , V_210 ) && V_210 ) {
V_242 += F_176 ( V_8 ,
& V_283 [ V_242 ] ,
& V_237 [ V_242 ] ,
V_210 , NULL ) ;
}
if ( F_141 ( V_3 , V_104 ) && V_8 -> V_72 -> V_104 ) {
V_242 += F_176 ( V_8 ,
& V_283 [ V_242 ] ,
& V_237 [ V_242 ] ,
NULL , V_8 -> V_72 -> V_104 ) ;
...
static void F_202 ( struct V_23 * V_8 ,
void * V_139 , int V_36 )
{
...
V_90 = F_140 ( V_90 , & V_211 ) ;
V_110 = F_90 ( V_76 , sizeof( V_76 ) , L_91 , V_90 ,
...
F_68 ( V_8 , V_312 ) ;
V_90 = F_140 ( V_90 , & V_211 ) ;
V_110 += F_90 ( V_76 , sizeof( V_76 ) , L_92 ,
V_90 , V_211 , V_211 == ' ' ? L_19 : L_8 ) ;
V_310 = V_76 ;
}
F_69 ( V_8 , V_310 , V_8 -> V_35 - V_110 ) ;
if ( V_151 )
V_309 -> V_72 = V_206 ;
}
static int F_204 ( struct V_308 * V_309 ,
...
int V_83 = V_82 ? V_82 -> V_84 : 0 ;
int V_80 ;
if ( F_58 ( & V_309 -> V_24 , V_78 ,
L_94 ) < 0 )
return - 1 ;
while ( 1 ) {
V_80 = F_59 ( & V_309 -> V_24 , V_83 ) ;
switch ( V_80 ) {
case V_85 :
V_82 -> V_86 ( V_82 -> V_87 ) ;
...
if ( V_82 )
V_82 -> V_86 ( V_82 -> V_87 ) ;
V_80 = F_185 ( V_227 , V_90 , V_79 ,
true , V_82 ,
V_309 -> V_4 ,
V_309 -> V_208 ) ;
F_61 ( & V_309 -> V_24 , V_78 ) ;
switch ( V_80 ) {
case V_288 :
...
static bool F_210 ( struct V_23 * V_8 V_49 ,
void * V_139 )
{
struct V_205 * V_206 = F_37 ( V_139 , struct V_205 , V_43 ) ;
if ( V_5 . V_317 && ! F_211 ( V_206 ) )
return true ;
return false ;
}
static int F_212 ( struct V_313 * V_300 ,
...
F_191 ( L_95 ) ;
F_213 (evlist, pos) {
const char * V_220 = F_136 ( V_227 ) ;
T_3 V_322 = strlen ( V_220 ) + 7 ;
if ( V_309 . V_24 . V_35 < V_322 )
V_309 . V_24 . V_35 = V_322 ;
}
return F_204 ( & V_309 , V_18 , V_79 , V_82 ) ;
}
int F_214 ( struct V_313 * V_300 , const char * V_79 ,
struct V_81 * V_82 ,
float V_4 ,
struct V_207 * V_208 )
{
...
V_323:
if ( V_18 == 1 ) {
struct V_205 * V_61 = F_206 ( V_300 ) ;
return F_185 ( V_61 , V_18 , V_79 ,
false , V_82 , V_4 ,
V_208 ) ;
}
if ( V_5 . V_317 ) {
