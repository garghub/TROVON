...
* V_49 = ( unsigned long ) & V_36 -> V_110 ;
V_36 -> V_110 = 0 ;
V_44 -> V_54 = V_111 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( & V_36 -> V_110 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_49 ;
V_39 = F_32 ( V_36 , V_44 , V_112 ) ;
if ( V_39 )
goto V_100;
F_21 ( V_49 ) ;
F_21 ( V_44 ) ;
...
if ( ! V_44 )
return 0 ;
V_117 = F_18 ( sizeof( * V_117 ) , V_53 | V_18 ) ;
if ( ! V_117 ) {
V_17 = 0 ;
goto V_118;
}
...
V_44 -> V_54 = V_119 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_117 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_117 ;
V_39 = F_32 ( V_36 , V_44 , V_120 ) ;
if ( V_39 ) {
V_17 = 0 ;
goto V_118;
}
V_17 = F_68 ( V_117 -> V_117 ) ;
if ( V_36 -> V_80 == 0 )
goto V_118;
V_117 -> V_72 = 1 ;
V_44 -> V_54 = V_119 ;
...
F_72 ( V_3 ) ;
V_117 -> V_72 = 0 ;
V_117 -> V_117 = F_73 ( ( V_123 ) V_3 -> V_117 ) ;
V_44 -> V_54 = V_124 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_117 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_117 ;
V_39 = F_32 ( V_36 , V_44 , V_125 ) ;
if ( V_39 )
goto V_118;
if ( V_36 -> V_80 == 0 )
goto V_118;
V_117 -> V_72 = 1 ;
V_117 -> V_117 = F_73 ( V_3 -> V_117 >> 32 ) ;
V_44 -> V_54 = V_124 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_117 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_117 ;
...
unsigned int V_126 , void * V_127 , unsigned V_128 )
{
struct V_1 * V_36 = F_1 ( V_3 ) ;
int V_39 ;
struct V_43 * V_44 ;
...
if ( ! V_44 )
return;
V_129 = F_18 ( V_130 , V_53 | V_18 ) ;
if ( ! V_129 )
goto V_118;
V_44 -> V_54 = V_131 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = V_126 + V_128 ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_129 ;
V_39 = F_32 ( V_36 , V_44 , V_132 ) ;
if ( V_39 )
goto V_118;
memcpy ( V_36 -> V_133 , V_129 , V_126 + V_128 ) ;
if ( V_127 )
memcpy ( V_127 , & V_36 -> V_133 [ V_126 ] , V_128 ) ;
if ( V_36 -> V_134 < V_126 + V_128 )
V_36 -> V_134 = V_126 + V_128 ;
V_118:
F_21 ( V_129 ) ;
F_21 ( V_44 ) ;
}
static void F_75 ( struct V_2 * V_3 ,
unsigned int V_126 , const void * V_127 ,
unsigned V_128 )
{
struct V_1 * V_36 = F_1 ( V_3 ) ;
struct V_43 * V_44 ;
...
goto V_118;
if ( V_36 -> V_134 < V_126 )
F_74 ( V_3 , 0 , NULL , V_126 ) ;
memcpy ( & V_36 -> V_133 [ V_126 ] , V_127 , V_128 ) ;
memcpy ( V_129 , V_36 -> V_133 , sizeof( V_36 -> V_133 ) ) ;
V_44 -> V_54 = V_135 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = V_126 + V_128 ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_129 ;
F_32 ( V_36 , V_44 , V_136 ) ;
V_118:
F_21 ( V_129 ) ;
F_21 ( V_44 ) ;
}
...
V_44 -> V_54 = V_138 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_36 -> V_113 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_36 -> V_113 ;
F_32 ( V_36 , V_44 , V_139 ) ;
F_21 ( V_44 ) ;
return * V_36 -> V_113 ;
}
static void F_77 ( struct V_2 * V_3 , T_9 V_113 )
{
struct V_1 * V_36 = F_1 ( V_3 ) ;
T_9 V_137 = * V_36 -> V_113 ;
struct V_43 * V_44 ;
...
V_44 -> V_54 = V_140 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( V_113 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_36 -> V_113 ;
V_39 = F_32 ( V_36 , V_44 , V_141 ) ;
if ( V_39 )
* V_36 -> V_113 = V_137 ;
F_21 ( V_44 ) ;
}
static void F_78 ( struct V_142 * V_143 )
{
struct V_2 * V_63 = F_79 ( V_143 ) ;
struct V_1 * V_36 = F_1 ( V_63 ) ;
F_21 ( V_36 -> V_113 ) ;
F_21 ( V_36 -> V_73 ) ;
F_21 ( V_36 ) ;
}
static int F_80 ( struct V_144 * V_144 )
{
if ( F_81 ( & V_144 -> V_145 ) != 0 )
return 1 ;
if ( F_82 ( & V_144 -> V_145 ) & ~ ( V_146 | V_147 ) )
return 1 ;
if ( F_83 ( & V_144 -> V_145 ) != 0 )
return 1 ;
return 0 ;
}
...
static void F_88 ( struct V_150 * V_40 ,
unsigned long V_45 ,
struct V_144 * V_144 )
{
T_2 V_148 = V_45 & V_46 ;
...
if ( F_94 ( 0 , & V_36 -> V_110 ) ) {
F_95 ( & V_36 -> V_3 ) ;
F_92 ( 0 , & V_36 -> V_110 ) ;
}
}
static int F_96 ( struct V_150 * V_40 )
{
struct V_157 V_158 ;
F_97 ( V_40 , & V_158 ) ;
if ( F_94 ( V_158 . V_159 , V_160 [ V_158 . V_161 ] ) )
return 0 ;
return 1 ;
}
static void F_98 ( void * V_162 , T_10 V_67 )
{
struct V_150 * V_40 = V_162 ;
int V_39 ;
V_39 = F_99 ( V_40 ) ;
if ( V_39 )
F_47 ( & V_40 -> V_63 , L_17 , V_39 ) ;
}
static int F_100 ( struct V_150 * V_40 )
{
V_40 -> V_22 = F_88 ;
if ( F_96 ( V_40 ) )
F_101 ( F_98 , V_40 ) ;
...
static struct V_1 * F_102 ( struct V_150 * V_40 )
{
unsigned long V_9 ;
struct V_1 * V_36 ;
F_29 ( F_30 ( V_40 ) , V_9 ) ;
...
static void F_103 ( struct V_150 * V_40 )
{
unsigned long V_9 ;
...
static int F_107 ( struct V_150 * V_40 )
{
unsigned long V_9 ;
struct V_1 * V_36 = F_102 ( V_40 ) ;
if ( ! V_36 )
...
if ( ! V_44 )
return - V_95 ;
V_167 = F_18 ( sizeof( * V_167 ) , V_53 | V_18 ) ;
if ( ! V_167 ) {
F_21 ( V_44 ) ;
return - V_95 ;
}
V_44 -> V_54 = V_168 ;
V_44 -> V_9 = 0 ;
V_44 -> V_56 = sizeof( * V_167 ) ;
V_44 -> V_57 = ( T_2 ) ( unsigned long ) V_167 ;
V_36 -> V_80 = V_169 ;
do {
V_167 -> V_80 = V_36 -> V_80 ;
V_167 -> V_170 = 0 ;
V_39 = F_32 ( V_36 , V_44 ,
V_149 ) ;
if ( V_39 == - V_105 ) {
...
static int F_109 ( struct V_150 * V_40 )
{
int V_39 ;
struct V_1 * V_36 ;
unsigned long V_9 ;
...
V_36 -> V_113 = F_18 ( sizeof( * V_36 -> V_113 ) , V_53 | V_18 ) ;
if ( ! V_36 -> V_113 ) {
V_39 = - V_95 ;
goto V_118;
}
V_36 -> V_52 = V_106 ;
V_36 -> V_3 . V_63 . V_171 = & V_40 -> V_63 ;
V_36 -> V_3 . V_63 . V_172 = F_78 ;
V_36 -> V_3 . V_133 = & V_173 ;
V_36 -> V_40 = V_40 ;
F_110 ( & V_36 -> V_48 ) ;
F_111 ( & V_36 -> V_99 ) ;
F_112 ( & V_36 -> V_10 ) ;
...
F_31 ( F_30 ( V_40 ) , V_9 ) ;
V_36 -> V_3 . V_158 . V_174 = V_40 -> V_158 . V_175 ;
V_36 -> V_3 . V_158 . V_142 = V_40 -> V_158 . V_176 ;
V_39 = F_108 ( V_36 ) ;
if ( V_39 )
goto V_118;
V_39 = F_113 ( & V_36 -> V_3 ) ;
...
static int F_115 ( struct V_150 * V_40 , int V_178 )
{
int V_17 ;
struct V_1 * V_36 = F_89 ( & V_40 -> V_63 ) ;
if ( ! V_36 )
...
static int T_11 F_116 ( char * * V_181 , unsigned int * V_182 , int V_183 ,
int V_184 , int V_185 )
{
int V_186 ;
V_186 = 0 ;
* V_182 = 0 ;
while ( V_186 <= V_184 ) {
int V_187 = F_117 ( * * V_181 ) ;
if ( V_187 < 0 )
break;
* V_182 = * V_182 * 16 + V_187 ;
( * V_181 ) ++ ;
V_186 ++ ;
}
if ( ( V_186 < V_183 ) || ( V_186 > V_184 ) || ( * V_182 > V_185 ) )
return 1 ;
return 0 ;
}
static int T_11 F_118 ( char * V_188 , unsigned int * V_189 ,
unsigned int * V_161 , unsigned int * V_159 )
{
char * V_190 ;
int V_17 , V_39 ;
V_17 = 1 ;
...
goto V_100;
V_190 = V_188 ;
V_39 = F_116 ( & V_190 , V_189 , 1 , 2 , V_191 ) ;
if ( V_39 || ( V_190 [ 0 ] != '.' ) )
goto V_100;
V_190 ++ ;
V_39 = F_116 ( & V_190 , V_161 , 1 , 1 , V_192 ) ;
if ( V_39 || ( V_190 [ 0 ] != '.' ) )
goto V_100;
V_190 ++ ;
V_39 = F_116 ( & V_190 , V_159 , 4 , 4 , V_193 ) ;
if ( V_39 || ( V_190 [ 0 ] != '\0' ) )
goto V_100;
V_17 = 0 ;
V_100:
...
{
unsigned int V_194 , V_195 , V_196 , V_197 , V_198 , V_199 ;
char * V_200 , * V_188 ;
int V_17 ;
V_188 = V_201 ;
while ( ( V_200 = F_120 ( & V_188 , L_20 ) ) ) {
V_17 = F_118 ( F_120 ( & V_200 , L_21 ) , & V_194 ,
& V_196 , & V_198 ) ;
if ( V_17 )
continue;
if ( V_200 != NULL ) {
V_17 = F_118 ( V_200 , & V_195 ,
& V_197 , & V_199 ) ;
if ( ( V_196 > V_197 ) ||
