...
static int F_48 ( struct V_128 * V_129 , struct V_1 * V_11 )
{
int V_38 ;
V_38 = F_49 ( V_129 , & V_11 -> V_7 , & V_130 ,
V_131 ) ;
if ( V_38 ) {
F_37 ( L_7 ) ;
return V_38 ;
...
F_50 ( & V_11 -> V_7 , & V_132 ) ;
V_11 -> V_7 . V_133 = V_134 ;
F_51 ( & V_11 -> V_7 , & V_11 -> V_4 ) ;
if ( V_11 -> V_115 ) {
V_38 = F_52 ( V_11 -> V_115 , & V_11 -> V_7 ) ;
if ( V_38 ) {
F_37 ( L_8 ) ;
goto V_135;
}
...
static int F_54 ( struct V_128 * V_129 , struct V_1 * V_11 )
{
int V_38 ;
V_38 = F_55 ( V_129 , & V_11 -> V_4 , & V_136 ,
V_137 , NULL ) ;
if ( V_38 ) {
F_37 ( L_9 ) ;
return V_38 ;
...
F_56 ( & V_11 -> V_4 , & V_138 ) ;
V_11 -> V_4 . V_139 = 1 ;
V_38 = F_57 ( & V_11 -> V_4 , V_11 -> V_140 , NULL ) ;
if ( V_38 ) {
F_37 ( L_10 ) ;
V_38 = F_48 ( V_129 , V_11 ) ;
if ( V_38 )
goto V_141;
}
return 0 ;
...
{
struct V_1 * V_11 = F_2 ( V_143 , struct V_1 , V_144 ) ;
F_13 ( V_11 ) ;
}
static void F_60 ( struct V_142 * V_143 )
{
struct V_1 * V_11 = F_2 ( V_143 , struct V_1 , V_144 ) ;
F_33 ( V_11 ) ;
}
...
static int F_64 ( struct V_36 * V_37 , struct V_36 * V_146 , void * V_14 )
{
int V_38 ;
struct V_128 * V_129 = V_14 ;
struct V_1 * V_11 = F_65 ( V_37 ) ;
V_38 = F_66 ( V_129 , & V_11 -> V_144 ) ;
if ( V_38 < 0 ) {
F_16 ( V_37 , L_11 ,
V_37 -> V_147 -> V_148 , V_38 ) ;
return V_38 ;
}
V_38 = F_67 ( & V_11 -> V_10 ) ;
if ( V_38 < 0 ) {
...
F_68 ( & V_11 -> V_10 ) ;
V_149:
F_69 ( V_129 , & V_11 -> V_144 ) ;
return V_38 ;
}
static void F_70 ( struct V_36 * V_37 , struct V_36 * V_146 ,
void * V_14 )
{
struct V_128 * V_129 = V_14 ;
struct V_1 * V_11 = F_65 ( V_37 ) ;
...
{
struct V_1 * V_11 ;
struct V_36 * V_37 = & V_152 -> V_37 ;
struct V_153 * V_154 , * V_155 ;
struct V_156 * V_16 ;
int V_157 ;
int V_38 ;
V_11 = F_72 ( V_37 , sizeof( * V_11 ) , V_158 ) ;
if ( ! V_11 )
return - V_159 ;
V_11 -> V_10 . V_160 = & V_161 ;
V_11 -> V_10 . V_37 = V_37 ;
V_155 = F_73 ( V_37 -> V_147 , NULL ) ;
if ( V_155 ) {
V_154 = F_74 ( V_155 ) ;
if ( ! V_154 ) {
F_16 ( V_37 , L_14 ) ;
...
V_11 -> V_140 = F_75 ( V_154 ) ;
V_11 -> V_115 = F_76 ( V_154 ) ;
F_77 ( V_154 ) ;
if ( ! V_11 -> V_140 && ! V_11 -> V_115 ) {
F_78 ( V_37 , L_15 ) ;
return - V_163 ;
}
}
V_11 -> V_62 = F_79 ( V_37 , L_16 ) ;
if ( F_80 ( V_11 -> V_62 ) ) {
V_38 = F_81 ( V_11 -> V_62 ) ;
F_16 ( V_37 , L_17 , V_38 ) ;
return V_38 ;
}
V_11 -> V_64 = F_79 ( V_37 , L_18 ) ;
if ( F_80 ( V_11 -> V_64 ) ) {
V_38 = F_81 ( V_11 -> V_64 ) ;
F_16 ( V_37 , L_19 , V_38 ) ;
return V_38 ;
}
V_11 -> V_59 = F_79 ( V_37 , L_20 ) ;
if ( F_80 ( V_11 -> V_59 ) ) {
V_38 = F_81 ( V_11 -> V_59 ) ;
F_16 ( V_37 , L_21 , V_38 ) ;
return V_38 ;
}
V_16 = F_82 ( V_152 , V_164 , 0 ) ;
V_11 -> V_16 = F_83 ( V_37 , V_16 ) ;
if ( F_80 ( V_11 -> V_16 ) ) {
V_38 = F_81 ( V_11 -> V_16 ) ;
F_16 ( V_37 , L_22 , V_38 ) ;
return V_38 ;
}
V_11 -> V_61 = F_84 ( V_37 , L_23 ) ;
if ( F_80 ( V_11 -> V_61 ) ) {
V_38 = F_81 ( V_11 -> V_61 ) ;
F_16 ( V_37 , L_24 , V_38 ) ;
return V_38 ;
}
V_157 = F_85 ( V_37 -> V_147 , V_165 ) ;
if ( V_157 < 0 ) {
F_16 ( V_37 , L_25 , V_157 ) ;
return V_157 ;
}
V_38 = F_86 ( V_37 , V_37 -> V_147 , & V_11 -> V_144 , V_157 ,
& V_166 ) ;
if ( V_38 ) {
F_16 ( V_37 , L_26 , V_38 ) ;
return V_38 ;
...
F_87 ( V_152 , V_11 ) ;
return F_88 ( & V_152 -> V_37 , & V_167 ) ;
}
static int F_89 ( struct V_151 * V_152 )
{
struct V_1 * V_11 = F_90 ( V_152 ) ;
F_38 ( V_11 ) ;
F_91 ( & V_152 -> V_37 , & V_167 ) ;
return 0 ;
}
