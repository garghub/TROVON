...
goto V_151;
V_96 = - V_130 ;
V_2 = F_128 ( sizeof( * V_2 ) + V_146 , V_108 ) ;
if ( ! V_2 )
goto V_151;
...
static void F_129 ( struct V_13 * V_153 , struct V_13 * V_154 )
{
if ( F_130 ( V_153 == V_154 ) || ! V_154 ) {
F_14 ( V_153 ) ;
return;
}
if ( V_153 < V_154 ) {
...
static void F_132 ( struct V_13 * V_153 , struct V_13 * V_154 )
{
if ( F_130 ( V_153 == V_154 ) || ! V_154 ) {
F_16 ( V_153 ) ;
return;
...
static long F_136 ( struct V_13 * V_50 , long V_162 )
{
struct V_34 * V_35 = F_34 ( V_50 ) ;
int V_163 ;
F_137 ( V_65 ) ;
F_138 ( & V_35 -> V_49 , & V_65 , V_164 ) ;
...
goto V_100;
V_146 = V_96 ;
if ( F_134 ( V_158 , & V_13 -> V_44 ) && ! V_35 -> V_2 &&
( V_96 = F_106 ( V_13 ) ) != 0 )
goto V_100;
V_162 = F_142 ( V_14 , V_44 & V_170 ) ;
V_96 = - V_130 ;
V_168 = F_92 ( F_36 ( V_14 ) , NULL , 0 ) ;
if ( V_168 == NULL )
goto V_100;
V_9 = F_143 ( V_168 , 1 , 0 , V_108 ) ;
if ( V_9 == NULL )
goto V_100;
V_159:
...
F_80 ( V_168 ) ;
V_166 = F_34 ( V_168 ) ;
F_147 ( V_168 -> V_64 , & V_166 -> V_174 ) ;
V_167 = F_34 ( V_50 ) ;
if ( V_167 -> V_2 ) {
F_148 ( & V_167 -> V_2 -> V_21 ) ;
V_166 -> V_2 = V_167 -> V_2 ;
}
if ( V_167 -> V_41 . V_40 ) {
F_149 ( & V_167 -> V_41 ) ;
...
static int F_152 ( struct V_94 * V_177 , struct V_94 * V_178 )
{
...
static void F_153 ( const struct V_94 * V_180 ,
struct V_94 * V_181 )
{
if ( F_134 ( V_158 , & V_180 -> V_44 ) )
F_154 ( V_158 , & V_181 -> V_44 ) ;
if ( F_134 ( V_182 , & V_180 -> V_44 ) )
F_154 ( V_182 , & V_181 -> V_44 ) ;
}
static int F_155 ( struct V_94 * V_13 , struct V_94 * V_183 , int V_44 ,
bool V_106 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
struct V_13 * V_184 ;
...
if ( V_14 -> V_58 != V_59 )
goto V_100;
V_9 = F_156 ( V_14 , 0 , V_44 & V_170 , & V_96 ) ;
if ( ! V_9 ) {
if ( V_96 == 0 )
V_96 = - V_26 ;
goto V_100;
...
static int F_160 ( struct V_94 * V_13 , struct V_144 * V_145 , int * V_185 , int V_19 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
struct V_34 * V_35 ;
...
F_163 ( V_7 -> V_187 -> V_189 , V_7 -> V_187 -> V_187 [ V_39 ] ) ;
}
...
static inline bool F_167 ( struct V_190 * V_191 )
{
struct V_192 * V_189 = F_168 () ;
if ( F_130 ( V_189 -> V_193 > F_169 ( V_191 , V_194 ) ) )
return ! F_170 ( V_195 ) && ! F_170 ( V_196 ) ;
return false ;
}
...
return - V_198 ;
for ( V_39 = V_7 -> V_187 -> V_188 - 1 ; V_39 >= 0 ; V_39 -- ) {
struct V_13 * V_14 = F_172 ( V_7 -> V_187 -> V_187 [ V_39 ] ) ;
if ( V_14 )
V_197 = F_173 ( V_197 ,
F_34 ( V_14 ) -> V_199 ) ;
}
if ( F_130 ( V_197 > V_200 ) )
return - V_198 ;
F_3 ( V_9 ) . V_187 = F_174 ( V_7 -> V_187 ) ;
if ( ! F_3 ( V_9 ) . V_187 )
return - V_130 ;
for ( V_39 = V_7 -> V_187 -> V_188 - 1 ; V_39 >= 0 ; V_39 -- )
...
{
return F_134 ( V_158 , & V_13 -> V_44 ) ||
! V_50 -> V_72 ||
F_134 ( V_158 , & V_50 -> V_72 -> V_44 ) ;
}
...
if ( V_96 )
goto V_223;
V_162 = F_142 ( V_14 , V_207 -> V_214 & V_221 ) ;
V_159:
if ( ! V_50 ) {
V_96 = - V_70 ;
if ( V_23 == NULL )
...
if ( V_44 & V_215 )
goto V_100;
V_162 = F_210 ( V_14 , V_44 & V_221 ) ;
do {
F_211 ( & V_35 -> V_103 ) ;
V_251 = F_212 ( V_14 , V_44 ) ;
V_9 = F_213 ( V_14 , V_44 , NULL , & V_250 , & V_251 ,
& V_96 , & V_249 ) ;
if ( V_9 )
break;
F_91 ( & V_35 -> V_103 ) ;
...
static long F_222 ( struct V_13 * V_14 , long V_162 ,
...
static int F_228 ( struct V_257 * V_77 ,
bool V_255 )
{
struct V_6 V_7 ;
...
V_261 = F_229 ( V_14 , V_44 & V_262 , V_228 ) ;
V_162 = F_210 ( V_14 , V_259 ) ;
memset ( & V_7 , 0 , sizeof( V_7 ) ) ;
F_211 ( & V_35 -> V_103 ) ;
if ( V_44 & V_253 )
V_251 = F_212 ( V_14 , V_44 ) ;
...
V_263 = F_186 (unsigned int, unix_skb_len(skb) - skip, size) ;
F_232 ( V_9 ) ;
...
{
int V_270 ;
V_270 = F_216 ( V_9 , F_3 ( V_9 ) . V_88 + V_251 ,
V_77 -> V_207 , V_263 ) ;
return V_270 ? : V_263 ;
}
...
static T_7 F_238 ( struct V_94 * V_13 , T_8 * V_273 ,
struct V_274 * V_271 ,
...
struct V_276 * V_284 ;
int V_285 ;
if ( ! F_245 ( F_36 ( V_14 ) -> V_286 , V_287 ) )
return - V_160 ;
F_14 ( V_14 ) ;
V_41 = F_34 ( V_14 ) -> V_41 ;
if ( ! V_41 . V_40 ) {
...
static int F_251 ( struct V_94 * V_13 , unsigned int V_291 , unsigned long V_292 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
long V_283 = 0 ;
int V_96 ;
...
case V_293 :
V_283 = F_242 ( V_14 ) ;
V_96 = F_252 ( V_283 , ( int V_294 * ) V_292 ) ;
break;
case V_295 :
V_283 = F_240 ( V_14 ) ;
if ( V_283 < 0 )
...
static unsigned int F_253 ( struct V_276 * V_276 , struct V_94 * V_13 , T_9 * V_65 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
unsigned int V_298 ;
F_254 ( V_276 , F_43 ( V_14 ) , V_65 ) ;
V_298 = 0 ;
if ( V_14 -> V_69 )
V_298 |= V_299 ;
if ( V_14 -> V_78 == V_79 )
...
static unsigned int F_255 ( struct V_276 * V_276 , struct V_94 * V_13 ,
T_9 * V_65 )
{
...
static struct V_13 * F_257 ( struct V_310 * V_311 , T_8 * V_312 )
{
unsigned long V_239 = F_258 ( * V_312 ) ;
unsigned long V_313 = F_259 ( * V_312 ) ;
struct V_13 * V_14 ;
unsigned long V_188 = 0 ;
for ( V_14 = F_260 ( & V_5 [ V_313 ] ) ; V_14 ; V_14 = F_261 ( V_14 ) ) {
if ( F_36 ( V_14 ) != F_262 ( V_311 ) )
continue;
if ( ++ V_188 == V_239 )
break;
}
...
static struct V_13 * F_263 ( struct V_310 * V_311 ,
struct V_13 * V_14 ,
T_8 * V_312 )
{
unsigned long V_313 ;
...
do {
V_14 = F_257 ( V_311 , V_312 ) ;
if ( V_14 )
return V_14 ;
V_315:
V_313 = F_259 ( * V_312 ) + 1 ;
* V_312 = F_264 ( V_313 , 1 ) ;
} while ( V_313 < F_265 ( V_5 ) );
return NULL ;
}
static void * F_266 ( struct V_310 * V_311 , T_8 * V_312 )
__acquires( V_31 )
{
F_29 ( & V_31 ) ;
if ( ! * V_312 )
return V_314 ;
if ( F_259 ( * V_312 ) >= F_265 ( V_5 ) )
return NULL ;
return F_263 ( V_311 , NULL , V_312 ) ;
}
static void * F_267 ( struct V_310 * V_311 , void * V_316 , T_8 * V_312 )
{
++ * V_312 ;
return F_263 ( V_311 , V_316 , V_312 ) ;
}
static void F_268 ( struct V_310 * V_311 , void * V_316 )
__releases( V_31 )
{
F_30 ( & V_31 ) ;
}
static int F_269 ( struct V_310 * V_311 , void * V_316 )
{
if ( V_316 == V_314 )
F_270 ( V_311 , L_4
L_5 ) ;
...
for ( ; V_39 < V_24 ; V_39 ++ )
F_273 ( V_311 , V_35 -> V_2 -> V_36 -> V_29 [ V_39 ] ? :
'@' ) ;
}
F_16 ( V_18 ) ;
F_273 ( V_311 , '\n' ) ;
...
static int F_275 ( struct V_38 * V_38 , struct V_276 * V_276 )
{
return F_276 ( V_38 , V_276 , & V_321 ,
sizeof( struct V_322 ) ) ;
}
...
goto V_100;
#ifdef F_279
if ( ! F_280 ( L_7 , 0 , V_32 -> V_323 , & V_324 ) ) {
F_281 ( V_32 ) ;
goto V_100;
}
#endif
...
{
F_281 ( V_32 ) ;
F_283 ( L_7 , V_32 -> V_323 ) ;
}
static int T_12 F_284 ( void )
{
int V_52 = - 1 ;
F_188 ( sizeof( struct V_209 ) > F_285 ( struct V_8 , V_325 ) ) ;
V_52 = F_286 ( & V_109 , 1 ) ;
if ( V_52 != 0 ) {
F_287 ( L_8 , V_326 ) ;
goto V_100;
