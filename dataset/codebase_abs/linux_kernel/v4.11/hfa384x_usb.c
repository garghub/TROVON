...
memset ( F_141 ( V_28 , V_304 ) , 0xff , V_304 ) ;
F_157 ( V_28 ) ;
F_158 ( V_38 , V_28 ) ;
V_297 = F_159 ( V_28 ) ;
...
V_315 = F_141 ( V_28 , V_295 ) ;
memcpy ( V_315 , & V_312 -> V_243 , V_295 ) ;
if ( V_313 > 0 ) {
V_315 = F_141 ( V_28 , V_313 ) ;
memcpy ( V_315 , V_299 -> V_36 , V_313 ) ;
if ( * ( V_315 - V_295 + 1 ) & 0x40 )
if ( ( * ( V_315 ) == 0xaa ) && ( * ( V_315 + 1 ) == 0xaa ) )
* ( V_315 - V_295 + 1 ) &= 0xbf ;
}
if ( V_6 -> V_337 ) {
V_315 = F_141 ( V_28 , V_304 ) ;
...
union V_30 * V_262 )
{
V_262 -> V_338 . V_339 . V_340 =
F_49 ( V_262 -> V_338 . V_339 . V_340 ) ;
F_165 ( V_38 , & V_262 -> V_338 . V_339 ) ;
}
