...
static int F_21 ( struct V_68 * V_14 )
{
struct V_69 * V_70 ;
struct V_71 V_72 ;
struct V_73 * V_74 ;
...
V_74 = F_25 ( V_14 , V_78 , 1 ) ;
V_2 -> V_7 = F_26 ( & V_14 -> V_13 , V_74 ) ;
if ( F_6 ( V_2 -> V_7 ) ) {
V_11 = F_7 ( V_2 -> V_7 ) ;
goto V_77;
}
V_2 -> V_14 = V_14 ;
V_2 -> V_55 = F_27 ( V_14 -> V_13 . V_79 ) ;
if ( V_2 -> V_55 < 0 ) {
F_8 ( & V_14 -> V_13 , L_9 ) ;
V_11 = - V_66 ;
goto V_77;
}
if ( F_28 ( V_14 -> V_13 . V_79 , L_10 ,
& V_2 -> V_58 ) )
V_2 -> V_58 = 2 ;
V_11 = F_4 ( V_2 ) ;
if ( V_11 )
...
static int F_31 ( struct V_68 * V_14 )
{
struct V_1 * V_2 = F_32 ( & V_14 -> V_13 ) ;
F_20 ( V_2 -> V_52 ) ;
return F_33 ( V_14 ) ;
}
