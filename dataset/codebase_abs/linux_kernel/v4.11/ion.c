...
static int F_114 ( struct V_114 * V_115 )
{
struct V_1 * V_2 = V_115 -> V_111 -> V_116 ;
unsigned long V_117 ;
int V_27 ;
F_28 ( & V_2 -> V_45 ) ;
...
V_27 = F_116 ( V_115 -> V_111 , V_115 -> V_119 , V_117 ) ;
F_29 ( & V_2 -> V_45 ) ;
if ( V_27 )
return V_120 ;
return V_121 ;
...
static int F_152 ( void * V_165 , T_4 V_166 )
{
...
V_168 . V_172 = V_166 ;
if ( ! V_166 ) {
V_169 = V_19 -> V_173 . V_174 ( & V_19 -> V_173 , & V_168 ) ;
V_168 . V_172 = V_169 ;
}
V_19 -> V_173 . V_175 ( & V_19 -> V_173 , & V_168 ) ;
return 0 ;
}
static int F_153 ( void * V_165 , T_4 * V_166 )
{
struct V_18 * V_19 = V_165 ;
struct V_167 V_168 ;
int V_169 ;
...
if ( V_19 -> V_3 & V_33 )
F_156 ( V_19 ) ;
if ( ( V_19 -> V_3 & V_33 ) || V_19 -> V_31 -> V_179 )
F_157 ( V_19 ) ;
V_19 -> V_8 = V_8 ;
F_95 ( & V_8 -> V_45 ) ;
F_158 ( & V_19 -> V_14 , - V_19 -> V_62 ) ;
F_159 ( & V_19 -> V_14 , & V_8 -> V_147 ) ;
V_177 = F_98 ( V_19 -> V_80 , 0664 ,
V_8 -> V_180 , V_19 ,
& V_181 ) ;
if ( ! V_177 ) {
char V_97 [ 256 ] , * V_98 ;
V_98 = F_99 ( V_8 -> V_180 , V_97 , 256 ) ;
F_9 ( L_43 ,
V_98 , V_19 -> V_80 ) ;
}
if ( V_19 -> V_173 . V_174 && V_19 -> V_173 . V_175 ) {
char V_159 [ 64 ] ;
snprintf ( V_159 , 64 , L_44 , V_19 -> V_80 ) ;
V_177 = F_98 (
V_159 , 0644 , V_8 -> V_180 , V_19 ,
& V_182 ) ;
if ( ! V_177 ) {
char V_97 [ 256 ] , * V_98 ;
V_98 = F_99 ( V_8 -> V_180 , V_97 , 256 ) ;
...
struct V_7 * V_185 ;
int V_27 ;
V_185 = F_14 ( sizeof( * V_185 ) , V_28 ) ;
if ( ! V_185 )
return F_15 ( - V_29 ) ;
V_185 -> V_8 . V_186 = V_187 ;
V_185 -> V_8 . V_80 = L_46 ;
V_185 -> V_8 . V_188 = & V_189 ;
V_185 -> V_8 . V_12 = NULL ;
V_27 = F_162 ( & V_185 -> V_8 ) ;
if ( V_27 ) {
F_9 ( L_47 ) ;
F_30 ( V_185 ) ;
return F_15 ( V_27 ) ;
}
V_185 -> V_94 = F_163 ( L_46 , NULL ) ;
if ( ! V_185 -> V_94 ) {
F_9 ( L_48 ) ;
goto V_190;
}
V_185 -> V_180 = F_163 ( L_49 , V_185 -> V_94 ) ;
if ( ! V_185 -> V_180 ) {
F_9 ( L_50 ) ;
goto V_190;
}
V_185 -> V_95 = F_163 ( L_51 ,
V_185 -> V_94 ) ;
if ( ! V_185 -> V_95 )
F_9 ( L_52 ) ;
V_190:
