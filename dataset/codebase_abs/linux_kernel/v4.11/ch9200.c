...
int V_50 = 0 ;
V_50 = 64 ;
if ( F_25 ( V_44 -> V_47 < V_50 ) ) {
F_26 ( & V_2 -> V_21 -> V_2 , L_6 ) ;
return 0 ;
}
...
static int F_28 ( struct V_1 * V_2 , unsigned char * V_6 )
{
int V_11 = 0 ;
unsigned char V_51 [ 0x06 ] ;
int V_52 = 0 ;
F_2 ( V_2 -> V_17 , L_7 ,
V_2 -> V_21 -> V_53 . V_54 ,
V_2 -> V_21 -> V_53 . V_55 ) ;
...
V_56 , V_51 , 0x02 ,
V_31 ) ;
V_52 += F_1 ( V_2 , V_12 , 0 , V_57 ,
V_51 + 2 , 0x02 , V_31 ) ;
V_52 += F_1 ( V_2 , V_12 , 0 , V_58 ,
V_51 + 4 , 0x02 , V_31 ) ;
if ( V_52 != V_59 )
V_11 = - V_22 ;
V_6 [ 0 ] = V_51 [ 5 ] ;
...
static int F_29 ( struct V_1 * V_2 , struct V_60 * V_61 )
{
int V_62 = 0 ;
unsigned char V_6 [ 2 ] ;
V_62 = F_30 ( V_2 , V_61 ) ;
...
V_2 -> V_35 . V_65 = 0x1f ;
V_2 -> V_35 . V_66 = 0x1f ;
V_2 -> V_67 = V_2 -> V_17 -> V_68 + V_2 -> V_17 -> V_69 ;
V_2 -> V_70 = 24 * 64 + 16 ;
F_31 ( & V_2 -> V_35 ) ;
V_6 [ 0 ] = 0x01 ;
V_6 [ 1 ] = 0x0F ;
V_62 = F_7 ( V_2 , V_23 , 0 , V_71 , V_6 ,
0x02 , V_31 ) ;
V_6 [ 0 ] = 0xA0 ;
V_6 [ 1 ] = 0x90 ;
V_62 = F_7 ( V_2 , V_23 , 0 , V_72 , V_6 ,
0x02 , V_31 ) ;
V_6 [ 0 ] = 0x30 ;
V_6 [ 1 ] = 0x00 ;
V_62 = F_7 ( V_2 , V_23 , 0 , V_73 , V_6 ,
0x02 , V_31 ) ;
V_6 [ 0 ] = 0x17 ;
V_6 [ 1 ] = 0xD8 ;
V_62 = F_7 ( V_2 , V_23 , 0 , V_74 ,
V_6 , 0x02 , V_31 ) ;
V_6 [ 0 ] = 0x01 ;
V_6 [ 1 ] = 0x00 ;
V_62 = F_7 ( V_2 , V_23 , 0 , 254 , V_6 , 0x02 ,
V_31 ) ;
V_6 [ 0 ] = 0x5F ;
V_6 [ 1 ] = 0x0D ;
V_62 = F_7 ( V_2 , V_23 , 0 , V_75 , V_6 , 0x02 ,
V_31 ) ;
V_62 = F_28 ( V_2 , V_2 -> V_17 -> V_76 ) ;
return V_62 ;
}
