...
V_114 -> V_115 . error = 0 ;
V_114 -> V_115 . V_91 = 0 ;
V_114 -> V_115 . V_27 = F_125 ( V_3 -> V_58 ) ;
...
struct V_113 * V_114 = F_11 ( V_18 , struct V_113 , V_18 ) ;
if ( V_114 -> V_115 . V_29 )
F_129 ( V_114 -> V_115 . V_25 , V_114 -> V_12 ) ;
if ( V_114 -> V_115 . V_3 )
F_130 ( V_114 -> V_115 . V_3 ) ;
F_126 ( V_18 ) ;
}
...
F_142 ( V_114 -> V_133 , ! V_114 -> V_124 , V_114 -> V_115 . V_57 ) ;
...
F_155 ( & V_114 -> V_115 . V_25 -> V_158 , & V_156 , & V_157 ) ;
F_156 ( & V_2 -> V_155 ) ;
if ( F_155 ( & V_2 -> V_159 , & V_156 , & V_157 ) ) {
...
if ( ( F_71 ( V_3 ) != V_95 ) ||
F_158 ( F_159 ( V_2 -> V_160 ) ) )
F_133 ( V_3 , V_18 ) ;
} else if ( V_114 -> V_115 . V_55 ) {
F_160 ( V_2 ) ;
V_114 -> V_115 . V_3 = V_3 ;
if ( V_3 -> V_58 & V_59 ) {
struct V_3 * V_161 = F_147 ( V_68 , 0 ,
V_2 -> V_85 . V_64 ) ;
...
V_114 -> V_115 . V_3 = F_161 ( V_3 , V_68 , V_2 -> V_85 . V_64 ) ;
F_133 ( V_3 , V_18 ) ;
}
F_139 ( & V_114 -> V_115 . V_18 , F_55 , NULL , V_18 ) ;
...
static T_4 F_164 ( struct V_162 * V_163 ,
struct V_3 * V_3 )
{
struct V_113 * V_114 ;
...
int V_166 = F_111 ( V_3 ) ;
F_165 ( V_166 , F_24 ( V_3 ) , & V_12 -> V_85 -> V_134 ) ;
V_3 -> V_139 = V_2 -> V_160 ;
...
static int F_169 ( struct V_136 * V_12 , T_5 V_86 ,
unsigned int V_169 , unsigned long V_170 )
{
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_85 ) ;
return F_170 ( V_2 -> V_160 , V_86 , V_169 , V_170 ) ;
}
static int F_171 ( void * V_171 , int V_172 )
{
struct V_136 * V_12 = V_171 ;
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_85 ) ;
struct V_162 * V_163 = F_159 ( V_2 -> V_160 ) ;
int V_24 = 0 ;
if ( F_172 ( V_163 -> V_173 , V_172 ) )
return 1 ;
if ( F_166 ( V_2 ) ) {
unsigned V_61 ;
struct V_174 * V_175 ;
F_173 (ca, d->c, i) {
V_163 = F_159 ( V_175 -> V_160 ) ;
V_24 |= F_172 ( V_163 -> V_173 , V_172 ) ;
}
F_127 ( V_2 ) ;
}
return V_24 ;
...
V_177 -> V_178 -> V_179 = F_164 ;
V_177 -> V_178 -> V_173 -> V_180 = F_171 ;
V_2 -> V_85 . V_124 = F_144 ;
V_2 -> V_85 . V_181 = F_169 ;
}
static int F_175 ( struct V_120 * V_112 , struct V_113 * V_114 ,
struct V_3 * V_3 , unsigned V_43 )
{
unsigned V_182 = F_25 ( V_43 , F_24 ( V_3 ) ) << 9 ;
F_176 ( V_3 -> V_41 . V_46 , V_182 ) ;
F_177 ( V_3 ) ;
F_176 ( V_3 -> V_41 . V_46 , V_182 ) ;
F_178 ( V_3 , V_182 ) ;
if ( ! V_3 -> V_41 . V_46 )
...
static T_4 F_180 ( struct V_162 * V_163 ,
struct V_3 * V_3 )
{
struct V_113 * V_114 ;
struct V_17 * V_18 ;
...
static int F_181 ( struct V_136 * V_12 , T_5 V_86 ,
unsigned int V_169 , unsigned long V_170 )
{
return - V_183 ;
}
static int F_182 ( void * V_171 , int V_172 )
{
struct V_136 * V_12 = V_171 ;
struct V_162 * V_163 ;
struct V_174 * V_175 ;
...
void F_183 ( struct V_136 * V_12 )
{
struct V_176 * V_177 = V_12 -> V_85 ;
V_177 -> V_178 -> V_179 = F_180 ;
V_177 -> V_178 -> V_173 -> V_180 = F_182 ;
V_12 -> V_124 = F_175 ;
V_12 -> V_181 = F_181 ;
}
void F_184 ( void )
