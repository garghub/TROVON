...
V_2 -> V_10 = V_13 ;
} else if ( V_173 == V_12 && V_55 -> V_78 & V_204 ) {
V_2 -> V_10 = V_12 ;
}
switch ( V_2 -> V_10 ) {
case V_13 :
...
V_21 -> V_58 , V_21 -> V_58 / 1024 , V_21 -> V_207 ) ;
if ( V_21 -> V_207 )
for ( V_26 = 0 ; V_26 < V_21 -> V_207 ; V_26 ++ )
F_28 ( V_9 ,
L_31
L_32
L_33 ,
V_26 , ( long long ) V_21 -> V_208 [ V_26 ] . V_94 ,
V_21 -> V_208 [ V_26 ] . V_58 ,
V_21 -> V_208 [ V_26 ] . V_58 / 1024 ,
V_21 -> V_208 [ V_26 ] . V_209 ) ;
return 0 ;
}
