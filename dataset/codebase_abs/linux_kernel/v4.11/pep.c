...
T_1 V_27 , V_139 , V_65 ;
T_1 V_140 = 0 ;
V_2 = F_70 ( V_13 , 0 , V_132 & V_141 , V_133 ) ;
if ( ! V_2 )
return NULL ;
F_65 ( V_13 ) ;
if ( V_13 -> V_50 != V_121 ) {
...
V_136 = F_52 ( & V_31 -> V_113 , & V_45 , V_27 ) ;
if ( F_72 ( V_136 ) ) {
F_73 ( V_136 ) ;
V_136 = NULL ;
...
F_57 ( V_2 , & V_45 ) ;
F_15 ( V_2 , & V_137 ) ;
V_135 -> V_117 . V_118 = F_53 ( & V_45 ) ;
V_135 -> V_117 . V_153 = F_53 ( & V_137 ) ;
V_135 -> V_117 . V_154 = F_77 ( & V_45 ) ;
F_55 ( V_13 ) ;
V_135 -> V_155 = V_13 ;
F_78 ( & V_135 -> V_84 ) ;
V_135 -> V_27 = V_27 ;
...
if ( F_36 ( V_13 , V_164 ) &&
! F_83 ( & V_31 -> V_84 ) )
V_160 = F_84 ( & V_31 -> V_84 ) -> V_15 ;
else if ( ! F_83 ( & V_13 -> V_91 ) )
V_160 = F_84 ( & V_13 -> V_91 ) -> V_15 ;
else
V_160 = 0 ;
F_66 ( V_13 ) ;
...
static int F_97 ( struct V_12 * V_13 , struct V_186 * V_187 , T_4 V_15 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
struct V_1 * V_2 ;
long V_188 ;
int V_132 = V_187 -> V_189 ;
int V_68 , V_190 ;
if ( V_15 > V_191 )
return - V_192 ;
if ( ( V_187 -> V_189 & ~ ( V_193 | V_194 | V_195 |
V_196 ) ) ||
! ( V_187 -> V_189 & V_194 ) )
return - V_61 ;
...
if ( ! V_2 )
return V_68 ;
F_8 ( V_2 , V_197 + 3 + V_31 -> V_140 ) ;
V_68 = F_99 ( F_100 ( V_2 , V_15 ) , V_187 , V_15 ) ;
if ( V_68 < 0 )
goto V_198;
F_65 ( V_13 ) ;
V_188 = F_101 ( V_13 , V_132 & V_193 ) ;
...
F_107 ( F_108 ( V_13 ) , & V_202 ) ;
V_190 = F_109 ( V_13 , & V_188 , F_103 ( & V_31 -> V_63 ) , & V_202 ) ;
F_110 ( F_108 ( V_13 ) , & V_202 ) ;
if ( V_13 -> V_50 != V_51 )
goto V_200;
}
V_68 = F_94 ( V_13 , V_2 ) ;
...
F_113 ( V_206 ) -> V_209 = V_2 ;
V_206 -> V_15 += V_2 -> V_15 ;
V_206 -> V_210 += V_206 -> V_15 ;
V_206 -> V_211 += V_206 -> V_15 ;
F_114 (skb, fs)
V_208 += V_207 -> V_15 ;
V_2 -> V_212 = F_113 ( V_2 ) -> V_209 ;
F_115 ( V_2 ) ;
V_2 -> V_15 -= V_208 ;
V_2 -> V_210 -= V_208 ;
V_2 -> V_211 -= V_208 ;
F_8 ( V_206 , V_197 + 3 ) ;
return F_94 ( V_13 , V_206 ) ;
}
...
static int F_118 ( struct V_12 * V_13 , struct V_186 * V_187 , T_4 V_15 ,
int V_213 , int V_132 , int * V_214 )
{
struct V_1 * V_2 ;
int V_68 ;
if ( V_132 & ~ ( V_215 | V_216 | V_217 | V_193 | V_218 |
V_195 | V_196 ) )
return - V_61 ;
if ( F_72 ( 1 << V_13 -> V_50 & ( V_123 | V_122 ) ) )
return - V_199 ;
if ( ( V_132 & V_215 ) || F_36 ( V_13 , V_164 ) ) {
struct V_30 * V_31 = F_18 ( V_13 ) ;
if ( V_132 & V_216 )
return - V_61 ;
V_2 = F_117 ( & V_31 -> V_84 ) ;
...
V_2 = F_70 ( V_13 , V_132 , V_213 , & V_68 ) ;
F_65 ( V_13 ) ;
if ( V_2 == NULL ) {
if ( V_68 == - V_199 && V_13 -> V_50 == V_69 )
V_68 = - V_201 ;
F_66 ( V_13 ) ;
return V_68 ;
}
...
V_15 = V_2 -> V_15 ;
V_68 = F_119 ( V_2 , 0 , V_187 , V_15 ) ;
if ( ! V_68 )
V_68 = ( V_132 & V_217 ) ? V_2 -> V_15 : V_15 ;
F_120 ( V_13 , V_2 ) ;
return V_68 ;
}
