...
V_292 = V_289 -> V_294 + V_289 -> V_295 + V_289 -> V_296 ;
F_115 ( V_292 , 6 ) ;
F_115 ( V_289 -> V_297 , 6 ) ;
F_115 ( V_289 -> V_298 , 6 ) ;
if ( V_8 -> V_281 )
...
V_149 -> V_298 = 0 ;
if ( V_306 ) {
V_149 -> V_298 = V_287 - V_306 ;
if ( V_149 -> V_307 ) {
if ( V_149 -> V_307 > V_306 )
F_52 ( L_99 ) ;
else
V_149 -> V_297 = V_306 - V_149 -> V_307 ;
}
if ( V_149 -> V_274 > V_306 )
F_52 ( L_100 ) ;
else if ( V_149 -> V_274 ) {
T_1 V_308 = V_306 - V_149 -> V_274 ;
if ( V_149 -> V_309 == V_310 )
V_149 -> V_296 = V_308 ;
else if ( V_149 -> V_309 == V_311 )
V_149 -> V_295 = V_308 ;
else
V_149 -> V_294 = V_308 ;
}
}
F_128 ( & V_149 -> V_312 , V_149 -> V_298 ) ;
V_149 -> V_313 += V_149 -> V_298 ;
V_149 -> V_314 += V_149 -> V_297 ;
V_149 -> V_315 += V_149 -> V_294 ;
V_149 -> V_316 += V_149 -> V_295 ;
V_149 -> V_317 += V_149 -> V_296 ;
}
...
struct V_124 * V_124 )
{
struct V_305 * V_318 = & V_305 ;
struct V_106 * V_106 ;
V_106 = F_54 ( V_124 , V_123 -> V_44 , V_123 -> V_44 ) ;
if ( V_106 == NULL ) {
F_52 ( L_101 , V_123 -> V_44 ) ;
return;
}
if ( ! V_319 . V_320 || V_123 -> V_321 == NULL )
return;
if ( F_132 ( V_106 , V_318 , V_121 , V_123 ,
NULL , NULL , V_8 -> V_322 + 2 ) != 0 ) {
if ( V_51 > 0 )
error ( L_102 ) ;
return;
}
...
V_325 = V_157 -> V_325 ;
if ( V_325 ) {
if ( ! strcmp ( V_325 -> V_202 , L_103 ) ||
! strcmp ( V_325 -> V_202 , L_104 ) ||
! strcmp ( V_325 -> V_202 , L_105 ) )
V_325 -> V_326 = 1 ;
}
F_135 ( V_318 ) ;
}
...
struct V_327 * V_328 ;
F_137 ( V_106 , V_329 , 0 ) ;
V_328 = F_10 ( sizeof( * V_328 ) ) ;
if ( V_328 == NULL )
return - V_330 ;
F_138 ( & V_328 -> V_289 . V_312 ) ;
F_139 ( & V_328 -> V_321 ) ;
F_140 ( & V_328 -> V_318 ) ;
F_96 ( V_106 , V_328 ) ;
return 0 ;
...
{
int V_15 , V_56 ;
V_331 = F_10 ( V_273 * sizeof( struct V_106 * ) ) ;
if ( ! V_331 )
return - V_330 ;
V_332 = V_273 ;
for ( V_15 = 0 ; V_15 < V_273 ; ++ V_15 ) {
V_331 [ V_15 ] = F_142 ( 0 , 0 ) ;
if ( V_331 [ V_15 ] == NULL )
return - V_330 ;
V_56 = F_136 ( V_331 [ V_15 ] ) ;
if ( V_56 < 0 )
return V_56 ;
}
return 0 ;
...
{
if ( ( V_135 >= V_332 ) || ( V_331 == NULL ) ) {
int V_15 , V_54 = F_118 ( V_135 + 1 ) ;
void * V_276 ;
V_276 = realloc ( V_331 , V_54 * sizeof( struct V_106 * ) ) ;
if ( ! V_276 )
return NULL ;
V_331 = (struct V_106 * * ) V_276 ;
for ( V_15 = V_332 ; V_15 < V_54 ; ++ V_15 )
V_331 [ V_15 ] = NULL ;
V_332 = V_54 ;
}
if ( V_331 [ V_135 ] == NULL ) {
V_331 [ V_135 ] = F_142 ( 0 , 0 ) ;
if ( V_331 [ V_135 ] ) {
if ( F_136 ( V_331 [ V_135 ] ) < 0 )
return NULL ;
}
}
return V_331 [ V_135 ] ;
}
static void F_146 ( struct V_327 * V_328 ,
struct V_122 * V_123 )
{
if ( ! V_319 . V_320 || V_123 -> V_321 == NULL )
return;
F_147 ( & V_328 -> V_318 , & V_305 ) ;
}
...
printf ( L_96 , V_278 , F_120 ( V_106 ) ) ;
printf ( L_109 , L_85 , L_85 , L_85 ) ;
printf ( L_110 , F_120 ( V_337 ) ) ;
printf ( L_15 ) ;
}
...
return - 1 ;
if ( V_289 -> V_307 == 0 )
V_289 -> V_307 = V_123 -> time ;
if ( V_8 -> V_299 &&
! F_155 ( & V_8 -> V_338 , V_123 -> time ) )
...
return;
V_290 = V_8 -> V_226 + 1 ;
V_340 = F_50 ( V_121 , V_123 , L_111 ) ;
V_341 = F_50 ( V_121 , V_123 , L_112 ) ;
V_106 = F_54 ( V_124 , V_123 -> V_44 , V_123 -> V_126 ) ;
if ( V_106 == NULL )
return;
if ( F_151 ( V_8 , V_106 , V_121 , V_123 ) &&
...
printf ( L_96 , V_278 , F_120 ( V_106 ) ) ;
printf ( L_109 , L_85 , L_85 , L_85 ) ;
printf ( L_113 , F_120 ( V_339 ) ) ;
printf ( L_114 , V_340 , V_341 ) ;
printf ( L_15 ) ;
}
...
{
struct V_7 * V_8 = F_61 ( V_211 , struct V_7 , V_211 ) ;
struct V_344 * V_338 = & V_8 -> V_338 ;
struct V_285 V_286 ;
struct V_106 * V_106 ;
struct V_288 * V_289 = NULL ;
T_1 V_306 , V_287 = V_123 -> time ;
int V_259 = 0 ;
...
V_306 = F_119 ( V_121 , V_123 -> V_135 ) ;
if ( V_338 -> V_345 && V_338 -> V_345 > V_287 )
goto V_240;
if ( V_306 && V_338 -> V_345 > V_306 )
V_306 = V_338 -> V_345 ;
if ( V_338 -> V_346 ) {
if ( V_306 > V_338 -> V_346 )
goto V_240;
if ( V_287 > V_338 -> V_346 )
V_287 = V_338 -> V_346 ;
}
if ( ! V_8 -> V_333 || V_106 -> V_126 == 0 ) {
F_127 ( V_289 , V_287 , V_306 ) ;
if ( V_8 -> V_333 ) {
struct V_327 * V_328 = ( void * ) V_289 ;
struct V_288 * V_347 ;
F_11 ( V_106 -> V_126 != 0 ) ;
if ( V_328 -> V_335 == NULL )
goto V_240;
V_347 = F_149 ( V_328 -> V_335 ) ;
if ( V_347 == NULL )
goto V_240;
F_127 ( V_347 , V_287 , V_306 ) ;
V_347 -> V_298 = 0 ;
V_347 -> V_297 = 0 ;
V_347 -> V_294 = 0 ;
V_347 -> V_295 = 0 ;
V_347 -> V_296 = 0 ;
if ( V_328 -> V_318 . V_26 )
F_160 ( & V_328 -> V_321 , & V_328 -> V_318 , V_287 - V_306 ) ;
V_328 -> V_335 = NULL ;
}
}
if ( ! V_8 -> V_342 )
F_125 ( V_8 , V_123 , & V_286 , V_106 , V_287 , V_173 ) ;
V_240:
if ( V_8 -> V_348 . V_345 == 0 && V_287 >= V_338 -> V_345 )
V_8 -> V_348 . V_345 = V_287 ;
if ( V_338 -> V_346 == 0 || V_287 <= V_338 -> V_346 )
V_8 -> V_348 . V_346 = V_287 ;
if ( V_289 ) {
...
F_79 ( V_123 -> time , V_291 , sizeof( V_291 ) ) ;
printf ( L_116 , V_291 ) ;
printf ( L_117 V_16 L_118 , V_22 -> V_349 . V_349 , V_123 -> V_135 ) ;
return 0 ;
}
static void F_163 ( struct V_106 * V_287 ,
struct V_288 * V_149 )
{
double V_350 = F_164 ( & V_149 -> V_312 ) ;
float V_351 ;
printf ( L_119 V_16 L_48 ,
V_278 , F_120 ( V_287 ) , V_287 -> V_142 ,
( T_1 ) V_149 -> V_312 . V_275 ) ;
F_115 ( V_149 -> V_313 , 8 ) ;
V_351 = F_165 ( F_166 ( & V_149 -> V_312 ) , V_350 ) ;
F_115 ( V_149 -> V_312 . F_7 , 6 ) ;
printf ( L_48 ) ;
F_115 ( ( T_1 ) V_350 , 6 ) ;
printf ( L_48 ) ;
F_115 ( V_149 -> V_312 . F_43 , 6 ) ;
printf ( L_54 ) ;
printf ( L_120 , V_351 ) ;
printf ( L_121 V_16 , V_149 -> V_343 ) ;
printf ( L_15 ) ;
}
...
{
struct V_352 * V_264 = V_215 ;
struct V_288 * V_149 ;
if ( F_152 ( V_287 ) )
return 0 ;
V_149 = F_93 ( V_287 ) ;
if ( V_149 && V_149 -> V_312 . V_275 ) {
V_264 -> V_353 ++ ;
V_264 -> V_354 += V_149 -> V_312 . V_275 ;
V_264 -> V_313 += V_149 -> V_313 ;
if ( V_264 -> V_8 -> V_281 )
F_167 ( V_287 , V_149 ) ;
else
F_163 ( V_287 , V_149 ) ;
...
static T_2 F_171 ( T_9 * V_356 , struct V_357 * V_157 )
{
const char * V_358 = L_122 ;
struct V_359 * V_360 ;
T_2 V_56 = 0 ;
char V_361 [ 1024 ] ;
bool V_362 ;
if ( V_157 == NULL )
return 0 ;
V_56 = F_171 ( V_356 , V_157 -> V_140 ) ;
V_362 = ( V_56 == 0 ) ;
F_59 (chain, &node->val, list) {
if ( V_360 -> V_363 >= V_364 )
continue;
if ( V_360 -> V_365 . V_325 && V_360 -> V_365 . V_325 -> V_326 )
continue;
V_56 += fprintf ( V_356 , L_123 , V_362 ? L_85 : V_358 ,
F_172 ( V_360 , V_361 , sizeof( V_361 ) ,
false ) ) ;
V_362 = false ;
}
return V_56 ;
...
printf ( L_124 , L_125 , L_126 , L_127 ) ;
printf ( L_128 , V_282 , V_282 ,
V_282 ) ;
while ( V_156 ) {
V_360 = F_90 ( V_156 , struct V_357 , V_156 ) ;
V_156 = F_174 ( V_156 ) ;
V_56 += fprintf ( V_356 , L_54 ) ;
F_115 ( V_360 -> V_366 , 12 ) ;
V_56 += 16 ;
V_56 += fprintf ( V_356 , L_129 , V_360 -> V_367 ) ;
V_56 += F_171 ( V_356 , V_360 ) ;
V_56 += fprintf ( V_356 , L_15 ) ;
}
return V_56 ;
}
...
struct V_251 * V_252 )
{
struct V_124 * V_368 = & V_252 -> V_369 . V_370 ;
struct V_352 V_371 ;
T_1 V_353 ;
struct V_106 * V_287 ;
struct V_288 * V_149 ;
int V_15 ;
T_1 V_348 = V_8 -> V_348 . V_346 - V_8 -> V_348 . V_345 ;
memset ( & V_371 , 0 , sizeof( V_371 ) ) ;
V_371 . V_8 = V_8 ;
if ( V_8 -> V_333 ) {
printf ( L_130 ) ;
printf ( L_131 , V_278 , L_19 ) ;
printf ( L_132 ) ;
} else if ( V_8 -> V_281 ) {
printf ( L_133 ) ;
printf ( L_134 , V_278 , L_19 ) ;
printf ( L_135 ) ;
} else {
printf ( L_136 ) ;
printf ( L_134 , V_278 , L_19 ) ;
...
printf ( L_138 , V_278 , L_85 ) ;
printf ( L_139 ,
V_8 -> V_281 ? L_88 : L_140 ) ;
printf ( L_141 , V_282 ) ;
F_176 ( V_368 , F_169 , & V_371 ) ;
V_353 = V_371 . V_353 ;
if ( ! V_353 )
printf ( L_142 ) ;
printf ( L_143 ) ;
F_176 ( V_368 , F_170 , & V_371 ) ;
if ( V_353 == V_371 . V_353 )
printf ( L_144 ) ;
if ( V_8 -> V_336 && ! V_8 -> V_333 )
return;
printf ( L_145 ) ;
for ( V_15 = 0 ; V_15 < V_332 ; ++ V_15 ) {
V_287 = V_331 [ V_15 ] ;
...
V_149 = F_93 ( V_287 ) ;
if ( V_149 && V_149 -> V_312 . V_275 ) {
V_371 . V_354 += V_149 -> V_312 . V_275 ;
printf ( L_146 , V_15 ) ;
F_115 ( V_149 -> V_313 , 6 ) ;
printf ( L_147 , 100.0 * V_149 -> V_313 / V_348 ) ;
} else
printf ( L_148 , V_15 ) ;
}
if ( V_8 -> V_333 && V_319 . V_320 ) {
V_372 . V_257 = V_373 ;
V_372 . V_374 = V_375 ;
F_177 ( & V_372 ) ;
printf ( L_149 ) ;
...
if ( V_328 == NULL )
continue;
V_372 . V_151 ( & V_328 -> V_376 , & V_328 -> V_321 ,
0 , & V_372 ) ;
printf ( L_150 , V_15 ) ;
F_115 ( V_328 -> V_289 . V_313 , 6 ) ;
printf ( L_151 ) ;
F_173 ( & V_328 -> V_376 ) ;
printf ( L_15 ) ;
}
...
L_152 V_16 L_15
L_153 V_16 L_15 ,
V_371 . V_353 , V_371 . V_354 ) ;
printf ( L_154 ) ;
F_115 ( V_371 . V_313 , 2 ) ;
printf ( L_15 ) ;
printf ( L_155 ) ;
F_115 ( V_348 , 2 ) ;
printf ( L_156 , V_8 -> V_226 ) ;
}
...
V_8 -> V_211 . V_382 = V_383 ;
V_8 -> V_211 . V_45 = V_384 ;
V_8 -> V_211 . exit = V_385 ;
V_8 -> V_211 . V_141 = F_105 ;
V_8 -> V_211 . V_349 = F_162 ;
V_8 -> V_211 . V_69 = V_386 ;
V_8 -> V_211 . V_387 = V_388 ;
V_8 -> V_211 . V_389 = V_390 ;
V_8 -> V_211 . V_391 = true ;
V_8 -> V_211 . V_392 = true ;
V_319 . V_320 = V_8 -> V_300 ;
V_252 = F_109 ( & V_254 , false , & V_8 -> V_211 ) ;
if ( V_252 == NULL )
return - V_330 ;
V_263 = V_252 -> V_263 ;
F_110 ( & V_252 -> V_260 . V_261 ) ;
if ( F_182 ( & V_8 -> V_338 , V_8 -> V_393 ) != 0 ) {
F_31 ( L_159 ) ;
return - V_394 ;
}
...
F_111 ( V_252 , V_381 ) )
goto V_240;
V_8 -> V_226 = V_252 -> V_260 . V_261 . V_396 ;
if ( V_8 -> V_226 == 0 )
V_8 -> V_226 = 4 ;
if ( F_141 ( V_8 -> V_226 ) )
goto V_240;
...
struct V_156 * * V_162 = & ( V_154 -> V_156 ) , * V_140 = NULL ;
struct V_147 * V_163 ;
const char * V_45 = F_55 ( V_161 -> V_106 ) , * V_398 ;
while ( * V_162 ) {
int V_152 ;
V_163 = F_61 ( * V_162 , struct V_147 , V_157 ) ;
V_140 = * V_162 ;
V_398 = F_55 ( V_163 -> V_106 ) ;
V_152 = strcmp ( V_45 , V_398 ) ;
if ( V_152 > 0 ) {
V_162 = & ( ( * V_162 ) -> V_159 ) ;
} else if ( V_152 < 0 ) {
V_162 = & ( ( * V_162 ) -> V_160 ) ;
...
if ( ! V_8 -> V_218 . V_402 )
return 0 ;
V_218 = F_193 ( V_8 -> V_218 . V_402 ) ;
if ( ! V_218 ) {
F_31 ( L_171 , V_8 -> V_218 . V_402 ) ;
return - 1 ;
}
...
if ( ! V_8 -> V_218 . V_404 )
return 0 ;
V_218 = F_195 ( V_8 -> V_218 . V_404 ) ;
if ( ! V_218 ) {
F_31 ( L_172 , V_8 -> V_218 . V_404 ) ;
return - 1 ;
}
...
if ( ! V_8 -> V_218 . V_405 )
return 0 ;
V_218 = F_193 ( V_8 -> V_218 . V_405 ) ;
if ( ! V_218 ) {
F_31 ( L_172 , V_8 -> V_218 . V_405 ) ;
return - 1 ;
}
...
if ( F_108 ( V_8 ) )
return - 1 ;
printf ( L_173 , V_8 -> V_32 ) ;
printf ( L_174 , V_8 -> V_43 ) ;
printf ( L_175 , V_8 -> V_41 ) ;
if ( V_8 -> V_37 )
printf ( L_176 , V_8 -> V_37 ) ;
if ( V_8 -> V_39 )
printf ( L_177 , V_8 -> V_39 ) ;
if ( V_8 -> V_31 )
printf ( L_178 ,
V_8 -> V_31 ) ;
F_19 ( V_8 ) ;
...
static void F_199 ( struct V_7 * V_8 , const struct V_406 * V_407 ,
const char * const V_408 [] )
{
char * V_409 , * V_200 , * V_168 = F_200 ( V_8 -> V_410 ) ;
for ( V_200 = strtok_r ( V_168 , L_180 , & V_409 ) ;
V_200 ; V_200 = strtok_r ( NULL , L_180 , & V_409 ) ) {
...
static int F_202 ( int V_411 , const char * * V_412 )
{
unsigned int V_413 , V_15 , V_54 ;
const char * * V_414 ;
...
V_413 = F_86 ( V_415 ) + V_411 - 1 ;
V_414 = calloc ( V_413 + 1 , sizeof( char * ) ) ;
if ( V_414 == NULL )
return - V_330 ;
for ( V_15 = 0 ; V_15 < F_86 ( V_415 ) ; V_15 ++ )
V_414 [ V_15 ] = F_200 ( V_415 [ V_15 ] ) ;
for ( V_54 = 1 ; V_54 < ( unsigned int ) V_411 ; V_54 ++ , V_15 ++ )
V_414 [ V_15 ] = V_412 [ V_54 ] ;
F_11 ( V_15 != V_413 ) ;
return F_203 ( V_15 , V_414 , NULL ) ;
}
int F_204 ( int V_411 , const char * * V_412 , const char * T_11 V_42 )
{
const char V_416 [] = L_194 ;
struct V_7 V_8 = {
. V_211 = {
. V_123 = F_107 ,
. V_45 = V_384 ,
...
const struct V_406 V_419 [] = {
F_206 ( 'i' , L_195 , & V_256 , L_196 ,
L_197 ) ,
F_207 ( 'v' , L_198 , & V_51 ,
L_199 ) ,
F_208 ( 'D' , L_200 , & V_420 ,
L_201 ) ,
F_208 ( 'f' , L_202 , & V_8 . V_83 , L_203 ) ,
F_209 ()
} ;
const struct V_406 V_421 [] = {
F_206 ( 's' , L_204 , & V_8 . V_410 , L_205 ,
L_206 ) ,
F_210 ( 'C' , L_207 , & V_8 . V_188 ,
L_208 ) ,
F_208 ( 'p' , L_209 , & V_8 . V_399 ,
L_210 ) ,
F_211 (sched_options)
} ;
const struct V_406 V_422 [] = {
F_212 ( 'r' , L_211 , & V_8 . V_109 ,
L_212 ) ,
F_211 (sched_options)
} ;
const struct V_406 V_423 [] = {
F_208 ( 0 , L_213 , & V_8 . V_218 . V_227 ,
L_214 ) ,
F_206 ( 0 , L_215 , & V_8 . V_218 . V_404 , L_209 ,
L_216 ) ,
F_206 ( 0 , L_217 , & V_8 . V_218 . V_405 , L_218 ,
L_219 ) ,
F_206 ( 0 , L_218 , & V_8 . V_218 . V_402 , L_218 ,
L_220 ) ,
F_211 (sched_options)
} ;
const struct V_406 V_424 [] = {
F_206 ( 'k' , L_221 , & V_319 . V_425 ,
L_196 , L_222 ) ,
F_206 ( 0 , L_223 , & V_319 . V_426 ,
L_196 , L_224 ) ,
F_208 ( 'g' , L_225 , & V_8 . V_300 ,
L_226 ) ,
F_212 ( 0 , L_227 , & V_8 . V_322 ,
L_228 ) ,
F_206 ( 0 , L_229 , & V_319 . V_427 , L_230 ,
L_231 ) ,
F_208 ( 's' , L_232 , & V_8 . V_342 ,
L_233 ) ,
F_208 ( 'S' , L_234 , & V_8 . V_397 ,
L_235 ) ,
F_208 ( 'w' , L_236 , & V_8 . V_299 , L_237 ) ,
F_208 ( 'M' , L_238 , & V_8 . V_395 , L_239 ) ,
F_208 ( 'V' , L_240 , & V_8 . V_280 , L_241 ) ,
F_208 ( 'I' , L_242 , & V_8 . V_333 , L_243 ) ,
F_206 ( 0 , L_74 , & V_8 . V_393 , L_244 ,
L_245 ) ,
F_208 ( 0 , L_83 , & V_8 . V_281 , L_246 ) ,
F_211 (sched_options)
} ;
const char * const V_428 [] = {
L_247 ,
NULL
} ;
const char * const V_429 [] = {
L_248 ,
NULL
} ;
const char * const V_430 [] = {
L_249 ,
NULL
} ;
const char * const V_431 [] = {
L_250 ,
NULL
} ;
const char * const V_432 [] = { L_182 , L_251 , L_252 ,
L_253 , L_254 ,
L_255 , NULL } ;
const char * V_433 [] = {
NULL ,
...
V_8 . V_241 [ V_15 ] = - 1 ;
V_411 = F_213 ( V_411 , V_412 , V_419 , V_432 ,
V_433 , V_438 ) ;
if ( ! V_411 )
F_214 ( V_433 , V_419 ) ;
if ( ! strcmp ( V_412 [ 0 ] , L_254 ) )
return F_215 ( V_411 , V_412 , T_11 ) ;
if ( ! strncmp ( V_412 [ 0 ] , L_256 , 3 ) ) {
return F_202 ( V_411 , V_412 ) ;
} else if ( ! strncmp ( V_412 [ 0 ] , L_257 , 3 ) ) {
V_8 . V_212 = & V_435 ;
if ( V_411 > 1 ) {
V_411 = F_216 ( V_411 , V_412 , V_421 , V_428 , 0 ) ;
if ( V_411 )
F_214 ( V_428 , V_421 ) ;
}
F_199 ( & V_8 , V_421 , V_428 ) ;
return F_189 ( & V_8 ) ;
} else if ( ! strcmp ( V_412 [ 0 ] , L_252 ) ) {
if ( V_411 ) {
V_411 = F_216 ( V_411 , V_412 , V_423 , V_430 , 0 ) ;
if ( V_411 )
F_214 ( V_430 , V_423 ) ;
}
V_8 . V_212 = & V_436 ;
F_199 ( & V_8 , V_421 , V_428 ) ;
return F_197 ( & V_8 ) ;
} else if ( ! strncmp ( V_412 [ 0 ] , L_258 , 3 ) ) {
V_8 . V_212 = & V_437 ;
if ( V_411 ) {
V_411 = F_216 ( V_411 , V_412 , V_422 , V_429 , 0 ) ;
if ( V_411 )
F_214 ( V_429 , V_422 ) ;
}
return F_198 ( & V_8 ) ;
} else if ( ! strcmp ( V_412 [ 0 ] , L_255 ) ) {
if ( V_411 ) {
V_411 = F_216 ( V_411 , V_412 , V_424 ,
V_431 , 0 ) ;
if ( V_411 )
F_214 ( V_431 , V_424 ) ;
}
if ( V_8 . V_299 && V_8 . V_342 ) {
F_31 ( L_259 ) ;
F_217 ( V_431 , V_424 , L_260 , true ) ;
F_217 ( NULL , V_424 , L_261 , true ) ;
return - V_394 ;
}
return F_181 ( & V_8 ) ;
} else {
