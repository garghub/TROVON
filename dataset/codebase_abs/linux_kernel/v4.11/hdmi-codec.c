...
int V_55 ;
F_17 ( V_54 -> V_58 , L_2 , V_59 ) ;
V_55 = F_30 ( V_126 -> V_130 , V_131 ,
NULL , V_128 -> V_132 . V_133 , 0 ,
& V_8 -> V_32 ) ;
if ( V_55 < 0 )
return V_55 ;
V_8 -> V_32 -> V_48 = V_8 ;
V_8 -> V_32 -> V_134 -> V_135 = F_10 ;
V_8 -> V_32 -> V_34 = V_36 ;
V_8 -> V_49 = V_50 ;
return 0 ;
}
...
{
struct V_143 * V_60 = V_142 -> V_58 . V_144 ;
struct V_145 * V_58 = & V_142 -> V_58 ;
struct V_7 * V_8 ;
struct V_146 * V_147 ;
struct V_148 * V_149 ;
int V_150 , V_18 = 0 ;
...
V_150 = V_60 -> V_151 + V_60 -> V_152 ;
if ( V_150 < 1 || ! V_60 -> V_61 || ! V_60 -> V_61 -> V_88 ||
! V_60 -> V_61 -> V_66 ) {
F_14 ( V_58 , L_8 , V_59 ) ;
return - V_44 ;
}
V_8 = F_33 ( V_58 , sizeof( * V_8 ) , V_153 ) ;
if ( ! V_8 )
return - V_154 ;
V_147 = NULL ;
F_13 ( & V_155 ) ;
F_34 (pos, &hdmi_device_list) {
struct V_146 * V_156 = F_35 ( V_149 ) ;
if ( V_156 -> V_58 == V_58 -> V_63 ) {
V_147 = V_156 ;
break;
}
}
if ( ! V_147 ) {
V_147 = F_33 ( V_58 , sizeof( * V_147 ) , V_153 ) ;
if ( ! V_147 ) {
F_15 ( & V_155 ) ;
return - V_154 ;
}
V_147 -> V_58 = V_58 -> V_63 ;
F_36 ( & V_147 -> V_157 , & V_158 ) ;
}
F_15 ( & V_155 ) ;
if ( V_147 -> V_159 >= F_6 ( V_139 ) ) {
F_14 ( V_58 , L_9 ) ;
return - V_44 ;
}
V_8 -> V_60 = * V_60 ;
F_37 ( & V_8 -> V_56 ) ;
V_8 -> V_160 = F_33 ( V_58 , V_150 * sizeof( * V_8 -> V_160 ) ,
V_153 ) ;
if ( ! V_8 -> V_160 )
return - V_154 ;
if ( V_60 -> V_151 ) {
V_8 -> V_160 [ V_18 ] = V_161 ;
V_8 -> V_160 [ V_18 ] . V_132 . V_133 =
V_60 -> V_162 ;
V_8 -> V_160 [ V_18 ] . V_163 = V_139 [ V_147 -> V_159 ++ ] ;
V_18 ++ ;
}
if ( V_60 -> V_152 ) {
V_8 -> V_160 [ V_18 ] = V_164 ;
V_8 -> V_160 [ V_18 ] . V_163 = V_139 [ V_147 -> V_159 ++ ] ;
}
V_55 = F_38 ( V_58 , & V_165 , V_8 -> V_160 ,
V_150 ) ;
if ( V_55 ) {
F_14 ( V_58 , L_10 ,
V_59 , V_55 ) ;
