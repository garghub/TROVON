...
static void F_37 ( struct V_96 * V_97 , int V_98 )
{
return;
}
...
static void F_39 ( struct V_96 * V_97 )
{
}
static void F_40 ( struct V_96 * V_97 )
{
struct V_99 * V_99 = F_41 ( V_97 ) ;
F_42 ( V_97 ) ;
F_28 ( V_99 ) ;
}
static struct V_96 * F_43 ( struct V_4 * V_5 )
{
struct V_96 * V_97 ;
struct V_99 * V_99 ;
V_99 = F_30 ( sizeof( struct V_99 ) , V_91 ) ;
if ( ! V_99 )
return NULL ;
V_97 = & V_99 -> V_92 ;
V_97 -> V_100 = 0x1 ;
...
static int F_46 ( struct V_90 * V_104 )
{
int V_105 ;
if ( V_106 <= 24 ) {
V_105 = F_47 ( V_104 , 1280 , 1024 ) ;
F_48 ( V_104 , 1024 , 768 ) ;
} else {
V_105 = F_47 ( V_104 , 800 , 600 ) ;
F_48 ( V_104 , 800 , 600 ) ;
}
return V_105 ;
}
static struct V_96 * F_49 ( struct V_90
* V_104 )
{
int V_107 = V_104 -> V_108 [ 0 ] ;
if ( V_107 )
return F_50 ( V_104 -> V_5 , V_107 ) ;
return NULL ;
}
...
static struct V_90 * F_53 ( struct V_4 * V_5 )
{
struct V_90 * V_104 ;
struct V_109 * V_109 ;
V_109 = F_30 ( sizeof( struct V_109 ) , V_91 ) ;
if ( ! V_109 )
return NULL ;
V_104 = & V_109 -> V_92 ;
F_54 ( V_5 , V_104 ,
...
F_58 ( V_7 -> V_5 ) ;
V_7 -> V_48 . V_113 = true ;
V_7 -> V_5 -> V_114 . V_115 = V_116 ;
V_7 -> V_5 -> V_114 . V_117 = V_118 ;
V_7 -> V_5 -> V_114 . V_119 = V_7 -> V_120 . V_121 ;
V_7 -> V_5 -> V_114 . V_122 = 24 ;
V_7 -> V_5 -> V_114 . V_123 = 0 ;
F_29 ( V_7 -> V_5 ) ;
V_97 = F_43 ( V_7 -> V_5 ) ;
if ( ! V_97 ) {
F_18 ( L_2 ) ;
