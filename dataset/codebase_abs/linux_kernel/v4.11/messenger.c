...
static bool F_118 ( struct V_157 * V_158 ,
T_1 V_166 )
{
bool V_187 ;
...
static struct V_226 * F_135 ( struct V_7 * V_8 ,
int * V_227 )
{
struct V_226 * V_228 ;
if ( ! V_8 -> V_77 -> V_229 ) {
...
static T_4 F_141 ( T_4 V_202 , struct V_99 * V_99 ,
unsigned int V_100 ,
unsigned int V_101 )
{
char * V_255 ;
...
if ( F_77 ( & V_90 -> V_151 ) )
return - V_258 ;
V_202 = V_256 ? F_126 ( V_90 -> V_194 . V_218 ) : 0 ;
while ( V_158 -> V_161 ) {
struct V_99 * V_99 ;
T_1 V_100 ;
T_1 V_101 ;
...
V_202 = F_141 ( V_202 , V_99 , V_100 , V_101 ) ;
V_183 = F_118 ( V_158 , ( T_1 ) V_69 ) ;
}
...
V_114 = strlen ( V_239 ) ;
V_267 = V_114 ;
V_69 = F_153 ( V_8 , V_267 , V_114 , V_8 -> V_271 ) ;
if ( V_69 <= 0 )
goto V_254;
V_114 = sizeof ( V_8 -> V_272 ) ;
V_267 += V_114 ;
V_69 = F_153 ( V_8 , V_267 , V_114 , & V_8 -> V_272 ) ;
if ( V_69 <= 0 )
goto V_254;
V_114 = sizeof ( V_8 -> V_273 ) ;
V_267 += V_114 ;
V_69 = F_153 ( V_8 , V_267 , V_114 , & V_8 -> V_273 ) ;
if ( V_69 <= 0 )
goto V_254;
V_254:
return V_69 ;
...
V_267 = V_114 ;
V_69 = F_153 ( V_8 , V_267 , V_114 , & V_8 -> V_274 ) ;
if ( V_69 <= 0 )
goto V_254;
V_114 = F_126 ( V_8 -> V_274 . V_233 ) ;
V_267 += V_114 ;
V_69 = F_153 ( V_8 , V_267 , V_114 , V_8 -> V_235 ) ;
if ( V_69 <= 0 )
goto V_254;
F_37 ( L_45 ,
V_8 , ( int ) V_8 -> V_274 . V_275 ,
F_126 ( V_8 -> V_274 . V_124 ) ,
F_126 ( V_8 -> V_274 . V_146 ) ) ;
V_254:
return V_69 ;
}
...
static void F_161 ( struct V_10 * V_11 , int V_281 )
{
switch ( V_11 -> V_21 ) {
case V_22 :
( (struct V_14 * ) V_11 ) -> V_25 = F_162 ( V_281 ) ;
break;
case V_26 :
( (struct V_16 * ) V_11 ) -> V_28 = F_162 ( V_281 ) ;
break;
}
}
static int F_163 ( const char * V_282 , T_1 V_86 , struct V_10 * V_11 ,
char V_283 , const char * * V_284 )
{
struct V_14 * V_15 = (struct V_14 * ) V_11 ;
struct V_16 * V_17 = (struct V_16 * ) V_11 ;
memset ( V_11 , 0 , sizeof( * V_11 ) ) ;
if ( F_164 ( V_282 , V_86 , ( V_285 * ) & V_15 -> V_24 . V_279 , V_283 , V_284 ) ) {
V_11 -> V_21 = V_22 ;
return 0 ;
}
if ( F_165 ( V_282 , V_86 , ( V_285 * ) & V_17 -> V_27 . V_286 , V_283 , V_284 ) ) {
V_11 -> V_21 = V_26 ;
return 0 ;
}
return - V_258 ;
}
static int F_166 ( const char * V_287 , T_1 V_288 ,
...
if ( V_267 <= V_287 )
return - V_258 ;
V_292 = F_167 ( NULL , V_287 , V_267 - V_287 , NULL , & V_291 , NULL ) ;
if ( V_292 > 0 )
V_69 = F_163 ( V_291 , V_292 , V_11 , - 1 , NULL ) ;
else
V_69 = - V_293 ;
F_168 ( V_291 ) ;
* V_284 = V_267 ;
F_169 ( L_48 , ( int ) ( V_267 - V_287 ) , V_287 ,
V_69 , V_69 ? L_49 : F_13 ( V_11 ) ) ;
return V_69 ;
}
static inline int F_166 ( const char * V_287 , T_1 V_288 ,
struct V_10 * V_11 , char V_283 , const char * * V_284 )
{
return - V_258 ;
}
static int F_170 ( const char * V_287 , T_1 V_288 ,
struct V_10 * V_11 , char V_283 , const char * * V_284 )
{
int V_69 ;
V_69 = F_163 ( V_287 , V_288 , V_11 , V_283 , V_284 ) ;
if ( V_69 )
V_69 = F_166 ( V_287 , V_288 , V_11 , V_283 , V_284 ) ;
return V_69 ;
}
int F_171 ( const char * V_294 , const char * V_267 ,
struct V_135 * V_33 ,
int V_295 , int * V_296 )
{
int V_12 , V_69 = - V_258 ;
...
V_69 = F_170 ( V_281 , V_267 - V_281 , V_11 , V_283 , & V_284 ) ;
if ( V_69 )
goto V_298;
V_69 = - V_258 ;
V_281 = V_284 ;
...
sizeof( V_8 -> V_66 ) ) != 0 &&
! ( F_157 ( & V_8 -> V_272 . V_67 ) &&
V_8 -> V_272 . V_300 == V_8 -> V_66 . V_300 ) ) {
F_174 ( L_55 ,
F_13 ( & V_8 -> V_66 . V_67 ) ,
( int ) F_126 ( V_8 -> V_66 . V_300 ) ,
F_13 ( & V_8 -> V_272 . V_67 ) ,
( int ) F_126 ( V_8 -> V_272 . V_300 ) ) ;
V_8 -> V_276 = L_56 ;
return - 1 ;
}
if ( F_157 ( & V_8 -> V_30 -> V_32 . V_33 . V_67 ) ) {
int V_297 = F_160 ( & V_8 -> V_30 -> V_32 . V_33 . V_67 ) ;
memcpy ( & V_8 -> V_30 -> V_32 . V_33 . V_67 ,
& V_8 -> V_273 . V_67 ,
sizeof( V_8 -> V_273 . V_67 ) ) ;
F_161 ( & V_8 -> V_30 -> V_32 . V_33 . V_67 , V_297 ) ;
F_16 ( V_8 -> V_30 ) ;
F_37 ( L_57 ,
...
F_178 ( V_8 -> V_137 ) ,
F_13 ( & V_8 -> V_66 . V_67 ) ,
F_126 ( V_8 -> V_230 . V_251 ) ,
F_126 ( V_8 -> V_274 . V_251 ) ) ;
V_8 -> V_276 = L_65 ;
F_79 ( V_8 ) ;
return - 1 ;
case V_308 :
...
case V_312 :
F_37 ( L_71 ,
F_126 ( V_8 -> V_230 . V_124 ) ,
F_126 ( V_8 -> V_274 . V_124 ) ) ;
V_8 -> V_124 = F_126 ( V_8 -> V_274 . V_124 ) ;
F_94 ( V_8 ) ;
V_69 = F_138 ( V_8 ) ;
if ( V_69 < 0 )
return V_69 ;
...
V_8 -> V_56 = V_314 ;
V_8 -> V_234 = 0 ;
V_8 -> V_132 = F_126 ( V_8 -> V_274 . V_146 ) ;
V_8 -> V_124 ++ ;
V_8 -> V_188 = V_304 ;
F_37 ( L_75 ,
V_8 -> V_132 ,
...
int V_267 = V_114 ;
return F_153 ( V_8 , V_267 , V_114 , & V_8 -> V_317 ) ;
}
...
V_172 V_207 ;
while ( ! F_77 ( & V_8 -> V_122 ) ) {
V_193 = F_78 ( & V_8 -> V_122 , struct V_35 ,
V_119 ) ;
...
struct V_87 * V_321 ,
unsigned int V_322 , T_4 * V_202 )
{
int V_69 , V_269 ;
F_3 ( ! V_321 ) ;
while ( V_321 -> V_153 < V_322 ) {
F_3 ( V_321 -> V_154 == NULL ) ;
V_269 = V_322 - V_321 -> V_153 ;
V_69 = F_60 ( V_8 -> V_50 , ( char * ) V_321 -> V_154 +
V_321 -> V_153 , V_269 ) ;
if ( V_69 <= 0 )
return V_69 ;
V_321 -> V_153 += V_69 ;
}
if ( V_321 -> V_153 == V_322 )
* V_202 = F_128 ( 0 , V_321 -> V_154 , V_321 -> V_153 ) ;
return 1 ;
}
...
if ( V_256 )
V_202 = F_141 ( V_202 , V_99 , V_100 , V_69 ) ;
( void ) F_118 ( V_158 , ( T_1 ) V_69 ) ;
}
if ( V_256 )
V_8 -> V_266 = V_202 ;
return 1 ;
...
bool V_256 = ! F_57 ( F_58 ( V_8 -> V_30 ) , V_257 ) ;
bool V_324 = ( V_8 -> V_188 & V_189 ) ;
V_172 V_207 ;
T_4 V_202 ;
F_37 ( L_79 , V_8 , V_193 ) ;
V_114 = sizeof ( V_8 -> V_325 ) ;
V_267 = V_114 ;
V_69 = F_153 ( V_8 , V_267 , V_114 , & V_8 -> V_325 ) ;
if ( V_69 <= 0 )
return V_69 ;
V_202 = F_128 ( 0 , & V_8 -> V_325 , F_129 ( struct V_215 , V_202 ) ) ;
if ( F_130 ( V_202 ) != V_8 -> V_325 . V_202 ) {
F_29 ( L_80 ,
V_202 , V_8 -> V_325 . V_202 ) ;
return - V_326 ;
}
V_208 = F_126 ( V_8 -> V_325 . V_208 ) ;
if ( V_208 > V_327 )
return - V_323 ;
V_209 = F_126 ( V_8 -> V_325 . V_209 ) ;
if ( V_209 > V_328 )
return - V_323 ;
V_192 = F_126 ( V_8 -> V_325 . V_192 ) ;
if ( V_192 > V_329 )
return - V_323 ;
V_207 = F_177 ( V_8 -> V_325 . V_207 ) ;
if ( ( V_330 ) V_207 - ( V_330 ) V_8 -> V_127 < 1 ) {
F_169 ( L_81 ,
F_178 ( V_8 -> V_137 ) ,
F_13 ( & V_8 -> V_66 . V_67 ) ,
V_207 , V_8 -> V_127 + 1 ) ;
V_8 -> V_260 = - V_208 - V_209 - V_192 -
F_120 ( V_8 ) ;
V_8 -> V_261 = V_263 ;
return 1 ;
} else if ( ( V_330 ) V_207 - ( V_330 ) V_8 -> V_127 > 1 ) {
F_29 ( L_82 ,
V_207 , V_8 -> V_127 + 1 ) ;
V_8 -> V_276 = L_83 ;
return - V_331 ;
...
V_69 = F_181 ( V_8 , & V_193 -> V_210 , V_208 ,
& V_8 -> V_264 ) ;
if ( V_69 <= 0 )
return V_69 ;
if ( V_193 -> V_213 ) {
V_69 = F_181 ( V_8 , & V_193 -> V_213 -> V_214 ,
V_209 ,
& V_8 -> V_265 ) ;
if ( V_69 <= 0 )
return V_69 ;
...
V_114 = F_120 ( V_8 ) ;
V_267 += V_114 ;
V_69 = F_153 ( V_8 , V_267 , V_114 , & V_193 -> V_194 ) ;
if ( V_69 <= 0 )
return V_69 ;
if ( ! V_324 ) {
...
if ( V_8 -> V_264 != F_126 ( V_193 -> V_194 . V_216 ) ) {
F_29 ( L_87 ,
V_193 , V_8 -> V_264 , V_193 -> V_194 . V_216 ) ;
return - V_326 ;
}
if ( V_8 -> V_265 != F_126 ( V_193 -> V_194 . V_217 ) ) {
F_29 ( L_88 ,
V_193 , V_8 -> V_265 , V_193 -> V_194 . V_217 ) ;
return - V_326 ;
}
if ( V_256 &&
( V_193 -> V_194 . V_9 & V_259 ) == 0 &&
V_8 -> V_266 != F_126 ( V_193 -> V_194 . V_218 ) ) {
F_29 ( L_89 , V_193 ,
V_8 -> V_266 , F_126 ( V_193 -> V_194 . V_218 ) ) ;
return - V_326 ;
}
if ( V_324 && V_8 -> V_77 -> V_332 &&
V_8 -> V_77 -> V_332 ( V_193 ) ) {
F_29 ( L_90 , V_193 ) ;
return - V_326 ;
}
return 1 ;
...
V_8 -> V_123 = NULL ;
if ( V_8 -> V_137 . type == 0 )
V_8 -> V_137 = V_90 -> V_206 . V_333 ;
V_8 -> V_127 ++ ;
F_83 ( & V_8 -> V_130 ) ;
F_37 ( L_91 ,
V_90 , F_177 ( V_90 -> V_206 . V_207 ) ,
F_178 ( V_90 -> V_206 . V_333 ) ,
F_127 ( V_90 -> V_206 . type ) ,
F_186 ( F_127 ( V_90 -> V_206 . type ) ) ,
F_126 ( V_90 -> V_206 . V_208 ) ,
F_126 ( V_90 -> V_206 . V_192 ) ,
V_8 -> V_264 , V_8 -> V_265 , V_8 -> V_266 ) ;
V_8 -> V_77 -> V_334 ( V_8 , V_90 ) ;
F_81 ( & V_8 -> V_130 ) ;
}
static int F_187 ( struct V_7 * V_8 )
{
struct V_335 V_336 ;
T_1 V_114 = sizeof( V_336 ) ;
int V_69 = F_153 ( V_8 , V_114 , V_114 , & V_336 ) ;
if ( V_69 <= 0 )
return V_69 ;
F_188 ( & V_8 -> V_337 , & V_336 ) ;
F_150 ( V_8 ) ;
return 1 ;
}
...
static void V_143 ( struct V_359 * V_142 )
{
...
{
if ( V_90 -> V_8 )
V_90 -> V_8 -> V_77 -> V_349 ( V_90 -> V_8 ) ;
V_90 -> V_8 = V_8 ? V_8 -> V_77 -> V_347 ( V_8 ) : NULL ;
F_3 ( V_90 -> V_8 != V_8 ) ;
}
...
{
V_90 -> V_206 . V_333 = V_8 -> V_30 -> V_32 . V_287 ;
...
F_37 ( L_131 , V_90 ,
F_178 ( V_8 -> V_137 ) , F_127 ( V_90 -> V_206 . type ) ,
F_186 ( F_127 ( V_90 -> V_206 . type ) ) ,
F_126 ( V_90 -> V_206 . V_208 ) ,
...
F_81 ( & V_8 -> V_130 ) ;
if ( V_8 -> V_123 == V_90 ) {
unsigned int V_208 = F_126 ( V_8 -> V_325 . V_208 ) ;
unsigned int V_209 = F_126 ( V_8 -> V_325 . V_209 ) ;
unsigned int V_192 = F_126 ( V_8 -> V_325 . V_192 ) ;
...
struct V_220 V_368 ;
F_217 ( V_367 , & V_368 ) ;
V_368 = F_218 ( V_8 -> V_337 , V_368 ) ;
return F_219 ( & V_221 , & V_368 ) >= 0 ;
}
return false ;
}
static struct V_38 * F_220 ( enum V_369 type )
{
struct V_38 * V_151 ;
if ( F_35 ( ! F_221 ( type ) ) )
return NULL ;
...
struct V_35 * F_229 ( int type , int V_208 , T_6 V_9 ,
bool V_370 )
{
struct V_35 * V_193 ;
...
V_193 -> V_206 . V_371 = F_230 ( V_372 ) ;
V_193 -> V_206 . V_208 = F_130 ( V_208 ) ;
F_89 ( & V_193 -> V_119 ) ;
F_231 ( & V_193 -> V_373 ) ;
F_89 ( & V_193 -> V_151 ) ;
if ( V_208 ) {
V_193 -> V_210 . V_154 = F_232 ( V_208 , V_9 ) ;
...
V_193 -> V_375 = V_193 -> V_210 . V_153 = V_208 ;
...
F_3 ( ! V_8 -> V_77 -> V_376 ) ;
F_83 ( & V_8 -> V_130 ) ;
V_90 = V_8 -> V_77 -> V_376 ( V_8 , V_206 , V_156 ) ;
F_81 ( & V_8 -> V_130 ) ;
if ( V_8 -> V_56 != V_314 ) {
if ( V_90 )
F_75 ( V_90 ) ;
...
memcpy ( & V_8 -> V_123 -> V_206 , & V_8 -> V_325 , sizeof( V_8 -> V_325 ) ) ;
...
F_236 ( V_193 -> V_210 . V_154 ) ;
F_225 ( V_34 , V_193 ) ;
}
static void F_237 ( struct V_373 * V_373 )
{
struct V_35 * V_193 = F_198 ( V_373 , struct V_35 , V_373 ) ;
struct V_38 * V_151 , * V_377 ;
F_37 ( L_113 , V_46 , V_193 ) ;
...
F_37 ( L_143 , V_46 , V_90 ,
F_241 ( & V_90 -> V_373 ) ) ;
F_243 ( & V_90 -> V_373 , F_237 ) ;
}
void F_244 ( struct V_35 * V_90 )
{
F_245 ( L_144 , V_90 ,
V_90 -> V_375 , V_90 -> V_184 ) ;
F_246 ( V_379 , L_145 ,
V_380 , 16 , 1 ,
