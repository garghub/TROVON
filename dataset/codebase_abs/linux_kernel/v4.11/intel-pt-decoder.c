...
memcpy ( V_4 -> V_83 . V_179 , V_149 -> V_59 ,
V_180 ) ;
if ( V_4 -> V_71 & V_72 )
V_4 -> V_83 . V_181 |= V_72 ;
return V_39 ;
...
if ( V_39 )
return V_39 ;
if ( V_149 . V_158 == V_185 ) {
F_40 ( L_17 ,
V_4 -> V_37 ) ;
V_4 -> V_69 = V_175 ;
return - V_50 ;
}
if ( V_149 . V_158 == V_186 ) {
F_40 ( L_18 ,
V_4 -> V_37 ) ;
V_4 -> V_69 = V_175 ;
return - V_50 ;
...
static int F_44 ( struct V_3 * V_4 , bool * V_194 )
{
unsigned int V_183 ;
int V_39 ;
V_183 = V_4 -> V_64 . V_67 &
...
break;
case V_116 :
V_4 -> V_199 = V_4 -> V_64 . V_67 ;
break;
case V_115 :
V_4 -> V_200 = V_4 -> V_64 . V_67 & ( V_193 - 1 ) ;
break;
case V_113 :
V_4 -> V_189 = true ;
F_19 ( V_4 ) ;
...
V_4 -> V_71 = 0 ;
V_4 -> V_83 . V_181 &= ~ V_72 ;
V_4 -> V_83 . V_181 |= V_195 ;
} else {
V_4 -> V_83 . V_181 |= V_201 ;
}
while ( 1 ) {
V_39 = F_35 ( V_4 ) ;
if ( V_39 )
...
{
const unsigned char * V_210 = V_4 -> V_59 + V_4 -> V_79 ;
T_3 V_2 ;
for ( V_2 = V_211 - 1 ; V_2 ; V_2 -- ) {
if ( V_2 > V_4 -> V_79 )
continue;
if ( ! memcmp ( V_210 - V_2 , V_212 , V_2 ) )
return V_2 ;
}
return 0 ;
}
static int F_60 ( struct V_3 * V_4 , int V_213 )
{
T_3 V_214 = V_211 - V_213 ;
const char * V_215 = V_212 ;
if ( V_214 > V_4 -> V_79 ||
memcmp ( V_4 -> V_59 , V_215 + V_213 , V_214 ) )
return 0 ;
return V_214 ;
}
...
if ( V_78 )
return V_78 ;
V_214 = F_60 ( V_4 , V_213 ) ;
if ( ! V_214 )
return 0 ;
V_4 -> V_35 -= V_213 ;
V_4 -> V_87 = V_4 -> V_59 + V_214 ;
V_4 -> V_88 = V_4 -> V_79 - V_214 ;
memcpy ( V_4 -> V_89 , V_212 , V_211 ) ;
V_4 -> V_59 = V_4 -> V_89 ;
V_4 -> V_79 = V_211 ;
return 0 ;
}
...
V_202 = F_63 ( V_4 -> V_59 , V_4 -> V_79 , V_212 ,
V_211 ) ;
if ( ! V_202 ) {
int V_213 ;
V_213 = F_59 ( V_4 ) ;
...
{
T_1 V_217 = V_4 -> V_141 << 1 ;
if ( ! V_4 -> V_105 || ! V_4 -> V_20 )
goto V_157;
V_217 *= V_4 -> V_20 ;
V_217 /= V_4 -> V_105 ;
V_157:
return V_4 -> V_82 + V_217 ;
}
const struct V_218 * F_66 ( struct V_3 * V_4 )
{
int V_39 ;
do {
V_4 -> V_83 . type = V_188 ;
...
V_4 -> V_83 . V_219 = F_65 ( V_4 ) ;
V_4 -> V_83 . V_200 = V_4 -> V_200 ;
...
if ( V_79 < V_211 )
return false ;
return F_63 ( V_59 , V_211 , V_212 ,
V_211 ) ;
}
static bool F_68 ( unsigned char * * V_59 , T_3 * V_79 )
{
unsigned char * V_202 ;
V_202 = F_63 ( * V_59 , * V_79 , V_212 , V_211 ) ;
if ( V_202 ) {
* V_79 -= V_202 - * V_59 ;
* V_59 = V_202 ;
return true ;
...
if ( ! * V_79 )
return false ;
V_202 = F_63 ( * V_59 + 1 , * V_79 - 1 , V_212 , V_211 ) ;
if ( V_202 ) {
* V_79 -= V_202 - * V_59 ;
* V_59 = V_202 ;
return true ;
...
V_221 = V_79 - V_211 + 1 ;
while ( 1 ) {
V_220 = F_71 ( V_59 , V_11 [ 0 ] , V_221 ) ;
if ( ! V_220 )
return NULL ;
if ( ! memcmp ( V_220 + 1 , V_11 + 1 , V_211 - 1 ) )
return V_220 ;
V_221 = V_220 - V_59 ;
if ( ! V_221 )
return NULL ;
...
static bool F_72 ( unsigned char * V_59 , T_3 V_79 , T_1 * V_222 )
{
struct V_63 V_64 ;
int V_78 ;
while ( V_79 ) {
...
static int F_73 ( T_1 V_223 , T_1 V_224 )
{
const T_1 V_225 = ( 1ULL << 55 ) ;
if ( V_223 == V_224 )
return 0 ;
if ( V_223 < V_224 ) {
if ( V_224 - V_223 < V_225 )
return - 1 ;
else
return 1 ;
} else {
...
static unsigned char * F_74 ( unsigned char * V_226 ,
T_3 V_227 ,
unsigned char * V_228 ,
T_3 V_229 )
{
...
unsigned char * V_220 ;
T_3 V_79 ;
V_220 = F_70 ( V_226 , V_227 ) ;
if ( ! V_220 )
return V_228 ;
V_79 = V_227 - ( V_220 - V_226 ) ;
if ( ! F_72 ( V_220 , V_79 , & V_230 ) ) {
V_227 -= V_79 ;
V_220 = F_70 ( V_226 , V_227 ) ;
if ( ! V_220 )
return V_228 ;
...
unsigned char * F_75 ( unsigned char * V_226 , T_3 V_227 ,
unsigned char * V_228 , T_3 V_229 ,
bool V_232 )
{
unsigned char * V_233 ;
if ( ! F_68 ( & V_228 , & V_229 ) )
...
return V_228 ;
if ( V_232 ) {
V_233 = F_74 ( V_226 , V_227 , V_228 , V_229 ) ;
if ( V_233 )
return V_233 ;
}
while ( V_229 < V_227 ) {
...
if ( V_229 > V_227 ) {
while ( ! F_67 ( V_228 + V_227 , V_229 - V_227 ) ) {
if ( ! F_69 ( & V_226 , & V_227 ) )
return V_228 ;
}
}
while ( 1 ) {
V_233 = F_63 ( V_226 , V_227 , V_228 , V_227 ) ;
if ( V_233 )
return V_228 + V_227 ;
if ( ! F_69 ( & V_226 , & V_227 ) )
return V_228 ;
