...
struct V_24 * * V_25 ;
int V_26 , V_27 ;
V_27 = ( V_19 -> V_28 - sizeof( struct V_18 ) ) / sizeof( int ) ;
if ( V_27 <= 0 )
return 0 ;
if ( V_27 > V_29 )
return - V_7 ;
...
int F_22 ( struct V_40 * V_41 , struct V_42 * V_43 , struct V_38 * V_44 )
{
struct V_18 * V_19 ;
int V_45 ;
F_23 (cmsg, msg) {
...
T_2 V_4 ;
T_3 V_6 ;
if ( V_19 -> V_28 != F_25 ( sizeof( struct V_1 ) ) )
goto error;
...
if ( ! V_44 -> V_8 || F_26 ( V_44 -> V_8 ) != V_2 . V_8 ) {
struct V_8 * V_8 ;
V_45 = - V_54 ;
V_8 = F_27 ( V_2 . V_8 ) ;
if ( ! V_8 )
...
V_45 = - V_7 ;
V_4 = F_3 ( F_29 () , V_2 . V_4 ) ;
V_6 = F_4 ( F_29 () , V_2 . V_6 ) ;
if ( ! F_5 ( V_4 ) || ! F_6 ( V_6 ) )
goto error;
V_44 -> V_2 . V_4 = V_4 ;
V_44 -> V_2 . V_6 = V_6 ;
...
int F_31 ( struct V_42 * V_43 , int V_55 , int type , int V_56 , void * V_57 )
{
...
int V_45 ;
if ( V_63 & V_43 -> V_64 )
return F_32 ( V_43 , V_55 , type , V_56 , V_57 ) ;
...
V_61 . V_28 = V_62 ;
V_45 = - V_67 ;
if ( F_33 ( V_58 , & V_61 , sizeof V_61 ) )
goto V_68;
if ( F_33 ( F_13 ( V_58 ) , V_57 , V_62 - sizeof( struct V_18 ) ) )
goto V_68;
V_62 = F_34 ( V_56 ) ;
if ( V_43 -> V_65 < V_62 )
V_62 = V_43 -> V_65 ;
...
void F_35 ( struct V_42 * V_43 , struct V_38 * V_39 )
{
struct V_18 T_4 * V_58
= ( V_59 struct V_18 T_4 * ) V_43 -> V_60 ;
int V_69 = 0 ;
...
V_41 = F_41 ( V_35 [ V_26 ] , & V_45 ) ;
if ( V_41 ) {
F_42 ( & V_41 -> V_75 -> V_76 ) ;
F_43 ( & V_41 -> V_75 -> V_76 ) ;
}
F_44 ( V_72 , F_45 ( V_35 [ V_26 ] ) ) ;
}
if ( V_26 > 0 )
{
int V_62 = F_25 ( V_26 * sizeof( int ) ) ;
V_45 = F_39 ( V_47 , & V_58 -> V_46 ) ;
if ( ! V_45 )
V_45 = F_39 ( V_49 , & V_58 -> V_48 ) ;
if ( ! V_45 )
V_45 = F_39 ( V_62 , & V_58 -> V_28 ) ;
if ( ! V_45 ) {
V_62 = F_34 ( V_26 * sizeof( int ) ) ;
if ( V_43 -> V_65 < V_62 )
V_62 = V_43 -> V_65 ;
V_43 -> V_60 += V_62 ;
V_43 -> V_65 -= V_62 ;
...
struct V_20 * F_46 ( struct V_20 * V_23 )
{
struct V_20 * V_77 ;
int V_26 ;
if ( ! V_23 )
return NULL ;
V_77 = F_47 ( V_23 , F_48 ( struct V_20 , V_35 [ V_23 -> V_32 ] ) ,
V_30 ) ;
if ( V_77 ) {
for ( V_26 = 0 ; V_26 < V_23 -> V_32 ; V_26 ++ )
F_45 ( V_23 -> V_35 [ V_26 ] ) ;
V_77 -> V_33 = V_77 -> V_32 ;
V_77 -> V_34 = F_16 ( V_23 -> V_34 ) ;
}
return V_77 ;
}
