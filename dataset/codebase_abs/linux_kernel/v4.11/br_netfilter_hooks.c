...
struct V_77 V_78 ;
int V_46 ;
for ( V_149 = F_108 ( V_22 -> V_150 . V_151 [ V_152 ] [ V_145 ] ) ;
V_149 && F_109 ( V_149 ) <= V_153 ;
V_149 = F_108 ( V_149 -> V_154 ) )
;
if ( ! V_149 )
return V_129 ( V_22 , V_40 , V_2 ) ;
F_110 () ;
F_111 ( & V_78 , V_145 , V_152 , V_146 , V_147 ,
V_40 , V_22 , V_129 ) ;
V_46 = F_112 ( V_2 , & V_78 , V_149 ) ;
F_113 () ;
if ( V_46 == 1 )
...
static
int F_114 ( struct V_155 * V_156 , int V_157 ,
void T_6 * V_158 , T_7 * V_159 , T_8 * V_160 )
{
int V_46 ;
V_46 = F_115 ( V_156 , V_157 , V_158 , V_159 , V_160 ) ;
