...
int V_72 ;
if ( F_64 ( & V_2 -> V_7 ) ) {
V_8 -> V_16 = * ( T_1 * ) F_64 ( & V_2 -> V_7 ) ;
F_3 ( V_2 ,
V_73 , V_8 -> V_16 ) ;
} else {
V_8 -> V_16 = F_1 ( V_2 , V_73 ) ;
}
V_8 -> V_71 = F_1 ( V_2 , V_65 ) & 0x6F ;
V_72 = F_65 ( & V_2 -> V_7 , F_62 , V_2 ) ;
if ( V_72 )
return V_72 ;
if ( ! ( V_8 -> V_71 & 0x01 ) ) {
int V_14 ;
...
static int F_66 ( struct V_1 * V_2 , const struct V_74 * V_75 )
{
struct V_5 * V_8 ;
struct V_6 * V_76 ;
int V_52 ;
unsigned int V_77 = 0 ;
V_8 = F_67 ( & V_2 -> V_7 , sizeof( struct V_5 ) , V_78 ) ;
if ( ! V_8 )
return - V_79 ;
F_68 ( V_2 , V_8 ) ;
F_69 ( & V_8 -> V_9 ) ;
...
V_8 -> V_49 [ 0 ] = 2500 ;
V_8 -> V_49 [ 1 ] = 2700 ;
V_8 -> V_49 [ 2 ] = ( V_8 -> V_16 & V_80 ) ? 5000 : 3300 ;
V_8 -> V_49 [ 3 ] = 5000 ;
V_8 -> V_49 [ 4 ] = 12000 ;
V_8 -> V_49 [ 5 ] = 2700 ;
V_8 -> V_49 [ 6 ] = 1875 ;
