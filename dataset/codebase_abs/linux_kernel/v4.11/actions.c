...
V_245 = F_135 ( V_246 ) ;
if ( V_245 <= V_247 ) {
struct V_248 * V_249 = F_6 ( V_248 ) ;
struct V_9 * V_250 = & V_249 -> V_10 [ V_245 - 1 ] ;
* V_250 = * V_10 ;
V_250 -> V_251 = F_112 ( V_195 ) ;
F_136 ( V_8 , V_250 ) ;
return 0 ;
}
V_13 = F_5 ( V_8 , V_10 , NULL ) ;
if ( V_13 ) {
V_13 -> V_16 . V_251 = F_112 ( V_195 ) ;
} else {
F_84 ( V_8 ) ;
if ( F_120 () )
F_121 ( L_4 ,
...
switch ( F_111 ( V_195 ) ) {
case V_252 : {
int V_129 = F_112 ( V_195 ) ;
struct V_7 * V_253 ;
if ( F_118 ( V_195 , V_196 ) ) {
F_102 ( V_188 , V_8 , V_129 , V_10 ) ;
return 0 ;
}
V_253 = F_119 ( V_8 , V_215 ) ;
if ( V_253 )
F_102 ( V_188 , V_253 , V_129 , V_10 ) ;
F_86 ( V_8 ) -> V_190 = 0 ;
break;
}
case V_210 : {
