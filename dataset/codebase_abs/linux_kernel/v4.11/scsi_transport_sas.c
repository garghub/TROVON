...
const int V_63 = 32 ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
char * V_64 = F_50 ( V_63 , V_33 ) ;
int V_17 = 0 ;
if ( F_51 ( V_3 , 0x90 , V_64 , V_63 ) )
goto V_65;
V_17 = V_64 [ 12 ] & 0x01 ;
V_65:
F_52 ( V_64 ) ;
...
{
struct V_71 * V_72 = F_57 ( V_27 ) ;
if ( ! V_72 -> V_8 . V_9 )
return snprintf ( V_70 , 20 , L_4 ) ;
return F_58 ( V_72 -> V_8 . V_9 , V_70 ) ;
}
static T_2 F_59 ( struct V_26 * V_27 ,
T_3 V_73 , int V_74 )
{
struct V_71 * V_72 = F_57 ( V_27 ) ;
...
static T_2
F_60 ( struct V_26 * V_27 , struct V_68 * V_69 ,
...
static T_2
F_62 ( struct V_26 * V_27 , T_3 V_73 , int V_79 )
{
struct V_71 * V_72 = F_57 ( V_27 ) ;
struct V_13 * V_14 = F_18 ( V_72 -> V_27 . V_75 ) ;
struct V_53 * V_54 = F_11 ( V_14 -> V_21 ) ;
...
static T_2
F_63 ( struct V_26 * V_27 , struct V_68 * V_69 ,
const char * V_70 , T_3 V_73 )
{
return F_62 ( V_27 , V_73 , 0 ) ;
}
static T_2
F_64 ( struct V_26 * V_27 , struct V_68 * V_69 ,
const char * V_70 , T_3 V_73 )
{
return F_62 ( V_27 , V_73 , 1 ) ;
}
static int F_65 ( struct V_42 * V_43 , struct V_26 * V_27 ,
struct V_26 * V_44 )
{
...
static int F_66 ( struct V_51 * V_52 , struct V_26 * V_27 )
{
struct V_13 * V_14 ;
struct V_53 * V_54 ;
if ( ! F_42 ( V_27 ) )
...
struct V_71 * F_69 ( struct V_26 * V_75 , int V_84 )
{
struct V_13 * V_14 = F_18 ( V_75 ) ;
struct V_71 * V_72 ;
V_72 = F_50 ( sizeof( * V_72 ) , V_33 ) ;
if ( ! V_72 )
return NULL ;
V_72 -> V_84 = V_84 ;
V_72 -> V_77 = 1 ;
F_70 ( & V_72 -> V_27 ) ;
V_72 -> V_27 . V_75 = F_71 ( V_75 ) ;
V_72 -> V_27 . F_22 = F_67 ;
F_32 ( & V_72 -> V_85 ) ;
if ( F_72 ( V_75 ) ) {
struct V_4 * V_5 = F_73 ( V_75 ) ;
F_74 ( & V_72 -> V_27 , L_6 , V_14 -> V_39 ,
V_5 -> V_86 , V_84 ) ;
} else
F_74 ( & V_72 -> V_27 , L_7 , V_14 -> V_39 , V_84 ) ;
F_75 ( & V_72 -> V_27 ) ;
return V_72 ;
}
int F_76 ( struct V_71 * V_72 )
{
int error ;
error = F_77 ( & V_72 -> V_27 ) ;
if ( ! error ) {
F_78 ( & V_72 -> V_27 ) ;
F_79 ( & V_72 -> V_27 ) ;
}
...
{
return V_27 -> F_22 == F_67 ;
}
static int F_85 ( struct V_51 * V_52 , struct V_26 * V_27 )
{
struct V_13 * V_14 ;
struct V_53 * V_54 ;
if ( ! F_39 ( V_27 ) )
...
{
int V_91 ;
V_91 = F_88 ( & V_89 -> V_27 . V_92 , & V_72 -> V_27 . V_92 ,
F_25 ( & V_72 -> V_27 ) ) ;
if ( V_91 )
goto V_93;
V_91 = F_88 ( & V_72 -> V_27 . V_92 , & V_89 -> V_27 . V_92 , L_8 ) ;
if ( V_91 )
goto V_93;
return;
V_93:
...
static void F_89 ( struct V_88 * V_89 ,
struct V_71 * V_72 )
{
F_90 ( & V_89 -> V_27 . V_92 , F_25 ( & V_72 -> V_27 ) ) ;
F_90 ( & V_72 -> V_27 . V_92 , L_8 ) ;
}
struct V_88 * F_91 ( struct V_26 * V_75 , int V_95 )
{
struct V_13 * V_14 = F_18 ( V_75 ) ;
struct V_88 * V_89 ;
V_89 = F_50 ( sizeof( * V_89 ) , V_33 ) ;
if ( ! V_89 )
return NULL ;
V_89 -> V_96 = V_95 ;
F_70 ( & V_89 -> V_27 ) ;
V_89 -> V_27 . V_75 = F_71 ( V_75 ) ;
V_89 -> V_27 . F_22 = F_86 ;
F_33 ( & V_89 -> V_97 ) ;
F_32 ( & V_89 -> V_90 ) ;
if ( F_72 ( V_75 ) ) {
struct V_4 * V_5 = F_73 ( V_75 ) ;
F_74 ( & V_89 -> V_27 , L_10 , V_14 -> V_39 ,
V_5 -> V_86 , V_89 -> V_96 ) ;
} else
F_74 ( & V_89 -> V_27 , L_11 , V_14 -> V_39 ,
V_89 -> V_96 ) ;
F_75 ( & V_89 -> V_27 ) ;
return V_89 ;
}
struct V_88 * F_92 ( struct V_26 * V_75 )
{
int V_98 ;
struct V_13 * V_14 = F_18 ( V_75 ) ;
struct V_28 * V_29 = F_19 ( V_14 ) ;
...
if ( F_72 ( V_75 ) ) {
struct V_4 * V_5 = F_73 ( V_75 ) ;
struct V_99 * exp = F_94 ( V_5 ) ;
V_98 = exp -> V_49 ++ ;
} else
V_98 = V_29 -> V_49 ++ ;
F_95 ( & V_29 -> V_46 ) ;
return F_91 ( V_75 , V_98 ) ;
}
int F_96 ( struct V_88 * V_89 )
{
int error ;
F_3 ( ! F_82 ( & V_89 -> V_90 ) ) ;
error = F_77 ( & V_89 -> V_27 ) ;
if ( error )
return error ;
F_78 ( & V_89 -> V_27 ) ;
F_79 ( & V_89 -> V_27 ) ;
...
F_93 ( & V_89 -> V_97 ) ;
F_99 (phy, tmp_phy, &port->phy_list,
port_siblings) {
F_89 ( V_89 , V_72 ) ;
F_100 ( & V_72 -> V_85 ) ;
}
...
{
return V_27 -> F_22 == F_86 ;
}
struct V_71 * F_101 ( struct V_88 * V_89 )
{
struct V_71 * V_72 ;
F_93 ( & V_89 -> V_97 ) ;
if ( F_82 ( & V_89 -> V_90 ) )
...
V_72 = F_102 ( V_103 , F_103 ( * V_72 ) , V_85 ) ;
F_71 ( & V_72 -> V_27 ) ;
}
F_95 ( & V_89 -> V_97 ) ;
return V_72 ;
}
void F_104 ( struct V_88 * V_89 , struct V_71 * V_72 )
{
F_93 ( & V_89 -> V_97 ) ;
if ( F_105 ( ! F_82 ( & V_72 -> V_85 ) ) ) {
struct V_71 * V_105 ;
F_106 (tmp, &port->phy_list, port_siblings)
if ( V_105 == V_72 )
break;
if ( F_105 ( V_105 != V_72 ) ) {
...
F_87 ( V_89 , V_72 ) ;
F_108 ( & V_72 -> V_85 , & V_89 -> V_90 ) ;
V_89 -> V_106 ++ ;
}
F_95 ( & V_89 -> V_97 ) ;
}
void F_109 ( struct V_88 * V_89 , struct V_71 * V_72 )
{
F_93 ( & V_89 -> V_97 ) ;
F_89 ( V_89 , V_72 ) ;
F_100 ( & V_72 -> V_85 ) ;
...
return;
V_89 -> V_101 = 1 ;
V_91 = F_88 ( & V_89 -> V_27 . V_92 , & V_75 -> V_92 ,
F_25 ( V_75 ) ) ;
if ( V_91 )
goto V_93;
return;
...
static T_2
F_111 ( struct V_26 * V_27 ,
struct V_68 * V_69 , char * V_70 )
{
struct V_4 * V_5 = F_112 ( V_27 ) ;
if ( ! V_5 -> V_8 . V_9 )
return snprintf ( V_70 , 20 , L_4 ) ;
return F_58 (
V_5 -> V_8 . V_9 , V_70 ) ;
...
{
char * V_64 = F_50 ( V_111 , V_33 ) , * V_112 ;
struct V_1 * V_7 = F_1 ( V_3 ) ;
struct V_113 V_114 ;
int V_91 , error ;
if ( ! V_64 )
return - V_34 ;
V_91 = F_116 ( V_3 , 1 , 0x19 , V_64 , V_111 , 30 * V_115 , 3 ,
& V_114 , NULL ) ;
error = - V_78 ;
if ( ! F_117 ( V_91 ) )
goto V_65;
...
static int F_118 ( struct V_51 * V_52 , struct V_26 * V_27 )
{
struct V_13 * V_14 ;
struct V_53 * V_54 ;
if ( ! F_119 ( V_27 ) )
...
static void F_122 ( struct V_26 * V_27 )
{
struct V_4 * V_5 = F_73 ( V_27 ) ;
struct V_99 * V_126 = F_94 ( V_5 ) ;
if ( V_5 -> V_12 )
F_20 ( V_5 -> V_12 ) ;
F_68 ( V_27 -> V_75 ) ;
F_52 ( V_126 ) ;
...
struct V_4 * F_125 ( struct V_88 * V_75 )
{
struct V_13 * V_14 = F_18 ( & V_75 -> V_27 ) ;
struct V_1 * V_7 ;
V_7 = F_50 ( sizeof( * V_7 ) , V_33 ) ;
if ( ! V_7 ) {
return NULL ;
}
F_70 ( & V_7 -> V_5 . V_27 ) ;
V_7 -> V_5 . V_27 . V_75 = F_71 ( & V_75 -> V_27 ) ;
V_7 -> V_5 . V_27 . F_22 = F_123 ;
if ( F_72 ( V_75 -> V_27 . V_75 ) ) {
struct V_4 * V_5 = F_73 ( V_75 -> V_27 . V_75 ) ;
F_74 ( & V_7 -> V_5 . V_27 , L_16 ,
V_14 -> V_39 , V_5 -> V_86 ,
V_75 -> V_96 ) ;
} else
F_74 ( & V_7 -> V_5 . V_27 , L_17 ,
V_14 -> V_39 , V_75 -> V_96 ) ;
...
F_70 ( & V_7 -> V_5 . V_27 ) ;
V_7 -> V_5 . V_27 . V_75 = F_71 ( & V_75 -> V_27 ) ;
V_7 -> V_5 . V_27 . F_22 = F_122 ;
F_93 ( & V_29 -> V_46 ) ;
V_7 -> V_5 . V_86 = V_29 -> V_48 ++ ;
F_95 ( & V_29 -> V_46 ) ;
F_74 ( & V_7 -> V_5 . V_27 , L_18 ,
...
V_135 = 0 ;
F_128 ( & V_5 -> V_27 , 0 , V_5 -> V_86 , V_135 ,
V_137 ) ;
}
return 0 ;
}
...
int F_119 ( const struct V_26 * V_27 )
{
return V_27 -> F_22 == F_123 ||
V_27 -> F_22 == F_122 ;
}
static int F_134 ( struct V_13 * V_14 , T_4 V_138 ,
T_4 V_139 , T_1 V_135 )
{
struct V_28 * V_29 = F_19 ( V_14 ) ;
struct V_4 * V_5 ;
F_93 ( & V_29 -> V_46 ) ;
F_106 (rphy, &sas_host->rphy_list, list) {
if ( V_5 -> V_8 . V_9 != V_10 ||
V_5 -> V_86 == - 1 )
continue;
if ( ( V_138 == V_136 || V_138 == 0 ) &&
( V_139 == V_136 || V_139 == V_5 -> V_86 ) ) {
F_128 ( & V_5 -> V_27 , 0 , V_5 -> V_86 ,
V_135 , V_140 ) ;
}
}
F_95 ( & V_29 -> V_46 ) ;
...
void F_146 ( struct V_141 * V_59 )
{
struct V_53 * V_54 = F_11 ( V_59 ) ;
F_147 ( & V_54 -> V_59 . V_55 ) ;
F_147 ( & V_54 -> V_82 ) ;
F_147 ( & V_54 -> V_87 ) ;
F_147 ( & V_54 -> V_121 ) ;
F_147 ( & V_54 -> V_122 ) ;
