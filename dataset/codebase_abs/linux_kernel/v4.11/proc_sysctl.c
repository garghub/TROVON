...
void F_53 ( struct V_37 * V_27 )
{
}
static int F_54 ( int V_63 , int V_64 )
{
if ( F_55 ( F_56 () , V_65 ) )
V_63 >>= 6 ;
else if ( F_57 ( V_66 ) )
...
static int F_58 ( struct V_1 * V_2 , struct V_3 * V_40 , int V_64 )
{
...
static struct V_52 * F_59 ( struct V_72 * V_73 ,
...
V_55 -> V_76 = V_2 ;
V_55 -> V_77 = V_40 ;
F_63 ( & V_55 -> V_78 , & V_2 -> V_46 ) ;
V_2 -> V_43 ++ ;
F_39 ( & V_58 ) ;
V_52 -> V_79 = V_52 -> V_80 = V_52 -> V_81 = F_64 ( V_52 ) ;
V_52 -> V_82 = V_40 -> V_63 ;
if ( ! F_65 ( V_40 -> V_63 ) ) {
V_52 -> V_82 |= V_83 ;
V_52 -> V_84 = & V_85 ;
...
void F_67 ( struct V_52 * V_52 , struct V_1 * V_2 )
{
F_42 ( & V_58 ) ;
F_68 ( & F_62 ( V_52 ) -> V_78 ) ;
if ( ! -- V_2 -> V_43 )
...
static struct V_1 * F_70 ( struct V_52 * V_52 )
{
struct V_1 * V_2 = F_62 ( V_52 ) -> V_76 ;
if ( ! V_2 )
V_2 = & V_95 . V_60 . V_7 . V_8 ;
return F_43 ( V_2 ) ;
}
static struct V_96 * F_71 ( struct V_52 * V_7 , struct V_96 * V_96 ,
unsigned int V_97 )
{
...
if ( F_72 ( V_2 ) )
return F_73 ( V_2 ) ;
V_6 = F_74 ( V_2 , struct V_6 , V_8 ) ;
V_31 = F_47 ( & V_98 , V_6 , V_22 -> V_22 , V_22 -> V_102 ) ;
if ( ! V_31 )
goto V_74;
if ( F_75 ( V_31 -> V_63 ) ) {
V_101 = F_76 ( & V_98 , & V_31 ) ;
V_47 = F_41 ( V_101 ) ;
if ( V_101 )
goto V_74;
}
V_47 = F_41 ( - V_103 ) ;
V_52 = F_59 ( V_7 -> V_104 , V_98 ? V_98 : V_2 , V_31 ) ;
if ( ! V_52 )
goto V_74;
V_47 = NULL ;
F_77 ( V_96 , & V_105 ) ;
...
static T_1 F_79 ( struct V_106 * V_107 , void T_2 * V_108 ,
T_3 V_43 , T_4 * V_109 , int V_110 )
{
struct V_52 * V_52 = F_80 ( V_107 ) ;
struct V_1 * V_2 = F_70 ( V_52 ) ;
struct V_3 * V_40 = F_62 ( V_52 ) -> V_77 ;
T_1 error ;
T_3 V_111 ;
if ( F_72 ( V_2 ) )
return F_81 ( V_2 ) ;
error = - V_112 ;
if ( F_58 ( V_2 , V_40 , V_110 ? V_68 : V_67 ) )
goto V_74;
error = - V_49 ;
if ( ! V_40 -> V_113 )
goto V_74;
...
static T_1 F_82 ( struct V_106 * V_107 , char T_2 * V_108 ,
T_3 V_43 , T_4 * V_109 )
{
return F_79 ( V_107 , ( void T_2 * ) V_108 , V_43 , V_109 , 0 ) ;
}
static T_1 F_83 ( struct V_106 * V_107 , const char T_2 * V_108 ,
T_3 V_43 , T_4 * V_109 )
{
return F_79 ( V_107 , ( void T_2 * ) V_108 , V_43 , V_109 , 1 ) ;
}
static int F_84 ( struct V_52 * V_52 , struct V_106 * V_107 )
{
struct V_1 * V_2 = F_70 ( V_52 ) ;
struct V_3 * V_40 = F_62 ( V_52 ) -> V_77 ;
if ( F_72 ( V_2 ) )
return F_81 ( V_2 ) ;
if ( V_40 -> V_10 )
V_107 -> V_114 = F_85 ( V_40 -> V_10 ) ;
F_45 ( V_2 ) ;
return 0 ;
}
static unsigned int F_86 ( struct V_106 * V_107 , T_5 * V_12 )
{
struct V_52 * V_52 = F_80 ( V_107 ) ;
struct V_1 * V_2 = F_70 ( V_52 ) ;
struct V_3 * V_40 = F_62 ( V_52 ) -> V_77 ;
...
F_87 ( V_107 , & V_40 -> V_10 -> V_12 , V_12 ) ;
if ( V_11 != F_88 ( & V_40 -> V_10 -> V_11 ) ) {
V_107 -> V_114 = F_85 ( V_40 -> V_10 ) ;
...
static bool F_89 ( struct V_106 * V_106 ,
struct V_121 * V_122 ,
struct V_1 * V_2 ,
struct V_3 * V_40 )
{
...
V_124 . V_127 = F_90 ( V_7 , V_124 . V_22 , V_124 . V_102 ) ;
V_4 = F_91 ( V_7 , & V_124 ) ;
if ( ! V_4 ) {
F_92 ( V_128 ) ;
V_4 = F_93 ( V_7 , & V_124 , & V_128 ) ;
if ( F_72 ( V_4 ) )
return false ;
if ( F_94 ( V_4 ) ) {
V_52 = F_59 ( V_7 -> V_129 , V_2 , V_40 ) ;
if ( ! V_52 ) {
F_95 ( V_4 ) ;
F_96 ( V_4 ) ;
return false ;
...
type = V_52 -> V_82 >> 12 ;
F_96 ( V_4 ) ;
return F_98 ( V_122 , V_124 . V_22 , V_124 . V_102 , V_125 , type ) ;
}
static bool F_99 ( struct V_106 * V_106 ,
struct V_121 * V_122 ,
struct V_1 * V_2 ,
struct V_3 * V_40 )
{
...
V_2 = F_43 ( V_2 ) ;
if ( F_75 ( V_40 -> V_63 ) ) {
int V_47 = F_76 ( & V_2 , & V_40 ) ;
if ( V_47 )
goto V_74;
}
V_101 = F_89 ( V_106 , V_122 , V_2 , V_40 ) ;
V_74:
F_45 ( V_2 ) ;
return V_101 ;
}
static int F_100 ( struct V_1 * V_2 , struct V_3 * V_40 ,
...
return true ;
if ( F_27 ( F_75 ( V_40 -> V_63 ) ) )
V_111 = F_99 ( V_106 , V_122 , V_2 , V_40 ) ;
else
V_111 = F_89 ( V_106 , V_122 , V_2 , V_40 ) ;
if ( V_111 )
V_122 -> V_130 = * V_130 ;
return V_111 ;
}
static int F_101 ( struct V_106 * V_106 , struct V_121 * V_122 )
{
struct V_1 * V_2 = F_70 ( F_80 ( V_106 ) ) ;
struct V_1 * V_98 = NULL ;
struct V_3 * V_24 ;
struct V_6 * V_6 ;
unsigned long V_130 ;
...
return F_81 ( V_2 ) ;
V_6 = F_74 ( V_2 , struct V_6 , V_8 ) ;
if ( ! F_102 ( V_106 , V_122 ) )
goto V_74;
V_130 = 2 ;
for ( F_50 ( V_6 , & V_98 , & V_24 ) ; V_98 ; F_52 ( & V_98 , & V_24 ) ) {
if ( ! F_100 ( V_98 , V_24 , & V_130 , V_106 , V_122 ) ) {
F_45 ( V_98 ) ;
break;
}
}
...
static int F_103 ( struct V_52 * V_52 , int V_131 )
{
struct V_1 * V_2 ;
struct V_3 * V_40 ;
int error ;
if ( ( V_131 & V_69 ) && F_104 ( V_52 -> V_82 ) )
return - V_70 ;
V_2 = F_70 ( V_52 ) ;
if ( F_72 ( V_2 ) )
return F_81 ( V_2 ) ;
...
error = F_58 ( V_2 , V_40 , V_131 & ~ V_132 ) ;
F_45 ( V_2 ) ;
return error ;
}
static int F_105 ( struct V_96 * V_96 , struct V_133 * V_134 )
{
struct V_52 * V_52 = F_97 ( V_96 ) ;
int error ;
if ( V_134 -> V_135 & ( V_136 | V_137 | V_138 ) )
return - V_112 ;
error = F_106 ( V_96 , V_134 ) ;
if ( error )
return error ;
F_107 ( V_52 , V_134 ) ;
F_108 ( V_52 ) ;
...
static int F_109 ( const struct V_139 * V_139 , struct V_140 * V_141 ,
T_7 V_142 , unsigned int V_143 )
{
struct V_52 * V_52 = F_97 ( V_139 -> V_96 ) ;
struct V_1 * V_2 = F_70 ( V_52 ) ;
struct V_3 * V_40 = F_62 ( V_52 ) -> V_77 ;
if ( F_72 ( V_2 ) )
return F_81 ( V_2 ) ;
...
static int F_111 ( struct V_96 * V_96 , unsigned int V_97 )
{
if ( V_97 & V_145 )
return - V_146 ;
return ! F_62 ( F_97 ( V_96 ) ) -> V_76 -> V_45 ;
}
static int F_112 ( const struct V_96 * V_96 )
{
return ! ! F_62 ( F_97 ( V_96 ) ) -> V_76 -> V_45 ;
}
static int F_113 ( struct V_1 * V_31 )
{
...
static int F_114 ( const struct V_96 * V_96 ,
...
return 1 ;
V_2 = F_116 ( F_62 ( V_52 ) -> V_76 ) ;
return ! V_2 || ! F_113 ( V_2 ) ;
}
static struct V_6 * F_117 ( struct V_6 * V_7 ,
const char * V_22 , int V_23 )
{
struct V_1 * V_2 ;
struct V_3 * V_24 ;
...
if ( ! F_65 ( V_24 -> V_63 ) )
return F_41 ( - V_149 ) ;
return F_74 ( V_2 , struct V_6 , V_8 ) ;
}
static struct V_6 * F_118 ( struct V_38 * V_39 ,
const char * V_22 , int V_23 )
{
struct V_3 * V_40 ;
struct V_6 * V_150 ;
struct V_28 * V_26 ;
char * V_151 ;
V_150 = F_119 ( sizeof( * V_150 ) + sizeof( struct V_28 ) +
...
static struct V_6 * F_120 ( struct V_6 * V_7 ,
const char * V_22 , int V_23 )
{
...
int V_47 ;
F_42 ( & V_58 ) ;
V_155 = F_117 ( V_7 , V_22 , V_23 ) ;
if ( ! F_72 ( V_155 ) )
goto V_156;
if ( F_81 ( V_155 ) != - V_59 )
goto V_157;
F_39 ( & V_58 ) ;
V_150 = F_118 ( V_39 , V_22 , V_23 ) ;
F_42 ( & V_58 ) ;
V_155 = F_41 ( - V_103 ) ;
if ( ! V_150 )
goto V_157;
...
static struct V_6 * F_121 ( struct V_38 * V_39 , struct V_6 * V_7 )
{
struct V_6 * V_13 ;
const char * V_14 ;
if ( ! V_7 -> V_8 . V_13 )
return & V_39 -> V_7 ;
V_13 = F_121 ( V_39 , V_7 -> V_8 . V_13 ) ;
if ( F_72 ( V_13 ) )
return V_13 ;
V_14 = V_7 -> V_8 . V_3 [ 0 ] . V_14 ;
return F_117 ( V_13 , V_14 , strlen ( V_14 ) ) ;
}
...
static int F_122 ( const char * V_139 , struct V_3 * V_40 , char * V_159 , ... )
{
struct V_160 V_161 ;
T_8 args ;
va_start ( args , V_159 ) ;
...
static int F_123 ( const char * V_139 , struct V_3 * V_40 )
{
int V_47 = 0 ;
for (; V_40 -> V_14 ; V_40 ++ ) {
if ( V_40 -> V_4 )
V_47 = F_122 ( V_139 , V_40 , L_7 ) ;
if ( ( V_40 -> V_113 == V_163 ) ||
( V_40 -> V_113 == V_164 ) ||
( V_40 -> V_113 == V_165 ) ||
( V_40 -> V_113 == V_166 ) ||
...
( V_40 -> V_113 == V_171 ) ) {
if ( ! V_40 -> V_158 )
V_47 = F_122 ( V_139 , V_40 , L_8 ) ;
if ( ! V_40 -> V_172 )
V_47 = F_122 ( V_139 , V_40 , L_9 ) ;
}
if ( ! V_40 -> V_113 )
V_47 = F_122 ( V_139 , V_40 , L_10 ) ;
if ( ( V_40 -> V_63 & ( V_153 | V_173 ) ) != V_40 -> V_63 )
V_47 = F_122 ( V_139 , V_40 , L_11 ,
V_40 -> V_63 ) ;
}
return V_47 ;
}
static struct V_1 * F_124 ( struct V_6 * V_7 , struct V_3 * V_40 ,
struct V_37 * V_174 )
{
...
static bool F_125 ( struct V_6 * V_7 ,
...
if ( ! V_176 )
return false ;
if ( F_65 ( V_176 -> V_63 ) && F_65 ( V_24 -> V_63 ) )
continue;
if ( F_75 ( V_176 -> V_63 ) && ( V_176 -> V_158 == V_174 ) )
continue;
return false ;
}
for ( V_24 = V_40 ; V_24 -> V_14 ; V_24 ++ ) {
...
if ( V_2 -> V_39 == V_183 )
return 0 ;
V_184 = F_121 ( V_183 , V_2 -> V_13 ) ;
if ( F_72 ( V_184 ) )
return 0 ;
if ( F_125 ( V_184 , V_2 -> V_3 , V_2 -> V_27 ) )
return 0 ;
V_184 -> V_8 . V_44 ++ ;
F_39 ( & V_58 ) ;
V_177 = F_124 ( V_184 , V_2 -> V_3 , V_2 -> V_27 ) ;
F_42 ( & V_58 ) ;
V_47 = - V_103 ;
if ( ! V_177 )
goto V_74;
...
struct V_1 * F_129 ( const char * V_139 , struct V_3 * V_40 )
{
return F_127 ( & V_95 . V_60 ,
V_139 , V_40 ) ;
}
static char * F_130 ( const char * V_139 , char * V_130 , const char * V_22 )
{
int V_23 ;
V_23 = strlen ( V_22 ) ;
...
static int F_131 ( struct V_3 * V_40 )
{
int V_188 = 0 ;
int V_189 = 0 ;
struct V_3 * V_24 ;
...
for ( V_24 = V_40 ; V_24 -> V_14 ; V_24 ++ ) {
if ( V_24 -> V_4 )
V_189 += F_131 ( V_24 -> V_4 ) ;
else
V_188 = 1 ;
}
return V_189 + V_188 ;
}
static int F_132 ( const char * V_139 , char * V_130 ,
...
if ( V_193 && V_192 ) {
struct V_3 * V_150 ;
V_191 = F_119 ( sizeof( struct V_3 ) * ( V_192 + 1 ) ,
V_152 ) ;
if ( ! V_191 )
goto V_74;
V_41 = V_191 ;
...
continue;
V_47 = - V_195 ;
V_194 = F_130 ( V_139 , V_130 , V_24 -> V_14 ) ;
if ( ! V_194 )
goto V_74;
V_47 = F_132 ( V_139 , V_194 , V_190 ,
V_39 , V_24 -> V_4 ) ;
V_130 [ 0 ] = '\0' ;
if ( V_47 )
goto V_74;
...
int V_189 = F_131 ( V_40 ) ;
struct V_1 * V_8 = NULL , * * V_197 , * * V_190 ;
const struct V_196 * V_198 ;
char * V_199 , * V_130 ;
V_130 = V_199 = F_134 ( V_187 , V_152 ) ;
if ( ! V_199 )
return NULL ;
V_130 [ 0 ] = '\0' ;
for ( V_198 = V_139 ; V_198 -> V_14 ; V_198 ++ ) {
V_130 = F_130 ( V_199 , V_130 , V_198 -> V_14 ) ;
if ( ! V_130 )
goto V_74;
}
while ( V_40 -> V_14 && V_40 -> V_4 && ! V_40 [ 1 ] . V_14 ) {
V_130 = F_130 ( V_199 , V_130 , V_40 -> V_14 ) ;
if ( ! V_130 )
goto V_74;
V_40 = V_40 -> V_4 ;
}
if ( V_189 == 1 ) {
V_8 = F_127 ( V_39 , V_199 , V_40 ) ;
if ( V_8 )
V_8 -> V_41 = V_41 ;
} else {
V_8 = F_119 ( sizeof( * V_8 ) +
...
struct V_1 * F_136 ( const struct V_196 * V_139 ,
struct V_3 * V_40 )
{
return F_133 ( & V_95 . V_60 ,
V_139 , V_40 ) ;
}
struct V_1 * F_137 ( struct V_3 * V_40 )
{
static const struct V_196 V_202 [] = { {} } ;
return F_136 ( V_202 , V_40 ) ;
}
...
if ( V_176 &&
( ( F_65 ( V_176 -> V_63 ) && F_65 ( V_24 -> V_63 ) ) ||
( F_75 ( V_176 -> V_63 ) && ( V_176 -> V_158 == V_27 ) ) ) ) {
F_25 ( V_203 ) ;
}
else {
F_13 ( L_12 ) ;
...
void F_135 ( struct V_1 * V_8 )
{
int V_189 ;
F_138 () ;
if ( V_8 == NULL )
return;
V_189 = F_131 ( V_8 -> V_41 ) ;
if ( F_27 ( V_189 > 1 ) ) {
struct V_1 * * V_197 ;
int V_204 ;
V_197 = (struct V_1 * * ) ( V_8 + 1 ) ;
...
void F_140 ( struct V_38 * V_39 )
{
F_141 ( ! F_22 ( & V_39 -> V_7 . V_27 ) ) ;
}
int T_9 F_142 ( void )
{
struct V_206 * V_207 ;
V_207 = F_143 ( L_13 , NULL ) ;
V_207 -> V_208 = & V_89 ;
V_207 -> V_209 = & V_90 ;
V_207 -> V_210 = 0 ;
return F_144 () ;
