...
static unsigned int T_3 F_78 ( struct V_19 * V_4 ,
int V_3 )
{
V_3 <<= V_4 -> V_5 ;
return F_2 ( V_4 -> V_6 + V_3 ) ;
}
static void T_3 F_79 ( struct V_19 * V_4 , int V_3 ,
int V_7 )
{
V_3 <<= V_4 -> V_5 ;
F_4 ( V_7 , V_4 -> V_6 + V_3 ) ;
}
static void T_3 F_80 ( struct V_19 * V_4 , int V_249 )
{
unsigned int V_64 ;
for (; ; ) {
V_64 = F_78 ( V_4 , V_105 ) ;
...
static void T_3 F_82 ( struct V_250 * V_250 ,
const char * V_251 , unsigned int V_51 )
{
...
struct V_291 * V_292 )
{
struct V_267 * V_293 = & V_2 -> V_4 . V_31 ;
T_4 V_294 [ 2 ] ;
enum V_295 V_32 ;
int V_99 ;
V_293 -> V_32 = 0 ;
...
V_293 -> V_32 |= V_37 ;
V_2 -> V_38 = F_115 ( V_292 , L_18 , 0 , & V_32 ) ;
if ( F_96 ( V_2 -> V_38 ) ) {
...
{
struct V_12 * V_288 = F_7 ( & V_298 -> V_14 ) ;
struct V_1 * V_2 ;
struct V_299 * V_300 ;
void T_6 * V_301 ;
int V_302 = 0 ;
...
int V_99 ;
if ( V_298 -> V_14 . V_290 ) {
V_302 = F_120 ( V_298 -> V_14 . V_290 , 0 ) ;
if ( ! V_302 )
return - V_296 ;
V_149 = F_120 ( V_298 -> V_14 . V_290 , 1 ) ;
V_288 = F_110 ( & V_298 -> V_14 ) ;
V_298 -> V_14 . V_303 = V_288 ;
} else {
V_302 = F_121 ( V_298 , 0 ) ;
if ( V_302 < 0 )
return - V_296 ;
}
V_2 = F_111 ( & V_298 -> V_14 , sizeof( * V_2 ) , V_289 ) ;
if ( ! V_2 )
return - V_304 ;
V_300 = F_122 ( V_298 , V_305 , 0 ) ;
V_301 = F_123 ( & V_298 -> V_14 , V_300 ) ;
if ( F_124 ( V_301 ) )
return F_125 ( V_301 ) ;
V_2 -> V_14 = & V_298 -> V_14 ;
...
V_2 -> V_4 . V_308 = & V_309 ;
if ( V_298 -> V_14 . V_290 )
V_99 = F_126 ( V_298 -> V_14 . V_290 , L_23 ) ;
else
V_99 = V_298 -> V_310 ;
if ( V_99 < 0 ) {
F_127 ( & V_298 -> V_14 , L_24 ,
V_99 ) ;
goto V_311;
}
V_2 -> V_4 . line = V_99 ;
if ( V_2 -> V_4 . line >= V_312 ) {
F_127 ( & V_298 -> V_14 , L_25 , V_2 -> V_4 . line ,
V_312 ) ;
V_99 = - V_313 ;
goto V_311;
}
...
V_2 -> V_4 . line ) ;
V_99 = F_113 ( V_2 , V_298 -> V_14 . V_290 ) ;
if ( V_99 < 0 )
goto V_314;
sprintf ( V_2 -> V_148 , L_27 , V_2 -> V_4 . line ) ;
V_2 -> V_4 . V_315 = V_300 -> V_316 ;
V_2 -> V_4 . V_6 = V_301 ;
...
static int F_141 ( struct V_297 * V_14 )
{
