...
V_13 = F_3 ( V_22 ) ;
V_24 = F_10 ( & V_13 -> V_13 , true , false , NULL ) ;
if ( V_24 )
return V_24 ;
...
V_2 -> V_43 = V_44 ;
V_2 -> V_45 = & V_46 ;
F_19 ( V_2 , V_10 -> V_25 [ 0 ] , V_10 -> V_47 -> V_48 ) ;
F_20 ( V_2 , & V_9 -> V_10 . V_11 , V_28 -> V_49 ,
V_28 -> V_50 ) ;
V_2 -> V_51 = V_13 -> V_39 . V_52 ;
V_2 -> V_53 = V_23 ;
F_21 ( & V_13 -> V_13 . V_54 -> V_55 , & V_13 -> V_13 . V_56 ) ;
V_2 -> V_41 . V_57 = 0 ;
V_2 -> V_41 . V_58 = V_23 ;
return 0 ;
}
...
{
struct V_59 * V_14 = & V_9 -> V_10 . V_14 ;
F_23 ( L_5 ) ;
F_24 ( & V_9 -> V_10 . V_11 ) ;
F_18 ( & V_9 -> V_10 . V_11 ) ;
if ( V_14 -> V_15 ) {
...
{
int V_24 ;
F_30 ( V_9 -> V_21 , & V_9 -> V_10 . V_11 ,
& V_60 ) ;
V_24 = F_31 ( V_9 -> V_21 , & V_9 -> V_10 . V_11 , 1 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_32 ( & V_9 -> V_10 . V_11 ) ;
if ( V_24 )
goto V_61;
F_33 ( V_9 -> V_21 ) ;
V_24 = F_34 ( & V_9 -> V_10 . V_11 , 32 ) ;
if ( V_24 )
goto V_61;
V_9 -> V_10 . V_62 = true ;
return 0 ;
