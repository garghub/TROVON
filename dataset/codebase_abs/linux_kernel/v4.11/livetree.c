...
if ( ! V_11 )
return V_3 ;
for ( V_35 = V_11 ; V_35 -> V_5 ; V_35 = V_35 -> V_5 )
;
V_35 -> V_5 = V_3 ;
return V_11 ;
}
struct V_36 * F_31 ( unsigned int V_37 ,
struct V_31 * V_38 ,
struct V_14 * V_39 , T_2 V_40 )
{
struct V_36 * V_41 ;
V_41 = xmalloc ( sizeof( * V_41 ) ) ;
V_41 -> V_37 = V_37 ;
V_41 -> V_38 = V_38 ;
V_41 -> V_42 = V_39 ;
V_41 -> V_40 = V_40 ;
...
{
if ( V_14 -> V_7 [ V_14 -> V_43 ] == '\0' )
return L_1 ;
else
return V_14 -> V_7 + V_14 -> V_43 + 1 ;
}
struct V_6 * F_26 ( struct V_14 * V_14 , const char * V_44 )
{
struct V_6 * V_27 ;
F_24 (node, prop)
if ( F_3 ( V_27 -> V_7 , V_44 ) )
return V_27 ;
return NULL ;
}
...
return F_34 ( * ( ( T_3 * ) V_27 -> V_9 . V_9 ) ) ;
}
struct V_6 * F_35 ( struct V_14 * V_39 , const char * V_1 ,
struct V_14 * * V_14 )
{
struct V_6 * V_27 ;
struct V_14 * V_45 ;
...
struct V_46 * F_36 ( struct V_14 * V_39 , const char * V_1 ,
...
struct V_14 * F_39 ( struct V_14 * V_39 , const char * V_51 )
{
const char * V_12 ;
struct V_14 * V_17 ;
if ( ! V_51 || ! ( * V_51 ) ) {
...
struct V_14 * F_41 ( struct V_14 * V_39 , const char * V_1 )
{
...
struct V_14 * F_42 ( struct V_14 * V_39 , T_3 V_52 )
{
struct V_14 * V_17 , * V_14 ;
...
struct V_14 * F_43 ( struct V_14 * V_39 , const char * V_49 )
{
if ( F_3 ( V_49 , L_2 ) )
return V_39 ;
else if ( V_49 [ 0 ] == '/' )
return F_39 ( V_39 , V_49 ) ;
else
return F_41 ( V_39 , V_49 ) ;
}
...
if ( V_62 -> V_34 . V_32 < V_63 -> V_34 . V_32 )
return - 1 ;
else if ( V_62 -> V_34 . V_32 > V_63 -> V_34 . V_32 )
return 1 ;
else if ( V_62 -> V_34 . V_33 < V_63 -> V_34 . V_33 )
return - 1 ;
else if ( V_62 -> V_34 . V_33 > V_63 -> V_34 . V_33 )
return 1 ;
else
...
static void F_48 ( struct V_36 * V_41 )
{
...
static struct V_14 * F_57 ( struct V_14 * V_42 , char * V_7 )
{
struct V_14 * V_69 ;
V_69 = F_38 ( V_42 , V_7 ) ;
if ( ! V_69 )
...
static bool F_59 ( struct V_36 * V_41 , struct V_14 * V_14 )
{
struct V_14 * V_45 ;
if ( V_14 -> V_2 )
return true ;
...
static void F_60 ( struct V_36 * V_41 ,
struct V_14 * V_69 , struct V_14 * V_14 ,
bool V_70 )
{
struct V_14 * V_42 = V_41 -> V_42 ;
struct V_14 * V_45 ;
struct V_6 * V_12 ;
struct V_1 * V_25 ;
if ( V_14 -> V_2 ) {
...
F_11 (node, c)
F_60 ( V_41 , V_69 , V_45 , V_70 ) ;
}
static bool F_62 ( struct V_36 * V_41 , struct V_14 * V_14 )
{
struct V_14 * V_45 ;
struct V_6 * V_27 ;
struct V_46 * V_47 ;
...
static void F_63 ( struct V_36 * V_41 , struct V_14 * V_73 ,
struct V_14 * V_14 , struct V_6 * V_27 ,
struct V_46 * V_47 )
{
char * V_74 ;
...
static void F_65 ( struct V_36 * V_41 ,
struct V_14 * V_73 ,
struct V_14 * V_14 )
{
struct V_14 * V_42 = V_41 -> V_42 ;
...
V_47 = V_27 -> V_9 . V_48 ;
F_37 (m, REF_PHANDLE) {
V_77 = F_43 ( V_42 , V_47 -> V_49 ) ;
if ( ! V_77 )
F_63 ( V_41 , V_73 , V_14 , V_27 , V_47 ) ;
}
}
F_11 (node, c)
F_65 ( V_41 , V_73 , V_45 ) ;
}
static bool F_66 ( struct V_36 * V_41 , struct V_14 * V_14 )
{
struct V_14 * V_45 ;
struct V_6 * V_27 ;
struct V_46 * V_47 ;
...
static void F_67 ( struct V_36 * V_41 ,
...
static void F_69 ( struct V_36 * V_41 ,
struct V_14 * V_78 ,
struct V_14 * V_14 )
{
struct V_14 * V_42 = V_41 -> V_42 ;
...
V_77 = F_43 ( V_42 , V_47 -> V_49 ) ;
if ( V_77 )
F_67 ( V_41 , V_78 , V_14 , V_27 , V_47 , V_77 ) ;
}
}
F_11 (node, c)
F_69 ( V_41 , V_78 , V_45 ) ;
}
void F_70 ( struct V_36 * V_41 , char * V_7 , bool V_70 )
{
if ( ! F_59 ( V_41 , V_41 -> V_42 ) )
return;
F_60 ( V_41 , F_57 ( V_41 -> V_42 , V_7 ) ,
V_41 -> V_42 , V_70 ) ;
}
void F_71 ( struct V_36 * V_41 , char * V_7 )
{
if ( ! F_62 ( V_41 , V_41 -> V_42 ) )
return;
F_65 ( V_41 , F_57 ( V_41 -> V_42 , V_7 ) ,
V_41 -> V_42 ) ;
}
void F_72 ( struct V_36 * V_41 , char * V_7 )
{
if ( ! F_66 ( V_41 , V_41 -> V_42 ) )
return;
F_69 ( V_41 , F_57 ( V_41 -> V_42 , V_7 ) ,
V_41 -> V_42 ) ;
}
