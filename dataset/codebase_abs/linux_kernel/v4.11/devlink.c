...
if ( V_66 )
goto V_65;
V_66 = F_52 ( V_56 , V_152 , V_149 ) ;
if ( V_66 )
goto V_65;
}
if ( V_45 -> V_153 ) {
V_66 = V_45 -> V_153 ( V_2 , & V_150 ) ;
if ( V_66 )
goto V_65;
V_66 = F_71 ( V_56 , V_154 ,
V_150 ) ;
if ( V_66 )
goto V_65;
}
...
if ( ! V_45 -> V_156 )
return - V_109 ;
V_149 = F_24 ( V_16 -> V_5 [ V_152 ] ) ;
V_66 = V_45 -> V_156 ( V_2 , V_149 ) ;
if ( V_66 )
return V_66 ;
}
if ( V_16 -> V_5 [ V_154 ] ) {
...
V_150 = F_27 (
V_16 -> V_5 [ V_154 ] ) ;
V_66 = V_45 -> V_157 ( V_2 , V_150 ) ;
if ( V_66 )
return V_66 ;
}
return 0 ;
}
struct V_2 * F_94 ( const struct V_130 * V_45 , T_4 V_158 )
{
struct V_2 * V_2 ;
V_2 = F_95 ( sizeof( * V_2 ) + V_158 , V_70 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_45 = V_45 ;
F_3 ( V_2 , & V_159 ) ;
...
int F_97 ( struct V_2 * V_2 , struct V_162 * V_11 )
{
F_34 ( & V_48 ) ;
V_2 -> V_11 = V_11 ;
F_98 ( & V_2 -> V_163 , & V_164 ) ;
F_45 ( V_2 , V_67 ) ;
F_36 ( & V_48 ) ;
return 0 ;
}
