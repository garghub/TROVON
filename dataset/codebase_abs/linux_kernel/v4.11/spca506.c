...
switch ( V_1 -> V_31 . V_32 [ ( int ) V_1 -> V_35 ] . V_36 ) {
case 0 :
...
switch ( V_37 [ 0 ] ) {
case 0 :
F_18 ( V_1 , V_39 , NULL , 0 ) ;
V_37 += V_40 ;
V_38 -= V_40 ;
F_18 ( V_1 , V_41 , V_37 , V_38 ) ;
break;
case 0xff :
break;
default:
V_37 += 1 ;
V_38 -= 1 ;
F_18 ( V_1 , V_42 , V_37 , V_38 ) ;
break;
}
}
static void F_19 ( struct V_1 * V_1 , T_4 V_43 )
{
F_6 ( V_1 ) ;
F_7 ( V_1 , V_43 , V_44 ) ;
F_7 ( V_1 , 0x01 , 0x09 ) ;
}
static void F_20 ( struct V_1 * V_1 , T_4 V_43 )
{
F_6 ( V_1 ) ;
F_7 ( V_1 , V_43 , V_45 ) ;
F_7 ( V_1 , 0x01 , 0x09 ) ;
}
static void F_21 ( struct V_1 * V_1 , T_4 V_43 )
{
F_6 ( V_1 ) ;
F_7 ( V_1 , V_43 , V_46 ) ;
F_7 ( V_1 , 0x01 , 0x09 ) ;
}
static void F_22 ( struct V_1 * V_1 , T_4 V_43 )
{
F_6 ( V_1 ) ;
F_7 ( V_1 , V_43 , V_47 ) ;
F_7 ( V_1 , 0x01 , 0x09 ) ;
...
{
struct V_1 * V_1 =
F_24 ( V_49 -> V_50 , struct V_1 , V_51 ) ;
V_1 -> V_52 = 0 ;
if ( ! V_1 -> V_53 )
return 0 ;
switch ( V_49 -> V_30 ) {
...
static int F_29 ( struct V_62 * V_63 , const struct V_29 * V_30 )
{
return F_30 ( V_63 , V_30 , & V_64 , sizeof( struct V_19 ) ,
V_65 ) ;
}
