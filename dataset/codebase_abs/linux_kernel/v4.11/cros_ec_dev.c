...
T_5 V_95 = F_30 ( V_96 , V_91 -> V_61 ) ;
struct V_1 * V_2 = F_25 ( sizeof( * V_2 ) , V_11 ) ;
if ( ! V_2 )
return V_92 ;
F_31 ( V_31 , V_2 ) ;
V_2 -> V_19 = F_32 ( V_31 -> V_97 ) ;
V_2 -> V_31 = V_31 ;
V_2 -> V_16 = V_94 -> V_16 ;
V_2 -> V_29 [ 0 ] = - 1U ;
V_2 -> V_29 [ 1 ] = - 1U ;
F_33 ( & V_2 -> V_59 ) ;
F_34 ( & V_2 -> V_36 , & V_98 ) ;
V_2 -> V_36 . V_99 . V_97 = & V_2 -> V_59 . V_99 ;
V_92 = F_35 ( & V_2 -> V_36 , V_95 , 1 ) ;
if ( V_92 ) {
F_27 ( V_31 , L_22 ) ;
goto V_100;
}
V_2 -> V_59 . V_101 = V_2 -> V_36 . V_31 ;
V_2 -> V_59 . V_102 = & V_103 ;
V_2 -> V_59 . V_97 = V_31 ;
V_2 -> V_59 . V_104 = F_23 ;
V_92 = F_36 ( & V_2 -> V_59 , L_23 , V_94 -> V_105 ) ;
if ( V_92 ) {
F_27 ( V_31 , L_24 , V_92 ) ;
goto V_106;
}
...
V_10 = F_46 ( & V_112 ) ;
if ( V_10 < 0 ) {
F_47 ( V_109 L_28 , V_10 ) ;
goto V_113;
}
return 0 ;
V_113:
F_48 ( F_30 ( V_96 , 0 ) , V_110 ) ;
V_111:
F_49 ( & V_103 ) ;
return V_10 ;
}
