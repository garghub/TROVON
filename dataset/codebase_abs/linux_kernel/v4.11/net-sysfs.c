...
if ( ! F_36 ( & F_9 ( V_2 ) -> V_49 ) )
V_74 -> V_123 = 1 ;
if ( V_2 -> V_119 )
F_123 ( V_74 , V_2 -> V_119 ) ;
F_120 ( V_74 ) ;
}
return error ;
#else
...
{
struct V_124 * V_75 = F_125 ( V_7 ) ;
struct V_125 * V_78 = F_126 ( V_74 ) ;
if ( ! V_75 -> V_79 )
return - V_80 ;
return V_75 -> V_79 ( V_78 , V_75 , V_8 ) ;
}
...
static T_1 F_128 ( struct V_125 * V_78 ,
struct V_124 * V_75 ,
char * V_8 )
{
unsigned long V_126 ;
...
V_126 = V_78 -> V_126 ;
F_130 ( & V_78 -> V_127 ) ;
return sprintf ( V_8 , L_10 , V_126 ) ;
}
static unsigned int F_131 ( struct V_125 * V_78 )
{
struct V_1 * V_2 = V_78 -> V_2 ;
unsigned int V_85 ;
V_85 = V_78 - V_2 -> V_128 ;
F_132 ( V_85 >= V_2 -> V_129 ) ;
return V_85 ;
}
static T_1 F_133 ( struct V_125 * V_78 ,
struct V_124 * V_75 ,
char * V_8 )
{
struct V_1 * V_2 = V_78 -> V_2 ;
int V_114 = F_131 ( V_78 ) ;
int V_130 = F_134 ( V_2 , V_114 ) ;
if ( V_130 < 0 )
return - V_11 ;
return sprintf ( V_8 , L_11 , V_130 ) ;
}
static T_1 F_135 ( struct V_125 * V_78 ,
struct V_124 * V_75 ,
char * V_8 )
{
return sprintf ( V_8 , L_8 , V_78 -> V_131 ) ;
}
static T_1 F_136 ( struct V_125 * V_78 ,
struct V_124 * V_75 ,
const char * V_8 , T_2 V_13 )
{
struct V_1 * V_2 = V_78 -> V_2 ;
...
V_20 = - V_133 ;
if ( V_2 -> V_134 -> V_135 )
V_20 = V_2 -> V_134 -> V_135 ( V_2 , V_114 , V_132 ) ;
F_14 () ;
if ( ! V_20 ) {
V_78 -> V_131 = V_132 ;
return V_13 ;
...
static T_1 F_138 ( char * V_8 , unsigned int V_136 )
{
return sprintf ( V_8 , L_11 , V_136 ) ;
}
static T_1 F_139 ( const char * V_8 , const T_2 V_49 ,
unsigned int * V_137 )
{
unsigned int V_136 ;
int V_20 ;
...
static T_1 F_141 ( struct V_125 * V_78 ,
struct V_124 * V_7 ,
char * V_8 )
{
struct V_139 * V_139 = & V_78 -> V_139 ;
return sprintf ( V_8 , L_11 , F_142 ( V_139 -> V_140 ) ) ;
}
static T_1 F_143 ( struct V_125 * V_78 ,
struct V_124 * V_75 ,
const char * V_8 , T_2 V_13 )
{
struct V_139 * V_139 = & V_78 -> V_139 ;
...
if ( V_20 < 0 )
return V_20 ;
V_139 -> V_140 = F_144 ( V_136 ) ;
return V_13 ;
}
static T_1 F_145 ( struct V_125 * V_78 ,
struct V_124 * V_7 ,
char * V_8 )
{
struct V_139 * V_139 = & V_78 -> V_139 ;
return sprintf ( V_8 , L_11 , V_139 -> V_141 - V_139 -> V_142 ) ;
}
static T_1 F_146 ( struct V_125 * V_78 ,
struct V_124 * V_75 , char * V_8 )
{
struct V_1 * V_2 = V_78 -> V_2 ;
int V_91 , V_13 , V_143 = 1 , V_130 = 0 ;
struct V_144 * V_145 ;
T_3 V_84 ;
unsigned long V_114 ;
if ( ! F_74 ( & V_84 , V_86 ) )
...
if ( V_2 -> V_143 ) {
V_143 = V_2 -> V_143 ;
V_130 = F_134 ( V_2 , V_114 ) ;
if ( V_130 < 0 )
return - V_11 ;
}
F_75 () ;
V_145 = F_76 ( V_2 -> V_146 ) ;
if ( V_145 ) {
F_147 (cpu) {
int V_85 , V_147 = V_91 * V_143 + V_130 ;
struct V_148 * V_83 ;
V_83 = F_76 ( V_145 -> V_149 [ V_147 ] ) ;
if ( ! V_83 )
continue;
for ( V_85 = V_83 -> V_13 ; V_85 -- ; ) {
if ( V_83 -> V_150 [ V_85 ] == V_114 ) {
F_77 ( V_91 , V_84 ) ;
break;
}
}
...
static T_1 F_148 ( struct V_125 * V_78 ,
struct V_124 * V_75 ,
const char * V_8 , T_2 V_13 )
{
struct V_1 * V_2 = V_78 -> V_2 ;
...
static const void * F_151 ( struct V_73 * V_74 )
{
struct V_125 * V_78 = F_126 ( V_74 ) ;
struct V_5 * V_2 = & V_78 -> V_2 -> V_2 ;
const void * V_110 = NULL ;
...
static int F_152 ( struct V_1 * V_2 , int V_114 )
{
struct V_125 * V_78 = V_2 -> V_128 + V_114 ;
struct V_73 * V_74 = & V_78 -> V_74 ;
int error = 0 ;
V_74 -> V_116 = V_2 -> V_117 ;
error = F_116 ( V_74 , & V_151 , NULL ,
L_14 , V_114 ) ;
if ( error )
goto exit;
#ifdef F_153
error = F_117 ( V_74 , & V_152 ) ;
if ( error )
goto exit;
#endif
F_118 ( V_74 , V_120 ) ;
...
int
F_154 ( struct V_1 * V_2 , int V_121 , int V_122 )
{
#ifdef F_122
int V_85 ;
int error = 0 ;
for ( V_85 = V_121 ; V_85 < V_122 ; V_85 ++ ) {
error = F_152 ( V_2 , V_85 ) ;
if ( error ) {
V_122 = V_121 ;
break;
}
...
while ( -- V_85 >= V_122 ) {
struct V_125 * V_78 = V_2 -> V_128 + V_85 ;
if ( ! F_36 ( & F_9 ( V_2 ) -> V_49 ) )
V_78 -> V_74 . V_123 = 1 ;
#ifdef F_153
F_123 ( & V_78 -> V_74 , & V_152 ) ;
#endif
F_120 ( & V_78 -> V_74 ) ;
}
return error ;
...
{
int error = 0 , V_153 = 0 , V_154 = 0 , V_155 = 0 , V_156 = 0 ;
#ifdef F_122
V_2 -> V_117 = F_156 ( L_15 ,
NULL , & V_2 -> V_2 . V_74 ) ;
if ( ! V_2 -> V_117 )
return - V_87 ;
V_155 = V_2 -> V_157 ;
#endif
V_156 = V_2 -> V_158 ;
error = F_121 ( V_2 , 0 , V_155 ) ;
if ( error )
goto error;
V_154 = V_155 ;
error = F_154 ( V_2 , 0 , V_156 ) ;
if ( error )
goto error;
V_153 = V_156 ;
return 0 ;
...
{
struct V_15 * V_15 = V_159 -> V_160 -> V_161 ;
return F_10 ( V_15 -> V_17 , V_162 ) ;
}
static void * F_160 ( void )
{
struct V_15 * V_110 = V_159 -> V_160 -> V_161 ;
#ifdef F_161
if ( V_110 )
F_162 ( & V_110 -> V_163 ) ;
#endif
...
static const void * F_164 ( struct V_165 * V_166 )
{
return F_165 ( V_166 ) ;
}
static int F_166 ( struct V_5 * V_65 , struct V_167 * V_168 )
{
struct V_1 * V_2 = F_4 ( V_65 ) ;
int V_169 ;
V_169 = F_167 ( V_168 , L_16 , V_2 -> V_57 ) ;
if ( V_169 )
goto exit;
V_169 = F_167 ( V_168 , L_17 , V_2 -> V_170 ) ;
exit:
return V_169 ;
}
static void F_168 ( struct V_5 * V_65 )
{
struct V_1 * V_2 = F_4 ( V_65 ) ;
F_132 ( V_2 -> V_3 != V_171 ) ;
F_89 ( V_2 -> V_50 ) ;
...
static const void * F_170 ( struct V_5 * V_65 )
{
struct V_1 * V_2 = F_4 ( V_65 ) ;
return F_9 ( V_2 ) ;
}
static int F_171 ( struct V_5 * V_2 , const void * V_172 )
{
int V_10 = 0 ;
if ( V_2 -> V_173 )
V_10 = V_2 -> V_173 -> V_174 == V_172 ;
return V_10 == 0 ? V_2 -> V_174 == V_172 : V_10 ;
}
struct V_1 * F_172 ( struct V_175 * V_176 )
{
struct V_5 * V_2 ;
V_2 = F_173 ( & V_177 , NULL , V_176 , F_171 ) ;
if ( ! V_2 )
return NULL ;
return F_4 ( V_2 ) ;
}
...
{
struct V_5 * V_2 = & ( V_9 -> V_2 ) ;
const struct V_178 * * V_179 = V_9 -> V_180 ;
int error = 0 ;
F_180 ( V_2 ) ;
V_2 -> V_111 = & V_177 ;
V_2 -> V_181 = V_9 ;
V_2 -> V_179 = V_179 ;
F_181 ( V_2 , L_18 , V_9 -> V_57 ) ;
#ifdef F_122
if ( * V_179 )
V_179 ++ ;
* V_179 ++ = & V_182 ;
#if F_182 ( V_183 ) || F_182 ( V_184 )
if ( V_9 -> V_185 )
* V_179 ++ = & V_186 ;
#if F_182 ( V_183 )
else if ( V_9 -> V_187 )
...
int F_184 ( struct V_188 * V_189 ,
const void * V_110 )
{
return F_185 ( & V_177 , V_189 , V_110 ) ;
}
void F_186 ( struct V_188 * V_189 ,
const void * V_110 )
{
F_187 ( & V_177 , V_189 , V_110 ) ;
}
int T_4 F_188 ( void )
{
F_189 ( & V_190 ) ;
