...
struct V_43 * V_91 )
{
memcpy ( V_91 , V_36 -> V_7 . V_68 + V_68 , sizeof( * V_91 ) ) ;
return 0 ;
}
...
{
V_36 -> V_55 = true ;
memcpy ( V_36 -> V_7 . V_68 + V_68 , V_91 , sizeof( * V_91 ) ) ;
return 0 ;
}
...
if ( V_57 )
return V_57 ;
memcpy ( & V_36 -> V_7 , F_2 ( V_93 ) , sizeof( V_36 -> V_7 ) ) ;
F_28 ( V_36 -> V_38 , V_93 ) ;
return 0 ;
}
...
int V_57 , V_44 ;
struct V_3 * V_4 ;
V_57 = F_39 ( V_36 -> V_38 , V_36 -> V_53 , & V_92 , & V_4 , & V_44 ) ;
if ( V_57 )
return V_57 ;
...
int V_57 ;
struct V_99 V_100 ;
if ( V_98 < sizeof( struct V_99 ) ) {
F_24 ( L_10 ) ;
return - V_101 ;
}
memcpy ( & V_100 , V_97 , sizeof( V_100 ) ) ;
V_57 = F_21 ( V_36 , V_38 ) ;
if ( V_57 < 0 )
return V_57 ;
V_36 -> V_71 = F_52 ;
...
V_36 -> V_62 = F_56 ;
V_36 -> V_90 = F_57 ;
V_36 -> V_52 = F_8 ( V_100 . V_52 ) ;
V_36 -> V_87 = F_8 ( V_100 . V_87 ) ;
V_36 -> V_53 = F_8 ( V_100 . V_53 ) ;
V_36 -> V_54 = F_8 ( V_100 . V_54 ) ;
return V_36 -> V_96 ( V_36 ) ;
}
static int F_61 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_91 )
{
return F_33 ( & V_36 -> V_39 , V_36 -> V_53 , & V_68 , V_91 ) ;
}
