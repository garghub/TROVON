...
V_71 = F_39 ( V_69 , V_2 -> V_37 ) ;
if ( F_40 ( V_68 , V_2 -> V_11 , V_71 ) ) {
V_17 = - V_79 ;
goto V_30;
}
F_31 ( & V_2 -> V_50 ) ;
...
static T_4 F_41 ( struct V_15 * V_15 , const char T_5 * V_68 , T_6 V_69 , T_3 * V_70 )
{
struct V_8 * V_2 ;
T_6 V_80 ;
int V_17 = 0 ;
...
V_17 = F_42 ( V_2 -> V_48 , ! V_2 -> V_47 ) ;
if ( V_17 ) {
goto V_30;
}
}
V_80 = F_43 ( int , V_69 , V_81 ) ;
F_5 ( & V_2 -> V_31 -> V_2 , L_10 ,
V_46 , V_69 , V_80 ) ;
if ( F_44 ( V_2 -> V_13 , V_68 , V_80 ) ) {
V_17 = - V_79 ;
goto V_30;
}
F_22 ( V_2 -> V_10 ,
V_2 -> V_31 ,
F_45 ( V_2 -> V_31 , V_2 -> V_82 -> V_39 ) ,
V_2 -> V_13 ,
V_80 ,
V_83 ,
V_2 ,
...
static int F_51 ( struct V_18 * V_19 , const struct V_95 * V_96 )
{
struct V_1 * V_97 = & V_19 -> V_2 ;
struct V_98 * V_31 = F_52 ( V_19 ) ;
struct V_8 * V_2 = NULL ;
struct V_99 * V_100 ;
struct V_101 * V_102 ;
struct V_103 V_104 ;
...
int V_17 = - V_105 ;
int V_22 ;
V_2 = F_53 ( sizeof( struct V_8 ) , V_4 ) ;
if ( ! V_2 )
goto exit;
F_54 ( & V_2 -> V_26 ) ;
V_2 -> V_31 = V_31 ;
...
V_2 -> V_11 = F_53 ( V_55 , V_4 ) ;
if ( ! V_2 -> V_11 )
goto error;
V_2 -> V_12 = F_53 ( F_24 ( V_2 -> V_38 ) , V_4 ) ;
if ( ! V_2 -> V_12 )
goto error;
V_2 -> V_9 = F_59 ( 0 , V_4 ) ;
if ( ! V_2 -> V_9 )
goto error;
V_2 -> V_13 = F_53 ( V_81 , V_4 ) ;
if ( ! V_2 -> V_13 )
goto error;
V_2 -> V_10 = F_59 ( 0 , V_4 ) ;
if ( ! V_2 -> V_10 )
...
F_61 ( V_104 . V_113 ) ) ;
F_62 ( V_19 , V_2 ) ;
V_17 = F_63 ( V_19 , & V_114 ) ;
if ( V_17 ) {
F_21 ( V_97 , L_22 ) ;
F_62 ( V_19 , NULL ) ;
goto error;
}
V_2 -> V_112 = V_19 -> V_112 ;
F_60 ( & V_19 -> V_2 , L_23
L_24 , ( V_2 -> V_112 - V_115 ) ,
V_116 , V_2 -> V_112 ) ;
exit:
return V_17 ;
error:
