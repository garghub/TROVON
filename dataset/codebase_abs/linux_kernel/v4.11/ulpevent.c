...
V_2 = F_4 ( V_9 ) ;
F_1 ( V_2 , V_12 , V_9 -> V_11 ) ;
V_54 = (struct V_53 * ) F_16 ( V_9 , sizeof( * V_54 ) ) ;
...
return NULL ;
V_9 = F_8 ( V_2 ) ;
V_146 = (struct V_145 * ) F_19 ( V_9 , V_28 ) ;
V_146 -> V_148 = V_149 ;
V_146 -> V_150 = V_21 ;
V_146 -> V_151 = V_28 ;
F_6 ( V_2 , V_14 ) ;
...
T_1 F_46 ( const struct V_1 * V_2 )
{
union V_154 * V_155 ;
struct V_8 * V_9 ;
V_9 = F_8 ( V_2 ) ;
V_155 = (union V_154 * ) V_9 -> V_58 ;
return V_155 -> V_156 . V_157 ;
}
...
V_74 . V_159 = V_2 -> V_110 ;
V_74 . V_160 = V_2 -> V_111 ;
V_74 . V_161 = V_2 -> V_112 ;
V_74 . V_76 = V_2 -> V_21 ;
V_74 . V_162 = V_2 -> V_106 ;
V_74 . V_163 = V_2 -> V_115 ;
V_74 . V_164 = F_20 ( V_2 -> V_14 ) ;
V_74 . V_165 = V_2 -> V_14 -> V_166 ;
V_74 . V_167 = 0 ;
F_48 ( V_158 , V_168 , V_169 ,
sizeof( V_74 ) , & V_74 ) ;
}
...
V_171 . V_172 = V_2 -> V_110 ;
V_171 . V_173 = V_2 -> V_111 ;
V_171 . V_174 = V_2 -> V_112 ;
V_171 . V_175 = V_2 -> V_21 ;
V_171 . V_176 = V_2 -> V_106 ;
V_171 . V_177 = V_2 -> V_115 ;
V_171 . V_178 = F_20 ( V_2 -> V_14 ) ;
V_171 . V_179 = V_2 -> V_14 -> V_166 ;
F_48 ( V_158 , V_168 , V_180 ,
sizeof( V_171 ) , & V_171 ) ;
}
...
V_182 . V_183 = V_2 -> V_110 ;
V_182 . V_184 = V_2 -> V_112 ;
V_182 . V_185 = V_2 -> V_21 ;
if ( F_5 ( V_2 ) )
V_182 . V_185 |= V_186 ;
V_182 . V_187 = V_9 -> V_4 ;
V_182 . V_188 = F_20 ( V_2 -> V_14 ) ;
F_48 ( V_158 , V_168 , V_189 ,
sizeof( V_182 ) , & V_182 ) ;
}
...
unsigned int F_60 ( struct V_196 * V_197 )
{
struct V_8 * V_9 ;
unsigned int V_198 = 0 ;
while ( ( V_9 = F_61 ( V_197 ) ) != NULL ) {
