...
static int F_10 ( struct V_5 * V_5 , unsigned V_3 ,
unsigned V_17 )
{
int V_18 = V_10 + V_3 ;
int V_12 , V_19 ;
...
static void F_14 ( struct V_29 * V_30 , struct V_1 * V_2 )
{
struct V_4 * V_4 = F_2 ( V_2 ) ;
struct V_5 * V_5 = V_4 -> V_5 ;
int V_31 , V_32 ;
...
{
struct V_5 * V_5 = F_20 ( V_47 -> V_39 . V_48 ) ;
struct V_49 * V_50 = F_21 ( V_5 -> V_39 ) ;
struct V_4 * V_4 ;
int V_12 ;
V_4 = F_22 ( & V_47 -> V_39 , sizeof( * V_4 ) ,
V_51 ) ;
if ( V_4 == NULL )
return - V_52 ;
V_4 -> V_5 = V_5 ;
...
V_4 -> V_1 . V_35 = - 1 ;
V_12 = F_23 ( & V_47 -> V_39 , & V_4 -> V_1 ,
V_4 ) ;
if ( V_12 < 0 ) {
F_17 ( & V_47 -> V_39 , L_24 , V_12 ) ;
return V_12 ;
}
F_24 ( V_47 , V_4 ) ;
return V_12 ;
