...
V_18 = F_16 ( V_15 -> V_20 ) ;
if ( F_17 ( V_15 ) == V_21 )
return V_13 -> V_22 ( V_3 ) ;
if ( F_14 ( V_15 ) + F_18 ( V_15 ) >
F_19 ( V_15 -> V_23 ) )
return - V_24 ;
switch ( F_17 ( V_15 ) ) {
case V_25 :
return V_13 -> V_26 ( V_3 , V_16 , V_17 ) ;
case V_27 :
for (; V_17 > 0 ; V_17 -- , V_16 ++ , V_18 += V_13 -> V_28 )
if ( V_13 -> V_29 ( V_3 , V_16 , V_18 ) )
return - V_24 ;
F_20 ( V_15 ) ;
return 0 ;
case V_30 :
...
{
struct V_2 * V_3 =
F_2 ( V_34 , struct V_2 , V_34 ) ;
struct V_12 * V_13 = V_3 -> V_13 ;
struct V_35 * V_7 = V_3 -> V_7 ;
...
static void F_27 ( struct V_35 * V_7 )
{
struct V_2 * V_3 ;
struct V_14 * V_15 = NULL ;
V_3 = V_7 -> V_41 ;
...
F_29 ( V_3 -> V_43 , & V_3 -> V_34 ) ;
}
static int F_30 ( struct V_44 * V_45 , T_1 V_46 )
{
...
static void F_34 ( struct V_9 * V_5 , T_1 V_46 )
{
...
static int F_37 ( struct V_44 * V_45 , T_1 V_46 ,
...
F_46 ( V_69 , ( ( V_86 ) V_66 -> V_87 * V_13 -> V_28 ) >> 9 ) ;
F_47 ( & V_66 -> V_37 ) ;
V_66 -> V_7 = F_48 ( F_27 , & V_66 -> V_37 ) ;
if ( ! V_66 -> V_7 )
goto V_88;
if ( V_13 -> V_22 )
F_49 ( V_66 -> V_7 , true , false ) ;
V_66 -> V_7 -> V_41 = V_66 ;
F_50 ( V_66 -> V_7 , V_13 -> V_28 ) ;
F_51 ( V_89 , V_66 -> V_7 ) ;
F_52 ( V_90 , V_66 -> V_7 ) ;
if ( V_13 -> V_26 ) {
F_51 ( V_91 , V_66 -> V_7 ) ;
...
V_69 -> V_93 = V_66 -> V_7 ;
V_66 -> V_43 = F_54 ( L_3 , 0 , 0 ,
V_13 -> V_85 , V_66 -> V_53 -> V_94 ) ;
if ( ! V_66 -> V_43 )
goto V_95;
F_55 ( & V_66 -> V_34 , F_22 ) ;
if ( V_66 -> V_77 )
F_56 ( V_69 , 1 ) ;
F_57 ( & V_66 -> V_53 -> V_3 , V_69 ) ;
if ( V_66 -> V_96 ) {
V_48 = F_58 ( & F_59 ( V_69 ) -> V_97 ,
V_66 -> V_96 ) ;
F_60 ( V_48 ) ;
}
return 0 ;
...
static void F_68 ( struct V_100 * V_53 )
{
struct V_12 * V_13 ;
...
static void F_70 ( struct V_100 * V_53 )
{
struct V_12 * V_13 ;
if ( V_53 -> type == V_103 )
return;
F_41 (tr, &blktrans_majors, list)
V_13 -> V_104 ( V_13 , V_53 ) ;
}
