...
static int F_28 ( struct V_1 * V_1 , struct V_2 * V_3 , struct V_4 * V_5 )
{
int V_14 ;
V_14 = F_29 ( V_3 , V_5 ) ;
if ( V_14 ) {
...
if ( ( V_5 -> V_32 > F_30 ( V_5 ) && ! F_31 ( V_5 ) ) ||
F_32 ( F_2 ( V_5 ) ) ||
( F_9 ( V_5 ) -> V_41 && V_5 -> V_32 > F_9 ( V_5 ) -> V_41 ) )
return F_33 ( V_1 , V_3 , V_5 , F_1 ) ;
else
return F_1 ( V_1 , V_3 , V_5 ) ;
}
int F_34 ( struct V_1 * V_1 , struct V_2 * V_3 , struct V_4 * V_5 )
{
...
V_5 -> V_47 = V_47 ;
V_60 = F_51 ( V_7 ) ;
if ( ( V_5 -> V_32 <= V_60 ) || V_5 -> V_72 || F_31 ( V_5 ) ) {
...
F_82 ( & V_38 , V_1 , & V_55 -> V_17 , V_5 -> V_9 , 0 ) ) {
int V_117 = F_58 ( V_5 ) ;
if ( V_117 > 0 )
return F_83 ( V_5 ) ;
else if ( V_117 < 0 ) {
...
V_119 = & V_55 -> V_17 ;
V_121 = F_86 ( V_1 -> V_103 . V_126 , & V_55 -> V_17 , 1 ) ;
if ( F_87 ( V_121 , 1 * V_127 ) )
F_88 ( V_5 , V_119 ) ;
if ( V_121 )
F_89 ( V_121 ) ;
} else {
int V_128 = F_63 ( & V_55 -> V_23 ) ;
if ( V_128 == V_129 ||
V_128 & ( V_130 | V_131 ) )
goto error;
if ( V_128 & V_98 ) {
...
V_55 = F_5 ( V_5 ) ;
V_55 -> V_29 -- ;
F_78 ( V_1 , F_6 ( V_7 ) , V_137 ) ;
F_91 ( V_1 , F_6 ( V_7 ) , V_138 , V_5 -> V_32 ) ;
return F_12 ( V_26 , V_139 ,
V_1 , NULL , V_5 , V_5 -> V_9 , V_7 -> V_9 ,
F_65 ) ;
error:
F_78 ( V_1 , F_6 ( V_7 ) , V_140 ) ;
V_108:
F_14 ( V_5 ) ;
return - V_40 ;
}
...
V_87 = 0 ;
* V_155 = V_168 ;
V_145 = F_110 ( F_62 ( V_5 ) , V_148 , V_25 ) ;
if ( ! V_145 ) {
F_13 ( V_1 , F_6 ( F_2 ( V_5 ) ) ,
V_77 ) ;
V_154 = - V_169 ;
...
F_112 ( V_5 ) ;
F_113 ( V_5 , V_148 ) ;
V_147 = (struct V_146 * ) F_114 ( V_5 , sizeof( struct V_146 ) ) ;
F_114 ( V_5 , V_148 ) ;
F_47 ( V_5 ) ;
...
V_144 -> V_158 = V_175 ;
F_117 ( V_144 ) ;
V_147 = (struct V_146 * ) F_114 ( V_144 , sizeof( struct V_146 ) ) ;
F_114 ( V_144 , V_148 ) ;
F_47 ( V_144 ) ;
...
V_144 = F_121 ( V_32 + V_148 + sizeof( struct V_146 ) +
V_150 + V_151 , V_25 ) ;
if ( ! V_144 ) {
F_13 ( V_1 , F_6 ( F_2 ( V_5 ) ) ,
V_77 ) ;
...
F_92 ( V_144 , V_5 ) ;
F_122 ( V_144 , V_150 ) ;
F_123 ( V_144 , V_32 + V_148 + sizeof( struct V_146 ) ) ;
F_47 ( V_144 ) ;
...
V_147 -> V_171 = 0 ;
V_147 -> V_173 = V_152 ;
F_109 ( F_125 ( V_5 , V_153 , F_126 ( V_144 ) ,
V_32 ) ) ;
V_149 -= V_32 ;
V_147 -> V_86 = F_3 ( V_87 ) ;
if ( V_149 > 0 )
...
static inline int F_128 ( const struct V_183 * V_184 ,
const struct V_12 * V_185 ,
const struct V_12 * V_186 )
{
return ( V_184 -> V_187 != 128 || ! F_129 ( V_185 , & V_184 -> V_188 ) ) &&
( ! V_186 || ! F_129 ( V_185 , V_186 ) ) ;
}
static struct V_6 * F_130 ( struct V_2 * V_3 ,
struct V_6 * V_7 ,
...
V_122 = (struct V_37 * ) V_7 ;
if ( F_128 ( & V_122 -> V_193 , & V_46 -> V_17 , V_52 -> V_194 ) ||
#ifdef F_132
F_128 ( & V_122 -> V_195 , & V_46 -> V_23 , V_52 -> V_196 ) ||
#endif
( ! ( V_46 -> V_197 & V_198 ) &&
...
static int F_133 ( struct V_1 * V_1 , const struct V_2 * V_3 ,
...
int V_154 ;
int V_20 = 0 ;
if ( F_135 ( & V_46 -> V_23 ) && ( ! * V_7 || ! ( * V_7 ) -> error ) ) {
struct V_37 * V_122 ;
bool V_201 = * V_7 != NULL ;
if ( ! V_201 )
* V_7 = F_136 ( V_1 , V_3 , V_46 ) ;
V_122 = ( * V_7 ) -> error ? NULL : (struct V_37 * ) * V_7 ;
V_154 = F_137 ( V_1 , V_122 , & V_46 -> V_17 ,
...
V_122 = (struct V_37 * ) * V_7 ;
F_19 () ;
V_200 = F_21 ( V_122 -> V_7 . V_9 ,
F_20 ( V_122 , & V_46 -> V_17 ) ) ;
V_154 = V_200 && ! ( V_200 -> V_205 & V_206 ) ? - V_40 : 0 ;
F_27 () ;
if ( V_154 ) {
struct V_207 * V_208 ;
struct V_45 V_209 ;
int V_210 ;
V_208 = F_139 ( V_1 , & V_46 -> V_23 ,
( * V_7 ) -> V_9 , 1 ) ;
...
#endif
if ( F_141 ( & V_46 -> V_23 ) &&
! ( F_141 ( & V_46 -> V_17 ) || F_135 ( & V_46 -> V_17 ) ) ) {
V_154 = - V_212 ;
goto V_203;
}
return 0 ;
...
int F_142 ( struct V_1 * V_1 , struct V_2 * V_3 , struct V_6 * * V_7 ,
struct V_45 * V_46 )
{
* V_7 = NULL ;
return F_133 ( V_1 , V_3 , V_7 , V_46 ) ;
}
struct V_6 * F_143 ( const struct V_2 * V_3 , struct V_45 * V_46 ,
const struct V_12 * V_214 )
{
struct V_6 * V_7 = NULL ;
int V_154 ;
V_154 = F_133 ( F_37 ( V_3 ) , V_3 , & V_7 , V_46 ) ;
if ( V_154 )
return F_144 ( V_154 ) ;
if ( V_214 )
V_46 -> V_17 = * V_214 ;
return F_145 ( F_37 ( V_3 ) , V_7 , F_146 ( V_46 ) , V_3 , 0 ) ;
}
struct V_6 * F_147 ( struct V_2 * V_3 , struct V_45 * V_46 ,
const struct V_12 * V_214 )
{
struct V_6 * V_7 = F_148 ( V_3 , F_38 ( V_3 ) -> V_215 ) ;
V_7 = F_130 ( V_3 , V_7 , V_46 ) ;
if ( ! V_7 )
V_7 = F_143 ( V_3 , V_46 , V_214 ) ;
return V_7 ;
}
static inline int F_149 ( struct V_2 * V_3 ,
struct V_216 * V_217 ,
int F_150 ( void * V_142 , char * V_141 , int V_87 , int V_32 ,
...
& V_46 -> V_23 ) ;
V_227:
return F_156 ( V_3 , V_5 , F_150 , V_142 ,
( V_219 - V_223 ) ) ;
}
static inline struct V_232 * F_157 ( struct V_232 * V_233 ,
T_6 V_234 )
{
return V_233 ? F_110 ( V_233 , ( V_233 -> V_235 + 1 ) * 8 , V_234 ) : NULL ;
}
static inline struct V_236 * F_158 ( struct V_236 * V_233 ,
T_6 V_234 )
{
return V_233 ? F_110 ( V_233 , ( V_233 -> V_235 + 1 ) * 8 , V_234 ) : NULL ;
}
static void F_159 ( unsigned int * V_60 ,
int * V_237 ,
unsigned int V_221 ,
struct V_4 * V_5 ,
struct V_37 * V_122 ,
...
static int F_160 ( struct V_2 * V_3 , struct V_241 * V_242 ,
...
if ( F_161 ( V_244 -> V_49 ) )
return - V_40 ;
V_244 -> V_49 = F_162 ( V_49 -> V_247 , V_3 -> V_248 ) ;
if ( F_22 ( ! V_244 -> V_49 ) )
return - V_65 ;
V_244 -> V_49 -> V_247 = V_49 -> V_247 ;
V_244 -> V_49 -> V_63 = V_49 -> V_63 ;
V_244 -> V_49 -> V_62 = V_49 -> V_62 ;
V_244 -> V_49 -> V_249 = F_157 ( V_49 -> V_249 ,
V_3 -> V_248 ) ;
if ( V_49 -> V_249 && ! V_244 -> V_49 -> V_249 )
return - V_65 ;
V_244 -> V_49 -> V_250 = F_157 ( V_49 -> V_250 ,
V_3 -> V_248 ) ;
if ( V_49 -> V_250 && ! V_244 -> V_49 -> V_250 )
return - V_65 ;
V_244 -> V_49 -> V_251 = F_157 ( V_49 -> V_251 ,
V_3 -> V_248 ) ;
if ( V_49 -> V_251 && ! V_244 -> V_49 -> V_251 )
return - V_65 ;
V_244 -> V_49 -> V_118 = F_158 ( V_49 -> V_118 ,
V_3 -> V_248 ) ;
...
if ( F_32 ( V_122 -> V_7 . V_258 ) )
V_242 -> V_252 . V_20 |= V_260 ;
V_242 -> V_252 . V_219 = 0 ;
return 0 ;
}
...
struct V_243 * V_244 ,
struct V_262 * V_263 ,
int F_150 ( void * V_142 , char * V_141 , int V_87 ,
int V_32 , int V_218 , struct V_4 * V_5 ) ,
void * V_142 , int V_219 , int V_223 ,
unsigned int V_20 , struct V_245 * V_246 ,
...
T_7 V_269 = 0 ;
T_3 V_270 = 0 ;
struct V_37 * V_122 = (struct V_37 * ) V_242 -> V_7 ;
...
V_154 = F_149 ( V_3 , V_217 , F_150 , V_142 , V_219 ,
V_220 , V_221 , V_222 ,
V_223 , V_60 , V_20 , V_46 ) ;
if ( V_154 )
goto error;
return 0 ;
}
...
goto V_294;
while ( V_219 > 0 ) {
V_268 = ( V_242 -> V_219 <= V_60 && ! ( V_242 -> V_20 & V_260 ) ? V_60 : V_237 ) - V_5 -> V_32 ;
if ( V_268 < V_219 )
V_268 = V_237 - V_5 -> V_32 ;
if ( V_268 <= 0 ) {
char * V_91 ;
unsigned int V_295 ;
unsigned int V_296 ;
...
V_266 = V_5 ;
V_295 = V_219 + V_297 ;
if ( V_295 > ( V_242 -> V_219 <= V_60 && ! ( V_242 -> V_20 & V_260 ) ? V_60 : V_237 ) - V_221 )
...
V_5 -> V_158 = V_271 ;
V_5 -> V_225 = 0 ;
F_122 ( V_5 , V_220 + sizeof( struct V_146 ) +
V_267 ) ;
F_111 ( V_5 ) -> V_269 = V_269 ;
V_269 = 0 ;
F_111 ( V_5 ) -> V_270 = V_270 ;
V_270 = 0 ;
V_91 = F_123 ( V_5 , V_296 ) ;
F_153 ( V_5 , V_222 ) ;
V_91 += V_221 ;
V_5 -> V_180 = ( V_5 -> V_181 +
V_221 ) ;
...
F_14 ( V_5 ) ;
goto error;
} else if ( V_268 > 0 && F_150 ( V_142 , V_91 + V_223 , V_87 , V_268 , V_297 , V_5 ) < 0 ) {
V_154 = - V_303 ;
F_14 ( V_5 ) ;
goto error;
}
...
unsigned int V_304 ;
V_304 = V_5 -> V_32 ;
if ( F_150 ( V_142 , F_123 ( V_5 , V_268 ) ,
...
error:
V_242 -> V_219 -= V_219 ;
F_13 ( F_37 ( V_3 ) , V_122 -> V_312 , V_30 ) ;
return V_154 ;
}
...
return 0 ;
if ( F_185 ( & V_3 -> V_316 ) ) {
V_154 = F_160 ( V_3 , & V_314 -> V_242 , & V_52 -> V_242 ,
V_246 , V_122 , V_46 ) ;
if ( V_154 )
return V_154 ;
...
return F_163 ( V_3 , V_46 , & V_3 -> V_316 , & V_314 -> V_242 . V_252 ,
& V_52 -> V_242 , F_186 ( V_3 ) , F_150 ,
V_142 , V_219 , V_223 , V_20 , V_246 , V_265 ) ;
}
static void F_187 ( struct V_241 * V_242 ,
struct V_243 * V_244 )
{
if ( V_244 -> V_49 ) {
F_118 ( V_244 -> V_49 -> V_249 ) ;
F_118 ( V_244 -> V_49 -> V_250 ) ;
F_118 ( V_244 -> V_49 -> V_251 ) ;
F_118 ( V_244 -> V_49 -> V_118 ) ;
F_118 ( V_244 -> V_49 ) ;
V_244 -> V_49 = NULL ;
}
if ( V_242 -> V_252 . V_7 ) {
F_131 ( V_242 -> V_252 . V_7 ) ;
...
struct V_54 * V_55 ;
struct V_48 * V_49 = V_244 -> V_49 ;
struct V_37 * V_122 = (struct V_37 * ) V_242 -> V_252 . V_7 ;
...
F_44 ( V_5 , V_49 , & V_56 ) ;
if ( V_49 && V_49 -> V_62 )
F_45 ( V_5 , V_49 , & V_56 , & V_214 , & V_46 -> V_23 ) ;
F_46 ( V_5 , sizeof( struct V_54 ) ) ;
F_47 ( V_5 ) ;
V_55 = F_5 ( V_5 ) ;
...
F_15 ( V_1 , V_122 -> V_312 , V_73 , V_5 -> V_32 ) ;
if ( V_56 == V_88 ) {
struct V_18 * V_19 = F_6 ( F_2 ( V_5 ) ) ;
F_192 ( V_1 , V_19 , F_193 ( V_5 ) -> V_92 ) ;
F_194 ( V_1 , V_19 , V_321 ) ;
}
F_187 ( V_242 , V_244 ) ;
V_189:
return V_5 ;
...
V_244 . V_49 = NULL ;
V_154 = F_160 ( V_3 , & V_242 , & V_244 , V_246 , V_122 , V_46 ) ;
if ( V_154 )
return F_144 ( V_154 ) ;
if ( V_246 -> V_275 < 0 )
V_246 -> V_275 = F_38 ( V_3 ) -> V_275 ;
V_154 = F_163 ( V_3 , V_46 , & V_217 , & V_242 . V_252 , & V_244 ,
& V_322 -> V_323 , F_150 , V_142 ,
