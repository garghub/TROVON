...
int V_134 = 0 ;
F_8 ( L_48 , V_2 ) ;
V_15 = F_128 ( sizeof( * V_15 ) , V_237 ) ;
if ( ! V_15 )
return F_129 ( - V_176 ) ;
V_235 = V_2 -> V_3 ;
if ( V_236 )
V_134 = F_130 ( V_132 , F_73 ( V_2 -> V_3 ) , V_235 -> V_4 ,
V_235 -> V_89 ,
F_131 ( F_24 ( V_235 ) -> V_238 ) ) ;
if ( V_134 < 0 ) {
F_132 ( V_15 ) ;
return F_129 ( V_134 ) ;
}
...
bool F_133 ( struct V_154 * V_154 , int V_240 )
{
int V_134 ;
struct V_1 * V_2 = F_134 ( V_240 , & V_134 ) ;
bool V_108 = false ;
if ( ! V_2 )
goto V_63;
...
int F_136 ( struct V_131 * V_132 , const int V_240 , char * V_241 ,
const T_1 V_60 )
{
int V_134 = 0 ;
struct V_1 * V_242 = F_134 ( V_240 , & V_134 ) ;
...
error = F_141 ( V_154 , V_254 , type , V_251 , & V_2 , 1 ) ;
if ( error < 0 )
return F_129 ( error ) ;
F_1 ( V_2 ) ;
V_255 = 1 ;
