...
V_98 -> V_104 . V_105 . V_106 . V_108 =
( V_98 -> V_108 < 0 ) ? 0 : V_98 -> V_108 ;
} else {
...
static T_1 F_102 ( struct V_9 * V_10 , struct V_43 * V_114 ,
char * V_45 )
{
struct V_97 * V_98 = F_100 ( V_10 ) ;
if ( V_98 -> V_108 < 0 )
return - V_115 ;
return sprintf ( V_45 , L_16 , V_98 -> V_108 ) ;
}
static T_1 F_103 ( struct V_9 * V_10 , struct V_43 * V_114 ,
char * V_45 )
{
struct V_97 * V_98 = F_100 ( V_10 ) ;
int V_4 ;
F_33 ( & V_98 -> V_113 ) ;
V_4 = sprintf ( V_45 , L_16 , V_98 -> V_116 ) ;
F_36 ( & V_98 -> V_113 ) ;
return V_4 ;
}
static T_1 F_104 ( struct V_9 * V_10 , struct V_43 * V_114 ,
const char * V_45 , T_4 V_117 )
{
struct V_97 * V_98 = F_100 ( V_10 ) ;
unsigned long V_118 ;
int V_4 ;
V_4 = F_105 ( V_45 , 16 , & V_118 ) ;
if ( V_4 )
return V_4 ;
F_33 ( & V_98 -> V_113 ) ;
switch ( V_118 ) {
case 0 :
V_4 = V_98 -> V_116 ? F_106 ( V_98 , 0 ) : 0 ;
break;
case 1 :
V_4 = V_98 -> V_116 ? 0 : F_106 ( V_98 , 1 ) ;
break;
default:
V_4 = - V_115 ;
}
...
static T_5 F_107 ( struct V_119 * V_53 , struct V_120 * V_44 ,
int V_121 )
{
return V_122 . V_123 ? V_44 -> V_124 : 0 ;
}
static int T_2 F_108 ( int V_125 )
{
struct V_97 * V_98 ;
int V_4 ;
V_98 = F_27 ( sizeof( * V_98 ) , V_22 ) ;
if ( ! V_98 )
return - V_23 ;
V_48 [ V_125 ] = V_98 ;
F_34 ( & V_98 -> V_9 , L_17 , V_125 ) ;
V_98 -> V_9 . V_50 = V_126 ;
V_98 -> V_9 . V_31 = F_99 ;
F_22 ( & V_98 -> V_113 ) ;
V_98 -> V_108 = F_109 ( V_125 ) ;
F_96 ( V_98 , ( T_3 ) ( F_110 () >> 32 ) ) ;
V_4 = F_111 ( & V_98 -> V_9 ) ;
if ( V_4 ) {
F_11 ( & V_98 -> V_9 ) ;
goto V_127;
}
V_98 -> V_128 = F_27 ( sizeof( * V_98 -> V_128 ) ,
V_22 ) ;
if ( ! V_98 -> V_128 ) {
F_39 ( & V_98 -> V_9 ) ;
V_4 = - V_23 ;
...
V_98 -> V_128 -> V_10 . V_47 = & V_98 -> V_9 ;
V_98 -> V_128 -> V_10 . V_31 = F_23 ;
F_22 ( & V_98 -> V_128 -> V_24 ) ;
V_4 = F_19 ( V_98 -> V_128 ) ;
if ( V_4 ) {
F_25 ( V_98 -> V_128 ) ;
F_39 ( & V_98 -> V_9 ) ;
...
F_34 ( & V_98 -> V_128 -> V_10 , L_18 ) ;
V_4 = F_111 ( & V_98 -> V_128 -> V_10 ) ;
if ( V_4 ) {
F_11 ( & V_98 -> V_128 -> V_10 ) ;
F_39 ( & V_98 -> V_9 ) ;
goto V_127;
}
return V_4 ;
...
static int F_114 ( struct V_129 * V_130 , unsigned long V_131 ,
void * V_132 )
{
struct V_97 * V_98 ;
int V_4 ;
...
V_143:
while ( V_35 -- > 0 ) {
struct V_97 * V_98 = V_48 [ V_35 ] ;
F_39 ( & V_98 -> V_128 -> V_10 ) ;
F_39 ( & V_98 -> V_9 ) ;
}
F_127 ( & V_19 ) ;
V_20:
...
static int F_137 ( struct V_150 * V_151 , void * V_77 )
{
struct V_152 * V_153 = F_138 ( V_151 ) ;
if ( V_153 -> V_154 )
return V_153 -> V_154 () ;
return 0 ;
}
...
return - V_155 ;
F_92 ( V_65 ) ;
return F_142 ( & V_19 , NULL , NULL , F_137 ) ;
}
...
static T_1 F_150 ( struct V_159 * V_159 , const char T_6 * V_45 ,
T_4 V_117 , T_7 * V_160 )
{
int V_4 ;
F_151 () ;
...
{
return V_12 == F_100 ( V_12 -> V_10 . V_47 ) -> V_128 ;
}
static int F_155 ( struct V_9 * V_10 , struct V_150 * V_151 )
{
struct V_11 * V_12 = F_5 ( V_10 ) ;
struct V_152 * V_52 = F_138 ( V_151 ) ;
struct V_165 * V_40 ;
for ( V_40 = V_52 -> V_166 ; V_40 -> V_167 ; V_40 ++ ) {
...
int V_4 ;
V_12 = F_5 ( V_10 ) ;
V_12 -> V_52 = F_138 ( V_10 -> V_52 ) ;
V_4 = V_12 -> V_52 -> V_168 ? V_12 -> V_52 -> V_168 ( V_12 ) : 0 ;
if ( V_4 )
V_12 -> V_52 = NULL ;
return V_4 ;
}
...
struct V_11 * V_12 ;
V_12 = F_5 ( V_10 ) ;
if ( V_12 -> V_52 && V_12 -> V_52 -> V_169 )
V_12 -> V_52 -> V_169 ( V_12 ) ;
}
static int F_159 ( struct V_9 * V_10 , struct V_170 * V_171 )
{
struct V_11 * V_12 = F_5 ( V_10 ) ;
int V_4 ;
V_4 = F_160 ( V_171 , L_23 , V_12 -> V_46 ) ;
if ( V_4 )
return V_4 ;
V_4 = F_160 ( V_171 , L_24 , V_12 -> V_46 ) ;
return V_4 ;
}
...
if ( ! V_12 -> V_10 . V_52 )
return 0 ;
V_151 = F_138 ( V_12 -> V_10 . V_52 ) ;
return V_151 -> V_172 ? V_151 -> V_172 ( V_12 ) : 0 ;
}
...
return 0 ;
V_151 = F_138 ( V_12 -> V_10 . V_52 ) ;
return V_151 -> V_174 ? V_151 -> V_174 ( V_12 ) : 0 ;
}
...
return 0 ;
V_151 = F_138 ( V_12 -> V_10 . V_52 ) ;
return V_151 -> V_175 ? V_151 -> V_175 ( V_12 ) : 0 ;
}
...
return 0 ;
V_151 = F_138 ( V_12 -> V_10 . V_52 ) ;
return V_151 -> V_176 ? V_151 -> V_176 ( V_12 ) : 0 ;
}
int F_167 ( struct V_152 * V_177 )
{
V_177 -> V_151 . V_49 = & V_19 ;
return F_168 ( & V_177 -> V_151 ) ;
}
void F_169 ( struct V_152 * V_177 )
{
F_170 ( & V_177 -> V_151 ) ;
}
