...
int V_145 ;
T_3 V_158 [ 5 ] ;
if ( F_125 ( V_76 -> V_211 , L_68 , & V_209 ) ||
F_125 ( V_76 -> V_211 , L_69 , & V_210 ) )
return 0 ;
V_164 = F_126 ( 0x3F , 0x59 ) ;
V_158 [ 0 ] = V_164 & 0xFF ;
V_158 [ 1 ] = V_164 >> 8 ;
V_158 [ 2 ] = 2 ;
V_158 [ 3 ] = V_209 ;
...
if ( ! V_11 ) {
F_127 ( V_23 , L_70 , V_212 ) ;
return - V_16 ;
}
memcpy ( F_11 ( V_11 , sizeof( V_158 ) ) , V_158 , sizeof( V_158 ) ) ;
F_8 ( V_11 ) = V_107 ;
V_145 = F_75 ( V_23 , V_11 ) ;
if ( V_145 ) {
F_127 ( V_23 , L_71 , V_212 ) ;
F_3 ( V_11 ) ;
return V_145 ;
}
return 0 ;
...
static int F_130 ( struct V_32 * V_23 , T_3 V_214 ,
void * V_2 , T_7 V_51 )
{
...
return - V_16 ;
V_50 = F_131 ( V_44 , 0 ) ;
V_12 = F_132 ( V_44 , V_50 , V_214 , V_217 | V_218 ,
0 , 0 , V_49 , V_51 , V_219 ) ;
if ( V_12 < 0 ) {
...
V_50 = F_66 ( V_44 , 0 ) ;
V_12 = F_132 ( V_44 , V_50 , V_223 , V_217 ,
0 , 0 , V_49 , V_51 , V_219 ) ;
if ( V_12 < 0 ) {
...
V_50 = F_69 ( V_44 , 0x02 ) ;
V_12 = F_134 ( V_44 , V_50 , V_49 , V_51 , & V_13 ,
V_224 ) ;
if ( V_12 < 0 ) {
F_25 ( L_76 ,
...
char V_144 [ 64 ] ;
int V_12 ;
V_230 = F_136 ( V_142 -> V_234 ) ;
V_231 = F_136 ( V_142 -> V_235 ) ;
...
V_12 = F_133 ( V_23 , V_143 , V_227 -> V_237 ) ;
V_77:
F_99 ( V_143 ) ;
return V_12 ;
}
...
V_12 = F_133 ( V_23 , V_143 , V_227 -> V_238 ) ;
F_99 ( V_143 ) ;
return V_12 ;
}
static int F_138 ( struct V_32 * V_23 )
{
...
T_3 V_35 ;
int V_62 , V_12 ;
V_12 = F_130 ( V_23 , V_239 , & V_142 ,
sizeof( V_142 ) ) ;
if ( V_12 < 0 )
return V_12 ;
V_230 = F_136 ( V_142 . V_234 ) ;
for ( V_62 = 0 ; V_62 < F_139 ( V_240 ) ; V_62 ++ ) {
...
V_12 = F_130 ( V_23 , V_241 , & V_35 ,
sizeof( V_35 ) ) ;
if ( V_12 < 0 )
return V_12 ;
if ( ! ( V_35 & V_242 ) ) {
V_12 = F_135 ( V_23 , & V_142 , V_227 ) ;
if ( V_12 < 0 )
return V_12 ;
}
if ( ! ( V_35 & V_243 ) ) {
...
static inline int F_140 ( struct V_32 * V_23 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
...
struct V_117 * V_118 ;
V_118 = & V_84 -> V_120 -> V_123 [ V_62 ] . V_121 ;
if ( ! V_2 -> V_244 && F_141 ( V_118 ) ) {
V_2 -> V_244 = V_118 ;
continue;
}
if ( ! V_2 -> V_75 && F_142 ( V_118 ) ) {
V_2 -> V_75 = V_118 ;
continue;
}
}
...
static struct V_31 * F_143 ( struct V_32 * V_23 , bool V_245 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_10 * V_11 ;
struct V_31 * V_31 ;
...
static int F_144 ( struct V_32 * V_23 , bool V_245 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_31 * V_31 ;
if ( ! V_2 -> V_89 )
...
if ( ! F_24 ( V_37 , & V_23 -> V_3 ) )
return - V_246 ;
V_31 = F_143 ( V_23 , V_245 ) ;
if ( F_76 ( V_31 ) )
return F_77 ( V_31 ) ;
return F_73 ( V_23 , V_31 ) ;
}
static T_10 F_145 ( int V_247 , void * V_248 )
{
struct V_1 * V_2 = V_248 ;
F_146 ( & V_2 -> V_44 -> V_76 , 0 ) ;
...
static int F_149 ( struct V_32 * V_23 )
{
struct V_1 * V_2 = F_22 ( V_23 ) ;
struct V_208 * V_76 = & V_2 -> V_44 -> V_76 ;
int V_247 , V_145 ;
...
if ( ! F_150 ( V_251 , V_76 ) )
return 0 ;
V_247 = F_151 ( V_76 -> V_211 , L_89 ) ;
if ( V_247 <= 0 ) {
F_152 ( V_23 , L_90 , V_212 ) ;
return 0 ;
}
V_145 = F_153 ( & V_23 -> V_76 , V_247 , F_145 ,
0 , L_91 , V_2 ) ;
if ( V_145 ) {
F_127 ( V_23 , L_92 , V_212 ) ;
return V_145 ;
}
V_145 = F_154 ( V_76 , true ) ;
if ( V_145 ) {
F_127 ( V_23 , L_93 , V_212 ) ;
return V_145 ;
}
V_2 -> V_252 = V_247 ;
F_155 ( V_247 ) ;
F_156 ( V_23 , L_94 , V_247 ) ;
return 0 ;
}
static int F_157 ( struct V_115 * V_84 ,
...
struct V_216 * V_44 = F_159 ( V_84 ) ;
if ( F_32 ( V_44 -> V_263 . V_264 ) <= 0x0001 )
return - V_47 ;
}
V_2 = F_160 ( & V_84 -> V_76 , sizeof( * V_2 ) , V_87 ) ;
if ( ! V_2 )
return - V_16 ;
for ( V_62 = 0 ; V_62 < V_84 -> V_120 -> V_121 . V_122 ; V_62 ++ ) {
V_118 = & V_84 -> V_120 -> V_123 [ V_62 ] . V_121 ;
if ( ! V_2 -> V_52 && F_161 ( V_118 ) ) {
V_2 -> V_52 = V_118 ;
continue;
}
if ( ! V_2 -> V_103 && F_141 ( V_118 ) ) {
V_2 -> V_103 = V_118 ;
continue;
}
if ( ! V_2 -> V_61 && F_142 ( V_118 ) ) {
V_2 -> V_61 = V_118 ;
continue;
}
}
...
V_23 -> V_286 = F_144 ;
V_23 -> V_287 = V_288 ;
V_2 -> V_89 = F_170 ( V_2 -> V_44 , V_255 + 2 ) ;
}
...
V_2 -> V_116 = F_170 ( V_2 -> V_44 , V_255 + 1 ) ;
}
if ( ! V_310 )
...
static void F_176 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_177 ( V_84 ) ;
struct V_32 * V_23 ;
F_23 ( L_97 , V_84 ) ;
if ( ! V_2 )
return;
...
F_174 ( V_2 -> V_84 , NULL ) ;
if ( V_2 -> V_116 )
F_174 ( V_2 -> V_116 , NULL ) ;
if ( V_2 -> V_89 )
F_174 ( V_2 -> V_89 , NULL ) ;
F_178 ( V_23 ) ;
if ( V_84 == V_2 -> V_84 ) {
if ( V_2 -> V_116 )
F_179 ( & V_319 , V_2 -> V_116 ) ;
if ( V_2 -> V_89 )
F_179 ( & V_319 , V_2 -> V_89 ) ;
} else if ( V_84 == V_2 -> V_116 ) {
if ( V_2 -> V_89 )
F_179 ( & V_319 , V_2 -> V_89 ) ;
F_179 ( & V_319 , V_2 -> V_84 ) ;
...
if ( V_2 -> V_252 )
F_154 ( & V_2 -> V_44 -> V_76 , false ) ;
F_175 ( V_23 ) ;
}
static int F_180 ( struct V_115 * V_84 , T_11 V_320 )
{
struct V_1 * V_2 = F_177 ( V_84 ) ;
F_23 ( L_97 , V_84 ) ;
if ( V_2 -> V_321 ++ )
...
F_58 ( V_2 ) ;
F_54 ( & V_2 -> V_93 ) ;
if ( V_2 -> V_252 && F_184 ( & V_2 -> V_44 -> V_76 ) ) {
F_55 ( V_249 , & V_2 -> V_3 ) ;
F_185 ( V_2 -> V_252 ) ;
F_186 ( V_2 -> V_252 ) ;
}
...
static int F_189 ( struct V_115 * V_84 )
{
struct V_1 * V_2 = F_177 ( V_84 ) ;
struct V_32 * V_23 = V_2 -> V_23 ;
int V_12 = 0 ;
