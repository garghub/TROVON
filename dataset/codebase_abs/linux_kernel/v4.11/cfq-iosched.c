...
static enum V_253 F_228 ( struct V_248 * V_47 , struct V_110 * * V_254 ,
struct V_243 * V_243 )
{
struct V_49 * V_50 = V_47 -> V_70 -> V_71 ;
struct V_110 * V_255 ;
V_255 = F_219 ( V_50 , V_243 ) ;
if ( V_255 && F_229 ( V_255 , V_243 ) ) {
* V_254 = V_255 ;
return V_256 ;
}
return V_257 ;
}
static void F_230 ( struct V_248 * V_47 , struct V_110 * V_254 ,
enum V_253 type )
{
if ( type == V_256 ) {
struct V_53 * V_54 = F_212 ( V_254 ) ;
F_217 ( V_54 , V_254 ) ;
}
}
static void F_231 ( struct V_248 * V_47 , struct V_110 * V_254 ,
struct V_243 * V_243 )
{
F_45 ( F_218 ( V_254 ) , V_243 -> V_247 ) ;
}
static void
...
V_131 -> V_258 < V_240 -> V_258 &&
V_54 == F_212 ( V_131 ) ) {
F_234 ( & V_240 -> V_250 , & V_131 -> V_250 ) ;
V_240 -> V_258 = V_131 -> V_258 ;
}
if ( V_54 -> V_235 == V_131 )
V_54 -> V_235 = V_240 ;
F_226 ( V_131 ) ;
...
V_50 -> V_259 = NULL ;
if ( V_50 -> V_262 ) {
F_251 ( V_50 -> V_262 -> V_64 . V_66 ) ;
V_50 -> V_262 = NULL ;
}
}
static inline void F_252 ( struct V_49 * V_50 , bool V_261 )
{
struct V_53 * V_54 = V_50 -> V_259 ;
if ( V_54 )
F_245 ( V_50 , V_54 , V_261 ) ;
}
...
struct V_110 * V_240 )
{
return F_257 ( V_50 , V_240 ) <= V_263 ;
}
static struct V_53 * F_259 ( struct V_49 * V_50 ,
struct V_53 * V_264 )
{
struct V_128 * V_124 = & V_50 -> V_237 [ V_264 -> V_238 ] ;
...
if ( F_258 ( V_50 , V_264 , V_225 -> V_235 ) )
return V_225 ;
...
if ( F_249 ( V_264 ) )
return NULL ;
if ( V_264 -> V_3 -> V_134 == 1 )
return NULL ;
V_54 = F_259 ( V_50 , V_264 ) ;
if ( ! V_54 )
return NULL ;
if ( V_264 -> V_3 != V_54 -> V_3 )
return NULL ;
if ( ! F_61 ( V_54 ) )
return NULL ;
if ( F_249 ( V_54 ) )
return NULL ;
if ( F_59 ( V_54 ) != F_59 ( V_264 ) )
return NULL ;
return V_54 ;
}
...
return;
V_68 = V_50 -> V_262 ;
if ( ! V_68 || ! F_265 ( & V_68 -> V_64 . V_66 -> V_269 ) )
return;
if ( F_266 ( V_68 -> V_167 . V_270 ) &&
( V_54 -> V_108 - V_12 < V_68 -> V_167 . V_271 ) ) {
F_90 ( V_50 , V_54 , L_19 ,
V_68 -> V_167 . V_271 ) ;
return;
}
...
V_265 = V_50 -> V_51 ;
F_268 ( & V_50 -> V_260 , F_269 ( V_265 ) ,
V_272 ) ;
F_20 ( V_54 -> V_3 ) ;
F_90 ( V_50 , V_54 , L_20 , V_265 ,
V_266 ? 1 : 0 ) ;
}
...
{
const int V_275 = V_50 -> V_276 ;
F_76 ( V_54 -> V_81 >= V_80 ) ;
return 2 * V_275 * ( V_80 - V_54 -> V_81 ) ;
}
static int F_277 ( struct V_53 * V_54 )
{
int V_277 , V_278 ;
V_278 = V_54 -> V_279 [ V_280 ] + V_54 -> V_279 [ V_281 ] ;
V_277 = V_54 -> V_282 - V_278 ;
F_21 ( V_277 < 0 ) ;
return V_277 ;
}
...
if ( V_54 -> V_268 && F_261 ( V_50 , V_54 ) ) {
V_54 = NULL ;
goto V_292;
}
V_293:
if ( V_50 -> V_267 && V_54 -> V_3 -> V_134 == 1 &&
V_54 -> V_3 -> V_268 &&
...
if ( F_92 ( V_54 ) )
return true ;
if ( V_12 + V_50 -> V_51 * V_54 -> V_268 > V_54 -> V_108 )
return true ;
return false ;
}
...
if ( F_285 ( V_54 ) )
return true ;
if ( F_261 ( V_50 , V_54 ) && V_50 -> V_273 [ V_295 ] )
return false ;
if ( V_50 -> V_273 [ V_296 ] && ! F_61 ( V_54 ) )
return false ;
V_294 = F_119 (unsigned int, cfqd->cfq_quantum / 2 , 1 ) ;
if ( F_58 ( V_54 ) )
V_294 = 1 ;
if ( V_54 -> V_268 >= V_294 ) {
bool V_297 = false ;
...
! V_297 )
return false ;
if ( V_50 -> V_72 == 1 || V_297 )
V_294 = - 1 ;
else
V_294 = V_50 -> V_298 ;
}
if ( ! F_61 ( V_54 ) && V_50 -> V_100 ) {
T_2 V_299 = F_89 () - V_50 -> V_300 ;
unsigned int V_301 ;
V_301 = F_87 ( V_299 , V_50 -> V_77 [ 1 ] ) ;
if ( ! V_301 && ! V_54 -> V_268 )
V_301 = 1 ;
if ( V_301 < V_294 )
V_294 = V_301 ;
}
return V_54 -> V_268 < V_294 ;
}
...
F_296 ( & V_68 -> V_64 . V_66 -> V_302 ) ;
V_50 -> V_262 = V_68 ;
}
return true ;
}
static int F_297 ( struct V_248 * V_47 , int V_303 )
{
struct V_49 * V_50 = V_47 -> V_70 -> V_71 ;
struct V_53 * V_54 ;
if ( ! V_50 -> V_72 )
...
F_21 ( V_54 -> V_279 [ V_280 ] + V_54 -> V_279 [ V_281 ] ) ;
V_3 = V_54 -> V_3 ;
if ( F_55 ( V_50 -> V_259 == V_54 ) ) {
F_245 ( V_50 , V_54 , 0 ) ;
F_71 ( V_50 ) ;
}
F_21 ( F_206 ( V_54 ) ) ;
...
if ( ! F_305 ( V_54 ) )
return;
V_305 = F_306 ( V_68 -> V_81 ) ;
switch ( V_305 ) {
default:
F_307 ( V_306 L_28 , V_305 ) ;
case V_307 :
V_54 -> V_81 = F_308 ( V_245 ) ;
V_54 -> V_305 = F_309 ( V_245 ) ;
break;
case V_308 :
...
if ( V_54 ) {
F_150 ( V_54 ) ;
V_54 = F_313 ( V_50 , V_295 , V_68 , V_243 ) ;
...
bool V_314 ;
F_320 () ;
V_313 = F_321 ( V_243 ) -> V_36 . V_313 ;
V_314 = F_321 ( V_243 ) != & V_176 ;
F_322 () ;
if ( F_55 ( ! V_50 ) || F_155 ( V_68 -> V_315 == V_313 ) )
return V_314 ;
V_54 = F_68 ( V_68 , false ) ;
if ( V_54 ) {
F_90 ( V_50 , V_54 , L_29 ) ;
...
static struct V_53 * *
F_323 ( struct V_2 * V_3 , int V_305 , int V_81 )
{
switch ( V_305 ) {
case V_308 :
...
V_54 -> V_305 = V_307 ;
F_315 ( V_50 , V_54 , V_246 -> V_312 , V_69 ) ;
F_304 ( V_54 , V_68 ) ;
F_156 ( V_54 , V_3 ) ;
F_90 ( V_50 , V_54 , L_30 ) ;
if ( V_178 ) {
...
static void
F_327 ( struct V_321 * V_167 , T_2 V_322 )
{
T_2 V_323 = F_89 () - V_167 -> V_168 ;
V_323 = F_83 ( V_323 , 2UL * V_322 ) ;
V_167 -> V_270 = ( 7 * V_167 -> V_270 + 256 ) / 8 ;
V_167 -> V_324 = F_75 ( 7 * V_167 -> V_324 + 256 * V_323 , 8 ) ;
V_167 -> V_271 = F_328 ( V_167 -> V_324 + 128 ,
V_167 -> V_270 ) ;
}
static void
...
#ifdef F_330
F_327 ( & V_54 -> V_3 -> V_167 , V_50 -> V_267 ) ;
#endif
}
static void
...
{
T_4 V_325 = 0 ;
T_4 V_326 = F_224 ( V_240 ) ;
if ( V_54 -> V_327 ) {
if ( V_54 -> V_327 < F_97 ( V_240 ) )
V_325 = F_97 ( V_240 ) - V_54 -> V_327 ;
else
V_325 = V_54 -> V_327 - F_97 ( V_240 ) ;
}
V_54 -> V_328 <<= 1 ;
if ( F_262 ( V_50 -> V_67 ) )
V_54 -> V_328 |= ( V_326 < V_329 ) ;
else
V_54 -> V_328 |= ( V_325 > V_330 ) ;
}
static inline bool F_332 ( struct V_110 * V_254 )
{
return F_333 ( V_254 ) == V_331 &&
( V_254 -> V_120 & ( V_332 | V_333 ) ) == V_332 ;
}
static void
...
return;
V_335 = V_334 = F_62 ( V_54 ) ;
if ( V_54 -> V_19 [ 0 ] + V_54 -> V_19 [ 1 ] >= 4 )
F_335 ( V_54 ) ;
if ( V_54 -> V_235 && F_332 ( V_54 -> V_235 ) )
V_335 = 0 ;
else if ( ! F_265 ( & V_68 -> V_64 . V_66 -> V_269 ) ||
! V_50 -> V_51 ||
( ! F_336 ( V_54 ) && F_249 ( V_54 ) ) )
V_335 = 0 ;
else if ( F_266 ( V_68 -> V_167 . V_270 ) ) {
if ( V_68 -> V_167 . V_271 > V_50 -> V_51 )
V_335 = 0 ;
else
V_335 = 1 ;
}
if ( V_334 != V_335 ) {
F_90 ( V_50 , V_54 , L_31 , V_335 ) ;
if ( V_335 )
F_317 ( V_54 ) ;
else
F_288 ( V_54 ) ;
...
{
enum V_6 V_336 = F_60 ( V_50 -> V_259 ) ;
F_90 ( V_50 , V_54 , L_32 ) ;
F_252 ( V_50 , 1 ) ;
if ( V_336 != F_60 ( V_54 ) )
V_54 -> V_3 -> V_151 = 0 ;
...
V_54 -> V_327 = F_97 ( V_240 ) + F_224 ( V_240 ) ;
if ( V_54 == V_50 -> V_259 ) {
if ( F_246 ( V_54 ) ) {
if ( F_340 ( V_240 ) > V_337 ||
V_50 -> V_72 > 1 ) {
F_237 ( V_50 , V_54 ) ;
F_240 ( V_54 ) ;
F_341 ( V_50 -> V_67 ) ;
...
V_240 -> V_258 = F_89 () + V_50 -> V_338 [ F_96 ( V_240 ) ] ;
F_343 ( & V_240 -> V_250 , & V_54 -> V_274 ) ;
F_215 ( V_240 ) ;
...
{
struct V_53 * V_54 = V_50 -> V_259 ;
if ( V_50 -> V_249 > V_50 -> V_339 )
V_50 -> V_339 = V_50 -> V_249 ;
if ( V_50 -> V_52 == 1 )
return;
if ( V_50 -> V_251 <= V_340 &&
V_50 -> V_249 <= V_340 )
return;
if ( V_54 && F_62 ( V_54 ) &&
V_54 -> V_268 + V_54 -> V_19 [ 0 ] + V_54 -> V_19 [ 1 ] <
V_340 && V_50 -> V_249 < V_340 )
return;
if ( V_50 -> V_341 ++ < 50 )
return;
if ( V_50 -> V_339 >= V_340 )
...
if ( F_91 ( V_54 ) )
return true ;
if ( V_68 && F_266 ( V_68 -> V_167 . V_270 )
&& ( V_54 -> V_108 - V_12 < V_68 -> V_167 . V_271 ) )
return true ;
...
#endif
if ( V_50 -> V_259 == V_54 ) {
const bool V_343 = F_214 ( & V_54 -> V_133 ) ;
if ( F_92 ( V_54 ) ) {
F_88 ( V_50 , V_54 ) ;
F_351 ( V_54 ) ;
}
...
struct V_53 * V_54 = F_212 ( V_240 ) ;
if ( V_54 ) {
const int V_347 = F_359 ( V_240 ) ;
F_21 ( ! V_54 -> V_279 [ V_347 ] ) ;
V_54 -> V_279 [ V_347 ] -- ;
F_38 ( F_218 ( V_240 ) ) ;
V_240 -> V_348 . V_349 [ 0 ] = NULL ;
V_240 -> V_348 . V_349 [ 1 ] = NULL ;
F_150 ( V_54 ) ;
}
}
static struct V_53 *
...
{
struct V_49 * V_50 = V_47 -> V_70 -> V_71 ;
struct V_62 * V_68 = F_65 ( V_240 -> V_348 . V_64 ) ;
const int V_347 = F_359 ( V_240 ) ;
...
F_175 ( V_47 -> V_48 ) ;
F_312 ( V_68 , V_243 ) ;
V_351 = F_319 ( V_68 , V_243 ) ;
V_290:
V_54 = F_68 ( V_68 , V_69 ) ;
if ( ! V_54 || V_54 == & V_50 -> V_317 ) {
if ( V_54 )
F_150 ( V_54 ) ;
...
V_54 -> V_282 ++ ;
F_36 ( V_54 -> V_3 ) ;
V_240 -> V_348 . V_349 [ 0 ] = V_54 ;
V_240 -> V_348 . V_349 [ 1 ] = V_54 -> V_3 ;
F_177 ( V_47 -> V_48 ) ;
if ( V_351 )
F_367 ( V_47 ) ;
return 0 ;
...
static int F_377 ( struct V_248 * V_47 , struct V_363 * V_362 )
{
struct V_49 * V_50 ;
...
if ( ! V_365 )
return - V_171 ;
V_50 = F_147 ( sizeof( * V_50 ) , V_366 , V_47 -> V_135 ) ;
if ( ! V_50 ) {
F_379 ( & V_365 -> V_367 ) ;
return - V_171 ;
}
...
#endif
for ( V_164 = 0 ; V_164 < V_370 ; V_164 ++ )
V_50 -> V_237 [ V_164 ] = V_371 ;
F_315 ( V_50 , & V_50 -> V_317 , 1 , 0 ) ;
V_50 -> V_317 . V_282 ++ ;
F_175 ( V_47 -> V_48 ) ;
F_156 ( & V_50 -> V_317 , V_50 -> V_222 ) ;
F_38 ( V_50 -> V_222 ) ;
F_177 ( V_47 -> V_48 ) ;
F_381 ( & V_50 -> V_260 , V_372 ,
V_272 ) ;
V_50 -> V_260 . V_373 = F_369 ;
F_382 ( & V_50 -> V_73 , F_368 ) ;
V_50 -> V_298 = V_298 ;
V_50 -> V_338 [ 0 ] = V_338 [ 0 ] ;
V_50 -> V_338 [ 1 ] = V_338 [ 1 ] ;
V_50 -> V_122 = V_122 ;
V_50 -> V_123 = V_123 ;
V_50 -> V_77 [ 0 ] = V_374 ;
V_50 -> V_77 [ 1 ] = V_375 ;
...
static T_6
F_384 ( unsigned int V_376 , char * V_377 )
{
return sprintf ( V_377 , L_6 , V_376 ) ;
}
static T_6
F_385 ( unsigned int * V_376 , const char * V_377 , T_7 V_61 )
{
char * V_224 = ( char * ) V_377 ;
* V_376 = F_386 ( V_224 , & V_224 , 10 ) ;
return V_61 ;
}
