...
if ( ! V_2 -> V_5 )
return false ;
V_2 -> V_10 = F_24 ( F_25 ( V_14 ) , V_16 , V_2 -> V_5 ) ;
F_12 ( V_2 -> V_10 ) ;
if ( ! F_13 ( V_2 ) )
return F_5 ( V_2 ) ;
return true ;
...
V_21:
V_17 = F_26 ( V_16 , V_2 -> V_6 ) ;
if ( ! F_27 ( * V_17 ) )
return false ;
V_18 = F_28 ( V_17 , V_2 -> V_6 ) ;
if ( ! F_29 ( * V_18 ) )
return false ;
V_19 = F_30 ( V_18 , V_2 -> V_6 ) ;
if ( ! F_31 ( * V_19 ) )
return false ;
V_2 -> V_4 = F_32 ( V_19 , V_2 -> V_6 ) ;
if ( F_4 ( * V_2 -> V_4 ) ) {
V_2 -> V_10 = F_33 ( V_16 , V_2 -> V_4 ) ;
if ( ! F_3 ( * V_2 -> V_4 ) )
return F_5 ( V_2 ) ;
if ( F_34 ( F_4 ( * V_2 -> V_4 ) ) ) {
if ( V_2 -> V_7 & V_9 )
return F_5 ( V_2 ) ;
if ( F_35 ( * V_2 -> V_4 ) != V_14 )
return F_5 ( V_2 ) ;
return true ;
} else {
F_36 ( V_2 -> V_10 ) ;
...
return true ;
V_20:
if ( ! F_37 ( V_2 -> V_14 ) || F_22 ( V_2 -> V_14 ) )
return F_5 ( V_2 ) ;
do {
V_2 -> V_6 += V_22 ;
if ( V_2 -> V_6 >= V_2 -> V_11 -> V_23 ||
V_2 -> V_6 >=
F_38 ( V_2 -> V_14 , V_2 -> V_11 ) +
F_18 ( V_2 -> V_14 ) * V_22 )
return F_5 ( V_2 ) ;
if ( V_2 -> V_6 % V_24 == 0 ) {
F_39 ( V_2 -> V_5 ) ;
...
int F_41 ( struct V_14 * V_14 , struct V_25 * V_11 )
{
struct V_1 V_2 = {
. V_14 = V_14 ,
. V_11 = V_11 ,
...
V_26 = F_38 ( V_14 , V_11 ) ;
V_27 = V_26 + V_22 * ( F_18 ( V_14 ) - 1 ) ;
if ( F_21 ( V_27 < V_11 -> V_28 || V_26 >= V_11 -> V_23 ) )
return 0 ;
V_2 . V_6 = F_42 ( V_26 , V_11 -> V_28 ) ;
if ( ! V_1 ( & V_2 ) )
return 0 ;
F_6 ( & V_2 ) ;
return 1 ;
