...
unsigned int V_46 , unsigned int V_1 )
{
bool V_47 ;
unsigned int V_48 ;
int V_49 = - V_50 ;
...
return V_49 ;
if ( V_45 -> V_52 ) {
F_34 ( ( * V_3 ) ++ , 1 , V_45 -> V_51 ) ;
if ( ! V_43 -- )
return V_49 ;
F_34 ( ( * V_3 ) , 0 , V_45 -> V_51 ) ;
} else {
F_34 ( ( * V_3 ) , 1 , V_45 -> V_51 ) ;
}
V_48 >>= 1 ;
...
int F_35 ( struct V_2 * * V_3 , unsigned int V_43 ,
...
V_49 = F_36 ( V_3 , & V_43 , V_45 -> V_63 ,
V_45 -> V_55 ) ;
return V_49 ;
}
int F_37 ( struct V_2 * * V_3 , unsigned int V_43 ,
...
if ( ! V_43 -- )
return V_49 ;
F_34 ( ( * V_3 ) ++ , 0 , V_45 -> V_55 ) ;
return 0 ;
}
int F_38 ( enum V_41 V_65 , T_4 V_66 ,
...
int F_39 ( struct V_17 * V_10 )
{
int V_25 ;
struct V_4 * V_5 ;
if ( ! V_10 )
return - V_18 ;
V_10 -> V_7 = F_40 ( sizeof( * V_10 -> V_7 ) , V_70 ) ;
if ( ! V_10 -> V_7 )
return - V_71 ;
V_10 -> V_7 -> V_10 = V_10 ;
V_10 -> F_31 = F_31 ;
F_41 ( V_10 -> V_7 -> V_9 ) ;
if ( V_10 -> V_72 != V_73 ) {
V_10 -> V_7 -> V_39 = F_42 ( F_1 , V_10 -> V_7 ,
L_6 , V_10 -> V_74 ) ;
if ( F_43 ( V_10 -> V_7 -> V_39 ) ) {
V_25 = F_44 ( V_10 -> V_7 -> V_39 ) ;
goto V_75;
}
}
F_2 ( & V_8 ) ;
F_45 ( & V_10 -> V_7 -> V_76 , & V_77 ) ;
F_4 (handler, &ir_raw_handler_list, list)
if ( V_5 -> V_78 )
V_5 -> V_78 ( V_10 ) ;
F_5 ( & V_8 ) ;
