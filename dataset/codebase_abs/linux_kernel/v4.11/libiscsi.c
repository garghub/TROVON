...
V_326 -> V_331 [ V_224 ] = F_136 ( V_329 , V_332 ) ;
...
void F_138 ( struct V_325 * V_326 )
{
int V_224 ;
for ( V_224 = 0 ; V_224 < V_326 -> V_327 ; V_224 ++ )
F_139 ( V_326 -> V_331 [ V_224 ] ) ;
F_139 ( V_326 -> V_331 ) ;
}
int F_140 ( struct V_3 * V_4 , struct V_76 * V_334 )
{
if ( ! V_4 -> V_289 )
V_4 -> V_289 = V_335 ;
if ( ! V_4 -> V_336 )
V_4 -> V_336 = V_337 ;
return F_141 ( V_4 , V_334 ) ;
}
struct V_3 * F_142 ( struct V_338 * V_339 ,
int V_340 , bool V_341 )
{
struct V_3 * V_4 ;
struct V_7 * V_8 ;
V_4 = F_143 ( V_339 , sizeof( struct V_7 ) + V_340 ) ;
if ( ! V_4 )
return NULL ;
V_8 = F_2 ( V_4 ) ;
if ( V_341 ) {
...
static void F_148 ( struct V_269 * V_270 )
{
...
struct V_269 *
F_159 ( struct V_353 * V_354 , struct V_3 * V_4 ,
...
if ( ! F_164 ( V_354 -> V_368 ) )
goto V_369;
if ( F_165 ( V_270 , V_113 ) )
goto V_370;
return V_270 ;
V_370:
F_166 ( V_354 -> V_368 ) ;
...
struct V_164 *
F_170 ( struct V_269 * V_270 , int V_355 ,
T_1 V_384 )
{
struct V_11 * V_5 = V_270 -> V_166 ;
struct V_1 * V_2 ;
struct V_164 * V_165 ;
char * V_153 ;
V_165 = F_171 ( V_270 , sizeof( * V_2 ) + V_355 ,
V_384 ) ;
if ( ! V_165 )
return NULL ;
V_2 = V_165 -> V_166 ;
...
void F_184 ( struct V_164 * V_165 , int V_392 )
{
struct V_1 * V_2 = V_165 -> V_166 ;
struct V_11 * V_5 = V_2 -> V_5 ;
switch ( V_392 ) {
...
int F_186 ( char * * V_397 , char * V_398 )
{
char * V_399 ;
if ( * V_397 ) {
...
break;
case V_428 :
return F_186 ( & V_5 -> V_375 , V_402 ) ;
case V_429 :
return F_186 ( & V_5 -> V_376 , V_402 ) ;
case V_430 :
return F_186 ( & V_5 -> V_373 , V_402 ) ;
case V_431 :
return F_186 ( & V_5 -> V_374 , V_402 ) ;
case V_432 :
return F_186 ( & V_5 -> V_322 , V_402 ) ;
case V_433 :
return F_186 ( & V_5 -> V_377 , V_402 ) ;
case V_434 :
...
break;
case V_438 :
return F_186 ( & V_2 -> V_323 , V_402 ) ;
case V_439 :
return F_186 ( & V_5 -> V_381 , V_402 ) ;
case V_440 :
return F_186 ( & V_5 -> V_352 , V_402 ) ;
case V_441 :
return F_186 ( & V_5 -> V_378 , V_402 ) ;
case V_442 :
return F_186 ( & V_5 -> V_379 , V_402 ) ;
case V_443 :
return F_186 ( & V_5 -> V_380 , V_402 ) ;
case V_444 :
return F_186 ( & V_5 -> V_382 , V_402 ) ;
case V_445 :
return F_186 ( & V_5 -> V_383 ,
V_402 ) ;
case V_446 :
...
break;
case V_448 :
return F_186 ( & V_2 -> V_388 , V_402 ) ;
default:
return - V_449 ;
}
return 0 ;
}
int F_189 ( struct V_269 * V_270 ,
...
int F_193 ( struct V_3 * V_4 , enum V_523 V_397 ,
char * V_402 , int V_403 )
{
struct V_7 * V_8 = F_2 ( V_4 ) ;
switch ( V_397 ) {
case V_524 :
return F_186 ( & V_8 -> V_350 , V_402 ) ;
case V_525 :
return F_186 ( & V_8 -> V_351 , V_402 ) ;
case V_526 :
return F_186 ( & V_8 -> V_352 , V_402 ) ;
default:
return - V_449 ;
}
return 0 ;
