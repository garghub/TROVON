...
T_1 * V_97 ;
unsigned V_71 ;
V_97 = F_47 ( ( void V_83 * ) ( unsigned long ) V_63 -> V_77 ,
sizeof( V_97 [ 0 ] ) * V_63 -> V_96 ) ;
if ( F_48 ( V_97 ) )
return F_49 ( V_97 ) ;
F_38 ( & V_20 -> V_90 ) ;
for ( V_71 = 0 ; V_71 < V_63 -> V_96 ; V_71 ++ ) {
V_25 = F_50 ( V_15 , V_97 [ V_71 ] , NULL ) ;
if ( V_25 ) {
F_40 ( V_91 , L_7 ,
V_25 ) ;
break;
...
int F_51 ( struct V_14 * V_15 , struct V_62 * V_63 )
{
struct V_16 * V_17 = V_15 -> V_18 ;
struct V_19 * V_20 = V_17 -> V_20 ;
...
V_108 = V_24 < V_66 ? F_53 ( V_76 [ V_24 ] ) : 0 ;
if ( V_108 != ++ V_107 ) {
while ( V_105 ) {
int V_109 = V_105 ;
...
static int F_56 ( struct V_14 * V_15 , unsigned long V_74 ,
...
if ( ! V_122 )
return - V_38 ;
V_123 = F_57 ( V_22 -> V_124 ,
F_58 ( F_59 ( V_76 [ 0 ] ) ) ,
V_66 * V_84 , V_125 ) ;
if ( F_60 ( & V_22 -> V_124 -> V_126 , V_123 ) ) {
F_33 ( V_22 , L_8 ,
V_123 ) ;
F_24 ( V_122 ) ;
return - V_85 ;
...
if ( ! V_17 -> V_52 )
V_25 = F_61 ( V_17 , & V_122 -> V_127 ) ;
else
V_25 = F_62 ( V_17 -> V_52 , & V_122 -> V_127 ) ;
if ( V_25 ) {
F_40 ( V_91 , L_9 ,
V_122 -> V_1 , V_122 -> V_127 . V_128 , V_122 -> V_123 , V_25 ) ;
F_63 ( V_22 -> V_124 , V_123 , V_66 * V_84 ,
V_125 ) ;
F_24 ( V_122 ) ;
return - V_85 ;
}
F_64 ( V_22 , V_1 , V_132 , V_123 , F_65 ( V_66 ) + 1 ) ;
F_66 ( V_20 -> V_100 , V_17 -> V_29 , V_1 , V_66 ,
V_122 -> V_127 . V_128 , V_122 -> V_123 , V_123 ) ;
return 0 ;
}
static int F_50 ( struct V_14 * V_15 , T_1 V_97 ,
struct V_9 * * V_10 )
{
struct V_16 * V_17 = V_15 -> V_18 ;
struct V_19 * V_20 = V_17 -> V_20 ;
struct V_21 * V_22 = V_20 -> V_22 ;
struct V_121 * V_122 ;
T_4 V_133 = F_67 ( V_97 , V_4 ) ;
T_1 V_71 = F_67 ( V_97 , V_3 ) << 1 , V_1 ;
if ( V_71 >= V_20 -> V_34 ) {
F_33 ( V_22 , L_10 ,
V_71 , V_20 -> V_100 ) ;
return - V_81 ;
...
F_69 ( V_17 -> V_52 , & V_122 -> V_127 ) ;
return 0 ;
}
static void F_70 ( struct V_16 * V_17 , struct V_121 * V_122 )
{
struct V_19 * V_20 = V_17 -> V_20 ;
struct V_21 * V_22 = V_20 -> V_22 ;
F_71 ( V_20 -> V_100 , V_17 -> V_29 , V_122 -> V_1 ,
V_122 -> V_66 , V_122 -> V_127 . V_128 , V_122 -> V_123 ,
V_122 -> V_130 ) ;
F_64 ( V_22 , V_122 -> V_1 , V_135 , 0 , 0 ) ;
F_72 () ;
F_63 ( V_22 -> V_124 , V_122 -> V_130 , V_122 -> V_127 . V_129 ,
V_125 ) ;
...
static int F_73 ( void * V_136 , struct V_137 * V_138 )
{
struct V_16 * V_139 = V_136 ;
struct V_19 * V_20 = V_139 -> V_20 ;
struct V_121 * V_122 =
F_74 ( V_138 , struct V_121 , V_127 ) ;
if ( V_122 -> V_131 )
return 0 ;
F_75 ( V_20 -> V_100 , V_139 -> V_29 , V_122 -> V_127 . V_128 ,
...
static int F_61 ( void * V_136 , struct V_137 * V_122 )
{
struct V_16 * V_139 = V_136 ;
struct V_121 * V_140 =
F_74 ( V_122 , struct V_121 , V_127 ) ;
T_1 V_41 = V_139 -> V_20 -> V_33 ;
V_139 -> V_42 [ V_140 -> V_1 - V_41 ] = V_140 ;
return 0 ;
}
static void F_68 ( struct V_16 * V_139 ,
struct V_121 * V_140 )
{
T_1 V_41 = V_139 -> V_20 -> V_33 ;
...
static void F_77 ( void * V_136 , struct V_137 * V_122 )
{
struct V_16 * V_139 = V_136 ;
struct V_121 * V_140 =
F_74 ( V_122 , struct V_121 , V_127 ) ;
