...
if ( V_8 < 0 ) {
F_5 ( V_4 -> V_12 , L_1 , V_8 ) ;
return;
}
for ( V_10 = 0 ; V_10 < V_4 -> V_13 ; V_10 ++ ) {
V_7 = & V_4 -> V_14 [ V_10 ] ;
if ( V_7 -> V_15 <= V_9 && V_7 -> V_16 >= V_9 ) {
F_6 ( V_4 -> V_17 , V_7 -> V_18 , true ) ;
return;
}
}
for ( V_10 = 0 ; V_10 < V_4 -> V_13 ; V_10 ++ ) {
V_7 = & V_4 -> V_14 [ V_10 ] ;
F_6 ( V_4 -> V_17 , V_7 -> V_18 , false ) ;
}
}
...
V_4 -> V_12 = & V_25 -> V_12 ;
V_4 -> V_17 = F_12 ( & V_25 -> V_12 , V_27 -> V_31 ) ;
if ( F_13 ( V_4 -> V_17 ) ) {
F_5 ( & V_25 -> V_12 , L_3 ) ;
return - V_30 ;
}
...
V_4 -> V_14 = V_27 -> V_14 ;
for ( V_10 = 0 ; V_4 -> V_14 [ V_10 ] . V_18 != V_33 ; V_10 ++ ) ;
V_4 -> V_13 = V_10 ;
V_4 -> V_11 = F_14 ( & V_25 -> V_12 , V_27 -> V_34 ) ;
if ( F_13 ( V_4 -> V_11 ) )
...
static int F_28 ( struct V_40 * V_12 )
{
struct V_3 * V_4 = F_29 ( V_12 ) ;
F_30 ( & V_4 -> V_5 ) ;
if ( F_31 ( V_4 -> V_12 ) )
F_32 ( V_4 -> V_19 ) ;
return 0 ;
}
static int F_33 ( struct V_40 * V_12 )
{
struct V_3 * V_4 = F_29 ( V_12 ) ;
if ( F_31 ( V_4 -> V_12 ) )
F_34 ( V_4 -> V_19 ) ;
