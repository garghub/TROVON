...
const unsigned char * V_54 , bool V_26 )
{
struct V_27 * V_9 = F_25 ( V_4 ) -> V_34 ;
const unsigned char * V_55 = F_36 ( V_4 ) -> V_56 ;
if ( ! F_1 ( V_2 , V_4 ) )
return;
if ( V_4 -> V_9 == V_2 -> V_9 && F_37 ( V_55 , V_54 ) )
return;
V_4 = F_38 ( V_4 , V_35 ) ;
if ( ! V_4 ) {
V_9 -> V_36 . V_37 ++ ;
...
if ( ! F_39 ( V_54 ) )
memcpy ( F_36 ( V_4 ) -> V_57 , V_54 , V_58 ) ;
F_16 ( V_2 , V_4 , V_26 ) ;
}
...
struct V_61 * V_2 ;
struct V_62 * V_63 ;
V_63 = F_42 ( F_43 ( & V_30 -> V_64 ) ) ;
V_2 = V_60 ? F_42 ( V_60 -> V_65 ) : NULL ;
while ( V_2 || V_63 ) {
struct V_1 * V_66 , * V_67 , * V_68 ;
V_67 = V_2 ? V_2 -> V_66 : NULL ;
V_68 = V_63 ? F_44 ( V_63 , struct V_1 , V_69 ) :
NULL ;
if ( ( unsigned long ) V_67 > ( unsigned long ) V_68 ) {
V_66 = V_67 ;
if ( V_66 -> V_7 & V_70 ) {
F_35 ( V_67 , V_4 , V_2 -> V_71 ,
V_26 ) ;
goto V_72;
}
} else {
...
V_33 = F_28 ( V_33 , V_66 , V_4 , V_26 ) ;
V_72:
if ( F_33 ( V_33 ) )
goto V_41;
if ( V_33 == V_66 )
F_34 ( V_66 -> V_30 , V_66 , V_4 , V_45 ,
V_53 ) ;
if ( ( unsigned long ) V_67 >= ( unsigned long ) V_66 )
V_2 = F_42 ( V_2 -> V_73 ) ;
if ( ( unsigned long ) V_68 >= ( unsigned long ) V_66 )
V_63 = F_42 ( F_45 ( V_63 ) ) ;
}
if ( ! V_33 )
goto V_41;
