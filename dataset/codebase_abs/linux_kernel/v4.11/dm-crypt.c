...
if ( F_101 ( F_134 () ) ) {
F_131 ( V_156 ) ;
F_135 ( & V_3 -> V_151 , & V_149 ) ;
break;
}
F_136 () ;
F_131 ( V_156 ) ;
F_129 ( & V_3 -> V_151 . V_152 ) ;
F_137 ( & V_3 -> V_151 , & V_149 ) ;
goto V_153;
V_154:
V_146 = V_3 -> V_146 ;
V_3 -> V_146 = V_157 ;
F_133 ( & V_3 -> V_151 . V_152 ) ;
F_110 ( F_138 ( V_146 . V_158 ) ) ;
F_139 ( & V_148 ) ;
do {
V_106 = F_140 ( F_141 ( & V_146 ) ) ;
F_142 ( & V_106 -> V_158 , & V_146 ) ;
F_126 ( V_106 ) ;
} while ( ! F_130 ( & V_146 ) );
F_143 ( & V_148 ) ;
}
...
static void F_144 ( struct V_105 * V_106 , int V_159 )
{
struct V_81 * V_113 = V_106 -> V_63 . V_82 ;
struct V_2 * V_3 = V_106 -> V_3 ;
unsigned long V_59 ;
...
V_113 -> V_84 . V_140 = V_3 -> V_141 + V_106 -> V_77 ;
if ( F_145 ( ! V_159 ) && F_146 ( V_162 , & V_3 -> V_59 ) ) {
F_120 ( V_113 ) ;
return;
}
F_147 ( & V_3 -> V_151 . V_152 , V_59 ) ;
V_160 = & V_3 -> V_146 . V_158 ;
V_161 = NULL ;
V_77 = V_106 -> V_77 ;
while ( * V_160 ) {
V_161 = * V_160 ;
if ( V_77 < F_140 ( V_161 ) -> V_77 )
V_160 = & ( * V_160 ) -> V_163 ;
else
V_160 = & ( * V_160 ) -> V_164 ;
}
F_148 ( & V_106 -> V_158 , V_161 , V_160 ) ;
F_149 ( & V_106 -> V_158 , & V_3 -> V_146 ) ;
F_150 ( & V_3 -> V_151 ) ;
F_151 ( & V_3 -> V_151 . V_152 , V_59 ) ;
}
...
{
struct V_2 * V_3 = V_106 -> V_3 ;
F_124 ( & V_106 -> V_143 , F_157 ) ;
F_125 ( V_3 -> V_170 , & V_106 -> V_143 ) ;
}
static int F_158 ( T_1 * V_22 , char * V_171 , unsigned int V_112 )
{
char V_172 [ 3 ] ;
unsigned int V_57 ;
V_172 [ 2 ] = '\0' ;
...
static int F_162 ( struct V_2 * V_3 , char * V_173 )
{
unsigned V_57 ;
int V_21 ;
...
static bool F_166 ( const char * V_175 )
{
while ( * V_175 )
if ( isspace ( * V_175 ++ ) )
return true ;
...
static int F_167 ( struct V_2 * V_3 , const char * V_176 )
{
char * V_177 , * V_178 ;
int V_179 ;
struct V_22 * V_22 ;
...
return - V_34 ;
V_177 = F_169 ( V_176 , V_38 ) ;
if ( ! V_177 )
return - V_39 ;
V_22 = F_170 ( V_176 [ 0 ] == 'l' ? & V_182 : & V_183 ,
V_178 + 1 , NULL ) ;
if ( F_19 ( V_22 ) ) {
F_26 ( V_177 ) ;
return F_29 ( V_22 ) ;
...
goto V_78;
if ( V_22 [ 0 ] == ':' ) {
V_28 = F_167 ( V_3 , V_22 + 1 ) ;
goto V_78;
}
F_175 ( V_187 , & V_3 -> V_59 ) ;
F_26 ( V_3 -> V_176 ) ;
V_3 -> V_176 = NULL ;
if ( V_3 -> V_23 && F_158 ( V_3 -> V_22 , V_22 , V_3 -> V_23 ) < 0 )
goto V_78;
V_28 = F_164 ( V_3 ) ;
if ( ! V_28 )
F_176 ( V_187 , & V_3 -> V_59 ) ;
...
V_244 += ! ! V_30 -> V_229 ;
V_244 += F_146 ( V_230 , & V_3 -> V_59 ) ;
V_244 += F_146 ( V_162 , & V_3 -> V_59 ) ;
if ( V_244 ) {
F_213 ( L_70 , V_244 ) ;
if ( V_30 -> V_229 )
F_213 ( L_71 ) ;
