...
return - V_124 ;
V_89 = F_117 ( V_9 , ( V_141 -> V_14 & V_210 ) ? V_141 -> V_146 . V_89 : - 1 ) ;
if ( V_89 == NULL )
return - V_54 ;
if ( V_9 -> type == V_44 && V_141 -> V_204 ) {
F_118 ( V_9 , V_89 -> V_146 . V_89 ) ;
return - V_136 ;
}
if ( V_9 -> type == V_45 ) {
...
V_89 -> V_211 = V_209 -> V_211 ;
V_89 -> V_128 = V_209 -> V_128 ;
V_89 -> V_137 . V_212 = V_209 -> V_213 ;
V_89 -> V_137 . V_214 = V_209 -> V_215 ;
V_89 -> V_216 . V_212 = V_209 -> V_217 ;
V_89 -> V_216 . V_214 = V_209 -> V_218 ;
}
}
...
V_81 . type = V_226 ;
V_81 . V_57 . V_227 . V_92 = V_141 -> V_92 ;
V_81 . V_57 . V_227 . V_222 = V_141 -> V_222 ;
return F_128 ( V_9 , V_89 , & V_81 ) ;
}
static int F_129 ( struct V_8 * V_9 ,
void * V_183 )
{
struct V_221 * V_130 = V_183 ;
int V_69 = - V_136 ;
struct V_8 * V_228 = NULL , * V_222 = NULL ;
struct V_88 * V_219 = NULL , * V_220 = NULL ;
if ( ( V_228 = F_6 ( V_130 -> V_92 . V_9 ) ) == NULL )
goto V_229;
if ( ( V_222 = F_6 ( V_130 -> V_222 . V_9 ) ) == NULL )
goto V_229;
if ( ( V_219 = F_73 ( V_222 , V_130 -> V_222 . V_89 ) ) == NULL )
goto V_229;
if ( ( V_220 = F_73 ( V_228 , V_130 -> V_92 . V_89 ) ) == NULL )
goto V_229;
V_69 = F_126 ( V_9 , V_219 , V_220 , V_130 ) ;
if ( V_69 < 0 )
goto V_229;
V_69 = F_130 ( V_9 , V_222 , V_219 , V_228 , V_220 , V_130 ) ;
if ( ! V_69 )
F_127 ( V_151 , 0 ,
V_130 , V_230 ) ;
V_229:
...
if ( V_69 < 0 )
goto V_229;
V_69 = F_132 ( V_9 , V_222 , V_219 , V_228 , V_220 , V_130 ) ;
if ( ! V_69 )
F_127 ( V_151 , 0 ,
V_130 , V_231 ) ;
V_229:
...
{
struct V_232 * V_141 = V_183 ;
int V_69 ;
struct V_112 * V_113 ;
V_69 = F_134 ( V_9 -> V_42 , V_141 -> V_233 , V_141 -> V_14 ) ;
if ( V_69 < 0 )
return V_69 ;
V_113 = F_68 ( V_69 ) ;
if ( V_113 == NULL )
...
static int F_135 ( struct V_8 * V_9 , void * V_183 )
{
struct V_232 * V_141 = V_183 ;
return F_136 ( V_9 -> V_42 , V_141 -> V_102 ) ;
}
...
return - V_136 ;
if ( F_139 ( V_141 -> V_102 , V_9 -> V_42 ) ) {
if ( F_140 ( V_141 -> V_102 , V_9 -> V_42 , V_141 -> V_233 ) < 0 )
return - V_124 ;
if ( V_141 -> V_233 )
F_141 ( V_141 -> V_102 , V_9 -> V_42 , 1 ) ;
} else {
return - V_124 ;
}
V_113 = F_68 ( V_141 -> V_102 ) ;
...
void * V_183 )
{
struct V_234 * V_235 = V_183 ;
struct V_112 * V_102 ;
struct V_236 * V_237 ;
V_102 = F_68 ( V_235 -> V_102 ) ;
if ( V_102 == NULL )
return - V_136 ;
memset ( V_235 , 0 , sizeof( * V_235 ) ) ;
V_235 -> V_102 = V_102 -> V_102 ;
V_237 = V_102 -> V_115 ;
V_235 -> V_238 = V_102 -> V_239 -> V_240 + V_102 -> V_241 -> V_240 ;
V_235 -> time = F_69 ( V_237 ) ;
V_235 -> V_117 = F_70 ( V_237 ) ;
V_235 -> V_242 = V_237 -> V_242 ;
V_235 -> V_14 = V_102 -> V_14 ;
F_71 ( V_102 ) ;
return 0 ;
}
...
void * V_183 )
{
struct V_243 * V_244 = V_183 ;
struct V_112 * V_102 ;
struct V_236 * V_237 ;
V_102 = F_68 ( V_244 -> V_102 ) ;
if ( V_102 == NULL )
return - V_136 ;
memset ( V_244 , 0 , sizeof( * V_244 ) ) ;
V_244 -> V_102 = V_102 -> V_102 ;
V_237 = V_102 -> V_115 ;
V_244 -> V_244 = V_237 -> V_244 ;
V_244 -> V_245 = V_237 -> V_245 ;
V_244 -> V_246 = V_237 -> V_247 ;
V_244 -> V_248 = V_237 -> V_248 ;
F_71 ( V_102 ) ;
return 0 ;
}
int F_146 ( int V_9 , struct V_243 * V_244 )
{
if ( ! F_139 ( V_244 -> V_102 , V_9 ) )
return - V_124 ;
return F_147 ( V_244 -> V_102 , V_9 , V_244 ) ;
}
...
V_115 -> type = V_237 -> type ;
if ( V_237 -> type == V_251 ) {
V_115 -> V_252 . V_253 . V_254 = V_237 -> V_255 ;
V_115 -> V_252 . V_253 . V_256 = V_237 -> V_257 ;
}
F_36 ( & V_102 -> V_250 ) ;
F_71 ( V_102 ) ;
return 0 ;
...
V_237 = V_113 -> V_115 ;
F_151 ( V_115 -> V_102 ) ;
V_237 -> type = V_115 -> type ;
if ( V_237 -> type == V_251 ) {
V_237 -> V_255 = V_115 -> V_252 . V_253 . V_254 ;
V_237 -> V_257 = V_115 -> V_252 . V_253 . V_256 ;
}
V_69 = F_152 ( V_115 -> V_102 ) ;
F_36 ( & V_113 -> V_250 ) ;
F_71 ( V_113 ) ;
} else {
return - V_124 ;
...
void * V_183 )
{
struct V_258 * V_141 = V_183 ;
int V_259 ;
V_259 = F_90 ( V_141 -> V_102 , V_9 -> V_42 ) ;
if ( V_259 < 0 )
return - V_136 ;
V_141 -> V_259 = V_259 ;
V_141 -> V_9 = V_9 -> V_42 ;
...
int V_51 ;
if ( V_141 -> V_259 >= 0 ) {
V_51 = F_141 ( V_141 -> V_102 , V_9 -> V_42 , V_141 -> V_259 ) ;
if ( V_51 < 0 )
return V_51 ;
}
return F_153 ( V_9 , V_183 ) ;
}
static int F_155 ( struct V_8 * V_9 ,
void * V_183 )
{
struct V_260 * V_141 = V_183 ;
struct V_8 * V_197 ;
V_197 = F_6 ( V_141 -> V_9 ) ;
if ( V_197 == NULL )
return - V_120 ;
memset ( V_141 , 0 , sizeof( * V_141 ) ) ;
V_141 -> V_9 = V_197 -> V_42 ;
V_141 -> V_261 = V_197 -> V_10 -> V_168 ;
V_141 -> V_262 = V_197 -> V_10 -> V_263 ;
V_141 -> V_264 = V_141 -> V_261 ;
V_141 -> V_264 = F_156 ( V_197 -> V_10 ) ;
if ( V_197 -> type == V_44 ) {
V_141 -> V_265 = V_197 -> V_57 . V_50 . V_59 ;
V_141 -> V_266 = V_141 -> V_265 ;
if ( V_197 -> V_57 . V_50 . V_58 )
V_141 -> V_266 = F_156 ( V_197 -> V_57 . V_50 . V_58 -> V_10 ) ;
} else {
V_141 -> V_265 = 0 ;
V_141 -> V_266 = 0 ;
}
...
return - V_136 ;
if ( V_141 -> V_261 >= 1 && V_141 -> V_261 <= V_268 &&
( ! F_2 ( V_9 ) ||
V_141 -> V_261 != V_9 -> V_10 -> V_168 ) ) {
if ( F_2 ( V_9 ) ) {
F_158 ( V_9 -> V_10 ) ;
F_159 ( V_9 -> V_42 ) ;
F_160 ( V_9 -> V_10 ) ;
}
V_9 -> V_10 -> V_168 = V_141 -> V_261 ;
V_267 = F_96 ( V_9 -> V_10 ) ;
if ( V_267 < 0 )
return V_267 ;
}
...
V_141 -> V_265 >= 1 &&
V_141 -> V_265 <= V_269 &&
V_141 -> V_265 != V_9 -> V_57 . V_50 . V_59 ) {
V_267 = F_161 ( V_9 -> V_57 . V_50 . V_58 , V_141 -> V_265 ) ;
if ( V_267 < 0 )
return V_267 ;
V_9 -> V_57 . V_50 . V_59 = V_141 -> V_265 ;
}
if ( V_141 -> V_262 >= 1 &&
V_141 -> V_262 <= V_9 -> V_10 -> V_168 ) {
V_9 -> V_10 -> V_263 = V_141 -> V_262 ;
}
return F_155 ( V_9 , V_183 ) ;
}
static int F_162 ( struct V_8 * V_9 ,
void * V_183 )
{
struct V_270 * V_141 = V_183 ;
if ( V_141 -> V_271 & V_272 ) {
if ( V_9 -> type == V_44 && V_9 -> V_57 . V_50 . V_58 )
F_52 ( V_9 -> V_57 . V_50 . V_58 ) ;
}
if ( V_141 -> V_271 & V_273 )
F_163 ( V_9 -> V_42 , V_141 ) ;
return 0 ;
}
...
struct V_221 * V_130 = V_183 ;
int V_69 ;
struct V_8 * V_222 = NULL ;
struct V_88 * V_219 = NULL ;
struct V_129 * V_274 ;
V_69 = - V_136 ;
if ( ( V_222 = F_6 ( V_130 -> V_222 . V_9 ) ) == NULL )
goto V_229;
if ( ( V_219 = F_73 ( V_222 , V_130 -> V_222 . V_89 ) ) == NULL )
goto V_229;
V_274 = F_165 ( & V_219 -> V_137 , & V_130 -> V_92 ) ;
if ( V_274 ) {
V_69 = 0 ;
* V_130 = V_274 -> V_141 ;
} else
...
static int F_166 ( struct V_8 * V_9 , void * V_183 )
{
struct V_275 * V_130 = V_183 ;
int V_69 = - V_72 ;
...
struct V_277 * V_274 ;
int V_278 ;
if ( ( V_197 = F_6 ( V_130 -> V_279 . V_9 ) ) == NULL )
goto V_229;
if ( ( V_89 = F_73 ( V_197 , V_130 -> V_279 . V_89 ) ) == NULL )
goto V_229;
switch ( V_130 -> type ) {
case V_280 :
V_276 = & V_89 -> V_137 ;
...
F_78 ( & V_276 -> V_139 ) ;
V_130 -> V_282 = V_276 -> V_66 ;
V_278 = 0 ;
V_69 = - V_120 ;
F_167 (p, &group->list_head) {
if ( V_278 ++ == V_130 -> V_283 ) {
struct V_129 * V_284 ;
if ( V_130 -> type == V_280 ) {
V_284 = F_168 ( V_274 , struct V_129 , V_285 ) ;
V_130 -> V_146 = V_284 -> V_141 . V_92 ;
} else {
V_284 = F_168 ( V_274 , struct V_129 , V_286 ) ;
V_130 -> V_146 = V_284 -> V_141 . V_222 ;
}
V_130 -> V_14 = V_284 -> V_141 . V_14 ;
V_130 -> V_102 = V_284 -> V_141 . V_102 ;
V_69 = 0 ;
break;
}
}
...
static long F_172 ( struct V_1 * V_1 , unsigned int V_287 ,
unsigned long V_183 )
{
struct V_8 * V_9 = V_1 -> V_61 ;
union {
...
if ( F_50 ( ! V_9 ) )
return - V_72 ;
for ( V_300 = V_301 ; V_300 -> V_287 > 0 ; ++ V_300 ) {
if ( V_300 -> V_287 == V_287 )
break;
}
if ( V_300 -> V_287 == 0 )
return - V_302 ;
memset ( & V_65 , 0 , sizeof( V_65 ) ) ;
V_168 = F_173 ( V_300 -> V_287 ) ;
if ( V_300 -> V_287 & V_303 ) {
if ( F_97 ( & V_65 , ( const void T_3 * ) V_183 , V_168 ) )
return - V_74 ;
}
V_51 = V_300 -> V_304 ( V_9 , & V_65 ) ;
if ( V_51 >= 0 ) {
if ( V_300 -> V_287 == V_305 ||
V_300 -> V_287 == V_306 ||
( V_300 -> V_287 & V_307 ) )
...
int F_174 ( struct V_308 * V_25 , int V_34 ,
const char * V_309 , ... )
{
struct V_8 * V_9 ;
T_7 args ;
...
va_start ( args , V_309 ) ;
vsnprintf ( V_9 -> V_62 , sizeof( V_9 -> V_62 ) , V_309 , args ) ;
va_end ( args ) ;
V_9 -> type = V_45 ;
F_36 ( & V_43 ) ;
F_44 ( V_9 -> V_42 ) ;
...
static int F_176 ( int V_9 , struct V_77 * V_153 ,
struct V_1 * V_1 , int V_163 ,
int V_96 , int V_97 )
{
struct V_8 * V_197 ;
...
int F_177 ( int V_9 , struct V_77 * V_153 ,
int V_96 , int V_97 )
{
return F_176 ( V_9 , V_153 , NULL , 0 , V_96 , V_97 ) ;
}
int F_178 ( int V_9 , struct V_77 * V_153 ,
struct V_1 * V_1 ,
int V_96 , int V_97 )
{
return F_176 ( V_9 , V_153 , V_1 , 1 , V_96 , V_97 ) ;
}
int F_179 ( int V_9 , struct V_77 * V_153 ,
int V_96 , int V_97 )
{
struct V_8 * V_197 ;
int V_69 ;
...
int F_180 ( int V_11 , unsigned int V_287 , void * V_183 )
{
const struct V_299 * V_300 ;
struct V_8 * V_9 ;
V_9 = F_4 ( V_11 ) ;
...
for ( V_300 = V_301 ; V_300 -> V_287 > 0 ; ++ V_300 ) {
if ( V_300 -> V_287 == V_287 )
return V_300 -> V_304 ( V_9 , V_183 ) ;
}
F_5 ( L_9 ,
V_287 , F_181 ( V_287 ) , F_182 ( V_287 ) ) ;
return - V_302 ;
}
int F_183 ( int V_11 , struct V_1 * V_1 , T_6 * V_177 )
{
struct V_8 * V_9 ;
V_9 = F_4 ( V_11 ) ;
if ( V_9 == NULL )
...
struct V_134 * V_276 ,
int V_313 , char * V_314 )
{
struct V_277 * V_274 ;
struct V_129 * V_284 ;
int V_66 = 0 ;
F_78 ( & V_276 -> V_139 ) ;
if ( F_185 ( & V_276 -> V_277 ) ) {
F_81 ( & V_276 -> V_139 ) ;
return;
}
F_186 ( V_312 , V_314 ) ;
...
F_186 ( V_312 , L_10 ) ;
F_186 ( V_312 , L_11 ,
V_313 ? V_284 -> V_141 . V_92 . V_9 : V_284 -> V_141 . V_222 . V_9 ,
V_313 ? V_284 -> V_141 . V_92 . V_89 : V_284 -> V_141 . V_222 . V_89 ) ;
if ( V_284 -> V_141 . V_14 & V_142 )
F_186 ( V_312 , L_12 , ( ( V_284 -> V_141 . V_14 & V_143 ) ? 'r' : 't' ) , V_284 -> V_141 . V_102 ) ;
if ( V_276 -> V_315 )
F_186 ( V_312 , L_13 ) ;
}
F_81 ( & V_276 -> V_139 ) ;
...
static void F_187 ( struct V_311 * V_312 ,
struct V_8 * V_9 )
{
struct V_88 * V_274 ;
F_33 ( & V_9 -> V_40 ) ;
...
F_186 ( V_312 , L_15 ,
V_274 -> V_146 . V_89 , V_274 -> V_62 ,
F_188 ( V_274 -> V_90 ) ,
F_189 ( V_274 -> V_90 ) ,
F_190 ( V_274 -> V_90 ) ,
F_191 ( V_274 -> V_90 ) ) ;
F_184 ( V_312 , & V_274 -> V_137 , 1 , L_16 ) ;
F_184 ( V_312 , & V_274 -> V_216 , 0 , L_17 ) ;
}
F_36 ( & V_9 -> V_40 ) ;
}
void F_192 ( struct V_316 * V_317 ,
struct V_311 * V_312 )
{
int V_36 ;
struct V_8 * V_9 ;
F_186 ( V_312 , L_18 ) ;
F_186 ( V_312 , L_19 , V_46 . V_32 ) ;
F_186 ( V_312 , L_20 , V_46 . V_33 ) ;
F_186 ( V_312 , L_21 , V_12 ) ;
F_186 ( V_312 , L_14 ) ;
...
if ( F_2 ( V_9 ) ) {
F_186 ( V_312 , L_25 ) ;
F_193 ( V_312 , V_9 -> V_10 , L_26 ) ;
}
if ( V_9 -> type == V_44 && V_9 -> V_57 . V_50 . V_58 &&
V_9 -> V_57 . V_50 . V_58 -> V_10 ) {
F_186 ( V_312 , L_27 ) ;
F_193 ( V_312 , V_9 -> V_57 . V_50 . V_58 -> V_10 , L_26 ) ;
}
F_64 ( V_9 ) ;
}
}
