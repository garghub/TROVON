...
struct V_1 * V_2 ;
struct V_18 * V_19 ;
unsigned short * V_39 = F_26 ( & V_5 -> V_10 ) ;
int V_6 = 0 ;
int V_40 ;
if ( ! V_39 ) {
F_4 ( & V_5 -> V_10 , L_17 ) ;
...
F_31 ( V_2 -> V_14 ) ;
V_19 -> V_24 = F_30 ( V_5 ) -> V_24 ;
V_19 -> V_10 . V_42 = & V_5 -> V_10 ;
V_19 -> V_43 = & V_44 ;
V_19 -> V_45 = V_46 ;
if ( V_5 -> V_31 ) {
V_6 = F_32 ( & V_5 -> V_10 , V_5 -> V_31 ,
NULL ,
& F_19 ,
V_47 | V_48 ,
V_19 -> V_24 ,
