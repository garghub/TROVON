...
static void F_62 ( struct V_38 * V_122 )
{
F_63 ( V_122 ) ;
}
static int F_64 ( struct V_54 * V_55 , const struct V_123 * V_124 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
T_6 V_125 = F_65 ( V_124 ) / sizeof( V_126 ) ;
const V_126 * V_7 = F_66 ( V_124 ) ;
T_7 * V_127 ;
struct V_38 * V_122 ;
int V_128 ;
T_6 V_129 ;
...
V_127 = F_69 ( V_55 ) ;
F_70 ( V_127 ) ;
F_71 ( V_15 -> V_106 , V_122 ) ;
F_72 ( V_127 ) ;
F_62 ( V_122 ) ;
return 0 ;
}
static void F_73 ( struct V_14 * V_15 , const struct V_123 * V_124 )
{
const struct V_136 * V_137 = F_66 ( V_124 ) ;
...
static int F_82 ( struct V_123 * V_162 [] , int V_163 , struct V_123 * V_164 ,
const struct V_165 * V_166 , int V_45 )
{
int V_167 = F_65 ( V_164 ) - F_83 ( V_45 ) ;
if ( V_167 < 0 ) {
F_81 ( L_4 , V_167 ) ;
return - V_131 ;
}
if ( V_167 >= F_84 ( 0 ) )
return F_85 ( V_162 , V_163 , F_66 ( V_164 ) + F_83 ( V_45 ) ,
V_167 , V_166 ) ;
memset ( V_162 , 0 , sizeof( struct V_123 * ) * ( V_163 + 1 ) ) ;
return 0 ;
}
static int F_86 ( struct V_54 * V_55 , struct V_123 * V_168 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
...
return - V_131 ;
V_171 = F_66 ( V_168 ) ;
V_174 = F_82 ( V_162 , V_169 , V_168 , V_175 , sizeof( * V_171 ) ) ;
if ( V_174 < 0 )
return V_174 ;
V_172 = V_15 -> V_17 ;
V_173 = V_15 -> V_30 ;
if ( V_162 [ V_176 ] ) {
V_174 = F_78 ( V_15 , V_162 [ V_176 ] ) ;
if ( V_174 ) {
V_15 -> V_30 = V_173 ;
return V_174 ;
}
...
V_15 -> V_101 = ~ 0 ;
if ( V_162 [ V_178 ] )
F_73 ( V_15 , V_162 [ V_178 ] ) ;
if ( V_162 [ V_179 ] )
F_74 ( V_15 , V_162 [ V_179 ] ) ;
if ( V_162 [ V_180 ] )
F_75 ( V_15 , V_162 [ V_180 ] ) ;
if ( V_162 [ V_181 ] )
F_76 ( V_15 , V_162 [ V_181 ] ) ;
if ( V_162 [ V_182 ] )
V_15 -> V_53 = F_47 ( T_2 , V_15 -> V_53 ,
F_87 ( V_162 [ V_182 ] ) ) ;
if ( V_162 [ V_183 ] )
V_15 -> V_84 = F_88 ( V_162 [ V_183 ] ) ;
return V_174 ;
}
static int F_89 ( struct V_54 * V_55 , struct V_123 * V_168 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
int V_174 ;
if ( ! V_168 )
return - V_131 ;
F_90 ( & V_15 -> V_121 , V_55 ) ;
V_15 -> V_30 = V_31 ;
V_174 = F_86 ( V_55 , V_168 ) ;
if ( V_174 )
F_81 ( L_5 ) ;
return V_174 ;
}
...
static int F_93 ( const struct V_14 * V_15 ,
struct V_1 * V_6 )
{
struct V_123 * V_184 ;
V_184 = F_94 ( V_6 , V_176 ) ;
if ( V_184 == NULL )
goto V_185;
switch ( V_15 -> V_30 ) {
case V_31 :
...
if ( F_96 ( V_6 , V_149 , sizeof( V_151 ) , & V_151 ) )
goto V_185;
break;
}
case V_35 : {
...
if ( F_96 ( V_6 , V_157 , sizeof( V_159 ) , & V_159 ) )
goto V_185;
break;
}
}
...
static int F_98 ( struct V_54 * V_55 , struct V_1 * V_6 )
{
const struct V_14 * V_15 = F_17 ( V_55 ) ;
struct V_123 * V_164 = (struct V_123 * ) F_99 ( V_6 ) ;
struct V_170 V_171 ;
struct V_136 V_186 ;
struct V_141 V_101 ;
struct V_145 V_92 ;
...
V_53 . V_48 = V_15 -> V_48 ;
V_53 . V_51 = V_15 -> V_51 ;
if ( F_96 ( V_6 , V_181 , sizeof( V_53 ) , & V_53 ) )
goto V_185;
if ( V_15 -> V_84 && F_101 ( V_6 , V_183 , V_15 -> V_84 ) )
goto V_185;
if ( F_93 ( V_15 , V_6 ) != 0 )
goto V_185;
return F_97 ( V_6 , V_164 ) ;
V_185:
F_102 ( V_6 , V_164 ) ;
return - 1 ;
}
static int F_103 ( struct V_54 * V_55 , unsigned long V_189 ,
...
static int F_105 ( struct V_54 * V_55 , unsigned long V_196 , struct V_54 * V_197 ,
struct V_54 * * V_198 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
* V_198 = F_106 ( V_55 , V_197 , & V_15 -> V_117 ) ;
return 0 ;
}
static struct V_54 * F_107 ( struct V_54 * V_55 , unsigned long V_196 )
{
struct V_14 * V_15 = F_17 ( V_55 ) ;
return V_15 -> V_117 ;
}
static unsigned long F_108 ( struct V_54 * V_55 , T_1 V_199 )
{
return 1 ;
}
static void F_109 ( struct V_54 * V_55 , unsigned long V_196 )
{
}
static void F_110 ( struct V_54 * V_55 , struct V_200 * V_201 )
{
if ( ! V_201 -> V_202 ) {
