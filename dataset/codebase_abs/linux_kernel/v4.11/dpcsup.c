...
V_66 = F_26 ( V_71 ,
V_52 ,
sizeof( struct V_7 ) - sizeof( struct V_72 ) ,
V_73 ,
0 , 1 ,
( V_74 ) F_21 , V_52 ) ;
}
unsigned int F_23 ( struct V_3 * V_4 , T_1 V_15 , int V_75 ,
int V_76 , struct V_7 * V_77 )
{
unsigned long V_12 ;
F_27 ( ( V_78 L_1 , V_4 , V_15 ) ) ;
if ( V_75 == 1 ) {
struct V_7 * V_7 ;
struct V_9 * V_9 ;
...
memcpy ( V_7 , V_77 , sizeof( struct V_7 ) ) ;
} else {
memcpy ( V_7 , (struct V_7 * )
( ( ( V_80 ) ( V_4 -> V_81 . V_82 ) ) + V_15 ) ,
sizeof( struct V_7 ) ) ;
}
F_17 ( & V_9 -> V_56 ) ;
V_9 -> type = V_57 ;
