...
if ( V_8 )
return V_8 ;
if ( ! V_55 -> V_72 -> V_73 -> V_75 )
return - V_76 ;
V_8 = V_55 -> V_72 -> V_73 -> V_75 ( V_55 , & V_31 , sizeof( V_31 ) ) ;
if ( V_8 < 0 ) {
if ( ! F_37 ( V_55 ) ||
V_55 -> V_72 -> V_73 -> V_77 ( V_55 ) )
return V_8 ;
...
if ( ! V_32 )
goto V_21;
V_8 = F_18 ( V_29 , & V_31 , V_32 , V_86 ) ;
if ( V_8 && V_55 -> V_72 -> V_73 -> V_87 ) {
int V_88 = F_18 ( V_29 , & V_31 , V_32 ,
V_55 -> V_72 -> V_73 -> V_87 ) ;
if ( V_88 ) {
if ( V_88 == - V_47 )
V_8 = - V_47 ;
