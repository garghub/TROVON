...
if ( ( V_4 -> V_5 & V_22 ) && V_15 ) {
V_32 = F_28 ( & V_28 -> V_33 , V_15 , F_10 ,
V_48 | V_49 |
V_50 , V_28 -> V_51 , V_28 ) ;
if ( V_32 ) {
F_29 ( & V_28 -> V_33 ,
...
{
struct V_3 * V_4 = F_11 ( V_28 ) ;
F_4 ( & V_4 -> V_2 ) ;
F_36 ( & V_4 -> V_2 ) ;
return 0 ;
}
static int F_37 ( struct V_53 * V_33 )
{
struct V_3 * V_4 = F_38 ( V_33 ) ;
F_3 ( V_4 , V_7 , V_4 -> V_5 & ~ V_6 ) ;
if ( V_4 -> V_5 & V_6 )
F_3 ( V_4 , V_7 , V_4 -> V_5 ) ;
return 0 ;
}
