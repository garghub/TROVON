...
static struct V_5 * F_23 ( struct V_79 * V_75 )
{
struct V_5 * V_6 ;
struct V_80 * V_81 ;
F_3 ( 3 , L_39 ) ;
F_24 (item, &mc_devices) {
V_6 = F_25 ( V_81 , struct V_5 , V_82 ) ;
if ( V_6 -> V_40 == V_75 )
return V_6 ;
}
return NULL ;
}
struct V_5 * F_26 ( struct V_79 * V_75 )
{
struct V_5 * V_76 ;
F_20 ( & V_77 ) ;
V_76 = F_23 ( V_75 ) ;
...
{
struct V_89 * V_90 = F_29 ( V_88 ) ;
struct V_5 * V_6 = F_30 ( V_90 ) ;
F_20 ( & V_77 ) ;
if ( V_6 -> V_73 != V_91 ) {
F_22 ( & V_77 ) ;
return;
...
V_6 -> V_35 ( V_6 ) ;
F_22 ( & V_77 ) ;
F_31 ( & V_6 -> V_92 , F_32 ( F_33 () ) ) ;
}
void F_34 ( unsigned long V_93 )
{
struct V_5 * V_6 ;
struct V_80 * V_81 ;
F_20 ( & V_77 ) ;
...
goto V_95;
F_24 (item, &mc_devices) {
V_10 = F_25 ( V_81 , struct V_5 , V_82 ) ;
if ( V_10 -> V_71 >= V_6 -> V_71 ) {
if ( F_37 ( V_10 -> V_71 == V_6 -> V_71 ) )
goto V_96;
V_94 = V_81 ;
break;
}
...
F_40 ( V_98 , V_99 ,
L_40 , F_41 ( V_10 -> V_40 ) ,
F_42 ( V_6 ) , V_10 -> V_41 , V_10 -> V_42 , V_10 -> V_71 ) ;
return 1 ;
V_96:
F_40 ( V_98 , V_99 ,
L_41
...
struct V_5 * F_55 ( struct V_79 * V_75 )
{
struct V_5 * V_6 ;
F_3 ( 0 , L_39 ) ;
F_20 ( & V_77 ) ;
