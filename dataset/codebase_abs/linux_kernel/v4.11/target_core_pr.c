...
if ( V_2 -> V_7 ) {
V_3 [ V_295 ++ ] |= 0x01 ;
V_3 [ V_295 ++ ] = ( V_2 -> V_166 & 0xf0 ) |
( V_2 -> V_8 & 0x0f ) ;
} else if ( V_62 ) {
V_3 [ V_295 ++ ] |= 0x01 ;
V_3 [ V_295 ++ ] = ( V_166 & 0xf0 ) |
( V_8 & 0x0f ) ;
} else {
V_295 += 2 ;
}
