...
int V_32 ;
if ( V_23 -> V_36 [ 0 ] )
F_24 ( V_36 , V_23 -> V_36 , V_37 ) ;
else
sprintf ( V_36 , L_1 ) ;
V_18 = F_25 ( sizeof( * V_10 ) , V_36 , V_38 , V_39 ) ;
if ( ! V_18 )
goto V_40;
F_26 ( V_18 , V_7 ) ;
V_10 = F_19 ( V_18 ) ;
...
V_10 = F_4 ( F_20 ( V_45 -> V_18 ) , & V_132 -> V_49 , & V_132 -> V_48 ) ;
if ( ! V_10 )
return - 1 ;
...
static void
F_92 ( struct V_22 * V_23 , const struct V_149 * V_150 )
{
V_23 -> V_16 = V_150 -> V_16 ;
V_23 -> V_17 = V_150 -> V_17 ;
V_23 -> V_147 = V_150 -> V_147 ;
V_23 -> V_74 = V_150 -> V_74 ;
V_23 -> V_117 = V_150 -> V_117 ;
V_23 -> V_50 = V_150 -> V_50 ;
memcpy ( V_23 -> V_36 , V_150 -> V_36 , sizeof( V_150 -> V_36 ) ) ;
}
static void
F_93 ( struct V_149 * V_150 , const struct V_22 * V_23 )
{
V_150 -> V_16 = V_23 -> V_16 ;
V_150 -> V_17 = V_23 -> V_17 ;
V_150 -> V_147 = V_23 -> V_147 ;
V_150 -> V_74 = V_23 -> V_74 ;
V_150 -> V_117 = V_23 -> V_117 ;
if ( V_150 -> V_74 )
V_150 -> V_151 |= V_152 ;
if ( V_150 -> V_117 )
V_150 -> V_153 |= V_152 ;
V_150 -> V_50 = V_23 -> V_50 ;
memcpy ( V_150 -> V_36 , V_23 -> V_36 , sizeof( V_150 -> V_36 ) ) ;
}
static int
F_94 ( struct V_30 * V_18 , struct V_154 * V_155 , int V_156 )
{
int V_32 = 0 ;
struct V_149 V_23 ;
struct V_22 V_157 ;
...
case V_158 :
if ( V_18 == V_12 -> V_43 ) {
if ( F_95 ( & V_23 , V_155 -> V_159 . V_160 , sizeof( V_23 ) ) ) {
V_32 = - V_161 ;
break;
}
F_92 ( & V_157 , & V_23 ) ;
V_10 = F_27 ( V_7 , & V_157 , 0 ) ;
} else {
...
V_10 = F_19 ( V_18 ) ;
F_93 ( & V_23 , & V_10 -> V_15 ) ;
if ( F_96 ( V_155 -> V_159 . V_160 , & V_23 , sizeof( V_23 ) ) )
V_32 = - V_161 ;
break;
case V_162 :
case V_163 :
V_32 = - V_75 ;
if ( ! F_97 ( V_7 -> V_164 , V_165 ) )
break;
V_32 = - V_161 ;
if ( F_95 ( & V_23 , V_155 -> V_159 . V_160 , sizeof( V_23 ) ) )
break;
...
break;
F_92 ( & V_157 , & V_23 ) ;
V_10 = F_27 ( V_7 , & V_157 , V_156 == V_162 ) ;
if ( V_18 != V_12 -> V_43 && V_156 == V_163 ) {
if ( V_10 ) {
if ( V_10 -> V_18 != V_18 ) {
V_32 = - V_166 ;
break;
...
V_18 -> V_172 = F_15 ;
V_18 -> type = V_173 ;
V_18 -> V_174 = V_175 + sizeof( struct V_46 ) ;
V_18 -> V_92 = V_176 ;
V_18 -> V_177 = V_102 ;
V_18 -> V_178 = V_179 ;
V_18 -> V_19 |= V_180 ;
V_18 -> V_181 = sizeof( struct V_1 ) ;
F_99 ( V_18 ) ;
V_18 -> V_182 = V_183 ;
F_100 ( V_18 -> V_184 ) ;
}
...
static int F_105 ( struct V_186 * V_187 [] , struct V_186 * V_133 [] )
{
return 0 ;
}
static void F_106 ( struct V_186 * V_133 [] ,
struct V_22 * V_15 )
{
...
return;
if ( V_133 [ V_188 ] )
V_15 -> V_147 = F_107 ( V_133 [ V_188 ] ) ;
if ( V_133 [ V_189 ] )
V_15 -> V_16 = F_108 ( V_133 [ V_189 ] ) ;
if ( V_133 [ V_190 ] )
V_15 -> V_17 = F_108 ( V_133 [ V_190 ] ) ;
if ( V_133 [ V_191 ] )
V_15 -> V_74 = F_109 ( V_133 [ V_191 ] ) ;
if ( V_133 [ V_192 ] )
V_15 -> V_117 = F_109 ( V_133 [ V_192 ] ) ;
}
static int F_110 ( struct V_7 * V_193 , struct V_30 * V_18 ,
struct V_186 * V_187 [] , struct V_186 * V_133 [] )
{
struct V_7 * V_7 = F_20 ( V_18 ) ;
struct V_6 * V_194 ;
V_194 = F_19 ( V_18 ) ;
F_106 ( V_133 , & V_194 -> V_15 ) ;
V_194 -> V_15 . V_50 = V_51 ;
if ( F_27 ( V_7 , & V_194 -> V_15 , 0 ) )
return - V_166 ;
return F_18 ( V_18 ) ;
}
static void F_111 ( struct V_30 * V_18 , struct V_195 * V_196 )
{
struct V_7 * V_7 = F_20 ( V_18 ) ;
struct V_11 * V_12 = F_5 ( V_7 , V_13 ) ;
if ( V_18 != V_12 -> V_43 )
...
static int F_113 ( struct V_30 * V_18 , struct V_186 * V_187 [] ,
struct V_186 * V_133 [] )
{
struct V_6 * V_10 ;
struct V_22 V_23 ;
...
struct V_22 * V_197 = & V_63 -> V_15 ;
if ( F_117 ( V_45 , V_188 , V_197 -> V_147 ) ||
F_118 ( V_45 , V_189 , & V_197 -> V_16 ) ||
F_118 ( V_45 , V_190 , & V_197 -> V_17 ) ||
F_119 ( V_45 , V_191 , V_197 -> V_74 ) ||
F_119 ( V_45 , V_192 , V_197 -> V_117 ) )
goto V_198;
return 0 ;
V_198:
return - V_106 ;
...
struct V_6 * V_10 ;
F_121 ( V_199 ) ;
for ( V_24 = 0 ; V_24 < V_200 ; V_24 ++ ) {
V_10 = F_13 ( V_12 -> V_201 [ V_24 ] ) ;
while ( V_10 ) {
F_112 ( V_10 -> V_18 , & V_199 ) ;
V_10 = F_13 ( V_10 -> V_28 ) ;
}
}
...
goto V_213;
V_210 = L_5 ;
V_32 = F_135 ( & V_214 , V_135 ) ;
if ( V_32 < 0 )
goto V_215;
V_32 = F_135 ( & V_216 , V_136 ) ;
if ( V_32 < 0 )
goto V_217;
V_32 = F_135 ( & V_218 , V_137 ) ;
if ( V_32 < 0 )
goto V_219;
V_210 = L_6 ;
V_32 = F_136 ( & V_34 ) ;
