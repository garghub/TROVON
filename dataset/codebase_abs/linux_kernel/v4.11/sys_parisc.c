...
unsigned long V_4 )
{
return F_23 ( V_5 , V_15 , V_53 , V_16 , V_54 ,
V_4 >> ( V_3 - 12 ) ) ;
}
...
T_1 long F_25 ( const char T_2 * V_56 ,
unsigned int V_57 , unsigned int V_58 )
{
return F_26 ( V_56 , ( long ) V_57 << 32 | V_58 ) ;
}
T_1 long F_27 ( unsigned int V_54 ,
unsigned int V_57 , unsigned int V_58 )
{
return F_28 ( V_54 , ( long ) V_57 << 32 | V_58 ) ;
}
T_1 long F_29 ( const char T_2 * V_56 , unsigned long V_33 )
{
return F_26 ( V_56 , V_33 ) ;
}
T_1 long F_30 ( unsigned int V_54 , unsigned long V_33 )
{
return F_28 ( V_54 , V_33 ) ;
}
T_1 long F_31 ( unsigned int V_54 , unsigned int V_59 , unsigned long V_60 )
{
return F_32 ( V_54 , V_59 , V_60 ) ;
}
T_1 long F_25 ( const char T_2 * V_56 ,
unsigned int V_57 , unsigned int V_58 )
{
return F_29 ( V_56 , ( V_61 ) V_57 << 32 | V_58 ) ;
}
T_1 long F_27 ( unsigned int V_54 ,
unsigned int V_57 , unsigned int V_58 )
{
return F_30 ( V_54 , ( V_61 ) V_57 << 32 | V_58 ) ;
}
T_1 T_3 F_33 ( unsigned int V_54 , char T_2 * V_62 , T_4 V_63 ,
unsigned int V_57 , unsigned int V_58 )
{
return F_34 ( V_54 , V_62 , V_63 , ( V_61 ) V_57 << 32 | V_58 ) ;
}
T_1 T_3 F_35 ( unsigned int V_54 , const char T_2 * V_62 ,
T_4 V_63 , unsigned int V_57 , unsigned int V_58 )
{
return F_36 ( V_54 , V_62 , V_63 , ( V_61 ) V_57 << 32 | V_58 ) ;
}
T_1 T_3 F_37 ( int V_54 , unsigned int V_57 , unsigned int V_58 ,
T_4 V_63 )
{
return F_38 ( V_54 , ( V_61 ) V_57 << 32 | V_58 , V_63 ) ;
}
T_1 long F_39 ( int V_54 ,
unsigned int V_64 , unsigned int V_65 ,
unsigned int V_66 , unsigned int V_67 , int V_68 )
{
return F_40 ( V_54 , ( V_61 ) V_64 << 32 | V_65 ,
...
unsigned int V_16 )
{
return F_42 ( V_54 , ( V_61 ) V_69 << 32 | V_70 ,
( V_61 ) V_71 << 32 | V_72 , V_16 ) ;
}
T_1 long F_43 ( int V_54 , int V_73 , T_5 V_74 , T_5 V_75 ,
T_5 V_76 , T_5 V_77 )
{
return F_44 ( V_54 , V_73 , ( ( V_78 ) V_74 << 32 ) | V_75 ,
( ( V_78 ) V_76 << 32 ) | V_77 ) ;
}
