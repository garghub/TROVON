...
F_32 ( V_2 , V_4 , V_39 , & V_41 , F_23 ( V_39 -> V_47 ) ) ;
return V_83 ;
}
return V_93 ;
}
static unsigned int F_43 ( void * V_94 ,
struct V_3 * V_4 ,
...
if ( V_39 == NULL )
return V_83 ;
V_66 = & V_97 -> V_101 . V_102 ;
switch ( V_66 -> V_66 ) {
case V_103 :
if ( V_39 -> V_87 && ! F_48 ( V_104 , & V_97 -> V_105 ) ) {
F_49 ( V_97 , V_24 , V_99 -> V_106 -
F_23 ( V_39 -> V_47 ) + 1 ) ;
break;
}
...
F_23 ( V_39 -> V_47 ) + 1 ) )
F_34 ( V_60 -> V_71 -> V_110 ) ;
return V_83 ;
}
V_99 -> V_106 = F_23 ( V_39 -> V_48 ) ;
if ( V_41 . V_51 & V_75 )
V_99 -> V_111 = V_41 . V_112 ;
break;
case V_113 :
if ( ! V_39 -> V_84 || ! V_39 -> V_85 )
break;
...
return V_83 ;
if ( V_41 . V_51 & V_75 )
V_99 -> V_107 = V_41 . V_114 - V_99 -> V_111 ;
V_41 . V_51 &= ~ ( V_74 |
V_91 |
V_92 ) ;
F_51 ( V_41 . V_114 , V_41 . V_112 ) ;
F_29 ( V_2 , V_66 , V_4 , V_39 , & V_41 ) ;
F_49 ( V_97 , V_24 , V_99 -> V_106 - F_23 ( V_39 -> V_47 ) ) ;
F_51 ( V_41 . V_114 , V_41 . V_112 ) ;
...
F_53 ( V_4 , V_82 , V_39 , V_97 , V_24 , V_99 ) ;
return V_100 ;
}
static int F_54 ( const struct V_116 * V_77 )
{
const struct V_117 * V_118 = V_77 -> V_119 ;
if ( V_118 -> V_120 . V_101 != V_18 ||
V_118 -> V_120 . V_121 & V_122 )
return - V_123 ;
return F_55 ( V_77 -> V_2 , V_77 -> V_124 ) ;
}
static void F_56 ( const struct V_125 * V_77 )
{
F_57 ( V_77 -> V_2 , V_77 -> V_124 ) ;
}
