...
V_37 . V_38 = V_32 ;
V_32 -> V_39 = F_18 ( V_21 , L_6 , 0 ) ;
if ( ! V_32 -> V_39 )
return - V_40 ;
V_32 -> V_41 = F_18 ( V_21 , L_7 , 0 ) ;
if ( ! V_32 -> V_41 )
return - V_40 ;
V_32 -> V_42 = V_32 -> V_41 ;
V_37 . V_22 = & V_28 -> V_22 ;
...
V_10 = F_24 ( & V_28 -> V_22 , sizeof( * V_10 ) , V_44 ) ;
if ( ! V_10 )
return - V_45 ;
V_10 -> V_11 = V_11 ;
V_17 = F_25 ( V_21 , L_11 , & V_10 -> V_18 ) ;
if ( V_17 < 0 ) {
if ( ! V_10 -> V_11 ) {
F_17 ( & V_28 -> V_22 ,
L_12 ) ;
...
F_29 ( & V_37 , V_10 ) ;
V_17 = F_30 ( & V_28 -> V_22 , & V_37 ) ;
if ( V_17 )
F_17 ( & V_28 -> V_22 , L_14 , V_17 ) ;
return V_17 ;
}
