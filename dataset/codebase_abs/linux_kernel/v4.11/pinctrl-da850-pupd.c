...
F_12 ( V_24 , V_9 -> V_14 + V_19 ) ;
F_12 ( V_23 , V_9 -> V_14 + V_15 ) ;
return 0 ;
}
...
struct V_8 * V_9 ;
struct V_30 * V_31 ;
V_9 = F_14 ( V_29 , sizeof( * V_9 ) , V_32 ) ;
if ( ! V_9 )
return - V_33 ;
V_31 = F_15 ( V_27 , V_34 , 0 ) ;
V_9 -> V_14 = F_16 ( V_29 , V_31 ) ;
if ( F_17 ( V_9 -> V_14 ) ) {
F_18 ( V_29 , L_1 ) ;
return F_19 ( V_9 -> V_14 ) ;
}
V_9 -> V_35 . V_36 = F_20 ( V_29 ) ;
V_9 -> V_35 . V_37 = & V_38 ;
V_9 -> V_35 . V_39 = & V_40 ;
V_9 -> V_35 . V_41 = V_42 ;
V_9 -> V_43 = F_21 ( V_29 , & V_9 -> V_35 , V_9 ) ;
if ( F_17 ( V_9 -> V_43 ) ) {
F_18 ( V_29 , L_2 ) ;
return F_19 ( V_9 -> V_43 ) ;
}
F_22 ( V_27 , V_9 ) ;
return 0 ;
}
