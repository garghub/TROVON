...
static int F_26 ( struct V_44 * V_45 , void * V_46 )
{
...
static T_2 F_29 ( struct V_2 * V_2 , const char T_3 * V_56 ,
T_4 V_57 , T_5 * V_58 )
{
...
return - V_61 ;
if ( F_30 ( V_60 , V_56 , V_57 ) )
return - V_62 ;
V_60 [ V_57 ] = '\0' ;
if ( ! strcmp ( V_60 , L_12 ) )
V_48 -> V_51 = V_52 ;
else if ( ! strcmp ( V_60 , L_13 ) )
V_48 -> V_51 = V_53 ;
...
static int F_31 ( struct V_44 * V_45 , void * V_46 )
{
struct V_47 * V_48 = V_45 -> V_49 ;
struct V_63 * V_64 = V_48 -> V_65 ;
if ( V_48 -> V_66 && V_64 )
F_32 ( V_45 , V_64 -> V_46 , V_64 -> V_67 ) ;
return 0 ;
}
static int F_33 ( struct V_1 * V_1 , struct V_2 * V_2 )
{
struct V_47 * V_16 = V_1 -> V_5 ;
return F_2 ( V_2 , F_31 , V_16 ) ;
}
static T_2 F_34 ( struct V_2 * V_2 , const char T_3 * V_56 ,
T_4 V_57 , T_5 * V_58 )
{
struct V_44 * V_45 = V_2 -> V_59 ;
struct V_47 * V_48 = V_45 -> V_49 ;
...
return - V_71 ;
V_48 -> V_72 = V_12 ;
V_17 = F_5 ( L_17 , V_28 | V_73 , V_12 , V_48 ,
& V_74 ) ;
if ( ! V_17 )
goto error;
V_17 = F_5 ( L_18 , V_28 | V_73 , V_12 ,
V_48 , & V_75 ) ;
if ( ! V_17 )
goto error;
return 0 ;
