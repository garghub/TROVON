...
struct V_24 * V_146 , struct V_24 T_6 * V_147 )
{
return F_88 ( V_146 , V_147 , V_21 & V_135 ?
V_136 : V_137 ,
V_23 ) ;
}
long F_89 ( struct V_148 * V_148 )
{
T_2 V_23 = V_148 -> V_149 . V_150 ;
struct V_32 * V_139 = F_71 ( V_23 ) ;
if ( F_82 ( ! V_139 || ! V_139 -> V_40 ) )
return - V_140 ;
return V_139 -> V_40 ( V_148 ) ;
}
