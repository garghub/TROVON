...
static int F_77 ( struct V_9 * V_10 , const char * V_143 )
{
...
static void F_45 ( struct V_9 * V_10 , bool V_138 )
{
struct V_58 * V_59 = V_10 -> V_144 ;
struct V_2 * V_3 ;
F_58 () ;
...
F_61 () ;
F_41 ( V_3 , V_10 , NULL , V_138 ) ;
F_42 ( & V_3 -> V_1 , F_1 ) ;
}
static int F_80 ( struct V_9 * V_10 , struct V_155 * V_156 )
{
struct V_58 * V_59 = V_10 -> V_144 ;
struct V_2 * V_3 ;
