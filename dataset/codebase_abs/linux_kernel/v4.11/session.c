...
( unsigned short ) V_155 -> V_94 . V_156 ,
...
if ( V_307 == NULL )
return - V_299 ;
V_307 -> V_308 = F_178 ( V_304 ) ;
if ( V_307 -> V_308 == NULL ) {
free ( V_307 ) ;
return - V_299 ;
}
V_305 = strchr ( V_307 -> V_308 , ']' ) ;
if ( V_305 )
* V_305 = '\0' ;
V_307 -> V_184 = V_184 ;
for ( V_102 = 0 ; V_102 < V_309 ; ++ V_102 ) {
struct V_310 * V_310 = F_179 ( V_303 [ V_102 ] ) ;
if ( ! V_310 )
continue;
V_310 -> V_306 = V_307 ;
}
...
T_10 F_180 ( struct V_1 * V_2 , T_16 * V_311 )
{
return F_181 ( & V_2 -> V_9 , V_311 ) ;
}
T_10 F_182 ( struct V_1 * V_2 , T_16 * V_311 ,
bool (V_270)( struct V_312 * V_312 , int V_313 ) , int V_313 )
{
return F_183 ( & V_2 -> V_9 , V_311 , V_270 , V_313 ) ;
}
T_10 F_184 ( struct V_1 * V_2 , T_16 * V_311 )
{
T_10 V_10 ;
const char * V_300 = L_87 ;
if ( F_5 ( & V_2 -> V_5 , V_314 ) )
V_300 = L_88 ;
V_10 = fprintf ( V_311 , L_89 , V_300 ) ;
V_10 += F_185 ( & V_2 -> V_7 -> V_208 , V_311 ) ;
return V_10 ;
}
T_10 F_186 ( struct V_1 * V_2 , T_16 * V_311 )
{
return F_187 ( & V_2 -> V_9 . V_11 , V_311 ) ;
}
...
if ( V_315 -> V_14 . type == type )
return V_315 ;
}
return NULL ;
}
int F_189 ( struct V_1 * V_2 ,
const char * V_316 , unsigned long * V_317 )
{
int V_102 , V_230 = - 1 ;
struct V_68 * V_302 ;
for ( V_102 = 0 ; V_102 < V_318 ; ++ V_102 ) {
struct V_12 * V_13 ;
...
void F_193 ( struct V_1 * V_2 , T_16 * V_311 ,
bool V_321 )
{
if ( V_2 == NULL || V_311 == NULL )
return;
fprintf ( V_311 , L_95 ) ;
F_194 ( V_2 , V_311 , V_321 ) ;
fprintf ( V_311 , L_96 ) ;
}
...
V_13 = F_196 ( V_2 -> V_7 , V_323 [ V_102 ] . V_308 ) ;
if ( V_13 == NULL )
continue;
V_230 = - V_325 ;
if ( V_13 -> V_326 != NULL )
...
struct V_330 * V_155 = & V_328 -> V_127 [ V_102 ] ;
struct V_206 * V_207 ;
if ( V_36 ) {
fprintf ( stdout , L_98 V_150 , V_155 -> V_91 ) ;
fprintf ( stdout , L_99 V_150 , V_155 -> V_122 ) ;
fprintf ( stdout , L_100 V_331 , V_155 -> V_123 ) ;
fprintf ( stdout , L_101 V_331 L_10 , V_155 -> V_79 ) ;
}
...
union V_34 * V_334 ;
struct V_12 * V_13 ;
T_10 V_126 = 0 , V_102 = 0 , T_9 , V_329 , V_39 ;
int V_230 ;
F_199 ( L_102 ) ;
...
F_18 (evlist, evsel)
V_126 += V_13 -> V_336 ;
V_39 = V_126 > V_329 ? V_329 : V_126 ;
T_9 = sizeof( struct V_327 ) + V_39 * sizeof( struct V_330 ) ;
V_334 = F_26 ( T_9 ) ;
if ( ! V_334 )
return - V_299 ;
V_334 -> V_64 . V_5 . type = V_238 ;
V_334 -> V_64 . V_5 . V_42 = T_9 ;
V_334 -> V_64 . V_126 = V_39 ;
F_18 (evlist, evsel) {
T_12 V_337 ;
...
struct V_206 * V_207 ;
if ( V_102 >= V_39 ) {
V_230 = V_333 ( V_22 , V_334 , NULL , V_37 ) ;
if ( V_230 )
goto V_275;
V_126 -= V_39 ;
V_102 = 0 ;
}
V_155 = & V_334 -> V_64 . V_127 [ V_102 ++ ] ;
V_155 -> V_91 = V_13 -> V_91 [ V_337 ] ;
V_207 = F_132 ( V_7 , V_155 -> V_91 ) ;
if ( ! V_207 ) {
free ( V_334 ) ;
return - V_332 ;
...
T_9 = sizeof( struct V_327 ) + V_126 * sizeof( struct V_330 ) ;
V_334 -> V_64 . V_5 . V_42 = T_9 ;
V_334 -> V_64 . V_126 = V_126 ;
V_230 = V_333 ( V_22 , V_334 , NULL , V_37 ) ;
V_275:
free ( V_334 ) ;
return V_230 ;
