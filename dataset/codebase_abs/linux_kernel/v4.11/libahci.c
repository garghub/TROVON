...
int F_95 ( struct V_96 * V_97 , unsigned int * V_220 ,
unsigned long V_221 , bool * V_236 )
{
const unsigned long * V_237 = F_96 ( & V_97 -> V_238 ) ;
struct V_6 * V_7 = V_97 -> V_7 ;
struct V_106 * V_107 = V_7 -> V_18 ;
struct V_15 * V_16 = V_7 -> V_17 -> V_18 ;
T_6 * V_239 = V_107 -> V_240 + V_241 ;
struct V_185 V_186 ;
int V_136 ;
F_78 ( L_34 ) ;
F_33 ( V_7 ) ;
F_82 ( V_97 -> V_9 , & V_186 ) ;
V_186 . V_242 = V_203 ;
F_75 ( & V_186 , 0 , 0 , V_239 ) ;
V_136 = F_97 ( V_97 , V_237 , V_221 , V_236 ,
F_89 ) ;
V_16 -> V_79 ( V_7 ) ;
if ( * V_236 )
* V_220 = F_68 ( V_7 ) ;
...
static int F_98 ( struct V_96 * V_97 , unsigned int * V_220 ,
unsigned long V_221 )
{
bool V_236 ;
return F_95 ( V_97 , V_220 , V_221 , & V_236 ) ;
}
static void F_99 ( struct V_96 * V_97 , unsigned int * V_220 )
{
struct V_6 * V_7 = V_97 -> V_7 ;
void T_1 * V_22 = F_16 ( V_7 ) ;
T_2 V_243 , V_3 ;
...
static unsigned int F_101 ( struct V_246 * V_247 , void * V_212 )
{
struct V_248 * V_249 ;
...
T_5 V_253 = F_103 ( V_249 ) ;
T_2 V_254 = F_104 ( V_249 ) ;
...
static int F_105 ( struct V_246 * V_247 )
{
...
static void F_108 ( struct V_246 * V_247 )
{
struct V_6 * V_7 = V_247 -> V_7 ;
struct V_106 * V_107 = V_7 -> V_18 ;
int V_257 = F_109 ( V_247 -> V_186 . V_258 ) ;
void * V_212 ;
T_2 V_193 ;
const T_2 V_210 = 5 ;
unsigned int V_259 ;
...
static void F_113 ( struct V_6 * V_7 , T_2 V_270 )
{
struct V_15 * V_16 = V_7 -> V_17 -> V_18 ;
struct V_106 * V_107 = V_7 -> V_18 ;
...
if ( ! V_97 )
V_97 = & V_7 -> V_97 ;
V_274 = F_115 ( V_7 , V_97 -> V_282 ) ;
V_275 = & V_97 -> V_273 ;
F_116 ( V_272 ) ;
F_117 ( V_272 , L_45 , V_270 ) ;
...
const T_8 * V_309 = V_107 -> V_240 + V_310 ;
T_2 V_311 = F_127 ( V_309 [ 0 ] ) ;
if ( V_311 & ( 1 << 15 ) )
F_125 ( V_7 ) ;
}
}
...
V_136 = F_128 ( V_7 , V_305 ) ;
if ( F_123 ( V_136 < 0 && ! V_303 ) ) {
V_302 -> V_286 |= V_293 ;
V_302 -> V_294 |= V_295 ;
F_119 ( V_7 ) ;
}
...
F_122 ( V_7 , V_22 , V_197 ) ;
}
static T_9 F_130 ( int V_314 , void * V_315 )
{
...
T_2 F_133 ( struct V_83 * V_17 , T_2 V_317 )
{
...
F_131 ( & V_17 -> V_31 ) ;
V_136 = F_133 ( V_17 , V_317 ) ;
F_3 ( V_270 , V_1 + V_175 ) ;
F_132 ( & V_17 -> V_31 ) ;
F_63 ( L_53 ) ;
return F_135 ( V_136 ) ;
}
unsigned int F_136 ( struct V_246 * V_247 )
{
struct V_6 * V_7 = V_247 -> V_7 ;
void T_1 * V_22 = F_16 ( V_7 ) ;
struct V_106 * V_107 = V_7 -> V_18 ;
V_107 -> V_312 = V_247 -> V_8 -> V_97 ;
if ( F_137 ( V_247 -> V_186 . V_258 ) )
...
static bool F_138 ( struct V_246 * V_247 )
{
struct V_106 * V_107 = V_247 -> V_7 -> V_18 ;
T_6 * V_240 = V_107 -> V_240 ;
if ( V_107 -> V_213 )
V_240 += V_247 -> V_8 -> V_97 -> V_139 * V_320 ;
if ( V_247 -> V_186 . V_258 == V_321 && V_247 -> V_322 == V_323 &&
! ( V_247 -> V_29 & V_324 ) ) {
F_139 ( V_240 + V_325 , & V_247 -> V_326 ) ;
V_247 -> V_326 . V_242 = ( V_240 + V_325 ) [ 15 ] ;
} else
F_139 ( V_240 + V_241 , & V_247 -> V_326 ) ;
return true ;
}
...
F_143 ( V_7 ) ;
if ( ! F_144 ( V_7 -> V_97 . V_9 ) )
F_33 ( V_7 ) ;
}
static void F_145 ( struct V_246 * V_247 )
{
struct V_6 * V_7 = V_247 -> V_7 ;
if ( V_247 -> V_29 & V_324 )
F_72 ( V_7 ) ;
...
static int F_151 ( struct V_6 * V_7 , T_10 V_355 )
{
const char * V_145 = NULL ;
int V_136 ;
V_136 = F_47 ( V_7 , & V_145 ) ;
...
T_5 V_357 ;
T_4 V_358 , V_359 ;
V_107 = F_154 ( V_8 , sizeof( * V_107 ) , V_360 ) ;
if ( ! V_107 )
return - V_361 ;
if ( V_7 -> V_17 -> V_180 > 1 ) {
V_107 -> V_362 = F_154 ( V_8 , 8 , V_360 ) ;
if ( ! V_107 -> V_362 ) {
F_155 ( V_8 , V_107 ) ;
return - V_361 ;
}
snprintf ( V_107 -> V_362 , 8 ,
L_64 , F_156 ( V_8 ) , V_7 -> V_156 ) ;
}
...
V_356 = F_158 ( V_8 , V_358 , & V_357 , V_360 ) ;
if ( ! V_356 )
return - V_361 ;
...
void F_161 ( struct V_83 * V_17 , const char * V_370 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
...
static int F_163 ( struct V_83 * V_17 ,
struct V_393 * V_394 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
int V_2 , V_136 ;
...
V_136 = F_166 ( V_17 -> V_8 , V_314 , F_130 ,
0 , V_107 -> V_362 , V_17 -> V_181 [ V_2 ] ) ;
if ( V_136 )
return V_136 ;
F_167 ( V_17 -> V_181 [ V_2 ] , L_98 , V_314 ) ;
}
return F_168 ( V_17 , V_394 ) ;
}
int F_169 ( struct V_83 * V_17 , struct V_393 * V_394 )
{
struct V_15 * V_16 = V_17 -> V_18 ;
...
V_136 = F_163 ( V_17 , V_394 ) ;
} else {
V_136 = F_170 ( V_17 , V_314 , V_16 -> V_81 ,
V_396 , V_394 ) ;
}
return V_136 ;
}
