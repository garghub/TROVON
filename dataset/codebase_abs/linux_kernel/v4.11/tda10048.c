...
static int F_26 ( struct V_24 * V_25 , enum V_127 * V_128 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
T_1 V_3 ;
* V_128 = 0 ;
...
static int F_27 ( struct V_24 * V_25 , T_3 * V_134 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
static T_3 V_135 ;
T_3 V_136 ;
T_4 V_137 ;
F_2 ( 1 , L_8 , V_15 ) ;
if ( F_5 ( V_2 , V_138 ) & 0x01 ) {
V_137 = F_5 ( V_2 , V_139 ) << 8 |
F_5 ( V_2 , V_140 ) ;
V_136 = F_5 ( V_2 , V_141 ) << 8 |
F_5 ( V_2 , V_142 ) ;
V_137 *= 100000000 ;
V_137 *= 2 ;
V_137 = F_28 ( V_137 , ( V_136 * 32 ) + 1 ) ;
V_135 = ( T_3 ) V_137 ;
F_1 ( V_2 , V_124 , 0x39 ) ;
}
* V_134 = V_135 ;
...
static int F_30 ( struct V_24 * V_25 , T_2 * V_146 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
T_1 V_144 ;
int V_43 , V_7 = - V_30 ;
F_2 ( 1 , L_8 , V_15 ) ;
V_144 = F_5 ( V_2 , V_145 ) ;
for ( V_43 = 0 ; V_43 < F_15 ( V_147 ) ; V_43 ++ ) {
if ( V_144 <= V_147 [ V_43 ] . V_81 ) {
* V_146 = V_147 [ V_43 ] . V_4 ;
V_7 = 0 ;
break;
}
}
...
static int F_31 ( struct V_24 * V_25 , T_3 * V_148 )
{
struct V_1 * V_2 = V_25 -> V_28 ;
F_2 ( 1 , L_8 , V_15 ) ;
* V_148 = F_5 ( V_2 , V_149 ) << 8 |
F_5 ( V_2 , V_150 ) ;
if ( * V_148 == 0xFFFF )
F_1 ( V_2 , V_151 , 0x80 ) ;
return 0 ;
...
V_2 -> V_75 = V_6 -> V_161 ;
V_2 -> V_42 = 8000000 ;
if ( F_5 ( V_2 , V_162 ) != 0x048 )
goto error;
memcpy ( & V_2 -> V_163 . V_120 , & V_164 ,
sizeof( struct V_165 ) ) ;
V_2 -> V_163 . V_28 = V_2 ;
if ( V_6 -> V_166 ) {
V_2 -> V_52 = V_6 -> V_167 ;
...
F_35 ( & V_2 -> V_163 ) ;
if ( F_14 ( & V_2 -> V_163 , 8000000 ) != 0 )
goto error;
if ( F_13 ( & V_2 -> V_163 , 8000000 ) != 0 )
goto error;
F_22 ( & V_2 -> V_163 , 0 ) ;
return & V_2 -> V_163 ;
error:
