...
static struct V_56 * F_22 ( struct V_57 * V_58 )
{
struct V_56 * V_56 ;
int V_59 ;
V_59 = sizeof( struct V_60 ) + F_23 ( V_58 ) ;
V_56 = F_16 ( V_59 , V_45 ) ;
if ( ! V_56 )
return F_24 ( - V_61 ) ;
V_56 -> V_62 . V_2 = V_58 ;
...
static int F_25 ( T_3 * V_64 , const T_3 * V_47 , unsigned int V_65 ,
...
V_24 = F_26 ( V_68 , V_47 , V_65 ) ;
if ( ! V_24 )
V_24 = F_27 ( & V_56 -> V_62 , V_66 , V_67 , V_64 ) ;
F_28 ( V_56 ) ;
return V_24 ;
}
static int F_29 ( T_3 * V_64 , const T_3 * V_66 , unsigned int V_67 )
{
struct V_56 * V_56 ;
int V_24 ;
V_56 = F_22 ( V_70 ) ;
...
static int F_30 ( T_3 * V_72 , enum V_73 V_74 ,
...
V_49 ) ;
V_24 = F_29 ( V_72 , V_75 , V_76 ) ;
F_28 ( V_75 ) ;
return V_24 ;
}
static struct V_78 * F_32 ( const T_3 * V_47 ,
unsigned int V_79 )
{
struct V_78 * V_80 ;
struct V_1 * V_2 ;
...
F_36 ( V_80 , 0 , NULL , NULL ) ;
return V_80 ;
}
static struct V_47 * F_37 ( struct V_38 * V_39 ,
const T_3 * * V_48 , T_2 * V_49 )
{
struct V_47 * V_81 = F_24 ( - V_10 ) ;
...
F_43 ( V_85 , 2 ) ;
F_44 ( & V_85 [ 0 ] , V_39 -> V_91 ,
V_39 -> V_21 ) ;
F_44 ( & V_85 [ 1 ] , V_90 , V_89 ) ;
F_43 ( V_86 , 1 ) ;
F_44 ( V_86 , V_39 -> V_92 , V_87 ) ;
memcpy ( V_43 , V_39 -> V_43 , sizeof( V_43 ) ) ;
F_45 ( V_80 , V_85 , V_86 , V_87 , V_43 ) ;
V_24 = F_46 ( V_80 ) ;
V_2 = F_47 ( V_80 ) ;
F_48 ( V_80 ) ;
F_8 ( V_2 ) ;
...
T_3 * V_64 ;
int V_24 ;
V_24 = F_30 ( V_72 , V_93 , V_48 , V_49 ) ;
if ( V_24 < 0 )
goto V_15;
V_64 = V_39 -> V_19 + V_39 -> V_94 ;
V_24 = F_25 ( V_64 , V_72 , sizeof V_72 ,
V_39 -> V_19 , V_39 -> V_94 ) ;
if ( ! V_24 )
F_51 ( NULL , V_64 , V_77 ) ;
V_15:
...
V_27 = V_39 -> V_19 ;
V_24 = F_25 ( V_64 , V_72 , sizeof V_72 , V_27 , V_44 ) ;
if ( V_24 < 0 )
goto V_15;
...
F_43 ( V_85 , 1 ) ;
F_43 ( V_86 , 2 ) ;
F_44 ( V_85 , V_39 -> V_92 , V_87 ) ;
F_44 ( & V_86 [ 0 ] , V_39 -> V_91 ,
V_39 -> V_21 ) ;
F_44 ( & V_86 [ 1 ] , V_90 , sizeof V_90 ) ;
memcpy ( V_43 , V_39 -> V_43 , sizeof( V_43 ) ) ;
F_45 ( V_80 , V_85 , V_86 , V_87 , V_43 ) ;
V_24 = F_54 ( V_80 ) ;
V_2 = F_47 ( V_80 ) ;
...
static struct V_38 * F_55 ( struct V_47 * V_47 ,
const char * V_19 ,
const char * V_20 ,
const char * V_46 )
{
...
return - V_10 ;
V_105 = V_22 + ( 2 * V_5 ) + 2 ;
V_24 = F_59 ( V_39 -> V_43 , V_22 , V_5 ) ;
if ( V_24 < 0 )
return - V_10 ;
V_24 = F_59 ( V_39 -> V_92 , V_105 ,
V_87 ) ;
if ( V_24 < 0 )
return - V_10 ;
V_104 = V_39 -> V_19 + V_39 -> V_94 ;
V_24 = F_59 ( V_104 , V_105 + ( V_87 * 2 ) ,
V_77 ) ;
if ( V_24 < 0 )
return - V_10 ;
V_81 = F_37 ( V_39 , & V_48 , & V_49 ) ;
if ( F_3 ( V_81 ) )
return F_5 ( V_81 ) ;
V_24 = F_52 ( V_39 , V_19 , V_48 , V_49 ) ;
if ( V_24 < 0 ) {
F_4 ( L_32 , V_24 ) ;
goto V_15;
}
V_24 = F_30 ( V_72 , V_107 , V_48 , V_49 ) ;
if ( V_24 < 0 )
goto V_15;
V_24 = F_53 ( V_39 , V_72 , sizeof V_72 ) ;
if ( V_24 < 0 )
F_4 ( L_33 , V_24 ) ;
V_15:
F_60 ( & V_81 -> V_54 ) ;
...
if ( V_24 < 0 )
return V_24 ;
F_65 ( (struct V_103 * ) V_39 -> V_108 ,
V_109 ) ;
}
F_62 ( V_39 , V_19 , V_20 , V_46 ) ;
if ( ! V_22 ) {
F_66 ( V_39 -> V_43 , V_5 ) ;
F_66 ( V_39 -> V_91 ,
V_39 -> V_21 ) ;
} else
V_24 = F_58 ( V_39 , V_19 , V_22 ) ;
return V_24 ;
}
static int F_67 ( struct V_47 * V_47 ,
struct V_110 * V_111 )
{
struct V_38 * V_39 = NULL ;
char * V_18 = NULL ;
...
if ( V_24 < 0 )
goto V_15;
V_39 = F_55 ( V_47 , V_19 , V_20 ,
V_21 ) ;
if ( F_3 ( V_39 ) ) {
V_24 = F_5 ( V_39 ) ;
goto V_15;
}
V_24 = F_64 ( V_39 , V_47 -> V_112 , V_19 , V_20 ,
V_21 , V_22 ) ;
if ( V_24 < 0 ) {
F_28 ( V_39 ) ;
goto V_15;
...
{
struct V_38 * V_39 ;
V_39 = F_70 ( V_114 , struct V_38 , V_114 ) ;
memset ( V_39 -> V_91 , 0 , V_39 -> V_21 ) ;
F_28 ( V_39 ) ;
}
static int F_71 ( struct V_47 * V_47 , struct V_110 * V_111 )
{
...
if ( V_24 < 0 )
goto V_15;
V_116 = F_55 ( V_47 , V_39 -> V_19 ,
V_117 , V_39 -> V_46 ) ;
if ( F_3 ( V_116 ) ) {
V_24 = F_5 ( V_116 ) ;
goto V_15;
}
F_62 ( V_116 , V_39 -> V_19 , V_117 ,
V_39 -> V_46 ) ;
memcpy ( V_116 -> V_43 , V_39 -> V_43 , V_5 ) ;
memcpy ( V_116 -> V_108 , V_39 -> V_108 ,
V_39 -> V_95 ) ;
F_68 ( V_47 , V_116 ) ;
F_73 ( & V_39 -> V_114 , F_69 ) ;
V_15:
F_28 ( V_66 ) ;
return V_24 ;
}
static long F_74 ( const struct V_47 * V_47 , char T_4 * V_120 ,
T_2 V_67 )
{
struct V_38 * V_39 ;
struct V_47 * V_81 ;
...
if ( V_24 < 0 )
goto V_15;
V_24 = F_40 ( V_39 , V_72 , sizeof V_72 ) ;
if ( V_24 < 0 )
goto V_15;
V_24 = F_50 ( V_39 , V_48 , V_49 ) ;
if ( V_24 < 0 )
goto V_15;
V_41 = F_15 ( V_39 , V_40 ) ;
if ( ! V_41 ) {
...
static void F_77 ( struct V_47 * V_47 )
{
struct V_38 * V_39 = V_47 -> V_115 . V_55 [ 0 ] ;
if ( ! V_39 )
return;
F_78 ( V_39 -> V_91 , V_39 -> V_21 ) ;
F_28 ( V_47 -> V_115 . V_55 [ 0 ] ) ;
}
...
{
int V_24 ;
V_68 = F_82 ( V_69 , 0 , V_4 ) ;
if ( F_3 ( V_68 ) ) {
F_13 ( L_34 ,
V_69 ) ;
return F_5 ( V_68 ) ;
}
V_70 = F_82 ( V_71 , 0 , V_4 ) ;
if ( F_3 ( V_70 ) ) {
F_13 ( L_34 ,
V_71 ) ;
V_24 = F_5 ( V_70 ) ;
