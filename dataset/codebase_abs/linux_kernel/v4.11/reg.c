...
static void F_141 ( struct V_16 * V_237 )
{
struct V_3 * V_3 = NULL ;
enum V_169 V_232 ;
if ( V_237 -> V_147 != V_238 )
V_3 = F_86 ( V_237 -> V_147 ) ;
switch ( V_237 -> V_62 ) {
case V_138 :
V_232 = F_132 ( V_237 ) ;
break;
...
if ( ! V_3 )
goto V_239;
V_232 = F_136 ( V_3 , V_237 ) ;
break;
case V_63 :
if ( ! V_3 )
goto V_239;
V_232 = F_140 ( V_3 , V_237 ) ;
break;
default:
F_29 ( 1 , L_28 , V_237 -> V_62 ) ;
goto V_239;
}
if ( V_232 == V_172 )
goto V_239;
...
{
struct V_199 * V_200 ;
struct V_182 * V_241 , * V_69 ;
F_146 ( & V_242 ) ;
F_147 (pending_beacon, tmp,
&reg_pending_beacons, list) {
F_144 ( & V_241 -> V_43 ) ;
F_103 (rdev, &cfg80211_rdev_list, list)
F_101 ( & V_200 -> V_3 , V_241 ) ;
F_44 ( & V_241 -> V_43 , & V_243 ) ;
}
F_148 ( & V_242 ) ;
}
...
int F_156 ( bool V_246 , T_1 V_247 )
{
F_130 ( & V_248 ) ;
V_249 = V_246 ;
if ( V_249 ) {
...
void F_159 ( struct V_3 * V_3 , enum V_192 V_186 ,
const T_3 * V_251 , T_3 V_252 )
{
char V_26 [ 2 ] ;
enum V_253 V_53 = V_254 ;
...
static void F_162 ( char * V_26 , bool V_259 )
{
V_26 [ 0 ] = '9' ;
V_26 [ 1 ] = '7' ;
if ( F_28 () ) {
...
static void F_49 ( bool V_259 )
{
char V_26 [ 2 ] ;
char V_261 [ 2 ] ;
struct V_182 * V_182 , * V_262 ;
F_164 ( V_263 ) ;
struct V_199 * V_200 ;
F_18 () ;
F_130 ( & V_248 ) ;
...
static bool F_167 ( T_4 V_265 )
{
if ( V_265 == F_168 ( 12 , V_266 ) ||
V_265 == F_168 ( 13 , V_266 ) ||
V_265 == F_168 ( 14 , V_266 ) )
return true ;
return false ;
}
static bool F_169 ( struct V_140 * V_267 )
{
struct V_182 * V_241 ;
...
if ( V_269 )
return 0 ;
V_182 = F_31 ( sizeof( struct V_182 ) , V_268 ) ;
if ( ! V_182 )
return - V_36 ;
F_6 ( L_36 ,
V_267 -> V_130 ,
F_171 ( V_267 -> V_130 ) ,
F_172 ( V_3 ) ) ;
memcpy ( & V_182 -> V_141 , V_267 ,
sizeof( struct V_140 ) ) ;
F_146 ( & V_242 ) ;
F_44 ( & V_182 -> V_43 , & V_270 ) ;
F_148 ( & V_242 ) ;
F_45 ( & V_227 ) ;
return 0 ;
}
...
V_67 -> V_83 ) ;
if ( V_84 -> V_77 & V_118 )
F_174 ( V_271 , sizeof( V_271 ) , L_40 ,
V_84 -> V_106 / 1000 ) ;
else
F_174 ( V_271 , sizeof( V_271 ) , L_41 ) ;
if ( V_100 -> V_105 )
F_6 ( L_42 ,
V_67 -> V_75 ,
V_67 -> V_74 ,
...
int F_190 ( int V_265 )
{
if ( V_265 >= 5150 && V_265 <= 5250 )
return 0 ;
if ( V_265 > 5250 && V_265 <= 5350 )
return 1 ;
if ( V_265 > 5350 && V_265 <= 5470 )
return 2 ;
if ( V_265 > 5470 && V_265 <= 5725 )
return 3 ;
if ( V_265 > 5725 && V_265 <= 5825 )
return 4 ;
return - V_56 ;
}
bool F_191 ( void )
