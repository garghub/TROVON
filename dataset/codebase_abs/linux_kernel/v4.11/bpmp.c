...
F_35 ( V_22 , V_9 -> V_47 . V_48 ) ;
F_36 ( & V_9 -> V_46 , V_44 ) ;
F_37 ( & V_9 -> V_47 . V_46 ) ;
return V_45 ;
}
static T_2 F_38 ( struct V_17 * V_18 ,
unsigned int V_49 , unsigned long V_44 ,
...
static struct V_17 *
F_40 ( struct V_1 * V_9 , unsigned int V_49 ,
const void * V_34 , T_3 V_31 )
{
...
unsigned int V_22 ;
int V_45 ;
V_45 = F_41 ( & V_9 -> V_47 . V_46 , F_42 ( V_38 ) ) ;
if ( V_45 < 0 )
return F_5 ( V_45 ) ;
F_34 ( & V_9 -> V_46 , V_44 ) ;
V_22 = F_43 ( V_9 -> V_47 . V_48 , V_21 ) ;
if ( V_22 == V_21 ) {
V_18 = F_5 ( - V_51 ) ;
goto V_52;
}
...
F_44 ( V_22 , V_9 -> V_47 . V_48 ) ;
V_45 = F_38 ( V_18 , V_49 , V_53 | V_54 ,
V_34 , V_31 ) ;
if ( V_45 < 0 ) {
F_35 ( V_22 , V_9 -> V_47 . V_48 ) ;
goto V_52;
}
F_44 ( V_22 , V_9 -> V_47 . V_55 ) ;
V_52:
F_36 ( & V_9 -> V_46 , V_44 ) ;
return V_18 ;
}
...
if ( V_45 < 0 )
return V_45 ;
return F_38 ( V_18 , V_49 , V_44 , V_34 , V_31 ) ;
}
...
if ( ! F_17 ( V_29 ) )
return - V_25 ;
V_18 = F_40 ( V_9 , V_29 -> V_49 , V_29 -> V_30 . V_34 ,
V_29 -> V_30 . V_31 ) ;
if ( F_20 ( V_18 ) )
return F_52 ( V_18 ) ;
V_45 = F_49 ( V_9 -> V_4 . V_18 , NULL ) ;
...
V_45 = F_53 ( & V_18 -> V_57 , V_38 ) ;
if ( V_45 == 0 )
return - V_40 ;
return F_33 ( V_18 , V_29 -> V_33 . V_34 , V_29 -> V_33 . V_31 ) ;
}
static struct V_58 * F_54 ( struct V_1 * V_9 ,
unsigned int V_49 )
{
struct V_58 * V_59 ;
...
int V_50 , const void * V_34 , T_3 V_31 )
{
...
if ( ! V_59 ) {
F_59 ( & V_9 -> V_46 ) ;
F_56 ( V_18 , - V_25 , & V_61 , sizeof( V_61 ) ) ;
return;
}
V_59 -> V_62 ( V_49 , V_18 , V_59 -> V_34 ) ;
F_59 ( & V_9 -> V_46 ) ;
}
int F_60 ( struct V_1 * V_9 , unsigned int V_49 ,
T_5 V_62 , void * V_34 )
{
struct V_58 * V_59 ;
unsigned long V_44 ;
if ( ! V_62 )
return - V_25 ;
V_59 = F_61 ( V_9 -> V_6 , sizeof( * V_59 ) , V_63 ) ;
if ( ! V_59 )
return - V_64 ;
F_34 ( & V_9 -> V_46 , V_44 ) ;
V_59 -> V_49 = V_49 ;
V_59 -> V_62 = V_62 ;
V_59 -> V_34 = V_34 ;
F_62 ( & V_59 -> V_65 , & V_9 -> V_66 ) ;
F_36 ( & V_9 -> V_46 , V_44 ) ;
return 0 ;
}
void F_63 ( struct V_1 * V_9 , unsigned int V_49 , void * V_34 )
{
struct V_58 * V_59 ;
unsigned long V_44 ;
F_34 ( & V_9 -> V_46 , V_44 ) ;
...
static void F_66 ( unsigned int V_49 ,
struct V_17 * V_18 ,
void * V_34 )
{
struct V_67 * V_68 ;
struct V_69 V_70 ;
V_68 = (struct V_67 * ) V_18 -> V_37 -> V_34 ;
memset ( & V_70 , 0 , sizeof( V_70 ) ) ;
V_70 . V_71 = V_68 -> V_72 << 1 ;
F_56 ( V_18 , 0 , & V_70 , sizeof( V_70 ) ) ;
}
...
V_29 . V_49 = V_73 ;
V_29 . V_30 . V_34 = & V_68 ;
V_29 . V_30 . V_31 = sizeof( V_68 ) ;
V_29 . V_33 . V_34 = & V_70 ;
V_29 . V_33 . V_31 = sizeof( V_70 ) ;
F_68 ( V_44 ) ;
V_42 = F_23 () ;
V_45 = F_46 ( V_9 , & V_29 ) ;
V_39 = F_23 () ;
...
static int F_73 ( struct V_1 * V_9 , char * V_74 ,
T_3 V_31 )
{
struct V_75 V_68 ;
struct V_28 V_29 ;
...
struct V_17 * V_18 ;
unsigned int V_81 , V_21 ;
unsigned long * V_55 ;
V_18 = F_16 ( V_9 ) ;
V_21 = V_9 -> V_23 -> V_19 . V_24 . V_21 ;
V_55 = V_9 -> V_47 . V_55 ;
if ( F_18 ( V_18 ) )
F_57 ( V_9 , V_18 -> V_37 -> V_50 , V_18 ) ;
F_58 ( & V_9 -> V_46 ) ;
F_80 (i, busy, count) {
struct V_17 * V_18 ;
V_18 = F_13 ( V_9 , V_81 ) ;
...
static void F_81 ( struct V_82 * V_36 , void * V_34 )
{
struct V_1 * V_9 = V_34 ;
int V_45 ;
...
V_9 -> V_33 . V_77 + V_20 , V_9 -> V_33 . V_76 + V_20 ,
V_9 -> V_30 . V_77 + V_20 , V_9 -> V_30 . V_76 + V_20 ,
1 , V_83 , F_81 ,
V_9 ) ;
if ( V_45 < 0 ) {
F_86 ( V_9 -> V_6 , L_3 ,
...
T_3 V_31 ;
int V_45 ;
V_9 = F_61 ( & V_8 -> V_6 , sizeof( * V_9 ) , V_63 ) ;
if ( ! V_9 )
return - V_64 ;
V_9 -> V_23 = F_94 ( & V_8 -> V_6 ) ;
V_9 -> V_6 = & V_8 -> V_6 ;
V_9 -> V_30 . V_86 = F_95 ( V_8 -> V_6 . V_12 , L_4 , 0 ) ;
if ( ! V_9 -> V_30 . V_86 ) {
F_86 ( & V_8 -> V_6 , L_5 ) ;
return - V_64 ;
}
V_9 -> V_30 . V_77 = F_96 ( V_9 -> V_30 . V_86 , 4096 , & V_9 -> V_30 . V_76 ) ;
if ( ! V_9 -> V_30 . V_77 ) {
F_86 ( & V_8 -> V_6 , L_6 ) ;
return - V_64 ;
}
V_9 -> V_33 . V_86 = F_95 ( V_8 -> V_6 . V_12 , L_4 , 1 ) ;
if ( ! V_9 -> V_33 . V_86 ) {
F_86 ( & V_8 -> V_6 , L_7 ) ;
V_45 = - V_64 ;
goto V_87;
}
V_9 -> V_33 . V_77 = F_96 ( V_9 -> V_33 . V_86 , 4096 , & V_9 -> V_33 . V_76 ) ;
if ( ! V_9 -> V_33 . V_86 ) {
F_86 ( & V_8 -> V_6 , L_8 ) ;
V_45 = - V_64 ;
goto V_87;
...
F_97 ( & V_9 -> V_66 ) ;
F_98 ( & V_9 -> V_46 ) ;
V_9 -> V_47 . V_21 = V_9 -> V_23 -> V_19 . V_24 . V_21 ;
F_99 ( & V_9 -> V_47 . V_46 , V_9 -> V_47 . V_21 ) ;
V_31 = F_100 ( V_9 -> V_47 . V_21 ) * sizeof( long ) ;
V_9 -> V_47 . V_48 = F_61 ( & V_8 -> V_6 , V_31 , V_63 ) ;
if ( ! V_9 -> V_47 . V_48 ) {
V_45 = - V_64 ;
goto V_88;
}
V_9 -> V_47 . V_55 = F_61 ( & V_8 -> V_6 , V_31 , V_63 ) ;
if ( ! V_9 -> V_47 . V_55 ) {
V_45 = - V_64 ;
goto V_88;
}
V_9 -> V_89 = V_9 -> V_23 -> V_19 . V_26 . V_21 +
V_9 -> V_23 -> V_19 . V_24 . V_21 +
V_9 -> V_23 -> V_19 . V_27 . V_21 ;
V_9 -> V_19 = F_101 ( & V_8 -> V_6 , V_9 -> V_89 ,
sizeof( * V_18 ) , V_63 ) ;
if ( ! V_9 -> V_19 ) {
V_45 = - V_64 ;
goto V_88;
}
for ( V_81 = 0 ; V_81 < V_9 -> V_89 ; V_81 ++ ) {
struct V_17 * V_18 = & V_9 -> V_19 [ V_81 ] ;
V_45 = F_82 ( V_18 , V_9 , V_81 ) ;
if ( V_45 < 0 )
goto V_90;
}
V_9 -> V_4 . V_3 . V_6 = & V_8 -> V_6 ;
V_9 -> V_4 . V_3 . V_91 = F_79 ;
V_9 -> V_4 . V_3 . V_92 = false ;
...
V_45 = F_73 ( V_9 , V_74 , sizeof( V_74 ) - 1 ) ;
if ( V_45 < 0 ) {
F_86 ( & V_8 -> V_6 , L_11 , V_45 ) ;
goto V_95;
}
F_103 ( & V_8 -> V_6 , L_12 , V_74 ) ;
V_45 = F_104 ( V_8 -> V_6 . V_12 , NULL , & V_8 -> V_6 ) ;
if ( V_45 < 0 )
goto V_95;
V_45 = F_105 ( V_9 ) ;
if ( V_45 < 0 )
...
F_91 ( & V_9 -> V_19 [ V_81 ] ) ;
V_88:
F_109 ( V_9 -> V_33 . V_86 , ( unsigned long ) V_9 -> V_33 . V_77 , 4096 ) ;
V_87:
F_109 ( V_9 -> V_30 . V_86 , ( unsigned long ) V_9 -> V_30 . V_77 , 4096 ) ;
return V_45 ;
}
