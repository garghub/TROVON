...
V_9 = F_9 ( & V_6 -> V_10 , & V_21 ) ;
if ( V_9 ) {
F_10 ( V_2 , L_1 ) ;
return V_9 ;
}
V_20 -> V_28 . V_29 = V_17 ;
V_20 -> V_28 . V_30 = V_21 . V_16 . V_26 ;
F_4 (
& V_8 , V_21 . V_11 . V_8 ) ;
V_20 -> V_31 . V_32 = V_8 ;
V_20 -> V_28 . V_33 = V_21 . V_16 . V_33 ;
if ( F_11 ( V_6 -> V_2 ) ) {
F_12 ( V_6 ) ;
V_9 = F_13 ( V_6 ) ;
} else {
...
* V_47 ++ = F_20 ( & V_20 -> V_54 -> V_55 + V_48 ) ;
for ( V_48 = 0 ; V_48 < V_56 ; V_48 ++ ) {
F_21 ( & V_6 -> V_20 , V_48 , & V_49 ) ;
* V_47 ++ = V_49 ;
}
}
...
struct V_19 * V_20 = & V_6 -> V_20 ;
V_106 -> V_33 =
( ( V_20 -> V_28 . V_107 ) ? V_108 : V_109 ) ;
if ( V_20 -> V_28 . V_110 == V_111 ) {
V_106 -> V_112 = 1 ;
} else if ( V_20 -> V_28 . V_110 == V_113 ) {
V_106 -> V_114 = 1 ;
} else if ( V_20 -> V_28 . V_110 == V_115 ) {
V_106 -> V_112 = 1 ;
V_106 -> V_114 = 1 ;
}
}
...
struct V_19 * V_20 = & V_6 -> V_20 ;
int V_9 = 0 ;
V_20 -> V_28 . V_107 = V_106 -> V_33 ;
if ( ( V_106 -> V_112 ) && ( V_106 -> V_114 ) )
V_20 -> V_28 . V_110 = V_115 ;
else if ( ( V_106 -> V_112 ) && ( ! V_106 -> V_114 ) )
V_20 -> V_28 . V_110 = V_111 ;
else if ( ( ! V_106 -> V_112 ) && ( V_106 -> V_114 ) )
V_20 -> V_28 . V_110 = V_113 ;
else if ( ( ! V_106 -> V_112 ) && ( ! V_106 -> V_114 ) )
V_20 -> V_28 . V_110 = V_116 ;
if ( V_20 -> V_28 . V_107 == V_108 ) {
if ( ( F_11 ( V_6 -> V_2 ) ) ) {
F_12 ( V_6 ) ;
V_9 = F_13 ( V_6 ) ;
} else {
