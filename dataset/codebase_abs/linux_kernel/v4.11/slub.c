...
V_366 -> V_368 ( V_374 , V_79 ) ;
V_366 -> V_370 ( V_2 , V_79 , strlen ( V_79 ) ) ;
}
if ( V_373 )
...
int V_387 = F_458 ( V_2 ) ;
if ( ! V_379 ) {
F_459 ( & V_2 -> V_364 , & V_382 ) ;
return 0 ;
}
if ( V_387 ) {
F_460 ( & V_384 -> V_364 , V_2 -> V_40 ) ;
V_40 = V_2 -> V_40 ;
} else {
V_40 = F_457 ( V_2 ) ;
}
V_2 -> V_364 . V_379 = V_379 ;
V_144 = F_461 ( & V_2 -> V_364 , & V_382 , NULL , L_16 , V_40 ) ;
if ( V_144 )
goto V_123;
V_144 = F_462 ( & V_2 -> V_364 , & V_388 ) ;
if ( V_144 )
goto V_389;
#ifdef F_447
if ( F_448 ( V_2 ) && V_353 ) {
V_2 -> V_383 = F_463 ( L_110 , NULL , & V_2 -> V_364 ) ;
if ( ! V_2 -> V_383 ) {
V_144 = - V_310 ;
goto V_389;
}
...
struct V_393 * V_394 ;
if ( V_285 == V_371 ) {
F_460 ( & V_384 -> V_364 , V_40 ) ;
return F_469 ( & V_384 -> V_364 , & V_2 -> V_364 , V_40 ) ;
}
V_394 = F_364 ( sizeof( struct V_393 ) , V_147 ) ;
if ( ! V_394 )
return - V_310 ;
V_394 -> V_2 = V_2 ;
V_394 -> V_40 = V_40 ;
...
static int T_5 F_470 ( void )
{
struct V_1 * V_2 ;
int V_144 ;
F_139 ( & V_148 ) ;
V_384 = F_463 ( L_111 , & V_396 , V_397 ) ;
if ( ! V_384 ) {
F_141 ( & V_148 ) ;
F_63 ( L_112 ) ;
return - V_281 ;
...
while ( V_395 ) {
struct V_393 * V_394 = V_395 ;
V_395 = V_395 -> V_154 ;
V_144 = F_8 ( V_394 -> V_2 , V_394 -> V_40 ) ;
if ( V_144 )
F_63 ( L_114 ,
V_394 -> V_40 ) ;
F_302 ( V_394 ) ;
...
void F_471 ( struct V_1 * V_2 , struct V_398 * V_399 )
{
...
V_399 -> V_400 = V_242 - V_243 ;
V_399 -> V_401 = V_242 ;
V_399 -> V_402 = V_111 ;
V_399 -> V_403 = V_111 ;
V_399 -> V_404 = F_25 ( V_2 -> V_141 ) ;
V_399 -> V_405 = F_24 ( V_2 -> V_141 ) ;
}
void F_472 ( struct V_406 * V_216 , struct V_1 * V_2 )
{
}
T_9 F_473 ( struct V_407 * V_407 , const char T_10 * V_373 ,
T_6 V_145 , T_11 * V_408 )
{
return - V_369 ;
}
