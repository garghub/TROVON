...
F_258 ( NULL , & V_326 , F_236 ) ;
F_259 ( V_84 , V_295 , V_36 , V_230 ) ;
...
static int F_264 ( struct V_3 * log , struct V_108 * V_84 ,
...
struct V_3 * log = V_4 -> V_11 ;
const T_1 V_147 = F_61 ( V_84 ) ;
const T_1 V_165 = F_267 ( & V_84 -> V_138 ) ;
if ( ! F_19 ( V_8 , V_97 ) )
return 0 ;
V_44 . V_54 = V_147 ;
V_44 . type = V_197 ;
...
if ( V_267 == V_282 ) {
V_231 = F_264 ( log , V_84 , V_41 , & V_252 ) ;
if ( V_231 )
goto V_235;
}
if ( F_176 ( V_355 ,
...
F_31 ( V_41 ) ;
F_31 ( V_239 ) ;
V_231 = F_265 ( V_2 , V_4 , V_84 , V_41 , V_239 ) ;
if ( V_231 )
goto V_235;
if ( V_248 . type >= V_197 && ! V_352 ) {
F_31 ( V_41 ) ;
F_31 ( V_239 ) ;
V_231 = F_266 ( V_2 , V_4 , V_84 , V_41 ) ;
if ( V_231 )
goto V_235;
}
V_361:
...
goto V_13;
if ( ! F_39 ( V_84 -> V_138 . V_152 ) ) {
if ( ! V_200 || F_284 ( V_200 ) || V_364 != V_200 -> V_376 )
goto V_13;
V_84 = F_62 ( F_285 ( V_200 ) ) ;
}
while ( 1 ) {
if ( V_84 != V_375 )
V_84 -> V_234 = V_2 -> V_79 ;
...
int V_174 ;
int V_178 ;
V_380 = F_290 ( & V_378 , struct V_379 ,
V_25 ) ;
if ( V_9 )
goto V_381;
...
continue;
F_31 ( V_41 ) ;
V_382 = F_276 ( V_8 -> V_364 , & V_168 , V_4 , NULL ) ;
if ( F_89 ( V_382 ) ) {
V_9 = F_135 ( V_382 ) ;
goto V_381;
}
if ( F_291 ( F_62 ( V_382 ) , V_2 -> V_79 ) ) {
F_80 ( V_382 ) ;
break;
}
V_6 -> V_247 = false ;
...
V_384 = V_360 ;
V_9 = F_270 ( V_2 , V_4 , F_62 ( V_382 ) ,
V_384 , 0 , V_366 , V_6 ) ;
if ( ! V_9 &&
F_282 ( V_2 , F_62 ( V_382 ) ) )
V_9 = 1 ;
F_80 ( V_382 ) ;
if ( V_9 )
goto V_381;
...
V_386 = F_276 ( V_8 -> V_364 , & V_362 ,
V_4 , NULL ) ;
if ( F_89 ( V_386 ) )
continue;
if ( V_6 )
V_6 -> V_247 = false ;
V_9 = F_270 ( V_2 , V_4 , F_62 ( V_386 ) ,
V_360 , 0 , V_366 , V_6 ) ;
if ( ! V_9 &&
F_282 ( V_2 , F_62 ( V_386 ) ) )
V_9 = 1 ;
...
if ( V_4 != V_84 -> V_4 || F_294 ( & V_4 -> V_208 ) == 0 ) {
V_9 = 1 ;
goto V_390;
}
V_9 = F_283 ( V_2 , V_84 , V_200 , V_364 ,
V_373 ) ;
if ( V_9 )
goto V_390;
...
if ( V_9 )
goto V_390;
V_9 = F_270 ( V_2 , V_4 , V_84 , V_267 , V_36 , V_230 , V_6 ) ;
if ( V_9 )
goto V_393;
if ( F_46 ( V_84 -> V_138 . V_152 ) &&
V_84 -> V_253 <= V_373 &&
...
struct V_5 * V_6 )
{
struct V_371 * V_200 = F_287 ( V_371 ) ;
int V_9 ;
V_9 = F_293 ( V_2 , V_4 , F_62 ( F_285 ( V_371 ) ) ,
...
return 0 ;
return F_293 ( V_2 , V_4 , V_84 , V_200 , 0 ,
V_366 , 1 , NULL ) ;
}
