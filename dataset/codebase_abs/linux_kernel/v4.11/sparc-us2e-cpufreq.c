...
static int F_18 ( struct V_33 * V_34 , unsigned int V_25 )
{
...
{
unsigned int V_30 = V_34 -> V_30 ;
unsigned long V_10 = F_17 ( V_30 ) / 1000 ;
struct V_36 * V_37 =
& V_38 [ V_30 ] . V_37 [ 0 ] ;
V_37 [ 0 ] . V_39 = 0 ;
V_37 [ 0 ] . V_40 = V_10 / 1 ;
...
struct V_52 * V_53 ;
V_2 = - V_54 ;
V_53 = F_23 ( sizeof( * V_53 ) , V_55 ) ;
if ( ! V_53 )
goto V_56;
V_38 = F_23 ( ( V_57 * sizeof( * V_38 ) ) ,
V_55 ) ;
if ( ! V_38 )
goto V_56;
V_53 -> V_58 = F_19 ;
