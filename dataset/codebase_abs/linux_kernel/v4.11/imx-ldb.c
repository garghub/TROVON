...
F_57 ( V_114 ) ;
if ( V_115 ) {
V_45 -> V_24 = F_71 ( V_115 ) ;
V_45 -> V_88 = F_72 ( V_115 ) ;
} else
return - V_103 ;
F_57 ( V_115 ) ;
if ( ! V_45 -> V_24 && ! V_45 -> V_88 ) {
F_18 ( V_32 , L_23 ,
V_115 -> V_116 ) ;
return - V_103 ;
}
...
static void F_74 ( struct V_92 * V_32 , struct V_92 * V_107 ,
void * V_108 )
{
struct V_10 * V_10 = F_75 ( V_32 ) ;
int V_97 ;
...
{
return F_80 ( & V_118 -> V_32 , & V_119 ) ;
}
static int F_81 ( struct V_117 * V_118 )
{
F_82 ( & V_118 -> V_32 , & V_119 ) ;
return 0 ;
}
