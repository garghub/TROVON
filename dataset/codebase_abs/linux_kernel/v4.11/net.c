...
struct V_4 * * V_16 ;
int V_14 ;
V_13 = F_3 ( sizeof *V_13 , V_7 | V_131 | V_132 ) ;
if ( ! V_13 ) {
V_13 = F_88 ( sizeof *V_13 ) ;
if ( ! V_13 )
return - V_8 ;
}
...
V_13 -> V_16 [ V_63 ] . V_1 . V_133 = F_83 ;
V_13 -> V_16 [ V_109 ] . V_1 . V_133 = F_84 ;
for ( V_14 = 0 ; V_14 < V_15 ; V_14 ++ ) {
V_13 -> V_16 [ V_14 ] . V_6 = NULL ;
V_13 -> V_16 [ V_14 ] . V_17 = NULL ;
V_13 -> V_16 [ V_14 ] . V_21 = 0 ;
...
F_90 ( V_41 , V_16 , V_15 ) ;
F_91 ( V_13 -> V_48 + V_63 , F_85 , V_134 , V_41 ) ;
F_91 ( V_13 -> V_48 + V_109 , F_86 , V_135 , V_41 ) ;
V_130 -> V_53 = V_13 ;
return 0 ;
}
...
static void F_93 ( struct V_12 * V_13 , struct V_28 * * V_136 ,
struct V_28 * * V_137 )
{
* V_136 = F_92 ( V_13 , & V_13 -> V_16 [ V_63 ] . V_1 ) ;
* V_137 = F_92 ( V_13 , & V_13 -> V_16 [ V_109 ] . V_1 ) ;
}
static void F_94 ( struct V_12 * V_13 , int V_138 )
{
F_95 ( V_13 -> V_48 + V_138 ) ;
F_95 ( & V_13 -> V_16 [ V_138 ] . V_1 . V_48 ) ;
}
...
static struct V_28 * F_102 ( int V_139 )
{
struct {
struct V_140 V_141 ;
char V_142 [ V_143 ] ;
} V_144 ;
int V_145 = sizeof V_144 , V_11 ;
struct V_28 * V_29 = F_103 ( V_139 , & V_11 ) ;
if ( ! V_29 )
return F_4 ( - V_146 ) ;
if ( V_29 -> V_31 -> V_147 != V_148 ) {
V_11 = - V_149 ;
goto V_19;
}
V_11 = V_29 -> V_88 -> V_150 ( V_29 , (struct V_151 * ) & V_144 . V_141 ,
& V_145 , 0 ) ;
if ( V_11 )
goto V_19;
if ( V_144 . V_141 . V_152 != V_153 ) {
V_11 = - V_154 ;
goto V_19;
}
return V_29 ;
...
static struct V_28 * F_104 ( int V_139 )
{
struct V_54 * V_54 = F_105 ( V_139 ) ;
struct V_28 * V_29 ;
if ( ! V_54 )
return F_4 ( - V_155 ) ;
V_29 = F_106 ( V_54 ) ;
...
static struct V_28 * F_110 ( int V_139 )
{
struct V_28 * V_29 ;
if ( V_139 == - 1 )
return NULL ;
...
static long F_111 ( struct V_12 * V_13 , unsigned V_138 , int V_139 )
{
struct V_28 * V_29 , * V_156 ;
struct V_4 * V_1 ;
struct V_33 * V_34 ;
struct V_3 * V_6 , * V_157 = NULL ;
int V_11 ;
F_54 ( & V_13 -> V_41 . V_79 ) ;
...
V_1 = & V_13 -> V_16 [ V_138 ] . V_1 ;
V_34 = & V_13 -> V_16 [ V_138 ] ;
F_54 ( & V_1 -> V_79 ) ;
if ( ! F_113 ( V_1 ) ) {
V_11 = - V_158 ;
goto V_159;
...
static int F_119 ( struct V_12 * V_13 , T_5 V_165 )
{
T_1 V_22 , V_23 , V_166 ;
int V_14 ;
V_166 = ( V_165 & ( ( 1ULL << V_122 ) |
( 1ULL << V_167 ) ) ) ?
sizeof( struct V_168 ) :
sizeof( struct V_111 ) ;
if ( V_165 & ( 1 << V_169 ) ) {
...
V_13 -> V_16 [ V_14 ] . V_1 . V_172 = V_165 ;
...
static long F_125 ( struct V_54 * V_130 , unsigned int V_174 ,
unsigned long V_175 )
{
struct V_12 * V_13 = V_130 -> V_53 ;
void T_6 * V_176 = ( void T_6 * ) V_175 ;
T_5 T_6 * V_177 = V_176 ;
struct V_178 V_179 ;
T_5 V_165 ;
int V_11 ;
switch ( V_174 ) {
case V_180 :
if ( F_126 ( & V_179 , V_176 , sizeof V_179 ) )
return - V_158 ;
return F_111 ( V_13 , V_179 . V_138 , V_179 . V_139 ) ;
case V_181 :
V_165 = V_182 ;
if ( F_127 ( V_177 , & V_165 , sizeof V_165 ) )
return - V_158 ;
return 0 ;
case V_183 :
if ( F_126 ( & V_165 , V_177 , sizeof V_165 ) )
return - V_158 ;
if ( V_165 & ~ V_182 )
return - V_184 ;
return F_119 ( V_13 , V_165 ) ;
case V_185 :
return F_116 ( V_13 ) ;
case V_186 :
return F_122 ( V_13 ) ;
default:
F_54 ( & V_13 -> V_41 . V_79 ) ;
V_11 = F_128 ( & V_13 -> V_41 , V_174 , V_176 ) ;
if ( V_11 == - V_187 )
V_11 = F_129 ( & V_13 -> V_41 , V_174 , V_176 ) ;
else
F_96 ( V_13 ) ;
F_68 ( & V_13 -> V_41 . V_79 ) ;
return V_11 ;
...
static long F_130 ( struct V_54 * V_130 , unsigned int V_174 ,
unsigned long V_175 )
{
return F_125 ( V_130 , V_174 , ( unsigned long ) F_131 ( V_175 ) ) ;
}
static T_7 F_132 ( struct V_188 * V_189 , struct V_118 * V_190 )
{
struct V_54 * V_54 = V_189 -> V_191 ;
struct V_12 * V_13 = V_54 -> V_53 ;
struct V_49 * V_41 = & V_13 -> V_41 ;
int V_192 = V_54 -> V_193 & V_194 ;
return F_133 ( V_41 , V_190 , V_192 ) ;
}
static T_7 F_134 ( struct V_188 * V_189 ,
struct V_118 * V_195 )
{
struct V_54 * V_54 = V_189 -> V_191 ;
struct V_12 * V_13 = V_54 -> V_53 ;
struct V_49 * V_41 = & V_13 -> V_41 ;
return F_135 ( V_41 , V_195 ) ;
}
