...
L_4 ,
V_6 ) ;
V_84 = F_34 ( & V_85 , 0 , 0 , V_26 ) ;
if ( V_84 < 0 )
return F_19 ( V_84 ) ;
V_17 = F_35 ( sizeof( * V_17 ) , V_26 ) ;
if ( V_17 == NULL ) {
V_83 = - V_27 ;
goto V_86;
}
...
struct V_1 *
F_41 ( struct V_1 * V_2 , const char * V_6 ,
void * V_51 ,
const struct V_77 * V_20 ,
...
struct V_1 * F_42 ( struct V_1 * V_2 )
{
F_33 ( V_2 ,
L_5 ) ;
return F_32 ( V_2 , NULL , NULL , NULL , NULL ) ;
}
