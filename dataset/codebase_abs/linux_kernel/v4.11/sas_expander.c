...
F_62 ( V_203 -> V_211 , V_203 -> V_60 ) ;
F_56 ( V_186 , V_203 , V_65 ) ;
V_159 -> V_224 = V_205 -> V_224 + 1 ;
V_186 -> V_22 -> V_85 . V_225 = F_57 ( V_186 -> V_22 -> V_85 . V_225 ,
V_159 -> V_224 ) ;
F_70 ( V_203 ) ;
F_76 ( V_203 , V_90 ) ;
F_88 ( V_90 ) ;
F_80 ( & V_186 -> V_22 -> V_220 ) ;
F_74 ( & V_203 -> V_221 , & V_186 -> V_22 -> V_226 ) ;
F_81 ( & V_186 -> V_22 -> V_220 ) ;
V_18 = F_89 ( V_203 ) ;
if ( V_18 ) {
F_90 ( V_90 ) ;
...
static int F_96 ( struct V_12 * V_13 , T_1 * V_231 )
{
struct V_87 * V_88 = & V_13 -> V_27 ;
int V_21 ;
for ( V_21 = 0 ; V_21 < V_88 -> V_140 ; V_21 ++ ) {
...
{
struct V_87 * V_88 = & V_13 -> V_27 ;
int V_21 = 0 , V_233 = V_88 -> V_140 ;
int V_18 = 0 ;
if ( 0 <= V_136 && V_136 < V_233 ) {
V_21 = V_136 ;
V_233 = V_21 + 1 ;
}
for ( ; V_21 < V_233 ; V_21 ++ ) {
...
int V_18 = 0 ;
struct V_12 * V_186 = V_203 -> V_186 ;
if ( F_16 ( V_186 -> V_22 -> V_85 . V_230 ) != 0 ) {
V_18 = - V_239 ;
F_14 ( L_47
L_48 ,
F_16 ( V_186 -> V_60 ) ,
...
F_16 ( V_203 -> V_60 ) ,
V_237 -> V_80 ,
F_16 ( V_186 -> V_22 -> V_85 . V_230 ) ) ;
} else if ( F_16 ( V_186 -> V_22 -> V_85 . V_240 ) == 0 ) {
memcpy ( V_186 -> V_22 -> V_85 . V_240 , V_186 -> V_60 ,
V_84 ) ;
memcpy ( V_186 -> V_22 -> V_85 . V_241 , V_203 -> V_60 ,
V_84 ) ;
} else if ( ( ( F_16 ( V_186 -> V_22 -> V_85 . V_240 ) ==
F_16 ( V_186 -> V_60 ) ) ||
( F_16 ( V_186 -> V_22 -> V_85 . V_240 ) ==
F_16 ( V_203 -> V_60 ) ) )
&&
( ( F_16 ( V_186 -> V_22 -> V_85 . V_241 ) ==
F_16 ( V_186 -> V_60 ) ) ||
( F_16 ( V_186 -> V_22 -> V_85 . V_241 ) ==
F_16 ( V_203 -> V_60 ) ) ) )
;
...
continue;
V_237 = & V_242 -> V_64 [ V_204 -> V_108 ] ;
switch ( V_203 -> V_186 -> V_82 ) {
case V_130 :
if ( V_203 -> V_82 == V_131 ) {
if ( V_204 -> V_66 != V_70 ||
V_237 -> V_66 != V_67 ) {
F_100 ( V_203 , V_204 , V_237 ) ;
V_18 = - V_239 ;
}
} else if ( V_204 -> V_66 == V_70 ) {
if ( V_237 -> V_66 == V_70 ) {
V_18 = F_101 ( V_203 , V_204 , V_237 ) ;
} else if ( V_237 -> V_66 != V_67 ) {
F_100 ( V_203 , V_204 , V_237 ) ;
V_18 = - V_239 ;
}
...
* ( V_250 * ) ( V_245 + 6 ) = F_104 ( V_21 ) ;
V_18 = F_7 ( V_13 , V_245 , V_247 , V_246 ,
V_248 ) ;
if ( V_18 )
goto V_102;
V_18 = V_246 [ 2 ] ;
...
T_1 * V_60 , int V_243 , int include )
{
int V_18 ;
T_1 * V_252 ;
T_1 * V_253 ;
...
V_252 [ 12 ] |= 0x80 ;
memcpy ( V_252 + 16 , V_60 , V_84 ) ;
V_18 = F_7 ( V_13 , V_252 , V_254 , V_253 ,
V_255 ) ;
if ( V_18 )
goto V_102;
V_18 = V_253 [ 2 ] ;
...
int V_244 ;
int V_18 ;
V_18 = F_103 ( V_13 , V_80 , V_60 , & V_243 , & V_244 ) ;
if ( V_18 )
return V_18 ;
if ( include ^ V_244 )
return F_105 ( V_13 , V_80 , V_60 , V_243 , include ) ;
return V_18 ;
}
...
for ( V_21 = 0 ; V_21 < V_257 -> V_140 ; V_21 ++ ) {
struct V_64 * V_65 = & V_257 -> V_64 [ V_21 ] ;
if ( ( V_65 -> V_66 == V_67 ) &&
( F_16 ( V_65 -> V_100 ) ==
F_16 ( V_203 -> V_60 ) ) ) {
...
static int F_109 ( struct V_184 * V_22 , const int V_224 )
{
int V_18 = 0 ;
struct V_12 * V_13 ;
F_51 (dev, &port->dev_list, dev_list_node) {
...
int V_224 ;
do {
V_224 = V_22 -> V_85 . V_225 ;
V_18 = F_109 ( V_22 , V_224 ) ;
F_111 () ;
} while ( V_224 < V_22 -> V_85 . V_225 );
return V_18 ;
}
...
if ( V_18 )
goto V_141;
V_88 -> V_224 = V_13 -> V_22 -> V_85 . V_225 ;
V_18 = F_89 ( V_13 ) ;
if ( V_18 )
goto V_259;
F_110 ( V_13 -> V_22 ) ;
...
int V_18 = 0 ;
int V_21 ;
for ( V_21 = V_261 ; V_21 < V_88 -> V_140 ; V_21 ++ ) {
int V_109 = 0 ;
...
static int F_118 ( struct V_12 * V_13 , int * V_264 )
{
int V_18 ;
T_1 * V_151 ;
struct V_38 * V_152 ;
...
if ( V_266 -> V_82 == V_130 || V_266 -> V_82 == V_131 ) {
V_18 = F_119 ( V_266 , V_265 ) ;
if ( * V_265 )
return V_18 ;
}
}
...
struct V_12 * V_203 , * V_267 , * V_269 = NULL ;
if ( V_268 ) {
F_121 (child, n,
...
F_67 ( V_269 , V_65 -> V_22 ) ;
if ( V_65 -> V_22 -> V_140 == 0 )
F_82 ( V_65 -> V_22 ) ;
V_65 -> V_22 = NULL ;
}
}
static int F_125 ( struct V_12 * V_270 ,
const int V_224 )
{
struct V_87 * V_271 = & V_270 -> V_27 ;
struct V_12 * V_203 ;
int V_18 = 0 ;
...
int V_18 ;
struct V_158 * V_88 = F_45 ( V_13 -> V_90 ) ;
int V_224 = V_88 -> V_224 + 1 ;
V_18 = F_98 ( V_13 , - 1 ) ;
if ( V_18 )
goto V_102;
do {
V_18 = F_125 ( V_13 , V_224 ) ;
F_111 () ;
V_224 += 1 ;
} while ( V_224 <= V_13 -> V_22 -> V_85 . V_225 );
V_102:
return V_18 ;
}
...
static bool F_128 ( enum V_71 V_272 , enum V_71 V_273 )
{
if ( V_273 == V_272 )
return true ;
if ( ( V_273 == V_79 && V_272 == V_129 ) ||
( V_273 == V_129 && V_272 == V_79 ) )
return true ;
return false ;
}
static int F_129 ( struct V_12 * V_13 , int V_80 , bool V_268 )
{
struct V_87 * V_88 = & V_13 -> V_27 ;
struct V_64 * V_65 = & V_88 -> V_64 [ V_80 ] ;
enum V_71 type = V_75 ;
...
struct V_12 * V_274 = F_31 ( V_13 , V_80 ) ;
char * V_275 = L_16 ;
F_36 ( V_13 , V_80 ) ;
if ( V_274 && V_65 -> V_74 == V_79 )
V_275 = L_62 ;
F_14 ( L_63 ,
F_16 ( V_13 -> V_60 ) , V_80 , V_275 ) ;
return V_18 ;
}
if ( F_16 ( V_65 -> V_100 ) &&
...
{
struct V_87 * V_88 = & V_13 -> V_27 ;
struct V_64 * V_276 = & V_88 -> V_64 [ V_80 ] ;
int V_18 = 0 ;
int V_21 ;
bool V_268 = true ;
F_14 ( L_65 ,
F_16 ( V_13 -> V_60 ) , V_80 ) ;
if ( F_16 ( V_276 -> V_100 ) != 0 ) {
for ( V_21 = 0 ; V_21 < V_88 -> V_140 ; V_21 ++ ) {
struct V_64 * V_65 = & V_88 -> V_64 [ V_21 ] ;
if ( V_21 == V_80 )
continue;
...
V_18 = F_129 ( V_13 , V_80 , V_268 ) ;
} else
V_18 = F_127 ( V_13 , V_80 ) ;
return V_18 ;
}
int F_131 ( struct V_12 * V_258 )
{
int V_18 ;
struct V_12 * V_13 = NULL ;
V_18 = F_119 ( V_258 , & V_13 ) ;
while ( V_18 == 0 && V_13 ) {
struct V_87 * V_88 = & V_13 -> V_27 ;
int V_21 = 0 , V_80 ;
do {
...
int F_132 ( struct V_277 * V_25 , struct V_89 * V_90 ,
struct V_278 * V_14 )
{
struct V_12 * V_13 ;
int V_279 , type ;
struct V_278 * V_81 = V_14 -> V_280 ;
if ( ! V_81 ) {
F_133 ( L_68 ,
V_59 ) ;
return - V_281 ;
...
F_135 ( V_81 -> V_282 ) ) {
F_133 ( L_71 ,
V_59 , F_136 ( V_14 ) , F_136 ( V_81 ) ) ;
return - V_281 ;
}
V_279 = F_7 ( V_13 , F_137 ( V_14 -> V_282 ) , F_136 ( V_14 ) ,
F_137 ( V_81 -> V_282 ) , F_136 ( V_81 ) ) ;
if ( V_279 > 0 ) {
F_138 ( V_81 ) -> V_283 = V_279 ;
F_138 ( V_14 ) -> V_283 = 0 ;
V_279 = 0 ;
} else if ( V_279 == 0 ) {
F_138 ( V_81 ) -> V_283 = 0 ;
