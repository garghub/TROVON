...
static int F_32 ( struct V_87 * V_75 )
{
struct V_56 * V_57 ;
struct V_73 * V_74 = & V_75 -> V_74 ;
const struct V_97 * V_98 ;
int V_78 ;
V_57 = F_33 ( V_74 , sizeof( * V_57 ) , V_99 ) ;
if ( ! V_57 )
return - V_96 ;
V_98 = F_34 ( V_100 , V_74 -> V_101 ) ;
if ( ! V_98 )
return - V_102 ;
...
V_57 -> V_104 = F_35 ( V_74 -> V_101 ,
L_13 ) ;
V_57 -> V_64 = F_30 ( V_75 , L_8 , L_14 ) ;
if ( F_31 ( V_57 -> V_64 ) ) {
F_15 ( V_74 , L_15 , V_81 ) ;
V_78 = - V_96 ;
goto V_85;
...
if ( V_78 )
goto V_85;
V_57 -> V_107 = F_38 ( V_75 , V_57 -> V_65 -> type , V_57 -> V_62 ) ;
if ( ! V_57 -> V_107 )
F_39 ( V_74 ,
L_19 ,
V_81 ) ;
...
static int F_41 ( struct V_87 * V_75 )
{
struct V_56 * V_57 = F_42 ( V_75 ) ;
if ( V_57 && V_57 -> V_107 ) {
F_43 ( V_57 -> V_107 ) ;
V_57 -> V_107 = NULL ;
}
...
int F_48 ( struct V_56 * V_57 , int V_109 ,
struct V_17 * V_18 )
{
struct V_73 * V_74 = & V_57 -> V_75 -> V_74 ;
int V_78 ;
...
struct V_119 * F_53 ( struct V_56 * V_57 )
{
if ( ! V_57 )
return NULL ;
return V_57 -> V_107 ;
