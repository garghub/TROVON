...
V_11 = 0 ;
return F_22 ( (struct V_36 * ) ( V_6 -> V_37 ) + V_11 ) ;
}
int F_23 ( struct V_3 * V_4 ,
struct V_1 * V_38 )
{
struct V_5 * V_6 = F_24 ( V_4 ) ;
struct V_1 * V_2 = F_19 ( V_6 , F_5 ( V_38 ) ) ;
F_25 ( V_38 ) ;
return F_26 ( V_2 , V_4 , V_2 -> type ) ;
}
int F_27 ( struct V_5 * V_6 )
{
struct V_39 * V_40 = F_28 ( V_6 ) ;
struct V_36 * V_37 ;
static struct V_41 * V_42 ;
int V_43 , V_44 , V_29 ;
V_44 = V_6 -> V_45 ;
V_37 = F_29 ( V_40 , sizeof( * V_37 ) * V_44 , V_46 ) ;
if ( ! V_37 )
return - V_47 ;
V_6 -> V_37 = V_37 ;
V_6 -> V_48 = V_44 ;
