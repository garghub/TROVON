...
V_14 -> V_82 = V_82 ;
V_14 -> V_96 = V_2 ;
F_48 ( V_2 , V_15 + V_97 , & V_14 -> V_69 ) ;
F_54 ( V_2 , V_15 + V_98 , & V_14 -> V_72 ) ;
if ( F_55 ( V_2 ) == V_99 )
...
V_113 = F_80 ( V_2 -> V_45 , V_115 , NULL ) ;
while ( V_113 ) {
if ( V_113 -> V_50 && ( V_113 -> V_49 == V_2 ) &&
F_81 ( V_113 ) )
V_114 ++ ;
V_113 = F_80 ( V_2 -> V_45 , V_115 , V_113 ) ;
}
return V_114 ;
}
int F_82 ( struct V_1 * V_2 , T_3 V_116 )
{
if ( ! V_2 -> V_4 )
return - V_74 ;
