...
static void F_36 ( struct V_1 * V_27 )
{
struct V_46 * V_47 = F_37 ( & V_27 -> V_48 , NULL ) ;
if ( V_47 )
V_48 ( V_47 ) ;
else
F_35 ( V_27 ) ;
}
static int F_38 ( void * V_26 )
{
struct V_1 * V_27 = V_26 ;
T_3 V_49 ;
F_21 ( & V_31 -> V_32 -> V_33 ) ;
...
F_23 ( & V_31 -> V_32 -> V_33 ) ;
V_49 = F_39 ( F_20 , V_27 , V_51 ) ;
if ( V_49 < 0 ) {
V_27 -> V_30 = V_49 ;
} else {
int V_17 = - V_55 ;
F_40 ( V_49 , ( int V_43 * ) & V_17 , 0 , NULL ) ;
if ( V_17 )
V_27 -> V_30 = V_17 ;
}
F_36 ( V_27 ) ;
...
{
struct V_1 * V_27 ;
V_27 = F_64 ( sizeof( struct V_1 ) , V_77 ) ;
if ( ! V_27 )
goto V_8;
F_65 ( & V_27 -> V_57 , F_41 ) ;
V_27 -> V_42 = V_42 ;
...
int F_70 ( char * V_42 , char * * V_3 , char * * V_6 , int V_5 )
{
struct V_1 * V_2 ;
...
static int F_71 ( struct V_84 * V_85 , int V_86 ,
...
V_90 = * V_85 ;
V_90 . V_26 = & V_91 ;
V_94 = F_74 ( & V_90 , V_86 , V_87 , V_88 , V_89 ) ;
if ( V_94 < 0 )
return V_94 ;
for ( V_95 = 0 ; V_95 < V_92 ; V_95 ++ )
