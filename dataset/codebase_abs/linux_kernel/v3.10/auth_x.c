...
V_97 -> V_121 = (struct V_122 * ) V_76 ;
V_97 -> V_123 = V_76 -> V_41 -> V_73 . V_84 ;
V_97 -> V_124 = V_76 -> V_41 -> V_73 . V_74 ;
V_97 -> V_125 = V_76 -> V_126 ;
V_97 -> V_127 = sizeof ( V_76 -> V_126 ) ;
return 0 ;
}
static int F_57 (
struct V_1 * V_2 , int V_119 ,
...
if ( F_30 ( V_30 ) )
return F_31 ( V_30 ) ;
V_76 = (struct V_75 * ) V_97 -> V_121 ;
if ( V_76 -> V_70 < V_30 -> V_70 ) {
F_3 ( L_21 ,
V_76 -> V_29 , V_76 -> V_70 , V_30 -> V_70 ) ;
return F_40 ( V_2 , V_30 , V_76 ) ;
}
return 0 ;
}
static int F_58 ( struct V_1 * V_2 ,
struct V_122 * V_128 , T_1 V_20 )
{
struct V_75 * V_76 = ( void * ) V_128 ;
struct V_28 * V_30 ;
int V_21 = 0 ;
struct V_129 V_130 ;
void * V_22 = V_76 -> V_126 ;
void * V_23 = V_22 + sizeof( V_76 -> V_126 ) ;
V_30 = F_14 ( V_2 , V_76 -> V_29 ) ;
if ( F_30 ( V_30 ) )
return F_31 ( V_30 ) ;
V_21 = F_10 ( & V_30 -> V_39 , & V_22 , V_23 , & V_130 , sizeof( V_130 ) ) ;
if ( V_21 < 0 )
return V_21 ;
if ( V_21 != sizeof( V_130 ) )
return - V_27 ;
if ( V_76 -> V_89 + 1 != F_13 ( V_130 . V_131 ) )
V_21 = - V_27 ;
else
V_21 = 0 ;
F_3 ( L_22 ,
V_76 -> V_89 , F_13 ( V_130 . V_131 ) , V_21 ) ;
return V_21 ;
}
...
V_30 = F_14 ( V_2 , V_119 ) ;
if ( ! F_30 ( V_30 ) )
memset ( & V_30 -> V_56 , 0 , sizeof( V_30 -> V_56 ) ) ;
}
