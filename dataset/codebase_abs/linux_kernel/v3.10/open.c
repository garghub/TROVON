...
struct V_4 * F_73 ( struct V_124 * V_125 , int V_104 , T_3 V_49 )
{
struct V_105 V_106 ;
int V_126 = F_71 ( V_104 , V_49 , & V_106 ) ;
return F_74 ( V_33 , V_125 , & V_106 , V_126 ) ;
}
struct V_4 * F_75 ( const char * V_124 , int V_104 , T_3 V_49 )
{
struct V_124 V_125 = { . V_125 = V_124 } ;
return F_73 ( & V_125 , V_104 , V_49 ) ;
}
struct V_4 * F_76 ( struct V_1 * V_1 , struct V_76 * V_22 ,
const char * V_124 , int V_104 )
{
struct V_105 V_106 ;
int V_126 = F_71 ( V_104 , 0 , & V_106 ) ;
if ( V_104 & V_96 )
return F_69 ( - V_9 ) ;
if ( ! V_124 && ( V_104 & V_113 ) )
if ( ! V_1 -> V_16 -> V_127 -> V_126 )
return F_69 ( - V_128 ) ;
return F_77 ( V_1 , V_22 , V_124 , & V_106 , V_126 ) ;
}
long F_78 ( int V_129 , const char T_2 * V_124 , int V_104 , T_3 V_49 )
{
struct V_105 V_106 ;
int V_126 = F_71 ( V_104 , V_49 , & V_106 ) ;
struct V_124 * V_130 = F_79 ( V_124 ) ;
int V_35 = F_80 ( V_130 ) ;
if ( ! F_67 ( V_130 ) ) {
V_35 = F_81 ( V_104 ) ;
if ( V_35 >= 0 ) {
struct V_4 * V_37 = F_74 ( V_129 , V_130 , & V_106 , V_126 ) ;
if ( F_67 ( V_37 ) ) {
F_82 ( V_35 ) ;
V_35 = F_80 ( V_37 ) ;
} else {
...
int F_86 ( struct V_4 * V_5 , T_8 V_131 )
{
int V_132 = 0 ;
if ( ! F_87 ( V_5 ) ) {
F_88 ( V_133 L_1 ) ;
