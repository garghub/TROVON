...
F_3 ( V_4 L_9 ,
V_24 -> V_7 , F_26 ( V_48 -> V_58 ) ) ;
V_22 = F_15 ( V_24 ) ;
V_3 = V_42 == V_51 ?
F_9 ( V_22 -> V_31 , V_24 -> V_11 , F_26 ( V_48 -> V_58 ) ) :
F_10 ( V_22 -> V_31 ) ;
F_3 ( V_4 L_10 ,
...
static void
F_30 ( unsigned char * V_59 , unsigned char * V_60 , int V_16 )
{
int V_61 ;
...
static int
F_31 ( struct V_62 * V_63 , struct V_23 * V_24 )
{
...
V_22 -> V_65 . V_67 ++ ;
if ( V_68 > 5 ) F_30 ( L_19 , V_63 -> V_69 , V_64 ) ;
...
#endif
V_63 -> V_77 = F_38 ( V_63 , V_24 ) ;
if ( V_68 > 6 ) F_30 ( L_22 , V_63 -> V_69 , V_16 ) ;
F_39 ( V_63 ) ;
V_22 -> V_65 . V_78 ++ ;
V_22 -> V_65 . V_79 += V_16 ;
} while ( -- V_74 );
