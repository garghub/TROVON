...
{
unsigned V_167 ;
V_167 = V_13 -> V_169 - V_13 -> V_23 -> V_170 ;
return F_53 ( V_13 , V_167 ) ;
}
...
struct V_12 * V_13 = V_143 -> V_144 ;
struct V_9 * V_10 = F_13 ( V_13 ) ;
int V_171 = ( ( unsigned char * ) V_143 -> V_35 ) [ 0 ] ;
int V_20 = ( ( unsigned char * ) V_143 -> V_35 ) [ 1 ] ;
int V_172 = ( ( unsigned char * ) V_143 -> V_35 ) [ 2 ] ;
unsigned char * V_39 = ( ( unsigned char * ) V_143 -> V_35 ) + 3 ;
int V_173 , V_174 ;
int V_147 = V_143 -> V_147 ;
if ( V_143 -> V_147 == - V_175 )
return 0 ;
if ( V_143 -> V_176 != V_20 + 2 ) {
F_18 ( & V_13 -> V_26 , L_23
L_24
L_25 , V_38 , V_147 ,
V_10 -> V_27 , V_171 , V_20 , V_143 -> V_176 ,
V_172 ) ;
return - 1 ;
}
F_22 ( & V_10 -> V_15 ) ;
...
F_14 ( & V_13 -> V_26 , L_27 , V_38 , V_171 ) ;
return V_174 ? 1 : 0 ;
}
...
struct V_59 * V_60 ;
struct V_9 * V_10 = F_13 ( V_13 ) ;
int V_171 , line , V_147 , V_137 ;
int V_76 ;
unsigned int V_187 ;
for ( V_76 = 0 ; V_76 < V_143 -> V_176 - 3 ; ) {
V_171 = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
line = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
V_147 = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
V_137 = ( ( unsigned char * ) V_143 -> V_35 ) [ V_76 ++ ] ;
F_14 ( & V_13 -> V_26 , L_28 ,
V_171 , line , V_147 , V_137 ) ;
