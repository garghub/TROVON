...
F_1 ( V_2 ) ;
F_14 ( V_62 ) ;
F_22 ( V_2 -> V_4 , F_23 ( V_34 ) , F_23 ( V_35 ) ) ;
V_2 -> V_74 . V_75 = 0 ;
V_37 = F_16 ( V_27 ) ;
F_17 ( V_64 , & V_37 ) ;
}
...
void F_25 ( void * V_76 , struct V_77 * V_78 ,
...
T_4 = F_34 ( V_2 , NULL , V_78 , V_89 , true ) ;
if ( T_4 != 0 ) {
F_35 ( V_2 , V_89 ) ;
F_26 ( V_78 ) ;
F_13 ( V_23 , V_97 , L_7 ) ;
...
if ( F_38 ( F_19 ( V_113 , & V_2 -> V_71 ) ) ) {
F_36 ( & V_2 -> V_90 ) ;
return;
}
V_111 = F_39 ( V_2 -> V_92 , V_84 ) ;
if ( ! V_111 ) {
F_36 ( & V_2 -> V_90 ) ;
return;
}
...
V_102 -> V_119 += 0x10 ;
V_86 -> V_120 &= F_41 ( V_121 ) ;
V_86 -> V_120 |= F_41 ( V_102 -> V_119 ) ;
}
V_106 = F_42 ( V_111 ) ;
...
V_112 = F_32 ( V_111 , sizeof( V_104 ) ) ;
memcpy ( V_112 , ( T_5 * ) & V_104 , sizeof( V_104 ) ) ;
T_4 = F_43 ( V_2 -> V_127 , V_111 ) ;
if ( T_4 != 0 ) {
if ( T_4 == - V_128 ) {
F_13 ( V_23 , V_129 ,
L_8 ) ;
...
V_102 -> V_116 = F_51 ( F_23 ( V_116 ) ) ;
F_13 ( V_23 , V_61 , L_14 ,
( unsigned long long ) V_116 , V_102 -> V_91 ) ;
}
static void F_52 ( void * V_93 , T_5 * V_138 , struct V_83 * V_84 )
{
