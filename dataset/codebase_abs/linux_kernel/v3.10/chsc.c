...
if ( V_65 -> V_66 != 0 )
return;
V_40 = (struct V_76 * ) & ( V_65 -> V_68 ) ;
F_6 ( & V_35 ) ;
for ( V_74 = 0 ; V_74 <= V_75 ; V_74 ++ ) {
if ( ! F_25 ( V_40 -> V_78 , V_74 ) )
continue;
V_35 . V_36 = V_74 ;
F_31 ( L_16 ,
V_77 [ V_40 -> V_79 ] , V_35 . V_51 , V_35 . V_36 ) ;
switch ( V_40 -> V_79 ) {
case 0 :
F_32 ( V_35 , 1 ) ;
break;
...
static void F_38 ( struct V_80 * V_65 )
{
switch ( V_65 -> V_81 ) {
case 1 :
F_39 ( V_65 -> V_68 ) ;
...
static void F_43 ( struct V_83 * V_84 , T_4 V_85 )
{
do {
...
break;
default:
F_21 ( 2 , L_27 , V_84 -> V_86 ) ;
break;
}
} while ( V_84 -> V_87 . V_88 . V_82 & 0x80 );
}
static void F_44 ( struct V_90 * V_91 , struct V_90 * V_92 , int V_93 )
{
...
F_21 ( 2 , L_28
L_29 ,
V_91 -> V_95 , V_91 -> V_96 , V_91 -> V_97 , V_91 -> V_98 , V_91 -> V_99 ,
V_91 -> V_100 , V_91 -> V_67 ) ;
F_11 ( 2 , L_30 ) ;
F_43 ( V_84 , V_101 | V_102 ) ;
}
void F_45 ( struct V_47 V_35 )
{
char V_48 [ 15 ] ;
struct V_49 V_50 ;
sprintf ( V_48 , L_31 , V_35 . V_51 , V_35 . V_36 ) ;
F_11 ( 2 , V_48 ) ;
if ( F_12 ( V_35 ) != 0 ) {
memset ( & V_50 , 0 , sizeof( struct V_49 ) ) ;
V_50 . V_35 = V_35 ;
...
int F_52 ( struct V_47 V_35 , int V_103 )
{
...
static void
F_53 ( struct V_106 * V_107 )
{
int V_15 ;
for ( V_15 = 0 ; V_15 <= V_75 ; V_15 ++ ) {
if ( ! V_107 -> V_108 [ V_15 ] )
continue;
F_54 ( V_107 -> V_108 [ V_15 ] ) ;
}
}
static int
F_55 ( struct V_106 * V_107 )
{
int V_15 , V_14 ;
V_14 = 0 ;
for ( V_15 = 0 ; V_15 <= V_75 ; V_15 ++ ) {
...
int F_57 ( struct V_106 * V_107 , int V_110 )
{
struct {
struct V_111 V_20 ;
T_3 V_112 : 2 ;
...
memset ( V_18 , 0 , V_19 ) ;
V_120 = V_18 ;
V_120 -> V_20 . V_21 = 0x0050 ;
V_120 -> V_20 . V_22 = 0x0016 ;
V_120 -> V_113 = V_121 >> 4 ;
V_120 -> V_115 = ( T_4 ) ( unsigned long ) V_107 -> V_115 ;
V_120 -> V_117 = ( T_4 ) ( unsigned long ) V_107 -> V_117 ;
V_120 -> V_112 = V_110 ? 0 : 1 ;
V_13 = F_4 ( V_120 ) ;
if ( V_13 > 0 ) {
V_14 = ( V_13 == 3 ) ? - V_27 : - V_4 ;
goto V_28;
}
switch ( V_120 -> V_1 . V_22 ) {
case 0x0102 :
case 0x0103 :
V_14 = - V_2 ;
break;
default:
V_14 = F_1 ( V_120 -> V_1 . V_22 ) ;
}
if ( V_14 != 0 )
F_21 ( 2 , L_32 ,
V_120 -> V_1 . V_22 ) ;
...
int
F_58 ( struct V_106 * V_107 , int V_110 )
{
int V_14 ;
if ( V_110 && ! V_107 -> V_122 ) {
V_107 -> V_115 = ( void * ) F_59 ( V_123 | V_124 ) ;
V_107 -> V_117 = ( void * ) F_59 ( V_123 | V_124 ) ;
if ( ! V_107 -> V_115 || ! V_107 -> V_117 ) {
F_60 ( ( unsigned long ) V_107 -> V_115 ) ;
F_60 ( ( unsigned long ) V_107 -> V_117 ) ;
return - V_5 ;
}
}
V_14 = F_57 ( V_107 , V_110 ) ;
if ( ! V_14 ) {
V_107 -> V_122 = V_110 ;
if ( V_107 -> V_122 ) {
V_14 = F_55 ( V_107 ) ;
...
int F_61 ( struct V_47 V_35 , int V_119 , int V_125 ,
int V_126 , int V_127 , void * V_128 )
{
struct V_129 * V_130 ;
int V_13 , V_14 ;
if ( ( V_125 == 1 ) && ! V_131 . V_132 )
return - V_2 ;
if ( ( V_125 == 2 ) && ! V_131 . V_133 )
return - V_2 ;
memset ( V_128 , 0 , V_19 ) ;
V_130 = V_128 ;
V_130 -> V_20 . V_21 = 0x0010 ;
V_130 -> V_20 . V_22 = 0x0002 ;
V_130 -> V_51 = V_35 . V_51 ;
V_130 -> V_134 = V_35 . V_36 ;
V_130 -> V_135 = V_35 . V_36 ;
V_130 -> V_127 = V_127 ;
V_130 -> V_126 = V_126 ;
V_130 -> V_119 = V_119 ;
V_130 -> V_125 = V_125 ;
...
V_14 = F_1 ( V_130 -> V_1 . V_22 ) ;
if ( V_14 )
F_21 ( 2 , L_33 ,
V_130 -> V_1 . V_22 ) ;
return V_14 ;
}
int F_62 ( struct V_47 V_35 ,
struct V_136 * V_137 )
{
struct V_138 * V_139 ;
struct V_129 * V_130 ;
...
F_47 ( & V_17 , V_82 ) ;
V_130 = V_18 ;
V_14 = F_61 ( V_35 , 0 , 0 , 0 , 0 , V_130 ) ;
if ( V_14 )
goto V_28;
V_139 = ( void * ) & V_130 -> V_1 ;
memcpy ( V_137 , & V_139 -> V_40 , sizeof( * V_137 ) ) ;
V_28:
F_48 ( & V_17 , V_82 ) ;
return V_14 ;
}
int F_63 ( struct V_47 V_35 ,
struct V_140 * V_137 )
{
struct V_138 * V_139 ;
struct V_129 * V_130 ;
...
static void
F_64 ( struct V_72 * V_73 , T_1 V_141 ,
struct V_142 * V_143 )
{
struct V_142 * V_142 ;
int V_15 , V_16 ;
...
{
int V_14 ;
V_94 = ( void * ) F_59 ( V_123 | V_124 ) ;
V_18 = ( void * ) F_59 ( V_123 | V_124 ) ;
if ( ! V_94 || ! V_18 ) {
V_14 = - V_5 ;
goto V_152;
}
V_14 = F_69 ( V_153 , F_44 ) ;
if ( V_14 )
goto V_152;
return V_14 ;
V_152:
...
int F_74 ( void * V_128 , unsigned int V_79 , T_2 V_169 )
{
struct {
struct V_111 V_20 ;
unsigned int V_170 ;
...
int F_75 ( void * V_128 , void * V_164 , T_6 V_176 )
{
struct {
struct V_111 V_20 ;
...
int F_77 ( struct F_77 * V_182 , T_4 V_183 )
{
int V_13 , V_14 ;
