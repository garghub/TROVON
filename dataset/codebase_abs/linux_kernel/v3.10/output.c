...
V_14 -> V_94 ? L_8 : L_9 ,
V_14 -> V_94 ?
F_53 ( V_14 -> V_95 . V_96 -> V_97 ) : 0 ,
L_10 , F_26 ( V_14 -> V_45 -> V_59 ) ,
L_11 , V_14 -> V_39 -> V_92 ,
L_12 , V_14 -> V_91 ) ;
if ( ! F_20 ( V_14 ) )
F_13 ( V_14 ) ;
...
T_1 V_103 = F_55 ( ( T_5 * ) V_73 , V_79 ) ;
V_73 -> V_89 = F_56 ( V_103 ) ;
} else {
V_74 -> V_104 = V_105 ;
V_74 -> V_106 = ( F_57 ( V_74 ) -
V_74 -> V_107 ) ;
V_74 -> V_108 = F_58 ( struct V_33 , V_89 ) ;
}
}
...
struct V_47 * V_48 ;
unsigned long V_112 ;
if ( F_59 ( V_17 , V_113 ) && V_17 -> V_114 ) {
V_48 = & V_17 -> V_49 [ V_115 ] ;
V_112 = V_17 -> V_116 [ V_115 ] ;
if ( ! F_60 ( V_48 , V_63 + V_112 ) )
F_61 ( V_17 ) ;
}
}
F_3 ( L_13 ,
...
V_86:
F_62 ( V_74 ) ;
F_63 ( F_64 ( V_17 -> V_27 . V_28 ) , V_119 ) ;
V_75:
F_11 (chunk, tmp, &packet->chunk_list, list) {
F_12 ( & V_14 -> V_35 ) ;
if ( ! F_20 ( V_14 ) )
