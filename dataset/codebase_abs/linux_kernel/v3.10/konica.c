...
+ V_58 -> V_51 [ V_20 ] . V_53 ;
if ( V_61 & 0x80 ) {
F_29 ( V_1 , V_74 , NULL , 0 ) ;
F_29 ( V_1 , V_75 , NULL , 0 ) ;
} else {
#if F_22 ( V_54 )
T_2 V_76 = V_61 & 0x40 ? 1 : 0 ;
if ( V_21 -> V_55 != V_76 ) {
F_23 ( V_1 -> V_56 ,
V_57 ,
V_76 ) ;
...
{
struct V_1 * V_1 =
F_31 ( V_79 -> V_80 , struct V_1 , V_81 ) ;
V_1 -> V_7 = 0 ;
if ( ! V_1 -> V_63 )
return 0 ;
switch ( V_79 -> V_14 ) {
case V_82 :
F_8 ( V_1 ) ;
F_1 ( V_1 , V_79 -> V_83 , V_84 ) ;
F_7 ( V_1 ) ;
break;
case V_85 :
F_8 ( V_1 ) ;
F_1 ( V_1 , V_79 -> V_83 , V_86 ) ;
F_7 ( V_1 ) ;
break;
case V_87 :
F_8 ( V_1 ) ;
F_1 ( V_1 , V_79 -> V_83 , V_88 ) ;
F_7 ( V_1 ) ;
break;
case V_89 :
F_8 ( V_1 ) ;
F_1 ( V_1 , V_79 -> V_83 , V_90 ) ;
F_7 ( V_1 ) ;
break;
case V_91 :
F_8 ( V_1 ) ;
F_1 ( V_1 , V_79 -> V_83 , V_92 ) ;
F_7 ( V_1 ) ;
break;
}
return V_1 -> V_7 ;
...
const struct V_13 * V_14 )
{
return F_36 ( V_28 , V_14 , & V_97 , sizeof( struct V_21 ) ,
V_98 ) ;
}
