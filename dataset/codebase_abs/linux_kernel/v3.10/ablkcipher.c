...
if ( ! F_66 ( V_111 ) )
goto V_115;
V_104 . V_102 . V_116 = sizeof( V_104 ) ;
V_104 . V_102 . V_117 = V_118 ;
V_104 . V_3 . type = type | V_95 ;
V_104 . V_3 . V_68 = V_68 | V_95 ;
V_101 [ 0 ] = & V_104 . V_102 ;
V_106 . V_102 . V_116 = sizeof( V_106 ) ;
V_106 . V_102 . V_117 = V_119 ;
memcpy ( V_106 . V_3 . V_120 , V_67 -> V_112 , V_121 ) ;
V_101 [ 1 ] = & V_106 . V_102 ;
V_101 [ 2 ] = NULL ;
if ( ( V_67 -> V_93 & V_96 ) ==
V_97 )
...
if ( ! V_108 )
goto V_123;
V_110 = V_108 -> V_124 ( V_101 ) ;
V_22 = F_64 ( V_110 ) ;
if ( F_65 ( V_110 ) )
goto V_125;
if ( ( V_22 = F_68 ( V_108 , V_110 ) ) ) {
V_108 -> free ( V_110 ) ;
goto V_125;
}
V_22 = - V_114 ;
...
struct V_66 * F_72 ( const char * V_120 , T_2 type , T_2 V_68 )
{
struct V_66 * V_67 ;
V_67 = F_73 ( V_120 , type , V_68 ) ;
if ( F_65 ( V_67 ) )
return V_67 ;
if ( ( V_67 -> V_93 & V_96 ) ==
V_113 )
...
return V_67 ;
F_71 ( V_67 ) ;
V_67 = F_73 ( V_120 , type | V_126 ,
V_68 & ~ V_126 ) ;
if ( F_65 ( V_67 ) )
return V_67 ;
if ( ( V_67 -> V_93 & V_96 ) ==
V_113 ) {
if ( ( V_67 -> V_93 ^ type ^ ~ V_68 ) & V_126 ) {
F_71 ( V_67 ) ;
V_67 = F_74 ( - V_122 ) ;
}
return V_67 ;
...
int F_76 ( struct V_127 * V_128 , const char * V_120 ,
T_2 type , T_2 V_68 )
{
struct V_66 * V_67 ;
int V_22 ;
type = F_77 ( type ) ;
V_68 = F_78 ( V_68 ) ;
V_67 = F_72 ( V_120 , type , V_68 ) ;
if ( F_65 ( V_67 ) )
return F_64 ( V_67 ) ;
V_22 = F_79 ( & V_128 -> V_25 , V_67 , V_128 -> V_25 . V_110 , V_68 ) ;
F_71 ( V_67 ) ;
return V_22 ;
}
