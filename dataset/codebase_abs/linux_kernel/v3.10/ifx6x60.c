...
V_153 = (struct V_152 * ) V_151 -> V_19 . V_155 ;
if ( ! V_153 ) {
F_89 ( & V_151 -> V_19 , L_11 ) ;
return - V_154 ;
}
V_2 = F_90 ( sizeof( struct V_1 ) , V_130 ) ;
if ( ! V_2 ) {
F_89 ( & V_151 -> V_19 , L_12 ) ;
return - V_131 ;
}
V_9 = V_2 ;
V_2 -> V_18 = V_151 ;
...
V_2 -> V_158 = V_153 -> V_159 ;
V_2 -> V_117 = V_153 -> V_117 ;
V_2 -> V_160 = V_153 -> V_160 ;
V_151 -> V_113 = V_2 -> V_160 ;
V_151 -> V_161 = V_162 | ( V_163 & V_151 -> V_161 ) ;
V_151 -> V_114 = V_164 ;
V_127 = F_92 ( V_151 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_13 , V_127 ) ;
return - V_154 ;
}
if ( V_151 -> V_114 == 32 )
V_2 -> V_80 = F_18 ;
...
V_2 -> V_76 = 0 ;
V_2 -> V_77 = 0 ;
V_2 -> V_74 = F_93 ( V_2 -> V_18 -> V_19 . V_165 ,
V_81 ,
& V_2 -> V_120 ,
V_130 ) ;
if ( ! V_2 -> V_74 ) {
F_89 ( & V_151 -> V_19 , L_14 ) ;
V_127 = - V_131 ;
goto V_132;
}
V_2 -> V_101 = F_93 ( V_2 -> V_18 -> V_19 . V_165 ,
V_81 ,
& V_2 -> V_122 ,
V_130 ) ;
if ( ! V_2 -> V_101 ) {
F_89 ( & V_151 -> V_19 , L_15 ) ;
V_127 = - V_131 ;
goto V_132;
}
F_94 ( & V_2 -> V_146 ) ;
...
V_127 = F_72 ( V_2 ) ;
if ( V_127 != 0 ) {
F_89 ( & V_151 -> V_19 , L_16 ) ;
goto V_132;
}
V_2 -> V_12 . V_148 = V_153 -> V_167 ;
V_2 -> V_12 . V_147 = V_153 -> V_168 ;
V_2 -> V_12 . V_13 = V_153 -> V_13 ;
V_2 -> V_12 . V_26 = V_153 -> V_26 ;
V_2 -> V_12 . V_140 = V_153 -> V_169 ;
F_97 ( & V_151 -> V_19 , L_17 ,
V_2 -> V_12 . V_148 , V_2 -> V_12 . V_147 , V_2 -> V_12 . V_13 ,
V_2 -> V_12 . V_26 , V_2 -> V_12 . V_140 ) ;
V_127 = F_98 ( V_2 -> V_12 . V_148 , L_18 ) ;
if ( V_127 < 0 ) {
F_89 ( & V_151 -> V_19 , L_19 ,
V_2 -> V_12 . V_148 ) ;
goto V_132;
}
V_127 += F_99 ( V_2 -> V_12 . V_148 , 0 ) ;
V_127 += F_100 ( V_2 -> V_12 . V_148 , 1 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_20 ,
V_2 -> V_12 . V_148 ) ;
V_127 = - V_170 ;
goto V_171;
}
V_127 = F_98 ( V_2 -> V_12 . V_147 , L_18 ) ;
V_127 += F_99 ( V_2 -> V_12 . V_147 , 0 ) ;
V_127 += F_100 ( V_2 -> V_12 . V_147 , 1 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_21 ,
V_2 -> V_12 . V_147 ) ;
V_127 = - V_170 ;
goto V_172;
}
V_127 = F_98 ( V_2 -> V_12 . V_13 , L_18 ) ;
if ( V_127 < 0 ) {
F_89 ( & V_151 -> V_19 , L_22 ,
V_2 -> V_12 . V_13 ) ;
goto V_172;
}
V_127 += F_100 ( V_2 -> V_12 . V_13 , 1 ) ;
V_127 += F_99 ( V_2 -> V_12 . V_13 , 0 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_23 ,
V_2 -> V_12 . V_13 ) ;
V_127 = - V_170 ;
goto V_173;
}
V_127 = F_98 ( V_2 -> V_12 . V_26 , L_18 ) ;
if ( V_127 < 0 ) {
F_89 ( & V_151 -> V_19 , L_24 ,
V_2 -> V_12 . V_26 ) ;
V_127 = - V_170 ;
goto V_173;
}
V_127 += F_100 ( V_2 -> V_12 . V_26 , 1 ) ;
V_127 += F_101 ( V_2 -> V_12 . V_26 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_25 ,
V_2 -> V_12 . V_26 ) ;
V_127 = - V_170 ;
goto V_174;
}
V_127 = F_98 ( V_2 -> V_12 . V_140 , L_18 ) ;
if ( V_127 < 0 ) {
F_89 ( & V_151 -> V_19 , L_26 ,
V_2 -> V_12 . V_140 ) ;
goto V_174;
}
V_127 += F_100 ( V_2 -> V_12 . V_140 , 1 ) ;
V_127 += F_101 ( V_2 -> V_12 . V_140 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_27 ,
V_2 -> V_12 . V_140 ) ;
V_127 = - V_170 ;
goto V_175;
}
V_127 = F_102 ( F_103 ( V_2 -> V_12 . V_140 ) ,
F_82 ,
V_176 | V_177 , V_178 ,
( void * ) V_2 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_28 ,
F_103 ( V_2 -> V_12 . V_140 ) ) ;
goto V_175;
}
V_127 = F_86 ( V_2 ) ;
V_127 = F_102 ( F_103 ( V_2 -> V_12 . V_26 ) ,
F_81 ,
V_176 , V_178 ,
( void * ) V_2 ) ;
if ( V_127 ) {
F_89 ( & V_151 -> V_19 , L_29 ,
F_103 ( V_2 -> V_12 . V_26 ) ) ;
goto V_179;
}
F_104 ( & V_151 -> V_19 ) ;
...
return 0 ;
V_179:
F_106 ( F_103 ( V_2 -> V_12 . V_140 ) , ( void * ) V_2 ) ;
V_175:
F_107 ( V_2 -> V_12 . V_26 ) ;
V_174:
F_107 ( V_2 -> V_12 . V_13 ) ;
V_173:
F_107 ( V_2 -> V_12 . V_148 ) ;
V_172:
F_107 ( V_2 -> V_12 . V_147 ) ;
V_171:
F_107 ( V_2 -> V_12 . V_140 ) ;
V_132:
F_84 ( V_2 ) ;
V_9 = NULL ;
return V_127 ;
}
static int F_108 ( struct V_150 * V_151 )
{
struct V_1 * V_2 = F_109 ( V_151 ) ;
F_55 ( & V_2 -> V_91 ) ;
F_106 ( F_103 ( V_2 -> V_12 . V_140 ) , ( void * ) V_2 ) ;
F_106 ( F_103 ( V_2 -> V_12 . V_26 ) , ( void * ) V_2 ) ;
F_107 ( V_2 -> V_12 . V_26 ) ;
F_107 ( V_2 -> V_12 . V_13 ) ;
F_107 ( V_2 -> V_12 . V_148 ) ;
F_107 ( V_2 -> V_12 . V_147 ) ;
...
static void F_110 ( struct V_150 * V_151 )
{
struct V_1 * V_2 = F_109 ( V_151 ) ;
F_1 ( V_2 ) ;
}
static int F_111 ( struct V_180 * V_19 )
{
return 0 ;
}
static int F_112 ( struct V_180 * V_19 )
{
return 0 ;
}
static int F_113 ( struct V_180 * V_19 )
{
return 0 ;
}
static int F_114 ( struct V_180 * V_19 )
{
return 0 ;
}
static int F_115 ( struct V_180 * V_19 )
{
struct V_150 * V_151 = F_116 ( V_19 ) ;
struct V_1 * V_2 = F_109 ( V_151 ) ;
if ( ! V_2 -> V_17 )
F_117 ( V_19 ) ;
return 0 ;
