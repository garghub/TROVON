...
V_122 = F_15 ( V_2 , 0 ) ;
if ( V_122 > F_104 ( V_33 ) ) {
struct V_32 * V_123 = V_33 ;
V_33 = F_105 ( V_33 , V_122 ) ;
if ( ! V_33 ) {
F_8 ( V_123 ) ;
return;
}
...
F_37 ( & V_2 -> V_60 , V_59 ) ;
memcpy ( F_64 ( V_33 , V_8 ) , V_25 , V_8 ) ;
V_13 -> V_2 . V_39 ( V_13 , V_112 | V_80 , V_33 ) ;
F_5 ( V_20 , & V_13 -> V_2 . V_4 ) ;
...
static void
F_120 ( struct V_84 * V_85 , int V_91 , void * V_92 )
{
struct V_12 * V_13 = V_85 -> V_86 ;
V_13 -> V_93 . V_94 ( V_13 , V_95 | V_80 , V_92 ) ;
}
static void
F_121 ( struct V_84 * V_85 , int V_91 , void * V_92 )
{
struct V_12 * V_13 = V_85 -> V_86 ;
V_13 -> V_93 . V_94 ( V_13 , V_95 | V_80 , V_92 ) ;
F_52 ( V_85 ) ;
...
F_123 ( & V_13 -> V_2 . V_57 , V_129 , ( void * ) 'N' ) ;
F_8 ( V_33 ) ;
return;
}
if ( ! ( * V_56 & 1 ) ) {
if ( ! ( V_128 = F_28 ( V_13 , V_33 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_130 , V_33 ) ;
} else if ( F_23 ( V_56 , V_13 ) ) {
if ( ! ( V_128 = F_29 ( V_13 , V_33 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_131 , V_33 ) ;
} else if ( F_19 ( V_56 ) ) {
if ( ! ( V_128 = F_31 ( V_13 , V_33 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_132 , V_33 ) ;
} else if ( F_24 ( V_56 , V_13 ) ) {
if ( ! ( V_128 = F_30 ( V_13 , V_33 , V_88 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_133 , V_33 ) ;
} else if ( F_20 ( V_56 ) ) {
if ( ! ( V_128 = F_30 ( V_13 , V_33 , V_103 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_134 , V_33 ) ;
} else if ( F_22 ( V_56 ) ) {
if ( ! ( V_128 = F_30 ( V_13 , V_33 , V_88 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_135 , V_33 ) ;
} else if ( F_21 ( V_56 ) ) {
if ( ! ( V_128 = F_30 ( V_13 , V_33 , V_103 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_136 , V_33 ) ;
} else if ( F_26 ( V_56 ) ) {
if ( ! ( V_128 = F_32 ( V_13 , V_33 ) ) )
V_127 = F_123 ( & V_13 -> V_2 . V_57 , V_137 , V_33 ) ;
} else {
F_123 ( & V_13 -> V_2 . V_57 , V_129 , ( void * ) 'L' ) ;
F_8 ( V_33 ) ;
V_127 = 0 ;
}
if ( V_128 ) {
F_8 ( V_33 ) ;
F_123 ( & V_13 -> V_2 . V_57 , V_129 , ( void * ) ( long ) V_128 ) ;
V_127 = 0 ;
}
if ( V_127 )
F_8 ( V_33 ) ;
break;
case ( V_112 | V_79 ) :
F_123 ( & V_13 -> V_2 . V_57 , V_138 , V_92 ) ;
break;
case ( V_139 | V_80 ) :
...
if ( F_5 ( V_126 , & V_13 -> V_2 . V_4 ) )
F_123 ( & V_13 -> V_2 . V_57 , V_142 , V_92 ) ;
break;
case ( V_83 | V_80 ) :
case ( V_83 | V_79 ) :
F_5 ( V_141 , & V_13 -> V_2 . V_4 ) ;
F_123 ( & V_13 -> V_2 . V_57 , V_143 , V_92 ) ;
break;
default:
...
static void
F_124 ( struct V_12 * V_13 , int V_76 , void * V_92 )
{
switch ( V_76 ) {
case ( V_119 | V_41 ) :
if ( F_123 ( & V_13 -> V_2 . V_57 , V_144 , V_92 ) ) {
F_8 ( (struct V_32 * ) V_92 ) ;
}
break;
case ( V_101 | V_41 ) :
if ( F_123 ( & V_13 -> V_2 . V_57 , V_145 , V_92 ) ) {
F_8 ( (struct V_32 * ) V_92 ) ;
}
break;
case ( V_108 | V_41 ) :
...
F_123 ( & V_13 -> V_2 . V_57 , V_146 , V_92 ) ;
break;
case ( V_99 | V_41 ) :
F_123 ( & V_13 -> V_2 . V_57 , V_147 , V_92 ) ;
break;
case ( V_148 | V_41 ) :
F_123 ( & V_13 -> V_2 . V_57 , V_149 , V_92 ) ;
break;
case ( V_95 | V_150 ) :
F_123 ( & V_13 -> V_2 . V_57 , V_151 , V_92 ) ;
break;
}
}
void
...
struct V_12 * V_13 = V_85 -> V_86 ;
va_start ( args , V_152 ) ;
F_126 ( V_13 -> V_35 . V_153 , V_13 -> V_2 . V_154 , V_152 , args ) ;
va_end ( args ) ;
}
void
F_127 ( struct V_12 * V_13 , char * V_154 )
{
F_128 ( & V_13 -> V_2 . V_60 ) ;
V_13 -> V_35 . V_155 = F_122 ;
V_13 -> V_156 . V_157 = F_124 ;
F_129 ( & V_13 -> V_2 . V_5 ) ;
F_129 ( & V_13 -> V_2 . V_6 ) ;
F_6 ( & V_13 -> V_2 ) ;
V_13 -> V_2 . V_158 = 0 ;
...
F_130 ( & V_13 -> V_2 . V_57 , & V_13 -> V_2 . V_72 ) ;
F_130 ( & V_13 -> V_2 . V_57 , & V_13 -> V_2 . V_89 ) ;
}
static void
F_131 ( struct V_12 * V_13 , int V_76 , void * V_92 )
{
switch ( V_76 ) {
case ( V_119 | V_41 ) :
case ( V_101 | V_41 ) :
...
V_160 . V_167 = V_168 ;
V_160 . V_169 = V_170 ;
return F_135 ( & V_160 , V_171 , F_136 ( V_171 ) ) ;
}
void
F_137 ( void )
{
