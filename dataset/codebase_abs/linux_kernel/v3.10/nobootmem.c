...
static void F_20 ( T_4 * V_22 )
{
struct V_23 * V_24 ;
for ( V_24 = V_22 -> V_25 ; V_24 < V_22 -> V_25 + V_26 ; V_24 ++ )
if ( ! F_21 ( V_24 ) )
V_24 -> V_27 = 0 ;
}
...
void T_1 F_24 ( T_4 * V_22 , unsigned long V_29 ,
unsigned long V_2 )
{
F_7 ( F_8 ( V_29 ) , V_2 ) ;
F_25 ( V_29 , V_2 ) ;
...
{
void * V_33 = F_27 ( V_2 , V_3 , V_4 , V_5 ) ;
if ( V_33 )
return V_33 ;
F_33 ( V_34 L_1 , V_2 ) ;
F_34 ( L_2 ) ;
...
{
if ( F_28 ( F_29 () ) )
return F_38 ( V_2 , V_30 , V_22 -> V_36 ) ;
