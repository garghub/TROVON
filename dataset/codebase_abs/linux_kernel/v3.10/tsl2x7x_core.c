...
static int F_55 ( unsigned char * V_51 , int V_176 )
{
switch ( V_176 ) {
case V_52 :
case V_53 :
case V_55 :
return ( ( * V_51 & 0xf0 ) == V_177 ) ;
break;
case V_54 :
case V_56 :
return ( ( * V_51 & 0xf0 ) == V_178 ) ;
break;
case V_57 :
case V_58 :
case V_59 :
case V_60 :
case V_61 :
return ( ( * V_51 & 0xf0 ) == V_179 ) ;
break;
}
return - V_107 ;
}
static T_7 F_56 ( int V_180 , void * V_181 )
{
struct V_9 * V_10 = V_181 ;
struct V_19 * V_20 = F_6 ( V_10 ) ;
T_8 V_182 = F_57 () ;
int V_5 ;
T_1 V_146 ;
...
static int F_61 ( struct V_1 * V_188 ,
const struct V_189 * V_51 )
{
int V_5 ;
unsigned char V_190 ;
struct V_9 * V_10 ;
struct V_19 * V_20 ;
V_10 = F_62 ( sizeof( * V_20 ) ) ;
if ( ! V_10 )
return - V_191 ;
V_20 = F_6 ( V_10 ) ;
V_20 -> V_2 = V_188 ;
...
if ( V_5 < 0 )
goto V_193;
if ( ( ! F_55 ( & V_190 , V_51 -> V_194 ) ) ||
( F_55 ( & V_190 , V_51 -> V_194 ) == - V_107 ) ) {
F_15 ( & V_20 -> V_2 -> V_7 ,
L_42 ,
V_8 ) ;
V_5 = - V_107 ;
...
F_64 ( & V_20 -> V_49 ) ;
V_20 -> V_26 = V_195 ;
V_20 -> V_65 = V_188 -> V_7 . V_196 ;
V_20 -> V_51 = V_51 -> V_194 ;
V_20 -> V_197 =
& V_198 [ V_199 [ V_51 -> V_194 ] ] ;
V_10 -> V_200 = V_20 -> V_197 -> V_200 ;
V_10 -> V_7 . V_201 = & V_188 -> V_7 ;
V_10 -> V_202 = V_203 ;
V_10 -> V_80 = V_20 -> V_2 -> V_80 ;
V_10 -> V_204 = V_20 -> V_197 -> V_171 ;
V_10 -> V_205 = V_20 -> V_197 -> V_206 ;
if ( V_188 -> V_180 ) {
V_5 = F_65 ( V_188 -> V_180 ,
NULL ,
& F_56 ,
V_207 | V_208 ,
L_44 ,
...
F_15 ( & V_188 -> V_7 , L_47 , V_51 -> V_80 ) ;
return 0 ;
V_209:
if ( V_188 -> V_180 )
F_67 ( V_188 -> V_180 , V_10 ) ;
V_193:
F_68 ( V_10 ) ;
return V_5 ;
}
static int F_69 ( struct V_141 * V_7 )
{
struct V_9 * V_10 = F_70 ( V_7 ) ;
struct V_19 * V_20 = F_6 ( V_10 ) ;
int V_5 = 0 ;
if ( V_20 -> V_26 == V_27 ) {
V_5 = F_19 ( V_10 ) ;
...
if ( V_20 -> V_65 && V_20 -> V_65 -> V_210 ) {
T_9 V_211 = { V_212 } ;
V_20 -> V_65 -> V_210 ( V_7 , V_211 ) ;
}
return V_5 ;
}
static int F_71 ( struct V_141 * V_7 )
{
struct V_9 * V_10 = F_70 ( V_7 ) ;
struct V_19 * V_20 = F_6 ( V_10 ) ;
int V_5 = 0 ;
