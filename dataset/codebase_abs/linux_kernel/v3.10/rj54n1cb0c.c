...
{
struct V_8 * V_9 = F_15 ( V_21 ) ;
if ( V_159 -> V_160 . type != V_161 )
return - V_24 ;
if ( V_159 -> V_160 . V_162 != V_9 -> V_162 )
return - V_163 ;
V_159 -> V_164 = V_165 ;
V_159 -> V_166 = 0 ;
return 0 ;
...
{
struct V_8 * V_9 = F_15 ( V_21 ) ;
if ( V_11 -> V_160 . type != V_161 ||
V_11 -> V_11 < 0x400 || V_11 -> V_11 > 0x1fff )
return - V_24 ;
if ( V_11 -> V_160 . V_162 != V_9 -> V_162 )
return - V_163 ;
V_11 -> V_168 = 1 ;
...
static int F_36 ( struct V_20 * V_21 , int V_169 )
{
struct V_8 * V_9 = F_15 ( V_21 ) ;
struct V_170 * V_171 = F_37 ( V_9 ) ;
return F_38 ( & V_9 -> V_14 , V_171 , V_169 ) ;
}
static int F_39 ( struct V_172 * V_173 )
{
struct V_7 * V_7 = F_3 ( V_173 -> V_174 , struct V_7 , V_175 ) ;
...
return 0 ;
case V_178 :
if ( F_9 ( V_9 , V_132 , V_173 -> V_19 * 2 ) < 0 )
return - V_127 ;
return 0 ;
case V_179 :
if ( F_10 ( V_9 , V_136 , V_173 -> V_19 << 7 ,
0x80 ) < 0 )
return - V_127 ;
V_7 -> V_88 = V_173 -> V_19 ;
return 0 ;
...
if ( F_41 ( V_171 , V_181 ) &
V_183 )
return F_9 ( V_9 , V_190 , 1 << 4 ) ;
else
return F_9 ( V_9 , V_190 , 0 ) ;
}
...
V_12 = F_9 ( V_9 , V_198 , V_192 -> V_199 << 7 ) ;
if ( V_12 < 0 )
goto V_197;
F_44 ( & V_9 -> V_14 , L_9 ,
V_193 , V_194 ) ;
...
struct V_7 * V_7 ;
struct V_170 * V_171 = F_37 ( V_9 ) ;
struct V_202 * V_203 = F_47 ( V_9 -> V_14 . V_204 ) ;
struct V_191 * V_205 ;
int V_12 ;
if ( ! V_171 || ! V_171 -> V_206 ) {
F_28 ( & V_9 -> V_14 , L_10 ) ;
return - V_24 ;
}
V_205 = V_171 -> V_206 ;
...
V_7 = F_50 ( & V_9 -> V_14 , sizeof( struct V_7 ) , V_208 ) ;
if ( ! V_7 )
return - V_209 ;
F_51 ( & V_7 -> V_10 , V_9 , & V_210 ) ;
F_52 ( & V_7 -> V_175 , 4 ) ;
F_53 ( & V_7 -> V_175 , & V_211 ,
V_176 , 0 , 1 , 1 , 0 ) ;
F_53 ( & V_7 -> V_175 , & V_211 ,
V_177 , 0 , 1 , 1 , 0 ) ;
F_53 ( & V_7 -> V_175 , & V_211 ,
...
F_53 ( & V_7 -> V_175 , & V_211 ,
V_179 , 0 , 1 , 1 , 1 ) ;
V_7 -> V_10 . V_212 = & V_7 -> V_175 ;
if ( V_7 -> V_175 . error )
return V_7 -> V_175 . error ;
V_7 -> V_110 = V_110 ;
V_7 -> V_36 . V_51 = V_43 ;
V_7 -> V_36 . V_52 = V_45 ;
V_7 -> V_36 . V_30 = V_44 ;
...
V_7 -> V_4 = & V_23 [ 0 ] ;
V_7 -> V_47 = 1024 ;
V_7 -> V_94 = ( V_205 -> V_213 / V_106 * V_108 ) /
