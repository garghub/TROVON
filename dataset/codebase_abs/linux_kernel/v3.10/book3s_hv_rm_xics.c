...
{
union V_27 V_47 , V_48 ;
struct V_41 * V_42 = V_4 -> V_54 -> V_8 . V_42 ;
...
do {
V_47 = V_48 = F_12 ( V_9 -> V_36 ) ;
V_55 = V_47 . V_33 | ( ( ( T_2 ) V_47 . V_35 ) << 24 ) ;
if ( ! V_47 . V_33 )
break;
V_48 . V_35 = V_48 . V_34 ;
V_48 . V_34 = 0xff ;
...
int F_14 ( struct V_3 * V_4 , unsigned long V_58 ,
unsigned long V_50 )
{
union V_27 V_47 , V_48 ;
struct V_41 * V_42 = V_4 -> V_54 -> V_8 . V_42 ;
...
if ( V_50 > V_47 . V_50 && V_50 > V_48 . V_35 ) {
V_49 = V_48 . V_52 ;
V_48 . V_52 = 0 ;
}
} while ( ! F_8 ( V_9 , V_47 , V_48 ) );
...
int F_17 ( struct V_3 * V_4 , unsigned long V_55 )
{
struct V_41 * V_42 = V_4 -> V_54 -> V_8 . V_42 ;
struct V_6 * V_9 = V_4 -> V_8 . V_9 ;
struct V_65 * V_66 ;
struct V_67 * V_36 ;
T_2 V_68 = V_55 & 0x00ffffff ;
T_3 V_69 ;
if ( ! V_42 || ! V_42 -> V_56 )
return V_44 ;
F_11 ( V_42 , V_9 , V_55 >> 24 ) ;
if ( V_68 == V_51 )
goto V_38;
V_66 = F_18 ( V_42 , V_68 , & V_69 ) ;
if ( ! V_66 )
goto V_38;
V_36 = & V_66 -> V_70 [ V_69 ] ;
if ( V_36 -> V_71 ) {
