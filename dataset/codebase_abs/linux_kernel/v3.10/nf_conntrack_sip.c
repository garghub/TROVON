...
static void F_45 ( struct V_1 * V_2 , bool V_77 )
{
struct V_57 * V_58 = F_38 ( V_2 ) ;
struct V_59 * exp ;
struct V_60 * V_61 ;
...
static int F_48 ( struct V_78 * V_79 , unsigned int V_80 ,
unsigned int V_32 ,
const char * * V_3 , unsigned int * V_24 ,
...
enum V_87 V_88 ;
struct V_1 * V_2 = F_49 ( V_79 , & V_88 ) ;
struct V_89 * V_89 = F_50 ( V_2 ) ;
enum V_90 V_91 = F_51 ( V_88 ) ;
union V_11 * V_92 ;
struct V_93 V_66 ;
int V_94 = 0 , V_95 = 0 , V_15 = V_96 ;
T_2 V_97 ;
T_1 V_98 , V_99 ;
F_52 (nf_nat_sdp_port_hook) V_100 ;
F_52 (nf_nat_sdp_media_hook) V_101 ;
V_92 = NULL ;
if ( V_102 ) {
if ( ! F_41 ( V_81 , & V_2 -> V_103 [ V_91 ] . V_66 . V_104 . V_68 ) )
return V_105 ;
...
F_53 () ;
do {
exp = F_54 ( V_89 , F_55 ( V_2 ) , & V_66 ) ;
if ( ! exp || exp -> V_107 == V_2 ||
F_38 ( exp -> V_107 ) -> V_108 != F_38 ( V_2 ) -> V_108 ||
exp -> V_64 != V_64 )
break;
#ifdef F_56
if ( ! V_94 &&
( ! F_41 ( & exp -> V_109 , & exp -> V_66 . V_67 . V_68 ) ||
...
F_57 () ;
V_97 = F_58 ( V_66 . V_67 . V_70 . V_71 . V_27 ) & ~ 1 ;
V_98 = F_18 ( V_97 ) ;
V_99 = F_18 ( V_97 + 1 ) ;
if ( V_94 ) {
V_100 = F_59 ( V_113 ) ;
if ( V_100 &&
! V_100 ( V_79 , V_80 , V_32 , V_3 , V_24 ,
V_83 , V_84 , F_58 ( V_98 ) ) )
goto V_114;
}
if ( V_95 )
...
if ( V_85 == NULL )
goto V_114;
F_61 ( V_85 , V_64 , F_8 ( V_2 ) , V_92 , V_81 ,
V_47 , NULL , & V_98 ) ;
V_86 = F_60 ( V_2 ) ;
if ( V_86 == NULL )
goto V_115;
F_61 ( V_86 , V_64 , F_8 ( V_2 ) , V_92 , V_81 ,
V_47 , NULL , & V_99 ) ;
V_101 = F_59 ( V_116 ) ;
if ( V_101 && V_2 -> V_111 & V_112 && ! V_94 )
V_15 = V_101 ( V_79 , V_80 , V_32 , V_3 , V_24 ,
V_85 , V_86 ,
V_83 , V_84 , V_81 ) ;
else {
if ( F_62 ( V_85 ) == 0 ) {
...
unsigned int V_119 ;
for ( V_119 = 0 ; V_119 < F_64 ( V_120 ) ; V_119 ++ ) {
V_118 = & V_120 [ V_119 ] ;
if ( V_26 < V_118 -> V_6 ||
...
const struct V_117 * V_118 ;
int V_15 = V_105 ;
F_52 (nf_nat_sdp_addr_hook) V_128 ;
F_52 (nf_nat_sdp_session_hook) V_129 ;
V_128 = F_59 ( V_130 ) ;
...
V_122 = V_25 ;
V_123 = 0 ;
if ( F_36 ( V_2 , * V_3 , V_122 , * V_24 ,
V_132 , V_133 ,
& V_25 , & V_26 , & V_125 ) > 0 )
V_123 = V_26 ;
V_83 = V_122 ;
for ( V_119 = 0 ; V_119 < F_64 ( V_120 ) ; ) {
...
V_83 += V_118 -> V_6 ;
V_84 -= V_118 -> V_6 ;
V_27 = F_17 ( * V_3 + V_83 , NULL , 10 ) ;
if ( V_27 == 0 )
continue;
if ( V_27 < 1024 || V_27 > 65535 ) {
F_66 ( V_79 , V_2 , L_8 , V_27 ) ;
return V_96 ;
}
V_124 = 0 ;
if ( F_36 ( V_2 , * V_3 , V_83 , * V_24 ,
V_132 , V_133 ,
& V_25 , & V_26 , & V_126 ) > 0 ) {
V_124 = V_26 ;
...
V_15 = F_48 ( V_79 , V_80 , V_32 ,
V_3 , V_24 ,
& V_127 , F_18 ( V_27 ) , V_118 -> V_64 ,
V_83 , V_84 ) ;
if ( V_15 != V_105 ) {
F_66 ( V_79 , V_2 ,
L_10 ) ;
...
if ( V_124 && V_128 && V_2 -> V_111 & V_112 ) {
V_15 = V_128 ( V_79 , V_80 , V_32 ,
V_3 , V_24 , V_83 ,
V_132 , V_133 ,
& V_127 ) ;
if ( V_15 != V_105 ) {
...
V_129 = F_59 ( V_134 ) ;
if ( V_129 && V_2 -> V_111 & V_112 )
V_15 = V_129 ( V_79 , V_80 , V_32 ,
V_3 , V_24 , V_122 , & V_127 ) ;
return V_15 ;
}
static int F_67 ( struct V_78 * V_79 , unsigned int V_80 ,
unsigned int V_32 ,
const char * * V_3 , unsigned int * V_24 ,
unsigned int V_121 , unsigned int V_135 )
{
enum V_87 V_88 ;
struct V_1 * V_2 = F_49 ( V_79 , & V_88 ) ;
struct V_136 * V_137 = F_68 ( V_2 ) ;
if ( ( V_135 >= 100 && V_135 <= 199 ) ||
( V_135 >= 200 && V_135 <= 299 ) )
return F_65 ( V_79 , V_80 , V_32 , V_3 , V_24 , V_121 ) ;
else if ( V_137 -> V_138 == V_121 )
F_45 ( V_2 , true ) ;
return V_105 ;
}
...
unsigned int V_15 ;
F_45 ( V_2 , true ) ;
V_15 = F_65 ( V_79 , V_80 , V_32 , V_3 , V_24 , V_121 ) ;
if ( V_15 == V_105 )
V_137 -> V_138 = V_121 ;
return V_15 ;
}
...
unsigned int V_56 = 0 ;
int V_15 ;
F_52 (nf_nat_sip_expect_hook) V_139 ;
if ( V_2 -> V_111 & V_140 )
return V_105 ;
if ( F_22 ( V_2 , * V_3 , 0 , * V_24 , V_141 ,
& V_25 , & V_26 ) > 0 )
...
return V_105 ;
if ( ! F_41 ( & V_2 -> V_103 [ V_91 ] . V_66 . V_104 . V_68 , & V_81 ) )
return V_105 ;
...
if ( V_144 )
V_92 = & V_2 -> V_103 [ ! V_91 ] . V_66 . V_104 . V_68 ;
F_61 ( exp , V_65 , F_8 ( V_2 ) ,
V_92 , & V_81 , V_45 , NULL , & V_27 ) ;
exp -> V_72 . V_56 = V_145 * V_76 ;
exp -> V_108 = F_38 ( V_2 ) -> V_108 ;
exp -> V_73 = V_146 | V_74 ;
V_139 = F_59 ( V_147 ) ;
if ( V_139 && V_2 -> V_111 & V_112 )
V_15 = V_139 ( V_79 , V_80 , V_32 , V_3 , V_24 ,
exp , V_25 , V_26 ) ;
else {
if ( F_62 ( exp ) != 0 ) {
F_66 ( V_79 , V_2 , L_16 ) ;
...
T_1 V_27 ;
V_17 V_45 ;
unsigned int V_25 , V_26 , V_149 = 0 ;
unsigned int V_56 = 0 ;
int V_150 = 0 , V_15 ;
if ( V_137 -> V_148 != V_121 )
return V_105 ;
if ( V_135 >= 100 && V_135 <= 199 )
return V_105 ;
if ( V_135 < 200 || V_135 > 299 )
goto V_151;
if ( F_22 ( V_2 , * V_3 , 0 , * V_24 , V_141 ,
& V_25 , & V_26 ) > 0 )
V_56 = F_17 ( * V_3 + V_25 , NULL , 10 ) ;
while ( 1 ) {
unsigned int V_152 = V_56 ;
V_15 = F_25 ( V_2 , * V_3 , & V_149 , * V_24 ,
V_142 , & V_150 ,
& V_25 , & V_26 ,
& V_12 , & V_27 ) ;
if ( V_15 < 0 ) {
...
break;
if ( ! F_41 ( & V_2 -> V_103 [ V_91 ] . V_66 . V_67 . V_68 , & V_12 ) )
continue;
...
static int F_75 ( struct V_78 * V_79 , unsigned int V_80 ,
unsigned int V_32 ,
const char * * V_3 , unsigned int * V_24 )
{
enum V_87 V_88 ;
struct V_1 * V_2 = F_49 ( V_79 , & V_88 ) ;
unsigned int V_25 , V_26 , V_153 ;
unsigned int V_135 , V_121 , V_119 ;
if ( * V_24 < strlen ( L_17 ) )
return V_105 ;
V_135 = F_17 ( * V_3 + strlen ( L_18 ) , NULL , 10 ) ;
if ( ! V_135 ) {
F_66 ( V_79 , V_2 , L_19 ) ;
return V_96 ;
}
if ( F_22 ( V_2 , * V_3 , 0 , * V_24 , V_154 ,
& V_25 , & V_26 ) <= 0 ) {
F_66 ( V_79 , V_2 , L_20 ) ;
return V_96 ;
}
V_121 = F_17 ( * V_3 + V_25 , NULL , 10 ) ;
if ( ! V_121 ) {
F_66 ( V_79 , V_2 , L_21 ) ;
return V_96 ;
}
V_153 = V_25 + V_26 + 1 ;
for ( V_119 = 0 ; V_119 < F_64 ( V_155 ) ; V_119 ++ ) {
const struct V_156 * V_157 ;
V_157 = & V_155 [ V_119 ] ;
if ( V_157 -> V_158 == NULL )
continue;
if ( * V_24 < V_153 + V_157 -> V_6 ||
F_16 ( * V_3 + V_153 , V_157 -> V_159 , V_157 -> V_6 ) )
continue;
return V_157 -> V_158 ( V_79 , V_80 , V_32 , V_3 , V_24 ,
V_121 , V_135 ) ;
}
return V_105 ;
}
...
union V_11 V_12 ;
T_1 V_27 ;
if ( F_25 ( V_2 , * V_3 , NULL , * V_24 ,
V_160 , NULL , & V_25 ,
& V_26 , & V_12 , & V_27 ) > 0 &&
V_27 != V_2 -> V_103 [ V_91 ] . V_66 . V_104 . V_70 . V_71 . V_27 &&
F_41 ( & V_12 , & V_2 -> V_103 [ V_91 ] . V_66 . V_104 . V_68 ) )
V_137 -> V_161 = V_27 ;
for ( V_119 = 0 ; V_119 < F_64 ( V_155 ) ; V_119 ++ ) {
const struct V_156 * V_157 ;
V_157 = & V_155 [ V_119 ] ;
...
continue;
if ( * V_24 < V_157 -> V_6 ||
F_16 ( * V_3 , V_157 -> V_159 , V_157 -> V_6 ) )
continue;
if ( F_22 ( V_2 , * V_3 , 0 , * V_24 , V_154 ,
& V_25 , & V_26 ) <= 0 ) {
F_66 ( V_79 , V_2 , L_20 ) ;
...
return V_157 -> V_162 ( V_79 , V_80 , V_32 , V_3 , V_24 ,
V_121 ) ;
}
return V_105 ;
}
static int F_77 ( struct V_78 * V_79 , struct V_1 * V_2 ,
unsigned int V_80 , unsigned int V_32 ,
const char * * V_3 , unsigned int * V_24 )
{
F_52 (nf_nat_sip_hook) V_163 ;
int V_15 ;
if ( F_16 ( * V_3 , L_18 , strlen ( L_18 ) ) != 0 )
V_15 = F_76 ( V_79 , V_80 , V_32 , V_3 , V_24 ) ;
else
V_15 = F_75 ( V_79 , V_80 , V_32 , V_3 , V_24 ) ;
if ( V_15 == V_105 && V_2 -> V_111 & V_112 ) {
V_163 = F_59 ( V_164 ) ;
if ( V_163 && ! V_163 ( V_79 , V_80 , V_32 ,
V_3 , V_24 ) ) {
F_66 ( V_79 , V_2 , L_22 ) ;
V_15 = V_96 ;
}
...
static int F_78 ( struct V_78 * V_79 , unsigned int V_80 ,
...
int V_15 = V_105 ;
bool V_49 ;
F_52 (nf_nat_sip_seq_adjust_hook) V_172 ;
if ( V_88 != V_173 &&
V_88 != V_174 )
return V_105 ;
V_166 = F_79 ( V_79 , V_80 , sizeof( V_167 ) , & V_167 ) ;
if ( V_166 == NULL )
return V_105 ;
V_32 = V_80 + V_166 -> V_175 * 4 ;
if ( V_32 >= V_79 -> V_6 )
return V_105 ;
F_80 ( V_2 , V_79 , V_145 * V_76 ) ;
if ( F_81 ( F_82 ( V_79 ) ) )
return V_96 ;
V_3 = V_79 -> V_176 + V_32 ;
V_24 = V_79 -> V_6 - V_32 ;
...
V_168 = V_169 = V_14 - V_3 ;
if ( V_168 > V_24 )
return V_105 ;
V_15 = F_77 ( V_79 , V_2 , V_80 , V_32 ,
& V_3 , & V_168 ) ;
if ( V_15 != V_105 )
break;
V_170 = V_168 - V_169 ;
...
V_32 += V_168 ;
V_3 += V_168 ;
V_24 = V_24 + V_170 - V_168 ;
}
if ( V_15 == V_105 && V_2 -> V_111 & V_112 ) {
V_172 = F_59 ( V_178 ) ;
if ( V_172 )
V_172 ( V_79 , V_80 , V_171 ) ;
}
return V_15 ;
}
static int F_83 ( struct V_78 * V_79 , unsigned int V_80 ,
struct V_1 * V_2 , enum V_87 V_88 )
{
unsigned int V_32 , V_24 ;
const char * V_3 ;
V_32 = V_80 + sizeof( struct V_179 ) ;
if ( V_32 >= V_79 -> V_6 )
return V_105 ;
F_80 ( V_2 , V_79 , V_145 * V_76 ) ;
if ( F_81 ( F_82 ( V_79 ) ) )
...
if ( V_24 < strlen ( L_17 ) )
return V_105 ;
return F_77 ( V_79 , V_2 , V_80 , V_32 , & V_3 , & V_24 ) ;
}
static void F_84 ( void )
{
int V_119 , V_180 ;
for ( V_119 = 0 ; V_119 < V_181 ; V_119 ++ ) {
for ( V_180 = 0 ; V_180 < F_64 ( V_182 [ V_119 ] ) ; V_180 ++ ) {
if ( V_182 [ V_119 ] [ V_180 ] . V_183 == NULL )
continue;
F_85 ( & V_182 [ V_119 ] [ V_180 ] ) ;
}
}
}
static int T_4 F_86 ( void )
{
int V_119 , V_180 , V_15 ;
if ( V_181 == 0 )
V_184 [ V_181 ++ ] = V_30 ;
for ( V_119 = 0 ; V_119 < V_181 ; V_119 ++ ) {
memset ( & V_182 [ V_119 ] , 0 , sizeof( V_182 [ V_119 ] ) ) ;
V_182 [ V_119 ] [ 0 ] . V_66 . V_104 . V_106 = V_16 ;
V_182 [ V_119 ] [ 0 ] . V_66 . V_67 . V_69 = V_47 ;
V_182 [ V_119 ] [ 0 ] . V_58 = F_83 ;
V_182 [ V_119 ] [ 1 ] . V_66 . V_104 . V_106 = V_16 ;
V_182 [ V_119 ] [ 1 ] . V_66 . V_67 . V_69 = V_46 ;
V_182 [ V_119 ] [ 1 ] . V_58 = F_78 ;
V_182 [ V_119 ] [ 2 ] . V_66 . V_104 . V_106 = V_19 ;
V_182 [ V_119 ] [ 2 ] . V_66 . V_67 . V_69 = V_47 ;
V_182 [ V_119 ] [ 2 ] . V_58 = F_83 ;
V_182 [ V_119 ] [ 3 ] . V_66 . V_104 . V_106 = V_19 ;
V_182 [ V_119 ] [ 3 ] . V_66 . V_67 . V_69 = V_46 ;
V_182 [ V_119 ] [ 3 ] . V_58 = F_78 ;
for ( V_180 = 0 ; V_180 < F_64 ( V_182 [ V_119 ] ) ; V_180 ++ ) {
V_182 [ V_119 ] [ V_180 ] . V_185 = sizeof( struct V_136 ) ;
V_182 [ V_119 ] [ V_180 ] . V_66 . V_104 . V_70 . V_71 . V_27 = F_18 ( V_184 [ V_119 ] ) ;
V_182 [ V_119 ] [ V_180 ] . V_186 = V_187 ;
V_182 [ V_119 ] [ V_180 ] . V_188 = V_189 ;
V_182 [ V_119 ] [ V_180 ] . V_183 = V_190 ;
if ( V_184 [ V_119 ] == V_30 )
sprintf ( V_182 [ V_119 ] [ V_180 ] . V_37 , L_24 ) ;
else
sprintf ( V_182 [ V_119 ] [ V_180 ] . V_37 , L_25 , V_119 ) ;
F_13 ( L_26 , V_119 , V_184 [ V_119 ] ) ;
V_15 = F_87 ( & V_182 [ V_119 ] [ V_180 ] ) ;
if ( V_15 ) {
F_88 ( V_191 L_27
L_28 ,
V_182 [ V_119 ] [ V_180 ] . V_66 . V_104 . V_106 , V_184 [ V_119 ] ) ;
F_84 () ;
return V_15 ;
}
}
