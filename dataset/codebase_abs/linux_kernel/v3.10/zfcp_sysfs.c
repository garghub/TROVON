...
T_3 V_36 ;
int V_25 ;
if ( F_28 ( V_5 , 0 , ( unsigned long long * ) & V_36 ) )
return - V_12 ;
V_25 = F_40 ( V_7 , V_36 ) ;
if ( V_25 )
return V_25 ;
...
char * V_5 )
{
struct V_37 * V_38 = F_47 ( V_2 ) ;
struct V_39 * V_40 ;
struct V_22 * V_14 ;
int V_25 ;
V_14 = (struct V_22 * ) V_38 -> V_41 [ 0 ] ;
if ( ! ( V_14 -> V_42 & V_43 ) )
return - V_44 ;
V_40 = F_48 ( sizeof( struct V_39 ) , V_45 ) ;
if ( ! V_40 )
return - V_46 ;
V_25 = F_49 ( V_14 -> V_47 , V_40 ) ;
if ( ! V_25 )
V_25 = sprintf ( V_5 , L_9 , V_40 -> V_48 ,
V_40 -> V_49 , V_40 -> V_50 ) ;
F_50 ( V_40 ) ;
return V_25 ;
}
...
if ( ! ( V_14 -> V_42 & V_43 ) )
return - V_44 ;
V_54 = F_48 ( sizeof( struct V_53 ) ,
V_45 ) ;
if ( ! V_54 )
return - V_46 ;
V_25 = F_52 ( V_14 -> V_47 , V_54 ) ;
if ( ! V_25 )
* V_52 = V_54 -> V_55 ;
F_50 ( V_54 ) ;
return V_25 ;
...
char * V_5 )
{
struct V_37 * V_38 = F_54 ( V_2 ) ;
struct V_56 * V_47 =
( (struct V_22 * ) V_38 -> V_41 [ 0 ] ) -> V_47 ;
T_3 V_57 ;
F_55 ( & V_47 -> V_58 ) ;
V_57 = V_47 -> V_59 ;
F_56 ( & V_47 -> V_58 ) ;
return sprintf ( V_5 , L_10 , F_3 ( & V_47 -> V_60 ) ,
