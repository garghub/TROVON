...
return V_23 ;
V_1 = ( T_1 * ) V_17 ;
for ( V_14 = sizeof( struct V_16 ) ; V_14 < F_5 ( V_5 ) ; V_14 += V_13 ) {
V_13 = F_1 ( V_1 , V_14 ) ;
if ( V_14 + V_13 > F_5 ( V_5 ) )
break;
if ( ! F_6 ( V_11 -> V_25 , V_1 [ V_14 ] ) )
continue;
...
static unsigned int
F_9 ( struct V_4 * V_5 , const struct V_6 * V_7 )
{
return F_2 ( V_5 , V_7 , F_10 ( V_5 ) ,
sizeof( struct V_27 ) + sizeof( struct V_16 ) ) ;
}
static unsigned int
F_11 ( struct V_4 * V_5 , const struct V_6 * V_7 )
{
...
T_3 V_31 ;
V_30 = V_29 -> V_30 ;
V_8 = F_13 ( V_5 , sizeof( * V_29 ) , & V_30 , & V_31 ) ;
if ( V_8 < 0 )
return V_23 ;
return F_2 ( V_5 , V_7 , V_8 ,
sizeof( * V_29 ) + sizeof( struct V_16 ) ) ;
}
