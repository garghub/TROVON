...
F_10 ( V_4 , ! F_11 ( V_4 ) ) ;
if ( ! F_11 ( V_4 ) ) {
unsigned int V_25 = V_26 * 43 / 64 ;
unsigned int V_27 = V_26 ;
unsigned char V_28 ;
T_1 * V_29 ;
F_12 ( L_4 ) ;
F_4 ( NULL , V_4 , & V_4 -> V_14 , 0 , V_24 ) ;
F_12 ( L_5 ) ;
V_29 = ( T_1 * ) V_4 -> V_29 - V_25 ;
if ( V_29 < ( T_1 * ) V_30 || F_13 ( V_29 , V_28 ) ) {
V_29 = ( T_1 * ) V_4 -> V_29 ;
V_27 = V_27 - V_25 + 1 ;
}
for ( V_21 = 0 ; V_21 < V_27 ; V_21 ++ , V_29 ++ ) {
if ( V_29 < ( T_1 * ) V_30 ||
F_13 ( V_29 , V_28 ) ) {
F_6 ( L_6 ) ;
break;
}
if ( V_29 == ( T_1 * ) V_4 -> V_29 )
F_6 ( L_7 , V_28 ) ;
else
F_6 ( L_8 , V_28 ) ;
}
...
int F_14 ( unsigned long V_29 )
{
unsigned short V_31 ;
if ( V_29 < V_30 )
return 0 ;
if ( F_13 ( ( unsigned short * ) V_29 , V_31 ) )
return 0 ;
return V_31 == 0x0b0f ;
}
