...
static T_2 F_60 ( struct V_54 * V_54 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
...
if ( F_42 ( V_2 , V_60 ) < 0 )
return V_42 ;
if ( ! F_62 ( V_101 [ V_61 ] . V_102 ) ||
! F_62 ( V_101 [ V_61 ] . V_103 ) )
return V_42 ;
}
return 0 ;
}
static T_2 F_63 ( struct V_54 * V_54 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
...
V_14 = F_61 ( V_2 , V_101 , V_66 ) ;
if ( V_14 )
return V_14 ;
for ( V_61 = 0 ; V_61 < V_66 ; V_61 ++ ) {
V_60 = V_101 [ V_61 ] . V_60 ;
memset ( & V_105 , 0 , sizeof( struct V_104 ) ) ;
V_14 = F_64 ( V_2 , & V_105 , V_60 ) ;
if ( V_14 )
return V_14 ;
V_105 . V_60 = V_60 ;
...
static T_2 F_67 ( struct V_54 * V_54 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
...
return V_42 ;
memset ( & V_116 , 0 , V_49 ) ;
V_14 = F_68 ( V_2 , V_48 , V_118 ,
& V_116 . V_119 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_68 ( V_2 , V_48 , V_120 ,
& V_116 . V_121 ) ;
if ( V_14 )
return V_14 ;
...
static T_2 F_69 ( struct V_54 * V_54 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
...
return V_42 ;
memset ( & V_122 , 0 , V_49 ) ;
V_14 = F_70 ( V_2 , V_48 , V_118 ,
& V_122 . V_119 ) ;
if ( V_14 )
return V_14 ;
V_14 = F_70 ( V_2 , V_48 , V_120 ,
& V_122 . V_121 ) ;
if ( V_14 )
return V_14 ;
...
static T_2 F_71 ( struct V_54 * V_54 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
...
static T_2 F_74 ( struct V_54 * V_54 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
...
return V_42 ;
V_129 = F_75 ( V_80 , sizeof( * V_129 ) , V_130 ) ;
if ( ! V_129 )
return - V_131 ;
V_14 = F_76 ( V_2 , V_129 ) ;
if ( V_14 ) {
...
static T_2 F_78 ( struct V_54 * V_55 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
...
if ( ! V_11 )
return V_42 ;
V_66 = V_49 / sizeof( T_1 ) ;
if ( V_49 % sizeof( T_1 ) )
V_66 ++ ;
V_139 = F_75 ( V_49 , sizeof( unsigned char ) , V_130 ) ;
if ( ! V_139 )
return - V_131 ;
if ( F_79 ( V_2 ) != 0 ) {
F_77 ( V_139 ) ;
...
V_140 = F_75 ( V_49 , sizeof( unsigned char ) , V_130 ) ;
if ( ! V_140 )
return - V_131 ;
memcpy ( V_140 , V_11 , V_49 ) ;
V_141 = V_140 ;
V_66 = V_49 / sizeof( T_1 ) ;
if ( F_79 ( V_2 ) != 0 ) {
F_77 ( V_140 ) ;
...
if ( V_2 -> V_16 -> V_142 . V_143 == V_2 -> V_144 ) {
V_14 = F_83 ( V_2 ) ;
if ( V_14 ) {
F_77 ( V_140 ) ;
F_81 ( V_2 ) ;
...
for ( V_61 = 0 ; V_61 < V_66 / V_145 ; V_61 ++ ) {
V_14 = F_84 ( V_2 , V_48 ,
( T_1 * ) V_141 ,
V_145 ) ;
if ( V_14 ) {
...
V_141 = V_141 + sizeof( T_1 ) * V_145 ;
V_48 = V_48 + sizeof( T_1 ) * V_145 ;
}
if ( V_2 -> V_16 -> V_142 . V_143 == V_2 -> V_144 ) {
V_14 = F_85 ( V_2 ) ;
if ( V_14 ) {
...
V_141 = V_141 + sizeof( T_1 ) ;
V_48 = V_48 + sizeof( T_1 ) ;
}
if ( V_2 -> V_16 -> V_142 . V_143 == V_2 -> V_144 ) {
V_14 = F_85 ( V_2 ) ;
if ( V_14 ) {
...
static T_2 F_88 ( struct V_54 * V_55 ,
struct V_56 * V_57 ,
struct V_58 * V_10 ,
char * V_11 , T_6 V_48 ,
T_3 V_49 )
