...
struct V_71 * V_3 ;
int V_87 ;
V_87 = F_96 ( V_47 , V_56 , V_64 & V_117 , 1 , 0 , 0 , & V_3 , NULL ) ;
if ( V_87 >= 0 ) {
V_87 = F_49 ( V_3 ) ;
F_97 ( V_3 ) ;
}
...
static long F_98 ( int * V_34 , T_1 * V_118 ,
...
if ( ! F_104 ( V_71 ) ) {
F_105 ( & V_71 -> V_125 , V_124 ) ;
F_106 ( V_71 , V_126 +
F_107 ( V_71 ) ) ;
}
}
}
static struct V_71 * F_108 ( struct V_71 * V_71 , unsigned long V_5 , int * * V_127 )
{
return F_109 ( V_5 , V_128 , 0 ) ;
}
static int F_110 ( struct V_55 * V_56 , int V_129 , int V_130 ,
int V_12 )
{
T_1 V_118 ;
F_111 ( V_124 ) ;
...
F_94 ( V_129 , V_118 ) ;
F_17 ( ! ( V_12 & ( V_74 | V_75 ) ) ) ;
F_69 ( V_56 , V_56 -> V_60 -> V_91 , V_56 -> V_131 , & V_118 ,
V_12 | V_94 , & V_124 ) ;
if ( ! F_112 ( & V_124 ) ) {
V_87 = F_113 ( & V_124 , F_108 , V_130 ,
V_132 , V_133 ) ;
if ( V_87 )
F_114 ( & V_124 ) ;
}
...
int F_115 ( struct V_55 * V_56 , const T_1 * V_134 ,
...
return V_87 ;
F_99 ( & V_56 -> V_59 ) ;
V_87 = F_117 ( V_56 , V_134 , V_135 , V_12 ) ;
if ( V_87 )
goto V_111;
V_17 = * V_134 ;
while ( ! F_11 ( V_17 ) ) {
...
break;
F_119 ( V_129 , V_17 ) ;
V_87 = F_110 ( V_56 , V_129 , V_130 , V_12 ) ;
if ( V_87 > 0 )
V_136 += V_87 ;
if ( V_87 < 0 )
break;
...
static struct V_71 * F_120 ( struct V_71 * V_71 , unsigned long V_66 , int * * V_127 )
{
struct V_57 * V_58 = (struct V_57 * ) V_66 ;
unsigned long V_139 ( V_140 ) ;
while ( V_58 ) {
V_140 = F_121 ( V_71 , V_58 ) ;
if ( V_140 != - V_90 )
break;
V_58 = V_58 -> V_61 ;
}
return F_122 ( V_128 , V_58 , V_140 ) ;
}
static void F_50 ( struct V_71 * V_71 , struct V_123 * V_124 ,
unsigned long V_12 )
{
...
static long F_123 ( unsigned long V_86 , unsigned long V_142 ,
...
if ( V_87 )
goto V_148;
V_58 = F_69 ( V_56 , V_86 , V_65 , V_118 ,
V_12 | V_73 , & V_124 ) ;
V_87 = F_76 ( V_58 ) ;
if ( ! F_75 ( V_58 ) )
...
static int F_126 ( T_1 * V_18 , const unsigned long T_8 * V_118 ,
unsigned long V_151 )
{
unsigned long V_152 ;
unsigned long V_153 ;
...
return - V_19 ;
for ( V_152 = F_127 ( V_49 ) ; V_152 < V_153 ; V_152 ++ ) {
unsigned long V_157 ;
if ( F_128 ( V_157 , V_118 + V_152 ) )
return - V_90 ;
if ( V_152 == V_153 - 1 ) {
if ( V_157 & V_154 )
return - V_19 ;
...
if ( F_129 ( F_21 ( * V_18 ) , V_118 , V_153 *sizeof( unsigned long ) ) )
return - V_90 ;
F_21 ( * V_18 ) [ V_153 - 1 ] &= V_154 ;
return 0 ;
}
static int F_130 ( unsigned long T_8 * V_158 , unsigned long V_151 ,
T_1 * V_18 )
{
unsigned long V_159 = F_131 ( V_151 - 1 , 64 ) / 8 ;
const int V_160 = F_127 ( V_49 ) * sizeof( long ) ;
if ( V_159 > V_160 ) {
if ( V_159 > V_76 )
return - V_19 ;
if ( F_132 ( ( char T_8 * ) V_158 + V_160 , V_159 - V_160 ) )
return - V_90 ;
V_159 = V_160 ;
}
return F_133 ( V_158 , F_21 ( * V_18 ) , V_159 ) ? - V_90 : 0 ;
}
...
F_135 ( V_164 , V_49 ) ;
V_162 = F_136 (unsigned long, maxnode-1 , MAX_NUMNODES) ;
V_163 = F_131 ( V_162 , V_156 ) / 8 ;
if ( V_118 )
V_161 = F_137 ( V_163 ) ;
V_87 = F_138 ( V_34 , V_161 , V_162 + 1 , V_64 , V_12 ) ;
if ( ! V_87 && V_118 ) {
unsigned long V_165 ;
V_165 = F_136 (unsigned long, sizeof(bm), alloc_size) ;
V_87 = F_129 ( V_164 , V_161 , V_165 ) ;
V_87 |= F_132 ( V_118 , F_131 ( V_151 - 1 , 8 ) / 8 ) ;
V_87 |= F_139 ( V_118 , V_164 , V_162 ) ;
}
return V_87 ;
}
T_9 long F_140 ( int V_8 , T_10 T_8 * V_118 ,
T_10 V_151 )
{
long V_87 = 0 ;
unsigned long T_8 * V_161 = NULL ;
...
V_163 = F_131 ( V_162 , V_156 ) / 8 ;
if ( V_118 ) {
V_87 = F_141 ( V_164 , V_118 , V_162 ) ;
V_161 = F_137 ( V_163 ) ;
V_87 |= F_133 ( V_161 , V_164 , V_163 ) ;
}
if ( V_87 )
return - V_90 ;
return F_142 ( V_8 , V_161 , V_162 + 1 ) ;
}
T_9 long F_143 ( T_10 V_86 , T_10 V_142 ,
...
V_163 = F_131 ( V_162 , V_156 ) / 8 ;
if ( V_118 ) {
V_87 = F_141 ( F_21 ( V_164 ) , V_118 , V_162 ) ;
V_161 = F_137 ( V_163 ) ;
V_87 |= F_133 ( V_161 , F_21 ( V_164 ) , V_163 ) ;
}
if ( V_87 )
return - V_90 ;
return F_144 ( V_86 , V_142 , V_8 , V_161 , V_162 + 1 , V_12 ) ;
}
struct V_1 * F_145 ( struct V_2 * V_166 ,
struct V_57 * V_58 , unsigned long V_64 )
{
struct V_1 * V_4 = F_1 ( V_166 ) ;
if ( V_58 ) {
if ( V_58 -> V_99 && V_58 -> V_99 -> V_122 ) {
struct V_1 * V_167 = V_58 -> V_99 -> V_122 ( V_58 ,
V_64 ) ;
if ( V_167 )
V_4 = V_167 ;
} else if ( V_58 -> V_62 ) {
...
static int F_148 ( struct V_1 * V_34 , enum V_168 V_169 )
{
...
static T_1 * F_150 ( T_11 V_174 , struct V_1 * V_34 )
{
if ( F_151 ( V_34 -> V_8 == V_116 ) &&
F_148 ( V_34 , F_152 ( V_174 ) ) &&
F_153 ( & V_34 -> V_20 . V_18 ) )
return & V_34 -> V_20 . V_18 ;
return NULL ;
}
static struct V_175 * F_154 ( T_11 V_174 , struct V_1 * V_34 ,
int V_176 )
{
switch ( V_34 -> V_8 ) {
case V_27 :
...
break;
case V_116 :
if ( F_151 ( V_174 & V_177 ) &&
F_151 ( ! F_33 ( V_176 , V_34 -> V_20 . V_18 ) ) )
V_176 = F_13 ( V_34 -> V_20 . V_18 ) ;
break;
default:
F_31 () ;
}
return F_155 ( V_176 , V_174 ) ;
}
...
struct V_175 * V_175 ;
struct V_169 * V_169 ;
enum V_168 V_179 = F_152 ( V_39 ) ;
V_175 = & F_159 ( F_2 () ) -> V_180 [ 0 ] ;
( void ) F_160 ( V_175 , V_179 ,
& V_34 -> V_20 . V_18 ,
& V_169 ) ;
...
unsigned long V_181 ;
F_149 ( V_185 < V_108 ) ;
V_181 = V_58 -> V_98 >> ( V_185 - V_108 ) ;
V_181 += ( V_64 - V_58 -> V_91 ) >> V_185 ;
return F_161 ( V_4 , V_58 , V_181 ) ;
} else
return F_156 ( V_4 ) ;
}
int F_163 ( const T_1 * V_186 )
{
int V_30 , V_187 = - 1 ;
V_30 = F_8 ( * V_186 ) ;
if ( V_30 )
V_187 = F_164 ( V_186 -> V_188 ,
F_165 () % V_30 , V_49 ) ;
return V_187 ;
}
struct V_175 * F_166 ( struct V_57 * V_58 , unsigned long V_64 ,
T_11 V_189 , struct V_1 * * V_190 ,
T_1 * * V_9 )
{
struct V_175 * V_191 ;
* V_190 = F_145 ( V_47 , V_58 , V_64 ) ;
* V_9 = NULL ;
if ( F_151 ( ( * V_190 ) -> V_8 == V_114 ) ) {
V_191 = F_155 ( F_162 ( * V_190 , V_58 , V_64 ,
F_167 ( F_168 ( V_58 ) ) ) , V_189 ) ;
} else {
V_191 = F_154 ( V_189 , * V_190 , F_2 () ) ;
if ( ( * V_190 ) -> V_8 == V_116 )
* V_9 = & ( * V_190 ) -> V_20 . V_18 ;
}
return V_191 ;
}
bool F_169 ( T_1 * V_158 )
{
struct V_1 * V_1 ;
int V_72 ;
if ( ! ( V_158 && V_47 -> V_1 ) )
...
static struct V_71 * F_172 ( T_11 V_174 , unsigned V_192 ,
unsigned V_72 )
{
struct V_175 * V_191 ;
struct V_71 * V_71 ;
V_191 = F_155 ( V_72 , V_174 ) ;
V_71 = F_173 ( V_174 , V_192 , V_191 ) ;
if ( V_71 && F_174 ( V_71 ) == F_175 ( & V_191 -> V_193 [ 0 ] ) )
F_106 ( V_71 , V_194 ) ;
return V_71 ;
}
struct V_71 *
F_176 ( T_11 V_174 , int V_192 , struct V_57 * V_58 ,
...
V_195 = F_177 () ;
if ( F_151 ( V_4 -> V_8 == V_114 ) ) {
unsigned V_72 ;
V_72 = F_162 ( V_4 , V_58 , V_64 , V_108 + V_192 ) ;
F_102 ( V_4 ) ;
V_71 = F_172 ( V_174 , V_192 , V_72 ) ;
if ( F_151 ( ! F_178 ( V_195 ) && ! V_71 ) )
goto V_196;
return V_71 ;
}
V_71 = F_179 ( V_174 , V_192 ,
F_154 ( V_174 , V_4 , V_5 ) ,
F_150 ( V_174 , V_4 ) ) ;
if ( F_151 ( F_146 ( V_4 ) ) )
F_25 ( V_4 ) ;
...
struct V_71 * F_180 ( T_11 V_174 , unsigned V_192 )
{
struct V_1 * V_4 = F_1 ( V_47 ) ;
struct V_71 * V_71 ;
unsigned int V_195 ;
if ( ! V_4 || F_158 () || ( V_174 & V_177 ) )
V_4 = & V_115 ;
V_196:
V_195 = F_177 () ;
if ( V_4 -> V_8 == V_114 )
V_71 = F_172 ( V_174 , V_192 , F_156 ( V_4 ) ) ;
else
V_71 = F_179 ( V_174 , V_192 ,
F_154 ( V_174 , V_4 , F_2 () ) ,
F_150 ( V_174 , V_4 ) ) ;
...
T_1 V_197 = V_32 ( V_47 ) ;
if ( V_54 -> V_12 & V_51 )
F_37 ( V_54 , & V_197 , V_46 ) ;
else
F_37 ( V_54 , & V_197 , V_44 ) ;
}
F_184 () ;
F_24 ( & V_54 -> V_41 , 1 ) ;
return V_54 ;
}
bool F_185 ( struct V_1 * V_198 , struct V_1 * V_199 )
{
if ( ! V_198 || ! V_199 )
return false ;
if ( V_198 -> V_8 != V_199 -> V_8 )
return false ;
if ( V_198 -> V_12 != V_199 -> V_12 )
return false ;
if ( F_5 ( V_198 ) )
if ( ! F_38 ( V_198 -> V_30 . V_31 , V_199 -> V_30 . V_31 ) )
return false ;
switch ( V_198 -> V_8 ) {
case V_116 :
case V_114 :
return ! ! F_38 ( V_198 -> V_20 . V_18 , V_199 -> V_20 . V_18 ) ;
case V_27 :
return V_198 -> V_20 . V_22 == V_199 -> V_20 . V_22 ;
default:
F_31 () ;
return false ;
}
...
static struct V_200 *
F_186 ( struct V_201 * V_202 , unsigned long V_86 , unsigned long V_65 )
{
struct V_203 * V_204 = V_202 -> V_205 . V_203 ;
while ( V_204 ) {
struct V_200 * V_3 = F_187 ( V_204 , struct V_200 , V_176 ) ;
if ( V_86 >= V_3 -> V_65 )
V_204 = V_204 -> V_206 ;
...
return NULL ;
for (; ; ) {
struct V_200 * V_30 = NULL ;
struct V_203 * V_89 = F_188 ( V_204 ) ;
if ( ! V_89 )
break;
V_30 = F_187 ( V_89 , struct V_200 , V_176 ) ;
if ( V_30 -> V_65 <= V_86 )
break;
V_204 = V_89 ;
}
return F_187 ( V_204 , struct V_200 , V_176 ) ;
}
static void F_189 ( struct V_201 * V_202 , struct V_200 * V_54 )
{
struct V_203 * * V_3 = & V_202 -> V_205 . V_203 ;
struct V_203 * V_208 = NULL ;
struct V_200 * V_176 ;
while ( * V_3 ) {
V_208 = * V_3 ;
V_176 = F_187 ( V_208 , struct V_200 , V_176 ) ;
if ( V_54 -> V_86 < V_176 -> V_86 )
V_3 = & ( * V_3 ) -> V_207 ;
...
F_190 ( & V_54 -> V_176 , V_208 , V_3 ) ;
F_191 ( & V_54 -> V_176 , & V_202 -> V_205 ) ;
F_20 ( L_4 , V_54 -> V_86 , V_54 -> V_65 ,
V_54 -> V_34 ? V_54 -> V_34 -> V_8 : 0 ) ;
}
struct V_1 *
F_192 ( struct V_201 * V_202 , unsigned long V_209 )
{
struct V_1 * V_4 = NULL ;
struct V_200 * V_210 ;
if ( ! V_202 -> V_205 . V_203 )
return NULL ;
F_193 ( & V_202 -> V_211 ) ;
V_210 = F_186 ( V_202 , V_209 , V_209 + 1 ) ;
if ( V_210 ) {
F_147 ( V_210 -> V_34 ) ;
V_4 = V_210 -> V_34 ;
}
...
static void F_195 ( struct V_200 * V_204 )
{
F_77 ( V_204 -> V_34 ) ;
F_27 ( V_212 , V_204 ) ;
}
...
static void F_198 ( struct V_201 * V_202 , struct V_200 * V_204 )
{
F_20 ( L_5 , V_204 -> V_86 , V_204 -> V_65 ) ;
F_199 ( & V_204 -> V_176 , & V_202 -> V_205 ) ;
F_195 ( V_204 ) ;
}
static void F_200 ( struct V_200 * V_5 , unsigned long V_86 ,
...
static struct V_200 * F_201 ( unsigned long V_86 , unsigned long V_65 ,
struct V_1 * V_4 )
{
struct V_200 * V_204 ;
struct V_1 * V_218 ;
V_204 = F_23 ( V_212 , V_39 ) ;
if ( ! V_204 )
return NULL ;
V_218 = F_74 ( V_4 ) ;
if ( F_75 ( V_218 ) ) {
...
V_218 -> V_12 |= V_219 ;
F_200 ( V_204 , V_86 , V_65 , V_218 ) ;
return V_204 ;
}
static int F_202 ( struct V_201 * V_202 , unsigned long V_86 ,
unsigned long V_65 , struct V_200 * V_54 )
{
struct V_200 * V_204 ;
struct V_200 * V_220 = NULL ;
struct V_1 * F_19 = NULL ;
int V_14 = 0 ;
V_221:
F_193 ( & V_202 -> V_211 ) ;
V_204 = F_186 ( V_202 , V_86 , V_65 ) ;
while ( V_204 && V_204 -> V_86 < V_65 ) {
struct V_203 * V_78 = F_203 ( & V_204 -> V_176 ) ;
if ( V_204 -> V_86 >= V_86 ) {
if ( V_204 -> V_65 <= V_65 )
F_198 ( V_202 , V_204 ) ;
else
...
* F_19 = * V_204 -> V_34 ;
F_24 ( & F_19 -> V_41 , 1 ) ;
F_200 ( V_220 , V_65 , V_204 -> V_65 , F_19 ) ;
V_204 -> V_65 = V_86 ;
F_189 ( V_202 , V_220 ) ;
V_220 = NULL ;
F_19 = NULL ;
...
if ( ! V_78 )
break;
V_204 = F_187 ( V_78 , struct V_200 , V_176 ) ;
}
if ( V_54 )
F_189 ( V_202 , V_54 ) ;
F_194 ( & V_202 -> V_211 ) ;
...
void F_204 ( struct V_201 * V_202 , struct V_1 * V_190 )
{
int V_14 ;
V_202 -> V_205 = V_223 ;
F_205 ( & V_202 -> V_211 ) ;
...
if ( V_14 )
goto V_227;
memset ( & V_224 , 0 , sizeof( struct V_57 ) ) ;
V_224 . V_93 = V_228 ;
F_206 ( V_202 , & V_224 , V_54 ) ;
V_227:
F_77 ( V_54 ) ;
V_226:
F_91 ( V_113 ) ;
...
int F_206 ( struct V_201 * V_229 ,
struct V_57 * V_58 , struct V_1 * V_230 )
{
int V_87 ;
struct V_200 * V_54 = NULL ;
unsigned long V_231 = F_207 ( V_58 ) ;
F_20 ( L_6 ,
V_58 -> V_98 ,
V_231 , V_230 ? V_230 -> V_8 : - 1 ,
V_230 ? V_230 -> V_12 : - 1 ,
V_230 ? F_21 ( V_230 -> V_20 . V_18 ) [ 0 ] : V_6 ) ;
if ( V_230 ) {
V_54 = F_201 ( V_58 -> V_98 , V_58 -> V_98 + V_231 , V_230 ) ;
if ( ! V_54 )
return - V_40 ;
}
V_87 = F_202 ( V_229 , V_58 -> V_98 , V_58 -> V_98 + V_231 , V_54 ) ;
if ( V_87 && V_54 )
F_195 ( V_54 ) ;
return V_87 ;
}
void F_208 ( struct V_201 * V_3 )
{
struct V_200 * V_204 ;
struct V_203 * V_78 ;
if ( ! V_3 -> V_205 . V_203 )
return;
F_193 ( & V_3 -> V_211 ) ;
V_78 = F_209 ( & V_3 -> V_205 ) ;
while ( V_78 ) {
V_204 = F_187 ( V_78 , struct V_200 , V_176 ) ;
V_78 = F_203 ( & V_204 -> V_176 ) ;
F_198 ( V_3 , V_204 ) ;
}
F_194 ( & V_3 -> V_211 ) ;
}
...
static int T_12 F_214 ( char * V_237 )
{
int V_14 = 0 ;
if ( ! V_237 )
goto V_111;
...
F_93 ( F_156 ) ;
F_219 (nid, N_MEMORY) {
unsigned long V_242 = F_220 ( V_72 ) ;
if ( V_239 < V_242 ) {
V_239 = V_242 ;
V_240 = V_72 ;
}
if ( ( V_242 << V_108 ) >= ( 16 << 20 ) )
F_94 ( V_72 , F_156 ) ;
}
if ( F_151 ( F_11 ( F_156 ) ) )
F_94 ( V_240 , F_156 ) ;
if ( F_87 ( V_114 , 0 , & F_156 ) )
F_212 ( L_14 ) ;
F_210 () ;
}
void F_221 ( void )
...
int F_222 ( char * V_237 , struct V_1 * * V_190 )
{
...
int F_225 ( char * V_247 , int V_248 , struct V_1 * V_4 )
{
char * V_3 = V_247 ;
int V_249 ;
T_1 V_18 ;
...
F_17 ( V_248 < strlen ( L_17 ) + strlen ( L_16 ) + 16 ) ;
if ( ! V_4 || V_4 == & V_115 )
V_8 = V_35 ;
else
V_8 = V_4 -> V_8 ;
...
V_249 = strlen ( V_245 [ V_8 ] ) ;
if ( V_247 + V_248 < V_3 + V_249 + 1 )
return - V_250 ;
strcpy ( V_3 , V_245 [ V_8 ] ) ;
V_3 += V_249 ;
if ( V_12 & V_13 ) {
if ( V_247 + V_248 < V_3 + 2 )
return - V_250 ;
* V_3 ++ = '=' ;
if ( V_12 & V_36 )
V_3 += snprintf ( V_3 , V_247 + V_248 - V_3 , L_15 ) ;
else if ( V_12 & V_28 )
...
return - V_250 ;
* V_3 ++ = ':' ;
V_3 += F_226 ( V_3 , V_247 + V_248 - V_3 , V_18 ) ;
}
return V_3 - V_247 ;
}
