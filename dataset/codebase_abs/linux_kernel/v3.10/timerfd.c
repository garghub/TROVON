...
static int F_40 ( int V_59 , int V_7 ,
const struct V_25 * V_60 ,
struct V_25 * V_61 )
{
struct V_53 V_55 ;
struct V_4 * V_5 ;
...
if ( V_5 -> V_10 && V_5 -> V_33 . V_15 )
F_34 ( & V_5 -> V_6 , V_5 -> V_33 ) ;
V_61 -> V_32 = F_44 ( F_18 ( V_5 ) ) ;
V_61 -> V_34 = F_44 ( V_5 -> V_33 ) ;
V_62 = F_21 ( V_5 , V_7 , V_60 ) ;
F_35 ( & V_5 -> V_8 . V_9 ) ;
F_39 ( V_55 ) ;
return V_62 ;
}
static int F_45 ( int V_59 , struct V_25 * V_64 )
{
struct V_53 V_55 ;
struct V_4 * V_5 ;
int V_62 = F_37 ( V_59 , & V_55 ) ;
if ( V_62 )
return V_62 ;
V_5 = V_55 . V_38 -> V_39 ;
F_32 ( & V_5 -> V_8 . V_9 ) ;
...
V_5 -> V_10 = 0 ;
V_5 -> V_11 +=
F_34 ( & V_5 -> V_6 , V_5 -> V_33 ) - 1 ;
V_1 ( & V_5 -> V_6 ) ;
}
V_64 -> V_32 = F_44 ( F_18 ( V_5 ) ) ;
V_64 -> V_34 = F_44 ( V_5 -> V_33 ) ;
F_35 ( & V_5 -> V_8 . V_9 ) ;
F_39 ( V_55 ) ;
return 0 ;
}
