...
F_15 ( V_19 ) ;
V_19 -> V_46 = ( V_9 -> V_2 . V_45 ) ? V_47 : V_65 ;
V_19 -> V_57 = V_66 ;
...
static T_3 F_31 ( struct V_17 * V_17 , char T_4 * V_67 , T_5 V_68 ,
T_6 * V_69 )
{
struct V_1 V_2 ;
struct V_8 * V_9 = NULL ;
...
F_6 ( & V_11 ) ;
if ( ! F_21 ( & V_12 ) ) {
V_9 = F_32 ( V_12 . V_70 , struct V_8 , V_10 ) ;
...
if ( V_9 -> V_2 . V_35 & V_36 )
F_20 ( V_9 ) ;
if ( F_34 ( V_67 , & V_2 , sizeof( V_2 ) ) )
return - V_73 ;
return sizeof( V_2 ) ;
}
static T_3 F_35 ( struct V_17 * V_17 , const char T_4 * V_67 , T_5 V_68 ,
T_6 * V_69 )
{
struct V_1 V_2 ;
struct V_8 * V_9 ;
