...
F_81 ( V_130 , & V_20 -> V_21 ) ;
F_66 ( V_3 ) ;
F_35 ( V_3 , V_163 , V_76 ) ;
F_35 ( V_3 , V_63 , F_32 ( V_3 , V_61 ) | V_119 ) ;
V_44 = F_82 ( V_130 , 0 , & V_174 , V_3 , & V_3 -> V_128 ) ;
if ( V_44 ) {
F_5 ( & V_20 -> V_21 , L_31 ) ;
goto V_191;
}
...
static int F_98 ( struct V_160 * V_20 )
{
struct V_167 * V_130 = F_99 ( V_20 ) ;
...
static int F_100 ( struct V_160 * V_20 )
{
struct V_167 * V_130 = F_99 ( V_20 ) ;
struct V_2 * V_3 = V_130 -> V_141 ;
F_73 ( V_3 -> V_172 ) ;
...
static int F_101 ( struct V_166 * V_20 )
{
struct V_167 * V_130 = F_102 ( V_20 ) ;
