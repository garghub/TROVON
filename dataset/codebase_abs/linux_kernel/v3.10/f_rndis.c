...
static int
F_43 ( struct V_80 * V_81 , struct V_2 * V_3 )
{
...
V_86 . V_89 = V_26 ;
V_26 = - V_90 ;
V_31 = F_45 ( V_22 -> V_62 , & V_91 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_4 . V_72 = V_31 ;
V_31 -> V_66 = V_22 ;
V_31 = F_45 ( V_22 -> V_62 , & V_92 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_4 . V_73 = V_31 ;
V_31 -> V_66 = V_22 ;
V_31 = F_45 ( V_22 -> V_62 , & V_93 ) ;
if ( ! V_31 )
goto V_68;
V_17 -> V_28 = V_31 ;
V_31 -> V_66 = V_22 ;
V_26 = - V_94 ;
V_17 -> V_20 = F_46 ( V_31 , V_95 ) ;
if ( ! V_17 -> V_20 )
goto V_68;
V_17 -> V_20 -> V_25 = F_47 ( V_96 , V_95 ) ;
if ( ! V_17 -> V_20 -> V_25 )
goto V_68;
V_17 -> V_20 -> V_37 = V_96 ;
V_17 -> V_20 -> V_32 = V_17 ;
...
V_17 -> V_23 = V_26 ;
F_39 ( V_17 -> V_23 , V_79 , 0 ) ;
F_50 ( V_17 -> V_23 , V_17 -> V_109 ) ;
if ( V_17 -> V_110 && V_17 -> V_111 &&
F_51 ( V_17 -> V_23 , V_17 -> V_111 ,
V_17 -> V_110 ) )
goto V_68;
F_15 ( V_22 , L_15 ,
...
static void
F_55 ( struct V_80 * V_81 , struct V_2 * V_3 )
{
struct V_1 * V_17 = F_1 ( V_3 ) ;
F_56 ( V_17 -> V_23 ) ;
F_57 () ;
...
static inline bool F_58 ( struct V_80 * V_81 )
{
return true ;
}
int
F_59 ( struct V_80 * V_81 , V_38 V_109 [ V_114 ] ,
T_3 V_111 , const char * V_110 , struct V_115 * V_116 )
{
struct V_1 * V_17 ;
int V_26 ;
if ( ! F_58 ( V_81 ) || ! V_109 )
...
if ( V_26 < 0 )
return V_26 ;
V_26 = F_61 ( V_81 -> V_22 , V_112 ) ;
if ( V_26 )
return V_26 ;
V_84 . V_117 = V_112 [ 0 ] . V_113 ;
V_88 . V_117 = V_112 [ 1 ] . V_113 ;
V_82 . V_118 = V_112 [ 2 ] . V_113 ;
}
V_26 = - V_94 ;
V_17 = F_62 ( sizeof *V_17 , V_95 ) ;
if ( ! V_17 )
goto V_68;
memcpy ( V_17 -> V_109 , V_109 , V_114 ) ;
V_17 -> V_111 = V_111 ;
V_17 -> V_110 = V_110 ;
V_17 -> V_4 . V_119 = V_116 ;
V_17 -> V_4 . V_75 = 0 ;
V_17 -> V_4 . V_120 = sizeof( struct V_15 ) ;
V_17 -> V_4 . V_121 = F_6 ;
V_17 -> V_4 . V_122 = V_123 ;
V_17 -> V_4 . V_5 . V_35 = L_20 ;
V_17 -> V_4 . V_5 . V_124 = V_125 ;
V_17 -> V_4 . V_5 . V_126 = F_43 ;
V_17 -> V_4 . V_5 . V_127 = F_55 ;
V_17 -> V_4 . V_5 . V_128 = F_27 ;
V_17 -> V_4 . V_5 . V_129 = F_22 ;
V_17 -> V_4 . V_5 . V_130 = F_36 ;
V_26 = F_63 ( V_81 , & V_17 -> V_4 . V_5 ) ;
if ( V_26 ) {
F_53 ( V_17 ) ;
V_68:
F_57 () ;
