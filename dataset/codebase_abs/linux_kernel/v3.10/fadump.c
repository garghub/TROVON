...
static T_5 F_72 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
...
static T_5 F_74 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
char * V_88 )
{
return sprintf ( V_88 , L_70 , V_10 . V_20 ) ;
}
static T_5 F_75 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
char * V_88 )
{
return sprintf ( V_88 , L_70 , V_10 . V_65 ) ;
}
static T_5 F_76 ( struct V_194 * V_195 ,
struct V_196 * V_197 ,
const char * V_88 , T_4 V_115 )
{
int V_199 = 0 ;
...
V_200:
F_71 ( & V_193 ) ;
return V_199 < 0 ? V_199 : V_115 ;
}
static int F_77 ( struct V_201 * V_202 , void * V_203 )
{
...
static int F_79 ( struct V_206 * V_206 , struct V_207 * V_207 )
{
return F_80 ( V_207 , F_77 , V_206 -> V_208 ) ;
}
static void F_81 ( void )
{
struct V_209 * V_210 ;
int V_61 = 0 ;
V_61 = F_82 ( V_211 , & V_212 . V_197 ) ;
if ( V_61 )
F_16 ( V_64 L_76
L_77 , V_61 ) ;
V_61 = F_82 ( V_211 , & V_213 . V_197 ) ;
if ( V_61 )
F_16 ( V_64 L_76
L_78 , V_61 ) ;
V_210 = F_83 ( L_79 , 0444 ,
V_214 , NULL ,
& V_215 ) ;
if ( ! V_210 )
F_16 ( V_64 L_80
