...
goto V_21;
F_13 () ;
for ( V_18 = V_7 -> V_20 ; V_18 != NULL ; V_18 = V_18 -> V_22 ) {
if ( ! ( V_18 -> V_23 & ( V_24 | V_25 ) ) )
continue;
if ( F_14 ( V_18 -> V_26 ) != V_13 )
continue;
F_15 () ;
...
F_23 ( & V_30 -> V_37 ) ;
V_31 = F_24 ( & V_30 -> V_38 ) ;
V_32 = F_25 ( V_13 , V_15 , V_16 ) ;
if ( ! V_32 )
V_32 = F_12 ( V_13 , V_15 , V_16 ) ;
...
{
int V_42 = 0 ;
V_42 = F_35 ( V_7 , V_2 -> V_3 , & V_2 -> V_16 , V_49 ) ;
F_1 ( V_2 ) ;
return V_42 ;
}
