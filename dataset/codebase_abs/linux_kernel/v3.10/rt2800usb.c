...
{
if ( V_77 == V_78 )
F_46 ( V_2 , V_79 , 0xff , 0 , 2 ) ;
else
F_46 ( V_2 , V_80 , 0xff , 0xff , 2 ) ;
return 0 ;
}
...
return ( T_4 * ) ( V_19 -> V_95 -> V_43 ) ;
else
return ( T_4 * ) ( V_19 -> V_95 -> V_43 + V_96 ) ;
}
static void F_52 ( struct V_18 * V_19 ,
struct V_97 * V_98 )
{
struct V_99 * V_100 = F_53 ( V_19 -> V_95 ) ;
T_4 * V_101 = ( T_4 * ) V_19 -> V_95 -> V_43 ;
T_1 V_102 ;
F_54 ( V_101 , 0 , & V_102 ) ;
F_4 ( & V_102 , V_103 ,
F_55 ( V_19 -> V_95 -> V_44 , 4 ) - V_96 ) ;
F_4 ( & V_102 , V_104 ,
...
{
return F_55 ( V_19 -> V_95 -> V_44 , 4 ) + 4 ;
}
static enum V_115
...
V_119 = F_18 ( V_6 , V_128 ) ;
V_123 = F_18 ( V_6 , V_129 ) ;
V_116 = F_51 ( V_19 ) ;
F_54 ( V_116 , 1 , & V_102 ) ;
V_120 = F_18 ( V_102 , V_130 ) ;
V_121 = F_18 ( V_102 , V_131 ) ;
V_122 = F_18 ( V_102 , V_132 ) ;
...
{
struct V_99 * V_100 = F_53 ( V_19 -> V_95 ) ;
T_4 * V_142 = ( T_4 * ) V_19 -> V_95 -> V_43 ;
T_4 * V_143 ;
T_1 V_102 ;
int V_144 ;
memcpy ( V_100 -> V_112 , V_142 , V_100 -> V_113 ) ;
F_54 ( V_142 , 0 , & V_102 ) ;
V_144 = F_18 ( V_102 , V_145 ) ;
...
V_143 = ( T_4 * ) ( V_19 -> V_95 -> V_43 + V_144 ) ;
F_54 ( V_143 , 0 , & V_102 ) ;
if ( F_18 ( V_102 , V_148 ) )
V_141 -> V_22 |= V_149 ;
V_141 -> V_150 = F_18 ( V_102 , V_151 ) ;
if ( F_18 ( V_102 , V_152 ) ) {
V_141 -> V_22 |= V_153 ;
V_141 -> V_22 |= V_154 ;
...
static int F_81 ( struct V_167 * V_168 ,
const struct V_169 * V_170 )
{
if ( V_170 -> V_171 == 5592 )
return F_82 ( V_168 , & V_172 ) ;
return F_82 ( V_168 , & V_173 ) ;
}
