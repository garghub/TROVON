...
int V_88 ;
struct V_89 V_90 ;
V_88 = F_39 ( V_83 , V_10 , V_86 , V_87 , & V_90 , & V_91 ) ;
if ( V_88 < 0 )
return V_88 ;
V_88 = - V_81 ;
if ( V_86 [ V_92 ] ) {
T_4 V_65 = F_40 ( V_86 [ V_92 ] ) ;
struct V_18 * V_46 = NULL , * V_93 ;
if ( F_19 ( V_65 ) )
goto V_94;
if ( V_65 ) {
...
if ( V_86 [ V_95 ] ) {
V_21 -> V_12 . V_96 = F_40 ( V_86 [ V_95 ] ) ;
F_41 ( V_10 , & V_21 -> V_12 , V_84 ) ;
}
#ifdef F_9
if ( V_86 [ V_97 ] ) {
V_88 = F_42 ( V_10 , V_21 -> V_50 , V_86 [ V_97 ] ) ;
if ( V_88 < 0 )
goto V_94;
}
#endif
F_43 ( V_10 , & V_21 -> V_52 , & V_90 ) ;
return 0 ;
V_94:
F_27 ( V_10 , & V_90 ) ;
return V_88 ;
}
static int F_44 ( struct V_83 * V_83 , struct V_7 * V_98 ,
...
struct V_85 * V_86 [ V_103 + 1 ] ;
T_4 V_104 ;
int V_88 ;
if ( V_101 == NULL )
return V_65 ? - V_81 : 0 ;
V_88 = F_45 ( V_86 , V_103 , V_101 , V_105 ) ;
if ( V_88 < 0 )
return V_88 ;
...
if ( V_86 [ V_107 ] ) {
unsigned int V_54 = F_40 ( V_86 [ V_107 ] ) ;
if ( -- V_54 > 0x100 )
return - V_81 ;
if ( F_19 ( V_65 ) )
return - V_81 ;
...
if ( V_86 [ V_109 ] ) {
V_104 = F_40 ( V_86 [ V_109 ] ) ;
if ( F_18 ( V_104 ) == V_67 ) {
V_19 = V_10 -> V_20 ;
V_104 = V_19 -> V_65 ;
} else {
V_19 = F_14 ( V_10 -> V_41 , F_18 ( V_104 ) ) ;
if ( V_19 == NULL )
return - V_81 ;
}
} else {
...
if ( V_19 -> V_54 < F_16 ( V_104 ) )
return - V_81 ;
if ( V_65 ) {
if ( F_18 ( V_65 ) && F_18 ( V_65 ^ V_104 ) )
return - V_81 ;
V_65 = V_104 | F_37 ( V_65 ) ;
} else
V_65 = F_36 ( V_19 , V_104 ) ;
if ( V_86 [ V_110 ] == NULL )
return - V_81 ;
V_100 = F_46 ( V_86 [ V_110 ] ) ;
V_21 = F_23 ( sizeof( * V_21 ) + V_100 -> V_38 * sizeof( struct V_29 ) , V_73 ) ;
if ( V_21 == NULL )
return - V_74 ;
#ifdef F_5
V_21 -> V_31 = F_23 ( sizeof( struct V_111 ) + V_100 -> V_38 * sizeof( V_112 ) , V_73 ) ;
if ( V_21 -> V_31 == NULL ) {
F_24 ( V_21 ) ;
return - V_74 ;
}
#endif
memcpy ( & V_21 -> V_3 , V_100 , sizeof( * V_100 ) + V_100 -> V_38 * sizeof( struct V_29 ) ) ;
V_21 -> V_62 = V_19 ;
V_21 -> V_65 = V_65 ;
V_21 -> V_4 = V_100 -> V_6 ? F_47 ( F_2 ( V_100 -> V_6 ) ) - 1 : 0 ;
#ifdef F_6
if ( V_86 [ V_113 ] ) {
struct V_114 * V_33 ;
V_33 = F_46 ( V_86 [ V_113 ] ) ;
memcpy ( & V_21 -> V_33 , V_33 , sizeof( struct V_114 ) ) ;
V_21 -> V_33 . V_37 = 0 ;
}
#endif
V_88 = F_38 ( V_83 , V_10 , V_84 , V_19 , V_21 , V_86 , V_99 [ V_106 ] ) ;
if ( V_88 == 0 ) {
struct V_13 * * V_115 ;
for ( V_115 = & V_19 -> V_19 [ F_16 ( V_65 ) ] ; * V_115 ; V_115 = & ( * V_115 ) -> V_36 )
if ( F_37 ( V_65 ) < F_37 ( ( * V_115 ) -> V_65 ) )
break;
V_21 -> V_36 = * V_115 ;
F_29 ( V_10 ) ;
* V_115 = V_21 ;
...
static void F_48 ( struct V_9 * V_10 , struct V_116 * V_80 )
{
struct V_63 * V_64 = V_10 -> V_41 ;
struct V_18 * V_19 ;
struct V_13 * V_21 ;
...
continue;
if ( V_80 -> V_118 >= V_80 -> V_119 ) {
if ( V_80 -> V_120 ( V_10 , ( unsigned long ) V_19 , V_80 ) < 0 ) {
V_80 -> V_117 = 1 ;
return;
}
}
...
if ( V_80 -> V_120 ( V_10 , ( unsigned long ) V_21 , V_80 ) < 0 ) {
V_80 -> V_117 = 1 ;
return;
}
V_80 -> V_118 ++ ;
...
static int F_49 ( struct V_9 * V_10 , unsigned long V_121 ,
struct V_7 * V_8 , struct V_122 * V_123 )
{
struct V_13 * V_21 = (struct V_13 * ) V_121 ;
struct V_85 * V_124 ;
if ( V_21 == NULL )
return V_8 -> V_61 ;
V_123 -> V_125 = V_21 -> V_65 ;
V_124 = F_50 ( V_8 , V_102 ) ;
if ( V_124 == NULL )
goto V_126;
if ( F_19 ( V_21 -> V_65 ) == 0 ) {
struct V_18 * V_19 = (struct V_18 * ) V_121 ;
T_4 V_54 = V_19 -> V_54 + 1 ;
if ( F_51 ( V_8 , V_107 , V_54 ) )
goto V_126;
} else {
if ( F_52 ( V_8 , V_110 ,
...
goto V_126;
if ( V_21 -> V_62 ) {
T_4 V_104 = V_21 -> V_65 & 0xFFFFF000 ;
if ( F_51 ( V_8 , V_109 , V_104 ) )
goto V_126;
}
if ( V_21 -> V_12 . V_96 &&
F_51 ( V_8 , V_95 , V_21 -> V_12 . V_96 ) )
goto V_126;
if ( V_21 -> V_46 &&
F_51 ( V_8 , V_92 , V_21 -> V_46 -> V_65 ) )
goto V_126;
#ifdef F_6
if ( ( V_21 -> V_33 . V_35 || V_21 -> V_33 . V_34 ) &&
F_52 ( V_8 , V_113 , sizeof( V_21 -> V_33 ) , & V_21 -> V_33 ) )
goto V_126;
#endif
if ( F_53 ( V_8 , & V_21 -> V_52 , & V_91 ) < 0 )
goto V_126;
#ifdef F_9
if ( strlen ( V_21 -> V_50 ) &&
F_54 ( V_8 , V_97 , V_21 -> V_50 ) )
goto V_126;
#endif
#ifdef F_5
if ( F_52 ( V_8 , V_127 ,
sizeof( struct V_111 ) + V_21 -> V_3 . V_38 * sizeof( V_112 ) ,
V_21 -> V_31 ) )
goto V_126;
#endif
}
