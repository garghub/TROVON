...
F_54 ( V_1 -> V_30 ) , V_1 -> V_30 -> V_93 ) ;
F_55 ( V_73 , & V_1 -> V_30 -> V_94 ) ;
V_39 = F_56 ( V_73 , V_95 , V_1 , & V_84 ) ;
if ( V_39 < 0 )
goto V_96;
strcpy ( V_73 -> V_97 , L_5 ) ;
V_86 = V_98 ;
V_86 . V_51 = V_1 -> V_76 ;
V_39 = F_57 ( V_73 , F_58 ( & V_86 , V_1 ) ) ;
if ( V_39 < 0 )
return V_39 ;
V_39 = F_45 ( V_1 ) ;
if ( V_39 < 0 )
