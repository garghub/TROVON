...
struct V_1 * V_2 = V_59 -> V_63 ;
T_1 V_64 ;
F_12 ( V_2 , V_61 -> V_48 ) ;
F_7 ( V_2 , V_61 -> V_21 ) ;
V_64 = F_4 ( V_2 , V_65 ) & 0x7f ;
F_6 ( V_2 , V_65 , V_64 | ( 1 << 7 ) ) ;
F_6 ( V_2 , V_65 , V_64 ) ;
return 0 ;
}
...
static int F_16 ( struct V_58 * V_59 , T_2 * V_66 )
{
return 0 ;
}
...
struct V_1 * V_2 = V_59 -> V_63 ;
int V_22 ;
for ( V_22 = 0 ; V_22 < F_9 ( V_67 ) ; V_22 ++ )
F_6 ( V_2 , V_67 [ V_22 ] [ 0 ] , V_67 [ V_22 ] [ 1 ] ) ;
...
struct V_58 * F_21 ( struct V_58 * V_59 , struct V_69 * V_13 , struct V_70 * V_10 )
{
struct V_1 * V_2 = NULL ;
T_1 V_22 = 0 ;
V_2 = F_22 ( sizeof( struct V_1 ) , V_71 ) ;
if ( V_2 == NULL )
return NULL ;
V_2 -> V_10 = V_10 ;
V_2 -> V_13 = V_13 ;
...
memcpy ( & V_59 -> V_72 . V_73 , & V_74 , sizeof( struct V_75 ) ) ;
V_59 -> V_63 = V_2 ;
return V_59 ;
}
