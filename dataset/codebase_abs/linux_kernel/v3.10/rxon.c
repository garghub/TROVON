...
V_132 = V_138 ;
V_131 = 3000 ;
} else if ( V_129 -> V_6 && V_130 -> V_6 ) {
int V_139 = V_130 -> V_91 ;
int V_140 = V_130 -> V_6 -> V_96 . V_106 ? : 1 ;
V_128 . V_17 |= F_3 ( V_141 ) ;
...
V_139 = F_49 ( int , V_139 ,
V_129 -> V_91 ) ;
if ( ! V_139 )
V_139 = V_86 ;
V_131 = V_139 / 2 ;
V_132 = V_139 - V_131 ;
if ( F_41 ( V_142 , & V_2 -> V_122 ) ||
( ! V_129 -> V_6 -> V_96 . V_143 &&
! V_129 -> V_6 -> V_96 . V_144 ) ) {
V_131 = V_140 * V_139 * 3 - V_138 ;
V_132 = V_138 ;
} else if ( ! V_130 -> V_6 -> V_96 . V_143 &&
! V_130 -> V_6 -> V_96 . V_144 ) {
V_132 = V_140 * V_139 * 3 - V_138 ;
V_131 = V_138 ;
}
} else if ( V_130 -> V_6 ) {
V_131 = 0 ;
...
V_128 . V_136 [ 0 ] . V_145 = F_3 ( V_131 ) ;
V_128 . V_136 [ 1 ] . V_145 = F_3 ( V_132 ) ;
V_40 = F_6 ( V_2 , V_146 , V_43 ,
sizeof( V_128 ) , & V_128 ) ;
if ( V_40 )
F_2 ( V_2 , L_19 , V_40 ) ;
return V_40 ;
...
V_149 -> V_17 |= F_29 ( V_4 -> V_58 . V_154 <<
V_155 ) ;
V_149 -> V_17 &= ~ ( V_150 |
V_151 ) ;
...
F_30 ( V_2 , L_21
L_22 ,
F_31 ( V_149 -> V_17 ) , V_4 -> V_58 . V_154 ,
V_4 -> V_58 . V_157 ) ;
}
void F_53 ( struct V_1 * V_2 , struct V_147 * V_148 )
{
struct V_3 * V_4 ;
F_54 (priv, ctx)
F_50 ( V_2 , V_148 , V_4 ) ;
}
void F_55 ( struct V_1 * V_2 , struct V_162 * V_163 ,
struct V_3 * V_4 )
{
enum V_164 V_28 = V_163 -> V_28 ;
T_3 V_22 = V_163 -> V_27 ;
...
if ( ( V_149 -> V_31 [ 0 ] | V_149 -> V_176 [ 0 ] ) & 0x1 ) {
F_38 ( V_2 , L_28 ) ;
V_173 |= F_47 ( 4 ) ;
}
if ( ( V_149 -> V_75 & V_177 ) == 0 &&
( V_149 -> V_72 & V_178 ) == 0 ) {
F_38 ( V_2 , L_29 ) ;
V_173 |= F_47 ( 5 ) ;
}
if ( F_26 ( V_149 -> V_179 ) > 2007 ) {
F_38 ( V_2 , L_30 ) ;
V_173 |= F_47 ( 6 ) ;
}
if ( ( V_149 -> V_17 & ( V_168 | V_169 ) )
== ( V_168 | V_169 ) ) {
F_38 ( V_2 , L_31 ) ;
V_173 |= F_47 ( 7 ) ;
}
if ( ( V_149 -> V_17 & ( V_168 | V_167 ) )
== ( V_168 | V_167 ) ) {
F_38 ( V_2 , L_32 ) ;
V_173 |= F_47 ( 8 ) ;
}
...
struct V_37 * V_149 = & V_4 -> V_5 ;
F_64 ( V_2 , L_36 ) ;
F_65 ( V_2 , V_184 , ( T_2 * ) V_149 , sizeof( * V_149 ) ) ;
F_64 ( V_2 , L_37 ,
F_26 ( V_149 -> V_22 ) ) ;
F_64 ( V_2 , L_38 ,
F_31 ( V_149 -> V_17 ) ) ;
F_64 ( V_2 , L_39 ,
F_31 ( V_149 -> V_13 ) ) ;
F_64 ( V_2 , L_40 , V_149 -> V_7 ) ;
F_64 ( V_2 , L_41 ,
V_149 -> V_75 ) ;
F_64 ( V_2 , L_42 ,
V_149 -> V_72 ) ;
F_64 ( V_2 , L_43 , V_149 -> V_31 ) ;
F_64 ( V_2 , L_44 , V_149 -> V_176 ) ;
F_64 ( V_2 , L_45 ,
F_26 ( V_149 -> V_179 ) ) ;
}
...
if ( V_4 -> V_6 ) {
struct V_189 * V_190 ;
unsigned long V_191 = V_4 -> V_6 -> V_96 . V_192 ;
int V_193 ;
V_190 = V_2 -> V_23 -> V_194 -> V_195 [ V_2 -> V_23 -> V_24 . V_25 . V_26 -> V_28 ] ;
F_67 (i, &basic, BITS_PER_LONG) {
int V_23 = V_190 -> V_196 [ V_193 ] . V_27 ;
if ( V_23 >= V_197 ) {
V_188 |= F_47 ( V_23 - V_197 ) ;
if ( V_185 > V_23 )
V_185 = V_23 ;
} else {
F_48 ( V_198 != 0 ) ;
...
if ( F_41 ( V_215 , & V_2 -> V_122 ) &&
( V_2 -> V_216 != V_4 -> V_5 . V_22 ) ) {
F_71 ( V_2 , L_48 ,
F_26 ( V_2 -> V_216 ) ) ;
F_72 ( V_2 , false ) ;
}
...
V_4 -> V_58 . V_157 =
V_160 ;
V_4 -> V_58 . V_219 = false ;
}
}
int F_77 ( struct V_220 * V_23 , T_7 V_221 )
{
struct V_1 * V_2 = F_78 ( V_23 ) ;
struct V_3 * V_4 ;
struct V_90 * V_24 = & V_23 -> V_24 ;
struct V_162 * V_22 = V_24 -> V_25 . V_26 ;
int V_40 = 0 ;
F_79 ( V_2 , L_56 , V_221 ) ;
F_80 ( & V_2 -> V_64 ) ;
...
if ( V_221 & V_230 ) {
F_79 ( V_2 , L_60 ,
V_2 -> V_114 , V_24 -> V_231 ) ;
F_37 ( V_2 , V_24 -> V_231 , false ) ;
}
F_54 (priv, ctx) {
...
V_109 = true ;
if ( V_268 & V_271 ) {
V_4 -> V_53 . V_56 = V_96 -> V_272 ;
F_14 ( V_2 , V_4 ) ;
}
V_4 -> V_5 . V_179 = F_3 ( V_6 -> V_96 . V_273 ) ;
if ( V_6 -> V_96 . V_274 )
V_4 -> V_5 . V_17 |= V_18 ;
else
V_4 -> V_5 . V_17 &= ~ V_18 ;
...
if ( V_4 -> V_58 . V_59 ) {
V_4 -> V_58 . V_154 = V_96 -> V_278 &
V_279 ;
V_4 -> V_58 . V_280 = ! ! ( V_96 -> V_278 &
V_281 ) ;
F_86 ( V_2 , V_4 , V_96 ) ;
F_53 ( V_2 , & V_2 -> V_225 ) ;
}
F_52 ( V_2 , V_4 ) ;
if ( V_96 -> V_282 && ( V_2 -> V_28 != V_165 ) )
V_4 -> V_5 . V_17 |= V_180 ;
else
V_4 -> V_5 . V_17 &= ~ V_180 ;
if ( V_96 -> V_282 )
...
V_4 -> V_5 . V_17 &= ~ V_214 ;
memcpy ( V_4 -> V_5 . V_176 , V_96 -> V_239 , V_33 ) ;
if ( V_6 -> type == V_9 ||
V_6 -> type == V_15 ) {
if ( V_6 -> V_96 . V_283 ) {
V_4 -> V_5 . V_13 |= V_41 ;
...
F_69 ( V_2 , V_4 ) ;
if ( V_268 & V_275 && V_96 -> V_144 ) {
if ( V_2 -> V_252 . V_254 == V_285 )
F_73 ( V_2 , false ) ;
F_90 ( V_2 ) ;
V_2 -> V_123 = 1 ;
}
...
if ( V_40 )
F_2 ( V_2 , L_65 ,
V_96 -> V_287 ? L_66 : L_67 ,
V_96 -> V_239 ) ;
}
if ( V_268 & V_288 && V_2 -> V_284 == V_4 ) {
if ( F_16 ( V_2 , V_6 ) )
F_2 ( V_2 , L_68 ) ;
}
F_85 ( & V_2 -> V_64 ) ;
...
{
struct V_3 * V_4 ;
F_100 ( V_2 , & V_2 -> V_289 . V_290 , false ) ;
F_37 ( V_2 , V_2 -> V_120 , false ) ;
F_54 (priv, ctx)
if ( memcmp ( & V_4 -> V_5 , & V_4 -> V_71 , sizeof( V_4 -> V_5 ) ) )
F_69 ( V_2 , V_4 ) ;
