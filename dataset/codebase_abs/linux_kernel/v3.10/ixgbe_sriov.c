...
V_140 = F_20 ( V_4 , F_56 ( V_102 ) ) ;
V_140 |= ( 1 << V_103 ) ;
F_6 ( V_4 , F_56 ( V_102 ) , V_140 ) ;
V_71 [ 0 ] = V_143 ;
if ( ! F_54 ( V_139 ) ) {
V_71 [ 0 ] |= V_144 ;
...
V_71 [ 3 ] = V_4 -> V_18 . V_146 ;
F_57 ( V_4 , V_71 , V_147 , V_24 ) ;
return 0 ;
}
static int F_58 ( struct V_1 * V_2 ,
T_1 * V_71 , T_1 V_24 )
{
T_4 * V_148 = ( ( T_4 * ) ( & V_71 [ 1 ] ) ) ;
if ( ! F_59 ( V_148 ) ) {
F_60 ( V_113 , L_12 , V_24 ) ;
return - 1 ;
}
if ( V_2 -> V_30 [ V_24 ] . V_149 &&
memcmp ( V_2 -> V_30 [ V_24 ] . V_130 , V_148 ,
V_134 ) ) {
F_60 ( V_113 ,
L_13
L_14 ,
...
int V_93 = ( V_71 [ 1 ] & V_150 ) ;
int V_46 ;
T_4 V_151 = F_47 ( V_2 -> V_98 ) ;
if ( V_2 -> V_30 [ V_24 ] . V_123 || V_151 ) {
F_60 ( V_113 ,
L_15
L_14 ,
V_24 ) ;
...
V_74 ;
int V_46 ;
if ( V_2 -> V_30 [ V_24 ] . V_149 && V_131 > 0 ) {
F_60 ( V_113 ,
L_16 ,
V_24 ) ;
return - 1 ;
...
F_63 ( V_2 -> V_98 , V_24 , false ) ;
}
V_46 = F_51 ( V_2 , V_24 , V_131 , V_148 ) ;
if ( V_46 == - V_133 )
F_60 ( V_113 ,
L_17 ,
V_24 ) ;
...
case V_128 :
case V_109 :
V_2 -> V_30 [ V_24 ] . V_108 = V_153 ;
return 0 ;
default:
break;
}
F_2 ( V_113 , L_18 , V_24 , V_153 ) ;
return - 1 ;
}
...
{
struct V_97 * V_45 = V_2 -> V_98 ;
struct V_154 * V_155 = & V_2 -> V_14 [ V_15 ] ;
...
V_71 [ V_158 ] = F_66 ( 1 , ~ V_155 -> V_159 ) ;
V_71 [ V_160 ] = F_66 ( 1 , ~ V_155 -> V_159 ) ;
if ( V_34 > 1 )
V_156 = F_67 ( V_45 , V_2 -> V_125 ) ;
if ( V_34 )
V_71 [ V_161 ] = V_34 ;
...
static int F_68 ( struct V_1 * V_2 , T_1 V_24 )
{
T_1 V_163 = V_164 ;
T_1 V_71 [ V_164 ] ;
struct V_3 * V_4 = & V_2 -> V_4 ;
T_3 V_165 ;
V_165 = F_69 ( V_4 , V_71 , V_163 , V_24 ) ;
if ( V_165 ) {
F_70 ( L_19 ) ;
return V_165 ;
}
if ( V_71 [ 0 ] & ( V_144 | V_145 ) )
return V_165 ;
F_21 ( V_4 ) ;
if ( V_71 [ 0 ] == V_143 )
...
V_71 [ 0 ] |= V_145 ;
F_57 ( V_4 , V_71 , 1 , V_24 ) ;
return V_165 ;
}
switch ( ( V_71 [ 0 ] & 0xFFFF ) ) {
case V_166 :
V_165 = F_58 ( V_2 , V_71 , V_24 ) ;
break;
case V_167 :
V_165 = F_30 ( V_2 , V_71 , V_24 ) ;
break;
case V_168 :
V_165 = F_61 ( V_2 , V_71 , V_24 ) ;
break;
case V_169 :
V_165 = F_38 ( V_2 , V_71 , V_24 ) ;
break;
case V_170 :
V_165 = F_62 ( V_2 , V_71 , V_24 ) ;
break;
case V_171 :
V_165 = F_64 ( V_2 , V_71 , V_24 ) ;
break;
case V_172 :
V_165 = F_65 ( V_2 , V_71 , V_24 ) ;
break;
default:
...
V_71 [ 0 ] |= V_144 ;
V_71 [ 0 ] |= V_174 ;
F_57 ( V_4 , V_71 , V_163 , V_24 ) ;
return V_165 ;
}
static void F_71 ( struct V_1 * V_2 , T_1 V_24 )
{
struct V_3 * V_4 = & V_2 -> V_4 ;
T_1 V_175 = V_145 ;
if ( ! V_2 -> V_30 [ V_24 ] . V_142 )
F_57 ( V_4 , & V_175 , 1 , V_24 ) ;
}
...
V_176 |= V_174 ;
F_57 ( V_4 , & V_176 , 1 , V_6 ) ;
}
}
int F_78 ( struct V_97 * V_98 , int V_24 , T_4 * V_18 )
{
struct V_1 * V_2 = F_79 ( V_98 ) ;
if ( ! F_59 ( V_18 ) || ( V_24 >= V_2 -> V_12 ) )
return - V_112 ;
V_2 -> V_30 [ V_24 ] . V_149 = true ;
F_80 ( & V_2 -> V_44 -> V_45 , L_21 , V_18 , V_24 ) ;
F_80 ( & V_2 -> V_44 -> V_45 , L_22
L_23 ) ;
if ( F_81 ( V_178 , & V_2 -> V_179 ) ) {
...
int F_82 ( struct V_97 * V_98 , int V_24 , T_2 V_180 , T_4 V_181 )
{
int V_46 = 0 ;
struct V_1 * V_2 = F_79 ( V_98 ) ;
struct V_3 * V_4 = & V_2 -> V_4 ;
...
static void F_84 ( struct V_1 * V_2 , int V_24 )
{
struct V_154 * V_155 = & V_2 -> V_14 [ V_15 ] ;
struct V_3 * V_4 = & V_2 -> V_4 ;
T_1 V_186 = 0 ;
...
int F_86 ( struct V_97 * V_98 , int V_24 , int V_189 )
{
struct V_1 * V_2 = F_79 ( V_98 ) ;
int V_182 ;
if ( V_24 >= V_2 -> V_12 )
...
int F_63 ( struct V_97 * V_98 , int V_24 , bool V_200 )
{
struct V_1 * V_2 = F_79 ( V_98 ) ;
int V_201 = V_24 >> 3 ;
int V_202 = V_24 % 8 ;
...
V_203 = F_20 ( V_4 , F_87 ( V_201 ) ) ;
V_203 &= ~ ( 1 << V_202 ) ;
V_203 |= ( V_200 << V_202 ) ;
F_6 ( V_4 , F_87 ( V_201 ) , V_203 ) ;
if ( V_2 -> V_30 [ V_24 ] . V_152 ) {
V_202 += V_204 ;
V_203 = F_20 ( V_4 , F_87 ( V_201 ) ) ;
V_203 &= ~ ( 1 << V_202 ) ;
