...
int V_76 , V_123 ;
int V_62 = 0 , V_124 ;
const int V_125 = 160000000 ;
V_120 = F_48 ( V_112 , V_126 , 0 ) ;
V_124 = F_49 ( V_112 , 0 ) ;
if ( ! V_120 || V_124 < 0 )
return - V_13 ;
V_23 = F_50 ( & V_112 -> V_2 , V_120 ) ;
if ( F_51 ( V_23 ) )
return F_52 ( V_23 ) ;
V_121 = F_53 ( & V_112 -> V_2 ) ;
if ( F_51 ( V_121 ) )
return F_52 ( V_121 ) ;
V_122 = F_54 ( & V_112 -> V_2 , NULL ) ;
if ( F_51 ( V_122 ) )
return F_52 ( V_122 ) ;
V_76 = (enum V_127 ) V_114 -> V_128 ;
V_62 = F_55 ( V_117 , L_9 ,
& V_123 ) ;
if ( V_62 )
V_123 = V_125 ;
V_7 = F_56 ( & V_112 -> V_2 , sizeof( * V_6 ) ) ;
if ( ! V_7 )
return - V_72 ;
V_7 -> V_129 = F_42 ;
V_7 -> V_130 = F_10 ;
...
V_9 -> V_76 = V_76 ;
F_57 ( & V_6 -> V_45 ) ;
V_62 = F_58 ( & V_112 -> V_2 , V_124 , F_21 , 0 ,
V_135 , V_9 ) ;
if ( V_62 )
goto V_136;
V_9 -> V_83 = F_59 ( & V_112 -> V_2 , L_10 ) ;
if ( ! V_9 -> V_83 ) {
F_3 ( V_9 -> V_2 , L_11 ) ;
V_62 = - V_137 ;
goto V_136;
...
F_60 ( V_9 -> V_122 ) ;
F_61 ( V_9 -> V_122 , V_123 ) ;
V_9 -> V_138 = F_62 ( V_9 -> V_122 ) / 1000 ;
F_44 ( V_9 -> V_23 ) ;
F_63 ( V_112 , V_7 ) ;
V_62 = F_64 ( V_7 ) ;
if ( V_62 ) {
F_3 ( & V_112 -> V_2 , L_12 , V_62 ) ;
goto V_139;
}
return 0 ;
V_139:
