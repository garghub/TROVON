...
{
struct V_17 * V_18 = F_21 ( V_13 ) ;
unsigned char V_112 = V_18 -> V_113 ;
if ( V_112 & V_3 ) {
unsigned char V_4 ;
if ( V_18 -> V_114 ) {
if ( V_18 -> V_98 )
...
V_120 . V_94 = V_121 . V_123 ;
V_120 . V_95 = V_121 . V_122 ;
V_120 . V_96 = V_121 . V_69 ;
if ( V_121 . V_44 & V_124 )
F_60 ( V_13 , L_30 ) ;
V_13 -> V_79 = & V_120 ;
F_83 ( V_13 , 1 ) ;
