...
static int F_46 ( struct V_83 * V_83 , struct V_60 * V_60 )
{
struct V_35 * V_39 = V_60 -> V_64 ;
F_41 ( & ( V_4 . V_67 ) ) ;
F_2 ( L_9 , V_39 ) ;
...
static T_6 F_50 ( struct V_60 * V_60 , char T_7 * V_90 ,
T_3 V_91 , T_8 * V_92 )
{
return - V_59 ;
}
static T_6 F_51 ( struct V_60 * V_60 , const char T_7 * V_90 ,
T_3 V_91 , T_8 * V_92 )
{
return - V_59 ;
}
static int F_52 ( struct V_35 * V_39 , void T_7 * V_93 )
{
struct V_94 V_95 ;
struct V_65 V_66 ;
F_43 ( V_41 , & V_66 ) ;
...
if ( F_53 ( V_93 , & V_95 , sizeof( struct V_94 ) ) )
return - V_108 ;
return 0 ;
}
int F_54 ( struct V_35 * V_39 )
{
struct V_42 * V_44 ;
F_2 ( L_11 ) ;
...
int F_57 ( struct V_35 * V_39 )
{
F_2 ( L_11 ) ;
F_33 ( V_4 . V_5 , V_39 ) ;
return 0 ;
}
int F_58 ( struct V_35 * V_39 , void T_7 * V_93 )
{
struct V_112 V_102 ;
F_2 ( L_11 ) ;
if ( F_59 ( & V_102 , V_93 , sizeof( struct V_112 ) ) )
return - V_108 ;
F_60 ( V_41 , V_102 . V_101 ) ;
return 0 ;
}
static int F_61 ( struct V_35 * V_39 , void T_7 * V_93 )
{
struct V_26 V_113 ;
struct V_11 * V_12 ;
struct V_35 * V_114 ;
F_2 ( L_11 ) ;
if ( F_59 ( & V_113 , V_93 , sizeof( struct V_26 ) ) )
return - V_108 ;
...
if ( V_115 == NULL )
return - V_34 ;
if ( F_59 ( V_115 , ( void T_7 * ) V_113 . V_33 ,
...
int F_62 ( struct V_35 * V_39 )
{
F_2 ( L_11 ) ;
return - V_59 ;
}
static int F_63 ( struct V_35 * V_39 , void T_7 * V_93 )
{
struct V_1 * V_40 ;
struct V_116 V_117 ;
F_2 ( L_11 ) ;
if ( F_59 ( & V_117 , V_93 , sizeof( struct V_116 ) ) )
return - V_108 ;
if ( V_117 . type >= V_118 )
return - V_59 ;
...
if ( F_53 ( V_93 , & V_117 , sizeof( struct V_116 ) ) ) {
F_19 ( V_40 ) ;
return - V_108 ;
}
return 0 ;
}
int F_64 ( struct V_35 * V_39 , int V_93 )
{
struct V_1 * V_40 ;
F_2 ( L_11 ) ;
V_40 = F_1 ( V_93 ) ;
...
static int F_65 ( struct V_35 * V_39 , void T_7 * V_93 )
{
struct V_120 V_121 ;
struct V_1 * V_40 ;
F_2 ( L_11 ) ;
if ( F_59 ( & V_121 , V_93 , sizeof( struct V_120 ) ) )
return - V_108 ;
V_40 = F_1 ( V_121 . V_2 ) ;
if ( V_40 == NULL )
return - V_59 ;
return F_66 ( V_40 , V_121 . V_19 ) ;
}
static int F_67 ( struct V_35 * V_39 , void T_7 * V_93 )
{
struct V_1 * V_40 ;
struct V_122 V_123 ;
F_2 ( L_11 ) ;
if ( F_59 ( & V_123 , V_93 , sizeof( struct V_122 ) ) )
return - V_108 ;
V_40 = F_1 ( V_123 . V_2 ) ;
if ( V_40 == NULL )
return - V_59 ;
...
static long F_69 ( struct V_60 * V_60 ,
...
switch ( V_124 ) {
case V_130 :
V_126 = F_52 ( V_125 , ( void T_7 * ) V_93 ) ;
break;
case V_128 :
V_126 = F_54 ( V_125 ) ;
break;
...
break;
case V_132 :
V_126 = F_58 ( V_125 , ( void T_7 * ) V_93 ) ;
break;
case V_133 :
V_126 = F_61 ( V_125 , ( void T_7 * ) V_93 ) ;
break;
case V_134 :
V_126 = F_62 ( V_125 ) ;
break;
case V_135 :
V_126 = F_63 ( V_125 , ( void T_7 * ) V_93 ) ;
break;
case V_136 :
V_126 = F_64 ( V_125 , ( int ) V_93 ) ;
break;
case V_137 :
V_126 = F_65 ( V_125 , ( void T_7 * ) V_93 ) ;
break;
case V_138 :
V_126 = F_67 ( V_125 , ( void T_7 * ) V_93 ) ;
break;
case V_139 :
break;
}
...
F_71 ( & ( V_4 . V_67 ) ) ;
if ( F_72 ( & V_141 ) ) {
F_73 (KERN_ERR PFX L_14 , AGPGART_MINOR) ;
return - V_142 ;
}
return 0 ;
}
