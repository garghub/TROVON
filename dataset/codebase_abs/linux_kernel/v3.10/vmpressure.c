...
V_17 = V_7 -> V_17 ;
F_18 ( & V_7 -> V_26 ) ;
if ( V_17 < V_32 || F_20 ( & V_7 -> V_3 ) )
return;
F_21 ( & V_7 -> V_3 ) ;
}
void F_22 ( T_1 V_27 , struct V_8 * V_9 , int V_33 )
{
if ( V_33 > V_34 )
return;
V_1 ( V_27 , V_9 , V_32 , 0 ) ;
}
int F_23 ( struct V_4 * V_5 , struct V_35 * V_36 ,
...
if ( V_22 >= V_39 )
return - V_41 ;
V_21 = F_24 ( sizeof( * V_21 ) , V_42 ) ;
if ( ! V_21 )
return - V_43 ;
V_21 -> V_25 = V_38 ;
V_21 -> V_22 = V_22 ;
F_15 ( & V_7 -> V_24 ) ;
F_25 ( & V_21 -> V_44 , & V_7 -> V_45 ) ;
F_18 ( & V_7 -> V_24 ) ;
return 0 ;
}
void F_26 ( struct V_4 * V_5 , struct V_35 * V_36 ,
struct V_37 * V_38 )
{
struct V_1 * V_7 = F_3 ( V_5 ) ;
struct F_14 * V_21 ;
