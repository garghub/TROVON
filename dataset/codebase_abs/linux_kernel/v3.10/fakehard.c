...
{
return F_16 ( V_3 , V_16 ) ;
}
static int F_17 ( struct V_2 * V_3 , struct V_8 * V_9 ,
T_2 V_10 , T_2 V_11 ,
...
static int F_19 ( struct V_2 * V_3 , T_2 type , T_3 V_26 ,
T_2 V_11 , T_2 V_27 )
{
T_2 V_28 [ 27 ] = {} ;
return F_20 ( V_3 , V_16 , type ,
V_26 , V_11 ,
type == V_29 ? V_28 : NULL ) ;
}
...
static T_4 F_25 ( struct V_30 * V_31 ,
struct V_2 * V_3 )
{
V_3 -> V_32 . V_33 ++ ;
...
static int F_27 ( struct V_2 * V_3 , struct V_37 * V_38 ,
int V_39 )
{
struct V_40 * V_41 =
...
static int F_28 ( struct V_2 * V_3 , void * V_53 )
{
return - V_54 ;
}
...
struct V_2 * V_3 ;
struct V_4 * V_5 ;
struct V_1 * V_6 = F_35 ( 0 ) ;
int V_70 ;
if ( ! V_6 )
return - V_71 ;
V_3 = F_36 ( sizeof( struct V_4 ) , L_1 , F_33 ) ;
if ( ! V_3 ) {
F_32 ( V_6 ) ;
return - V_71 ;
}
...
{
struct V_2 * V_3 = F_45 ( V_69 ) ;
F_43 ( V_3 ) ;
return 0 ;
}
static T_5 int F_46 ( void )
{
V_80 = F_47 (
L_4 , - 1 , NULL , 0 ) ;
return F_48 ( & V_81 ) ;
}
static T_6 void F_49 ( void )
{
F_50 ( & V_81 ) ;
F_51 ( V_80 ) ;
}
