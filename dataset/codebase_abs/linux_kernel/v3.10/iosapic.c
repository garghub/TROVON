...
{
return F_1 ( V_34 -> V_6 , V_109 ) ;
}
void * F_62 ( unsigned long V_110 )
{
...
V_34 -> V_6 = F_65 ( V_110 , 4096 ) ;
V_34 -> V_43 = V_110 ;
V_34 -> V_112 = F_61 ( V_34 ) ;
V_34 -> V_113 = F_66 ( V_34 -> V_112 ) + 1 ;
V_111 = V_34 -> V_101 = F_67 ( V_34 -> V_113 ,
sizeof( struct V_59 ) , V_11 ) ;
if ( V_111 == NULL ) {
F_68 ( V_34 ) ;
return NULL ;
}
for ( V_37 = 0 ; V_37 < V_34 -> V_113 ; V_37 ++ , V_111 ++ ) {
V_111 -> V_65 = ( unsigned char ) V_37 ;
V_111 -> V_1 = V_34 ;
}
if ( ! V_108 )
V_108 = V_34 ;
...
static void
F_69 ( void * V_13 , long V_114 )
{
unsigned int V_19 , * V_115 = ( unsigned int * ) V_13 ;
F_14 (KERN_DEBUG MODULE_NAME L_34 , num_entry) ;
for ( V_19 = 0 ; V_19 < V_114 ; V_19 ++ , V_115 += 4 ) {
F_14 ( V_88 L_35 ,
V_115 , V_19 , V_115 [ 0 ] , V_115 [ 1 ] , V_115 [ 2 ] , V_115 [ 3 ] ) ;
}
}
static void
...
F_14 ( V_88 L_45 , V_34 -> V_116 ) ;
F_14 ( V_88 L_46 , V_34 -> V_112 ) ;
