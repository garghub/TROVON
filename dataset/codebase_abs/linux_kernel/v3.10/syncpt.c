...
static bool F_25 ( struct V_1 * V_8 , T_1 V_20 )
{
F_15 ( V_8 -> V_3 , V_8 ) ;
return F_26 ( V_8 , V_20 ) ;
}
int F_27 ( struct V_1 * V_8 , T_1 V_20 , long V_21 ,
T_1 * V_22 )
{
F_28 ( V_23 ) ;
void * V_24 ;
...
V_26 = F_29 ( sizeof( * V_26 ) , V_13 ) ;
if ( ! V_26 ) {
V_27 = - V_31 ;
goto V_29;
}
V_27 = F_30 ( V_8 -> V_3 , V_8 -> V_14 , V_20 ,
V_32 ,
& V_23 , V_26 , & V_24 ) ;
if ( V_27 )
goto V_29;
...
V_21 = V_33 ;
while ( V_21 ) {
long V_34 = F_31 ( long , V_35 , V_21 ) ;
int V_36 = F_32 ( V_23 ,
F_25 ( V_8 , V_20 ) ,
V_34 ) ;
if ( V_36 > 0 || F_26 ( V_8 , V_20 ) ) {
if ( V_22 )
* V_22 = F_19 ( V_8 ) ;
V_27 = 0 ;
break;
...
F_36 ( V_8 -> V_3 , V_8 -> V_14 , V_24 ) ;
V_29:
return V_27 ;
}
bool F_26 ( struct V_1 * V_8 , T_1 V_20 )
{
T_1 V_40 ;
T_1 V_41 ;
F_37 () ;
V_40 = ( T_1 ) F_38 ( & V_8 -> V_42 ) ;
V_41 = ( T_1 ) F_38 ( & V_8 -> V_16 ) ;
if ( ! F_14 ( V_8 ) )
return V_41 - V_20 >= V_40 - V_20 ;
else
return ( V_43 ) ( V_40 - V_20 ) >= 0 ;
}
int F_39 ( struct V_1 * V_8 , void * V_44 )
{
return F_40 ( V_8 -> V_3 , V_8 , V_44 ) ;
}
int F_41 ( struct V_2 * V_3 )
{
struct V_1 * V_9 ;
int V_7 ;
V_9 = F_42 ( V_3 -> V_5 , sizeof( * V_9 ) * V_3 -> V_11 -> V_12 ,
V_13 ) ;
if ( ! V_9 )
return - V_31 ;
...
V_3 -> V_9 = V_9 ;
F_7 ( V_3 ) ;
V_3 -> V_45 = F_1 ( V_3 , NULL , 0 ) ;
if ( ! V_3 -> V_45 )
return - V_31 ;
return 0 ;
}
struct V_1 * F_43 ( struct V_4 * V_5 ,
int V_6 )
{
struct V_2 * V_3 = F_44 ( V_5 -> V_46 ) ;
...
struct V_1 * F_49 ( struct V_2 * V_3 , T_1 V_14 )
{
