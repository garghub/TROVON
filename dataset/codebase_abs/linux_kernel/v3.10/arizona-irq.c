...
if ( V_1 -> V_20 . V_22 & ( V_48 |
V_23 ) ) {
V_3 = F_37 ( V_1 -> V_17 , V_50 ,
V_51 , 0 ) ;
if ( V_3 != 0 ) {
F_12 ( V_1 -> V_11 , L_7 ,
V_3 ) ;
...
if ( V_1 -> V_20 . V_21 ) {
if ( F_41 ( V_1 -> V_20 . V_21 ) != V_1 -> V_2 ) {
F_42 ( V_1 -> V_11 , L_14 ,
V_1 -> V_2 , V_1 -> V_20 . V_21 ,
F_41 ( V_1 -> V_20 . V_21 ) ) ;
V_1 -> V_2 = F_41 ( V_1 -> V_20 . V_21 ) ;
}
V_3 = F_43 ( V_1 -> V_11 ,
V_1 -> V_20 . V_21 ,
V_60 , L_15 ) ;
...
return 0 ;
V_61:
F_6 ( F_1 ( V_1 , V_58 ) , V_1 ) ;
V_59:
F_6 ( F_1 ( V_1 , V_56 ) , V_1 ) ;
V_57:
F_44 ( F_40 ( V_1 -> V_16 , 1 ) ,
V_1 -> V_5 ) ;
V_55:
F_44 ( F_40 ( V_1 -> V_16 , 0 ) ,
V_1 -> V_4 ) ;
V_54:
V_52:
return V_3 ;
