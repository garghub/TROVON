...
static int F_216 ( struct V_26 * V_27 ,
...
static void F_217 ( struct V_26 * V_27 , T_1 V_18 )
{
int V_3 ;
for ( V_3 = 0 ; V_3 < V_18 ; V_3 ++ )
F_215 ( V_27 ) ;
}
int F_218 ( struct V_26 * V_27 , struct V_55 * V_56 ,
const struct V_157 * V_343 )
{
...
if ( V_56 == NULL )
return - V_38 ;
V_14 = F_218 ( V_27 , V_56 , V_343 ) ;
if ( V_14 )
F_16 ( V_56 ) ;
return V_14 ;
}
void F_220 ( struct V_55 * V_56 )
{
F_147 ( & V_341 ) ;
F_71 ( & V_56 -> V_155 ) ;
F_130 ( & V_341 ) ;
F_42 ( V_56 -> V_27 , L_103 ,
V_56 -> V_49 ) ;
F_16 ( V_56 -> V_49 ) ;
}
struct V_55 * F_221 ( struct V_26 * V_27 )
{
struct V_55 * V_56 ;
F_34 (platform, &platform_list, list) {
if ( V_27 == V_56 -> V_27 )
...
static void F_223 ( struct V_346 * V_66 )
{
int V_3 ;
...
V_5 -> V_353 = V_348 -> V_353 ;
V_5 -> V_54 . V_98 = V_104 ;
V_5 -> V_54 . V_27 = V_27 ;
V_5 -> V_54 . V_5 = V_5 ;
V_5 -> V_54 . V_354 = V_348 -> V_354 ;
...
F_223 ( & V_339 [ V_3 ] . V_363 ) ;
F_223 ( & V_339 [ V_3 ] . V_364 ) ;
}
F_147 ( & V_341 ) ;
F_88 ( & V_5 -> V_155 , & V_365 ) ;
F_130 ( & V_341 ) ;
V_14 = F_216 ( V_27 , V_339 , V_349 ) ;
if ( V_14 < 0 ) {
F_50 ( V_5 -> V_27 , L_105 , V_14 ) ;
goto V_357;
}
F_42 ( V_5 -> V_27 , L_106 , V_5 -> V_49 ) ;
return 0 ;
V_357:
F_147 ( & V_341 ) ;
F_71 ( & V_5 -> V_155 ) ;
...
struct V_368 * V_369 ;
int V_14 ;
F_42 ( V_27 , L_108 , F_68 ( V_27 ) ) ;
V_369 = F_209 ( V_27 , sizeof( * V_369 ) , V_37 ) ;
if ( ! V_369 ) {
F_50 ( V_27 , L_109 ) ;
return - V_38 ;
}
V_369 -> V_49 = F_210 ( V_27 , & V_369 -> V_268 ) ;
if ( ! V_369 -> V_49 ) {
F_50 ( V_27 , L_110 ) ;
return - V_38 ;
}
...
F_147 ( & V_341 ) ;
F_88 ( & V_369 -> V_155 , & V_371 ) ;
F_130 ( & V_341 ) ;
F_42 ( V_369 -> V_27 , L_111 , V_369 -> V_49 ) ;
return V_14 ;
V_370:
F_16 ( V_369 -> V_49 ) ;
return V_14 ;
...
return;
V_186:
F_217 ( V_27 , V_369 -> V_349 ) ;
F_147 ( & V_341 ) ;
F_71 ( & V_369 -> V_155 ) ;
F_130 ( & V_341 ) ;
F_42 ( V_27 , L_112 , V_369 -> V_49 ) ;
F_16 ( V_369 -> V_49 ) ;
}
int F_229 ( struct V_60 * V_47 ,
const char * V_372 )
{
struct V_373 * V_374 = V_47 -> V_27 -> V_120 ;
int V_14 ;
V_14 = F_230 ( V_374 , V_372 , 0 , & V_47 -> V_49 ) ;
if ( V_14 < 0 && V_14 != - V_17 ) {
F_50 ( V_47 -> V_27 ,
L_113 ,
V_372 , V_14 ) ;
...
struct V_376 * V_377 ;
int V_3 , V_14 ;
V_375 = F_232 ( V_374 , V_372 ) ;
if ( V_375 < 0 || V_375 & 1 ) {
F_50 ( V_47 -> V_27 , L_114
L_115 , V_372 ) ;
return - V_17 ;
}
V_375 /= 2 ;
...
V_377 = F_209 ( V_47 -> V_27 , V_375 * sizeof( * V_377 ) ,
V_37 ) ;
if ( ! V_377 ) {
F_50 ( V_47 -> V_27 ,
L_117 ) ;
...
for ( V_3 = 0 ; V_3 < V_375 ; V_3 ++ ) {
V_14 = F_230 ( V_374 , V_372 ,
2 * V_3 , & V_377 [ V_3 ] . V_378 ) ;
if ( V_14 ) {
F_50 ( V_47 -> V_27 ,
L_118 ,
V_372 , 2 * V_3 , V_14 ) ;
...
unsigned int F_233 ( struct V_373 * V_374 ,
const char * V_243 )
{
int V_14 , V_3 ;
char V_379 [ 128 ] ;
...
if ( ! V_243 )
V_243 = L_128 ;
snprintf ( V_379 , sizeof( V_379 ) , L_129 , V_243 ) ;
V_14 = F_234 ( V_374 , V_379 , & V_383 ) ;
if ( V_14 == 0 ) {
for ( V_3 = 0 ; V_3 < F_126 ( V_384 ) ; V_3 ++ ) {
if ( strcmp ( V_383 , V_384 [ V_3 ] . V_49 ) == 0 ) {
V_380 |= V_384 [ V_3 ] . V_1 ;
break;
}
}
}
snprintf ( V_379 , sizeof( V_379 ) , L_130 , V_243 ) ;
if ( F_235 ( V_374 , V_379 , NULL ) )
V_380 |= V_394 ;
else
V_380 |= V_395 ;
snprintf ( V_379 , sizeof( V_379 ) , L_131 , V_243 ) ;
V_381 = ! ! F_235 ( V_374 , V_379 , NULL ) ;
snprintf ( V_379 , sizeof( V_379 ) , L_132 , V_243 ) ;
V_382 = ! ! F_235 ( V_374 , V_379 , NULL ) ;
switch ( ( V_381 << 4 ) + V_382 ) {
case 0x11 :
V_380 |= V_396 ;
break;
case 0x10 :
...
snprintf ( V_379 , sizeof( V_379 ) , L_133 , V_243 ) ;
V_381 = ! ! F_235 ( V_374 , V_379 , NULL ) ;
snprintf ( V_379 , sizeof( V_379 ) , L_134 , V_243 ) ;
V_382 = ! ! F_235 ( V_374 , V_379 , NULL ) ;
switch ( ( V_381 << 4 ) + V_382 ) {
case 0x11 :
V_380 |= V_202 ;
