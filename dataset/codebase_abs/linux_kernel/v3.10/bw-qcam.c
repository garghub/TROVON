...
static int F_37 ( struct V_88 * V_88 , void * V_89 ,
struct V_90 * V_91 )
{
struct V_1 * V_1 = F_38 ( V_88 ) ;
F_39 ( V_91 -> V_92 , V_1 -> V_93 . V_19 , sizeof( V_91 -> V_92 ) ) ;
F_39 ( V_91 -> V_94 , L_3 , sizeof( V_91 -> V_94 ) ) ;
F_39 ( V_91 -> V_95 , V_1 -> V_3 -> V_19 , sizeof( V_91 -> V_95 ) ) ;
V_91 -> V_96 = V_97 | V_98 |
V_99 ;
V_91 -> V_100 = V_91 -> V_96 | V_101 ;
return 0 ;
}
static int F_40 ( struct V_88 * V_88 , void * V_102 , struct V_103 * V_104 )
{
if ( V_104 -> V_105 > 0 )
return - V_106 ;
F_39 ( V_104 -> V_19 , L_4 , sizeof( V_104 -> V_19 ) ) ;
V_104 -> type = V_107 ;
V_104 -> V_108 = 0 ;
V_104 -> V_109 = 0 ;
V_104 -> V_110 = 0 ;
...
static int F_41 ( struct V_88 * V_88 , void * V_102 , unsigned int * V_111 )
{
* V_111 = 0 ;
return 0 ;
}
static int F_42 ( struct V_88 * V_88 , void * V_102 , unsigned int V_111 )
{
return ( V_111 > 0 ) ? - V_106 : 0 ;
}
static int F_43 ( struct V_88 * V_88 , void * V_102 , struct V_71 * V_72 )
{
struct V_1 * V_1 = F_38 ( V_88 ) ;
struct V_112 * V_79 = & V_72 -> V_72 . V_79 ;
V_79 -> V_38 = V_1 -> V_38 / V_1 -> V_23 ;
V_79 -> V_37 = V_1 -> V_37 / V_1 -> V_23 ;
V_79 -> V_113 = ( V_1 -> V_24 == 4 ) ? V_114 : V_115 ;
V_79 -> V_116 = V_117 ;
V_79 -> V_118 = V_79 -> V_38 ;
V_79 -> V_119 = V_79 -> V_38 * V_79 -> V_37 ;
V_79 -> V_120 = V_121 ;
V_79 -> V_89 = 0 ;
return 0 ;
}
static int F_44 ( struct V_88 * V_88 , void * V_102 , struct V_71 * V_72 )
{
struct V_112 * V_79 = & V_72 -> V_72 . V_79 ;
...
static int F_45 ( struct V_88 * V_88 , void * V_102 , struct V_71 * V_72 )
{
struct V_1 * V_1 = F_38 ( V_88 ) ;
struct V_112 * V_79 = & V_72 -> V_72 . V_79 ;
int V_44 = F_44 ( V_88 , V_102 , V_72 ) ;
if ( V_44 )
return V_44 ;
if ( F_46 ( & V_1 -> V_122 ) )
return - V_123 ;
...
static int F_47 ( struct V_88 * V_88 , void * V_102 , struct V_124 * V_72 )
{
...
enum V_126 type = V_72 -> type ;
if ( V_72 -> V_105 > 1 )
return - V_106 ;
* V_72 = V_125 [ V_72 -> V_105 ] ;
V_72 -> type = type ;
return 0 ;
}
static int F_48 ( struct V_88 * V_88 , void * V_102 ,
struct V_127 * V_128 )
{
static const struct V_129 V_75 [] = {
{ 80 , 60 } ,
{ 160 , 120 } ,
{ 320 , 240 } ,
} ;
if ( V_128 -> V_105 > 2 )
return - V_106 ;
if ( V_128 -> V_130 != V_114 &&
V_128 -> V_130 != V_115 )
return - V_106 ;
V_128 -> type = V_131 ;
V_128 -> V_132 = V_75 [ V_128 -> V_105 ] ;
return 0 ;
}
static int F_49 ( struct V_133 * V_134 )
{
struct V_1 * V_1 =
F_50 ( V_134 -> V_135 , struct V_1 , V_136 ) ;
int V_44 = 0 ;
switch ( V_134 -> V_137 ) {
case V_138 :
V_1 -> V_36 = V_134 -> V_5 ;
...
static struct V_1 * F_51 ( struct V_141 * V_142 )
{
struct V_1 * V_1 ;
struct V_143 * V_93 ;
struct V_69 * V_2 ;
int V_144 ;
V_1 = F_52 ( sizeof( struct V_1 ) , V_145 ) ;
if ( V_1 == NULL )
return NULL ;
V_93 = & V_1 -> V_93 ;
snprintf ( V_93 -> V_19 , sizeof( V_93 -> V_19 ) , L_7 , V_146 ) ;
if ( F_53 ( V_142 -> V_77 , V_93 ) < 0 ) {
F_54 ( V_93 , L_8 ) ;
F_55 ( V_1 ) ;
return NULL ;
}
F_56 ( & V_1 -> V_136 , 3 ) ;
F_57 ( & V_1 -> V_136 , & V_147 ,
V_138 , 0 , 255 , 1 , 180 ) ;
F_57 ( & V_1 -> V_136 , & V_147 ,
V_139 , 0 , 255 , 1 , 192 ) ;
F_57 ( & V_1 -> V_136 , & V_147 ,
...
V_2 = & V_1 -> V_122 ;
V_2 -> type = V_149 ;
V_2 -> V_150 = V_151 | V_152 | V_153 ;
V_2 -> V_154 = V_1 ;
V_2 -> V_155 = & V_156 ;
V_2 -> V_157 = & V_158 ;
V_144 = F_59 ( V_2 ) ;
if ( V_144 < 0 ) {
F_54 ( V_93 , L_10 , V_142 -> V_19 ) ;
goto exit;
}
V_1 -> V_159 . V_160 = V_2 ;
V_1 -> V_159 . V_160 -> V_78 = & V_1 -> V_148 ;
V_1 -> V_3 = V_142 ;
V_1 -> V_86 = F_60 ( V_142 , V_93 -> V_19 , NULL , NULL ,
NULL , 0 , NULL ) ;
if ( V_1 -> V_86 == NULL ) {
F_54 ( V_93 , L_11 , V_142 -> V_19 ) ;
goto exit;
}
F_39 ( V_1 -> V_159 . V_19 , L_12 , sizeof( V_1 -> V_159 . V_19 ) ) ;
V_1 -> V_159 . V_93 = V_93 ;
V_1 -> V_159 . V_161 = & V_1 -> V_136 ;
V_1 -> V_159 . V_162 = & V_163 ;
V_1 -> V_159 . V_78 = & V_1 -> V_78 ;
V_1 -> V_159 . V_164 = & V_165 ;
F_61 ( V_166 , & V_1 -> V_159 . V_167 ) ;
V_1 -> V_159 . V_168 = V_169 ;
F_62 ( & V_1 -> V_159 , V_1 ) ;
V_1 -> V_25 = ( V_34 | V_28 ) ;
V_1 -> V_38 = 320 ;
V_1 -> V_37 = 240 ;
...
F_68 ( & V_1 -> V_136 ) ;
F_35 ( V_1 -> V_86 ) ;
F_69 ( & V_1 -> V_93 , L_14 , V_1 -> V_3 -> V_19 ) ;
if ( F_70 ( & V_1 -> V_159 , V_174 , V_175 ) < 0 ) {
F_67 ( V_1 -> V_86 ) ;
F_55 ( V_1 ) ;
return - V_173 ;
}
...
#ifdef F_74
int V_177 ;
if ( V_141 [ 0 ] && strncmp ( V_141 [ 0 ] , L_15 , 4 ) != 0 ) {
for ( V_177 = 0 ; V_177 < V_171 && V_141 [ V_177 ] ; V_177 ++ ) {
char * V_178 ;
unsigned long V_179 ;
V_179 = F_75 ( V_141 [ V_177 ] , & V_178 , 0 ) ;
if ( V_178 == V_141 [ V_177 ] ) {
F_18 ( V_18
L_16 ,
V_141 [ V_177 ] ) ;
continue;
}
if ( V_179 == V_142 -> V_180 )
return 1 ;
}
return 0 ;
}
...
static void F_77 ( struct V_141 * V_142 )
{
int V_16 ;
for ( V_16 = 0 ; V_16 < V_146 ; V_16 ++ ) {
struct V_1 * V_1 = V_176 [ V_16 ] ;
if ( V_1 && V_1 -> V_86 -> V_142 == V_142 ) {
V_176 [ V_16 ] = NULL ;
F_71 ( V_1 ) ;
}
}
