...
int F_56 ( struct V_4 * V_21 )
{
int V_140 ;
int V_141 = - 1 ;
F_14 ( & V_142 ) ;
for ( V_140 = 0 ; V_140 < sizeof( V_143 ) * 8 ; V_140 ++ ) {
if ( ( V_143 & ( 1 << V_140 ) ) == 0 ) {
V_143 |= ( 1 << V_140 ) ;
V_21 -> V_144 = V_140 ;
F_30 ( & V_21 -> V_145 ) ;
F_57 ( & V_21 -> V_146 , & V_147 ) ;
V_141 = 0 ;
break;
}
}
...
void F_58 ( struct V_4 * V_21 )
{
struct V_1 * V_49 ;
struct V_1 * V_148 ;
F_14 ( & V_142 ) ;
V_143 &= ~ ( 1 << V_21 -> V_144 ) ;
F_59 (vdev, tmp, &bridge->devices, bridge_list) {
F_60 ( & V_49 -> V_149 ) ;
F_60 ( & V_49 -> V_150 ) ;
F_61 ( & V_49 -> V_3 ) ;
}
...
struct V_1 * V_49 ;
struct V_1 * V_148 ;
for ( V_140 = 0 ; V_140 < V_153 ; V_140 ++ ) {
V_49 = F_63 ( sizeof( struct V_1 ) , V_61 ) ;
if ( ! V_49 ) {
V_154 = - V_155 ;
goto V_156;
}
...
F_64 ( & V_49 -> V_3 , L_53 , V_152 -> V_22 , V_21 -> V_144 ,
V_49 -> V_144 ) ;
V_154 = F_65 ( & V_49 -> V_3 ) ;
if ( V_154 )
goto V_161;
if ( V_49 -> V_3 . V_157 ) {
F_57 ( & V_49 -> V_149 , & V_152 -> V_145 ) ;
F_57 ( & V_49 -> V_150 , & V_21 -> V_145 ) ;
} else
F_61 ( & V_49 -> V_3 ) ;
}
return 0 ;
...
F_19 ( V_49 ) ;
V_156:
F_59 (vdev, tmp, &drv->devices, drv_list) {
F_60 ( & V_49 -> V_149 ) ;
F_60 ( & V_49 -> V_150 ) ;
F_61 ( & V_49 -> V_3 ) ;
}
...
static int F_67 ( struct V_151 * V_152 , unsigned int V_153 )
{
struct V_4 * V_21 ;
int V_154 = 0 ;
F_14 ( & V_142 ) ;
F_68 (bridge, &vme_bus_list, bus_list) {
V_154 = F_62 ( V_152 , V_21 , V_153 ) ;
if ( V_154 )
break;
}
F_15 ( & V_142 ) ;
...
int F_69 ( struct V_151 * V_152 , unsigned int V_153 )
{
int V_154 ;
V_152 -> V_162 . V_22 = V_152 -> V_22 ;
V_152 -> V_162 . V_159 = & V_160 ;
F_30 ( & V_152 -> V_145 ) ;
V_154 = F_70 ( & V_152 -> V_162 ) ;
if ( V_154 )
return V_154 ;
V_154 = F_67 ( V_152 , V_153 ) ;
if ( V_154 )
F_71 ( & V_152 -> V_162 ) ;
return V_154 ;
}
void F_72 ( struct V_151 * V_152 )
{
struct V_1 * V_3 , * V_163 ;
F_14 ( & V_142 ) ;
F_59 (dev, dev_tmp, &drv->devices, drv_list) {
F_60 ( & V_3 -> V_149 ) ;
F_60 ( & V_3 -> V_150 ) ;
F_61 ( & V_3 -> V_3 ) ;
}
...
static int F_73 ( struct V_2 * V_3 , struct V_164 * V_152 )
{
struct V_151 * V_165 ;
