...
static int F_20 ( struct V_9 * V_63 , void * V_64 )
{
struct V_65 * V_66 = V_64 ;
int V_31 = 0 ;
switch ( V_66 -> V_67 ) {
case 1 :
V_31 = F_4 ( V_66 -> V_68 , V_63 ) ;
break;
case 2 :
if ( V_66 -> V_69 ) {
F_3 ( V_63 , L_40
...
static void * F_21 ( struct V_9 * V_63 , T_2 * V_70 )
{
struct V_71 * V_72 ;
struct V_73 * V_74 ;
...
if ( V_79 >= V_76 -> V_84 )
return NULL ;
V_66 = F_22 ( sizeof( struct V_65 ) , V_85 ) ;
if ( ! V_66 )
return NULL ;
if ( V_78 == 0 )
V_66 -> V_69 = 1 ;
...
F_23 ( & V_76 -> V_89 [ V_79 ] . V_91 ) ;
if ( ! F_24 ( V_72 ) ) {
for ( V_74 = F_25 ( V_72 ) ; V_74 ; V_74 = F_26 ( V_74 ) ) {
V_43 = F_27 ( V_74 , struct V_13 , V_92 ) ;
if ( ! V_80 -- ) {
F_28 ( V_43 ) ;
V_66 -> V_68 = V_43 ;
V_66 -> V_79 = V_79 ;
F_29 ( & V_76 -> V_89 [ V_79 ] . V_91 ) ;
return V_66 ;
}
}
}
...
static void * F_31 ( struct V_9 * V_63 , void * V_64 , T_2 * V_70 )
{
struct V_75 * V_76 = V_63 -> V_77 ;
struct V_65 * V_66 = V_64 ;
struct V_71 * V_72 ;
...
V_93 = F_26 ( & V_94 -> V_92 ) ;
if ( V_93 ) {
V_43 = F_27 ( V_93 , struct V_13 , V_92 ) ;
F_28 ( V_43 ) ;
V_66 -> V_68 = V_43 ;
F_29 ( & V_76 -> V_89 [ V_79 ] . V_91 ) ;
F_32 ( V_94 ) ;
...
static void F_33 ( struct V_9 * V_63 , void * V_64 )
{
struct V_65 * V_66 = V_64 ;
if ( V_66 ) {
F_32 ( V_66 -> V_68 ) ;
...
static int F_34 ( struct V_95 * V_95 , struct V_96 * V_96 )
{
struct V_9 * V_63 ;
int V_97 = - 1 ;
if ( V_96 -> V_98 == & V_99 )
...
static T_3 F_36 ( struct V_96 * V_96 , char T_4 * V_105 ,
T_5 V_106 , T_2 * V_107 )
{
...
F_38 ( & V_76 -> V_111 ) ;
V_31 = F_39 ( V_105 , V_106 , V_107 , V_112 , V_70 ) ;
F_38 ( & V_110 ) ;
return V_31 ;
}
...
int F_42 ( struct V_75 * V_76 )
{
char V_119 [ V_120 + 8 ] ;
V_76 -> V_114 = F_43 ( V_76 -> V_121 ,
V_122 | V_123 ,
V_124 ,
V_76 ,
& V_99 ) ;
