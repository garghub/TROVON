...
static struct V_88 *
F_29 ( struct V_49 * V_37 )
{
struct V_104 * V_105 = V_37 -> V_38 . V_106 , * V_107 ;
struct V_88 * V_89 ;
struct V_108 * V_109 ;
int V_110 ;
V_110 = F_30 ( V_105 ) ;
if ( ! V_110 || V_110 > V_91 )
return F_31 ( - V_111 ) ;
V_109 = F_32 ( & V_37 -> V_38 ,
sizeof( struct V_108 ) * V_110 , V_112 ) ;
if ( ! V_109 )
return F_31 ( - V_113 ) ;
F_33 (np, child) {
struct V_108 V_20 ;
...
int V_114 ;
V_20 . V_93 =
F_34 ( V_107 , L_6 , NULL ) ? : V_107 -> V_93 ;
V_20 . V_115 =
F_34 ( V_107 , L_7 , NULL ) ;
V_114 = F_35 ( V_107 , L_8 , & V_27 ) ;
if ( V_114 != 0 )
continue;
V_109 [ V_27 ] = V_20 ;
}
V_89 = F_32 ( & V_37 -> V_38 ,
sizeof( struct V_88 ) , V_112 ) ;
if ( ! V_89 )
return F_31 ( - V_113 ) ;
V_89 -> V_92 . V_92 = V_109 ;
V_89 -> V_92 . V_116 = V_110 ;
return V_89 ;
}
static struct V_88 *
F_29 ( struct V_49 * V_37 )
...
static int F_36 ( struct V_49 * V_37 ,
...
int V_74 ;
int V_63 = 0 ;
V_120 = F_37 ( V_37 -> V_38 . V_121 ) ;
V_89 = V_37 -> V_38 . V_122 ;
if ( ! F_38 ( V_120 , V_123 ) )
return - V_124 ;
if ( ! V_89 || V_89 -> V_92 . V_116 != V_91 ) {
V_89 = F_29 ( V_37 ) ;
if ( F_39 ( V_89 ) ) {
F_28 ( & V_37 -> V_38 , L_9 ,
V_91 ) ;
...
V_19 = F_32 ( & V_37 -> V_38 , sizeof( * V_19 ) , V_112 ) ;
if ( ! V_19 )
return - V_113 ;
V_19 -> V_37 = V_37 ;
F_41 ( & V_19 -> V_48 , F_9 ) ;
...
F_43 ( V_37 , V_19 ) ;
for ( V_63 = 0 ; V_63 < V_91 ; V_63 ++ ) {
struct V_56 * V_125 = V_19 -> V_92 + V_63 ;
V_125 -> V_57 = V_19 ;
V_125 -> V_65 = V_63 ;
if ( V_89 -> V_92 . V_92 [ V_63 ] . V_93 && ! V_89 -> V_92 . V_92 [ V_63 ] . V_75 ) {
V_125 -> V_62 . V_93 = V_89 -> V_92 . V_92 [ V_63 ] . V_93 ;
V_125 -> V_62 . V_115
= V_89 -> V_92 . V_92 [ V_63 ] . V_115 ;
V_125 -> V_62 . V_126 = F_20 ;
V_125 -> V_62 . V_127 = F_21 ;
V_125 -> V_28 = - 1 ;
V_74 = F_44 ( & V_37 -> V_38 ,
& V_125 -> V_62 ) ;
if ( V_74 < 0 )
...
F_45 ( & V_19 -> V_92 [ V_63 ] . V_62 ) ;
}
return V_74 ;
}
static int F_46 ( struct V_49 * V_37 )
{
int V_63 ;
struct V_18 * V_19 = F_47 ( V_37 ) ;
struct V_56 * V_109 = V_19 -> V_92 ;
for ( V_63 = 0 ; V_63 < V_91 ; V_63 ++ ) {
if ( V_109 [ V_63 ] . V_62 . V_93 )
F_45 ( & V_109 [ V_63 ] . V_62 ) ;
}
F_26 ( V_19 ) ;
F_48 ( & V_19 -> V_48 ) ;
return 0 ;
