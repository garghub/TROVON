...
error = F_75 ( V_49 , & V_81 , V_71 -> V_170 [ 0 ] ) ;
if ( error < 0 )
goto error;
if ( V_71 -> V_171 . V_30 ) {
...
V_183 = F_80 ( F_82 ( V_49 -> V_141 ) , NULL ) ;
if ( V_49 -> V_163 > V_183 )
V_49 -> V_163 = V_183 ;
if ( V_49 -> V_163 > V_188 )
V_49 -> V_163 = V_188 ;
V_49 -> V_189 = ( V_49 -> V_163 + V_190 - 1 ) >> V_191 ;
V_49 -> V_192 . V_193 = L_19 ;
...
V_49 -> V_197 = F_83 ( V_182 -> V_197 , NULL ) ;
V_49 -> V_198 = F_80 ( V_182 -> V_199 , NULL ) ;
if ( V_49 -> V_198 > V_190 * V_200 )
V_49 -> V_198 = V_190 * V_200 ;
if ( V_49 -> V_198 > V_49 -> V_163 )
V_49 -> V_198 = V_49 -> V_163 ;
if ( V_49 -> V_123 & V_201 ) {
V_49 -> V_165 = V_49 -> V_166 = 0 ;
V_49 -> V_167 = V_49 -> V_168 = 0 ;
}
V_49 -> V_202 = V_182 -> V_202 ;
V_49 -> V_203 = V_182 -> V_203 ;
F_84 ( V_49 -> V_141 , V_49 -> V_164 + 100 , V_49 -> V_163 + 100 ) ;
}
int F_85 ( struct V_48 * V_49 , struct V_179 * V_180 , struct V_204 * V_205 )
{
struct V_181 V_182 ;
struct V_13 * V_16 = V_49 -> V_13 ;
int error ;
F_35 ( L_20 ) ;
if ( V_16 -> V_5 -> V_206 != NULL ) {
error = V_16 -> V_5 -> V_206 ( V_49 , V_180 ) ;
if ( error < 0 )
goto V_207;
}
V_182 . V_205 = V_205 ;
...
V_210 . V_205 = V_205 ;
F_86 ( V_205 ) ;
if ( V_16 -> V_5 -> V_211 ( V_49 , V_180 , & V_210 ) >= 0 )
V_49 -> V_177 = V_210 . V_212 ;
}
F_35 ( L_21 ) ;
return 0 ;
V_207:
...
void F_87 ( struct V_48 * V_213 , struct V_48 * V_214 )
{
V_213 -> V_123 = V_214 -> V_123 ;
V_213 -> V_163 = V_214 -> V_163 ;
V_213 -> V_164 = V_214 -> V_164 ;
V_213 -> V_165 = V_214 -> V_165 ;
V_213 -> V_166 = V_214 -> V_166 ;
V_213 -> V_167 = V_214 -> V_167 ;
V_213 -> V_168 = V_214 -> V_168 ;
V_213 -> V_151 = V_214 -> V_151 ;
V_213 -> V_148 = V_214 -> V_148 ;
}
...
struct V_43 * V_44 = F_28 ( V_16 -> V_40 , V_45 ) ;
F_2 ( & V_44 -> V_51 ) ;
F_89 ( & V_49 -> V_215 , & V_16 -> V_35 ) ;
F_61 ( & V_49 -> V_216 , & V_44 -> V_217 ) ;
F_90 ( V_218 , & V_16 -> V_219 ) ;
F_4 ( & V_44 -> V_51 ) ;
}
...
if ( ! V_49 )
return NULL ;
V_49 -> V_141 = V_49 -> V_220 = F_5 ( - V_37 ) ;
F_22 ( & V_49 -> V_215 ) ;
F_22 ( & V_49 -> V_216 ) ;
F_22 ( & V_49 -> V_221 ) ;
F_22 ( & V_49 -> V_222 ) ;
...
struct V_48 * F_103 ( struct V_228 * V_229 ,
struct V_1 * V_24 )
{
struct V_48 * V_49 ;
struct V_204 * V_205 ;
...
if ( V_205 == NULL )
goto error;
error = F_78 ( V_49 , V_229 -> V_230 , V_24 ) ;
if ( error < 0 )
goto error;
error = F_85 ( V_49 , V_229 -> V_180 , V_205 ) ;
if ( error < 0 )
goto error;
if ( V_49 -> V_13 -> V_5 -> V_2 == 3 ) {
if ( V_49 -> V_177 == 0 || V_49 -> V_177 > V_231 )
V_49 -> V_177 = V_231 ;
if ( ! ( V_229 -> V_230 -> V_123 & V_232 ) )
V_49 -> V_151 |= V_233 ;
} else {
if ( V_49 -> V_177 == 0 || V_49 -> V_177 > V_234 )
V_49 -> V_177 = V_234 ;
}
if ( ! ( V_205 -> V_235 & V_236 ) ) {
error = V_24 -> V_5 -> V_237 ( V_49 , V_229 -> V_180 , V_205 ) ;
if ( error < 0 ) {
F_35 ( L_25 , - error ) ;
goto error;
}
}
memcpy ( & V_49 -> V_238 , & V_205 -> V_238 , sizeof( V_49 -> V_238 ) ) ;
F_35 ( L_26 ,
( unsigned long long ) V_49 -> V_238 . V_239 ,
( unsigned long long ) V_49 -> V_238 . V_240 ) ;
F_88 ( V_49 ) ;
V_49 -> V_241 = V_242 ;
F_105 ( V_205 ) ;
return V_49 ;
...
struct V_48 * F_106 ( struct V_48 * V_214 ,
struct V_179 * V_243 ,
struct V_204 * V_205 ,
T_1 V_110 )
{
...
int error ;
F_35 ( L_27 ,
( unsigned long long ) V_205 -> V_238 . V_239 ,
( unsigned long long ) V_205 -> V_238 . V_240 ) ;
V_49 = F_94 () ;
if ( ! V_49 )
return F_5 ( - V_20 ) ;
error = - V_20 ;
...
if ( V_244 == NULL )
goto V_245;
V_49 -> V_13 = V_214 -> V_13 ;
V_49 -> V_139 = V_214 -> V_139 ;
F_54 ( & V_49 -> V_13 -> V_25 ) ;
F_87 ( V_49 , V_214 ) ;
V_49 -> V_238 = V_205 -> V_238 ;
error = F_75 ( V_49 ,
V_214 -> V_141 -> V_143 ,
V_110 ) ;
if ( error < 0 )
goto V_245;
error = F_85 ( V_49 , V_243 , V_244 ) ;
if ( error < 0 )
goto V_245;
if ( V_49 -> V_177 == 0 || V_49 -> V_177 > V_246 )
V_49 -> V_177 = V_246 ;
F_35 ( L_28 ,
( unsigned long long ) V_49 -> V_238 . V_239 ,
( unsigned long long ) V_49 -> V_238 . V_240 ) ;
...
static int F_111 ( struct V_250 * V_250 , struct V_251 * V_251 )
{
struct V_252 * V_253 ;
int V_254 ;
struct V_255 * V_256 = V_251 -> V_257 -> V_258 -> V_259 ;
struct V_41 * V_41 = V_256 -> V_260 -> V_261 -> V_262 ;
V_254 = F_112 ( V_251 , & V_263 ) ;
if ( V_254 < 0 )
return V_254 ;
V_253 = V_251 -> V_264 ;
V_253 -> V_265 = V_41 ;
...
static void * F_113 ( struct V_252 * V_253 , T_2 * V_266 )
{
struct V_43 * V_44 = F_28 ( V_253 -> V_265 , V_45 ) ;
F_2 ( & V_44 -> V_51 ) ;
return F_114 ( & V_44 -> V_86 , * V_266 ) ;
}
static void * F_115 ( struct V_252 * V_267 , void * V_268 , T_2 * V_269 )
{
struct V_43 * V_44 = F_28 ( V_267 -> V_265 , V_45 ) ;
return F_116 ( V_268 , & V_44 -> V_86 , V_269 ) ;
}
static void F_117 ( struct V_252 * V_267 , void * V_268 )
{
struct V_43 * V_44 = F_28 ( V_267 -> V_265 , V_45 ) ;
F_4 ( & V_44 -> V_51 ) ;
}
static int F_118 ( struct V_252 * V_253 , void * V_268 )
{
struct V_13 * V_16 ;
struct V_43 * V_44 = F_28 ( V_253 -> V_265 , V_45 ) ;
if ( V_268 == & V_44 -> V_86 ) {
...
V_16 = F_120 ( V_268 , struct V_13 , V_52 ) ;
if ( V_16 -> V_26 != V_78 )
return 0 ;
F_121 () ;
F_122 ( V_253 , L_32 ,
V_16 -> V_5 -> V_2 ,
F_123 ( V_16 -> V_36 , V_270 ) ,
...
static int F_125 ( struct V_250 * V_250 , struct V_251 * V_251 )
{
struct V_252 * V_253 ;
int V_254 ;
struct V_255 * V_256 = V_251 -> V_257 -> V_258 -> V_259 ;
struct V_41 * V_41 = V_256 -> V_260 -> V_261 -> V_262 ;
V_254 = F_112 ( V_251 , & V_272 ) ;
if ( V_254 < 0 )
return V_254 ;
V_253 = V_251 -> V_264 ;
V_253 -> V_265 = V_41 ;
...
static void * F_126 ( struct V_252 * V_253 , T_2 * V_266 )
{
struct V_43 * V_44 = F_28 ( V_253 -> V_265 , V_45 ) ;
F_2 ( & V_44 -> V_51 ) ;
return F_114 ( & V_44 -> V_217 , * V_266 ) ;
}
static void * F_127 ( struct V_252 * V_267 , void * V_268 , T_2 * V_269 )
{
struct V_43 * V_44 = F_28 ( V_267 -> V_265 , V_45 ) ;
return F_116 ( V_268 , & V_44 -> V_217 , V_269 ) ;
}
static void F_128 ( struct V_252 * V_267 , void * V_268 )
{
struct V_43 * V_44 = F_28 ( V_267 -> V_265 , V_45 ) ;
F_4 ( & V_44 -> V_51 ) ;
}
static int F_129 ( struct V_252 * V_253 , void * V_268 )
{
struct V_48 * V_49 ;
struct V_13 * V_16 ;
char V_273 [ 8 ] , V_238 [ 17 ] ;
struct V_43 * V_44 = F_28 ( V_253 -> V_265 , V_45 ) ;
if ( V_268 == & V_44 -> V_217 ) {
F_119 ( V_253 , L_33 ) ;
return 0 ;
}
V_49 = F_120 ( V_268 , struct V_48 , V_216 ) ;
V_16 = V_49 -> V_13 ;
snprintf ( V_273 , 8 , L_34 ,
F_130 ( V_49 -> V_274 ) , F_131 ( V_49 -> V_274 ) ) ;
snprintf ( V_238 , 17 , L_35 ,
( unsigned long long ) V_49 -> V_238 . V_239 ,
( unsigned long long ) V_49 -> V_238 . V_240 ) ;
F_121 () ;
F_122 ( V_253 , L_36 ,
...
{
struct V_275 * V_267 ;
V_276 = F_134 ( L_37 , NULL ) ;
if ( ! V_276 )
goto V_22;
V_267 = F_135 ( L_38 , V_277 | V_278 ,
V_276 , & V_279 ) ;
if ( ! V_267 )
goto V_280;
V_267 = F_135 ( L_39 , V_277 | V_278 ,
V_276 , & V_281 ) ;
if ( ! V_267 )
goto V_282;
return 0 ;
