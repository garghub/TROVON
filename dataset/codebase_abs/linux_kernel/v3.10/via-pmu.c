...
{
F_41 ( V_124 , L_41 , V_36 ) ;
F_41 ( V_124 , L_42 , V_38 ) ;
F_41 ( V_124 , L_43 ,
...
if ( ! V_3 )
return;
while( ( V_33 != V_34 && V_33 != V_186 ) || ! V_82 -> V_44 )
V_46 ( 0 , NULL ) ;
}
void
F_69 ( void )
...
if ( V_146 > V_136 )
V_146 = V_136 ;
if ( V_146 > 0 && F_129 ( V_298 , V_291 -> V_148 , V_146 ) )
V_146 = - V_143 ;
if ( ++ V_70 >= V_288 )
V_70 = 0 ;
F_60 ( & V_281 -> V_286 , V_63 ) ;
...
V_253 -> V_301 = V_306 ;
F_132 ( & V_281 -> V_292 , & V_292 ) ;
F_62 ( & V_281 -> V_286 , V_63 ) ;
return V_146 ;
}
static T_4
F_133 ( struct V_127 * V_127 , const char T_5 * V_298 ,
T_6 V_136 , T_7 * V_299 )
{
return 0 ;
}
static unsigned int
F_134 ( struct V_127 * V_307 , T_11 * V_292 )
{
...
static int
F_136 ( struct V_126 * V_126 , struct V_127 * V_127 )
{
struct V_280 * V_281 = V_127 -> V_297 ;
unsigned long V_63 ;
if ( V_281 != 0 ) {
...
static int F_154 ( struct V_127 * V_307 ,
...
case V_321 :
if ( F_25 ( V_133 , NULL , 0 , - 1 ) < 0 )
return F_157 ( 0 , V_317 ) ;
else
return F_157 ( 1 , V_317 ) ;
#ifdef F_158
case V_322 :
{
int V_323 ;
...
return F_157 ( V_323 , V_317 ) ;
}
case V_324 :
{
int V_323 ;
error = F_160 ( V_323 , V_317 ) ;
if ( error )
return error ;
return F_161 ( V_323 ) ;
}
...
#endif
case V_326 :
return F_157 ( V_17 , V_317 ) ;
case V_327 :
return F_157 ( V_9 , V_317 ) ;
}
return error ;
}
static long F_163 ( struct V_127 * V_307 ,
T_13 V_316 , T_14 V_211 )
{
int V_146 ;
F_122 ( & V_294 ) ;
V_146 = F_154 ( V_307 , V_316 , V_211 ) ;
F_124 ( & V_294 ) ;
return V_146 ;
}
static long F_164 ( struct V_127 * V_307 , T_13 V_316 , T_14 V_211 )
{
switch ( V_316 ) {
case V_318 :
break;
...
return F_163 ( V_307 , V_316 , ( unsigned long ) F_165 ( V_211 ) ) ;
}
...
static inline void
F_168 ( volatile unsigned char T_9 * V_3 )
{
V_3 [ V_83 ] &= ~ V_84 ; F_169 () ;
...
static inline void
F_170 ( volatile unsigned char T_9 * V_3 , int V_175 )
{
V_3 [ V_176 ] |= V_177 | V_178 ; F_169 () ;
V_3 [ V_179 ] = V_175 ; F_169 () ;
F_168 ( V_3 ) ;
}
static inline int
F_171 ( volatile unsigned char T_9 * V_3 )
{
int V_175 ;
V_3 [ V_176 ] = ( V_3 [ V_176 ] & ~ V_177 ) | V_178 ; F_169 () ;
V_175 = V_3 [ V_179 ] ; F_169 () ;
F_168 ( V_3 ) ;
V_175 = V_3 [ V_179 ] ; F_169 () ;
return V_175 ;
}
int
F_172 ( struct V_81 * V_82 )
{
unsigned long V_63 ;
...
F_170 ( V_125 , V_82 -> V_148 [ V_70 ] ) ;
V_336 = V_151 [ V_337 ] [ 1 ] ;
if ( V_336 < 0 )
V_336 = F_171 ( V_125 ) ;
for ( V_70 = 0 ; V_70 < V_336 ; ++ V_70 )
V_82 -> V_93 [ V_70 + V_82 -> V_92 ] = F_171 ( V_125 ) ;
if ( V_82 -> V_166 )
(* V_82 -> V_166 )( V_82 ) ;
F_174 ( V_63 ) ;
return 0 ;
}
void F_175 ( int V_338 )
{
struct V_81 V_82 ;
