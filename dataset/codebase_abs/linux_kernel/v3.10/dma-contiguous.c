...
int T_1 F_13 ( struct V_32 * V_31 , T_2 V_30 ,
T_2 V_33 , T_2 V_9 )
{
...
V_26 -> V_31 = V_31 ;
V_27 ++ ;
F_31 ( L_7 , ( unsigned long ) V_30 / V_15 ,
( unsigned long ) V_33 ) ;
F_32 ( V_33 , V_30 ) ;
return 0 ;
V_39:
F_26 ( L_8 , ( unsigned long ) V_30 / V_15 ) ;
return V_33 ;
}
struct V_42 * F_33 ( struct V_32 * V_31 , int V_17 ,
unsigned int V_43 )
{
unsigned long V_44 , V_18 , V_45 , V_29 = 0 ;
struct V_28 * V_28 = F_34 ( V_31 ) ;
...
F_35 ( & V_48 ) ;
for (; ; ) {
V_45 = F_36 ( V_28 -> V_49 , V_28 -> V_17 ,
V_29 , V_17 , V_44 ) ;
if ( V_45 >= V_28 -> V_17 )
break;
V_18 = V_28 -> V_16 + V_45 ;
V_46 = F_37 ( V_18 , V_18 + V_17 , V_50 ) ;
if ( V_46 == 0 ) {
F_38 ( V_28 -> V_49 , V_45 , V_17 ) ;
V_42 = F_18 ( V_18 ) ;
break;
} else if ( V_46 != - V_38 ) {
break;
...
bool F_40 ( struct V_32 * V_31 , struct V_42 * V_51 ,
int V_17 )
{
struct V_28 * V_28 = F_34 ( V_31 ) ;
unsigned long V_18 ;
...
return false ;
F_42 ( V_18 + V_17 > V_28 -> V_16 + V_28 -> V_17 ) ;
F_35 ( & V_48 ) ;
F_43 ( V_28 -> V_49 , V_18 - V_28 -> V_16 , V_17 ) ;
F_44 ( V_18 , V_17 ) ;
F_39 ( & V_48 ) ;
return true ;
}
