...
static int F_25 ( struct V_83 * V_84 )
{
struct V_85 * V_27 ;
struct V_1 * V_2 ;
void T_3 * V_10 ;
...
V_2 -> V_96 = F_30 ( V_84 -> V_28 . V_87 , 1 ) ;
V_2 -> V_50 = F_6 ;
...
F_39 ( & V_2 -> V_29 ) ;
F_40 ( & V_2 -> V_72 , F_18 ) ;
if ( V_2 -> V_53 && V_2 -> V_96 ) {
V_70 = F_41 ( V_2 -> V_53 , F_15 , 0 ,
L_10 , V_2 ) ;
V_70 |= F_41 ( V_2 -> V_96 , F_15 , 0 ,
L_11 , V_2 ) ;
if ( V_70 ) {
F_42 ( V_2 -> V_53 , V_2 ) ;
F_42 ( V_2 -> V_96 , V_2 ) ;
...
{
struct V_85 * V_27 = F_50 ( F_51 ( & V_84 -> V_28 ) ) ;
