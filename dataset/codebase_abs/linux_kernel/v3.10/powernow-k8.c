...
F_9 ( L_95 ,
F_14 () , V_3 , V_19 ) ;
V_139 . V_140 = F_4 ( V_10 -> V_14 ) ;
V_139 . V_141 = F_4 ( V_3 ) ;
V_136 = F_48 ( F_14 () ) ;
F_49 ( V_136 ) ;
F_50 ( V_136 , & V_139 , V_142 ) ;
V_137 = F_20 ( V_10 , V_3 , V_19 ) ;
if ( V_137 )
return V_137 ;
V_139 . V_141 = F_4 ( V_10 -> V_14 ) ;
F_50 ( V_136 , & V_139 , V_143 ) ;
return V_137 ;
}
static long F_51 ( void * V_144 )
{
struct V_145 * V_146 = V_144 ;
struct V_135 * V_147 = V_146 -> V_147 ;
unsigned V_148 = V_146 -> V_148 ;
unsigned V_149 = V_146 -> V_149 ;
struct V_9 * V_10 = F_52 ( V_150 , V_147 -> V_2 ) ;
T_1 V_151 ;
T_1 V_152 ;
unsigned int V_153 ;
int V_154 ;
...
F_9 ( L_97 ,
V_147 -> V_2 , V_148 , V_147 -> V_155 , V_147 -> V_156 , V_149 ) ;
if ( F_8 ( V_10 ) )
return - V_80 ;
F_9 ( L_98 ,
V_10 -> V_14 , V_10 -> V_12 ) ;
...
if ( F_54 ( V_147 , V_10 -> V_70 ,
V_148 , V_149 , & V_153 ) )
return - V_80 ;
F_55 ( & V_158 ) ;
F_36 ( V_10 , V_153 ) ;
V_154 = F_47 ( V_10 , V_153 ) ;
if ( V_154 ) {
...
F_56 ( & V_158 ) ;
V_147 -> V_159 = F_4 ( V_10 -> V_14 ) ;
return 0 ;
}
static int F_57 ( struct V_135 * V_147 ,
unsigned V_148 , unsigned V_149 )
{
struct V_145 V_146 = { . V_147 = V_147 , . V_148 = V_148 ,
. V_149 = V_149 } ;
return F_58 ( V_147 -> V_2 , F_51 , & V_146 ) ;
}
static int F_59 ( struct V_135 * V_147 )
{
struct V_9 * V_10 = F_52 ( V_150 , V_147 -> V_2 ) ;
if ( ! V_10 )
return - V_67 ;
return F_60 ( V_147 , V_10 -> V_70 ) ;
}
static void T_4 F_61 ( void * V_160 )
{
struct V_161 * V_161 = V_160 ;
if ( F_6 () ) {
...
static int T_4 F_62 ( struct V_135 * V_147 )
{
struct V_9 * V_10 ;
struct V_161 V_161 ;
int V_50 ;
F_63 ( V_147 -> V_2 , F_24 , & V_50 , 1 ) ;
if ( V_50 )
return - V_51 ;
...
if ( V_50 != 0 )
goto V_164;
F_67 ( V_147 -> V_165 , F_1 ( V_147 -> V_2 ) ) ;
V_10 -> V_166 = V_147 -> V_165 ;
V_147 -> V_159 = F_4 ( V_10 -> V_14 ) ;
F_9 ( L_106 , V_147 -> V_159 ) ;
if ( F_68 ( V_147 , V_10 -> V_70 ) ) {
...
F_69 ( V_10 -> V_70 , V_147 -> V_2 ) ;
F_9 ( L_108 ,
V_10 -> V_14 , V_10 -> V_12 ) ;
F_52 ( V_150 , V_147 -> V_2 ) = V_10 ;
return 0 ;
V_164:
F_43 ( V_10 ) ;
V_114:
...
static int F_70 ( struct V_135 * V_147 )
{
struct V_9 * V_10 = F_52 ( V_150 , V_147 -> V_2 ) ;
if ( ! V_10 )
return - V_67 ;
...
F_32 ( V_10 -> V_70 ) ;
F_32 ( V_10 ) ;
F_52 ( V_150 , V_147 -> V_2 ) = NULL ;
return 0 ;
}
static void F_72 ( void * V_167 )
{
int * V_168 = V_167 ;
struct V_9 * V_10 = F_73 ( V_150 ) ;
* V_168 = F_8 ( V_10 ) ;
}
static unsigned int F_74 ( unsigned int V_2 )
{
struct V_9 * V_10 = F_52 ( V_150 , V_2 ) ;
unsigned int V_169 = 0 ;
int V_168 ;
if ( ! V_10 )
return 0 ;
F_63 ( V_2 , F_72 , & V_168 , true ) ;
if ( V_168 )
goto V_170;
V_169 = F_4 ( V_10 -> V_14 ) ;
V_170:
...
{
const char * V_171 , * V_172 = L_109 ;
V_171 = F_76 () ;
if ( ! V_171 )
goto V_173;
if ( strncmp ( V_171 , V_172 , F_77 ( V_174 , strlen ( V_171 ) , strlen ( V_172 ) ) ) )
F_78 ( V_157 L_110 , V_171 ) ;
return;
V_173:
F_78 ( V_157 L_111 ) ;
F_79 ( V_172 ) ;
...
if ( V_154 )
return V_154 ;
F_53 ( V_157 L_112 V_179 L_113 ,
F_87 () , V_180 . V_181 , V_175 ) ;
return V_154 ;
}
