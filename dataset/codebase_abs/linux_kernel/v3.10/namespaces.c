...
const struct V_6 * V_7 = F_3 ( V_4 ) -> V_8 . V_7 ;
return F_4 ( V_1 , V_2 , V_3 , L_1 ,
V_7 -> V_9 , V_4 -> V_10 ) ;
}
static struct V_1 * F_5 ( struct V_11 * V_12 ,
...
if ( ! F_15 ( V_14 , V_46 ) )
goto V_47;
V_43 . V_1 = F_5 ( V_12 , V_14 , V_17 -> V_8 . V_7 ) ;
if ( F_16 ( V_43 . V_1 ) ) {
error = F_17 ( V_43 . V_1 ) ;
goto V_47;
}
...
T_2 V_60 , struct V_13 * V_14 ,
const struct V_6 * V_61 )
{
return F_28 ( V_58 , V_59 , V_60 ,
V_61 -> V_9 , strlen ( V_61 -> V_9 ) ,
F_23 , V_14 , V_61 ) ;
}
...
if ( strlen ( ( * V_64 ) -> V_9 ) != V_49 )
continue;
if ( ! memcmp ( V_1 -> V_73 . V_9 , ( * V_64 ) -> V_9 , V_49 ) )
break;
}
if ( V_64 == V_65 )
goto V_45;
error = F_23 ( V_51 , V_1 , V_14 , * V_64 ) ;
V_45:
F_20 ( V_14 ) ;
V_68:
return error ;
...
struct V_79 * F_36 ( struct V_4 * V_4 )
{
return & F_3 ( V_4 ) -> V_8 ;
}
bool F_37 ( struct V_4 * V_4 )
{
