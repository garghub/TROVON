...
static int F_61 ( struct V_27 * V_28 , int V_62 , int V_63 )
{
struct V_5 * V_2 ;
struct V_37 * V_38 ;
int V_64 ;
...
V_38 = F_64 ( V_28 , V_65 ) ;
F_48 ( L_42 , V_65 , V_38 ) ;
for ( V_64 = V_65 , V_2 = F_65 ( V_28 , V_65 ) , V_38 ++ ; V_64 < V_66 ;
V_64 ++ , V_2 ++ , V_38 ++ ) {
...
static int F_66 ( struct V_27 * V_28 , int V_67 , int V_62 ,
int V_63 )
{
struct V_68 * V_69 ;
struct V_16 * V_17 ;
...
if ( F_66 ( V_28 , V_85 , V_62 , V_63 ) )
if ( F_61 ( V_28 , V_62 , V_63 ) )
if ( F_75 ( V_28 ) )
if ( F_92 ( V_28 ) )
F_46
( L_74 ,
...
V_28 ) ;
if ( F_108 ( V_69 ) > V_28 -> V_32 - V_121 - V_122 * V_70 )
...
return;
F_106 ( V_28 ) ;
for ( V_64 = 0 , V_17 = F_70 ( V_28 , 0 ) ; V_64 < F_29 ( V_28 ) ; V_64 ++ , V_17 ++ )
