...
int T_6 F_34 ( unsigned long V_13 , unsigned long V_16 , int V_39 )
{
unsigned long V_8 = V_13 ;
T_5 * V_17 ;
T_2 * V_18 ;
...
int V_56 ;
V_54 = F_51 ( ( unsigned long ) & V_57 ) ;
V_55 = ( unsigned long ) & V_58 & V_59 ;
for ( V_56 = 0 ; V_56 < V_60 ; V_56 ++ ) {
if ( ! V_61 [ V_56 ] . V_14 )
continue;
V_13 = V_61 [ V_56 ] . V_62 ;
V_16 = V_61 [ V_56 ] . V_62 + V_61 [ V_56 ] . V_14 ;
if ( V_13 >= V_55 || V_16 <= V_54 )
F_12 ( V_13 , V_16 - V_13 , 0 ) ;
else if ( V_13 >= V_54 && V_16 <= V_55 )
F_12 ( V_13 , V_16 - V_13 , 1 ) ;
else if ( V_13 >= V_54 ) {
F_12 ( V_13 , V_55 - V_13 , 1 ) ;
F_12 ( V_55 , V_16 - V_55 , 0 ) ;
} else if ( V_16 < V_55 ) {
F_12 ( V_13 , V_54 - V_13 , 0 ) ;
F_12 ( V_54 , V_16 - V_54 , 1 ) ;
} else {
F_12 ( V_13 , V_54 - V_13 , 0 ) ;
F_12 ( V_54 , V_55 - V_54 , 1 ) ;
F_12 ( V_55 , V_16 - V_55 , 0 ) ;
}
}
}
...
if ( ! V_43 )
F_53 ( L_1 ) ;
V_43 -> V_13 = V_61 [ V_56 ] . V_62 ;
V_43 -> V_14 = V_61 [ V_56 ] . V_14 ;
F_38 ( V_43 ) ;
}
F_47 ( & V_50 ) ;
return 0 ;
