...
struct V_2 * F_67 ( struct V_147 * V_9 , void * V_148 )
{
int V_4 ;
struct V_2 * V_3 =
...
F_66 ( V_3 , F_5 ( V_3 -> V_115 + V_160 ) + 4 ) ;
if ( ! V_3 -> V_44 ) {
F_69 ( V_3 ) ;
return NULL ;
}
V_149 = F_68 ( F_5 ( V_4 + V_161 ) ) ;
while ( * V_149 && ( ( * V_149 == '\n' ) || ( * V_149 == '\r' ) ) )
V_149 ++ ;
...
int V_130 ;
memset ( V_47 , 0 , 64 ) ;
V_47 [ 0 ] = F_19 ( F_71 ( V_162 + V_164 ) ) ;
V_47 [ 1 ] = F_19 ( F_71 ( V_162 + V_165 ) ) ;
if ( ! V_47 [ 0 ] || ! V_47 [ 1 ] )
return 1 ;
if ( ! F_5 ( V_3 -> V_93 + 4 + 2 * V_166 ) )
return 1 ;
V_130 = F_63 ( V_3 , V_166 , V_47 ) ;
if ( V_130 )
return V_130 ;
memset ( V_47 , 0 , 64 ) ;
if ( V_8 -> V_17 < V_167 ) {
if ( F_5 ( V_3 -> V_93 + 4 + 2 * V_168 ) )
F_63 ( V_3 , V_168 , V_47 ) ;
}
return V_130 ;
}
...
{
int V_173 = V_5 * 2 + 4 ;
int V_32 = F_5 ( V_3 -> V_115 + V_173 ) ;
T_5 * V_174 = ( T_5 * ) ( V_3 -> V_148 + V_3 -> V_115 + 4 ) ;
if ( ! V_174 [ V_5 ] )
return false ;
if ( V_169 )
* V_169 = F_5 ( V_32 ) ;
...
bool F_73 ( struct V_2 * V_3 , int V_5 , T_3 * V_170 ,
T_3 * V_171 )
{
int V_173 = V_5 * 2 + 4 ;
int V_32 = F_5 ( V_3 -> V_93 + V_173 ) ;
T_5 * V_175 = ( T_5 * ) ( V_3 -> V_148 + V_3 -> V_93 + 4 ) ;
if ( ! V_175 [ V_5 ] )
return false ;
if ( V_170 )
* V_170 = F_4 ( V_32 + 2 ) ;
...
{
int V_5 = F_75 ( V_176 , V_177 ) ;
T_4 V_178 ;
int V_179 = 0 ;
struct V_180 * V_181 ;
if ( F_72 ( V_3 , V_5 , NULL , NULL , NULL , & V_178 ) ) {
V_181 = (struct V_180 * ) ( V_3 -> V_148 + V_178 ) ;
F_76 ( L_79 ,
F_77 ( V_181 -> V_182 [ 0 ] . V_183 ) ,
F_78 ( V_181 -> V_182 [ 0 ] . V_184 ) ) ;
V_179 = F_78 ( V_181 -> V_182 [ 0 ] . V_184 ) * 1024 ;
}
V_3 -> V_65 = 0 ;
if ( V_179 == 0 )
V_179 = 20 * 1024 ;
V_3 -> V_66 = F_60 ( V_179 , V_137 ) ;
if ( ! V_3 -> V_66 )
return - V_185 ;
V_3 -> V_65 = V_179 ;
return 0 ;
