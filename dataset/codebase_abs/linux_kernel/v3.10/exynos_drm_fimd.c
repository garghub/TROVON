...
F_6 ( L_1 , __FILE__ ) ;
if ( V_7 -> V_155 ) {
V_151 = F_94 ( V_7 , sizeof( * V_151 ) , V_156 ) ;
if ( ! V_151 ) {
F_95 ( L_16 ) ;
return - V_157 ;
}
V_148 = F_96 ( V_7 -> V_155 , & V_151 -> V_13 . V_14 ,
V_158 ) ;
if ( V_148 ) {
F_95 ( L_17 , V_148 ) ;
return V_148 ;
...
V_12 = F_94 ( V_7 , sizeof( * V_12 ) , V_156 ) ;
if ( ! V_12 )
return - V_157 ;
V_12 -> V_149 = F_97 ( V_7 , L_20 ) ;
if ( F_98 ( V_12 -> V_149 ) ) {
F_41 ( V_7 , L_21 ) ;
return F_99 ( V_12 -> V_149 ) ;
}
V_12 -> V_141 = F_97 ( V_7 , L_22 ) ;
if ( F_98 ( V_12 -> V_141 ) ) {
F_41 ( V_7 , L_23 ) ;
return F_99 ( V_12 -> V_141 ) ;
}
V_153 = F_100 ( V_3 , V_160 , 0 ) ;
V_12 -> V_43 = F_101 ( V_7 , V_153 ) ;
if ( F_98 ( V_12 -> V_43 ) )
return F_99 ( V_12 -> V_43 ) ;
V_153 = F_102 ( V_3 , V_161 , L_24 ) ;
if ( ! V_153 ) {
F_41 ( V_7 , L_25 ) ;
return - V_162 ;
}
V_12 -> V_128 = V_153 -> V_163 ;
V_148 = F_103 ( V_7 , V_12 -> V_128 , F_75 ,
0 , L_26 , V_12 ) ;
if ( V_148 ) {
F_41 ( V_7 , L_25 ) ;
return V_148 ;
...
V_13 -> V_14 . V_166 = F_85 ( V_12 -> V_141 ) / V_12 -> V_60 ;
F_6 ( L_27 ,
V_13 -> V_14 . V_166 , V_12 -> V_60 ) ;
