...
F_56 ( V_6 -> V_2 [ V_11 ] -> V_14 ) ;
F_9 ( V_6 -> V_2 [ V_11 ] ) ;
}
V_112:
return V_19 ;
}
static int F_57 ( struct V_5 * V_6 , struct V_3 * V_3 )
{
int V_19 ;
struct V_23 * V_24 = & V_6 -> V_16 -> V_25 -> V_24 ;
enum V_61 V_87 = 0 ;
...
static int F_59 ( struct V_45 * V_46 , struct V_5 * V_6 ,
struct V_1 * V_2 )
{
int V_19 ;
...
while ( F_61 ( & V_46 -> V_126 ) > 0
&& ! F_62 ( & V_46 -> V_127 ) ) {
V_2 = F_63 ( V_46 -> V_127 . V_128 , struct V_1 ,
V_8 ) ;
F_64 ( & V_2 -> V_8 ) ;
V_6 = V_2 -> V_6 ;
V_19 = F_59 ( V_46 , V_6 , V_2 ) ;
F_24 ( V_24 , L_21 ,
V_6 , V_2 -> V_35 , F_61 ( & V_46 -> V_126 ) , V_19 ) ;
if ( F_65 ( V_19 < 0 ) ) {
...
T_4 V_132 ;
F_15 ( & V_16 -> V_17 , V_15 ) ;
F_67 ( & V_6 -> V_8 , & V_16 -> V_133 ) ;
F_17 ( & V_16 -> V_17 , V_15 ) ;
F_68 ( F_61 ( & V_46 -> V_126 ) > V_129 ) ;
V_19 = 0 ;
F_15 ( & V_46 -> V_125 , V_15 ) ;
for ( V_11 = 0 ; V_11 < V_6 -> V_12 ; V_11 ++ ) {
V_131 = F_61 ( & V_46 -> V_126 ) ;
V_132 = F_62 ( & V_46 -> V_127 ) ;
V_2 = V_6 -> V_2 [ V_11 ] ;
F_24 ( V_24 , L_22 ,
...
struct V_20 * V_20 ;
unsigned V_98 ;
V_19 = F_70 ( V_16 , V_6 -> V_21 , V_3 , V_6 -> V_136 ) ;
if ( V_19 < 0 )
goto V_137;
V_19 = - V_138 ;
F_71 ( & V_135 -> V_139 ) ;
...
struct V_3 * V_3 ;
F_75 ( & V_16 -> V_17 ) ;
F_76 (xfer, next, &wa->xfer_delayed_list,
list_node) {
F_16 ( & V_6 -> V_8 ) ;
F_77 ( & V_16 -> V_17 ) ;
V_3 = V_6 -> V_3 ;
...
int F_78 ( struct V_40 * V_16 , struct V_148 * V_21 ,
...
F_67 ( & V_6 -> V_8 , & V_16 -> V_151 ) ;
F_17 ( & V_16 -> V_17 , V_149 ) ;
F_84 ( V_152 , & V_16 -> V_147 ) ;
} else {
F_69 ( V_6 ) ;
}
return 0 ;
...
int F_85 ( struct V_40 * V_16 , struct V_3 * V_3 )
{
...
static void F_90 ( struct V_40 * V_16 , struct V_5 * V_6 )
{
int V_19 ;
struct V_23 * V_24 = & V_16 -> V_25 -> V_24 ;
unsigned long V_15 ;
...
void F_94 ( struct V_40 * V_16 , struct V_196 * V_197 )
{
int V_19 ;
struct V_23 * V_24 = & V_16 -> V_25 -> V_24 ;
struct V_198 * V_199 ;
...
F_95 ( V_16 -> V_57 , 0x80 | V_199 -> V_202 ) ,
