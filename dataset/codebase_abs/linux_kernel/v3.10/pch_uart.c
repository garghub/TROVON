...
static int F_114 ( struct V_85 * V_14 )
{
struct V_5 * V_6 =
F_38 ( V_14 , struct V_5 , V_14 ) ;
T_6 V_84 = F_3 ( V_6 -> V_15 + V_20 ) ;
if ( ! ( V_84 & V_86 ) )
return V_273 ;
return F_3 ( V_6 -> V_15 + V_88 ) ;
}
static void F_115 ( struct V_85 * V_14 ,
unsigned char V_274 )
{
unsigned int V_37 ;
struct V_5 * V_6 =
...
F_11 ( V_6 , V_223 ) ;
F_111 ( V_6 , V_275 ) ;
F_4 ( V_274 , V_6 -> V_15 + V_81 ) ;
if ( V_274 == 10 ) {
F_111 ( V_6 , V_275 ) ;
F_4 ( 13 , V_6 -> V_15 + V_81 ) ;
}
F_111 ( V_6 , V_276 ) ;
F_4 ( V_37 , V_6 -> V_15 + V_16 ) ;
}
static void F_116 ( struct V_85 * V_14 , int V_277 )
{
struct V_5 * V_6 =
F_38 ( V_14 , struct V_5 , V_14 ) ;
F_111 ( V_6 , V_275 ) ;
F_4 ( V_277 , V_6 -> V_15 + V_81 ) ;
}
static void
F_117 ( struct V_278 * V_279 , const char * V_280 , unsigned int V_3 )
{
struct V_5 * V_6 ;
unsigned long V_189 ;
int V_281 = 1 ;
...
V_281 = F_119 ( & V_6 -> V_191 ) ;
V_282 = F_119 ( & V_6 -> V_14 . V_191 ) ;
} else {
F_97 ( & V_6 -> V_191 ) ;
F_97 ( & V_6 -> V_14 . V_191 ) ;
}
V_37 = F_3 ( V_6 -> V_15 + V_16 ) ;
F_11 ( V_6 , V_223 ) ;
F_120 ( & V_6 -> V_14 , V_280 , V_3 , F_116 ) ;
F_111 ( V_6 , V_276 ) ;
F_4 ( V_37 , V_6 -> V_15 + V_16 ) ;
if ( V_282 )
...
static int T_10 F_122 ( struct V_278 * V_279 , char * V_286 )
{
struct V_85 * V_14 ;
int V_39 = V_224 ;
int V_41 = 8 ;
int V_40 = 'n' ;
int V_287 = 'n' ;
if ( V_279 -> V_284 >= V_288 )
V_279 -> V_284 = 0 ;
V_14 = & V_283 [ V_279 -> V_284 ] -> V_14 ;
if ( ! V_14 || ( ! V_14 -> V_289 && ! V_14 -> V_15 ) )
return - V_290 ;
V_14 -> V_45 = F_7 () ;
if ( V_286 )
F_123 ( V_286 , & V_39 , & V_40 , & V_41 , & V_287 ) ;
return F_124 ( V_14 , V_279 , V_39 , V_40 , V_41 , V_287 ) ;
}
static struct V_5 * F_125 ( struct V_122 * V_124 ,
...
struct V_293 * V_294 ;
char V_295 [ 32 ] ;
V_294 = & V_296 [ V_292 -> V_297 ] ;
V_264 = V_294 -> V_264 ;
V_6 = F_2 ( sizeof( struct V_5 ) , V_13 ) ;
if ( V_6 == NULL )
goto V_298;
V_158 = ( unsigned char * ) F_126 ( V_13 ) ;
if ( ! V_158 )
goto V_299;
switch ( V_264 ) {
case V_300 :
...
V_6 -> V_169 = 1 ;
V_6 -> V_158 . V_8 = V_158 ;
V_6 -> V_158 . V_97 = V_303 ;
V_6 -> V_64 = V_110 ;
V_6 -> V_45 = F_7 () ;
V_6 -> V_264 = V_304 + V_264 + 1 ;
V_6 -> V_14 . V_47 = & V_124 -> V_47 ;
V_6 -> V_14 . V_289 = V_289 ;
V_6 -> V_14 . V_15 = NULL ;
V_6 -> V_14 . V_129 = V_129 ;
V_6 -> V_14 . V_185 = V_124 -> V_185 ;
V_6 -> V_14 . V_305 = V_306 ;
V_6 -> V_14 . V_307 = & V_308 ;
V_6 -> V_14 . V_189 = V_309 ;
V_6 -> V_14 . V_110 = V_110 ;
V_6 -> V_14 . line = V_294 -> V_310 ;
V_6 -> V_65 = V_234 ;
F_129 ( & V_6 -> V_14 . V_191 ) ;
F_131 ( V_124 , V_6 ) ;
V_6 -> V_69 = 1 ;
V_6 -> V_61 = 0 ;
#ifdef F_132
V_283 [ V_294 -> V_310 ] = V_6 ;
#endif
V_10 = F_133 ( & V_311 , & V_6 -> V_14 ) ;
if ( V_10 < 0 )
goto V_302;
#ifdef F_134
snprintf ( V_295 , sizeof( V_295 ) , L_50 , V_294 -> V_310 ) ;
V_6 -> V_312 = F_135 ( V_295 , V_313 | V_314 ,
NULL , V_6 , & V_315 ) ;
#endif
return V_6 ;
V_302:
#ifdef F_132
V_283 [ V_294 -> V_310 ] = NULL ;
#endif
F_136 ( ( unsigned long ) V_158 ) ;
V_299:
F_6 ( V_6 ) ;
V_298:
return NULL ;
...
F_138 ( V_6 -> V_312 ) ;
#endif
F_139 ( & V_311 , & V_6 -> V_14 ) ;
F_131 ( V_6 -> V_124 , NULL ) ;
F_136 ( ( unsigned long ) V_6 -> V_158 . V_8 ) ;
}
static void F_140 ( struct V_122 * V_124 )
{
struct V_5 * V_6 = F_141 ( V_124 ) ;
F_142 ( V_124 ) ;
#ifdef F_132
V_283 [ V_6 -> V_14 . line ] = NULL ;
#endif
F_137 ( V_6 ) ;
F_143 ( V_124 ) ;
F_6 ( V_6 ) ;
...
static int F_144 ( struct V_122 * V_124 , T_11 V_100 )
{
struct V_5 * V_6 = F_141 ( V_124 ) ;
F_145 ( & V_311 , & V_6 -> V_14 ) ;
F_146 ( V_124 ) ;
F_147 ( V_124 , F_148 ( V_124 , V_100 ) ) ;
return 0 ;
}
static int F_149 ( struct V_122 * V_124 )
{
struct V_5 * V_6 = F_141 ( V_124 ) ;
int V_10 ;
F_147 ( V_124 , V_316 ) ;
...
F_152 ( & V_311 , & V_6 -> V_14 ) ;
return 0 ;
}
static int F_153 ( struct V_122 * V_124 ,
const struct V_291 * V_292 )
{
int V_10 ;
struct V_5 * V_6 ;
