...
static short F_56 ( T_2 V_131 , T_2 V_170 )
{
#ifdef F_57
if ( V_131 < ( T_2 ) V_171 )
return 0 ;
if ( V_131 > ( T_2 ) ( V_172 + V_173 ) )
return 0 ;
if ( ( V_131 + ( V_170 << 2 ) ) >
( T_2 ) ( V_172 + V_173 ) )
return 0 ;
...
T_1 V_154 ;
T_2 V_130 , V_131 ;
T_2 * V_155 = ( T_2 * ) V_2 -> V_52 . V_175 . V_52 . V_57 . V_176 ;
T_1 V_147 = 8 ;
( void ) V_4 ;
while ( ( V_174 < ( V_2 -> V_52 . V_175 . V_52 . V_57 . V_177 & ~ 3L ) )
&& -- V_147 ) {
V_154 = F_52 ( V_9 , V_47 , V_156 ) ;
if ( V_154 & V_157 )
return V_178 ;
...
T_2 * V_155 = ( T_2 * ) V_2 -> V_52 . V_175 . V_52 . V_57 . V_176 ;
( void ) V_4 ;
while ( V_188 < ( V_2 -> V_52 . V_175 . V_52 . V_57 . V_177 & ~ 3L ) ) {
V_154 = F_52 ( V_9 , V_47 , V_156 ) ;
if ( V_154 & V_157 )
return V_189 ;
if ( F_53 ( V_9 , V_47 ,
...
T_2 V_196 ;
struct V_10 * V_11 = V_9 -> V_12 ;
V_196 = F_33 ( V_11 -> V_68 + V_197 ) ;
if ( V_196 ) {
F_28 ( 0L , V_11 -> V_68 + V_197 ) ;
V_11 -> V_80 ++ ;
if ( V_195 == 1 )
V_97 ++ ;
else
...
struct V_1 V_85 ;
T_1 V_216 ;
V_85 . V_212 = V_2 -> V_52 . V_175 . V_52 . V_217 . V_218 ;
V_85 . V_28 = V_2 -> V_52 . V_175 . V_52 . V_217 . V_219 ;
V_216 = F_62 ( V_9 , & V_85 ) ;
if ( V_216 != V_47 ) {
V_4 -> error = V_220 ;
return;
