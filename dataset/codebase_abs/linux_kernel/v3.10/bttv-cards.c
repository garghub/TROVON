...
{
int V_159 = V_160 ;
if ( V_160 != V_17 [ V_2 -> V_6 . type ] . V_161 )
V_159 = V_17 [ V_2 -> V_6 . type ] . V_161 ;
if ( V_2 -> V_33 != V_35 ) {
struct V_162 V_163 ;
if ( V_2 -> V_29 )
F_46 ( & V_2 -> V_6 . V_147 ,
...
if ( V_2 -> V_29 )
V_163 . V_167 |= V_169 ;
F_51 ( V_2 , V_130 , V_170 , & V_163 ) ;
}
if ( V_2 -> V_53 ) {
struct V_171 V_172 ;
V_172 . V_130 = V_173 ;
V_172 . V_174 = & V_2 -> V_53 ;
F_51 ( V_2 , V_130 , V_175 , & V_172 ) ;
}
}
...
{
struct V_179 V_180 ;
F_52 ( & V_2 -> V_181 , & V_180 , V_23 ) ;
V_2 -> V_33 = V_180 . V_33 ;
V_2 -> V_29 = V_180 . V_29 ;
F_2 ( L_52 ,
V_2 -> V_6 . V_12 , V_180 . V_182 ) ;
...
static int F_55 ( struct V_1 * V_2 , const T_2 * V_189 , T_1 V_190 )
{
T_1 V_191 ;
T_2 V_192 ;
int V_4 ;
F_8 ( 0xffffff , V_193 | V_194 | V_195 ) ;
F_14 ( 0 ) ;
F_9 ( V_196 ) ;
F_14 ( V_195 ) ;
F_9 ( V_196 ) ;
...
int V_199 ;
V_199 = F_56 ( & V_198 , L_55 , & V_2 -> V_6 . V_7 -> V_200 ) ;
if ( V_199 != 0 ) {
F_45 ( L_56 , V_2 -> V_6 . V_12 ) ;
return V_199 ;
}
V_199 = F_55 ( V_2 , V_198 -> V_201 , V_198 -> V_202 ) ;
F_2 ( L_57 ,
V_2 -> V_6 . V_12 , ( V_199 < 0 ) ? L_58 : L_59 ) ;
F_57 ( V_198 ) ;
return V_199 ;
}
static void F_40 ( struct V_1 * V_2 , const T_2 V_203 [ 256 ] )
{
int V_4 ;
T_1 V_204 = 0 ;
int V_5 = - 1 ;
if ( V_2 -> V_6 . type == V_82 ) {
if ( ! strncmp ( V_203 , L_60 , 4 ) ) {
T_2 V_205 = 0 ;
...
V_204 = F_60 ( ( V_207 * ) ( V_203 + 6 ) ) ;
}
F_2 ( L_62 ,
V_2 -> V_6 . V_12 , V_5 ,
V_5 > 0 ? V_17 [ V_5 ] . V_13 : L_63 , V_204 ) ;
...
{
int V_208 , V_209 , V_210 , V_33 = 0 ;
V_208 = ( V_23 [ 0x41 ] & 0x7 ) ;
V_209 = ( V_23 [ 0x41 ] & 0x18 ) >> 3 ;
V_210 = ( V_23 [ 0x42 ] & 0xf0 ) >> 4 ;
...
static void F_30 ( struct V_1 * V_2 , int V_220 )
{
int V_221 = ( 1 << V_220 ) ;
F_8 ( V_221 , V_221 ) ;
F_15 ( V_221 , 0 ) ;
...
{
static int V_224 [] = { 0x08 , 0x09 , 0x0a , 0x0b , 0x0d , 0x0d , 0x01 , 0x02 ,
...
F_9 ( 10 ) ;
F_14 ( 1 << 2 ) ;
for ( V_4 = 0 ; V_4 < F_4 ( V_224 ) ; V_4 ++ ) {
V_225 = F_64 ( V_2 , 0x1E , 0 , V_224 [ V_4 ] , 1 ) ;
if ( V_225 != - 1 ) {
F_2 ( L_75 ,
V_224 [ V_4 ] , V_225 , F_12 ( V_2 , 0x1F , NULL ) ) ;
}
}
F_2 ( L_76 ) ;
}
...
F_2 ( L_77 ,
V_2 -> V_6 . V_12 ) ;
F_22 ( 0x00c3feff , V_233 ) ;
F_22 ( 0 + V_232 , V_234 ) ;
F_66 ( 1 ) ;
F_22 ( 0x10 + V_232 , V_234 ) ;
F_66 ( 10 ) ;
F_22 ( 0 + V_232 , V_234 ) ;
V_231 = F_65 ( V_234 ) ;
if ( ( ( ( V_231 >> 18 ) & 0x01 ) != 0 ) || ( ( ( V_231 >> 19 ) & 0x01 ) != 1 ) ) {
F_2 ( L_78 ,
V_2 -> V_6 . V_12 , V_231 ) ;
}
F_22 ( 0x4400 + V_232 , V_234 ) ;
F_66 ( 10 ) ;
F_22 ( 0x4410 + V_232 , V_234 ) ;
F_66 ( 1 ) ;
F_22 ( V_232 , V_234 ) ;
F_66 ( 1 ) ;
V_231 = F_65 ( V_234 ) ;
if ( ( ( ( V_231 >> 18 ) & 0x01 ) != 0 ) || ( ( ( V_231 >> 19 ) & 0x01 ) != 0 ) ) {
F_2 ( L_79 ,
V_2 -> V_6 . V_12 , V_231 ) ;
return;
}
...
static void F_67 ( struct V_1 * V_2 , int V_235 )
{
if ( V_2 -> V_187 ) {
F_15 ( V_2 -> V_187 | V_2 -> V_186 | V_2 -> V_188 ,
...
F_9 ( 5 ) ;
if ( V_2 -> V_187 ) {
F_15 ( V_2 -> V_186 | V_2 -> V_188 , 0 ) ;
F_9 ( 5 ) ;
}
}
static void F_68 ( struct V_1 * V_2 , int V_235 )
{
if ( V_2 -> V_187 ) {
F_15 ( V_2 -> V_187 | V_2 -> V_186 | V_2 -> V_188 ,
V_2 -> V_187 | V_2 -> V_186 | V_2 -> V_188 ) ;
...
static int F_69 ( struct V_1 * V_2 , int V_235 )
{
if ( V_2 -> V_187 ) {
F_15 ( V_2 -> V_187 | V_2 -> V_186 | V_2 -> V_188 ,
V_2 -> V_187 | V_2 -> V_186 | V_2 -> V_188 ) ;
...
F_67 ( V_2 , V_2 -> V_46 ) ;
F_9 ( 10 ) ;
V_236 = V_237 + F_70 ( 1000 ) ;
while ( F_69 ( V_2 , V_2 -> V_47 ) && F_71 ( V_237 , V_236 ) )
F_72 () ;
...
void F_75 ( struct V_1 * V_2 , unsigned short V_185 )
{
F_73 ( L_88 , V_185 ) ;
F_53 ( V_2 , 5 * V_185 + 0x358 ) ;
}
...
{
static const T_2 V_239 [] = { 0x3 , 0x1 , 0x2 , 0x4 , 0xf , 0x7 , 0xe , 0x0 ,
0xd , 0xb , 0xc , 0x6 , 0x9 , 0x5 , 0x8 , 0xa } ;
F_15 ( 0x07f , V_239 [ V_59 ] ) ;
F_15 ( 0x200 , 0x200 ) ;
F_62 ( 1 ) ;
F_15 ( 0x200 , 0x000 ) ;
F_62 ( 1 ) ;
...
unsigned char V_201 ) {
unsigned int V_242 ;
V_242 = ( V_201 << 7 ) | ( ( V_241 & 3 ) << 4 ) | ( V_240 & 0xf ) ;
F_15 ( 0x1ff , V_242 ) ;
F_15 ( 0x1ff , V_242 | ( 1 << 8 ) ) ;
F_15 ( 0x1ff , V_242 ) ;
}
...
V_241 = ( V_2 -> V_6 . V_12 - V_244 -> V_6 . V_12 + 1 ) & 3 ;
V_241 = V_245 [ V_241 ] ;
V_243 = ( char * ) ( & V_244 -> V_44 ) ;
V_240 = V_59 & 0xf ;
if ( V_243 [ V_241 ] != V_240 )
{
F_78 ( V_244 , V_243 [ V_241 ] , V_241 , 0 ) ;
V_243 [ V_241 ] = V_240 ;
F_78 ( V_244 , V_240 , V_241 , 1 ) ;
}
}
static void F_43 ( struct V_1 * V_2 )
{
char * V_243 = ( char * ) ( & V_2 -> V_44 ) ;
int V_247 ;
F_8 ( 0x0003ff , 0x0003ff ) ;
F_14 ( 1 << 9 ) ;
F_14 ( 0 ) ;
for ( V_247 = 0 ; V_247 < 4 ; V_247 ++ ) {
V_243 [ V_247 ] = V_247 ;
F_78 ( V_2 , V_247 , V_247 , 1 ) ;
}
if ( ( V_2 -> V_6 . V_12 < 1 ) || ( V_2 -> V_6 . V_12 > V_248 - 3 ) )
return;
...
V_249 , V_249 | V_250 , V_249 | V_251 , V_249 | V_250 | V_251 ,
V_252 , V_252 | V_250 , V_252 | V_251 , V_252 | V_250 | V_251 ,
V_253 , V_253 | V_254 , V_253 | V_255 , V_253 | V_254 | V_255 ,
V_256 , V_256 | V_254 , V_256 | V_255 , V_256 | V_254 | V_255 ,
} ;
F_14 ( V_65 [ V_59 % 16 ] ) ;
}
...
int V_258 = V_59 / 4 ;
F_73 ( L_90 ,
V_2 -> V_6 . V_12 , V_59 , V_258 , V_257 ) ;
F_64 ( V_2 , V_259 , 0x00 ,
( ( V_258 == 3 ) ? ( V_257 | V_257 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_260 , 0x00 ,
( ( V_258 == 0 ) ? ( V_257 | V_257 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_261 , 0x00 ,
( ( V_258 == 1 ) ? ( V_257 | V_257 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_262 , 0x00 ,
( ( V_258 == 2 ) ? ( V_257 | V_257 << 2 ) : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_259 , 0x02 ,
( ( V_258 == 3 ) ? 0x03 : 0x00 ) , 1 ) ;
F_64 ( V_2 , V_260 , 0x02 ,
( ( V_258 == 0 ) ? 0x03 : 0x00 ) , 1 ) ;
...
long V_263 ;
int V_264 ;
unsigned char V_265 [ 2 ] ;
V_265 [ 0 ] = 0 ;
V_265 [ 1 ] = 0 ;
V_199 = F_64 ( V_2 , ( V_266 << 1 ) , V_265 [ 0 ] , V_265 [ 1 ] , 1 ) ;
if ( V_199 ) {
F_3 ( L_91 ,
V_2 -> V_6 . V_12 , V_199 ) ;
return;
}
V_199 = F_12 ( V_2 , ( V_266 << 1 ) , NULL ) ;
if ( ! ( V_199 & V_267 ) ) {
F_3 ( L_92 ,
V_2 -> V_6 . V_12 , V_199 ) ;
return;
...
V_264 = F_65 ( V_234 ) ;
if ( V_2 -> V_5 == V_268 )
V_264 = ( V_264 & ~ 0x280 ) | ( ( V_263 & 2 ) << 8 ) | ( ( V_263 & 1 ) << 7 ) ;
else
V_264 = ( V_264 & ~ 0x300 ) | ( ( V_263 & 3 ) << 8 ) ;
F_22 ( V_264 , V_234 ) ;
if ( V_2 -> V_5 == V_268 )
F_16 ( 2 << 5 , ~ V_269 , V_58 ) ;
else
F_19 ( ~ V_269 , V_58 ) ;
F_3 ( L_93 , V_2 -> V_6 . V_12 , ( int ) V_263 ) ;
}
static void F_84 ( struct V_1 * V_2 , unsigned int V_59 )
{
unsigned int V_263 = V_59 % 4 ;
if ( V_59 == V_2 -> V_135 )
V_263 = 0 ;
F_15 ( 0x3 , V_263 ) ;
}
...
unsigned char V_241 ,
unsigned char V_201 ) {
const T_1 V_270 = ( ( V_240 & 0xf ) | ( V_241 & 3 ) << 4 ) ;
const T_1 V_271 = 1 << 16 ;
const T_1 V_272 = 1 << 17 ;
const T_1 V_273 = V_201 << 18 ;
F_15 ( 0x1007f , V_270 | V_271 ) ;
F_15 ( 0x20000 , V_272 ) ;
F_15 ( 0x40000 , V_273 ) ;
F_15 ( 0x20000 , ~ V_272 ) ;
}
...
V_241 = ( V_2 -> V_6 . V_12 - V_244 -> V_6 . V_12 ) & 3 ;
V_243 = ( char * ) ( & V_244 -> V_44 ) ;
V_240 = V_245 [ V_241 ] [ V_59 ] & 0xf ;
if ( V_243 [ V_241 ] != V_240 ) {
F_85 ( V_244 , V_243 [ V_241 ] , V_241 , 0 ) ;
V_243 [ V_241 ] = V_240 ;
F_85 ( V_244 , V_240 , V_241 , 1 ) ;
}
}
...
for ( V_247 = 0 ; V_247 < 4 ; V_247 ++ ) {
V_243 [ V_247 ] = V_247 ;
F_85 ( V_2 , V_247 , V_247 , 1 ) ;
}
F_64 ( V_2 , 0x18 , 0x5 , 0x90 , 1 ) ;
if ( V_2 -> V_6 . V_12 > V_248 - 4 )
return;
V_246 [ V_2 -> V_6 . V_12 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 + 1 ] = V_2 ;
V_246 [ V_2 -> V_6 . V_12 + 2 ] = V_2 ;
...
{
int V_274 = 0 ;
struct V_275 * V_200 = NULL ;
if ( V_276 & ( V_277 | V_278 ) )
V_274 = 1 ;
if ( V_276 & ( V_279 | V_280 | V_281 ) )
V_282 = 1 ;
if ( V_276 & V_283 )
V_284 = 1 ;
#ifdef F_88
...
if ( V_18 != V_285 )
F_2 ( L_99 , V_285 ) ;
while ( ( V_200 = F_89 ( V_287 ,
V_288 , V_200 ) ) ) {
unsigned char V_289 ;
F_90 ( V_200 , 0x53 , & V_289 ) ;
if ( V_70 )
F_2 ( L_100 ,
V_289 ) ;
}
...
{
unsigned char V_290 ;
if ( ! V_282 && ! V_284 && V_18 == V_285 )
return 0 ;
if ( V_223 ) {
if ( V_282 )
F_2 ( L_101 ,
V_2 -> V_6 . V_12 ) ;
if ( V_284 && V_2 -> V_11 >= 878 )
...
F_90 ( V_2 -> V_6 . V_7 , V_292 , & V_290 ) ;
if ( V_282 )
V_290 |= V_293 ;
if ( V_284 )
V_290 |= V_294 ;
F_92 ( V_2 -> V_6 . V_7 , V_292 , V_290 ) ;
}
if ( V_18 != V_285 )
F_92 ( V_2 -> V_6 . V_7 , V_295 , V_285 ) ;
return 0 ;
}
