...
return;
V_147 = F_2 ( V_152 ) ;
if ( V_147 == 0xff && V_2 -> V_27 -> V_153 )
return;
F_32 ( & V_151 ) ;
for ( V_148 = 32 ; V_148 > 0 ; V_148 -= V_149 ) {
V_151 . V_154 = V_147 & 0x80000000 ? false : true ;
V_149 = F_33 ( V_148 , 32U - F_34 ( V_151 . V_154 ? V_147 : ~ V_147 ) ) ;
V_151 . V_155 = ( V_149 * ( V_156 / 1000 ) ) / V_42 ;
F_35 ( V_2 -> V_27 , & V_151 ) ;
V_147 <<= V_149 ;
}
F_36 ( V_2 -> V_27 ) ;
}
static int F_37 ( struct V_157 * V_2 , T_1 * V_158 , T_1 * V_159 )
{
int V_160 , V_161 ;
V_160 = F_38 ( V_2 -> V_162 , 0x10 ) ;
if ( V_160 < 0 ) {
F_39 ( L_10 ) ;
return 0 ;
}
if ( 0 == ( V_160 & 0x80 ) )
return 0 ;
V_161 = F_38 ( V_2 -> V_162 , 0x00 ) ;
if ( V_161 < 0 ) {
F_39 ( L_10 ) ;
return 0 ;
}
F_39 ( L_11 ,
V_161 & 0xff , V_160 & 0xff ) ;
* V_158 = V_161 & 0xff ;
* V_159 = V_161 ;
return 1 ;
}
...
const unsigned short * V_168 = V_165 ;
const unsigned short * V_169 ;
if ( 0 != V_4 -> V_170 )
return;
memset ( & V_164 , 0 , sizeof( struct V_163 ) ) ;
F_41 ( V_164 . type , L_12 , V_171 ) ;
switch ( V_4 -> V_9 ) {
case V_172 :
V_168 = V_167 ;
V_4 -> V_173 . V_121 = L_13 ;
V_4 -> V_173 . type = V_174 ;
V_4 -> V_173 . V_175 = F_37 ;
V_4 -> V_173 . V_49 = V_176 ;
break;
}
for ( V_169 = V_168 ; * V_169 != V_166 ; V_169 ++ ) {
V_164 . V_177 = NULL ;
memset ( & V_4 -> V_173 , 0 , sizeof( V_4 -> V_173 ) ) ;
if ( * V_169 == 0x71 ) {
V_4 -> V_173 . V_121 = L_14 ;
V_4 -> V_173 . V_49 = V_74 ;
V_4 -> V_173 . type = V_178 ;
V_4 -> V_173 . V_179 = V_180 ;
V_164 . V_177 = & V_4 -> V_173 ;
}
if ( F_42 ( & V_4 -> V_181 , * V_169 , 0 ,
V_182 , 0 ,
V_183 , NULL ) >= 0 ) {
V_164 . V_184 = * V_169 ;
F_43 ( & V_4 -> V_181 , & V_164 ) ;
break;
}
}
}
