...
F_108 ( & V_2 -> V_40 , F_80 , ( unsigned long ) V_2 ) ;
F_108 ( & V_2 -> V_127 , F_81 , ( unsigned long ) V_2 ) ;
V_12 = F_26 ( V_2 ) ;
if ( V_12 )
goto V_161;
F_109 ( & V_2 -> V_162 ) ;
F_110 ( & V_38 ) ;
F_111 ( & V_2 -> V_162 , & V_163 ) ;
F_112 ( & V_38 ) ;
...
static int F_122 ( struct V_135 * V_9 )
{
F_8 ( V_9 ) ;
return 0 ;
}
