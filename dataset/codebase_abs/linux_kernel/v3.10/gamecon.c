...
static int T_1 F_15 ( struct V_20 * V_21 , int V_7 )
{
struct V_38 * V_39 ;
int V_53 ;
...
static int T_1 F_42 ( struct V_1 * V_1 , int V_40 , int V_120 )
{
...
static struct V_1 T_1 * F_52 ( int V_4 , int * V_27 , int V_140 )
{
struct V_1 * V_1 ;
struct V_4 * V_141 ;
struct V_142 * V_6 ;
...
V_6 = F_54 ( V_141 , L_6 , NULL , NULL , NULL , V_145 , NULL ) ;
if ( ! V_6 ) {
F_43 ( L_7 ) ;
V_53 = - V_146 ;
goto V_147;
...
for ( V_7 = 0 ; V_7 < V_140 && V_7 < V_26 ; V_7 ++ ) {
if ( ! V_27 [ V_7 ] )
continue;
V_53 = F_42 ( V_1 , V_7 , V_27 [ V_7 ] ) ;
if ( V_53 )
goto V_149;
V_143 ++ ;
}
...
int V_151 = 0 ;
int V_53 = 0 ;
for ( V_7 = 0 ; V_7 < V_152 ; V_7 ++ ) {
if ( V_153 [ V_7 ] . V_154 == 0 || V_153 [ V_7 ] . args [ 0 ] < 0 )
continue;
if ( V_153 [ V_7 ] . V_154 < 2 ) {
F_43 ( L_10 ) ;
V_53 = - V_122 ;
break;
}
V_155 [ V_7 ] = F_52 ( V_153 [ V_7 ] . args [ 0 ] ,
V_153 [ V_7 ] . args + 1 , V_153 [ V_7 ] . V_154 - 1 ) ;
if ( F_64 ( V_155 [ V_7 ] ) ) {
V_53 = F_65 ( V_155 [ V_7 ] ) ;
break;
}
