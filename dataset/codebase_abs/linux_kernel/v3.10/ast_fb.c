...
static int F_20 ( struct V_54 * V_49 ,
struct V_55 * V_56 )
{
...
V_45 . V_53 = F_21 ( V_56 -> V_63 ,
V_56 -> V_64 ) ;
V_51 = V_45 . V_31 [ 0 ] * V_45 . V_6 ;
V_18 = F_17 ( V_2 , & V_45 , & V_52 ) ;
if ( V_18 ) {
F_7 ( L_2 , V_18 ) ;
return V_18 ;
}
...
V_34 -> V_37 = V_2 ;
V_18 = F_24 ( V_48 , & V_2 -> V_15 , & V_45 , V_52 ) ;
if ( V_18 )
goto V_66;
V_2 -> V_32 = V_32 ;
V_2 -> V_51 = V_51 ;
...
V_34 -> V_75 -> V_76 [ 0 ] . V_16 = F_27 ( V_48 -> V_60 , 0 ) ;
V_34 -> V_75 -> V_76 [ 0 ] . V_51 = F_28 ( V_48 -> V_60 , 0 ) ;
F_29 ( V_34 , V_58 -> V_31 [ 0 ] , V_58 -> V_50 ) ;
F_30 ( V_34 , & V_2 -> V_49 , V_56 -> V_77 , V_56 -> V_78 ) ;
V_34 -> V_79 = V_32 ;
V_34 -> V_80 = V_51 ;
V_34 -> V_81 . V_23 = V_82 ;
F_31 ( L_4 ,
...
static void F_32 ( struct V_83 * V_84 , T_2 V_85 , T_2 V_86 ,
T_2 V_87 , int V_88 )
{
struct V_89 * V_89 = F_33 ( V_84 ) ;
...
struct V_1 * V_2 ;
int V_18 ;
V_2 = F_45 ( sizeof( struct V_1 ) , V_98 ) ;
if ( ! V_2 )
return - V_65 ;
V_96 -> V_67 = V_2 ;
V_2 -> V_49 . V_99 = & V_100 ;
F_46 ( & V_2 -> V_25 ) ;
V_18 = F_47 ( V_48 , & V_2 -> V_49 ,
1 , 1 ) ;
if ( V_18 ) {
F_48 ( V_2 ) ;
return V_18 ;
...
void F_53 ( struct V_47 * V_48 , int V_101 )
{
struct V_95 * V_96 = V_48 -> V_97 ;
if ( ! V_96 -> V_67 )
return;
F_54 ( V_96 -> V_67 -> V_49 . V_67 , V_101 ) ;
}
