...
V_89 , V_3 -> V_7 + V_90 ) ;
V_65 = F_33 ( V_64 -> V_91 , F_22 ,
0 , L_1 , V_3 ) ;
if ( V_65 ) {
F_34 ( L_2 ) ;
return V_65 ;
}
V_65 = F_33 ( V_64 -> V_92 , F_24 ,
0 , L_3 , V_3 ) ;
if ( V_65 ) {
F_34 ( L_4 ) ;
goto V_93;
}
V_65 = F_33 ( V_64 -> V_94 , F_23 ,
0 , L_5 , V_3 ) ;
if ( V_65 ) {
F_34 ( L_6 ) ;
goto V_95;
...
V_106 = F_39 ( V_3 , V_101 , V_102 , 0 , V_3 -> V_67 / 16 ) ;
V_105 = F_40 ( V_3 , V_106 ) ;
V_105 = V_105 / 2 - 1 ;
...
F_7 ( & V_5 , V_4 ) ;
if ( F_41 ( V_101 ) )
F_42 ( V_101 , V_106 , V_106 ) ;
F_43 ( V_3 , V_103 , V_106 ) ;
}
static const char *
F_44 ( struct V_2 * V_3 )
{
...
F_47 ( struct V_2 * V_3 )
{
struct V_134 * V_135 = F_48 ( V_3 -> V_136 ) ;
struct V_137 * V_138 ;
int V_139 ;
V_138 = F_49 ( V_135 , V_140 , 0 ) ;
if ( ! V_138 ) {
F_50 ( & V_135 -> V_136 , L_7 ) ;
return - V_141 ;
}
V_139 = F_51 ( V_138 ) ;
V_138 = F_52 ( & V_135 -> V_136 , V_138 -> V_142 ,
V_139 , F_53 ( & V_135 -> V_136 ) ) ;
if ( ! V_138 ) {
F_50 ( & V_135 -> V_136 , L_8 ) ;
return - V_143 ;
}
if ( V_3 -> V_4 & V_133 ) {
V_3 -> V_7 = F_54 ( & V_135 -> V_136 ,
V_3 -> V_144 , V_139 ) ;
if ( V_3 -> V_7 == NULL )
return - V_145 ;
}
...
static void
F_58 ( struct V_155 * V_156 , const char * V_157 , T_3 V_158 )
{
struct V_1 * V_64 ;
struct V_2 * V_3 ;
unsigned long V_4 ;
...
V_3 = & V_64 -> V_3 ;
F_5 ( & V_5 , V_4 ) ;
F_59 ( V_3 , V_157 , V_158 , F_57 ) ;
F_7 ( & V_5 , V_4 ) ;
}
static int T_4
F_60 ( struct V_155 * V_156 , char * V_162 )
{
struct V_1 * V_64 ;
struct V_2 * V_3 ;
int V_106 = 115200 ;
...
V_3 -> V_67 = F_31 ( V_64 -> V_68 ) ;
if ( V_162 )
F_61 ( V_162 , & V_106 , & V_26 , & V_163 , & V_164 ) ;
return F_62 ( V_3 , V_156 , V_106 , V_26 , V_163 , V_164 ) ;
}
static int T_4
F_63 ( void )
{
...
int line = 0 ;
int V_149 ;
V_169 = F_49 ( V_135 , V_140 , 0 ) ;
V_149 = F_66 ( V_167 , V_170 , 3 ) ;
if ( ! V_169 || ( V_149 != 3 ) ) {
F_50 ( & V_135 -> V_136 ,
L_9 ) ;
return - V_141 ;
}
if ( V_169 -> V_142 != F_67 ( V_171 ) )
line = 1 ;
if ( V_161 [ line ] ) {
F_50 ( & V_135 -> V_136 , L_10 , line ) ;
return - V_143 ;
}
V_64 = F_68 ( & V_135 -> V_136 , sizeof( struct V_1 ) ,
V_172 ) ;
if ( ! V_64 )
return - V_145 ;
V_3 = & V_64 -> V_3 ;
