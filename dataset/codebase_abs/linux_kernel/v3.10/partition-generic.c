...
{
struct V_15 * V_36 = F_31 ( V_35 , struct V_15 , V_34 ) ;
V_36 -> V_17 = 0 ;
V_36 -> V_37 = 0 ;
F_32 ( V_36 , 0 ) ;
F_33 ( F_34 ( V_36 ) ) ;
...
void F_37 ( struct V_1 * V_38 , int V_3 )
{
...
struct V_15 * F_45 ( struct V_1 * V_38 , int V_3 ,
T_4 V_45 , T_4 V_42 , int V_46 ,
struct V_47 * V_48 )
{
struct V_15 * V_16 ;
T_1 V_49 = F_46 ( 0 , 0 ) ;
struct V_12 * V_50 = F_47 ( V_38 ) ;
struct V_12 * V_51 ;
struct V_39 * V_40 ;
const char * V_52 ;
int V_53 ;
...
V_16 -> V_17 = V_45 ;
V_16 -> V_19 =
F_53 ( & V_38 -> V_59 -> V_60 , V_45 ) ;
V_16 -> V_20 =
F_54 ( & V_38 -> V_59 -> V_60 , V_45 ) ;
V_16 -> V_37 = V_42 ;
V_16 -> V_3 = V_3 ;
V_16 -> V_18 = F_55 ( V_38 ) ;
if ( V_48 ) {
struct V_47 * V_61 = F_56 ( V_38 ) ;
if ( ! V_61 )
goto V_62;
memcpy ( V_61 , V_48 , sizeof( * V_48 ) ) ;
V_16 -> V_48 = V_61 ;
}
V_52 = F_57 ( V_50 ) ;
if ( isdigit ( V_52 [ strlen ( V_52 ) - 1 ] ) )
F_58 ( V_51 , L_2 , V_52 , V_3 ) ;
else
F_58 ( V_51 , L_3 , V_52 , V_3 ) ;
F_59 ( V_51 ) ;
V_51 -> V_63 = & V_64 ;
V_51 -> type = & V_65 ;
V_51 -> V_66 = V_50 ;
...
static bool F_68 ( struct V_1 * V_38 )
{
const struct V_74 * V_75 = V_38 -> V_76 ;
if ( V_75 -> V_77 &&
! ( V_38 -> V_46 & V_78 ) ) {
F_69 ( V_79 L_14 ) ;
V_75 -> V_77 ( V_38 ) ;
...
static int F_70 ( struct V_1 * V_38 , struct V_6 * V_7 )
{
struct V_80 V_81 ;
struct V_15 * V_36 ;
int V_82 ;
...
return V_82 ;
F_72 ( & V_81 , V_38 , V_84 ) ;
while ( ( V_36 = F_73 ( & V_81 ) ) )
F_37 ( V_38 , V_36 -> V_3 ) ;
F_74 ( & V_81 ) ;
return 0 ;
}
int F_75 ( struct V_1 * V_38 , struct V_6 * V_7 )
{
...
F_78 ( V_38 , V_7 ) ;
V_7 -> V_90 = 0 ;
if ( ! F_79 ( V_38 ) || ! ( V_86 = F_80 ( V_38 , V_7 ) ) )
return 0 ;
if ( F_76 ( V_86 ) ) {
if ( F_81 ( V_86 ) == - V_91 ) {
F_69 ( V_92 L_16 ,
...
F_69 ( V_92
L_18 ,
V_38 -> F_1 , V_16 , ( unsigned long long ) V_99 ) ;
if ( F_68 ( V_38 ) )
goto V_88;
continue;
}
if ( V_99 + V_98 > F_79 ( V_38 ) ) {
F_69 ( V_92
L_19 ,
...
V_48 = & V_86 -> V_97 [ V_16 ] . V_48 ;
V_36 = F_45 ( V_38 , V_16 , V_99 , V_98 ,
V_86 -> V_97 [ V_16 ] . V_46 ,
& V_86 -> V_97 [ V_16 ] . V_48 ) ;
if ( F_76 ( V_36 ) ) {
F_69 ( V_101 L_20 ,
V_38 -> F_1 , V_16 , - F_81 ( V_36 ) ) ;
continue;
}
#ifdef F_82
if ( V_86 -> V_97 [ V_16 ] . V_46 & V_102 )
F_83 ( F_34 ( V_36 ) -> V_49 ) ;
#endif
}
F_77 ( V_86 ) ;
...
int F_84 ( struct V_1 * V_38 , struct V_6 * V_7 )
{
int V_82 ;
if ( ! V_7 -> V_90 )
return 0 ;
...
unsigned char * F_86 ( struct V_6 * V_7 , T_4 V_103 , T_5 * V_16 )
{
struct V_104 * V_105 = V_7 -> V_106 -> V_107 ;
struct V_108 * V_108 ;
V_108 = F_87 ( V_105 , ( V_109 ) ( V_103 >> ( V_110 - 9 ) ) ,
NULL ) ;
if ( ! F_76 ( V_108 ) ) {
if ( F_88 ( V_108 ) )
goto V_111;
V_16 -> V_112 = V_108 ;
return ( unsigned char * ) F_89 ( V_108 ) + ( ( V_103 & ( ( 1 << ( V_110 - 9 ) ) - 1 ) ) << 9 ) ;
V_111:
F_90 ( V_108 ) ;
}
V_16 -> V_112 = NULL ;
