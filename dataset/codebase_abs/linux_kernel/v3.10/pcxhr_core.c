...
if ( ( V_198 < 0 ) &&
( V_2 -> V_199 != V_200 ) ) {
int V_201 = V_198 + V_197 + 1 ;
F_3 ( L_46 ,
V_2 -> V_199 , V_195 ) ;
if ( V_201 > 0 && V_201 <= ( 2 * V_2 -> V_170 ) ) {
F_3 ( L_47
L_48 , V_201 ) ;
V_198 = V_201 ;
} else {
...
V_2 -> V_194 = V_194 ;
V_3 &= ~ V_193 ;
for ( V_7 = 0 ; V_7 < V_2 -> V_203 ; V_7 ++ ) {
V_189 = V_2 -> V_189 [ V_7 ] ;
for ( V_148 = 0 ; V_148 < V_189 -> V_204 ; V_148 ++ )
F_42 ( V_2 ,
& V_189 -> V_205 [ V_148 ] ,
V_198 ) ;
}
for ( V_7 = 0 ; V_7 < V_2 -> V_203 ; V_7 ++ ) {
V_189 = V_2 -> V_189 [ V_7 ] ;
for ( V_148 = 0 ; V_148 < V_189 -> V_206 ; V_148 ++ )
F_42 ( V_2 ,
& V_189 -> V_207 [ V_148 ] ,
V_198 ) ;
}
