...
struct V_6 * V_7 = V_4 -> V_7 ;
int V_11 = 0 ;
if ( V_7 -> V_14 -> V_15 && V_7 -> V_14 -> V_15 -> V_70 )
V_11 = V_7 -> V_14 -> V_15 -> V_70 ( V_2 , V_69 ) ;
return V_11 ;
}
...
V_11 = V_7 -> V_14 -> V_15 -> V_71 ( V_2 , V_69 ) ;
return V_11 ;
}
int F_24 ( struct V_3 * V_4 , int V_72 )
{
struct V_37 * V_27 = V_4 -> V_27 ;
struct V_6 * V_7 = V_4 -> V_7 ;
struct V_8 * V_10 = V_4 -> V_10 ;
...
char V_75 [ 64 ] ;
int V_11 = 0 , V_22 = 0 ;
snprintf ( V_75 , sizeof( V_75 ) , L_8 ,
V_4 -> V_19 -> V_33 , V_10 -> V_17 , V_72 ) ;
if ( V_10 -> V_14 -> V_32 . V_76 )
V_22 = V_23 ;
else if ( V_10 -> V_14 -> V_77 . V_76 )
V_22 = V_78 ;
else
return - V_79 ;
V_74 = F_25 ( sizeof( * V_74 ) , V_80 ) ;
if ( V_74 == NULL ) {
F_26 ( V_81 L_9 ) ;
return - V_82 ;
}
V_74 -> V_83 = F_27 ( V_4 -> V_84 -> V_31 , sizeof( V_85 ) ,
V_80 ) ;
if ( V_74 -> V_83 == NULL ) {
F_28 ( V_4 -> V_84 -> V_31 , L_10 ) ;
V_11 = - V_82 ;
goto V_86;
}
memcpy ( V_74 -> V_83 , & V_85 , sizeof( V_85 ) ) ;
if ( V_7 -> V_14 -> V_15 && V_7 -> V_14 -> V_15 -> V_67 )
V_74 -> V_83 -> V_67 = F_21 ;
F_29 ( & V_74 -> V_87 ) ;
V_11 = F_30 ( V_4 -> V_84 -> V_88 , V_72 , V_22 , V_74 ) ;
if ( V_11 < 0 ) {
F_3 ( L_11 ,
V_27 -> V_17 ) ;
goto V_86;
