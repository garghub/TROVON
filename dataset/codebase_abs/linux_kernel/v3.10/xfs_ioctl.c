...
if ( F_25 ( V_15 ) )
return F_26 ( V_15 ) ;
V_96 = F_45 ( V_95 . V_77 , V_101 | V_102 ) ;
if ( ! V_96 ) {
V_96 = F_46 ( V_95 . V_77 ) ;
if ( ! V_96 )
goto V_63;
...
V_94 = ( T_7 * ) & V_95 . V_103 ;
error = - F_47 ( F_5 ( V_15 -> V_16 ) , V_96 , V_95 . V_77 ,
V_95 . V_98 , V_94 ) ;
if ( error )
goto V_85;
...
if ( * V_79 > V_106 )
return V_17 ;
V_96 = F_45 ( * V_79 , V_101 | V_102 ) ;
if ( ! V_96 ) {
V_96 = F_46 ( * V_79 ) ;
if ( ! V_96 )
return V_84 ;
}
error = F_52 ( F_5 ( V_5 ) , V_104 , V_96 , ( int * ) V_79 , V_98 ) ;
if ( error )
goto V_85;
if ( F_12 ( V_105 , V_96 , * V_79 ) )
error = V_38 ;
V_85:
if ( F_48 ( V_96 ) )
F_49 ( V_96 ) ;
...
struct V_5 * V_5 ,
unsigned char * V_104 ,
const unsigned char V_14 * V_105 ,
T_9 V_79 ,
T_9 V_98 )
{
unsigned char * V_96 ;
...
if ( V_79 > V_106 )
return V_17 ;
V_96 = F_54 ( V_105 , V_79 ) ;
if ( F_25 ( V_96 ) )
return F_26 ( V_96 ) ;
error = F_55 ( F_5 ( V_5 ) , V_104 , V_96 , V_79 , V_98 ) ;
return error ;
}
int
F_56 (
...
if ( F_29 ( V_5 ) || F_28 ( V_5 ) )
return V_62 ;
return F_57 ( F_5 ( V_5 ) , V_104 , V_98 ) ;
}
STATIC int
F_58 (
struct V_12 * V_43 ,
...
! F_83 ( & V_10 -> V_24 -> V_131 ) )
return F_24 ( V_17 ) ;
if ( F_84 ( V_143 ) && ( V_217 & V_230 ) ) {
V_226 = F_85 ( V_10 , V_10 -> V_34 . V_231 ,
...
V_221 = V_236 ;
F_74 ( V_10 , V_221 ) ;
if ( F_89 () != V_10 -> V_34 . V_231 && ! F_23 ( V_237 ) ) {
V_226 = F_24 ( V_62 ) ;
goto V_235;
}
if ( V_217 & V_230 ) {
...
case V_297 :
return F_117 ( V_5 -> V_298 , ( int V_14 * ) V_86 ) ;
case V_299 :
