...
static int T_7 F_35 ( struct V_2 * V_2 )
{
int V_80 ;
struct V_1 * V_4 = F_1 ( V_2 ) ;
struct V_81 V_82 = {
...
V_4 -> V_5 [ V_80 ] = V_80 ;
F_36 ( & V_4 -> V_7 [ V_80 ] . V_8 , F_7 ,
( unsigned long ) & V_4 -> V_5 [ V_80 ] ) ;
F_37 ( & V_4 -> V_7 [ V_80 ] . V_18 ) ;
}
V_4 -> V_15 = F_38 ( V_2 , V_85 , & V_82 ) ;
if ( ! V_4 -> V_15 )
return - V_86 ;
F_39 ( V_2 , V_87 , & V_88 ) ;
return 0 ;
}
static void T_8 F_40 ( struct V_2 * V_2 )
{
int V_80 ;
struct V_1 * V_4 = F_1 ( V_2 ) ;
F_41 ( V_2 , & V_88 ) ;
for ( V_80 = 0 ; V_80 < V_84 ; V_80 ++ ) {
T_1 * V_6 = & V_4 -> V_7 [ V_80 ] ;
F_4 ( & V_6 -> V_8 ) ;
if ( V_6 -> V_9 ) {
F_20 ( V_6 -> V_9 ) ;
V_6 -> V_9 = NULL ;
