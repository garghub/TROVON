...
static void F_27 ( void * V_32 , void * V_33 )
{
T_1 V_34 = F_21 () ;
struct V_16 * V_17 ;
V_35 = V_36 . V_37 ;
...
if ( V_42 )
return - V_62 ;
V_42 = F_36 ( V_41 -> V_63 . V_51 ) ;
if ( V_42 ) {
F_37 ( L_1 , V_10 -> V_58 . V_64 ,
V_41 -> V_63 . V_51 ) ;
F_38 ( & V_41 -> V_63 , sizeof( void * ) ) ;
return V_42 ;
}
F_39 ( L_2 ) ;
F_40 ( & V_41 -> V_45 , sizeof( unsigned long ) ) ;
F_40 ( & V_41 -> V_46 , sizeof( unsigned long ) ) ;
return 0 ;
}
int T_2 F_41 ( void )
{
V_3 = F_42 ( sizeof( struct V_8 ) * V_65 ,
V_66 ) ;
if ( ! V_3 )
return - V_67 ;
return 0 ;
