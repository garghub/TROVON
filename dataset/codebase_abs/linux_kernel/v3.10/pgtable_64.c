...
static T_4 * F_47 ( struct V_47 * V_48 )
{
void * V_49 , * V_30 ;
F_48 ( & V_48 -> V_50 ) ;
V_30 = V_48 -> V_51 . V_49 ;
...
static T_4 * F_50 ( struct V_47 * V_48 , int V_53 )
{
void * V_30 = NULL ;
struct V_54 * V_54 = F_51 ( V_55 | V_56 |
V_57 | V_58 ) ;
if ( ! V_54 )
return NULL ;
V_30 = F_52 ( V_54 ) ;
F_48 ( & V_48 -> V_50 ) ;
if ( F_53 ( ! V_48 -> V_51 . V_49 ) ) {
F_54 ( & V_54 -> V_59 , V_60 ) ;
V_48 -> V_51 . V_49 = V_30 + V_52 ;
}
F_49 ( & V_48 -> V_50 ) ;
if ( ! V_53 )
F_55 ( V_54 ) ;
...
T_4 * F_56 ( struct V_47 * V_48 , unsigned long V_61 , int V_53 )
{
T_4 * V_62 ;
V_62 = F_47 ( V_48 ) ;
if ( V_62 )
return V_62 ;
return F_50 ( V_48 , V_53 ) ;
}
void F_57 ( struct V_47 * V_48 , unsigned long * V_63 , int V_53 )
{
struct V_54 * V_54 = F_58 ( V_63 ) ;
if ( F_59 ( V_54 ) ) {
if ( ! V_53 )
F_60 ( V_54 ) ;
F_61 ( V_54 , 0 ) ;
...
void F_63 ( struct V_64 * V_65 , void * V_63 , int V_66 )
{
