...
static T_2 F_32 ( char * V_67 , int V_68 ,
const unsigned char * V_44 , int V_7 )
{
int V_69 ;
char * V_70 = V_67 ;
for ( V_69 = 0 ; V_69 < V_7 ; V_69 ++ ) {
V_70 += F_33 ( V_70 , V_68 - ( V_70 - V_67 ) , L_3 , V_44 [ V_69 ] ) ;
if ( V_69 == V_7 - 1 )
break;
V_70 += F_33 ( V_70 , V_68 - ( V_70 - V_67 ) , L_4 ) ;
}
return V_70 - V_67 ;
}
T_3 F_34 ( char * V_67 , const unsigned char * V_44 , int V_7 )
{
T_2 V_71 ;
V_71 = F_32 ( V_67 , V_72 , V_44 , V_7 ) ;
V_71 += F_33 ( V_67 + V_71 , V_72 - V_71 , L_5 ) ;
return ( T_3 ) V_71 ;
}
