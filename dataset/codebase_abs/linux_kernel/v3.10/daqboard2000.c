...
{
struct V_58 * V_59 = F_22 ( V_2 ) ;
const struct V_60 * V_61 ;
int V_62 ;
V_62 = F_23 ( & V_61 , V_63 , & V_59 -> V_2 ) ;
if ( V_62 )
return V_62 ;
V_62 = F_19 ( V_2 , V_61 -> V_19 , V_61 -> V_64 ) ;
F_24 ( V_61 ) ;
return V_62 ;
}
...
static int F_33 ( int V_73 , int V_74 , int V_19 ,
unsigned long V_75 )
{
...
V_16 -> V_98 = & V_103 ;
V_16 = & V_2 -> V_90 [ 2 ] ;
V_49 = F_41 ( V_2 , V_16 , F_33 ,
( unsigned long ) ( V_5 -> V_7 + V_104 ) ) ;
if ( V_49 )
return V_49 ;
F_42 ( V_2 -> V_105 , L_1 ,
V_2 -> V_106 -> V_107 , V_2 -> V_86 ) ;
return 0 ;
}
...
static int F_48 ( struct V_58 * V_2 ,
const struct V_109 * V_82 )
{
return F_49 ( V_2 , & V_110 ,
V_82 -> V_111 ) ;
}
