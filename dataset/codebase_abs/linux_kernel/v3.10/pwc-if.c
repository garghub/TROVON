...
V_3 -> V_165 = V_166 ;
strcpy ( V_3 -> V_165 . V_140 , V_140 ) ;
V_3 -> V_165 . V_167 = & V_3 -> V_150 ;
V_3 -> V_165 . V_167 -> V_168 = & V_3 -> V_149 ;
F_74 ( V_169 , & V_3 -> V_165 . V_4 ) ;
F_75 ( & V_3 -> V_165 , V_3 ) ;
V_3 -> V_170 = F_24 ( V_60 -> V_141 . V_171 ) ;
F_64 ( L_108 , V_3 -> V_170 ) ;
V_3 -> V_107 = F_76 ( sizeof( V_3 -> V_172 ) , V_87 ) ;
if ( ! V_3 -> V_107 ) {
F_17 ( L_106 ) ;
V_135 = - V_88 ;
goto V_164;
...
V_3 -> V_165 . V_105 = & V_3 -> V_105 ;
V_3 -> V_165 . V_168 = & V_3 -> V_127 ;
V_135 = F_81 ( & V_3 -> V_165 , V_175 , - 1 ) ;
if ( V_135 < 0 ) {
F_17 ( L_112 , V_135 ) ;
goto V_176;
}
F_65 ( L_113 , F_82 ( & V_3 -> V_165 ) ) ;
#ifdef F_9
V_3 -> V_12 = F_83 () ;
if ( ! V_3 -> V_12 ) {
F_17 ( L_114 ) ;
...
F_84 ( V_60 , V_3 -> V_178 , sizeof( V_3 -> V_178 ) ) ;
F_85 ( V_3 -> V_178 , L_115 , sizeof( V_3 -> V_178 ) ) ;
V_3 -> V_12 -> V_140 = L_116 ;
V_3 -> V_12 -> V_179 = V_3 -> V_178 ;
F_86 ( V_3 -> V_60 , & V_3 -> V_12 -> V_131 ) ;
V_3 -> V_12 -> V_91 . V_180 = & V_3 -> V_60 -> V_91 ;
V_3 -> V_12 -> V_181 [ 0 ] = F_87 ( V_182 ) ;
V_3 -> V_12 -> V_183 [ F_88 ( V_13 ) ] = F_87 ( V_13 ) ;
V_135 = F_89 ( V_3 -> V_12 ) ;
if ( V_135 ) {
F_90 ( V_3 -> V_12 ) ;
V_3 -> V_12 = NULL ;
