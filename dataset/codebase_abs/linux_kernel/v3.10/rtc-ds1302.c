...
static int F_22 ( struct V_10 * V_11 , unsigned int V_29 ,
unsigned long V_30 )
{
switch ( V_29 ) {
#ifdef F_23
...
{
int V_31 ;
if ( F_24 ( & V_31 , ( int V_32 * ) V_30 , sizeof( int ) ) )
return - V_33 ;
F_15 ( V_34 , ( 0xa0 | V_31 * 0xf ) ) ;
return 0 ;
}
#endif
}
...
static int T_1 F_25 ( struct V_36 * V_37 )
{
struct V_38 * V_39 ;
if ( F_1 () ) {
F_26 ( & V_37 -> V_11 , L_3 ) ;
...
static int T_2 F_31 ( struct V_36 * V_37 )
{
F_30 ( V_37 , NULL ) ;
return 0 ;
}
