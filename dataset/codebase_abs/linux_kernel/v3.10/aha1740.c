...
{
int V_118 , V_119 ;
unsigned int V_120 , V_121 , V_17 ;
struct V_2 * V_12 ;
struct V_5 * V_3 ;
struct V_52 * V_15 = F_47 ( V_63 ) ;
F_17 ( F_8 ( L_32 ) ) ;
V_118 = V_15 -> V_122 + V_123 ;
if ( ! F_48 ( V_118 , V_124 , L_33 ) )
return - V_125 ;
if ( ! F_9 ( V_118 ) )
goto V_126;
F_49 ( V_118 , & V_120 , & V_121 , & V_17 ) ;
if ( ( F_10 ( F_16 ( V_118 ) ) &
( V_114 | V_115 ) ) != V_114 ) {
F_21 ( V_127 , F_22 ( V_118 ) ) ;
F_21 ( 0 , F_22 ( V_118 ) ) ;
}
F_8 ( V_128 L_34 ,
V_15 -> V_16 , V_118 , V_120 , V_121 ? L_35 : L_36 ) ;
F_8 ( V_128 L_37 ,
V_17 ? L_3 : L_4 ) ;
V_12 = F_50 ( & V_129 ,
sizeof( struct V_5 ) ) ;
...
F_17 ( F_8 ( L_39 , V_120 ) ) ;
if ( F_53 ( V_120 , F_12 , V_121 ? 0 : V_135 ,
L_33 , V_12 ) ) {
F_8 ( V_133 L_40 ,
V_120 ) ;
goto V_136;
