...
V_109 = F_52 ( V_95 , V_63 , V_103 , V_100 [ V_115 ] , & V_106 , & V_116 ) ;
if ( V_109 < 0 )
return V_109 ;
V_109 = F_53 ( V_63 , V_103 [ V_117 ] , & V_108 ) ;
if ( V_109 < 0 )
goto V_118;
...
if ( F_54 ( V_89 ) == 0 )
V_89 = F_39 ( V_63 -> V_124 -> V_98 , V_89 ) ;
if ( F_47 ( V_89 ) == 0 )
V_89 = F_39 ( V_89 , 1 ) ;
V_109 = - V_125 ;
V_70 = F_55 ( sizeof( * V_70 ) , V_126 ) ;
if ( V_70 == NULL )
goto V_119;
V_70 -> V_98 = V_98 ;
V_70 -> V_83 = ~ 0U ;
F_42 ( & V_70 -> V_82 , 4 ) ;
V_70 -> V_93 . V_127 = F_41 ;
V_70 -> V_93 . V_128 = ( unsigned long ) V_70 ;
F_56 ( & V_70 -> V_93 ) ;
}
...
V_70 -> V_80 = V_80 ;
if ( V_103 [ V_129 ] )
V_70 -> V_83 = F_46 ( V_103 [ V_129 ] ) ;
if ( V_103 [ V_130 ] )
V_70 -> V_84 = F_46 ( V_103 [ V_130 ] ) ;
if ( V_103 [ V_131 ] )
V_70 -> V_85 = F_46 ( V_103 [ V_131 ] ) ;
if ( V_103 [ V_132 ] )
V_70 -> V_86 = F_46 ( V_103 [ V_132 ] ) ;
if ( V_103 [ V_133 ] )
V_70 -> V_87 = F_46 ( V_103 [ V_133 ] ) ;
if ( V_89 )
V_70 -> V_89 = V_89 ;
V_70 -> V_92 = V_92 ;
F_60 ( & V_70 -> V_93 ) ;
...
static int F_76 ( struct V_62 * V_63 , unsigned long V_137 ,
struct V_4 * V_5 , struct V_138 * V_108 )
{
struct V_69 * V_70 = (struct V_69 * ) V_137 ;
struct V_99 * V_139 ;
if ( V_70 == NULL )
return V_5 -> V_140 ;
V_108 -> V_141 = V_70 -> V_98 ;
V_139 = F_77 ( V_5 , V_102 ) ;
if ( V_139 == NULL )
goto V_142;
if ( F_78 ( V_5 , V_113 , V_70 -> V_71 ) ||
F_78 ( V_5 , V_120 , V_70 -> V_80 ) )
goto V_142;
if ( V_70 -> V_83 != ~ 0 || V_70 -> V_84 != 0 ) {
if ( F_78 ( V_5 , V_129 , V_70 -> V_83 ) ||
F_78 ( V_5 , V_130 , V_70 -> V_84 ) )
goto V_142;
}
if ( V_70 -> V_85 &&
F_78 ( V_5 , V_131 , V_70 -> V_85 ) )
goto V_142;
if ( V_70 -> V_86 &&
F_78 ( V_5 , V_132 , V_70 -> V_86 ) )
goto V_142;
if ( V_70 -> V_87 &&
F_78 ( V_5 , V_133 , V_70 -> V_87 ) )
goto V_142;
if ( V_70 -> V_89 &&
F_78 ( V_5 , V_112 , V_70 -> V_89 ) )
goto V_142;
if ( V_70 -> V_92 &&
F_78 ( V_5 , V_121 , V_70 -> V_92 / V_122 ) )
goto V_142;
if ( F_79 ( V_5 , & V_70 -> V_90 , & V_116 ) < 0 )
goto V_142;
#ifdef F_80
if ( V_70 -> V_77 . V_143 . V_144 &&
F_81 ( V_5 , & V_70 -> V_77 , V_117 ) < 0 )
goto V_142;
#endif
F_82 ( V_5 , V_139 ) ;
if ( F_83 ( V_5 , & V_70 -> V_90 , & V_116 ) < 0 )
goto V_142;
return V_5 -> V_140 ;
V_142:
F_84 ( V_5 , V_139 ) ;
...
static void F_85 ( struct V_62 * V_63 , struct V_145 * V_91 )
{
struct V_66 * V_67 = V_63 -> V_68 ;
struct V_69 * V_70 ;
F_34 (f, &head->filters, list) {
if ( V_91 -> V_146 < V_91 -> V_147 )
goto V_147;
if ( V_91 -> V_148 ( V_63 , ( unsigned long ) V_70 , V_91 ) < 0 ) {
V_91 -> V_149 = 1 ;
break;
}
V_147:
