...
V_152 . V_155 = V_5 ;
F_50 ( V_154 [ V_5 ] . V_167 , 0 , V_163 ,
& V_168 , ( void * ) V_152 . V_11 ) ;
}
}
static void
F_51 ( unsigned int V_169 )
{
char V_164 [ 3 + 4 + 1 ] ;
sprintf ( V_164 , L_125 , V_169 ) ;
F_52 ( V_164 , V_165 ) ;
}
static int T_16 F_53 ( struct V_170 * V_171 ,
unsigned long V_172 , void * V_169 )
{
unsigned int V_173 = ( unsigned long ) V_169 ;
switch ( V_172 ) {
case V_174 :
case V_175 :
F_48 ( V_173 ) ;
