...
static void F_19 ( int V_38 , struct V_39 * V_40 )
{
T_1 V_41 , V_22 ;
while ( ( V_41 = F_20 ( V_4 . V_28 [ V_38 ] ) ) ) {
V_22 = F_8 ( V_38 , F_21 ( V_41 ) - 1 ) ;
F_22 ( F_23 ( V_4 . V_26 , V_22 ) , V_40 ) ;
}
}
static void F_24 ( int V_38 , struct V_39 * V_40 ,
T_1 V_41 )
{
T_1 V_22 = F_8 ( V_38 , V_42 [ F_21 ( V_41 >> V_43 ) - 1 ] ) ;
F_22 ( F_23 ( V_4 . V_26 , V_22 ) , V_40 ) ;
}
T_4 void T_5 F_25 (
struct V_39 * V_40 )
{
T_1 V_41 , V_22 ;
while ( ( V_41 = F_20 ( V_4 . V_28 [ 0 ] ) & V_44 ) ) {
if ( V_41 & V_45 ) {
V_22 = F_8 ( 0 , F_21 ( V_41 & V_45 ) - 1 ) ;
F_22 ( F_23 ( V_4 . V_26 , V_22 ) , V_40 ) ;
} else if ( V_41 & V_46 ) {
F_24 ( 1 , V_40 , V_41 & V_46 ) ;
} else if ( V_41 & V_47 ) {
F_24 ( 2 , V_40 , V_41 & V_47 ) ;
} else if ( V_41 & V_48 ) {
F_19 ( 1 , V_40 ) ;
} else if ( V_41 & V_49 ) {
F_19 ( 2 , V_40 ) ;
