...
static int F_25 ( struct V_57 * V_12 )
{
int V_15 = 0 ;
struct V_1 * V_2 = NULL ;
...
struct V_58 V_48 ;
V_2 = F_26 ( & V_12 -> V_24 , sizeof( struct V_1 ) , V_59 ) ;
if ( ! V_2 )
return - V_60 ;
V_12 -> V_61 = 16 ;
V_15 = F_27 ( V_12 ) ;
...
V_2 -> V_12 = V_12 ;
V_2 -> V_24 = & V_12 -> V_24 ;
V_2 -> V_41 = V_12 -> V_24 . V_62 ;
if ( ! V_2 -> V_41 ) {
F_9 ( & V_12 -> V_24 , L_11 ) ;
return - V_46 ;
}
V_43 = F_28 ( L_12 , & V_12 -> V_24 , V_2 ,
& V_63 ) ;
if ( F_29 ( V_43 ) )
return F_30 ( V_43 ) ;
V_2 -> V_43 = V_43 ;
...
static int F_35 ( struct V_57 * V_12 )
{
...
static int F_38 ( struct V_69 * V_24 )
{
struct V_1 * V_2 = F_39 ( V_24 ) ;
F_40 ( V_24 , L_15 , V_2 -> V_35 ) ;
return F_18 ( V_2 , V_53 ) ;
}
static int F_41 ( struct V_69 * V_24 )
{
struct V_1 * V_2 = F_39 ( V_24 ) ;
V_2 -> V_35 = V_53 ;
return F_18 ( V_2 , V_52 ) ;
}
static void F_42 ( struct V_57 * V_12 )
{
struct V_1 * V_2 = F_36 ( V_12 ) ;
F_18 ( V_2 , V_53 ) ;
}
