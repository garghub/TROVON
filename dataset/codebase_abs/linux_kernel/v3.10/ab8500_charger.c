...
static int F_54 ( struct V_144 * V_145 ,
int V_147 , int V_148 )
{
T_1 V_180 = 0 ;
int V_8 = 0 ;
...
V_168 , & V_180 ) ;
if ( V_8 < 0 ) {
F_5 ( V_2 -> V_9 , L_52 , __LINE__ ) ;
return V_8 ;
}
F_2 ( V_2 -> V_9 , L_53 , V_180 ) ;
if ( ! ( V_180 & V_169 ) ) {
F_40 ( V_2 -> V_9 , L_54 ) ;
V_8 = F_55 ( V_2 -> V_9 ,
V_35 , V_181 ,
V_182 , V_182 ) ;
if ( V_8 < 0 ) {
F_5 ( V_2 -> V_9 , L_55 , __LINE__ ) ;
return V_8 ;
}
V_8 = F_50 ( & V_2 -> V_24 , true , V_147 , V_148 ) ;
if ( V_8 < 0 ) {
F_5 ( V_2 -> V_9 , L_56 ,
__LINE__ ) ;
return V_8 ;
...
static int F_61 ( struct V_175 * V_9 , void * V_174 )
{
struct V_14 * V_15 ;
struct V_14 * V_192 ;
struct V_1 * V_2 ;
...
static void F_72 ( struct V_207 * V_208 )
{
int V_8 ;
struct V_1 * V_2 = F_64 ( V_208 ,
struct V_1 , V_230 ) ;
...
{
struct V_1 * V_2 =
F_64 ( V_208 , struct V_1 , V_232 . V_208 ) ;
int V_8 ;
if ( ! V_2 -> V_17 . V_34 ) {
V_8 = F_38 ( V_2 ,
V_2 -> V_58 . V_59 ) ;
...
static void F_76 ( struct V_207 * V_208 )
{
int V_8 ;
unsigned long V_22 ;
struct V_1 * V_2 = F_64 ( V_208 ,
...
static T_3 F_82 ( int V_260 , void * V_261 )
{
...
static T_3 F_88 ( int V_260 , void * V_261 )
{
struct V_1 * V_2 = V_261 ;
V_2 -> V_75 = false ;
F_2 ( V_2 -> V_9 , L_82 ) ;
F_71 ( V_2 -> V_27 , & V_2 -> V_230 ) ;
return V_262 ;
}
...
if ( F_101 ( V_2 -> V_10 ) || F_102 ( V_2 -> V_10 )
|| F_103 ( V_2 -> V_10 ) || F_35 ( V_2 -> V_10 ) )
V_8 = F_55 ( V_2 -> V_9 ,
V_35 ,
V_292 ,
V_293 ,
...
static int F_105 ( struct V_171 * V_319 ,
unsigned long V_173 , void * V_320 )
{
struct V_1 * V_2 =
F_64 ( V_319 , struct V_1 , V_319 ) ;
enum V_321 V_322 ;
...
static int F_108 ( struct V_327 * V_328 )
{
int V_8 ;
struct V_1 * V_2 = F_109 ( V_328 ) ;
if ( V_2 -> V_160 && F_47 ( V_2 -> V_10 ) ) {
V_8 = F_6 ( V_2 -> V_9 , V_35 ,
V_186 , V_187 ) ;
if ( V_8 )
F_5 ( V_2 -> V_9 , L_59 ) ;
...
static int F_110 ( struct V_327 * V_328 ,
T_4 V_241 )
{
struct V_1 * V_2 = F_109 ( V_328 ) ;
F_52 ( & V_2 -> V_212 ) ;
...
static int F_114 ( struct V_327 * V_328 )
{
struct V_1 * V_2 = F_109 ( V_328 ) ;
int V_95 , V_260 , V_8 ;
F_44 ( & V_2 -> V_165 , false , 0 , 0 ) ;
F_50 ( & V_2 -> V_24 , false , 0 , 0 ) ;
for ( V_95 = 0 ; V_95 < F_28 ( V_330 ) ; V_95 ++ ) {
V_260 = F_115 ( V_328 , V_330 [ V_95 ] . V_198 ) ;
F_116 ( V_260 , V_2 ) ;
}
V_8 = F_55 ( V_2 -> V_9 ,
V_310 , V_314 , V_315 , 0 ) ;
...
V_2 -> V_16 = F_127 ( V_336 , L_108 ) ;
} else
V_2 -> V_16 = false ;
V_2 -> V_9 = & V_328 -> V_9 ;
V_2 -> V_10 = F_62 ( V_328 -> V_9 . V_10 ) ;
V_2 -> V_31 = F_128 ( L_109 ) ;
F_129 ( & V_2 -> V_105 . V_240 ) ;
F_130 ( & V_2 -> V_135 ) ;
V_2 -> V_20 = false ;
V_2 -> V_235 = 0 ;
V_2 -> V_165 . V_15 . V_198 = L_110 ;
V_2 -> V_165 . V_15 . type = V_184 ;
V_2 -> V_165 . V_15 . V_202 = V_345 ;
V_2 -> V_165 . V_15 . V_199 = F_28 ( V_345 ) ;
V_2 -> V_165 . V_15 . V_203 = F_97 ;
V_2 -> V_165 . V_15 . V_197 = V_346 ;
V_2 -> V_165 . V_15 . V_196 = F_28 ( V_346 ) ,
V_2 -> V_165 . V_347 . V_146 = & F_44 ;
V_2 -> V_165 . V_347 . V_348 = & F_56 ;
V_2 -> V_165 . V_347 . V_349 = & F_57 ;
V_2 -> V_165 . V_347 . V_350 = & F_58 ;
...
F_131 (
& V_333 , & V_172 ) ;
V_2 -> V_24 . V_15 . V_198 = L_111 ;
V_2 -> V_24 . V_15 . type = V_185 ;
V_2 -> V_24 . V_15 . V_202 = V_356 ;
V_2 -> V_24 . V_15 . V_199 = F_28 ( V_356 ) ;
V_2 -> V_24 . V_15 . V_203 = F_99 ;
V_2 -> V_24 . V_15 . V_197 = V_346 ;
V_2 -> V_24 . V_15 . V_196 = F_28 ( V_346 ) ,
V_2 -> V_24 . V_347 . V_146 = & F_50 ;
V_2 -> V_24 . V_347 . V_348 = & F_54 ;
V_2 -> V_24 . V_347 . V_349 = & F_57 ;
V_2 -> V_24 . V_347 . V_350 = & F_58 ;
V_2 -> V_24 . V_347 . V_357 = & F_59 ;
V_2 -> V_24 . V_347 . V_358 = & F_60 ;
V_2 -> V_24 . V_351 = V_97 [
F_28 ( V_97 ) - 1 ] ;
V_2 -> V_24 . V_352 =
V_2 -> V_100 -> V_101 [ V_2 -> V_100 -> V_102 - 1 ] ;
