...
#endif
F_109 ( V_25 ) ;
V_172 = F_110 ( & V_224 -> V_25 , & V_25 -> V_40 ) ;
if ( ! V_172 )
return V_172 ;
F_111 ( V_25 ) ;
#ifdef F_107
...
static void F_116 ( struct V_223 * V_178 )
{
F_1 () ;
}
static int T_7 F_117 ( struct V_223 * V_224 )
{
struct V_24 * V_25 = F_118 ( V_224 ) ;
if ( V_25 -> V_39 )
return - V_258 ;
F_119 ( & V_25 -> V_40 ) ;
V_25 -> F_53 = 0 ;
...
static int F_120 ( struct V_223 * V_25 , T_8 V_259 )
{
...
static int F_121 ( struct V_223 * V_25 )
{
struct V_24 * V_134 = F_118 ( V_25 ) ;
unsigned long V_48 ;
V_134 -> V_137 = 0 ;
