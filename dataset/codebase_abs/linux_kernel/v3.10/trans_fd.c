...
static int F_62 ( struct V_24 * V_18 , struct V_124 * V_125 )
{
struct V_29 * V_95 ;
struct V_92 * V_92 ;
int V_27 ;
...
{
F_9 ( V_52 , L_29 ,
V_2 , V_2 -> V_97 . V_130 , V_2 -> V_97 . V_79 ) ;
F_1 ( V_2 ) ;
F_72 ( & V_2 -> V_51 ) ;
F_72 ( & V_2 -> V_75 ) ;
F_7 ( V_2 , - V_101 ) ;
...
V_137 . V_142 = F_77 ( V_108 . V_113 ) ;
V_12 = F_78 ( F_79 ( & V_102 -> V_143 -> V_144 ) , V_145 ,
V_146 , V_147 , & V_125 , 1 ) ;
if ( V_12 ) {
F_65 ( L_31 ,
V_129 , F_66 ( V_102 ) ) ;
...
V_12 = V_125 -> V_148 -> V_149 ( V_125 ,
(struct V_150 * ) & V_137 ,
sizeof( struct V_136 ) , 0 ) ;
if ( V_12 < 0 ) {
F_65 ( L_32 ,
V_129 , F_66 ( V_102 ) , V_135 ) ;
F_67 ( V_125 ) ;
return V_12 ;
}
return F_62 ( V_18 , V_125 ) ;
}
static int
...
V_12 = F_78 ( F_79 ( & V_102 -> V_143 -> V_144 ) , V_156 ,
V_146 , 0 , & V_125 , 1 ) ;
if ( V_12 < 0 ) {
F_65 ( L_31 ,
V_129 , F_66 ( V_102 ) ) ;
...
V_12 = V_125 -> V_148 -> V_149 ( V_125 , (struct V_150 * ) & V_152 ,
sizeof( struct V_151 ) - 1 , 0 ) ;
if ( V_12 < 0 ) {
F_65 ( L_34 ,
V_129 , F_66 ( V_102 ) , V_135 , V_12 ) ;
F_67 ( V_125 ) ;
return V_12 ;
}
return F_62 ( V_18 , V_125 ) ;
