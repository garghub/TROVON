...
static int F_55 ( struct V_153 * V_154 , const int type )
{
...
F_11 ( V_162 ) ;
if ( V_154 )
snprintf ( V_103 , sizeof( V_103 ) , L_8 , F_56 ( V_154 ) ) ;
else {
V_29 = 0 ;
V_26 = V_163 ;
while ( V_26 ) {
...
static void T_6 F_69 ( struct V_153 * V_154 )
{
...
static int F_74 ( struct V_153 * V_26 )
{
...
static int T_6 F_76 ( struct V_153 * V_26 )
{
F_77 ( V_26 ) ;
F_69 ( V_26 ) ;
return 0 ;
