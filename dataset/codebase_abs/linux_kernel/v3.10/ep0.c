...
{
enum V_107 V_2 = V_8 -> V_108 . V_2 ;
T_3 V_120 ;
T_3 V_79 ;
V_120 = F_28 ( V_28 -> V_106 ) ;
if ( V_120 > 127 ) {
...
V_79 = F_31 ( V_8 -> V_89 , V_121 ) ;
V_79 &= ~ ( V_122 ) ;
V_79 |= F_36 ( V_120 ) ;
F_34 ( V_8 -> V_89 , V_121 , V_79 ) ;
if ( V_120 )
F_37 ( & V_8 -> V_108 , V_123 ) ;
else
F_37 ( & V_8 -> V_108 , V_124 ) ;
return 0 ;
}
static int F_38 ( struct V_7 * V_8 , struct V_77 * V_28 )
{
int V_18 ;
F_39 ( & V_8 -> V_60 ) ;
V_18 = V_8 -> V_125 -> V_126 ( & V_8 -> V_108 , V_28 ) ;
F_40 ( & V_8 -> V_60 ) ;
return V_18 ;
}
static int F_41 ( struct V_7 * V_8 , struct V_77 * V_28 )
{
enum V_107 V_2 = V_8 -> V_108 . V_2 ;
T_3 V_127 ;
int V_18 ;
...
static void F_42 ( struct V_56 * V_57 , struct V_58 * V_42 )
{
struct V_16 * V_17 = F_16 ( V_57 ) ;
struct V_7 * V_8 = V_17 -> V_8 ;
T_3 V_133 = 0 ;
...
static int F_44 ( struct V_7 * V_8 , struct V_77 * V_28 )
{
struct V_16 * V_17 ;
enum V_107 V_2 = V_8 -> V_108 . V_2 ;
T_6 V_141 ;
...
static int F_47 ( struct V_7 * V_8 , struct V_77 * V_28 )
{
int V_18 ;
switch ( V_28 -> V_144 ) {
case V_145 :
...
V_8 -> V_70 , 0 ,
V_171 ) ;
} else if ( ! F_56 ( V_42 -> V_43 . V_66 , V_17 -> V_61 . V_142 )
&& ( V_17 -> V_36 == 0 ) ) {
T_3 V_167 ;
T_3 V_142 ;
V_18 = F_57 ( & V_8 -> V_108 , & V_42 -> V_43 ,
V_17 -> V_36 ) ;
if ( V_18 ) {
F_7 ( V_8 -> V_22 , L_30 ) ;
return;
...
V_142 = V_17 -> V_61 . V_142 ;
V_167 = F_58 ( V_42 -> V_43 . V_66 , V_142 ) ;
V_8 -> V_166 = true ;
V_18 = F_2 ( V_8 , V_17 -> V_36 ,
V_8 -> V_173 , V_167 ,
V_171 ) ;
