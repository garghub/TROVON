...
for ( V_49 = ( void * ) V_52 -> V_5 ; V_49 ; V_49 = F_23 ( V_49 ) ) {
memcpy ( V_53 , V_49 -> V_5 , F_24 ( V_49 -> V_6 ) ) ;
...
V_1 -> V_62 . V_61 = V_60 ;
F_32 ( V_60 , 2 ) ;
V_1 -> V_19 = F_33 ( V_60 , NULL ,
V_63 , 0 , 2047 , 1 , 256 ) ;
V_1 -> V_20 = F_33 ( V_60 , NULL ,
V_64 , 0 , 255 , 1 , 200 ) ;
if ( V_60 -> error ) {
F_4 ( L_5 ) ;
return V_60 -> error ;
