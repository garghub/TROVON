...
F_43 ( V_76 -> V_79 , V_80 , sizeof( V_76 -> V_79 ) ) ;
F_43 ( V_76 -> V_81 , L_8 , sizeof( V_76 -> V_81 ) ) ;
}
...
static int F_50 ( struct V_19 * V_11 , void * V_96 )
{
struct V_3 * V_4 = F_6 ( V_11 ) ;
struct V_22 * V_83 = V_4 -> V_10 ;
...
V_101 = V_11 -> V_104 ;
V_102 = F_51 ( V_11 , V_96 ) ;
if ( V_102 != 0 )
return V_102 ;
V_102 = F_52 ( V_83 , V_98 -> V_105 ) ;
if ( V_102 != 0 ) {
...
static int F_55 ( struct V_22 * V_106 ,
...
V_20 -> V_110 = & V_111 ;
V_20 -> V_112 = V_113 ;
V_20 -> V_114 = V_113 | V_115 ;
F_59 ( V_20 , & V_116 ) ;
F_60 ( V_20 , & V_106 -> V_117 ) ;
V_24 = F_61 ( V_20 ) ;
if ( V_24 != 0 ) {
F_62 ( L_9 ) ;
F_63 ( V_20 ) ;
...
memcpy ( V_20 -> V_103 , V_85 . V_119 , V_100 ) ;
F_30 ( V_20 ) ;
V_118:
return V_24 ;
}
static int F_65 ( struct V_22 * V_106 )
{
struct V_19 * V_20 ;
struct V_3 * V_64 ;
struct V_6 * V_19 ;
