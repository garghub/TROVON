...
V_2 -> V_29 = NULL ;
if ( V_2 -> V_30 )
F_18 ( F_19 ( V_2 ) -> V_31 . V_32 ,
V_2 -> V_33 * sizeof ( V_34 ) ,
V_2 -> V_30 , V_2 -> V_35 ) ;
V_2 -> V_30 = NULL ;
F_13 ( V_2 -> V_36 ) ;
V_2 -> V_36 = NULL ;
...
V_2 -> V_30 = ( V_40 * )
F_22 ( F_19 ( V_2 ) -> V_31 . V_32 ,
V_2 -> V_33 * sizeof( V_40 ) ,
& V_2 -> V_35 , 0 ) ;
if ( V_2 -> V_30 == NULL ) {
goto V_25;
}
...
V_20 -> V_7 &= ~ V_43 ;
V_2 -> V_18 -> V_20 = V_20 ;
for ( V_37 = 0 ; V_37 < V_2 -> V_33 ; V_37 ++ )
V_2 -> V_30 [ V_37 ] = V_2 -> V_18 -> V_21 ;
} else {
for ( V_37 = 0 ; V_37 < V_2 -> V_33 ; V_37 ++ )
V_2 -> V_30 [ V_37 ] = F_3 ( V_2 ) ;
}
V_2 -> V_36 = F_23 ( V_2 -> V_33 , sizeof( void * ) , V_12 ) ;
if ( V_2 -> V_36 != NULL )
return 0 ;
V_25:
F_11 ( V_2 , L_7 ) ;
