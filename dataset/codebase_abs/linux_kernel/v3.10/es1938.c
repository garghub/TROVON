...
static int F_90 ( struct V_113 * V_166 )
{
struct V_167 * V_125 = F_91 ( V_166 ) ;
struct V_168 * V_116 = F_92 ( V_166 ) ;
...
static int F_99 ( struct V_113 * V_166 )
{
struct V_167 * V_125 = F_91 ( V_166 ) ;
struct V_168 * V_116 = F_92 ( V_166 ) ;
struct V_1 * V_2 = V_116 -> V_121 ;
...
{
struct V_181 * V_182 ;
V_2 -> V_181 = V_182 = F_105 () ;
if ( ! V_182 ) {
F_12 ( V_21 L_23 ) ;
return - V_183 ;
}
F_106 ( V_182 , L_24 ) ;
F_107 ( V_182 , L_25 , F_108 ( V_2 -> V_125 ) ) ;
F_109 ( V_182 , & V_2 -> V_125 -> V_166 ) ;
V_182 -> V_184 = V_2 -> V_185 ;
F_110 ( V_182 ) ;
return 0 ;
}
...
static inline int F_104 ( struct V_1 * V_2 ) { return - V_186 ; }
static inline void F_111 ( struct V_1 * V_2 ) { }
static int F_113 ( struct V_1 * V_2 )
{
F_3 ( 0x00 , F_21 ( V_2 , V_165 ) ) ;
if ( V_2 -> V_187 )
F_10 ( V_2 , V_188 , 0x40 , 0 ) ;
F_111 ( V_2 ) ;
if ( V_2 -> V_173 >= 0 )
F_95 ( V_2 -> V_173 , V_2 ) ;
F_114 ( V_2 -> V_125 ) ;
...
static int F_116 ( struct V_189 * V_113 )
{
struct V_1 * V_2 = V_113 -> V_190 ;
return F_113 ( V_2 ) ;
}
static int F_117 ( struct V_168 * V_116 ,
struct V_167 * V_125 ,
struct V_1 * * V_191 )
{
struct V_1 * V_2 ;
...
V_2 -> V_197 = F_124 ( V_125 , 0 ) ;
V_2 -> V_198 = F_124 ( V_125 , 1 ) ;
V_2 -> V_199 = F_124 ( V_125 , 2 ) ;
V_2 -> V_200 = F_124 ( V_125 , 3 ) ;
V_2 -> V_185 = F_124 ( V_125 , 4 ) ;
if ( F_103 ( V_125 -> V_173 , V_177 , V_178 ,
V_179 , V_2 ) ) {
...
#ifdef F_125
F_7 ( V_9 L_28 ,
V_2 -> V_197 , V_2 -> V_198 , V_2 -> V_199 , V_2 -> V_200 , V_2 -> V_185 ) ;
#endif
V_2 -> V_163 = V_2 -> V_199 + 0x00 ;
F_86 ( V_2 ) ;
if ( ( V_102 = F_126 ( V_116 , V_202 , V_2 , & V_193 ) ) < 0 ) {
F_113 ( V_2 ) ;
return V_102 ;
}
F_127 ( V_116 , & V_125 -> V_166 ) ;
* V_191 = V_2 ;
return 0 ;
}
static T_4 V_177 ( int V_173 , void * V_203 )
{
struct V_1 * V_2 = V_203 ;
unsigned char V_204 , V_205 ;
int V_206 = 0 ;
V_204 = F_9 ( F_21 ( V_2 , V_165 ) ) ;
#if 0
...
if ( V_204 & 0x40 ) {
int V_207 = F_8 ( V_2 , 0x64 ) & 0x80 ;
V_206 = 1 ;
F_129 ( V_2 -> V_116 , V_208 , & V_2 -> V_146 -> V_209 ) ;
F_129 ( V_2 -> V_116 , V_208 , & V_2 -> V_145 -> V_209 ) ;
if ( ! V_207 ) {
F_129 ( V_2 -> V_116 , V_208 ,
& V_2 -> V_144 -> V_209 ) ;
F_129 ( V_2 -> V_116 , V_208 ,
& V_2 -> V_143 -> V_209 ) ;
}
...
int V_102 ;
V_116 = V_2 -> V_116 ;
strcpy ( V_116 -> V_211 , L_11 ) ;
for ( V_210 = 0 ; V_210 < F_133 ( V_212 ) ; V_210 ++ ) {
struct V_126 * V_213 ;
V_213 = F_134 ( & V_212 [ V_210 ] , V_2 ) ;
switch ( V_210 ) {
case 0 :
V_2 -> V_143 = V_213 ;
V_213 -> V_214 = F_77 ;
...
if ( ( V_102 = F_135 ( V_116 , V_213 ) ) < 0 )
return V_102 ;
}
return 0 ;
}
static int F_136 ( struct V_167 * V_125 ,
...
V_102 = F_137 ( V_222 [ V_166 ] , V_209 [ V_166 ] , V_223 , 0 , & V_116 ) ;
if ( V_102 < 0 )
return V_102 ;
for ( V_210 = 0 ; V_210 < 5 ; V_210 ++ ) {
if ( F_124 ( V_125 , V_210 ) == 0 ||
! ( F_138 ( V_125 , V_210 ) & V_224 ) ) {
F_139 ( V_116 ) ;
return - V_25 ;
}
}
...
V_116 -> V_121 = V_2 ;
strcpy ( V_116 -> V_225 , L_24 ) ;
strcpy ( V_116 -> V_226 , L_29 ) ;
sprintf ( V_116 -> V_227 , L_30 ,
V_116 -> V_226 ,
V_2 -> V_228 ,
V_2 -> V_173 ) ;
...
if ( ( V_102 = F_141 ( V_218 , 0 , 1 ) ) < 0 ) {
F_139 ( V_116 ) ;
return V_102 ;
}
if ( ( V_102 = F_142 ( V_218 , 0 , 1 , NULL ) ) < 0 ) {
F_139 ( V_116 ) ;
return V_102 ;
}
}
if ( F_143 ( V_116 , 0 , V_232 ,
V_2 -> V_200 ,
V_233 | V_234 ,
- 1 , & V_2 -> V_187 ) < 0 ) {
F_12 ( V_21 L_32 ) ;
} else {
F_10 ( V_2 , V_188 , 0x40 , 0x40 ) ;
}
F_104 ( V_2 ) ;
...
static void F_146 ( struct V_167 * V_125 )
{
F_139 ( F_147 ( V_125 ) ) ;
F_145 ( V_125 , NULL ) ;
}
