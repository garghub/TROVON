...
if ( V_19 == NULL || V_8 == NULL || V_29 == NULL || V_1 < 0 ) {
F_47 ( & V_15 -> V_15 , L_5 ) ;
return - V_31 ;
}
...
struct V_5 * V_6 = V_4 -> V_6 ;
F_6 ( V_186 L_8 ) ;
#define F_64 ( T_5 ) printk(KERN_DEBUG "\t" #n " = \t%04x\n",\
...
static int F_66 ( struct V_14 * V_15 , T_6 V_101 )
{
struct V_3 * V_4 = F_9 ( V_15 ) ;
#ifdef F_4
struct V_5 * V_6 = V_4 -> V_6 ;
...
static void T_7 F_71 ( char * V_268 )
{
char * V_269 ;
if ( ! V_268 || ! * V_268 )
return;
while ( ( V_269 = F_72 ( & V_268 , L_11 ) ) != NULL ) {
if ( ! * V_269 )
continue;
}
}
