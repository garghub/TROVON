...
static int F_31 ( struct V_2 * V_3 , int V_21 )
{
struct V_5 * V_6 = F_6 ( V_3 ) ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
const struct V_94 * V_26 = V_4 -> V_26 ;
int V_8 ;
if ( V_26 == NULL ) {
F_32 ( 1 , L_5 ) ;
return - V_39 ;
...
{
const struct V_94 * V_26
= V_6 -> V_96 . V_97 ;
int V_8 ;
if ( V_26 -> V_95 ) {
V_8 = V_26 -> V_95 ( & V_6 -> V_96 , 1 ) ;
if ( V_8 )
return V_8 ;
}
V_8 = F_7 ( V_6 , V_98 ) ;
if ( V_26 -> V_95 )
V_26 -> V_95 ( & V_6 -> V_96 , 0 ) ;
if ( V_8 < 0 ) {
F_34 ( & V_6 -> V_96 , L_6 , V_60 ) ;
return V_8 ;
}
return V_8 == V_99 ? 0 : - V_100 ;
}
static int F_35 ( struct V_5 * V_6 ,
const struct V_101 * V_58 )
{
struct V_1 * V_4 ;
struct V_2 * V_3 ;
const struct V_94 * V_26
...
if ( V_8 )
return V_8 ;
V_4 = F_36 ( sizeof( * V_4 ) , V_103 ) ;
if ( ! V_4 )
return - V_104 ;
V_3 = & V_4 -> V_3 ;
strcpy ( V_3 -> V_105 , V_106 ) ;
V_4 -> V_26 = V_6 -> V_96 . V_97 ;
F_37 ( V_3 , V_6 , & V_107 ) ;
V_4 -> V_10 = - 1 ;
V_4 -> V_36 = 1 ;
V_4 -> V_23 = 1 ;
