...
int F_19 ( struct V_1 * V_2 , T_3 V_46 ,
union V_47 * V_48 )
{
return - V_49 ;
}
int F_20 ( struct V_1 * V_2 , T_3 V_46 ,
union V_47 * V_48 )
{
return - V_49 ;
}
struct V_1 * F_21 ( struct V_50 * V_50 , unsigned int V_46 )
{
struct V_8 * V_9 ;
struct V_1 * V_2 ;
int V_51 ;
...
int F_30 ( struct V_50 * V_50 )
{
return 0 ;
}
void F_31 ( struct V_50 * V_50 )
{
}
...
if ( V_4 )
return V_4 ;
return F_34 ( NULL , sizeof( struct V_8 ) , 0 , V_60 ) ;
}
