...
struct V_1 * F_19 ( struct V_1 * V_2 , int V_50 ,
struct V_51 * V_24 ,
unsigned int V_52 )
{
T_1 V_53 [] = { 0 } ;
...
( V_56 [ V_57 ] < F_20 ( V_59 ) ) )
V_52 = V_56 [ V_57 ] ;
F_21 ( V_52 < 1 || V_52 >= F_20 ( V_59 ) ) ;
V_29 = V_59 [ V_52 ] ;
if ( V_24 != NULL ) {
if ( V_2 -> V_22 . V_23 )
V_2 -> V_22 . V_23 ( V_2 , 1 ) ;
V_55 = F_7 ( V_24 , & V_15 , 1 ) ;
if ( V_55 != 1 )
return NULL ;
if ( V_2 -> V_22 . V_23 )
V_2 -> V_22 . V_23 ( V_2 , 0 ) ;
}
V_10 = F_22 ( sizeof( struct V_9 ) , V_60 ) ;
if ( V_10 == NULL )
return NULL ;
V_10 -> V_17 = V_50 ;
V_10 -> V_24 = V_24 ;
...
F_8 ( L_4 , V_10 -> V_61 ) ;
if ( V_24 != NULL )
F_8 ( L_5 , F_23 ( V_24 ) , V_50 ) ;
F_8 ( L_6 , V_52 , V_29 -> V_39 ,
V_56 [ V_10 -> V_61 ] == V_52 ?
L_7 : L_8 ) ;
}
return V_2 ;
