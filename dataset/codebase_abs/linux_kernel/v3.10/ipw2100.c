...
V_63 = F_298 ( & V_261 -> V_2 . V_697 , & V_698 ) ;
if ( V_63 )
goto V_71;
if ( ! ( V_6 -> V_49 & V_487 ) ) {
if ( F_83 ( V_6 ) ) {
...
static void F_306 ( struct V_261 * V_261 )
{
struct V_5 * V_6 = F_307 ( V_261 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
F_84 ( & V_6 -> V_266 ) ;
V_6 -> V_49 &= ~ V_622 ;
F_302 ( & V_261 -> V_2 . V_697 , & V_698 ) ;
#ifdef F_61
if ( V_120 . V_121 )
F_66 ( V_6 , & V_120 ) ;
#endif
...
static int F_308 ( struct V_261 * V_261 , T_13 V_102 )
{
struct V_5 * V_6 = F_307 ( V_261 ) ;
struct V_1 * V_2 = V_6 -> V_33 ;
F_31 ( L_263 , V_2 -> V_51 ) ;
