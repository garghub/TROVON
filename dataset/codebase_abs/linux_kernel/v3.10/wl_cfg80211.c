...
static T_5
F_67 ( struct V_75 * V_75 , struct V_64 * V_65 ,
struct V_215 * V_79 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
struct V_67 * V_68 = F_18 ( V_65 ) ;
...
static T_5 F_69 ( struct V_64 * V_65 ,
struct V_240 * V_241 )
{
struct V_210 * V_216 = F_70 ( V_65 ) ;
struct V_242 * V_243 ;
T_5 V_244 = 0 ;
T_5 V_66 = 0 ;
...
V_66 = F_71 ( F_18 ( V_65 ) , L_82 , V_244 ) ;
if ( V_66 ) {
F_19 ( L_83 , V_66 ) ;
return V_66 ;
}
...
V_66 = F_71 ( F_18 ( V_65 ) , L_89 , V_244 ) ;
if ( V_66 ) {
F_19 ( L_90 , V_66 ) ;
return V_66 ;
}
...
V_241 -> V_229 )
V_259 = V_268 ;
V_66 = F_71 ( F_18 ( V_65 ) , L_76 , V_259 | V_260 ) ;
if ( V_66 ) {
F_19 ( L_42 , V_66 ) ;
return V_66 ;
}
...
static T_5
F_74 ( struct V_64 * V_65 , struct V_240 * V_241 )
{
struct V_210 * V_216 = F_70 ( V_65 ) ;
struct V_242 * V_243 ;
T_5 V_244 = 0 ;
...
static
enum V_283 F_77 ( struct V_67 * V_68 ,
enum V_283 type )
{
T_4 V_284 ;
if ( type == V_257 ) {
...
static T_5
F_79 ( struct V_75 * V_75 , struct V_64 * V_65 ,
struct V_240 * V_241 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
struct V_67 * V_68 = F_18 ( V_65 ) ;
...
V_66 = F_69 ( V_65 , V_241 ) ;
if ( V_66 ) {
F_19 ( L_111 , V_66 ) ;
goto V_129;
}
V_241 -> V_254 = F_77 ( V_68 , V_241 -> V_254 ) ;
V_66 = F_72 ( V_65 , V_241 ) ;
if ( V_66 ) {
F_19 ( L_112 , V_66 ) ;
goto V_129;
}
...
static T_5
F_81 ( struct V_75 * V_75 , struct V_64 * V_65 ,
T_1 V_298 )
{
struct V_67 * V_68 = F_18 ( V_65 ) ;
struct V_210 * V_216 = & V_68 -> V_2 -> V_216 ;
...
static T_5
F_82 ( struct V_75 * V_75 , struct V_74 * V_119 ,
...
static T_5 F_84 ( struct V_75 * V_75 ,
struct V_74 * V_119 ,
T_5 * V_305 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
...
static T_5
F_86 ( struct V_75 * V_75 , struct V_64 * V_65 ,
...
static T_5
F_89 ( struct V_75 * V_75 , struct V_64 * V_65 ,
...
if ( V_318 ) {
F_3 ( V_73 , L_136 ) ;
return F_87 ( V_75 , V_65 , V_278 , V_318 , V_79 ) ;
}
memset ( & V_32 , 0 , sizeof( V_32 ) ) ;
V_32 . V_36 = ( T_4 ) V_79 -> V_277 ;
V_32 . V_55 = ( T_4 ) V_278 ;
...
void (* F_92) ( void * V_330 , struct V_319 * V_79 ) )
{
struct V_319 V_79 ;
struct V_67 * V_68 = F_18 ( V_65 ) ;
struct V_210 * V_216 = & V_68 -> V_2 -> V_216 ;
...
static T_5
F_94 ( struct V_75 * V_75 , struct V_64 * V_65 ,
...
V_333 -> V_339 = V_340 ;
V_333 -> V_341 = F_96 ( V_338 . V_342 ) * 1000 ;
if ( F_96 ( V_338 . V_57 ) & V_343 ) {
V_333 -> V_339 |= V_344 ;
V_333 -> V_345 = F_96 ( V_338 . V_346 ) ;
}
F_3 ( V_73 , L_145 ,
...
V_66 = F_98 ( V_68 , V_352 ,
& V_334 , sizeof( V_334 ) ) ;
if ( V_66 ) {
F_19 ( L_149 , V_66 ) ;
goto V_129;
} else {
V_335 = F_96 ( V_334 . V_244 ) ;
V_333 -> V_339 |= V_353 ;
V_333 -> signal = V_335 ;
...
static T_5
F_99 ( struct V_75 * V_75 , struct V_64 * V_65 ,
...
static T_5 F_100 ( struct V_94 * V_95 ,
struct V_363 * V_364 )
{
...
T_6 V_374 ;
T_5 V_375 ;
if ( F_96 ( V_364 -> V_376 ) > V_377 ) {
F_19 ( L_157 ) ;
return 0 ;
}
if ( ! V_364 -> V_378 ) {
V_20 . V_28 = F_101 ( V_364 -> V_139 ) ;
...
V_370 = F_102 ( V_234 , V_369 -> V_369 ) ;
V_365 = F_103 ( V_75 , V_370 ) ;
V_371 = F_101 ( V_364 -> V_384 ) ;
V_372 = F_101 ( V_364 -> V_385 ) ;
V_373 = ( T_2 * ) V_364 + F_101 ( V_364 -> V_386 ) ;
V_374 = F_96 ( V_364 -> V_387 ) ;
V_375 = ( V_388 ) F_101 ( V_364 -> V_389 ) * 100 ;
F_3 ( V_222 , L_158 , V_364 -> V_390 ) ;
F_3 ( V_222 , L_159 , V_234 , V_370 ) ;
F_3 ( V_222 , L_160 , V_371 ) ;
F_3 ( V_222 , L_161 , V_372 ) ;
F_3 ( V_222 , L_162 , V_375 ) ;
V_367 = F_104 ( V_75 , V_365 , ( const T_2 * ) V_364 -> V_390 ,
0 , V_371 , V_372 , V_373 ,
V_374 , V_375 , V_157 ) ;
if ( ! V_367 )
return - V_158 ;
...
static struct V_363 *
F_106 ( struct V_164 * V_391 , struct V_363 * V_367 )
{
if ( V_367 == NULL )
return V_391 -> V_392 ;
...
static T_5 F_107 ( struct V_94 * V_95 )
{
struct V_164 * V_393 ;
...
V_364 = F_106 ( V_393 , V_364 ) ;
V_66 = F_100 ( V_95 , V_364 ) ;
if ( V_66 )
break;
}
return V_66 ;
...
V_369 = V_75 -> V_381 [ V_383 ] ;
V_370 = F_102 ( V_20 . V_23 , V_369 -> V_369 ) ;
V_365 = F_103 ( V_75 , V_370 ) ;
V_371 = F_101 ( V_364 -> V_384 ) ;
V_372 = F_101 ( V_364 -> V_385 ) ;
V_373 = ( T_2 * ) V_364 + F_101 ( V_364 -> V_386 ) ;
...
static T_5 F_110 ( struct V_94 * V_95 ,
struct V_67 * V_68 )
{
struct V_210 * V_216 = F_70 ( V_68 -> V_65 ) ;
struct V_363 * V_364 ;
struct V_156 * V_149 ;
struct V_29 * V_399 ;
T_1 V_227 ;
...
if ( V_66 )
goto V_403;
V_38 = ( ( T_2 * ) V_364 ) + F_101 ( V_364 -> V_386 ) ;
V_226 = F_96 ( V_364 -> V_387 ) ;
V_227 = F_101 ( V_364 -> V_385 ) ;
V_399 = F_8 ( V_38 , V_226 , V_404 ) ;
if ( V_399 )
V_400 = V_399 -> V_62 [ 1 ] ;
else {
T_4 V_405 ;
V_66 = F_85 ( V_68 , L_170 , & V_405 ) ;
if ( V_66 ) {
F_19 ( L_171 , V_66 ) ;
goto V_403;
}
...
static void F_113 ( unsigned long V_62 )
{
struct V_94 * V_95 =
(struct V_94 * ) V_62 ;
if ( V_95 -> V_101 ) {
...
V_410 . V_28 = F_101 ( V_367 -> V_139 ) ;
V_95 -> V_18 . V_379 ( & V_410 ) ;
V_411 . V_28 = F_101 ( V_392 -> V_139 ) ;
...
if ( ( V_367 -> V_57 & V_412 ) ==
( V_392 -> V_57 & V_412 ) ) {
V_388 V_413 = F_101 ( V_367 -> V_389 ) ;
V_388 V_414 = F_101 ( V_392 -> V_389 ) ;
if ( V_414 > V_413 )
...
V_422 = F_96 ( V_392 -> V_376 ) ;
if ( V_422 != ( F_96 ( V_421 -> V_31 ) -
V_173 ) ) {
F_19 ( L_178 ,
V_422 ) ;
goto exit;
...
static void F_119 ( struct V_94 * V_95 )
{
F_120 ( V_95 -> V_430 , V_431 ,
F_116 ) ;
V_95 -> V_122 . V_167 = V_406 ;
F_121 ( & V_95 -> V_103 ) ;
V_95 -> V_103 . V_62 = ( unsigned long ) V_95 ;
V_95 -> V_103 . V_432 = F_113 ;
F_122 ( & V_95 -> V_409 ,
F_112 ) ;
}
static T_7 void F_123 ( T_4 V_433 )
{
if ( V_433 < 1000 / V_192 ) {
F_124 () ;
F_125 ( V_433 ) ;
...
static T_5 F_127 ( struct V_75 * V_75 )
{
F_3 ( V_73 , L_13 ) ;
return 0 ;
}
...
static T_5
F_131 ( struct V_75 * V_75 , struct V_64 * V_65 ,
struct V_445 * V_446 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
struct V_67 * V_68 = F_18 ( V_65 ) ;
...
V_66 = F_130 ( V_65 , V_95 -> V_437 , V_66 ) ;
F_3 ( V_73 , L_30 ) ;
return V_66 ;
}
static T_5
...
V_439 = F_96 ( V_95 -> V_437 -> V_440 . V_441 ) ;
for ( V_138 = 0 ; V_138 < V_439 ; V_138 ++ )
if ( ! memcmp
...
V_455 = F_96 ( V_454 -> V_172 ) ;
V_419 = F_96 ( V_454 -> V_419 ) ;
F_135 ( V_419 != V_458 ) ;
F_3 ( V_102 , L_189 , V_455 ) ;
if ( V_455 > 0 ) {
int V_138 ;
V_135 = F_46 ( sizeof( * V_135 ) , V_157 ) ;
V_149 = F_136 ( V_455 , sizeof( * V_149 ) , V_157 ) ;
V_234 = F_136 ( V_455 , sizeof( * V_234 ) , V_157 ) ;
...
static int F_138 ( struct V_64 * V_65 )
{
int V_463 ;
...
static int F_141 ( struct V_75 * V_75 ,
struct V_64 * V_65 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
F_3 ( V_102 , L_208 ) ;
...
static int F_142 ( struct V_75 * V_75 , void * V_62 , int V_36 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
struct V_64 * V_65 = F_63 ( V_95 ) ;
...
V_463 = F_98 ( F_18 ( V_65 ) , V_483 -> V_199 ,
V_483 -> V_30 , V_483 -> V_36 ) ;
if ( V_463 == 0 ) {
V_485 = F_143 ( V_75 , sizeof( * V_483 ) ) ;
F_144 ( V_485 , V_487 , sizeof( * V_483 ) , V_483 ) ;
V_463 = F_145 ( V_485 ) ;
}
return V_463 ;
}
static T_5 F_146 ( struct V_67 * V_68 )
{
T_5 V_66 ;
V_66 = F_71 ( V_68 , L_89 , 0 ) ;
if ( V_66 < 0 ) {
F_19 ( L_210 , V_66 ) ;
return V_66 ;
}
V_66 = F_71 ( V_68 , L_76 , 0 ) ;
if ( V_66 < 0 ) {
F_19 ( L_211 , V_66 ) ;
return V_66 ;
}
V_66 = F_71 ( V_68 , L_82 , V_488 ) ;
if ( V_66 < 0 ) {
F_19 ( L_212 , V_66 ) ;
return V_66 ;
}
...
static bool F_147 ( T_2 * V_41 , bool V_489 )
{
if ( V_489 )
...
static T_5
F_148 ( struct V_64 * V_65 , struct V_45 * V_286 ,
bool V_489 )
{
struct V_67 * V_68 = F_18 ( V_65 ) ;
T_4 V_478 = 0 ;
...
static T_5
F_149 ( const T_2 * V_508 , T_4 V_509 ,
struct V_510 * V_511 )
{
T_5 V_66 = 0 ;
struct V_45 * V_512 ;
...
static T_4
F_150 ( T_2 * V_522 , T_5 V_523 , T_2 * V_520 , T_4 V_226 , T_9 * V_524 )
{
V_396 V_525 ;
V_396 V_526 ;
...
T_5 F_80 ( struct V_1 * V_2 , T_5 V_523 ,
...
int V_138 ;
for ( V_138 = 0 ; V_138 < F_152 ( V_557 ) ; V_138 ++ )
F_80 ( V_2 , V_557 [ V_138 ] , NULL , 0 ) ;
...
static T_5
F_155 ( struct V_75 * V_75 , struct V_64 * V_65 ,
struct V_564 * V_565 )
{
T_5 V_386 ;
struct V_94 * V_95 = F_52 ( V_75 ) ;
...
F_153 ( V_68 -> V_2 , & V_565 -> V_559 ) ;
V_66 = F_154 ( V_95 , V_68 , V_565 -> V_223 . V_224 ) ;
if ( V_66 < 0 ) {
F_19 ( L_250 , V_66 ) ;
goto exit;
}
...
static int F_157 ( struct V_75 * V_75 , struct V_64 * V_65 )
{
struct V_67 * V_68 = F_18 ( V_65 ) ;
T_5 V_66 ;
struct V_568 V_569 ;
...
static T_5
F_158 ( struct V_75 * V_75 , struct V_64 * V_65 ,
struct V_558 * V_582 )
{
struct V_67 * V_68 = F_18 ( V_65 ) ;
T_5 V_66 ;
F_3 ( V_73 , L_13 ) ;
V_66 = F_153 ( V_68 -> V_2 , V_582 ) ;
return V_66 ;
}
static int
...
if ( V_587 )
V_2 -> V_590 |= F_118 ( V_588 ) ;
else
V_2 -> V_590 &= ~ F_118 ( V_588 ) ;
}
static int
F_161 ( struct V_75 * V_75 , struct V_74 * V_119 ,
...
& V_30 [ V_386 ] ,
V_226 ) ;
F_164 ( V_119 , * V_330 , V_30 , V_36 , true ,
V_157 ) ;
} else if ( F_165 ( V_596 -> V_603 ) ) {
...
V_602 = F_7 ( V_224 -> V_24 ) ;
V_600 -> V_234 = F_13 ( V_602 ) ;
memcpy ( V_598 -> V_62 , & V_30 [ V_571 ] ,
F_101 ( V_598 -> V_36 ) ) ;
F_3 ( V_73 , L_272 ,
* V_330 , F_101 ( V_598 -> V_36 ) ,
V_224 -> V_24 ) ;
V_601 = F_166 ( V_95 , F_63 ( V_95 ) ,
V_600 ) ;
F_164 ( V_119 , * V_330 , V_30 , V_36 , V_601 ,
V_157 ) ;
F_49 ( V_600 ) ;
} else {
F_3 ( V_73 , L_273 , V_596 -> V_603 ) ;
F_167 ( true , V_30 , V_36 , L_274 , V_36 ) ;
}
exit:
return V_66 ;
}
static int
F_168 ( struct V_75 * V_75 ,
struct V_74 * V_119 ,
T_10 V_330 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
...
static int F_170 ( struct V_75 * V_75 ,
struct V_74 * V_119 ,
enum V_606 V_607 ,
T_1 V_608 )
{
...
F_111 ( V_95 ) ;
return F_66 ( V_2 , V_610 , V_608 ) ;
}
static void F_171 ( struct V_75 * V_75 ,
struct V_74 * V_119 )
{
struct V_94 * V_95 = F_52 ( V_75 ) ;
struct V_1 * V_2 ;
...
static T_5 F_172 ( enum V_77 type )
{
switch ( type ) {
case V_83 :
case V_84 :
...
static void F_173 ( struct V_75 * V_75 )
{
V_75 -> V_613 = V_614 ;
V_75 -> V_615 = V_614 ;
V_75 -> V_616 = V_617 ;
...
static struct V_75 * F_174 ( struct V_619 * V_620 )
{
struct V_75 * V_75 ;
T_5 V_66 = 0 ;
V_75 = F_175 ( & V_621 , sizeof( struct V_94 ) ) ;
if ( ! V_75 ) {
F_19 ( L_277 ) ;
return F_23 ( - V_158 ) ;
}
...
F_118 ( V_90 ) ;
V_75 -> V_626 = V_627 ;
V_75 -> V_628 = F_152 ( V_627 ) ;
V_75 -> V_381 [ V_382 ] = & V_629 ;
V_75 -> V_630 = V_631 ;
V_75 -> V_632 = V_633 ;
V_75 -> V_634 = F_152 ( V_633 ) ;
V_75 -> V_57 |= V_635 |
V_636 |
V_637 ;
V_75 -> V_638 = V_639 ;
...
struct V_1 * F_180 ( struct V_94 * V_95 ,
enum V_77 type ,
bool V_643 )
{
struct V_1 * V_2 ;
...
V_2 -> V_647 = - 1 ;
F_64 ( & V_2 -> V_216 ) ;
F_181 ( & V_2 -> V_391 , & V_95 -> V_648 ) ;
V_95 -> V_644 ++ ;
return V_2 ;
}
void F_182 ( struct V_94 * V_95 ,
struct V_1 * V_2 )
{
F_183 ( & V_2 -> V_391 ) ;
V_95 -> V_644 -- ;
...
static bool F_185 ( const struct V_415 * V_416 )
{
T_4 V_649 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_649 == V_650 && V_419 == V_429 ) {
F_3 ( V_222 , L_281 ) ;
return true ;
}
return false ;
...
T_4 V_649 = V_416 -> V_456 ;
T_1 V_57 = V_416 -> V_57 ;
if ( V_649 == V_651 && ( ! ( V_57 & V_652 ) ) ) {
F_3 ( V_222 , L_282 ) ;
return true ;
}
return false ;
}
static bool F_187 ( struct V_94 * V_95 ,
const struct V_415 * V_416 )
{
T_4 V_649 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_649 == V_651 && V_419 == V_653 ) {
F_3 ( V_222 , L_283 ,
V_416 -> V_57 & V_652 ? L_284 : L_285 ) ;
return true ;
}
if ( V_649 == V_650 && V_419 != V_429 ) {
F_3 ( V_222 , L_286 ) ;
...
static T_5 F_190 ( struct V_94 * V_95 ,
struct V_67 * V_68 )
{
struct V_660 * V_661 ;
struct V_654 * V_655 = F_189 ( V_95 ) ;
...
V_661 =
(struct V_660 * ) V_95 -> V_401 ;
V_662 = F_96 ( V_661 -> V_662 ) ;
V_663 = F_96 ( V_661 -> V_663 ) ;
if ( V_662 ) {
V_66 = F_95 ( V_68 , L_289 ,
V_95 -> V_401 ,
V_664 ) ;
if ( V_66 ) {
F_19 ( L_290 , V_66 ) ;
...
F_3 ( V_222 , L_293 ,
V_655 -> V_657 , V_655 -> V_659 ) ;
return V_66 ;
}
static T_5
F_192 ( struct V_94 * V_95 ,
struct V_64 * V_65 ,
const struct V_415 * V_416 )
{
struct V_67 * V_68 = F_18 ( V_65 ) ;
...
F_3 ( V_73 , L_13 ) ;
F_190 ( V_95 , V_68 ) ;
memcpy ( V_216 -> V_104 , V_416 -> V_665 , V_105 ) ;
F_110 ( V_95 , V_68 ) ;
V_30 = F_46 ( V_377 , V_157 ) ;
if ( V_30 == NULL ) {
V_66 = - V_158 ;
...
V_129:
F_49 ( V_30 ) ;
F_193 ( V_65 , V_365 , ( T_2 * ) V_216 -> V_104 ,
V_655 -> V_656 , V_655 -> V_657 ,
V_655 -> V_658 , V_655 -> V_659 , V_157 ) ;
F_3 ( V_222 , L_294 ) ;
...
static T_5
F_196 ( struct V_94 * V_95 ,
struct V_64 * V_65 ,
const struct V_415 * V_416 , void * V_62 )
{
static int V_669 ;
T_4 V_649 = V_416 -> V_456 ;
T_4 V_670 = V_416 -> V_670 ;
struct V_332 V_333 ;
F_3 ( V_222 , L_297 , V_649 , V_670 ) ;
if ( V_649 == V_651 && V_670 == V_671 &&
V_65 != F_63 ( V_95 ) ) {
F_3 ( V_222 , L_298 ) ;
F_197 ( & V_95 -> V_672 ) ;
return 0 ;
}
if ( ( ( V_649 == V_673 ) || ( V_649 == V_674 ) ) &&
( V_670 == V_429 ) ) {
...
V_333 . V_676 = V_62 ;
V_333 . V_677 = V_416 -> V_678 ;
V_669 ++ ;
V_333 . V_669 = V_669 ;
F_198 ( V_65 , V_416 -> V_665 , & V_333 , V_157 ) ;
} else if ( ( V_649 == V_679 ) ||
( V_649 == V_680 ) ||
( V_649 == V_681 ) ) {
F_199 ( V_65 , V_416 -> V_665 , V_157 ) ;
}
return 0 ;
}
static T_5
...
T_5 V_66 = 0 ;
if ( V_68 -> V_2 -> V_70 == V_128 ) {
V_66 = F_196 ( V_95 , V_65 , V_416 , V_62 ) ;
} else if ( F_185 ( V_416 ) ) {
F_3 ( V_222 , L_300 ) ;
if ( F_109 ( V_68 -> V_2 ) ) {
memcpy ( V_216 -> V_104 , V_416 -> V_665 , V_105 ) ;
F_108 ( V_95 , V_65 , V_416 -> V_665 ) ;
F_201 ( V_65 , V_416 -> V_665 , V_157 ) ;
F_56 ( V_185 ,
& V_68 -> V_2 -> V_4 ) ;
F_40 ( V_212 ,
& V_68 -> V_2 -> V_4 ) ;
} else
F_194 ( V_95 , V_65 , V_416 , true ) ;
} else if ( F_186 ( V_416 ) ) {
F_3 ( V_222 , L_301 ) ;
if ( ! F_109 ( V_68 -> V_2 ) ) {
F_194 ( V_95 , V_65 , V_416 , false ) ;
if ( F_33 ( V_212 ,
& V_68 -> V_2 -> V_4 ) )
F_202 ( V_65 , 0 , NULL , 0 ,
V_157 ) ;
...
T_4 V_649 = V_416 -> V_456 ;
T_4 V_419 = V_416 -> V_419 ;
if ( V_649 == V_682 && V_419 == V_429 ) {
if ( F_2 ( V_212 , & V_68 -> V_2 -> V_4 ) )
F_192 ( V_95 , V_68 -> V_65 , V_416 ) ;
else
F_194 ( V_95 , V_68 -> V_65 , V_416 , true ) ;
}
return V_66 ;
}
static T_5
...
V_684 = V_687 ;
F_205 ( V_68 -> V_65 , ( T_2 * ) & V_416 -> V_665 , V_684 , - 1 ,
NULL , V_157 ) ;
return 0 ;
}
...
{
struct V_94 * V_95 = V_68 -> V_417 -> V_418 ;
struct V_688 * V_689 = (struct V_688 * ) V_62 ;
struct V_690 * V_649 = & V_95 -> V_691 ;
struct V_1 * V_2 ;
F_3 ( V_73 , L_302 ,
V_689 -> V_152 , V_689 -> V_57 , V_689 -> V_692 ,
V_689 -> V_423 ) ;
F_207 ( & V_649 -> V_693 ) ;
V_649 -> V_152 = V_689 -> V_152 ;
V_2 = V_649 -> V_2 ;
switch ( V_689 -> V_152 ) {
case V_694 :
if ( ! V_95 -> V_691 . V_2 ) {
...
static void F_212 ( struct V_699 * V_204 )
{
V_204 -> V_196 = ( T_4 ) - 1 ;
V_204 -> V_195 = ( T_4 ) - 1 ;
V_204 -> V_209 = ( T_4 ) - 1 ;
...
{
F_120 ( V_95 -> V_430 , V_651 ,
F_200 ) ;
F_120 ( V_95 -> V_430 , V_680 ,
F_200 ) ;
F_120 ( V_95 -> V_430 , V_681 ,
F_200 ) ;
F_120 ( V_95 -> V_430 , V_679 ,
F_200 ) ;
F_120 ( V_95 -> V_430 , V_673 ,
F_200 ) ;
F_120 ( V_95 -> V_430 , V_674 ,
F_200 ) ;
F_120 ( V_95 -> V_430 , V_682 ,
F_203 ) ;
F_120 ( V_95 -> V_430 , V_700 ,
F_204 ) ;
F_120 ( V_95 -> V_430 , V_650 ,
F_200 ) ;
F_120 ( V_95 -> V_430 , V_701 ,
F_134 ) ;
F_120 ( V_95 -> V_430 , V_702 ,
F_206 ) ;
F_120 ( V_95 -> V_430 , V_703 ,
V_704 ) ;
F_120 ( V_95 -> V_430 , V_705 ,
V_706 ) ;
F_120 ( V_95 -> V_430 , V_707 ,
V_708 ) ;
F_120 ( V_95 -> V_430 , V_709 ,
V_710 ) ;
F_120 ( V_95 -> V_430 , V_711 ,
V_710 ) ;
}
...
static void F_220 ( struct V_690 * V_649 )
{
F_221 ( & V_649 -> V_696 ) ;
F_217 ( & V_649 -> V_693 ) ;
}
struct V_94 * F_222 ( struct V_717 * V_417 ,
struct V_619 * V_718 )
{
struct V_64 * V_65 = V_417 -> V_719 [ 0 ] -> V_65 ;
struct V_94 * V_95 ;
struct V_75 * V_75 ;
struct V_1 * V_2 ;
struct V_67 * V_68 ;
...
V_66 = F_97 ( V_68 , V_723 ,
& V_720 ) ;
if ( V_66 ) {
F_19 ( L_307 , V_66 ) ;
goto V_722;
}
V_95 -> V_18 . V_720 = ( T_2 ) V_720 ;
F_228 ( & V_95 -> V_18 ) ;
return V_95 ;
V_722:
F_219 ( V_95 ) ;
...
static T_5
F_232 ( struct V_67 * V_68 , T_4 V_725 , T_4 V_726 )
{
T_5 V_66 = 0 ;
V_396 V_727 [ 2 ] ;
V_396 V_728 [ 2 ] ;
if ( V_725 ) {
V_66 = F_21 ( V_68 , L_308 , V_726 ) ;
if ( V_66 ) {
F_19 ( L_309 , V_66 ) ;
goto V_729;
}
}
F_3 ( V_5 , L_310 , V_725 ? L_311 : L_312 ) ;
V_66 = F_21 ( V_68 , L_313 , V_725 ) ;
if ( V_66 ) {
F_19 ( L_314 , V_66 ) ;
goto V_729;
}
V_727 [ 0 ] = F_13 ( V_730 ) ;
V_727 [ 1 ] = F_13 ( V_731 ) ;
V_66 = F_29 ( V_68 , V_732 ,
( void * ) V_727 , sizeof( V_727 ) ) ;
if ( V_66 ) {
F_19 ( L_315 , V_66 ) ;
goto V_729;
}
...
static T_5
F_233 ( struct V_67 * V_68 , T_5 V_735 ,
T_5 V_736 , T_5 V_737 )
{
T_5 V_66 = 0 ;
V_66 = F_41 ( V_68 , V_738 ,
V_735 ) ;
if ( V_66 ) {
if ( V_66 == - V_87 )
F_3 ( V_5 , L_317 ) ;
...
static T_5 F_234 ( struct V_94 * V_95 , T_4 V_742 )
{
struct V_67 * V_68 = F_18 ( F_63 ( V_95 ) ) ;
struct V_19 * V_743 ;
struct V_744 * V_391 ;
...
bool V_751 ;
T_4 V_752 ;
V_745 = F_46 ( V_159 , V_157 ) ;
if ( V_745 == NULL )
return - V_158 ;
V_391 = (struct V_744 * ) V_745 ;
V_66 = F_95 ( V_68 , L_323 , V_745 ,
V_159 ) ;
if ( V_66 ) {
F_19 ( L_324 , V_66 ) ;
goto exit;
...
V_629 . V_137 = 0 ;
V_753 . V_137 = 0 ;
V_746 = F_96 ( V_391 -> V_172 ) ;
for ( V_138 = 0 ; V_138 < V_746 ; V_138 ++ ) {
V_20 . V_28 = ( T_1 ) F_96 ( V_391 -> V_754 [ V_138 ] ) ;
V_95 -> V_18 . V_379 ( & V_20 ) ;
if ( V_20 . V_369 == V_398 ) {
V_743 = V_755 ;
V_752 = F_152 ( V_755 ) ;
...
if ( ! V_749 && V_20 . V_25 == V_760 )
continue;
V_751 = false ;
for ( V_438 = 0 ; ( V_438 < * V_748 && ( * V_748 < V_752 ) ) ; V_438 ++ ) {
if ( V_743 [ V_438 ] . V_144 == V_20 . V_23 ) {
V_751 = true ;
break;
}
}
...
if ( V_55 < V_752 ) {
V_743 [ V_55 ] . V_24 =
F_102 ( V_20 . V_23 , V_369 ) ;
V_743 [ V_55 ] . V_144 = V_20 . V_23 ;
if ( V_20 . V_25 == V_760 && V_749 ) {
V_750 = V_743 [ V_55 ] . V_57 &
V_462 ;
if ( V_20 . V_761 == V_762 ) {
if ( V_750 == V_462 )
V_743 [ V_55 ] . V_57 &=
...
T_4 V_774 ;
T_5 V_138 ;
struct V_368 * V_381 [ V_775 ] ;
T_5 V_55 ;
V_66 = F_98 ( V_68 , V_776 ,
& V_770 , sizeof( V_770 ) ) ;
if ( V_66 ) {
F_19 ( L_327 , V_66 ) ;
return V_66 ;
...
F_3 ( V_5 , L_330 ,
V_771 [ 0 ] , V_771 [ 1 ] , V_771 [ 2 ] ) ;
V_66 = F_85 ( V_68 , L_331 , & V_772 ) ;
if ( V_66 ) {
F_19 ( L_332 , V_66 ) ;
} else {
V_66 = F_85 ( V_68 , L_333 , & V_742 ) ;
if ( V_66 )
F_19 ( L_334 , V_66 ) ;
}
F_3 ( V_5 , L_335 , V_772 , V_742 ) ;
V_66 = F_234 ( V_95 , V_742 ) ;
if ( V_66 ) {
F_19 ( L_336 , V_66 ) ;
return V_66 ;
}
...
for ( V_138 = 1 ; V_138 <= V_774 && V_138 < F_152 ( V_771 ) ; V_138 ++ ) {
V_55 = - 1 ;
if ( ( V_771 [ V_138 ] == V_778 ) &&
( V_753 . V_137 > 0 ) ) {
V_55 = V_383 ;
V_381 [ V_55 ] = & V_753 ;
if ( ( V_742 == V_756 ) ||
( V_742 == V_779 ) )
V_381 [ V_55 ] -> V_780 . V_781 |=
V_782 ;
} else if ( ( V_771 [ V_138 ] == V_783 ) &&
( V_629 . V_137 > 0 ) ) {
V_55 = V_382 ;
V_381 [ V_55 ] = & V_629 ;
if ( V_742 == V_756 )
...
if ( ( V_55 >= 0 ) && V_772 ) {
V_381 [ V_55 ] -> V_780 . V_781 |= V_784 ;
V_381 [ V_55 ] -> V_780 . V_781 |= V_785 ;
V_381 [ V_55 ] -> V_780 . V_786 = true ;
V_381 [ V_55 ] -> V_780 . V_787 =
V_788 ;
V_381 [ V_55 ] -> V_780 . V_789 =
V_790 ;
V_381 [ V_55 ] -> V_780 . V_791 . V_792 [ 0 ] = 0xff ;
}
}
V_75 = F_31 ( V_95 ) ;
...
F_233 ( V_68 , V_794 ,
V_795 , V_796 ) ;
V_793 = V_95 -> V_358 ? V_359 : V_360 ;
V_66 = F_41 ( V_68 , V_361 , V_793 ) ;
if ( V_66 )
goto V_797;
F_3 ( V_5 , L_337 ,
( V_793 ? L_154 : L_155 ) ) ;
V_66 = F_232 ( V_68 , ( V_95 -> V_714 ? 0 : 1 ) , V_798 ) ;
if ( V_66 )
goto V_797;
...
T_4 F_243 ( struct V_94 * V_95 , unsigned long V_799 )
{
struct V_1 * V_2 ;
bool V_313 = 0 ;
F_129 (vif, &cfg->vif_list, list) {
if ( F_2 ( V_799 , & V_2 -> V_4 ) )
V_313 ++ ;
}
return V_313 ;
}
static inline bool F_244 ( struct V_690 * V_649 ,
T_2 V_152 )
{
T_2 V_800 ;
F_207 ( & V_649 -> V_693 ) ;
...
{
struct V_690 * V_649 = & V_95 -> V_691 ;
return F_247 ( V_649 -> V_696 ,
F_244 ( V_649 , V_152 ) , V_356 ) ;
}
