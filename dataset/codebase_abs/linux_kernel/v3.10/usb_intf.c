...
static T_5 F_20 ( T_5 V_64 , T_5 V_65 )
{
return ( F_21 ( V_64 ) << 4 ) | F_21 ( V_65 ) ;
}
...
if ( V_77 & V_85 ) {
V_78 = true ;
V_77 = F_31 ( V_10 , V_86 + 3 ) ;
F_32 ( V_10 , V_86 + 3 , V_77 | 0x80 ) ;
F_33 ( 20 ) ;
F_32 ( V_10 , V_86 + 3 ,
( V_77 & ( ~ F_34 ( 7 ) ) ) ) ;
V_77 = ( T_5 ) ( ( F_35 ( V_10 , V_87 ) >> 15 ) &
0x1F ) ;
if ( V_77 == 0x3 )
V_10 -> V_60 . V_88 =
V_89 ;
...
F_11 ( & V_66 -> V_40 , L_13 ,
V_10 -> V_81 . V_97 ) ;
switch ( V_10 -> V_81 . V_97 ) {
case V_120 :
case V_98 :
case V_100 :
V_10 -> V_121 . V_122 = V_123 ;
V_10 -> V_121 . V_124 = true ;
break;
case V_102 :
V_10 -> V_121 . V_122 = V_125 ;
V_10 -> V_121 . V_124 = true ;
break;
case V_104 :
case V_106 :
V_10 -> V_121 . V_122 = V_126 ;
V_10 -> V_121 . V_124 = true ;
break;
case V_108 :
V_10 -> V_121 . V_122 = V_127 ;
V_10 -> V_121 . V_124 = true ;
break;
case V_110 :
V_10 -> V_121 . V_122 = V_128 ;
V_10 -> V_121 . V_124 = true ;
break;
case V_112 :
V_10 -> V_121 . V_122 = V_129 ;
V_10 -> V_121 . V_124 = true ;
break;
default:
V_10 -> V_121 . V_122 = V_130 ;
V_10 -> V_121 . V_124 = false ;
break;
}
} else
V_78 = false ;
...
if ( V_92 ) {
V_76 [ 0 ] &= 0xFE ;
F_11 ( & V_66 -> V_40 , L_14 , V_76 ) ;
} else
F_11 ( & V_66 -> V_40 , L_15 , V_76 ) ;
...
{
struct V_4 * V_5 = F_2 ( V_2 ) ;
struct V_9 * V_10 = F_27 ( V_5 ) ;
struct V_26 * V_66 = F_24 ( V_2 ) ;
F_28 ( V_2 , NULL ) ;
if ( V_10 -> V_135 )
F_43 ( V_10 -> V_136 ) ;
F_44 ( & V_10 -> V_137 ) ;
