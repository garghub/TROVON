...
static void F_47 ( struct V_69 * V_19 )
{
...
if ( F_49 ( V_71 ) )
break;
V_14 = F_50 ( V_71 -> V_72 , struct V_13 , V_18 ) ;
F_51 ( V_71 -> V_72 ) ;
F_11 ( & V_2 -> V_17 , V_10 ) ;
V_21 = & V_14 -> V_21 ;
...
static T_1 F_52 ( struct V_15 * V_15 , T_1 V_73 , int V_5 )
{
F_53 ( V_73 || V_5 ,
L_23 , V_74 ) ;
return V_15 -> V_75 ;
...
V_2 = F_57 ( sizeof( struct V_1 ) , V_83 ) ;
V_15 -> V_16 = V_2 ;
if ( ! V_2 ) {
F_7 ( V_12
L_25 ,
...
V_15 -> V_63 -> V_53 . V_87 = F_27 ;
V_15 -> V_63 -> V_53 . V_88 = V_15 ;
if ( F_46 ( V_15 ) )
goto V_84;
return 0 ;
V_84:
