...
V_8 -> V_183 . F_24 = F_24 ;
V_8 -> V_183 . F_26 = F_26 ;
V_8 -> V_183 . V_228 = 0x1f ;
V_8 -> V_183 . V_229 = 0x1f ;
V_8 -> V_184 = F_114 ( V_230 , V_231
| V_232 | V_233 ) ;
...
F_33 ( V_8 ) ;
if ( V_8 -> V_71 & V_72 ) {
F_115 ( & V_218 -> V_6 , L_28 ) ;
F_98 ( V_8 ) ;
}
V_8 -> V_33 = F_97 ( V_8 ) ;
if ( V_8 -> V_33 == 0xff ) {
F_116 ( & V_218 -> V_6 , L_29 ) ;
V_8 -> V_33 = 1 ;
}
V_8 -> V_183 . V_49 = V_8 -> V_33 ;
F_117 ( V_218 , V_8 ) ;
F_118 ( V_17 , & V_218 -> V_6 ) ;
F_82 ( V_17 ) ;
V_51 = F_119 ( V_17 ) ;
if ( V_51 )
goto V_236;
F_102 ( V_204 , & V_8 -> V_203 ,
V_205 ) ;
F_115 ( & V_218 -> V_6 , L_30 , V_17 -> V_237 ,
...
static void F_121 ( struct V_217 * V_218 )
{
struct V_8 * V_8 = F_122 ( V_218 ) ;
F_117 ( V_218 , NULL ) ;
if ( ! V_8 ) {
F_2 ( & V_218 -> V_6 , L_31 ) ;
return;
...
static int F_125 ( struct V_217 * V_218 , T_9 V_238 )
{
struct V_8 * V_8 = F_122 ( V_218 ) ;
F_18 ( V_8 -> V_17 ) ;
F_123 ( & V_8 -> V_203 ) ;
...
V_220 [ V_36 ] . V_243 = V_244 ;
V_220 [ V_36 ] . V_210 = V_239 ;
V_220 [ V_36 ] . V_212 = V_240 ;
}
static int T_10 F_132 ( void )
{
F_131 ( L_34 V_245 L_35 , V_167 , V_169 ) ;
if ( V_246 )
F_128 ( V_246 ) ;
return F_133 ( & V_247 ) ;
}
