...
int V_84 ;
int V_29 ;
V_84 = F_24 ( & V_83 , V_85 , & V_2 -> V_18 -> V_86 ) ;
if ( V_84 )
return V_84 ;
F_1 ( V_2 , 0xC6 , 0x40 ) ;
F_1 ( V_2 , 0x3D , 0x04 ) ;
...
F_1 ( V_2 , 0x3B , 0x00 ) ;
F_1 ( V_2 , 0x38 , 0x00 ) ;
for ( V_29 = 0 ; V_29 < V_83 -> V_87 ; V_29 ++ ) {
F_1 ( V_2 , 0x38 , 0x00 ) ;
...
static int F_26 ( struct V_88 * V_89 )
{
struct V_1 * V_2 =
...
{
struct V_1 * V_96 = V_89 -> V_90 ;
F_2 ( L_12 , V_17 ) ;
F_28 ( V_96 ) ;
}
static int F_29 ( struct V_88 * V_89 , const T_1 V_6 [] , int V_10 )
{
...
struct V_1 * V_2 = V_89 -> V_90 ;
F_2 ( L_12 , V_17 ) ;
if ( V_89 -> V_98 . V_99 . V_100 ) {
V_89 -> V_98 . V_99 . V_100 ( V_89 ) ;
if ( V_89 -> V_98 . V_101 )
V_89 -> V_98 . V_101 ( V_89 , 0 ) ;
}
F_19 ( V_2 ) ;
F_6 ( 10 ) ;
return 0 ;
...
static int F_33 ( struct V_88 * V_89 , T_5 * V_124 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
T_4 V_5 ;
T_1 V_28 , V_48 = 0 ;
...
T_1 V_131 [ 2 ] , V_132 ;
F_2 ( L_21 , V_17 ) ;
F_4 ( V_2 , 0x3F , & V_131 [ 0 ] ) ;
F_4 ( V_2 , 0x3E , & V_131 [ 1 ] ) ;
V_130 = V_131 [ 0 ] ;
V_130 <<= 8 ;
V_130 |= V_131 [ 1 ] ;
F_2 ( L_22 , V_130 ) ;
...
static int F_37 ( struct V_88 * V_89 , T_6 * signal )
{
struct V_1 * V_2 = V_89 -> V_90 ;
if ( V_2 -> V_12 -> V_14 == V_43 )
...
static int F_38 ( struct V_88 * V_89 , T_6 * V_136 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
T_1 V_28 ;
* V_136 = 0 ;
...
static int F_39 ( struct V_88 * V_89 , T_2 * V_137 )
{
* V_137 = 0 ;
F_2 ( L_29 , V_17 , * V_137 ) ;
return 0 ;
...
static int F_42 ( struct V_88 * V_89 , T_2 * V_139 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
T_1 V_140 , V_141 , V_28 ;
T_2 V_142 = 0 , V_143 = 0 ;
int V_29 ;
F_2 ( L_12 , V_17 ) ;
F_40 ( V_2 ) ;
...
F_41 ( V_2 ) ;
if ( V_2 -> V_12 -> V_14 == V_15 ) {
V_141 = 0x28 ; V_140 = 0x2C ;
} else {
V_141 = 0xD0 ; V_140 = 0xD4 ;
}
for ( V_29 = 0 ; V_29 < 4 ; V_29 ++ ) {
V_142 <<= 8 ;
F_4 ( V_2 , V_141 + 3 - V_29 , & V_28 ) ;
V_142 |= V_28 ;
}
for ( V_29 = 0 ; V_29 < 4 ; V_29 ++ ) {
V_143 <<= 8 ;
...
F_2 ( L_30 , V_143 , V_142 ) ;
if ( V_142 == 0 )
* V_139 = 0 ;
else
* V_139 = V_143 * 100 / V_142 ;
F_2 ( L_31 , V_17 , * V_139 ) ;
return 0 ;
}
static int F_43 ( struct V_88 * V_89 , int V_144 )
{
struct V_1 * V_2 = V_89 -> V_90 ;
if ( V_2 -> V_12 -> V_145 == 0 )
return 0 ;
if ( V_144 ) {
T_1 V_130 = 0x80 | V_2 -> V_12 -> V_145 ;
return F_1 ( V_2 , 0x01 , V_130 ) ;
}
return F_1 ( V_2 , 0x01 , 0 ) ;
}
struct V_88 * F_44 ( const struct V_30 * V_12 ,
struct V_146 * V_18 )
{
struct V_1 * V_2 = NULL ;
T_1 V_4 = 0 ;
...
return NULL ;
V_2 = F_45 ( sizeof( struct V_1 ) , V_147 ) ;
if ( V_2 == NULL )
goto V_148;
V_2 -> V_12 = V_12 ;
V_2 -> V_18 = V_18 ;
