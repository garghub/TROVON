...
F_11 ( V_32 . V_33 ) ;
if ( V_8 -> V_28 . V_34 == F_12 ( V_35 ) )
{
V_25 * V_36 = ( V_25 * ) V_8 -> V_26 ;
if ( * V_36 & F_10 ( 0xffff0000 ) )
* V_36 = F_10 ( V_27 ) ;
}
if ( V_8 -> V_28 . V_29 & F_10 ( V_37 | V_38 ) )
{
if ( V_8 -> V_28 . V_29 & F_10 ( V_37 ) )
F_11 ( V_32 . V_39 ) ;
else
F_11 ( V_32 . V_40 ) ;
V_9 -> V_11 &= V_31 ;
...
V_7 = & V_4 -> V_53 [ V_15 ] ;
if ( V_4 -> V_54 )
if( ( V_9 = F_15 ( sizeof( struct V_9 ) , V_55 ) ) == NULL )
V_9 = & V_52 ;
...
static void F_20 ( void * V_62 , struct V_9 * V_63 )
{
struct V_9 * V_52 ;
struct V_3 * V_4 ;
struct V_64 * V_65 ;
...
F_22 ( V_4 , 0 , 1 , 0 , V_63 -> V_18 ) ;
F_23 ( V_52 ) ;
V_65 = (struct V_64 * ) F_24 ( V_52 ) ;
V_65 -> V_68 = F_10 ( V_69 ) ;
V_66 = F_25 ( V_70 ,
V_52 ,
...
unsigned long V_11 ;
if ( ( ! V_4 -> V_54 )
|| ( ! ( V_9 = F_27 ( sizeof( struct V_9 ) , V_55 ) ) ) )
return 1 ;
if ( ! ( V_7 = F_27 ( sizeof( struct V_7 ) , V_55 ) ) ) {
F_28 ( V_9 ) ;
return 1 ;
}
if ( V_76 != NULL ) {
