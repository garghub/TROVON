...
{
return fprintf ( V_48 , L_13 V_49 L_14 V_49 L_13 V_49 L_15 ,
...
{
T_4 V_70 = fprintf ( V_48 , L_18 , V_71 [ type ] ) ;
struct V_12 * V_31 ;
for ( V_31 = F_13 ( & V_56 -> V_59 [ type ] ) ; V_31 ; V_31 = F_39 ( V_31 ) ) {
struct V_2 * V_64 = F_14 ( V_31 , struct V_2 , V_12 ) ;
V_70 += fprintf ( V_48 , L_19 ) ;
V_70 += F_33 ( V_64 , V_48 ) ;
if ( V_69 > 2 ) {
