...
for ( V_23 = 0 ; V_23 < V_325 ; V_23 ++ ) {
V_60 = V_39 -> V_59 [ V_23 ] . V_60 ;
if ( ! V_60 )
continue;
V_254 -> V_299 = V_326 ;
V_254 -> V_120 = 0 ;
V_254 -> V_327 = ( V_60 -> V_248 == 0 ) ? 0 : V_328 ;
...
V_254 -> V_299 = V_300 ;
V_254 -> V_332 = V_333 ;
V_40 = F_140 ( V_60 , V_254 , V_303 | V_334 ) ;
if ( V_40 ) {
F_62 (KERN_ERR PFX L_27
L_30 , i, ret) ;
goto V_99;
...
static void F_154 ( struct V_335 * V_336 , void * V_337 )
{
struct V_91 * V_59 = V_337 ;
F_62 (KERN_ERR PFX L_34 ,
event->event, qp_info->qp->qp_num) ;
}
static void F_155 ( struct V_91 * V_59 ,
struct V_107 * V_108 )
{
V_108 -> V_59 = V_59 ;
V_108 -> V_110 = 0 ;
...
{
V_59 -> V_39 = V_39 ;
F_155 ( V_59 , & V_59 -> V_209 ) ;
F_155 ( V_59 , & V_59 -> V_296 ) ;
F_22 ( & V_59 -> V_215 ) ;
F_21 ( & V_59 -> V_95 ) ;
V_59 -> V_97 = NULL ;
V_59 -> V_96 = 0 ;
...
static int F_157 ( struct V_91 * V_59 ,
enum V_10 V_11 )
{
struct V_338 V_339 ;
int V_40 ;
memset ( & V_339 , 0 , sizeof V_339 ) ;
V_339 . V_340 = V_59 -> V_39 -> V_307 ;
V_339 . V_341 = V_59 -> V_39 -> V_307 ;
V_339 . V_342 = V_343 ;
V_339 . V_344 . V_345 = V_346 ;
V_339 . V_344 . V_347 = V_348 ;
V_339 . V_344 . V_349 = V_350 ;
V_339 . V_344 . V_351 = V_352 ;
V_339 . V_11 = V_11 ;
V_339 . V_4 = V_59 -> V_39 -> V_4 ;
V_339 . V_337 = V_59 ;
V_339 . V_353 = F_154 ;
V_59 -> V_60 = F_158 ( V_59 -> V_39 -> V_66 , & V_339 ) ;
if ( F_19 ( V_59 -> V_60 ) ) {
F_62 (KERN_ERR PFX L_35 ,
get_spl_qp_index(qp_type)) ;
V_40 = F_159 ( V_59 -> V_60 ) ;
goto error;
}
V_59 -> V_209 . V_214 = V_346 ;
V_59 -> V_296 . V_214 = V_348 ;
return 0 ;
error:
return V_40 ;
}
static void F_160 ( struct V_91 * V_59 )
{
if ( ! V_59 -> V_60 )
return;
F_161 ( V_59 -> V_60 ) ;
...
F_21 ( & V_39 -> V_82 ) ;
F_22 ( & V_39 -> V_87 ) ;
F_156 ( V_39 , & V_39 -> V_59 [ 0 ] ) ;
F_156 ( V_39 , & V_39 -> V_59 [ 1 ] ) ;
V_354 = V_346 + V_348 ;
V_356 = F_163 ( V_3 , V_4 ) == V_357 ;
if ( V_356 )
V_354 *= 2 ;
V_39 -> V_307 = F_164 ( V_39 -> V_3 ,
F_150 ,
NULL , V_39 , V_354 , 0 ) ;
if ( F_19 ( V_39 -> V_307 ) ) {
F_62 (KERN_ERR PFX L_37 ) ;
V_40 = F_159 ( V_39 -> V_307 ) ;
goto V_69;
}
V_39 -> V_66 = F_165 ( V_3 ) ;
if ( F_19 ( V_39 -> V_66 ) ) {
F_62 (KERN_ERR PFX L_38 ) ;
V_40 = F_159 ( V_39 -> V_66 ) ;
goto V_86;
}
V_39 -> V_65 = F_18 ( V_39 -> V_66 , V_67 ) ;
if ( F_19 ( V_39 -> V_65 ) ) {
F_62 (KERN_ERR PFX L_39 ) ;
V_40 = F_159 ( V_39 -> V_65 ) ;
goto V_358;
}
if ( V_356 ) {
V_40 = F_157 ( & V_39 -> V_59 [ 0 ] , V_12 ) ;
if ( V_40 )
goto V_359;
}
V_40 = F_157 ( & V_39 -> V_59 [ 1 ] , V_13 ) ;
if ( V_40 )
goto V_360;
snprintf ( V_355 , sizeof V_355 , L_40 , V_4 ) ;
V_39 -> V_103 = F_166 ( V_355 ) ;
if ( ! V_39 -> V_103 ) {
V_40 = - V_63 ;
goto V_361;
}
...
static int F_171 ( struct V_2 * V_3 , int V_4 )
{
struct V_1 * V_39 ;
unsigned long V_6 ;
F_4 ( & V_7 , V_6 ) ;
...
{
int V_364 , V_365 , V_23 ;
if ( F_173 ( V_3 -> V_145 ) != V_366 )
return;
if ( V_3 -> V_145 == V_146 ) {
V_364 = 0 ;
V_365 = 0 ;
...
for ( V_23 = V_364 ; V_23 <= V_365 ; V_23 ++ ) {
if ( F_162 ( V_3 , V_23 ) ) {
...
for ( V_23 = 0 ; V_23 < V_368 ; V_23 ++ , V_369 ++ ) {
if ( F_175 ( V_3 , V_369 ) )
F_62 (KERN_ERR PFX L_47
L_45 ,
...
{
int V_40 ;
V_348 = F_178 ( V_348 , V_370 ) ;
V_348 = F_179 ( V_348 , V_371 ) ;
V_346 = F_178 ( V_346 , V_370 ) ;
V_346 = F_179 ( V_346 , V_371 ) ;
V_153 = F_180 ( L_48 ,
sizeof( struct V_139 ) ,
0 ,
V_372 ,
