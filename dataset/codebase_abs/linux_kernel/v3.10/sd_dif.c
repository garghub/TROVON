...
if ( V_9 -> V_17 == 0xffff )
return 0 ;
if ( F_11 ( V_9 -> V_16 ) != ( V_11 & 0xffffffff ) ) {
F_12 ( V_19
L_1 ,
...
void F_33 ( struct V_51 * V_52 , T_3 V_53 ,
unsigned int V_54 )
{
...
V_9 = F_37 ( V_63 -> V_67 )
+ V_63 -> V_68 ;
for ( V_26 = 0 ; V_26 < V_63 -> V_69 ; V_26 += V_55 , V_9 ++ ) {
if ( F_11 ( V_9 -> V_16 ) == V_58 )
V_9 -> V_16 = F_7 ( V_57 ) ;
V_58 ++ ;
V_57 ++ ;
}
...
void F_39 ( struct V_71 * V_72 , unsigned int V_73 )
{
const int V_55 = sizeof( struct V_8 ) ;
struct V_27 * V_28 ;
struct V_56 * V_56 ;
...
V_50 V_57 , V_58 ;
V_28 = V_27 ( V_72 -> V_51 -> V_74 ) ;
if ( V_28 -> V_34 == V_39 || V_73 == 0 )
return;
V_54 = V_72 -> V_31 -> V_14 ;
V_24 = V_73 / V_54 ;
V_57 = F_40 ( V_72 -> V_51 ) & 0xffffffff ;
if ( V_54 == 4096 )
V_57 >>= 3 ;
