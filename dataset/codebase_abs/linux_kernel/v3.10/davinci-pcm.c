...
return 0 ;
V_53 -> V_60 = V_51 ;
V_59 = ( void * ) F_21 ( V_50 , V_51 ) ;
if ( ! V_59 )
goto V_61;
V_58 = F_22 ( V_50 , ( unsigned ) V_59 ) ;
...
F_24 ( V_50 , ( unsigned ) V_57 -> V_64 , V_57 -> V_66 ) ;
}
static int F_20 ( struct V_14 * V_15 ,
struct V_49 * V_50 , unsigned V_51 ,
struct V_52 * V_53 )
...
F_33 ( V_17 -> V_36 [ 0 ] , V_17 -> V_36 [ 1 ] ) ;
F_33 ( V_17 -> V_36 [ 1 ] , V_17 -> V_36 [ 0 ] ) ;
F_33 ( V_17 -> V_76 , V_17 -> V_76 ) ;
if ( V_15 -> V_37 == V_38 ) {
V_83 = V_57 -> V_65 ;
V_84 = V_35 -> V_34 ;
} else {
...
F_2 ( V_17 -> V_36 [ 0 ] , & V_17 -> V_79 ) ;
V_17 -> V_79 . V_6 &= ~ ( V_93 | F_34 ( 0x3f ) | V_94 ) ;
V_17 -> V_79 . V_6 |= V_95 |
F_34 ( V_17 -> V_46 & 0x3f ) ;
F_27 ( V_17 -> V_36 [ 0 ] , & V_17 -> V_79 ) ;
...
V_17 -> V_79 . V_6 &= ~ ( V_93 | F_34 ( 0x3f ) ) ;
V_17 -> V_79 . V_6 |= V_94 | V_95 |
F_34 ( V_17 -> V_46 & 0x3f ) ;
F_27 ( V_17 -> V_36 [ 1 ] , & V_17 -> V_79 ) ;
...
if ( ! V_35 )
return - V_96 ;
V_85 = V_17 -> V_89 = F_30 ( V_35 -> V_97 ,
F_15 , V_15 ,
V_17 -> V_35 -> V_98 ) ;
if ( V_85 < 0 )
goto V_61;
V_85 = V_17 -> V_36 [ 0 ] = F_31 (
F_32 ( V_17 -> V_89 ) , V_88 ) ;
if ( V_85 < 0 )
goto V_63;
V_57 = (struct V_54 * ) V_15 -> V_56 . V_19 ;
if ( V_57 ) {
if ( F_29 ( V_15 , V_17 , V_57 ) == 0 )
return 0 ;
F_3 ( V_99 L_10
L_11 , V_73 ) ;
}
...
V_17 -> V_79 . V_6 |= V_94 |
F_34 ( F_28 ( V_17 -> V_89 ) ) ;
V_17 -> V_79 . V_11 = F_28 ( V_17 -> V_36 [ 0 ] ) << 5 ;
F_27 ( V_17 -> V_36 [ 0 ] , & V_17 -> V_79 ) ;
return 0 ;
V_63:
F_35 ( V_17 -> V_89 ) ;
...
static int F_37 ( struct V_14 * V_15 , int V_100 )
{
struct V_16 * V_17 = V_15 -> V_18 -> V_19 ;
int V_85 = 0 ;
F_17 ( & V_17 -> V_48 ) ;
...
if ( V_85 < 0 )
return V_85 ;
F_27 ( V_17 -> V_46 , & V_17 -> V_80 ) ;
F_27 ( V_17 -> V_89 , & V_17 -> V_79 ) ;
F_1 ( V_17 -> V_46 , L_12 ) ;
F_1 ( V_17 -> V_76 , L_13 ) ;
F_1 ( V_17 -> V_82 , L_14 ) ;
F_1 ( V_17 -> V_89 , L_15 ) ;
...
if ( V_85 < 0 )
return V_85 ;
V_17 = F_23 ( sizeof( struct V_16 ) , V_62 ) ;
if ( V_17 == NULL )
return - V_67 ;
F_48 ( & V_17 -> V_48 ) ;
V_17 -> V_35 = V_35 ;
...
{
struct V_20 * V_18 = V_15 -> V_18 ;
return F_60 ( V_15 -> V_122 -> V_123 -> V_124 , V_121 ,
V_18 -> V_125 ,
V_18 -> V_34 ,
V_18 -> V_126 ) ;
}
static int F_61 ( struct V_127 * V_122 , int V_37 ,
T_4 V_51 )
{
...
V_55 -> V_19 = NULL ;
V_55 -> V_64 = F_62 ( V_122 -> V_123 -> V_124 , V_51 ,
& V_55 -> V_65 , V_62 ) ;
F_9 ( L_19
...
static void F_63 ( struct V_127 * V_122 )
{
struct V_14 * V_15 ;
struct V_54 * V_55 ;
int V_37 ;
...
if ( ! V_55 -> V_64 )
continue;
F_64 ( V_122 -> V_123 -> V_124 , V_55 -> V_66 ,
V_55 -> V_64 , V_55 -> V_65 ) ;
V_55 -> V_64 = NULL ;
V_57 = V_55 -> V_19 ;
if ( V_57 ) {
...
V_123 -> V_124 -> V_131 = & V_132 ;
if ( ! V_123 -> V_124 -> V_133 )
V_123 -> V_124 -> V_133 = F_66 ( 32 ) ;
...
int F_67 ( struct V_136 * V_124 )
{
return F_68 ( V_124 , & V_137 ) ;
}
void F_69 ( struct V_136 * V_124 )
{
F_70 ( V_124 ) ;
}
