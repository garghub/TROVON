...
return - V_99 ;
V_6 -> V_100 = V_62 == V_80 -> V_83 ? V_101 :
( V_2 -> V_12 -> V_2 [ 3 ] ? V_102 : V_101 ) ;
V_6 -> V_81 = V_2 ;
V_2 -> V_7 = V_80 ;
F_55 ( V_6 , V_103 , 1000 , 200000 ) ;
return 0 ;
}
...
static int F_61 ( struct V_116 * V_100 , struct V_117 * V_117 )
{
...
static int F_62 ( struct V_116 * V_100 , struct V_117 * V_117 )
{
struct V_104 * V_105 = V_100 -> V_105 ;
int V_51 = F_57 ( V_105 ) ;
if ( 0 == V_51 )
...
V_121 -> V_126 = F_66 ( V_122 ) ;
F_67 ( V_121 -> V_126 ) ;
return 0 ;
}
static int F_68 ( struct V_116 * V_100 , struct V_117 * V_127 , struct V_118 * V_119 )
{
unsigned long V_128 = ( unsigned long ) ( V_119 -> V_129 - V_119 -> V_130 ) ;
struct V_11 * V_12 = V_100 -> V_81 ;
if ( ! ( V_12 -> V_97 & V_131 ) )
return - V_99 ;
if ( V_128 > F_69 ( sizeof( struct V_30 ) ) ) {
F_70 ( L_19 , V_128 , ( unsigned long ) sizeof( struct V_30 ) ) ;
return - V_69 ;
}
if ( ! V_12 -> V_13 ) {
return - V_132 ;
...
static void F_71 ( struct V_116 * V_138 )
{
...
if ( 1 != F_4 () )
return 0 ;
if ( ( V_51 = F_74 ( V_105 , V_139 , 1 , & V_100 ) ) < 0 )
return V_51 ;
V_100 -> V_140 = V_141 ;
V_100 -> V_81 = V_12 ( V_105 ) ;
V_100 -> V_142 = F_71 ;
V_100 -> V_143 . V_144 = F_61 ;
V_100 -> V_143 . V_145 = F_62 ;
V_100 -> V_143 . V_146 = F_68 ;
V_100 -> V_147 = 1 ;
sprintf ( V_100 -> V_148 , L_20 , V_57 -> V_149 -> V_150 , V_57 -> V_151 ) ;
V_51 = F_75 ( V_105 , V_152 L_21 , 2 , 1 , 1 , & V_110 ) ;
if ( V_51 < 0 ) {
return V_51 ;
}
F_76 ( V_110 , V_62 , & V_153 ) ;
F_76 ( V_110 , V_61 , & V_153 ) ;
V_110 -> V_81 = V_12 ( V_105 ) -> V_2 ;
V_110 -> V_154 = 0 ;
sprintf ( V_110 -> V_148 , V_152 L_21 ) ;
if ( 0 > ( V_51 = F_77 ( V_110 -> V_115 [ V_62 ] . V_80 ,
V_155 ,
F_78 ( V_71 ) ,
64 * 1024 , 128 * 1024 ) ) ||
0 > ( V_51 = F_77 ( V_110 -> V_115 [ V_61 ] . V_80 ,
V_155 ,
F_78 ( V_71 ) ,
64 * 1024 , 128 * 1024 ) ) ) {
return V_51 ;
