...
int V_161 = V_126 -> V_161 ;
struct V_162 * V_140 = V_14 -> V_140 ;
unsigned long V_118 ;
struct V_147 * V_148 ;
if ( ( V_148 = F_51 ( sizeof *V_148 , V_137 ) ) == NULL ) {
F_28 ( & V_14 -> V_22 , L_18 ) ;
return - V_163 ;
}
...
V_148 -> V_154 = V_126 -> V_154 ;
F_32 ( & V_140 -> V_143 , V_118 ) ;
F_34 ( & V_148 -> V_144 , & V_140 -> V_144 ) ;
F_56 ( & V_140 -> V_142 ) ;
F_38 ( & V_140 -> V_143 , V_118 ) ;
return 0 ;
}
...
return - V_68 ;
V_7 = F_3 ( V_14 -> V_23 ) ;
V_193 = F_36 ( V_7 -> V_113 ) ;
F_67 ( V_193 ) ;
F_41 ( V_14 -> V_124 , V_7 -> V_194 ) ;
F_65 ( V_7 , V_14 -> V_124 ) ;
F_68 ( V_193 ) ;
return 0 ;
}
...
unsigned V_240 ;
unsigned V_241 ;
V_7 -> V_135 = F_51 ( sizeof( * V_7 -> V_135 ) , V_242 ) ;
if ( ! V_7 -> V_135 ) {
V_56 = - V_163 ;
goto V_243;
}
...
if ( ( V_174 & V_252 ) == 0 )
F_20 ( V_235 , L_66 ,
( V_236 & V_278 ) ? L_39 : L_67 ) ;
V_161 = F_92 ( V_2 , V_233 -> V_279 ) ;
V_238 = F_93 ( V_2 , V_161 , F_94 ( V_161 ) ) ;
if ( V_238 > sizeof( * V_7 -> V_135 ) )
V_238 = sizeof( * V_7 -> V_135 ) ;
V_7 -> V_126 = F_95 ( 0 , V_242 ) ;
if ( ! V_7 -> V_126 ) {
V_56 = - V_163 ;
goto V_243;
}
F_96 ( V_7 -> V_126 , V_2 , V_161 , * V_7 -> V_135 , V_238 , F_42 ,
V_7 , V_233 -> V_280 ) ;
if ( V_7 -> V_226 && V_100 )
V_7 -> V_87 [ 0 ] = V_88 ;
for ( V_55 = 0 ; V_55 < V_2 -> V_12 ; V_55 ++ )
...
return false ;
V_7 = F_3 ( V_14 -> V_23 ) ;
return ! ! V_7 -> V_158 [ V_14 -> V_124 - 1 ] -> V_307 ;
}
...
struct V_156 * V_157 = V_7 -> V_158 [ V_14 -> V_124 - 1 ] ;
F_138 ( & V_14 -> V_22 . V_327 , L_77 ) ;
F_138 ( & V_157 -> V_22 . V_327 , L_78 ) ;
if ( ! V_157 -> V_328 )
F_139 ( & V_157 -> V_22 ) ;
else
V_157 -> V_328 = false ;
...
if ( ! string )
return;
F_84 ( & V_14 -> V_22 , L_79 , V_285 , string ) ;
}
...
V_14 -> V_3 . V_333 ,
V_14 -> V_3 . V_334 ) ;
F_144 ( V_14 , L_82 , V_14 -> V_335 ) ;
F_144 ( V_14 , L_83 , V_14 -> V_336 ) ;
F_144 ( V_14 , L_84 , V_14 -> V_337 ) ;
}
...
V_14 -> V_335 = F_153 ( L_90 , V_242 ) ;
V_14 -> V_336 = F_153 ( L_90 , V_242 ) ;
V_14 -> V_337 = F_153 ( L_90 , V_242 ) ;
}
else {
...
& V_157 -> V_22 . V_327 , L_77 ) ;
if ( V_338 )
goto V_243;
V_338 = F_168 ( & V_157 -> V_22 . V_327 ,
& V_14 -> V_22 . V_327 , L_78 ) ;
if ( V_338 ) {
F_138 ( & V_14 -> V_22 . V_327 , L_77 ) ;
goto V_243;
}
...
F_176 ( V_359 , - 1 ) ;
F_48 ( V_359 -> V_335 ) ;
V_359 -> V_335 = F_153 ( L_90 , V_242 ) ;
F_48 ( V_359 -> V_336 ) ;
V_359 -> V_336 = F_153 ( L_90 , V_242 ) ;
F_48 ( V_359 -> V_337 ) ;
V_359 -> V_337 = F_153 ( L_90 , V_242 ) ;
F_177 ( V_359 ) ;
V_359 -> V_3 . V_361 = 0 ;
V_360:
F_141 ( V_359 ) ;
...
F_28 ( V_7 -> V_113 ,
L_102 ,
V_372 ? L_99 : L_39 , V_71 , V_75 ) ;
} else {
V_75 = F_185 ( V_7 , V_71 , V_14 , V_173 ,
V_372 ) ;
if ( V_75 && V_75 != - V_378 && V_75 != - V_112 )
F_20 ( V_7 -> V_113 ,
L_103 ,
V_75 ) ;
}
if ( V_75 == 0 || V_75 == - V_378 || V_75 == - V_112 ) {
...
void F_212 ( struct V_1 * V_426 )
{
F_7 ( & V_426 -> V_22 , L_126 ) ;
V_426 -> V_223 = 1 ;
}
static int F_213 ( struct V_1 * V_14 , enum V_427 V_82 )
{
struct V_428 * V_429 ;
...
int V_56 ;
V_430 = F_214 ( V_14 -> V_52 . V_43 , 1000 ) ;
V_431 = F_214 ( V_14 -> V_52 . V_40 , 1000 ) ;
V_432 = F_214 ( V_14 -> V_53 . V_43 , 1000 ) ;
V_433 = F_214 ( V_14 -> V_53 . V_40 , 1000 ) ;
if ( ( V_82 == V_434 &&
( V_430 > V_435 ||
V_431 > V_435 ) ) ||
( V_82 == V_436 &&
...
if ( V_433 > V_437 )
V_433 = V_437 ;
V_429 = F_51 ( sizeof *( V_429 ) , V_211 ) ;
if ( ! V_429 )
return - V_163 ;
V_429 -> V_430 = V_430 ;
V_429 -> V_431 = V_431 ;
V_429 -> V_432 = F_215 ( V_432 ) ;
V_429 -> V_433 = F_215 ( V_433 ) ;
...
if ( V_82 == V_434 )
V_14 -> V_52 . V_443 = V_443 ;
else
V_14 -> V_53 . V_443 = V_443 ;
return 0 ;
}
...
{
int V_443 , V_56 ;
T_4 V_448 = V_14 -> V_17 -> V_21 -> V_50 ;
T_5 V_449 = V_14 -> V_17 -> V_21 -> V_51 ;
if ( ( V_82 == V_434 && V_448 == 0 ) ||
( V_82 == V_436 && V_449 == 0 ) )
return;
...
V_443 = V_151 -> V_152 -> V_450 ( V_151 , V_14 , V_82 ) ;
if ( V_443 == 0 )
return;
if ( V_443 < 0 ) {
F_7 ( & V_14 -> V_22 , L_142
...
if ( F_217 ( V_14 , V_82 , V_443 ) )
V_151 -> V_152 -> V_451 ( V_151 , V_14 , V_82 ) ;
else if ( V_14 -> V_11 )
...
if ( V_151 -> V_152 -> V_451 ( V_151 , V_14 , V_82 ) )
F_7 ( & V_14 -> V_22 , L_145
L_146 ,
V_438 [ V_82 ] ) ;
return 0 ;
...
if ( ! V_151 || ! V_151 -> V_152 -> V_451 )
return 0 ;
V_14 -> V_452 ++ ;
if ( ( V_14 -> V_52 . V_443 == 0 && V_14 -> V_53 . V_443 == 0 ) )
return 0 ;
if ( F_220 ( V_151 , V_14 , V_434 ) )
goto V_453;
if ( F_220 ( V_151 , V_14 , V_436 ) )
goto V_453;
return 0 ;
V_453:
F_222 ( V_14 ) ;
...
if ( V_14 -> V_452 > 0 )
return;
F_219 ( V_151 , V_14 , V_434 ) ;
F_219 ( V_151 , V_14 , V_436 ) ;
}
...
void F_195 ( struct V_1 * V_14 ) { }
int F_223 ( struct V_6 * V_7 , int V_71 , bool V_455 )
{
int V_56 ;
int V_180 , V_456 = 0 ;
T_1 V_181 , V_8 ;
unsigned V_457 = 0xffff ;
for ( V_180 = 0 ; ; V_180 += V_183 ) {
V_56 = F_26 ( V_7 , V_71 , & V_8 , & V_181 ) ;
if ( V_56 < 0 )
return V_56 ;
...
int V_459 ;
struct V_196 * V_151 = F_55 ( V_14 -> V_169 ) ;
if ( ! V_151 -> V_152 -> V_460 && V_166 <= 1 )
return - V_68 ;
if ( V_14 -> V_82 == V_412 )
return 0 ;
if ( V_14 -> V_82 != V_385 )
return - V_68 ;
if ( V_151 -> V_152 -> V_460 )
V_459 = V_151 -> V_152 -> V_460 ( V_151 , V_14 ) ;
else
V_459 = F_13 ( V_14 , F_228 () ,
V_461 , 0 , V_166 , 0 ,
NULL , 0 , V_205 ) ;
if ( V_459 == 0 ) {
F_133 ( V_14 , V_166 ) ;
...
int V_55 , V_464 , V_459 ;
unsigned V_173 = V_376 ;
enum V_465 V_466 = V_14 -> V_15 ;
const char * V_15 ;
...
V_173 = V_377 ;
F_27 ( & V_463 ) ;
V_459 = F_187 ( V_7 , V_71 , V_14 , V_173 , false ) ;
if ( V_459 < 0 )
goto V_243;
V_459 = - V_112 ;
if ( V_466 != V_468 && V_466 != V_14 -> V_15 ) {
...
case V_49 :
case V_379 :
V_14 -> V_329 . V_275 . V_469 = F_215 ( 512 ) ;
break;
case V_16 :
V_14 -> V_329 . V_275 . V_469 = F_215 ( 64 ) ;
break;
case V_381 :
V_14 -> V_329 . V_275 . V_469 = F_215 ( 64 ) ;
break;
case V_380 :
V_14 -> V_329 . V_275 . V_469 = F_215 ( 8 ) ;
break;
default:
goto V_243;
}
...
V_166 , V_14 -> V_169 -> V_470 -> V_152 -> V_471 ) ;
if ( V_2 -> V_140 ) {
...
for ( V_55 = 0 ; V_55 < V_472 ; ( ++ V_55 , F_59 ( 100 ) ) ) {
if ( F_232 ( V_462 ) && ! ( V_151 -> V_152 -> V_118 & V_473 ) ) {
struct V_474 * V_475 ;
int V_476 = 0 ;
#define F_233 64
V_475 = F_51 ( F_233 , V_211 ) ;
if ( ! V_475 ) {
V_459 = - V_163 ;
continue;
}
for ( V_464 = 0 ; V_464 < 3 ; ++ V_464 ) {
V_475 -> V_477 = 0 ;
V_476 = F_13 ( V_14 , F_234 () ,
V_63 , V_64 ,
V_478 << 8 , 0 ,
V_475 , F_233 ,
V_479 ) ;
...
if ( V_14 -> V_321 == 0 ) {
for ( V_464 = 0 ; V_464 < V_483 ; ++ V_464 ) {
V_459 = F_227 ( V_14 , V_166 ) ;
if ( V_459 >= 0 )
break;
F_59 ( 200 ) ;
}
...
if ( V_459 )
goto V_243;
if ( V_151 -> V_484 && ! V_2 -> V_23 )
F_235 ( V_151 -> V_484 , V_14 -> V_15 ) ;
if ( ( V_14 -> V_15 == V_49 ) &&
( F_29 ( V_14 -> V_3 . V_485 ) < 0x0300 ) ) {
...
V_14 -> V_329 . V_275 . V_469 = F_215 ( V_55 ) ;
F_224 ( V_14 ) ;
}
V_459 = F_180 ( V_14 , V_487 ) ;
if ( V_459 < ( signed ) sizeof( V_14 -> V_3 ) ) {
if ( V_459 != - V_112 )
...
if ( V_14 -> V_321 == 0 && F_29 ( V_14 -> V_3 . V_485 ) >= 0x0201 ) {
V_459 = F_237 ( V_14 ) ;
if ( ! V_459 ) {
V_14 -> V_24 = F_5 ( V_14 ) ;
F_11 ( V_14 ) ;
...
V_459 = 0 ;
if ( V_151 -> V_152 -> V_489 )
V_151 -> V_152 -> V_489 ( V_151 , V_14 ) ;
V_243:
if ( V_459 ) {
F_63 ( V_7 , V_71 , 0 ) ;
F_133 ( V_14 , V_166 ) ;
...
struct V_490 * V_491 ;
int V_75 ;
V_491 = F_51 ( sizeof *V_491 , V_242 ) ;
if ( V_491 == NULL )
return;
V_75 = F_239 ( V_14 , V_492 , 0 ,
V_491 , sizeof *V_491 ) ;
if ( V_75 == sizeof *V_491 ) {
...
if ( V_75 != - V_378 && V_75 != - V_112 )
F_28 ( V_235 , L_176 ,
V_71 ) ;
}
V_387:
F_63 ( V_7 , V_71 , 1 ) ;
if ( V_151 -> V_152 -> V_504 && ! V_7 -> V_2 -> V_23 )
V_151 -> V_152 -> V_504 ( V_151 , V_71 ) ;
}
...
V_506 = V_122 . V_146 ;
F_104 ( V_506 ) ;
V_7 = F_46 ( V_506 , struct V_6 , V_121 ) ;
F_252 ( & V_7 -> V_281 ) ;
F_106 ( & V_119 ) ;
V_2 = V_7 -> V_2 ;
V_235 = V_7 -> V_113 ;
...
if ( F_130 ( V_55 , V_7 -> V_417 ) )
continue;
V_505 = F_130 ( V_55 , V_7 -> V_191 ) ;
V_507 = F_255 ( V_55 , V_7 -> V_125 ) ;
if ( ! F_255 ( V_55 , V_7 -> V_136 ) &&
! V_505 && ! V_507 )
continue;
V_56 = F_26 ( V_7 , V_55 ,
& V_8 , & V_181 ) ;
...
V_525 = F_264 ( F_256 , NULL , L_201 ) ;
if ( ! F_265 ( V_525 ) )
return 0 ;
F_266 ( & V_523 ) ;
F_263 ( V_524 L_202 , V_522 ) ;
return - 1 ;
}
void F_267 ( void )
{
...
int V_531 ;
char * V_475 ;
if ( memcmp ( & V_14 -> V_3 , V_526 ,
sizeof( * V_526 ) ) != 0 )
return 1 ;
if ( V_14 -> V_337 )
V_528 = strlen ( V_14 -> V_337 ) + 1 ;
V_529 = V_528 ;
for ( V_527 = 0 ; V_527 < V_14 -> V_3 . V_361 ; V_527 ++ ) {
V_530 = F_29 ( V_14 -> V_340 [ V_527 ] . V_275 . V_343 ) ;
V_529 = F_58 ( V_529 , V_530 ) ;
}
V_475 = F_51 ( V_529 , V_211 ) ;
if ( V_475 == NULL ) {
...
for ( V_527 = 0 ; V_527 < V_14 -> V_3 . V_361 ; V_527 ++ ) {
V_530 = F_29 ( V_14 -> V_340 [ V_527 ] . V_275 . V_343 ) ;
V_531 = F_239 ( V_14 , V_532 , V_527 , V_475 ,
V_530 ) ;
if ( V_531 != V_530 ) {
...
if ( memcmp ( V_475 , V_14 -> V_342 [ V_527 ] , V_530 )
!= 0 ) {
...
if ( ! V_80 && V_528 ) {
V_531 = F_270 ( V_14 , V_14 -> V_3 . V_334 ,
V_475 , V_528 ) ;
if ( V_531 + 1 != V_528 ) {
F_20 ( & V_14 -> V_22 , L_206 ,
V_531 ) ;
V_80 = 1 ;
} else if ( memcmp ( V_475 , V_14 -> V_337 , V_531 ) != 0 ) {
...
{
struct V_1 * V_535 = V_14 -> V_23 ;
struct V_6 * V_536 ;
struct V_196 * V_151 = F_55 ( V_14 -> V_169 ) ;
struct V_474 V_3 = V_14 -> V_3 ;
int V_55 , V_56 = 0 ;
int V_71 = V_14 -> V_124 ;
if ( V_14 -> V_82 == V_189 ||
V_14 -> V_82 == V_313 ) {
...
F_41 ( V_71 , V_536 -> V_417 ) ;
for ( V_55 = 0 ; V_55 < V_494 ; ++ V_55 ) {
F_224 ( V_14 ) ;
V_56 = F_229 ( V_536 , V_14 , V_71 , V_55 ) ;
if ( V_56 >= 0 || V_56 == - V_378 || V_56 == - V_112 )
break;
}
F_72 ( V_71 , V_536 -> V_417 ) ;
if ( V_56 < 0 )
goto V_538;
if ( F_269 ( V_14 , & V_3 ) ) {
...
V_56 = F_13 ( V_14 , F_16 ( V_14 , 0 ) ,
V_539 , 0 ,
V_14 -> V_11 -> V_275 . V_534 , 0 ,
NULL , 0 , V_205 ) ;
if ( V_56 < 0 ) {
F_28 ( & V_14 -> V_22 ,
L_215 ,
V_14 -> V_11 -> V_275 . V_534 , V_56 ) ;
F_30 ( V_151 -> V_454 ) ;
goto V_538;
}
F_30 ( V_151 -> V_454 ) ;
F_64 ( V_14 , V_83 ) ;
for ( V_55 = 0 ; V_55 < V_14 -> V_11 -> V_275 . V_540 ; V_55 ++ ) {
struct V_541 * V_340 = V_14 -> V_11 ;
...
F_179 ( V_14 ) ;
if ( V_340 ) {
for ( V_55 = 0 ; V_55 < V_340 -> V_275 . V_540 ; ++ V_55 ) {
struct V_192 * V_547 = V_340 -> V_13 [ V_55 ] ;
struct V_548 * V_150 ;
int V_549 = 0 ;
if ( V_547 -> V_22 . V_152 ) {
V_150 = F_275 ( V_547 -> V_22 . V_152 ) ;
if ( V_150 -> V_550 && V_150 -> V_551 )
V_549 = ( V_150 -> V_550 ) ( V_547 ) ;
else if ( V_547 -> V_552 ==
V_553 )
V_549 = 1 ;
if ( V_549 )
...
V_56 = F_204 ( V_14 ) ;
if ( V_340 ) {
for ( V_55 = V_340 -> V_275 . V_540 - 1 ; V_55 >= 0 ; -- V_55 ) {
struct V_192 * V_547 = V_340 -> V_13 [ V_55 ] ;
struct V_548 * V_150 ;
int V_554 = V_547 -> V_555 ;
if ( ! V_554 && V_547 -> V_22 . V_152 ) {
V_150 = F_275 ( V_547 -> V_22 . V_152 ) ;
if ( V_150 -> V_551 )
V_554 = ( V_150 -> V_551 ) ( V_547 ) ;
else if ( V_547 -> V_552 ==
V_553 )
V_554 = 1 ;
}
...
{
struct V_6 * V_7 = F_3 ( V_2 ) ;
V_7 -> V_158 [ V_71 - 1 ] -> V_559 = type ;
}
enum V_558
F_282 ( struct V_1 * V_2 , int V_71 )
{
struct V_6 * V_7 = F_3 ( V_2 ) ;
return V_7 -> V_158 [ V_71 - 1 ] -> V_559 ;
}
...
V_559 = F_282 ( V_2 , V_55 ) ;
if ( V_559 == V_560 ) {
T_2 V_561 = 1 << ( V_55 % 8 ) ;
if ( ! ( V_275 -> V_34 . V_247 . V_248 [ V_55 / 8 ] & V_561 ) ) {
F_20 ( & V_2 -> V_22 , L_218 ,
V_55 ) ;
V_275 -> V_34 . V_247 . V_248 [ V_55 / 8 ] |= V_561 ;
}
}
}
} else {
T_1 V_562 = F_29 ( V_275 -> V_34 . V_35 . V_248 ) ;
for ( V_55 = 1 ; V_55 <= V_2 -> V_12 ; V_55 ++ ) {
V_559 = F_282 ( V_2 , V_55 ) ;
if ( V_559 == V_560 ) {
T_1 V_561 = 1 << V_55 ;
...
V_275 -> V_34 . V_35 . V_248 = F_215 ( V_562 ) ;
}
}
