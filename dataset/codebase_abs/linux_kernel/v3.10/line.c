...
void F_86 ( int V_36 , int V_101 , int V_96 , struct V_45 * V_35 ,
unsigned long V_97 )
{
struct V_94 * V_94 ;
...
* V_94 = ( (struct V_94 ) { . V_98 = F_87 ( V_94 -> V_98 ) ,
. V_36 = V_36 ,
. V_101 = V_101 ,
. V_96 = V_96 ,
. V_35 = V_35 ,
...
struct V_10 * V_111 ;
F_23 ( & V_106 ) ;
F_89 (ele, next, &winch_handlers) {
V_94 = F_90 ( V_109 , struct V_94 , V_98 ) ;
