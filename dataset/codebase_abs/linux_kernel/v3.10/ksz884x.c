...
static void F_237 ( struct V_419 * V_420 )
{
...
static inline void F_238 ( struct V_418 * V_410 )
{
unsigned short V_439 ;
struct V_451 * V_452 ;
V_439 = V_410 -> V_439 ;
F_239 ( V_410 ) ;
V_452 = (struct V_451 * ) F_240 ( V_410 ) ;
if ( V_439 == F_234 ( V_453 ) ) {
V_439 = V_452 -> V_454 ;
F_230 ( V_410 , V_455 ) ;
V_452 = (struct V_451 * ) F_240 ( V_410 ) ;
}
if ( V_439 == F_234 ( V_456 ) ) {
if ( V_452 -> V_439 == V_457 )
V_410 -> V_428 = V_458 ;
}
}
static inline int F_241 ( struct V_419 * V_420 , struct V_1 * V_2 ,
...
F_243 ( V_410 , 2 ) ;
memcpy ( F_244 ( V_410 , V_459 ) ,
V_407 -> V_410 -> V_20 , V_459 ) ;
} while ( 0 );
V_410 -> V_439 = F_245 ( V_410 , V_420 ) ;
...
static int F_247 ( struct V_258 * V_259 )
{
int V_34 ;
union V_15 V_12 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
...
break;
if ( V_2 -> V_384 > 1 ) {
int V_93 = F_249 ( V_12 . V_16 . V_471 ) ;
...
static void F_251 ( unsigned long V_20 )
{
struct V_258 * V_259 = (struct V_258 * ) V_20 ;
struct V_1 * V_2 = & V_259 -> V_2 ;
if ( ! V_2 -> V_213 )
return;
if ( F_252 ( ! V_259 -> V_475 ( V_259 ) ) ) {
F_164 ( V_2 ) ;
F_221 ( & V_259 -> V_436 ) ;
F_9 ( V_2 , V_476 ) ;
F_224 ( & V_259 -> V_436 ) ;
...
static T_8 F_256 ( int V_481 , void * V_482 )
{
T_1 V_483 = 0 ;
...
if ( F_252 ( V_483 & V_326 ) ) {
V_420 -> V_432 . V_486 ++ ;
F_164 ( V_2 ) ;
}
if ( F_252 ( V_483 & V_487 ) ) {
struct V_203 * V_66 = & V_422 -> V_66 ;
V_2 -> V_225 |= V_488 ;
F_136 ( V_66 ) ;
}
if ( F_252 ( V_483 & V_343 ) ) {
F_255 ( V_2 ) ;
break;
}
if ( F_252 ( V_483 & V_489 ) ) {
T_2 V_20 ;
V_2 -> V_7 &= ~ V_489 ;
F_260 ( L_3 ) ;
...
int V_294 = 0 ;
V_259 -> V_420 = V_420 ;
V_294 = F_270 ( V_420 -> V_481 , F_256 , V_501 , V_420 -> V_502 , V_420 ) ;
if ( V_294 )
return V_294 ;
F_271 ( & V_259 -> V_478 , F_251 ,
( unsigned long ) V_259 ) ;
F_271 ( & V_259 -> V_485 , F_254 ,
( unsigned long ) V_259 ) ;
V_2 -> V_323 = 0 ;
V_2 -> V_321 = 0 ;
V_2 -> V_379 = 0 ;
...
static int F_341 ( struct V_260 * V_261 , const struct V_647 * V_364 )
{
struct V_419 * V_420 ;
struct V_421 * V_422 ;
struct V_258 * V_259 ;
