...
if ( V_17 -> V_8 != V_37 )
if ( F_11 ( V_17 -> V_8 , V_38 , V_39 , L_2 ,
V_17 ) ) {
F_2 ( L_6 ,
V_17 -> V_40 , V_17 -> V_8 ) ;
V_17 -> V_8 = V_37 ;
...
#if F_7 ( V_27 ) && ( V_27 & V_28 )
F_2 ( L_9 , V_17 -> V_40 , V_17 -> V_8 ) ;
#endif
F_2 ( L_10 , V_17 -> V_40 , V_17 -> V_18 ) ;
if ( V_17 -> V_8 == V_37 )
F_2 ( L_11 ) ;
else
F_2 ( L_12 , V_17 -> V_8 ) ;
...
static int F_13 ( struct V_16 * V_44 )
{
F_14 () ;
F_15 ( V_44 ) ;
if ( V_44 -> V_8 )
...
F_18 ( V_44 -> V_45 , V_44 -> V_46 ) ;
F_19 ( V_44 ) ;
F_6 ( V_18 ) ;
return 0 ;
}
int F_20 ( struct V_47 * V_48 , struct V_49 * V_50 ,
T_3 V_51 , int * V_52 )
{
V_52 [ 0 ] = 64 ;
V_52 [ 1 ] = 32 ;
...
static inline int F_21 ( struct V_16 * V_17 , unsigned char * V_53 ,
int V_54 ) {
F_14 () ;
void T_2 * V_55 ;
unsigned char * V_56 = V_53 ;
register int V_4 = V_54 ;
F_15 ( V_17 ) ;
V_55 = V_18 + V_57 ;
#if 0
for (; i; --i) {
...
#else
while ( ! ( F_22 ( V_18 + V_58 ) & V_59 ) ) F_23 () ;
for (; V_4 ; -- V_4 ) {
#endif
* V_56 ++ = F_22 ( V_55 ) ;
}
if ( F_22 ( V_18 + V_58 ) & V_60 ) {
unsigned char V_61 ;
void T_2 * V_62 = V_18 + V_63 ;
V_61 = F_22 ( V_62 ) ;
F_24 ( V_61 | V_64 , V_62 ) ;
F_24 ( V_61 , V_62 ) ;
F_2 ( L_15 ,
...
static inline int F_25 ( struct V_16 * V_17 , unsigned char * V_65 ,
int V_54 ) {
F_14 () ;
void T_2 * V_55 ;
unsigned char * V_66 = V_65 ;
register int V_4 = V_54 ;
F_15 ( V_17 ) ;
V_55 = V_18 + V_57 ;
#if 0
