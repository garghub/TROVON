...
static void F_41 ( struct V_14 * V_15 , struct V_23 * V_62 ,
int * V_63 )
{
struct V_13 * V_17 ;
while ( ! F_16 ( V_62 ) ) {
V_17 = F_17 ( V_62 -> V_32 , struct V_13 , V_33 ) ;
F_19 ( & V_17 -> V_33 ) ;
F_13 ( V_15 , V_17 ) ;
if ( V_63 )
( * V_63 ) -- ;
...
static int F_42 ( struct V_14 * V_15 , struct V_23 * V_62 ,
void (* F_43)( struct V_14 * , struct V_13 * ) ,
int * V_63 )
{
int V_64 ;
struct V_13 * V_17 ;
int V_58 = V_63 ? V_31 - * V_63 : V_31 ;
...
static int F_45 ( struct V_47 * V_44 , struct V_70 * V_70 )
{
int V_38 = V_44 -> V_71 ;
struct V_19 * V_20 ;
int V_28 ;
...
static int F_49 ( struct V_19 * V_83 )
{
int V_84 ;
F_29 ( & V_83 -> V_40 ) ;
...
static void F_50 ( struct V_47 * V_44 , struct V_70 * V_70 )
{
...
static int F_57 ( struct V_47 * V_44 , unsigned char V_88 )
{
struct V_19 * V_20 = V_44 -> V_61 ;
unsigned long V_55 ;
int V_28 ;
F_20 ( L_16 ,
V_20 -> V_38 , V_44 , V_88 , F_58 ( 0 ) ) ;
F_55 ( & V_20 -> V_40 , V_55 ) ;
...
static int F_63 ( struct V_47 * V_44 , int V_91 )
{
struct V_19 * V_20 = V_44 -> V_61 ;
int V_28 = 0 ;
struct V_80 * V_81 ;
...
static int
F_64 ( unsigned V_38 , struct V_93 * V_94 )
{
struct V_19 * V_20 ;
int V_95 = 0 ;
F_46 ( & V_72 [ V_38 ] . V_73 ) ;
...
V_20 = F_65 ( sizeof( struct V_19 ) , V_5 ) ;
if ( V_20 == NULL ) {
V_95 = - V_6 ;
goto V_46;
}
...
F_67 ( & V_20 -> V_40 ) ;
F_68 ( & V_20 -> V_35 ) ;
F_69 ( & V_20 -> V_60 , F_28 , ( unsigned long ) V_20 ) ;
F_70 ( & V_20 -> V_45 ) ;
F_70 ( & V_20 -> V_51 ) ;
F_70 ( & V_20 -> V_25 ) ;
V_20 -> V_38 = V_38 ;
...
{
F_73 ( & V_20 -> V_60 ) ;
F_74 ( V_20 -> V_20 . V_87 , F_71 ( V_20 ) ) ;
F_51 ( V_20 -> V_27 != NULL ) ;
F_75 ( & V_20 -> V_20 ) ;
F_4 ( V_20 ) ;
}
void F_76 ( unsigned char V_38 )
{
struct V_19 * V_20 ;
F_46 ( & V_72 [ V_38 ] . V_73 ) ;
if ( F_51 ( ! V_72 [ V_38 ] . V_20 ) ) {
F_47 ( & V_72 [ V_38 ] . V_73 ) ;
return;
}
V_20 = V_72 [ V_38 ] . V_20 ;
...
int F_78 ( unsigned char * V_98 )
{
struct V_93 V_94 ;
struct V_99 * V_100 ;
int V_95 ;
int V_38 ;
V_94 . V_101 = F_79 ( 9600 ) ;
V_94 . V_102 = 8 ;
V_94 . V_103 = V_104 ;
V_94 . V_105 = V_106 ;
...
if ( V_95 )
return V_95 ;
V_100 = F_80 ( & V_72 [ V_38 ] . V_20 -> V_20 ,
V_97 , V_38 , NULL ) ;
if ( F_81 ( V_100 ) ) {
struct V_19 * V_20 ;
F_82 ( L_22 ,
V_42 , V_38 , F_83 ( V_100 ) ) ;
V_95 = F_83 ( V_100 ) ;
V_20 = V_72 [ V_38 ] . V_20 ;
V_72 [ V_38 ] . V_20 = NULL ;
F_72 ( V_20 ) ;
...
int F_84 ( struct V_80 * V_81 , V_39 V_38 )
{
struct V_19 * V_20 ;
unsigned long V_55 ;
int V_28 ;
...
if ( V_20 -> V_20 . V_11 == 0 && ! V_20 -> V_75 )
F_3 ( & V_20 -> V_22 ) ;
F_41 ( V_81 -> V_46 , & V_20 -> V_45 , NULL ) ;
F_41 ( V_81 -> V_46 , & V_20 -> V_51 , NULL ) ;
F_41 ( V_81 -> V_26 , & V_20 -> V_25 , NULL ) ;
V_20 -> V_67 = V_20 -> V_48 =
V_20 -> V_68 = V_20 -> V_30 = 0 ;
F_56 ( & V_20 -> V_40 , V_55 ) ;
}
