...
{
struct V_167 * V_33 = & V_2 -> V_32 -> V_33 ;
int V_168 , V_169 , V_151 ;
for ( V_168 = 0 ; V_168 < 7 ; V_168 ++ ) {
V_169 = F_70 ( V_33 -> V_170 , V_168 ) ;
if ( ! F_71 ( V_169 ) ) {
F_22 ( V_33 , L_18 , V_168 , V_169 ) ;
goto V_171;
}
V_151 = F_72 ( V_169 , F_73 ( V_33 ) ) ;
if ( V_151 ) {
F_22 ( V_33 , L_19 , V_169 ) ;
goto V_171;
}
V_2 -> V_172 [ V_168 ] = V_169 ;
}
return 0 ;
V_171:
while ( -- V_168 >= 0 )
F_74 ( V_2 -> V_172 [ V_168 ] ) ;
return - V_67 ;
}
...
static int F_69 ( struct V_1 * V_15 )
{
return - V_67 ;
}
...
static inline int F_76 ( struct V_149 * V_32 )
{
#ifdef F_77
struct V_173 * V_174 ;
if ( V_32 -> V_33 . V_170 ) {
const struct V_175 * V_176 ;
V_176 = F_78 ( V_177 , V_32 -> V_33 . V_170 ) ;
V_174 = (struct V_173 * ) V_176 -> V_174 ;
return V_174 -> V_178 ;
} else
#endif
return F_79 ( V_32 ) -> V_179 ;
}
static int F_80 ( struct V_167 * V_33 )
{
struct V_1 * V_2 = F_81 ( V_33 ) ;
F_30 ( V_2 -> V_141 ) ;
return 0 ;
}
static int F_82 ( struct V_167 * V_33 )
{
struct V_1 * V_2 = F_81 ( V_33 ) ;
F_34 ( V_2 -> V_141 ) ;
return 0 ;
}
static int F_83 ( struct V_149 * V_32 )
{
struct V_1 * V_3 , * V_12 = NULL ;
struct V_180 * V_181 = V_32 -> V_33 . V_182 ;
struct V_183 * V_184 = NULL ;
struct V_185 * V_186 ;
T_1 V_187 , V_62 = 0 , V_188 = 0 ;
struct V_189 * V_190 = V_32 -> V_33 . V_170 ;
enum V_191 V_191 ;
int V_151 = 0 ;
V_191 = F_76 ( V_32 ) ;
if ( V_191 == V_192 ) {
...
if ( ! V_190 ) {
V_186 = F_86 ( V_32 , V_196 , 0 ) ;
if ( ! V_186 ) {
F_22 ( & V_32 -> V_33 ,
L_22 ) ;
return - V_144 ;
}
V_3 -> V_93 . V_197 = V_186 -> V_198 ;
V_186 = F_86 ( V_32 , V_196 , 1 ) ;
if ( ! V_186 ) {
F_22 ( & V_32 -> V_33 ,
L_23 ) ;
return - V_144 ;
}
V_3 -> V_95 . V_197 = V_186 -> V_198 ;
if ( V_181 == NULL ) {
F_22 ( & V_32 -> V_33 , L_24 ) ;
return - V_67 ;
}
if ( & V_181 -> type )
V_184 = & V_181 -> type . V_2 ;
if ( V_184 ) {
V_62 = V_184 -> V_62 ;
V_188 = V_184 -> V_188 ;
}
} else {
if ( F_87 ( V_190 , L_25 , NULL ) )
V_62 |= V_199 ;
if ( F_87 ( V_190 , L_26 , NULL ) )
V_62 |= V_146 ;
if ( F_87 ( V_190 , L_27 , NULL ) )
V_62 |= V_114 ;
if ( F_88 ( V_190 , L_28 ,
& V_188 ) ) {
if ( V_62 & V_146 ) {
...
V_186 = F_86 ( V_32 , V_200 , 0 ) ;
if ( ! V_186 ) {
F_22 ( & V_32 -> V_33 , L_31 ) ;
return - V_144 ;
}
if ( ! F_89 ( V_186 -> V_198 , F_90 ( V_186 ) ,
L_32 ) ) {
F_22 ( & V_32 -> V_33 , L_33 ) ;
return - V_201 ;
}
V_187 = V_186 -> V_198 ;
V_3 -> V_93 . V_148 = V_187 + V_202 ;
V_3 -> V_95 . V_148 = V_187 + V_203 ;
V_3 -> V_93 . V_204 =
(struct V_205 * ) & V_3 -> V_93 ;
V_3 -> V_93 . V_206 = L_34 ;
V_3 -> V_95 . V_204 =
(struct V_205 * ) & V_3 -> V_95 ;
V_3 -> V_95 . V_206 = L_35 ;
V_3 -> V_93 . V_94 = 4 ;
V_3 -> V_95 . V_94 = 4 ;
V_3 -> V_143 = V_187 ;
...
V_12 -> V_93 . V_148 = V_187 + V_208 ;
V_12 -> V_93 . V_204 =
(struct V_205 * ) & V_12 -> V_93 ;
V_12 -> V_93 . V_206 = L_37 ;
if ( ! V_190 ) {
V_186 = F_86 ( V_32 , V_196 , 2 ) ;
if ( V_186 )
V_12 -> V_93 . V_197 = V_186 -> V_198 ;
}
V_12 -> V_93 . V_94 = 4 ;
V_12 -> V_143 = V_187 ;
V_12 -> V_62 = V_62 ;
V_12 -> V_147 . V_148 = V_188 ;
V_12 -> V_3 = V_3 ;
V_3 -> V_12 = V_12 ;
}
if ( V_190 ) {
...
if ( V_181 -> V_209 && V_181 -> V_209 ( V_32 ) ) {
F_22 ( & V_32 -> V_33 , L_38 ) ;
V_151 = - V_67 ;
goto V_207;
}
}
F_84 ( & V_3 -> V_32 -> V_33 , & V_194 ,
& V_3 -> V_153 , 1 ) ;
F_91 ( & V_32 -> V_33 ) ;
F_85 ( & V_32 -> V_33 ) ;
return 0 ;
V_207:
F_92 ( V_187 , F_90 ( V_186 ) ) ;
return V_151 ;
}
static int F_93 ( struct V_149 * V_32 )
{
struct V_1 * V_2 , * V_11 ;
struct V_185 * V_186 ;
struct V_180 * V_181 = V_32 -> V_33 . V_182 ;
...
if ( ! V_181 -> V_209 && V_32 -> V_33 . V_170 )
F_75 ( V_2 -> V_3 ) ;
if ( V_11 ) {
V_11 -> V_3 = NULL ;
V_11 -> V_12 = NULL ;
