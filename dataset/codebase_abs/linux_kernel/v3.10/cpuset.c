...
static int F_66 ( struct V_6 * V_38 ,
struct V_86 * V_87 )
{
return ! F_60 ( & V_38 -> V_33 ,
( F_1 ( V_87 -> V_88 ) ) -> V_33 ) ;
}
static void F_67 ( struct V_6 * V_38 ,
struct V_86 * V_87 )
{
F_68 ( V_38 , ( ( F_1 ( V_87 -> V_88 ) ) -> V_33 ) ) ;
}
static void F_69 ( struct V_1 * V_8 , struct V_89 * V_90 )
{
struct V_86 V_87 ;
V_87 . V_88 = V_8 -> V_5 . V_2 ;
V_87 . V_91 = F_66 ;
V_87 . V_92 = F_67 ;
V_87 . V_90 = V_90 ;
F_70 ( & V_87 ) ;
}
static int F_71 ( struct V_1 * V_8 , struct V_1 * V_93 ,
const char * V_94 )
{
struct V_89 V_90 ;
int V_95 ;
...
V_95 = F_72 ( V_94 , V_93 -> V_33 ) ;
if ( V_95 < 0 )
return V_95 ;
if ( ! F_31 ( V_93 -> V_33 , V_85 ) )
return - V_52 ;
}
V_95 = F_39 ( V_8 , V_93 ) ;
if ( V_95 < 0 )
return V_95 ;
if ( F_60 ( V_8 -> V_33 , V_93 -> V_33 ) )
return 0 ;
V_95 = F_73 ( & V_90 , V_97 , V_44 , NULL ) ;
if ( V_95 )
return V_95 ;
V_96 = F_13 ( V_93 ) ;
F_64 ( & V_98 ) ;
F_24 ( V_8 -> V_33 , V_93 -> V_33 ) ;
F_65 ( & V_98 ) ;
F_69 ( V_8 , & V_90 ) ;
F_74 ( & V_90 ) ;
if ( V_96 )
...
static int F_91 ( struct V_1 * V_8 , struct V_1 * V_93 ,
const char * V_94 )
{
F_92 ( T_1 , V_113 , V_44 ) ;
int V_95 ;
...
struct V_86 * V_87 )
{
F_29 ( F_1 ( V_87 -> V_88 ) , V_38 ) ;
}
static void F_101 ( struct V_1 * V_8 , struct V_89 * V_90 )
{
struct V_86 V_87 ;
V_87 . V_88 = V_8 -> V_5 . V_2 ;
V_87 . V_91 = NULL ;
...
return - V_115 ;
if ( V_119 )
F_103 ( V_118 , & V_93 -> V_13 ) ;
else
F_104 ( V_118 , & V_93 -> V_13 ) ;
V_122 = F_39 ( V_8 , V_93 ) ;
if ( V_122 < 0 )
goto V_49;
V_122 = F_73 ( & V_90 , V_97 , V_44 , NULL ) ;
if ( V_122 < 0 )
goto V_49;
V_120 = ( F_13 ( V_8 ) !=
F_13 ( V_93 ) ) ;
V_121 = ( ( F_16 ( V_8 ) != F_16 ( V_93 ) )
|| ( F_15 ( V_8 ) != F_15 ( V_93 ) ) ) ;
F_64 ( & V_98 ) ;
V_8 -> V_13 = V_93 -> V_13 ;
F_65 ( & V_98 ) ;
if ( ! F_43 ( V_93 -> V_33 ) && V_120 )
F_57 () ;
if ( V_121 )
F_101 ( V_8 , & V_90 ) ;
F_74 ( & V_90 ) ;
...
switch ( type ) {
case V_148 :
V_95 = F_102 ( V_14 , V_8 , V_116 ) ;
break;
case V_149 :
V_95 = F_102 ( V_15 , V_8 , V_116 ) ;
break;
case V_150 :
V_95 = F_102 ( V_16 , V_8 , V_116 ) ;
break;
case V_151 :
V_95 = F_102 ( V_17 , V_8 , V_116 ) ;
break;
case V_152 :
V_95 = F_102 ( V_18 , V_8 , V_116 ) ;
break;
case V_153 :
V_154 = ! ! V_116 ;
break;
...
break;
case V_156 :
V_95 = F_102 ( V_19 , V_8 , V_116 ) ;
break;
case V_157 :
V_95 = F_102 ( V_20 , V_8 , V_116 ) ;
break;
default:
V_95 = - V_52 ;
break;
...
switch ( V_146 -> V_147 ) {
case V_161 :
V_95 = F_71 ( V_8 , V_93 , V_94 ) ;
break;
case V_162 :
V_95 = F_91 ( V_8 , V_93 , V_94 ) ;
break;
default:
V_95 = - V_52 ;
break;
...
* V_168 ++ = '\n' ;
V_95 = F_134 ( V_94 , V_166 , V_167 , V_163 , V_168 - V_163 ) ;
V_49:
...
static void F_149 ( struct V_1 * V_8 )
{
struct V_1 * V_10 ;
V_10 = F_6 ( V_8 ) ;
...
F_44 ( V_10 -> V_35 ) )
V_10 = F_6 ( V_10 ) ;
if ( F_150 ( V_10 -> V_5 . V_2 , V_8 -> V_5 . V_2 ) ) {
F_40 () ;
F_54 ( V_176 L_7 ,
F_151 ( V_8 -> V_5 . V_2 ) ) ;
F_45 () ;
...
static void V_171 ( struct V_177 * V_178 )
{
static T_13 V_179 ;
static T_1 V_180 , V_181 ;
struct V_1 * V_8 = F_2 ( V_178 , struct V_1 , V_170 ) ;
bool V_182 ;
F_64 ( & V_84 ) ;
F_152 ( & V_179 , V_8 -> V_33 , V_50 . V_33 ) ;
F_153 ( V_180 , V_8 -> V_35 , V_50 . V_35 ) ;
if ( ! F_43 ( & V_179 ) ) {
F_64 ( & V_98 ) ;
F_152 ( V_8 -> V_33 , V_8 -> V_33 , & V_179 ) ;
F_65 ( & V_98 ) ;
F_69 ( V_8 , NULL ) ;
}
if ( ! F_44 ( V_180 ) ) {
...
if ( ! F_155 ( & V_8 -> V_5 ) )
return;
if ( ! F_156 ( V_160 , & V_8 -> V_170 ) )
F_154 ( & V_8 -> V_5 ) ;
}
static void F_157 ( struct V_177 * V_178 )
{
static T_13 V_183 , V_184 ;
static T_1 V_185 , V_181 ;
bool V_186 , V_187 ;
bool V_188 , V_189 ;
F_64 ( & V_84 ) ;
F_24 ( & V_183 , V_85 ) ;
V_185 = V_36 [ V_37 ] ;
V_186 = ! F_60 ( V_50 . V_33 , & V_183 ) ;
V_188 = F_152 ( & V_184 , V_50 . V_33 ,
& V_183 ) ;
V_187 = ! F_95 ( V_50 . V_35 , V_185 ) ;
F_153 ( V_181 , V_50 . V_35 , V_185 ) ;
V_189 = ! F_44 ( V_181 ) ;
if ( V_186 ) {
F_64 ( & V_98 ) ;
F_24 ( V_50 . V_33 , & V_183 ) ;
F_65 ( & V_98 ) ;
}
if ( V_187 ) {
V_181 = V_50 . V_35 ;
...
void F_158 ( bool V_190 )
{
F_61 ( 1 , NULL , NULL ) ;
F_159 ( & V_159 ) ;
}
static int F_160 ( struct V_191 * V_192 ,
unsigned long V_193 , void * V_194 )
{
F_159 ( & V_159 ) ;
return V_195 ;
}
void T_12 F_161 ( void )
{
F_24 ( V_50 . V_33 , V_85 ) ;
V_50 . V_35 = V_36 [ V_37 ] ;
F_162 ( & V_196 ) ;
...
int F_171 ( int V_199 , T_14 V_200 )
{
const struct V_1 * V_8 ;
int V_201 ;
if ( F_172 () || ( V_200 & V_202 ) )
return 1 ;
F_173 ( ! ( V_200 & V_203 ) ) ;
if ( F_174 ( V_199 , V_103 -> V_35 ) )
return 1 ;
if ( F_78 ( F_79 ( V_107 ) ) )
return 1 ;
if ( V_200 & V_203 )
...
V_8 = F_170 ( F_4 ( V_103 ) ) ;
F_85 ( V_103 ) ;
V_201 = F_174 ( V_199 , V_8 -> V_35 ) ;
F_65 ( & V_98 ) ;
return V_201 ;
}
int F_175 ( int V_199 , T_14 V_200 )
{
if ( F_172 () || ( V_200 & V_202 ) )
return 1 ;
if ( F_174 ( V_199 , V_103 -> V_35 ) )
...
static int F_176 ( int * V_204 )
{
int V_199 ;
V_199 = F_177 ( * V_204 , V_103 -> V_35 ) ;
if ( V_199 == V_205 )
V_199 = F_178 ( V_103 -> V_35 ) ;
* V_204 = V_199 ;
return V_199 ;
}
int F_179 ( void )
...
V_103 -> V_208 =
F_180 ( & V_103 -> V_35 ) ;
return F_176 ( & V_103 -> V_208 ) ;
}
int F_182 ( const struct V_6 * V_209 ,
...
{
static char V_211 [ V_212 ] ;
static F_184 ( V_213 ) ;
struct V_2 * V_133 = F_4 ( V_38 ) -> V_5 . V_2 ;
F_40 () ;
F_111 ( & V_213 ) ;
F_131 ( V_211 , V_212 ,
V_38 -> V_35 ) ;
F_54 ( V_214 L_9 ,
V_38 -> V_215 , F_151 ( V_133 ) , V_211 ) ;
F_112 ( & V_213 ) ;
F_45 () ;
}
void F_185 ( void )
...
int F_186 ( struct V_216 * V_217 , void * V_218 )
{
struct V_219 * V_219 ;
struct V_6 * V_38 ;
char * V_94 ;
...
V_95 = - V_220 ;
V_219 = V_217 -> V_147 ;
V_38 = F_187 ( V_219 , V_221 ) ;
if ( ! V_38 )
goto V_222;
F_40 () ;
V_5 = F_5 ( V_38 , V_4 ) ;
V_95 = F_188 ( V_5 -> V_2 , V_94 , V_97 ) ;
F_45 () ;
if ( V_95 < 0 )
goto V_223;
F_189 ( V_217 , V_94 ) ;
...
void F_192 ( struct V_216 * V_217 , struct V_6 * V_7 )
{
F_193 ( V_217 , L_10 ) ;
F_194 ( V_217 , & V_7 -> V_35 ) ;
F_193 ( V_217 , L_11 ) ;
F_193 ( V_217 , L_12 ) ;
F_195 ( V_217 , & V_7 -> V_35 ) ;
F_193 ( V_217 , L_11 ) ;
}
