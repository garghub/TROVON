...
V_61 = V_16 -> V_213 - F_120 ( V_16 , V_206 ) ;
if ( V_61 < 0 )
F_50 ( & V_16 -> V_16 , L_28
L_29 ,
V_205 , - V_61 ) ;
...
F_125 ( & V_131 -> V_203 , F_113 ) ;
V_131 -> V_221 = - 1 ;
F_126 ( & V_131 -> V_16 ) ;
F_127 ( & V_131 -> V_16 ) ;
F_128 ( & V_131 -> V_16 , L_30 ,
...
! ( V_16 -> V_104 & V_223 ) )
V_206 -> string = F_60 ( V_16 , V_206 -> V_20 . V_224 ) ;
F_101 ( V_16 ) ;
F_129 ( V_16 ) ;
for ( V_61 = 0 ; V_61 < V_209 ; ++ V_61 ) {
...
static void F_132 ( struct V_201 * V_225 )
{
struct V_226 * V_227 =
F_114 ( V_225 , struct V_226 , V_225 ) ;
struct V_22 * V_117 = V_227 -> V_117 ;
F_133 ( V_117 ) ;
F_28 ( & V_228 ) ;
F_134 ( & V_227 -> V_229 ) ;
F_30 ( & V_228 ) ;
if ( V_227 -> V_171 >= - 1 )
F_118 ( V_117 , V_227 -> V_171 ) ;
F_117 ( V_117 ) ;
F_135 ( V_117 ) ;
F_20 ( V_227 ) ;
}
...
if ( V_227 -> V_117 == V_117 )
V_227 -> V_171 = - 999 ;
}
F_30 ( & V_228 ) ;
}
int F_137 ( struct V_22 * V_117 , int V_171 )
{
struct V_226 * V_227 ;
...
V_227 -> V_117 = V_117 ;
V_227 -> V_171 = V_171 ;
F_125 ( & V_227 -> V_225 , F_132 ) ;
F_28 ( & V_228 ) ;
F_138 ( & V_227 -> V_229 , & V_230 ) ;
F_30 ( & V_228 ) ;
F_139 ( V_117 ) ;
F_140 ( & V_227 -> V_225 ) ;
return 0 ;
