...
{
T_3 V_20 ;
V_20 = F_13 ( V_1 , V_2 , V_3 , V_21 ) ;
if ( V_20 == 0x13 )
F_21 () ;
}
static int T_1 F_22 ( int V_1 , int V_2 , int V_3 )
{
T_4 V_22 ;
T_4 V_23 ;
T_4 V_24 ;
T_3 type ;
int V_25 ;
V_22 = F_23 ( V_1 , V_2 , V_3 , V_26 ) ;
if ( V_22 == 0xffff )
return - 1 ;
V_23 = F_23 ( V_1 , V_2 , V_3 , V_27 ) ;
V_24 = F_23 ( V_1 , V_2 , V_3 , V_28 ) ;
for ( V_25 = 0 ; V_29 [ V_25 ] . V_30 != NULL ; V_25 ++ ) {
if ( ( ( V_29 [ V_25 ] . V_23 == V_31 ) ||
( V_29 [ V_25 ] . V_23 == V_23 ) ) &&
( ( V_29 [ V_25 ] . V_24 == V_31 ) ||
( V_29 [ V_25 ] . V_24 == V_24 ) ) &&
( ! ( ( V_29 [ V_25 ] . V_22 ^ V_22 ) &
