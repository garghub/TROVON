...
SPRINTF ( L_59 ) ;
SPRINTF ( L_60 , V_246 ) ;
SPRINTF ( L_61 , V_12 -> V_173 ) ;
SPRINTF ( L_62 , V_12 -> V_83 , V_12 -> V_83 + V_12 -> V_236 - 1 ) ;
SPRINTF ( L_63 , V_12 -> V_46 , V_12 -> V_46 + V_10 -> V_248 - 1 ) ;
SPRINTF ( L_64 , V_12 -> V_249 ) ;
SPRINTF ( L_65 ) ;
switch ( V_170 ) {
case V_250 :
SPRINTF ( L_66 ) ;
...
SPRINTF ( L_70 ) ;
F_58 ( & ( V_10 -> V_239 ) , V_245 ) ;
SPRINTF ( L_71 , V_10 -> V_14 ) ;
F_59 ( & ( V_10 -> V_239 ) , V_245 ) ;
SPRINTF ( L_72 ) ;
...
static int F_63 ( struct V_254 * V_255 )
{
V_179 * V_180 ;
T_2 * V_10 = & V_231 ;
int V_132 ;
F_12 ( V_48 , L_9 ) ;
V_180 = F_64 ( sizeof( * V_180 ) , V_256 ) ;
if ( V_180 == NULL ) { return - V_257 ; }
V_180 -> V_258 = V_255 ;
V_255 -> V_259 = V_180 ;
V_10 -> V_233 = V_180 ;
F_12 ( V_48 , L_81 , V_180 ) ;
V_132 = F_65 ( V_255 ) ;
F_12 ( V_48 , L_82 , V_255 ) ;
return V_132 ;
}
static void F_66 ( struct V_254 * V_255 )
{
F_12 ( V_48 , L_83 , V_255 ) ;
( ( V_179 * ) V_255 -> V_259 ) -> V_260 = 1 ;
F_67 ( V_255 ) ;
F_68 ( V_255 -> V_259 ) ;
V_255 -> V_259 = NULL ;
}
static int F_69 ( struct V_254 * V_258 , void * V_261 )
{
T_2 * V_10 = V_261 ;
if ( V_258 -> V_262 == 0 )
return - V_263 ;
if ( F_70 ( V_258 ) != 0 )
goto V_264;
if ( F_71 ( V_258 -> V_265 [ 2 ] ) ) {
V_258 -> V_265 [ 2 ] -> V_245 |= ( V_266 |
V_267 |
V_268 ) ;
if ( V_258 -> V_265 [ 2 ] -> V_269 < 0x1000 )
V_258 -> V_265 [ 2 ] -> V_269 = 0x1000 ;
if ( F_72 ( V_258 , V_258 -> V_265 [ 2 ] , 0 ) != 0 )
goto V_264;
if ( F_73 ( V_258 , V_258 -> V_265 [ 2 ] ,
V_258 -> V_270 ) != 0 )
goto V_264;
V_10 -> V_238 = ( unsigned long )
F_74 ( V_258 -> V_265 [ 2 ] -> V_271 ,
F_71 ( V_258 -> V_265 [ 2 ] ) ) ;
V_10 -> V_248 = F_71 ( V_258 -> V_265 [ 2 ] ) ;
}
return 0 ;
V_264:
F_12 ( V_48 , L_84 ) ;
...
static int F_65 ( struct V_254 * V_255 )
{
int V_132 ;
...
if ( V_280 ) {
if ( V_255 -> V_265 [ 0 ] ) {
F_79 ( V_255 -> V_265 [ 0 ] -> V_271 ,
F_71 ( V_255 -> V_265 [ 0 ] ) ) ;
}
if ( V_255 -> V_265 [ 1 ] ) {
F_79 ( V_255 -> V_265 [ 1 ] -> V_271 ,
F_71 ( V_255 -> V_265 [ 1 ] ) ) ;
}
}
V_10 -> V_47 = V_255 -> V_265 [ 0 ] -> V_271 ;
V_10 -> V_237 = F_71 ( V_255 -> V_265 [ 0 ] ) ;
...
static void F_67 ( struct V_254 * V_255 )
{
V_179 * V_180 = V_255 -> V_259 ;
T_2 * V_10 = NULL ;
if ( V_180 -> V_12 == NULL ) {
...
if ( F_71 ( V_255 -> V_265 [ 2 ] ) ) {
if ( V_10 != NULL ) {
F_83 ( ( void * ) ( V_10 -> V_238 ) ) ;
}
}
F_75 ( V_255 ) ;
if ( V_180 -> V_12 != NULL ) {
