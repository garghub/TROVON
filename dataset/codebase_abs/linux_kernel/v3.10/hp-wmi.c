...
V_70 -> V_97 = L_10 ;
V_70 -> V_98 = L_11 ;
V_70 -> V_52 . V_99 = V_100 ;
F_36 ( V_101 , V_70 -> V_102 ) ;
F_36 ( V_71 , V_70 -> V_103 ) ;
F_36 ( V_72 , V_70 -> V_103 ) ;
V_42 = F_37 ( V_70 , V_104 , NULL ) ;
if ( V_42 )
goto V_105;
F_31 ( V_70 , V_71 , F_10 () ) ;
F_31 ( V_70 , V_72 ,
...
static void F_46 ( struct V_110 * V_50 )
{
F_47 ( & V_50 -> V_55 , & V_111 ) ;
F_47 ( & V_50 -> V_55 , & V_112 ) ;
F_47 ( & V_50 -> V_55 , & V_113 ) ;
F_47 ( & V_50 -> V_55 , & V_114 ) ;
F_47 ( & V_50 -> V_55 , & V_115 ) ;
}
static int F_48 ( struct V_110 * V_50 )
{
int V_42 ;
int V_38 = 0 ;
...
static int F_55 ( struct V_110 * V_50 )
{
int V_42 , V_43 ;
struct V_44 V_28 ;
V_42 = F_1 ( V_41 , 0 , & V_28 ,
...
default:
F_5 ( L_17 ,
V_28 . V_50 [ V_43 ] . V_127 ) ;
continue;
}
if ( ! V_28 . V_50 [ V_43 ] . V_128 ) {
F_5 ( L_18 ,
V_43 , V_28 . V_51 ) ;
continue;
}
V_53 = F_49 ( V_97 , & V_50 -> V_55 , type ,
& V_129 , ( void * ) ( long ) V_43 ) ;
if ( ! V_53 ) {
V_42 = - V_96 ;
goto V_130;
}
...
static int T_5 F_56 ( struct V_110 * V_50 )
{
int V_42 ;
V_78 = NULL ;
V_80 = NULL ;
...
if ( F_48 ( V_50 ) )
F_55 ( V_50 ) ;
V_42 = F_57 ( & V_50 -> V_55 , & V_111 ) ;
if ( V_42 )
goto V_132;
V_42 = F_57 ( & V_50 -> V_55 , & V_112 ) ;
if ( V_42 )
goto V_132;
V_42 = F_57 ( & V_50 -> V_55 , & V_113 ) ;
if ( V_42 )
goto V_132;
V_42 = F_57 ( & V_50 -> V_55 , & V_114 ) ;
if ( V_42 )
goto V_132;
V_42 = F_57 ( & V_50 -> V_55 , & V_115 ) ;
if ( V_42 )
goto V_132;
return 0 ;
V_132:
...
static int T_6 F_58 ( struct V_110 * V_50 )
{
int V_43 ;
F_46 ( V_50 ) ;
for ( V_43 = 0 ; V_43 < V_45 ; V_43 ++ ) {
