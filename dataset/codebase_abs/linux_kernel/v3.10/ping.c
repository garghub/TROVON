...
struct V_16 * V_16 ;
int type = F_44 ( V_90 ) -> type ;
int V_87 = F_44 ( V_90 ) -> V_87 ;
struct V_1 * V_1 = F_45 ( V_90 -> V_97 ) ;
struct V_10 * V_11 ;
int V_98 ;
int V_66 ;
...
static int F_49 ( void * V_126 , char * V_127 ,
...
F_16 () ;
if ( F_50 ( V_127 + sizeof( struct V_94 ) ,
...
static int F_51 ( struct V_10 * V_11 , struct V_131 * V_132 ,
struct V_136 * V_137 )
{
struct V_89 * V_90 = F_52 ( & V_11 -> V_138 ) ;
V_132 -> V_134 = F_53 ( ( char * ) & V_132 -> V_95 ,
sizeof( struct V_94 ) , V_132 -> V_134 ) ;
V_132 -> V_95 . V_139 = F_54 ( V_132 -> V_134 ) ;
memcpy ( F_44 ( V_90 ) , & V_132 -> V_95 , sizeof( struct V_94 ) ) ;
V_90 -> V_140 = V_141 ;
...
V_132 . V_134 = 0 ;
V_66 = F_74 ( V_11 , & V_137 , F_49 , & V_132 , V_146 ,
0 , & V_149 , & V_152 , V_145 -> V_157 ) ;
if ( V_66 )
F_75 ( V_11 ) ;
else
V_66 = F_51 ( V_11 , & V_132 , & V_137 ) ;
F_41 ( V_11 ) ;
V_79:
F_76 ( V_152 ) ;
if ( free )
...
struct V_224 * V_225 ;
int V_226 = 0 ;
V_225 = F_118 ( L_32 , V_227 , V_1 -> V_228 , & V_229 ) ;
if ( ! V_225 )
V_226 = - V_230 ;
return V_226 ;
}
