...
static int F_69 ( struct V_2 * V_3 , struct V_215 * V_8 )
{
struct V_11 * V_216 = F_5 ( V_3 ) ;
return F_70 ( V_216 , V_8 , V_217 , 0 ) ;
}
...
F_72 ( & V_8 -> V_7 , V_3 -> V_29 ) ;
return 0 ;
}
static int F_73 ( struct V_11 * V_216 , const struct V_218 * V_180 )
{
struct V_1 * V_8 ;
struct V_36 * V_37 ;
struct V_2 * V_3 ;
...
F_17 ( V_219 L_40 ) ;
F_17 ( V_219 L_41 ) ;
for ( V_37 = V_220 ; V_37 -> V_29 != NULL ; V_37 ++ )
F_17 ( L_42 , ( V_37 == V_220 ) ? L_35 : L_43 , V_37 -> V_29 ) ;
F_17 ( L_13 ) ;
}
V_8 = F_74 ( sizeof( * V_8 ) , V_221 ) ;
if ( ! V_8 )
return - V_222 ;
V_3 = & V_8 -> V_3 ;
F_75 ( V_3 , V_216 , & V_223 ) ;
F_6 ( 1 , V_14 , V_3 , L_44 , V_216 -> V_23 << 1 ) ;
for ( V_37 = V_220 ; V_37 -> V_29 != NULL ; V_37 ++ ) {
if ( 0 == * ( V_37 -> V_224 ) )
continue;
if ( V_216 -> V_23 < V_37 -> V_225 ||
V_216 -> V_23 > V_37 -> V_226 )
continue;
if ( V_37 -> V_227 && ! V_37 -> V_227 ( V_8 ) )
continue;
break;
}
if ( V_37 -> V_29 == NULL ) {
...
F_10 ( V_3 , L_46 , V_37 -> V_29 , V_216 -> V_23 << 1 , V_216 -> V_28 -> V_29 ) ;
if ( V_37 -> V_26 ) {
F_6 ( 1 , V_14 , V_3 , L_47 ,
( V_37 -> V_26 & V_229 ) ? L_48 : L_35 ,
( V_37 -> V_26 & V_230 ) ? L_49 : L_35 ,
( V_37 -> V_26 & V_204 ) ? L_50 : L_35 ) ;
}
if ( ! V_180 )
F_77 ( V_216 -> V_29 , V_37 -> V_29 , V_231 ) ;
V_8 -> V_37 = V_37 ;
V_8 -> V_15 . V_32 = V_37 -> V_232 + 1 ;
V_8 -> V_44 = - 1 ;
V_8 -> V_46 = V_48 ;
if ( V_37 -> V_233 != NULL )
V_37 -> V_233 ( V_8 ) ;
else
F_16 ( V_8 , L_51 , & V_37 -> V_234 ) ;
F_78 ( & V_8 -> V_7 , 5 ) ;
if ( V_37 -> V_26 & V_204 )
F_79 ( & V_8 -> V_7 , & V_235 ,
V_181 , 0 , 1 , 1 , 0 ) ;
...
V_8 -> V_189 = F_79 ( & V_8 -> V_7 ,
& V_235 , V_188 ,
0 , 65535 , 65535 / 100 ,
V_37 -> V_236 ? V_37 -> V_236 : 65535 ) ;
V_8 -> V_190 = F_79 ( & V_8 -> V_7 ,
& V_235 , V_237 ,
...
& V_235 , V_199 ,
0 , 65535 , 65535 / 100 ,
V_37 -> V_239 ? V_37 -> V_239 : 32768 ) ;
}
}
V_3 -> V_240 = & V_8 -> V_7 ;
if ( V_8 -> V_7 . error ) {
int V_241 = V_8 -> V_7 . error ;
F_81 ( & V_8 -> V_7 ) ;
F_76 ( V_8 ) ;
return V_241 ;
}
...
V_8 -> V_35 = F_84 ( F_20 , V_8 , V_216 -> V_29 ) ;
if ( F_85 ( V_8 -> V_35 ) ) {
F_8 ( V_3 , L_55 ) ;
V_8 -> V_35 = NULL ;
}
...
static int F_86 ( struct V_11 * V_216 )
{
struct V_2 * V_3 = F_87 ( V_216 ) ;
struct V_1 * V_8 = F_1 ( V_3 ) ;
F_88 ( & V_8 -> V_55 ) ;
if ( V_8 -> V_35 ) {
F_89 ( V_8 -> V_35 ) ;
