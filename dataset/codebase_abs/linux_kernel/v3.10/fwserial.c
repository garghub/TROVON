...
F_213 ( & V_49 -> V_105 ) ;
if ( V_309 )
F_192 ( V_285 , F_193 ( V_49 -> V_165 [ V_14 ] ) ) ;
V_321:
...
static int F_228 ( struct V_243 * V_293 )
{
struct V_42 * V_43 = F_229 ( V_293 ) ;
...
switch ( F_160 ( V_252 -> V_254 . V_250 ) & V_335 ) {
case V_253 :
if ( F_234 ( & V_43 -> V_90 ) ) {
...
V_323 = F_223 ( V_338 , NULL ) ;
if ( V_274 + V_337 > V_339 )
V_274 = V_339 - V_337 ;
V_164 = V_274 + V_337 ;
V_320 = F_239 ( V_156 , V_340
| V_341 ) ;
if ( F_211 ( V_320 ) ) {
V_84 = F_221 ( V_320 ) ;
return V_84 ;
