...
continue;
V_12 -> V_146 |= F_5 ( V_44 ) ;
if ( V_84 -> V_147 [ V_44 ] . V_5 & V_148 )
V_12 -> V_136 |= F_5 ( V_44 ) ;
}
V_12 -> V_17 [ V_15 ] . V_18 = V_12 -> V_146 ;
}
static void
...
struct V_86 * V_87 = V_85 ;
struct V_11 * V_12 = & V_87 -> V_88 ;
struct V_149 * V_150 = & V_73 -> V_151 . V_150 ;
T_1 V_152 = V_73 -> V_151 . V_153 ;
int V_154 = 0 ;
int V_155 ;
int V_156 ;
int V_44 ;
...
V_12 -> V_73 = V_73 ;
V_12 -> V_57 = V_58 ;
V_155 = F_45 ( V_84 -> V_144 , 10 , 60 , 1 , 1 ) ;
V_12 -> V_36 = F_45 ( V_84 -> V_144 , 0 , 60 , 1 , 1 ) + V_155 ;
V_12 -> V_118 = V_12 -> V_36 + 2 * V_155 ;
V_12 -> V_37 = F_9 ( 1 , 1 ) ;
if ( V_10 -> V_161 ) {
V_12 -> V_49 = 16 ;
V_12 -> V_104 = 0 ;
...
V_87 -> V_99 . V_174 = V_87 -> V_175 ;
V_87 -> V_99 . V_62 = V_87 -> V_62 ;
return V_97 . V_176 ( V_82 , V_84 , V_73 , & V_87 -> V_99 ) ;
}
static void
...
static void *
F_48 ( void * V_82 , struct V_65 * V_73 , T_4 V_178 )
{
struct V_83 * V_84 ;
struct V_86 * V_87 ;
struct V_9 * V_10 = V_82 ;
struct V_179 * V_131 = V_10 -> V_131 ;
int V_132 = 0 ;
int V_44 ;
for ( V_44 = 0 ; V_44 < V_180 ; V_44 ++ ) {
V_84 = V_131 -> V_181 -> V_182 [ V_44 ] ;
if ( V_84 && V_84 -> V_183 > V_132 )
V_132 = V_84 -> V_183 ;
}
V_87 = F_33 ( sizeof( * V_87 ) , V_178 ) ;
if ( ! V_87 )
return NULL ;
V_87 -> V_175 = F_33 ( sizeof( struct V_184 ) * V_132 , V_178 ) ;
if ( ! V_87 -> V_175 )
goto error;
V_87 -> V_62 = F_49 ( V_185 * V_132 , V_178 ) ;
if ( ! V_87 -> V_62 )
goto V_186;
return V_87 ;
V_186:
...
static void *
F_52 ( struct V_179 * V_131 , struct V_187 * V_188 )
{
return V_97 . V_189 ( V_131 , V_188 ) ;
}
static void
F_53 ( void * V_82 )
{
...
F_54 ( void )
{
int V_190 , V_44 , V_191 ;
T_2 V_192 [ V_4 ] ;
memset ( V_62 , 0xff , sizeof( V_62 ) ) ;
for ( V_190 = 0 ; V_190 < V_185 ; V_190 ++ ) {
for ( V_44 = 0 ; V_44 < V_4 ; V_44 ++ ) {
F_55 ( V_192 , sizeof( V_192 ) ) ;
V_191 = ( V_44 + V_192 [ V_44 ] ) % V_4 ;
while ( V_62 [ V_190 ] [ V_191 ] != 0xff )
V_191 = ( V_191 + 1 ) % V_4 ;
V_62 [ V_190 ] [ V_191 ] = V_44 ;
}
}
}
int T_5
