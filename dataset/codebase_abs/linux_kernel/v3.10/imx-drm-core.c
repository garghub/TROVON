...
int F_59 ( struct V_71 * V_44 ,
struct V_29 * * V_72 , struct V_60 * V_33 )
{
struct V_4 * V_5 = F_23 () ;
struct V_29 * V_29 ;
int V_25 ;
...
if ( ! F_61 ( & V_29 -> V_43 ) )
return - V_62 ;
for ( V_78 = 0 ; ! V_25 ; V_78 ++ ) {
V_25 = F_62 ( V_75 , L_2 ,
L_3 , V_78 , & args ) ;
if ( V_25 < 0 )
break;
V_77 = F_54 ( sizeof( * V_77 ) , V_64 ) ;
if ( ! V_77 ) {
F_63 ( args . V_75 ) ;
return - V_65 ;
}
V_77 -> V_56 = args . V_75 ;
V_77 -> V_57 = args . V_79 > 0 ? args . args [ 0 ] : 0 ;
F_63 ( args . V_75 ) ;
F_12 ( & V_5 -> V_21 ) ;
F_55 ( & V_77 -> V_68 , & V_29 -> V_43 ) ;
F_13 ( & V_5 -> V_21 ) ;
}
F_52 () ;
return 0 ;
...
F_33 ( & V_4 -> V_83 ) ;
F_33 ( & V_4 -> V_73 ) ;
V_89 = F_76 ( L_4 , - 1 , NULL , 0 ) ;
if ( ! V_89 ) {
V_25 = - V_3 ;
goto V_90;
}
V_89 -> V_17 . V_91 = F_77 ( 32 ) ,
V_25 = F_78 ( & V_92 ) ;
if ( V_25 )
goto V_93;
return 0 ;
