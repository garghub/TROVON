...
T_1 V_18 ;
int V_38 ;
V_38 = F_19 ( V_31 , V_7 , V_33 , V_34 [ V_39 ] , & V_37 , & V_40 ) ;
if ( V_38 < 0 )
return V_38 ;
if ( V_33 [ V_41 ] ) {
V_14 -> V_9 . V_24 = F_20 ( V_33 [ V_41 ] ) ;
F_21 ( V_7 , & V_14 -> V_9 , V_35 ) ;
}
#ifdef F_3
if ( V_33 [ V_42 ] ) {
V_38 = F_22 ( V_7 , V_14 -> V_21 , V_33 [ V_42 ] ) ;
if ( V_38 < 0 )
goto V_43;
}
#endif
...
goto V_43;
F_23 ( V_7 , & V_14 -> V_22 , & V_37 ) ;
return 0 ;
V_43:
F_12 ( V_7 , & V_37 ) ;
return V_38 ;
}
static int F_24 ( struct V_31 * V_31 , struct V_4 * V_45 ,
...
struct V_10 * V_11 = (struct V_10 * ) V_7 -> V_12 ;
struct V_13 * V_14 = (struct V_13 * ) * V_27 ;
struct V_32 * V_46 = V_34 [ V_47 ] ;
struct V_32 * V_33 [ V_48 + 1 ] ;
int V_38 ;
if ( ! V_46 )
return V_1 ? - V_30 : 0 ;
V_38 = F_25 ( V_33 , V_48 , V_46 , V_49 ) ;
if ( V_38 < 0 )
return V_38 ;
if ( V_14 != NULL ) {
...
if ( V_33 [ V_44 ] )
V_18 = F_20 ( V_33 [ V_44 ] ) ;
V_11 = F_26 ( sizeof( struct V_10 ) , V_50 ) ;
if ( V_11 == NULL )
return - V_51 ;
V_11 -> V_18 = V_18 ;
F_16 ( V_7 ) ;
...
V_14 = F_26 ( sizeof( struct V_13 ) , V_50 ) ;
if ( V_14 == NULL )
return - V_51 ;
V_14 -> V_16 = V_1 ;
...
static void F_27 ( struct V_6 * V_7 , struct V_52 * V_27 )
{
struct V_10 * V_11 = (struct V_10 * ) V_7 -> V_12 ;
int V_26 ;
if ( V_11 == NULL )
...
if ( V_27 -> V_54 < V_27 -> V_55 ) {
V_27 -> V_54 ++ ;
continue;
}
if ( V_27 -> V_56 ( V_7 , ( unsigned long ) V_14 , V_27 ) < 0 ) {
V_27 -> V_53 = 1 ;
return;
}
V_27 -> V_54 ++ ;
...
static int F_28 ( struct V_6 * V_7 , unsigned long V_57 ,
struct V_4 * V_5 , struct V_58 * V_3 )
{
struct V_10 * V_11 = (struct V_10 * ) V_7 -> V_12 ;
struct V_13 * V_14 = (struct V_13 * ) V_57 ;
unsigned char * V_59 = F_29 ( V_5 ) ;
struct V_32 * V_60 ;
if ( V_14 == NULL )
return V_5 -> V_61 ;
V_3 -> V_62 = V_14 -> V_16 ;
...
goto V_63;
if ( V_14 -> V_9 . V_24 &&
F_32 ( V_5 , V_41 , V_14 -> V_9 . V_24 ) )
goto V_63;
#ifdef F_3
if ( strlen ( V_14 -> V_21 ) &&
F_33 ( V_5 , V_42 , V_14 -> V_21 ) )
goto V_63;
#endif
if ( V_11 -> V_18 != 0xFFFFFFFF &&
F_32 ( V_5 , V_44 , V_11 -> V_18 ) )
goto V_63;
if ( F_34 ( V_5 , & V_14 -> V_22 , & V_40 ) < 0 )
goto V_63;
F_35 ( V_5 , V_60 ) ;
if ( F_36 ( V_5 , & V_14 -> V_22 , & V_40 ) < 0 )
goto V_63;
return V_5 -> V_61 ;
V_63:
F_37 ( V_5 , V_59 ) ;
