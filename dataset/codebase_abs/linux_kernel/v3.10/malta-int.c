...
if ( V_67 >= 0 )
return V_67 ;
V_68 = ( unsigned long ) F_39 ( V_69 , V_70 ) ;
V_71 = ( unsigned long ) F_39 ( V_72 , V_73 ) ;
V_67 = ( F_40 ( V_74 ) & V_75 ) == V_69 ;
if ( V_67 )
F_41 ( L_16 ) ;
return V_67 ;
}
...
if ( V_67 ) {
unsigned long V_144 = F_40 ( V_145 ) ;
unsigned long V_146 = F_40 ( V_147 ) ;
unsigned long V_148 = F_40 ( V_149 ) ;
