...
if ( V_37 > 1 )
F_18 ( V_6 , V_21 -> V_38 -> V_39 ,
sizeof( V_21 -> V_38 -> V_39 ) ) ;
F_19 ( V_6 , V_22 ) ;
}
static int F_20 ( struct V_40 * V_40 ,
const char * V_41 ,
const char * V_42 ,
T_5 V_43 ,
char type , char * V_22 )
{
struct V_21 * V_21 = V_40 -> V_44 ;
struct V_1 * V_6 ;
char * * V_45 ;
T_5 V_46 = 0 ;
char * V_47 = NULL ;
...
int F_22 ( struct V_40 * V_40 , const char * V_41 ,
const char * V_42 , T_5 V_43 ,
char * V_22 )
{
return F_20 ( V_40 , V_41 , V_42 ,
V_43 , V_7 , V_22 ) ;
}
int F_23 ( struct V_40 * V_40 , const char * V_41 ,
const char * V_42 , T_5 V_43 ,
char * V_22 )
{
return F_20 ( V_40 , V_41 , V_42 ,
...
int F_24 ( struct V_40 * V_40 , const char * V_56 ,
const char * V_47 , T_5 V_57 )
{
struct V_21 * V_21 = V_40 -> V_44 ;
struct V_58 V_59 ;
int V_2 = 0 ;
V_2 = F_22 ( V_40 , V_56 , V_47 ,
V_57 , V_59 . V_22 ) ;
if ( V_2 == 0 ) {
V_59 . type = V_7 ;
V_2 = F_25 ( V_40 , V_60 ,
...
V_2 = V_21 -> V_49 -> V_61 ( V_40 , V_60 ) ;
}
return V_2 ;
}
int F_26 ( struct V_21 * V_21 , const struct V_62 * V_63 ,
char * V_64 )
{
struct V_1 * V_6 ;
V_6 = F_1 ( V_7 ) ;
