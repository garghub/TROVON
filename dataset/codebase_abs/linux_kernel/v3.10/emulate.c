...
unsigned long V_288 ;
V_6 -> V_38 ( V_2 , & V_284 , & V_282 , & V_70 , V_196 ) ;
if ( ! V_282 . V_102 )
return false ;
if ( F_19 ( & V_282 ) < 103 )
return false ;
...
if ( V_191 != V_89 )
return V_191 ;
V_191 = F_74 ( V_2 , V_291 -> V_316 , V_193 ) ;
if ( V_191 != V_89 )
return V_191 ;
return V_89 ;
}
...
V_6 -> V_71 ( V_2 , V_302 , & V_325 , 0 , V_196 ) ;
if ( V_323 ) {
...
if ( V_2 -> V_22 . V_112 == 0 )
return F_29 ( V_2 ) ;
V_336 = V_2 -> V_27 . V_112 & 0xff ;
V_345 = V_336 / V_2 -> V_22 . V_112 ;
V_336 %= V_2 -> V_22 . V_112 ;
V_2 -> V_27 . V_112 = ( V_2 -> V_27 . V_112 & 0xffff0000 ) | V_336 | ( V_345 << 8 ) ;
V_2 -> V_22 . type = V_343 ;
V_2 -> V_22 . V_112 = 0 ;
V_2 -> V_22 . V_25 = 1 ;
F_108 ( V_2 , V_344 ) ;
...
{
return F_151 ( V_2 , V_2 -> V_6 -> V_181 ) ;
}
static int F_154 ( struct V_1 * V_2 )
{
return F_151 ( V_2 , V_2 -> V_6 -> V_178 ) ;
}
...
static unsigned F_181 ( struct V_1 * V_2 )
{
unsigned V_72 ;
...
static int F_183 ( struct V_1 * V_2 , struct V_110 * V_111 ,
unsigned V_40 )
{
int V_91 = V_89 ;
switch ( V_40 ) {
...
break;
case V_406 :
V_91 = F_182 ( V_2 , V_111 , F_181 ( V_2 ) , true ) ;
break;
case V_407 :
V_91 = F_182 ( V_2 , V_111 , V_2 -> V_104 , true ) ;
break;
case V_408 :
V_2 -> V_395 . V_25 = 1 ;
if ( V_2 -> V_395 . type == V_131 ) {
V_2 -> V_395 . V_77 . V_9 = F_43 ( V_2 , V_2 -> V_20 , 1 ) ;
F_47 ( & V_2 -> V_395 ) ;
}
goto V_396;
case V_409 :
...
goto V_396;
case V_411 :
V_91 = F_182 ( V_2 , V_111 , 2 , false ) ;
break;
case V_412 :
V_91 = F_182 ( V_2 , V_111 , F_181 ( V_2 ) , false ) ;
break;
case V_413 :
V_111 -> type = V_143 ;
V_111 -> V_25 = ( V_2 -> V_40 & V_132 ) ? 1 : V_2 -> V_104 ;
...
F_184 ( V_111 -> V_240 , V_111 -> V_25 , V_2 ) ;
break;
case V_416 :
...
int F_185 ( struct V_1 * V_2 , void * V_424 , int V_425 )
{
int V_91 = V_89 ;
int V_36 = V_2 -> V_36 ;
...
V_2 -> V_79 . V_96 = V_2 -> V_79 . V_98 + V_425 ;
if ( V_425 > 0 )
memcpy ( V_2 -> V_79 . V_90 , V_424 , V_425 ) ;
switch ( V_36 ) {
case V_87 :
case V_194 :
case V_219 :
...
if ( V_2 -> V_121 & 8 )
V_2 -> V_104 = 8 ;
V_431 = V_433 [ V_2 -> V_123 ] ;
if ( V_2 -> V_123 == 0x0f ) {
V_2 -> V_434 = 1 ;
V_2 -> V_123 = F_60 ( T_4 , V_2 ) ;
V_431 = V_435 [ V_2 -> V_123 ] ;
}
V_2 -> V_40 = V_431 . V_106 ;
if ( V_2 -> V_40 & V_122 )
V_2 -> V_141 = F_60 ( T_4 , V_2 ) ;
while ( V_2 -> V_40 & V_436 ) {
switch ( V_2 -> V_40 & V_436 ) {
case V_437 :
V_428 = ( V_2 -> V_141 >> 3 ) & 7 ;
V_431 = V_431 . V_438 . V_439 [ V_428 ] ;
break;
case V_440 :
V_428 = ( V_2 -> V_141 >> 3 ) & 7 ;
if ( ( V_2 -> V_141 >> 6 ) == 3 )
V_431 = V_431 . V_438 . V_441 -> V_442 [ V_428 ] ;
else
V_431 = V_431 . V_438 . V_441 -> V_443 [ V_428 ] ;
break;
case V_444 :
V_428 = V_2 -> V_141 & 7 ;
V_431 = V_431 . V_438 . V_439 [ V_428 ] ;
...
if ( V_2 -> V_17 && V_430 )
return V_333 ;
V_429 = V_430 ? 0x66 : V_2 -> V_17 ;
switch ( V_429 ) {
case 0x00 : V_431 = V_431 . V_438 . V_446 -> V_447 ; break;
case 0x66 : V_431 = V_431 . V_438 . V_446 -> V_448 ; break;
case 0xf2 : V_431 = V_431 . V_438 . V_446 -> V_449 ; break;
case 0xf3 : V_431 = V_431 . V_438 . V_446 -> V_450 ; break;
}
break;
case V_451 :
if ( V_2 -> V_141 > 0xbf )
V_431 = V_431 . V_438 . V_452 -> V_453 [ V_2 -> V_141 - 0xc0 ] ;
else
V_431 = V_431 . V_438 . V_452 -> V_111 [ ( V_2 -> V_141 >> 3 ) & 7 ] ;
break;
default:
return V_333 ;
}
V_2 -> V_40 &= ~ ( V_113 ) V_436 ;
V_2 -> V_40 |= V_431 . V_106 ;
}
V_2 -> V_454 = V_431 . V_438 . V_454 ;
V_2 -> V_455 = V_431 . V_455 ;
V_2 -> V_12 = V_431 . V_12 ;
if ( V_2 -> V_40 == 0 || ( V_2 -> V_40 & V_456 ) )
return V_333 ;
if ( ! ( V_2 -> V_40 & V_457 ) && V_2 -> V_458 )
return V_333 ;
if ( V_36 == V_37 && ( V_2 -> V_40 & V_459 ) )
V_2 -> V_104 = 8 ;
if ( V_2 -> V_40 & V_460 ) {
if ( V_36 == V_37 )
V_2 -> V_104 = 8 ;
...
V_91 = F_183 ( V_2 , & V_2 -> V_22 , ( V_2 -> V_40 >> V_462 ) & V_463 ) ;
if ( V_91 != V_89 )
goto V_155;
V_91 = F_183 ( V_2 , & V_2 -> V_224 , ( V_2 -> V_40 >> V_464 ) & V_463 ) ;
if ( V_91 != V_89 )
goto V_155;
V_91 = F_183 ( V_2 , & V_2 -> V_27 , ( V_2 -> V_40 >> V_465 ) & V_463 ) ;
V_155:
...
static int F_108 ( struct V_1 * V_2 , void (* F_46)( struct F_108 * ) )
{
T_1 V_106 = ( V_2 -> V_172 & V_108 ) | V_109 ;
F_46 += F_190 ( V_2 -> V_27 . V_25 ) * V_471 ;
...
const struct V_179 * V_6 = V_2 -> V_6 ;
int V_91 = V_89 ;
int V_472 = V_2 -> V_27 . type ;
V_2 -> V_160 . V_161 = 0 ;
if ( ( V_2 -> V_36 == V_37 && ( V_2 -> V_40 & V_473 ) ) ||
( V_2 -> V_40 & V_474 ) ) {
V_91 = F_27 ( V_2 ) ;
goto V_155;
}
if ( V_2 -> V_199 && ( ! ( V_2 -> V_40 & V_475 ) || V_2 -> V_27 . type != V_143 ) ) {
V_91 = F_27 ( V_2 ) ;
goto V_155;
}
if ( ( V_2 -> V_40 & V_476 ) == V_477 && V_2 -> V_22 . type != V_143 ) {
V_91 = F_27 ( V_2 ) ;
goto V_155;
}
if ( ( ( V_2 -> V_40 & ( V_124 | V_128 ) ) && ( ( V_6 -> V_116 ( V_2 , 0 ) & V_118 ) ) )
|| ( ( V_2 -> V_40 & V_124 ) && ! ( V_6 -> V_116 ( V_2 , 4 ) & V_478 ) ) ) {
V_91 = F_27 ( V_2 ) ;
goto V_155;
}
...
if ( F_41 ( V_2 -> V_480 ) && V_2 -> V_12 ) {
V_91 = F_7 ( V_2 , V_2 -> V_12 ,
V_481 ) ;
if ( V_91 != V_89 )
goto V_155;
}
if ( ( V_2 -> V_40 & V_482 ) && V_6 -> V_84 ( V_2 ) ) {
V_91 = F_25 ( V_2 , 0 ) ;
goto V_155;
}
if ( ( V_2 -> V_40 & V_483 ) && V_2 -> V_36 < V_219 ) {
V_91 = F_27 ( V_2 ) ;
goto V_155;
}
if ( V_2 -> V_455 ) {
...
if ( ( V_2 -> V_22 . type == V_143 ) && ! ( V_2 -> V_40 & V_485 ) ) {
...
if ( ( V_2 -> V_40 & V_486 ) == V_487 )
goto V_488;
if ( ( V_2 -> V_27 . type == V_143 ) && ! ( V_2 -> V_40 & V_479 ) ) {
...
if ( V_2 -> V_454 ) {
if ( V_2 -> V_40 & V_490 ) {
void (* F_46)( struct F_108 * ) = ( void * ) V_2 -> V_454 ;
V_91 = F_108 ( V_2 , F_46 ) ;
if ( V_91 != V_89 )
goto V_155;
goto F_78;
...
goto V_155;
V_2 -> V_27 . type = V_472 ;
if ( ( V_2 -> V_40 & V_476 ) == V_494 )
F_127 ( V_2 , V_148 , & V_2 -> V_22 ) ;
if ( ( V_2 -> V_40 & V_486 ) == V_495 )
