...
V_61 = L_16 ;
break;
case V_62 : V_38 = V_63 ; V_52 = '_' ; break;
case V_64 : V_38 = V_65 ;
V_61 = L_17 ;
V_66 = V_67 ;
V_68 = V_69 ;
break;
case V_70 : V_52 = '_' ; break;
case V_71 : V_38 = V_72 ; V_52 = '_' ; break;
case V_73 : V_38 = V_74 ; V_52 = '_' ; break;
case V_75 : V_52 = '_' ; break;
case V_76 : V_38 = V_77 ; break;
case V_78 : V_38 = V_79 ; V_52 = '_' ; break;
case V_80 :
V_56 = F_12 ;
V_20 = V_81 ;
V_38 = V_82 ;
...
break;
case V_85 :
if ( V_39 ( V_37 -> V_86 ) != sizeof( T_7 )
|| V_39 ( V_37 -> V_87 ) != sizeof( V_88 ) ) {
fprintf ( V_15 ,
L_19 , V_21 ) ;
F_6 () ;
}
if ( V_39 ( V_37 -> V_53 ) == V_75 ) {
V_38 = V_89 ;
V_58 = - 4 ;
}
if ( V_39 ( V_37 -> V_53 ) == V_70 ) {
V_38 = V_90 ;
V_68 = V_69 ;
}
F_28 ( V_37 , V_21 , V_38 ) ;
break;
case V_91 : {
T_8 * const V_92 = ( T_8 * ) V_37 ;
if ( V_39 ( V_92 -> V_86 ) != sizeof( T_8 )
|| V_39 ( V_92 -> V_87 ) != sizeof( V_93 ) ) {
fprintf ( V_15 ,
L_19 , V_21 ) ;
F_6 () ;
}
if ( V_39 ( V_92 -> V_53 ) == V_75 ) {
V_38 = V_94 ;
V_83 = - 8 ;
}
if ( V_39 ( V_92 -> V_53 ) == V_70 ) {
V_38 = V_95 ;
V_96 = F_25 ;
V_97 = F_26 ;
V_98 = V_99 ;
...
int
main ( int V_100 , char * V_101 [] )
{
const char V_102 [] = L_20 ;
int V_103 = sizeof( V_102 ) - 1 ;
int V_104 = 0 ;
int V_105 ;
int V_106 ;
while ( ( V_105 = F_30 ( V_100 , V_101 , L_21 ) ) >= 0 ) {
switch ( V_105 ) {
case 'w' :
V_107 = 1 ;
break;
...
for ( V_106 = V_108 ; V_106 < V_100 ; V_106 ++ ) {
char * V_109 = V_101 [ V_106 ] ;
int const V_110 = setjmp ( V_111 ) ;
int V_112 ;
V_112 = strlen ( V_109 ) ;
if ( V_112 >= V_103 &&
strcmp ( V_109 + ( V_112 - V_103 ) , V_102 ) == 0 )
continue;
switch ( V_110 ) {
default:
fprintf ( V_15 , L_23 , V_109 ) ;
exit ( 1 ) ;
break;
case V_113 :
V_5 = - 1 ;
