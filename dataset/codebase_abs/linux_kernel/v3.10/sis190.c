...
static V_15 F_12 ( void T_1 * V_1 , T_2 V_7 )
{
V_15 V_21 = 0xffff ;
unsigned int V_3 ;
if ( ! ( F_4 ( V_22 ) & 0x0002 ) )
...
static inline void F_21 ( struct V_30 * V_31 , T_3 V_41 ,
T_2 V_34 )
{
V_31 -> V_42 = F_17 ( V_41 ) ;
F_18 ( V_31 , V_34 ) ;
...
static T_4 F_54 ( int V_113 , void * V_114 )
{
...
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
const int V_113 = V_19 -> V_46 -> V_113 ;
F_60 ( V_113 ) ;
F_54 ( V_113 , V_17 ) ;
F_61 ( V_113 ) ;
}
...
goto V_206;
F_89 ( V_17 ) ;
V_202 = F_95 ( V_79 -> V_113 , F_54 , V_207 , V_17 -> V_208 , V_17 ) ;
if ( V_202 < 0 )
goto V_209;
F_75 ( V_17 ) ;
V_48:
...
static T_5 F_106 ( struct V_43 * V_44 ,
struct V_16 * V_17 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
void T_1 * V_1 = V_19 -> V_20 ;
...
static struct V_16 * F_132 ( struct V_46 * V_79 )
{
struct V_18 * V_19 ;
struct V_16 * V_17 ;
void T_1 * V_1 ;
...
F_134 ( V_17 , & V_79 -> V_17 ) ;
V_19 = F_9 ( V_17 ) ;
V_19 -> V_17 = V_17 ;
V_19 -> V_258 = F_135 ( V_259 . V_258 , V_260 ) ;
V_202 = F_136 ( V_79 ) ;
if ( V_202 < 0 ) {
if ( F_115 ( V_19 ) )
F_5 ( L_23 , F_117 ( V_79 ) ) ;
...
V_202 = - V_262 ;
if ( ! ( F_137 ( V_79 , 0 ) & V_263 ) ) {
if ( F_115 ( V_19 ) )
F_5 ( L_24 ,
F_117 ( V_79 ) ) ;
goto V_264;
}
if ( F_138 ( V_79 , 0 ) < V_265 ) {
if ( F_115 ( V_19 ) )
F_5 ( L_25 ,
F_117 ( V_79 ) ) ;
goto V_264;
}
V_202 = F_139 ( V_79 , V_266 ) ;
if ( V_202 < 0 ) {
if ( F_115 ( V_19 ) )
F_5 ( L_26 ,
F_117 ( V_79 ) ) ;
...
V_268 = F_147 ( V_28 ) ;
if ( V_268 & V_149 )
F_148 ( V_28 , V_268 & ~ V_149 ) ;
F_38 ( V_19 , V_212 , V_17 , L_29 ,
F_4 ( V_28 ) , F_4 ( V_269 ) ) ;
F_2 ( V_26 , 0x0000 ) ;
F_100 ( & V_19 -> V_137 ) ;
F_97 ( V_19 ) ;
...
static void F_149 ( struct V_18 * V_19 , T_6 V_7 )
{
V_19 -> V_188 |= ( V_7 & 0x80 ) ? V_189 : 0 ;
}
static int F_150 ( struct V_46 * V_79 ,
struct V_16 * V_17 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
void T_1 * V_1 = V_19 -> V_20 ;
...
for ( V_3 = 0 ; V_3 < V_136 / 2 ; V_3 ++ ) {
V_15 V_272 = F_12 ( V_1 , V_273 + V_3 ) ;
( ( V_274 * ) V_17 -> V_275 ) [ V_3 ] = F_151 ( V_272 ) ;
}
F_149 ( V_19 , F_12 ( V_1 , V_276 ) ) ;
return 0 ;
}
static int F_152 ( struct V_46 * V_79 ,
struct V_16 * V_17 )
{
static const V_15 V_277 [] = { 0x0965 , 0x0966 , 0x0968 } ;
struct V_18 * V_19 = F_9 ( V_17 ) ;
struct V_46 * V_278 ;
T_6 V_7 , V_268 ;
unsigned int V_3 ;
if ( F_115 ( V_19 ) )
F_116 ( L_32 , F_117 ( V_79 ) ) ;
for ( V_3 = 0 ; V_3 < F_153 ( V_277 ) ; V_3 ++ ) {
V_278 = F_154 ( V_279 , V_277 [ V_3 ] , NULL ) ;
if ( V_278 )
break;
}
if ( ! V_278 ) {
...
F_155 ( V_278 , 0x48 , & V_268 ) ;
V_7 = ( V_268 & ~ 0x02 ) ;
F_156 ( V_278 , 0x48 , V_7 ) ;
F_83 ( 50 ) ;
F_155 ( V_278 , 0x48 , & V_7 ) ;
for ( V_3 = 0 ; V_3 < V_136 ; V_3 ++ ) {
F_157 ( 0x9 + V_3 , 0x78 ) ;
V_17 -> V_275 [ V_3 ] = F_158 ( 0x79 ) ;
}
F_157 ( 0x12 , 0x78 ) ;
V_7 = F_158 ( 0x79 ) ;
F_149 ( V_19 , V_7 ) ;
F_156 ( V_278 , 0x48 , V_268 ) ;
F_159 ( V_278 ) ;
return 0 ;
}
static inline void F_160 ( struct V_16 * V_17 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
void T_1 * V_1 = V_19 -> V_20 ;
V_15 V_2 ;
...
for ( V_3 = 0 ; V_3 < V_136 ; V_3 ++ )
F_148 ( V_280 + V_3 , V_17 -> V_275 [ V_3 ] ) ;
F_72 ( V_138 , V_2 ) ;
F_14 () ;
}
static int F_162 ( struct V_46 * V_79 , struct V_16 * V_17 )
{
int V_202 ;
V_202 = F_150 ( V_79 , V_17 ) ;
if ( V_202 < 0 ) {
T_6 V_7 ;
F_155 ( V_79 , 0x73 , & V_7 ) ;
if ( V_7 & 0x00000001 )
V_202 = F_152 ( V_79 , V_17 ) ;
}
return V_202 ;
}
...
int V_6 = V_19 -> V_152 . V_6 ;
int V_8 ;
F_38 ( V_19 , V_162 , V_17 , L_34 ) ;
V_8 = F_7 ( V_1 , V_6 , V_179 ) ;
F_6 ( V_1 , V_6 , V_179 , ( V_8 & V_281 ) |
V_282 | V_283 |
V_284 | V_285 ) ;
...
static int F_164 ( struct V_16 * V_17 , struct V_287 * V_288 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return F_165 ( & V_19 -> V_152 , V_288 ) ;
}
static int F_166 ( struct V_16 * V_17 , struct V_287 * V_288 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return F_167 ( & V_19 -> V_152 , V_288 ) ;
}
static void F_168 ( struct V_16 * V_17 ,
struct V_289 * V_290 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
F_169 ( V_290 -> V_291 , V_266 , sizeof( V_290 -> V_291 ) ) ;
F_169 ( V_290 -> V_292 , V_293 , sizeof( V_290 -> V_292 ) ) ;
F_169 ( V_290 -> V_294 , F_117 ( V_19 -> V_46 ) ,
sizeof( V_290 -> V_294 ) ) ;
}
...
static void F_171 ( struct V_16 * V_17 , struct V_295 * V_296 ,
void * V_173 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
unsigned long V_123 ;
...
V_296 -> V_89 = V_265 ;
F_71 ( & V_19 -> V_137 , V_123 ) ;
F_172 ( V_173 , V_19 -> V_20 , V_296 -> V_89 ) ;
F_73 ( & V_19 -> V_137 , V_123 ) ;
}
...
static void F_176 ( struct V_16 * V_17 , T_2 V_297 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
V_19 -> V_258 = V_297 ;
}
static int F_177 ( struct V_16 * V_17 , struct V_298 * V_299 , int V_288 )
{
struct V_18 * V_19 = F_9 ( V_17 ) ;
return ! F_55 ( V_17 ) ? - V_300 :
F_178 ( & V_19 -> V_152 , F_179 ( V_299 ) , V_288 , NULL ) ;
}
static int F_180 ( struct V_16 * V_17 , void * V_173 )
{
int V_202 ;
V_202 = F_181 ( V_17 , V_173 ) ;
if ( ! V_202 )
F_160 ( V_17 ) ;
return V_202 ;
}
static int F_182 ( struct V_46 * V_79 ,
...
V_19 = F_9 ( V_17 ) ;
V_1 = V_19 -> V_20 ;
V_202 = F_162 ( V_79 , V_17 ) ;
if ( V_202 < 0 )
goto V_305;
F_160 ( V_17 ) ;
F_187 ( & V_19 -> V_118 , F_77 ) ;
V_17 -> V_306 = & V_307 ;
F_188 ( V_17 , & V_308 ) ;
V_17 -> V_309 = V_310 ;
F_189 ( & V_19 -> V_137 ) ;
...
F_191 ( V_17 , L_36 ,
F_117 ( V_79 ) ,
V_312 [ V_302 -> V_313 ] . V_208 ,
V_1 , V_79 -> V_113 , V_17 -> V_275 ) ;
F_191 ( V_17 , L_37 ,
( V_19 -> V_188 & V_189 ) ? L_38 : L_39 ) ;
}
F_81 ( V_17 ) ;
F_163 ( V_17 ) ;
V_48:
...
static void F_192 ( struct V_46 * V_79 )
{
struct V_16 * V_17 = F_127 ( V_79 ) ;
struct V_18 * V_19 = F_9 ( V_17 ) ;
F_125 ( V_17 ) ;
