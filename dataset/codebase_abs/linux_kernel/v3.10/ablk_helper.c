...
struct V_13 * V_22 =
F_14 ( V_14 ) ;
memcpy ( V_22 , V_14 , sizeof( * V_14 ) ) ;
F_15 ( V_22 , & V_6 -> V_8 -> V_9 ) ;
return F_16 ( V_22 ) ;
} else {
return F_7 ( V_14 ) ;
}
...
V_16 . V_17 = V_14 -> V_17 ;
V_16 . V_18 = 0 ;
return F_10 ( V_16 . V_2 ) -> F_19 (
& V_16 , V_14 -> V_19 , V_14 -> V_20 , V_14 -> V_21 ) ;
}
}
void F_20 ( struct V_23 * V_2 )
{
struct V_5 * V_6 = F_21 ( V_2 ) ;
F_22 ( V_6 -> V_8 ) ;
}
int F_23 ( struct V_23 * V_2 , const char * V_24 )
{
struct V_5 * V_6 = F_21 ( V_2 ) ;
struct V_25 * V_8 ;
V_8 = F_24 ( V_24 , 0 , 0 ) ;
...
return F_26 ( V_8 ) ;
V_6 -> V_8 = V_8 ;
V_2 -> V_26 . V_27 = sizeof( struct V_13 ) +
F_27 ( & V_8 -> V_9 ) ;
return 0 ;
}
int F_28 ( struct V_23 * V_2 )
{
char V_24 [ V_28 ] ;
