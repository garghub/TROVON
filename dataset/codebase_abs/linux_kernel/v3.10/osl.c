...
if ( V_197 != V_200 )
V_203 = 1 ;
V_204 = F_156 ( V_9 , V_202 -> V_208 , V_5 , V_203 ) ;
if ( V_204 ) {
if ( V_197 != V_200 ) {
if ( V_197 == V_199 )
F_11 ( V_209 L_52
...
int F_157 ( T_21 V_208 , T_21 V_212 ,
const char * V_69 )
{
struct V_201 V_202 = {
. V_208 = V_208 ,
...
void F_159 ( T_22 V_163 )
{
F_160 ( V_163 ) ;
}
T_23 F_161 ( T_22 V_213 )
{
T_23 V_205 ;
F_162 ( V_213 , V_205 ) ;
return V_205 ;
}
void F_163 ( T_22 V_213 , T_23 V_205 )
{
F_164 ( V_213 , V_205 ) ;
}
T_11
F_165 ( char * V_69 , V_126 V_41 , V_126 V_214 , T_24 * * V_215 )
{
* V_215 = F_166 ( V_69 , V_41 , 0 , 0 , NULL ) ;
if ( * V_215 == NULL )
return V_139 ;
else
return V_65 ;
}
T_11 F_167 ( T_24 * V_215 )
{
F_168 ( V_215 ) ;
return ( V_65 ) ;
}
T_11 F_169 ( T_24 * V_215 )
{
F_170 ( V_215 ) ;
return ( V_65 ) ;
}
T_11 F_171 ( T_24 * V_215 , void * V_216 )
{
F_172 ( V_215 , V_216 ) ;
return ( V_65 ) ;
}
...
T_11 T_3 F_174 ( void )
{
V_160 = F_175 ( L_58 , 0 , 1 ) ;
V_159 = F_175 ( L_59 , 0 , 1 ) ;
V_157 = F_175 ( L_60 , 0 , 1 ) ;
F_131 ( ! V_160 ) ;
F_131 ( ! V_159 ) ;
F_131 ( ! V_157 ) ;
F_176 ( F_1 ) ;
...
T_11 F_179 ( T_12 V_217 , T_1 V_218 ,
T_1 V_219 )
{
int V_220 = 0 ;
if ( V_221 )
...
void F_180 ( int (* F_181)( T_12 V_217 ,
T_1 V_223 , T_1 V_224 ) )
{
V_221 = F_181 ;
}
void F_182 ( T_19 V_163 , T_1 type , void * V_112 ,
void (* F_181)( struct V_144 * V_145 ) )
{
struct V_225 * V_226 ;
int V_153 ;
V_226 = F_183 ( sizeof( * V_226 ) , V_56 ) ;
if ( ! V_226 )
return;
V_226 -> V_163 = V_163 ;
V_226 -> type = type ;
V_226 -> V_112 = V_112 ;
F_122 ( & V_226 -> V_145 , F_181 ) ;
V_153 = F_184 ( V_157 , & V_226 -> V_145 ) ;
if ( ! V_153 )
F_38 ( V_226 ) ;
}
