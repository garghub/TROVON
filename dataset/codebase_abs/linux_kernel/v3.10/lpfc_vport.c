...
V_2 -> V_117 |= V_125 ;
F_6 ( & V_19 -> V_21 ) ;
if ( ! ( V_19 -> V_82 -> V_117 & V_125 ) ) {
int V_126 = 0 ;
while ( V_126 < ( ( V_19 -> V_39 * 3 ) + 3 ) &&
V_2 -> V_14 > V_15 &&
V_2 -> V_14 < V_75 ) {
V_126 ++ ;
F_28 ( 1000 ) ;
...
if ( V_2 -> V_131 ) {
V_112 = F_25 ( V_19 -> V_39 * 2000 ) ;
if ( ! F_69 ( V_2 , V_132 , 0 , 0 ) )
while ( V_2 -> V_133 && V_112 )
V_112 = F_46 ( V_112 ) ;
else
F_19 ( V_2 -> V_19 , V_134 ,
V_44 ,
...
struct V_1 * * V_141 ;
int V_142 = 0 ;
V_141 = F_75 ( ( V_19 -> V_143 + 1 ) * sizeof( struct V_1 * ) ,
V_35 ) ;
if ( V_141 == NULL )
return NULL ;
F_3 ( & V_19 -> V_21 ) ;
F_22 (port_iterator, &phba->port_list, listentry) {
if ( V_140 -> V_117 & V_125 )
continue;
if ( ! F_58 ( F_43 ( V_140 ) ) ) {
F_15 ( V_140 , V_42 , V_44 ,
L_44
L_45 ) ;
continue;
}
...
void
F_76 ( struct V_18 * V_19 , struct V_1 * * V_141 )
{
int V_144 ;
if ( V_141 == NULL )
return;
for ( V_144 = 0 ; V_144 <= V_19 -> V_143 && V_141 [ V_144 ] != NULL ; V_144 ++ )
F_59 ( F_43 ( V_141 [ V_144 ] ) ) ;
F_17 ( V_141 ) ;
}
void
F_77 ( struct V_1 * V_2 )
