...
if ( F_49 ( V_6 -> V_164 ) )
F_50 ( V_6 -> V_164 , 250 ) ;
F_14 ( & V_157 -> V_219 . V_30 , F_10 ( 200 ) ) ;
return V_225 ;
}
static T_3 F_51 ( int V_223 , void * V_224 )
{
struct V_3 * V_157 = V_224 ;
struct V_6 * V_6 = V_157 -> V_6 ;
#ifndef F_47
...
if ( F_49 ( V_6 -> V_164 ) )
F_50 ( V_6 -> V_164 , 250 ) ;
F_14 ( & V_157 -> V_221 . V_30 , F_10 ( 200 ) ) ;
return V_225 ;
}
int F_52 ( struct V_1 * V_2 , enum V_226 V_227 ,
...
static T_3 F_53 ( int V_223 , void * V_224 )
{
struct V_3 * V_157 = V_224 ;
struct V_6 * V_6 = V_157 -> V_6 ;
T_1 V_9 ;
...
V_157 = F_58 ( V_2 -> V_164 , sizeof( struct V_3 ) ,
V_244 ) ;
if ( V_157 == NULL )
return - V_245 ;
F_59 ( V_2 , V_157 ) ;
V_157 -> V_6 = V_6 ;
for ( V_34 = 0 ; V_34 < F_38 ( V_246 ) ; V_34 ++ )
V_157 -> V_189 [ V_34 ] . V_247 = V_246 [ V_34 ] ;
V_55 = F_60 ( V_6 -> V_164 , F_38 ( V_157 -> V_189 ) ,
V_157 -> V_189 ) ;
if ( V_55 != 0 )
return V_55 ;
V_2 -> V_248 = V_6 -> V_249 ;
F_61 ( V_2 , 8 , 16 , V_250 ) ;
F_23 ( V_6 , V_251 , V_252 ) ;
...
F_23 ( V_6 , V_237 ,
V_232 | V_235 ) ;
F_23 ( V_6 , V_161 , V_236 ) ;
F_65 ( V_6 , V_263 , V_157 ) ;
F_65 ( V_6 , V_262 , V_157 ) ;
F_65 ( V_6 , V_231 , V_157 ) ;
F_65 ( V_6 , V_234 , V_157 ) ;
...
static int F_68 ( struct V_264 * V_265 )
{
return F_69 ( & V_265 -> V_164 , & V_266 ,
& V_267 , 1 ) ;
}
