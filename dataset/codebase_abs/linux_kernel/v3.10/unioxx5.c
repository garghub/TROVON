...
{
struct V_2 * V_3 ;
int V_24 , V_42 , V_43 = 0 ;
int V_44 ;
V_3 = F_18 ( sizeof( * V_3 ) , V_45 ) ;
if ( V_3 == NULL )
return - V_46 ;
V_44 = F_19 ( V_28 , V_41 , V_47 ) ;
if ( V_44 ) {
F_20 ( V_3 ) ;
return V_44 ;
}
...
F_3 ( V_24 + 1 , V_41 + 5 ) ;
F_3 ( 'H' , V_41 + 6 ) ;
while ( ! ( F_6 ( V_41 + 0 ) & V_26 ) )
;
F_3 ( 0 , V_41 + 6 ) ;
while ( ! ( F_6 ( V_41 + 0 ) & V_48 ) ) {
if ( -- V_42 <= 0 ) {
V_43 = 1 ;
break;
}
...
V_28 -> V_41 = V_41 ;
V_41 += V_68 ;
for ( V_24 = V_63 = 0 , V_66 = V_41 ; V_24 < 4 ; V_24 ++ , V_66 += V_69 ) {
V_64 = F_6 ( V_66 + 0xE ) ;
V_65 = F_6 ( V_66 + 0xF ) ;
if ( V_64 != 'g' || V_65 != 1 )
continue;
...
if ( V_44 )
return V_44 ;
for ( V_24 = 0 ; V_24 < V_63 ; V_24 ++ , V_41 += V_69 ) {
V_40 = & V_28 -> V_70 [ V_24 ] ;
V_44 = F_17 ( V_28 , V_40 , V_41 ) ;
if ( V_44 )
return V_44 ;
}
return 0 ;
...
struct V_29 * V_30 ;
struct V_2 * V_3 ;
for ( V_24 = 0 ; V_24 < V_28 -> V_71 ; V_24 ++ ) {
V_30 = & V_28 -> V_70 [ V_24 ] ;
V_3 = V_30 -> V_33 ;
F_25 ( V_3 -> V_10 , V_47 ) ;
F_20 ( V_30 -> V_33 ) ;
