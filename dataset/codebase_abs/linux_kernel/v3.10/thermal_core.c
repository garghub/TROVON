...
int F_36 ( struct V_7 * V_23 , unsigned long * V_64 )
{
int V_21 = - V_8 ;
#ifdef F_37
int V_65 ;
...
static T_1
F_44 ( struct V_38 * V_72 , struct V_73 * V_74 , char * V_75 )
{
...
static T_1
F_47 ( struct V_38 * V_72 , struct V_73 * V_74 , char * V_75 )
{
struct V_7 * V_23 = F_45 ( V_72 ) ;
enum V_76 V_77 ;
int V_78 ;
...
static T_1
F_50 ( struct V_38 * V_72 , struct V_73 * V_74 ,
const char * V_75 , T_2 V_65 )
{
struct V_7 * V_23 = F_45 ( V_72 ) ;
int V_24 , V_21 ;
...
static T_1
F_57 ( struct V_38 * V_72 , struct V_73 * V_74 ,
const char * V_75 , T_2 V_65 )
{
int V_21 = - V_8 ;
struct V_7 * V_23 = F_45 ( V_72 ) ;
...
static T_1
F_58 ( struct V_38 * V_72 , struct V_73 * V_93 , char * V_75 )
{
struct V_7 * V_23 = F_45 ( V_72 ) ;
return sprintf ( V_75 , L_4 , V_23 -> V_5 -> V_2 ) ;
}
static T_1
F_59 ( struct V_38 * V_72 , struct V_73 * V_74 ,
const char * V_75 , T_2 V_65 )
{
struct V_7 * V_23 = F_45 ( V_72 ) ;
int V_21 = 0 ;
...
static T_1
F_60 ( struct V_38 * V_72 ,
struct V_73 * V_74 , char * V_75 )
{
struct V_35 * V_36 = F_61 ( V_72 ) ;
...
static T_1
F_65 ( struct V_38 * V_72 ,
struct V_73 * V_74 , char * V_75 )
{
struct V_34 * V_98 ;
V_98 =
F_43 ( V_74 , struct V_34 , V_74 ) ;
if ( V_98 -> V_24 == V_91 )
...
static T_1
F_66 ( struct V_38 * V_72 , struct V_73 * V_74 , char * V_75 )
{
struct V_99 * V_100 = F_67 ( V_72 ) ;
return sprintf ( V_75 , L_4 , V_100 -> type ) ;
}
static T_1
F_68 ( struct V_38 * V_72 , struct V_73 * V_74 , char * V_75 )
{
long V_29 ;
int V_21 ;
struct V_101 * V_102
...
static T_1
F_69 ( struct V_38 * V_72 , struct V_73 * V_74 ,
char * V_75 )
{
struct V_101 * V_102
= F_43 ( V_74 , struct V_101 , V_74 ) ;
...
V_100 = F_73 ( sizeof( struct V_99 ) , V_22 ) ;
if ( ! V_100 )
return - V_108 ;
F_74 ( & V_100 -> V_109 ) ;
F_75 ( V_100 -> type , V_23 -> type , V_4 ) ;
V_100 -> V_38 = F_76 ( NULL ) ;
if ( F_38 ( V_100 -> V_38 ) ) {
...
goto V_110;
V_107:
V_64 = F_73 ( sizeof( struct V_103 ) , V_22 ) ;
if ( ! V_64 ) {
V_78 = - V_108 ;
goto V_112;
}
...
! V_27 -> V_97 )
return F_94 ( - V_8 ) ;
V_36 = F_73 ( sizeof( struct V_35 ) , V_22 ) ;
if ( ! V_36 )
return F_94 ( - V_108 ) ;
...
F_75 ( V_36 -> type , type ? : L_26 , sizeof( V_36 -> type ) ) ;
F_95 ( & V_36 -> V_19 ) ;
F_74 ( & V_36 -> V_132 ) ;
V_36 -> V_27 = V_27 ;
V_36 -> V_141 = true ;
...
V_23 -> V_152 = F_73 ( V_150 , V_22 ) ;
if ( ! V_23 -> V_152 )
return - V_108 ;
V_23 -> V_153 = F_73 ( V_150 , V_22 ) ;
if ( ! V_23 -> V_153 ) {
F_83 ( V_23 -> V_152 ) ;
return - V_108 ;
}
if ( V_23 -> V_27 -> V_88 ) {
V_23 -> V_154 = F_73 ( V_150 , V_22 ) ;
if ( ! V_23 -> V_154 ) {
F_83 ( V_23 -> V_152 ) ;
F_83 ( V_23 -> V_153 ) ;
return - V_108 ;
...
if ( V_41 > 0 && ! V_27 -> V_62 )
return F_94 ( - V_8 ) ;
V_23 = F_73 ( sizeof( struct V_7 ) , V_22 ) ;
if ( ! V_23 )
return F_94 ( - V_108 ) ;
F_74 ( & V_23 -> V_132 ) ;
F_105 ( & V_23 -> V_17 ) ;
...
F_75 ( V_23 -> type , type ? : L_26 , sizeof( V_23 -> type ) ) ;
V_23 -> V_27 = V_27 ;
V_23 -> V_14 = V_14 ;
...
struct V_7 * F_110 ( const char * V_2 )
{
struct V_7 * V_3 = NULL , * V_168 = F_94 ( - V_8 ) ;
...
if ( ! V_23 )
return - V_8 ;
V_150 = F_112 ( sizeof( struct V_175 ) ) +
F_112 ( 0 ) ;
V_173 = F_113 ( V_150 , V_179 ) ;
if ( ! V_173 )
return - V_108 ;
V_177 = F_114 ( V_173 , 0 , V_178 ++ ,
& V_180 , 0 ,
V_181 ) ;
if ( ! V_177 ) {
F_115 ( V_173 ) ;
...
V_176 -> V_171 = V_171 ;
V_78 = F_118 ( V_173 , V_177 ) ;
if ( V_78 < 0 ) {
F_115 ( V_173 ) ;
return V_78 ;
}
V_78 = F_119 ( V_173 , 0 , V_184 . V_20 , V_179 ) ;
if ( V_78 )
...
static inline int F_120 ( void ) { return 0 ; }
