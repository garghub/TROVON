...
unsigned int V_115 ;
if ( V_42 -> V_84 > F_50 ( V_13 ) )
return V_116 ;
if ( V_42 -> V_84 & 0xf )
return V_116 ;
if ( V_42 -> V_43 > 2048 )
return V_117 ;
V_115 = V_42 -> V_84 * V_42 -> V_43 * F_51 ( V_42 ) ;
if ( V_115 > V_28 -> V_118 )
return V_119 ;
return V_120 ;
}
...
struct V_27 * V_28 = V_5 -> V_29 ;
int V_44 = V_3 -> V_44 ;
unsigned int V_121 , div ;
int V_59 ;
F_9 ( V_5 -> V_5 ) ;
if ( V_44 == V_45 )
F_32 ( V_13 , V_57 ) ;
V_59 = F_53 ( V_28 -> V_122 , V_13 -> V_42 . clock * 1000 * 2 ) ;
if ( V_59 ) {
F_13 ( V_5 -> V_5 , L_6 ,
V_13 -> V_42 . clock ) ;
goto V_123;
}
V_121 = F_54 ( V_28 -> V_124 ) ;
div = V_121 / ( V_13 -> V_42 . clock * 1000 ) ;
F_44 ( L_7 , V_121 , V_13 -> V_42 . clock , div ) ;
F_44 ( L_8 , F_54 ( V_28 -> V_124 ) , F_54 ( V_28 -> V_122 ) ) ;
F_10 ( V_5 , V_125 , F_55 ( div ) |
V_126 ) ;
if ( V_28 -> V_46 == 2 )
F_20 ( V_5 , V_127 ,
V_128 | V_129 |
...
T_2 F_56 ( struct V_12 * V_13 )
{
struct V_3 * V_3 = F_8 ( V_13 ) ;
struct V_4 * V_5 = V_13 -> V_5 ;
struct V_27 * V_28 = V_5 -> V_29 ;
T_1 V_21 = F_57 ( V_5 ) ;
if ( ( V_21 & V_131 ) && ( V_21 & V_132 ) ) {
F_24 ( V_13 ) ;
F_13 ( V_5 -> V_5 , L_9 , V_21 ) ;
F_58 ( V_5 , V_21 ) ;
V_24 ( V_13 ) ;
} else if ( V_21 & V_133 ) {
F_58 ( V_5 , V_21 ) ;
...
F_7 ( V_13 , 1 ) ;
F_59 ( V_5 , 0 ) ;
F_60 ( & V_5 -> V_134 , V_107 ) ;
V_55 = V_3 -> V_55 ;
V_3 -> V_55 = NULL ;
if ( V_55 )
F_61 ( V_5 , 0 , V_55 ) ;
F_62 ( & V_5 -> V_134 , V_107 ) ;
if ( V_31 && ! V_3 -> V_31 )
F_63 ( V_5 , 0 ) ;
}
if ( V_28 -> V_46 == 2 ) {
...
void F_65 ( struct V_12 * V_13 , struct V_138 * V_139 )
{
struct V_3 * V_3 = F_8 ( V_13 ) ;
struct V_54 * V_55 ;
struct V_4 * V_5 = V_13 -> V_5 ;
...
F_60 ( & V_5 -> V_134 , V_107 ) ;
V_55 = V_3 -> V_55 ;
if ( V_55 && V_55 -> V_6 . V_140 == V_139 ) {
V_3 -> V_55 = NULL ;
V_55 -> V_6 . V_141 ( & V_55 -> V_6 ) ;
F_63 ( V_5 , 0 ) ;
}
F_62 ( & V_5 -> V_134 , V_107 ) ;
}
struct V_12 * F_66 ( struct V_4 * V_5 )
{
struct V_3 * V_3 ;
struct V_12 * V_13 ;
int V_59 ;
V_3 = F_67 ( sizeof( * V_3 ) , V_142 ) ;
if ( ! V_3 ) {
F_13 ( V_5 -> V_5 , L_10 ) ;
return NULL ;
}
...
V_3 -> V_44 = V_57 ;
F_68 ( & V_3 -> V_60 ) ;
V_59 = F_69 ( & V_3 -> V_11 , 16 , V_142 ) ;
if ( V_59 ) {
F_13 ( V_5 -> V_5 , L_11 ) ;
goto V_143;
}
F_70 ( & V_3 -> V_2 , F_1 ) ;
V_59 = F_71 ( V_5 , V_13 , & V_144 ) ;
if ( V_59 < 0 )
goto V_143;
F_72 ( V_13 , & V_145 ) ;
return V_13 ;
