...
static int F_17 ( struct V_25 * V_2 , unsigned V_9 )
{
return F_10 ( V_9 , V_33 ) ;
}
static void F_18 ( struct V_25 * V_2 , unsigned V_9 , int V_3 )
{
if ( V_3 )
F_5 ( V_9 , V_34 ) ;
else
...
static int F_19 ( struct V_25 * V_26 , unsigned V_9 )
{
struct V_1 * V_2 = (struct V_1 * ) V_26 ;
unsigned long V_10 ;
F_6 ( & V_2 -> V_11 , V_10 ) ;
...
static int F_20 ( struct V_25 * V_26 , unsigned V_9 , int V_3 )
{
struct V_1 * V_2 = (struct V_1 * ) V_26 ;
unsigned long V_10 ;
F_6 ( & V_2 -> V_11 , V_10 ) ;
...
static int F_21 ( struct V_37 * V_28 )
{
struct V_38 * V_39 ;
int V_40 = - V_41 ;
T_3 V_42 = V_27 ;
V_39 = F_22 ( V_28 , V_43 , 0 ) ;
if ( ! V_39 ) {
F_23 ( & V_28 -> V_29 , L_2 ) ;
goto V_44;
}
if ( ! F_24 ( V_39 -> V_45 , F_25 ( V_39 ) , V_28 -> V_46 ) ) {
F_23 ( & V_28 -> V_29 , L_3 ) ;
goto V_44;
}
V_1 . V_6 = V_39 -> V_45 ;
...
return 0 ;
V_47:
V_47 ( V_39 -> V_45 , F_25 ( V_39 ) ) ;
V_44:
return V_40 ;
}
static int F_28 ( struct V_37 * V_28 )
{
struct V_38 * V_48 ;
int V_40 ;
V_40 = F_29 ( & V_1 . V_2 ) ;
...
V_48 = F_22 ( V_28 , V_43 , 0 ) ;
V_47 ( V_48 -> V_45 , F_25 ( V_48 ) ) ;
return 0 ;
}
