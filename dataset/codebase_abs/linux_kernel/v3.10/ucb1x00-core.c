...
struct V_62 * V_63 ;
int V_64 = - V_65 ;
V_63 = F_37 ( sizeof( struct V_62 ) , V_66 ) ;
if ( V_63 ) {
V_63 -> V_2 = V_2 ;
V_63 -> V_61 = V_61 ;
V_64 = V_61 -> V_67 ( V_63 ) ;
if ( V_64 == 0 ) {
F_38 ( & V_63 -> V_68 , & V_2 -> V_69 ) ;
F_38 ( & V_63 -> V_70 , & V_61 -> V_69 ) ;
} else {
F_39 ( V_63 ) ;
}
}
...
V_2 = F_52 ( sizeof( struct V_1 ) , V_66 ) ;
V_64 = - V_65 ;
if ( ! V_2 )
goto V_4;
F_53 ( & V_2 -> V_63 ) ;
...
{
struct V_52 * V_53 = V_63 -> V_56 ;
struct V_1 * V_2 = F_86 ( V_63 ) ;
struct V_62 * V_113 ;
F_17 ( & V_104 ) ;
...
static int F_90 ( struct V_73 * V_63 )
{
struct V_52 * V_53 = V_63 -> V_56 ;
struct V_1 * V_2 = F_86 ( V_63 ) ;
struct V_62 * V_113 ;
