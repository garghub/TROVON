...
{
struct V_19 * V_19 = F_11 ( V_24 -> V_25 . V_26 ) ;
struct V_7 * V_8 ;
int V_27 ;
V_8 = F_12 ( & V_24 -> V_25 , sizeof( struct V_7 ) ,
V_28 ) ;
if ( V_8 == NULL )
return - V_29 ;
F_13 ( V_24 , V_8 ) ;
V_8 -> V_18 . V_19 = V_19 ;
V_8 -> V_18 . V_30 = 8 ;
for ( V_27 = 0 ; V_27 < F_14 ( V_8 -> V_10 ) ; V_27 ++ )
...
V_36 , V_37 ,
& V_8 -> V_10 [ 1 ] ) ;
for ( V_27 = 0 ; V_27 < F_14 ( V_38 ) ; V_27 ++ )
F_16 ( & V_8 -> V_18 , V_27 ) ;
for ( V_27 = 0 ; V_27 < F_14 ( V_39 ) ; V_27 ++ )
F_17 ( V_19 -> V_20 , V_39 [ V_27 ] ,
V_40 , V_40 ) ;
F_18 ( & V_24 -> V_25 ) ;
F_19 ( & V_24 -> V_25 ) ;
return F_20 ( & V_24 -> V_25 , & V_41 ,
V_38 , F_14 ( V_38 ) ) ;
}
