...
{
struct V_73 * V_74 = V_72 -> V_10 . V_75 ;
...
V_29 = F_27 ( V_10 , sizeof( * V_29 ) , V_93 ) ;
if ( ! V_29 ) {
F_5 ( V_10 , L_16 ) ;
return - V_85 ;
}
V_29 -> V_40 = F_28 ( NULL , L_17 ) ;
if ( F_29 ( V_29 -> V_40 ) ) {
F_5 ( V_10 , L_18 ) ;
return - V_94 ;
}
...
V_70 | F_30 ( 0 ) ;
V_29 -> V_99 = F_31 ( V_10 ,
V_77 -> V_100 + V_101 , V_102 ) ;
if ( ! V_29 -> V_99 ) {
F_5 ( V_10 , L_19 ) ;
V_32 = - V_85 ;
goto V_103;
}
V_29 -> V_104 = F_31 ( V_10 ,
V_77 -> V_100 + V_105 , V_102 ) ;
if ( ! V_29 -> V_104 ) {
F_5 ( V_10 , L_20 ) ;
V_32 = - V_85 ;
goto V_103;
}
V_56 -> V_106 . V_107 = V_29 -> V_99 ;
V_56 -> V_106 . V_108 = V_29 -> V_104 + 0x06 ;
V_56 -> V_106 . V_109 = V_56 -> V_106 . V_108 ;
F_32 ( & V_56 -> V_106 ) ;
F_26 ( V_56 , L_21 ,
( unsigned long long ) V_77 -> V_100 + V_101 ,
( unsigned long long ) V_77 -> V_100 + V_105 ) ;
V_57 -> V_58 = V_29 ;
return F_33 ( V_57 , F_25 ( V_80 ) ? F_34 ( V_80 ) : 0 ,
F_25 ( V_80 ) ? V_110 : NULL ,
V_79 , & V_111 ) ;
if ( ! V_32 )
return 0 ;
V_103:
...
{
struct V_78 * V_57 = F_37 ( & V_72 -> V_10 ) ;
struct V_28 * V_29 ;
if ( ! V_57 )
return 0 ;
V_29 = V_57 -> V_58 ;
