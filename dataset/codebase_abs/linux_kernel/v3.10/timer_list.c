...
F_23 ( V_2 , F_34 ( V_80 -> V_34 ) , V_80 -> V_34 ) ;
#endif
return 0 ;
}
void F_35 ( void )
...
F_24 ( NULL ) ;
F_36 (cpu)
F_23 ( NULL , F_34 ( V_34 ) , V_34 ) ;
#endif
return;
}
static void * F_37 ( struct V_1 * V_82 , T_3 * V_33 )
{
struct V_79 * V_80 = V_82 -> V_83 ;
if ( ! * V_33 ) {
V_80 -> V_34 = - 1 ;
V_80 -> V_10 = F_6 ( F_32 () ) ;
} else if ( V_80 -> V_34 >= V_84 ) {
#ifdef F_33
if ( ! V_80 -> V_81 ) {
V_80 -> V_34 = - 1 ;
V_80 -> V_81 = true ;
...
static void * F_38 ( struct V_1 * V_82 , void * V_78 , T_3 * V_33 )
{
struct V_79 * V_80 = V_82 -> V_83 ;
V_80 -> V_34 = F_39 ( V_80 -> V_34 , V_85 ) ;
++ * V_33 ;
return F_37 ( V_82 , V_33 ) ;
}
static void F_40 ( struct V_1 * V_86 , void * V_78 )
{
}
static int F_41 ( struct V_87 * V_87 , struct V_82 * V_88 )
{
