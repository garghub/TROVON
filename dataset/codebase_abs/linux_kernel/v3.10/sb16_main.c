...
V_128 -> type = V_130 ;
V_128 -> V_58 = 1 ;
V_128 -> V_131 . V_132 . V_133 = 3 ;
if ( V_128 -> V_131 . V_132 . V_134 > 2 )
V_128 -> V_131 . V_132 . V_134 = 2 ;
strcpy ( V_128 -> V_131 . V_132 . V_135 , V_129 [ V_128 -> V_131 . V_132 . V_134 ] ) ;
return 0 ;
}
static int F_45 ( struct V_125 * V_126 , struct V_136 * V_137 )
{
struct V_1 * V_2 = F_46 ( V_126 ) ;
unsigned long V_47 ;
F_11 ( & V_2 -> V_37 , V_47 ) ;
V_137 -> V_131 . V_132 . V_134 [ 0 ] = F_43 ( V_2 ) ;
F_15 ( & V_2 -> V_37 , V_47 ) ;
return 0 ;
}
static int F_47 ( struct V_125 * V_126 , struct V_136 * V_137 )
{
struct V_1 * V_2 = F_46 ( V_126 ) ;
unsigned long V_47 ;
unsigned char V_138 , V_139 ;
int V_140 ;
if ( ( V_138 = V_137 -> V_131 . V_132 . V_134 [ 0 ] ) > 2 )
return - V_85 ;
F_11 ( & V_2 -> V_37 , V_47 ) ;
V_139 = F_43 ( V_2 ) ;
V_140 = V_138 != V_139 ;
...
{
unsigned long V_47 ;
unsigned char V_141 = 0 , V_142 = 0 , V_143 ;
unsigned char V_144 , V_145 , V_146 ;
F_11 ( & V_2 -> V_96 , V_47 ) ;
V_143 = F_31 ( V_2 , V_147 ) & ~ 0x06 ;
F_15 ( & V_2 -> V_96 , V_47 ) ;
switch ( V_2 -> V_92 ) {
case 2 :
case 9 :
...
F_11 ( & V_2 -> V_96 , V_47 ) ;
F_49 ( V_2 , V_159 , V_141 ) ;
V_144 = F_31 ( V_2 , V_159 ) ;
F_49 ( V_2 , V_160 , V_142 ) ;
V_145 = F_31 ( V_2 , V_160 ) ;
F_49 ( V_2 , V_147 , V_143 ) ;
V_146 = F_31 ( V_2 , V_147 ) ;
F_15 ( & V_2 -> V_96 , V_47 ) ;
if ( ( ~ V_144 ) & V_141 || ( ~ V_145 ) & V_142 ) {
F_50 ( V_161 L_4 , V_2 -> V_162 ) ;
F_50 ( V_161 L_5 , V_2 -> V_162 , V_144 , V_145 , V_146 ) ;
F_50 ( V_161 L_6 , V_2 -> V_162 , V_141 , V_142 , V_143 ) ;
return - V_163 ;
}
return 0 ;
}
int F_51 ( struct V_1 * V_2 , int V_164 , struct V_165 * * V_166 )
{
...
if ( V_166 )
* V_166 = NULL ;
if ( ( V_170 = F_52 ( V_168 , L_7 , V_164 , 1 , 1 , & V_169 ) ) < 0 )
return V_170 ;
sprintf ( V_169 -> V_135 , L_8 , V_2 -> V_171 >> 8 , V_2 -> V_171 & 0xff ) ;
V_169 -> V_172 = V_173 ;
V_169 -> V_101 = V_2 ;
F_53 ( V_169 , V_48 , & V_174 ) ;
F_53 ( V_169 , V_86 , & V_175 ) ;
if ( V_2 -> V_67 >= 0 && V_2 -> V_66 != V_2 -> V_67 )
F_54 ( V_168 , F_55 ( & V_176 , V_2 ) ) ;
else
V_169 -> V_172 = V_177 ;
F_56 ( V_169 , V_178 ,
F_57 () ,
...
const struct V_179 * F_58 ( int V_180 )
{
return V_180 == V_48 ?
& V_174 : & V_175 ;
}
