...
int F_24 ( struct V_19 * V_17 , int V_13 )
{
struct V_8 * V_9 ;
int V_38 ;
if ( V_13 <= 0 ) {
F_25 ( V_17 -> V_39 , L_1 , V_13 ) ;
return 0 ;
}
V_9 = F_26 ( V_17 -> V_39 , sizeof( * V_9 ) , V_40 ) ;
if ( ! V_9 )
return - V_41 ;
V_9 -> V_17 = V_17 ;
V_9 -> V_27 = F_27 ( V_17 -> V_39 -> V_42 , V_26 ,
& V_43 , V_9 ) ;
if ( ! V_9 -> V_27 ) {
F_28 ( V_17 -> V_39 , L_2 ) ;
return - V_44 ;
...
void F_31 ( struct V_19 * V_17 )
{
if ( V_17 -> V_13 )
F_32 ( V_17 -> V_13 , V_17 -> V_45 ) ;
}
