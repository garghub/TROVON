...
static T_3 F_82 ( struct V_24 * V_21 , struct V_69 * V_70 ,
char * V_71 )
{
struct V_17 * V_18 = F_36 ( V_21 ) ;
return sprintf ( V_71 , L_4 , F_83 ( V_18 -> V_35 , V_18 -> V_119 ) ) ;
}
static T_3 F_84 ( struct V_24 * V_21 , struct V_69 * V_70 ,
char * V_71 )
{
struct V_17 * V_18 = F_37 ( V_21 ) ;
return sprintf ( V_71 , L_9 , V_18 -> V_120 ) ;
}
static inline void F_85 ( int V_121 )
{
F_32 ( 0x55 , V_121 ) ;
}
...
static inline int F_87 ( int V_121 , int V_1 )
{
F_32 ( V_1 , V_121 ) ;
return F_33 ( V_121 + 1 ) ;
}
static inline void F_88 ( int V_121 , int V_1 , int V_4 )
{
F_32 ( V_1 , V_121 ) ;
F_32 ( V_4 , V_121 + 1 ) ;
}
...
{
if ( F_89 ( & V_21 -> V_124 , V_70 , V_123 ) ) {
F_31 ( V_21 , L_10 ,
V_70 -> V_120 ) ;
}
}
static void F_90 ( struct V_24 * V_21 ,
...
if ( V_18 -> V_33 & V_44 )
F_92 ( & V_21 -> V_124 , & V_132 ) ;
if ( V_18 -> V_33 & V_34 )
F_92 ( & V_21 -> V_124 , & V_133 ) ;
if ( V_18 -> V_33 & V_60 )
F_92 ( & V_21 -> V_124 , & V_134 ) ;
if ( V_18 -> V_33 & V_63 )
F_92 ( & V_21 -> V_124 , & V_135 ) ;
if ( V_18 -> V_33 & V_38 )
F_92 ( & V_21 -> V_124 , & V_136 ) ;
F_92 ( & V_21 -> V_124 , & V_137 ) ;
if ( ! V_18 -> V_20 )
F_93 ( & V_21 -> V_124 , & V_138 . V_70 ) ;
}
static int F_94 ( struct V_24 * V_21 )
{
struct V_17 * V_18 = F_37 ( V_21 ) ;
int V_84 , V_7 ;
if ( ! V_18 -> V_20 ) {
V_84 = F_95 ( & V_21 -> V_124 , & V_138 . V_70 ) ;
if ( V_84 )
goto exit;
}
V_84 = F_96 ( & V_21 -> V_124 , & V_137 ) ;
if ( V_84 )
goto V_139;
if ( V_18 -> V_33 & V_44 ) {
...
if ( V_18 -> V_33 & V_34 ) {
V_84 = F_96 ( & V_21 -> V_124 , & V_133 ) ;
if ( V_84 )
goto V_139;
}
if ( V_18 -> V_33 & V_60 ) {
V_84 = F_96 ( & V_21 -> V_124 , & V_134 ) ;
if ( V_84 )
goto V_139;
}
if ( V_18 -> V_33 & V_63 ) {
V_84 = F_96 ( & V_21 -> V_124 , & V_135 ) ;
if ( V_84 )
goto V_139;
}
if ( V_18 -> V_33 & V_38 ) {
V_84 = F_96 ( & V_21 -> V_124 , & V_136 ) ;
if ( V_84 )
goto V_139;
}
for ( V_7 = 0 ; V_7 < F_40 ( V_128 ) ; V_7 ++ ) {
...
static int F_98 ( struct V_24 * V_21 )
{
struct V_17 * V_18 = F_37 ( V_21 ) ;
struct V_19 * V_20 = V_18 -> V_20 ;
int V_7 ;
T_1 V_1 ;
V_18 -> V_78 = F_99 ( V_18 -> type ) ;
...
static int F_101 ( int V_121 , struct V_17 * V_18 )
{
int V_84 = 0 , V_1 ;
V_92 V_23 ;
F_85 ( V_121 ) ;
V_1 = V_151 ? V_151 : F_87 ( V_121 , 0x20 ) ;
if ( ! ( V_1 == V_152 || V_1 == V_153 ||
V_1 == V_154 ) ) {
V_84 = - V_155 ;
goto exit;
}
F_88 ( V_121 , 0x07 , 0x0a ) ;
V_23 = ( F_87 ( V_121 , 0x60 ) << 8 ) |
F_87 ( V_121 , 0x61 ) ;
if ( ! V_23 ) {
V_84 = - V_155 ;
goto exit;
...
int V_84 ;
V_18 = F_107 ( V_21 , sizeof( struct V_17 ) , V_172 ) ;
if ( ! V_18 )
return - V_173 ;
F_108 ( V_20 , V_18 ) ;
...
static int T_6 F_115 ( int V_121 , unsigned short * V_23 )
{
int V_84 = 0 , V_1 ;
...
static int T_6 F_117 ( unsigned short V_23 )
{
struct V_181 V_3 = {
. V_182 = V_23 ,
. V_183 = V_23 + V_184 - 1 ,
...
if ( V_84 )
goto exit;
V_187 = F_119 ( L_22 , V_23 ) ;
if ( ! V_187 ) {
F_116 ( L_30 ) ;
V_84 = - V_173 ;
goto exit;
}
V_84 = F_120 ( V_187 , & V_3 , 1 ) ;
if ( V_84 ) {
F_116 ( L_31 , V_84 ) ;
goto V_188;
}
...
static int F_123 ( struct V_189 * V_187 )
{
T_1 V_160 , V_24 ;
struct V_181 * V_3 ;
struct V_17 * V_18 ;
...
int V_84 ;
V_3 = F_124 ( V_187 , V_186 , 0 ) ;
if ( ! F_125 ( V_21 , V_3 -> V_182 , V_184 , L_22 ) ) {
F_100 ( V_21 , L_33 ,
...
static int F_127 ( struct V_189 * V_187 )
{
struct V_17 * V_18 = F_128 ( V_187 ) ;
F_114 ( V_18 -> V_175 ) ;
F_91 ( & V_187 -> V_21 ) ;
return 0 ;
}
