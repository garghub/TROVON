...
V_108 = F_44 ( F_45 ( V_109 ) , & V_101 -> V_84 ) ;
V_15 = F_46 ( & V_101 -> V_84 , sizeof( * V_15 ) , V_110 ) ;
if ( ! V_15 ) {
...
if ( ! F_36 ( V_15 , & V_85 ) )
return - V_98 ;
V_103 = F_48 ( V_101 , V_112 , 0 ) ;
if ( ! V_103 ) {
F_37 ( & V_101 -> V_84 , L_20 ) ;
return - V_113 ;
}
V_15 -> V_48 = F_49 ( V_101 , 0 ) ;
if ( V_15 -> V_48 < 0 ) {
F_37 ( & V_101 -> V_84 , L_21 ) ;
return - V_113 ;
}
V_15 -> V_35 = F_50 ( & V_101 -> V_84 ) ;
if ( ! V_15 -> V_35 ) {
F_37 ( & V_101 -> V_84 , L_22 ) ;
return - V_111 ;
}
F_51 ( & V_15 -> V_46 , F_11 , ( unsigned long ) V_15 ) ;
V_15 -> V_22 = F_52 ( & V_101 -> V_84 , V_103 ) ;
if ( F_53 ( V_15 -> V_22 ) )
return F_54 ( V_15 -> V_22 ) ;
V_15 -> V_77 = F_55 ( & V_101 -> V_84 , NULL ) ;
if ( F_53 ( V_15 -> V_77 ) ) {
...
V_15 -> V_45 = F_56 ( V_15 -> V_45 , V_116 ) ;
...
F_58 ( V_125 , V_15 -> V_35 -> V_126 ) ;
F_59 ( V_15 -> V_35 , V_12 , V_13 ) ;
F_60 ( V_15 -> V_35 , V_15 ) ;
V_104 = F_61 ( & V_101 -> V_84 , V_15 -> V_48 , F_16 ,
...
F_30 ( V_15 -> V_48 ) ;
V_104 = F_62 ( V_15 -> V_35 ) ;
if ( V_104 ) {
F_37 ( & V_101 -> V_84 , L_26 ) ;
return V_104 ;
}
F_63 ( V_101 , V_15 ) ;
F_64 ( & V_101 -> V_84 , V_15 -> V_56 ) ;
return 0 ;
}
...
static int F_66 ( struct V_130 * V_84 )
{
struct V_100 * V_101 = F_67 ( V_84 ) ;
struct V_14 * V_15 = F_68 ( V_101 ) ;
...
static int F_74 ( struct V_130 * V_84 )
{
struct V_100 * V_101 = F_67 ( V_84 ) ;
struct V_14 * V_15 = F_68 ( V_101 ) ;
int V_104 = 0 ;
