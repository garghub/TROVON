...
unsigned long V_64 ;
F_68 ( V_3 ) ;
if ( F_69 ( ! F_70 () && ! ( V_62 -> V_64 & V_65 ) ) ) {
F_71 ( & V_3 -> V_5 . V_6 , F_64 ) ;
if ( ! F_72 ( V_62 , & V_3 -> V_5 . V_6 , true ) )
return;
}
F_73 ( & V_57 , V_64 ) ;
F_74 ( & V_3 -> V_5 . V_24 , & V_58 ) ;
F_75 ( & V_66 ) ;
F_76 ( & V_57 , V_64 ) ;
}
}
...
static inline int F_80 ( struct V_3 * V_3 )
{
#ifdef F_81
return V_3 -> V_67 ;
#else
...
static inline void F_83 ( struct V_3 * V_3 , struct V_68 * V_69 )
{
struct V_70 * V_71 ;
#ifdef F_81
int V_72 ;
V_72 = F_82 () ;
V_3 -> V_67 = V_72 ;
V_71 = F_84 ( V_69 -> V_73 , V_72 ) ;
#else
V_71 = & V_69 -> V_73 ;
#endif
F_74 ( & V_3 -> V_5 . V_24 , V_71 ) ;
}
void F_85 ( struct V_3 * V_3 , struct V_68 * V_69 )
{
F_86 ( & V_74 ) ;
F_83 ( V_3 , V_69 ) ;
F_87 ( & V_74 ) ;
...
void F_90 ( struct V_68 * V_69 )
{
struct V_3 * V_4 ;
F_91 ( & V_74 ) ;
F_92 (sb, f) {
if ( ! F_93 ( F_94 ( V_4 ) -> V_43 ) )
continue;
if ( ! F_95 ( V_4 ) )
continue;
if ( ! ( V_4 -> V_40 & V_42 ) )
...
void T_6 F_99 ( unsigned long V_76 )
{
unsigned long V_77 ;
V_8 = F_100 ( L_2 , sizeof( struct V_3 ) , 0 ,
V_78 | V_79 , NULL ) ;
V_77 = ( V_76 * ( V_80 / 1024 ) ) / 10 ;
V_10 . V_11 = F_101 (unsigned long, n, NR_FILE) ;
F_102 () ;
F_103 ( & V_74 , L_3 ) ;
F_104 ( & V_9 , 0 ) ;
}
