...
static void
F_23 ( struct V_5 * V_6 , struct V_65 * V_70 )
{
struct V_67 * V_68 ;
if ( ! V_6 || ! V_70 )
return;
...
static void
F_27 ( struct V_11 * V_12 , struct V_67 * V_68 , int V_71 )
{
struct V_9 * V_10 ;
unsigned V_45 = V_12 -> V_45 ;
F_28 ( & V_68 -> V_69 ) ;
if ( F_29 ( V_68 -> V_68 . V_71 == - V_72 ) )
V_68 -> V_68 . V_71 = V_71 ;
else
V_71 = V_68 -> V_68 . V_71 ;
V_10 = V_12 -> V_10 ;
...
V_12 -> V_45 = 1 ;
F_32 ( & V_10 -> V_38 ) ;
V_68 -> V_68 . V_75 ( & V_12 -> V_12 , & V_68 -> V_68 ) ;
F_33 ( & V_10 -> V_38 ) ;
V_12 -> V_45 = V_45 ;
}
static inline int
F_34 ( T_2 T_1 * V_76 , T_5 * V_77 , struct V_67 * V_68 , unsigned V_14 )
{
unsigned V_74 , V_78 ;
V_74 = F_35 ( V_68 -> V_68 . V_74 - V_68 -> V_68 . V_73 , V_14 ) ;
V_68 -> V_68 . V_73 += V_74 ;
V_78 = V_74 ;
while ( F_29 ( V_78 -- ) )
F_2 ( * V_77 ++ , V_76 ) ;
...
unsigned V_78 ;
int V_79 ;
V_39 = F_9 ( & V_10 -> V_2 -> V_80 ) ;
V_77 = V_68 -> V_68 . V_77 + V_68 -> V_68 . V_73 ;
F_37 ( V_77 ) ;
V_10 = V_12 -> V_10 ;
if ( F_38 ( V_12 -> V_24 == 0 && V_10 -> V_63 != V_81 ) )
return - V_82 ;
if ( F_38 ( ( V_39 & F_39 ( V_12 -> V_24 ) ) != 0 ) )
return 0 ;
if ( V_12 -> V_24 != 0 )
F_2 ( ~ F_16 ( V_12 -> V_24 ) , & V_10 -> V_2 -> V_83 ) ;
V_78 = F_34 ( V_12 -> V_84 , V_77 , V_68 , V_12 -> V_12 . V_44 ) ;
if ( F_38 ( V_78 != V_12 -> V_12 . V_44 ) ) {
F_2 ( ~ ( 1 << V_12 -> V_24 ) , & V_10 -> V_2 -> V_85 ) ;
if ( V_12 -> V_24 == 0 ) {
V_10 -> V_12 [ 0 ] . V_45 = 1 ;
V_10 -> V_63 = V_86 ;
}
...
if ( F_29 ( V_68 -> V_68 . V_74 != V_68 -> V_68 . V_73 )
|| V_68 -> V_68 . V_87 )
V_79 = 0 ;
else
V_79 = 1 ;
...
V_77 = V_68 -> V_68 . V_77 + V_68 -> V_68 . V_73 ;
F_41 ( V_77 ) ;
if ( F_38 ( V_12 -> V_24 == 0 && V_12 -> V_10 -> V_63 != V_94 ) )
return - V_82 ;
V_92 = ( V_12 -> V_24 == 1 || V_12 -> V_24 == 2 ) ;
do {
if ( V_12 -> V_24 != 0 )
F_2 ( ~ F_16 ( V_12 -> V_24 ) , & V_2 -> V_83 ) ;
V_89 = F_9 ( & V_2 -> V_80 ) & F_42 ( V_12 -> V_24 ) ;
V_88 = F_9 ( & V_2 -> V_95 [ V_12 -> V_24 ] ) ;
V_90 = V_68 -> V_68 . V_74 - V_68 -> V_68 . V_73 ;
if ( F_29 ( V_12 -> V_24 != 0 || V_90 != 0 ) ) {
if ( F_38 ( V_89 == 0 ) )
break;
if ( ! ( V_88 & V_96 ) )
V_88 = F_9 ( & V_2 -> V_97 [ V_12 -> V_24 ] ) ;
if ( ! ( V_88 & V_96 ) )
break;
V_88 &= V_98 ;
} else
V_88 = 0 ;
V_68 -> V_68 . V_73 += V_88 ;
V_91 = ( V_88 < V_12 -> V_12 . V_44 ) ;
#ifdef F_31
F_18 ( V_12 -> V_10 , L_9 ,
V_12 -> V_12 . V_37 , V_88 , V_91 ? L_10 : L_11 ,
V_68 , V_68 -> V_68 . V_73 , V_68 -> V_68 . V_74 ) ;
#endif
while ( F_29 ( V_88 -- != 0 ) ) {
T_5 V_99 = ( T_5 ) F_9 ( V_12 -> V_84 ) ;
if ( F_38 ( V_90 == 0 ) ) {
if ( V_68 -> V_68 . V_71 != - V_100 )
F_12 ( V_12 -> V_10 , L_12 ,
V_12 -> V_12 . V_37 , V_88 ) ;
V_68 -> V_68 . V_71 = - V_100 ;
} else {
* V_77 ++ = V_99 ;
V_90 -- ;
}
}
if ( F_38 ( V_91 || V_68 -> V_68 . V_73 == V_68 -> V_68 . V_74 ) ) {
if ( F_38 ( V_12 -> V_24 == 0 ) ) {
if ( V_12 -> V_10 -> V_101 )
F_2 ( V_12 -> V_10 -> V_102
? V_103
...
F_27 ( V_12 , V_68 , 0 ) ;
if ( V_92 && ! F_25 ( & V_12 -> V_69 ) ) {
V_68 = F_43 ( V_12 -> V_69 . V_105 ,
struct V_67 , V_69 ) ;
goto V_93;
}
return 1 ;
...
{
struct V_67 * V_68 ;
if ( F_38 ( F_25 ( & V_12 -> V_69 ) ) )
return;
V_68 = F_43 ( V_12 -> V_69 . V_105 , struct V_67 , V_69 ) ;
...
struct V_1 T_1 * V_2 = V_12 -> V_10 -> V_2 ;
T_2 V_53 ;
T_2 V_106 = V_68 -> V_68 . V_33 ;
T_2 V_107 = V_106 + V_68 -> V_68 . V_74 - 1 ;
V_53 = F_9 ( & V_2 -> V_54 ) & V_55 ;
if ( F_29 ( V_12 -> V_32 ) ) {
if ( F_38 ( V_53 & V_108 ) ) {
F_12 ( V_12 -> V_10 , L_13 ,
...
static void F_49 ( struct V_11 * V_12 , int V_71 )
{
struct V_1 T_1 * V_2 = V_12 -> V_10 -> V_2 ;
struct V_67 * V_68 ;
T_2 V_121 , V_53 ;
F_1 ( V_2 , V_122 , V_12 -> V_24 ) ;
V_68 = F_43 ( V_12 -> V_69 . V_105 , struct V_67 , V_69 ) ;
V_53 = F_9 ( & V_2 -> V_54 ) & V_55 ;
if ( V_12 -> V_32 ) {
if ( F_38 ( ( F_9 ( & V_2 -> V_54 ) & V_108 ) == 0 ) )
goto V_123;
V_121 = F_9 ( & V_2 -> V_119 ) ;
F_2 ( V_121 , & V_2 -> V_109 ) ;
F_2 ( V_121 , & V_2 -> V_110 ) ;
...
V_53 |= V_59 ;
F_2 ( V_53 , & V_2 -> V_54 ) ;
if ( F_9 ( & V_2 -> V_54 ) & V_108 )
F_12 ( V_12 -> V_10 , L_16 ) ;
} else {
if ( F_38 ( ( F_9 ( & V_2 -> V_54 ) & V_114 ) == 0 ) )
goto V_123;
V_121 = F_9 ( & V_2 -> V_120 ) ;
F_2 ( V_121 , & V_2 -> V_115 ) ;
F_2 ( V_121 , & V_2 -> V_116 ) ;
...
V_53 |= V_57 ;
F_2 ( V_53 , & V_2 -> V_54 ) ;
if ( F_9 ( & V_2 -> V_54 ) & V_114 )
F_12 ( V_12 -> V_10 , L_17 ) ;
}
V_68 -> V_68 . V_73 = ( V_121 - V_68 -> V_68 . V_33 ) + 1 ;
V_68 -> V_68 . V_71 = V_71 ;
F_18 ( V_12 -> V_10 , L_18 , V_124 , V_12 -> V_12 . V_37 ,
V_12 -> V_32 ? L_3 : L_4 ,
V_68 -> V_68 . V_73 , V_68 -> V_68 . V_74 ) ;
F_1 ( V_2 , V_125 , V_12 -> V_24 ) ;
return;
V_123:
F_1 ( V_2 , V_125 , V_12 -> V_24 ) ;
V_68 -> V_68 . V_73 = V_68 -> V_68 . V_74 ;
...
static int
F_50 ( struct V_5 * V_6 , struct V_65 * V_70 , T_4 V_66 )
{
struct V_67 * V_68 ;
struct V_11 * V_12 ;
struct V_9 * V_10 ;
...
int V_71 ;
V_68 = F_6 ( V_70 , struct V_67 , V_68 ) ;
if ( F_38 ( ! V_70 || ! V_70 -> V_75
|| ! V_70 -> V_77 || ! F_25 ( & V_68 -> V_69 ) ) )
return - V_18 ;
V_12 = F_6 ( V_6 , struct V_11 , V_12 ) ;
...
#ifdef F_31
F_18 ( V_10 , L_19 ,
V_6 -> V_37 , V_70 , V_70 -> V_74 , V_70 -> V_77 ) ;
#endif
F_13 ( & V_10 -> V_38 , V_15 ) ;
V_70 -> V_71 = - V_72 ;
V_70 -> V_73 = 0 ;
...
V_70 -> V_87 = 1 ;
V_71 = 0 ;
if ( F_25 ( & V_12 -> V_69 ) && F_29 ( ! V_12 -> V_45 ) ) {
if ( V_12 -> V_33 )
V_71 = F_47 ( V_12 , V_68 ) ;
else
V_71 = ( V_12 -> V_32 ? F_36 : F_40 ) ( V_12 , V_68 ) ;
if ( F_38 ( V_71 != 0 ) ) {
if ( V_71 > 0 )
V_71 = 0 ;
V_68 = NULL ;
...
if ( F_29 ( V_68 != 0 ) )
F_52 ( & V_68 -> V_69 , & V_12 -> V_69 ) ;
if ( F_29 ( ! F_25 ( & V_12 -> V_69 ) )
&& F_29 ( V_12 -> V_24 != 0 )
&& ! V_12 -> V_33
&& ! ( V_10 -> V_47 & F_16 ( V_12 -> V_24 ) ) )
...
static void F_19 ( struct V_11 * V_12 , int V_71 )
{
struct V_67 * V_68 ;
V_12 -> V_45 = 1 ;
if ( F_25 ( & V_12 -> V_69 ) )
...
if ( V_12 -> V_33 )
F_49 ( V_12 , V_71 ) ;
while ( ! F_25 ( & V_12 -> V_69 ) ) {
V_68 = F_43 ( V_12 -> V_69 . V_105 , struct V_67 , V_69 ) ;
F_27 ( V_12 , V_68 , V_71 ) ;
}
}
static int F_53 ( struct V_5 * V_6 , struct V_65 * V_70 )
{
struct V_67 * V_68 ;
struct V_11 * V_12 ;
struct V_9 * V_10 ;
...
if ( V_12 -> V_33 && V_12 -> V_69 . V_105 == & V_68 -> V_69 && ! V_12 -> V_45 ) {
F_49 ( V_12 , - V_126 ) ;
F_27 ( V_12 , V_68 , - V_126 ) ;
F_48 ( V_10 , V_12 ) ;
} else if ( ! F_25 ( & V_68 -> V_69 ) )
F_27 ( V_12 , V_68 , - V_126 ) ;
else
V_68 = NULL ;
F_14 ( & V_10 -> V_38 , V_15 ) ;
...
if ( F_25 ( & V_12 -> V_69 ) )
return;
V_68 = F_43 ( V_12 -> V_69 . V_105 , struct V_67 ,
V_69 ) ;
( void ) F_47 ( V_12 , V_68 ) ;
} else
F_46 ( V_12 ) ;
...
static int F_56 ( struct V_5 * V_6 , int V_130 )
{
struct V_11 * V_12 ;
unsigned long V_15 ;
int V_131 = 0 ;
...
F_12 ( V_12 -> V_10 , L_22 , V_124 , V_12 -> V_12 . V_37 ) ;
return - V_18 ;
}
F_13 ( & V_12 -> V_10 -> V_38 , V_15 ) ;
if ( ! F_25 ( & V_12 -> V_69 ) )
...
return - V_127 ;
V_2 = V_12 -> V_10 -> V_2 ;
V_88 = F_9 ( & V_2 -> V_95 [ V_12 -> V_24 ] ) & V_98 ;
V_88 += F_9 ( & V_2 -> V_97 [ V_12 -> V_24 ] ) & V_98 ;
F_18 ( V_12 -> V_10 , L_24 , V_124 , V_12 -> V_12 . V_37 , V_88 ) ;
return V_88 ;
}
...
return;
V_12 = F_6 ( V_6 , struct V_11 , V_12 ) ;
F_18 ( V_12 -> V_10 , L_25 , V_124 , V_12 -> V_12 . V_37 ) ;
...
static inline const char * F_60 ( void )
{
if ( V_34 == 0 )
return L_26 ;
else if ( V_34 == 2 )
...
static void F_61 ( struct V_138 * V_139 , const char * V_140 , T_2 V_141 )
{
F_62 (m,
...
static int F_63 ( struct V_138 * V_139 , void * V_142 )
{
...
F_61 ( V_139 , L_67 , F_9 ( & V_2 -> V_83 ) ) ;
F_61 ( V_139 , L_68 , F_9 ( & V_2 -> V_47 ) ) ;
if ( ! V_145 || ! V_10 -> V_19 || ( V_39 & V_148 ) == 0 )
goto F_27;
if ( F_62 ( V_139 , L_69
L_70 ,
V_10 -> V_61 , F_9 ( & V_2 -> V_80 ) ,
...
( V_39 & V_113 ) ? L_72 : L_11 ,
( V_39 & V_112 ) ? L_73 : L_11 ,
( V_39 & V_117 ) ? L_74 : L_11 ,
( V_39 & V_151 ) ? L_75 : L_11 ,
( V_39 & V_111 ) ? L_76 : L_11 ,
( V_39 & V_59 ) ? L_77 : L_11 ,
( V_39 & V_57 ) ? L_78 : L_11 ,
( V_39 & V_108 ) ? L_79 : L_11 ,
( V_39 & V_114 ) ? L_80 : L_11 ,
( V_39 & V_152 )
? L_81
: L_82 ) < 0 )
goto F_27;
...
static int F_67 ( struct V_154 * V_154 , struct V_155 * V_155 )
{
return F_68 ( V_155 , F_63 , F_69 ( F_70 ( V_155 ) ) ) ;
}
...
V_12 -> V_84 = & V_10 -> V_2 -> V_160 [ V_144 ] ;
...
F_12 ( V_10 , L_106 , V_124 ) ;
V_10 -> V_47 = V_180 ;
F_2 ( V_10 -> V_47 , & V_10 -> V_2 -> V_47 ) ;
}
}
static int F_75 ( struct V_136 * V_181 ,
struct V_182 * V_19 )
{
struct V_9 * V_10 = F_76 ( V_181 ) ;
...
static void
F_77 ( struct V_9 * V_10 , struct V_182 * V_19 )
{
unsigned V_144 ;
F_12 ( V_10 , L_106 , V_124 ) ;
...
F_72 ( V_10 ) ;
for ( V_144 = 0 ; V_144 < 4 ; V_144 ++ )
F_19 ( & V_10 -> V_12 [ V_144 ] , - V_23 ) ;
if ( V_10 -> V_19 )
F_74 ( V_10 ) ;
}
static int F_78 ( struct V_136 * V_181 ,
struct V_182 * V_19 )
{
struct V_9 * V_10 = F_76 ( V_181 ) ;
unsigned long V_15 ;
...
V_185 . V_188 = F_80 ( ( F_9 ( & V_2 -> V_189 ) << 8 )
| F_9 ( & V_2 -> V_190 ) ) ;
V_185 . V_191 = F_80 ( ( F_9 ( & V_2 -> V_192 ) << 8 )
| F_9 ( & V_2 -> V_193 ) ) ;
V_185 . V_194 = F_80 ( ( F_9 ( & V_2 -> V_195 ) << 8 )
| F_9 ( & V_2 -> V_196 ) ) ;
F_2 ( 0 , & V_2 -> V_197 ) ;
F_19 ( & V_10 -> V_12 [ 0 ] , 0 ) ;
V_10 -> V_12 [ 0 ] . V_45 = 0 ;
if ( F_29 ( V_185 . V_186 & V_198 ) ) {
V_10 -> V_12 [ 0 ] . V_32 = 1 ;
V_10 -> V_63 = V_81 ;
...
F_81 ( V_185 . V_188 ) , F_81 ( V_185 . V_191 ) ,
F_81 ( V_185 . V_194 ) ) ;
#endif
V_10 -> V_101 = ( V_185 . V_187 == V_208
&& V_185 . V_186 == V_206 ) ;
if ( F_38 ( V_10 -> V_101 ) )
V_10 -> V_102 = ( V_185 . V_188 != F_80 ( 0 ) ) ;
F_32 ( & V_10 -> V_38 ) ;
...
F_9 ( & V_2 -> V_83 ) , V_10 -> V_47 ) ;
return F_85 ( V_213 ) ;
}
static void F_86 ( struct V_226 * V_211 )
{
struct V_9 * V_10 = F_87 ( V_211 ) ;
F_26 ( V_10 ) ;
}
static void F_88 ( struct V_227 * V_228 )
{
struct V_9 * V_10 = F_89 ( V_228 ) ;
F_12 ( V_10 , L_106 , V_124 ) ;
F_90 ( & V_10 -> V_20 ) ;
F_91 ( V_10 -> V_19 ) ;
#ifdef F_92
...
static int F_101 ( struct V_227 * V_228 , const struct V_233 * V_234 )
{
...
int V_131 ;
if ( ! V_228 -> V_210 ) {
F_102 ( V_238 L_120 , F_103 ( V_228 ) ) ;
V_131 = - V_62 ;
goto V_239;
}
V_10 = F_21 ( sizeof *V_10 , V_240 ) ;
if ( V_10 == NULL ) {
F_104 ( L_121 , F_103 ( V_228 ) ) ;
V_131 = - V_241 ;
goto V_239;
}
F_105 ( & V_10 -> V_38 ) ;
...
V_235 = F_97 ( V_228 , 0 ) ;
V_236 = F_98 ( V_228 , 0 ) ;
if ( ! F_107 ( V_235 , V_236 , V_244 ) ) {
F_12 ( V_10 , L_123 ) ;
V_131 = - V_30 ;
goto V_239;
}
V_10 -> V_231 = 1 ;
V_237 = F_108 ( V_235 , V_236 ) ;
if ( V_237 == NULL ) {
F_12 ( V_10 , L_124 ) ;
V_131 = - V_245 ;
goto V_239;
...
F_100 ( V_228 , V_10 ) ;
F_84 ( V_10 , L_106 , V_246 ) ;
F_84 ( V_10 , L_125 V_247 L_126 , F_60 () ) ;
F_84 ( V_10 , L_127 , V_228 -> V_210 , V_237 ) ;
F_72 ( V_10 ) ;
F_71 ( V_10 ) ;
if ( F_109 ( V_228 -> V_210 , F_82 , V_248 ,
V_244 , V_10 ) != 0 ) {
...
F_110 ( V_228 ) ;
#ifdef F_92
F_111 ( V_229 , 0 , NULL , & V_249 , V_10 ) ;
#endif
V_131 = F_112 ( & V_228 -> V_10 , & V_10 -> V_20 ,
F_86 ) ;
if ( V_131 )
goto V_239;
return 0 ;
