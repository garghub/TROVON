...
V_121 = ( 4000 * 1000 ) >> V_123 ;
else
V_121 = ( 5000 * 1000 ) >> V_123 ;
* V_8 = V_121 / 1000 ;
* V_119 = ( V_121 % 1000 ) * 1000 ;
return V_124 ;
}
return - V_64 ;
}
...
{
const struct V_125 * V_126 = V_14 -> V_49 . V_127 ;
struct V_9 * V_10 ;
int V_18 ;
const unsigned short V_128 [ 4 ] = { 465 , 1010 , 1460 , 1890 } ;
const unsigned short V_129 [ 4 ] = { 1 , 2 , 4 , 8 } ;
struct V_53 * V_54 = F_47 ( sizeof( * V_10 ) ) ;
if ( V_54 == NULL )
return - V_68 ;
V_10 = F_20 ( V_54 ) ;
F_48 ( V_14 , V_54 ) ;
...
V_126 = & V_130 ;
F_1 ( V_10 -> V_1 ) ;
V_10 -> V_14 -> V_131 = V_132 ;
V_10 -> V_14 -> V_92 = V_133 ;
F_49 ( V_10 -> V_14 ) ;
V_10 -> V_46 = F_50 ( V_126 -> V_134 & 0x3 ) ;
V_10 -> V_31 = F_51 ( V_126 -> V_135
& 0x3 ) | ( V_126 -> V_136 ?
V_137 : 0 ) ;
V_18 = F_16 ( V_10 ) ;
if ( V_18 < 0 )
goto V_138;
V_10 -> V_66 = V_18 ;
V_10 -> V_111 = ( V_10 -> V_66 + 1 ) * V_139 ;
V_10 -> V_102 = 0xFF ;
V_10 -> V_106 = 0xFF ;
V_10 -> V_12 =
( ( V_128 [ V_126 -> V_134 & 0x3 ] + 695 ) *
( V_139 * V_129 [ V_126 -> V_135 & 0x3 ] ) )
- V_128 [ V_126 -> V_134 & 0x3 ] +
V_10 -> V_66 * 250 ;
V_10 -> V_12 = F_52 ( V_10 -> V_12 , 1000 ) ;
V_10 -> V_12 += 5 ;
V_54 -> V_97 = F_53 ( V_14 ) -> V_97 ;
V_54 -> V_49 . V_140 = & V_14 -> V_49 ;
V_54 -> V_141 = V_142 ;
V_18 = F_29 ( V_10 ) ;
if ( V_18 < 0 )
goto V_138;
...
{
struct V_53 * V_54 = F_59 ( V_14 ) ;
struct V_9 * V_10 = F_20 ( V_54 ) ;
if ( V_14 -> V_109 > 0 )
F_60 ( V_14 -> V_109 , V_54 ) ;
F_56 ( V_54 ) ;
