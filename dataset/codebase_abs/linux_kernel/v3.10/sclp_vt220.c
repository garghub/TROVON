...
F_30 ( & V_16 , V_65 ) ;
V_16 . V_71 = 0 ;
if ( ! V_65 -> V_72 . V_73 && ! V_65 -> V_72 . V_74 ) {
V_65 -> V_72 . V_73 = 24 ;
V_65 -> V_72 . V_74 = 80 ;
}
}
...
static int
F_32 ( struct V_64 * V_65 , unsigned char V_75 )
{
return F_22 ( & V_75 , 1 , 0 , 0 , 1 ) ;
}
static void
F_33 ( struct V_64 * V_65 )
{
if ( ! V_14 )
F_9 () ;
else
...
if ( V_36 != NULL )
V_48 = F_19 ( V_36 ) ;
F_35 (l, &sclp_vt220_outqueue) {
V_78 = F_6 ( V_76 , struct V_1 , V_8 ) ;
V_48 += F_19 ( V_78 ) ;
}
F_7 ( & V_7 , V_3 ) ;
return V_48 ;
...
{
struct V_9 * V_4 , * V_79 ;
F_39 (page, p, &sclp_vt220_empty) {
F_3 ( V_4 ) ;
F_40 ( ( unsigned long ) V_4 ) ;
}
}
...
static void F_60 ( struct F_50 * V_109 ,
enum V_110 V_110 )
{
switch ( V_110 ) {
case V_111 :
...
static void
F_61 ( struct V_114 * V_115 , const char * V_54 , unsigned int V_48 )
{
F_22 ( ( const unsigned char * ) V_54 , V_48 , 1 , 1 , 0 ) ;
}
static struct V_88 *
F_62 ( struct V_114 * V_51 , int * V_116 )
{
* V_116 = 0 ;
return V_108 ;
}
