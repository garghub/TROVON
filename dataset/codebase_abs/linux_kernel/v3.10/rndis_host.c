...
int F_34 ( struct V_1 * V_2 , struct V_125 * V_126 )
{
...
V_128 = F_37 ( V_126 , V_134 ) ;
if ( F_10 ( ! V_128 ) )
break;
F_35 ( V_126 , V_29 - sizeof *V_127 ) ;
F_36 ( V_128 , V_130 ) ;
F_38 ( V_2 , V_128 ) ;
}
return 1 ;
...
struct V_125 *
F_39 ( struct V_1 * V_2 , struct V_125 * V_126 , T_2 V_75 )
{
struct V_98 * V_127 ;
struct V_125 * V_128 ;
unsigned V_70 = V_126 -> V_70 ;
if ( F_7 ( ! F_40 ( V_126 ) ) ) {
int V_135 = F_41 ( V_126 ) ;
...
V_128 = F_44 ( V_126 , sizeof *V_127 , 1 , V_75 ) ;
F_45 ( V_126 ) ;
if ( F_10 ( ! V_128 ) )
return V_128 ;
V_126 = V_128 ;
V_136:
V_127 = ( void * ) F_46 ( V_126 , sizeof *V_127 ) ;
