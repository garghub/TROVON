...
const struct V_295 * V_296 , int V_297 )
{
struct V_1 * V_2 = V_10 -> V_2 ;
V_2 -> V_6 . V_298 = 1 ;
}
...
T_1 * V_301 ;
for ( V_301 = V_300 ; * V_301 ; V_301 ++ )
F_71 ( V_10 , * V_301 , V_85 ,
V_302 |
F_144 ( V_10 , * V_301 , V_85 ) ) ;
}
...
F_143 ( V_10 ) ;
V_10 -> V_154 = 1 ;
F_147 ( V_10 , NULL , V_309 , V_310 ) ;
break;
default:
V_10 -> V_154 = 1 ;
F_147 ( V_10 , NULL , V_311 , V_310 ) ;
break;
}
switch ( V_10 -> V_142 >> 16 ) {
case 0x103c :
...
F_148 ( V_10 , V_299 ) ;
V_11 = F_149 ( V_10 , & V_2 -> V_6 . V_313 , NULL , 0 ) ;
if ( V_11 < 0 )
goto error;
V_11 = F_150 ( V_10 , & V_2 -> V_6 . V_313 ) ;
if ( V_11 < 0 )
goto error;
V_10 -> V_122 = V_314 ;
if ( ! V_10 -> V_315 -> V_316 ) {
