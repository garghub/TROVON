...
struct V_24 * V_63 = ( void * ) V_59 -> V_64 ;
F_14 ( V_63 -> V_31 , V_62 -> V_65 ) ;
}
int F_15 ( struct V_33 * V_34 , struct V_24 * V_25 ,
struct V_1 * V_2 ,
T_1 V_35 , T_1 V_36 )
{
struct V_61 V_62 = {
...
if ( V_25 != & V_34 -> V_66 )
F_14 ( V_34 -> V_66 . V_31 , V_62 . V_65 ) ;
F_16 ( & V_34 -> V_67 ) ;
V_25 -> V_32 ++ ;
if ( ! F_17 ( V_68 , & V_34 -> V_69 ) ) {
F_18 (
V_34 -> V_57 , F_13 , & V_62 ) ;
V_25 -> V_31 = F_19 ( V_62 . V_65 , V_70 ) ;
if ( F_20 ( V_25 -> V_31 == V_70 ,
L_4 ) )
return - V_71 ;
}
V_25 -> V_44 = V_2 -> V_13 ;
