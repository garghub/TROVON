...
static int F_35 ( struct V_103 * V_33 )
{
return 0 ;
}
static int F_36 ( struct V_103 * V_33 )
{
struct V_104 * V_105 = F_37 ( V_33 ) ;
struct V_13 * V_14 = F_38 ( V_105 ) ;
struct V_2 * V_3 = F_14 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
int V_7 ;
T_2 V_24 , V_25 ;
...
static int F_39 ( struct V_13 * V_14 , int V_106 )
{
struct V_2 * V_3 = F_14 ( V_14 ) ;
struct V_107 * V_108 = F_40 ( V_3 ) ;
struct V_104 * V_105 = F_41 ( V_3 ) ;
int V_7 ;
if ( V_106 ) {
V_7 = F_42 ( & V_3 -> V_33 , V_108 ) ;
if ( V_7 < 0 )
return V_7 ;
V_105 -> V_33 . type = & V_109 ;
} else {
...
F_46 ( & V_3 -> V_33 , L_8 , V_6 ) ;
V_7 = F_47 ( & V_1 -> V_86 ) ;
V_110:
F_39 ( & V_1 -> V_4 , 0 ) ;
return V_7 ;
}
static int F_48 ( struct V_13 * V_14 , T_3 * V_113 )
{
struct V_2 * V_3 = F_14 ( V_14 ) ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
* V_113 = V_1 -> V_44 ;
...
static int F_49 ( struct V_13 * V_14 , unsigned int V_114 ,
enum V_115 * V_65 )
{
if ( V_114 )
return - V_75 ;
...
struct V_1 * V_1 ;
struct V_107 * V_108 = F_40 ( V_3 ) ;
struct V_129 * V_130 = F_54 ( V_3 -> V_33 . V_131 ) ;
int V_7 ;
if ( ! V_108 ) {
F_45 ( & V_3 -> V_33 , L_9 ) ;
return - V_75 ;
...
V_1 = F_57 ( & V_3 -> V_33 , sizeof( struct V_1 ) , V_133 ) ;
if ( ! V_1 )
return - V_134 ;
...
F_60 ( & V_1 -> V_86 , & V_136 ,
V_95 , 0 , 127 , 1 , 64 ) ;
V_1 -> V_45 = F_61 ( & V_1 -> V_86 ,
& V_136 , V_88 , 1 , 0 ,
V_46 ) ;
V_1 -> V_89 = F_60 ( & V_1 -> V_86 , & V_136 ,
V_137 , 1 , 255 , 1 , 255 ) ;
