...
V_200 = F_100 ( V_203 , L_23 , & V_201 ) ;
if ( V_200 && ( V_201 >= sizeof( V_13 ) * 2 ) ) {
V_4 -> V_54 = V_200 [ 0 ] ;
V_4 -> V_46 = V_200 [ 1 ] ? V_53 : V_228 ;
}
V_4 -> V_57 = F_101 ( V_203 , L_24 , 0 ) ;
if ( F_102 ( V_203 , L_25 , NULL ) ) {
V_4 -> V_177 = 1 ;
F_103 ( & V_58 -> V_2 , L_26 ) ;
}
F_66 ( V_58 ) ;
...
F_106 ( V_58 , L_27 ,
V_196 -> V_2 . V_204 -> V_230 , V_58 -> V_20 ) ;
return 0 ;
V_229:
F_107 ( V_4 -> V_57 ) ;
F_108 ( V_58 -> V_60 ) ;
...
F_111 ( V_4 -> V_11 ) ;
V_219:
F_112 ( V_199 . V_211 , sizeof( struct V_10 ) ) ;
V_209:
F_113 ( V_58 ) ;
return V_197 ;
}
static int
F_114 ( struct V_195 * V_196 )
{
struct V_1 * V_58 ;
struct V_3 * V_4 ;
V_58 = F_115 ( & V_196 -> V_2 ) ;
V_4 = F_2 ( V_58 ) ;
F_116 ( V_58 ) ;
if ( V_4 -> V_57 )
F_107 ( V_4 -> V_57 ) ;
...
F_110 ( V_4 -> V_71 ) ;
F_111 ( V_4 -> V_11 ) ;
F_112 ( V_58 -> V_218 , sizeof( struct V_10 ) ) ;
F_113 ( V_58 ) ;
F_105 ( & V_196 -> V_2 , NULL ) ;
return 0 ;
}
static int F_117 ( struct V_195 * V_196 , T_5 V_231 )
{
struct V_1 * V_2 = F_115 ( & V_196 -> V_2 ) ;
if ( F_118 ( V_2 ) )
F_40 ( V_2 ) ;
return 0 ;
}
static int F_119 ( struct V_195 * V_196 )
{
struct V_1 * V_2 = F_115 ( & V_196 -> V_2 ) ;
F_66 ( V_2 ) ;
F_60 ( V_2 ) ;
