...
if ( F_18 ( V_17 + V_28 , L_4 , 4 ) == 0 ) {
V_28 += V_29 ;
continue;
}
if ( F_18 ( V_17 + V_28 , L_5 , 3 ) == 0 ) {
V_28 += V_29 ;
continue;
}
if ( F_18 ( V_17 + V_28 , L_6 , 11 ) == 0 ) {
V_28 += V_29 ;
continue;
}
...
static struct V_37 * F_20 ( struct V_38 * V_39 ,
...
static struct V_37 * F_23 ( struct V_46 * V_47 )
{
...
V_51 = F_29 ( V_56 ) -> V_51 ;
V_53 = F_30 () ;
V_22 = F_31 ( V_53 , V_51 , V_52 + 1 , V_39 -> V_61 ,
& V_49 , & V_48 ,
V_39 -> V_62 & V_63 ) ;
F_32 ( V_53 ) ;
F_33 ( V_56 ) ;
...
struct V_37 * F_35 ( struct V_68 * V_68 )
{
struct V_37 * V_69 ;
F_16 ( V_33 , L_11 , V_34 ) ;
V_69 = F_23 ( V_68 -> V_46 ) ;
