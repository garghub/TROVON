...
{
unsigned long V_31 = V_1 -> V_32 ? ( 352 * 288 * 2 ) : ( 640 * 480 * 2 ) ,
y0 = 0x0000 ,
V_33 = y0 + V_31 / 2 ,
V_34 = V_33 + V_31 / 4 ,
y1 = V_34 + V_31 / 4 ,
...
F_10 ( V_1 , 0x21 , y0 >> 16 ) ;
F_10 ( V_1 , 0x24 , V_33 & 0xffff ) ;
F_10 ( V_1 , 0x25 , V_33 >> 16 ) ;
F_10 ( V_1 , 0x28 , V_34 & 0xffff ) ;
F_10 ( V_1 , 0x29 , V_34 >> 16 ) ;
F_10 ( V_1 , 0x22 , y1 & 0xffff ) ;
F_10 ( V_1 , 0x23 , y1 >> 16 ) ;
F_10 ( V_1 , 0x26 , V_35 & 0xffff ) ;
F_10 ( V_1 , 0x27 , V_35 >> 16 ) ;
F_10 ( V_1 , 0x2a , V_36 & 0xffff ) ;
F_10 ( V_1 , 0x2b , V_36 >> 16 ) ;
...
{
int V_37 , V_38 , V_39 , V_40 , V_41 , V_42 , V_43 , V_44 ,
V_45 , V_46 ;
if ( V_1 -> V_32 ) {
V_45 = 352 ;
V_46 = 288 ;
...
#define F_24 ( V_39 ) ((x) << 10)
V_41 = F_24 ( V_1 -> V_5 . V_51 ) / V_45 ;
V_42 = F_24 ( V_1 -> V_5 . V_52 ) / V_46 ;
V_43 = ( V_41 >= V_42 ) ? V_45 : F_24 ( V_1 -> V_5 . V_51 ) / V_42 ;
V_44 = ( V_41 >= V_42 ) ? F_24 ( V_1 -> V_5 . V_52 ) / V_41 : V_46 ;
V_1 -> V_53 = V_45 ;
V_1 -> V_54 = V_46 ;
V_39 = ( V_45 - V_43 ) / 2 ;
V_40 = ( V_46 - V_44 ) / 2 ;
F_10 ( V_1 , 0x10 , V_37 + V_39 ) ;
F_10 ( V_1 , 0x11 , V_38 + V_40 ) ;
F_10 ( V_1 , 0x12 , V_37 + V_39 + V_43 ) ;
F_10 ( V_1 , 0x13 , V_38 + V_40 + V_44 ) ;
}
static void F_25 ( struct V_1 * V_1 )
{
int V_50 , V_55 , V_56 ;
F_23 ( V_1 ) ;
F_10 ( V_1 , 0x14 , V_1 -> V_5 . V_51 ) ;
F_10 ( V_1 , 0x15 , V_1 -> V_5 . V_52 ) ;
F_10 ( V_1 , 0x30 , V_1 -> V_5 . V_51 ) ;
F_10 ( V_1 , 0x31 , V_1 -> V_5 . V_52 ) ;
if ( V_57 [ V_1 -> V_5 . V_58 ] . V_59 ==
V_60 ) {
F_10 ( V_1 , 0x2c , V_1 -> V_5 . V_51 / 2 ) ;
F_10 ( V_1 , 0x2d , V_1 -> V_5 . V_51 / 4 ) ;
} else
F_10 ( V_1 , 0x2c , V_1 -> V_5 . V_51 ) ;
F_10 ( V_1 , 0x00 , 0xbf17 ) ;
F_10 ( V_1 , 0x00 , 0xbf10 ) ;
V_50 = V_1 -> V_5 . V_51 * V_1 -> V_5 . V_52 ;
F_10 ( V_1 , 0x3d , V_50 & 0xffff ) ;
F_10 ( V_1 , 0x3e , V_50 >> 16 ) ;
if ( V_57 [ V_1 -> V_5 . V_58 ] . V_59 ==
V_60 ) {
F_26 ( V_1 -> V_61 , V_1 -> V_5 . V_52 ,
V_1 -> V_5 . V_51 , 0x22 ) ;
F_27 ( V_1 -> V_61 , F_28 ( V_1 -> V_62 ) ) ;
F_9 ( V_1 ) ;
F_29 ( V_1 -> V_62 , true ) ;
}
if ( V_1 -> V_47 == V_48 ) {
