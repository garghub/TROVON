...
struct V_9 * V_10 = F_5 ( V_3 ) ;
V_116 = F_4 ( V_3 , V_32 ) ;
return F_31 ( V_10 , V_115 , V_117 , V_116 ) ;
}
static int F_32 ( struct V_2 * V_3 , struct V_118 * V_8 )
{
struct V_9 * V_10 = F_5 ( V_3 ) ;
if ( ! F_33 ( V_10 , & V_8 -> V_119 ) )
return - V_69 ;
if ( ! F_34 ( V_120 ) )
return - V_121 ;
...
static int F_35 ( struct V_2 * V_3 , const struct V_118 * V_8 )
{
struct V_9 * V_10 = F_5 ( V_3 ) ;
if ( ! F_33 ( V_10 , & V_8 -> V_119 ) )
return - V_69 ;
...
if ( ! F_37 ( V_10 -> V_127 , V_128 ) )
return - V_129 ;
F_38 ( V_10 , L_33 ,
V_10 -> V_130 << 1 , V_10 -> V_127 -> V_59 ) ;
V_126 = V_10 -> V_131 . V_132 ;
if ( V_126 == NULL )
return - V_69 ;
V_16 = F_39 ( sizeof( struct V_1 ) , V_133 ) ;
if ( V_16 == NULL )
return - V_134 ;
V_16 -> V_135 = V_126 [ 0 ] ;
V_16 -> V_113 = V_126 [ 1 ] ;
if ( F_40 ( V_16 -> V_135 , L_34 ) ) {
F_41 ( V_10 , L_35 , V_16 -> V_135 ) ;
V_125 = - V_136 ;
goto V_137;
}
if ( F_40 ( V_16 -> V_113 , L_36 ) ) {
F_41 ( V_10 , L_35 , V_16 -> V_113 ) ;
V_125 = - V_136 ;
goto V_138;
}
V_3 = & V_16 -> V_3 ;
