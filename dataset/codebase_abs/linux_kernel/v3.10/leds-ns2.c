...
{
F_24 ( V_2 -> V_19 . V_26 , & V_46 ) ;
F_22 ( & V_2 -> V_19 ) ;
}
static int
F_25 ( struct V_25 * V_26 , struct V_48 * V_49 )
{
...
if ( ! V_55 )
return - V_56 ;
V_54 = F_27 ( V_26 , V_55 * sizeof( struct V_35 ) ,
V_57 ) ;
if ( ! V_54 )
return - V_58 ;
F_28 (np, child) {
...
static inline int F_31 ( int V_55 )
{
...
{
struct V_48 * V_49 = V_34 -> V_26 . V_60 ;
struct V_59 * V_61 ;
int V_5 ;
int V_6 ;
#ifdef F_33
...
return - V_58 ;
V_61 -> V_55 = V_49 -> V_55 ;
for ( V_5 = 0 ; V_5 < V_61 -> V_55 ; V_5 ++ ) {
V_6 = F_16 ( V_34 , & V_61 -> V_62 [ V_5 ] ,
& V_49 -> V_54 [ V_5 ] ) ;
if ( V_6 < 0 ) {
