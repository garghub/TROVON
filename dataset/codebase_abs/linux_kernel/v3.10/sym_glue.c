...
struct V_311 V_312 ;
int V_301 = 2 ;
F_136 ( V_127 , & V_312 , & V_127 -> V_313 [ 1 ] ) ;
V_64 -> V_270 = V_312 . V_314 ;
if ( V_64 -> V_257 . V_262 & V_315 ) {
if ( ! V_127 -> V_313 [ V_301 ] . V_138 )
V_301 ++ ;
F_136 ( V_127 , & V_312 , & V_127 -> V_313 [ V_301 ] ) ;
V_64 -> V_272 = V_312 . V_314 ;
}
#ifdef F_137
if ( V_64 -> V_270 )
...
static void F_141 ( struct V_126 * V_127 , struct V_248 * V_317 )
{
int V_318 ;
T_7 V_319 ;
for ( V_318 = 0 ; V_318 < 256 ; V_318 ++ ) {
struct V_126 * V_320 = F_142 ( V_127 -> V_321 , V_318 ) ;
if ( ! V_320 || V_320 -> V_322 != 0x101a || V_320 -> V_64 == 0x0009 ) {
F_143 ( V_320 ) ;
continue;
}
F_144 ( V_320 , 0x44 , & V_319 ) ;
if ( ( V_319 & 0x2 ) == 0 ) {
V_319 |= 0x2 ;
F_145 ( V_320 , 0x44 , V_319 ) ;
}
F_144 ( V_320 , 0x45 , & V_319 ) ;
if ( ( V_319 & 0x4 ) == 0 ) {
V_319 |= 0x4 ;
F_145 ( V_320 , 0x45 , V_319 ) ;
}
F_143 ( V_320 ) ;
break;
}
F_144 ( V_127 , 0x84 , & V_319 ) ;
V_317 -> V_15 = V_319 ;
}
...
static T_8 F_161 ( struct V_126 * V_127 ,
enum V_335 V_336 )
{
if ( V_336 == V_337 ) {
F_159 ( V_127 ) ;
...
static T_8 F_163 ( struct V_126 * V_127 )
{
struct V_123 * V_124 = F_156 ( V_127 ) ;
F_164 ( V_124 ) ;
return V_340 ;
...
static T_8 F_166 ( struct V_126 * V_127 )
{
struct V_123 * V_124 = F_156 ( V_127 ) ;
struct V_19 * V_20 = F_78 ( V_124 ) ;
F_3 ( V_109 L_73 ,
