...
V_120 = V_54 [ 0 ] ;
V_121 = V_54 [ 1 ] ;
if ( ( V_120 == 0x00 && V_121 == 0x11 ) ||
( V_120 == 0x22 && V_121 == 0x33 ) ||
( V_120 == 0x44 && V_121 == 0x55 ) ||
( V_120 == 0x66 && V_121 == 0x77 ) ||
( V_120 == 0x88 && V_121 == 0x99 ) ||
( V_120 == 0xaa && V_121 == 0xbb ) ||
( V_120 == 0xcc && V_121 == 0xdd ) ||
( V_120 == 0xee && V_121 == 0xff ) ) {
F_44 ( V_1 -> V_122 , V_123 , 1 ) ;
F_45 ( V_1 -> V_122 ) ;
F_44 ( V_1 -> V_122 , V_123 , 0 ) ;
F_45 ( V_1 -> V_122 ) ;
V_5 = 0 ;
}
}
...
const struct V_21 * V_22 )
{
return F_47 ( V_125 , V_22 , & V_126 , sizeof( struct V_23 ) ,
V_127 ) ;
}
