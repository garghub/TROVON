...
if ( ! V_35 ) {
strncpy ( V_39 , V_29 ? L_1 : L_2 ,
F_15 ( V_39 ) ) ;
V_38 = F_16 ( V_39 , F_15 ( V_39 ) ) ;
if ( V_38 > * V_36 )
V_38 = * V_36 ;
if ( F_17 ( V_15 , V_39 , V_38 ) )
return - V_40 ;
goto V_41;
}
V_38 = * V_36 ;
if ( F_18 ( V_39 , V_15 , V_38 > sizeof( V_39 ) ? sizeof( V_39 ) : V_38 ) )
return - V_40 ;
F_19 ( & V_42 ) ;
if ( V_39 [ 0 ] == '1' )
F_10 ( V_28 ) ;
...
if ( ! V_35 ) {
strncpy ( V_39 , V_8 -> V_11 ? L_1 : L_2 , F_15 ( V_39 ) ) ;
V_38 = F_16 ( V_39 , F_15 ( V_39 ) ) ;
if ( V_38 > * V_36 )
V_38 = * V_36 ;
if ( F_17 ( V_15 , V_39 , V_38 ) ) {
...
if ( V_8 -> V_51 > V_54 )
return - V_44 ;
V_8 -> T_3 = F_27 ( 4 * sizeof( struct T_3 ) , V_55 ) ;
if ( ! V_8 -> T_3 )
return - V_56 ;
F_4 ( & V_9 ) ;
F_28 ( & V_8 -> V_10 , & V_57 ) ;
