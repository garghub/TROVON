...
if ( V_77 ) {
F_59 ( & V_77 -> V_40 , V_83 , V_82 ) ;
F_60 ( & V_77 -> V_40 , & V_80 -> V_93 ) ;
V_77 -> V_97 = V_80 ;
F_8 ( & V_80 -> V_92 ) ;
} else {
F_30 ( V_98 ) ;
...
int error , V_32 ;
struct V_1 * V_2 ;
F_89 ( V_29 , V_106 , V_86 ) ;
V_2 = F_20 ( V_28 , & V_29 , 1 , 0 ) ;
if ( F_22 ( V_2 == NULL ) )
goto V_119;
V_51 = F_87 ( V_86 << V_120 ) >> V_66 ;
...
{
struct V_1 * V_2 =
F_115 ( V_129 , T_2 , V_130 ) ;
bool V_131 = ! ! ( V_2 -> V_17 & V_107 ) ;
V_2 -> V_17 &= ~ ( V_107 | V_105 | V_37 ) ;
if ( V_131 && V_2 -> V_102 && ! V_2 -> V_132 && ( V_2 -> V_17 & V_133 ) )
V_2 -> V_102 -> V_134 ( V_2 ) ;
if ( V_2 -> V_101 )
( * ( V_2 -> V_101 ) ) ( V_2 ) ;
...
if ( V_135 ) {
F_119 ( & V_2 -> V_130 , F_114 ) ;
F_120 ( V_136 , & V_2 -> V_130 ) ;
} else {
F_114 ( & V_2 -> V_130 ) ;
}
} else {
...
F_54 ( V_2 -> V_9 -> V_89 ,
L_4 ,
( V_138 ) F_124 ( V_2 ) , V_137 , V_2 -> V_132 , V_2 -> V_44 ) ;
}
STATIC int
F_125 (
T_2 * V_2 )
...
struct V_1 * V_2 )
{
if ( F_133 ( V_2 -> V_9 -> V_89 ) ) {
F_134 ( V_2 , V_50 ) ;
if ( ! V_2 -> V_101 && ! F_127 ( V_2 ) )
return F_130 ( V_2 ) ;
else
return F_125 ( V_2 ) ;
}
...
if ( ! V_2 -> V_132 )
F_121 ( V_2 , - error ) ;
if ( ! V_2 -> V_132 && F_1 ( V_2 ) && ( V_2 -> V_17 & V_107 ) )
...
if ( V_59 > V_58 )
V_59 = V_58 ;
V_161 = F_143 ( V_145 , V_2 -> V_52 [ V_150 ] , V_59 ,
V_60 ) ;
if ( V_161 < V_59 )
break;
V_60 = 0 ;
...
F_141 ( V_2 , V_32 , & V_60 , & V_58 , V_149 ) ;
if ( V_2 -> V_132 )
break;
if ( V_58 <= 0 )
break;
...
F_4 ( & V_8 -> V_10 ) ;
while ( ! F_5 ( & V_8 -> V_13 ) ) {
V_2 = F_156 ( & V_8 -> V_13 , struct V_1 , V_11 ) ;
if ( F_15 ( & V_2 -> V_12 ) > 1 ) {
F_157 ( V_2 , V_50 ) ;
F_158 ( & V_2 -> V_11 , & V_8 -> V_13 ) ;
F_8 ( & V_8 -> V_10 ) ;
F_159 ( 100 ) ;
goto V_187;
}
...
break;
V_2 = F_156 ( & V_8 -> V_13 , struct V_1 , V_11 ) ;
if ( ! F_162 ( & V_2 -> V_20 , - 1 , 0 ) ) {
F_158 ( & V_2 -> V_11 , & V_8 -> V_13 ) ;
continue;
}
F_163 ( & V_2 -> V_11 , & V_194 ) ;
V_8 -> V_14 -- ;
V_2 -> V_15 |= V_16 ;
}
F_8 ( & V_8 -> V_10 ) ;
while ( ! F_5 ( & V_194 ) ) {
V_2 = F_156 ( & V_194 , struct V_1 , V_11 ) ;
F_10 ( & V_2 -> V_11 ) ;
F_63 ( V_2 ) ;
}
return V_8 -> V_14 ;
...
{
V_8 -> V_200 = V_197 ;
V_8 -> V_87 = F_168 ( V_198 ) - 1 ;
V_8 -> V_88 = V_198 - 1 ;
if ( F_169 ( V_8 -> V_158 , V_198 ) ) {
char V_201 [ V_202 ] ;
F_170 ( V_8 -> V_158 , V_201 ) ;
F_68 ( V_8 -> V_89 ,
L_5 ,
V_198 , V_201 ) ;
return V_203 ;
...
unsigned int V_198 )
{
return F_167 ( V_8 , V_197 , V_198 , 1 ) ;
}
T_12 *
F_174 (
struct V_142 * V_143 ,
...
{
T_12 * V_8 ;
V_8 = F_17 ( sizeof( * V_8 ) , V_208 | V_26 ) ;
V_8 -> V_89 = V_143 ;
V_8 -> V_209 = V_205 -> V_210 ;
V_8 -> V_158 = V_205 ;
V_8 -> V_111 = F_175 ( V_205 ) ;
if ( ! V_8 -> V_111 )
goto error;
F_24 ( & V_8 -> V_13 ) ;
F_176 ( & V_8 -> V_10 ) ;
...
struct V_213 * V_217 )
{
struct V_1 * V_218 = F_115 ( V_216 , struct V_1 , V_39 ) ;
struct V_1 * V_2 = F_115 ( V_217 , struct V_1 , V_39 ) ;
T_7 V_219 ;
...
F_158 ( & V_2 -> V_39 , V_221 ) ;
F_185 ( V_2 , V_50 ) ;
}
F_186 ( NULL , V_221 , F_181 ) ;
F_147 ( & V_164 ) ;
F_183 (bp, n, io_list, b_list) {
V_2 -> V_17 &= ~ ( V_19 | V_36 ) ;
V_2 -> V_17 |= V_105 ;
if ( ! V_124 ) {
V_2 -> V_17 |= V_36 ;
...
{
F_161 ( V_221 ) ;
return F_182 ( V_220 , & V_221 , false ) ;
}
int
F_188 (
struct V_213 * V_220 )
...
int error = 0 , V_224 ;
struct V_1 * V_2 ;
F_182 ( V_220 , & V_221 , true ) ;
while ( ! F_5 ( & V_221 ) ) {
V_2 = F_156 ( & V_221 , struct V_1 , V_39 ) ;
F_10 ( & V_2 -> V_39 ) ;
V_224 = F_73 ( V_2 ) ;
F_69 ( V_2 ) ;
if ( ! error )
