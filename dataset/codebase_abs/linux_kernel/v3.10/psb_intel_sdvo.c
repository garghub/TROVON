...
struct V_2 * V_3 =
& F_4 ( V_6 ) -> V_4 ;
struct V_1 * V_208 = F_1 ( V_3 ) ;
struct V_153 * V_154 = V_3 -> V_154 ;
F_9 ( V_208 -> V_14 , V_208 -> V_291 ) ;
if ( V_6 -> V_32 == V_221 )
F_92 ( V_154 , & V_154 -> V_46 , V_154 -> V_287 , V_154 -> V_288 ,
NULL ) ;
}
...
F_103 ( V_208 -> V_27 , V_299 ) ;
F_104 ( V_208 -> V_27 , true ) ;
} else
V_208 -> V_27 = & V_211 -> V_213 [ V_300 ] . V_215 ;
}
static bool
F_105 ( struct V_1 * V_1 , int V_305 )
{
return F_39 ( V_1 ) ;
}
static T_2
...
static bool
F_113 ( struct V_1 * V_1 , int V_305 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_316 * V_317 ;
struct V_7 * V_7 ;
V_7 = F_114 ( sizeof( struct V_7 ) , V_318 ) ;
if ( ! V_7 )
return false ;
if ( V_305 == 0 ) {
V_1 -> V_319 |= V_320 ;
...
static bool
F_118 ( struct V_1 * V_1 , int V_305 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_316 * V_317 ;
...
static bool
F_119 ( struct V_1 * V_1 , int V_305 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_316 * V_317 ;
...
return false ;
if ( ( V_22 & V_346 ) == 0 ) {
unsigned char V_347 [ 2 ] ;
V_1 -> V_319 = 0 ;
memcpy ( V_347 , & V_1 -> V_193 . V_206 , 2 ) ;
F_12 ( L_34 ,
F_14 ( V_1 ) ,
V_347 [ 0 ] , V_347 [ 1 ] ) ;
return false ;
}
V_1 -> V_4 . V_348 = ( 1 << 0 ) | ( 1 << 1 ) ;
return true ;
}
...
if ( V_144 & ( 1 << V_13 ) )
V_7 -> V_276 [ V_7 -> V_350 ++ ] = V_13 ;
V_7 -> V_264 =
F_121 ( V_10 , V_351 ,
L_35 , V_7 -> V_350 ) ;
if ( ! V_7 -> V_264 )
return false ;
for ( V_13 = 0 ; V_13 < V_7 -> V_350 ; V_13 ++ )
F_122 (
V_7 -> V_264 , V_13 ,
V_13 , V_352 [ V_7 -> V_276 [ V_13 ] ] ) ;
...
return false ;
V_7 -> V_279 = V_355 [ 0 ] ;
V_7 -> V_277 = V_355 [ 0 ] - V_36 ;
V_7 -> V_278 = V_7 -> V_277 ;
V_7 -> V_247 =
F_125 ( V_10 , 0 , L_36 , 0 , V_355 [ 0 ] ) ;
if ( ! V_7 -> V_247 )
return false ;
F_123 ( & V_6 -> V_4 ,
V_7 -> V_247 ,
...
return false ;
V_7 -> V_284 = V_355 [ 0 ] ;
V_7 -> V_282 = V_355 [ 0 ] - V_36 ;
V_7 -> V_283 = V_7 -> V_282 ;
V_7 -> V_249 =
F_125 ( V_10 , 0 , L_40 , 0 , V_355 [ 0 ] ) ;
if ( ! V_7 -> V_249 )
return false ;
F_123 ( & V_6 -> V_4 ,
V_7 -> V_249 ,
...
if ( F_80 ( V_7 ) )
return F_124 ( V_1 , V_7 , V_354 . V_237 ) ;
else if( F_81 ( V_7 ) )
return F_127 ( V_1 , V_7 , V_354 . V_237 ) ;
else
return true ;
}
static int F_128 ( struct V_378 * V_215 ,
struct V_19 * V_20 ,
int V_379 )
{
struct V_1 * V_208 = V_215 -> V_380 ;
if ( ! F_21 ( V_208 , V_208 -> V_47 ) )
return - V_286 ;
return V_208 -> V_27 -> V_381 -> V_382 ( V_208 -> V_27 , V_20 , V_379 ) ;
}
static T_1 F_129 ( struct V_378 * V_215 )
{
struct V_1 * V_208 = V_215 -> V_380 ;
return V_208 -> V_27 -> V_381 -> V_383 ( V_208 -> V_27 ) ;
}
static bool
F_130 ( struct V_1 * V_208 ,
struct V_9 * V_10 )
{
V_208 -> V_209 . V_384 = V_385 ;
V_208 -> V_209 . V_386 = V_387 ;
snprintf ( V_208 -> V_209 . V_31 , V_388 , L_46 ) ;
V_208 -> V_209 . V_10 . V_389 = & V_10 -> V_390 -> V_10 ;
V_208 -> V_209 . V_380 = V_208 ;
V_208 -> V_209 . V_381 = & V_391 ;
return F_131 ( & V_208 -> V_209 ) == 0 ;
}
...
struct V_1 * V_1 ;
int V_13 ;
V_1 = F_114 ( sizeof( struct V_1 ) , V_318 ) ;
if ( ! V_1 )
return false ;
V_1 -> V_14 = V_14 ;
V_1 -> V_21 = F_106 ( V_10 , V_14 ) >> 1 ;
F_102 ( V_211 , V_1 , V_14 ) ;
if ( ! F_130 ( V_1 , V_10 ) ) {
F_65 ( V_1 ) ;
return false ;
}
