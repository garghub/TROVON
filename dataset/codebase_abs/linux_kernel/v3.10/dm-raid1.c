...
int V_100 )
{
int V_101 = F_69 ( V_3 -> V_76 , V_85 , V_100 ) ;
...
F_76 ( V_3 -> V_76 , & V_109 ) ;
F_76 ( V_3 -> V_76 , & V_110 ) ;
V_3 -> V_117 = F_77 ( V_3 -> V_76 ) ? 1 : V_3 -> V_117 ;
if ( F_31 ( V_3 -> V_117 ) && F_25 ( V_3 ) ) {
F_59 ( & V_3 -> V_23 ) ;
F_75 ( & V_3 -> V_106 , & V_109 ) ;
F_60 ( & V_3 -> V_23 ) ;
F_1 ( V_3 ) ;
} else
...
static void F_80 ( struct V_2 * V_3 , struct V_18 * V_106 )
{
struct V_14 * V_14 ;
if ( F_49 ( ! V_106 -> V_24 ) )
return;
...
{
struct V_2 * V_3 =
F_82 ( V_119 , struct V_2 , V_40 ) ;
F_47 ( V_3 -> V_42 -> V_84 ) ;
}
static void F_83 ( struct V_118 * V_119 )
{
struct V_2 * V_3 = F_82 ( V_119 , struct V_2 ,
V_5 ) ;
...
unsigned int V_25 , char * * V_125 )
{
unsigned long long V_77 ;
char V_126 ;
if ( sscanf ( V_125 [ 1 ] , L_12 , & V_77 , & V_126 ) != 1 ) {
V_42 -> error = L_13 ;
return - V_127 ;
}
if ( F_98 ( V_42 , V_125 [ 0 ] , F_99 ( V_42 -> V_84 ) ,
& V_3 -> V_25 [ V_25 ] . V_38 ) ) {
V_42 -> error = L_14 ;
return - V_128 ;
}
...
if ( sscanf ( V_125 [ 1 ] , L_16 , & V_131 , & V_126 ) != 1 ) {
V_42 -> error = L_17 ;
return NULL ;
}
* V_130 = 2 + V_131 ;
...
V_120 = F_101 ( V_125 [ 0 ] , V_42 , F_29 , V_131 ,
V_125 + 2 ) ;
if ( ! V_120 ) {
V_42 -> error = L_18 ;
return NULL ;
...
static int F_102 ( struct V_2 * V_3 , unsigned V_129 , char * * V_125 ,
unsigned * V_130 )
{
unsigned V_132 ;
...
if ( ! V_129 )
return 0 ;
if ( sscanf ( V_125 [ 0 ] , L_16 , & V_132 , & V_126 ) != 1 ) {
V_42 -> error = L_19 ;
return - V_127 ;
}
V_129 -- ;
...
static int F_103 ( struct V_41 * V_42 , unsigned int V_129 , char * * V_125 )
{
int V_69 ;
unsigned int V_30 , V_27 , V_130 ;
struct V_2 * V_3 ;
struct V_82 * V_120 ;
char V_126 ;
V_120 = F_100 ( V_42 , V_129 , V_125 , & V_130 ) ;
if ( ! V_120 )
return - V_127 ;
V_125 += V_130 ;
V_129 -= V_130 ;
if ( ! V_129 || sscanf ( V_125 [ 0 ] , L_16 , & V_30 , & V_126 ) != 1 ||
V_30 < 2 || V_30 > V_72 + 1 ) {
V_42 -> error = L_23 ;
F_104 ( V_120 ) ;
return - V_127 ;
...
V_3 = F_85 ( V_30 , V_120 -> type -> V_135 ( V_120 ) , V_42 , V_120 ) ;
if ( ! V_3 ) {
F_104 ( V_120 ) ;
return - V_136 ;
}
for ( V_27 = 0 ; V_27 < V_30 ; V_27 ++ ) {
V_69 = F_97 ( V_3 , V_42 , V_27 , V_125 ) ;
if ( V_69 ) {
F_94 ( V_3 , V_42 , V_27 ) ;
return V_69 ;
}
...
V_3 -> V_7 = 0 ;
F_107 ( & V_3 -> V_40 , V_40 ) ;
V_69 = F_102 ( V_3 , V_129 , V_125 , & V_130 ) ;
if ( V_69 )
goto V_145;
V_125 += V_130 ;
V_129 -= V_130 ;
...
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
struct V_141 * V_147 =
F_118 ( V_14 , sizeof( struct V_141 ) ) ;
V_147 -> V_148 . V_88 = NULL ;
if ( V_15 == V_20 ) {
V_147 -> V_149 = F_52 ( V_3 -> V_76 , V_14 ) ;
F_10 ( V_3 , V_14 , V_15 ) ;
return V_150 ;
}
V_69 = log -> type -> V_37 ( log , F_52 ( V_3 -> V_76 , V_14 ) , 0 ) ;
if ( V_69 < 0 && V_69 != - V_151 )
return V_69 ;
if ( ! V_69 || ( V_69 == - V_151 ) ) {
if ( V_15 == V_152 )
return - V_151 ;
...
F_118 ( V_14 , sizeof( struct V_141 ) ) ;
if ( V_15 == V_20 ) {
if ( ! ( V_14 -> V_50 & ( V_113 | V_108 ) ) )
F_121 ( V_3 -> V_76 , V_147 -> V_149 ) ;
return error ;
}
if ( error == - V_156 )
goto V_36;
if ( ( error == - V_151 ) && ( V_14 -> V_50 & V_157 ) )
goto V_36;
if ( F_31 ( error ) ) {
if ( ! V_147 -> V_148 . V_88 ) {
F_35 ( L_28 ) ;
...
V_166 [ V_27 ] = F_130 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_166 [ V_27 ] = '\0' ;
F_132 ( L_36 ,
( unsigned long long ) log -> type -> V_83 ( log ) ,
( unsigned long long ) V_3 -> V_78 , V_166 ) ;
V_165 += log -> type -> V_168 ( log , type , V_163 + V_165 , V_164 - V_165 ) ;
break;
case V_169 :
V_165 = log -> type -> V_168 ( log , type , V_163 , V_164 ) ;
F_132 ( L_37 , V_3 -> V_30 ) ;
for ( V_27 = 0 ; V_27 < V_3 -> V_30 ; V_27 ++ )
