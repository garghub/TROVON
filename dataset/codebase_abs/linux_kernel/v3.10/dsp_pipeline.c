...
{
int V_40 , V_41 = 0 , V_42 = 0 ;
char * V_43 , * V_44 , * V_11 , * args ;
struct V_14 * V_15 , * V_31 ;
struct V_36 * V_45 ;
struct V_6 * V_7 ;
if ( ! V_35 )
...
if ( ! V_40 )
return 0 ;
V_43 = F_35 ( V_40 + 1 , V_19 ) ;
if ( ! V_43 )
return 0 ;
strcpy ( V_43 , V_39 ) ;
while ( ( V_44 = F_36 ( & V_43 , L_16 ) ) ) {
if ( ! strlen ( V_44 ) )
continue;
V_11 = F_36 ( & V_44 , L_17 ) ;
args = F_36 ( & V_44 , L_18 ) ;
...
#ifdef F_16
F_12 ( V_30 L_30 ,
V_25 , V_41 ? L_31 : L_3 , V_39 ) ;
#endif
F_6 ( V_43 ) ;
return 0 ;
}
void F_38 ( struct V_34 * V_35 , T_2 * V_49 , int V_40 )
{
struct V_36 * V_15 ;
if ( ! V_35 )
return;
F_39 (entry, &pipeline->list, list)
if ( V_15 -> V_7 -> V_50 )
V_15 -> V_7 -> V_50 ( V_15 -> V_9 , V_49 , V_40 ) ;
}
void F_40 ( struct V_34 * V_35 , T_2 * V_49 , int V_40 ,
unsigned int V_51 )
{
struct V_36 * V_15 ;
if ( ! V_35 )
return;
F_41 (entry, &pipeline->list, list)
if ( V_15 -> V_7 -> V_52 )
V_15 -> V_7 -> V_52 ( V_15 -> V_9 , V_49 , V_40 , V_51 ) ;
}
