...
int V_5 , V_11 ;
F_22 ( V_26 -> V_27 , V_1 -> V_28 , V_1 -> V_29 ,
0x22 ) ;
F_23 ( V_26 -> V_27 , V_30 ) ;
F_20 ( V_1 -> V_4 , V_1 -> V_24 , 1 ) ;
F_12 ( V_1 , 0x10000000 ) ;
...
{
struct V_26 * V_26 = (struct V_26 * ) V_1 ;
static unsigned char V_36 [] = { 0xff , 0xd9 } ;
if ( V_34 [ 0 ] == 0xff && V_34 [ 1 ] == 0xfe ) {
F_27 ( V_1 , V_37 ,
V_36 , 2 ) ;
F_27 ( V_1 , V_38 ,
V_26 -> V_27 , V_39 ) ;
...
F_27 ( V_1 , V_40 , V_34 , V_35 ) ;
}
static int F_29 ( struct V_41 * V_42 )
{
struct V_1 * V_1 =
F_30 ( V_42 -> V_43 , struct V_1 , V_44 ) ;
V_1 -> V_6 = 0 ;
if ( ! V_1 -> V_45 )
return 0 ;
switch ( V_42 -> V_19 ) {
...
const struct V_18 * V_19 )
{
return F_36 ( V_57 , V_19 , & V_58 , sizeof( struct V_26 ) ,
V_59 ) ;
}
