...
V_121 . V_131 = F_64 ( V_104 -> V_108 ,
V_104 -> V_106 ) ;
V_121 . V_109 = F_65 ( V_104 -> V_109 ) ;
error = F_66 ( V_25 , & V_121 ) ;
ASSERT ( error == V_115 ) ;
...
STATIC int
F_69 ( const void * V_133 , const void * V_134 )
{
T_11 * V_135 , * V_136 ;
V_135 = ( T_11 * ) V_133 ;
V_136 = ( T_11 * ) V_134 ;
...
V_142 -> V_138 = V_5 ;
V_142 -> V_137 = F_64 ( V_104 -> V_108 , V_104 -> V_106 ) ;
...
F_75 ( V_141 , V_144 , sizeof( * V_141 ) , F_69 ) ;
V_15 = 0 ;
V_140 -> V_149 = 1 ;
V_140 -> V_37 = 0 ;
...
int V_5 ;
F_80 ( args ) ;
V_122 = F_60 ( F_81 ( V_53 -> V_68 ) , V_123 ) ;
if ( ! V_122 )
return V_161 ;
memcpy ( V_122 , V_25 -> V_31 , F_81 ( V_53 -> V_68 ) ) ;
V_30 = ( V_162 * ) V_122 ;
F_1 ( & V_32 , V_30 ) ;
V_151 = F_77 ( V_30 ) ;
memset ( V_25 -> V_31 , 0 , F_81 ( V_53 -> V_68 ) ) ;
error = F_63 ( args , 0 , V_25 ) ;
if ( error )
goto V_125;
if ( V_102 == - 1 ) {
...
if ( error )
goto V_125;
error = F_84 ( args -> V_99 , V_53 , V_37 , - 1 , & V_173 , V_58 ) ;
if ( error )
goto V_125;
F_21 ( args -> V_99 , V_173 , V_60 ) ;
V_173 -> V_174 = V_172 -> V_174 ;
memcpy ( V_173 -> V_31 , V_172 -> V_31 , F_81 ( V_27 ) ) ;
if ( F_8 ( & V_27 -> V_33 ) ) {
struct V_175 * V_12 = V_173 -> V_31 ;
V_12 -> V_37 = F_14 ( V_173 -> V_38 ) ;
}
F_85 ( args -> V_99 , V_173 , 0 , F_81 ( V_27 ) - 1 ) ;
error = F_86 ( args , 0 , 1 , & V_172 , V_58 ) ;
if ( error )
goto V_125;
V_171 = V_172 -> V_31 ;
F_87 ( & V_169 , V_171 ) ;
...
V_169 . V_15 = 1 ;
F_89 ( V_171 , & V_169 ) ;
F_85 ( args -> V_99 , V_172 , 0 , F_81 ( V_27 ) - 1 ) ;
error = 0 ;
V_125:
return error ;
}
...
int error ;
F_90 ( args ) ;
error = F_84 ( args -> V_99 , args -> V_53 , V_37 , - 1 , & V_25 ,
V_58 ) ;
if ( error )
return error ;
V_25 -> V_174 = & V_59 ;
...
F_5 ( V_30 , & V_32 ) ;
F_85 ( args -> V_99 , V_25 , 0 , F_81 ( V_27 ) - 1 ) ;
* V_56 = V_25 ;
return 0 ;
}
int
...
error = F_61 ( V_181 -> args , & V_37 ) ;
if ( error )
return ( error ) ;
error = F_62 ( V_181 -> args , V_37 , & V_184 -> V_25 ) ;
if ( error )
return ( error ) ;
V_184 -> V_37 = V_37 ;
V_184 -> V_8 = V_9 ;
F_94 ( V_181 , V_183 , V_184 ) ;
error = F_95 ( V_181 , V_183 , V_184 ) ;
if ( error )
return ( error ) ;
if ( V_181 -> V_185 ) {
F_96 ( V_181 -> args ) ;
error = F_67 ( V_183 -> V_25 , V_181 -> args ) ;
} else {
F_97 ( V_181 -> args ) ;
error = F_67 ( V_184 -> V_25 , V_181 -> args ) ;
}
V_183 -> V_131 = F_98 ( V_183 -> V_25 , NULL ) ;
V_184 -> V_131 = F_98 ( V_184 -> V_25 , NULL ) ;
return ( error ) ;
}
int
F_67 (
...
V_187 = F_100 ( args -> V_106 , args -> V_110 ,
...
V_189 = F_102 ( V_25 , & V_32 , args , V_5 ) ;
goto V_194;
}
V_188 += V_32 . V_20 [ V_5 ] . V_22 ;
}
...
return F_54 ( V_132 ) ;
F_103 ( args , & V_32 , V_25 ) ;
if ( V_32 . V_20 [ 0 ] . V_22 < ( V_187 + sizeof( V_193 ) ) ) {
V_189 = V_132 ;
goto V_194;
}
V_189 = F_102 ( V_25 , & V_32 , args , 0 ) ;
V_194:
F_5 ( V_30 , & V_32 ) ;
F_85 ( args -> V_99 , V_25 ,
F_104 ( V_30 , & V_30 -> V_6 ,
...
V_197 -> V_201 = 0 ;
args -> V_202 = 1 ;
args -> V_203 = F_107 ( V_27 , args -> V_110 ) ;
}
F_85 ( args -> V_99 , V_25 ,
F_104 ( V_30 , F_108 ( V_30 , args -> V_190 ) ,
F_109 ( V_30 , args -> V_190 ) ) ) ;
...
V_32 -> V_16 += F_109 ( V_30 , args -> V_190 ) ;
return 0 ;
}
STATIC void
F_103 (
...
char * V_122 ;
F_110 ( args ) ;
V_122 = F_60 ( F_81 ( V_27 ) , V_123 ) ;
memcpy ( V_122 , V_25 -> V_31 , F_81 ( V_27 ) ) ;
memset ( V_25 -> V_31 , 0 , F_81 ( V_27 ) ) ;
V_205 = ( V_162 * ) V_122 ;
V_206 = V_25 -> V_31 ;
memcpy ( V_25 -> V_31 , V_122 , F_101 ( V_205 ) ) ;
V_207 = * V_204 ;
V_204 -> V_17 = F_81 ( V_27 ) ;
V_204 -> V_16 = 0 ;
V_204 -> V_15 = 0 ;
V_204 -> V_18 = 0 ;
V_204 -> V_20 [ 0 ] . V_21 = F_101 ( V_205 ) ;
V_204 -> V_20 [ 0 ] . V_22 = V_204 -> V_17 -
V_204 -> V_20 [ 0 ] . V_21 ;
F_5 ( V_206 , V_204 ) ;
F_111 ( V_205 , & V_207 , 0 , V_206 , V_204 , 0 ,
V_207 . V_15 , V_27 ) ;
F_85 ( V_99 , V_25 , 0 , F_81 ( V_27 ) - 1 ) ;
F_68 ( V_122 ) ;
}
static int
F_112 (
...
struct V_150 * V_212 ;
struct V_150 * V_213 ;
V_212 = F_77 ( V_208 -> V_31 ) ;
V_213 = F_77 ( V_210 -> V_31 ) ;
...
return F_112 ( V_208 , & V_214 , V_210 , & V_215 ) ;
}
STATIC void
F_94 (
struct V_180 * V_181 ,
...
F_114 ( args ) ;
V_223 = 0 ;
if ( F_112 ( V_216 -> V_25 , & V_214 , V_217 -> V_25 , & V_215 ) ) {
struct V_182 * V_224 ;
struct V_1 V_225 ;
V_224 = V_216 ;
V_216 = V_217 ;
...
V_181 -> V_185 = F_115 ( V_181 , V_216 , & V_214 ,
V_217 , & V_215 ,
& V_15 , & V_220 ) ;
if ( V_223 )
...
V_221 = V_215 . V_17 - F_101 ( V_218 ) ;
V_221 -= V_215 . V_15 * sizeof( V_193 ) ;
if ( V_222 > V_221 )
F_103 ( args , & V_215 , V_217 -> V_25 ) ;
F_111 ( V_218 , & V_214 , V_214 . V_15 - V_15 ,
...
V_222 += V_15 * sizeof( V_193 ) ;
V_221 = V_214 . V_17 - F_101 ( V_218 ) ;
V_221 -= V_214 . V_15 * sizeof( V_193 ) ;
if ( V_222 > V_221 )
F_103 ( args , & V_214 , V_216 -> V_25 ) ;
F_111 ( V_219 , & V_215 , 0 , V_218 , & V_214 ,
V_214 . V_15 , V_15 , V_181 -> V_27 ) ;
}
F_5 ( V_218 , & V_214 ) ;
F_5 ( V_219 , & V_215 ) ;
F_85 ( args -> V_99 , V_216 -> V_25 , 0 , V_181 -> V_226 - 1 ) ;
F_85 ( args -> V_99 , V_217 -> V_25 , 0 , V_181 -> V_226 - 1 ) ;
V_212 = F_77 ( V_218 ) ;
V_213 = F_77 ( V_219 ) ;
...
V_181 -> args -> V_110 ,
V_181 -> V_226 , NULL ) ;
if ( F_116 ( V_230 - V_189 ) > V_231 )
break;
V_231 = F_116 ( V_230 - V_189 ) ;
V_220 = V_189 ;
V_232 = 1 ;
}
if ( V_15 == V_214 -> V_15 ) {
...
V_189 = V_220 + sizeof( * V_151 ) + F_109 ( V_218 ,
V_190 ) ;
if ( F_116 ( V_230 - V_189 ) > V_231 )
break;
V_231 = F_116 ( V_230 - V_189 ) ;
...
error = F_119 ( V_181 , & V_181 -> V_239 , V_235 ,
0 , & V_236 ) ;
if ( error )
return ( error ) ;
if ( V_236 ) {
...
error = F_119 ( V_181 , & V_181 -> V_237 , V_235 ,
0 , & V_236 ) ;
}
if ( error )
return ( error ) ;
...
V_30 = V_25 -> V_31 ;
F_1 ( & V_32 , V_30 ) ;
ASSERT ( V_32 . V_15 > 0 && V_32 . V_15 < F_81 ( V_27 ) / 8 ) ;
ASSERT ( args -> V_190 >= 0 && args -> V_190 < V_32 . V_15 ) ;
ASSERT ( V_32 . V_17 >= V_32 . V_15 * sizeof( * V_151 ) +
F_101 ( V_30 ) ) ;
V_151 = & F_77 ( V_30 ) [ args -> V_190 ] ;
ASSERT ( F_4 ( V_151 -> V_163 ) >= V_32 . V_17 ) ;
ASSERT ( F_4 ( V_151 -> V_163 ) < F_81 ( V_27 ) ) ;
V_186 = V_32 . V_15 * sizeof( V_193 )
+ F_101 ( V_30 ) ;
V_189 = V_32 . V_20 [ 0 ] . V_22 ;
V_176 = V_240 = - 1 ;
V_241 = V_19 - 1 ;
V_187 = F_109 ( V_30 , args -> V_190 ) ;
for ( V_5 = 0 ; V_5 < V_19 ; V_5 ++ ) {
ASSERT ( V_32 . V_20 [ V_5 ] . V_21 < F_81 ( V_27 ) ) ;
ASSERT ( V_32 . V_20 [ V_5 ] . V_22 < F_81 ( V_27 ) ) ;
...
V_241 = 0 ;
memset ( F_108 ( V_30 , args -> V_190 ) , 0 , V_187 ) ;
V_32 . V_16 -= V_187 ;
F_85 ( args -> V_99 , V_25 ,
F_104 ( V_30 , F_108 ( V_30 , args -> V_190 ) ,
V_187 ) ) ;
...
V_32 . V_15 -- ;
F_85 ( args -> V_99 , V_25 ,
F_104 ( V_30 , V_151 , V_189 + sizeof( V_193 ) ) ) ;
V_151 = & F_77 ( V_30 ) [ V_32 . V_15 ] ;
...
struct V_3 * V_250 ;
struct V_1 V_251 ;
V_250 = F_125 ( V_181 -> V_226 , V_123 ) ;
memcpy ( V_250 , V_247 , F_101 ( V_247 ) ) ;
...
F_5 ( V_247 , & V_249 ) ;
F_85 ( V_181 -> args -> V_99 , V_245 -> V_25 , 0 ,
V_181 -> V_226 - 1 ) ;
V_151 = F_77 ( V_247 ) ;
...
F_1 ( & V_32 , V_30 ) ;
V_165 = F_77 ( V_30 ) ;
ASSERT ( V_32 . V_15 < F_81 ( args -> V_53 -> V_68 ) / 8 ) ;
V_131 = args -> V_131 ;
...
args -> V_202 = F_3 ( V_197 -> V_201 ) ;
args -> V_203 = F_107 ( args -> V_53 -> V_68 ,
V_110 ) ;
if ( args -> V_109 & V_119 ) {
args -> V_110 = V_110 ;
return 0 ;
...
ASSERT ( V_255 -> V_15 > 0 && V_255 -> V_15 < F_81 ( V_27 ) / 8 ) ;
ASSERT ( V_255 -> V_17 >= ( V_255 -> V_15 * sizeof( * V_260 ) )
+ F_101 ( V_254 ) ) ;
ASSERT ( V_258 -> V_15 < F_81 ( V_27 ) / 8 ) ;
...
V_189 *= sizeof( V_193 ) ;
V_260 = & F_77 ( V_257 ) [ V_259 ] ;
V_261 = & F_77 ( V_257 ) [ V_259 + V_15 ] ;
memmove ( V_261 , V_260 , V_189 ) ;
}
V_260 = & F_77 ( V_254 ) [ V_256 ] ;
V_261 = & F_77 ( V_257 ) [ V_259 ] ;
V_262 = V_259 ;
for ( V_5 = 0 ; V_5 < V_15 ; V_260 ++ , V_261 ++ , V_262 ++ , V_5 ++ ) {
ASSERT ( F_4 ( V_260 -> V_163 ) >= V_255 -> V_17 ) ;
V_189 = F_109 ( V_254 , V_256 + V_5 ) ;
#ifdef F_128
if ( V_260 -> V_109 & V_155 ) {
memset ( F_108 ( V_254 , V_256 + V_5 ) , 0 , V_189 ) ;
V_255 -> V_16 -= V_189 ;
V_255 -> V_15 -= 1 ;
V_261 -- ;
V_262 -- ;
...
<= F_81 ( V_27 ) ) ;
memmove ( F_108 ( V_257 , V_262 ) ,
F_108 ( V_254 , V_256 + V_5 ) , V_189 ) ;
...
( ( char * ) V_254 + F_81 ( V_27 ) ) ) ;
memset ( V_260 , 0 , V_189 ) ;
} else {
V_189 = ( V_255 -> V_15 - V_15 ) * sizeof( V_193 ) ;
V_260 = & F_77 ( V_254 ) [ V_256 + V_15 ] ;
V_261 = & F_77 ( V_254 ) [ V_256 ] ;
memmove ( V_261 , V_260 , V_189 ) ;
V_189 = V_15 * sizeof( V_193 ) ;
V_260 = & F_77 ( V_254 ) [ V_255 -> V_15 ] ;
ASSERT ( ( ( char * ) V_260 + V_189 ) <=
( ( char * ) V_254 + F_81 ( V_27 ) ) ) ;
memset ( V_260 , 0 , V_189 ) ;
}
V_258 -> V_20 [ 0 ] . V_21 = F_101 ( V_257 ) ;
...
V_152 = F_78 ( V_30 , V_190 ) ;
V_22 = F_129 ( V_152 -> V_106 ,
F_4 ( V_152 -> V_110 ) ) ;
} else {
V_197 = F_106 ( V_30 , V_190 ) ;
V_22 = F_130 ( V_197 -> V_106 ) ;
}
return V_22 ;
}
int
F_100 ( int V_106 , int V_110 , int V_226 , int * V_264 )
{
int V_22 ;
V_22 = F_129 ( V_106 , V_110 ) ;
if ( V_22 < F_131 ( V_226 ) ) {
if ( V_264 ) {
* V_264 = 1 ;
}
...
F_85 ( args -> V_99 , V_25 ,
F_104 ( V_30 , V_197 , sizeof( * V_197 ) ) ) ;
}
return F_139 ( & args -> V_99 , args -> V_53 ) ;
}
int
F_140 (
struct V_159 * args )
...
V_218 = V_172 -> V_31 ;
V_270 = & F_77 ( V_218 ) [ args -> V_190 ] ;
V_219 = V_173 -> V_31 ;
V_271 = & F_77 ( V_219 ) [ args -> V_200 ] ;
#ifdef F_46
F_1 ( & V_214 , V_218 ) ;
...
V_152 = F_78 ( V_218 , args -> V_190 ) ;
V_272 = V_152 -> V_106 ;
V_274 = ( char * ) V_152 -> V_108 ;
} else {
V_197 = F_106 ( V_218 , args -> V_190 ) ;
V_272 = V_197 -> V_106 ;
V_274 = ( char * ) V_197 -> V_107 ;
}
if ( V_271 -> V_109 & V_156 ) {
V_152 = F_78 ( V_219 , args -> V_200 ) ;
V_273 = V_152 -> V_106 ;
V_275 = ( char * ) V_152 -> V_108 ;
} else {
V_197 = F_106 ( V_219 , args -> V_200 ) ;
V_273 = V_197 -> V_106 ;
...
V_270 -> V_109 &= ~ V_155 ;
F_85 ( args -> V_99 , V_172 ,
F_104 ( V_218 , V_270 , sizeof( * V_270 ) ) ) ;
if ( args -> V_202 ) {
...
V_197 -> V_110 = F_6 ( args -> V_110 ) ;
F_85 ( args -> V_99 , V_172 ,
F_104 ( V_218 , V_197 , sizeof( * V_197 ) ) ) ;
}
V_271 -> V_109 |= V_155 ;
F_85 ( args -> V_99 , V_173 ,
F_104 ( V_219 , V_271 , sizeof( * V_271 ) ) ) ;
if ( ( V_271 -> V_109 & V_156 ) == 0 ) {
V_197 = F_106 ( V_219 , args -> V_200 ) ;
V_197 -> V_201 = 0 ;
V_197 -> V_110 = 0 ;
F_85 ( args -> V_99 , V_173 ,
F_104 ( V_219 , V_197 , sizeof( * V_197 ) ) ) ;
}
error = F_139 ( & args -> V_99 , args -> V_53 ) ;
return error ;
}
int
F_144 (
...
T_2 V_37 ;
int error ;
error = F_145 ( * V_99 , V_53 , 0 , - 1 , & V_25 , V_58 ) ;
if ( error )
return error ;
V_37 = V_25 -> V_38 ;
V_7 = V_25 -> V_31 ;
...
case F_2 ( V_277 ) :
case F_2 ( V_278 ) :
error = F_146 ( V_99 , V_53 , V_25 , 1 ) ;
break;
case F_2 ( V_9 ) :
case F_2 ( V_10 ) :
error = F_147 ( V_99 , V_53 , V_25 ) ;
break;
default:
error = F_54 ( V_124 ) ;
F_120 ( * V_99 , V_25 ) ;
...
if ( error )
return error ;
error = F_84 ( * V_99 , V_53 , 0 , V_37 , & V_25 , V_58 ) ;
if ( error )
return error ;
F_148 ( * V_99 , V_25 ) ;
error = F_139 ( V_99 , V_53 ) ;
return error ;
}
STATIC int
F_146 (
...
error = F_145 ( * V_99 , V_53 , V_280 , - 2 , & V_283 ,
V_58 ) ;
if ( error )
return ( error ) ;
if ( V_283 ) {
...
while ( V_293 > 0 ) {
V_295 = 1 ;
error = F_151 ( V_53 , ( V_296 ) V_291 , V_293 ,
& V_290 , & V_295 , V_297 ) ;
if ( error ) {
return ( error ) ;
}
...
V_292 = F_152 ( V_53 -> V_68 ,
V_290 . V_298 ) ;
V_294 = F_153 ( V_53 -> V_68 ,
V_290 . V_301 ) ;
V_25 = F_154 ( * V_99 ,
V_53 -> V_68 -> V_302 ,
V_292 , V_294 , 0 ) ;
