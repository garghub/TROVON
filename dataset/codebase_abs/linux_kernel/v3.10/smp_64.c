...
static void T_1 F_37 ( unsigned int V_46 , unsigned long V_52 , void * * V_53 )
{
...
static int T_1 F_41 ( unsigned int V_46 , struct V_77 * V_78 )
{
unsigned long V_79 =
( unsigned long ) ( & V_80 ) ;
unsigned long V_81 =
...
static void F_49 ( T_2 V_93 , T_2 V_94 , T_2 V_95 , T_2 V_96 , unsigned long V_46 )
{
T_2 V_97 , V_98 ;
int V_99 , V_100 ;
if ( V_101 ) {
...
static void F_58 ( T_2 V_93 , T_2 V_94 , T_2 V_95 , const T_4 * V_139 )
{
struct V_59 * V_60 ;
int V_123 , V_3 , V_103 ;
unsigned long V_37 ;
...
static void F_62 ( unsigned long * V_140 , T_5 V_141 , T_2 V_94 , T_2 V_95 , const T_4 * V_139 )
{
T_2 V_93 = ( ( ( T_2 ) V_141 ) << 32 | ( ( ( T_2 ) V_140 ) & 0xffffffff ) ) ;
F_58 ( V_93 , V_94 , V_95 , V_139 ) ;
}
static void F_63 ( unsigned long * V_140 , T_5 V_141 , T_2 V_94 , T_2 V_95 )
{
...
void T_6 F_67 ( int V_147 , struct V_148 * V_149 )
{
F_68 ( 1 << V_147 ) ;
F_69 () ;
}
void T_6 F_70 ( int V_147 , struct V_148 * V_149 )
{
F_68 ( 1 << V_147 ) ;
F_71 () ;
}
...
void T_6 F_90 ( int V_147 , struct V_148 * V_149 )
{
struct V_152 * V_153 ;
unsigned long V_37 ;
F_68 ( 1 << V_147 ) ;
...
void T_6 F_118 ( int V_147 , struct V_148 * V_149 )
{
F_68 ( 1 << V_147 ) ;
F_20 () ;
...
void T_7 F_121 ( unsigned int V_192 )
{
}
void F_122 ( void )
{
...
int T_1 F_129 ( unsigned int V_46 , struct V_77 * V_198 )
{
...
void T_7 F_147 ( unsigned int V_192 )
{
F_148 () ;
}
void F_149 ( int V_46 )
...
void T_6 F_150 ( int V_147 , struct V_148 * V_149 )
{
F_68 ( 1 << V_147 ) ;
F_151 () ;
}
...
static void * T_7 F_153 ( unsigned int V_46 , T_9 V_210 ,
T_9 V_211 )
{
...
static void T_7 F_162 ( void * V_215 , T_9 V_210 )
{
F_163 ( F_40 ( V_215 ) , V_210 ) ;
}
static int T_7 F_164 ( unsigned int V_216 , unsigned int V_217 )
{
...
static void T_7 F_165 ( unsigned long V_220 )
{
T_10 * V_155 = F_166 ( V_220 ) ;
T_11 * V_221 ;
T_12 * V_222 ;
