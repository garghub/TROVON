...
int F_199 ( struct V_6 * V_7 , int V_298 , int V_299 ,
...
if ( V_200 < sizeof( int ) )
return - V_181 ;
if ( F_201 ( V_301 , ( int V_243 * ) V_300 ) )
return - V_302 ;
switch ( V_299 ) {
case V_303 :
if ( V_301 != 0 ) {
...
int F_202 ( struct V_6 * V_7 , int V_298 , int V_299 ,
char V_243 * V_300 , unsigned int V_200 )
{
if ( V_298 == V_316 || V_298 == V_317 )
return F_199 ( V_7 , V_298 , V_299 , V_300 , V_200 ,
F_88 ) ;
return F_203 ( V_7 , V_298 , V_299 , V_300 , V_200 ) ;
}
int F_204 ( struct V_6 * V_7 , int V_298 , int V_299 ,
char V_243 * V_300 , unsigned int V_200 )
{
if ( V_298 == V_316 || V_298 == V_317 )
return F_199 ( V_7 , V_298 , V_299 , V_300 , V_200 ,
F_88 ) ;
return F_205 ( V_7 , V_298 , V_299 , V_300 , V_200 ) ;
}
int F_206 ( struct V_6 * V_7 , int V_298 , int V_299 ,
...
return - V_302 ;
if ( F_208 ( V_300 , & V_301 , V_122 ) )
return - V_302 ;
return 0 ;
}
int F_209 ( struct V_6 * V_7 , int V_298 , int V_299 ,
char V_243 * V_300 , int V_243 * V_200 )
{
if ( V_298 == V_316 || V_298 == V_317 )
return F_206 ( V_7 , V_298 , V_299 , V_300 , V_200 ) ;
return F_210 ( V_7 , V_298 , V_299 , V_300 , V_200 ) ;
}
int F_211 ( struct V_6 * V_7 , int V_298 , int V_299 ,
char V_243 * V_300 , int V_243 * V_200 )
{
if ( V_298 == V_316 || V_298 == V_317 )
return F_206 ( V_7 , V_298 , V_299 , V_300 , V_200 ) ;
return F_212 ( V_7 , V_298 , V_299 , V_300 , V_200 ) ;
}
unsigned int F_213 ( struct V_318 * V_318 , struct V_319 * V_6 , T_8 * V_320 )
{
unsigned int V_33 = F_214 ( V_318 , V_6 , V_320 ) ;
...
static struct V_6 * F_215 ( struct V_327 * V_328 , int V_329 )
{
struct V_6 * V_7 ;
struct V_330 * V_331 = V_328 -> V_332 ;
struct V_1 * V_1 = F_216 ( V_328 ) ;
...
static struct V_6 * F_218 ( struct V_327 * V_328 , struct V_6 * V_7 )
{
struct V_330 * V_331 = V_328 -> V_332 ;
struct V_1 * V_1 = F_216 ( V_328 ) ;
do {
...
return F_215 ( V_328 , V_331 -> V_333 + 1 ) ;
}
return V_7 ;
}
static struct V_6 * F_219 ( struct V_327 * V_328 , T_9 V_335 )
{
struct V_6 * V_7 = F_215 ( V_328 , 0 ) ;
if ( V_7 )
while ( V_335 && ( V_7 = F_218 ( V_328 , V_7 ) ) != NULL )
-- V_335 ;
return V_335 ? NULL : V_7 ;
}
static void * F_220 ( struct V_327 * V_328 , T_9 * V_335 )
{
struct V_330 * V_331 = V_328 -> V_332 ;
V_331 -> V_333 = V_336 ;
return * V_335 ? F_219 ( V_328 , * V_335 - 1 ) : V_337 ;
}
static void * F_221 ( struct V_327 * V_328 , void * V_338 , T_9 * V_335 )
{
struct V_6 * V_7 ;
if ( V_338 == V_337 )
V_7 = F_219 ( V_328 , 0 ) ;
else
V_7 = F_218 ( V_328 , V_338 ) ;
++ * V_335 ;
return V_7 ;
}
static void F_222 ( struct V_327 * V_328 , void * V_338 )
{
struct V_330 * V_331 = V_328 -> V_332 ;
if ( V_331 -> V_333 <= V_331 -> V_22 -> V_33 )
F_23 ( & V_331 -> V_22 -> V_70 [ V_331 -> V_333 ] . V_19 ) ;
}
int F_223 ( struct V_339 * V_339 , struct V_318 * V_318 )
{
struct V_340 * V_341 = F_224 ( V_339 ) ;
struct V_330 * V_84 ;
int V_92 ;
V_92 = F_225 ( V_339 , V_318 , & V_341 -> V_342 ,
sizeof( struct V_330 ) ) ;
if ( V_92 < 0 )
return V_92 ;
...
int F_226 ( struct V_1 * V_1 , struct V_340 * V_341 )
{
struct V_344 * V_345 ;
int V_270 = 0 ;
V_341 -> V_342 . V_329 = F_220 ;
V_341 -> V_342 . V_134 = F_221 ;
V_341 -> V_342 . V_346 = F_222 ;
V_345 = F_227 ( V_341 -> V_347 , V_348 , V_1 -> V_349 ,
V_341 -> V_350 , V_341 ) ;
if ( ! V_345 )
V_270 = - V_271 ;
return V_270 ;
}
void F_228 ( struct V_1 * V_1 , struct V_340 * V_341 )
{
F_229 ( V_341 -> V_347 , V_1 -> V_349 ) ;
}
static void F_230 ( struct V_6 * V_351 , struct V_327 * V_352 ,
int V_333 , int * V_122 )
{
struct V_45 * V_61 = F_25 ( V_351 ) ;
T_3 V_93 = V_61 -> V_64 ;
T_3 V_123 = V_61 -> V_48 ;
T_1 V_353 = F_49 ( V_61 -> V_65 ) ;
T_1 V_354 = F_49 ( V_61 -> V_141 ) ;
F_231 ( V_352 , L_9
L_10 ,
...
F_232 ( V_351 ) ,
0 , 0L , 0 ,
F_233 ( F_234 ( V_352 ) , F_3 ( V_351 ) ) ,
0 , F_235 ( V_351 ) ,
F_236 ( & V_351 -> V_72 ) , V_351 ,
F_236 ( & V_351 -> V_237 ) , V_122 ) ;
}
int F_237 ( struct V_327 * V_328 , void * V_338 )
{
if ( V_338 == V_337 )
F_231 ( V_328 , L_11 ,
L_12
...
struct V_330 * V_331 = V_328 -> V_332 ;
int V_122 ;
F_230 ( V_338 , V_328 , V_331 -> V_333 , & V_122 ) ;
F_231 ( V_328 , L_15 , 127 - V_122 , L_7 ) ;
}
return 0 ;
}
static int T_10 F_238 ( struct V_1 * V_1 )
{
return F_226 ( V_1 , & V_355 ) ;
}
...
static int T_12 F_244 ( char * V_357 )
{
T_13 V_230 ;
if ( ! V_357 )
return 0 ;
V_230 = F_245 ( V_357 , 0 , & V_358 ) ;
if ( V_230 )
return 0 ;
...
void T_12 F_246 ( struct V_22 * V_360 , const char * V_347 )
{
unsigned int V_286 ;
V_360 -> V_70 = F_247 ( V_347 ,
2 * sizeof( struct V_3 ) ,
V_358 ,
21 ,
0 ,
...
F_248 ( & V_360 -> V_70 [ V_286 ] . V_43 , V_286 ) ;
V_360 -> V_70 [ V_286 ] . V_36 = 0 ;
F_249 ( & V_360 -> V_70 [ V_286 ] . V_19 ) ;
}
for ( V_286 = 0 ; V_286 <= V_360 -> V_33 ; V_286 ++ ) {
F_248 ( & V_360 -> V_73 [ V_286 ] . V_43 , V_286 ) ;
V_360 -> V_73 [ V_286 ] . V_36 = 0 ;
F_249 ( & V_360 -> V_73 [ V_286 ] . V_19 ) ;
}
}
...
static struct V_75 * F_254 ( struct V_75 * V_76 ,
T_14 V_367 )
{
struct V_75 * V_368 = F_255 ( - V_181 ) ;
int V_369 = V_76 -> V_369 ;
int V_370 = F_256 ( V_76 ) - F_77 ( V_76 ) ;
T_4 V_371 = V_76 -> V_371 ;
T_14 V_372 ;
int V_373 ;
if ( F_45 ( ! F_193 ( V_76 , V_370 ) ) )
goto V_100;
V_76 -> V_366 = 0 ;
F_257 ( V_76 , V_370 ) ;
F_258 ( V_76 ) ;
F_259 ( V_76 , F_260 ( V_76 ) ) ;
V_76 -> V_369 = F_260 ( V_76 ) ;
V_76 -> V_371 = F_42 ( V_374 ) ;
V_372 = V_76 -> V_79 -> V_375 & F_261 ( V_76 ) ;
V_368 = F_262 ( V_76 , V_372 ) ;
if ( ! V_368 || F_107 ( V_368 ) )
goto V_100;
V_373 = F_263 ( V_76 ) ;
V_76 = V_368 ;
do {
struct V_87 * V_88 ;
int V_376 = V_373 - V_370 ;
V_76 -> V_369 = V_369 ;
F_264 ( V_76 , V_373 ) ;
F_258 ( V_76 ) ;
F_259 ( V_76 , V_369 ) ;
F_265 ( V_76 , V_376 ) ;
V_88 = F_74 ( V_76 ) ;
V_88 -> V_122 = F_42 ( V_76 -> V_122 - V_376 ) ;
if ( F_45 ( V_88 -> V_132 ) ) {
struct V_77 * V_78 = F_55 ( V_76 ) ;
V_88 -> V_132 = ~ F_79 ( V_78 -> V_49 , V_78 -> V_57 ,
V_76 -> V_122 - V_376 ,
V_133 , 0 ) ;
V_88 -> V_132 = F_266 ( F_81 ( V_76 , V_376 ,
V_76 -> V_122 - V_376 , 0 ) ) ;
if ( V_88 -> V_132 == 0 )
V_88 -> V_132 = V_137 ;
}
...
struct V_75 * F_267 ( struct V_75 * V_76 ,
T_14 V_367 )
{
struct V_75 * V_368 = F_255 ( - V_181 ) ;
unsigned int V_377 ;
V_377 = F_75 ( V_76 ) -> V_378 ;
if ( F_45 ( V_76 -> V_122 <= V_377 ) )
goto V_100;
if ( F_268 ( V_76 , V_367 | V_379 ) ) {
int type = F_75 ( V_76 ) -> V_380 ;
if ( F_45 ( type & ~ ( V_381 | V_382 |
V_383 |
V_384 ) ||
! ( type & ( V_381 ) ) ) )
goto V_100;
F_75 ( V_76 ) -> V_385 = F_269 ( V_76 -> V_122 , V_377 ) ;
V_368 = NULL ;
goto V_100;
}
if ( V_76 -> V_366 && F_75 ( V_76 ) -> V_380 & V_383 )
V_368 = F_254 ( V_76 , V_367 ) ;
else {
int V_127 ;
T_5 V_129 ;
V_127 = F_270 ( V_76 ) ;
...
V_127 += V_76 -> V_131 ;
* ( V_386 * ) ( V_76 -> V_86 + V_127 ) = F_266 ( V_129 ) ;
V_76 -> V_135 = V_136 ;
V_368 = F_271 ( V_76 , V_367 ) ;
}
V_100:
return V_368 ;
}
