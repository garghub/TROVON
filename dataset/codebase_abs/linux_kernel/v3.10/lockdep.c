...
static void F_213 ( struct V_70 * V_71 )
{
if ( ! F_8 () )
return;
if ( V_138 )
...
void F_214 ( struct V_70 * V_307 )
{
if ( F_60 ( V_307 -> V_73 > 0 ) )
F_213 ( V_307 ) ;
}
void F_177 ( void )
{
struct V_70 * V_308 , * V_309 ;
int V_86 = 10 ;
int V_310 = 1 ;
if ( F_60 ( ! V_2 ) ) {
F_30 ( L_150 ) ;
...
F_217 (g, p) {
if ( V_309 -> V_187 == V_314 && V_309 != V_3 )
continue;
if ( V_309 -> V_73 )
F_45 ( V_309 ) ;
if ( ! V_310 )
