...
int F_60 ( struct V_13 * V_14 , int V_100 , unsigned int V_101 )
{
int V_94 , V_31 ;
if ( V_101 < V_14 -> V_95 )
return - V_102 ;
...
for ( V_94 = 0 ; V_94 < V_14 -> V_95 ; V_94 ++ ) {
V_31 = F_62 ( V_14 -> V_10 ,
V_100 + V_94 , V_103 , V_104 , V_105 ,
F_63 ( V_14 -> V_10 ) , V_14 -> V_73 [ V_94 ] ) ;
if ( V_31 )
goto V_106;
}
for ( V_94 = 0 ; V_94 < V_14 -> V_95 ; V_94 ++ )
F_64 ( V_14 -> V_73 [ V_94 ] , L_56 , V_100 + V_94 ) ;
V_31 = F_65 ( V_14 , & V_107 ) ;
if ( V_31 )
goto V_108;
return 0 ;
V_108:
...
F_66 ( V_14 -> V_10 , V_100 + V_94 , V_14 -> V_73 [ V_94 ] ) ;
return V_31 ;
}
static int F_67 ( struct V_1 * V_2 , const struct V_109 * V_110 )
{
unsigned int V_111 = V_110 -> V_80 ;
struct V_112 V_113 = V_114 [ V_111 ] ;
const struct V_112 * V_115 [] = { & V_113 , NULL } ;
struct V_9 * V_10 = & V_2 -> V_10 ;
struct V_3 * V_4 ;
struct V_13 * V_14 ;
int V_95 , V_101 , V_94 , V_31 ;
int V_116 = V_117 ;
F_13 ( L_4 ) ;
F_68 ( ( int ) V_118 > V_119 ) ;
F_69 ( & V_2 -> V_10 , V_120 ) ;
...
F_2 ( & V_2 -> V_10 ,
L_57 ) ;
if ( V_2 -> V_7 == V_130 && V_2 -> V_9 == 0xCC06 )
V_116 = V_131 ;
...
V_4 = F_74 ( V_10 , sizeof( * V_4 ) , V_137 ) ;
if ( ! V_4 )
return - V_138 ;
V_4 -> V_11 |= ( unsigned long ) V_113 . V_16 ;
if ( V_111 == V_139 &&
( V_2 -> V_140 == 0xa1 || V_2 -> V_140 == 0xa2 ) )
V_4 -> V_11 |= V_99 ;
if ( V_111 == V_141 && V_2 -> V_140 >= 0x40 )
V_4 -> V_11 &= ~ V_142 ;
if ( F_43 ( V_2 ) )
V_4 -> V_11 &= ~ V_143 ;
V_4 -> V_46 = F_75 ( V_2 ) [ V_116 ] ;
V_101 = F_55 ( V_2 , V_4 ) ;
if ( V_101 > 1 )
V_4 -> V_11 |= V_144 ;
F_1 ( V_2 , V_4 ) ;
...
V_95 = F_77 ( F_78 ( V_4 -> V_145 ) , F_79 ( V_4 -> V_18 ) ) ;
V_14 = F_80 ( & V_2 -> V_10 , V_115 , V_95 ) ;
if ( ! V_14 )
return - V_138 ;
V_14 -> V_16 = V_4 ;
if ( ! ( V_4 -> V_145 & V_154 ) || V_155 )
V_14 -> V_11 |= V_156 ;
else
F_81 ( V_157 L_61 ) ;
if ( V_113 . V_11 & V_158 )
...
for ( V_94 = 0 ; V_94 < V_14 -> V_95 ; V_94 ++ ) {
struct V_28 * V_29 = V_14 -> V_73 [ V_94 ] ;
F_83 ( V_29 , V_116 , - 1 , L_62 ) ;
F_83 ( V_29 , V_116 ,
0x100 + V_29 -> V_159 * 0x80 , L_63 ) ;
if ( V_29 -> V_11 & V_158 )
V_29 -> V_160 = V_4 -> V_161 ;
if ( ! ( V_4 -> V_18 & ( 1 << V_94 ) ) )
V_29 -> V_74 = & V_162 ;
}
F_39 ( V_14 ) ;
F_52 ( V_14 ) ;
V_31 = F_33 ( V_2 , V_4 -> V_145 & V_163 ) ;
if ( V_31 )
return V_31 ;
V_31 = F_4 ( V_14 ) ;
if ( V_31 )
...
F_84 ( V_2 ) ;
if ( V_4 -> V_11 & V_144 )
return F_60 ( V_14 , V_2 -> V_100 , V_101 ) ;
return F_85 ( V_14 , V_2 -> V_100 , V_164 , V_105 ,
& V_107 ) ;
}
