...
static int F_16 ( void * V_16 ,
const struct V_1 * V_2 , T_2 V_4 )
{
return F_17 ( V_16 , ( const unsigned char * ) & V_2 -> V_14 ,
V_4 ) ;
}
int F_18 ( struct V_34 * V_35 , const char * V_26 )
{
struct V_10 V_11 ;
V_11 . V_16 = V_35 ;
V_11 . V_15 = F_16 ;
return F_9 ( & V_35 -> V_25 , & V_11 , V_26 ) ;
}
static int F_19 ( void * V_16 ,
const struct V_1 * V_2 , T_2 V_4 )
{
return F_20 ( V_16 , F_21 ( V_2 -> V_14 ) ,
V_2 -> V_5 , V_4 - 2 ) ;
}
int F_22 ( struct V_24 * V_25 , struct V_36 * V_36 ,
const char * V_26 )
{
struct V_10 V_11 ;
V_11 . V_16 = V_36 ;
V_11 . V_15 = F_19 ;
return F_9 ( V_25 , & V_11 , V_26 ) ;
}
