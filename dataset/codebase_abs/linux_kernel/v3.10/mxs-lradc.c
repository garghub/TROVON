...
{
struct V_1 * V_88 = F_58 ( V_92 ) ;
struct V_7 * V_8 = F_2 ( V_88 ) ;
const T_1 V_109 = V_108 ? V_24 : V_21 ;
F_7 ( V_110 , V_8 -> V_19 + F_59 ( 0 ) + V_109 ) ;
return 0 ;
}
static int F_60 ( struct V_1 * V_88 )
{
int V_9 ;
struct V_107 * V_92 ;
V_92 = F_61 ( L_2 , V_88 -> V_74 , V_88 -> V_76 ) ;
if ( V_92 == NULL )
return - V_73 ;
...
static void F_65 ( struct V_1 * V_88 )
{
F_66 ( V_88 -> V_92 ) ;
F_64 ( V_88 -> V_92 ) ;
}
static int F_67 ( struct V_1 * V_88 )
{
struct V_7 * V_8 = F_2 ( V_88 ) ;
...
const T_1 V_98 = V_99 |
( ( V_100 - 1 ) << V_101 ) ;
const int V_118 = F_68 ( V_88 -> V_119 , V_14 ) ;
if ( ! V_118 )
return - V_12 ;
V_9 = F_5 ( & V_8 -> V_15 ) ;
if ( ! V_9 )
return - V_16 ;
V_8 -> V_103 = F_69 ( V_118 * sizeof( * V_8 -> V_103 ) , V_120 ) ;
if ( ! V_8 -> V_103 ) {
V_9 = - V_73 ;
goto V_121;
}
...
V_8 -> V_19 + V_20 + V_21 ) ;
F_7 ( 0xff , V_8 -> V_19 + V_22 + V_21 ) ;
F_53 (chan, iio->active_scan_mask, LRADC_MAX_TOTAL_CHANS) {
V_115 |= V_3 << F_17 ( V_113 ) ;
V_116 |= F_8 ( V_113 ) ;
V_117 |= F_10 ( V_113 ) ;
F_7 ( V_98 , V_8 -> V_19 + F_9 ( V_113 ) ) ;
F_3 ( & V_114 , V_113 , 1 ) ;
V_113 ++ ;
}
F_7 ( V_123 | V_110 ,
V_8 -> V_19 + F_59 ( 0 ) + V_21 ) ;
F_7 ( V_116 , V_8 -> V_19 + V_23 + V_21 ) ;
F_7 ( V_115 , V_8 -> V_19 + V_23 + V_24 ) ;
F_7 ( V_117 , V_8 -> V_19 + V_20 + V_24 ) ;
F_7 ( V_114 << V_124 ,
V_8 -> V_19 + F_59 ( 0 ) + V_24 ) ;
return 0 ;
V_122:
F_71 ( V_8 -> V_103 ) ;
V_121:
...
static int F_72 ( struct V_1 * V_88 )
{
struct V_7 * V_8 = F_2 ( V_88 ) ;
F_7 ( V_123 | V_110 ,
V_8 -> V_19 + F_59 ( 0 ) + V_21 ) ;
...
static bool F_73 ( struct V_1 * V_88 ,
const unsigned long * V_10 )
{
struct V_7 * V_8 = F_2 ( V_88 ) ;
const int V_118 = V_88 -> V_125 ;
const int V_126 = F_68 ( V_10 , V_118 ) ;
int V_127 = 0 ;
...
( V_138 << V_139 ) ;
F_76 ( V_8 -> V_19 ) ;
F_7 ( V_136 , V_8 -> V_19 + F_59 ( 0 ) ) ;
F_7 ( 0 , V_8 -> V_19 + F_59 ( 1 ) ) ;
F_7 ( 0 , V_8 -> V_19 + F_59 ( 2 ) ) ;
F_7 ( 0 , V_8 -> V_19 + F_59 ( 3 ) ) ;
F_7 ( V_140 ,
V_8 -> V_19 + V_22 + V_21 ) ;
if ( V_8 -> V_72 == V_133 ) {
F_7 ( V_140 ,
...
F_7 ( V_18 ,
V_8 -> V_19 + V_20 + V_21 ) ;
for ( V_52 = 0 ; V_52 < V_142 ; V_52 ++ )
F_7 ( 0 , V_8 -> V_19 + F_59 ( V_52 ) ) ;
}
static int F_78 ( struct V_143 * V_144 )
{
const struct V_145 * V_146 =
F_79 ( V_147 , & V_144 -> V_69 ) ;
const struct V_148 * V_149 =
& V_148 [ ( enum V_150 ) V_146 -> V_87 ];
struct V_71 * V_69 = & V_144 -> V_69 ;
struct V_151 * V_152 = V_69 -> V_153 ;
struct V_7 * V_8 ;
struct V_1 * V_88 ;
struct V_154 * V_155 ;
T_1 V_156 = 0 ;
int V_9 = 0 ;
int V_52 ;
V_88 = F_80 ( sizeof( * V_8 ) ) ;
if ( ! V_88 ) {
F_38 ( V_69 , L_3 ) ;
return - V_73 ;
}
V_8 = F_2 ( V_88 ) ;
V_155 = F_81 ( V_144 , V_157 , 0 ) ;
V_8 -> V_69 = & V_144 -> V_69 ;
V_8 -> V_19 = F_82 ( V_69 , V_155 ) ;
if ( F_83 ( V_8 -> V_19 ) ) {
V_9 = F_84 ( V_8 -> V_19 ) ;
goto V_158;
}
...
F_88 ( V_69 , L_6 ,
V_156 ) ;
for ( V_52 = 0 ; V_52 < V_149 -> V_159 ; V_52 ++ ) {
V_8 -> V_86 [ V_52 ] = F_89 ( V_144 , V_52 ) ;
if ( V_8 -> V_86 [ V_52 ] < 0 ) {
V_9 = - V_12 ;
goto V_158;
}
V_9 = F_90 ( V_69 , V_8 -> V_86 [ V_52 ] ,
F_46 , 0 ,
V_149 -> V_160 [ V_52 ] , V_88 ) ;
if ( V_9 )
goto V_158;
}
F_91 ( V_144 , V_88 ) ;
F_92 ( & V_8 -> V_17 ) ;
F_93 ( & V_8 -> V_15 ) ;
V_88 -> V_74 = V_144 -> V_74 ;
V_88 -> V_69 . V_79 = & V_144 -> V_69 ;
V_88 -> V_161 = & V_162 ;
V_88 -> V_163 = V_164 ;
V_88 -> V_165 = V_166 ;
V_88 -> V_167 = F_94 ( V_166 ) ;
V_9 = F_95 ( V_88 , & V_168 ,
& F_52 ,
& V_169 ) ;
if ( V_9 )
