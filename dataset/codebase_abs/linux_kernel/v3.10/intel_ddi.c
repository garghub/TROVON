...
struct V_29 * V_29 = F_19 ( V_28 ) ;
struct V_2 * V_2 = F_35 ( V_28 ) ;
enum V_104 V_105 = V_29 -> V_106 . V_105 ;
int type = V_2 -> type ;
T_2 V_30 ;
if ( type == V_6 || type == V_7 ) {
V_30 = V_107 ;
switch ( V_29 -> V_106 . V_108 ) {
case 18 :
V_30 |= V_109 ;
break;
case 24 :
...
if ( V_28 -> V_57 . V_118 & V_119 )
V_30 |= V_120 ;
if ( V_28 -> V_57 . V_118 & V_121 )
V_30 |= V_122 ;
if ( V_105 == V_123 ) {
switch ( V_59 ) {
case V_124 :
...
bool F_52 ( struct V_142 * V_142 )
{
struct V_14 * V_15 = V_142 -> V_5 . V_15 ;
struct V_17 * V_18 = V_15 -> V_19 ;
struct V_2 * V_2 = V_142 -> V_4 ;
int type = V_142 -> V_5 . V_143 ;
enum V_1 V_1 = F_1 ( V_2 ) ;
enum V_59 V_59 = 0 ;
enum V_104 V_105 ;
T_2 V_144 ;
if ( ! V_2 -> V_145 ( V_2 , & V_59 ) )
return false ;
if ( V_1 == V_25 )
V_105 = V_123 ;
else
V_105 = (enum V_104 ) V_59 ;
V_144 = F_17 ( F_50 ( V_105 ) ) ;
switch ( V_144 & V_146 ) {
case V_133 :
case V_134 :
return ( type == V_147 ) ;
...
for ( V_21 = V_153 ; V_21 <= V_154 ; V_21 ++ ) {
V_144 = F_17 ( F_50 ( V_21 ) ) ;
if ( ( V_144 & V_140 )
== F_49 ( V_1 ) ) {
* V_59 = V_21 ;
return true ;
...
if ( F_17 ( V_165 ) & V_166 )
return 450 ;
else if ( ( F_17 ( V_167 ) & V_168 ) ==
V_169 )
return 450 ;
else if ( F_77 ( V_18 -> V_15 ) )
return 338 ;
else
return 540 ;
}
...
static bool F_85 ( struct V_2 * V_4 ,
struct V_177 * V_178 )
{
int type = V_4 -> type ;
F_8 ( type == V_9 , L_41 ) ;
if ( type == V_8 )
return F_86 ( V_4 , V_178 ) ;
else
return F_87 ( V_4 , V_178 ) ;
}
void F_88 ( struct V_14 * V_15 , enum V_1 V_1 )
{
struct V_17 * V_18 = V_15 -> V_19 ;
struct V_10 * V_11 ;
struct V_2 * V_2 ;
struct V_3 * V_4 ;
struct V_142 * V_179 = NULL ;
struct V_142 * V_180 = NULL ;
V_11 = F_89 ( sizeof( struct V_10 ) , V_181 ) ;
if ( ! V_11 )
return;
V_180 = F_89 ( sizeof( struct V_142 ) , V_181 ) ;
if ( ! V_180 ) {
F_90 ( V_11 ) ;
return;
}
if ( V_1 != V_25 ) {
V_179 = F_89 ( sizeof( struct V_142 ) ,
V_181 ) ;
if ( ! V_179 ) {
F_90 ( V_180 ) ;
F_90 ( V_11 ) ;
...
V_190 ;
if ( V_179 )
V_11 -> V_191 . V_192 = F_15 ( V_1 ) ;
V_11 -> V_172 . V_193 = F_15 ( V_1 ) ;
V_2 -> type = V_9 ;
V_2 -> V_194 = ( 1 << 0 ) | ( 1 << 1 ) | ( 1 << 2 ) ;
V_2 -> V_195 = false ;
V_2 -> V_196 = F_81 ;
if ( V_179 )
F_93 ( V_11 , V_179 ) ;
