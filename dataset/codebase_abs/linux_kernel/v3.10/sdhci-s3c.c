...
V_3 -> V_24 |= V_64 ;
if ( V_70 -> V_83 == V_85 )
V_3 -> V_49 -> V_121 = V_122 ;
switch ( V_70 -> V_81 ) {
case 8 :
V_3 -> V_49 -> V_121 |= V_123 ;
case 4 :
V_3 -> V_49 -> V_121 |= V_124 ;
break;
}
if ( V_70 -> V_125 )
V_3 -> V_49 -> V_125 |= V_70 -> V_125 ;
V_3 -> V_24 |= ( V_126 |
V_127 ) ;
V_3 -> V_24 |= V_128 ;
if ( V_3 -> V_24 & V_25 ) {
...
if ( V_70 -> V_132 )
V_3 -> V_49 -> V_121 |= V_70 -> V_132 ;
if ( V_70 -> V_133 )
V_3 -> V_49 -> V_134 |= V_70 -> V_133 ;
F_64 ( & V_12 -> V_13 ) ;
F_65 ( & V_12 -> V_13 , 50 ) ;
F_66 ( & V_12 -> V_13 ) ;
F_67 ( & V_12 -> V_13 , 1 ) ;
