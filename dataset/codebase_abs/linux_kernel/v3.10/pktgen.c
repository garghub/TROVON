...
{
F_164 ( V_149 -> V_323 -> V_324 , V_149 -> V_177 -> V_165 ) ;
}
...
{
T_5 V_325 = F_19 () ;
while ( F_167 ( & ( V_23 -> V_237 -> V_326 ) ) != 1 ) {
if ( F_88 ( V_13 ) )
break;
if ( F_168 () )
F_165 ( V_23 ) ;
...
T_13 (* F_171)( struct V_236 * , struct V_162 * )
= V_51 -> V_327 -> V_328 ;
struct V_329 * V_330 ;
V_250 V_280 ;
int V_150 ;
if ( F_124 ( ! F_66 ( V_51 ) || ! F_172 ( V_51 ) ) ) {
F_155 ( V_23 ) ;
return;
}
...
V_280 = F_173 ( V_23 -> V_237 ) ;
V_330 = F_174 ( V_51 , V_280 ) ;
F_175 ( V_330 ) ;
if ( F_124 ( F_176 ( V_330 ) ) ) {
V_150 = V_336 ;
V_23 -> V_332 = 0 ;
goto V_337;
}
F_177 ( & ( V_23 -> V_237 -> V_326 ) ) ;
V_150 = (* F_171)( V_23 -> V_237 , V_51 ) ;
switch ( V_150 ) {
case V_338 :
F_178 ( V_330 ) ;
V_23 -> V_332 = 1 ;
...
static int F_190 ( struct V_148 * V_149 ,
struct V_22 * V_23 )
{
int V_349 = 0 ;
F_43 ( V_149 ) ;
...
struct V_22 * V_23 ;
int V_9 ;
int V_71 = F_192 ( V_149 -> V_345 ) ;
V_23 = F_54 ( V_149 -> V_177 , V_154 , V_156 ) ;
if ( V_23 ) {
F_47 ( L_247 ) ;
return - V_351 ;
}
V_23 = F_193 ( sizeof( struct V_22 ) , V_263 , V_71 ) ;
if ( ! V_23 )
return - V_353 ;
strcpy ( V_23 -> V_32 , V_154 ) ;
V_23 -> V_217 = F_194 ( V_145 * sizeof( struct V_354 ) ,
V_71 ) ;
if ( V_23 -> V_217 == NULL ) {
F_195 ( V_23 ) ;
return - V_353 ;
...
static int T_14 F_197 ( int V_345 , struct V_11 * V_12 )
{
struct V_148 * V_149 ;
struct V_362 * V_363 ;
struct V_364 * V_316 ;
V_149 = F_193 ( sizeof( struct V_148 ) , V_263 ,
F_192 ( V_345 ) ) ;
if ( ! V_149 ) {
F_47 ( L_249 ) ;
return - V_353 ;
...
static void F_210 ( struct V_148 * V_149 ,
struct V_22 * V_23 )
{
struct V_319 * V_320 , * V_114 ;
struct V_22 * V_316 ;
...
static int T_14 F_211 ( struct V_177 * V_177 )
{
...
F_199 ( & V_12 -> V_366 ) ;
V_12 -> V_171 = false ;
V_12 -> V_165 = F_212 ( V_359 , V_12 -> V_177 -> V_368 ) ;
if ( ! V_12 -> V_165 ) {
F_213 ( L_254 , V_359 ) ;
return - V_178 ;
}
V_363 = F_214 ( V_369 , 0600 , V_12 -> V_165 , & V_370 ) ;
if ( V_363 == NULL ) {
F_47 ( L_255 , V_369 ) ;
V_150 = - V_126 ;
goto remove;
...
return 0 ;
V_371:
F_164 ( V_369 , V_12 -> V_165 ) ;
remove:
F_164 ( V_359 , V_12 -> V_177 -> V_368 ) ;
return V_150 ;
}
static void T_15 F_217 ( struct V_177 * V_177 )
{
struct V_11 * V_12 = F_4 ( V_177 , V_16 ) ;
struct V_148 * V_149 ;
struct V_319 * V_320 , * V_114 ;
