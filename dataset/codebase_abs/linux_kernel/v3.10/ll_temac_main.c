...
V_2 -> V_39 [ V_28 ] . V_47 = V_2 -> V_41 +
sizeof( * V_2 -> V_39 ) * ( ( V_28 + 1 ) % V_40 ) ;
}
for ( V_28 = 0 ; V_28 < V_31 ; V_28 ++ ) {
V_2 -> V_34 [ V_28 ] . V_47 = V_2 -> V_38 +
...
V_36 ,
V_37 ) ;
V_2 -> V_34 [ V_28 ] . V_49 = V_36 ;
V_2 -> V_34 [ V_28 ] . V_50 = V_51 ;
}
V_2 -> V_24 ( V_2 , V_52 , 0x10220400 |
V_53 |
V_54 |
V_55 ) ;
V_2 -> V_24 ( V_2 , V_56 , 0xff070000 |
V_53 |
V_54 |
V_55 |
V_57 ) ;
V_2 -> V_24 ( V_2 , V_58 , V_2 -> V_38 ) ;
V_2 -> V_24 ( V_2 , V_59 ,
V_2 -> V_38 + ( sizeof( * V_2 -> V_34 ) * ( V_31 - 1 ) ) ) ;
V_2 -> V_24 ( V_2 , V_60 , V_2 -> V_41 ) ;
return 0 ;
V_45:
F_21 ( V_27 ) ;
return - V_61 ;
...
( V_27 -> V_64 [ 3 ] << 24 ) ) ;
F_9 ( V_2 , V_65 ,
( V_27 -> V_64 [ 4 ] & 0x000000ff ) |
( V_27 -> V_64 [ 5 ] << 8 ) ) ;
F_34 ( & V_2 -> V_62 ) ;
}
static int F_35 ( struct V_26 * V_27 , void * V_66 )
{
memcpy ( V_27 -> V_64 , V_66 , V_67 ) ;
if ( ! F_36 ( V_27 -> V_64 ) )
F_37 ( V_27 ) ;
F_32 ( V_27 ) ;
return 0 ;
}
static int F_38 ( struct V_26 * V_27 , void * V_68 )
{
struct V_69 * V_70 = V_68 ;
if ( ! F_36 ( V_70 -> V_71 ) )
return - V_72 ;
memcpy ( V_27 -> V_64 , V_70 -> V_71 , V_67 ) ;
F_32 ( V_27 ) ;
return 0 ;
}
...
V_124 = V_123 -> V_50 ;
while ( V_124 & V_126 ) {
F_23 ( V_27 -> V_25 . V_33 , V_123 -> V_35 , V_123 -> V_49 ,
V_127 ) ;
if ( V_123 -> V_128 )
F_51 ( (struct V_42 * ) V_123 -> V_128 ) ;
V_123 -> V_50 = 0 ;
V_123 -> V_129 = 0 ;
V_123 -> V_130 = 0 ;
V_123 -> V_131 = 0 ;
...
static inline int F_53 ( struct V_1 * V_2 , int V_135 )
{
struct V_122 * V_123 ;
int V_136 ;
V_136 = V_2 -> V_137 ;
...
unsigned long V_135 ;
T_3 * V_142 ;
V_135 = F_55 ( V_43 ) -> V_143 ;
V_142 = & F_55 ( V_43 ) -> V_144 [ 0 ] ;
...
V_123 -> V_50 |= V_150 ;
V_123 -> V_49 = F_59 ( V_43 ) ;
V_123 -> V_35 = F_31 ( V_27 -> V_25 . V_33 , V_43 -> V_48 , V_43 -> V_49 ,
V_127 ) ;
...
V_2 -> V_137 = 0 ;
V_123 = & V_2 -> V_39 [ V_2 -> V_137 ] ;
V_123 -> V_35 = F_31 ( V_27 -> V_25 . V_33 ,
F_60 ( V_142 ) ,
F_61 ( V_142 ) , V_127 ) ;
V_123 -> V_49 = F_61 ( V_142 ) ;
V_123 -> V_50 = 0 ;
V_142 ++ ;
}
V_123 -> V_50 |= V_151 ;
...
V_123 -> V_50 = V_51 ;
V_123 -> V_35 = F_31 ( V_27 -> V_25 . V_33 , V_154 -> V_48 ,
V_36 ,
V_37 ) ;
V_123 -> V_49 = V_36 ;
...
F_20 ( & V_27 -> V_25 , L_11 ) ;
if ( V_2 -> V_176 ) {
V_2 -> V_107 = F_75 ( V_2 -> V_27 , V_2 -> V_176 ,
F_48 , 0 , 0 ) ;
if ( ! V_2 -> V_107 ) {
F_47 ( V_2 -> V_25 , L_12 ) ;
return - V_177 ;
...
if ( ! V_2 -> V_107 )
return - V_186 ;
return F_86 ( V_2 -> V_107 , V_184 , V_185 ) ;
}
...
V_49 += sprintf ( V_190 + V_49 , L_15 , V_2 -> V_23 ( V_2 , V_28 ) ,
( V_28 % 8 ) == 7 ? L_16 : L_17 ) ;
V_49 += sprintf ( V_190 + V_49 , L_16 ) ;
return V_49 ;
}
static int F_89 ( struct V_26 * V_27 , struct V_191 * V_185 )
{
struct V_1 * V_2 = F_22 ( V_27 ) ;
return F_90 ( V_2 -> V_107 , V_185 ) ;
}
static int F_91 ( struct V_26 * V_27 , struct V_191 * V_185 )
{
struct V_1 * V_2 = F_22 ( V_27 ) ;
return F_92 ( V_2 -> V_107 , V_185 ) ;
}
static int F_93 ( struct V_26 * V_27 )
{
struct V_1 * V_2 = F_22 ( V_27 ) ;
return F_94 ( V_2 -> V_107 ) ;
}
...
V_2 -> V_160 = 0 ;
V_68 = ( T_6 * ) F_103 ( V_19 -> V_25 . V_202 , L_19 , NULL ) ;
if ( V_68 && F_104 ( * V_68 ) ) {
V_2 -> V_160 |= V_204 ;
V_27 -> V_194 |= V_205 ;
}
V_68 = ( T_6 * ) F_103 ( V_19 -> V_25 . V_202 , L_20 , NULL ) ;
if ( V_68 && F_104 ( * V_68 ) )
V_2 -> V_160 |= V_161 ;
...
V_70 = F_103 ( V_19 -> V_25 . V_202 , L_26 , & V_192 ) ;
if ( ( ! V_70 ) || ( V_192 != 6 ) ) {
F_47 ( & V_19 -> V_25 , L_27 ) ;
V_175 = - V_177 ;
goto V_207;
