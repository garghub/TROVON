...
V_81 = F_68 ( V_2 -> V_83 / 2 ,
V_84 / V_85 ) ;
V_81 = F_68 ( V_81 , V_17 -> V_24 ) ;
V_81 = F_69 ( V_81 + V_86 ,
V_86 ) ;
}
return V_81 ;
...
V_5 -> V_39 |= V_40 ;
F_21 ( & V_5 -> V_58 ) ;
V_93 = F_67 ( V_22 -> V_2 , V_17 ) ;
V_56 . V_71 = V_93 ;
V_56 . V_69 = 0 ;
F_59 ( V_5 , & V_56 ) ;
V_17 -> V_24 -= V_93 - V_56 . V_71 ;
V_94 += V_93 - V_56 . V_71 ;
F_19 ( & V_22 -> V_31 ) ;
F_19 ( & V_5 -> V_58 ) ;
if ( ! ( V_5 -> V_39 & V_66 ) )
...
if ( V_17 -> V_24 <= 0 )
break;
if ( ( V_17 -> V_88 || V_17 -> V_87 ) &&
! F_24 ( & V_22 -> V_2 -> V_20 ) )
break;
if ( V_17 -> V_88 && ! F_78 ( V_22 -> V_2 ) )
break;
if ( V_17 -> V_87 ) {
V_103 = V_37 -
F_86 ( V_105 * 10 ) ;
...
F_40 ( V_22 , V_17 ) ;
if ( V_17 -> V_7 )
V_104 = F_70 ( V_17 -> V_7 , V_22 , V_17 ) ;
else
V_104 = F_74 ( V_22 , V_17 ) ;
F_88 ( V_22 -> V_2 , V_17 ) ;
F_83 ( V_22 , V_102 ) ;
if ( V_104 )
continue;
...
long F_95 ( struct V_32 * V_22 , int V_111 )
{
