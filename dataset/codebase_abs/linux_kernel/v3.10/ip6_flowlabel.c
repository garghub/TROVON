...
int F_60 ( struct V_34 * V_35 , char T_4 * V_58 , int V_59 )
{
int V_99 ( V_63 ) ;
...
goto V_115;
if ( ! V_57 . V_105 ) {
if ( F_66 ( & ( (struct V_56 T_4 * ) V_58 ) -> V_105 ,
...
static struct V_1 * F_72 ( struct V_119 * V_120 , T_5 V_126 )
{
...
static void * F_73 ( struct V_119 * V_120 , T_5 * V_126 )
__acquires( T_6 )
{
F_5 () ;
return * V_126 ? F_72 ( V_120 , * V_126 - 1 ) : V_127 ;
}
static void * F_74 ( struct V_119 * V_120 , void * V_128 , T_5 * V_126 )
{
struct V_1 * V_4 ;
if ( V_128 == V_127 )
V_4 = F_67 ( V_120 ) ;
