...
default:
F_2 ( V_89 L_12 ,
V_2 -> V_23 -> V_24 , V_4 -> V_25 , V_4 -> V_26 , V_7 ) ;
case V_11 :
V_4 -> V_90 = V_13 -> V_91 ;
...
if ( V_4 -> V_90 < 1 ) {
F_4 ( V_45 L_13 ,
V_2 -> V_23 -> V_24 , V_4 -> V_25 , V_4 -> V_26 , V_4 -> V_90 ) ;
return - V_46 ;
}
return V_68 ;
}
...
V_2 -> V_23 -> V_24 , V_4 -> V_25 , V_4 -> V_26 , V_7 ) ;
case V_11 : {
struct V_97 * V_13 = V_6 ;
V_92 = F_26 ( V_13 -> V_98 ) ;
V_93 = F_26 ( V_13 -> V_99 ) ;
F_25 ( V_22 L_15 , V_92 , V_93 ) ;
V_4 -> V_100 = V_93 ;
V_68 = F_7 ( V_2 , V_4 , V_6 , 8 ) ;
break;
}
case V_16 : {
struct V_101 * V_13 = V_6 ;
V_92 = F_26 ( V_13 -> V_98 ) ;
V_93 = F_26 ( V_13 -> V_99 ) ;
F_25 ( V_22 L_15 , V_92 , V_93 ) ;
V_4 -> V_100 = V_93 ;
...
struct V_3 * V_4 , unsigned int V_5 ,
struct V_77 * V_13 ,
int V_102 , struct V_78 * V_25 )
{
int V_70 ;
switch ( V_13 -> V_83 ) {
case V_103 :
case V_84 :
V_70 = F_21 ( V_2 , V_4 , V_5 , V_13 , V_25 ) ;
break;
case V_104 :
V_70 = F_24 ( V_2 , V_4 , V_5 , V_13 , V_25 ) ;
break;
default:
F_25 ( V_22 L_16 ,
V_2 -> V_23 -> V_24 , V_4 -> V_25 , V_4 -> V_26 ,
