...
V_5 = F_14 ( & V_63 -> V_28 , sizeof( struct V_4 ) ,
V_69 ) ;
if ( ! V_5 ) {
F_9 ( & V_63 -> V_28 , L_5 ) ;
return - V_70 ;
}
V_5 -> V_9 = F_15 ( V_63 , & V_71 ) ;
if ( F_16 ( V_5 -> V_9 ) ) {
F_9 ( & V_63 -> V_28 , L_6 ) ;
return F_17 ( V_5 -> V_9 ) ;
}
...
V_5 -> V_67 = V_19 -> V_67 ;
F_18 ( V_63 , V_5 ) ;
V_6 = F_7 ( V_5 -> V_9 , V_72 , & V_17 ) ;
if ( V_6 < 0 ) {
F_9 ( & V_63 -> V_28 , L_7 ) ;
return - V_68 ;
}
V_5 -> V_29 = V_17 & V_73 ;
V_6 = F_7 ( V_5 -> V_9 , V_74 , & V_17 ) ;
if ( V_6 < 0 ) {
F_9 ( & V_63 -> V_28 , L_8 ) ;
return - V_68 ;
}
