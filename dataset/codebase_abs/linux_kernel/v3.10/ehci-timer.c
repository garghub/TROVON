...
while ( ! F_20 ( & V_2 -> V_41 ) ) {
struct V_42 * V_43 ;
V_43 = F_21 ( & V_2 -> V_41 , struct V_42 ,
V_44 ) ;
if ( ! V_39 && V_43 -> V_45 == V_2 -> V_46 )
break;
F_22 ( & V_43 -> V_44 ) ;
F_23 ( V_2 , V_43 ) ;
}
...
F_28 (itd, n, &ehci->cached_itd_list, itd_list) {
F_22 ( & V_58 -> V_53 ) ;
F_29 ( V_2 -> V_62 , V_58 , V_58 -> V_63 ) ;
if ( V_58 == V_2 -> V_49 )
break;
}
F_28 (sitd, sn, &ehci->cached_sitd_list, sitd_list) {
F_22 ( & V_60 -> V_57 ) ;
F_29 ( V_2 -> V_64 , V_60 , V_60 -> V_65 ) ;
if ( V_60 == V_2 -> V_54 )
break;
}
if ( ! F_20 ( & V_2 -> V_50 ) ||
