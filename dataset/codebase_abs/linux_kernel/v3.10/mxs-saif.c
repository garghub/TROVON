...
static int F_27 ( struct V_1 * V_78 )
{
struct V_6 * V_7 = F_28 ( V_78 -> V_16 ) ;
F_29 ( V_78 , V_7 ) ;
V_78 -> V_79 = & V_7 -> V_80 ;
V_78 -> V_81 = & V_7 -> V_80 ;
return 0 ;
...
return V_86 ;
if ( V_27 & V_84 ) {
F_5 ( V_7 -> V_16 , L_11 , ++ V_7 -> V_55 ) ;
F_11 ( V_84 ,
V_7 -> V_20 + V_28 + V_34 ) ;
}
if ( V_27 & V_85 ) {
F_5 ( V_7 -> V_16 , L_12 , ++ V_7 -> V_56 ) ;
F_11 ( V_85 ,
V_7 -> V_20 + V_28 + V_34 ) ;
}
F_5 ( V_7 -> V_16 , L_13 ,
...
if ( ! V_91 )
return - V_10 ;
V_7 = F_32 ( & V_89 -> V_16 , sizeof( * V_7 ) , V_98 ) ;
if ( ! V_7 )
return - V_99 ;
V_14 = F_33 ( V_91 , L_14 ) ;
if ( V_14 < 0 )
...
V_94 = F_40 ( V_89 , V_100 , 0 ) ;
V_7 -> V_20 = F_41 ( & V_89 -> V_16 , V_94 ) ;
if ( F_37 ( V_7 -> V_20 ) )
return F_38 ( V_7 -> V_20 ) ;
V_95 = F_40 ( V_89 , V_101 , 0 ) ;
if ( ! V_95 ) {
V_14 = F_42 ( V_91 , L_18 ,
& V_7 -> V_80 . V_102 ) ;
if ( V_14 ) {
...
V_7 -> V_80 . V_102 = V_95 -> V_103 ;
}
V_7 -> V_82 = F_43 ( V_89 , 0 ) ;
if ( V_7 -> V_82 < 0 ) {
V_14 = V_7 -> V_82 ;
F_6 ( & V_89 -> V_16 , L_20 ,
V_14 ) ;
...
V_7 -> V_16 = & V_89 -> V_16 ;
V_14 = F_44 ( & V_89 -> V_16 , V_7 -> V_82 , F_30 , 0 ,
L_21 , V_7 ) ;
if ( V_14 ) {
F_6 ( & V_89 -> V_16 , L_22 ) ;
return V_14 ;
}
V_7 -> V_80 . V_104 . V_105 = F_43 ( V_89 , 1 ) ;
if ( V_7 -> V_80 . V_104 . V_105 < 0 ) {
V_14 = V_7 -> V_80 . V_104 . V_105 ;
F_6 ( & V_89 -> V_16 , L_23 ,
V_14 ) ;
return V_14 ;
}
F_45 ( V_89 , V_7 ) ;
V_14 = F_46 ( & V_89 -> V_16 , & V_106 ,
& V_107 , 1 ) ;
if ( V_14 ) {
F_6 ( & V_89 -> V_16 , L_24 ) ;
return V_14 ;
