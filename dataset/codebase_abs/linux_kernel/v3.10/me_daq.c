...
{
struct V_77 * V_78 = F_19 ( V_7 ) ;
const struct V_79 * V_80 ;
int V_81 ;
V_81 = F_20 ( & V_80 , V_82 , & V_78 -> V_7 ) ;
if ( V_81 )
return V_81 ;
V_81 = F_14 ( V_7 , V_80 -> V_12 , V_80 -> V_67 ) ;
F_21 ( V_80 ) ;
return V_81 ;
}
...
if ( V_81 )
return V_81 ;
V_14 -> V_70 = F_27 ( V_78 , 0 ) ;
if ( ! V_14 -> V_70 )
return - V_92 ;
V_14 -> V_31 = F_27 ( V_78 , 2 ) ;
if ( ! V_14 -> V_31 )
return - V_92 ;
if ( V_85 -> V_93 ) {
V_81 = F_18 ( V_7 ) ;
...
static int F_33 ( struct V_77 * V_7 ,
const struct V_116 * V_117 )
{
return F_34 ( V_7 , & V_118 , V_117 -> V_119 ) ;
}
