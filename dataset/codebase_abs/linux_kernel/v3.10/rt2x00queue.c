...
F_17 ( V_3 -> V_9 , V_8 -> V_134 -> V_140 ) ;
memset ( V_3 -> V_9 -> V_23 , 0 , V_8 -> V_134 -> V_140 ) ;
...
void F_91 ( struct V_5 * V_6 , bool V_206 )
{
bool V_207 ;
bool V_208 =
( V_6 -> V_137 == V_198 ) ||
...
void F_98 ( struct V_7 * V_8 , bool V_206 )
{
struct V_5 * V_6 ;
F_95 (rt2x00dev, queue)
F_91 ( V_6 , V_206 ) ;
F_91 ( V_8 -> V_210 , V_206 ) ;
}
...
unsigned int V_186 ;
F_99 ( V_6 ) ;
V_6 -> V_191 = V_213 -> V_215 ;
V_6 -> V_216 = F_103 ( V_213 -> V_215 , 10 ) ;
V_6 -> V_15 = V_213 -> V_15 ;
V_6 -> V_16 = V_213 -> V_16 ;
V_6 -> V_17 = V_213 -> V_17 ;
V_214 = sizeof( * V_190 ) + V_213 -> V_217 ;
V_190 = F_104 ( V_6 -> V_191 , V_214 , V_218 ) ;
if ( ! V_190 )
return - V_30 ;
...
V_190 [ V_186 ] . V_219 = V_186 ;
V_190 [ V_186 ] . V_220 =
F_105 ( V_190 , V_186 , V_6 -> V_191 ,
sizeof( * V_190 ) , V_213 -> V_217 ) ;
}
#undef F_105
V_6 -> V_190 = V_190 ;
return 0 ;
...
struct V_5 * V_6 ;
int V_221 ;
V_221 = F_102 ( V_8 -> V_210 , V_8 -> V_134 -> V_210 ) ;
if ( V_221 )
goto exit;
F_95 (rt2x00dev, queue) {
V_221 = F_102 ( V_6 , V_8 -> V_134 -> V_222 ) ;
if ( V_221 )
goto exit;
}
V_221 = F_102 ( V_8 -> V_223 , V_8 -> V_134 -> V_223 ) ;
if ( V_221 )
goto exit;
if ( F_2 ( V_224 , & V_8 -> V_19 ) ) {
V_221 = F_102 ( V_8 -> V_225 ,
V_8 -> V_134 -> V_225 ) ;
if ( V_221 )
goto exit;
}
V_221 = F_107 ( V_8 -> V_210 ) ;
if ( V_221 )
goto exit;
return 0 ;
exit:
...
struct V_5 * V_6 , enum V_226 V_137 )
{
F_112 ( & V_6 -> V_203 ) ;
F_113 ( & V_6 -> V_168 ) ;
F_113 ( & V_6 -> V_188 ) ;
...
unsigned int V_230 =
! ! F_2 ( V_224 , & V_8 -> V_19 ) ;
V_8 -> V_231 = 2 + V_8 -> V_134 -> V_232 + V_230 ;
V_6 = F_104 ( V_8 -> V_231 , sizeof( * V_6 ) , V_218 ) ;
if ( ! V_6 ) {
F_51 ( V_8 , L_10 ) ;
return - V_30 ;
}
V_8 -> V_210 = V_6 ;
V_8 -> V_222 = & V_6 [ 1 ] ;
V_8 -> V_223 = & V_6 [ 1 + V_8 -> V_134 -> V_232 ] ;
V_8 -> V_225 = V_230 ? & V_6 [ 2 + V_8 -> V_134 -> V_232 ] : NULL ;
F_111 ( V_8 , V_8 -> V_210 , V_202 ) ;
V_137 = V_198 ;
F_95 (rt2x00dev, queue)
F_111 ( V_8 , V_6 , V_137 ++ ) ;
F_111 ( V_8 , V_8 -> V_223 , V_233 ) ;
if ( V_230 )
F_111 ( V_8 , V_8 -> V_225 , V_234 ) ;
return 0 ;
}
