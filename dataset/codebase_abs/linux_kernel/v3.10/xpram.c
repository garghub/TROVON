...
V_28 = 0 ;
for ( V_23 = 0 ; V_23 < V_51 ; V_23 ++ ) {
struct V_60 * V_61 = V_54 [ V_23 ] ;
V_62 [ V_23 ] . V_27 = V_53 [ V_23 ] / 4 ;
V_62 [ V_23 ] . V_28 = V_28 ;
V_28 += V_62 [ V_23 ] . V_27 ;
V_61 -> V_63 = V_58 ;
V_61 -> V_64 = V_23 ;
...
V_61 -> V_18 = & V_62 [ V_23 ] ;
V_61 -> V_67 = V_56 [ V_23 ] ;
sprintf ( V_61 -> V_68 , L_11 , V_23 ) ;
F_27 ( V_61 , V_53 [ V_23 ] << 1 ) ;
F_28 ( V_61 ) ;
}
return 0 ;
V_55:
...
static void F_30 ( const char * V_69 )
{
F_16 ( L_12 , V_69 ) ;
F_31 ( L_13 ) ;
}
