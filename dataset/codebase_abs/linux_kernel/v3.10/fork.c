...
if ( V_61 )
goto V_311;
V_61 = F_243 ( V_164 , V_116 ) ;
if ( V_61 )
goto V_312;
V_61 = F_178 ( V_164 , V_116 ) ;
if ( V_61 )
goto V_313;
V_61 = F_244 ( V_164 , V_232 , V_233 , V_116 ) ;
if ( V_61 )
goto V_314;
if ( V_235 != & V_315 ) {
V_61 = - V_108 ;
V_235 = F_245 ( V_116 -> V_243 -> V_244 ) ;
if ( ! V_235 )
goto V_314;
}
V_116 -> V_235 = F_246 ( V_235 ) ;
V_116 -> V_316 = V_116 -> V_235 ;
if ( V_164 & V_204 )
V_116 -> V_316 = V_28 -> V_316 ;
V_116 -> V_317 = ( V_164 & V_318 ) ? V_234 : NULL ;
V_116 -> V_154 = ( V_164 & V_319 ) ? V_234 : NULL ;
#ifdef F_179
V_116 -> V_320 = NULL ;
#endif
#ifdef F_158
...
#endif
F_247 ( V_116 ) ;
if ( ( V_164 & ( V_171 | V_322 ) ) == V_171 )
V_116 -> V_323 = V_116 -> V_324 = 0 ;
F_248 ( V_116 ) ;
F_249 ( V_116 , V_325 ) ;
#ifdef F_250
F_249 ( V_116 , F_250 ) ;
...
V_116 -> V_326 = V_28 -> V_216 -> V_326 ;
else
V_116 -> V_326 = ( V_164 & V_327 ) ;
V_116 -> V_328 = 0 ;
V_116 -> V_26 = 0 ;
V_116 -> V_329 = 0 ;
V_116 -> V_330 = 128 >> ( V_331 - 10 ) ;
V_116 -> V_332 = 0 ;
V_116 -> V_216 = V_116 ;
F_69 ( & V_116 -> V_333 ) ;
V_116 -> V_334 = NULL ;
...
V_116 -> V_335 = V_28 -> V_335 ;
V_116 -> V_336 = V_28 -> V_336 ;
} else {
V_116 -> V_335 = V_28 ;
V_116 -> V_336 = V_28 -> V_337 ;
}
F_132 ( & V_28 -> V_193 -> V_338 ) ;
F_253 () ;
if ( F_254 ( V_28 ) ) {
F_134 ( & V_28 -> V_193 -> V_338 ) ;
F_255 ( & V_1 ) ;
V_61 = - V_339 ;
goto V_340;
}
...
F_256 ( & V_116 -> V_333 , & V_116 -> V_216 -> V_333 ) ;
}
if ( F_109 ( V_116 -> V_235 ) ) {
F_257 ( V_116 , ( V_164 & V_341 ) || V_236 ) ;
if ( F_258 ( V_116 ) ) {
if ( F_259 ( V_235 ) ) {
F_260 ( V_235 ) -> V_342 = V_116 ;
V_116 -> signal -> V_120 |= V_241 ;
}
V_116 -> signal -> V_343 = V_235 ;
V_116 -> signal -> V_344 = F_261 ( V_28 -> signal -> V_344 ) ;
F_262 ( V_116 , V_345 , F_263 ( V_28 ) ) ;
F_262 ( V_116 , V_346 , F_264 ( V_28 ) ) ;
F_265 ( & V_116 -> V_260 , & V_116 -> V_335 -> V_259 ) ;
F_256 ( & V_116 -> V_347 , & V_34 . V_347 ) ;
F_266 ( V_4 ) ;
}
F_262 ( V_116 , V_348 , V_235 ) ;
V_205 ++ ;
}
V_349 ++ ;
F_134 ( & V_28 -> V_193 -> V_338 ) ;
...
static inline void F_281 ( struct V_351 * V_352 )
{
enum V_353 type ;
for ( type = V_348 ; type < V_354 ; ++ type ) {
F_282 ( & V_352 [ type ] . V_7 ) ;
V_352 [ type ] . V_235 = & V_315 ;
}
}
struct V_5 * T_3 F_283 ( int V_2 )
{
struct V_5 * V_141 ;
V_141 = F_207 ( V_171 , 0 , 0 , NULL , & V_315 , 0 ) ;
if ( ! F_73 ( V_141 ) ) {
F_281 ( V_141 -> V_355 ) ;
F_284 ( V_141 , V_2 ) ;
}
...
long F_285 ( unsigned long V_164 ,
unsigned long V_232 ,
unsigned long V_233 ,
int T_2 * V_356 ,
int T_2 * V_234 )
...
if ( V_164 & V_322 )
V_236 = V_359 ;
else if ( ( V_164 & V_327 ) != V_360 )
V_236 = V_361 ;
else
V_236 = V_362 ;
if ( F_109 ( ! F_286 ( V_28 , V_236 ) ) )
V_236 = 0 ;
}
...
T_4 F_293 ( int (* F_294)( void * ) , void * V_365 , unsigned long V_120 )
{
return F_285 ( V_120 | V_171 | V_358 , ( unsigned long ) F_294 ,
( unsigned long ) V_365 , NULL , NULL ) ;
}
static void F_295 ( void * V_366 )
{
struct V_191 * V_193 = V_366 ;
F_104 ( & V_193 -> V_338 ) ;
F_194 ( & V_193 -> V_367 ) ;
}
void T_1 F_296 ( void )
...
V_368 | V_30 | V_31 , NULL ) ;
V_372 = F_18 ( L_9 ,
sizeof( struct V_50 ) , V_373 ,
V_368 | V_30 | V_31 , NULL ) ;
V_85 = F_297 ( V_53 , V_30 ) ;
F_298 () ;
F_299 () ;
}
static int F_300 ( unsigned long V_374 )
{
if ( V_374 & ~ ( V_204 | V_175 | V_237 | V_192 |
V_171 | V_184 | V_375 |
V_376 | V_377 | V_378 |
V_239 | V_242 ) )
return - V_238 ;
if ( V_374 & ( V_204 | V_192 | V_171 ) ) {
if ( F_35 ( & V_28 -> V_51 -> V_117 ) > 1 )
return - V_238 ;
}
return 0 ;
}
static int F_301 ( unsigned long V_374 , struct V_173 * * V_379 )
{
struct V_173 * V_174 = V_28 -> V_174 ;
if ( ! ( V_374 & V_175 ) || ! V_174 )
return 0 ;
if ( V_174 -> V_179 == 1 )
return 0 ;
* V_379 = F_175 ( V_174 ) ;
...
static int F_302 ( unsigned long V_374 , struct V_180 * * V_380 )
{
struct V_180 * V_381 = V_28 -> V_183 ;
int error = 0 ;
if ( ( V_374 & V_184 ) &&
( V_381 && F_35 ( & V_381 -> V_131 ) > 1 ) ) {
* V_380 = F_177 ( V_381 , & error ) ;
if ( ! * V_380 )
return error ;
}
return 0 ;
}
int F_303 ( struct V_180 * * V_382 )
{
struct V_5 * V_141 = V_28 ;
struct V_180 * V_383 = NULL ;
int error ;
error = F_302 ( V_184 , & V_383 ) ;
if ( error || ! V_383 ) {
* V_382 = NULL ;
return error ;
}
