...
void F_39 ( struct V_3 * V_3 , int V_16 ,
struct V_63 * V_64 )
{
F_30 ( & V_3 -> V_55 ) ;
V_64 -> V_16 = V_16 ;
F_40 ( & V_64 -> V_65 , & V_3 -> V_66 ) ;
F_33 ( & V_3 -> V_55 ) ;
}
void F_41 ( struct V_3 * V_3 , int V_16 ,
struct V_63 * V_64 )
{
F_30 ( & V_3 -> V_55 ) ;
F_42 ( & V_64 -> V_65 ) ;
...
int V_68 ;
F_24 () ;
V_68 = F_25 ( V_3 -> V_50 ) -> V_69 [ V_9 ] [ V_10 ] ;
if ( V_68 != - 1 )
...
V_2 -> V_9 . V_9 = V_73 -> V_77 . V_9 . V_9 ;
V_2 -> V_9 . V_10 = V_73 -> V_77 . V_9 . V_10 + V_74 ;
if ( V_2 -> V_9 . V_10 >= V_75 )
goto V_84;
V_71 -> V_69 [ V_73 -> V_77 . V_9 . V_9 ] [ V_2 -> V_9 . V_10 ] = V_73 -> V_68 ;
break;
case V_52 :
V_2 -> V_79 = F_20 ;
V_2 -> V_34 . V_35 = V_73 -> V_77 . V_34 . V_35 ;
V_2 -> V_34 . V_85 = V_73 -> V_77 . V_34 . V_85 ;
V_2 -> V_34 . V_36 = V_73 -> V_77 . V_34 . V_36 ;
break;
default:
goto V_84;
}
