...
if ( F_22 ( V_12 ) )
continue;
V_50 = F_23 ( V_12 , V_47 , V_48 , & type ) ;
if ( V_12 -> V_13 -> V_42 != V_42 )
type |= V_51 ;
V_45 = F_26 ( V_50 , V_50 -> V_7 . V_14 , type ) ;
if ( F_27 ( V_45 ) ) {
V_46 = F_28 ( V_45 ) ;
F_15 ( V_40 , V_49 . V_21 ) ;
goto V_52;
}
if ( F_29 ( V_38 -> V_53 , V_12 -> V_7 . V_14 ) ) {
F_30 ( V_12 , V_38 , V_45 ) ;
F_31 ( & V_45 -> V_54 , V_40 ) ;
} else {
F_31 ( & V_45 -> V_54 , & V_49 ) ;
...
static inline int F_35 ( struct V_1 * V_7 , int V_56 )
{
int V_57 = F_36 ( V_7 ) - V_7 -> V_58 ;
return ( V_57 > V_56 ) ;
}
int F_37 ( struct V_1 * V_7 , int V_59 )
{
struct V_1 * V_12 , * V_45 ;
struct V_1 * V_60 = V_7 -> V_61 ;
int V_46 = 0 ;
if ( V_7 == V_60 )
return F_35 ( V_7 , V_59 ) ;
if ( ! F_10 ( & V_7 -> V_62 ) || F_35 ( V_7 , V_59 ) )
return 1 ;
for ( V_12 = F_21 ( V_60 , V_60 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_60 ) ) {
V_45 = F_38 ( & V_12 -> V_7 , V_7 -> V_63 , 0 ) ;
...
for ( V_12 = F_21 ( V_60 , V_60 ) ; V_12 ;
V_12 = F_21 ( V_12 , V_60 ) ) {
struct V_1 * V_45 = F_38 ( & V_12 -> V_7 ,
V_7 -> V_63 , 0 ) ;
if ( V_45 && F_10 ( & V_45 -> V_62 ) )
F_41 ( & V_45 -> V_54 , & V_7 -> V_54 ) ;
}
}
int F_42 ( struct V_22 * V_64 )
{
struct V_1 * V_7 ;
