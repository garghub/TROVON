...
F_30 ( F_12 ( V_4 -> V_60 ) - 1 ) , & V_19 ) ;
V_31 = F_31 ( & V_19 ) ;
if ( ! V_31 ) {
V_31 = F_16 ( & V_19 , & V_4 -> V_67 ,
F_30 ( F_12 ( V_4 -> V_68 ) - 1 ) ,
V_6 , V_4 -> V_58 ,
V_23 -> V_59 ) ;
if ( ! V_31 )
return 0 ;
...
static int T_4 F_32 ( struct V_39 * V_39 )
{
int V_20 , V_34 ;
struct V_1 * V_2 ;
struct V_69 * V_70 = F_33 ( V_39 ) ;
if ( ! V_70 )
return - V_71 ;
V_2 = F_34 ( V_39 , & V_72 ) ;
if ( F_35 ( V_2 ) )
...
if ( ! V_74 [ V_20 ] )
continue;
V_34 = F_37 ( V_39 , V_2 , V_2 -> V_54 , V_74 [ V_20 ] ) ;
if ( V_34 )
goto V_75;
F_38 ( L_7 ,
