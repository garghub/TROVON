...
int F_27 ( void * V_5 , struct V_29 * * V_41 )
{
int V_31 ;
struct V_29 * V_29 ;
* V_41 = NULL ;
...
if ( ! V_29 )
return - V_38 ;
V_31 = F_28 ( & V_29 -> V_30 , V_32 , V_42 , V_5 ) ;
if ( V_31 )
goto error;
F_29 ( & V_29 -> V_39 ) ;
V_29 -> V_43 = F_18 ;
...
const struct V_45 * V_28 ,
struct V_46 * V_30 )
{
int V_31 ;
V_31 = F_15 ( & V_17 -> V_1 , V_17 -> V_3 [ 0 ] , V_47 , V_28 -> V_23 , V_30 -> V_30 . V_5 ) ;
if ( V_31 )
return V_31 ;
V_17 -> V_1 . V_12 = & V_48 ;
return 0 ;
...
static int F_38 ( struct V_46 * V_30 ,
const struct V_45 * V_28 ,
struct V_17 * * V_49 )
{
int V_31 , V_21 ;
...
static int F_39 ( struct V_46 * V_30 , struct V_17 * V_17 )
{
unsigned long V_36 ;
int V_21 ;
F_20 ( & V_30 -> V_39 , V_36 ) ;
...
int F_40 ( void * V_5 , struct V_46 * * V_50 )
{
int V_31 ;
struct V_46 * V_46 ;
* V_50 = NULL ;
V_46 = F_19 ( sizeof( * V_46 ) , V_37 ) ;
if ( ! V_46 )
return - V_38 ;
V_31 = F_28 ( & V_46 -> V_30 , V_47 , V_51 , V_5 ) ;
if ( V_31 )
goto error;
F_29 ( & V_46 -> V_39 ) ;
V_46 -> V_52 = F_38 ;
