...
static int F_20 ( struct V_10 * V_11 , unsigned int V_31 )
{
unsigned int V_24 , V_32 , V_25 , type ;
unsigned int V_26 = 0 ;
F_21 ( V_33 , 1 , V_11 , V_11 -> V_34 ) ;
V_26 = F_22 ( V_31 , V_11 -> V_35 ) ;
switch ( V_26 ) {
case V_36 :
break;
case V_37 :
...
V_24 = V_11 -> V_42 [ F_23 ( V_31 , V_43 ) ] ;
V_25 = V_11 -> V_42 [ F_23 ( V_31 , V_44 ) ] ;
V_32 = F_23 ( V_31 , V_45 ) ;
type = V_31 & V_27 ;
F_11 ( L_9 ,
F_23 ( V_31 , V_43 ) , V_24 ,
V_32 , F_23 ( V_31 , V_44 ) , V_25 ) ;
if ( ! F_24 ( V_46 , ( V_24 & ~ 3 ) , 4 ) ) {
F_11 ( L_10 ,
( void * ) V_24 ) ;
V_26 = - V_28 ;
} else {
