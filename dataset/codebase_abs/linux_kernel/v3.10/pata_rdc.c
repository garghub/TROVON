...
static int F_16 ( struct V_15 * V_16 , const struct V_53 * V_54 )
{
...
if ( V_60 )
return V_60 ;
V_4 = F_19 ( V_17 , sizeof( * V_4 ) , V_63 ) ;
if ( ! V_4 )
return - V_64 ;
F_20 ( V_16 , 0x54 , & V_4 -> V_9 ) ;
V_60 = F_21 ( V_16 , V_58 , & V_5 ) ;
if ( V_60 )
return V_60 ;
V_5 -> V_6 = V_4 ;
F_22 ( V_16 , 1 ) ;
V_5 -> V_26 |= V_65 ;
F_23 ( V_16 ) ;
return F_24 ( V_5 , V_66 , & V_67 ) ;
}
static void F_25 ( struct V_15 * V_16 )
{
struct V_59 * V_5 = F_26 ( & V_16 -> V_17 ) ;
