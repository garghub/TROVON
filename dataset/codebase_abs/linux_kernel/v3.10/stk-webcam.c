...
F_108 ( V_208 , & V_2 -> V_204 . V_28 ) ;
F_109 ( & V_2 -> V_204 , V_2 ) ;
V_88 = F_110 ( & V_2 -> V_204 , V_209 , - 1 ) ;
if ( V_88 )
F_10 ( L_30 ) ;
else
F_111 ( L_31 ,
...
static int F_113 ( struct V_210 * V_94 ,
const struct V_211 * V_144 )
{
struct V_212 * V_143 ;
int V_88 = 0 ;
int V_12 ;
...
F_123 ( V_2 ) ;
V_214 = V_94 -> V_219 ;
for ( V_12 = 0 ; V_12 < V_214 -> V_220 . V_221 ; ++ V_12 ) {
V_216 = & V_214 -> V_216 [ V_12 ] . V_220 ;
if ( ! V_2 -> V_67
&& F_124 ( V_216 ) ) {
V_2 -> V_67 = F_125 ( V_216 ) ;
break;
}
}
if ( ! V_2 -> V_67 ) {
...
static void F_129 ( struct V_210 * V_94 )
{
...
static int F_134 ( struct V_210 * V_223 , T_8 V_224 )
{
struct V_1 * V_2 = F_130 ( V_223 ) ;
if ( F_65 ( V_2 ) ) {
F_16 ( V_2 ) ;
F_15 ( V_2 ) ;
}
...
static int F_135 ( struct V_210 * V_223 )
{
struct V_1 * V_2 = F_130 ( V_223 ) ;
if ( ! F_9 ( V_2 ) )
return 0 ;
