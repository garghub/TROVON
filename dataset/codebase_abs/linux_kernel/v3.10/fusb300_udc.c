...
V_45 -> V_45 . V_78 = V_78 ;
F_74 ( & V_6 -> V_1 -> V_49 ) ;
V_45 -> V_45 . V_124 ( & V_6 -> V_6 , & V_45 -> V_45 ) ;
F_75 ( & V_6 -> V_1 -> V_49 ) ;
if ( V_6 -> V_9 ) {
F_46 ( V_6 ) ;
if ( ! F_34 ( & V_6 -> V_47 ) )
...
static void F_85 ( struct V_5 * V_6 , T_5 V_125 ,
T_1 V_126 )
{
T_1 V_3 ;
T_1 V_4 ;
...
F_3 ( V_125 , V_6 -> V_1 -> V_4 + F_87 ( V_6 -> V_9 ) ) ;
V_3 = F_88 ( V_126 ) | V_127 |
V_128 | V_129 | V_130 ;
...
{
int V_81 ;
V_81 = F_95 ( & V_6 -> V_1 -> V_74 ,
& V_45 -> V_45 , V_138 ) ;
if ( V_81 )
return;
F_1 ( V_6 -> V_1 , V_54 ,
F_93 ( V_6 -> V_9 ) ) ;
F_85 ( V_6 , V_45 -> V_45 . V_139 , V_45 -> V_45 . V_56 ) ;
F_91 ( V_6 ) ;
F_96 ( & V_6 -> V_1 -> V_74 ,
& V_45 -> V_45 , V_138 ) ;
}
...
struct V_44 * V_45 = F_35 ( V_6 -> V_47 . V_48 ,
struct V_44 , V_47 ) ;
T_1 V_4 = F_2 ( V_1 -> V_4 + F_99 ( V_6 -> V_9 ) ) ;
T_1 V_56 = V_4 & V_140 ;
F_67 ( V_6 , V_45 , V_56 ) ;
...
static T_6 F_108 ( int V_149 , void * V_150 )
{
struct V_1 * V_1 = V_150 ;
T_1 V_151 = F_2 ( V_1 -> V_4 + V_87 ) ;
T_1 V_152 = F_2 ( V_1 -> V_4 + V_71 ) ;
T_1 V_153 = F_2 ( V_1 -> V_4 + V_137 ) ;
T_1 V_154 = F_2 ( V_1 -> V_4 + V_54 ) ;
struct V_90 V_91 ;
T_2 V_155 ;
T_1 V_4 ;
int V_59 ;
...
if ( F_83 ( V_1 , & V_91 ) ) {
F_74 ( & V_1 -> V_49 ) ;
if ( V_1 -> V_176 -> V_177 ( & V_1 -> V_74 , & V_91 ) < 0 )
F_64 ( V_1 ) ;
F_75 ( & V_1 -> V_49 ) ;
}
}
...
{
T_1 V_4 ;
V_4 = F_2 ( V_1 -> V_4 + V_186 ) ;
V_4 &= ~ 0xff ;
V_4 |= F_111 ( time ) ;
F_3 ( V_4 , V_1 -> V_4 + V_186 ) ;
}
...
T_1 V_187 = 0 ;
T_1 V_12 = 0 ;
V_187 = V_12 = V_188 | V_189 ;
V_4 = F_2 ( V_1 -> V_4 + V_190 ) ;
V_4 &= ~ V_187 ;
V_4 |= V_12 ;
F_3 ( V_4 , V_1 -> V_4 + V_190 ) ;
V_187 = V_12 = V_191 ;
V_4 = F_2 ( V_1 -> V_4 + V_192 ) ;
V_4 &= ~ V_187 ;
V_4 |= V_12 ;
F_3 ( V_4 , V_1 -> V_4 + V_192 ) ;
F_110 ( V_1 , 0xff ) ;
F_112 ( V_1 , 0xff ) ;
...
struct V_195 * V_176 )
{
struct V_1 * V_1 = F_116 ( V_194 ) ;
V_176 -> V_176 . V_196 = NULL ;
V_1 -> V_176 = V_176 ;
return 0 ;
}
...
{
struct V_1 * V_1 = F_116 ( V_194 ) ;
V_176 -> V_197 ( & V_1 -> V_74 ) ;
F_114 ( V_1 ) ;
V_1 -> V_176 = NULL ;
return 0 ;
}
static int F_118 ( struct V_193 * V_198 , int V_199 )
{
return 0 ;
}
static int T_7 F_119 ( struct V_200 * V_201 )
{
struct V_1 * V_1 = F_120 ( & V_201 -> V_202 ) ;
F_121 ( & V_1 -> V_74 ) ;
F_122 ( V_1 -> V_4 ) ;
F_123 ( F_124 ( V_201 , 0 ) , V_1 ) ;
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_102 ) ;
F_43 ( V_1 ) ;
return 0 ;
}
static int T_8 F_125 ( struct V_200 * V_201 )
{
struct V_203 * V_204 , * V_205 , * V_206 ;
void T_9 * V_4 = NULL ;
struct V_1 * V_1 = NULL ;
struct V_5 * V_42 [ V_123 ] ;
int V_81 = 0 ;
int V_59 ;
V_204 = F_126 ( V_201 , V_207 , 0 ) ;
if ( ! V_204 ) {
V_81 = - V_208 ;
F_12 ( L_30 ) ;
goto V_209;
}
V_205 = F_126 ( V_201 , V_210 , 0 ) ;
if ( ! V_205 ) {
V_81 = - V_208 ;
F_127 ( & V_201 -> V_202 ,
L_31 ) ;
...
V_4 = F_128 ( V_204 -> V_211 , F_129 ( V_204 ) ) ;
if ( V_4 == NULL ) {
V_81 = - V_212 ;
F_12 ( L_33 ) ;
goto V_209;
...
F_130 ( & V_1 -> V_49 ) ;
F_131 ( & V_201 -> V_202 , V_1 ) ;
V_1 -> V_74 . V_213 = & V_214 ;
V_1 -> V_74 . V_215 = V_146 ;
V_1 -> V_74 . V_216 = V_217 ;
V_1 -> V_4 = V_4 ;
V_81 = F_132 ( V_205 -> V_211 , F_108 , V_218 ,
V_217 , V_1 ) ;
if ( V_81 < 0 ) {
F_12 ( L_36 , V_81 ) ;
goto V_209;
}
V_81 = F_132 ( V_206 -> V_211 , F_108 ,
V_218 , V_217 , V_1 ) ;
if ( V_81 < 0 ) {
F_12 ( L_37 , V_81 ) ;
goto V_209;
...
if ( V_59 != 0 ) {
F_41 ( & V_1 -> V_6 [ V_59 ] -> V_6 . V_219 ) ;
F_56 ( & V_1 -> V_6 [ V_59 ] -> V_6 . V_219 ,
& V_1 -> V_74 . V_219 ) ;
}
V_6 -> V_1 = V_1 ;
F_41 ( & V_6 -> V_47 ) ;
V_6 -> V_6 . V_216 = V_220 [ V_59 ] ;
V_6 -> V_6 . V_213 = & V_221 ;
V_6 -> V_6 . V_21 = V_222 ;
}
V_1 -> V_6 [ 0 ] -> V_6 . V_21 = V_223 ;
V_1 -> V_6 [ 0 ] -> V_9 = 0 ;
V_1 -> V_74 . V_103 = & V_1 -> V_6 [ 0 ] -> V_6 ;
F_41 ( & V_1 -> V_74 . V_103 -> V_219 ) ;
...
F_114 ( V_1 ) ;
V_81 = F_133 ( & V_201 -> V_202 , & V_1 -> V_74 ) ;
if ( V_81 )
goto V_225;
F_134 ( & V_201 -> V_202 , L_38 , V_226 ) ;
return 0 ;
V_225:
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 , V_1 -> V_102 ) ;
V_224:
F_123 ( V_205 -> V_211 , V_1 ) ;
V_209:
if ( V_1 ) {
if ( V_1 -> V_102 )
F_42 ( & V_1 -> V_6 [ 0 ] -> V_6 ,
