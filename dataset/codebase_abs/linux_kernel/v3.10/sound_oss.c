...
int V_38 = - 1 ;
int V_39 = - 1 , V_40 = - 1 ;
struct V_41 * V_42 = F_11 ( V_10 ) ;
if ( V_10 && V_10 -> V_14 >= V_43 )
return 0 ;
if ( V_1 < 0 )
return V_1 ;
V_36 = F_12 ( sizeof( struct V_2 ) , V_44 ) ;
if ( V_36 == NULL )
return - V_45 ;
V_36 -> type = type ;
V_36 -> V_10 = V_10 ? V_10 -> V_14 : - 1 ;
V_36 -> V_41 = V_11 ;
V_36 -> V_33 = V_33 ;
V_36 -> V_4 = V_4 ;
V_36 -> V_7 = V_10 ;
...
{
struct V_53 * V_54 ;
V_54 = F_22 ( V_57 , L_9 , V_58 ) ;
if ( V_54 ) {
V_54 -> V_59 . V_60 . V_61 = F_19 ;
if ( F_23 ( V_54 ) < 0 ) {
F_24 ( V_54 ) ;
V_54 = NULL ;
}
