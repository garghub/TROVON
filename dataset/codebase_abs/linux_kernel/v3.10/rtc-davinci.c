...
int V_20 = 0 ;
V_1 = F_31 ( & V_80 -> V_33 , sizeof( struct V_1 ) , V_84 ) ;
if ( ! V_1 ) {
F_32 ( V_33 , L_1 ) ;
return - V_85 ;
}
...
F_39 ( V_80 , V_1 ) ;
V_1 -> V_30 = F_40 ( & V_80 -> V_33 , V_80 -> V_90 ,
& V_92 , V_93 ) ;
if ( F_41 ( V_1 -> V_30 ) ) {
V_20 = F_42 ( V_1 -> V_30 ) ;
F_34 ( V_33 , L_6 ,
...
static int T_6 F_45 ( struct V_79 * V_80 )
{
struct V_1 * V_1 = F_46 ( V_80 ) ;
F_44 ( & V_80 -> V_33 , 0 ) ;
F_1 ( V_1 , 0 , V_95 ) ;
F_39 ( V_80 , NULL ) ;
return 0 ;
