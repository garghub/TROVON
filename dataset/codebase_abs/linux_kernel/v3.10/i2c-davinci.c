...
int V_45 ;
V_106 = F_40 ( V_104 , V_108 , 0 ) ;
if ( ! V_106 ) {
F_9 ( & V_104 -> V_8 , L_18 ) ;
return - V_109 ;
}
V_107 = F_40 ( V_104 , V_110 , 0 ) ;
if ( ! V_107 ) {
F_9 ( & V_104 -> V_8 , L_19 ) ;
return - V_109 ;
}
...
#endif
V_8 -> V_8 = & V_104 -> V_8 ;
V_8 -> V_107 = V_107 -> V_113 ;
V_8 -> V_11 = V_8 -> V_8 -> V_114 ;
F_43 ( V_104 , V_8 ) ;
if ( ! V_8 -> V_11 && V_104 -> V_8 . V_115 ) {
T_2 V_116 ;
V_8 -> V_11 = F_41 ( & V_104 -> V_8 ,
sizeof( struct V_10 ) , V_111 ) ;
if ( ! V_8 -> V_11 )
return - V_112 ;
memcpy ( V_8 -> V_11 , & V_117 ,
sizeof( struct V_10 ) ) ;
if ( ! F_44 ( V_104 -> V_8 . V_115 , L_21 ,
& V_116 ) )
V_8 -> V_11 -> V_23 = V_116 / 1000 ;
} else if ( ! V_8 -> V_11 ) {
V_8 -> V_11 = & V_117 ;
}
...
V_41 -> V_120 = V_121 ;
V_41 -> V_122 = V_123 ;
F_52 ( V_41 -> V_119 , L_24 , sizeof( V_41 -> V_119 ) ) ;
V_41 -> V_124 = & V_125 ;
V_41 -> V_8 . V_126 = & V_104 -> V_8 ;
V_41 -> V_32 = V_127 ;
V_41 -> V_8 . V_115 = V_104 -> V_8 . V_115 ;
