...
static void F_140 ( struct V_6 * V_62 , int V_7 )
{
struct V_2 * V_3 = V_62 -> V_10 ;
struct V_13 * V_14 = F_3 ( V_3 ) ;
struct V_135 * V_137 = F_137 ( V_3 ) ;
if ( ! V_7 ) {
...
static struct V_2 * F_141 ( struct V_2 * V_3 ,
bool V_138 )
{
struct V_13 * V_14 = F_3 ( V_3 ) ;
...
struct V_141 * V_142 ;
V_5 * V_143 ;
V_5 * V_24 = F_4 ( ( V_5 * ) ( V_137 + 1 ) + F_116 ( V_18 -> V_124 ) ,
F_2 ( V_18 -> V_124 ) + 1 ) ;
memcpy ( V_24 , V_18 -> V_125 , 4 ) ;
memcpy ( V_24 + 4 , V_3 -> V_24 , 8 ) ;
if ( V_138 )
...
V_142 = F_142 ( V_45 ) ;
V_143 = F_143 ( V_142 ) ? NULL : F_144 ( V_142 ) + V_45 -> V_144 ;
F_33 ( V_140 , 2 ) ;
F_34 ( V_140 , V_3 -> V_24 , 8 ) ;
F_145 ( V_140 , V_45 , V_143 == V_3 -> V_24 + 8 , 2 ) ;
V_57 += 8 + V_3 -> V_40 - ( V_138 ? 0 : V_37 ) ;
if ( V_3 -> V_63 -> V_145 == V_3 -> V_57 ) {
F_33 ( V_63 , 2 ) ;
F_146 ( V_63 , F_142 ( V_3 -> V_63 ) , V_3 -> V_63 -> V_145 ,
V_3 -> V_63 -> V_144 ) ;
} else {
...
F_145 ( V_63 , V_140 , 0 , 2 ) ;
F_117 ( V_126 , V_18 -> V_124 ) ;
F_118 ( V_126 , V_3 -> V_64 . V_127 , F_140 ,
V_3 ) ;
F_119 ( V_126 , V_139 , V_139 , V_138 ? 0 : V_37 , V_24 ) ;
F_120 ( V_126 , V_63 , V_57 ) ;
return V_126 ;
}
static int F_147 ( struct V_2 * V_3 , bool V_138 )
{
struct V_13 * V_14 = F_3 ( V_3 ) ;
struct V_136 * V_18 = F_9 ( V_14 ) ;
unsigned int V_37 = F_67 ( V_14 ) ;
...
return F_148 ( & V_149 , V_3 -> V_42 , V_3 -> V_45 , V_147 ) ;
}
...
static int F_151 ( struct V_67 * V_36 )
{
struct V_68 * V_69 = ( void * ) V_36 -> V_70 ;
struct V_150 * V_72 = F_78 ( V_69 ) ;
...
static void F_153 ( struct V_67 * V_36 )
{
struct V_136 * V_18 = F_62 ( V_36 ) ;
F_129 ( V_18 -> V_124 ) ;
F_154 ( V_18 -> null ) ;
}
static struct V_68 * F_155 ( struct V_76 * * V_77 )
{
struct V_81 * V_82 ;
struct V_68 * V_69 ;
struct V_128 * V_129 ;
...
V_69 -> V_101 . V_115 = F_151 ;
V_69 -> V_101 . V_116 = F_153 ;
V_69 -> V_101 . V_112 . V_117 = F_138 ;
V_69 -> V_101 . V_112 . V_118 = F_139 ;
V_69 -> V_101 . V_112 . V_119 = F_149 ;
V_69 -> V_101 . V_112 . V_120 = F_150 ;
V_69 -> V_101 . V_112 . V_134 = L_6 ;
V_35:
return V_69 ;
V_153:
...
static void F_156 ( struct V_68 * V_69 )
{
struct V_150 * V_18 = F_78 ( V_69 ) ;
F_134 ( & V_18 -> V_14 ) ;
F_104 ( & V_18 -> null ) ;
F_29 ( V_69 ) ;
}
