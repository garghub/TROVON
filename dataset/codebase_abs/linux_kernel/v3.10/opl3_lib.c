...
if ( V_46 == 0 ) {
V_50 -> V_93 = V_94 ;
sprintf ( V_50 -> V_95 , L_13 , V_44 -> V_45 ) ;
}
#endif
strcpy ( V_50 -> V_48 , V_50 -> V_96 ) ;
switch ( V_2 -> V_23 & V_76 ) {
case V_25 :
...
break;
case V_79 :
strcpy ( V_50 -> V_48 , L_16 ) ;
V_50 -> V_97 = V_100 ;
break;
}
V_50 -> V_66 . V_101 = V_102 ;
V_50 -> V_66 . V_103 = V_104 ;
V_50 -> V_66 . V_105 = V_106 ;
V_50 -> V_66 . V_107 = V_108 ;
V_2 -> V_109 = V_50 ;
V_2 -> V_110 = V_90 ;
#if F_40 ( V_111 ) || ( F_40 ( V_112 ) && F_40 ( V_113 ) )
if ( F_41 ( V_44 , V_90 , V_114 ,
sizeof( struct V_1 * ) , & V_2 -> V_115 ) >= 0 ) {
strcpy ( V_2 -> V_115 -> V_48 , V_50 -> V_48 ) ;
* (struct V_1 * * ) F_42 ( V_2 -> V_115 ) = V_2 ;
}
#endif
if ( V_91 )
* V_91 = V_50 ;
