...
if ( V_36 -> V_50 == V_63 )
for ( V_88 = V_36 -> V_48 . V_35 ; V_88 < V_36 -> V_58 ; V_88 ++ )
F_24 ( V_36 , V_36 -> V_66 , V_88 ) ;
else
for ( V_88 = V_36 -> V_48 . V_35 ; V_88 < V_36 -> V_58 ; V_88 ++ )
F_26 ( V_36 , V_36 -> V_66 , V_88 ) ;
for ( V_88 = V_36 -> V_58 ; V_88 % ( sizeof( * V_36 -> V_66 ) << V_67 ) ; V_88 ++ )
F_26 ( V_36 , V_36 -> V_66 , V_88 ) ;
memcpy ( V_36 -> V_82 , V_36 -> V_66 , V_89 ) ;
V_36 -> V_83 = F_64 ( V_36 -> V_66 ,
V_36 -> V_68 * sizeof( T_1 ) ) ;
V_36 -> V_85 = 0 ;
...
static int F_67 ( struct V_16 * log , T_3 V_91 )
{
struct V_25 * V_36 = (struct V_25 * ) log -> V_86 ;
return F_22 ( V_36 -> V_66 , V_91 ) ;
}
static int F_68 ( struct V_16 * log , T_3 V_91 , int V_92 )
{
struct V_25 * V_36 = (struct V_25 * ) log -> V_86 ;
return F_22 ( V_36 -> V_82 , V_91 ) ;
}
...
log -> F_19 ( V_36 -> V_18 ) ) {
V_36 -> V_65 = 1 ;
for ( V_88 = 0 ; V_88 < V_36 -> V_58 ; V_88 ++ )
F_26 ( V_36 , V_36 -> V_66 , V_88 ) ;
}
V_11 = F_34 ( V_36 , V_90 ) ;
if ( V_11 )
...
static void F_71 ( struct V_16 * log , T_3 V_91 )
{
struct V_25 * V_36 = (struct V_25 * ) log -> V_86 ;
F_26 ( V_36 , V_36 -> V_66 , V_91 ) ;
}
static void F_72 ( struct V_16 * log , T_3 V_91 )
{
struct V_25 * V_36 = (struct V_25 * ) log -> V_86 ;
if ( F_73 ( ! V_36 -> V_65 ) )
F_24 ( V_36 , V_36 -> V_66 , V_91 ) ;
}
static int F_74 ( struct V_16 * log , T_3 * V_91 )
{
struct V_25 * V_36 = (struct V_25 * ) log -> V_86 ;
...
if ( * V_91 >= V_36 -> V_58 )
return 0 ;
} while ( F_22 ( V_36 -> V_84 , * V_91 ) );
F_24 ( V_36 , V_36 -> V_84 , * V_91 ) ;
return 1 ;
}
static void F_76 ( struct V_16 * log , T_3 V_91 ,
int V_93 )
{
struct V_25 * V_36 = (struct V_25 * ) log -> V_86 ;
F_26 ( V_36 , V_36 -> V_84 , V_91 ) ;
if ( V_93 ) {
F_24 ( V_36 , V_36 -> V_82 , V_91 ) ;
V_36 -> V_83 ++ ;
} else if ( F_22 ( V_36 -> V_82 , V_91 ) ) {
V_36 -> V_83 -- ;
F_26 ( V_36 , V_36 -> V_82 , V_91 ) ;
}
}
...
static int F_78 ( struct V_16 * log , T_4 V_94 ,
...
static int F_80 ( struct V_16 * log , T_4 V_94 ,
char * V_95 , unsigned int V_96 )
{
int V_97 = 0 ;
struct V_25 * V_36 = log -> V_86 ;
switch( V_94 ) {
case V_98 :
F_79 ( L_23 , log -> type -> V_2 , V_36 -> V_69 -> V_2 ,
V_36 -> V_71 ? 'F' :
V_36 -> V_70 ? 'D' :
'A' ) ;
break;
