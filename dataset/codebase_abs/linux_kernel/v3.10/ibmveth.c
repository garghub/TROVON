...
F_19 ( V_45 , L_8 , V_2 -> V_69 ) ;
F_19 ( V_45 , L_9 , V_2 -> V_78 ) ;
F_19 ( V_45 , L_10 , V_2 -> V_3 . V_4 ) ;
...
unsigned char * V_239 ;
unsigned int * V_240 ;
F_114 ( & V_49 -> V_49 , L_41 ,
V_49 -> V_61 ) ;
V_239 = ( unsigned char * ) F_115 ( V_49 , V_241 ,
& V_238 ) ;
if ( ! V_239 ) {
F_116 ( & V_49 -> V_49 , L_42 ) ;
return - V_231 ;
}
if ( V_238 == 8 )
V_239 += 2 ;
...
int V_23 ;
for ( V_23 = 0 ; V_23 < V_66 ; V_23 ++ )
F_126 ( & V_2 -> V_67 [ V_23 ] . V_251 ) ;
F_127 ( V_45 ) ;
F_124 ( V_45 ) ;
F_118 ( & V_49 -> V_49 , NULL ) ;
return 0 ;
}
static T_8 F_128 ( struct V_250 * V_251 ,
struct V_255 * V_256 , char * V_182 )
{
struct V_14 * V_15 = F_90 ( V_251 ,
struct V_14 ,
V_251 ) ;
if ( V_256 == & V_257 )
...
static T_8 F_129 ( struct V_250 * V_251 , struct V_255 * V_256 ,
...
F_90 ( V_251 -> V_260 , struct V_74 , V_251 ) ) ;
struct V_1 * V_2 = F_43 ( V_45 ) ;
long V_261 = F_130 ( V_182 , NULL , 10 ) ;
long V_86 ;
if ( V_256 == & V_257 ) {
if ( V_261 && ! V_15 -> V_22 ) {
if ( F_61 ( V_45 ) ) {
