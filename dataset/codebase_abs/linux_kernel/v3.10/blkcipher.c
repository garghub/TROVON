...
{
struct V_90 V_91 ;
strncpy ( V_91 . type , L_1 , sizeof( V_91 . type ) ) ;
strncpy ( V_91 . V_92 , V_70 -> V_57 . V_92 ? : L_2 ,
sizeof( V_91 . V_92 ) ) ;
V_91 . V_42 = V_70 -> V_93 ;
...
static void F_61 ( struct V_98 * V_99 , struct V_73 * V_70 )
{
F_62 ( V_99 , L_3 ) ;
F_62 ( V_99 , L_4 , V_70 -> V_93 ) ;
F_62 ( V_99 , L_5 , V_70 -> V_57 . V_62 ) ;
F_62 ( V_99 , L_6 , V_70 -> V_57 . V_63 ) ;
F_62 ( V_99 , L_7 , V_70 -> V_57 . V_46 ) ;
F_62 ( V_99 , L_8 , V_70 -> V_57 . V_92 ? :
L_2 ) ;
}
static int F_63 ( struct V_100 * V_101 ,
const char * V_102 , T_2 type , T_2 V_74 )
{
struct V_73 * V_70 ;
int V_26 ;
type = F_64 ( type ) ;
V_74 = F_65 ( V_74 ) | V_103 ;
V_70 = F_66 ( V_102 , type , V_74 ) ;
if ( F_67 ( V_70 ) )
return F_68 ( V_70 ) ;
V_26 = F_69 ( & V_101 -> V_69 , V_70 , V_101 -> V_69 . V_104 , V_74 ) ;
F_70 ( V_70 ) ;
return V_26 ;
}
struct V_105 * F_71 ( struct V_106 * V_107 ,
struct V_108 * * V_109 , T_2 type ,
T_2 V_74 )
{
struct {
...
if ( F_67 ( V_112 ) )
return F_73 ( V_112 ) ;
if ( ( V_112 -> type ^ ( V_113 | V_103 ) ) &
V_112 -> V_74 )
return F_74 ( - V_29 ) ;
V_102 = F_75 ( V_109 [ 1 ] ) ;
if ( F_67 ( V_102 ) )
return F_73 ( V_102 ) ;
V_104 = F_76 ( sizeof( * V_104 ) + sizeof( * V_101 ) , V_114 ) ;
if ( ! V_104 )
return F_74 ( - V_36 ) ;
V_101 = F_77 ( V_104 ) ;
V_74 |= F_78 ( V_112 -> type , V_112 -> V_74 ) ;
F_79 ( V_101 , V_104 ) ;
V_26 = F_63 ( V_101 , V_102 , type , V_74 ) ;
if ( V_26 )
goto V_115;
V_70 = F_80 ( V_101 ) ;
if ( ( V_70 -> V_116 & V_76 ) ==
V_117 ) {
V_110 . V_46 = V_70 -> V_57 . V_46 ;
V_110 . V_62 = V_70 -> V_57 . V_62 ;
V_110 . V_63 = V_70 -> V_57 . V_63 ;
V_110 . V_61 = F_48 ;
V_110 . V_71 = F_50 ;
V_110 . V_72 = F_52 ;
V_110 . V_92 = V_70 -> V_57 . V_92 ;
} else {
V_110 . V_46 = V_70 -> V_118 . V_46 ;
V_110 . V_62 = V_70 -> V_118 . V_62 ;
V_110 . V_63 = V_70 -> V_118 . V_63 ;
V_110 . V_61 = V_70 -> V_118 . V_61 ;
V_110 . V_71 = V_70 -> V_118 . V_71 ;
V_110 . V_72 = V_70 -> V_118 . V_72 ;
V_110 . V_92 = V_70 -> V_118 . V_92 ;
}
V_26 = - V_29 ;
if ( ! V_110 . V_46 )
goto V_119;
if ( V_112 -> V_74 & V_103 ) {
if ( ! V_110 . V_92 )
V_110 . V_92 = F_81 ( V_70 ) ;
V_26 = - V_120 ;
if ( strcmp ( V_107 -> V_102 , V_110 . V_92 ) )
goto V_119;
memcpy ( V_104 -> V_70 . V_121 , V_70 -> V_121 , V_122 ) ;
memcpy ( V_104 -> V_70 . V_123 , V_70 -> V_123 ,
V_122 ) ;
} else {
V_26 = - V_124 ;
if ( snprintf ( V_104 -> V_70 . V_121 , V_122 ,
L_9 , V_107 -> V_102 , V_70 -> V_121 ) >=
V_122 )
goto V_119;
if ( snprintf ( V_104 -> V_70 . V_123 , V_122 ,
L_9 , V_107 -> V_102 , V_70 -> V_123 ) >=
V_122 )
goto V_119;
}
V_104 -> V_70 . V_116 = V_113 | V_103 ;
V_104 -> V_70 . V_116 |= V_70 -> V_116 & V_125 ;
V_104 -> V_70 . V_126 = V_70 -> V_126 ;
V_104 -> V_70 . V_93 = V_70 -> V_93 ;
V_104 -> V_70 . V_77 = V_70 -> V_77 ;
V_104 -> V_70 . V_127 = & V_128 ;
V_104 -> V_70 . V_118 . V_46 = V_110 . V_46 ;
V_104 -> V_70 . V_118 . V_62 = V_110 . V_62 ;
V_104 -> V_70 . V_118 . V_63 = V_110 . V_63 ;
V_104 -> V_70 . V_118 . V_92 = V_110 . V_92 ;
V_104 -> V_70 . V_118 . V_61 = V_110 . V_61 ;
V_104 -> V_70 . V_118 . V_71 = V_110 . V_71 ;
V_104 -> V_70 . V_118 . V_72 = V_110 . V_72 ;
V_8:
return V_104 ;
V_119:
F_82 ( V_101 ) ;
...
void F_83 ( struct V_105 * V_104 )
{
F_82 ( F_77 ( V_104 ) ) ;
F_22 ( V_104 ) ;
}
int F_84 ( struct V_51 * V_14 )
{
struct V_105 * V_104 = ( void * ) V_14 -> V_56 ;
struct V_66 * V_55 ;
V_55 = F_85 ( F_77 ( V_104 ) ) ;
if ( F_67 ( V_55 ) )
return F_68 ( V_55 ) ;
V_14 -> V_80 . V_69 = V_55 ;
V_14 -> V_80 . V_129 += F_86 ( V_55 ) ;
return 0 ;
}
void F_87 ( struct V_51 * V_14 )
{
F_88 ( V_14 -> V_80 . V_69 ) ;
}
