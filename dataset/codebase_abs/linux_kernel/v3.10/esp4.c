...
F_74 ( & V_111 ) ;
F_75 ( V_102 ) ;
F_76 ( V_17 , V_102 , V_101 , 0 , 0 , V_48 , 0 ) ;
} else
F_77 ( V_17 , V_102 , 0 , 0 , V_48 , 0 ) ;
F_78 ( V_20 ) ;
}
...
struct V_1 * V_2 ;
int V_15 ;
V_2 = F_82 ( V_20 -> V_2 -> V_112 , 0 , 0 ) ;
V_15 = F_83 ( V_2 ) ;
if ( F_84 ( V_2 ) )
goto error;
V_26 -> V_2 = V_2 ;
V_15 = F_85 ( V_2 , V_20 -> V_2 -> V_113 ,
( V_20 -> V_2 -> V_114 + 7 ) / 8 ) ;
if ( V_15 )
goto error;
V_15 = F_86 ( V_2 , V_20 -> V_2 -> V_115 / 8 ) ;
if ( V_15 )
goto error;
error:
return V_15 ;
...
L_1 ,
V_20 -> V_127 ? V_20 -> V_127 -> V_112 : L_2 ,
...
( V_20 -> V_125 -> V_114 + 7 ) / 8 + F_88 ( sizeof( * V_117 ) ) ;
V_15 = - V_46 ;
...
V_119 = ( void * ) V_121 ;
V_119 -> V_129 = V_130 ;
V_119 -> V_131 = F_89 ( sizeof( * V_117 ) ) ;
V_117 = F_90 ( V_119 ) ;
V_121 += F_88 ( sizeof( * V_117 ) ) ;
if ( V_20 -> V_127 ) {
struct V_132 * V_133 ;
memcpy ( V_121 , V_20 -> V_127 -> V_113 , ( V_20 -> V_127 -> V_114 + 7 ) / 8 ) ;
V_121 += ( V_20 -> V_127 -> V_114 + 7 ) / 8 ;
V_133 = F_91 ( V_20 -> V_127 -> V_112 , 0 ) ;
F_92 ( ! V_133 ) ;
V_15 = - V_84 ;
...
V_117 -> V_140 = F_94 ( ( V_20 -> V_125 -> V_114 + 7 ) / 8 ) ;
memcpy ( V_121 , V_20 -> V_125 -> V_113 , ( V_20 -> V_125 -> V_114 + 7 ) / 8 ) ;
V_15 = F_85 ( V_2 , V_120 , V_124 ) ;
V_138:
F_19 ( V_120 ) ;
error:
return V_15 ;
...
else if ( V_20 -> V_43 . V_88 == V_99 && V_20 -> V_141 . V_142 != V_143 )
V_20 -> V_43 . V_100 += V_144 ;
if ( V_20 -> V_49 ) {
struct V_50 * V_49 = V_20 -> V_49 ;
switch ( V_49 -> V_56 ) {
default:
...
V_20 -> V_43 . V_145 = V_97 + 1 + F_23 ( V_26 -> V_2 ) ;
error:
return V_15 ;
}
static int T_6 F_97 ( void )
{
if ( F_98 ( & V_146 , V_110 ) < 0 ) {
F_99 ( L_5 , V_147 ) ;
return - V_148 ;
}
if ( F_100 ( & V_149 , V_48 ) < 0 ) {
F_99 ( L_6 , V_147 ) ;
F_101 ( & V_146 , V_110 ) ;
return - V_148 ;
}
...
{
if ( F_103 ( & V_149 , V_48 ) < 0 )
F_99 ( L_7 , V_147 ) ;
if ( F_101 ( & V_146 , V_110 ) < 0 )
F_99 ( L_8 , V_147 ) ;
}
