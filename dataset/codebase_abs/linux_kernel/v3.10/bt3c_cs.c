...
{
T_2 * V_12 ;
V_12 = F_57 ( & V_96 -> V_34 , sizeof( * V_12 ) , V_97 ) ;
if ( ! V_12 )
return - V_87 ;
V_12 -> V_15 = V_96 ;
V_96 -> V_98 = V_12 ;
...
static int F_61 ( struct V_95 * V_15 , void * V_103 )
{
int * V_104 = V_103 ;
if ( ! V_104 )
V_15 -> V_105 = 16 ;
...
static int F_63 ( struct V_95 * V_15 ,
void * V_103 )
{
...
if ( ! F_64 ( V_96 , F_61 , ( void * ) V_104 ) )
goto V_112;
if ( ! F_64 ( V_96 , F_63 , NULL ) )
goto V_112;
F_10 ( L_17 ) ;
goto V_113;
V_112:
