...
static unsigned int F_16 ( unsigned char V_32 )
{
...
{
struct V_1 * V_8 = F_19 ( V_59 ) ;
V_69 -> V_64 . integer . V_64 [ 0 ] = F_16 ( F_2 ( V_8 , V_33 ) ) ;
return 0 ;
}
static int F_28 ( struct V_58 * V_59 , struct V_60 * V_61 )
{
V_61 -> type = V_78 ;
V_61 -> V_63 = 1 ;
return 0 ;
...
static int F_30 ( struct V_58 * V_59 , struct V_60 * V_61 )
{
V_61 -> type = V_78 ;
V_61 -> V_63 = 1 ;
return 0 ;
...
static int F_32 ( struct V_58 * V_59 , struct V_60 * V_61 )
{
V_61 -> type = V_62 ;
V_61 -> V_64 . integer . V_65 = 0 ;
...
static int F_34 ( struct V_58 * V_59 , struct V_60 * V_61 )
{
V_61 -> type = V_89 ;
V_61 -> V_63 = V_90 ;
return 0 ;
...
int F_36 ( struct V_1 * V_1 , struct V_93 * V_94 )
{
struct V_58 * V_95 ;
unsigned int V_96 ;
int V_17 ;
...
int F_41 ( struct V_1 * V_1 , unsigned int V_106 )
{
...
F_43 ( & V_1 -> V_23 , V_109 ) ;
if ( V_27 & V_115 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 0 ] -> V_101 ) ;
if ( V_27 & V_117 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 1 ] -> V_101 ) ;
if ( V_34 & V_119 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 2 ] -> V_101 ) ;
if ( V_34 & V_121 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 3 ] -> V_101 ) ;
if ( V_112 & 0x0f )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 4 ] -> V_101 ) ;
if ( ( V_112 & V_128 ) | ( V_111 & V_30 ) )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 6 ] -> V_101 ) ;
if ( V_111 & V_29 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 8 ] -> V_101 ) ;
if ( V_111 & V_123 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 9 ] -> V_101 ) ;
if ( V_112 & V_127 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 10 ] -> V_101 ) ;
if ( V_112 & V_126 )
F_44 ( V_1 -> V_14 , V_129 , & V_1 -> V_105 [ 11 ] -> V_101 ) ;
