...
int F_28 ( struct V_20 * V_20 , struct V_163 * V_95 ,
...
int F_30 ( struct V_20 * V_20 , struct V_163 * V_95 ,
int * V_69 )
{
struct V_83 * V_84 = F_15 ( V_20 ) ;
T_1 * V_9 = V_84 -> V_9 ;
...
struct V_20 * F_37 ( struct V_173 * V_22 , T_1 * V_9 )
{
struct V_20 * V_20 ;
struct V_83 * V_84 ;
V_20 = F_38 ( & V_174 , sizeof( * V_84 ) ) ;
if ( ! V_20 )
return NULL ;
V_84 = F_15 ( V_20 ) ;
V_84 -> V_9 = V_9 ;
memcpy ( V_84 -> V_115 , V_113 , sizeof( V_113 ) ) ;
memcpy ( V_84 -> V_175 , V_176 , sizeof( V_176 ) ) ;
V_84 -> V_177 . V_115 = V_84 -> V_115 ;
V_84 -> V_177 . V_112 = F_16 ( V_113 ) ;
V_84 -> V_177 . V_178 = V_84 -> V_175 ;
V_84 -> V_177 . V_179 = F_16 ( V_176 ) ;
V_84 -> V_177 . V_177 = V_180 ;
V_84 -> V_177 . V_181 . V_182 = false ;
V_20 -> V_183 [ V_180 ] = & V_84 -> V_177 ;
F_39 ( V_20 , V_22 ) ;
V_20 -> V_184 = V_185 ;
V_20 -> V_186 = 1 ;
V_20 -> V_187 = F_40 ( V_32 )
| F_40 ( V_29 ) ;
V_20 -> V_188 = V_189 ;
V_20 -> V_190 = V_191 ;
V_20 -> V_192 = V_193 ;
