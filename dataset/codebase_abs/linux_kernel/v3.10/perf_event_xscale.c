...
V_32 = & V_29 -> V_33 ;
F_7 ( V_29 ) ;
F_8 ( & V_15 , 0 , V_32 -> V_34 ) ;
if ( ! F_9 ( V_29 ) )
continue;
if ( F_10 ( V_29 , & V_15 , V_22 ) )
V_17 -> V_35 ( V_29 ) ;
}
F_11 () ;
V_2 = F_1 () | V_24 ;
...
struct V_16 * V_17 = F_13 ( V_29 -> V_40 ) ;
struct V_31 * V_32 = & V_29 -> V_33 ;
struct V_18 * V_30 = V_17 -> V_20 () ;
int V_23 = V_32 -> V_23 ;
switch ( V_23 ) {
case V_6 :
V_37 = 0 ;
...
struct V_31 * V_32 = & V_29 -> V_33 ;
if ( V_51 == V_32 -> V_43 ) {
if ( F_18 ( V_6 , V_19 -> V_52 ) )
return - V_53 ;
return V_6 ;
} else {
if ( ! F_18 ( V_10 , V_19 -> V_52 ) )
return V_10 ;
if ( ! F_18 ( V_8 , V_19 -> V_52 ) )
return V_8 ;
return - V_53 ;
}
}
...
static inline T_1 F_21 ( struct V_28 * V_29 )
{
struct V_31 * V_32 = & V_29 -> V_33 ;
int V_4 = V_32 -> V_23 ;
T_1 V_1 = 0 ;
...
static inline void F_22 ( struct V_28 * V_29 , T_1 V_1 )
{
struct V_31 * V_32 = & V_29 -> V_33 ;
int V_4 = V_32 -> V_23 ;
switch ( V_4 ) {
...
struct V_28 * V_29 )
{
int V_23 = F_17 ( V_19 , V_29 ) ;
if ( V_23 >= 0 )
goto V_90;
if ( ! F_18 ( V_72 , V_19 -> V_52 ) )
V_23 = V_72 ;
else if ( ! F_18 ( V_70 , V_19 -> V_52 ) )
V_23 = V_70 ;
V_90:
return V_23 ;
}
...
static inline T_1 F_41 ( struct V_28 * V_29 )
{
struct V_31 * V_32 = & V_29 -> V_33 ;
int V_4 = V_32 -> V_23 ;
T_1 V_1 = 0 ;
...
static inline void F_42 ( struct V_28 * V_29 , T_1 V_1 )
{
struct V_31 * V_32 = & V_29 -> V_33 ;
int V_4 = V_32 -> V_23 ;
switch ( V_4 ) {
...
static inline int F_43 ( struct V_16 * V_17 )
{
return - V_92 ;
}
