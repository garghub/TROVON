...
{
struct V_171 * V_172 = V_54 ;
if ( V_172 -> V_174 && V_172 -> V_175 & V_176 )
F_102 ( V_172 -> V_174 ) ;
F_103 ( V_172 ) ;
return 0 ;
}
static int F_104 ( struct V_1 * V_2 , int V_177 )
{
int V_178 ;
F_41 ( & V_2 -> V_110 ) ;
if ( V_177 == 0 ) {
V_178 = F_105 ( & V_2 -> V_109 , F_100 , V_2 ) ;
} else if ( V_177 == 1 ) {
V_178 = F_105 ( & V_2 -> V_109 , F_99 , V_2 ) ;
} else {
V_178 = 0 ;
}
F_44 ( & V_2 -> V_110 ) ;
...
struct V_126 * V_179 ;
struct V_100 * V_6 ;
int V_72 , V_180 , V_178 ;
V_180 = F_104 ( V_2 , V_177 ) ;
F_41 ( & V_40 ) ;
if ( V_2 -> V_60 == 1 ) {
if ( V_180 ) {
V_178 = - V_181 ;
...
V_179 = F_110 ( V_6 , struct V_126 , V_182 ) ;
...
V_179 = F_114 ( & V_2 -> V_117 , struct V_126 ,
V_183 ) ;
F_63 ( & V_179 -> V_183 ) ;
F_112 ( V_179 ) ;
}
