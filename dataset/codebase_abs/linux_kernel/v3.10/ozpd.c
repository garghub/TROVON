...
struct V_1 * F_15 ( const T_1 * V_14 )
{
...
static void F_50 ( struct V_72 * V_40 )
{
struct V_67 * V_67 = (struct V_67 * ) F_51 ( V_40 ) ;
V_67 -> V_73 |= V_74 ;
}
static void F_52 ( struct V_1 * V_2 , struct V_72 * V_40 )
{
struct V_67 * V_67 = (struct V_67 * ) F_51 ( V_40 ) ;
...
int F_87 ( struct V_1 * V_2 , T_1 V_124 , const T_1 * V_98 , int V_94 )
{
struct V_89 * V_90 = V_2 -> V_42 ;
struct V_34 * V_35 ;
T_1 V_127 = 0 ;
struct V_72 * V_40 = NULL ;
...
{
struct V_36 * V_33 ;
const struct V_44 * V_45 = & V_47 [ V_147 - 1 ] ;
while ( 1 ) {
F_29 () ;
if ( F_91 ( & V_2 -> V_26 ) ) {
F_30 () ;
