...
F_91 ( V_98 , NULL , 0 ) ;
F_92 ( V_8 , V_98 , V_106 , V_107 ,
V_101 , V_102 , V_110 ) ;
V_109 = V_98 -> V_114 [ 0 ] ;
F_93 (curr, next, &head, tree_list) {
V_105 = F_94 ( V_104 , V_109 , char ) ;
F_95 ( V_104 , & V_99 -> V_115 ,
( unsigned long ) V_105 ,
V_99 -> V_53 ) ;
V_109 ++ ;
F_80 ( V_8 , V_99 ) ;
...
char * V_116 ;
int V_39 ;
V_39 = F_98 ( V_80 , V_8 , V_98 , & V_61 -> V_26 ,
V_61 -> V_53 ) ;
if ( V_39 < 0 && V_39 != - V_43 )
return V_39 ;
V_104 = V_98 -> V_48 [ 0 ] ;
V_116 = F_94 ( V_104 , V_98 -> V_114 [ 0 ] , char ) ;
F_95 ( V_104 , V_61 -> V_115 , ( unsigned long ) V_116 ,
V_61 -> V_53 ) ;
F_99 ( V_104 ) ;
F_80 ( V_8 , V_61 ) ;
return 0 ;
...
static int F_102 ( struct V_79 * V_80 ,
struct V_7 * V_8 ,
struct V_97 * V_98 ,
struct V_23 * V_54 )
{
...
if ( ! V_110 )
return 0 ;
V_39 = F_105 ( V_80 , V_8 , V_98 , V_98 -> V_114 [ 0 ] , V_110 ) ;
if ( V_39 )
goto V_51;
F_93 (curr, next, &head, tree_list) {
F_80 ( V_8 , V_99 ) ;
...
if ( ! V_99 )
goto V_121;
V_39 = F_107 ( V_80 , V_8 , & V_99 -> V_26 , V_98 , - 1 , 1 ) ;
if ( V_39 < 0 )
goto V_121;
else if ( V_39 > 0 ) {
V_58 = V_99 ;
...
F_110 ( & V_26 , V_123 ) ;
V_26 . V_29 = 0 ;
V_39 = F_111 ( V_80 , V_8 , V_98 , & V_26 , 1 ) ;
if ( V_39 > 0 ) {
F_101 ( V_98 ) ;
return - V_120 ;
} else if ( V_39 < 0 ) {
...
F_112 ( V_98 , 1 ) ;
V_104 = V_98 -> V_48 [ 0 ] ;
V_22 = F_94 ( V_104 , V_98 -> V_114 [ 0 ] ,
struct V_122 ) ;
F_95 ( V_104 , & V_36 -> V_22 , ( unsigned long ) V_22 ,
sizeof( struct V_122 ) ) ;
F_99 ( V_104 ) ;
F_101 ( V_98 ) ;
F_86 ( V_8 , V_36 ) ;
...
static inline int F_113 ( struct V_79 * V_80 ,
struct V_7 * V_8 ,
struct V_97 * V_98 ,
struct V_2 * V_36 )
{
...
V_39 = F_109 ( V_80 , V_8 , V_98 , V_36 ) ;
F_40 ( & V_36 -> V_17 ) ;
return V_39 ;
}
static inline int
F_114 ( struct V_79 * V_80 ,
struct V_97 * V_98 ,
struct V_2 * V_36 )
{
int V_39 ;
V_39 = F_100 ( V_80 , V_98 , V_36 -> V_8 , V_36 ) ;
if ( V_39 )
return V_39 ;
V_39 = F_106 ( V_80 , V_98 , V_36 -> V_8 , V_36 ) ;
if ( V_39 )
return V_39 ;
V_39 = F_113 ( V_80 , V_36 -> V_8 , V_98 , V_36 ) ;
return V_39 ;
}
...
int F_119 ( struct V_79 * V_80 ,
struct V_7 * V_8 )
{
return F_115 ( V_80 , V_8 , - 1 ) ;
}
int F_120 ( struct V_79 * V_80 ,
struct V_7 * V_8 , int V_124 )
{
return F_115 ( V_80 , V_8 , V_124 ) ;
}
int F_121 ( struct V_79 * V_80 ,
struct V_33 * V_33 )
{
...
struct V_81 * V_85 ;
int V_134 = 0 ;
V_133 = F_130 ( V_131 , struct V_132 , V_131 ) ;
V_32 = V_133 -> V_32 ;
V_98 = F_116 () ;
if ( ! V_98 )
goto V_51;
...
return - V_5 ;
V_133 -> V_32 = V_32 ;
V_133 -> V_131 . V_137 = F_129 ;
V_133 -> V_131 . V_138 = 0 ;
V_133 -> V_124 = V_124 ;
F_134 ( & V_8 -> V_31 -> V_139 , & V_133 -> V_131 ) ;
return 0 ;
}
...
V_152 -> V_154 = * V_149 ;
V_152 -> V_155 = F_144 ( V_80 -> V_155 ) ;
V_152 -> V_53 = 0 ;
V_152 -> V_146 = F_145 ( V_146 ) ;
V_152 -> type = type ;
memcpy ( ( char * ) ( V_152 + 1 ) , V_145 , V_146 ) ;
V_39 = F_76 ( V_80 , V_8 , V_61 ) ;
F_18 ( V_39 ) ;
F_39 ( & V_6 -> V_17 ) ;
V_39 = F_59 ( V_6 , V_61 ) ;
if ( F_146 ( V_39 ) ) {
...
void F_151 ( struct V_33 * V_33 , struct V_49 * V_160 ,
struct V_49 * V_161 )
{
struct V_2 * V_6 ;
struct V_23 * V_54 ;
...
int F_154 ( struct V_163 * V_164 , void * V_165 ,
T_5 V_166 ,
struct V_49 * V_160 )
{
struct V_151 * V_167 ;
...
V_145 = ( char * ) ( V_167 + 1 ) ;
V_146 = F_155 ( V_167 -> V_146 ) ;
V_169 = V_171 [ V_167 -> type ] ;
F_156 ( & V_154 , & V_167 -> V_154 ) ;
...
static void F_157 ( struct V_79 * V_80 ,
struct V_122 * V_22 ,
struct V_33 * V_33 )
{
F_158 ( V_22 , F_159 ( V_33 ) ) ;
F_160 ( V_22 , F_161 ( V_33 ) ) ;
F_162 ( V_22 , F_12 ( V_33 ) -> V_172 ) ;
F_163 ( V_22 , V_33 -> V_173 ) ;
F_164 ( V_22 , V_33 -> V_174 ) ;
F_165 ( V_22 , F_166 ( V_33 ) ) ;
F_167 ( V_22 ,
F_12 ( V_33 ) -> V_175 ) ;
F_168 ( V_22 , V_33 -> V_176 ) ;
F_169 ( V_22 , V_80 -> V_155 ) ;
F_170 ( V_22 , V_33 -> V_177 ) ;
F_171 ( V_22 , F_12 ( V_33 ) -> V_138 ) ;
F_172 ( V_22 , 0 ) ;
F_173 ( F_174 ( V_22 ) ,
V_33 -> V_178 . V_179 ) ;
F_175 ( F_174 ( V_22 ) ,
...
int F_178 ( struct V_33 * V_33 , T_3 * V_183 )
{
struct V_2 * V_6 ;
struct V_122 * V_22 ;
struct V_184 * V_185 ;
...
V_22 = & V_6 -> V_22 ;
F_179 ( V_33 , F_180 ( V_22 ) ) ;
F_181 ( V_33 , F_182 ( V_22 ) ) ;
F_183 ( V_33 , F_184 ( V_22 ) ) ;
V_33 -> V_173 = F_185 ( V_22 ) ;
F_186 ( V_33 , F_187 ( V_22 ) ) ;
F_188 ( V_33 , F_189 ( V_22 ) ) ;
F_12 ( V_33 ) -> V_175 = F_190 ( V_22 ) ;
V_33 -> V_176 = F_191 ( V_22 ) ;
V_33 -> V_177 = 0 ;
* V_183 = F_192 ( V_22 ) ;
F_12 ( V_33 ) -> V_138 = F_193 ( V_22 ) ;
V_185 = F_174 ( V_22 ) ;
V_33 -> V_178 . V_179 = F_194 ( V_185 ) ;
V_33 -> V_178 . V_180 = F_195 ( V_185 ) ;
V_185 = F_176 ( V_22 ) ;
V_33 -> V_181 . V_179 = F_194 ( V_185 ) ;
V_33 -> V_181 . V_180 = F_195 ( V_185 ) ;
V_185 = F_177 ( V_22 ) ;
V_33 -> V_182 . V_179 = F_194 ( V_185 ) ;
V_33 -> V_182 . V_180 = F_195 ( V_185 ) ;
...
F_39 ( & V_6 -> V_17 ) ;
if ( V_6 -> V_13 ) {
F_157 ( V_80 , & V_6 -> V_22 , V_33 ) ;
goto V_153;
}
V_39 = F_82 ( V_80 , V_8 , V_33 ,
V_6 ) ;
if ( V_39 )
goto V_153;
F_157 ( V_80 , & V_6 -> V_22 , V_33 ) ;
