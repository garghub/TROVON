...
V_16 |= ( ( V_111 & V_315 ) << V_313 ) ;
V_16 |= ( ( V_112 & V_315 ) << V_314 ) ;
V_311 = V_26 -> V_308 ;
if ( F_30 ( V_2 , false ) ) {
F_5 ( ( V_28 == 0 ) ? V_316 : V_317 , V_16 ) ;
F_5 ( ( V_28 == 0 ) ? V_295 : V_296 , V_311 ) ;
F_35 ( V_2 ) ;
}
return 0 ;
}
static void F_64 ( struct V_21 * V_22 , T_4 * V_318 ,
T_4 * V_319 , T_4 * V_320 , T_2 V_124 , T_2 V_259 )
{
struct V_26 * V_26 = F_11 ( V_22 ) ;
int V_172 ;
int V_321 = ( V_124 + V_259 > 256 ) ? 256 : V_124 + V_259 ;
for ( V_172 = V_124 ; V_172 < V_321 ; V_172 ++ ) {
V_26 -> V_176 [ V_172 ] = V_318 [ V_172 ] >> 8 ;
V_26 -> V_178 [ V_172 ] = V_319 [ V_172 ] >> 8 ;
V_26 -> V_179 [ V_172 ] = V_320 [ V_172 ] >> 8 ;
}
F_42 ( V_22 ) ;
}
static int F_65 ( struct V_322 * V_323 )
{
int V_5 = 0 ;
struct V_1 * V_2 = V_323 -> V_22 -> V_2 ;
struct V_115 * V_116 = V_2 -> V_117 ;
if ( ! V_116 -> V_324 )
return F_66 ( V_323 ) ;
F_67 ( & V_2 -> V_325 -> V_2 ) ;
...
struct V_23 clock ;
bool V_24 ;
struct V_327 * V_31 = & V_116 -> V_180 . V_28 [ V_28 ] ;
if ( F_30 ( V_2 , false ) ) {
V_186 = F_3 ( V_122 -> V_186 ) ;
if ( ( V_186 & V_328 ) == 0 )
V_326 = F_3 ( V_122 -> V_272 ) ;
else
V_326 = F_3 ( V_122 -> V_274 ) ;
...
V_326 = V_31 -> V_274 ;
V_24 = ( V_28 == 1 ) &&
( V_116 -> V_180 . V_329 . V_330 & V_103 ) ;
}
clock . V_109 = ( V_326 & V_331 ) >> V_332 ;
clock . V_48 = ( V_326 & V_333 ) >> V_334 ;
clock . V_53 = ( V_326 & V_335 ) >> V_336 ;
if ( V_24 ) {
clock . V_60 =
F_71 ( ( V_186 &
V_337 ) >>
...
int V_256 ;
if ( F_30 ( V_2 , false ) ) {
V_344 = F_3 ( V_122 -> V_241 ) ;
V_247 = F_3 ( V_122 -> V_247 ) ;
V_345 = F_3 ( V_122 -> V_250 ) ;
...
V_182 = F_73 ( sizeof( * V_182 ) , V_346 ) ;
if ( ! V_182 )
return NULL ;
V_182 -> clock = F_70 ( V_2 , V_22 ) ;
V_182 -> V_261 = ( V_344 & 0xffff ) + 1 ;
V_182 -> V_241 = ( ( V_344 & 0xffff0000 ) >> 16 ) + 1 ;
V_182 -> V_347 = ( V_247 & 0xffff ) + 1 ;
V_182 -> V_348 = ( ( V_247 & 0xffff0000 ) >> 16 ) + 1 ;
V_182 -> V_260 = ( V_345 & 0xffff ) + 1 ;
V_182 -> V_250 = ( ( V_345 & 0xffff0000 ) >> 16 ) + 1 ;
V_182 -> V_349 = ( V_256 & 0xffff ) + 1 ;
V_182 -> V_350 = ( ( V_256 & 0xffff0000 ) >> 16 ) + 1 ;
F_74 ( V_182 ) ;
F_75 ( V_182 , 0 ) ;
return V_182 ;
}
