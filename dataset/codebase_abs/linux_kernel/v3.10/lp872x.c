...
V_44 = V_65 -> V_44 ;
if ( ! F_18 ( V_44 ) ) {
F_3 ( V_2 -> V_8 , L_2 , V_44 ) ;
return - V_24 ;
}
V_86 = V_65 -> V_91 ;
V_5 = F_25 ( V_2 -> V_8 , V_44 , V_86 , L_3 ) ;
if ( V_5 ) {
F_3 ( V_2 -> V_8 , L_4 , V_5 ) ;
return V_5 ;
}
...
& V_107 [ V_70 ] ;
V_105 . V_8 = V_2 -> V_8 ;
V_105 . V_101 = F_27 ( V_103 -> V_98 , V_2 ) ;
V_105 . V_108 = V_2 ;
V_105 . V_7 = V_2 -> V_7 ;
V_27 = F_29 ( V_103 , & V_105 ) ;
if ( F_30 ( V_27 ) ) {
F_3 ( V_2 -> V_8 , L_5 ) ;
V_5 = F_31 ( V_27 ) ;
goto V_109;
...
static int F_34 ( struct V_111 * V_112 , const struct V_113 * V_98 )
{
struct V_1 * V_2 ;
int V_5 , V_15 , V_99 ;
const int V_114 [] = {
...
V_2 = F_35 ( & V_112 -> V_8 , sizeof( struct V_1 ) , V_117 ) ;
if ( ! V_2 )
goto V_118;
V_99 = V_114 [ V_98 -> V_108 ] ;
V_15 = sizeof( struct V_26 * ) * V_99 ;
V_2 -> V_110 = F_35 ( & V_112 -> V_8 , V_15 , V_117 ) ;
if ( ! V_2 -> V_110 )
goto V_118;
V_2 -> V_7 = F_36 ( V_112 , & V_119 ) ;
if ( F_30 ( V_2 -> V_7 ) ) {
V_5 = F_31 ( V_2 -> V_7 ) ;
F_3 ( & V_112 -> V_8 , L_6 , V_5 ) ;
goto V_120;
}
V_2 -> V_8 = & V_112 -> V_8 ;
V_2 -> V_66 = V_112 -> V_8 . V_121 ;
V_2 -> V_12 = V_98 -> V_108 ;
V_2 -> V_99 = V_99 ;
F_37 ( V_112 , V_2 ) ;
V_5 = F_26 ( V_2 ) ;
