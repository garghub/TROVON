...
if ( V_9 & V_57 )
return F_4 ( V_8 , V_9 , type , V_58 [ V_46 ] ) ;
if ( ! V_58 [ V_46 ] )
return - 1 ;
if ( V_9 == V_59 || V_9 == V_60 ) {
V_48 = F_9 ( & V_8 -> V_51 ,
V_14 , type , 0 , F_10 ( V_58 [ V_46 ] ) ) ;
} else if ( V_9 == V_61 ) {
struct V_62 V_63 ;
struct V_11 V_64 = {
. type = L_3 ,
...
V_63 . V_65 = V_8 -> V_65 ;
V_48 = F_11 ( & V_8 -> V_51 , V_14 ,
& V_64 , NULL ) ;
} else {
V_48 = F_9 ( & V_8 -> V_51 ,
V_14 , type , V_58 [ V_46 ] , NULL ) ;
}
if ( V_48 )
V_48 -> V_54 = 1 << V_46 ;
return V_48 ? 0 : - 1 ;
}
struct V_47 * F_12 ( struct V_7 * V_8 , T_1 V_9 )
{
...
static void F_16 ( struct V_7 * V_8 , int V_68 )
{
F_17 ( ~ V_68 , V_69 ) ;
}
static void F_18 ( struct V_7 * V_8 , int V_68 )
{
F_17 ( ~ V_68 & 1 , V_70 ) ;
}
...
static int F_23 ( struct V_7 * V_8 , int V_74 )
{
int V_73 ;
F_22 ( V_8 ) ;
...
static int F_28 ( struct V_7 * V_8 , unsigned char V_77 )
{
int V_73 , V_78 ;
F_26 ( L_8 , V_77 ) ;
...
static int F_29 ( struct V_7 * V_8 , unsigned char * V_77 , int V_79 )
{
int V_73 ;
* V_77 = 0 ;
F_18 ( V_8 , 1 ) ;
...
static int F_32 ( struct V_7 * V_8 , unsigned char V_10 , unsigned char * V_81 , T_1 V_82 , int V_83 )
{
int V_84 , V_75 = - V_76 ;
T_1 V_73 ;
...
V_75 = F_30 ( V_8 ) ;
if ( V_75 == 0 ) {
V_75 = F_28 ( V_8 , V_10 << 1 ) ;
for ( V_73 = 0 ; V_75 == 0 && V_73 < V_82 ; ++ V_73 )
V_75 = F_28 ( V_8 , V_81 [ V_73 ] ) ;
}
if ( V_75 != 0 || V_83 ) {
F_31 ( V_8 ) ;
}
...
static int F_33 ( struct V_7 * V_8 , unsigned char V_10 , unsigned char * V_81 , T_1 V_82 )
{
int V_84 , V_75 = - V_76 ;
T_1 V_73 ;
for ( V_84 = 0 ; V_75 != 0 && V_84 < 8 ; ++ V_84 ) {
V_75 = F_30 ( V_8 ) ;
if ( V_75 == 0 )
V_75 = F_28 ( V_8 , ( V_10 << 1 ) | 1 ) ;
for ( V_73 = 0 ; V_75 == 0 && V_73 < V_82 ; ++ V_73 ) {
V_75 = F_29 ( V_8 , & V_81 [ V_73 ] , V_73 == V_82 - 1 ) ;
}
F_31 ( V_8 ) ;
}
if ( V_75 )
...
static int F_34 ( struct V_13 * V_15 , struct V_85 * V_86 , int V_87 )
{
struct V_88 * V_51 = F_35 ( V_15 ) ;
struct V_7 * V_8 = F_36 ( V_51 ) ;
int V_89 ;
int V_73 ;
F_37 ( & V_8 -> V_90 ) ;
for ( V_73 = V_89 = 0 ; V_89 == 0 && V_73 < V_87 ; V_73 ++ ) {
if ( V_86 [ V_73 ] . V_91 & V_92 )
V_89 = F_33 ( V_8 , V_86 [ V_73 ] . V_10 , V_86 [ V_73 ] . V_93 , V_86 [ V_73 ] . V_82 ) ;
else {
int V_94 = ! ( V_73 + 1 < V_87 && V_86 [ V_73 + 1 ] . V_91 == V_92 ) ;
V_89 = F_32 ( V_8 , V_86 [ V_73 ] . V_10 , V_86 [ V_73 ] . V_93 , V_86 [ V_73 ] . V_82 , V_94 ) ;
}
}
F_38 ( & V_8 -> V_90 ) ;
return V_89 ? V_89 : V_87 ;
}
static T_1 F_39 ( struct V_13 * V_14 )
{
return V_95 | V_96 ;
}
static void F_40 ( void * V_81 , int V_68 )
{
...
V_8 -> V_103 . V_105 = V_8 -> V_99 . V_106 / 2 ;
V_8 -> V_103 . V_81 = V_8 ;
V_8 -> V_15 . V_107 = & V_8 -> V_103 ;
sprintf ( V_8 -> V_15 . V_31 + strlen ( V_8 -> V_15 . V_31 ) , L_25 ,
V_8 -> V_108 ) ;
F_47 ( & V_8 -> V_15 , & V_8 -> V_51 ) ;
V_8 -> V_45 = V_109 ;
V_8 -> V_45 . V_110 = & V_8 -> V_15 ;
V_8 -> V_15 . V_111 . V_112 = & V_8 -> V_113 -> V_111 ;
F_27 ( L_26 ) ;
F_16 ( V_8 , 1 ) ;
F_18 ( V_8 , 1 ) ;
if ( V_8 -> V_99 . V_100 > 0 )
