...
{
struct V_24 * V_25 = ( void * ) ( V_9 + 1 ) ;
int V_26 = F_3 ( V_23 ) ;
T_1 V_27 ;
if ( F_14 ( V_9 , V_23 ) || V_9 -> V_28 & ( 1 << V_23 ) )
if ( V_25 -> V_29 == V_5 )
...
V_27 |= 0x0100 ;
F_6 ( V_26 , 0x04 , V_27 ) ;
F_6 ( V_26 , 0x05 , F_14 ( V_9 , V_23 ) ? 0x8000 : 0x0000 ) ;
V_27 = ( V_23 & 0xf ) << 12 ;
if ( F_14 ( V_9 , V_23 ) )
V_27 |= V_9 -> V_30 ;
else
...
static int
F_19 ( struct V_8 * V_9 , int V_33 , int V_34 )
{
int V_26 = F_18 ( V_33 ) ;
return F_20 ( V_9 , V_26 , V_34 ) ;
}
static int
F_21 ( struct V_8 * V_9 ,
...
{
int V_26 = F_18 ( V_33 ) ;
return F_22 ( V_9 , V_26 , V_34 , V_27 ) ;
}
static void
F_23 ( struct V_8 * V_9 , int V_33 , T_2 * V_35 )
{
F_24 ( V_9 , F_25 ( V_36 ) ,
V_36 , V_33 , V_35 ) ;
}
