...
if ( V_116 -> V_118 == 24 )
V_116 -> V_118 = 32 ;
V_110 . V_40 = V_116 -> V_119 ;
V_110 . V_41 = V_116 -> V_120 ;
V_110 . V_59 [ 0 ] = V_110 . V_40 * ( ( V_116 -> V_118 + 7 ) / 8 ) ;
V_110 . V_121 = F_49 ( V_116 -> V_118 ,
V_116 -> V_122 ) ;
...
V_10 -> V_114 . V_125 = V_2 ;
strcpy ( V_2 -> V_29 . V_126 , L_6 ) ;
V_2 -> V_127 = V_10 -> V_14 . V_51 -> V_52 ;
V_2 -> V_29 . V_71 = V_66 ;
V_2 -> V_29 . V_30 = ( unsigned long ) V_10 -> V_14 . V_51 -> V_52 ;
V_2 -> V_49 = V_128 | V_129 ;
V_2 -> V_91 = & V_130 ;
F_53 ( V_2 , V_37 -> V_59 [ 0 ] , V_37 -> V_131 ) ;
F_54 ( V_2 , & V_10 -> V_114 , V_116 -> V_132 , V_116 -> V_133 ) ;
V_43 = F_55 ( & V_2 -> V_134 , 256 , 0 ) ;
if ( V_43 ) {
V_43 = - V_53 ;
goto V_124;
}
...
int V_43 ;
T_3 V_66 ;
V_51 = F_74 ( V_13 , V_101 , V_110 -> V_140 [ 0 ] ) ;
if ( V_51 == NULL )
return F_75 ( - V_141 ) ;
V_66 = V_110 -> V_59 [ 0 ] * V_110 -> V_41 ;
V_66 = F_50 ( V_66 , V_33 ) ;
