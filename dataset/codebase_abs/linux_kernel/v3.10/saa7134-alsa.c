...
static T_1 F_14 ( int V_20 , void * V_21 )
{
...
static int F_17 ( struct V_31 * V_16 ,
int V_32 )
{
...
static int F_31 ( struct V_31 * V_16 )
{
struct V_33 * V_34 = V_16 -> V_34 ;
int V_83 , V_84 ;
T_4 V_85 , V_86 ;
...
F_36 ( V_90 , ( ( V_2 -> V_3 . V_13 - 1 ) & 0x0000ff ) ) ;
F_36 ( V_91 , ( ( V_2 -> V_3 . V_13 - 1 ) & 0x00ff00 ) >> 8 ) ;
F_36 ( V_92 , ( ( V_2 -> V_3 . V_13 - 1 ) & 0xff0000 ) >> 16 ) ;
F_36 ( V_68 , V_85 ) ;
break;
case V_73 :
case V_74 :
...
if ( ! V_84 )
V_85 |= 0x04 ;
F_11 ( V_93 , V_2 -> V_3 . V_13 - 1 ) ;
F_11 ( V_94 , 0x543210 | ( V_85 << 24 ) ) ;
break;
}
F_6 ( L_10 ,
...
F_24 ( V_87 -> V_80 [ V_2 -> V_3 . V_63 ] , 1 , 1 ,
true ) ;
return 0 ;
}
static T_5
F_39 ( struct V_31 * V_16 )
{
struct V_33 * V_34 = V_16 -> V_34 ;
T_2 * V_35 = V_34 -> V_36 ;
struct V_1 * V_2 = V_35 -> V_2 ;
...
V_2 -> V_3 . V_99 += F_12 ( V_16 ) ;
if ( V_2 -> V_3 . V_99 == V_2 -> V_3 . V_15 )
V_2 -> V_3 . V_99 = 0 ;
}
return F_40 ( V_34 , V_2 -> V_3 . V_99 ) ;
}
...
return 0 ;
if ( V_16 -> V_34 -> V_104 ) {
F_46 ( V_2 -> V_64 , & V_2 -> V_3 . V_97 ) ;
F_47 ( & V_2 -> V_64 -> V_2 , & V_2 -> V_3 . V_41 ) ;
F_22 ( V_2 ) ;
...
if ( 0 != ( V_37 = F_48 ( & V_2 -> V_64 -> V_2 , & V_2 -> V_3 . V_41 ) ) ) {
F_22 ( V_2 ) ;
return V_37 ;
}
if ( 0 != ( V_37 = F_49 ( V_2 -> V_64 , & V_2 -> V_3 . V_97 ) ) ) {
F_47 ( & V_2 -> V_64 -> V_2 , & V_2 -> V_3 . V_41 ) ;
F_22 ( V_2 ) ;
return V_37 ;
}
if ( 0 != ( V_37 = F_50 ( V_2 -> V_64 , & V_2 -> V_3 . V_97 ,
V_2 -> V_3 . V_41 . V_105 ,
V_2 -> V_3 . V_41 . V_106 ,
0 ) ) ) {
F_46 ( V_2 -> V_64 , & V_2 -> V_3 . V_97 ) ;
...
static int F_51 ( struct V_31 * V_16 )
{
T_3 * V_87 = F_32 ( V_16 ) ;
struct V_1 * V_2 ;
V_2 = V_87 -> V_2 ;
...
static int F_52 ( struct V_31 * V_16 )
{
T_3 * V_87 = F_32 ( V_16 ) ;
...
static struct V_122 * F_62 ( struct V_31 * V_16 ,
unsigned long V_123 )
{
void * V_124 = V_16 -> V_34 -> V_104 + V_123 ;
return F_63 ( V_124 ) ;
}
static int F_64 ( T_3 * V_87 , int V_65 )
{
struct V_125 * V_35 ;
int V_37 ;
if ( ( V_37 = F_65 ( V_87 -> V_78 , L_13 , V_65 , 0 , 1 , & V_35 ) ) < 0 )
return V_37 ;
F_66 ( V_35 , V_126 , & V_127 ) ;
V_35 -> V_36 = V_87 ;
V_35 -> V_128 = 0 ;
...
return F_24 ( V_46 , V_47 , V_48 , false ) ;
}
static int F_73 ( T_3 * V_50 )
{
...
for ( V_142 = 0 ; V_142 < F_74 ( V_144 ) ; V_142 ++ ) {
V_46 = F_75 ( & V_144 [ V_142 ] ,
V_50 ) ;
V_37 = F_76 ( V_78 , V_46 ) ;
if ( V_37 < 0 )
return V_37 ;
}
for ( V_142 = 0 ; V_142 < F_74 ( V_145 ) ; V_142 ++ ) {
V_46 = F_75 ( & V_145 [ V_142 ] ,
V_50 ) ;
...
static void F_77 ( struct V_141 * V_78 )
{
T_3 * V_50 = V_78 -> V_36 ;
if ( V_50 -> V_2 -> V_3 . V_23 == NULL )
return;
if ( V_50 -> V_20 >= 0 )
F_78 ( V_50 -> V_20 , & V_50 -> V_2 -> V_3 ) ;
V_50 -> V_2 -> V_3 . V_23 = NULL ;
}
static int F_79 ( struct V_1 * V_2 , int V_146 )
{
struct V_141 * V_78 ;
T_3 * V_50 ;
int V_37 ;
...
if ( ! V_148 [ V_146 ] )
return - V_114 ;
V_37 = F_80 ( V_149 [ V_146 ] , V_81 [ V_146 ] , V_150 ,
sizeof( T_3 ) , & V_78 ) ;
if ( V_37 < 0 )
return V_37 ;
...
V_50 -> V_78 = V_78 ;
V_50 -> V_64 = V_2 -> V_64 ;
V_50 -> V_152 = F_81 ( V_2 -> V_64 , 0 ) ;
V_37 = F_82 ( V_2 -> V_64 -> V_20 , F_14 ,
...
if ( ( V_37 = F_73 ( V_50 ) ) < 0 )
goto V_155;
if ( ( V_37 = F_64 ( V_50 , 0 ) ) < 0 )
goto V_155;
F_84 ( V_78 , & V_50 -> V_64 -> V_2 ) ;
strcpy ( V_78 -> V_156 , L_15 ) ;
sprintf ( V_78 -> V_157 , L_17 ,
V_50 -> V_2 -> V_129 , V_50 -> V_152 , V_50 -> V_20 ) ;
F_55 ( V_158 L_18 , V_2 -> V_129 , V_78 -> V_157 , V_149 [ V_146 ] ) ;
if ( ( V_37 = F_85 ( V_78 ) ) == 0 ) {
V_159 [ V_146 ] = V_78 ;
return 0 ;
}
...
V_164 = F_88 ;
F_55 ( V_158 L_19 ) ;
F_90 (list,&saa7134_devlist) {
V_2 = F_91 ( V_162 , struct V_1 , V_165 ) ;
