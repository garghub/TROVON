...
int F_37 ( struct V_99 * V_100 , T_1 V_117 )
{
...
static int F_46 ( struct V_125 * V_90 )
{
struct V_126 * V_126 ;
if ( F_47 ( V_127 ) ) {
V_126 = F_48 ( & V_90 -> V_91 , L_15 ) ;
if ( F_42 ( V_126 ) ) {
F_8 ( L_16 ) ;
return F_43 ( V_126 ) ;
}
...
static struct V_99 * F_49 ( struct V_125 * V_90 )
{
struct V_129 * V_130 = V_90 -> V_91 . V_131 ;
const char * V_132 = F_50 () ;
struct V_99 * V_133 ;
int V_134 ;
V_133 = NULL ;
for ( V_134 = 0 ; V_134 < V_130 -> V_135 ; ++ V_134 ) {
struct V_99 * V_100 = V_130 -> V_136 [ V_134 ] ;
if ( V_100 -> type != V_137 )
continue;
if ( V_133 == NULL )
V_133 = V_100 ;
if ( V_132 != NULL &&
strcmp ( V_100 -> V_138 , V_132 ) == 0 ) {
V_133 = V_100 ;
break;
}
}
...
static int F_51 ( struct V_125 * V_139 )
{
struct V_99 * V_140 ;
struct V_99 * V_100 ;
int V_89 ;
...
if ( ! V_140 )
return 0 ;
V_100 = F_52 ( & V_139 -> V_91 ) ;
if ( ! V_100 )
return - V_141 ;
F_53 ( V_100 , V_140 ) ;
V_89 = F_40 ( V_100 ) ;
if ( V_89 ) {
F_8 ( L_17 , V_100 -> V_138 , V_89 ) ;
F_54 ( V_100 ) ;
return V_89 ;
}
V_89 = F_55 ( & V_3 . V_103 , V_100 ) ;
if ( V_89 ) {
F_8 ( L_18 ,
V_100 -> V_138 ) ;
F_54 ( V_100 ) ;
...
static void F_58 ( struct V_125 * V_90 )
{
...
static void T_2 F_60 ( struct V_125 * V_90 )
{
struct V_112 * V_113 = & V_3 . V_103 ;
F_61 ( V_113 ) ;
}
static int F_62 ( struct V_125 * V_90 )
{
T_3 V_146 ;
struct V_147 * V_148 ;
int V_89 ;
...
F_63 ( & V_3 . V_114 ) ;
V_3 . V_30 = 0 ;
V_148 = F_64 ( V_3 . V_90 , V_149 , 0 ) ;
if ( ! V_148 ) {
F_8 ( L_21 ) ;
return - V_116 ;
}
V_3 . V_4 = F_65 ( & V_90 -> V_91 , V_148 -> V_150 ,
F_66 ( V_148 ) ) ;
if ( ! V_3 . V_4 ) {
F_8 ( L_22 ) ;
return - V_141 ;
...
if ( V_89 )
goto V_151;
V_146 = ( T_3 ) ( F_3 ( V_152 ) & 0xff ) ;
F_68 ( & V_90 -> V_91 , L_23 , V_146 ) ;
F_14 () ;
V_89 = F_69 () ;
if ( V_89 )
goto V_153;
...
static int T_2 F_73 ( struct V_125 * V_90 )
{
F_74 ( & V_90 -> V_91 ) ;
if ( V_3 . V_109 != NULL ) {
F_75 ( V_3 . V_109 ) ;
...
static int F_76 ( struct V_154 * V_91 )
{
if ( V_3 . V_128 )
F_77 ( V_3 . V_128 ) ;
F_78 () ;
...
static int F_79 ( struct V_154 * V_91 )
{
int V_89 ;
V_89 = F_80 () ;
if ( V_89 < 0 )
