...
static int T_5 F_28 ( struct V_41 * V_42 )
{
struct V_61 * V_62 ;
...
static void T_3 F_35 ( struct V_85 * V_86 , void T_6 * V_66 )
{
struct V_87 * V_88 , * V_89 ;
V_89 = V_86 ? F_36 ( V_86 , L_4 ) :
F_37 ( NULL , L_4 ) ;
if ( F_38 ( V_89 ) )
F_6 ( L_5 , V_90 ) ;
V_30 = F_39 ( V_89 ) ;
V_88 = V_86 ? F_36 ( V_86 , L_6 ) : F_37 ( NULL , L_6 ) ;
if ( F_38 ( V_88 ) )
F_6 ( L_7 , V_90 ) ;
F_40 ( V_88 ) ;
V_6 = V_66 ;
...
void T_3 F_45 ( void T_6 * V_66 , int V_94 , int V_95 , int V_96 )
{
V_58 [ V_59 ] = V_94 ;
V_58 [ V_82 ] = V_95 ;
V_58 [ V_84 ] = V_96 ;
...
static void T_3 F_46 ( struct V_85 * V_86 , unsigned int V_97 )
{
T_1 V_98 , V_5 ;
V_79 = V_97 ;
V_58 [ V_59 ] = F_47 ( V_86 , V_59 ) ;
#ifdef F_48
V_98 = F_49 ( V_86 ) ;
#else
V_98 = 0 ;
#endif
for ( V_5 = V_82 ; V_5 < V_98 ; V_5 ++ )
V_58 [ V_5 ] = F_47 ( V_86 , V_5 ) ;
F_35 ( V_86 , F_50 ( V_86 , 0 ) ) ;
F_10 () ;
F_17 () ;
}
static void T_3 F_51 ( struct V_85 * V_86 )
{
return F_46 ( V_86 , V_80 ) ;
}
static void T_3 F_52 ( struct V_85 * V_86 )
{
return F_46 ( V_86 , V_91 ) ;
}
