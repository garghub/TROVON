...
F_8 ( V_179 L_97 , V_7 -> V_157 ) ;
if ( V_7 -> V_37 == V_180 ) {
V_7 -> V_37 = V_38 ;
F_106 ( V_7 ) ;
} else if ( V_7 -> V_37 == V_181 ) {
V_7 -> V_37 = V_38 ;
F_106 ( V_7 ) ;
V_160 = V_7 -> V_37 ;
V_7 -> V_37 = V_38 ;
...
V_7 -> V_103 |= V_184 | V_185 ;
V_7 -> V_147 -> V_186 = F_62 ;
#ifdef F_117
V_7 -> V_147 -> V_187 = F_66 ;
#endif
if ( V_7 -> V_78 != V_80 ) {
F_8 ( V_179 L_99 , V_7 -> V_78 ) ;
V_7 -> V_103 |= V_188 ;
} else
F_8 ( V_179 L_100 ) ;
} else
...
static int F_136 ( struct V_198 * V_166 , int V_199 , int V_200 ,
const struct V_201 * V_202 )
{
short V_203 [ 6 ] = { 0x2A0 , 0x2C0 , 0x220 , 0x240 , 0x1E0 } ;
T_6 V_204 ;
T_6 V_205 , V_206 ;
T_4 V_207 , type ;
int V_37 ;
...
if ( F_76 ( V_203 [ V_60 ] , 32 , L_112 ) ) {
int V_208 ;
F_137 ( V_166 , 0x60 ,
0xe5000000 | V_203 [ V_60 ] ) ;
F_137 ( V_166 , 0x78 ,
0x00000000 | V_203 [ V_60 ] ) ;
V_208 = F_2 ( V_203 [ V_60 ] ) ;
if ( V_208 != 0xff )
break;
F_77 ( V_203 [ V_60 ] , 32 ) ;
}
...
F_138 ( V_166 , 0x3c , & V_207 ) ;
F_139 ( V_166 , 0x1c , & V_205 ) ;
V_205 &= 0x0000ff00 ;
F_139 ( V_166 , 0x20 , & V_206 ) ;
V_206 &= 0x0000ff00 ;
F_137 ( V_166 , 0x6c , 0xe3000000 | V_205 ) ;
F_137 ( V_166 , 0x70 , 0xe3000000 | V_206 ) ;
F_137 ( V_166 , 0x80 , ( V_206 << 16 ) | V_205 ) ;
F_137 ( V_166 , 0x9c ,
V_204 | ( V_207 * 0x11111 ) ) ;
F_4 ( V_6 L_122 , V_207 ) ;
F_4 ( V_6 L_123 ,
...
static int F_140 ( struct V_198 * V_166 , int V_199 , int V_200 ,
const struct V_201 * V_202 )
{
...
F_138 ( V_166 , V_202 -> V_223 , & V_209 ) ;
V_209 |= V_202 -> V_224 ;
F_141 ( V_166 , V_202 -> V_223 , V_209 ) ;
F_5 ( V_202 -> V_225 , V_226 ) ;
V_209 = F_2 ( V_227 ) ;
F_5 ( V_202 -> V_228 , V_226 ) ;
V_210 = F_2 ( V_227 ) ;
if ( V_211 == V_222 ) {
V_211 = V_209 & V_229 ;
V_212 = V_210 ;
...
F_5 ( V_202 -> V_230 , V_226 ) ;
V_213 = F_2 ( V_227 ) << 2 ;
F_8 ( V_6 L_135 ,
V_213 ) ;
if ( V_213 == 0x3BC && V_215 ) {
F_5 ( V_202 -> V_230 , V_226 ) ;
F_5 ( ( 0x378 >> 2 ) , V_227 ) ;
F_8 ( V_6
L_136 ) ;
...
F_138 ( V_166 , V_202 -> V_231 , & V_209 ) ;
V_37 = ( ( V_209 & V_232 ) >> 4 ) ;
if ( V_211 == V_220 ) {
F_138 ( V_166 , V_202 -> V_233 , & V_209 ) ;
V_78 = ( ( V_209 & V_234 ) >> 2 ) ;
} else
V_78 = V_80 ;
if ( V_199 == V_38 ) {
...
if ( F_109 ( V_213 , V_214 , V_37 , V_78 , & V_166 -> V_30 , 0 ) ) {
F_8 ( V_15
L_139 , V_213 ) ;
if ( V_37 != V_38 )
F_8 ( L_126 , V_37 ) ;
...
static int F_142 ( struct V_198 * V_30 ,
const struct V_235 * V_117 )
{
int V_236 , V_76 , V_65 , V_60 = V_117 -> V_237 ;
struct V_238 * V_239 ;
if ( V_60 < V_240 )
return 0 ;
V_60 -= V_240 ;
...
if ( V_236 )
return V_236 ;
V_239 = F_113 ( sizeof( struct V_238 ) , V_169 ) ;
if ( ! V_239 )
return - V_241 ;
if ( V_242 [ V_60 ] . V_243 &&
V_242 [ V_60 ] . V_243 ( V_30 , V_38 , V_80 ) ) {
F_128 ( V_239 ) ;
return - V_244 ;
}
for ( V_65 = 0 ; V_65 < V_242 [ V_60 ] . V_245 ; V_65 ++ ) {
int V_246 = V_242 [ V_60 ] . V_247 [ V_65 ] . V_246 ;
int V_248 = V_242 [ V_60 ] . V_247 [ V_65 ] . V_248 ;
int V_37 ;
unsigned long V_249 , V_250 ;
V_249 = F_144 ( V_30 , V_246 ) ;
V_250 = 0 ;
if ( ( V_248 >= 0 ) && ( V_248 <= 6 ) )
V_250 = F_144 ( V_30 , V_248 ) ;
else if ( V_248 > 6 )
V_249 += V_248 ;
V_37 = V_30 -> V_37 ;
if ( V_37 == V_251 ) {
F_8 ( V_6
L_142 ,
V_252 [ V_60 + V_240 ] . V_253 ,
V_252 [ V_60 + V_240 ] . V_67 ,
V_249 , V_250 ) ;
V_37 = V_38 ;
} else {
F_8 ( V_6
...
static void F_146 ( struct V_198 * V_30 )
{
struct V_238 * V_239 = F_147 ( V_30 ) ;
int V_60 ;
F_145 ( V_30 , NULL ) ;
if ( V_239 ) {
for ( V_60 = V_239 -> V_256 - 1 ; V_60 >= 0 ; V_60 -- )
F_130 ( V_239 -> V_254 [ V_60 ] ) ;
F_128 ( V_239 ) ;
}
}
static int T_7 F_148 ( int V_199 , int V_200 )
{
const struct V_235 * V_117 ;
struct V_198 * V_166 = NULL ;
int V_53 = 0 ;
F_149 (pdev) {
V_117 = F_150 ( V_252 , V_166 ) ;
if ( V_117 == NULL || V_117 -> V_237 >= V_240 )
continue;
if ( V_258 [ V_117 -> V_237 ] . F_151 (
V_166 , V_199 , V_200 ,
V_258 [ V_117 -> V_237 ] . V_202 ) ) {
V_53 ++ ;
}
}
return V_53 ;
...
static int F_152 ( struct V_259 * V_30 ,
const struct V_260 * V_117 )
{
struct V_1 * V_261 ;
unsigned long V_249 , V_250 ;
int V_78 , V_37 ;
...
V_78 = V_80 ;
F_162 ( & V_30 -> V_30 , L_144 , V_30 -> V_264 -> V_48 ) ;
V_261 = F_109 ( V_249 , V_250 , V_37 , V_78 , & V_30 -> V_30 , 0 ) ;
if ( V_261 == NULL )
return - V_244 ;
F_163 ( V_30 , V_261 ) ;
return 0 ;
}
static void F_164 ( struct V_259 * V_30 )
{
struct V_1 * V_261 = (struct V_1 * ) F_165 ( V_30 ) ;
if ( ! V_261 )
return;
F_130 ( V_261 ) ;
}
static int F_166 ( struct V_165 * V_166 )
{
return 0 ;
}
static void T_7 F_167 ( int V_199 , int V_200 )
{
int V_76 = 0 , V_236 ;
#ifdef F_168
F_82 () ;
...
static int T_7 F_172 ( const char * V_32 , int * V_269 ,
int V_270 , int V_271 , int V_272 )
{
if ( ! V_32 )
return 0 ;
...
* V_269 = V_271 ;
else if ( V_272 && ! strncmp ( V_32 , L_147 , 6 ) )
* V_269 = V_272 ;
else {
char * V_273 ;
unsigned long V_28 = F_173 ( V_32 , & V_273 , 0 ) ;
if ( V_273 != V_32 )
* V_269 = V_28 ;
else {
F_8 ( V_274 L_148 , V_32 ) ;
return - 1 ;
}
}
return 0 ;
}
static int T_7 F_174 ( const char * V_275 , int * V_269 )
{
return F_172 ( V_275 , V_269 , V_180 ,
V_38 , 0 ) ;
}
static int T_7 F_175 ( const char * V_276 , int * V_269 )
{
return F_172 ( V_276 , V_269 , V_182 ,
V_80 , V_183 ) ;
}
static int T_7 F_176 ( char * V_277 )
{
F_8 ( V_6
L_149 , V_277 ) ;
if ( ! strcmp ( V_277 , L_150 ) )
V_216 = 1 ;
if ( ! strcmp ( V_277 , L_151 ) )
V_216 = 2 ;
if ( ! strcmp ( V_277 , L_152 ) )
V_216 = 3 ;
if ( ! strcmp ( V_277 , L_153 ) )
V_216 = 4 ;
if ( ! strcmp ( V_277 , L_154 ) )
V_216 = 5 ;
return 1 ;
}
...
F_176 ( V_278 ) ;
#endif
for ( V_60 = 0 ; V_60 < V_279 && V_95 [ V_60 ] ; V_60 ++ ) {
if ( F_174 ( V_37 [ V_60 ] , & V_269 ) )
return 1 ;
V_280 [ V_60 ] = V_269 ;
if ( F_175 ( V_78 [ V_60 ] , & V_269 ) )
return 1 ;
V_281 [ V_60 ] = V_269 ;
}
if ( ! V_95 [ 0 ] ) {
if ( V_37 [ 0 ] && ! F_174 ( V_37 [ 0 ] , & V_269 ) )
switch ( V_269 ) {
case V_38 :
case V_180 :
V_280 [ 0 ] = V_269 ;
...
static int T_7 F_179 ( char * V_277 )
{
char * V_282 ;
char * V_283 ;
int V_269 ;
if ( ! V_277 || ! * V_277 || ( * V_277 == '0' && ! * ( V_277 + 1 ) ) ) {
V_95 [ 0 ] = V_284 ;
return 1 ;
}
if ( ! strncmp ( V_277 , L_145 , 4 ) ) {
V_280 [ 0 ] = V_180 ;
V_281 [ 0 ] = V_182 ;
return 1 ;
}
V_269 = F_173 ( V_277 , & V_282 , 0 ) ;
if ( V_282 == V_277 ) {
F_8 ( V_144 L_159 , V_277 ) ;
return 1 ;
}
if ( V_285 == V_279 ) {
F_8 ( V_274 L_160 , V_277 ) ;
return 1 ;
}
V_95 [ V_285 ] = V_269 ;
V_280 [ V_285 ] = V_38 ;
...
V_283 = strchr ( V_277 , ',' ) ;
if ( V_283 ++ ) {
if ( F_174 ( V_283 , & V_269 ) )
return 1 ;
V_280 [ V_285 ] = V_269 ;
V_283 = strchr ( V_283 , ',' ) ;
if ( V_283 ++ ) {
if ( F_175 ( V_283 , & V_269 ) )
return 1 ;
V_281 [ V_285 ] = V_269 ;
}
}
...
int V_60 ;
V_133 = 1 ;
for ( V_60 = 0 ; V_60 < V_279 ; V_60 ++ ) {
if ( ! V_95 [ V_60 ] )
break;
if ( V_250 [ V_60 ] == V_287 )
V_250 [ V_60 ] = 0x400 + V_95 [ V_60 ] ;
F_109 ( V_95 [ V_60 ] , V_250 [ V_60 ] ,
V_280 [ V_60 ] , V_281 [ V_60 ] , NULL , 0 ) ;
}
} else
F_167 ( V_280 [ 0 ] , V_281 [ 0 ] ) ;
return 0 ;
}
...
struct V_10 * V_11 ;
struct V_1 * V_36 ;
V_11 = F_187 ( V_197 . V_288 ,
struct V_10 , V_175 ) ;
V_36 = V_11 -> V_36 ;
if ( V_36 -> V_30 && V_36 -> V_30 -> V_289 == & V_290 )
F_129 (
F_188 ( V_36 -> V_30 ) ) ;
F_130 ( V_36 ) ;
}
