...
V_14 = F_3 ( V_6 -> V_39 -> V_42 , V_3 -> V_32 -> V_33 ,
& ( V_6 -> V_24 ) ) ;
if ( ! V_14 )
return NULL ;
* V_4 += V_6 -> V_24 - V_6 -> V_23 ;
...
V_43 = ( sizeof( struct V_1 ) +
V_7 -> V_44 +
F_12 ( V_7 -> V_45 ) + 3 ) & ~ 3 ;
* V_4 += V_43 - ( V_6 -> V_24 - V_6 -> V_23 ) ;
V_6 -> V_24 = V_6 -> V_23 + V_43 ;
} else {
memcpy ( ( V_34 * ) V_7 , ( V_34 * ) V_14 ,
sizeof( struct V_1 ) ) ;
}
...
struct V_1 * F_3 ( void * V_46 , int V_47 , int * V_13 )
{
struct V_1 * V_14 ;
int V_48 ;
V_34 * V_49 ;
...
if ( ( * V_13 > 0 ) && ( * V_13 < V_47 ) )
V_49 += * V_13 ;
V_14 = (struct V_1 * ) V_49 ;
if ( V_14 -> V_51 . V_52 != F_14 ( V_53 ) ) {
F_13 ( L_2 ,
F_12 ( V_14 -> V_51 . V_52 ) ) ;
F_13 ( L_3 ,
...
if ( ( * V_13 + sizeof( struct V_1 ) ) > V_47 )
V_48 = sizeof( struct V_1 ) ;
else
V_48 = sizeof( struct V_1 ) +
V_14 -> V_44 + F_12 ( V_14 -> V_45 ) ;
V_50 = V_48 % V_54 ;
if ( V_50 )
V_48 += ( V_54 - V_50 ) ;
* V_13 = * V_13 + V_48 ;
...
struct V_55 * F_15 ( V_34 * V_49 , int V_56 , T_2 * V_13 ,
int V_57 )
{
struct V_55 * V_58 ;
if ( ( ! V_49 ) || ( ! V_13 ) ) {
...
if ( ( * V_13 + sizeof( struct V_55 ) ) > V_56 )
return NULL ;
else {
V_58 = (struct V_55 * ) V_49 ;
if ( V_58 -> V_60 == 0 )
return NULL ;
}
if ( V_57 )
* V_13 += sizeof( struct V_55 ) ;
return V_58 ;
}
struct V_61 * F_17 ( V_34 * V_49 , int V_56 , T_2 * V_13 , int V_57 )
{
struct V_61 * V_62 ;
if ( ( ! V_49 ) || ( ! V_13 ) ) {
F_16 ( L_4 , V_59 ) ;
...
if ( ( * V_13 + sizeof( struct V_61 ) ) > V_56 )
return NULL ;
else {
V_62 = (struct V_61 * ) V_49 ;
if ( V_62 -> V_60 == 0 )
return NULL ;
}
if ( V_57 )
* V_13 += sizeof( struct V_61 ) ;
return V_62 ;
}
