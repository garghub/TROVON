...
{
struct V_16 * V_17 , * V_81 , * V_93 ;
struct V_1 * V_2 ;
V_93 = V_16 ( V_77 ) ;
F_41 (llcp_sock, n, &parent_sock->accept_queue,
accept_queue) {
V_2 = & V_17 -> V_2 ;
if ( V_2 -> V_9 == V_60 )
return V_94 | V_95 ;
...
static unsigned int F_50 ( struct V_96 * V_96 , struct V_12 * V_1 ,
T_3 * V_5 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
unsigned int V_97 = 0 ;
F_3 ( L_13 , V_2 ) ;
F_51 ( V_96 , F_5 ( V_2 ) , V_5 ) ;
if ( V_2 -> V_9 == V_51 )
return F_49 ( V_2 ) ;
if ( V_2 -> V_98 || ! F_52 ( & V_2 -> V_99 ) )
V_97 |= V_100 |
( F_53 ( V_2 , V_101 ) ? V_102 : 0 ) ;
if ( ! F_52 ( & V_2 -> V_103 ) )
V_97 |= V_94 | V_95 ;
if ( V_2 -> V_9 == V_30 )
V_97 |= V_104 ;
...
F_55 ( V_112 , & V_2 -> V_113 -> V_83 ) ;
F_3 ( L_14 , V_97 ) ;
return V_97 ;
}
static int F_56 ( struct V_12 * V_1 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_18 * V_19 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
...
static int F_61 ( struct V_12 * V_1 , struct V_13 * V_117 ,
int V_24 , int V_83 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
struct V_22 * V_14 = (struct V_22 * ) V_117 ;
struct V_20 * V_21 ;
struct V_18 * V_19 ;
int V_25 = 0 ;
F_3 ( L_15 , V_1 , V_2 , V_83 ) ;
if ( ! V_14 || V_24 < sizeof( struct V_118 ) ||
V_14 -> V_26 != V_27 )
return - V_28 ;
...
static int F_67 ( struct V_128 * V_129 , struct V_12 * V_1 ,
struct V_130 * V_131 , T_4 V_24 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_16 * V_17 = V_16 ( V_2 ) ;
int V_25 ;
...
if ( V_2 -> V_135 == V_136 ) {
struct V_22 * V_14 =
(struct V_22 * ) V_131 -> V_137 ;
if ( V_131 -> V_138 < sizeof( * V_14 ) ) {
F_9 ( V_2 ) ;
return - V_28 ;
}
F_9 ( V_2 ) ;
return F_68 ( V_17 , V_14 -> V_29 , V_14 -> V_39 ,
V_131 , V_24 ) ;
}
if ( V_2 -> V_9 != V_60 ) {
F_9 ( V_2 ) ;
...
F_9 ( V_2 ) ;
return F_69 ( V_17 , V_131 , V_24 ) ;
}
static int F_70 ( struct V_128 * V_129 , struct V_12 * V_1 ,
struct V_130 * V_131 , T_4 V_24 , int V_83 )
{
int V_140 = V_83 & V_141 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
V_143 = V_145 -> V_24 ;
V_142 = F_16 (unsigned int, rlen, len) ;
V_146 = V_145 ;
if ( F_73 ( V_146 , 0 , V_131 -> V_147 , V_142 ) ) {
if ( ! ( V_83 & V_148 ) )
F_74 ( & V_2 -> V_103 , V_145 ) ;
return - V_61 ;
}
F_75 ( V_131 , V_2 , V_145 ) ;
if ( V_2 -> V_135 == V_136 && V_131 -> V_137 ) {
struct V_149 * V_150 = F_76 ( V_145 ) ;
struct V_22 * V_13 =
(struct V_22 * ) V_131 -> V_137 ;
V_131 -> V_138 = sizeof( struct V_22 ) ;
F_3 ( L_20 , V_150 -> V_29 , V_150 -> V_39 ) ;
memset ( V_13 , 0 , sizeof( * V_13 ) ) ;
V_13 -> V_26 = V_27 ;
V_13 -> V_35 = V_151 ;
V_13 -> V_29 = V_150 -> V_29 ;
V_13 -> V_39 = V_150 -> V_39 ;
}
if ( ! ( V_83 & V_148 ) ) {
if ( V_2 -> V_135 == V_48 ||
V_2 -> V_135 == V_136 ||
...
struct V_1 * F_82 ( struct V_12 * V_1 , int type , T_5 V_155 )
{
struct V_1 * V_2 ;
struct V_16 * V_17 ;
V_2 = F_83 ( & V_156 , V_157 , V_155 , & V_158 ) ;
if ( ! V_2 )
return NULL ;
V_17 = V_16 ( V_2 ) ;
F_84 ( V_1 , V_2 ) ;
...
static int F_90 ( struct V_170 * V_170 , struct V_12 * V_1 ,
const struct V_35 * V_171 )
{
struct V_1 * V_2 ;
F_3 ( L_13 , V_1 ) ;
if ( V_1 -> type != V_48 &&
