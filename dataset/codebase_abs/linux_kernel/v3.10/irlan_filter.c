...
F_2 (self != NULL, return;) ;
F_2 (self->magic == IRLAN_MAGIC, return;) ;
F_3 ( 4 , L_15 , V_21 , V_22 ) ;
if ( strcmp ( V_21 , L_16 ) == 0 ) {
F_3 ( 0 , L_14 , V_23 ) ;
V_2 -> V_24 = TRUE ;
return;
}
if ( strcmp ( V_21 , L_17 ) == 0 ) {
...
if ( strcmp ( V_21 , L_23 ) == 0 ) {
if ( strcmp ( V_22 , L_24 ) == 0 ) {
V_2 -> V_5 . V_8 = V_9 ;
return;
}
if ( strcmp ( V_22 , L_25 ) == 0 ) {
V_2 -> V_5 . V_8 = V_20 ;
return;
}
}
}
void F_9 ( struct V_26 * V_27 , int V_6 )
{
static struct {
int V_28 ;
const char * V_29 ;
...
for ( V_35 = V_30 ; V_35 -> V_29 ; V_35 ++ ) {
if ( V_6 & V_35 -> V_28 )
F_11 ( V_27 , L_30 , V_35 -> V_29 ) ;
}
F_12 ( V_27 , '\n' ) ;
}
