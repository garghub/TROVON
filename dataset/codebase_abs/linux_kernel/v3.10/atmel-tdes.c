...
int V_26 = - V_78 ;
T_4 V_155 , V_156 ;
if ( V_154 && V_154 -> V_157 -> V_158 . V_150 &&
V_154 -> V_157 -> V_159 . V_150 ) {
F_65 ( V_155 ) ;
F_66 ( V_160 , V_155 ) ;
V_12 -> V_103 . V_111 = F_67 ( V_155 ,
F_63 , & V_154 -> V_157 -> V_159 ) ;
if ( ! V_12 -> V_103 . V_111 )
goto V_161;
V_12 -> V_103 . V_104 . V_162 = V_113 ;
V_12 -> V_103 . V_104 . V_163 = V_12 -> V_164 +
V_165 ;
V_12 -> V_103 . V_104 . V_166 = 1 ;
V_12 -> V_103 . V_104 . V_108 =
V_110 ;
V_12 -> V_103 . V_104 . V_167 = 1 ;
V_12 -> V_103 . V_104 . V_105 =
V_110 ;
V_12 -> V_103 . V_104 . V_168 = false ;
F_65 ( V_156 ) ;
F_66 ( V_160 , V_156 ) ;
V_12 -> V_107 . V_111 = F_67 ( V_156 ,
F_63 , & V_154 -> V_157 -> V_158 ) ;
if ( ! V_12 -> V_107 . V_111 )
goto V_169;
V_12 -> V_107 . V_104 . V_162 = V_116 ;
V_12 -> V_107 . V_104 . V_170 = V_12 -> V_164 +
V_171 ;
V_12 -> V_107 . V_104 . V_166 = 1 ;
V_12 -> V_107 . V_104 . V_108 =
V_110 ;
V_12 -> V_107 . V_104 . V_167 = 1 ;
V_12 -> V_107 . V_104 . V_105 =
V_110 ;
V_12 -> V_107 . V_104 . V_168 = false ;
return 0 ;
} else {
return - V_172 ;
}
...
static int F_70 ( struct V_173 * V_88 , const V_90 * V_64 ,
unsigned int V_40 )
{
T_2 V_18 [ V_174 ] ;
int V_26 ;
struct V_87 * V_175 = F_47 ( V_88 ) ;
...
static int F_73 ( struct V_173 * V_88 , const V_90 * V_64 ,
unsigned int V_40 )
{
struct V_15 * V_16 = F_60 ( V_88 ) ;
const char * V_180 ;
V_180 = F_74 ( F_47 ( V_88 ) ) ;
if ( ! V_16 -> V_12 -> V_35 . V_181 && strstr ( V_180 , L_11 )
&& ( V_40 != 2 * V_41 ) ) {
F_71 ( V_88 , V_176 ) ;
return - V_77 ;
...
static int F_75 ( struct V_125 * V_65 )
{
...
static int F_89 ( struct V_87 * V_88 )
{
struct V_15 * V_16 = F_36 ( V_88 ) ;
struct V_11 * V_12 ;
V_88 -> V_182 . V_183 = sizeof( struct V_132 ) ;
V_12 = F_10 ( V_16 ) ;
if ( ! V_12 )
return - V_172 ;
return 0 ;
...
static void F_91 ( unsigned long V_30 )
{
...
static T_5 F_93 ( int V_184 , void * V_185 )
{
struct V_11 * V_17 = V_185 ;
T_2 V_186 ;
V_186 = F_5 ( V_17 , V_187 ) ;
if ( V_186 & F_5 ( V_17 , V_188 ) ) {
F_7 ( V_17 , V_189 , V_186 ) ;
if ( V_126 & V_17 -> V_22 )
F_21 ( & V_17 -> V_31 ) ;
else
F_94 ( V_17 -> V_29 , L_12 ) ;
...
{
int V_26 , V_192 , V_194 ;
for ( V_192 = 0 ; V_192 < F_96 ( V_193 ) ; V_192 ++ ) {
V_26 = F_99 ( & V_193 [ V_192 ] ) ;
if ( V_26 )
goto V_195;
}
return 0 ;
...
struct V_11 * V_17 ;
struct V_153 * V_154 ;
struct V_151 * V_29 = & V_197 -> V_29 ;
struct V_198 * V_199 ;
unsigned long V_200 ;
int V_26 ;
V_17 = F_102 ( sizeof( struct V_11 ) , V_80 ) ;
if ( V_17 == NULL ) {
F_29 ( V_29 , L_14 ) ;
V_26 = - V_78 ;
goto V_201;
...
F_103 ( V_197 , V_17 ) ;
F_104 ( & V_17 -> V_202 ) ;
F_105 ( & V_17 -> V_31 , F_92 ,
( unsigned long ) V_17 ) ;
F_105 ( & V_17 -> V_142 , F_91 ,
( unsigned long ) V_17 ) ;
F_106 ( & V_17 -> V_135 , V_203 ) ;
V_17 -> V_184 = - 1 ;
V_199 = F_107 ( V_197 , V_204 , 0 ) ;
if ( ! V_199 ) {
F_29 ( V_29 , L_15 ) ;
V_26 = - V_172 ;
goto V_205;
}
V_17 -> V_164 = V_199 -> V_206 ;
V_200 = F_108 ( V_199 ) ;
V_17 -> V_184 = F_109 ( V_197 , 0 ) ;
if ( V_17 -> V_184 < 0 ) {
F_29 ( V_29 , L_16 ) ;
V_26 = V_17 -> V_184 ;
goto V_205;
}
V_26 = F_110 ( V_17 -> V_184 , F_93 , V_207 ,
L_17 , V_17 ) ;
if ( V_26 ) {
F_29 ( V_29 , L_18 ) ;
goto V_208;
}
V_17 -> V_21 = F_111 ( & V_197 -> V_29 , L_19 ) ;
if ( F_112 ( V_17 -> V_21 ) ) {
F_29 ( V_29 , L_20 ) ;
V_26 = F_113 ( V_17 -> V_21 ) ;
goto V_209;
}
V_17 -> V_13 = F_114 ( V_17 -> V_164 , V_200 ) ;
if ( ! V_17 -> V_13 ) {
F_29 ( V_29 , L_21 ) ;
V_26 = - V_78 ;
goto V_210;
...
goto V_211;
if ( V_17 -> V_35 . V_36 ) {
V_154 = V_197 -> V_29 . V_212 ;
if ( ! V_154 ) {
F_29 ( & V_197 -> V_29 , L_22 ) ;
V_26 = - V_213 ;
goto V_214;
}
