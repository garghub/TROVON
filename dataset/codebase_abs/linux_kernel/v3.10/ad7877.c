...
struct V_21 * V_22 ;
struct V_34 * V_34 ;
struct V_95 * V_96 = V_2 -> V_58 . V_97 ;
int V_98 ;
T_1 V_99 ;
if ( ! V_2 -> V_57 ) {
F_51 ( & V_2 -> V_58 , L_3 ) ;
...
V_22 -> V_2 = V_2 ;
V_22 -> V_35 = V_34 ;
F_55 ( & V_22 -> V_49 , F_25 , ( unsigned long ) V_22 ) ;
F_56 ( & V_22 -> V_63 ) ;
F_57 ( & V_22 -> V_56 ) ;
...
V_22 -> V_86 = V_96 -> V_86 ;
V_22 -> V_87 = V_96 -> V_87 ;
snprintf ( V_22 -> V_106 , sizeof( V_22 -> V_106 ) , L_7 , F_58 ( & V_2 -> V_58 ) ) ;
V_34 -> V_107 = L_8 ;
V_34 -> V_106 = V_22 -> V_106 ;
V_34 -> V_58 . V_108 = & V_2 -> V_58 ;
F_59 ( V_109 , V_34 -> V_110 ) ;
F_59 ( V_50 , V_34 -> V_111 ) ;
F_59 ( V_112 , V_34 -> V_110 ) ;
F_59 ( V_51 , V_34 -> V_113 ) ;
F_59 ( V_52 , V_34 -> V_113 ) ;
F_59 ( V_53 , V_34 -> V_113 ) ;
F_60 ( V_34 , V_51 ,
V_96 -> V_114 ? : 0 ,
V_96 -> V_115 ? : V_20 ,
0 , 0 ) ;
...
0 , 0 ) ;
F_60 ( V_34 , V_53 ,
V_96 -> V_118 , V_96 -> V_47 , 0 , 0 ) ;
F_9 ( V_2 , V_119 , V_120 ) ;
V_99 = F_1 ( V_2 , V_119 ) ;
if ( V_99 != V_120 ) {
F_29 ( & V_2 -> V_58 , L_9 ,
F_58 ( & V_2 -> V_58 ) , V_34 -> V_107 ) ;
V_98 = - V_100 ;
goto V_104;
}
if ( V_73 )
F_9 ( V_2 , V_74 , V_121 ) ;
F_49 ( V_2 , V_22 ) ;
V_98 = F_61 ( V_2 -> V_57 , NULL , F_28 ,
V_122 | V_123 ,
V_2 -> V_58 . V_124 -> V_107 , V_22 ) ;
if ( V_98 ) {
F_51 ( & V_2 -> V_58 , L_10 , V_2 -> V_57 ) ;
goto V_104;
}
V_98 = F_62 ( & V_2 -> V_58 . V_78 , & V_125 ) ;
if ( V_98 )
goto V_126;
V_98 = F_63 ( V_34 ) ;
if ( V_98 )
...
static int F_69 ( struct V_65 * V_58 )
{
struct V_21 * V_22 = F_39 ( V_58 ) ;
F_31 ( V_22 ) ;
return 0 ;
}
static int F_70 ( struct V_65 * V_58 )
{
struct V_21 * V_22 = F_39 ( V_58 ) ;
F_36 ( V_22 ) ;
return 0 ;
