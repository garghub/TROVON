...
static unsigned int F_32 ( struct V_11 * V_11 , T_1 * V_109 )
{
struct V_12 * V_13 = F_7 ( V_11 ) ;
struct V_3 * V_4 = F_8 ( V_13 ) ;
...
struct V_61 * V_115 )
{
if ( V_114 -> V_62 . V_116 != V_115 -> V_62 . V_116
|| V_114 -> V_62 . V_117 != V_115 -> V_62 . V_117
|| V_114 -> V_62 . V_87 != V_115 -> V_62 . V_87 )
return - V_66 ;
return 0 ;
}
static int
F_36 ( struct V_118 * V_6 ,
struct V_61 * V_119 )
{
if ( F_37 ( V_6 -> V_7 ) == V_120 ) {
struct V_3 * V_4 =
F_38 ( V_6 -> V_7 ) ;
V_119 -> V_63 = V_65 ;
V_119 -> V_6 = V_6 -> V_121 ;
return F_26 ( V_4 , V_6 , V_67 , NULL , V_119 ) ;
}
F_39 ( V_6 -> V_7 -> type != V_122 ,
L_3 ,
V_6 -> V_7 -> type , V_6 -> V_7 -> V_58 ) ;
return - V_66 ;
}
int F_40 ( struct V_112 * V_113 )
{
struct V_3 * V_123 ;
struct V_61 V_115 , V_114 ;
int V_75 ;
V_75 = F_36 (
V_113 -> V_124 , & V_114 ) ;
if ( V_75 < 0 )
...
if ( V_75 < 0 )
return 0 ;
V_123 = F_38 ( V_113 -> V_123 -> V_7 ) ;
V_75 = F_26 ( V_123 , V_6 , V_125 , V_113 ,
& V_114 , & V_115 ) ;
if ( V_75 != - V_41 )
return V_75 ;
return F_35 (
V_123 , V_113 , & V_114 , & V_115 ) ;
}
void F_41 ( struct V_3 * V_4 , const struct V_126 * V_127 )
{
F_42 ( & V_4 -> V_128 ) ;
F_43 ( ! V_127 ) ;
V_4 -> V_127 = V_127 ;
