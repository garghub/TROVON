...
return - V_123 ;
V_7 -> V_124 = V_69 ;
V_7 -> V_125 = V_69 -> V_126 ;
V_10 = F_38 ( sizeof( * V_10 ) , V_127 ) ;
if ( ! V_10 )
return - V_128 ;
V_7 -> V_11 = V_10 ;
V_121 = F_39 ( V_7 ) ;
if ( V_121 < 0 )
return V_121 ;
V_10 -> V_13 = F_40 ( V_120 , 0 ) ;
if ( ! V_10 -> V_13 )
return - V_128 ;
V_121 = F_41 ( V_120 -> V_43 , F_14 , V_129 ,
V_7 -> V_125 , V_7 ) ;
if ( V_121 )
return V_121 ;
V_7 -> V_43 = V_120 -> V_43 ;
...
V_7 -> V_130 = V_29 ;
V_29 -> type = V_131 ;
V_29 -> V_132 = V_133 | V_134 | V_135 | V_136 ;
V_29 -> V_137 = V_69 -> V_138 ;
V_29 -> V_139 = F_28 ;
V_29 -> V_140 = ( 1 << V_69 -> V_141 ) - 1 ;
V_29 -> V_142 = 512 ;
V_29 -> V_143 = & V_144 ;
V_29 -> V_145 = F_24 ;
V_29 -> V_146 = F_18 ;
...
V_29 -> V_139 = F_30 ;
V_29 -> V_150 = F_29 ;
V_29 -> V_140 = ( 1 << V_69 -> V_151 ) - 1 ;
V_29 -> V_142 = 1 ;
V_29 -> V_143 = & V_152 ;
V_29 = & V_7 -> V_47 [ 2 ] ;
V_29 -> type = V_153 ;
V_29 -> V_132 = V_133 | V_149 ;
V_29 -> V_137 = 8 ;
V_29 -> V_154 = F_32 ;
V_29 -> V_155 = F_33 ;
V_29 -> V_140 = 1 ;
...
static int F_48 ( struct V_119 * V_7 ,
const struct V_159 * V_160 )
{
return F_49 ( V_7 , & V_161 , V_160 -> V_162 ) ;
}
