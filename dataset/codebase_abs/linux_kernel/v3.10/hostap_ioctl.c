...
if ( V_48 != 0 )
return - V_60 ;
V_500 = F_121 ( V_6 -> V_104 , V_112 , 0 , & V_54 ) ;
if ( V_500 == NULL ) {
if ( V_6 -> V_22 == V_79 ) {
V_48 = 0 ;
V_54 = & V_6 -> V_57 . V_54 [ V_48 ] ;
...
V_500 = F_121 ( V_6 -> V_104 , V_375 -> V_518 , 0 ,
& V_54 ) ;
if ( V_500 == NULL ) {
V_375 -> V_150 . V_54 . V_516 = V_521 ;
return - V_60 ;
...
switch ( V_533 -> V_248 ) {
case V_536 :
return F_133 ( V_6 , V_533 -> V_112 . V_136 ,
V_537 ,
( T_2 * ) & V_534 , 2 ) ;
case V_538 :
return F_133 ( V_6 , V_533 -> V_112 . V_136 ,
...
static int F_136 ( T_1 * V_6 , struct V_50 * V_474 )
{
struct V_514 * V_375 ;
int V_89 = 0 ;
int V_542 = 0 ;
...
break;
case V_548 :
V_89 = F_128 ( V_6 , V_375 , V_474 -> V_72 ) ;
break;
case V_549 :
V_89 = F_131 ( V_6 , V_375 ,
V_474 -> V_72 ) ;
break;
case V_550 :
...
break;
default:
V_89 = F_137 ( V_6 -> V_104 , V_375 ) ;
V_542 = 1 ;
break;
}
if ( V_89 == 1 || ! V_542 ) {
if ( F_138 ( V_474 -> V_476 , V_375 , V_474 -> V_72 ) ) {
V_89 = - V_477 ;
goto V_478;
} else if ( V_542 )
V_89 = 0 ;
...
V_5 = F_2 ( V_3 ) ;
V_6 = V_5 -> V_6 ;
F_140 ( V_45 -> V_553 , L_92 , sizeof( V_45 -> V_553 ) ) ;
snprintf ( V_45 -> V_554 , sizeof( V_45 -> V_554 ) ,
L_93 , ( V_6 -> V_212 >> 16 ) & 0xff ,
( V_6 -> V_212 >> 8 ) & 0xff ,
V_6 -> V_212 & 0xff ) ;
}
int F_141 ( struct V_2 * V_3 , struct V_555 * V_556 , int V_248 )
{
...
case V_563 :
if ( ! F_142 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_143 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 ) ;
break;
case V_564 :
if ( ! F_142 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_144 ( V_6 , V_257 -> V_150 . V_135 . V_136 , 1 , 0 ) ;
break;
case V_565 :
if ( ! F_142 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_109 ( V_3 ,
...
case V_568 :
if ( ! F_142 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_147 ( & V_6 -> V_104 -> V_465 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
case V_569 :
if ( ! F_142 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_148 ( V_6 -> V_104 , V_6 -> V_3 ,
V_257 -> V_150 . V_135 . V_136 ) ;
break;
#endif
#ifdef F_149
...
case V_571 :
if ( ! F_142 ( V_559 ) ) V_89 = - V_560 ;
else V_89 = F_136 ( V_6 , & V_257 -> V_150 . V_110 ) ;
break;
default:
V_89 = - V_71 ;
break;
