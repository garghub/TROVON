...
unsigned int V_104 = V_156 ? V_156 -> V_104 & ~ V_158 : 0 ;
for ( V_10 = 0 ; V_10 < V_137 ; V_10 ++ ) {
unsigned long V_159 ;
unsigned long V_160 ;
unsigned long V_161 ;
V_159 = ( unsigned long ) V_136 [ V_10 ] . V_150 ;
V_160 = ( V_159 + V_136 [ V_10 ] . V_152 + V_101 - 1 ) >> V_162 ;
V_161 = V_159 >> V_162 ;
if ( V_160 < V_161 )
return F_97 ( - V_163 ) ;
V_100 += V_160 - V_161 ;
...
V_121 = V_103 ;
if ( V_156 ) {
if ( V_10 == V_156 -> V_167 * V_100 ) {
V_97 = - V_123 ;
break;
}
V_102 = V_156 -> V_168 [ V_10 / V_100 ] ;
V_102 += ( V_10 % V_100 ) ;
V_10 ++ ;
} else {
V_102 = F_80 ( V_85 -> V_169 | V_37 ) ;
if ( ! V_102 ) {
V_97 = - V_123 ;
break;
}
...
if ( V_97 )
goto V_170;
if ( ( ! V_157 && ( ! V_156 || ! V_156 -> V_171 ) ) ||
( V_156 && V_156 -> V_144 ) ) {
V_97 = F_90 ( V_4 , V_4 -> V_52 , V_136 , V_137 , 0 , 1 , 0 ) ;
if ( V_97 )
goto V_170;
}
F_87 ( V_134 , V_4 , V_136 , V_137 , V_156 ? 0 : 1 ) ;
return V_4 ;
V_170:
if ( ! V_156 )
F_79 (bvec, bio, i)
...
struct V_4 * F_99 ( struct V_84 * V_85 , struct V_155 * V_156 ,
unsigned long V_159 , unsigned int V_103 ,
int V_157 , T_2 V_37 )
{
struct V_135 V_136 ;
V_136 . V_150 = ( void T_3 * ) V_159 ;
V_136 . V_152 = V_103 ;
return F_96 ( V_85 , V_156 , & V_136 , 1 , V_157 , V_37 ) ;
}
...
int V_97 , V_104 ;
for ( V_10 = 0 ; V_10 < V_137 ; V_10 ++ ) {
unsigned long V_159 = ( unsigned long ) V_136 [ V_10 ] . V_150 ;
unsigned long V_103 = V_136 [ V_10 ] . V_152 ;
unsigned long V_160 = ( V_159 + V_103 + V_101 - 1 ) >> V_162 ;
unsigned long V_161 = V_159 >> V_162 ;
if ( V_160 < V_161 )
return F_97 ( - V_163 ) ;
V_100 += V_160 - V_161 ;
if ( V_159 & F_101 ( V_85 ) )
...
return F_97 ( - V_123 ) ;
V_97 = - V_123 ;
V_168 = F_102 ( V_100 , sizeof( struct V_102 * ) , V_37 ) ;
if ( ! V_168 )
goto V_26;
for ( V_10 = 0 ; V_10 < V_137 ; V_10 ++ ) {
unsigned long V_159 = ( unsigned long ) V_136 [ V_10 ] . V_150 ;
...
unsigned long V_160 = ( V_159 + V_103 + V_101 - 1 ) >> V_162 ;
unsigned long V_161 = V_159 >> V_162 ;
const int V_174 = V_160 - V_161 ;
const int V_175 = V_173 + V_174 ;
V_97 = F_103 ( V_159 , V_174 ,
V_157 , & V_168 [ V_173 ] ) ;
if ( V_97 < V_174 ) {
V_97 = - V_151 ;
goto V_176;
...
V_104 = V_159 & ~ V_158 ;
for ( V_172 = V_173 ; V_172 < V_175 ; V_172 ++ ) {
unsigned int V_121 = V_101 - V_104 ;
if ( V_103 <= 0 )
break;
if ( V_121 > V_103 )
V_121 = V_103 ;
if ( F_65 ( V_85 , V_4 , V_168 [ V_172 ] , V_121 , V_104 ) <
V_121 )
break;
V_103 -= V_121 ;
V_104 = 0 ;
...
unsigned long V_159 , unsigned int V_103 , int V_157 ,
T_2 V_37 )
{
struct V_135 V_136 ;
V_136 . V_150 = ( void T_3 * ) V_159 ;
V_136 . V_152 = V_103 ;
return F_106 ( V_85 , V_99 , & V_136 , 1 , V_157 , V_37 ) ;
}
...
{
struct V_4 * V_4 ;
V_4 = F_100 ( V_85 , V_99 , V_136 , V_137 , V_157 ,
V_37 ) ;
if ( F_107 ( V_4 ) )
return V_4 ;
F_108 ( V_4 ) ;
...
static void F_112 ( struct V_4 * V_4 , int V_178 )
{
F_50 ( V_4 ) ;
}
...
{
unsigned long V_179 = ( unsigned long ) V_81 ;
unsigned long V_160 = ( V_179 + V_103 + V_101 - 1 ) >> V_162 ;
unsigned long V_161 = V_179 >> V_162 ;
const int V_100 = V_160 - V_161 ;
int V_104 , V_10 ;
struct V_4 * V_4 ;
V_4 = F_98 ( V_37 , V_100 ) ;
if ( ! V_4 )
...
static void F_117 ( struct V_4 * V_4 , int V_178 )
{
struct V_31 * V_107 ;
const int V_180 = F_95 ( V_4 ) == V_154 ;
struct V_133 * V_134 = V_4 -> V_116 ;
int V_10 ;
char * V_49 = V_134 -> V_140 [ 0 ] . V_150 ;
F_79 (bvec, bio, i) {
char * V_181 = F_91 ( V_107 -> V_83 ) ;
int V_103 = V_134 -> V_139 [ V_10 ] . V_82 ;
if ( V_180 )
memcpy ( V_49 , V_181 , V_103 ) ;
F_81 ( V_107 -> V_83 ) ;
V_49 += V_103 ;
}
F_88 ( V_134 ) ;
...
void F_133 ( struct V_190 * V_191 )
{
if ( F_52 ( & V_191 -> V_192 ) ) {
struct V_4 * V_193 = V_191 -> V_194 . V_116 ;
F_130 ( V_193 , V_191 -> error ) ;
F_14 ( V_191 , V_191 -> V_195 . V_116 ) ;
}
}
static void F_134 ( struct V_4 * V_188 , int V_178 )
{
struct V_190 * V_191 = F_32 ( V_188 , struct V_190 , V_194 ) ;
if ( V_178 )
V_191 -> error = V_178 ;
F_133 ( V_191 ) ;
}
static void F_135 ( struct V_4 * V_188 , int V_178 )
{
struct V_190 * V_191 = F_32 ( V_188 , struct V_190 , V_195 ) ;
if ( V_178 )
V_191 -> error = V_178 ;
F_133 ( V_191 ) ;
}
struct V_190 * F_136 ( struct V_4 * V_188 , int V_196 )
{
struct V_190 * V_191 = F_17 ( V_197 , V_198 ) ;
if ( ! V_191 )
return V_191 ;
F_137 ( F_59 ( V_188 -> V_90 ) , V_188 ,
V_188 -> V_89 + V_196 ) ;
F_138 ( F_139 ( V_188 ) > 1 ) ;
F_29 ( & V_191 -> V_192 , 3 ) ;
V_191 -> error = 0 ;
V_191 -> V_194 = * V_188 ;
V_191 -> V_195 = * V_188 ;
V_191 -> V_195 . V_89 += V_196 ;
V_191 -> V_195 . V_94 -= V_196 << 9 ;
V_191 -> V_194 . V_94 = V_196 << 9 ;
if ( V_188 -> V_93 != 0 ) {
V_191 -> V_199 = * F_77 ( V_188 ) ;
V_191 -> V_200 = * F_77 ( V_188 ) ;
if ( F_140 ( V_188 ) ) {
V_191 -> V_200 . V_109 += V_196 << 9 ;
V_191 -> V_200 . V_82 -= V_196 << 9 ;
V_191 -> V_199 . V_82 = V_196 << 9 ;
}
V_191 -> V_194 . V_52 = & V_191 -> V_199 ;
V_191 -> V_195 . V_52 = & V_191 -> V_200 ;
V_191 -> V_194 . V_80 = 1 ;
V_191 -> V_195 . V_80 = 1 ;
}
V_191 -> V_194 . V_120 = F_134 ;
V_191 -> V_195 . V_120 = F_135 ;
V_191 -> V_194 . V_116 = V_188 ;
V_191 -> V_195 . V_116 = V_197 ;
if ( F_22 ( V_188 ) )
F_141 ( V_188 , V_191 , V_196 ) ;
return V_191 ;
}
T_4 F_142 ( struct V_4 * V_4 , unsigned short V_201 ,
unsigned int V_104 )
{
unsigned int V_202 ;
struct V_31 * V_32 ;
T_4 V_203 ;
int V_10 ;
V_202 = F_143 ( V_4 -> V_90 -> V_204 -> V_205 ) ;
V_203 = 0 ;
if ( V_201 >= V_4 -> V_95 )
V_201 = V_4 -> V_93 - 1 ;
F_79 (bv, bio, i) {
if ( V_10 == V_201 ) {
if ( V_104 > V_32 -> V_109 )
V_203 += ( V_104 - V_32 -> V_109 ) / V_202 ;
break;
}
V_203 += V_32 -> V_82 / V_202 ;
}
return V_203 ;
}
T_1 * F_144 ( struct V_23 * V_24 , int V_206 )
{
struct V_35 * V_191 = V_28 + V_34 ;
return F_145 ( V_206 , V_191 -> V_5 ) ;
}
...
struct V_23 * F_150 ( unsigned int V_207 , unsigned int V_53 )
{
unsigned int V_208 = V_76 * sizeof( struct V_31 ) ;
struct V_23 * V_24 ;
...
V_24 -> V_6 = F_1 ( V_53 + V_208 ) ;
if ( ! V_24 -> V_6 ) {
F_27 ( V_24 ) ;
return NULL ;
}
V_24 -> V_54 = F_145 ( V_207 , V_24 -> V_6 ) ;
if ( ! V_24 -> V_54 )
goto V_209;
V_24 -> V_51 = F_144 ( V_24 , V_207 ) ;
if ( ! V_24 -> V_51 )
goto V_209;
V_24 -> V_70 = F_154 ( L_5 , V_210 , 0 ) ;
if ( ! V_24 -> V_70 )
goto V_209;
return V_24 ;
V_209:
...
V_4 -> V_215 = V_212 ;
F_157 () ;
V_214 = F_158 ( V_69 , V_218 ) ;
if ( V_214 && F_159 ( V_214 ) )
V_4 -> V_219 = V_214 ;
F_160 () ;
return 0 ;
}
...
V_220 = V_36 -> V_29 * sizeof( struct V_31 ) ;
V_36 -> V_5 = F_4 ( V_36 -> V_20 , V_220 , 0 ,
V_21 | V_221 , NULL ) ;
}
}
