...
V_46 = F_23 ( V_43 * sizeof( * V_46 ) , V_40 ) ;
if ( ! V_46 ) return - V_41 ;
memcpy ( V_46 , V_21 -> V_47 , V_43 * sizeof( * V_46 ) ) ;
}
F_24 ( V_21 -> V_47 ) ;
V_21 -> V_47 = V_46 ;
V_21 -> V_45 = V_43 ;
...
V_51 = F_27 ( V_50 , struct V_7 , V_30 ) ;
F_14 ( V_51 ) ;
...
struct V_20 * F_35 ( void )
{
struct V_20 * V_21 ;
V_21 = F_36 ( sizeof( * V_21 ) , V_40 ) ;
if ( ! V_21 ) return V_21 ;
F_3 ( V_68 , L_27 , V_21 ) ;
F_28 ( V_21 ) ;
return V_21 ;
...
int F_42 ( struct V_20 * V_21 , unsigned int V_17 )
{
int V_42 ;
...
struct V_7 * F_43 ( struct V_20 * V_21 )
{
struct V_49 * V_50 = V_21 -> V_36 . V_52 ;
if ( V_50 == & V_21 -> V_36 ) return NULL ;
return F_27 ( V_50 , struct V_7 , V_30 ) ;
}
...
struct V_7 * F_45 ( struct V_20 * V_21 , int V_12 )
{
...
int F_52 ( struct V_7 * V_8 , void * V_86 , unsigned int V_17 )
{
int V_42 = 0 ;
unsigned long V_32 ;
struct V_20 * V_21 ;
...
unsigned int F_53 ( struct V_7 * V_8 )
{
return V_8 -> V_29 ;
}
