...
static int F_16 ( T_1 V_19 , T_1 V_20 , int V_21 )
{
int V_10 ;
if ( ! ( V_20 & V_22 ) )
return - V_23 ;
...
static inline void
F_50 ( unsigned long V_13 , unsigned long V_14 )
{
int V_10 ;
struct V_4 * V_5 = V_18 ;
struct V_6 * V_7 ;
...
void F_53 ( unsigned long V_54 , unsigned long V_55 )
{
if ( ! F_1 () && F_3 () )
F_50 ( V_54 , V_55 ) ;
}
...
void F_55 ( unsigned long V_13 )
{
}
void F_56 ( unsigned long V_13 )
{
}
inline void F_57 ( struct V_56 * V_57 )
{
}
void F_58 ( void )
{
...
void F_62 ( unsigned long V_54 , unsigned long V_55 )
{
if ( F_1 () && ! F_3 () )
F_50 ( V_54 , V_55 ) ;
}
...
static int F_64 ( int V_59 , int V_21 )
{
int V_27 ;
...
static int F_71 ( struct V_64 * V_64 , T_1 V_65 , int V_21 )
{
if ( V_65 & V_62 )
F_70 ( V_21 ) ;
return F_72 ( V_64 , V_65 , V_21 ) ;
}
