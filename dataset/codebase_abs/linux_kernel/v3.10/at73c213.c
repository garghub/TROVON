...
static int F_32 ( struct V_1 * V_2 , int V_76 )
{
struct V_77 * V_78 ;
int V_11 ;
...
static T_3 F_36 ( int V_90 , void * V_91 )
{
struct V_1 * V_2 = V_91 ;
...
static int F_65 ( struct V_123 * V_79 ,
struct V_164 * V_16 )
{
...
static int F_73 ( struct V_164 * V_16 )
{
struct V_123 * V_79 ;
struct V_1 * V_2 ;
struct V_172 * V_31 ;
...
static int F_82 ( struct V_164 * V_16 )
{
...
static int F_84 ( struct V_76 * V_37 )
{
struct V_123 * V_79 = F_83 ( V_37 ) ;
struct V_1 * V_2 = V_79 -> V_82 ;
F_9 ( V_2 -> V_19 -> V_34 , V_159 , F_27 ( V_163 ) ) ;
F_62 ( V_2 -> V_31 -> V_32 ) ;
return 0 ;
}
static int F_85 ( struct V_76 * V_37 )
{
struct V_123 * V_79 = F_83 ( V_37 ) ;
struct V_1 * V_2 = V_79 -> V_82 ;
F_60 ( V_2 -> V_31 -> V_32 ) ;
