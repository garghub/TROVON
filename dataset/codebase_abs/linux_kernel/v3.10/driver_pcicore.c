...
static V_28 F_48 ( struct V_1 * V_2 )
{
return ( F_49 ( V_2 , 0x204 ) & 0x10 ) ? 0xC0 : 0x80 ;
}
...
F_51 ( V_2 , V_85 , 1 ,
F_48 ( V_2 ) ) ;
V_10 = F_52 ( V_2 , V_84 , 1 ) ;
if ( V_10 & 0x4000 )
F_51 ( V_2 , V_84 , 1 , V_10 & ~ 0x4000 ) ;
}
...
static T_1 F_49 ( struct V_1 * V_2 , T_1 V_103 )
{
F_3 ( V_2 , 0x130 , V_103 ) ;
return F_1 ( V_2 , 0x134 ) ;
}
static void F_56 ( struct V_1 * V_2 , T_1 V_103 , T_1 V_104 )
{
F_3 ( V_2 , 0x130 , V_103 ) ;
F_3 ( V_2 , 0x134 , V_104 ) ;
}
static void F_62 ( struct V_1 * V_2 , V_28 V_105 )
{
...
static T_2 F_52 ( struct V_1 * V_2 , V_28 V_110 , V_28 V_103 )
{
const T_2 V_106 = 0x128 ;
const T_2 V_107 = 0x12C ;
int V_111 = 10 ;
...
static void F_51 ( struct V_1 * V_2 , V_28 V_110 ,
...
goto V_12;
V_6 = V_87 -> V_6 ;
F_65 ( V_87 -> V_90 . V_101 != V_113 ) ;
if ( ( V_87 -> V_90 . V_91 >= 6 ) || ( V_87 -> V_90 . V_101 == V_102 ) ) {
T_1 V_114 ;
V_114 = ( 1 << V_4 -> V_82 ) ;
F_12 ( V_6 -> V_98 != V_99 ) ;
V_21 = F_66 ( V_6 -> V_115 , V_116 , & V_10 ) ;
if ( V_21 )
goto V_12;
V_10 |= V_114 << 8 ;
