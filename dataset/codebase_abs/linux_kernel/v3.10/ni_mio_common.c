...
static unsigned F_180 ( enum V_580 V_6 )
{
unsigned V_581 ;
switch ( V_6 ) {
case V_582 :
...
static void F_189 ( struct V_609 * V_610 , unsigned V_72 ,
enum V_580 V_6 )
{
...
default:
V_581 = F_180 ( V_6 ) ;
V_10 -> V_16 ( V_5 , V_72 , V_581 ) ;
}
}
static unsigned F_190 ( struct V_609 * V_610 ,
enum V_580 V_6 )
{
struct V_4 * V_5 = V_610 -> V_52 -> V_5 ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
static int F_200 ( int V_43 , int V_654 , int V_71 , unsigned long V_655 )
{
struct V_4 * V_5 = (struct V_4 * ) V_655 ;
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
if ( V_43 ) {
F_5 ( V_71 , V_656 + 2 * V_654 ) ;
return 0 ;
} else {
return F_90 ( V_656 + 2 * V_654 ) ;
}
}
...
int V_657 ;
int V_658 ;
V_658 = 0x0300 | ( ( V_74 & 0x100 ) << 3 ) | ( V_74 & 0xff ) ;
F_5 ( 0x04 , V_659 ) ;
...
F_5 ( 0x04 , V_659 ) ;
F_5 ( 0x05 , V_659 ) ;
V_658 |= ( ( F_90 ( V_198 ) & V_660 ) ? V_657 : 0 ) ;
}
F_5 ( 0x00 , V_659 ) ;
return V_658 ;
}
...
{
struct V_9 * V_10 = V_5 -> V_11 ;
V_71 [ 0 ] = V_10 -> V_661 [ F_111 ( V_247 -> V_251 ) ] ;
return 1 ;
}
static int F_204 ( struct V_4 * V_5 , unsigned int * V_71 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
V_71 [ 1 ] = V_10 -> V_662 * V_10 -> V_310 ;
V_71 [ 2 ] = V_10 -> V_663 * V_10 -> V_310 ;
return 3 ;
}
...
if ( V_664 * V_10 -> V_310 != V_71 [ 2 ] ||
V_665 * V_10 -> V_310 != V_71 [ 4 ] ) {
V_71 [ 2 ] = V_664 * V_10 -> V_310 ;
V_71 [ 4 ] = V_665 * V_10 -> V_310 ;
return - V_407 ;
}
F_33 ( F_206 ( V_664 ) |
F_207 ( V_665 ) ,
...
{
struct V_9 * V_10 = V_5 -> V_11 ;
V_71 [ 0 ] = V_10 -> V_671 [ F_111 ( V_247 -> V_251 ) ] ;
return 1 ;
}
...
type = V_59 -> V_676 [ V_106 ] ;
if ( type == V_677 )
break;
if ( V_671 [ type ] . V_674 != V_674 )
V_675 = 1 ;
V_410 += V_671 [ type ] . V_410 ;
}
V_673 = V_106 ;
V_100 -> V_257 = V_410 ;
if ( V_675 ) {
...
V_100 -> V_678 = V_678 = V_10 -> V_680 ;
V_172 = 0 ;
for ( V_106 = 0 ; V_106 < V_673 ; V_106 ++ ) {
type = V_59 -> V_676 [ V_106 ] ;
for ( V_672 = 0 ; V_672 < V_671 [ type ] . V_410 ; V_672 ++ ) {
V_678 [ V_172 ] =
...
F_210 ( V_5 , V_106 , V_100 -> V_678 [ V_106 ] / 2 ) ;
} else {
type = V_59 -> V_676 [ 0 ] ;
V_100 -> V_681 = ( 1 << V_671 [ type ] . V_674 ) - 1 ;
for ( V_172 = 0 ; V_172 < V_100 -> V_257 ; V_172 ++ )
F_210 ( V_5 , V_106 , V_100 -> V_681 / 2 ) ;
}
}
static void F_210 ( struct V_4 * V_5 , int V_74 , int V_682 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
unsigned int V_683 = 0 , V_72 = 0 , V_657 , V_658 = 0 ;
int V_106 ;
int type ;
if ( V_10 -> V_671 [ V_74 ] == V_682 )
return;
V_10 -> V_671 [ V_74 ] = V_682 ;
for ( V_106 = 0 ; V_106 < 3 ; V_106 ++ ) {
type = V_59 -> V_676 [ V_106 ] ;
if ( type == V_677 )
break;
if ( V_74 < V_671 [ type ] . V_410 ) {
V_72 = V_671 [ type ] . F_213 ( V_74 , V_682 , & V_658 ) ;
V_683 = F_214 ( V_106 ) ;
break;
}
V_74 -= V_671 [ type ] . V_410 ;
}
for ( V_657 = 1 << ( V_72 - 1 ) ; V_657 ; V_657 >>= 1 ) {
...
static int F_215 ( int V_74 , int V_682 , int * V_658 )
{
V_74 ++ ;
* V_658 = ( ( V_74 & 0x1 ) << 11 ) |
( ( V_74 & 0x2 ) << 9 ) |
( ( V_74 & 0x4 ) << 7 ) | ( ( V_74 & 0x8 ) << 5 ) | ( V_682 & 0xff ) ;
return 12 ;
}
static int F_216 ( int V_74 , int V_682 , int * V_658 )
{
* V_658 = ( ( V_74 & 0x7 ) << 8 ) | ( V_682 & 0xff ) ;
return 11 ;
}
static int F_217 ( int V_74 , int V_682 , int * V_658 )
{
* V_658 = V_682 & 0xfff ;
return 12 ;
}
static int F_218 ( int V_74 , int V_682 , int * V_658 )
{
* V_658 = ( V_682 & 0xfff ) | ( V_74 ? 0xc000 : 0xa000 ) ;
return 16 ;
}
static int F_219 ( int V_74 , int V_682 , int * V_658 )
{
* V_658 = ( ( V_74 & 0xf ) << 8 ) | ( V_682 & 0xff ) ;
return 12 ;
}
static int F_220 ( int V_74 , int V_682 , int * V_658 )
{
* V_658 = ( ( V_74 + 1 ) << 8 ) | ( V_682 & 0xff ) ;
return 12 ;
}
...
struct V_246 * V_247 , unsigned int * V_71 )
{
struct V_609 * V_610 = V_100 -> V_11 ;
return F_222 ( V_610 , V_247 , V_71 ) ;
}
...
{
struct V_609 * V_610 = V_100 -> V_11 ;
return F_226 ( V_610 , V_247 , V_71 ) ;
}
static int F_227 ( struct V_4 * V_5 , struct V_99 * V_100 )
{
int V_194 ;
struct V_609 * V_610 = V_100 -> V_11 ;
V_194 = F_21 ( V_5 , V_610 -> V_1 ,
V_44 ) ;
if ( V_194 ) {
F_19 ( V_5 ,
L_54 ) ;
...
F_228 ( V_610 , NULL , NULL , NULL , NULL ) ;
F_30 ( V_5 , V_610 -> V_1 , 1 ) ;
V_194 = F_229 ( V_610 , V_100 -> V_103 ) ;
return V_194 ;
}
...
const struct V_58 * V_59 = F_31 ( V_5 ) ;
if ( V_59 -> V_60 & V_61 )
return F_233 ( V_5 , V_172 , V_685 ) ;
else
return F_237 ( V_5 , V_172 , V_685 ) ;
}
static unsigned F_240 ( struct V_4 * V_5 ,
unsigned V_172 )
{
struct V_9 * V_10 = V_5 -> V_11 ;
const unsigned V_687 = V_172 / 3 ;
return F_241 ( V_172 ,
V_10 ->
V_688
[ V_687 ] ) ;
...
static int F_243 ( struct V_4 * V_5 , unsigned V_699 ,
enum V_700 V_701 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 V_197 = V_5 -> V_11 ;
...
static int F_252 ( unsigned V_723 ,
unsigned * V_724 ,
unsigned * V_725 ,
unsigned * V_726 )
{
...
static int F_249 ( struct V_4 * V_5 , unsigned V_685 ,
unsigned V_738 )
{
const struct V_58 * V_59 = F_31 ( V_5 ) ;
struct V_9 * V_10 = V_5 -> V_11 ;
...
{
struct V_9 * V_10 = V_5 -> V_11 ;
if ( F_259 ( V_5 , V_172 , V_685 ) == 0 )
return - V_392 ;
if ( V_172 < 4 ) {
V_10 -> V_711 &= ~ F_261 ( V_172 ) ;
V_10 -> V_711 |=
F_250 ( V_172 , V_685 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_711 ,
V_716 ) ;
} else if ( V_172 < 8 ) {
V_10 -> V_717 &= ~ F_261 ( V_172 ) ;
V_10 -> V_717 |=
F_250 ( V_172 , V_685 ) ;
V_10 -> V_16 ( V_5 , V_10 -> V_717 ,
V_722 ) ;
...
const int V_105 = V_766 ;
int V_106 ;
for ( V_106 = 0 ; V_106 < V_105 ; V_106 ++ ) {
V_130 = F_41 ( V_5 , V_767 ) ;
if ( ( V_130 & V_768 ) == 0 ) {
break;
}
F_267 ( V_769 ) ;
...
unsigned int V_78 ;
V_771 &= V_774 ;
F_269 ( V_5 , V_775 | V_776 | V_771 ) ;
if ( F_266 ( V_5 ) )
F_19 ( V_5 , L_67 ) ;
V_78 = ( F_41 ( V_5 ,
V_772 ) << 16 ) &
0xff0000 ;
V_78 |= F_41 ( V_5 , V_773 ) & 0xffff ;
return V_78 ;
}
...
V_782 = F_111 ( V_247 -> V_251 ) ;
F_38 ( V_5 , V_782 , V_784 ) ;
for ( V_168 = 0 ; V_168 < V_247 -> V_168 ; V_168 ++ ) {
V_194 = F_272 ( V_5 , & V_781 ) ;
if ( V_194 < 0 )
return V_194 ;
V_71 [ V_168 ] = V_781 ;
}
...
V_785 | V_786 ;
#if 1
F_270 ( V_5 , V_278 | V_787 ,
V_788 ) ;
F_272 ( V_5 , NULL ) ;
#else
F_270 ( V_5 , 0x400000 , V_789 ) ;
F_270 ( V_5 , V_278 | V_790 ,
V_788 ) ;
if ( F_266 ( V_5 ) )
F_19 ( V_5 , L_71 ) ;
#endif
