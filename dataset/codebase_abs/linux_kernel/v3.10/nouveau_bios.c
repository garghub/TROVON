...
static int F_70 ( struct V_15 * V_16 , struct V_5 * V_6 , T_2 V_221 , int V_141 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_54 * V_55 = F_16 ( V_22 -> V_55 ) ;
T_1 V_222 ;
T_2 V_223 ;
int V_3 ;
if ( V_6 -> V_1 [ V_221 ] <= V_141 ) {
F_14 ( V_22 , L_51
L_52 ) ;
return - V_53 ;
}
V_222 = V_6 -> V_1 [ V_221 + 1 ] ;
if ( V_222 != 36 ) {
F_14 ( V_22 , L_53 ) ;
return - V_36 ;
}
F_5 ( V_22 , L_54 ) ;
V_223 = V_221 + 2 + V_141 * V_222 ;
F_20 ( V_55 , 0x00001304 , F_34 ( V_6 -> V_1 [ V_223 ] ) ) ;
V_222 -= 4 ;
for ( V_3 = 0 ; V_3 < V_222 ; V_3 += 4 )
F_20 ( V_55 , 0x00001400 + V_3 , F_34 ( V_6 -> V_1 [ V_223 + V_3 + 4 ] ) ) ;
F_20 ( V_55 , V_224 , F_17 ( V_55 , V_224 ) | 0x18 ) ;
return 0 ;
}
static int F_71 ( struct V_15 * V_16 ,
struct V_5 * V_6 )
{
const T_1 V_225 [] = { 'H' , 'W' , 'S' , 'Q' } ;
const int V_226 = sizeof( V_225 ) ;
int V_221 ;
V_221 = F_48 ( V_6 -> V_1 , V_6 -> V_2 , V_225 , V_226 ) ;
if ( ! V_221 )
return 0 ;
return F_70 ( V_16 , V_6 , V_221 + V_226 , 0 ) ;
}
...
int V_229 = V_230 ;
if ( V_6 -> V_30 . V_231 )
return V_6 -> V_30 . V_231 ;
while ( V_229 ) {
V_228 = F_48 ( & V_6 -> V_1 [ V_119 ] , V_229 ,
V_227 , 8 ) ;
if ( ! V_228 )
return NULL ;
V_119 += V_228 ;
if ( ! F_1 ( & V_6 -> V_1 [ V_119 ] , V_232 ) )
break;
V_229 -= V_119 ;
V_119 ++ ;
}
F_5 ( V_22 , L_55 ) ;
return V_6 -> V_30 . V_231 = & V_6 -> V_1 [ V_119 ] ;
}
static bool F_73 ( struct V_15 * V_16 )
{
struct V_21 * V_22 = V_21 ( V_16 ) ;
struct V_233 * V_6 = V_233 ( V_22 -> V_55 ) ;
...
V_110 -> V_1 = V_6 -> V_1 ;
V_110 -> V_2 = V_6 -> V_235 ;
V_110 -> V_12 = V_6 -> V_123 . V_236 ;
V_110 -> V_108 = V_6 -> V_123 . V_237 ;
if ( V_6 -> V_238 ) {
V_110 -> type = V_142 ;
...
return V_59 ;
if ( V_6 -> V_12 < 5 )
V_6 -> V_81 = F_77 ( V_16 , 0 , V_243 ) & 0x40 ;
