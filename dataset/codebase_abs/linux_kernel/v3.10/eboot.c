...
V_200 -> V_230 = ( unsigned long ) V_4 ;
V_200 -> V_231 = V_12 ;
V_200 -> V_232 = V_16 ;
V_200 -> V_233 = ( unsigned long ) V_225 ;
V_200 -> V_234 = V_26 ;
#ifdef F_16
V_200 -> V_235 = ( unsigned long ) V_4 >> 32 ;
V_200 -> V_236 = ( unsigned long ) V_225 >> 32 ;
#endif
V_14 = F_2 ( V_4 -> V_18 -> V_237 ,
V_148 , V_15 ) ;
if ( V_14 != V_21 )
goto V_227;
V_49 -> V_238 = 32 * 1024 ;
...
T_2 V_14 ;
V_35 = V_58 -> V_259 ;
V_30 = F_9 ( V_58 -> V_260 , V_33 ) / V_33 ;
V_14 = F_11 ( V_4 -> V_18 -> V_42 ,
V_43 , V_20 ,
V_30 , & V_35 ) ;
if ( V_14 != V_21 ) {
V_14 = F_12 ( V_58 -> V_260 , V_58 -> V_261 ,
& V_35 ) ;
if ( V_14 != V_21 )
F_3 ( L_16 ) ;
}
...
V_263 -> V_26 = 0x800 ;
V_14 = F_12 ( V_263 -> V_26 , 8 , ( unsigned long * ) & V_263 -> V_266 ) ;
if ( V_14 != V_21 ) {
F_3 ( L_18 ) ;
goto V_22;
}
