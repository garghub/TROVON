...
F_52 ( & V_6 -> V_98 ) ;
if ( V_55 ) {
F_49 ( V_104 , & V_6 -> V_101 ) ;
F_53 ( V_6 -> V_105 ) ;
F_54 ( V_6 -> V_106 ,
F_55 ( V_107 , & V_6 -> V_101 ) ) ;
}
F_56 ( V_6 ) ;
F_48 ( & V_6 -> V_99 ) ;
F_16 ( V_6 -> V_24 ) ;
...
{
struct V_86 * V_87 = NULL , * V_112 ;
struct V_64 * V_89 ;
int error , V_113 ;
V_87 = F_15 ( sizeof( struct V_86 ) , V_52 ) ;
if ( ! V_87 )
return - V_53 ;
error = F_59 ( V_6 -> V_114 , & V_89 , & V_113 ) ;
if ( error < 0 )
goto V_115;
F_48 ( & V_6 -> V_99 ) ;
if ( ! F_60 ( V_6 ) ) {
...
if ( V_112 ) {
F_12 ( V_6 , L_20 ,
( unsigned long long ) V_112 -> V_80 , V_112 -> V_88 ) ;
F_16 ( V_112 -> V_89 ) ;
F_16 ( V_112 ) ;
}
F_49 ( V_118 , & V_6 -> V_101 ) ;
F_53 ( V_6 -> V_105 ) ;
return 0 ;
V_115:
F_16 ( V_87 ) ;
