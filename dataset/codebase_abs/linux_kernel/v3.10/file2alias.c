...
static bool F_50 ( const char * V_57 , unsigned V_255 , const char * V_256 )
{
if ( V_255 != strlen ( V_256 ) )
return false ;
return memcmp ( V_57 , V_256 , V_255 ) == 0 ;
}
static void F_51 ( void * V_7 , unsigned long V_5 ,
unsigned long V_6 ,
const char * V_4 ,
void * V_124 ,
struct V_16 * V_17 )
...
unsigned int V_8 ;
char V_18 [ 500 ] ;
int (* F_52)( const char * , void * V_257 , char * V_18 ) = V_124 ;
F_2 ( V_17 -> V_57 , V_4 , V_5 , V_6 , V_7 ) ;
V_5 -= V_6 ;
for ( V_8 = 0 ; V_8 < V_5 ; V_8 += V_6 ) {
if ( F_52 ( V_17 -> V_57 , V_7 + V_8 , V_18 ) ) {
F_7 ( & V_17 -> V_40 ,
L_30 , V_18 ) ;
}
}
}
void F_53 ( struct V_16 * V_17 , struct V_258 * V_259 ,
T_3 * V_260 , const char * V_261 )
{
void * V_7 ;
char * V_262 = NULL ;
const char * V_57 ;
unsigned int V_255 ;
if ( ! V_260 -> V_263 || F_54 ( V_259 , V_260 ) >= V_259 -> V_264 )
return;
if ( F_55 ( V_260 -> V_265 ) != V_266 )
return;
V_57 = strstr ( V_261 , L_114 ) ;
if ( ! V_57 )
return;
V_57 += strlen ( L_114 ) ;
V_255 = strlen ( V_57 ) ;
if ( V_255 < strlen ( L_115 ) )
return;
if ( strcmp ( V_57 + V_255 - strlen ( L_115 ) , L_115 ) )
return;
V_255 -= strlen ( L_115 ) ;
if ( V_259 -> V_267 [ F_54 ( V_259 , V_260 ) ] . V_268 & V_269 ) {
V_262 = calloc ( 1 , V_260 -> V_270 ) ;
V_7 = V_262 ;
} else {
V_7 = ( void * ) V_259 -> V_271
+ V_259 -> V_267 [ F_54 ( V_259 , V_260 ) ] . V_272
+ V_260 -> V_273 ;
}
if ( F_50 ( V_57 , V_255 , L_31 ) )
F_10 ( V_7 , V_260 -> V_270 , V_17 ) ;
else if ( F_50 ( V_57 , V_255 , L_60 ) )
F_21 ( V_7 , V_260 -> V_270 , V_17 ) ;
else if ( F_50 ( V_57 , V_255 , L_116 ) )
F_22 ( V_7 , V_260 -> V_270 , V_17 ) ;
else {
struct V_274 * * V_242 ;
F_56 ( V_275 ) ;
for ( V_242 = V_276 ; V_242 < V_277 ; V_242 ++ ) {
if ( F_50 ( V_57 , V_255 , ( * V_242 ) -> V_4 ) ) {
F_51 ( V_7 , V_260 -> V_270 , ( * V_242 ) -> V_6 ,
...
void F_57 ( struct V_278 * V_279 , struct V_16 * V_17 )
{
F_7 ( V_279 , L_9 ) ;
F_58 ( V_279 , V_17 -> V_40 . V_242 , V_17 -> V_40 . V_280 ) ;
