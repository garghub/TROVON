...
static int F_32 ( struct V_5 * V_38 )
{
struct V_4 * V_5 = F_33 ( V_38 ) ;
struct V_12 * V_13 = F_9 ( V_5 ) ;
if ( V_13 -> type == V_17 )
return F_22 ( V_5 ) ;
return 0 ;
...
struct V_12 * V_13 ;
struct V_42 * V_36 ;
const char * V_51 = F_35 ( V_5 ) ;
char * V_52 , * V_53 ;
int error ;
V_13 = F_36 ( sizeof( struct V_12 ) , V_54 ) ;
if ( ! V_13 )
return - V_55 ;
V_5 -> V_56 = V_13 ;
V_13 -> V_36 = V_36 = F_37 () ;
...
sprintf ( V_53 , L_8 ,
V_21 , V_62 ) ;
} else if ( ! strcmp ( V_51 , V_63 ) ||
! strcmp ( V_51 , V_64 ) ) {
V_13 -> type = V_65 ;
strcpy ( V_52 , V_66 ) ;
sprintf ( V_53 , L_8 ,
V_21 , V_67 ) ;
} else if ( ! strcmp ( V_51 , V_68 ) ) {
V_13 -> type = V_17 ;
strcpy ( V_52 , V_69 ) ;
sprintf ( V_53 , L_8 ,
V_21 , V_24 ) ;
...
if ( error )
goto V_70;
snprintf ( V_13 -> V_71 , sizeof( V_13 -> V_71 ) , L_10 , V_51 ) ;
V_36 -> V_52 = V_52 ;
V_36 -> V_71 = V_13 -> V_71 ;
V_36 -> V_72 . V_73 = V_74 ;
V_36 -> V_72 . V_75 = V_13 -> type ;
V_36 -> V_38 . V_76 = & V_5 -> V_38 ;
switch ( V_13 -> type ) {
case V_60 :
V_36 -> V_77 [ 0 ] = F_40 ( V_78 ) ;
F_41 ( V_48 , V_36 -> V_47 ) ;
break;
case V_65 :
V_36 -> V_77 [ 0 ] = F_40 ( V_78 ) ;
