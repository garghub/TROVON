...
static struct V_20 * F_199 ( struct V_178 * V_179 )
{
...
{
struct V_20 * V_21 = F_199 ( V_179 ) ;
return F_201 ( V_184 , V_185 , L_8 , ( bool ) ! ( V_21 -> V_29 & V_69 ) ) ;
}
static T_3 F_202 ( struct V_178 * V_179 ,
struct V_182 * V_183 , char * V_184 )
{
struct V_20 * V_21 = F_199 ( V_179 ) ;
return F_201 ( V_184 , V_185 , L_8 , V_21 -> V_172 ) ;
}
...
int V_190 ;
F_137 ( & V_21 -> V_162 ) ;
V_190 = F_201 ( V_184 , V_185 , L_8 , V_21 -> V_191 -> V_122 ) ;
F_138 ( & V_21 -> V_162 ) ;
return V_190 ;
}
static struct V_192 * F_210 ( struct V_20 * V_21 )
{
struct V_192 * V_121 ;
V_121 = F_211 ( V_17 ) ;
if ( ! V_121 )
...
int V_190 ;
F_137 ( & V_21 -> V_162 ) ;
V_190 = F_217 ( V_184 , V_185 , V_21 -> V_191 -> V_124 ) ;
F_138 ( & V_21 -> V_162 ) ;
V_190 += F_201 ( V_184 + V_190 , V_185 - V_190 , L_12 ) ;
return V_190 ;
}
...
if ( ! V_121 )
goto V_87;
if ( ! F_233 ( & V_121 -> V_124 , V_203 ) )
goto V_87;
F_234 ( V_121 -> V_124 , V_204 ) ;
return V_121 ;
V_87:
F_215 ( V_121 ) ;
return NULL ;
...
return false ;
if ( ! F_241 ( V_209 -> V_124 , V_210 -> V_124 ) )
return false ;
return true ;
}
...
F_252 ( V_13 ) ;
F_138 ( & V_15 ) ;
F_254 ( & V_30 -> V_215 , F_259 ) ;
if ( V_222 ) {
F_215 ( V_21 -> V_191 ) ;
F_134 ( V_21 ) ;
}
}
static void F_263 ( struct V_19 * V_30 )
{
struct V_20 * V_21 = V_30 -> V_21 ;
...
static void F_264 ( struct V_19 * V_30 , struct V_20 * V_21 ,
struct V_12 * V_13 )
{
F_265 ( ( unsigned long ) V_30 & V_227 ) ;
...
F_124 ( & V_30 -> V_223 ) ;
F_124 ( & V_30 -> V_134 ) ;
F_192 ( & V_30 -> V_70 , F_261 ) ;
}
static void F_266 ( struct V_19 * V_30 )
{
struct V_20 * V_21 = V_30 -> V_21 ;
F_20 ( & V_21 -> V_162 ) ;
if ( ! F_48 ( & V_30 -> V_223 ) )
...
F_263 ( V_30 ) ;
F_267 ( & V_30 -> V_223 , & V_21 -> V_224 ) ;
}
static struct V_19 * F_268 ( struct V_20 * V_21 ,
...
if ( ! V_13 )
return NULL ;
V_30 = F_269 ( V_221 , V_17 , V_13 -> V_22 ) ;
if ( ! V_30 ) {
F_252 ( V_13 ) ;
return NULL ;
}
F_264 ( V_30 , V_21 , V_13 ) ;
return V_30 ;
}
static void F_270 ( struct V_19 * V_30 )
{
F_20 ( & V_15 ) ;
if ( V_30 ) {
F_252 ( V_30 -> V_13 ) ;
...
static bool F_271 ( const struct V_192 * V_121 , int V_22 ,
int V_228 , T_8 * V_124 )
{
if ( ! V_218 || V_121 -> V_193 )
goto V_229;
F_272 ( V_124 , F_273 ( V_22 ) , V_121 -> V_124 ) ;
if ( V_228 >= 0 )
F_274 ( V_228 , V_124 ) ;
if ( F_275 ( V_124 ) )
goto V_229;
F_272 ( V_124 , V_121 -> V_124 , V_219 [ V_22 ] ) ;
return ! F_241 ( V_124 , V_121 -> V_124 ) ;
V_229:
F_234 ( V_124 , V_121 -> V_124 ) ;
return false ;
}
static struct V_19 * F_276 ( struct V_20 * V_21 ,
int V_22 ,
struct V_19 * V_30 )
{
struct V_19 * V_230 ;
F_20 ( & V_21 -> V_162 ) ;
F_266 ( V_30 ) ;
V_230 = F_277 ( V_21 -> V_23 [ V_22 ] ) ;
F_278 ( V_21 -> V_23 [ V_22 ] , V_30 ) ;
return V_230 ;
}
...
goto V_236;
F_212 ( V_231 , V_121 ) ;
F_272 ( V_231 -> V_124 , V_231 -> V_124 , V_204 ) ;
F_212 ( V_232 , V_231 ) ;
F_190 () ;
F_137 ( & V_15 ) ;
V_234 = F_268 ( V_21 , V_231 ) ;
if ( ! V_234 )
goto V_237;
F_207 (node) {
if ( F_271 ( V_121 , V_22 , - 1 , V_232 -> V_124 ) ) {
V_233 [ V_22 ] = F_268 ( V_21 , V_232 ) ;
if ( ! V_233 [ V_22 ] )
goto V_237;
} else {
V_234 -> V_68 ++ ;
...
F_138 ( & V_15 ) ;
F_137 ( & V_21 -> V_162 ) ;
F_212 ( V_21 -> V_191 , V_231 ) ;
F_207 (node)
V_233 [ V_22 ] = F_276 ( V_21 , V_22 , V_233 [ V_22 ] ) ;
F_266 ( V_234 ) ;
F_279 ( V_21 -> V_234 , V_234 ) ;
F_138 ( & V_21 -> V_162 ) ;
F_207 (node)
F_78 ( V_233 [ V_22 ] ) ;
F_78 ( V_234 ) ;
...
static void F_280 ( struct V_20 * V_21 , int V_54 ,
bool V_239 )
{
int V_22 = F_105 ( V_54 ) ;
...
if ( V_21 -> V_191 -> V_193 )
goto V_164;
F_212 ( V_241 , V_21 -> V_191 ) ;
V_30 = F_22 ( V_21 , V_22 ) ;
if ( F_271 ( V_21 -> V_191 , V_22 , V_240 , V_124 ) ) {
if ( F_241 ( V_124 , V_30 -> V_13 -> V_121 -> V_124 ) )
goto V_164;
} else {
if ( V_30 == V_21 -> V_234 )
goto V_164;
...
F_137 ( & V_21 -> V_162 ) ;
V_230 = F_276 ( V_21 , V_22 , V_30 ) ;
goto V_164;
V_243:
F_79 ( & V_21 -> V_234 -> V_13 -> V_67 ) ;
F_75 ( V_21 -> V_234 ) ;
F_80 ( & V_21 -> V_234 -> V_13 -> V_67 ) ;
V_230 = F_276 ( V_21 , V_22 , V_21 -> V_234 ) ;
V_164:
F_138 ( & V_21 -> V_162 ) ;
F_78 ( V_230 ) ;
}
...
return F_214 ( V_21 , V_248 [ V_244 ] ) ;
}
}
static int F_285 ( int V_77 , unsigned int V_29 ,
const char * V_99 )
{
...
F_176 ( L_14 ,
V_77 , V_99 , 1 , V_249 ) ;
return F_286 ( V_77 , 1 , V_249 ) ;
}
struct V_20 * F_287 ( const char * V_252 ,
unsigned int V_29 ,
int V_77 ,
struct V_253 * V_254 ,
const char * V_255 , ... )
...
va_end ( args ) ;
V_77 = V_77 ? : V_258 ;
V_77 = F_285 ( V_77 , V_29 , V_21 -> V_99 ) ;
V_21 -> V_29 = V_29 ;
V_21 -> V_172 = V_77 ;
F_247 ( & V_21 -> V_162 ) ;
F_166 ( & V_21 -> V_79 , 0 ) ;
...
F_124 ( & V_21 -> V_163 ) ;
F_124 ( & V_21 -> V_135 ) ;
F_288 ( & V_21 -> V_161 , V_255 , V_254 , 0 ) ;
F_124 ( & V_21 -> V_159 ) ;
if ( F_282 ( V_21 ) < 0 )
goto V_257;
if ( V_29 & V_259 ) {
...
goto V_260;
V_133 -> V_146 = V_21 ;
V_133 -> V_52 = F_289 ( F_155 , V_133 , L_15 ,
V_21 -> V_99 ) ;
if ( F_129 ( V_133 -> V_52 ) ) {
F_134 ( V_133 ) ;
goto V_260;
...
F_167 (pwq, wq) {
int V_263 ;
for ( V_263 = 0 ; V_263 < V_27 ; V_263 ++ ) {
if ( F_10 ( V_30 -> V_76 [ V_263 ] ) ) {
F_138 ( & V_21 -> V_162 ) ;
return;
}
}
...
F_207 (node) {
V_30 = F_277 ( V_21 -> V_23 [ V_22 ] ) ;
F_291 ( V_21 -> V_23 [ V_22 ] , NULL ) ;
F_78 ( V_30 ) ;
}
V_30 = V_21 -> V_234 ;
V_21 -> V_234 = NULL ;
...
void F_204 ( struct V_20 * V_21 , int V_77 )
{
struct V_19 * V_30 ;
if ( F_10 ( V_21 -> V_29 & V_196 ) )
return;
V_77 = F_285 ( V_77 , V_21 -> V_29 , V_21 -> V_99 ) ;
F_137 ( & V_21 -> V_162 ) ;
V_21 -> V_172 = V_77 ;
F_167 (pwq, wq)
F_263 ( V_30 ) ;
...
bool F_293 ( int V_54 , struct V_20 * V_21 )
{
struct V_19 * V_30 ;
bool V_14 ;
F_206 () ;
...
unsigned int F_295 ( struct V_2 * V_6 )
{
struct V_12 * V_13 ;
unsigned long V_29 ;
unsigned int V_14 = 0 ;
...
void F_296 ( const char * V_252 , ... )
{
struct V_50 * V_50 = F_101 () ;
T_9 args ;
if ( V_50 ) {
va_start ( args , V_252 ) ;
vsnprintf ( V_50 -> V_266 , sizeof( V_50 -> V_266 ) , V_252 , args ) ;
va_end ( args ) ;
V_50 -> V_267 = true ;
}
}
void F_297 ( const char * V_268 , struct V_53 * V_52 )
{
T_1 * V_175 = NULL ;
char V_99 [ V_269 ] = { } ;
char V_266 [ V_270 ] = { } ;
...
return;
V_50 = F_298 ( V_52 ) ;
F_299 ( & V_175 , & V_50 -> V_61 , sizeof( V_175 ) ) ;
F_299 ( & V_30 , & V_50 -> V_91 , sizeof( V_30 ) ) ;
F_299 ( & V_21 , & V_30 -> V_21 , sizeof( V_21 ) ) ;
F_299 ( V_99 , V_21 -> V_99 , sizeof( V_99 ) - 1 ) ;
F_299 ( & V_267 , & V_50 -> V_267 , sizeof( V_267 ) ) ;
if ( V_267 )
F_299 ( V_266 , V_50 -> V_266 , sizeof( V_266 ) - 1 ) ;
if ( V_175 || V_99 [ 0 ] || V_266 [ 0 ] ) {
F_300 ( L_16 , V_268 , V_99 , V_175 ) ;
if ( V_266 [ 0 ] )
F_301 ( L_17 , V_266 ) ;
F_301 ( L_12 ) ;
}
...
F_79 ( & V_13 -> V_67 ) ;
F_304 (worker, wi, pool) {
unsigned int V_272 = V_50 -> V_29 ;
if ( V_272 & V_107 )
F_60 ( V_50 -> V_52 ) ;
F_9 ( ! ( V_272 & V_126 ) ) ;
V_272 |= V_143 ;
V_272 &= ~ V_126 ;
F_306 ( V_50 -> V_29 ) = V_272 ;
}
F_80 ( & V_13 -> V_67 ) ;
}
static void F_307 ( struct V_12 * V_13 , int V_54 )
{
static T_8 V_124 ;
struct V_50 * V_50 ;
int V_271 ;
F_20 ( & V_13 -> V_118 ) ;
if ( ! F_308 ( V_54 , V_13 -> V_121 -> V_124 ) )
return;
F_272 ( & V_124 , V_13 -> V_121 -> V_124 , V_273 ) ;
if ( F_309 ( & V_124 ) != 1 )
return;
F_304 (worker, wi, pool)
F_9 ( F_131 ( V_50 -> V_52 ,
...
static int T_10 F_310 ( struct V_274 * V_275 ,
unsigned long V_276 ,
void * V_277 )
{
int V_54 = ( unsigned long ) V_277 ;
struct V_12 * V_13 ;
struct V_20 * V_21 ;
int V_278 ;
switch ( V_276 & ~ V_279 ) {
...
F_280 ( V_21 , V_54 , true ) ;
F_138 ( & V_15 ) ;
break;
}
return V_284 ;
}
static int T_10 F_312 ( struct V_274 * V_275 ,
unsigned long V_276 ,
void * V_277 )
{
int V_54 = ( unsigned long ) V_277 ;
...
case V_286 :
F_162 ( & V_285 , F_302 ) ;
F_108 ( V_54 , V_287 , & V_285 ) ;
F_137 ( & V_15 ) ;
F_146 (wq, &workqueues, list)
F_280 ( V_21 , V_54 , false ) ;
F_138 ( & V_15 ) ;
F_182 ( & V_285 ) ;
break;
}
...
static void F_313 ( struct V_2 * V_6 )
{
struct V_288 * V_289 = F_160 ( V_6 , struct V_288 , V_6 ) ;
V_289 -> V_14 = V_289 -> V_175 ( V_289 -> V_290 ) ;
}
long F_314 ( int V_54 , long (* V_175)( void * ) , void * V_290 )
{
struct V_288 V_289 = { . V_175 = V_175 , . V_290 = V_290 } ;
F_162 ( & V_289 . V_6 , F_313 ) ;
F_193 ( V_54 , & V_289 . V_6 ) ;
F_182 ( & V_289 . V_6 ) ;
return V_289 . V_14 ;
}
void F_315 ( void )
...
static void T_5 F_318 ( void )
{
T_11 * V_292 ;
int V_22 , V_54 ;
F_207 (node)
V_235 = F_319 ( V_235 , V_22 + 1 ) ;
if ( F_320 () <= 1 )
return;
if ( V_293 ) {
F_321 ( L_18 ) ;
...
V_242 = F_211 ( V_17 ) ;
F_265 ( ! V_242 ) ;
V_292 = F_123 ( V_235 * sizeof( V_292 [ 0 ] ) , V_17 ) ;
F_265 ( ! V_292 ) ;
F_207 (node)
F_265 ( ! F_322 ( & V_292 [ V_22 ] , V_17 ,
F_323 ( V_22 ) ? V_22 : V_211 ) ) ;
F_283 (cpu) {
V_22 = F_105 ( V_54 ) ;
if ( F_10 ( V_22 == V_211 ) ) {
F_176 ( L_19 , V_54 ) ;
...
F_324 ( V_54 , V_292 [ V_22 ] ) ;
}
V_219 = V_292 ;
V_218 = true ;
}
static int T_5 F_325 ( void )
{
int V_294 [ V_295 ] = { 0 , V_296 } ;
int V_263 , V_54 ;
F_326 ( ( 1LU << ( V_297 - V_35 ) ) <
V_298 * V_295 ) ;
F_10 ( F_327 ( struct V_19 ) < F_327 (long long) ) ;
V_221 = F_328 ( V_19 , V_299 ) ;
F_329 ( F_310 , V_300 ) ;
F_330 ( F_312 , V_301 ) ;
F_318 () ;
F_283 (cpu) {
...
F_265 ( F_242 ( V_13 ) ) ;
V_13 -> V_54 = V_54 ;
F_234 ( V_13 -> V_121 -> V_124 , F_331 ( V_54 ) ) ;
V_13 -> V_121 -> V_122 = V_294 [ V_263 ++ ] ;
...
for ( V_263 = 0 ; V_263 < V_295 ; V_263 ++ ) {
struct V_192 * V_121 ;
F_265 ( ! ( V_121 = F_211 ( V_17 ) ) ) ;
V_121 -> V_122 = V_294 [ V_263 ] ;
V_248 [ V_263 ] = V_121 ;
}
V_174 = F_332 ( L_20 , 0 , 0 ) ;
V_287 = F_332 ( L_21 , V_245 , 0 ) ;
V_302 = F_332 ( L_22 , 0 , 0 ) ;
V_303 = F_332 ( L_23 , V_69 ,
V_250 ) ;
V_304 = F_332 ( L_24 ,
V_226 , 0 ) ;
F_265 ( ! V_174 || ! V_287 || ! V_302 ||
! V_303 || ! V_304 ) ;
return 0 ;
}
