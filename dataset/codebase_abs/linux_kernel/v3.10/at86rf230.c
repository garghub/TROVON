...
static T_2 F_46 ( int V_96 , void * V_4 )
{
F_47 ( V_96 ) ;
return F_44 ( V_96 , V_4 ) ;
}
...
return V_33 ;
if ( ! V_6 ) {
F_51 ( & V_2 -> V_16 -> V_17 , L_14 ) ;
return - V_48 ;
}
return 0 ;
}
static void F_52 ( struct V_115 * V_16 )
{
...
static int F_54 ( struct V_115 * V_16 )
{
struct V_100 * V_101 ;
struct V_29 * V_17 ;
struct V_1 * V_2 ;
...
F_60 ( V_16 , V_2 ) ;
F_52 ( V_16 ) ;
V_33 = F_61 ( V_2 -> V_116 , L_17 ) ;
if ( V_33 )
goto V_131;
if ( F_62 ( V_2 -> V_117 ) ) {
V_33 = F_61 ( V_2 -> V_117 , L_18 ) ;
if ( V_33 )
goto V_132;
}
V_33 = F_63 ( V_2 -> V_116 , 1 ) ;
if ( V_33 )
goto V_133;
if ( F_62 ( V_2 -> V_117 ) ) {
V_33 = F_63 ( V_2 -> V_117 , 0 ) ;
if ( V_33 )
goto V_133;
}
F_22 ( 1 ) ;
...
F_50 ( & V_16 -> V_17 , L_23 , V_124 , V_2 -> V_139 ) ;
if ( ! V_123 ) {
V_33 = - V_140 ;
goto V_133;
}
...
static int F_73 ( struct V_115 * V_16 )
{
struct V_1 * V_2 = F_53 ( V_16 ) ;
F_74 ( V_2 -> V_17 ) ;
F_68 ( V_16 -> V_96 , V_2 ) ;
