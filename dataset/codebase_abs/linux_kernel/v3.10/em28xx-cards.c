...
case V_194 :
V_174 = L_53 ;
if ( F_46 ( V_8 -> V_163 -> V_195 . V_196 )
== 0xeb1a ) {
T_1 V_197 = V_8 -> V_163 -> V_195 . V_198 ;
if ( F_46 ( V_197 ) == 0x2710 )
V_174 = L_50 ;
else if ( F_46 ( V_197 ) == 0x2820 )
V_174 = L_54 ;
}
break;
case V_199 :
...
F_51 ( & V_8 -> V_211 ) ;
if ( V_8 -> V_15 . V_27 )
V_172 = F_52 ( V_8 , 0 , V_212 ) ;
else
V_172 = F_52 ( V_8 , 0 , V_213 ) ;
if ( V_172 < 0 ) {
F_15 ( L_68 ,
V_210 , V_172 ) ;
goto V_214;
...
if ( V_8 -> V_221 . V_222 != V_223 ) {
F_53 ( V_171 , & V_224 ,
V_225 , 0 , 1 , 1 , 1 ) ;
F_53 ( V_171 , & V_224 ,
V_226 , 0 , 0x1f , 1 , 0x1f ) ;
} else {
F_54 ( F_55 ( V_171 , V_225 ) ,
V_227 , V_8 ) ;
F_54 ( F_55 ( V_171 , V_226 ) ,
V_227 , V_8 ) ;
}
F_56 ( V_8 ) ;
F_57 ( & V_8 -> V_228 . V_229 ) ;
F_57 ( & V_8 -> V_230 . V_229 ) ;
if ( V_8 -> V_15 . V_129 ) {
...
struct V_7 * V_8 = NULL ;
int V_172 ;
bool V_235 = false , V_236 = false , V_157 = false ;
int V_102 , V_237 , V_238 ;
const int V_239 = V_168 -> V_240 [ 0 ] . V_241 . V_242 ;
char * V_243 ;
V_163 = F_60 ( F_61 ( V_168 ) ) ;
do {
V_237 = F_62 ( & V_165 , V_244 ) ;
if ( V_237 >= V_244 ) {
F_47 ( V_245 L_74 ,
V_244 ) ;
V_172 = - V_246 ;
...
} while ( F_63 ( V_237 , & V_165 ) );
if ( V_168 -> V_240 [ 0 ] . V_241 . V_248 == V_249 ) {
F_64 ( V_245 L_75
L_76 ,
F_46 ( V_163 -> V_195 . V_196 ) ,
F_46 ( V_163 -> V_195 . V_198 ) ,
V_239 ,
V_168 -> V_240 [ 0 ] . V_241 . V_248 ) ;
V_172 = - V_208 ;
goto V_250;
}
V_8 = F_65 ( sizeof( * V_8 ) , V_251 ) ;
if ( V_8 == NULL ) {
F_64 ( V_245 L_77 ) ;
V_172 = - V_246 ;
goto V_250;
...
for ( V_102 = 0 ; V_102 < V_168 -> V_253 ; V_102 ++ ) {
int V_254 ;
for ( V_254 = 0 ; V_254 < V_168 -> V_240 [ V_102 ] . V_241 . V_255 ; V_254 ++ ) {
const struct V_256 * V_257 ;
int V_258 , V_259 ;
V_257 = & V_168 -> V_240 [ V_102 ] . V_260 [ V_254 ] . V_241 ;
V_258 = F_46 ( V_257 -> V_261 ) ;
V_259 = V_258 & 0x7ff ;
if ( V_163 -> V_243 == V_262 )
V_259 = V_259 * F_67 ( V_258 ) ;
if ( F_68 ( V_257 ) ) {
switch ( V_257 -> V_263 ) {
case 0x82 :
V_236 = true ;
...
if ( V_259 > V_8 -> V_266 ) {
V_157 = true ;
V_8 -> V_267 = V_257 -> V_263 ;
V_8 -> V_266 = V_259 ;
V_8 -> V_268 = V_102 ;
}
} else {
V_157 = true ;
V_8 -> V_269 = V_257 -> V_263 ;
}
}
break;
}
...
V_8 -> V_164 = V_237 ;
V_8 -> V_18 = V_234 -> V_275 ;
V_8 -> V_276 = - 1 ;
V_8 -> V_207 = V_235 && ! ( V_236 || V_157 ) ;
V_8 -> V_156 = V_235 ;
V_8 -> V_277 = V_239 ;
for ( V_102 = 0 ; V_102 < V_163 -> V_278 -> V_241 . V_279 ; V_102 ++ ) {
struct V_167 * V_280 = V_163 -> V_278 -> V_168 [ V_102 ] ;
if ( V_280 -> V_240 [ 0 ] . V_241 . V_248 == V_249 ) {
V_8 -> V_155 = 1 ;
break;
}
}
...
V_8 -> V_281 = V_168 -> V_253 ;
if ( ( unsigned ) V_282 [ V_237 ] < V_115 )
V_8 -> V_18 = V_282 [ V_237 ] ;
F_71 ( V_168 , V_8 ) ;
F_72 ( V_8 ) ;
F_44 ( & V_8 -> V_283 ) ;
F_73 ( & V_8 -> V_283 ) ;
V_172 = F_43 ( V_8 , V_163 , V_168 , V_237 ) ;
if ( V_172 ) {
goto V_284;
}
if ( V_285 < 0 ) {
...
if ( V_236 ) {
if ( ! V_8 -> V_264 || ( V_238 && V_8 -> V_265 ) )
V_8 -> V_286 = 1 ;
F_19 ( L_97 ,
V_8 -> V_286 ? L_98 : L_99 ) ;
}
if ( V_157 ) {
if ( ! V_8 -> V_267 || ( V_238 && V_8 -> V_269 ) )
V_8 -> V_287 = 1 ;
F_19 ( L_100 ,
V_8 -> V_287 ? L_98 : L_99 ) ;
if ( V_8 -> V_287 ) {
V_172 = F_74 ( V_8 , V_288 ,
V_8 -> V_287 ,
V_289 ,
512 ,
V_290 ) ;
