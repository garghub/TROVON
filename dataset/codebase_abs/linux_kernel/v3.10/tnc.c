...
V_24 = F_37 ( V_2 , V_19 , V_43 ) ;
if ( V_24 )
return V_24 ;
V_24 = F_28 ( V_2 , V_19 , V_43 ) ;
return V_24 ;
}
static int F_38 ( const struct V_1 * V_2 , void * V_49 , int type ,
...
V_24 = F_41 ( V_2 , V_3 , V_49 , V_4 , V_22 , 1 ) ;
if ( V_24 ) {
F_5 ( L_3 ,
type , V_3 , V_4 , V_24 ) ;
return V_24 ;
}
if ( F_42 ( V_52 -> V_55 ) != V_56 )
return 0 ;
if ( V_52 -> V_57 != type )
return 0 ;
V_50 = F_42 ( V_52 -> V_22 ) ;
...
! V_2 -> V_61 )
return 1 ;
V_53 = F_43 ( V_62 , V_49 + 8 , V_50 - 8 ) ;
V_54 = F_42 ( V_52 -> V_53 ) ;
if ( V_53 != V_54 )
return 0 ;
return 1 ;
}
static int F_44 ( struct V_1 * V_2 , const union V_63 * V_48 ,
struct V_18 * V_19 , void * V_43 )
{
int V_64 ;
F_45 ( V_48 , L_4 , V_19 -> V_3 , V_19 -> V_4 ) ;
V_64 = F_38 ( V_2 , V_43 , F_46 ( V_2 , V_48 ) , V_19 -> V_22 , V_19 -> V_3 ,
V_19 -> V_4 ) ;
if ( V_64 == 1 ) {
union V_63 V_65 ;
...
if ( ! V_46 )
return - V_12 ;
V_24 = F_44 ( V_2 , & V_19 -> V_48 , V_19 , V_46 ) ;
if ( V_24 < 0 )
goto V_70;
if ( V_24 == 0 ) {
V_24 = V_79 ;
...
F_68 ( L_10 , V_17 -> V_34 , * V_36 ) ;
* V_27 = V_17 ;
return 1 ;
}
static int F_69 ( struct V_1 * V_2 , const union V_63 * V_48 ,
struct V_16 * * V_27 , int * V_36 )
{
int V_24 , V_89 ;
struct V_16 * V_17 ;
...
static int F_70 ( struct V_1 * V_2 , int V_3 , int V_91 )
{
int V_92 , V_93 ;
V_93 = V_2 -> V_93 ;
F_71 () ;
...
int F_72 ( struct V_1 * V_2 , const union V_63 * V_48 ,
...
V_24 = F_44 ( V_2 , V_48 , & V_19 , V_43 ) ;
if ( V_24 <= 0 || F_70 ( V_2 , V_19 . V_3 , V_91 ) ) {
V_96 = 1 ;
goto V_98;
}
return 0 ;
...
int F_76 ( struct V_1 * V_2 , struct V_101 * V_102 )
{
int V_36 , V_24 = 0 , V_3 = - 1 , V_82 ( V_4 ) ;
int V_82 ( V_22 ) ;
unsigned int V_103 = F_77 ( V_2 , & V_102 -> V_48 ) ;
struct V_16 * V_17 ;
V_102 -> V_104 = 0 ;
V_102 -> V_105 = 0 ;
V_102 -> V_106 = 0 ;
...
V_19 = & V_17 -> V_20 [ V_36 ] ;
V_48 = & V_19 -> V_48 ;
if ( F_78 ( V_2 , V_48 ) != F_78 ( V_2 , & V_102 -> V_48 ) ||
F_46 ( V_2 , V_48 ) != V_109 ) {
V_24 = - V_77 ;
goto V_100;
}
...
V_103 = F_77 ( V_2 , & V_102 -> V_48 ) + V_102 -> V_105 ;
V_103 &= ~ ( V_111 - 1 ) ;
while ( V_102 -> V_104 ) {
if ( F_77 ( V_2 , & V_102 -> V_20 [ V_102 -> V_104 - 1 ] . V_48 ) < V_103 )
break;
V_102 -> V_104 -= 1 ;
}
return 0 ;
}
static int F_79 ( struct V_112 * V_113 , void * V_49 , int V_22 , int V_3 ,
int V_4 )
{
...
if ( ! V_115 ) {
F_81 ( & V_113 -> V_118 ) ;
return F_41 ( V_2 , V_3 , V_49 , V_4 , V_22 , 0 ) ;
}
V_114 = V_113 -> V_4 - V_4 ;
if ( V_114 < 0 )
V_114 = 0 ;
...
F_81 ( & V_113 -> V_118 ) ;
if ( V_114 > 0 )
return F_41 ( V_2 , V_3 , V_49 , V_4 , V_114 , 0 ) ;
return 0 ;
}
static int F_82 ( struct V_1 * V_2 , void * V_49 ,
struct V_18 * V_19 )
{
union V_63 V_119 ;
struct V_51 * V_52 = V_49 ;
...
V_24 = F_83 ( V_2 , V_49 , V_19 -> V_3 , V_19 -> V_4 , 0 , 0 ) ;
if ( V_24 ) {
F_5 ( L_14 , V_58 ) ;
goto V_100;
}
...
if ( V_22 > V_102 -> V_107 ) {
F_5 ( L_20 , V_102 -> V_107 , V_22 ) ;
return - V_78 ;
}
V_113 = F_75 ( V_2 , V_3 ) ;
if ( V_113 )
V_24 = F_79 ( V_113 , V_102 -> V_49 , V_22 , V_3 , V_4 ) ;
else
V_24 = F_41 ( V_2 , V_3 , V_102 -> V_49 , V_4 , V_22 , 0 ) ;
if ( F_70 ( V_2 , V_3 , V_102 -> V_94 ) )
return - V_122 ;
if ( V_24 && V_24 != - V_123 ) {
F_5 ( L_21 ,
V_3 , V_4 , V_24 ) ;
F_31 () ;
F_45 ( & V_102 -> V_48 , L_22 ) ;
return V_24 ;
}
V_49 = V_102 -> V_49 ;
for ( V_35 = 0 ; V_35 < V_102 -> V_104 ; V_35 ++ ) {
V_24 = F_82 ( V_2 , V_49 , & V_102 -> V_20 [ V_35 ] ) ;
if ( V_24 )
return V_24 ;
...
int V_95 , V_36 , V_24 ;
struct V_16 * V_17 ;
F_45 ( V_48 , L_23 , V_68 -> V_22 , V_68 -> V_71 ) ;
F_73 ( & V_2 -> V_99 ) ;
V_95 = F_65 ( V_2 , V_48 , & V_17 , & V_36 ) ;
if ( ! V_95 ) {
V_24 = - V_77 ;
...
V_24 = F_36 ( V_2 , & V_17 -> V_20 [ V_36 ] , V_43 ) ;
V_124:
F_74 ( & V_2 -> V_99 ) ;
return V_24 ;
}
...
F_17 ( V_36 != V_2 -> V_130 ) ;
F_45 ( V_48 , L_25 , V_36 , V_17 -> V_34 ) ;
F_91 ( V_17 , V_19 , V_36 ) ;
if ( V_36 == 0 && V_76 && V_17 -> V_21 == 0 )
F_89 ( V_2 , V_17 ) ;
return 0 ;
}
F_45 ( V_48 , L_26 , V_17 -> V_34 ) ;
if ( V_17 -> V_125 )
F_10 ( V_2 , V_17 ) ;
...
if ( F_78 ( V_2 , V_119 ) == F_78 ( V_2 , V_48 ) &&
...
struct V_16 * V_17 ;
F_73 ( & V_2 -> V_99 ) ;
F_45 ( V_48 , L_30 , V_3 , V_4 , V_22 ) ;
V_95 = F_69 ( V_2 , V_48 , & V_17 , & V_36 ) ;
if ( ! V_95 ) {
struct V_18 V_19 ;
V_19 . V_17 = NULL ;
V_19 . V_3 = V_3 ;
...
struct V_16 * V_17 ;
F_73 ( & V_2 -> V_99 ) ;
F_45 ( V_48 , L_36 , V_68 -> V_22 , V_68 -> V_71 ) ;
V_24 = F_69 ( V_2 , V_48 , & V_17 , & V_36 ) ;
if ( V_24 < 0 )
goto V_124;
if ( V_24 ) {
if ( V_2 -> V_66 )
...
struct V_18 * V_19 ;
union V_63 * V_144 ;
F_45 ( V_48 , L_40 , V_68 -> V_71 ? ( char * ) V_68 -> V_71 : L_41 ) ;
F_17 ( F_29 ( V_2 , V_48 ) ) ;
F_73 ( & V_2 -> V_99 ) ;
...
V_144 = & V_19 -> V_48 ;
if ( F_78 ( V_2 , V_144 ) != F_78 ( V_2 , V_48 ) ||
F_46 ( V_2 , V_144 ) != type ) {
V_24 = - V_77 ;
goto V_70;
}
