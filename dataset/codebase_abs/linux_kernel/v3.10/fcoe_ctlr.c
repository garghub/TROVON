...
static void F_137 ( struct V_5 * V_6 , struct V_278 * V_32 )
{
struct V_128 * V_129 = V_6 -> V_7 ;
struct V_278 * V_279 ;
struct V_336 * V_306 ;
...
F_145 ( & V_279 -> V_343 , V_129 -> V_313 . V_345 ) ;
return;
}
if ( V_6 -> V_2 != V_175 )
return;
...
F_18 ( & V_129 -> V_304 . V_315 ) ;
F_147 (rdata, &lport->disc.rports, peers) {
V_305 = F_120 ( V_279 ) ;
if ( ! V_305 -> time )
continue;
V_184 = V_305 -> time +
...
V_192 = (struct V_78 * ) V_74 -> V_88 ;
V_231 = V_192 -> V_99 ;
V_38 = F_133 ( V_6 , V_74 , & V_349 . V_279 ) ;
if ( V_38 ) {
F_4 ( V_6 , L_71 , V_38 ) ;
goto V_169;
}
...
switch ( V_231 ) {
case V_326 :
F_135 ( V_6 , & V_349 . V_279 ) ;
break;
case V_327 :
F_136 ( V_6 , & V_349 . V_279 ) ;
break;
case V_288 :
F_140 ( V_6 , & V_349 . V_279 ) ;
break;
case V_289 :
F_142 ( V_6 , & V_349 . V_279 ) ;
break;
case V_290 :
...
V_129 -> V_313 . V_369 = F_126 ;
V_129 -> V_313 . V_370 = F_127 ;
V_53 = V_6 ;
} else {
V_129 -> V_366 = 0 ;
V_129 -> V_154 = 0 ;
