...
V_2 -> V_98 . V_236 = F_97 ;
V_2 -> V_98 . V_237 = F_98 ;
F_113 ( & V_224 -> V_37 , L_24 , V_174 ) ;
V_2 -> V_174 = F_114 ( V_174 , ( V_238 |
V_239 |
V_240 ) ) ;
F_115 ( & V_2 -> V_115 ) ;
F_116 ( V_225 , & V_241 ) ;
F_117 ( V_225 , & V_224 -> V_37 ) ;
F_118 ( V_224 , V_2 ) ;
V_225 -> V_242 = V_243 ;
V_225 -> V_244 = & V_245 ;
...
F_99 ( V_2 ) ;
F_26 ( V_2 ) ;
V_12 = F_119 ( V_224 -> V_70 , NULL , F_39 ,
V_254 | V_255 ,
V_225 -> V_256 , V_2 ) ;
if ( V_12 < 0 ) {
...
{
struct V_1 * V_259 = F_126 ( V_224 ) ;
if ( F_127 ( V_259 ) )
F_113 ( & V_224 -> V_37 , L_31 ) ;
F_128 ( V_259 -> V_18 ) ;
F_123 ( V_224 -> V_70 , V_259 ) ;
F_124 ( V_259 -> V_18 ) ;
return 0 ;
}
