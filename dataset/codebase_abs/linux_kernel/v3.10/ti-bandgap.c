...
V_100 = F_48 ( V_98 ) ;
if ( V_100 ) {
F_22 ( V_2 -> V_37 , L_12 , V_98 ) ;
return V_100 ;
}
V_100 = F_49 ( F_50 ( V_98 ) , F_13 ,
V_101 , L_10 , NULL ) ;
if ( V_100 ) {
F_51 ( V_98 ) ;
F_22 ( V_2 -> V_37 , L_13 ) ;
...
static struct V_1 * F_55 ( struct V_96 * V_97 )
{
struct V_104 * V_105 = V_97 -> V_37 . V_106 ;
...
V_2 = F_56 ( & V_97 -> V_37 , sizeof( * V_2 ) , V_112 ) ;
if ( ! V_2 ) {
F_22 ( & V_97 -> V_37 , L_18 ) ;
return F_42 ( - V_113 ) ;
}
V_108 = F_57 ( V_114 , & V_97 -> V_37 ) ;
if ( V_108 )
V_2 -> V_11 = V_108 -> V_27 ;
V_2 -> V_81 = F_56 ( & V_97 -> V_37 , sizeof( * V_2 -> V_81 ) *
V_2 -> V_11 -> V_12 , V_112 ) ;
if ( ! V_2 ) {
F_22 ( & V_97 -> V_37 , L_18 ) ;
return F_42 ( - V_113 ) ;
...
do {
void T_3 * V_115 ;
V_110 = F_58 ( V_97 , V_116 , V_7 ) ;
if ( ! V_110 )
break;
V_115 = F_59 ( & V_97 -> V_37 , V_110 ) ;
if ( V_7 == 0 )
V_2 -> V_4 = V_115 ;
if ( F_60 ( V_115 ) )
return F_61 ( V_115 ) ;
...
V_2 -> V_118 = F_66 ( NULL , V_2 -> V_11 -> V_119 ) ;
V_8 = F_24 ( V_2 -> V_118 ) ;
if ( V_8 ) {
F_22 ( & V_97 -> V_37 , L_24 ) ;
goto V_120;
}
V_2 -> V_121 = F_66 ( NULL , V_2 -> V_11 -> V_122 ) ;
V_8 = F_24 ( V_2 -> V_121 ) ;
if ( V_8 ) {
F_22 ( & V_97 -> V_37 ,
L_25 ) ;
...
V_75 == 0xffffffff ) {
V_8 = - V_126 ;
F_22 ( & V_97 -> V_37 , L_27 , V_75 ) ;
goto V_127;
}
V_8 = F_69 ( V_2 -> V_121 , V_75 ) ;
if ( V_8 )
F_22 ( & V_97 -> V_37 , L_28 ) ;
V_2 -> V_75 = V_75 ;
if ( F_6 ( V_2 , V_128 ) )
...
V_120:
if ( F_6 ( V_2 , V_117 ) ) {
F_75 ( F_50 ( V_2 -> V_99 ) , NULL ) ;
F_51 ( V_2 -> V_99 ) ;
}
return V_8 ;
}
static
int F_76 ( struct V_96 * V_97 )
{
struct V_1 * V_2 = F_77 ( V_97 ) ;
int V_7 ;
for ( V_7 = 0 ; V_7 < V_2 -> V_11 -> V_12 ; V_7 ++ ) {
if ( V_2 -> V_11 -> V_19 [ V_7 ] . V_140 )
V_2 -> V_11 -> V_19 [ V_7 ] . V_140 ( V_2 , V_7 ) ;
...
static int F_80 ( struct V_147 * V_37 )
{
...
static int F_82 ( struct V_147 * V_37 )
{
struct V_1 * V_2 = F_81 ( V_37 ) ;
if ( F_6 ( V_2 , V_128 ) )
F_70 ( V_2 -> V_118 ) ;
