...
F_67 ( V_2 , V_115 , V_2 -> V_127 ,
& V_2 -> V_128 , 0 ) ;
}
static void F_76 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
struct V_117 * V_129 = & V_2 -> V_128 ;
struct V_5 * V_6 ;
if ( V_44 == NULL ) {
F_77 ( V_2 , F_78 ( V_129 ) ) ;
return;
...
while ( ! F_78 ( V_129 ) ) {
V_6 = F_79 ( V_129 -> V_66 , struct V_5 , V_124 ) ;
F_80 ( & V_6 -> V_124 ) ;
V_2 -> V_127 -- ;
...
struct V_132 * V_129 , int V_133 )
{
struct V_1 * V_2 = F_83 ( V_131 -> V_134 ) ;
if ( V_133 != 0 )
return;
V_2 -> V_135 = 0 ;
V_2 -> V_136 = 0 ;
}
static int F_84 ( struct V_130 * V_131 , unsigned int V_137 ,
struct V_103 * V_104 , T_4 * V_114 ,
int V_133 )
{
struct V_138 * V_139 = F_85 ( V_131 -> V_134 ) ;
struct V_1 * V_2 = F_83 ( V_131 -> V_134 ) ;
struct V_19 * V_20 = V_139 -> V_140 ;
unsigned int V_141 = F_86 ( V_104 -> V_102 ) ;
struct V_3 * V_142 , * V_143 ;
T_1 V_83 ;
int error = 0 ;
if ( V_133 != 1 || F_86 ( V_104 -> V_100 ) != V_126 )
return 0 ;
F_87 ( V_2 , & V_137 ) ;
for (; V_141 ; F_87 ( V_2 , & V_137 ) , V_141 -- ) {
V_83 = F_88 ( * V_114 ++ ) ;
V_2 -> V_135 ++ ;
if ( F_89 ( V_2 , V_83 , V_137 ) )
continue;
error = F_90 ( V_131 , V_137 , & V_142 ) ;
if ( error )
return error ;
V_143 = F_91 ( V_20 , V_83 ) ;
memcpy ( V_143 -> V_37 , V_142 -> V_37 , V_142 -> V_73 ) ;
if ( F_92 ( V_2 , V_143 ) )
error = - V_144 ;
else
F_21 ( V_143 ) ;
...
static void F_93 ( struct V_130 * V_131 , int error , int V_133 )
{
struct V_138 * V_139 = F_85 ( V_131 -> V_134 ) ;
struct V_1 * V_2 = F_83 ( V_131 -> V_134 ) ;
if ( error ) {
...
F_94 ( V_139 -> V_140 ) ;
F_95 ( V_2 , L_2 ,
V_131 -> V_145 , V_2 -> V_136 , V_2 -> V_135 ) ;
}
static void F_96 ( struct V_1 * V_2 )
{
struct V_146 * V_147 ;
unsigned int V_97 ;
struct V_117 * V_129 = & V_2 -> V_148 ;
struct V_5 * V_6 ;
struct V_67 * V_67 ;
unsigned int V_149 ;
if ( ! V_2 -> V_150 )
return;
V_149 = F_97 ( V_2 , V_2 -> V_150 , sizeof( T_1 ) ) ;
V_67 = F_57 ( V_2 , V_151 , V_149 , V_2 -> V_150 ) ;
V_97 = sizeof( struct V_103 ) ;
F_30 (bd, head, bd_list) {
V_2 -> V_150 -- ;
if ( V_97 + sizeof( T_1 ) > V_2 -> V_152 . V_153 ) {
F_56 ( V_2 , V_67 ) ;
V_67 = F_58 ( V_78 , V_89 ) ;
V_147 = F_59 ( V_67 ) ;
F_60 ( V_147 ) ;
V_147 -> V_106 = F_61 ( V_107 ) ;
V_147 -> V_108 = F_61 ( V_154 ) ;
V_147 -> V_110 = F_61 ( V_155 ) ;
V_97 = sizeof( struct V_146 ) ;
}
* ( T_4 * ) ( F_59 ( V_67 ) + V_97 ) = F_72 ( V_6 -> V_156 ) ;
V_97 += sizeof( T_1 ) ;
}
F_5 ( V_2 , ! V_2 -> V_150 ) ;
F_56 ( V_2 , V_67 ) ;
}
static void F_98 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
struct V_117 * V_129 = & V_2 -> V_148 ;
struct V_5 * V_6 ;
struct V_19 * V_20 ;
...
static void F_100 ( struct V_130 * V_131 ,
struct V_132 * V_129 , int V_133 )
{
struct V_1 * V_2 = F_83 ( V_131 -> V_134 ) ;
if ( V_133 != 0 )
return;
V_2 -> V_159 = 0 ;
V_2 -> V_160 = V_129 -> V_161 ;
}
static int F_101 ( struct V_130 * V_131 , unsigned int V_137 ,
struct V_103 * V_104 , T_4 * V_114 ,
int V_133 )
{
struct V_1 * V_2 = F_83 ( V_131 -> V_134 ) ;
unsigned int V_141 = F_86 ( V_104 -> V_101 ) ;
unsigned int V_162 = F_86 ( V_104 -> V_102 ) ;
struct V_3 * V_4 ;
unsigned int V_97 ;
T_1 V_83 ;
int V_163 = 1 ;
int error ;
if ( V_133 != 0 || F_86 ( V_104 -> V_100 ) != V_151 )
return 0 ;
V_97 = sizeof( struct V_103 ) ;
for (; V_141 ; F_87 ( V_2 , & V_137 ) , V_141 -- ) {
error = F_90 ( V_131 , V_137 , & V_4 ) ;
if ( error )
return error ;
if ( ! V_163 )
F_102 ( V_2 , V_4 , V_154 ) ;
while ( V_97 + sizeof( T_1 ) <= V_2 -> V_152 . V_153 ) {
V_83 = F_88 ( * ( T_4 * ) ( V_4 -> V_37 + V_97 ) ) ;
error = F_103 ( V_2 , V_83 , V_137 ) ;
if ( error < 0 ) {
F_24 ( V_4 ) ;
return error ;
}
...
static void F_104 ( struct V_130 * V_131 , int error , int V_133 )
{
struct V_1 * V_2 = F_83 ( V_131 -> V_134 ) ;
if ( error ) {
F_105 ( V_2 ) ;
...
return;
F_95 ( V_2 , L_3 ,
V_131 -> V_145 , V_2 -> V_159 ) ;
F_105 ( V_2 ) ;
}
static void F_106 ( struct V_1 * V_2 )
{
unsigned int V_115 = F_75 ( V_2 ) / 2 ;
F_67 ( V_2 , V_115 , V_2 -> V_164 ,
& V_2 -> V_165 , 1 ) ;
}
static int F_107 ( struct V_130 * V_131 , unsigned int V_137 ,
struct V_103 * V_104 ,
T_4 * V_114 , int V_133 )
{
struct V_138 * V_139 = F_85 ( V_131 -> V_134 ) ;
...
T_1 V_166 ;
int error = 0 ;
if ( V_133 != 1 || F_86 ( V_104 -> V_100 ) != V_125 )
return 0 ;
F_87 ( V_2 , & V_137 ) ;
for (; V_141 ; F_87 ( V_2 , & V_137 ) , V_141 -- ) {
V_83 = F_88 ( * V_114 ++ ) ;
...
static void F_108 ( struct V_130 * V_131 , int error , int V_133 )
{
struct V_138 * V_139 = F_85 ( V_131 -> V_134 ) ;
struct V_1 * V_2 = F_83 ( V_131 -> V_134 ) ;
if ( error ) {
...
static void F_109 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
struct V_117 * V_129 = & V_2 -> V_165 ;
struct V_5 * V_6 ;
if ( V_44 == NULL ) {
F_77 ( V_2 , F_78 ( V_129 ) ) ;
return;
