...
unsigned int V_20 ;
int V_99 ;
V_99 = F_25 ( V_2 , V_96 -> V_100 [ 0 ] , V_101 ) ;
if ( V_99 )
return V_99 ;
V_99 = F_26 ( V_2 , 4 ) ;
if ( V_99 )
return V_99 ;
V_8 = F_27 ( sizeof( * V_8 ) , V_102 ) ;
if ( ! V_8 )
return - V_103 ;
V_2 -> V_9 = V_8 ;
F_3 ( V_2 ) ;
...
V_8 -> V_104 = V_96 -> V_100 [ 5 ] ;
V_8 -> V_105 = V_96 -> V_100 [ 6 ] ;
V_8 -> V_106 = V_96 -> V_100 [ 7 ] ;
V_8 -> V_107 = V_96 -> V_100 [ 8 ] ;
V_8 -> V_84 = V_96 -> V_100 [ 9 ] ;
V_8 -> V_108 = V_96 -> V_100 [ 10 ] ;
V_8 -> V_109 = V_96 -> V_100 [ 11 ] ;
V_8 -> V_86 = V_96 -> V_100 [ 12 ] ;
V_23 = & V_2 -> V_24 [ 0 ] ;
V_2 -> V_110 = V_23 ;
V_23 -> type = V_111 ;
V_23 -> V_112 = V_113 | V_114 | V_115 ;
V_23 -> V_116 = ( V_8 -> V_104 ? 16 : 8 ) ;
V_23 -> V_117 = 16 ;
V_23 -> V_118 = F_17 ;
V_23 -> V_119 = F_8 ;
V_23 -> V_120 = F_13 ;
