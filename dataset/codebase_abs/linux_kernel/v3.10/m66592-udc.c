...
{
struct V_1 * V_1 = F_105 ( & V_285 -> V_286 ) ;
F_106 ( & V_1 -> V_18 ) ;
F_107 ( & V_1 -> V_257 ) ;
F_108 ( V_1 -> V_5 ) ;
...
static void F_113 ( struct V_263 * V_23 , struct V_266 * V_288 )
{
}
...
int V_33 = 0 ;
int V_178 ;
V_290 = F_115 ( V_285 , V_293 , 0 ) ;
if ( ! V_290 ) {
V_33 = - V_112 ;
F_16 ( L_19 ) ;
goto V_294;
}
V_291 = F_115 ( V_285 , V_295 , 0 ) ;
if ( ! V_291 ) {
V_33 = - V_112 ;
F_116 ( & V_285 -> V_286 ,
L_20 ) ;
...
V_5 = F_117 ( V_290 -> V_296 , F_118 ( V_290 ) ) ;
if ( V_5 == NULL ) {
V_33 = - V_75 ;
F_16 ( L_21 ) ;
goto V_294;
}
if ( V_285 -> V_286 . V_297 == NULL ) {
F_116 ( & V_285 -> V_286 , L_22 ) ;
V_33 = - V_112 ;
goto V_294;
}
...
V_1 -> V_51 = V_285 -> V_286 . V_297 ;
V_1 -> V_160 = V_291 -> V_262 & V_298 ;
F_119 ( & V_1 -> V_17 ) ;
F_120 ( & V_285 -> V_286 , V_1 ) ;
V_1 -> V_18 . V_299 = & V_300 ;
V_1 -> V_18 . V_301 = V_222 ;
V_1 -> V_18 . V_302 = V_303 ;
F_121 ( & V_1 -> V_257 ) ;
V_1 -> V_257 . V_304 = F_84 ;
V_1 -> V_257 . V_305 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
V_33 = F_122 ( V_291 -> V_296 , F_81 , V_306 ,
V_303 , V_1 ) ;
if ( V_33 < 0 ) {
F_16 ( L_24 , V_33 ) ;
goto V_294;
...
if ( V_1 -> V_51 -> V_52 ) {
snprintf ( V_292 , sizeof( V_292 ) , L_25 , V_285 -> V_307 ) ;
V_1 -> V_287 = F_123 ( & V_285 -> V_286 , V_292 ) ;
if ( F_124 ( V_1 -> V_287 ) ) {
F_116 ( & V_285 -> V_286 , L_26 ,
V_292 ) ;
V_33 = F_125 ( V_1 -> V_287 ) ;
goto V_308;
}
F_126 ( V_1 -> V_287 ) ;
}
...
F_13 ( & V_1 -> V_18 . V_206 -> V_309 ) ;
for ( V_178 = 0 ; V_178 < V_29 ; V_178 ++ ) {
struct V_45 * V_23 = & V_1 -> V_23 [ V_178 ] ;
if ( V_178 != 0 ) {
F_13 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_309 ) ;
F_94 ( & V_1 -> V_23 [ V_178 ] . V_23 . V_309 ,
& V_1 -> V_18 . V_309 ) ;
}
V_23 -> V_1 = V_1 ;
F_13 ( & V_23 -> V_24 ) ;
V_23 -> V_23 . V_302 = V_310 [ V_178 ] ;
V_23 -> V_23 . V_299 = & V_311 ;
V_23 -> V_23 . V_76 = 512 ;
}
...
F_56 ( V_1 ) ;
V_33 = F_127 ( & V_285 -> V_286 , & V_1 -> V_18 ) ;
if ( V_33 )
goto V_313;
F_128 ( & V_285 -> V_286 , L_27 , V_314 ) ;
return 0 ;
V_313:
F_92 ( & V_1 -> V_23 [ 0 ] . V_23 , V_1 -> V_205 ) ;
V_312:
