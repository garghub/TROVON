...
static int F_10 ( struct V_16 * V_22 , unsigned V_2 )
{
return F_6 ( V_21 , V_2 ) ;
}
static int F_11 ( struct V_16 * V_22 , unsigned V_2 )
{
unsigned long V_5 ;
T_1 V_6 ;
if ( V_2 < 16 ) {
...
return - V_24 ;
F_2 ( & V_11 . V_12 , V_5 ) ;
F_4 ( 1 << ( 16 + V_2 ) , 0 , V_11 . V_23 ) ;
V_6 = F_3 ( 0 , V_11 . V_23 ) ;
F_5 ( & V_11 . V_12 , V_5 ) ;
return ( V_6 >> 16 ) & ( 1 << V_2 ) ? 1 : 0 ;
} else {
return F_10 ( V_22 , V_2 ) ;
}
}
static int F_12 ( struct V_16 * V_22 , unsigned V_2 )
{
if ( ! F_7 ( V_22 , V_2 ) )
return - V_24 ;
...
static int F_13 ( struct V_16 * V_22 , unsigned V_2 )
{
if ( V_2 == 16 || V_2 == 17 )
V_2 -= 16 ;
return F_12 ( V_22 , V_2 ) ;
}
static void F_14 ( struct V_16 * V_22 , unsigned V_2 , int V_3 )
{
F_1 ( V_21 , V_2 , V_3 , 0 ) ;
}
static void F_15 ( struct V_16 * V_22 )
{
V_22 -> V_29 = V_30 ;
V_22 -> V_31 = V_32 ;
V_22 -> V_33 = & V_11 . V_33 -> V_33 ;
V_22 -> V_34 = V_11 . V_25 -> V_34 ?
V_11 . V_25 -> V_34 : F_12 ;
V_22 -> V_35 = V_11 . V_25 -> V_35 ?
V_11 . V_25 -> V_35 : F_10 ;
V_22 -> V_36 = F_14 ;
V_22 -> V_37 = F_8 ;
V_22 -> V_38 = F_9 ;
V_22 -> V_39 = V_40 ;
V_22 -> V_41 = V_11 . V_25 -> V_41 ;
V_22 -> V_42 = 0 ;
V_22 -> V_43 = NULL ;
}
...
F_28 ( L_4 , V_11 . V_22 . V_39 ,
V_11 . V_22 . V_39 + V_11 . V_22 . V_41 - 1 , V_32 ) ;
return 0 ;
V_80:
