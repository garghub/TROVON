...
static struct V_42 *
F_62 ( struct V_49 * V_50 , T_6 V_110 )
{
...
V_42 -> V_111 = F_64 () ;
V_42 -> V_112 = V_110 ;
V_42 -> V_113 = V_42 -> V_114 = V_42 -> V_115 = V_116 ;
switch ( V_110 & V_117 ) {
case V_118 :
V_42 -> V_119 = & V_120 ;
V_42 -> V_121 = & V_122 ;
...
static int F_66 ( struct V_42 * V_123 , struct V_19 * V_19 ,
T_6 V_110 ,
...
struct V_42 * V_42 ;
F_67 ( V_19 ) ;
V_42 = F_62 ( V_123 -> V_59 , V_110 ) ;
if ( ! V_42 )
goto V_125;
V_42 -> V_111 = F_68 ( V_123 -> V_59 , 100 ) ;
if ( V_119 )
V_42 -> V_119 = V_119 ;
if ( V_43 )
F_26 ( V_42 , V_43 ) ;
...
V_125:
F_70 ( V_126 L_6 ,
__FILE__ , V_127 , V_19 -> V_128 . V_129 ) ;
F_19 ( V_19 ) ;
return - V_130 ;
}
static int F_71 ( struct V_42 * V_123 , struct V_19 * V_19 ,
T_6 V_110 ,
const struct V_124 * V_119 ,
void * V_43 )
{
int V_8 ;
V_8 = F_66 ( V_123 , V_19 , V_131 | V_110 , V_119 , V_43 ) ;
if ( V_8 )
return V_8 ;
F_72 ( V_123 , V_19 ) ;
return 0 ;
}
static int F_73 ( struct V_42 * V_123 , struct V_19 * V_19 ,
T_6 V_110 ,
const struct V_124 * V_119 ,
void * V_43 )
{
int V_8 ;
V_8 = F_66 ( V_123 , V_19 , V_118 | V_110 , V_119 , V_43 ) ;
if ( V_8 )
return V_8 ;
F_65 ( V_123 ) ;
F_74 ( V_123 , V_19 ) ;
...
static int F_84 ( struct V_42 * V_123 , struct V_19 * V_19 ,
T_6 V_110 ,
const struct V_124 * V_119 ,
void * V_43 ,
struct V_16 * V_17 )
...
struct V_51 * V_52 ;
int V_8 ;
V_8 = F_66 ( V_123 , V_19 , V_134 | V_110 , V_119 , V_43 ) ;
if ( V_8 )
return V_8 ;
V_52 = F_18 ( V_19 -> V_24 ) ;
V_52 -> V_43 = V_43 ;
...
static int F_85 ( struct V_42 * V_123 , struct V_19 * V_19 )
{
int V_106 ;
F_16 ( V_19 ) ;
V_106 = F_86 ( V_123 , V_19 ) ;
F_87 ( V_19 ) ;
F_19 ( V_19 ) ;
return V_106 ;
}
...
V_135 = F_89 ( V_19 ) ;
V_123 = V_135 -> V_24 ;
F_90 ( & V_123 -> V_45 , V_136 ) ;
error = F_85 ( V_123 , V_19 ) ;
F_30 ( & V_123 -> V_45 ) ;
F_19 ( V_135 ) ;
return error ;
}
static int F_91 ( struct V_42 * V_123 , struct V_19 * V_19 )
{
int V_106 ;
F_16 ( V_19 ) ;
V_106 = F_92 ( V_123 , V_19 ) ;
F_87 ( V_19 ) ;
F_19 ( V_19 ) ;
return V_106 ;
}
static int F_93 ( struct V_42 * V_123 , struct V_19 * V_19 )
{
struct V_42 * V_42 = V_19 -> V_24 ;
F_27 ( V_42 ) ;
return F_91 ( V_123 , V_19 ) ;
}
static struct V_19 * F_94 ( struct V_19 * V_135 ,
struct V_137 * V_129 )
{
struct V_19 * V_19 ;
V_19 = F_95 ( V_135 , V_129 ) ;
if ( ! V_19 ) {
V_19 = F_96 ( V_135 , V_129 ) ;
if ( ! V_19 )
return F_83 ( - V_130 ) ;
}
if ( V_19 -> V_24 == NULL ) {
...
int V_142 , int V_143 )
{
struct V_42 * V_123 = V_135 -> V_24 ;
struct V_19 * V_19 ;
struct V_137 V_129 ;
int V_144 ;
for ( V_144 = V_142 ; V_144 < V_143 ; V_144 ++ ) {
V_129 . V_129 = V_141 [ V_144 ] . V_129 ;
V_129 . V_33 = strlen ( V_141 [ V_144 ] . V_129 ) ;
V_129 . V_145 = F_99 ( V_129 . V_129 , V_129 . V_33 ) ;
V_19 = F_95 ( V_135 , & V_129 ) ;
if ( V_19 == NULL )
continue;
if ( V_19 -> V_24 == NULL )
goto V_10;
switch ( V_19 -> V_24 -> V_112 & V_117 ) {
default:
F_100 () ;
case V_131 :
F_91 ( V_123 , V_19 ) ;
...
static void F_101 ( struct V_19 * V_135 ,
const struct V_140 * V_141 ,
int V_142 , int V_143 )
{
struct V_42 * V_123 = V_135 -> V_24 ;
F_90 ( & V_123 -> V_45 , V_146 ) ;
F_98 ( V_135 , V_141 , V_142 , V_143 ) ;
F_30 ( & V_123 -> V_45 ) ;
}
static int F_102 ( struct V_19 * V_135 ,
const struct V_140 * V_141 ,
int V_142 , int V_143 ,
void * V_43 )
{
...
for ( V_144 = V_142 ; V_144 < V_143 ; V_144 ++ ) {
struct V_137 V_147 ;
V_147 . V_129 = V_141 [ V_144 ] . V_129 ;
V_147 . V_33 = strlen ( V_141 [ V_144 ] . V_129 ) ;
V_147 . V_145 = F_99 ( V_147 . V_129 , V_147 . V_33 ) ;
V_19 = F_94 ( V_135 , & V_147 ) ;
V_8 = F_103 ( V_19 ) ;
if ( F_104 ( V_19 ) )
goto V_148;
switch ( V_141 [ V_144 ] . V_110 & V_117 ) {
default:
F_100 () ;
case V_131 :
V_8 = F_71 ( V_123 , V_19 ,
...
F_30 ( & V_123 -> V_45 ) ;
F_70 ( V_126 L_7 ,
__FILE__ , V_127 , V_135 -> V_128 . V_129 ) ;
return V_8 ;
}
static struct V_19 * F_105 ( struct V_19 * V_135 ,
struct V_137 * V_129 , T_6 V_110 , void * V_43 ,
...
int error ;
F_90 ( & V_123 -> V_45 , V_136 ) ;
V_19 = F_94 ( V_135 , V_129 ) ;
if ( F_104 ( V_19 ) )
goto V_67;
error = F_73 ( V_123 , V_19 , V_110 , NULL , V_43 ) ;
if ( error != 0 )
goto V_125;
if ( F_106 != NULL ) {
...
struct V_19 * F_109 ( struct V_19 * V_135 , const char * V_129 ,
void * V_43 , struct V_16 * V_17 )
{
struct V_19 * V_19 ;
struct V_42 * V_123 = V_135 -> V_24 ;
T_6 V_151 = V_134 | V_152 | V_153 ;
struct V_137 V_147 ;
int V_8 ;
...
V_151 &= ~ V_155 ;
V_147 . V_129 = V_129 ;
V_147 . V_33 = strlen ( V_129 ) ;
V_147 . V_145 = F_99 ( V_147 . V_129 , V_147 . V_33 ) ,
F_90 ( & V_123 -> V_45 , V_136 ) ;
V_19 = F_94 ( V_135 , & V_147 ) ;
if ( F_104 ( V_19 ) )
goto V_67;
V_8 = F_84 ( V_123 , V_19 , V_151 , & V_156 ,
V_43 , V_17 ) ;
if ( V_8 )
goto V_125;
V_67:
...
V_19 = F_83 ( V_8 ) ;
F_70 ( V_126 L_8 ,
__FILE__ , V_127 , V_135 -> V_128 . V_129 , V_129 ,
V_8 ) ;
goto V_67;
}
int
...
struct V_96 * V_160 )
{
return F_105 ( V_19 , V_129 , V_154 | V_161 , NULL ,
F_111 , V_160 ) ;
}
...
struct V_19 * F_117 ( struct V_19 * V_135 , struct V_137 * V_129 ,
T_6 V_151 , struct V_163 * V_164 )
{
return F_105 ( V_135 , V_129 , V_151 , NULL ,
F_115 , V_164 ) ;
}
...
{
struct V_137 V_123 = F_120 ( V_165 , strlen ( V_165 ) ) ;
V_123 . V_145 = F_99 ( V_123 . V_129 , V_123 . V_33 ) ;
return F_95 ( V_50 -> V_166 , & V_123 ) ;
}
void F_121 ( struct V_58 * V_58 )
{
struct V_61 * V_62 = F_38 ( V_58 , V_63 ) ;
F_122 ( & V_62 -> V_167 ) ;
V_62 -> V_66 = 1 ;
...
struct V_49 * F_123 ( const struct V_58 * V_58 )
{
struct V_61 * V_62 = F_38 ( V_58 , V_63 ) ;
F_28 ( & V_62 -> V_167 ) ;
if ( V_62 -> V_169 )
...
void F_124 ( const struct V_58 * V_58 )
{
struct V_61 * V_62 = F_38 ( V_58 , V_63 ) ;
F_125 ( V_62 -> V_169 == NULL ) ;
F_30 ( & V_62 -> V_167 ) ;
}
static int
F_126 ( struct V_49 * V_50 , void * V_30 , int V_170 )
{
struct V_42 * V_42 ;
struct V_19 * V_171 ;
...
V_50 -> V_178 = & V_179 ;
V_50 -> V_180 = 1 ;
V_42 = F_62 ( V_50 , V_118 | V_154 | V_161 ) ;
V_50 -> V_166 = V_171 = F_127 ( V_42 ) ;
if ( ! V_171 )
return - V_130 ;
if ( F_102 ( V_171 , V_141 , V_181 , V_182 , NULL ) )
return - V_130 ;
F_128 ( L_9 ,
V_58 , F_129 ( V_58 ) ) ;
V_62 -> V_169 = V_50 ;
...
V_50 ) ;
V_62 -> V_169 = NULL ;
F_98 ( V_171 , V_141 , V_181 , V_182 ) ;
return V_8 ;
}
static struct V_19 *
F_132 ( struct V_186 * V_187 ,
int V_38 , const char * V_188 , void * V_30 )
{
return F_133 ( V_187 , V_38 , V_189 -> V_190 -> V_191 , F_126 ) ;
}
static void F_134 ( struct V_49 * V_50 )
{
...
F_137 ( void * V_192 )
{
struct V_51 * V_52 = (struct V_51 * ) V_192 ;
F_138 ( & V_52 -> V_55 ) ;
V_52 -> V_43 = NULL ;
V_52 -> V_17 = NULL ;
F_139 ( & V_52 -> V_4 ) ;
