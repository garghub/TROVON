...
void * V_98 )
{
struct V_31 * V_32 = V_98 ;
if ( ! F_45 ( F_46 ( V_32 ) , & V_99 ) )
return V_100 ;
if ( V_97 == V_101 )
F_42 ( V_32 ) ;
return V_100 ;
}
static int F_47 ( int V_102 , void T_2 * V_103 )
{
...
struct V_76 V_111 ;
int V_112 ;
if ( F_48 ( & V_106 , V_103 , sizeof( V_106 ) ) )
return - V_113 ;
V_32 = F_49 ( & V_99 , V_106 . V_114 ) ;
if ( ! V_32 )
return - V_115 ;
...
if ( ! V_8 )
return - V_132 ;
F_54 ( V_8 -> V_32 , & ( V_40 -> V_14 ) ) ;
return 0 ;
}
return F_55 ( V_103 , & V_106 , sizeof( V_106 ) ) ? - V_113 : 0 ;
}
static int F_56 ( unsigned int V_102 , void T_2 * V_103 )
{
struct V_76 V_82 ;
if ( F_48 ( & V_82 , V_103 , sizeof( V_82 ) ) )
return - V_113 ;
switch ( V_102 ) {
case V_138 :
...
if ( V_82 . V_141 ) {
char V_142 [ V_143 ] ;
if ( F_48 ( V_142 , V_82 . V_141 , V_143 - 1 ) )
return - V_113 ;
V_142 [ V_143 - 1 ] = '\0' ;
V_32 = F_49 ( & V_99 , V_142 ) ;
if ( ! V_32 )
return - V_115 ;
}
...
static unsigned long F_57 ( const unsigned char * V_25 ,
...
static unsigned long F_59 ( const struct V_146 * V_147 , int V_148 ,
int V_144 , unsigned long V_145 )
{
int V_149 = F_60 ( V_147 ) ;
struct V_146 * V_150 ;
int V_151 , V_152 ;
if ( ( V_152 = V_149 - V_148 ) > 0 ) {
if ( V_152 > V_144 )
V_152 = V_144 ;
V_145 = F_57 ( V_147 -> V_25 + V_148 , V_152 , V_145 ) ;
if ( ( V_144 -= V_152 ) == 0 )
return V_145 ;
V_148 += V_152 ;
}
for ( V_151 = 0 ; V_151 < F_61 ( V_147 ) -> V_153 ; V_151 ++ ) {
int V_154 ;
const T_3 * V_155 = & F_61 ( V_147 ) -> V_156 [ V_151 ] ;
F_62 ( V_149 > V_148 + V_144 ) ;
V_154 = V_149 + F_63 ( V_155 ) ;
if ( ( V_152 = V_154 - V_148 ) > 0 ) {
T_4 * V_157 ;
if ( V_152 > V_144 )
V_152 = V_144 ;
V_157 = F_64 ( F_65 ( V_155 ) ) ;
V_145 = F_57 ( V_157 + V_155 -> V_158 +
...
static T_1 F_69 ( const struct V_146 * V_147 , int V_144 )
{
unsigned long V_145 ;
V_145 = F_59 ( V_147 , 4 , V_144 - 4 , 0 ) ;
return V_145 ? F_28 ( ( unsigned short ) V_145 ) : F_28 ( 0xFFFF ) ;
}
static int F_70 ( struct V_64 * V_64 , struct V_159 * V_1 , int V_160 ,
int V_161 )
{
struct V_1 * V_2 ;
int V_162 = - V_163 ;
...
goto V_42;
V_162 = - V_129 ;
V_2 = F_71 ( V_64 , V_167 , V_41 , & V_168 ) ;
if ( ! V_2 )
goto V_42;
V_162 = 0 ;
V_1 -> V_169 = & V_170 ;
...
static int F_74 ( struct V_159 * V_1 )
{
...
static int F_79 ( struct V_1 * V_2 , struct V_5 * V_24 )
{
int V_58 ;
F_4 ( & V_4 ) ;
for ( V_24 -> V_12 = V_172 ;
...
static int F_82 ( struct V_159 * V_1 , struct V_177 * V_178 , int V_179 )
{
...
static int F_84 ( struct V_159 * V_1 , struct V_177 * V_178 ,
int V_179 , int V_59 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_10 * V_11 = F_10 ( V_2 ) ;
...
static int F_86 ( struct V_159 * V_1 , struct V_177 * V_178 ,
int * V_195 , int V_196 )
{
struct V_5 V_24 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
static T_5 int F_87 ( struct V_146 * V_147 )
{
return V_147 -> V_25 [ 12 ] == 22 ;
}
static int F_88 ( struct V_146 * V_147 )
{
struct V_31 * V_32 = F_49 ( & V_99 , L_7 ) ;
struct V_198 * V_199 ;
if ( ! V_32 ) {
F_89 ( V_147 ) ;
return V_200 ;
...
static int F_94 ( struct V_146 * V_147 , struct V_31 * V_32 ,
...
F_95 ( V_147 , F_96 (unsigned int, origlen,
(rt->dev->hard_header_len +
ddp_dl->header_length + (len_hops & 1023))) ) ;
V_205 -> V_213 = F_28 ( V_206 ) ;
if ( F_97 ( V_147 ) < 22 ) {
struct V_146 * V_214 = F_98 ( V_147 , 32 ) ;
F_89 ( V_147 ) ;
V_147 = V_214 ;
} else
V_147 = F_99 ( V_147 , V_90 ) ;
if ( V_147 == NULL )
goto V_215;
if ( F_100 ( V_82 -> V_32 , V_147 , & V_78 , NULL ) == V_216 )
return V_200 ;
return V_217 ;
V_211:
F_89 ( V_147 ) ;
...
static int F_101 ( struct V_146 * V_147 , struct V_31 * V_32 ,
...
if ( ! F_45 ( F_46 ( V_32 ) , & V_99 ) )
goto V_215;
if ( ! ( V_147 = F_102 ( V_147 , V_90 ) ) )
goto V_42;
if ( ! F_103 ( V_147 , sizeof( * V_205 ) ) )
goto V_215;
V_205 = F_104 ( V_147 ) ;
V_206 = F_27 ( V_205 -> V_213 ) ;
V_207 = V_147 -> V_144 ;
F_95 ( V_147 , F_96 (unsigned int, skb->len, len_hops & 1023 ) ) ;
...
if ( V_205 -> V_222 &&
F_69 ( V_147 , V_206 & 1023 ) != V_205 -> V_222 )
goto V_215;
if ( ! V_205 -> V_210 )
...
if ( ! V_8 ) {
return F_94 ( V_147 , V_32 , V_205 , V_206 , V_207 ) ;
}
if ( F_87 ( V_147 ) )
return F_88 ( V_147 ) ;
...
static int F_107 ( struct V_146 * V_147 , struct V_31 * V_32 ,
struct V_218 * V_219 , struct V_31 * V_220 )
{
if ( ! F_45 ( F_46 ( V_32 ) , & V_99 ) )
goto V_224;
...
if ( ! ( V_147 = F_102 ( V_147 , V_90 ) ) )
return 0 ;
V_205 = (struct V_204 * ) F_109 ( V_147 , sizeof( * V_205 ) - 4 ) ;
V_205 -> V_212 = F_108 ( V_147 ) [ 0 ] ;
V_205 -> V_225 = F_108 ( V_147 ) [ 1 ] ;
...
F_91 ( V_147 ) ;
return F_101 ( V_147 , V_32 , V_219 , V_220 ) ;
V_224:
F_89 ( V_147 ) ;
return 0 ;
}
static int F_110 ( struct V_228 * V_229 , struct V_159 * V_1 , struct V_230 * V_231 ,
T_7 V_144 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
struct V_10 * V_11 = F_10 ( V_2 ) ;
...
V_238 += V_32 -> V_247 ;
F_78 ( V_2 ) ;
V_147 = F_112 ( V_2 , V_238 , ( V_59 & V_239 ) , & V_180 ) ;
F_76 ( V_2 ) ;
if ( ! V_147 )
goto V_42;
V_147 -> V_2 = V_2 ;
F_113 ( V_147 , V_244 -> V_245 ) ;
F_113 ( V_147 , V_32 -> V_247 ) ;
V_147 -> V_32 = V_32 ;
F_111 ( V_2 , L_14 , V_2 ) ;
V_205 = (struct V_204 * ) F_114 ( V_147 , sizeof( struct V_204 ) ) ;
...
F_111 ( V_2 , L_15 , V_2 , V_144 ) ;
V_180 = F_115 ( F_114 ( V_147 , V_144 ) , V_231 -> V_249 , V_144 ) ;
if ( V_180 ) {
F_89 ( V_147 ) ;
V_180 = - V_113 ;
goto V_42;
...
V_205 -> V_222 = F_69 ( V_147 , V_144 + sizeof( * V_205 ) ) ;
if ( V_205 -> V_212 == V_18 &&
! ( V_82 -> V_59 & V_93 ) && ! ( V_32 -> V_59 & V_60 ) ) {
struct V_146 * V_251 = F_116 ( V_147 , V_41 ) ;
if ( V_251 ) {
V_235 = 1 ;
F_111 ( V_2 , L_16 , V_2 ) ;
F_100 ( V_32 , V_251 , & V_232 -> V_14 , NULL ) ;
}
}
...
F_100 ( V_32 , V_147 , & V_232 -> V_14 , NULL ) ;
}
F_111 ( V_2 , L_19 , V_2 , V_144 ) ;
V_42:
F_78 ( V_2 ) ;
return V_180 ? : V_144 ;
}
static int F_118 ( struct V_228 * V_229 , struct V_159 * V_1 , struct V_230 * V_231 ,
T_7 V_238 , int V_59 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
...
V_180 = F_120 ( V_147 , V_148 , V_231 -> V_249 , V_255 ) ;
if ( ! V_180 ) {
if ( V_24 ) {
V_24 -> V_85 = V_86 ;
...
static int F_122 ( struct V_159 * V_1 , unsigned int V_102 , unsigned long V_103 )
{
int V_162 = - V_258 ;
struct V_1 * V_2 = V_1 -> V_2 ;
...
switch ( V_102 ) {
case V_260 : {
long V_261 = V_2 -> V_262 - F_123 ( V_2 ) ;
if ( V_261 < 0 )
V_261 = 0 ;
V_162 = F_124 ( V_261 , ( int T_2 * ) V_259 ) ;
break;
}
case V_263 : {
struct V_146 * V_147 = F_125 ( & V_2 -> V_30 ) ;
long V_261 = 0 ;
if ( V_147 )
...
case V_137 :
F_128 () ;
V_162 = F_47 ( V_102 , V_259 ) ;
F_129 () ;
break;
}
return V_162 ;
}
static int F_130 ( struct V_159 * V_1 , unsigned int V_102 , unsigned long V_103 )
{
if ( V_102 == V_134 )
return F_122 ( V_1 , V_102 , ( unsigned long ) F_131 ( V_103 ) ) ;
return - V_258 ;
}
static int T_8 F_132 ( void )
{
int V_162 = F_133 ( & V_168 , 0 ) ;
if ( V_162 != 0 )
goto V_42;
( void ) F_134 ( & V_266 ) ;
V_244 = F_135 ( V_267 , F_101 ) ;
if ( ! V_244 )
F_52 ( V_268 ) ;
F_136 ( & V_269 ) ;
F_136 ( & V_270 ) ;
