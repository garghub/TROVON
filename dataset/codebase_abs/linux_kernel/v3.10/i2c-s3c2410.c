...
V_11 = F_64 ( & V_2 -> V_3 , sizeof( struct V_10 ) , V_134 ) ;
if ( ! V_11 ) {
F_21 ( & V_2 -> V_3 , L_37 ) ;
return - V_135 ;
}
V_11 -> V_100 = F_64 ( & V_2 -> V_3 , sizeof( * V_100 ) , V_134 ) ;
if ( ! V_11 -> V_100 ) {
F_21 ( & V_2 -> V_3 , L_38 ) ;
return - V_135 ;
}
...
F_65 ( V_11 -> V_82 . V_136 , L_39 , sizeof( V_11 -> V_82 . V_136 ) ) ;
V_11 -> V_82 . V_137 = V_138 ;
V_11 -> V_82 . V_139 = & V_140 ;
V_11 -> V_82 . V_86 = 2 ;
V_11 -> V_82 . V_141 = V_142 | V_143 ;
V_11 -> V_35 = 50 ;
F_66 ( & V_11 -> V_17 ) ;
V_11 -> V_3 = & V_2 -> V_3 ;
V_11 -> V_85 = F_67 ( & V_2 -> V_3 , L_40 ) ;
if ( F_68 ( V_11 -> V_85 ) ) {
F_21 ( & V_2 -> V_3 , L_41 ) ;
return - V_144 ;
}
F_5 ( & V_2 -> V_3 , L_42 , V_11 -> V_85 ) ;
V_132 = F_69 ( V_2 , V_145 , 0 ) ;
V_11 -> V_19 = F_70 ( & V_2 -> V_3 , V_132 ) ;
if ( F_68 ( V_11 -> V_19 ) )
return F_71 ( V_11 -> V_19 ) ;
F_5 ( & V_2 -> V_3 , L_43 ,
V_11 -> V_19 , V_132 ) ;
V_11 -> V_82 . V_83 = V_11 ;
V_11 -> V_82 . V_3 . V_146 = & V_2 -> V_3 ;
V_11 -> V_147 = F_72 ( V_11 -> V_3 ) ;
if ( V_11 -> V_100 -> V_148 ) {
V_11 -> V_100 -> V_148 ( F_73 ( V_11 -> V_3 ) ) ;
} else if ( F_68 ( V_11 -> V_147 ) && F_54 ( V_11 ) ) {
return - V_60 ;
}
F_36 ( V_11 -> V_85 ) ;
V_12 = F_60 ( V_11 ) ;
...
V_11 -> V_149 = V_12 = F_74 ( V_2 , 0 ) ;
if ( V_12 <= 0 ) {
F_21 ( & V_2 -> V_3 , L_45 ) ;
return V_12 ;
}
V_12 = F_75 ( & V_2 -> V_3 , V_11 -> V_149 , F_23 , 0 ,
F_76 ( & V_2 -> V_3 ) , V_11 ) ;
if ( V_12 != 0 ) {
F_21 ( & V_2 -> V_3 , L_46 , V_11 -> V_149 ) ;
return V_12 ;
}
V_12 = F_50 ( V_11 ) ;
if ( V_12 < 0 ) {
...
V_11 -> V_82 . V_150 = V_11 -> V_100 -> V_130 ;
...
F_80 ( & V_2 -> V_3 ) ;
F_80 ( & V_11 -> V_82 . V_3 ) ;
F_49 ( & V_2 -> V_3 , L_49 , F_76 ( & V_11 -> V_82 . V_3 ) ) ;
return 0 ;
}
...
F_84 ( & V_11 -> V_82 ) ;
F_37 ( V_11 -> V_85 ) ;
if ( V_2 -> V_3 . V_4 && F_68 ( V_11 -> V_147 ) )
F_59 ( V_11 ) ;
return 0 ;
}
