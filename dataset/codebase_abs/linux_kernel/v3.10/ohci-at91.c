...
static int F_44 ( struct V_7 * V_8 , T_2 V_55 , T_2 V_56 ,
T_2 V_57 , char * V_52 , T_2 V_58 )
{
struct V_35 * V_46 = V_8 -> V_37 . V_38 -> V_39 ;
struct V_59 * V_60 ;
int V_42 = - V_51 ;
...
static T_4 F_48 ( int V_78 , void * V_61 )
{
struct V_5 * V_6 = V_61 ;
struct V_35 * V_46 = V_6 -> V_11 . V_39 ;
int V_79 , V_80 , V_47 ;
F_43 (port) {
if ( F_37 ( V_46 -> V_81 [ V_47 ] ) &&
F_49 ( V_46 -> V_81 [ V_47 ] ) == V_78 ) {
V_80 = V_46 -> V_81 [ V_47 ] ;
break;
}
}
...
return 0 ;
if ( ! V_6 -> V_11 . V_89 )
V_6 -> V_11 . V_89 = & V_6 -> V_11 . V_90 ;
if ( ! V_6 -> V_11 . V_90 )
V_6 -> V_11 . V_90 = F_51 ( 32 ) ;
V_46 = F_52 ( & V_6 -> V_11 , sizeof( * V_46 ) , V_91 ) ;
if ( ! V_46 )
return - V_22 ;
if ( ! F_53 ( V_85 , L_27 , & V_44 ) )
V_46 -> V_44 = V_44 ;
F_43 (i) {
V_80 = F_54 ( V_85 , L_28 , V_87 , & V_19 ) ;
V_46 -> V_49 [ V_87 ] = V_80 ;
if ( ! F_37 ( V_80 ) )
continue;
