...
if ( ! V_86 -> V_27 . V_88 )
goto V_139;
V_9 = F_33 ( V_280 , V_86 -> V_27 . V_88 , & V_278 ) ;
if ( ! V_9 ) {
F_43 ( V_105 L_39 ,
V_2 -> V_56 ) ;
goto V_139;
...
V_86 -> V_27 . V_88 -> V_281 = F_46 ;
V_100 = F_47 ( & V_2 -> V_87 , V_282 , V_2 ,
& V_2 -> V_57 -> V_2 , V_283 , 0 ) ;
if ( ! V_100 ) {
...
if ( V_2 -> V_116 == V_117 ) {
struct V_284 V_285 ;
static int V_3 = V_286 | V_287 ;
V_285 . V_41 = V_288 ;
V_285 . V_28 = & V_3 ;
F_13 ( V_2 , V_41 , V_289 , & V_285 ) ;
