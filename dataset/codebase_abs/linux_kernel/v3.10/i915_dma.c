...
int F_123 ( struct V_7 * V_4 , struct V_229 * V_12 )
{
struct V_9 * V_10 ;
...
void F_125 ( struct V_7 * V_4 , struct V_229 * V_12 )
{
...
static void
F_126 ( struct V_1 * V_2 , unsigned long V_230 ,
unsigned long V_32 )
{
V_2 -> V_158 . V_231 = - 1 ;
#if F_127 ( V_232 )
...
return;
#endif
V_2 -> V_158 . V_231 = F_128 ( V_230 , V_32 , V_234 , 1 ) ;
if ( V_2 -> V_158 . V_231 < 0 ) {
F_105 ( L_36
L_37 ) ;
}
}
...
if ( ! V_236 )
return;
V_236 -> V_237 [ 0 ] . V_230 = V_2 -> V_173 . V_174 ;
V_236 -> V_237 [ 0 ] . V_32 = V_2 -> V_173 . V_238 - V_2 -> V_173 . V_93 ;
V_11 =
V_133 -> V_239 [ V_240 ] . V_185 & V_241 ;
F_131 ( V_236 , L_38 , V_11 ) ;
F_52 ( V_236 ) ;
}
...
static void F_135 ( struct V_7 * V_4 )
{
struct V_1 * V_2 = V_4 -> V_8 ;
if ( F_136 ( V_4 ) )
F_137 ( V_246 , V_247 ) ;
}
int F_138 ( struct V_7 * V_4 , unsigned long V_185 )
{
struct V_1 * V_2 ;
struct V_242 * V_243 ;
int V_40 = 0 , V_248 , V_249 ;
T_14 V_250 ;
V_243 = (struct V_242 * ) V_185 ;
if ( V_243 -> V_19 >= 6 && ! F_15 ( V_4 , V_25 ) )
return - V_64 ;
V_4 -> V_251 += 4 ;
V_4 -> V_252 [ 6 ] = V_253 ;
V_4 -> V_252 [ 7 ] = V_254 ;
...
V_249 = 2 * 1024 * 1024 ;
V_2 -> V_259 = F_140 ( V_4 -> V_133 , V_248 , V_249 ) ;
if ( ! V_2 -> V_259 ) {
F_26 ( L_41 ) ;
V_40 = - V_257 ;
goto V_260;
...
F_142 ( V_4 -> V_133 ) ;
if ( F_139 ( V_4 ) )
F_143 ( & V_4 -> V_133 -> V_4 , F_144 ( 30 ) ) ;
if ( F_145 ( V_4 ) || F_146 ( V_4 ) )
F_143 ( & V_4 -> V_133 -> V_4 , F_144 ( 32 ) ) ;
V_250 = V_2 -> V_173 . V_238 ;
V_2 -> V_173 . V_261 =
F_147 ( V_2 -> V_173 . V_174 ,
V_250 ) ;
if ( V_2 -> V_173 . V_261 == NULL ) {
V_40 = - V_257 ;
goto V_262;
}
F_126 ( V_2 , V_2 -> V_173 . V_174 ,
V_250 ) ;
V_2 -> V_263 = F_148 ( L_42 , 0 ) ;
if ( V_2 -> V_263 == NULL ) {
F_26 ( L_43 ) ;
V_40 = - V_58 ;
goto V_264;
...
F_158 ( V_4 -> V_133 ) ;
F_159 ( & V_2 -> V_265 ) ;
F_159 ( & V_2 -> V_266 . V_267 ) ;
F_159 ( & V_2 -> V_268 . V_267 ) ;
F_160 ( & V_2 -> V_269 ) ;
F_160 ( & V_2 -> V_268 . V_270 ) ;
F_160 ( & V_2 -> V_271 ) ;
V_2 -> V_272 = 1 ;
if ( F_161 ( V_4 ) )
V_2 -> V_272 = 2 ;
if ( F_9 ( V_4 ) -> V_225 ) {
V_40 = F_162 ( V_4 , F_9 ( V_4 ) -> V_225 ) ;
if ( V_40 )
goto V_273;
}
V_2 -> V_158 . V_226 = 1 ;
...
return 0 ;
V_273:
if ( V_2 -> V_158 . V_274 . V_275 )
F_167 ( & V_2 -> V_158 . V_274 ) ;
if ( V_4 -> V_133 -> V_276 )
F_168 ( V_4 -> V_133 ) ;
F_169 ( V_4 ) ;
F_89 ( V_4 ) ;
...
V_264:
if ( V_2 -> V_158 . V_231 >= 0 ) {
F_171 ( V_2 -> V_158 . V_231 ,
V_2 -> V_173 . V_174 ,
V_250 ) ;
V_2 -> V_158 . V_231 = - 1 ;
}
F_172 ( V_2 -> V_173 . V_261 ) ;
V_2 -> V_173 . V_277 ( V_4 ) ;
V_262:
F_173 ( V_4 -> V_133 , V_2 -> V_259 ) ;
V_260:
F_174 ( V_2 -> V_176 ) ;
V_258:
F_52 ( V_2 ) ;
...
F_185 ( & V_2 -> V_266 . V_281 ) ;
F_184 ( & V_2 -> V_266 . V_282 ) ;
F_186 ( V_4 ) ;
if ( V_4 -> V_133 -> V_276 )
F_168 ( V_4 -> V_133 ) ;
F_187 ( V_4 ) ;
...
int F_193 ( struct V_7 * V_4 , struct V_61 * V_285 )
{
struct V_286 * V_62 ;
F_25 ( L_17 ) ;
...
return - V_58 ;
V_285 -> V_13 = V_62 ;
F_159 ( & V_62 -> V_158 . V_267 ) ;
F_194 ( & V_62 -> V_158 . V_287 ) ;
F_195 ( & V_62 -> V_288 ) ;
return 0 ;
}
void F_196 ( struct V_7 * V_4 )
{
T_2 * V_2 = V_4 -> V_8 ;
if ( ! V_2 )
return;
...
void F_200 ( struct V_7 * V_4 , struct V_61 * V_62 )
{
F_201 ( V_4 , V_62 ) ;
F_202 ( V_4 , V_62 ) ;
}
void F_203 ( struct V_7 * V_4 , struct V_61 * V_285 )
{
struct V_286 * V_62 = V_285 -> V_13 ;
F_52 ( V_62 ) ;
}
int F_204 ( struct V_7 * V_4 )
{
return 1 ;
}
