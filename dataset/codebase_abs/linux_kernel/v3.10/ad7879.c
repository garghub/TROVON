...
{
const struct V_68 * V_69 = V_2 -> V_6 -> V_83 ;
int V_70 ;
if ( V_69 -> V_71 ) {
V_70 = F_43 ( & V_2 -> V_60 ) ;
if ( V_70 )
...
struct V_1 * F_44 ( struct V_51 * V_6 , T_1 V_84 , unsigned int V_36 ,
const struct V_85 * V_4 )
{
struct V_68 * V_69 = V_6 -> V_83 ;
struct V_1 * V_2 ;
struct V_13 * V_13 ;
int V_61 ;
T_2 V_86 ;
...
V_2 -> V_36 = V_36 ;
V_2 -> V_26 = V_69 -> V_26 ;
F_47 ( & V_2 -> V_30 , F_12 , ( unsigned long ) V_2 ) ;
...
V_2 -> V_94 = V_69 -> V_94 ;
V_2 -> V_95 = V_69 -> V_95 ;
snprintf ( V_2 -> V_96 , sizeof( V_2 -> V_96 ) , L_7 , F_48 ( V_6 ) ) ;
V_13 -> V_97 = L_8 ;
V_13 -> V_96 = V_2 -> V_96 ;
V_13 -> V_6 . V_98 = V_6 ;
V_13 -> V_99 . V_100 = V_4 -> V_100 ;
V_13 -> V_101 = F_21 ;
V_13 -> V_102 = F_23 ;
F_49 ( V_13 , V_2 ) ;
F_50 ( V_103 , V_13 -> V_104 ) ;
F_50 ( V_32 , V_13 -> V_105 ) ;
F_50 ( V_33 , V_13 -> V_105 ) ;
F_50 ( V_34 , V_13 -> V_105 ) ;
F_50 ( V_106 , V_13 -> V_104 ) ;
F_50 ( V_31 , V_13 -> V_107 ) ;
F_51 ( V_13 , V_32 ,
V_69 -> V_108 ? : 0 ,
V_69 -> V_109 ? : V_22 ,
0 , 0 ) ;
...
0 , 0 ) ;
F_51 ( V_13 , V_34 ,
V_69 -> V_112 , V_69 -> V_28 , 0 , 0 ) ;
V_61 = F_3 ( V_2 , V_42 , V_113 ) ;
if ( V_61 < 0 ) {
F_41 ( V_6 , L_9 , V_13 -> V_97 ) ;
goto V_90;
}
V_86 = F_1 ( V_2 , V_114 ) ;
V_13 -> V_99 . V_115 = ( V_86 & 0xff ) ;
V_13 -> V_99 . V_116 = V_86 >> 8 ;
if ( V_13 -> V_99 . V_115 != V_84 ) {
F_41 ( V_6 , L_10 ,
V_13 -> V_97 , V_84 , V_86 ) ;
V_61 = - V_117 ;
goto V_90;
...
V_123 |
V_124 ;
V_2 -> V_43 = F_18 ( V_125 ) | V_126 |
F_52 ( V_2 -> V_93 ) |
F_53 ( V_2 -> V_95 ) |
F_54 ( V_2 -> V_91 ) ;
V_2 -> V_47 = V_127 | V_128 |
F_55 ( V_2 -> V_92 ) |
F_56 ( V_2 -> V_94 ) ;
V_61 = F_57 ( V_2 -> V_36 , NULL , F_13 ,
V_129 | V_130 ,
F_48 ( V_6 ) , V_2 ) ;
if ( V_61 ) {
