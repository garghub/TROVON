...
return snprintf ( V_1 , 20 , L_17 , V_14 -> V_119 ) ;
}
static T_6
F_48 ( struct V_8 * V_9 ,
...
if ( ! V_76 )
return - V_111 ;
return snprintf ( V_1 , V_149 , L_19 , V_76 ) ;
}
static T_6
F_72 ( struct V_8 * V_9 ,
...
static void
F_107 ( struct V_18 * V_19 , T_8 V_176 , T_8 V_194 , T_8 V_195 )
{
struct V_13 * V_14 ;
unsigned long V_136 ;
F_53 ( V_19 -> V_137 , V_136 ) ;
...
static int
F_109 ( struct V_18 * V_19 , T_8 V_176 , T_8 V_194 , T_8 V_195 )
{
T_8 V_198 , V_199 ;
T_8 V_200 , V_201 ;
...
{
struct V_20 * V_21 = F_10 ( V_19 ) ;
struct V_113 * V_255 = F_43 ( V_19 -> V_114 ) ;
struct V_13 * V_14 ;
struct V_8 * V_9 ;
unsigned long V_136 ;
int error ;
T_7 V_256 ;
V_256 = ( sizeof( struct V_13 ) + V_255 -> V_121 -> V_257 ) ;
V_14 = F_113 ( V_256 , V_81 ) ;
if ( F_114 ( ! V_14 ) ) {
F_29 ( V_236 L_24 , V_94 ) ;
return NULL ;
}
V_14 -> V_28 = - 1 ;
V_14 -> V_23 = V_24 ;
...
V_14 -> V_132 = V_254 -> V_132 ;
V_14 -> V_40 = V_197 ;
if ( V_255 -> V_121 -> V_257 )
V_14 -> V_258 = & V_14 [ 1 ] ;
V_14 -> V_176 = V_176 ;
V_14 -> V_119 = - 1 ;
F_154 ( & V_14 -> V_250 , V_259 ) ;
F_154 ( & V_14 -> V_249 , V_260 ) ;
F_155 ( & V_14 -> V_261 , V_262 ) ;
F_155 ( & V_14 -> V_245 , F_145 ) ;
F_155 ( & V_14 -> V_152 , F_148 ) ;
F_53 ( V_19 -> V_137 , V_136 ) ;
...
struct V_13 *
F_166 ( struct V_18 * V_19 , int V_176 ,
struct V_253 * V_254 )
{
struct V_113 * V_255 = F_43 ( V_19 -> V_114 ) ;
struct V_20 * V_21 = F_10 ( V_19 ) ;
...
if ( V_14 -> V_132 & V_168 &&
V_19 -> V_272 & V_273 )
F_170 ( V_19 , ( unsigned long ) V_14 ) ;
F_171 ( & V_14 -> V_9 ) ;
if ( ( V_14 -> V_119 != - 1 ) &&
( V_14 -> V_119 < V_271 ) )
F_136 ( V_19 , & V_14 -> V_249 ,
V_14 -> V_119 * V_274 ) ;
F_136 ( V_19 , & V_14 -> V_250 , V_271 * V_274 ) ;
}
void
...
V_275 = 1 ;
} else if ( V_19 -> V_272 & V_273 ) {
V_153 = F_173 ( V_19 , ( unsigned long ) V_14 ,
( char * ) & V_14 -> V_15 ) ;
if ( V_153 )
F_29 ( V_236 L_27 ,
V_153 ) ;
...
struct V_165 * V_254 , struct V_134 * * V_281 )
{
struct V_20 * V_21 = F_10 ( V_19 ) ;
struct V_113 * V_255 = F_43 ( V_19 -> V_114 ) ;
struct V_134 * V_135 ;
...
int error ;
* V_281 = NULL ;
if ( ! V_255 -> V_121 -> V_227 )
return - V_79 ;
V_256 = ( sizeof( struct V_134 ) + V_255 -> V_121 -> V_282 ) ;
V_135 = F_113 ( V_256 , V_81 ) ;
if ( F_114 ( ! V_135 ) ) {
F_29 ( V_236 L_24 , V_94 ) ;
return - V_59 ;
}
V_135 -> V_143 = V_283 ;
V_135 -> V_232 = V_283 ;
V_135 -> V_15 = V_254 -> V_15 ;
V_135 -> V_16 = V_254 -> V_16 ;
V_135 -> V_132 = V_254 -> V_132 ;
V_135 -> V_169 = V_254 -> V_169 ;
if ( V_255 -> V_121 -> V_282 )
V_135 -> V_258 = & V_135 [ 1 ] ;
V_135 -> V_19 = V_19 ;
V_135 -> V_176 = V_176 ;
V_135 -> V_136 = V_139 ;
F_155 ( & V_135 -> V_141 , V_284 ) ;
F_53 ( V_19 -> V_137 , V_136 ) ;
...
F_162 ( V_9 ) ;
F_163 ( V_9 ) ;
error = V_255 -> V_121 -> V_227 ( V_135 , V_254 -> V_171 ) ;
if ( error ) {
F_29 ( V_236 L_40 ) ;
goto V_287;
}
if ( V_280 != & V_19 -> V_172 ) {
error = F_177 ( & V_19 -> V_172 . V_288 ,
& V_9 -> V_288 , F_178 ( V_9 ) ) ;
if ( error )
F_29 ( V_236
L_41
L_42 ,
V_94 , F_178 ( V_9 ) , error ) ;
}
F_53 ( V_19 -> V_137 , V_136 ) ;
V_135 -> V_136 &= ~ V_139 ;
F_54 ( V_19 -> V_137 , V_136 ) ;
...
struct V_134 *
F_179 ( struct V_18 * V_19 , int V_176 ,
struct V_165 * V_254 )
{
int V_142 ;
struct V_134 * V_135 ;
...
F_180 ( & V_19 -> V_172 . V_288 , F_178 ( V_9 ) ) ;
F_150 ( V_9 ) ;
F_151 ( V_9 ) ;
F_152 ( V_9 ) ;
F_98 ( V_9 ) ;
...
V_142 = F_91 ( V_135 ) ;
if ( V_142 )
F_174 ( V_236 , V_135 -> V_9 . V_184 ,
L_44
L_45 , V_94 ,
F_178 ( & V_135 -> V_9 ) , V_135 -> V_19 -> V_57 ,
V_135 -> V_176 , V_142 ) ;
}
static void
F_181 ( struct V_291 * V_292 )
{
unsigned long V_136 ;
F_53 ( & V_292 -> V_293 , V_136 ) ;
if ( V_292 -> V_294 ) {
F_54 ( & V_292 -> V_293 , V_136 ) ;
return;
}
F_54 ( & V_292 -> V_293 , V_136 ) ;
F_98 ( V_292 -> V_9 ) ;
F_99 ( V_292 -> V_295 . V_296 ) ;
F_99 ( V_292 -> V_297 . V_296 ) ;
F_99 ( V_292 ) ;
}
static void
F_182 ( struct V_291 * V_292 )
{
struct V_298 * V_299 = V_292 -> V_299 ;
struct V_298 * V_300 = V_299 -> V_301 ;
int V_77 ;
V_77 = V_292 -> V_299 -> V_302 = V_292 -> V_303 -> V_208 ;
if ( V_77 < 0 )
V_292 -> V_299 -> V_304 = sizeof( V_305 ) ;
else
V_292 -> V_299 -> V_304 = V_292 -> V_306 ;
V_299 -> V_307 = 0 ;
if ( V_300 ) {
F_83 ( V_292 -> V_303 -> V_308 > V_300 -> V_307 ) ;
V_300 -> V_307 -= F_183 ( V_292 -> V_303 -> V_308 ,
V_300 -> V_307 ) ;
}
F_184 ( V_299 ) ;
}
static void F_185 ( struct V_298 * V_309 )
{
struct V_291 * V_292 = V_309 -> V_310 ;
unsigned long V_136 ;
F_53 ( & V_292 -> V_293 , V_136 ) ;
V_292 -> V_311 |= V_312 ;
V_292 -> V_294 -- ;
F_54 ( & V_292 -> V_293 , V_136 ) ;
F_186 ( V_309 , V_309 -> V_302 ) ;
F_181 ( V_292 ) ;
}
static enum V_189
F_187 ( struct V_298 * V_299 )
{
struct V_291 * V_292 = ( void * ) V_299 -> V_310 ;
struct V_18 * V_19 = V_292 -> V_19 ;
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
unsigned long V_136 ;
int V_77 = 0 , V_313 = 0 ;
if ( V_292 -> V_14 && V_292 -> V_14 -> V_40 == V_115 )
return V_192 ;
F_53 ( & V_292 -> V_293 , V_136 ) ;
...
V_292 -> V_294 ++ ;
F_54 ( & V_292 -> V_293 , V_136 ) ;
if ( ! V_313 && V_3 -> V_121 -> V_314 ) {
V_77 = V_3 -> V_121 -> V_314 ( V_292 ) ;
if ( V_77 == - V_315 ) {
V_292 -> V_294 -- ;
return V_192 ;
} else if ( V_77 )
...
static int
F_188 ( struct V_317 * V_1 , struct V_298 * V_299 )
{
T_7 V_318 = ( sizeof( struct V_319 ) * V_299 -> V_320 ) ;
F_117 ( ! V_299 -> V_320 ) ;
V_1 -> V_296 = F_113 ( V_318 , V_81 ) ;
if ( ! V_1 -> V_296 )
return - V_59 ;
F_189 ( V_1 -> V_296 , V_299 -> V_320 ) ;
V_1 -> V_321 = F_190 ( V_299 -> V_322 , V_299 , V_1 -> V_296 ) ;
V_1 -> V_323 = F_191 ( V_299 ) ;
return 0 ;
}
static int
F_192 ( struct V_18 * V_19 , struct V_13 * V_14 ,
struct V_298 * V_299 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_298 * V_300 = V_299 -> V_301 ;
...
int V_153 ;
F_117 ( V_299 -> V_310 ) ;
V_292 = F_113 ( sizeof( struct V_291 ) + V_3 -> V_121 -> V_324 ,
V_81 ) ;
if ( ! V_292 )
return - V_59 ;
V_299 -> V_310 = V_292 ;
...
V_292 -> V_299 = V_299 ;
if ( V_3 -> V_121 -> V_324 )
V_292 -> V_258 = ( void * ) & V_292 [ 1 ] ;
F_193 ( & V_292 -> V_293 ) ;
V_292 -> V_298 = (struct V_325 * ) V_299 -> V_326 ;
V_292 -> V_327 = V_299 -> V_328 ;
V_292 -> V_303 = V_299 -> V_329 ;
V_292 -> V_306 = V_330 ;
if ( V_299 -> V_331 ) {
V_153 = F_188 ( & V_292 -> V_295 , V_299 ) ;
if ( V_153 )
goto V_332;
}
if ( V_300 && V_300 -> V_331 ) {
V_153 = F_188 ( & V_292 -> V_297 , V_300 ) ;
if ( V_153 )
goto V_333;
}
V_292 -> V_334 = F_182 ;
...
static enum V_335
F_194 ( struct V_336 * V_322 , struct V_18 * V_19 ,
struct V_291 * V_292 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
int V_337 = sizeof( V_305 ) ;
int V_153 ;
switch ( V_292 -> V_298 -> V_338 ) {
case V_339 :
V_337 += sizeof( struct V_340 ) ;
break;
case V_341 :
V_337 += sizeof( struct V_342 ) ;
break;
case V_343 :
V_337 += sizeof( struct V_344 ) ;
if ( ( ! V_292 -> V_295 . V_323 ) ||
( ! V_292 -> V_297 . V_323 ) ) {
V_153 = - V_111 ;
goto V_345;
}
...
break;
case V_348 :
V_337 += sizeof( struct V_349 ) ;
if ( ( V_19 -> V_237 -> V_89 == 0L ) ||
( V_292 -> V_298 -> V_350 . V_351 . V_89 !=
V_19 -> V_237 -> V_89 ) ) {
V_153 = - V_352 ;
goto V_345;
}
...
if ( V_292 -> V_327 < V_337 ) {
V_153 = - V_354 ;
goto V_345;
}
V_153 = V_3 -> V_121 -> V_355 ( V_292 ) ;
if ( ! V_153 )
return V_356 ;
V_345:
F_117 ( V_292 -> V_306 < sizeof( V_305 ) ) ;
V_292 -> V_303 -> V_308 = 0 ;
V_292 -> V_303 -> V_208 = V_153 ;
V_292 -> V_306 = sizeof( V_305 ) ;
F_182 ( V_292 ) ;
return V_356 ;
}
static void
F_167 ( struct V_13 * V_14 )
{
if ( ! V_14 -> V_64 )
return;
F_157 ( & V_14 -> V_9 ) ;
...
static enum V_335
F_196 ( struct V_336 * V_322 , struct V_18 * V_19 ,
struct V_13 * V_14 , struct V_291 * V_292 )
{
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
int V_337 = sizeof( V_305 ) ;
int V_153 ;
switch ( V_292 -> V_298 -> V_338 ) {
case V_357 :
V_337 += sizeof( struct V_358 ) ;
goto V_359;
case V_360 :
V_337 += sizeof( struct V_361 ) ;
V_359:
if ( ( ! V_292 -> V_295 . V_323 ) ||
( ! V_292 -> V_297 . V_323 ) ) {
V_153 = - V_111 ;
...
static void
F_197 ( struct V_336 * V_322 , struct V_18 * V_19 ,
...
V_292 = V_299 -> V_310 ;
if ( V_292 -> V_327 < sizeof( V_305 ) ) {
F_117 ( V_292 -> V_306 < sizeof( V_305 ) ) ;
V_292 -> V_303 -> V_308 = 0 ;
V_292 -> V_303 -> V_208 = - V_354 ;
V_292 -> V_306 = sizeof( V_305 ) ;
F_182 ( V_292 ) ;
F_200 ( V_322 -> V_364 ) ;
continue;
...
if ( V_14 )
V_153 = F_196 ( V_322 , V_19 , V_14 , V_292 ) ;
else
V_153 = F_194 ( V_322 , V_19 , V_292 ) ;
if ( V_153 == V_365 )
break;
if ( V_153 == V_356 )
F_200 ( V_322 -> V_364 ) ;
...
static void
F_201 ( struct V_336 * V_322 )
{
struct V_18 * V_19 = V_322 -> V_366 ;
F_197 ( V_322 , V_19 , NULL , & V_19 -> V_172 ) ;
}
static void
F_202 ( struct V_336 * V_322 )
{
struct V_13 * V_14 = V_322 -> V_366 ;
struct V_18 * V_19 = F_42 ( V_14 ) ;
F_197 ( V_322 , V_19 , V_14 , & V_14 -> V_9 ) ;
}
static int
...
F_206 ( V_322 , F_187 ) ;
F_207 ( V_322 , V_370 ) ;
V_77 = F_208 ( V_322 , V_9 , V_367 , NULL ) ;
if ( V_77 ) {
F_29 ( V_236 L_49
L_51 ,
V_19 -> V_57 ) ;
...
static int
F_164 ( struct V_18 * V_19 , struct V_13 * V_14 )
{
struct V_8 * V_9 = & V_14 -> V_9 ;
struct V_113 * V_3 = F_43 ( V_19 -> V_114 ) ;
struct V_336 * V_322 ;
...
F_206 ( V_322 , F_187 ) ;
F_207 ( V_322 , V_371 ) ;
V_77 = F_208 ( V_322 , V_9 , NULL , NULL ) ;
if ( V_77 ) {
F_29 ( V_236 L_52
L_51 ,
V_9 -> V_288 . V_76 ) ;
