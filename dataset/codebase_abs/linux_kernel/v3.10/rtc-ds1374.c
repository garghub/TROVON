...
struct V_25 * V_25 ;
int V_6 ;
V_25 = F_30 ( & V_2 -> V_14 , sizeof( struct V_25 ) , V_49 ) ;
if ( ! V_25 )
return - V_50 ;
V_25 -> V_2 = V_2 ;
F_31 ( V_2 , V_25 ) ;
...
return V_6 ;
if ( V_2 -> V_30 > 0 ) {
V_6 = F_34 ( & V_2 -> V_14 , V_2 -> V_30 , F_21 , 0 ,
L_3 , V_2 ) ;
if ( V_6 ) {
F_35 ( & V_2 -> V_14 , L_4 ) ;
return V_6 ;
...
V_25 -> V_43 = F_37 ( & V_2 -> V_14 , V_2 -> V_51 ,
& V_52 , V_53 ) ;
if ( F_38 ( V_25 -> V_43 ) ) {
F_35 ( & V_2 -> V_14 , L_5 ) ;
return F_39 ( V_25 -> V_43 ) ;
}
return 0 ;
}
...
V_25 -> V_46 = 1 ;
F_18 ( & V_25 -> V_31 ) ;
F_41 ( & V_2 -> V_14 , V_2 -> V_30 , V_2 ) ;
F_42 ( & V_25 -> V_39 ) ;
}
return 0 ;
}
static int F_43 ( struct V_19 * V_14 )
{
struct V_1 * V_2 = F_11 ( V_14 ) ;
if ( V_2 -> V_30 >= 0 && F_44 ( & V_2 -> V_14 ) )
F_45 ( V_2 -> V_30 ) ;
return 0 ;
}
static int F_46 ( struct V_19 * V_14 )
{
struct V_1 * V_2 = F_11 ( V_14 ) ;
if ( V_2 -> V_30 >= 0 && F_44 ( & V_2 -> V_14 ) )
F_47 ( V_2 -> V_30 ) ;
