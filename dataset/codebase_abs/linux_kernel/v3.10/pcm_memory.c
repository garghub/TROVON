...
if ( F_27 ( V_2 ) )
return - V_31 ;
if ( F_28 ( V_2 -> V_6 . V_10 . type ==
V_57 ) )
return - V_31 ;
V_29 = V_2 -> V_29 ;
if ( V_29 -> V_58 ) {
if ( V_29 -> V_58 -> V_9 >= V_3 ) {
V_29 -> V_59 = V_3 ;
return 0 ;
}
F_29 ( V_2 ) ;
...
struct V_48 * F_37 ( struct V_1 * V_2 ,
unsigned long V_49 )
{
return F_38 ( V_2 -> V_29 -> V_61 + V_49 ) ;
}
