...
for ( V_8 = 0 ; V_8 <= 4 ; V_8 ++ )
V_7 [ V_8 ] |= 0x80 ;
if ( ( V_39 = F_9 ( V_2 , V_41 , 3 ) ) != 3 ) {
F_3 ( & V_2 -> V_16 , L_7 , V_17 , V_39 ) ;
return - V_18 ;
}
if ( ( V_39 = F_9 ( V_2 , V_43 , 3 ) ) != 3 ) {
...
{
int V_50 , V_93 , V_94 ;
if ( ( V_50 = F_12 ( F_17 ( V_16 ) , & V_93 ) ) == 0 )
F_22 ( V_92 , L_21 , V_93 ) ;
if ( ( V_50 = F_13 ( F_17 ( V_16 ) , & V_94 ) ) == 0 )
F_22 ( V_92 , L_22 ,
V_94 / 1000 , V_94 % 1000 ) ;
return 0 ;
}
