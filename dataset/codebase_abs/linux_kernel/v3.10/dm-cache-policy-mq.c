...
static void F_95 ( struct V_32 * V_33 , T_2 V_47 )
{
struct V_34 * V_35 = F_41 ( V_33 , V_47 ) ;
F_28 ( ! V_35 || ! V_35 -> V_67 ) ;
F_62 ( V_33 , V_35 ) ;
...
static void F_96 ( struct V_95 * V_96 , T_2 V_47 )
{
struct V_32 * V_33 = F_81 ( V_96 ) ;
F_88 ( & V_33 -> V_102 ) ;
F_95 ( V_33 , V_47 ) ;
...
static void F_97 ( struct V_32 * V_33 ,
T_2 V_109 , T_2 V_110 )
{
...
struct V_32 * V_33 = F_81 ( V_96 ) ;
F_88 ( & V_33 -> V_102 ) ;
F_97 ( V_33 , V_109 , V_110 ) ;
F_91 ( & V_33 -> V_102 ) ;
}
static T_3 F_99 ( struct V_95 * V_96 )
{
struct V_32 * V_33 = F_81 ( V_96 ) ;
return F_56 ( V_33 -> V_56 ) ;
}
static void F_100 ( struct V_95 * V_96 )
{
struct V_32 * V_33 = F_81 ( V_96 ) ;
unsigned long V_98 ;
F_85 ( & V_33 -> V_99 , V_98 ) ;
...
return - V_113 ;
if ( F_102 ( V_112 , 10 , & V_36 ) )
return - V_113 ;
V_33 -> V_94 . V_16 [ V_11 ] = V_36 ;
return 0 ;
}
static int F_103 ( struct V_95 * V_96 , char * V_59 , unsigned V_114 )
{
T_6 V_115 = 0 ;
struct V_32 * V_33 = F_81 ( V_96 ) ;
F_104 ( L_4 ,
...
V_33 -> V_97 . F_95 = F_96 ;
V_33 -> V_97 . V_120 = NULL ;
V_33 -> V_97 . F_97 = F_98 ;
V_33 -> V_97 . V_121 = F_99 ;
V_33 -> V_97 . V_66 = F_100 ;
V_33 -> V_97 . V_122 = F_103 ;
V_33 -> V_97 . V_123 = F_101 ;
}
static struct V_95 * F_106 ( T_3 V_54 ,
T_7 V_124 ,
T_7 V_125 )
{
int V_29 ;
struct V_32 * V_33 = F_107 ( sizeof( * V_33 ) , V_43 ) ;
if ( ! V_33 )
return NULL ;
F_105 ( V_33 ) ;
F_9 ( & V_33 -> V_94 , V_126 , V_127 ) ;
V_33 -> V_54 = V_54 ;
V_33 -> V_100 = 0 ;
V_33 -> V_66 = 0 ;
V_33 -> V_65 = 0 ;
...
V_33 -> V_42 = 0 ;
V_33 -> V_56 = 0 ;
V_33 -> V_129 = F_1 ( F_49 ( V_54 ) / 2 , 16 ) ;
V_33 -> V_48 = F_110 ( V_33 -> V_129 ) - 1 ;
V_33 -> V_50 = F_107 ( sizeof( * V_33 -> V_50 ) * V_33 -> V_129 , V_43 ) ;
if ( ! V_33 -> V_50 )
goto V_130;
