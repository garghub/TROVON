...
snprintf ( V_251 , 512 , L_108 , & V_245 -> V_252 [ 0 ] ) ;
V_246 = F_73 ( V_251 , V_247 , 0600 ) ;
if ( F_74 ( V_246 ) ) {
F_9 ( L_109
L_81 , V_251 ) ;
return F_75 ( V_246 ) ;
...
if ( ! V_125 )
V_125 = ( strlen ( & V_3 [ 0 ] ) + 1 ) ;
V_55 = F_76 ( V_246 , V_3 , V_125 , 0 ) ;
if ( V_55 < 0 )
F_11 ( L_110 , V_251 ) ;
F_77 ( V_246 ) ;
return V_55 ? - V_253 : 0 ;
...
static int
F_78 ( struct V_9 * V_10 , unsigned char * V_254 ,
T_1 V_255 )
{
unsigned char V_256 [ 64 ] , * V_3 ;
T_1 V_125 ;
int V_237 = 0 ;
int V_55 ;
if ( ! V_254 ) {
...
static T_2
F_79 ( struct V_7 * V_8 , T_3 V_257 , T_3 V_119 ,
int V_121 , int V_120 , int V_258 , int V_259 )
{
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_59 * V_51 ;
...
struct V_39 * V_42 ;
struct V_1 * V_2 , * V_260 , * V_147 , * V_210 ;
struct V_26 * V_27 = & V_10 -> V_28 ;
...
static T_2
F_81 ( struct V_7 * V_8 , int type , int V_268 , T_3 V_257 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_49 * V_49 = V_8 -> V_49 ;
...
static T_2
F_82 ( struct V_7 * V_8 , int type , int V_268 ,
T_3 V_257 )
{
switch ( type ) {
case V_69 :
...
case V_34 :
case V_35 :
return F_81 ( V_8 , type , V_268 , V_257 ) ;
default:
F_9 ( L_156
L_157 , type ) ;
return V_264 ;
...
int V_271 )
{
struct V_144 * V_145 = V_270 -> V_42 -> V_47 ;
char V_170 [ V_171 ] ;
int V_172 ;
memset ( V_170 , 0 , V_171 ) ;
V_172 = F_1 ( V_2 , & V_170 [ 0 ] ,
...
F_11 ( L_158
L_153 ,
V_145 -> V_48 () , ( V_271 ) ? L_159 : L_160 ,
F_15 ( V_2 -> V_31 ) ,
( V_2 -> V_135 ) ? 1 : 0 ) ;
F_11 ( L_161 ,
V_145 -> V_48 () , V_270 -> V_53 ,
( V_172 ) ? & V_170 [ 0 ] : L_29 ) ;
V_2 -> V_30 = V_2 -> V_31 = V_2 -> V_162 = 0 ;
}
static T_2
F_83 ( struct V_7 * V_8 , int type , int V_268 ,
T_3 V_257 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_12 * V_14 = V_8 -> V_14 ;
...
static T_2
F_84 ( struct V_7 * V_8 , T_3 V_257 )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_20 * V_111 ;
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_26 * V_27 = & V_10 -> V_28 ;
struct V_1 * V_2 , * V_147 , * V_273 , * V_30 ;
T_1 V_133 = 0 ;
int V_274 = 0 ;
V_273 = F_4 ( V_8 -> V_11 ,
V_14 -> V_20 , V_14 ) ;
...
if ( V_257 != V_273 -> V_110 ) {
F_9 ( L_119
L_120
L_121
L_122 , V_257 , V_273 -> V_110 ) ;
F_5 ( V_273 ) ;
return V_21 ;
}
F_6 ( & V_10 -> V_44 ) ;
...
static T_2
F_87 ( struct V_7 * V_8 , int type , int V_268 , T_3 V_257 ,
T_3 V_119 , int abort )
{
struct V_9 * V_10 = V_8 -> V_11 ;
struct V_20 * V_111 ;
...
static T_2
F_89 ( struct V_7 * V_8 , int type , int V_268 ,
T_3 V_257 , T_3 V_119 , int abort )
{
switch ( type ) {
case V_69 :
case V_70 :
...
case V_34 :
case V_35 :
return F_87 ( V_8 , type , V_268 , V_257 ,
V_119 , abort ) ;
default:
F_9 ( L_180
...
static T_2
F_90 ( struct V_7 * V_8 , T_3 V_257 ,
T_3 V_119 , int V_121 , int V_281 )
{
struct V_12 * V_14 = V_8 -> V_14 ;
struct V_9 * V_10 = V_8 -> V_11 ;
...
struct V_141 * V_141 ;
struct V_39 * V_42 , * V_282 = NULL ;
struct V_144 * V_283 = NULL , * V_284 ;
...
char * V_221 = NULL , V_222 [ 64 ] , V_170 [ V_171 ] ;
T_1 V_224 , V_286 ;
int V_287 = 0 , type , V_268 , V_288 , V_172 ;
T_2 V_55 ;
...
V_285 = V_283 -> V_234 ( V_282 ,
( const char * ) & V_3 [ 24 ] , & V_286 , & V_221 ) ;
if ( ! V_285 ) {
F_9 ( L_192
L_201 ) ;
V_55 = V_230 ;
...
V_3 = NULL ;
F_11 ( L_202
L_203 , V_283 -> V_48 () , ( V_221 != NULL ) ?
L_204 : L_205 , V_285 , ( V_221 != NULL ) ?
V_221 : L_29 ) ;
V_111 = V_2 -> V_111 ;
V_288 = ( ! strcmp ( V_285 ,
V_111 -> V_53 ) ) ? 1 : 0 ;
...
L_215 , V_283 -> V_48 () ,
V_205 -> V_53 ) ;
V_206 = F_68 ( V_205 , V_289 ) ;
if ( ! V_206 ) {
F_9 ( L_216
L_194 , V_283 -> V_48 () , V_289 ) ;
V_55 = V_230 ;
goto V_43;
}
if ( F_33 ( V_206 ) ) {
...
F_11 ( L_229
L_230 ,
V_284 -> V_48 () , V_111 -> V_53 ,
( V_172 ) ? & V_170 [ 0 ] : L_29 , V_283 -> V_48 () ,
...
V_291 = ( V_58 [ 0 ] << 24 ) | ( V_58 [ 1 ] << 16 ) | ( V_58 [ 2 ] << 8 ) | V_58 [ 3 ] ;
V_292 = ( V_58 [ 4 ] << 24 ) | ( V_58 [ 5 ] << 16 ) | ( V_58 [ 6 ] << 8 ) | V_58 [ 7 ] ;
return ( ( unsigned long long ) V_292 ) | ( unsigned long long ) V_291 << 32 ;
}
T_2
F_92 ( struct V_7 * V_8 )
{
...
unsigned char * V_3 ;
T_3 V_257 , V_119 ;
int V_293 , V_268 , type , V_121 ;
int V_258 = 0 , V_120 = 0 , V_281 = 0 ;
T_2 V_55 ;
...
case V_83 :
V_55 = F_79 ( V_8 ,
V_257 , V_119 , V_121 , V_120 , V_258 , 0 ) ;
break;
case V_86 :
V_55 = F_82 ( V_8 , type , V_268 , V_257 ) ;
break;
case V_87 :
V_55 = F_83 ( V_8 , type , V_268 , V_257 ) ;
break;
case V_80 :
V_55 = F_84 ( V_8 , V_257 ) ;
break;
case V_81 :
V_55 = F_89 ( V_8 , type , V_268 ,
V_257 , V_119 , 0 ) ;
break;
case V_82 :
V_55 = F_89 ( V_8 , type , V_268 ,
...
V_42 , V_270 , V_2 , & V_300 ) ;
if ( ( V_299 + V_294 ) > V_8 -> V_229 ) {
F_63 ( L_244
L_245 , V_8 -> V_229 ) ;
F_6 ( & V_27 -> V_36 ) ;
F_34 ( & V_2 -> V_131 ) ;
...
V_3 [ V_295 ++ ] = ( ( V_142 -> V_235 >> 8 ) & 0xff ) ;
V_3 [ V_295 ++ ] = ( V_142 -> V_235 & 0xff ) ;
} else
V_295 += 2 ;
V_298 = V_42 -> V_47 -> V_302 ( V_42 ,
V_270 , V_2 , & V_300 , & V_3 [ V_295 + 4 ] ) ;
F_6 ( & V_27 -> V_36 ) ;
F_34 ( & V_2 -> V_131 ) ;
F_35 () ;
