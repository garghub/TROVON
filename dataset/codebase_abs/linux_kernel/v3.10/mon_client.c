...
{
struct V_127 * V_128 = V_23 -> V_66 -> V_129 ;
struct V_21 * V_130 = V_128 -> V_130 ;
int V_11 = V_128 -> V_11 ;
int V_5 ;
...
return - V_18 ;
for ( V_5 = 0 ; V_5 < V_11 ; V_5 ++ ) {
V_23 -> V_38 -> V_15 [ V_5 ] . V_19 = V_130 [ V_5 ] ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_19 . V_132 = 0 ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_133 . type =
V_43 ;
V_23 -> V_38 -> V_15 [ V_5 ] . V_133 . V_52 = F_34 ( V_5 ) ;
}
V_23 -> V_38 -> V_11 = V_11 ;
return 0 ;
}
int F_93 ( struct V_22 * V_23 , struct V_69 * V_134 )
{
int V_6 = 0 ;
F_4 ( L_30 ) ;
...
if ( V_6 )
goto V_73;
V_23 -> V_35 = F_95 ( V_134 -> V_129 -> V_133 ,
V_134 -> V_129 -> V_135 ) ;
if ( F_48 ( V_23 -> V_35 ) ) {
V_6 = F_49 ( V_23 -> V_35 ) ;
goto V_136;
...
V_139 | V_140 ;
V_6 = - V_18 ;
V_23 -> V_34 = F_78 ( V_141 ,
sizeof( struct V_59 ) ,
V_17 , true ) ;
if ( ! V_23 -> V_34 )
goto V_142;
V_23 -> V_33 = F_78 ( V_143 , 96 , V_17 ,
true ) ;
if ( ! V_23 -> V_33 )
goto V_144;
V_23 -> V_32 = F_78 ( V_145 , 4096 , V_17 ,
true ) ;
if ( ! V_23 -> V_32 )
goto V_146;
V_23 -> V_25 = F_78 ( V_147 , 4096 , V_17 , true ) ;
V_23 -> V_24 = 0 ;
if ( ! V_23 -> V_25 )
goto V_148;
F_96 ( & V_23 -> V_30 , V_23 , & V_149 ,
& V_23 -> V_66 -> V_150 ) ;
V_23 -> V_31 = - 1 ;
V_23 -> V_63 = true ;
V_23 -> V_40 = V_41 ;
...
F_37 ( & V_23 -> V_62 ) ;
V_71 = F_46 ( V_23 ) ;
V_152 = F_91 ( V_23 -> V_35 ) ;
V_23 -> V_24 = 0 ;
V_37 = F_103 ( V_23 -> V_35 , V_50 -> V_26 . V_44 ,
V_50 -> V_26 . V_27 ,
V_23 -> V_25 -> V_26 . V_44 ,
V_23 -> V_25 -> V_45 ) ;
if ( V_37 < 0 ) {
V_23 -> V_66 -> V_153 = V_37 ;
F_53 ( & V_23 -> V_66 -> V_75 ) ;
} else if ( V_37 > 0 ) {
F_14 ( V_23 , V_37 ) ;
} else if ( ! V_152 && F_91 ( V_23 -> V_35 ) ) {
F_4 ( L_32 ) ;
V_23 -> V_66 -> V_150 . V_154 . V_133 . type = V_155 ;
V_23 -> V_66 -> V_150 . V_154 . V_133 . V_52 =
F_34 ( V_23 -> V_35 -> V_68 ) ;
F_31 ( V_23 ) ;
F_86 ( V_23 ) ;
}
...
if ( V_23 -> V_24 )
return 0 ;
V_37 = F_104 ( V_23 -> V_35 , V_23 -> V_25 -> V_26 . V_44 ,
V_23 -> V_25 -> V_45 ) ;
if ( V_37 <= 0 )
return V_37 ;
F_14 ( V_23 , V_37 ) ;
...
static void F_106 ( struct V_90 * V_30 , struct V_49 * V_50 )
{
struct V_22 * V_23 = V_30 -> V_93 ;
int type = F_107 ( V_50 -> V_28 . type ) ;
if ( ! V_23 )
return;
switch ( type ) {
case V_145 :
...
break;
case V_157 :
F_108 ( & V_23 -> V_66 -> V_158 , V_50 ) ;
break;
default:
if ( V_23 -> V_66 -> V_159 &&
V_23 -> V_66 -> V_159 ( V_23 -> V_66 , V_50 ) == 0 )
break;
F_40 ( L_33 , type ,
F_109 ( type ) ) ;
}
...
static struct V_49 * F_110 ( struct V_90 * V_30 ,
struct V_91 * V_28 ,
int * V_92 )
{
struct V_22 * V_23 = V_30 -> V_93 ;
int type = F_107 ( V_28 -> type ) ;
...
static void F_111 ( struct V_90 * V_30 )
{
struct V_22 * V_23 = V_30 -> V_93 ;
if ( ! V_23 )
return;
...
static struct V_90 * F_112 ( struct V_90 * V_30 )
{
return V_30 ;
}
static void F_113 ( struct V_90 * V_30 )
{
}
