...
struct V_12 * V_13 = F_2 ( F_3 ( V_50 ) ,
struct V_12 , V_108 ) ;
struct V_51 * V_134 = & V_13 -> V_108 ;
struct V_1 * V_75 ;
int V_76 ;
for ( V_76 = 0 ; V_134 -> V_70 [ V_76 ] ; V_76 ++ ) {
V_75 = & V_134 -> V_70 [ V_76 ] -> V_29 ;
V_134 -> V_70 [ V_76 ] = NULL ;
F_30 ( V_75 ) ;
}
F_30 ( V_50 ) ;
}
...
V_121 = V_57 -> V_77 . V_137 ( V_57 , V_52 , V_53 ) ;
if ( ! V_121 || F_33 ( V_121 ) )
return F_19 ( - V_26 ) ;
V_121 -> V_59 = V_57 ;
V_121 -> V_123 . V_70 = V_121 -> V_138 ;
V_121 -> V_123 . V_70 [ 0 ] = & V_121 -> V_139 ;
V_121 -> V_123 . V_70 [ 1 ] = NULL ;
F_25 ( & V_121 -> V_123 , V_53 ,
& F_26 ( V_57 ) -> V_140 ) ;
F_25 ( & V_121 -> V_139 , L_28 ,
& F_26 ( V_57 ) -> V_141 ) ;
return & V_121 -> V_123 ;
}
static void F_71 (
...
struct V_120 , V_123 ) ;
struct V_1 * V_75 ;
struct V_51 * V_142 = & V_121 -> V_123 ;
int V_76 ;
for ( V_76 = 0 ; V_142 -> V_70 [ V_76 ] ; V_76 ++ ) {
V_75 = & V_142 -> V_70 [ V_76 ] -> V_29 ;
V_142 -> V_70 [ V_76 ] = NULL ;
F_30 ( V_75 ) ;
}
F_30 ( V_50 ) ;
}
