...
static int F_15 ( struct V_22 * V_23 , T_4 * V_85 )
{
struct V_1 * V_2 = V_23 -> V_26 ;
T_2 V_86 = F_5 ( V_2 , 0xf16 ) ;
T_2 V_87 = F_5 ( V_2 , 0x200 ) ;
T_2 V_88 = F_5 ( V_2 , 0xf17 ) ;
* V_85 = 0 ;
if ( V_86 > 0x00f )
* V_85 |= V_89 ;
if ( ( V_88 & 0x00f ) == 0x002 ) {
...
static int F_16 ( struct V_22 * V_23 , T_3 * V_95 )
{
struct V_1 * V_2 = V_23 -> V_26 ;
* V_95 = ( F_5 ( V_2 , 0xc08 ) & 0x3f ) |
( F_5 ( V_2 , 0xc07 ) << 6 ) ;
F_4 ( V_2 , 0xc08 , 0x000 ) ;
F_4 ( V_2 , 0xc07 , 0x000 ) ;
if ( * V_95 >= 0x3fff0 )
...
static int F_17 ( struct V_22 * V_23 , T_2 * V_96 )
{
struct V_1 * V_2 = V_23 -> V_26 ;
T_2 V_86 = F_5 ( V_2 , 0xf16 ) ;
T_3 signal = 3 * ( V_86 << 4 ) ;
* V_96 = ( signal < 0xffff ) ? signal : 0xffff ;
return 0 ;
}
static int F_18 ( struct V_22 * V_23 , T_2 * V_97 )
{
struct V_1 * V_2 = V_23 -> V_26 ;
T_2 V_86 = F_5 ( V_2 , 0xf16 ) ;
* V_97 = ( V_86 << 4 ) | ( V_86 >> 8 ) ;
...
static int F_19 ( struct V_22 * V_23 , T_3 * V_98 )
{
struct V_1 * V_2 = V_23 -> V_26 ;
* V_98 = F_5 ( V_2 , 0xc0c ) ;
if ( * V_98 == 0xfff )
...
static int F_20 ( struct V_22 * V_23 , int V_99 )
{
struct V_1 * V_2 = V_23 -> V_26 ;
if ( V_99 ) {
...
if ( ! V_2 -> V_100 ) {
F_3 ( L_10 , V_101 ) ;
V_18 = V_2 -> V_8 -> V_102 ( V_23 , & V_25 , V_101 ) ;
if ( V_18 ) {
F_3 ( L_11 ) ;
return V_18 ;
}
...
static int F_24 ( struct V_22 * V_23 , struct V_103 * V_104 )
{
V_104 -> V_105 = 350 ;
V_104 -> V_106 = 166666 * 2 ;
V_104 -> V_107 = ( 166666 * 2 ) + 1 ;
return 0 ;
}
...
struct V_22 * F_27 ( const struct V_108 * V_8 ,
struct V_109 * V_12 )
{
struct V_1 * V_2 = NULL ;
V_2 = F_28 ( sizeof( struct V_1 ) , V_110 ) ;
if ( V_2 == NULL ) goto error;
V_2 -> V_8 = V_8 ;
V_2 -> V_12 = V_12 ;
V_2 -> V_100 = 0 ;
if ( F_5 ( V_2 , 0x0200 ) < 0 ) goto error;
memcpy ( & V_2 -> V_111 . V_78 , & V_112 , sizeof( struct V_113 ) ) ;
V_2 -> V_111 . V_26 = V_2 ;
return & V_2 -> V_111 ;
error:
F_26 ( V_2 ) ;
