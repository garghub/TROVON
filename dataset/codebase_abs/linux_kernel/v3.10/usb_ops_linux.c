...
F_26 ( V_36 , V_51 ) ;
if ( ( V_51 -> V_58 == false ) || ( V_51 -> V_61 == NULL ) ) {
V_51 -> V_61 = F_27 ( V_36 -> V_70 ,
V_56 + V_77 ) ;
if ( V_51 -> V_61 == NULL )
return V_5 ;
V_73 = ( V_78 ) V_51 -> V_61 -> V_79 ;
V_74 = V_73 & ( V_77 - 1 ) ;
F_28 ( V_51 -> V_61 ,
( V_77 - V_74 ) ) ;
V_51 -> V_80 = V_51 -> V_61 -> V_81 ;
V_51 -> V_82 = V_51 -> V_61 -> V_79 ;
V_51 -> V_83 = F_29 ( V_51 -> V_61 ) ;
V_51 -> V_84 = F_30 ( V_51 -> V_61 ) ;
V_51 -> V_49 = V_51 -> V_61 -> V_79 ;
} else {
V_51 -> V_80 = V_51 -> V_61 -> V_81 ;
V_51 -> V_82 = V_51 -> V_61 -> V_79 ;
V_51 -> V_83 = F_29 ( V_51 -> V_61 ) ;
...
{
int V_75 = false ;
struct V_34 * V_35 = (struct V_34 * ) V_89 ;
...
struct V_26 * V_27 = NULL ;
struct V_34 * V_35 = (struct V_34 * ) V_41 -> V_36 ;
struct V_8 * V_9 = (struct V_8 * ) & V_35 -> V_111 ;
struct V_90 * V_91 = & V_35 -> V_92 ;
...
T_3 * V_130 , * V_131 ;
V_130 = F_43 ( ( T_2 ) V_125 + 16 ) ;
if ( V_130 == NULL ) {
F_44 ( & V_129 -> V_132 , L_4 ,
V_133 ) ;
return - 1 ;
}
...
V_37 = F_47 ( V_129 , V_11 , V_122 , V_127 , V_123 , V_124 ,
V_131 , V_125 , V_136 / 2 ) ;
if ( V_37 > 0 ) {
if ( V_126 == 0x01 ) {
