...
if ( sscanf ( V_120 [ 3 ] , L_19 , & V_121 , & V_124 ) != 1 ||
! V_121 || ( V_121 & ( V_121 - 1 ) ) ||
...
V_3 -> V_48 = F_73 ( V_121 ) - 1 ;
if ( sscanf ( V_120 [ 4 ] , L_19 , & V_121 , & V_124 ) != 1 ||
! V_121 || ( V_121 & ( V_121 - 1 ) ) ||
...
V_3 -> V_25 = F_73 ( V_121 ) - 1 ;
if ( sscanf ( V_120 [ 5 ] , L_22 , & V_122 , & V_124 ) != 1 ||
...
if ( sscanf ( V_120 [ 6 ] , L_22 , & V_122 , & V_124 ) != 1 ||
...
T_2 V_136 ;
V_3 -> V_23 [ V_41 ] = V_123 ;
V_136 = F_8 ( V_3 , V_3 -> V_88 , V_41 ) ;
V_136 = ( V_136 >> V_3 -> V_18 ) +
! ! ( V_136 & ( ( 1 << V_3 -> V_18 ) - 1 ) ) ;
...
V_3 -> V_69 = F_84 ( L_38 , V_139 | V_140 | V_141 , F_85 () ) ;
if ( ! V_3 -> V_69 ) {
V_15 -> error = L_39 ;
V_28 = - V_126 ;
goto V_130;
