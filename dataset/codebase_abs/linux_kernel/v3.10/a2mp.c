...
if ( ! V_31 )
return - V_40 ;
V_83 = F_45 ( V_31 , V_10 , V_45 -> V_26 , true ) ;
if ( ! V_83 )
goto V_69;
...
static int F_47 ( struct V_9 * V_10 , struct V_35 * V_36 ,
struct V_1 * V_37 )
{
...
V_83 = F_45 ( V_31 , V_10 , V_43 -> V_93 , false ) ;
if ( V_83 ) {
F_49 ( V_31 , V_10 , V_83 ) ;
V_45 . V_27 = V_97 ;
} else {
...
static int F_50 ( struct V_9 * V_10 , struct V_35 * V_36 ,
struct V_1 * V_37 )
{
struct V_91 * V_43 = ( void * ) V_36 -> V_5 ;
struct V_92 V_45 ;
...
V_83 = F_51 ( V_31 , V_100 , V_10 -> V_58 -> V_101 ) ;
if ( ! V_83 ) {
F_52 ( L_13 ) ;
V_45 . V_27 = V_102 ;
goto V_103;
...
static inline int F_53 ( struct V_9 * V_10 , struct V_35 * V_36 ,
struct V_1 * V_37 )
{
...
static int F_54 ( struct V_11 * V_12 , struct V_35 * V_36 )
{
struct V_1 * V_37 ;
...
break;
case V_109 :
V_105 = F_47 ( V_10 , V_36 , V_37 ) ;
break;
case V_110 :
V_105 = F_50 ( V_10 , V_36 , V_37 ) ;
break;
case V_53 :
...
static void F_59 ( struct V_11 * V_12 , int V_61 )
{
struct V_9 * V_10 = V_12 -> V_5 ;
if ( ! V_10 )
return;
...
static struct V_35 * F_60 ( struct V_11 * V_12 ,
unsigned long V_4 , int V_113 )
{
return F_61 ( V_4 , V_8 ) ;
}
static struct V_11 * F_62 ( struct V_58 * V_59 , bool V_114 )
{
struct V_11 * V_12 ;
int V_105 ;
V_12 = F_63 () ;
...
struct V_9 * F_55 ( struct V_9 * V_10 )
{
F_13 ( L_19 , V_10 , F_70 ( & V_10 -> V_135 . V_136 ) ) ;
F_71 ( & V_10 -> V_135 ) ;
return V_10 ;
}
static void F_72 ( struct V_135 * V_135 )
{
struct V_9 * V_10 = F_73 ( V_135 , struct V_9 , V_135 ) ;
F_13 ( L_20 , V_10 ) ;
F_23 ( & V_137 ) ;
F_74 ( & V_10 -> V_138 ) ;
F_28 ( & V_137 ) ;
...
{
F_13 ( L_19 , V_10 , F_70 ( & V_10 -> V_135 . V_136 ) ) ;
return F_76 ( & V_10 -> V_135 , & F_72 ) ;
}
static struct V_9 * F_77 ( struct V_58 * V_59 , bool V_114 )
{
struct V_9 * V_10 ;
struct V_11 * V_12 ;
...
F_80 ( & V_10 -> V_140 ) ;
F_23 ( & V_137 ) ;
F_81 ( & V_10 -> V_138 , & V_141 ) ;
F_28 ( & V_137 ) ;
return V_10 ;
}
struct V_11 * F_82 ( struct V_58 * V_59 ,
struct V_35 * V_36 )
{
struct V_9 * V_10 ;
V_10 = F_77 ( V_59 , false ) ;
if ( ! V_10 ) {
F_52 ( L_22 ) ;
return NULL ;
}
...
if ( V_31 -> V_33 != V_78 ) {
V_45 . V_27 = 0 ;
V_45 . V_143 = F_85 ( V_31 -> V_144 ) ;
V_45 . V_145 = F_85 ( V_31 -> V_146 ) ;
V_45 . V_147 = F_85 ( V_31 -> V_148 ) ;
...
void F_88 ( struct V_30 * V_31 , T_1 V_27 )
{
struct V_9 * V_10 ;
struct V_92 V_45 ;
struct V_82 * V_155 ;
