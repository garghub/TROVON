...
static struct V_25 * F_112 ( struct V_49 * V_50 )
{
...
static struct V_25 * F_113 ( struct V_25 * V_12 )
{
...
static struct V_25 * F_114 ( struct V_49 * V_50 , int V_186 )
{
struct V_25 * V_12 = F_112 ( V_50 ) ;
while ( V_12 && V_186 -- > 0 )
V_12 = F_113 ( V_12 ) ;
return V_12 ;
}
int F_115 ( struct V_86 * V_87 )
{
struct V_49 * V_50 = (struct V_49 * ) V_87 -> V_90 ;
struct V_25 * V_12 , * V_187 = NULL ;
int V_165 = 0 ;
for ( V_12 = F_112 ( V_50 ) ; V_12 ; V_12 = F_113 ( V_12 ) ) {
V_165 += F_108 ( V_12 ) ;
...
void F_116 ( struct V_86 * V_87 )
{
F_35 ( V_87 ) ;
}
static int F_117 ( T_1 V_40 , int V_36 , struct V_76 * V_188 ,
struct V_86 * V_87 ,
...
if ( F_118 ( V_190 , F_119 ( V_192 -> V_190 ) . V_195 ,
V_192 -> V_196 -> V_197 ,
V_123 ,
V_87 -> V_101 ,
V_22 -> V_113 ,
...
static int F_120 ( struct V_25 * V_12 , struct V_86 * V_87 ,
struct V_189 * V_190 , struct V_191 * V_192 )
{
struct V_27 * V_37 ;
int V_8 , V_193 ;
...
if ( F_104 ( & V_37 -> V_39 ) )
continue;
if ( F_117 ( V_12 -> V_40 , V_37 -> V_36 , & V_37 -> V_39 , V_87 , V_190 , V_192 ) < 0 ) {
V_192 -> args [ 4 ] = V_8 ;
return - 1 ;
}
V_8 ++ ;
...
int F_121 ( struct V_86 * V_87 , struct V_189 * V_190 ,
struct V_191 * V_192 )
{
struct V_25 * V_12 ;
struct V_49 * V_50 = (struct V_49 * ) V_87 -> V_90 ;
...
V_12 = F_73 ( V_50 , V_40 ) ;
if ( ! V_12 )
V_12 = F_114 ( V_50 , V_200 ) ;
}
while ( V_12 ) {
V_192 -> args [ 2 ] = V_12 -> V_40 ;
if ( F_120 ( V_12 , V_87 , V_190 , V_192 ) < 0 ) {
V_192 -> args [ 3 ] = V_200 ;
F_98 () ;
return - 1 ;
}
...
0 , V_201 , NULL ) ;
V_26 = F_123 ( L_11 ,
F_124 ( sizeof( struct V_25 ) ,
sizeof( struct V_27 ) ) ,
0 , V_201 , NULL ) ;
}
struct V_86 * F_125 ( T_3 V_202 )
{
struct V_86 * V_87 ;
struct V_49 * V_50 ;
...
static struct V_2 * F_127 ( struct V_204 * V_205 ,
struct V_49 * V_50 )
{
struct V_2 * V_45 ;
if ( ! V_50 )
...
static void F_128 ( struct V_49 * V_50 , struct V_208 * V_209 )
{
struct V_2 * V_45 ;
struct V_204 V_205 ;
memset ( V_209 , 0 , sizeof( * V_209 ) ) ;
F_95 () ;
for ( V_45 = F_127 ( & V_205 , V_50 ) ; V_45 ; V_45 = F_126 ( & V_205 ) ) {
if ( F_38 ( V_45 ) ) {
...
static void F_129 ( struct V_218 * V_219 , struct V_208 * V_220 )
{
unsigned int V_8 , F_124 , V_221 , V_222 , V_223 ;
if ( V_220 -> V_210 )
...
F_130 ( V_219 , L_13 ,
V_223 / 100 , V_223 % 100 ) ;
F_130 ( V_219 , L_14 , V_220 -> V_212 ) ;
F_130 ( V_219 , L_15 , V_220 -> V_210 ) ;
V_222 = sizeof( struct V_25 ) * V_220 -> V_210 ;
F_130 ( V_219 , L_16 , V_220 -> V_213 ) ;
V_222 += sizeof( struct V_27 ) * V_220 -> V_213 ;
F_130 ( V_219 , L_17 , V_220 -> V_214 ) ;
V_222 += sizeof( struct V_1 ) * V_220 -> V_214 ;
F_124 = V_215 ;
while ( F_124 > 0 && V_220 -> V_216 [ F_124 - 1 ] == 0 )
F_124 -- ;
V_221 = 0 ;
for ( V_8 = 1 ; V_8 <= F_124 ; V_8 ++ )
if ( V_220 -> V_216 [ V_8 ] != 0 ) {
F_130 ( V_219 , L_18 , V_8 , V_220 -> V_216 [ V_8 ] ) ;
V_221 += ( 1 << V_8 ) * V_220 -> V_216 [ V_8 ] ;
}
F_131 ( V_219 , '\n' ) ;
F_130 ( V_219 , L_19 , V_221 ) ;
V_222 += sizeof( struct V_2 * ) * V_221 ;
F_130 ( V_219 , L_20 , V_220 -> V_217 ) ;
F_130 ( V_219 , L_21 , ( V_222 + 1023 ) / 1024 ) ;
}
static void F_132 ( struct V_218 * V_219 ,
const struct V_224 * V_61 )
{
F_130 ( V_219 , L_22 ) ;
F_130 ( V_219 , L_23 , V_61 -> gets ) ;
F_130 ( V_219 , L_24 , V_61 -> V_169 ) ;
F_130 ( V_219 , L_25 ,
V_61 -> V_142 ) ;
F_130 ( V_219 , L_26 ,
V_61 -> V_156 ) ;
F_130 ( V_219 , L_27 , V_61 -> V_166 ) ;
F_130 ( V_219 , L_28 ,
V_61 -> V_62 ) ;
}
static void F_133 ( struct V_218 * V_219 , struct V_86 * V_87 )
{
if ( V_87 -> V_101 == V_225 )
F_134 ( V_219 , L_29 ) ;
...
F_130 ( V_219 , L_31 , V_87 -> V_101 ) ;
}
static int F_135 ( struct V_218 * V_219 , void * V_227 )
{
...
F_129 ( V_219 , & V_220 ) ;
#ifdef F_59
F_132 ( V_219 , & V_50 -> V_61 ) ;
#endif
}
}
return 0 ;
}
static int F_136 ( struct V_67 * V_67 , struct V_234 * V_234 )
{
return F_137 ( V_67 , V_234 , F_135 ) ;
}
static struct V_2 * F_138 ( struct V_218 * V_219 , T_7 V_18 )
{
struct V_204 * V_205 = V_219 -> V_229 ;
struct V_228 * V_228 = F_139 ( V_219 ) ;
T_7 V_185 = 0 ;
unsigned int V_230 ;
for ( V_230 = 0 ; V_230 < V_231 ; V_230 ++ ) {
struct V_75 * V_20 = & V_228 -> V_232 . V_233 [ V_230 ] ;
...
F_65 (tb, head, tb_hlist) {
struct V_2 * V_45 ;
for ( V_45 = F_127 ( V_205 ,
(struct V_49 * ) V_87 -> V_90 ) ;
V_45 ; V_45 = F_126 ( V_205 ) )
if ( V_18 == V_185 ++ ) {
V_205 -> V_87 = V_87 ;
return V_45 ;
}
...
static void * F_140 ( struct V_218 * V_219 , T_7 * V_18 )
__acquires( T_8 )
{
F_95 () ;
return F_138 ( V_219 , * V_18 ) ;
}
static void * F_141 ( struct V_218 * V_219 , void * V_227 , T_7 * V_18 )
{
struct V_204 * V_205 = V_219 -> V_229 ;
struct V_228 * V_228 = F_139 ( V_219 ) ;
...
while ( ( V_235 = F_96 ( F_142 ( & V_87 -> V_236 ) ) ) ) {
V_87 = F_143 ( V_235 , struct V_86 , V_236 ) ;
V_45 = F_127 ( V_205 , (struct V_49 * ) V_87 -> V_90 ) ;
if ( V_45 )
goto V_165;
}
while ( ++ V_230 < V_231 ) {
...
static void F_144 ( struct V_218 * V_219 , void * V_227 )
__releases( T_8 )
{
F_98 () ;
}
static void F_145 ( struct V_218 * V_219 , int V_45 )
{
while ( V_45 -- > 0 )
F_134 ( V_219 , L_34 ) ;
}
static inline const char * F_146 ( char * V_237 , T_2 V_199 , enum V_238 V_209 )
{
switch ( V_209 ) {
...
static inline const char * F_147 ( char * V_237 , T_2 V_199 , unsigned int V_50 )
{
...
F_145 ( V_219 , V_205 -> V_206 ) ;
F_130 ( V_219 , L_43 , & V_246 ) ;
F_65 (li, &l->list, hlist) {
struct V_21 * V_22 ;
F_91 (fa, &li->falh, fa_list) {
char V_247 [ 32 ] , V_248 [ 32 ] ;
F_145 ( V_219 , V_205 -> V_206 + 1 ) ;
F_130 ( V_219 , L_44 , V_37 -> V_36 ,
F_146 ( V_247 , sizeof( V_247 ) ,
V_22 -> V_104 -> V_139 ) ,
F_147 ( V_248 , sizeof( V_248 ) ,
V_22 -> V_113 ) ) ;
if ( V_22 -> V_103 )
F_130 ( V_219 , L_45 , V_22 -> V_103 ) ;
F_131 ( V_219 , '\n' ) ;
}
}
}
...
static int F_149 ( struct V_67 * V_67 , struct V_234 * V_234 )
{
return F_150 ( V_67 , V_234 , & V_249 ,
sizeof( struct V_204 ) ) ;
}
static struct V_25 * F_151 ( struct V_250 * V_205 , T_7 V_18 )
{
...
static void * F_152 ( struct V_218 * V_219 , T_7 * V_18 )
__acquires( T_8 )
{
struct V_250 * V_205 = V_219 -> V_229 ;
struct V_86 * V_87 ;
F_95 () ;
V_87 = F_153 ( F_139 ( V_219 ) , V_226 ) ;
if ( ! V_87 )
return NULL ;
...
return F_151 ( V_205 , * V_18 - 1 ) ;
}
static void * F_154 ( struct V_218 * V_219 , void * V_227 , T_7 * V_18 )
{
struct V_250 * V_205 = V_219 -> V_229 ;
...
static void F_155 ( struct V_218 * V_219 , void * V_227 )
__releases( T_8 )
{
F_98 () ;
}
static unsigned int F_156 ( int type , T_5 V_97 , const struct V_92 * V_93 )
{
...
static int F_157 ( struct V_218 * V_219 , void * V_227 )
{
struct V_25 * V_12 = V_227 ;
struct V_27 * V_37 ;
if ( V_227 == V_252 ) {
F_130 ( V_219 , L_46 , L_47
L_48
L_49 ) ;
return 0 ;
}
...
unsigned int V_253 = F_156 ( V_22 -> V_113 , V_97 , V_93 ) ;
int V_199 ;
if ( V_22 -> V_113 == V_262
|| V_22 -> V_113 == V_263 )
continue;
...
V_261 , 0 , V_253 , 0 , 0 , 0 ,
V_97 , 0 , 0 , 0 , & V_199 ) ;
F_130 ( V_219 , L_54 , 127 - V_199 , L_55 ) ;
}
}
return 0 ;
}
static int F_158 ( struct V_67 * V_67 , struct V_234 * V_234 )
{
return F_150 ( V_67 , V_234 , & V_269 ,
sizeof( struct V_250 ) ) ;
}
int T_9 F_159 ( struct V_228 * V_228 )
{
if ( ! F_160 ( L_56 , V_270 , V_228 -> V_271 , & V_272 ) )
goto V_273;
if ( ! F_160 ( L_57 , V_270 , V_228 -> V_271 ,
& V_274 ) )
goto V_275;
if ( ! F_160 ( L_58 , V_270 , V_228 -> V_271 , & V_276 ) )
goto V_277;
return 0 ;
V_277:
F_161 ( L_57 , V_228 -> V_271 ) ;
V_275:
F_161 ( L_56 , V_228 -> V_271 ) ;
V_273:
return - V_66 ;
}
void T_10 F_162 ( struct V_228 * V_228 )
{
F_161 ( L_56 , V_228 -> V_271 ) ;
F_161 ( L_57 , V_228 -> V_271 ) ;
F_161 ( L_58 , V_228 -> V_271 ) ;
}
