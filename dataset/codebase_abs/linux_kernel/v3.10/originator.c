...
int F_59 ( struct V_95 * V_96 , void * V_97 )
{
...
V_111 = F_66 ( V_112 , V_29 ) ;
if ( ! V_111 )
return - V_17 ;
memcpy ( V_111 , V_22 -> V_42 , V_113 ) ;
F_34 ( V_22 -> V_42 ) ;
V_22 -> V_42 = V_111 ;
V_111 = F_66 ( V_110 * sizeof( T_1 ) , V_29 ) ;
if ( ! V_111 )
return - V_17 ;
