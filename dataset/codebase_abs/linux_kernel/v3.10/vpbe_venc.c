...
struct V_109 * V_110 ;
int V_85 ;
V_5 = F_34 ( sizeof( struct V_1 ) , V_111 ) ;
if ( V_5 == NULL )
return - V_112 ;
V_108 = F_35 ( V_99 ) ;
if ( ! V_108 ) {
...
if ( ! F_38 ( V_110 -> V_119 , F_39 ( V_110 ) , L_21 ) ) {
F_36 ( V_5 -> V_99 , L_22 ) ;
V_85 = - V_118 ;
goto V_113;
}
V_5 -> V_6 = F_40 ( V_110 -> V_119 , F_39 ( V_110 ) ) ;
if ( ! V_5 -> V_6 ) {
F_36 ( V_5 -> V_99 , L_23 ) ;
V_85 = - V_118 ;
goto V_120;
