...
static int F_259 ( struct V_10 * V_223 )
{
...
if ( strncmp ( V_412 . V_418 , L_86 , strlen ( L_86 ) ) ) {
F_65 (KERN_ERR PFX L_87 ) ;
V_32 = - V_82 ;
goto V_358;
}
} else {
...
static int F_266 ( struct V_1 * V_7 , enum V_339 V_340 )
{
return F_260 ( V_7 , V_340 , V_424 ) ;
}
static int F_267 ( struct V_1 * V_7 )
{
return F_260 ( V_7 , V_413 ,
V_425 ) ;
}
static struct V_36 * F_268 ( struct V_312 * V_313 )
{
struct V_36 * V_37 ;
...
static struct V_36 * F_263 ( struct V_1
* V_202 )
{
struct V_36 * V_37 ;
F_128 (hba, &adapter_list, list) {
...
static void F_269 ( struct V_312 * V_99 )
{
struct V_36 * V_37 ;
struct V_4 * V_35 , * V_150 ;
F_19 ( L_96 ) ;
...
static int F_270 ( struct V_155 * V_156 )
{
struct V_2 * V_3 = F_100 ( V_156 ) ;
F_271 ( V_3 ) ;
return 0 ;
}
static bool F_272 ( struct V_1 * V_7 )
{
struct V_1 * V_202 = V_7 ;
F_20 ( & V_234 ) ;
if ( V_7 -> V_415 & V_416 )
...
static void F_273 ( unsigned int V_427 )
{
struct V_146 * V_147 ;
struct V_428 * V_128 ;
V_147 = & F_274 ( V_429 , V_427 ) ;
V_128 = F_275 ( F_91 ,
( void * ) V_147 , F_276 ( V_427 ) ,
L_99 , V_427 ) ;
if ( F_277 ( ! F_164 ( V_128 ) ) ) {
F_278 ( V_128 , V_427 ) ;
V_147 -> V_430 = V_128 ;
F_70 ( V_128 ) ;
}
}
static void F_279 ( unsigned int V_427 )
{
struct V_146 * V_147 ;
struct V_428 * V_128 ;
struct V_148 * V_149 , * V_150 ;
...
static int F_281 ( struct V_431 * V_432 ,
...
case V_435 :
case V_436 :
F_65 ( V_381 L_101 , V_427 ) ;
F_273 ( V_427 ) ;
break;
case V_437 :
case V_438 :
F_65 ( V_381 L_102 , V_427 ) ;
F_279 ( V_427 ) ;
break;
default:
break;
...
struct V_146 * V_147 ;
F_65 (KERN_INFO PFX L_103 , version) ;
V_32 = F_283 ( & V_441 ) ;
if ( V_32 ) {
F_65 ( V_229 L_104
L_105 ) ;
