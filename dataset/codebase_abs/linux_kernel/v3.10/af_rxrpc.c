...
case V_102 :
V_40 = - V_17 ;
if ( V_94 != sizeof( unsigned int ) )
goto error;
V_40 = - V_80 ;
if ( V_13 -> V_2 . V_41 != V_42 )
goto error;
V_40 = F_55 ( V_95 ,
( unsigned int T_4 * ) V_93 ) ;
if ( V_40 < 0 )
goto error;
V_40 = - V_17 ;
if ( V_95 > V_103 )
...
{
int V_40 = - 1 ;
F_85 ( sizeof( struct V_145 ) > F_86 ( struct V_146 , V_147 ) ) ;
V_148 = F_87 ( F_88 () ) ;
V_40 = - V_123 ;
V_149 = F_89 (
...
#ifdef F_94
F_95 ( L_28 , 0 , V_114 . V_162 , & V_163 ) ;
F_95 ( L_29 , 0 , V_114 . V_162 ,
& V_164 ) ;
#endif
return 0 ;
V_161:
...
F_13 ( L_30 ) ;
F_78 ( V_142 ) ;
F_107 ( L_29 , V_114 . V_162 ) ;
F_107 ( L_28 , V_114 . V_162 ) ;
F_99 ( V_142 ) ;
F_100 ( V_149 ) ;
F_27 ( L_11 ) ;
}
