...
goto V_151;
if ( V_195 ) {
V_17 = F_94 ( V_32 , & V_32 -> V_187 . V_202 ,
V_195 ) ;
if ( F_9 ( V_17 != 0 ) )
goto V_151;
}
...
{
F_11 ( L_31 ) ;
( void ) F_82 ( V_32 , false , true , 0 , false , 10 * V_203 ) ;
F_45 ( V_32 -> V_95 , false ) ;
...
struct V_172 * V_207 = NULL ;
if ( V_32 -> V_95 == NULL )
goto V_198;
F_91 ( & V_204 ) ;
V_205 . V_37 = F_26 ( V_32 -> V_95 ) ;
F_14 ( & V_205 . V_23 , & V_204 ) ;
V_206 . V_37 = F_26 ( V_32 -> V_93 ) ;
F_14 ( & V_206 . V_23 , & V_204 ) ;
do {
V_17 = F_93 ( & V_204 ) ;
} while ( V_17 == - V_54 );
if ( F_9 ( V_17 != 0 ) ) {
...
V_32 -> V_96 = false ;
if ( V_183 == NULL ) {
( void ) F_78 ( NULL , V_32 , & V_207 ,
NULL ) ;
V_183 = V_207 ;
}
F_97 ( & V_204 , ( void * ) V_183 ) ;
if ( V_207 != NULL )
F_99 ( & V_207 ) ;
F_46 ( & V_206 . V_37 ) ;
F_46 ( & V_205 . V_37 ) ;
...
int F_106 ( struct V_210 * V_211 , void * V_212 ,
struct V_170 * V_171 )
{
struct V_31 * V_32 = F_107 ( V_211 ) ;
struct V_213 * V_214 = (struct V_213 * ) V_212 ;
struct V_215 * V_216 = V_215 ( V_171 -> V_217 ) ;
int V_17 ;
if ( F_9 ( V_214 -> V_218 != V_219 ) ) {
F_11 ( L_32 ) ;
F_11 ( L_33
L_34 ) ;
return - V_35 ;
}
V_17 = F_108 ( & V_216 -> V_220 , true ) ;
if ( F_9 ( V_17 != 0 ) )
return V_17 ;
V_17 = F_88 ( V_171 , V_32 ,
( void T_22 * ) ( unsigned long ) V_214 -> V_221 ,
NULL , V_214 -> V_194 , V_214 -> V_195 ,
( void T_22 * ) ( unsigned long ) V_214 -> V_185 ,
NULL ) ;
if ( F_9 ( V_17 != 0 ) )
goto V_198;
F_109 ( V_32 ) ;
