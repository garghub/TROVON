...
static void
F_123 ( struct V_14 * V_20 , T_2 V_127 ,
struct V_64 * V_130 )
{
T_4 V_131 ;
struct V_61 * V_62 ;
...
static T_1 int F_177 ( struct V_18 * V_19 ,
struct V_1 * V_2 , int V_35 )
{
int V_80 ;
int V_95 ;
...
if ( V_204 ) {
V_20 = F_135 ( V_19 , V_204 , V_142 , 0 ) ;
F_12 ( V_20 ) ;
}
if ( V_205 ) {
V_20 = F_135 ( V_19 , V_205 , V_142 , 0 ) ;
F_12 ( V_20 ) ;
}
}
return V_34 ;
...
if ( V_210 < V_6 && V_6 >= V_207 )
V_211 = 1 ;
V_212 = V_2 -> V_8 [ V_6 ] ;
if ( V_6 >= V_207 && V_6 > V_210 && V_2 -> V_9 [ V_6 ] ) {
F_11 ( V_212 , V_2 -> V_9 [ V_6 ] ) ;
V_2 -> V_9 [ V_6 ] = 0 ;
if ( V_209 &&
V_6 > V_208 &&
V_6 <= * V_209 ) {
...
struct V_14 * * V_214 , int V_35 , int V_80 ,
...
struct V_14 * V_173 ;
int V_34 ;
V_146 = F_83 ( V_215 , V_80 ) ;
V_156 = F_84 ( V_215 , V_80 ) ;
V_142 = F_134 ( V_19 , V_35 - 1 ) ;
V_173 = F_150 ( V_19 , V_146 , V_142 ) ;
if ( V_173 ) {
if ( F_151 ( V_173 , 0 , 1 ) > 0 ) {
...
F_12 ( V_173 ) ;
F_3 ( V_5 ) ;
V_173 = F_135 ( V_19 , V_146 , V_142 , V_156 ) ;
if ( V_173 && F_151 ( V_173 , V_156 , 0 ) > 0 ) {
* V_214 = V_173 ;
return 0 ;
}
F_12 ( V_173 ) ;
...
{
int V_34 ;
if ( ( V_5 -> V_217 || V_216 > 0 ) && F_90 ( V_215 ) >=
F_132 ( V_19 ) - 3 ) {
int V_218 ;
if ( * V_209 < V_35 + 1 ) {
* V_209 = V_35 + 1 ;
...
if ( ! V_33 )
F_179 ( V_5 , V_35 + 1 ) ;
V_34 = F_160 ( V_215 , V_85 , V_35 , & V_80 ) ;
if ( V_35 != 0 ) {
int V_226 = 0 ;
if ( V_34 && V_80 > 0 ) {
V_226 = 1 ;
...
V_5 -> V_17 [ V_35 ] = V_80 ;
V_160 = F_181 ( V_29 , V_19 , V_5 , V_215 , V_35 ,
V_216 , & V_209 ) ;
if ( V_160 == - V_206 )
goto V_219;
if ( V_160 ) {
...
V_5 -> V_17 [ V_35 ] = V_80 ;
F_178 ( V_5 , V_35 , V_207 , 0 , NULL ) ;
if ( V_35 == V_222 ) {
if ( V_226 )
V_5 -> V_17 [ V_35 ] ++ ;
goto V_220;
}
V_160 = F_180 ( NULL , V_19 , V_5 , & V_215 , V_35 ,
V_80 , V_85 , V_127 ) ;
if ( V_160 == - V_206 )
goto V_219;
if ( V_160 ) {
...
V_215 = F_128 ( V_19 -> V_23 , V_215 , V_127 ) ;
V_5 -> V_9 [ V_35 ] = V_10 ;
V_5 -> V_8 [ V_35 ] = V_215 ;
} else {
V_5 -> V_17 [ V_35 ] = V_80 ;
...
break;
V_212 = V_2 -> V_8 [ V_6 ] ;
F_97 ( V_19 -> V_23 , V_212 , V_230 , 1 ) ;
F_124 ( V_212 , V_85 , V_230 ) ;
F_49 ( V_2 -> V_8 [ V_6 ] ) ;
if ( V_230 != 0 )
break;
}
...
struct V_18 * V_19 ,
struct V_1 * V_2 , int V_35 , int V_99 )
{
T_2 V_237 ;
struct V_14 * V_238 ;
struct V_14 * V_239 ;
...
if ( V_239 == V_19 -> V_21 ) {
V_34 = F_196 ( V_29 , V_19 , V_2 , V_35 + 1 , 0 ) ;
if ( V_34 )
return V_34 ;
} else {
