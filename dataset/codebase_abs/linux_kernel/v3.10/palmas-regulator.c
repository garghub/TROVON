...
static void F_27 ( struct V_71 * V_11 ,
struct V_72 * V_73 ,
struct V_74 * V_75 )
{
struct V_72 * V_76 ;
...
! V_79 [ V_78 ] . V_82 )
continue;
V_75 -> V_83 [ V_78 ] = V_79 [ V_78 ] . V_81 ;
V_75 -> V_50 [ V_78 ] = F_33 ( V_11 ,
sizeof( struct V_49 ) , V_84 ) ;
V_75 -> V_50 [ V_78 ] -> V_55 =
F_34 ( V_79 [ V_78 ] . V_82 ,
L_10 ) ;
V_75 -> V_50 [ V_78 ] -> V_57 =
F_34 ( V_79 [ V_78 ] . V_82 ,
L_11 ) ;
V_37 = F_35 ( V_79 [ V_78 ] . V_82 ,
L_12 , & V_77 ) ;
if ( ! V_37 )
V_75 -> V_50 [ V_78 ] -> V_53 = V_77 ;
V_37 = F_34 ( V_79 [ V_78 ] . V_82 ,
L_13 ) ;
if ( V_37 )
V_75 -> V_50 [ V_78 ] -> V_62 =
V_85 ;
...
V_75 -> V_87 = F_34 ( V_73 , L_15 ) ;
}
static int F_36 ( struct V_88 * V_89 )
{
struct V_1 * V_1 = F_37 ( V_89 -> V_11 . V_90 ) ;
struct V_74 * V_75 = V_89 -> V_11 . V_91 ;
struct V_72 * V_73 = V_89 -> V_11 . V_82 ;
struct V_10 * V_34 ;
struct V_92 V_93 = { } ;
struct V_12 * V_13 ;
struct V_49 * V_50 ;
...
if ( V_73 && ! V_75 ) {
V_75 = F_33 ( & V_89 -> V_11 , sizeof( * V_75 ) , V_84 ) ;
if ( ! V_75 )
return - V_94 ;
F_27 ( & V_89 -> V_11 , V_73 , V_75 ) ;
}
V_13 = F_33 ( & V_89 -> V_11 , sizeof( * V_13 ) , V_84 ) ;
if ( ! V_13 )
return - V_94 ;
V_13 -> V_11 = & V_89 -> V_11 ;
V_13 -> V_1 = V_1 ;
...
V_13 -> V_110 [ V_14 ] . V_43 =
V_47 [ V_2 & 0x3 ] ;
V_13 -> V_43 [ V_14 ] = V_13 -> V_110 [ V_14 ] . V_43 ;
}
if ( V_75 && V_75 -> V_50 [ V_14 ] ) {
V_50 = V_75 -> V_50 [ V_14 ] ;
V_37 = F_22 ( V_1 , V_14 , V_50 ) ;
if ( V_37 )
goto V_109;
}
V_13 -> V_110 [ V_14 ] . V_111 = V_15 [ V_14 ] . V_111 ;
V_13 -> V_110 [ V_14 ] . V_14 = V_14 ;
switch ( V_14 ) {
case V_51 :
V_13 -> V_110 [ V_14 ] . V_112 = V_113 ;
V_13 -> V_110 [ V_14 ] . V_114 = & V_115 ;
V_13 -> V_110 [ V_14 ] . V_116 =
F_2 ( V_5 ,
V_117 ) ;
V_13 -> V_110 [ V_14 ] . V_118 = V_119 ;
V_13 -> V_110 [ V_14 ] . V_120 =
F_2 ( V_5 ,
V_117 ) ;
V_13 -> V_110 [ V_14 ] . V_121 = V_122 ;
V_13 -> V_110 [ V_14 ] . V_35 = 3750000 ;
V_13 -> V_110 [ V_14 ] . V_123 = 1250000 ;
break;
default:
V_4 = V_15 [ V_14 ] . V_61 ;
V_37 = F_1 ( V_13 -> V_1 , V_4 , & V_2 ) ;
...
if ( V_2 & V_85 )
V_13 -> V_33 [ V_14 ] = 1 ;
V_13 -> V_110 [ V_14 ] . V_114 = & V_124 ;
V_13 -> V_110 [ V_14 ] . V_112 = V_125 ;
V_13 -> V_110 [ V_14 ] . V_116 =
F_2 ( V_5 ,
V_15 [ V_14 ] . V_61 ) ;
V_13 -> V_110 [ V_14 ] . V_118 =
V_126 ;
V_4 = V_15 [ V_14 ] . V_16 ;
V_37 = F_1 ( V_13 -> V_1 , V_4 , & V_2 ) ;
if ( V_37 )
...
V_13 -> V_110 [ V_14 ] . type = V_127 ;
V_13 -> V_110 [ V_14 ] . V_128 = V_129 ;
if ( V_75 )
V_93 . V_81 = V_75 -> V_83 [ V_14 ] ;
else
V_93 . V_81 = NULL ;
V_13 -> V_110 [ V_14 ] . V_130 = V_15 [ V_14 ] . V_131 ;
V_93 . V_82 = V_79 [ V_14 ] . V_82 ;
V_34 = F_39 ( & V_13 -> V_110 [ V_14 ] , & V_93 ) ;
if ( F_40 ( V_34 ) ) {
F_20 ( & V_89 -> V_11 ,
L_17 ,
V_89 -> V_111 ) ;
...
V_13 -> V_110 [ V_14 ] . V_128 = V_129 ;
if ( V_14 < V_132 ) {
V_13 -> V_110 [ V_14 ] . V_112 = V_133 ;
V_13 -> V_110 [ V_14 ] . V_114 = & V_134 ;
V_13 -> V_110 [ V_14 ] . V_35 = 900000 ;
V_13 -> V_110 [ V_14 ] . V_123 = 50000 ;
V_13 -> V_110 [ V_14 ] . V_135 = 1 ;
V_13 -> V_110 [ V_14 ] . V_116 =
F_2 ( V_9 ,
V_15 [ V_14 ] . V_61 ) ;
V_13 -> V_110 [ V_14 ] . V_118 =
...
F_2 ( V_9 ,
V_15 [ V_14 ] . V_16 ) ;
V_13 -> V_110 [ V_14 ] . V_121 =
V_137 ;
if ( V_75 && ( V_14 == V_68 ) &&
V_75 -> V_86 ) {
F_26 ( V_1 ) ;
V_13 -> V_110 [ V_14 ] . V_35 = 450000 ;
V_13 -> V_110 [ V_14 ] . V_123 = 25000 ;
}
} else {
V_13 -> V_110 [ V_14 ] . V_112 = 1 ;
V_13 -> V_110 [ V_14 ] . V_114 = & V_138 ;
V_13 -> V_110 [ V_14 ] . V_120 =
F_2 ( V_67 ,
V_15 [ V_14 ] . V_16 ) ;
V_13 -> V_110 [ V_14 ] . V_121 =
