...
if ( F_8 ( V_7 , V_1 -> V_5 , F_13 ( V_1 ) , V_19 ) )
V_29 = 1 ;
if ( F_4 ( V_7 , V_18 ) ) {
...
if ( F_8 ( V_7 , V_1 -> V_5 , F_13 ( V_1 ) , V_21 ) )
V_29 = 1 ;
if ( F_4 ( V_7 , V_33 ) )
V_29 = 1 ;
if ( F_4 ( V_7 , V_20 ) ) {
...
if ( V_29 ) {
struct V_1 * V_2 = F_14 ( V_1 , V_34 , V_27 ) ;
...
static void F_16 ( struct V_39 * V_40 , struct V_27 * V_27 )
{
struct V_6 * V_7 = V_27 -> V_28 ;
int V_25 ;
...
static T_1 F_19 ( struct V_27 * V_27 , T_1 V_50 , int V_51 )
{
F_20 ( V_51 ,
L_8 , V_52 ) ;
if ( V_50 == 0 )
...
F_24 (rdev, mddev) {
V_7 -> V_36 = V_36 ;
F_25 ( V_27 -> V_57 , V_36 -> V_37 ,
V_36 -> V_58 << 9 ) ;
}
F_26 ( V_27 , F_19 ( V_27 , 0 , 0 ) ) ;
V_27 -> V_28 = V_7 ;
F_18 ( V_27 ) ;
return 0 ;
}
static int F_27 ( struct V_27 * V_27 )
{
struct V_6 * V_7 = V_27 -> V_28 ;
F_28 ( V_7 ) ;
V_27 -> V_28 = NULL ;
