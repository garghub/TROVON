...
static T_4 F_25 ( int V_61 , void * V_62 )
{
struct V_3 * V_4 = V_62 ;
T_1 V_63 ;
...
T_1 V_61 , T_5 V_70 , int V_71 , int V_72 , int V_44 )
{
struct V_66 * V_31 ;
struct V_3 * V_4 ;
int V_73 ;
...
goto V_86;
F_15 ( V_4 ) ;
V_73 = F_35 ( V_4 -> V_61 , F_25 , 0 , V_81 , V_4 ) ;
if ( V_73 )
goto V_86;
V_73 = F_36 ( & V_4 -> V_75 ) ;
if ( V_73 ) {
...
F_37 ( V_45 , L_4 ,
( unsigned long long ) V_69 -> V_80 , V_4 -> V_7 , V_4 -> V_61 ) ;
return V_31 ;
V_87:
V_87 ( V_4 -> V_61 , V_4 ) ;
V_86:
...
static int F_43 ( struct V_88 * V_45 )
{
struct V_89 * V_90 ;
struct V_68 * V_91 ;
int V_61 , V_71 = 0 , V_72 = 0 , V_44 = 8 ;
struct V_66 * V_31 ;
T_3 V_92 ;
V_90 = V_45 -> V_45 . V_93 ;
if ( V_90 ) {
...
if ( V_61 < 0 )
return - V_97 ;
V_31 = F_27 ( & V_45 -> V_45 , V_91 , V_61 , V_45 -> V_98 , V_71 ,
V_72 , V_44 ) ;
if ( ! V_31 )
return - V_96 ;
if ( V_90 ) {
