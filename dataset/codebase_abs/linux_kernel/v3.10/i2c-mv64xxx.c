...
static int
F_14 ( struct V_1 * V_2 , struct V_74 * V_23 ,
int V_81 , int V_82 )
{
unsigned long V_24 ;
F_9 ( & V_2 -> V_70 , V_24 ) ;
F_11 ( V_2 , V_23 ) ;
if ( F_15 ( V_23 -> V_24 & V_83 ) ) {
...
static T_1
F_16 ( struct V_85 * V_86 )
{
return V_87 | V_88 | V_89 ;
}
static int
F_17 ( struct V_85 * V_86 , struct V_74 V_90 [] , int V_91 )
{
struct V_1 * V_2 = F_18 ( V_86 ) ;
int V_92 , V_51 ;
for ( V_92 = 0 ; V_92 < V_91 ; V_92 ++ ) {
V_51 = F_14 ( V_2 , & V_90 [ V_92 ] ,
V_92 == 0 , V_92 + 1 == V_91 ) ;
if ( V_51 < 0 )
return V_51 ;
}
...
static int
F_19 ( struct V_93 * V_94 ,
struct V_1 * V_2 )
{
int V_95 ;
struct V_96 * V_97 = F_20 ( V_94 , V_98 , 0 ) ;
if ( ! V_97 )
return - V_52 ;
V_95 = F_21 ( V_97 ) ;
if ( ! F_22 ( V_97 -> V_99 , V_95 , V_2 -> V_53 . V_100 ) )
return - V_101 ;
V_2 -> V_3 = F_23 ( V_97 -> V_99 , V_95 ) ;
V_2 -> V_102 = V_97 -> V_99 ;
V_2 -> V_103 = V_95 ;
return 0 ;
}
...
if ( V_2 -> V_3 ) {
F_25 ( V_2 -> V_3 ) ;
F_26 ( V_2 -> V_102 , V_2 -> V_103 ) ;
}
V_2 -> V_3 = NULL ;
V_2 -> V_102 = 0 ;
}
static int
F_27 ( const int V_104 , const int V_105 , const int V_106 )
{
return V_104 / ( 10 * ( V_106 + 1 ) * ( 2 << V_105 ) ) ;
}
static bool
F_28 ( const T_1 V_107 , const T_1 V_104 , T_1 * V_108 ,
T_1 * V_109 )
{
...
V_104 = F_32 ( V_2 -> V_118 ) ;
F_33 ( V_115 , L_6 , & V_116 ) ;
if ( ! F_28 ( V_116 , V_104 ,
& V_2 -> V_6 , & V_2 -> V_5 ) ) {
V_51 = - V_120 ;
goto V_119;
}
V_2 -> V_67 = F_34 ( V_115 , 0 ) ;
V_2 -> V_53 . V_79 = V_121 ;
V_119:
return V_51 ;
#endif
...
return - V_52 ;
V_2 = F_36 ( sizeof( struct V_1 ) , V_126 ) ;
if ( ! V_2 )
return - V_127 ;
if ( F_19 ( V_94 , V_2 ) ) {
V_51 = - V_52 ;
...
F_37 ( V_2 -> V_53 . V_100 , V_129 L_7 ,
sizeof( V_2 -> V_53 . V_100 ) ) ;
F_38 ( & V_2 -> V_60 ) ;
F_39 ( & V_2 -> V_70 ) ;
#if F_30 ( V_117 )
V_2 -> V_118 = F_40 ( & V_94 -> V_54 , NULL ) ;
if ( ! F_31 ( V_2 -> V_118 ) ) {
F_41 ( V_2 -> V_118 ) ;
F_42 ( V_2 -> V_118 ) ;
}
...
V_2 -> V_5 = V_123 -> V_5 ;
V_2 -> V_6 = V_123 -> V_6 ;
V_2 -> V_67 = F_43 ( V_94 , 0 ) ;
V_2 -> V_53 . V_79 = F_44 ( V_123 -> V_79 ) ;
} else if ( V_94 -> V_54 . V_125 ) {
V_51 = F_29 ( V_2 , V_94 -> V_54 . V_125 ) ;
if ( V_51 )
goto V_130;
}
if ( V_2 -> V_67 < 0 ) {
...
static int
F_54 ( struct V_93 * V_54 )
{
struct V_1 * V_2 = F_55 ( V_54 ) ;
F_56 ( & V_2 -> V_53 ) ;
F_50 ( V_2 -> V_67 , V_2 ) ;
F_24 ( V_2 ) ;
#if F_30 ( V_117 )
