...
{
struct V_197 * V_198 = V_183 -> V_199 . V_200 ;
struct V_182 * V_1 ;
struct V_201 * V_202 ;
int V_60 = - V_192 ;
V_202 = F_83 ( sizeof( * V_202 ) , V_203 ) ;
if ( ! V_202 ) {
F_84 ( & V_183 -> V_199 , L_44 ) ;
goto V_204;
}
V_1 = F_85 ( L_45 , V_205 ) ;
if ( ! V_1 ) {
F_84 ( & V_183 -> V_199 , L_46 ) ;
goto V_206;
}
V_1 -> V_199 . V_207 = & V_183 -> V_199 ;
V_1 -> V_199 . V_208 = & V_209 ;
V_1 -> V_199 . V_210 = V_209 ;
V_202 -> V_199 = & V_183 -> V_199 ;
V_202 -> V_1 = V_1 ;
V_198 -> V_211 = & V_212 ;
F_86 ( V_183 , V_202 ) ;
V_60 = F_87 ( V_1 , V_183 -> V_184 ,
V_183 -> V_213 ) ;
if ( V_60 ) {
F_84 ( & V_183 -> V_199 , L_47 ) ;
goto V_214;
}
V_60 = F_88 ( V_1 , V_198 , sizeof( * V_198 ) ) ;
if ( V_60 ) {
F_84 ( & V_183 -> V_199 , L_48 ) ;
goto V_214;
}
V_60 = F_89 ( V_1 ) ;
if ( V_60 ) {
F_84 ( & V_183 -> V_199 , L_49 ) ;
goto V_214;
}
return 0 ;
V_214:
