...
V_238 = F_1 ( V_241 -> type , V_10 -> V_2 , V_212 , V_11 -> V_251 ,
V_11 -> V_252 , & V_239 ) ;
if ( ! V_238 ) {
V_29 = - V_215 ;
goto V_250;
}
V_29 = V_241 -> V_248 ( V_18 , V_11 , V_11 -> V_251 , V_20 , V_238 ) ;
if ( V_29 < 0 ) {
F_53 ( V_238 ) ;
goto V_250;
}
...
F_46 ( & V_175 ) ;
if ( ( V_157 = F_78 ( V_257 , V_186 -> V_176 , 0 ) ) ) {
if ( V_257 -> V_78 )
...
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( F_78 ( V_257 , V_186 -> V_176 , V_257 -> V_78 ) ) {
V_150 = - V_259 ;
goto V_250;
}
V_150 = F_79 ( V_257 , V_186 -> V_176 ) ;
...
V_211 . V_158 = V_186 -> V_21 -> V_178 ( V_186 ) ;
F_46 ( & V_175 ) ;
if ( ( V_157 = F_78 ( V_260 , V_186 -> V_176 , V_260 -> V_78 ) ) ) {
F_81 ( & V_157 -> V_255 ) ;
F_43 ( V_157 ) ;
V_150 = 0 ;
}
...
{
F_87 ( & V_256 ) ;
F_88 ( V_263 , V_264 , F_70 , NULL , NULL ) ;
F_88 ( V_263 , V_79 , F_70 , NULL , NULL ) ;
return 0 ;
}
