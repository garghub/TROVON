...
static void F_36 ( struct V_116 * V_117 , struct V_118 * V_9 )
{
T_1 * V_119 ;
V_119 = F_37 ( sizeof( T_1 ) , V_29 ) ;
if ( ! V_119 ) {
F_3 ( V_82 L_63 ,
V_9 -> V_120 ) ;
return;
...
#ifdef F_38
F_3 ( V_121 L_64 ,
F_7 ( V_119 -> V_2 . V_7 ) >> 10 ) ;
#endif
V_119 -> V_8 . V_10 = F_7 ( V_119 -> V_2 . V_7 ) >> 9 ;
V_119 -> V_8 . V_117 = V_117 ;
V_119 -> V_8 . V_122 = - 1 ;
if ( ! F_39 ( ( void * ) V_119 ) )
return;
}
