...
V_22 = F_54 ( & V_6 -> V_7 . V_8 , & V_66 ) ;
if ( V_22 )
return V_22 ;
V_4 -> V_67 = F_55 ( & V_6 -> V_7 ) ;
if ( F_56 ( V_4 -> V_67 ) ) {
V_22 = F_57 ( V_4 -> V_67 ) ;
goto V_68;
}
...
return 0 ;
V_68:
F_59 ( & V_6 -> V_7 . V_8 , & V_66 ) ;
return V_22 ;
}
static int F_60 ( struct V_24 * V_6 )
{
struct V_3 * V_4 = F_61 ( V_6 ) ;
F_62 ( V_4 -> V_67 ) ;
F_59 ( & V_6 -> V_7 . V_8 , & V_66 ) ;
return 0 ;
}
static int F_63 ( struct V_13 * V_7 )
{
struct V_3 * V_4 = F_8 ( V_7 ) ;
if ( V_4 -> V_30 ) {
V_4 -> V_69 = V_4 -> V_31 ;
