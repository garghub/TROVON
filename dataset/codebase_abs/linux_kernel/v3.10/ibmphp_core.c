...
V_101 = F_49 ( V_98 -> V_95 , ( V_98 -> V_33 << 3 ) | V_102 ) ;
if ( V_101 ) {
F_50 ( V_101 ) ;
F_51 ( V_101 ) ;
}
...
static T_2 F_52 ( T_2 V_95 )
{
struct V_66 * V_30 ;
struct V_100 * V_103 ;
T_3 V_104 ;
if ( F_53 ( 0 , V_95 ) || ! ( F_54 ( V_95 ) ) )
return 1 ;
...
if ( ! F_55 ( V_103 , V_107 , & V_104 ) &&
( V_104 != 0x0000 ) && ( V_104 != 0xffff ) ) {
F_2 ( L_52 ,
V_68 ) ;
F_56 ( V_95 , V_106 -> V_105 , NULL ) ;
break;
}
}
F_16 ( V_103 ) ;
...
static int F_57 ( struct V_94 * V_98 )
{
struct V_66 * V_108 ;
int V_109 ;
int V_110 = 0 ;
...
V_110 = 1 ;
if ( V_98 -> V_103 == NULL )
V_98 -> V_103 = F_49 ( V_98 -> V_95 ,
F_58 ( V_98 -> V_33 , V_98 -> V_96 ) ) ;
if ( V_98 -> V_103 == NULL ) {
struct V_66 * V_30 = F_53 ( 0 , V_98 -> V_95 ) ;
if ( ! V_30 )
return 0 ;
V_109 = F_59 ( V_30 ,
F_58 ( V_98 -> V_33 , V_98 -> V_96 ) ) ;
...
if ( ! ( V_110 ) && ( V_98 -> V_103 -> V_111 == V_112 ) ) {
F_61 ( V_98 -> V_103 ) ;
V_108 = V_98 -> V_103 -> V_113 ;
if ( V_108 )
F_60 ( V_108 ) ;
}
return 0 ;
...
{ F_65 (PCI_VENDOR_ID_SERVERWORKS, 0x0101 ) } ,
{ } ,
} ;
F_2 ( L_54 , V_68 , V_4 -> V_19 ) ;
if ( F_66 ( V_4 -> V_5 ) && F_62 ( V_4 ) ) {
V_3 = F_8 ( & V_4 ) ;
if ( V_3 )
return V_3 ;
V_65 = F_67 ( V_4 -> V_60 ) ;
...
static inline void F_73 ( struct V_1 * V_4 )
{
V_84 ( L_62 ) ;
if ( ( V_4 -> V_60 & V_134 ) == V_135 )
V_84 ( L_63 ) ;
else if ( ( V_4 -> V_60 & V_134 ) == V_136 )
V_84 ( L_64 ) ;
else if ( ( V_4 -> V_60 & V_134 ) == V_137 )
V_84 ( L_65 ) ;
else
V_84 ( L_66 ) ;
}
static int F_74 ( struct V_45 * V_138 )
{
int V_3 , V_25 , V_139 ;
struct V_1 * V_4 ;
T_2 V_96 ;
...
if ( F_39 ( V_4 -> V_42 ) && ( F_78 ( V_4 -> V_42 ) ) ) {
F_15 ( L_84
L_85 ) ;
F_73 ( V_4 ) ;
goto V_142;
...
V_4 -> V_98 = F_79 ( sizeof( struct V_94 ) , V_86 ) ;
if ( ! V_4 -> V_98 ) {
F_15 ( L_45 ) ;
V_3 = - V_26 ;
goto V_142;
...
V_96 = 0x00 ;
do {
V_140 = F_44 ( V_4 -> V_30 , V_4 -> V_98 -> V_33 ,
V_96 ++ ) ;
...
static int F_83 ( struct V_45 * V_45 )
{
