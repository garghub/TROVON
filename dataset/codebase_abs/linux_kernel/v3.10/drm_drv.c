...
static int F_35 ( char * V_43 , T_3 * V_44 , const char * V_45 )
{
int V_46 ;
V_46 = strlen ( V_45 ) ;
if ( V_46 > * V_44 )
...
struct V_49 * V_50 )
{
struct F_37 * V_51 = V_48 ;
int V_52 ;
V_51 -> V_53 = V_2 -> V_6 -> V_54 ;
V_51 -> V_55 = V_2 -> V_6 -> V_56 ;
V_51 -> V_57 = V_2 -> V_6 -> V_58 ;
V_52 = F_35 ( V_51 -> V_59 , & V_51 -> V_60 ,
V_2 -> V_6 -> V_59 ) ;
if ( ! V_52 )
V_52 = F_35 ( V_51 -> V_61 , & V_51 -> V_62 ,
V_2 -> V_6 -> V_61 ) ;
if ( ! V_52 )
V_52 = F_35 ( V_51 -> V_63 , & V_51 -> V_64 ,
V_2 -> V_6 -> V_63 ) ;
return V_52 ;
}
long F_38 ( struct V_65 * V_66 ,
...
( V_73 < V_85 + V_2 -> V_6 -> V_88 ) ) {
T_5 V_89 ;
V_71 = & V_2 -> V_6 -> V_90 [ V_73 - V_85 ] ;
V_89 = F_42 ( V_71 -> V_91 ) ;
V_78 = V_79 = F_42 ( V_67 ) ;
if ( V_89 > V_79 )
V_79 = V_89 ;
...
F_2 ( L_10 ,
F_43 ( V_93 ) ,
( long ) F_44 ( V_50 -> V_56 -> V_94 ) ,
V_50 -> V_95 , V_71 -> V_59 ) ;
V_72 = V_71 -> V_72 ;
if ( ( V_73 == F_39 ( V_96 ) ) && V_2 -> V_6 -> V_97 )
V_72 = V_2 -> V_6 -> V_97 ;
if ( ! V_72 ) {
F_2 ( L_11 ) ;
V_74 = - V_75 ;
} else if ( ( ( V_71 -> V_98 & V_99 ) && ! F_45 ( V_100 ) ) ||
( ( V_71 -> V_98 & V_101 ) && ! V_50 -> V_95 ) ||
...
struct V_113 * F_49 ( struct V_1 * V_2 )
{
struct V_114 * V_13 ;
