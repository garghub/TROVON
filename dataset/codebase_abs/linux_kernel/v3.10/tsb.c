...
static unsigned long F_25 ( unsigned long V_73 )
{
...
void F_26 ( struct V_21 * V_22 , unsigned long V_76 , unsigned long V_77 )
{
...
int F_36 ( struct V_97 * V_98 , struct V_21 * V_22 )
{
#if F_10 ( V_33 ) || F_10 ( V_34 )
unsigned long V_99 ;
#endif
...
F_26 ( V_22 , V_28 , F_38 ( V_22 ) ) ;
#if F_10 ( V_33 ) || F_10 ( V_34 )
if ( F_29 ( V_99 ) )
F_26 ( V_22 , V_35 , V_99 ) ;
#endif
if ( F_29 ( ! V_22 -> V_25 . V_27 [ V_28 ] . V_12 ) )
return - V_103 ;
return 0 ;
}
...
F_8 ( & V_108 , V_24 ) ;
if ( F_44 ( V_22 -> V_25 ) ) {
unsigned long V_109 = F_45 ( V_22 -> V_25 ) ;
