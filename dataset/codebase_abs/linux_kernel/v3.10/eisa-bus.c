...
if ( V_56 )
return V_56 ;
V_56 = F_26 ( & V_6 -> V_22 , & V_57 ) ;
if ( V_56 )
goto V_58;
V_56 = F_26 ( & V_6 -> V_22 , & V_59 ) ;
if ( V_56 )
goto V_60;
V_56 = F_26 ( & V_6 -> V_22 , & V_61 ) ;
if ( V_56 )
goto V_62;
return 0 ;
V_62:
...
static int T_1 F_29 ( struct V_3 * V_4 ,
struct V_5 * V_6 ,
int V_10 )
{
int V_7 ;
...
F_30 ( V_68 , & V_6 -> V_22 , L_8 , & V_6 -> V_50 [ V_7 ] ) ;
...
struct V_5 * V_6 ;
char * V_71 ;
F_35 ( V_4 -> V_22 , L_9 , V_4 -> V_9 ) ;
V_6 = F_36 ( sizeof( * V_6 ) , V_72 ) ;
if ( ! V_6 ) {
F_37 ( V_4 -> V_22 , L_10 ) ;
return - V_73 ;
}
...
F_35 ( & V_6 -> V_22 , L_12 , V_6 -> V_12 . V_13 ) ;
if ( F_24 ( V_6 ) ) {
F_37 ( & V_6 -> V_22 , L_13 ,
V_6 -> V_12 . V_13 ) ;
F_33 ( V_6 ) ;
...
V_74:
for ( V_70 = 0 , V_7 = 1 ; V_7 <= V_4 -> V_77 ; V_7 ++ ) {
V_6 = F_36 ( sizeof( * V_6 ) , V_72 ) ;
if ( ! V_6 ) {
F_37 ( V_4 -> V_22 , L_14 ,
V_7 ) ;
...
F_35 ( V_4 -> V_22 , L_21 , V_70 , V_70 == 1 ? L_19 : L_22 ) ;
return 0 ;
}
int T_1 F_40 ( struct V_3 * V_4 )
{
int V_78 ;
V_4 -> V_79 . V_16 = V_79 . V_16 ;
V_4 -> V_79 . V_63 = V_4 -> V_50 -> V_63 ;
V_4 -> V_79 . V_64 = V_4 -> V_50 -> V_64 ;
V_4 -> V_79 . V_65 = V_67 ;
V_78 = F_31 ( & V_79 , & V_4 -> V_79 ) ;
if ( V_78 )
return V_78 ;
V_4 -> V_9 = V_80 ++ ;
V_78 = F_34 ( V_4 ) ;
