...
{
F_175 ( V_183 ) ;
F_176 ( & V_17 -> V_184 , & V_183 ) ;
F_177 ( & V_183 ) ;
}
void F_177 ( struct V_185 * V_186 )
{
int V_187 ;
struct V_17 * V_17 ;
F_178 () ;
...
F_184 ( V_17 ) ;
F_185 ( V_17 ) ;
F_186 ( V_17 -> V_18 . V_104 ) ;
F_187 ( V_17 -> V_18 . V_189 ) ;
F_188 ( V_17 -> V_18 . V_190 ) ;
}
}
void * F_189 ( unsigned int * V_191 , int V_192 )
{
struct V_193 * V_14 ;
unsigned int V_194 , V_94 ;
T_8 V_195 ;
F_190 ( sizeof( struct V_193 ) != sizeof( struct V_177 ) ) ;
V_194 = * V_191 = F_191 ( * V_191 , V_196 / sizeof( struct V_193 ) ) ;
V_195 = V_194 * sizeof( struct V_193 ) ;
V_14 = ( void * ) F_192 ( V_197 | V_198 | V_199 ,
F_154 ( V_195 ) ) ;
if ( ! V_14 ) {
F_193 ( V_200 L_16 ) ;
V_14 = F_194 ( V_195 ) ;
...
F_195 ( & V_14 [ V_94 ] , V_94 ) ;
return V_14 ;
}
int F_196 ( const char * V_201 , struct V_202 * V_203 )
{
int V_94 , V_68 , V_204 ;
...
return - V_212 ;
if ( ! V_213 )
return F_197 ( V_201 , V_203 ) ;
V_204 = F_198 ( V_201 , 0 , & V_205 ) ;
if ( V_204 )
return V_204 ;
if ( ! V_205 )
return - V_168 ;
...
return - V_103 ;
F_25 ( & V_48 ) ;
for ( V_94 = 0 ; V_94 < V_211 . V_18 . V_19 ; V_94 ++ ) {
while ( ! F_199 ( & V_211 . V_18 . V_14 [ V_94 ] ) ) {
V_66 = F_200 ( V_211 . V_18 . V_14 [ V_94 ] . V_214 ,
struct V_65 , V_41 ) ;
V_18 = F_54 ( V_66 ) ;
F_16 ( & V_66 -> V_41 ) ;
...
void F_201 ( unsigned long V_215 )
{
int V_178 ;
F_159 (cpu)
F_160 ( V_179 , V_178 ) . V_61 |= V_215 ;
}
int F_202 ( void )
{
int V_216 = 8 ;
...
int F_213 ( struct V_17 * V_17 )
{
int V_33 ;
F_97 ( & V_17 -> V_18 . V_101 , 0 ) ;
F_195 ( & V_17 -> V_18 . V_129 , V_232 ) ;
F_195 ( & V_17 -> V_18 . V_52 , V_233 ) ;
F_195 ( & V_17 -> V_18 . V_114 , V_234 ) ;
V_17 -> V_18 . V_190 = F_214 ( struct V_235 ) ;
if ( ! V_17 -> V_18 . V_190 ) {
V_33 = - V_103 ;
goto V_236;
}
V_17 -> V_18 . V_189 = F_215 ( V_197 , L_18 , V_17 ) ;
if ( ! V_17 -> V_18 . V_189 ) {
V_33 = - V_103 ;
goto V_237;
}
V_17 -> V_18 . V_104 = F_216 ( V_17 -> V_18 . V_189 ,
...
V_17 -> V_18 . V_14 = F_189 ( & V_17 -> V_18 . V_19 , 1 ) ;
if ( ! V_17 -> V_18 . V_14 ) {
V_33 = - V_103 ;
F_193 ( V_239 L_20 ) ;
goto V_241;
