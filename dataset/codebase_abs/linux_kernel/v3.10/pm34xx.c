...
F_25 ( 0xffffffff , V_128 , V_129 ) ;
F_25 ( 0xffffffff , V_38 , V_129 ) ;
F_25 ( 0xffffffff , V_39 , V_129 ) ;
F_25 ( 0xffffffff , V_130 , V_129 ) ;
F_25 ( 0xffffffff , V_131 , V_129 ) ;
F_25 ( 0xffffffff , V_106 , V_129 ) ;
F_25 ( 0xffffffff , V_29 , V_129 ) ;
F_25 ( 0 , V_132 , V_133 ) ;
F_61 () ;
F_62 () ;
}
...
int F_73 ( struct V_137 * V_67 , int V_65 )
{
struct V_63 * V_64 ;
F_56 (pwrst, &pwrst_list, node) {
if ( V_64 -> V_67 == V_67 ) {
...
static int T_6 F_74 ( struct V_137 * V_67 , void * V_32 )
{
struct V_63 * V_64 ;
if ( ! V_67 -> V_139 )
return 0 ;
V_64 = F_75 ( sizeof( struct V_63 ) , V_140 ) ;
if ( ! V_64 )
return - V_141 ;
V_64 -> V_67 = V_67 ;
V_64 -> V_68 = V_49 ;
F_76 ( & V_64 -> V_142 , & V_143 ) ;
if ( F_77 ( V_67 ) )
F_78 ( V_67 ) ;
...
int T_6 F_84 ( void )
{
struct V_63 * V_64 , * V_153 ;
struct V_154 * V_155 , * V_156 , * V_157 , * V_158 ;
int V_3 ;
if ( ! F_85 () )
F_86 ( L_7 ) ;
F_81 () ;
