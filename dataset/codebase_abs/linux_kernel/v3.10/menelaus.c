...
F_68 ( & V_102 -> V_16 ) ;
F_69 ( & V_102 -> V_103 , F_35 ) ;
F_70 ( L_22 , V_170 >> 4 , V_170 & 0x0f ) ;
V_3 = F_4 ( V_74 ) ;
if ( V_3 < 0 )
goto V_179;
if ( V_3 & ( 1 << 7 ) )
...
V_102 -> V_75 = 0 ;
if ( V_173 != NULL && V_173 -> V_180 != NULL ) {
V_171 = V_173 -> V_180 ( & V_5 -> V_66 ) ;
if ( V_171 < 0 )
goto V_179;
}
F_58 ( V_102 ) ;
