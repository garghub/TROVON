...
static void F_42 ( struct V_65 * V_66 , int V_67 )
{
struct V_1 * V_24 ;
struct V_74 * V_38 ;
V_24 = F_1 ( V_67 ) ;
...
static int F_44 ( struct V_74 * V_38 ,
...
static void F_49 ( struct V_74 * V_38 , T_4 V_80 [ 16 ] )
{
struct V_1 * V_24 = V_38 -> V_89 ;
F_38 ( V_24 ) ;
}
static void F_50 ( struct V_74 * V_38 ,
struct V_90 * V_11 )
{
struct V_1 * V_24 = V_38 -> V_89 ;
struct V_6 * V_28 ;
...
static int T_5 F_61 ( int V_67 , unsigned int V_75 )
{
struct V_1 * V_24 ;
char V_96 [ 9 ] ;
int V_30 ;
V_24 = F_62 ( sizeof( struct V_1 ) , V_97 ) ;
if ( ! V_24 )
return - V_37 ;
F_63 ( & V_24 -> V_52 ) ;
F_64 ( & V_24 -> V_61 ) ;
...
F_65 ( & V_24 -> V_58 , F_27 ) ;
F_66 ( & V_24 -> V_72 ) ;
V_24 -> V_56 = ( void * ) F_67 ( V_97 ) ;
if ( ! V_24 -> V_56 ) {
F_8 ( V_24 ) ;
return - V_37 ;
}
V_24 -> V_75 = V_75 ;
V_24 -> V_46 = F_68 ( V_3 + V_67 ,
V_3 + V_67 , & V_98 , 256 ) ;
if ( F_69 ( V_24 -> V_46 ) ) {
V_30 = F_70 ( V_24 -> V_46 ) ;
goto V_99;
...
F_71 ( V_24 -> V_83 , 8 ) ;
V_24 -> V_95 = F_62 ( sizeof( * V_24 -> V_95 ) , V_97 ) ;
if ( ! V_24 -> V_95 ) {
V_30 = - V_37 ;
goto V_101;
}
F_72 ( V_24 -> V_95 , L_4 , V_67 ) ;
F_73 ( V_24 -> V_95 , V_24 ) ;
...
F_76 ( V_24 -> V_46 ) ;
V_99:
F_77 ( ( unsigned long ) V_24 -> V_56 ) ;
F_8 ( V_24 ) ;
return V_30 ;
}
static void T_5 F_78 ( struct V_1 * V_24 )
{
F_76 ( V_24 -> V_46 ) ;
F_79 ( V_24 -> V_95 ) ;
F_77 ( ( unsigned long ) V_24 -> V_56 ) ;
...
static const char * F_80 ( const char * V_109 , char * V_110 )
{
...
static int F_82 ( const char * V_114 )
{
const char * V_112 ;
int V_115 ;
T_2 V_7 , V_26 ;
...
static int F_85 ( const char * V_114 , const struct V_122 * V_123 )
{
int V_30 ;
if ( ! V_124 || ! V_4 )
return - V_51 ;
...
static int F_87 ( char * V_126 , const struct V_122 * V_123 )
{
int V_30 ;
T_2 V_127 , V_53 ;
void * V_128 , * V_129 ;
...
static int T_5 F_100 ( char * V_114 )
{
return F_101 ( V_114 , 10 , & V_4 ) ;
}
