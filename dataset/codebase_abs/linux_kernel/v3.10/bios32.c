...
static int F_26 ( int V_72 , struct V_63 * V_64 )
{
int V_73 ;
struct V_74 * V_75 ;
if ( F_27 ( & V_64 -> V_76 ) ) {
...
static void F_32 ( struct V_88 * V_89 , struct V_12 * V_90 )
{
...
F_36 ( & V_64 -> V_76 ) ;
if ( V_89 -> V_96 )
V_64 -> V_96 = V_89 -> V_96 [ V_91 ] ;
V_73 = V_89 -> V_97 ( V_91 , V_64 ) ;
if ( V_73 > 0 ) {
V_73 = F_26 ( V_91 , V_64 ) ;
if ( V_73 ) {
F_37 ( V_64 ) ;
...
if ( V_89 -> V_98 )
V_64 -> V_2 = V_89 -> V_98 ( V_91 , V_64 ) ;
else
V_64 -> V_2 = F_38 ( NULL , V_64 -> V_72 ,
V_89 -> V_99 , V_64 , & V_64 -> V_76 ) ;
if ( ! V_64 -> V_2 )
F_34 ( L_10 ) ;
V_72 = V_64 -> V_2 -> V_100 . V_19 + 1 ;
F_39 ( & V_64 -> V_101 , V_90 ) ;
} else {
F_37 ( V_64 ) ;
if ( V_73 < 0 )
break;
...
T_6 F_51 ( void * V_107 , const struct V_18 * V_79 ,
T_6 V_108 , T_6 V_109 )
{
...
V_20 = ( V_20 + V_109 - 1 ) & ~ ( V_109 - 1 ) ;
if ( V_64 -> V_95 )
return V_64 -> V_95 ( V_6 , V_79 , V_20 , V_108 , V_109 ) ;
return V_20 ;
}
int F_52 ( struct V_5 * V_6 , int V_110 )
{
T_2 V_54 , V_111 ;
int V_112 ;
struct V_18 * V_26 ;
...
int F_53 ( struct V_5 * V_6 , struct V_118 * V_119 ,
enum V_120 V_121 , int V_122 )
{
struct V_63 * V_123 = V_6 -> V_65 ;
unsigned long V_124 ;
if ( V_121 == V_125 ) {
return - V_114 ;
} else {
V_124 = V_119 -> V_126 + ( V_123 -> V_78 >> V_127 ) ;
}
V_119 -> V_128 = F_54 ( V_119 -> V_128 ) ;
if ( F_55 ( V_119 , V_119 -> V_129 , V_124 ,
V_119 -> V_130 - V_119 -> V_129 ,
V_119 -> V_128 ) )
return - V_131 ;
return 0 ;
}
void T_5 F_56 ( unsigned long V_132 )
{
struct V_133 V_134 = {
. V_135 = V_136 ,
. type = V_137 ,
