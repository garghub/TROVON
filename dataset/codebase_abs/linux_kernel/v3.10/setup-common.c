...
T_4 int T_3 F_78 ( char * V_98 )
{
if ( V_98 && strncmp ( V_98 , L_58 , 1 ) != 0 )
V_99 = 1 ;
return 0 ;
}
int T_3 F_79 ( char * V_98 )
{
unsigned long V_71 ;
if ( V_98 ) {
if ( ! F_80 ( V_98 , 0 , & V_71 ) )
...
void F_81 ( char * V_101 , unsigned short V_102 )
{
F_82 ( L_59 , V_101 ) ;
}
void F_83 ( struct V_69 * V_103 )
{
V_103 -> V_104 . V_105 = F_84 ( 32 ) ;
V_103 -> V_106 . V_105 = & V_103 -> V_104 . V_105 ;
F_85 ( & V_103 -> V_106 , & V_107 ) ;
}
