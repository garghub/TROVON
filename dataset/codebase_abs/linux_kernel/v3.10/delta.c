...
struct V_59 * V_60 ;
unsigned char V_4 ;
if ( V_2 -> V_10 . V_11 == V_86 &&
V_2 -> V_10 . V_87 == 0x7b )
V_2 -> V_10 . V_11 = V_12 ;
if ( V_2 -> V_10 . V_11 == V_88 &&
V_2 -> V_10 . V_87 == 0xfb )
V_2 -> V_10 . V_11 = V_21 ;
switch ( V_2 -> V_10 . V_11 ) {
case V_17 :
...
case V_91 :
case V_88 :
V_2 -> V_89 = V_2 -> V_92 ? 8 : 4 ;
V_2 -> V_90 = V_2 -> V_92 ? 8 : 4 ;
break;
case V_86 :
case V_12 :
case V_13 :
...
case V_26 :
case V_21 :
if ( ( V_85 = F_44 ( V_2 -> V_75 , L_2 , NULL , & V_2 -> V_96 ) ) < 0 ) {
F_41 ( V_83 L_3 ) ;
return V_85 ;
}
V_2 -> V_96 -> V_37 = V_2 ;
V_2 -> V_96 -> V_97 = & V_98 ;
if ( ( V_85 = F_45 ( V_2 , V_99 ) ) < 0 )
return V_85 ;
break;
case V_86 :
case V_93 :
V_2 -> V_100 . V_101 = F_27 ;
break;
case V_95 :
V_2 -> V_100 . V_101 = F_27 ;
case V_88 :
V_2 -> V_52 . V_97 . V_102 = F_33 ;
V_2 -> V_52 . V_97 . V_103 = F_34 ;
V_2 -> V_52 . V_97 . V_104 = F_14 ;
V_2 -> V_52 . V_97 . V_105 = F_16 ;
V_2 -> V_52 . V_97 . V_106 = F_20 ;
V_2 -> V_52 . V_97 . V_107 = F_21 ;
...
V_60 = V_2 -> V_108 = F_46 ( sizeof( struct V_59 ) , V_109 ) ;
if ( ! V_60 )
return - V_110 ;
V_2 -> V_111 = 1 ;
switch ( V_2 -> V_10 . V_11 ) {
case V_17 :
V_85 = F_47 ( V_60 , & V_112 , & V_113 , V_2 ) ;
break;
case V_18 :
V_85 = F_47 ( V_60 , & V_114 , & V_115 , V_2 ) ;
break;
case V_13 :
case V_94 :
V_85 = F_47 ( V_60 , & V_116 , & V_117 , V_2 ) ;
break;
case V_88 :
case V_91 :
V_85 = F_47 ( V_60 , & V_118 , & V_119 , V_2 ) ;
break;
case V_26 :
V_85 = F_47 ( V_60 , & V_120 , & V_121 , V_2 ) ;
break;
case V_21 :
V_85 = F_47 ( V_60 , & V_122 , & V_123 , V_2 ) ;
break;
default:
F_48 () ;
return - V_124 ;
...
case V_86 :
case V_93 :
V_85 = F_50 ( V_2 -> V_75 , F_51 ( & V_125 , V_2 ) ) ;
if ( V_85 < 0 )
return V_85 ;
V_85 = F_50 ( V_2 -> V_75 , F_51 ( & V_126 , V_2 ) ) ;
if ( V_85 < 0 )
return V_85 ;
break;
case V_95 :
V_85 = F_50 ( V_2 -> V_75 , F_51 ( & V_127 , V_2 ) ) ;
if ( V_85 < 0 )
return V_85 ;
break;
case V_12 :
case V_13 :
V_85 = F_50 ( V_2 -> V_75 , F_51 ( & V_128 , V_2 ) ) ;
if ( V_85 < 0 )
return V_85 ;
V_85 = F_50 ( V_2 -> V_75 , F_51 ( & V_129 , V_2 ) ) ;
if ( V_85 < 0 )
return V_85 ;
break;
}
...
case V_88 :
case V_93 :
V_85 = F_50 ( V_2 -> V_75 , F_51 ( & V_130 , V_2 ) ) ;
if ( V_85 < 0 )
return V_85 ;
break;
}
