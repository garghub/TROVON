...
unsigned long V_42 ;
F_4 ( & V_40 -> V_52 , V_42 ) ;
if ( F_51 ( V_174 , & V_33 -> V_49 ) )
V_40 -> V_175 -- ;
F_7 ( & V_40 -> V_52 , V_42 ) ;
}
int F_52 ( struct V_32 * V_176 )
{
struct V_37 * V_40 = V_176 -> V_39 -> V_40 ;
struct V_76 * V_79 = V_40 -> V_78 . V_79 ;
struct V_45 * V_46 ;
int V_177 ;
F_53 ( & V_176 -> V_56 . V_178 , V_40 -> V_33 , & V_179 ) ;
V_46 = F_54 ( & V_176 -> V_56 . V_178 ,
& V_180 ,
V_79 ) ;
if ( ! V_46 ) {
F_2 ( L_11 ) ;
...
struct V_182 * V_183 ;
if ( V_30 -> V_50 ) {
struct V_184 * V_185 = V_30 -> V_50 -> V_148 -> V_184 ;
unsigned long V_42 ;
F_4 ( V_185 -> V_186 , V_42 ) ;
F_58 ( V_30 -> V_50 -> V_187 ) ;
F_7 ( V_185 -> V_186 , V_42 ) ;
return;
}
V_30 -> V_42 &= ~ V_188 ;
V_30 -> V_42 |= V_65 ;
...
else if ( ( V_59 -> V_193 == 1 &&
V_59 -> V_190 == 1 &&
V_59 -> V_194 == 0x14 &&
V_59 -> V_195 == 0xEB &&
( V_59 -> V_148 & ~ 0x10 ) == 0 ) )
V_33 -> V_56 . V_57 = V_58 ;
else if ( ( V_59 -> V_189 == 1 &&
V_59 -> V_190 == 1 &&
V_59 -> V_191 == 0x3C &&
V_59 -> V_192 == 0xC3 &&
V_59 -> V_148 == 0 )
...
void F_60 ( struct V_196 * V_39 )
{
struct V_32 * V_33 , * V_197 ;
F_61 ( & V_39 -> V_40 -> V_198 ) ;
F_62 (dev, &port->disco_list, disco_list_node) {
if ( ! F_63 ( V_33 ) )
continue;
F_64 ( V_33 -> V_56 . V_46 ) ;
}
F_65 ( & V_39 -> V_40 -> V_198 ) ;
F_66 (dev, n, &port->disco_list, disco_list_node) {
if ( ! F_63 ( V_33 ) )
continue;
F_67 ( V_33 ) ;
if ( F_68 ( F_69 ( V_33 ) ) )
F_70 ( V_33 , V_21 , - V_143 ) ;
}
}
static bool F_71 ( struct V_196 * V_39 , const char * V_199 )
{
struct V_32 * V_33 , * V_197 ;
bool V_200 = false ;
...
continue;
F_67 ( V_33 ) ;
V_177 = V_33 -> V_56 . V_201 ;
if ( V_177 == - V_160 )
V_200 = true ;
else if ( V_177 ) {
F_72 ( 1 , L_12 , V_199 ,
F_39 ( & V_33 -> V_149 -> V_33 ) , V_177 ) ;
}
if ( F_68 ( F_69 ( V_33 ) ) )
F_70 ( V_33 , V_199 , - V_143 ) ;
}
return V_200 ;
}
void F_73 ( struct V_196 * V_39 )
{
struct V_32 * V_33 ;
V_200:
F_61 ( & V_39 -> V_40 -> V_198 ) ;
...
continue;
V_203 = & V_33 -> V_56 ;
if ( V_203 -> V_46 -> V_204 . V_205 == V_206 )
continue;
V_203 -> V_201 = - V_207 ;
F_74 ( V_203 -> V_46 , & V_203 -> V_201 ) ;
}
F_65 ( & V_39 -> V_40 -> V_198 ) ;
if ( F_71 ( V_39 , V_21 ) )
goto V_200;
}
void F_75 ( struct V_196 * V_39 )
{
struct V_32 * V_33 ;
V_200:
F_61 ( & V_39 -> V_40 -> V_198 ) ;
...
continue;
V_203 = & V_33 -> V_56 ;
if ( V_203 -> V_46 -> V_204 . V_205 == V_208 )
continue;
V_203 -> V_201 = - V_207 ;
F_76 ( V_203 -> V_46 , & V_203 -> V_201 ) ;
}
F_65 ( & V_39 -> V_40 -> V_198 ) ;
if ( F_71 ( V_39 , V_21 ) )
goto V_200;
...
return - V_143 ;
F_30 ( V_33 ) ;
F_78 ( V_33 , V_33 -> V_149 ) ;
V_129 = F_79 ( V_33 ) ;
if ( V_129 )
return V_129 ;
F_80 ( V_33 -> V_39 , V_210 ) ;
return 0 ;
}
static void F_81 ( void * V_211 , T_2 V_212 )
{
struct V_32 * V_33 = V_211 ;
struct V_45 * V_46 = V_33 -> V_56 . V_46 ;
struct V_37 * V_40 = V_33 -> V_39 -> V_40 ;
F_37 ( V_159 , V_33 , L_13 ) ;
...
F_87 ( V_38 ) ;
F_88 ( & V_38 -> V_214 ) ;
for ( V_81 = 0 ; V_81 < V_38 -> V_215 ; V_81 ++ ) {
struct V_196 * V_39 = V_38 -> V_216 [ V_81 ] ;
struct V_32 * V_33 ;
F_22 ( & V_39 -> V_217 ) ;
F_62 (dev, &port->dev_list, dev_list_node) {
if ( ! F_63 ( V_33 ) )
...
void F_94 ( struct V_76 * V_79 , struct V_219 * V_220 ,
struct V_219 * V_221 )
{
struct V_222 * V_223 , * V_197 ;
struct V_32 * V_224 ;
do {
F_95 ( V_225 ) ;
V_224 = NULL ;
F_66 (cmd, n, work_q, eh_entry) {
struct V_32 * V_146 = F_96 ( V_223 ) ;
if ( ! F_63 ( V_146 ) || F_97 ( V_223 ) )
continue;
if ( V_224 && V_224 != V_146 )
continue;
V_224 = V_146 ;
F_98 ( & V_223 -> V_226 , & V_225 ) ;
}
if ( ! F_99 ( & V_225 ) ) {
struct V_45 * V_46 = V_224 -> V_56 . V_46 ;
F_37 ( V_159 , V_224 , L_14 ) ;
F_100 ( V_79 , V_46 , & V_225 ) ;
while ( ! F_99 ( & V_225 ) )
F_11 ( V_225 . V_227 ) ;
}
} while ( V_224 );
