...
static T_4 F_67 ( struct V_90 * V_69 )
{
struct V_1 * V_2 = F_43 ( V_69 ) ;
struct V_91 * V_92 = V_69 -> V_92 ;
struct V_66 * V_63 = V_92 -> V_16 ;
...
static T_4 F_68 ( struct V_90 * V_69 )
{
struct V_1 * V_2 = F_43 ( V_69 ) ;
struct V_91 * V_92 = V_69 -> V_92 ;
struct V_66 * V_63 = V_92 -> V_16 ;
...
int V_66 ( struct V_1 * V_2 , int V_191 , struct V_192 * * V_193 )
{
struct V_192 * V_51 ;
int V_116 ;
if ( V_193 )
...
static int F_146 ( struct V_290 * V_111 , struct V_1 * V_2 )
{
struct V_285 * V_286 ;
...
V_306 = ( const T_7 * ) V_2 -> V_297 -> V_310 ;
for ( V_25 = 0 ; V_25 < V_300 / 4 ; V_25 ++ )
F_11 ( V_2 , V_311 + ( V_25 << 2 ) ,
F_36 ( V_306 [ V_25 ] ) ) ;
V_306 = ( const T_7 * ) V_2 -> V_303 -> V_310 ;
...
static int F_168 ( struct V_350 * V_191 )
{
struct V_1 * V_2 = V_191 -> V_351 ;
return F_160 ( V_2 ) ;
}
static int F_169 ( struct V_191 * V_298 )
{
struct V_291 * V_143 = F_170 ( V_298 ) ;
struct V_290 * V_111 = F_171 ( V_298 ) ;
...
F_175 ( V_2 -> V_143 , V_356 ,
& V_2 -> V_357 ) ;
F_175 ( V_2 -> V_143 , V_358 ,
& V_2 -> V_359 ) ;
F_11 ( V_2 , V_236 , 0 ) ;
F_11 ( V_2 , V_238 , 0 ) ;
F_154 ( V_2 ) ;
...
static int F_178 ( struct V_191 * V_298 )
{
struct V_291 * V_143 = F_170 ( V_298 ) ;
struct V_290 * V_111 = F_171 ( V_298 ) ;
struct V_1 * V_2 = V_111 -> V_16 ;
...
V_2 -> V_368 = F_189 ( V_143 , 0 ) ;
V_2 -> V_4 = F_190 ( V_2 -> V_368 , 0x8000 ) ;
F_183 ( V_143 ) ;
V_2 -> V_62 = - 1 ;
if ( ( V_2 -> V_345 = F_191 ( V_2 -> V_368 , 0x8000 , L_2 ) ) == NULL ) {
F_17 ( V_12 L_24 , V_2 -> V_368 , V_2 -> V_368 + 0x8000 - 1 ) ;
F_160 ( V_2 ) ;
return - V_13 ;
}
if ( F_192 ( V_143 -> V_161 , F_73 , V_369 ,
V_370 , V_2 ) ) {
...
#ifdef F_161
V_2 -> V_346 = F_193 ( V_353 * sizeof( T_2 ) ,
V_176 ) ;
if ( V_2 -> V_346 == NULL ) {
F_160 ( V_2 ) ;
return - V_56 ;
...
#endif
if ( ( V_116 = F_194 ( V_111 , V_371 , V_2 , & V_252 ) ) < 0 ) {
F_160 ( V_2 ) ;
return V_116 ;
}
F_146 ( V_111 , V_2 ) ;
F_195 ( V_111 , & V_143 -> V_298 ) ;
* V_364 = V_2 ;
return 0 ;
}
