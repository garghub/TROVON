...
static void F_11 ( struct V_38 * V_38 )
{
struct V_12 * V_13 = V_38 -> V_39 ;
struct V_1 * V_2 = (struct V_1 * ) V_13 -> V_35 ;
F_3 ( L_3 , V_2 -> V_8 ,
V_38 , V_38 -> V_40 , V_38 -> V_41 ) ;
if ( ! F_12 ( V_42 , & V_2 -> V_43 ) )
goto V_44;
if ( ! V_38 -> V_40 )
V_2 -> V_10 . V_45 += V_38 -> V_46 ;
else
V_2 -> V_10 . V_47 ++ ;
V_44:
F_13 ( V_38 -> V_48 ) ;
...
F_25 ( V_38 , V_7 -> V_56 , V_50 , V_4 , V_54 ,
F_15 , V_2 , 1 ) ;
V_38 -> V_57 |= V_58 ;
F_17 ( V_38 , & V_7 -> V_53 ) ;
V_49 = F_18 ( V_38 , V_55 ) ;
...
if ( ! V_38 )
return - V_34 ;
* F_37 ( V_13 , 1 ) = F_9 ( V_13 ) -> V_37 ;
switch ( F_9 ( V_13 ) -> V_37 ) {
case V_63 :
...
F_40 ( V_38 , V_7 -> V_56 , V_50 , ( void * ) V_61 ,
...
return - V_80 ;
V_7 = F_43 ( & V_74 -> V_35 , sizeof( * V_7 ) , V_55 ) ;
if ( ! V_7 )
return - V_34 ;
V_7 -> V_56 = F_44 ( V_74 ) ;
F_45 ( & V_7 -> V_59 ) ;
