...
/ sizeof( struct V_112 ) ;
while ( -- V_17 > 0 ) {
V_55 = F_62 ( V_55 , V_113 -> V_45 , V_113 -> V_115 ,
V_116 ) ;
V_113 ++ ;
}
V_39 [ V_117 ] . V_55 = V_55 ;
V_39 [ V_117 ] . V_56 = F_63 ( V_113 -> V_45 , V_113 -> V_115 ) ;
...
V_43 [ V_119 ] . V_56 = F_63 ( V_113 -> V_45 , V_113 -> V_115 ) ;
...
static void F_74 ( struct V_5 * V_5 , int V_134 ,
unsigned int V_135 )
{
...
V_5 -> V_134 = V_134 ;
V_5 -> V_141 = F_75 ( V_135 ) ;
V_5 -> V_142 = 1 ;
}
static int F_76 ( int V_2 ,
struct V_143 * V_144 ,
unsigned int V_145 , int V_134 ,
struct V_146 * V_147 )
{
int V_132 = F_66 ( V_147 -> V_148 ) ;
