...
V_152 = F_123 ( V_152 ) ;
F_12 ( V_15 ) ;
F_194 ( V_223 , & V_15 -> V_61 -> V_145 ) ;
}
F_124 ( F_191 ( V_15 ) , & V_49 ) ;
F_14 ( V_15 ) ;
return V_152 ;
}
static int F_195 ( struct V_186 * V_216 , struct V_86 * V_14 ,
struct V_187 * V_188 , T_3 V_207 ,
int V_145 )
{
struct V_189 * V_190 = F_159 ( V_216 ) ;
...
if ( V_145 & V_196 )
goto V_92;
V_226 = F_196 ( V_15 , V_145 & V_227 , V_207 ) ;
...
! F_199 ( F_145 ( V_9 ) . V_182 , V_190 -> V_7 -> V_183 . V_182 ) ||
! F_200 ( F_145 ( V_9 ) . V_184 , V_190 -> V_7 -> V_183 . V_184 ) )
break;
...
if ( F_201 ( V_188 -> V_204 , V_9 -> V_231 + V_219 , V_228 ) ) {
if ( V_224 == 0 )
V_224 = - V_232 ;
break;
}
...
static int F_205 ( struct V_86 * V_14 , int V_131 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_14 * V_55 ;
...
static int F_210 ( struct V_86 * V_14 , unsigned int V_238 , unsigned long V_239 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
long V_237 = 0 ;
int V_88 ;
...
case V_240 :
V_237 = F_208 ( V_15 ) ;
V_88 = F_211 ( V_237 , ( int V_241 * ) V_239 ) ;
break;
case V_242 :
V_237 = F_206 ( V_15 ) ;
if ( V_237 < 0 )
...
static unsigned int F_212 ( struct V_244 * V_244 , struct V_86 * V_14 , T_4 * V_49 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
unsigned int V_245 ;
F_213 ( V_244 , F_191 ( V_15 ) , V_49 ) ;
V_245 = 0 ;
if ( V_15 -> V_58 )
V_245 |= V_246 ;
if ( V_15 -> V_69 == V_70 )
...
static unsigned int F_214 ( struct V_244 * V_244 , struct V_86 * V_14 ,
T_4 * V_49 )
{
...
if ( V_55 ) {
if ( F_7 ( V_55 ) != V_15 ) {
F_213 ( V_244 , & F_32 ( V_55 ) -> V_56 , V_49 ) ;
if ( F_9 ( V_55 ) )
V_251 = 0 ;
}
F_61 ( V_55 ) ;
...
static struct V_14 * F_216 ( struct V_257 * V_258 , T_5 * V_259 )
{
unsigned long V_260 = F_217 ( * V_259 ) ;
unsigned long V_261 = F_218 ( * V_259 ) ;
struct V_14 * V_15 ;
unsigned long V_175 = 0 ;
for ( V_15 = F_219 ( & V_5 [ V_261 ] ) ; V_15 ; V_15 = F_220 ( V_15 ) ) {
if ( F_34 ( V_15 ) != F_221 ( V_258 ) )
continue;
if ( ++ V_175 == V_260 )
break;
}
...
static struct V_14 * F_222 ( struct V_257 * V_258 ,
struct V_14 * V_15 ,
T_5 * V_259 )
{
unsigned long V_261 ;
...
do {
V_15 = F_216 ( V_258 , V_259 ) ;
if ( V_15 )
return V_15 ;
V_263:
V_261 = F_218 ( * V_259 ) + 1 ;
* V_259 = F_223 ( V_261 , 1 ) ;
} while ( V_261 < F_224 ( V_5 ) );
return NULL ;
}
static void * F_225 ( struct V_257 * V_258 , T_5 * V_259 )
__acquires( V_32 )
{
F_27 ( & V_32 ) ;
if ( ! * V_259 )
return V_262 ;
if ( F_218 ( * V_259 ) >= F_224 ( V_5 ) )
return NULL ;
return F_222 ( V_258 , NULL , V_259 ) ;
}
static void * F_226 ( struct V_257 * V_258 , void * V_264 , T_5 * V_259 )
{
++ * V_259 ;
return F_222 ( V_258 , V_264 , V_259 ) ;
}
static void F_227 ( struct V_257 * V_258 , void * V_264 )
__releases( V_32 )
{
F_28 ( & V_32 ) ;
}
static int F_228 ( struct V_257 * V_258 , void * V_264 )
{
if ( V_264 == V_262 )
F_229 ( V_258 , L_4
L_5 ) ;
...
for ( ; V_40 < V_25 ; V_40 ++ )
F_232 ( V_258 , V_36 -> V_2 -> V_37 -> V_30 [ V_40 ] ) ;
}
F_14 ( V_19 ) ;
F_232 ( V_258 , '\n' ) ;
}
...
static int F_234 ( struct V_39 * V_39 , struct V_244 * V_244 )
{
return F_235 ( V_39 , V_244 , & V_269 ,
sizeof( struct V_270 ) ) ;
}
...
goto V_92;
#ifdef F_238
if ( ! F_239 ( L_7 , 0 , V_33 -> V_271 , & V_272 ) ) {
F_240 ( V_33 ) ;
goto V_92;
}
#endif
...
{
F_240 ( V_33 ) ;
F_242 ( L_7 , V_33 -> V_271 ) ;
}
static int T_8 F_243 ( void )
{
int V_273 = - 1 ;
F_244 ( sizeof( struct V_274 ) > F_245 ( struct V_8 , V_275 ) ) ;
V_273 = F_246 ( & V_99 , 1 ) ;
if ( V_273 != 0 ) {
F_52 ( V_276 L_8 ,
V_277 ) ;
