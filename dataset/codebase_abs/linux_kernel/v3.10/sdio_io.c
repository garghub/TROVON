...
{
unsigned V_22 = V_2 -> V_3 -> V_4 -> V_17 ;
if ( F_17 ( V_2 -> V_3 ) )
...
V_5 = F_22 ( V_2 -> V_3 , V_30 , V_2 -> V_10 , V_31 ,
V_32 , V_33 , 0 , V_34 ) ;
if ( V_5 )
return V_5 ;
V_35 -= V_34 ;
...
if ( V_39 )
* V_39 = 0 ;
V_5 = F_9 ( V_2 -> V_3 , 0 , V_2 -> V_10 , V_31 , 0 , & V_40 ) ;
if ( V_5 ) {
if ( V_39 )
* V_39 = V_5 ;
return 0xFF ;
...
int V_5 ;
F_2 ( ! V_2 ) ;
V_5 = F_9 ( V_2 -> V_3 , 1 , V_2 -> V_10 , V_31 , V_41 , NULL ) ;
if ( V_39 )
* V_39 = V_5 ;
}
...
int V_5 ;
T_1 V_40 ;
V_5 = F_9 ( V_2 -> V_3 , 1 , V_2 -> V_10 , V_31 ,
V_42 , & V_40 ) ;
if ( V_39 )
* V_39 = V_5 ;
if ( V_5 )
