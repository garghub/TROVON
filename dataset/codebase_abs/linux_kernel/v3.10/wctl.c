...
unsigned int F_7 ( struct V_17 * V_18 ,
struct V_2 * V_3 )
{
unsigned int V_5 ;
if ( V_18 -> V_22 == 0 )
...
bool F_8 ( struct V_17 * V_18 , struct V_2 * V_3 , unsigned int V_27 , bool V_28 , bool V_29 )
{
unsigned int V_30 ;
if ( V_28 == true ) {
V_30 = 28 ;
