...
if ( F_145 ( V_20 -> V_23 ) )
return F_146 ( V_20 -> V_23 ) ;
F_147 ( V_377 , V_291 ) ;
V_373 = V_377 -> V_373 [ 0 ] ;
V_207 = F_148 ( V_373 , F_141 , 0 ,
F_149 ( & V_377 -> V_98 ) , V_20 ) ;
if ( V_207 )
return V_207 ;
V_207 = F_83 ( V_20 ) ;
if ( V_207 )
...
F_150 ( & V_377 -> V_98 , L_46 ) ;
V_383 = & V_291 -> V_315 ;
F_85 ( & V_383 -> V_223 ) ;
if ( V_380 )
V_16 = F_151 ( int , V_380 -> V_390 , V_20 -> V_15 . V_16 ) ;
else
...
static int F_155 ( struct V_376 * V_377 )
{
struct V_290 * V_291 = F_156 ( V_377 ) ;
struct V_281 * V_293 , * V_381 ;
struct V_19 * V_20 ;
int V_373 ;
if ( ! V_291 )
