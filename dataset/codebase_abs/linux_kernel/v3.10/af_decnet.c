...
void * V_213 )
{
struct V_167 * V_168 = (struct V_167 * ) V_213 ;
if ( ! F_54 ( F_156 ( V_168 ) , & V_154 ) )
return V_362 ;
switch ( V_361 ) {
case V_363 :
F_157 ( V_168 ) ;
...
static void F_169 ( struct V_21 * V_376 , unsigned char * V_28 )
{
int V_22 ;
...
static char * F_171 ( unsigned char V_70 )
{
switch ( V_70 ) {
case V_71 :
return L_5 ;
...
static int F_176 ( struct V_385 * V_385 , struct V_245 * V_245 )
{
return F_177 ( V_245 , & V_386 ,
sizeof( struct V_367 ) ) ;
}
...
F_185 ( & V_389 ) ;
F_186 ( & V_390 ) ;
F_187 ( L_27 , V_391 , V_154 . V_392 , & V_393 ) ;
F_188 () ;
V_19:
return V_373 ;
}
