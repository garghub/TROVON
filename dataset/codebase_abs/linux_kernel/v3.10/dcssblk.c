...
int V_24 ;
V_94 = 0 ;
V_4 = V_88 -> V_95 -> V_82 -> V_68 ;
if ( V_4 == NULL )
goto V_96;
if ( ( V_88 -> V_97 & 7 ) != 0 || ( V_88 -> V_98 & 4095 ) != 0 )
goto V_96;
if ( F_64 ( V_88 ) > F_65 ( V_88 -> V_95 -> V_82 ) ) {
goto V_96;
}
if ( V_4 -> V_42 ) {
switch ( V_4 -> V_32 ) {
...
F_68 (bvec, bio, i) {
V_92 = ( unsigned long )
F_69 ( V_90 -> V_100 ) + V_90 -> V_101 ;
V_93 = V_4 -> V_23 + ( V_91 << 12 ) + V_94 ;
if ( F_70 ( ( V_92 & 4095 ) != 0 ) || ( V_90 -> V_102 & 4095 ) != 0 )
goto V_96;
if ( F_66 ( V_88 ) == V_103 ) {
memcpy ( ( void * ) V_92 , ( void * ) V_93 ,
V_90 -> V_102 ) ;
} else {
memcpy ( ( void * ) V_93 , ( void * ) V_92 ,
V_90 -> V_102 ) ;
}
V_94 += V_90 -> V_102 ;
}
...
static int
F_73 ( struct V_79 * V_80 , T_4 V_104 ,
void * * V_105 , unsigned long * V_106 )
{
struct V_3 * V_4 ;
unsigned long V_107 ;
V_4 = V_80 -> V_82 -> V_68 ;
...
if ( V_104 % ( V_108 / 512 ) )
return - V_12 ;
V_107 = V_104 / ( V_108 / 512 ) ;
if ( ( V_107 + 1 ) * V_108 - 1 > V_4 -> V_20 - V_4 -> V_23 )
return - V_109 ;
* V_105 = ( void * ) ( V_4 -> V_23 + V_107 * V_108 ) ;
* V_106 = F_74 ( * V_105 ) >> V_110 ;
return 0 ;
}
static void
F_75 ( void )
{
int V_26 , V_24 , V_25 , V_111 ;
char V_41 [ V_112 + 1 ] ;
struct V_3 * V_4 ;
for ( V_24 = 0 ; ( V_24 < V_112 ) && ( V_113 [ V_24 ] != '\0' ) ;
V_24 ++ ) {
for ( V_25 = V_24 ; ( V_113 [ V_25 ] != ',' ) &&
( V_113 [ V_25 ] != '\0' ) &&
( V_113 [ V_25 ] != '(' ) &&
( V_25 < V_112 ) ; V_25 ++ )
{
V_41 [ V_25 - V_24 ] = V_113 [ V_25 ] ;
}
V_41 [ V_25 - V_24 ] = '\0' ;
V_26 = F_43 ( V_55 , NULL , V_41 , V_25 - V_24 ) ;
if ( ( V_26 >= 0 ) && ( V_113 [ V_25 ] == '(' ) ) {
for ( V_111 = 0 ; ( V_41 [ V_111 ] != ':' ) && ( V_41 [ V_111 ] != '\0' ) ; V_111 ++ )
V_41 [ V_111 ] = toupper ( V_41 [ V_111 ] ) ;
V_41 [ V_111 ] = '\0' ;
if ( ! strncmp ( & V_113 [ V_25 ] , L_28 , 7 ) ) {
F_17 ( & V_36 ) ;
V_4 = F_9 ( V_41 ) ;
F_18 ( & V_36 ) ;
if ( V_4 )
...
V_26 = F_91 ( V_55 , & V_120 ) ;
if ( V_26 )
goto V_121;
V_26 = F_91 ( V_55 , & V_122 ) ;
if ( V_26 )
goto V_121;
V_26 = F_92 ( 0 , V_117 ) ;
if ( V_26 < 0 )
