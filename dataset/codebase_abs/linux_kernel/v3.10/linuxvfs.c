...
char * V_48 ;
int V_49 ;
const char * V_50 = V_39 -> V_51 . V_25 -> V_33 . V_32 ;
F_6 ( V_12 , L_16
L_17 ,
V_50 , V_7 -> V_20 , V_39 -> V_52 ) ;
V_43 = F_24 ( V_12 , V_14 , V_39 -> V_52 , V_47 + 1 ,
V_46 , & V_44 , & V_42 ) ;
if ( V_43 == V_53 ) {
F_6 ( V_12 , L_18 ) ;
F_7 ( V_12 , L_19 ,
...
if ( F_12 ( V_12 ) -> V_34 ) {
V_43 =
F_25 ( V_12 , V_46 , V_44 , & V_48 , & V_49 ) ;
if ( V_43 < 0 ) {
F_6 ( V_12 , L_18 ) ;
return V_43 ;
}
V_43 = V_41 ( V_40 , V_48 , V_49 , V_39 -> V_52 ,
( V_38 ) V_42 , V_45 ) ;
F_16 ( V_48 ) ;
} else {
V_43 = V_41 ( V_40 , V_46 , V_44 , V_39 -> V_52 ,
( V_38 ) V_42 , V_45 ) ;
}
if ( ! V_43 )
V_39 -> V_52 ++ ;
F_6 ( V_12 , L_22 , V_39 -> V_52 ) ;
return 0 ;
}
static struct V_7 *
...
{
struct V_7 * V_7 = F_29 ( V_63 , struct V_7 , V_64 ) ;
F_30 ( V_59 , F_5 ( V_7 ) ) ;
}
...
return V_7 ;
V_70 = F_5 ( V_7 ) ;
V_70 -> V_73 = F_36 ( V_12 , V_7 -> V_20 ) ;
F_6 ( V_12 , L_25 ,
V_70 -> V_73 . V_74 ,
V_70 -> V_73 . V_75 , V_70 -> V_73 . V_76 ) ;
V_67 = F_37 ( V_12 , V_7 -> V_20 ) ;
if ( ! V_67 ) {
F_7 ( V_12 , L_26
L_24 , V_7 -> V_20 ) ;
goto V_77;
...
V_68 = ( T_8 * ) V_67 -> V_78 ;
F_38 ( V_12 , V_68 ) ;
if ( F_39 ( V_12 , V_68 , V_7 -> V_20 ) != V_23 ) {
F_7 ( V_12 , L_27 , V_7 -> V_20 ) ;
goto V_79;
}
V_7 -> V_80 = ( V_81 ) F_40 ( V_12 , V_68 -> V_82 ) ;
V_7 -> V_83 = V_69 -> V_84 . V_85 ?
V_69 -> V_84 . V_86 :
F_41 ( & V_87 , F_40 ( V_12 , V_68 -> V_86 ) ) ;
V_7 -> V_88 = V_69 -> V_84 . V_89 ?
V_69 -> V_84 . V_90 :
F_42 ( & V_87 , F_40 ( V_12 , V_68 -> V_90 ) ) ;
F_43 ( V_7 , 1 ) ;
V_7 -> V_91 . V_92 =
F_44 ( V_12 , V_68 -> V_93 ) >> 16 ;
V_7 -> V_91 . V_94 = 0 ;
V_7 -> V_95 = V_7 -> V_91 ;
V_7 -> V_96 = V_7 -> V_91 ;
V_70 -> V_73 = F_45 ( V_12 , V_68 -> V_97 ) ;
V_70 -> V_98 = F_45 ( V_12 , V_68 -> V_99 ) ;
V_70 -> V_100 = F_45 ( V_12 , V_68 -> V_101 ) ;
V_70 -> V_102 = F_40 ( V_12 , V_68 -> V_27 ) ;
if ( F_46 ( V_7 -> V_80 ) && ! ( V_70 -> V_102 & V_103 ) ) {
V_7 -> V_104 = 0 ;
...
int V_111 ;
V_70 -> V_15 . V_14 =
F_47 ( V_12 , & V_68 -> V_109 . V_112 ) ;
V_111 = F_48 ( V_12 , & V_70 -> V_15 . V_14 ) ;
V_7 -> V_105 =
...
if ( F_49 ( V_7 -> V_80 ) ) {
V_7 -> V_117 = & V_118 ;
} else if ( F_50 ( V_7 -> V_80 ) ) {
V_7 -> V_119 = & V_120 ;
V_7 -> V_117 = & V_121 ;
} else if ( F_46 ( V_7 -> V_80 ) ) {
V_7 -> V_119 = & V_122 ;
} else {
F_7 ( V_12 , L_28
L_29
...
static void *
F_60 ( struct V_25 * V_25 , struct V_127 * V_128 )
{
...
F_6 ( V_12 , L_37 ) ;
V_130 = F_61 ( V_76 , V_132 ) ;
if ( ! V_130 ) {
V_130 = F_14 ( - V_126 ) ;
} else if ( F_62 ( V_12 , V_109 , V_130 , V_76 ) != V_76 ) {
F_16 ( V_130 ) ;
F_7 ( V_12 , L_38 ) ;
V_130 = F_14 ( - V_21 ) ;
} else {
...
static void F_64 ( struct V_25 * V_25 , struct V_127 * V_128 , void * V_133 )
{
V_57 * V_70 = F_5 ( V_25 -> V_129 ) ;
if ( V_70 -> V_102 & V_103 ) {
char * V_130 = F_65 ( V_128 ) ;
if ( ! F_19 ( V_130 ) )
F_16 ( V_130 ) ;
}
}
...
if ( V_141 > V_147 )
goto V_146;
V_142 = V_34 -> V_148 ( V_141 , & V_43 [ V_140 ] , V_135 - V_140 ) ;
if ( V_142 < 0 )
goto V_146;
}
V_43 [ V_140 ] = '\0' ;
...
if ( ! V_152 )
return 1 ;
while ( ( V_133 = F_69 ( & V_152 , L_50 ) ) != NULL ) {
int V_160 ;
if ( ! * V_133 )
continue;
V_160 = F_70 ( V_133 , V_161 , args ) ;
switch ( V_160 ) {
case V_162 :
if ( F_71 ( & args [ 0 ] , & V_155 ) )
return 0 ;
V_86 = V_163 ;
if ( V_155 >= 0 )
V_86 = F_41 ( F_72 () , V_155 ) ;
if ( ! F_73 ( V_86 ) ) {
F_56 ( V_125 L_51
L_52 , V_155 ) ;
break;
...
static int
F_78 ( struct V_11 * V_12 , void * V_109 , int V_169 )
{
struct V_8 * V_67 ;
T_9 * V_69 ;
T_16 * V_170 ;
...
F_79 ( V_12 , V_109 ) ;
V_12 -> V_168 = F_61 ( sizeof ( * V_69 ) , V_60 ) ;
if ( V_12 -> V_168 == NULL ) {
F_56 ( V_125
L_58
L_59 , V_12 -> V_174 ) ;
...
#endif
F_81 ( V_12 , 1024 ) ;
if ( ! ( V_67 = F_82 ( V_12 , V_172 ) ) ) {
F_7 ( V_12 , L_63 ) ;
goto V_175;
}
V_170 = ( T_16 * ) V_67 -> V_78 ;
...
F_6 ( V_12 , L_65 ) ;
V_170 =
( T_16 * ) ( ( void * ) V_67 -> V_78 + V_173 ) ;
}
if ( F_83 ( V_12 , V_170 ) != V_23 )
goto V_79;
F_84 ( V_12 , V_170 ) ;
F_51 ( V_67 ) ;
if ( F_85 ( V_12 ) != V_23 )
...
F_6 ( V_12 , L_69 ,
V_69 -> V_84 . V_158 ) ;
V_69 -> V_34 = F_89 ( V_69 -> V_84 . V_158 ) ;
if ( ! V_69 -> V_34 ) {
F_17 ( V_12 , L_70
L_71 ,
V_69 -> V_84 . V_158 ) ;
...
static int
F_91 ( struct V_11 * V_12 , int * V_27 , char * V_109 )
{
if ( ! ( * V_27 & V_177 ) )
return - V_145 ;
return 0 ;
...
static int
F_92 ( struct V_25 * V_25 , struct V_188 * V_189 )
{
struct V_11 * V_12 = V_25 -> V_131 ;
T_18 V_190 = F_93 ( V_12 -> V_191 -> V_192 ) ;
F_6 ( V_12 , L_73 ) ;
V_189 -> V_193 = V_183 ;
...
static struct V_25 *
F_94 ( struct V_206 * V_207 , int V_27 , const char * V_208 ,
void * V_109 )
{
return F_95 ( V_207 , V_27 , V_208 , V_109 , F_78 ) ;
}
static int T_19
F_96 ( void )
{
int V_209 ;
F_56 ( V_210 L_75 , V_211 ) ;
V_209 = F_54 () ;
if ( V_209 )
goto V_77;
V_209 = F_97 ( & V_212 ) ;
