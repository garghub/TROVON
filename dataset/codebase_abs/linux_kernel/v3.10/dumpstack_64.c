...
0 , V_43 ) ;
F_20 ( V_43 L_8 ) ;
V_48 = ( T_1 * ) V_20 -> V_48 - V_44 ;
if ( V_48 < ( T_1 * ) V_49 || F_21 ( V_48 , V_47 ) ) {
V_48 = ( T_1 * ) V_20 -> V_48 ;
V_46 = V_46 - V_44 + 1 ;
}
for ( V_39 = 0 ; V_39 < V_46 ; V_39 ++ , V_48 ++ ) {
if ( V_48 < ( T_1 * ) V_49 ||
F_21 ( V_48 , V_47 ) ) {
F_12 ( L_9 ) ;
break;
}
if ( V_48 == ( T_1 * ) V_20 -> V_48 )
F_12 ( L_10 , V_47 ) ;
else
F_12 ( L_11 , V_47 ) ;
}
...
int F_22 ( unsigned long V_48 )
{
unsigned short V_50 ;
if ( F_23 ( & V_50 , ( const void V_51 * ) V_48 , sizeof( V_50 ) ) )
return 0 ;
return V_50 == 0x0b0f ;
}
