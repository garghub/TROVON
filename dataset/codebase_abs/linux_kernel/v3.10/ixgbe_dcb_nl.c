...
if ( ! V_149 -> V_150 )
F_55 ( V_2 , V_149 -> V_151 ,
V_20 -> V_69 , V_145 ) ;
}
}
return 0 ;
}
static int F_56 ( struct V_46 * V_71 ,
struct V_19 * V_20 )
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
int V_50 ;
...
int V_145 ;
long unsigned int V_144 = F_54 ( V_71 , V_20 ) ;
int V_153 = V_144 ? F_58 ( & V_144 , 8 ) : 0 ;
V_2 -> V_146 = V_153 ;
for ( V_145 = 0 ; V_145 < V_2 -> V_147 ; V_145 ++ ) {
struct V_148 * V_149 = & V_2 -> V_149 [ V_145 ] ;
if ( ! V_149 -> V_150 )
...
static T_1 F_59 ( struct V_46 * V_71 )
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
return V_2 -> V_51 ;
}
static T_1 F_60 ( struct V_46 * V_71 , T_1 V_154 )
{
struct V_1 * V_2 = F_5 ( V_71 ) ;
