...
if ( F_25 ( F_65 ( V_229 , & V_17 -> args . V_25 -> V_33 ) ) )
F_170 ( V_174 , - V_230 ) ;
}
void F_171 ( struct V_173 * V_174 , void * V_228 )
{
struct V_1 * V_17 = V_228 ;
F_73 ( V_17 -> V_43 ) -> F_172 ( V_174 , V_17 ) ;
}
static void F_173 ( struct V_173 * V_174 , void * V_228 )
{
struct V_15 * V_17 = V_228 ;
F_174 ( V_174 , V_17 ) ;
}
static void F_175 ( void * V_228 )
{
struct V_15 * V_17 = V_228 ;
...
void F_174 ( struct V_173 * V_174 , struct V_15 * V_17 )
{
struct V_231 * V_232 = & V_17 -> args ;
struct V_233 * V_234 = & V_17 -> V_179 ;
struct V_43 * V_43 = V_17 -> V_10 -> V_43 ;
int V_145 ;
F_136 ( L_5 ,
V_174 -> V_190 , V_174 -> V_194 ) ;
V_145 = F_73 ( V_43 ) -> F_177 ( V_174 , V_17 ) ;
if ( V_145 != 0 )
return;
F_69 ( V_43 , V_235 , V_234 -> V_47 ) ;
#if F_178 ( V_236 ) || F_178 ( V_237 )
if ( V_234 -> V_14 -> V_116 < V_232 -> V_199 && V_174 -> V_194 >= 0 ) {
static unsigned long V_238 ;
if ( F_179 ( V_238 , V_239 ) ) {
F_136 ( L_6
L_7 ,
F_48 ( V_43 ) -> V_240 -> V_241 ,
V_234 -> V_14 -> V_116 , V_232 -> V_199 ) ;
V_238 = V_239 + 300 * V_242 ;
}
}
#endif
if ( V_174 -> V_194 < 0 )
F_180 ( V_17 -> V_10 , V_174 -> V_194 , V_232 -> V_46 ) ;
else if ( V_234 -> V_47 < V_232 -> V_47 ) {
static unsigned long V_238 ;
F_39 ( V_43 , V_243 ) ;
if ( V_234 -> V_47 == 0 ) {
if ( F_179 ( V_238 , V_239 ) ) {
...
F_180 ( V_17 -> V_10 , - V_230 , V_232 -> V_46 ) ;
V_174 -> V_194 = - V_230 ;
return;
}
if ( V_234 -> V_14 -> V_116 != V_200 ) {
V_17 -> V_196 += V_234 -> V_47 ;
V_232 -> V_46 += V_234 -> V_47 ;
V_232 -> V_197 += V_234 -> V_47 ;
V_232 -> V_47 -= V_234 -> V_47 ;
} else {
V_232 -> V_199 = V_118 ;
}
F_182 ( V_174 ) ;
...
static int F_183 ( struct V_35 * V_36 , int V_245 )
{
int V_65 ;
if ( ! F_176 ( V_246 , & V_36 -> V_33 ) )
return 1 ;
if ( ! V_245 )
return 0 ;
V_65 = F_184 ( & V_36 -> V_33 ,
V_246 ,
V_88 ,
V_89 ) ;
return ( V_65 < 0 ) ? V_65 : 1 ;
}
static void F_185 ( struct V_35 * V_36 )
{
F_92 ( V_246 , & V_36 -> V_33 ) ;
F_83 () ;
F_84 ( & V_36 -> V_33 , V_246 ) ;
}
...
int F_187 ( struct V_168 * V_169 , struct V_1 * V_17 ,
const struct V_170 * V_171 ,
int V_164 , int V_33 )
{
struct V_173 * V_174 ;
...
F_73 ( V_17 -> V_43 ) -> F_188 ( V_17 , & V_176 ) ;
...
void F_189 ( struct V_1 * V_17 ,
struct V_99 * V_202 ,
struct V_113 * V_114 ,
struct V_101 * V_102 )
{
struct V_34 * V_247 = F_117 ( V_202 -> V_121 ) ;
struct V_43 * V_43 = V_247 -> V_96 -> V_97 -> V_98 ;
F_190 ( V_202 , & V_17 -> V_5 ) ;
V_17 -> V_43 = V_43 ;
V_17 -> V_181 = V_247 -> V_96 -> V_181 ;
V_17 -> V_114 = V_114 ;
V_17 -> V_248 = & V_249 ;
...
V_17 -> args . V_46 = 0 ;
V_17 -> args . V_47 = 0 ;
V_17 -> V_25 = F_147 ( V_247 -> V_96 ) ;
V_17 -> V_179 . V_201 = & V_17 -> V_201 ;
V_17 -> V_179 . V_14 = & V_17 -> V_14 ;
F_148 ( & V_17 -> V_201 ) ;
}
void F_191 ( struct V_99 * V_250 ,
struct V_113 * V_114 ,
struct V_101 * V_102 )
{
struct V_34 * V_38 ;
while ( ! F_116 ( V_250 ) ) {
V_38 = F_117 ( V_250 -> V_121 ) ;
F_102 ( V_38 ) ;
...
static int
F_192 ( struct V_43 * V_43 , struct V_99 * V_202 , int V_164 ,
struct V_101 * V_102 )
{
struct V_1 * V_17 ;
V_17 = F_1 () ;
if ( ! V_17 )
goto V_251;
F_189 ( V_17 , V_202 , NULL , V_102 ) ;
F_13 ( & V_102 -> V_103 -> V_252 ) ;
return F_187 ( F_150 ( V_43 ) , V_17 , V_17 -> V_248 ,
V_164 , 0 ) ;
V_251:
F_191 ( V_202 , NULL , V_102 ) ;
V_102 -> V_28 -> V_206 ( F_32 ( V_43 ) ) ;
return - V_218 ;
}
static void F_193 ( struct V_173 * V_174 , void * V_228 )
{
struct V_1 * V_17 = V_228 ;
F_136 ( L_10 ,
V_174 -> V_190 , V_174 -> V_194 ) ;
F_73 ( V_17 -> V_43 ) -> F_194 ( V_174 , V_17 ) ;
}
static void F_195 ( struct V_1 * V_17 )
{
struct V_34 * V_38 ;
int V_145 = V_17 -> V_174 . V_194 ;
struct V_101 V_102 ;
...
F_136 ( L_14 ) ;
F_93 ( V_38 ) ;
F_21 ( V_254 , & V_38 -> V_96 -> V_33 ) ;
V_121:
F_130 ( V_38 ) ;
}
F_105 ( & V_102 , V_17 -> V_43 , V_17 -> V_105 ) ;
if ( F_18 ( & V_102 . V_103 -> V_252 ) )
F_185 ( F_32 ( V_17 -> V_43 ) ) ;
}
static void F_196 ( void * V_228 )
{
struct V_1 * V_17 = V_228 ;
V_17 -> V_28 -> V_29 ( V_17 ) ;
F_186 ( V_228 ) ;
}
int F_197 ( struct V_43 * V_43 , struct V_99 * V_202 ,
int V_164 , struct V_101 * V_102 )
{
int V_145 ;
V_145 = F_198 ( V_43 , V_202 , V_164 , V_102 ) ;
if ( V_145 == V_255 )
V_145 = F_192 ( V_43 , V_202 , V_164 , V_102 ) ;
return V_145 ;
}
int F_199 ( struct V_43 * V_43 , int V_164 )
{
F_200 ( V_202 ) ;
struct V_101 V_102 ;
int V_245 = V_164 & V_193 ;
int V_179 ;
V_179 = F_183 ( F_32 ( V_43 ) , V_245 ) ;
if ( V_179 <= 0 )
goto V_256;
F_103 ( & V_102 , V_43 ) ;
...
if ( V_179 ) {
int error ;
error = F_197 ( V_43 , & V_202 , V_164 , & V_102 ) ;
if ( error < 0 )
return error ;
if ( ! V_245 )
goto V_256;
error = F_201 ( & F_32 ( V_43 ) -> V_33 ,
V_246 ,
V_88 ,
V_89 ) ;
if ( error < 0 )
...
static int F_202 ( struct V_43 * V_43 , struct V_54 * V_55 )
{
struct V_35 * V_36 = F_32 ( V_43 ) ;
int V_33 = V_193 ;
int V_65 = 0 ;
...
int F_203 ( struct V_43 * V_43 , struct V_54 * V_55 )
{
return F_202 ( V_43 , V_55 ) ;
}
int F_204 ( struct V_43 * V_43 )
{
struct V_54 V_55 = {
. V_80 = V_258 ,
. V_257 = V_259 ,
...
return F_205 ( V_43 , & V_55 ) ;
}
int F_206 ( struct V_43 * V_43 , struct V_37 * V_37 )
{
struct V_34 * V_38 ;
int V_65 = 0 ;
for (; ; ) {
...
int F_210 ( struct V_85 * V_83 , struct V_37 * V_264 ,
struct V_37 * V_37 , enum V_265 V_266 )
{
if ( F_23 ( V_37 ) )
return - V_267 ;
if ( ! F_211 ( V_37 , V_20 ) )
return - V_267 ;
return F_212 ( V_83 , V_264 , V_37 , V_266 ) ;
}
int T_4 F_213 ( void )
{
V_268 = F_214 ( L_15 ,
