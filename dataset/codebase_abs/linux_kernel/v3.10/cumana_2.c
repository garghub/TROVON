...
static int F_23 ( struct V_66 * V_67 , struct V_11 * V_12 )
{
struct V_4 * V_5 ;
...
V_5 -> V_2 = V_2 ;
V_5 -> V_8 = V_8 ;
F_4 ( V_12 , V_75 [ V_2 -> V_61 ] ) ;
V_5 -> V_5 . V_27 . V_76 = V_8 + V_77 ;
V_5 -> V_5 . V_27 . V_78 = V_79 ;
V_5 -> V_5 . V_27 . V_18 = V_2 -> V_18 ;
V_5 -> V_5 . V_27 . V_28 = V_2 -> V_28 ;
V_5 -> V_5 . V_80 . V_81 = 40 ;
V_5 -> V_5 . V_80 . V_82 = 255 ;
V_5 -> V_5 . V_80 . V_83 = 200 ;
V_5 -> V_5 . V_80 . V_84 = 7 ;
V_5 -> V_5 . V_80 . V_85 = V_86 | V_87 | V_88 ;
V_5 -> V_5 . V_80 . V_89 = 1 ;
V_5 -> V_5 . V_80 . V_90 = 0 ;
V_5 -> V_5 . V_80 . V_91 = V_92 ;
V_5 -> V_5 . V_28 . V_93 = F_7 ;
V_5 -> V_5 . V_28 . V_94 = F_15 ;
V_5 -> V_5 . V_28 . V_95 = F_20 ;
V_2 -> V_96 = V_5 -> V_8 + V_54 ;
V_2 -> V_97 = V_55 ;
F_33 ( V_2 , & V_98 , V_5 ) ;
V_64 = F_34 ( V_12 ) ;
if ( V_64 )
goto V_99;
V_64 = F_35 ( V_2 -> V_18 , F_5 ,
V_100 , L_9 , V_5 ) ;
if ( V_64 ) {
F_16 ( L_10 ,
V_12 -> V_101 , V_2 -> V_18 , V_64 ) ;
goto V_102;
}
if ( V_5 -> V_5 . V_27 . V_28 != V_30 ) {
if ( F_36 ( V_5 -> V_5 . V_27 . V_28 , L_9 ) ) {
F_16 ( L_11 ,
V_12 -> V_101 , V_5 -> V_5 . V_27 . V_28 ) ;
V_5 -> V_5 . V_27 . V_28 = V_30 ;
} else {
F_37 ( V_5 -> V_5 . V_27 . V_28 , 180 ) ;
V_5 -> V_5 . V_80 . V_91 |= V_103 ;
}
}
V_64 = F_38 ( V_12 , & V_2 -> V_25 ) ;
if ( V_64 == 0 )
goto V_70;
if ( V_5 -> V_5 . V_27 . V_28 != V_30 )
