...
if ( ! V_22 && memcmp ( V_40 -> V_62 , V_40 -> V_42 , V_26 ) )
V_22 = - V_63 ;
}
F_40 ( V_3 , V_22 ) ;
}
...
if ( V_22 )
return V_22 ;
if ( memcmp ( V_64 , V_42 , V_26 ) )
return - V_63 ;
return V_22 ;
}
static int F_54 ( struct V_65 * V_20 )
{
struct V_66 * V_67 = ( void * ) V_20 -> V_68 ;
struct V_69 * V_70 = F_55 ( V_67 ) ;
struct V_15 * V_16 = F_56 ( V_20 ) ;
struct V_19 * V_21 ;
struct V_17 * V_18 ;
unsigned long V_4 ;
int V_22 ;
...
static void F_65 ( struct V_65 * V_20 )
{
struct V_15 * V_16 = F_56 ( V_20 ) ;
F_64 ( V_16 -> V_21 ) ;
F_66 ( V_16 -> V_18 ) ;
}
static struct V_66 * F_67 ( struct V_74 * * V_75 ,
const char * V_76 ,
const char * V_77 ,
const char * V_78 )
{
...
if ( V_21 -> V_86 != 16 )
goto V_87;
V_67 = F_72 ( sizeof( * V_67 ) + sizeof( * V_70 ) , V_88 ) ;
V_22 = - V_89 ;
if ( ! V_67 )
goto V_87;
V_70 = F_55 ( V_67 ) ;
V_22 = F_73 ( & V_70 -> V_21 , V_21 , V_67 ,
V_85 ) ;
if ( V_22 )
goto V_90;
F_74 ( & V_70 -> V_18 , V_67 ) ;
V_22 = F_75 ( & V_70 -> V_18 , V_77 , 0 ,
F_76 ( V_80 -> type ,
V_80 -> V_83 ) ) ;
if ( V_22 )
goto V_91;
...
static struct V_66 * F_83 ( struct V_74 * * V_75 )
{
const char * V_78 ;
char V_77 [ V_98 ] ;
char V_76 [ V_98 ] ;
...
V_98 )
return F_70 ( - V_95 ) ;
return F_67 ( V_75 , V_76 , V_77 , V_78 ) ;
}
static void F_85 ( struct V_66 * V_67 )
{
struct V_69 * V_16 = F_55 ( V_67 ) ;
F_81 ( & V_16 -> V_21 ) ;
F_80 ( & V_16 -> V_18 ) ;
F_82 ( V_67 ) ;
}
static struct V_66 * F_86 ( struct V_74 * * V_75 )
{
const char * V_77 ;
const char * V_78 ;
char V_76 [ V_98 ] ;
...
static int F_87 ( struct V_11 * V_116 , const V_5 * V_13 ,
unsigned int V_14 )
{
...
V_23 ) ;
V_22 = F_89 ( V_118 , V_13 , V_14 ) ;
F_14 ( V_116 , F_12 ( V_118 ) &
V_24 ) ;
return V_22 ;
}
static int F_90 ( struct V_11 * V_116 ,
unsigned int V_26 )
{
struct V_117 * V_16 = F_9 ( V_116 ) ;
switch ( V_26 ) {
...
return F_91 ( V_16 -> V_118 , V_26 ) ;
}
static struct V_2 * F_92 ( struct V_2 * V_3 )
{
struct V_2 * V_120 = F_5 ( V_3 ) ;
struct V_11 * V_12 = F_3 ( V_3 ) ;
struct V_117 * V_16 = F_9 ( V_12 ) ;
struct V_11 * V_118 = V_16 -> V_118 ;
V_5 * V_31 = F_4 ( ( V_5 * ) ( V_120 + 1 ) + F_93 ( V_118 ) ,
F_2 ( V_118 ) + 1 ) ;
V_31 [ 0 ] = 3 ;
memcpy ( V_31 + 1 , V_16 -> V_119 , 3 ) ;
memcpy ( V_31 + 4 , V_3 -> V_31 , 8 ) ;
F_94 ( V_120 , V_118 ) ;
F_95 ( V_120 , V_3 -> V_121 . V_52 , V_3 -> V_121 . V_122 ,
V_3 -> V_121 . V_9 ) ;
F_96 ( V_120 , V_3 -> V_61 , V_3 -> V_58 , V_3 -> V_29 , V_31 ) ;
F_97 ( V_120 , V_3 -> V_55 , V_3 -> V_34 ) ;
return V_120 ;
}
...
{
struct V_66 * V_67 = ( void * ) V_20 -> V_68 ;
struct V_123 * V_124 = F_55 ( V_67 ) ;
struct V_117 * V_16 = F_56 ( V_20 ) ;
struct V_11 * V_12 ;
unsigned long V_4 ;
V_12 = F_103 ( V_124 ) ;
if ( F_58 ( V_12 ) )
...
static void F_105 ( struct V_65 * V_20 )
{
struct V_117 * V_16 = F_56 ( V_20 ) ;
F_106 ( V_16 -> V_118 ) ;
}
static struct V_66 * F_107 ( struct V_74 * * V_75 )
{
struct V_79 * V_80 ;
struct V_66 * V_67 ;
struct V_123 * V_124 ;
...
if ( F_58 ( V_125 ) )
return F_69 ( V_125 ) ;
V_67 = F_72 ( sizeof( * V_67 ) + sizeof( * V_124 ) , V_88 ) ;
if ( ! V_67 )
return F_70 ( - V_89 ) ;
V_124 = F_55 ( V_67 ) ;
F_108 ( V_124 , V_67 ) ;
V_22 = F_109 ( V_124 , V_125 , 0 ,
F_76 ( V_80 -> type , V_80 -> V_83 ) ) ;
if ( V_22 )
goto V_126;
V_96 = F_110 ( V_124 ) ;
V_22 = - V_27 ;
...
V_67 -> V_96 . V_110 = F_102 ;
V_67 -> V_96 . V_111 = F_105 ;
V_67 -> V_96 . V_107 . V_112 = F_87 ;
V_67 -> V_96 . V_107 . V_113 = F_90 ;
V_67 -> V_96 . V_107 . V_114 = F_98 ;
V_67 -> V_96 . V_107 . V_115 = F_100 ;
