...
for ( V_16 = 0 ; V_16 < F_64 ( V_382 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_127 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_383 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_37 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_384 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_385 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_386 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_348 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_387 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_351 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_388 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_389 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_390 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_391 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_392 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_393 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_64 ( V_394 ) ; V_16 ++ )
V_381 |= V_114 -> V_115 -> V_395 [ V_16 ] ;
return ! ! V_381 ;
}
...
list) {
for ( V_16 = 0 ; V_16 < V_20 -> V_23 ; V_16 ++ )
if ( V_20 -> V_24 [ V_16 ] -> V_114 == V_114 )
V_20 -> V_24 [ V_16 ] -> V_114 = NULL ;
}
}
F_27 ( V_114 ) ;
}
int F_67 ( struct V_12 * V_5 , unsigned int V_397 )
{
struct V_362 * V_363 = V_5 -> V_121 ;
struct V_19 * V_20 ;
...
F_68 ( & V_5 -> V_380 ) ;
if ( ! V_397 ) {
for ( V_16 = 0 ; V_16 < V_5 -> V_398 ; V_16 ++ ) {
struct V_399 * V_400 = & V_5 -> V_401 [ V_16 ] ;
if ( V_400 -> type == V_402 ||
V_400 -> type == V_403 )
if ( F_69 ( V_400 -> V_2 ) )
break;
