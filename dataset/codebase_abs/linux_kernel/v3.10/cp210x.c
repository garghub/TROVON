...
F_9 ( & V_2 -> V_15 , L_33 , V_16 , V_78 ) ;
return F_10 ( V_2 , V_85 , & V_78 , 2 ) ;
}
static void F_28 ( struct V_1 * V_86 , int V_87 )
{
if ( V_87 )
F_27 ( V_86 , V_82 | V_79 , 0 ) ;
else
F_27 ( V_86 , 0 , V_82 | V_79 ) ;
}
...
int V_11 ;
F_1 ( V_2 , V_88 , & V_78 , 1 ) ;
V_11 = ( ( V_78 & V_83 ) ? V_82 : 0 )
| ( ( V_78 & V_80 ) ? V_79 : 0 )
| ( ( V_78 & V_89 ) ? V_90 : 0 )
| ( ( V_78 & V_91 ) ? V_92 : 0 )
| ( ( V_78 & V_93 ) ? V_94 : 0 )
| ( ( V_78 & V_95 ) ? V_96 : 0 ) ;
F_9 ( & V_2 -> V_15 , L_34 , V_16 , V_78 ) ;
return V_11 ;
}
static void F_30 ( struct V_25 * V_26 , int V_97 )
{
struct V_1 * V_2 = V_26 -> V_30 ;
unsigned int V_98 ;
if ( V_97 == 0 )
...
if ( ! V_9 )
return - V_17 ;
V_103 = V_7 -> V_104 -> V_103 ;
V_9 -> V_19 = V_103 -> V_105 . V_19 ;
F_34 ( V_7 , V_9 ) ;
return 0 ;
}
