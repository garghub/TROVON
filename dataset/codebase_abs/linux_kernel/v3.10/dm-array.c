...
static int F_33 ( struct V_16 * V_17 , T_1 V_5 ,
T_2 V_10 ,
...
V_32 = F_33 ( V_17 , V_5 , V_10 , V_43 , V_10 , V_36 , V_38 ) ;
return V_32 ;
}
static int F_35 ( struct V_45 * V_45 , unsigned V_46 ,
unsigned V_47 )
{
int V_32 ;
while ( V_46 != V_47 ) {
T_4 V_39 = V_46 ++ ;
V_32 = F_36 ( & V_45 -> V_17 -> V_33 , V_45 -> V_38 ,
& V_39 , & V_45 -> V_38 ) ;
if ( V_32 )
return V_32 ;
}
...
static unsigned F_37 ( unsigned V_48 ,
unsigned V_49 )
{
...
static int F_39 ( struct V_45 * V_45 , T_2 V_56 )
{
int V_32 ;
struct V_3 * V_31 ;
struct V_6 * V_18 ;
...
{
return F_33 ( V_45 -> V_17 , V_45 -> V_5 ,
V_45 -> V_10 ,
V_45 -> V_52 ,
V_45 -> V_54 ,
V_45 -> V_36 , & V_45 -> V_38 ) ;
...
int V_32 ;
if ( V_45 -> V_55 > 0 ) {
V_32 = F_39 ( V_45 , V_45 -> V_10 ) ;
if ( V_32 )
return V_32 ;
}
V_32 = F_34 ( V_45 -> V_17 , V_45 -> V_5 ,
V_45 -> V_53 ,
V_45 -> V_52 ,
V_45 -> V_10 , V_45 -> V_36 ,
& V_45 -> V_38 ) ;
...
return F_39 ( V_45 , V_45 -> V_54 ) ;
else
return F_40 ( V_45 ) ;
}
static void F_43 ( void * V_25 , const void * V_36 )
{
T_5 V_40 ;
struct V_16 * V_17 = V_25 ;
memcpy ( & V_40 , V_36 , sizeof( V_40 ) ) ;
F_44 ( V_17 -> V_33 . V_34 , F_8 ( V_40 ) ) ;
}
...
memcpy ( & V_40 , V_36 , sizeof( V_40 ) ) ;
V_4 = F_8 ( V_40 ) ;
V_32 = F_46 ( V_17 -> V_33 . V_34 , V_4 , & V_57 ) ;
if ( V_32 ) {
F_9 ( L_3 ,
...
static int F_48 ( void * V_25 , const void * V_58 , const void * V_59 )
{
return ! memcmp ( V_58 , V_59 , sizeof( T_5 ) ) ;
}
void F_49 ( struct V_16 * V_17 ,
struct V_60 * V_34 ,
struct V_26 * V_27 )
{
struct V_26 * V_61 = & V_17 -> V_33 . V_21 ;
memcpy ( & V_17 -> V_21 , V_27 , sizeof( V_17 -> V_21 ) ) ;
V_17 -> V_33 . V_34 = V_34 ;
V_17 -> V_33 . V_62 = 1 ;
V_61 -> V_25 = V_17 ;
V_61 -> V_22 = sizeof( T_5 ) ;
V_61 -> V_28 = F_43 ;
V_61 -> V_29 = F_45 ;
V_61 -> V_63 = F_48 ;
}
...
V_45 . V_5 ) ;
V_45 . V_53 = V_64 / V_45 . V_10 ;
V_45 . V_55 = V_64 % V_45 . V_10 ;
V_45 . V_52 = V_65 / V_45 . V_10 ;
V_45 . V_54 = V_65 % V_45 . V_10 ;
V_45 . V_36 = V_36 ;
V_32 = ( ( V_65 > V_64 ) ? F_42 : F_38 ) ( & V_45 ) ;
if ( V_32 )
return V_32 ;
* V_66 = V_45 . V_38 ;
return 0 ;
...
{
int V_32 = F_52 ( V_17 , V_38 , V_64 , V_65 , V_36 , V_66 ) ;
F_56 ( V_36 ) ;
return V_32 ;
}
...
memcpy ( V_67 , F_11 ( V_17 , V_18 , V_20 ) ,
V_17 -> V_21 . V_22 ) ;
F_24 ( V_17 , V_31 ) ;
return V_32 ;
}
static int F_60 ( struct V_16 * V_17 , T_3 V_38 ,
T_2 V_19 , const void * V_36 , T_3 * V_66 )
{
int V_32 ;
struct V_3 * V_31 ;
struct V_6 * V_18 ;
...
V_69 = F_11 ( V_17 , V_18 , V_20 ) ;
if ( V_27 -> V_29 &&
( ! V_27 -> V_63 || ! V_27 -> V_63 ( V_27 -> V_25 , V_69 , V_36 ) ) ) {
V_27 -> V_29 ( V_27 -> V_25 , V_69 ) ;
if ( V_27 -> V_28 )
V_27 -> V_28 ( V_27 -> V_25 , V_36 ) ;
}
memcpy ( V_69 , V_36 , V_17 -> V_21 . V_22 ) ;
V_70:
F_24 ( V_17 , V_31 ) ;
return V_32 ;
}
...
{
int V_32 ;
V_32 = F_60 ( V_17 , V_38 , V_19 , V_36 , V_66 ) ;
F_56 ( V_36 ) ;
return V_32 ;
}
static int F_62 ( void * V_25 , T_4 * V_71 , void * V_72 )
{
...
struct V_3 * V_31 ;
struct V_6 * V_18 ;
memcpy ( & V_40 , V_72 , sizeof( V_40 ) ) ;
V_32 = F_22 ( V_74 -> V_17 , F_8 ( V_40 ) , & V_31 , & V_18 ) ;
if ( V_32 )
return V_32 ;
V_10 = F_10 ( V_18 -> V_10 ) ;
V_24 = F_10 ( V_18 -> V_24 ) ;
for ( V_23 = 0 ; V_23 < V_24 ; V_23 ++ ) {
V_32 = V_74 -> F_13 ( V_74 -> V_25 , V_71 [ 0 ] * V_10 + V_23 ,
F_11 ( V_74 -> V_17 , V_18 , V_23 ) ) ;
if ( V_32 )
break;
}
F_24 ( V_74 -> V_17 , V_31 ) ;
...
int (* F_13)( void * , T_4 V_39 , void * V_72 ) ,
void * V_25 )
{
struct V_73 V_74 ;
V_74 . V_17 = V_17 ;
V_74 . F_13 = F_13 ;
V_74 . V_25 = V_25 ;
return F_64 ( & V_17 -> V_33 , V_38 , F_62 , & V_74 ) ;
}
