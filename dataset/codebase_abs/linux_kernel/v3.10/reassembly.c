...
struct V_45 * V_46 ;
struct V_14 * V_15 ;
const struct V_1 * V_97 = F_27 ( V_44 ) ;
struct V_24 * V_24 = F_24 ( F_25 ( V_44 ) -> V_28 ) ;
int V_98 ;
F_16 ( V_24 , F_28 ( F_25 ( V_44 ) ) , V_99 ) ;
if ( V_97 -> V_54 == 0 )
goto V_100;
...
V_98 = F_69 ( & V_24 -> V_42 . V_26 , & V_16 , false ) ;
if ( V_98 )
F_70 ( V_24 , F_28 ( F_25 ( V_44 ) ) ,
V_36 , V_98 ) ;
V_15 = F_71 ( V_24 , V_46 -> V_102 , & V_97 -> V_6 , & V_97 -> V_7 ,
F_1 ( V_97 ) ) ;
if ( V_15 != NULL ) {
int V_103 ;
F_12 ( & V_15 -> V_13 . V_29 ) ;
V_103 = F_23 ( V_15 , V_44 , V_46 , F_63 ( V_44 ) -> V_47 ) ;
F_20 ( & V_15 -> V_13 . V_29 ) ;
F_21 ( & V_15 -> V_13 , & V_16 ) ;
return V_103 ;
}
...
V_105 = V_107 ;
if ( ! F_73 ( V_24 , & V_108 ) ) {
V_105 = F_74 ( V_105 , sizeof( V_107 ) , V_109 ) ;
if ( V_105 == NULL )
goto V_110;
V_105 [ 0 ] . V_41 = & V_24 -> V_42 . V_26 . V_111 ;
V_105 [ 1 ] . V_41 = & V_24 -> V_42 . V_26 . V_112 ;
V_105 [ 2 ] . V_41 = & V_24 -> V_42 . V_26 . V_113 ;
if ( V_24 -> V_114 != & V_115 )
V_105 [ 0 ] . V_116 = NULL ;
}
V_97 = F_75 ( V_24 , L_3 , V_105 ) ;
if ( V_97 == NULL )
goto V_117;
V_24 -> V_42 . V_118 . V_119 = V_97 ;
return 0 ;
V_117:
if ( ! F_73 ( V_24 , & V_108 ) )
F_76 ( V_105 ) ;
...
{
struct V_104 * V_105 ;
V_105 = V_24 -> V_42 . V_118 . V_119 -> V_121 ;
F_78 ( V_24 -> V_42 . V_118 . V_119 ) ;
if ( ! F_73 ( V_24 , & V_108 ) )
F_76 ( V_105 ) ;
}
static int F_79 ( void )
{
V_122 = F_75 ( & V_108 , L_3 ,
V_123 ) ;
return V_122 == NULL ? - V_120 : 0 ;
}
...
{
V_24 -> V_42 . V_26 . V_111 = V_124 ;
V_24 -> V_42 . V_26 . V_112 = V_125 ;
...
V_16 . V_134 = NULL ;
V_16 . V_135 = NULL ;
V_16 . V_136 = sizeof( struct V_14 ) ;
V_16 . V_137 = F_8 ;
V_16 . V_138 = F_22 ;
V_16 . V_139 = 10 * 60 * V_140 ;
F_88 ( & V_16 ) ;
V_32:
return V_103 ;
V_131:
