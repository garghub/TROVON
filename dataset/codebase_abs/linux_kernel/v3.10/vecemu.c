...
V_21 [ V_20 ] . V_29 [ V_16 ] = F_1 ( V_21 [ V_18 ] . V_29 [ V_16 ] ) ;
break;
case 7 :
for ( V_16 = 0 ; V_16 < 4 ; ++ V_16 )
V_21 [ V_20 ] . V_29 [ V_16 ] = F_2 ( V_21 [ V_18 ] . V_29 [ V_16 ] ) ;
break;
case 8 :
for ( V_16 = 0 ; V_16 < 4 ; ++ V_16 )
V_21 [ V_20 ] . V_29 [ V_16 ] = F_7 ( V_21 [ V_18 ] . V_29 [ V_16 ] ) ;
break;
case 9 :
for ( V_16 = 0 ; V_16 < 4 ; ++ V_16 )
V_21 [ V_20 ] . V_29 [ V_16 ] = F_5 ( V_21 [ V_18 ] . V_29 [ V_16 ] ) ;
break;
case 10 :
for ( V_16 = 0 ; V_16 < 4 ; ++ V_16 ) {
T_2 V_7 = V_21 [ V_18 ] . V_29 [ V_16 ] ;
V_7 = ( V_7 & 0x80000000 ) ? F_5 ( V_7 ) : F_6 ( V_7 ) ;
V_21 [ V_20 ] . V_29 [ V_16 ] = V_7 ;
}
break;
case 11 :
for ( V_16 = 0 ; V_16 < 4 ; ++ V_16 ) {
...
case 14 :
for ( V_16 = 0 ; V_16 < 4 ; ++ V_16 )
V_21 [ V_20 ] . V_29 [ V_16 ] = F_4 ( V_21 [ V_18 ] . V_29 [ V_16 ] , V_17 ,
& V_26 -> V_27 . V_30 . V_29 [ 3 ] ) ;
break;
case 15 :
for ( V_16 = 0 ; V_16 < 4 ; ++ V_16 )
V_21 [ V_20 ] . V_29 [ V_16 ] = F_3 ( V_21 [ V_18 ] . V_29 [ V_16 ] , V_17 ,
& V_26 -> V_27 . V_30 . V_29 [ 3 ] ) ;
break;
default:
return - V_25 ;
