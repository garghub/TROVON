...
V_2 -> V_45 = F_28 ( & V_109 -> V_13 , sizeof( struct V_124 ) ,
V_116 ) ;
if ( ! V_2 -> V_45 ) {
F_3 ( & V_109 -> V_13 , L_35 ) ;
V_4 = - V_117 ;
...
V_2 -> V_45 -> V_126 = V_127 ;
V_4 = F_34 ( V_2 -> V_45 , NULL ) ;
if ( V_4 ) {
F_3 ( & V_109 -> V_13 , L_36 ) ;
goto V_121;
}
...
F_1 ( V_2 , V_7 ) ;
F_37 ( & V_2 -> V_107 , F_23 ) ;
F_38 ( & V_2 -> V_107 , V_115 ) ;
return 0 ;
V_121:
while ( -- V_90 >= 0 )
F_39 ( V_92 [ V_90 ] . V_94 , V_2 ) ;
return V_4 ;
}
static int F_40 ( struct V_108 * V_109 )
{
struct V_1 * V_2 = F_41 ( V_109 ) ;
int V_90 ;
for ( V_90 = 0 ; V_90 < F_16 ( V_92 ) ; V_90 ++ )
F_39 ( V_92 [ V_90 ] . V_94 , V_2 ) ;
F_42 ( & V_2 -> V_88 ) ;
