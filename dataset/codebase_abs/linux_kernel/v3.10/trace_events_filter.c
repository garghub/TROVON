...
static int F_36 ( struct V_83 * V_84 , int V_60 )
{
V_84 -> V_28 = F_37 ( V_60 + 1 , sizeof( * V_84 -> V_28 ) , V_67 ) ;
if ( ! V_84 -> V_28 )
return - V_68 ;
V_84 -> V_29 = V_60 ;
return 0 ;
...
static int F_39 ( struct V_83 * V_84 ,
struct V_1 * V_2 )
{
int V_29 = V_84 -> V_29 ;
if ( F_19 ( V_29 == 0 ) )
...
static struct V_58 * F_46 ( void )
{
struct V_58 * V_59 ;
V_59 = F_47 ( sizeof( * V_59 ) , V_67 ) ;
return V_59 ;
}
static int F_48 ( struct V_58 * V_59 , int V_60 )
{
struct V_1 * V_2 ;
int V_22 ;
if ( V_59 -> V_28 )
F_42 ( V_59 ) ;
V_59 -> V_28 = F_37 ( V_60 , sizeof( * V_59 -> V_28 ) , V_67 ) ;
if ( ! V_59 -> V_28 )
return - V_68 ;
V_59 -> V_91 = V_60 ;
V_59 -> V_60 = 0 ;
...
static void F_49 ( struct V_81 * system )
{
struct V_76 * V_77 ;
F_50 (call, &ftrace_events, list) {
...
static void F_51 ( struct V_81 * system )
{
struct V_76 * V_77 ;
F_50 (call, &ftrace_events, list) {
if ( strcmp ( V_77 -> V_94 -> system , system -> V_95 ) != 0 )
...
V_42 = F_41 ( V_59 , V_59 -> V_60 , V_84 , V_2 ) ;
if ( V_42 )
return V_42 ;
V_59 -> V_60 ++ ;
return 0 ;
}
int F_53 ( const char * type )
{
...
static bool F_54 ( struct V_100 * V_101 )
{
...
static int F_56 ( struct V_100 * V_101 , int V_26 )
{
if ( F_55 ( V_101 ) &&
( V_26 != V_105 && V_26 != V_106 && V_26 != V_27 ) )
return 0 ;
if ( ! F_55 ( V_101 ) && V_26 == V_27 )
return 0 ;
return 1 ;
}
static T_3 F_57 ( int V_26 , int V_107 ,
int V_108 )
{
T_3 V_54 = NULL ;
switch ( V_107 ) {
...
V_2 -> V_52 = V_52 ;
V_54 = F_57 ( V_2 -> V_26 , V_101 -> V_122 ,
V_101 -> V_124 ) ;
if ( ! V_54 ) {
F_20 ( V_62 , V_126 , 0 ) ;
return - V_41 ;
...
static char F_63 ( struct V_61 * V_62 )
{
V_62 -> V_129 . V_130 -- ;
...
static inline int F_66 ( struct V_61 * V_62 ,
int V_134 , int V_135 )
{
return V_62 -> V_53 [ V_134 ] . V_136 < V_62 -> V_53 [ V_135 ] . V_136 ;
}
static inline int F_67 ( struct V_61 * V_62 , char V_137 )
{
int V_22 ;
...
static int F_68 ( struct V_61 * V_62 , char V_138 )
{
char V_139 = F_64 ( V_62 ) ;
char V_140 [ 3 ] ;
int V_22 ;
V_140 [ 0 ] = V_138 ;
V_140 [ 1 ] = V_139 ;
...
static inline void F_69 ( struct V_61 * V_62 )
{
memset ( V_62 -> V_143 . string , '\0' , V_144 ) ;
V_62 -> V_143 . V_133 = 0 ;
}
static inline int F_70 ( struct V_61 * V_62 , char V_137 )
{
...
static int F_71 ( struct V_61 * V_62 , int V_26 )
{
struct V_145 * V_145 ;
...
return - V_68 ;
V_145 -> V_26 = V_26 ;
F_72 ( & V_145 -> V_146 , & V_62 -> V_131 ) ;
return 0 ;
}
static int F_73 ( struct V_61 * V_62 )
{
return F_74 ( & V_62 -> V_131 ) ;
}
static int F_75 ( struct V_61 * V_62 )
{
struct V_145 * V_145 ;
if ( F_73 ( V_62 ) )
return V_142 ;
V_145 = F_76 ( & V_62 -> V_131 , struct V_145 , V_146 ) ;
return V_145 -> V_26 ;
}
...
static void F_79 ( struct V_61 * V_62 )
{
while ( ! F_73 ( V_62 ) )
F_77 ( V_62 ) ;
}
static char * F_80 ( struct V_61 * V_62 )
{
return V_62 -> V_143 . string ;
}
static int F_81 ( struct V_61 * V_62 , char * V_143 )
{
struct V_147 * V_148 ;
...
F_82 ( & V_148 -> V_146 , & V_62 -> V_132 ) ;
return 0 ;
}
static int F_83 ( struct V_61 * V_62 , int V_26 )
{
struct V_147 * V_148 ;
V_148 = F_27 ( sizeof( * V_148 ) , V_67 ) ;
if ( ! V_148 )
...
{
struct V_147 * V_148 ;
while ( ! F_74 ( & V_62 -> V_132 ) ) {
V_148 = F_76 ( & V_62 -> V_132 , struct V_147 , V_146 ) ;
F_78 ( & V_148 -> V_146 ) ;
F_22 ( V_148 -> V_143 ) ;
F_22 ( V_148 ) ;
}
...
static struct V_1 * F_86 ( struct V_61 * V_62 ,
struct V_76 * V_77 ,
...
V_2 . V_101 = V_101 ;
return F_58 ( V_62 , V_101 , & V_2 ) ? NULL : & V_2 ;
}
static int F_88 ( struct V_61 * V_62 )
{
int V_160 = 0 , V_161 = 0 ;
struct V_147 * V_148 ;
F_50 (elt, &ps->postfix, list) {
if ( V_148 -> V_26 == V_142 )
continue;
...
static int F_90 ( enum V_30 V_31 , struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
...
static int F_91 ( struct V_58 * V_59 ,
struct V_1 * V_36 )
{
struct V_163 V_38 = {
. V_165 = 3 * V_59 -> V_60 ,
...
static int F_93 ( struct V_1 * V_28 , struct V_1 * V_36 )
{
int V_164 = 0 , V_43 ;
V_43 = F_13 ( V_28 , V_36 , F_92 , & V_164 ) ;
F_19 ( V_43 ) ;
return V_164 ;
}
...
if ( V_36 -> V_47 == V_48 )
return 0 ;
V_167 = F_93 ( V_28 , & V_28 [ V_36 -> V_47 ] ) ;
V_167 += F_93 ( V_28 , & V_28 [ V_36 -> V_49 ] ) ;
V_36 -> V_53 = F_37 ( V_167 , sizeof( * V_36 -> V_53 ) , V_67 ) ;
if ( ! V_36 -> V_53 )
return - V_68 ;
V_36 -> V_52 = V_167 ;
V_38 . V_167 = V_167 ;
return F_13 ( V_28 , V_36 , F_94 , & V_38 ) ;
}
...
struct V_1 * V_36 )
{
return F_13 ( V_59 -> V_28 , V_36 , F_96 ,
V_59 -> V_28 ) ;
}
...
V_2 = F_86 ( V_62 , V_77 , V_148 -> V_26 , V_156 , V_157 ) ;
if ( ! V_2 ) {
V_42 = - V_41 ;
goto V_170;
}
if ( ! V_168 ) {
V_42 = F_52 ( V_62 , V_59 , V_2 , & V_84 ) ;
if ( V_42 )
goto V_170;
}
V_156 = V_157 = NULL ;
...
static int F_100 ( struct V_81 * system ,
struct V_61 * V_62 ,
char * V_66 )
{
struct V_76 * V_77 ;
...
if ( strcmp ( V_77 -> V_94 -> system , system -> V_95 ) != 0 )
continue;
V_42 = F_98 ( V_77 , NULL , V_62 , V_66 , true ) ;
if ( V_42 )
V_77 -> V_92 |= V_175 ;
else
V_77 -> V_92 &= ~ V_175 ;
...
if ( V_77 -> V_92 & V_175 )
continue;
V_173 = F_47 ( sizeof( * V_173 ) , V_67 ) ;
if ( ! V_173 )
goto V_176;
F_82 ( & V_173 -> V_146 , & V_172 ) ;
V_173 -> V_59 = F_46 () ;
if ( ! V_173 -> V_59 )
goto V_176;
V_59 = V_173 -> V_59 ;
...
if ( V_42 )
goto V_176;
V_42 = F_98 ( V_77 , V_59 , V_62 , V_66 , false ) ;
if ( V_42 ) {
F_43 ( V_77 ) ;
F_20 ( V_62 , V_177 , 0 ) ;
F_28 ( V_62 , V_59 ) ;
...
goto V_170;
F_103 () ;
F_104 (filter_item, tmp, &filter_list, list) {
F_44 ( V_173 -> V_59 ) ;
F_78 ( & V_173 -> V_146 ) ;
F_22 ( V_173 ) ;
}
...
static int F_105 ( char * V_178 , bool V_179 ,
struct V_61 * * V_180 ,
struct V_58 * * V_181 )
{
struct V_58 * V_59 ;
...
struct V_61 * V_62 = NULL ;
int V_42 ;
V_42 = F_105 ( V_178 , V_179 , & V_62 , & V_59 ) ;
if ( ! V_42 ) {
V_42 = F_98 ( V_77 , V_59 , V_62 , V_178 , false ) ;
if ( V_42 && V_179 )
F_28 ( V_62 , V_59 ) ;
}
F_106 ( V_62 ) ;
...
static int F_108 ( struct V_81 * system ,
char * V_178 , struct V_58 * * V_181 )
{
struct V_58 * V_59 = NULL ;
struct V_61 * V_62 = NULL ;
int V_42 ;
V_42 = F_105 ( V_178 , true , & V_62 , & V_59 ) ;
if ( ! V_42 ) {
V_42 = F_100 ( system , V_62 , V_178 ) ;
if ( ! V_42 ) {
F_22 ( V_59 -> V_66 ) ;
V_59 -> V_66 = NULL ;
} else {
...
int F_109 ( struct V_76 * V_77 , char * V_66 )
{
struct V_58 * V_59 ;
int V_42 = 0 ;
F_32 ( & V_80 ) ;
if ( ! strcmp ( F_110 ( V_66 ) , L_9 ) ) {
F_43 ( V_77 ) ;
V_59 = V_77 -> V_59 ;
if ( ! V_59 )
goto V_183;
...
V_42 = F_107 ( V_77 , V_66 , true , & V_59 ) ;
if ( V_59 ) {
...
int F_112 ( struct V_184 * V_185 ,
char * V_66 )
{
struct V_81 * system = V_185 -> V_186 ;
struct V_58 * V_59 ;
int V_42 = 0 ;
F_32 ( & V_80 ) ;
if ( ! V_185 -> V_187 ) {
...
static char * *
F_114 ( char * V_71 , int V_11 , int * V_164 )
{
char * V_15 , * V_190 , * * V_191 ;
V_15 = F_115 ( V_71 , V_11 , V_67 ) ;
if ( ! V_15 )
return NULL ;
while ( ( V_190 = strchr ( V_15 , ',' ) ) )
* V_190 = ' ' ;
V_191 = F_116 ( V_67 , V_15 , V_164 ) ;
F_22 ( V_15 ) ;
return V_191 ;
}
static int F_117 ( struct V_192 * V_53 , int V_59 ,
int V_193 , char * V_191 , int V_11 )
{
int V_43 ;
if ( V_59 )
V_43 = F_118 ( V_53 , V_191 , V_11 , V_193 ) ;
else
V_43 = F_119 ( V_53 , V_191 , V_11 , V_193 ) ;
return V_43 ;
}
static int F_120 ( int V_59 , char * V_71 , int V_11 ,
struct V_194 * V_38 )
{
...
V_191 = F_114 ( V_71 , V_11 , & V_195 ) ;
if ( ! V_191 )
return - V_41 ;
for ( V_22 = 0 ; V_22 < V_195 ; V_22 ++ ) {
V_43 = F_117 ( V_38 -> V_53 , V_59 , * V_193 ,
...
static int F_122 ( struct V_1 * V_2 , int V_198 )
{
...
static int F_123 ( enum V_30 V_31 ,
struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
if ( ( V_31 != V_39 ) ||
...
static int F_124 ( struct V_189 * V_3 ,
struct V_58 * V_59 )
{
struct V_194 V_38 = {
. V_196 = 1 ,
...
int F_125 ( struct V_189 * V_3 , int V_199 ,
char * V_178 )
{
int V_42 ;
struct V_58 * V_59 ;
...
if ( V_3 -> V_59 )
goto V_183;
V_42 = F_107 ( V_77 , V_178 , false , & V_59 ) ;
if ( V_42 )
goto V_202;
if ( F_126 ( V_77 ) )
V_42 = F_124 ( V_3 , V_59 ) ;
...
static int F_127 ( struct V_1 * V_2 , void * V_3 )
{
struct V_100 * V_101 = V_2 -> V_101 ;
V_203 = 1 ;
F_128 ( V_204 L_10 , V_101 -> V_95 ) ;
return 1 ;
}
static int F_129 ( enum V_30 V_31 , struct V_1 * V_2 ,
int * V_42 , void * V_38 )
{
char * V_205 = V_38 ;
if ( ( V_31 == V_39 ) &&
