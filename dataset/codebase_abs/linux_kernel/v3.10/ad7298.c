...
struct V_4 * V_5 ;
struct V_1 * V_2 = F_28 ( sizeof( * V_5 ) ) ;
int V_34 ;
if ( V_2 == NULL )
return - V_69 ;
V_5 = F_2 ( V_2 ) ;
...
F_33 ( V_26 , V_2 ) ;
V_5 -> V_26 = V_26 ;
V_2 -> V_73 = F_34 ( V_26 ) -> V_73 ;
V_2 -> V_67 . V_74 = & V_26 -> V_67 ;
V_2 -> V_75 = V_76 ;
V_2 -> V_77 = V_78 ;
V_2 -> V_79 = F_35 ( V_78 ) ;
V_2 -> V_80 = & V_81 ;
V_5 -> V_82 [ 0 ] . V_14 = & V_5 -> V_14 [ 0 ] ;
V_5 -> V_82 [ 0 ] . V_16 = 2 ;
V_5 -> V_82 [ 0 ] . V_17 = 1 ;
V_5 -> V_82 [ 1 ] . V_14 = & V_5 -> V_14 [ 1 ] ;
V_5 -> V_82 [ 1 ] . V_16 = 2 ;
V_5 -> V_82 [ 1 ] . V_17 = 1 ;
V_5 -> V_82 [ 2 ] . V_19 = & V_5 -> V_19 [ 0 ] ;
V_5 -> V_82 [ 2 ] . V_16 = 2 ;
F_7 ( & V_5 -> V_35 ) ;
F_8 ( & V_5 -> V_82 [ 0 ] , & V_5 -> V_35 ) ;
F_8 ( & V_5 -> V_82 [ 1 ] , & V_5 -> V_35 ) ;
F_8 ( & V_5 -> V_82 [ 2 ] , & V_5 -> V_35 ) ;
V_34 = F_36 ( V_2 , NULL ,
& F_9 , NULL ) ;
if ( V_34 )
goto V_83;
...
static int F_42 ( struct V_64 * V_26 )
{
struct V_1 * V_2 = F_43 ( V_26 ) ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
F_44 ( V_2 ) ;
F_38 ( V_2 ) ;
if ( V_5 -> V_12 ) {
