...
for ( V_20 = 0 ; V_20 < F_18 ( V_24 ) ; V_20 ++ ) {
if ( ! V_16 -> V_29 [ V_20 ] )
continue;
V_19 = F_19 ( & V_14 -> V_17 , - 1 , & V_24 [ V_20 ] , 1 , NULL ,
V_16 -> V_29 [ V_20 ] , NULL ) ;
if ( V_19 )
goto V_31;
}
V_19 = F_19 ( & V_14 -> V_17 , 0 , V_32 ,
F_18 ( V_32 ) , NULL , 0 , NULL ) ;
if ( V_19 )
goto V_31;
return 0 ;
V_31:
...
if ( F_23 ( V_35 ) != F_23 ( V_36 ) ) {
F_16 ( & V_14 -> V_17 , L_7 , V_35 , V_36 ) ;
return - V_38 ;
}
V_9 = F_24 ( & V_14 -> V_17 , sizeof( * V_9 ) , V_40 ) ;
if ( ! V_9 )
return - V_41 ;
V_9 -> V_42 = F_23 ( V_35 ) ;
V_9 -> V_43 = F_25 ( V_35 ) ;
V_9 -> V_14 = V_14 ;
V_34 = F_26 ( V_14 , V_44 , 0 ) ;
V_9 -> V_12 = F_27 ( & V_14 -> V_17 , V_34 ) ;
if ( F_28 ( V_9 -> V_12 ) )
return F_29 ( V_9 -> V_12 ) ;
F_30 ( V_14 , V_9 ) ;
V_19 = F_14 ( V_9 ) ;
if ( V_19 ) {
F_16 ( & V_14 -> V_17 , L_8 ) ;
...
F_31 ( & V_14 -> V_17 , L_9 ,
F_32 ( V_9 -> V_43 ) , F_33 ( V_9 -> V_43 ) ,
V_9 -> V_42 ) ;
return 0 ;
}
static int F_34 ( struct V_13 * V_14 )
{
struct V_8 * V_9 = F_35 ( V_14 ) ;
F_21 ( V_9 ) ;
F_30 ( V_14 , NULL ) ;
return 0 ;
}
