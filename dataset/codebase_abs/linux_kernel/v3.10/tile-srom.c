...
V_17 = F_34 ( 4 * sizeof( struct V_18 ) , V_26 ) ;
for ( V_57 = 0 ; ; V_57 ++ ) {
int V_49 ;
char V_2 [ 20 ] ;
struct V_18 * V_58 =
F_35 ( V_17 , ( V_57 + 1 ) * sizeof( struct V_18 ) ,
V_26 | V_59 ) ;
if ( ! V_58 ) {
V_56 = - V_27 ;
goto V_60;
...
if ( V_55 )
V_56 = F_38 ( V_40 , V_62 , L_8 ) ;
else {
V_56 = F_39 ( & V_40 , 0 , V_62 , L_8 ) ;
V_55 = F_40 ( V_40 ) ;
}
if ( V_56 < 0 )
goto V_60;
