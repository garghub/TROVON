...
V_108 = F_59 ( ( V_112 * ) & V_105 -> V_113 [ V_114 ] ) ;
if ( V_108 >= V_105 -> V_88 ) {
...
F_31 ( L_20 , V_72 ) ;
F_62 ( & V_12 -> V_125 ) ;
V_123 = F_49 ( V_3 -> V_10 , V_82 , V_3 -> V_23 , V_29 ,
V_84 , V_12 -> V_68 ) ;
F_53 ( V_3 -> V_6 , V_12 -> V_15 , V_12 -> V_126 ,
V_3 -> V_10 , V_123 ,
F_38 , V_3 ) ;
if ( V_3 -> V_24 )
...
case V_21 :
case V_36 :
F_58 (KERN_ERR PFX L_22
L_23 , state, upriv->reply_count) ;
V_12 -> V_68 = 0 ;
if ( V_19 == V_20
|| V_19 == V_21 ) {
...
F_31 ( L_26
L_27 , V_72 ,
V_3 -> V_24 , V_128 , V_3 -> V_73 ) ;
V_90 = - V_129 ;
goto exit;
}
if ( V_120 )
memcpy ( V_120 , V_63 -> V_29 , F_64 ( V_128 , V_121 ) ) ;
if ( V_122 )
...
static int F_65 ( struct V_130 * V_131 , int V_132 , T_3 V_83 ,
...
static int F_67 ( struct V_130 * V_131 , int V_132 , T_3 V_83 ,
...
if ( ! V_3 )
return - V_111 ;
return F_60 ( V_12 , V_3 , 0 , NULL , V_135 ,
V_10 , V_136 , V_82 ) ;
}
static int F_68 ( struct V_130 * V_131 , T_3 V_137 , T_3 V_138 , T_3 V_139 ,
...
static int F_69 ( struct V_130 * V_131 , T_3 V_137 , T_3 V_138 ,
struct V_141 * V_142 )
{
struct V_11 * V_12 = V_131 -> V_42 ;
struct V_2 * V_3 ;
...
static int F_70 ( struct V_130 * V_131 , int V_132 ,
...
memcpy ( V_10 , V_63 -> V_29 + V_146 , V_144 ) ;
return 0 ;
}
if ( F_71 ( V_145 ) ) {
...
memcpy ( V_10 , V_63 -> V_29 + V_146 - 4 , V_144 ) ;
} else {
F_58 (KERN_ERR PFX L_33 , id) ;
return - V_115 ;
}
return 0 ;
}
static int F_72 ( struct V_130 * V_131 , T_4 * V_148 ,
T_5 V_149 , T_3 V_150 )
{
struct V_11 * V_12 = V_131 -> V_42 ;
struct V_2 * V_3 ;
...
if ( ! V_3 )
return - V_111 ;
V_148 [ 0 ] = F_50 ( V_150 - 2 ) ;
V_148 [ 1 ] = F_50 ( 0x0800 ) ;
return F_60 ( V_12 , V_3 , sizeof( V_29 ) , & V_29 ,
V_135 , & V_148 [ 2 ] , V_150 - 4 ,
NULL ) ;
}
static int F_73 ( struct V_130 * V_131 , T_5 V_152 )
{
struct V_11 * V_12 = V_131 -> V_42 ;
struct V_2 * V_3 ;
T_6 V_29 = F_74 ( V_152 ) ;
...
static int F_76 ( struct V_130 * V_131 , const char * V_10 ,
T_5 V_107 , T_5 V_144 )
{
struct V_11 * V_12 = V_131 -> V_42 ;
struct V_2 * V_3 ;
...
if ( ! V_3 )
return - V_111 ;
return F_60 ( V_12 , V_3 , V_144 , V_10 ,
V_135 , NULL , 0 , NULL ) ;
}
...
F_31 = F_76 ( V_131 , & V_10 [ V_157 - V_107 ] ,
V_157 , V_158 ) ;
if ( F_31 )
break;
V_157 += V_158 ;
...
static T_7 F_79 ( struct V_160 * V_161 , struct V_40 * V_39 )
{
struct V_41 * V_42 = F_29 ( V_39 ) ;
struct V_43 * V_44 = & V_42 -> V_44 ;
...
V_10 = V_3 -> V_10 -> V_29 ;
V_165 = 0 ;
F_31 = F_84 ( V_161 , V_39 , V_42 , & V_165 ,
& V_163 [ 0 ] ) ;
if ( F_31 )
goto V_173;
{
...
memcpy ( V_10 , V_161 -> V_29 , V_161 -> V_144 ) ;
V_10 += V_161 -> V_144 ;
if ( V_165 & V_177 ) {
T_1 * V_178 = V_163 ;
if ( V_161 -> V_144 % 2 )
...
F_85 ( V_39 ) ;
V_166 = F_86 ( V_10 - V_3 -> V_10 -> V_29 , 2 ) ;
F_31 = F_60 ( V_12 , V_3 , V_166 , NULL ,
V_134 , NULL , 0 , NULL ) ;
if ( F_31 ) {
F_87 ( V_39 ) ;
if ( F_88 () )
...
static int F_91 ( struct V_130 * V_131 , T_3 V_88 , T_3 * V_184 )
{
* V_184 = V_38 ;
return 0 ;
}
...
F_5 ( ! V_12 ) ;
V_12 -> V_68 = 0 ;
F_95 ( V_131 , V_186 , V_187 ) ;
F_95 ( V_131 , V_188 , V_147 ) ;
F_96 ( V_12 -> V_92 ) ;
F_52 ( V_12 ) ;
V_90 = F_65 ( V_131 , 0 , V_189 ,
F_51 ( 2 ) , L_44 ) ;
if ( V_90 < 0 ) {
F_58 (KERN_ERR PFX L_45 , retval) ;
return V_90 ;
}
V_90 = F_69 ( V_131 , V_190 , 0 , NULL ) ;
if ( V_90 < 0 ) {
F_58 (KERN_ERR PFX L_46 , retval) ;
return V_90 ;
}
return 0 ;
}
...
static void F_107 ( T_8 * V_200 ,
unsigned long * V_32 ) __acquires( V_200 )
{
F_62 ( V_200 ) ;
}
static void F_108 ( T_8 * V_200 ,
unsigned long * V_32 ) __releases( V_200 )
{
F_63 ( V_200 ) ;
}
static void F_109 ( T_8 * V_200 ) __acquires( V_200 )
{
F_62 ( V_200 ) ;
}
static void F_110 ( T_8 * V_200 ) __releases( V_200 )
{
F_63 ( V_200 ) ;
}
...
F_40 ( L_63 ,
V_208 -> V_223 ) ;
V_12 -> V_126 = F_118 ( V_15 ,
V_208 ->
V_223 ) ;
V_12 -> V_199 = F_18 ( V_26 , V_110 ) ;
if ( ! V_12 -> V_199 ) {
F_31 ( L_64 ) ;
goto error;
}
...
static void F_124 ( struct V_201 * V_232 )
{
struct V_11 * V_12 = F_125 ( V_232 ) ;
F_123 ( V_232 , NULL ) ;
F_99 ( V_12 ) ;
F_58 (KERN_INFO PFX L_73 ) ;
}
