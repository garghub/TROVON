...
static int F_17 ( struct V_34 * V_14 ,
struct V_35 * * V_36 , const int V_37 )
{
struct V_38 * V_39 = F_18 ( V_14 ) ;
struct V_35 * V_40 =
F_19 ( V_14 -> V_41 -> V_36 , L_3 ) ;
struct V_42 * V_43 ;
int V_22 , V_44 ;
if ( ! V_40 ) {
F_20 ( V_14 , L_4 ) ;
...
for ( V_44 = 0 , V_43 = V_46 ; V_44 < V_37 ; V_44 ++ , V_43 ++ )
if ( V_43 -> V_36 ) {
V_39 -> V_47 [ V_44 ] = V_43 -> V_47 ;
V_36 [ V_44 ] = V_43 -> V_36 ;
}
return 0 ;
}
...
{
struct V_38 * V_39 = F_18 ( & V_49 -> V_14 ) ;
struct V_50 * V_50 = F_23 ( V_49 -> V_14 . V_41 ) ;
struct V_51 * V_52 ;
struct V_53 V_54 = { . V_14 = & V_49 -> V_14 ,} ;
struct V_9 * V_10 = NULL ;
struct V_9 * V_55 ;
struct V_35 * V_36 [ V_56 ] = {} ;
struct V_1 * V_2 ;
struct V_11 * V_57 ;
int V_22 ;
int V_58 ;
...
if ( V_49 -> V_14 . V_41 -> V_36 ) {
V_22 = F_17 ( & V_49 -> V_14 , V_36 , V_56 ) ;
if ( V_22 < 0 ) {
F_20 ( & V_49 -> V_14 , L_7 , V_22 ) ;
return V_22 ;
}
}
V_55 = F_24 ( & V_49 -> V_14 , V_56 *
sizeof( struct V_9 ) , V_59 ) ;
if ( ! V_55 ) {
F_20 ( & V_49 -> V_14 , L_8 ) ;
return - V_60 ;
}
for ( V_58 = 0 , V_57 = V_61 ; V_58 < V_56 ; ++ V_58 , V_57 ++ ) {
V_52 = V_39 -> V_47 [ V_58 ] ;
if ( ! V_52 )
continue;
V_10 = & V_55 [ V_58 ] ;
