...
static int F_9 ( struct V_47 * V_48 ,
struct V_11 * V_49 )
{
struct V_1 * V_2 = F_10 ( V_48 ) ;
struct V_41 * V_19 = V_49 -> V_19 ;
struct V_13 * V_14 ;
int V_50 = 0 ;
if ( V_2 -> V_51 == V_1 && V_19 -> V_20 == 2 ) {
V_50 = - V_52 ;
goto error;
}
V_2 -> V_17 = 0 ;
F_11 (t, &m->transfers, transfer_list) {
T_2 V_27 = V_14 -> V_46 ? : V_19 -> V_45 ;
bool V_15 ;
V_50 = F_8 ( V_19 , V_14 , V_2 -> V_17 ) ;
if ( V_50 < 0 )
break;
V_50 = F_6 ( V_2 , V_27 , V_19 -> V_28 ) ;
if ( V_50 < 0 )
break;
V_15 = V_14 -> V_53 || F_12 ( & V_14 -> V_54 ,
& V_49 -> V_55 ) ;
if ( V_14 -> V_3 ) {
V_50 = F_4 ( V_2 , V_49 , V_14 , V_15 ) ;
if ( V_50 < 0 )
break;
V_49 -> V_56 += V_50 ;
}
...
static int F_16 ( struct V_58 * V_9 ,
const struct V_59 * V_51 )
{
struct V_60 * V_61 = & V_9 -> V_61 ;
struct V_62 * V_63 = V_61 -> V_64 ;
struct V_65 * V_66 = F_17 ( V_61 ) ;
struct V_1 * V_2 ;
struct V_47 * V_48 ;
int error ;
if ( ! F_18 ( V_9 -> V_67 , V_68 |
V_69 ) )
return - V_43 ;
V_48 = F_19 ( V_61 , sizeof( struct V_1 ) ) ;
if ( ! V_48 )
return - V_70 ;
V_2 = F_10 ( V_48 ) ;
F_20 ( V_9 , V_2 ) ;
...
const T_4 * V_77 ;
int V_3 ;
V_77 = F_21 ( V_63 , L_1 , & V_3 ) ;
if ( V_77 && V_3 >= sizeof( T_4 ) )
V_2 -> V_36 = F_22 ( V_77 ) ;
}
if ( ! V_2 -> V_36 )
V_2 -> V_36 = V_74 ;
...
V_48 -> V_78 = V_9 -> V_67 -> V_79 ;
V_48 -> V_80 = V_30 | V_32 | V_34 ;
V_48 -> V_81 = F_15 ;
V_48 -> V_82 = F_9 ;
V_48 -> V_61 . V_64 = V_63 ;
error = F_23 ( V_48 ) ;
...
static int F_25 ( struct V_58 * V_9 )
{
