...
static int
F_36 ( struct V_80 * V_25 , struct V_113 * V_114 )
{
if ( F_37 ( V_25 -> V_26 ) != 0 )
return - V_115 ;
...
static struct V_31 * F_40 ( struct V_9 * V_121 ,
struct V_80 * V_25 ,
struct V_122 * V_123 )
{
struct V_31 * V_32 ;
...
if ( F_41 ( V_123 ) == V_138 )
V_137 = V_105 ;
else if ( F_41 ( V_123 ) == V_139 )
V_137 = V_140 ;
else
return F_42 ( - V_115 ) ;
V_135 = V_25 -> V_26 ;
V_133 = F_43 ( V_123 ) >> V_25 -> V_112 ;
V_134 =
( F_43 ( V_123 ) + F_44 ( V_123 ) - 1 ) >> V_25 -> V_112 ;
V_130 = 0 ;
F_45 (bv, req, iter) {
...
V_132 = V_133 ;
F_45 (bv, req, iter) {
V_129 = F_47 ( V_128 -> V_143 ) + V_128 -> V_144 ;
...
static int
F_49 ( struct V_31 * V_32 , struct V_122 * V_123 )
{
int V_38 ;
V_38 = V_32 -> V_38 == V_152 ;
F_50 ( V_32 , V_32 -> V_121 ) ;
return V_38 ;
}
...
static void
F_53 ( struct V_9 * V_10 , struct V_31 * V_123 ,
struct V_162 * V_163 )
{
F_9 ( V_58 , V_10 , L_9 ,
L_33 ) ;
