...
struct V_14 * V_15 ;
int V_46 ;
V_15 = F_21 ( & V_41 -> V_20 , sizeof( struct V_14 ) ,
V_47 ) ;
if ( ! V_15 ) {
F_5 ( & V_41 -> V_20 , L_6 ) ;
return - V_48 ;
...
F_22 ( V_41 , V_13 ) ;
F_23 ( V_13 , V_15 ) ;
V_15 -> V_29 = F_24 ( V_43 , L_7 ,
0 ) ;
if ( V_15 -> V_29 == - V_49 )
return - V_49 ;
if ( F_8 ( V_15 -> V_29 ) ) {
V_46 = F_25 ( & V_41 -> V_20 , V_15 -> V_29 ,
V_50 , L_8 ) ;
if ( V_46 ) {
F_5 ( V_13 -> V_20 , L_9 ) ;
return V_46 ;
...
V_15 -> V_30 = F_24 ( V_43 , L_10 ,
0 ) ;
if ( V_15 -> V_30 == - V_49 )
return - V_49 ;
if ( F_8 ( V_15 -> V_30 ) ) {
V_46 = F_25 ( & V_41 -> V_20 , V_15 -> V_30 ,
V_51 , L_11 ) ;
if ( V_46 ) {
F_5 ( V_13 -> V_20 , L_12 ) ;
return V_46 ;
