...
F_37 ( & V_147 [ 2 ] , & V_148 ,
V_145 - V_144 ) ;
V_54 = F_38 ( & V_2 -> V_40 , V_147 , 3 , & signal ) ;
if ( V_54 == 0 && signal )
F_1 ( V_2 ) ;
return V_54 ;
}
...
int F_42 ( struct V_1 * V_2 , void * V_138 ,
...
* V_140 = V_143 . V_152 ;
V_54 = F_45 ( & V_2 -> V_39 , V_138 , V_170 ,
( V_143 . V_149 << 3 ) , & signal ) ;
if ( signal )
F_1 ( V_2 ) ;
return 0 ;
}
int F_46 ( struct V_1 * V_2 , void * V_138 ,
T_2 V_139 , T_2 * V_169 ,
V_108 * V_140 )
{
struct V_142 V_143 ;
...
* V_140 = V_143 . V_152 ;
V_54 = F_45 ( & V_2 -> V_39 , V_138 , V_144 , 0 ,
& signal ) ;
if ( signal )
F_1 ( V_2 ) ;
return 0 ;
