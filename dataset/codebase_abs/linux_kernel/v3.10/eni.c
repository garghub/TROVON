...
if ( V_56 -> V_30 & 3 ) {
F_66 ( V_21 -> V_36 , V_12 -> V_61 , & V_65 , V_12 -> V_184 . V_61 ,
4 - ( V_56 -> V_30 & 3 ) ) ;
}
...
static int F_102 ( struct V_18 * V_19 , void T_1 * V_272 )
{
void T_1 * V_273 ;
int V_10 ;
...
V_12 -> V_248 = V_272 + V_293 ;
V_12 -> V_294 = V_272 + V_295 ;
V_12 -> V_141 = V_272 + V_296 ;
V_50 = V_288 - V_296 ;
...
if ( ! ( F_15 ( V_298 ) & 0x200 ) != ! V_12 -> V_285 ) {
F_3 ( L_138 ) ;
...
{
struct V_12 * V_300 = F_6 ( V_19 ) ;
V_19 -> V_248 -> V_301 ( V_19 ) ;
V_19 -> V_248 = NULL ;
F_109 ( V_300 -> V_289 ) ;
}
...
F_9 ( L_146 ) ;
V_12 = F_6 ( V_19 ) ;
if ( F_112 ( V_12 -> V_241 , & F_93 , V_304 , V_90 , V_19 ) ) {
...
if ( ( error = F_114 ( V_12 -> V_66 , V_308 ,
V_309 ) ) ) {
...
V_12 -> V_83 = V_12 -> V_141 + V_310 * 16 ;
V_12 -> V_196 = V_12 -> V_83 + V_82 * 8 ;
V_12 -> V_115 = V_12 -> V_196 + V_180 * 8 ;
V_302 = V_12 -> V_115 + V_116 * 4 ;
F_9 ( L_151 ,
V_12 -> V_46 , V_12 -> V_83 , V_12 -> V_196 ,
V_12 -> V_115 , V_302 ) ;
F_115 ( & V_12 -> V_250 ) ;
F_116 ( & V_12 -> V_159 , F_97 , ( unsigned long ) V_19 ) ;
V_12 -> V_251 = 0 ;
V_303 = V_12 -> V_220 - ( V_302 - V_12 -> V_141 ) ;
V_12 -> V_32 = V_303 / V_34 / 2 ;
V_12 -> V_15 = F_117 (
...
V_12 -> V_13 = 0 ;
F_8 ( V_12 , V_302 , V_303 ) ;
F_11 ( V_12 -> V_46 , 0 , 16 * V_310 ) ;
F_14 ( 0xffffffff , V_311 ) ;
error = F_91 ( V_19 ) ;
if ( error ) goto V_15;
error = F_62 ( V_19 ) ;
if ( error ) goto V_15;
...
if ( error ) goto V_15;
F_14 ( F_15 ( V_42 ) | ( 1 << V_312 ) |
V_313 | V_43 | V_44 | V_45 ,
V_42 ) ;
( void ) F_15 ( V_243 ) ;
return 0 ;
V_15:
...
F_9 ( L_152 ) ;
if ( ! F_7 ( V_40 ) ) return;
F_120 ( V_314 , & V_40 -> V_253 ) ;
F_53 ( V_40 ) ;
F_89 ( V_40 ) ;
F_9 ( L_153 ) ;
F_118 ( F_7 ( V_40 ) ) ;
V_40 -> V_315 = NULL ;
F_120 ( V_316 , & V_40 -> V_253 ) ;
}
...
F_123 ( V_314 , & V_40 -> V_253 ) ;
return 0 ;
}
static int F_124 ( struct V_39 * V_40 , struct V_318 * V_117 , int V_319 )
{
struct V_12 * V_12 = F_6 ( V_40 -> V_19 ) ;
struct V_168 * V_21 = F_7 ( V_40 ) -> V_21 ;
struct V_55 * V_56 ;
int error , V_221 , V_320 , V_321 ;
if ( V_117 -> V_217 . V_119 == V_136 ) return 0 ;
if ( V_21 == V_12 -> V_207 ) return - V_322 ;
V_221 = F_85 ( & V_117 -> V_217 ) ;
if ( V_221 < 0 ) V_221 = - V_221 ;
V_320 = V_321 = 0 ;
if ( ( V_319 & V_323 ) && V_221 && V_221 < V_21 -> V_209 ) V_320 = 1 ;
if ( ( V_319 & V_324 ) && ( ! V_221 || V_221 > V_21 -> V_209 ) ) V_320 = 1 ;
if ( ( V_319 & V_325 ) && V_221 && V_221 < V_21 -> V_228 ) V_321 = 1 ;
if ( ( V_319 & V_326 ) && ( ! V_221 || V_221 > V_21 -> V_228 ) ) V_321 = 1 ;
if ( ! V_320 && ! V_321 ) return 0 ;
error = F_84 ( V_40 , & V_117 -> V_217 , V_320 , V_321 ) ;
if ( error ) return error ;
if ( V_321 && ! ( V_319 & V_327 ) ) return 0 ;
F_59 ( & V_12 -> V_159 ) ;
F_125 (&eni_dev->tx_queue, skb) {
void T_1 * V_328 ;
if ( F_22 ( V_56 ) -> V_40 != V_40 ) continue;
V_328 = V_21 -> V_22 + F_29 ( V_56 ) * 4 ;
F_28 ( ( F_16 ( V_328 ) & ~ ( V_329 | V_330 ) ) |
( V_21 -> V_188 << V_189 ) |
( V_21 -> V_190 << V_191 ) , V_328 ) ;
}
F_60 ( & V_12 -> V_159 ) ;
return 0 ;
}
static int F_126 ( struct V_18 * V_19 , unsigned int V_331 , void T_5 * V_332 )
{
struct V_12 * V_12 = F_6 ( V_19 ) ;
if ( V_331 == V_333 ) {
if ( ! F_127 ( V_334 ) ) return - V_335 ;
F_3 ( V_336 L_157 V_90 L_158
L_159 , V_19 -> V_91 ) ;
F_5 ( V_19 ) ;
return 0 ;
}
...
struct V_338 V_339 ;
if ( ! F_127 ( V_334 ) ) return - V_335 ;
if ( F_128 ( & V_339 , V_332 ,
sizeof( struct V_338 ) ) )
return - V_340 ;
if ( ( V_339 . V_21 && V_339 . V_21 <= 100 ) || ( V_339 . V_25 && V_339 . V_25 <= 100 ) ||
V_339 . V_21 > 65536 || V_339 . V_25 > 65536 )
return - V_232 ;
if ( V_339 . V_21 ) V_12 -> V_225 = V_339 . V_21 ;
if ( V_339 . V_25 ) V_12 -> V_138 = V_339 . V_25 ;
return 0 ;
}
if ( V_331 == V_341 ) {
struct V_342 V_343 ;
if ( F_128 ( & V_343 , V_332 , sizeof( struct V_342 ) ) )
return - V_340 ;
if ( ( V_343 . V_279 == 0 || V_343 . V_279 == V_344 ) &&
( V_343 . V_280 == V_281 || V_343 . V_279 == V_344 ) )
return 0 ;
return - V_232 ;
}
if ( ! V_19 -> V_248 -> V_345 ) return - V_346 ;
return V_19 -> V_248 -> V_345 ( V_19 , V_331 , V_332 ) ;
}
static int F_129 ( struct V_39 * V_40 , int V_347 , int V_348 ,
void T_5 * V_349 , int V_350 )
{
return - V_232 ;
}
static int F_130 ( struct V_39 * V_40 , int V_347 , int V_348 ,
void T_5 * V_349 , unsigned int V_350 )
{
return - V_232 ;
}
static int F_131 ( struct V_39 * V_40 , struct V_55 * V_56 )
{
enum V_167 V_201 ;
F_9 ( L_160 ) ;
if ( ! F_7 ( V_40 ) -> V_21 ) {
...
* ( T_2 * ) V_56 -> V_67 = F_133 ( * ( T_2 * ) V_56 -> V_67 ) ;
}
V_351 ++ ;
F_22 ( V_56 ) -> V_40 = V_40 ;
...
static void F_134 ( struct V_18 * V_19 , unsigned char V_353 ,
unsigned long V_354 )
{
F_28 ( V_353 , F_6 ( V_19 ) -> V_248 + V_354 * 4 ) ;
}
static unsigned char F_135 ( struct V_18 * V_19 , unsigned long V_354 )
{
return F_16 ( F_6 ( V_19 ) -> V_248 + V_354 * 4 ) ;
}
static int F_136 ( struct V_18 * V_19 , T_6 * V_355 , char * V_356 )
{
struct V_357 * V_1 ;
...
if ( -- V_358 ) continue;
return sprintf ( V_356 , L_179 , L_142 ,
F_139 ( & V_21 -> V_202 ) ) ;
}
F_140 ( & V_359 ) ;
for( V_10 = 0 ; V_10 < V_360 ; ++ V_10 ) {
struct V_361 * V_362 = & V_363 [ V_10 ] ;
F_141 (s, head) {
struct V_41 * V_41 ;
int V_85 ;
V_40 = F_142 ( V_1 ) ;
...
V_41 = F_7 ( V_40 ) ;
if ( -- V_358 ) continue;
V_85 = sprintf ( V_356 , L_180 , V_40 -> V_46 ) ;
if ( V_41 -> V_25 ) {
V_85 += sprintf ( V_356 + V_85 , L_181
L_182 ,
( unsigned long ) ( V_41 -> V_26 - V_12 -> V_141 ) ,
V_41 -> V_26 - V_12 -> V_141 + V_41 -> V_23 * 4 - 1 ,
V_41 -> V_23 * 4 ) ;
if ( V_41 -> V_21 ) V_85 += sprintf ( V_356 + V_85 , L_183 ) ;
}
if ( V_41 -> V_21 )
V_85 += sprintf ( V_356 + V_85 , L_184 ,
...
F_143 ( & V_359 ) ;
for ( V_10 = 0 ; V_10 < V_12 -> V_13 ; V_10 ++ ) {
struct V_28 * V_364 = V_12 -> V_15 + V_10 ;
unsigned long V_365 ;
if ( -- V_358 ) continue;
V_365 = ( unsigned long ) V_12 -> V_141 + V_12 -> V_31 ;
return sprintf ( V_356 , L_185 ,
V_364 -> V_16 - V_365 , V_364 -> V_16 - V_365 + ( 1 << V_364 -> V_17 ) - 1 ,
1 << V_364 -> V_17 ) ;
}
return 0 ;
}
static int F_144 ( struct V_66 * V_66 ,
...
goto V_299;
V_369 = - V_162 ;
V_12 = F_117 ( sizeof( struct V_12 ) , V_161 ) ;
if ( ! V_12 )
goto V_370;
V_184 = & V_12 -> V_184 ;
V_184 -> V_354 = F_146 ( V_66 , V_371 , & V_184 -> V_61 ) ;
if ( ! V_184 -> V_354 )
goto V_372;
V_19 = F_147 ( V_90 , & V_66 -> V_19 , & V_373 , - 1 , NULL ) ;
if ( ! V_19 )
goto V_374;
V_19 -> V_315 = V_12 ;
F_148 ( V_66 , V_19 ) ;
V_12 -> V_66 = V_66 ;
V_12 -> V_285 = V_367 -> V_375 ;
V_369 = F_104 ( V_19 ) ;
if ( V_369 < 0 )
goto V_376;
V_369 = F_111 ( V_19 ) ;
...
F_149 ( V_19 ) ;
V_374:
F_150 ( V_66 , V_371 , V_184 -> V_354 , V_184 -> V_61 ) ;
V_372:
F_118 ( V_12 ) ;
V_370:
F_151 ( V_66 ) ;
...
static void F_152 ( struct V_66 * V_380 )
{
struct V_18 * V_19 = F_153 ( V_380 ) ;
struct V_12 * V_300 = F_6 ( V_19 ) ;
struct V_368 * V_184 = & V_300 -> V_184 ;
F_110 ( V_19 ) ;
F_149 ( V_19 ) ;
F_150 ( V_380 , V_371 , V_184 -> V_354 , V_184 -> V_61 ) ;
F_118 ( V_300 ) ;
F_151 ( V_380 ) ;
}
