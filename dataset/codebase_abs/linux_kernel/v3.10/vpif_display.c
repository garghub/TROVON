...
V_95 -> V_103 = * V_227 ;
V_41 -> V_240 = V_104 -> V_234 + V_104 -> V_235 +
V_104 -> V_236 - 8 ;
V_41 -> V_241 = V_104 -> V_106 ;
V_41 -> V_242 = 1 ;
V_41 -> V_243 = V_104 -> V_239 + V_104 -> V_238 + 1 ;
if ( V_104 -> V_244 ) {
if ( V_104 -> V_245 || V_104 -> V_246 || V_104 -> V_247 ) {
V_41 -> V_248 = V_104 -> V_105 * 2 +
V_104 -> V_237 + V_104 -> V_239 + V_104 -> V_238 +
V_104 -> V_246 + V_104 -> V_247 +
V_104 -> V_245 ;
V_41 -> V_249 = V_41 -> V_248 / 2 -
( V_104 -> V_237 - 1 ) ;
V_41 -> V_250 = V_41 -> V_248 / 2 + 1 ;
V_41 -> V_251 = V_41 -> V_250 + V_104 -> V_247 +
V_104 -> V_245 + 1 ;
V_41 -> V_252 = V_41 -> V_248 -
( V_104 -> V_246 - 1 ) ;
} else {
F_51 ( 2 , V_101 , L_40
L_41 ) ;
...
V_41 -> V_248 = V_104 -> V_105 + V_104 -> V_237 +
V_104 -> V_239 + V_104 -> V_238 ;
V_41 -> V_249 = V_41 -> V_248 - ( V_104 -> V_237 - 1 ) ;
}
strncpy ( V_41 -> V_213 , L_42 ,
V_253 ) ;
V_41 -> V_106 = V_104 -> V_106 ;
V_41 -> V_105 = V_104 -> V_105 ;
V_41 -> V_67 = V_104 -> V_244 ? 0 : 1 ;
V_41 -> V_42 = 0 ;
V_41 -> V_254 = 0 ;
V_41 -> V_255 = 0 ;
V_41 -> V_72 = 1 ;
...
V_257 -> V_258 = V_259 ;
V_257 -> V_260 = 0 ;
if ( V_257 -> V_261 . type != V_262 &&
V_257 -> V_261 . type != V_263 ) {
F_51 ( 2 , V_101 , L_43 ) ;
return - V_25 ;
}
return F_92 ( & V_88 . V_183 , 0 , V_185 ,
V_264 , V_257 ) ;
}
...
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
return F_104 ( V_33 -> V_215 , V_185 , V_267 , V_266 ) ;
}
...
struct V_3 * V_4 = V_148 ;
struct V_32 * V_33 = V_4 -> V_10 ;
return F_104 ( V_33 -> V_215 , V_185 , V_268 , V_266 ) ;
}
static int F_117 ( struct V_129 * V_130 , void * V_148 )
{
F_118 ( & V_88 . V_183 , 0 , V_185 , V_269 ) ;
return 0 ;
}
...
( V_276 < V_37 . V_44 ) )
V_276 = V_37 . V_44 ;
if ( V_277 < V_37 . V_278 [ V_75 ] )
V_277 =
V_37 . V_278 [ V_75 ] ;
if ( V_279 < V_37 . V_278 [ V_78 ] )
V_279 =
V_37 . V_278 [ V_78 ] ;
V_37 . V_116 [ V_75 ] = V_275 ;
if ( V_275 ) {
V_37 . V_38 [ V_75 ] =
V_277 ;
}
V_37 . V_116 [ V_78 ] = V_276 ;
if ( V_276 ) {
V_37 . V_38 [ V_78 ] =
V_279 ;
}
for ( V_90 = 0 ; V_90 < V_280 ; V_90 ++ ) {
V_88 . V_87 [ V_90 ] =
...
V_270 = V_280 ;
V_271 = V_282 ;
V_272 = V_37 . V_116 [ V_90 - 1 ] ;
return 0 ;
V_281:
for ( V_274 = 0 ; V_274 < V_270 ; V_274 ++ )
F_65 ( V_88 . V_87 [ V_274 ] ) ;
return V_273 ;
}
static T_6 int F_120 ( struct V_283 * V_284 )
{
struct V_208 * V_285 ;
struct V_54 * V_98 ;
int V_90 , V_274 = 0 , V_286 , V_273 = 0 ;
int V_287 = 0 ;
struct V_288 * V_289 ;
struct V_7 * V_8 ;
struct V_32 * V_33 ;
...
V_273 = F_122 ( V_56 , & V_88 . V_183 ) ;
if ( V_273 ) {
F_121 ( V_56 -> V_156 , L_45 ) ;
return V_273 ;
}
while ( ( V_137 = F_123 ( V_284 , V_292 , V_287 ) ) ) {
for ( V_90 = V_137 -> V_293 ; V_90 <= V_137 -> V_294 ; V_90 ++ ) {
if ( F_124 ( V_90 , F_47 , V_295 ,
L_46 , ( void * )
( & V_88 . V_87 [ V_287 ] -> V_39 ) ) ) {
V_273 = - V_163 ;
for ( V_274 = 0 ; V_274 < V_90 ; V_274 ++ )
F_125 ( V_274 , ( void * )
( & V_88 . V_87 [ V_287 ] -> V_39 ) ) ;
goto V_296;
}
...
* V_290 = V_297 ;
V_290 -> V_183 = & V_88 . V_183 ;
V_290 -> V_298 = F_127 ;
V_290 -> V_299 = V_300 ;
snprintf ( V_290 -> V_213 , sizeof( V_290 -> V_213 ) ,
L_47 ,
V_301 ) ;
V_33 -> V_223 = V_290 ;
}
V_137 = F_123 ( V_284 , V_302 , 0 ) ;
if ( V_137 ) {
V_34 = F_128 ( V_137 ) ;
for ( V_274 = 0 ; V_274 < V_280 ; V_274 ++ ) {
V_33 = V_88 . V_87 [ V_274 ] ;
V_33 -> V_39 = V_274 ;
...
V_88 . V_215 [ V_90 ] = F_130 ( & V_88 . V_183 ,
V_289 ,
& V_285 [ V_90 ] . V_304 ,
NULL ) ;
if ( ! V_88 . V_215 [ V_90 ] ) {
...
if ( V_88 . V_215 [ V_90 ] )
V_88 . V_215 [ V_90 ] -> V_306 = 1 << V_90 ;
}
for ( V_274 = 0 ; V_274 < V_280 ; V_274 ++ ) {
V_33 = V_88 . V_87 [ V_274 ] ;
F_131 ( & V_33 -> V_143 , 0 ) ;
for ( V_286 = 0 ; V_286 < V_92 ; V_286 ++ ) {
V_33 -> V_8 [ V_286 ] . V_116 = 0 ;
V_8 = & V_33 -> V_8 [ V_286 ] ;
V_8 -> V_147 = 0 ;
V_8 -> V_66 = 0 ;
F_132 ( & V_8 -> V_49 ) ;
...
F_135 ( V_33 -> V_223 , V_33 ) ;
V_273 = F_103 ( V_98 , V_33 , 0 ) ;
if ( V_273 )
goto V_307;
F_51 ( 1 , V_101 , L_50 ,
( int ) V_33 , ( int ) & V_33 -> V_223 ) ;
V_273 = F_136 ( V_33 -> V_223 ,
V_308 , ( V_274 ? 3 : 2 ) ) ;
if ( V_273 < 0 )
goto V_307;
}
...
return 0 ;
V_307:
for ( V_286 = 0 ; V_286 < V_274 ; V_286 ++ ) {
V_33 = V_88 . V_87 [ V_286 ] ;
F_138 ( V_33 -> V_223 ) ;
F_127 ( V_33 -> V_223 ) ;
V_33 -> V_223 = NULL ;
}
...
F_139 ( & V_88 . V_183 ) ;
F_9 ( L_52 ) ;
for ( V_90 = 0 ; V_90 < V_287 ; V_90 ++ ) {
V_137 = F_123 ( V_284 , V_292 , V_90 ) ;
for ( V_274 = V_137 -> V_293 ; V_274 <= V_137 -> V_294 ; V_274 ++ )
F_125 ( V_274 , ( void * ) ( & V_88 . V_87 [ V_90 ] -> V_39 ) ) ;
}
return V_273 ;
}
static int F_140 ( struct V_283 * V_309 )
{
struct V_32 * V_33 ;
int V_90 ;
F_139 ( & V_88 . V_183 ) ;
...
static int F_141 ( struct V_309 * V_87 )
{
struct V_7 * V_8 ;
struct V_32 * V_33 ;
int V_90 ;
...
static int F_143 ( struct V_309 * V_87 )
{
struct V_7 * V_8 ;
struct V_32 * V_33 ;
int V_90 ;
...
int V_311 ;
int V_90 = 0 ;
V_284 = F_12 ( V_56 , struct V_283 , V_87 ) ;
while ( ( V_137 = F_123 ( V_284 , V_292 , V_90 ) ) ) {
for ( V_311 = V_137 -> V_293 ; V_311 <= V_137 -> V_294 ; V_311 ++ )
F_125 ( V_311 ,
