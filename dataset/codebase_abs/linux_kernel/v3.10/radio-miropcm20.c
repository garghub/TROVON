...
return - V_27 ;
V_2 -> V_3 = F_10 ( V_47 , V_44 -> V_46 , 87 * 16000U , 108 * 16000U ) ;
F_1 ( V_2 , V_2 -> V_3 ) ;
return 0 ;
}
static int F_11 ( struct V_48 * V_49 )
{
struct V_1 * V_2 = F_12 ( V_49 -> V_50 , struct V_1 , V_51 ) ;
switch ( V_49 -> V_52 ) {
case V_53 :
F_2 ( V_2 -> V_7 , V_54 , V_49 -> V_55 , - 1 ) ;
return 0 ;
}
return - V_27 ;
}
...
F_5 ( V_2 -> V_64 . V_18 , V_17 -> V_18 , sizeof( V_2 -> V_64 . V_18 ) ) ;
V_2 -> V_64 . V_17 = V_17 ;
V_2 -> V_64 . V_65 = & V_66 ;
V_2 -> V_64 . V_67 = & V_68 ;
V_2 -> V_64 . V_69 = V_70 ;
V_2 -> V_64 . V_61 = & V_2 -> V_61 ;
F_20 ( V_71 , & V_2 -> V_64 . V_72 ) ;
F_21 ( & V_2 -> V_64 , V_2 ) ;
F_2 ( V_2 -> V_7 , V_41 ,
V_2 -> V_39 == V_42 , - 1 ) ;
F_1 ( V_2 , V_2 -> V_3 ) ;
if ( F_22 ( & V_2 -> V_64 , V_73 , V_74 ) < 0 )
goto V_63;
F_23 ( V_17 , L_8 ) ;
return 0 ;
V_63:
