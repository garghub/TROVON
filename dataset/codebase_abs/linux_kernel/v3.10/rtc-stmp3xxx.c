...
struct V_48 * V_49 ;
int V_50 ;
V_5 = F_23 ( & V_47 -> V_2 , sizeof( * V_5 ) , V_51 ) ;
if ( ! V_5 )
return - V_52 ;
V_49 = F_24 ( V_47 , V_53 , 0 ) ;
if ( ! V_49 ) {
F_25 ( & V_47 -> V_2 , L_2 ) ;
return - V_54 ;
}
V_5 -> V_6 = F_26 ( & V_47 -> V_2 , V_49 -> V_55 , F_27 ( V_49 ) ) ;
if ( ! V_5 -> V_6 ) {
F_25 ( & V_47 -> V_2 , L_3 ) ;
return - V_56 ;
}
V_5 -> V_57 = F_28 ( V_47 , 0 ) ;
if ( ! ( F_8 ( V_21 + V_5 -> V_6 ) &
V_58 ) ) {
F_25 ( & V_47 -> V_2 , L_4 ) ;
return - V_59 ;
...
V_41 ,
V_5 -> V_6 + V_31 ) ;
V_5 -> V_32 = F_30 ( & V_47 -> V_2 , V_47 -> V_62 ,
& V_63 , V_64 ) ;
if ( F_31 ( V_5 -> V_32 ) ) {
V_50 = F_32 ( V_5 -> V_32 ) ;
goto V_65;
}
V_50 = F_33 ( & V_47 -> V_2 , V_5 -> V_57 ,
F_13 , 0 , L_5 , & V_47 -> V_2 ) ;
if ( V_50 ) {
F_25 ( & V_47 -> V_2 , L_6 ,
V_5 -> V_57 ) ;
