...
int F_38 ( struct V_37 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_38 ;
F_25 ( L_4 , V_27 -> V_22 ) ;
return 1 ;
}
void F_39 ( struct V_37 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_38 ;
T_1 V_22 ;
F_13 ( & V_10 ) ;
...
T_1 F_41 ( struct V_37 * V_32 )
{
struct V_24 * V_27 = V_32 -> V_38 ;
return V_27 -> V_22 ;
}
T_1 F_42 ( struct V_37 * V_32 ,
unsigned char * V_39 , T_1 V_40 )
{
struct V_24 * V_27 = V_32 -> V_38 ;
return F_43 ( V_39 , V_40 , V_27 -> V_41 ) ;
}
static int F_44 ( struct V_42 * V_43 , T_1 V_44 ,
const struct V_45 * V_46 , struct V_45 * V_47 )
{
struct V_1 * V_6 ;
struct V_24 * V_27 ;
struct V_30 * V_31 ;
...
if ( ! V_6 )
goto V_50;
V_31 = F_45 ( V_6 -> V_5 , V_43 ) ;
if ( ! V_31 )
goto V_50;
if ( ! V_46 )
goto V_51;
if ( V_46 -> V_52 & ( V_53 | V_54 ) )
return V_55 ;
V_48 = F_46 ( V_46 -> V_56 ) ;
if ( ! ( V_48 & ( V_57 | V_58 ) ) )
return V_59 ;
...
if ( ! ( V_48 & V_57 ) )
return V_61 ;
V_27 = F_26 ( V_6 , V_43 -> V_62 . V_22 , V_31 ) ;
if ( ! V_27 )
return V_63 ;
if ( ! V_27 -> V_36 )
V_43 -> V_64 ++ ;
V_27 -> V_36 = V_48 ;
V_27 -> V_41 = V_43 -> V_62 . V_41 ;
V_27 -> V_65 = V_43 -> V_66 ;
}
V_51:
V_48 = F_46 ( V_47 -> V_56 ) ;
V_48 &= ~ V_67 ;
V_47 -> V_56 = F_47 ( V_48 | V_58 ) ;
return V_68 ;
V_50:
V_48 = F_46 ( V_47 -> V_56 ) ;
V_48 &= ~ V_58 ;
...
static int F_48 ( struct V_42 * V_43 , T_1 V_44 ,
const struct V_45 * V_46 , struct V_45 * V_47 )
{
int V_69 ;
F_13 ( & V_10 ) ;
V_69 = F_44 ( V_43 , V_44 , V_46 , V_47 ) ;
F_14 ( & V_10 ) ;
F_25 ( L_5 ,
V_43 -> V_62 . V_22 , V_46 ? V_46 -> V_52 : 0 , V_69 ) ;
return V_69 ;
}
...
struct V_1 * V_6 ;
F_13 ( & V_10 ) ;
V_6 = F_2 ( V_43 -> V_49 -> V_8 [ V_9 ] ,
F_3 ( & V_10 ) ) ;
if ( ! V_6 ) {
F_14 ( & V_10 ) ;
return;
}
V_27 = F_35 ( V_6 , V_43 -> V_62 . V_22 ) ;
if ( ! V_27 ) {
F_14 ( & V_10 ) ;
return;
}
...
static void F_55 ( struct V_2 * V_3 , struct V_72 * V_73 )
{
struct V_24 * V_27 ;
T_1 V_74 = F_56 ( V_73 ) ;
F_25 ( L_6 , V_74 ) ;
