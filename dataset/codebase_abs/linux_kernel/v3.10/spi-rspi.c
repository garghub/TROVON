...
F_49 ( & V_2 -> V_89 , V_88 ) ;
while ( ! F_50 ( & V_2 -> V_90 ) ) {
V_34 = F_51 ( V_2 -> V_90 . V_91 , struct V_33 , V_90 ) ;
F_52 ( & V_34 -> V_90 ) ;
F_53 ( & V_2 -> V_89 , V_88 ) ;
F_16 ( V_2 ) ;
...
struct V_103 * V_104 )
{
struct V_105 * V_106 = V_104 -> V_44 . V_107 ;
T_4 V_108 ;
struct V_109 V_110 ;
int V_15 ;
if ( ! V_106 )
...
F_64 ( V_108 ) ;
F_65 ( V_113 , V_108 ) ;
V_2 -> V_83 = F_66 ( V_108 , V_114 ,
( void * ) V_106 -> V_111 ) ;
if ( V_2 -> V_83 ) {
V_110 . V_115 = V_106 -> V_111 ;
V_110 . V_116 = V_117 ;
V_15 = F_67 ( V_2 -> V_83 , & V_110 ) ;
if ( ! V_15 )
F_68 ( & V_104 -> V_44 , L_3 ) ;
else
return V_15 ;
...
F_64 ( V_108 ) ;
F_65 ( V_113 , V_108 ) ;
V_2 -> V_64 = F_66 ( V_108 , V_114 ,
( void * ) V_106 -> V_112 ) ;
if ( V_2 -> V_64 ) {
V_110 . V_115 = V_106 -> V_112 ;
V_110 . V_116 = V_118 ;
V_15 = F_67 ( V_2 -> V_64 , & V_110 ) ;
if ( ! V_15 )
F_68 ( & V_104 -> V_44 , L_4 ) ;
else
return V_15 ;
...
static int F_71 ( struct V_103 * V_104 )
{
struct V_1 * V_2 = F_72 ( & V_104 -> V_44 ) ;
F_73 ( V_2 -> V_43 ) ;
F_69 ( V_2 ) ;
F_74 ( F_75 ( V_104 , 0 ) , V_2 ) ;
F_76 ( V_2 -> V_8 ) ;
F_77 ( V_2 -> V_5 ) ;
F_78 ( V_2 -> V_43 ) ;
return 0 ;
}
static int F_79 ( struct V_103 * V_104 )
{
struct V_119 * V_120 ;
struct V_121 * V_43 ;
struct V_1 * V_2 ;
...
V_43 = F_82 ( & V_104 -> V_44 , sizeof( struct V_1 ) ) ;
if ( V_43 == NULL ) {
F_21 ( & V_104 -> V_44 , L_7 ) ;
return - V_63 ;
}
...
F_83 ( & V_104 -> V_44 , V_2 ) ;
V_2 -> V_43 = V_43 ;
V_2 -> V_5 = F_84 ( V_120 -> V_126 , F_85 ( V_120 ) ) ;
if ( V_2 -> V_5 == NULL ) {
F_21 ( & V_104 -> V_44 , L_8 ) ;
V_15 = - V_63 ;
goto V_127;
}
snprintf ( V_122 , sizeof( V_122 ) , L_9 , V_104 -> V_128 ) ;
V_2 -> V_8 = F_86 ( & V_104 -> V_44 , V_122 ) ;
if ( F_87 ( V_2 -> V_8 ) ) {
...
F_93 ( & V_2 -> V_18 ) ;
V_43 -> V_130 = 2 ;
V_43 -> V_131 = V_104 -> V_128 ;
V_43 -> V_132 = F_55 ;
V_43 -> V_133 = F_57 ;
V_43 -> V_134 = F_60 ;
V_15 = F_94 ( V_72 , F_61 , 0 , F_95 ( & V_104 -> V_44 ) , V_2 ) ;
if ( V_15 < 0 ) {
