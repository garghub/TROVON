...
int V_45 ;
struct V_41 * V_46 ;
V_46 = F_17 ( sizeof( struct V_41 ) , V_47 ) ;
if ( ! V_46 )
return NULL ;
V_45 = F_18 ( & V_48 , 0 , 0 , V_47 ) ;
if ( V_45 < 0 ) {
F_3 ( V_46 ) ;
return NULL ;
}
...
static int F_19 ( struct V_1 * V_2 , void * V_49 )
{
struct V_3 * V_15 = F_2 ( V_2 ) ;
struct V_41 * V_46 = V_49 ;
if ( V_15 -> V_46 == V_46 )
F_20 ( V_15 ) ;
return 1 ;
}
int F_21 ( struct V_41 * V_46 )
{
F_22 ( & V_50 , NULL , V_46 ,
F_19 ) ;
F_23 ( & V_48 , V_46 -> V_45 ) ;
...
int F_24 ( struct V_18 * V_51 , struct V_52 * V_53 ,
const char * V_54 )
{
V_51 -> V_22 . V_53 = V_53 ;
V_51 -> V_22 . V_54 = V_54 ;
V_51 -> V_22 . V_46 = & V_50 ;
return F_25 ( & V_51 -> V_22 ) ;
}
void F_26 ( struct V_18 * V_51 )
{
F_27 ( & V_51 -> V_22 ) ;
}
...
V_2 -> V_2 . V_46 = & V_50 ;
V_2 -> V_2 . V_5 = F_1 ;
V_2 -> V_2 . V_42 = V_2 -> V_46 -> V_42 ;
F_43 ( & V_2 -> V_2 ,
L_11 , V_2 -> V_46 -> V_45 , V_2 -> V_68 ) ;
F_44 ( & V_2 -> V_2 ) ;
if ( V_2 -> V_46 -> V_23 -> V_69 ( V_2 , 8 ) )
F_32 ( & V_2 -> V_2 , L_12 ) ;
if ( V_2 -> V_46 -> V_23 -> V_70 ( V_2 ) )
F_32 ( & V_2 -> V_2 , L_13 ) ;
V_61 = F_35 ( V_2 ) ;
if ( V_61 < 0 ) {
F_37 ( & V_2 -> V_2 , L_14 ) ;
...
if ( V_2 -> V_57 ) {
V_61 = V_2 -> V_46 -> V_23 -> V_69 ( V_2 , 32 ) ;
if ( V_61 < 0 )
F_37 ( & V_2 -> V_2 , L_15 ) ;
}
return 0 ;
