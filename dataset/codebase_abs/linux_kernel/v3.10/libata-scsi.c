...
F_189 ( V_468 , & V_10 -> V_469 ,
F_190 ( V_116 ) ) ;
}
int F_191 ( struct V_25 * V_2 )
{
if ( V_2 -> V_22 ) {
F_192 ( V_2 -> V_22 , V_470 ) ;
return 1 ;
}
return 0 ;
}
...
{
if ( V_2 -> V_22 )
F_204 ( V_2 -> V_22 , V_207 ,
V_473 ) ;
}
void F_205 ( struct V_474 * V_475 )
{
struct V_9 * V_10 =
F_206 ( V_475 , struct V_9 , V_469 . V_475 ) ;
int V_159 ;
if ( V_10 -> V_36 & V_476 ) {
F_97 ( L_54 ) ;
return;
...
F_202 ( & V_10 -> V_360 [ V_159 ] ) ;
F_178 ( V_10 , 0 ) ;
F_198 ( & V_10 -> V_477 ) ;
F_97 ( L_36 ) ;
}
int F_207 ( struct V_7 * V_8 , unsigned int V_361 ,
...
void F_208 ( struct V_474 * V_475 )
{
struct V_9 * V_10 =
F_206 ( V_475 , struct V_9 , V_484 ) ;
struct V_23 * V_24 ;
struct V_25 * V_2 ;
unsigned long V_13 ;
F_194 ( & V_10 -> V_477 ) ;
...
struct V_9 * F_210 ( struct V_442 * V_30 ,
struct V_485 * V_486 ,
struct V_7 * V_8 )
{
struct V_9 * V_10 ;
