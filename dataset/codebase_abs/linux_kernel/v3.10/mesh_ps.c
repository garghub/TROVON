...
if ( V_55 ) {
F_23 ( V_3 , V_23 ) ;
F_24 ( & V_3 -> V_5 -> V_29 . V_30 . V_58 . V_59 ) ;
F_9 ( V_3 -> V_5 , L_6 ,
V_3 -> V_3 . V_17 ) ;
} else {
F_25 ( V_3 ) ;
...
static void F_32 ( struct V_2 * V_3 , bool V_62 , bool V_63 )
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_1 * V_10 ;
struct V_8 * V_9 ;
...
V_70 ;
F_9 ( V_5 , L_9 ,
V_62 ? L_10 : L_11 , V_63 ? L_12 : L_11 , V_3 -> V_3 . V_17 ) ;
F_12 ( V_5 , V_10 ) ;
}
...
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_1 * V_73 , * V_10 = F_35 ( V_72 ) ;
...
F_37 ( V_5 , V_73 ) ;
V_65 = F_33 ( V_73 ) ;
V_65 -> V_76 . V_18 = & V_5 -> V_18 ;
V_65 -> V_68 |= V_77 ;
F_38 ( V_72 , V_73 ) ;
}
static void F_39 ( struct V_2 * V_3 , int V_78 )
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_6 * V_7 = V_5 -> V_7 ;
int V_79 ;
...
F_34 ( V_3 , & V_72 ) ;
F_9 ( V_3 -> V_5 , L_14 ,
F_43 ( & V_72 ) , V_3 -> V_3 . V_17 ) ;
F_44 (&frames, skb) {
struct V_64 * V_65 = F_33 ( V_10 ) ;
struct V_8 * V_52 = ( void * ) V_10 -> V_25 ;
V_65 -> V_68 |= V_69 ;
if ( V_80 || ! F_45 ( & V_72 , V_10 ) )
V_52 -> V_19 |=
F_5 ( V_66 ) ;
else
V_52 -> V_19 &=
...
bool V_86 , bool V_87 )
{
T_2 V_62 = V_24 [ 1 ] & ( V_67 >> 8 ) ;
T_2 V_63 = V_24 [ 0 ] & V_26 ;
if ( V_86 ) {
if ( V_62 && V_87 )
F_23 ( V_3 , V_61 ) ;
if ( V_63 )
...
bool V_91 = false ;
if ( V_3 -> V_37 == V_41 )
V_91 = F_50 ( V_89 -> V_92 , V_89 -> V_93 ,
F_51 ( V_3 -> V_94 ) % V_95 ) ;
if ( V_91 )
F_9 ( V_3 -> V_5 , L_15 ,
V_3 -> V_3 . V_17 ) ;
if ( F_10 ( V_3 , V_23 ) &&
( ! V_89 -> V_96 || ! F_51 ( * V_89 -> V_96 ) ) )
return;
for ( V_79 = 0 ; V_79 < V_81 ; V_79 ++ )
V_90 += F_43 ( & V_3 -> V_83 [ V_79 ] ) +
F_43 ( & V_3 -> V_82 [ V_79 ] ) ;
if ( ! V_91 && ! V_90 )
return;
if ( V_3 -> V_37 == V_41 )
