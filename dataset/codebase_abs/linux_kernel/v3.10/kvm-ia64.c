...
V_368 = F_193 ( V_5 , V_369 + V_12 ) ;
if ( ! F_194 ( V_368 ) ) {
F_110 ( V_5 , V_369 + V_12 ,
V_368 << V_137 ,
V_371 | V_372 ) ;
V_346 -> V_348 [ V_12 ] = ( unsigned long ) F_195 ( V_368 ) ;
} else {
F_110 ( V_5 , V_369 + V_12 ,
V_373 | ( V_368 << V_137 ) ,
V_374 ) ;
...
void F_199 ( struct V_5 * V_5 ,
struct V_345 * V_35 )
{
F_197 () ;
}
long F_200 ( struct V_258 * V_259 ,
unsigned int V_260 , unsigned long V_261 )
{
return - V_40 ;
}
...
long V_295 ;
V_295 = F_203 ( & V_376 , & V_30 , & V_377 , 0 ) ;
if ( V_295 )
goto V_163;
if ( ! ( V_376 & V_378 ) )
goto V_163;
F_23 ( V_50 L_23 ) ;
V_295 = F_204 ( & V_274 , & V_379 ) ;
if ( V_295 )
goto V_163;
...
static void F_205 ( struct V_186 * V_381 ,
struct V_382 * V_382 )
{
...
static int F_206 ( struct V_186 * V_381 ,
struct V_382 * V_382 )
{
unsigned long V_385 ;
unsigned long V_389 ;
...
static void F_209 ( struct V_5 * V_5 ,
struct V_345 * V_346 )
{
int V_12 ;
long V_298 ;
...
if ( log -> V_35 >= V_411 )
goto V_163;
V_346 = F_212 ( V_5 -> V_412 , log -> V_35 ) ;
V_53 = - V_413 ;
if ( ! V_346 -> V_406 )
goto V_163;
F_209 ( V_5 , V_346 ) ;
V_53 = F_213 ( V_5 , log , & V_410 ) ;
if ( V_53 )
goto V_163;
if ( V_410 ) {
F_198 ( V_5 ) ;
...
int F_216 ( struct V_1 * V_2 , struct V_414 * V_256 )
{
return F_41 ( V_2 , V_256 -> V_91 ) ;
}
int F_217 ( struct V_312 * V_305 , T_10 V_415 )
{
return V_305 -> V_2 -> V_325 == V_415 ;
}
int F_218 ( struct V_312 * V_305 , T_11 V_416 )
{
return 0 ;
}
int F_219 ( struct V_1 * V_417 , struct V_1 * V_418 )
{
return V_417 -> V_6 . V_245 - V_418 -> V_6 . V_245 ;
}
int F_220 ( struct V_1 * V_2 , struct V_312 * V_419 ,
