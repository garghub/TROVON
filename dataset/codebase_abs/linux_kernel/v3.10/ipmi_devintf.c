...
static long F_58 ( struct V_15 * V_108 , unsigned int V_46 ,
unsigned long V_52 )
{
int V_97 ;
F_11 ( & V_23 ) ;
V_97 = F_56 ( V_108 , V_46 , V_52 ) ;
F_13 ( & V_23 ) ;
return V_97 ;
}
static void F_59 ( int V_25 , struct V_118 * V_118 )
{
T_5 V_119 = F_60 ( V_120 , V_25 ) ;
struct V_121 * V_61 ;
...
V_61 -> V_119 = V_119 ;
F_11 ( & V_123 ) ;
F_62 ( V_124 , V_118 , V_119 , NULL , L_3 , V_25 ) ;
...
return - V_43 ;
F_61 ( V_126 L_4 ) ;
V_124 = F_67 ( V_127 , L_5 ) ;
if ( F_68 ( V_124 ) ) {
F_61 ( V_122 L_6 ) ;
return F_69 ( V_124 ) ;
}
V_26 = F_70 ( V_120 , V_128 , & V_129 ) ;
if ( V_26 < 0 ) {
F_71 ( V_124 ) ;
F_61 ( V_122 L_7 , V_120 ) ;
return V_26 ;
}
if ( V_120 == 0 ) {
V_120 = V_26 ;
...
F_11 ( & V_123 ) ;
F_75 (entry, entry2, &reg_list, link) {
F_31 ( & V_61 -> V_10 ) ;
F_65 ( V_124 , V_61 -> V_119 ) ;
F_18 ( V_61 ) ;
}
F_13 ( & V_123 ) ;
F_71 ( V_124 ) ;
