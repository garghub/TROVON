...
case V_53 :
* V_4 = 0 ;
* V_45 = ( ( ( T_6 ) V_25 -> V_54 ) * 1000000ULL ) >> V_23 -> V_50 . V_55 ;
return V_56 ;
case V_57 :
...
V_21 = F_22 ( sizeof( * V_25 ) ) ;
if ( V_21 == NULL ) {
V_10 = - V_67 ;
goto V_68;
}
V_25 = F_10 ( V_21 ) ;
V_25 -> V_69 = F_23 ( & V_2 -> V_63 , L_2 ) ;
if ( ! F_24 ( V_25 -> V_69 ) ) {
V_10 = F_25 ( V_25 -> V_69 ) ;
if ( V_10 )
goto V_70;
...
V_25 -> V_30 = true ;
V_25 -> V_2 = V_2 ;
if ( ! F_24 ( V_25 -> V_72 ) && ! F_24 ( V_25 -> V_69 ) ) {
V_25 -> V_54 = ( V_65 + V_66 ) / 1000 ;
V_25 -> V_58 = V_66 / 1000 ;
} else if ( V_62 ) {
V_25 -> V_54 = V_62 -> V_75 + V_62 -> V_58 ;
V_25 -> V_58 = V_62 -> V_58 ;
} else {
F_27 ( & V_2 -> V_63 , L_4 ) ;
}
...
if ( V_10 )
goto V_74;
V_25 -> V_78 = & V_79 [ F_28 ( V_2 )
-> V_80 ] ;
V_25 -> V_31 = F_29 ( V_25 -> V_78 -> V_81 ( V_25 -> V_54 ) )
| ( ( V_62 && V_62 -> V_82 ) ? 0 : V_83 ) |
V_84 ;
...
goto V_74;
F_30 ( V_2 , V_21 ) ;
V_21 -> V_63 . V_85 = & V_2 -> V_63 ;
V_21 -> V_86 = & V_87 ;
V_21 -> V_88 = V_89 ;
V_21 -> V_90
= & V_91 [ F_28 ( V_2 ) -> V_80 ] ;
V_21 -> V_92 = 1 ;
V_21 -> V_93 = F_28 ( V_25 -> V_2 ) -> V_93 ;
V_10 = F_31 ( V_21 ) ;
if ( V_10 )
goto V_74;
return 0 ;
