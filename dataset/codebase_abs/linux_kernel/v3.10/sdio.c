...
static int F_71 ( struct V_145 * V_32 )
{
int V_165 , V_80 = 0 ;
for ( V_165 = 0 ; V_165 < V_32 -> V_5 -> V_166 ; V_165 ++ ) {
struct V_1 * V_2 = V_32 -> V_5 -> V_1 [ V_165 ] ;
if ( V_2 && F_72 ( V_2 ) && V_2 -> V_163 . V_168 ) {
