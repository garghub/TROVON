...
struct V_87 * V_88 = F_25 ( V_86 -> V_89 ) ;
struct V_5 * V_6 = V_88 -> V_90 ;
struct V_139 * V_140 = F_55 ( V_86 ) ;
const struct V_141 * V_142 ;
struct V_143 * V_144 = & V_138 -> V_80 . V_144 ;
struct V_145 V_146 ;
int V_60 ;
V_142 = F_56 ( V_86 , V_144 -> V_147 ) ;
if ( ! V_142 ) {
F_57 ( V_86 -> V_89 , L_9 ,
V_144 -> V_147 ) ;
return - V_26 ;
...
F_27 ( V_86 -> V_89 , L_10 ,
V_144 -> V_10 , V_144 -> V_11 ) ;
V_146 . V_10 = V_144 -> V_10 ;
V_146 . V_11 = V_144 -> V_11 ;
V_146 . V_148 = V_144 -> V_148 ;
V_146 . V_149 = V_144 -> V_149 ;
V_146 . V_13 = V_142 -> V_13 ;
V_60 = F_58 ( V_140 , V_150 , V_151 , & V_146 ) ;
if ( V_60 < 0 )
return V_60 ;
if ( V_146 . V_13 != V_142 -> V_13 )
return - V_26 ;
V_60 = F_6 ( V_6 , V_144 -> V_10 , V_144 -> V_11 , V_142 -> V_13 ) ;
if ( V_60 < 0 )
return V_60 ;
V_144 -> V_10 = V_146 . V_10 ;
V_144 -> V_11 = V_146 . V_11 ;
V_144 -> V_148 = V_146 . V_148 ;
V_144 -> V_149 = V_146 . V_149 ;
V_86 -> V_152 = V_142 ;
F_27 ( V_86 -> V_89 , L_11 ,
V_144 -> V_10 , V_144 -> V_11 ) ;
return V_60 ;
...
struct V_143 * V_144 = & V_138 -> V_80 . V_144 ;
struct V_145 V_146 ;
T_1 V_153 = V_144 -> V_147 ;
int V_60 ;
V_142 = F_56 ( V_86 , V_153 ) ;
if ( V_153 && ! V_142 ) {
F_57 ( V_86 -> V_89 , L_9 , V_153 ) ;
return - V_26 ;
}
if ( V_144 -> V_11 > V_154 )
V_144 -> V_11 = V_154 ;
...
V_146 . V_149 = V_144 -> V_149 ;
V_146 . V_13 = V_142 -> V_13 ;
V_60 = F_58 ( V_140 , V_150 , V_156 , & V_146 ) ;
if ( V_60 < 0 )
return V_60 ;
V_144 -> V_10 = V_146 . V_10 ;
V_144 -> V_11 = V_146 . V_11 ;
...
static bool F_60 ( const struct V_159 * V_80 )
{
return V_80 -> V_160 == V_161 ||
( V_80 -> V_162 == 8 &&
V_80 -> V_160 == V_163 ) ||
( V_80 -> V_162 > 8 &&
V_80 -> V_160 == V_164 ) ;
...
struct V_87 * V_88 = F_25 ( V_86 -> V_89 ) ;
struct V_5 * V_6 = V_88 -> V_90 ;
struct V_166 V_167 = { . type = V_168 ,} ;
unsigned long V_169 ;
int V_60 ;
V_60 = F_58 ( V_140 , V_150 , V_170 , & V_167 ) ;
if ( ! V_60 ) {
V_169 = F_62 ( & V_167 ,
V_171 ) ;
if ( ! V_169 ) {
...
int V_175 = 0 , V_60 ;
enum V_12 V_13 ;
const struct V_159 * V_80 ;
V_60 = F_58 ( V_140 , V_150 , V_176 , V_174 , & V_13 ) ;
if ( V_60 < 0 )
return 0 ;
V_80 = F_64 ( V_13 ) ;
if ( ! V_80 ) {
...
static unsigned int F_70 ( struct V_184 * V_184 , T_3 * V_185 )
{
struct V_85 * V_86 = V_184 -> V_186 ;
return F_71 ( & V_86 -> V_187 , V_184 , V_185 ) ;
}
...
V_167 . V_114 = V_169 ;
V_60 = F_58 ( V_140 , V_150 , V_204 , & V_167 ) ;
if ( V_60 < 0 && V_60 != - V_172 ) {
F_27 ( V_86 -> V_89 , L_23 ,
V_169 , V_60 ) ;
return V_60 ;
}
...
{
struct V_87 * V_214 = F_25 ( & V_213 -> V_215 ) ;
struct V_5 * V_6 = F_29 ( V_214 ,
struct V_5 , V_214 ) ;
F_75 ( V_6 -> V_55 , V_6 ) ;
F_76 ( V_214 ) ;
F_77 ( V_6 -> V_96 ) ;
...
struct V_219 * V_9 ;
int V_60 , V_220 ;
struct V_221 * V_215 = & V_213 -> V_215 ;
struct V_87 * V_214 ;
struct V_222 * V_110 ;
V_110 = V_215 -> V_223 ;
if ( ! V_110 || ! V_110 -> V_224 || ! V_110 -> V_225 ) {
F_26 ( & V_213 -> V_215 ,
L_24 ) ;
return - V_26 ;
}
V_9 = F_84 ( V_213 , V_226 , 0 ) ;
if ( ! V_9 )
return - V_227 ;
V_181 = F_85 ( & V_213 -> V_215 , L_25 ) ;
if ( F_86 ( V_181 ) )
return F_87 ( V_181 ) ;
V_60 = F_88 ( V_181 ) ;
if ( V_60 )
goto V_228;
V_6 = F_89 ( sizeof( struct V_5 ) , V_229 ) ;
if ( ! V_6 ) {
V_60 = - V_230 ;
F_26 ( & V_213 -> V_215 , L_26 ) ;
goto V_231;
}
V_6 -> V_181 = V_181 ;
V_6 -> V_110 = V_110 ;
...
if ( V_60 )
goto V_233;
V_60 = F_92 ( V_6 -> V_182 , V_110 -> V_225 ) ;
if ( V_60 < 0 )
goto V_234;
V_6 -> V_216 = F_93 ( & V_213 -> V_215 ,
sizeof( struct V_1 ) * V_94 ,
& V_6 -> V_217 ,
V_229 ) ;
if ( ! V_6 -> V_216 ) {
V_60 = - V_230 ;
F_26 ( & V_213 -> V_215 , L_29 ) ;
goto V_235;
}
for ( V_220 = 0 ; V_220 < V_94 ; V_220 ++ ) {
V_6 -> V_236 [ V_220 ] . V_101 = V_6 -> V_216 + V_220 ;
V_6 -> V_236 [ V_220 ] . V_48 = V_6 -> V_217 +
V_220 * sizeof( struct V_1 ) ;
F_36 ( & V_6 -> V_236 [ V_220 ] . V_39 , & V_6 -> V_100 ) ;
}
V_6 -> V_96 = F_94 ( & V_213 -> V_215 ) ;
if ( F_86 ( V_6 -> V_96 ) ) {
V_60 = F_87 ( V_6 -> V_96 ) ;
goto V_237;
}
V_6 -> V_9 = F_95 ( V_9 -> V_238 , F_96 ( V_9 ) ) ;
if ( ! V_6 -> V_9 ) {
V_60 = - V_230 ;
goto V_239;
}
if ( V_110 -> V_224 & V_240 )
V_6 -> V_173 = 1 << 7 ;
if ( V_110 -> V_224 & V_241 )
V_6 -> V_173 |= 1 << 9 ;
F_2 ( V_6 , V_27 , V_28 ) ;
V_55 = F_97 ( V_213 , 0 ) ;
if ( F_98 ( V_55 ) ) {
...
V_60 = F_99 ( V_55 , F_13 , 0 , L_30 , V_6 ) ;
if ( V_60 ) {
F_26 ( & V_213 -> V_215 , L_31 , V_55 ) ;
goto V_242;
}
V_6 -> V_55 = V_55 ;
V_214 = & V_6 -> V_214 ;
...
V_214 -> V_132 = & V_244 ;
V_214 -> V_90 = V_6 ;
V_214 -> V_245 . V_215 = & V_213 -> V_215 ;
V_214 -> V_246 = V_213 -> V_247 ;
V_60 = F_100 ( V_214 ) ;
if ( V_60 ) {
F_26 ( & V_213 -> V_215 , L_33 ) ;
goto V_248;
}
return 0 ;
V_248:
