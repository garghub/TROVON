...
static void F_32 ( struct V_8 * V_8 )
{
V_8 -> V_71 = F_33 ( NULL , V_72 ) ;
if ( F_34 ( V_8 -> V_71 ) ) {
F_9 ( L_5 , V_72 ) ;
V_8 -> V_71 = NULL ;
return;
...
static void F_36 ( struct V_8 * V_8 )
{
F_37 ( V_8 -> V_71 ) ;
F_38 ( V_8 -> V_71 ) ;
}
static int F_39 ( struct V_73 * V_74 , unsigned int V_75 ,
T_6 V_76 , T_7 V_77 )
{
T_6 * V_78 ;
unsigned int V_79 ;
...
if ( V_74 -> V_92 + V_84 < V_79 + V_93 + sizeof( * V_78 ) )
return 0 ;
if ( F_41 ( V_75 & V_94 ) )
V_80 = V_81 + V_79 + V_95 ;
else
V_80 = V_81 + V_79 ;
V_78 = ( T_6 * ) ( V_81 + V_79 + V_93 ) ;
return ( V_77 == ( * V_80 & 0xf ) && V_76 == F_42 ( * V_78 ) ) ;
}
static T_3 F_43 ( struct V_8 * V_8 , struct V_73 * V_74 , int V_96 )
{
T_3 V_55 = 0 ;
struct V_1 * V_2 ;
struct V_34 * V_35 , * V_36 ;
unsigned int V_97 = F_44 ( V_74 , V_98 ) ;
unsigned long V_46 ;
T_6 V_78 ;
T_7 V_99 ;
if ( V_97 == V_100 )
...
V_78 = ( V_2 -> V_5 >> V_103 ) & V_104 ;
if ( V_96 == F_3 ( V_2 ) &&
F_39 ( V_74 , V_97 , V_78 , V_99 ) ) {
...
void F_46 ( struct V_8 * V_8 , struct V_73 * V_74 )
{
T_3 V_55 ;
struct V_105 * V_106 ;
if ( ! V_8 -> V_107 )
return;
V_55 = F_43 ( V_8 , V_74 , V_25 ) ;
if ( ! V_55 )
return;
V_106 = F_47 ( V_74 ) ;
...
void F_49 ( struct V_8 * V_8 , struct V_73 * V_74 )
{
T_3 V_55 ;
struct V_105 V_106 ;
if ( ! ( F_50 ( V_74 ) -> V_109 & V_110 ) )
return;
V_55 = F_43 ( V_8 , V_74 , V_26 ) ;
if ( ! V_55 )
return;
memset ( & V_106 , 0 , sizeof( V_106 ) ) ;
V_106 . V_108 = F_48 ( V_55 ) ;
...
int F_52 ( struct V_111 * V_112 , struct V_8 * V_8 ,
T_1 V_44 , T_1 V_113 )
{
#ifdef F_53
int V_114 , V_18 ;
unsigned long V_46 ;
if ( F_54 ( V_98 , F_55 ( V_98 ) ) ) {
F_9 ( L_6 ) ;
return - V_115 ;
}
V_8 -> V_47 = V_116 ;
V_8 -> clock = F_56 ( & V_8 -> V_47 , V_112 ) ;
if ( F_34 ( V_8 -> clock ) ) {
V_114 = F_57 ( V_8 -> clock ) ;
V_8 -> clock = NULL ;
return V_114 ;
}
F_58 ( & V_8 -> V_49 ) ;
V_8 -> V_32 . V_117 = F_13 ;
V_8 -> V_32 . V_118 = F_59 ( 32 ) ;
V_8 -> V_48 = V_44 ;
V_8 -> V_32 . V_44 = V_44 ;
V_8 -> V_32 . V_113 = V_113 ;
F_60 ( & V_8 -> V_27 ) ;
F_60 ( & V_8 -> V_22 ) ;
for ( V_18 = 0 ; V_18 < V_119 ; V_18 ++ )
F_17 ( & V_8 -> V_120 [ V_18 ] . V_23 , & V_8 -> V_22 ) ;
F_32 ( V_8 ) ;
F_6 ( V_8 , V_66 , V_67 ) ;
F_6 ( V_8 , V_68 , V_69 ) ;
F_20 ( & V_8 -> V_49 , V_46 ) ;
F_24 ( & V_8 -> V_50 , & V_8 -> V_32 , F_61 ( F_62 () ) ) ;
F_22 ( & V_8 -> V_49 , V_46 ) ;
F_63 ( & V_8 -> V_65 , F_29 ) ;
F_31 ( & V_8 -> V_65 , V_70 ) ;
V_8 -> V_121 = F_64 ( V_8 -> clock ) ;
#endif
return 0 ;
}
