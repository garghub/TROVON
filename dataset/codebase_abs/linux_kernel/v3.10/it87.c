...
struct V_75 * V_76 = V_17 -> V_138 ;
int V_53 ;
F_95 ( & V_17 -> V_139 , & V_140 ) ;
for ( V_53 = 0 ; V_53 < 9 ; V_53 ++ ) {
if ( V_76 -> V_129 & ( 1 << V_53 ) )
continue;
F_95 ( & V_17 -> V_139 , & V_141 [ V_53 ] ) ;
if ( V_142 [ V_53 ] )
F_96 ( & V_17 -> V_139 ,
V_142 [ V_53 ] ) ;
}
...
if ( ! ( V_10 -> V_147 & ( 1 << V_53 ) ) )
continue;
F_95 ( & V_17 -> V_139 , & V_148 [ V_53 ] ) ;
if ( V_76 -> V_114 )
F_96 ( & V_17 -> V_139 ,
V_149 [ V_53 ] ) ;
if ( V_53 < 3 && ! F_50 ( V_10 ) )
...
if ( V_76 -> V_128 & ( 1 << 0 ) )
continue;
F_95 ( & V_17 -> V_139 , & V_151 [ V_53 ] ) ;
if ( F_61 ( V_10 ) )
F_95 ( & V_17 -> V_139 ,
& V_152 [ V_53 ] ) ;
}
if ( ! V_76 -> V_113 )
F_95 ( & V_17 -> V_139 , & V_153 ) ;
F_95 ( & V_17 -> V_139 , & V_154 ) ;
}
static int F_98 ( struct V_155 * V_137 )
{
struct V_9 * V_10 ;
struct V_156 * V_157 ;
...
int V_158 ;
int V_159 ;
V_157 = F_99 ( V_137 , V_160 , 0 ) ;
if ( ! F_100 ( & V_137 -> V_17 , V_157 -> V_161 , V_162 ,
V_7 ) ) {
F_62 ( V_17 , L_31 ,
( unsigned long ) V_157 -> V_161 ,
( unsigned long ) ( V_157 -> V_161 + V_162 - 1 ) ) ;
return - V_8 ;
}
V_10 = F_101 ( & V_137 -> V_17 , sizeof( struct V_9 ) , V_163 ) ;
if ( ! V_10 )
return - V_164 ;
V_10 -> V_165 = V_157 -> V_161 ;
V_10 -> type = V_76 -> type ;
V_10 -> V_166 = V_167 [ V_76 -> type ] . V_166 ;
V_10 -> V_168 = V_167 [ V_76 -> type ] . V_168 ;
V_10 -> V_169 = V_167 [ V_76 -> type ] . V_169 ;
V_10 -> V_73 = V_167 [ V_76 -> type ] . V_73 ;
switch ( V_10 -> type ) {
case V_84 :
if ( V_76 -> V_110 >= 0x03 ) {
V_10 -> V_166 &= ~ V_170 ;
...
F_105 ( V_137 ) ;
V_54 = F_106 ( & V_17 -> V_139 , & V_140 ) ;
if ( V_54 )
return V_54 ;
for ( V_53 = 0 ; V_53 < 9 ; V_53 ++ ) {
if ( V_76 -> V_129 & ( 1 << V_53 ) )
continue;
V_54 = F_106 ( & V_17 -> V_139 , & V_141 [ V_53 ] ) ;
if ( V_54 )
goto error;
if ( V_76 -> V_114 && V_142 [ V_53 ] ) {
V_54 = F_107 ( & V_17 -> V_139 ,
V_142 [ V_53 ] ) ;
if ( V_54 )
goto error;
}
...
if ( ! ( V_10 -> V_143 & ( 1 << V_53 ) ) )
continue;
V_54 = F_106 ( & V_17 -> V_139 , & V_144 [ V_53 ] ) ;
if ( V_54 )
goto error;
if ( F_97 ( V_10 ) ) {
V_54 = F_107 ( & V_17 -> V_139 ,
...
if ( ! ( V_10 -> V_147 & ( 1 << V_53 ) ) )
continue;
V_54 = F_106 ( & V_17 -> V_139 , & V_148 [ V_53 ] ) ;
if ( V_54 )
goto error;
if ( V_53 < 3 && ! F_50 ( V_10 ) ) {
V_54 = F_107 ( & V_17 -> V_139 ,
...
V_10 -> V_176 = F_111 ( V_17 ) ;
if ( F_112 ( V_10 -> V_176 ) ) {
V_54 = F_113 ( V_10 -> V_176 ) ;
goto error;
}
return 0 ;
error:
...
static int F_114 ( struct V_155 * V_137 )
{
struct V_9 * V_10 = F_94 ( V_137 ) ;
F_115 ( V_10 -> V_176 ) ;
F_93 ( & V_137 -> V_17 ) ;
...
{
F_116 ( V_1 , V_10 -> V_165 + V_177 ) ;
return F_117 ( V_10 -> V_165 + V_178 ) ;
}
static void F_30 ( struct V_9 * V_10 , T_1 V_1 , T_1 V_179 )
{
F_116 ( V_1 , V_10 -> V_165 + V_177 ) ;
F_116 ( V_179 , V_10 -> V_165 + V_178 ) ;
}
...
T_1 V_181 [ 3 ] ;
for ( V_53 = 0 ; V_53 < 3 ; V_53 ++ )
V_181 [ V_53 ] = F_40 ( V_10 ,
F_64 ( V_53 ) ) ;
if ( ! ( ( V_181 [ 0 ] | V_181 [ 1 ] | V_181 [ 2 ] ) & 0x80 ) ) {
F_118 ( V_17 ,
L_33 ) ;
F_30 ( V_10 , V_58 ,
V_57 | 0x87 ) ;
...
static void F_105 ( struct V_155 * V_137 )
{
struct V_75 * V_76 = V_137 -> V_17 . V_138 ;
struct V_9 * V_10 = F_94 ( V_137 ) ;
int V_57 , V_53 ;
T_1 V_182 ;
for ( V_53 = 0 ; V_53 < 3 ; V_53 ++ ) {
...
if ( ( V_57 & 0xff ) == 0 ) {
F_30 ( V_10 , V_183 , 0xff ) ;
}
V_182 = 0x70 & ~ ( V_76 -> V_127 << 4 ) ;
V_10 -> V_40 = F_40 ( V_10 , V_59 ) ;
if ( ( V_10 -> V_40 & V_182 ) == 0 ) {
V_10 -> V_40 |= V_182 ;
F_30 ( V_10 , V_59 ,
V_10 -> V_40 ) ;
}
V_10 -> V_147 = ( V_10 -> V_40 >> 4 ) & 0x07 ;
if ( F_50 ( V_10 ) ) {
V_57 = F_40 ( V_10 , V_184 ) ;
if ( ~ V_57 & 0x07 & V_10 -> V_147 ) {
F_109 ( & V_137 -> V_17 ,
L_37 ) ;
F_30 ( V_10 , V_184 ,
V_57 | 0x07 ) ;
...
int V_53 ;
F_29 ( & V_10 -> V_27 ) ;
if ( F_120 ( V_186 , V_10 -> V_187 + V_188 + V_188 / 2 )
|| ! V_10 -> V_31 ) {
if ( V_185 ) {
F_30 ( V_10 , V_66 ,
F_40 ( V_10 , V_66 ) | 0x40 ) ;
...
if ( V_54 )
goto exit;
V_137 = F_125 ( V_7 , V_74 ) ;
if ( ! V_137 ) {
V_54 = - V_164 ;
F_126 ( L_38 ) ;
goto exit;
}
V_54 = F_127 ( V_137 , & V_157 , 1 ) ;
if ( V_54 ) {
F_126 ( L_39 , V_54 ) ;
goto V_198;
}
V_54 = F_128 ( V_137 , V_76 ,
sizeof( struct V_75 ) ) ;
if ( V_54 ) {
F_126 ( L_40 ) ;
goto V_198;
...
{
int V_54 ;
unsigned short V_199 = 0 ;
struct V_75 V_76 ;
memset ( & V_76 , 0 , sizeof( struct V_75 ) ) ;
V_54 = F_88 ( & V_199 , & V_76 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_132 ( & V_200 ) ;
if ( V_54 )
return V_54 ;
V_54 = F_123 ( V_199 , & V_76 ) ;
if ( V_54 ) {
F_133 ( & V_200 ) ;
return V_54 ;
}
