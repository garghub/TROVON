...
if ( V_21 )
return V_21 ;
V_4 = F_17 ( sizeof( struct V_3 ) , V_34 ) ;
V_10 = F_17 ( sizeof( struct V_13 ) , V_34 ) ;
if ( ! V_4 || ! V_10 ) {
V_21 = - V_35 ;
goto V_23;
}
...
V_10 -> V_38 = F_7 ;
V_10 -> V_39 = F_13 ;
F_18 ( V_10 -> V_40 , F_19 ( & V_31 -> V_31 ) , sizeof( V_10 -> V_40 ) ) ;
F_18 ( V_10 -> V_41 , F_19 ( & V_31 -> V_31 ) , sizeof( V_10 -> V_41 ) ) ;
V_10 -> V_15 = V_4 ;
V_10 -> V_31 . V_42 = & V_31 -> V_31 ;
V_4 -> V_10 = V_10 ;
V_4 -> V_43 = F_20 ( V_31 -> V_44 . V_45 , F_21 ( & V_31 -> V_44 ) ) ;
if ( ! V_4 -> V_43 ) {
V_21 = - V_35 ;
goto V_23;
}
V_4 -> V_22 = F_22 ( & V_31 -> V_31 , L_3 ) ;
if ( F_23 ( V_4 -> V_22 ) ) {
V_21 = F_24 ( V_4 -> V_22 ) ;
goto V_46;
}
