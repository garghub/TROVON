...
if ( F_23 ( V_3 ) )
return false ;
for ( V_98 = 0 ; V_99 [ V_98 ] . V_100 ; V_98 ++ ) {
if ( ! strncmp ( V_3 -> V_100 , V_99 [ V_98 ] . V_100 ,
strlen ( V_99 [ V_98 ] . V_100 ) ) &&
! strncmp ( V_3 -> V_101 , V_99 [ V_98 ] . V_101 ,
strlen ( V_99 [ V_98 ] . V_101 ) ) ) {
return true ;
}
}
return false ;
...
if ( ! F_26 ( V_108 ) )
goto V_107;
F_27 ( V_3 -> V_39 -> V_109 , V_68 ) ;
V_3 -> V_4 = V_4 ;
F_28 ( V_3 -> V_39 -> V_109 , V_68 ) ;
F_5 ( V_17 , V_3 ,
L_34 ,
V_13 , V_79 -> V_29 + 'A' ,
