...
V_166 = F_69 ( V_158 ) ;
while ( ( V_85 = F_81 ( V_165 , V_166 , V_142 , V_145 ) ) == 0 )
...
return - V_174 ;
for ( V_5 = 0 ; V_5 < V_25 ; V_5 ++ ) {
F_88 ( V_7 -> V_56 [ V_5 ] , V_9 ++ ) ;
F_88 ( V_7 -> V_207 [ V_5 ] , V_9 ++ ) ;
}
return 0 ;
} else
return - V_208 ;
...
case V_209 :
if ( V_66 ) {
if ( F_89 ( & V_198 , V_200 , sizeof( V_198 ) ) )
return - V_174 ;
return F_90 ( & V_198 , V_200 ) ;
} else
return - V_208 ;
default:
return - V_208 ;
...
case V_212 :
if ( V_66 ) {
if ( F_89 ( V_195 , V_200 , sizeof( V_195 ) ) )
return - V_174 ;
V_8 = V_195 ;
} else {
V_8 = NULL ;
}
V_194 = F_91 ( & V_7 -> V_213 ) ;
if ( V_194 ) return V_194 ;
if ( ( V_8 = F_92 ( V_8 , NULL ) ) ) {
...
case V_214 :
if ( V_66 ) {
if ( F_89 ( V_196 , V_200 , sizeof( V_196 ) - 1 ) )
return - V_174 ;
} else
return - V_208 ;
V_194 = F_91 ( & V_7 -> V_213 ) ;
...
case V_216 :
if ( V_66 ) {
if ( F_89 ( & V_199 , V_200 , sizeof( V_199 ) ) )
return - V_174 ;
return F_95 ( & V_199 ) ;
} else
return - V_208 ;
...
return - V_174 ;
for ( V_5 = 0 ; V_5 < V_25 ; V_5 ++ ) {
if ( F_75 ( V_9 , V_7 -> V_235 . V_236 [ V_5 ] . V_237 . V_238 ,
V_233 ) )
return - V_174 ;
V_9 += V_233 ;
if ( F_75 ( V_9 , V_7 -> V_235 . V_236 [ V_5 ] . V_237 . V_239 , V_21 ) )
return - V_174 ;
V_9 += V_21 ;
if ( F_75 ( V_9 , V_7 -> V_235 . V_236 [ V_5 ] . V_237 . V_240 , V_234 ) )
return - V_174 ;
V_9 += V_234 ;
}
return ( V_233 + V_21 + V_234 ) * V_25 ;
} else
return - V_208 ;
break;
case V_241 :
...
return - V_174 ;
for ( V_5 = 0 ; V_5 < V_25 ; V_5 ++ ) {
if ( F_89 ( V_7 -> V_235 . V_236 [ V_5 ] . V_237 . V_238 , V_9 ,
V_233 ) )
return - V_174 ;
V_9 += V_233 ;
if ( F_89 ( V_7 -> V_235 . V_236 [ V_5 ] . V_237 . V_240 , V_9 , V_234 ) )
return - V_174 ;
V_9 += V_234 ;
if ( F_89 ( V_7 -> V_235 . V_236 [ V_5 ] . V_237 . V_239 , V_9 , V_21 ) )
return - V_174 ;
V_9 += V_21 ;
}
return 0 ;
...
if ( ! F_87 ( V_242 , V_9 , 1 ) )
return - V_174 ;
F_104 ( V_196 [ V_246 ] , V_9 ++ ) ;
switch ( V_196 [ V_246 ] ) {
case '\0' :
V_245 = 0 ;
case ',' :
V_196 [ V_246 ] = '\0' ;
strcpy ( V_7 -> V_1 [ V_165 ] -> V_247 [ V_5 ] , V_196 ) ;
V_246 = V_21 ;
break;
default:
V_246 ++ ;
...
strlen ( V_7 -> V_1 [ V_165 ] -> V_247 [ V_5 ] ) ?
V_7 -> V_1 [ V_165 ] -> V_247 [ V_5 ] : L_40 ,
( V_5 < 9 ) ? L_41 : L_42 ) ;
...
default:
if ( ( V_60 & V_249 ) == V_249 )
V_60 = ( ( V_60 >> V_250 ) & V_251 ) & V_252 ;
else
return - V_208 ;
if ( V_66 ) {
int V_5 ;
char * V_9 ;
if ( F_89 ( & V_197 , V_200 , sizeof( T_17 ) ) )
return - V_174 ;
V_197 . V_113 [ sizeof( V_197 . V_113 ) - 1 ] = 0 ;
if ( strlen ( V_197 . V_113 ) ) {
if ( ( V_9 = strchr ( V_197 . V_113 , ',' ) ) )
...
#ifdef F_77
if ( V_158 <= V_182 )
return ( F_105 ( V_158 - V_183 , V_163 , V_60 , V_66 ) ) ;
#endif
return - V_175 ;
#undef V_195
#undef V_196
...
static long
F_106 ( struct V_163 * V_163 , unsigned int V_60 , unsigned long V_66 )
{
int V_194 ;
F_74 ( & V_167 ) ;
...
static int
F_107 ( struct V_254 * V_255 , struct V_163 * V_256 )
{
T_14 V_158 = F_72 ( V_255 ) ;
int V_165 ;
int V_166 ;
int V_85 = - V_175 ;
F_74 ( & V_167 ) ;
...
static int
F_110 ( struct V_254 * V_255 , struct V_163 * V_256 )
{
T_14 V_158 = F_72 ( V_255 ) ;
F_74 ( & V_167 ) ;
if ( V_158 == V_168 ) {
...
T_9 * V_257 = NULL ;
while ( V_9 ) {
if ( V_9 -> V_161 == ( char * ) & ( V_256 -> V_169 ) ) {
if ( V_257 )
V_257 -> V_105 = V_9 -> V_105 ;
else
...
char *
F_112 ( char * V_109 , int V_23 )
{
T_1 * V_258 = V_7 -> V_1 [ V_23 ] ;
int V_5 ;
if ( strlen ( V_109 ) == 1 ) {
V_5 = V_109 [ 0 ] - '0' ;
if ( ( V_5 >= 0 ) && ( V_5 <= 9 ) )
if ( strlen ( V_258 -> V_247 [ V_5 ] ) )
return ( V_258 -> V_247 [ V_5 ] ) ;
}
return ( V_109 ) ;
}
int
F_113 ( int V_126 , int V_259 , int V_260 , int V_261
, int V_262 , char * V_109 )
{
int V_5 ;
T_3 V_68 ;
T_3 V_263 ;
V_68 = ( ( 1 << V_259 ) | ( 0x10000 << V_260 ) ) ;
V_263 = ( ( ( 1 << V_259 ) | ( 0x10000 << V_260 ) ) &
~ ( V_264 | V_265 | V_266 ) ) ;
for ( V_5 = 0 ; V_5 < V_25 ; V_5 ++ )
if ( F_49 ( V_7 -> V_126 [ V_5 ] ) &&
( V_7 -> V_27 [ V_5 ] != - 1 ) ) {
int V_267 = V_7 -> V_27 [ V_5 ] ;
if ( ( V_7 -> V_126 [ V_5 ] & V_268 ) &&
( ( V_261 != V_267 ) || ( V_262 != V_7 -> V_26 [ V_5 ] ) ) )
continue;
if ( ! strcmp ( F_112 ( V_109 , V_267 ) , L_22 ) )
continue;
if ( V_7 -> V_126 [ V_5 ] & V_127 )
continue;
if ( V_7 -> V_1 [ V_267 ] -> V_50 & V_94 ) {
if ( ( ( V_7 -> V_1 [ V_267 ] -> V_2 -> V_68 & V_68 ) == V_68 ) ||
( ( ( V_7 -> V_1 [ V_267 ] -> V_2 -> V_68 & V_263 ) == V_263 ) &&
( V_7 -> V_1 [ V_267 ] -> V_2 -> V_68 & V_269 ) ) ) {
if ( ( V_261 < 0 ) || ( V_262 < 0 ) ) {
V_7 -> V_126 [ V_5 ] &= V_268 ;
V_7 -> V_126 [ V_5 ] |= V_126 ;
F_46 () ;
...
if ( ( V_261 == V_267 ) && ( V_262 == V_7 -> V_26 [ V_5 ] ) ) {
V_7 -> V_126 [ V_5 ] &= V_268 ;
V_7 -> V_126 [ V_5 ] |= V_126 ;
F_46 () ;
return V_5 ;
...
void
F_114 ( int V_23 , int V_24 , int V_126 )
{
int V_5 ;
if ( ( V_23 < 0 ) || ( V_24 < 0 ) ) {
F_8 ( V_62 L_45 ,
...
for ( V_5 = 0 ; V_5 < V_25 ; V_5 ++ )
if ( ( ( ! V_126 ) || ( ( V_7 -> V_126 [ V_5 ] & V_271 ) == V_126 ) ) &&
( V_7 -> V_27 [ V_5 ] == V_23 ) &&
( V_7 -> V_26 [ V_5 ] == V_24 ) ) {
V_7 -> V_126 [ V_5 ] &= ( V_272 | V_268 ) ;
strcpy ( V_7 -> V_79 [ V_5 ] , L_46 ) ;
V_7 -> V_56 [ V_5 ] = 0 ;
V_7 -> V_207 [ V_5 ] = 0 ;
V_7 -> V_75 [ V_5 ] = 0 ;
F_115 ( & ( V_7 -> V_58 [ V_5 ] ) , 0 ) ;
F_116 ( V_7 -> V_57 [ V_5 ] ) ;
V_7 -> V_57 [ V_5 ] = NULL ;
F_46 () ;
if ( V_7 -> V_1 [ V_23 ] )
...
static int
F_81 ( int V_165 , int V_273 , const T_2 T_11 * V_142 , int V_10 )
{
int V_194 ;
int V_274 = V_7 -> V_1 [ V_165 ] -> V_2 -> V_275 ;
struct V_54 * V_55 = F_118 ( V_274 + V_10 , V_276 ) ;
if ( ! V_55 )
return - V_178 ;
F_119 ( V_55 , V_274 ) ;
if ( F_89 ( F_120 ( V_55 , V_10 ) , V_142 , V_10 ) ) {
F_26 ( V_55 ) ;
return - V_174 ;
}
V_194 = V_7 -> V_1 [ V_165 ] -> V_2 -> V_277 ( V_165 , V_273 , 1 , V_55 ) ;
if ( V_194 <= 0 )
F_26 ( V_55 ) ;
if ( V_194 > 0 )
V_7 -> V_207 [ F_12 ( V_165 , V_273 ) ] += V_194 ;
return V_194 ;
}
int
F_121 ( int V_165 , int V_273 , int V_278 , struct V_54 * V_55 )
{
int V_194 ;
struct V_54 * V_279 = NULL ;
int V_280 = V_55 -> V_10 ;
int V_65 = F_12 ( V_165 , V_273 ) ;
if ( V_7 -> V_57 [ V_65 ] ) {
F_28 ( & V_7 -> V_58 [ V_65 ] ) ;
V_279 = F_122 ( V_7 -> V_57 [ V_65 ] , V_55 ) ;
F_30 ( & V_7 -> V_58 [ V_65 ] ) ;
if ( ! V_279 )
return 0 ;
V_280 = * ( ( int * ) V_279 -> V_151 ) ;
F_63 ( V_279 , sizeof( int ) ) ;
if ( ! V_279 -> V_10 ) {
F_26 ( V_279 ) ;
return V_280 ;
}
V_278 = 1 ;
V_194 = V_7 -> V_1 [ V_165 ] -> V_2 -> V_277 ( V_165 , V_273 , V_278 , V_279 ) ;
} else {
int V_274 = V_7 -> V_1 [ V_165 ] -> V_2 -> V_275 ;
if ( F_123 ( V_55 ) < V_274 ) {
struct V_54 * V_281 ;
V_281 = F_124 ( V_55 , V_274 ) ;
F_8 ( V_13 L_47 , V_281 ? L_48 : L_49 ) ;
if ( ! V_281 ) return - V_178 ;
V_194 = V_7 -> V_1 [ V_165 ] -> V_2 -> V_277 ( V_165 , V_273 , V_278 , V_281 ) ;
if ( V_194 > 0 ) {
F_26 ( V_55 ) ;
} else {
F_26 ( V_281 ) ;
...
V_194 = V_7 -> V_1 [ V_165 ] -> V_2 -> V_277 ( V_165 , V_273 , V_278 , V_55 ) ;
}
}
if ( V_194 > 0 ) {
V_7 -> V_207 [ V_65 ] += V_194 ;
if ( V_7 -> V_57 [ V_65 ] ) {
F_28 ( & V_7 -> V_58 [ V_65 ] ) ;
V_7 -> V_57 [ V_65 ] -> V_282 ++ ;
F_30 ( & V_7 -> V_58 [ V_65 ] ) ;
...
static int
F_48 ( T_1 * V_267 , int V_165 , int V_283 , int V_284 )
{
int V_246 , V_285 , V_286 ;
F_125 ( & V_267 -> V_92 ) ;
if ( V_267 -> V_50 & V_94 )
return - 1 ;
if ( V_283 < 1 ) return 0 ;
V_286 = ( V_284 ) ? V_267 -> V_130 + V_283 : V_283 ;
if ( V_7 -> V_130 + V_283 > V_25 ) {
F_8 ( V_62 L_50 ,
V_25 ) ;
return - 1 ;
}
if ( ( V_284 ) && ( V_267 -> V_131 ) )
F_50 ( V_267 -> V_131 ) ;
if ( ! ( V_267 -> V_131 = F_126 ( sizeof( int ) * V_286 , V_276 ) ) ) {
F_8 ( V_62 L_51 ) ;
return - 1 ;
}
if ( ( V_284 ) && ( V_267 -> V_132 ) )
F_50 ( V_267 -> V_132 ) ;
if ( ! ( V_267 -> V_132 = F_126 ( sizeof( int ) * V_286 , V_276 ) ) ) {
F_8 ( V_62 L_52 ) ;
if ( ! V_284 )
F_50 ( V_267 -> V_131 ) ;
return - 1 ;
}
if ( ( V_284 ) && ( V_267 -> V_133 ) ) {
for ( V_246 = 0 ; V_246 < V_267 -> V_130 ; V_246 ++ )
F_51 ( & V_267 -> V_133 [ V_246 ] ) ;
F_50 ( V_267 -> V_133 ) ;
}
if ( ! ( V_267 -> V_133 = F_76 ( sizeof( struct V_287 ) * V_286 , V_276 ) ) ) {
F_8 ( V_62 L_53 ) ;
if ( ! V_284 ) {
F_50 ( V_267 -> V_132 ) ;
F_50 ( V_267 -> V_131 ) ;
...
for ( V_246 = 0 ; V_246 < V_286 ; V_246 ++ ) {
F_127 ( & V_267 -> V_133 [ V_246 ] ) ;
}
if ( ( V_284 ) && ( V_267 -> V_59 ) )
F_50 ( V_267 -> V_59 ) ;
V_267 -> V_59 = F_76 ( sizeof( T_8 ) * 2 * V_286 , V_276 ) ;
if ( ! V_267 -> V_59 ) {
F_8 ( V_62 L_54 ) ;
if ( ! V_284 ) {
F_50 ( V_267 -> V_133 ) ;
...
V_267 -> V_89 = V_267 -> V_59 + V_286 ;
for ( V_246 = 0 ; V_246 < V_286 ; V_246 ++ ) {
F_125 ( & V_267 -> V_59 [ V_246 ] ) ;
F_125 ( & V_267 -> V_89 [ V_246 ] ) ;
}
V_7 -> V_130 += V_283 ;
for ( V_246 = V_267 -> V_130 ; V_246 < V_286 ; V_246 ++ )
for ( V_285 = 0 ; V_285 < V_25 ; V_285 ++ )
if ( V_7 -> V_26 [ V_285 ] < 0 ) {
V_7 -> V_26 [ V_285 ] = V_246 ;
V_7 -> V_27 [ V_285 ] = V_165 ;
break;
}
V_267 -> V_130 = V_286 ;
return 0 ;
...
V_7 -> V_288 |= V_7 -> V_1 [ V_165 ] -> V_2 -> V_68 ;
}
}
static char * F_128 ( int V_23 )
{
if ( ( V_23 < 0 ) || ( V_23 >= V_6 ) )
return ( NULL ) ;
return ( V_7 -> V_113 [ V_23 ] ) ;
}
static int F_129 ( char * V_289 )
{ int V_5 ;
for ( V_5 = 0 ; V_5 < V_6 ; V_5 ++ )
{ if ( ! strcmp ( V_7 -> V_113 [ V_5 ] , V_289 ) )
return ( V_5 ) ;
}
return ( - 1 ) ;
}
int F_130 ( T_20 * V_290 )
{
...
if ( ! ( V_267 = F_126 ( sizeof( T_1 ) , V_177 ) ) ) {
F_8 ( V_62 L_57 ) ;
return 0 ;
}
V_267 -> V_303 = V_5 -> V_303 ;
V_267 -> V_304 = 0 ;
V_267 -> V_91 = 0 ;
V_267 -> V_50 = V_305 ;
V_267 -> V_119 = 0 ;
...
if ( ! V_7 -> V_1 [ V_165 ] )
break;
if ( F_48 ( V_267 , V_165 , V_5 -> V_130 , 0 ) ) {
F_24 ( & V_7 -> V_124 , V_50 ) ;
F_50 ( V_267 ) ;
return 0 ;
}
...
V_5 -> V_307 = F_37 ;
if ( ! strlen ( V_5 -> V_289 ) )
sprintf ( V_5 -> V_289 , L_58 , V_165 ) ;
for ( V_246 = 0 ; V_246 < V_165 ; V_246 ++ )
if ( ! strcmp ( V_5 -> V_289 , V_7 -> V_113 [ V_246 ] ) )
sprintf ( V_5 -> V_289 , L_58 , V_165 ) ;
V_7 -> V_1 [ V_165 ] = V_267 ;
strcpy ( V_7 -> V_113 [ V_165 ] , V_5 -> V_289 ) ;
F_46 () ;
V_7 -> V_129 ++ ;
F_41 () ;
F_24 ( & V_7 -> V_124 , V_50 ) ;
...
static int T_22 F_133 ( void )
{
int V_5 ;
char V_310 [ 50 ] ;
V_7 = F_134 ( sizeof( V_311 ) ) ;
if ( ! V_7 ) {
F_8 ( V_62 L_59 ) ;
return - V_312 ;
}
...
#endif
strcpy ( V_310 , V_318 ) ;
F_8 ( V_319 L_64 , F_132 ( V_310 ) ) ;
strcpy ( V_310 , V_320 ) ;
F_8 ( L_65 , F_132 ( V_310 ) ) ;
strcpy ( V_310 , V_321 ) ;
F_8 ( L_65 , F_132 ( V_310 ) ) ;
strcpy ( V_310 , V_322 ) ;
F_8 ( L_65 , F_132 ( V_310 ) ) ;
strcpy ( V_310 , V_323 ) ;
F_8 ( L_66 , F_132 ( V_310 ) ) ;
#ifdef F_137
F_8 ( L_67 ) ;
#else
F_8 ( L_3 ) ;
