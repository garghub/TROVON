...
static int F_92 ( struct V_12 * V_13 , struct V_137 * V_18 ,
T_2 V_138 )
{
int V_68 = - V_96 ;
struct V_1 * V_1 ;
...
static int F_94 ( struct V_12 * V_13 , const char * V_139 )
{
struct V_5 * V_6 ;
unsigned V_140 ;
unsigned long V_70 ;
...
static int F_95 ( struct V_12 * V_13 , const char * V_139 , int V_58 )
{
struct V_5 * V_6 ;
unsigned V_140 ;
char V_141 ;
...
static void F_97 ( void * V_143 , int V_144 )
{
...
V_21 = & V_1 -> V_6 -> V_21 ;
if ( V_21 -> type -> V_157 )
V_21 -> type -> V_157 ( V_21 , & V_1 -> V_17 , V_40 -> V_52 ) ;
}
F_26 ( V_13 , V_66 ) ;
return V_68 ;
}
...
unsigned V_158 , char * V_159 , unsigned V_160 )
{
int V_161 = 0 ;
unsigned long V_70 ;
struct V_12 * V_13 = (struct V_12 * ) V_10 -> V_14 ;
...
V_162 = 'E' ;
F_110 ( L_49 , V_162 ) ;
if ( V_6 -> V_21 . type -> V_164 )
V_161 += V_6 -> V_21 . type -> V_164 ( & V_6 -> V_21 , NULL , type ,
V_159 + V_161 ,
V_160 - V_161 ) ;
else
F_110 ( L_47 ) ;
...
F_110 ( L_51 , V_99 -> V_17 . V_18 -> V_133 ,
V_99 -> V_3 ? L_52 : L_53 ,
V_99 -> V_134 ) ;
if ( V_6 -> V_21 . type -> V_164 )
V_161 += V_6 -> V_21 . type -> V_164 ( & V_6 -> V_21 ,
& V_99 -> V_17 , type , V_159 + V_161 ,
V_160 - V_161 ) ;
}
}
break;
case V_166 :
F_30 (pg, &m->priority_groups, list) {
F_110 ( L_54 , V_6 -> V_21 . type -> V_133 ) ;
if ( V_6 -> V_21 . type -> V_164 )
V_161 += V_6 -> V_21 . type -> V_164 ( & V_6 -> V_21 , NULL , type ,
V_159 + V_161 ,
V_160 - V_161 ) ;
...
V_6 -> V_21 . type -> V_167 ) ;
F_30 (p, &pg->pgpaths, list) {
F_110 ( L_54 , V_99 -> V_17 . V_18 -> V_133 ) ;
if ( V_6 -> V_21 . type -> V_164 )
V_161 += V_6 -> V_21 . type -> V_164 ( & V_6 -> V_21 ,
& V_99 -> V_17 , type , V_159 + V_161 ,
V_160 - V_161 ) ;
...
V_68 = F_92 ( V_13 , V_18 , V_138 ) ;
F_13 ( V_10 , V_18 ) ;
V_132:
F_107 ( & V_13 -> V_32 ) ;
return V_68 ;
}
static int F_113 ( struct V_9 * V_10 , unsigned int V_168 ,
unsigned long V_169 )
{
struct V_12 * V_13 = V_10 -> V_14 ;
struct V_1 * V_1 ;
...
V_68 = - V_80 ;
F_43 ( & V_13 -> V_25 , V_70 ) ;
if ( ! V_68 && V_10 -> V_116 != F_114 ( V_19 -> V_173 ) >> V_174 )
V_68 = F_115 ( NULL , V_168 ) ;
if ( V_68 == - V_172 && ! F_116 ( V_127 ) ) {
F_42 ( V_74 , & V_13 -> V_29 ) ;
F_117 ( 10 ) ;
goto V_171;
}
return V_68 ? : F_118 ( V_19 , V_170 , V_168 , V_169 ) ;
}
static int F_119 ( struct V_9 * V_10 ,
T_5 V_175 , void * V_143 )
{
struct V_12 * V_13 = V_10 -> V_14 ;
struct V_5 * V_6 ;
struct V_1 * V_99 ;
...
F_30 (pg, &m->priority_groups, list) {
F_30 (p, &pg->pgpaths, list) {
V_113 = V_175 ( V_10 , V_99 -> V_17 . V_18 , V_10 -> V_176 , V_10 -> V_116 , V_143 ) ;
if ( V_113 )
goto V_132;
}
}
