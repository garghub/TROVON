...
V_62 = & V_90 -> V_94 [ V_83 ] ;
F_14 ( V_62 -> V_77 , V_62 -> V_78 , V_62 -> V_19 ) ;
}
F_54 () ;
V_95 = 1 ;
} else {
...
for ( V_83 = 0 ; V_83 < V_90 -> V_93 ; V_83 ++ ) {
V_62 = & V_90 -> V_94 [ V_83 ] ;
F_57 ( ( unsigned long ) V_62 -> V_77 ,
( unsigned long ) V_62 -> V_77 + V_62 -> V_19 ) ;
}
F_40 () ;
return 0 ;
}
void * T_5 F_58 ( void * V_77 , const void * V_78 , T_4 V_19 )
{
struct V_89 V_90 ;
struct V_91 V_62 ;
V_62 . V_77 = V_77 ;
...
F_59 ( & V_92 , 1 ) ;
V_95 = 0 ;
F_60 ( F_52 , ( void * ) & V_90 , V_96 ) ;
return V_77 ;
}
void T_5 F_61 ( struct V_91 * V_94 , int V_97 )
{
