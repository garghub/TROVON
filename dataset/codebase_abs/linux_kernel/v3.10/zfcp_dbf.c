...
char V_156 [ V_162 ] ;
struct V_4 * V_5 ;
V_5 = F_37 ( sizeof( struct V_4 ) , V_163 ) ;
if ( ! V_5 )
return - V_164 ;
F_38 ( & V_5 -> V_13 ) ;
F_38 ( & V_5 -> V_33 ) ;
...
F_38 ( & V_5 -> V_131 ) ;
F_38 ( & V_5 -> V_91 ) ;
sprintf ( V_156 , L_5 , F_39 ( & V_21 -> V_165 -> V_166 ) ) ;
V_5 -> V_30 = F_29 ( V_156 , V_167 , sizeof( struct V_77 ) ) ;
if ( ! V_5 -> V_30 )
goto V_168;
sprintf ( V_156 , L_6 , F_39 ( & V_21 -> V_165 -> V_166 ) ) ;
V_5 -> V_56 = F_29 ( V_156 , V_167 , sizeof( struct V_29 ) ) ;
if ( ! V_5 -> V_56 )
goto V_168;
sprintf ( V_156 , L_7 , F_39 ( & V_21 -> V_165 -> V_166 ) ) ;
V_5 -> V_16 = F_29 ( V_156 , V_167 * 2 , sizeof( struct V_2 ) ) ;
if ( ! V_5 -> V_16 )
goto V_168;
sprintf ( V_156 , L_8 , F_39 ( & V_21 -> V_165 -> V_166 ) ) ;
V_5 -> V_112 = F_29 ( V_156 , V_167 , sizeof( struct F_23 ) ) ;
if ( ! V_5 -> V_112 )
goto V_168;
sprintf ( V_156 , L_9 , F_39 ( & V_21 -> V_165 -> V_166 ) ) ;
V_5 -> V_155 = F_29 ( V_156 , V_167 , sizeof( struct F_28 ) ) ;
if ( ! V_5 -> V_155 )
goto V_168;
V_21 -> V_5 = V_5 ;
return 0 ;
