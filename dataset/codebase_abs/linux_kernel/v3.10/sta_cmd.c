...
int F_32 ( struct V_1 * V_2 , T_3 V_310 ,
T_1 V_5 , T_2 V_32 ,
void * V_76 , void * V_311 )
{
struct V_3 * V_312 = V_311 ;
int V_167 = 0 ;
switch ( V_310 ) {
case V_313 :
V_167 = F_33 ( V_2 , V_312 ) ;
break;
case V_31 :
V_167 = F_3 ( V_2 , V_312 , V_5 ,
V_76 ) ;
break;
case V_118 :
V_167 = F_16 ( V_2 , V_312 ,
V_5 ) ;
break;
case V_129 :
V_167 = F_17 ( V_312 , V_5 ,
V_76 ) ;
break;
case V_56 :
V_167 = F_10 ( V_2 , V_312 , V_5 ,
V_76 ) ;
break;
case V_74 :
V_167 = F_11 ( V_312 , V_5 ,
V_76 ) ;
break;
case V_78 :
V_167 = F_12 ( V_2 , V_312 , V_5 ,
V_76 ) ;
break;
case V_85 :
V_167 = F_13 ( V_2 , V_312 , V_5 ,
V_76 ) ;
break;
case V_314 :
V_167 = F_34 ( V_2 , V_312 , V_5 ,
( T_3 ) V_32 , V_76 ) ;
break;
case V_105 :
V_167 = F_14 ( V_2 , V_312 , V_5 ,
(struct V_98 * ) V_76 ) ;
break;
case V_315 :
V_167 = F_35 ( V_312 , V_76 ) ;
break;
case V_316 :
V_167 = F_36 ( V_312 ) ;
break;
case V_317 :
V_167 = F_37 ( V_2 , V_312 , V_76 ) ;
break;
case V_136 :
V_167 = F_18 ( V_2 , V_312 ,
V_76 ) ;
break;
case V_318 :
V_167 = F_38 ( V_2 , V_312 ,
V_76 ) ;
break;
case V_45 :
V_167 = F_9 ( V_312 ) ;
...
break;
case V_7 :
V_167 = F_1 ( V_2 , V_312 , V_5 ) ;
break;
case V_37 :
V_167 = F_5 ( V_2 , V_312 , V_5 ,
V_32 , V_76 ) ;
break;
case V_320 :
V_312 -> V_6 =
...
case V_323 :
V_312 -> V_6 = F_2 ( V_310 ) ;
V_312 -> V_11 . V_324 . V_325 =
( V_58 ) ( * ( ( T_2 * ) V_76 ) ) ;
memcpy ( & V_312 -> V_11 , V_76 ,
sizeof( struct V_326 ) ) ;
V_312 -> V_8 =
F_2 ( sizeof( struct V_326 ) +
V_10 ) ;
V_167 = 0 ;
break;
case V_327 :
V_312 -> V_6 = F_2 ( V_310 ) ;
V_312 -> V_11 . V_328 . V_13 = F_2 ( V_5 ) ;
V_312 -> V_11 . V_328 . V_329 = F_15 ( * ( T_2 * ) V_76 ) ;
V_312 -> V_8 =
F_2 ( sizeof( struct V_330 ) +
V_10 ) ;
V_167 = 0 ;
break;
case V_331 :
...
sizeof( struct V_332 ) ) ;
V_312 -> V_8 =
F_2 ( sizeof( struct V_332 ) +
V_10 ) ;
break;
case V_333 :
V_167 = F_40 ( V_2 , V_312 , V_5 , V_76 ) ;
break;
case V_334 :
V_312 -> V_6 = F_2 ( V_310 ) ;
V_312 -> V_11 . V_335 . V_13 = F_2 ( V_5 ) ;
V_312 -> V_11 . V_335 . V_75 = F_2 ( * ( T_1 * ) V_76 ) ;
V_312 -> V_8 =
F_2 ( sizeof( struct V_336 ) +
V_10 ) ;
break;
case V_337 :
if ( V_2 -> V_29 -> V_338 == V_339 )
V_2 -> V_29 -> V_338 = V_340 ;
V_312 -> V_6 = F_2 ( V_310 ) ;
V_312 -> V_8 = F_2 ( V_10 ) ;
break;
case V_341 :
V_2 -> V_29 -> V_338 = V_339 ;
V_312 -> V_6 = F_2 ( V_310 ) ;
V_312 -> V_8 = F_2 ( V_10 ) ;
break;
case V_342 :
V_167 = F_41 ( V_312 , V_76 ) ;
break;
case V_343 :
V_167 = F_42 ( V_312 , V_76 ) ;
break;
case V_344 :
V_167 = F_43 ( V_2 , V_312 , V_76 ) ;
break;
case V_168 :
V_167 = F_22 ( V_2 , V_312 ,
V_5 , V_32 ,
V_76 ) ;
break;
case V_203 :
V_167 = F_24 ( V_2 , V_312 ,
V_5 ) ;
break;
case V_345 :
V_167 = F_44 ( V_2 , V_312 , V_5 ,
V_76 ) ;
break;
case V_346 :
V_167 = F_45 ( V_312 , V_5 ,
V_76 ) ;
break;
case V_347 :
V_167 = F_46 ( V_2 , V_312 , V_5 , V_76 ) ;
break;
case V_348 :
F_6 ( V_2 -> V_29 -> V_30 ,
L_22 ) ;
...
case V_229 :
case V_231 :
V_167 = F_26 ( V_312 , V_5 , V_76 ) ;
break;
case V_350 :
V_312 -> V_6 = F_2 ( V_310 ) ;
if ( V_2 -> V_351 == V_352 )
V_312 -> V_11 . V_351 . V_353 =
V_354 ;
else if ( V_2 -> V_351 == V_355 )
V_312 -> V_11 . V_351 . V_353 =
V_356 ;
else if ( V_2 -> V_351 == V_357 )
V_312 -> V_11 . V_351 . V_353 = V_358 ;
V_312 -> V_8 = F_2 ( sizeof( struct
V_359 ) + V_10 ) ;
V_167 = 0 ;
break;
case V_243 :
V_167 = F_28 ( V_2 , V_312 , V_5 ) ;
break;
case V_271 :
V_167 = F_29 ( V_2 , V_312 , V_76 ) ;
break;
case V_305 :
V_167 = F_31 ( V_2 , V_312 , V_76 ) ;
break;
default:
F_4 ( V_2 -> V_29 -> V_30 ,
L_23 , V_310 ) ;
...
int F_47 ( struct V_1 * V_2 , V_58 V_360 )
{
int V_167 ;
T_1 V_209 = true ;
struct V_361 V_362 ;
...
V_167 = F_48 ( V_2 , V_337 ,
V_28 , 0 , NULL ) ;
if ( V_167 )
return - 1 ;
V_167 = F_48 ( V_2 , V_313 ,
V_39 , 0 , NULL ) ;
if ( V_167 )
return - 1 ;
V_167 = F_48 ( V_2 ,
...
V_2 -> V_29 -> V_386 = V_347 ;
V_368 . V_387 = V_388 ;
V_167 = F_48 ( V_2 , V_347 ,
V_28 , 0 , & V_368 ) ;
V_167 = - V_389 ;
return V_167 ;
}
