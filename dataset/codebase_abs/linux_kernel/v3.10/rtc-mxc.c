...
unsigned long V_66 ;
int V_61 ;
V_64 = F_25 ( V_9 , V_67 , 0 ) ;
if ( ! V_64 )
return - V_68 ;
V_10 = F_26 ( & V_9 -> V_6 , sizeof( * V_10 ) , V_69 ) ;
if ( ! V_10 )
return - V_70 ;
V_10 -> V_3 = V_9 -> V_71 -> V_72 ;
if ( ! F_27 ( & V_9 -> V_6 , V_64 -> V_73 ,
F_28 ( V_64 ) , V_9 -> V_74 ) )
return - V_75 ;
V_10 -> V_11 = F_29 ( & V_9 -> V_6 , V_64 -> V_73 ,
F_28 ( V_64 ) ) ;
V_10 -> V_76 = F_30 ( & V_9 -> V_6 , NULL ) ;
if ( F_31 ( V_10 -> V_76 ) ) {
F_32 ( & V_9 -> V_6 , L_1 ) ;
V_61 = F_33 ( V_10 -> V_76 ) ;
goto V_77;
...
F_32 ( & V_9 -> V_6 , L_2 , V_66 ) ;
V_61 = - V_81 ;
goto V_82;
}
V_40 |= V_83 ;
F_7 ( V_40 , ( V_10 -> V_11 + V_84 ) ) ;
if ( ( ( F_5 ( V_10 -> V_11 + V_84 ) ) & V_83 ) == 0 ) {
F_32 ( & V_9 -> V_6 , L_3 ) ;
V_61 = - V_85 ;
goto V_82;
}
F_36 ( V_9 , V_10 ) ;
V_10 -> V_44 = F_37 ( V_9 , 0 ) ;
if ( V_10 -> V_44 >= 0 &&
F_38 ( & V_9 -> V_6 , V_10 -> V_44 , F_14 ,
V_86 , V_9 -> V_74 , V_9 ) < 0 ) {
F_39 ( & V_9 -> V_6 , L_4 ) ;
V_10 -> V_44 = - 1 ;
}
if ( V_10 -> V_44 >= 0 )
F_40 ( & V_9 -> V_6 , 1 ) ;
V_41 = F_41 ( & V_9 -> V_6 , V_9 -> V_74 , & V_87 ,
V_88 ) ;
if ( F_31 ( V_41 ) ) {
V_61 = F_33 ( V_41 ) ;
goto V_89;
