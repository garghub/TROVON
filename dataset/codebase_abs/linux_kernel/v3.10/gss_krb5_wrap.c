...
T_3 V_64 ;
F_11 ( L_1 , V_44 ) ;
if ( V_29 -> V_43 -> V_92 == NULL )
return V_56 ;
if ( F_15 ( V_4 , V_5 , V_47 ) )
return V_56 ;
V_16 = V_87 = V_4 -> V_14 [ 0 ] . V_15 + V_5 ;
* V_16 ++ = ( unsigned char ) ( ( V_93 >> 8 ) & 0xff ) ;
* V_16 ++ = ( unsigned char ) ( V_93 & 0xff ) ;
if ( ( V_29 -> V_88 & V_94 ) == 0 )
V_88 |= V_95 ;
if ( ( V_29 -> V_88 & V_96 ) != 0 )
V_88 |= V_97 ;
...
V_91 = ( T_6 * ) V_89 ;
F_19 ( & V_57 ) ;
* V_91 = F_40 ( V_29 -> V_100 ++ ) ;
F_20 ( & V_57 ) ;
V_64 = (* V_29 -> V_43 -> V_92 )( V_29 , V_5 , V_4 , V_90 , V_24 ) ;
if ( V_64 )
return V_64 ;
V_38 = F_12 () ;
return ( V_29 -> V_67 < V_38 ) ? V_68 : V_69 ;
...
static T_3
F_41 ( struct V_28 * V_29 , int V_5 , struct V_3 * V_4 )
{
T_5 V_38 ;
T_4 V_71 ;
T_1 * V_16 ;
...
return V_56 ;
V_16 = V_4 -> V_14 [ 0 ] . V_15 + V_5 ;
if ( F_42 ( * ( ( V_50 * ) V_16 ) ) != V_93 )
return V_77 ;
V_88 = V_16 [ 2 ] ;
if ( ( ! V_29 -> V_59 && ( V_88 & V_95 ) ) ||
( V_29 -> V_59 && ! ( V_88 & V_95 ) ) )
return V_78 ;
if ( ( V_88 & V_98 ) == 0 ) {
F_11 ( L_3 , V_44 ) ;
...
if ( V_16 [ 3 ] != 0xff )
return V_77 ;
V_90 = F_43 ( ( V_50 * ) ( V_16 + 4 ) ) ;
V_101 = F_43 ( ( V_50 * ) ( V_16 + 6 ) ) ;
V_71 = F_44 ( ( T_6 * ) ( V_16 + 8 ) ) ;
if ( V_101 != 0 )
...
if ( V_38 > V_29 -> V_67 )
return V_68 ;
V_105 = F_45 (unsigned int, buf->head[0].iov_len, buf->len) ;
...
T_3
F_47 ( struct V_107 * V_108 , int V_5 ,
struct V_3 * V_4 , struct V_30 * * V_24 )
{
...
T_3
F_48 ( struct V_107 * V_108 , int V_5 , struct V_3 * V_4 )
{
struct V_28 * V_29 = V_108 -> V_109 ;
switch ( V_29 -> V_60 ) {
default:
