...
V_96 -> V_582 = F_88 ( F_105 ( V_5 -> V_193 ) ) ;
for ( V_154 = V_158 ; V_154 < V_159 ; V_154 ++ )
V_96 -> V_160 [ V_154 ] = F_88 ( V_5 -> V_124 -> V_156 . V_160 [ V_154 ] ) ;
V_96 -> V_43 = F_63 ( V_5 -> V_124 -> V_156 . V_43 ) ;
V_96 -> V_88 = F_63 ( V_583 ) ;
V_96 -> V_584 = F_63 ( V_5 -> V_124 -> V_156 . V_584 ) ;
V_96 -> V_585 = F_63 ( V_5 -> V_124 -> V_156 . V_585 ) ;
V_96 -> V_586 = F_63 ( V_5 -> V_450 -> V_587 ) ;
V_96 -> V_588 = F_63 ( V_589 ) ;
V_96 -> V_590 = F_88 ( V_5 -> V_124 -> V_156 . V_590 ) ;
V_96 -> V_591 = F_63 ( V_5 -> V_124 -> V_156 . V_591 ) ;
V_96 -> V_592 = F_63 ( V_5 -> V_405 ) ;
V_96 -> V_593 = F_63 ( V_5 -> V_124 -> V_156 . V_593 ) ;
V_96 -> V_594 = F_63 ( V_5 -> V_124 -> V_156 . V_594 ) ;
F_96 ( F_303 ( V_5 -> V_124 ) == V_5 -> V_124 -> V_156 . V_595 ) ;
V_251 = V_5 -> V_124 -> V_156 . V_595 ;
if ( F_304 ( V_5 , V_5 -> V_124 , V_251 , V_596 ) ) {
F_120 ( V_168 , L_63 ) ;
F_305 ( V_5 , 1 , V_597 ) ;
}
V_5 -> V_124 -> V_156 . V_582 = F_105 ( V_5 -> V_193 ) ;
F_306 ( V_5 ) ;
V_482:
F_83 ( V_5 ) ;
}
...
struct V_599 * V_600 )
{
T_4 V_593 = F_308 ( V_598 -> V_593 ) ;
T_4 V_594 = F_308 ( V_598 -> V_594 ) ;
T_2 V_601 ;
if ( V_593 == 0 && V_594 == 0 ) {
V_593 = 1 ;
V_594 = V_602 / 8 ;
...
static int F_309 ( struct V_4 * V_5 , struct V_574 * V_337 )
{
...
T_9 V_605 ;
if ( V_600 -> V_585 < 0 ) {
if ( V_600 -> V_591 > V_600 -> V_585 )
goto V_106;
V_604 = - V_600 -> V_585 ;
V_605 = V_600 -> V_585 - V_600 -> V_591 ;
} else {
if ( V_600 -> V_585 != V_606 )
goto V_106;
if ( V_600 -> V_591 < V_600 -> V_585 + V_600 -> V_601 * V_606 )
goto V_106;
V_604 = V_600 -> V_591 - V_606 ;
V_605 = V_600 -> V_584 - V_600 -> V_591 ;
}
if ( V_600 -> V_607 >= 0 ) {
if ( V_600 -> V_584 != V_608
|| V_600 -> V_585 != V_606
|| V_600 -> V_591 != V_606 + V_602
|| V_600 -> V_593 != 1
|| V_600 -> V_594 != V_602 / 8 )
goto V_106;
}
if ( V_603 < V_600 -> V_584 )
goto V_106;
if ( V_603 - V_600 -> V_584 < F_310 ( V_337 ) )
goto V_106;
...
if ( V_600 -> V_591 & 7 )
goto V_106;
if ( V_605 < ( V_600 -> V_582 + 7 ) / V_606 / 8 / 512 )
goto V_106;
return 0 ;
V_106:
F_120 ( V_168 , L_65
...
L_67 ,
V_600 -> V_607 ,
V_600 -> V_593 , V_600 -> V_594 ,
V_600 -> V_585 , V_600 -> V_591 , V_600 -> V_584 ,
( unsigned long long ) V_600 -> V_582 ,
( unsigned long long ) V_603 ) ;
return - V_563 ;
}
int F_311 ( struct V_4 * V_5 , struct V_574 * V_337 )
{
struct V_579 * V_96 ;
T_4 V_88 , V_43 ;
...
V_337 -> V_156 . V_595 = F_303 ( V_337 ) ;
if ( F_304 ( V_5 , V_337 , V_337 -> V_156 . V_595 , V_610 ) ) {
F_120 ( V_168 , L_68 ) ;
V_325 = V_611 ;
goto V_106;
}
V_88 = F_308 ( V_96 -> V_88 ) ;
V_43 = F_308 ( V_96 -> V_43 ) ;
if ( V_88 == V_583 ||
...
if ( F_308 ( V_96 -> V_588 ) != V_589 ) {
F_120 ( V_168 , L_72 ,
F_308 ( V_96 -> V_588 ) , V_589 ) ;
goto V_106;
}
V_337 -> V_156 . V_582 = F_312 ( V_96 -> V_582 ) ;
for ( V_154 = V_158 ; V_154 < V_159 ; V_154 ++ )
V_337 -> V_156 . V_160 [ V_154 ] = F_312 ( V_96 -> V_160 [ V_154 ] ) ;
V_337 -> V_156 . V_43 = F_308 ( V_96 -> V_43 ) ;
V_337 -> V_156 . V_590 = F_312 ( V_96 -> V_590 ) ;
V_337 -> V_156 . V_584 = F_308 ( V_96 -> V_584 ) ;
V_337 -> V_156 . V_585 = F_308 ( V_96 -> V_585 ) ;
V_337 -> V_156 . V_591 = F_308 ( V_96 -> V_591 ) ;
if ( F_307 ( V_5 , V_96 , & V_337 -> V_156 ) )
goto V_106;
if ( F_309 ( V_5 , V_337 ) )
goto V_106;
if ( F_308 ( V_96 -> V_591 ) != V_337 -> V_156 . V_591 ) {
F_120 ( V_168 , L_73 ,
F_308 ( V_96 -> V_591 ) , V_337 -> V_156 . V_591 ) ;
goto V_106;
}
if ( F_308 ( V_96 -> V_584 ) != V_337 -> V_156 . V_584 ) {
F_120 ( V_168 , L_74 ,
F_308 ( V_96 -> V_584 ) , V_337 -> V_156 . V_584 ) ;
goto V_106;
}
V_325 = V_559 ;
F_9 ( & V_5 -> V_14 -> V_22 ) ;
if ( V_5 -> V_10 . V_31 < V_255 ) {
unsigned int V_352 ;
V_352 = F_308 ( V_96 -> V_592 ) ;
V_352 = F_313 ( V_352 , V_406 ) ;
V_5 -> V_405 = V_352 ;
}
F_14 ( & V_5 -> V_14 -> V_22 ) ;
V_106:
...
void F_314 ( struct V_4 * V_5 , unsigned int line , const char * F_31 )
{
if ( ! F_315 ( V_580 , & V_5 -> V_43 ) ) {
F_316 ( & V_5 -> V_392 , V_617 + V_618 ) ;
V_5 -> V_619 . line = line ;
V_5 -> V_619 . F_31 = F_31 ;
}
}
void F_317 ( struct V_4 * V_5 )
{
if ( ! F_315 ( V_580 , & V_5 -> V_43 ) )
F_316 ( & V_5 -> V_392 , V_617 + 5 * V_618 ) ;
}
void F_318 ( struct V_4 * V_5 ) __must_hold( T_10 )
{
int V_154 ;
for ( V_154 = V_170 ; V_154 < V_171 ; V_154 ++ )
V_5 -> V_124 -> V_156 . V_160 [ V_154 + 1 ] = V_5 -> V_124 -> V_156 . V_160 [ V_154 ] ;
}
void F_319 ( struct V_4 * V_5 , int V_620 , T_2 V_200 ) __must_hold( T_10 )
{
if ( V_620 == V_158 ) {
if ( V_5 -> V_10 . V_341 == V_342 )
V_200 |= 1 ;
...
void F_321 ( struct V_4 * V_5 , int V_620 , T_2 V_200 ) __must_hold( T_10 )
{
unsigned long V_43 ;
F_23 ( & V_5 -> V_124 -> V_156 . V_157 , V_43 ) ;
F_319 ( V_5 , V_620 , V_200 ) ;
...
void F_322 ( struct V_4 * V_5 ) __must_hold( T_10 )
{
T_2 V_200 ;
...
F_319 ( V_5 , V_158 , V_200 ) ;
F_14 ( & V_5 -> V_124 -> V_156 . V_157 ) ;
F_93 ( V_5 , L_76 ) ;
F_99 ( V_5 ) ;
}
void F_323 ( struct V_4 * V_5 , T_2 V_200 ) __must_hold( T_10 )
{
unsigned long V_43 ;
...
if ( F_82 ( V_5 ) ) {
F_329 ( V_5 , V_624 -> V_625 , V_624 -> V_43 ) ;
V_325 = V_624 -> V_626 ( V_5 ) ;
F_330 ( V_5 ) ;
F_83 ( V_5 ) ;
}
F_331 ( V_627 , & V_5 -> V_43 ) ;
F_7 ( & V_5 -> V_12 ) ;
if ( V_624 -> V_628 )
...
if ( ! F_315 ( V_629 , & V_5 -> V_43 ) )
F_337 ( & V_5 -> V_14 -> V_423 , & V_5 -> V_383 . V_38 ) ;
}
F_14 ( & V_5 -> V_14 -> V_22 ) ;
}
int F_338 ( struct V_4 * V_5 , int (* V_626)( struct V_4 * ) ,
char * V_625 , enum V_633 V_43 )
{
int V_325 ;
F_96 ( V_45 != V_5 -> V_14 -> V_71 . V_54 ) ;
...
void F_325 ( struct V_4 * V_5 , int V_635 ) __must_hold( T_10 )
{
...
F_341 ( & V_5 -> V_14 -> V_423 , & V_5 -> V_381 ) ;
}
...
const char * F_343 ( enum V_85 V_86 )
{
...
int F_344 ( struct V_4 * V_5 , struct V_665 * V_154 )
{
struct V_114 * V_115 ;
F_345 ( V_65 ) ;
long V_666 ;
...
return F_351 ( V_673 -> V_10 ) ;
}
static char *
F_352 ( unsigned int type ) {
static char * V_679 [] = {
[ V_680 ] = L_130 ,
[ V_681 ] = L_131 ,
[ V_682 ] = L_132 ,
...
unsigned int
F_353 ( struct V_4 * V_5 , unsigned int type )
{
static struct V_672 V_691 = { 0 , 0 } ;
unsigned int V_692 = (
( V_693 == 0 ||
( ( 1 << F_50 ( V_5 ) ) & V_693 ) != 0 ) &&
( ( ( F_350 ( & V_691 ) % 100 ) + 1 ) <= V_694 ) ) ;
if ( V_692 ) {
V_695 ++ ;
if ( F_354 ( & V_696 ) )
F_160 ( V_168 , L_141 ,
