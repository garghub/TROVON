...
case V_151 : {
T_6 V_152 = V_153 ;
V_82 = F_68 ( ( T_6 V_105 * ) ( long ) V_128 -> V_154 ,
& V_152 , sizeof( T_6 ) ) ;
break;
}
#ifdef F_69
...
V_130 = F_65 ( V_128 -> V_131 , F_70 ( V_2 ) ) ;
break;
#endif
default:
V_82 = - V_132 ;
...
if ( V_82 )
return V_82 ;
if ( F_68 ( ( char V_105 * ) ( unsigned long ) V_128 -> V_154 , & V_130 , V_94 ) )
V_82 = - V_157 ;
return V_82 ;
}
int F_71 ( struct V_1 * V_2 , struct V_127 * V_128 )
{
int V_82 ;
union V_129 V_130 ;
int V_94 ;
...
if ( V_94 > sizeof( V_130 ) )
return - V_132 ;
if ( F_42 ( & V_130 , ( char V_105 * ) ( unsigned long ) V_128 -> V_154 , V_94 ) )
return - V_157 ;
V_82 = F_72 ( V_2 , V_128 -> V_131 , & V_130 ) ;
if ( V_82 == - V_132 ) {
V_82 = 0 ;
switch ( V_128 -> V_131 ) {
case V_133 :
V_2 -> V_5 . V_6 -> V_134 = F_73 ( V_128 -> V_131 , V_130 ) ;
break;
case V_135 :
V_2 -> V_5 . V_6 -> V_136 = F_73 ( V_128 -> V_131 , V_130 ) ;
break;
case V_137 ... V_138 :
V_108 = V_128 -> V_131 - V_137 ;
V_2 -> V_5 . V_139 [ V_108 ] = F_73 ( V_128 -> V_131 , V_130 ) ;
break;
case V_140 :
V_2 -> V_5 . V_141 = F_73 ( V_128 -> V_131 , V_130 ) ;
break;
#ifdef F_66
case V_142 ... V_143 :
if ( ! F_67 ( V_144 ) ) {
...
V_2 -> V_5 . V_149 . V_150 [ 3 ] = F_73 ( V_128 -> V_131 , V_130 ) ;
break;
#endif
#ifdef F_69
case V_155 :
