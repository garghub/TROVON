...
static char * F_121 ( T_8 * V_191 , char * V_192 )
{
char V_193 , * V_194 ;
int V_76 ;
for ( V_76 = 0 , V_194 = V_192 ; V_76 < 6 ; V_76 ++ ) {
V_193 = ( V_191 -> V_195 [ V_76 ] >> 1 ) & 0x7F ;
if ( V_193 != ' ' )
* V_194 ++ = V_193 ;
}
* V_194 ++ = '-' ;
V_76 = ( V_191 -> V_195 [ 6 ] >> 1 ) & 0x0F ;
if ( V_76 > 9 ) {
* V_194 ++ = '1' ;
V_76 -= 10 ;
}
...
F_123 ( & V_76 -> V_166 ) ;
#if F_15 ( V_32 )
if ( V_203 == V_33 || V_203 == V_35 )
F_121 ( ( T_8 * ) V_76 -> V_38 , V_198 ) ;
else {
#endif
for ( V_200 = 0 , V_201 = 0 ; V_200 < V_199 - 3 && V_201 < V_4 -> V_12 ; V_201 ++ ) {
V_198 [ V_200 ++ ] = F_124 ( V_76 -> V_38 [ V_201 ] ) ;
V_198 [ V_200 ++ ] = F_125 ( V_76 -> V_38 [ V_201 ] ) ;
V_198 [ V_200 ++ ] = ':' ;
}
if ( V_200 != 0 )
-- V_200 ;
...
#endif
sprintf ( V_202 , L_6 , V_76 -> V_18 ) ;
F_126 ( V_197 , L_7 ,
V_202 , V_203 , F_92 ( V_76 ) , V_198 , V_4 -> V_168 ) ;
F_127 ( & V_76 -> V_166 ) ;
}
static void F_128 ( struct V_196 * V_197 ,
struct V_204 * V_76 )
{
struct V_3 * V_4 = V_76 -> V_4 ;
int V_203 = V_4 ? V_4 -> type : 0 ;
char V_202 [ 16 ] ;
sprintf ( V_202 , L_6 , V_76 -> V_205 ) ;
F_126 ( V_197 , L_7 ,
V_202 , V_203 , V_161 | V_162 , L_8 ,
V_4 ? V_4 -> V_168 : L_5 ) ;
}
static int F_129 ( struct V_196 * V_197 , void * V_206 )
{
if ( V_206 == V_207 ) {
F_130 ( V_197 , L_9
L_10 ) ;
} else {
struct V_208 * V_125 = V_197 -> V_209 ;
if ( V_125 -> V_39 & V_210 )
F_128 ( V_197 , V_206 ) ;
else
F_122 ( V_197 , V_206 ) ;
...
static void * F_131 ( struct V_196 * V_197 , T_9 * V_211 )
{
return F_132 ( V_197 , V_211 , & V_78 , V_212 ) ;
}
static int F_133 ( struct V_213 * V_213 , struct V_214 * V_214 )
{
return F_134 ( V_213 , V_214 , & V_215 ,
sizeof( struct V_208 ) ) ;
}
static int T_10 F_135 ( struct V_71 * V_71 )
{
if ( ! F_136 ( L_11 , V_216 , V_71 -> V_217 , & V_218 ) )
return - V_219 ;
return 0 ;
}
static void T_11 F_137 ( struct V_71 * V_71 )
{
F_138 ( L_11 , V_71 -> V_217 ) ;
}
