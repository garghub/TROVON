...
V_25 -> V_26 = V_15 ;
V_25 -> V_55 = F_20 ;
V_44 = F_26 ( V_59 , sizeof( V_56 ) , V_44 ) ;
...
static int
F_29 ( struct V_9 * V_10 , const struct V_40 * V_41 )
{
struct V_27 * V_28 = V_10 -> V_29 -> V_28 ;
struct V_24 * V_25 = V_28 -> V_25 ;
int V_56 = - V_57 ;
T_3 V_70 = F_21 ( V_41 -> V_43 ) ;
T_3 V_46 = F_21 ( V_41 -> V_47 ) ;
T_3 V_71 = F_21 ( V_41 -> V_45 ) ;
switch ( V_41 -> V_72 ) {
case V_73 | V_74 | V_75 :
V_56 = F_22 ( V_10 , V_41 ) ;
break;
...
V_25 -> V_78 = 0 ;
V_25 -> V_37 = V_56 ;
V_56 = F_19 ( V_28 -> V_79 -> V_80 , V_25 , V_4 ) ;
if ( V_56 < 0 )
ERROR ( V_28 , L_6 , V_56 ) ;
}
return V_56 ;
}
static int F_30 ( struct V_9 * V_10 , unsigned V_81 , unsigned V_82 )
{
struct V_8 * V_15 = F_6 ( V_10 ) ;
struct V_27 * V_28 = V_10 -> V_29 -> V_28 ;
struct V_22 * V_35 = V_15 -> V_35 ;
...
if ( F_18 ( V_15 -> V_3 ) )
return - V_5 ;
for ( V_83 = 0 ; V_83 < V_85 && V_30 == 0 ; V_83 ++ ) {
V_25 = F_32 ( V_35 , V_4 ) ;
if ( V_25 ) {
V_25 -> V_6 = F_2 ( V_86 ,
V_4 ) ;
...
static int T_4
F_37 ( struct V_94 * V_95 , struct V_9 * V_10 )
{
...
V_100 . V_98 = V_34 ;
V_34 = - V_101 ;
V_23 = F_39 ( V_28 -> V_79 , & V_102 ) ;
if ( ! V_23 )
goto V_96;
V_15 -> V_35 = V_23 ;
V_15 -> V_35 -> V_103 = & V_102 ;
V_23 -> V_84 = V_28 ;
V_34 = - V_5 ;
V_34 = F_40 ( V_10 , V_104 , V_104 , NULL ) ;
if ( V_34 )
goto V_96;
return 0 ;
V_96:
...
{
F_46 ( & V_15 -> V_52 ) ;
F_47 ( & V_105 . V_20 , & V_15 -> V_52 ) ;
F_46 ( & V_105 . V_106 ) ;
F_47 ( & V_107 . V_20 , & V_105 . V_106 ) ;
F_47 ( & V_108 . V_20 , & V_105 . V_106 ) ;
V_108 . V_14 [ V_109 ] = 0xffc0 ;
V_108 . V_14 [ V_110 ] = 0xe3a0 ;
V_108 . V_14 [ V_111 ] = 0xfff0 ;
V_108 . V_14 [ V_112 ] = 0x0030 ;
return 0 ;
}
...
struct V_8 * V_15 ;
int V_34 ;
V_15 = F_2 ( sizeof *V_15 , V_113 ) ;
if ( ! V_15 )
return - V_5 ;
V_15 -> V_11 . V_12 . V_33 = L_8 ;
V_15 -> V_11 . V_79 = V_95 -> V_28 -> V_79 ;
F_46 ( & V_15 -> V_19 ) ;
F_49 ( & V_15 -> V_18 ) ;
V_34 = F_50 ( & V_15 -> V_11 ) ;
if ( V_34 < 0 )
goto V_114;
V_15 -> V_11 . V_12 . V_115 = V_116 ;
V_15 -> V_11 . V_12 . V_117 = F_37 ;
V_15 -> V_11 . V_12 . V_118 = F_41 ;
V_15 -> V_11 . V_12 . V_119 = F_30 ;
V_15 -> V_11 . V_12 . V_120 = F_29 ;
V_15 -> V_11 . V_12 . V_121 = F_33 ;
F_45 ( V_15 ) ;
F_51 ( & V_15 -> V_16 , F_8 ) ;
