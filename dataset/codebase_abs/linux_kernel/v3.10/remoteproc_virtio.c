...
static void F_27 ( struct V_14 * V_15 , T_3 V_39 )
{
struct V_18 * V_7 = F_8 ( V_15 ) ;
struct V_35 * V_36 ;
V_36 = ( void * ) V_7 -> V_6 -> V_37 + V_7 -> V_38 ;
V_36 -> V_39 = V_39 ;
F_2 ( & V_15 -> V_9 , L_6 , V_39 ) ;
}
...
V_36 = ( void * ) V_7 -> V_6 -> V_37 + V_7 -> V_38 ;
F_31 ( V_15 ) ;
V_36 -> V_41 = V_15 -> V_42 [ 0 ] ;
}
static void F_32 ( struct V_14 * V_15 , unsigned V_43 ,
void * V_44 , unsigned V_21 )
{
struct V_18 * V_7 = F_8 ( V_15 ) ;
struct V_35 * V_36 ;
void * V_45 ;
V_36 = ( void * ) V_7 -> V_6 -> V_37 + V_7 -> V_38 ;
V_45 = & V_36 -> V_24 [ V_36 -> V_46 ] ;
if ( V_43 + V_21 > V_36 -> V_47 || V_43 + V_21 < V_21 ) {
F_15 ( & V_15 -> V_9 , L_8 ) ;
return;
}
memcpy ( V_44 , V_45 + V_43 , V_21 ) ;
}
static void F_33 ( struct V_14 * V_15 , unsigned V_43 ,
const void * V_44 , unsigned V_21 )
{
struct V_18 * V_7 = F_8 ( V_15 ) ;
struct V_35 * V_36 ;
void * V_45 ;
...
memcpy ( V_45 + V_43 , V_44 , V_21 ) ;
}
static void F_34 ( struct V_19 * V_9 )
{
struct V_14 * V_15 = F_35 ( V_9 ) ;
struct V_18 * V_7 = F_8 ( V_15 ) ;
struct V_6 * V_6 = F_9 ( V_15 ) ;
F_36 ( & V_7 -> V_48 ) ;
F_37 ( V_7 ) ;
...
int F_39 ( struct V_18 * V_7 , int V_16 )
{
...
F_42 ( V_9 , L_11 , F_43 ( & V_15 -> V_9 ) , V_16 ) ;
V_53:
return V_23 ;
}
void F_44 ( struct V_18 * V_7 )
{
F_45 ( & V_7 -> V_15 ) ;
}
