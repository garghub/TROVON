...
static void F_20 ( const char * V_28 , T_5 V_73 ,
struct V_74 * V_75 ,
int (* F_18)( char * V_9 , int V_10 ) )
{
F_21 ( V_28 , V_73 , V_75 , F_18 , & V_76 ) ;
}
int T_6 F_22 ( void )
{
struct V_74 * V_75 ;
...
if ( F_24 ( V_75 ) )
return 1 ;
F_20 ( L_23 , 0444 , V_75 , F_9 ) ;
F_20 ( L_24 , 0444 , V_75 , F_4 ) ;
F_20 ( L_25 , 0444 , V_75 , F_8 ) ;
F_20 ( L_26 , 0444 , V_75 , F_13 ) ;
F_20 ( L_27 , 0444 , V_75 , F_16 ) ;
F_20 ( L_28 , 0444 , V_75 , F_14 ) ;
return 0 ;
}
void F_25 ( void )
{
...
#endif
F_10 ( & V_82 , V_55 ) ;
V_77 = F_26 ( V_83 , sizeof( * V_77 ) ) ;
if ( V_77 )
F_27 ( L_29 , * V_77 ) ;
V_77 = F_26 ( V_84 , sizeof( * V_77 ) ) ;
if ( V_77 )
F_27 ( L_30 , * V_77 ) ;
V_77 = F_26 ( V_85 , sizeof( * V_77 ) ) ;
if ( V_77 )
F_27 ( L_31 , * V_77 ) ;
#ifndef F_7
V_81 = F_26 ( V_86 , sizeof( * V_81 ) ) ;
if ( V_81 )
F_27 ( L_32 ,
V_81 -> V_87 ,
V_81 -> V_88 ,
V_81 -> V_89 ) ;
V_79 = F_26 ( V_90 , sizeof( * V_79 ) ) ;
if ( V_79 ) {
int V_30 ;
for ( V_30 = 0 ; V_30 < V_91 ; V_30 ++ )
F_27 ( L_33 ,
V_30 , V_79 -> V_92 [ V_30 ] , V_79 -> V_93 [ V_30 ] ,
V_79 -> V_94 [ V_30 ] ) ;
for ( V_30 = 0 ; V_30 < V_95 ; V_30 ++ )
F_27 ( L_34 ,
V_30 , V_79 -> V_96 [ V_30 ] , V_79 -> V_97 [ V_30 ] [ 0 ] ,
V_79 -> V_97 [ V_30 ] [ 1 ] ) ;
}
#else
#endif
