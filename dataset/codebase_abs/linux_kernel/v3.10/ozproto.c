...
const T_1 * V_48 , struct V_8 * V_10 )
{
struct V_3 * V_4 ;
struct V_49 * V_15 =
(struct V_49 * ) ( V_13 + 1 ) ;
...
do {
V_4 = V_141 -> V_4 ;
F_13 ( V_147 , 0 , V_141 -> type , NULL , 0 ) ;
F_66 ( V_4 , V_141 -> type ) ;
F_21 ( & V_57 ) ;
if ( V_150 < V_151 ) {
...
int V_160 = 0 ;
F_13 ( V_156 , 1 , ( T_2 ) type , NULL , ( unsigned ) V_153 ) ;
F_41 ( & V_57 ) ;
if ( remove ) {
F_23 (e, &g_timer_list) {
...
{
struct V_59 * V_131 = NULL ;
struct V_140 * V_141 ;
struct V_140 * V_161 ;
int V_160 = 0 ;
int V_162 = 0 ;
F_13 ( V_156 , 2 , ( T_2 ) type , NULL , 0 ) ;
F_41 ( & V_57 ) ;
...
struct V_3 * F_52 ( const T_1 * V_20 )
{
struct V_3 * V_4 ;
struct V_59 * V_60 ;
F_21 ( & V_57 ) ;
