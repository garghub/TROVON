...
static void F_19 ( void T_1 * V_1 , unsigned int V_37 ,
...
static void F_20 ( void T_1 * V_1 , unsigned long V_43 )
{
return;
}
struct V_44 * F_21 ( void T_1 * V_1 )
{
struct V_44 * V_45 ;
V_45 = F_22 ( sizeof( const struct V_44 ) , V_46 ) ;
if ( ! V_45 )
return NULL ;
F_6 ( L_12 ) ;
V_45 -> V_45 = & V_47 ;
