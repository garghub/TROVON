...
T_1 V_178 = F_91 ( ( T_1 ) ( ( V_34 >> 16 ) & 0x1F ) ) % 2 ;
...
static T_3 F_93 ( struct V_8 * V_9 , T_2 V_134 ,
T_3 V_34 , bool V_179 ,
T_1 V_180 )
{
T_3 V_181 ;
...
static int F_99 ( T_3 V_185 , T_2 V_35 , T_2 V_13 )
{
struct V_25 * V_26 ;
struct V_8 * V_9 ;
T_3 V_186 , V_187 ;
...
static int F_101 ( struct V_8 * V_9 , unsigned V_134 ,
T_3 V_34 , int * V_196 )
{
int V_188 = - V_11 ;
T_3 V_197 ;
...
( ( V_34 >> 27 ) >= ( V_198 >> 11 ) ) )
V_199 = true ;
V_156 = F_90 ( V_9 , V_34 , V_199 , V_37 ) ;
V_197 = F_93 ( V_9 , V_134 , V_34 ,
V_199 , V_198 ) ;
if ( V_37 )
V_197 = ( ( V_197 >> ( 12 + F_92 ( V_37 ) ) ) << 12 ) |
( V_197 & 0xfff ) ;
if ( F_88 ( V_9 ) &&
! F_85 ( V_9 ) &&
! F_52 ( V_9 ) ) {
...
struct V_8 * V_9 = V_26 -> V_28 ;
F_43 ( V_34 , V_6 ) ;
V_6 -> V_43 = F_102 ( V_9 , V_34 , & V_6 -> V_156 ) ;
if ( V_6 -> V_43 < 0 ) {
V_6 -> V_151 = V_153 ;
return;
}
...
static int F_105 ( T_4 V_157 , const T_4 * V_211 , unsigned V_212 ,
unsigned V_213 )
{
...
static int F_106 ( int V_214 , int V_219 )
{
if ( V_219 == 4 )
switch ( V_214 ) {
case 0x20 :
...
int V_214 = - 1 ;
if ( V_9 -> V_86 == 8 )
V_214 = F_105 ( V_157 , V_221 ,
F_14 ( V_221 ) ,
V_9 -> V_86 ) ;
else if ( V_9 -> V_86 == 4 )
V_214 = F_105 ( V_157 , V_222 ,
F_14 ( V_222 ) ,
V_9 -> V_86 ) ;
else {
F_3 ( L_71 , V_9 -> V_86 ) ;
...
return F_106 ( V_214 , V_9 -> V_86 ) ;
}
static void F_108 ( struct V_25 * V_26 , struct V_69 * V_6 ,
T_2 V_223 )
{
enum V_224 V_225 ;
const char * string ;
...
static inline void F_110 ( struct V_25 * V_26 ,
struct V_114 * V_115 )
{
struct V_8 * V_9 = V_26 -> V_28 ;
T_2 V_223 = ( V_115 -> V_229 >> 45 ) & 0x3 ;
T_2 V_230 = F_111 ( V_115 -> V_229 , 0x1f ) ;
T_4 V_231 = F_112 ( V_115 -> V_229 ) ;
T_3 V_34 ;
struct V_69 V_6 ;
if ( F_113 ( V_231 ) == V_232 )
return;
...
V_34 = F_59 ( V_115 ) ;
if ( V_223 == 2 )
V_6 . V_157 = F_114 ( V_115 -> V_229 ) ;
V_9 -> V_209 -> V_234 ( V_26 , V_34 , & V_6 ) ;
F_108 ( V_26 , & V_6 , V_223 ) ;
}
void F_115 ( int V_36 , struct V_114 * V_115 )
{
F_110 ( V_125 [ V_36 ] , V_115 ) ;
}
static int F_116 ( struct V_8 * V_9 , T_4 V_235 , T_4 V_236 )
{
...
F_26 ( 1 , L_80 , F_118 ( V_9 -> V_15 ) ) ;
F_26 ( 1 , L_81 , F_118 ( V_9 -> V_12 ) ) ;
F_26 ( 1 , L_82 , F_118 ( V_9 -> V_32 ) ) ;
return 0 ;
}
...
T_1 V_122 ;
unsigned V_134 ;
F_121 ( V_240 , V_9 -> V_241 ) ;
F_26 ( 0 , L_83 , V_9 -> V_241 ) ;
F_121 ( V_242 , V_239 ) ;
if ( V_239 & ( 1U << 21 ) ) {
F_121 ( V_243 , V_9 -> V_244 ) ;
...
static T_1 F_122 ( struct V_8 * V_9 , T_2 V_13 , int V_256 )
{
T_1 V_161 , V_257 ;
...
static void F_124 ( struct V_274 * V_45 , T_4 V_35 )
{
int V_275 ;
F_125 (cpu)
if ( F_60 ( V_275 ) == V_35 )
...
F_124 ( V_45 , V_35 ) ;
F_129 ( V_45 , V_278 , V_279 ) ;
F_130 (cpu, mask) {
struct V_280 * V_14 = F_131 ( V_279 , V_275 ) ;
...
static int F_133 ( struct V_285 * V_215 , T_4 V_35 , bool V_286 )
{
T_5 V_287 ;
int V_275 ;
if ( ! F_128 ( & V_287 , V_277 ) ) {
F_3 ( L_100 , V_42 ) ;
return false ;
}
F_124 ( V_287 , V_35 ) ;
F_129 ( V_287 , V_278 , V_279 ) ;
F_130 (cpu, cmask) {
struct V_280 * V_14 = F_131 ( V_279 , V_275 ) ;
if ( V_286 ) {
if ( V_14 -> V_281 & V_282 )
...
F_134 ( V_287 , V_278 , V_279 ) ;
F_132 ( V_287 ) ;
return 0 ;
}
static bool F_135 ( struct V_285 * V_215 , T_4 V_35 ,
struct V_1 * V_32 )
{
bool V_64 = true ;
T_1 V_290 , V_45 = 0x3 ;
if ( F_133 ( V_215 , V_35 , V_291 ) ) {
F_3 ( L_101 ) ;
return false ;
}
...
static void F_136 ( struct V_285 * V_215 , T_4 V_35 ,
struct V_1 * V_32 )
{
T_1 V_290 , V_45 = 0x3 ;
if ( ! V_215 -> V_294 )
...
if ( F_133 ( V_215 , V_35 , V_296 ) )
F_3 ( L_108 ) ;
}
static bool F_137 ( struct V_1 * V_32 , T_4 V_35 )
{
T_1 V_290 ;
T_2 V_297 = 0 ;
bool V_298 = false ;
...
static int F_139 ( struct V_25 * V_26 )
{
int V_300 ;
V_300 = F_140 ( V_26 ) ;
if ( V_300 < 0 )
...
static void F_142 ( struct V_25 * V_26 )
{
F_143 ( V_26 ) ;
if ( V_30 . V_31 >= 0x10 )
F_144 ( V_26 ) ;
...
V_26 -> V_313 = F_118 ( V_9 -> V_12 ) ;
V_26 -> V_314 = NULL ;
V_26 -> V_315 = F_16 ;
V_26 -> V_316 = F_17 ;
}
static struct V_301 * F_146 ( struct V_8 * V_9 )
{
T_2 V_302 = V_30 . V_31 ;
...
struct V_323 V_324 [ 2 ] ;
int V_6 = 0 , V_64 ;
T_4 V_35 = F_148 ( V_12 ) ;
V_64 = - V_325 ;
V_9 = F_149 ( sizeof( struct V_8 ) , V_277 ) ;
if ( ! V_9 )
goto V_326;
V_9 -> V_57 = V_35 ;
V_9 -> V_12 = V_12 ;
...
goto V_327;
V_64 = - V_238 ;
V_6 = F_116 ( V_9 , V_317 -> V_235 , V_317 -> V_236 ) ;
if ( V_6 )
goto V_327;
F_120 ( V_9 ) ;
V_64 = - V_11 ;
V_9 -> V_273 = V_9 -> V_209 -> V_328 ( V_9 ) ;
if ( V_9 -> V_273 < 0 )
goto V_329;
V_64 = - V_325 ;
V_324 [ 0 ] . type = V_330 ;
V_324 [ 0 ] . V_331 = V_9 -> V_53 [ 0 ] . V_88 ;
V_324 [ 0 ] . V_332 = true ;
V_324 [ 1 ] . type = V_333 ;
V_324 [ 1 ] . V_331 = V_9 -> V_273 ;
V_324 [ 1 ] . V_332 = false ;
V_26 = F_150 ( V_35 , F_14 ( V_324 ) , V_324 , 0 ) ;
if ( ! V_26 )
goto V_329;
V_26 -> V_28 = V_9 ;
...
V_64 = - V_325 ;
V_215 = F_149 ( sizeof( struct V_285 ) , V_277 ) ;
if ( ! V_215 )
goto V_341;
V_342 [ V_35 ] = V_215 ;
if ( ! F_137 ( V_32 , V_35 ) ) {
...
goto V_344;
F_3 ( L_119 ) ;
if ( ! F_135 ( V_215 , V_35 , V_32 ) )
goto V_344;
}
V_64 = F_147 ( V_2 ) ;
if ( V_64 < 0 ) {
F_117 ( L_120 , V_35 ) ;
F_136 ( V_215 , V_35 , V_32 ) ;
}
return V_64 ;
V_344:
F_157 ( V_215 ) ;
...
T_4 V_35 = F_148 ( V_2 ) ;
struct V_1 * V_32 = F_68 ( V_35 ) -> V_137 ;
struct V_285 * V_215 = V_342 [ V_35 ] ;
V_26 = F_161 ( & V_2 -> V_131 ) ;
F_142 ( V_26 ) ;
V_26 = F_155 ( & V_2 -> V_131 ) ;
if ( ! V_26 )
return;
V_9 = V_26 -> V_28 ;
F_136 ( V_215 , V_35 , V_32 ) ;
...
{
int V_6 = - V_238 ;
F_167 ( V_346 L_123 , V_311 ) ;
F_168 () ;
if ( F_169 () < 0 )
goto V_326;
V_6 = - V_325 ;
V_125 = F_149 ( F_170 () * sizeof( V_125 [ 0 ] ) , V_277 ) ;
V_342 = F_149 ( F_170 () * sizeof( V_342 [ 0 ] ) , V_277 ) ;
if ( ! ( V_125 && V_342 ) )
goto V_327;
V_279 = F_171 () ;
if ( ! V_279 )
