...
V_44 = F_22 ( V_16 , F_26 ( 0 ) ) ;
V_45 = F_22 ( V_16 , F_26 ( 1 ) ) ;
if ( V_44 < 0 || V_45 < 0 )
return - V_35 ;
V_40 = F_22 ( V_16 , F_27 ( 0 ) ) ;
V_41 = F_22 ( V_16 , F_27 ( 1 ) ) ;
V_42 = F_22 ( V_16 , F_28 ( 0 ) ) ;
V_43 = F_22 ( V_16 , F_28 ( 1 ) ) ;
...
F_25 ( L_13 ,
V_29 , F_29 ( V_28 ) , V_16 -> V_47 ) ;
F_30 ( V_26 -> type , V_29 , V_48 ) ;
return 0 ;
}
...
struct V_7 * V_8 ;
int V_17 ;
V_8 = F_32 ( & V_16 -> V_2 , sizeof( struct V_7 ) ,
V_51 ) ;
if ( ! V_8 )
return - V_52 ;
F_33 ( V_16 , V_8 ) ;
V_8 -> type = V_50 -> V_53 ;
F_34 ( & V_8 -> V_18 ) ;
if ( V_8 -> type != V_54 && ! V_19 )
F_35 ( V_16 ) ;
V_17 = F_36 ( & V_16 -> V_2 . V_55 , & V_56 ) ;
if ( V_17 )
return V_17 ;
V_8 -> V_57 = F_37 ( & V_16 -> V_2 ) ;
if ( F_38 ( V_8 -> V_57 ) ) {
V_17 = F_39 ( V_8 -> V_57 ) ;
goto error;
}
...
struct V_7 * V_8 = F_10 ( V_16 ) ;
F_12 ( & V_8 -> V_18 ) ;
if ( F_43 ( V_59 , V_8 -> V_60 + V_61 + V_61 / 2 )
|| ! V_8 -> V_62 ) {
int V_63 ;
F_44 ( & V_16 -> V_2 , L_14 ) ;
