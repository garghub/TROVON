...
bool F_24 ( T_4 V_63 , T_5 V_64 , T_6 V_65 )
{
bool V_58 = true ;
if ( V_60 -> V_66 )
V_58 = V_60 -> V_66 ( V_63 , V_64 , V_65 ) ;
else
F_23 ( 1 , L_9 ,
V_62 ) ;
return V_58 ;
}
void F_25 ( T_4 V_63 , T_5 V_64 , T_6 V_65 )
{
if ( V_60 -> V_67 )
V_60 -> V_67 ( V_63 , V_64 , V_65 ) ;
else
F_23 ( 1 , L_9 ,
V_62 ) ;
}
int F_26 ( struct V_60 * V_68 )
{
if ( ! V_68 )
return - V_42 ;
if ( V_60 != & V_69 )
