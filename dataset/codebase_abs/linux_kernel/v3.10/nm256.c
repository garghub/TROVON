...
static int F_92 ( struct V_116 * V_182 )
{
struct V_183 * V_54 = F_93 ( V_182 ) ;
struct V_184 * V_120 = F_94 ( V_182 ) ;
...
static int F_101 ( struct V_116 * V_182 )
{
struct V_183 * V_54 = F_93 ( V_182 ) ;
struct V_184 * V_120 = F_94 ( V_182 ) ;
struct V_1 * V_2 = V_120 -> V_80 ;
...
static int F_110 ( struct V_192 * V_116 )
{
struct V_1 * V_2 = V_116 -> V_193 ;
return F_107 ( V_2 ) ;
}
static int
F_111 ( struct V_184 * V_120 , struct V_183 * V_54 ,
struct V_1 * * V_194 )
{
struct V_1 * V_2 ;
int V_81 , V_195 ;
static struct V_196 V_160 = {
. V_197 = F_110 ,
} ;
T_3 V_24 ;
* V_194 = NULL ;
...
V_2 -> V_53 = - 1 ;
F_114 ( & V_2 -> V_52 ) ;
V_2 -> V_98 [ V_18 ] . V_106 = V_198 * 1024 ;
V_2 -> V_98 [ V_21 ] . V_106 = V_199 * 1024 ;
V_2 -> V_119 = F_115 ( V_54 , 0 ) ;
V_2 -> V_200 = F_115 ( V_54 , 1 ) ;
V_2 -> V_190 = F_116 ( V_2 -> V_200 , V_201 ,
V_120 -> V_121 ) ;
if ( V_2 -> V_190 == NULL ) {
F_15 ( V_10 L_14 ,
V_2 -> V_200 , V_201 ) ;
...
V_2 -> V_4 = F_89 ( V_2 -> V_200 , V_201 ) ;
if ( V_2 -> V_4 == NULL ) {
F_15 ( V_10 L_15 , V_2 -> V_200 ) ;
V_81 = - V_165 ;
goto V_202;
}
...
V_2 -> V_9 += V_211 + V_212 ;
if ( V_213 >= V_2 -> V_9 && V_213 < V_2 -> V_175 )
V_2 -> V_175 = V_213 ;
else {
if ( ( V_81 = F_88 ( V_2 ) ) < 0 )
goto V_202;
...
V_2 -> V_29 = 0 ;
F_72 ( V_2 ) ;
if ( ( V_81 = F_117 ( V_120 , V_215 , V_2 , & V_160 ) ) < 0 )
goto V_202;
F_118 ( V_120 , & V_54 -> V_182 ) ;
* V_194 = V_2 ;
return 0 ;
V_202:
F_107 ( V_2 ) ;
...
static int F_119 ( struct V_183 * V_54 ,
...
V_81 = F_123 ( V_224 , V_171 , V_225 , 0 , & V_120 ) ;
if ( V_81 < 0 )
return V_81 ;
switch ( V_54 -> V_116 ) {
case V_226 :
...
sprintf ( V_120 -> V_230 , L_34 , V_120 -> V_121 ) ;
sprintf ( V_120 -> V_231 , L_35 ,
V_120 -> V_230 ,
V_2 -> V_119 , V_2 -> V_200 , V_2 -> V_53 ) ;
if ( ( V_81 = F_125 ( V_120 ) ) < 0 ) {
F_124 ( V_120 ) ;
return V_81 ;
}
F_126 ( V_54 , V_120 ) ;
...
static void F_127 ( struct V_183 * V_54 )
{
F_124 ( F_128 ( V_54 ) ) ;
F_126 ( V_54 , NULL ) ;
}
