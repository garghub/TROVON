...
{
struct V_94 V_74 ;
struct V_89 * V_90 = V_92 -> V_86 . V_95 ;
struct V_1 * V_2 ;
int V_96 = 0 ;
if ( V_90 == NULL ) {
F_36 ( & V_92 -> V_86 , L_5 ) ;
...
V_2 = F_39 ( & V_92 -> V_86 , sizeof( struct V_1 ) , V_98 ) ;
if ( ! V_2 ) {
F_36 ( & V_92 -> V_86 , L_6 ) ;
return - V_99 ;
}
V_2 -> V_19 = V_92 ;
V_2 -> V_87 = F_40 ( L_7 , & V_92 -> V_86 ,
V_2 , & V_100 ) ;
if ( F_41 ( V_2 -> V_87 ) )
return F_42 ( V_2 -> V_87 ) ;
V_2 -> V_64 = V_88 ;
V_2 -> V_20 = ( V_90 ) ? V_90 -> V_101 : V_22 ;
memset ( & V_74 , 0 , sizeof( struct V_94 ) ) ;
V_74 . type = V_102 ;
V_74 . V_103 = V_90 -> V_104 ;
V_2 -> V_84 = F_43 ( L_8 , & V_92 -> V_86 , V_2 ,
& V_105 , & V_74 ) ;
if ( F_41 ( V_2 -> V_84 ) ) {
V_96 = F_42 ( V_2 -> V_84 ) ;
goto V_106;
}
V_2 -> V_84 -> V_74 . V_75 = V_90 -> V_107 ;
