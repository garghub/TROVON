...
V_16 -> V_153 = F_52 ( V_153 ) ;
V_16 -> V_155 = F_52 ( V_155 ) ;
...
static void F_58 ( struct V_145 * V_146 )
{
struct V_15 * V_16 = F_59 ( V_146 ) ;
F_60 ( V_16 ) ;
F_50 ( F_61 ( V_16 -> V_153 ) ,
sizeof( struct V_3 ) ) ;
F_50 ( F_61 ( V_16 -> V_155 ) , V_161 ) ;
F_55 ( V_16 ) ;
}
