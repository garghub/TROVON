...
int V_7 ;
if ( F_61 ( V_2 , 0x5a , 9 ) )
if ( ( V_7 = F_1 ( V_2 , & V_331 [ 0 ] , 1 ) ) < 0 )
return V_7 ;
if ( ( V_7 = F_1 ( V_2 , & V_331 [ 1 ] , F_42 ( V_331 ) - 1 ) ) < 0 )
return V_7 ;
V_15 = F_156 ( V_2 , L_47 ) ;
if ( ! V_15 )
return - V_46 ;
...
struct V_1 * V_337 ;
V_337 = F_14 ( V_28 ) ;
V_335 = F_8 ( V_337 , 0x7a ) >> 14 ;
V_336 = F_8 ( V_337 , 0x20 ) >> 8 ;
V_38 -> V_21 . V_34 . V_36 [ 0 ] = ( V_335 << 1 ) + V_336 ;
return 0 ;
}
static int F_185 ( struct V_14 * V_28 ,
struct V_37 * V_38 )
{
T_2 V_335 , V_336 , V_338 ;
struct V_1 * V_337 ;
V_337 = F_14 ( V_28 ) ;
V_335 = V_38 -> V_21 . V_34 . V_36 [ 0 ] >> 1 ;
V_336 = V_38 -> V_21 . V_34 . V_36 [ 0 ] & 1 ;
V_338 = F_8 ( V_337 , 0x7a ) ;
F_35 ( V_337 , 0x7a , ( V_338 & 0x3FFF ) + ( V_335 << 14 ) ) ;
V_338 = F_8 ( V_337 , 0x20 ) ;
F_35 ( V_337 , 0x20 , ( V_338 & 0xFEFF ) + ( V_336 << 8 ) ) ;
return 0 ;
}
...
struct V_1 * V_337 = F_14 ( V_28 ) ;
F_7 ( & V_337 -> V_25 ) ;
V_342 = F_8 ( V_337 , V_26 ) & V_27 ;
F_9 ( V_337 , V_26 , V_27 , 0 ) ;
V_343 = F_8 ( V_337 , 0x60 ) &
V_341 [ V_28 -> V_43 ] . V_20 ;
F_9 ( V_337 , V_26 , V_27 , V_342 ) ;
F_10 ( & V_337 -> V_25 ) ;
V_38 -> V_21 . V_34 . V_36 [ 0 ] = V_343 >>
V_341 [ V_28 -> V_43 ] . V_122 ;
return 0 ;
}
...
struct V_29 * V_30 )
{
static const char * V_344 [] = { L_73 , L_74 } ;
return F_11 ( V_28 , V_30 , V_344 , 2 ) ;
}
...
{
int V_6 , V_7 ;
for ( V_6 = 0 ; V_6 < F_42 ( V_349 ) ; V_6 ++ )
if ( ( V_7 = F_2 ( V_2 -> V_8 -> V_9 , F_198 ( & V_349 [ V_6 ] , V_2 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
...
{
int V_6 , V_7 ;
for ( V_6 = 0 ; V_6 < F_42 ( V_352 ) ; V_6 ++ )
if ( ( V_7 = F_2 ( V_2 -> V_8 -> V_9 , F_198 ( & V_352 [ V_6 ] , V_2 ) ) ) < 0 )
return V_7 ;
return 0 ;
}
