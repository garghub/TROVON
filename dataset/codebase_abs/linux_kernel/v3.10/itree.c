...
static void F_53 ( struct V_87 * V_88 , T_4 V_26 )
{
struct V_3 * V_3 = V_88 -> V_89 ;
if ( V_26 > V_3 -> V_63 ) {
F_54 ( V_3 , V_26 , V_3 -> V_63 ) ;
F_39 ( V_3 ) ;
}
}
static int F_55 ( struct V_84 * V_84 , struct V_87 * V_88 ,
T_4 V_85 , unsigned V_86 , unsigned V_90 ,
struct V_81 * * V_91 , void * * V_92 )
{
int V_93 ;
V_93 = F_56 ( V_88 , V_85 , V_86 , V_90 , V_91 , F_30 ) ;
if ( F_57 ( V_93 ) )
F_53 ( V_88 , V_85 + V_86 ) ;
return V_93 ;
}
static T_3 F_58 ( struct V_87 * V_88 , T_3 V_4 )
{
return F_59 ( V_88 , V_4 , F_30 ) ;
}
