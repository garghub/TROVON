...
if ( F_64 ( V_11 -> V_14 ) )
return - V_196 ;
F_120 ( & V_11 -> V_7 , & V_197 ) ;
F_121 ( & V_11 -> V_198 ) ;
F_121 ( & V_11 -> V_89 ) ;
F_122 ( & V_11 -> V_199 ) ;
V_11 -> V_49 = V_143 ;
if ( ! strcmp ( V_11 -> V_14 , V_200 ) )
V_178 = V_11 ;
return 0 ;
}
static int T_4 F_123 ( struct V_6 * * V_201 ,
struct V_6 * * V_202 )
{
unsigned int V_203 ;
...
V_203 = sizeof( struct V_6 ) * V_205 ;
* V_202 = NULL ;
* V_201 = F_124 ( V_203 ) ;
memset ( * V_201 , 0 , V_203 ) ;
* V_202 = ( void * ) ( * V_201 ) + sizeof( struct V_6 ) ;
V_208 ++ ;
F_17 ( L_48 ,
V_208 * V_205 ) ;
return 0 ;
...
{
struct V_6 * V_201 , * V_202 ;
F_17 ( L_49 , V_5 -> V_209 -> V_14 ,
V_5 -> V_210 -> V_14 ) ;
F_123 ( & V_201 , & V_202 ) ;
V_201 -> V_8 = V_5 ;
F_121 ( & V_201 -> V_7 ) ;
F_126 ( & V_201 -> V_7 , & V_5 -> V_209 -> V_198 ) ;
V_5 -> V_209 -> V_211 ++ ;
V_202 -> V_8 = V_5 ;
F_121 ( & V_202 -> V_7 ) ;
F_126 ( & V_202 -> V_7 , & V_5 -> V_210 -> V_89 ) ;
V_5 -> V_210 -> V_90 ++ ;
return 0 ;
}
static int T_4 F_127 ( struct V_1 * V_5 )
{
if ( ! V_5 || ! V_5 -> V_209 || ! V_5 -> V_210 || ! V_5 -> V_123 )
return - V_15 ;
if ( V_5 -> V_20 & V_212 )
return - V_196 ;
F_17 ( L_50 ,
V_5 -> V_209 -> V_14 , V_5 -> V_210 -> V_14 ) ;
if ( V_5 -> V_209 -> V_49 != V_143 )
F_119 ( V_5 -> V_209 ) ;
...
static int T_4 F_128 ( struct V_1 * * V_213 )
{
unsigned int V_4 = 0 ;
unsigned int V_203 ;
if ( V_207 ) {
...
while ( V_213 [ V_4 ++ ] )
V_206 += V_205 ;
V_203 = sizeof( struct V_6 ) * V_206 ;
F_17 ( L_52 ,
V_100 , V_203 , V_206 ) ;
V_207 = F_124 ( V_203 ) ;
memset ( V_207 , 0 , V_203 ) ;
return 0 ;
}
...
if ( ! F_59 ( V_11 ) )
return 0 ;
return F_130 ( V_11 -> V_97 . V_214 . V_215 ,
V_11 -> V_97 . V_214 . V_216 ,
V_11 -> V_97 . V_214 . V_217 ) ;
}
...
if ( ! F_59 ( V_11 ) )
return 0 ;
return F_132 ( V_11 -> V_97 . V_214 . V_215 ,
V_11 -> V_97 . V_214 . V_216 ,
V_11 -> V_97 . V_214 . V_217 ) ;
}
...
struct V_146 * V_147 )
{
return F_138 ( V_11 -> V_97 . V_214 . V_215 ,
V_147 -> V_151 ) ;
}
static int F_139 ( struct V_10 * V_11 ,
struct V_146 * V_147 )
{
return F_140 ( V_11 -> V_97 . V_214 . V_215 ,
V_147 -> V_151 ,
V_147 -> V_152 ) ;
}
...
struct V_146 * V_147 )
{
return F_142 ( V_11 -> V_97 . V_214 . V_215 ,
V_147 -> V_152 ) ;
}
...
T_1 F_5 ( struct V_10 * V_11 , T_3 V_220 )
{
if ( V_11 -> V_66 & V_221 )
return F_155 ( V_11 -> V_188 + V_220 ) ;
else
return F_156 ( V_11 -> V_188 + V_220 ) ;
}
void F_7 ( T_1 V_22 , struct V_10 * V_11 , T_3 V_220 )
{
if ( V_11 -> V_66 & V_221 )
F_157 ( V_22 , V_11 -> V_188 + V_220 ) ;
else
F_158 ( V_22 , V_11 -> V_188 + V_220 ) ;
}
...
int T_4 F_163 ( struct V_1 * * V_213 )
{
int V_165 , V_4 ;
if ( ! V_222 )
return - V_15 ;
...
V_4 = 0 ;
do {
V_165 = F_127 ( V_213 [ V_4 ] ) ;
F_4 ( V_165 && V_165 != - V_196 ,
L_55 ,
V_213 [ V_4 ] -> V_209 -> V_14 , V_213 [ V_4 ] -> V_210 -> V_14 , V_165 ) ;
} while ( V_213 [ ++ V_4 ] );
return 0 ;
}
static void T_4 F_164 ( struct V_10 * V_11 )
{
if ( ! V_178 || V_178 -> V_49 == V_194 )
F_113 ( L_56 ,
V_100 , V_200 ) ;
else if ( V_178 -> V_49 == V_143 && V_11 != V_178 )
F_165 ( V_200 ) ;
}
int T_4 F_165 ( const char * V_224 )
{
struct V_10 * V_11 ;
F_17 ( L_25 , V_224 , V_100 ) ;
V_11 = F_64 ( V_224 ) ;
if ( ! V_11 ) {
F_4 ( 1 , L_57 , V_224 ) ;
return - V_15 ;
...
if ( ! V_11 )
return - V_15 ;
F_87 ( & V_11 -> V_199 , V_66 ) ;
V_165 = F_99 ( V_11 ) ;
F_93 ( & V_11 -> V_199 , V_66 ) ;
return V_165 ;
}
...
int F_176 ( struct V_10 * V_11 , struct V_228 * V_229 )
{
struct V_1 * V_88 ;
struct V_2 * V_3 ;
int V_4 , V_61 , V_230 , V_231 , V_232 ;
int V_165 = 0 ;
V_230 = F_52 ( V_11 ) ;
for ( V_4 = 0 ; V_4 < V_230 ; V_4 ++ ) {
( V_229 + V_165 ) -> V_14 = ( V_11 -> V_109 + V_4 ) -> V_14 ;
( V_229 + V_165 ) -> V_233 = ( V_11 -> V_109 + V_4 ) -> V_110 ;
( V_229 + V_165 ) -> V_234 = ( V_11 -> V_109 + V_4 ) -> V_110 ;
( V_229 + V_165 ) -> V_66 = V_225 ;
V_165 ++ ;
}
V_231 = F_53 ( V_11 ) ;
for ( V_4 = 0 ; V_4 < V_231 ; V_4 ++ ) {
( V_229 + V_165 ) -> V_14 = ( V_11 -> V_113 + V_4 ) -> V_14 ;
( V_229 + V_165 ) -> V_233 = ( V_11 -> V_113 + V_4 ) -> V_114 ;
( V_229 + V_165 ) -> V_234 = ( V_11 -> V_113 + V_4 ) -> V_114 ;
( V_229 + V_165 ) -> V_66 = V_226 ;
V_165 ++ ;
}
V_3 = V_11 -> V_89 . V_9 ;
V_4 = 0 ;
...
V_88 = F_1 ( & V_3 , & V_4 ) ;
V_232 = F_54 ( V_88 ) ;
for ( V_61 = 0 ; V_61 < V_232 ; V_61 ++ ) {
( V_229 + V_165 ) -> V_14 = ( V_88 -> V_117 + V_61 ) -> V_14 ;
( V_229 + V_165 ) -> V_233 = ( V_88 -> V_117 + V_61 ) -> V_118 ;
( V_229 + V_165 ) -> V_234 = ( V_88 -> V_117 + V_61 ) -> V_119 ;
( V_229 + V_165 ) -> V_66 = V_227 ;
V_165 ++ ;
}
}
return V_165 ;
}
int F_177 ( struct V_10 * V_11 , struct V_228 * V_229 )
{
int V_4 , V_231 ;
int V_165 = 0 ;
V_231 = F_53 ( V_11 ) ;
...
const char * V_14 , struct V_228 * V_235 )
{
int V_165 ;
...
struct V_236 * F_179 ( struct V_10 * V_11 )
{
struct V_80 * V_41 ;
struct V_1 * V_5 ;
struct V_78 * V_81 ;
...
V_100 , V_237 ) ;
F_65 (temp_oh, &omap_hwmod_list, node) {
if ( ! strcmp ( V_140 -> V_12 -> V_14 , V_237 ) ) {
F_17 ( L_60 ,
V_100 , V_140 -> V_14 ) ;
...
int F_189 ( struct V_10 * V_11 , T_2 V_238 )
{
int V_86 ;
unsigned long V_66 ;
if ( ! V_11 )
...
int F_193 ( struct V_10 * V_11 , int V_241 , int V_242 )
{
int V_243 ;
F_194 () ;
if ( ! V_11 || ! V_11 -> V_62 || ! V_11 -> V_109 || V_241 < 0 ||
V_241 >= V_11 -> V_62 -> V_64 )
return - V_15 ;
for ( V_243 = 0 ; V_11 -> V_109 [ V_243 ] . V_110 >= 0 ; V_243 ++ )
;
if ( V_242 >= V_243 )
return - V_15 ;
if ( ! V_11 -> V_62 -> V_244 ) {
V_11 -> V_62 -> V_244 = F_195 ( sizeof( int ) * V_11 -> V_62 -> V_64 ,
V_245 ) ;
if ( ! V_11 -> V_62 -> V_244 )
return - V_223 ;
}
V_11 -> V_62 -> V_244 [ V_241 ] = V_242 ;
return 0 ;
}
void T_4 F_196 ( void )
{
...
const char * F_200 ( struct V_10 * V_11 )
{
if ( ! V_11 )
return NULL ;
return V_11 -> V_87 ;
