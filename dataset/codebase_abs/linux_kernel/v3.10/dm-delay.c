...
V_9 -> V_58 = V_3 -> V_43 -> V_59 ;
if ( F_44 ( V_9 ) )
V_9 -> V_60 = V_3 -> V_46 +
F_45 ( V_30 , V_9 -> V_60 ) ;
return F_36 ( V_3 , V_3 -> V_47 , V_9 ) ;
}
V_9 -> V_58 = V_3 -> V_42 -> V_59 ;
V_9 -> V_60 = V_3 -> V_39 + F_45 ( V_30 , V_9 -> V_60 ) ;
return F_36 ( V_3 , V_3 -> V_40 , V_9 ) ;
}
static void F_46 ( struct V_29 * V_30 , T_1 type ,
...
break;
case V_66 :
F_47 ( L_13 , V_3 -> V_42 -> V_67 ,
( unsigned long long ) V_3 -> V_39 ,
V_3 -> V_40 ) ;
if ( V_3 -> V_43 )
F_47 ( L_14 , V_3 -> V_43 -> V_67 ,
...
struct V_2 * V_3 = V_30 -> V_54 ;
int V_69 = 0 ;
V_69 = V_68 ( V_30 , V_3 -> V_42 , V_3 -> V_39 , V_30 -> V_70 , V_1 ) ;
if ( V_69 )
goto V_44;
if ( V_3 -> V_43 )
V_69 = V_68 ( V_30 , V_3 -> V_43 , V_3 -> V_46 , V_30 -> V_70 , V_1 ) ;
V_44:
return V_69 ;
}
