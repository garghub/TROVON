...
{
struct V_26 * V_27 = V_2 -> V_31 ;
struct V_112 * V_14 = F_48 ( V_2 ) ;
...
V_12 -> V_111 = 0 ;
if ( F_50 ( V_114 ) ) {
V_12 -> V_111 = F_51 ( V_114 ) ;
F_7 ( & V_19 -> V_109 , 0xffffffff ) ;
}
V_14 -> V_116 = V_12 -> V_111 ;
V_27 -> V_33 = F_45 ;
}
static struct V_112 * F_52 ( struct V_1 * V_2 ,
...
T_3 V_119 ;
int V_67 = 0 ;
V_14 = F_53 ( V_2 , sizeof( struct V_12 ) ) ;
if ( V_14 == NULL ) {
V_67 = - V_85 ;
goto V_120;
}
F_54 ( V_2 , V_14 ) ;
V_67 = F_55 ( V_2 , V_118 , V_103 ) ;
if ( V_67 )
goto V_121;
V_14 -> V_122 = F_30 ;
V_14 -> V_123 = F_36 ;
...
if ( V_67 )
goto V_126;
V_12 -> V_19 = F_57 ( V_118 -> V_127 , F_58 ( V_118 ) ) ;
if ( V_12 -> V_19 == NULL ) {
V_67 = - V_85 ;
goto V_128;
}
...
static void F_65 ( struct V_10 * V_11 , bool V_108 )
{
struct V_1 * V_2 = V_11 -> V_2 . V_30 -> V_30 ;
struct V_136 * V_137 = F_66 ( V_2 -> V_31 ) ;
T_7 V_16 = V_11 -> V_110 ;
...
V_137 -> V_139 = F_69 ( V_144 * sizeof( * V_137 -> V_139 ) , V_84 ) ;
if ( ! V_137 -> V_139 )
return - V_85 ;
...
int V_138 ;
enum V_148 V_21 ;
V_138 = F_70 ( V_143 , V_145 , & V_21 ) ;
if ( ! F_32 ( V_138 ) ) {
F_71 ( V_2 , L_6 , V_145 , V_138 ) ;
V_67 = V_138 ;
goto V_149;
}
V_67 = F_33 ( V_138 , F_19 ( V_2 ) ) ;
if ( V_67 ) {
F_71 ( V_2 , L_7 , V_145 , V_67 ) ;
goto V_149;
}
...
{
struct V_112 * V_14 = F_48 ( & V_152 -> V_2 ) ;
struct V_12 * V_12 = F_4 ( V_14 ) ;
int V_67 ;
V_67 = F_81 ( & V_152 -> V_2 ) ;
if ( V_67 )
...
static int F_82 ( struct V_151 * V_153 )
{
struct V_117 * V_118 ;
int V_103 ;
struct V_112 * V_14 ;
if ( ! V_153 -> V_2 . V_31 )
return - V_47 ;
V_118 = F_83 ( V_153 , V_154 , 0 ) ;
if ( ! V_118 )
return - V_47 ;
V_103 = F_84 ( V_153 , 0 ) ;
if ( V_103 <= 0 )
return - V_47 ;
V_14 = F_52 ( & V_153 -> V_2 , V_118 , V_103 ) ;
return F_85 ( V_14 ) ;
}
static int F_86 ( struct V_151 * V_153 )
{
return F_81 ( & V_153 -> V_2 ) ;
}
