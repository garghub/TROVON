...
if ( V_4 -> V_7 == V_31 ) {
int V_53 ;
for ( V_53 = 0 ; V_53 < V_4 -> V_6 . V_34 . V_35 ; V_53 ++ )
F_7 ( V_3 , V_4 -> V_6 . V_34 . V_99 [ V_53 ] ,
0 , V_100 ,
0x00 ) ;
}
return 0 ;
}
static int F_40 ( struct V_2 * V_3 , T_3 V_42 )
{
struct V_1 * V_4 = V_3 -> V_4 ;
F_13 ( V_3 ) ;
F_29 ( V_3 ) ;
F_9 ( V_3 ) ;
return F_41 ( V_3 , & V_4 -> V_6 . V_79 , V_42 ) ;
}
static void F_42 ( struct V_2 * V_3 , T_3 V_42 )
{
unsigned int V_57 ;
unsigned char V_101 ;
V_57 = F_21 ( V_3 , V_42 ) ;
V_101 = ( unsigned char ) F_43 ( V_57 ) ;
V_101 = ( V_101 << 4 ) | F_44 ( V_57 ) ;
if ( F_23 ( V_57 ) == V_63
...
static void F_48 ( struct V_2 * V_3 , struct V_103 * V_104 )
{
F_13 ( V_3 ) ;
F_49 ( V_3 , V_104 ) ;
}
static void F_50 ( struct V_2 * V_3 , struct V_103 * V_104 )
{
F_13 ( V_3 ) ;
F_51 ( V_3 , V_104 ) ;
}
static void F_52 ( struct V_2 * V_3 , struct V_103 * V_104 )
{
F_13 ( V_3 ) ;
}
...
{
struct V_1 * V_4 = V_3 -> V_4 ;
struct V_105 * V_106 = & V_4 -> V_6 . V_34 ;
T_3 V_52 ;
int V_53 ;
V_4 -> V_6 . V_107 = F_48 ;
if ( V_106 -> V_108 [ 0 ] )
V_4 -> V_6 . V_109 = F_50 ;
for ( V_53 = 0 ; V_53 < V_106 -> V_110 ; V_53 ++ ) {
V_52 = V_106 -> V_111 [ V_53 ] ;
if ( V_52 && ! F_54 ( V_3 , V_52 ) &&
F_55 ( V_3 , V_52 ) )
F_56 ( V_3 , V_52 ,
V_112 ,
F_52 ) ;
}
for ( V_53 = 0 ; V_53 < V_106 -> V_113 ; V_53 ++ ) {
V_52 = V_106 -> V_111 [ V_53 ] ;
if ( V_52 && ! F_54 ( V_3 , V_52 ) &&
F_55 ( V_3 , V_52 ) )
F_56 ( V_3 , V_52 ,
...
V_4 -> V_6 . V_114 = & V_115 ;
V_4 -> V_6 . V_116 = & V_117 ;
V_90 = F_58 ( V_3 , & V_4 -> V_6 . V_34 , NULL , 0 ) ;
if ( V_90 < 0 )
return V_90 ;
V_90 = F_59 ( V_3 , & V_4 -> V_6 . V_34 ) ;
if ( V_90 < 0 )
return V_90 ;
F_53 ( V_3 ) ;
return 0 ;
...
struct V_1 * V_4 = V_3 -> V_4 ;
int V_53 ;
for ( V_53 = 0 ; V_53 < V_4 -> V_118 ; V_53 ++ )
F_61 ( V_3 , V_4 -> V_119 [ V_53 ] ) ;
F_13 ( V_3 ) ;
F_32 ( V_3 , true ) ;
F_62 ( V_3 ) ;
F_9 ( V_3 ) ;
...
return V_90 ;
for ( V_53 = 0 ; V_53 < V_3 -> V_121 ; V_53 ++ ) {
struct V_122 * V_123 = & V_4 -> V_6 . V_124 [ V_53 ] ;
if ( ! V_123 -> V_125 [ V_126 ] . V_127 ||
V_123 -> V_128 != V_129 )
continue;
V_123 -> V_125 [ V_126 ] . V_130 =
V_131 ;
}
return 0 ;
}
...
V_4 -> V_91 [ V_4 -> V_92 ++ ] = V_137 ;
V_4 -> V_119 [ V_4 -> V_118 ++ ] = V_138 ;
V_3 -> V_139 = V_140 ;
...
if ( V_144 )
F_20 ( V_3 , 0x23 , & V_43 ) ;
F_14 ( V_3 , 0x16 , V_143 ? V_49 : V_43 ) ;
F_14 ( V_3 , 0x10 , V_43 ) ;
if ( V_144 ) {
F_14 ( V_3 , 0x25 , V_43 ) ;
F_14 ( V_3 , 0x27 , V_43 ) ;
} else if ( V_3 -> V_16 == 0x11064397 && V_4 -> V_6 . V_146 )
F_14 ( V_3 , 0x25 , V_43 ) ;
}
...
static void F_71 ( struct V_2 * V_3 , T_3 V_52 ,
...
F_20 ( V_3 , 0x28 , & V_43 ) ;
F_14 ( V_3 , 0x8 , V_43 ) ;
if ( ! V_4 -> V_6 . V_146 && V_161 != V_64 )
V_43 = V_161 ;
F_14 ( V_3 , 0xb , V_43 ) ;
F_14 ( V_3 , 0x21 , V_143 ? V_49 : V_43 ) ;
V_43 = V_64 ;
F_20 ( V_3 , 0x25 , & V_43 ) ;
if ( F_18 ( V_3 ) )
F_20 ( V_3 , 0x2a , & V_43 ) ;
...
if ( ! V_4 -> V_6 . V_133 )
return 0 ;
V_162 = F_78 ( V_3 , V_4 -> V_6 . V_133 , V_163 ,
F_79 ( V_163 ) - 1 ) ;
for ( V_53 = 0 ; V_53 < V_162 ; V_53 ++ ) {
if ( F_80 ( F_81 ( V_3 , V_163 [ V_53 ] ) ) == V_164 )
return 0 ;
}
V_42 = V_3 -> V_165 ;
for ( V_53 = 0 ; V_53 < V_3 -> V_166 ; V_53 ++ , V_42 ++ ) {
unsigned int V_167 = F_81 ( V_3 , V_42 ) ;
if ( F_80 ( V_167 ) == V_164 &&
! ( V_167 & V_168 ) ) {
V_163 [ V_162 ++ ] = V_42 ;
return F_82 ( V_3 ,
...
F_82 ( V_3 , 0x24 , F_79 ( V_183 ) , V_183 ) ;
F_82 ( V_3 , 0x33 , F_79 ( V_184 ) , V_184 ) ;
}
...
if ( V_4 -> V_7 == V_31 )
V_4 -> V_119 [ V_4 -> V_118 ++ ] = V_187 ;
else
V_4 -> V_119 [ V_4 -> V_118 ++ ] = V_188 ;
V_3 -> V_139 = V_140 ;
V_4 -> F_13 = F_89 ;
return 0 ;
}
