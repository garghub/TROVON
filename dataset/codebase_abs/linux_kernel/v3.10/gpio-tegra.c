...
static int F_54 ( struct V_13 * V_14 , unsigned int V_55 )
{
struct V_16 * V_4 = F_32 ( V_14 ) ;
int V_7 = V_14 -> V_15 ;
T_1 V_5 , V_6 , V_56 ;
...
int V_65 ;
int V_66 ;
V_60 = F_58 ( V_67 , & V_58 -> V_44 ) ;
if ( ! V_60 ) {
F_59 ( & V_58 -> V_44 , L_1 ) ;
return - V_68 ;
}
V_62 = (struct V_61 * ) V_60 -> V_69 ;
V_70 = V_62 -> V_71 ;
V_72 = V_62 -> V_73 ;
for (; ; ) {
V_64 = F_60 ( V_58 , V_74 , V_47 ) ;
if ( ! V_64 )
break;
V_47 ++ ;
}
...
V_12 = F_62 ( V_58 -> V_44 . V_78 ,
V_75 . V_76 ,
& V_79 , NULL ) ;
if ( ! V_12 )
return - V_68 ;
for ( V_65 = 0 ; V_65 < V_47 ; V_65 ++ ) {
V_64 = F_60 ( V_58 , V_74 , V_65 ) ;
if ( ! V_64 ) {
F_59 ( & V_58 -> V_44 , L_2 ) ;
return - V_68 ;
}
...
V_64 = F_60 ( V_58 , V_81 , 0 ) ;
V_3 = F_63 ( & V_58 -> V_44 , V_64 ) ;
if ( F_64 ( V_3 ) )
return F_65 ( V_3 ) ;
for ( V_65 = 0 ; V_65 < V_47 ; V_65 ++ ) {
for ( V_66 = 0 ; V_66 < 4 ; V_66 ++ ) {
int V_7 = F_5 ( V_65 , V_66 , 0 ) ;
F_1 ( 0x00 , F_43 ( V_7 ) ) ;
}
}
V_75 . V_78 = V_58 -> V_44 . V_78 ;
F_66 ( & V_75 ) ;
for ( V_7 = 0 ; V_7 < V_75 . V_76 ; V_7 ++ ) {
...
static int F_78 ( struct V_87 * V_88 , void * V_89 )
{
int V_65 ;
int V_66 ;
for ( V_65 = 0 ; V_65 < V_47 ; V_65 ++ ) {
...
static int F_80 ( struct V_90 * V_90 , struct V_91 * V_91 )
{
return F_81 ( V_91 , F_78 , & V_90 -> V_92 ) ;
}
