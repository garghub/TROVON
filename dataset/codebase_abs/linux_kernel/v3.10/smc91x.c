...
{
struct V_306 * V_307 = V_286 -> V_10 . V_308 ;
struct V_11 * V_12 ;
struct V_9 * V_287 ;
struct V_290 * V_291 , * V_309 ;
unsigned int T_2 * V_207 ;
unsigned long V_258 = V_310 ;
int V_218 ;
V_287 = F_165 ( sizeof( struct V_11 ) ) ;
if ( ! V_287 ) {
V_218 = - V_295 ;
goto V_311;
}
F_166 ( V_287 , & V_286 -> V_10 ) ;
V_12 = F_4 ( V_287 ) ;
if ( V_307 ) {
memcpy ( & V_12 -> V_16 , V_307 , sizeof( V_12 -> V_16 ) ) ;
V_12 -> V_312 = F_167 ( V_12 -> V_16 . V_28 ) ;
} else {
V_12 -> V_16 . V_28 |= ( V_313 ) ? V_314 : 0 ;
V_12 -> V_16 . V_28 |= ( V_315 ) ? V_316 : 0 ;
V_12 -> V_16 . V_28 |= ( V_317 ) ? V_318 : 0 ;
V_12 -> V_16 . V_28 |= ( V_319 ) ? V_29 : 0 ;
}
if ( ! V_12 -> V_16 . V_211 && ! V_12 -> V_16 . V_213 ) {
V_12 -> V_16 . V_211 = V_320 ;
V_12 -> V_16 . V_213 = V_321 ;
}
V_287 -> V_282 = ( unsigned char ) - 1 ;
V_291 = F_150 ( V_286 , V_292 , L_71 ) ;
if ( ! V_291 )
V_291 = F_168 ( V_286 , V_292 , 0 ) ;
if ( ! V_291 ) {
V_218 = - V_264 ;
goto V_322;
}
if ( ! F_159 ( V_291 -> V_293 , V_323 , V_48 ) ) {
V_218 = - V_302 ;
goto V_322;
}
V_309 = F_168 ( V_286 , V_324 , 0 ) ;
if ( ! V_309 ) {
V_218 = - V_264 ;
goto V_325;
}
V_287 -> V_184 = V_309 -> V_293 ;
if ( V_258 == - 1 || V_309 -> V_28 & V_326 )
V_258 = V_309 -> V_28 & V_326 ;
...
{
struct V_11 * V_12 = F_4 ( V_287 ) ;
V_12 -> V_330 = & V_286 -> V_10 ;
V_12 -> V_331 = V_291 -> V_293 ;
}
#endif
...
static int F_173 ( struct V_285 * V_286 )
{
struct V_9 * V_287 = F_149 ( V_286 ) ;
struct V_11 * V_12 = F_4 ( V_287 ) ;
struct V_290 * V_291 ;
...
static int F_176 ( struct V_330 * V_10 )
{
struct V_285 * V_286 = F_177 ( V_10 ) ;
struct V_9 * V_287 = F_149 ( V_286 ) ;
if ( V_287 ) {
if ( F_178 ( V_287 ) ) {
F_179 ( V_287 ) ;
...
static int F_180 ( struct V_330 * V_10 )
{
struct V_285 * V_286 = F_177 ( V_10 ) ;
struct V_9 * V_287 = F_149 ( V_286 ) ;
if ( V_287 ) {
