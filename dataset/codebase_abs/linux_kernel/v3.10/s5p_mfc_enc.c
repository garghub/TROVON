...
struct V_103 * V_104 = & V_3 -> V_9 . V_10 ;
int V_122 = 0 ;
V_122 = F_40 ( V_76 , V_77 , V_3 ) ;
if ( V_122 )
return V_122 ;
if ( V_18 -> V_123 . V_124 || V_18 -> V_125 . V_124 ) {
F_43 ( & V_37 -> V_126 , L_16 , V_127 ) ;
V_122 = - V_128 ;
goto V_93;
}
if ( V_3 -> type == V_105 ) {
...
V_18 -> V_21 = V_129 ;
V_18 -> V_110 = V_9 ;
V_18 -> V_130 = V_18 -> V_110 -> V_130 ;
V_18 -> V_113 = V_104 -> V_111 [ 0 ] . V_114 ;
V_104 -> V_111 [ 0 ] . V_112 = 0 ;
V_18 -> V_131 = 0 ;
V_18 -> V_132 = V_133 ;
F_15 ( V_37 -> V_44 , V_134 , V_18 ) ;
F_21 ( V_18 ) ;
F_44 ( V_18 ) ;
F_15 ( V_37 -> V_44 , V_54 , V_37 ) ;
if ( F_45 ( V_18 , \
V_135 , 1 ) ) {
F_39 ( L_18 ) ;
F_15 ( V_37 -> V_44 , V_136 ,
V_18 ) ;
V_122 = - V_137 ;
goto V_93;
}
F_4 ( 2 , L_19 , V_18 -> V_138 ) ;
} else if ( V_3 -> type == V_115 ) {
V_9 = F_1 ( V_3 , V_96 ) ;
if ( ! V_9 ) {
F_39 ( L_20 ) ;
...
V_122 = F_48 ( & V_18 -> V_125 , V_145 ) ;
if ( V_122 != 0 ) {
F_39 ( L_25 ) ;
return V_122 ;
}
V_18 -> V_132 = V_149 ;
V_122 = F_15 ( V_18 -> V_37 -> V_44 ,
V_150 , V_18 ) ;
if ( V_122 ) {
F_39 ( L_26 ) ;
V_145 -> V_151 = 0 ;
...
if ( V_154 -> type == V_115 ) {
V_122 = F_54 ( & V_18 -> V_123 , V_154 , V_76 -> V_163 & V_164 ) ;
} else if ( V_154 -> type == V_105 ) {
V_122 = F_54 ( & V_18 -> V_125 , V_154 , V_76 -> V_163 & V_164 ) ;
if ( V_122 == 0 && V_18 -> V_21 == V_165
&& F_6 ( & V_18 -> V_125 . V_166 ) )
