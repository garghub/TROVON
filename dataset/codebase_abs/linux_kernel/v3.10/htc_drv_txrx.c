...
if ( V_132 -> V_154 . V_155 -> V_156 == V_157 )
V_130 -> V_145 += 4 ;
}
F_41 ( V_8 , V_88 , V_41 ) ;
V_136:
...
struct V_28 * V_29 = F_16 ( V_8 -> V_30 ) ;
struct V_27 * V_31 ;
struct V_40 * V_41 , * V_160 ;
unsigned long V_13 ;
T_2 V_22 = F_50 ( V_128 -> V_146 , V_169 ) ;
V_31 = F_15 ( V_8 , V_22 ) ;
if ( ! V_31 )
return NULL ;
F_64 ( & V_31 -> V_170 , V_13 ) ;
F_65 (epid_queue, skb, tmp) {
if ( F_62 ( V_8 , V_41 , V_128 -> V_47 , V_22 ) ) {
F_66 ( V_41 , V_31 ) ;
F_67 ( & V_31 -> V_170 , V_13 ) ;
return V_41 ;
}
}
F_67 ( & V_31 -> V_170 , V_13 ) ;
...
void F_68 ( struct V_7 * V_8 , void * V_171 )
{
struct V_172 * V_128 = (struct V_172 * ) V_171 ;
struct V_127 * V_173 ;
struct V_40 * V_41 ;
struct V_158 * V_174 ;
int V_175 ;
for ( V_175 = 0 ; V_175 < V_128 -> V_176 ; V_175 ++ ) {
F_51 ( V_128 -> V_176 > V_177 ) ;
V_173 = & V_128 -> V_178 [ V_175 ] ;
V_41 = F_63 ( V_8 , V_173 ) ;
if ( ! V_41 ) {
V_174 = F_69 ( sizeof( struct V_158 ) ,
V_179 ) ;
if ( ! V_174 )
continue;
memcpy ( & V_174 -> V_128 , V_173 ,
sizeof( struct V_127 ) ) ;
F_70 ( & V_8 -> V_162 -> V_166 ) ;
F_71 ( & V_174 -> V_167 ,
& V_8 -> V_162 -> V_180 ) ;
F_72 ( & V_8 -> V_162 -> V_166 ) ;
continue;
}
F_48 ( V_8 , V_41 , V_173 ) ;
}
...
F_70 ( & V_8 -> V_162 -> V_166 ) ;
F_58 (event, tmp, &priv->wmi->pending_tx_events, list) {
V_41 = F_63 ( V_8 , & V_159 -> V_128 ) ;
if ( V_41 ) {
F_37 ( V_29 , V_112 ,
L_7 ,
V_159 -> V_128 . V_47 ,
F_50 ( V_159 -> V_128 . V_146 , V_169 ) ) ;
F_48 ( V_8 , V_41 , & V_159 -> V_128 ) ;
F_59 ( & V_159 -> V_167 ) ;
F_60 ( V_159 ) ;
continue;
}
if ( ++ V_159 -> V_144 >= V_185 ) {
F_59 ( & V_159 -> V_167 ) ;
F_60 ( V_159 ) ;
}
}
...
bool F_86 ( struct V_7 * V_8 , int V_188 )
{
struct V_53 * V_30 = V_8 -> V_30 ;
...
memset ( & V_54 , 0 , sizeof( V_54 ) ) ;
F_87 ( 0 ) ;
return F_88 ( V_8 -> V_30 , V_190 , & V_54 ) ;
}
...
F_96 ( V_30 , V_191 ) ;
V_214 [ 0 ] = V_214 [ 1 ] = ~ 0 ;
F_97 ( V_30 , V_214 [ 0 ] , V_214 [ 1 ] ) ;
}
void F_98 ( struct V_7 * V_8 )
{
F_99 ( V_8 -> V_30 ) ;
F_95 ( V_8 ) ;
F_100 ( V_8 -> V_30 , F_101 ( V_215 , & V_8 -> V_216 ) ) ;
V_8 -> V_217 . V_218 = V_219 ;
}
static void F_102 ( struct V_220 * V_15 ,
struct V_221 * V_222 ,
T_2 V_223 , T_2 V_224 )
{
struct V_225 * V_226 ;
...
if ( V_224 & V_232 )
V_222 -> V_228 |= V_233 ;
V_222 -> V_234 = V_223 & 0x7f ;
return;
}
V_156 = V_15 -> V_123 . V_154 . V_155 -> V_156 ;
V_226 = V_15 -> V_97 -> V_235 [ V_156 ] ;
for ( V_175 = 0 ; V_175 < V_226 -> V_236 ; V_175 ++ ) {
if ( V_226 -> V_237 [ V_175 ] . V_238 == V_223 ) {
V_222 -> V_234 = V_175 ;
return;
}
if ( V_226 -> V_237 [ V_175 ] . V_239 == V_223 ) {
V_222 -> V_234 = V_175 ;
V_222 -> V_228 |= V_240 ;
return;
}
...
{
struct V_69 * V_70 ;
struct V_220 * V_15 = V_8 -> V_15 ;
struct V_40 * V_41 = V_242 -> V_41 ;
struct V_28 * V_29 = F_16 ( V_8 -> V_30 ) ;
struct V_244 * V_245 ;
int V_246 , V_247 ;
int V_218 = V_219 ;
...
V_245 = (struct V_244 * ) V_41 -> V_46 ;
if ( F_104 ( V_245 -> V_250 ) -
( V_41 -> V_99 - V_248 ) != 0 ) {
F_17 ( V_29 ,
L_10 ,
V_245 -> V_250 , V_41 -> V_99 ) ;
goto V_249;
}
F_105 ( V_8 , V_245 ) ;
memcpy ( & V_242 -> V_245 , V_245 , V_248 ) ;
F_20 ( V_41 , V_248 ) ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
V_121 = V_70 -> V_72 ;
V_246 = F_106 ( V_41 ) ;
...
memset ( V_243 , 0 , sizeof( struct V_221 ) ) ;
if ( V_242 -> V_245 . V_252 != 0 ) {
if ( V_242 -> V_245 . V_252 & V_253 )
V_243 -> V_228 |= V_254 ;
if ( V_242 -> V_245 . V_252 & V_255 )
goto V_249;
if ( V_242 -> V_245 . V_252 & V_256 ) {
} else if ( V_242 -> V_245 . V_252 & V_257 ) {
if ( F_107 ( V_121 ) )
V_242 -> V_245 . V_252 &= ~ V_257 ;
else
V_243 -> V_228 |= V_258 ;
}
if ( V_8 -> V_30 -> V_198 == V_259 ) {
if ( V_242 -> V_245 . V_252 &
~ ( V_256 | V_257 |
V_253 ) )
goto V_249;
} else {
...
if ( ! ( V_242 -> V_245 . V_252 & V_256 ) ) {
T_2 V_82 ;
V_82 = V_242 -> V_245 . V_260 ;
if ( V_82 != V_261 ) {
V_243 -> V_228 |= V_262 ;
} else if ( F_108 ( V_121 ) &&
V_41 -> V_99 >= V_246 + 4 ) {
V_82 = V_41 -> V_46 [ V_246 + 3 ] >> 6 ;
if ( F_101 ( V_82 , V_29 -> V_263 ) )
V_243 -> V_228 |= V_262 ;
}
}
F_102 ( V_15 , V_243 , V_242 -> V_245 . V_264 ,
V_242 -> V_245 . V_224 ) ;
if ( V_242 -> V_245 . V_265 != V_266 &&
! V_242 -> V_245 . V_267 )
F_109 ( V_8 -> V_217 . V_218 ,
V_242 -> V_245 . V_265 ) ;
V_218 = V_8 -> V_217 . V_218 ;
if ( F_110 ( V_70 -> V_72 ) &&
! F_111 ( V_29 -> V_268 ) &&
F_112 ( V_70 -> V_269 , V_29 -> V_268 ) ) {
T_5 V_270 = V_242 -> V_245 . V_265 ;
if ( F_113 ( V_218 != V_219 ) )
V_270 = F_114 ( V_218 , V_271 ) ;
if ( V_270 < 0 )
V_270 = 0 ;
V_8 -> V_30 -> V_272 . V_273 = V_270 ;
}
V_243 -> V_274 = F_115 ( V_242 -> V_245 . V_275 ) ;
V_243 -> V_156 = V_15 -> V_123 . V_154 . V_155 -> V_156 ;
V_243 -> V_276 = V_15 -> V_123 . V_154 . V_155 -> V_277 ;
V_243 -> signal = V_242 -> V_245 . V_265 + V_278 ;
V_243 -> V_279 = V_242 -> V_245 . V_280 ;
V_243 -> V_228 |= V_281 ;
return true ;
V_249:
return false ;
}
void F_116 ( unsigned long V_46 )
{
struct V_7 * V_8 = (struct V_7 * ) V_46 ;
struct V_241 * V_242 = NULL , * V_282 = NULL ;
struct V_221 V_243 ;
struct V_40 * V_41 ;
unsigned long V_13 ;
struct V_69 * V_70 ;
do {
F_64 ( & V_8 -> V_217 . V_283 , V_13 ) ;
F_117 (tmp_buf, &priv->rx.rxbuf, list) {
if ( V_282 -> V_284 ) {
V_242 = V_282 ;
break;
}
...
if ( V_242 == NULL ) {
F_67 ( & V_8 -> V_217 . V_283 , V_13 ) ;
break;
}
if ( ! V_242 -> V_41 )
goto V_285;
if ( ! F_103 ( V_8 , V_242 , & V_243 ) ) {
F_49 ( V_242 -> V_41 ) ;
goto V_285;
}
memcpy ( F_118 ( V_242 -> V_41 ) , & V_243 ,
sizeof( struct V_221 ) ) ;
V_41 = V_242 -> V_41 ;
V_70 = (struct V_69 * ) V_41 -> V_46 ;
if ( F_110 ( V_70 -> V_72 ) && V_8 -> V_286 )
F_119 ( V_8 -> V_15 , & V_8 -> V_287 ) ;
F_67 ( & V_8 -> V_217 . V_283 , V_13 ) ;
F_120 ( V_8 -> V_15 , V_41 ) ;
F_64 ( & V_8 -> V_217 . V_283 , V_13 ) ;
V_285:
V_242 -> V_284 = false ;
V_242 -> V_41 = NULL ;
F_121 ( & V_242 -> V_167 , & V_8 -> V_217 . V_242 ) ;
V_242 = NULL ;
F_67 ( & V_8 -> V_217 . V_283 , V_13 ) ;
} while ( 1 );
}
...
{
int V_175 = 0 ;
F_125 ( & V_8 -> V_217 . V_242 ) ;
F_126 ( & V_8 -> V_217 . V_283 ) ;
for ( V_175 = 0 ; V_175 < V_292 ; V_175 ++ ) {
struct V_241 * V_242 =
F_69 ( sizeof( struct V_241 ) , V_293 ) ;
if ( V_242 == NULL )
goto V_289;
F_71 ( & V_242 -> V_167 , & V_8 -> V_217 . V_242 ) ;
}
return 0 ;
V_289:
F_123 ( V_8 ) ;
