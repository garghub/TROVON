...
{
if ( V_2 -> V_9 == V_64 ) {
return F_5 ( V_97 -> V_47 . V_60 ) <
F_5 ( V_98 -> V_47 . V_60 ) ;
} else {
return F_5 ( V_97 -> V_47 . V_48 ) <
F_5 ( V_98 -> V_47 . V_48 ) ||
( V_97 -> V_47 . V_48 == V_98 -> V_47 . V_48 &&
F_5 ( V_97 -> V_47 . V_60 ) <
F_5 ( V_98 -> V_47 . V_60 ) ) ;
}
}
...
{
if ( V_2 -> V_9 == V_64 ) {
return F_5 ( V_99 -> V_47 . V_60 ) +
F_5 ( V_99 -> V_47 . V_48 ) <=
F_5 ( V_100 -> V_47 . V_60 ) ;
} else {
return F_5 ( V_99 -> V_47 . V_48 ) <
F_5 ( V_100 -> V_47 . V_48 ) ||
( V_99 -> V_47 . V_48 == V_100 -> V_47 . V_48 &&
F_5 ( V_99 -> V_47 . V_60 ) <
F_5 ( V_100 -> V_47 . V_60 ) ) ;
}
}
...
V_2 = F_47 ( V_103 , V_104 ) ;
V_2 -> V_4 = V_102 ;
V_2 -> V_3 = V_66 ;
V_2 -> V_9 = V_18 ;
V_2 -> V_105 = V_66 -> V_73 . V_106 ;
V_2 -> V_107 = & V_108 ;
if ( V_18 == V_45 ) {
V_2 -> V_109 = F_5 ( V_15 -> V_23 [ V_45 ] ) ;
V_2 -> V_110 = V_111 ;
} else {
V_2 -> V_109 = F_5 ( V_15 -> V_23 [ V_64 ] ) ;
}
V_2 -> V_5 . V_6 . V_7 = V_7 ;
V_2 -> V_5 . V_6 . V_8 = V_8 ;
if ( F_35 ( & V_66 -> V_73 ) )
...
V_113 -= F_49 ( V_66 ) ;
if ( V_114 )
return V_113 / sizeof( T_4 ) ;
return V_113 / ( sizeof( T_7 ) + sizeof( V_115 ) ) ;
}
