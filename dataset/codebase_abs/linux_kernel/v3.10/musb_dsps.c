...
F_40 ( & V_5 -> V_58 [ V_19 -> V_6 ] , F_16 , ( unsigned long ) V_14 ) ;
...
struct V_18 * V_19 = F_13 ( V_16 ) ;
struct V_4 * V_5 = F_17 ( V_16 -> V_20 ) ;
F_44 ( & V_5 -> V_58 [ V_19 -> V_6 ] ) ;
F_9 ( V_5 , V_19 -> V_6 , 0 ) ;
F_41 ( V_14 -> V_47 ) ;
F_42 () ;
return 0 ;
}
static int F_45 ( struct V_4 * V_5 , T_1 V_6 )
{
...
V_106 [ 0 ] . V_46 = V_112 ;
V_5 -> V_9 [ V_6 ] = F_46 ( & V_19 -> V_16 , V_106 ) ;
if ( F_47 ( V_5 -> V_9 [ V_6 ] ) ) {
V_68 = F_48 ( V_5 -> V_9 [ V_6 ] ) ;
goto V_90;
}
V_105 = F_49 ( V_19 , V_112 , V_6 + 1 ) ;
if ( ! V_105 ) {
F_50 ( V_16 , L_13 , V_6 ) ;
V_68 = - V_89 ;
goto V_90;
...
V_5 -> V_14 [ V_6 ] = V_14 ;
V_68 = F_52 ( V_14 , V_106 , 2 ) ;
if ( V_68 ) {
F_50 ( V_16 , L_18 ) ;
goto V_120;
}
if ( V_100 ) {
V_97 = F_53 ( & V_19 -> V_16 , sizeof( * V_97 ) , V_121 ) ;
if ( ! V_97 ) {
F_50 ( & V_19 -> V_16 ,
L_19 ) ;
V_68 = - V_116 ;
...
V_103 = F_53 ( & V_19 -> V_16 , sizeof( * V_103 ) , V_121 ) ;
if ( ! V_103 ) {
F_50 ( & V_19 -> V_16 ,
L_20 ) ;
V_68 = - V_116 ;
...
F_54 ( V_100 , L_21 , ( T_3 * ) & V_103 -> V_122 ) ;
F_54 ( V_100 , L_22 , ( T_3 * ) & V_103 -> V_123 ) ;
snprintf ( V_107 , sizeof( V_107 ) , L_23 , V_6 ) ;
F_54 ( V_100 , V_107 , ( T_3 * ) & V_97 -> V_124 ) ;
F_54 ( V_100 , L_24 , ( T_3 * ) & V_97 -> V_125 ) ;
V_103 -> V_126 = F_55 ( V_100 , L_25 ) ;
V_97 -> V_103 = V_103 ;
}
V_97 -> V_127 = & V_128 ;
V_68 = F_56 ( V_14 , V_97 , sizeof( * V_97 ) ) ;
if ( V_68 ) {
F_50 ( V_16 , L_26 ) ;
goto V_120;
}
...
struct V_104 * V_131 ;
int V_68 , V_132 ;
V_130 = F_60 ( V_133 , V_19 -> V_16 . V_101 ) ;
if ( ! V_130 ) {
F_50 ( & V_19 -> V_16 , L_28 ) ;
V_68 = - V_134 ;
goto V_90;
...
V_22 = V_130 -> V_3 ;
V_5 = F_61 ( sizeof( * V_5 ) , V_121 ) ;
if ( ! V_5 ) {
F_50 ( & V_19 -> V_16 , L_29 ) ;
V_68 = - V_116 ;
goto V_90;
}
V_131 = F_49 ( V_19 , V_112 , 0 ) ;
if ( ! V_131 ) {
F_50 ( & V_19 -> V_16 , L_30 ) ;
V_68 = - V_89 ;
goto V_135;
...
V_5 -> V_16 = & V_19 -> V_16 ;
V_5 -> V_22 = F_62 ( V_22 , sizeof( * V_22 ) , V_121 ) ;
if ( ! V_5 -> V_22 ) {
F_50 ( & V_19 -> V_16 , L_31 ) ;
V_68 = - V_116 ;
goto V_135;
