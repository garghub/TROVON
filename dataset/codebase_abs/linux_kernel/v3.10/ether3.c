...
struct V_134 * V_91 = & V_4 -> V_91 ;
F_4 ( V_99 >> 8 , V_69 ) ;
if ( V_107 & V_126 ) V_91 -> V_135 ++ ;
if ( V_107 & V_127 ) V_91 -> V_136 ++ ;
if ( V_107 & V_128 ) V_91 -> V_137 ++ ;
if ( V_107 & V_129 ) V_91 -> V_138 ++ ;
V_91 -> V_139 ++ ;
}
}
while ( -- V_118 );
...
{
static unsigned V_149 = 0 ;
if ( V_111 && V_149 ++ == 0 )
F_9 ( V_150 L_21 , V_151 ) ;
}
static int
F_59 ( struct V_32 * V_33 , const struct V_152 * V_153 )
{
const struct V_154 * V_22 = V_153 -> V_22 ;
struct V_3 * V_4 ;
int V_155 , V_45 ;
F_58 () ;
V_45 = F_60 ( V_33 ) ;
if ( V_45 )
goto V_102;
V_4 = F_61 ( sizeof( struct V_156 ) ) ;
if ( ! V_4 ) {
V_45 = - V_157 ;
goto V_158;
}
F_62 ( V_4 , & V_33 -> V_4 ) ;
F_7 ( V_4 ) -> V_159 = F_63 ( V_33 , V_160 , 0 , 0 ) ;
if ( ! F_7 ( V_4 ) -> V_159 ) {
V_45 = - V_157 ;
goto free;
}
V_33 -> V_161 = F_7 ( V_4 ) -> V_159 + V_22 -> V_162 ;
V_33 -> V_163 = 0xf0 ;
F_7 ( V_4 ) -> V_164 = F_7 ( V_4 ) -> V_159 + V_22 -> V_162 ;
V_4 -> V_87 = V_33 -> V_87 ;
F_14 ( V_4 -> V_57 , V_33 ) ;
F_64 ( & F_7 ( V_4 ) -> V_26 ) ;
F_1 ( 0x80 , V_25 + 4 ) ;
...
switch ( V_155 ) {
case V_165 :
F_9 ( V_39 L_22 , V_4 -> V_17 ) ;
V_45 = - V_40 ;
goto free;
case V_166 :
F_9 ( V_39 L_23
L_24 , V_4 -> V_17 , V_22 -> V_17 ) ;
V_45 = - V_40 ;
goto free;
default:
break;
...
V_4 -> V_168 = & V_169 ;
V_4 -> V_170 = 5 * V_29 / 100 ;
V_45 = F_65 ( V_4 ) ;
if ( V_45 )
goto free;
F_9 ( L_25 ,
V_4 -> V_17 , V_22 -> V_17 , V_33 -> V_171 , V_4 -> V_57 ) ;
F_66 ( V_33 , V_4 ) ;
return 0 ;
free:
F_67 ( V_4 ) ;
