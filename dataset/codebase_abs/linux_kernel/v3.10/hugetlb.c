...
static void F_180 ( struct V_179 * V_179 )
{
struct V_34 * V_35 ;
...
static void F_183 ( struct V_179 * V_179 )
{
struct V_34 * V_35 ;
struct V_176 * V_177 = & V_178 [ V_179 -> V_180 . V_181 ] ;
int V_82 ;
...
static int F_207 ( struct V_34 * V_35 , long V_9 )
{
int V_10 = - V_11 ;
F_8 ( & V_96 ) ;
if ( V_9 > 0 ) {
...
static int F_213 ( struct V_14 * V_15 , struct V_216 * V_217 )
{
F_179 () ;
return 0 ;
}
static T_10 F_214 ( struct V_14 * V_15 , struct V_58 * V_58 ,
int V_218 )
{
T_10 V_219 ;
if ( V_218 ) {
V_219 = F_215 ( F_216 ( F_217 ( V_58 ,
V_15 -> V_220 ) ) ) ;
} else {
V_219 = F_218 ( F_217 ( V_58 ,
V_15 -> V_220 ) ) ;
}
V_219 = F_219 ( V_219 ) ;
V_219 = F_220 ( V_219 ) ;
V_219 = F_221 ( V_219 , V_15 , V_58 , V_218 ) ;
return V_219 ;
}
...
{
T_10 V_219 ;
V_219 = F_215 ( F_216 ( F_223 ( V_221 ) ) ) ;
if ( F_224 ( V_15 , V_36 , V_221 , V_219 , 1 ) )
F_225 ( V_15 , V_36 , V_221 ) ;
}
int F_226 ( struct V_222 * V_59 , struct V_222 * V_60 ,
struct V_14 * V_15 )
{
...
V_223 = F_227 ( V_60 , V_128 ) ;
if ( ! V_223 )
continue;
V_224 = F_228 ( V_59 , V_128 , V_227 ) ;
if ( ! V_224 )
goto V_230;
if ( V_224 == V_223 )
continue;
F_8 ( & V_59 -> V_231 ) ;
F_229 ( & V_60 -> V_231 , V_232 ) ;
if ( ! F_230 ( F_223 ( V_223 ) ) ) {
if ( V_226 )
F_231 ( V_60 , V_128 , V_223 ) ;
V_219 = F_223 ( V_223 ) ;
V_225 = F_232 ( V_219 ) ;
F_233 ( V_225 ) ;
F_234 ( V_225 ) ;
F_235 ( V_59 , V_128 , V_224 , V_219 ) ;
}
F_2 ( & V_60 -> V_231 ) ;
F_2 ( & V_59 -> V_231 ) ;
}
...
static int F_236 ( T_10 V_233 )
{
T_11 V_234 ;
if ( F_230 ( V_233 ) || F_237 ( V_233 ) )
return 0 ;
V_234 = F_238 ( V_233 ) ;
if ( F_239 ( V_234 ) && F_240 ( V_234 ) )
return 1 ;
else
return 0 ;
}
static int F_241 ( T_10 V_233 )
{
T_11 V_234 ;
if ( F_230 ( V_233 ) || F_237 ( V_233 ) )
return 0 ;
V_234 = F_238 ( V_233 ) ;
if ( F_239 ( V_234 ) && F_242 ( V_234 ) )
return 1 ;
else
return 0 ;
}
void F_243 ( struct V_235 * V_236 , struct V_14 * V_15 ,
...
F_142 ( ! F_35 ( V_15 ) ) ;
F_9 ( V_214 & ~ F_244 ( V_35 ) ) ;
F_9 ( V_30 & ~ F_244 ( V_35 ) ) ;
F_245 ( V_236 , V_15 ) ;
F_246 ( V_239 , V_241 , V_242 ) ;
V_243:
F_8 ( & V_239 -> V_231 ) ;
for ( V_36 = V_214 ; V_36 < V_30 ; V_36 += V_227 ) {
V_221 = F_227 ( V_239 , V_36 ) ;
if ( ! V_221 )
continue;
if ( F_247 ( V_239 , & V_36 , V_221 ) )
continue;
V_233 = F_223 ( V_221 ) ;
if ( F_230 ( V_233 ) )
continue;
if ( F_58 ( F_241 ( V_233 ) ) ) {
F_248 ( V_239 , V_36 , V_221 ) ;
continue;
}
V_58 = F_232 ( V_233 ) ;
if ( V_237 ) {
...
V_233 = F_249 ( V_239 , V_36 , V_221 ) ;
F_250 ( V_236 , V_221 , V_36 ) ;
if ( F_251 ( V_233 ) )
F_252 ( V_58 ) ;
F_253 ( V_58 ) ;
V_238 = ! F_254 ( V_236 , V_58 ) ;
if ( V_238 )
break;
if ( V_237 )
break;
...
F_256 ( V_239 , V_241 , V_242 ) ;
F_257 ( V_236 , V_15 ) ;
}
void F_258 ( struct V_235 * V_236 ,
struct V_14 * V_15 , unsigned long V_214 ,
unsigned long V_30 , struct V_58 * V_237 )
{
F_243 ( V_236 , V_15 , V_214 , V_30 , V_237 ) ;
V_15 -> V_49 &= ~ V_50 ;
}
void F_259 ( struct V_14 * V_15 , unsigned long V_214 ,
unsigned long V_30 , struct V_58 * V_237 )
{
struct V_222 * V_239 ;
struct V_235 V_236 ;
...
F_260 ( & V_236 , V_239 , 0 ) ;
F_243 ( & V_236 , V_15 , V_214 , V_30 , V_237 ) ;
F_261 ( & V_236 , V_214 , V_30 ) ;
}
static int F_262 ( struct V_222 * V_239 , struct V_14 * V_15 ,
...
struct V_129 * V_95 ;
T_1 V_246 ;
V_36 = V_36 & F_244 ( V_35 ) ;
V_246 = ( ( V_36 - V_15 -> V_37 ) >> V_41 ) +
V_15 -> V_38 ;
V_95 = F_15 ( V_15 -> V_16 ) -> V_133 ;
F_263 ( & V_95 -> V_247 ) ;
F_264 (iter_vma, &mapping->i_mmap, pgoff, pgoff) {
if ( V_245 == V_15 )
continue;
if ( ! F_47 ( V_245 , V_57 ) )
F_259 ( V_245 , V_36 ,
...
static int F_266 ( struct V_222 * V_239 , struct V_14 * V_15 ,
...
if ( V_251 ) {
if ( F_267 ( V_249 ) )
F_268 ( V_249 , V_15 , V_36 ) ;
F_222 ( V_15 , V_36 , V_221 ) ;
return 0 ;
}
if ( ! ( V_15 -> V_49 & V_50 ) &&
F_47 ( V_15 , V_57 ) &&
...
if ( F_270 ( V_250 ) ) {
long V_82 = F_271 ( V_250 ) ;
F_272 ( V_249 ) ;
if ( V_252 ) {
F_9 ( F_230 ( V_233 ) ) ;
if ( F_262 ( V_239 , V_15 , V_249 , V_36 ) ) {
F_9 ( F_230 ( V_233 ) ) ;
F_8 ( & V_239 -> V_231 ) ;
V_221 = F_227 ( V_239 , V_36 & F_244 ( V_35 ) ) ;
if ( F_273 ( F_274 ( F_223 ( V_221 ) , V_233 ) ) )
goto V_253;
return 0 ;
}
F_275 ( 1 ) ;
...
F_277 ( V_250 , V_249 , V_36 , V_15 ,
F_53 ( V_35 ) ) ;
F_278 ( V_250 ) ;
V_241 = V_36 & F_244 ( V_35 ) ;
V_242 = V_241 + F_81 ( V_35 ) ;
F_246 ( V_239 , V_241 , V_242 ) ;
F_8 ( & V_239 -> V_231 ) ;
V_221 = F_227 ( V_239 , V_36 & F_244 ( V_35 ) ) ;
if ( F_273 ( F_274 ( F_223 ( V_221 ) , V_233 ) ) ) {
F_279 ( V_15 , V_36 , V_221 ) ;
F_235 ( V_239 , V_36 , V_221 ,
F_214 ( V_15 , V_250 , 1 ) ) ;
F_253 ( V_249 ) ;
F_280 ( V_250 , V_15 , V_36 ) ;
V_250 = V_249 ;
}
F_2 ( & V_239 -> V_231 ) ;
F_256 ( V_239 , V_241 , V_242 ) ;
...
static struct V_58 * F_281 ( struct V_34 * V_35 ,
struct V_14 * V_15 , unsigned long V_36 )
{
struct V_129 * V_95 ;
T_1 V_132 ;
...
return F_282 ( V_95 , V_132 ) ;
}
static bool F_283 ( struct V_34 * V_35 ,
struct V_14 * V_15 , unsigned long V_36 )
{
struct V_129 * V_95 ;
T_1 V_132 ;
...
V_95 = V_15 -> V_16 -> V_130 ;
V_132 = F_29 ( V_35 , V_15 , V_36 ) ;
V_58 = F_284 ( V_95 , V_132 ) ;
if ( V_58 )
F_92 ( V_58 ) ;
return V_58 != NULL ;
}
static int F_285 ( struct V_222 * V_239 , struct V_14 * V_15 ,
...
V_132 = F_29 ( V_35 , V_15 , V_36 ) ;
V_124:
V_58 = F_282 ( V_95 , V_132 ) ;
if ( ! V_58 ) {
V_94 = F_286 ( V_95 -> V_131 ) >> F_30 ( V_35 ) ;
if ( V_132 >= V_94 )
goto V_152;
...
F_287 ( V_58 , V_36 , F_53 ( V_35 ) ) ;
F_278 ( V_58 ) ;
if ( V_15 -> V_49 & V_50 ) {
int V_82 ;
struct V_12 * V_12 = V_95 -> V_131 ;
V_82 = F_288 ( V_58 , V_95 , V_132 , V_7 ) ;
if ( V_82 ) {
F_92 ( V_58 ) ;
if ( V_82 == - V_259 )
goto V_124;
...
goto V_265;
V_10 = 0 ;
if ( ! F_230 ( F_223 ( V_221 ) ) )
goto V_265;
if ( V_256 )
F_280 ( V_58 , V_15 , V_36 ) ;
else
F_234 ( V_58 ) ;
V_257 = F_214 ( V_15 , V_58 , ( ( V_15 -> V_49 & V_266 )
&& ( V_15 -> V_49 & V_228 ) ) ) ;
F_235 ( V_239 , V_36 , V_221 , V_257 ) ;
if ( ( V_53 & V_264 ) && ! ( V_15 -> V_49 & V_228 ) ) {
V_10 = F_266 ( V_239 , V_15 , V_36 , V_221 , V_257 , V_58 ) ;
}
F_2 ( & V_239 -> V_231 ) ;
F_293 ( V_58 ) ;
V_152:
...
int F_294 ( struct V_222 * V_239 , struct V_14 * V_15 ,
...
F_296 ( V_239 , V_221 ) ;
return 0 ;
} else if ( F_58 ( F_241 ( V_219 ) ) )
return V_268 |
F_292 ( F_88 ( V_35 ) ) ;
}
V_221 = F_228 ( V_239 , V_36 , F_81 ( V_35 ) ) ;
if ( ! V_221 )
return V_254 ;
F_263 ( & V_267 ) ;
V_219 = F_223 ( V_221 ) ;
if ( F_230 ( V_219 ) ) {
V_10 = F_285 ( V_239 , V_15 , V_36 , V_221 , V_53 ) ;
goto V_269;
}
V_10 = 0 ;
if ( ( V_53 & V_264 ) && ! F_297 ( V_219 ) ) {
if ( F_122 ( V_35 , V_15 , V_36 ) < 0 ) {
V_10 = V_254 ;
goto V_269;
}
...
F_290 ( V_58 ) ;
F_8 ( & V_239 -> V_231 ) ;
if ( F_58 ( ! F_274 ( V_219 , F_223 ( V_221 ) ) ) )
goto V_270;
if ( V_53 & V_264 ) {
if ( ! F_297 ( V_219 ) ) {
V_10 = F_266 ( V_239 , V_15 , V_36 , V_221 , V_219 ,
V_248 ) ;
goto V_270;
}
V_219 = F_216 ( V_219 ) ;
...
V_219 = F_219 ( V_219 ) ;
if ( F_224 ( V_15 , V_36 , V_221 , V_219 ,
V_53 & V_264 ) )
F_225 ( V_15 , V_36 , V_221 ) ;
V_270:
F_2 ( & V_239 -> V_231 ) ;
...
struct V_58 *
F_298 ( struct V_222 * V_239 , unsigned long V_36 ,
T_12 * V_271 , int V_202 )
{
F_179 () ;
return NULL ;
}
long F_299 ( struct V_222 * V_239 , struct V_14 * V_15 ,
struct V_58 * * V_272 , struct V_14 * * V_273 ,
unsigned long * V_274 , unsigned long * V_99 ,
long V_61 , unsigned int V_53 )
{
unsigned long V_275 ;
unsigned long V_276 = * V_274 ;
unsigned long V_277 = * V_99 ;
struct V_34 * V_35 = F_33 ( V_15 ) ;
F_8 ( & V_239 -> V_231 ) ;
while ( V_276 < V_15 -> V_215 && V_277 ) {
T_10 * V_233 ;
int V_278 ;
struct V_58 * V_58 ;
V_233 = F_227 ( V_239 , V_276 & F_244 ( V_35 ) ) ;
V_278 = ! V_233 || F_230 ( F_223 ( V_233 ) ) ;
if ( V_278 && ( V_53 & V_279 ) &&
! F_283 ( V_35 , V_15 , V_276 ) ) {
V_277 = 0 ;
break;
}
if ( V_278 || F_300 ( F_223 ( V_233 ) ) ||
( ( V_53 & V_280 ) &&
! F_297 ( F_223 ( V_233 ) ) ) ) {
int V_10 ;
F_2 ( & V_239 -> V_231 ) ;
V_10 = F_294 ( V_239 , V_15 , V_276 ,
( V_53 & V_280 ) ? V_264 : 0 ) ;
F_8 ( & V_239 -> V_231 ) ;
if ( ! ( V_10 & V_281 ) )
continue;
...
V_275 = ( V_276 & ~ F_244 ( V_35 ) ) >> V_41 ;
V_58 = F_232 ( F_223 ( V_233 ) ) ;
V_282:
if ( V_272 ) {
V_272 [ V_61 ] = F_301 ( V_58 , V_275 ) ;
F_233 ( V_272 [ V_61 ] ) ;
}
if ( V_273 )
V_273 [ V_61 ] = V_15 ;
...
* V_99 = V_277 ;
* V_274 = V_276 ;
return V_61 ? V_61 : - V_283 ;
}
unsigned long F_302 ( struct V_14 * V_15 ,
...
F_9 ( V_36 >= V_30 ) ;
F_303 ( V_15 , V_36 , V_30 ) ;
F_263 ( & V_15 -> V_16 -> V_130 -> V_247 ) ;
F_8 ( & V_239 -> V_231 ) ;
...
if ( ! F_230 ( F_223 ( V_221 ) ) ) {
V_233 = F_249 ( V_239 , V_36 , V_221 ) ;
V_233 = F_220 ( F_304 ( V_233 , V_284 ) ) ;
V_233 = F_221 ( V_233 , V_15 , NULL , 0 ) ;
F_235 ( V_239 , V_36 , V_221 , V_233 ) ;
V_272 ++ ;
}
}
F_2 ( & V_239 -> V_231 ) ;
F_305 ( V_15 , V_214 , V_30 ) ;
F_265 ( & V_15 -> V_16 -> V_130 -> V_247 ) ;
return V_272 << V_35 -> V_40 ;
}
int F_306 ( struct V_12 * V_12 ,
long V_26 , long V_25 ,
struct V_14 * V_15 ,
T_14 V_49 )
{
long V_10 , V_28 ;
struct V_34 * V_35 = F_307 ( V_12 ) ;
...
void F_308 ( struct V_12 * V_12 , long V_286 , long V_287 )
{
struct V_34 * V_35 = F_307 ( V_12 ) ;
long V_28 = F_23 ( & V_12 -> V_133 -> V_134 , V_286 ) ;
struct V_1 * V_2 = F_12 ( V_12 ) ;
F_8 ( & V_12 -> V_260 ) ;
V_12 -> V_261 -= ( F_289 ( V_35 ) * V_287 ) ;
F_2 ( & V_12 -> V_260 ) ;
F_11 ( V_2 , ( V_28 - V_287 ) ) ;
F_207 ( V_35 , - ( V_28 - V_287 ) ) ;
}
static int F_309 ( struct V_58 * V_288 )
{
struct V_58 * V_58 ;
struct V_58 * V_120 ;
struct V_34 * V_35 = F_52 ( V_288 ) ;
int V_65 = F_61 ( V_288 ) ;
