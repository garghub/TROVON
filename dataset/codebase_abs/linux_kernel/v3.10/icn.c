...
strcpy ( V_191 , L_54 ) ;
strcpy ( V_190 , V_91 ) ;
sprintf ( V_167 , L_55 , ( int ) ( V_166 + 1 ) ,
V_191 , V_190 , V_16 -> V_58 . V_74 . V_76 ,
...
static int
F_72 ( const T_2 T_6 * V_151 , int V_47 , int V_204 , int V_2 )
{
T_1 * V_1 = F_70 ( V_204 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_25 & V_150 ) )
...
static int
F_73 ( T_2 T_6 * V_151 , int V_47 , int V_204 , int V_2 )
{
T_1 * V_1 = F_70 ( V_204 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_25 & V_150 ) )
...
static int
F_74 ( int V_204 , int V_2 , int V_114 , struct V_6 * V_7 )
{
T_1 * V_1 = F_70 ( V_204 ) ;
if ( V_1 ) {
if ( ! ( V_1 -> V_25 & V_150 ) )
...
F_77 ( & V_1 -> V_45 ) ;
V_1 -> V_11 = V_11 ;
V_1 -> V_40 . V_205 = V_206 ;
V_1 -> V_40 . V_207 = 1 ;
V_1 -> V_40 . V_208 = V_189 ;
V_1 -> V_40 . V_209 = 4000 ;
V_1 -> V_40 . V_54 = F_71 ;
V_1 -> V_40 . V_210 = F_74 ;
V_1 -> V_40 . V_211 = F_72 ;
V_1 -> V_40 . V_212 = F_73 ;
V_1 -> V_40 . V_104 = V_213 |
V_214 |
V_215 |
V_216 ;
V_1 -> V_102 = V_185 ;
F_32 ( V_1 -> V_40 . V_204 , V_204 , sizeof( V_1 -> V_40 . V_204 ) ) ;
V_1 -> V_83 = V_1 -> V_86 ;
V_1 -> V_84 = V_1 -> V_86 ;
V_1 -> V_85 = & V_1 -> V_86 [ sizeof( V_1 -> V_86 ) - 1 ] ;
for ( V_90 = 0 ; V_90 < V_189 ; V_90 ++ ) {
V_1 -> V_193 [ V_90 ] = V_194 ;
F_78 ( & V_1 -> V_5 [ V_90 ] ) ;
}
V_1 -> V_165 = V_164 ;
V_164 = V_1 ;
...
V_1 -> V_42 = V_1 -> V_40 . V_208 ;
sprintf ( V_1 -> V_137 , L_76 , V_1 -> V_40 . V_204 ) ;
return V_1 ;
}
static int
...
if ( ! ( V_217 = F_75 ( V_11 , V_182 ) ) ) {
F_10 ( V_101
L_78 ,
V_217 -> V_40 . V_204 , V_11 ) ;
return 0 ;
}
V_1 -> V_139 = 1 ;
V_1 -> V_28 = 0 ;
...
F_10 ( V_101
L_79 ,
V_1 -> V_40 . V_204 , V_217 -> V_40 . V_204 , V_11 ) ;
return 0 ;
}
static int T_9
F_80 ( char * line )
...
static char V_221 [ 20 ] ;
V_218 = F_81 ( line , 2 , V_219 ) ;
if ( V_219 [ 0 ] )
V_222 = V_219 [ 1 ] ;
if ( V_219 [ 0 ] > 1 )
V_223 = ( unsigned long ) V_219 [ 2 ] ;
if ( V_218 && * V_218 ) {
strcpy ( V_220 , V_218 ) ;
V_224 = V_220 ;
if ( ( V_91 = strchr ( V_220 , ',' ) ) ) {
* V_91 ++ = 0 ;
strcpy ( V_221 , V_91 ) ;
V_225 = V_221 ;
}
...
char * V_91 ;
char V_226 [ 21 ] ;
memset ( & V_19 , 0 , sizeof( V_227 ) ) ;
V_19 . V_142 = ( V_223 & 0x0ffc000 ) ;
V_19 . V_2 = - 1 ;
V_19 . V_20 = NULL ;
V_19 . V_178 = 1 ;
F_77 ( & V_19 . V_26 ) ;
if ( ( V_91 = strchr ( V_228 , ':' ) ) ) {
strncpy ( V_226 , V_91 + 1 , 20 ) ;
V_226 [ 20 ] = '\0' ;
V_91 = strchr ( V_226 , '$' ) ;
if ( V_91 )
* V_91 = 0 ;
...
strcpy ( V_226 , L_80 ) ;
F_10 ( V_229 L_81 , V_226 ,
V_19 . V_142 ) ;
return ( F_69 ( V_222 , V_224 , V_225 ) ) ;
}
