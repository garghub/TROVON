...
static void F_20 ( char * V_24 , char * V_34 , bool V_33 )
{
if ( V_33 )
printf ( L_22 , V_24 , V_34 ) ;
else
printf ( L_23 , L_12 , V_24 , V_34 ) ;
}
static int F_21 ( void * V_35 )
{
struct V_36 * V_37 ;
...
static int F_23 ( void * V_42 , void * V_43 )
{
return strcmp ( V_42 , V_43 ) ;
}
static int F_24 ( bool V_33 )
{
char V_44 [] = L_25 ;
char V_24 [ V_45 ] ;
char V_4 [ 128 ] ;
...
F_28 (devlist, dev, struct sysfs_device) {
V_19 = F_22 ( V_39 , L_30 ) ;
V_20 = F_22 ( V_39 , L_31 ) ;
V_49 = F_22 ( V_39 , L_32 ) ;
V_50 = F_22 ( V_39 , L_33 ) ;
...
F_10 ( V_4 , sizeof( V_4 ) ,
strtol ( V_19 -> V_41 , NULL , 16 ) ,
strtol ( V_20 -> V_41 , NULL , 16 ) ) ;
F_18 ( V_39 -> V_55 , V_19 -> V_41 , V_20 -> V_41 ,
V_33 ) ;
F_19 ( V_4 , V_33 ) ;
for ( V_14 = 0 ; V_14 < atoi ( V_50 -> V_41 ) ; V_14 ++ ) {
snprintf ( V_24 , sizeof( V_24 ) , L_35 ,
...
F_15 ( L_40 , V_64 ) ;
for (; ; ) {
V_63 = F_34 ( V_57 , V_58 , L_41 , V_60 , NULL ) ;
if ( V_63 == - 1 )
break;
switch ( V_63 ) {
case 'p' :
