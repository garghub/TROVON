...
static int F_42 ( struct V_2 * V_2 , int V_101 )
{
struct V_8 * V_9 = F_16 ( & V_2 -> V_10 ) ;
if ( V_101 == V_109 )
...
static int F_43 ( struct V_2 * V_2 , int V_112 )
{
struct V_8 * V_9 = F_16 ( & V_2 -> V_10 ) ;
if ( V_112 )
return F_22 ( V_110 , V_113 ) ;
return F_23 ( V_110 , V_113 ) ;
}
static int F_44 ( struct V_114 * V_115 )
{
struct V_2 * V_2 = F_4 ( V_115 -> V_116 ,
struct V_2 , V_117 ) ;
switch ( V_115 -> V_92 ) {
case V_118 :
return F_38 ( V_2 , V_115 -> V_101 ,
V_119 ) ;
case V_120 :
return F_38 ( V_2 , V_115 -> V_101 ,
V_121 ) ;
case V_122 :
return F_41 ( V_2 , V_115 -> V_101 ) ;
case V_123 :
return F_42 ( V_2 , V_115 -> V_101 ) ;
case V_124 :
return F_43 ( V_2 , V_115 -> V_101 ) ;
}
return - V_15 ;
}
...
{
struct V_8 * V_9 = F_16 ( & V_2 -> V_10 ) ;
struct V_127 * V_128 = F_52 ( V_9 ) ;
int V_12 ;
V_12 = F_53 ( & V_9 -> V_17 , V_128 ) ;
if ( V_12 < 0 )
return V_12 ;
V_12 = F_49 ( V_2 ) ;
if ( V_12 < 0 ) {
...
static int F_56 ( struct V_46 * V_47 , int V_112 )
{
struct V_2 * V_2 = F_4 ( V_47 , struct V_2 , V_10 ) ;
int V_12 = 0 ;
F_57 ( & V_2 -> V_129 ) ;
...
static int F_60 ( struct V_46 * V_47 , unsigned int V_131 ,
enum V_3 * V_4 )
{
if ( V_131 >= F_2 ( V_6 ) )
return - V_15 ;
...
{
struct V_2 * V_2 ;
struct V_147 * V_148 = F_66 ( V_9 -> V_17 . V_149 ) ;
struct V_127 * V_128 = F_52 ( V_9 ) ;
int V_12 ;
if ( ! V_128 ) {
F_32 ( & V_9 -> V_17 , L_11 ) ;
...
V_2 = F_69 ( & V_9 -> V_17 , sizeof( struct V_2 ) , V_151 ) ;
if ( ! V_2 )
return - V_152 ;
V_2 -> V_21 = & V_39 ;
F_70 ( & V_2 -> V_10 , V_9 , & V_153 ) ;
F_71 ( & V_2 -> V_117 , 5 ) ;
F_72 ( & V_2 -> V_117 , & V_154 ,
V_118 , 0 , 1 , 1 , 0 ) ;
F_72 ( & V_2 -> V_117 , & V_154 ,
V_120 , 0 , 1 , 1 , 0 ) ;
F_72 ( & V_2 -> V_117 , & V_154 ,
V_124 , 0 , 1 , 1 , 1 ) ;
V_2 -> V_108 = F_72 ( & V_2 -> V_117 , & V_154 ,
V_122 , 0 , 63 * 2 * 2 , 1 , 32 ) ;
F_73 ( & V_2 -> V_117 ,
& V_154 , V_123 , 1 , 0 ,
V_109 ) ;
V_2 -> V_10 . V_155 = & V_2 -> V_117 ;
if ( V_2 -> V_117 . error )
return V_2 -> V_117 . error ;
V_2 -> V_25 . V_33 = V_53 ;
V_2 -> V_25 . V_35 = V_55 ;
V_2 -> V_25 . V_26 = V_54 ;
V_2 -> V_25 . V_27 = V_56 ;
