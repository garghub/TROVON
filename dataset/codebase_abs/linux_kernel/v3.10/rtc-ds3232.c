...
struct V_40 * V_40 ;
int V_3 ;
V_40 = F_28 ( & V_2 -> V_8 , sizeof( struct V_40 ) , V_63 ) ;
if ( ! V_40 )
return - V_64 ;
V_40 -> V_2 = V_2 ;
F_29 ( V_2 , V_40 ) ;
...
if ( V_3 )
return V_3 ;
V_40 -> V_51 = F_32 ( & V_2 -> V_8 , V_2 -> V_65 ,
& V_66 , V_67 ) ;
if ( F_33 ( V_40 -> V_51 ) ) {
F_34 ( & V_2 -> V_8 , L_3 ) ;
return F_35 ( V_40 -> V_51 ) ;
}
if ( V_2 -> V_48 >= 0 ) {
V_3 = F_36 ( & V_2 -> V_8 , V_2 -> V_48 , F_20 , 0 ,
L_4 , V_2 ) ;
if ( V_3 ) {
F_34 ( & V_2 -> V_8 , L_5 ) ;
return V_3 ;
