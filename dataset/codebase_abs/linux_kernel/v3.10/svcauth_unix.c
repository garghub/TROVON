...
static int F_74 ( struct V_66 * V_67 ,
struct V_32 * V_33 ,
struct V_14 * V_5 )
{
...
V_101 = 0 ;
F_35 ( V_67 , L_9 , F_75 ( V_100 , V_89 -> V_85 ) , V_101 ) ;
for ( V_31 = 0 ; V_31 < V_101 ; V_31 ++ )
F_35 ( V_67 , L_10 , F_76 ( V_100 , F_72 ( V_89 -> V_90 , V_31 ) ) ) ;
F_35 ( V_67 , L_11 ) ;
return 0 ;
}
int F_77 ( struct V_55 * V_55 )
{
struct V_70 * V_71 = F_39 ( V_55 , V_72 ) ;
struct V_32 * V_33 ;
int V_51 ;
V_33 = F_78 ( & V_103 , V_55 ) ;
if ( F_79 ( V_33 ) )
return F_80 ( V_33 ) ;
V_51 = F_81 ( V_33 , V_55 ) ;
if ( V_51 ) {
...
static struct V_88 * F_73 ( struct V_32 * V_33 , T_2 V_85 )
{
struct V_88 V_89 ;
struct V_14 * V_69 ;
V_89 . V_85 = V_85 ;
...
static struct V_105 * F_85 ( T_2 V_85 , struct V_106 * V_107 )
{
struct V_88 * V_89 ;
struct V_105 * V_90 ;
int V_108 ;
...
V_72 ) ;
V_89 = F_73 ( V_71 -> V_104 , V_85 ) ;
if ( ! V_89 )
return F_86 ( - V_110 ) ;
V_108 = F_87 ( V_71 -> V_104 , & V_89 -> V_5 , & V_107 -> V_111 ) ;
switch ( V_108 ) {
case - V_64 :
return F_86 ( - V_64 ) ;
case - V_112 :
...
if ( V_74 == NULL )
return V_126 ;
switch ( F_87 ( V_71 -> V_73 , & V_74 -> V_5 , & V_107 -> V_111 ) ) {
default:
F_91 () ;
case - V_112 :
return V_127 ;
...
static int
F_92 ( struct V_106 * V_107 , T_4 * V_131 )
{
...
if ( F_93 ( V_133 ) != F_95 ( V_142 ) || F_93 ( V_133 ) != 0 ) {
F_94 ( L_13 ) ;
* V_131 = V_143 ;
return V_126 ;
}
...
F_96 ( V_136 , V_142 ) ;
F_96 ( V_136 , 0 ) ;
V_107 -> V_117 . V_147 = V_142 ;
return V_122 ;
}
static int
F_97 ( struct V_106 * V_107 )
{
if ( V_107 -> V_120 )
F_6 ( V_107 -> V_120 ) ;
V_107 -> V_120 = NULL ;
...
static int
F_98 ( struct V_106 * V_107 , T_4 * V_131 )
{
struct V_132 * V_133 = & V_107 -> V_134 . V_135 [ 0 ] ;
struct V_132 * V_136 = & V_107 -> V_137 . V_135 [ 0 ] ;
struct V_115 * V_116 = & V_107 -> V_117 ;
T_5 V_148 , V_31 ;
int V_41 = V_133 -> V_139 ;
V_116 -> V_130 = NULL ;
V_116 -> V_138 = NULL ;
V_107 -> V_120 = NULL ;
if ( ( V_41 -= 3 * 4 ) < 0 )
...
F_93 ( V_133 ) ;
F_93 ( V_133 ) ;
V_148 = F_99 ( F_100 ( V_133 ) ) ;
if ( V_148 > 64 || ( V_41 -= ( V_148 + 3 ) * 4 ) < 0 )
goto V_149;
V_133 -> V_150 = ( void * ) ( ( T_4 * ) V_133 -> V_150 + V_148 ) ;
V_133 -> V_139 -= V_148 * 4 ;
V_116 -> V_129 = F_67 ( & V_86 , F_100 ( V_133 ) ) ;
V_116 -> V_145 = F_70 ( & V_86 , F_100 ( V_133 ) ) ;
V_148 = F_100 ( V_133 ) ;
if ( V_148 > 16 || ( V_41 -= ( V_148 + 2 ) * 4 ) < 0 )
goto V_149;
V_116 -> V_130 = F_69 ( V_148 ) ;
if ( V_116 -> V_130 == NULL )
return V_127 ;
for ( V_31 = 0 ; V_31 < V_148 ; V_31 ++ ) {
T_3 V_97 = F_70 ( & V_86 , F_100 ( V_133 ) ) ;
F_72 ( V_116 -> V_130 , V_31 ) = V_97 ;
}
if ( F_93 ( V_133 ) != F_95 ( V_142 ) || F_93 ( V_133 ) != 0 ) {
* V_131 = V_143 ;
return V_126 ;
...
int F_102 ( struct V_55 * V_55 )
{
struct V_70 * V_71 = F_39 ( V_55 , V_72 ) ;
struct V_32 * V_33 ;
int V_51 ;
V_33 = F_78 ( & V_152 , V_55 ) ;
if ( F_79 ( V_33 ) )
return F_80 ( V_33 ) ;
V_51 = F_81 ( V_33 , V_55 ) ;
if ( V_51 ) {
