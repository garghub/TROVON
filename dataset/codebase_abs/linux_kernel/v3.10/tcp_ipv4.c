...
bool V_219 )
{
const struct V_220 * V_221 = F_95 ( V_104 ) ;
struct V_33 V_34 ;
int V_37 = - 1 ;
struct V_1 * V_2 ;
if ( ! V_68 && ( V_68 = F_97 ( V_8 , & V_34 , V_104 ) ) == NULL )
return - 1 ;
V_2 = F_98 ( V_8 , V_68 , V_104 , NULL ) ;
if ( V_2 ) {
...
{
int V_225 = F_96 ( V_8 , NULL , V_104 , 0 , false ) ;
if ( ! V_225 )
F_88 ( F_19 ( V_8 ) , V_226 ) ;
return V_225 ;
}
...
struct V_246 * V_247 ;
V_247 = F_112 ( V_14 -> V_248 ,
F_13 ( V_8 ) ||
F_113 ( & V_8 -> V_249 . V_250 ) ) ;
if ( ! V_247 )
return NULL ;
#if F_114 ( V_251 )
if ( V_243 == V_252 )
...
{
union V_183 * V_242 ;
V_242 = (union V_183 * ) & F_95 ( V_104 ) -> V_223 ;
return F_83 ( V_8 , V_242 , V_42 ) ;
}
...
F_13 ( V_8 ) ) ;
if ( ! V_247 ) {
V_247 = F_110 ( sizeof( * V_247 ) , V_257 ) ;
if ( ! V_247 )
return - V_259 ;
F_119 ( V_8 , V_260 ) ;
F_120 ( & V_247 -> V_159 ) ;
F_121 ( V_14 -> V_248 , V_247 ) ;
}
V_168 = F_122 ( V_8 , sizeof( * V_168 ) , V_257 ) ;
if ( ! V_168 )
return - V_259 ;
if ( F_123 ( & V_247 -> V_159 ) && ! F_124 ( V_8 ) ) {
...
return - V_262 ;
F_128 ( & V_168 -> V_261 ) ;
F_129 ( sizeof( * V_168 ) , & V_8 -> V_263 ) ;
F_130 ( V_168 , V_264 ) ;
V_247 = F_12 ( V_14 -> V_248 ,
F_13 ( V_8 ) ) ;
if ( F_123 ( & V_247 -> V_159 ) )
F_131 () ;
return 0 ;
}
...
static int F_134 ( struct V_7 * V_8 , char T_9 * V_267 ,
int V_71 )
{
struct V_268 V_269 ;
...
return - V_40 ;
if ( F_135 ( & V_269 , V_267 , sizeof( V_269 ) ) )
return - V_271 ;
if ( sin -> V_41 != V_42 )
return - V_40 ;
...
static int F_136 ( struct V_276 * V_277 ,
...
V_280 -> V_284 = 0 ;
V_280 -> V_285 = V_57 ;
V_280 -> V_109 = F_137 ( V_278 ) ;
F_138 ( & V_282 , V_280 , sizeof( * V_280 ) ) ;
return F_139 ( & V_277 -> V_286 , & V_282 , sizeof( * V_280 ) ) ;
}
static int F_85 ( char * V_287 , const struct V_167 * V_168 ,
...
if ( F_141 ( V_289 ) )
goto V_291;
if ( F_136 ( V_277 , V_3 , V_4 , V_98 -> V_161 << 2 ) )
goto V_291;
if ( F_142 ( V_277 , V_98 ) )
goto V_291;
if ( F_143 ( V_277 , V_168 ) )
goto V_291;
if ( F_144 ( V_289 , V_287 ) )
goto V_291;
F_145 () ;
return 0 ;
V_291:
...
int F_84 ( char * V_287 , struct V_167 * V_168 ,
...
V_4 = F_95 ( V_104 ) -> V_222 ;
V_3 = F_95 ( V_104 ) -> V_223 ;
} else {
...
if ( F_141 ( V_289 ) )
goto V_291;
if ( F_136 ( V_277 , V_3 , V_4 , V_2 -> V_109 ) )
goto V_291;
if ( F_142 ( V_277 , V_98 ) )
goto V_291;
if ( F_146 ( V_277 , V_2 , V_98 -> V_161 << 2 ) )
goto V_291;
if ( F_143 ( V_277 , V_168 ) )
goto V_291;
if ( F_144 ( V_289 , V_287 ) )
...
int V_171 ;
unsigned char V_170 [ 16 ] ;
V_292 = F_83 ( V_8 , (union V_183 * ) & V_95 -> V_4 ,
V_42 ) ;
V_169 = F_78 ( V_98 ) ;
if ( ! V_292 && ! V_169 )
return false ;
...
F_151 ( & V_300 -> V_310 ) ;
V_309 = V_300 -> V_311 ;
if ( ( V_309 == NULL ) || F_152 ( V_309 -> V_312 , V_79 ) ) {
F_153 ( & V_300 -> V_310 ) ;
F_46 ( F_19 ( V_8 ) ,
V_313 ) ;
V_296 -> V_109 = - 1 ;
...
V_37 = F_100 ( V_319 , V_8 , V_221 -> V_222 ,
V_221 -> V_223 , V_221 -> V_46 ) ;
V_37 = F_101 ( V_37 ) ;
if ( ! V_37 )
F_50 ( V_104 ) -> V_224 = V_143 ;
F_151 ( & V_321 -> V_300 -> V_310 ) ;
V_321 -> V_300 -> V_308 ++ ;
F_153 ( & V_321 -> V_300 -> V_310 ) ;
V_14 = F_7 ( V_322 ) ;
V_14 -> V_121 = V_104 ;
F_9 ( V_8 ) ;
F_50 ( V_104 ) -> V_328 = V_8 ;
V_14 -> V_329 = F_81 ( F_4 ( V_2 ) -> V_204 ) ;
F_58 ( V_322 , V_145 ,
V_142 , V_146 ) ;
F_158 ( V_8 , V_104 , V_322 ) ;
...
F_174 ( V_2 , & V_335 , 0 , V_229 ? NULL : & V_296 ) ;
if ( V_229 && ! V_335 . V_344 )
F_173 ( & V_335 ) ;
V_335 . V_345 = V_335 . V_344 ;
F_175 ( V_104 , & V_335 , V_2 ) ;
V_221 = F_95 ( V_104 ) ;
V_221 -> V_222 = V_3 ;
V_221 -> V_223 = V_4 ;
V_221 -> V_217 = F_11 ( V_8 ) -> V_190 ;
V_221 -> V_46 = F_108 ( V_2 ) ;
if ( F_176 ( V_8 , V_2 , V_104 ) )
goto V_346;
if ( ! V_229 || V_335 . V_345 )
F_177 ( V_104 , V_2 , F_19 ( V_8 ) ) ;
if ( V_229 ) {
V_336 = F_178 ( V_8 , V_2 , & V_104 -> V_347 ) ;
...
( V_351 - F_180 ( V_8 ) <
( V_351 >> 2 ) ) &&
! F_179 ( V_104 , V_68 , false ) ) {
F_181 (KERN_DEBUG pr_fmt(L_8),
...
V_337 = F_149 ( V_8 , V_2 , V_104 , & V_296 , & V_297 ) ;
V_319 = F_98 ( V_8 , V_68 , V_104 ,
F_150 ( & V_297 ) ? & V_297 : NULL ) ;
if ( V_319 ) {
F_66 ( V_319 , V_221 -> V_222 , V_221 -> V_223 ) ;
F_99 ( V_319 , F_182 ( V_2 ) ) ;
} else
goto V_346;
if ( F_21 ( ! V_337 ) ) {
int V_37 ;
...
F_183 ( V_8 , V_104 , V_142 ) ;
if ( F_150 ( & V_296 ) && V_296 . V_109 != 0 )
F_46 ( F_19 ( V_8 ) ,
V_327 ) ;
} else if ( F_156 ( V_8 , V_2 , V_319 , V_104 ) )
goto V_346;
return 0 ;
V_350:
F_184 ( V_68 ) ;
...
struct V_7 * F_185 ( struct V_7 * V_8 , struct V_1 * V_2 ,
struct V_103 * V_104 ,
struct V_82 * V_68 )
{
struct V_220 * V_221 ;
...
#ifdef F_75
V_168 = F_83 ( V_8 , (union V_183 * ) & V_352 -> V_64 ,
V_42 ) ;
if ( V_168 != NULL ) {
F_118 ( V_354 , (union V_183 * ) & V_352 -> V_64 ,
V_42 , V_168 -> V_168 , V_168 -> V_258 , V_241 ) ;
F_119 ( V_354 , V_260 ) ;
}
#endif
if ( F_192 ( V_8 , V_354 ) < 0 )
goto V_360;
F_193 ( V_354 , NULL ) ;
return V_354 ;
V_355:
...
static struct V_7 * F_195 ( struct V_7 * V_8 , struct V_1 * V_2 )
{
struct V_97 * V_98 = F_4 ( V_2 ) ;
const struct V_94 * V_95 = F_3 ( V_2 ) ;
struct V_7 * V_363 ;
...
V_95 -> V_4 , V_95 -> V_3 ) ;
if ( V_104 )
return F_196 ( V_8 , V_2 , V_104 , V_149 , false ) ;
V_363 = F_197 ( F_19 ( V_8 ) , & V_111 , V_95 -> V_4 ,
...
#ifdef F_106
if ( ! V_98 -> V_178 )
V_8 = F_198 ( V_8 , V_2 , & ( F_109 ( V_2 ) -> V_46 ) ) ;
#endif
return V_8 ;
}
static T_10 F_199 ( struct V_1 * V_2 )
{
const struct V_94 * V_95 = F_3 ( V_2 ) ;
if ( V_2 -> V_155 == V_364 ) {
...
int F_201 ( struct V_7 * V_8 , struct V_1 * V_2 )
{
struct V_7 * V_366 ;
#ifdef F_75
if ( F_147 ( V_8 , V_2 ) )
...
if ( V_2 -> V_109 < F_204 ( V_2 ) || F_205 ( V_2 ) )
goto V_373;
if ( V_8 -> V_112 == V_122 ) {
struct V_7 * V_363 = F_195 ( V_8 , V_2 ) ;
if ( ! V_363 )
goto V_367;
if ( V_363 != V_8 ) {
F_202 ( V_363 , V_2 ) ;
if ( F_206 ( V_8 , V_363 , V_2 ) ) {
V_366 = V_363 ;
goto V_372;
}
return 0 ;
...
F_202 ( V_8 , V_2 ) ;
if ( F_207 ( V_8 , V_2 , F_4 ( V_2 ) , V_2 -> V_109 ) ) {
V_366 = V_8 ;
goto V_372;
}
return 0 ;
...
if ( V_2 -> V_376 != V_377 )
return;
if ( ! F_73 ( V_2 , F_209 ( V_2 ) + sizeof( struct V_97 ) ) )
return;
V_95 = F_3 ( V_2 ) ;
V_98 = F_4 ( V_2 ) ;
if ( V_98 -> V_161 < sizeof( struct V_97 ) / 4 )
return;
V_8 = F_210 ( F_39 ( V_2 -> V_108 ) , & V_111 ,
V_95 -> V_4 , V_98 -> V_6 ,
V_95 -> V_3 , F_81 ( V_98 -> V_5 ) ,
V_2 -> V_371 ) ;
if ( V_8 ) {
...
bool F_213 ( struct V_7 * V_8 , struct V_1 * V_2 )
{
struct V_13 * V_14 = F_7 ( V_8 ) ;
if ( V_380 || ! V_14 -> V_381 . V_382 )
return false ;
if ( V_2 -> V_109 <= F_204 ( V_2 ) &&
F_214 ( & V_14 -> V_381 . V_383 ) == 0 )
return false ;
F_215 ( V_2 ) ;
F_167 ( & V_14 -> V_381 . V_383 , V_2 ) ;
V_14 -> V_381 . V_384 += V_2 -> V_385 ;
if ( V_14 -> V_381 . V_384 > V_8 -> V_386 ) {
struct V_1 * V_387 ;
F_55 ( F_13 ( V_8 ) ) ;
while ( ( V_387 = F_216 ( & V_14 -> V_381 . V_383 ) ) != NULL ) {
F_217 ( V_8 , V_387 ) ;
F_46 ( F_19 ( V_8 ) ,
V_388 ) ;
}
V_14 -> V_381 . V_384 = 0 ;
} else if ( F_214 ( & V_14 -> V_381 . V_383 ) == 1 ) {
F_218 ( F_219 ( V_8 ) ,
V_389 | V_390 | V_391 ) ;
if ( ! F_220 ( V_8 ) )
F_58 ( V_8 , V_392 ,
...
F_57 ( V_2 ) -> V_144 = 0 ;
F_57 ( V_2 ) -> V_398 = F_224 ( V_95 ) ;
F_57 ( V_2 ) -> V_399 = 0 ;
V_8 = F_225 ( & V_111 , V_2 , V_98 -> V_6 , V_98 -> V_5 ) ;
if ( ! V_8 )
goto V_400;
V_401:
if ( V_8 -> V_112 == V_113 )
...
return V_393 ;
V_400:
if ( ! F_226 ( NULL , V_404 , V_2 ) )
goto V_394;
if ( V_2 -> V_109 < ( V_98 -> V_161 << 2 ) || F_205 ( V_2 ) ) {
V_397:
F_88 ( V_107 , V_374 ) ;
V_396:
F_88 ( V_107 , V_375 ) ;
...
switch ( F_233 ( F_44 ( V_8 ) , V_2 , V_98 ) ) {
case V_409 : {
struct V_7 * V_410 = F_234 ( F_39 ( V_2 -> V_108 ) ,
& V_111 ,
V_95 -> V_4 , V_98 -> V_6 ,
V_95 -> V_3 , V_98 -> V_5 ,
F_42 ( V_2 ) ) ;
...
void F_187 ( struct V_7 * V_8 , const struct V_1 * V_2 )
{
...
static inline struct V_206 * F_248 ( struct V_419 * V_159 )
{
return F_249 ( V_159 ) ? NULL :
F_250 ( V_159 -> V_420 , struct V_206 , V_421 ) ;
}
static inline struct V_206 * F_251 ( struct V_206 * V_207 )
{
return ! F_252 ( V_207 -> V_421 . V_422 ) ?
F_253 ( V_207 -> V_421 . V_422 , F_254 ( * V_207 ) , V_421 ) : NULL ;
}
static void * F_255 ( struct V_423 * V_105 , void * V_424 )
{
struct V_100 * V_101 ;
struct V_425 * V_261 ;
...
struct V_107 * V_107 = F_256 ( V_105 ) ;
if ( ! V_8 ) {
V_427 = & V_111 . V_431 [ V_429 -> V_432 ] ;
F_257 ( & V_427 -> V_310 ) ;
V_8 = F_258 ( & V_427 -> V_159 ) ;
V_429 -> V_205 = 0 ;
goto V_433;
}
V_427 = & V_111 . V_431 [ V_429 -> V_432 ] ;
...
V_8 = F_259 ( V_429 -> V_437 ) ;
V_429 -> V_435 = V_443 ;
F_260 ( & V_101 -> V_235 . V_444 ) ;
} else {
V_101 = F_23 ( V_8 ) ;
F_261 ( & V_101 -> V_235 . V_444 ) ;
if ( F_262 ( & V_101 -> V_235 ) )
goto V_445;
F_260 ( & V_101 -> V_235 . V_444 ) ;
V_8 = F_259 ( V_8 ) ;
}
...
static void * F_267 ( struct V_423 * V_105 , T_11 * V_449 )
{
struct V_428 * V_429 = V_105 -> V_430 ;
void * V_450 ;
V_429 -> V_432 = 0 ;
V_429 -> V_205 = 0 ;
V_450 = F_255 ( V_105 , NULL ) ;
while ( V_450 && * V_449 ) {
V_450 = F_255 ( V_105 , V_450 ) ;
-- * V_449 ;
}
return V_450 ;
}
static inline bool F_268 ( struct V_428 * V_429 )
{
return F_249 ( & V_111 . V_451 [ V_429 -> V_432 ] . V_452 ) &&
F_249 ( & V_111 . V_451 [ V_429 -> V_432 ] . V_453 ) ;
}
static void * F_269 ( struct V_423 * V_105 )
{
struct V_428 * V_429 = V_105 -> V_430 ;
struct V_107 * V_107 = F_256 ( V_105 ) ;
void * V_450 = NULL ;
...
struct V_425 * V_261 ;
struct V_206 * V_207 ;
T_12 * V_310 = F_270 ( & V_111 , V_429 -> V_432 ) ;
if ( F_268 ( V_429 ) )
continue;
F_257 ( V_310 ) ;
F_271 (sk, node, &tcp_hashinfo.ehash[st->bucket].chain) {
if ( V_8 -> V_446 != V_429 -> V_243 ||
! F_264 ( F_19 ( V_8 ) , V_107 ) ) {
continue;
}
V_450 = V_8 ;
goto V_117;
...
static void * F_274 ( struct V_423 * V_105 , void * V_424 )
{
struct V_7 * V_8 = V_424 ;
struct V_206 * V_207 ;
struct V_425 * V_261 ;
...
V_207 = F_251 ( V_207 ) ;
V_458:
while ( V_207 && ( V_207 -> V_456 != V_429 -> V_243 || ! F_264 ( F_273 ( V_207 ) , V_107 ) ) ) {
V_207 = F_251 ( V_207 ) ;
}
if ( V_207 ) {
V_424 = V_207 ;
...
return NULL ;
F_257 ( F_270 ( & V_111 , V_429 -> V_432 ) ) ;
V_8 = F_258 ( & V_111 . V_451 [ V_429 -> V_432 ] . V_452 ) ;
} else
V_8 = F_259 ( V_8 ) ;
F_263 (sk, node) {
if ( V_8 -> V_446 == V_429 -> V_243 && F_264 ( F_19 ( V_8 ) , V_107 ) )
goto V_459;
}
V_429 -> V_435 = V_455 ;
V_207 = F_248 ( & V_111 . V_451 [ V_429 -> V_432 ] . V_453 ) ;
goto V_458;
V_459:
V_424 = V_8 ;
V_117:
...
static void * F_275 ( struct V_423 * V_105 , T_11 V_449 )
{
struct V_428 * V_429 = V_105 -> V_430 ;
void * V_450 ;
V_429 -> V_432 = 0 ;
...
struct V_428 * V_429 = V_105 -> V_430 ;
V_429 -> V_435 = V_443 ;
V_450 = F_267 ( V_105 , & V_449 ) ;
if ( ! V_450 ) {
V_429 -> V_435 = V_457 ;
V_450 = F_275 ( V_105 , V_449 ) ;
}
return V_450 ;
}
static void * F_277 ( struct V_423 * V_105 )
{
struct V_428 * V_429 = V_105 -> V_430 ;
...
static void * F_278 ( struct V_423 * V_105 , T_11 * V_449 )
{
struct V_428 * V_429 = V_105 -> V_430 ;
void * V_450 ;
...
V_429 -> V_432 = 0 ;
V_429 -> V_205 = 0 ;
V_450 = * V_449 ? F_276 ( V_105 , * V_449 - 1 ) : V_462 ;
V_117:
V_429 -> V_461 = * V_449 ;
return V_450 ;
}
static void * F_279 ( struct V_423 * V_105 , void * V_463 , T_11 * V_449 )
{
struct V_428 * V_429 = V_105 -> V_430 ;
void * V_450 = NULL ;
if ( V_463 == V_462 ) {
...
static void F_280 ( struct V_423 * V_105 , void * V_463 )
{
struct V_428 * V_429 = V_105 -> V_430 ;
switch ( V_429 -> V_435 ) {
case V_436 :
...
case V_443 :
if ( V_463 != V_462 )
F_266 ( & V_111 . V_431 [ V_429 -> V_432 ] . V_310 ) ;
break;
case V_455 :
case V_457 :
if ( V_463 )
...
int F_281 ( struct V_464 * V_464 , struct V_465 * V_465 )
{
struct V_466 * V_467 = F_282 ( V_464 ) ;
struct V_428 * V_468 ;
int V_37 ;
V_37 = F_283 ( V_464 , V_465 , & V_467 -> V_469 ,
sizeof( struct V_428 ) ) ;
if ( V_37 < 0 )
return V_37 ;
...
int F_284 ( struct V_107 * V_107 , struct V_466 * V_467 )
{
int V_450 = 0 ;
struct V_471 * V_472 ;
V_467 -> V_469 . V_473 = F_278 ;
V_467 -> V_469 . V_422 = F_279 ;
V_467 -> V_469 . V_474 = F_280 ;
V_472 = F_285 ( V_467 -> V_475 , V_476 , V_107 -> V_477 ,
V_467 -> V_478 , V_467 ) ;
if ( ! V_472 )
V_450 = - V_259 ;
return V_450 ;
}
void F_286 ( struct V_107 * V_107 , struct V_466 * V_467 )
{
F_287 ( V_467 -> V_475 , V_107 -> V_477 ) ;
}
static void F_288 ( const struct V_7 * V_8 , const struct V_103 * V_104 ,
...
static void F_294 ( struct V_7 * V_8 , struct V_423 * V_479 , int V_480 , int * V_109 )
{
int V_484 ;
unsigned long V_485 ;
...
T_3 V_5 = V_29 -> V_64 ;
T_3 V_486 = V_29 -> V_63 ;
T_14 V_487 = F_81 ( V_29 -> V_69 ) ;
T_14 V_488 = F_81 ( V_29 -> V_49 ) ;
int V_489 ;
...
V_489 = F_296 ( int , V_14 -> V_215 - V_14 -> V_497 , 0 ) ;
F_289 ( V_479 , L_11
L_12 ,
...
F_290 ( V_485 - V_79 ) ,
V_101 -> V_138 ,
F_291 ( F_292 ( V_479 ) , F_265 ( V_8 ) ) ,
V_101 -> V_498 ,
F_297 ( V_8 ) ,
F_293 ( & V_8 -> V_483 ) , V_8 ,
F_298 ( V_101 -> V_140 ) ,
F_298 ( V_101 -> V_499 . V_500 ) ,
( V_101 -> V_499 . V_501 << 1 ) | V_101 -> V_499 . V_502 ,
V_14 -> V_503 ,
V_8 -> V_112 == V_122 ?
( V_300 ? V_300 -> V_307 : 0 ) :
( F_299 ( V_14 ) ? - 1 : V_14 -> V_504 ) ,
V_109 ) ;
}
static void F_300 ( const struct V_206 * V_207 ,
...
V_5 = V_207 -> V_506 ;
V_486 = V_207 -> V_507 ;
V_487 = F_81 ( V_207 -> V_508 ) ;
V_488 = F_81 ( V_207 -> V_509 ) ;
F_289 ( V_479 , L_9
L_13 ,
V_480 , V_486 , V_488 , V_5 , V_487 , V_207 -> V_510 , 0 , 0 ,
3 , F_290 ( V_481 ) , 0 , 0 , 0 , 0 ,
F_293 ( & V_207 -> V_511 ) , V_207 , V_109 ) ;
}
static int F_301 ( struct V_423 * V_105 , void * V_463 )
{
struct V_428 * V_429 ;
int V_109 ;
if ( V_463 == V_462 ) {
F_289 ( V_105 , L_14 , V_512 - 1 ,
L_15
L_16
L_17 ) ;
goto V_117;
...
case V_443 :
case V_457 :
F_294 ( V_463 , V_105 , V_429 -> V_434 , & V_109 ) ;
break;
case V_436 :
F_288 ( V_429 -> V_437 , V_463 , V_105 , V_429 -> V_434 , V_429 -> V_447 , & V_109 ) ;
break;
case V_455 :
F_300 ( V_463 , V_105 , V_429 -> V_434 , & V_109 ) ;
break;
}
F_289 ( V_105 , L_18 , V_512 - 1 - V_109 , L_6 ) ;
V_117:
return 0 ;
}
static int T_15 F_302 ( struct V_107 * V_107 )
{
return F_284 ( V_107 , & V_513 ) ;
}
static void T_16 F_303 ( struct V_107 * V_107 )
{
F_286 ( V_107 , & V_513 ) ;
}
int T_17 F_304 ( void )
...
struct V_1 * * F_308 ( struct V_1 * * V_159 , struct V_1 * V_2 )
{
const struct V_94 * V_95 = F_309 ( V_2 ) ;
T_18 V_515 ;
T_10 V_516 ;
switch ( V_2 -> V_155 ) {
case V_364 :
if ( ! F_67 ( F_310 ( V_2 ) , V_95 -> V_4 , V_95 -> V_3 ,
V_2 -> V_162 ) ) {
V_2 -> V_155 = V_365 ;
break;
}
...
return NULL ;
case V_518 :
V_515 = F_86 ( V_95 -> V_4 , V_95 -> V_3 ,
F_310 ( V_2 ) , V_57 , 0 ) ;
V_516 = F_312 ( F_313 ( V_2 ,
F_314 ( V_2 ) ,
F_310 ( V_2 ) ,
V_515 ) ) ;
if ( V_516 )
...
return F_315 ( V_159 , V_2 ) ;
}
int F_316 ( struct V_1 * V_2 )
{
const struct V_94 * V_95 = F_3 ( V_2 ) ;
struct V_97 * V_98 = F_4 ( V_2 ) ;
V_98 -> V_157 = ~ F_67 ( V_2 -> V_109 - F_209 ( V_2 ) ,
V_95 -> V_4 , V_95 -> V_3 , 0 ) ;
F_317 ( V_2 ) -> V_519 = V_77 ;
return F_318 ( V_2 ) ;
}
static int T_15 F_319 ( struct V_107 * V_107 )
{
V_107 -> V_520 . V_521 = 2 ;
return 0 ;
}
static void T_16 F_320 ( struct V_107 * V_107 )
{
}
static void T_16 F_321 ( struct V_522 * V_523 )
{
F_322 ( & V_111 , & V_66 , V_42 ) ;
}
void T_17 F_323 ( void )
{
F_324 ( & V_111 ) ;
if ( F_305 ( & V_524 ) )
F_325 ( L_19 ) ;
