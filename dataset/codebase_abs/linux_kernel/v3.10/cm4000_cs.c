...
struct V_15 * V_16 = V_88 -> V_92 ;
unsigned int V_12 = V_16 -> V_33 -> V_34 [ 0 ] -> V_35 ;
struct V_116 * V_116 = F_51 ( V_88 ) ;
struct V_117 * V_118 ;
int V_119 ;
int V_43 ;
void T_3 * V_120 = ( void T_3 * ) V_115 ;
#ifdef F_27
char * V_121 [ V_122 + 1 ] = {
[ F_52 ( V_123 ) ] L_126 ,
[ F_52 ( V_124 ) ] L_127 ,
...
F_14 ( 3 , V_16 , L_131 , F_53 ( V_116 ) ,
F_54 ( V_116 ) , V_121 [ F_52 ( V_114 ) ] ) ;
#endif
F_55 ( & V_128 ) ;
V_43 = - V_98 ;
V_118 = V_129 [ F_54 ( V_116 ) ] ;
if ( ! F_40 ( V_118 ) ) {
F_14 ( 4 , V_16 , L_132 ) ;
goto V_130;
}
...
V_43 = - V_107 ;
F_14 ( 4 , V_16 , L_136 ,
F_58 ( V_114 ) , V_133 , V_134 , V_119 , V_114 ) ;
if ( F_58 ( V_114 ) & V_133 ) {
if ( ! F_59 ( V_135 , V_120 , V_119 ) )
goto V_130;
}
if ( F_58 ( V_114 ) & V_134 ) {
if ( ! F_59 ( V_136 , V_120 , V_119 ) )
goto V_130;
}
V_43 = 0 ;
switch ( V_114 ) {
...
V_137 |= V_141 ;
if ( F_42 ( V_120 , & V_137 , sizeof( int ) ) )
V_43 = - V_107 ;
}
break;
case V_124 :
...
if ( F_24 ( V_50 , & V_16 -> V_25 ) == 0 ) {
V_14 = - 1 ;
if ( F_42 ( & ( V_142 -> V_22 ) , & V_14 ,
sizeof( int ) ) )
break;
} else {
if ( F_42 ( V_142 -> V_23 , V_16 -> V_23 ,
V_16 -> V_22 ) )
break;
V_14 = V_16 -> V_22 ;
if ( F_42 ( & ( V_142 -> V_22 ) , & V_14 , sizeof( int ) ) )
break;
}
V_43 = 0 ;
break;
...
static int F_61 ( struct V_116 * V_116 , struct V_87 * V_88 )
{
struct V_15 * V_16 ;
struct V_117 * V_118 ;
int V_145 = F_54 ( V_116 ) ;
int V_146 ;
if ( V_145 >= V_147 )
return - V_98 ;
F_55 ( & V_128 ) ;
V_118 = V_129 [ V_145 ] ;
if ( V_118 == NULL || ! F_40 ( V_118 ) ) {
V_146 = - V_98 ;
goto V_130;
}
if ( V_118 -> V_148 ) {
...
V_88 -> V_92 = V_16 ;
F_14 ( 2 , V_16 , L_147 ,
F_53 ( V_116 ) , V_145 , V_95 -> V_96 , V_95 -> V_97 ) ;
F_62 ( V_16 ) ;
if ( V_88 -> V_100 & V_101 ) {
V_146 = - V_102 ;
goto V_130;
...
V_118 -> V_148 = 1 ;
F_14 ( 2 , V_16 , L_148 ) ;
V_146 = F_63 ( V_116 , V_88 ) ;
V_130:
F_60 ( & V_128 ) ;
return V_146 ;
}
static int F_64 ( struct V_116 * V_116 , struct V_87 * V_88 )
{
struct V_15 * V_16 ;
struct V_117 * V_118 ;
int V_145 = F_54 ( V_116 ) ;
...
{
struct V_15 * V_16 = V_118 -> V_150 ;
F_14 ( 3 , V_16 , L_151 ) ;
while ( V_118 -> V_148 ) {
F_67 (KERN_INFO MODULE_NAME L_152
L_153 ) ;
F_68 ( V_16 -> V_52 , ( V_118 -> V_148 == 0 ) ) ;
}
F_14 ( 3 , V_16 , L_154 ) ;
return;
}
static int F_69 ( struct V_117 * V_33 , void * V_151 )
{
return F_70 ( V_33 ) ;
}
static int F_71 ( struct V_117 * V_118 , int V_152 )
{
struct V_15 * V_16 ;
V_118 -> V_153 |= V_154 ;
if ( F_72 ( V_118 , F_69 , NULL ) )
goto V_155;
if ( F_73 ( V_118 ) )
goto V_155;
V_16 = V_118 -> V_150 ;
...
static void F_74 ( struct V_117 * V_118 )
{
F_66 ( V_118 ) ;
F_77 ( V_118 ) ;
}
static int F_78 ( struct V_117 * V_118 )
{
struct V_15 * V_16 ;
int V_6 , V_146 ;
...
break;
if ( V_6 == V_147 ) {
F_67 (KERN_NOTICE MODULE_NAME L_155 ) ;
return - V_98 ;
}
V_16 = F_79 ( sizeof( struct V_15 ) , V_156 ) ;
if ( V_16 == NULL )
return - V_157 ;
V_16 -> V_33 = V_118 ;
V_118 -> V_150 = V_16 ;
...
F_80 ( & V_16 -> V_80 ) ;
F_80 ( & V_16 -> V_104 ) ;
V_146 = F_71 ( V_118 , V_6 ) ;
if ( V_146 ) {
V_129 [ V_6 ] = NULL ;
F_81 ( V_16 ) ;
return V_146 ;
}
F_82 ( V_158 , NULL , F_83 ( V_159 , V_6 ) , NULL , L_156 , V_6 ) ;
return 0 ;
}
...
V_129 [ V_152 ] = NULL ;
F_81 ( V_16 ) ;
F_85 ( V_158 , F_83 ( V_159 , V_152 ) ) ;
return;
}
static int T_6 F_86 ( void )
{
int V_43 ;
V_158 = F_87 ( V_160 , L_157 ) ;
if ( F_88 ( V_158 ) )
return F_89 ( V_158 ) ;
V_159 = F_90 ( 0 , V_161 , & V_162 ) ;
if ( V_159 < 0 ) {
F_67 (KERN_WARNING MODULE_NAME
L_158 ) ;
F_91 ( V_158 ) ;
return V_159 ;
}
