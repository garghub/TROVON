...
T_2 * V_10 )
{
return F_2 ( V_7 + V_11 , V_1 , V_2 , V_9 ,
V_10 ) ;
}
static void F_4 ( struct V_12 * V_13 , struct V_14 * V_14 )
{
...
static int T_4 F_10 ( int V_28 , T_2 V_9 , T_2 V_38 )
{
struct V_15 * V_16 ;
int V_39 = V_28 - V_40 ;
F_11 ( L_1 , V_39 ,
...
V_16 = F_13 ( sizeof( struct V_15 ) , V_42 ) ;
if ( ! V_16 )
goto V_43;
V_16 -> V_28 = V_28 ;
V_16 -> V_9 = V_9 ;
V_16 -> V_38 = V_38 ;
V_16 -> V_26 = F_14 ( V_38 ) - 10 ;
V_16 -> V_13 = F_15 ( V_42 ) ;
if ( V_16 -> V_13 == NULL )
goto V_44;
V_16 -> V_13 -> V_17 = V_16 ;
...
F_19 ( V_16 -> V_45 , ( T_3 ) V_9 * ( V_38 / 512 ) ) ;
