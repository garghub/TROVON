...
static unsigned int
F_88 ( T_1 * V_8 , unsigned int V_123 ,
unsigned char * V_124 , unsigned char * V_125 )
{
...
static int
F_89 ( T_1 * V_8 , int V_38 , unsigned char V_138 ,
unsigned char V_139 )
{
switch ( V_38 ) {
case V_104 :
...
static int F_90 ( T_1 * V_8 , int V_38 )
{
int V_102 ;
switch ( V_38 ) {
case V_104 :
...
if ( F_57 ( V_151 , V_31 ) )
return - V_155 ;
if ( F_95 ( V_242 , ( void * ) V_151 , sizeof( V_242 ) ) )
return - V_155 ;
switch ( V_242 [ 14 ] ) {
case V_243 :
F_59 ( V_8 ) ;
...
F_22 ( & V_45 , V_41 ) ;
if ( F_96 ( ( void * ) V_151 , V_242 , sizeof( V_242 ) ) )
return - V_155 ;
break;
default:
return - V_68 ;
...
static int T_7 F_99 ( char * V_257 )
{
int V_258 [ 5 ] ;
V_257 = F_100 ( V_257 , F_101 ( V_258 ) , V_258 ) ;
V_252 = V_258 [ 1 ] ;
V_92 = V_258 [ 2 ] ;
V_173 = V_258 [ 3 ] ;
V_174 = V_258 [ 4 ] ;
