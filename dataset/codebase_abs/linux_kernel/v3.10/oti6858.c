...
static int F_47 ( struct V_42 * V_43 , unsigned long V_113 )
{
struct V_6 * V_7 = V_43 -> V_45 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
unsigned long V_10 ;
...
static void F_50 ( struct V_122 * V_122 )
{
struct V_6 * V_7 = V_122 -> V_123 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
int V_26 = 0 , V_124 = 0 , V_125 = 1 ;
int V_96 = V_122 -> V_96 ;
switch ( V_96 ) {
case 0 :
break;
...
case - V_127 :
case - V_128 :
F_14 ( & V_122 -> V_14 -> V_14 , L_10 ,
V_15 , V_96 ) ;
return;
default:
F_14 ( & V_122 -> V_14 -> V_14 , L_11 ,
V_15 , V_96 ) ;
break;
}
if ( V_96 == 0 && V_122 -> V_129 == V_12 ) {
struct V_8 * V_130 = V_122 -> V_39 ;
unsigned long V_10 ;
F_10 ( & V_4 -> V_19 , V_10 ) ;
if ( ! V_4 -> V_26 ) {
if ( ! F_11 ( V_130 , V_4 ) ) {
...
if ( ! V_4 -> V_26 ) {
if ( V_130 -> V_94 != V_4 -> V_96 . V_94 )
F_51 ( & V_7 -> V_7 . V_116 ) ;
memcpy ( & V_4 -> V_96 , V_130 , V_12 ) ;
}
if ( ! V_4 -> V_26 && V_130 -> V_95 != 0 ) {
V_124 = V_130 -> V_95 ;
V_4 -> V_10 . V_131 = 1 ;
}
V_26 = V_4 -> V_26 ;
...
static void F_52 ( struct V_122 * V_122 )
{
struct V_6 * V_7 = V_122 -> V_123 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
unsigned char * V_133 = V_122 -> V_39 ;
unsigned long V_10 ;
int V_96 = V_122 -> V_96 ;
int V_11 ;
F_10 ( & V_4 -> V_19 , V_10 ) ;
...
F_12 ( & V_4 -> V_19 , V_10 ) ;
if ( V_96 != 0 ) {
F_14 ( & V_122 -> V_14 -> V_14 , L_16 , V_15 ) ;
return;
}
if ( V_122 -> V_129 > 0 ) {
F_53 ( & V_7 -> V_7 , V_133 , V_122 -> V_129 ) ;
F_54 ( & V_7 -> V_7 ) ;
}
V_11 = F_15 ( V_7 -> V_28 , V_132 ) ;
if ( V_11 != 0 && V_11 != - V_134 ) {
F_4 ( & V_7 -> V_14 , L_13
L_14 , V_15 , V_11 ) ;
}
}
static void F_55 ( struct V_122 * V_122 )
{
struct V_6 * V_7 = V_122 -> V_123 ;
struct V_3 * V_4 = F_27 ( V_7 ) ;
int V_96 = V_122 -> V_96 ;
...
case - V_127 :
case - V_128 :
F_14 ( & V_122 -> V_14 -> V_14 , L_10 , V_15 , V_96 ) ;
V_4 -> V_10 . V_32 = 0 ;
return;
default:
F_14 ( & V_122 -> V_14 -> V_14 , L_17 , V_15 , V_96 ) ;
F_14 ( & V_122 -> V_14 -> V_14 , L_18 , V_15 ) ;
V_7 -> V_38 -> V_40 = 1 ;
V_11 = F_15 ( V_7 -> V_38 , V_132 ) ;
if ( V_11 ) {
F_18 ( V_7 , L_13
L_14 , V_15 , V_11 ) ;
} else {
