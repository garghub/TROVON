...
if ( ! V_29 )
return - V_17 ;
V_60 = V_57 ? V_57 -> V_29 : F_30 ( V_11 ) ;
V_29 -> V_14 = & V_11 -> V_14 ;
V_29 -> V_2 = V_2 ;
F_31 ( V_29 -> V_55 , V_60 -> V_55 , sizeof( V_29 -> V_55 ) ) ;
switch ( V_60 -> V_62 ) {
case V_63 :
V_29 -> V_43 = V_64 ;
V_29 -> V_44 = F_32 ( V_64 ) ;
...
F_33 ( V_11 , V_29 ) ;
V_8 = F_34 ( & V_29 -> V_14 -> V_67 , & V_68 ) ;
if ( V_8 ) {
F_28 ( V_29 -> V_14 , L_14 ) ;
return V_8 ;
}
V_29 -> V_69 = F_35 ( V_29 -> V_14 ) ;
if ( F_8 ( V_29 -> V_69 ) ) {
F_28 ( V_29 -> V_14 , L_15 ) ;
V_8 = F_27 ( V_29 -> V_69 ) ;
goto V_70;
...
return 0 ;
V_70:
F_37 ( & V_29 -> V_14 -> V_67 , & V_68 ) ;
F_12 ( V_2 ) ;
return V_8 ;
}
static int F_38 ( struct V_10 * V_11 )
{
struct V_28 * V_29 = F_39 ( V_11 ) ;
struct V_1 * V_2 = V_29 -> V_2 ;
F_40 ( V_29 -> V_69 ) ;
F_37 ( & V_29 -> V_14 -> V_67 , & V_68 ) ;
F_12 ( V_2 ) ;
