...
F_29 ( V_2 , V_113 [ V_2 -> V_5 . V_122 ] ,
F_40 ( V_113 [ 0 ] ) ) ;
F_30 ( V_2 , V_114 [ V_2 -> V_5 . V_122 ] ,
F_40 ( V_114 [ 0 ] ) ) ;
F_30 ( V_2 , V_115 ,
F_40 ( V_115 ) ) ;
}
...
V_123 = 5 ;
F_2 ( V_2 , 0xa4 , V_124 [ V_2 -> V_5 . V_122 ] [ V_123 ] [ 0 ] ) ;
F_2 ( V_2 , 0x23 , V_124 [ V_2 -> V_5 . V_122 ] [ V_123 ] [ 1 ] ) ;
clock = V_124 [ V_2 -> V_5 . V_122 ] [ V_123 ] [ 2 ] ;
if ( V_2 -> V_59 == V_72 )
clock |= 0x80 ;
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
struct V_129 * V_129 = & V_5 -> V_129 ;
V_2 -> V_9 = V_128 -> V_130 & V_131 ;
V_2 -> V_79 = ( V_128 -> V_130 & V_132 ) != 0 ;
switch ( V_2 -> V_9 ) {
case V_10 :
case V_11 :
V_129 -> V_133 = V_134 ;
V_129 -> V_135 = F_40 ( V_134 ) ;
break;
case V_36 :
case V_37 :
V_129 -> V_133 = V_136 ;
V_129 -> V_135 = F_40 ( V_136 ) ;
break;
case V_38 :
V_129 -> V_133 = V_137 ;
V_129 -> V_135 = F_40 ( V_137 ) ;
break;
case V_12 :
V_129 -> V_133 = V_137 ;
V_129 -> V_135 = F_40 ( V_137 ) ;
...
if ( V_2 -> V_77 ) {
V_129 -> V_133 = V_149 ;
V_129 -> V_135 = F_40 ( V_149 ) ;
}
break;
case V_38 :
if ( V_2 -> V_77 ) {
V_129 -> V_133 = V_150 ;
V_129 -> V_135 = F_40 ( V_150 ) ;
}
break;
case V_12 :
switch ( V_2 -> V_59 ) {
...
case V_61 :
V_129 -> V_133 = V_151 ;
V_129 -> V_135 = F_40 ( V_151 ) ;
break;
case V_63 :
V_129 -> V_133 = V_152 ;
V_129 -> V_135 = F_40 ( V_152 ) ;
break;
case V_62 :
V_129 -> V_133 = V_153 ;
V_129 -> V_135 = F_40 ( V_153 ) ;
break;
default:
if ( V_2 -> V_77 ) {
V_129 -> V_133 = V_150 ;
...
case V_13 :
if ( V_2 -> V_77 )
V_129 -> V_135 = F_40 ( V_143 ) - 1 ;
F_50 ( V_2 ) ;
break;
}
switch ( V_2 -> V_59 ) {
case V_60 :
F_30 ( V_2 , V_154 , F_40 ( V_154 ) ) ;
...
case V_12 :
if ( V_5 -> V_171 != 800 )
V_5 -> V_129 . V_138 = V_139 ;
else
V_5 -> V_129 . V_138 = 7 * 4096 ;
break;
}
return 0 ;
}
...
struct V_178 * V_179 ;
struct V_180 * V_181 ;
V_181 = F_53 ( V_2 -> V_5 . V_15 , V_2 -> V_5 . V_182 ) ;
V_179 = F_54 ( V_181 , V_2 -> V_5 . V_179 ) ;
if ( ! V_179 ) {
F_6 ( L_59 ) ;
V_2 -> V_5 . V_8 = - V_183 ;
return;
}
V_174 = F_55 ( V_179 -> V_184 [ 0 ] . V_185 . V_186 ) ;
F_2 ( V_2 , V_187 , V_174 >> 5 ) ;
F_2 ( V_2 , V_188 , 0x01 ) ;
F_2 ( V_2 , V_189 , 0x01 ) ;
F_2 ( V_2 , V_190 , 0x03 ) ;
V_172 = ( V_2 -> V_5 . V_171 >> 3 ) - 1 ;
V_173 = ( V_2 -> V_5 . V_191 >> 3 ) - 1 ;
F_2 ( V_2 , V_192 , V_172 ) ;
F_2 ( V_2 , V_193 , V_173 ) ;
F_2 ( V_2 , V_194 , 0x00 ) ;
F_2 ( V_2 , V_195 , 0x00 ) ;
...
V_175 = ( V_177 ? 60 : 30 ) / ( V_2 -> V_201 + 1 ) + 1 ;
V_176 = V_175 * V_2 -> V_5 . V_171 * V_2 -> V_5 . V_191 * 3 / 2 ;
if ( V_176 > 1000 * V_174 ) {
F_2 ( V_2 , V_100 , 0x07 ) ;
F_2 ( V_2 , V_101 , 0x03 ) ;
} else {
...
V_172 = V_2 -> V_5 . V_171 / 16 ;
V_173 = V_2 -> V_5 . V_191 / 4 ;
F_2 ( V_2 , 0x29 , V_172 ) ;
F_2 ( V_2 , 0x2a , V_173 ) ;
F_2 ( V_2 , 0x39 , V_172 ) ;
F_2 ( V_2 , 0x3a , V_173 ) ;
...
{
static const struct V_53 V_203 [] = {
{ 0x5d , 0x03 } ,
{ 0x53 , 0x9f } ,
{ V_110 , 0x0f } ,
{ 0xa2 , 0x20 } ,
...
switch ( V_2 -> V_59 ) {
default:
F_29 ( V_2 , V_204 , F_40 ( V_204 ) ) ;
if ( V_2 -> V_59 == V_70 ||
V_2 -> V_59 == V_71 ) {
F_10 ( V_2 , V_205 , 0x10 , 0x10 ) ;
}
break;
case V_72 :
return;
...
F_2 ( V_2 , V_206 , V_2 -> V_5 . V_171 >> 4 ) ;
F_2 ( V_2 , V_207 , V_2 -> V_5 . V_191 >> 3 ) ;
if ( V_2 -> V_59 == V_66 &&
V_2 -> V_5 . V_129 . V_133 [ V_2 -> V_5 . V_122 ] . V_208 )
F_2 ( V_2 , V_209 , 0x04 ) ;
...
{
struct V_5 * V_5 = (struct V_5 * ) V_2 ;
int V_215 , V_216 , V_217 , V_218 , V_219 ;
T_2 V_1 ;
V_215 = V_5 -> V_129 . V_133 [ V_5 -> V_122 ] . V_208 & 1 ;
switch ( V_2 -> V_59 ) {
case V_60 :
F_24 ( V_2 , 0x14 , V_215 ? 0x20 : 0x00 , 0x20 ) ;
F_24 ( V_2 , 0x28 , V_215 ? 0x00 : 0x20 , 0x20 ) ;
F_20 ( V_2 , 0x24 , V_215 ? 0x20 : 0x3a ) ;
F_20 ( V_2 , 0x25 , V_215 ? 0x30 : 0x60 ) ;
F_24 ( V_2 , 0x2d , V_215 ? 0x40 : 0x00 , 0x40 ) ;
F_24 ( V_2 , 0x67 , V_215 ? 0xf0 : 0x90 , 0xf0 ) ;
F_24 ( V_2 , 0x74 , V_215 ? 0x20 : 0x00 , 0x20 ) ;
return;
case V_61 : {
T_2 V_1 ;
V_1 = 80 ;
...
F_20 ( V_2 , 0x11 , V_1 ) ;
F_20 ( V_2 , 0x12 , V_215 ? 0x60 : 0x20 ) ;
return;
}
case V_63 :
if ( V_215 ) {
V_216 = ( 1040 - V_5 -> V_171 ) / 2 + ( 0x1f << 4 ) ;
V_218 = ( 776 - V_5 -> V_191 ) / 2 ;
} else {
V_216 = ( 2076 - V_5 -> V_171 ) / 2 + ( 0x10 << 4 ) ;
V_218 = ( 1544 - V_5 -> V_191 ) / 2 ;
}
V_217 = V_216 + V_5 -> V_171 ;
V_219 = V_218 + V_5 -> V_191 ;
F_24 ( V_2 , 0x12 , V_215 ? 0x40 : 0x00 , 0xf0 ) ;
F_24 ( V_2 , 0x32 ,
( ( ( V_217 >> 1 ) & 7 ) << 3 ) | ( ( V_216 >> 1 ) & 7 ) ,
0x3f ) ;
F_24 ( V_2 , 0x03 ,
( ( ( V_219 >> 1 ) & 3 ) << 2 ) | ( ( V_218 >> 1 ) & 3 ) ,
0x0f ) ;
F_20 ( V_2 , 0x17 , V_216 >> 4 ) ;
F_20 ( V_2 , 0x18 , V_217 >> 4 ) ;
F_20 ( V_2 , 0x19 , V_218 >> 3 ) ;
F_20 ( V_2 , 0x1a , V_219 >> 3 ) ;
return;
case V_65 :
F_24 ( V_2 , V_220 , V_215 ? ( 1 << 5 ) : 0 , 1 << 5 ) ;
...
F_20 ( V_2 , 0x25 , V_215 ? 0x30 : 0x60 ) ;
F_24 ( V_2 , 0x2d , V_215 ? 0x40 : 0x00 , 0x40 ) ;
F_24 ( V_2 , 0x67 , V_215 ? 0xb0 : 0x90 , 0xf0 ) ;
F_24 ( V_2 , 0x74 , V_215 ? 0x20 : 0x00 , 0x20 ) ;
F_24 ( V_2 , 0x13 , 0x00 , 0x20 ) ;
F_24 ( V_2 , 0x12 , 0x04 , 0x06 ) ;
if ( V_2 -> V_59 == V_69 )
...
F_20 ( V_2 , V_116 , V_216 >> 3 ) ;
F_20 ( V_2 , V_117 , V_217 >> 3 ) ;
V_1 = F_22 ( V_2 , V_118 ) ;
V_1 = ( V_1 & 0xc0 ) | ( ( V_217 & 0x7 ) << 3 ) | ( V_216 & 0x07 ) ;
F_16 ( 10 ) ;
F_20 ( V_2 , V_118 , V_1 ) ;
F_20 ( V_2 , V_119 , V_218 >> 2 ) ;
F_20 ( V_2 , V_120 , V_219 >> 2 ) ;
V_1 = F_22 ( V_2 , V_121 ) ;
V_1 = ( V_1 & 0xc0 ) | ( ( V_219 & 0x3 ) << 2 ) | ( V_218 & 0x03 ) ;
F_16 ( 10 ) ;
F_20 ( V_2 , V_121 , V_1 ) ;
break;
case V_75 :
...
break;
case V_62 : {
const struct V_56 * V_226 ;
static const struct V_56 V_227 [] = {
...
F_24 ( V_2 , 0x12 , V_215 ? 0x40 : 0x00 , 0x40 ) ;
if ( V_215 )
V_226 = V_2 -> V_125 < 30 ? V_230 : V_229 ;
else
V_226 = V_2 -> V_125 < 15 ? V_228 : V_227 ;
F_30 ( V_2 , V_226 , F_40 ( V_227 ) ) ;
return;
}
default:
return;
}
F_20 ( V_2 , 0x11 , V_2 -> V_201 ) ;
}
static void F_59 ( struct V_5 * V_5 , T_4 V_231 , T_4 V_232 )
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
if ( V_2 -> V_5 . V_233 )
F_2 ( V_2 , V_42 , 0x0f ) ;
F_24 ( V_2 , V_234 ,
V_235 * V_231 | V_236 * V_232 ,
V_235 | V_236 ) ;
if ( V_2 -> V_5 . V_233 )
F_2 ( V_2 , V_42 , 0x00 ) ;
}
...
struct V_5 * V_5 ;
int V_215 , V_237 ;
int V_238 , V_239 , V_240 , V_241 , V_242 , V_243 ;
switch ( V_2 -> V_59 ) {
case V_60 :
case V_61 :
case V_63 :
...
V_5 = & V_2 -> V_5 ;
V_215 = V_5 -> V_129 . V_133 [ V_5 -> V_122 ] . V_208 & 1 ;
V_237 = V_5 -> V_129 . V_133 [ V_5 -> V_122 ] . V_208 & 2 ;
switch ( V_2 -> V_59 ) {
case V_65 :
V_238 = 0x1e ;
V_239 = 0x1e ;
...
F_58 ( V_2 ) ;
F_20 ( V_2 , 0x17 , V_238 ) ;
F_20 ( V_2 , 0x18 , V_239 + ( V_2 -> V_244 >> V_242 ) ) ;
F_20 ( V_2 , 0x19 , V_240 ) ;
F_20 ( V_2 , 0x1a , V_241 + ( V_2 -> V_245 >> V_243 ) ) ;
}
static int F_61 ( struct V_5 * V_5 )
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
V_2 -> V_244 = V_2 -> V_5 . V_171 ;
V_2 -> V_245 = V_2 -> V_5 . V_191 ;
switch ( V_2 -> V_9 ) {
case V_10 :
case V_11 :
F_52 ( V_2 ) ;
...
static void F_69 ( struct V_5 * V_5 , T_2 V_252 )
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
if ( V_2 -> V_249 != V_252 ) {
#if F_66 ( V_248 )
F_67 ( V_5 -> V_250 , V_251 , V_252 ) ;
F_68 ( V_5 -> V_250 ) ;
#endif
if ( V_252 )
V_2 -> V_83 = 1 ;
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
if ( ! ( V_253 [ 0 ] | V_253 [ 1 ] | V_253 [ 2 ] | V_253 [ 3 ] | V_253 [ 4 ] | V_253 [ 5 ] | V_253 [ 6 ] | V_253 [ 7 ] ) &&
( V_253 [ 8 ] & 0x08 ) ) {
F_69 ( V_5 , ( V_253 [ 8 ] >> 2 ) & 1 ) ;
if ( V_253 [ 8 ] & 0x80 ) {
if ( ( V_253 [ 9 ] + 1 ) * 8 != V_5 -> V_171 ||
( V_253 [ 10 ] + 1 ) * 8 != V_5 -> V_191 ) {
F_6 ( L_61
L_62 ,
( V_253 [ 9 ] + 1 ) * 8 , ( V_253 [ 10 ] + 1 ) * 8 ,
V_5 -> V_171 , V_5 -> V_191 ) ;
V_5 -> V_255 = V_256 ;
return;
}
F_71 ( V_5 , V_257 , V_253 , 11 ) ;
return;
} else {
F_71 ( V_5 , V_258 , V_253 , 0 ) ;
V_2 -> V_259 = 0 ;
}
}
V_254 -- ;
F_71 ( V_5 , V_260 , V_253 , V_254 ) ;
}
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
if ( ( ! ( V_261 [ 0 ] | V_261 [ 1 ] | V_261 [ 2 ] | V_261 [ 3 ] | V_261 [ 5 ] ) ) && V_261 [ 6 ] ) {
F_69 ( V_5 , ( V_261 [ 6 ] >> 1 ) & 1 ) ;
F_71 ( V_5 , V_257 , NULL , 0 ) ;
F_71 ( V_5 , V_258 , NULL , 0 ) ;
V_2 -> V_259 = 0 ;
}
if ( V_5 -> V_255 == V_256 )
return;
if ( V_254 & 7 ) {
V_254 -- ;
if ( V_2 -> V_259 == V_261 [ V_254 ] )
V_2 -> V_259 ++ ;
else if ( V_2 -> V_259 == 0 || V_261 [ V_254 ] ) {
F_6 ( L_63 ,
( int ) V_261 [ V_254 ] , ( int ) V_2 -> V_259 ) ;
V_5 -> V_255 = V_256 ;
return;
}
}
F_71 ( V_5 , V_260 , V_261 , V_254 ) ;
}
static void F_73 ( struct V_5 * V_5 ,
T_2 * V_261 ,
int V_254 )
{
if ( V_261 [ 0 ] == 0xff && V_261 [ 1 ] == 0xff && V_261 [ 2 ] == 0xff ) {
switch ( V_261 [ 3 ] ) {
case 0x50 :
#define F_74 16
V_261 += F_74 ;
...
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
F_71 ( V_5 , V_260 , V_261 , V_254 ) ;
if ( V_254 < V_5 -> V_129 . V_138 ) {
if ( V_2 -> V_246 ) {
V_2 -> V_246 -- ;
if ( V_5 -> V_262 <
V_2 -> V_5 . V_171 * V_2 -> V_5 . V_191 )
V_5 -> V_255 = V_256 ;
}
F_71 ( V_5 , V_257 , NULL , 0 ) ;
F_71 ( V_5 , V_258 , NULL , 0 ) ;
...
case V_10 :
case V_11 :
F_70 ( V_5 , V_261 , V_254 ) ;
break;
case V_36 :
case V_37 :
F_72 ( V_5 , V_261 , V_254 ) ;
break;
case V_38 :
F_73 ( V_5 , V_261 , V_254 ) ;
break;
case V_12 :
F_75 ( V_5 , V_261 , V_254 ) ;
break;
case V_13 :
F_77 ( V_5 , V_261 , V_254 ) ;
break;
}
}
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
static const struct V_56 V_263 [] [ 7 ] = {
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
static const struct V_56 V_266 [] [ 31 ] = {
...
case V_74 :
case V_76 :
F_24 ( V_2 , V_267 , V_55 >> 4 , 0x0f ) ;
break;
case V_65 : {
static const T_2 V_268 [] = {
0x03 , 0x09 , 0x0b , 0x0f , 0x53 , 0x6f , 0x35 , 0x7f
} ;
F_20 ( V_2 , 0x64 , V_268 [ V_55 >> 5 ] ) ;
break;
}
case V_73 :
case V_68 : {
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
static const struct V_56 V_270 [] [ 6 ] = {
...
switch ( V_55 ) {
case 0 :
F_24 ( V_2 , V_224 , 0 , V_272 ) ;
break;
case 1 :
F_24 ( V_2 , V_224 , V_272 ,
V_272 ) ;
F_24 ( V_2 , V_273 , 0x08 , 0x18 ) ;
break;
case 2 :
F_24 ( V_2 , V_224 , V_272 ,
V_272 ) ;
F_24 ( V_2 , V_273 , 0x00 , 0x18 ) ;
break;
case 3 :
F_24 ( V_2 , V_224 , V_272 ,
V_272 ) ;
F_24 ( V_2 , V_273 , V_274 ,
0x18 ) ;
break;
}
} else {
...
if ( V_2 -> V_9 != V_13 )
return - V_277 ;
F_89 ( V_2 -> V_279 , V_276 -> V_278 ) ;
return 0 ;
}
static int F_90 ( struct V_284 * V_285 )
{
struct V_5 * V_5 =
F_91 ( V_285 -> V_286 , struct V_5 , V_287 ) ;
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
V_5 -> V_8 = 0 ;
switch ( V_285 -> V_128 ) {
case V_288 :
V_5 -> V_289 -> V_55 = F_22 ( V_2 , 0x10 ) ;
break;
}
return 0 ;
}
...
if ( V_285 -> V_294 )
F_82 ( V_5 , V_285 -> V_55 ) ;
if ( ! V_285 -> V_55 && V_2 -> V_295 -> V_294 )
F_78 ( V_5 , V_2 -> V_295 -> V_55 ) ;
break;
case V_296 :
F_81 ( V_5 , V_285 -> V_55 ) ;
break;
case V_297 :
F_59 ( V_5 , V_285 -> V_55 , V_2 -> V_232 -> V_55 ) ;
break;
case V_288 :
if ( V_285 -> V_294 )
F_46 ( V_5 , V_285 -> V_55 ) ;
if ( ! V_285 -> V_55 && V_5 -> V_289 -> V_294 )
F_80 ( V_5 , V_5 -> V_289 -> V_55 ) ;
break;
case V_298 :
return - V_299 ;
}
...
{
struct V_2 * V_2 = (struct V_2 * ) V_5 ;
struct V_300 * V_301 = & V_5 -> V_287 ;
V_5 -> V_302 . V_287 = V_301 ;
F_94 ( V_301 , 10 ) ;
if ( V_303 [ V_2 -> V_59 ] . V_304 )
V_2 -> V_295 = F_95 ( V_301 , & V_305 ,
V_290 , 0 ,
V_2 -> V_59 == V_72 ? 6 : 255 , 1 ,
V_2 -> V_59 == V_72 ? 3 : 127 ) ;
if ( V_303 [ V_2 -> V_59 ] . V_306 ) {
if ( V_2 -> V_59 == V_72 )
F_95 ( V_301 , & V_305 ,
V_291 , 0 , 6 , 1 , 3 ) ;
else
...
if ( V_303 [ V_2 -> V_59 ] . V_307 )
F_95 ( V_301 , & V_305 ,
V_296 , 0 ,
V_2 -> V_59 == V_72 ? 4 : 255 , 1 ,
V_2 -> V_59 == V_72 ? 2 : 127 ) ;
if ( V_303 [ V_2 -> V_59 ] . V_308 )
V_5 -> V_289 = F_95 ( V_301 , & V_305 ,
V_309 , 0 , 255 , 1 , 127 ) ;
if ( V_303 [ V_2 -> V_59 ] . V_310 ) {
V_2 -> V_231 = F_95 ( V_301 , & V_305 ,
V_297 , 0 , 1 , 1 , 0 ) ;
V_2 -> V_232 = F_95 ( V_301 , & V_305 ,
V_311 , 0 , 1 , 1 , 0 ) ;
}
if ( V_303 [ V_2 -> V_59 ] . V_312 )
V_2 -> V_313 = F_95 ( V_301 , & V_305 ,
V_293 , 0 , 1 , 1 , 1 ) ;
if ( V_303 [ V_2 -> V_59 ] . V_314 )
V_5 -> V_315 = F_95 ( V_301 , & V_305 ,
V_288 , 0 , 1 , 1 , 1 ) ;
if ( V_303 [ V_2 -> V_59 ] . V_316 ) {
if ( V_2 -> V_59 == V_66 )
V_2 -> V_317 = F_96 ( V_301 , & V_305 ,
V_292 ,
V_318 , 0 ,
V_318 ) ;
else
...
if ( V_5 -> V_315 )
F_97 ( 3 , & V_5 -> V_315 , 0 , true ) ;
if ( V_2 -> V_313 )
F_97 ( 2 , & V_2 -> V_313 , 0 , false ) ;
if ( V_2 -> V_231 )
F_98 ( 2 , & V_2 -> V_231 ) ;
return 0 ;
}
static int F_99 ( struct V_180 * V_181 ,
const struct V_127 * V_128 )
{
return F_100 ( V_181 , V_128 , & V_323 , sizeof( struct V_2 ) ,
V_324 ) ;
}
