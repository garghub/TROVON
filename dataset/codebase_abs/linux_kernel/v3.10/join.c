...
V_2 -> V_99 . V_159 ) ;
return F_50 ( V_2 , V_245 ,
V_221 , 0 , V_15 ) ;
}
static int F_54 ( struct V_1 * V_2 , T_1 * V_258 )
{
T_1 V_83 [ V_247 ] ;
int V_27 ;
if ( ! V_258 || F_55 ( V_258 ) )
...
int F_56 ( struct V_1 * V_2 , T_1 * V_258 )
{
if ( ! V_2 -> V_152 )
return 0 ;
switch ( V_2 -> V_198 ) {
case V_256 :
return F_54 ( V_2 , V_258 ) ;
case V_200 :
return F_50 ( V_2 ,
V_260 ,
V_221 , 0 , NULL ) ;
case V_261 :
return F_50 ( V_2 , V_262 ,
V_221 , 0 , NULL ) ;
default:
break;
}
