...
F_1 ( V_1 , V_2 , & V_39 , 1 ) ;
F_6 ( V_1 , V_2 , 1 ) ;
return V_1 -> V_10 [ 0 ] == V_39 ;
}
static int F_16 ( struct V_1 * V_1 ,
const struct V_40 * V_41 )
{
struct V_25 * V_25 = (struct V_25 * ) V_1 ;
if ( ( unsigned ) V_26 >= V_42 )
V_26 = 0 ;
V_25 -> V_26 = V_26 ;
V_1 -> V_43 . V_44 = 1 ;
V_25 -> V_34 = - 1 ;
...
if ( V_25 -> V_26 == V_47 )
V_25 -> V_26 = V_27 ;
} else if ( V_41 -> V_50 == 0x06a5 && V_41 -> V_51 == 0xd800 ) {
F_6 ( V_1 , 0x0403 , 1 ) ;
F_2 ( V_52 , L_7 ,
V_1 -> V_10 [ 0 ] ) ;
switch ( V_1 -> V_10 [ 0 ] >> 1 ) {
...
if ( V_56 [ V_25 -> V_26 ] != V_25 -> V_45 ) {
F_5 ( L_8 ,
V_25 -> V_26 , V_25 -> V_45 ) ;
V_1 -> V_8 = - V_57 ;
return V_1 -> V_8 ;
}
F_2 ( V_52 , L_9 , V_25 -> V_45 , V_25 -> V_26 ) ;
if ( V_25 -> V_45 == V_58 ) {
switch ( V_25 -> V_26 ) {
case V_59 :
V_1 -> V_43 . V_60 = V_61 ;
...
F_22 ( V_1 , V_82 , NULL , 0 ) ;
F_22 ( V_1 , V_83 , V_3 + 8 , V_4 - 8 ) ;
} else {
F_22 ( V_1 , V_84 , V_3 , V_4 ) ;
}
}
...
return;
V_25 -> V_34 = V_35 ;
F_6 ( V_1 , V_25 -> V_45 == V_49 ? 0x080d : 0x080c , 4 ) ;
V_85 = ( V_1 -> V_10 [ 3 ] << 24 ) + ( V_1 -> V_10 [ 2 ] << 16 )
...
{
struct V_1 * V_1 =
F_27 ( V_87 -> V_88 , struct V_1 , V_89 ) ;
V_1 -> V_8 = 0 ;
if ( ! V_1 -> V_90 )
return 0 ;
switch ( V_87 -> V_41 ) {
...
{
struct V_25 * V_25 = (struct V_25 * ) V_1 ;
struct V_96 * V_97 = & V_1 -> V_89 ;
V_1 -> V_98 . V_89 = V_97 ;
F_29 ( V_97 , 3 ) ;
switch ( V_25 -> V_26 ) {
case V_27 :
V_1 -> V_99 = F_30 ( V_97 , & V_100 ,
V_91 , 0 , 1 , 1 , 1 ) ;
V_1 -> V_93 = F_30 ( V_97 , & V_100 ,
V_101 , 0 , 127 , 1 , 127 / 5 * 2 ) ;
V_1 -> V_94 = F_30 ( V_97 , & V_100 ,
V_95 , 0 , 9 , 1 , 9 ) ;
break;
case V_28 :
V_1 -> V_99 = F_30 ( V_97 , & V_100 ,
...
if ( V_1 -> V_99 )
F_31 ( 3 , & V_1 -> V_99 , 0 , false ) ;
return 0 ;
}
static int F_32 ( struct V_102 * V_103 ,
const struct V_40 * V_41 )
{
return F_33 ( V_103 , V_41 , & V_104 , sizeof( struct V_25 ) ,
V_105 ) ;
}
