...
{
F_4 ( V_1 -> V_7 , L_15 , V_71 ) ;
F_38 ( & V_1 -> V_7 -> V_46 , & V_74 ) ;
F_36 ( V_1 -> V_7 ) ;
F_16 ( V_1 ) ;
}
static bool F_39 ( struct V_33 * V_7 , unsigned int V_2 )
{
switch ( V_2 ) {
case 0x10 ... 0x2c :
case 0x30 ... 0x38 :
...
V_1 = F_43 ( & V_77 -> V_7 , sizeof( * V_1 ) , V_79 ) ;
if ( ! V_1 )
return - V_80 ;
F_44 ( V_77 , V_1 ) ;
V_1 -> V_6 = F_45 ( V_77 , & V_81 ) ;
if ( F_46 ( V_1 -> V_6 ) )
return F_47 ( V_1 -> V_6 ) ;
V_1 -> V_7 = & V_77 -> V_7 ;
V_1 -> V_82 = V_77 -> V_82 ;
