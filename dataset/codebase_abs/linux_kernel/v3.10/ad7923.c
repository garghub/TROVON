...
{
struct V_4 * V_5 ;
struct V_1 * V_2 = F_24 ( sizeof( * V_5 ) ) ;
...
V_5 -> V_11 = V_57 | V_36 |
F_26 ( V_58 ) ;
V_55 = & V_54 [ F_27 ( V_24 ) -> V_59 ] ;
V_2 -> V_60 = F_27 ( V_24 ) -> V_60 ;
V_2 -> V_61 . V_62 = & V_24 -> V_61 ;
V_2 -> V_63 = V_64 ;
V_2 -> V_65 = V_55 -> V_65 ;
V_2 -> V_66 = V_55 -> V_66 ;
V_2 -> V_55 = & V_67 ;
...
static int F_38 ( struct V_53 * V_24 )
{
