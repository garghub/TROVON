...
static int F_46 ( struct V_184 * V_184 ,
...
unsigned int V_3 ;
V_72 = F_47 ( & V_184 -> V_2 , sizeof( struct V_71 ) ,
V_187 ) ;
if ( V_72 == NULL )
return - V_188 ;
V_72 -> V_2 = & V_184 -> V_2 ;
V_72 -> V_132 = F_48 ( V_184 , & V_189 ) ;
if ( F_49 ( V_72 -> V_132 ) ) {
V_59 = F_50 ( V_72 -> V_132 ) ;
F_7 ( & V_184 -> V_2 , L_12 , V_59 ) ;
return V_59 ;
}
F_51 ( V_184 , V_72 ) ;
if ( F_52 ( & V_184 -> V_2 ) )
memcpy ( & V_72 -> V_171 , F_52 ( & V_184 -> V_2 ) ,
sizeof( V_72 -> V_171 ) ) ;
V_59 = F_53 ( V_72 -> V_132 , V_190 ,
F_4 ( V_190 ) ) ;
if ( V_59 != 0 )
F_54 ( V_72 -> V_2 , L_13 ,
V_59 ) ;
V_59 = F_55 ( V_72 -> V_132 , V_4 , & V_3 ) ;
V_186 = V_3 & V_191 ;
if ( V_186 != V_192 ) {
V_59 = - V_193 ;
F_7 ( & V_184 -> V_2 ,
...
static int F_57 ( struct V_184 * V_196 )
{
F_58 ( & V_196 -> V_2 ) ;
return 0 ;
}
