...
F_54 ( V_149 -> V_18 , V_6 ,
V_178 -> V_182 ) ;
V_149 -> V_18 -> V_152 . V_196 += V_178 -> V_182 ;
}
exit:
F_61 ( & V_149 -> V_197 ) ;
...
const unsigned char * V_6 , int V_233 )
{
struct V_46 * V_149 = F_58 ( V_18 ) ;
if ( V_233 == 0 ) {
...
if ( V_149 -> V_195 == 1 )
return - V_61 ;
V_233 = F_82 ( & V_149 -> V_231 , V_6 , V_233 ,
& V_149 -> V_197 ) ;
F_67 ( V_18 , V_154 ) ;
return V_233 ;
}
static void F_67 ( struct V_17 * V_18 , struct V_153 * V_154 )
{
int V_233 , V_234 ;
struct V_46 * V_149 = F_58 ( V_18 ) ;
unsigned long V_230 ;
...
V_149 -> V_203 = 1 ;
F_79 ( & V_149 -> V_197 , V_230 ) ;
F_11 ( & V_18 -> V_2 , V_12 , V_233 , V_18 -> V_225 -> V_181 ) ;
V_18 -> V_225 -> V_236 = V_233 ;
V_234 = F_59 ( V_18 -> V_225 , V_193 ) ;
if ( V_234 ) {
F_66 ( V_18 ,
L_97 ,
V_12 , V_234 ) ;
...
V_149 -> V_18 -> V_152 . V_237 += V_233 ;
if ( V_154 )
F_51 ( V_154 ) ;
}
static int F_84 ( struct V_153 * V_154 )
{
struct V_17 * V_18 = V_154 -> V_238 ;
struct V_46 * V_149 = F_58 ( V_18 ) ;
int V_239 = 0 ;
unsigned long V_230 ;
if ( V_149 == NULL )
...
return 0 ;
F_77 ( & V_149 -> V_197 , V_230 ) ;
V_239 = F_85 ( & V_149 -> V_231 ) ;
F_79 ( & V_149 -> V_197 , V_230 ) ;
F_4 ( & V_18 -> V_2 , L_98 , V_12 , V_239 ) ;
return V_239 ;
}
...
return 0 ;
F_77 ( & V_149 -> V_197 , V_230 ) ;
V_240 = F_87 ( & V_149 -> V_231 ) ;
F_79 ( & V_149 -> V_197 , V_230 ) ;
F_4 ( & V_18 -> V_2 , L_98 , V_12 , V_240 ) ;
return V_240 ;
}
...
return;
if ( F_90 ( V_154 ) ) {
unsigned char V_242 = F_91 ( V_154 ) ;
V_8 = F_81 ( V_154 , V_18 , & V_242 , 1 ) ;
if ( V_8 <= 0 ) {
...
return;
if ( F_90 ( V_154 ) ) {
unsigned char V_243 = F_94 ( V_154 ) ;
V_8 = F_81 ( V_154 , V_18 , & V_243 , 1 ) ;
if ( V_8 <= 0 ) {
...
static void F_92 ( struct V_46 * V_149 )
{
unsigned long V_230 ;
F_77 ( & V_149 -> V_197 , V_230 ) ;
if ( V_149 -> V_198 == V_199 )
...
static int F_95 ( struct V_46 * V_149 )
{
struct V_178 * V_178 ;
int V_8 = 0 ;
unsigned long V_230 ;
...
static void F_96 ( struct V_153 * V_154 ,
struct V_46 * V_149 , struct V_244 * V_245 )
{
struct V_43 * V_2 = & V_149 -> V_18 -> V_2 ;
struct V_246 * V_57 ;
int V_247 ;
...
V_248 = V_154 -> V_210 . V_249 ;
V_57 -> V_250 = 0 ;
V_57 -> V_250 |= V_251 ;
V_57 -> V_250 |= V_252 ;
V_57 -> V_253 = ( T_1 ) ( V_149 -> V_253 ) ;
switch ( V_248 & V_254 ) {
case V_255 :
V_57 -> V_256 = V_257 ;
F_4 ( V_2 , L_103 , V_12 ) ;
...
V_57 -> V_278 = F_94 ( V_154 ) ;
V_57 -> V_279 = F_91 ( V_154 ) ;
if ( F_90 ( V_154 ) ) {
V_57 -> V_250 |= V_280 ;
F_4 ( V_2 , L_114 ,
V_12 , V_57 -> V_278 , V_57 -> V_279 ) ;
} else
F_4 ( V_2 , L_115 , V_12 ) ;
if ( F_97 ( V_154 ) ) {
V_57 -> V_250 |= V_281 ;
...
F_4 ( V_2 , L_117 , V_12 ) ;
V_154 -> V_210 . V_249 &= ~ V_282 ;
V_247 = F_98 ( V_154 ) ;
if ( ! V_247 ) {
V_247 = 9600 ;
} else
F_99 ( V_154 , V_247 , V_247 ) ;
V_149 -> V_283 = V_247 ;
V_57 -> V_284 = ( T_2 ) ( ( 461550L + V_247 / 2 ) / V_247 ) ;
F_4 ( V_2 , L_118 , V_12 , V_247 , V_57 -> V_284 ) ;
F_4 ( V_2 , L_119 , ( int ) ( 461550L / V_57 -> V_284 ) ) ;
F_4 ( V_2 , L_120 , V_57 -> V_250 ) ;
F_4 ( V_2 , L_121 , V_57 -> V_256 ) ;
F_4 ( V_2 , L_122 , V_57 -> V_267 ) ;
F_4 ( V_2 , L_123 , V_57 -> V_272 ) ;
F_4 ( V_2 , L_124 , V_57 -> V_278 ) ;
F_4 ( V_2 , L_125 , V_57 -> V_279 ) ;
F_4 ( V_2 , L_126 , V_57 -> V_253 ) ;
F_100 ( & V_57 -> V_250 ) ;
F_100 ( & V_57 -> V_284 ) ;
V_8 = F_7 ( V_149 -> V_18 -> V_22 -> V_2 , V_285 ,
( T_1 ) ( V_25 + V_20 ) ,
...
V_154 -> V_210 . V_249 , V_154 -> V_210 . V_286 ) ;
F_4 ( & V_18 -> V_2 , L_129 , V_12 ,
V_245 -> V_249 , V_245 -> V_286 ) ;
F_4 ( & V_18 -> V_2 , L_102 , V_12 , V_18 -> V_21 ) ;
if ( V_149 == NULL )
return;
F_96 ( V_154 , V_149 , V_245 ) ;
}
...
V_150 = V_149 -> V_164 ;
V_141 = V_149 -> V_219 ;
V_234 = ( ( V_141 & V_143 ) ? V_290 : 0 )
| ( ( V_141 & V_145 ) ? V_289 : 0 )
| ( ( V_150 & V_165 ) ? V_292 : 0 )
| ( ( V_150 & V_293 ) ? V_294 : 0 )
| ( ( V_150 & V_295 ) ? V_296 : 0 )
| ( ( V_150 & V_297 ) ? V_298 : 0 ) ;
F_4 ( & V_18 -> V_2 , L_130 , V_12 , V_234 ) ;
F_79 ( & V_149 -> V_197 , V_230 ) ;
return V_234 ;
}
static int F_103 ( struct V_46 * V_149 ,
struct V_299 T_8 * V_300 )
{
struct V_299 V_301 ;
unsigned V_302 ;
if ( ! V_300 )
return - V_303 ;
V_302 = V_149 -> V_18 -> V_18 . V_304 ;
if ( V_302 != V_305 )
V_302 = F_104 ( V_302 ) / 10 ;
memset ( & V_301 , 0 , sizeof( V_301 ) ) ;
V_301 . type = V_306 ;
V_301 . line = V_149 -> V_18 -> V_22 -> V_23 ;
V_301 . V_18 = V_149 -> V_18 -> V_21 ;
V_301 . V_307 = 0 ;
V_301 . V_230 = V_308 | V_309 ;
V_301 . V_310 = V_149 -> V_18 -> V_235 ;
V_301 . V_311 = 9600 ;
V_301 . V_312 = 5 * V_313 ;
V_301 . V_304 = V_302 ;
if ( F_105 ( V_300 , & V_301 , sizeof( * V_300 ) ) )
return - V_303 ;
return 0 ;
}
static int F_106 ( struct V_153 * V_154 ,
unsigned int V_314 , unsigned long V_315 )
{
struct V_17 * V_18 = V_154 -> V_238 ;
struct V_46 * V_149 = F_58 ( V_18 ) ;
F_4 ( & V_18 -> V_2 , L_131 , V_12 , V_18 -> V_21 , V_314 ) ;
switch ( V_314 ) {
case V_316 :
F_4 ( & V_18 -> V_2 , L_132 , V_12 ) ;
return F_103 ( V_149 ,
(struct V_299 T_8 * ) V_315 ) ;
}
return - V_317 ;
}
static void F_107 ( struct V_153 * V_154 , int V_318 )
{
struct V_17 * V_18 = V_154 -> V_238 ;
struct V_46 * V_149 = F_58 ( V_18 ) ;
int V_8 ;
...
if ( V_318 == - 1 )
V_319 = 1 ;
V_8 = F_43 ( V_149 , V_320 , V_319 ) ;
if ( V_8 )
F_4 ( & V_18 -> V_2 , L_133 ,
V_12 , V_8 ) ;
}
static int F_108 ( struct V_109 * V_22 )
{
struct V_35 * V_179 ;
int V_8 ;
V_179 = F_109 ( sizeof( struct V_35 ) , V_40 ) ;
if ( V_179 == NULL ) {
F_16 ( & V_22 -> V_2 -> V_2 , L_134 , V_12 ) ;
return - V_41 ;
}
F_110 ( & V_179 -> V_220 ) ;
V_179 -> V_22 = V_22 ;
...
static void F_112 ( struct V_109 * V_22 )
{
}
static void F_113 ( struct V_109 * V_22 )
{
F_17 ( F_76 ( V_22 ) ) ;
}
...
struct V_46 * V_149 ;
int V_241 ;
V_149 = F_109 ( sizeof( * V_149 ) , V_40 ) ;
if ( ! V_149 )
return - V_41 ;
V_241 = F_115 ( & V_149 -> V_231 , V_321 ,
V_40 ) ;
if ( V_241 ) {
F_17 ( V_149 ) ;
return - V_41 ;
...
V_18 -> V_18 . V_304 = F_120 ( V_304 * 10 ) ;
return 0 ;
}
...
static T_9 F_123 ( struct V_43 * V_2 ,
struct V_323 * V_324 , char * V_325 )
{
struct V_17 * V_18 = F_124 ( V_2 ) ;
struct V_46 * V_149 = F_58 ( V_18 ) ;
return sprintf ( V_325 , L_64 , V_149 -> V_253 ) ;
}
static T_9 F_125 ( struct V_43 * V_2 ,
struct V_323 * V_324 , const char * V_326 , T_10 V_233 )
{
struct V_17 * V_18 = F_124 ( V_2 ) ;
struct V_46 * V_149 = F_58 ( V_18 ) ;
unsigned int V_327 = F_126 ( V_326 , NULL , 0 ) ;
F_4 ( V_2 , L_135 , V_12 , V_327 ) ;
if ( V_327 < 256 )
V_149 -> V_253 = V_327 ;
else
F_16 ( V_2 , L_136 , V_12 , V_327 ) ;
return V_233 ;
}
static int F_118 ( struct V_17 * V_18 )
{
return F_127 ( & V_18 -> V_2 , & V_328 ) ;
}
static int F_122 ( struct V_17 * V_18 )
{
F_128 ( & V_18 -> V_2 , & V_328 ) ;
return 0 ;
}
