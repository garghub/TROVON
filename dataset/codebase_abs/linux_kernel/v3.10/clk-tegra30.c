...
V_42 [ V_196 ] = V_36 ;
for ( V_20 = 0 ; V_20 < F_8 ( V_197 ) ; V_20 ++ ) {
V_164 = & V_197 [ V_20 ] ;
V_36 = F_31 ( V_164 -> V_198 , V_164 -> V_199 ,
V_164 -> V_200 , & V_164 -> V_201 ,
V_2 , V_164 -> V_202 , V_164 -> V_203 ) ;
F_16 ( V_36 , V_164 -> V_204 , V_164 -> V_205 ) ;
V_42 [ V_164 -> V_206 ] = V_36 ;
}
for ( V_20 = 0 ; V_20 < F_8 ( V_207 ) ; V_20 ++ ) {
V_164 = & V_207 [ V_20 ] ;
V_36 = F_32 ( V_164 -> V_198 ,
V_164 -> V_199 ,
V_164 -> V_200 , & V_164 -> V_201 ,
V_2 , V_164 -> V_202 ) ;
F_16 ( V_36 , V_164 -> V_204 , V_164 -> V_205 ) ;
...
{
struct V_36 * V_36 ;
V_36 = F_34 ( NULL , L_79 , NULL , V_208 ,
32768 ) ;
F_16 ( V_36 , L_79 , NULL ) ;
V_42 [ V_209 ] = V_36 ;
...
V_42 [ V_213 ] = V_36 ;
V_36 = F_24 ( NULL , L_142 , L_31 , 0 , V_2 + V_92 ,
1 , 0 , & V_212 ) ;
...
unsigned int V_6 ;
F_1 () ;
V_36 = F_34 ( NULL , L_96 , NULL , V_208 ,
V_10 ) ;
F_16 ( V_36 , L_96 , NULL ) ;
V_42 [ V_215 ] = V_36 ;
V_6 = F_6 () ;
...
static void F_39 ( T_1 V_217 )
{
F_40 ( F_41 ( V_217 ) ,
V_2 + V_219 ) ;
F_42 () ;
}
static void F_43 ( T_1 V_217 )
{
F_40 ( F_41 ( V_217 ) ,
V_2 + V_220 ) ;
F_44 () ;
}
static void F_45 ( T_1 V_217 )
{
unsigned int V_19 ;
F_40 ( F_46 ( V_217 ) ,
V_2 + V_221 ) ;
...
static void F_47 ( T_1 V_217 )
{
unsigned int V_19 ;
V_19 = F_37 ( V_2 + V_222 ) ;
F_40 ( V_19 | F_46 ( V_217 ) ,
V_2 + V_222 ) ;
}
...
{
unsigned int V_19 , V_239 ;
V_19 = F_37 ( V_2 + V_232 ) ;
V_239 = ( V_19 >> V_240 ) & 0xF ;
if ( V_239 == V_241 )
V_19 = ( V_19 >> V_242 ) & 0xF ;
else if ( V_239 == V_243 )
V_19 = ( V_19 >> V_244 ) & 0xF ;
...
{
F_54 ( V_246 , V_42 , V_247 ) ;
}
void T_2 F_55 ( struct V_248 * V_249 )
{
struct V_248 * V_250 ;
int V_20 ;
V_2 = F_56 ( V_249 , 0 ) ;
...
if ( ! V_42 [ V_20 ] )
V_42 [ V_20 ] = F_60 ( - V_252 ) ;
}
F_61 ( V_253 , V_42 , V_247 ) ;
V_254 . V_42 = V_42 ;
V_254 . V_255 = F_8 ( V_42 ) ;
F_62 ( V_249 , V_256 , & V_254 ) ;
V_257 = F_53 ;
V_258 = & V_259 ;
}
