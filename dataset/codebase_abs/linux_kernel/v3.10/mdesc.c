...
static void T_3 F_57 ( struct V_1 * V_2 , T_2 V_88 , int V_99 )
{
T_2 V_32 ;
...
static void T_3 F_60 ( struct V_1 * V_2 , T_2 V_88 , int V_105 )
{
T_2 V_32 ;
F_32 (a, hp, mp, MDESC_ARC_TYPE_BACK) {
T_2 V_100 = F_33 ( V_2 , V_32 ) ;
...
static void T_3 F_61 ( struct V_1 * V_2 , const char * V_106 )
{
int V_104 ;
T_2 V_88 ;
V_104 = 0 ;
...
static void T_3 F_63 ( const T_2 * V_42 , unsigned int * V_107 ,
...
static void T_3 F_64 ( struct V_1 * V_2 , T_2 V_88 ,
struct V_111 * V_112 )
{
static int V_113 ;
const T_2 * V_64 ;
...
static void * T_3 F_67 ( void * (* F_36)( struct V_1 * , T_2 , int , void * ) , void * V_118 , T_5 * V_107 )
{
struct V_1 * V_2 = F_20 () ;
void * V_61 = NULL ;
T_2 V_88 ;
...
static void * T_3 F_69 ( struct V_1 * V_2 , T_2 V_88 , int V_119 , void * V_118 )
{
V_121 ++ ;
#ifdef F_53
F_70 ( V_119 , true ) ;
...
void T_1 F_73 ( T_5 * V_107 , unsigned long * V_125 )
{
* V_125 = 0 ;
F_67 ( F_72 , V_125 , V_107 ) ;
}
static void * T_3 F_74 ( struct V_1 * V_2 , T_2 V_88 , int V_119 , void * V_118 )
{
...
static T_6 F_78 ( struct V_135 * V_135 , char T_7 * V_136 ,
T_8 V_46 , T_9 * V_137 )
{
struct V_1 * V_2 = F_20 () ;
int V_138 ;
...
if ( V_46 < V_2 -> V_3 )
V_138 = - V_140 ;
else if ( F_79 ( V_136 , & V_2 -> V_5 , V_2 -> V_3 ) )
V_138 = - V_141 ;
F_24 ( V_2 ) ;
return V_138 ;
}
