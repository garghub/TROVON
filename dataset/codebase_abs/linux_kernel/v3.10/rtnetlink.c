...
struct V_136 V_222 ;
V_218 . V_223 = - 1 ;
memset ( V_218 . V_224 , 0 , sizeof( V_218 . V_224 ) ) ;
if ( V_29 -> V_144 -> V_214 ( V_29 , V_66 , & V_218 ) )
break;
V_219 . V_152 =
V_220 . V_152 =
V_221 . V_152 =
V_222 . V_152 = V_218 . V_152 ;
...
V_152 = F_47 ( V_40 , V_230 ) ;
if ( ! V_152 ) {
F_50 ( V_40 , V_215 ) ;
goto V_70;
}
if ( F_70 ( V_40 , V_231 , sizeof( V_219 ) , & V_219 ) ||
F_70 ( V_40 , V_232 , sizeof( V_220 ) , & V_220 ) ||
F_70 ( V_40 , V_233 , sizeof( V_221 ) ,
& V_221 ) ||
F_70 ( V_40 , V_234 , sizeof( V_222 ) ,
& V_222 ) )
goto V_70;
F_49 ( V_40 , V_152 ) ;
}
...
static int F_104 ( struct V_39 * V_40 , struct V_239 * V_240 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
int V_242 , V_243 ;
int V_244 = 0 , V_245 ;
struct V_28 * V_29 ;
struct V_246 * V_247 ;
struct V_32 * V_248 [ V_249 + 1 ] ;
T_5 V_129 = 0 ;
V_243 = V_240 -> args [ 0 ] ;
V_245 = V_240 -> args [ 1 ] ;
F_106 () ;
V_240 -> V_159 = V_27 -> V_250 ;
if ( F_107 ( V_240 -> V_61 , sizeof( struct V_97 ) , V_248 , V_249 ,
V_251 ) >= 0 ) {
if ( V_248 [ V_252 ] )
V_129 = F_108 ( V_248 [ V_252 ] ) ;
}
for ( V_242 = V_243 ; V_242 < V_253 ; V_242 ++ , V_245 = 0 ) {
V_244 = 0 ;
V_247 = & V_27 -> V_254 [ V_242 ] ;
F_109 (dev, head, index_hlist) {
if ( V_244 < V_245 )
goto V_255;
if ( F_89 ( V_40 , V_29 , V_256 ,
F_52 ( V_240 -> V_40 ) . V_257 ,
V_240 -> V_61 -> V_258 , 0 ,
V_259 ,
V_129 ) <= 0 )
goto V_45;
F_110 ( V_240 , F_111 ( V_40 ) ) ;
V_255:
V_244 ++ ;
}
}
...
struct V_27 * F_113 ( struct V_27 * V_261 , struct V_32 * V_248 [] )
{
struct V_27 * V_27 ;
if ( V_248 [ V_262 ] )
V_27 = F_114 ( F_108 ( V_248 [ V_262 ] ) ) ;
else if ( V_248 [ V_263 ] )
V_27 = F_115 ( F_108 ( V_248 [ V_263 ] ) ) ;
else
V_27 = F_116 ( V_261 ) ;
return V_27 ;
}
static int F_117 ( struct V_28 * V_29 , struct V_32 * V_248 [] )
{
if ( V_29 ) {
if ( V_248 [ V_207 ] &&
F_118 ( V_248 [ V_207 ] ) < V_29 -> V_206 )
return - V_264 ;
if ( V_248 [ V_209 ] &&
F_118 ( V_248 [ V_209 ] ) < V_29 -> V_206 )
return - V_264 ;
}
if ( V_248 [ V_235 ] ) {
struct V_32 * V_237 ;
...
{
int V_265 , V_26 = - V_264 ;
struct V_32 * V_152 ;
const struct V_270 * V_20 = V_29 -> V_144 ;
F_119 (vf, attr, rem) {
switch ( F_120 ( V_152 ) ) {
case V_231 : {
struct V_133 * V_271 ;
...
V_26 = - V_268 ;
if ( V_20 -> V_272 )
V_26 = V_20 -> V_272 ( V_29 , V_271 -> V_152 ,
V_271 -> V_224 ) ;
break;
}
case V_232 : {
...
struct V_32 * * V_248 , char * V_281 , int V_282 )
{
const struct V_270 * V_20 = V_29 -> V_144 ;
int V_26 ;
if ( V_248 [ V_262 ] || V_248 [ V_263 ] ) {
struct V_27 * V_27 = F_113 ( F_124 ( V_29 ) , V_248 ) ;
if ( F_126 ( V_27 ) ) {
V_26 = F_127 ( V_27 ) ;
goto V_283;
}
if ( ! F_128 ( V_27 -> V_284 , V_285 ) ) {
V_26 = - V_286 ;
goto V_283;
}
V_26 = F_129 ( V_29 , V_27 , V_281 ) ;
F_130 ( V_27 ) ;
if ( V_26 )
goto V_283;
V_282 = 1 ;
...
V_287 = F_101 ( V_248 [ V_205 ] ) ;
V_289 . V_198 = ( unsigned long ) V_287 -> V_198 ;
V_289 . V_199 = ( unsigned long ) V_287 -> V_199 ;
V_289 . V_200 = ( unsigned short ) V_287 -> V_200 ;
V_289 . V_201 = ( unsigned char ) V_287 -> V_201 ;
V_289 . V_202 = ( unsigned char ) V_287 -> V_202 ;
V_289 . V_203 = ( unsigned char ) V_287 -> V_203 ;
...
struct V_292 * V_293 ;
int V_260 ;
V_260 = sizeof( V_294 ) + V_29 -> V_206 ;
V_293 = F_132 ( V_260 , V_15 ) ;
if ( ! V_293 ) {
V_26 = - V_295 ;
goto V_283;
}
V_293 -> V_296 = V_29 -> type ;
memcpy ( V_293 -> V_297 , F_101 ( V_248 [ V_207 ] ) ,
V_29 -> V_206 ) ;
V_26 = F_133 ( V_29 , V_293 ) ;
F_24 ( V_293 ) ;
if ( V_26 )
goto V_283;
V_282 = 1 ;
...
if ( V_248 [ V_180 ] ) {
V_26 = F_134 ( V_29 , F_108 ( V_248 [ V_180 ] ) ) ;
if ( V_26 < 0 )
goto V_283;
V_282 = 1 ;
}
if ( V_248 [ V_182 ] ) {
F_135 ( V_29 , F_108 ( V_248 [ V_182 ] ) ) ;
V_282 = 1 ;
}
if ( V_98 -> V_170 > 0 && V_281 [ 0 ] ) {
V_26 = F_136 ( V_29 , V_281 ) ;
if ( V_26 < 0 )
goto V_283;
V_282 = 1 ;
}
if ( V_248 [ V_196 ] ) {
V_26 = F_137 ( V_29 , F_101 ( V_248 [ V_196 ] ) ,
F_118 ( V_248 [ V_196 ] ) ) ;
if ( V_26 < 0 )
goto V_283;
V_282 = 1 ;
...
if ( V_248 [ V_209 ] ) {
F_138 ( V_29 -> V_210 , V_248 [ V_209 ] , V_29 -> V_206 ) ;
F_139 ( V_298 , V_29 ) ;
}
...
if ( V_248 [ V_191 ] ) {
V_26 = F_122 ( V_29 , F_108 ( V_248 [ V_191 ] ) ) ;
if ( V_26 )
goto V_283;
V_282 = 1 ;
}
if ( V_248 [ V_192 ] ) {
V_26 = F_141 ( V_29 , F_142 ( V_248 [ V_192 ] ) ) ;
if ( V_26 )
goto V_283;
V_282 = 1 ;
}
if ( V_248 [ V_174 ] )
V_29 -> V_175 = F_108 ( V_248 [ V_174 ] ) ;
if ( V_248 [ V_176 ] )
F_71 ( V_29 , F_142 ( V_248 [ V_176 ] ) ) ;
if ( V_248 [ V_178 ] ) {
F_73 ( & V_93 ) ;
V_29 -> V_179 = F_142 ( V_248 [ V_178 ] ) ;
F_74 ( & V_93 ) ;
}
if ( V_248 [ V_216 ] ) {
struct V_32 * V_163 ;
...
V_26 = V_20 -> V_300 ( V_29 , V_152 , V_203 ) ;
if ( V_26 < 0 )
goto V_283;
V_282 = 1 ;
}
...
V_26 = - V_268 ;
if ( V_20 -> V_300 )
V_26 = V_20 -> V_300 ( V_29 , V_158 , V_203 ) ;
if ( V_26 < 0 )
goto V_283;
V_282 = 1 ;
}
...
struct V_32 * V_248 [ V_249 + 1 ] ;
char V_281 [ V_146 ] ;
V_26 = F_107 ( V_61 , sizeof( * V_98 ) , V_248 , V_249 , V_251 ) ;
if ( V_26 < 0 )
goto V_283;
if ( V_248 [ V_172 ] )
F_147 ( V_281 , V_248 [ V_172 ] , V_146 ) ;
else
V_281 [ 0 ] = '\0' ;
V_26 = - V_264 ;
V_98 = F_93 ( V_61 ) ;
...
V_26 = F_117 ( V_29 , V_248 ) ;
if ( V_26 < 0 )
goto V_283;
V_26 = F_125 ( V_29 , V_98 , V_248 , V_281 , 0 ) ;
V_283:
return V_26 ;
}
...
char * V_281 , const struct V_18 * V_20 , struct V_32 * V_248 [] )
{
int V_26 ;
struct V_28 * V_29 ;
...
if ( V_248 [ V_185 ] )
V_186 = F_108 ( V_248 [ V_185 ] ) ;
else if ( V_20 -> V_305 )
V_186 = V_20 -> V_305 () ;
if ( V_248 [ V_187 ] )
V_188 = F_108 ( V_248 [ V_187 ] ) ;
else if ( V_20 -> V_306 )
V_188 = V_20 -> V_306 () ;
V_26 = - V_295 ;
V_29 = F_155 ( V_20 -> V_307 , V_281 , V_20 -> V_308 ,
V_186 , V_188 ) ;
if ( ! V_29 )
goto V_26;
F_156 ( V_29 , V_27 ) ;
...
V_29 -> V_303 = V_309 ;
if ( V_248 [ V_180 ] )
V_29 -> V_181 = F_108 ( V_248 [ V_180 ] ) ;
if ( V_248 [ V_207 ] ) {
memcpy ( V_29 -> V_208 , F_101 ( V_248 [ V_207 ] ) ,
F_118 ( V_248 [ V_207 ] ) ) ;
V_29 -> V_310 = V_311 ;
}
if ( V_248 [ V_209 ] )
memcpy ( V_29 -> V_210 , F_101 ( V_248 [ V_209 ] ) ,
F_118 ( V_248 [ V_209 ] ) ) ;
if ( V_248 [ V_174 ] )
V_29 -> V_175 = F_108 ( V_248 [ V_174 ] ) ;
if ( V_248 [ V_176 ] )
...
F_32 (net, dev) {
if ( V_29 -> V_53 == V_53 ) {
V_26 = F_125 ( V_29 , V_98 , V_248 , NULL , 0 ) ;
if ( V_26 < 0 )
return V_26 ;
}
}
...
! V_20 -> V_323 )
return - V_268 ;
V_26 = V_20 -> V_323 ( V_29 , V_248 , V_42 ) ;
if ( V_26 < 0 )
return V_26 ;
V_282 = 1 ;
}
return F_125 ( V_29 , V_98 , V_248 , V_281 , V_282 ) ;
}
if ( ! ( V_61 -> V_320 & V_324 ) ) {
if ( V_98 -> V_170 == 0 && V_248 [ V_182 ] )
return F_158 ( V_27 ,
F_108 ( V_248 [ V_182 ] ) ,
V_98 , V_248 ) ;
return - V_291 ;
}
if ( V_248 [ V_205 ] || V_248 [ V_191 ] || V_248 [ V_325 ] )
return - V_268 ;
if ( ! V_20 ) {
#ifdef F_160
if ( V_19 [ 0 ] ) {
...
if ( ! V_281 [ 0 ] )
snprintf ( V_281 , V_146 , L_5 , V_20 -> V_19 ) ;
V_317 = F_113 ( V_27 , V_248 ) ;
if ( F_126 ( V_317 ) )
return F_127 ( V_317 ) ;
V_29 = F_154 ( V_317 , V_281 , V_20 , V_248 ) ;
if ( F_126 ( V_29 ) ) {
V_26 = F_127 ( V_29 ) ;
goto V_45;
}
...
if ( V_20 -> V_326 )
V_26 = V_20 -> V_326 ( V_27 , V_29 , V_248 , V_42 ) ;
else
V_26 = F_162 ( V_29 ) ;
...
if ( V_29 == NULL )
return - V_291 ;
V_327 = F_166 ( F_84 ( V_29 , V_129 ) , V_15 ) ;
if ( V_327 == NULL )
return - V_16 ;
V_26 = F_89 ( V_327 , V_29 , V_256 , F_52 ( V_40 ) . V_257 ,
V_61 -> V_258 , 0 , 0 , V_129 ) ;
if ( V_26 < 0 ) {
F_167 ( V_26 == - V_43 ) ;
F_168 ( V_327 ) ;
} else
V_26 = F_56 ( V_327 , V_27 , F_52 ( V_40 ) . V_257 ) ;
return V_26 ;
}
...
T_5 V_129 = 0 ;
T_8 V_328 = 0 ;
if ( F_107 ( V_61 , sizeof( struct V_97 ) , V_248 , V_249 ,
V_251 ) >= 0 ) {
if ( V_248 [ V_252 ] )
V_129 = F_108 ( V_248 [ V_252 ] ) ;
}
...
V_328 = F_170 ( T_8 , V_328 ,
F_84 ( V_29 ,
V_129 ) ) ;
}
return V_328 ;
}
static int F_171 ( struct V_39 * V_40 , struct V_239 * V_240 )
{
int V_244 ;
...
int type = V_240 -> V_61 -> V_330 - V_4 ;
if ( V_244 < V_245 || V_244 == V_331 )
continue;
if ( V_10 [ V_244 ] == NULL ||
...
int V_26 = - V_16 ;
T_4 V_333 ;
V_40 = F_166 ( ( V_333 = F_84 ( V_29 , 0 ) ) , V_15 ) ;
if ( V_40 == NULL )
goto V_283;
...
struct V_60 * V_61 ;
struct V_336 * V_337 ;
V_61 = F_92 ( V_40 , V_52 , V_159 , type , sizeof( * V_337 ) , V_259 ) ;
if ( ! V_61 )
return - V_43 ;
V_337 = F_93 ( V_61 ) ;
V_337 -> V_338 = V_339 ;
...
static void F_174 ( struct V_28 * V_29 , T_9 * V_335 , int type )
{
struct V_27 * V_27 = F_124 ( V_29 ) ;
struct V_39 * V_40 ;
int V_26 = - V_16 ;
V_40 = F_166 ( F_173 () , V_349 ) ;
if ( ! V_40 )
goto V_283;
V_26 = F_172 ( V_40 , V_29 , V_335 , 0 , 0 , type , V_350 ) ;
if ( V_26 < 0 ) {
F_168 ( V_40 ) ;
goto V_283;
}
...
int F_175 ( struct V_336 * V_337 ,
struct V_32 * V_248 [] ,
struct V_28 * V_29 ,
const unsigned char * V_335 ,
T_8 V_62 )
{
int V_26 = - V_264 ;
if ( V_337 -> V_345 && ! ( V_337 -> V_345 & V_346 ) ) {
F_176 ( L_6 , V_29 -> V_173 ) ;
return V_26 ;
}
if ( F_177 ( V_335 ) || F_178 ( V_335 ) )
V_26 = F_179 ( V_29 , V_335 ) ;
else if ( F_180 ( V_335 ) )
V_26 = F_181 ( V_29 , V_335 ) ;
if ( V_26 == - V_21 && ! ( V_62 & V_321 ) )
V_26 = 0 ;
return V_26 ;
}
...
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_336 * V_337 ;
struct V_32 * V_248 [ V_352 + 1 ] ;
struct V_28 * V_29 ;
T_9 * V_335 ;
int V_26 ;
V_26 = F_107 ( V_61 , sizeof( * V_337 ) , V_248 , V_352 , NULL ) ;
if ( V_26 < 0 )
return V_26 ;
V_337 = F_93 ( V_61 ) ;
if ( V_337 -> V_344 == 0 ) {
...
V_29 = F_123 ( V_27 , V_337 -> V_344 ) ;
if ( V_29 == NULL ) {
F_176 ( L_8 ) ;
return - V_291 ;
}
if ( ! V_248 [ V_347 ] || F_118 ( V_248 [ V_347 ] ) != V_348 ) {
F_176 ( L_9 ) ;
return - V_264 ;
}
V_335 = F_101 ( V_248 [ V_347 ] ) ;
if ( F_183 ( V_335 ) ) {
F_176 ( L_10 ) ;
return - V_264 ;
}
...
( V_29 -> V_354 & V_355 ) ) {
struct V_28 * V_356 = F_90 ( V_29 ) ;
const struct V_270 * V_20 = V_356 -> V_144 ;
V_26 = V_20 -> V_357 ( V_337 , V_248 , V_29 , V_335 , V_61 -> V_320 ) ;
if ( V_26 )
goto V_45;
else
V_337 -> V_342 &= ~ V_353 ;
}
if ( ( V_337 -> V_342 & V_350 ) ) {
if ( V_29 -> V_144 -> V_357 )
V_26 = V_29 -> V_144 -> V_357 ( V_337 , V_248 , V_29 , V_335 ,
V_61 -> V_320 ) ;
else
V_26 = F_175 ( V_337 , V_248 , V_29 , V_335 ,
V_61 -> V_320 ) ;
if ( ! V_26 ) {
F_174 ( V_29 , V_335 , V_358 ) ;
V_337 -> V_342 &= ~ V_350 ;
}
}
V_45:
...
if ( F_177 ( V_335 ) || F_178 ( V_335 ) )
V_26 = F_185 ( V_29 , V_335 ) ;
else if ( F_180 ( V_335 ) )
V_26 = F_186 ( V_29 , V_335 ) ;
else
V_26 = - V_264 ;
return V_26 ;
}
static int F_187 ( struct V_39 * V_40 , struct V_60 * V_61 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_336 * V_337 ;
struct V_32 * V_248 [ V_352 + 1 ] ;
...
const struct V_270 * V_20 = V_356 -> V_144 ;
if ( V_20 -> V_359 )
V_26 = V_20 -> V_359 ( V_337 , V_248 , V_29 , V_335 ) ;
if ( V_26 )
goto V_45;
else
V_337 -> V_342 &= ~ V_353 ;
...
if ( V_337 -> V_342 & V_350 ) {
if ( V_29 -> V_144 -> V_359 )
V_26 = V_29 -> V_144 -> V_359 ( V_337 , V_248 , V_29 , V_335 ) ;
else
V_26 = F_184 ( V_337 , V_248 , V_29 , V_335 ) ;
if ( ! V_26 ) {
F_174 ( V_29 , V_335 , V_360 ) ;
V_337 -> V_342 &= ~ V_350 ;
}
}
V_45:
...
static int F_189 ( struct V_39 * V_40 ,
struct V_239 * V_240 ,
struct V_28 * V_29 ,
int * V_244 ,
struct V_361 * V_24 )
...
int V_26 ;
T_5 V_257 , V_159 ;
V_257 = F_52 ( V_240 -> V_40 ) . V_257 ;
V_159 = V_240 -> V_61 -> V_258 ;
F_26 (ha, &list->list, list) {
if ( * V_244 < V_240 -> args [ 0 ] )
goto V_364;
V_26 = F_172 ( V_40 , V_29 , V_363 -> V_335 ,
V_257 , V_159 ,
V_358 , V_350 ) ;
if ( V_26 < 0 )
return V_26 ;
...
int V_26 ;
F_191 ( V_29 ) ;
V_26 = F_189 ( V_40 , V_240 , V_29 , & V_244 , & V_29 -> V_365 ) ;
if ( V_26 )
goto V_45;
F_189 ( V_40 , V_240 , V_29 , & V_244 , & V_29 -> V_366 ) ;
V_45:
F_192 ( V_29 ) ;
return V_244 ;
}
static int F_193 ( struct V_39 * V_40 , struct V_239 * V_240 )
{
int V_244 = 0 ;
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_28 * V_29 ;
...
V_20 = V_356 -> V_144 ;
if ( V_20 -> V_367 )
V_244 = V_20 -> V_367 ( V_40 , V_240 , V_29 , V_244 ) ;
}
if ( V_29 -> V_144 -> V_367 )
V_244 = V_29 -> V_144 -> V_367 ( V_40 , V_240 , V_29 , V_244 ) ;
else
V_244 = F_190 ( V_40 , V_240 , V_29 , V_244 ) ;
}
F_112 () ;
V_240 -> args [ 0 ] = V_244 ;
return V_40 -> V_260 ;
}
int F_195 ( struct V_39 * V_40 , T_5 V_52 , T_5 V_159 ,
struct V_28 * V_29 , T_8 V_368 )
{
struct V_60 * V_61 ;
struct V_97 * V_98 ;
struct V_32 * V_369 ;
...
struct V_28 * V_356 = F_90 ( V_29 ) ;
V_61 = F_92 ( V_40 , V_52 , V_159 , V_256 , sizeof( * V_98 ) , V_259 ) ;
if ( V_61 == NULL )
return - V_43 ;
V_98 = F_93 ( V_61 ) ;
V_98 -> V_166 = V_339 ;
...
( V_356 &&
F_64 ( V_40 , V_191 , V_356 -> V_171 ) ) ||
( V_29 -> V_206 &&
F_70 ( V_40 , V_207 , V_29 -> V_206 , V_29 -> V_208 ) ) ||
( V_29 -> V_171 != V_29 -> V_189 &&
F_64 ( V_40 , V_190 , V_29 -> V_189 ) ) )
goto V_70;
V_369 = F_47 ( V_40 , V_235 ) ;
if ( ! V_369 )
goto V_70;
if ( F_196 ( V_40 , V_370 , V_371 ) ||
F_196 ( V_40 , V_372 , V_368 ) ) {
F_50 ( V_40 , V_369 ) ;
goto V_70;
}
F_49 ( V_40 , V_369 ) ;
...
static int F_197 ( struct V_39 * V_40 , struct V_239 * V_240 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_28 * V_29 ;
int V_244 = 0 ;
T_5 V_257 = F_52 ( V_240 -> V_40 ) . V_257 ;
T_5 V_159 = V_240 -> V_61 -> V_258 ;
struct V_32 * V_373 ;
T_5 V_374 = 0 ;
V_373 = F_198 ( V_240 -> V_61 , sizeof( struct V_375 ) ,
V_252 ) ;
if ( V_373 )
V_374 = F_108 ( V_373 ) ;
F_106 () ;
...
const struct V_270 * V_20 = V_29 -> V_144 ;
struct V_28 * V_356 = F_90 ( V_29 ) ;
if ( V_356 && V_356 -> V_144 -> V_376 ) {
if ( V_244 >= V_240 -> args [ 0 ] &&
V_356 -> V_144 -> V_376 (
V_40 , V_257 , V_159 , V_29 , V_374 ) < 0 )
break;
V_244 ++ ;
}
if ( V_20 -> V_376 ) {
if ( V_244 >= V_240 -> args [ 0 ] &&
V_20 -> V_376 ( V_40 , V_257 , V_159 , V_29 ,
V_374 ) < 0 )
break;
V_244 ++ ;
}
...
static int F_200 ( struct V_28 * V_29 , T_8 V_62 )
{
struct V_27 * V_27 = F_124 ( V_29 ) ;
struct V_28 * V_356 = F_90 ( V_29 ) ;
struct V_39 * V_40 ;
int V_26 = - V_268 ;
V_40 = F_166 ( F_199 () , V_349 ) ;
if ( ! V_40 ) {
V_26 = - V_295 ;
goto V_283;
}
if ( ( ! V_62 || ( V_62 & V_377 ) ) &&
V_356 && V_356 -> V_144 -> V_376 ) {
V_26 = V_356 -> V_144 -> V_376 ( V_40 , 0 , 0 , V_29 , 0 ) ;
if ( V_26 < 0 )
goto V_283;
}
if ( ( V_62 & V_371 ) &&
V_29 -> V_144 -> V_376 ) {
V_26 = V_29 -> V_144 -> V_376 ( V_40 , 0 , 0 , V_29 , 0 ) ;
if ( V_26 < 0 )
goto V_283;
}
F_58 ( V_40 , V_27 , 0 , V_334 , NULL , V_349 ) ;
return 0 ;
V_283:
F_167 ( V_26 == - V_43 ) ;
F_168 ( V_40 ) ;
...
static int F_201 ( struct V_39 * V_40 , struct V_60 * V_61 )
{
struct V_27 * V_27 = F_105 ( V_40 -> V_241 ) ;
struct V_97 * V_98 ;
struct V_28 * V_29 ;
struct V_32 * V_378 , * V_163 = NULL ;
int V_265 , V_26 = - V_268 ;
T_8 V_379 , V_62 = 0 ;
bool V_380 = false ;
if ( F_202 ( V_61 ) < sizeof( * V_98 ) )
return - V_264 ;
V_98 = F_93 ( V_61 ) ;
if ( V_98 -> V_166 != V_339 )
return - V_381 ;
...
V_378 = F_198 ( V_61 , sizeof( struct V_97 ) , V_235 ) ;
if ( V_378 ) {
F_119 (attr, br_spec, rem) {
if ( F_120 ( V_163 ) == V_370 ) {
V_380 = true ;
V_62 = F_203 ( V_163 ) ;
break;
}
...
if ( ! V_62 || ( V_62 & V_377 ) ) {
struct V_28 * V_356 = F_90 ( V_29 ) ;
if ( ! V_356 || ! V_356 -> V_144 -> V_382 ) {
V_26 = - V_268 ;
goto V_45;
}
V_26 = V_356 -> V_144 -> V_382 ( V_29 , V_61 ) ;
if ( V_26 )
goto V_45;
V_62 &= ~ V_377 ;
}
...
V_26 = V_29 -> V_144 -> V_382 ( V_29 , V_61 ) ;
if ( ! V_26 )
V_62 &= ~ V_371 ;
}
if ( V_380 )
...
if ( ! V_62 || ( V_62 & V_377 ) ) {
struct V_28 * V_356 = F_90 ( V_29 ) ;
if ( ! V_356 || ! V_356 -> V_144 -> V_383 ) {
V_26 = - V_268 ;
goto V_45;
}
V_26 = V_356 -> V_144 -> V_383 ( V_29 , V_61 ) ;
if ( V_26 )
goto V_45;
V_62 &= ~ V_377 ;
}
...
V_26 = V_29 -> V_144 -> V_383 ( V_29 , V_61 ) ;
if ( ! V_26 )
V_62 &= ~ V_371 ;
}
if ( V_380 )
...
return - V_268 ;
type -= V_4 ;
if ( F_202 ( V_61 ) < sizeof( struct V_375 ) )
return 0 ;
V_36 = ( (struct V_375 * ) F_93 ( V_61 ) ) -> V_386 ;
V_384 = type >> 2 ;
V_19 = type & 3 ;
if ( V_19 != 2 && ! F_128 ( V_27 -> V_284 , V_285 ) )
return - V_286 ;
if ( V_19 == 2 && V_61 -> V_320 & V_387 ) {
struct V_55 * V_56 ;
T_2 V_13 ;
T_3 V_14 ;
T_8 V_388 = 0 ;
...
V_26 = F_206 ( V_56 , V_40 , V_61 , & V_390 ) ;
}
F_1 () ;
return V_26 ;
}
...
static void F_207 ( struct V_39 * V_40 )
{
F_1 () ;
F_208 ( V_40 , & F_205 ) ;
F_5 () ;
}
static int F_209 ( struct V_392 * V_393 , unsigned long V_394 , void * V_395 )
{
struct V_28 * V_29 = V_395 ;
switch ( V_394 ) {
case V_396 :
case V_397 :
case V_398 :
...
F_21 ( L_16 ) ;
F_216 ( & V_418 ) ;
F_20 ( V_12 , V_419 , F_165 ,
F_104 , F_169 ) ;
F_20 ( V_12 , V_420 , F_146 , NULL , NULL ) ;
F_20 ( V_12 , V_256 , F_159 , NULL , NULL ) ;
F_20 ( V_12 , V_421 , F_149 , NULL , NULL ) ;
F_20 ( V_12 , V_422 , NULL , F_171 , NULL ) ;
F_20 ( V_12 , V_423 , NULL , F_171 , NULL ) ;
F_20 ( V_424 , V_358 , F_182 , NULL , NULL ) ;
F_20 ( V_424 , V_360 , F_187 , NULL , NULL ) ;
F_20 ( V_424 , V_425 , NULL , F_193 , NULL ) ;
F_20 ( V_424 , V_419 , NULL , F_197 , NULL ) ;
F_20 ( V_424 , V_421 , F_204 , NULL , NULL ) ;
F_20 ( V_424 , V_420 , F_201 , NULL , NULL ) ;
}
