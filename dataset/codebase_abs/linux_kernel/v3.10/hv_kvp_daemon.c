...
V_184 = V_204 ;
F_55 ( V_8 , V_205 , V_206 , & V_184 , sizeof( V_184 ) ) ;
V_169 = (struct V_163 * ) V_207 ;
V_169 -> V_208 . V_209 = V_204 ;
V_169 -> V_208 . V_210 = V_211 ;
V_190 = (struct V_189 * ) V_169 -> V_212 ;
...
V_186 . V_8 = V_8 ;
while ( 1 ) {
struct V_203 * V_217 = (struct V_203 * ) & V_91 ;
T_4 V_218 = sizeof( V_91 ) ;
V_186 . V_219 = V_220 ;
V_186 . V_221 = 0 ;
F_56 ( & V_186 , 1 , - 1 ) ;
V_72 = F_57 ( V_8 , V_222 , sizeof( V_222 ) , 0 ,
V_217 , & V_218 ) ;
if ( V_72 < 0 ) {
F_4 ( V_10 , L_65 ,
V_91 . V_201 , V_223 , strerror ( V_223 ) ) ;
F_54 ( V_8 ) ;
return - 1 ;
}
if ( V_91 . V_201 ) {
...
V_187 = (struct V_165 * ) V_222 ;
if ( V_187 -> V_174 != V_175 )
continue;
V_188 = (struct V_163 * ) F_58 ( V_187 ) ;
V_190 = (struct V_189 * ) V_188 -> V_212 ;
V_102 = V_190 -> V_213 . V_214 ;
V_1 = V_190 -> V_213 . V_1 ;
V_190 -> error = V_225 ;
if ( ( V_226 ) && ( V_102 == V_215 ) ) {
V_226 = 0 ;
V_43 = ( char * ) V_190 -> V_227 . V_228 . V_229 ;
V_230 = malloc ( strlen ( V_43 ) + 1 ) ;
if ( V_230 ) {
strcpy ( V_230 , V_43 ) ;
F_4 ( V_195 , L_67 ,
V_230 ) ;
...
switch ( V_102 ) {
case V_122 :
V_193 = & V_190 -> V_227 . V_193 ;
V_63 =
F_24 ( ( char * ) V_193 -> V_231 ) ;
if ( V_63 == NULL ) {
V_190 -> error = V_101 ;
break;
}
...
case V_234 :
if ( F_13 ( V_1 ,
V_190 -> V_227 . V_235 . V_212 . V_33 ,
V_190 -> V_227 . V_235 . V_212 . V_34 ,
V_190 -> V_227 . V_235 . V_212 . V_37 ,
V_190 -> V_227 . V_235 . V_212 . V_38 ) )
V_190 -> error = V_236 ;
break;
case V_237 :
if ( F_14 ( V_1 ,
...
case V_238 :
if ( F_12 ( V_1 ,
V_190 -> V_227 . V_239 . V_33 ,
V_190 -> V_227 . V_239 . V_34 ) )
V_190 -> error = V_236 ;
break;
default:
break;
...
if ( V_1 != V_241 ) {
if ( F_15 ( V_1 ,
V_190 -> V_227 . V_242 . V_41 ,
V_190 -> V_227 . V_242 . V_212 . V_33 ,
V_39 ,
V_190 -> V_227 . V_242 . V_212 . V_37 ,
V_40 ) )
V_190 -> error = V_236 ;
goto V_240;
}
V_190 = (struct V_189 * ) V_188 -> V_212 ;
V_192 = ( char * ) V_190 -> V_227 . V_242 . V_212 . V_33 ;
V_191 = ( char * ) V_190 -> V_227 . V_242 . V_212 . V_37 ;
switch ( V_190 -> V_227 . V_242 . V_41 ) {
case V_243 :
F_42 ( V_191 ,
V_40 ) ;
strcpy ( V_192 , L_68 ) ;
...
V_240:
V_188 -> V_208 . V_209 = V_204 ;
V_188 -> V_208 . V_210 = V_211 ;
V_188 -> V_216 = 0 ;
