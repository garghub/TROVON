...
static int F_85 ( struct V_97 * V_37 , const struct V_211 * V_212 )
{
...
F_99 ( V_31 -> V_230 ) ;
F_100 ( & V_31 -> V_103 ) ;
V_215 = F_101 ( V_26 -> V_104 , F_77 , 0 , L_25 , V_26 ) ;
if ( V_215 ) {
F_26 ( V_217 L_26 , V_26 -> V_104 ) ;
goto V_232;
}
V_215 = F_101 ( V_31 -> V_105 , F_60 , 0 , L_27 , V_26 ) ;
if ( V_215 ) {
F_26 ( V_217 L_26 , V_31 -> V_105 ) ;
goto V_233;
}
V_215 = F_101 ( V_31 -> V_106 , F_54 , 0 , L_28 , V_26 ) ;
if ( V_215 ) {
F_26 ( V_217 L_26 , V_31 -> V_106 ) ;
goto V_234;
}
F_33 ( V_26 -> V_104 ) ;
F_16 ( V_36 , F_17 ( V_31 -> V_37 ) , 0 , 0 ) ;
...
F_26 ( V_236 L_30 ,
V_26 -> V_237 , ( V_50 ? L_31 : L_32 ) , V_26 -> V_79 ) ;
F_42 ( ( L_33 , V_26 -> V_29 ) ) ;
F_26 ( L_3 ) ;
return 0 ;
V_235:
