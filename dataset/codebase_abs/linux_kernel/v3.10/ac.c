...
F_23 ( V_40 ) ;
F_1 ( V_2 ) ;
F_24 ( V_6 , V_35 , ( T_2 ) V_2 -> V_8 ) ;
F_25 ( V_6 -> V_41 . V_42 ,
F_26 ( & V_6 -> V_43 ) , V_35 ,
( T_2 ) V_2 -> V_8 ) ;
F_27 ( V_6 , V_35 , ( T_2 ) V_2 -> V_8 ) ;
F_28 ( & V_2 -> V_44 . V_43 -> V_45 , V_46 ) ;
}
return;
}
static int F_29 ( const struct V_47 * V_48 )
{
V_40 = 1000 ;
return 0 ;
}
static int F_30 ( struct V_28 * V_6 )
{
int V_49 = 0 ;
struct V_1 * V_2 = NULL ;
if ( ! V_6 )
return - V_5 ;
V_2 = F_31 ( sizeof( struct V_1 ) , V_50 ) ;
if ( ! V_2 )
return - V_51 ;
V_2 -> V_6 = V_6 ;
strcpy ( F_32 ( V_6 ) , V_52 ) ;
strcpy ( F_33 ( V_6 ) , V_53 ) ;
V_6 -> V_54 = V_2 ;
V_49 = F_1 ( V_2 ) ;
if ( V_49 )
goto V_55;
...
V_2 -> V_44 . type = V_57 ;
V_2 -> V_44 . V_58 = V_59 ;
V_2 -> V_44 . V_60 = F_35 ( V_59 ) ;
V_2 -> V_44 . V_61 = F_5 ;
V_49 = F_36 ( & V_2 -> V_6 -> V_43 , & V_2 -> V_44 ) ;
if ( V_49 )
goto V_55;
...
static int F_39 ( struct V_6 * V_43 )
{
struct V_1 * V_2 ;
unsigned V_63 ;
if ( ! V_43 )
...
static int F_41 ( struct V_28 * V_6 )
{
struct V_1 * V_2 = NULL ;
if ( ! V_6 || ! F_18 ( V_6 ) )
return - V_5 ;
