...
static int F_26 ( struct V_69 * V_70 , struct V_1 * V_3 )
{
T_6 * V_16 ;
struct V_71 * V_72 ;
char * V_73 ;
...
V_72 -> V_87 -- ;
V_72 -> V_88 = 0 ;
V_72 -> V_88 = F_28 ( ( unsigned char * ) V_72 , V_72 -> V_89 ) ;
if ( V_16 -> V_90 . V_76 != 0 ) {
F_27 ( L_33 ,
V_3 -> V_11 -> V_30 , V_16 -> V_90 . V_76 ) ;
V_77 . V_76 = V_16 -> V_90 . V_76 ;
F_29 ( V_70 , V_91 ) ;
F_30 ( V_70 , sizeof( V_77 ) ) ;
F_31 ( V_70 , & V_77 ,
sizeof( V_77 ) ) ;
} else {
F_29 ( V_70 , V_91 ) ;
F_30 ( V_70 , sizeof( struct V_74 ) ) ;
F_31 ( V_70 , & V_92 ,
sizeof( struct V_74 ) ) ;
}
F_32 ( V_70 -> V_93 , & F_33 ( V_16 -> V_94 ) -> V_95 ) ;
F_34 ( V_70 ) -> V_96 = V_16 -> V_94 -> V_96 ;
...
if ( V_100 -> V_103 != F_35 ( V_104 ) )
goto V_102;
if ( V_70 -> V_105 < V_91 + sizeof( struct V_71 ) )
goto V_102;
F_36 ( V_70 , V_91 ) ;
if ( V_70 -> V_105 < V_91 + F_37 ( V_70 ) -> V_89 * 4 || F_37 ( V_70 ) -> V_89 < 5 )
goto V_102;
while ( V_101 < V_3 -> V_61 ) {
if ( F_38 ( V_100 -> V_106 , V_3 -> V_66 + V_101 * V_64 ) )
if ( F_26 ( V_70 , V_3 ) == 0 )
return V_107 ;
V_101 ++ ;
}
...
static int F_39 ( struct V_7 * V_8 , void T_8 * V_108 )
{
int V_109 ;
struct V_1 * V_3 ;
struct V_110 V_111 ;
T_6 * V_112 ;
T_1 V_18 ;
V_109 = F_40 ( & V_111 , V_108 , sizeof( struct V_110 ) ) ;
if ( V_109 != 0 ) {
F_7 ( L_35 ,
V_109 ) ;
return - V_113 ;
...
static void F_41 ( struct V_7 * V_8 , struct V_10 * V_11 )
{
struct V_1 * V_3 ;
T_6 * V_112 ;
T_9 * V_123 ;
...
struct V_130 * V_131 = F_33 ( V_8 ) ;
F_19 ( L_44 , V_11 -> V_30 ) ;
F_42 ( & V_131 -> V_132 , V_70 ) ;
V_131 -> V_133 ( V_131 , V_70 -> V_105 ) ;
return;
}
F_43 ( V_8 , V_70 -> V_93 ) ;
V_3 = F_3 ( V_11 ) ;
...
F_29 ( V_70 , sizeof( struct V_74 ) + sizeof( V_76 ) ) ;
V_126 = F_46 ( V_70 , V_127 -> V_90 . V_136 ) ;
F_44 ( V_70 ) ;
if ( V_126 == NULL ) {
V_3 -> V_125 -> V_84 ( V_127 ) ;
return;
}
F_30 ( V_126 , V_127 -> V_90 . V_136 ) ;
F_31 ( V_126 , V_127 -> V_90 . V_137 ,
V_127 -> V_90 . V_136 ) ;
V_126 -> V_138 = F_47 ( V_126 , V_11 ) ;
F_48 ( V_126 ) ;
V_127 -> V_139 = F_37 ( V_126 ) -> V_140 ;
V_127 -> V_141 ++ ;
V_3 -> V_125 -> V_84 ( V_127 ) ;
memset ( F_34 ( V_126 ) , 0 , sizeof( struct V_142 ) ) ;
F_49 ( V_126 ) ;
}
static int F_50 ( struct V_7 * V_8 , int V_108 )
{
struct V_1 * V_3 ;
struct V_143 * V_144 ;
int V_145 ;
...
V_8 -> V_11 = & V_153 ;
F_57 ( F_33 ( V_8 ) ) ;
F_58 ( V_154 , & V_8 -> V_155 ) ;
F_58 ( V_156 , & V_8 -> V_155 ) ;
if ( V_3 -> V_11 ) {
char V_157 [ V_158 ] ;
...
V_3 -> V_9 = NULL ;
if ( V_3 -> V_11 ) {
struct V_143 * V_144 = F_55 ( V_3 -> V_11 ) ;
...
V_3 -> V_81 -> V_166 ( V_3 ) ;
V_3 -> V_125 -> V_166 ( V_3 ) ;
while ( ( V_70 = F_62 ( & F_33 ( V_8 ) -> V_132 ) ) ) {
F_43 ( V_8 , V_70 -> V_93 ) ;
F_63 ( V_70 ) ;
}
F_7 ( L_55 ,
...
static int F_65 ( struct V_7 * V_8 , struct V_69 * V_70 )
{
struct V_1 * V_3 = F_2 ( V_8 ) ;
struct V_162 * V_163 = (struct V_162 * ) V_70 -> V_78 ;
F_66 ( V_70 -> V_93 , & F_33 ( V_8 ) -> V_95 ) ;
if ( V_3 == NULL ) {
F_7 ( L_57 ) ;
return 0 ;
}
...
case V_175 :
F_21 ( L_66 ) ;
F_75 ( V_163 , V_3 , V_176 ) ;
break;
case V_177 :
F_21 ( L_67 ) ;
F_75 ( V_163 , V_3 , V_177 ) ;
break;
case V_178 :
F_21 ( L_68 ) ;
...
int F_60 ( struct V_162 * V_163 , struct V_1 * V_3 )
{
struct V_69 * V_70 ;
struct V_130 * V_131 ;
if ( V_3 == NULL || ! V_3 -> V_9 ) {
...
V_70 = F_76 ( sizeof( struct V_162 ) , V_182 ) ;
if ( V_70 == NULL )
return - V_148 ;
F_77 ( V_70 , sizeof( struct V_162 ) ) ;
F_31 ( V_70 , V_163 , sizeof( * V_163 ) ) ;
F_78 ( V_3 -> V_9 , V_70 -> V_93 ) ;
V_131 = F_33 ( V_3 -> V_9 ) ;
F_42 ( & V_131 -> V_132 , V_70 ) ;
V_131 -> V_133 ( V_131 , V_70 -> V_105 ) ;
return 0 ;
}
static int F_79 ( struct V_183 * V_147 ,
...
static void F_84 ( struct V_162 * V_197 ,
struct V_1 * V_203 ,
T_6 * V_16 )
{
T_1 V_13 = V_197 -> V_179 . V_198 . V_119 ;
...
static void F_67 ( struct V_162 * V_197 , struct V_1 * V_3 )
{
T_1 V_13 = V_197 -> V_179 . V_198 . V_119 ;
...
static void F_45 ( struct V_7 * V_8 , T_9 * V_16 )
{
struct V_130 * V_131 ;
struct V_162 * V_218 ;
struct V_69 * V_70 ;
...
static void F_72 ( struct V_162 * V_197 ,
struct V_1 * V_3 )
{
T_10 V_221 ;
...
static void F_73 ( struct V_162 * V_163 ,
struct V_1 * V_3 )
{
struct V_143 * V_144 ;
int V_101 , V_223 ;
...
static void F_74 ( struct V_162 * V_197 ,
struct V_1 * V_203 )
{
if ( V_203 -> V_61 )
F_9 ( V_203 -> V_66 ) ;
V_203 -> V_61 = 0 ;
V_203 -> V_66 = F_92 ( V_197 -> V_165 , V_64 , V_17 ) ;
if ( V_203 -> V_66 == NULL ) {
F_7 ( L_91 ) ;
return;
}
...
static void F_75 ( struct V_162 * V_197 , struct V_1 * V_3 , int V_229 )
{
T_9 * V_16 ;
V_197 -> type = V_230 ;
F_90 ( & V_3 -> V_34 ) ;
...
static int F_94 ( struct V_243 * V_130 , unsigned int V_244 ,
unsigned long V_108 )
{
int V_145 = 0 ;
struct V_7 * V_8 = F_95 ( V_130 ) ;
...
switch ( V_244 ) {
case V_245 :
V_145 = F_50 ( V_8 , ( int ) V_108 ) ;
if ( V_145 >= 0 )
V_130 -> V_250 = V_251 ;
break;
case V_246 :
V_145 = F_39 ( V_8 , ( void T_8 * ) V_108 ) ;
break;
default:
break;
}
