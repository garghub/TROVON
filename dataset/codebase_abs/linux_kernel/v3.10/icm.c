...
int F_33 ( struct V_1 * V_2 , struct V_43 * V_44 , T_3 V_45 )
{
T_3 V_5 = ( V_45 & ( V_44 -> V_46 - 1 ) ) /
( V_47 / V_44 -> V_48 ) ;
int V_26 = 0 ;
F_34 ( & V_44 -> V_49 ) ;
if ( V_44 -> V_13 [ V_5 ] ) {
...
void F_36 ( struct V_1 * V_2 , struct V_43 * V_44 , T_3 V_45 )
{
T_3 V_5 ;
T_2 V_24 ;
...
void * F_37 ( struct V_43 * V_44 , T_3 V_45 ,
T_4 * V_56 )
{
int V_24 , V_57 , V_5 ;
T_2 V_58 ;
...
return NULL ;
F_34 ( & V_44 -> V_49 ) ;
V_58 = ( T_2 ) ( V_45 & ( V_44 -> V_46 - 1 ) ) * V_44 -> V_48 ;
V_13 = V_44 -> V_13 [ V_58 / V_47 ] ;
V_57 = V_24 = V_58 % V_47 ;
if ( ! V_13 )
goto V_50;
...
T_2 V_35 , int V_48 , T_3 V_63 , int V_64 ,
int V_65 , int V_66 )
{
int V_67 ;
int V_68 ;
