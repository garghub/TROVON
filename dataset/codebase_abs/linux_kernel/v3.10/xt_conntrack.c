...
return false ;
if ( V_13 -> V_31 & V_73 )
if ( F_3 ( V_11 , V_13 , V_57 -> V_14 ) ^
! ( V_13 -> V_34 & V_73 ) )
return false ;
if ( V_13 -> V_31 & V_74 )
if ( F_4 ( V_11 , V_13 , V_57 -> V_14 ) ^
! ( V_13 -> V_34 & V_74 ) )
return false ;
if ( V_13 -> V_31 & V_75 )
if ( F_5 ( V_11 , V_13 , V_57 -> V_14 ) ^
! ( V_13 -> V_34 & V_75 ) )
return false ;
if ( V_13 -> V_31 & V_76 )
if ( F_6 ( V_11 , V_13 , V_57 -> V_14 ) ^
! ( V_13 -> V_34 & V_76 ) )
return false ;
if ( V_57 -> V_77 -> V_78 != 3 ) {
if ( ! F_7 ( V_13 , V_11 ) )
...
{
const struct V_87 * V_13 = V_57 -> V_60 ;
...
static int F_22 ( const struct V_88 * V_57 )
{
int V_89 ;
V_89 = F_23 ( V_57 -> V_14 ) ;
if ( V_89 < 0 )
