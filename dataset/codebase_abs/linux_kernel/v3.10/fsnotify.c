...
if ( ( V_16 & V_40 ) ||
( V_57 & V_26 -> V_20 ) )
V_51 = F_24 ( V_26 -> V_60 . V_61 ,
& V_59 ) ;
if ( V_3 && ( ( V_16 & V_40 ) ||
( V_57 & V_3 -> V_58 ) ) ) {
V_52 = F_24 ( V_3 -> V_62 . V_61 ,
& V_59 ) ;
V_51 = F_24 ( V_26 -> V_60 . V_61 ,
& V_59 ) ;
}
...
V_53 = V_54 = NULL ;
if ( V_51 ) {
V_28 = F_25 ( F_24 ( V_51 , & V_59 ) ,
struct V_27 , V_63 . V_64 ) ;
V_53 = V_28 -> V_37 ;
}
if ( V_52 ) {
V_29 = F_25 ( F_24 ( V_52 , & V_59 ) ,
struct V_27 , V_65 . V_66 ) ;
V_54 = V_29 -> V_37 ;
}
if ( V_53 > V_54 ) {
V_19 = F_18 ( V_26 , V_28 , NULL , V_16 , V_30 ,
V_31 , V_32 , V_33 , & V_35 ) ;
V_54 = NULL ;
} else if ( V_54 > V_53 ) {
V_19 = F_18 ( V_26 , NULL , V_29 , V_16 , V_30 ,
V_31 , V_32 , V_33 , & V_35 ) ;
V_53 = NULL ;
} else {
V_19 = F_18 ( V_26 , V_28 , V_29 ,
