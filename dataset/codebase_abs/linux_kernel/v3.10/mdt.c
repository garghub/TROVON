...
{
struct V_1 * V_1 = V_50 -> V_57 -> V_58 ;
struct V_14 * V_15 ;
int V_19 = 0 ;
if ( V_1 && ( V_1 -> V_16 -> V_59 & V_60 ) ) {
F_52 ( V_50 , false ) ;
F_21 ( V_50 ) ;
return - V_61 ;
}
...
int F_56 ( struct V_1 * V_1 , T_3 V_66 , T_4 V_67 )
{
struct V_68 * V_69 ;
V_69 = F_57 ( F_58 ( sizeof( * V_69 ) , V_67 ) , V_70 ) ;
if ( ! V_69 )
return - V_20 ;
F_59 ( & V_69 -> V_71 ) ;
V_1 -> V_72 = V_69 ;
V_1 -> V_73 = V_74 ;
F_60 ( V_1 -> V_21 , V_66 ) ;
V_1 -> V_21 -> V_75 = V_1 -> V_16 -> V_76 ;
V_1 -> V_77 = & V_78 ;
V_1 -> V_79 = & V_80 ;
V_1 -> V_21 -> V_81 = & V_82 ;
return 0 ;
}
void F_61 ( struct V_1 * V_1 , unsigned V_83 ,
unsigned V_84 )
{
struct V_68 * V_69 = F_62 ( V_1 ) ;
V_69 -> V_85 = V_83 ;
V_69 -> V_86 = ( 1 << V_1 -> V_12 ) / V_83 ;
V_69 -> V_87 = F_63 ( V_84 , V_83 ) ;
}
int F_64 ( struct V_1 * V_1 ,
struct V_88 * V_89 )
{
struct V_68 * V_69 = F_62 ( V_1 ) ;
struct V_75 * V_90 = V_1 -> V_16 -> V_76 ;
F_65 ( & V_89 -> V_91 ) ;
F_66 ( & V_89 -> V_92 ) ;
F_67 ( & V_89 -> V_92 , V_1 , V_90 ) ;
F_66 ( & V_89 -> V_93 ) ;
F_67 ( & V_89 -> V_93 , V_1 , V_90 ) ;
V_69 -> V_94 = V_89 ;
return 0 ;
}
...
struct V_68 * V_69 = F_62 ( V_1 ) ;
struct V_5 * V_6 = F_3 ( V_1 ) ;
struct V_88 * V_89 = V_69 -> V_94 ;
int V_8 ;
V_8 = F_69 ( & V_89 -> V_92 , V_1 -> V_21 ) ;
if ( V_8 )
goto V_31;
V_8 = F_69 ( & V_89 -> V_93 ,
& V_6 -> V_95 ) ;
if ( V_8 )
goto V_31;
F_70 ( V_6 -> V_10 , & V_89 -> V_96 ) ;
V_31:
return V_8 ;
}
int F_71 ( struct V_1 * V_1 , struct V_3 * V_4 )
{
struct V_88 * V_89 = F_62 ( V_1 ) -> V_94 ;
struct V_3 * V_97 ;
struct V_50 * V_50 ;
int V_98 = V_1 -> V_12 ;
V_50 = F_72 ( & V_89 -> V_92 , V_4 -> V_11 -> V_48 ) ;
if ( ! V_50 )
return - V_20 ;
if ( ! F_41 ( V_50 ) )
F_73 ( V_50 , 1 << V_98 , 0 ) ;
V_97 = F_42 ( V_50 , F_8 ( V_4 ) >> V_98 ) ;
if ( ! F_17 ( V_97 ) )
F_74 ( V_97 , V_4 ) ;
if ( F_75 ( & V_97 -> V_99 ) ) {
F_76 ( & V_97 -> V_99 ,
...
struct V_3 *
F_78 ( struct V_1 * V_1 , struct V_3 * V_4 )
{
struct V_88 * V_89 = F_62 ( V_1 ) -> V_94 ;
struct V_3 * V_97 = NULL ;
struct V_50 * V_50 ;
int V_100 ;
V_50 = F_39 ( & V_89 -> V_92 , V_4 -> V_11 -> V_48 ) ;
if ( V_50 ) {
if ( F_41 ( V_50 ) ) {
V_100 = F_8 ( V_4 ) >> V_1 -> V_12 ;
V_97 = F_42 ( V_50 , V_100 ) ;
}
F_21 ( V_50 ) ;
F_22 ( V_50 ) ;
}
...
{
struct V_101 * V_102 = & V_89 -> V_91 ;
struct V_3 * V_4 ;
while ( ! F_75 ( V_102 ) ) {
V_4 = F_80 ( V_102 , struct V_3 ,
V_99 ) ;
F_81 ( & V_4 -> V_99 ) ;
F_23 ( V_4 ) ;
}
...
F_84 ( V_1 ) ;
F_85 ( V_1 -> V_21 , true ) ;
F_86 ( V_1 -> V_21 , & V_89 -> V_92 ) ;
F_85 ( & V_6 -> V_95 , true ) ;
F_86 ( & V_6 -> V_95 , & V_89 -> V_93 ) ;
F_87 ( V_6 -> V_10 , & V_89 -> V_96 ) ;
F_88 ( & V_69 -> V_71 ) ;
}
