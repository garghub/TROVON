...
memcpy ( V_18 + V_70 , V_73 -> V_78 , V_79 ) ;
* ( V_80 * ) ( V_18 + V_70 + V_79 ) =
F_54 ( 1 ) ;
F_55 ( V_77 , V_8 ) ;
F_56 ( V_77 , V_73 -> V_81 . V_82 ,
V_73 -> V_81 . V_83 , V_73 -> V_81 . V_84 ) ;
F_57 ( V_77 , V_73 -> V_21 , V_73 -> V_24 , V_73 -> V_25 ,
V_18 ) ;
return F_58 ( V_77 ) ;
}
static int F_59 ( struct V_1 * V_14 )
{
struct V_31 * V_32 = ( void * ) V_14 -> V_33 ;
struct V_85 * V_35 = F_27 ( V_32 ) ;
struct V_69 * V_6 = F_2 ( V_14 ) ;
struct V_68 * V_36 ;
unsigned long V_74 ;
V_36 = F_60 ( V_35 ) ;
if ( F_29 ( V_36 ) )
...
static struct V_31 * F_66 ( struct V_37 * * V_38 )
{
struct V_88 * V_89 ;
struct V_31 * V_32 ;
struct V_39 * V_40 ;
...
if ( F_29 ( V_89 ) )
return F_37 ( V_89 ) ;
if ( ( V_89 -> type ^ V_41 ) & V_89 -> V_91 )
return F_35 ( - V_44 ) ;
V_90 = F_68 ( V_38 [ 1 ] ) ;
if ( F_29 ( V_90 ) )
return F_37 ( V_90 ) ;
V_32 = F_69 ( sizeof( * V_32 ) + sizeof( * V_35 ) , V_92 ) ;
if ( ! V_32 )
return F_35 ( - V_93 ) ;
V_35 = F_27 ( V_32 ) ;
F_70 ( V_35 , V_32 ) ;
V_9 = F_71 ( V_35 , V_90 , 0 ,
F_72 ( V_89 -> type ,
V_89 -> V_91 ) ) ;
if ( V_9 )
goto V_94;
V_40 = F_73 ( V_35 ) ;
V_9 = - V_44 ;
if ( V_40 -> V_95 . V_55 != V_96 )
goto V_97;
if ( V_40 -> V_45 != 1 )
goto V_97;
V_9 = - V_98 ;
if ( snprintf ( V_32 -> V_40 . V_99 , V_100 , L_3 ,
V_40 -> V_99 ) >= V_100 )
goto V_97;
if ( snprintf ( V_32 -> V_40 . V_101 , V_100 ,
L_3 , V_40 -> V_101 ) >=
V_100 )
goto V_97;
V_32 -> V_40 . V_49 = V_40 -> V_49 ;
...
V_32 -> V_40 . V_48 = V_102 |
( V_40 -> V_48 & V_103 ) ;
V_32 -> V_40 . V_52 = & V_104 ;
V_32 -> V_40 . V_95 . V_55 = V_79 ;
V_32 -> V_40 . V_95 . V_56 =
V_40 -> V_95 . V_56 + V_70 ;
V_32 -> V_40 . V_95 . V_59 =
V_40 -> V_95 . V_59 + V_70 ;
V_32 -> V_40 . V_95 . V_67 = L_4 ;
V_32 -> V_40 . V_95 . V_64 = F_44 ;
V_32 -> V_40 . V_95 . V_65 = F_50 ;
V_32 -> V_40 . V_95 . V_66 = F_50 ;
V_32 -> V_40 . V_61 = sizeof( struct V_69 ) ;
V_32 -> V_40 . V_62 = F_59 ;
V_32 -> V_40 . V_63 = F_64 ;
return V_32 ;
V_97:
