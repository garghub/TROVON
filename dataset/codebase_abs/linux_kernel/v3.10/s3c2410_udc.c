...
F_75 ( V_60 ) ;
F_83 ( V_60 ) ;
V_198 = F_100 ( V_169 , F_46 ,
0 , V_241 , V_60 ) ;
if ( V_198 != 0 ) {
F_91 ( V_62 , L_79 , V_169 , V_198 ) ;
V_198 = - V_242 ;
goto V_245;
}
F_88 ( V_62 , L_80 , V_169 ) ;
if ( V_206 && V_206 -> V_213 > 0 ) {
V_198 = F_101 ( V_206 -> V_213 , L_81 ) ;
if ( V_198 < 0 ) {
F_91 ( V_62 , L_82 ) ;
goto V_246;
}
V_212 = F_102 ( V_206 -> V_213 ) ;
if ( V_212 < 0 ) {
F_91 ( V_62 , L_83 ) ;
V_198 = V_212 ;
goto V_247;
}
V_198 = F_100 ( V_212 , F_78 ,
V_248
| V_249 | V_250 ,
V_241 , V_60 ) ;
if ( V_198 != 0 ) {
...
F_88 ( V_62 , L_80 , V_212 ) ;
} else {
V_60 -> V_211 = 1 ;
}
if ( V_206 && ! V_206 -> V_207 &&
F_73 ( V_206 -> V_208 ) ) {
V_198 = F_103 ( V_206 -> V_208 ,
V_206 -> V_214 ?
V_251 : V_252 ,
L_85 ) ;
if ( V_198 )
...
V_198 = F_104 ( & V_229 -> V_62 , & V_60 -> V_141 ) ;
if ( V_198 )
goto V_254;
if ( V_255 ) {
V_60 -> V_256 = F_105 ( L_86 , V_257 ,
V_255 ,
V_60 , & V_258 ) ;
if ( ! V_60 -> V_256 )
F_106 ( V_62 , L_87 ) ;
...
F_88 ( & V_229 -> V_62 , L_89 , V_75 ) ;
return 0 ;
}
static int
F_117 ( struct V_228 * V_229 , T_8 V_259 )
{
F_81 ( V_221 ) ;
return 0 ;
}
...
{
int V_198 ;
F_6 ( V_89 , L_90 , V_241 , V_260 ) ;
V_255 = F_120 ( V_241 , NULL ) ;
if ( F_90 ( V_255 ) ) {
F_121 ( L_91 ,
V_241 , F_92 ( V_255 ) ) ;
V_255 = NULL ;
