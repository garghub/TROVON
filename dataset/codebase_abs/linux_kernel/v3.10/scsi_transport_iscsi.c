...
return V_588 | V_589 ;
else if ( V_6 == & V_590 . V_6 )
return V_588 ;
else if ( V_6 == & V_591 . V_6 )
return V_588 ;
else if ( V_6 == & V_592 . V_6 )
return V_588 ;
else {
F_26 ( 1 , L_87 ) ;
return 0 ;
...
return V_4 -> V_8 -> V_69 ( V_605 , V_35 ) ;
}
...
char * V_606 = L_79 ;
struct V_249 * V_250 = V_72 -> V_261 ;
T_5 V_607 = V_250 -> V_607 ;
for ( V_32 = 0 ; V_32 < F_77 ( V_608 ) ; V_32 ++ ) {
if ( V_608 [ V_32 ] . V_275 & V_607 ) {
V_606 = V_608 [ V_32 ] . V_223 ;
break;
}
}
return V_606 ;
...
char * V_273 = L_79 ;
struct V_249 * V_250 = V_72 -> V_261 ;
T_5 V_609 = V_250 -> V_609 ;
for ( V_32 = 0 ; V_32 < F_77 ( V_610 ) ; V_32 ++ ) {
if ( V_610 [ V_32 ] . V_275 & V_609 ) {
V_273 = V_610 [ V_32 ] . V_223 ;
break;
}
}
return V_273 ;
}
static int F_210 ( struct V_611 * V_612 ,
struct V_1 * V_2 )
{
struct V_266 * V_276 ;
struct V_71 * V_72 ;
...
return 0 ;
V_4 = F_55 ( V_72 -> V_231 ) ;
if ( V_4 -> V_613 . V_614 . V_20 != & V_615 . V_20 )
return 0 ;
return & V_4 -> V_613 . V_614 == V_612 ;
}
static int F_211 ( struct V_611 * V_612 ,
struct V_1 * V_2 )
{
struct V_266 * V_276 ;
struct V_264 * V_265 ;
...
return 0 ;
V_4 = F_55 ( V_72 -> V_231 ) ;
if ( V_4 -> V_616 . V_614 . V_20 != & V_617 . V_20 )
return 0 ;
return & V_4 -> V_616 . V_614 == V_612 ;
}
static int F_212 ( struct V_611 * V_612 ,
struct V_1 * V_2 )
{
struct V_71 * V_72 ;
struct V_3 * V_4 ;
...
V_72 = F_64 ( V_2 ) ;
if ( ! V_72 -> V_231 ||
V_72 -> V_231 -> V_618 . V_614 . V_20 != & V_619 . V_20 )
return 0 ;
V_4 = F_55 ( V_72 -> V_231 ) ;
return & V_4 -> V_33 . V_618 . V_614 == V_612 ;
}
struct V_620 *
...
if ( V_15 )
goto V_625;
V_15 = F_16 ( & V_4 -> V_2 . V_22 , & V_626 ) ;
if ( V_15 )
goto V_24;
V_4 -> V_33 . V_618 . V_614 . V_20 = & V_619 . V_20 ;
V_4 -> V_33 . V_618 . V_614 . V_627 = F_212 ;
V_4 -> V_33 . V_618 . V_614 . V_628 = & V_629 ;
V_4 -> V_33 . V_630 = sizeof( struct V_249 ) ;
F_215 ( & V_4 -> V_33 . V_618 ) ;
V_4 -> V_616 . V_614 . V_20 = & V_617 . V_20 ;
V_4 -> V_616 . V_614 . V_627 = F_211 ;
V_4 -> V_616 . V_614 . V_628 = & V_631 ;
F_215 ( & V_4 -> V_616 ) ;
V_4 -> V_613 . V_614 . V_20 = & V_615 . V_20 ;
V_4 -> V_613 . V_614 . V_627 = F_210 ;
V_4 -> V_613 . V_614 . V_628 = & V_632 ;
F_215 ( & V_4 -> V_613 ) ;
F_72 ( & V_324 , V_269 ) ;
F_130 ( & V_4 -> V_621 , & V_633 ) ;
F_74 ( & V_324 , V_269 ) ;
F_12 ( V_634 L_90 , V_323 -> V_223 ) ;
return & V_4 -> V_33 ;
V_24:
F_17 ( & V_4 -> V_2 ) ;
return NULL ;
...
F_217 ( & V_4 -> V_616 ) ;
F_217 ( & V_4 -> V_613 ) ;
F_217 ( & V_4 -> V_33 . V_618 ) ;
F_19 ( & V_4 -> V_2 . V_22 , & V_626 ) ;
F_17 ( & V_4 -> V_2 ) ;
F_92 ( & V_508 ) ;
return 0 ;
}
