...
{
struct V_154 * V_155 = V_35 -> V_40 ;
int V_6 ;
if ( V_155 == NULL || V_155 -> V_41 == NULL ) {
F_38 ( L_18 ) ;
return - V_156 ;
}
V_6 = F_5 () ;
...
static struct V_34 * F_66 ( struct V_159 * V_7 )
{
struct V_160 * V_161 = V_7 -> V_8 . V_162 ;
const char * V_163 = F_67 () ;
struct V_34 * V_164 ;
int V_29 ;
V_164 = NULL ;
for ( V_29 = 0 ; V_29 < V_161 -> V_165 ; ++ V_29 ) {
struct V_34 * V_35 = V_161 -> V_166 [ V_29 ] ;
if ( V_35 -> type != V_167 )
continue;
if ( V_164 == NULL )
V_164 = V_35 ;
if ( V_163 != NULL &&
strcmp ( V_35 -> V_168 , V_163 ) == 0 ) {
V_164 = V_35 ;
break;
}
}
...
static int F_68 ( struct V_159 * V_169 )
{
struct V_34 * V_170 ;
struct V_34 * V_35 ;
int V_6 ;
...
V_6 = F_65 ( V_35 ) ;
if ( V_6 ) {
F_38 ( L_21 , V_35 -> V_168 , V_6 ) ;
F_71 ( V_35 ) ;
return V_6 ;
}
V_6 = F_72 ( & V_4 . V_40 , V_35 ) ;
if ( V_6 ) {
F_38 ( L_22 ,
V_35 -> V_168 ) ;
F_71 ( V_35 ) ;
...
static void F_75 ( struct V_159 * V_7 )
{
struct V_154 * V_155 = & V_4 . V_40 ;
V_155 -> V_7 = V_7 ;
V_155 -> V_172 = V_173 ;
V_155 -> type = V_167 ;
V_155 -> V_168 = L_24 ;
...
static void T_5 F_77 ( struct V_159 * V_7 )
{
struct V_154 * V_155 = & V_4 . V_40 ;
F_78 ( V_155 ) ;
}
static int F_79 ( struct V_159 * V_7 )
{
T_1 V_176 ;
struct V_177 * V_178 ;
struct V_179 * V_179 ;
...
V_4 . V_7 = V_7 ;
F_80 ( & V_4 . V_10 , 1 ) ;
V_178 = F_81 ( V_4 . V_7 , V_180 , 0 ) ;
if ( ! V_178 ) {
F_38 ( L_25 ) ;
return - V_98 ;
}
V_4 . V_5 = F_82 ( & V_7 -> V_8 , V_178 -> V_181 ,
F_83 ( V_178 ) ) ;
if ( ! V_4 . V_5 ) {
F_38 ( L_26 ) ;
return - V_171 ;
}
V_179 = F_84 ( & V_7 -> V_8 , L_27 ) ;
if ( F_85 ( V_179 ) ) {
F_38 ( L_28 ) ;
return F_86 ( V_179 ) ;
}
V_4 . V_52 = F_87 ( V_179 ) / 1000 ;
F_88 ( V_179 ) ;
F_89 ( & V_7 -> V_8 ) ;
V_6 = F_5 () ;
if ( V_6 )
...
static int T_5 F_95 ( struct V_159 * V_7 )
{
F_96 ( & V_7 -> V_8 ) ;
F_77 ( V_7 ) ;
F_94 ( & V_7 -> V_8 ) ;
...
static int F_99 ( struct V_183 * V_8 )
{
int V_6 ;
V_6 = F_100 () ;
if ( V_6 < 0 )
