...
T_6 V_270 ;
if ( V_99 -> V_201 == V_255 )
F_39 ( V_283 , V_2 , L_1 , L_86 ) ;
else
F_138 ( & V_2 -> V_56 -> V_57 , L_87 ) ;
V_270 = V_2 -> V_42 -> V_284 ( V_99 ) ;
V_270 ( V_99 ) ;
}
...
return;
if ( V_287 -> V_26 < V_70 ) {
while ( ( V_101 = F_205 ( V_34 -> V_285 ) ) )
F_206 ( V_101 , - V_207 ) ;
return;
}
while ( ( V_101 = F_207 ( V_286 ) ) ) {
if ( V_287 -> V_81 & V_288 &&
F_86 ( V_101 ) == V_289 ) {
F_39 ( V_185 , V_287 ,
L_88 ,
...
V_99 = V_287 -> V_42 -> V_290 ( V_287 , V_34 , V_101 ) ;
if ( F_30 ( V_99 ) ) {
if ( F_104 ( V_99 ) == - V_208 )
break;
if ( F_104 ( V_99 ) == - V_4 )
...
V_201 = V_99 -> V_34 -> V_63 -> V_42 -> V_291 ( V_99 , V_101 ) ;
if ( V_201 <= 0 )
error = V_201 ? V_201 : - V_207 ;
F_206 ( V_101 , error ) ;
}
...
static int F_215 ( struct V_98 * V_99 )
{
...
static void F_217 ( struct V_285 * V_286 )
{
struct V_33 * V_34 ;
V_34 = V_286 -> V_296 ;
F_87 ( & V_34 -> V_38 ) ;
...
{
int V_40 ;
V_34 -> V_285 = F_218 ( F_217 ,
& V_34 -> V_36 ) ;
if ( V_34 -> V_285 == NULL )
return - V_4 ;
V_34 -> V_285 -> V_296 = V_34 ;
F_219 ( V_34 -> V_285 -> V_297 ) ;
V_34 -> V_285 -> V_297 = NULL ;
V_40 = F_220 ( V_34 -> V_285 , L_91 ) ;
if ( V_40 ) {
F_221 ( V_34 -> V_285 ) ;
return V_40 ;
}
...
V_298 = V_34 -> V_63 -> V_42 -> V_299 << V_34 -> V_69 ;
}
F_222 ( V_34 -> V_285 ,
V_34 -> V_73 ) ;
F_223 ( V_34 -> V_285 , V_298 ) ;
F_224 ( V_34 -> V_285 , - 1L ) ;
F_225 ( V_34 -> V_285 , V_9 ) ;
F_226 ( V_34 -> V_285 , V_9 - 1 ) ;
}
...
static int F_227 ( struct V_300 * V_85 , T_7 V_177 )
{
struct V_1 * V_63 ;
int V_40 ;
V_63 = F_228 ( V_85 -> V_86 ) ;
if ( ! V_63 )
return - V_206 ;
F_229 ( & V_63 -> V_34 -> V_35 ) ;
if ( F_141 ( V_249 , & V_63 -> V_192 ) ) {
V_40 = - V_206 ;
goto V_301;
}
if ( ! F_230 ( V_63 -> V_42 -> V_44 ) ) {
V_40 = - V_167 ;
goto V_301;
}
if ( V_96 ) {
F_231 ( & V_63 -> V_56 -> V_57 ,
L_92
L_93 ) ;
V_40 = - V_89 ;
goto V_67;
...
if ( V_63 -> V_26 <= V_62 ) {
F_39 ( V_185 , V_63 , L_94 ,
L_95 ) ;
V_40 = - V_206 ;
goto V_67;
}
if ( ( V_177 & V_302 ) &&
( F_141 ( V_303 , & V_63 -> V_192 ) ||
( V_63 -> V_81 & V_288 ) ) ) {
V_40 = - V_304 ;
goto V_67;
}
...
F_26 ( V_63 -> V_42 -> V_44 ) ;
V_301:
F_232 ( & V_63 -> V_34 -> V_35 ) ;
F_23 ( V_63 ) ;
return V_40 ;
}
static void F_233 ( struct V_74 * V_75 , T_7 V_177 )
{
struct V_1 * V_63 = F_228 ( V_75 ) ;
if ( V_63 ) {
F_232 ( & V_63 -> V_34 -> V_35 ) ;
F_26 ( V_63 -> V_42 -> V_44 ) ;
F_23 ( V_63 ) ;
...
static int F_234 ( struct V_300 * V_85 , struct V_305 * V_306 )
{
struct V_1 * V_63 ;
V_63 = F_228 ( V_85 -> V_86 ) ;
if ( ! V_63 )
...
V_63 -> V_42 -> V_307 ( V_63 -> V_34 , V_306 ) ;
V_306 -> V_308 = F_235 ( V_85 ) >> V_63 -> V_34 -> V_69 ;
F_23 ( V_63 ) ;
return 0 ;
}
static void
...
if ( ! V_315 )
return 0 ;
F_244 ( V_2 -> V_56 , & V_312 ) ;
memset ( & V_314 , 0 , sizeof( V_314 ) ) ;
V_314 . V_316 = V_312 . V_317 ;
V_314 . V_318 = sizeof( V_314 ) ;
V_40 = V_313 ( & V_314 ) ;
if ( V_40 == 0 || V_40 == 2 ) {
return V_314 . V_319 & 0x80 ;
} else {
F_119 ( V_60 , L_96 ,
V_312 . V_317 , V_40 ) ;
return 0 ;
...
static void F_245 ( void * V_19 , T_8 V_320 )
{
...
if ( V_321 )
F_247 ( L_97 ,
F_35 ( & V_56 -> V_57 ) , V_321 ) ;
}
int F_248 ( struct V_226 * V_56 ,
struct V_322 * V_42 )
{
int V_321 ;
V_321 = F_249 ( V_56 ) ;
...
V_56 -> V_323 = & F_156 ;
if ( ( F_250 ( V_56 , V_324 ) > 0 ) ||
( V_325 && F_251 ( F_35 ( & V_56 -> V_57 ) ) != 0 ) )
F_252 ( F_245 , V_56 ) ;
return 0 ;
}
void F_253 ( struct V_226 * V_56 )
{
struct V_1 * V_2 ;
struct V_33 * V_34 ;
V_56 -> V_323 = NULL ;
...
return F_104 ( V_2 ) ;
if ( V_2 -> V_34 ) {
V_328 = V_2 -> V_34 -> V_85 ? 0 : - 1 ;
V_35 = F_263 ( & V_2 -> V_34 -> V_35 ) ;
if ( V_35 > V_328 ) {
if ( V_35 > 0 )
F_247 ( L_107
L_108 ,
...
F_264 ( V_329 , & V_2 -> V_192 ) ;
} else
if ( F_141 ( V_249 , & V_2 -> V_192 ) ) {
F_23 ( V_2 ) ;
return - V_208 ;
}
if ( F_265 ( V_329 , & V_2 -> V_192 ) &&
! F_256 ( V_258 , & V_2 -> V_192 ) ) {
V_40 = F_266 ( V_2 -> V_34 -> V_85 ) ;
if ( V_40 != 0 )
goto V_330;
F_75 ( V_2 ) ;
V_40 = F_193 ( V_266 ,
...
{
struct V_98 * V_99 ;
F_267 ( & V_2 -> V_56 -> V_57 , L_110
L_111 ) ;
F_39 ( V_60 , V_2 , L_1 , L_112 ) ;
F_211 ( V_2 , NULL , V_331 ) ;
if ( V_2 -> V_26 < V_62 )
return 0 ;
...
int F_269 ( struct V_226 * V_56 , int V_332 )
{
struct V_1 * V_2 ;
int V_321 ;
V_2 = F_153 ( V_56 ) ;
...
void F_270 ( struct V_226 * V_56 , int * V_337 )
{
int V_338 ;
T_9 V_339 , V_340 ;
struct V_1 * V_2 ;
...
if ( F_30 ( V_2 ) )
return;
for ( V_338 = 0 ; V_338 < 8 ; V_338 ++ ) {
V_340 = 0x80 >> V_338 ;
if ( V_337 [ V_338 ] & V_341 ) {
V_339 = V_2 -> V_216 . V_217 ;
V_2 -> V_216 . V_217 &= ~ V_340 ;
V_2 -> V_216 . V_220 &= ~ V_340 ;
V_2 -> V_216 . V_221 &= ~ V_340 ;
if ( V_339 && ! V_2 -> V_216 . V_217 ) {
F_267 ( & V_2 -> V_56 -> V_57 ,
L_116
L_111 ) ;
F_39 ( V_60 , V_2 ,
...
if ( V_337 [ V_338 ] & V_342 ) {
V_2 -> V_216 . V_217 &= ~ V_340 ;
V_2 -> V_216 . V_220 &= ~ V_340 ;
V_2 -> V_216 . V_221 &= ~ V_340 ;
V_2 -> V_216 . V_222 |= V_340 ;
F_75 ( V_2 ) ;
}
if ( V_337 [ V_338 ] & V_343 ) {
if ( ! ( V_2 -> V_216 . V_217 & V_340 ) &&
! ( V_2 -> V_216 . V_222 & V_340 ) ) {
V_2 -> V_216 . V_222 |= V_340 ;
F_75 ( V_2 ) ;
}
...
int F_271 ( struct V_1 * V_2 , T_9 V_215 )
{
...
int F_272 ( struct V_226 * V_56 )
{
struct V_1 * V_2 = F_254 ( V_56 ) ;
struct V_102 V_344 ;
struct V_98 * V_99 , * V_252 ;
struct V_98 * V_275 ;
int V_40 ;
if ( F_30 ( V_2 ) )
return F_104 ( V_2 ) ;
F_124 ( V_345 , & V_2 -> V_192 ) ;
if ( V_2 -> V_42 -> V_346 )
V_40 = V_2 -> V_42 -> V_346 ( V_2 ) ;
F_179 ( V_2 , V_347 ) ;
F_12 ( & V_344 ) ;
F_173 ( F_146 ( V_56 ) ) ;
V_40 = 0 ;
...
V_275 = V_99 -> V_275 ;
F_273 ( & V_99 -> V_278 ) ;
F_274 ( V_99 , V_99 -> V_348 ) ;
V_99 = V_275 ;
}
if ( V_99 -> V_34 )
F_168 ( & V_99 -> V_278 ) ;
V_99 -> V_34 -> V_63 -> V_42 -> V_291 (
V_99 , (struct V_100 * ) V_99 -> V_254 ) ;
}
if ( ! F_53 ( & V_344 ) ) {
F_173 ( F_146 ( V_56 ) ) ;
F_275 ( & V_344 , & V_2 -> V_15 ) ;
F_175 ( F_146 ( V_56 ) ) ;
}
F_23 ( V_2 ) ;
return V_40 ;
}
int F_276 ( struct V_226 * V_56 )
{
struct V_1 * V_2 = F_254 ( V_56 ) ;
int V_40 = 0 ;
if ( F_30 ( V_2 ) )
...
if ( V_2 -> V_34 )
F_60 ( V_2 -> V_34 ) ;
F_264 ( V_345 , & V_2 -> V_192 ) ;
F_23 ( V_2 ) ;
return 0 ;
}
static struct V_98 * F_277 ( struct V_1 * V_2 ,
void * V_349 ,
int V_350 ,
int V_186 )
{
...
V_194 = V_99 -> V_190 ;
V_194 -> V_352 = V_353 ;
if ( F_278 ( V_349 , V_350 ) ) {
V_351 = ( unsigned long * ) ( V_99 -> V_19 ) ;
V_194 -> V_354 = ( V_355 ) ( V_356 ) V_351 ;
V_194 -> V_192 = V_357 ;
V_351 = F_279 ( V_351 , V_349 , V_350 ) ;
} else {
V_194 -> V_354 = ( V_355 ) ( V_356 ) V_349 ;
V_194 -> V_192 = 0 ;
}
V_194 -> V_358 = V_350 ;
V_99 -> V_109 = V_2 ;
...
int F_280 ( struct V_1 * V_2 , int V_186 ,
void * V_349 , int V_350 )
{
int V_321 ;
struct V_98 * V_99 ;
V_99 = F_277 ( V_2 , V_349 , V_350 ,
V_186 ) ;
if ( F_30 ( V_99 ) )
return F_104 ( V_99 ) ;
V_321 = F_198 ( V_99 ) ;
F_132 ( V_99 , V_99 -> V_348 ) ;
return V_321 ;
}
char * F_281 ( struct V_229 * V_229 )
{
struct V_359 * V_359 = NULL ;
char * V_360 = NULL ;
if ( F_282 ( & V_229 -> V_233 ) && ( V_229 -> V_233 . V_361 . V_362 == 0x01 ) ) {
if ( V_229 -> V_233 . V_361 . V_363 )
V_359 = F_283 ( (struct V_363 * ) ( unsigned long )
V_229 -> V_233 . V_361 . V_363 ) ;
if ( V_359 && V_359 -> V_364 == 64 && V_359 -> V_192 )
switch ( V_359 -> V_192 & 0x07 ) {
case 1 :
V_360 = V_359 -> V_365 . V_366 . V_360 ;
break;
case 2 :
V_360 = V_359 -> V_365 . V_367 . V_360 ;
break;
default:
break;
}
} else if ( V_229 -> V_368 . V_369 . V_370 . V_371 ) {
V_360 = V_229 -> V_372 ;
}
return V_360 ;
}
void F_284 ( struct V_226 * V_56 )
{
struct V_1 * V_2 ;
V_2 = F_254 ( V_56 ) ;
if ( F_30 ( V_2 ) )
...
F_286 ( & V_268 ) ;
F_286 ( & V_266 ) ;
V_310 = F_36 ( L_33 , 1 , 1 , 8 * sizeof( long ) ) ;
if ( V_310 == NULL ) {
V_40 = - V_4 ;
goto V_373;
}
