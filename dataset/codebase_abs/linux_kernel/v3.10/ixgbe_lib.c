...
for (; V_83 < V_117 ; V_83 ++ ) {
int V_121 = F_41 ( V_118 , V_117 - V_83 ) ;
int V_122 = F_41 ( V_119 , V_117 - V_83 ) ;
V_67 = F_27 ( V_2 , V_117 , V_83 ,
V_122 , V_85 ,
V_121 , V_87 ) ;
if ( V_67 )
...
void F_57 ( struct V_76 * V_20 , T_3 V_141 ,
...
V_143 |= V_148 | V_149 ;
V_146 -> V_141 = F_59 ( V_141 ) ;
V_146 -> V_150 = F_59 ( V_142 ) ;
V_146 -> V_151 = F_59 ( V_143 ) ;
V_146 -> V_144 = F_59 ( V_144 ) ;
}
