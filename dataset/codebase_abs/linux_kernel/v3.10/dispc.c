...
static void F_247 ( struct V_412 * V_413 , enum V_5 V_6 )
{
int V_406 , V_407 ;
enum V_414 V_415 ;
F_248 ( V_413 , L_45 , V_11 [ V_6 ] . V_55 ) ;
V_415 = F_243 ( V_6 ) ;
F_248 ( V_413 , L_46 , V_11 [ V_6 ] . V_55 ,
F_249 ( V_415 ) ,
F_250 ( V_415 ) ) ;
...
void F_251 ( struct V_412 * V_413 )
{
int V_406 ;
T_2 V_243 ;
enum V_414 V_416 = F_239 () ;
if ( F_60 () )
return;
F_248 ( V_413 , L_49 ) ;
F_248 ( V_413 , L_50 ,
...
static void F_252 ( struct V_412 * V_413 )
{
int V_16 , V_17 ;
const char * V_418 [] = {
[ V_142 ] = L_53 ,
...
const char * * V_420 ;
#define F_253 ( V_44 ) seq_printf(s, "%-50s %08x\n", #r, dispc_read_reg(r))
if ( F_60 () )
return;
F_253 ( V_421 ) ;
F_253 ( V_422 ) ;
...
#undef F_253
#define F_254 ( V_16 , V_55 ) name(i)
#define F_253 ( V_16 , V_44 ) seq_printf(s, "%s(%s)%*s %08x\n", #r, p_names[i], \
...
#undef F_254
#undef F_253
#define F_254 ( V_58 , V_55 , V_16 ) name(plane, i)
#define F_253 ( V_58 , V_55 , V_16 ) \
seq_printf(s, "%s_%d(%s)%*s %08x\n", #name, i, p_names[plane], \
(int)(46 - strlen(#name) - strlen(p_names[plane])), " ", \
dispc_read_reg(DISPC_REG(plane, name, i)))
for ( V_16 = 1 ; V_16 < F_27 () ; V_16 ++ ) {
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_253 ( V_16 , F_77 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_253 ( V_16 , F_79 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 5 ; V_17 ++ )
F_253 ( V_16 , F_94 , V_17 ) ;
if ( F_12 ( V_35 ) ) {
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_253 ( V_16 , F_81 , V_17 ) ;
}
if ( F_12 ( V_36 ) ) {
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_253 ( V_16 , F_84 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_253 ( V_16 , F_86 , V_17 ) ;
for ( V_17 = 0 ; V_17 < 8 ; V_17 ++ )
F_253 ( V_16 , F_88 , V_17 ) ;
}
}
F_63 () ;
#undef F_254
...
int F_255 ( unsigned long F_237 ,
struct V_438 * V_439 )
{
if ( V_439 -> V_398 > 255 || V_439 -> V_398 == 0 )
return - V_281 ;
if ( V_439 -> V_399 < 1 || V_439 -> V_399 > 255 )
return - V_281 ;
V_439 -> V_440 = F_237 / V_439 -> V_398 ;
V_439 -> V_441 = V_439 -> V_440 / V_439 -> V_399 ;
return 0 ;
}
bool F_256 ( unsigned long V_3 ,
unsigned long V_442 , unsigned long V_443 ,
T_9 V_444 , void * V_445 )
{
int V_446 , V_447 , V_448 ;
int V_449 , V_450 , V_451 ;
unsigned long V_441 , V_440 ;
unsigned long V_452 ;
...
V_452 = F_187 ( V_458 ) ;
V_442 = V_442 ? V_442 : 1 ;
V_443 = V_443 ? V_443 : V_459 ;
V_447 = F_178 ( F_176 ( V_3 , V_452 ) , 1ul ) ;
V_448 = F_186 ( V_3 / V_442 , 255ul ) ;
for ( V_446 = V_447 ; V_446 <= V_448 ; ++ V_446 ) {
V_440 = V_3 / V_446 ;
V_450 = F_178 ( F_176 ( V_440 , V_443 ) , V_453 ) ;
V_451 = F_186 ( V_440 / V_442 , V_454 ) ;
for ( V_449 = V_450 ; V_449 <= V_451 ; ++ V_449 ) {
V_441 = V_440 / V_449 ;
if ( F_12 ( V_38 ) )
V_456 = F_188 () ;
else
V_456 = V_440 ;
if ( V_456 < V_441 * V_455 )
continue;
if ( V_444 ( V_446 , V_449 , V_440 , V_441 , V_445 ) )
return true ;
}
}
return false ;
...
{
F_10 ( L_61 , V_439 -> V_440 , V_439 -> V_398 ) ;
F_10 ( L_62 , V_439 -> V_441 , V_439 -> V_399 ) ;
F_235 ( V_6 , V_439 -> V_398 , V_439 -> V_399 ) ;
}
int F_259 ( enum V_5 V_6 ,
struct V_438 * V_439 )
{
unsigned long V_456 ;
V_456 = F_237 () ;
V_439 -> V_398 = F_6 ( F_236 ( V_6 ) , 23 , 16 ) ;
V_439 -> V_399 = F_6 ( F_236 ( V_6 ) , 7 , 0 ) ;
V_439 -> V_440 = V_456 / V_439 -> V_398 ;
V_439 -> V_441 = V_439 -> V_440 / V_439 -> V_399 ;
return 0 ;
}
T_2 F_260 ( void )
...
void F_262 ( T_2 V_460 )
{
T_2 V_461 = F_3 ( V_425 ) ;
F_59 ( ( V_460 ^ V_461 ) & V_460 ) ;
F_1 ( V_425 , V_460 ) ;
}
void F_263 ( void )
{
...
static int T_10 F_266 ( struct V_401 * V_45 )
{
const struct V_466 * V_467 ;
struct V_466 * V_468 ;
V_468 = F_267 ( & V_45 -> V_46 , sizeof( * V_468 ) , V_469 ) ;
if ( ! V_468 ) {
F_268 ( & V_45 -> V_46 , L_63 ) ;
return - V_470 ;
}
switch ( F_269 () ) {
case V_471 :
...
int F_270 ( T_11 V_486 , void * V_487 )
{
return F_271 ( & V_3 . V_45 -> V_46 , V_3 . V_488 , V_486 ,
V_489 , L_64 , V_487 ) ;
}
void F_272 ( void * V_487 )
{
F_273 ( & V_3 . V_45 -> V_46 , V_3 . V_488 , V_487 ) ;
}
static int T_10 F_274 ( struct V_401 * V_45 )
{
T_2 V_490 ;
int V_44 = 0 ;
struct V_491 * V_492 ;
...
if ( V_44 )
return V_44 ;
V_492 = F_275 ( V_3 . V_45 , V_493 , 0 ) ;
if ( ! V_492 ) {
F_75 ( L_65 ) ;
return - V_281 ;
}
V_3 . V_4 = F_276 ( & V_45 -> V_46 , V_492 -> V_171 ,
F_277 ( V_492 ) ) ;
if ( ! V_3 . V_4 ) {
F_75 ( L_66 ) ;
return - V_470 ;
}
V_3 . V_488 = F_278 ( V_3 . V_45 , 0 ) ;
if ( V_3 . V_488 < 0 ) {
F_75 ( L_67 ) ;
return - V_485 ;
}
...
F_265 () ;
V_490 = F_3 ( V_421 ) ;
F_280 ( & V_45 -> V_46 , L_68 ,
F_125 ( V_490 , 7 , 4 ) , F_125 ( V_490 , 3 , 0 ) ) ;
F_63 () ;
F_281 ( L_69 , F_252 ) ;
return 0 ;
V_494:
...
static int F_284 ( struct V_495 * V_46 )
{
F_9 () ;
return 0 ;
}
static int F_285 ( struct V_495 * V_46 )
{
F_57 () ;
return 0 ;
}
int T_10 F_286 ( void )
{
return F_287 ( & V_496 , F_274 ) ;
}
void T_12 F_288 ( void )
{
F_289 ( & V_496 ) ;
}
