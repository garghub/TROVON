...
V_18 -> V_30 = F_43 ( V_18 ) ? V_20 -> V_56 : 0 ;
...
V_18 -> V_30 = F_49 ( V_65 , V_57 ) ;
V_18 -> V_30 <<= F_50 ( V_65 , V_57 ) + V_20 -> V_70 ;
if ( V_18 -> V_30 > V_67 || V_18 -> V_30 == 0 )
V_18 -> V_30 = V_67 ;
}
...
struct V_15 * V_16 = V_20 -> V_51 ;
F_13 ( L_21 ,
V_18 -> V_29 , F_70 ( V_20 -> V_101 ) , V_105 ) ;
V_16 -> V_92 . V_106 ++ ;
V_20 -> V_104 = F_77 ( F_78 () , V_20 -> V_107 ) ;
if ( V_16 -> V_42 -> V_57 != NULL )
F_71 ( V_18 ) ;
F_8 ( & V_20 -> V_108 ) ;
...
struct V_15 * V_16 = V_20 -> V_51 ;
int V_53 , V_114 ;
F_13 ( L_24 , V_18 -> V_29 , V_20 -> V_115 ) ;
if ( ! V_20 -> V_111 ) {
if ( F_64 ( & V_20 -> V_108 ) && F_85 ( V_18 ) ) {
F_24 ( & V_16 -> V_41 ) ;
memcpy ( & V_20 -> V_109 , & V_20 -> V_116 ,
sizeof( V_20 -> V_109 ) ) ;
...
return;
V_20 -> V_117 = V_16 -> V_86 ;
V_20 -> V_107 = F_78 () ;
V_53 = V_16 -> V_42 -> V_118 ( V_18 ) ;
if ( V_53 != 0 ) {
V_18 -> V_31 = V_53 ;
return;
}
...
V_18 -> V_119 |= V_120 ;
F_24 ( & V_16 -> V_41 ) ;
V_16 -> V_42 -> V_121 ( V_18 ) ;
V_114 = F_87 ( & V_16 -> V_122 ) ;
if ( V_114 > V_16 -> V_92 . V_123 )
V_16 -> V_92 . V_123 = V_114 ;
V_16 -> V_92 . V_124 ++ ;
V_16 -> V_92 . V_125 += V_16 -> V_92 . V_124 - V_16 -> V_92 . V_106 ;
V_16 -> V_92 . V_126 += V_16 -> V_127 . V_128 ;
V_16 -> V_92 . V_129 += V_16 -> V_36 . V_128 ;
V_16 -> V_92 . V_130 += V_16 -> V_54 . V_128 ;
if ( ! F_62 ( V_16 ) )
V_18 -> V_31 = - V_131 ;
else if ( ! V_20 -> V_111 && F_85 ( V_18 ) ) {
...
{
F_60 ( V_132 , & V_16 -> V_24 ) ;
F_44 ( & V_16 -> V_127 , V_18 , NULL ) ;
}
static void F_89 ( struct V_15 * V_16 )
{
if ( F_90 ( & V_16 -> V_127 ) == NULL )
F_18 ( V_132 , & V_16 -> V_24 ) ;
}
static bool F_91 ( struct V_15 * V_16 , struct V_17 * V_18 )
{
bool V_133 = false ;
if ( ! F_16 ( V_132 , & V_16 -> V_24 ) )
goto V_8;
F_2 ( & V_16 -> V_134 ) ;
if ( F_16 ( V_132 , & V_16 -> V_24 ) ) {
F_44 ( & V_16 -> V_127 , V_18 , NULL ) ;
...
{
struct V_19 * V_20 = F_93 ( - V_32 ) ;
if ( ! F_94 ( & V_16 -> V_122 , 1 , V_16 -> V_136 ) )
goto V_8;
...
{
if ( F_94 ( & V_16 -> V_122 , - 1 , V_16 -> V_138 ) ) {
F_98 ( V_20 ) ;
return true ;
}
return false ;
...
V_16 = V_20 -> V_51 ;
if ( V_18 -> V_156 -> V_157 != NULL )
V_18 -> V_156 -> V_157 ( V_18 , V_18 -> V_158 ) ;
else if ( V_18 -> V_63 )
F_125 ( V_18 , V_18 -> V_63 -> V_159 ) ;
F_24 ( & V_16 -> V_41 ) ;
V_16 -> V_42 -> V_46 ( V_16 , V_18 ) ;
if ( V_16 -> V_42 -> V_160 )
V_16 -> V_42 -> V_160 ( V_18 ) ;
if ( ! F_64 ( & V_20 -> V_108 ) )
F_101 ( & V_20 -> V_108 ) ;
V_16 -> V_161 = V_78 ;
if ( F_64 ( & V_16 -> V_88 ) && F_81 ( V_16 ) )
F_126 ( & V_16 -> V_57 ,
V_16 -> V_161 + V_16 -> V_112 ) ;
F_25 ( & V_16 -> V_41 ) ;
if ( V_20 -> V_154 )
V_16 -> V_42 -> V_162 ( V_20 -> V_154 ) ;
if ( V_20 -> V_163 != NULL )
F_127 ( V_20 -> V_163 ) ;
V_18 -> V_21 = NULL ;
if ( V_20 -> V_155 )
...
V_16 -> V_49 = V_168 ;
V_16 -> V_169 = 0 ;
F_133 ( & V_16 -> V_170 , L_31 ) ;
F_133 ( & V_16 -> V_54 , L_32 ) ;
F_134 ( & V_16 -> V_36 , L_33 ) ;
F_134 ( & V_16 -> V_127 , L_34 ) ;
F_121 ( V_16 ) ;
V_16 -> V_150 = F_135 ( V_143 ) ;
}
struct V_15 * F_136 ( struct V_171 * args )
{
struct V_15 * V_16 ;
struct V_1 * V_3 ;
F_2 ( & V_6 ) ;
...
if ( args -> V_175 & V_176 )
V_16 -> V_112 = 0 ;
F_137 ( & V_16 -> V_39 , F_55 ) ;
if ( F_81 ( V_16 ) )
F_138 ( & V_16 -> V_57 , F_63 ,
( unsigned long ) V_16 ) ;
else
F_139 ( & V_16 -> V_57 ) ;
if ( strlen ( args -> V_97 ) > V_177 ) {
F_140 ( V_16 ) ;
return F_93 ( - V_178 ) ;
}
