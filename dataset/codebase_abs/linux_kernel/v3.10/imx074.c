...
{
struct V_2 * V_3 = F_14 ( V_27 ) ;
if ( V_60 -> V_61 . type != V_62 )
return - V_41 ;
if ( V_60 -> V_61 . V_10 != V_3 -> V_10 )
return - V_63 ;
V_60 -> V_64 = V_65 ;
V_60 -> V_66 = 0 ;
return 0 ;
}
static int F_21 ( struct V_26 * V_27 , int V_67 )
{
struct V_2 * V_3 = F_14 ( V_27 ) ;
struct V_68 * V_69 = F_22 ( V_3 ) ;
return F_23 ( & V_3 -> V_25 , V_69 , V_67 ) ;
}
...
{
struct V_1 * V_40 ;
struct V_12 * V_14 = F_28 ( V_3 -> V_25 . V_105 ) ;
struct V_68 * V_69 = F_22 ( V_3 ) ;
if ( ! V_69 ) {
F_29 ( & V_3 -> V_25 , L_4 ) ;
return - V_41 ;
...
V_40 = F_31 ( & V_3 -> V_25 , sizeof( struct V_1 ) , V_107 ) ;
if ( ! V_40 )
return - V_108 ;
F_32 ( & V_40 -> V_4 , V_3 , & V_109 ) ;
V_40 -> V_30 = & V_9 [ 0 ] ;
return F_25 ( V_3 ) ;
}
