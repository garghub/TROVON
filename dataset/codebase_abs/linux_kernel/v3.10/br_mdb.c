...
struct V_5 * V_6 ,
struct V_40 * V_68 , T_1 V_69 ,
T_1 V_56 , int type , unsigned int V_70 )
{
struct V_54 * V_55 ;
struct V_61 * V_62 ;
struct V_11 * V_12 , * V_22 ;
...
F_62 ( & V_10 -> V_102 ) ;
F_63 ( & V_10 -> V_103 ) ;
F_64 ( & V_10 -> V_104 , V_105 ) ;
V_24 = 0 ;
if ( ! V_31 -> V_38 && ! V_31 -> V_102 &&
F_55 ( V_8 -> V_6 ) )
F_65 ( & V_31 -> V_103 , V_106 ) ;
break;
}
V_101:
F_58 ( & V_8 -> V_98 ) ;
...
void F_67 ( void )
{
F_68 ( V_108 , V_65 , NULL , F_14 , NULL ) ;
F_68 ( V_108 , V_94 , F_59 , NULL , NULL ) ;
F_68 ( V_108 , V_107 , F_66 , NULL , NULL ) ;
}
void F_69 ( void )
{
F_70 ( V_108 , V_65 ) ;
