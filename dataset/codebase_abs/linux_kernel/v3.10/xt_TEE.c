...
void * V_58 )
{
struct V_59 * V_6 = V_58 ;
struct V_60 * V_16 ;
V_16 = F_31 ( V_56 , struct V_60 , V_61 ) ;
switch ( V_57 ) {
case V_62 :
...
static int F_32 ( const struct V_69 * V_31 )
{
...
static void F_35 ( const struct V_75 * V_31 )
{
struct V_8 * V_9 = V_31 -> V_32 ;
if ( V_9 -> V_16 ) {
F_36 ( & V_9 -> V_16 -> V_61 ) ;
