...
static T_4
F_55 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
static T_4
F_58 ( struct V_36 * V_37 , struct V_106 * V_107 ,
...
if ( ! V_3 ) {
V_18 -> V_39 [ V_15 ] = 255 ;
V_117 = V_18 -> V_32 [ V_15 ] ;
F_59 ( V_37 , L_5 , V_15 + 1 ) ;
goto V_119;
}
V_2 = 1350000U / V_3 ;
if ( V_2 >= 128 * 255 ) {
...
F_60 ( V_37 ,
L_6 ,
V_15 + 1 , V_3 , V_18 -> V_116 ( 254 , 7 ) ) ;
} else if ( ! V_2 ) {
V_18 -> V_39 [ V_15 ] = 1 ;
V_117 = 0 ;
F_60 ( V_37 ,
L_7 ,
V_15 + 1 , V_3 , V_18 -> V_116 ( 1 , 0 ) ) ;
} else {
V_117 = 0 ;
while ( V_2 > 192 && V_117 < 7 ) {
V_2 >>= 1 ;
V_117 ++ ;
}
V_18 -> V_39 [ V_15 ] = V_2 ;
...
V_119:
if ( V_117 != V_18 -> V_32 [ V_15 ] ) {
F_39 ( V_37 , L_8 ,
V_15 + 1 , F_19 ( V_18 -> V_32 [ V_15 ] ) ,
F_19 ( V_117 ) ) ;
V_18 -> V_32 [ V_15 ] = V_117 ;
F_32 ( V_18 , V_15 ) ;
V_18 -> V_81 = V_80 ;
}
V_118:
...
static T_4
F_61 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
int V_120 = V_18 -> V_92 [ V_110 -> V_111 ] ;
return sprintf ( V_108 , L_4 , V_120 ? : 4 ) ;
}
static T_4
F_62 ( struct V_36 * V_37 , struct V_106 * V_107 ,
const char * V_108 , T_5 V_112 )
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
struct V_114 * V_110 = F_54 ( V_107 ) ;
int V_15 = V_110 -> V_111 ;
return sprintf ( V_108 , L_9 , V_18 -> V_122 [ V_18 -> V_123 [ V_15 ] ] ) ;
}
static T_4
F_64 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_109 * V_110 = F_50 ( V_107 ) ;
int V_15 = V_110 -> V_15 ;
int V_111 = V_110 -> V_111 ;
return sprintf ( V_108 , L_4 , F_65 ( V_18 -> V_97 [ V_111 ] [ V_15 ] ) ) ;
}
static T_4
F_66 ( struct V_36 * V_37 , struct V_106 * V_107 , const char * V_108 ,
T_5 V_112 )
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
struct V_109 * V_110 = F_50 ( V_107 ) ;
...
int V_113 ;
long V_3 ;
V_113 = F_67 ( V_108 , 10 , & V_3 ) ;
if ( V_113 < 0 )
return V_113 ;
F_46 ( & V_18 -> V_79 ) ;
V_18 -> V_97 [ V_111 ] [ V_15 ] = F_68 ( V_3 ) ;
...
static T_4
F_69 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
static T_4
F_70 ( struct V_36 * V_37 , struct V_106 * V_107 ,
const char * V_108 , T_5 V_112 )
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
struct V_114 * V_110 = F_54 ( V_107 ) ;
int V_15 = V_110 -> V_111 ;
return sprintf ( V_108 , L_4 , ( int ) V_18 -> V_124 [ V_15 ] ) ;
}
static T_4
...
F_46 ( & V_18 -> V_79 ) ;
V_18 -> V_124 [ V_15 ] = V_3 ;
V_125 = F_26 ( V_18 , V_18 -> V_128 ) & ~ ( 0x02 << V_15 ) ;
V_126 = F_26 ( V_18 , V_18 -> V_129 ) & ~ ( 0x02 << V_15 ) ;
V_127 = 0x02 << V_15 ;
switch ( V_3 ) {
case 1 :
V_125 |= V_127 ;
...
F_28 ( V_18 , V_18 -> V_128 , V_125 ) ;
F_28 ( V_18 , V_18 -> V_129 , V_126 ) ;
F_48 ( & V_18 -> V_79 ) ;
return V_112 ;
}
static T_4
...
int V_111 = V_110 -> V_111 ;
int V_9 ;
if ( V_111 == 0 && V_18 -> V_8 [ V_15 ] > V_130 )
V_9 = F_26 ( V_18 , V_18 -> V_131 [ V_15 ] ) ;
else
V_9 = V_18 -> V_9 [ V_111 ] [ V_15 ] ;
return sprintf ( V_108 , L_4 , V_9 ) ;
}
static T_4
F_76 ( struct V_36 * V_37 , struct V_106 * V_107 , const char * V_108 ,
T_5 V_112 )
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
struct V_109 * V_110 = F_50 ( V_107 ) ;
...
int V_111 = V_110 -> V_111 ;
unsigned long V_3 ;
int V_132 [ 7 ] = { 0 , 1 , 1 , V_18 -> V_9 [ 2 ] [ V_15 ] , 0 , 0 , 0 } ;
int V_133 [ 7 ]
...
if ( V_113 < 0 )
return V_113 ;
V_3 = F_14 ( V_3 , V_132 [ V_111 ] , V_133 [ V_111 ] ) ;
F_46 ( & V_18 -> V_79 ) ;
...
static int F_77 ( struct V_17 * V_18 , int V_15 )
{
int V_34 ;
...
static void F_78 ( struct V_17 * V_18 , int V_15 )
{
T_1 V_2 ;
...
static T_4
F_79 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
static T_4
F_80 ( struct V_36 * V_37 , struct V_106 * V_107 ,
const char * V_108 , T_5 V_112 )
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
if ( V_3 > V_135 )
return - V_121 ;
if ( V_3 == V_136 && V_18 -> V_19 != V_20 )
return - V_121 ;
if ( V_3 == V_135 && F_77 ( V_18 , V_15 ) ) {
F_81 ( V_37 , L_10 ) ;
F_81 ( V_37 , L_11 ) ;
return - V_121 ;
}
...
static T_4
F_82 ( struct V_17 * V_18 , char * V_108 , int V_137 )
{
int V_34 , V_138 = 0 ;
for ( V_34 = 0 ; V_34 < V_94 ; V_34 ++ ) {
if ( ! ( V_18 -> V_95 & ( 1 << V_34 ) ) )
continue;
if ( V_137 == V_18 -> V_123 [ V_34 ] ) {
V_138 = V_34 + 1 ;
break;
}
}
return sprintf ( V_108 , L_4 , V_138 ) ;
}
static T_4
F_83 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
int V_111 = V_110 -> V_111 ;
return F_82 ( V_18 , V_108 , V_18 -> V_59 [ V_111 ] ) ;
}
static T_4
F_84 ( struct V_36 * V_37 , struct V_106 * V_107 ,
const char * V_108 , T_5 V_112 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
if ( V_3 == 0 || V_3 > V_94 )
return - V_121 ;
if ( ! ( V_18 -> V_95 & ( 1 << ( V_3 - 1 ) ) ) || ! V_18 -> V_123 [ V_3 - 1 ] )
return - V_121 ;
F_46 ( & V_18 -> V_79 ) ;
V_137 = V_18 -> V_123 [ V_3 - 1 ] ;
V_18 -> V_59 [ V_15 ] = V_137 ;
V_2 = F_26 ( V_18 , V_18 -> V_58 [ V_15 ] ) ;
V_2 &= 0xe0 ;
V_2 |= V_137 ;
F_28 ( V_18 , V_18 -> V_58 [ V_15 ] , V_2 ) ;
...
static T_4
F_85 ( struct V_36 * V_37 , struct V_106 * V_107 ,
char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
int V_111 = V_110 -> V_111 ;
return F_82 ( V_18 , V_108 ,
V_18 -> V_61 [ V_111 ] ) ;
}
static T_4
...
static T_4
F_87 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_114 * V_110 = F_54 ( V_107 ) ;
...
V_139 = F_18 ( V_3 , V_18 -> V_32 [ V_15 ] ) ;
F_46 ( & V_18 -> V_79 ) ;
V_18 -> V_71 [ V_15 ] = V_139 ;
F_78 ( V_18 , V_15 ) ;
F_48 ( & V_18 -> V_79 ) ;
return V_112 ;
}
static T_4
F_91 ( struct V_36 * V_37 , struct V_106 * V_107 ,
char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_109 * V_110 = F_50 ( V_107 ) ;
...
if ( V_113 < 0 )
return V_113 ;
V_3 = F_14 ( F_21 ( V_3 , 1000 ) , 0 , V_18 -> V_134 ) ;
F_46 ( & V_18 -> V_79 ) ;
...
struct V_114 * V_110 = F_54 ( V_107 ) ;
int V_15 = V_110 -> V_111 ;
int V_140 = V_18 -> V_71 [ V_15 ] - V_18 -> V_54 [ V_15 ] ;
int V_141 = V_18 -> V_71 [ V_15 ] + V_18 -> V_54 [ V_15 ] ;
int V_142 ;
if ( V_140 <= 0 )
V_140 = 1 ;
if ( V_141 > 0xffff )
...
if ( V_141 < V_140 )
V_141 = V_140 ;
V_142 = ( F_17 ( V_140 , V_18 -> V_32 [ V_15 ] )
- F_17 ( V_141 , V_18 -> V_32 [ V_15 ] ) ) / 2 ;
...
if ( V_113 < 0 )
return V_113 ;
V_141 = F_17 ( V_18 -> V_71 [ V_15 ] ,
V_18 -> V_32 [ V_15 ] ) + V_3 ;
V_140 = F_17 ( V_18 -> V_71 [ V_15 ] ,
V_18 -> V_32 [ V_15 ] ) - V_3 ;
if ( V_140 <= 0 )
V_140 = 1 ;
if ( V_141 < V_140 )
V_141 = V_140 ;
V_3 = ( F_18 ( V_140 , V_18 -> V_32 [ V_15 ] ) -
F_18 ( V_141 , V_18 -> V_32 [ V_15 ] ) ) / 2 ;
V_3 = F_14 ( V_3 , 0 , V_18 -> V_143 ) ;
F_46 ( & V_18 -> V_79 ) ;
V_18 -> V_54 [ V_15 ] = V_3 ;
F_78 ( V_18 , V_15 ) ;
F_48 ( & V_18 -> V_79 ) ;
...
static T_4
F_95 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_109 * V_110 = F_50 ( V_107 ) ;
int V_15 = V_110 -> V_15 ;
...
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
return sprintf ( V_108 , L_9 , V_18 -> V_144 ) ;
}
static T_4
F_100 ( struct V_36 * V_37 , struct V_106 * V_107 , char * V_108 )
{
struct V_17 * V_18 = F_45 ( V_37 ) ;
struct V_109 * V_110 = F_50 ( V_107 ) ;
...
static T_4
F_101 ( struct V_36 * V_37 , struct V_106 * V_107 ,
const char * V_108 , T_5 V_112 )
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
struct V_109 * V_110 = F_50 ( V_107 ) ;
int V_15 = V_110 -> V_15 ;
int V_145 = V_110 -> V_111 ;
unsigned long V_3 ;
int V_113 ;
T_1 V_2 ;
V_113 = F_52 ( V_108 , 10 , & V_3 ) ;
...
F_46 ( & V_18 -> V_79 ) ;
V_18 -> V_73 [ V_15 ] [ V_145 ] = V_3 ;
if ( V_145 < V_18 -> V_72 ) {
F_28 ( V_18 ,
F_43 ( V_18 , V_15 , V_145 ) ,
V_18 -> V_73 [ V_15 ] [ V_145 ] ) ;
} else {
switch ( V_18 -> V_19 ) {
case V_20 :
V_2 = F_26 ( V_18 ,
...
int V_15 = V_110 -> V_15 ;
int V_145 = V_110 -> V_111 ;
return sprintf ( V_108 , L_4 , V_18 -> V_74 [ V_15 ] [ V_145 ] * 1000 ) ;
}
static T_4
...
return - V_121 ;
F_46 ( & V_18 -> V_79 ) ;
V_18 -> V_74 [ V_15 ] [ V_145 ] = F_21 ( V_3 , 1000 ) ;
if ( V_145 < V_18 -> V_72 ) {
F_28 ( V_18 ,
F_44 ( V_18 , V_15 , V_145 ) ,
V_18 -> V_74 [ V_15 ] [ V_145 ] ) ;
} else {
...
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
return sprintf ( V_108 , L_4 , F_105 ( V_18 -> V_146 , V_18 -> V_147 ) ) ;
}
static T_4
F_106 ( struct V_36 * V_37 , struct V_106 * V_107 ,
const char * V_108 , T_5 V_112 )
{
struct V_17 * V_18 = F_41 ( V_37 ) ;
struct V_148 * V_149 = V_37 -> V_150 ;
int V_15 = F_54 ( V_107 ) -> V_111 - V_151 ;
unsigned long V_3 ;
T_1 V_2 ;
int V_152 ;
...
return - V_121 ;
F_46 ( & V_18 -> V_79 ) ;
V_152 = F_6 ( V_149 -> V_153 ) ;
if ( V_152 ) {
V_112 = V_152 ;
goto error;
}
F_5 ( V_149 -> V_153 , V_154 ) ;
V_2 = F_3 ( V_149 -> V_153 , V_155 [ V_15 ] ) ;
V_2 |= V_156 [ V_15 ] ;
F_1 ( V_149 -> V_153 , V_155 [ V_15 ] , V_2 ) ;
V_2 &= ~ V_156 [ V_15 ] ;
F_1 ( V_149 -> V_153 , V_155 [ V_15 ] , V_2 ) ;
F_8 ( V_149 -> V_153 ) ;
V_18 -> V_83 = false ;
...
static void F_107 ( struct V_36 * V_37 )
{
int V_34 ;
struct V_17 * V_18 = F_41 ( V_37 ) ;
for ( V_34 = 0 ; V_34 < V_18 -> V_45 ; V_34 ++ )
F_108 ( & V_37 -> V_157 , & V_158 [ V_34 ] ) ;
for ( V_34 = 0 ; V_34 < F_36 ( V_159 ) ; V_34 ++ )
F_109 ( V_37 , & V_159 [ V_34 ] . V_160 ) ;
for ( V_34 = 0 ; V_34 < F_36 ( V_161 ) ; V_34 ++ )
F_109 ( V_37 , & V_161 [ V_34 ] . V_160 ) ;
for ( V_34 = 0 ; V_34 < F_36 ( V_162 ) ; V_34 ++ )
F_109 ( V_37 , & V_162 [ V_34 ] . V_160 ) ;
for ( V_34 = 0 ; V_34 < F_36 ( V_163 ) ; V_34 ++ )
F_109 ( V_37 , & V_163 [ V_34 ] . V_160 ) ;
for ( V_34 = 0 ; V_34 < V_18 -> V_84 ; V_34 ++ )
F_108 ( & V_37 -> V_157 , & V_164 [ V_34 ] ) ;
for ( V_34 = 0 ; V_34 < 5 ; V_34 ++ ) {
F_109 ( V_37 , & V_165 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_166 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_167 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_168 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_169 [ V_34 ] . V_160 ) ;
}
for ( V_34 = 0 ; V_34 < V_94 ; V_34 ++ ) {
if ( ! ( V_18 -> V_95 & ( 1 << V_34 ) ) )
continue;
F_109 ( V_37 , & V_170 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_171 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_172 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_173 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_174 [ V_34 ] . V_160 ) ;
if ( ! ( V_18 -> V_98 & ( 1 << V_34 ) ) )
continue;
F_109 ( V_37 , & V_175 [ V_34 ] . V_160 ) ;
F_109 ( V_37 , & V_176 [ V_34 ] . V_160 ) ;
if ( V_34 >= V_177 )
continue;
F_109 ( V_37 , & V_178 [ V_34 ] . V_160 ) ;
}
F_109 ( V_37 , & V_179 [ 0 ] . V_160 ) ;
F_109 ( V_37 , & V_179 [ 1 ] . V_160 ) ;
F_109 ( V_37 , & V_180 ) ;
F_109 ( V_37 , & V_181 ) ;
}
static inline void F_110 ( struct V_17 * V_18 )
{
int V_34 ;
T_1 V_182 , V_126 ;
if ( V_18 -> V_183 ) {
V_182 = F_26 ( V_18 , V_18 -> V_183 ) ;
if ( ! ( V_182 & 0x01 ) )
F_28 ( V_18 , V_18 -> V_183 , V_182 | 0x01 ) ;
}
for ( V_34 = 0 ; V_34 < V_94 ; V_34 ++ ) {
if ( ! ( V_18 -> V_95 & ( 1 << V_34 ) ) )
continue;
if ( ! V_18 -> V_184 [ V_34 ] )
continue;
V_182 = F_26 ( V_18 , V_18 -> V_184 [ V_34 ] ) ;
if ( V_182 & 0x01 )
F_28 ( V_18 , V_18 -> V_184 [ V_34 ] ,
V_182 & 0xfe ) ;
}
V_182 = F_26 ( V_18 , V_18 -> V_128 ) ;
if ( ! ( V_182 & 0x01 ) )
F_28 ( V_18 , V_18 -> V_128 , V_182 | 0x01 ) ;
V_126 = F_26 ( V_18 , V_18 -> V_129 ) ;
for ( V_34 = 0 ; V_34 < V_18 -> V_185 ; V_34 ++ ) {
if ( ! ( V_18 -> V_98 & ( 1 << V_34 ) ) )
continue;
if ( ( V_182 & ( 0x02 << V_34 ) ) )
V_18 -> V_124 [ V_34 ] = 3 - ( ( V_126 >> V_34 ) & 0x02 ) ;
else
V_18 -> V_124 [ V_34 ] = 4 ;
}
}
static int
F_111 ( const struct V_148 * V_149 ,
struct V_17 * V_18 )
{
int V_186 ;
bool V_187 , V_188 , V_189 , V_190 , V_191 ;
bool V_192 , V_193 , V_194 ;
int V_152 ;
V_152 = F_6 ( V_149 -> V_153 ) ;
if ( V_152 )
return V_152 ;
if ( V_18 -> V_19 == V_20 ) {
V_186 = F_3 ( V_149 -> V_153 , 0x2c ) ;
V_187 = V_186 & ( 1 << 6 ) ;
V_188 = V_187 ;
V_192 = V_186 & ( 1 << 7 ) ;
V_189 = ! ( F_3 ( V_149 -> V_153 , 0x2A ) & 0x80 ) ;
V_190 = 0 ;
V_191 = 0 ;
V_193 = 0 ;
V_194 = 0 ;
} else if ( V_18 -> V_19 == V_21 ) {
bool V_195 = F_3 ( V_149 -> V_153 , 0x27 ) & 0x80 ;
F_5 ( V_149 -> V_153 , V_196 ) ;
V_186 = F_3 ( V_149 -> V_153 , V_197 ) ;
if ( V_186 & 0x80 )
V_187 = V_195 ;
else
V_187 = ! ( F_3 ( V_149 -> V_153 , 0x24 ) & 0x40 ) ;
if ( V_186 & 0x40 )
V_189 = V_195 ;
else
V_189 = F_3 ( V_149 -> V_153 , 0x1C ) & 0x01 ;
if ( V_186 & 0x20 )
V_191 = V_195 ;
else
V_191 = F_3 ( V_149 -> V_153 , 0x1C ) & 0x02 ;
V_190 = V_189 ;
V_188 = V_187 ;
V_192 = V_187 ;
V_193 = 0 ;
...
V_18 -> V_35 |= V_187 << 2 ;
V_18 -> V_40 |= V_188 << 2 ;
V_18 -> V_35 |= ( V_189 << 3 ) | ( V_191 << 4 ) ;
V_18 -> V_40 |= ( V_190 << 3 ) | ( V_191 << 4 ) ;
V_18 -> V_46 = 0x03 | ( V_192 << 2 ) | ( V_193 << 3 ) | ( V_194 << 4 ) ;
return 0 ;
}
static void F_112 ( struct V_17 * V_18 , const T_2 * V_198 ,
int * V_199 , int * V_200 )
{
int V_34 ;
T_1 V_137 ;
for ( V_34 = 0 ; V_34 < V_18 -> V_45 && * V_199 ; V_34 ++ ) {
int V_111 ;
if ( ! V_198 [ V_34 ] )
continue;
V_137 = F_26 ( V_18 , V_198 [ V_34 ] ) ;
V_137 &= 0x1f ;
if ( ! V_137 || ( * V_200 & ( 1 << V_137 ) ) )
continue;
if ( V_137 >= V_18 -> V_201 ||
! strlen ( V_18 -> V_122 [ V_137 ] ) )
continue;
V_111 = F_113 ( * V_199 ) ;
F_28 ( V_18 , V_18 -> V_202 [ V_111 ] , V_137 ) ;
* V_199 &= ~ ( 1 << V_111 ) ;
* V_200 |= 1 << V_137 ;
}
}
...
struct V_17 * V_18 ;
struct V_205 * V_28 ;
int V_34 , V_206 , V_113 = 0 ;
int V_137 , V_200 , V_199 ;
const T_2 * V_96 , * V_207 , * V_208 , * V_184 ;
const T_2 * V_209 , * V_210 ;
int V_211 ;
bool V_212 = false ;
T_1 V_213 ;
V_28 = F_115 ( V_204 , V_214 , 0 ) ;
if ( ! F_116 ( & V_204 -> V_37 , V_28 -> V_215 , V_216 ,
V_6 ) )
return - V_7 ;
V_18 = F_117 ( & V_204 -> V_37 , sizeof( struct V_17 ) ,
V_217 ) ;
if ( ! V_18 )
return - V_218 ;
V_18 -> V_19 = V_149 -> V_19 ;
V_18 -> V_25 = V_28 -> V_215 ;
F_118 ( & V_18 -> V_79 ) ;
V_18 -> V_144 = V_219 [ V_18 -> V_19 ] ;
V_18 -> V_23 = 0xff ;
F_119 ( V_204 , V_18 ) ;
switch ( V_18 -> V_19 ) {
case V_20 :
...
V_200 = 0 ;
V_199 = 0 ;
for ( V_34 = 0 ; V_34 < V_211 ; V_34 ++ ) {
if ( V_96 [ V_34 ] == 0 )
continue;
V_137 = F_26 ( V_18 , V_18 -> V_202 [ V_34 ] ) & 0x1f ;
if ( ! V_137 || ( V_200 & ( 1 << V_137 ) ) )
V_199 |= 1 << V_34 ;
V_200 |= 1 << V_137 ;
}
F_112 ( V_18 , V_18 -> V_58 , & V_199 , & V_200 ) ;
F_112 ( V_18 , V_18 -> V_60 , & V_199 , & V_200 ) ;
V_200 = 0 ;
V_206 = V_290 ;
for ( V_34 = 0 ; V_34 < V_211 ; V_34 ++ ) {
if ( V_96 [ V_34 ] == 0 )
...
F_59 ( V_37 ,
L_12 ,
V_137 , V_34 , V_18 -> V_202 [ V_34 ] , V_96 [ V_34 ] ) ;
continue;
}
V_200 |= 1 << V_137 ;
if ( V_137 <= V_18 -> V_185 ) {
V_18 -> V_95 |= 1 << ( V_137 - 1 ) ;
V_18 -> V_98 |= 1 << ( V_137 - 1 ) ;
V_18 -> V_96 [ 0 ] [ V_137 - 1 ] = V_96 [ V_34 ] ;
V_18 -> V_96 [ 1 ] [ V_137 - 1 ] = V_207 [ V_34 ] ;
V_18 -> V_96 [ 2 ] [ V_137 - 1 ] = V_208 [ V_34 ] ;
V_18 -> V_184 [ V_137 - 1 ] = V_184 [ V_34 ] ;
V_18 -> V_123 [ V_137 - 1 ] = V_137 ;
continue;
}
if ( V_206 >= V_94 )
continue;
V_18 -> V_95 |= 1 << V_206 ;
V_18 -> V_96 [ 0 ] [ V_206 ] = V_96 [ V_34 ] ;
V_18 -> V_96 [ 1 ] [ V_206 ] = V_207 [ V_34 ] ;
V_18 -> V_96 [ 2 ] [ V_206 ] = V_208 [ V_34 ] ;
V_18 -> V_184 [ V_206 ] = V_184 [ V_34 ] ;
if ( V_210 [ V_137 - 1 ] )
V_18 -> V_96 [ 3 ] [ V_206 ] = V_210 [ V_137 - 1 ] ;
V_18 -> V_123 [ V_206 ] = V_137 ;
V_206 ++ ;
}
#ifdef F_120
for ( V_34 = 0 ; V_34 < V_18 -> V_201 - 1 ; V_34 ++ ) {
if ( ! V_209 [ V_34 ] )
continue;
if ( V_200 & ( 1 << ( V_34 + 1 ) ) )
continue;
...
V_18 -> V_95 |= 1 << V_34 ;
V_18 -> V_98 |= 1 << V_34 ;
V_18 -> V_96 [ 0 ] [ V_34 ] = V_209 [ V_34 ] ;
if ( V_34 < V_211 ) {
V_18 -> V_96 [ 1 ] [ V_34 ] = V_207 [ V_34 ] ;
V_18 -> V_96 [ 2 ] [ V_34 ] = V_208 [ V_34 ] ;
}
V_18 -> V_123 [ V_34 ] = V_34 + 1 ;
continue;
}
if ( V_206 >= V_94 )
break;
V_18 -> V_95 |= 1 << V_206 ;
V_18 -> V_96 [ 0 ] [ V_206 ] = V_209 [ V_34 ] ;
V_18 -> V_123 [ V_206 ] = V_34 + 1 ;
V_206 ++ ;
}
#endif
F_110 ( V_18 ) ;
V_113 = F_6 ( V_149 -> V_153 ) ;
if ( V_113 )
return V_113 ;
V_213 = F_3 ( V_149 -> V_153 , 0x2a ) ;
switch ( V_18 -> V_19 ) {
case V_20 :
V_212 = ( V_213 & 0x40 ) ;
break;
case V_21 :
V_212 = ( V_213 & 0x60 ) == 0x40 ;
break;
case V_22 :
break;
}
if ( V_212 ) {
F_5 ( V_149 -> V_153 , V_291 ) ;
V_18 -> V_146 = F_3 ( V_149 -> V_153 , 0xe3 ) ;
V_18 -> V_147 = F_121 () ;
}
if ( V_292 ) {
T_1 V_182 ;
F_5 ( V_149 -> V_153 , V_196 ) ;
V_182 = F_3 ( V_149 -> V_153 ,
V_293 ) ;
switch ( V_18 -> V_19 ) {
case V_20 :
V_182 |= 0x1e ;
...
F_1 ( V_149 -> V_153 , V_293 ,
V_182 ) ;
F_59 ( & V_204 -> V_37 , L_13 ,
V_18 -> V_144 ) ;
}
F_8 ( V_149 -> V_153 ) ;
if ( V_212 ) {
V_113 = F_122 ( V_37 , & V_181 ) ;
if ( V_113 )
return V_113 ;
}
V_113 = F_111 ( V_149 , V_18 ) ;
if ( V_113 )
goto V_294;
F_37 ( V_37 , V_18 ) ;
for ( V_34 = 0 ; V_34 < V_18 -> V_45 ; V_34 ++ ) {
if ( ! ( V_18 -> V_46 & ( 1 << V_34 ) ) )
continue;
V_113 = F_123 ( & V_37 -> V_157 , & V_158 [ V_34 ] ) ;
if ( V_113 )
goto V_294;
if ( V_18 -> V_51 [ 3 ] ) {
V_113 = F_122 ( V_37 ,
...
if ( ! ( V_18 -> V_85 & ( 1 << V_34 ) ) )
continue;
V_113 = F_123 ( & V_37 -> V_157 , & V_164 [ V_34 ] ) ;
if ( V_113 )
goto V_294;
}
for ( V_34 = 0 ; V_34 < 5 ; V_34 ++ ) {
...
if ( ! ( V_18 -> V_95 & ( 1 << V_34 ) ) )
continue;
V_113 = F_122 ( V_37 , & V_170 [ V_34 ] . V_160 ) ;
if ( V_113 )
goto V_294;
if ( V_18 -> V_122 ) {
V_113 = F_122 ( V_37 ,
...
if ( ! ( V_18 -> V_98 & ( 1 << V_34 ) ) )
continue;
V_113 = F_122 ( V_37 , & V_175 [ V_34 ] . V_160 ) ;
if ( V_113 )
goto V_294;
V_113 = F_122 ( V_37 , & V_176 [ V_34 ] . V_160 ) ;
if ( V_113 )
goto V_294;
if ( V_34 >= V_177 ||
V_18 -> V_115 [ V_295 + V_34 ] < 0 )
continue;
V_113 = F_122 ( V_37 , & V_178 [ V_34 ] . V_160 ) ;
if ( V_113 )
goto V_294;
}
for ( V_34 = 0 ; V_34 < F_36 ( V_179 ) ; V_34 ++ ) {
if ( V_18 -> V_115 [ V_151 + V_34 ] < 0 )
continue;
V_113 = F_122 ( V_37 , & V_179 [ V_34 ] . V_160 ) ;
if ( V_113 )
goto V_294;
}
V_113 = F_122 ( V_37 , & V_180 ) ;
if ( V_113 )
goto V_294;
V_18 -> V_296 = F_124 ( V_37 ) ;
if ( F_125 ( V_18 -> V_296 ) ) {
V_113 = F_126 ( V_18 -> V_296 ) ;
goto V_294;
}
return 0 ;
V_294:
...
struct V_148 * V_149 = V_37 -> V_150 ;
F_46 ( & V_18 -> V_79 ) ;
V_18 -> V_125 = F_26 ( V_18 , V_18 -> V_128 ) ;
if ( V_149 -> V_19 == V_20 ) {
V_18 -> V_297 = F_26 ( V_18 , V_31 ) ;
V_18 -> V_298 = F_26 ( V_18 , V_33 ) ;
}
F_48 ( & V_18 -> V_79 ) ;
return 0 ;
}
...
F_28 ( V_18 , V_18 -> V_128 , V_18 -> V_125 ) ;
if ( V_149 -> V_19 == V_20 ) {
F_28 ( V_18 , V_31 , V_18 -> V_297 ) ;
F_28 ( V_18 , V_33 , V_18 -> V_298 ) ;
}
V_18 -> V_83 = false ;
F_48 ( & V_18 -> V_79 ) ;
return 0 ;
}
static int T_6 F_132 ( int V_299 , unsigned short * V_25 ,
struct V_148 * V_149 )
{
T_2 V_3 ;
int V_113 ;
...
if ( ! ( V_3 & 0x01 ) ) {
F_135 ( L_16 ) ;
F_1 ( V_299 , V_197 , V_3 | 0x01 ) ;
}
F_8 ( V_299 ) ;
F_136 ( L_17 ,
V_308 [ V_149 -> V_19 ] , * V_25 ) ;
V_149 -> V_153 = V_299 ;
return 0 ;
}
...
struct V_205 V_28 ;
struct V_148 V_149 ;
if ( F_132 ( 0x2e , & V_309 , & V_149 ) &&
F_132 ( 0x4e , & V_309 , & V_149 ) )
return - V_289 ;
V_113 = F_138 ( & V_310 ) ;
if ( V_113 )
goto exit;
V_204 = F_139 ( V_6 , V_309 ) ;
if ( ! V_204 ) {
V_113 = - V_218 ;
F_134 ( L_18 ) ;
goto V_311;
}
V_113 = F_140 ( V_204 , & V_149 ,
sizeof( struct V_148 ) ) ;
if ( V_113 ) {
F_134 ( L_19 ) ;
goto V_312;
...
V_28 . V_144 = V_6 ;
V_28 . V_215 = V_309 + V_313 ;
V_28 . V_314 = V_309 + V_313 + V_216 - 1 ;
V_28 . V_315 = V_214 ;
V_113 = F_141 ( & V_28 ) ;
if ( V_113 )
goto V_312;
V_113 = F_142 ( V_204 , & V_28 , 1 ) ;
if ( V_113 ) {
F_134 ( L_20 , V_113 ) ;
goto V_312;
}
