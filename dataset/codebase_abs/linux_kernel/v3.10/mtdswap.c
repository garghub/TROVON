...
static int F_83 ( struct V_199 * V_199 , struct V_200 * V_200 )
{
return F_84 ( V_200 , F_78 , V_199 -> V_201 ) ;
}
static int F_85 ( struct V_1 * V_2 )
{
struct V_202 * V_203 = V_2 -> V_177 -> V_204 ;
struct V_205 * V_30 = F_86 ( V_203 ) ;
struct V_206 * V_11 ;
struct V_206 * V_207 ;
V_11 = F_87 ( V_203 -> V_208 , NULL ) ;
if ( F_88 ( V_11 ) )
return 0 ;
if ( ! V_11 ) {
F_40 ( V_30 , L_45 ) ;
...
V_2 -> V_209 = V_11 ;
V_207 = F_89 ( L_46 , V_210 , V_11 , V_2 ,
& V_211 ) ;
if ( ! V_207 ) {
F_40 ( V_2 -> V_30 , L_47 ) ;
F_90 ( V_11 ) ;
...
static int F_91 ( struct V_1 * V_2 , unsigned int V_212 ,
unsigned int V_213 )
{
...
V_2 -> V_131 = F_92 ( sizeof( int ) * V_196 ) ;
if ( ! V_2 -> V_131 )
goto V_217;
V_2 -> V_114 = F_92 ( sizeof( int ) * V_215 ) ;
if ( ! V_2 -> V_114 )
goto V_218;
...
V_2 -> V_128 = F_94 ( V_122 , V_220 ) ;
if ( ! V_2 -> V_128 )
goto V_221;
V_2 -> V_49 = F_94 ( 2 * V_6 -> V_46 -> V_47 , V_220 ) ;
if ( ! V_2 -> V_49 )
goto V_222;
F_32 ( V_2 ) ;
return 0 ;
...
F_67 ( V_2 -> V_131 ) ;
V_217:
F_95 ( V_223 L_48 , V_224 , V_25 ) ;
return V_25 ;
}
static void F_96 ( struct V_225 * V_226 , struct V_92 * V_6 )
{
struct V_1 * V_2 ;
struct V_163 * V_177 ;
char * V_227 ;
...
if ( ! * V_227 )
return;
while ( ( V_228 = F_97 ( & V_227 , L_49 ) ) != NULL ) {
if ( F_98 ( V_228 , 0 , & V_229 ) < 0 )
return;
if ( V_6 -> V_237 == V_229 )
break;
}
...
V_213 = F_100 ( ( T_5 ) V_230 * V_239 , 100 ) ;
if ( V_213 < V_135 )
V_213 = V_135 ;
if ( V_213 > V_230 - 1 )
V_213 = V_230 - 1 ;
...
V_2 = F_101 ( sizeof( struct V_1 ) , V_220 ) ;
if ( ! V_2 )
return;
V_177 = F_101 ( sizeof( struct V_163 ) , V_220 ) ;
if ( ! V_177 ) {
F_68 ( V_2 ) ;
return;
}
...
if ( ! ( V_6 -> V_28 & V_244 ) )
V_177 -> V_245 = 1 ;
if ( F_91 ( V_2 , V_212 , V_213 ) < 0 )
goto V_246;
if ( F_102 ( V_177 ) < 0 )
goto V_247;
V_2 -> V_30 = F_86 ( V_177 -> V_204 ) ;
V_25 = F_85 ( V_2 ) ;
if ( V_25 < 0 )
goto V_248;
return;
...
static void F_104 ( struct V_163 * V_30 )
{
struct V_1 * V_2 = F_64 ( V_30 ) ;
F_90 ( V_2 -> V_209 ) ;
F_103 ( V_30 ) ;
