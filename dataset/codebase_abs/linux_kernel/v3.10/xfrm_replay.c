...
static void F_22 ( struct V_1 * V_2 , int V_13 )
{
T_1 V_52 , V_53 ;
struct V_14 V_15 ;
struct V_7 * V_8 = V_2 -> V_8 ;
...
break;
if ( V_8 -> V_5 == V_51 -> V_5 )
V_52 = V_8 -> V_4 - V_51 -> V_4 ;
else
V_52 = ~ V_51 -> V_4 + V_8 -> V_4 + 1 ;
if ( V_8 -> V_54 == V_51 -> V_54 )
V_53 = V_8 -> V_20 - V_51 -> V_20 ;
else
V_53 = ~ V_51 -> V_20 + V_8 -> V_20 + 1 ;
if ( V_52 < V_2 -> V_17 &&
V_53 < V_2 -> V_17 ) {
if ( V_2 -> V_21 & V_22 )
V_13 = V_23 ;
...
if ( V_2 -> type -> V_10 & V_35 ) {
F_10 ( V_32 ) -> V_4 . V_36 . V_37 = ++ V_8 -> V_20 ;
F_10 ( V_32 ) -> V_4 . V_36 . V_55 = V_8 -> V_54 ;
if ( F_4 ( V_8 -> V_20 == 0 ) ) {
F_10 ( V_32 ) -> V_4 . V_36 . V_55 = ++ V_8 -> V_54 ;
if ( V_8 -> V_54 == 0 ) {
V_8 -> V_20 -- ;
...
struct V_31 * V_32 , T_2 V_3 )
{
if ( F_4 ( F_10 ( V_32 ) -> V_4 . V_58 . V_55 !=
F_26 ( F_1 ( V_2 , V_3 ) ) ) ) {
V_2 -> V_42 . V_12 ++ ;
return - V_44 ;
}
return F_24 ( V_2 , V_32 , V_3 ) ;
}
static void F_27 ( struct V_1 * V_2 , T_2 V_3 )
{
unsigned int V_45 , V_46 , V_50 ;
int V_59 ;
