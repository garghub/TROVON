...
{
F_9 () -> V_8 [ V_7 ] . V_9 = 0 ;
F_9 () -> V_8 [ V_7 ] . V_10 = F_5 ( V_1 , V_2 , V_5 ) ;
F_9 () -> V_8 [ V_7 ] . V_9 = F_3 ( V_1 , V_2 , V_7 ) ;
}
static inline void F_10 ( unsigned long V_7 )
{
F_9 () -> V_8 [ V_7 ] . V_9 = 0 ;
}
static inline void F_11 ( unsigned long V_1 , int V_2 ,
unsigned long V_5 ,
unsigned long V_7 )
{
F_8 ( V_1 , V_2 , V_5 , V_7 ) ;
...
V_13 = V_21 | V_11 ;
V_14 = V_21 | V_12 ;
V_15 = F_3 ( F_13 () -> V_22 , V_23 , 2 ) ;
if ( ( V_15 & ~ 0xfffffffUL ) <= V_24 ) {
V_15 &= ~ V_4 ;
V_16 = 0 ;
F_10 ( 2 ) ;
} else {
F_8 ( F_13 () -> V_22 , V_23 , V_13 , 2 ) ;
V_16 = F_9 () -> V_8 [ 2 ] . V_10 ;
}
asm volatile("isync\n"
"slbia\n"
...
static inline int F_19 ( unsigned long V_27 , unsigned long V_28 )
{
int V_29 ;
if ( ! F_20 ( V_30 ) )
return ( F_21 ( V_27 ) == F_21 ( V_28 ) ) ;
V_29 = ( ( ( V_27 >> V_31 ) != 0 ) +
( ( V_28 >> V_31 ) != 0 ) ) ;
if ( V_29 == 0 )
return ( F_21 ( V_27 ) == F_21 ( V_28 ) ) ;
if ( V_29 == 1 )
return 0 ;
return ( F_22 ( V_27 ) == F_22 ( V_28 ) ) ;
}
void F_23 ( struct V_32 * V_33 , struct V_34 * V_35 )
{
unsigned long V_36 ;
unsigned long V_37 = 0 ;
unsigned long V_38 = F_24 ( V_33 ) ;
unsigned long V_39 = F_25 ( V_33 ) ;
unsigned long V_40 ;
F_17 () ;
V_36 = F_13 () -> V_25 ;
if ( ! F_20 ( V_41 ) &&
...
V_37 = ( unsigned long ) F_13 () -> V_44 [ V_43 ]
<< V_45 ;
V_37 |= F_26 ( V_37 )
<< V_46 ;
V_37 |= V_47 ;
...
static inline void F_28 ( unsigned int * V_49 ,
unsigned int V_50 )
{
...
F_11 ( V_24 , V_23 , V_13 , 0 ) ;
F_11 ( V_26 , V_23 , V_14 , 1 ) ;
F_10 ( 2 ) ;
if ( F_34 () != V_66 &&
( F_13 () -> V_22 & F_4 ( V_23 ) ) > V_24 )
F_11 ( F_13 () -> V_22 ,
V_23 , V_13 , 2 ) ;
asm volatile("isync":::"memory");
}
