...
F_1 ( V_2 , 0x470 , V_47 ) ;
F_1 ( V_2 , 0x471 , 0xff & ( ( ( V_47 >> 8 ) & 0x3 ) |
( V_48 << 4 ) ) ) ;
F_1 ( V_2 , 0x472 , V_48 >> 4 ) ;
F_1 ( V_2 , 0x473 , V_49 ) ;
F_1 ( V_2 , 0x474 , V_50 ) ;
F_1 ( V_2 , 0x475 , 0xff & ( ( ( V_50 >> 8 ) & 0x3 ) |
( V_51 << 4 ) ) ) ;
F_1 ( V_2 , 0x476 , V_51 >> 4 ) ;
F_1 ( V_2 , 0x477 , V_53 ) ;
F_1 ( V_2 , 0x478 , 0xff & V_46 ) ;
F_1 ( V_2 , 0x479 , 0xff & ( V_46 >> 8 ) ) ;
F_1 ( V_2 , 0x47a , V_54 << 6 | ( ( V_55 << 4 ) & 0x30 ) ) ;
F_1 ( V_2 , 0x47b , V_56 ) ;
F_1 ( V_2 , 0x47c , V_52 ) ;
F_1 ( V_2 , 0x47d , 0xff & V_52 >> 8 ) ;
F_1 ( V_2 , 0x47e , 0xff & V_52 >> 16 ) ;
if ( V_45 & V_61 ) {
V_19 -> V_69 = 1 ;
...
static inline int F_44 ( const struct V_187 * V_188 )
{
return V_188 -> type == V_189 && V_188 -> V_3 == 1 ;
}
...
struct V_18 * V_19 = F_16 ( V_17 ) ;
if ( F_44 ( & V_191 -> V_188 ) ) {
V_191 -> V_192 = V_19 -> V_151 ;
V_191 -> V_193 = V_19 -> V_194 ;
}
return 0 ;
}
...
struct V_16 * V_17 ;
int V_199 ;
V_19 -> V_194 = F_11 ( V_2 , V_31 ) & 0xffff ;
V_19 -> V_151 = ( ( V_19 -> V_194 >> 4 ) == V_200 )
? V_201 : V_202 ;
V_19 -> V_78 = V_203 ;
V_19 -> V_80 = V_118 ;
V_19 -> V_178 = 48000 ;
...
F_50 ( V_17 , & V_204 ) ;
F_51 ( V_17 , V_2 ) ;
snprintf ( V_17 -> V_205 , sizeof( V_17 -> V_205 ) ,
L_123 , V_2 -> V_206 . V_205 , ( V_19 -> V_194 >> 4 ) ) ;
V_17 -> V_207 = V_208 ;
F_52 ( & V_19 -> V_42 , 9 ) ;
F_53 ( & V_19 -> V_42 , & V_209 ,
V_152 , 0 , 255 , 1 , 128 ) ;
F_53 ( & V_19 -> V_42 , & V_209 ,
V_153 , 0 , 127 , 1 , 64 ) ;
F_53 ( & V_19 -> V_42 , & V_209 ,
...
F_53 ( & V_19 -> V_42 , & V_209 ,
V_155 , - 128 , 127 , 1 , 0 ) ;
V_19 -> V_38 = F_53 ( & V_19 -> V_42 ,
& V_210 , V_211 ,
0 , 65535 , 65535 / 100 , 0 ) ;
F_53 ( & V_19 -> V_42 ,
& V_210 , V_212 ,
0 , 1 , 1 , 0 ) ;
F_53 ( & V_19 -> V_42 , & V_210 ,
V_213 ,
...
V_215 ,
0 , 65535 , 65535 / 100 , 32768 ) ;
V_17 -> V_216 = & V_19 -> V_42 ;
if ( V_19 -> V_42 . error ) {
int V_199 = V_19 -> V_42 . error ;
F_54 ( & V_19 -> V_42 ) ;
return V_199 ;
}
V_199 = F_55 ( & V_2 -> V_206 , V_17 ) ;
if ( V_199 )
F_54 ( & V_19 -> V_42 ) ;
else
F_14 ( V_2 ) ;
