...
F_48 ( & V_2 -> V_59 -> V_83 , V_76 ) ;
F_49 ( V_34 , V_6 -> V_12 , V_6 -> V_10 , V_6 -> V_13 ,
V_6 -> V_14 ) ;
F_50 ( V_2 , V_85 ) ;
return V_86 ;
}
int F_51 ( struct V_1 * V_2 , T_7 V_87 , T_7 V_73 , T_7 V_88 , T_7 V_89 )
{
T_1 V_90 ;
int V_34 ;
unsigned int V_33 = F_52 ( V_2 ) ;
unsigned int V_32 = F_46 ( V_2 ) ;
V_90 = F_44 ( V_2 , V_88 ) ;
if ( V_73 )
V_90 += F_44 ( V_2 , V_73 ) ;
V_34 = F_14 ( V_2 , V_90 , V_32 , V_33 ) ;
if ( V_89 ) {
T_1 V_91 = F_53 ( V_2 ) ;
if ( V_34 < 0 )
F_54 ( V_2 , V_91 & ~ 0x20000000 ) ;
else
F_54 ( V_2 , V_91 | 0x20000000 ) ;
}
F_55 ( V_2 , V_87 , V_34 ) ;
