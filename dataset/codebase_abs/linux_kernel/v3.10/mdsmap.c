...
V_2 -> V_6 [ V_30 ] . V_28 = V_28 ;
V_2 -> V_6 [ V_30 ] . V_7 = V_7 ;
V_2 -> V_6 [ V_30 ] . V_35 = V_35 ;
V_2 -> V_6 [ V_30 ] . V_41 =
( V_39 . V_42 != 0 ||
V_39 . V_43 != 0 ) ;
V_2 -> V_6 [ V_30 ] . V_36 = V_36 ;
if ( V_36 ) {
V_2 -> V_6 [ V_30 ] . V_44 =
F_11 ( V_36 , sizeof( V_18 ) ,
V_15 ) ;
for ( V_11 = 0 ; V_11 < V_36 ; V_11 ++ )
V_2 -> V_6 [ V_30 ] . V_44 [ V_11 ] =
F_9 ( & V_37 ) ;
} else {
V_2 -> V_6 [ V_30 ] . V_44 = NULL ;
}
}
}
F_15 ( V_8 , V_9 , V_3 , V_17 ) ;
V_2 -> V_45 = V_3 ;
V_2 -> V_46 = F_11 ( V_3 , sizeof( V_19 ) , V_15 ) ;
if ( ! V_2 -> V_46 )
goto V_27;
F_8 ( V_8 , V_9 , sizeof( V_19 ) * ( V_3 + 1 ) , V_17 ) ;
for ( V_4 = 0 ; V_4 < V_3 ; V_4 ++ )
V_2 -> V_46 [ V_4 ] = F_10 ( V_8 ) ;
V_2 -> V_47 = F_10 ( V_8 ) ;
F_16 ( L_3 , V_2 -> V_20 ) ;
return V_2 ;
V_27:
