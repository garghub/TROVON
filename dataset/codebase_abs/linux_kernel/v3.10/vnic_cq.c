...
void F_7 ( struct V_1 * V_2 , unsigned int V_14 ,
...
{
T_1 V_24 ;
V_24 = ( T_1 ) V_2 -> V_4 . V_25 | V_26 ;
F_8 ( V_24 , & V_2 -> V_5 -> V_27 ) ;
F_9 ( V_2 -> V_4 . V_8 , & V_2 -> V_5 -> V_28 ) ;
...
F_9 ( V_22 , & V_2 -> V_5 -> V_22 ) ;
F_8 ( V_23 , & V_2 -> V_5 -> V_23 ) ;
}
