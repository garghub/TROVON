...
static void F_34 ( void * V_86 , const void * V_87 )
{
...
memcpy ( V_90 . V_32 , V_89 -> V_32 , sizeof( V_90 . V_32 ) ) ;
memcpy ( V_86 , & V_90 , sizeof( V_90 ) ) ;
}
static int F_35 ( void T_5 * V_86 , const void * V_87 )
{
const struct V_30 * V_90 = V_87 ;
struct V_88 V_89 = {
. V_39 = V_90 -> V_39 ,
. V_40 = V_90 -> V_40 ,
. V_43 = V_90 -> V_43 ,
} ;
memcpy ( V_89 . V_32 , V_90 -> V_32 , sizeof( V_89 . V_32 ) ) ;
return F_36 ( V_86 , & V_89 , sizeof( V_89 ) ) ? - V_91 : 0 ;
}
static int T_6 F_37 ( struct V_2 * V_2 )
{
int V_92 ;
struct V_1 * V_4 = F_1 ( V_2 ) ;
struct V_93 V_94 = {
...
V_4 -> V_19 [ V_92 ] = V_92 ;
F_39 ( & V_4 -> V_7 [ V_92 ] . V_8 , F_8 ,
( unsigned long ) & V_4 -> V_19 [ V_92 ] ) ;
}
V_4 -> V_15 = F_40 ( V_2 , V_97 , & V_94 ) ;
if ( ! V_4 -> V_15 )
return - V_98 ;
if ( V_99 )
F_41 ( V_2 , V_100 , & V_101 ) ;
return 0 ;
}
