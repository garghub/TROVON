...
F_24 ( V_46 , V_55 + V_50 + 1 - V_46 -> V_60 ) ) {
V_55 = F_22 ( V_46 ) ;
...
F_24 ( V_46 , V_55 + V_50 + 4 - V_46 -> V_60 ) ) ) {
T_4 * V_70 = ( T_4 * ) V_54 ;
V_7 -> V_71 = V_70 [ ! ! V_47 ] ;
V_7 -> V_72 = V_70 [ ! V_47 ] ;
}
...
return;
case V_74 :
if ( ! V_49 && F_24 ( V_46 , V_55 + V_50 + 2 - V_46 -> V_60 ) ) {
T_3 * V_75 = ( T_3 * ) V_54 ;
V_7 -> V_76 = V_75 [ 0 ] ;
V_7 -> V_77 = V_75 [ 1 ] ;
}
...
#if F_26 ( V_78 )
case V_79 :
if ( ! V_49 && F_24 ( V_46 , V_55 + V_50 + 3 - V_46 -> V_60 ) ) {
struct V_80 * V_81 ;
...
static inline int F_27 ( struct V_88 * V_25 )
{
struct V_2 * V_2 = F_28 ( V_25 , struct V_2 , V_89 . V_90 ) ;
V_91 . V_92 ( V_2 ) ;
return F_29 ( V_25 ) > V_25 -> V_93 * 2 ;
}
...
static void F_31 ( struct V_1 * V_8 , struct V_94 * V_95 ,
struct V_45 * V_46 )
{
struct V_17 * V_18 = (struct V_17 * ) V_8 ;
struct V_1 * V_23 = V_18 -> V_34 ;
...
struct V_99 * V_100 = F_37 ( & V_18 -> V_31 . V_32 ) ;
F_38 ( V_100 ) ;
}
F_39 ( V_18 ) ;
}
...
static int T_7 F_49 ( struct V_2 * V_2 )
{
struct V_106 * V_107 ;
struct V_108 * V_52 ;
V_107 = V_109 ;
if ( ! F_50 ( V_2 , & V_110 ) ) {
V_107 = F_51 ( V_107 , sizeof( V_109 ) , V_111 ) ;
if ( ! V_107 )
goto V_112;
V_107 [ 0 ] . V_60 = & V_2 -> V_89 . V_90 . V_93 ;
}
V_52 = F_52 ( V_2 , L_1 , V_107 ) ;
if ( ! V_52 )
goto V_113;
...
static void T_8 F_54 ( struct V_2 * V_2 )
{
struct V_106 * V_107 ;
if ( V_2 -> V_21 . V_114 . V_115 == NULL )
return;
V_107 = V_2 -> V_21 . V_114 . V_115 -> V_117 ;
F_55 ( V_2 -> V_21 . V_114 . V_115 ) ;
if ( ! F_50 ( V_2 , & V_110 ) )
F_53 ( V_107 ) ;
}
int T_6 F_56 ( void )
