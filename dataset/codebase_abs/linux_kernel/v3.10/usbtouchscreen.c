...
V_2 -> V_35 = V_116 ;
if ( V_5 -> V_139 )
F_82 ( V_2 -> V_140 , V_5 -> V_139 , sizeof( V_2 -> V_140 ) ) ;
if ( V_5 -> V_141 ) {
if ( V_5 -> V_139 )
F_83 ( V_2 -> V_140 , L_16 , sizeof( V_2 -> V_140 ) ) ;
F_83 ( V_2 -> V_140 , V_5 -> V_141 , sizeof( V_2 -> V_140 ) ) ;
}
if ( ! strlen ( V_2 -> V_140 ) )
snprintf ( V_2 -> V_140 , sizeof( V_2 -> V_140 ) ,
L_17 ,
F_84 ( V_5 -> V_142 . V_143 ) ,
F_84 ( V_5 -> V_142 . V_144 ) ) ;
F_85 ( V_5 , V_2 -> V_145 , sizeof( V_2 -> V_145 ) ) ;
F_83 ( V_2 -> V_145 , L_18 , sizeof( V_2 -> V_145 ) ) ;
V_116 -> V_140 = V_2 -> V_140 ;
V_116 -> V_145 = V_2 -> V_145 ;
F_86 ( V_5 , & V_116 -> V_133 ) ;
V_116 -> V_8 . V_146 = & V_49 -> V_8 ;
F_87 ( V_116 , V_2 ) ;
V_116 -> V_147 = F_64 ;
V_116 -> V_148 = F_68 ;
V_116 -> V_149 [ 0 ] = F_88 ( V_150 ) | F_88 ( V_151 ) ;
V_116 -> V_152 [ F_89 ( V_94 ) ] = F_88 ( V_94 ) ;
F_19 ( V_116 , V_36 , type -> V_153 , type -> V_87 , 0 , 0 ) ;
F_19 ( V_116 , V_37 , type -> V_154 , type -> V_88 , 0 , 0 ) ;
if ( type -> V_96 )
F_19 ( V_116 , V_97 , type -> V_155 ,
type -> V_96 , 0 , 0 ) ;
if ( F_90 ( V_68 ) == V_156 )
F_91 ( V_2 -> V_118 , V_5 ,
F_92 ( V_5 , V_68 -> V_69 ) ,
