...
{
struct V_43 * V_15 = F_31 ( & V_2 -> V_15 ) ;
struct V_44 * V_45 = F_23 ( V_15 ) ;
F_26 ( & V_2 -> V_15 , NULL ) ;
F_32 ( V_15 ) ;
F_10 ( V_45 -> V_55 ) ;
F_29 ( V_15 -> V_47 ) ;
...
static int F_33 ( struct V_1 * V_2 , T_3 V_60 )
{
struct V_43 * V_15 = F_31 ( & V_2 -> V_15 ) ;
struct V_44 * V_45 = F_23 ( V_15 ) ;
struct V_61 * V_62 = (struct V_61 * ) V_45 -> V_55 ;
F_34 ( & V_63 , V_62 , sizeof( * V_62 ) ) ;
return 0 ;
}
...
V_62 -> V_69 = V_63 . V_69 ;
V_62 -> V_70 = V_63 . V_70 ;
F_37 ( & V_62 -> V_71 , ( void * ) & V_63 . V_71 ,
sizeof( * V_62 ) - F_38 ( struct V_61 , V_71 ) ) ;
V_62 -> V_64 &= ~ V_65 ;
V_62 -> V_72 = V_63 . V_72 ;
V_62 -> V_73 = V_63 . V_73 ;
V_62 -> V_74 = V_63 . V_74 ;
