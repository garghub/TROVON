...
static void F_50 ( struct V_56 * V_57 , struct V_18 * V_19 )
{
struct V_1 * V_2 =
F_21 ( V_19 , struct V_1 , V_19 ) ;
...
V_66 = 1 << V_52 ;
V_67 = ! ( V_59 & V_66 ) ;
F_52 ( V_57 , L_1 , V_19 -> V_21 + V_52 , V_65 ) ;
if ( V_67 ) {
F_52 ( V_57 , L_2 ,
V_58 & V_66 ? L_3 : L_4 ,
V_60 & V_66 ? L_5 : L_6 ) ;
...
if ( V_64 & V_66 )
F_52 ( V_57 , L_10 ) ;
F_52 ( V_57 , L_11 , V_51 & V_66 ? L_12 : L_13 ) ;
}
}
...
int V_10 ;
int V_52 , V_9 , V_80 ;
V_71 = F_54 ( V_81 , & V_69 -> V_74 ) ;
if ( V_71 )
V_10 = ( int ) V_71 -> V_82 ;
else
V_10 = V_11 ;
V_77 = F_55 ( V_69 , V_83 , 0 ) ;
if ( ! V_77 ) {
F_56 ( & V_69 -> V_74 , L_14 ) ;
return - V_84 ;
}
V_2 = F_57 ( & V_69 -> V_74 , sizeof( struct V_1 ) , V_85 ) ;
if ( ! V_2 ) {
F_56 ( & V_69 -> V_74 , L_15 ) ;
return - V_86 ;
}
if ( F_58 ( V_69 -> V_74 . V_75 , L_16 , & V_79 ) ) {
F_56 ( & V_69 -> V_74 , L_17 ) ;
return - V_84 ;
}
V_80 = F_59 ( V_69 -> V_74 . V_75 , L_18 ) ;
if ( V_80 < 0 ) {
F_56 ( & V_69 -> V_74 , L_19 ) ;
return V_80 ;
}
V_78 = F_60 ( & V_69 -> V_74 , NULL ) ;
if ( ! F_61 ( V_78 ) )
F_62 ( V_78 ) ;
V_2 -> V_10 = V_10 ;
V_2 -> V_19 . V_65 = F_63 ( & V_69 -> V_74 ) ;
...
V_2 -> V_19 . V_91 = F_20 ;
V_2 -> V_19 . V_92 = F_32 ;
V_2 -> V_19 . V_21 = V_80 * V_93 ;
V_2 -> V_19 . V_53 = V_79 ;
V_2 -> V_19 . V_94 = 0 ;
V_2 -> V_19 . V_75 = V_73 ;
V_2 -> V_19 . V_95 = F_50 ;
F_64 ( & V_2 -> V_25 ) ;
V_2 -> V_3 = F_65 ( & V_69 -> V_74 , V_77 ) ;
if ( F_61 ( V_2 -> V_3 ) )
return F_66 ( V_2 -> V_3 ) ;
if ( V_10 == V_14 ) {
V_77 = F_55 ( V_69 , V_83 , 1 ) ;
V_2 -> V_15 = F_65 ( & V_69 -> V_74 ,
V_77 ) ;
if ( F_61 ( V_2 -> V_15 ) )
...
V_2 -> V_54 = F_72 ( - 1 , 0 , V_79 , - 1 ) ;
if ( V_2 -> V_54 < 0 ) {
F_56 ( & V_69 -> V_74 , L_20 ) ;
return - V_86 ;
}
V_31 = F_73 ( L_21 , 2 , V_2 -> V_54 ,
V_2 -> V_3 , V_96 ) ;
if ( ! V_31 ) {
F_56 ( & V_69 -> V_74 , L_22 ) ;
return - V_86 ;
...
V_38 -> V_103 = V_104 ;
V_38 -> V_19 . V_101 = V_2 -> V_19 . V_65 ;
F_74 ( V_31 , F_75 ( V_79 ) , 0 ,
V_105 , V_106 | V_107 ) ;
V_2 -> V_27 = F_76 ( V_73 , V_2 -> V_19 . V_53 ,
V_2 -> V_54 ,
& V_108 ,
V_2 ) ;
if ( ! V_2 -> V_27 ) {
