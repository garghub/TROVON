...
F_55 ( V_24 ) ) ;
if ( * V_73 <= V_98 ) {
if ( V_96 ( V_95 , L_1 , 1 , V_98 & 0x7fffffff , V_15 -> V_66 , V_100 ) ) {
...
if ( * V_73 <= V_99 ) {
V_9 = F_7 ( V_42 ) ;
if ( V_96 ( V_95 , L_2 , 2 , V_99 & 0x7fffffff , V_9 , V_100 ) ) {
...
V_97 & 0x7fffffff , V_9 , V_101 ) ) {
* V_73 = V_97 & 0x7fffffff ;
return 0 ;
}
V_12 = F_29 ( V_42 , V_12 ) ;
}
* V_73 = F_53 ( V_24 , V_24 -> V_47 + 1 , 0 ) &
0x7fffffff ;
return 0 ;
}
int
...
V_6 ++ , V_12 = F_29 ( V_42 , V_12 ) ) {
V_103 = V_15 -> V_26 -> V_108 -> V_109 ( args , V_12 -> V_13 ,
V_12 -> V_14 ) ;
...
ASSERT ( args -> V_78 & V_111 ) ;
if ( ! V_104 )
return F_39 ( V_76 ) ;
error = F_57 ( args , V_104 -> V_13 , V_104 -> V_14 ) ;
return F_39 ( error ) ;
}
int
F_58 (
...
V_15 = args -> V_15 ;
ASSERT ( V_15 -> V_50 . V_51 & V_53 ) ;
V_114 = ( int ) V_15 -> V_54 . V_62 ;
if ( V_114 < F_37 ( T_5 , V_10 ) ) {
ASSERT ( F_38 ( V_15 -> V_26 ) ) ;
return F_39 ( V_77 ) ;
}
ASSERT ( V_15 -> V_50 . V_57 == V_114 ) ;
ASSERT ( V_15 -> V_50 . V_60 . V_61 != NULL ) ;
V_42 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
ASSERT ( V_114 >= F_18 ( V_42 -> V_4 ) ) ;
for ( V_6 = 0 , V_12 = F_26 ( V_42 ) ; V_6 < V_42 -> V_20 ;
V_6 ++ , V_12 = F_29 ( V_42 , V_12 ) ) {
if ( F_60 ( args , V_12 -> V_13 , V_12 -> V_14 ) ==
V_106 ) {
...
return F_39 ( V_76 ) ;
V_81 = ( int ) ( ( char * ) V_12 - ( char * ) V_42 ) ;
V_112 = F_40 ( V_42 , args -> V_14 ) ;
V_113 = V_114 - V_112 ;
if ( V_81 + V_112 < V_114 )
memmove ( ( char * ) V_42 + V_81 , ( char * ) V_42 + V_81 + V_112 ,
V_114 - ( V_81 + V_112 ) ) ;
V_42 -> V_20 -- ;
V_15 -> V_54 . V_62 = V_113 ;
F_24 ( V_15 , V_113 - V_114 , V_58 ) ;
V_42 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
#if V_29
if ( args -> V_30 > V_31 ) {
if ( V_42 -> V_4 == 1 )
...
F_66 ( args ) ;
V_15 = args -> V_15 ;
V_114 = V_15 -> V_50 . V_57 ;
V_83 = F_22 ( V_114 , V_44 ) ;
V_88 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
ASSERT ( V_88 -> V_4 == 1 ) ;
memcpy ( V_83 , V_88 , V_114 ) ;
V_113 =
V_114 -
( V_88 -> V_20 + 1 ) *
( ( V_32 ) sizeof( V_34 ) - ( V_32 ) sizeof( V_35 ) ) ;
F_24 ( V_15 , - V_114 , V_58 ) ;
F_24 ( V_15 , V_113 , V_58 ) ;
V_88 = ( T_5 * ) V_83 ;
V_42 = ( T_5 * ) V_15 -> V_50 . V_60 . V_61 ;
V_42 -> V_20 = V_88 -> V_20 ;
V_42 -> V_4 = 0 ;
