...
static void F_140 ( struct V_278 * V_21 , struct V_281 * V_303 )
{
}
...
{
struct V_304 * V_305 ;
V_305 = F_142 ( V_298 , V_306 , L_20 ) ;
if ( ! V_305 ) {
F_17 ( & V_298 -> V_299 , L_21 ) ;
return - V_111 ;
}
V_1 -> V_301 = F_143 ( V_305 -> V_307 , F_144 ( V_305 ) ) ;
if ( V_1 -> V_301 == NULL ) {
...
V_5 = F_143 ( V_305 -> V_307 , F_144 ( V_305 ) ) ;
if ( V_5 == NULL ) {
V_31 = - V_81 ;
...
F_147 ( & V_1 -> V_14 ) ;
F_148 ( & V_298 -> V_299 , V_1 ) ;
V_1 -> V_46 = V_298 -> V_299 . V_314 ;
V_1 -> V_160 = V_310 == V_315 ;
V_1 -> V_15 . V_316 = & V_317 ;
V_1 -> V_15 . V_291 = V_231 ;
V_1 -> V_15 . V_318 = V_319 ;
F_149 ( & V_1 -> V_272 ) ;
V_1 -> V_272 . V_320 = F_109 ;
V_1 -> V_272 . V_321 = ( unsigned long ) V_1 ;
V_1 -> V_5 = V_5 ;
if ( V_1 -> V_46 -> V_47 ) {
snprintf ( V_308 , sizeof( V_308 ) , L_27 , V_298 -> V_322 ) ;
V_1 -> V_302 = F_150 ( & V_298 -> V_299 , V_308 ) ;
if ( F_151 ( V_1 -> V_302 ) ) {
F_17 ( & V_298 -> V_299 , L_28 ,
V_308 ) ;
V_31 = F_152 ( V_1 -> V_302 ) ;
goto V_311;
}
F_153 ( V_1 -> V_302 ) ;
}
...
F_12 ( V_1 ) ;
V_31 = F_154 ( V_255 , F_106 , V_324 ,
V_319 , V_1 ) ;
if ( V_31 < 0 ) {
F_17 ( & V_298 -> V_299 , L_29 , V_31 ) ;
goto V_323;
}
F_14 ( & V_1 -> V_15 . V_325 ) ;
V_1 -> V_15 . V_214 = & V_1 -> V_21 [ 0 ] . V_21 ;
F_14 ( & V_1 -> V_15 . V_214 -> V_325 ) ;
for ( V_54 = 0 ; V_54 < V_27 ; V_54 ++ ) {
struct V_57 * V_21 = & V_1 -> V_21 [ V_54 ] ;
if ( V_54 != 0 ) {
F_14 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_325 ) ;
F_119 ( & V_1 -> V_21 [ V_54 ] . V_21 . V_325 ,
& V_1 -> V_15 . V_325 ) ;
}
V_21 -> V_1 = V_1 ;
F_14 ( & V_21 -> V_22 ) ;
V_21 -> V_21 . V_318 = V_326 [ V_54 ] ;
V_21 -> V_21 . V_316 = & V_327 ;
V_21 -> V_21 . V_82 = 512 ;
}
...
V_31 = F_155 ( & V_298 -> V_299 , & V_1 -> V_15 ) ;
if ( V_31 )
goto V_329;
F_156 ( & V_298 -> V_299 , L_30 , V_330 ) ;
return 0 ;
V_329:
F_117 ( & V_1 -> V_21 [ 0 ] . V_21 , V_1 -> V_213 ) ;
V_328:
