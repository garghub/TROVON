...
struct V_3 * V_4 ;
T_9 V_211 ;
V_4 = V_363 -> V_359 . V_364 ;
V_20 -> V_51 = V_4 -> V_51 ;
V_20 -> V_234 = F_56 ( sizeof( struct V_14 ) * V_20 -> V_269 , V_365 ) ;
if ( ! V_20 -> V_234 ) {
F_36 ( L_111 ) ;
return - 1 ;
}
...
if ( V_211 < V_366 )
V_211 = V_366 ;
else if ( ( V_211 % V_366 ) != 0 ) {
V_211 += V_366 + 1 ;
V_211 &= ~ ( V_366 - 1 ) ;
}
V_20 -> V_83 = F_124 ( & V_363 -> V_359 , V_211 ,
& V_20 -> V_80 , V_365 ) ;
if ( ! V_20 -> V_83 ) {
F_36 ( L_112 ) ;
F_59 ( V_20 -> V_234 ) ;
...
V_20 -> V_361 = V_211 ;
V_20 -> V_231 = F_49 ( F_55 ( NULL , V_365 ) ,
struct V_16 , V_17 ) ;
V_20 -> V_231 -> V_17 . V_199 = F_125 ( 8 , V_365 ) ;
V_20 -> V_320 = V_367 ;
V_20 -> V_241 = V_368 ;
V_20 -> V_210 = 0 ;
V_20 -> V_220 = 0 ;
...
static int T_8 F_126 ( struct V_19 * V_20 , unsigned char V_239 ,
char * V_35 , int V_369 )
{
...
F_57 ( & V_15 -> V_26 ) ;
if ( V_369 )
F_73 ( & V_15 -> V_15 . V_372 , & V_20 -> V_33 . V_372 ) ;
V_15 -> V_33 = & V_20 -> V_33 ;
V_15 -> V_163 = & V_20 -> V_83 [ V_239 ] ;
return 0 ;
}
static int T_8 F_127 ( struct V_362 * V_363 )
{
struct V_3 * V_4 ;
struct V_373 * V_374 ;
int V_198 = - V_212 ;
unsigned int V_304 ;
T_1 V_84 ;
V_9 = F_56 ( sizeof( struct V_19 ) , V_365 ) ;
if ( V_9 == NULL ) {
F_36 ( L_113 ) ;
return - V_196 ;
}
...
#endif
V_374 = F_131 ( V_363 , V_379 , 0 ) ;
if ( ! V_374 ) {
V_198 = - V_380 ;
goto V_378;
}
if ( V_4 -> V_375 == V_381 ) {
if ( ! F_132 ( V_374 -> V_382 , F_133 ( V_374 ) ,
V_352 ) ) {
...
V_47 = F_134 ( V_374 -> V_382 , F_133 ( V_374 ) ) ;
if ( ! V_47 ) {
V_198 = - V_196 ;
goto V_384;
}
V_4 -> V_385 = ( void * ) V_47 ;
if ( V_4 -> V_386 && V_4 -> V_386 ( V_363 ) ) {
V_198 = - V_212 ;
goto V_387;
}
F_9 ( V_4 ) ;
...
V_9 -> V_269 = ( V_84 & V_391 ) * 2 ;
V_9 -> V_329 = F_136 ( V_363 , 0 ) ;
if ( ! V_9 -> V_329 ) {
V_198 = - V_212 ;
goto V_390;
}
V_198 = F_137 ( V_9 -> V_329 , F_111 , V_392 ,
V_352 , V_9 ) ;
if ( V_198 != 0 ) {
F_36 ( L_117 ,
V_9 -> V_329 , V_198 ) ;
...
if ( V_198 )
goto V_393;
V_9 -> V_33 . V_370 = & V_394 ;
V_9 -> V_33 . V_395 = V_313 ;
V_9 -> V_33 . V_280 = & V_9 -> V_234 [ 0 ] . V_15 ;
F_57 ( & V_9 -> V_33 . V_372 ) ;
V_9 -> V_33 . V_149 = V_150 ;
V_9 -> V_33 . V_35 = V_352 ;
F_139 ( & V_9 -> V_33 . V_359 , L_119 ) ;
V_9 -> V_33 . V_359 . V_396 = V_363 -> V_359 . V_396 ;
if ( ! F_84 ( V_9 -> V_228 ) )
V_9 -> V_33 . V_106 = 1 ;
F_47 ( V_9 ) ;
F_126 ( V_9 , 0 , L_120 , 0 ) ;
V_9 -> V_234 [ 0 ] . V_15 . V_142 = & V_397 ;
V_9 -> V_234 [ 0 ] . V_15 . V_153 = V_137 ;
for ( V_304 = 1 ; V_304 < ( int ) ( V_9 -> V_269 / 2 ) ; V_304 ++ ) {
char V_35 [ 14 ] ;
sprintf ( V_35 , L_121 , V_304 ) ;
F_126 ( V_9 , V_304 * 2 , V_35 , 1 ) ;
sprintf ( V_35 , L_122 , V_304 ) ;
F_126 ( V_9 , V_304 * 2 + 1 , V_35 , 1 ) ;
}
V_9 -> V_31 = F_140 ( L_123 , & V_363 -> V_359 ,
sizeof( struct V_22 ) ,
V_398 , V_399 ) ;
if ( V_9 -> V_31 == NULL ) {
V_198 = - V_196 ;
...
V_198 = F_141 ( & V_363 -> V_359 , & V_9 -> V_33 ,
F_121 ) ;
if ( V_198 )
goto V_400;
F_142 () ;
...
V_384:
if ( V_4 -> V_375 == V_381 )
F_147 ( V_374 -> V_382 , F_133 ( V_374 ) ) ;
V_378:
F_59 ( V_9 ) ;
V_9 = NULL ;
return V_198 ;
}
static int T_10 F_148 ( struct V_362 * V_363 )
{
struct V_373 * V_374 = F_131 ( V_363 , V_379 , 0 ) ;
struct V_3 * V_4 = V_363 -> V_359 . V_364 ;
F_149 ( F_16 ) ;
if ( ! V_9 )
return - V_212 ;
F_150 ( & V_9 -> V_33 ) ;
...
static int F_153 ( struct V_362 * V_363 , T_11 V_401 )
{
F_41 ( V_9 ) ;
return 0 ;
}
static int F_154 ( struct V_362 * V_363 )
{
if ( V_9 -> V_21 ) {
F_28 ( V_9 ) ;
F_40 ( V_9 ) ;
...
static int F_155 ( struct V_358 * V_359 , T_11 V_401 )
{
struct V_19 * V_20 = V_9 ;
T_1 V_402 , V_68 ;
V_402 = F_30 ( & V_47 -> V_73 ) & V_74 ;
F_42 ( L_124 , V_105 , V_402 , V_20 -> V_21 ) ;
if ( V_20 -> V_21 ) {
F_42 ( L_125 ) ;
V_20 -> V_403 = 1 ;
return 0 ;
...
static int F_157 ( struct V_358 * V_359 )
{
F_42 ( L_128 , V_105 ,
V_9 -> V_21 , V_9 -> V_403 ) ;
if ( V_9 -> V_403 ) {
