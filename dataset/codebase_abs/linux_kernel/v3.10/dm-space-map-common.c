...
int F_32 ( struct V_35 * V_36 , T_4 V_4 , V_48 * V_33 )
{
V_11 V_72 ;
...
int F_34 ( struct V_35 * V_36 , T_4 V_31 ,
T_4 V_32 , T_4 * V_33 )
{
int V_57 ;
struct V_43 V_69 ;
...
V_57 = F_20 ( F_13 ( V_70 ) ,
F_35 ( unsigned , V_31 , F_10 ( V_69 . V_66 ) ) ,
V_76 , & V_75 ) ;
if ( V_57 == - V_34 ) {
F_28 ( V_36 -> V_38 , V_70 ) ;
continue;
...
int F_36 ( struct V_35 * V_36 , T_4 V_4 ,
V_48 V_77 , enum V_78 * V_79 )
{
int V_57 ;
V_48 V_80 , V_81 ;
struct V_3 * V_82 ;
...
void * V_83 ;
int V_44 ;
V_80 = F_30 ( V_68 , V_36 -> V_50 ) ;
V_57 = V_36 -> V_71 ( V_36 , V_68 , & V_69 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_37 ( V_36 -> V_38 , F_8 ( V_69 . V_8 ) ,
& V_64 , & V_82 , & V_44 ) ;
if ( V_57 < 0 ) {
F_24 ( L_7 ) ;
return V_57 ;
}
V_69 . V_8 = F_3 ( F_4 ( V_82 ) ) ;
V_83 = F_13 ( V_82 ) ;
V_81 = F_15 ( V_83 , V_80 ) ;
if ( V_77 <= 2 ) {
F_17 ( V_83 , V_80 , V_77 ) ;
V_57 = F_28 ( V_36 -> V_38 , V_82 ) ;
if ( V_57 < 0 )
return V_57 ;
if ( V_81 > 2 ) {
V_57 = F_38 ( & V_36 -> V_47 ,
...
V_36 -> V_85 ++ ;
F_41 ( & V_69 . V_65 , - 1 ) ;
if ( F_10 ( V_69 . V_66 ) == V_80 )
V_69 . V_66 = F_5 ( V_80 + 1 ) ;
} else if ( V_81 && ! V_77 ) {
* V_79 = V_86 ;
V_36 -> V_85 -- ;
F_41 ( & V_69 . V_65 , 1 ) ;
V_69 . V_66 = F_5 ( F_42 ( F_10 ( V_69 . V_66 ) , V_80 ) ) ;
}
return V_36 -> V_67 ( V_36 , V_68 , & V_69 ) ;
}
int F_43 ( struct V_35 * V_36 , T_4 V_4 , enum V_78 * V_79 )
{
int V_57 ;
V_48 V_87 ;
V_57 = F_32 ( V_36 , V_4 , & V_87 ) ;
if ( V_57 )
return V_57 ;
return F_36 ( V_36 , V_4 , V_87 + 1 , V_79 ) ;
}
int F_44 ( struct V_35 * V_36 , T_4 V_4 , enum V_78 * V_79 )
{
int V_57 ;
V_48 V_87 ;
V_57 = F_32 ( V_36 , V_4 , & V_87 ) ;
...
static int F_46 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
memcpy ( V_89 , V_36 -> V_7 . V_68 + V_68 , sizeof( * V_89 ) ) ;
return 0 ;
}
static int F_47 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
V_36 -> V_55 = true ;
memcpy ( V_36 -> V_7 . V_68 + V_68 , V_89 , sizeof( * V_89 ) ) ;
return 0 ;
}
...
if ( V_57 )
return V_57 ;
memcpy ( & V_36 -> V_7 , F_2 ( V_91 ) , sizeof( V_36 -> V_7 ) ) ;
return F_28 ( V_36 -> V_38 , V_91 ) ;
}
static T_4 F_50 ( struct V_35 * V_36 )
{
return V_92 ;
}
...
int V_57 , V_44 ;
struct V_3 * V_4 ;
V_57 = F_37 ( V_36 -> V_38 , V_36 -> V_53 , & V_90 , & V_4 , & V_44 ) ;
if ( V_57 )
return V_57 ;
memcpy ( F_2 ( V_4 ) , & V_36 -> V_7 , sizeof( V_36 -> V_7 ) ) ;
V_36 -> V_53 = F_4 ( V_4 ) ;
...
int F_52 ( struct V_35 * V_36 , struct V_37 * V_38 )
{
int V_57 ;
V_57 = F_21 ( V_36 , V_38 ) ;
if ( V_57 < 0 )
...
if ( V_57 < 0 )
return V_57 ;
V_57 = F_53 ( & V_36 -> V_47 , & V_36 -> V_54 ) ;
if ( V_57 < 0 )
return V_57 ;
return 0 ;
}
int F_54 ( struct V_35 * V_36 , struct V_37 * V_38 ,
void * V_95 , T_1 V_96 )
{
int V_57 ;
struct V_97 * V_98 = V_95 ;
if ( V_96 < sizeof( struct V_97 ) ) {
F_24 ( L_9 ) ;
return - V_99 ;
}
V_57 = F_21 ( V_36 , V_38 ) ;
...
V_36 -> V_62 = F_50 ;
V_36 -> V_88 = F_51 ;
V_36 -> V_52 = F_8 ( V_98 -> V_52 ) ;
V_36 -> V_85 = F_8 ( V_98 -> V_85 ) ;
V_36 -> V_53 = F_8 ( V_98 -> V_53 ) ;
V_36 -> V_54 = F_8 ( V_98 -> V_54 ) ;
return V_36 -> V_94 ( V_36 ) ;
}
static int F_55 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
return F_33 ( & V_36 -> V_39 , V_36 -> V_53 , & V_68 , V_89 ) ;
}
static int F_56 ( struct V_35 * V_36 , T_4 V_68 ,
struct V_43 * V_89 )
{
F_39 ( V_89 ) ;
return F_40 ( & V_36 -> V_39 , V_36 -> V_53 ,
& V_68 , V_89 , & V_36 -> V_53 ) ;
}
static int F_57 ( struct V_35 * V_36 )
{
return F_53 ( & V_36 -> V_39 , & V_36 -> V_53 ) ;
}
...
int F_61 ( struct V_35 * V_36 , struct V_37 * V_38 )
{
int V_57 ;
V_57 = F_21 ( V_36 , V_38 ) ;
if ( V_57 < 0 )
...
int F_62 ( struct V_35 * V_36 , struct V_37 * V_38 ,
void * V_95 , T_1 V_96 )
{
int V_57 ;
struct V_97 * V_98 = V_95 ;
