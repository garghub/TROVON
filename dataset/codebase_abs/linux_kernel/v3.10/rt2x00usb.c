...
{
struct V_107 * V_108 = F_75 ( V_2 -> V_12 ) ;
...
static void F_82 ( struct V_56 * V_57 )
{
struct V_1 * V_2 = V_57 -> V_2 ;
struct V_69 * V_70 ;
struct V_94 * V_95 ;
...
{
V_2 -> V_22 . V_23 = F_88 ( V_24 , V_85 ) ;
if ( ! V_2 -> V_22 . V_23 )
goto exit;
V_2 -> V_120 = F_88 ( V_2 -> V_61 -> V_121 , V_85 ) ;
if ( ! V_2 -> V_120 )
goto exit;
V_2 -> V_119 = F_88 ( V_2 -> V_61 -> V_122 , V_85 ) ;
if ( ! V_2 -> V_119 )
goto exit;
return 0 ;
exit:
...
int F_90 ( struct V_107 * V_123 ,
const struct V_124 * V_61 )
{
struct V_10 * V_11 = F_91 ( V_123 ) ;
struct V_125 * V_126 ;
struct V_1 * V_2 ;
int V_127 ;
V_11 = F_92 ( V_11 ) ;
...
int F_105 ( struct V_107 * V_123 , T_4 V_136 )
{
struct V_125 * V_126 = F_103 ( V_123 ) ;
struct V_1 * V_2 = V_126 -> V_129 ;
return F_106 ( V_2 , V_136 ) ;
}
int F_107 ( struct V_107 * V_123 )
{
struct V_125 * V_126 = F_103 ( V_123 ) ;
struct V_1 * V_2 = V_126 -> V_129 ;
return F_108 ( V_2 ) ;
