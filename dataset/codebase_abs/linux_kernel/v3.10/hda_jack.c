...
! F_1 ( V_2 , V_3 ) ;
if ( V_73 ) {
F_39 ( V_62 , V_73 , sizeof( V_62 ) ) ;
V_63 = 0 ;
} else
F_40 ( V_2 , V_3 , V_72 , V_62 , sizeof( V_62 ) , & V_63 ) ;
if ( V_28 )
...
const T_1 * V_77 ;
int V_21 , V_65 ;
for ( V_21 = 0 ; V_21 < V_72 -> V_78 ; V_21 ++ ) {
if ( V_72 -> V_79 [ V_21 ] . V_80 ) {
if ( F_42 ( V_72 ) == 1 )
V_65 = F_37 ( V_2 , F_43 ( V_72 ) [ 0 ] ,
V_72 , L_3 ) ;
else
V_65 = F_37 ( V_2 , V_72 -> V_79 [ V_21 ] . V_81 ,
V_72 , L_3 ) ;
} else
V_65 = F_37 ( V_2 , V_72 -> V_79 [ V_21 ] . V_81 , V_72 ,
NULL ) ;
if ( V_65 < 0 )
return V_65 ;
}
for ( V_21 = 0 , V_77 = V_72 -> V_82 ; V_21 < V_72 -> V_83 ; V_21 ++ , V_77 ++ ) {
V_65 = F_37 ( V_2 , * V_77 , V_72 , NULL ) ;
if ( V_65 < 0 )
return V_65 ;
}
for ( V_21 = 0 , V_77 = V_72 -> V_84 ; V_21 < V_72 -> V_85 ; V_21 ++ , V_77 ++ ) {
if ( * V_77 == * V_72 -> V_82 )
break;
V_65 = F_37 ( V_2 , * V_77 , V_72 , NULL ) ;
if ( V_65 < 0 )
...
for ( V_21 = 0 , V_77 = V_72 -> V_86 ; V_21 < V_72 -> V_87 ; V_21 ++ , V_77 ++ ) {
if ( * V_77 == * V_72 -> V_82 )
break;
V_65 = F_37 ( V_2 , * V_77 , V_72 , NULL ) ;
if ( V_65 < 0 )
...
for ( V_21 = 0 , V_77 = V_72 -> V_88 ; V_21 < V_72 -> V_89 ; V_21 ++ , V_77 ++ ) {
V_65 = F_37 ( V_2 , * V_77 , V_72 , NULL ) ;
if ( V_65 < 0 )
return V_65 ;
}
V_65 = F_37 ( V_2 , V_72 -> V_90 , V_72 , NULL ) ;
if ( V_65 < 0 )
return V_65 ;
V_65 = F_37 ( V_2 , V_72 -> V_91 , V_72 , NULL ) ;
if ( V_65 < 0 )
return V_65 ;
return 0 ;
}
...
void F_45 ( struct V_1 * V_2 , unsigned int V_92 )
{
struct V_17 * V_93 ;
