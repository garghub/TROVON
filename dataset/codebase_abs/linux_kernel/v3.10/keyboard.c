...
if ( V_155 [ V_45 ] . V_156 ) {
if ( * V_155 [ V_45 ] . V_157 & V_155 [ V_45 ] . V_158 )
V_152 |= ( 1 << V_45 ) ;
else
V_152 &= ~ ( 1 << V_45 ) ;
}
...
{
struct V_144 * V_66 = V_151 + V_165 ;
int V_167 ;
unsigned long V_12 ;
F_34 ( & V_146 , V_12 ) ;
V_167 = F_91 ( V_66 , V_166 ) ;
F_35 ( & V_146 , V_12 ) ;
return V_167 ;
}
...
V_186 . V_194 = V_184 = ( V_50 | V_66 -> V_134 ) ^ V_66 -> V_133 ;
V_186 . V_143 = V_66 -> V_153 ;
V_182 = V_54 [ V_184 ] ;
V_187 = F_125 ( & V_3 ,
V_195 , & V_186 ) ;
...
if ( V_187 == V_196 )
return;
if ( ( V_183 || V_66 -> V_67 == V_97 ) && type != V_206 && type != V_55 )
return;
...
for ( V_45 = V_217 ; V_45 < V_191 ; V_45 ++ )
if ( F_14 ( V_45 , V_9 -> V_218 ) )
return true ;
for ( V_45 = V_199 ; V_45 <= V_219 ; V_45 ++ )
if ( F_14 ( V_45 , V_9 -> V_218 ) )
return true ;
}
return false ;
...
V_151 [ V_45 ] . V_153 = F_1 () ;
V_151 [ V_45 ] . V_227 = F_1 () ;
V_151 [ V_45 ] . V_148 = V_150 ;
V_151 [ V_45 ] . V_133 = V_228 ;
V_151 [ V_45 ] . V_134 = 0 ;
V_151 [ V_45 ] . V_229 = V_230 ;
V_151 [ V_45 ] . V_67 = V_231 ? V_68 : V_232 ;
}
error = F_145 ( & V_16 ) ;
if ( error )
return error ;
...
struct V_240 * V_60 ;
int V_45 ;
V_60 = F_147 ( V_241 * sizeof( struct V_240 ) ,
V_222 ) ;
if ( V_60 == NULL )
return - V_223 ;
F_34 ( & V_59 , V_12 ) ;
V_238 = V_62 ;
for ( V_45 = 0 ; V_45 < V_238 ; V_45 ++ ) {
V_60 [ V_45 ] . V_60 = F_37 (
V_63 [ V_45 ] . V_60 ) ;
V_60 [ V_45 ] . V_64 = F_37 (
V_63 [ V_45 ] . V_64 ) ;
...
V_167 = - V_243 ;
else if ( F_149 ( V_237 -> V_240 , V_60 ,
...
void * V_43 ;
V_43 = F_147 ( V_241 * sizeof( struct V_246 ) ,
V_222 ) ;
if ( V_43 == NULL )
return - V_223 ;
F_34 ( & V_59 , V_12 ) ;
V_238 = V_62 ;
memcpy ( V_43 , V_63 , V_238 * sizeof( struct V_246 ) ) ;
F_35 ( & V_59 , V_12 ) ;
if ( F_148 ( V_238 , & V_237 -> V_242 ) )
V_167 = - V_243 ;
else if ( F_149 ( V_237 -> V_246 , V_43 ,
...
return - V_250 ;
if ( V_248 ) {
V_60 = F_147 ( sizeof( struct V_240 ) * V_248 ,
V_222 ) ;
if ( V_60 == NULL )
return - V_223 ;
if ( F_151 ( V_60 , V_237 -> V_240 ,
...
return - V_250 ;
if ( V_248 ) {
V_43 = F_147 ( V_248 * sizeof( struct V_246 ) ,
V_222 ) ;
if ( V_43 == NULL )
return - V_223 ;
if ( F_151 ( V_43 , V_237 -> V_246 ,
...
V_182 = V_54 [ V_272 ] ;
if ( V_182 ) {
V_49 = F_30 ( V_182 [ V_45 ] ) ;
if ( V_66 -> V_67 != V_68 && F_31 ( V_49 ) >= V_273 )
V_49 = V_274 ;
} else
V_49 = ( V_45 ? V_274 : V_275 ) ;
F_35 ( & V_59 , V_12 ) ;
return F_148 ( V_49 , & V_267 -> V_276 ) ;
case V_277 :
if ( ! V_235 )
return - V_249 ;
if ( ! V_45 && V_278 == V_275 ) {
...
V_182 = V_268 ;
V_182 [ 0 ] = F_30 ( V_279 ) ;
for ( V_46 = 1 ; V_46 < V_198 ; V_46 ++ )
V_182 [ V_46 ] = F_30 ( V_274 ) ;
V_280 ++ ;
} else
F_138 ( V_268 ) ;
V_269 = F_30 ( V_182 [ V_45 ] ) ;
if ( V_278 == V_269 )
goto V_287;
...
V_182 [ V_45 ] = F_30 ( V_278 ) ;
if ( ! V_272 && ( F_31 ( V_269 ) == V_55 || F_31 ( V_278 ) == V_55 ) )
F_28 () ;
V_287:
F_35 ( & V_59 , V_12 ) ;
break;
...
for ( V_46 = V_45 + 1 ; V_46 < V_308 && ! V_101 [ V_46 ] ; V_46 ++ )
;
if ( V_46 < V_308 )
V_297 = V_101 [ V_46 ] ;
else
...
if ( V_101 [ V_47 ] )
V_101 [ V_47 ] = V_298 + ( V_101 [ V_47 ] - V_305 ) ;
if ( V_296 > V_297 ) {
memmove ( V_298 + ( V_297 - V_305 ) + V_295 , V_297 , V_296 - V_297 ) ;
for ( V_47 = V_46 ; V_47 < V_308 ; V_47 ++ )
if ( V_101 [ V_47 ] )
V_101 [ V_47 ] = V_298 + ( V_101 [ V_47 ] - V_305 ) + V_295 ;
}
if ( V_305 != V_309 )
F_138 ( V_305 ) ;
V_305 = V_298 ;
...
{
struct V_144 * V_66 = V_151 + V_165 ;
return F_39 ( V_66 , V_132 ) ? V_259 : V_258 ;
}
void F_164 ( int V_165 )
{
unsigned long V_12 ;
F_34 ( & V_59 , V_12 ) ;
V_151 [ V_165 ] . V_67 = V_231 ? V_68 : V_232 ;
F_35 ( & V_59 , V_12 ) ;
}
int F_165 ( void )
{
