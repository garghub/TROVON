...
if ( V_2 -> V_9 ) {
unsigned int V_10 = F_4 ( 255 , V_2 -> V_9 ) ;
V_3 [ 2 ] = F_4 ( F_5 ( V_2 -> V_11 ) , V_10 ) ;
V_3 [ 3 ] = F_4 ( F_6 ( V_2 -> V_11 ) , V_10 ) ;
V_3 [ 4 ] = F_4 ( F_7 ( V_2 -> V_11 ) , V_10 ) ;
}
if ( V_2 -> V_12 ) {
V_3 [ 1 ] = 'c' ;
...
enum V_15 V_9 )
{
struct V_1 * V_2 = F_9 ( V_14 -> V_16 -> V_17 ) ;
V_2 -> V_9 = V_9 ;
if ( F_3 ( V_2 ) )
F_10 ( V_2 -> V_6 , L_2 ) ;
}
static enum V_15 F_11 ( struct V_13 * V_14 )
{
struct V_1 * V_2 = F_9 ( V_14 -> V_16 -> V_17 ) ;
return V_2 -> V_9 ;
}
static T_2 F_12 ( struct V_18 * V_16 ,
struct V_19 * V_20 , char * V_3 )
{
struct V_1 * V_2 = F_9 ( V_16 -> V_17 ) ;
...
static T_2 F_15 ( struct V_18 * V_16 ,
struct V_19 * V_20 , char * V_3 )
{
struct V_1 * V_2 = F_9 ( V_16 -> V_17 ) ;
...
static int F_19 ( struct V_25 * V_6 , const struct V_26 * V_27 )
{
struct V_1 * V_2 ;
struct V_13 * V_28 ;
char V_29 [ 13 ] ;
int V_5 ;
V_2 = F_20 ( & V_6 -> V_16 , sizeof( struct V_1 ) , V_30 ) ;
if ( ! V_2 )
return - V_31 ;
F_21 ( V_6 , V_2 ) ;
V_2 -> V_6 = V_6 ;
...
V_28 -> V_35 = F_8 ;
V_28 -> V_36 = F_11 ;
V_5 = F_24 ( & V_6 -> V_16 , V_28 ) ;
if ( V_5 )
goto V_37;
V_5 = F_25 ( & V_28 -> V_16 -> V_38 , & V_39 ) ;
if ( V_5 )
goto V_40;
return 0 ;
V_40:
...
static void F_28 ( struct V_25 * V_6 )
{
struct V_1 * V_2 = F_29 ( V_6 ) ;
struct V_13 * V_28 = & V_2 -> V_14 ;
F_30 ( & V_28 -> V_16 -> V_38 , & V_39 ) ;
F_26 ( V_28 ) ;
F_27 ( V_6 ) ;
}
