...
if ( ! F_81 ( V_6 -> V_201 . V_203 ) &&
F_83 ( V_6 -> V_201 . V_203 ) )
F_84 ( V_6 -> V_201 . V_203 ) ;
break;
case V_204 :
if ( ! F_81 ( V_6 -> V_201 . V_202 ) )
F_82 ( V_6 , V_6 -> V_201 . V_202 , V_26 -> V_205 ) ;
V_12 |= V_17 -> V_206 ;
break;
case V_207 :
if ( ! F_81 ( V_6 -> V_201 . V_203 ) &&
! F_83 ( V_6 -> V_201 . V_203 ) ) {
V_112 = F_85 ( V_6 -> V_201 . V_203 ) ;
if ( V_112 < 0 )
F_3 ( F_4 ( V_6 ) ,
L_17 ) ;
}
...
if ( V_17 -> V_209 && V_26 -> V_199 != V_200 ) {
V_12 |= V_2 -> V_54 -> V_210 ;
if ( V_26 -> V_27 == V_28 )
V_12 &= ~ V_211 ;
else if ( V_26 -> V_27 == V_212 )
V_12 &= ( ~ V_211 &
~ V_213 &
~ V_214 ) ;
}
...
static int F_86 ( struct V_116 * V_6 )
{
struct V_1 * V_2 = F_49 ( V_6 ) ;
if ( V_2 -> V_222 == - V_119 )
return - V_119 ;
return F_87 ( V_2 -> V_222 ) ;
}
static int F_88 ( struct V_116 * V_6 )
{
struct V_1 * V_2 = F_49 ( V_6 ) ;
struct V_53 * V_54 = V_2 -> V_54 ;
unsigned int V_77 ;
...
static T_4 F_89 ( int V_183 , void * V_184 )
{
struct V_1 * V_2 = V_184 ;
F_90 ( V_2 -> V_6 , F_91 ( 500 ) ) ;
return V_192 ;
}
static void F_92 ( struct V_225 * V_226 ,
struct V_53 * V_227 )
{
int V_27 = 0 ;
V_227 -> V_222 = F_93 ( V_226 , L_18 , 0 ) ;
V_227 -> V_223 = F_93 ( V_226 , L_19 , 0 ) ;
if ( F_94 ( V_226 , L_20 , NULL ) )
V_227 -> V_224 = true ;
else
V_227 -> V_224 = false ;
F_95 ( V_226 , L_21 , & V_227 -> V_228 ) ;
if ( ! V_227 -> V_228 )
F_96 ( L_22 , V_226 -> V_229 ) ;
if ( F_94 ( V_226 , L_23 , NULL ) )
V_227 -> V_230 |= V_231 ;
if ( F_94 ( V_226 , L_24 , NULL ) )
V_227 -> V_230 |= V_232 ;
F_95 ( V_226 , L_25 , & V_27 ) ;
switch ( V_27 ) {
case 0 :
break;
case 4 :
...
static int F_97 ( struct V_235 * V_66 ,
const struct V_236 * V_237 )
{
struct V_53 * V_54 = V_66 -> V_66 . V_238 ;
struct V_225 * V_226 = V_66 -> V_66 . V_239 ;
struct V_16 * V_17 = V_237 -> V_4 ;
struct V_1 * V_2 ;
struct V_116 * V_6 ;
int V_112 ;
if ( ! V_54 && ! V_226 ) {
...
if ( ! V_54 ) {
V_54 = F_98 ( & V_66 -> V_66 , sizeof( * V_54 ) , V_240 ) ;
if ( ! V_54 )
return - V_108 ;
}
if ( V_226 )
F_92 ( V_226 , V_54 ) ;
V_112 = F_99 ( V_66 , V_241 ) ;
if ( V_112 )
goto V_242;
V_6 = F_100 ( sizeof( struct V_1 ) , & V_66 -> V_66 ) ;
if ( ! V_6 ) {
V_112 = - V_108 ;
goto V_243;
}
...
V_2 -> V_223 = - V_119 ;
V_2 -> V_244 = - 1 ;
V_2 -> V_217 = F_101 ( V_66 ) ;
V_2 -> V_245 = F_102 ( V_66 ) ;
F_52 ( F_4 ( V_6 ) , L_28 , V_2 -> V_217 ) ;
F_52 ( F_4 ( V_6 ) , L_29 , V_2 -> V_245 ) ;
V_2 -> V_8 = F_103 ( & V_66 -> V_66 , NULL ) ;
if ( F_81 ( V_2 -> V_8 ) ) {
V_112 = F_104 ( V_2 -> V_8 ) ;
V_2 -> V_8 = NULL ;
goto V_246;
...
V_2 -> V_54 = V_54 ;
V_2 -> V_17 = V_17 ;
V_2 -> V_19 = F_106 ( V_2 -> V_8 ) ;
if ( V_2 -> V_19 > 100000000 ) {
V_112 = F_107 ( V_2 -> V_8 , 100000000 ) ;
if ( V_112 < 0 )
goto V_248;
V_2 -> V_19 = F_106 ( V_2 -> V_8 ) ;
F_52 ( F_4 ( V_6 ) , L_30 ,
...
V_2 -> V_87 = V_66 -> V_249 . V_250 ;
V_2 -> V_10 = F_108 ( V_66 -> V_249 . V_250 , F_109 ( & V_66 -> V_249 ) ) ;
if ( ! V_2 -> V_10 ) {
V_112 = - V_108 ;
goto V_248;
}
V_6 -> V_251 = & V_252 ;
if ( V_17 -> V_21 )
V_6 -> V_253 = F_9 ( V_2 -> V_19 , 257 ) ;
else
V_6 -> V_253 = F_9 ( V_2 -> V_19 , 512 ) ;
if ( V_54 -> V_228 )
V_6 -> V_228 = F_65 ( V_2 -> V_19 , V_54 -> V_228 ) ;
else
V_6 -> V_228 = F_65 ( V_2 -> V_19 , V_254 ) ;
F_52 ( F_4 ( V_6 ) , L_31 , V_6 -> V_228 ) ;
V_2 -> V_255 = F_110 ( & V_66 -> V_66 ) ;
if ( F_81 ( V_2 -> V_255 ) ) {
V_112 = F_104 ( V_2 -> V_255 ) ;
goto V_248;
}
V_2 -> V_256 = F_111 ( V_2 -> V_255 ,
V_257 ) ;
if ( ! F_81 ( V_2 -> V_256 ) ) {
V_112 = F_112 ( V_2 -> V_255 , V_2 -> V_256 ) ;
if ( V_112 )
F_25 ( & V_66 -> V_66 , L_32 ) ;
} else
F_25 ( & V_66 -> V_66 , L_33 ) ;
F_113 ( V_6 ) ;
if ( ! V_6 -> V_258 )
V_6 -> V_258 = V_54 -> V_259 ;
else if ( V_54 -> V_259 )
F_25 ( F_4 ( V_6 ) , L_34 ) ;
V_6 -> V_260 = V_54 -> V_230 ;
V_6 -> V_261 = V_54 -> V_262 ;
V_6 -> V_263 = V_264 ;
V_6 -> V_265 = V_266 ;
V_6 -> V_267 = ( 1 << V_17 -> V_268 ) - 1 ;
V_6 -> V_67 = V_6 -> V_267 ;
V_6 -> V_269 = 1 << 11 ;
V_6 -> V_270 = V_6 -> V_267 >> 11 ;
F_114 ( & V_2 -> V_193 ) ;
F_6 ( 0 , V_2 -> V_10 + V_41 ) ;
F_6 ( 0 , V_2 -> V_10 + V_43 ) ;
...
if ( F_115 ( V_54 -> V_223 ) ) {
V_112 = F_116 ( V_54 -> V_223 , V_241 L_35 ) ;
if ( V_112 == 0 )
V_112 = F_117 ( V_54 -> V_223 ) ;
if ( V_112 == 0 )
V_2 -> V_223 = V_54 -> V_223 ;
else if ( V_112 != - V_119 )
goto V_272;
V_112 = F_118 ( F_119 ( V_54 -> V_223 ) ,
F_89 ,
V_273 | V_274 ,
V_241 L_35 , V_2 ) ;
if ( V_112 >= 0 )
V_2 -> V_244 = F_119 ( V_54 -> V_223 ) ;
}
if ( V_54 -> V_222 == - V_271 ) {
V_112 = - V_271 ;
goto V_275;
...
if ( F_115 ( V_54 -> V_222 ) ) {
V_112 = F_116 ( V_54 -> V_222 , V_241 L_36 ) ;
if ( V_112 == 0 )
V_112 = F_117 ( V_54 -> V_222 ) ;
if ( V_112 == 0 )
V_2 -> V_222 = V_54 -> V_222 ;
else if ( V_112 != - V_119 )
goto V_275;
}
if ( ( V_2 -> V_54 -> V_77 || V_2 -> V_223 != - V_119 )
&& V_2 -> V_244 < 0 )
V_6 -> V_260 |= V_276 ;
V_112 = F_120 ( V_66 -> V_183 [ 0 ] , F_72 , V_277 , V_241 L_37 , V_2 ) ;
if ( V_112 )
goto V_278;
if ( ! V_66 -> V_183 [ 1 ] )
V_2 -> V_39 = true ;
else {
V_112 = F_120 ( V_66 -> V_183 [ 1 ] , F_67 , V_277 ,
V_241 L_38 , V_2 ) ;
if ( V_112 )
goto V_279;
}
F_6 ( V_280 , V_2 -> V_10 + V_41 ) ;
F_121 ( V_66 , V_6 ) ;
F_21 ( & V_66 -> V_66 , L_39 ,
F_122 ( V_6 ) , F_123 ( V_66 ) , F_101 ( V_66 ) ,
F_102 ( V_66 ) , ( unsigned long long ) V_66 -> V_249 . V_250 ,
...
static int F_135 ( struct V_235 * V_66 )
{
struct V_116 * V_6 = F_136 ( V_66 ) ;
F_121 ( V_66 , NULL ) ;
if ( V_6 ) {
struct V_1 * V_2 = F_49 ( V_6 ) ;
F_77 ( & V_66 -> V_66 ) ;
...
{
struct V_235 * V_281 = F_139 ( V_66 ) ;
struct V_116 * V_6 = F_136 ( V_281 ) ;
int V_112 = 0 ;
if ( V_6 ) {
struct V_1 * V_2 = F_49 ( V_6 ) ;
V_112 = F_140 ( V_6 ) ;
...
static int F_144 ( struct V_65 * V_66 )
{
struct V_235 * V_281 = F_139 ( V_66 ) ;
struct V_116 * V_6 = F_136 ( V_281 ) ;
if ( V_6 ) {
