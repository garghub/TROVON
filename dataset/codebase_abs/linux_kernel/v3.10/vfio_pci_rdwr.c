...
return - V_25 ;
V_6 = V_22 ;
} else if ( ! V_15 -> V_26 [ V_21 ] ) {
int V_27 ;
V_27 = F_20 ( V_18 , 1 << V_21 , L_1 ) ;
if ( V_27 )
return V_27 ;
...
V_31 = F_25 ( 0xa0000 , 0xbffff - 0xa0000 + 1 ) ;
V_3 = V_19 - 0xa0000 ;
V_32 = V_35 ;
V_33 = false ;
break;
...
if ( ! V_31 )
return - V_25 ;
V_27 = F_27 ( V_15 -> V_18 , V_32 ) ;
if ( V_27 ) {
V_33 ? F_28 ( V_31 ) : F_29 ( V_31 ) ;
return V_27 ;
}
V_8 = F_1 ( V_31 , V_2 , V_3 , V_4 , 0 , 0 , V_7 ) ;
F_30 ( V_15 -> V_18 , V_32 ) ;
V_33 ? F_28 ( V_31 ) : F_29 ( V_31 ) ;
if ( V_8 >= 0 )
* V_16 += V_8 ;
