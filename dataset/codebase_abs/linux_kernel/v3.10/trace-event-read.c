...
static int F_17 ( struct V_14 * V_14 , unsigned long long V_3 )
{
char * V_2 ;
V_2 = malloc ( V_3 ) ;
if ( V_2 == NULL )
...
static int F_19 ( struct V_14 * V_14 , char * V_21 ,
unsigned long long V_3 )
{
char * V_2 ;
V_2 = malloc ( V_3 ) ;
...
T_2 F_23 ( int V_1 , struct V_14 * * V_26 , bool V_27 )
{
char V_2 [ V_13 ] ;
char V_28 [] = { 23 , 8 , 68 } ;
char * V_29 ;
