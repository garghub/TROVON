...
unsigned int F_59 ( unsigned int V_132 , T_4 V_133 , int V_134 )
{
struct V_135 * V_135 ;
if ( ! F_60 ( F_61 ( V_133 ) ) )
return V_132 ;
...
#ifdef F_31
if ( V_171 ) {
V_74 = F_92 ( V_150 , V_163 , V_23 , V_170 , V_134 , V_175 ,
V_14 , V_171 , V_13 ) ;
goto V_177;
}
#endif
...
#ifdef F_41
if ( V_13 == V_49 )
V_74 = F_94 ( V_150 , V_163 , V_23 , V_170 , V_134 , V_175 , V_14 ) ;
else
#endif
{
...
V_74 = F_95 ( V_150 , V_163 , V_23 , V_170 , V_134 ,
V_175 , V_14 , V_153 ) ;
}
if ( V_74 == - 1 )
...
void F_97 ( struct V_148 * V_149 , unsigned long V_150 ,
...
#ifdef F_98
if ( F_99 ( F_71 ( V_149 , V_150 ) != V_149 -> V_144 . V_147 ) )
return;
#endif
F_81 ( L_46
...
if ( V_169 == NULL )
return;
V_170 = F_100 ( V_169 , V_150 ) ;
if ( ! V_170 )
return;
#ifdef F_27
if ( F_91 ( * V_170 ) & ( V_185 | V_186 ) )
return;
#endif
V_14 = F_83 ( V_150 ) ;
V_23 = F_84 ( V_149 -> V_144 . V_178 , V_150 , V_14 ) ;
...
#endif
V_74 = F_95 ( V_150 , V_163 , V_23 , V_170 , V_134 , V_175 , V_14 ,
F_76 ( V_149 , V_150 ) ) ;
if ( V_74 == - 1 )
...
void F_103 ( unsigned long V_24 , T_6 V_133 , int V_13 , int V_14 ,
int V_175 )
{
unsigned long V_21 , V_141 , V_18 , V_189 , V_190 ;
F_81 ( L_48 , V_24 ) ;
F_104 (pte, psize, vpn, index, shift) {
V_21 = F_7 ( V_24 , V_18 , V_14 ) ;
V_189 = F_105 ( V_133 , V_141 ) ;
if ( V_189 & V_191 )
V_21 = ~ V_21 ;
V_190 = ( V_21 & V_26 ) * V_27 ;
V_190 += V_189 & V_192 ;
F_81 ( L_49 , V_141 , V_190 , V_189 ) ;
V_28 . V_193 ( V_190 , V_24 , V_13 , V_14 , V_175 ) ;
} F_106 () ;
#ifdef F_107
if ( V_175 && F_108 ( V_194 ) &&
V_165 -> V_195 . V_196 &&
F_109 ( V_165 -> V_195 . V_196 -> V_197 ) ) {
F_110 () ;
F_111 ( V_198 ) ;
}
#endif
}
void F_112 ( unsigned long V_199 , int V_175 )
{
if ( V_28 . F_112 )
V_28 . F_112 ( V_199 , V_175 ) ;
else {
int V_200 ;
struct V_201 * V_202 =
& F_113 ( V_201 ) ;
for ( V_200 = 0 ; V_200 < V_199 ; V_200 ++ )
F_103 ( V_202 -> V_24 [ V_200 ] , V_202 -> V_133 [ V_200 ] ,
V_202 -> V_13 , V_202 -> V_14 , V_175 ) ;
}
}
void F_114 ( struct V_203 * V_196 , unsigned long V_204 , int V_74 )
{
enum V_167 V_168 = F_80 () ;
if ( F_115 ( V_196 ) ) {
#ifdef F_116
if ( V_74 == - 2 )
F_117 ( V_205 , V_196 , V_206 , V_204 ) ;
else
#endif
F_117 ( V_207 , V_196 , V_208 , V_204 ) ;
} else
F_118 ( V_196 , V_204 , V_207 ) ;
F_96 ( V_168 ) ;
}
long F_119 ( unsigned long V_21 , unsigned long V_24 ,
unsigned long V_209 , unsigned long V_2 ,
unsigned long V_210 , int V_13 , int V_14 )
{
unsigned long V_211 ;
long V_190 ;
V_212:
V_211 = ( ( V_21 & V_26 ) *
V_27 ) & ~ 0x7UL ;
V_190 = V_28 . V_29 ( V_211 , V_24 , V_209 , V_2 , V_210 ,
V_13 , V_13 , V_14 ) ;
if ( F_99 ( V_190 == - 1 ) ) {
V_211 = ( ( ~ V_21 & V_26 ) *
V_27 ) & ~ 0x7UL ;
V_190 = V_28 . V_29 ( V_211 , V_24 , V_209 , V_2 ,
V_210 | V_213 ,
V_13 , V_13 , V_14 ) ;
if ( V_190 == - 1 ) {
if ( F_120 () & 0x1 )
...
static void F_121 ( unsigned long V_15 , unsigned long V_214 )
{
unsigned long V_21 ;
unsigned long V_23 = F_4 ( V_15 , V_94 ) ;
unsigned long V_24 = F_5 ( V_15 , V_23 , V_94 ) ;
unsigned long V_215 = F_1 ( V_93 ) ;
long V_19 ;
V_21 = F_7 ( V_24 , V_31 , V_94 ) ;
if ( ! V_23 )
return;
V_19 = F_119 ( V_21 , V_24 , F_37 ( V_15 ) , V_215 ,
V_30 ,
V_78 , V_94 ) ;
F_8 ( V_19 < 0 ) ;
F_122 ( & V_216 ) ;
F_8 ( V_33 [ V_214 ] & 0x80 ) ;
V_33 [ V_214 ] = V_19 | 0x80 ;
F_123 ( & V_216 ) ;
}
static void F_124 ( unsigned long V_15 , unsigned long V_214 )
{
unsigned long V_21 , V_189 , V_190 ;
unsigned long V_23 = F_4 ( V_15 , V_94 ) ;
unsigned long V_24 = F_5 ( V_15 , V_23 , V_94 ) ;
V_21 = F_7 ( V_24 , V_31 , V_94 ) ;
F_122 ( & V_216 ) ;
F_8 ( ! ( V_33 [ V_214 ] & 0x80 ) ) ;
V_189 = V_33 [ V_214 ] & 0x7f ;
V_33 [ V_214 ] = 0 ;
F_123 ( & V_216 ) ;
if ( V_189 & V_191 )
V_21 = ~ V_21 ;
V_190 = ( V_21 & V_26 ) * V_27 ;
V_190 += V_189 & V_192 ;
V_28 . V_193 ( V_190 , V_24 , V_78 , V_94 , 0 ) ;
}
void F_125 ( struct V_135 * V_135 , int V_217 , int V_218 )
{
unsigned long V_137 , V_15 , V_214 ;
int V_200 ;
F_101 ( V_137 ) ;
for ( V_200 = 0 ; V_200 < V_217 ; V_200 ++ , V_135 ++ ) {
V_15 = ( unsigned long ) F_126 ( V_135 ) ;
V_214 = F_37 ( V_15 ) >> V_31 ;
if ( V_214 >= V_32 )
continue;
if ( V_218 )
F_121 ( V_15 , V_214 ) ;
...
void F_127 ( T_7 V_219 ,
T_7 V_220 )
{
F_8 ( V_219 != 0 ) ;
V_121 = F_128 ( V_128 , V_220 , 0x40000000 ) ;
F_53 ( V_121 ) ;
}
