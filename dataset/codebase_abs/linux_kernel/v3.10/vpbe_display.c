...
static int F_99 ( struct V_152 * V_152 , void * V_153 ,
struct V_244 * V_245 )
{
...
static int F_100 ( struct V_152 * V_152 , void * V_153 ,
const struct V_244 * V_245 )
{
return 0 ;
}
static int F_101 ( struct V_249 * V_48 , void * V_250 )
{
struct V_251 * V_168 = F_102 ( V_48 ) ;
struct V_1 * V_252 = V_250 ;
if ( strcmp ( L_65 , V_168 -> V_253 ) == 0 )
V_252 -> V_4 = F_103 ( V_168 ) ;
if ( strstr ( V_168 -> V_253 , L_66 ) != NULL )
V_252 -> V_28 = F_103 ( V_168 ) ;
return 0 ;
}
static int F_104 ( int V_47 , struct V_1 * V_2 ,
struct V_251 * V_168 )
{
struct V_13 * V_254 = NULL ;
struct V_255 * V_256 = NULL ;
V_2 -> V_48 [ V_47 ] =
F_105 ( sizeof( struct V_13 ) , V_239 ) ;
if ( ! V_2 -> V_48 [ V_47 ] ) {
F_106 ( V_257 L_67 ) ;
return - V_240 ;
}
F_107 ( & V_2 -> V_48 [ V_47 ] -> V_83 ) ;
F_108 ( & V_2 -> V_48 [ V_47 ] -> V_84 ) ;
V_254 = V_2 -> V_48 [ V_47 ] ;
V_256 = & V_254 -> V_258 ;
V_256 -> V_259 = V_260 ;
V_256 -> V_261 = & V_262 ;
...
V_256 -> V_266 = & V_254 -> V_84 ;
V_256 -> V_267 = V_268 ;
if ( V_2 -> V_4 -> V_111 . V_196 &
V_197 )
V_256 -> V_269 = ( V_123 | V_124 ) ;
...
V_254 -> V_90 = V_47 ;
V_254 -> V_39 . V_40 =
( ( V_47 == V_91 ) ? V_270 : V_271 ) ;
F_109 ( & V_254 -> V_157 ) ;
return 0 ;
}
static int F_110 ( struct V_13 * V_254 ,
struct V_1 * V_2 ,
struct V_251 * V_168 )
{
int V_238 ;
...
static int F_115 ( struct V_251 * V_168 )
{
struct V_13 * V_254 ;
struct V_1 * V_2 ;
...
int V_42 ;
F_106 ( V_277 L_71 ) ;
V_2 = F_105 ( sizeof( struct V_1 ) , V_239 ) ;
if ( ! V_2 ) {
F_106 ( V_257 L_67 ) ;
return - V_240 ;
}
F_107 ( & V_2 -> V_30 ) ;
V_238 = F_116 ( & V_278 , NULL , V_2 ,
F_101 ) ;
if ( V_238 < 0 )
return V_238 ;
if ( NULL != V_2 -> V_4 -> V_37 . V_279 ) {
V_238 = V_2 -> V_4 -> V_37 . V_279 ( & V_168 -> V_48 ,
V_2 -> V_4 ) ;
if ( V_238 ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_72 ) ;
...
for ( V_47 = 0 ; V_47 < V_53 ; V_47 ++ ) {
if ( F_104 ( V_47 , V_2 , V_168 ) ) {
V_238 = - V_273 ;
goto V_280;
}
}
V_275 = F_117 ( V_168 , V_281 , 0 ) ;
if ( ! V_275 ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_73 ) ;
V_238 = - V_273 ;
...
V_42 = V_275 -> V_282 ;
if ( F_118 ( V_42 , F_14 , V_283 , V_284 ,
V_2 ) ) {
F_3 ( & V_2 -> V_4 -> V_11 ,
L_74 ) ;
V_238 = - V_273 ;
...
for ( V_47 = 0 ; V_47 < V_53 ; V_47 ++ ) {
if ( F_110 ( V_2 -> V_48 [ V_47 ] , V_2 , V_168 ) ) {
V_238 = - V_273 ;
goto V_285;
}
}
...
return 0 ;
V_285:
F_119 ( V_275 -> V_282 , V_2 ) ;
V_280:
for ( V_276 = 0 ; V_276 < V_53 ; V_276 ++ ) {
V_254 = V_2 -> V_48 [ V_276 ] ;
if ( V_254 ) {
F_120 (
& V_254 -> V_258 ) ;
F_94 ( V_2 -> V_48 [ V_276 ] ) ;
...
static int F_121 ( struct V_251 * V_168 )
{
struct V_13 * V_254 ;
struct V_1 * V_2 = F_103 ( V_168 ) ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_274 * V_275 ;
int V_47 ;
...
V_275 = F_117 ( V_168 , V_281 , 0 ) ;
F_119 ( V_275 -> V_282 , V_2 ) ;
if ( NULL != V_4 -> V_37 . V_286 )
V_4 -> V_37 . V_286 ( & V_168 -> V_48 , V_4 ) ;
for ( V_47 = 0 ; V_47 < V_53 ; V_47 ++ ) {
V_254 = V_2 -> V_48 [ V_47 ] ;
F_120 ( & V_254 -> V_258 ) ;
}
