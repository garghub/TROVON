...
{
struct V_143 * V_144 ;
V_144 = F_70 ( V_13 -> V_4 , L_21 ,
V_13 -> V_4 -> V_156 ) ;
if ( ! V_144 )
return;
V_144 -> V_157 = V_158 ;
V_144 -> V_159 = V_160 | V_161 | V_162 ;
V_144 -> V_163 . V_164 . V_165 = F_59 ;
V_144 -> V_163 . V_164 . V_166 = F_63 ;
V_144 -> V_14 = V_13 ;
if ( F_71 ( V_144 ) < 0 ) {
F_72 ( V_144 ) ;
V_144 = NULL ;
...
unsigned int V_119 ;
for ( V_119 = 0 ; V_119 < F_75 ( V_168 ) ; V_119 ++ )
F_58 ( V_13 , & V_168 [ V_119 ] , 0 , 0 ) ;
if ( V_13 -> V_37 ) {
V_13 -> V_28 = F_51 ;
V_13 -> V_29 = F_52 ;
}
}
static int F_76 ( void * V_194 )
{
...
F_14 ( V_13 -> V_22 , V_22 , sizeof( V_13 -> V_22 ) ) ;
#ifdef F_81
F_82 ( F_81 ,
V_4 -> V_134 ,
V_13 -> V_22 ) ;
