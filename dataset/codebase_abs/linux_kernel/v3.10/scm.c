...
goto V_69;
if ( F_32 ( F_13 ( V_59 ) , V_58 , V_63 - sizeof( struct V_20 ) ) )
goto V_69;
V_63 = F_33 ( V_57 ) ;
if ( V_44 -> V_66 < V_63 )
V_63 = V_44 -> V_66 ;
...
void F_34 ( struct V_43 * V_44 , struct V_39 * V_40 )
{
struct V_20 T_4 * V_59
= ( V_60 struct V_20 T_4 * ) V_44 -> V_61 ;
int V_70 = 0 ;
...
V_42 = F_40 ( V_36 [ V_28 ] , & V_46 ) ;
if ( V_42 ) {
F_41 ( V_42 -> V_76 ) ;
F_42 ( V_42 -> V_76 ) ;
}
F_43 ( V_73 , F_44 ( V_36 [ V_28 ] ) ) ;
}
if ( V_28 > 0 )
{
...
if ( ! V_46 )
V_46 = F_38 ( V_63 , & V_59 -> V_30 ) ;
if ( ! V_46 ) {
V_63 = F_33 ( V_28 * sizeof( int ) ) ;
V_44 -> V_61 += V_63 ;
V_44 -> V_66 -= V_63 ;
}
}
...
struct V_22 * F_45 ( struct V_22 * V_25 )
{
struct V_22 * V_77 ;
int V_28 ;
if ( ! V_25 )
return NULL ;
V_77 = F_46 ( V_25 , F_47 ( struct V_22 , V_36 [ V_25 -> V_34 ] ) ,
V_32 ) ;
if ( V_77 ) {
