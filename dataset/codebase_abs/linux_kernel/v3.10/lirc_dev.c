...
{
struct V_1 * V_2 = V_55 [ F_40 ( F_50 ( V_67 ) ) ] ;
unsigned int V_72 ;
if ( ! V_2 ) {
F_25 ( V_41 L_34 , V_44 ) ;
return V_73 ;
...
long F_53 ( struct V_67 * V_67 , unsigned int V_76 , unsigned long V_77 )
{
T_2 V_78 ;
int V_79 = 0 ;
struct V_1 * V_2 = V_55 [ F_40 ( F_50 ( V_67 ) ) ] ;
...
switch ( V_76 ) {
case V_80 :
V_79 = F_54 ( V_2 -> V_4 . V_59 , ( T_2 * ) V_77 ) ;
break;
case V_81 :
if ( ! ( V_2 -> V_4 . V_59 & V_82 ) ) {
V_79 = - V_83 ;
break;
}
V_79 = F_54 ( F_55
...
V_79 = F_56 ( V_78 , ( T_2 * ) V_77 ) ;
if ( ! V_79 && ! ( F_57 ( V_78 ) & V_2 -> V_4 . V_59 ) )
V_79 = - V_45 ;
break;
case V_85 :
V_79 = F_54 ( V_2 -> V_4 . V_47 , ( T_2 * ) V_77 ) ;
break;
case V_86 :
if ( ! ( V_2 -> V_4 . V_59 & V_87 ) ||
V_2 -> V_4 . V_88 == 0 ) {
V_79 = - V_83 ;
break;
}
V_79 = F_54 ( V_2 -> V_4 . V_88 , ( T_2 * ) V_77 ) ;
break;
case V_89 :
if ( ! ( V_2 -> V_4 . V_59 & V_87 ) ||
V_2 -> V_4 . V_90 == 0 ) {
...
V_79 = F_54 ( V_2 -> V_4 . V_90 , ( T_2 * ) V_77 ) ;
break;
default:
V_79 = - V_45 ;
}
F_4 ( V_2 -> V_4 . V_7 , V_8 L_41 ,
V_2 -> V_4 . V_9 , V_2 -> V_4 . V_5 , V_79 ) ;
F_34 ( & V_2 -> V_3 ) ;
return V_79 ;
}
T_3 F_58 ( struct V_67 * V_67 ,
char T_4 * V_91 ,
T_5 V_92 ,
T_6 * V_93 )
{
...
F_60 ( & V_2 -> V_12 -> V_25 , & V_71 ) ;
F_13 ( V_24 ) ;
while ( V_94 < V_92 && V_72 == 0 ) {
if ( F_52 ( V_2 -> V_12 ) ) {
if ( V_94 )
break;
if ( V_67 -> V_98 & V_99 ) {
...
void * F_65 ( struct V_67 * V_67 )
{
return V_55 [ F_40 ( F_50 ( V_67 ) ) ] -> V_4 . V_19 ;
}
T_3 F_66 ( struct V_67 * V_67 , const char T_4 * V_91 ,
T_5 V_92 , T_6 * V_93 )
{
struct V_1 * V_2 = V_55 [ F_40 ( F_50 ( V_67 ) ) ] ;
if ( ! V_2 ) {
