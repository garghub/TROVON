...
static void F_41 ( struct V_100 * V_131 , struct V_79 * V_79 )
{
struct V_132 V_41 ;
V_41 . V_79 = V_79 ;
...
static int F_44 ( struct V_100 * V_131 , struct V_137 * V_41 )
{
const struct V_9 * V_16 = V_41 -> V_138 ;
int V_14 ;
V_41 -> V_104 = V_131 -> V_58 . V_59 . V_104 ;
V_41 -> V_105 = V_131 -> V_62 ;
V_14 = F_45 ( V_41 , V_131 -> V_58 . V_139 - sizeof( * V_131 ) ,
...
static int
F_46 ( struct V_100 * V_131 , struct V_137 * V_41 )
{
struct V_140 * V_104 ;
int V_14 ;
V_104 = F_47 ( V_97 , V_131 -> V_58 . V_124 . V_60 ,
...
return 0 ;
V_142:
F_42 ( V_131 -> V_58 . V_59 . V_104 -> V_134 ) ;
return V_14 ;
}
static int F_50 ( struct V_44 * V_49 , struct V_79 * V_79 , const char * V_60 )
{
...
int V_14 ;
V_56 = F_17 ( V_49 ) ;
V_14 = F_51 ( & V_41 , V_56 -> V_58 . V_136 - sizeof( * V_56 ) ,
...
static int
F_52 ( struct V_44 * V_49 , struct V_79 * V_79 , const char * V_60 ,
unsigned int V_126 )
{
struct V_48 * V_56 ;
struct V_145 * V_57 ;
...
V_147 . V_96 = V_97 ;
F_31 (ematch, e) {
V_14 = F_46 ( V_101 , & V_147 ) ;
if ( V_14 != 0 )
goto V_148;
++ V_146 ;
}
V_56 = F_17 ( V_49 ) ;
V_57 = F_53 ( V_97 , V_56 -> V_58 . V_124 . V_60 ,
...
V_14 = F_50 ( V_49 , V_79 , V_60 ) ;
if ( V_14 )
goto V_142;
return 0 ;
V_142:
F_42 ( V_56 -> V_58 . V_59 . V_57 -> V_134 ) ;
V_148:
F_31 (ematch, e) {
if ( V_146 -- == 0 )
break;
...
static void F_57 ( struct V_44 * V_49 , struct V_79 * V_79 )
{
struct V_154 V_41 ;
struct V_48 * V_56 ;
struct V_100 * V_101 ;
...
F_42 ( V_41 . V_57 -> V_134 ) ;
}
static int
F_58 ( struct V_79 * V_79 , struct V_74 * V_117 , void * V_118 ,
...
if ( ! F_38 ( V_117 , V_156 -> V_99 , V_118 ) )
return - V_160 ;
V_157 = 0 ;
F_22 (iter, entry0, newinfo->size) {
V_14 = F_52 ( V_78 , V_79 , V_156 -> V_60 , V_156 -> V_126 ) ;
if ( V_14 != 0 )
break;
++ V_157 ;
}
...
} while ( F_63 ( V_50 , V_163 ) );
F_32 ( V_106 [ V_157 ] , V_162 , V_121 ) ;
++ V_157 ;
}
}
}
static struct V_153 * F_64 ( const struct V_1 * V_86 )
{
unsigned int V_164 ;
struct V_153 * V_106 ;
...
if ( F_48 ( V_106 ) )
return F_49 ( V_106 ) ;
V_170 = V_75 -> V_80 [ F_68 () ] ;
if ( F_69 ( V_167 , V_170 , V_166 ) != 0 ) {
V_14 = - V_171 ;
goto V_172;
}
...
if ( V_174 > 0 )
V_174 -= F_73 ( V_84 , V_174 ) ;
return F_69 ( V_23 , & V_174 , sizeof( V_174 ) ) ? - V_171 : 0 ;
}
...
F_31 (ematch, e)
V_168 += F_76 ( V_101 -> V_58 . V_59 . V_104 ) ;
V_56 = F_16 ( V_49 ) ;
V_168 += F_77 ( V_56 -> V_58 . V_59 . V_57 ) ;
V_117 -> V_126 -= V_168 ;
V_14 = F_78 ( V_84 , V_175 , V_168 ) ;
if ( V_14 )
return V_14 ;
for ( V_157 = 0 ; V_157 < V_119 ; V_157 ++ ) {
if ( V_2 -> V_81 [ V_157 ] &&
...
if ( ! V_117 || ! V_2 )
return - V_135 ;
memcpy ( V_117 , V_2 , F_70 ( struct V_74 , V_80 ) ) ;
V_117 -> V_177 = 0 ;
V_170 = V_2 -> V_80 [ F_68 () ] ;
F_80 ( V_84 , V_2 -> V_158 ) ;
F_22 (iter, loc_cpu_entry, info->size) {
V_14 = F_75 ( V_78 , V_2 , V_170 , V_117 ) ;
if ( V_14 != 0 )
return V_14 ;
}
return 0 ;
}
static int F_81 ( struct V_79 * V_79 , void T_4 * V_124 ,
...
static int
F_91 ( struct V_79 * V_79 , struct V_183 T_4 * V_184 ,
const int * V_107 )
{
int V_14 ;
struct V_183 V_185 ;
...
if ( F_82 ( & V_185 , V_184 , sizeof( V_185 ) ) != 0 )
return - V_171 ;
...
V_56 = F_86 ( V_79 , V_84 , V_185 . V_60 ) ;
if ( ! F_87 ( V_56 ) ) {
...
static int
F_92 ( struct V_79 * V_79 , const char * V_60 , unsigned int V_99 ,
...
struct V_44 * V_78 ;
V_14 = 0 ;
V_106 = F_65 ( V_188 * sizeof( struct V_153 ) ) ;
if ( ! V_106 ) {
V_14 = - V_165 ;
goto V_72;
}
...
V_190 = F_93 ( V_56 , V_188 , V_117 , & V_14 ) ;
if ( ! V_190 )
goto V_193;
F_11 ( L_42 ,
...
static int
F_95 ( struct V_79 * V_79 , const void T_4 * V_124 , unsigned int V_107 )
{
int V_14 ;
struct V_155 V_181 ;
struct V_74 * V_117 ;
void * V_170 ;
struct V_44 * V_78 ;
if ( F_82 ( & V_181 , V_124 , sizeof( V_181 ) ) != 0 )
return - V_171 ;
if ( V_181 . V_188 >= V_194 / sizeof( struct V_153 ) )
return - V_165 ;
V_181 . V_60 [ sizeof( V_181 . V_60 ) - 1 ] = 0 ;
V_117 = F_96 ( V_181 . V_126 ) ;
if ( ! V_117 )
return - V_165 ;
V_170 = V_117 -> V_80 [ F_68 () ] ;
if ( F_82 ( V_170 , V_124 + sizeof( V_181 ) ,
V_181 . V_126 ) != 0 ) {
V_14 = - V_171 ;
goto V_195;
}
V_14 = F_58 ( V_79 , V_117 , V_170 , & V_181 ) ;
if ( V_14 != 0 )
goto V_195;
F_11 ( L_43 ) ;
V_14 = F_92 ( V_79 , V_181 . V_60 , V_181 . V_99 , V_117 ,
...
return - V_135 ;
V_199 = F_98 ( V_107 - V_126 ) ;
if ( ! V_199 )
return - V_165 ;
if ( F_82 ( V_199 , V_124 + V_126 , V_107 - V_126 ) != 0 ) {
V_14 = - V_171 ;
goto free;
}
V_56 = F_86 ( V_79 , V_84 , V_60 ) ;
if ( F_87 ( V_56 ) ) {
V_14 = V_56 ? F_49 ( V_56 ) : - V_182 ;
goto free;
}
...
F_32 ( V_78 -> V_106 , V_199 [ V_157 ] . V_162 , V_199 [ V_157 ] . V_121 ) ;
++ V_157 ;
}
F_35 ( V_95 ) ;
V_203:
...
static int
F_99 ( struct V_44 * V_49 , void T_4 * * V_204 ,
...
if ( F_69 ( V_205 , V_49 , sizeof( struct V_44 ) ) != 0 ||
F_69 ( & V_205 -> V_106 , & V_106 [ V_157 ] ,
sizeof( V_106 [ V_157 ] ) ) != 0 )
return - V_171 ;
* V_204 += sizeof( struct V_176 ) ;
* V_126 -= sizeof( struct V_44 ) - sizeof( struct V_176 ) ;
F_31 (ematch, e) {
V_14 = F_100 ( V_101 , V_204 , V_126 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_63 = V_49 -> V_63 - ( V_206 - * V_126 ) ;
V_56 = F_17 ( V_49 ) ;
V_14 = F_101 ( V_56 , V_204 , V_126 ) ;
if ( V_14 )
return V_14 ;
V_129 = V_49 -> V_129 - ( V_206 - * V_126 ) ;
if ( F_102 ( V_63 , & V_205 -> V_63 ) != 0 ||
F_102 ( V_129 , & V_205 -> V_129 ) != 0 )
return - V_171 ;
return 0 ;
}
static int
F_103 ( struct V_100 * V_131 ,
const char * V_60 ,
...
static void F_104 ( struct V_176 * V_49 )
{
struct V_48 * V_56 ;
struct V_100 * V_101 ;
F_31 (ematch, e)
F_42 ( V_101 -> V_58 . V_59 . V_104 -> V_134 ) ;
V_56 = F_105 ( V_49 ) ;
F_42 ( V_56 -> V_58 . V_59 . V_57 -> V_134 ) ;
}
static int
F_106 ( struct V_176 * V_49 ,
struct V_74 * V_117 ,
unsigned int * V_126 ,
const unsigned char * V_45 ,
const unsigned char * V_149 ,
...
F_11 ( L_45 , V_49 ) ;
if ( ( unsigned long ) V_49 % F_56 ( struct V_176 ) != 0 ||
...
static int
F_107 ( struct V_176 * V_49 , void * * V_204 ,
...
* V_126 += sizeof( struct V_44 ) - sizeof( struct V_176 ) ;
F_31 (ematch, e) {
V_14 = F_108 ( V_101 , V_204 , V_126 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_210 -> V_63 = V_49 -> V_63 - ( V_206 - * V_126 ) ;
V_56 = F_105 ( V_49 ) ;
F_109 ( V_56 , V_204 , V_126 ) ;
...
static int F_110 ( struct V_44 * V_49 , struct V_79 * V_79 ,
const char * V_60 )
{
unsigned int V_146 ;
int V_14 = 0 ;
...
V_213 = V_117 -> V_80 [ F_68 () ] ;
V_120 = V_213 ;
V_126 = V_166 ;
F_22 (iter0, entry0, total_size) {
V_14 = F_107 ( V_214 , & V_120 , & V_126 ,
V_60 , V_117 , V_213 ) ;
if ( V_14 != 0 )
break;
}
...
goto V_195;
V_14 = - V_160 ;
if ( ! F_38 ( V_117 , V_99 , V_213 ) )
goto V_195;
V_157 = 0 ;
F_22 (iter1, entry1, newinfo->size) {
V_14 = F_110 ( V_215 , V_79 , V_60 ) ;
if ( V_14 != 0 )
break;
++ V_157 ;
...
static int
F_112 ( struct V_79 * V_79 , void T_4 * V_124 , unsigned int V_107 )
{
int V_14 ;
struct V_218 V_181 ;
struct V_74 * V_117 ;
...
V_14 = F_111 ( V_79 , V_181 . V_60 , V_181 . V_99 ,
...
static int
F_115 ( struct V_219 * V_220 , int V_221 , void T_4 * V_124 ,
unsigned int V_107 )
{
int V_14 ;
if ( ! F_116 ( F_117 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_225 :
V_14 = F_112 ( F_117 ( V_220 ) , V_124 , V_107 ) ;
break;
case V_226 :
V_14 = F_97 ( F_117 ( V_220 ) , V_124 , V_107 , 1 ) ;
break;
default:
F_11 ( L_51 , V_221 ) ;
V_14 = - V_135 ;
...
static int
F_118 ( unsigned int V_166 , struct V_1 * V_86 ,
void T_4 * V_167 )
{
struct V_153 * V_106 ;
const struct V_74 * V_75 = V_86 -> V_75 ;
...
static int
F_119 ( struct V_79 * V_79 , struct V_227 T_4 * V_184 ,
int * V_107 )
{
int V_14 ;
struct V_227 V_185 ;
...
static int
F_120 ( struct V_219 * V_220 , int V_221 , void T_4 * V_124 , int * V_107 )
{
int V_14 ;
if ( ! F_116 ( F_117 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_228 :
V_14 = F_81 ( F_117 ( V_220 ) , V_124 , V_107 , 1 ) ;
break;
case V_229 :
V_14 = F_119 ( F_117 ( V_220 ) , V_124 , V_107 ) ;
break;
default:
V_14 = F_121 ( V_220 , V_221 , V_124 , V_107 ) ;
}
return V_14 ;
}
static int
F_122 ( struct V_219 * V_220 , int V_221 , void T_4 * V_124 , unsigned int V_107 )
{
int V_14 ;
if ( ! F_116 ( F_117 ( V_220 ) -> V_222 , V_223 ) )
return - V_224 ;
switch ( V_221 ) {
case V_225 :
V_14 = F_95 ( F_117 ( V_220 ) , V_124 , V_107 ) ;
break;
case V_226 :
V_14 = F_97 ( F_117 ( V_220 ) , V_124 , V_107 , 0 ) ;
break;
default:
F_11 ( L_51 , V_221 ) ;
V_14 = - V_135 ;
...
switch ( V_221 ) {
case V_228 :
V_14 = F_81 ( F_117 ( V_220 ) , V_124 , V_107 , 0 ) ;
break;
case V_229 :
V_14 = F_91 ( F_117 ( V_220 ) , V_124 , V_107 ) ;
break;
case V_230 :
case V_231 : {
struct V_232 V_233 ;
...
struct V_1 * F_124 ( struct V_79 * V_79 ,
const struct V_1 * V_86 ,
const struct V_155 * V_156 )
{
int V_14 ;
...
V_14 = F_58 ( V_79 , V_117 , V_170 , V_156 ) ;
if ( V_14 != 0 )
goto V_236;
V_235 = F_125 ( V_79 , V_86 , & V_234 , V_117 ) ;
if ( F_48 ( V_235 ) ) {
V_14 = F_49 ( V_235 ) ;
goto V_236;
}
...
void F_126 ( struct V_79 * V_79 , struct V_1 * V_86 )
{
struct V_74 * V_75 ;
void * V_170 ;
...
static inline bool
F_128 ( T_7 V_239 , T_7 V_240 , T_7 V_241 ,
T_7 type , T_7 V_242 ,
bool V_243 )
{
...
static bool
F_129 ( const struct V_5 * V_6 , struct V_40 * V_41 )
{
...
if ( V_41 -> V_12 != 0 )
return false ;
V_245 = F_130 ( V_6 , V_41 -> V_102 , sizeof( V_246 ) , & V_246 ) ;
if ( V_245 == NULL ) {
F_11 ( L_57 ) ;
V_41 -> V_13 = true ;
return false ;
}
return F_128 ( V_248 -> type ,
V_248 -> V_242 [ 0 ] ,
V_248 -> V_242 [ 1 ] ,
V_245 -> V_249 , V_245 -> V_250 ,
! ! ( V_248 -> V_28 & V_251 ) ) ;
}
static int F_131 ( const struct V_137 * V_41 )
{
const struct V_247 * V_248 = V_41 -> V_105 ;
return ( V_248 -> V_28 & ~ V_251 ) ? - V_135 : 0 ;
}
static int T_8 F_132 ( struct V_79 * V_79 )
{
return F_133 ( V_79 , V_97 ) ;
}
static void T_9 F_134 ( struct V_79 * V_79 )
{
F_135 ( V_79 , V_97 ) ;
}
...
if ( V_14 < 0 )
goto V_253;
V_14 = F_138 ( V_254 , F_139 ( V_254 ) ) ;
if ( V_14 < 0 )
goto V_255;
V_14 = F_140 ( V_256 , F_139 ( V_256 ) ) ;
if ( V_14 < 0 )
goto V_257;
V_14 = F_141 ( & V_258 ) ;
if ( V_14 < 0 )
...
return 0 ;
V_259:
F_143 ( V_256 , F_139 ( V_256 ) ) ;
V_257:
F_144 ( V_254 , F_139 ( V_254 ) ) ;
V_255:
F_145 ( & V_252 ) ;
V_253:
return V_14 ;
