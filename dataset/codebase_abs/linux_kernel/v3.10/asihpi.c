...
struct V_50 V_153 ;
int V_33 ;
V_83 = F_86 ( sizeof( * V_83 ) , V_154 ) ;
if ( V_83 == NULL )
return - V_93 ;
V_33 = F_87 ( V_85 -> V_155 -> V_156 -> V_157 ,
V_37 -> V_109 , & V_83 -> V_1 ) ;
F_52 ( V_33 ) ;
if ( V_33 )
F_60 ( V_83 ) ;
...
static int F_104 ( struct V_48 * V_49 , int V_190 )
{
struct V_191 * V_192 ;
int V_33 ;
T_1 V_193 , V_194 , V_195 ;
T_2 V_196 ;
V_33 = F_105 ( V_49 -> V_155 -> V_156 -> V_157 ,
& V_194 , & V_193 ,
& V_195 , & V_196 , & V_195 ) ;
V_33 = F_106 ( V_49 -> V_85 , L_47 , V_190 ,
V_194 , V_193 , & V_192 ) ;
if ( V_33 < 0 )
return V_33 ;
F_107 ( V_192 , V_107 ,
...
static inline int F_110 ( struct V_202 * V_85 , struct V_203 * V_204 ,
struct V_48 * V_49 )
{
int V_33 ;
V_33 = F_111 ( V_85 , F_112 ( V_204 , V_49 ) ) ;
if ( V_33 < 0 )
return V_33 ;
else if ( V_205 )
...
static void F_113 ( struct V_203 * V_206 ,
struct V_207 * V_208 ,
char * V_40 )
{
char * V_209 ;
...
F_52 ( F_124 ( V_52 , V_240 ) ) ;
return V_239 ;
}
static int F_125 ( struct V_48 * V_49 ,
struct V_207 * V_208 )
{
...
V_33 = F_110 ( V_85 , & V_206 , V_49 ) ;
if ( V_33 )
return V_33 ;
if ( F_122 ( V_208 -> V_52 , & V_240 ) == 0 ) {
F_113 ( & V_206 , V_208 , L_56 ) ;
V_206 . V_242 = V_243 ;
V_206 . V_174 = V_249 ;
V_206 . V_245 = F_121 ;
V_206 . V_246 = F_123 ;
...
static int F_126 ( struct V_223 * V_224 ,
struct V_225 * V_226 )
{
T_2 V_52 = V_224 -> V_210 ;
T_1 V_33 ;
...
struct V_202 * V_85 = V_49 -> V_85 ;
struct V_203 V_206 ;
F_113 ( & V_206 , V_208 , L_58 ) ;
V_206 . V_242 = V_243 ;
V_206 . V_174 = F_133 ;
V_206 . V_245 = F_137 ;
V_206 . V_246 = F_138 ;
if ( F_110 ( V_85 , & V_206 , V_49 ) < 0 )
return - V_47 ;
F_113 ( & V_206 , V_208 , L_59 ) ;
V_206 . V_242 =
V_262 | V_263 ;
V_206 . V_174 = F_139 ;
V_206 . V_245 = F_140 ;
...
F_52 ( F_164 ( V_52 , V_281 ) ) ;
return 1 ;
}
static int F_165 ( struct V_48 * V_49 ,
struct V_207 * V_208 )
{
struct V_202 * V_85 = V_49 -> V_85 ;
struct V_203 V_206 ;
V_206 . V_210 = V_208 -> V_52 ;
V_206 . V_242 = V_243 ;
if ( ! F_149 ( V_208 -> V_52 , NULL ) ) {
F_113 ( & V_206 , V_208 , L_60 ) ;
V_206 . V_174 = F_146 ;
V_206 . V_245 = F_148 ;
V_206 . V_246 = F_150 ;
if ( F_110 ( V_85 , & V_206 , V_49 ) < 0 )
...
F_113 ( & V_206 , V_208 , L_61 ) ;
V_206 . V_174 = F_154 ;
V_206 . V_245 = F_155 ;
V_206 . V_246 = F_157 ;
if ( F_110 ( V_85 , & V_206 , V_49 ) < 0 )
return - V_47 ;
F_113 ( & V_206 , V_208 , L_62 ) ;
V_206 . V_174 = F_159 ;
V_206 . V_245 = F_161 ;
V_206 . V_246 = F_163 ;
return F_110 ( V_85 , & V_206 , V_49 ) ;
...
static int F_167 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
T_2 V_52 = V_224 -> V_210 ;
short V_238 [ V_232 ] , V_270 ;
T_1 V_33 ;
V_33 = F_168 ( V_52 , V_238 ) ;
...
static int F_170 ( struct V_223 * V_206 )
{
T_2 V_52 = V_206 -> V_210 ;
struct V_207 V_208 ;
int V_103 , V_33 ;
for ( V_103 = 0 ; V_103 < 32 ; V_103 ++ ) {
V_33 = F_171 ( V_52 , V_103 ,
& V_208 .
V_213 ,
& V_208 .
V_220 ) ;
...
static int F_173 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
T_2 V_52 = V_224 -> V_210 ;
T_1 V_284 , V_285 ;
...
static int F_175 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
int V_239 ;
T_2 V_52 = V_224 -> V_210 ;
...
static int F_178 ( struct V_223 * V_224 ,
struct V_225 * V_226 )
{
...
static int F_180 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
T_2 V_52 = V_224 -> V_210 ;
T_1 V_288 ;
...
static int F_186 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
struct V_48 * V_49 =
(struct V_48 * ) ( V_224 -> V_84 ) ;
...
static int F_189 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
struct V_48 * V_49 =
(struct V_48 * ) ( V_224 -> V_84 ) ;
...
static int F_195 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
int V_239 ;
T_2 V_52 = V_224 -> V_210 ;
...
static int F_198 ( struct V_223 * V_224 ,
struct V_236 * V_237 )
{
T_2 V_52 = V_224 -> V_210 ;
T_2 V_296 ;
...
switch ( V_208 . V_307 ) {
case V_309 :
V_33 = F_125 ( V_49 , & V_208 ) ;
break;
case V_310 :
V_33 = F_132 ( V_49 , & V_208 ) ;
break;
case V_311 :
V_33 = F_177 ( V_49 , & V_208 ) ;
break;
case V_312 :
V_33 = F_184 ( V_49 , & V_208 ) ;
break;
case V_313 :
V_33 = F_169 ( V_49 , & V_208 , V_304 ) ;
break;
case V_63 :
V_33 = F_199 (
V_49 , & V_208 ) ;
...
continue;
case V_315 :
V_33 = F_165 ( V_49 , & V_208 ) ;
break;
case V_316 :
V_33 = F_145 ( V_49 , & V_208 ) ;
break;
case V_317 :
V_33 = F_142 ( V_49 , & V_208 ) ;
break;
case V_318 :
case V_319 :
case V_320 :
...
int V_33 ;
F_207 ( V_17 , L_83 ) ;
F_52 ( F_105 ( V_49 -> V_155 -> V_156 -> V_157 ,
& V_194 , & V_193 ,
& V_326 , & V_327 , & type ) ) ;
F_207 ( V_17 ,
L_84
...
{
struct V_323 * V_324 ;
if ( ! F_209 ( V_49 -> V_85 , L_88 , & V_324 ) )
F_210 ( V_324 , V_49 , F_206 ) ;
}
...
static int F_212 ( struct V_328 * V_183 , struct V_329 * V_329 )
{
if ( V_330 )
return F_213 ( V_329 ) ;
else
...
static int F_214 ( struct V_328 * V_183 , struct V_329 * V_329 ,
unsigned int V_102 , unsigned long V_148 )
{
if ( V_330 )
return F_215 ( V_329 , V_102 , V_148 ) ;
else
return - V_331 ;
}
...
if ( V_332 )
* V_332 = NULL ;
V_33 = F_217 ( V_49 -> V_85 , L_89 , V_190 , & V_183 ) ;
if ( V_33 < 0 )
return V_33 ;
strcpy ( V_183 -> V_40 , L_90 ) ;
V_183 -> V_211 = V_333 ;
V_183 -> V_334 . V_335 = F_211 ;
V_183 -> V_334 . V_336 = F_214 ;
V_183 -> V_334 . V_337 = F_212 ;
V_183 -> V_84 = V_49 ;
if ( V_332 )
* V_332 = V_183 ;
return 0 ;
}
static int F_218 ( struct V_338 * V_338 ,
...
static void F_227 ( struct V_338 * V_338 )
{
struct V_341 * V_155 = F_220 ( V_338 ) ;
F_226 ( V_155 -> V_202 ) ;
V_155 -> V_202 = NULL ;
F_228 ( V_338 ) ;
}
