...
void F_34 ( struct V_33 * V_8 , struct V_3 * V_4 )
{
F_31 ( V_8 , V_4 , NULL , F_15 ) ;
}
void F_35 ( struct V_33 * V_8 , struct V_3 * V_4 ,
struct V_3 * V_34 )
{
F_31 ( V_8 , V_4 , V_34 , F_20 ) ;
}
...
struct V_37 * V_2 ;
struct V_38 * V_39 ;
V_39 = F_38 ( F_39 ( & V_8 -> V_40 ) ) ;
V_2 = V_36 ? F_38 ( V_36 -> V_41 ) : NULL ;
while ( V_2 || V_39 ) {
struct V_1 * V_42 , * V_43 , * V_44 ;
V_43 = V_2 ? V_2 -> V_42 : NULL ;
V_44 = V_39 ? F_40 ( V_39 , struct V_1 , V_45 ) :
NULL ;
V_42 = ( unsigned long ) V_43 > ( unsigned long ) V_44 ?
V_43 : V_44 ;
V_25 = F_29 ( V_25 , V_42 , V_4 , F_26 ) ;
if ( F_33 ( V_25 ) )
goto V_32;
