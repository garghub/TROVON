...
V_234 = F_74 ( V_234 ) ;
do {
V_239 = F_75 ( V_49 -> V_65 . V_227 ,
V_234 , type , 1 ) ;
V_234 >>= 1 ;
} while ( V_234 >= V_233 && V_239 == - V_107 );
}
}
#endif
}
...
switch ( V_232 ) {
case 1 :
V_49 -> V_240 = F_77 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
break;
case 2 :
V_49 -> V_240 = F_78 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
break;
case 3 :
V_49 -> V_240 = F_79 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
break;
case 4 :
default:
V_49 -> V_240 = F_80 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
break;
}
#else
V_49 -> V_240 = F_80 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
...
static T_2 F_81 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
return snprintf ( V_19 , V_233 , L_62 , V_53 -> V_104 . V_108 ) ;
}
static T_2 F_84 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
int V_245 = 0 , V_86 ;
for ( V_86 = 0 ; V_86 < V_53 -> V_90 && V_245 < V_233 ; V_86 ++ ) {
V_245 += snprintf ( V_19 + V_245 , V_233 - V_245 ,
L_63 ,
...
static T_2 F_85 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_2 F_86 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_2 F_87 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_2 F_88 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_2 F_89 ( struct V_241 * V_242 ,
struct V_243 * V_244 , char * V_19 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
...
static T_2 F_90 ( struct V_241 * V_242 ,
struct V_243 * V_244 , const char * V_19 , T_3 V_164 )
{
struct V_48 * V_49 = F_82 ( F_83 ( V_242 ) ) ;
struct V_52 * V_53 = V_49 -> V_53 ;
if ( V_164 > 0 ) {
...
static int F_91 ( struct V_246 * V_242 )
{
struct V_48 * V_49 ;
struct V_50 * V_51 = NULL ;
struct V_52 * V_53 ;
int V_26 = 0 , V_86 ;
V_49 = F_92 ( sizeof( * V_53 ) + sizeof( V_106 ) * 256 , & V_242 -> V_242 ) ;
if ( ! V_49 )
return - V_31 ;
V_53 = V_49 -> V_53 ;
V_26 = F_41 ( V_49 ) ;
...
if ( F_93 ( & V_49 -> V_174 , 256 , 0 ) < 0 ) {
V_26 = - V_248 ;
goto V_36;
}
F_71 ( V_49 , V_51 ) ;
if ( ! F_94 ( 0x3c0 , 32 , L_67 ) ) {
F_9 ( V_38 L_68 ) ;
V_26 = - V_249 ;
goto V_250;
}
if ( ! F_95 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ,
L_67 ) ) {
F_9 ( V_38 L_69
...
V_49 -> V_240 , V_49 -> V_65 . V_66 / 1024 ,
V_53 -> V_104 . V_224 * 64 ) ;
F_9 ( V_110 L_76 , V_49 -> V_254 ,
V_49 -> V_65 . V_32 ) ;
V_26 = F_98 ( & V_242 -> V_242 . V_255 , & V_256 ) ;
if ( V_26 != 0 )
F_9 ( V_28 L_77 ,
V_49 -> V_254 ) ;
return 0 ;
...
F_99 ( V_49 -> V_240 ) ;
V_252:
F_100 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
V_251:
F_101 ( 0x3c0 , 32 ) ;
V_250:
if ( ! F_102 ( & V_49 -> V_145 ) )
F_103 ( & V_49 -> V_145 ) ;
F_104 ( V_49 -> V_129 . V_149 ) ;
F_105 ( & V_49 -> V_174 ) ;
V_36:
if ( V_53 -> V_91 )
F_17 ( V_53 -> V_91 ) ;
...
static int F_107 ( struct V_246 * V_242 )
{
struct V_48 * V_49 = F_82 ( V_242 ) ;
if ( V_49 ) {
struct V_52 * V_53 = V_49 -> V_53 ;
F_108 ( & V_242 -> V_242 . V_255 , & V_256 ) ;
F_109 ( V_49 ) ;
F_101 ( 0x3c0 , 32 ) ;
F_99 ( V_49 -> V_240 ) ;
F_100 ( V_49 -> V_65 . V_227 , V_49 -> V_65 . V_66 ) ;
...
static int F_110 ( char * V_258 )
{
char * V_259 ;
if ( ! V_258 || ! * V_258 )
return 0 ;
while ( ( V_259 = F_111 ( & V_258 , L_78 ) ) != NULL ) {
if ( ! * V_259 ) continue;
if ( ! strcmp ( V_259 , L_79 ) )
V_64 = 0 ;
else if ( ! strcmp ( V_259 , L_60 ) )
V_64 = 1 ;
else if ( ! strcmp ( V_259 , L_59 ) )
V_64 = 2 ;
else if ( ! strcmp ( V_259 , L_80 ) )
V_123 = 0 ;
else if ( ! strcmp ( V_259 , L_81 ) )
V_123 = 1 ;
else if ( ! strncmp ( V_259 , L_82 , 5 ) )
V_232 = F_112 ( V_259 + 5 , NULL , 0 ) ;
else if ( ! strcmp ( V_259 , L_83 ) )
V_232 = 0 ;
else if ( ! strcmp ( V_259 , L_84 ) )
V_136 = 1 ;
else if ( ! strcmp ( V_259 , L_85 ) )
V_131 = 1 ;
else if ( ! strcmp ( V_259 , L_86 ) )
V_179 = 0 ;
else if ( ! strncmp ( V_259 , L_87 , 7 ) )
V_225 = F_112 ( V_259 + 7 , NULL , 0 ) ;
else if ( ! strncmp ( V_259 , L_88 , 7 ) )
V_226 = F_112 ( V_259 + 7 , NULL , 0 ) ;
else if ( ! strncmp ( V_259 , L_89 , 6 ) )
V_139 = F_112 ( V_259 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_259 , L_90 , 6 ) )
V_138 = F_112 ( V_259 + 6 , NULL , 0 ) ;
else if ( ! strncmp ( V_259 , L_91 , 7 ) )
V_137 = F_112 ( V_259 + 7 , NULL , 0 ) ;
else if ( ! strncmp ( V_259 , L_92 , 8 ) )
V_156 = F_112 ( V_259 + 8 , NULL , 0 ) ;
else if ( V_259 [ 0 ] >= '0' && V_259 [ 0 ] <= '9' ) {
V_160 = V_259 ;
} else {
F_9 ( V_28
L_93 , V_259 ) ;
...
static T_2 F_113 ( struct V_260 * V_242 , char * V_19 )
{
return snprintf ( V_19 , V_233 , L_64 , V_23 ) ;
}
static T_2 F_114 ( struct V_260 * V_242 , const char * V_19 ,
T_3 V_164 )
{
strncpy ( V_23 , V_19 , V_261 ) ;
return V_164 ;
}
...
F_124 ( & V_33 ) ;
F_127 ( & V_264 . V_266 , & V_267 ) ;
F_128 ( V_265 ) ;
F_123 ( & V_264 ) ;
}
static int F_129 ( const char * V_268 , const struct V_269 * V_270 )
{
V_64 = 0 ;
if ( ! strcmp ( V_268 , L_79 ) )
V_64 = 0 ;
else if ( ! strcmp ( V_268 , L_60 ) )
V_64 = 1 ;
else if ( ! strcmp ( V_268 , L_59 ) )
V_64 = 2 ;
else
return - V_107 ;
return 0 ;
