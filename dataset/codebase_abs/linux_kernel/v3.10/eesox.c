...
static int F_25 ( struct V_74 * V_75 , struct V_10 * V_11 )
{
struct V_4 * V_5 ;
...
static T_5 F_30 ( struct V_23 * V_24 , struct V_76 * V_77 , char * V_42 )
{
...
static T_5 F_33 ( struct V_23 * V_24 , struct V_76 * V_77 , const char * V_42 , T_6 V_78 )
{
struct V_1 * V_2 = F_31 ( V_24 ) ;
struct V_10 * V_11 = F_32 ( V_2 ) ;
struct V_4 * V_5 = (struct V_4 * ) V_11 -> V_13 ;
...
static int F_34 ( struct V_1 * V_2 , const struct V_79 * V_80 )
{
struct V_10 * V_11 ;
struct V_4 * V_5 ;
void T_4 * V_44 ;
...
V_5 -> V_44 = V_44 ;
V_5 -> V_9 = V_44 + V_86 ;
V_5 -> V_7 = V_87 [ V_2 -> V_69 ] ? V_16 : 0 ;
F_2 ( V_5 -> V_7 , V_5 -> V_9 ) ;
V_5 -> V_5 . V_26 . V_88 = V_44 + V_46 ;
V_5 -> V_5 . V_26 . V_89 = V_54 ;
V_5 -> V_5 . V_26 . V_17 = V_2 -> V_17 ;
V_5 -> V_5 . V_26 . V_27 = V_2 -> V_27 ;
V_5 -> V_5 . V_90 . V_91 = 40 ;
V_5 -> V_5 . V_90 . V_92 = 255 ;
V_5 -> V_5 . V_90 . V_93 = 200 ;
V_5 -> V_5 . V_90 . V_94 = 7 ;
V_5 -> V_5 . V_90 . V_95 = V_96 | V_97 ;
V_5 -> V_5 . V_90 . V_98 = 1 ;
V_5 -> V_5 . V_90 . V_99 = 0 ;
V_5 -> V_5 . V_90 . V_100 = V_101 ;
V_5 -> V_5 . V_27 . V_102 = F_9 ;
V_5 -> V_5 . V_27 . V_103 = F_22 ;
V_5 -> V_5 . V_27 . V_104 = F_23 ;
V_2 -> V_105 = V_44 + V_48 ;
V_2 -> V_106 = V_107 ;
F_39 ( V_2 , & V_108 , V_5 ) ;
F_40 ( & V_2 -> V_24 , & V_109 ) ;
...
if ( V_72 )
goto V_110;
V_72 = F_42 ( V_2 -> V_17 , F_7 , 0 , L_9 , V_5 ) ;
if ( V_72 ) {
F_43 ( L_10 ,
V_11 -> V_111 , V_2 -> V_17 , V_72 ) ;
goto V_112;
}
if ( V_5 -> V_5 . V_26 . V_27 != V_28 ) {
if ( F_44 ( V_5 -> V_5 . V_26 . V_27 , L_11 ) ) {
F_43 ( L_12 ,
V_11 -> V_111 , V_5 -> V_5 . V_26 . V_27 ) ;
V_5 -> V_5 . V_26 . V_27 = V_28 ;
} else {
F_45 ( V_5 -> V_5 . V_26 . V_27 , 180 ) ;
V_5 -> V_5 . V_90 . V_100 |= V_113 ;
V_5 -> V_5 . V_90 . V_95 |= V_114 ;
}
}
V_72 = F_46 ( V_11 , & V_2 -> V_24 ) ;
if ( V_72 == 0 )
goto V_81;
if ( V_5 -> V_5 . V_26 . V_27 != V_28 )
F_47 ( V_5 -> V_5 . V_26 . V_27 ) ;
F_48 ( V_2 -> V_17 , V_11 ) ;
V_112:
F_49 ( V_11 ) ;
V_110:
