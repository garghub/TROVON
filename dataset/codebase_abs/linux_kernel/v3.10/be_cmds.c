...
memset ( & V_424 , 0 , sizeof( struct V_124 ) ) ;
if ( ! F_18 ( V_2 ) )
V_424 . V_174 = sizeof( struct V_610 ) ;
else
...
V_192 -> V_195 . V_217 = V_217 ;
V_192 -> V_578 = F_68 ( 1 ) ;
V_192 -> V_614 . V_583 = V_584 ;
V_192 -> V_614 . V_581 = V_582 ;
V_192 -> V_614 . V_26 = ( 1 << V_615 ) | ( 1 << V_616 ) | ( 1 << V_617 ) ;
V_192 -> V_614 . V_592 = V_2 -> V_591 ;
V_192 -> V_614 . V_618 = V_217 ;
V_192 -> V_614 . V_594 = 0xFFFF ;
V_192 -> V_614 . V_619 = 0xFFFF ;
V_192 -> V_614 . V_596 = 0xFFFF ;
V_192 -> V_614 . V_598 = 0xFFFF ;
V_192 -> V_614 . V_600 = 0xFFFF ;
V_192 -> V_614 . V_604 = 0xFFFF ;
V_192 -> V_614 . V_602 = 0xFFFF ;
V_192 -> V_614 . V_620 = 0xFFFF ;
V_192 -> V_614 . V_621 = 0xFFFF ;
V_192 -> V_614 . V_622 = 0xFFFF ;
V_192 -> V_614 . V_606 = 0xFFFF ;
V_192 -> V_614 . V_623 = 0xFF ;
V_192 -> V_614 . V_624 = 0xFFFFFFFF ;
V_192 -> V_614 . V_625 = 0xFF ;
V_192 -> V_614 . V_626 = 0x0F ;
V_192 -> V_614 . V_624 = F_68 ( V_499 ) ;
V_192 -> V_614 . V_627 = F_68 ( V_499 ) ;
V_35 = F_47 ( V_2 ) ;
V_146:
F_35 ( & V_2 -> V_209 ) ;
return V_35 ;
}
int F_164 ( struct V_1 * V_2 , struct V_628 * V_629 ,
int V_618 )
{
struct V_11 * V_12 ;
struct V_630 * V_192 ;
...
V_632 , sizeof( * V_50 ) ,
V_12 , NULL ) ;
V_192 -> V_195 . V_217 = V_618 + 1 ;
V_35 = F_47 ( V_2 ) ;
if ( ! V_35 ) {
V_50 = (struct V_631 * ) V_192 ;
V_629 -> V_206 = F_8 ( V_50 -> V_633 . V_213 ) ;
}
V_146:
F_35 ( & V_2 -> V_209 ) ;
return V_35 ;
}
int F_165 ( struct V_1 * V_2 , T_1 V_217 )
{
struct V_11 * V_12 ;
struct V_634 * V_192 ;
int V_35 ;
...
int F_166 ( struct V_1 * V_2 , bool V_636 )
{
struct V_11 * V_12 ;
struct V_637 * V_192 ;
int V_35 ;
...
int F_167 ( void * V_640 , void * V_641 ,
int V_642 , T_3 * V_643 , T_3 * V_644 )
{
struct V_1 * V_2 = F_168 ( V_640 ) ;
struct V_11 * V_12 ;
struct V_160 * V_195 = (struct V_160 * ) V_641 ;
struct V_160 * V_192 ;
struct V_28 * V_50 ;
int V_35 ;
F_33 ( & V_2 -> V_209 ) ;
...
V_195 -> V_3 , V_642 , V_12 , NULL ) ;
memcpy ( V_192 , V_641 , V_642 ) ;
F_69 ( V_192 , V_642 ) ;
V_35 = F_47 ( V_2 ) ;
if ( V_643 )
* V_643 = ( V_35 & 0xffff ) ;
if ( V_644 )
* V_644 = 0 ;
memcpy ( V_641 , V_50 , sizeof( * V_50 ) + V_50 -> V_562 ) ;
F_12 ( V_641 , sizeof( * V_50 ) + V_50 -> V_562 ) ;
V_146:
F_35 ( & V_2 -> V_209 ) ;
return V_35 ;
}
