...
V_20 = F_22 ( & V_18 -> V_26 , sizeof( * V_20 ) , V_34 ) ;
if ( ! V_20 ) {
V_25 = - V_35 ;
goto V_36;
}
...
memcpy ( V_4 , V_18 -> V_26 . V_28 , sizeof( * V_4 ) ) ;
}
if ( V_4 -> V_14 ) {
F_3 ( V_4 -> V_5 , 1 ) ;
V_22 -> V_37 = F_4 ;
...
V_24 -> V_42 = V_43 ;
if ( V_18 -> V_26 . V_27 )
F_23 ( V_24 -> V_44 , F_24 ( & V_18 -> V_26 ) , sizeof( V_24 -> V_44 ) ) ;
else
snprintf ( V_24 -> V_44 , sizeof( V_24 -> V_44 ) , L_9 , V_18 -> V_45 ) ;
V_24 -> V_46 = V_22 ;
V_24 -> V_47 = V_48 | V_49 ;
V_24 -> V_26 . V_50 = & V_18 -> V_26 ;
