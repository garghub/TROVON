...
if ( V_18 -> V_4 == NULL || ! V_18 -> V_68 )
return;
F_3 ( V_2 , V_18 -> V_4 ) ;
}
static int
F_13 ( struct V_67 * V_18 , struct V_69 * V_70 ,
...
int F_18 ( struct V_16 * V_17 , unsigned int V_53 )
{
struct V_1 * V_2 ;
int V_76 ;
V_2 = F_19 ( sizeof( * V_2 ) , V_77 ) ;
if ( V_2 == NULL )
return - V_78 ;
V_2 -> V_53 = V_53 ;
V_2 -> V_22 = 255 ;
V_76 = F_20 ( V_17 -> V_54 , & V_2 -> V_18 , 1 ,
& V_79 , V_80 ,
F_21 ( V_80 ) , false ) ;
if ( V_76 < 0 )
F_17 ( V_2 ) ;
