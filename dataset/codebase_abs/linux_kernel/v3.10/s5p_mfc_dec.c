...
if ( V_106 -> type == V_72 )
V_77 = F_36 ( & V_13 -> V_78 , V_106 , V_27 -> V_117 & V_118 ) ;
else if ( V_106 -> type == V_57 ) {
V_77 = F_36 ( & V_13 -> V_80 , V_106 , V_27 -> V_117 & V_118 ) ;
if ( V_77 == 0 && V_13 -> V_15 == V_119 &&
F_37 ( & V_13 -> V_80 . V_120 ) )
...
struct V_12 * V_13 = F_15 ( V_28 ) ;
if ( V_123 -> type == V_72 )
return F_40 ( & V_13 -> V_78 , V_123 ) ;
if ( V_123 -> type == V_57 )
return F_40 ( & V_13 -> V_80 , V_123 ) ;
return - V_52 ;
}
...
F_3 ( 2 , L_29 , V_13 -> V_130 ) ;
}
V_77 = F_42 ( & V_13 -> V_78 , type ) ;
}
else if ( type == V_57 )
V_77 = F_42 ( & V_13 -> V_80 , type ) ;
F_20 () ;
return V_77 ;
}
...
struct V_12 * V_13 = F_15 ( V_28 ) ;
if ( type == V_72 )
return F_44 ( & V_13 -> V_78 , type ) ;
else if ( type == V_57 )
return F_44 ( & V_13 -> V_80 , type ) ;
return - V_52 ;
}
...
F_3 ( 2 , L_35
L_36 , V_145 -> V_157 . V_60 , V_145 -> V_157 . V_62 , V_13 -> V_61 ,
V_13 -> V_63 ) ;
}
return 0 ;
}
