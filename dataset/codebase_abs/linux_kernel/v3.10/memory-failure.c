...
int F_147 ( struct V_1 * V_1 , int V_30 )
{
int V_33 ;
unsigned long V_29 = F_31 ( V_1 ) ;
struct V_1 * V_96 = F_148 ( V_1 ) ;
if ( F_93 ( V_1 ) ) {
F_30 ( L_40 , V_29 ) ;
return - V_104 ;
}
...
static int F_149 ( struct V_1 * V_1 , int V_30 )
{
int V_33 ;
unsigned long V_29 = F_31 ( V_1 ) ;
F_94 ( V_1 ) ;
