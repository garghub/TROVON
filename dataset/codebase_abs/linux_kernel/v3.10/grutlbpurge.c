...
if ( V_38 -> V_51 ) {
F_36 () ;
F_37 (mn, &mm->mmu_notifier_mm->list,
hlist)
if ( V_36 -> V_49 == V_49 ) {
V_50 = V_36 ;
break;
...
struct V_35 * V_36 ;
int V_52 ;
V_36 = F_35 ( V_53 -> V_38 , & V_54 ) ;
if ( V_36 ) {
V_11 = F_27 ( V_36 , struct V_10 , V_40 ) ;
F_28 ( & V_11 -> V_55 ) ;
} else {
V_11 = F_40 ( sizeof( * V_11 ) , V_56 ) ;
if ( V_11 ) {
F_16 ( V_57 ) ;
F_41 ( & V_11 -> V_27 ) ;
V_11 -> V_40 . V_49 = & V_54 ;
...
{
F_17 ( V_25 , L_10 , V_11 ,
F_29 ( & V_11 -> V_55 ) , V_11 -> V_47 ) ;
if ( F_48 ( & V_11 -> V_55 ) == 0 ) {
if ( ! V_11 -> V_47 )
F_49 ( & V_11 -> V_40 , V_53 -> V_38 ) ;
F_45 ( V_11 ) ;
F_16 ( V_58 ) ;
}
}
...
if ( V_59 ) {
V_3 = 1 << F_52 ( V_59 - 1 ) ;
V_60 = F_53 ( 0 , F_52 ( V_3 - 1 ) - F_52 ( V_61 - 1 ) ) ;
}
V_2 -> V_6 = V_60 ;
V_2 -> V_5 = ( V_59 + ( 1 << V_60 ) - 1 ) >> V_60 ;
}
