...
T_2 V_82 = V_95 -> V_82 ;
int V_97 ;
if ( ! F_62 ( V_54 -> V_98 && V_54 -> V_98 -> V_99 ) )
return - V_100 ;
...
int V_24 ;
if ( F_41 ( ! ( V_107 -> V_126 & V_127 ) ) )
return - V_128 ;
if ( F_41 ( V_107 -> V_129 & V_130 ) )
return - V_100 ;
V_24 = F_89 ( V_131 , V_107 , V_56 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
if ( V_107 -> V_98 && V_107 -> V_98 -> F_88 )
F_88 = V_107 -> V_98 -> F_88 ;
else
F_88 = F_85 ;
F_90 ( V_107 ) ;
V_24 = F_88 ( V_2 , V_107 , V_56 , V_39 , V_10 ) ;
F_91 ( V_107 ) ;
return V_24 ;
}
...
int V_24 ;
if ( F_41 ( ! ( V_55 -> V_126 & V_132 ) ) )
return - V_128 ;
V_24 = F_89 ( V_133 , V_55 , V_56 , V_39 ) ;
if ( F_41 ( V_24 < 0 ) )
return V_24 ;
if ( V_55 -> V_98 && V_55 -> V_98 -> F_93 )
F_93 = V_55 -> V_98 -> F_93 ;
else
F_93 = F_57 ;
return F_93 ( V_55 , V_56 , V_2 , V_39 , V_10 ) ;
}
T_1 F_94 ( struct V_54 * V_55 , struct V_94 * V_95 ,
T_7 * V_114 )
{
struct V_1 * V_2 ;
long V_24 , V_134 ;
...
T_3 V_39 ;
int V_49 , V_10 ;
V_135 = F_95 ( V_55 ) -> V_135 ;
if ( F_41 ( ! F_96 ( V_135 ) && ! F_97 ( V_135 ) ) )
return - V_100 ;
V_2 = V_29 -> V_136 ;
if ( F_41 ( ! V_2 ) ) {
V_2 = F_98 () ;
...
{
struct V_54 * V_54 = V_95 -> V_96 . V_54 ;
return F_87 ( V_2 , V_54 , V_95 -> V_140 , V_95 -> V_103 ,
V_95 -> V_10 ) ;
}
long F_100 ( struct V_54 * V_55 , T_2 * V_56 , struct V_54 * V_107 ,
...
long V_24 ;
V_24 = F_94 ( V_55 , & V_95 , F_99 ) ;
if ( V_24 > 0 )
* V_56 = V_95 . V_82 ;
return V_24 ;
}
static long F_101 ( struct V_54 * V_55 , T_2 V_84 * V_141 ,
...
if ( V_143 == V_144 )
return - V_100 ;
return F_103 ( V_143 , V_144 , V_39 , V_10 ) ;
}
if ( V_143 ) {
if ( V_141 )
return - V_145 ;
...
return - V_100 ;
if ( F_104 ( & V_37 , V_142 , sizeof( T_2 ) ) )
return - V_147 ;
} else {
V_37 = V_107 -> V_148 ;
}
...
if ( ! ( V_55 -> V_126 & V_149 ) )
return - V_100 ;
if ( F_104 ( & V_37 , V_141 , sizeof( T_2 ) ) )
return - V_147 ;
} else {
V_37 = V_55 -> V_148 ;
}
V_24 = F_92 ( V_55 , & V_37 , V_144 , V_39 , V_10 ) ;
if ( ! V_141 )
V_55 -> V_148 = V_37 ;
...
int V_49 ;
error = - V_147 ;
if ( F_104 ( & V_156 , V_150 , sizeof( V_156 ) ) )
break;
V_157 = V_156 . V_92 ;
V_39 = V_156 . V_93 ;
error = 0 ;
...
static int F_103 ( struct V_1 * V_143 ,
struct V_1 * V_144 ,
T_3 V_39 , unsigned int V_10 )
{
...
unsigned int V_10 )
{
struct V_1 * V_143 = F_102 ( V_55 ) ;
struct V_1 * V_144 = F_102 ( V_107 ) ;
int V_24 = - V_100 ;
