...
static int F_69 ( struct V_43 * V_167 )
{
struct V_161 * V_42 = V_161 ( V_167 ) ;
struct V_168 * V_169 = F_70 ( V_42 ) ;
struct V_160 * V_53 ;
struct V_1 * V_1 ;
int V_31 ;
V_31 = F_71 ( - 1 , NULL , V_170 , sizeof( * V_1 ) , & V_53 ) ;
if ( V_31 < 0 )
return V_31 ;
F_72 ( V_53 , V_167 ) ;
V_1 = V_53 -> V_88 ;
...
static int F_80 ( struct V_43 * V_179 )
{
struct V_1 * V_1 = F_81 ( V_179 ) ;
F_6 ( V_1 ) ;
F_82 ( V_1 -> V_53 ) ;
F_41 ( & V_1 -> V_95 ) ;
F_37 ( V_1 ) ;
...
static void F_84 ( struct V_161 * V_42 )
{
