...
static int F_52 ( struct V_458 * V_459 )
{
struct V_34 * V_35 ;
int V_32 ;
V_35 = F_53 ( & V_459 -> V_9 , sizeof( * V_35 ) , V_460 ) ;
if ( ! V_35 )
return - V_461 ;
F_54 ( V_459 , V_35 ) ;
...
static int F_59 ( struct V_458 * V_459 )
{
F_60 ( & V_459 -> V_9 ) ;
return 0 ;
}
static int F_61 ( struct V_465 * V_466 ,
const struct V_467 * V_302 )
{
struct V_34 * V_35 ;
int V_32 ;
V_35 = F_53 ( & V_466 -> V_9 , sizeof( * V_35 ) , V_460 ) ;
if ( ! V_35 )
return - V_461 ;
F_62 ( V_466 , V_35 ) ;
V_35 -> V_418 = F_63 ( V_466 , & V_462 ) ;
if ( F_56 ( V_35 -> V_418 ) ) {
V_32 = F_57 ( V_35 -> V_418 ) ;
F_14 ( & V_466 -> V_9 , L_43 , V_32 ) ;
return V_32 ;
}
V_32 = F_58 ( & V_466 -> V_9 ,
& V_463 , V_464 ,
F_28 ( V_464 ) ) ;
if ( V_32 < 0 )
F_14 ( & V_466 -> V_9 , L_44 , V_32 ) ;
return V_32 ;
}
static int F_64 ( struct V_465 * V_468 )
{
F_60 ( & V_468 -> V_9 ) ;
return 0 ;
}
