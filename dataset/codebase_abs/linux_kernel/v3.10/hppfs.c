...
static int F_52 ( struct V_2 * V_2 , struct V_20 * V_20 )
{
struct V_50 * V_54 = V_20 -> V_52 ;
struct V_20 * V_61 = V_54 -> V_61 ;
if ( V_61 )
...
static int F_54 ( void * V_92 , const char * V_13 , int V_93 ,
...
static int F_55 ( struct V_20 * V_20 , void * V_99 , T_6 V_97 )
{
struct V_50 * V_54 = V_20 -> V_52 ;
struct V_20 * V_61 = V_54 -> V_61 ;
int (* F_56)( struct V_20 * , void * , T_6 );
...
int V_29 ;
F_56 = F_23 ( V_61 ) -> V_41 -> F_56 ;
V_61 -> V_43 = V_20 -> V_43 ;
V_29 = (* F_56)( V_61 , & V_96 , F_54 ) ;
V_20 -> V_43 = V_61 -> V_43 ;
return V_29 ;
}
static int F_57 ( struct V_4 * V_4 , struct V_100 * V_101 )
{
V_101 -> V_102 = 0 ;
V_101 -> V_103 = 0 ;
V_101 -> V_104 = 0 ;
...
static void F_64 ( struct V_110 * V_64 )
{
struct V_2 * V_2 = F_2 ( V_64 , struct V_2 , V_111 ) ;
F_11 ( F_1 ( V_2 ) ) ;
}
...
static int F_67 ( struct V_4 * V_4 , char T_2 * V_112 ,
int V_113 )
{
struct V_4 * V_27 = F_1 ( V_4 -> V_32 ) -> V_27 ;
return V_27 -> V_32 -> V_114 -> V_115 ( V_27 , V_112 ,
V_113 ) ;
}
static void * F_68 ( struct V_4 * V_4 , struct V_116 * V_117 )
{
struct V_4 * V_27 = F_1 ( V_4 -> V_32 ) -> V_27 ;
return V_27 -> V_32 -> V_114 -> V_118 ( V_27 , V_117 ) ;
}
static void F_69 ( struct V_4 * V_4 , struct V_116 * V_117 ,
void * V_119 )
{
struct V_4 * V_27 = F_1 ( V_4 -> V_32 ) -> V_27 ;
if ( V_27 -> V_32 -> V_114 -> V_120 )
V_27 -> V_32 -> V_114 -> V_120 ( V_27 , V_117 , V_119 ) ;
}
static struct V_2 * F_19 ( struct V_5 * V_6 , struct V_4 * V_4 )
{
struct V_2 * V_121 = V_4 -> V_32 ;
struct V_2 * V_2 = F_70 ( V_6 ) ;
if ( ! V_2 ) {
F_62 ( V_4 ) ;
return NULL ;
}
if ( F_71 ( V_4 -> V_32 -> V_122 ) ) {
V_2 -> V_114 = & V_123 ;
V_2 -> V_41 = & V_124 ;
} else if ( F_72 ( V_4 -> V_32 -> V_122 ) ) {
V_2 -> V_114 = & V_125 ;
V_2 -> V_41 = & V_126 ;
} else {
V_2 -> V_114 = & V_127 ;
...
V_2 -> V_129 = V_121 -> V_129 ;
V_2 -> V_130 = V_121 -> V_130 ;
V_2 -> V_131 = V_121 -> V_131 ;
V_2 -> V_132 = V_121 -> V_132 ;
V_2 -> V_133 = V_121 -> V_133 ;
V_2 -> V_122 = V_121 -> V_122 ;
F_73 ( V_2 , V_121 -> V_134 ) ;
V_2 -> V_135 = V_121 -> V_135 ;
V_2 -> V_136 = V_121 -> V_136 ;
return V_2 ;
}
static int F_74 ( struct V_5 * V_6 , void * V_92 , int V_137 )
{
struct V_2 * V_138 ;
struct V_139 * V_140 ;
int V_29 = - V_31 ;
V_140 = F_75 ( F_76 ( V_141 ) -> V_140 ) ;
if ( F_18 ( V_140 ) )
goto V_35;
V_6 -> V_142 = 1024 ;
V_6 -> V_143 = 10 ;
...
V_6 -> V_85 = V_140 ;
V_29 = - V_24 ;
V_138 = F_19 ( V_6 , F_77 ( V_140 -> V_147 ) ) ;
V_6 -> V_10 = F_78 ( V_138 ) ;
if ( ! V_6 -> V_10 )
goto V_148;
return 0 ;
...
static struct V_4 * F_79 ( struct V_149 * type ,
int V_26 , const char * V_150 ,
void * V_54 )
{
