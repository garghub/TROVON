...
if ( ! V_2 -> V_88 )
return 0 ;
F_17 ( V_2 , V_2 -> V_7 -> V_29 + V_30 , & V_119 ) ;
V_117 = F_91 ( V_2 -> V_28 , V_119 , NULL ) ;
while ( V_117 ) {
if ( V_117 -> V_41 && ( V_117 -> V_40 == V_2 ) &&
( V_117 -> V_120 & V_121 ) )
V_118 ++ ;
V_117 = F_91 ( V_2 -> V_28 , V_119 , V_117 ) ;
}
return V_118 ;
}
int F_92 ( struct V_1 * V_2 , T_3 V_122 )
{
if ( ! V_2 -> V_88 || ( V_122 > V_2 -> V_7 -> V_37 ) )
return - V_80 ;
