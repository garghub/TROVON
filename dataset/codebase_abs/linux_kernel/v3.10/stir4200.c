...
if ( ! V_2 -> V_140 ) {
F_75 ( & V_2 -> V_7 -> V_6 , L_16 ) ;
goto V_142;
}
V_2 -> V_87 = F_76 ( F_55 , V_2 ,
L_17 , V_2 -> V_8 -> V_9 ) ;
if ( F_77 ( V_2 -> V_87 ) ) {
V_63 = F_78 ( V_2 -> V_87 ) ;
F_75 ( & V_2 -> V_7 -> V_6 , L_18 ) ;
goto V_143;
}
F_79 ( V_8 ) ;
return 0 ;
...
static int F_84 ( struct V_85 * V_8 )
{
struct V_1 * V_2 = F_31 ( V_8 ) ;
F_32 ( V_8 ) ;
F_85 ( V_2 -> V_87 ) ;
...
static int F_86 ( struct V_85 * V_8 , struct V_144 * V_145 , int V_146 )
{
...
{
struct V_5 * V_6 = F_90 ( V_159 ) ;
struct V_1 * V_2 = NULL ;
struct V_85 * V_162 ;
int V_149 = - V_134 ;
V_162 = F_91 ( sizeof( * V_2 ) ) ;
if( ! V_162 )
goto V_133;
F_92 ( V_162 , & V_159 -> V_6 ) ;
V_2 = F_31 ( V_162 ) ;
V_2 -> V_8 = V_162 ;
V_2 -> V_7 = V_6 ;
V_149 = F_93 ( V_6 ) ;
...
F_94 ( V_163 L_20
L_21 ,
V_6 -> V_139 , F_95 ( V_6 -> V_164 . V_165 ) ,
F_95 ( V_6 -> V_164 . V_166 ) ) ;
F_96 ( & V_2 -> V_141 ) ;
...
static void F_101 ( struct V_158 * V_159 )
{
struct V_1 * V_2 = F_102 ( V_159 ) ;
if ( ! V_2 )
return;
F_103 ( V_2 -> V_8 ) ;
F_100 ( V_2 -> V_8 ) ;
...
static int F_104 ( struct V_158 * V_159 , T_7 V_180 )
{
struct V_1 * V_2 = F_102 ( V_159 ) ;
F_105 ( V_2 -> V_8 ) ;
return 0 ;
}
static int F_106 ( struct V_158 * V_159 )
{
struct V_1 * V_2 = F_102 ( V_159 ) ;
F_107 ( V_2 -> V_8 ) ;
return 0 ;
