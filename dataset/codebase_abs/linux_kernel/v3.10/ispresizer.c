...
static int F_75 ( struct V_244 * V_113 ,
const struct V_245 * V_246 ,
const struct V_245 * V_247 , T_2 V_248 )
{
struct V_207 * V_208 = F_76 ( V_113 ) ;
struct V_2 * V_3 = F_57 ( V_208 ) ;
switch ( V_246 -> V_239 | F_77 ( V_247 -> V_113 ) ) {
case V_12 | V_249 :
if ( V_248 & V_250 ) {
if ( V_3 -> V_129 == V_179 )
return - V_251 ;
...
{
int V_256 ;
V_256 = F_82 ( V_255 , & V_3 -> V_112 ) ;
if ( V_256 < 0 )
goto error;
V_256 = F_83 ( & V_3 -> V_195 , V_255 ) ;
if ( V_256 < 0 )
goto error;
V_256 = F_83 ( & V_3 -> V_186 , V_255 ) ;
if ( V_256 < 0 )
goto error;
return 0 ;
error:
...
struct V_245 * V_257 = V_3 -> V_257 ;
struct V_244 * V_258 = & V_208 -> V_113 ;
int V_256 ;
V_3 -> V_129 = V_252 ;
F_85 ( V_208 , & V_259 ) ;
V_208 -> V_260 = & V_261 ;
...
F_87 ( V_208 , V_3 ) ;
V_208 -> V_248 |= V_263 ;
V_257 [ V_12 ] . V_248 = V_264 ;
V_257 [ V_115 ] . V_248 = V_265 ;
V_258 -> V_266 = & V_267 ;
V_256 = F_88 ( V_258 , V_268 , V_257 , 0 ) ;
if ( V_256 < 0 )
return V_256 ;
F_74 ( V_208 , NULL ) ;
V_3 -> V_195 . type = V_205 ;
V_3 -> V_195 . V_266 = & V_269 ;
V_3 -> V_195 . V_18 = F_6 ( V_3 ) ;
V_3 -> V_195 . V_270 = F_89 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_195 . V_271 = 32 ;
V_3 -> V_186 . type = V_206 ;
V_3 -> V_186 . V_266 = & V_269 ;
V_3 -> V_186 . V_18 = F_6 ( V_3 ) ;
V_3 -> V_186 . V_270 = F_89 ( 4096 * 4096 ) * 2 * 3 ;
V_3 -> V_186 . V_271 = 32 ;
V_256 = F_90 ( & V_3 -> V_195 , L_10 ) ;
if ( V_256 < 0 )
goto V_272;
V_256 = F_90 ( & V_3 -> V_186 , L_10 ) ;
if ( V_256 < 0 )
goto V_273;
V_3 -> V_186 . V_203 . V_113 . V_248 |= V_274 ;
V_256 = F_91 ( & V_3 -> V_195 . V_203 . V_113 , 0 ,
& V_3 -> V_112 . V_113 , V_12 , 0 ) ;
if ( V_256 < 0 )
goto V_275;
V_256 = F_91 ( & V_3 -> V_112 . V_113 , V_115 ,
