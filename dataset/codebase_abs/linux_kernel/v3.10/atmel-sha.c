...
int V_107 = - V_171 ;
T_7 V_172 ;
if ( V_170 && V_170 -> V_173 -> V_174 . V_166 ) {
F_97 ( V_172 ) ;
F_98 ( V_175 , V_172 ) ;
V_2 -> V_92 . V_96 = F_99 ( V_172 ,
F_95 , & V_170 -> V_173 -> V_174 ) ;
if ( ! V_2 -> V_92 . V_96 )
return V_107 ;
...
struct V_1 * V_146 ;
struct V_169 * V_170 ;
struct V_167 * V_33 = & V_185 -> V_33 ;
struct V_186 * V_187 ;
unsigned long V_188 ;
int V_107 ;
V_146 = F_104 ( sizeof( struct V_1 ) , V_189 ) ;
if ( V_146 == NULL ) {
F_40 ( V_33 , L_19 ) ;
V_107 = - V_171 ;
goto V_190;
...
F_105 ( V_185 , V_146 ) ;
F_106 ( & V_146 -> V_191 ) ;
F_107 ( & V_146 -> V_120 , F_87 ,
( unsigned long ) V_146 ) ;
F_108 ( & V_146 -> V_129 , V_192 ) ;
V_146 -> V_144 = - 1 ;
V_187 = F_109 ( V_185 , V_193 , 0 ) ;
if ( ! V_187 ) {
F_40 ( V_33 , L_20 ) ;
V_107 = - V_183 ;
goto V_194;
}
V_146 -> V_178 = V_187 -> V_195 ;
V_188 = F_110 ( V_187 ) ;
V_146 -> V_144 = F_111 ( V_185 , 0 ) ;
if ( V_146 -> V_144 < 0 ) {
F_40 ( V_33 , L_21 ) ;
V_107 = V_146 -> V_144 ;
goto V_194;
}
V_107 = F_112 ( V_146 -> V_144 , F_88 , V_196 , L_22 ,
V_146 ) ;
if ( V_107 ) {
F_40 ( V_33 , L_23 ) ;
goto V_194;
}
V_146 -> V_117 = F_113 ( & V_185 -> V_33 , L_24 ) ;
if ( F_79 ( V_146 -> V_117 ) ) {
F_40 ( V_33 , L_25 ) ;
V_107 = F_81 ( V_146 -> V_117 ) ;
goto V_197;
}
V_146 -> V_4 = F_114 ( V_146 -> V_178 , V_188 ) ;
if ( ! V_146 -> V_4 ) {
F_40 ( V_33 , L_26 ) ;
V_107 = - V_171 ;
goto V_198;
...
F_102 ( V_146 ) ;
if ( V_146 -> V_54 . V_55 ) {
V_170 = V_185 -> V_33 . V_199 ;
if ( ! V_170 ) {
F_40 ( & V_185 -> V_33 , L_27 ) ;
V_107 = - V_200 ;
goto V_201;
}
...
static int F_124 ( struct V_184 * V_185 )
{
