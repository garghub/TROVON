...
F_85 ( V_128 ) ) ;
V_25 -> V_105 [ 0 ] = NULL ;
F_105 ( ( unsigned long ) ( V_25 -> V_56 . V_135 ) ,
F_85 ( V_129 ) ) ;
V_25 -> V_56 . V_135 = NULL ;
}
if ( V_121 )
F_106 ( V_121 , V_120 ) ;
if ( V_124 )
...
{
struct V_127 * V_140 , * V_141 , * V_142 ;
T_9 * V_143 ;
T_5 * V_72 ;
unsigned char * V_144 ;
...
V_144 = F_87 ( F_88 ( V_140 ) ) ;
V_148 = V_150 * sizeof( * V_143 ) ;
V_146 = F_85 ( V_148 ) ;
...
V_143 = F_87 ( F_88 ( V_141 ) ) ;
V_147 = F_85 ( sizeof( * V_72 ) ) ;
V_142 = F_112 ( V_122 , V_147 ) ;
if ( V_142 == NULL ) {
F_71 ( V_32 ,
L_28 ,
V_152 << V_147 ) ;
...
V_149 = V_2 ;
V_2 = F_114 ( V_72 , & V_20 , V_149 , V_88 ,
V_143 , V_148 , 0 ) ;
if ( V_2 != 0 ) {
F_80 ( V_32 , L_30 , V_2 ) ;
goto V_155;
...
static int F_116 ( struct V_31 * V_32 , T_11 * V_156 ,
const char * V_157 )
{
int V_2 = F_117 ( V_156 , & V_20 , V_157 , 0 ) ;
if ( V_2 < 0 ) {
F_80 ( V_32 , L_31 , V_157 ) ;
return V_2 ;
}
V_2 = F_118 ( V_156 ) ;
if ( V_2 < 0 || V_2 >= V_101 ) {
...
if ( F_122 ( ( V_160 != NULL ) &&
! strcmp ( V_32 -> V_161 , V_160 ) ) ) {
V_2 = F_116 ( V_32 , & V_39 -> V_156 , L_33 ) ;
if ( V_2 < 0 )
goto V_139;
V_39 -> V_51 = V_2 ;
V_2 = F_116 ( V_32 , & V_39 -> V_162 , L_34 ) ;
if ( V_2 < 0 )
goto V_139;
V_39 -> V_163 = V_2 ;
V_39 -> V_88 = V_2 ;
} else {
V_2 = F_116 ( V_32 , & V_39 -> V_156 , V_32 -> V_161 ) ;
if ( V_2 < 0 )
goto V_139;
V_39 -> V_51 = V_2 ;
V_39 -> V_88 = V_2 ;
...
struct V_86 * V_87 =
& V_25 -> V_87 [ V_39 -> V_88 ] ;
F_124 ( & V_87 -> V_89 , V_164 ,
V_165 ) ;
V_87 -> V_85 = V_114 ;
V_87 -> V_89 . V_166 = F_52 ;
V_87 -> V_32 = V_32 ;
}
F_72 (cpu)
F_125 ( V_32 , V_114 ) ;
...
V_139:
if ( V_39 -> V_163 >= 0 ) {
if ( F_119 ( & V_39 -> V_162 ) != 0 )
F_71 ( V_32 , L_35 ) ;
V_39 -> V_163 = - 1 ;
}
if ( V_39 -> V_51 >= 0 ) {
if ( F_119 ( & V_39 -> V_156 ) != 0 )
F_71 ( V_32 , L_36 ) ;
V_39 -> V_51 = - 1 ;
}
V_39 -> V_88 = - 1 ;
...
static inline void * F_130 ( T_12 * V_167 )
{
unsigned long V_168 = F_88 ( F_131 ( V_167 ) ) ;
return F_87 ( V_168 ) + V_167 -> V_169 ;
}
...
T_13 V_171 = F_133 ( V_72 , V_170 ) ;
if ( V_171 >= 0 )
return V_171 ;
F_45 ( V_72 , V_74 , V_80 , false ) ;
V_171 = F_133 ( V_72 , V_170 ) ;
if ( V_171 >= 0 )
return V_171 ;
}
F_129 ( V_32 , V_85 ) ;
...
{
struct V_172 * V_173 = F_135 ( V_15 ) ;
unsigned int V_174 = F_136 ( V_15 ) + F_137 ( V_15 ) ;
unsigned int V_175 = V_15 -> V_16 - V_174 ;
unsigned int V_176 = V_173 -> V_177 ;
long V_178 = - 1 ;
long V_179 = F_138 ( V_15 ) - V_174 ;
long V_180 = 0 ;
long V_65 ;
int V_170 = 0 ;
int V_181 ;
for ( V_181 = 0 ; V_181 < V_173 -> V_182 ; V_181 ++ ) {
unsigned int V_183 = 0 ;
for ( V_170 ++ ; V_183 < V_176 ; V_170 ++ ) {
while ( V_180 >= V_179 ) {
V_178 ++ ;
V_179 = F_139 ( & V_173 -> V_184 [ V_178 ] ) ;
V_180 = 0 ;
}
V_65 = V_176 - V_183 ;
if ( V_65 > V_179 - V_180 )
...
static void F_140 ( struct V_14 * V_15 , unsigned char * V_144 ,
T_13 V_171 )
{
struct V_172 * V_173 = F_135 ( V_15 ) ;
struct V_185 * V_186 ;
...
unsigned int V_189 , V_190 , V_176 ;
unsigned int V_191 , V_192 , V_193 , V_194 ;
long V_178 = - 1 ;
long V_179 = F_138 ( V_15 ) - V_174 ;
long V_180 = 0 ;
long V_65 ;
...
V_190 = F_136 ( V_15 ) ;
V_176 = V_173 -> V_177 ;
V_191 = ( ( 0xFFFF - V_186 -> V_195 ) +
( 0xFFFF - V_186 -> V_196 ) +
( 0xFFFF - V_186 -> V_193 ) ) ;
V_192 = V_188 -> V_195 + ( 0xFFFF ^ F_144 ( V_15 -> V_16 ) ) ;
V_193 = F_145 ( V_186 -> V_193 ) ;
V_194 = F_146 ( V_188 -> V_194 ) ;
for ( V_181 = 0 ; V_181 < V_173 -> V_182 ; V_181 ++ ) {
unsigned char * V_1 ;
unsigned int V_183 = 0 ;
V_1 = V_144 + ( V_171 % V_150 ) * V_151 +
V_59 ;
memcpy ( V_1 , V_19 , V_174 ) ;
V_186 = (struct V_185 * ) ( V_1 + V_189 ) ;
V_186 -> V_196 = F_144 ( V_174 + V_176 - V_189 ) ;
V_186 -> V_193 = F_144 ( V_193 ) ;
V_186 -> V_195 = F_147 ( V_191 + V_186 -> V_196 +
V_186 -> V_193 ) ^ 0xffff ;
V_188 = (struct V_187 * ) ( V_1 + V_190 ) ;
V_188 -> V_194 = F_148 ( V_194 ) ;
V_188 -> V_195 = F_147 ( V_192 + F_144 ( V_174 + V_176 ) ) ;
if ( V_181 != V_173 -> V_182 - 1 ) {
V_188 -> V_197 = 0 ;
V_188 -> V_198 = 0 ;
}
V_171 ++ ;
...
struct V_14 * V_15 , unsigned char * V_144 , T_13 V_171 )
{
struct V_38 * V_39 = F_30 ( V_32 ) ;
struct V_172 * V_173 = F_135 ( V_15 ) ;
unsigned int V_174 = F_136 ( V_15 ) + F_137 ( V_15 ) ;
...
V_180 += V_65 ;
V_183 += V_65 ;
V_200 . V_21 = F_16 ( V_21 ) ;
V_200 . V_208 = V_65 ;
V_200 . V_210 = ! ( V_183 < V_176 ) ;
F_151 ( V_72 , V_200 , V_171 ) ;
V_171 ++ ;
}
V_202 ++ ;
V_203 += V_174 + V_176 ;
...
V_170 = F_134 ( V_15 ) ;
F_57 ( V_99 ) ;
V_171 = F_132 ( V_32 , V_15 -> V_211 , V_74 ,
V_72 , V_170 ) ;
if ( V_171 < 0 ) {
F_58 ( V_99 ) ;
return V_212 ;
}
F_140 ( V_15 , V_103 -> V_144 , V_171 ) ;
F_149 ( V_32 , V_72 , V_15 , V_103 -> V_144 , V_171 ) ;
F_47 ( V_72 , V_74 , V_171 + V_170 - 1 , V_15 ) ;
F_58 ( V_99 ) ;
F_55 () ;
return V_213 ;
}
static unsigned int F_153 ( struct V_214 * V_184 ,
struct V_14 * V_15 ,
void * V_215 , unsigned int V_216 )
{
unsigned int V_64 , V_65 = 0 ;
struct V_172 * V_173 = F_135 ( V_15 ) ;
if ( V_216 != 0 ) {
V_184 [ V_65 ] . V_1 = V_215 ;
V_184 [ V_65 ++ ] . V_217 = V_216 ;
}
for ( V_64 = 0 ; V_64 < V_173 -> V_218 ; V_64 ++ ) {
T_12 * V_167 = & V_173 -> V_184 [ V_64 ] ;
V_184 [ V_65 ] . V_1 = F_130 ( V_167 ) ;
V_184 [ V_65 ++ ] . V_217 = F_139 ( V_167 ) ;
}
return V_65 ;
}
...
V_170 = F_153 ( V_184 , V_15 , V_19 , F_138 ( V_15 ) ) ;
V_220 . V_209 = V_12 ;
for ( V_64 = 0 ; V_64 < V_170 ; V_64 ++ ) {
V_220 . V_208 = V_184 [ V_64 ] . V_217 ;
V_220 . V_21 = F_16 ( V_184 [ V_64 ] . V_1 ) ;
V_143 [ V_64 ] = V_220 ;
}
V_143 [ V_170 - 1 ] . V_210 = 1 ;
if ( V_15 -> V_43 == V_221 ) {
unsigned int V_204 = F_150 ( V_15 ) ;
V_143 [ 0 ] . V_205 = 1 ;
V_143 [ 0 ] . V_204 = V_204 ;
V_143 [ 0 ] . V_206 = V_204 + V_15 -> V_207 ;
}
F_57 ( V_99 ) ;
V_171 = F_132 ( V_32 , V_15 -> V_211 , V_74 ,
V_72 , V_170 ) ;
...
for ( V_64 = 0 ; V_64 < V_170 ; V_64 ++ )
F_151 ( V_72 , V_143 [ V_64 ] , V_171 ++ ) ;
F_47 ( V_72 , V_74 , V_171 - 1 , V_15 ) ;
F_8 ( 1 , & V_39 -> V_45 . V_202 ) ;
...
static int F_160 ( struct V_31 * V_32 , struct V_222 * V_223 , int V_224 )
{
return - V_225 ;
}
static struct V_226 * F_161 ( struct V_31 * V_32 )
{
struct V_38 * V_39 = F_30 ( V_32 ) ;
return & V_39 -> V_45 ;
}
static int F_162 ( struct V_31 * V_32 , int V_227 )
{
if ( ( V_227 < 68 ) || ( V_227 > 1500 ) )
return - V_158 ;
V_32 -> V_228 = V_227 ;
return 0 ;
}
static int F_163 ( struct V_31 * V_32 , void * V_229 )
{
struct V_230 * V_23 = V_229 ;
if ( ! F_164 ( V_23 -> V_231 ) )
return - V_158 ;
memcpy ( V_32 -> V_36 , V_23 -> V_231 , V_32 -> V_232 ) ;
return 0 ;
}
...
static void F_168 ( const char * V_161 , const T_3 * V_242 )
{
int V_243 ;
int V_64 ;
int V_244 = 0 ;
struct V_31 * V_32 ;
struct V_38 * V_39 ;
if ( strncmp ( V_161 , L_37 , 4 ) == 0 )
return;
V_32 = F_169 ( sizeof( * V_39 ) , V_161 , F_166 ,
V_245 , 1 ) ;
if ( ! V_32 ) {
F_170 ( L_38 , V_161 ) ;
return;
...
V_25 -> V_107 = false ;
V_25 -> V_30 = V_30 ;
F_124 ( & V_25 -> V_97 , V_164 , V_165 ) ;
V_25 -> V_97 . V_166 = F_56 ;
}
...
F_176 ( & V_159 ) ;
F_177 ( F_174 , NULL , 1 ) ;
for ( V_64 = 0 ; F_178 ( V_64 , V_161 , V_242 ) >= 0 ; V_64 ++ )
F_168 ( V_161 , V_242 ) ;
if ( ! F_1 () )
V_4 = * V_247 ;
return 0 ;
