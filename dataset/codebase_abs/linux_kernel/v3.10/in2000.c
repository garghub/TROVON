...
static int F_63 ( struct V_57 * V_58 , char * V_75 , int V_289 )
{
#ifdef F_57
char * V_290 ;
struct V_1 * V_291 ;
int V_10 , V_80 ;
V_291 = (struct V_1 * ) V_58 -> V_2 ;
V_75 [ V_289 ] = '\0' ;
V_290 = V_75 ;
if ( ! strncmp ( V_290 , L_93 , 6 ) ) {
V_290 += 6 ;
V_291 -> args = F_46 ( V_290 , NULL , 0 ) & V_270 ;
} else if ( ! strncmp ( V_290 , L_94 , 11 ) ) {
V_290 += 11 ;
V_10 = F_46 ( V_290 , NULL , 0 ) ;
if ( V_10 < V_267 || V_10 > V_268 )
V_10 = V_255 ;
V_291 -> V_156 = V_10 ;
} else if ( ! strncmp ( V_290 , L_95 , 7 ) ) {
V_290 += 7 ;
V_10 = F_46 ( V_290 , NULL , 0 ) ;
V_291 -> V_161 = V_51 [ F_11 ( ( unsigned int ) V_10 ) ] . V_52 ;
} else if ( ! strncmp ( V_290 , L_96 , 7 ) ) {
V_290 += 7 ;
V_10 = F_46 ( V_290 , NULL , 0 ) ;
for ( V_80 = 0 ; V_80 < 7 ; V_80 ++ )
if ( V_10 & ( 1 << V_80 ) )
V_291 -> V_128 [ V_80 ] = V_199 ;
} else if ( ! strncmp ( V_290 , L_97 , 5 ) ) {
V_290 += 5 ;
V_291 -> V_259 = F_46 ( V_290 , NULL , 0 ) ;
} else if ( ! strncmp ( V_290 , L_98 , 7 ) ) {
V_290 += 7 ;
V_291 -> V_87 = F_46 ( V_290 , NULL , 0 ) ;
}
#endif
return V_289 ;
}
static int F_64 ( struct V_292 * V_293 , struct V_57 * V_58 )
{
#ifdef F_57
unsigned long V_110 ;
struct V_1 * V_291 ;
...
V_291 = (struct V_1 * ) V_58 -> V_2 ;
F_27 ( V_58 -> V_111 , V_110 ) ;
if ( V_291 -> V_259 & V_260 )
F_65 ( V_293 , L_99 , V_279 , V_280 ) ;
if ( V_291 -> V_259 & V_261 ) {
F_65 ( V_293 , L_100 , ( V_291 -> V_244 & 0x7f ) , V_58 -> V_251 , V_291 -> V_99 , ( V_291 -> V_244 & 0x40 ) ? L_81 : L_82 , ( V_291 -> V_244 & 0x20 ) ? L_81 : L_82 ) ;
F_65 ( V_293 , L_101 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_293 , L_102 , V_291 -> V_82 [ V_10 ] ) ;
F_65 ( V_293 , L_103 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_293 , L_102 , V_291 -> V_128 [ V_10 ] ) ;
}
#ifdef F_28
if ( V_291 -> V_259 & V_262 ) {
F_65 ( V_293 , L_104 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_293 , L_105 , V_291 -> V_253 [ V_10 ] ) ;
F_65 ( V_293 , L_106 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_293 , L_105 , V_291 -> V_254 [ V_10 ] ) ;
F_65 ( V_293 , L_107 ) ;
for ( V_10 = 0 ; V_10 < 7 ; V_10 ++ )
F_65 ( V_293 , L_105 , V_291 -> V_175 [ V_10 ] ) ;
F_65 ( V_293 , L_108 , V_291 -> V_112 ) ;
}
#endif
if ( V_291 -> V_259 & V_263 ) {
F_65 ( V_293 , L_109 ) ;
if ( V_291 -> V_114 ) {
V_7 = ( T_2 * ) V_291 -> V_114 ;
F_65 ( V_293 , L_110 , V_7 -> V_60 -> V_83 , V_7 -> V_60 -> V_106 , V_7 -> V_20 [ 0 ] ) ;
}
}
if ( V_291 -> V_259 & V_264 ) {
F_65 ( V_293 , L_111 ) ;
V_7 = ( T_2 * ) V_291 -> V_73 ;
while ( V_7 ) {
F_65 ( V_293 , L_110 , V_7 -> V_60 -> V_83 , V_7 -> V_60 -> V_106 , V_7 -> V_20 [ 0 ] ) ;
