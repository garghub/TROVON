...
static int F_76 ( char * V_20 , char * * V_25 )
{
int V_3 , V_136 ;
V_20 = F_77 ( V_20 , V_137 ) ;
if ( V_20 == NULL ) {
* V_25 = L_51 ;
return - V_112 ;
}
...
static int F_78 ( char * V_17 , char * V_20 , int V_74 , char * * V_25 )
{
struct V_26 * V_27 ;
int V_3 , V_80 = 0 ;
V_3 = F_13 ( & V_17 ) ;
...
F_17 ( & V_37 ) ;
if( V_27 -> V_12 == NULL ) {
F_79 ( V_20 , V_74 , V_80 , L_53 , 1 ) ;
goto V_44;
}
F_79 ( V_20 , V_74 , V_80 , V_27 -> V_12 , 0 ) ;
if( V_27 -> V_50 . V_12 != NULL ) {
F_79 ( V_20 , V_74 , V_80 , L_54 , 0 ) ;
F_79 ( V_20 , V_74 , V_80 , V_27 -> V_50 . V_12 , 1 ) ;
}
else F_79 ( V_20 , V_74 , V_80 , L_53 , 1 ) ;
V_44:
F_19 ( & V_37 ) ;
return V_80 ;
}
static int F_80 ( char * * V_20 , int * V_139 , int * V_140 )
{
int V_3 ;
V_3 = F_13 ( V_20 ) ;
* V_139 = 0 ;
...
static int F_81 ( int V_3 , char * * V_25 )
{
...
V_145 = F_92 ( 0 , 0 ) ;
V_68 = F_93 ( V_145 + V_111 - sizeof( void * ) ,
& V_58 ) ;
if( V_68 < 0 ) {
F_18 ( V_52
L_61
...
V_32 = F_94 ( V_61 , V_58 , V_146 , F_33 ,
0 , L_56 , V_43 ) ;
if( V_32 != 0 )
F_18 ( V_52 L_63 , - V_32 ) ;
return 0 ;
}
static int F_95 ( struct V_147 * V_148 , T_7 V_97 )
{
struct V_116 * V_118 = V_148 -> V_149 ;
...
V_27 -> V_142 ++ ;
F_96 ( V_118 , ! V_27 -> V_28 . V_45 ) ;
V_44:
F_19 ( & V_150 ) ;
return V_32 ;
}
static void F_97 ( struct V_116 * V_118 , T_7 V_97 )
{
struct V_26 * V_27 = V_118 -> V_129 ;
F_17 ( & V_150 ) ;
if( -- V_27 -> V_142 == 0 )
...
static void F_98 ( T_1 V_151 , int V_60 , unsigned long * V_152 ,
...
static void F_100 ( struct V_53 * V_54 , unsigned long * V_105 ,
T_1 V_76 , T_1 V_109 )
{
...
else F_98 ( V_54 -> V_79 , V_54 -> V_60 , & V_54 -> V_157 ,
& V_54 -> V_153 , V_105 , V_76 ,
V_54 -> V_154 , V_109 ) ;
}
static void F_102 ( struct V_160 * V_54 , struct V_53 * V_161 ,
unsigned long long V_79 , int V_162 ,
int V_80 , struct V_163 * V_163 )
{
struct V_116 * V_118 = V_54 -> V_164 ;
struct V_26 * V_27 = V_118 -> V_129 ;
V_161 -> V_54 = V_54 ;
...
V_161 -> error = 0 ;
V_161 -> V_157 = 0 ;
V_161 -> V_158 = ( F_103 ( V_54 ) == V_166 ) ? V_159 : V_167 ;
V_161 -> V_168 [ 0 ] = 0 ;
V_161 -> V_168 [ 1 ] = V_27 -> V_50 . V_110 ;
V_161 -> V_169 = F_104 ( V_163 ) + V_162 ;
V_161 -> V_95 = 1 << 9 ;
if( V_27 -> V_50 . V_12 != NULL )
F_100 ( V_161 , V_27 -> V_50 . V_105 ,
...
int V_3 ;
while( 1 ) {
struct V_26 * V_66 = V_171 -> V_132 ;
if( V_66 -> V_172 == 0 ) {
struct V_160 * V_54 = F_105 ( V_171 ) ;
if( V_54 == NULL )
return;
V_66 -> V_160 = V_54 ;
V_66 -> V_173 = F_106 ( V_54 ) ;
V_66 -> V_174 = 0 ;
V_66 -> V_172 = F_107 ( V_171 , V_54 , V_66 -> V_130 ) ;
}
V_54 = V_66 -> V_160 ;
while( V_66 -> V_174 < V_66 -> V_172 ) {
struct V_175 * V_130 = & V_66 -> V_130 [ V_66 -> V_174 ] ;
V_161 = F_108 ( sizeof( struct V_53 ) ,
V_176 ) ;
if( V_161 == NULL ) {
if( F_109 ( & V_66 -> V_62 ) )
...
V_130 -> V_79 , V_130 -> V_60 , F_111 ( V_130 ) ) ;
V_3 = F_112 ( V_58 , & V_161 ,
sizeof( struct V_53 * ) ) ;
...
static int F_113 ( struct V_147 * V_148 , struct V_177 * V_178 )
{
...
static int F_114 ( struct V_147 * V_148 , T_7 V_97 ,
...
struct V_185 V_186 ;
case V_187 :
memset ( & F_80 , 0 , V_184 * 2 ) ;
F_80 [ V_188 ] = V_27 -> V_74 / ( 128 * 32 * 512 ) ;
F_80 [ V_189 ] = 128 ;
F_80 [ V_190 ] = 32 ;
if( F_115 ( ( char V_191 * ) V_183 , ( char * ) & F_80 ,
sizeof( F_80 ) ) )
return - V_192 ;
return 0 ;
case V_193 :
if( F_116 ( & V_186 , ( char V_191 * ) V_183 , sizeof( V_186 ) ) )
return - V_192 ;
V_186 . V_194 = 255 ;
V_186 . V_195 = 255 ;
V_186 . V_196 = 255 ;
V_186 . V_197 = 255 ;
if( F_115 ( ( char V_191 * ) V_183 , & V_186 , sizeof( V_186 ) ) )
return - V_192 ;
return 0 ;
}
return - V_36 ;
...
if( V_54 -> V_153 == - 1 )
return 0 ;
V_3 = F_44 ( V_54 -> V_165 [ 1 ] , V_54 -> V_153 ) ;
if( V_3 < 0 ) {
F_18 ( L_68 , - V_3 ) ;
return 1 ;
}
V_3 = F_112 ( V_54 -> V_165 [ 1 ] , & V_54 -> V_154 ,
sizeof( V_54 -> V_154 ) ) ;
...
static void F_117 ( struct V_53 * V_54 )
{
char * V_78 ;
unsigned long V_80 ;
...
V_199 * V_54 -> V_95 ;
V_80 = ( V_23 - V_199 ) * V_54 -> V_95 ;
V_78 = & V_54 -> V_169 [ V_199 * V_54 -> V_95 ] ;
V_32 = F_44 ( V_54 -> V_165 [ V_1 ] , V_5 ) ;
if( V_32 < 0 ) {
F_18 ( L_70 , - V_32 ) ;
V_54 -> error = 1 ;
return;
...
V_78 = & V_78 [ V_3 ] ;
V_80 -= V_3 ;
V_3 = F_23 ( V_54 -> V_165 [ V_1 ] , V_78 , V_80 ) ;
if ( V_3 < 0 ) {
F_18 ( L_71
...
V_3 = F_112 ( V_54 -> V_165 [ V_1 ] , V_78 , V_80 ) ;
if( V_3 != V_80 ) {
F_18 ( L_73
L_72 , - V_3 , V_54 -> V_165 [ V_1 ] ) ;
V_54 -> error = 1 ;
