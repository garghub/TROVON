...
struct V_29 * V_30 = F_32 ( V_60 ) ;
int V_17 ;
V_17 = F_81 ( V_60 -> V_189 , & V_30 -> V_45 ) ;
if ( V_17 ) {
F_9 ( V_60 -> V_189 , L_33 ,
V_30 -> V_190 . V_175 ) ;
return V_17 ;
}
V_17 = F_82 ( & V_30 -> V_45 . V_191 ,
V_138 , & V_30 -> V_190 . V_191 , V_130 ,
V_192 | V_193 ) ;
V_17 = F_82 ( & V_30 -> V_45 . V_191 ,
V_154 , & V_30 -> V_190 . V_191 , V_133 ,
V_192 | V_193 ) ;
F_33 ( & V_30 -> V_95 ) ;
V_17 = F_75 ( V_30 ) ;
if ( V_17 == 0 )
...
static int F_85 ( int V_194 , int V_82 , const char * V_175 )
{
unsigned long V_25 = V_82 ? V_195 : V_196 ;
int V_17 ;
if ( ! F_71 ( V_194 ) )
return 0 ;
V_17 = F_86 ( V_194 , V_25 , V_175 ) ;
if ( ! V_17 )
F_87 ( V_194 , 0 ) ;
return V_17 ;
}
...
{
int V_99 ;
for ( V_99 = 0 ; V_99 < F_41 ( V_30 -> V_181 ) ; V_99 ++ ) {
if ( ! F_71 ( V_30 -> V_181 [ V_99 ] . V_181 ) )
continue;
F_89 ( V_30 -> V_181 [ V_99 ] . V_181 ) ;
V_30 -> V_181 [ V_99 ] . V_181 = - V_66 ;
}
return 0 ;
}
...
{
const struct V_199 * V_181 = & V_198 -> V_200 ;
int V_17 ;
V_30 -> V_181 [ V_187 ] . V_181 = - V_66 ;
V_30 -> V_181 [ V_188 ] . V_181 = - V_66 ;
V_17 = F_85 ( V_181 -> V_181 , V_181 -> V_182 , L_36 ) ;
if ( V_17 ) {
F_88 ( V_30 ) ;
return V_17 ;
}
...
F_72 ( V_181 -> V_181 , 0 ) ;
V_181 = & V_198 -> V_201 ;
V_17 = F_85 ( V_181 -> V_181 , V_181 -> V_182 , L_37 ) ;
if ( V_17 ) {
F_88 ( V_30 ) ;
return V_17 ;
}
...
const struct V_202 * V_180 )
{
struct V_203 * V_65 = & V_13 -> V_65 ;
const struct V_197 * V_198 = V_13 -> V_65 . V_204 ;
struct V_59 * V_60 ;
struct V_59 * V_190 ;
struct V_29 * V_30 ;
int V_17 , V_99 ;
...
V_30 = F_93 ( V_65 , sizeof( * V_30 ) , V_205 ) ;
if ( ! V_30 )
return - V_206 ;
F_94 ( & V_30 -> V_95 ) ;
V_60 = & V_30 -> V_45 ;
V_190 = & V_30 -> V_190 ;
F_95 ( V_60 , & V_207 ) ;
V_60 -> V_208 = V_13 -> V_209 -> V_209 . V_208 ;
F_96 ( V_60 , V_30 ) ;
F_97 ( V_60 -> V_175 , L_39 , sizeof( V_60 -> V_175 ) ) ;
V_60 -> V_210 = & V_211 ;
V_60 -> V_25 |= V_212 ;
V_30 -> V_213 [ V_154 ] . V_25 = V_214 ;
V_30 -> V_213 [ V_138 ] . V_25 = V_214 ;
V_60 -> V_191 . type = V_215 ;
V_17 = F_98 ( & V_60 -> V_191 , V_167 ,
V_30 -> V_213 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
F_99 ( V_190 , V_13 , & V_216 ) ;
strcpy ( V_190 -> V_175 , L_40 ) ;
V_190 -> V_210 = & V_217 ;
V_190 -> V_25 |= V_212 ;
V_30 -> V_218 [ V_130 ] . V_25 = V_219 ;
V_30 -> V_218 [ V_133 ] . V_25 = V_219 ;
V_30 -> V_218 [ V_134 ] . V_25 = V_214 ;
V_190 -> V_191 . type = V_215 ;
V_17 = F_98 ( & V_190 -> V_191 , V_220 ,
V_30 -> V_218 , 0 ) ;
if ( V_17 < 0 )
return V_17 ;
V_30 -> V_221 = V_198 -> V_221 ;
V_30 -> V_222 = V_198 -> V_222 ;
V_17 = F_90 ( V_30 , V_198 ) ;
if ( V_17 )
goto V_223;
for ( V_99 = 0 ; V_99 < V_183 ; V_99 ++ )
V_30 -> V_184 [ V_99 ] . V_224 = V_225 [ V_99 ] ;
V_17 = F_100 ( V_65 , V_183 ,
V_30 -> V_184 ) ;
if ( V_17 ) {
F_92 ( V_65 , L_41 ) ;
goto V_226;
