...
static struct V_6 * T_5 F_22 ( unsigned int V_8 )
{
return F_23 ( sizeof( struct V_6 ) , V_60 ,
F_24 ( V_8 ) ) ;
}
static void T_5 F_25 ( unsigned int V_8 )
{
struct V_6 * V_31 ;
if ( V_7 ) {
V_31 = F_22 ( V_8 ) ;
...
static void T_5 F_28 ( unsigned int V_8 )
{
...
static void T_5 F_32 ( unsigned int V_8 ,
struct V_6 * T_6 * V_68 )
{
...
static void T_5 F_35 ( unsigned int V_8 )
{
if ( V_7 )
F_32 ( V_8 , V_7 ) ;
if ( V_9 )
...
static void T_5 F_36 ( unsigned int V_8 ,
struct V_6 * T_6 * V_68 )
{
unsigned int V_30 ;
...
static void T_5 F_39 ( unsigned int V_8 )
{
if ( V_7 )
F_36 ( V_8 , V_7 ) ;
if ( V_9 )
...
static void T_5 F_40 ( unsigned int V_8 ,
struct V_6 * T_6 * V_68 )
{
struct V_6 * V_31 = * F_4 ( V_68 , V_8 ) ;
if ( V_8 == V_31 -> V_8 )
...
static void T_5 F_41 ( unsigned int V_8 )
{
if ( V_7 )
F_40 ( V_8 , V_7 ) ;
if ( V_9 )
...
static void T_7 F_43 ( void * V_91 )
{
