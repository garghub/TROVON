...
{ 0x14 , 0xe7 , 0x1e , 0xdd } ;
F_52 ( V_19 -> V_141 , V_1 -> V_164 , V_1 -> V_165 ,
0x21 ) ;
V_53 = V_64 [ V_19 -> V_20 ] ;
V_148 = V_53 [ 1 ] ;
if ( V_19 -> V_42 & V_166 )
...
F_9 ( V_1 , 0x84 , V_176 , sizeof V_176 ) ;
switch ( V_19 -> V_20 ) {
case V_21 :
case V_92 :
case V_93 :
...
F_7 ( V_1 , 0x06 , 0x20 ) ;
V_151 = NULL ;
V_25 = V_1 -> V_33 . V_43 [ V_1 -> V_177 ] . V_178 ;
V_148 |= V_171 | V_179 ;
V_149 &= ~ V_170 ;
V_149 |= 0x02 ;
switch ( V_19 -> V_20 ) {
...
V_19 -> V_148 = V_148 ;
V_19 -> V_149 = V_149 ;
V_19 -> V_192 = V_19 -> V_47 = 0 ;
V_19 -> V_193 = V_19 -> V_194 = 0 ;
V_19 -> V_195 = F_54 ( V_196 ) ;
return V_1 -> V_5 ;
}
...
static const T_2 V_200 [] =
{ 0xa1 , 0x21 , 0x12 , 0x80 , 0x00 , 0x00 , 0x00 , 0x10 } ;
T_2 V_148 ;
T_2 V_149 ;
V_148 = V_19 -> V_148 ;
V_149 = V_19 -> V_149 & ~ V_168 ;
switch ( V_19 -> V_20 ) {
case V_21 :
case V_23 :
case V_63 :
...
return;
V_19 -> V_48 = V_134 ;
V_126 = F_59 ( & V_19 -> V_205 ) ;
F_5 ( V_114 , L_30 , V_126 ) ;
if ( V_19 -> V_20 == V_63 ) {
F_60 ( V_1 , V_126 , V_203 , V_204 ,
15 , 1024 ) ;
return;
}
if ( V_126 < V_203 - V_204 ||
V_126 > V_203 + V_204 ) {
switch ( V_19 -> V_20 ) {
case V_23 :
V_202 = V_19 -> V_86 ;
...
static void F_61 ( struct V_19 * V_19 ,
T_2 * V_13 )
{
int V_205 ;
V_205 = ( V_13 [ 27 ] << 8 ) + V_13 [ 28 ]
+ ( V_13 [ 31 ] << 8 ) + V_13 [ 32 ]
+ ( V_13 [ 23 ] << 8 ) + V_13 [ 24 ]
+ ( V_13 [ 35 ] << 8 ) + V_13 [ 36 ]
+ ( V_13 [ 29 ] << 10 ) + ( V_13 [ 30 ] << 2 ) ;
V_205 >>= 10 ;
F_62 ( & V_19 -> V_205 , V_205 ) ;
}
...
F_64 ( V_1 , V_209 , V_13 , V_27 ) ;
if ( V_206 == 0 ) {
int V_214 ;
V_214 = ( V_19 -> V_192 * 100 ) /
( V_19 -> V_47 *
V_1 -> V_215 [ 0 ] -> V_216 [ 0 ] . V_217 ) ;
if ( V_214 >= 85 )
V_206 = - 3 ;
else if ( V_214 < 75 )
V_206 = 2 ;
...
static int F_66 ( struct V_220 * V_221 )
{
struct V_1 * V_1 =
F_48 ( V_221 -> V_222 , struct V_1 , V_67 ) ;
V_1 -> V_5 = 0 ;
if ( ! V_1 -> V_223 )
return 0 ;
switch ( V_221 -> V_39 ) {
...
int V_4 = - V_224 ;
if ( V_3 == 1 && V_13 [ 0 ] == 1 ) {
F_68 ( V_1 -> V_225 , V_226 , 1 ) ;
F_69 ( V_1 -> V_225 ) ;
F_68 ( V_1 -> V_225 , V_226 , 0 ) ;
F_69 ( V_1 -> V_225 ) ;
V_4 = 0 ;
}
return V_4 ;
...
const struct V_38 * V_39 )
{
return F_71 ( V_228 , V_39 , & V_229 , sizeof( struct V_19 ) ,
V_230 ) ;
}
