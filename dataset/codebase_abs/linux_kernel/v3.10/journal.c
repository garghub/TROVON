...
static void F_150 ( struct V_1 * V_225 ,
struct V_3 * V_4 )
{
if ( V_4 -> V_222 != NULL ) {
F_193 ( V_4 -> V_222 , V_4 -> V_226 ) ;
V_4 -> V_222 = NULL ;
}
}
...
V_4 -> V_226 = V_230 ;
if ( F_198 ( V_4 -> V_222 ) ) {
V_228 = F_199 ( V_4 -> V_222 ) ;
V_4 -> V_222 = NULL ;
F_27 ( V_225 , L_99 ,
L_100 ,
F_200 ( V_229 , V_72 ) , V_228 ) ;
return V_228 ;
...
V_4 -> V_226 = V_230 ;
V_4 -> V_222 = F_202 ( V_227 , V_230 , V_4 ) ;
if ( F_198 ( V_4 -> V_222 ) ) {
V_228 = F_199 ( V_4 -> V_222 ) ;
V_4 -> V_222 = NULL ;
F_27 ( V_225 ,
