...
V_172 -> V_183 . V_190 = 0 ;
if ( ( unsigned ) V_174 <= V_121 - sizeof( * V_172 ) +
...
int F_97 ( int V_386 , char * V_387 [] )
{
if ( V_386 >= 2 && ! strcmp ( V_387 [ 0 ] , L_43 ) &&
! strcmp ( V_387 [ 1 ] , L_44 ) ) {
V_2 -> V_6 . V_388 = 1 ;
return 0 ;
}
return F_98 ( 0 , V_386 , V_387 ) ;
}
...
F_94 ( V_2 ) ;
F_94 ( V_296 ) ;
return F_99 ( V_2 , F_100 ( V_2 , V_389 ) ) ;
#else
F_94 ( V_296 ) ;
switch ( V_2 -> V_6 . V_390 ) {
case V_391 :
case V_392 :
case V_393 :
return 1 ;
...
{
#ifdef F_73
return F_99 ( V_2 , F_100 ( V_2 , F_101 ( V_51 ) ) ) ;
#else
switch ( V_2 -> V_6 . V_390 ) {
case V_391 :
return V_51 == V_396 ? 3 : 2 ;
case V_394 :
return V_51 == V_396 ? 1 : 3 ;
case V_395 :
return V_51 == V_396 ? 3 : 1 ;
case V_392 :
return V_51 == V_396 ? 2 : 3 ;
case V_393 :
return 2 ;
}
return V_51 ;
...
static int F_99 ( struct V_1 * V_2 , int V_397 )
{
if ( V_397 == V_389 )
return V_34 ( V_2 , 1 ) ;
else
return F_87 ( V_2 , V_397 - F_101 ( 0 ) ) ;
}
static int F_91 ( V_10 V_222 )
{
return ( ( V_222 >> 8 ) & 0xff ) | ( ( V_222 & 0xff ) << 8 ) ;
}
void F_39 ( struct V_96 * V_21 , int V_173 , int V_398 )
{
struct V_385 * V_399 ;
...
int type ;
int V_14 ;
F_102 ( ( char * ) V_21 , V_402 , V_173 ) ;
V_173 -= sizeof( struct V_96 ) ;
V_268 = ( char * ) ( V_21 + 1 ) ;
while ( V_173 > 0 ) {
V_399 = (struct V_385 * ) V_268 ;
V_383 = V_399 -> V_179 ;
type = V_399 -> V_177 ;
V_399 -> V_177 = F_91 ( V_399 -> V_177 ) ;
V_399 -> V_179 = F_91 ( V_399 -> V_179 ) ;
if ( V_398 ) {
V_383 = V_399 -> V_179 ;
type = V_399 -> V_177 ;
}
...
break ;
V_383 += V_181 ;
for ( V_14 = V_403 , V_401 = V_400 ; V_14 ; V_14 -- , V_401 ++ ) {
if ( V_401 -> V_404 == type )
break ;
}
if ( V_14 && V_401 -> V_405 ) {
F_102 ( V_268 + V_181 , V_401 -> V_405 , V_173 ) ;
}
V_173 -= V_383 ;
V_268 += V_383 ;
}
}
static void F_102 ( char * V_406 , const char * V_407 , int V_173 )
{
...
int F_103 ( struct V_1 * V_2 , int V_234 , int V_410 , int V_411 )
{
int V_40 ;
int V_49 ;
F_14 ( L_45 , V_234 , V_410 ) ;
switch( V_234 ) {
case V_412 :
switch( V_410 ) {
case V_413 :
...
break ;
case V_425 :
if ( V_2 -> V_72 [ V_396 ] . V_426 == V_427 ) {
F_104 ( V_2 , V_428 ) ;
F_19 ( V_2 , V_429 + V_396 , V_430 ) ;
}
break ;
case V_431 :
if ( V_2 -> V_72 [ V_432 ] . V_426 == V_427 ) {
F_104 ( V_2 , V_428 ) ;
F_19 ( V_2 , V_429 + V_432 , V_430 ) ;
}
break ;
case V_433 :
for ( V_49 = 0 ; V_49 < V_71 ; V_49 ++ ) {
if ( V_2 -> V_6 . V_268 [ V_49 ] . V_434 != V_435 )
continue ;
F_104 ( V_2 , V_428 ) ;
F_19 ( V_2 , V_429 + V_49 , V_430 ) ;
}
break ;
default :
return 1 ;
...
static void F_38 ( struct V_1 * V_2 , char * V_406 , int V_173 )
{
int V_14 ;
F_94 ( V_2 ) ;
for ( V_14 = V_173 ; V_14 ; V_14 -- , V_406 ++ )
* V_406 = F_7 ( * V_406 ) ;
}
