...
if ( ! F_110 ( V_220 , V_66 , V_73 -> V_38 ) )
return - V_45 ;
V_154 = ( void T_1 * ) V_66 + V_73 -> V_38 ;
V_41 = 0 ;
while ( V_66 < V_154 ) {
if ( F_111 ( V_211 , & V_66 -> V_211 ) )
return - V_45 ;
V_214 . V_213 . V_221 = F_112 ( V_211 ) ;
V_214 . V_213 . V_177 = F_113 ( V_211 ) ;
V_214 . V_213 . V_222 = F_114 ( V_211 ) ;
V_214 . V_213 . V_223 = F_115 ( V_211 ) ;
V_214 . V_213 . V_224 = F_116 ( V_211 ) ;
V_214 . V_213 . V_174 = F_117 ( V_211 ) ;
switch ( V_203 -> type ) {
case V_184 :
...
switch ( V_73 -> V_251 ) {
case V_252 : F_129 ( & V_246 ) ; break;
case V_253 : F_130 ( & V_246 ) ; break;
case V_254 : F_131 ( & V_246 ) ; break;
default:
V_44 = - V_94 ;
}
F_132 () ;
...
return - V_94 ;
V_5 = F_71 ( sizeof( * V_5 ) , V_20 ) ;
V_280 = F_71 ( sizeof( * V_280 ) , V_20 ) ;
V_281 = F_71 ( sizeof( * V_281 ) , V_20 ) ;
...
return - V_289 ;
return F_70 ( V_1 , V_73 , V_290 | 0x3f , V_291 ) ;
}
...
return - V_94 ;
V_294 = F_149 ( V_73 -> V_223 , V_73 -> V_196 , V_73 -> V_224 ) ;
V_105 . V_108 = V_109 ;
V_105 . V_97 = V_73 -> V_97 ;
V_105 . V_51 = V_73 -> V_51 ;
V_105 . V_37 = V_73 -> V_37 ;
V_105 . V_54 = V_73 -> V_54 ;
return F_70 ( V_1 , & V_105 , V_294 , V_73 -> V_107 ) ;
}
static void F_150 ( struct V_296 * V_213 ,
...
return - V_167 ;
F_35 ( & V_50 -> V_22 ) ;
F_154 ( & V_1 -> V_27 , & V_50 -> V_317 ) ;
V_1 -> V_318 = V_73 -> V_51 ;
F_38 ( & V_50 -> V_22 ) ;
return 0 ;
}
void F_155 ( struct V_49 * V_50 , struct V_296 * V_66 )
{
struct V_1 * V_1 ;
struct V_319 * V_68 ;
unsigned long V_35 ;
...
return - V_19 ;
if ( F_157 ( V_321 ) != '#' ||
F_158 ( V_321 ) >= F_39 ( V_322 ) ||
F_159 ( V_321 ) > sizeof( V_40 ) )
return - V_323 ;
if ( F_160 ( V_321 ) == V_324 )
memset ( & V_40 , 0 , F_159 ( V_321 ) ) ;
if ( F_160 ( V_321 ) & V_325 )
if ( F_72 ( & V_40 , V_71 , F_159 ( V_321 ) ) )
return - V_45 ;
V_44 = V_322 [ F_158 ( V_321 ) ] ( V_1 , & V_40 ) ;
if ( V_44 < 0 )
return V_44 ;
if ( F_160 ( V_321 ) & V_324 )
if ( F_41 ( V_71 , & V_40 , F_159 ( V_321 ) ) )
return - V_45 ;
return V_44 ;
}
...
{
return F_156 ( V_16 -> V_29 , V_321 , ( void T_1 * ) V_71 ) ;
}
static long F_162 ( struct V_16 * V_16 ,
unsigned int V_321 , unsigned long V_71 )
{
return F_156 ( V_16 -> V_29 , V_321 , F_14 ( V_71 ) ) ;
}
static int F_163 ( struct V_16 * V_16 , struct V_326 * V_327 )
{
struct V_1 * V_1 = V_16 -> V_29 ;
unsigned long V_38 ;
int V_216 , V_44 ;
...
static unsigned int F_174 ( struct V_16 * V_16 , T_12 * V_333 )
{
struct V_1 * V_1 = V_16 -> V_29 ;
unsigned int V_334 = 0 ;
F_175 ( V_16 , & V_1 -> V_25 , V_333 ) ;
if ( F_19 ( V_1 -> V_3 ) )
V_334 |= V_335 | V_336 ;
if ( ! F_34 ( & V_1 -> V_24 ) )
V_334 |= V_337 | V_338 ;
