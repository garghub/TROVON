...
if ( V_38 != 0 )
goto V_45;
V_14 = ! V_35 ? F_9 ( & V_3 -> V_5 , & V_13 ) : V_35 ;
if ( ! V_14 )
V_14 = ( const char * ) V_3 -> V_46 -> V_25 . V_26 ;
if ( V_40 & V_47 )
F_22 ( V_28 , V_3 , V_14 ) ;
if ( V_40 & V_48 )
...
{
if ( V_3 && ( V_55 & V_56 ) )
return F_17 ( V_3 , NULL , V_57 , V_58 ) ;
return 0 ;
}
int F_26 ( struct V_59 * V_60 )
{
return F_17 ( V_60 -> V_3 ,
( strcmp ( V_60 -> V_35 , V_60 -> V_61 ) == 0 ) ?
V_60 -> V_35 : V_60 -> V_61 ,
V_57 , V_62 ) ;
}
...
return F_17 ( V_3 , NULL , V_57 , V_64 ) ;
}
