...
static void T_1 F_4 ( struct V_5 * V_5 , int type , int V_8 , struct V_9 * V_10 )
{
V_5 -> type = type ;
V_5 -> V_8 = V_8 ;
V_5 -> V_10 = F_5 ( V_10 ) ;
...
static struct V_5 * T_1 F_8 ( int type , int V_8 , struct V_9 * V_10 )
{
struct V_5 * V_5 ;
...
static struct V_5 * T_1 F_31 ( struct V_9 * V_33 , int V_8 )
{
struct V_5 * V_5 ;
...
static struct V_5 * T_1 F_32 ( struct V_9 * V_33 , int V_8 )
{
...
static struct V_5 * T_1 F_33 ( struct V_9 * V_33 , int V_8 )
{
struct V_5 * V_5 ;
if ( F_30 ( V_33 ) )
V_5 = F_31 ( V_33 , V_8 ) ;
...
static struct V_5 * T_1 F_34 ( struct V_9 * V_33 , int V_8 )
{
struct V_5 * V_5 ;
V_5 = F_29 ( V_33 ) ;
...
static void T_1 F_35 ( struct V_5 * V_39 , struct V_5 * V_40 )
{
while ( V_39 -> V_15 ) {
if ( V_39 -> V_15 == V_40 )
return;
...
static void T_1 F_36 ( struct V_5 * V_5 )
{
F_37 ( V_5 -> V_8 != 1 ) ;
F_37 ( strcmp ( V_5 -> V_10 -> type , L_8 ) ) ;
}
static void T_1 F_38 ( struct V_5 * V_5 )
{
struct V_9 * V_41 ;
int V_8 = V_5 -> V_8 ;
F_36 ( V_5 ) ;
...
static struct V_5 * T_1 F_40 ( unsigned int V_43 )
{
struct V_9 * V_44 ;
...
static struct V_47 * T_1 F_42 ( unsigned int V_43 )
{
struct V_47 * V_47 ;
struct V_48 * V_49 ;
struct V_2 * V_4 = NULL ;
...
static T_3 F_48 ( struct V_2 * V_3 , struct V_52 * V_53 , char * V_54 )
{
struct V_55 * V_56 ;
...
static T_3 F_50 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
unsigned int V_58 ;
struct V_5 * V_5 ;
V_5 = F_49 ( V_3 ) ;
...
static T_3 F_51 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
unsigned int V_25 ;
struct V_5 * V_5 ;
V_5 = F_49 ( V_3 ) ;
...
static T_3 F_52 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
unsigned int V_29 ;
struct V_5 * V_5 ;
V_5 = F_49 ( V_3 ) ;
...
static T_3 F_53 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
unsigned int V_59 ;
struct V_5 * V_5 ;
V_5 = F_49 ( V_3 ) ;
...
static T_3 F_54 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
struct V_5 * V_5 ;
V_5 = F_49 ( V_3 ) ;
return sprintf ( V_54 , L_16 , F_3 ( V_5 ) ) ;
}
static T_3 F_55 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
struct V_1 * V_51 ;
struct V_5 * V_5 ;
V_51 = F_1 ( V_3 ) ;
...
static T_3 F_56 ( struct V_2 * V_3 , struct V_55 * V_53 , char * V_54 )
{
struct V_1 * V_51 ;
struct V_5 * V_5 ;
int V_60 ;
...
static void T_1 F_58 ( struct V_1 * V_63 )
{
const char * V_64 ;
const char * V_65 ;
struct V_5 * V_5 ;
...
static void T_1 F_61 ( struct V_5 * V_5 , int V_51 , struct V_47 * V_47 )
{
struct V_1 * V_68 ;
int V_67 ;
...
static void T_1 F_63 ( unsigned int V_43 , struct V_5 * V_12 )
{
struct V_47 * V_47 ;
struct V_5 * V_5 ;
int V_51 = 0 ;
...
void T_1 F_64 ( unsigned int V_43 )
{
struct V_5 * V_5 ;
V_5 = F_40 ( V_43 ) ;
if ( ! V_5 )
