...
if ( V_48 != V_123 )
return;
V_2 -> V_78 . V_251 = & V_252 ;
V_2 -> V_78 . V_253 = & V_254 ;
}
...
F_22 ( 200 ) ;
V_173 ( V_8 , V_20 ) ;
V_255 = V_2 -> V_78 . V_168 ? V_256 : 0 ;
F_22 ( 100 ) ;
F_5 ( V_8 , 0x18 , 0 , V_257 ,
V_255 ) ;
F_22 ( 500 ) ;
F_5 ( V_8 , 0x18 , 0 , V_257 ,
V_255 ) ;
...
if ( V_48 == V_49 ) {
V_2 -> V_148 |= V_258 ;
V_2 -> V_78 . V_259 = F_133 ;
}
}
static void F_135 ( void * V_260 , int V_261 )
{
struct V_7 * V_8 = V_260 ;
struct V_1 * V_2 = V_8 -> V_2 ;
unsigned int V_262 ;
if ( V_2 -> V_263 )
V_261 = ! V_261 ;
...
if ( V_48 != V_49 )
return;
while ( ( V_268 = F_138 ( V_269 , NULL , V_268 ) ) ) {
int V_270 , V_183 ;
if ( sscanf ( V_268 -> V_128 , L_19 , & V_270 , & V_183 ) != 2 )
continue;
if ( V_183 < 0x0a || V_183 >= 0x10 )
break;
V_2 -> V_263 = V_270 ;
V_2 -> V_266 = V_183 - 0x0a + 0x18 ;
V_2 -> V_78 . V_271 . V_272 = F_135 ;
V_2 -> V_78 . V_273 = 1 ;
F_29 ( L_20 , V_2 -> V_266 ,
V_2 -> V_263 ) ;
break;
...
static void F_141 ( void * V_260 , int V_261 )
{
struct V_7 * V_8 = V_260 ;
struct V_1 * V_2 = V_8 -> V_2 ;
unsigned int V_274 = V_2 -> V_275 ;
if ( V_261 )
V_2 -> V_275 &= ~ 0x08 ;
else
V_2 -> V_275 |= 0x08 ;
...
{
struct V_1 * V_2 = V_8 -> V_2 ;
static const struct V_248 V_276 [] = {
{ 0x01 , V_192 , 0x18 } ,
{ 0x01 , V_193 , 0x18 } ,
{}
} ;
if ( V_48 == V_49 ) {
V_2 -> V_78 . V_271 . V_272 = F_141 ;
V_2 -> V_78 . V_122 = F_142 ;
V_2 -> V_275 = 0 ;
F_89 ( V_8 , V_276 ) ;
}
}
...
static void F_146 ( struct V_7 * V_8 , T_1 V_277 ,
T_1 V_278 )
{
int V_9 ;
switch ( V_8 -> V_45 ) {
...
F_22 ( 300 ) ;
V_9 = F_34 ( V_8 , 0x46 ) ;
V_280 = ( V_9 & 0x0070 ) == 0x0070 ;
break;
case 0x10ec0292 :
F_35 ( V_8 , 0x6b , 0xd429 ) ;
F_22 ( 300 ) ;
V_9 = F_34 ( V_8 , 0x6c ) ;
V_280 = ( V_9 & 0x001c ) == 0x001c ;
break;
case 0x10ec0668 :
F_35 ( V_8 , 0x11 , 0x0001 ) ;
F_35 ( V_8 , 0xb7 , 0x802b ) ;
...
F_22 ( 300 ) ;
V_9 = F_34 ( V_8 , 0xbe ) ;
V_280 = ( V_9 & 0x1c02 ) == 0x1c02 ;
break;
}
F_145 ( L_26 ,
V_280 ? L_27 : L_28 ) ;
V_2 -> V_281 = V_280 ? V_282 : V_283 ;
}
static void F_151 ( struct V_7 * V_8 )
{
struct V_1 * V_2 = V_8 -> V_2 ;
T_1 V_284 = V_2 -> V_78 . V_102 [ V_2 -> V_78 . V_117 [ 0 ] ] ;
T_1 V_277 = V_2 -> V_78 . V_79 . V_80 [ 0 ] ;
int V_285 ;
if ( ! F_152 ( V_8 , V_277 ) )
V_285 = V_286 ;
else if ( V_284 == V_2 -> V_287 )
V_285 = V_288 ;
else if ( V_284 == V_2 -> V_289 )
V_285 = V_290 ;
else
V_285 = V_291 ;
if ( V_285 == V_2 -> V_292 )
...
static void F_154 ( struct V_7 * V_8 , struct V_19 * V_20 )
{
struct V_1 * V_2 = V_8 -> V_2 ;
V_2 -> V_281 = V_297 ;
V_173 ( V_8 , V_20 ) ;
...
struct V_1 * V_2 = V_8 -> V_2 ;
struct V_146 * V_147 = & V_2 -> V_78 . V_79 ;
for ( V_55 = 0 ; V_55 < V_147 -> V_298 ; V_55 ++ ) {
if ( V_147 -> V_299 [ V_55 ] . V_300 && ! V_2 -> V_287 )
V_2 -> V_287 = V_147 -> V_299 [ V_55 ] . V_183 ;
if ( V_147 -> V_299 [ V_55 ] . V_301 && ! V_2 -> V_289 )
V_2 -> V_289 = V_147 -> V_299 [ V_55 ] . V_183 ;
}
V_2 -> V_78 . V_122 = F_153 ;
V_2 -> V_78 . V_169 = F_151 ;
V_2 -> V_78 . V_259 = F_154 ;
}
...
struct V_1 * V_2 = V_8 -> V_2 ;
if ( V_48 == V_123 ) {
if ( F_2 ( ! V_2 -> V_78 . V_303 [ 1 ] . V_183 ||
! V_2 -> V_78 . V_79 . V_80 [ 0 ] ) )
return;
F_160 ( V_8 , V_2 -> V_78 . V_303 [ 1 ] . V_183 ,
V_2 -> V_78 . V_79 . V_80 [ 0 ] ) ;
}
}
...
return;
for ( V_55 = 0 ; V_55 < V_147 -> V_298 ; V_55 ++ ) {
T_1 V_16 = V_147 -> V_299 [ V_55 ] . V_183 ;
unsigned int V_304 ;
if ( V_147 -> V_299 [ V_55 ] . type != V_305 )
continue;
V_304 = F_27 ( V_8 , V_16 ) ;
if ( F_162 ( V_304 ) != V_306 )
continue;
...
case 0x0010 :
if ( V_8 -> V_59 -> V_60 -> V_310 == 0x1025 &&
V_2 -> V_50 . V_68 == 1 )
V_124 = F_69 ( V_8 , L_17 ) ;
V_2 -> V_236 = V_241 ;
break;
case 0x0020 :
if ( V_8 -> V_59 -> V_60 -> V_310 == 0x17aa &&
...
{
static const T_1 V_312 [] = { 0x1d , 0 } ;
static const T_1 V_313 [] = { 0x0e , 0x0f , 0x0b , 0 } ;
return F_75 ( V_8 , V_312 , V_313 ) ;
}
...
static const T_1 V_318 [] = { 0x15 , 0x1b , 0x14 , 0 } ;
...
{
if ( V_48 == V_49 ) {
F_172 ( V_8 , 0x18 , 0x00000734 ) ;
F_172 ( V_8 , 0x19 , 0x0000073c ) ;
}
}
...
{
static const T_1 V_321 [] = { 0x1d , 0 } ;
static const T_1 V_322 [] = { 0x15 , 0x1b , 0x14 , 0x21 } ;
...
static int T_2 F_180 ( void )
{
return F_181 ( & V_328 ) ;
}
static void T_3 F_182 ( void )
{
F_183 ( & V_328 ) ;
}
