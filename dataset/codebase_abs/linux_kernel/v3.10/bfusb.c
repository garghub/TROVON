...
static int F_39 ( struct V_65 * V_19 )
{
struct V_2 * V_3 = F_36 ( V_19 ) ;
F_2 ( L_18 , V_19 , V_3 ) ;
F_40 ( & V_3 -> V_26 ) ;
...
static int F_41 ( struct V_65 * V_19 )
{
struct V_2 * V_3 = F_36 ( V_19 ) ;
unsigned long V_30 ;
F_2 ( L_18 , V_19 , V_3 ) ;
if ( ! F_42 ( V_29 , & V_19 -> V_30 ) )
return 0 ;
F_37 ( & V_3 -> V_35 , V_30 ) ;
F_38 ( & V_3 -> V_35 , V_30 ) ;
F_5 ( V_3 ) ;
...
memcpy ( F_44 ( V_5 , 1 ) , & F_32 ( V_5 ) -> V_44 , 1 ) ;
V_60 = V_5 -> V_13 ;
...
V_68 -> V_28 = ( void * ) V_3 ;
while ( V_60 ) {
V_36 = F_45 ( V_76 , V_60 , V_77 ) ;
V_41 [ 0 ] = 0xc1 | ( ( V_69 == 0 ) ? 0x04 : 0 ) | ( ( V_60 == V_36 ) ? 0x08 : 0 ) ;
V_41 [ 1 ] = 0x00 ;
V_41 [ 2 ] = ( V_36 == V_77 ) ? 0 : V_36 ;
memcpy ( F_33 ( V_68 , 3 ) , V_41 , 3 ) ;
F_46 ( V_5 , V_69 , F_33 ( V_68 , V_36 ) , V_36 ) ;
V_69 += V_36 ;
V_60 -= V_36 ;
}
if ( ( V_68 -> V_13 % V_3 -> V_78 ) == 0 ) {
V_41 [ 0 ] = 0xdd ;
V_41 [ 1 ] = 0x00 ;
memcpy ( F_33 ( V_68 , 2 ) , V_41 , 2 ) ;
}
F_25 ( & V_3 -> V_35 ) ;
F_7 ( & V_3 -> V_26 , V_68 ) ;
F_17 ( V_3 ) ;
...
static int F_47 ( struct V_65 * V_19 , unsigned int V_79 , unsigned long V_80 )
{
return - V_81 ;
}
static int F_48 ( struct V_2 * V_3 ,
const unsigned char * V_82 , int V_60 )
{
unsigned char * V_41 ;
int V_11 , V_12 , V_13 , V_36 , V_69 = 0 ;
F_2 ( L_22 , V_3 , V_3 -> V_16 ) ;
F_49 ( L_23 ) ;
V_41 = F_50 ( V_77 + 3 , V_83 ) ;
if ( ! V_41 ) {
F_14 ( L_24 ) ;
return - V_15 ;
}
V_12 = F_51 ( V_3 -> V_16 , 0 ) ;
if ( F_52 ( V_3 -> V_16 , V_12 , V_84 ,
0 , 1 , 0 , NULL , 0 , V_85 ) < 0 ) {
F_14 ( L_25 ) ;
F_53 ( V_41 ) ;
return - V_71 ;
}
V_3 -> V_16 -> V_86 [ 0 ] = V_3 -> V_16 -> V_86 [ 1 ] = 0 ;
V_12 = F_11 ( V_3 -> V_16 , V_3 -> V_17 ) ;
while ( V_60 ) {
V_36 = F_45 ( V_76 , V_60 , V_77 + 3 ) ;
memcpy ( V_41 , V_82 + V_69 , V_36 ) ;
...
F_53 ( V_41 ) ;
V_12 = F_51 ( V_3 -> V_16 , 0 ) ;
F_52 ( V_3 -> V_16 , V_12 , V_84 ,
0 , 0 , 0 , NULL , 0 , V_85 ) ;
return V_11 ;
}
static int F_55 ( struct V_88 * V_89 , const struct V_90 * V_91 )
{
const struct V_82 * V_82 ;
struct V_92 * V_16 = F_56 ( V_89 ) ;
struct V_93 * V_17 ;
struct V_93 * V_38 ;
struct V_65 * V_19 ;
struct V_2 * V_3 ;
F_2 ( L_30 , V_89 , V_91 ) ;
if ( V_89 -> V_94 -> V_95 . V_96 < 2 )
return - V_43 ;
V_17 = & V_89 -> V_94 -> V_97 [ 0 ] ;
V_38 = & V_89 -> V_94 -> V_97 [ 1 ] ;
if ( ! V_17 || ! V_38 ) {
F_14 ( L_31 ) ;
goto V_98;
}
V_3 = F_57 ( & V_89 -> V_28 , sizeof( struct V_2 ) , V_83 ) ;
if ( ! V_3 ) {
F_14 ( L_32 ) ;
goto V_98;
}
V_3 -> V_16 = V_16 ;
V_3 -> V_38 = V_38 -> V_95 . V_99 ;
V_3 -> V_17 = V_17 -> V_95 . V_99 ;
V_3 -> V_78 = F_58 ( V_17 -> V_95 . V_100 ) ;
F_59 ( & V_3 -> V_35 ) ;
V_3 -> V_42 = NULL ;
F_60 ( & V_3 -> V_26 ) ;
F_60 ( & V_3 -> V_9 ) ;
F_60 ( & V_3 -> V_6 ) ;
if ( F_61 ( & V_82 , L_33 , & V_16 -> V_28 ) < 0 ) {
F_14 ( L_34 ) ;
goto V_98;
}
F_2 ( L_35 , V_82 -> V_3 , V_82 -> V_36 ) ;
if ( F_48 ( V_3 , V_82 -> V_3 , V_82 -> V_36 ) < 0 ) {
F_14 ( L_36 ) ;
goto V_101;
}
F_62 ( V_82 ) ;
