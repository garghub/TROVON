...
static void F_69 ( struct V_206 * V_203 )
{
struct V_42 * V_43 = F_70 ( V_203 ) ;
...
V_203 -> V_209 = & V_35 -> V_203 ;
V_203 -> V_210 = & V_211 ;
V_203 -> V_212 = F_69 ;
V_203 -> V_200 = & V_43 -> V_181 -> V_200 ;
F_80 ( V_213 , & V_203 -> V_75 ) ;
if ( V_43 -> type == V_120 )
V_203 -> V_214 = V_215 ;
F_17 ( V_203 -> V_69 , V_35 -> V_69 , sizeof V_203 -> V_69 ) ;
V_43 -> V_203 = V_203 ;
F_81 ( V_203 , V_43 ) ;
V_112 = F_82 ( V_203 , V_216 , - 1 ) ;
if ( V_112 < 0 ) {
F_18 ( V_208 , L_93 ,
V_112 ) ;
V_43 -> V_203 = NULL ;
...
if ( V_43 -> type == V_122 )
V_43 -> V_181 -> V_217 |= V_218 ;
else
V_43 -> V_181 -> V_217 |= V_219 ;
F_73 ( & V_35 -> V_207 ) ;
return 0 ;
}
...
V_43 -> V_181 = V_181 ;
V_112 = F_76 ( V_35 , V_43 ) ;
if ( V_112 < 0 )
return V_112 ;
V_154 -> V_203 = V_43 -> V_203 ;
}
return 0 ;
}
...
const struct V_220 * V_36 )
{
struct V_143 * V_65 = F_87 ( V_53 ) ;
struct V_34 * V_35 ;
int V_112 ;
if ( V_36 -> V_147 && V_36 -> V_221 )
F_16 ( V_183 , L_97
L_98 , V_65 -> V_222 , V_36 -> V_147 ,
V_36 -> V_221 ) ;
else
F_16 ( V_183 , L_99 ,
V_65 -> V_222 ) ;
...
? V_36 -> V_226 : V_225 ;
if ( V_65 -> V_227 != NULL )
F_17 ( V_35 -> V_69 , V_65 -> V_227 , sizeof V_35 -> V_69 ) ;
else
snprintf ( V_35 -> V_69 , sizeof V_35 -> V_69 ,
L_100 ,
F_31 ( V_65 -> V_146 . V_147 ) ,
F_31 ( V_65 -> V_146 . V_221 ) ) ;
if ( F_42 ( V_35 ) < 0 ) {
F_16 ( V_183 , L_101
L_102 ) ;
goto error;
...
V_65 -> V_227 ? V_65 -> V_227 : L_104 ,
F_31 ( V_65 -> V_146 . V_147 ) ,
F_31 ( V_65 -> V_146 . V_221 ) ) ;
if ( V_35 -> V_97 != V_36 -> V_226 ) {
F_18 ( V_71 , L_105
L_106 , V_35 -> V_97 ) ;
F_18 ( V_71 , L_107
L_108 ) ;
...
#ifdef F_63
V_35 -> V_204 . V_35 = & V_53 -> V_35 ;
F_17 ( V_35 -> V_204 . V_228 , V_35 -> V_69 , sizeof( V_35 -> V_204 . V_228 ) ) ;
if ( V_65 -> V_229 )
F_17 ( V_35 -> V_204 . V_229 , V_65 -> V_229 ,
sizeof( V_35 -> V_204 . V_229 ) ) ;
strcpy ( V_35 -> V_204 . V_230 , V_65 -> V_222 ) ;
V_35 -> V_204 . V_231 = F_31 ( V_65 -> V_146 . V_232 ) ;
V_35 -> V_204 . V_233 = V_234 ;
if ( F_90 ( & V_35 -> V_204 ) < 0 )
goto error;
V_35 -> V_203 . V_204 = & V_35 -> V_204 ;
#endif
if ( F_91 ( & V_53 -> V_35 , & V_35 -> V_203 ) < 0 )
goto error;
if ( F_92 ( V_35 ) < 0 )
goto error;
if ( F_54 ( V_35 ) < 0 )
...
static void F_96 ( struct V_52 * V_53 )
{
struct V_34 * V_35 = F_97 ( V_53 ) ;
F_93 ( V_53 , NULL ) ;
if ( V_53 -> V_54 -> V_7 . V_113 ==
V_114 )
return;
...
static int F_98 ( struct V_52 * V_53 , T_7 V_238 )
{
struct V_34 * V_35 = F_97 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_239 , L_113 ,
...
static int F_101 ( struct V_52 * V_53 , int V_241 )
{
struct V_34 * V_35 = F_97 ( V_53 ) ;
struct V_42 * V_43 ;
F_16 ( V_239 , L_116 ,
...
F_10 (stream, &dev->streams, list) {
if ( V_43 -> V_53 == V_53 )
return F_104 ( V_43 , V_241 ) ;
}
F_16 ( V_239 , L_117
L_115 ) ;
return - V_68 ;
}
static int F_105 ( struct V_52 * V_53 )
{
return F_101 ( V_53 , 0 ) ;
}
...
static int F_107 ( char * V_50 , struct V_242 * V_243 )
{
if ( V_244 == V_245 )
...
static int F_108 ( const char * V_246 , struct V_242 * V_243 )
{
if ( strncasecmp ( V_246 , L_120 , strlen ( L_120 ) ) == 0 )
V_246 += strlen ( L_120 ) ;
if ( strcasecmp ( V_246 , L_121 ) == 0 )
V_244 = V_245 ;
else if ( strcasecmp ( V_246 , L_122 ) == 0 )
V_244 = V_247 ;
else
return - V_68 ;
return 0 ;
