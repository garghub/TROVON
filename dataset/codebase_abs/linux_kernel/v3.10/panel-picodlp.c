...
F_13 ( 1000 ) ;
F_26 ( V_3 , & V_3 -> V_109 . V_110 ) ;
F_27 ( V_3 , V_3 -> V_111 . V_112 . V_113 ) ;
V_21 = F_28 ( V_3 ) ;
if ( V_21 ) {
F_8 ( & V_3 -> V_23 , L_6 ) ;
goto V_114;
}
V_21 = F_14 ( V_105 -> V_115 ) ;
if ( V_21 )
goto V_25;
V_3 -> V_116 = V_117 ;
return V_21 ;
...
struct V_5 * V_115 ;
int V_21 , V_119 ;
V_3 -> V_109 . V_110 = V_120 ;
if ( ! V_106 )
return - V_121 ;
V_105 = F_32 ( & V_3 -> V_23 , sizeof( * V_105 ) , V_102 ) ;
if ( ! V_105 )
return - V_103 ;
F_18 ( & V_105 -> V_122 ) ;
V_119 = V_106 -> V_119 ;
...
T_3 * V_128 , T_3 * V_129 )
{
* V_128 = V_3 -> V_109 . V_110 . V_130 ;
* V_129 = V_3 -> V_109 . V_110 . V_131 ;
}
