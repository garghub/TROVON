...
V_222 = F_151 ( & V_269 -> V_90 , & V_5 -> V_78 ) ;
if ( V_222 )
goto V_285;
F_14 ( V_5 ) ;
return 0 ;
...
static int F_155 ( struct V_268 * V_265 )
{
struct V_4 * V_5 = F_156 ( V_265 ) ;
...
static void F_161 ( struct V_268 * V_265 )
{
struct V_4 * V_5 = F_156 ( V_265 ) ;
if ( F_3 ( V_5 , V_17 ) & V_27 )
F_109 ( V_5 ) ;
}
static int F_162 ( struct V_268 * V_265 , T_5 V_75 )
{
int V_48 ;
struct V_4 * V_5 = F_156 ( V_265 ) ;
struct V_44 * V_45 ;
...
static int F_163 ( struct V_268 * V_265 )
{
int V_48 ;
struct V_4 * V_5 = F_156 ( V_265 ) ;
struct V_44 * V_45 ;
