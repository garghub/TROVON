...
static int F_64 ( struct V_2 * V_3 , int V_157 ,
const T_2 * V_85 , T_3 V_158 )
{
struct V_4 * V_5 = V_3 -> V_6 ;
...
V_5 -> V_10 -> V_15 + V_162 ) ;
for ( V_160 = 0 ;
F_65 ( V_5 -> V_10 -> V_15 + V_163 ) !=
0x3 && V_160 < V_159 ; ++ V_160 ) {
F_66 ( 1 ) ;
}
if ( V_160 == V_159 ) {
F_67 ( V_3 -> V_164 ,
...
for ( V_161 = 0 ; V_161 + 1 < V_158 ; ) {
unsigned int V_165 = V_85 [ V_161 ++ ] ;
V_165 |= V_85 [ V_161 ++ ] << 8 ;
F_39 ( V_165 ,
V_5 -> V_10 -> V_15 + V_166 ) ;
for ( V_160 = 0 ;
...
F_39 ( 0x0 , V_5 -> V_10 -> V_15 + V_162 ) ;
return 0 ;
}
static int F_70 ( struct V_2 * V_3 , int V_157 )
{
return F_64 ( V_3 , V_157 , NULL , 0 ) ;
}
...
V_155 = F_70 ( V_3 , V_160 ) ;
if ( V_155 < 0 )
break;
}
F_39 ( 0x0 , V_5 -> V_10 -> V_15 + V_167 ) ;
return V_155 ;
}
...
static const char * const V_176 [ 3 ] = {
V_177 ,
V_178 ,
V_179 ,
} ;
...
V_155 = F_74 ( & V_175 , V_176 [ V_86 ] ,
& V_5 -> V_10 -> V_180 -> V_3 ) ;
if ( V_155 == 0 ) {
V_155 = F_64 ( V_3 , V_86 , V_175 -> V_85 , V_175 -> V_181 ) ;
if ( V_155 == 0 && V_86 == 2 )
F_72 ( V_3 ) ;
F_75 ( V_175 ) ;
}
...
return - V_187 ;
V_3 -> V_188 = V_185 ;
V_3 -> V_189 = V_185 -> V_190 ;
V_155 = F_79 ( V_3 ) ;
if ( V_155 )
return V_155 ;
V_5 = F_80 ( sizeof( * V_5 ) , V_191 ) ;
if ( ! V_5 )
return - V_192 ;
V_3 -> V_6 = V_5 ;
F_81 ( & V_5 -> V_8 ) ;
...
if ( V_155 )
return V_155 ;
F_87 ( V_3 -> V_164 , L_19 , V_3 -> V_189 ,
F_23 ( V_5 -> V_10 -> V_15 + V_194 ) ) ;
V_18 = & V_3 -> V_31 [ 0 ] ;
V_3 -> V_195 = V_18 ;
V_18 -> type = V_196 ;
V_18 -> V_197 =
...
F_30 ( 0 , V_5 -> V_10 -> V_15 + F_88 ( 0 ) ) ;
F_9 ( 0x00 ,
V_5 -> V_10 -> V_15 +
V_53 ) ;
V_155 = F_89 ( V_29 , F_22 , V_217 ,
L_20 , V_3 ) ;
if ( V_155 < 0 )
F_67 ( V_3 -> V_164 , L_21 ) ;
V_3 -> V_29 = V_29 ;
...
static int F_96 ( struct V_183 * V_3 ,
const struct V_218 * V_219 )
{
return F_97 ( V_3 , & V_220 , V_219 -> V_221 ) ;
}
