...
static int F_17 ( struct V_27 * V_28 , unsigned long V_8 )
{
int V_15 ;
T_3 V_29 ;
V_28 -> V_8 = F_18 ( V_8 , 1 << V_22 ) ;
F_3 ( L_14 , V_20 , __LINE__ , V_8 ) ;
F_3 ( L_15 , V_20 , __LINE__ , V_28 -> V_8 ) ;
F_3 ( L_16 , V_20 , __LINE__ ,
V_8 - V_28 -> V_8 , ( V_8 - V_28 -> V_8 ) / 1024 / 1024 ) ;
if ( V_28 -> V_8 == 0 ) {
F_3 ( L_17 , V_20 , __LINE__ ) ;
V_15 = - 1 ;
goto V_30;
}
V_15 = F_19 ( V_28 -> V_8 , V_22 , 0 ,
V_31 , & V_28 -> V_12 , & V_29 ) ;
...
F_3 ( L_20 , V_20 , __LINE__ , V_28 -> V_12 ) ;
if ( V_28 -> V_12 ) {
V_15 = F_22 ( V_28 -> V_12 ) ;
F_5 ( V_15 ) ;
V_28 -> V_8 = V_28 -> V_12 = V_28 -> V_13 = 0 ;
...
{
int V_15 ;
V_15 = F_24 ( 0 , & V_28 -> V_12 , & V_28 -> V_8 ) ;
if ( V_15 )
goto V_30;
...
return 0 ;
V_30:
F_3 ( L_22 , V_20 , __LINE__ ) ;
V_28 -> V_8 = V_28 -> V_12 = V_28 -> V_13 = 0 ;
return V_15 ;
}
static unsigned long F_25 ( struct V_33 * V_28 ,
unsigned long V_34 )
{
if ( V_34 >= V_3 . V_7 . V_8 )
V_34 -= V_3 . V_11 . V_13 ;
...
static void T_1 F_26 ( const struct V_33 * V_28 ,
const char * V_5 , int line )
{
...
static void F_27 ( const struct V_41 * V_42 , const char * V_5 ,
int line )
{
F_3 ( L_28 , V_5 , line ,
...
static struct V_41 * F_28 ( struct V_33 * V_28 ,
unsigned long V_36 , unsigned long V_35 )
{
struct V_41 * V_42 ;
unsigned long V_44 = F_18 ( V_36 , 1 << V_28 -> V_40 ) ;
unsigned long V_45 = F_29 ( V_35 + V_36 - V_44 ,
1 << V_28 -> V_40 ) ;
F_30 (c, &r->chunk_list.head, link) {
if ( V_44 >= V_42 -> V_36 &&
...
static struct V_41 * F_33 ( struct V_33 * V_28 ,
unsigned long V_34 , unsigned long V_35 )
{
struct V_41 * V_42 ;
unsigned long V_46 = F_18 ( V_34 , 1 << V_28 -> V_40 ) ;
unsigned long V_45 = F_29 ( V_35 + V_34 - V_46 ,
1 << V_28 -> V_40 ) ;
F_30 (c, &r->chunk_list.head, link) {
if ( V_42 -> V_34 <= V_46 &&
...
static int F_39 ( struct V_33 * V_28 , unsigned long V_14 ,
unsigned long V_35 , struct V_41 * * V_49 , T_3 V_50 )
{
int V_15 ;
struct V_41 * V_42 ;
V_42 = F_40 ( sizeof( struct V_41 ) , V_51 ) ;
if ( ! V_42 ) {
V_15 = - V_52 ;
goto V_53;
}
V_42 -> V_43 = V_28 ;
V_42 -> V_34 = F_4 ( V_14 ) ;
V_42 -> V_36 = F_25 ( V_28 , V_42 -> V_34 ) ;
V_42 -> V_35 = V_35 ;
F_5 ( V_50 != 0xf800000000000000UL ) ;
V_15 = F_41 ( V_42 -> V_43 -> V_37 -> V_38 ,
...
static int F_43 ( struct V_33 * V_28 , unsigned long V_14 ,
...
V_42 -> V_35 = V_35 ;
V_42 -> V_34 = F_4 ( V_14 ) ;
if ( F_44 ( & V_28 -> V_56 . V_57 ) ) {
V_42 -> V_36 = V_28 -> V_36 ;
} else {
V_58 = F_45 ( V_28 -> V_56 . V_57 . V_61 ,
struct V_41 , V_55 ) ;
...
static int F_47 ( struct V_33 * V_28 )
{
int V_15 ;
T_3 V_36 ;
...
F_48 ( & V_28 -> V_56 . V_57 ) ;
F_49 ( & V_28 -> V_56 . V_63 ) ;
V_15 = F_50 ( V_28 -> V_37 -> V_38 , V_28 -> V_37 -> V_39 ,
F_51 ( V_28 -> V_35 ) , V_28 -> V_40 , V_28 -> V_64 ,
& V_36 ) ;
V_28 -> V_36 = V_36 ;
if ( V_15 ) {
F_3 ( L_50 ,
...
static int F_52 ( struct V_33 * V_28 )
{
int V_15 ;
T_3 V_36 ;
F_48 ( & V_28 -> V_56 . V_57 ) ;
...
F_55 (c, tmp, &r->chunk_list.head, link) {
F_56 ( & V_42 -> V_55 ) ;
F_34 ( V_42 ) ;
}
V_15 = F_57 ( V_28 -> V_37 -> V_38 , V_28 -> V_37 -> V_39 ,
V_28 -> V_36 ) ;
if ( V_15 )
F_3 ( L_53 ,
V_20 , __LINE__ , F_9 ( V_15 ) ) ;
...
static int F_58 ( struct V_33 * V_28 )
{
int V_15 ;
struct V_41 * V_42 , * V_66 ;
F_3 ( L_54 , V_20 ) ;
F_55 (c, n, &r->chunk_list.head, link) {
F_56 ( & V_42 -> V_55 ) ;
F_37 ( V_42 ) ;
}
V_15 = F_59 ( 0 , V_28 -> V_36 ) ;
if ( V_15 )
F_3 ( L_53 ,
V_20 , __LINE__ , F_9 ( V_15 ) ) ;
V_28 -> V_36 = 0 ;
...
static int F_60 ( struct V_33 * V_28 , unsigned long V_67 ,
...
unsigned long V_19 ;
struct V_41 * V_42 ;
unsigned long V_14 = F_6 ( V_67 ) ? F_61 ( V_67 )
: V_67 ;
unsigned long V_68 = F_18 ( V_14 , 1 << V_28 -> V_40 ) ;
unsigned long V_45 = F_29 ( V_35 + V_14 - V_68 ,
1 << V_28 -> V_40 ) ;
* V_36 = F_25 ( V_28 , F_4 ( V_14 ) ) ;
if ( ! V_69 ) {
...
F_62 ( & V_28 -> V_56 . V_63 , V_19 ) ;
V_42 = F_28 ( V_28 , * V_36 , V_35 ) ;
if ( V_42 ) {
F_3 ( L_61 , V_20 , __LINE__ ) ;
F_31 ( V_42 ) ;
V_42 -> V_70 ++ ;
F_63 ( & V_28 -> V_56 . V_63 , V_19 ) ;
return 0 ;
}
V_15 = F_39 ( V_28 , V_68 , V_45 , & V_42 , V_50 ) ;
if ( V_15 ) {
* V_36 = 0 ;
F_3 ( L_62 ,
V_20 , __LINE__ , V_15 ) ;
...
static int F_64 ( struct V_33 * V_28 , unsigned long V_67 ,
unsigned long V_35 , T_4 * V_36 ,
T_3 V_50 )
{
int V_15 ;
...
static int F_65 ( struct V_33 * V_28 , T_4 V_36 ,
unsigned long V_35 )
{
unsigned long V_19 ;
struct V_41 * V_42 ;
...
V_42 = F_28 ( V_28 , V_36 , V_35 ) ;
if ( ! V_42 ) {
unsigned long V_44 = F_18 ( V_36 ,
1 << V_28 -> V_40 ) ;
unsigned long V_45 = F_29 ( V_35 + V_36
- V_44 , 1 << V_28 -> V_40 ) ;
F_3 ( L_67 ,
V_20 , __LINE__ , V_36 ) ;
F_3 ( L_68 ,
...
static int F_66 ( struct V_33 * V_28 ,
...
static int F_67 ( struct V_33 * V_28 )
{
int V_15 ;
...
V_20 , __LINE__ ) ;
V_28 -> V_40 = V_71 ;
V_28 -> V_35 = F_29 ( V_28 -> V_35 , 1 << V_28 -> V_40 ) ;
}
}
V_15 = F_47 ( V_28 ) ;
F_5 ( V_15 ) ;
...
V_28 -> V_35 = V_35 ? V_35 : F_29 ( V_3 . V_6 , 1 << V_28 -> V_40 ) ;
switch ( V_37 -> V_80 ) {
case V_81 :
V_28 -> V_62 = ( V_69 )
? & V_82
...
int F_74 ( struct V_33 * V_28 , unsigned long V_67 ,
unsigned long V_35 , T_4 * V_36 ,
T_3 V_50 )
{
return V_28 -> V_62 -> V_3 ( V_28 , V_67 , V_35 , V_36 , V_50 ) ;
}
int F_75 ( struct V_33 * V_28 , T_4 V_36 ,
unsigned long V_35 )
{
...
int V_15 ;
F_3 ( L_55 , V_20 , __LINE__ ) ;
V_15 = F_77 ( & V_3 . V_7 . V_12 , & V_3 . V_7 . V_8 ,
& V_3 . V_6 ) ;
if ( V_15 )
F_14 ( L_73 ) ;
...
F_5 ( ! V_3 . V_7 . V_8 ) ;
if ( F_23 ( & V_3 . V_11 ) )
F_17 ( & V_3 . V_11 , V_3 . V_6 - V_3 . V_7 . V_8 ) ;
...
V_3 . V_6 - V_3 . V_7 . V_8 ) ;
F_78 ( V_3 . V_7 . V_8 , V_3 . V_6 - V_3 . V_7 . V_8 ) ;
}
F_3 ( L_41 , V_20 , __LINE__ ) ;
}
void F_79 ( void )
