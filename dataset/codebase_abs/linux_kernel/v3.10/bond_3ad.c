...
int F_90 ( struct V_1 * V_4 , struct V_215 * V_215 )
{
int V_207 ;
F_80 ( & V_4 -> V_203 ) ;
V_207 = F_89 ( V_4 , V_215 ) ;
F_82 ( & V_4 -> V_203 ) ;
return V_207 ;
}
int F_91 ( struct V_89 * V_90 , struct V_218 * V_14 )
{
struct V_3 * V_3 , * V_219 ;
struct V_1 * V_4 = F_92 ( V_14 ) ;
int V_220 ;
int V_221 ;
int V_222 ;
int V_223 ;
...
V_219 = V_3 ;
F_94 (bond, slave, i, start_at) {
int V_227 = 0 ;
struct V_8 * V_9 = F_4 ( V_3 ) . V_2 . V_8 ;
if ( V_9 )
V_227 = V_9 -> V_154 ;
if ( F_95 ( V_3 ) && V_9 && ( V_227 == V_222 ) ) {
V_224 = F_96 ( V_4 , V_90 , V_3 -> V_14 ) ;
break;
}
}
V_225:
...
int F_98 ( const struct V_89 * V_90 , struct V_1 * V_4 ,
struct V_3 * V_3 )
{
int V_207 = V_208 ;
...
if ( V_90 -> V_97 != V_98 )
return V_207 ;
V_46 = F_99 ( V_90 , 0 , sizeof( V_229 ) , & V_229 ) ;
if ( ! V_46 )
return V_207 ;
F_80 ( & V_4 -> V_203 ) ;
