...
V_107 ) ;
V_102 . V_7 = F_29 ( F_30 ( V_15 -> V_102 . V_7 , 2 ) , V_108 ,
V_109 ) ;
V_102 . V_23 = F_29 ( F_30 ( V_15 -> V_102 . V_23 , 2 ) , V_110 ,
V_111 ) ;
V_102 . V_7 = F_31 ( V_102 . V_7 , V_112 - V_102 . V_30 ) ;
V_102 . V_23 = F_31 ( V_102 . V_23 , V_113 - V_102 . V_32 ) ;
...
if ( V_115 -> V_12 . V_22 == 0 )
V_115 -> V_12 . V_22 = 1 ;
V_26 = F_9 ( V_6 , & V_115 -> V_12 ) ;
if ( ! V_26 )
V_6 -> V_19 = V_115 -> V_12 ;
V_100:
F_25 ( & V_6 -> V_98 ) ;
...
static int F_35 ( struct V_74 * V_116 ,
struct V_117 * V_3 )
{
struct V_5 * V_6 = F_23 ( V_116 ) ;
struct V_1 * V_2 = F_10 ( & V_6 -> V_13 ) ;
int V_118 ;
if ( V_3 -> V_119 . type != V_120 || V_3 -> V_3 > 0xff )
return - V_80 ;
if ( V_3 -> V_119 . V_121 != V_2 -> V_121 )
return - V_122 ;
V_118 = F_1 ( V_2 , V_3 -> V_3 ) ;
if ( V_118 < 0 )
return - V_123 ;
V_3 -> V_124 = 2 ;
V_3 -> V_118 = V_118 ;
...
static int F_36 ( struct V_74 * V_116 ,
const struct V_117 * V_3 )
{
struct V_5 * V_6 = F_23 ( V_116 ) ;
struct V_1 * V_2 = F_10 ( & V_6 -> V_13 ) ;
if ( V_3 -> V_119 . type != V_120 || V_3 -> V_3 > 0xff )
...
if ( V_3 -> V_119 . V_121 != V_2 -> V_121 )
return - V_122 ;
return F_3 ( V_2 , V_3 -> V_3 , V_3 -> V_118 ) ;
}
static int F_37 ( struct V_5 * V_6 , bool V_125 , bool V_126 )
{
struct V_1 * V_2 = F_10 ( & V_6 -> V_13 ) ;
int V_34 = ( V_125 << V_127 )
| ( V_126 << V_128 )
| V_129
| 0x0007 ;
return F_3 ( V_2 , V_130 , V_34 ) ;
}
static int F_38 ( struct V_5 * V_6 , T_4 V_118 )
{
struct V_1 * V_2 = F_10 ( & V_6 -> V_13 ) ;
int V_131 ;
int V_132 ;
...
| ( ( V_132 & 1 ) << V_136 )
| ( V_133 & V_137 ) ;
return F_3 ( V_2 , V_138 , V_34 ) ;
}
static int F_39 ( struct V_139 * V_140 )
{
if ( V_140 -> V_141 == V_142 && V_140 -> V_118 >= 63 ) {
V_140 -> V_118 &= ~ 1 ;
}
return 0 ;
}
...
{
struct V_5 * V_6 =
F_41 ( V_140 -> V_143 , struct V_5 , V_144 ) ;
struct V_1 * V_2 = F_10 ( & V_6 -> V_13 ) ;
int V_26 ;
switch ( V_140 -> V_141 ) {
case V_142 :
return F_38 ( V_6 , V_140 -> V_118 ) ;
case V_145 :
return F_37 ( V_6 , V_6 -> V_125 -> V_118 ,
V_6 -> V_126 -> V_118 ) ;
case V_146 :
V_26 = F_3 ( V_2 , V_147 ,
( V_140 -> V_118 >> 16 ) & 0xffff ) ;
if ( V_26 < 0 )
return V_26 ;
return F_3 ( V_2 , V_148 ,
V_140 -> V_118 & 0xffff ) ;
}
return 0 ;
}
...
{
struct V_53 * V_54 = V_2 -> V_58 . V_151 ;
...
if ( ! V_2 -> V_58 . V_151 )
return - V_122 ;
V_6 = F_46 ( sizeof( * V_6 ) , V_156 ) ;
if ( V_6 == NULL )
return - V_157 ;
F_47 ( & V_6 -> V_98 ) ;
V_6 -> V_54 = V_54 ;
F_48 ( & V_6 -> V_13 , V_2 , & V_158 ) ;
V_6 -> V_13 . V_159 |= V_160 ;
V_154 = F_1 ( V_2 , V_161 ) ;
if ( V_154 != V_162 ) {
F_43 ( & V_2 -> V_58 , L_4
L_5 , V_154 ) ;
...
F_50 ( & V_6 -> V_144 , 5 ) ;
F_51 ( & V_6 -> V_144 , & V_170 ,
V_142 , 0 , 127 , 1 , 64 ) ;
V_6 -> V_126 = F_51 ( & V_6 -> V_144 ,
& V_170 ,
V_145 , 0 , 1 , 1 , 0 ) ;
V_6 -> V_125 = F_51 ( & V_6 -> V_144 ,
& V_170 ,
V_171 , 0 , 1 , 1 , 0 ) ;
F_51 ( & V_6 -> V_144 , & V_170 ,
V_146 , V_172 ,
...
if ( V_6 -> V_144 . error ) {
V_26 = V_6 -> V_144 . error ;
F_43 ( & V_2 -> V_58 , L_7 , V_26 ) ;
goto V_176;
}
F_52 ( 2 , & V_6 -> V_126 ) ;
V_6 -> V_13 . V_177 = & V_6 -> V_144 ;
V_6 -> V_178 . V_159 = V_179 ;
V_26 = F_53 ( & V_6 -> V_13 . V_180 , 1 , & V_6 -> V_178 , 0 ) ;
if ( V_26 < 0 )
goto V_176;
...
V_26 = F_3 ( V_2 , V_186 , 1 ) ;
if ( V_26 < 0 )
goto V_182;
F_56 ( 100 ) ;
V_26 = F_3 ( V_2 , V_186 , 0 ) ;
if ( V_26 < 0 )
goto V_182;
F_56 ( 100 ) ;
V_26 = F_13 ( V_6 , false ) ;
