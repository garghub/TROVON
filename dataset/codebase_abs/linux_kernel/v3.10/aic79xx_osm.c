...
V_52 = F_43 ( V_2 , V_55 , V_2 -> V_58 ,
V_242 , & V_54 ) ;
if ( V_52 -> V_112 . V_65 != V_52 -> V_280 . V_65
|| V_52 -> V_112 . V_21 != V_52 -> V_280 . V_21
|| V_52 -> V_112 . V_66 != V_52 -> V_280 . V_66
|| V_52 -> V_112 . V_113 != V_52 -> V_280 . V_113 )
if ( V_73 == 0 )
break;
...
&& V_52 -> V_112 . V_113 == V_278 )
if ( V_73 == 0 )
break;
F_154 ( V_43 ) = V_52 -> V_112 . V_65 ;
F_155 ( V_43 ) = V_52 -> V_112 . V_21 ;
F_156 ( V_43 ) = V_52 -> V_112 . V_66 ;
F_147 ( V_43 ) = V_52 -> V_112 . V_113 & V_281 ? 1 : 0 ;
F_148 ( V_43 ) = V_52 -> V_112 . V_113 & V_282 ? 1 : 0 ;
F_149 ( V_43 ) = V_52 -> V_112 . V_113 & V_114 ? 1 : 0 ;
F_150 ( V_43 ) = V_52 -> V_112 . V_113 & V_283 ? 1 : 0 ;
F_151 ( V_43 ) = V_52 -> V_112 . V_113 & V_284 ? 1 : 0 ;
F_45 ( V_43 ) = V_52 -> V_112 . V_113 & V_285 ? 1 : 0 ;
F_152 ( V_43 ) = V_52 -> V_112 . V_113 & V_286 ? 1 : 0 ;
F_153 ( V_43 ) = V_52 -> V_112 . V_113 & V_287 ? 1 : 0 ;
F_157 ( V_43 ) ;
break;
}
case V_288 :
...
struct V_24 * V_25 ;
V_25 = V_3 -> V_26 ;
if ( ( V_3 -> V_47 & ( V_308 | V_309 ) ) != 0 ) {
struct V_310 * V_311 ;
T_6 V_312 ;
T_6 V_313 ;
if ( V_3 -> V_47 & V_308 ) {
V_312 = F_175 ( sizeof( struct V_314 )
- F_176 ( V_3 ) ,
( T_14 ) V_315 ) ;
V_313 = 0 ;
} else {
...
F_189 ( V_2 ) ;
V_93 = TRUE ;
if ( ( V_359 -> V_47 & V_111 ) == 0 ) {
F_71 ( V_76 , V_25 , L_62 ) ;
goto V_367;
}
F_2 ( L_63 ,
F_56 ( V_2 ) , V_364 ? L_64 : L_65 ) ;
F_163 ( V_2 ) ;
V_365 = TRUE ;
...
V_366 = F_191 ( V_2 ) ;
F_192 ( V_2 , V_369 , V_369 ) ;
V_362 = F_8 ( V_2 , V_370 ) ;
V_360 = F_193 ( V_2 ) ;
V_361 = V_360 ;
if ( V_365 && ( F_8 ( V_2 , V_371 ) & V_372 ) == 0 ) {
struct V_3 * V_373 ;
V_373 = F_194 ( V_2 , V_361 ) ;
if ( V_373 == V_359 )
V_365 = FALSE ;
}
V_363 = F_8 ( V_2 , V_374 ) ;
if ( V_362 != V_375
&& F_162 ( V_359 ) == V_361 ) {
V_359 = F_194 ( V_2 , V_361 ) ;
V_359 -> V_47 |= V_110 | V_376 ;
F_12 ( V_2 , V_377 , V_378 ) ;
F_12 ( V_2 , V_379 , V_362 | V_380 ) ;
F_71 ( V_76 , V_25 , L_67 ) ;
V_94 = TRUE ;
} else if ( V_365 ) {
V_359 -> V_47 |= V_110 | V_376 ;
F_195 ( V_2 , F_162 ( V_359 ) ) ;
V_359 -> V_102 -> V_106 = 0 ;
V_359 -> V_102 -> V_381 = 0 ;
V_359 -> V_102 -> V_107 = V_382 ;
if ( ( V_359 -> V_47 & V_115 ) != 0 ) {
F_12 ( V_2 , V_383 ,
V_359 -> V_102 -> V_107 ) ;
} else {
V_359 -> V_102 -> V_103 |= V_116 | V_384 ;
F_12 ( V_2 , V_385 ,
F_8 ( V_2 , V_385 ) | V_116 ) ;
}
...
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_49 V_50 ;
unsigned long V_47 ;
F_50 ( & V_50 , V_386 -> V_193 , V_43 -> V_57 , 0 ,
V_43 -> V_55 + 'A' , V_68 ) ;
F_41 ( V_2 , & V_47 ) ;
...
= F_43 ( V_2 ,
V_43 -> V_55 + 'A' ,
V_386 -> V_193 , V_43 -> V_57 , & V_54 ) ;
struct V_49 V_50 ;
unsigned int V_113 = V_52 -> V_280 . V_113 ;
unsigned int V_387 ;
unsigned long V_47 ;
unsigned long V_66 = V_52 -> V_280 . V_66 ;
#ifdef F_80
if ( ( V_124 & V_388 ) != 0 )
...
unsigned int V_65 = 0 ;
unsigned int V_387 = V_113 & V_281 ;
unsigned long V_47 ;
#ifdef F_80
if ( ( V_124 & V_388 ) != 0 )
...
V_43 -> V_55 + 'A' , V_68 ) ;
if ( V_66 != 0 ) {
V_65 = V_52 -> V_280 . V_65 ;
V_113 = V_52 -> V_280 . V_113 ;
F_200 ( V_2 , & V_65 , & V_113 ,
V_387 ? V_390 : V_391 ) ;
}
F_41 ( V_2 , & V_47 ) ;
...
static void F_202 ( struct V_42 * V_43 , int V_387 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
unsigned int V_113 = V_52 -> V_280 . V_113
& ~ V_281 ;
unsigned int V_65 = V_52 -> V_280 . V_65 ;
unsigned int V_21 = V_52 -> V_280 . V_21 ;
unsigned long V_47 ;
#ifdef F_80
if ( ( V_124 & V_388 ) != 0 )
F_2 ( L_76 , F_56 ( V_2 ) ,
...
V_387 ? V_390 : V_391 ) ;
F_41 ( V_2 , & V_47 ) ;
F_51 ( V_2 , & V_50 , V_65 , V_52 -> V_280 . V_66 ,
V_113 , V_69 , FALSE ) ;
F_53 ( V_2 , & V_47 ) ;
}
static void F_203 ( struct V_42 * V_43 , int V_392 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_204 ( struct V_42 * V_43 , int V_393 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_205 ( struct V_42 * V_43 , int V_394 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_206 ( struct V_42 * V_43 , int V_395 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_207 ( struct V_42 * V_43 , int V_396 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_208 ( struct V_42 * V_43 , int V_397 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_209 ( struct V_42 * V_43 , int V_398 )
{
struct V_28 * V_386 = F_39 ( V_43 -> V_36 . V_126 ) ;
struct V_1 * V_2 = * ( (struct V_1 * * ) V_386 -> V_32 ) ;
struct V_53 * V_54 ;
...
static void F_210 ( struct V_28 * V_386 )
{
struct V_1 * V_2 = * (struct V_1 * * ) V_386 -> V_32 ;
unsigned long V_47 ;
T_22 V_399 ;
