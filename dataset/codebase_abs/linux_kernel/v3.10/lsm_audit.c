...
case V_63 : {
struct V_64 * V_64 ;
F_19 ( V_46 , L_7 , & V_52 -> V_10 . V_65 ) ;
V_64 = V_52 -> V_10 . V_65 . V_66 -> V_67 ;
if ( V_64 ) {
F_14 ( V_46 , L_8 ) ;
F_18 ( V_46 , V_64 -> V_68 -> V_69 ) ;
...
struct V_64 * V_64 ;
F_14 ( V_46 , L_10 ) ;
F_18 ( V_46 , V_52 -> V_10 . V_66 -> V_72 . V_73 ) ;
...
struct V_98 * V_99 ;
V_99 = F_26 ( & V_100 , V_52 -> V_10 . V_11 -> V_97 ) ;
if ( V_99 ) {
...
F_14 ( V_46 , L_21 ) ;
F_18 ( V_46 , V_52 -> V_10 . V_102 . V_104 ) ;
}
break;
#endif
case V_105 :
F_14 ( V_46 , L_22 ) ;
F_18 ( V_46 , V_52 -> V_10 . V_106 ) ;
break;
}
}
void F_29 ( struct V_3 * V_52 ,
...
if ( V_52 == NULL )
return;
V_46 = F_32 ( V_55 -> V_107 , V_108 , V_109 ) ;
if ( V_46 == NULL )
return;
if ( F_30 )
F_30 ( V_46 , V_52 ) ;
