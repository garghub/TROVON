...
int error = 0 ;
F_28 ( L_1 ,
V_2 , V_32 , V_32 && V_32 -> V_39 ?
F_29 ( F_30 ( V_32 -> V_39 -> type ) )
: L_2 ) ;
if ( F_31 ( V_32 ) ) {
...
{
struct V_10 * V_55 ;
struct V_3 * V_56 , * V_30 ;
T_1 V_57 , V_58 ;
int V_59 = 0 ;
V_56 = F_5 ( V_54 , struct V_3 , V_35 ) ;
V_57 = F_35 ( V_56 -> V_60 . V_61 -> V_20 ) ;
F_36 (pos, head) {
V_30 = F_5 ( V_55 , struct V_3 , V_35 ) ;
V_58 = F_35 ( V_30 -> V_60 . V_61 -> V_20 ) ;
if ( F_13 ( V_57 , V_58 ) ) {
F_2 ( V_54 , V_55 -> V_62 ) ;
V_59 = 1 ;
break;
...
( V_122 -> V_40 == V_132 ) ||
( V_122 -> V_40 == V_133 ) ) {
if ( V_32 -> V_39 -> type != V_134 &&
V_32 -> V_39 -> type != V_135 &&
V_32 -> V_39 -> type != V_136 )
V_122 = V_24 -> V_68 . V_130 ;
}
if ( V_122 != V_15 ) {
V_15 = V_122 ;
...
F_28 ( L_8
L_9 ,
F_35 ( V_32 -> V_60 . V_61 -> V_20 ) ,
V_32 -> V_8 ? V_32 -> V_8 -> V_53 : NULL ,
V_32 -> V_8 ?
...
{
struct V_23 * V_24 = V_2 -> V_24 ;
struct V_170 * V_171 = V_32 -> V_60 . V_179 ;
struct V_13 * V_15 ;
...
V_227 = V_20 - V_182 ;
for ( V_120 = 0 ; V_120 < F_62 ( V_171 -> V_175 ) ; ++ V_120 ) {
if ( F_64 ( F_62 ( V_172 [ V_120 ] . V_176 . V_178 ) , V_227 ) &&
F_64 ( V_227 , F_62 ( V_172 [ V_120 ] . V_176 . V_177 ) ) )
goto V_228;
}
return 0 ;
V_228:
...
static inline int F_79 ( struct V_229 * V_230 ,
int V_231 , T_8 V_232 )
{
int V_120 ;
for ( V_120 = 0 ; V_120 < V_231 ; V_120 ++ ) {
if ( V_230 [ V_120 ] . V_232 == V_232 )
return V_120 ;
}
return V_120 ;
}
...
V_235 = F_79 ( & V_234 [ 0 ] ,
V_231 ,
V_32 -> V_60 . V_61 -> V_232 ) ;
V_234 [ V_235 ] . V_232 =
V_32 -> V_60 . V_61 -> V_232 ;
V_234 [ V_235 ] . V_237 =
V_32 -> V_60 . V_61 -> V_237 ;
if ( V_235 == V_231 )
V_231 ++ ;
if ( V_231 == 10 )
break;
...
if ( V_24 -> V_198 > V_182 )
V_233 = F_80 ( V_24 , V_24 -> V_198 ,
V_231 , & V_234 [ 0 ] ) ;
if ( V_233 ) {
F_8 ( & V_233 -> V_5 , & V_2 -> V_25 ) ;
F_32 ( F_27 ( V_24 -> V_37 . V_38 ) , V_51 ) ;
}
}
