...
V_150 = V_17 -> V_179 ;
V_149 = F_45 ( V_17 -> V_184 ) ;
V_181 = F_35 ( V_22 -> V_177 ,
V_17 -> V_178 ) ;
if ( V_181 ) {
clock = V_181 -> V_185 ;
V_154 = F_45 ( V_181 -> V_186 ) ;
break;
}
...
if ( F_47 ( V_22 , V_4 , V_149 , V_153 , V_12 , V_112 ) < 0 ) {
F_3 ( V_4 -> V_7 ) ;
F_3 ( V_4 -> V_8 ) ;
F_3 ( V_4 ) ;
V_4 = NULL ;
...
F_44 ( V_199 L_12 , V_21 -> V_127 , V_113 , V_148 , V_4 -> V_29 ) ;
...
F_48 ( V_22 -> V_21 , V_113 , V_148 ) ;
F_49 ( V_22 , V_113 , V_112 , V_4 ) ;
F_50 ( V_22 , V_113 , V_112 , V_4 , V_4 -> V_200 ) ;
}
return 0 ;
}
