...
static int F_38 ( const struct V_82 * V_83 , T_5 V_84 , T_5 V_85 )
{
struct V_31 * V_32 =
...
void F_62 ( struct V_87 * V_115 )
{
}
char * F_63 ( char * V_102 )
{
...
static void F_66 ( struct V_82 * V_157 )
{
...
void T_12 * F_69 ( T_1 V_162 , unsigned long V_4 )
{
...
void F_70 ( struct V_82 * V_83 , void T_12 * V_168 )
{
F_71 ( V_168 ) ;
}
static int F_72 ( struct V_87 * V_115 , unsigned int V_141 , int V_108 ,
int V_4 , T_13 * V_169 )
{
...
static int F_78 ( struct V_87 * V_115 , unsigned int V_141 , int V_108 ,
int V_4 , T_13 V_169 )
{
struct V_31 * V_32 = V_115 -> V_86 ;
T_2 * V_33 = V_32 -> V_34 ;
...
T_14 V_174 ;
void * V_175 ;
T_13 V_182 = ( T_13 ) V_169 ;
T_15 V_183 = ( T_15 ) V_169 ;
T_5 V_184 = ( T_5 ) V_169 ;
if ( F_74 ( V_115 ) ) {
if ( V_84 == 0 ) {
unsigned int V_37 ;
