...
V_11 -> V_4 . V_69 -> V_109 , V_11 -> V_4 . V_70 -> V_109 ,
V_11 -> V_39 -> V_109 ) ;
return 0 ;
V_65:
if ( V_11 -> V_14 ) {
F_35 ( V_11 -> V_14 -> V_22 ) ;
F_36 ( V_11 -> V_39 , V_11 -> V_14 ) ;
}
if ( V_11 -> V_39 )
V_11 -> V_39 -> V_66 = NULL ;
if ( V_11 -> V_4 . V_70 )
...
ERROR ( V_18 , L_22 , V_3 -> V_109 , V_21 ) ;
return V_21 ;
}
static void
F_37 ( struct V_79 * V_80 , struct V_2 * V_3 )
{
struct V_1 * V_11 = F_1 ( V_3 ) ;
F_8 ( V_80 -> V_18 , L_23 ) ;
V_110 [ 0 ] . V_111 = 0 ;
...
int
F_39 ( struct V_79 * V_80 , T_3 V_112 [ V_113 ] ,
struct V_114 * V_115 )
{
struct V_1 * V_11 ;
int V_21 ;
if ( ! F_40 ( V_80 -> V_18 -> V_35 ) || ! V_112 )
return - V_75 ;
if ( V_110 [ 0 ] . V_111 == 0 ) {
V_21 = F_41 ( V_80 -> V_18 , V_110 ) ;
if ( V_21 )
return V_21 ;
V_83 . V_116 = V_110 [ 0 ] . V_111 ;
V_88 . V_116 = V_110 [ 2 ] . V_111 ;
V_117 . V_118 = V_110 [ 1 ] . V_111 ;
V_81 . V_119 = V_110 [ 3 ] . V_111 ;
}
V_11 = F_42 ( sizeof *V_11 , V_95 ) ;
if ( ! V_11 )
return - V_94 ;
snprintf ( V_11 -> V_112 , sizeof V_11 -> V_112 , L_24 , V_112 ) ;
V_110 [ 1 ] . V_120 = V_11 -> V_112 ;
V_11 -> V_4 . V_121 = V_115 ;
V_11 -> V_4 . V_60 = V_74 ;
V_11 -> V_4 . V_5 . V_109 = L_25 ;
V_11 -> V_4 . V_5 . V_122 = V_123 ;
V_11 -> V_4 . V_5 . V_124 = F_29 ;
V_11 -> V_4 . V_5 . V_125 = F_37 ;
