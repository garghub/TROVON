...
if ( V_10 )
goto V_53;
F_39 ( V_5 -> V_12 , V_5 -> V_78 , sizeof( V_5 -> V_78 ) ) ;
V_36 -> V_79 = V_80 ;
V_36 -> V_81 = V_5 -> V_78 ;
F_40 ( V_5 -> V_12 , & V_36 -> V_82 ) ;
V_36 -> V_17 . V_83 = & V_41 -> V_17 ;
V_36 -> V_84 = V_85 ;
V_36 -> V_86 = V_87 ;
V_36 -> V_88 = V_5 ;
V_36 -> V_89 = V_90 ;
...
for ( V_29 = 0 ; V_29 < V_61 ; V_29 ++ ) {
F_46 ( V_5 -> V_19 [ V_29 ] ) ;
F_47 ( V_12 , 128 , V_5 -> V_19 [ V_29 ] -> V_38 ,
V_5 -> V_19 [ V_29 ] -> V_65 ) ;
F_34 ( V_5 -> V_19 [ V_29 ] ) ;
}
F_46 ( V_5 -> V_15 ) ;
...
static int F_52 ( struct V_40 * V_41 , T_2 V_98 )
{
struct V_4 * V_5 = F_51 ( V_41 ) ;
int V_29 ;
for ( V_29 = 0 ; V_29 < V_61 ; V_29 ++ )
