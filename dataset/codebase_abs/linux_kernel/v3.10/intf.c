...
void F_14 ( struct V_17 * V_10 , enum V_18 type ,
unsigned long V_19 )
{
...
void * F_22 ( struct V_17 * V_10 , enum V_23 V_24 , int V_25 )
{
struct V_3 * V_4 = V_3 ( V_10 ) ;
struct V_5 * V_6 ;
unsigned long V_20 ;
...
F_15 ( & V_4 -> V_11 , V_20 ) ;
F_8 (dev_ctx, &priv->ctx_list, list)
if ( V_6 -> V_2 -> V_27 == V_24 && V_6 -> V_2 -> V_28 ) {
V_26 = V_6 -> V_2 -> V_28 ( V_10 , V_6 -> V_8 , V_25 ) ;
break;
}
F_16 ( & V_4 -> V_11 , V_20 ) ;
return V_26 ;
