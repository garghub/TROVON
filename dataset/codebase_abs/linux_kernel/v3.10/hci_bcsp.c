...
static struct V_5 * F_10 ( struct V_13 * V_14 , T_2 * V_23 ,
int V_16 , int V_17 )
{
struct V_5 * V_24 ;
T_2 V_25 [ 4 ] , V_26 ;
...
if ( V_32 && V_26 == 5 ) {
T_3 V_33 = ( (struct V_34 * ) V_23 ) -> V_33 ;
...
unsigned long V_42 ;
struct V_5 * V_6 ;
if ( ( V_6 = F_17 ( & V_14 -> V_22 ) ) != NULL ) {
struct V_5 * V_24 = F_10 ( V_14 , V_6 -> V_23 , V_6 -> V_16 , F_8 ( V_6 ) -> V_17 ) ;
if ( V_24 ) {
F_7 ( V_6 ) ;
return V_24 ;
} else {
...
if ( V_14 -> V_43 . V_46 < V_47 && ( V_6 = F_17 ( & V_14 -> V_20 ) ) != NULL ) {
struct V_5 * V_24 = F_10 ( V_14 , V_6 -> V_23 , V_6 -> V_16 , F_8 ( V_6 ) -> V_17 ) ;
if ( V_24 ) {
F_20 ( & V_14 -> V_43 , V_6 ) ;
...
if ( V_14 -> V_58 -> V_23 [ 1 ] >> 4 == 4 && V_14 -> V_58 -> V_23 [ 2 ] == 0 &&
! memcmp ( & V_14 -> V_58 -> V_23 [ 4 ] , V_55 , 4 ) ) {
...
else if ( V_14 -> V_58 -> V_23 [ 1 ] >> 4 == 4 && V_14 -> V_58 -> V_23 [ 2 ] == 0 &&
! memcmp ( & V_14 -> V_58 -> V_23 [ 4 ] , V_57 , 4 ) ) {
F_6 ( L_11 ) ;
}
}
...
V_14 -> V_54 = ( V_14 -> V_58 -> V_23 [ 0 ] >> 3 ) & 0x07 ;
F_14 ( L_14 , V_14 -> V_54 ) ;
F_24 ( V_14 ) ;
if ( ( V_14 -> V_58 -> V_23 [ 1 ] & 0x0f ) == 6 &&
V_14 -> V_58 -> V_23 [ 0 ] & 0x80 ) {
F_8 ( V_14 -> V_58 ) -> V_17 = V_18 ;
V_70 = 1 ;
} else if ( ( V_14 -> V_58 -> V_23 [ 1 ] & 0x0f ) == 5 &&
V_14 -> V_58 -> V_23 [ 0 ] & 0x80 ) {
F_8 ( V_14 -> V_58 ) -> V_17 = V_71 ;
V_70 = 1 ;
} else if ( ( V_14 -> V_58 -> V_23 [ 1 ] & 0x0f ) == 7 ) {
F_8 ( V_14 -> V_58 ) -> V_17 = V_21 ;
V_70 = 1 ;
} else if ( ( V_14 -> V_58 -> V_23 [ 1 ] & 0x0f ) == 1 &&
! ( V_14 -> V_58 -> V_23 [ 0 ] & 0x80 ) ) {
F_31 ( V_12 ) ;
V_70 = 0 ;
} else
...
if ( ! V_70 ) {
struct V_72 V_25 ;
T_2 V_35 = ( V_14 -> V_58 -> V_23 [ 1 ] & 0x0f ) ;
if ( V_35 != 0 && V_35 != 1 ) {
if ( V_32 ) {
V_35 |= 0xc0 ;
F_35 ( V_14 -> V_58 , 4 ) ;
...
{
return F_39 ( & V_14 -> V_58 -> V_23 [ V_14 -> V_58 -> V_16 - 2 ] ) ;
}
static int F_40 ( struct V_11 * V_12 , void * V_23 , int V_76 )
{
struct V_13 * V_14 = V_12 -> V_15 ;
unsigned char * V_77 ;
F_14 ( L_18 ,
V_12 , V_76 , V_14 -> V_65 , V_14 -> V_68 ) ;
V_77 = V_23 ;
while ( V_76 ) {
if ( V_14 -> V_68 ) {
if ( * V_77 == 0xc0 ) {
...
switch ( V_14 -> V_65 ) {
case V_79 :
if ( ( 0xff & ( T_2 ) ~ ( V_14 -> V_58 -> V_23 [ 0 ] + V_14 -> V_58 -> V_23 [ 1 ] +
V_14 -> V_58 -> V_23 [ 2 ] ) ) != V_14 -> V_58 -> V_23 [ 3 ] ) {
F_6 ( L_20 ) ;
F_7 ( V_14 -> V_58 ) ;
V_14 -> V_65 = V_69 ;
V_14 -> V_68 = 0 ;
...
if ( V_14 -> V_58 -> V_23 [ 0 ] & 0x80
&& ( V_14 -> V_58 -> V_23 [ 0 ] & 0x07 ) != V_14 -> V_38 ) {
F_6 ( L_21 ,
V_14 -> V_58 -> V_23 [ 0 ] & 0x07 , V_14 -> V_38 ) ;
F_7 ( V_14 -> V_58 ) ;
V_14 -> V_65 = V_69 ;
...
V_14 -> V_65 = V_80 ;
V_14 -> V_68 = ( V_14 -> V_58 -> V_23 [ 1 ] >> 4 ) +
( V_14 -> V_58 -> V_23 [ 2 ] << 4 ) ;
continue;
case V_80 :
if ( V_14 -> V_58 -> V_23 [ 0 ] & 0x40 ) {
V_14 -> V_65 = V_66 ;
V_14 -> V_68 = 2 ;
} else
F_34 ( V_12 ) ;
...
{
struct V_11 * V_12 = (struct V_11 * ) V_83 ;
struct V_13 * V_14 = V_12 -> V_15 ;
struct V_5 * V_6 ;
unsigned long V_42 ;
