...
struct V_7 * V_8 = ( (struct V_52 * ) V_200 ) -> V_8 ;
F_8 ( 1 , L_5 , V_6 ) ;
F_15 ( V_8 , V_29 , V_234 , V_44 ) ;
return 0 ;
}
static int F_109 ( struct V_159 * V_159 , void * V_200 , T_2 V_235 )
{
struct V_7 * V_8 = ( (struct V_52 * ) V_200 ) -> V_8 ;
F_8 ( 1 , L_5 , V_6 ) ;
F_21 ( & V_8 -> V_56 ) ;
...
int F_110 ( struct V_7 * V_8 , struct V_236 * V_3 )
{
static const char * V_237 [] = {
[ V_238 ] = L_32 ,
[ V_239 ] = L_33 ,
[ V_240 ] = L_34 ,
[ V_241 ] = L_35 ,
...
if ( V_247 >= V_248 )
return - V_47 ;
if ( 0 == F_33 ( V_247 ) -> type )
return - V_47 ;
V_3 -> V_228 = V_247 ;
V_3 -> type = V_249 ;
strcpy ( V_3 -> V_39 , V_237 [ F_33 ( V_247 ) -> type ] ) ;
if ( ( V_85 == F_33 ( V_247 ) -> type ) ||
( V_244 == F_33 ( V_247 ) -> type ) ) {
V_3 -> type = V_250 ;
V_3 -> V_251 = V_252 ;
}
if ( F_33 ( V_247 ) -> type != V_85 )
V_3 -> V_253 = 0x3 ;
if ( V_8 -> V_71 == V_247 ) {
F_15 ( V_8 , V_88 , V_254 , & V_3 -> V_255 ) ;
}
return 0 ;
}
...
V_8 -> V_263 = V_3 -> V_228 ;
F_31 ( V_8 , V_8 -> V_263 + 1 ) ;
return 0 ;
}
static int F_121 ( struct V_159 * V_159 , void * V_200 ,
struct V_42 * V_43 )
{
V_43 -> V_44 = F_122 ( V_264 , V_43 -> V_44 ) ;
if ( F_95 ( V_43 -> V_44 == 0 ) )
return - V_47 ;
return F_19 ( V_43 ) ;
}
...
if ( 0 != V_266 -> V_228 )
return - V_47 ;
strcpy ( V_266 -> V_39 , L_38 ) ;
F_15 ( V_8 , V_267 , V_268 , V_266 ) ;
return 0 ;
}
...
if ( F_95 ( V_139 == V_8 -> V_225 ) )
return - V_47 ;
V_202 -> type = V_53 -> V_162 ? V_271 : V_272 ;
V_202 -> V_273 = V_8 -> V_274 ;
F_15 ( V_8 , V_267 , V_275 , V_202 ) ;
return 0 ;
}
static int F_128 ( struct V_7 * V_8 , const struct V_270 * V_202 )
{
struct V_193 V_197 ;
if ( F_95 ( V_139 == V_8 -> V_225 ) )
return - V_47 ;
if ( F_95 ( V_202 -> V_267 != 0 ) )
return - V_47 ;
F_21 ( & V_8 -> V_56 ) ;
V_8 -> V_274 = V_202 -> V_273 ;
V_197 . V_44 = V_276 ;
V_197 . V_198 = 1 ;
F_83 ( V_8 , & V_197 ) ;
F_15 ( V_8 , V_267 , V_277 , V_202 ) ;
F_129 ( 100 ) ;
V_197 . V_198 = 0 ;
F_83 ( V_8 , & V_197 ) ;
F_22 ( & V_8 -> V_56 ) ;
...
F_83 ( V_8 , & V_197 ) ;
F_8 ( 1 , L_49 , V_6 ,
V_283 . V_273 , V_202 -> V_267 , V_283 . V_251 ) ;
V_279 = F_131 ( & V_8 -> V_286 . V_287 , 1 ) ;
if ( ! V_279 ) {
F_22 ( & V_8 -> V_56 ) ;
return - V_47 ;
}
V_281 = V_279 -> V_288 . V_289 ;
if ( ( V_8 -> V_41 == V_95 ) ||
( V_8 -> V_41 == V_93 ) ||
( V_8 -> V_41 == V_94 ) )
V_281 = & V_8 -> V_290 . V_291 ;
if ( V_281 && V_281 -> V_292 . V_293 . V_294 ) {
F_15 ( V_8 , V_29 , V_30 , V_8 -> V_28 ) ;
V_281 -> V_292 . V_293 . V_294 ( V_281 , & V_283 ) ;
}
else
F_3 ( V_5 L_50 , V_6 ) ;
F_129 ( 100 ) ;
...
int F_137 ( struct V_7 * V_8 , T_1 V_255 )
{
T_1 V_295 , V_11 ;
int V_296 = 0 ;
V_295 = F_105 ( V_108 ) ;
...
F_149 ( & V_8 -> V_173 ) ;
V_308 = V_309 ;
strcpy ( V_308 . V_39 , L_58 ) ;
V_8 -> V_28 = V_309 . V_310 ;
F_150 ( & V_8 -> V_148 . V_15 ) ;
F_150 ( & V_8 -> V_148 . V_113 ) ;
V_8 -> V_148 . V_24 . V_311 = F_134 ;
...
F_41 ( V_8 , 0x01 ) ;
if ( ( V_313 != V_8 -> V_225 ) &&
( ( V_8 -> V_314 == 0 ) || ( V_8 -> V_314 == 1 ) ) ) {
struct V_315 * V_316 = NULL ;
if ( V_8 -> V_317 )
V_316 = F_153 ( & V_8 -> V_36 ,
& V_8 -> V_65 [ V_8 -> V_314 ] . V_66 ,
L_59 , V_8 -> V_317 , NULL ) ;
else
V_316 = F_153 ( & V_8 -> V_36 ,
& V_8 -> V_65 [ V_8 -> V_314 ] . V_66 ,
...
V_320 . V_321 = V_322 ;
V_320 . type = V_8 -> V_225 ;
V_320 . V_62 = F_155 ( V_316 ) ;
V_320 . V_323 = V_324 ;
F_35 ( V_316 , V_267 , V_325 , & V_320 ) ;
if ( V_8 -> V_41 == V_326 ) {
struct V_327 V_197 = {
. V_328 = V_329 ,
. V_330 = 64
...
V_8 -> V_306 = F_16 ( V_8 , V_8 -> V_33 ,
& V_309 , L_61 ) ;
V_212 = F_156 ( V_8 -> V_306 , V_164 ,
V_334 [ V_8 -> V_335 ] ) ;
if ( V_212 < 0 ) {
F_3 ( V_256 L_62 ,
V_8 -> V_39 ) ;
...
F_3 ( V_256 L_63 ,
V_8 -> V_39 , F_65 ( V_8 -> V_306 ) ) ;
V_8 -> V_305 = F_16 ( V_8 , V_8 -> V_33 ,
& V_308 , L_64 ) ;
V_212 = F_156 ( V_8 -> V_305 , V_165 ,
V_337 [ V_8 -> V_335 ] ) ;
if ( V_212 < 0 ) {
F_3 ( V_256 L_65 ,
V_8 -> V_39 ) ;
