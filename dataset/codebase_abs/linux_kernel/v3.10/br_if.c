...
struct V_10 * V_11 ;
unsigned long * V_35 ;
V_35 = F_39 ( F_40 ( V_36 ) , sizeof( unsigned long ) ,
V_37 ) ;
if ( ! V_35 )
return - V_38 ;
F_41 ( 0 , V_35 ) ;
...
int F_51 ( struct V_43 * V_43 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_44 ;
...
int F_56 ( struct V_43 * V_43 , const char * V_9 )
{
struct V_1 * V_2 ;
int V_48 = 0 ;
F_57 () ;
...
if ( V_60 )
goto V_75;
V_60 = F_71 ( & V_11 -> V_21 , & V_76 , & ( V_2 -> V_2 . V_21 ) ,
V_77 ) ;
if ( V_60 )
goto V_78;
V_60 = F_72 ( V_11 ) ;
if ( V_60 )
goto V_79;
if ( F_73 ( V_13 ) && ( ( V_60 = F_74 ( V_11 , V_37 ) ) ) )
goto V_80;
V_60 = F_75 ( V_2 , V_13 -> V_2 ) ;
if ( V_60 )
goto V_81;
V_60 = F_76 ( V_2 , V_82 , V_11 ) ;
if ( V_60 )
goto V_83;
V_2 -> V_28 |= V_29 ;
F_77 ( V_2 ) ;
F_78 ( & V_11 -> V_27 , & V_13 -> V_55 ) ;
F_79 ( V_13 -> V_2 ) ;
F_7 ( & V_13 -> V_17 ) ;
V_61 = F_80 ( V_13 ) ;
if ( F_5 ( V_2 ) && F_6 ( V_2 ) &&
...
if ( V_61 )
F_70 ( V_85 , V_13 -> V_2 ) ;
F_81 ( V_13 -> V_2 , F_60 ( V_13 ) ) ;
if ( F_82 ( V_13 , V_11 , V_2 -> V_66 , 0 ) )
F_83 ( V_2 , L_3 ) ;
F_28 ( & V_11 -> V_21 , V_86 ) ;
return 0 ;
V_83:
...
void T_2 F_86 ( struct V_43 * V_43 )
{
struct V_1 * V_2 ;
F_87 ( V_27 ) ;
F_57 () ;
