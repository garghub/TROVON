...
static void F_20 ( struct V_1 * V_2 , struct V_96 * V_97 )
{
V_97 -> V_98 = V_99 ;
V_97 -> V_100 = 0 ;
if ( F_4 ( V_2 , V_28 ,
...
static int F_21 ( struct V_1 * V_2 , struct V_96 * V_97 )
{
int V_3 , V_34 , V_51 ;
V_34 = F_2 ( V_2 , V_28 ) ;
if ( V_97 -> V_100 & V_99 ) {
