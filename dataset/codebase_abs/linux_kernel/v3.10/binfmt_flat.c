...
V_104 = F_27 ( V_10 -> V_39 ) ;
V_67 = F_28 ( V_89 -> V_109 ) ;
V_94 = F_28 ( V_89 -> V_110 ) - F_28 ( V_89 -> V_109 ) ;
V_95 = F_28 ( V_89 -> V_111 ) - F_28 ( V_89 -> V_110 ) ;
V_96 = F_28 ( V_89 -> V_112 ) ;
if ( V_87 ) {
V_96 += * V_87 ;
* V_87 = V_96 ;
}
V_107 = F_28 ( V_89 -> V_113 ) ;
V_97 = F_28 ( V_89 -> V_97 ) ;
V_106 = F_28 ( V_89 -> V_106 ) ;
...
V_101 = F_35 (unsigned long, bss_len + stack_len,
relocs * sizeof(unsigned long)) ;
if ( ( V_97 & ( V_120 | V_121 ) ) == 0 ) {
F_8 ( L_35 ) ;
V_90 = F_36 ( V_10 -> V_39 , 0 , V_67 , V_126 | V_127 ,
V_128 | V_129 , 0 ) ;
if ( ! V_90 || F_19 ( V_90 ) ) {
if ( ! V_90 )
...
V_81 = ( unsigned long * ) ( V_91 + ( F_28 ( V_89 -> V_132 ) - V_67 ) ) ;
V_99 = V_93 ;
V_100 = V_27 ;
} else {
...
V_93 = V_90 + F_28 ( V_89 -> V_109 ) ;
V_91 = F_39 ( V_93 +
V_69 * sizeof( unsigned long ) ,
V_131 ) ;
V_81 = ( unsigned long * )
( V_91 + ( F_28 ( V_89 -> V_132 ) - V_67 ) ) ;
V_99 = V_90 ;
V_100 = V_27 ;
#ifdef F_30
if ( V_97 & V_121 ) {
...
if ( V_97 & V_116 )
F_2 ( L_42 ,
( int ) V_90 , 0x00ffffff & F_28 ( V_89 -> V_133 ) , F_28 ( V_89 -> V_109 ) ) ;
...
V_86 -> V_71 [ V_64 ] . V_133 = ( 0x00ffffff & F_28 ( V_89 -> V_133 ) ) + V_90 ;
V_86 -> V_71 [ V_64 ] . V_73 = F_28 ( V_89 -> V_73 ) ;
if ( V_97 & V_137 ) {
...
static int F_20 ( int V_64 , struct V_60 * V_140 )
{
struct V_9 V_10 ;
int V_141 ;
char V_29 [ 16 ] ;
...
V_141 = F_50 ( & V_10 ) ;
if ( ! F_19 ( V_141 ) )
V_141 = F_26 ( & V_10 , V_140 , V_64 , NULL ) ;
F_51 ( V_10 . V_142 ) ;
V_143:
F_52 ( V_10 . V_39 ) ;
F_53 ( V_10 . V_39 ) ;
