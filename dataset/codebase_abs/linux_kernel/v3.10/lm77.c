...
static int F_13 ( struct V_18 * V_19 , T_5 V_5 , T_4 V_54 )
{
if ( V_5 == V_53 )
return F_37 ( V_19 , V_5 , V_54 ) ;
else
return F_38 ( V_19 , V_5 , V_54 ) ;
}
static void F_27 ( struct V_18 * V_19 )
{
int V_35 = F_35 ( V_19 , V_53 ) ;
if ( V_35 & 1 )
F_13 ( V_19 , V_53 , V_35 & 0xfe ) ;
}
...
struct V_11 * V_12 = F_10 ( V_19 ) ;
F_12 ( & V_12 -> V_22 ) ;
if ( F_39 ( V_55 , V_12 -> V_56 + V_57 + V_57 / 2 )
|| ! V_12 -> V_48 ) {
F_40 ( & V_19 -> V_7 , L_4 ) ;
V_12 -> V_58 =
F_3 ( F_35 ( V_19 ,
