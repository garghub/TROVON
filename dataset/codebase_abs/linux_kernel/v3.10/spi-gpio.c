...
static int F_29 ( unsigned V_35 , const char * V_36 , bool V_37 )
{
int V_38 ;
V_38 = F_22 ( V_35 , V_36 ) ;
if ( V_38 == 0 ) {
...
if ( ! V_9 )
return - V_55 ;
V_49 = F_35 ( V_28 , L_1 , 0 ) ;
if ( V_49 < 0 ) {
F_36 ( & V_48 -> V_29 , L_2 ) ;
goto V_56;
}
V_9 -> V_57 = V_49 ;
V_49 = F_35 ( V_28 , L_3 , 0 ) ;
if ( V_49 < 0 ) {
F_37 ( & V_48 -> V_29 , L_4 ) ;
V_9 -> V_58 = V_43 ;
} else
V_9 -> V_58 = V_49 ;
V_49 = F_35 ( V_28 , L_5 , 0 ) ;
if ( V_49 < 0 ) {
F_37 ( & V_48 -> V_29 , L_6 ) ;
V_9 -> V_59 = V_40 ;
} else
V_9 -> V_59 = V_49 ;
V_49 = F_38 ( V_28 , L_7 , & V_50 ) ;
if ( V_49 < 0 ) {
F_36 ( & V_48 -> V_29 , L_8 ) ;
goto V_56;
}
