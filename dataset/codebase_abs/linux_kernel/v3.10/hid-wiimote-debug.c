...
if ( V_4 == 0 )
return - V_15 ;
V_33 = F_15 ( ( T_3 ) 15 , V_4 ) ;
if ( F_16 ( V_13 , V_3 , V_33 ) )
return - V_22 ;
V_13 [ 15 ] = 0 ;
...
unsigned long V_11 ;
int V_12 = - V_34 ;
V_7 = F_20 ( sizeof( * V_7 ) , V_35 ) ;
if ( ! V_7 )
return - V_34 ;
V_7 -> V_10 = V_10 ;
V_7 -> V_36 = F_21 ( L_3 , V_37 ,
V_7 -> V_10 -> V_38 -> V_39 , V_7 , & V_40 ) ;
if ( ! V_7 -> V_36 )
goto V_41;
V_7 -> V_27 = F_21 ( L_4 , V_37 ,
V_7 -> V_10 -> V_38 -> V_39 , V_7 , & V_42 ) ;
if ( ! V_7 -> V_27 )
goto V_43;
F_3 ( & V_10 -> V_16 . V_17 , V_11 ) ;
V_10 -> V_44 = V_7 ;
