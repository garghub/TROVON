...
switch ( V_71 & V_108 ) {
case V_109 :
V_47 -> V_101 |= V_110 | V_111 |
V_112 | V_113 ;
break;
case V_114 :
V_47 -> V_101 |= V_112 | V_113 ;
break;
case V_115 :
V_47 -> V_101 |= V_110 | V_111 ;
break;
...
struct V_7 * V_8 = F_58 ( V_135 ) ;
struct V_9 * V_10 = F_2 ( V_8 ) ;
V_146 -> V_144 . integer . V_144 [ 0 ] = F_59 ( V_10 ) ;
return 0 ;
}
...
{
struct V_153 * V_26 = F_68 ( & V_152 -> V_133 ) ;
struct V_9 * V_10 ;
...
int V_19 ;
V_26 = F_70 ( & V_152 -> V_133 ,
sizeof( struct V_153 ) ,
V_161 ) ;
if ( ! V_26 )
return - V_162 ;
memcpy ( V_26 , V_155 -> V_163 , sizeof( * V_26 ) ) ;
if ( ! F_71 ( V_159 , L_4 , & V_19 ) )
V_26 -> V_19 = V_19 ;
} else if ( ! V_26 ) {
F_72 ( & V_152 -> V_133 , L_5 ) ;
return - V_42 ;
}
V_10 = F_70 ( & V_152 -> V_133 , sizeof( struct V_9 ) , V_161 ) ;
if ( ! V_10 )
return - V_162 ;
V_10 -> V_148 = V_152 -> V_148 ;
V_10 -> V_26 = V_26 ;
V_10 -> V_133 = & V_152 -> V_133 ;
F_73 ( V_152 , V_10 ) ;
V_156 = F_74 ( V_152 ) ;
if ( ! V_156 )
...
{
struct V_9 * V_10 = F_77 ( V_152 ) ;
F_78 ( & V_152 -> V_133 ) ;
if ( V_10 -> V_26 -> V_166 && V_10 -> V_26 -> V_166 -> free )
V_10 -> V_26 -> V_166 -> free ( V_10 -> V_148 ) ;
F_79 ( V_10 ) ;
F_80 ( V_10 -> V_167 ) ;
F_73 ( V_152 , NULL ) ;
return 0 ;
