...
F_67 ( V_2 , V_52 ) ;
if ( ! ( V_2 -> V_40 -> V_220 &&
V_2 -> V_40 -> V_220 ( V_2 , V_214 , V_194 ,
V_52 , V_139 , V_140 ) ) ) {
memset ( V_194 , 0 , V_4 -> V_82 . V_98 * sizeof( V_194 [ 0 ] ) ) ;
memset ( V_214 , 0 , V_4 -> V_82 . V_98 * sizeof( V_214 [ 0 ] ) ) ;
if ( ! F_68 ( V_2 ,
V_194 , V_52 , V_139 , V_140 ) &&
! F_71 ( V_2 ,
V_194 , V_52 , V_139 , V_140 ) )
F_17 ( L_32 ) ;
F_10 ( L_33 ,
...
struct V_97 * V_221 = V_214 [ V_7 ] ;
V_144 = & V_221 -> V_50 ;
if ( V_17 && V_221 ) {
F_10 ( L_34 ,
V_17 -> V_203 , V_221 -> V_50 . V_33 -> V_61 . V_62 ) ;
V_221 -> V_158 = V_17 ;
if ( V_144 -> V_17 )
F_34 ( V_4 , V_144 -> V_17 ) ;
V_144 -> V_17 = F_74 ( V_4 ,
...
bool F_76 ( struct V_1 * V_2 , int V_222 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
int V_184 = 0 ;
F_5 ( V_2 ) ;
...
if ( ! V_2 -> V_55 )
return 0 ;
F_77 ( & V_2 -> V_4 -> V_82 . V_223 ) ;
if ( ! F_24 ( V_2 ) ) {
V_2 -> V_143 = true ;
F_78 ( & V_2 -> V_4 -> V_82 . V_223 ) ;
return 0 ;
}
F_10 ( L_30 ) ;
V_218 = V_2 -> V_55 -> V_139 ;
V_219 = V_2 -> V_55 -> V_140 ;
V_222 = V_2 -> V_55 -> V_121 ;
