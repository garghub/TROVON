...
if ( V_81 -> V_234 ) {
V_233 = V_81 -> V_234 ( V_81 , V_227 , V_229 ) ;
V_231 = F_125 ( V_231 , V_233 ) ;
}
F_27 ( V_2 ) ;
}
return V_231 ;
}
struct V_3 * F_126 ( struct V_49 * V_50 )
{
struct V_3 * V_235 ;
F_127 (r, &tconn->transfer_log, tl_requests) {
if ( F_20 ( & V_235 -> V_34 ) )
return V_235 ;
}
return NULL ;
}
void F_128 ( unsigned long V_236 )
{
struct V_1 * V_2 = (struct V_1 * ) V_236 ;
struct V_49 * V_50 = V_2 -> V_50 ;
struct V_3 * V_4 ;
struct V_87 * V_88 ;
unsigned long V_237 = 0 , V_238 = 0 , V_239 , V_240 ;
unsigned long V_241 ;
F_60 () ;
V_88 = F_61 ( V_50 -> V_87 ) ;
if ( V_88 && V_2 -> V_144 . V_184 >= V_242 )
V_237 = V_88 -> V_243 * V_244 / 10 * V_88 -> V_245 ;
if ( F_67 ( V_2 ) ) {
V_238 = F_61 ( V_2 -> V_83 -> V_188 ) -> V_246 * V_244 / 10 ;
F_27 ( V_2 ) ;
}
F_62 () ;
V_239 = F_129 ( V_238 , V_237 ) ;
if ( ! V_239 )
return;
V_241 = V_15 ;
F_81 ( & V_50 -> V_173 ) ;
...
if ( ! V_4 ) {
F_79 ( & V_50 -> V_173 ) ;
F_130 ( & V_2 -> V_247 , V_241 + V_239 ) ;
return;
}
if ( V_237 && V_4 -> V_22 & V_64 &&
F_131 ( V_241 , V_4 -> V_16 + V_237 ) &&
! F_132 ( V_241 , V_50 -> V_248 , V_50 -> V_248 + V_237 ) ) {
F_29 ( V_41 , L_16 ) ;
F_85 ( F_86 ( V_2 , V_184 , V_249 ) , V_250 | V_251 , NULL ) ;
}
if ( V_238 && V_4 -> V_22 & V_38 && V_4 -> V_25 . V_2 == V_2 &&
F_131 ( V_241 , V_4 -> V_16 + V_238 ) &&
! F_132 ( V_241 , V_2 -> V_252 , V_2 -> V_252 + V_238 ) ) {
F_29 ( V_41 , L_17 ) ;
F_63 ( V_2 , V_253 ) ;
}
V_240 = ( F_131 ( V_241 , V_4 -> V_16 + V_239 ) ? V_241 : V_4 -> V_16 ) + V_239 ;
F_79 ( & V_50 -> V_173 ) ;
F_130 ( & V_2 -> V_247 , V_240 ) ;
}
