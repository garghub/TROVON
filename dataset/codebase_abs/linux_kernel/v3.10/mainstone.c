...
static enum V_81 F_57 ( struct V_79 * V_80 )
{
struct V_83 * V_84 = F_56 ( V_80 ,
struct V_83 , V_80 ) ;
T_3 V_85 = V_86 ;
return ( V_85 & V_84 -> V_88 ) ? V_89 : V_87 ;
}
...
return - V_91 ;
V_86 |= 0xff ;
for ( V_90 = 0 ; V_90 < F_45 ( V_92 ) ; V_90 ++ ) {
struct V_83 * V_84 ;
V_84 = F_59 ( sizeof( * V_84 ) , V_93 ) ;
if ( ! V_84 )
break;
V_84 -> V_80 . V_63 = V_92 [ V_90 ] . V_63 ;
V_84 -> V_80 . V_94 = F_55 ;
V_84 -> V_80 . V_95 = F_57 ;
V_84 -> V_80 . V_96 = V_92 [ V_90 ] . V_97 ;
V_84 -> V_88 = F_60 ( V_90 ) ;
if ( F_61 ( NULL , & V_84 -> V_80 ) < 0 ) {
F_62 ( V_84 ) ;
break;
}
}
