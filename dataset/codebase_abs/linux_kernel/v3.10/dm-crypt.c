...
struct V_109 * V_110 ;
struct V_2 * V_3 = V_35 -> V_161 ;
if ( F_100 ( V_75 -> V_139 & ( V_203 | V_204 ) ) ) {
...
V_3 -> V_137 -> V_214 , ( unsigned long long ) V_3 -> V_142 ) ;
if ( V_35 -> V_197 )
F_164 ( L_57 ) ;
break;
}
...
if ( V_3 -> V_96 && V_3 -> V_96 -> V_217 ) {
V_172 = V_3 -> V_96 -> V_217 ( V_3 ) ;
if ( V_172 )
return V_172 ;
}
return F_131 ( V_3 ) ;
...
static int F_171 ( struct V_34 * V_35 , struct V_218 * V_219 ,
struct V_89 * V_220 , int V_221 )
{
struct V_2 * V_3 = V_35 -> V_161 ;
struct V_222 * V_223 = F_172 ( V_3 -> V_137 -> V_138 ) ;
if ( ! V_223 -> V_224 )
return V_221 ;
V_219 -> V_136 = V_3 -> V_137 -> V_138 ;
V_219 -> V_141 = V_3 -> V_142 + F_162 ( V_35 , V_219 -> V_141 ) ;
return F_173 ( V_221 , V_223 -> V_224 ( V_223 , V_219 , V_220 ) ) ;
}
static int F_174 ( struct V_34 * V_35 ,
T_7 V_225 , void * V_57 )
{
struct V_2 * V_3 = V_35 -> V_161 ;
return V_225 ( V_35 , V_3 -> V_137 , V_3 -> V_142 , V_35 -> V_119 , V_57 ) ;
}
