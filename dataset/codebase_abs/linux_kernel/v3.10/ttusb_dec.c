...
F_2 ( L_5 , V_13 ) ;
if ( F_77 ( & V_191 , V_3 -> V_192 , & V_3 -> V_36 -> V_117 ) ) {
F_6 ( V_193 L_41 ,
V_13 , V_3 -> V_192 ) ;
return 1 ;
}
...
V_3 -> V_212 . V_204 = 0 ;
if ( ( V_26 = F_87 ( & V_3 -> V_212 , & V_3 -> V_200 ) ) < 0 ) {
F_6 ( L_54 ,
V_13 , V_26 ) ;
F_88 ( & V_3 -> V_139 ) ;
F_86 ( & V_3 -> V_200 ) ;
...
F_90 ( & V_3 -> V_200 , & V_3 -> V_218 , & V_3 -> V_139 . V_152 ) ;
return 0 ;
}
...
switch ( V_228 -> V_230 ) {
case 0x1006 :
V_3 -> V_220 = F_107 ( & V_231 ) ;
break;
case 0x1008 :
case 0x1009 :
V_3 -> V_220 = F_108 ( & V_231 ) ;
break;
}
if ( V_3 -> V_220 == NULL ) {
F_6 ( L_56 ,
F_109 ( V_3 -> V_36 -> V_232 . V_233 ) ,
F_109 ( V_3 -> V_36 -> V_232 . V_230 ) ) ;
} else {
