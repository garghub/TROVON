...
&& ! F_40 ( V_105 , V_115 ) )
return - V_13 ;
V_20 = F_41 ( sizeof( struct V_20 ) , V_116 ) ;
if ( ! V_20 )
return - V_117 ;
F_42 ( V_2 , V_20 ) ;
V_20 -> V_2 = V_2 ;
...
if ( V_20 -> V_45 [ 0 ] & V_122 )
V_20 -> V_45 [ 0 ] &= ~ V_122 ;
if ( V_20 -> V_2 -> V_36 > 0 && V_101 -> V_123 ) {
F_43 ( & V_20 -> V_19 , F_13 ) ;
V_20 -> V_45 [ 0 ] |= V_124
| V_111 [ V_20 -> type ] ;
...
V_133 = F_26 ( V_20 -> V_45 [ V_50 ] ) ;
if ( V_133 == 12 )
V_133 = 0 ;
if ( V_20 -> V_45 [ V_50 ] & V_134 )
V_133 += 12 ;
F_7 ( V_2 ,
V_50 << 4 | 0x08 ,
V_133 ) ;
...
V_20 -> V_25 = F_45 ( V_2 -> V_147 , & V_2 -> V_11 ,
& V_148 , V_149 ) ;
if ( F_46 ( V_20 -> V_25 ) ) {
V_98 = F_47 ( V_20 -> V_25 ) ;
F_5 ( & V_2 -> V_11 ,
...
if ( V_101 -> V_152 ) {
V_20 -> V_92 = F_41 ( sizeof( struct V_88 ) ,
V_116 ) ;
if ( ! V_20 -> V_92 ) {
V_98 = - V_117 ;
goto V_153;
}
V_20 -> V_92 -> V_89 . V_147 = L_29 ;
V_20 -> V_92 -> V_89 . V_154 = V_155 | V_156 ;
F_51 ( V_20 -> V_92 ) ;
V_20 -> V_92 -> V_157 = F_34 ;
V_20 -> V_92 -> V_158 = F_37 ;
V_20 -> V_92 -> V_93 = V_101 -> V_152 ;
...
F_50 ( V_159 , & V_20 -> V_35 ) ;
F_54 ( & V_2 -> V_11 , L_30 , V_20 -> V_92 -> V_93 ) ;
}
return 0 ;
V_153:
V_151:
...
{
struct V_20 * V_20 = F_21 ( V_2 ) ;
if ( F_57 ( V_34 , & V_20 -> V_35 ) ) {
F_58 ( V_2 -> V_36 , V_2 ) ;
F_59 ( & V_20 -> V_19 ) ;
}
if ( F_57 ( V_159 , & V_20 -> V_35 ) ) {
F_60 ( & V_2 -> V_11 . V_87 , V_20 -> V_92 ) ;
F_53 ( V_20 -> V_92 ) ;
}
F_55 ( V_20 -> V_25 ) ;
F_53 ( V_20 ) ;
