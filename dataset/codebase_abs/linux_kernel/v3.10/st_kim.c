...
V_5 = F_56 ( sizeof( struct V_4 ) , V_23 ) ;
if ( ! V_5 ) {
F_5 ( L_49 ) ;
return - V_100 ;
}
...
V_5 -> V_31 -> V_63 = V_5 ;
V_5 -> V_71 = V_68 -> V_102 ;
V_41 = F_59 ( V_5 -> V_71 , L_51 ) ;
if ( F_4 ( V_41 ) ) {
F_5 ( L_52 , V_5 -> V_71 ) ;
return V_41 ;
}
V_41 = F_60 ( V_5 -> V_71 , 0 ) ;
if ( F_4 ( V_41 ) ) {
F_5 ( L_53 , V_5 -> V_71 ) ;
return V_41 ;
}
...
F_61 ( & V_5 -> V_12 ) ;
F_61 ( & V_5 -> V_64 ) ;
V_41 = F_62 ( & V_93 -> V_48 . V_75 , & V_103 ) ;
if ( V_41 ) {
F_5 ( L_54 ) ;
goto V_104;
}
...
V_5 -> V_91 = V_68 -> V_91 ;
F_13 ( L_55 ) ;
V_106 = F_63 ( L_56 , NULL ) ;
if ( F_64 ( V_106 ) ) {
F_5 ( L_57 ) ;
V_41 = - V_32 ;
goto V_107;
}
F_65 ( L_58 , V_108 , V_106 ,
V_5 , & V_109 ) ;
F_65 ( L_59 , V_108 , V_106 ,
V_5 , & V_110 ) ;
F_13 ( L_60 ) ;
return 0 ;
V_107:
F_66 ( & V_93 -> V_48 . V_75 , & V_103 ) ;
V_104:
F_67 ( V_5 -> V_31 ) ;
V_101:
F_68 ( V_5 ) ;
...
static int F_69 ( struct V_1 * V_93 )
{
struct V_67 * V_68 = V_93 -> V_48 . V_69 ;
struct V_4 * V_5 ;
V_5 = F_45 ( & V_93 -> V_48 ) ;
...
static int F_72 ( struct V_1 * V_93 , T_3 V_111 )
{
struct V_67 * V_68 = V_93 -> V_48 . V_69 ;
if ( V_68 -> V_112 )
...
static int F_73 ( struct V_1 * V_93 )
{
struct V_67 * V_68 = V_93 -> V_48 . V_69 ;
if ( V_68 -> V_114 )
