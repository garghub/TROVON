...
struct V_1 * V_2 ;
struct V_10 * V_11 = F_88 ( V_16 ) ;
int V_110 = F_107 ( V_16 , V_110 ) ;
int V_111 ;
int V_28 ;
V_7 = F_71 ( sizeof( struct V_6 ) , V_112 ) ;
if ( ! V_7 ) {
F_40 ( V_11 , L_16 ) ;
return - V_113 ;
}
V_2 = F_71 ( sizeof( struct V_1 ) * V_110 , V_112 ) ;
if ( ! V_2 ) {
F_40 ( V_11 , L_17 ) ;
V_28 = - V_113 ;
goto V_114;
}
F_108 ( V_16 , & V_7 -> V_96 , V_115 ) ;
V_7 -> V_96 . V_59 = L_18 ;
V_7 -> V_96 . V_116 = F_104 ;
V_7 -> V_96 . V_117 = F_105 ;
V_7 -> V_2 = V_2 ;
V_7 -> V_118 = V_110 ;
F_109 ( V_7 ) ;
V_7 -> V_30 . V_11 . V_119 = V_11 ;
V_7 -> V_30 . V_59 = L_19 ;
V_7 -> V_30 . V_120 = & V_121 ;
V_7 -> V_30 . V_104 = V_122 ;
F_110 ( & V_7 -> V_30 . V_123 ) ;
F_111 (uep, gpriv, i) {
V_2 -> V_7 = V_7 ;
V_2 -> V_9 = NULL ;
snprintf ( V_2 -> V_124 , V_125 , L_20 , V_111 ) ;
V_2 -> V_14 . V_59 = V_2 -> V_124 ;
V_2 -> V_14 . V_120 = & V_126 ;
F_110 ( & V_2 -> V_14 . V_123 ) ;
if ( F_112 ( V_2 ) ) {
...
V_2 -> V_14 . V_128 = 512 ;
F_113 ( & V_2 -> V_14 . V_123 , & V_7 -> V_30 . V_123 ) ;
}
}
