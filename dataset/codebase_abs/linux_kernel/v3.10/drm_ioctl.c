...
if ( V_30 ++ >= V_29 ) {
V_40 -> V_42 = V_41 -> V_43 ;
V_40 -> V_44 = F_14 ( V_41 -> V_44 ) ;
V_40 -> V_45 = F_15 ( F_16 () , V_41 -> V_45 ) ;
V_40 -> V_46 = V_41 -> V_46 ;
V_40 -> V_47 = V_41 -> V_48 ;
F_11 ( & V_2 -> V_32 ) ;
return 0 ;
...
V_50 -> V_3 [ V_30 ] . V_54 = F_18 ( & V_2 -> V_57 [ V_30 ] ) ;
...
break;
case V_70 :
V_60 -> V_54 |= V_2 -> V_18 -> V_71 ? V_72 : 0 ;
V_60 -> V_54 |= V_2 -> V_18 -> V_73 ? V_74 : 0 ;
break;
case V_75 :
V_60 -> V_54 = V_76 ;
break;
