...
V_10 -> V_170 = (enum V_171 ) V_154 -> V_38 ;
V_4 -> V_2 = V_2 ;
V_4 -> V_31 = 0 ;
V_165 = F_58 ( & V_152 -> V_156 , L_3 ) ;
if ( ! F_56 ( V_165 ) ) {
V_5 = F_59 ( V_165 ) ;
if ( V_5 ) {
F_60 ( & V_152 -> V_156 ,
...
V_162 = F_61 ( & V_152 -> V_156 ) ;
if ( F_56 ( V_162 ) ) {
V_5 = F_57 ( V_162 ) ;
goto V_169;
}
V_10 -> V_172 = F_62 ( & V_152 -> V_156 , NULL ) ;
if ( F_56 ( V_10 -> V_172 ) ) {
V_5 = F_57 ( V_10 -> V_172 ) ;
goto V_169;
}
F_63 ( V_10 -> V_172 ) ;
F_8 ( V_4 ) ;
V_10 -> V_77 = F_64 ( & V_152 -> V_156 , L_5 ) ;
if ( ! V_10 -> V_77 ) {
F_60 ( F_21 ( V_4 -> V_2 ) ,
L_6 , V_94 ) ;
goto V_173;
...
V_179 | V_180 ;
F_65 ( V_158 , L_7 , & V_122 ) ;
if ( V_122 == 4 )
V_2 -> V_176 |= V_181 ;
else if ( V_122 == 8 )
V_2 -> V_176 |= V_181 | V_182 ;
V_4 -> V_12 = F_66 ( V_158 , L_8 ) ;
V_4 -> V_11 = F_66 ( V_158 , L_9 ) ;
if ( V_4 -> V_11 )
V_2 -> V_176 |= V_183 ;
V_4 -> V_6 = F_67 ( V_158 , L_10 , 0 , & V_71 ) ;
if ( V_71 & V_184 )
V_4 -> V_8 = 1 ;
V_4 -> V_15 = F_66 ( V_158 , L_11 ) ;
V_2 -> V_185 = 400000 ;
V_2 -> V_186 = 288000000 ;
...
V_2 -> V_194 = F_68 ( V_10 -> V_77 -> V_195 -> V_156 ) ;
F_69 ( V_152 , V_2 ) ;
V_5 = F_70 ( & V_152 -> V_156 , V_163 , F_25 , 0 ,
V_196 , V_4 ) ;
if ( V_5 )
goto V_197;
F_71 ( & V_4 -> V_55 ) ;
...
static int F_78 ( struct V_151 * V_152 )
{
struct V_1 * V_2 = F_79 ( V_152 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_9 * V_10 = & V_4 -> V_10 ;
F_80 ( V_2 ) ;
F_69 ( V_152 , NULL ) ;
...
static int F_81 ( struct V_195 * V_156 )
{
struct V_1 * V_2 = F_82 ( V_156 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_9 * V_10 = & V_4 -> V_10 ;
int V_5 = 0 ;
V_5 = F_83 ( V_2 ) ;
...
static int F_84 ( struct V_195 * V_156 )
{
struct V_1 * V_2 = F_82 ( V_156 ) ;
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_9 * V_10 = & V_4 -> V_10 ;
