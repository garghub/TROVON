...
int F_34 ( struct V_1 * V_2 , T_3 V_114 ,
union V_115 * V_25 )
{
int V_75 = F_35 ( V_2 , V_114 , V_25 ) ;
return V_75 ;
}
int F_36 ( struct V_1 * V_2 , T_3 V_114 ,
union V_115 * V_25 )
{
int V_75 = F_37 ( V_2 , V_114 , V_25 ) ;
return V_75 ;
}
struct V_1 * F_38 ( struct V_14 * V_14 , unsigned int V_114 )
{
struct V_18 * V_19 ;
struct V_1 * V_2 ;
int V_116 ;
...
F_55 ( 64 ) ;
F_56 ( 0 ) ;
return F_57 ( NULL , sizeof( struct V_18 ) , 0 , V_125 ) ;
}
