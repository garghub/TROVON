...
static int F_16 ( struct V_20 * V_51 ,
...
static int F_17 ( struct V_20 * V_51 , unsigned int V_55 )
{
struct V_1 * V_2 = V_51 -> V_2 ;
struct V_4 * V_4 = F_2 ( V_2 ) ;
...
static T_3 F_18 ( struct V_68 * V_13 ,
...
static T_3 F_20 ( struct V_68 * V_13 ,
struct V_69 * V_70 ,
...
static int F_27 ( struct V_86 * V_12 )
{
struct V_4 * V_4 ;
int V_77 ;
F_12 ( & V_12 -> V_13 , L_16 ) ;
V_4 = F_28 ( & V_12 -> V_13 , sizeof *V_4 , V_87 ) ;
if ( ! V_4 )
return - V_88 ;
V_4 -> V_12 = V_12 ;
F_29 ( & V_12 -> V_13 , V_4 ) ;
...
static int F_31 ( struct V_86 * V_12 )
{
F_32 ( & V_12 -> V_13 ) ;
return 0 ;
}
