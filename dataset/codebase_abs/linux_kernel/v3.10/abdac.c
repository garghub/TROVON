...
strcpy ( V_65 -> V_125 , L_18 ) ;
strcpy ( V_65 -> V_66 , L_18 ) ;
sprintf ( V_65 -> V_126 , L_19 ) ;
V_38 = F_37 ( V_3 ) ;
if ( V_38 ) {
F_4 ( & V_19 -> V_20 , L_20 ) ;
goto V_127;
...
static int F_70 ( struct V_81 * V_19 )
{
struct V_95 * V_65 = F_69 ( V_19 ) ;
struct V_2 * V_3 = V_65 -> V_69 ;
F_25 ( V_3 -> V_88 ) ;
...
static int F_71 ( struct V_94 * V_19 )
{
struct V_95 * V_65 = F_72 ( V_19 ) ;
