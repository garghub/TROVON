...
static int F_10 ( struct V_19 * V_19 , struct V_20 * V_21 )
{
int V_22 ;
...
int F_16 ( struct V_19 * V_19 )
{
struct V_20 V_21 ;
int V_22 = 0 ;
if ( F_11 ( V_19 ) -> V_28 & V_33 ) {
V_22 = F_17 ( F_18 ( V_19 -> V_37 ) -> V_38 , & V_21 ) ;
if ( V_22 )
return V_22 ;
V_22 = F_10 ( V_19 , & V_21 ) ;
F_19 ( & V_21 ) ;
...
static int F_27 ( struct V_15 * V_39 , T_3 V_43 ,
T_3 V_44 , T_3 V_45 )
{
T_3 V_18 , V_46 ;
int V_17 ;
...
static int F_28 ( struct V_48 * V_49 , struct V_15 * V_39 ,
T_3 V_43 , T_3 V_50 )
{
T_3 V_18 , V_46 ;
int V_17 ;
...
int F_30 ( struct V_48 * V_49 , struct V_52 * V_53 , int type )
{
struct V_20 V_21 ;
T_2 V_54 , V_55 , V_46 ;
...
V_22 = F_28 ( V_49 , V_39 , V_55 , V_55 ) ;
if ( V_22 )
return V_22 ;
if ( V_54 == V_55 )
return 0 ;
V_22 = F_17 ( F_18 ( V_49 ) -> V_38 , & V_21 ) ;
if ( V_22 )
return V_22 ;
do {
...
int F_32 ( struct V_19 * V_19 , T_8 V_3 ,
...
F_39 ( V_19 ) ;
if ( V_19 -> V_24 < V_82 )
F_41 ( V_83 , & F_18 ( V_49 ) -> V_28 ) ;
F_41 ( V_84 , & F_18 ( V_49 ) -> V_28 ) ;
F_42 ( V_49 ) ;
}
return V_22 ;
V_81:
...
int V_22 ;
F_25 ( V_88 , L_7 ,
V_19 -> V_24 , ( long long ) F_11 ( V_19 ) -> V_75 ,
V_19 -> V_89 ) ;
...
struct V_94 * V_94 ;
V_87 = V_19 -> V_89 - 1 ;
V_22 = F_44 ( NULL , V_91 , V_87 + 1 , 0 ,
V_95 , & V_94 , & V_93 ) ;
if ( ! V_22 ) {
V_22 = F_45 ( NULL , V_91 , V_87 + 1 , 0 , 0 ,
V_94 , V_93 ) ;
}
if ( V_22 )
...
F_46 ( V_19 , F_11 ( V_19 ) -> V_68 << V_49 -> V_96 ) ;
F_39 ( V_19 ) ;
}
