...
if ( ! memcmp ( V_6 -> V_9 , V_7 , V_8 ) )
F_4 ( V_4 -> V_14 , V_6 -> V_9 ,
sizeof( V_4 -> V_14 ) ) ;
else
...
static int
F_64 ( struct V_1 * V_2 , struct V_215 * V_216 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
return F_65 ( V_6 , V_216 -> V_69 ) ;
}
static int
F_66 ( struct V_1 * V_2 )
{
...
if ( F_17 ( V_6 ) ) {
if ( F_16 ( V_6 ) )
return F_8 ( V_6 , V_217 ,
V_221 -> V_46 , V_69 ) ;
else
return F_8 ( V_6 , V_218 ,
V_221 -> V_46 , V_69 ) ;
}
V_221 -> V_225 = V_226 | ( V_6 -> V_16 -> V_227 << 16 ) ;
memset ( & V_222 , 0 , sizeof( struct V_24 ) ) ;
V_222 . V_33 = sizeof( struct V_228 ) ;
V_222 . V_35 = F_57 ( & V_6 -> V_16 -> V_37 , V_222 . V_33 ,
& V_222 . V_36 , V_201 ) ;
if ( ! V_222 . V_35 )
return - V_38 ;
V_26 = F_68 ( V_6 , & V_222 ) ;
if ( ! V_26 ) {
V_224 = V_222 . V_35 ;
memcpy ( V_69 , V_224 -> V_229 + V_221 -> V_81 , V_221 -> V_46 ) ;
}
F_59 ( & V_6 -> V_16 -> V_37 , V_222 . V_33 , V_222 . V_35 ,
V_222 . V_36 ) ;
return V_26 ;
}
...
static void F_70 ( struct V_5 * V_6 , T_1 V_231 )
{
struct V_24 V_232 ;
struct V_233 * V_234 ;
int V_26 ;
int V_64 , V_75 ;
memset ( & V_232 , 0 , sizeof( struct V_24 ) ) ;
V_232 . V_33 = sizeof( struct V_235 ) ;
V_232 . V_35 = F_9 ( V_6 -> V_16 , V_232 . V_33 ,
& V_232 . V_36 ) ;
if ( ! V_232 . V_35 ) {
F_10 ( & V_6 -> V_16 -> V_37 , L_9 ,
V_236 ) ;
goto V_202;
}
V_26 = F_71 ( V_6 , & V_232 ) ;
if ( ! V_26 ) {
V_234 = (struct V_233 * ) ( V_232 . V_35 +
sizeof( struct V_237 ) ) ;
for ( V_64 = 0 ; V_64 < F_72 ( V_234 -> V_238 ) ; V_64 ++ ) {
T_1 V_239 = F_72 ( V_234 -> V_240 [ V_64 ] . V_239 ) ;
for ( V_75 = 0 ; V_75 < V_239 ; V_75 ++ ) {
if ( V_234 -> V_240 [ V_64 ] . V_241 [ V_75 ] . V_242 ==
V_243 )
V_234 -> V_240 [ V_64 ] . V_241 [ V_75 ] . V_244 =
F_73 ( V_231 ) ;
}
}
V_26 = F_74 ( V_6 , & V_232 ,
...
F_13 ( V_6 -> V_16 , V_232 . V_33 , V_232 . V_35 ,
V_232 . V_36 ) ;
V_202:
return;
}
static void F_75 ( struct V_1 * V_2 , T_1 V_231 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( F_17 ( V_6 ) ) {
F_10 ( & V_6 -> V_16 -> V_37 , L_8 ) ;
...
if ( V_6 -> V_230 == V_231 )
return;
if ( ( V_231 & V_245 ) != ( V_6 -> V_230 & V_245 ) )
F_70 ( V_6 , V_231 & V_245 ?
V_246 : V_247 ) ;
V_6 -> V_230 = V_231 ;
return;
}
static V_93 F_76 ( struct V_5 * V_6 , V_93 V_248 )
{
V_93 V_69 = 0 ;
switch ( V_248 ) {
case V_249 :
...
static int F_77 ( struct V_1 * V_2 , struct V_264 * V_265 ,
T_1 * V_266 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( ! F_78 ( V_6 ) ) {
...
switch ( V_265 -> V_265 ) {
case V_267 :
V_265 -> V_69 = F_76 ( V_6 , V_265 -> V_248 ) ;
break;
case V_268 :
V_265 -> V_69 = V_6 -> V_98 - 1 ;
break;
default:
return - V_103 ;
}
...
T_1 V_250 = V_6 -> V_250 ;
if ( V_265 -> V_69 != V_270 &&
V_265 -> V_69 != ( V_270 | V_271 ) )
return - V_103 ;
switch ( V_265 -> V_248 ) {
case V_249 :
if ( V_265 -> V_69 == V_270 )
V_250 &= ~ V_254 ;
else if ( V_265 -> V_69 == ( V_270 | V_271 ) )
V_250 |= V_251 |
V_254 ;
break;
case V_259 :
...
if ( ( V_75 + V_64 ) >= 128 )
break;
V_269 [ V_75 + V_64 ] = V_71 -> V_272 ;
}
}
}
V_26 = F_83 ( V_6 , V_269 , V_250 , 128 ) ;
if ( ! V_26 )
V_6 -> V_250 = V_250 ;
return V_26 ;
}
static int F_84 ( struct V_1 * V_2 , struct V_264 * V_265 )
{
struct V_5 * V_6 = F_2 ( V_2 ) ;
int V_26 = 0 ;
if ( ! F_78 ( V_6 ) ) {
