...
F_32 ( V_39 , sizeof( V_39 ) , V_2 -> V_67 . V_68 , V_69 ) ;
F_29 ( V_56 , L_4 , V_39 ) ;
}
F_33 ( & V_11 -> V_59 ) ;
return 0 ;
}
static int F_34 ( struct V_70 * V_70 , struct V_38 * V_38 )
{
return F_35 ( V_38 , F_26 , V_70 -> V_71 ) ;
}
static int F_36 ( struct V_55 * V_56 , void * V_57 )
{
struct V_10 * V_11 = V_56 -> V_58 ;
char V_39 [ 72 ] ;
F_32 ( V_39 , sizeof( V_39 ) , V_11 -> V_72 . V_73 , V_69 ) ;
F_29 ( V_56 , L_5 , V_39 ) ;
F_32 ( V_39 , sizeof( V_39 ) , V_11 -> V_72 . V_74 , V_69 ) ;
F_29 ( V_56 , L_6 , V_39 ) ;
F_32 ( V_39 , sizeof( V_39 ) , V_11 -> V_72 . V_75 , V_69 ) ;
F_29 ( V_56 , L_7 , V_39 ) ;
return 0 ;
}
static int F_37 ( struct V_70 * V_70 , struct V_38 * V_38 )
{
return F_35 ( V_38 , F_36 , V_70 -> V_71 ) ;
}
static void F_38 ( struct V_76 * V_53 , int V_77 )
{
...
static void F_40 ( struct V_76 * V_53 , struct V_1 * V_2 )
{
struct V_3 * V_4 = F_41 ( V_53 , struct V_3 , V_53 ) ;
if ( V_4 -> V_79 ) {
F_3 ( & V_4 -> V_8 ) ;
...
{
V_11 -> V_4 = F_44 ( sizeof( struct V_3 ) , V_80 ) ;
if ( V_11 -> V_4 == NULL )
return;
F_45 ( & V_11 -> V_4 -> V_26 ) ;
F_46 ( & ( V_11 -> V_4 ) -> V_8 ) ;
...
V_11 -> V_4 -> V_53 . V_81 = F_38 ;
V_11 -> V_4 -> V_53 . V_82 = F_40 ;
F_48 ( & V_11 -> V_4 -> V_53 ) ;
if ( V_83 ) {
V_11 -> V_4 -> V_84 = F_49 ( F_50 ( & V_11 -> V_16 . V_22 ) ,
V_83 ) ;
V_11 -> V_4 -> V_85 = F_51 ( L_10 , 0200 ,
V_11 -> V_4 -> V_84 , V_11 ,
& V_86 ) ;
V_11 -> V_4 -> V_87 = F_51 ( L_11 , 0444 ,
V_11 -> V_4 -> V_84 , V_11 ,
& V_88 ) ;
V_11 -> V_4 -> V_89 = F_52 ( L_12 , 0644 ,
V_11 -> V_4 -> V_84 ,
& V_11 -> V_4 -> V_79 ) ;
V_11 -> V_4 -> V_90 = F_51 ( L_13 , 0444 ,
V_11 -> V_4 -> V_84 , V_11 ,
& V_91 ) ;
}
}
...
if ( V_11 -> V_4 == NULL )
return;
F_54 (rsv, t, &rc->dbg->rsvs, pal_node) {
F_16 ( V_2 ) ;
}
F_55 ( & V_11 -> V_4 -> V_53 ) ;
if ( V_83 ) {
...
struct V_93 * F_59 ( struct V_76 * V_53 )
{
struct V_10 * V_11 = V_53 -> V_11 ;
if ( V_83 && V_11 -> V_4 && V_11 -> V_4 -> V_84 && V_53 -> V_94 )
return F_49 ( V_53 -> V_94 , V_11 -> V_4 -> V_84 ) ;
return NULL ;
}
