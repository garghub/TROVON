...
{
struct V_9 * V_10 = F_102 ( V_182 , struct V_9 , V_182 ) ;
struct V_183 * V_184 ;
T_6 V_185 ;
if ( V_10 -> V_61 & V_186 )
F_103 ( V_10 ) ;
if ( V_10 -> V_61 & V_187 ) {
V_185 = F_104 ( V_10 -> V_188 ) ;
V_184 = F_105 ( V_10 -> V_188 , 0 ) ;
if ( V_184 ) {
F_106 ( & V_184 -> V_189 -> V_190 ) ;
F_107 ( V_184 -> V_189 , ( V_191 ) V_185 << 9 ) ;
F_108 ( & V_184 -> V_189 -> V_190 ) ;
F_109 ( V_184 ) ;
}
F_110 ( & V_10 -> V_155 ) ;
V_10 -> V_61 |= V_192 ;
...
static void
F_113 ( struct V_9 * V_10 , struct V_23 * V_24 , unsigned char * V_193 )
{
T_6 V_185 ;
T_7 V_18 ;
V_18 = F_114 ( & V_193 [ 83 << 1 ] ) ;
V_18 |= F_114 ( & V_193 [ 86 << 1 ] ) ;
if ( V_18 & ( 1 << 10 ) ) {
V_10 -> V_61 |= V_98 ;
V_185 = F_115 ( & V_193 [ 100 << 1 ] ) ;
...
V_10 -> V_61 &= ~ V_98 ;
V_185 = F_116 ( & V_193 [ 60 << 1 ] ) ;
V_10 -> V_196 . V_197 = F_114 ( & V_193 [ 54 << 1 ] ) ;
V_10 -> V_196 . V_198 = F_114 ( & V_193 [ 55 << 1 ] ) ;
V_10 -> V_196 . V_199 = F_114 ( & V_193 [ 56 << 1 ] ) ;
}
F_112 ( ( T_7 * ) & V_193 [ 10 << 1 ] , 10 ) ;
F_112 ( ( T_7 * ) & V_193 [ 23 << 1 ] , 4 ) ;
F_112 ( ( T_7 * ) & V_193 [ 27 << 1 ] , 20 ) ;
...
static void
F_119 ( struct V_9 * V_10 , struct V_23 * V_24 , int V_203 )
{
register long V_18 ;
V_18 = V_203 ;
...
static struct V_23 *
F_120 ( struct V_9 * V_10 , char * V_33 )
{
...
static void
F_121 ( struct V_82 * V_59 , T_1 V_83 , struct V_1 * V_3 , long V_84 )
{
T_1 V_86 ;
char * V_134 ;
int V_205 = 0 ;
...
if ( V_86 > V_84 )
V_86 = V_84 ;
V_134 = F_122 ( V_59 -> V_90 ) + V_83 ;
F_123 ( V_3 , V_205 , V_134 , V_86 ) ;
V_205 += V_86 ;
V_84 -= V_86 ;
if ( V_84 <= 0 )
return;
...
void
F_124 ( struct V_9 * V_10 , struct V_168 * V_172 , int V_206 )
{
struct V_101 * V_101 ;
int V_207 ;
struct V_175 * V_176 ;
...
do {
V_101 = V_172 -> V_101 ;
V_207 = ! V_206 && F_125 ( V_208 , & V_101 -> V_209 ) ;
} while ( F_126 ( V_172 , V_207 ? 0 : - V_210 , V_101 -> V_173 ) );
if ( ! V_206 )
F_127 ( V_176 ) ;
}
static void
F_128 ( struct V_9 * V_10 , struct V_58 * V_58 )
{
struct V_168 * V_172 ;
unsigned long V_18 ;
...
F_131 ( V_3 , sizeof( * V_211 ) ) ;
V_213 = (struct V_42 * ) V_3 -> V_216 ;
F_131 ( V_3 , sizeof( * V_213 ) ) ;
if ( V_213 -> V_107 & 0xa9 ) {
F_69 ( L_12 ,
V_214 -> V_107 , V_213 -> V_107 ,
V_10 -> V_37 , V_10 -> V_39 ) ;
V_215: if ( V_58 )
F_132 ( V_208 , & V_58 -> V_101 -> V_209 ) ;
goto V_158;
}
V_18 = V_214 -> V_96 << 9 ;
switch ( V_214 -> V_107 ) {
...
F_121 ( V_16 -> V_59 , V_16 -> V_103 , V_3 , V_18 ) ;
case V_218 :
case V_219 :
F_110 ( & V_10 -> V_155 ) ;
...
break;
F_110 ( & V_10 -> V_155 ) ;
F_113 ( V_10 , V_24 , V_3 -> V_216 ) ;
F_111 ( & V_10 -> V_155 ) ;
break;
default:
F_59 ( L_17 ,
V_214 -> V_107 ,
F_134 ( F_135 ( & V_211 -> V_36 ) ) ,
V_211 -> V_38 ) ;
}
V_158:
F_110 ( & V_10 -> V_155 ) ;
...
V_227 = V_224 -> V_230 () ;
if ( ! V_227 ) {
F_143 ( V_224 -> V_231 , & V_225 ) ;
F_144 ( V_232 ) ;
}
F_111 ( V_224 -> V_155 ) ;
if ( ! V_227 ) {
F_145 () ;
F_146 ( V_224 -> V_231 , & V_225 ) ;
} else
F_147 () ;
} while ( ! F_148 () );
F_142 ( & V_224 -> V_229 ) ;
...
struct V_234 * V_233 ;
F_153 ( & V_224 -> V_229 ) ;
V_233 = F_154 ( F_139 , V_224 , V_224 -> V_235 ) ;
if ( V_233 == NULL || F_155 ( V_233 ) )
return - V_236 ;
V_224 -> V_233 = V_233 ;
F_151 ( & V_224 -> V_229 ) ;
F_153 ( & V_224 -> V_229 ) ;
...
T_1 V_61 ;
V_16 -> V_60 = V_3 ;
F_77 ( & V_222 . V_155 , V_61 ) ;
F_39 ( & V_16 -> V_13 , & V_222 . V_13 ) ;
F_78 ( & V_222 . V_155 , V_61 ) ;
F_156 ( & V_237 ) ;
}
struct V_1 *
F_157 ( struct V_1 * V_3 )
{
struct V_9 * V_10 ;
struct V_25 * V_26 ;
struct V_8 * V_16 ;
...
V_37 = F_134 ( F_135 ( & V_26 -> V_36 ) ) ;
V_10 = F_158 ( V_37 , V_26 -> V_38 , 0 ) ;
if ( V_10 == NULL ) {
snprintf ( V_238 , sizeof V_238 , L_18
L_19 ,
V_37 , V_26 -> V_38 ) ;
F_61 ( V_238 ) ;
return V_3 ;
...
F_77 ( & V_10 -> V_155 , V_61 ) ;
V_18 = F_159 ( F_135 ( & V_26 -> V_11 ) ) ;
V_16 = F_12 ( V_10 , V_18 ) ;
if ( V_16 ) {
F_119 ( V_10 , V_16 -> V_24 , F_62 ( V_16 ) ) ;
V_16 -> V_24 -> V_78 -- ;
if ( V_16 -> V_61 & V_127 )
V_16 -> V_24 -> V_146 -- ;
} else {
V_16 = F_8 ( V_10 , V_18 ) ;
if ( V_16 ) {
F_119 ( V_10 , NULL , F_62 ( V_16 ) ) ;
} else {
F_119 ( V_10 , NULL , F_63 ( V_18 ) ) ;
F_78 ( & V_10 -> V_155 , V_61 ) ;
F_136 ( V_10 ) ;
snprintf ( V_238 , sizeof( V_238 ) ,
L_20 ,
L_21 ,
F_160 ( & V_26 -> V_36 ) ,
V_26 -> V_38 ,
...
void
F_162 ( T_4 V_37 , unsigned char V_39 )
{
struct V_110 V_111 ;
F_49 ( & V_111 ) ;
...
V_242 = V_10 -> V_76 ;
V_243 = V_242 * 2 ;
V_69 = F_32 ( V_243 , sizeof( * V_10 -> V_73 ) , V_5 ) ;
if ( ! V_69 )
return NULL ;
memmove ( V_69 , V_10 -> V_73 , sizeof( * V_10 -> V_73 ) * V_242 ) ;
V_10 -> V_75 = V_69 + ( V_10 -> V_75 - V_10 -> V_73 ) ;
F_165 ( V_10 -> V_73 ) ;
V_10 -> V_73 = V_69 ;
V_10 -> V_76 = V_243 ;
return & V_10 -> V_73 [ V_242 ] ;
}
static struct V_23 *
F_166 ( struct V_9 * V_10 , char * V_33 , T_1 V_162 )
{
struct V_23 * V_24 , * * V_69 , * * V_244 ;
V_69 = V_10 -> V_73 ;
V_244 = V_69 + V_10 -> V_76 ;
for (; V_69 < V_244 && * V_69 ; V_69 ++ )
;
if ( V_69 == V_244 ) {
V_69 = F_164 ( V_10 ) ;
if ( ! V_69 )
...
static void
F_171 ( struct V_23 * V_24 , struct V_123 * V_30 , int V_97 )
{
struct V_9 * V_10 ;
struct V_51 * V_134 , * V_135 ;
int V_246 ;
...
V_18 = F_134 ( V_122 -> V_248 ) ;
if ( V_18 > V_249 )
V_18 = V_249 ;
V_10 = F_158 ( V_37 , V_26 -> V_38 , 1 ) ;
if ( V_10 == NULL ) {
F_59 ( L_29 ) ;
return;
}
F_77 ( & V_10 -> V_155 , V_61 ) ;
V_24 = F_120 ( V_10 , V_26 -> V_28 ) ;
if ( V_24 ) {
V_24 -> V_162 = V_18 ;
if ( V_18 < V_24 -> V_79 )
F_168 ( V_24 ) ;
} else {
V_24 = F_166 ( V_10 , V_26 -> V_28 , V_18 ) ;
if ( ! V_24 )
goto V_65;
}
V_18 = V_3 -> V_109 -> V_250 ;
V_18 -= sizeof( struct V_25 ) + sizeof( struct V_42 ) ;
V_18 /= 512 ;
if ( V_18 > V_122 -> V_96 )
V_18 = V_122 -> V_96 ;
V_18 = V_18 ? V_18 * 512 : V_114 ;
F_171 ( V_24 , V_3 -> V_109 , V_18 ) ;
if ( V_10 -> V_251 == 0 ) {
V_10 -> V_201 = F_134 ( V_122 -> V_252 ) ;
V_247 = F_163 ( V_10 ) ;
}
V_65:
F_78 ( & V_10 -> V_155 , V_61 ) ;
...
V_10 -> V_113 = 0 ;
V_24 = V_10 -> V_73 ;
V_244 = V_24 + V_10 -> V_76 ;
for (; V_24 < V_244 && * V_24 ; V_24 ++ )
F_168 ( * V_24 ) ;
}
void
F_174 ( struct V_9 * V_10 , struct V_58 * V_58 )
{
if ( V_58 == NULL )
return;
V_58 -> V_115 = 0 ;
...
F_149 ( & V_255 ) ;
F_175 () ;
F_183 ( ( unsigned long ) F_122 ( V_139 ) ) ;
V_139 = NULL ;
}
