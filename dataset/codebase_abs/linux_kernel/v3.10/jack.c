...
int F_17 ( struct V_3 * V_4 , enum V_36 type ,
int V_37 )
{
int V_18 = F_18 ( V_20 ) - F_18 ( type ) ;
F_16 ( V_4 -> V_7 ) ;
if ( ! V_37 || V_18 >= F_7 ( V_4 -> V_18 ) )
return - V_38 ;
V_4 -> type |= type ;
V_4 -> V_18 [ V_18 ] = V_37 ;
return 0 ;
}
void F_19 ( struct V_3 * V_4 , int V_39 )
{
int V_13 ;
if ( ! V_4 )
return;
