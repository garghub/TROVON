...
static T_4 F_21 ( struct V_52 * V_46 ,
struct V_53 * V_54 , char * V_26 )
{
if ( F_22 ( V_33 + 0x30 , V_26 ) )
return - V_55 ;
return sizeof( V_33 ) ;
}
static T_4 F_23 ( struct V_52 * V_46 ,
struct V_53 * V_54 ,
...
struct V_6 * V_7 = NULL ;
if ( V_33 ) {
V_7 = F_26 ( sizeof( struct V_6 ) , V_58 ) ;
if ( ! V_7 )
return - V_59 ;
V_5 -> V_27 = V_7 ;
}
for ( V_28 = 0 ; V_28 < V_60 && ! V_57 ; ++ V_28 )
V_57 = F_27 (
& V_5 -> V_46 . V_23 , & ( V_61 [ V_28 ] ) ) ;
if ( ! V_57 ) {
V_57 = F_28 ( & V_5 -> V_46 , & V_62 ) ;
}
if ( V_57 ) {
