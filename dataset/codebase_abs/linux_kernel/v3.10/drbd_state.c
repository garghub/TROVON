...
V_33 . V_13 > V_142 )
V_9 -> V_201 = V_178 ;
V_171 = F_79 ( sizeof( * V_171 ) , V_202 ) ;
if ( V_171 ) {
V_171 -> V_32 = V_32 ;
V_171 -> V_33 = V_33 ;
V_171 -> V_46 = V_46 ;
V_171 -> V_203 . V_204 = V_205 ;
V_171 -> V_203 . V_9 = V_9 ;
V_171 -> V_57 = V_57 ;
F_80 ( & V_9 -> V_7 -> V_206 , & V_171 -> V_203 ) ;
} else {
F_42 ( V_68 , L_27 ) ;
}
return V_10 ;
}
static int V_205 ( struct V_207 * V_203 , int V_208 )
{
struct V_170 * V_171 =
F_81 ( V_203 , struct V_170 , V_203 ) ;
struct V_8 * V_9 = V_203 -> V_9 ;
...
V_9 -> V_87 -> V_144 . V_145 [ V_230 ] == 0 && V_33 . V_13 >= V_95 ) {
if ( F_105 ( V_9 ) ) {
F_76 ( V_225 , & V_9 -> V_46 ) ;
} else {
F_106 ( V_9 ) ;
...
L_33 , V_229 ) ;
if ( V_32 . V_13 != V_37 && V_33 . V_13 == V_37 ) {
enum V_234 V_235 = V_236 ;
int V_237 = 0 ;
if ( V_9 -> V_87 ) {
F_3 () ;
V_235 = F_53 ( V_9 -> V_87 -> V_88 ) -> V_238 ;
F_5 () ;
V_237 = F_26 ( V_239 , & V_9 -> V_46 ) ;
if ( V_237 && V_235 == V_240 )
F_94 ( V_9 , L_34 ) ;
if ( F_26 ( V_241 , & V_9 -> V_46 ) )
F_109 ( V_9 ) ;
...
static int F_114 ( struct V_207 * V_203 , int V_208 )
{
struct V_245 * V_246 =
F_81 ( V_203 , struct V_245 , V_203 ) ;
struct V_6 * V_7 = V_203 -> V_7 ;
enum V_29 V_125 = V_246 -> V_125 ;
union V_1 V_247 = V_246 -> V_247 ;
struct V_8 * V_9 ;
int V_11 ;
F_84 ( V_246 ) ;
if ( V_125 == V_16 && V_247 . V_15 == V_119 )
F_115 ( & V_7 -> V_200 ) ;
if ( V_125 == V_38 && V_247 . V_15 == V_16 ) {
struct V_84 * V_248 ;
F_33 ( & V_7 -> V_249 ) ;
V_248 = V_7 -> V_84 ;
V_7 -> V_250 = 0 ;
...
F_119 ( & V_7 -> V_253 , & V_254 ) ;
F_120 ( V_7 ) ;
return 0 ;
}
void F_121 ( struct V_6 * V_7 , union V_1 * V_255 , enum V_44 * V_256 )
{
enum V_44 V_46 = ~ 0 ;
struct V_8 * V_9 ;
int V_11 , V_257 = 1 ;
union V_258 V_32 , V_162 = {
{ . V_17 = V_18 ,
. V_24 = V_23 ,
. V_15 = V_7 -> V_259 ,
. V_13 = V_14 ,
...
V_32 = F_21 ( V_9 ) ;
V_33 = F_27 ( V_9 , F_18 ( V_32 , V_40 , V_41 ) , NULL ) ;
if ( V_46 & V_260 && V_33 . V_13 == V_106 && V_32 . V_13 < V_106 )
V_33 . V_13 = V_32 . V_13 ;
if ( V_33 . V_42 == V_32 . V_42 )
continue;
V_10 = F_28 ( V_32 , V_33 ) ;
...
union V_1 * V_261 , union V_1 * V_262 , enum V_44 V_46 )
{
union V_1 V_33 , V_32 , V_247 = { } ;
union V_1 V_263 = {
{ . V_17 = V_264 ,
. V_24 = V_264 ,
. V_15 = V_41 . V_15 ,
...
int V_11 , V_265 = 0 ;
if ( V_40 . V_15 == V_30 ) {
if ( V_7 -> V_259 != V_31 && V_41 . V_15 == V_31 )
V_7 -> V_266 = V_178 ;
V_7 -> V_259 = V_41 . V_15 ;
}
F_3 () ;
...
V_247 . V_17 = F_6 ( V_33 . V_17 , V_247 . V_17 ) ;
V_247 . V_24 = F_6 ( V_33 . V_24 , V_247 . V_24 ) ;
V_247 . V_15 = F_11 ( enum V_29 , V_33 . V_15 , V_247 . V_15 ) ;
V_247 . V_13 = F_11 ( enum V_25 , V_33 . V_13 , V_247 . V_13 ) ;
V_247 . V_28 = F_11 ( enum V_25 , V_33 . V_28 , V_247 . V_28 ) ;
V_263 . V_17 = F_7 ( V_33 . V_17 , V_263 . V_17 ) ;
V_263 . V_24 = F_7 ( V_33 . V_24 , V_263 . V_24 ) ;
V_263 . V_15 = F_13 ( enum V_29 , V_33 . V_15 , V_263 . V_15 ) ;
V_263 . V_13 = F_13 ( enum V_25 , V_33 . V_13 , V_263 . V_13 ) ;
V_263 . V_28 = F_13 ( enum V_25 , V_33 . V_28 , V_263 . V_28 ) ;
}
F_5 () ;
if ( V_265 == 0 ) {
V_263 = V_247 = (union V_1 ) { {
. V_17 = V_18 ,
. V_24 = V_23 ,
. V_15 = V_41 . V_15 ,
. V_13 = V_14 ,
...
V_263 . V_3 = V_247 . V_3 = V_7 -> V_3 ;
V_263 . V_4 = V_247 . V_4 = V_7 -> V_4 ;
V_263 . V_5 = V_247 . V_5 = V_7 -> V_5 ;
* V_261 = V_263 ;
* V_262 = V_247 ;
}
static enum V_43
...
{
enum V_43 V_10 ;
if ( F_26 ( V_267 , & V_7 -> V_46 ) )
return V_50 ;
if ( F_26 ( V_268 , & V_7 -> V_46 ) )
return V_52 ;
V_10 = F_122 ( V_7 , V_40 , V_41 , 0 ) ;
if ( V_10 == V_53 && V_7 -> V_259 == V_31 )
V_10 = V_54 ;
return V_10 ;
}
enum V_43
...
enum V_43 V_10 = V_53 ;
struct V_245 * V_246 ;
enum V_29 V_125 = V_7 -> V_259 ;
union V_1 V_247 , V_263 , V_32 ;
bool V_269 = false ;
if ( V_40 . V_15 ) {
...
F_121 ( V_7 , & V_32 , & V_46 ) ;
V_46 |= V_81 ;
F_123 ( V_7 , V_40 , V_41 , & V_263 , & V_247 , V_46 ) ;
F_50 ( V_7 , V_32 , V_247 , V_46 ) ;
V_246 = F_79 ( sizeof( * V_246 ) , V_202 ) ;
if ( V_246 ) {
V_246 -> V_125 = V_32 . V_15 ;
V_246 -> V_263 = V_263 ;
V_246 -> V_247 = V_247 ;
V_246 -> V_46 = V_46 ;
V_246 -> V_203 . V_204 = F_114 ;
F_128 ( & V_7 -> V_253 ) ;
V_246 -> V_203 . V_7 = V_7 ;
F_80 ( & V_7 -> V_206 , & V_246 -> V_203 ) ;
} else {
F_129 ( V_7 , L_38 ) ;
}
abort:
