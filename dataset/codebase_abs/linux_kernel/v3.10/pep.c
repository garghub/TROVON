...
static T_1 F_46 ( const T_1 * V_101 , unsigned int V_102 )
{
unsigned int V_103 ;
T_1 V_104 = V_105 ;
...
T_3 V_116 = F_53 ( V_45 ) ;
F_54 (sknode, hlist) {
struct V_30 * V_117 = F_18 ( V_115 ) ;
if ( V_117 -> V_118 . V_119 != V_116 )
continue;
if ( V_117 -> V_27 != V_27 )
continue;
if ( V_115 -> V_50 == V_70 )
...
goto V_120;
F_57 ( V_2 , & V_45 ) ;
V_115 = F_52 ( & V_31 -> V_114 , & V_45 , V_27 ) ;
if ( V_115 )
return F_58 ( V_115 , V_2 , 1 ) ;
switch ( V_58 -> V_26 ) {
case V_71 :
if ( V_13 -> V_50 != V_122 || F_59 ( V_13 ) ) {
F_24 ( V_13 , V_2 , V_72 ,
V_37 ) ;
break;
}
...
static void F_63 ( struct V_12 * V_13 , long V_127 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
int V_128 = 0 ;
F_55 ( V_13 ) ;
...
static struct V_12 * F_69 ( struct V_12 * V_13 , int V_133 , int * V_134 )
{
struct V_30 * V_31 = F_18 ( V_13 ) , * V_135 ;
struct V_12 * V_136 = NULL ;
struct V_1 * V_2 ;
struct V_18 * V_58 ;
struct V_22 V_45 , V_137 ;
int V_69 ;
T_3 V_138 ;
T_1 V_27 , V_139 , V_66 ;
T_1 V_140 = 0 ;
V_2 = F_70 ( V_13 , 0 , V_133 & V_141 , V_134 ) ;
if ( ! V_2 )
return NULL ;
F_65 ( V_13 ) ;
if ( V_13 -> V_50 != V_122 ) {
...
V_136 = F_52 ( & V_31 -> V_114 , & V_45 , V_27 ) ;
if ( F_72 ( V_136 ) ) {
F_73 ( V_136 ) ;
V_136 = NULL ;
...
V_136 = F_74 ( F_75 ( V_13 ) , V_148 , V_32 , V_13 -> V_149 ) ;
if ( ! V_136 ) {
F_24 ( V_13 , V_2 , V_150 , V_32 ) ;
V_69 = - V_91 ;
goto V_120;
}
F_76 ( NULL , V_136 ) ;
V_136 -> V_50 = V_97 ;
V_136 -> V_131 = F_35 ;
V_136 -> V_151 = V_13 -> V_151 ;
V_136 -> V_152 = F_44 ;
V_135 = F_18 ( V_136 ) ;
F_57 ( V_2 , & V_45 ) ;
F_15 ( V_2 , & V_137 ) ;
V_135 -> V_118 . V_119 = F_53 ( & V_45 ) ;
V_135 -> V_118 . V_153 = F_53 ( & V_137 ) ;
V_135 -> V_118 . V_154 = F_77 ( & V_45 ) ;
F_55 ( V_13 ) ;
V_135 -> V_155 = V_13 ;
F_78 ( & V_135 -> V_85 ) ;
V_135 -> V_27 = V_27 ;
...
static int F_80 ( struct V_12 * V_13 , struct V_156 * V_157 , int V_15 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
int V_69 ;
...
static int F_81 ( struct V_12 * V_13 , struct V_156 * V_157 , int V_15 )
{
int V_69 ;
...
static int F_82 ( struct V_12 * V_13 , int V_158 , unsigned long V_159 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
int V_160 ;
int V_161 = - V_162 ;
...
if ( F_36 ( V_13 , V_164 ) &&
! F_83 ( & V_31 -> V_85 ) )
V_160 = F_84 ( & V_31 -> V_85 ) -> V_15 ;
else if ( ! F_83 ( & V_13 -> V_92 ) )
V_160 = F_84 ( & V_13 -> V_92 ) -> V_15 ;
else
V_160 = 0 ;
F_66 ( V_13 ) ;
V_161 = F_85 ( V_160 , ( int V_165 * ) V_159 ) ;
break;
case V_166 :
F_65 ( V_13 ) ;
if ( V_13 -> V_50 == V_110 )
...
static int F_88 ( struct V_12 * V_13 , int V_169 , int V_170 ,
char V_165 * V_171 , unsigned int V_172 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
int V_173 = 0 , V_69 = 0 ;
if ( V_169 != V_174 )
...
static int F_92 ( struct V_12 * V_13 , int V_169 , int V_170 ,
char V_165 * V_171 , int V_165 * V_172 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
int V_15 , V_173 ;
if ( V_169 != V_174 )
...
static int F_97 ( struct V_186 * V_187 , struct V_12 * V_13 ,
struct V_188 * V_189 , T_4 V_15 )
{
struct V_30 * V_31 = F_18 ( V_13 ) ;
struct V_1 * V_2 ;
long V_190 ;
int V_133 = V_189 -> V_191 ;
int V_69 , V_192 ;
if ( V_15 > V_193 )
return - V_194 ;
if ( ( V_189 -> V_191 & ~ ( V_195 | V_196 | V_197 |
V_198 ) ) ||
! ( V_189 -> V_191 & V_196 ) )
return - V_62 ;
...
if ( ! V_2 )
return V_69 ;
F_8 ( V_2 , V_199 + 3 + V_31 -> V_140 ) ;
V_69 = F_99 ( F_100 ( V_2 , V_15 ) , V_189 -> V_200 , V_15 ) ;
if ( V_69 < 0 )
goto V_201;
F_65 ( V_13 ) ;
V_190 = F_101 ( V_13 , V_133 & V_195 ) ;
if ( ( 1 << V_13 -> V_50 ) & ( V_124 | V_123 ) ) {
V_69 = - V_202 ;
goto V_82;
}
if ( V_13 -> V_50 != V_51 ) {
V_203:
V_69 = F_102 ( V_13 , & V_190 ) ;
if ( V_69 )
goto V_82;
if ( V_13 -> V_50 == V_70 ) {
V_69 = - V_204 ;
...
F_107 ( F_108 ( V_13 ) , & V_205 ,
V_208 ) ;
V_192 = F_109 ( V_13 , & V_190 , F_103 ( & V_31 -> V_64 ) ) ;
F_110 ( F_108 ( V_13 ) , & V_205 ) ;
if ( V_13 -> V_50 != V_51 )
goto V_203;
}
V_69 = F_94 ( V_13 , V_2 ) ;
...
F_113 ( V_209 ) -> V_212 = V_2 ;
V_209 -> V_15 += V_2 -> V_15 ;
V_209 -> V_213 += V_209 -> V_15 ;
V_209 -> V_214 += V_209 -> V_15 ;
F_114 (skb, fs)
V_211 += V_210 -> V_15 ;
V_2 -> V_215 = F_113 ( V_2 ) -> V_212 ;
F_115 ( V_2 ) ;
V_2 -> V_15 -= V_211 ;
V_2 -> V_213 -= V_211 ;
V_2 -> V_214 -= V_211 ;
F_8 ( V_209 , V_199 + 3 ) ;
return F_94 ( V_13 , V_209 ) ;
}
...
static int F_118 ( struct V_186 * V_187 , struct V_12 * V_13 ,
struct V_188 * V_189 , T_4 V_15 , int V_216 ,
int V_133 , int * V_217 )
{
struct V_1 * V_2 ;
int V_69 ;
if ( V_133 & ~ ( V_218 | V_219 | V_220 | V_195 | V_221 |
V_197 | V_198 ) )
return - V_62 ;
if ( F_72 ( 1 << V_13 -> V_50 & ( V_124 | V_123 ) ) )
return - V_202 ;
if ( ( V_133 & V_218 ) || F_36 ( V_13 , V_164 ) ) {
struct V_30 * V_31 = F_18 ( V_13 ) ;
if ( V_133 & V_219 )
return - V_62 ;
V_2 = F_117 ( & V_31 -> V_85 ) ;
...
V_2 = F_70 ( V_13 , V_133 , V_216 , & V_69 ) ;
F_65 ( V_13 ) ;
if ( V_2 == NULL ) {
if ( V_69 == - V_202 && V_13 -> V_50 == V_70 )
V_69 = - V_204 ;
F_66 ( V_13 ) ;
return V_69 ;
}
...
V_15 = V_2 -> V_15 ;
V_69 = F_119 ( V_2 , 0 , V_189 -> V_200 , V_15 ) ;
if ( ! V_69 )
V_69 = ( V_133 & V_220 ) ? V_2 -> V_15 : V_15 ;
F_120 ( V_13 , V_2 ) ;
return V_69 ;
}
