...
static int F_56 ( struct V_38 * V_38 , void T_3 * V_99 )
{
int V_32 ;
struct V_100 args ;
struct V_5 * V_14 = NULL ;
if ( F_57 ( & args , V_99 , sizeof( struct V_100 ) ) )
return - V_101 ;
args . V_102 [ 23 ] = 0 ;
...
case V_112 :
V_32 = - V_113 ;
V_14 = F_59 ( V_38 , args . V_102 ) ;
if ( ! V_14 )
goto V_83;
V_32 = - V_114 ;
if ( args . V_105 != V_109 && ! F_49 ( V_14 ) )
goto V_83;
}
switch ( args . V_105 ) {
case V_106 :
V_32 = - V_115 ;
if ( ! F_60 ( V_38 -> V_116 , V_117 ) )
break;
F_61 ( V_14 ,
args . V_103 . V_118 ,
args . V_119 ) ;
...
static int T_4 F_68 ( struct V_38 * V_38 )
{
struct V_39 * V_40 = F_31 ( V_38 , V_41 ) ;
int V_32 ;
V_40 -> V_46 = V_49 ;
...
static void T_5 F_70 ( struct V_38 * V_38 )
{
F_71 ( V_38 ) ;
}
