...
V_2 = F_25 ( sizeof( struct V_61 ) , V_62 ) ;
if ( ! V_2 ) {
F_14 ( & V_55 -> V_58 , L_4 ) ;
return - V_63 ;
}
V_2 -> V_57 = F_26 ( V_57 -> V_64 , F_27 ( V_57 ) ) ;
if ( ! V_2 -> V_57 ) {
V_32 = - V_63 ;
F_14 ( & V_55 -> V_58 , L_5 ) ;
goto V_65;
...
static int T_6 F_34 ( struct V_54 * V_55 )
{
if ( V_2 && F_35 ( V_55 ) == V_2 ) {
if ( ! V_51 )
F_1 () ;
F_36 ( & V_2 -> V_15 ) ;
F_32 ( V_2 -> V_57 ) ;
...
static int F_38 ( struct V_54 * V_55 , T_7 V_75 )
{
F_1 () ;
return 0 ;
}
