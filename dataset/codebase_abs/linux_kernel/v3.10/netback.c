...
V_103 -> V_78 = V_78 ;
V_103 -> V_68 = V_68 ;
V_103 -> V_95 = ( V_239 ) V_49 ;
if ( V_236 < 0 )
V_103 -> V_95 = ( V_239 ) V_236 ;
V_8 -> V_42 . V_45 = ++ V_9 ;
return V_103 ;
}
...
if ( V_174 )
goto V_174;
V_244 = (struct V_243 * ) V_242 ;
F_147 ( & V_8 -> V_139 , V_244 , V_34 ) ;
V_174 = F_146 ( F_144 ( V_8 ) ,
V_241 , & V_242 ) ;
if ( V_174 )
goto V_174;
V_246 = (struct V_245 * ) V_242 ;
F_147 ( & V_8 -> V_42 , V_246 , V_34 ) ;
V_8 -> V_40 = 0 ;
return 0 ;
V_174:
F_142 ( V_8 ) ;
...
F_150 ( V_252 L_22 ) ;
F_157 ( & V_2 -> V_132 ) ;
V_248 = F_158 ( V_2 -> V_251 ) ;
goto V_253;
}
F_159 ( V_2 -> V_251 , V_17 ) ;
F_160 ( & V_2 -> V_135 ) ;
F_161 ( & V_2 -> V_134 ) ;
F_162 ( & V_2 -> V_12 , 0 ) ;
F_163 ( V_2 -> V_251 ) ;
