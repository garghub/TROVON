...
int F_45 ( struct V_55 * V_89 ,
struct V_9 * V_10 ,
T_1 V_92 )
{
return F_46 ( V_89 , V_92 ) ;
}
int F_47 ( struct V_53 * V_50 )
{
F_48 () ;
return 0 ;
}
void F_49 ( struct V_83 * * V_96 )
{
struct V_97 * V_98 ;
if ( ( * V_96 ) == NULL )
return;
...
void F_51 ( struct V_53 * V_50 )
{
struct V_83 * V_83 = F_52 ( V_50 ) ;
if ( ! V_83 )
return;
F_49 ( & V_83 ) ;
}
static inline T_5 F_53 ( struct V_83 * V_96 )
{
return V_96 -> V_96 . V_99 ;
}
int
F_54 ( struct V_55 * V_89 ,
struct V_9 * V_10 ,
T_1 V_92 ,
T_6 * V_100 )
{
