...
int V_51 , V_131 , V_134 , V_135 , V_136 ;
V_134 = 50 ; V_135 = V_136 = 33 ;
if ( V_133 == V_137 ) {
int V_43 , V_25 [ 3 ] ;
...
while( V_20 && * V_20 ) {
char * V_138 ;
int V_139 = strtol ( V_20 , & V_138 , 10 ) ;
if( V_139 >= 0 && V_139 <= 100 ) {
V_25 [ V_43 ++ ] = V_139 ;
} else {
V_119 = V_140 ;
perror ( L_55 ) ;
...
switch( V_43 ) {
case 1 :
V_134 = V_25 [ 0 ] ; V_136 = V_134 / 2 ; V_135 = V_134 - V_136 ;
break;
case 2 :
V_135 = V_25 [ 0 ] ; V_136 = V_25 [ 1 ] ; V_134 = V_135 + V_136 ;
break;
case 3 :
V_134 = V_25 [ 0 ] ; V_135 = V_25 [ 1 ] ; V_136 = V_25 [ 2 ] ;
break;
}
if( V_135 + V_136 > 100 ) {
V_119 = V_140 ;
