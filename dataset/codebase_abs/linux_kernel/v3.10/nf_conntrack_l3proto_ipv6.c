...
sizeof( V_66 . V_91 ) ) ;
F_44 ( V_29 ) ;
V_66 . V_92 = F_45 ( & V_66 . V_91 ,
V_56 -> V_93 ) ;
return F_46 ( V_58 , & V_66 , sizeof( V_66 ) ) ? - V_94 : 0 ;
}
static int F_47 ( struct V_1 * V_2 ,
const struct V_4 * V_5 )
{
if ( F_48 ( V_2 , V_95 , sizeof( T_1 ) * 4 ,
& V_5 -> V_10 . V_11 . V_12 ) ||
F_48 ( V_2 , V_96 , sizeof( T_1 ) * 4 ,
& V_5 -> V_13 . V_11 . V_12 ) )
goto V_97;
return 0 ;
V_97:
...
struct V_4 * V_100 )
{
if ( ! V_99 [ V_95 ] || ! V_99 [ V_96 ] )
return - V_80 ;
memcpy ( & V_100 -> V_10 . V_11 . V_12 , F_50 ( V_99 [ V_95 ] ) ,
sizeof( T_1 ) * 4 ) ;
memcpy ( & V_100 -> V_13 . V_11 . V_12 , F_50 ( V_99 [ V_96 ] ) ,
sizeof( T_1 ) * 4 ) ;
return 0 ;
}
static int F_51 ( void )
{
return F_52 ( V_101 , V_102 + 1 ) ;
}
static int F_53 ( struct V_44 * V_44 )
{
int V_48 = 0 ;
V_48 = F_54 ( V_44 , & V_103 ) ;
if ( V_48 < 0 ) {
F_55 ( L_7 ) ;
goto V_27;
}
...
V_48 = F_54 ( V_44 , & V_106 ) ;
if ( V_48 < 0 ) {
F_55 ( L_9 ) ;
goto V_107;
}
V_48 = F_56 ( V_44 , & V_108 ) ;
if ( V_48 < 0 ) {
F_55 ( L_10 ) ;
goto V_109;
}
