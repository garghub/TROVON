...
struct V_27 * V_27 ;
int error ;
V_4 = F_12 ( sizeof( struct V_7 ) , V_43 ) ;
V_27 = F_13 () ;
if ( ! V_4 || ! V_27 ) {
F_14 ( & V_2 -> V_44 , L_1 ) ;
error = - V_45 ;
...
V_27 -> V_47 = L_2 ;
V_27 -> V_42 . V_48 = V_49 ;
V_27 -> V_44 . V_50 = & V_2 -> V_44 ;
F_15 ( V_51 , V_27 -> V_52 ) ;
F_15 ( V_30 , V_27 -> V_52 ) ;
F_15 ( V_31 , V_27 -> V_53 ) ;
F_16 ( V_27 , V_28 , 0 , V_54 , 0 , 0 ) ;
F_16 ( V_27 , V_29 , 0 , V_55 , 0 , 0 ) ;
F_17 ( V_27 , V_4 ) ;
F_10 ( V_4 ) ;
error = F_18 ( V_2 -> V_5 , NULL , F_5 ,
V_56 | V_57 ,
L_2 , V_4 ) ;
if ( error ) {
F_14 ( & V_2 -> V_44 , L_3 ) ;
