...
struct V_217 * V_218 ;
int V_94 , V_219 ;
V_94 = F_103 ( V_213 -> V_8 . V_220 , 0 , & V_215 ) ;
if ( V_94 ) {
F_104 ( & V_213 -> V_8 , L_47 ) ;
return - V_221 ;
}
V_219 = F_105 ( V_213 -> V_8 . V_220 , 0 ) ;
if ( V_219 == V_222 ) {
F_104 ( & V_213 -> V_8 , L_48 ) ;
return - V_58 ;
}
if ( ! F_106 ( & V_213 -> V_8 , V_215 . V_223 ,
sizeof( struct V_9 ) , V_224 ) ) {
F_104 ( & V_213 -> V_8 , L_49 ) ;
V_94 = - V_185 ;
goto V_106;
}
V_216 = F_107 ( & V_213 -> V_8 , V_215 . V_223 , sizeof( struct V_9 ) ) ;
if ( ! V_216 ) {
F_104 ( & V_213 -> V_8 , L_50 ) ;
V_94 = - V_190 ;
goto V_106;
}
V_7 = F_108 ( & V_213 -> V_8 , sizeof( struct V_7 ) , V_225 ) ;
if ( ! V_7 ) {
...
F_109 ( & V_7 -> V_19 . V_24 ) ;
F_109 ( & V_7 -> V_19 . V_34 ) ;
snprintf ( V_7 -> V_226 . V_84 ,
sizeof( V_7 -> V_226 . V_84 ) , L_52 , L_53 ) ;
V_94 = F_110 ( V_7 -> V_8 , & V_7 -> V_226 ) ;
if ( V_94 < 0 ) {
F_104 ( & V_213 -> V_8 , L_54 , V_94 ) ;
goto V_106;
}
V_218 = F_111 ( 0 ) ;
V_7 -> V_227 = F_112 ( & V_7 -> V_226 , V_218 ,
L_55 , V_228 , NULL ) ;
...
memcpy ( V_135 , & V_231 , sizeof( V_231 ) ) ;
V_135 -> V_226 = & V_7 -> V_226 ;
V_7 -> V_135 = V_135 ;
F_115 ( & V_7 -> V_187 ) ;
...
F_116 ( V_7 -> V_135 , V_7 ) ;
F_93 ( & V_7 -> V_187 ) ;
V_94 = F_117 ( V_7 -> V_135 , V_232 , - 1 ) ;
if ( V_94 < 0 ) {
F_118 ( V_7 -> V_135 ) ;
goto V_230;
}
V_7 -> V_233 = F_119 ( & V_213 -> V_8 , L_56 ) ;
if ( F_120 ( V_7 -> V_233 ) ) {
...
F_99 ( V_7 -> V_10 ) ;
if ( F_122 ( V_7 -> V_168 , F_81 , 0 , L_20 , ( void * ) V_7 ) ) {
F_104 ( & V_213 -> V_8 , L_58 ) ;
V_94 = - V_221 ;
goto V_235;
}
F_87 ( & V_7 -> V_187 ) ;
F_123 ( & V_213 -> V_8 , L_59 ) ;
return V_94 ;
V_235:
F_124 ( V_7 -> V_233 ) ;
F_125 ( V_7 -> V_233 ) ;
