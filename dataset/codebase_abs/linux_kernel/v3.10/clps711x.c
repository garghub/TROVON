...
V_4 -> V_107 . V_110 = L_7 ;
V_4 -> V_107 . V_111 = V_112 ;
V_4 -> V_107 . V_113 = V_114 ;
V_4 -> V_107 . V_115 = V_116 ;
#ifdef F_62
V_4 -> V_107 . V_117 = & V_4 -> V_88 ;
V_4 -> V_107 . V_117 -> V_118 = V_119 ;
V_4 -> V_107 . V_117 -> V_120 = F_49 ;
V_4 -> V_107 . V_117 -> V_121 = F_52 ;
V_4 -> V_107 . V_117 -> V_50 = V_122 ;
V_4 -> V_107 . V_117 -> V_93 = - 1 ;
V_4 -> V_107 . V_117 -> V_92 = V_4 ;
strcpy ( V_4 -> V_107 . V_117 -> V_123 , L_7 ) ;
#endif
V_54 = F_63 ( & V_4 -> V_107 ) ;
if ( V_54 ) {
F_57 ( & V_101 -> V_5 , L_8 ) ;
F_64 ( & V_101 -> V_5 , V_4 -> V_105 ) ;
goto V_106;
}
for ( V_102 = 0 ; V_102 < V_116 ; V_102 ++ ) {
V_4 -> V_2 [ V_102 ] . line = V_102 ;
V_4 -> V_2 [ V_102 ] . V_5 = & V_101 -> V_5 ;
V_4 -> V_2 [ V_102 ] . V_7 = F_4 ( & V_4 -> V_2 [ V_102 ] ) ;
V_4 -> V_2 [ V_102 ] . V_124 = F_37 ( & V_4 -> V_2 [ V_102 ] ) ;
V_4 -> V_2 [ V_102 ] . type = V_86 ;
V_4 -> V_2 [ V_102 ] . V_125 = 16 ;
V_4 -> V_2 [ V_102 ] . V_50 = V_126 | V_127 ;
V_4 -> V_2 [ V_102 ] . V_67 = F_65 ( V_4 -> V_105 ) ;
V_4 -> V_2 [ V_102 ] . V_128 = & V_129 ;
F_66 ( F_67 ( & V_4 -> V_107 , & V_4 -> V_2 [ V_102 ] ) ) ;
}
return 0 ;
V_106:
F_58 ( V_101 , NULL ) ;
...
{
struct V_3 * V_4 = F_69 ( V_101 ) ;
int V_102 ;
for ( V_102 = 0 ; V_102 < V_116 ; V_102 ++ )
F_70 ( & V_4 -> V_107 , & V_4 -> V_2 [ V_102 ] ) ;
F_64 ( & V_101 -> V_5 , V_4 -> V_105 ) ;
F_71 ( & V_4 -> V_107 ) ;
F_58 ( V_101 , NULL ) ;
return 0 ;
