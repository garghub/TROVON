...
T_2 V_46 = V_111 -> V_46 ;
int V_24 ;
if ( V_46 <= 0 || V_46 > 32767 || ! V_111 -> V_56 )
return - V_10 ;
V_18 = F_16 ( V_46 + 1 , V_45 ) ;
if ( ! V_18 )
return - V_62 ;
V_18 [ V_46 ] = 0 ;
memcpy ( V_18 , V_111 -> V_56 , V_46 ) ;
...
V_24 = F_58 ( V_39 , V_47 -> V_112 , V_19 , V_20 ,
V_21 , V_22 ) ;
if ( V_24 < 0 ) {
F_27 ( V_39 ) ;
goto V_15;
...
{
struct V_38 * V_39 ;
V_39 = F_64 ( V_114 , struct V_38 , V_114 ) ;
memset ( V_39 -> V_91 , 0 , V_39 -> V_21 ) ;
F_27 ( V_39 ) ;
}
static int F_65 ( struct V_47 * V_47 , struct V_110 * V_111 )
{
...
return - V_62 ;
V_67 [ V_46 ] = 0 ;
memcpy ( V_67 , V_111 -> V_56 , V_46 ) ;
V_24 = F_11 ( V_67 , & V_19 , & V_116 , NULL , NULL ) ;
if ( V_24 < 0 )
goto V_15;
...
memcpy ( V_115 -> V_108 , V_39 -> V_108 ,
V_39 -> V_95 ) ;
F_62 ( V_47 , V_115 ) ;
F_66 ( & V_39 -> V_114 , F_63 ) ;
V_15:
F_27 ( V_67 ) ;
return V_24 ;
}
static long F_67 ( const struct V_47 * V_47 , char T_4 * V_117 ,
T_2 V_68 )
{
struct V_38 * V_39 ;
struct V_47 * V_82 ;
