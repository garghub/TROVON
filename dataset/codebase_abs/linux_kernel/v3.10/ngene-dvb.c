...
V_29 ++ ;
if ( V_27 % 100 == 0 && V_28 )
F_13 ( V_30 L_1 , V_31 , V_27 , V_28 , V_29 ) ;
#endif
V_2 += 188 ;
V_20 -= 188 ;
}
...
if ( V_9 -> V_32 > 0 )
F_14 ( & V_9 -> V_33 , V_2 , V_20 ) ;
return NULL ;
}
void * F_15 ( void * V_10 , void * V_2 , T_4 V_20 , T_4 clock , T_4 V_21 )
{
struct V_8 * V_9 = V_10 ;
struct V_11 * V_12 = V_9 -> V_12 ;
T_4 V_34 ;
...
V_34 -= V_34 % 188 ;
if ( V_34 < V_20 )
F_16 ( V_2 + V_34 , V_20 - V_34 , V_21 ) ;
else
V_34 = V_20 ;
F_17 ( & V_12 -> V_13 , V_2 , V_34 ) ;
if ( V_21 & V_22 )
F_8 ( ( T_4 * ) V_2 , V_34 ) ;
F_18 ( & V_12 -> V_13 . V_14 ) ;
return V_2 ;
...
int F_22 ( struct V_37 * V_41 , char * V_42 ,
int (* F_23)( struct V_35 * ) ,
