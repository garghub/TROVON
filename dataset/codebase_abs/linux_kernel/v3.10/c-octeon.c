...
int F_32 ( struct V_59 * V_60 )
{
return F_33 ( & V_61 , V_60 ) ;
}
int F_34 ( struct V_59 * V_60 )
{
return F_35 ( & V_61 , V_60 ) ;
}
static void F_36 ( unsigned long V_62 )
{
int V_63 = F_37 ( & V_61 , V_62 , NULL ) ;
if ( ( V_63 & ~ V_64 ) != V_65 ) {
T_3 V_66 ;
unsigned long V_67 = F_38 () ;
T_3 V_68 = F_39 () ;
if ( V_62 ) {
V_66 = V_69 [ V_67 ] ;
V_69 [ V_67 ] = 0 ;
