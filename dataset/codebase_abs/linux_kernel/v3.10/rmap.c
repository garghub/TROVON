...
F_96 ( F_146 ( V_87 ) != V_109 ) ;
V_78 = F_159 ( V_38 , F_110 ( V_92 ) ) ;
}
F_115 ( V_16 , V_51 , V_64 , F_151 ( V_78 ) ) ;
F_96 ( F_160 ( * V_64 ) ) ;
} else if ( F_158 ( V_108 ) &&
( F_146 ( V_87 ) == V_109 ) ) {
T_9 V_78 ;
...
static int F_163 ( unsigned long V_112 , unsigned int * V_67 ,
...
V_114 = V_51 ;
V_115 = V_116 ;
F_164 ( V_16 , V_114 , V_115 ) ;
if ( F_50 ( & V_11 -> V_17 -> V_110 ) ) {
V_117 = ( V_11 -> V_55 & V_70 ) ;
if ( ! V_117 )
F_51 ( & V_11 -> V_17 -> V_110 ) ;
}
V_64 = F_165 ( V_16 , V_61 , V_51 , & V_65 ) ;
F_148 ( V_16 ) ;
for (; V_51 < V_116 ; V_64 ++ , V_51 += V_120 ) {
if ( ! F_77 ( * V_64 ) )
continue;
V_38 = F_166 ( V_11 , V_51 , * V_64 ) ;
F_96 ( ! V_38 || F_63 ( V_38 ) ) ;
if ( V_117 ) {
F_162 ( V_38 ) ;
if ( V_38 == V_113 )
...
F_115 ( V_16 , V_51 , V_64 , F_167 ( V_38 -> V_46 ) ) ;
if ( F_109 ( V_92 ) )
F_147 ( V_38 ) ;
F_138 ( V_38 ) ;
F_161 ( V_38 ) ;
...
F_82 ( V_64 - 1 , V_65 ) ;
F_168 ( V_16 , V_114 , V_115 ) ;
if ( V_117 )
F_51 ( & V_11 -> V_17 -> V_110 ) ;
return V_77 ;
}
bool F_169 ( struct V_10 * V_11 )
{
...
static int F_170 ( struct V_38 * V_38 , enum V_91 V_87 )
{
struct V_1 * V_1 ;
T_3 V_45 ;
struct V_7 * V_12 ;
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 ;
if ( F_158 ( V_108 ) && ( V_87 & V_109 ) &&
F_169 ( V_11 ) )
continue;
V_51 = F_61 ( V_38 , V_11 ) ;
V_77 = F_145 ( V_38 , V_11 , V_51 , V_87 ) ;
...
static int F_171 ( struct V_38 * V_38 , enum V_91 V_87 )
{
struct V_73 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
struct V_10 * V_11 ;
...
if ( F_146 ( V_87 ) == V_96 )
goto V_43;
F_173 (vma, &mapping->i_mmap_nonlinear,
shared.nonlinear) {
...
int F_175 ( struct V_38 * V_38 , enum V_91 V_87 )
{
int V_77 ;
F_96 ( ! F_97 ( V_38 ) ) ;
F_5 ( ! F_73 ( V_38 ) && F_86 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
V_77 = F_176 ( V_38 , V_87 ) ;
else if ( F_63 ( V_38 ) )
V_77 = F_170 ( V_38 , V_87 ) ;
else
V_77 = F_171 ( V_38 , V_87 ) ;
if ( V_77 != V_111 && ! F_46 ( V_38 ) )
V_77 = V_129 ;
return V_77 ;
}
int F_177 ( struct V_38 * V_38 )
{
F_5 ( ! F_97 ( V_38 ) || F_178 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
return F_176 ( V_38 , V_96 ) ;
else if ( F_63 ( V_38 ) )
return F_170 ( V_38 , V_96 ) ;
else
return F_171 ( V_38 , V_96 ) ;
}
...
static int F_179 ( struct V_38 * V_38 , int (* F_180)( struct V_38 * ,
...
struct V_10 * V_11 = V_12 -> V_11 ;
unsigned long V_51 = F_61 ( V_38 , V_11 ) ;
V_77 = F_180 ( V_38 , V_11 , V_51 , V_130 ) ;
if ( V_77 != V_93 )
break;
}
F_54 ( V_1 ) ;
...
static int F_181 ( struct V_38 * V_38 , int (* F_180)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_130 )
{
struct V_73 * V_40 = V_38 -> V_40 ;
T_3 V_45 = V_38 -> V_46 << ( V_47 - V_48 ) ;
...
int F_182 ( struct V_38 * V_38 , int (* F_180)( struct V_38 * ,
struct V_10 * , unsigned long , void * ) , void * V_130 )
{
F_5 ( ! F_97 ( V_38 ) ) ;
if ( F_18 ( F_103 ( V_38 ) ) )
return F_183 ( V_38 , F_180 , V_130 ) ;
else if ( F_63 ( V_38 ) )
return F_179 ( V_38 , F_180 , V_130 ) ;
else
return F_181 ( V_38 , F_180 , V_130 ) ;
}
static void F_184 ( struct V_38 * V_38 ,
struct V_10 * V_11 , unsigned long V_51 , int V_80 )
{
struct V_1 * V_1 = V_11 -> V_1 ;
F_96 ( ! V_1 ) ;
