...
V_14 -> V_15 -> V_103 = V_104 ;
V_14 -> V_15 -> V_105 = 0 ;
V_77 = F_36 ( V_63 , V_106 , V_107 ) ;
if ( V_77 < 0 ) {
F_37 ( V_108 , V_14 , 0 ) ;
return V_77 ;
}
...
V_109 = F_33 ( V_76 ) ;
V_110 = V_76 . V_83 + V_76 . V_84 ;
error = F_6 ( V_109 & V_111 , V_110 ) ;
if ( error != ( V_109 & V_111 ) ) {
F_37 ( V_108 , V_14 , 0 ) ;
return error ;
}
error = F_39 ( V_63 -> V_49 , V_109 , 32 ,
V_76 . V_83 + V_76 . V_84 ) ;
...
#ifdef F_40
static unsigned long V_112 , V_113 ;
if ( ( V_76 . V_83 & 0xfff || V_76 . V_84 & 0xfff ) &&
( F_21 ( V_76 ) != V_82 ) &&
F_41 ( V_114 , V_113 + 5 * V_115 ) ) {
F_42 ( V_116 L_1 ) ;
V_113 = V_114 ;
}
if ( ( V_73 & ~ V_111 ) != 0 &&
F_41 ( V_114 , V_112 + 5 * V_115 ) ) {
F_42 ( V_117
L_2
L_3 ,
V_63 -> V_49 -> V_118 . V_119 -> V_120 . V_121 ) ;
V_112 = V_114 ;
}
#endif
if ( ! V_63 -> V_49 -> V_122 -> V_123 || ( V_73 & ~ V_111 ) != 0 ) {
...
{
unsigned long V_136 , V_137 , V_138 , error ;
int V_77 ;
struct V_75 V_76 ;
V_77 = - V_85 ;
...
F_23 ( V_76 ) || ( ( V_76 . V_135 & 0xfff ) && F_21 ( V_76 ) == V_79 ) ||
F_24 ( F_25 ( V_49 ) ) <
V_76 . V_83 + V_76 . V_84 + F_26 ( V_76 ) + F_27 ( V_76 ) ) {
goto V_139;
}
if ( F_49 ( V_76 ) )
goto V_139;
V_137 = V_76 . V_135 & 0xfffff000 ;
if ( ( F_27 ( V_76 ) & ~ V_111 ) != 0 ) {
#ifdef F_40
static unsigned long V_112 ;
if ( F_41 ( V_114 , V_112 + 5 * V_115 ) ) {
F_42 ( V_117
L_4
L_5 ,
V_49 -> V_118 . V_119 -> V_120 . V_121 ) ;
V_112 = V_114 ;
}
#endif
F_6 ( V_137 , V_76 . V_83 + V_76 . V_84 + V_76 . V_88 ) ;
F_39 ( V_49 , V_137 , F_27 ( V_76 ) ,
V_76 . V_83 + V_76 . V_84 ) ;
V_77 = 0 ;
goto V_139;
}
error = F_43 ( V_49 , V_137 , V_76 . V_83 + V_76 . V_84 ,
V_125 | V_132 | V_126 ,
V_127 | V_128 | V_129 | V_131 ,
F_27 ( V_76 ) ) ;
V_77 = error ;
if ( error != V_137 )
goto V_139;
V_138 = F_5 ( V_76 . V_83 + V_76 . V_84 ) ;
V_136 = V_76 . V_83 + V_76 . V_84 + V_76 . V_88 ;
if ( V_136 > V_138 ) {
error = F_6 ( V_137 + V_138 , V_136 - V_138 ) ;
V_77 = error ;
if ( error != V_137 + V_138 )
goto V_139;
}
V_77 = 0 ;
V_139:
