...
F_108 ( V_36 -> V_155 , 65536 ) ;
V_36 -> V_155 -> V_176 . V_181 = 256 ;
}
if ( F_109 ( V_182 , L_51 ) ) {
V_103 = - V_23 ;
goto V_106;
}
F_15 ( V_183 L_52 , V_182 ) ;
F_4 ( V_184 , L_53 , V_185 ) ;
for ( V_166 = 0 ; V_166 < V_170 ; V_166 ++ ) {
struct V_121 * V_36 = V_169 [ V_166 ] . V_36 ;
V_169 [ V_166 ] . V_142 = NULL ;
V_169 [ V_166 ] . V_90 = V_124 ;
V_169 [ V_166 ] . V_26 = 0 ;
F_110 ( & V_169 [ V_166 ] . V_128 ) ;
F_111 ( & V_169 [ V_166 ] . V_30 ) ;
F_110 ( & V_169 [ V_166 ] . V_126 ) ;
F_112 ( & V_169 [ V_166 ] . V_34 ) ;
F_113 ( & V_169 [ V_166 ] . V_104 ) ;
F_113 ( & V_169 [ V_166 ] . V_137 ) ;
V_169 [ V_166 ] . V_148 = 1024 ;
V_169 [ V_166 ] . V_149 = 0 ;
V_36 -> V_186 = V_182 ;
V_36 -> V_187 = V_166 << V_167 ;
V_36 -> V_188 = & V_189 ;
