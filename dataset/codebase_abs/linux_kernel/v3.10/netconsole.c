...
static void F_62 ( struct V_71 * V_72 , const char * V_73 , unsigned int V_38 )
{
int V_74 , V_75 ;
unsigned long V_53 ;
struct V_7 * V_8 ;
...
F_59 (nt, &target_list, list) {
F_9 ( V_8 ) ;
if ( V_8 -> V_23 && F_64 ( V_8 -> V_15 . V_32 ) ) {
V_76 = V_73 ;
for ( V_75 = V_38 ; V_75 ; ) {
V_74 = F_65 ( V_75 , V_79 ) ;
F_66 ( & V_8 -> V_15 , V_76 , V_74 ) ;
V_76 += V_74 ;
V_75 -= V_74 ;
}
}
