...
snprintf (drv_string, sizeof(drv_string), L_8.L_9%dL_9.L_9%dL_10Failed to set driver version in firmware\nL_11Failed to set mtu\nL_12Failed to create rx ctx in firmware%d\nL_13Failed to destroy rx ctx in firmware\nL_14Failed to create tx ctx in firmware%d\nL_15Failed to destroy tx ctx in firmware\nL_16Failed to get mac address%d\nL_17Failed to get nic info%d\nL_18Failed to set nic info%d\nL_19Failed to get PCI Info%d\nL_20Failed to configure port mirroring%d on eswitch:%d\nL_21Configured eSwitch %d for port mirroring:%d\nL_22Not privilege to query stats for func=%dL_23%s: Get mac stats failed, err=%d.\nL_24Invalid args func_esw %d port %d rx_ctx %d\nL_25eSwitch port config for pci func %d\nL_26Failed to get eswitch port config for pci func %d\nL_27Failed to configure eswitch pci func %d\nL_28Configured eSwitch for pci func %d\n"
