...
V_98 -> V_103 = V_26 -> V_103 ;
return 0 ;
}
static int F_24 ( struct V_22 * V_23 , int V_104 )
{
struct V_1 * V_2 = F_9 ( V_23 ) ;
struct V_105 * V_106 = F_25 ( V_2 ) ;
struct V_25 * V_26 = F_10 ( V_23 ) ;
int V_5 ;
if ( V_104 ) {
V_5 = F_26 ( & V_2 -> V_14 , V_106 ) ;
if ( V_5 < 0 )
return V_5 ;
if ( V_26 -> V_32 ) {
F_15 ( V_23 , & V_26 -> V_77 ) ;
...
T_2 V_110 , V_111 ;
int V_5 ;
V_5 = F_24 ( & V_26 -> V_112 , 1 ) ;
if ( V_5 < 0 )
return V_5 ;
V_5 = F_1 ( V_2 , V_113 , & V_110 ) ;
if ( V_5 < 0 )
goto V_45;
V_5 = F_1 ( V_2 , V_114 , & V_111 ) ;
if ( V_5 < 0 )
goto V_45;
V_26 -> V_115 = ( V_110 << 8 ) | V_111 ;
V_5 = F_1 ( V_2 , V_116 , & V_26 -> V_103 ) ;
if ( V_5 < 0 )
goto V_45;
...
F_32 ( & V_2 -> V_14 , L_7
L_8 ,
V_26 -> V_115 , V_26 -> V_103 , V_26 -> V_118 , V_26 -> V_120 ) ;
V_5 = F_33 ( & V_26 -> V_97 ) ;
V_45:
F_24 ( & V_26 -> V_112 , 0 ) ;
return V_5 ;
...
struct V_1 * V_2 = F_9 ( V_23 ) ;
struct V_105 * V_106 = F_25 ( V_2 ) ;
V_124 -> V_9 = V_125 | V_126 |
V_127 | V_128 |
V_129 ;
V_124 -> type = V_130 ;
V_124 -> V_9 = F_35 ( V_106 , V_124 ) ;
return 0 ;
}
...
V_26 = F_37 ( & V_2 -> V_14 , sizeof( struct V_25 ) , V_133 ) ;
if ( ! V_26 ) {
F_4 ( & V_2 -> V_14 , L_10 ) ;
return - V_134 ;
}
F_38 ( & V_26 -> V_112 , V_2 , & V_135 ) ;
F_39 ( & V_26 -> V_97 , 13 ) ;
F_40 ( & V_26 -> V_97 , & V_136 ,
V_99 , 0 , 1 , 1 , 0 ) ;
F_40 ( & V_26 -> V_97 , & V_136 ,
V_100 , 0 , 1 , 1 , 0 ) ;
V_26 -> V_112 . V_137 = & V_26 -> V_97 ;
if ( V_26 -> V_97 . error )
