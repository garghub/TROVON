...
static void T_1 F_16 ( unsigned long V_6 ,
unsigned long V_7 ,
unsigned long * V_24 )
{
struct V_9 * V_10 = (struct V_9 * ) ( V_6 + V_7 ) ;
...
static unsigned long T_1 F_17 ( unsigned long V_54 )
{
T_4 * V_34 = V_28 ;
...
void T_1 F_21 ( unsigned long V_79 , unsigned long V_80 )
{
T_4 * V_34 = ( T_4 * ) V_80 ;
unsigned long V_57 ;
unsigned long V_81 ;
...
|| strcmp ( V_84 , L_53 ) == 0 ) ) {
F_1 ( L_54 ) ;
F_30 ( ( unsigned V_88 * ) 0x80880008 , 1 ) ;
}
}
if ( V_34 -> V_69 < 5 ) {
