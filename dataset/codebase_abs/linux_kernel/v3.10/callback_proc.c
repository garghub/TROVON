...
int V_67 ;
T_1 V_11 = F_2 ( V_119 ) ;
V_13 = F_47 ( V_5 -> V_120 , args -> V_121 , & args -> V_122 ) ;
if ( V_13 == NULL )
goto V_14;
V_80 = & V_13 -> V_106 -> V_123 ;
F_21 ( & V_80 -> V_116 ) ;
if ( F_27 ( V_124 , & V_80 -> V_125 ) ) {
F_22 ( & V_80 -> V_116 ) ;
V_11 = F_2 ( V_58 ) ;
if ( F_27 ( V_126 , & V_13 -> V_127 ) )
V_11 = F_2 ( V_119 ) ;
goto V_14;
}
V_11 = F_43 ( & V_13 -> V_106 -> V_123 , args ) ;
F_22 ( & V_80 -> V_116 ) ;
if ( V_11 )
goto V_14;
V_5 -> V_128 = args -> V_84 ;
if ( F_45 ( V_13 , args -> V_129 , args -> V_130 ) ) {
V_11 = F_2 ( V_58 ) ;
goto V_14;
}
memcpy ( & V_3 -> V_131 , & args -> V_122 ,
sizeof( V_3 -> V_131 ) ) ;
V_3 -> V_132 = args -> V_85 ;
V_3 -> V_133 = args -> V_84 ;
V_3 -> V_134 = V_86 - 1 ;
...
V_14:
V_5 -> V_13 = V_13 ;
for ( V_67 = 0 ; V_67 < args -> V_129 ; V_67 ++ )
F_41 ( args -> V_130 [ V_67 ] . V_113 ) ;
F_41 ( args -> V_130 ) ;
if ( V_11 == F_2 ( V_92 ) ) {
V_5 -> V_136 = V_11 ;
V_11 = 0 ;
...
V_3 -> V_137 = V_11 ;
F_12 ( L_16 , V_32 ,
F_13 ( V_11 ) , F_13 ( V_3 -> V_137 ) ) ;
return V_11 ;
}
static bool
F_48 ( unsigned long V_138 )
{
return ( V_138 & ~ V_139 ) == 0 ;
}
T_1 F_49 ( struct V_140 * args , void * V_34 ,
struct V_4 * V_5 )
{
T_1 V_11 ;
T_4 V_141 = 0 ;
...
goto V_14;
V_11 = F_37 ( V_96 ) ;
if ( F_27 ( V_144 , ( const unsigned long * )
& args -> V_143 ) )
V_141 = V_145 ;
if ( F_27 ( V_146 , ( const unsigned long * )
& args -> V_143 ) )
V_141 |= V_20 ;
...
T_1 F_51 ( struct V_148 * args , void * V_34 ,
struct V_4 * V_5 )
{
struct V_79 * V_149 ;
T_1 V_11 ;
...
F_4 ( V_5 -> V_13 -> V_17 , V_18 ) ,
args -> V_150 ) ;
V_149 = & V_5 -> V_13 -> V_106 -> V_107 ;
V_11 = F_2 ( V_96 ) ;
F_52 ( V_149 , args -> V_150 ) ;
F_53 ( V_5 -> V_13 ) ;
V_14:
F_12 ( L_2 , V_32 , F_13 ( V_11 ) ) ;
return V_11 ;
