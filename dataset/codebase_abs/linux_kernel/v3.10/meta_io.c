...
void F_58 ( struct V_71 * V_72 , T_1 V_73 , T_2 V_74 )
{
struct V_25 * V_26 = F_59 ( & V_72 -> V_75 ) ;
struct V_4 * V_5 ;
while ( V_74 ) {
V_5 = F_24 ( V_72 -> V_76 , V_73 , V_77 ) ;
if ( V_5 ) {
F_7 ( V_5 ) ;
F_60 ( V_26 ) ;
...
int F_62 ( struct V_71 * V_72 , int V_78 , T_1 V_79 ,
struct V_4 * * V_42 )
{
struct V_25 * V_26 = F_59 ( & V_72 -> V_75 ) ;
...
V_80 = F_38 ( V_19 , V_79 , V_49 , & V_5 ) ;
if ( V_80 == 0 && F_63 ( V_26 , V_5 , V_81 ) ) {
F_44 ( V_5 ) ;
V_80 = - V_45 ;
}
* V_42 = V_5 ;
...
struct V_4 * F_64 ( struct V_18 * V_19 , T_1 V_84 , T_2 V_85 )
{
struct V_25 * V_26 = V_19 -> V_22 ;
struct V_4 * V_86 , * V_5 ;
T_2 V_87 = F_65 ( V_26 , V_88 ) >>
V_26 -> V_31 . V_32 ;
F_2 ( ! V_85 ) ;
if ( V_87 < 1 )
V_87 = 1 ;
if ( V_85 > V_87 )
V_85 = V_87 ;
V_86 = F_24 ( V_19 , V_84 , V_40 ) ;
if ( F_41 ( V_86 ) )
goto V_89;
if ( ! F_66 ( V_86 ) )
F_67 ( V_48 | V_9 , 1 , & V_86 ) ;
V_84 ++ ;
V_85 -- ;
while ( V_85 ) {
V_5 = F_24 ( V_19 , V_84 , V_40 ) ;
if ( ! F_41 ( V_5 ) && ! F_66 ( V_5 ) )
F_67 ( V_90 | V_9 , 1 , & V_5 ) ;
F_44 ( V_5 ) ;
V_84 ++ ;
V_85 -- ;
if ( ! F_66 ( V_86 ) && F_41 ( V_86 ) )
goto V_89;
}
F_42 ( V_86 ) ;
V_89:
