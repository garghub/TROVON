...
if ( V_18 -> V_26 . V_50 ) {
void (* F_30)( unsigned ) = V_18 -> V_26 . V_50 ;
F_30 ( V_39 . V_48 + 8 + 5 ) ;
}
if ( F_31 () ) {
V_37 = F_11 ( V_18 , L_23 ,
...
static void F_33 ( unsigned V_51 )
{
int V_11 ;
V_11 = F_1 ( V_51 , V_52 ) ;
if ( V_11 < 0 )
...
static int
F_36 ( struct V_17 * V_18 , const struct V_55 * V_56 )
{
int V_11 ;
const char * V_57 = F_37 () ? L_26 : L_27 ;
if ( V_3 )
return - V_58 ;
V_3 = V_18 ;
V_11 = F_3 ( V_59 ) ;
