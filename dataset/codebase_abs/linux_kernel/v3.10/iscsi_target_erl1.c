...
if ( V_32 -> V_34 && ! V_32 -> V_165 && ! V_32 -> V_166 ) {
* V_12 = V_32 -> V_12 ;
* V_10 = V_32 -> V_69 ;
F_8 ( & V_30 -> V_33 ) ;
return 0 ;
...
static void F_64 ( unsigned long V_167 )
{
T_1 V_106 = 0 , V_105 = 0 ;
T_1 V_108 = 0 , V_107 = 0 ;
struct V_29 * V_30 = (struct V_29 * ) V_167 ;
struct V_1 * V_2 = V_30 -> V_2 ;
...
if ( ++ V_30 -> V_176 == V_169 -> V_176 ) {
F_25 ( L_62
L_63 ,
V_30 -> V_42 , V_169 -> V_176 ) ;
goto V_175;
}
V_30 -> V_39 |= V_117 ;
if ( V_2 -> V_16 -> V_17 -> V_99 ) {
...
V_30 -> V_52 ) ) > V_30 -> V_76 . V_163 )
V_106 = ( V_30 -> V_76 . V_163 -
V_30 -> V_109 ) ;
else
...
F_73 ( & V_30 -> V_177 ) ;
V_30 -> V_177 . V_180 = ( F_72 () + V_169 -> V_178 * V_179 ) ;
V_30 -> V_177 . V_167 = ( unsigned long ) V_30 ;
V_30 -> V_177 . V_181 = F_64 ;
V_30 -> V_171 &= ~ V_172 ;
V_30 -> V_171 |= V_173 ;
F_74 ( & V_30 -> V_177 ) ;
}
