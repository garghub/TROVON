...
V_2 -> V_79 = V_2 -> V_25 -> V_78 + V_80 + V_81 ;
...
F_53 ( V_103 , V_76 ) ;
if ( ( V_103 -> V_34 % V_2 -> V_113 ) == 0 )
V_34 ++ ;
V_103 -> V_5 [ 0 ] = V_34 ;
V_103 -> V_5 [ 1 ] = V_34 >> 8 ;
return V_103 ;
}
static void F_54 ( struct V_1 * V_2 , struct V_114 * V_114 )
{
int V_115 ;
T_1 * V_116 ;
if ( V_114 -> V_117 < 8 )
...
{
struct V_119 V_120 = { . V_46 = V_121 } ;
F_58 ( & V_2 -> V_43 , 1 , 1 ) ;
F_59 ( & V_2 -> V_43 , & V_120 ) ;
F_14 ( V_2 -> V_25 , L_16 ,
F_60 ( & V_120 ) , V_120 . V_122 ) ;
return 0 ;
}
