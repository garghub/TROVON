...
if ( F_24 ( V_4 ) )
V_83 = F_36 ( V_81 , V_81 -> V_85 & ~ ( V_71 - 1 ) , V_71 ) ;
if ( V_83 < 0 )
V_83 = F_37 ( & V_87 , V_81 , V_71 , 0 , ~ 0 ,
V_71 , NULL , NULL ) ;
if ( V_83 < 0 )
goto V_94;
V_83 = F_21 ( V_4 , V_81 -> V_85 , F_38 ( V_81 ) ) ;
if ( V_83 < 0 ) {
F_33 ( V_81 ) ;
goto V_94;
}
...
V_98 = F_3 ( V_102 ) ;
F_1 ( V_102 , V_98 ) ;
return F_55 ( V_151 , V_167 , 0 , L_6 , NULL ) ;
}
...
V_20 -> V_216 = F_82 ( V_243 , L_13 ) ;
V_20 -> V_217 = F_82 ( V_243 , L_14 ) ;
V_20 -> V_221 = F_82 ( V_243 , L_15 ) ;
...
V_258 = F_87 ( & V_245 -> V_249 , sizeof( * V_258 ) ,
V_251 ) ;
if ( ! V_258 )
return - V_92 ;
V_258 -> V_4 = V_2 ;
...
F_86 ( & V_245 -> V_249 , L_59 ,
V_246 -> V_250 ) ;
return - V_91 ;
}
V_88 = F_35 ( V_4 , F_38 ( & V_81 ) , & V_70 ) ;
if ( V_88 < 0 ) {
F_86 ( & V_245 -> V_249 , L_60 , V_4 ) ;
return V_88 ;
}
V_88 = F_34 ( V_4 , V_81 . V_85 ) ;
if ( V_88 < 0 ) {
F_86 ( & V_245 -> V_249 , L_61 ,
V_4 , V_81 . V_85 ) ;
goto V_260;
}
F_81 ( V_246 , & V_214 ) ;
V_88 = F_83 ( V_246 , L_62 , & V_214 . V_219 ) ;
if ( V_88 < 0 )
goto V_260;
V_88 = F_75 ( V_4 , & V_214 ) ;
if ( V_88 < 0 )
...
return 0 ;
F_86 ( & V_245 -> V_249 , L_63 , V_246 -> V_154 ) ;
V_88 = - V_91 ;
V_260:
F_39 ( V_4 ) ;
return V_88 ;
...
F_98 ( V_263 , & V_245 -> V_249 ) ;
if ( ! V_262 )
return 0 ;
V_88 = F_83 ( V_245 -> V_249 . V_252 , L_64 ,
& V_234 ) ;
if ( V_88 < 0 ) {
F_42 ( L_65 , V_106 ) ;
return V_88 ;
...
if ( ! V_246 -> V_154 )
continue;
if ( F_100 ( V_246 -> V_154 , L_66 ) == 0 )
V_88 = F_85 ( V_245 , V_246 ) ;
else if ( F_100 ( V_246 -> V_154 , L_67 ) == 0 )
V_88 = F_92 ( V_245 , V_246 ) ;
else if ( F_100 ( V_246 -> V_154 , L_68 ) == 0 ||
F_100 ( V_246 -> V_154 , L_69 ) == 0 )
V_88 = F_94 ( V_245 , V_246 ) ;
if ( F_101 ( V_88 < 0 , L_70 ,
V_106 , V_246 -> V_250 ) )
F_102 ( V_246 ) ;
}
return 0 ;
...
if ( F_106 ( V_3 ) )
return F_107 ( V_3 ) ;
V_81 = F_104 ( V_245 , V_269 , 0 ) ;
if ( V_81 == NULL )
F_108 ( & V_245 -> V_249 , L_71 ) ;
else
V_151 = V_81 -> V_85 ;
V_9 = F_109 ( & V_245 -> V_249 , L_72 ) ;
if ( F_106 ( V_9 ) ) {
F_86 ( & V_245 -> V_249 , L_73 ) ;
V_151 = 0 ;
return F_107 ( V_9 ) ;
}
F_110 ( V_9 ) ;
...
static int F_116 ( struct V_244 * V_245 )
{
F_56 () ;
F_62 () ;
V_270 = NULL ;
...
V_245 = F_124 ( V_277 , - 1 , V_275 , NULL , 0 ) ;
F_101 ( F_106 ( V_245 ) , L_78 , V_276 ) ;
return F_106 ( V_245 ) ? F_107 ( V_245 ) : 0 ;
}
...
return V_278 ;
for ( V_108 = 0 ; V_108 < V_144 ; V_108 ++ )
if ( V_98 & V_145 [ V_108 ] . V_146 )
F_125 ( V_145 [ V_108 ] . V_147 ) ;
F_1 ( V_102 , V_98 ) ;
return V_279 ;
}
void F_126 ( void )
{
int V_108 ;
V_280 . V_281 = F_3 ( V_282 ) ;
V_280 . V_283 = F_3 ( V_100 ) ;
V_280 . V_284 = F_3 ( V_285 ) ;
V_280 . V_286 = F_3 ( V_104 ) ;
V_280 . V_287 = F_3 ( V_118 ) ;
V_280 . V_288 = F_3 ( V_120 ) ;
V_280 . V_289 = F_3 ( V_122 ) ;
for ( V_108 = 0 ; V_108 < V_90 ; V_108 ++ ) {
V_280 . V_290 [ V_108 ] . V_291 = F_24 ( V_108 ) ;
if ( V_280 . V_290 [ V_108 ] . V_291 ) {
V_280 . V_290 [ V_108 ] . V_218 =
F_6 ( V_108 , V_21 ) ;
V_280 . V_290 [ V_108 ] . V_292 =
F_6 ( V_108 , V_24 ) ;
V_280 . V_290 [ V_108 ] . V_293 =
F_6 ( V_108 , V_27 ) ;
V_280 . V_290 [ V_108 ] . V_294 =
F_6 ( V_108 , V_30 ) ;
V_280 . V_290 [ V_108 ] . V_295 =
F_6 ( V_108 , V_52 ) ;
V_280 . V_290 [ V_108 ] . V_296 =
F_6 ( V_108 , V_34 ) ;
V_280 . V_290 [ V_108 ] . V_297 =
F_6 ( V_108 , V_74 ) ;
}
}
}
...
{
int V_108 ;
F_1 ( V_282 , V_280 . V_281 ) ;
F_1 ( V_100 , V_280 . V_283 ) ;
F_1 ( V_285 , V_280 . V_284 ) ;
F_1 ( V_104 , V_280 . V_286 ) ;
F_1 ( V_118 , V_280 . V_287 ) ;
F_1 ( V_120 , V_280 . V_288 ) ;
F_1 ( V_122 , V_280 . V_289 ) ;
for ( V_108 = 0 ; V_108 < V_90 ; V_108 ++ ) {
if ( V_280 . V_290 [ V_108 ] . V_291 ) {
F_5 ( V_108 , V_21 ,
V_280 . V_290 [ V_108 ] . V_218 ) ;
