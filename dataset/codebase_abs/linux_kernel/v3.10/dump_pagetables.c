...
T_4 * V_35 , unsigned long V_25 )
{
unsigned int V_15 ;
T_3 * V_31 ;
int V_27 ;
for ( V_27 = 0 ; V_27 < V_36 && V_25 < V_29 ; V_27 ++ ) {
V_10 -> V_22 = V_25 ;
V_31 = F_14 ( V_35 , V_25 ) ;
if ( ! F_15 ( * V_31 ) )
if ( F_16 ( * V_31 ) ) {
...
for ( V_27 = 0 ; V_27 < V_39 && V_25 < V_29 ; V_27 ++ ) {
V_10 . V_22 = V_25 ;
V_35 = F_19 ( V_25 ) ;
if ( ! F_20 ( * V_35 ) )
F_13 ( V_2 , & V_10 , V_35 , V_25 ) ;
else
F_4 ( V_2 , & V_10 , V_6 , 1 ) ;
V_25 += V_40 ;
}
...
static int F_21 ( struct V_1 * V_2 , void * V_41 )
{
F_18 ( V_2 ) ;
return 0 ;
}
static int F_22 ( struct V_42 * V_42 , struct V_43 * V_44 )
{
return F_23 ( V_44 , F_21 , NULL ) ;
}
...
V_29 = 1UL << 31 ;
#else
V_29 = ( V_45 . V_46 & V_47 ) >> 2 ;
V_29 = 1UL << ( V_29 * 11 + 31 ) ;
V_20 [ V_48 ] . V_23 = V_49 ;
#endif
V_20 [ V_50 ] . V_23 = ( unsigned long ) V_51 ;
V_20 [ V_52 ] . V_23 = V_53 ;
F_26 ( L_17 , 0400 , NULL , NULL , & V_54 ) ;
return 0 ;
}
