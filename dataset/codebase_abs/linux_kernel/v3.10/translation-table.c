...
int V_86 ;
V_86 = V_83 ;
V_86 += F_32 ( F_41 ( & V_21 -> V_23 . V_52 ) ) ;
if ( V_86 > V_21 -> V_61 -> V_87 )
V_86 = V_83 ;
F_47 ( V_81 , V_82 ,
V_83 , V_86 ) ;
}
...
V_21 -> V_23 . V_93 = NULL ;
if ( V_90 > 0 ) {
V_21 -> V_23 . V_93 = F_25 ( V_90 , V_44 ) ;
if ( V_21 -> V_23 . V_93 ) {
memcpy ( V_21 -> V_23 . V_93 , V_91 , V_90 ) ;
V_21 -> V_23 . V_94 = V_90 ;
}
}
F_30 ( & V_21 -> V_23 . V_92 ) ;
...
int F_50 ( struct V_95 * V_96 , void * V_97 )
{
struct V_60 * V_98 = (struct V_60 * ) V_96 -> V_99 ;
struct V_20 * V_21 = F_40 ( V_98 ) ;
...
F_52 ( V_96 ,
L_6 ,
V_98 -> V_108 , ( T_2 ) F_41 ( & V_21 -> V_23 . V_73 ) ,
V_21 -> V_23 . V_109 ) ;
F_52 ( V_96 , L_7 , L_8 , L_9 ,
L_10 ) ;
...
V_127:
F_68 ( V_27 , V_33 , V_121 ) ;
F_37 ( V_59 , V_21 ,
L_14 ,
V_25 -> V_35 , V_33 -> V_128 ) ;
V_123 = 1 ;
V_126:
V_124 = F_56 ( V_21 , V_122 ,
L_15 ,
V_36 & V_70 ) ;
...
int F_79 ( struct V_95 * V_96 , void * V_97 )
{
struct V_60 * V_98 = (struct V_60 * ) V_96 -> V_99 ;
struct V_20 * V_21 = F_40 ( V_98 ) ;
...
static bool F_85 ( struct V_26 * V_57 ,
char * * V_139 )
{
bool V_140 = false ;
...
F_60 ( V_57 -> V_80 , V_141 ) ) {
V_140 = true ;
* V_139 = L_25 ;
}
if ( ( V_57 -> V_25 . V_36 & V_125 ) &&
F_60 ( V_57 -> V_25 . V_76 , V_143 ) ) {
V_140 = true ;
* V_139 = L_26 ;
}
return V_140 ;
...
struct V_118 * F_89 ( struct V_20 * V_21 ,
const T_2 * V_146 ,
const T_2 * V_35 )
{
struct V_19 * V_22 = NULL ;
...
F_16 ( V_33 -> V_91 ) ;
V_33 -> V_154 = 0 ;
V_33 -> V_91 = F_25 ( V_154 , V_44 ) ;
if ( V_33 -> V_91 ) {
memcpy ( V_33 -> V_91 , V_91 , V_154 ) ;
V_33 -> V_154 = V_154 ;
}
}
F_30 ( & V_33 -> V_155 ) ;
...
V_159 -> V_156 = V_67 ;
F_98 ( & V_159 -> V_49 , & V_21 -> V_23 . V_160 ) ;
V_50:
F_30 ( & V_21 -> V_23 . V_152 ) ;
return V_159 ;
}
static int F_99 ( const void * V_161 ,
const void * V_162 )
{
...
T_1 V_102 ;
T_6 V_173 ;
if ( V_172 + V_164 > V_21 -> V_61 -> V_87 ) {
V_164 = V_21 -> V_61 -> V_87 - V_172 ;
V_164 -= V_164 % sizeof( struct V_54 ) ;
}
V_170 = V_164 / sizeof( struct V_54 ) ;
V_173 = V_172 + V_164 ;
V_169 = F_103 ( V_173 + V_174 + V_175 ) ;
if ( ! V_169 )
goto V_72;
F_104 ( V_169 , V_174 + V_175 ) ;
V_167 = (struct V_166 * ) F_105 ( V_169 , V_173 ) ;
V_167 -> V_121 = V_121 ;
...
if ( ! V_101 )
goto V_72;
V_159 = F_96 ( V_21 , V_177 ) ;
if ( ! V_159 )
goto V_72;
V_169 = F_103 ( sizeof( * V_179 ) + V_174 + V_175 ) ;
if ( ! V_169 )
goto V_72;
F_104 ( V_169 , V_174 + V_175 ) ;
V_180 = sizeof( * V_179 ) ;
V_179 = (struct V_166 * ) F_105 ( V_169 , V_180 ) ;
V_179 -> V_181 . V_182 = V_183 ;
V_179 -> V_181 . V_184 = V_185 ;
memcpy ( V_179 -> V_146 , V_101 -> V_98 -> V_77 , V_7 ) ;
memcpy ( V_179 -> V_186 , V_177 -> V_128 , V_7 ) ;
V_179 -> V_181 . V_187 = V_188 ;
V_179 -> V_121 = V_121 ;
V_179 -> V_176 = F_106 ( V_135 ) ;
V_179 -> V_36 = V_189 ;
if ( V_178 )
V_179 -> V_36 |= V_190 ;
F_37 ( V_59 , V_21 , L_28 ,
...
goto V_50;
F_104 ( V_169 , V_174 + V_175 ) ;
V_196 = F_105 ( V_169 , V_173 ) ;
V_167 = (struct V_166 * ) V_196 ;
V_167 -> V_121 = V_195 ;
V_167 -> V_176 = F_106 ( V_170 ) ;
V_91 = V_169 -> V_10 + sizeof( * V_167 ) ;
memcpy ( V_91 , V_192 -> V_91 ,
V_192 -> V_154 ) ;
F_30 ( & V_192 -> V_155 ) ;
} else {
...
V_167 -> V_181 . V_184 = V_185 ;
V_167 -> V_181 . V_187 = V_188 ;
memcpy ( V_167 -> V_146 , V_101 -> V_98 -> V_77 , V_7 ) ;
memcpy ( V_167 -> V_186 , V_179 -> V_146 , V_7 ) ;
V_167 -> V_36 = V_197 ;
if ( V_178 )
V_167 -> V_36 |= V_190 ;
...
struct V_166 * V_179 )
{
if ( F_117 ( V_21 , V_179 -> V_186 ) ) {
if ( F_118 ( V_21 , V_179 -> V_146 ) )
return true ;
return F_115 ( V_21 , V_179 ) ;
} else {
...
struct V_54 * V_168 )
{
F_119 ( V_21 , V_33 , V_168 ,
V_153 , V_121 ) ;
F_94 ( V_21 , V_33 ,
( unsigned char * ) V_168 , V_153 ) ;
F_43 ( & V_33 -> V_134 , V_121 ) ;
}
bool F_123 ( struct V_20 * V_21 , const T_2 * V_35 )
{
struct V_19 * V_22 ;
bool V_123 = false ;
V_22 = F_10 ( V_21 , V_35 ) ;
...
if ( V_123 < 0 )
return V_123 ;
F_126 ( & V_21 -> V_23 . V_202 , V_203 ) ;
F_127 ( V_204 , & V_21 -> V_23 . V_202 ,
F_128 ( V_205 ) ) ;
return 1 ;
}
...
F_98 ( & V_211 -> V_49 , & V_21 -> V_23 . V_214 ) ;
V_123 = true ;
}
V_50:
F_30 ( & V_21 -> V_23 . V_207 ) ;
...
if ( ! F_131 ( V_21 , V_210 ) )
goto V_72;
V_169 = F_103 ( sizeof( * V_216 ) + V_174 + V_175 ) ;
if ( ! V_169 )
goto V_72;
F_104 ( V_169 , V_174 + V_175 ) ;
V_216 = (struct V_215 * ) F_105 ( V_169 , V_173 ) ;
...
if ( ! V_101 )
goto V_72;
memcpy ( V_216 -> V_146 , V_101 -> V_98 -> V_77 , V_7 ) ;
F_54 ( V_101 ) ;
...
return - V_227 ;
V_225 = F_135 ( V_21 -> V_23 . V_24 ,
V_74 , false ) ;
F_138 ( V_225 , & V_21 -> V_23 . V_200 ) ;
F_136 ( V_21 ) ;
V_21 -> V_23 . V_109 = F_92 ( V_21 ) ;
F_31 ( & V_21 -> V_23 . V_73 ) ;
F_37 ( V_59 , V_21 ,
L_38 ,
( T_2 ) F_41 ( & V_21 -> V_23 . V_73 ) ) ;
F_43 ( & V_21 -> V_23 . V_228 , V_229 ) ;
return F_49 ( V_21 , V_81 ,
V_82 , V_226 ) ;
}
...
{
int V_153 ;
V_153 = F_137 ( V_21 , V_81 ,
V_82 ,
V_226 ) ;
if ( ( V_153 < 0 ) &&
( ! F_132 ( & V_21 -> V_23 . V_228 ) ) ) {
F_47 ( V_81 , V_82 ,
V_226 , V_226 ) ;
V_153 = 0 ;
}
...
bool F_140 ( struct V_20 * V_21 , T_2 * V_146 ,
T_2 * V_186 )
{
struct V_19 * V_22 = NULL ;
struct V_26 * V_27 = NULL ;
...
struct V_118 * V_33 ,
const unsigned char * V_91 , T_2 V_153 ,
T_2 V_121 , T_3 V_135 )
{
T_2 V_194 = ( T_2 ) F_41 ( & V_33 -> V_134 ) ;
bool V_178 = true ;
struct V_54 * V_168 ;
if ( F_118 ( V_21 , V_33 -> V_128 ) )
return;
...
V_168 = (struct V_54 * ) V_91 ;
F_122 ( V_21 , V_33 , V_153 ,
V_121 , V_168 ) ;
V_33 -> V_135 = F_90 ( V_21 , V_33 ) ;
if ( V_33 -> V_135 != V_135 )
goto V_230;
