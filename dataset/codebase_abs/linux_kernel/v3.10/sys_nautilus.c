...
F_26 ( V_10 ) ;
V_10 -> V_47 [ 0 ] -> V_50 = 0 ;
V_10 -> V_47 [ 0 ] -> V_51 = 0xffff ;
V_40 = V_10 -> V_47 [ 1 ] -> V_50 ;
V_41 = V_10 -> V_47 [ 1 ] -> V_51 + 1 - V_40 ;
if ( V_40 < 0x1000000UL )
V_40 = 0x1000000UL ;
V_42 = ( 0x100000000UL - V_41 ) & - V_40 ;
V_10 -> V_47 [ 1 ] -> V_50 = V_42 ;
V_10 -> V_47 [ 1 ] -> V_51 = 0xffffffffUL ;
if ( F_27 ( & V_52 , V_10 -> V_47 [ 1 ] ) < 0 )
F_13 ( V_53 L_6 ) ;
if ( V_42 < V_43 )
V_43 = V_42 ;
if ( V_43 > V_2 . V_54 ) {
F_28 ( ( unsigned long ) F_29 ( V_2 . V_54 ) ,
( unsigned long ) F_29 ( V_43 ) , 0 , NULL ) ;
F_13 ( L_7 ,
( V_43 - V_2 . V_54 ) >> 10 ) ;
}
if ( ( V_30 -> V_55 >> 16 ) > 0x7006 )
V_30 -> V_42 = V_42 ;
F_30 ( V_10 ) ;
V_10 -> V_11 = NULL ;
F_31 ( V_2 . V_56 , V_2 . V_57 ) ;
}
