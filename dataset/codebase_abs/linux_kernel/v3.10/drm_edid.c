...
if ( ! V_217 -> clock )
return 0 ;
for ( V_68 = 0 ; V_68 < F_23 ( V_218 ) ; V_68 ++ ) {
const struct V_58 * V_219 = & V_218 [ V_68 ] ;
unsigned int V_220 , V_221 ;
V_220 = V_221 = V_219 -> clock ;
if ( V_219 -> V_171 % 6 == 0 ) {
if ( V_219 -> V_74 == 240 ||
V_219 -> V_74 == 480 )
V_220 = V_220 * 1001 / 1000 ;
else
V_221 = F_87 ( V_221 * 1000 , 1001 ) ;
}
if ( ( F_88 ( V_217 -> clock ) == F_88 ( V_220 ) ||
F_88 ( V_217 -> clock ) == F_88 ( V_221 ) ) &&
F_89 ( V_217 , V_219 ) )
return V_68 + 1 ;
}
return 0 ;
...
static int
F_90 ( struct V_38 * V_39 , T_1 * V_222 , T_1 V_21 )
{
struct V_75 * V_50 = V_39 -> V_50 ;
T_1 * V_68 , V_219 ;
int V_180 = 0 ;
...
static int
F_91 ( const T_1 * V_222 )
{
return V_222 [ 0 ] & 0x1f ;
}
static int
F_92 ( const T_1 * V_222 )
{
return V_222 [ 0 ] >> 5 ;
}
static int
F_93 ( const T_1 * V_223 )
{
return V_223 [ 1 ] ;
}
static int
F_94 ( const T_1 * V_223 , int * V_22 , int * V_224 )
{
* V_22 = 4 ;
* V_224 = V_223 [ 2 ] ;
if ( * V_224 == 0 )
...
static int
F_95 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
T_1 * V_223 = F_85 ( V_8 ) ;
T_1 * V_222 , V_226 ;
int V_180 = 0 ;
if ( V_223 && F_93 ( V_223 ) >= 3 ) {
int V_2 , V_22 , V_224 ;
if ( F_94 ( V_223 , & V_22 , & V_224 ) )
return 0 ;
F_96 (cea, i, start, end) {
V_222 = & V_223 [ V_2 ] ;
V_226 = F_91 ( V_222 ) ;
if ( F_92 ( V_222 ) == V_227 )
V_180 += F_90 ( V_39 , V_222 + 1 , V_226 ) ;
}
}
return V_180 ;
}
static void
F_97 ( struct V_38 * V_39 , const T_1 * V_222 )
{
T_1 V_21 = F_91 ( V_222 ) ;
if ( V_21 >= 6 ) {
...
static void
F_98 ( struct V_88 * V_59 , void * V_93 )
{
if ( V_59 -> V_93 . V_187 . type == V_234 )
* ( T_1 * * ) V_93 = V_59 -> V_93 . V_187 . V_93 . V_235 . V_235 ;
}
static bool F_99 ( const T_1 * V_222 )
{
int V_236 ;
if ( F_92 ( V_222 ) != V_237 )
return false ;
...
void F_100 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
...
int F_101 ( struct V_8 * V_8 , struct V_244 * * V_245 )
{
int V_246 = 0 ;
int V_2 , V_22 , V_224 , V_226 ;
T_1 * V_223 ;
V_223 = F_85 ( V_8 ) ;
if ( ! V_223 ) {
F_10 ( L_22 ) ;
...
V_226 = F_91 ( V_222 ) ;
V_246 = V_226 / 3 ;
* V_245 = F_102 ( V_246 , sizeof( * * V_245 ) , V_46 ) ;
if ( ! * V_245 )
return - V_250 ;
for ( V_40 = 0 ; V_40 < V_246 ; V_40 ++ ) {
T_1 * V_251 = & V_222 [ 1 + V_40 * 3 ] ;
( * V_245 ) [ V_40 ] . V_252 = ( V_251 [ 0 ] & 0x78 ) >> 3 ;
( * V_245 ) [ V_40 ] . V_253 = V_251 [ 0 ] & 0x7 ;
( * V_245 ) [ V_40 ] . V_254 = V_251 [ 1 ] & 0x7F ;
( * V_245 ) [ V_40 ] . V_255 = V_251 [ 2 ] ;
}
break;
}
}
...
if ( ! V_39 -> V_231 [ 1 ] )
V_2 = 0 ;
V_104 = V_39 -> V_233 [ V_2 ] ;
V_256 = V_39 -> V_232 [ V_2 ] ;
if ( V_104 == 255 || V_256 == 255 )
return 0 ;
if ( V_104 )
V_104 = F_37 ( 2 * ( V_104 - 1 ) , 500 ) ;
if ( V_256 )
V_256 = F_37 ( 2 * ( V_256 - 1 ) , 500 ) ;
return F_104 ( V_256 - V_104 , 0 ) ;
}
struct V_38 * F_105 ( struct V_257 * V_258 ,
struct V_58 * V_68 )
{
struct V_38 * V_39 ;
struct V_75 * V_50 = V_258 -> V_50 ;
F_50 (connector, &dev->mode_config.connector_list, head)
if ( V_39 -> V_258 == V_258 && V_39 -> V_228 [ 0 ] )
return V_39 ;
return NULL ;
}
bool F_106 ( struct V_8 * V_8 )
{
T_1 * V_216 ;
int V_2 ;
int V_259 , V_260 ;
...
if ( ! V_216 )
return false ;
if ( F_94 ( V_216 , & V_259 , & V_260 ) )
return false ;
F_96 (edid_ext, i, start_offset, end_offset) {
if ( F_99 ( & V_216 [ V_2 ] ) )
return true ;
}
return false ;
}
bool F_107 ( struct V_8 * V_8 )
{
T_1 * V_216 ;
int V_2 , V_40 ;
bool V_261 = false ;
...
goto V_224;
F_96 (edid_ext, i, start_offset, end_offset) {
if ( F_92 ( & V_216 [ V_2 ] ) == V_242 ) {
V_261 = true ;
for ( V_40 = 1 ; V_40 < F_91 ( & V_216 [ V_2 ] ) + 1 ; V_40 += 3 )
F_10 ( L_26 ,
...
if ( ! V_216 )
return false ;
if ( F_94 ( V_216 , & V_22 , & V_224 ) )
return false ;
F_96 (edid_ext, i, start, end) {
if ( F_92 ( & V_216 [ V_2 ] ) == V_263 &&
F_91 ( & V_216 [ V_2 ] ) == 2 ) {
F_10 ( L_27 , V_216 [ V_2 + 2 ] ) ;
return V_216 [ V_2 + 2 ] & V_264 ;
}
}
return false ;
}
static void F_109 ( struct V_8 * V_8 ,
struct V_265 * V_266 )
{
T_1 * V_216 ;
V_266 -> V_161 = V_8 -> V_168 * 10 ;
V_266 -> V_164 = V_8 -> V_169 * 10 ;
V_266 -> V_267 = 0 ;
V_266 -> V_268 = 0 ;
if ( V_8 -> V_13 < 3 )
return;
...
int F_110 ( struct V_38 * V_39 , struct V_8 * V_8 )
{
int V_285 = 0 ;
T_2 V_57 ;
if ( V_8 == NULL ) {
...
if ( ! F_7 ( V_8 ) ) {
F_16 ( V_39 -> V_50 -> V_50 , L_28 ,
F_17 ( V_39 ) ) ;
return 0 ;
}
V_57 = F_22 ( V_8 ) ;
V_285 += F_84 ( V_39 , V_8 , V_57 ) ;
V_285 += F_82 ( V_39 , V_8 ) ;
V_285 += F_79 ( V_39 , V_8 ) ;
V_285 += F_77 ( V_39 , V_8 ) ;
if ( V_8 -> V_98 & V_99 )
...
if ( V_57 & ( V_64 | V_65 ) )
F_25 ( V_39 , V_57 ) ;
F_109 ( V_8 , & V_39 -> V_286 ) ;
return V_285 ;
}
int F_111 ( struct V_38 * V_39 ,
int V_70 , int V_74 )
{
int V_2 , V_246 , V_285 = 0 ;
struct V_58 * V_68 ;
struct V_75 * V_50 = V_39 -> V_50 ;
V_246 = sizeof( V_80 ) / sizeof( struct V_58 ) ;
if ( V_70 < 0 )
V_70 = 0 ;
if ( V_74 < 0 )
V_74 = 0 ;
