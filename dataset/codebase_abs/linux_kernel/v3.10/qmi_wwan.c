...
int V_27 = 0 ;
F_13 ( & V_2 -> V_28 -> V_2 , L_1 , V_29 , F_14 ( & V_26 -> V_30 ) , V_24 ) ;
if ( ( V_24 && F_15 ( 1 , & V_26 -> V_30 ) == 1 ) || ( ! V_24 && F_16 ( & V_26 -> V_30 ) ) ) {
V_27 = F_17 ( V_2 -> V_28 ) ;
if ( V_27 < 0 )
goto V_31;
V_2 -> V_28 -> V_32 = V_24 ;
...
static int F_19 ( struct V_33 * V_28 , int V_24 )
{
...
F_23 ( & V_26 -> V_30 , 0 ) ;
V_35 = F_24 ( V_26 -> V_36 , & V_2 -> V_37 -> V_41 , 4096 , & F_19 ) ;
if ( F_25 ( V_35 ) ) {
...
static int F_28 ( struct V_1 * V_2 , struct V_33 * V_28 )
{
int V_37 = - 1 ;
...
T_3 V_51 = 0 ;
struct V_34 * V_52 = F_29 ( V_28 ) ;
struct V_25 * V_26 = ( void * ) & V_2 -> V_6 ;
F_30 ( ( sizeof( ( (struct V_1 * ) 0 ) -> V_6 ) < sizeof( struct V_25 ) ) ) ;
V_26 -> V_36 = V_28 ;
V_26 -> V_6 = V_28 ;
while ( V_44 > 3 ) {
...
if ( V_48 ) {
V_26 -> V_6 = F_31 ( V_2 -> V_63 , V_48 -> V_64 ) ;
if ( V_41 -> V_65 != V_48 -> V_66 || ! V_26 -> V_6 ) {
F_26 ( & V_28 -> V_2 , L_9 ,
V_48 -> V_66 , V_48 -> V_64 ) ;
goto V_31;
}
...
static void F_39 ( struct V_1 * V_2 , struct V_33 * V_28 )
{
struct V_25 * V_26 = ( void * ) & V_2 -> V_6 ;
struct V_34 * V_52 = F_29 ( V_28 ) ;
struct V_33 * V_73 ;
if ( V_26 -> V_35 && V_26 -> V_35 -> V_74 )
V_26 -> V_35 -> V_74 ( V_26 -> V_36 ) ;
if ( V_28 == V_26 -> V_36 )
V_73 = V_26 -> V_6 ;
else
V_73 = V_26 -> V_36 ;
...
static int F_40 ( struct V_33 * V_28 , T_4 V_75 )
{
struct V_1 * V_2 = F_20 ( V_28 ) ;
struct V_25 * V_26 = ( void * ) & V_2 -> V_6 ;
int V_19 ;
...
if ( V_19 < 0 )
goto V_31;
if ( V_28 == V_26 -> V_36 && V_26 -> V_35 && V_26 -> V_35 -> V_76 )
V_19 = V_26 -> V_35 -> V_76 ( V_28 , V_75 ) ;
if ( V_19 < 0 )
F_42 ( V_28 ) ;
V_31:
return V_19 ;
}
static int F_43 ( struct V_33 * V_28 )
{
struct V_1 * V_2 = F_20 ( V_28 ) ;
struct V_25 * V_26 = ( void * ) & V_2 -> V_6 ;
int V_19 = 0 ;
bool V_77 = ( V_28 == V_26 -> V_36 && V_26 -> V_35 && V_26 -> V_35 -> V_78 ) ;
if ( V_77 )
V_19 = V_26 -> V_35 -> V_78 ( V_28 ) ;
if ( V_19 < 0 )
goto V_31;
V_19 = F_42 ( V_28 ) ;
if ( V_19 < 0 && V_77 && V_26 -> V_35 -> V_76 )
V_26 -> V_35 -> V_76 ( V_28 , V_79 ) ;
V_31:
return V_19 ;
}
static int F_44 ( struct V_33 * V_28 , const struct V_80 * V_81 )
{
