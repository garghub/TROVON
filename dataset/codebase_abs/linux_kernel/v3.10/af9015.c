...
struct V_5 * V_6 = F_4 ( V_2 ) ;
int V_7 , V_51 ;
static const unsigned int V_72 = 256 ;
T_1 V_12 [ V_72 ] ;
...
goto error;
V_6 -> V_81 = V_38 ;
F_23 ( & V_2 -> V_31 -> V_32 , L_12 , V_62 , V_6 -> V_81 ) ;
if ( V_2 -> V_31 -> V_82 == V_83 )
V_6 -> V_81 = 0 ;
if ( V_6 -> V_81 ) {
V_4 . V_16 = V_84 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
...
for ( V_51 = 0 ; V_51 < V_6 -> V_81 + 1 ; V_51 ++ ) {
if ( V_51 == 1 )
V_77 = V_85 ;
V_4 . V_16 = V_86 + V_77 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
...
if ( V_7 )
goto error;
V_6 -> V_42 [ V_51 ] . V_88 = V_38 << 8 ;
V_4 . V_16 = V_89 + V_77 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
if ( V_7 )
goto error;
V_6 -> V_42 [ V_51 ] . V_88 += V_38 ;
V_6 -> V_42 [ V_51 ] . V_88 *= 1000 ;
F_23 ( & V_2 -> V_31 -> V_32 , L_14 , V_62 ,
V_51 , V_6 -> V_42 [ V_51 ] . V_88 ) ;
V_4 . V_16 = V_90 + V_77 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
if ( V_7 )
goto error;
V_6 -> V_91 [ V_51 ] = V_38 << 8 ;
V_4 . V_16 = V_92 + V_77 ;
V_7 = F_1 ( V_2 , & V_4 ) ;
if ( V_7 )
goto error;
...
case V_100 :
case V_101 :
V_6 -> V_42 [ V_51 ] . V_102 = 1 ;
break;
case V_103 :
case V_104 :
case V_105 :
case V_106 :
V_6 -> V_42 [ V_51 ] . V_102 = 0 ;
break;
case V_107 :
V_6 -> V_42 [ V_51 ] . V_108 [ 1 ] = V_109 ;
V_6 -> V_42 [ V_51 ] . V_102 = 1 ;
break;
default:
...
V_33 , V_7 ) ;
if ( F_30 ( V_2 -> V_31 -> V_112 . V_113 ) == V_114 &&
( ( F_30 ( V_2 -> V_31 -> V_112 . V_115 ) ==
V_116 ) ||
( F_30 ( V_2 -> V_31 -> V_112 . V_115 ) ==
V_117 ) ) ) {
F_23 ( & V_2 -> V_31 -> V_32 ,
...
V_62 ) ;
V_6 -> V_81 = 0 ;
V_6 -> V_42 [ 0 ] . V_88 = 4570000 ;
}
return V_7 ;
}
static int F_31 ( struct V_118 * V_119 , T_1 * V_120 ,
struct V_121 * V_122 )
{
struct V_1 * V_2 = F_32 ( V_119 ) ;
F_23 ( & V_2 -> V_31 -> V_32 , L_21 , V_62 , F_33 ( V_119 ) -> V_123 ) ;
if ( V_2 -> V_31 -> V_82 == V_83 )
V_122 -> V_124 . V_125 . V_126 = V_127 ;
return 0 ;
}
...
static int F_35 ( struct V_118 * V_119 )
{
int V_7 ;
struct V_5 * V_6 = F_36 ( V_119 ) ;
if ( F_20 ( & V_6 -> V_128 ) )
return - V_54 ;
V_7 = V_6 -> V_129 [ F_33 ( V_119 ) -> V_123 ] ( V_119 ) ;
F_8 ( & V_6 -> V_128 ) ;
return V_7 ;
}
...
if ( F_20 ( & V_6 -> V_128 ) )
return - V_54 ;
V_7 = V_6 -> V_131 [ F_33 ( V_119 ) -> V_123 ] ( V_119 , V_130 ) ;
F_8 ( & V_6 -> V_128 ) ;
return V_7 ;
}
...
if ( F_20 ( & V_6 -> V_128 ) )
return - V_54 ;
V_7 = V_6 -> V_132 [ F_33 ( V_119 ) -> V_123 ] ( V_119 ) ;
F_8 ( & V_6 -> V_128 ) ;
return V_7 ;
}
...
if ( F_20 ( & V_6 -> V_128 ) )
return - V_54 ;
V_7 = V_6 -> V_133 [ F_33 ( V_119 ) -> V_123 ] ( V_119 ) ;
F_8 ( & V_6 -> V_128 ) ;
return V_7 ;
}
...
if ( F_20 ( & V_6 -> V_128 ) )
return - V_54 ;
V_7 = V_6 -> V_134 [ F_33 ( V_119 ) -> V_123 ] ( V_119 ) ;
F_8 ( & V_6 -> V_128 ) ;
return V_7 ;
}
...
if ( F_20 ( & V_6 -> V_128 ) )
return - V_54 ;
V_7 = V_6 -> V_135 [ F_33 ( V_119 ) -> V_123 ] ( V_119 ) ;
F_8 ( & V_6 -> V_128 ) ;
return V_7 ;
}
...
F_23 ( & V_2 -> V_31 -> V_32 , L_5 , V_62 ) ;
V_136 [ 0 ] = V_6 -> V_70 >> 8 ;
V_136 [ 1 ] = V_6 -> V_70 & 0xff ;
V_136 [ 2 ] = V_6 -> V_71 >> 8 ;
V_136 [ 3 ] = V_6 -> V_71 & 0xff ;
F_43 ( 100 ) ;
...
memcpy ( V_6 -> V_42 [ 0 ] . V_141 , L_30 , 4 ) ;
V_6 -> V_42 [ 0 ] . V_108 [ 0 ] = V_142 ;
V_6 -> V_42 [ 0 ] . V_108 [ 3 ] = V_143 ;
} else if ( V_47 -> V_123 == 1 ) {
V_6 -> V_42 [ 1 ] . V_139 = V_144 ;
memcpy ( V_6 -> V_42 [ 1 ] . V_141 , L_30 , 4 ) ;
V_6 -> V_42 [ 1 ] . V_108 [ 0 ] = V_143 ;
V_6 -> V_42 [ 1 ] . V_108 [ 1 ] = V_109 ;
if ( V_6 -> V_81 ) {
V_7 = F_42 ( F_46 ( V_47 ) ) ;
if ( V_7 ) {
...
V_47 -> V_119 [ 0 ] = F_47 ( V_145 ,
& V_6 -> V_42 [ V_47 -> V_123 ] , & F_46 ( V_47 ) -> V_146 ) ;
if ( V_47 -> V_119 [ 0 ] ) {
V_6 -> V_129 [ V_47 -> V_123 ] =
V_47 -> V_119 [ 0 ] -> V_147 . V_129 ;
V_47 -> V_119 [ 0 ] -> V_147 . V_129 =
F_35 ;
V_6 -> V_131 [ V_47 -> V_123 ] =
V_47 -> V_119 [ 0 ] -> V_147 . V_131 ;
V_47 -> V_119 [ 0 ] -> V_147 . V_131 =
F_37 ;
V_6 -> V_132 [ V_47 -> V_123 ] = V_47 -> V_119 [ 0 ] -> V_147 . V_132 ;
V_47 -> V_119 [ 0 ] -> V_147 . V_132 = F_38 ;
V_6 -> V_133 [ V_47 -> V_123 ] = V_47 -> V_119 [ 0 ] -> V_147 . V_133 ;
V_47 -> V_119 [ 0 ] -> V_147 . V_133 = F_39 ;
}
return V_47 -> V_119 [ 0 ] == NULL ? - V_110 : 0 ;
}
...
int V_7 ;
F_23 ( & V_2 -> V_31 -> V_32 , L_5 , V_62 ) ;
switch ( V_6 -> V_42 [ V_47 -> V_123 ] . V_111 ) {
case V_95 :
case V_98 :
V_7 = F_47 ( V_148 , V_47 -> V_119 [ 0 ] ,
...
case V_96 :
case V_100 :
V_7 = F_47 ( V_150 , V_47 -> V_119 [ 0 ] ,
& F_46 ( V_47 ) -> V_146 ,
& V_151 ) == NULL ? - V_110 : 0 ;
break;
case V_99 :
V_7 = F_47 ( V_152 , V_47 -> V_119 [ 0 ] , 0xc0 ,
& F_46 ( V_47 ) -> V_146 ,
& V_153 ) == NULL ? - V_110 : 0 ;
break;
case V_101 :
V_7 = F_47 ( V_154 , V_47 -> V_119 [ 0 ] ,
& F_46 ( V_47 ) -> V_146 ,
& V_155 ) == NULL ? - V_110 : 0 ;
break;
case V_103 :
V_7 = F_47 ( V_156 , V_47 -> V_119 [ 0 ] ,
& F_46 ( V_47 ) -> V_146 ,
& V_157 ) == NULL ? - V_110 : 0 ;
break;
case V_104 :
...
break;
case V_94 :
V_7 = F_47 ( V_159 , V_47 -> V_119 [ 0 ] , 0xc0 ,
& F_46 ( V_47 ) -> V_146 ,
V_160 ) == NULL ? - V_110 : 0 ;
break;
case V_107 :
V_7 = F_47 ( V_161 , V_47 -> V_119 [ 0 ] ,
& F_46 ( V_47 ) -> V_146 ,
& V_162 ) == NULL ? - V_110 : 0 ;
break;
case V_106 :
V_7 = F_47 ( V_163 , V_47 -> V_119 [ 0 ] ,
& F_46 ( V_47 ) -> V_146 ,
0xc0 , & V_164 ) == NULL ? - V_110 : 0 ;
break;
case V_97 :
default:
F_6 ( & V_2 -> V_31 -> V_32 , L_34 ,
V_33 ,
V_6 -> V_42 [ V_47 -> V_123 ] . V_111 ) ;
V_7 = - V_110 ;
}
if ( V_47 -> V_119 [ 0 ] -> V_147 . V_165 . V_132 ) {
V_6 -> V_134 [ V_47 -> V_123 ] =
V_47 -> V_119 [ 0 ] -> V_147 . V_165 . V_132 ;
V_47 -> V_119 [ 0 ] -> V_147 . V_165 . V_132 = F_40 ;
}
if ( V_47 -> V_119 [ 0 ] -> V_147 . V_165 . V_133 ) {
V_6 -> V_135 [ V_47 -> V_123 ] =
V_47 -> V_119 [ 0 ] -> V_147 . V_165 . V_133 ;
V_47 -> V_119 [ 0 ] -> V_147 . V_165 . V_133 = F_41 ;
}
return V_7 ;
}
...
struct V_1 * V_2 = F_46 ( V_47 ) ;
int V_7 ;
F_23 ( & V_2 -> V_31 -> V_32 , L_35 , V_62 , V_166 ) ;
if ( V_166 )
...
T_2 V_170 ;
T_1 V_171 ;
F_23 ( & V_2 -> V_31 -> V_32 , L_37 , V_62 , V_2 -> V_31 -> V_82 ) ;
if ( V_2 -> V_31 -> V_82 == V_83 ) {
V_170 = V_127 / 4 ;
V_171 = V_172 / 4 ;
} else {
...
static char * F_54 ( unsigned int V_123 ,
const struct V_175 * V_176 )
{
for (; V_176 -> V_177 ; V_176 ++ )
if ( V_176 -> V_123 == V_123 )
return V_176 -> V_177 ;
return NULL ;
}
...
V_6 -> V_181 = V_12 [ 12 ] << 8 | V_12 [ 14 ] ;
} else {
V_6 -> V_181 = V_12 [ 12 ] << 16 |
V_12 [ 13 ] << 8 | V_12 [ 14 ] ;
}
} else {
V_6 -> V_181 = V_12 [ 12 ] << 24 | V_12 [ 13 ] << 16 |
V_12 [ 14 ] << 8 | V_12 [ 15 ] ;
}
F_56 ( V_2 -> V_180 , V_6 -> V_181 , 0 ) ;
} else {
...
static int F_58 ( struct V_1 * V_2 , struct V_183 * V_184 )
{
struct V_5 * V_6 = F_4 ( V_2 ) ;
T_2 V_185 = F_30 ( V_2 -> V_31 -> V_112 . V_113 ) ;
if ( V_6 -> V_79 == V_186 )
return 0 ;
if ( ! V_184 -> V_187 )
V_184 -> V_187 = F_54 ( V_188 ,
V_189 ) ;
if ( ! V_184 -> V_187 )
V_184 -> V_187 = F_54 ( V_6 -> V_75 ,
V_190 ) ;
if ( ! V_184 -> V_187 && V_185 == V_191 ) {
char V_192 [ 10 ] ;
memset ( V_192 , 0 , sizeof( V_192 ) ) ;
F_59 ( V_2 -> V_31 , V_2 -> V_31 -> V_112 . V_193 ,
V_192 , sizeof( V_192 ) ) ;
if ( ! strcmp ( L_44 , V_192 ) ) {
V_184 -> V_187 = F_54 (
V_194 ,
V_189 ) ;
}
...
static int F_60 ( struct V_200 * V_201 ,
const struct V_202 * V_123 )
{
struct V_203 * V_31 = F_61 ( V_201 ) ;
char V_192 [ sizeof( L_45 ) ] ;
memset ( V_192 , 0 , sizeof( V_192 ) ) ;
F_59 ( V_31 , V_31 -> V_112 . V_193 ,
V_192 , sizeof( V_192 ) ) ;
if ( ( F_30 ( V_31 -> V_112 . V_113 ) == V_204 ) &&
( F_30 ( V_31 -> V_112 . V_115 ) == 0x0099 ) ) {
if ( ! strcmp ( L_45 , V_192 ) ) {
F_23 ( & V_31 -> V_32 , L_46 , V_62 ) ;
return - V_110 ;
}
}
return F_62 ( V_201 , V_123 ) ;
}
