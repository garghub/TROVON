...
static int F_90 ( struct V_19 * V_20 , struct V_120 * V_130 )
{
struct V_82 * V_82 = F_91 ( V_20 -> V_147 ) ;
struct V_30 * V_148 [ V_90 + 1 ] ;
T_1 V_114 = V_20 ? F_88 ( V_20 ) . V_114 : 0 ;
int V_16 = 0 , V_85 = 0 ;
if ( ( V_130 -> V_149 != V_46 ) && ! F_92 ( V_150 ) )
return - V_151 ;
V_16 = F_93 ( V_130 , sizeof( struct V_118 ) , V_148 , V_90 , NULL ) ;
if ( V_16 < 0 )
return V_16 ;
if ( V_148 [ V_127 ] == NULL ) {
F_94 ( L_7 ) ;
...
switch ( V_130 -> V_149 ) {
case V_146 :
if ( V_130 -> V_140 & V_152 )
V_85 = 1 ;
V_153:
V_16 = F_89 ( V_82 , V_148 [ V_127 ] , V_130 , V_114 , V_85 ) ;
if ( V_16 == - V_93 )
goto V_153;
break;
case V_45 :
V_16 = F_85 ( V_82 , V_148 [ V_127 ] , V_130 ,
V_114 , V_45 ) ;
break;
case V_46 :
V_16 = F_85 ( V_82 , V_148 [ V_127 ] , V_130 ,
...
{
struct V_30 * V_154 , * V_155 [ V_90 + 1 ] ;
struct V_30 * V_89 [ V_36 + 1 ] ;
struct V_30 * V_83 [ V_156 + 1 ] ;
struct V_30 * V_40 ;
if ( F_93 ( V_130 , sizeof( struct V_118 ) , V_83 , V_156 , NULL ) < 0 )
return NULL ;
V_154 = V_83 [ V_127 ] ;
if ( V_154 == NULL )
return NULL ;
if ( F_97 ( V_89 , V_36 , F_98 ( V_154 ) ,
F_99 ( F_78 ( V_154 ) ) , NULL ) < 0 )
return NULL ;
if ( V_89 [ 1 ] == NULL )
return NULL ;
if ( F_97 ( V_155 , V_90 , F_98 ( V_89 [ 1 ] ) ,
F_78 ( V_89 [ 1 ] ) , NULL ) < 0 )
return NULL ;
V_40 = V_155 [ V_92 ] ;
return V_40 ;
...
V_22 -> V_121 -> V_149 , sizeof( * V_119 ) , 0 ) ;
if ( ! V_121 )
goto V_137;
V_119 = F_72 ( V_121 ) ;
V_119 -> V_123 = V_124 ;
...
{
F_103 ( V_158 , V_146 , F_90 , NULL , NULL ) ;
F_103 ( V_158 , V_45 , F_90 , NULL , NULL ) ;
F_103 ( V_158 , V_46 , F_90 , F_100 ,
NULL ) ;
return 0 ;
}
