...
static int F_35 ( struct V_8 * V_9 , int V_53 ,
int V_54 )
{
struct V_1 * V_2 = F_6 ( V_9 ) ;
int V_51 = 0 ;
...
V_37 = V_70 -> V_37 ;
V_74 = V_70 -> V_84 . V_87 ;
for ( V_71 = 0 , V_72 = NULL ; V_71 < F_43 ( V_83 ) ; V_71 ++ ) {
V_72 = V_83 [ V_71 ] . V_56 ;
