...
V_19 = F_15 ( sizeof( struct V_11 * ) * V_24 , V_27 ) ;
if ( ! V_19 ) {
V_25 = - V_28 ;
goto V_29;
}
...
int V_13 , V_50 ;
struct V_11 * * V_19 ;
V_2 = F_15 ( sizeof( struct V_1 ) , V_27 ) ;
if ( ! V_2 ) {
V_25 = - V_28 ;
goto V_51;
}
V_2 -> V_45 = V_24 ;
V_19 = F_40 ( V_49 , sizeof( struct V_11 * ) * V_24 , V_27 ) ;
if ( ! V_19 )
goto V_52;
V_2 -> V_19 = V_19 ;
V_2 -> V_9 = V_9 ;
...
V_48 = F_15 ( sizeof( struct V_33 ) * V_50 , V_27 ) ;
if ( ! V_48 )
goto V_57;
if ( ! V_9 -> V_32 ) {
F_2 ( & V_9 -> V_10 , L_12 ,
...
F_38 ( V_2 , & V_48 [ V_9 -> V_32 ] ) ;
}
V_25 = F_41 ( V_9 , V_48 , V_50 ) ;
F_22 ( V_48 ) ;
if ( V_25 )
goto V_57;
V_56:
...
struct V_18 T_2 * F_43 ( const char * V_59 ,
int V_60 ,
struct V_11 * V_12 ,
void * V_61 , int V_62 )
{
...
if ( ! V_12 )
return F_42 ( - V_30 ) ;
return F_44 ( V_59 , V_60 , V_49 , 1 , V_61 ,
V_62 ) ;
}
...
if ( V_9 -> V_64 != - 1 )
F_46 ( & V_9 -> V_10 , L_15 , V_9 -> V_34 , V_9 -> V_64 ) ;
else
F_46 ( & V_9 -> V_10 , L_16 , V_9 -> V_34 ) ;
V_2 = F_18 ( V_9 , V_49 , V_24 ) ;
if ( F_5 ( V_2 ) )
goto V_65;
V_25 = F_47 ( V_9 , V_61 , V_62 ) ;
if ( V_25 )
goto V_66;
V_25 = F_48 ( V_9 ) ;
if ( V_25 )
...
static int F_51 ( struct V_67 * V_10 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
int V_25 ;
V_25 = F_52 ( V_10 ) ;
...
static int F_54 ( struct V_67 * V_10 )
{
return F_55 ( V_10 ) ;
}
static int F_56 ( struct V_67 * V_10 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
F_57 ( V_9 ) ;
return F_58 ( V_10 ) ;
}
static int F_59 ( struct V_67 * V_10 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
...
static int F_62 ( struct V_67 * V_10 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
struct V_1 * V_2 = F_26 ( V_9 ) ;
if ( ( V_2 -> V_46 & V_70 ) &&
...
int F_65 ( struct V_18 * V_9 , const char * V_34 )
{
struct V_1 * V_2 = F_26 ( V_9 ) ;
int V_25 = 0 ;
int V_13 ;
for ( V_13 = 0 ; V_13 < V_2 -> V_45 ; V_13 ++ ) {
V_25 = F_66 ( V_2 -> V_19 [ V_13 ] , V_34 ) ;
if ( V_25 )
break;
}
return V_25 ;
}
int F_67 ( struct V_18 * V_9 ,
const char * V_34 )
{
struct V_1 * V_2 = F_26 ( V_9 ) ;
int V_25 = 0 ;
int V_13 ;
for ( V_13 = 0 ; V_13 < V_2 -> V_45 ; V_13 ++ ) {
V_25 = F_68 ( V_2 -> V_19 [ V_13 ] , V_34 ) ;
if ( V_25 )
break;
}
return V_25 ;
}
struct V_67 * F_69 ( const char * V_23 )
{
struct V_11 * V_12 ;
if ( ! V_23 ) {
F_70 ( 1 , L_20 , V_58 ) ;
...
static int T_2 F_73 ( struct V_67 * V_10 , void * V_76 )
{
struct V_18 * V_9 = F_24 ( V_10 ) ;
struct V_1 * V_2 = F_26 ( V_9 ) ;
if ( ! V_2 )
