...
if ( ! ( T_1 ) V_65 . V_39 ) {
F_6 ( L_25 ,
V_3 -> V_28 , V_65 . V_82 , V_65 . V_39 ) ;
F_25 ( & V_65 ) ;
return V_83 ;
}
V_80 = F_26 ( ( T_1 ) V_65 . V_39 , V_69 ) ;
if ( V_80 > V_67 ) {
F_6 ( L_26
L_27 , V_3 -> V_28 ,
V_68 , V_66 , V_67 ) ;
...
V_81 = F_27 ( V_63 ) + V_66 ;
if ( V_60 == V_77 )
memcpy ( V_65 . V_82 , V_81 , V_80 ) ;
else
memcpy ( V_81 , V_65 . V_82 , V_80 ) ;
V_67 -= V_80 ;
if ( ! V_67 )
continue;
V_69 -= V_80 ;
...
const char * V_21 , T_4 V_85 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
char * V_86 , * V_87 , * V_88 ;
T_5 args [ V_89 ] ;
int V_41 = 0 , V_90 , V_91 ;
V_88 = F_29 ( V_21 , V_8 ) ;
if ( ! V_88 )
return - V_9 ;
V_86 = V_88 ;
while ( ( V_87 = F_30 ( & V_88 , L_28 ) ) != NULL ) {
if ( ! * V_87 )
continue;
V_91 = F_31 ( V_87 , V_92 , args ) ;
switch ( V_91 ) {
case V_93 :
F_32 ( args , & V_90 ) ;
V_1 -> V_35 = V_90 ;
...
F_8 ( V_86 ) ;
return ( ! V_41 ) ? V_85 : V_41 ;
}
static T_4 F_33 ( struct V_2 * V_3 , char * V_95 )
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
T_4 V_96 = sprintf ( V_95 , L_32 ,
V_1 -> V_28 ) ;
V_96 += sprintf ( V_95 + V_96 , L_33
L_34 , V_1 -> V_35 ,
V_29 , V_1 -> V_26 ,
! ! ( V_1 -> V_42 & V_71 ) ) ;
return V_96 ;
...
{
struct V_1 * V_1 = F_1 ( V_3 ) ;
unsigned long long V_97 = ( ( V_1 -> V_35 * V_29 ) /
V_3 -> V_45 . V_74 ) - 1 ;
return V_97 ;
}
static T_2
