...
if ( V_43 -> V_44 != F_22 () )
return - V_28 ;
V_2 -> V_13 . V_44 = V_43 -> V_44 ;
F_26 ( V_2 -> V_13 . V_45 , V_46 ) ;
for ( V_30 = 0 ; V_30 < sizeof( V_43 -> V_45 ) * 8 ; V_30 ++ ) {
if ( F_27 ( V_30 , ( void * ) V_43 -> V_45 ) ) {
if ( V_30 >= V_46 )
return - V_15 ;
F_28 ( V_30 , V_2 -> V_13 . V_45 ) ;
}
}
return F_29 ( V_2 ) ;
}
...
int F_31 ( struct V_1 * V_2 , struct V_47 * V_48 )
{
return - V_28 ;
}
