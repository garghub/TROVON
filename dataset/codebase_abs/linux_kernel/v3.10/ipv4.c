...
static void F_76 ( struct V_1 * V_2 , struct V_76 * V_148 )
{
int V_20 ;
const struct V_63 * V_149 ;
struct V_76 * V_77 ;
struct V_66 * V_56 ;
struct V_88 * V_88 = F_28 ( F_77 ( V_148 ) -> V_89 ) ;
struct V_1 * V_150 = V_88 -> V_151 . V_152 ;
if ( V_84 ( V_148 ) -> V_153 == V_154 )
return;
if ( F_78 ( V_148 ) -> V_155 != V_156 )
return;
V_56 = F_66 ( V_88 , V_150 , V_148 ) ;
if ( V_56 == NULL )
return;
V_77 = F_79 ( V_150 , V_148 ) ;
if ( V_77 == NULL )
goto V_60;
V_149 = F_52 ( V_148 ) ;
V_84 ( V_77 ) -> V_125 = F_47 ( V_77 , V_149 -> V_47 ,
V_149 -> V_14 ) ;
F_80 ( V_77 , F_81 ( V_56 ) ) ;
F_35 ( V_150 ) ;
V_20 = F_74 ( V_77 , V_150 ,
...
struct V_113 * V_114 ;
struct V_160 * V_161 ;
const T_2 V_162 = F_87 ( V_77 ) -> V_163 ;
struct V_164 * V_165 = F_88 ( V_77 ) ;
...
V_161 -> V_116 = F_51 ( V_77 ) ;
V_161 -> V_117 = V_161 -> V_116 ;
V_161 -> V_175 = V_162 ;
if ( F_71 ( V_2 , V_114 ) )
goto V_171;
F_96 ( V_2 , V_114 , V_176 ) ;
return 0 ;
V_171:
F_97 ( V_114 ) ;
V_168:
...
if ( V_85 -> V_184 < F_106 ( V_77 ) / sizeof( T_3 ) ) {
F_105 ( L_3 , V_85 -> V_184 ) ;
return 1 ;
}
if ( ! F_104 ( V_77 , V_85 -> V_184 * sizeof( T_3 ) ) ) {
F_105 ( L_4 , V_85 -> V_184 ) ;
return 1 ;
}
if ( ( V_85 -> V_153 < V_185 ||
...
V_77 -> V_124 = F_109 ( V_77 , 0 , V_180 , 0 ) ;
return 0 ;
}
...
V_85 = V_84 ( V_77 ) ;
F_88 ( V_77 ) -> V_173 = F_37 ( V_85 ) ;
F_88 ( V_77 ) -> V_191 = V_85 -> V_153 ;
F_111 ( L_8 ,
F_107 ( V_85 -> V_153 ) ,
& V_64 -> V_47 , F_112 ( V_85 -> V_94 ) ,
& V_64 -> V_14 , F_112 ( V_85 -> V_93 ) ,
( unsigned long long ) F_88 ( V_77 ) -> V_173 ) ;
if ( F_113 ( V_77 ) ) {
F_88 ( V_77 ) -> V_192 = V_193 ;
F_114 ( L_9 ) ;
} else {
F_88 ( V_77 ) -> V_192 = F_115 ( V_77 ) ;
...
if ( ! F_117 ( V_2 , V_197 , V_77 ) )
goto V_196;
F_118 ( V_77 ) ;
return F_119 ( V_2 , V_77 , 1 ) ;
V_194:
if ( ! F_117 ( NULL , V_197 , V_77 ) )
goto V_190;
if ( V_85 -> V_153 != V_154 ) {
F_88 ( V_77 ) -> V_166 =
V_198 ;
...
if ( V_92 . V_202 == NULL )
return - V_203 ;
return F_124 ( & V_88 -> V_151 . V_152 , V_204 ,
V_205 , V_42 , V_88 ) ;
}
static void T_10 F_125 ( struct V_88 * V_88 )
{
F_126 ( V_88 -> V_151 . V_152 ) ;
}
static int T_11 F_127 ( void )
{
int V_20 = F_128 ( & V_206 , 1 ) ;
if ( V_20 != 0 )
goto V_60;
V_20 = F_129 ( & V_207 , V_42 ) ;
if ( V_20 != 0 )
goto V_208;
F_130 ( & V_209 ) ;
V_20 = F_131 ( & V_210 ) ;
