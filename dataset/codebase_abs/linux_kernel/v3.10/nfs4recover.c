...
static int
F_36 ( T_3 * V_70 , struct V_43 * V_44 )
{
const struct V_1 * V_37 ;
...
if ( V_22 < 0 )
return V_22 ;
V_22 = F_38 ( V_44 -> V_48 , 0 , V_71 ) ;
if ( V_22 < 0 ) {
F_5 ( V_37 ) ;
return V_22 ;
}
V_22 = F_39 ( V_44 -> V_48 , F_34 , & V_66 ) ;
F_40 ( & V_40 -> V_51 -> V_52 , V_72 ) ;
while ( ! F_41 ( & V_66 ) ) {
struct V_67 * V_68 ;
...
static int
F_51 ( struct V_39 * V_75 , struct V_39 * V_76 , struct V_43 * V_44 )
{
int V_22 ;
if ( F_52 ( V_76 -> V_77 . V_60 , V_44 ) )
return 0 ;
...
static void
F_53 ( struct V_43 * V_44 , T_4 V_78 )
{
int V_22 ;
V_44 -> V_56 = false ;
if ( ! V_44 -> V_48 )
...
if ( V_22 )
F_20 ( L_15
L_16 , V_44 -> V_48 -> V_50 . V_39 -> V_77 . V_60 ) ;
}
static int
F_55 ( struct V_39 * V_75 , struct V_39 * V_76 , struct V_43 * V_44 )
{
if ( V_76 -> V_77 . V_23 != V_38 - 1 ) {
F_20 ( L_17 ,
V_76 -> V_77 . V_60 ) ;
return 0 ;
}
F_31 ( V_76 -> V_77 . V_60 , V_44 ) ;
return 0 ;
}
static int
...
V_44 -> V_48 = F_59 ( V_58 , V_79 | V_80 , 0 ) ;
if ( F_11 ( V_44 -> V_48 ) ) {
F_20 ( L_22 ,
V_58 ) ;
V_22 = F_12 ( V_44 -> V_48 ) ;
...
struct V_43 * V_44 = F_23 ( V_36 , V_45 ) ;
int V_12 ;
V_44 -> V_81 = F_14 ( sizeof( struct V_65 ) *
V_82 , V_30 ) ;
if ( ! V_44 -> V_81 )
return - V_4 ;
...
T_8 V_110 ;
struct V_43 * V_44 = F_23 ( V_104 -> V_111 -> V_112 -> V_113 ,
V_45 ) ;
...
{
struct V_39 * V_40 , * V_39 ;
V_40 = F_92 ( V_124 , V_125 ) ;
if ( V_40 == NULL )
return F_93 ( - V_35 ) ;
V_39 = F_94 ( V_40 , V_126 , NULL , V_93 ) ;
F_29 ( V_40 ) ;
return V_39 ;
}
static void
...
static struct V_39 *
F_97 ( struct V_36 * V_36 , struct V_92 * V_93 )
{
struct V_123 * V_124 ;
struct V_39 * V_39 ;
V_124 = F_98 ( V_36 ) ;
if ( ! V_124 )
return NULL ;
V_39 = F_91 ( V_124 , V_93 ) ;
F_99 ( V_36 ) ;
return V_39 ;
}
static void
F_100 ( struct V_36 * V_36 , struct V_92 * V_93 )
{
struct V_123 * V_124 ;
V_124 = F_98 ( V_36 ) ;
if ( V_124 ) {
...
F_104 ( & V_115 -> V_119 ) ;
F_61 ( & V_115 -> V_130 ) ;
V_39 = F_97 ( V_36 , V_115 -> V_127 ) ;
if ( F_11 ( V_39 ) ) {
V_96 = F_12 ( V_39 ) ;
goto V_131;
}
V_115 -> V_127 -> V_39 = V_39 ;
V_44 -> V_114 = V_115 ;
return 0 ;
V_131:
F_105 ( V_115 -> V_127 ) ;
...
V_109 -> V_120 . V_142 . V_143 . V_144 = V_33 -> V_49 . V_23 ;
memcpy ( V_109 -> V_120 . V_142 . V_143 . V_145 , V_33 -> V_49 . V_24 ,
V_33 -> V_49 . V_23 ) ;
...
static void
F_113 ( struct V_43 * V_44 , T_4 V_78 )
{
int V_96 ;
struct V_107 * V_109 ;
struct V_114 * V_115 = V_44 -> V_114 ;
...
{
char * V_167 ;
V_167 = F_119 ( V_33 -> V_49 . V_24 , V_33 -> V_49 . V_23 ) ;
if ( ! V_167 ) {
F_9 ( L_49 , V_116 ) ;
return;
}
...
goto V_169;
V_44 -> V_168 = & V_170 ;
V_22 = V_44 -> V_168 -> V_171 ( V_36 ) ;
if ( ! V_22 )
return V_22 ;
V_44 -> V_168 = & V_172 ;
V_22 = F_70 ( F_73 () , V_89 , & V_88 ) ;
if ( ! V_22 ) {
V_22 = F_71 ( V_88 . V_39 -> V_51 -> V_91 ) ;
F_72 ( & V_88 ) ;
if ( V_22 )
goto V_169;
}
...
struct V_43 * V_44 = F_23 ( V_33 -> V_36 , V_45 ) ;
if ( V_44 -> V_168 )
return V_44 -> V_168 -> V_176 ( V_33 ) ;
return - V_177 ;
}
void
F_127 ( struct V_43 * V_44 , T_4 V_78 )
{
if ( V_44 -> V_168 )
V_44 -> V_168 -> V_178 ( V_44 , V_78 ) ;
}
static int
F_128 ( struct V_179 * V_180 , unsigned long V_181 , void * V_182 )
{
struct V_123 * V_124 = V_182 ;
struct V_36 * V_36 = V_124 -> V_113 ;
struct V_43 * V_44 = F_23 ( V_36 , V_45 ) ;
struct V_114 * V_115 = V_44 -> V_114 ;
struct V_39 * V_39 ;
int V_96 = 0 ;
