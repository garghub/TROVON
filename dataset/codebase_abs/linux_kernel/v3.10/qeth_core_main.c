...
int F_312 ( struct V_225 * V_226 , struct V_584 * * V_132 , int V_154 )
{
...
V_63 ;
F_54 ( & V_110 -> V_52 , V_446 ) ;
F_315 ( V_110 , V_74 , V_226 , V_132 , V_175 , V_596 ) ;
F_289 ( V_110 , V_160 , 1 ) ;
return 0 ;
V_68:
F_54 ( & V_110 -> V_52 , V_446 ) ;
...
struct V_619 * F_324 ( struct V_612 * V_6 )
{
struct V_3 * V_4 ;
V_4 = V_6 -> V_617 ;
F_3 ( V_4 , 5 , L_259 ) ;
...
int F_329 ( struct V_3 * V_4 , int V_630 )
{
int V_34 = 0 ;
F_3 ( V_4 , 4 , L_283 ) ;
...
int F_332 ( struct V_612 * V_6 , int V_647 , int V_648 )
{
...
V_687 = ( V_688 ) V_154 ;
memcpy ( F_334 ( V_112 -> V_116 ) , & V_686 , 2 ) ;
memcpy ( F_335 ( V_112 -> V_116 ) , & V_687 , 2 ) ;
...
( char * ) V_693 ,
V_582 + F_339 ( struct V_692 , V_116 ) ) ;
V_691 -> V_696 += F_339 ( struct V_692 , V_116 ) ;
} else {
memcpy ( V_691 -> V_698 + V_691 -> V_696 ,
...
int F_340 ( struct V_3 * V_4 , char T_4 * V_698 )
{
struct V_111 * V_112 ;
struct V_128 * V_129 ;
struct V_699 * V_700 ;
...
if ( F_341 ( & V_701 , V_698 + sizeof( int ) , sizeof( int ) ) )
return - V_703 ;
V_700 = F_342 ( V_698 , V_701 + sizeof( struct V_704 ) ) ;
if ( F_109 ( V_700 ) ) {
F_3 ( V_4 , 2 , L_296 ) ;
return F_110 ( V_700 ) ;
}
...
V_112 = F_267 ( V_4 , V_702 ,
V_705 + V_701 ) ;
V_129 = (struct V_128 * ) ( V_112 -> V_116 + V_387 ) ;
memcpy ( & V_129 -> V_116 . V_462 . V_116 . V_693 , & V_700 -> V_129 , V_701 ) ;
V_34 = F_333 ( V_4 , V_112 , V_706 + V_701 ,
F_338 , ( void * ) & V_691 ) ;
if ( V_34 )
F_62 ( 2 , L_297 ,
F_75 ( V_4 ) , V_34 ) ;
else {
if ( F_343 ( V_698 , V_691 . V_698 , V_691 . V_695 ) )
V_34 = - V_703 ;
}
F_31 ( V_700 ) ;
F_31 ( V_691 . V_698 ) ;
...
int F_345 ( struct V_3 * V_4 , char T_4 * V_698 )
{
int V_34 = 0 ;
struct V_111 * V_112 ;
struct V_128 * V_129 ;
...
if ( ! V_34 ) {
if ( F_346 () )
V_38 = F_347 ( V_717 . V_40 ) ;
else
V_38 = ( void T_4 * ) ( unsigned long ) V_717 . V_40 ;
if ( F_343 ( V_38 , V_708 . V_74 ,
V_708 . V_712 ) ) {
V_34 = - V_703 ;
goto V_720;
}
V_717 . V_712 = V_708 . V_712 ;
if ( F_343 ( V_698 , & V_717 ,
sizeof( struct V_716 ) ) )
V_34 = - V_703 ;
} else
if ( V_34 == V_713 )
...
F_354 [ V_41 ] = V_4 -> V_281 -> V_742 ;
F_353 ( V_4 , V_733 , F_354 ) ;
V_737 =
...
static inline int F_363 ( struct V_439 * V_760 ,
struct V_761 * V_238 ,
...
* V_762 = F_255 ( V_440 + V_441 ) ;
if ( ! ( * V_762 ) )
return - V_47 ;
}
F_364 ( * V_762 , V_441 ) ;
if ( V_582 <= V_440 ) {
memcpy ( F_365 ( * V_762 , V_582 ) , V_238 -> V_243 + V_175 ,
V_582 ) ;
} else {
F_366 ( V_435 ) ;
memcpy ( F_365 ( * V_762 , V_440 ) ,
V_238 -> V_243 + V_175 , V_440 ) ;
F_367 ( * V_762 , * V_763 , V_435 ,
V_175 + V_440 ,
V_582 - V_440 ) ;
...
F_366 ( V_435 ) ;
F_367 ( * V_762 , * V_763 , V_435 , V_175 , V_582 ) ;
( * V_762 ) -> V_582 += V_582 ;
( * V_762 ) -> V_154 += V_582 ;
( * V_762 ) -> V_764 += V_582 ;
( * V_763 ) ++ ;
...
while ( V_767 ) {
V_582 = F_370 ( V_767 , ( int ) ( V_238 -> V_246 - V_175 ) ) ;
if ( V_582 ) {
if ( V_770 ) {
if ( F_363 ( V_760 , V_238 ,
& V_226 , V_175 , & V_575 , V_582 ) )
goto V_778;
} else {
memcpy ( F_365 ( V_226 , V_582 ) , V_768 ,
V_582 ) ;
}
}
V_767 -= V_582 ;
...
V_4 -> V_437 . V_779 ++ ;
V_4 -> V_437 . V_780 += F_306 ( V_226 ) -> V_576 ;
}
return V_226 ;
V_778:
if ( F_372 () ) {
...
goto V_896;
V_830 = F_422 ( L_332 ) ;
V_34 = F_109 ( V_830 ) ? F_110 ( V_830 ) : 0 ;
if ( V_34 )
goto V_897;
V_245 = F_423 ( L_333 ,
