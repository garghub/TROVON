...
static unsigned char F_26 ( struct V_6 * V_7 )
{
struct V_1 * V_2 = F_6 ( V_7 ) ;
char V_33 , V_34 ;
V_2 -> V_22 = F_8 ( V_2 ) ;
...
static T_2 F_29 ( const struct V_6 * V_7 )
{
...
int V_47 ;
int V_38 ;
F_16 ( & V_7 -> V_19 -> V_7 , V_48 , F_31 ( V_41 ) ) ;
V_38 = F_32 ( V_7 ) ;
...
static int F_35 ( struct V_6 * V_7 , unsigned char * V_56 ,
unsigned long V_57 )
{
struct V_1 * V_2 = F_6 ( V_7 ) ;
T_1 * V_45 = ( T_1 * ) V_56 ;
...
struct V_6 * F_50 ( struct V_74 * V_19 )
{
struct V_6 * V_7 ;
V_7 = F_51 ( sizeof( struct V_6 ) +
sizeof( struct V_1 ) , V_75 ) ;
if ( ! V_7 )
return NULL ;
F_52 ( V_7 ) ;
V_7 -> V_76 = & V_77 ;
