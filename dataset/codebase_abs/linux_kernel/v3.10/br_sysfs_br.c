...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_2 , V_6 -> V_63 ) ;
}
static T_1 F_94 ( struct V_1 * V_2 ,
struct V_15 * V_16 ,
const char * V_3 , T_2 V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_64 ) ;
}
static T_1 F_95 ( struct V_65 * V_66 , struct V_67 * V_68 ,
struct V_69 * V_70 ,
char * V_3 , T_4 V_71 , T_2 V_72 )
{
struct V_1 * V_10 = F_96 ( V_68 ) ;
struct V_5 * V_6 = F_3 ( V_10 ) ;
int V_73 ;
if ( V_71 % sizeof( struct V_74 ) != 0 )
return - V_14 ;
V_73 = F_97 ( V_6 , V_3 ,
...
int F_98 ( struct V_75 * V_10 )
{
struct V_67 * V_76 = & V_10 -> V_10 . V_68 ;
struct V_5 * V_6 = F_99 ( V_10 ) ;
int V_9 ;
V_9 = F_100 ( V_76 , & V_77 ) ;
if ( V_9 ) {
F_101 ( L_8 ,
V_78 , V_10 -> V_79 , V_77 . V_79 ) ;
goto V_80;
}
V_9 = F_102 ( V_76 , & V_81 ) ;
if ( V_9 ) {
F_101 ( L_9 ,
V_78 , V_10 -> V_79 , V_81 . V_16 . V_79 ) ;
goto V_82;
}
V_6 -> V_83 = F_103 ( V_84 , V_76 ) ;
if ( ! V_6 -> V_83 ) {
F_101 ( L_10 ,
V_78 , V_10 -> V_79 , V_84 ) ;
goto V_85;
...
return 0 ;
V_85:
F_104 ( & V_10 -> V_10 . V_68 , & V_81 ) ;
V_82:
F_105 ( & V_10 -> V_10 . V_68 , & V_77 ) ;
V_80:
return V_9 ;
}
void F_106 ( struct V_75 * V_10 )
{
struct V_67 * V_68 = & V_10 -> V_10 . V_68 ;
struct V_5 * V_6 = F_99 ( V_10 ) ;
F_107 ( V_6 -> V_83 ) ;
F_104 ( V_68 , & V_81 ) ;
F_105 ( V_68 , & V_77 ) ;
