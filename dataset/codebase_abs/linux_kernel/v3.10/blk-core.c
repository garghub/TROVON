...
unsigned V_276 = F_273 ( V_35 -> V_43 , V_270 ) ;
if ( V_276 == V_35 -> V_43 )
V_178 -> V_35 = V_35 -> V_192 ;
F_21 ( V_178 , V_35 , V_276 , error ) ;
V_271 += V_276 ;
V_270 -= V_276 ;
if ( ! V_270 )
break;
...
F_150 ( F_165 ( V_178 ) ) ;
if ( F_24 ( V_278 ) && V_178 -> V_49 == V_201 )
...
unsigned int V_270 , unsigned int V_277 )
{
struct V_11 * V_12 = V_2 -> V_12 ;
unsigned long V_63 ;
if ( F_275 ( V_2 , error , V_270 , V_277 ) )
return true ;
F_58 ( V_12 -> V_56 , V_63 ) ;
F_279 ( V_2 , error ) ;
F_59 ( V_12 -> V_56 , V_63 ) ;
...
if ( F_24 ( F_268 ( V_2 ) ) )
V_277 = F_32 ( V_2 -> V_269 ) ;
V_279 = F_281 ( V_2 , error , F_32 ( V_2 ) , V_277 ) ;
F_150 ( V_279 ) ;
}
...
if ( F_24 ( F_268 ( V_2 ) ) )
V_277 = F_32 ( V_2 -> V_269 ) ;
V_279 = F_282 ( V_2 , error , F_32 ( V_2 ) , V_277 ) ;
F_150 ( V_279 ) ;
}
...
static void F_297 ( struct V_1 * V_287 , struct V_1 * V_288 )
{
V_287 -> V_7 = V_288 -> V_7 ;
V_287 -> V_40 = ( V_288 -> V_40 & V_289 ) | V_290 ;
V_287 -> V_49 = V_288 -> V_49 ;
V_287 -> V_23 = F_7 ( V_288 ) ;
V_287 -> V_187 = F_32 ( V_288 ) ;
V_287 -> V_189 = V_288 -> V_189 ;
V_287 -> V_193 = V_288 -> V_193 ;
V_287 -> V_291 = V_288 -> V_291 ;
}
int F_298 ( struct V_1 * V_2 , struct V_1 * V_292 ,
struct V_293 * V_294 , T_2 V_87 ,
int (* F_299)( struct V_35 * , struct V_35 * , void * ) ,
void * V_295 )
{
struct V_35 * V_35 , * V_296 ;
if ( ! V_294 )
V_294 = V_297 ;
F_16 ( NULL , V_2 ) ;
F_300 (bio_src, rq_src) {
V_35 = F_301 ( V_296 , V_87 , V_294 ) ;
if ( ! V_35 )
goto V_298;
if ( F_299 && F_299 ( V_35 , V_296 , V_295 ) )
goto V_298;
if ( V_2 -> V_35 ) {
V_2 -> V_50 -> V_192 = V_35 ;
V_2 -> V_50 = V_35 ;
...
struct V_299 * V_300 , unsigned long V_301 )
{
return F_41 ( V_58 , V_300 , V_301 ) ;
}
void F_305 ( struct V_196 * V_197 )
{
struct V_302 * V_303 = V_146 ;
V_197 -> V_304 = V_305 ;
F_17 ( & V_197 -> V_213 ) ;
F_17 ( & V_197 -> V_306 ) ;
if ( ! V_303 -> V_197 ) {
...
static int F_306 ( void * V_307 , struct V_308 * V_309 , struct V_308 * V_221 )
{
struct V_1 * V_310 = F_34 ( V_309 , struct V_1 , V_21 ) ;
struct V_1 * V_311 = F_34 ( V_221 , struct V_1 , V_21 ) ;
return ! ( V_310 -> V_12 < V_311 -> V_12 ||
( V_310 -> V_12 == V_311 -> V_12 && F_7 ( V_310 ) < F_7 ( V_311 ) ) ) ;
}
static void F_307 ( struct V_11 * V_12 , unsigned int V_312 ,
bool V_313 )
__releases( V_12 -> V_56 )
{
F_308 ( V_12 , V_312 , ! V_313 ) ;
if ( V_313 )
F_55 ( V_12 ) ;
else
F_36 ( V_12 ) ;
...
static void F_310 ( struct V_196 * V_197 , bool V_313 )
{
F_311 ( V_314 ) ;
while ( ! F_66 ( & V_197 -> V_306 ) ) {
F_312 ( & V_197 -> V_306 , & V_314 ) ;
while ( ! F_66 ( & V_314 ) ) {
struct V_315 * V_316 = F_313 ( & V_314 ,
struct V_315 ,
V_213 ) ;
F_314 ( & V_316 -> V_213 ) ;
V_316 -> V_317 ( V_316 , V_313 ) ;
}
}
}
struct V_315 * F_315 ( T_6 V_318 , void * V_295 ,
int V_319 )
{
...
if ( V_316 -> V_317 == V_318 && V_316 -> V_295 == V_295 )
return V_316 ;
F_150 ( V_319 < sizeof( * V_316 ) ) ;
V_316 = F_317 ( V_319 , V_241 ) ;
if ( V_316 ) {
V_316 -> V_295 = V_295 ;
V_316 -> V_317 = V_318 ;
F_318 ( & V_316 -> V_213 , & V_197 -> V_306 ) ;
}
return V_316 ;
}
void F_205 ( struct V_196 * V_197 , bool V_313 )
{
struct V_11 * V_12 ;
unsigned long V_63 ;
struct V_1 * V_2 ;
...
F_320 ( V_63 ) ;
while ( ! F_66 ( & V_213 ) ) {
V_2 = F_321 ( V_213 . V_320 ) ;
F_264 ( & V_2 -> V_21 ) ;
F_150 ( ! V_2 -> V_12 ) ;
if ( V_2 -> V_12 != V_12 ) {
if ( V_12 )
F_307 ( V_12 , V_312 , V_313 ) ;
V_12 = V_2 -> V_12 ;
V_312 = 0 ;
F_322 ( V_12 -> V_56 ) ;
}
...
void F_325 ( struct V_11 * V_12 , struct V_322 * V_163 )
{
V_12 -> V_163 = V_163 ;
V_12 -> V_257 = V_259 ;
F_326 ( V_12 -> V_163 , - 1 ) ;
...
F_336 ( L_29 ) ;
V_96 = F_337 ( L_30 ,
sizeof( struct V_1 ) , 0 , V_329 , NULL ) ;
V_102 = F_337 ( L_31 ,
sizeof( struct V_11 ) , 0 , V_329 , NULL ) ;
return 0 ;
}
