...
if ( ! F_18 ( V_43 -> V_87 , V_88 ) ) {
F_7 ( & V_43 -> V_36 , L_12 ) ;
return - V_89 ;
}
V_31 = F_19 ( & V_43 -> V_36 , sizeof( struct V_30 ) ,
V_90 ) ;
if ( V_31 == NULL )
return - V_91 ;
V_31 -> V_4 = V_8 -> V_4 ;
...
V_76 = F_24 ( & V_43 -> V_36 , & V_31 -> V_35 ) ;
if ( V_76 < 0 ) {
F_7 ( & V_43 -> V_36 , L_15 , V_76 ) ;
return V_76 ;
}
V_76 = F_25 ( V_31 -> V_35 . V_36 , & V_97 ) ;
if ( V_76 < 0 ) {
...
{
struct V_30 * V_31 = F_28 ( V_43 ) ;
F_29 ( V_31 -> V_35 . V_36 , & V_97 ) ;
F_8 ( V_31 ) ;
F_26 ( & V_31 -> V_35 ) ;
return 0 ;
}
