...
if( V_9 < 0 ) {
F_3 ( V_2 , V_27 , V_31 , V_29 , L_2 , V_30 , __LINE__ ) ;
return V_9 ;
}
}
switch( V_2 -> V_12 )
...
case V_38 :
V_4 = V_39 ;
V_5 = sizeof( V_39 ) / sizeof( struct V_3 ) ;
if( V_2 -> V_19 == V_20 )
{
V_8 = 0x03F137D2 ;
}
...
case 0xbece0130 :
case 0xbece0300 :
F_3 ( V_2 , V_40 , V_41 , V_29 , L_3 , V_2 -> V_12 ) ;
switch ( V_2 -> V_12 )
{
case V_13 :
V_4 = V_42 ;
...
V_6 = 0 ;
F_3 ( V_2 , V_40 , V_41 , V_29 , L_4 , V_5 ) ;
while( V_5 && ! V_9 )
{
if( V_8 && V_4 -> V_48 == V_49 )
{
V_6 = V_8 ;
}
else
...
V_9 = F_4 ( V_2 , V_4 -> V_48 , & V_6 , sizeof( V_6 ) ) ;
if( V_10 != V_9 ) {
F_3 ( V_2 , V_51 , 0 , 0 , L_5 , V_30 , __LINE__ ) ;
break;
}
V_5 -- ;
V_4 ++ ;
...
V_9 = F_2 ( V_2 , ( T_2 ) 0x0f000c00 , & V_7 , sizeof( V_7 ) ) ;
if( V_9 < 0 ) {
F_3 ( V_2 , V_51 , V_28 , V_29 , L_1 , V_30 , __LINE__ ) ;
return V_9 ;
}
V_9 = F_2 ( V_2 , ( T_2 ) 0x0f000c00 , & V_7 , sizeof( V_7 ) ) ;
if( V_9 < 0 ) {
...
V_6 = V_5 ;
V_9 = F_4 ( V_2 , V_56 , & V_6 , sizeof( V_6 ) ) ;
if( V_9 )
{
F_3 ( V_2 , V_51 , 0 , 0 , L_5 , V_30 , __LINE__ ) ;
return V_9 ;
...
if( ! V_9 )
{
if( V_58 && ( V_4 -> V_48 == 0x0F007018 ) )
{
V_6 = ( V_4 -> V_50 | ( 1 << 8 ) ) ;
if( V_10 != F_4 ( V_2 , V_56 ,
& V_6 , sizeof( V_6 ) ) ) {
F_3 ( V_2 , V_51 , 0 , 0 , L_5 , V_30 , __LINE__ ) ;
break;
}
