...
if ( V_11 -> V_19 != & V_35 )
return 0 ;
V_3 = F_10 ( F_11 ( V_11 ) ) -> V_36 ;
if ( V_3 -> V_37 & V_38 )
return 0 ;
return V_34 + 1 ;
}
static struct V_2 * F_12 ( int * V_34 )
{
struct V_11 * V_11 ;
int V_39 = F_13 ( V_40 -> V_41 , * V_34 , F_9 , NULL ) ;
if ( ! V_39 )
return NULL ;
* V_34 = V_39 - 1 ;
V_11 = F_14 ( * V_34 ) ;
return F_10 ( F_11 ( V_11 ) ) -> V_36 ;
}
int F_15 ( void )
{
struct V_2 * V_3 ;
...
V_28 = V_9 [ V_27 ] . V_5 ;
sprintf ( V_31 , L_2 , V_26 , V_30 ) ;
V_45 . V_48 = strlen ( V_31 ) + 1 ;
V_45 . V_49 = V_28 ;
V_45 . V_50 = V_51 ;
V_24 = F_3 ( V_11 , & V_45 , sizeof( V_45 ) , V_14 ) ;
if ( V_24 )
goto V_52;
V_24 = F_3 ( V_11 , V_31 , V_45 . V_48 , V_14 ) ;
if ( V_24 )
goto V_52;
...
goto V_52;
do {
V_43 = F_1 ( V_27 , V_3 , V_22 , V_44 , & V_42 ) ;
if ( V_43 > 0 ) {
V_24 = F_3 ( V_11 , V_22 , V_43 , V_14 ) ;
if ( V_24 )
goto V_52;
V_29 += V_43 ;
}
} while ( V_43 == V_44 && V_29 < V_28 );
if ( V_43 < 0 ) {
V_24 = V_43 ;
goto V_52;
}
...
V_14 ) ;
V_52:
F_20 ( ( unsigned long ) V_22 ) ;
return V_24 ;
}
int F_21 ( struct V_11 * V_11 , T_3 * V_14 )
{
struct V_2 * V_3 ;
int V_34 , V_53 , V_24 ;
V_34 = 0 ;
...
if ( V_24 )
return V_24 ;
for ( V_53 = 0 ; V_9 [ V_53 ] . V_30 != NULL ; V_53 ++ ) {
V_24 = F_18 ( V_3 , V_53 , V_11 , V_34 , V_14 ) ;
if ( V_24 ) {
F_17 ( V_3 ) ;
return V_24 ;
}
