...
static inline int F_52 ( T_2 * V_79 , T_3 V_11 ,
...
V_80 = F_35 ( V_23 ) -> F_56 ( V_23 ) ;
F_57 ( & V_4 ) ;
F_58 (sk, &dgram_head) {
if ( F_52 ( V_23 -> V_85 , V_11 , V_80 ,
F_1 ( V_3 ) ) ) {
if ( V_83 ) {
struct V_39 * V_86 ;
V_86 = F_59 ( V_40 , V_87 ) ;
...
static int F_61 ( struct V_2 * V_3 , int V_88 , int V_89 ,
...
if ( F_21 ( V_17 , V_91 ) )
return - V_94 ;
if ( F_64 ( V_90 , & V_92 , V_17 ) )
return - V_94 ;
return 0 ;
}
static int F_65 ( struct V_2 * V_3 , int V_88 , int V_89 ,
