...
#ifdef F_57
if ( F_58 ( V_12 -> V_13 . V_82 , L_11 , NULL ) == NULL )
V_78 = - 1 ;
#endif
}
V_2 -> V_12 = V_12 ;
...
V_6 = V_101 -> V_106 ( V_12 , V_2 -> V_8 . V_36 ,
V_2 -> V_8 . V_9 , V_101 -> V_107 ) ;
if ( V_6 < 0 )
...
static int F_61 ( struct V_79 * V_12 )
{
struct V_100 * V_101 = V_12 -> V_13 . V_104 ;
struct V_1 * V_2 = F_62 ( V_12 ) ;
int V_6 = 0 ;
if ( V_101 && V_101 -> V_108 ) {
V_6 = V_101 -> V_108 ( V_12 , V_2 -> V_8 . V_36 ,
V_2 -> V_8 . V_9 , V_101 -> V_107 ) ;
if ( V_6 < 0 ) {
F_4 ( & V_12 -> V_13 , L_13 ,
L_14 , V_6 ) ;
