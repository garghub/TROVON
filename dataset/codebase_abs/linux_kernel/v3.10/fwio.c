...
unsigned int V_14 ;
void * V_105 ;
T_7 V_171 = F_9 ( V_6 -> V_25 -> V_119 . V_172 . V_173 -> V_174 ) ;
...
goto V_181;
V_105 = ( void * ) ( V_6 -> V_200 -> V_9 + V_6 -> V_200 -> V_81 ) ;
for ( V_14 = 0 ; V_14 < V_6 -> V_200 -> V_185 ; V_14 ++ ) {
if ( * ( ( T_7 * ) V_105 ) != V_171 ) {
V_105 += V_6 -> V_200 -> V_187 ;
continue;
}
if ( V_6 -> V_145 == V_177 ) {
...
F_31 (
V_6 -> V_25 -> V_119 . V_172 . V_173 -> V_174 ) ) ;
F_32 ( V_73 ) ;
return - V_114 ;
}
