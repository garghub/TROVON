...
V_35 = V_1 -> V_34 -> V_35 . V_74 = F_48 ( V_1 -> V_34 -> V_35 . V_21 ) ;
if ( V_35 != V_73 )
return true ;
if ( ! V_16 || F_50 ( V_1 -> V_16 ) == V_73 )
return false ;
...
static void F_56 ( struct V_78 * V_79 , struct V_8 * V_9 ,
struct V_80 * V_81 )
{
int V_82 , V_83 ;
struct V_1 * V_84 [ 8 ] , * V_1 , * V_85 = NULL ;
struct V_86 * V_87 ;
F_57 ( V_79 , _ ( L_26 ) , _ ( V_9 -> V_39 ) ) ;
V_1 = V_9 -> V_1 -> V_17 ;
...
V_87 -> V_90 = F_59 ( V_81 -> V_91 , struct V_86 ,
V_92 ) -> V_90 + 1 ;
F_60 ( & V_87 -> V_92 , V_81 ) ;
}
if ( V_82 > 0 ) {
...
static struct V_8 * F_63 ( struct V_15 * V_16 )
{
struct V_8 * V_9 = NULL ;
F_64 (sym, prop, P_SYMBOL)
break;
return V_9 ;
}
void F_65 ( struct V_78 * V_79 , struct V_15 * V_16 ,
struct V_80 * V_81 )
{
bool V_95 ;
struct V_8 * V_9 ;
if ( V_16 && V_16 -> V_6 ) {
F_57 ( V_79 , L_30 , V_16 -> V_6 ,
F_61 ( V_16 ) ) ;
F_57 ( V_79 , L_31 , F_15 ( V_16 -> type ) ) ;
if ( V_16 -> type == V_48 || V_16 -> type == V_49 ) {
V_9 = F_66 ( V_16 ) ;
if ( V_9 ) {
F_57 ( V_79 , L_32 ) ;
...
V_9 = F_63 ( V_16 ) ;
if ( V_9 ) {
F_57 ( V_79 , _ ( L_33 ) , V_9 -> V_1 -> V_5 -> V_6 ,
V_9 -> V_1 -> V_7 ) ;
if ( ! F_40 ( V_9 -> V_35 . V_21 ) ) {
F_62 ( V_79 , _ ( L_34 ) ) ;
F_67 ( V_9 -> V_35 . V_21 , V_79 ) ;
F_62 ( V_79 , L_2 ) ;
}
}
V_95 = false ;
...
if ( V_16 -> V_61 . V_21 ) {
F_62 ( V_79 , _ ( L_37 ) ) ;
F_67 ( V_16 -> V_61 . V_21 , V_79 ) ;
F_62 ( V_79 , L_2 ) ;
}
F_62 ( V_79 , L_38 ) ;
}
struct V_78 F_69 ( struct V_15 * * V_96 , struct V_80 * V_81 )
{
struct V_15 * V_16 ;
struct V_78 V_97 = F_70 () ;
int V_82 ;
...
void F_71 ( struct V_1 * V_1 , struct V_78 * V_77 )
{
struct V_15 * V_16 = V_1 -> V_16 ;
const char * V_98 = V_99 ;
if ( F_54 ( V_1 ) ) {
if ( V_16 -> V_6 )
F_57 ( V_77 , L_40 , V_100 , V_16 -> V_6 ) ;
V_98 = F_55 ( V_1 ) ;
}
F_57 ( V_77 , L_41 , _ ( V_98 ) ) ;
if ( V_16 )
F_65 ( V_77 , V_16 , NULL ) ;
}
