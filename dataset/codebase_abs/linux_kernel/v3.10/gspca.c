...
struct V_1 * V_1 = F_65 ( V_106 ) ;
V_1 -> V_127 = 0 ;
return V_1 -> V_20 -> V_193 ( V_1 , V_191 ) ;
}
...
struct V_1 * V_1 = F_65 ( V_106 ) ;
V_1 -> V_127 = 0 ;
return V_1 -> V_20 -> V_196 ( V_1 , V_195 ) ;
}
...
V_89 = 0 ;
for ( V_65 = V_1 -> V_85 . V_184 ; -- V_65 >= 0 ; ) {
V_199 [ V_117 ] = V_1 -> V_85 . V_111 [ V_65 ] . V_185 ;
V_89 = 0 ;
for (; ; ) {
if ( V_199 [ V_89 ] == V_199 [ V_117 ] )
break;
V_89 ++ ;
}
if ( V_89 == V_117 ) {
if ( V_198 -> V_117 == V_117 )
break;
V_117 ++ ;
if ( V_117 >= F_69 ( V_199 ) )
return - V_48 ;
...
if ( V_65 < 0 )
return - V_48 ;
V_198 -> V_185 = V_199 [ V_117 ] ;
if ( V_1 -> V_85 . V_111 [ V_65 ] . V_112 <
V_1 -> V_85 . V_111 [ V_65 ] . V_137 *
V_1 -> V_85 . V_111 [ V_65 ] . V_138 )
V_198 -> V_14 = V_200 ;
V_198 -> V_201 [ 0 ] = V_198 -> V_185 & 0xff ;
V_198 -> V_201 [ 1 ] = ( V_198 -> V_185 >> 8 ) & 0xff ;
V_198 -> V_201 [ 2 ] = ( V_198 -> V_185 >> 16 ) & 0xff ;
V_198 -> V_201 [ 3 ] = V_198 -> V_185 >> 24 ;
V_198 -> V_201 [ 4 ] = '\0' ;
return 0 ;
}
...
int V_186 ;
V_186 = V_1 -> V_110 ;
V_203 -> V_203 . V_204 = V_1 -> V_85 . V_111 [ V_186 ] ;
V_203 -> V_203 . V_204 . V_189 = 0 ;
return 0 ;
}
static int F_71 ( struct V_1 * V_1 ,
struct V_202 * V_203 )
{
int V_5 , V_6 , V_186 , V_205 ;
V_5 = V_203 -> V_203 . V_204 . V_137 ;
V_6 = V_203 -> V_203 . V_204 . V_138 ;
F_1 ( V_1 , V_51 , L_41 ,
V_203 -> V_203 . V_204 . V_185 , V_5 , V_6 ) ;
V_186 = F_62 ( V_1 , V_5 , V_6 ) ;
if ( V_1 -> V_85 . V_111 [ V_186 ] . V_185
!= V_203 -> V_203 . V_204 . V_185 ) {
V_205 = F_63 ( V_1 , V_186 ,
V_203 -> V_203 . V_204 . V_185 ) ;
if ( V_205 >= 0 )
V_186 = V_205 ;
}
...
goto V_178;
if ( V_1 -> V_116 != 0
&& V_203 -> V_203 . V_204 . V_112 > V_1 -> V_99 ) {
V_18 = - V_48 ;
goto V_178;
}
if ( V_18 == V_1 -> V_110 ) {
...
V_1 -> V_137 = V_203 -> V_203 . V_204 . V_137 ;
V_1 -> V_138 = V_203 -> V_203 . V_204 . V_138 ;
V_1 -> V_4 = V_203 -> V_203 . V_204 . V_185 ;
V_1 -> V_110 = V_18 ;
V_18 = 0 ;
V_178:
F_75 ( & V_1 -> V_206 ) ;
...
static int F_77 ( struct V_106 * V_214 , void * V_189 ,
struct V_215 * V_216 )
{
struct V_1 * V_1 = F_65 ( V_214 ) ;
int V_186 = F_62 ( V_1 , V_216 -> V_137 , V_216 -> V_138 ) ;
T_1 V_65 ;
if ( V_1 -> V_85 . V_217 == NULL ||
V_1 -> V_85 . V_217 [ V_186 ] . V_218 == 0 )
return - V_48 ;
if ( V_216 -> V_211 !=
V_1 -> V_85 . V_111 [ V_186 ] . V_185 )
return - V_48 ;
for ( V_65 = 0 ; V_65 < V_1 -> V_85 . V_217 [ V_186 ] . V_218 ; V_65 ++ ) {
if ( V_216 -> V_117 == V_65 ) {
V_216 -> type = V_212 ;
V_216 -> V_213 . V_145 = 1 ;
V_216 -> V_213 . V_144 =
V_1 -> V_85 . V_217 [ V_186 ] . V_219 [ V_65 ] ;
return 0 ;
}
}
return - V_48 ;
}
static void F_78 ( struct V_220 * V_220 )
{
struct V_1 * V_1 =
F_79 ( V_220 , struct V_1 , V_221 ) ;
...
{
struct V_1 * V_1 = F_65 ( V_106 ) ;
F_2 ( V_113 , L_42 , V_223 -> V_224 ) ;
if ( ! F_84 ( V_1 -> V_225 ) )
return - V_26 ;
return F_85 ( V_106 ) ;
}
static int F_86 ( struct V_106 * V_106 )
{
struct V_1 * V_1 = F_65 ( V_106 ) ;
F_2 ( V_113 , L_43 , V_223 -> V_224 ) ;
if ( F_74 ( & V_1 -> V_226 ) )
return - V_207 ;
if ( F_74 ( & V_1 -> V_206 ) ) {
F_75 ( & V_1 -> V_226 ) ;
...
{
struct V_1 * V_1 = F_65 ( V_106 ) ;
F_90 ( ( char * ) V_228 -> V_229 , V_1 -> V_20 -> V_35 ,
sizeof V_228 -> V_229 ) ;
if ( V_1 -> V_29 -> V_230 != NULL ) {
F_90 ( ( char * ) V_228 -> V_231 , V_1 -> V_29 -> V_230 ,
sizeof V_228 -> V_231 ) ;
} else {
snprintf ( ( char * ) V_228 -> V_231 , sizeof V_228 -> V_231 ,
L_45 ,
F_19 ( V_1 -> V_29 -> V_232 . V_233 ) ,
F_19 ( V_1 -> V_29 -> V_232 . V_234 ) ) ;
}
F_11 ( V_1 -> V_29 , ( char * ) V_228 -> V_235 ,
sizeof( V_228 -> V_235 ) ) ;
V_228 -> V_236 = V_237
| V_238
| V_239 ;
V_228 -> V_240 = V_228 -> V_236 | V_241 ;
return 0 ;
}
...
return - V_48 ;
V_243 -> type = V_244 ;
V_243 -> V_19 = V_1 -> V_85 . V_245 ;
F_90 ( V_243 -> V_35 , V_1 -> V_20 -> V_35 ,
sizeof V_243 -> V_35 ) ;
return 0 ;
}
...
if ( V_247 -> V_109 == 0 )
goto V_178;
V_18 = F_42 ( V_1 , V_106 , V_247 -> V_108 , V_247 -> V_109 ) ;
if ( V_18 == 0 ) {
V_247 -> V_109 = V_1 -> V_116 ;
if ( V_84 )
V_18 = F_57 ( V_1 ) ;
}
V_178:
F_75 ( & V_1 -> V_206 ) ;
F_2 ( V_113 , L_46 , V_18 , V_247 -> V_109 ) ;
return V_18 ;
}
...
struct V_1 * V_1 = F_65 ( V_106 ) ;
V_1 -> V_127 = 0 ;
return V_1 -> V_20 -> V_257 ( V_1 , V_256 ) ;
}
...
struct V_1 * V_1 = F_65 ( V_106 ) ;
V_1 -> V_127 = 0 ;
return V_1 -> V_20 -> V_258 ( V_1 , V_256 ) ;
}
static int F_100 ( struct V_106 * V_214 , void * V_189 ,
struct V_140 * V_141 )
{
struct V_1 * V_1 = F_65 ( V_214 ) ;
V_141 -> V_141 . V_142 . V_259 = V_1 -> V_260 ;
if ( V_1 -> V_20 -> V_139 ) {
V_1 -> V_127 = 0 ;
V_1 -> V_20 -> V_139 ( V_1 , V_141 ) ;
return V_1 -> V_127 ;
...
static int F_101 ( struct V_106 * V_214 , void * V_189 ,
struct V_140 * V_141 )
{
struct V_1 * V_1 = F_65 ( V_214 ) ;
int V_161 ;
V_161 = V_141 -> V_141 . V_142 . V_259 ;
...
struct V_9 * V_10 ;
struct V_262 * V_262 ;
unsigned long V_263 , V_180 , V_264 ;
int V_65 , V_18 ;
V_180 = V_8 -> V_265 ;
V_264 = V_8 -> V_266 - V_8 -> V_265 ;
F_2 ( V_113 , L_48 , ( int ) V_180 , ( int ) V_264 ) ;
if ( F_74 ( & V_1 -> V_206 ) )
return - V_207 ;
if ( V_1 -> V_115 != V_106 ) {
V_18 = - V_48 ;
...
V_10 = NULL ;
for ( V_65 = 0 ; V_65 < V_1 -> V_116 ; ++ V_65 ) {
if ( V_1 -> V_10 [ V_65 ] . V_13 . V_108 != V_249 ) {
F_2 ( V_113 , L_49 ) ;
break;
}
if ( ( V_1 -> V_10 [ V_65 ] . V_13 . V_122 . V_83 >> V_267 )
== V_8 -> V_268 ) {
V_10 = & V_1 -> V_10 [ V_65 ] ;
break;
}
...
if ( V_264 != V_10 -> V_13 . V_121 ) {
F_2 ( V_113 , L_51 ) ;
V_18 = - V_48 ;
goto V_178;
}
V_8 -> V_269 |= V_270 ;
V_263 = ( unsigned long ) V_10 -> V_71 ;
while ( V_264 > 0 ) {
V_262 = F_103 ( ( void * ) V_263 ) ;
V_18 = F_104 ( V_8 , V_180 , V_262 ) ;
if ( V_18 < 0 )
goto V_178;
V_180 += V_271 ;
V_263 += V_271 ;
...
V_18 = 0 ;
if ( V_1 -> V_108 == V_250 ) {
if ( F_110 ( ( V_278 V_279 * ) V_10 -> V_13 . V_122 . V_280 ,
V_10 -> V_71 ,
V_10 -> V_13 . V_100 ) ) {
F_6 ( L_54 ) ;
V_18 = - V_281 ;
...
V_10 = & V_1 -> V_10 [ V_117 ] ;
if ( V_10 -> V_13 . V_14 & V_254 ) {
F_2 ( V_105 , L_58 ) ;
V_18 = - V_48 ;
goto V_178;
}
V_10 -> V_13 . V_14 |= V_102 ;
if ( V_10 -> V_13 . V_108 == V_250 ) {
V_10 -> V_13 . V_122 . V_280 = V_13 -> V_122 . V_280 ;
...
V_247 . V_109 = V_1 -> V_260 ;
V_247 . type = V_118 ;
V_247 . V_108 = V_248 ;
V_18 = F_94 ( V_106 , V_1 , & V_247 ) ;
if ( V_18 != 0 ) {
F_2 ( V_113 , L_60 , V_18 ) ;
goto V_178;
}
...
V_13 . type = V_118 ;
V_13 . V_108 = V_248 ;
for ( V_65 = 0 ; V_65 < V_1 -> V_260 ; V_65 ++ ) {
V_13 . V_117 = V_65 ;
...
static unsigned int F_114 ( struct V_106 * V_106 , T_5 * V_283 )
{
struct V_1 * V_1 = F_65 ( V_106 ) ;
unsigned long V_284 = F_115 ( V_283 ) ;
int V_18 = 0 ;
F_2 ( V_105 , L_63 ) ;
if ( V_284 & V_285 )
V_18 |= F_116 ( V_106 , V_283 ) ;
...
static T_6 F_118 ( struct V_106 * V_106 , char V_279 * V_71 ,
T_7 V_109 , T_8 * V_290 )
{
struct V_1 * V_1 = F_65 ( V_106 ) ;
struct V_9 * V_10 ;
...
if ( -- V_161 < 0 )
break;
if ( V_10 -> V_13 . V_95 . V_293 >= V_95 . V_293 )
break;
V_18 = F_112 ( V_106 , V_1 , & V_13 ) ;
if ( V_18 != 0 ) {
F_2 ( V_113 , L_66 , V_18 ) ;
...
V_18 = V_109 ;
V_178:
V_292 = F_112 ( V_106 , V_1 , & V_13 ) ;
if ( V_292 != 0 )
return V_292 ;
return V_18 ;
}
int F_119 ( struct V_61 * V_62 ,
const struct V_294 * V_36 ,
...
int V_18 ;
F_121 ( L_68 V_296 L_69 ,
V_20 -> V_35 , V_36 -> V_233 , V_36 -> V_234 ) ;
if ( V_295 < sizeof *V_1 )
V_295 = sizeof *V_1 ;
V_1 = F_122 ( V_295 , V_53 ) ;
if ( ! V_1 ) {
F_8 ( L_70 ) ;
return - V_33 ;
}
V_1 -> V_222 = F_123 ( V_297 , V_53 ) ;
if ( ! V_1 -> V_222 ) {
F_8 ( L_71 ) ;
V_18 = - V_33 ;
goto V_178;
...
V_1 -> V_29 = V_29 ;
V_1 -> V_66 = V_62 -> V_67 -> V_68 . V_298 ;
if ( V_29 -> V_299 -> V_68 . V_300 != 1 ) {
int V_65 ;
struct V_61 * V_301 ;
for ( V_65 = 0 ; V_65 < V_29 -> V_299 -> V_68 . V_300 ; V_65 ++ ) {
V_301 = V_29 -> V_299 -> V_302 [ V_65 ] ;
if ( V_301 != NULL
&& V_301 -> V_156 != NULL
&& V_301 -> V_156 -> V_68 . V_303 ==
V_304 ) {
V_1 -> V_160 = 1 ;
break;
}
...
V_1 -> V_221 . V_305 = F_78 ;
V_18 = F_124 ( & V_62 -> V_29 , & V_1 -> V_221 ) ;
if ( V_18 )
goto V_178;
V_1 -> V_20 = V_20 ;
V_1 -> V_260 = 2 ;
V_1 -> V_81 = - 1 ;
V_1 -> V_181 = V_306 ;
V_1 -> V_181 . V_221 = & V_1 -> V_221 ;
F_125 ( & V_1 -> V_181 , V_1 ) ;
F_126 ( V_307 , & V_1 -> V_181 . V_14 ) ;
V_1 -> V_225 = V_225 ;
V_1 -> V_274 = 1 ;
F_127 ( & V_1 -> V_226 ) ;
V_1 -> V_181 . V_308 = & V_1 -> V_226 ;
F_127 ( & V_1 -> V_206 ) ;
F_128 ( & V_1 -> V_104 ) ;
V_18 = V_20 -> V_309 ( V_1 , V_36 ) ;
if ( V_18 < 0 )
goto V_178;
V_18 = V_20 -> V_310 ( V_1 ) ;
if ( V_18 < 0 )
...
if ( V_18 )
goto V_178;
F_129 ( & V_1 -> V_181 , V_312 ) ;
F_129 ( & V_1 -> V_181 , V_313 ) ;
F_129 ( & V_1 -> V_181 , V_314 ) ;
if ( ! V_1 -> V_20 -> V_196 )
F_130 ( & V_1 -> V_181 , V_315 ) ;
#ifdef F_131
if ( ! V_1 -> V_20 -> V_196 ||
! V_1 -> V_20 -> V_192 )
F_130 ( & V_1 -> V_181 , V_316 ) ;
if ( ! V_1 -> V_20 -> V_196 ||
! V_1 -> V_20 -> V_193 )
F_130 ( & V_1 -> V_181 , V_317 ) ;
#endif
if ( ! V_1 -> V_20 -> V_257 )
F_130 ( & V_1 -> V_181 , V_318 ) ;
if ( ! V_1 -> V_20 -> V_258 )
F_130 ( & V_1 -> V_181 , V_319 ) ;
...
{
struct V_46 * V_29 = F_120 ( V_62 ) ;
if ( V_29 -> V_232 . V_323 != 1 ) {
F_8 ( L_74 ,
V_36 -> V_233 , V_36 -> V_234 ) ;
return - V_26 ;
}
if ( V_29 -> V_299 -> V_68 . V_300 != 1
&& V_62 -> V_67 -> V_68 . V_298 != 0 )
return - V_26 ;
return F_119 ( V_62 , V_36 , V_20 , V_295 , V_225 ) ;
}
