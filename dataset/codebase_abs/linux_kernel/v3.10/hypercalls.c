...
unsigned int V_32 ;
T_1 V_33 [ V_34 ] ;
if ( F_17 ( & V_33 , & V_2 -> V_13 -> V_35 -> V_36 , sizeof( V_33 ) ) )
return;
for ( V_32 = 0 ; V_32 < F_18 ( V_33 ) ; V_32 ++ ) {
struct V_3 args ;
unsigned int V_37 = V_2 -> V_38 ;
if ( V_33 [ V_37 ] == 0xFF )
break;
if ( ++ V_2 -> V_38 == V_34 )
V_2 -> V_38 = 0 ;
if ( F_17 ( & args , & V_2 -> V_13 -> V_35 -> V_39 [ V_37 ] ,
sizeof( struct V_3 ) ) ) {
F_2 ( V_2 , L_4 ) ;
break;
}
F_1 ( V_2 , & args ) ;
if ( F_19 ( 0xFF , & V_2 -> V_13 -> V_35 -> V_36 [ V_37 ] ) ) {
F_2 ( V_2 , L_5 ) ;
break;
}
if ( V_2 -> V_31 )
...
if ( F_21 ( V_2 ) )
F_2 ( V_2 , L_7 , V_2 -> V_13 -> V_35 ) ;
if ( F_22 ( V_2 -> V_13 -> V_41 , & V_2 -> V_13 -> V_35 -> V_41 )
|| F_22 ( V_2 -> V_13 -> V_42 , & V_2 -> V_13 -> V_35 -> V_42 ) )
F_2 ( V_2 , L_7 , V_2 -> V_13 -> V_35 ) ;
F_23 ( V_2 ) ;
F_24 ( V_2 ) ;
F_5 ( V_2 ) ;
