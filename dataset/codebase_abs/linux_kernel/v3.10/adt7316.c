...
struct V_6 * V_7 = F_2 ( V_2 ) ;
struct V_8 * V_9 = F_3 ( V_7 ) ;
return sprintf ( V_5 , L_20 , V_9 -> V_123 ) ;
}
...
int F_91 ( struct V_1 * V_2 , struct V_136 * V_14 ,
const char * V_137 )
{
struct V_8 * V_9 ;
struct V_6 * V_110 ;
