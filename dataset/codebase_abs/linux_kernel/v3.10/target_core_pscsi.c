...
{
unsigned char * V_28 = V_109 -> V_190 ;
...
F_65 ( V_109 -> V_190 ) ) ;
if ( ! V_157 ) {
V_206 = F_66 ( V_63 -> V_66 -> V_64 ,
( V_160 == V_172 ) ,
V_9 ) ;
if ( ! V_206 || F_12 ( V_206 ) ) {
F_5 ( L_77 ,
V_206 ? F_12 ( V_206 ) : - V_10 ) ;
V_31 = V_180 ;
goto V_174;
}
} else {
...
if ( V_31 )
goto V_174;
V_206 = F_68 ( V_63 -> V_66 -> V_64 , V_161 ,
V_9 ) ;
if ( F_12 ( V_206 ) ) {
F_5 ( L_78 ) ;
V_31 = V_180 ;
...
V_206 -> V_216 = V_218 ;
V_206 -> V_219 = V_220 ;
F_69 ( V_63 -> V_66 -> V_64 , NULL , V_206 ,
( V_109 -> V_221 == V_222 ) ,
V_211 ) ;
return 0 ;
V_207:
...
{
struct V_1 * V_63 = F_1 ( V_3 ) ;
if ( V_63 -> V_88 && V_63 -> V_88 -> V_223 )
return V_63 -> V_88 -> V_223 -> V_224 ;
F_72 () ;
return 0 ;
}
