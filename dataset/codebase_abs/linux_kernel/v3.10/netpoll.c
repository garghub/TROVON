...
void F_82 ( struct V_65 * V_66 , const char * V_78 , int V_67 )
{
int V_79 , V_80 , V_81 ;
struct V_6 * V_7 ;
struct V_19 * V_82 ;
...
F_84 ( V_7 , V_78 , V_67 ) ;
F_85 ( V_7 , V_67 ) ;
F_86 ( V_7 , sizeof( * V_82 ) ) ;
F_87 ( V_7 ) ;
V_82 = F_88 ( V_7 ) ;
V_82 -> V_92 = F_89 ( V_66 -> V_93 ) ;
V_82 -> V_94 = F_89 ( V_66 -> V_95 ) ;
V_82 -> V_67 = F_89 ( V_81 ) ;
if ( V_66 -> V_90 ) {
V_82 -> V_25 = 0 ;
V_82 -> V_25 = F_90 ( & V_66 -> V_96 . V_97 ,
& V_66 -> V_98 . V_97 ,
V_81 , V_26 ,
F_91 ( V_82 , V_81 , 0 ) ) ;
if ( V_82 -> V_25 == 0 )
V_82 -> V_25 = V_99 ;
F_86 ( V_7 , sizeof( * V_89 ) ) ;
F_92 ( V_7 ) ;
V_89 = F_93 ( V_7 ) ;
F_94 ( 0x60 , ( unsigned char * ) V_89 ) ;
V_89 -> V_100 [ 0 ] = 0 ;
V_89 -> V_100 [ 1 ] = 0 ;
V_89 -> V_100 [ 2 ] = 0 ;
V_89 -> V_101 = F_89 ( sizeof( struct V_19 ) + V_67 ) ;
V_89 -> V_102 = V_26 ;
V_89 -> V_103 = 32 ;
V_89 -> V_22 = V_66 -> V_96 . V_97 ;
V_89 -> V_23 = V_66 -> V_98 . V_97 ;
V_86 = (struct V_85 * ) F_86 ( V_7 , V_104 ) ;
F_95 ( V_7 ) ;
V_7 -> V_105 = V_86 -> V_106 = F_89 ( V_107 ) ;
} else {
V_82 -> V_25 = 0 ;
V_82 -> V_25 = F_96 ( V_66 -> V_96 . V_108 ,
V_66 -> V_98 . V_108 ,
V_81 , V_26 ,
F_91 ( V_82 , V_81 , 0 ) ) ;
if ( V_82 -> V_25 == 0 )
V_82 -> V_25 = V_99 ;
F_86 ( V_7 , sizeof( * V_84 ) ) ;
F_92 ( V_7 ) ;
V_84 = F_97 ( V_7 ) ;
F_94 ( 0x45 , ( unsigned char * ) V_84 ) ;
V_84 -> V_109 = 0 ;
F_94 ( F_89 ( V_80 ) , & ( V_84 -> V_110 ) ) ;
V_84 -> V_111 = F_89 ( F_98 ( & V_87 ) ) ;
V_84 -> V_112 = 0 ;
V_84 -> V_113 = 64 ;
V_84 -> V_105 = V_26 ;
V_84 -> V_25 = 0 ;
F_94 ( V_66 -> V_96 . V_108 , & ( V_84 -> V_22 ) ) ;
F_94 ( V_66 -> V_98 . V_108 , & ( V_84 -> V_23 ) ) ;
V_84 -> V_25 = F_99 ( ( unsigned char * ) V_84 , V_84 -> V_114 ) ;
V_86 = (struct V_85 * ) F_86 ( V_7 , V_104 ) ;
F_95 ( V_7 ) ;
V_7 -> V_105 = V_86 -> V_106 = F_89 ( V_115 ) ;
}
...
F_87 ( V_7 ) ;
V_135 = F_107 ( V_7 ) ;
if ( ( V_135 -> V_138 != F_89 ( V_139 ) &&
V_135 -> V_138 != F_89 ( V_140 ) ) ||
V_135 -> V_141 != F_89 ( V_115 ) ||
V_135 -> V_142 != F_89 ( V_143 ) )
return;
...
if ( F_108 ( V_124 ) || F_109 ( V_124 ) )
return;
V_121 = F_106 ( V_7 -> V_11 ) ;
F_54 ( & V_4 -> V_133 , V_8 ) ;
F_102 (np, tmp, &npinfo->rx_np, rx) {
...
continue;
F_92 ( V_126 ) ;
V_135 = (struct V_134 * ) F_85 ( V_126 , V_121 ) ;
V_126 -> V_11 = V_7 -> V_11 ;
V_126 -> V_105 = F_89 ( V_145 ) ;
if ( F_110 ( V_126 , V_7 -> V_11 , V_145 ,
V_125 , V_66 -> V_11 -> V_117 ,
V_126 -> V_67 ) < 0 ) {
F_111 ( V_126 ) ;
continue;
}
V_135 -> V_138 = F_89 ( V_66 -> V_11 -> type ) ;
V_135 -> V_141 = F_89 ( V_115 ) ;
V_135 -> V_146 = V_66 -> V_11 -> V_144 ;
V_135 -> V_147 = 4 ;
V_135 -> V_142 = F_89 ( type ) ;
V_136 = ( unsigned char * ) ( V_135 + 1 ) ;
...
struct V_154 * V_157 ;
V_156 = F_113 ( V_7 -> V_11 ) ;
if ( ! V_156 || ! V_156 -> V_158 . V_159 )
return;
if ( ! F_105 ( V_7 , V_7 -> V_67 ) )
return;
V_78 = (struct V_149 * ) F_114 ( V_7 ) ;
F_115 ( V_7 , V_7 -> V_160 - F_114 ( V_7 ) ) ;
if ( F_93 ( V_7 ) -> V_103 != 255 )
return;
...
if ( ! V_126 )
continue;
V_126 -> V_105 = F_89 ( V_107 ) ;
V_126 -> V_11 = V_7 -> V_11 ;
F_92 ( V_126 ) ;
F_85 ( V_126 , sizeof( struct V_88 ) ) ;
V_151 = F_93 ( V_126 ) ;
* ( T_2 * ) V_151 = F_117 ( 0x60000000 ) ;
V_151 -> V_101 = F_89 ( V_121 ) ;
V_151 -> V_102 = V_165 ;
V_151 -> V_103 = 255 ;
V_151 -> V_22 = * V_22 ;
V_151 -> V_23 = * V_23 ;
...
F_85 ( V_126 , V_121 ) ;
V_153 = (struct V_152 * ) F_114 ( V_7 ) ;
V_153 -> V_163 = V_168 ;
V_153 -> V_169 = 0 ;
V_153 -> V_170 = 1 ;
V_157 = (struct V_154 * ) ( F_114 ( V_126 ) + sizeof( struct V_152 ) ) ;
* V_157 = V_78 -> V_157 ;
V_153 -> V_171 = F_90 ( V_22 , V_23 , V_121 ,
V_165 ,
F_91 ( V_153 ,
V_121 , 0 ) ) ;
if ( F_110 ( V_126 , V_7 -> V_11 , V_107 ,
...
struct V_149 * V_78 ;
struct V_88 * V_151 ;
if ( V_7 -> V_105 != F_89 ( V_145 ) )
return false ;
if ( ! F_105 ( V_7 , sizeof( struct V_88 ) + sizeof( struct V_149 ) ) )
return false ;
V_78 = (struct V_149 * ) F_114 ( V_7 ) ;
F_115 ( V_7 , V_7 -> V_160 - F_114 ( V_7 ) ) ;
V_151 = F_93 ( V_7 ) ;
...
goto V_172;
if ( V_7 -> V_105 == F_89 ( V_145 ) && F_120 ( & V_37 ) ) {
F_41 ( & V_4 -> V_43 , V_7 ) ;
return 1 ;
...
goto V_172;
if ( V_131 == V_115 ) {
if ( ! F_105 ( V_7 , sizeof( struct V_83 ) ) )
goto V_172;
V_84 = (struct V_83 * ) V_7 -> V_160 ;
if ( V_84 -> V_114 < 5 || V_84 -> V_176 != 4 )
goto V_172;
if ( ! F_105 ( V_7 , V_84 -> V_114 * 4 ) )
goto V_172;
V_84 = (struct V_83 * ) V_7 -> V_160 ;
if ( F_99 ( ( T_5 * ) V_84 , V_84 -> V_114 ) != 0 )
goto V_172;
V_67 = F_103 ( V_84 -> V_110 ) ;
...
continue;
if ( V_66 -> V_93 && V_66 -> V_93 != F_103 ( V_20 -> V_94 ) )
continue;
V_66 -> V_177 ( V_66 , F_103 ( V_20 -> V_92 ) ,
( char * ) ( V_20 + 1 ) ,
...
if ( ! F_105 ( V_7 , sizeof( struct V_88 ) ) )
goto V_172;
V_89 = (struct V_88 * ) V_7 -> V_160 ;
if ( V_89 -> V_176 != 6 )
goto V_172;
V_67 = F_103 ( V_89 -> V_101 ) ;
if ( ! V_67 )
goto V_172;
if ( V_67 + sizeof( struct V_88 ) > V_7 -> V_67 )
goto V_172;
if ( F_124 ( V_7 , V_67 + sizeof( struct V_88 ) ) )
goto V_172;
V_89 = F_93 ( V_7 ) ;
...
goto V_172;
F_102 (np, tmp, &npinfo->rx_np, rx) {
if ( ! F_116 ( & V_66 -> V_96 . V_97 , & V_89 -> V_23 ) )
continue;
if ( ! F_116 ( & V_66 -> V_98 . V_97 , & V_89 -> V_22 ) )
continue;
if ( V_66 -> V_93 && V_66 -> V_93 != F_103 ( V_20 -> V_94 ) )
continue;
V_66 -> V_177 ( V_66 , F_103 ( V_20 -> V_92 ) ,
...
{
F_127 ( V_66 , L_2 , V_66 -> V_93 ) ;
if ( V_66 -> V_90 )
F_127 ( V_66 , L_3 , & V_66 -> V_96 . V_97 ) ;
else
F_127 ( V_66 , L_4 , & V_66 -> V_96 . V_108 ) ;
F_127 ( V_66 , L_5 , V_66 -> V_178 ) ;
F_127 ( V_66 , L_6 , V_66 -> V_95 ) ;
if ( V_66 -> V_90 )
F_127 ( V_66 , L_7 , & V_66 -> V_98 . V_97 ) ;
else
F_127 ( V_66 , L_8 , & V_66 -> V_98 . V_108 ) ;
F_127 ( V_66 , L_9 , V_66 -> V_120 ) ;
}
static int F_128 ( const char * V_179 , union V_180 * V_181 )
{
const char * V_182 ;
if ( ! strchr ( V_179 , ':' ) &&
F_129 ( V_179 , - 1 , ( void * ) V_181 , - 1 , & V_182 ) > 0 ) {
if ( ! * V_182 )
return 0 ;
}
if ( F_130 ( V_179 , - 1 , V_181 -> V_97 . V_183 , - 1 , & V_182 ) > 0 ) {
#if F_112 ( V_148 )
if ( ! * V_182 )
return 1 ;
#else
...
int F_131 ( struct V_65 * V_66 , char * V_184 )
{
...
goto V_187;
* V_186 = 0 ;
F_133 ( V_66 -> V_178 , V_185 , sizeof( V_66 -> V_178 ) ) ;
V_185 = V_186 ;
}
V_185 ++ ;
if ( * V_185 != '@' ) {
...
V_185 = V_186 + 1 ;
if ( * V_185 != 0 ) {
if ( ! F_134 ( V_185 , V_66 -> V_120 ) )
goto V_187;
}
F_126 ( V_66 ) ;
return 0 ;
V_187:
F_127 ( V_66 , L_11 , V_185 ) ;
return - 1 ;
}
int F_135 ( struct V_65 * V_66 , struct V_10 * V_188 , T_6 V_189 )
{
struct V_3 * V_4 ;
const struct V_12 * V_13 ;
unsigned long V_8 ;
int V_190 ;
V_66 -> V_11 = V_188 ;
F_133 ( V_66 -> V_178 , V_188 -> V_77 , V_191 ) ;
F_136 ( & V_66 -> V_192 , V_193 ) ;
...
V_188 = F_150 ( V_205 , V_66 -> V_178 ) ;
}
if ( ! V_188 ) {
F_137 ( V_66 , L_13 , V_66 -> V_178 ) ;
V_190 = - V_209 ;
goto V_210;
}
F_151 ( V_188 ) ;
if ( F_152 ( V_188 ) ) {
F_137 ( V_66 , L_14 , V_66 -> V_178 ) ;
V_190 = - V_211 ;
goto V_212;
}
if ( ! F_5 ( V_188 ) ) {
unsigned long V_213 , V_214 ;
F_127 ( V_66 , L_15 , V_66 -> V_178 ) ;
V_190 = F_153 ( V_188 ) ;
if ( V_190 ) {
F_137 ( V_66 , L_16 , V_188 -> V_77 ) ;
goto V_212;
}
F_154 () ;
V_214 = V_215 + V_18 / 10 ;
...
while ( ! F_155 ( V_188 ) ) {
if ( F_156 ( V_215 , V_213 ) ) {
F_157 ( V_66 , L_17 ) ;
break;
}
F_158 ( 1 ) ;
}
if ( F_159 ( V_215 , V_214 ) ) {
F_157 ( V_66 , L_18 ) ;
F_158 ( 4000 ) ;
}
F_149 () ;
...
F_127 ( V_66 , L_20 , & V_66 -> V_96 . V_108 ) ;
} else {
#if F_112 ( V_148 )
struct V_155 * V_220 ;
V_190 = - V_218 ;
...
F_127 ( V_66 , L_22 , & V_66 -> V_96 . V_97 ) ;
#else
F_137 ( V_66 , L_23 ,
V_66 -> V_178 ) ;
V_190 = - V_224 ;
