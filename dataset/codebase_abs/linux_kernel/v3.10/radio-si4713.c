...
F_18 ( V_55 , & V_37 -> V_52 . V_56 ) ;
V_37 -> V_52 . V_46 = & V_37 -> V_46 ;
F_19 ( & V_37 -> V_52 , V_37 ) ;
if ( F_20 ( & V_37 -> V_52 , V_57 , V_58 ) ) {
F_12 ( & V_32 -> V_35 , L_9 ) ;
V_42 = - V_59 ;
goto V_51;
}
...
{
struct V_13 * V_15 = F_25 ( V_32 ) ;
struct V_40 * V_41 = F_26 ( V_15 -> V_60 . V_61 ,
struct V_40 , V_62 ) ;
struct V_63 * V_64 = F_27 ( V_41 ) ;
struct V_14 * V_37 ;
V_37 = F_28 ( V_15 , struct V_14 , V_15 ) ;
F_29 ( & V_37 -> V_52 ) ;
F_22 ( V_64 -> V_39 ) ;
F_23 ( & V_37 -> V_15 ) ;
return 0 ;
