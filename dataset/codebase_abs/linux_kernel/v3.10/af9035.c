...
if ( V_9 -> V_1 [ 2 ] ) {
if ( V_8 -> V_21 == V_27 || V_9 -> V_1 [ 2 ] == 1 ) {
V_10 = 1 ;
goto exit;
}
F_11 ( & V_6 -> V_16 -> V_17 , L_4 ,
V_18 , V_8 -> V_21 , V_9 -> V_1 [ 2 ] ) ;
V_10 = - V_26 ;
goto exit;
}
if ( V_8 -> V_12 )
...
F_12 ( & V_6 -> V_14 ) ;
if ( V_10 < 0 )
F_11 ( & V_6 -> V_16 -> V_17 , L_5 , V_18 , V_10 ) ;
return V_10 ;
}
...
if ( V_10 < 0 )
goto V_54;
F_11 ( & V_6 -> V_16 -> V_17 , L_7 , V_18 , 4 , V_28 ) ;
...
F_11 ( & V_6 -> V_16 -> V_17 , L_8 \
L_9 , V_18 , V_70 , V_71 ,
V_72 , V_73 ) ;
if ( ( ( V_70 != 1 ) && ( V_70 != 2 ) ) ||
( V_72 > V_3 ) ) {
F_11 ( & V_6 -> V_16 -> V_17 , L_10 , V_18 ) ;
break;
}
V_8 . V_21 = V_76 ;
V_10 = F_2 ( V_6 , & V_8 ) ;
...
F_23 ( & V_6 -> V_16 -> V_17 , L_15 ,
V_25 , V_28 [ 0 ] , V_28 [ 1 ] , V_28 [ 2 ] , V_28 [ 3 ] ) ;
return 0 ;
V_54:
F_11 ( & V_6 -> V_16 -> V_17 , L_5 , V_18 , V_10 ) ;
return V_10 ;
...
goto V_54;
V_85 |= V_34 << 8 ;
F_11 ( & V_6 -> V_16 -> V_17 , L_23 , V_18 , V_3 , V_85 ) ;
V_45 += 0x10 ;
}
V_94:
...
int V_10 ;
T_2 V_30 ;
F_11 ( & V_6 -> V_16 -> V_17 , L_24 , V_18 , V_21 , V_112 ) ;
switch ( V_21 ) {
case V_113 :
if ( V_112 )
V_30 = 0x00 ;
...
F_11 ( & V_6 -> V_16 -> V_17 , L_27 \
L_28 , V_18 ,
V_6 -> V_16 -> V_120 , V_145 , V_146 ) ;
...
T_4 V_149 ;
T_2 V_1 [ 4 ] ;
struct V_7 V_8 = { V_27 , 0 , 0 , NULL , 4 , V_1 } ;
V_10 = F_2 ( V_6 , & V_8 ) ;
if ( V_10 == 1 )
return 0 ;
else if ( V_10 < 0 )
...
F_11 ( & V_6 -> V_16 -> V_17 , L_29 , V_18 , 4 , V_1 ) ;
...
if ( V_10 < 0 )
goto V_54;
F_11 ( & V_6 -> V_16 -> V_17 , L_30 , V_18 , V_34 ) ;
if ( V_34 == 5 ) {
V_10 = F_16 ( V_6 , V_9 -> V_60 + V_154 ,
& V_34 ) ;
if ( V_10 < 0 )
goto V_54;
F_11 ( & V_6 -> V_16 -> V_17 , L_31 , V_18 , V_34 ) ;
switch ( V_34 ) {
case 0 :
default:
V_152 -> V_155 = V_156 ;
...
F_11 ( & V_6 -> V_16 -> V_17 , L_32 , V_18 , F_51 ( V_124 ) -> V_123 ) ;
if ( V_6 -> V_16 -> V_120 == V_121 )
...
struct V_5 * V_6 = F_40 ( V_36 ) ;
int V_10 ;
F_11 ( & V_6 -> V_16 -> V_17 , L_33 , V_18 , V_168 ) ;
...
F_11 ( & V_6 -> V_16 -> V_17 , L_34 ,
V_18 , V_169 , V_170 , V_168 ) ;
