...
static int F_37 ( struct V_45 * V_45 , void * V_46 ,
struct V_101 * V_19 )
{
struct V_1 * V_2 = F_21 ( V_45 ) ;
int V_30 ;
T_2 V_20 ;
switch ( V_19 -> V_96 . type ) {
case V_102 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_103 , V_19 ) ;
return 0 ;
case V_104 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_103 , V_19 ) ;
return 0 ;
...
V_30 = F_39 ( V_2 , V_19 -> V_19 , & V_20 ) ;
V_19 -> V_20 = V_20 ;
V_19 -> V_105 = 1 ;
return V_30 ;
}
static int F_40 ( struct V_45 * V_45 , void * V_46 ,
const struct V_101 * V_19 )
{
struct V_1 * V_2 = F_21 ( V_45 ) ;
switch ( V_19 -> V_96 . type ) {
case V_102 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_106 , V_19 ) ;
return 0 ;
case V_104 :
F_12 ( & V_2 -> V_40 , 0 , V_84 , V_106 , V_19 ) ;
return 0 ;
...
return F_3 ( V_2 , V_19 -> V_19 , F_41 ( V_19 -> V_20 ) ) ;
}
static int F_42 ( struct V_78 * V_107 , const struct V_67 * V_108 ,
unsigned int * V_109 , unsigned int * V_110 ,
unsigned int V_111 [] , void * V_112 [] )
{
struct V_1 * V_2 = F_43 ( V_107 ) ;
unsigned long V_105 ;
V_105 = V_2 -> V_70 * V_2 -> V_71 * 2 ;
* V_109 = F_44 (unsigned int, *nbuffers,
...
{
unsigned long V_116 ;
struct V_1 * V_2 = F_43 ( V_115 -> V_78 ) ;
struct V_117 * V_118 =
F_46 ( V_115 , struct V_117 , V_115 ) ;
F_47 ( & V_2 -> V_119 , V_116 ) ;
if ( ! V_2 -> V_28 ) {
F_48 ( & V_118 -> V_115 , V_120 ) ;
} else {
V_118 -> V_121 = F_49 ( V_115 , 0 ) ;
V_118 -> V_122 = F_50 ( V_115 , 0 ) ;
V_118 -> V_123 = 0 ;
V_118 -> V_124 = 0 ;
if ( V_118 -> V_122 < V_2 -> V_70 * V_2 -> V_71 * 2 )
F_48 ( & V_118 -> V_115 , V_120 ) ;
else
F_51 ( & V_118 -> V_125 , & V_2 -> V_126 ) ;
}
F_52 ( & V_2 -> V_119 , V_116 ) ;
}
static int F_53 ( struct V_78 * V_107 , unsigned int V_127 )
{
struct V_1 * V_2 = F_43 ( V_107 ) ;
return F_7 ( V_2 ) ;
}
static int F_54 ( struct V_78 * V_107 )
{
struct V_1 * V_2 = F_43 ( V_107 ) ;
return F_17 ( V_2 ) ;
}
...
unsigned long V_116 ;
F_47 ( & V_2 -> V_119 , V_116 ) ;
while ( ! F_55 ( & V_2 -> V_126 ) ) {
V_118 = F_56 ( & V_2 -> V_126 ,
struct V_117 , V_125 ) ;
F_57 ( & V_118 -> V_125 ) ;
F_48 ( & V_118 -> V_115 , V_120 ) ;
F_5 ( L_14 ,
V_118 , V_118 -> V_115 . V_128 . V_60 ) ;
}
V_2 -> V_34 . V_118 = NULL ;
F_52 ( & V_2 -> V_119 , V_116 ) ;
}
...
V_79 = & V_2 -> V_80 ;
V_79 -> type = V_129 ;
V_79 -> V_130 = V_131 | V_132 | V_133 ;
V_79 -> V_134 = V_2 ;
V_79 -> V_135 = sizeof( struct V_117 ) ;
V_79 -> V_136 = & V_137 ;
V_79 -> V_138 = & V_139 ;
V_79 -> V_140 = V_141 ;
V_30 = F_59 ( V_79 ) ;
...
int V_30 ;
V_2 -> V_91 = V_142 ;
V_2 -> V_91 . V_143 = V_144 ;
V_2 -> V_91 . V_145 = & V_2 -> V_80 ;
V_2 -> V_91 . V_146 = & V_2 -> V_32 ;
V_2 -> V_91 . V_145 -> V_146 = & V_2 -> V_147 ;
V_2 -> V_91 . V_40 = & V_2 -> V_40 ;
F_62 ( V_148 , & V_2 -> V_91 . V_116 ) ;
V_2 -> V_17 = V_149 ;
V_2 -> V_70 = 720 ;
V_2 -> V_71 = 480 ;
V_2 -> V_68 = & V_63 [ 0 ] ;
