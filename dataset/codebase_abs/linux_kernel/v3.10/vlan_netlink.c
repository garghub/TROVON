...
V_40 -> V_41 = V_41 ;
V_40 -> V_8 = V_24 ;
V_10 = F_19 ( V_41 , V_40 -> V_45 , V_40 -> V_46 ) ;
if ( V_10 < 0 )
return V_10 ;
if ( ! V_5 [ V_47 ] )
V_31 -> V_48 = V_41 -> V_48 ;
...
static inline T_3 F_21 ( unsigned int V_49 )
{
if ( V_49 == 0 )
return 0 ;
return F_22 ( sizeof( struct V_1 ) ) +
F_22 ( sizeof( struct V_32 ) ) * V_49 ;
}
...
static int F_24 ( struct V_52 * V_53 , const struct V_30 * V_31 )
{
struct V_39 * V_40 = V_39 ( V_31 ) ;
struct V_54 * V_55 ;
struct V_7 V_56 ;
...
struct V_1 * V_57 ;
unsigned int V_58 ;
if ( F_25 ( V_53 , V_15 , V_40 -> V_45 ) ||
F_26 ( V_53 , V_19 , V_40 -> V_46 ) )
goto V_59;
if ( V_40 -> V_8 ) {
V_56 . V_8 = V_40 -> V_8 ;
V_56 . V_23 = ~ 0 ;
if ( F_27 ( V_53 , V_22 , sizeof( V_56 ) , & V_56 ) )
goto V_59;
}
if ( V_40 -> V_50 ) {
V_57 = F_28 ( V_53 , V_28 ) ;
if ( V_57 == NULL )
goto V_59;
for ( V_58 = 0 ; V_58 < F_29 ( V_40 -> V_60 ) ; V_58 ++ ) {
if ( ! V_40 -> V_60 [ V_58 ] )
continue;
V_33 . V_36 = V_58 ;
...
if ( V_57 == NULL )
goto V_59;
for ( V_58 = 0 ; V_58 < F_29 ( V_40 -> V_62 ) ; V_58 ++ ) {
