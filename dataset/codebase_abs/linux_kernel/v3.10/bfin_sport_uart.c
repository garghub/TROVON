...
V_61 = F_87 (
( unsigned short * ) V_117 -> V_62 . V_124 , V_68 ) ;
if ( V_61 ) {
F_41 ( & V_117 -> V_62 ,
L_31 ) ;
goto V_125;
}
F_88 ( & V_114 -> V_33 . V_36 ) ;
V_114 -> V_33 . V_126 = V_127 ,
V_114 -> V_33 . V_128 = & V_129 ;
V_114 -> V_33 . line = V_117 -> V_120 ;
V_114 -> V_33 . V_130 = V_131 ;
V_114 -> V_33 . V_82 = V_132 ;
V_119 = F_89 ( V_117 , V_133 , 0 ) ;
if ( V_119 == NULL ) {
F_41 ( & V_117 -> V_62 , L_32 ) ;
V_61 = - V_121 ;
goto V_134;
}
V_114 -> V_33 . V_135 = F_90 ( V_119 -> V_136 , F_91 ( V_119 ) ) ;
if ( ! V_114 -> V_33 . V_135 ) {
F_41 ( & V_117 -> V_62 , L_33 ) ;
V_61 = - V_137 ;
goto V_134;
}
V_114 -> V_33 . V_138 = V_119 -> V_136 ;
V_114 -> V_33 . V_30 = F_92 ( V_117 , 0 ) ;
if ( ( int ) V_114 -> V_33 . V_30 < 0 ) {
F_41 ( & V_117 -> V_62 , L_34 ) ;
V_61 = - V_121 ;
goto V_139;
}
V_114 -> V_64 = F_92 ( V_117 , 1 ) ;
if ( V_114 -> V_64 < 0 ) {
...
#ifdef F_42
V_119 = F_89 ( V_117 , V_140 , 0 ) ;
if ( V_119 == NULL )
V_114 -> V_52 = - 1 ;
else {
V_114 -> V_52 = V_119 -> V_136 ;
V_114 -> V_33 . V_82 |= V_141 ;
}
V_119 = F_89 ( V_117 , V_140 , 1 ) ;
if ( V_119 == NULL )
V_114 -> V_57 = - 1 ;
else
V_114 -> V_57 = V_119 -> V_136 ;
#endif
}
#ifdef F_93
if ( ! F_94 ( V_117 ) ) {
...
F_95 ( & V_117 -> V_62 , V_114 ) ;
V_61 = F_96 ( & V_115 , & V_114 -> V_33 ) ;
#ifdef F_93
}
#endif
if ( ! V_61 )
...
if ( V_114 ) {
V_139:
F_97 ( V_114 -> V_33 . V_135 ) ;
V_134:
F_98 (
( unsigned short * ) V_117 -> V_62 . V_124 ) ;
V_125:
F_99 ( V_114 ) ;
...
static int F_100 ( struct V_116 * V_117 )
{
struct V_1 * V_114 = F_101 ( V_117 ) ;
F_60 ( & V_117 -> V_62 , L_13 , V_4 ) ;
F_95 ( & V_117 -> V_62 , NULL ) ;
if ( V_114 ) {
F_102 ( & V_115 , & V_114 -> V_33 ) ;
F_97 ( V_114 -> V_33 . V_135 ) ;
F_98 (
( unsigned short * ) V_117 -> V_62 . V_124 ) ;
F_99 ( V_114 ) ;
