...
int V_15 ;
struct V_27 * V_28 ;
for ( V_15 = 0 , V_28 = V_13 -> V_23 ; V_15 < V_13 -> V_29 ; V_15 ++ , V_28 ++ ) {
V_13 -> V_30 [ V_15 ] . V_4 = F_12 ( F_13 ( V_28 ) ) ;
V_13 -> V_30 [ V_15 ] . V_20 = F_12 ( F_14 ( V_28 ) ) ;
V_13 -> V_30 [ V_15 ] . V_31 = F_12 ( V_24 ) ;
V_24 += F_13 ( V_28 ) ;
V_26 -= F_13 ( V_28 ) ;
if ( V_26 == 0 )
V_24 = V_25 ;
...
{
if ( V_33 -> V_34 . V_35 == 0 ) {
V_33 -> V_34 . V_35 = F_16 ( V_33 -> V_36 , V_33 -> V_34 . V_30 ,
sizeof( V_33 -> V_34 . V_30 ) , V_37 ) ;
F_17 ( V_33 ) ;
}
}
int F_18 ( struct V_32 * V_33 , unsigned long V_38 ,
void T_2 * V_39 , int V_40 )
{
struct V_1 V_41 ;
struct V_12 * V_13 = & V_33 -> V_34 ;
int V_15 , V_42 ;
F_19 ( L_1 , ( unsigned int ) V_38 ) ;
...
V_13 -> V_29 = F_25 ( V_33 -> V_36 , V_13 -> V_23 , V_13 -> V_11 , V_37 ) ;
F_11 ( V_13 , V_38 , 0 , - 1 ) ;
V_13 -> V_30 [ V_13 -> V_29 - 1 ] . V_4 |= F_12 ( 0x80000000 ) ;
F_26 ( V_33 ) ;
return V_13 -> V_11 ;
}
...
return;
if ( V_13 -> V_29 ) {
F_29 ( V_33 -> V_36 , V_13 -> V_23 , V_13 -> V_11 , V_37 ) ;
V_13 -> V_29 = 0 ;
}
F_17 ( V_33 ) ;
for ( V_15 = 0 ; V_15 < V_13 -> V_11 ; V_15 ++ ) {
...
int V_15 ;
if ( V_33 -> V_34 . V_35 ) {
F_31 ( V_33 -> V_36 , V_33 -> V_34 . V_35 ,
sizeof( V_33 -> V_34 . V_30 ) , V_37 ) ;
}
if ( V_33 -> V_34 . V_29 ) {
F_29 ( V_33 -> V_36 , V_33 -> V_34 . V_23 , V_33 -> V_34 . V_11 , V_37 ) ;
}
for ( V_15 = 0 ; V_15 < V_49 ; V_15 ++ ) {
if ( V_33 -> V_34 . V_21 [ V_15 ] )
F_32 ( V_33 -> V_34 . V_21 [ V_15 ] ) ;
}
}
void F_33 ( struct V_32 * V_33 )
{
F_19 ( L_6 ) ;
F_34 ( V_33 -> V_34 . V_35 , V_50 ) ;
F_35 ( F_36 ( V_51 ) | 0x01 , V_51 ) ;
F_37 ( V_52 , & V_33 -> V_53 ) ;
F_37 ( V_54 , & V_33 -> V_53 ) ;
F_38 ( V_55 , & V_33 -> V_53 ) ;
}
void F_39 ( struct V_32 * V_33 )
{
unsigned long V_16 ;
F_40 ( & V_33 -> V_56 , V_16 ) ;
if ( ! F_41 ( V_52 , & V_33 -> V_53 ) )
F_33 ( V_33 ) ;
else
F_37 ( V_55 , & V_33 -> V_53 ) ;
F_42 ( & V_33 -> V_56 , V_16 ) ;
