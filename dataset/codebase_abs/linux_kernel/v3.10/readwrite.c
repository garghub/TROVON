...
static void F_195 ( struct V_227 * V_229 , long V_236 )
{
...
struct V_227 * V_229 )
{
F_193 ( V_63 , V_185 , 0 , F_195 , ( long ) V_229 ) ;
}
static void F_197 ( struct V_227 * V_229 , long V_139 )
{
T_8 V_234 ;
...
static void F_199 ( struct V_227 * V_229 , long V_237 )
{
V_229 -> V_237 = F_25 ( V_237 ) ;
}
void F_200 ( struct V_62 * V_63 , T_8 V_185 , T_8 V_238 ,
T_7 V_144 )
{
T_8 V_237 = V_238 << 4 | ( V_13 T_3 ) V_144 ;
F_193 ( V_63 , V_185 , 1 , F_199 , V_237 ) ;
}
static void F_201 ( struct V_227 * V_229 , long V_239 )
{
...
static void F_203 ( struct V_227 * V_229 ,
long V_237 )
{
V_229 -> V_234 = 0 ;
V_229 -> V_237 = F_25 ( V_237 ) ;
}
void F_204 ( struct V_62 * V_63 , T_8 V_185 , T_8 V_238 )
{
T_8 V_237 = V_238 << 4 ;
...
int F_210 ( struct V_23 * V_23 , const void * V_248 , T_10 V_249 ,
...
F_91 ( & V_72 -> V_161 ) ;
F_214 ( & V_72 -> V_74 ) ;
V_72 -> V_118 = F_215 ( V_252 ,
sizeof( struct V_95 ) ) ;
V_72 -> V_184 = F_215 ( V_252 ,
sizeof( struct V_181 ) ) ;
return 0 ;
}
