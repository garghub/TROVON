...
V_41 = F_43 ( V_40 ) ;
F_44 ( V_39 -> V_58 , L_20 ,
( unsigned long long ) F_45 ( V_40 ) , V_41 ,
F_46 ( V_39 , V_40 ) ) ;
...
L_22 ,
V_6 ,
( unsigned long long ) V_21 . V_59 , type ,
( unsigned long long ) V_21 . V_26 ,
F_50 ( V_40 , V_43 ) , F_51 ( V_40 , V_43 ) ) ;
switch ( type ) {
case V_60 :
...
( unsigned long long )
F_52 ( V_40 , V_49 ) ,
( unsigned long long ) F_53 ( V_40 , V_49 ) ,
F_54 ( V_40 , V_49 ) ) ;
break;
case V_61 :
...
void F_71 ( struct V_38 * V_39 , struct V_1 * V_73 )
{
int V_6 ; T_1 V_41 ;
struct V_56 V_21 ;
int V_74 ;
...
F_44 ( V_39 -> V_58 , L_42 ,
( unsigned long long ) F_45 ( V_73 ) ,
V_74 , V_41 , ( T_1 ) F_73 ( V_39 ) - V_41 ) ;
for ( V_6 = 0 ; V_6 < V_41 ; V_6 ++ ) {
F_74 ( V_73 , & V_21 , V_6 ) ;
F_3 ( V_7 L_43 ,
V_6 ,
...
V_21 . type ,
( unsigned long long ) V_21 . V_26 ,
( unsigned long long ) F_75 ( V_73 , V_6 ) ) ;
}
for ( V_6 = 0 ; V_6 < V_41 ; V_6 ++ ) {
struct V_1 * V_75 = F_76 ( V_39 ,
F_75 ( V_73 , V_6 ) ,
F_77 ( V_39 , V_74 - 1 ) ,
F_78 ( V_73 , V_6 ) ) ;
if ( F_79 ( V_75 ) &&
