...
static int F_95 ( T_2 * V_9 )
{
int V_36 , V_35 ;
T_7 * V_31 ;
int V_274 , V_341 ;
V_9 -> V_324 = F_94 ( V_9 , 0x11 ) ;
for ( V_35 = 0 ; V_35 < V_349 ; V_35 ++ ) {
V_31 = & V_9 -> V_31 [ V_35 ] ;
V_36 = F_94 ( V_9 , V_35 ) ;
switch ( V_36 ) {
...
static int F_94 ( T_2 * V_9 , int V_350 )
{
int V_35 , V_341 ;
F_97 ( V_9 ) ;
F_98 ( V_9 , 1 ) ;
...
static void F_101 ( T_2 * V_9 , int V_351 , int V_341 )
{
int V_27 = V_9 -> V_157 ;
int V_322 ;
...
static int F_102 ( T_2 * V_9 , int V_351 )
{
int V_27 = V_9 -> V_157 ;
int V_322 , V_36 ;
if ( V_351 != V_353 ) {
...
static void F_98 ( T_2 * V_9 , int V_341 )
{
F_101 ( V_9 , V_353 , V_341 ) ;
F_101 ( V_9 , V_354 , 1 ) ;
F_101 ( V_9 , V_354 , 0 ) ;
}
...
F_101 ( V_9 , V_355 , 0 ) ;
F_101 ( V_9 , V_354 , 1 ) ;
V_341 = F_102 ( V_9 , V_353 ) ;
F_101 ( V_9 , V_354 , 0 ) ;
F_101 ( V_9 , V_355 , 1 ) ;
return V_341 ;
}
static int F_103 ( struct V_298 * V_299 , T_11 V_284 )
{
struct V_165 * V_11 = F_104 ( V_299 ) ;
F_9 ( V_173 , L_134 , V_299 , V_284 , F_105 ( V_299 ) , V_11 ) ;
F_106 ( V_299 ) ;
F_107 ( V_299 ) ;
F_108 ( V_299 , F_109 ( V_299 , V_284 ) ) ;
return 0 ;
}
static int F_110 ( struct V_298 * V_299 )
{
struct V_165 * V_11 = F_104 ( V_299 ) ;
T_2 * V_9 = ( T_2 * ) V_11 -> V_12 ;
unsigned short V_356 ;
F_9 ( V_173 , L_135 , V_299 , F_105 ( V_299 ) , V_11 ) ;
F_108 ( V_299 , V_357 ) ;
F_111 ( V_299 , V_357 , 0 ) ;
F_112 ( V_299 ) ;
...
static int F_113 ( struct V_298 * V_299 , const struct V_358 * V_130 )
{
int V_36 ;
T_2 * V_9 = & V_306 ;
F_13 ( V_303 , L_14 ) ;
...
V_9 -> V_157 = F_115 ( V_299 , 0 ) ;
V_9 -> V_309 = F_116 ( V_299 , 0 ) ;
V_9 -> V_310 = F_117 ( V_299 , 1 ) ;
V_9 -> V_216 = F_116 ( V_299 , 1 ) ;
F_118 ( V_299 ) ;
V_36 = F_70 ( V_299 ) ;
F_9 ( V_173 , L_140 ,
V_299 -> V_155 ,
...
static void F_119 ( struct V_298 * V_299 )
{
struct V_165 * V_11 = F_104 ( V_299 ) ;
F_13 ( V_303 , L_14 ) ;
F_120 ( V_11 ) ;
