...
struct V_1 * V_5 ;
int V_151 ;
int V_152 = V_144 -> V_153 % V_104 ;
int V_95 ;
V_5 = F_119 ( & V_144 -> V_19 , sizeof( * V_5 ) , V_142 ) ;
if ( ! V_5 )
return - V_154 ;
V_5 -> V_103 . V_19 = & V_144 -> V_19 ;
V_5 -> V_103 . V_155 = F_107 ;
V_5 -> V_103 . V_156 = F_114 ;
V_5 -> V_103 . V_157 = F_101 ;
V_5 -> V_103 . V_158 = F_102 ;
V_5 -> V_103 . V_159 = F_106 ;
if ( V_150 && V_150 -> V_160 == V_152 ) {
V_5 -> V_103 . V_138 = F_91 ;
F_120 ( V_161 , V_5 -> V_103 . V_162 ) ;
} else {
V_5 -> V_103 . V_163 = F_97 ;
F_120 ( V_164 , V_5 -> V_103 . V_162 ) ;
F_120 ( V_165 , V_5 -> V_103 . V_162 ) ;
}
F_34 ( & V_5 -> V_103 . V_166 ) ;
V_5 -> V_15 = F_121 ( V_148 ) ;
if ( V_5 -> V_15 -> V_95 < 0 ) {
V_95 = F_122 ( V_144 , 0 ) ;
if ( V_95 < 0 )
return V_95 ;
...
( unsigned long ) V_5 ) ;
V_5 -> V_95 = V_95 ;
V_151 = F_124 ( & V_144 -> V_19 , V_5 -> V_95 ,
F_83 , 0 , F_125 ( & V_144 -> V_19 ) , V_5 ) ;
if ( V_151 )
return V_151 ;
} else
V_5 -> V_95 = - 1 ;
...
F_90 ( & V_5 -> V_3 . V_167 , & V_5 -> V_3 . V_18 -> V_166 ) ;
F_108 ( & V_5 -> V_3 ) ;
if ( F_14 ( V_5 ) )
...
F_53 ( V_5 ) ;
F_127 ( V_144 , V_5 ) ;
V_151 = F_128 ( & V_5 -> V_103 ) ;
if ( V_151 )
return V_151 ;
F_42 ( & V_144 -> V_19 , L_36 ,
V_5 -> V_103 . V_98 ,
F_129 ( V_161 , V_5 -> V_103 . V_162 ) ? L_37 : L_38 ,
F_129 ( V_164 , V_5 -> V_103 . V_162 ) ? L_39 : L_38 ) ;
return 0 ;
}
static int F_130 ( struct V_143 * V_144 )
{
struct V_1 * V_5 = F_121 ( V_144 ) ;
F_131 ( & V_5 -> V_103 ) ;
if ( V_5 -> V_95 >= 0 )
F_132 ( & V_5 -> V_99 ) ;
V_5 -> V_15 -> V_3 [ V_144 -> V_153 % V_104 ] = NULL ;
return 0 ;
}
static int T_9 F_133 ( struct V_143 * V_144 )
{
...
T_4 V_101 ;
int V_151 ;
V_170 = F_134 ( V_144 , V_171 , 0 ) ;
if ( ! V_170 )
return - V_127 ;
V_15 = F_119 ( & V_144 -> V_19 , sizeof( * V_15 ) , V_142 ) ;
if ( ! V_15 )
return - V_154 ;
if ( ! F_135 ( & V_144 -> V_19 , V_170 -> V_172 , F_136 ( V_170 ) ,
F_125 ( & V_144 -> V_19 ) ) )
return - V_173 ;
V_15 -> V_16 = F_137 ( & V_144 -> V_19 , V_170 -> V_172 , F_136 ( V_170 ) ) ;
if ( ! V_15 -> V_16 )
return - V_154 ;
...
F_116 ( V_15 ) ;
V_15 -> V_95 = F_122 ( V_144 , 0 ) ;
if ( V_15 -> V_95 >= 0 ) {
F_123 ( & V_15 -> V_99 , F_86 ,
( unsigned long ) V_15 ) ;
V_151 = F_124 ( & V_144 -> V_19 , V_15 -> V_95 ,
F_88 , 0 , F_125 ( & V_144 -> V_19 ) , V_15 ) ;
if ( V_151 )
return V_151 ;
}
V_101 = V_175 | V_176 ;
if ( V_150 && V_150 -> V_160 >= 0 )
V_101 |= F_138 ( V_150 -> V_160 ) ;
F_117 ( V_15 , V_102 , V_101 ) ;
F_127 ( V_144 , V_15 ) ;
return 0 ;
}
static int F_139 ( struct V_143 * V_144 )
{
struct V_14 * V_15 = F_121 ( V_144 ) ;
F_116 ( V_15 ) ;
if ( V_15 -> V_95 >= 0 )
F_132 ( & V_15 -> V_99 ) ;
return 0 ;
}
static void F_140 ( struct V_143 * V_144 )
{
struct V_14 * V_15 = F_121 ( V_144 ) ;
F_116 ( V_15 ) ;
}
