...
int V_6 , V_52 ;
int V_28 = 0 ;
V_8 = F_137 ( & V_303 -> V_30 , sizeof( * V_8 ) , V_311 ) ;
if ( ! V_8 ) {
...
V_52 = F_146 ( V_303 , V_317 [ V_6 ] . V_243 ) ;
V_28 = F_147 ( V_52 , NULL , V_317 [ V_6 ] . V_318 ,
V_319 | V_320 ,
V_317 [ V_6 ] . V_243 , V_8 ) ;
if ( V_28 != 0 ) {
F_17 ( V_8 -> V_30 , L_108
