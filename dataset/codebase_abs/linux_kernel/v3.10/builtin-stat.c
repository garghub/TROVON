...
{
struct V_8 * V_53 ;
int V_75 , V_151 , V_152 , V_118 , V_14 ;
T_2 V_153 , V_154 , V_155 ;
if ( ! ( V_156 || V_157 ) )
return;
for ( V_151 = 0 ; V_151 < V_156 -> V_14 ; V_151 ++ ) {
V_118 = V_156 -> V_119 [ V_151 ] ;
F_11 (counter, &evsel_list->entries, node) {
V_155 = V_153 = V_154 = 0 ;
V_14 = 0 ;
for ( V_75 = 0 ; V_75 < F_3 ( V_53 ) ; V_75 ++ ) {
V_152 = V_157 ( V_13 -> V_10 , V_75 ) ;
if ( V_152 != V_118 )
continue;
V_155 += V_53 -> V_20 -> V_75 [ V_75 ] . V_155 ;
V_153 += V_53 -> V_20 -> V_75 [ V_75 ] . V_153 ;
...
if ( F_23 ( V_53 ) )
F_65 ( V_118 , V_14 , V_53 , V_155 ) ;
else
F_77 ( V_118 , V_14 , V_53 , V_155 ) ;
if ( ! V_85 ) {
F_60 ( V_53 , 1.0 ) ;
if ( V_154 != V_153 )
fprintf ( V_73 , L_43 ,
...
if ( V_160 ) {
double V_161 , V_162 ;
V_161 = F_66 ( & V_67 -> V_71 [ 1 ] ) ;
V_162 = F_66 ( & V_67 -> V_71 [ 2 ] ) ;
fprintf ( V_73 , L_44 , 100 * V_162 / V_161 ) ;
}
fprintf ( V_73 , L_3 ) ;
}
...
if ( F_23 ( V_53 ) )
F_65 ( V_75 , 0 , V_53 , V_155 ) ;
else
F_77 ( V_75 , 0 , V_53 , V_155 ) ;
if ( ! V_85 ) {
F_60 ( V_53 , 1.0 ) ;
if ( V_154 != V_153 )
fprintf ( V_73 , L_43 ,
...
fprintf ( V_73 , L_49 , V_11 . V_163 ) ;
else
fprintf ( V_73 , L_50 , V_11 . V_164 ) ;
fprintf ( V_73 , L_51 ) ;
if ( V_117 > 1 )
...
static int F_83 ( const struct V_169 * T_3 V_109 ,
const char * V_151 V_109 , int V_170 )
{
V_171 = V_170 ? 0 : 1 ;
return 0 ;
}
...
{
struct V_39 V_174 [] = {
{ . type = V_175 , . V_141 = V_176 } ,
{ . type = V_175 , . V_141 = V_177 } ,
{ . type = V_175 , . V_141 = V_178 } ,
{ . type = V_175 , . V_141 = V_179 } ,
{ . type = V_180 , . V_141 = V_181 } ,
{ . type = V_180 , . V_141 = V_182 } ,
{ . type = V_180 , . V_141 = V_183 } ,
{ . type = V_180 , . V_141 = V_184 } ,
{ . type = V_180 , . V_141 = V_185 } ,
{ . type = V_180 , . V_141 = V_186 } ,
} ;
struct V_39 V_187 [] = {
{ . type = V_140 ,
. V_141 =
...
return 0 ;
if ( ! V_13 -> V_192 ) {
if ( F_88 ( V_13 , V_174 ) < 0 )
return - 1 ;
}
if ( V_193 < 1 )
return 0 ;
if ( F_88 ( V_13 , V_187 ) < 0 )
return - 1 ;
if ( V_193 < 2 )
return 0 ;
if ( F_88 ( V_13 , V_189 ) < 0 )
return - 1 ;
if ( V_193 < 3 )
return 0 ;
return F_88 ( V_13 , V_190 ) ;
}
int F_89 ( int V_89 , const char * * V_90 , const char * V_79 V_109 )
{
bool V_194 = false ;
int V_195 = 0 ;
const char * V_196 = NULL ;
const struct V_169 V_197 [] = {
F_90 ( 'e' , L_59 , & V_13 , L_59 ,
L_60 ,
V_198 ) ,
F_90 ( 0 , L_61 , & V_13 , L_61 ,
L_62 , V_199 ) ,
F_91 ( 'i' , L_63 , & V_46 ,
L_64 ) ,
F_92 ( 'p' , L_65 , & V_11 . V_163 , L_65 ,
L_66 ) ,
F_92 ( 't' , L_67 , & V_11 . V_164 , L_67 ,
L_68 ) ,
F_91 ( 'a' , L_69 , & V_11 . V_200 ,
L_70 ) ,
F_91 ( 'g' , L_71 , & V_97 ,
L_72 ) ,
F_91 ( 'c' , L_73 , & V_41 , L_74 ) ,
F_93 ( 'v' , L_75 , & V_72 ,
L_76 ) ,
F_94 ( 'r' , L_77 , & V_117 ,
L_78 ) ,
...
F_91 ( 'S' , L_83 , & V_112 ,
L_84 ) ,
F_95 ( 'B' , L_85 , NULL , NULL ,
L_86 ,
F_83 ) ,
F_92 ( 'C' , L_87 , & V_11 . V_12 , L_87 ,
L_88 ) ,
F_96 ( 'A' , L_89 , & V_80 ,
L_90 , V_88 ) ,
F_92 ( 'x' , L_91 , & V_84 , L_92 ,
L_93 ) ,
F_90 ( 'G' , L_94 , & V_13 , L_95 ,
L_96 , V_201 ) ,
F_92 ( 'o' , L_97 , & V_196 , L_98 , L_99 ) ,
F_91 ( 0 , L_100 , & V_194 , L_101 ) ,
F_94 ( 0 , L_102 , & V_195 ,
L_103 ) ,
F_92 ( 0 , L_104 , & V_111 , L_105 ,
L_106 ) ,
F_92 ( 0 , L_107 , & V_113 , L_105 ,
L_108 ) ,
F_97 ( 'I' , L_109 , & V_96 ,
L_110 ) ,
F_96 ( 0 , L_111 , & V_80 ,
...
int V_94 = - V_17 , V_203 ;
const char * V_204 ;
setlocale ( V_205 , L_116 ) ;
V_13 = F_99 () ;
if ( V_13 == NULL )
return - V_17 ;
V_89 = F_100 ( V_89 , V_90 , V_197 , V_202 ,
V_206 ) ;
V_73 = V_207 ;
if ( V_196 && strcmp ( V_196 , L_117 ) )
V_73 = NULL ;
if ( V_196 && V_195 ) {
fprintf ( V_207 , L_118 ) ;
F_101 ( V_202 , V_197 ) ;
...
if ( ! V_73 ) {
struct V_1 V_208 ;
V_204 = V_194 ? L_120 : L_121 ;
V_73 = fopen ( V_196 , V_204 ) ;
if ( ! V_73 ) {
perror ( L_122 ) ;
return - 1 ;
}
F_34 ( V_209 , & V_208 ) ;
fprintf ( V_73 , L_123 , ctime ( & V_208 . V_5 ) ) ;
} else if ( V_195 > 0 ) {
V_204 = V_194 ? L_120 : L_121 ;
V_73 = fdopen ( V_195 , V_204 ) ;
if ( ! V_73 ) {
perror ( L_124 ) ;
return - V_98 ;
}
...
signal ( V_218 , F_80 ) ;
V_94 = 0 ;
for ( V_203 = 0 ; V_211 || V_203 < V_117 ; V_203 ++ ) {
if ( V_117 != 1 && V_72 )
fprintf ( V_73 , L_133 ,
V_203 + 1 ) ;
V_94 = F_56 ( V_89 , V_90 ) ;
