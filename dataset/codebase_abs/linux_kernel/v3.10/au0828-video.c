...
V_2 -> V_170 = 1 ;
F_1 ( V_2 , 1 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_168 , V_177 , V_2 -> V_178 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_179 , V_180 , & V_173 ) ;
F_1 ( V_2 , 0 ) ;
}
...
static unsigned int F_89 ( struct V_148 * V_149 , T_5 * V_183 )
{
struct V_108 * V_109 = V_149 -> V_154 ;
struct V_1 * V_2 = V_109 -> V_2 ;
unsigned long V_184 = F_90 ( V_183 ) ;
unsigned int V_185 ;
if ( F_4 ( V_2 ) < 0 )
return V_186 ;
V_185 = F_91 ( V_149 , V_183 ) ;
...
if ( ! F_61 ( V_109 , V_142 ) )
return V_186 ;
return V_185 | F_92 ( V_149 , & V_109 -> V_161 , V_183 ) ;
}
if ( V_109 -> type == V_143 ) {
if ( ! F_61 ( V_109 , V_144 ) )
return V_186 ;
return V_185 | F_92 ( V_149 , & V_109 -> V_164 , V_183 ) ;
}
return V_186 ;
}
static int F_93 ( struct V_148 * V_149 , struct V_189 * V_190 )
{
struct V_108 * V_109 = V_149 -> V_154 ;
struct V_1 * V_2 = V_109 -> V_2 ;
int V_53 ;
...
return V_53 ;
if ( V_109 -> type == V_141 )
V_53 = F_94 ( & V_109 -> V_161 , V_190 ) ;
else if ( V_109 -> type == V_143 )
V_53 = F_94 ( & V_109 -> V_164 , V_190 ) ;
return V_53 ;
}
static int F_95 ( struct V_1 * V_2 , unsigned int V_191 ,
struct V_192 * V_193 )
{
int V_131 ;
int V_84 = V_193 -> V_194 . V_195 . V_84 ;
int V_111 = V_193 -> V_194 . V_195 . V_111 ;
...
if ( V_111 != 480 )
V_111 = 480 ;
V_193 -> V_194 . V_195 . V_84 = V_84 ;
V_193 -> V_194 . V_195 . V_111 = V_111 ;
V_193 -> V_194 . V_195 . V_196 = V_197 ;
V_193 -> V_194 . V_195 . V_83 = V_84 * 2 ;
V_193 -> V_194 . V_195 . V_198 = V_84 * V_111 * 2 ;
V_193 -> V_194 . V_195 . V_199 = V_200 ;
V_193 -> V_194 . V_195 . V_117 = V_163 ;
V_193 -> V_194 . V_195 . V_201 = 0 ;
if ( V_191 == V_202 )
return 0 ;
V_2 -> V_84 = V_84 ;
V_2 -> V_111 = V_111 ;
V_2 -> V_203 = V_84 * V_111 * 2 ;
V_2 -> V_204 = V_84 * V_111 ;
V_2 -> V_83 = V_84 * 2 ;
if ( V_2 -> V_132 == V_205 ) {
F_52 ( 1 , L_52 ) ;
V_131 = F_56 ( V_2 ) ;
...
static int F_96 ( struct V_148 * V_148 , void * V_201 ,
struct V_206 * V_207 )
{
struct V_150 * V_136 = F_70 ( V_148 ) ;
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
F_97 ( V_207 -> V_208 , L_55 , sizeof( V_207 -> V_208 ) ) ;
F_97 ( V_207 -> V_209 , V_2 -> V_210 . V_211 , sizeof( V_207 -> V_209 ) ) ;
F_98 ( V_2 -> V_44 , V_207 -> V_212 , sizeof( V_207 -> V_212 ) ) ;
V_207 -> V_213 = V_214 |
V_215 |
V_216 |
V_217 ;
...
V_207 -> V_213 |= V_219 ;
V_207 -> V_220 = V_207 -> V_213 | V_221 |
V_219 | V_218 ;
return 0 ;
}
static int F_99 ( struct V_148 * V_148 , void * V_201 ,
struct V_222 * V_173 )
{
if ( V_173 -> V_223 )
return - V_121 ;
V_173 -> type = V_141 ;
strcpy ( V_173 -> V_224 , L_56 ) ;
V_173 -> V_30 = 0 ;
V_173 -> V_196 = V_197 ;
return 0 ;
}
static int F_100 ( struct V_148 * V_148 , void * V_201 ,
struct V_192 * V_173 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
V_173 -> V_194 . V_195 . V_84 = V_2 -> V_84 ;
V_173 -> V_194 . V_195 . V_111 = V_2 -> V_111 ;
V_173 -> V_194 . V_195 . V_196 = V_197 ;
V_173 -> V_194 . V_195 . V_83 = V_2 -> V_83 ;
V_173 -> V_194 . V_195 . V_198 = V_2 -> V_203 ;
V_173 -> V_194 . V_195 . V_199 = V_200 ;
V_173 -> V_194 . V_195 . V_117 = V_163 ;
V_173 -> V_194 . V_195 . V_201 = 0 ;
return 0 ;
}
static int F_101 ( struct V_148 * V_148 , void * V_201 ,
struct V_192 * V_173 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
return F_95 ( V_2 , V_202 , V_173 ) ;
}
static int F_102 ( struct V_148 * V_148 , void * V_201 ,
struct V_192 * V_173 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
V_53 = F_95 ( V_2 , V_226 , V_173 ) ;
V_225:
return V_53 ;
}
static int F_104 ( struct V_148 * V_148 , void * V_201 , T_6 V_227 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
V_2 -> V_178 = V_227 ;
F_86 ( V_2 ) ;
F_1 ( V_2 , 1 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_168 , V_177 , V_227 ) ;
F_1 ( V_2 , 0 ) ;
return 0 ;
}
static int F_105 ( struct V_148 * V_148 , void * V_201 , T_6 * V_227 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
* V_227 = V_2 -> V_178 ;
...
static int F_106 ( struct V_148 * V_148 , void * V_201 ,
struct V_228 * V_229 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
if ( V_230 >= V_239 )
return - V_121 ;
if ( F_107 ( V_230 ) . type == 0 )
return - V_121 ;
V_229 -> V_223 = V_230 ;
strcpy ( V_229 -> V_211 , V_231 [ F_107 ( V_230 ) . type ] ) ;
if ( ( F_107 ( V_230 ) . type == V_236 ) ||
( F_107 ( V_230 ) . type == V_235 ) ) {
V_229 -> type |= V_240 ;
V_229 -> V_241 = 1 ;
} else {
V_229 -> type |= V_242 ;
...
V_229 -> V_178 = V_2 -> V_136 -> V_243 ;
return 0 ;
}
static int F_108 ( struct V_148 * V_148 , void * V_201 , unsigned int * V_31 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
* V_31 = V_2 -> V_244 ;
...
static void F_109 ( struct V_1 * V_2 , int V_223 )
{
int V_31 ;
switch ( F_107 ( V_223 ) . type ) {
case V_234 :
V_2 -> V_245 = V_234 ;
V_2 -> V_246 = 1 ;
break;
...
F_83 ( & V_2 -> V_167 , 0 , V_247 , V_248 ,
F_107 ( V_223 ) . V_249 , 0 , 0 ) ;
...
F_107 ( V_223 ) . V_253 , 0 , 0 ) ;
}
static int F_110 ( struct V_148 * V_148 , void * V_201 , unsigned int V_223 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
F_52 ( 1 , L_66 , V_134 ,
...
if ( V_223 >= V_239 )
return - V_121 ;
if ( F_107 ( V_223 ) . type == 0 )
return - V_121 ;
V_2 -> V_244 = V_223 ;
F_109 ( V_2 , V_223 ) ;
return 0 ;
}
static int F_111 ( struct V_148 * V_148 , void * V_201 , struct V_254 * V_255 )
{
if ( V_255 -> V_223 > 1 )
return - V_121 ;
if ( V_255 -> V_223 == 0 )
strcpy ( V_255 -> V_211 , L_62 ) ;
else
strcpy ( V_255 -> V_211 , L_67 ) ;
V_255 -> V_256 = V_257 ;
return 0 ;
}
static int F_112 ( struct V_148 * V_148 , void * V_201 , struct V_254 * V_255 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
V_255 -> V_223 = V_2 -> V_246 ;
if ( V_255 -> V_223 == 0 )
strcpy ( V_255 -> V_211 , L_62 ) ;
else
strcpy ( V_255 -> V_211 , L_67 ) ;
...
static int F_113 ( struct V_148 * V_148 , void * V_201 , const struct V_254 * V_255 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
if ( V_255 -> V_223 != V_2 -> V_246 )
return - V_121 ;
return 0 ;
}
static int F_114 ( struct V_148 * V_148 , void * V_201 , struct V_258 * V_259 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
if ( V_259 -> V_223 != 0 )
return - V_121 ;
strcpy ( V_259 -> V_211 , L_68 ) ;
F_86 ( V_2 ) ;
F_1 ( V_2 , 1 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_179 , V_260 , V_259 ) ;
F_1 ( V_2 , 0 ) ;
return 0 ;
}
static int F_115 ( struct V_148 * V_148 , void * V_201 ,
...
F_86 ( V_2 ) ;
F_1 ( V_2 , 1 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_179 , V_261 , V_259 ) ;
F_1 ( V_2 , 0 ) ;
F_52 ( 1 , L_69 , V_259 -> signal ,
V_259 -> V_262 ) ;
return 0 ;
}
static int F_116 ( struct V_148 * V_148 , void * V_201 ,
struct V_172 * V_263 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
static int F_117 ( struct V_148 * V_148 , void * V_201 ,
...
F_86 ( V_2 ) ;
F_1 ( V_2 , 1 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_179 , V_180 , V_263 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_179 , V_265 , & V_264 ) ;
V_2 -> V_175 = V_264 . V_174 ;
F_1 ( V_2 , 0 ) ;
F_54 ( V_2 ) ;
return 0 ;
}
static int F_118 ( struct V_148 * V_148 , void * V_201 ,
struct V_192 * V_193 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
V_193 -> V_194 . V_266 . V_267 = V_2 -> V_91 ;
V_193 -> V_194 . V_266 . V_268 = V_269 ;
V_193 -> V_194 . V_266 . V_61 = 0 ;
V_193 -> V_194 . V_266 . V_30 = 0 ;
V_193 -> V_194 . V_266 . V_270 = 6750000 * 4 / 2 ;
V_193 -> V_194 . V_266 . V_107 [ 0 ] = V_2 -> V_92 ;
V_193 -> V_194 . V_266 . V_107 [ 1 ] = V_2 -> V_92 ;
V_193 -> V_194 . V_266 . V_271 [ 0 ] = 21 ;
V_193 -> V_194 . V_266 . V_271 [ 1 ] = 284 ;
memset ( V_193 -> V_194 . V_266 . V_272 , 0 , sizeof( V_193 -> V_194 . V_266 . V_272 ) ) ;
return 0 ;
}
static int F_119 ( struct V_148 * V_148 , void * V_201 ,
struct V_273 * V_274 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
V_274 -> V_275 = V_276 ;
V_274 -> V_277 = 0 ;
if ( F_120 ( & V_274 -> V_278 ) ) {
V_274 -> V_275 = V_279 ;
return 0 ;
}
F_83 ( & V_2 -> V_167 , 0 , V_168 , V_280 , V_274 ) ;
if ( V_274 -> V_275 == V_276 )
return - V_121 ;
return 0 ;
}
static int F_121 ( struct V_148 * V_148 , void * V_201 ,
struct V_281 * V_282 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
V_282 -> V_283 . V_284 = 0 ;
V_282 -> V_283 . V_285 = 0 ;
V_282 -> V_283 . V_84 = V_2 -> V_84 ;
V_282 -> V_283 . V_111 = V_2 -> V_111 ;
V_282 -> V_286 = V_282 -> V_283 ;
V_282 -> V_287 . V_288 = 54 ;
V_282 -> V_287 . V_289 = 59 ;
return 0 ;
}
static int F_122 ( struct V_148 * V_148 , void * V_201 ,
enum V_290 type )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
if ( V_53 < 0 )
return V_53 ;
if ( F_123 ( type != V_109 -> type ) )
return - V_121 ;
F_52 ( 1 , L_70 ,
V_109 , type , V_109 -> V_139 , V_2 -> V_139 ) ;
if ( F_123 ( ! F_61 ( V_109 , F_66 ( V_109 ) ) ) )
return - V_158 ;
F_86 ( V_2 ) ;
if ( type == V_141 ) {
F_51 ( V_2 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_247 , V_291 , 1 ) ;
}
if ( V_109 -> type == V_141 ) {
V_53 = F_124 ( & V_109 -> V_161 ) ;
V_2 -> V_98 = 1 ;
F_39 ( & V_2 -> V_99 , V_100 + ( V_101 / 10 ) ) ;
} else if ( V_109 -> type == V_143 ) {
V_53 = F_124 ( & V_109 -> V_164 ) ;
V_2 -> V_102 = 1 ;
F_39 ( & V_2 -> V_103 , V_100 + ( V_101 / 10 ) ) ;
}
return V_53 ;
}
static int F_125 ( struct V_148 * V_148 , void * V_201 ,
enum V_290 type )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
V_2 -> V_98 = 0 ;
F_80 ( & V_2 -> V_99 ) ;
F_83 ( & V_2 -> V_167 , 0 , V_247 , V_291 , 0 ) ;
V_53 = F_56 ( V_2 ) ;
if ( V_53 != 0 )
return V_53 ;
for ( V_31 = 0 ; V_31 < V_239 ; V_31 ++ ) {
...
static int F_127 ( struct V_148 * V_148 , void * V_201 ,
struct V_292 * V_293 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
switch ( V_293 -> V_278 . type ) {
case V_294 :
F_83 ( & V_2 -> V_167 , 0 , V_168 , V_295 , V_293 ) ;
return 0 ;
default:
if ( ! F_120 ( & V_293 -> V_278 ) )
return - V_121 ;
}
V_293 -> V_3 = F_128 ( V_2 , V_293 -> V_293 ) ;
return 0 ;
}
static int F_129 ( struct V_148 * V_148 , void * V_201 ,
...
switch ( V_293 -> V_278 . type ) {
case V_294 :
F_83 ( & V_2 -> V_167 , 0 , V_168 , V_296 , V_293 ) ;
return 0 ;
default:
if ( ! F_120 ( & V_293 -> V_278 ) )
return - V_121 ;
}
return F_50 ( V_2 , V_293 -> V_293 , V_293 -> V_3 ) ;
}
static int F_130 ( struct V_148 * V_148 , void * V_109 )
{
struct V_150 * V_136 = F_70 ( V_148 ) ;
F_131 ( V_148 , V_109 ) ;
F_83 ( V_136 -> V_167 , 0 , V_168 , V_297 ) ;
return 0 ;
}
static int F_132 ( struct V_148 * V_148 , void * V_201 ,
struct V_298 * V_299 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
return V_53 ;
if ( V_109 -> type == V_141 )
V_53 = F_133 ( & V_109 -> V_161 , V_299 ) ;
else if ( V_109 -> type == V_143 )
V_53 = F_133 ( & V_109 -> V_164 , V_299 ) ;
return V_53 ;
}
static int F_134 ( struct V_148 * V_148 , void * V_201 ,
struct V_300 * V_301 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
...
return V_53 ;
if ( V_109 -> type == V_141 )
V_53 = F_135 ( & V_109 -> V_161 , V_301 ) ;
else if ( V_109 -> type == V_143 )
V_53 = F_135 ( & V_109 -> V_164 , V_301 ) ;
return V_53 ;
}
static int F_136 ( struct V_148 * V_148 , void * V_201 , struct V_300 * V_301 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
int V_53 ;
...
return V_53 ;
if ( V_109 -> type == V_141 )
V_53 = F_137 ( & V_109 -> V_161 , V_301 ) ;
else if ( V_109 -> type == V_143 )
V_53 = F_137 ( & V_109 -> V_164 , V_301 ) ;
return V_53 ;
}
static int F_138 ( struct V_148 * V_148 , void * V_201 , struct V_300 * V_301 )
{
struct V_108 * V_109 = V_201 ;
struct V_1 * V_2 = V_109 -> V_2 ;
int V_53 ;
...
if ( V_109 -> type == V_141 )
V_53 = F_139 ( & V_109 -> V_161 , V_301 , V_148 -> V_181 & V_182 ) ;
else if ( V_109 -> type == V_143 )
V_53 = F_139 ( & V_109 -> V_164 , V_301 , V_148 -> V_181 & V_182 ) ;
return V_53 ;
}
...
F_52 ( 1 , L_73 ) ;
V_304 = F_74 ( V_2 -> V_44 ,
V_303 -> V_309 -> V_310 . V_311 , 5 ) ;
if ( V_304 != 0 ) {
F_5 ( V_21 L_74 ) ;
return V_304 ;
}
V_306 = V_303 -> V_309 ;
for ( V_31 = 0 ; V_31 < V_306 -> V_310 . V_312 ; V_31 ++ ) {
V_308 = & V_306 -> V_308 [ V_31 ] . V_310 ;
if ( ( ( V_308 -> V_313 & V_314 )
== V_315 ) &&
( ( V_308 -> V_316 & V_317 )
== V_318 ) ) {
T_7 V_230 = F_141 ( V_308 -> V_319 ) ;
V_2 -> V_48 = ( V_230 & 0x07ff ) *
( ( ( V_230 & 0x1800 ) >> 11 ) + 1 ) ;
V_2 -> V_57 = V_308 -> V_313 ;
}
}
if ( ! ( V_2 -> V_57 ) ) {
F_5 ( V_21 L_75 ) ;
...
F_142 ( & V_2 -> V_34 ) ;
F_143 ( & V_2 -> V_29 . V_89 ) ;
F_143 ( & V_2 -> V_29 . V_320 ) ;
F_143 ( & V_2 -> V_93 . V_89 ) ;
F_143 ( & V_2 -> V_93 . V_320 ) ;
V_2 -> V_99 . V_321 = F_67 ;
V_2 -> V_99 . V_145 = ( unsigned long ) V_2 ;
F_144 ( & V_2 -> V_99 ) ;
V_2 -> V_103 . V_321 = F_68 ;
V_2 -> V_103 . V_145 = ( unsigned long ) V_2 ;
F_144 ( & V_2 -> V_103 ) ;
V_2 -> V_84 = V_322 ;
V_2 -> V_111 = V_323 ;
V_2 -> V_204 = V_2 -> V_84 * V_2 -> V_111 ;
...
F_146 ( V_327 , & V_2 -> V_136 -> V_30 ) ;
strcpy ( V_2 -> V_136 -> V_211 , L_78 ) ;
* V_2 -> V_137 = V_326 ;
V_2 -> V_137 -> V_167 = & V_2 -> V_167 ;
V_2 -> V_137 -> V_155 = & V_2 -> V_155 ;
F_146 ( V_327 , & V_2 -> V_137 -> V_30 ) ;
strcpy ( V_2 -> V_137 -> V_211 , L_79 ) ;
F_147 ( V_2 -> V_136 , V_2 ) ;
V_304 = F_148 ( V_2 -> V_136 , V_152 , - 1 ) ;
if ( V_304 != 0 ) {
F_52 ( 1 , L_80 ,
V_304 ) ;
V_131 = - V_22 ;
