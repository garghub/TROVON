...
memcpy ( V_44 -> V_45 . V_203 . V_211 , V_9 -> V_45 . V_211 , 16 ) ;
...
int V_20 = 0 ;
F_43 ( V_213 ) ;
struct V_8 * V_214 = V_9 ;
struct V_13 * V_14 = NULL , * V_187 ;
struct V_1 * V_2 = V_9 -> V_75 -> V_164 -> V_16 -> V_215 ;
unsigned long V_4 ;
V_20 = F_41 ( V_2 , V_3 ) ;
if ( V_20 )
return V_20 ;
...
F_45 ( & V_213 , V_14 -> V_217 . V_218 , & V_14 -> V_217 ) ;
F_46 (a, &alist, list) {
V_187 -> V_43 = V_214 ;
V_214 -> V_15 = V_187 ;
V_214 = F_47 ( V_214 -> V_217 . V_219 , struct V_8 , V_217 ) ;
}
F_46 (a, &alist, list) {
V_214 = V_187 -> V_43 ;
V_187 -> V_220 = 1 ;
...
case V_143 :
case V_47 :
V_20 = F_34 ( V_187 , V_214 , V_12 ) ;
break;
case V_144 :
V_20 = F_37 ( V_187 , V_214 , V_12 ) ;
break;
case V_69 :
V_20 = F_39 ( V_187 , V_214 , V_12 ) ;
break;
default:
F_48 ( L_5 ,
V_214 -> V_33 ) ;
