...
T_1 V_219 = V_173 ( V_42 -> V_38 ) -> V_220 . V_221 ;
if ( V_219 == 0 )
V_219 = 340 ;
V_13 = F_109 ( V_51 -> V_2 , V_222 + V_206 , & V_219 , sizeof( V_219 ) ) ;
if ( V_13 || V_219 != 7 )
return V_223 ;
return V_224 ;
}
...
static int
F_112 ( struct V_93 * V_94 , struct V_225 * V_226 )
{
struct V_173 * V_174 = V_173 ( V_94 -> V_38 ) ;
struct V_227 * V_228 = V_227 ( V_174 -> V_50 ) ;
struct F_21 * V_205 ;
struct V_41 * V_42 ;
int type = V_229 ;
...
return - V_32 ;
V_205 -> V_230 = V_226 ;
V_205 -> V_206 = F_113 ( V_226 -> V_206 ) - 1 ;
V_205 -> V_228 = V_228 -> V_231 ( V_228 , V_226 -> V_232 ) ;
V_42 = F_114 ( V_205 ) ;
V_42 -> V_233 = V_226 -> V_234 ;
V_42 -> V_235 = 0 ;
F_115 ( V_94 -> V_38 , V_42 , & V_236 , type ) ;
F_116 ( V_42 , & V_237 ) ;
F_117 ( V_94 , V_42 ) ;
return 0 ;
}
...
F_109 ( V_51 -> V_2 , V_238 + V_205 -> V_206 ,
V_92 -> V_18 . V_239 ,
V_92 -> V_18 . V_239 [ 2 ] * 4 ) ;
}
static void
...
struct F_21 * V_205 = F_21 ( V_42 ) ;
struct V_36 * V_51 = V_36 ( V_42 -> V_38 ) ;
F_109 ( V_51 -> V_2 , V_238 + V_205 -> V_206 , NULL , 0 ) ;
}
static void
...
struct V_91 * V_92 ;
struct V_36 * V_51 = V_36 ( V_42 -> V_38 ) ;
const T_1 V_240 = ( V_67 -> V_68 << 3 ) | V_205 -> V_206 ;
T_1 V_241 = 56 ;
T_1 V_242 ;
V_92 = F_104 ( V_205 ) ;
if ( ! F_58 ( V_92 -> V_122 ) )
return;
V_242 = V_95 -> V_167 - V_95 -> V_115 ;
V_242 -= V_241 ;
V_242 -= 18 ;
V_242 /= 32 ;
F_102 ( V_51 -> V_2 , V_243 + V_240 ,
V_244 |
( V_242 << 16 ) | V_241 ) ;
F_118 ( V_42 , V_95 ) ;
}
...
const T_1 V_240 = ( V_67 -> V_68 << 3 ) | V_205 -> V_206 ;
F_121 ( V_42 ) ;
F_102 ( V_51 -> V_2 , V_243 + V_240 , 0x00000000 ) ;
}
static void
...
struct F_21 * V_247 = F_21 ( V_245 ) ;
if ( V_245 -> V_248 != V_249 )
continue;
if ( V_247 != V_205 &&
V_247 -> V_230 -> V_206 == V_205 -> V_230 -> V_206 ) {
if ( V_247 -> V_246 == V_213 )
return;
break;
}
}
F_102 ( V_51 -> V_2 , V_250 + V_206 , ( V_95 == V_213 ) ) ;
}
static bool
...
struct V_66 * V_67 = V_66 ( V_42 -> V_43 ) ;
struct V_91 * V_92 ;
struct V_251 * V_252 = & V_174 -> V_220 ;
T_1 * V_47 , V_253 = 0 ;
T_2 V_254 = 1 << V_67 -> V_68 ;
T_2 V_255 = 0xf ;
T_2 V_98 = 0x0 ;
V_92 = F_104 ( V_205 ) ;
switch ( V_205 -> V_230 -> type ) {
case V_256 :
if ( V_205 -> V_230 -> V_257 . V_258 & 1 ) {
...
V_255 = 0x0 ;
if ( V_252 -> V_260 ) {
if ( V_252 -> V_261 . V_262 )
V_253 |= 0x0100 ;
if ( V_252 -> V_261 . V_263 )
V_253 |= 0x0200 ;
} else {
if ( V_92 -> type == V_264 ) {
...
if ( V_95 -> clock >= V_252 -> V_261 . V_265 ) {
V_253 |= 0x0100 ;
}
if ( V_253 & 0x0100 ) {
if ( V_252 -> V_261 . V_266 & 2 )
V_253 |= 0x0200 ;
} else {
if ( V_252 -> V_261 . V_266 & 1 )
V_253 |= 0x0200 ;
}
if ( V_92 -> V_18 . V_99 . V_100 == 8 )
V_253 |= 0x0200 ;
}
F_102 ( V_51 -> V_2 , V_267 + V_205 -> V_206 , V_253 ) ;
break;
case V_268 :
if ( V_92 -> V_18 . V_99 . V_100 == 6 ) {
V_205 -> V_269 . V_270 = V_95 -> clock * 18 / 8 ;
V_98 = 0x2 ;
} else
if ( V_92 -> V_18 . V_99 . V_100 == 8 ) {
V_205 -> V_269 . V_270 = V_95 -> clock * 24 / 8 ;
V_98 = 0x5 ;
} else {
V_205 -> V_269 . V_270 = V_95 -> clock * 30 / 8 ;
V_98 = 0x6 ;
}
if ( V_205 -> V_230 -> V_257 . V_258 & 1 )
V_255 = 0x8 ;
...
if ( V_47 ) {
if ( F_54 ( V_53 ) < V_181 ) {
T_1 V_271 = ( V_98 << 16 ) | ( V_255 << 8 ) | V_254 ;
if ( V_95 -> V_117 & V_215 )
V_271 |= 0x00001000 ;
if ( V_95 -> V_117 & V_216 )
V_271 |= 0x00002000 ;
...
static int
F_132 ( struct V_93 * V_94 , struct V_225 * V_226 )
{
struct V_173 * V_174 = V_173 ( V_94 -> V_38 ) ;
struct V_227 * V_228 = V_227 ( V_174 -> V_50 ) ;
struct F_21 * V_205 ;
...
V_42 -> V_233 = V_226 -> V_234 ;
V_42 -> V_235 = 0 ;
F_115 ( V_94 -> V_38 , V_42 , & V_273 , type ) ;
F_116 ( V_42 , & V_274 ) ;
F_117 ( V_94 , V_42 ) ;
return 0 ;
}
...
struct F_21 * V_205 = F_21 ( V_42 ) ;
struct V_36 * V_51 = V_36 ( V_42 -> V_38 ) ;
T_1 V_275 = ( V_205 -> V_230 -> type << 12 ) | V_205 -> V_206 ;
T_1 V_271 = ( V_95 == V_213 ) ;
F_102 ( V_51 -> V_2 , V_276 + V_275 , V_271 ) ;
}
static bool
...
static int
F_139 ( struct V_93 * V_94 , struct V_225 * V_226 )
{
struct V_173 * V_174 = V_173 ( V_94 -> V_38 ) ;
struct V_227 * V_228 = V_227 ( V_174 -> V_50 ) ;
...
switch ( V_226 -> type ) {
case V_256 :
V_278 = V_228 -> V_279 ( V_228 , F_140 ( V_226 -> V_280 ) ) ;
type = V_249 ;
break;
case V_268 :
V_278 = V_228 -> V_279 ( V_228 , F_141 ( V_226 -> V_280 ) ) ;
type = V_249 ;
break;
default:
return - V_281 ;
...
V_42 -> V_233 = V_226 -> V_234 ;
V_42 -> V_235 = 0 ;
F_115 ( V_94 -> V_38 , V_42 , & V_282 , type ) ;
F_116 ( V_42 , & V_283 ) ;
F_117 ( V_94 , V_42 ) ;
return 0 ;
}
...
struct V_49 * V_50 = F_34 ( V_38 ) ;
struct V_173 * V_174 = V_173 ( V_38 ) ;
struct V_291 * V_230 = & V_174 -> V_220 . V_230 ;
struct V_93 * V_94 , * V_292 ;
struct V_36 * V_51 ;
struct V_225 * V_226 ;
int V_293 , V_13 , V_177 ;
V_51 = F_95 ( sizeof( * V_51 ) , V_196 ) ;
if ( ! V_51 )
return - V_32 ;
F_19 ( V_38 ) -> V_39 = V_51 ;
F_19 ( V_38 ) -> V_294 = F_144 ;
F_19 ( V_38 ) -> V_295 = F_143 ;
F_19 ( V_38 ) -> V_296 = F_142 ;
...
for ( V_177 = 0 , V_226 = & V_230 -> V_298 [ 0 ] ; V_177 < V_230 -> V_299 ; V_177 ++ , V_226 ++ ) {
V_94 = F_149 ( V_38 , V_226 -> V_94 ) ;
if ( F_150 ( V_94 ) )
continue;
if ( V_226 -> V_300 == V_301 ) {
switch ( V_226 -> type ) {
case V_256 :
case V_259 :
case V_268 :
V_13 = F_132 ( V_94 , V_226 ) ;
break;
case V_302 :
V_13 = F_112 ( V_94 , V_226 ) ;
break;
default:
V_13 = - V_281 ;
break;
...
V_13 = F_139 ( V_94 , V_226 ) ;
}
if ( V_13 ) {
F_151 ( V_174 , L_3 ,
V_226 -> V_300 , V_226 -> type ,
F_113 ( V_226 -> V_206 ) - 1 , V_13 ) ;
V_13 = 0 ;
}
}
