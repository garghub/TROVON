...
{
if ( F_31 () )
F_34 ( F_35 ( V_4 ) , F_3 , V_4 , 1 ) ;
else
F_4 ( V_4 ) ;
F_22 ( V_4 ) ;
}
void F_36 ( struct V_18 * V_19 , unsigned long V_20 )
{
if ( F_31 () ) {
struct V_5 V_6 ;
V_6 . V_7 = V_19 ;
V_6 . V_8 = V_20 ;
F_34 ( F_35 ( V_19 -> V_21 ) , F_5 ,
& V_6 , 1 ) ;
} else
F_6 ( V_19 , V_20 ) ;
F_22 ( V_19 -> V_21 ) ;
}
void F_37 ( unsigned long V_22 )
{
if ( F_31 () ) {
struct V_5 V_6 ;
V_6 . V_8 = V_22 ;
...
V_6 . V_8 = V_23 ;
V_6 . V_9 = V_24 ;
F_34 ( F_35 ( V_19 -> V_21 ) , F_9 ,
& V_6 , 1 ) ;
} else
F_10 ( V_19 , V_23 , V_24 ) ;
F_22 ( V_19 -> V_21 ) ;
}
void F_39 ( unsigned long V_23 , unsigned long V_24 )
{
if ( F_31 () ) {
struct V_5 V_6 ;
V_6 . V_8 = V_23 ;
