...
int V_103 = V_108 + 1 ;
F_104 () ;
F_105 ( V_103 , F_106 ( V_103 ) ) ;
V_143 = & F_107 ( V_144 , V_42 ) ;
V_143 -> V_145 ( V_143 ) ;
F_108 () ;
}
...
static T_7 F_115 ( int V_103 , void * V_151 )
{
...
void F_136 ( struct V_175 * V_176 , unsigned long V_42 )
{
...
if ( ( V_30 & V_31 ) ||
( V_27 [ V_10 ] . V_54 == V_27 [ V_42 ] . V_54 ) )
F_140 ( V_10 , V_176 ) = F_137 ( V_10 ) = V_179 ;
}
if ( V_30 & V_31 )
F_60 ( V_98 ) ;
else
...
void F_141 ( unsigned long V_179 )
{
int V_186 ;
unsigned long V_187 ;
V_186 = F_142 () ;
