...
struct V_255 * V_256 ;
int V_257 = 0 ;
V_4 = F_49 ( sizeof( struct V_1 ) , V_258 ) ;
if ( V_4 == NULL )
return - V_259 ;
V_254 = F_50 ( V_252 ) ;
if ( ! V_254 ) {
...
V_4 -> V_16 = & V_252 -> V_16 ;
V_4 -> V_63 = V_254 -> V_262 ;
V_256 = F_51 ( V_252 , V_263 , 0 ) ;
if ( ! V_256 ) {
F_52 ( V_4 -> V_16 , L_1 ) ;
V_257 = - V_249 ;
goto V_261;
}
V_4 -> V_264 = V_256 -> V_265 ;
V_4 -> V_266 = F_53 ( V_256 ) ;
if ( ! F_54 ( V_4 -> V_264 , V_4 -> V_266 ,
V_267 ) ) {
F_52 ( V_4 -> V_16 , L_2 ) ;
V_257 = - V_249 ;
goto V_261;
}
V_4 -> V_5 = F_55 ( V_256 -> V_265 , V_4 -> V_266 ) ;
if ( ! V_4 -> V_5 ) {
F_52 ( V_4 -> V_16 , L_3 ) ;
V_257 = - V_249 ;
goto V_268;
...
return V_257 ;
V_268:
V_268 ( V_4 -> V_264 , V_4 -> V_266 ) ;
V_261:
F_59 ( V_4 ) ;
return V_257 ;
}
static int F_60 ( struct V_251 * V_252 )
{
struct V_1 * V_4 = F_61 ( V_252 ) ;
F_62 ( ( void * ) V_4 -> V_5 ) ;
V_268 ( V_4 -> V_264 , V_4 -> V_266 ) ;
F_59 ( V_4 ) ;
return 0 ;
