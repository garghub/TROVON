...
static int F_65 ( struct V_1 * V_2 , const void * V_3 )
{
const struct V_5 * V_49 = V_3 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
if ( V_6 == NULL ) {
F_66 ( 1 ) ;
return 0 ;
...
static int F_71 ( struct V_1 * V_2 , const void * V_3 )
{
const struct V_1 * V_50 = V_3 ;
struct V_5 * V_6 = F_2 ( V_2 ) ;
