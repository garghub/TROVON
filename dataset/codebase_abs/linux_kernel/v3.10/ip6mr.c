...
if ( V_12 < 0 && V_12 != - V_76 )
goto V_369;
return F_213 ( V_32 , V_169 ) ;
V_369:
F_214 ( V_32 , V_169 ) ;
return - V_206 ;
}
static int F_215 ( bool V_166 , int V_71 )
{
T_9 V_120 =
F_216 ( sizeof( struct V_329 ) )
+ F_217 ( 4 )
+ F_217 ( sizeof( struct V_197 ) )
+ F_217 ( sizeof( struct V_197 ) )
;
if ( ! V_166 )
V_120 = V_120
+ F_217 ( 4 )
+ F_217 ( 0 )
+ V_71 * F_218 ( sizeof( struct V_331 ) )
+ F_217 ( sizeof( struct V_334 ) )
;
return V_120 ;
}
...
struct V_31 * V_32 ;
int V_12 = - V_189 ;
V_32 = F_219 ( F_215 ( V_63 -> V_93 >= V_182 , V_4 -> V_71 ) ,
V_204 ) ;
if ( V_32 == NULL )
goto V_377;
...
if ( V_12 < 0 )
goto V_377;
F_220 ( V_32 , V_2 , 0 , V_378 , NULL , V_204 ) ;
return;
V_377:
F_78 ( V_32 ) ;
if ( V_12 < 0 )
F_221 ( V_2 , V_378 , V_12 ) ;
}
