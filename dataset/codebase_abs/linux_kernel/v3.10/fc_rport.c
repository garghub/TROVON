...
static void F_60 ( struct V_112 * V_113 , struct V_98 * V_99 ,
void * V_143 )
{
struct V_1 * V_5 = V_143 ;
struct {
...
F_62 ( V_99 , V_181 , V_5 -> V_6 . V_4 ,
F_63 ( V_3 -> V_70 ) , V_182 ,
V_183 | V_184 | V_185 , 0 ) ;
if ( ! V_3 -> V_7 . V_186 ( V_3 , V_99 , F_60 ,
NULL , V_5 , 2 * V_3 -> V_25 ) )
F_41 ( V_5 , NULL ) ;
else
F_20 ( & V_5 -> V_15 ) ;
...
T_1 V_189 ;
T_1 V_190 ;
V_188 = F_45 ( V_99 , sizeof( * V_188 ) ) ;
if ( V_188 ) {
V_189 = F_47 ( V_188 -> V_191 ) ;
V_190 = F_47 ( V_188 -> V_192 ) ;
if ( V_190 == 0 )
V_190 = 1 ;
V_5 -> V_25 = V_190 ;
V_190 = F_47 ( V_188 -> V_193 ) ;
if ( V_189 & V_194 )
V_190 /= 1000000 ;
if ( V_190 == 0 )
V_190 = 1 ;
...
F_13 ( V_5 ) ) ;
F_17 ( V_5 , V_95 ) ;
V_99 = F_52 ( V_3 , sizeof( struct V_195 ) ) ;
if ( ! V_99 ) {
F_41 ( V_5 , V_99 ) ;
return;
}
...
static void F_67 ( struct V_112 * V_113 , struct V_98 * V_99 ,
void * V_143 )
{
struct V_1 * V_5 = V_143 ;
struct V_201 * V_202 ;
...
V_147 = F_46 ( V_99 ) ;
V_202 = F_45 ( V_99 , sizeof( * V_202 ) ) ;
if ( V_147 != V_117 || ! V_202 ||
F_68 ( V_202 -> V_203 ) != V_5 -> V_6 . V_4 ||
F_59 ( & V_202 -> V_204 ) != V_5 -> V_6 . V_12 ||
F_59 ( & V_202 -> V_205 ) != V_5 -> V_6 . V_11 ) {
F_19 ( V_5 , L_42 ) ;
F_26 ( V_5 ) ;
} else {
F_19 ( V_5 , L_43 ) ;
...
F_13 ( V_5 ) ) ;
F_17 ( V_5 , V_96 ) ;
V_99 = F_52 ( V_3 , sizeof( struct V_201 ) ) ;
if ( ! V_99 ) {
F_41 ( V_5 , V_99 ) ;
return;
}
...
static void F_69 ( struct V_1 * V_5 ,
struct V_98 * V_207 )
{
struct V_2 * V_3 = V_5 -> V_17 ;
struct V_98 * V_99 ;
...
V_99 = F_52 ( V_3 , sizeof( * V_202 ) ) ;
if ( ! V_99 )
goto V_209;
F_70 ( V_3 , V_99 ) ;
V_202 = F_45 ( V_99 , sizeof( * V_202 ) ) ;
V_202 -> V_210 = V_117 ;
F_57 ( V_99 , V_207 , V_139 , 0 ) ;
V_3 -> V_7 . V_140 ( V_3 , V_99 ) ;
V_209:
F_51 ( V_207 ) ;
}
...
F_19 ( V_5 , L_46 ,
F_13 ( V_5 ) ) ;
V_212 = F_45 ( V_123 , sizeof( * V_212 ) ) ;
if ( ! V_212 ) {
V_126 . V_128 = V_208 ;
V_126 . V_130 = V_134 ;
goto V_219;
}
V_99 = F_52 ( V_3 , sizeof( * V_214 ) ) ;
if ( ! V_99 ) {
V_126 . V_128 = V_220 ;
V_126 . V_130 = V_221 ;
goto V_219;
}
V_214 = F_45 ( V_99 , sizeof( * V_214 ) ) ;
...
F_72 ( V_3 -> V_70 ) ;
V_218 = & V_3 -> V_225 ;
V_216 -> V_226 = F_73 ( V_218 -> V_227 ) ;
V_216 -> V_228 = F_73 ( V_218 -> V_229 ) ;
V_216 -> V_230 = F_73 ( V_218 -> V_231 ) ;
V_216 -> V_232 = F_73 ( V_218 -> V_233 ) ;
V_216 -> V_234 = F_73 ( V_218 -> V_235 ) ;
V_216 -> V_236 = F_73 ( V_218 -> V_237 ) ;
}
F_57 ( V_99 , V_123 , V_139 , 0 ) ;
V_3 -> V_7 . V_140 ( V_3 , V_99 ) ;
goto V_91;
...
static void F_74 ( struct V_2 * V_3 , struct V_98 * V_99 )
{
struct V_1 * V_5 ;
struct V_125 V_238 ;
F_18 ( & V_3 -> V_36 . V_86 ) ;
...
static void F_77 ( struct V_2 * V_3 , struct V_98 * V_99 )
{
struct V_125 V_238 ;
switch ( F_46 ( V_99 ) ) {
case V_108 :
...
F_18 ( & V_5 -> V_16 ) ;
F_21 ( & V_36 -> V_86 ) ;
V_5 -> V_6 . V_12 = F_59 ( & V_245 -> V_148 ) ;
V_5 -> V_6 . V_11 = F_59 ( & V_245 -> V_149 ) ;
switch ( V_5 -> V_18 ) {
case V_19 :
F_19 ( V_5 , L_49 ) ;
break;
...
F_19 ( V_5 , L_55 ,
F_13 ( V_5 ) ) ;
V_249 = F_81 ( V_123 ) - sizeof( struct V_254 ) ;
V_159 = F_45 ( V_123 , sizeof( * V_159 ) ) ;
if ( ! V_159 )
goto V_255;
...
static void F_79 ( struct V_2 * V_3 , struct V_98 * V_99 )
{
struct V_1 * V_5 ;
T_1 V_127 ;
...
V_161 = F_47 ( V_158 -> V_169 ) ;
V_158 -> V_169 = F_73 ( V_161 | V_3 -> V_270 ) ;
return V_166 ;
}
static int F_88 ( struct V_1 * V_5 , T_1 V_269 ,
const struct V_157 * V_248 ,
struct V_157 * V_158 )
{
