...
void F_49 ( struct V_65 * V_66 , const struct V_38 * V_8 ,
const char * V_67 , ... )
{
...
V_40 = F_25 ( V_8 ) ;
V_29 = F_30 ( V_40 -> V_29 ) ;
F_50 ( F_23 ( V_8 ) , F_51 ( V_8 ) , 0 , V_66 , NULL , NULL , NULL ,
L_9 , V_29 -> V_34 , & V_69 ) ;
va_end ( args ) ;
}
int F_52 ( struct V_28 * V_36 )
{
int V_46 = 0 ;
struct V_28 * V_61 ;
...
F_53 ( V_36 -> V_71 == NULL ) ;
F_53 ( V_36 -> V_72 >= V_73 ) ;
F_53 ( strlen ( V_36 -> V_34 ) > V_74 - 1 ) ;
F_54 ( & V_75 ) ;
F_55 (cur, &nf_ct_helper_hash[h], hnode) {
...
F_56 ( & V_36 -> V_77 , & V_78 [ V_32 ] ) ;
V_33 ++ ;
V_6:
F_57 ( & V_75 ) ;
return V_46 ;
}
static void F_58 ( struct V_28 * V_36 ,
struct V_1 * V_1 )
{
struct V_53 * V_32 ;
struct V_79 * exp ;
...
struct V_37 * V_40 = F_25 ( exp -> V_85 ) ;
if ( ( F_34 (
V_40 -> V_29 ,
F_35 ( & V_54 )
) == V_36 || exp -> V_29 == V_36 ) &&
...
F_63 (h, nn, &net->ct.unconfirmed, hnnode)
F_32 ( V_32 , V_36 ) ;
for ( V_35 = 0 ; V_35 < V_1 -> V_8 . V_87 ; V_35 ++ ) {
F_63 (h, nn, &net->ct.hash[i], hnnode)
F_32 ( V_32 , V_36 ) ;
}
}
void F_64 ( struct V_28 * V_36 )
{
struct V_1 * V_1 ;
F_54 ( & V_75 ) ;
F_65 ( & V_36 -> V_77 ) ;
