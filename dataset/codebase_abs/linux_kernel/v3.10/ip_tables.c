...
static void F_42 ( struct V_105 * V_135 , struct V_78 * V_78 )
{
struct V_136 V_40 ;
V_40 . V_78 = V_78 ;
...
F_43 ( V_40 . V_108 -> V_138 ) ;
}
static int
F_44 ( const struct V_43 * V_48 , const char * V_59 )
{
const struct V_47 * V_55 ;
if ( ! F_7 ( & V_48 -> V_6 ) ) {
F_8 ( L_30 , V_48 , V_59 ) ;
...
static int
F_45 ( struct V_105 * V_135 , struct V_141 * V_40 )
{
const struct V_9 * V_6 = V_40 -> V_142 ;
int V_12 ;
V_40 -> V_108 = V_135 -> V_57 . V_58 . V_108 ;
V_40 -> V_109 = V_135 -> V_61 ;
V_12 = F_46 ( V_40 , V_135 -> V_57 . V_143 - sizeof( * V_135 ) ,
...
static int
F_47 ( struct V_105 * V_135 , struct V_141 * V_40 )
{
struct V_144 * V_108 ;
int V_12 ;
V_108 = F_48 ( V_101 , V_135 -> V_57 . V_128 . V_59 ,
...
V_12 = F_45 ( V_135 , V_40 ) ;
if ( V_12 )
goto V_146;
return 0 ;
V_146:
F_43 ( V_135 -> V_57 . V_58 . V_108 -> V_138 ) ;
return V_12 ;
}
static int F_51 ( struct V_43 * V_48 , struct V_78 * V_78 , const char * V_59 )
{
...
int V_12 ;
V_12 = F_52 ( & V_40 , V_55 -> V_57 . V_140 - sizeof( * V_55 ) ,
...
static int
F_53 ( struct V_43 * V_48 , struct V_78 * V_78 , const char * V_59 ,
unsigned int V_130 )
{
struct V_47 * V_55 ;
struct V_149 * V_56 ;
...
V_151 . V_100 = V_101 ;
F_32 (ematch, e) {
V_12 = F_47 ( V_106 , & V_151 ) ;
if ( V_12 != 0 )
goto V_152;
++ V_150 ;
}
V_55 = F_14 ( V_48 ) ;
V_56 = F_54 ( V_101 , V_55 -> V_57 . V_128 . V_59 ,
...
V_12 = F_51 ( V_48 , V_78 , V_59 ) ;
if ( V_12 )
goto V_146;
return 0 ;
V_146:
F_43 ( V_55 -> V_57 . V_58 . V_56 -> V_138 ) ;
V_152:
F_32 (ematch, e) {
if ( V_150 -- == 0 )
break;
...
static bool F_55 ( const struct V_43 * V_48 )
{
const struct V_47 * V_55 ;
unsigned int V_64 ;
if ( ! F_12 ( & V_48 -> V_6 ) )
...
{
unsigned int V_156 ;
if ( ( unsigned long ) V_48 % F_57 ( struct V_43 ) != 0 ||
...
static void
F_58 ( struct V_43 * V_48 , struct V_78 * V_78 )
{
struct V_158 V_40 ;
struct V_47 * V_55 ;
struct V_105 * V_106 ;
...
F_43 ( V_40 . V_56 -> V_138 ) ;
}
static int
F_59 ( struct V_78 * V_78 , struct V_73 * V_121 , void * V_122 ,
...
if ( ! F_39 ( V_121 , V_160 -> V_103 , V_122 ) )
return - V_164 ;
V_161 = 0 ;
F_19 (iter, entry0, newinfo->size) {
V_12 = F_53 ( V_77 , V_78 , V_160 -> V_59 , V_160 -> V_130 ) ;
if ( V_12 != 0 )
break;
++ V_161 ;
}
...
} while ( F_64 ( V_49 , V_167 ) );
F_33 ( V_110 [ V_161 ] , V_166 , V_125 ) ;
++ V_161 ;
}
}
}
static struct V_157 * F_65 ( const struct V_1 * V_85 )
{
unsigned int V_168 ;
struct V_157 * V_110 ;
...
if ( F_49 ( V_110 ) )
return F_50 ( V_110 ) ;
V_174 = V_74 -> V_79 [ F_69 () ] ;
if ( F_70 ( V_171 , V_174 , V_170 ) != 0 ) {
V_12 = - V_175 ;
goto V_176;
}
...
if ( V_178 > 0 )
V_178 -= F_74 ( V_83 , V_178 ) ;
return F_70 ( V_20 , & V_178 , sizeof( V_178 ) ) ? - V_175 : 0 ;
}
static int F_76 ( const struct V_43 * V_48 ,
...
F_32 (ematch, e)
V_172 += F_77 ( V_106 -> V_57 . V_58 . V_108 ) ;
V_55 = F_13 ( V_48 ) ;
V_172 += F_78 ( V_55 -> V_57 . V_58 . V_56 ) ;
V_121 -> V_130 -= V_172 ;
V_12 = F_79 ( V_83 , V_179 , V_172 ) ;
if ( V_12 )
return V_12 ;
for ( V_161 = 0 ; V_161 < V_123 ; V_161 ++ ) {
if ( V_2 -> V_80 [ V_161 ] &&
...
static int F_80 ( const struct V_73 * V_2 ,
struct V_73 * V_121 )
{
struct V_43 * V_77 ;
void * V_174 ;
...
if ( ! V_121 || ! V_2 )
return - V_139 ;
memcpy ( V_121 , V_2 , F_71 ( struct V_73 , V_79 ) ) ;
V_121 -> V_181 = 0 ;
V_174 = V_2 -> V_79 [ F_69 () ] ;
F_81 ( V_83 , V_2 -> V_162 ) ;
F_19 (iter, loc_cpu_entry, info->size) {
V_12 = F_76 ( V_77 , V_2 , V_174 , V_121 ) ;
if ( V_12 != 0 )
return V_12 ;
}
return 0 ;
}
static int F_82 ( struct V_78 * V_78 , void T_4 * V_128 ,
...
if ( F_83 ( V_59 , V_128 , sizeof( V_59 ) ) != 0 )
return - V_175 ;
V_59 [ V_183 - 1 ] = '\0' ;
#ifdef F_84
if ( V_182 )
...
static int
F_92 ( struct V_78 * V_78 , struct V_187 T_4 * V_188 ,
const int * V_111 )
{
int V_12 ;
struct V_187 V_189 ;
...
if ( F_83 ( & V_189 , V_188 , sizeof( V_189 ) ) != 0 )
return - V_175 ;
...
V_55 = F_87 ( V_78 , V_83 , V_189 . V_59 ) ;
if ( ! F_88 ( V_55 ) ) {
const struct V_73 * V_74 = V_55 -> V_74 ;
F_8 ( L_47 , V_74 -> V_162 ) ;
if ( V_189 . V_130 == V_74 -> V_130 )
V_12 = F_68 ( V_74 -> V_130 ,
V_55 , V_188 -> V_190 ) ;
else {
F_8 ( L_48 ,
...
static int
F_93 ( struct V_78 * V_78 , const char * V_59 , unsigned int V_103 ,
...
struct V_43 * V_77 ;
V_12 = 0 ;
V_110 = F_66 ( V_192 * sizeof( struct V_157 ) ) ;
if ( ! V_110 ) {
V_12 = - V_169 ;
goto V_71;
}
...
V_194 = F_94 ( V_55 , V_192 , V_121 , & V_12 ) ;
if ( ! V_194 )
goto V_197;
F_8 ( L_50 ,
...
static int
F_96 ( struct V_78 * V_78 , const void T_4 * V_128 , unsigned int V_111 )
{
int V_12 ;
struct V_159 V_185 ;
struct V_73 * V_121 ;
void * V_174 ;
struct V_43 * V_77 ;
if ( F_83 ( & V_185 , V_128 , sizeof( V_185 ) ) != 0 )
return - V_175 ;
if ( V_185 . V_192 >= V_198 / sizeof( struct V_157 ) )
return - V_169 ;
V_185 . V_59 [ sizeof( V_185 . V_59 ) - 1 ] = 0 ;
V_121 = F_97 ( V_185 . V_130 ) ;
if ( ! V_121 )
return - V_169 ;
V_174 = V_121 -> V_79 [ F_69 () ] ;
if ( F_83 ( V_174 , V_128 + sizeof( V_185 ) ,
V_185 . V_130 ) != 0 ) {
V_12 = - V_175 ;
goto V_199;
}
V_12 = F_59 ( V_78 , V_121 , V_174 , & V_185 ) ;
if ( V_12 != 0 )
goto V_199;
F_8 ( L_51 ) ;
V_12 = F_93 ( V_78 , V_185 . V_59 , V_185 . V_103 , V_121 ,
...
static int
F_98 ( struct V_78 * V_78 , const void T_4 * V_128 ,
...
return - V_139 ;
V_203 = F_99 ( V_111 - V_130 ) ;
if ( ! V_203 )
return - V_169 ;
if ( F_83 ( V_203 , V_128 + V_130 , V_111 - V_130 ) != 0 ) {
V_12 = - V_175 ;
goto free;
}
V_55 = F_87 ( V_78 , V_83 , V_59 ) ;
if ( F_88 ( V_55 ) ) {
V_12 = V_55 ? F_50 ( V_55 ) : - V_186 ;
goto free;
}
...
F_33 ( V_77 -> V_110 , V_203 [ V_161 ] . V_166 , V_203 [ V_161 ] . V_125 ) ;
++ V_161 ;
}
F_36 ( V_94 ) ;
V_207:
...
static int
F_100 ( struct V_43 * V_48 , void T_4 * * V_208 ,
...
if ( F_70 ( V_209 , V_48 , sizeof( struct V_43 ) ) != 0 ||
F_70 ( & V_209 -> V_110 , & V_110 [ V_161 ] ,
sizeof( V_110 [ V_161 ] ) ) != 0 )
return - V_175 ;
* V_208 += sizeof( struct V_180 ) ;
* V_130 -= sizeof( struct V_43 ) - sizeof( struct V_180 ) ;
F_32 (ematch, e) {
V_12 = F_101 ( V_106 , V_208 , V_130 ) ;
if ( V_12 != 0 )
return V_12 ;
}
V_62 = V_48 -> V_62 - ( V_210 - * V_130 ) ;
V_55 = F_14 ( V_48 ) ;
V_12 = F_102 ( V_55 , V_208 , V_130 ) ;
if ( V_12 )
return V_12 ;
V_133 = V_48 -> V_133 - ( V_210 - * V_130 ) ;
if ( F_103 ( V_62 , & V_209 -> V_62 ) != 0 ||
F_103 ( V_133 , & V_209 -> V_133 ) != 0 )
return - V_175 ;
return 0 ;
}
static int
F_104 ( struct V_105 * V_135 ,
const char * V_59 ,
...
static void F_105 ( struct V_180 * V_48 )
{
struct V_47 * V_55 ;
struct V_105 * V_106 ;
F_32 (ematch, e)
F_43 ( V_106 -> V_57 . V_58 . V_108 -> V_138 ) ;
V_55 = F_106 ( V_48 ) ;
F_43 ( V_55 -> V_57 . V_58 . V_56 -> V_138 ) ;
}
static int
F_107 ( struct V_180 * V_48 ,
struct V_73 * V_121 ,
unsigned int * V_130 ,
const unsigned char * V_44 ,
const unsigned char * V_153 ,
...
F_8 ( L_53 , V_48 ) ;
if ( ( unsigned long ) V_48 % F_57 ( struct V_180 ) != 0 ||
...
V_12 = F_44 ( (struct V_43 * ) V_48 , V_59 ) ;
if ( V_12 )
return V_12 ;
V_172 = sizeof( struct V_43 ) - sizeof( struct V_180 ) ;
...
static int
F_108 ( struct V_180 * V_48 , void * * V_208 ,
...
static int
F_111 ( struct V_43 * V_48 , struct V_78 * V_78 , const char * V_59 )
{
struct V_105 * V_106 ;
struct V_141 V_151 ;
unsigned int V_150 ;
...
V_217 = V_121 -> V_79 [ F_69 () ] ;
V_124 = V_217 ;
V_130 = V_170 ;
F_19 (iter0, entry0, total_size) {
V_12 = F_108 ( V_218 , & V_124 , & V_130 ,
V_59 , V_121 , V_217 ) ;
if ( V_12 != 0 )
break;
}
...
goto V_199;
V_12 = - V_164 ;
if ( ! F_39 ( V_121 , V_103 , V_217 ) )
goto V_199;
V_161 = 0 ;
F_19 (iter1, entry1, newinfo->size) {
V_12 = F_111 ( V_219 , V_78 , V_59 ) ;
if ( V_12 != 0 )
break;
++ V_161 ;
...
static int
F_113 ( struct V_78 * V_78 , void T_4 * V_128 , unsigned int V_111 )
{
int V_12 ;
struct V_222 V_185 ;
struct V_73 * V_121 ;
...
V_12 = F_112 ( V_78 , V_185 . V_59 , V_185 . V_103 ,
...
static int
F_116 ( struct V_223 * V_224 , int V_225 , void T_4 * V_128 ,
unsigned int V_111 )
{
int V_12 ;
if ( ! F_117 ( F_118 ( V_224 ) -> V_226 , V_227 ) )
return - V_228 ;
switch ( V_225 ) {
case V_229 :
V_12 = F_113 ( F_118 ( V_224 ) , V_128 , V_111 ) ;
break;
case V_230 :
V_12 = F_98 ( F_118 ( V_224 ) , V_128 , V_111 , 1 ) ;
break;
default:
F_8 ( L_59 , V_225 ) ;
V_12 = - V_139 ;
...
static int
F_119 ( unsigned int V_170 , struct V_1 * V_85 ,
void T_4 * V_171 )
{
struct V_157 * V_110 ;
const struct V_73 * V_74 = V_85 -> V_74 ;
...
static int
F_120 ( struct V_78 * V_78 , struct V_231 T_4 * V_188 ,
int * V_111 )
{
int V_12 ;
struct V_231 V_189 ;
...
static int
F_121 ( struct V_223 * V_224 , int V_225 , void T_4 * V_128 , int * V_111 )
{
int V_12 ;
if ( ! F_117 ( F_118 ( V_224 ) -> V_226 , V_227 ) )
return - V_228 ;
switch ( V_225 ) {
case V_232 :
V_12 = F_82 ( F_118 ( V_224 ) , V_128 , V_111 , 1 ) ;
break;
case V_233 :
V_12 = F_120 ( F_118 ( V_224 ) , V_128 , V_111 ) ;
break;
default:
V_12 = F_122 ( V_224 , V_225 , V_128 , V_111 ) ;
}
return V_12 ;
}
static int
F_123 ( struct V_223 * V_224 , int V_225 , void T_4 * V_128 , unsigned int V_111 )
{
int V_12 ;
if ( ! F_117 ( F_118 ( V_224 ) -> V_226 , V_227 ) )
return - V_228 ;
switch ( V_225 ) {
case V_229 :
V_12 = F_96 ( F_118 ( V_224 ) , V_128 , V_111 ) ;
break;
case V_230 :
V_12 = F_98 ( F_118 ( V_224 ) , V_128 , V_111 , 0 ) ;
break;
default:
F_8 ( L_59 , V_225 ) ;
V_12 = - V_139 ;
...
switch ( V_225 ) {
case V_232 :
V_12 = F_82 ( F_118 ( V_224 ) , V_128 , V_111 , 0 ) ;
break;
case V_233 :
V_12 = F_92 ( F_118 ( V_224 ) , V_128 , V_111 ) ;
break;
case V_234 :
case V_235 : {
struct V_236 V_237 ;
...
if ( F_83 ( & V_237 , V_128 , sizeof( V_237 ) ) != 0 ) {
V_12 = - V_175 ;
break;
}
...
struct V_1 * F_125 ( struct V_78 * V_78 ,
const struct V_1 * V_85 ,
const struct V_159 * V_160 )
{
int V_12 ;
...
V_12 = F_59 ( V_78 , V_121 , V_174 , V_160 ) ;
if ( V_12 != 0 )
goto V_240;
V_239 = F_126 ( V_78 , V_85 , & V_238 , V_121 ) ;
if ( F_49 ( V_239 ) ) {
V_12 = F_50 ( V_239 ) ;
goto V_240;
}
...
void F_127 ( struct V_78 * V_78 , struct V_1 * V_85 )
{
struct V_73 * V_74 ;
void * V_174 ;
...
static inline bool
F_129 ( T_7 V_243 , T_7 V_244 , T_7 V_245 ,
T_7 type , T_7 V_246 ,
bool V_247 )
{
return ( ( V_243 == 0xFF ) ||
...
static bool
F_130 ( const struct V_37 * V_38 , struct V_39 * V_40 )
{
...
if ( V_40 -> V_95 != 0 )
return false ;
V_249 = F_131 ( V_38 , V_40 -> V_98 , sizeof( V_250 ) , & V_250 ) ;
if ( V_249 == NULL ) {
F_8 ( L_65 ) ;
V_40 -> V_99 = true ;
return false ;
}
return F_129 ( V_252 -> type ,
V_252 -> V_246 [ 0 ] ,
V_252 -> V_246 [ 1 ] ,
V_249 -> type , V_249 -> V_246 ,
! ! ( V_252 -> V_22 & V_253 ) ) ;
}
static int F_132 ( const struct V_141 * V_40 )
{
const struct V_251 * V_252 = V_40 -> V_109 ;
return ( V_252 -> V_22 & ~ V_253 ) ? - V_139 : 0 ;
}
static int T_8 F_133 ( struct V_78 * V_78 )
{
return F_134 ( V_78 , V_101 ) ;
}
static void T_9 F_135 ( struct V_78 * V_78 )
{
F_136 ( V_78 , V_101 ) ;
}
...
if ( V_12 < 0 )
goto V_255;
V_12 = F_139 ( V_256 , F_140 ( V_256 ) ) ;
if ( V_12 < 0 )
goto V_257;
V_12 = F_141 ( V_258 , F_140 ( V_258 ) ) ;
if ( V_12 < 0 )
goto V_259;
V_12 = F_142 ( & V_260 ) ;
if ( V_12 < 0 )
...
return 0 ;
V_261:
F_144 ( V_258 , F_140 ( V_258 ) ) ;
V_259:
F_145 ( V_256 , F_140 ( V_256 ) ) ;
V_257:
F_146 ( & V_254 ) ;
V_255:
return V_12 ;
