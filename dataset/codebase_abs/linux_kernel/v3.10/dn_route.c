...
static int F_147 ( struct V_36 * V_263 , struct V_237 * V_238 )
{
struct V_264 * V_264 = F_148 ( V_263 -> V_35 ) ;
struct V_236 * V_265 = F_138 ( V_238 ) ;
struct V_3 * V_4 = NULL ;
struct V_76 * V_77 ;
int V_93 ;
struct V_36 * V_37 ;
...
if ( ! F_73 ( V_264 , & V_112 ) )
return - V_136 ;
V_93 = F_149 ( V_238 , sizeof( * V_265 ) , V_267 , V_268 , V_269 ) ;
if ( V_93 < 0 )
return V_93 ;
memset ( & V_64 , 0 , sizeof( V_64 ) ) ;
V_64 . V_214 = V_270 ;
V_37 = F_150 ( V_271 , V_272 ) ;
if ( V_37 == NULL )
return - V_211 ;
F_151 ( V_37 ) ;
V_77 = F_50 ( V_37 ) ;
if ( V_267 [ V_258 ] )
V_64 . V_55 = F_152 ( V_267 [ V_258 ] ) ;
if ( V_267 [ V_256 ] )
V_64 . V_54 = F_152 ( V_267 [ V_256 ] ) ;
if ( V_267 [ V_262 ] )
V_64 . V_59 = F_153 ( V_267 [ V_262 ] ) ;
if ( V_64 . V_59 ) {
struct V_6 * V_7 ;
...
goto V_275;
F_135 ( V_37 , & V_4 -> V_2 ) ;
if ( V_265 -> V_248 & V_254 )
V_4 -> V_82 |= V_253 ;
V_93 = F_136 ( V_37 , F_157 ( V_263 ) . V_232 , V_238 -> V_276 , V_277 , 0 , 0 ) ;
if ( V_93 == 0 )
goto V_275;
if ( V_93 < 0 ) {
V_93 = - V_239 ;
...
return F_158 ( V_37 , & V_112 , F_157 ( V_263 ) . V_232 ) ;
V_275:
F_59 ( V_37 ) ;
return V_93 ;
}
int F_159 ( struct V_36 * V_37 , struct V_278 * V_77 )
{
...
if ( ! F_73 ( V_264 , & V_112 ) )
return 0 ;
if ( F_160 ( V_77 -> V_238 ) < sizeof( struct V_236 ) )
return - V_136 ;
V_265 = F_138 ( V_77 -> V_238 ) ;
if ( ! ( V_265 -> V_248 & V_249 ) )
return 0 ;
V_280 = V_77 -> args [ 0 ] ;
...
if ( V_281 < V_282 )
continue;
F_135 ( V_37 , F_161 ( & V_4 -> V_2 ) ) ;
if ( F_136 ( V_37 , F_157 ( V_77 -> V_37 ) . V_232 ,
...
static struct V_3 * F_163 ( struct V_284 * V_233 )
{
struct V_3 * V_4 = NULL ;
...
static struct V_3 * F_164 ( struct V_284 * V_233 , struct V_3 * V_4 )
{
struct V_285 * V_286 = V_233 -> V_287 ;
V_4 = F_126 ( V_4 -> V_2 . V_29 ) ;
while ( ! V_4 ) {
...
static void * F_165 ( struct V_284 * V_233 , T_7 * V_289 )
{
struct V_3 * V_4 = F_163 ( V_233 ) ;
if ( V_4 ) {
while( * V_289 && ( V_4 = F_164 ( V_233 , V_4 ) ) )
-- * V_289 ;
}
return * V_289 ? NULL : V_4 ;
}
static void * F_166 ( struct V_284 * V_233 , void * V_290 , T_7 * V_289 )
{
struct V_3 * V_4 = F_164 ( V_233 , V_290 ) ;
++ * V_289 ;
return V_4 ;
}
static void F_167 ( struct V_284 * V_233 , void * V_290 )
{
if ( V_290 )
F_128 () ;
}
static int F_168 ( struct V_284 * V_233 , void * V_290 )
{
struct V_3 * V_4 = V_290 ;
char V_291 [ V_292 ] , V_293 [ V_292 ] ;
F_169 ( V_233 , L_11 ,
V_4 -> V_2 . V_7 ? V_4 -> V_2 . V_7 -> V_96 : L_12 ,
F_170 ( F_58 ( V_4 -> V_138 ) , V_291 ) ,
F_170 ( F_58 ( V_4 -> V_137 ) , V_293 ) ,
F_17 ( & V_4 -> V_2 . V_27 ) ,
V_4 -> V_2 . V_294 , 0 ) ;
return 0 ;
}
static int F_171 ( struct V_295 * V_295 , struct V_296 * V_296 )
{
return F_172 ( V_296 , & V_297 ,
sizeof( struct V_285 ) ) ;
}
void T_8 F_173 ( void )
{
...
V_200 . V_308 = ( V_14 + 1 ) ;
F_180 ( L_16 , V_309 , V_112 . V_310 ,
& V_311 ) ;
#ifdef F_181
F_182 ( V_312 , V_313 , F_147 ,
V_314 , NULL ) ;
#else
F_182 ( V_312 , V_313 , F_147 ,
F_159 , NULL ) ;
