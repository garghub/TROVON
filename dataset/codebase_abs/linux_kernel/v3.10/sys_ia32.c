...
static char V_71 [ sizeof( V_69 -> V_72 ) ] ;
if ( strncmp ( V_71 , V_69 -> V_72 , sizeof( V_71 ) ) ) {
F_36 ( V_73
L_1 ,
V_69 -> V_72 ) ;
strncpy ( V_71 , V_69 -> V_72 , sizeof( V_71 ) ) ;
}
return - V_74 ;
}
T_1 T_6 F_37 ( int V_5 , unsigned V_75 , unsigned V_76 ,
T_7 V_61 )
{
return F_38 ( V_5 , ( ( V_67 ) V_76 << 32 ) | V_75 , V_61 ) ;
}
T_1 long F_39 ( int V_5 , unsigned V_77 , unsigned V_76 ,
unsigned V_78 , unsigned V_79 , int V_56 )
{
return F_40 ( V_5 ,
( ( V_67 ) V_76 << 32 ) | V_77 ,
( ( V_67 ) V_79 << 32 ) | V_78 , V_56 ) ;
}
T_1 long F_41 ( int V_5 , unsigned V_80 , unsigned V_81 ,
T_7 V_54 , int V_66 )
{
return F_34 ( V_5 , ( ( V_67 ) V_81 << 32 ) | V_80 ,
V_54 , V_66 ) ;
}
T_1 long F_42 ( int V_5 , int V_18 , unsigned V_80 ,
unsigned V_81 , unsigned V_82 ,
unsigned V_83 )
{
return F_43 ( V_5 , V_18 , ( ( V_67 ) V_81 << 32 ) | V_80 ,
( ( V_67 ) V_83 << 32 ) | V_82 ) ;
}
