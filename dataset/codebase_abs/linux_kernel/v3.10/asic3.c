...
{
struct V_137 * V_138 = V_63 -> V_41 . V_158 ;
struct V_1 * V_2 ;
struct V_139 * V_140 ;
unsigned long V_64 ;
int V_65 = 0 ;
V_2 = F_86 ( sizeof( struct V_1 ) , V_160 ) ;
if ( V_2 == NULL ) {
F_87 ( V_161 L_7 ) ;
return - V_149 ;
}
...
V_2 -> V_5 = F_80 ( V_140 -> V_145 , F_90 ( V_140 ) ) ;
if ( ! V_2 -> V_5 ) {
V_65 = - V_149 ;
F_14 ( V_2 -> V_41 , L_9 ) ;
goto V_162;
...
memcpy ( V_2 -> V_110 , V_172 , sizeof( V_172 ) ) ;
