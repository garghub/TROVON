...
if ( V_7 -> V_330 != V_331 )
return;
if ( ! F_185 ( V_7 , F_198 ( V_7 ) + sizeof( struct V_111 ) ) )
return;
V_126 = F_14 ( V_7 ) ;
V_128 = F_15 ( V_7 ) ;
if ( V_128 -> V_204 < sizeof( struct V_111 ) / 4 )
...
static void F_206 ( struct V_356 * V_129 ,
...
F_108 ( F_208 ( V_153 ) -> V_363 ) ,
V_27 -> V_25 [ 0 ] , V_27 -> V_25 [ 1 ] ,
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] ,
F_108 ( F_208 ( V_153 ) -> V_364 ) ,
V_157 ,
0 , 0 ,
1 ,
F_209 ( V_359 ) ,
V_153 -> V_365 ,
F_210 ( F_211 ( V_129 ) , V_358 ) ,
0 ,
0 ,
0 , V_153 ) ;
}
static void F_212 ( struct V_356 * V_129 , struct V_2 * V_366 , int V_357 )
{
...
F_214 ( V_370 - V_361 ) ,
V_37 -> V_378 ,
F_210 ( F_211 ( V_129 ) , F_215 ( V_366 ) ) ,
V_37 -> V_379 ,
F_216 ( V_366 ) ,
F_217 ( & V_366 -> V_380 ) , V_366 ,
F_209 ( V_37 -> V_381 ) ,
F_209 ( V_37 -> V_382 . V_383 ) ,
( V_37 -> V_382 . V_384 << 1 ) | V_37 -> V_382 . V_385 ,
V_41 -> V_386 ,
F_218 ( V_41 ) ? - 1 : V_41 -> V_387
) ;
}
static void F_219 ( struct V_356 * V_129 ,
struct V_244 * V_245 , int V_357 )
{
const struct V_4 * V_27 , * V_362 ;
T_10 V_367 , V_368 ;
const struct V_388 * V_389 = F_220 ( (struct V_2 * ) V_245 ) ;
...
V_27 -> V_25 [ 2 ] , V_27 -> V_25 [ 3 ] , V_367 ,
V_245 -> V_396 , 0 , 0 ,
3 , F_214 ( V_390 ) , 0 , 0 , 0 , 0 ,
F_217 ( & V_245 -> V_397 ) , V_245 ) ;
}
static int F_221 ( struct V_356 * V_129 , void * V_398 )
{
struct V_399 * V_400 ;
if ( V_398 == V_401 ) {
F_222 ( V_129 ,
...
case V_404 :
case V_405 :
F_212 ( V_129 , V_398 , V_400 -> V_406 ) ;
break;
case V_407 :
F_206 ( V_129 , V_400 -> V_408 , V_398 , V_400 -> V_406 , V_400 -> V_358 ) ;
break;
case V_409 :
F_219 ( V_129 , V_398 , V_400 -> V_406 ) ;
break;
}
V_138:
return 0 ;
...
V_411 -= F_229 ( struct V_34 , V_298 ) + sizeof( V_35 -> V_298 ) ;
memset ( & V_35 -> V_298 + 1 , 0 , V_411 ) ;
}
static int T_11 F_230 ( struct V_130 * V_130 )
{
return F_231 ( & V_130 -> V_220 . F_17 , V_412 ,
V_413 , V_93 , V_130 ) ;
}
...
static void T_12 F_234 ( struct V_414 * V_415 )
{
