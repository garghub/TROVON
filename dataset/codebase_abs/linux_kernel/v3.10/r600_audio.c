...
struct V_1 * V_2 ;
bool V_35 = false ;
if ( V_17 -> V_34 . V_22 != V_34 . V_22 ||
V_17 -> V_34 . V_25 != V_34 . V_25 ||
V_17 -> V_34 . V_23 != V_34 . V_23 ||
V_17 -> V_34 . V_27 != V_34 . V_27 ||
V_17 -> V_34 . V_28 != V_34 . V_28 ) {
V_17 -> V_34 = V_34 ;
V_35 = true ;
}
...
static void F_14 ( struct V_16 * V_17 , bool V_36 )
{
T_2 V_20 = 0 ;
F_15 ( L_2 , V_36 ? L_3 : L_4 ) ;
if ( F_16 ( V_17 ) ) {
if ( V_36 ) {
V_20 |= 0x81000000 ;
V_20 |= 0x0e1000f0 ;
...
F_18 ( V_38 ,
V_36 ? 0x81000000 : 0x0 , ~ 0x81000000 ) ;
}
V_17 -> V_39 = V_36 ;
}
