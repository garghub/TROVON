...
if ( V_5 )
goto V_12;
V_5 = F_12 ( V_2 , V_152 , & V_24 ) ;
if ( V_5 )
goto V_12;
V_24 &= 0xef ;
V_5 = F_11 ( V_2 , V_152 , V_24 ) ;
if ( V_5 )
goto V_12;
V_5 = F_12 ( V_2 , V_153 , & V_24 ) ;
if ( V_5 )
goto V_12;
V_24 |= 0x80 ;
V_5 = F_11 ( V_2 , V_153 , V_24 ) ;
if ( V_5 )
goto V_12;
V_5 = F_12 ( V_2 , V_153 , & V_24 ) ;
if ( V_5 )
...
V_5 = F_12 ( V_2 , V_172 , & V_8 [ 0 ] ) ;
if ( V_5 )
goto V_12;
if ( V_8 [ 0 ] != 0x83 )
goto exit;
V_5 = F_12 ( V_2 , V_183 , & V_8 [ 0 ] ) ;
if ( V_5 )
goto V_12;
V_25 = V_8 [ 0 ] ;
V_5 = F_10 ( V_2 , V_184 , V_8 , V_25 ) ;
V_5 = F_11 ( V_2 , V_172 , 0x03 ) ;
V_5 = F_11 ( V_2 , V_171 , 0x80 ) ;
V_5 = F_11 ( V_2 , V_170 , 0x80 ) ;
exit:
return V_5 ;
V_12:
F_8 ( & V_2 -> V_18 -> V_21 , L_1 , V_22 , V_5 ) ;
