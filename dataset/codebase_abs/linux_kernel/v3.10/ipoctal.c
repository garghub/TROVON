...
if ( V_6 -> V_25 == 0 )
return;
V_37 = V_6 -> V_1 . V_56 [ * V_24 ] ;
F_3 ( V_37 , & V_6 -> V_9 -> V_10 . V_57 ) ;
V_6 -> V_16 . V_17 ++ ;
( * V_24 ) ++ ;
* V_24 = * V_24 % V_58 ;
V_6 -> V_25 -- ;
...
V_70 -> V_7 -> V_123 -> V_124 -> V_125 ( V_70 -> V_7 ,
F_19 , V_70 ) ;
F_3 ( 1 , V_70 -> V_94 + 1 ) ;
V_4 = F_24 ( V_74 ) ;
if ( ! V_4 )
...
V_4 -> V_127 = V_128 ;
V_4 -> V_129 = V_130 ;
sprintf ( V_80 , V_130 L_4 , V_76 , V_77 ) ;
V_4 -> V_80 = V_80 ;
V_4 -> V_131 = 0 ;
V_4 -> V_132 = 0 ;
V_4 -> type = V_133 ;
...
V_4 -> V_139 = V_140 ;
V_4 -> V_139 . V_141 = V_142 | V_143 | V_144 | V_145 | V_146 ;
V_4 -> V_139 . V_147 = 9600 ;
V_4 -> V_139 . V_148 = 9600 ;
F_25 ( V_4 , & V_149 ) ;
V_78 = F_26 ( V_4 ) ;
if ( V_78 ) {
...
V_6 -> V_23 = 0 ;
V_6 -> V_24 = 0 ;
V_152 = F_31 ( & V_6 -> V_1 , V_4 , V_69 , NULL ) ;
if ( F_32 ( V_152 ) ) {
...
if ( V_69 <= ( V_58 - V_6 -> V_25 ) ) {
F_36 ( & V_6 -> V_59 , V_136 ) ;
V_6 -> V_1 . V_56 [ * V_23 ] = V_154 [ V_69 ] ;
* V_23 = ( * V_23 + 1 ) % V_58 ;
V_6 -> V_25 ++ ;
F_37 ( & V_6 -> V_59 , V_136 ) ;
} else {
...
default:
V_162 |= V_102 ;
V_4 -> V_165 . V_141 = ( V_161 & ~ V_167 ) | V_143 ;
break;
}
if ( V_161 & V_172 )
if ( V_161 & V_173 )
...
return - V_126 ;
V_70 -> V_7 = V_7 ;
V_78 = F_21 ( V_70 , V_7 -> V_123 -> V_76 , V_7 -> V_77 ) ;
if ( V_78 )
goto V_219;
F_34 ( & V_7 -> V_7 , V_70 ) ;
return 0 ;
...
{
int V_69 ;
V_70 -> V_7 -> V_123 -> V_124 -> V_220 ( V_70 -> V_7 ) ;
for ( V_69 = 0 ; V_69 < V_74 ; V_69 ++ ) {
struct V_5 * V_6 = & V_70 -> V_6 [ V_69 ] ;
F_53 ( V_70 -> V_150 , V_69 ) ;
F_54 ( & V_6 -> V_1 ) ;
F_33 ( & V_6 -> V_1 ) ;
}
F_55 ( V_70 -> V_150 ) ;
