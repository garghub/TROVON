...
int F_65 ( struct V_74 * V_18 , struct V_71 * V_72 )
{
...
return - V_58 ;
F_59 ( & V_2 -> V_68 ) ;
if ( F_67 ( & V_4 -> V_10 , V_72 -> V_79 , & V_43 ) ) {
F_61 ( & V_2 -> V_68 ) ;
return F_68 ( V_18 , V_72 ) ;
}
V_45 = F_69 ( V_43 , struct V_40 , V_43 ) -> V_45 ;
if ( ! V_45 ||
( ( V_45 -> V_80 & V_81 ) && ! F_70 ( V_82 ) ) ) {
V_37 = - V_83 ;
goto V_84;
}
