...
static int F_25 ( struct V_1 * V_2 , T_3 V_112 )
{
...
static int F_26 ( struct V_1 * V_2 , T_3 V_112 )
{
T_2 V_18 ;
switch ( V_112 ) {
case 6000000 :
...
return F_3 ( V_2 , V_121 , V_122 ,
V_123 , V_18 ) ;
}
static int F_27 ( struct V_12 * V_13 , int V_124 )
{
struct V_15 * V_16 = V_13 -> V_17 ;
T_2 V_18 = V_124 ;
int V_8 ;
F_10 ( L_16 , V_124 ? L_17 : L_18 ) ;
...
4 , 1 , 0x01 ) ) )
return V_8 ;
if ( ( V_8 = F_2 ( V_16 -> V_2 , V_133 , 0 ) ) )
return V_8 ;
F_10 ( L_21 ) ;
for ( V_129 = 0 ; V_129 < 150 ; V_129 ++ ) {
if ( ( V_8 =
F_5 ( V_16 -> V_2 ,
V_134 , & V_18 ) ) )
return V_8 ;
if ( V_18 & ( V_135 [ V_136 - 1 ] << V_137 ) )
break;
F_30 ( 10 ) ;
}
if ( V_129 == 150 )
...
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_16 -> V_2 , V_139 , 0x00 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_2 ( V_16 -> V_2 , 0xb200 , 0xa1 ) ;
if ( V_8 )
return V_8 ;
V_18 = V_135 [ V_136 - 1 ] << V_137 ;
if ( ( V_8 =
F_3 ( V_16 -> V_2 , V_134 ,
V_137 , V_136 , 1 ) ) )
return V_8 ;
V_8 = F_3 ( V_16 -> V_2 , V_134 ,
V_137 , V_136 , 0 ) ;
if ( V_8 )
return V_8 ;
...
return V_8 ;
F_10 ( L_31 ) ;
V_130 = sizeof( V_159 ) / sizeof( V_160 ) ;
for ( V_129 = 0 ; V_129 < V_130 ; V_129 ++ ) {
if ( ( V_8 =
F_3 ( V_16 -> V_2 , V_159 [ V_129 ] . V_161 ,
V_159 [ V_129 ] . V_5 ,
V_159 [ V_129 ] . V_6 , V_159 [ V_129 ] . V_162 ) ) )
return V_8 ;
if ( V_159 [ V_129 ] . V_161 == 0xae18 )
V_30 = V_159 [ V_129 ] . V_162 ;
if ( V_159 [ V_129 ] . V_161 == 0xae19 )
V_10 = V_159 [ V_129 ] . V_162 ;
if ( V_159 [ V_129 ] . V_161 == 0xae1a )
V_9 = V_159 [ V_129 ] . V_162 ;
if ( V_159 [ V_129 ] . V_161 == V_163 )
V_16 -> V_164 = V_159 [ V_129 ] . V_162 ;
if ( V_159 [ V_129 ] . V_161 == V_165 )
V_16 -> V_166 = V_159 [ V_129 ] . V_162 ;
if ( V_159 [ V_129 ] . V_161 == V_167 )
V_16 -> V_168 = V_159 [ V_129 ] . V_162 ;
if ( V_159 [ V_129 ] . V_161 == V_169 )
V_16 -> V_170 = V_159 [ V_129 ] . V_162 ;
}
V_16 -> V_171 =
...
return V_8 ;
if ( V_13 -> V_83 . V_84 . V_85 == NULL ) {
V_8 = F_31 ( V_126 -> V_180 , 0xc6 , V_114 , 2 ) ;
if ( V_8 ) {
F_6 ( L_33 ) ;
return V_8 ;
}
...
switch ( V_114 [ 0 ] ) {
case 2 :
V_8 = F_31 ( V_126 -> V_180 , 0xc8 , V_114 , 2 ) ;
if ( V_8 ) {
F_6 ( L_33 ) ;
return V_8 ;
}
V_131 = ( T_1 ) ( V_114 [ 0 ] << 8 ) + V_114 [ 1 ] ;
if ( F_32 ( V_181 , V_13 , & V_126 -> V_180 -> V_182 ,
& V_183 , V_131 ) == NULL ) {
F_10 ( L_35 ) ;
return - V_86 ;
}
...
case 3 :
case 9 :
if ( F_32 ( V_184 , V_13 , & V_126 -> V_180 -> V_182 ,
& V_185 ) == NULL ) {
F_10 ( L_36 ) ;
return - V_86 ;
}
...
static int F_34 ( struct V_12 * V_13 , int V_187 )
{
struct V_15 * V_16 = V_13 -> V_17 ;
if ( V_187 ) {
V_16 -> V_100 ++ ;
...
{
struct V_188 * V_189 = & V_13 -> V_190 ;
struct V_15 * V_16 = V_13 -> V_17 ;
int V_8 ;
T_2 V_18 , V_9 , V_10 , V_30 ;
F_10 ( L_39 , V_189 -> V_191 ,
V_189 -> V_192 ) ;
if ( V_13 -> V_83 . V_84 . V_85 == NULL ) {
F_6 ( L_40 ) ;
return - V_86 ;
...
if ( V_8 )
return V_8 ;
V_8 = F_3 ( V_16 -> V_2 , V_193 , 2 , 1 , 0 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_42 ) ;
V_9 = ( T_2 ) ( V_16 -> V_171 & 0x000000ff ) ;
V_10 = ( T_2 ) ( ( V_16 -> V_171 & 0x0000ff00 ) >> 8 ) ;
V_30 = ( T_2 ) ( ( V_16 -> V_171 & 0x00ff0000 ) >> 16 ) ;
...
return V_8 ;
F_10 ( L_44 ) ;
V_8 = F_26 ( V_16 -> V_2 , V_189 -> V_192 ) ;
if ( V_8 )
return V_8 ;
V_8 = F_25 ( V_16 -> V_2 , V_189 -> V_192 ) ;
if ( V_8 )
return V_8 ;
F_10 ( L_45 ) ;
...
V_16 = F_41 ( sizeof( struct V_15 ) , V_236 ) ;
if ( V_16 == NULL )
goto error;
F_10 ( L_82 ) ;
V_16 -> V_2 = V_2 ;
V_16 -> V_100 = 0 ;
memcpy ( & V_16 -> V_237 . V_83 , & V_238 ,
sizeof( struct V_239 ) ) ;
V_16 -> V_237 . V_17 = V_16 ;
return & V_16 -> V_237 ;
error:
return NULL ;
}
