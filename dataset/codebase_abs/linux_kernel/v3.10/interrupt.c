...
static T_3 F_33 ( int V_23 , void * V_24 )
{
struct V_3 * V_4 = V_24 ;
T_1 V_25 = V_4 -> V_47 ;
F_11 ( V_4 , L_17 , V_25 ) ;
...
static int F_36 ( struct V_3 * V_4 , T_1 V_50 )
{
if ( ! F_37 ( V_14 , & V_4 -> V_15 ) ) {
...
static T_3 F_38 ( int V_23 , void * V_24 )
{
T_3 V_63 = V_29 ;
struct V_3 * V_4 = V_24 ;
...
static int F_39 ( struct V_3 * V_4 , int V_23 )
{
int V_63 ;
V_63 = F_40 ( V_23 , F_23 , V_68 ,
V_69 L_26 , V_4 ) ;
if ( V_63 )
return V_63 ;
V_63 = F_40 ( V_23 + 1 , F_20 , V_68 ,
V_69 L_27 , V_4 ) ;
if ( V_63 )
goto V_70;
V_63 = F_41 ( V_23 + 2 , F_32 ,
F_33 ,
V_68 , V_69 L_28 , V_4 ) ;
if ( V_63 )
goto V_71;
...
int F_43 ( struct V_3 * V_4 , int V_23 )
{
int V_63 ;
if ( V_4 -> V_72 == 3 )
V_63 = F_39 ( V_4 , V_23 ) ;
...
void F_44 ( struct V_3 * V_4 , int V_23 )
{
F_18 ( V_4 ) ;
F_42 ( V_23 , V_4 ) ;
if ( V_4 -> V_72 == 3 ) {
