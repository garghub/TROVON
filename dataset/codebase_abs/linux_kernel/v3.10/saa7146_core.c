...
static void F_60 ( struct V_29 * V_117 )
{
struct V_118 * V_116 = F_61 ( V_117 ) ;
struct V_1 * V_2 = F_62 ( V_116 ) ;
struct {
void * V_119 ;
T_3 V_47 ;
} V_120 [] = {
...
F_4 ( V_2 , V_89 , 0 ) ;
F_56 ( V_117 -> V_56 , V_2 ) ;
for ( V_54 = V_120 ; V_54 -> V_119 ; V_54 ++ )
F_30 ( V_117 , V_96 , V_54 -> V_119 , V_54 -> V_47 ) ;
F_57 ( V_2 -> V_35 ) ;
F_58 ( V_117 , 0 ) ;
F_59 ( V_117 ) ;
F_20 ( V_2 ) ;
...
int F_63 ( struct V_82 * V_62 )
{
F_42 ( L_18 , V_62 ) ;
V_62 -> V_122 . V_13 = V_62 -> V_13 ;
V_62 -> V_122 . V_123 = V_62 -> V_124 ;
V_62 -> V_122 . V_113 = F_40 ;
V_62 -> V_122 . remove = F_60 ;
F_50 ( L_19 , V_62 -> V_13 ) ;
return F_64 ( & V_62 -> V_122 ) ;
}
int F_65 ( struct V_82 * V_62 )
{
F_42 ( L_18 , V_62 ) ;
F_50 ( L_20 , V_62 -> V_13 ) ;
F_66 ( & V_62 -> V_122 ) ;
