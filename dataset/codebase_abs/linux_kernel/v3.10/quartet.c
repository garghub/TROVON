...
static struct V_58 * F_40 ( struct V_95 * V_57 ,
const char * V_77 )
{
struct V_96 V_97 ;
...
static void F_42 ( struct V_95 * V_57 ,
struct V_58 * V_100 , char * const * V_101 )
{
for (; * V_101 ; V_101 ++ ) {
...
static int F_44 ( struct V_9 * V_20 )
{
struct V_45 * V_46 = V_20 -> V_46 ;
int V_103 , V_3 ;
struct V_58 * V_104 ;
...
static int F_63 ( struct V_9 * V_20 )
{
