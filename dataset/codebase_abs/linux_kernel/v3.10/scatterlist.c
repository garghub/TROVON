...
( V_43 << V_39 ) - V_49 -> V_55 ;
V_49 -> V_54 = F_42 (unsigned long, miter->__remaining,
PAGE_SIZE - miter->__offset) ;
}
V_49 -> V_29 = F_43 ( & V_49 -> V_41 ) ;
V_49 -> V_56 = V_49 -> V_47 = V_49 -> V_54 ;
if ( V_49 -> V_53 & V_57 )
V_49 -> V_58 = F_44 ( V_49 -> V_29 ) + V_49 -> V_55 ;
else
V_49 -> V_58 = F_45 ( V_49 -> V_29 ) + V_49 -> V_55 ;
return true ;
}
void F_41 ( struct V_48 * V_49 )
{
...
static T_4 F_50 ( struct V_1 * V_6 , unsigned int V_5 ,
...
V_60 |= V_51 ;
F_38 ( & V_49 , V_6 , V_5 , V_60 ) ;
F_51 ( V_50 ) ;
while ( F_40 ( & V_49 ) && V_32 < V_10 ) {
unsigned int V_61 ;
...
T_4 F_53 ( struct V_1 * V_6 , unsigned int V_5 ,
void * V_9 , T_4 V_10 )
{
return F_50 ( V_6 , V_5 , V_9 , V_10 , 0 ) ;
}
T_4 F_54 ( struct V_1 * V_6 , unsigned int V_5 ,
void * V_9 , T_4 V_10 )
{
return F_50 ( V_6 , V_5 , V_9 , V_10 , 1 ) ;
}
