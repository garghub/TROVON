...
{
struct V_6 * V_7 = F_3 ( V_2 , struct V_6 ,
V_2 ) ;
T_1 V_8 ;
...
struct V_23 * V_24 ;
int V_25 ;
V_24 = F_11 ( V_18 , V_26 , 0 ) ;
if ( ! V_24 ) {
F_12 ( & V_18 -> V_21 , L_1 ) ;
return - V_27 ;
}
V_7 = F_13 ( & V_18 -> V_21 , sizeof( * V_7 ) , V_28 ) ;
if ( ! V_7 ) {
F_12 ( & V_18 -> V_21 , L_2 ) ;
return - V_29 ;
}
V_7 -> V_9 = F_14 ( & V_18 -> V_21 , V_24 ) ;
if ( F_15 ( V_7 -> V_9 ) )
return F_16 ( V_7 -> V_9 ) ;
if ( F_17 ( V_20 , L_3 ,
& V_7 -> V_10 ) )
...
V_7 -> V_2 . V_36 = F_1 ;
V_7 -> V_2 . V_37 = F_2 ;
V_7 -> V_2 . V_38 = F_19 ( & V_18 -> V_21 ) ;
V_7 -> V_2 . V_21 = & V_18 -> V_21 ;
V_7 -> V_2 . V_39 = V_40 ;
V_7 -> V_11 = - 1 ;
V_25 = F_20 ( & V_7 -> V_2 ) ;
if ( V_25 ) {
