...
static void F_64 ( struct V_6 * V_7 , int V_164 )
{
struct V_10 * V_11 = F_8 ( V_7 ) ;
if ( ! V_164 ) {
...
V_11 = F_8 ( V_7 ) ;
if ( V_11 -> V_38 == V_39 ) {
unsigned char * V_169 = V_167 ;
int V_126 , V_170 , V_171 ;
V_133 = 0 ;
F_68 ( & V_7 -> V_172 , V_33 ) ;
for ( V_126 = 0 ; V_126 < V_168 - 1 ; V_126 += V_11 -> V_129 ) {
V_170 = F_69 ( int , V_168 - V_126 , V_11 -> V_129 ) - 1 ;
V_171 = F_70 ( & V_7 -> V_173 , & V_169 [ V_126 + 1 ] , V_170 ) ;
if ( ! V_171 )
break;
V_7 -> V_174 . V_175 += V_171 ;
V_169 [ V_126 ] = ( V_171 << 2 ) + 1 ;
V_133 += V_171 + 1 ;
}
F_71 ( & V_7 -> V_172 , V_33 ) ;
} else {
V_133 = F_72 ( & V_7 -> V_173 , V_167 , V_168 ,
& V_7 -> V_172 ) ;
V_7 -> V_174 . V_175 += V_133 ;
}
return V_133 ;
}
static int F_73 ( struct V_6 * V_7 ,
struct V_10 * V_11 , char * V_176 , int V_170 )
{
int V_126 ;
char V_177 ;
char V_178 ;
...
V_7 -> V_174 . V_196 ++ ;
F_75 ( V_7 ) ;
} else if ( V_176 [ 1 ] & V_197 ) {
V_178 = V_198 ;
V_7 -> V_174 . V_199 ++ ;
} else if ( V_176 [ 1 ] & V_200 ) {
V_178 = V_201 ;
V_7 -> V_174 . V_202 ++ ;
}
if ( V_176 [ 1 ] & V_203 ) {
V_7 -> V_174 . V_204 ++ ;
F_76 ( & V_7 -> V_7 , 0 , V_205 ) ;
}
}
if ( V_176 [ 1 ] & V_206 )
V_11 -> V_104 = 1 ;
...
if ( ! V_170 )
return 0 ;
V_7 -> V_174 . V_207 += V_170 ;
V_179 = V_176 + 2 ;
if ( V_7 -> V_7 . V_208 && V_7 -> V_209 ) {
for ( V_126 = 0 ; V_126 < V_170 ; V_126 ++ , V_179 ++ ) {
if ( ! F_77 ( V_7 , * V_179 ) )
F_76 ( & V_7 -> V_7 , * V_179 , V_178 ) ;
}
} else {
F_78 ( & V_7 -> V_7 , V_179 , V_178 , V_170 ) ;
}
return V_170 ;
}
static void F_79 ( struct V_210 * V_210 )
{
struct V_6 * V_7 = V_210 -> V_211 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
char * V_212 = ( char * ) V_210 -> V_213 ;
int V_126 ;
int V_170 ;
int V_133 = 0 ;
for ( V_126 = 0 ; V_126 < V_210 -> V_214 ; V_126 += V_11 -> V_129 ) {
V_170 = F_69 ( int , V_210 -> V_214 - V_126 , V_11 -> V_129 ) ;
V_133 += F_73 ( V_7 , V_11 , & V_212 [ V_126 ] , V_170 ) ;
}
if ( V_133 )
F_80 ( & V_7 -> V_7 ) ;
}
static void F_81 ( struct V_29 * V_30 , int V_215 )
{
struct V_6 * V_7 = V_30 -> V_216 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
T_2 V_14 ;
if ( V_215 )
V_14 = V_11 -> V_217 | V_218 ;
else
V_14 = V_11 -> V_217 ;
if ( F_10 ( V_7 -> V_23 -> V_13 ,
F_11 ( V_7 -> V_23 -> V_13 , 0 ) ,
...
static bool F_82 ( struct V_6 * V_7 )
{
...
struct V_6 * V_7 , struct V_159 * V_221 )
{
struct V_72 * V_13 = V_7 -> V_23 -> V_13 ;
struct V_12 * V_222 = & V_7 -> V_13 ;
struct V_10 * V_11 = F_8 ( V_7 ) ;
struct V_159 * V_223 = & V_30 -> V_223 ;
unsigned int V_224 = V_223 -> V_225 ;
T_2 V_14 ;
unsigned int V_226 = V_223 -> V_227 ;
unsigned char V_228 ;
unsigned char V_229 ;
if ( V_11 -> V_149 && ( ( V_223 -> V_225 & V_230 ) != V_231 ) ) {
F_9 ( V_222 , L_38 , V_18 ) ;
...
if ( ! V_221 )
goto V_233;
if ( V_221 -> V_225 == V_223 -> V_225
&& V_221 -> V_234 == V_223 -> V_234
&& V_221 -> V_235 == V_223 -> V_235 )
goto V_236;
if ( ( V_221 -> V_225 & ( V_237 | V_238 | V_239 | V_240 | V_241 ) ) ==
( V_223 -> V_225 & ( V_237 | V_238 | V_239 | V_240 | V_241 ) ) )
goto V_242;
V_233:
V_14 = 0 ;
V_14 |= ( V_224 & V_241 ? V_243 :
V_244 ) ;
if ( V_224 & V_239 ) {
if ( V_224 & V_240 )
V_14 |= V_224 & V_238 ?
...
F_28 ( & V_11 -> V_91 ) ;
if ( F_17 ( V_30 , V_7 ) )
F_19 ( V_222 , L_45 , V_18 ) ;
F_30 ( & V_11 -> V_91 ) ;
if ( ! V_221 || ( V_221 -> V_225 & V_230 ) == V_231 )
F_65 ( V_7 , V_16 | V_17 ) ;
}
V_236:
if ( V_224 & V_232 ) {
...
F_9 ( V_222 , L_48 ,
V_18 , V_226 ) ;
V_229 = V_223 -> V_254 [ V_255 ] ;
V_228 = V_223 -> V_254 [ V_256 ] ;
V_14 = ( V_228 << 8 ) | ( V_229 ) ;
if ( F_10 ( V_13 ,
F_11 ( V_13 , 0 ) ,
V_165 ,
...
V_177 [ 1 ] = 0 ;
F_9 ( & V_7 -> V_13 , L_54 , V_18 , V_177 [ 0 ] ,
V_177 [ 1 ] ) ;
V_258:
F_23 ( V_79 ) ;
return V_147 ;
...
if ( V_147 < 0 )
return V_147 ;
V_147 = ( V_79 [ 0 ] & V_261 ? V_262 : 0 ) |
( V_79 [ 0 ] & V_263 ? V_264 : 0 ) |
( V_79 [ 0 ] & V_265 ? V_266 : 0 ) |
( V_79 [ 0 ] & V_267 ? V_268 : 0 ) |
V_11 -> V_28 ;
return V_147 ;
}
...
{
struct V_6 * V_7 = V_30 -> V_216 ;
F_9 ( & V_7 -> V_13 , L_55 , V_18 , V_269 ) ;
switch ( V_269 ) {
case V_271 :
return F_24 ( V_7 ,
(struct V_84 T_3 * ) V_270 ) ;
case V_272 :
return F_26 ( V_30 , V_7 ,
(struct V_84 T_3 * ) V_270 ) ;
case V_273 :
return F_31 ( V_7 , (struct V_84 T_3 * ) V_270 ) ;
break;
default:
break;
}
...
if ( V_275 > 0 && V_154 > 0 ) {
int V_126 ;
for ( V_126 = 0 ; V_276 [ V_126 ] . V_277 ; V_126 ++ )
;
V_276 [ V_126 ] . V_278 = V_279 ;
V_276 [ V_126 ] . V_277 = V_275 ;
V_276 [ V_126 ] . V_57 = V_154 ;
}
return F_88 ( V_280 , V_281 , V_276 ) ;
}
