...
strcpy ( V_4 -> V_7 . V_8 . V_99 , V_100 ) ;
V_4 -> V_7 . V_8 . type = V_101 ;
V_4 -> V_7 . V_8 . V_102 = 1 ;
V_4 -> V_7 . V_8 . V_103 = 1 ;
V_4 -> V_7 . V_8 . V_104 = 0 ;
V_4 -> V_7 . V_8 . V_105 = V_106 ;
V_4 -> V_7 . V_107 = & V_108 ;
V_4 -> V_7 . V_109 = V_110
| V_111
| V_112
...
V_4 -> V_7 . V_117 = - 1 ;
V_90 = V_4 ;
V_90 = V_90 + sizeof( struct V_3 ) ;
V_4 -> V_7 . V_76 = V_90 ;
V_87 = F_17 ( V_85 , V_118 , 0 ) ;
V_4 -> V_6 = F_18 ( & V_85 -> V_61 , V_87 ) ;
if ( F_19 ( V_4 -> V_6 ) )
return F_20 ( V_4 -> V_6 ) ;
V_89 = F_21 ( V_85 -> V_61 . V_119 ) ;
if ( ! V_89 )
return - V_47 ;
V_72 = F_22 ( V_85 -> V_61 . V_119 , & V_92 , V_120 ) ;
if ( V_72 )
return V_72 ;
V_72 = F_23 ( V_85 -> V_61 . V_119 , L_3 , & V_93 ) ;
if ( V_72 )
return V_72 ;
F_24 ( & V_4 -> V_7 . V_14 , & V_92 ) ;
V_4 -> V_7 . V_14 . V_121 = 0 ;
V_4 -> V_7 . V_14 . V_122 = V_123 ;
V_4 -> V_7 . V_14 . V_124 = - 1 ;
V_4 -> V_7 . V_14 . V_125 = - 1 ;
V_95 = V_92 . V_15 * V_92 . V_33 * 2 * ( V_93 / 8 ) ;
...
V_4 -> V_7 . V_14 . V_17 = V_92 . V_15 ;
V_4 -> V_7 . V_14 . V_127 = V_92 . V_33 * 2 ;
V_4 -> V_7 . V_14 . V_48 = V_93 ;
V_4 -> V_7 . V_8 . V_9 = V_94 ;
V_4 -> V_7 . V_8 . V_128 = V_95 ;
V_4 -> V_7 . V_129 = V_96 ;
V_4 -> V_7 . V_130 = V_95 ;
V_4 -> V_58 = 0x10 ;
V_72 = F_5 ( & V_4 -> V_7 ) ;
...
F_16 ( & V_85 -> V_61 ,
L_7 , V_72 ) ;
if ( V_4 -> V_7 . V_131 . V_132 )
F_30 ( & V_4 -> V_7 . V_131 ) ;
return V_72 ;
}
V_72 = F_31 ( & V_85 -> V_61 , & V_133 ) ;
if ( V_72 < 0 ) {
F_32 ( V_134 L_8 ,
V_4 -> V_7 . V_117 , V_72 ) ;
}
F_32 ( V_135 L_9 ,
V_4 -> V_7 . V_117 , V_4 -> V_7 . V_8 . V_99 , V_4 -> V_7 . V_8 . V_9 ,
V_4 -> V_7 . V_8 . V_9 + V_4 -> V_7 . V_8 . V_128 - 1 ) ;
return 0 ;
}
static int F_33 ( struct V_84 * V_85 )
{
struct V_3 * V_4 = F_34 ( V_85 ) ;
F_35 ( & V_85 -> V_61 , & V_133 ) ;
F_36 ( & V_4 -> V_7 ) ;
F_3 ( 0 , V_4 -> V_6 ) ;
if ( V_4 -> V_7 . V_131 . V_132 )
F_30 ( & V_4 -> V_7 . V_131 ) ;
