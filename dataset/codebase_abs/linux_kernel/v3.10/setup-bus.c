...
goto V_48;
F_11 (dev_res, head, list) {
if ( F_5 ( & V_45 , V_4 -> V_8 , V_4 -> V_10 , 0 , 0 ) ) {
F_1 ( & V_45 ) ;
goto V_48;
}
}
...
static void F_31 ( const struct V_50 * V_51 ,
struct V_1 * V_36 ,
struct V_1 * V_42 )
{
struct V_7 * V_8 ;
...
static void F_41 ( struct V_50 * V_51 , unsigned long type )
{
struct V_7 * V_52 = V_51 -> V_53 ;
F_33 ( & V_52 -> V_8 , L_9 ,
& V_51 -> V_56 ) ;
...
static struct V_9 * F_45 ( struct V_50 * V_51 , unsigned long type )
{
int V_20 ;
struct V_9 * V_22 ;
...
if ( V_103 == 1 )
V_103 = 0 ;
#if F_48 ( V_104 ) || F_48 ( V_105 )
V_100 = ( V_100 & 0xff ) + ( ( V_100 & ~ 0xffUL ) << 2 ) ;
#endif
V_100 = F_49 ( V_100 + V_102 , V_27 ) ;
if ( V_100 < V_103 )
V_100 = V_103 ;
return V_100 ;
}
static T_1 F_50 ( T_1 V_100 ,
T_1 V_101 ,
T_1 V_102 ,
T_1 V_103 ,
T_1 V_27 )
...
T_1 __weak F_51 ( struct V_50 * V_51 ,
unsigned long type )
{
return 1 ;
}
static T_1 F_52 ( struct V_50 * V_51 ,
unsigned long type )
{
T_1 V_27 = 1 , V_106 ;
if ( type & V_62 )
...
V_106 = F_51 ( V_51 , type ) ;
return F_53 ( V_27 , V_106 ) ;
}
static void F_54 ( struct V_50 * V_51 , T_1 V_101 ,
T_1 V_11 , struct V_1 * V_36 )
{
struct V_7 * V_8 ;
struct V_9 * V_89 = F_45 ( V_51 , V_57 ) ;
unsigned long V_100 = 0 , V_110 = 0 , V_102 = 0 ;
T_1 V_111 = 0 ;
T_1 V_12 , V_112 , V_27 ;
if ( ! V_89 )
return;
V_112 = V_12 = F_52 ( V_51 , V_57 ) ;
F_11 (dev, &bus->devices, bus_list) {
int V_20 ;
for ( V_20 = 0 ; V_20 < V_21 ; V_20 ++ ) {
...
if ( V_12 > V_112 )
V_12 = V_112 ;
V_110 = F_47 ( V_100 , V_101 , V_102 ,
F_22 ( V_89 ) , V_12 ) ;
if ( V_111 > V_11 )
V_11 = V_111 ;
V_102 = ( ! V_36 || ( V_36 && ! V_11 ) ) ? V_110 :
F_47 ( V_100 , V_101 , V_11 + V_102 ,
F_22 ( V_89 ) , V_12 ) ;
if ( ! V_110 && ! V_102 ) {
if ( V_89 -> V_15 || V_89 -> V_16 )
F_33 ( & V_51 -> V_53 -> V_8 , L_10
L_11 , V_89 ,
& V_51 -> V_56 ) ;
V_89 -> V_17 = 0 ;
return;
...
V_89 -> V_17 |= V_40 ;
if ( V_102 > V_110 && V_36 ) {
F_5 ( V_36 , V_51 -> V_53 , V_89 , V_102 - V_110 ,
V_12 ) ;
F_12 ( V_19 , & V_51 -> V_53 -> V_8 , L_12
L_13 , V_89 ,
& V_51 -> V_56 , V_102 - V_110 ) ;
}
}
static inline T_1 F_55 ( T_1 * V_114 ,
int V_115 )
{
T_1 V_27 = 0 ;
T_1 V_12 = 0 ;
...
if ( ! V_27 )
V_12 = V_117 ;
else if ( F_49 ( V_27 + V_12 , V_12 ) < V_117 )
V_12 = V_117 >> 1 ;
V_27 += V_114 [ V_116 ] ;
}
return V_12 ;
}
static int F_56 ( struct V_50 * V_51 , unsigned long V_118 ,
...
T_1 V_114 [ 12 ] ;
int V_116 , V_115 ;
struct V_9 * V_89 = F_45 ( V_51 , type ) ;
...
V_12 = F_55 ( V_114 , V_115 ) ;
V_12 = F_53 ( V_12 , F_52 ( V_51 , V_89 -> V_17 & V_118 ) ) ;
V_110 = F_50 ( V_100 , V_101 , 0 , F_22 ( V_89 ) , V_12 ) ;
if ( V_111 > V_11 )
V_11 = V_111 ;
V_102 = ( ! V_36 || ( V_36 && ! V_11 ) ) ? V_110 :
F_50 ( V_100 , V_101 , V_11 ,
F_22 ( V_89 ) , V_12 ) ;
if ( ! V_110 && ! V_102 ) {
if ( V_89 -> V_15 || V_89 -> V_16 )
F_33 ( & V_51 -> V_53 -> V_8 , L_10
...
if ( V_102 > V_110 && V_36 ) {
F_5 ( V_36 , V_51 -> V_53 , V_89 , V_102 - V_110 , V_12 ) ;
F_12 ( V_19 , & V_51 -> V_53 -> V_8 , L_12
L_16 , V_89 ,
& V_51 -> V_56 , ( unsigned long long ) V_102 - V_110 ) ;
}
return 1 ;
}
unsigned long F_59 ( struct V_9 * V_10 )
{
if ( V_10 -> V_17 & V_57 )
return V_122 ;
if ( V_10 -> V_17 & V_62 )
...
static void F_60 ( struct V_50 * V_51 ,
struct V_1 * V_36 )
{
struct V_7 * V_52 = V_51 -> V_53 ;
...
void T_5 F_61 ( struct V_50 * V_51 ,
struct V_1 * V_36 )
{
struct V_7 * V_8 ;
...
default:
F_54 ( V_51 , V_36 ? 0 : V_135 ,
V_135 , V_36 ) ;
V_118 = V_62 ;
V_133 = V_62 | V_81 ;
if ( F_56 ( V_51 , V_133 , V_133 ,
V_36 ? 0 : V_134 ,
V_134 , V_36 ) )
V_118 = V_133 ;
else
V_134 += V_134 ;
F_56 ( V_51 , V_118 , V_62 ,
V_36 ? 0 : V_134 ,
V_134 , V_36 ) ;
break;
}
}
void T_5 F_62 ( struct V_50 * V_51 )
{
F_61 ( V_51 , NULL ) ;
}
void T_5 F_63 ( const struct V_50 * V_51 ,
struct V_1 * V_36 ,
struct V_1 * V_42 )
{
struct V_50 * V_136 ;
...
default:
F_33 ( & V_8 -> V_8 , L_17
L_18 , F_65 ( V_136 ) , V_136 -> V_143 ) ;
break;
}
}
}
void T_5 F_66 ( const struct V_50 * V_51 )
{
F_63 ( V_51 , NULL , NULL ) ;
}
static void T_5 F_67 ( const struct V_7 * V_52 ,
struct V_1 * V_49 ,
struct V_1 * V_42 )
{
struct V_50 * V_136 ;
F_30 ( (struct V_7 * ) V_52 ,
V_49 , V_42 ) ;
V_136 = V_52 -> V_137 ;
if ( ! V_136 )
return;
F_63 ( V_136 , V_49 , V_42 ) ;
switch ( V_52 -> V_28 >> 8 ) {
case V_139 :
F_43 ( V_136 ) ;
break;
...
static void T_5 F_70 ( struct V_50 * V_51 ,
unsigned long type ,
enum V_146 V_147 )
{
struct V_7 * V_8 ;
...
continue;
F_12 ( V_19 , & V_51 -> V_8 , L_20 , V_20 , V_10 ) ;
}
}
...
static int T_6 F_74 ( struct V_50 * V_51 )
{
int V_150 = 0 ;
struct V_7 * V_8 ;
F_11 (dev, &bus->devices, bus_list) {
...
V_160 + 1 ) ;
F_11 (fail_res, &fail_head, list) {
struct V_50 * V_51 = V_162 -> V_8 -> V_51 ;
