...
( int ) V_84 -> V_97 , V_84 -> V_66 , V_84 -> V_67 ) ;
} else {
F_9 ( L_11 , V_84 -> V_53 -> V_30 . V_31 ) ;
return F_36 ( V_84 -> V_53 ) ;
}
V_2 = V_84 -> V_53 -> V_2 ;
V_85 = F_38 ( V_2 -> V_12 . V_98 *
sizeof( struct V_52 ) , V_99 ) ;
if ( ! V_85 )
return - V_100 ;
V_87 = F_38 ( V_2 -> V_12 . V_101 *
sizeof( struct V_50 ) , V_99 ) ;
if ( ! V_87 ) {
F_39 ( V_85 ) ;
return - V_100 ;
}
V_91 = F_38 ( V_2 -> V_12 . V_102 *
sizeof( struct V_3 ) , V_99 ) ;
if ( ! V_91 ) {
F_39 ( V_85 ) ;
F_39 ( V_87 ) ;
return - V_100 ;
...
V_89 = true ;
} else if ( V_84 -> V_62 -> V_103 != V_84 -> V_53 -> V_62 -> V_103 ) {
V_89 = true ;
} else if ( V_84 -> V_62 -> V_104 !=
V_84 -> V_53 -> V_62 -> V_104 ) {
V_89 = true ;
} else if ( V_84 -> V_62 -> V_105 !=
V_84 -> V_53 -> V_62 -> V_105 ) {
V_89 = true ;
} else
V_90 = true ;
}
...
V_90 = true ;
if ( V_84 -> V_16 && ! F_40 ( V_84 -> V_16 , & V_84 -> V_53 -> V_16 ) ) {
F_9 ( L_13 ) ;
F_23 ( & V_84 -> V_53 -> V_16 ) ;
F_23 ( V_84 -> V_16 ) ;
V_89 = true ;
...
V_4 -> V_26 ;
V_88 = V_4 -> V_51 ;
for ( V_92 = 0 ; V_92 < V_84 -> V_97 ; V_92 ++ ) {
if ( V_84 -> V_106 [ V_92 ] == V_4 ) {
V_88 = V_25 -> V_107 ( V_4 ) ;
if ( V_88 == NULL )
V_93 = 1 ;
break;
...
F_9 ( L_21 ) ;
for ( V_95 = 0 ; V_95 < V_84 -> V_97 ; V_95 ++ ) {
F_9 ( L_22 , V_84 -> V_106 [ V_95 ] -> V_30 . V_31 ,
F_10 ( V_84 -> V_106 [ V_95 ] ) ) ;
V_84 -> V_106 [ V_95 ] -> V_37 -> V_57 ( V_84 -> V_106 [ V_95 ] , V_109 ) ;
}
}
F_27 ( V_2 ) ;
} else if ( V_90 ) {
...
int F_45 ( struct V_68 * V_62 ,
struct V_111 * V_112 )
{
int V_95 ;
V_62 -> V_113 = V_112 -> V_113 ;
V_62 -> V_114 = V_112 -> V_114 ;
for ( V_95 = 0 ; V_95 < 4 ; V_95 ++ ) {
V_62 -> V_115 [ V_95 ] = V_112 -> V_115 [ V_95 ] ;
V_62 -> V_116 [ V_95 ] = V_112 -> V_116 [ V_95 ] ;
}
F_46 ( V_112 -> V_105 , & V_62 -> V_103 ,
& V_62 -> V_104 ) ;
V_62 -> V_105 = V_112 -> V_105 ;
return 0 ;
}
...
{
struct V_120 * V_120 = F_51 ( V_119 ) ;
struct V_1 * V_2 = F_52 ( V_120 , struct V_1 , V_12 . V_121 ) ;
struct V_3 * V_4 ;
enum V_122 V_123 ;
...
if ( V_134 )
F_56 ( & V_2 -> V_12 . V_121 , V_132 ) ;
}
void F_59 ( struct V_1 * V_2 )
{
F_60 ( & V_2 -> V_12 . V_121 , F_50 ) ;
V_2 -> V_12 . V_133 = true ;
F_11 ( V_2 ) ;
}
