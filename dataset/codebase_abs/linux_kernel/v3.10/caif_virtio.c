...
goto V_24;
V_24 = V_5 -> V_112 -> V_113 ( V_5 , 1 , & V_4 -> V_50 , & V_108 ) ;
if ( V_24 )
goto V_24;
V_24 = V_5 -> V_114 -> V_115 ( V_5 , 1 , & V_4 -> V_2 , & V_107 , & V_109 ) ;
if ( V_24 )
goto V_24;
#define F_80 ( T_5 , T_6 , T_7 ) \
((_v)->config->get(_v, offsetof(struct virtio_caif_transf_config, _f), \
&_var, \
FIELD_SIZEOF(struct virtio_caif_transf_config, _f)))
if ( V_5 -> V_114 -> V_116 ) {
F_80 ( V_5 , V_4 -> V_73 , V_117 ) ;
F_80 ( V_5 , V_4 -> V_31 , V_117 ) ;
F_80 ( V_5 , V_4 -> V_74 , V_118 ) ;
F_80 ( V_5 , V_4 -> V_32 , V_118 ) ;
F_80 ( V_5 , V_4 -> V_75 , V_75 ) ;
F_80 ( V_5 , V_4 -> V_30 , V_75 ) ;
} else {
V_4 -> V_73 = V_119 ;
V_4 -> V_31 = V_119 ;
V_4 -> V_74 = V_120 ;
...
if ( V_4 -> V_50 )
V_5 -> V_112 -> V_124 ( V_4 -> V_5 ) ;
if ( V_4 -> V_5 )
V_5 -> V_114 -> V_125 ( V_4 -> V_5 ) ;
V_104 ( V_79 ) ;
return V_24 ;
}
