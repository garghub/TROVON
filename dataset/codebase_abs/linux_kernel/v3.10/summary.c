...
V_126 = V_2 -> V_6 -> V_3 + sizeof( struct V_129 ) ;
V_125 = sizeof( struct V_75 ) + V_126 ;
V_127 = V_62 -> V_74 - V_125 ;
V_125 += V_127 ;
V_126 += V_127 ;
V_113 = F_52 ( V_2 , V_62 , V_125 , V_126 , V_127 ) ;
F_54 ( & V_2 -> V_143 ) ;
return V_113 ;
}
