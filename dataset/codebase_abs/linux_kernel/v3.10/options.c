...
int F_30 ( struct V_9 * V_10 , T_3 V_26 )
{
const int V_76 = F_29 ( V_26 ) ;
const int V_2 = 2 + V_76 ;
unsigned char * V_66 ;
if ( V_76 == 0 )
return 0 ;
if ( F_4 ( V_10 ) -> V_71 + V_2 > V_72 )
...
* V_66 ++ = V_2 ;
if ( V_76 == 2 ) {
const T_5 V_77 = F_31 ( ( V_78 ) V_26 ) ;
memcpy ( V_66 , & V_77 , 2 ) ;
} else {
const T_4 V_79 = F_32 ( V_26 ) ;
memcpy ( V_66 , & V_79 , 4 ) ;
}
return 0 ;
}
...
{
T_4 V_80 = F_32 ( F_13 () ) ;
return F_25 ( V_10 , V_45 , & V_80 , sizeof( V_80 ) ) ;
}
...
static int F_35 ( struct V_5 * V_6 , struct V_9 * V_10 )
{
struct V_11 * V_12 = F_3 ( V_6 ) ;
struct V_82 * V_83 = V_12 -> V_84 ;
struct V_85 * V_86 = F_4 ( V_10 ) ;
const V_78 V_87 = F_36 ( V_83 ) ;
const T_2 V_88 = F_37 ( V_87 , V_89 ) ;
V_78 V_2 = V_87 + 2 * V_88 ;
T_2 V_90 , V_91 = 0 ;
...
int F_41 ( struct V_9 * V_10 , T_2 type , T_2 V_105 ,
...
int F_43 ( struct V_5 * V_6 , struct V_9 * V_10 )
{
struct V_11 * V_12 = F_3 ( V_6 ) ;
F_4 ( V_10 ) -> V_71 = 0 ;
...
int F_47 ( struct V_7 * V_8 , struct V_9 * V_10 )
{
F_4 ( V_10 ) -> V_71 = 0 ;
if ( F_44 ( NULL , V_8 , V_10 ) )
return - 1 ;
if ( F_33 ( V_10 ) )
return - 1 ;
if ( V_8 -> V_46 != 0 &&
