...
static T_9 F_172 ( struct V_357 * V_358 ,
struct V_359 * V_360 , char * V_192 )
{
return sprintf ( V_192 , L_10 , V_100 + 1 ) ;
}
int T_8 F_173 ( const struct V_361 * V_362 )
{
F_174 ( & V_363 , V_362 ) ;
if ( F_175 ( & V_363 , F_176 ( V_364 , 0 ) , 1 ) ||
F_177 ( F_176 ( V_364 , 0 ) , 1 , L_11 ) < 0 )
F_178 ( L_12 ) ;
V_103 = F_179 ( V_365 , NULL , F_176 ( V_364 , 0 ) , NULL , L_13 ) ;
if ( F_180 ( V_103 ) )
V_103 = NULL ;
else
F_181 ( F_182 ( V_103 , & V_366 ) < 0 ) ;
F_183 () ;
V_301 = F_184 ( V_108 ) ;
if ( ! V_301 )
F_178 ( L_14 ) ;
...
V_301 -> V_372 = V_373 ;
if ( V_232 )
V_301 -> V_372 . V_331 |= V_332 ;
V_301 -> V_374 = V_375 | V_376 ;
F_185 ( V_301 , & V_377 ) ;
if ( F_186 ( V_301 ) )
F_178 ( L_16 ) ;
F_187 () ;
...
static int F_191 ( const struct V_378 * V_379 , int V_257 , int V_258 ,
int V_380 )
{
struct V_381 * V_111 = V_379 -> V_111 ;
const char * V_347 = NULL ;
struct V_344 * V_344 ;
int V_79 , V_246 = - 1 , V_335 = - 1 , V_323 = - V_382 ;
if ( ! F_192 ( V_111 ) )
return - V_382 ;
F_21 () ;
for ( V_79 = 0 ; V_79 < V_343 ; V_79 ++ ) {
V_344 = & V_345 [ V_79 ] ;
if ( V_344 -> V_346 == V_379 ) {
V_347 = V_344 -> V_347 ;
V_323 = 0 ;
break;
}
...
static int F_193 ( const struct V_378 * V_379 , int V_257 , int V_258 ,
int V_380 )
{
int V_169 ;
F_71 () ;
V_169 = F_191 ( V_379 , V_257 , V_258 , V_380 ) ;
F_72 () ;
return V_169 ;
}
static int F_194 ( const struct V_378 * V_379 , int V_257 , int V_258 )
{
int V_79 , V_323 = 0 ;
for ( V_79 = V_257 ; V_79 <= V_258 ; V_79 ++ ) {
struct V_4 * V_5 = V_99 [ V_79 ] . V_25 ;
...
int F_195 ( const struct V_378 * V_379 , int V_257 , int V_258 , int V_380 )
{
int V_323 ;
F_71 () ;
V_323 = F_196 ( V_379 , V_257 , V_258 , V_380 ) ;
F_72 () ;
return V_323 ;
}
int F_196 ( const struct V_378 * V_379 , int V_257 , int V_258 , int V_380 )
{
struct V_381 * V_111 = V_379 -> V_111 ;
const struct V_378 * V_383 = NULL ;
struct V_344 * V_344 = NULL , * V_384 = NULL ;
int V_79 , V_323 = - V_382 ;
if ( ! F_192 ( V_111 ) )
return - V_382 ;
F_21 () ;
for ( V_79 = 0 ; V_79 < V_343 ; V_79 ++ ) {
...
int V_79 , V_387 = 1 , V_257 = - 1 , V_258 = - 1 , V_380 = 0 ;
if ( ! V_346 -> V_346 || ! ( V_346 -> V_348 & V_385 ) ||
...
static int F_199 ( struct V_344 * V_346 )
{
...
static inline int F_199 ( struct V_344 * V_346 )
{
return 0 ;
}
static T_9 F_200 ( struct V_357 * V_358 , struct V_359 * V_360 ,
const char * V_192 , T_10 V_36 )
{
struct V_344 * V_346 = F_201 ( V_358 ) ;
int V_388 = F_202 ( V_192 , NULL , 0 ) ;
if ( V_388 )
F_198 ( V_346 ) ;
else
F_199 ( V_346 ) ;
...
static T_9 F_203 ( struct V_357 * V_358 , struct V_359 * V_360 ,
char * V_192 )
{
struct V_344 * V_346 = F_201 ( V_358 ) ;
int V_388 = F_197 ( V_346 -> V_346 ) ;
return snprintf ( V_192 , V_389 , L_21 , V_388 ) ;
}
static T_9 F_204 ( struct V_357 * V_358 , struct V_359 * V_360 ,
char * V_192 )
{
struct V_344 * V_346 = F_201 ( V_358 ) ;
return snprintf ( V_192 , V_389 , L_22 ,
( V_346 -> V_348 & V_385 ) ? L_23 : L_24 ,
V_346 -> V_347 ) ;
}
static int F_205 ( struct V_344 * V_346 )
{
int V_79 ;
int error = 0 ;
V_346 -> V_348 |= V_390 ;
F_206 ( V_346 -> V_358 , V_346 ) ;
for ( V_79 = 0 ; V_79 < F_119 ( V_391 ) ; V_79 ++ ) {
error = F_182 ( V_346 -> V_358 , & V_391 [ V_79 ] ) ;
if ( error )
break;
}
if ( error ) {
while ( -- V_79 >= 0 )
F_207 ( V_346 -> V_358 , & V_391 [ V_79 ] ) ;
V_346 -> V_348 &= ~ V_390 ;
}
return error ;
}
static void F_208 ( struct V_344 * V_346 )
{
int V_79 ;
if ( V_346 -> V_348 & V_390 ) {
for ( V_79 = 0 ; V_79 < F_119 ( V_391 ) ; V_79 ++ )
F_207 ( V_346 -> V_358 , & V_391 [ V_79 ] ) ;
V_346 -> V_348 &= ~ V_390 ;
}
}
int F_197 ( const struct V_378 * V_379 )
{
int V_79 , V_392 = 0 ;
for ( V_79 = 0 ; V_79 < V_108 ; V_79 ++ ) {
if ( V_113 [ V_79 ] == V_379 ) {
...
V_5 = V_99 [ V_100 ] . V_25 ;
if ( V_5 -> V_16 -> F_213 )
V_169 = V_5 -> V_16 -> F_213 ( V_5 ) ;
return V_169 ;
}
static int F_214 ( const struct V_378 * V_379 , int V_257 , int V_258 )
{
struct V_381 * V_111 = V_379 -> V_111 ;
struct V_344 * V_344 ;
const char * V_347 ;
...
if ( V_323 )
goto V_135;
V_344 -> V_358 = F_179 ( V_404 , NULL ,
F_176 ( 0 , V_344 -> V_403 ) ,
NULL , L_29 ,
V_344 -> V_403 ) ;
if ( F_180 ( V_344 -> V_358 ) ) {
F_124 ( V_405 L_30
L_31 , V_344 -> V_347 ,
F_215 ( V_344 -> V_358 ) ) ;
V_344 -> V_358 = NULL ;
...
int F_216 ( const struct V_378 * V_379 , int V_257 , int V_258 )
{
int V_323 ;
F_71 () ;
V_323 = F_214 ( V_379 , V_257 , V_258 ) ;
F_72 () ;
return V_323 ;
}
int F_217 ( const struct V_378 * V_379 )
{
int V_323 ;
F_71 () ;
V_323 = F_218 ( V_379 ) ;
...
int F_220 ( const struct V_378 * V_379 , int V_257 , int V_258 , int V_380 )
{
int V_135 ;
V_135 = F_214 ( V_379 , V_257 , V_258 ) ;
if ( V_135 == - V_402 )
V_135 = 0 ;
if ( ! V_135 )
F_191 ( V_379 , V_257 , V_258 , V_380 ) ;
return V_135 ;
}
int F_221 ( const struct V_378 * V_379 , int V_257 , int V_258 , int V_380 )
{
int V_135 ;
V_135 = F_216 ( V_379 , V_257 , V_258 ) ;
if ( V_135 == - V_402 )
V_135 = 0 ;
if ( ! V_135 )
F_193 ( V_379 , V_257 , V_258 , V_380 ) ;
...
void F_222 ( const struct V_378 * V_379 )
{
F_217 ( V_379 ) ;
}
...
for ( V_79 = 0 ; V_79 < V_343 ; V_79 ++ ) {
struct V_344 * V_346 = & V_345 [ V_79 ] ;
if ( V_346 -> V_346 && ! V_346 -> V_358 ) {
V_346 -> V_358 = F_179 ( V_404 , NULL ,
F_176 ( 0 , V_346 -> V_403 ) ,
NULL , L_29 ,
V_346 -> V_403 ) ;
if ( F_180 ( V_346 -> V_358 ) ) {
F_124 ( V_405 L_34
L_35 ,
V_346 -> V_347 , F_215 ( V_346 -> V_358 ) ) ;
V_346 -> V_358 = NULL ;
} else {
F_205 ( V_346 ) ;
}
...
return - V_306 ;
V_407 = ( V_289 < 4 ) ? V_289 : 0 ;
return 0 ;
}
void F_130 ( int V_408 )
{
struct V_4 * V_5 = V_99 [ V_100 ] . V_25 ;
int V_79 ;
F_21 () ;
...
V_286 = 0 ;
F_38 ( V_5 ) ;
V_79 = V_5 -> V_16 -> V_411 ( V_5 , V_213 ? 1 : ( V_407 + 1 ) , 0 ) ;
V_86 = V_100 + 1 ;
if ( V_79 )
F_37 ( V_5 ) ;
if ( V_412 && V_412 ( 1 ) )
...
F_68 ( V_413 , V_5 -> V_102 , V_5 -> V_102 ) ;
}
void F_226 ( int V_414 )
{
struct V_4 * V_5 ;
if ( ! V_415 )
F_123 () ;
...
F_42 ( V_5 ) ;
F_24 ( V_5 ) ;
F_68 ( V_416 , V_5 -> V_102 , V_5 -> V_102 ) ;
}
void F_143 ( void )
{
F_226 ( 0 ) ;
}
static void F_228 ( unsigned long V_417 )
{
if ( F_229 ( ! F_230 () ) ) {
F_168 ( & V_352 , V_353 + ( V_207 * V_211 ) ) ;
return;
...
F_21 () ;
if ( V_5 -> V_87 != V_88 )
V_5 -> V_16 -> V_418 ( V_5 , V_190 ) ;
}
int F_232 ( unsigned char T_7 * V_302 )
{
int V_79 , V_246 , V_335 ;
unsigned char V_419 [ 3 * 16 ] ;
if ( F_233 ( V_419 , V_302 , sizeof( V_419 ) ) )
return - V_306 ;
F_71 () ;
for ( V_79 = V_335 = 0 ; V_79 < 16 ; V_79 ++ ) {
V_336 [ V_79 ] = V_419 [ V_335 ++ ] ;
V_337 [ V_79 ] = V_419 [ V_335 ++ ] ;
V_338 [ V_79 ] = V_419 [ V_335 ++ ] ;
}
for ( V_79 = 0 ; V_79 < V_108 ; V_79 ++ ) {
if ( ! F_46 ( V_79 ) )
continue;
...
int F_234 ( unsigned char T_7 * V_302 )
{
int V_79 , V_335 ;
unsigned char V_419 [ 3 * 16 ] ;
F_71 () ;
for ( V_79 = V_335 = 0 ; V_79 < 16 ; V_79 ++ ) {
V_419 [ V_335 ++ ] = V_336 [ V_79 ] ;
V_419 [ V_335 ++ ] = V_337 [ V_79 ] ;
V_419 [ V_335 ++ ] = V_338 [ V_79 ] ;
}
F_72 () ;
if ( F_235 ( V_302 , V_419 , sizeof( V_419 ) ) )
return - V_306 ;
return 0 ;
}
...
static int F_236 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
struct V_422 V_423 ;
int V_424 = - V_156 ;
int V_9 ;
if ( V_421 -> V_303 ) {
V_423 . V_303 = F_57 ( V_425 , V_125 ) ;
if ( ! V_423 . V_303 )
return - V_126 ;
} else
V_423 . V_303 = NULL ;
...
V_424 = V_5 -> V_16 -> F_236 ( V_5 , & V_423 ) ;
else
V_424 = - V_426 ;
F_72 () ;
if ( V_424 )
...
if ( V_421 -> V_303 && V_423 . V_428 > V_421 -> V_428 )
V_424 = - V_429 ;
...
if ( V_421 -> V_303 && F_235 ( V_421 -> V_303 , V_423 . V_303 , V_9 ) )
V_424 = - V_306 ;
V_427:
F_58 ( V_423 . V_303 ) ;
return V_424 ;
...
if ( ! V_421 -> V_133 ) {
int V_433 , V_79 ;
T_2 T_7 * V_434 = V_421 -> V_303 ;
T_2 V_435 ;
if ( ! ( V_421 -> V_374 & V_430 ) )
return - V_156 ;
for ( V_433 = 32 ; V_433 > 0 ; V_433 -- )
for ( V_79 = 0 ; V_79 < V_421 -> V_428 ; V_79 ++ ) {
if ( F_140 ( V_435 , & V_434 [ 32 * V_79 + V_433 - 1 ] ) )
return - V_306 ;
if ( V_435 )
goto V_436;
}
...
V_423 . V_303 = F_238 ( V_421 -> V_303 , V_432 ) ;
if ( F_180 ( V_423 . V_303 ) )
return F_215 ( V_423 . V_303 ) ;
F_71 () ;
if ( V_5 -> V_87 != V_284 )
V_424 = - V_156 ;
else if ( V_5 -> V_16 -> F_237 )
V_424 = V_5 -> V_16 -> F_237 ( V_5 , & V_423 , V_421 -> V_374 ) ;
else
V_424 = - V_426 ;
F_72 () ;
F_58 ( V_423 . V_303 ) ;
...
static int F_239 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
...
if ( ! V_421 -> V_303 )
V_26 = NULL ;
else if ( F_240 ( V_367 , V_421 -> V_303 , V_437 - 1 ) < 0 )
return - V_306 ;
else
V_367 [ V_437 - 1 ] = 0 ;
F_71 () ;
...
if ( V_5 -> V_16 -> F_239 )
V_424 = V_5 -> V_16 -> F_239 ( V_5 , & V_423 , V_26 ) ;
else
V_424 = - V_426 ;
F_72 () ;
if ( ! V_424 ) {
...
static int F_241 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
int V_346 = V_421 -> V_133 ;
int V_424 ;
F_71 () ;
if ( V_5 -> V_87 != V_284 )
V_424 = - V_156 ;
else if ( ! V_5 -> V_16 -> F_241 )
V_424 = - V_426 ;
...
V_424 = V_5 -> V_16 -> F_241 ( V_5 , V_346 ) ;
F_72 () ;
return V_424 ;
}
int F_242 ( struct V_4 * V_5 , struct V_420 * V_421 )
{
switch ( V_421 -> V_421 ) {
case V_439 :
return F_237 ( V_5 , V_421 ) ;
case V_440 :
return F_236 ( V_5 , V_421 ) ;
case V_441 :
return F_239 ( V_5 , V_421 ) ;
case V_442 :
return F_241 ( V_5 , V_421 ) ;
}
return - V_426 ;
}
T_1 F_243 ( struct V_4 * V_5 , int V_12 )
{
...
unsigned short * F_244 ( struct V_4 * V_5 , int V_444 , int V_13 )
{
return F_8 ( V_5 , 2 * V_444 , V_13 ) ;
}
void F_245 ( struct V_4 * V_5 , unsigned char * V_14 )
{
V_14 [ 0 ] = V_5 -> V_77 ;
V_14 [ 1 ] = V_5 -> V_82 ;
}
...
T_1 F_247 ( struct V_4 * V_5 , const T_1 * V_445 )
{
if ( ( unsigned long ) V_445 == V_5 -> V_76 && V_81 != - 1 )
return V_81 ;
return F_19 ( V_445 ) ;
}
void F_248 ( struct V_4 * V_5 , T_1 V_446 , T_1 * V_445 )
{
F_28 ( V_446 , V_445 ) ;
