...
void T_1 F_68 ( T_2 V_88 )
{
V_2 . V_25 = V_88 ;
}
static void T_1 F_69 ( struct V_1 * type , char * V_94 )
{
unsigned long long V_5 , V_6 ;
int V_12 ;
F_70 ( L_9 , V_94 , type -> V_13 ) ;
for ( V_12 = 0 ; V_12 < type -> V_13 ; V_12 ++ ) {
struct V_32 * V_51 = & type -> V_15 [ V_12 ] ;
char V_95 [ 32 ] = L_10 ;
V_5 = V_51 -> V_5 ;
...
static int T_4 F_74 ( char * V_96 )
{
if ( V_96 && strstr ( V_96 , L_15 ) )
V_97 = 1 ;
return 0 ;
}
static int F_75 ( struct V_98 * V_71 , void * V_99 )
{
...
static int F_77 ( struct V_101 * V_101 , struct V_102 * V_102 )
{
return F_78 ( V_102 , F_75 , V_101 -> V_103 ) ;
}
static int T_4 F_79 ( void )
{
struct V_104 * V_105 = F_80 ( L_19 , NULL ) ;
if ( ! V_105 )
return - V_106 ;
F_81 ( L_1 , V_107 , V_105 , & V_2 . V_3 , & V_108 ) ;
F_81 ( L_2 , V_107 , V_105 , & V_2 . V_4 , & V_108 ) ;
return 0 ;
}
