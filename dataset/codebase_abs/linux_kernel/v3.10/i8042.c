...
static long F_58 ( int V_94 )
{
long V_95 = 0 ;
char V_96 ;
V_96 = ( V_94 ) ? 0x01 | 0x04 : 0 ;
while ( F_11 () & V_16 )
V_97 ;
F_16 ( L_42 , 0xed ) ;
V_44 = 2 ;
...
static void F_66 ( struct V_101 * V_100 )
{
F_57 ( false ) ;
}
...
V_4 = F_68 ( sizeof( struct V_4 ) , V_102 ) ;
if ( ! V_4 )
return - V_103 ;
...
F_69 ( V_4 -> V_113 , L_47 , sizeof( V_4 -> V_113 ) ) ;
F_69 ( V_4 -> V_114 , V_115 , sizeof( V_4 -> V_114 ) ) ;
V_11 -> V_4 = V_4 ;
V_11 -> V_45 = V_43 ;
return 0 ;
}
static int T_2 F_70 ( int V_116 )
{
struct V_4 * V_4 ;
...
V_4 -> V_100 . V_112 = & V_80 -> V_100 ;
if ( V_116 < 0 ) {
F_69 ( V_4 -> V_113 , L_48 , sizeof( V_4 -> V_113 ) ) ;
F_69 ( V_4 -> V_114 , V_117 , sizeof( V_4 -> V_114 ) ) ;
V_4 -> V_111 = F_23 ;
} else {
...
static int T_2 F_84 ( struct V_101 * V_100 )
{
int error ;
V_80 = V_100 ;
if ( V_93 ) {
...
static int F_85 ( struct V_101 * V_100 )
{
F_77 () ;
F_80 () ;
F_57 ( false ) ;
...
if ( V_133 )
goto V_134;
V_132 = F_89 ( & V_135 , F_84 , NULL , 0 , NULL , 0 ) ;
if ( F_90 ( V_132 ) ) {
V_133 = F_91 ( V_132 ) ;
goto V_134;
}
