...
T_2 V_10 [ 2 ] , V_11 [ 2 ] ;
int V_13 , V_37 ;
V_36 = F_18 ( & V_7 -> V_2 , sizeof( struct V_35 ) ,
V_38 ) ;
if ( ! V_36 )
return - V_39 ;
V_7 -> V_2 . V_40 = V_36 ;
...
goto V_41;
F_1 () ;
V_34 = F_20 ( & V_7 -> V_2 , V_45 . V_46 . V_14 ,
& V_47 , V_48 ) ;
if ( F_21 ( V_34 ) ) {
F_14 ( & V_7 -> V_2 , L_13 ) ;
V_13 = F_22 ( V_34 ) ;
...
F_23 ( & V_36 -> V_49 [ V_37 ] . V_4 . V_4 ) ;
sprintf ( V_36 -> V_49 [ V_37 ] . V_14 , L_14 , V_37 ) ;
V_36 -> V_49 [ V_37 ] . V_4 . V_4 . V_50 = V_51 | V_52 ;
V_36 -> V_49 [ V_37 ] . V_4 . V_4 . V_14 = V_36 -> V_49 [ V_37 ] . V_14 ;
V_36 -> V_49 [ V_37 ] . V_4 . V_53 = F_3 ;
V_36 -> V_49 [ V_37 ] . V_4 . V_54 = F_8 ;
V_13 = F_24 ( & V_7 -> V_2 , & V_36 -> V_49 [ V_37 ] . V_4 ) ;
if ( V_13 ) {
F_14 ( & V_7 -> V_2 , L_15 ,
V_36 -> V_49 [ V_37 ] . V_14 ) ;
goto V_55;
...
F_25 ( & V_7 -> V_2 , & V_36 -> V_49 [ V_37 ] . V_4 ) ;
V_41:
V_7 -> V_2 . V_40 = NULL ;
return V_13 ;
}
