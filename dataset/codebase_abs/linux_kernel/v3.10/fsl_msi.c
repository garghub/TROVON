...
static int F_63 ( struct V_80 * V_49 )
{
const struct V_92 * V_93 ;
struct V_9 * V_82 ;
struct V_94 V_95 ;
int V_96 , V_83 , V_97 , V_88 , V_98 ;
int V_17 ;
const T_1 * V_99 ;
const struct V_100 * V_101 ;
int V_38 ;
T_1 V_87 ;
static const T_1 V_102 [] = { 0 , V_19 } ;
V_93 = F_64 ( V_103 , & V_49 -> V_49 ) ;
if ( ! V_93 )
return - V_51 ;
V_101 = V_93 -> V_43 ;
F_65 ( V_104 L_14 ) ;
...
if ( ( V_101 -> V_107 & V_66 ) != V_76 ) {
V_96 = F_68 ( V_49 -> V_49 . V_21 , 0 , & V_95 ) ;
if ( V_96 ) {
F_31 ( & V_49 -> V_49 , L_17 ,
V_49 -> V_49 . V_21 -> V_50 ) ;
goto V_106;
}
V_82 -> V_75 = F_69 ( V_95 . V_108 , F_70 ( & V_95 ) ) ;
if ( ! V_82 -> V_75 ) {
V_96 = - V_48 ;
F_31 ( & V_49 -> V_49 , L_18 ,
V_49 -> V_49 . V_21 -> V_50 ) ;
...
V_82 -> V_40 =
V_101 -> V_40 + ( V_95 . V_108 & 0xfffff ) ;
}
V_82 -> V_65 = V_101 -> V_107 ;
...
V_99 = F_23 ( V_49 -> V_49 . V_21 , L_20 , & V_38 ) ;
if ( V_99 && V_38 % ( 2 * sizeof( T_1 ) ) != 0 ) {
F_31 ( & V_49 -> V_49 , L_21 ,
V_44 ) ;
V_96 = - V_51 ;
goto V_106;
...
V_99 [ V_83 * 2 + 1 ] , V_99 [ V_83 * 2 ] ) ;
V_96 = - V_51 ;
goto V_106;
}
V_87 = V_99 [ V_83 * 2 ] / V_45 ;
V_98 = V_99 [ V_83 * 2 + 1 ] / V_45 ;
for ( V_97 = 0 ; V_97 < V_98 ; V_97 ++ , V_88 ++ ) {
V_96 = F_57 ( V_82 , V_49 , V_87 + V_97 , V_88 ) ;
if ( V_96 )
goto V_106;
}
}
F_71 ( & V_82 -> V_84 , & V_110 ) ;
if ( ! V_111 . V_112 ) {
V_111 . V_112 = F_28 ;
V_111 . V_113 = F_14 ;
V_111 . V_114 = F_12 ;
