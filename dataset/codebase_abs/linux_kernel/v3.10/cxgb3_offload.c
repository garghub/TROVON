...
V_300 * sizeof( * V_91 -> V_225 ) + V_301 * sizeof( * V_91 -> V_227 ) ;
V_91 -> V_200 = F_138 ( V_109 ) ;
if ( ! V_91 -> V_200 )
return - V_302 ;
V_91 -> V_227 = (union V_196 * ) & V_91 -> V_200 [ V_221 ] ;
V_91 -> V_225 = (union V_188 * ) & V_91 -> V_227 [ V_301 ] ;
V_91 -> V_221 = V_221 ;
V_91 -> V_301 = V_301 ;
V_91 -> V_228 = V_228 ;
V_91 -> V_198 = NULL ;
...
if ( V_301 ) {
while ( -- V_301 )
V_91 -> V_227 [ V_301 - 1 ] . V_192 = & V_91 -> V_227 [ V_301 ] ;
V_91 -> V_198 = V_91 -> V_227 ;
}
if ( V_300 ) {
while ( -- V_300 )
V_91 -> V_225 [ V_300 - 1 ] . V_192 = & V_91 -> V_225 [ V_300 ] ;
...
static inline void F_149 ( struct V_3 * V_303 )
{
F_150 ( & V_282 ) ;
F_6 ( & V_303 -> V_304 , & V_304 ) ;
F_151 ( & V_282 ) ;
}
static inline void F_152 ( struct V_3 * V_303 )
{
F_150 ( & V_282 ) ;
F_10 ( & V_303 -> V_304 ) ;
F_151 ( & V_282 ) ;
...
return - V_302 ;
V_305 = - V_59 ;
if ( V_18 -> V_308 ( V_18 , V_139 , & V_91 -> V_309 ) < 0 ||
V_18 -> V_308 ( V_18 , V_135 , & V_91 -> V_310 ) < 0 ||
V_18 -> V_308 ( V_18 , V_148 , & V_307 ) < 0 ||
V_18 -> V_308 ( V_18 , V_149 , & V_124 ) < 0 ||
V_18 -> V_308 ( V_18 , V_140 , & V_122 ) < 0 ||
V_18 -> V_308 ( V_18 , V_147 , & V_306 ) < 0 )
goto V_311;
V_305 = - V_302 ;
F_154 ( V_18 -> V_312 , F_155 ( V_307 ) ) ;
if ( ! F_136 ( V_18 ) )
goto V_311;
V_300 = F_24 ( V_122 . V_141 / 2 , V_313 ) ;
V_305 = F_145 ( & V_91 -> V_187 , V_122 . V_141 , V_300 ,
V_306 . V_141 , V_314 , V_306 . V_146 ) ;
if ( V_305 )
goto V_315;
V_91 -> V_151 = V_124 . V_151 ;
V_91 -> V_316 = V_124 . V_109 ;
F_156 ( & V_91 -> V_214 , F_68 ) ;
F_147 ( & V_91 -> V_215 ) ;
F_157 ( & V_91 -> V_317 ) ;
V_91 -> V_18 = V_18 ;
F_54 ( V_18 ) = V_91 ;
...
V_315:
F_160 ( F_136 ( V_18 ) ) ;
F_154 ( V_18 -> V_312 , NULL ) ;
V_311:
F_144 ( V_91 ) ;
return V_305 ;
}
static void F_161 ( struct V_319 * V_320 )
{
struct V_321 * V_322 = F_69 ( V_320 , struct V_321 , V_319 ) ;
F_160 ( V_322 ) ;
}
...
V_322 = F_136 ( V_2 ) ;
F_21 () ;
F_154 ( V_2 -> V_312 , NULL ) ;
F_164 ( & V_322 -> V_319 , F_161 ) ;
if ( V_91 -> V_219 )
F_123 ( V_91 -> V_219 ) ;
F_144 ( V_91 ) ;
}
...
static int V_323 ;
F_5 ( & V_8 ) ;
snprintf ( V_2 -> V_55 , sizeof( V_2 -> V_55 ) , L_15 , V_323 ++ ) ;
F_6 ( & V_2 -> V_324 , & V_324 ) ;
F_8 ( & V_8 ) ;
}
