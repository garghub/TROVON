...
return 0 ;
F_13 ( L_1 ,
V_10 -> V_64 , V_10 -> V_55 . V_65 ,
V_2 -> V_66 , V_10 -> V_55 . V_56 >> 20 ) ;
F_5 ( V_2 ) ;
return 1 ;
}
...
V_2 = V_10 -> V_2 ;
if ( ( V_69 = V_68 -> V_76 [ 0 ] . V_21 ) == 0 ) {
F_13 ( L_4 ) ;
F_19 ( V_10 ) ;
F_18 ( V_68 ) ;
return - V_18 ;
}
if ( ( V_10 -> V_77 = F_20 ( V_69 , 1024 * 1024 * 2 ) ) == 0 ) {
F_13 ( L_5 , V_69 ) ;
F_19 ( V_10 ) ;
F_18 ( V_68 ) ;
return - V_18 ;
...
#ifdef F_21
if ( V_70 ) {
V_79 . V_80 = V_2 -> V_66 | 0x00800000 ;
} else {
V_79 . V_80 = 0x30000000 ;
}
if ( ( V_2 -> V_81 = ( int ) F_20 ( V_79 . V_80 , V_79 . V_56 ) ) == 0 ) {
F_13 ( L_6 , V_79 . V_80 ) ;
F_22 ( ( void * ) V_10 -> V_77 ) ;
F_19 ( V_10 ) ;
F_18 ( V_68 ) ;
...
V_2 -> V_17 = F_23 ( 4 * sizeof( * V_2 -> V_17 ) , V_82 ) ;
if ( ! V_2 -> V_17 ) {
F_13 ( L_7 ) ;
F_22 ( ( void * ) V_2 -> V_81 ) ;
F_22 ( V_10 -> V_77 ) ;
...
{
struct V_83 * V_84 = F_24 ( V_68 ) ;
int V_64 = V_84 -> V_64 ;
int V_85 = F_25 ( V_64 , L_8 , 1024 ) ;
int V_86 = F_25 ( V_64 , L_9 , 768 ) ;
int V_87 = F_25 ( V_64 , L_10 , 8 ) ;
switch ( V_85 ) {
case 1024 :
if ( V_86 == 768 )
V_88 = V_89 ;
...
#endif
V_79 . V_92 = ( unsigned long ) V_10 -> V_77 ;
V_79 . V_93 = V_88 . V_94 * ( V_88 . V_46 / 8 ) ;
V_79 . V_95 = V_88 . V_46 <= 8 ? V_96 : V_97 ;
V_10 -> V_45 = V_88 ;
V_10 -> V_55 = V_79 ;
