...
{
int V_17 ;
for ( V_17 = 0 ; V_17 < F_20 ( V_18 ) ; ++ V_17 ) {
V_19 [ V_17 ] . V_20 = F_3 ( V_18 [ V_17 ] ) ;
V_19 [ V_17 ] . V_21 = F_11 ( V_18 [ V_17 ] ) ;
V_19 [ V_17 ] . V_22 = F_9 ( V_18 [ V_17 ] ) ;
}
}
void F_21 ( void )
{
int V_17 ;
for ( V_17 = 0 ; V_17 < F_20 ( V_18 ) ; ++ V_17 ) {
F_10 ( V_18 [ V_17 ] , V_19 [ V_17 ] . V_21 ) ;
F_5 ( V_18 [ V_17 ] ,
V_19 [ V_17 ] . V_20 & V_19 [ V_17 ] . V_22 ) ;
F_8 ( V_18 [ V_17 ] , V_19 [ V_17 ] . V_22 ) ;
}
}
