...
static int F_55 ( struct V_25 * V_26 , int V_147 )
{
T_1 V_148 = 0 ;
unsigned int V_149 , V_150 ;
struct V_1 * V_2 = F_18 ( V_26 ) ;
T_1 V_12 = F_12 ( V_2 , V_151 ) ;
for ( V_149 = V_59 ;
V_149 <= V_112 && V_147 > 0 ;
V_12 = F_12 ( V_2 , V_151 ) ,
V_149 ++ ) {
if ( V_12 & ( 1 << ( V_149 - 1 ) ) ) {
F_17 ( V_26 , 0 , V_149 , V_53 &
~ V_66 ) ;
V_150 = V_2 -> V_13 ( V_2 ,
F_15 ( V_49 , 0 ) ) ;
if ( V_150 & V_52 )
...
switch ( V_155 ) {
case V_160 :
V_2 -> V_97 . V_161 . V_162 ++ ;
V_2 -> V_97 . V_125 = V_163 ;
V_157 -> V_36 |= V_68 ;
V_157 -> V_48 [ 1 ] = ( V_135 . V_141 > V_135 . V_138 ) ?
V_164 :
V_165 ;
V_157 -> V_48 [ 6 ] = V_135 . V_141 ;
V_157 -> V_48 [ 7 ] = V_135 . V_138 ;
break;
case V_166 :
V_2 -> V_97 . V_161 . V_167 ++ ;
V_2 -> V_97 . V_125 = V_168 ;
V_157 -> V_36 |= V_68 ;
if ( V_156 )
V_157 -> V_48 [ 1 ] |= V_169 ;
if ( V_135 . V_141 > 127 )
...
struct V_31 * V_157 ;
struct V_64 * V_65 ;
if ( V_175 == V_124 || V_175 == V_176 )
return 0 ;
V_65 = F_28 ( V_26 , & V_157 ) ;
if ( F_29 ( ! V_65 ) )
return 0 ;
V_2 -> V_97 . V_161 . V_177 ++ ;
V_63 -> V_70 ++ ;
V_157 -> V_36 |= V_178 | V_179 ;
V_157 -> V_48 [ 2 ] |= V_180 ;
switch ( V_175 ) {
case V_181 :
F_37 ( V_26 , L_6 ) ;
...
static int F_60 ( struct V_195 * V_196 , int V_147 )
{
T_2 V_197 ;
int V_175 = 0 ;
int V_198 = 0 ;
struct V_25 * V_26 = V_196 -> V_26 ;
struct V_1 * V_2 = F_18 ( V_26 ) ;
V_197 = V_2 -> V_197 ;
if ( ! V_197 )
goto V_199;
if ( V_197 == V_200 ) {
V_2 -> V_153 = V_2 -> V_13 ( V_2 ,
V_123 ) ;
if ( V_2 -> V_153 & V_201 )
V_2 -> V_19 ( V_2 , V_123 ,
V_2 -> V_153 & ~ V_201 ) ;
...
V_175 = F_56 ( V_2 ) ;
if ( V_175 )
V_198 += F_59 ( V_26 , V_175 ) ;
} else if ( ( V_197 >= V_59 ) &&
( V_197 <= V_112 ) ) {
V_198 += F_55 ( V_26 , ( V_147 - V_198 ) ) ;
} else if ( ( V_197 >= V_8 ) &&
( V_197 <= V_207 ) ) {
F_53 ( V_26 ) ;
}
...
static T_5 F_62 ( int V_208 , void * V_209 )
{
struct V_25 * V_26 = (struct V_25 * ) V_209 ;
struct V_1 * V_2 = F_18 ( V_26 ) ;
V_2 -> V_197 = V_2 -> V_13 ( V_2 , V_210 ) ;
if ( ! V_2 -> V_197 )
return V_211 ;
F_13 ( V_2 , V_128 ) ;
F_63 ( & V_2 -> V_196 ) ;
...
V_213 = F_66 ( V_26 -> V_208 , & F_62 , V_215 , V_26 -> V_216 ,
V_26 ) ;
if ( V_213 < 0 ) {
F_20 ( V_26 , L_18 ) ;
goto V_217;
...
struct V_25 * V_26 ;
struct V_1 * V_2 ;
V_26 = F_74 ( sizeof( struct V_1 ) , V_220 ) ;
if ( ! V_26 )
return NULL ;
V_2 = F_18 ( V_26 ) ;
F_75 ( V_26 , & V_2 -> V_196 , F_60 , V_221 ) ;
V_2 -> V_26 = V_26 ;
