...
F_34 ( & V_35 ) ;
for ( type = V_36 . V_37 ; type >= 0 ; type = V_34 -> V_38 ) {
V_34 = V_13 [ type ] ;
V_33 += F_35 ( & V_34 -> V_23 ) ;
}
return V_33 ;
}
static int F_36 ( unsigned long V_39 , unsigned long * V_40 ,
int * V_41 )
{
int V_22 = - V_15 ;
struct V_11 * V_34 = NULL ;
int V_42 ;
unsigned long V_43 = V_39 ;
...
static int F_39 ( unsigned long V_49 ,
unsigned long * V_45 ,
int * type )
{
unsigned long V_50 = 0 , V_43 ;
F_34 ( & V_35 ) ;
V_50 = F_33 () ;
if ( V_50 <= V_49 ) {
* V_45 = 0 ;
...
V_43 = V_50 - V_49 ;
return F_36 ( V_43 , V_45 , type ) ;
}
void F_40 ( unsigned long V_49 )
{
unsigned long V_45 = 0 ;
int V_51 ( type ) , V_22 ;
F_41 ( & V_35 ) ;
V_22 = F_39 ( V_49 , & V_45 , & type ) ;
F_42 ( & V_35 ) ;
if ( V_22 == 0 )
F_43 ( type , true , V_45 ) ;
return;
...
{
#ifdef F_46
struct V_52 * V_53 = F_47 ( L_1 , NULL ) ;
if ( V_53 == NULL )
return - V_54 ;
F_48 ( L_2 , V_55 , V_53 , & V_1 ) ;
F_48 ( L_3 , V_55 , V_53 , & V_2 ) ;
F_48 ( L_4 , V_55 , V_53 ,
& V_3 ) ;
F_48 ( L_5 , V_55 ,
V_53 , & V_4 ) ;
