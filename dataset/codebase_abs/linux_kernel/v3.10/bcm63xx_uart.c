...
static T_1 F_29 ( int V_76 , void * V_77 )
{
struct V_1 * V_2 ;
unsigned int V_78 ;
V_2 = V_77 ;
...
struct V_165 * V_165 ;
int V_88 ;
if ( V_161 -> V_166 < 0 || V_161 -> V_166 >= V_157 )
return - V_138 ;
if ( V_150 [ V_161 -> V_166 ] . V_4 )
return - V_134 ;
V_163 = F_70 ( V_161 , V_167 , 0 ) ;
if ( ! V_163 )
return - V_158 ;
V_164 = F_70 ( V_161 , V_168 , 0 ) ;
if ( ! V_164 )
return - V_158 ;
V_165 = F_71 ( & V_161 -> V_133 , L_5 ) ;
if ( F_72 ( V_165 ) )
return - V_158 ;
V_2 = & V_150 [ V_161 -> V_166 ] ;
memset ( V_2 , 0 , sizeof( * V_2 ) ) ;
V_2 -> V_139 = V_169 ;
V_2 -> V_132 = V_163 -> V_170 ;
V_2 -> V_76 = V_164 -> V_170 ;
V_2 -> V_171 = & V_172 ;
V_2 -> V_32 = V_173 ;
V_2 -> V_133 = & V_161 -> V_133 ;
V_2 -> V_71 = 16 ;
V_2 -> V_121 = F_73 ( V_165 ) / 2 ;
V_2 -> line = V_161 -> V_166 ;
F_74 ( V_165 ) ;
V_88 = F_75 ( & V_174 , V_2 ) ;
if ( V_88 ) {
V_150 [ V_161 -> V_166 ] . V_4 = 0 ;
return V_88 ;
}
F_76 ( V_161 , V_2 ) ;
return 0 ;
