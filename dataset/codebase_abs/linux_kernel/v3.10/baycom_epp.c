...
V_156 [ V_66 ] = 0 ;
if ( F_61 ( V_59 ) ) {
F_8 ( V_204 L_43 , V_28 , V_59 -> V_83 ) ;
F_62 ( V_59 ) ;
break;
}
if ( V_201 && F_50 ( F_21 ( V_59 ) , V_206 [ V_66 ] ) )
V_201 = 0 ;
V_207 [ V_66 ] = V_59 ;
V_200 ++ ;
}
...
static int T_3 F_65 ( char * V_209 )
{
static unsigned T_5 V_210 = 0 ;
int V_211 [ 2 ] ;
if ( V_210 >= V_203 )
return 0 ;
V_209 = F_66 ( V_209 , 2 , V_211 ) ;
if ( V_211 [ 0 ] < 1 )
return 0 ;
V_206 [ V_210 ] = V_209 ;
V_156 [ V_210 ] = V_211 [ 1 ] ;
