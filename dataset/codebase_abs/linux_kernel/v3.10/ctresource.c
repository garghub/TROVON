...
int F_9 ( struct V_15 * V_15 , T_2 V_10 , enum V_20 type , T_2 V_18 , void * V_21 )
{
int V_13 = 0 ;
V_15 -> V_10 = V_10 ;
V_15 -> V_16 = V_10 ;
...
switch ( type ) {
case V_25 :
V_13 = ( (struct V_21 * ) V_21 ) -> F_10 ( & V_15 -> V_24 ) ;
break;
case V_26 :
V_13 = ( (struct V_21 * ) V_21 ) ->
F_11 ( & V_15 -> V_24 ) ;
break;
case V_27 :
case V_28 :
...
int F_13 ( struct V_15 * V_15 )
{
if ( ( NULL != V_15 -> V_21 ) && ( NULL != V_15 -> V_24 ) ) {
switch ( V_15 -> type ) {
case V_25 :
( (struct V_21 * ) V_15 -> V_21 ) ->
F_14 ( V_15 -> V_24 ) ;
break;
case V_26 :
( (struct V_21 * ) V_15 -> V_21 ) ->
...
int F_16 ( struct V_11 * V_12 , enum V_20 type ,
unsigned int V_2 , void * V_33 )
{
int V_13 = 0 ;
struct V_21 * V_21 = V_33 ;
V_12 -> type = V_32 ;
V_12 -> V_1 = F_17 ( ( ( V_2 + 8 - 1 ) / 8 ) , V_34 ) ;
if ( ! V_12 -> V_1 )
return - V_35 ;
switch ( type ) {
case V_25 :
V_13 = V_21 -> V_36 ( & V_12 -> V_24 ) ;
break;
case V_27 :
V_13 = V_21 -> V_37 ( & V_12 -> V_24 ) ;
break;
case V_26 :
V_13 = V_21 -> V_38 ( & V_12 -> V_24 ) ;
break;
case V_29 :
V_13 = V_21 -> V_39 ( V_21 , & V_12 -> V_24 ) ;
break;
case V_28 :
break;
default:
