...
static int F_14 ( struct V_19 * V_20 , unsigned int V_21 )
{
int V_22 = V_6 != 0 ;
if ( V_22 ) {
if ( V_10 <= - 1 )
...
static int F_17 ( struct V_19 * V_20 , unsigned int V_21 )
{
F_18 ( & V_11 ) ;
...
static int F_27 ( struct V_19 * V_20 , unsigned int V_21 )
{
F_28 ( & V_14 ) ;
if ( V_10 > - 1 ) {
F_29 ( V_10 ) ;
