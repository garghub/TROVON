...
{
if ( V_2 -> V_11 . V_147 > 0 ) {
return F_96 ( V_2 -> V_11 . V_147 ) ;
}
return 0 ;
}
int F_102 ( struct V_1 * V_2 , union V_77 * V_84 ,
struct V_124 * V_148 )
{
struct V_15 * V_16 = F_52 ( V_2 ) ;
return F_103 ( V_16 , V_84 , V_148 ) ;
}
T_1 F_104 ( struct V_1 * V_2 , T_4 * V_149 )
{
struct V_15 * V_16 ;
T_1 V_150 = 0 ;
F_9 (evsel, &evlist->entries, node) {
V_150 += fprintf ( V_149 , L_8 , V_16 -> V_33 ? L_9 : L_6 ,
F_105 ( V_16 ) ) ;
}
return V_150 + fprintf ( V_149 , L_10 ) ; ;
}
