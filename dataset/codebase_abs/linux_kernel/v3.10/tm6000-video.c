...
return - V_129 ;
V_6 -> V_194 = V_14 ;
V_27 = F_85 ( V_135 , V_136 , V_6 -> V_195 -> V_196 ) ;
return V_27 ;
}
static int F_91 ( struct V_197 * V_198 )
{
struct V_5 * V_6 = F_2 ( V_198 -> V_199 , struct V_5 , V_200 ) ;
T_1 V_201 = V_198 -> V_201 ;
switch ( V_198 -> V_202 ) {
case V_203 :
F_92 ( V_6 , V_204 , V_201 ) ;
return 0 ;
case V_205 :
F_92 ( V_6 , V_206 , V_201 ) ;
return 0 ;
case V_207 :
F_92 ( V_6 , V_208 , V_201 ) ;
return 0 ;
case V_209 :
F_92 ( V_6 , V_210 , V_201 ) ;
return 0 ;
}
return - V_129 ;
}
...
{
struct V_5 * V_6 = F_2 ( V_198 -> V_199 ,
struct V_5 , V_211 ) ;
T_1 V_201 = V_198 -> V_201 ;
switch ( V_198 -> V_202 ) {
case V_212 :
...
if ( 0 != V_217 -> V_158 )
return - V_129 ;
strcpy ( V_217 -> V_161 , L_33 ) ;
V_217 -> type = V_220 ;
V_217 -> V_221 = V_222 | V_223 ;
V_217 -> V_224 = 0xffffffffUL ;
V_217 -> V_225 = V_226 ;
F_87 ( & V_6 -> V_182 , 0 , V_227 , V_228 , V_217 ) ;
V_217 -> V_229 = V_6 -> V_230 ;
return 0 ;
}
...
if ( 0 != V_217 -> V_158 )
return - V_129 ;
if ( V_217 -> V_229 > V_231 )
V_6 -> V_230 = V_231 ;
else
V_6 -> V_230 = V_217 -> V_229 ;
F_4 ( V_6 , 3 , L_34 , V_217 -> V_229 ) ;
F_87 ( & V_6 -> V_182 , 0 , V_227 , V_232 , V_217 ) ;
return 0 ;
}
...
if ( V_157 -> V_227 )
return - V_129 ;
V_157 -> V_234 = V_6 -> V_235 ;
F_87 ( & V_6 -> V_182 , 0 , V_227 , V_236 , V_157 ) ;
return 0 ;
}
static int F_99 ( struct V_135 * V_135 , void * V_136 ,
const struct V_233 * V_157 )
{
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
if ( V_218 == V_6 -> V_144 )
...
if ( V_157 -> V_227 != 0 )
return - V_129 ;
V_6 -> V_235 = V_157 -> V_234 ;
F_87 ( & V_6 -> V_182 , 0 , V_227 , V_237 , V_157 ) ;
return 0 ;
}
static int F_100 ( struct V_135 * V_135 , void * V_136 ,
struct V_216 * V_217 )
{
struct V_114 * V_115 = V_135 -> V_238 ;
struct V_5 * V_6 = V_115 -> V_6 ;
if ( 0 != V_217 -> V_158 )
return - V_129 ;
memset ( V_217 , 0 , sizeof( * V_217 ) ) ;
strcpy ( V_217 -> V_161 , L_35 ) ;
V_217 -> type = V_239 ;
V_217 -> V_221 = V_240 | V_223 ;
V_217 -> V_225 = V_226 ;
V_217 -> V_229 = V_231 ;
F_87 ( & V_6 -> V_182 , 0 , V_227 , V_228 , V_217 ) ;
return 0 ;
...
V_6 -> V_248 = V_249 ;
if ( ! V_115 -> V_38 ) {
F_107 ( & V_115 -> V_165 , & V_250 ,
NULL , & V_6 -> V_75 ,
V_115 -> type ,
V_172 ,
sizeof( struct V_3 ) , V_115 , & V_6 -> V_251 ) ;
} else {
F_4 ( V_6 , V_241 , L_43 ) ;
F_108 ( V_6 ) ;
F_87 ( & V_6 -> V_182 , 0 , V_227 , V_252 ) ;
F_33 ( V_6 ) ;
F_42 ( V_6 ) ;
}
F_109 ( & V_115 -> V_115 ) ;
...
if ( F_114 ( & V_6 -> V_251 ) )
return - V_254 ;
V_253 = F_115 ( & V_115 -> V_165 , V_20 , V_113 , V_34 , 0 ,
V_135 -> V_176 & V_177 ) ;
F_112 ( & V_6 -> V_251 ) ;
return V_253 ;
}
...
static unsigned int
F_116 ( struct V_135 * V_135 , struct V_255 * V_256 )
{
unsigned long V_257 = F_117 ( V_256 ) ;
struct V_114 * V_115 = V_135 -> V_238 ;
struct V_3 * V_4 ;
int V_253 = 0 ;
...
F_119 ( V_135 , & V_115 -> V_115 . V_256 , V_256 ) ;
if ( V_179 != V_115 -> type )
return V_253 | V_259 ;
if ( ! ! F_58 ( V_115 -> V_6 , V_115 ) )
return V_253 | V_259 ;
if ( ! F_57 ( V_115 -> V_6 , V_115 ) ) {
if ( F_3 ( & V_115 -> V_165 . V_260 ) )
return V_253 | V_259 ;
V_4 = F_5 ( V_115 -> V_165 . V_260 . V_10 , struct V_3 , V_11 . V_260 ) ;
F_119 ( V_135 , & V_4 -> V_11 . V_19 , V_256 ) ;
if ( V_4 -> V_11 . V_15 == V_16 ||
V_4 -> V_11 . V_15 == V_261 )
return V_253 | V_262 | V_263 ;
} else if ( V_257 & ( V_262 | V_263 ) ) {
return V_253 | F_120 ( V_135 , & V_115 -> V_165 , V_256 ) ;
}
return V_253 ;
}
static unsigned int F_121 ( struct V_135 * V_135 , struct V_255 * V_256 )
{
struct V_114 * V_115 = V_135 -> V_238 ;
struct V_5 * V_6 = V_115 -> V_6 ;
unsigned int V_253 ;
F_111 ( & V_6 -> V_251 ) ;
V_253 = F_116 ( V_135 , V_256 ) ;
F_112 ( & V_6 -> V_251 ) ;
return V_253 ;
}
...
static int F_127 ( struct V_135 * V_135 , struct V_265 * V_266 )
{
struct V_114 * V_115 = V_135 -> V_238 ;
struct V_5 * V_6 = V_115 -> V_6 ;
int V_253 ;
if ( F_114 ( & V_6 -> V_251 ) )
return - V_254 ;
V_253 = F_128 ( & V_115 -> V_165 , V_266 ) ;
F_112 ( & V_6 -> V_251 ) ;
return V_253 ;
}
static struct V_139 * F_129 ( struct V_5 * V_6 ,
const struct V_139
* V_267 , const char * V_268 )
{
struct V_139 * V_195 ;
V_195 = F_130 () ;
if ( NULL == V_195 )
return NULL ;
* V_195 = * V_267 ;
V_195 -> V_182 = & V_6 -> V_182 ;
V_195 -> V_269 = V_270 ;
V_195 -> V_271 = V_272 ;
V_195 -> V_251 = & V_6 -> V_251 ;
F_131 ( V_273 , & V_195 -> V_123 ) ;
snprintf ( V_195 -> V_161 , sizeof( V_195 -> V_161 ) , L_45 , V_6 -> V_161 , V_268 ) ;
F_132 ( V_195 , V_6 ) ;
return V_195 ;
}
...
F_134 ( & V_6 -> V_200 , 6 ) ;
F_134 ( & V_6 -> V_211 , 2 ) ;
F_135 ( & V_6 -> V_211 , & V_274 ,
V_212 , 0 , 1 , 1 , 0 ) ;
F_135 ( & V_6 -> V_211 , & V_274 ,
V_214 , - 15 , 15 , 1 , 0 ) ;
F_135 ( & V_6 -> V_200 , & V_275 ,
V_205 , 0 , 255 , 1 , 54 ) ;
F_135 ( & V_6 -> V_200 , & V_275 ,
V_203 , 0 , 255 , 1 , 119 ) ;
F_135 ( & V_6 -> V_200 , & V_275 ,
...
& V_6 -> V_211 , NULL ) ;
if ( V_6 -> V_211 . error )
V_173 = V_6 -> V_211 . error ;
if ( ! V_173 && V_6 -> V_200 . error )
V_173 = V_6 -> V_200 . error ;
if ( V_173 )
goto V_276;
V_6 -> V_195 = F_129 ( V_6 , & V_277 , L_46 ) ;
if ( ! V_6 -> V_195 ) {
F_137 ( V_278 L_47 ,
V_6 -> V_161 ) ;
V_173 = - V_81 ;
...
V_6 -> V_195 -> V_200 = & V_6 -> V_200 ;
F_138 ( & V_6 -> V_7 . V_8 ) ;
F_138 ( & V_6 -> V_7 . V_247 ) ;
V_173 = F_139 ( V_6 -> V_195 , V_149 , V_279 ) ;
if ( V_173 < 0 ) {
F_137 ( V_278 L_47 ,
V_6 -> V_161 ) ;
V_270 ( V_6 -> V_195 ) ;
...
F_137 ( V_278 L_48 ,
V_6 -> V_161 , F_104 ( V_6 -> V_195 ) ) ;
if ( V_6 -> V_280 . V_281 ) {
V_6 -> V_282 = F_129 ( V_6 , & V_283 ,
L_49 ) ;
if ( ! V_6 -> V_282 ) {
F_137 ( V_278 L_50 ,
V_6 -> V_161 ) ;
...
V_6 -> V_282 -> V_200 = & V_6 -> V_211 ;
V_173 = F_139 ( V_6 -> V_282 , V_244 ,
V_286 ) ;
if ( V_173 < 0 ) {
F_137 ( V_278 L_50 ,
V_6 -> V_161 ) ;
...
F_137 ( V_278 L_48 ,
V_6 -> V_161 , F_104 ( V_6 -> V_282 ) ) ;
}
F_137 ( V_278 L_51 , V_173 ) ;
return V_173 ;
V_285:
F_140 ( V_6 -> V_195 ) ;
V_276:
