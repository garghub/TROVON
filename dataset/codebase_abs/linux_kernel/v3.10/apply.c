...
V_31 = & V_15 -> V_16 ;
V_12 = F_2 ( V_3 -> V_27 ) ;
V_64 = F_38 ( V_12 -> V_22 , V_31 -> V_65 ) ;
V_49 = F_39 ( V_3 -> V_6 , V_31 , V_64 , & V_12 -> V_39 , false ) ;
if ( V_49 ) {
F_34 ( L_7 , V_3 -> V_6 ) ;
V_15 -> V_36 = false ;
F_40 ( V_3 -> V_6 , false ) ;
...
F_42 ( V_3 -> V_6 , V_15 -> V_66 , V_15 -> V_67 ) ;
V_12 = F_2 ( V_3 -> V_27 ) ;
V_15 -> V_45 = false ;
if ( V_12 -> V_41 )
V_15 -> V_46 = true ;
...
for ( V_13 = 0 ; V_13 < V_40 ; ++ V_13 )
V_70 |= F_58 ( V_13 ) ;
V_49 = F_61 ( V_71 , NULL , V_70 ) ;
F_44 ( V_49 ) ;
V_4 . V_69 = false ;
}
static void V_71 ( void * V_72 , T_1 V_70 )
{
const int V_40 = F_15 () ;
int V_13 ;
bool V_73 ;
...
static void F_70 ( struct V_2 * V_3 , bool V_77 )
{
struct V_1 * V_15 ;
V_15 = F_1 ( V_3 ) ;
if ( V_15 -> V_36 == V_77 )
...
{
struct V_1 * V_15 = F_1 ( V_3 ) ;
if ( V_15 -> V_66 == V_66 && V_15 -> V_67 == V_67 )
return;
V_15 -> V_66 = V_66 ;
V_15 -> V_67 = V_67 ;
V_15 -> V_45 = true ;
