...
{
struct V_66 * V_67 = F_27 ( & V_29 -> V_72 ) ;
while ( V_67 != NULL ) {
struct V_25 * V_26 = F_28 ( V_67 , struct V_25 , V_66 ) ;
...
static T_6 F_34 ( double V_73 , double V_74 )
{
if ( V_73 > V_74 )
return - 1 ;
else if ( V_73 < V_74 )
...
static T_6
F_35 ( struct V_25 * V_75 , struct V_25 * V_76 ,
int V_77 )
{
switch ( V_77 ) {
case V_20 :
...
double V_74 = V_76 -> V_36 . V_37 ;
return F_34 ( V_73 , V_74 ) ;
}
case V_45 :
{
double V_73 = V_75 -> V_36 . V_41 ;
double V_74 = V_76 -> V_36 . V_41 ;
return F_34 ( V_73 , V_74 ) ;
}
case V_11 :
{
T_3 V_73 = V_75 -> V_36 . V_42 ;
T_3 V_74 = V_76 -> V_36 . V_42 ;
return V_74 - V_73 ;
}
default:
F_15 ( 1 ) ;
...
int V_77 )
{
struct V_66 * * V_78 = & V_65 -> V_66 ;
struct V_66 * V_79 = NULL ;
struct V_25 * V_80 ;
while ( * V_78 != NULL ) {
V_79 = * V_78 ;
V_80 = F_28 ( V_79 , struct V_25 , V_66 ) ;
if ( F_35 ( V_26 , V_80 , V_77 ) < 0 )
V_78 = & ( * V_78 ) -> V_81 ;
else
V_78 = & ( * V_78 ) -> V_82 ;
}
F_37 ( & V_26 -> V_66 , V_79 , V_78 ) ;
F_38 ( & V_26 -> V_66 , V_65 ) ;
}
...
F_58 ( V_113 , V_112 ) ;
F_61 () ;
F_62 ( & V_118 , V_114 . V_119 , L_23 , NULL ) ;
F_62 ( & V_120 , V_114 . V_121 , L_24 , NULL ) ;
F_62 ( & V_122 , V_114 . V_123 , L_25 , NULL ) ;
return F_47 () ;
}
