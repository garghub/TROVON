...
T_3 V_78 ;
struct V_1 * V_2 =
F_19 ( F_20 ( V_65 , struct V_79 , V_65 ) ) ;
V_76 = F_21 ( & V_80 ) ;
if ( V_76 ) {
V_77 = - V_81 ;
goto V_82;
...
static T_3 F_26 ( struct V_79 * V_34 , struct V_90 * V_67 ,
char * V_68 )
{
T_2 V_91 [ 8 ] ;
...
static T_3 F_27 ( struct V_79 * V_34 , struct V_90 * V_67 ,
...
return - V_92 ;
sscanf ( V_68 , L_15 ,
( V_52 * ) & V_91 [ 0 ] , ( V_52 * ) & V_91 [ 1 ] , ( V_52 * ) & V_91 [ 2 ] , ( V_52 * ) & V_91 [ 3 ] ,
( V_52 * ) & V_91 [ 4 ] , ( V_52 * ) & V_91 [ 5 ] ) ;
V_2 -> V_46 = F_22 ( V_2 -> V_9 , & V_78 ) ;
if ( ! V_2 -> V_46 )
return - V_89 ;
F_17 ( V_2 , V_91 ) ;
...
int V_76 ;
struct V_1 * V_2 ;
V_2 = F_29 ( sizeof( struct V_1 ) , V_95 ) ;
if ( V_2 == NULL )
return - V_89 ;
V_76 = F_30 ( V_9 ) ;
if ( V_76 ) {
...
F_6 ( & V_9 -> V_34 , L_1
L_19 , V_35 , V_76 ) ;
V_2 -> V_7 = F_33 ( V_9 , 1 , 0 ) ;
if ( V_2 -> V_7 == NULL ) {
F_31 ( & V_9 -> V_34 , L_20 , V_35 ) ;
V_76 = - V_89 ;
goto V_99;
}
F_6 ( & V_9 -> V_34 , L_21
...
if ( V_94 -> V_100 == 1 ) {
const char * V_101 ;
V_59 = F_34 ( & V_9 -> V_34 . V_65 ,
& V_102 . V_67 ) ;
if ( V_59 )
goto V_103;
V_59 = F_35 ( & V_9 -> V_34 . V_65 , & V_104 ) ;
if ( V_59 )
goto V_105;
F_1 ( V_2 ,
( unsigned int ) V_40 ,
...
struct V_1 * V_2 = F_5 ( V_9 ) ;
F_38 ( & V_9 -> V_34 . V_65 , & V_102 . V_67 ) ;
F_44 ( & V_9 -> V_34 . V_65 , & V_104 ) ;
F_39 ( V_9 , V_2 -> V_7 ) ;
F_40 ( V_9 ) ;
F_41 ( V_9 ) ;
F_42 ( V_2 ) ;
}
static int F_45 ( struct V_8 * V_9 , T_6 V_119 )
{
int V_76 ;
F_4 ( V_9 ) ;
V_76 = F_46 ( V_9 ) ;
