...
if ( F_24 ( V_1 ) )
return F_25 ( V_1 ) ;
V_1 -> V_16 = F_50 ( V_100 , & V_4 -> V_16 ,
F_51 ( V_101 , V_4 -> V_5 ) , NULL ,
L_10 , V_4 -> V_5 ) ;
if ( F_24 ( V_1 -> V_16 ) ) {
V_46 = F_25 ( V_1 -> V_16 ) ;
goto error;
}
V_46 = F_52 ( V_1 -> V_16 , & V_102 ) ;
if ( V_46 )
goto V_103;
F_17 ( L_11 ,
V_4 -> V_21 , V_4 -> V_5 ) ;
return 0 ;
V_103:
F_53 ( V_100 , F_51 ( V_101 , V_4 -> V_5 ) ) ;
error:
F_10 ( V_1 ) ;
return V_46 ;
}
static int F_54 ( struct V_15 * V_16 , void * V_99 )
{
struct V_7 * V_4 ;
struct V_1 * V_1 ;
if ( V_16 -> type != & V_38 )
...
static int F_56 ( struct V_104 * V_105 , unsigned long V_106 ,
void * V_76 )
{
...
int V_46 ;
F_6 ( V_109 L_13 ) ;
V_46 = F_58 ( V_101 , L_14 , & V_110 ) ;
if ( V_46 )
goto V_111;
V_100 = F_59 ( V_112 , L_15 ) ;
if ( F_24 ( V_100 ) ) {
V_46 = F_25 ( V_100 ) ;
goto V_113;
}
V_46 = F_60 ( & V_114 , & V_115 ) ;
if ( V_46 )
goto V_116;
F_61 ( NULL , F_48 ) ;
return 0 ;
