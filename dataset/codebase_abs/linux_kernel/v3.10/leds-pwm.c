...
{
struct V_38 * V_39 = V_20 -> V_23 . V_40 ;
struct V_18 * V_26 ;
int V_41 , V_28 = 0 ;
if ( V_39 && V_39 -> V_17 ) {
V_26 = F_12 ( & V_20 -> V_23 ,
...
if ( ! V_26 )
return - V_42 ;
for ( V_41 = 0 ; V_41 < V_39 -> V_17 ; V_41 ++ ) {
struct V_43 * V_44 = & V_39 -> V_30 [ V_41 ] ;
struct V_1 * V_2 = & V_26 -> V_30 [ V_41 ] ;
V_2 -> V_5 = F_26 ( & V_20 -> V_23 , V_44 -> V_31 ) ;
if ( F_16 ( V_2 -> V_5 ) ) {
V_28 = F_27 ( V_2 -> V_5 ) ;
F_17 ( & V_20 -> V_23 ,
L_2 ,
...
V_32:
while ( V_41 -- )
F_24 ( & V_26 -> V_30 [ V_41 ] . V_13 ) ;
return V_28 ;
}
static int F_29 ( struct V_19 * V_20 )
{
struct V_18 * V_26 = F_30 ( V_20 ) ;
int V_41 ;
for ( V_41 = 0 ; V_41 < V_26 -> V_17 ; V_41 ++ ) {
F_24 ( & V_26 -> V_30 [ V_41 ] . V_13 ) ;
if ( V_26 -> V_30 [ V_41 ] . V_16 )
F_31 ( & V_26 -> V_30 [ V_41 ] . V_8 ) ;
}
return 0 ;
}
