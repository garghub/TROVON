...
V_86 = F_8 ( V_85 , sizeof( * V_85 ) , V_93 ) ;
if ( ! V_86 ) {
...
V_12 -> V_153 = F_20 ( V_128 , sizeof( * V_125 ) , V_93 ) ;
if ( ! V_12 -> V_153 ) {
F_3 ( L_23 ) ;
return;
}
