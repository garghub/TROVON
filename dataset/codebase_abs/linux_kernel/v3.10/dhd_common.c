...
F_14 ( V_24 , V_68 ,
0 , true ) ;
F_28 (cur, q, &ifp->drvr->bus_if->dcmd_list) {
V_56 = F_29 ( V_58 , struct V_55 , V_69 ) ;
if ( V_56 -> V_70 && V_56 -> V_71 && V_56 -> V_72 ) {
F_18 ( V_24 , V_56 -> V_70 ,
V_56 -> V_71 ,
V_56 -> V_72 ) ;
}
...
void F_31 ( const char * V_73 , const char * V_74 , ... )
{
struct V_75 V_76 = {
. V_74 = V_74 ,
} ;
...
void F_34 ( V_37 V_78 , const char * V_73 , const char * V_74 , ... )
{
struct V_75 V_76 = {
. V_74 = V_74 ,
} ;
