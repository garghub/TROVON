...
F_19 ( V_59 -> V_60 , V_1 -> V_61 , V_1 -> V_62 ,
0x22 ) ;
F_20 ( V_59 -> V_60 , V_63 ) ;
F_11 ( V_1 ) ;
F_9 ( V_1 ) ;
...
{
struct V_59 * V_59 = (struct V_59 * ) V_1 ;
if ( V_65 [ 0 ] == 0xff && V_65 [ 1 ] == 0xd8 ) {
F_23 ( V_1 , V_66 , NULL , 0 ) ;
F_23 ( V_1 , V_67 ,
V_59 -> V_60 , V_68 ) ;
V_65 += 2 ;
V_3 -= 2 ;
}
F_23 ( V_1 , V_69 , V_65 , V_3 ) ;
}
static void F_24 ( struct V_1 * V_1 , T_4 V_12 , T_4 V_70 )
{
T_2 V_71 [] = { 0x88 , 0x00 , 0xd4 , 0x01 , 0x88 , 0x01 , 0x01 , 0x01 } ;
T_2 V_72 [ 2 ] ;
V_71 [ 2 ] = V_12 ;
F_8 ( V_1 , 0x00e5 , V_71 , 8 ) ;
F_1 ( V_1 , 0x00e8 , 8 ) ;
F_8 ( V_1 , 0x00e5 , V_51 , 4 ) ;
F_1 ( V_1 , 0x00e8 , 1 ) ;
V_72 [ 0 ] = 0x77 ;
V_72 [ 1 ] = V_70 ;
F_8 ( V_1 , 0x0051 , V_72 , 2 ) ;
F_8 ( V_1 , 0x0010 , V_23 , 2 ) ;
F_6 ( V_1 , 0x0070 , V_53 ) ;
}
static void F_25 ( struct V_1 * V_1 , T_4 V_12 , T_4 V_70 )
{
T_2 V_73 [] = { 0x88 , 0x0a , 0x0c , 0x01 } ;
T_2 V_72 [ 2 ] ;
V_73 [ 2 ] = V_12 ;
F_8 ( V_1 , 0x00e5 , V_73 , 4 ) ;
F_1 ( V_1 , 0x00e8 , 1 ) ;
V_72 [ 0 ] = 0x77 ;
V_72 [ 1 ] = V_70 ;
F_8 ( V_1 , 0x0051 , V_72 , 2 ) ;
...
{
struct V_1 * V_1 =
F_27 ( V_75 -> V_76 , struct V_1 , V_77 ) ;
struct V_59 * V_59 = (struct V_59 * ) V_1 ;
V_1 -> V_78 = 0 ;
if ( ! V_1 -> V_79 )
return 0 ;
switch ( V_75 -> V_56 ) {
case V_80 :
F_24 ( V_1 , V_75 -> V_12 , V_59 -> V_70 -> V_81 . V_12 ) ;
break;
case V_82 :
F_25 ( V_1 , V_75 -> V_12 , V_59 -> V_70 -> V_81 . V_12 ) ;
break;
case V_83 :
F_24 ( V_1 , V_59 -> V_84 -> V_81 . V_12 , V_75 -> V_12 ) ;
F_25 ( V_1 , V_59 -> V_85 -> V_81 . V_12 , V_75 -> V_12 ) ;
break;
}
return V_1 -> V_78 ;
}
...
{
struct V_59 * V_59 = (struct V_59 * ) V_1 ;
struct V_86 * V_87 = & V_1 -> V_77 ;
V_1 -> V_88 . V_77 = V_87 ;
F_29 ( V_87 , 3 ) ;
V_59 -> V_84 = F_30 ( V_87 , & V_89 ,
V_80 , 0 , 255 , 1 , 0xd4 ) ;
V_59 -> V_85 = F_30 ( V_87 , & V_89 ,
V_82 , 0x0a , 0x1f , 1 , 0x0c ) ;
V_59 -> V_70 = F_30 ( V_87 , & V_89 ,
V_83 , 0 , 7 , 1 , 3 ) ;
if ( V_87 -> error ) {
F_31 ( L_6 ) ;
return V_87 -> error ;
...
const struct V_55 * V_56 )
{
return F_33 ( V_91 , V_56 , & V_92 , sizeof( struct V_59 ) ,
V_93 ) ;
}
