...
static void F_44 ( struct V_28 * V_29 , int V_31 ,
const struct V_76 * V_90 ,
...
V_31 = F_40 ( V_2 , V_90 ) ;
if ( V_31 == 0 && ( V_2 -> V_92 != V_17 ) )
V_31 = F_42 ( V_2 , V_91 ) ;
if ( V_31 )
goto V_49;
V_31 = F_45 ( V_2 -> V_93 -> V_65 , F_34 ,
V_94 , V_95 , V_2 ) ;
if ( V_31 ) {
F_41 ( L_27 ) ;
goto V_49;
...
static void F_51 ( struct V_102 * V_93 )
{
struct V_1 * V_2 = V_93 -> V_29 ;
F_18 ( V_25 ) ;
F_47 ( V_93 -> V_65 , V_2 ) ;
F_52 ( V_93 ) ;
if ( V_2 -> V_5 )
...
static int F_54 ( struct V_102 * V_93 , void * V_103 )
{
V_93 -> V_104 [ 0 ] -> V_47 &= ~ V_105 ;
V_93 -> V_104 [ 0 ] -> V_47 |= V_106 ;
if ( V_93 -> V_104 [ 1 ] -> V_107 ) {
F_41 ( L_31 ) ;
return - V_84 ;
}
return F_55 ( V_93 ) ;
}
static int F_56 ( struct V_102 * V_93 )
{
int V_31 = - V_108 ;
unsigned int V_109 ;
struct V_28 * V_29 ;
struct V_1 * V_2 ;
F_18 ( V_25 ) ;
V_2 = F_57 ( sizeof( struct V_1 ) , V_110 ) ;
if ( ! V_2 )
goto V_49;
V_2 -> V_93 = V_93 ;
V_93 -> V_29 = V_2 ;
V_93 -> V_111 |= V_112 | V_113 ;
if ( F_58 ( V_93 , F_54 , NULL ) ) {
F_41 ( L_32 ) ;
goto V_114;
}
if ( ! V_93 -> V_65 )
goto V_114;
V_2 -> V_5 = F_59 ( V_93 -> V_104 [ 0 ] -> V_115 ,
F_60 ( V_93 -> V_104 [ 0 ] ) ) ;
if ( ! V_2 -> V_5 ) {
F_41 ( L_33 ) ;
V_31 = - V_116 ;
...
F_35 ( L_35 , V_93 -> V_65 , V_93 -> V_104 [ 0 ] ) ;
V_2 -> V_80 = false ;
V_2 -> V_92 = F_16 ( V_93 -> V_13 , V_93 -> V_14 ) ;
if ( V_2 -> V_92 == V_24 ) {
F_41 ( L_36 ,
V_93 -> V_13 , V_93 -> V_14 ) ;
goto V_117;
...
if ( ( V_2 -> V_92 == V_20 ) && V_109 < V_120 ) {
F_41 ( L_38 ) ;
V_31 = - V_84 ;
goto V_117;
}
if ( ( V_2 -> V_92 == V_23 ) && V_109 < V_121 ) {
F_41 ( L_39 ) ;
V_31 = - V_84 ;
goto V_117;
}
V_29 = F_62 ( V_2 , & V_93 -> V_36 ) ;
if ( ! V_29 ) {
V_31 = - V_108 ;
goto V_117;
}
...
V_29 -> V_124 = NULL ;
V_29 -> V_125 = NULL ;
V_31 = F_63 ( V_29 , & V_93 -> V_36 , V_2 -> V_92 , V_126 ,
F_44 ) ;
if ( V_31 ) {
F_41 ( L_26 , V_31 ) ;
goto V_127;
...
static void F_65 ( struct V_102 * V_93 )
{
struct V_1 * V_2 = V_93 -> V_29 ;
F_18 ( V_25 ) ;
F_66 ( V_2 -> V_29 ) ;
