...
static int F_37 ( struct V_60 * V_8 )
{
struct V_1 * V_2 ;
struct V_61 * V_62 ;
int V_25 , V_6 ;
V_2 = F_38 ( sizeof( * V_2 ) , V_63 ) ;
if ( V_2 == NULL ) {
F_7 ( & V_8 -> V_9 , L_5 ) ;
V_6 = - V_64 ;
goto V_65;
...
V_2 -> V_4 = F_42 ( V_62 -> V_68 , F_43 ( V_62 ) ) ;
if ( V_2 -> V_4 == NULL ) {
F_7 ( & V_8 -> V_9 , L_8 ) ;
V_6 = - V_69 ;
goto V_65;
}
V_2 -> V_7 = F_44 ( & V_8 -> V_9 , L_9 ) ;
if ( F_45 ( V_2 -> V_7 ) ) {
F_7 ( & V_8 -> V_9 , L_10 ) ;
V_6 = F_46 ( V_2 -> V_7 ) ;
goto V_70;
...
static int F_52 ( struct V_60 * V_8 )
{
return - V_76 ;
}
