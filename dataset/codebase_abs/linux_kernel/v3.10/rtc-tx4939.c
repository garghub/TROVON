...
F_20 ( & V_12 -> V_15 ) ;
if ( F_21 ( V_12 -> V_44 ) )
F_22 ( V_12 -> V_44 , 1 , V_41 ) ;
return V_45 ;
}
static T_4 F_23 ( struct V_46 * V_47 , struct V_48 * V_49 ,
struct V_50 * V_51 ,
char * V_14 , T_5 V_52 , T_6 V_53 )
{
struct V_2 * V_3 = F_24 ( V_49 , struct V_2 , V_49 ) ;
struct V_1 * V_12 = F_1 ( V_3 ) ;
struct V_4 T_1 * V_5 = V_12 -> V_5 ;
T_4 V_54 ;
F_9 ( & V_12 -> V_15 ) ;
for ( V_54 = 0 ; V_53 > 0 && V_52 < V_55 ;
V_54 ++ , V_53 -- ) {
F_5 ( V_52 ++ , & V_5 -> V_16 ) ;
* V_14 ++ = F_6 ( & V_5 -> V_17 ) ;
}
...
static T_4 F_25 ( struct V_46 * V_47 , struct V_48 * V_49 ,
struct V_50 * V_51 ,
char * V_14 , T_5 V_52 , T_6 V_53 )
{
struct V_2 * V_3 = F_24 ( V_49 , struct V_2 , V_49 ) ;
...
static int T_7 F_26 ( struct V_56 * V_57 )
{
struct V_58 * V_44 ;
struct V_1 * V_12 ;
struct V_59 * V_60 ;
int V_39 , V_13 ;
V_60 = F_27 ( V_57 , V_61 , 0 ) ;
if ( ! V_60 )
return - V_62 ;
V_39 = F_28 ( V_57 , 0 ) ;
if ( V_39 < 0 )
return - V_62 ;
V_12 = F_29 ( & V_57 -> V_3 , sizeof( * V_12 ) , V_63 ) ;
if ( ! V_12 )
return - V_64 ;
F_30 ( V_57 , V_12 ) ;
if ( ! F_31 ( & V_57 -> V_3 , V_60 -> V_65 ,
F_32 ( V_60 ) , V_57 -> V_66 ) )
return - V_10 ;
V_12 -> V_5 = F_33 ( & V_57 -> V_3 , V_60 -> V_65 ,
F_32 ( V_60 ) ) ;
if ( ! V_12 -> V_5 )
return - V_10 ;
F_34 ( & V_12 -> V_15 ) ;
F_4 ( V_12 -> V_5 , V_38 ) ;
if ( F_35 ( & V_57 -> V_3 , V_39 , F_18 ,
0 , V_57 -> V_66 , & V_57 -> V_3 ) < 0 )
return - V_10 ;
V_44 = F_36 ( & V_57 -> V_3 , V_57 -> V_66 ,
& V_67 , V_68 ) ;
if ( F_37 ( V_44 ) )
return F_38 ( V_44 ) ;
V_12 -> V_44 = V_44 ;
V_13 = F_39 ( & V_57 -> V_3 . V_49 , & V_69 ) ;
return V_13 ;
}
static int T_8 F_40 ( struct V_56 * V_57 )
{
struct V_1 * V_12 = F_2 ( V_57 ) ;
F_41 ( & V_57 -> V_3 . V_49 , & V_69 ) ;
F_9 ( & V_12 -> V_15 ) ;
F_4 ( V_12 -> V_5 , V_38 ) ;
F_10 ( & V_12 -> V_15 ) ;
return 0 ;
