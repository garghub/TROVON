...
int V_74 ;
V_17 -> V_75 = V_20 -> V_31 ;
V_74 = F_13 ( V_17 , 8 , 8 , V_76 ) ;
if ( V_74 < 0 ) {
F_8 ( V_17 -> V_2 , L_3 , V_74 ) ;
return V_74 ;
}
F_2 ( V_17 , V_27 ) ;
return 0 ;
...
struct V_20 * V_20 ;
int V_74 ;
if ( ! F_18 ( V_78 -> V_81 , V_82 ) )
return - V_52 ;
V_20 = F_19 ( & V_78 -> V_2 , sizeof( struct V_20 ) , V_83 ) ;
if ( V_20 == NULL ) {
F_8 ( & V_78 -> V_2 , L_4 ) ;
return - V_84 ;
}
V_20 -> V_31 = F_20 ( V_78 , & V_85 ) ;
if ( F_21 ( V_20 -> V_31 ) ) {
V_74 = F_22 ( V_20 -> V_31 ) ;
F_8 ( & V_78 -> V_2 , L_5 , V_74 ) ;
return V_74 ;
}
F_23 ( V_78 , V_20 ) ;
V_74 = F_24 ( & V_78 -> V_2 ,
& V_86 , & V_87 , 1 ) ;
if ( V_74 != 0 )
F_8 ( & V_78 -> V_2 , L_6 , V_74 ) ;
return V_74 ;
}
static int F_25 ( struct V_77 * V_88 )
{
F_26 ( & V_88 -> V_2 ) ;
return 0 ;
}
