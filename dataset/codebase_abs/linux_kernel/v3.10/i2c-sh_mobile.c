...
{
struct V_101 * V_102 = V_21 -> V_21 . V_103 ;
struct V_1 * V_2 ;
struct V_79 * V_104 ;
struct V_92 * V_93 ;
int V_105 ;
int V_36 ;
V_2 = F_44 ( sizeof( struct V_1 ) , V_106 ) ;
if ( V_2 == NULL ) {
F_11 ( & V_21 -> V_21 , L_12 ) ;
return - V_107 ;
}
V_2 -> V_16 = F_45 ( & V_21 -> V_21 , NULL ) ;
if ( F_46 ( V_2 -> V_16 ) ) {
F_11 ( & V_21 -> V_21 , L_13 ) ;
V_36 = F_47 ( V_2 -> V_16 ) ;
goto V_83;
...
V_104 -> V_111 = V_112 ;
V_104 -> V_113 = & V_114 ;
V_104 -> V_21 . V_115 = & V_21 -> V_21 ;
V_104 -> V_116 = 5 ;
V_104 -> V_117 = V_21 -> V_118 ;
V_104 -> V_21 . V_119 = V_21 -> V_21 . V_119 ;
F_54 ( V_104 -> V_120 , V_21 -> V_120 , sizeof( V_104 -> V_120 ) ) ;
F_55 ( & V_2 -> V_37 ) ;
F_56 ( & V_2 -> V_68 ) ;
V_36 = F_57 ( V_104 ) ;
if ( V_36 < 0 ) {
...
F_58 ( & V_21 -> V_21 ,
L_18 ,
V_104 -> V_117 , V_2 -> V_18 , V_2 -> V_23 , V_2 -> V_27 ) ;
F_59 ( V_104 ) ;
return 0 ;
V_121:
F_60 ( V_2 -> V_7 ) ;
...
static int F_66 ( struct V_122 * V_21 )
{
return 0 ;
}
