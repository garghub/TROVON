...
static int F_60 ( struct V_4 * V_5 , V_3 V_29 )
{
T_6 V_86 ;
T_1 V_88 ;
memset ( & V_86 , 0 , sizeof( T_6 ) ) ;
V_86 . V_89 = F_47 ( V_111 << 23 ) ;
V_88 = V_112 |
( ( T_1 ) V_5 -> V_19 << 16 ) ;
V_86 . V_92 = F_47 ( V_88 ) ;
...
static int F_62 ( struct V_4 * V_5 , T_5 * V_1 )
{
F_54 ( V_5 -> V_53 ) ;
return 0 ;
}
...
V_86 . V_89 = F_47 ( V_111 << 23 ) ;
V_88 [ 0 ] = V_114 | ( ( T_1 ) V_5 -> V_19 << 16 ) ;
V_86 . V_92 = F_47 ( V_88 [ 0 ] ) ;
memcpy ( & V_88 [ 0 ] , & V_5 -> V_115 , sizeof( V_5 -> V_115 ) ) ;
for ( V_57 = 0 ; V_57 < 6 ; V_57 ++ )
V_86 . V_93 [ V_57 ] = F_47 ( V_88 [ V_57 ] ) ;
V_113 = F_37 ( V_5 , (struct V_64 * ) & V_86 , 1 ) ;
if ( V_113 != 0 ) {
F_64 ( V_116 L_1
L_2 ) ;
}
...
int F_65 ( struct V_4 * V_5 , int V_117 )
{
T_6 V_86 ;
T_1 V_88 ;
int V_113 = 0 ;
if ( ! F_66 ( V_118 , & V_5 -> V_119 ) )
return 0 ;
memset ( & V_86 , 0 , sizeof( T_6 ) ) ;
V_86 . V_89 = F_47 ( V_111 << 23 ) ;
V_88 = V_120 | ( ( T_1 ) V_5 -> V_19 << 16 ) ;
V_86 . V_92 = F_47 ( V_88 ) ;
V_86 . V_93 [ 0 ] = F_47 ( V_117 ) ;
V_113 = F_37 ( V_5 , (struct V_64 * ) & V_86 , 1 ) ;
if ( V_113 != 0 ) {
F_64 ( V_116 L_1
L_3 ) ;
...
int F_68 ( struct V_4 * V_5 , int V_117 )
{
T_6 V_86 ;
T_1 V_88 ;
int V_57 , V_113 ;
...
memset ( & V_86 , 0 , sizeof( T_6 ) ) ;
V_86 . V_89 = F_47 ( V_111 << 23 ) ;
V_88 = V_124 | ( ( T_1 ) V_5 -> V_19 << 16 ) ;
V_86 . V_92 = F_47 ( V_88 ) ;
V_88 = ( ( T_1 ) ( V_125 & 0x3 ) << 4 ) |
( ( T_1 ) ( V_125 & 0x3 ) << 6 ) |
( ( T_1 ) ( V_117 & 0x1 ) << 8 ) |
( ( 0x7ULL ) << 48 ) ;
V_86 . V_93 [ 0 ] = F_47 ( V_88 ) ;
for ( V_57 = 0 ; V_57 < F_69 ( V_123 ) ; V_57 ++ )
V_86 . V_93 [ V_57 + 1 ] = F_47 ( V_123 [ V_57 ] ) ;
V_113 = F_37 ( V_5 , (struct V_64 * ) & V_86 , 1 ) ;
if ( V_113 != 0 ) {
F_64 ( V_116 L_5 ,
V_5 -> V_53 -> V_126 ) ;
...
int F_70 ( struct V_4 * V_5 , T_9 V_127 , int V_128 )
{
T_6 V_86 ;
T_1 V_88 ;
int V_113 ;
...
memcpy ( & V_86 . V_93 [ 1 ] , & V_127 , sizeof( V_3 ) ) ;
V_113 = F_37 ( V_5 , (struct V_64 * ) & V_86 , 1 ) ;
if ( V_113 != 0 ) {
F_64 ( V_116 L_6 ,
V_5 -> V_53 -> V_126 ,
...
int F_71 ( struct V_4 * V_5 , int V_117 )
{
T_6 V_86 ;
T_1 V_88 ;
int V_113 ;
...
V_86 . V_92 = F_47 ( V_88 ) ;
V_86 . V_93 [ 0 ] = F_47 ( V_117 | ( V_117 << 8 ) ) ;
V_113 = F_37 ( V_5 , (struct V_64 * ) & V_86 , 1 ) ;
if ( V_113 != 0 ) {
F_64 ( V_116 L_9 ,
V_5 -> V_53 -> V_126 ) ;
...
static int
F_97 ( struct V_4 * V_5 , T_12 V_6 , V_3 V_179 )
{
unsigned long V_58 ;
...
static int
F_104 ( struct V_4 * V_5 , T_12 V_6 , V_3 V_179 )
{
unsigned long V_58 ;
int V_113 ;
void T_2 * V_1 = NULL ;
V_113 = F_86 ( V_5 , V_6 , & V_1 ) ;
if ( V_113 == 0 ) {
F_4 ( V_179 , V_1 ) ;
return 0 ;
}
...
static V_3 F_139 ( struct V_4 * V_5 ,
struct V_311 * V_312 ,
struct V_313 * V_314 )
{
int V_315 , V_57 , V_113 = 0 , V_316 ;
V_3 V_317 , V_318 ;
V_3 V_319 , V_320 , V_1 ;
...
for ( V_57 = 0 ; V_57 < sizeof( V_314 -> V_319 ) * 8 ; V_57 ++ ) {
V_319 = ( V_314 -> V_319 & ( 0x1 << V_57 ) ) ;
if ( V_319 ) {
switch ( V_319 ) {
case V_323 :
F_140 ( V_1 ,
...
V_315 = V_342 -> V_346 ;
V_315 /= sizeof( V_344 ) ;
for ( V_57 = 0 ; V_57 < V_315 ; V_57 ++ ) {
if ( F_130 ( V_5 , V_1 , & V_344 ) )
goto V_347;
* V_343 ++ = V_344 ;
V_1 += sizeof( V_344 ) ;
}
V_347:
return V_57 * sizeof( V_344 ) ;
}
static V_3 F_145 ( struct V_4 * V_5 ,
struct V_313
* V_348 , V_3 * V_343 )
{
int V_315 ;
...
V_318 = V_348 -> V_322 ;
for ( V_315 = 0 ; V_315 < V_317 ; V_315 ++ ) {
F_141 ( V_1 , V_5 -> V_21 . V_169 , & V_344 ) ;
* V_343 ++ = V_1 ;
* V_343 ++ = V_344 ;
V_1 = V_1 + V_318 ;
}
...
V_141 = V_350 -> V_346 / 4 ;
V_355:
V_351 = F_2 ( ( void T_2 * ) ( V_5 -> V_21 . V_169 +
V_356 ) ) ;
if ( ! V_351 && V_155 < V_231 ) {
F_14 ( 20 ) ;
V_155 ++ ;
goto V_355;
}
F_4 ( V_5 -> V_21 . V_152 , ( void T_2 * ) ( V_5 -> V_21 . V_169 +
V_357 ) ) ;
for ( V_57 = 0 ; V_57 < V_141 ; V_57 ++ ) {
V_353 = V_352 & 0xFFFF0000 ;
F_140 ( V_358 , V_5 -> V_21 . V_169 , V_353 ) ;
V_354 = V_359 + ( V_352 & 0x0000FFFF ) ;
F_141 ( V_354 , V_5 -> V_21 . V_169 , & V_2 ) ;
* V_343 ++ = F_76 ( V_2 ) ;
V_352 += sizeof( V_2 ) ;
}
F_2 ( ( void T_2 * ) ( V_5 -> V_21 . V_169 + V_360 ) ) ;
return V_350 -> V_346 ;
}
static V_3
...
V_367 = V_362 -> V_373 ;
for ( V_57 = 0 ; V_57 < V_315 ; V_57 ++ ) {
F_140 ( V_365 , V_5 -> V_21 . V_169 , V_366 ) ;
if ( V_368 )
F_140 ( V_364 , V_5 -> V_21 . V_169 ,
( V_3 ) V_368 ) ;
if ( V_362 -> V_374 ) {
V_16 = V_362 -> V_375 ;
F_141 ( V_364 , V_5 -> V_21 . V_169 ,
& V_369 ) ;
V_321 = F_142 ( V_16 ) + V_332 ;
for ( V_316 = 0 ; ! V_316 &&
( ( V_369 & V_362 -> V_374 ) != 0 ) ; ) {
if ( F_143 ( V_332 , V_321 ) )
V_316 = 1 ;
F_141 ( V_364 ,
V_5 -> V_21 . V_169 ,
& V_369 ) ;
...
static V_3 F_148 ( struct V_4 * V_5 ,
struct V_361
* V_362 , V_3 * V_343 )
{
int V_57 , V_363 , V_315 ;
V_3 V_1 , V_345 , V_320 , V_364 , V_365 ;
V_3 V_366 , V_367 ;
T_5 V_368 ;
V_315 = V_362 -> V_317 ;
...
V_3 V_344 ;
void T_2 * V_1 ;
V_1 = ( V_379 -> V_345 + V_5 -> V_21 . V_169 ) ;
V_315 = V_379 -> V_317 ;
for ( V_57 = 0 ; V_57 < V_315 ; V_57 ++ ) {
V_344 = F_2 ( V_1 ) ;
* V_343 ++ = V_344 ;
...
return V_57 * sizeof( V_3 ) ;
}
static V_3
F_150 ( struct V_4 * V_5 , struct V_380
* V_381 , V_3 * V_343 )
{
int V_315 = 0 ;
...
F_140 ( V_382 , V_5 -> V_21 . V_169 , V_383 ) ;
F_141 ( V_345 , V_5 -> V_21 . V_169 , & V_320 ) ;
* V_343 ++ = V_383 ;
* V_343 ++ = V_320 ;
V_383 += V_381 -> V_385 ;
}
...
V_315 ++ ) {
F_140 ( V_382 , V_5 -> V_21 . V_169 , V_388 ) ;
V_345 = V_387 -> V_345 ;
for ( V_363 = 0 ; V_363 < V_367 ; V_363 -- ) {
F_141 ( V_345 , V_5 -> V_21 . V_169 ,
& V_320 ) ;
* V_343 ++ = V_320 ;
V_345 += V_389 ;
}
...
{
struct V_311 * V_394 ;
int V_57 , V_363 , V_444 = 0 ;
V_3 V_413 ;
V_394 = (struct V_311 * )
V_5 -> V_409 . V_410 ;
V_413 = V_5 -> V_409 . V_414 ;
for ( V_57 = 0x2 , V_363 = 1 ; ( V_57 & V_445 ) ; V_57 <<= 1 , V_363 ++ ) {
if ( V_57 & V_413 )
...
if ( ! V_5 -> V_409 . V_412 ) {
V_5 -> V_409 . V_412 =
F_158 ( V_5 -> V_409 . V_448 ) ;
if ( ! V_5 -> V_409 . V_412 )
return;
if ( F_155 ( V_5 ) ) {
V_5 -> V_409 . V_449 = 0 ;
V_5 -> V_409 . V_448 = 0 ;
F_159 ( V_5 -> V_409 . V_412 ) ;
