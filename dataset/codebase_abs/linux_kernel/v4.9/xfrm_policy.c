...
switch ( V_5 -> V_31 ) {
case V_32 :
F_287 ( V_423 , L_3 , & V_5 -> V_15 . V_13 ) ;
if ( V_5 -> V_16 != 32 )
F_287 ( V_423 , L_4 ,
V_5 -> V_16 ) ;
F_287 ( V_423 , L_5 , & V_5 -> V_12 . V_13 ) ;
if ( V_5 -> V_14 != 32 )
F_287 ( V_423 , L_6 ,
V_5 -> V_14 ) ;
break;
case V_33 :
F_287 ( V_423 , L_7 , V_5 -> V_15 . V_427 ) ;
if ( V_5 -> V_16 != 128 )
F_287 ( V_423 , L_4 ,
V_5 -> V_16 ) ;
F_287 ( V_423 , L_8 , V_5 -> V_12 . V_427 ) ;
if ( V_5 -> V_14 != 128 )
F_287 ( V_423 , L_6 ,
V_5 -> V_14 ) ;
break;
...
void F_288 ( struct V_1 * V_58 , int V_428 , bool V_197 )
{
struct V_422 * V_423 ;
V_423 = F_289 ( L_9 ) ;
if ( V_423 == NULL )
...
static bool F_292 ( const struct V_4 * V_429 ,
const struct V_4 * V_430 )
{
if ( V_429 -> V_23 == V_431 ) {
if ( V_430 -> V_31 == V_429 -> V_31 &&
F_293 ( & V_430 -> V_12 , & V_429 -> V_12 ,
V_429 -> V_31 ) &&
F_293 ( & V_430 -> V_15 , & V_429 -> V_15 ,
V_429 -> V_31 ) &&
...
static struct V_1 * F_294 ( const struct V_4 * V_5 ,
...
static int F_295 ( const struct V_432 * V_186 , const struct V_230 * V_433 )
{
int V_206 = 0 ;
...
case V_240 :
case V_241 :
if ( F_293 ( & V_433 -> V_49 . V_12 , & V_186 -> V_434 ,
V_186 -> V_435 ) &&
F_293 ( & V_433 -> V_15 , & V_186 -> V_436 ,
V_186 -> V_435 ) ) {
V_206 = 1 ;
}
break;
...
static int F_296 ( struct V_1 * V_84 ,
...
if ( ! F_295 ( V_438 , & V_84 -> V_229 [ V_131 ] ) )
continue;
V_440 ++ ;
...
static int F_299 ( const struct V_432 * V_186 , int V_437 )
{
int V_131 , V_439 ;
if ( V_437 < 1 || V_437 > V_253 )
return - V_204 ;
for ( V_131 = 0 ; V_131 < V_437 ; V_131 ++ ) {
if ( F_293 ( & V_186 [ V_131 ] . V_434 , & V_186 [ V_131 ] . V_441 ,
V_186 [ V_131 ] . V_435 ) &&
F_293 ( & V_186 [ V_131 ] . V_436 , & V_186 [ V_131 ] . V_442 ,
V_186 [ V_131 ] . V_435 ) )
return - V_204 ;
...
struct V_432 * V_438 ;
if ( ( V_194 = F_299 ( V_186 , V_437 ) ) < 0 )
goto V_67;
if ( ( V_84 = F_294 ( V_5 , V_63 , type , V_38 ) ) == NULL ) {
V_194 = - V_196 ;
goto V_67;
}
for ( V_131 = 0 , V_438 = V_186 ; V_131 < V_437 ; V_131 ++ , V_438 ++ ) {
if ( ( V_45 = F_300 ( V_438 , V_38 ) ) ) {
V_449 [ V_446 ] = V_45 ;
V_446 ++ ;
if ( ( V_448 = F_301 ( V_45 , V_438 ) ) ) {
V_450 [ V_447 ] = V_448 ;
V_447 ++ ;
} else {
V_194 = - V_444 ;
...
if ( ( V_194 = F_296 ( V_84 , V_186 , V_437 ) ) < 0 )
goto V_451;
if ( V_446 ) {
F_302 ( V_449 , V_446 ) ;
F_303 ( V_449 , V_446 ) ;
}
F_304 ( V_5 , V_63 , type , V_186 , V_437 , V_357 ) ;
F_30 ( V_84 ) ;
return 0 ;
V_67:
return V_194 ;
