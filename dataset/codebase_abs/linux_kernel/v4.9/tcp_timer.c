...
goto V_69;
if ( F_31 ( V_26 -> V_66 . V_38 , V_70 ) ) {
F_32 ( V_2 , & V_26 -> V_71 , V_26 -> V_66 . V_38 ) ;
goto V_69;
}
V_26 -> V_66 . V_67 &= ~ V_68 ;
if ( ! F_33 ( & V_10 -> V_72 . V_73 ) ) {
struct V_74 * V_75 ;
F_3 ( F_4 ( V_2 ) , V_76 ) ;
while ( ( V_75 = F_34 ( & V_10 -> V_72 . V_73 ) ) != NULL )
F_35 ( V_2 , V_75 ) ;
V_10 -> V_72 . V_77 = 0 ;
}
if ( F_36 ( V_2 ) ) {
...
static void F_40 ( unsigned long V_82 )
{
...
goto V_69;
if ( F_31 ( V_26 -> V_136 , V_70 ) ) {
F_32 ( V_2 , & V_26 -> V_137 , V_26 -> V_136 ) ;
goto V_69;
}
V_134 = V_26 -> V_135 ;
switch ( V_134 ) {
...
static void F_72 ( unsigned long V_82 )
{
struct V_1 * V_2 = (struct V_1 * ) V_82 ;
F_41 ( V_2 ) ;
if ( ! F_42 ( V_2 ) ) {
...
if ( ! F_43 ( V_141 , & F_6 ( V_2 ) -> V_86 ) )
F_44 ( V_2 ) ;
}
F_45 ( V_2 ) ;
F_46 ( V_2 ) ;
}
void F_73 ( const struct V_93 * V_94 )
{
struct V_27 * V_27 = F_74 ( & F_75 ( V_94 ) -> V_142 ) ;
F_3 ( V_27 , V_128 ) ;
}
void F_76 ( struct V_1 * V_2 , int V_143 )
{
if ( ( 1 << V_2 -> V_48 ) & ( V_144 | V_145 ) )
return;
if ( V_143 && ! F_28 ( V_2 , V_146 ) )
F_77 ( V_2 , F_78 ( F_6 ( V_2 ) ) ) ;
else if ( ! V_143 )
F_79 ( V_2 ) ;
}
static void F_80 ( unsigned long V_82 )
{
struct V_1 * V_2 = (struct V_1 * ) V_82 ;
struct V_25 * V_26 = F_17 ( V_2 ) ;
struct V_9 * V_10 = F_6 ( V_2 ) ;
...
if ( V_2 -> V_48 == V_150 && F_28 ( V_2 , V_62 ) ) {
if ( V_10 -> V_151 >= 0 ) {
const int V_152 = F_82 ( V_2 ) - V_16 ;
if ( V_152 > 0 ) {
F_83 ( V_2 , V_150 , V_152 ) ;
goto V_69;
}
}
F_8 ( V_2 , V_19 ) ;
...
if ( ! F_28 ( V_2 , V_146 ) || V_2 -> V_48 == V_65 )
goto V_69;
V_147 = F_78 ( V_10 ) ;
if ( V_10 -> V_18 || F_48 ( V_2 ) )
goto V_154;
