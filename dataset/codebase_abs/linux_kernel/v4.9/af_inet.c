...
V_108 = F_39 ( V_42 , V_2 -> V_118 ) ? : V_108 ;
V_107 = F_40 ( V_42 , V_105 -> V_115 . V_116 , V_108 ) ;
V_27 = - V_119 ;
if ( ! V_42 -> V_76 . V_120 &&
! ( V_4 -> V_121 || V_4 -> V_122 ) &&
V_105 -> V_115 . V_116 != F_38 ( V_117 ) &&
...
V_143 = F_52 ( V_2 , V_64 & V_157 ) ;
if ( ( 1 << V_2 -> V_9 ) & ( V_148 | V_149 ) ) {
int V_144 = ( V_2 -> V_83 == V_158 ) &&
F_53 ( V_2 ) -> V_159 &&
F_53 ( V_2 ) -> V_159 -> V_160 ? 1 : 0 ;
...
int F_56 ( struct V_24 * V_1 , struct V_24 * V_163 , int V_64 )
{
...
int F_61 ( struct V_24 * V_1 , struct V_174 * V_175 , T_3 V_176 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
F_57 ( V_2 ) ;
...
T_4 F_62 ( struct V_24 * V_1 , struct V_179 * V_179 , int V_180 ,
T_3 V_176 , int V_64 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
F_57 ( V_2 ) ;
...
return F_63 ( V_1 , V_179 , V_180 , V_176 , V_64 ) ;
}
int F_64 ( struct V_24 * V_1 , struct V_174 * V_175 , T_3 V_176 ,
int V_64 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
int V_103 = 0 ;
...
int F_65 ( struct V_24 * V_1 , int V_185 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
int V_27 = 0 ;
V_185 ++ ;
...
int F_66 ( struct V_24 * V_1 , unsigned int V_192 , unsigned long V_193 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
int V_27 = 0 ;
struct V_42 * V_42 = F_37 ( V_2 ) ;
switch ( V_192 ) {
case V_194 :
V_27 = F_67 ( V_2 , (struct V_195 V_196 * ) V_193 ) ;
break;
case V_197 :
V_27 = F_68 ( V_2 , (struct V_198 V_196 * ) V_193 ) ;
break;
case V_199 :
case V_200 :
case V_201 :
V_27 = F_69 ( V_42 , V_192 , ( void V_196 * ) V_193 ) ;
break;
case V_202 :
case V_203 :
case V_204 :
...
static int F_72 ( struct V_24 * V_1 , unsigned int V_192 , unsigned long V_193 )
{
struct V_1 * V_2 = V_1 -> V_2 ;
int V_27 = - V_217 ;
if ( V_2 -> V_20 -> V_218 )
...
V_46 = F_76 ( V_221 , struct V_45 , V_227 ) ;
...
V_235 = F_84 ( V_233 , V_231 , 0 , F_85 ( V_2 ) ,
V_2 -> V_118 , V_2 -> V_83 ,
V_4 -> V_23 , V_4 -> V_139 , V_2 ) ;
if ( F_86 ( V_235 ) )
return F_87 ( V_235 ) ;
F_88 ( V_2 , & V_235 -> V_245 ) ;
V_236 = V_233 -> V_246 ;
if ( V_236 == V_230 )
return 0 ;
if ( F_37 ( V_2 ) -> V_76 . V_247 > 1 ) {
F_89 ( L_8 ,
V_248 , & V_230 , & V_236 ) ;
}
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_234 * V_235 = (struct V_234 * ) F_92 ( V_2 , 0 ) ;
T_2 V_231 ;
struct V_237 * V_16 ;
struct V_232 * V_233 ;
int V_27 ;
...
F_27 () ;
V_233 = & V_4 -> V_241 . V_242 . V_243 . V_244 ;
V_235 = F_94 ( F_37 ( V_2 ) , V_233 , V_2 , V_231 , V_4 -> V_132 ,
V_4 -> V_139 , V_4 -> V_23 ,
V_2 -> V_83 , F_85 ( V_2 ) ,
V_2 -> V_118 ) ;
if ( ! F_86 ( V_235 ) ) {
...
struct V_251 * F_95 ( struct V_251 * V_252 ,
T_5 V_253 )
{
bool V_254 = false , V_255 = false , V_256 , V_257 ;
struct V_251 * V_258 = F_96 ( - V_28 ) ;
...
int V_265 ;
F_97 ( V_252 ) ;
V_263 = F_98 ( V_252 ) - F_99 ( V_252 ) ;
if ( F_26 ( ! F_100 ( V_252 , sizeof( * V_261 ) ) ) )
goto V_31;
V_261 = F_101 ( V_252 ) ;
V_264 = V_261 -> V_264 * 4 ;
...
V_47 = V_261 -> V_43 ;
if ( F_26 ( ! F_100 ( V_252 , V_264 ) ) )
goto V_31;
F_102 ( V_252 , V_264 ) ;
V_257 = F_103 ( V_252 ) -> V_266 > 0 ;
if ( V_257 )
V_253 &= V_252 -> V_267 -> V_268 ;
F_103 ( V_252 ) -> V_266 += V_264 ;
F_104 ( V_252 ) ;
V_258 = F_96 ( - V_55 ) ;
if ( ! V_252 -> V_269 || V_257 ) {
V_254 = ! ! ( F_105 ( V_252 ) -> V_270 & V_271 ) ;
V_255 = ! ! ( F_105 ( V_252 ) -> V_270 & V_272 ) ;
if ( V_255 && ! ( F_101 ( V_252 ) -> V_273 & F_17 ( V_274 ) ) )
goto V_31;
}
V_62 = F_93 ( V_275 [ V_47 ] ) ;
if ( F_106 ( V_62 && V_62 -> V_276 . V_277 ) )
V_258 = V_62 -> V_276 . V_277 ( V_252 , V_253 ) ;
if ( F_107 ( V_258 ) )
goto V_31;
V_256 = ! ! ( F_105 ( V_258 ) -> V_270 & V_278 ) ;
V_252 = V_258 ;
do {
V_261 = (struct V_260 * ) ( F_99 ( V_252 ) + V_263 ) ;
if ( V_254 ) {
...
V_265 += F_105 ( V_252 ) -> V_282 ;
}
if ( V_256 )
V_262 = F_105 ( V_252 ) -> V_283 +
F_103 ( V_252 ) -> V_284 +
...
struct V_251 * * F_111 ( struct V_251 * * V_285 , struct V_251 * V_252 )
{
const struct V_259 * V_62 ;
...
V_261 = F_113 ( V_252 , V_290 ) ;
if ( F_114 ( V_252 , V_289 ) ) {
V_261 = F_115 ( V_252 , V_289 , V_290 ) ;
if ( F_26 ( ! V_261 ) )
goto V_31;
}
V_47 = V_261 -> V_43 ;
...
if ( * ( V_287 * ) V_261 != 0x45 )
goto V_293;
if ( F_26 ( F_116 ( ( V_287 * ) V_261 , 5 ) ) )
goto V_293;
V_265 = F_117 ( * ( T_2 * ) & V_261 -> V_265 ) ;
V_291 = ( V_294 ) ( ( F_117 ( * ( T_2 * ) V_261 ) ^ F_118 ( V_252 ) ) | ( V_265 & ~ V_274 ) ) ;
V_265 >>= 16 ;
for ( V_219 = * V_285 ; V_219 ; V_219 = V_219 -> V_279 ) {
struct V_260 * V_295 ;
V_294 V_296 ;
if ( ! F_119 ( V_219 ) -> V_297 )
continue;
...
F_119 ( V_219 ) -> V_291 |= V_291 ;
V_296 = ( V_294 ) ( V_265 - F_41 ( V_295 -> V_265 ) ) ;
if ( ! F_119 ( V_219 ) -> V_301 ||
! ( V_261 -> V_273 & F_17 ( V_274 ) ) ) {
V_296 ^= F_119 ( V_219 ) -> V_302 ;
V_296 = V_296 ? 0xFFFF : 0 ;
}
if ( F_119 ( V_252 ) -> V_301 )
F_119 ( V_219 ) -> V_296 = V_296 ;
else
F_119 ( V_219 ) -> V_296 |= V_296 ;
}
F_119 ( V_252 ) -> V_301 = ! ! ( V_261 -> V_273 & F_17 ( V_274 ) ) ;
F_119 ( V_252 ) -> V_291 |= V_291 ;
F_120 ( V_252 , V_290 ) ;
F_121 ( V_252 , sizeof( * V_261 ) ) ;
F_122 ( V_252 , F_112 ( V_252 ) ) ;
V_288 = F_123 ( V_62 -> V_276 . V_292 , V_285 , V_252 ) ;
V_293:
F_27 () ;
V_31:
F_119 ( V_252 ) -> V_291 |= V_291 ;
...
static struct V_251 * * F_124 ( struct V_251 * * V_285 ,
struct V_251 * V_252 )
{
if ( F_119 ( V_252 ) -> V_303 ) {
F_119 ( V_252 ) -> V_291 = 1 ;
return NULL ;
}
F_119 ( V_252 ) -> V_303 = 1 ;
return F_111 ( V_285 , V_252 ) ;
}
T_2 F_125 ( void )
{
T_1 V_304 ;
...
struct V_306 V_307 ;
F_126 ( & V_307 ) ;
( void ) F_127 ( V_307 . V_308 , V_309 , & V_304 ) ;
V_305 = V_304 * V_310 ;
V_305 += ( T_1 ) V_307 . V_311 / V_312 ;
return F_38 ( V_305 ) ;
}
int F_128 ( struct V_1 * V_2 , struct V_174 * V_175 , int V_281 , int * V_103 )
{
if ( V_2 -> V_313 == V_112 )
return F_129 ( V_2 , V_175 , V_281 , V_103 ) ;
#if F_130 ( V_314 )
if ( V_2 -> V_313 == V_315 )
...
int F_131 ( struct V_251 * V_252 , int V_263 )
{
...
if ( V_252 -> V_269 )
F_132 ( V_252 , V_263 ) ;
F_133 ( & V_261 -> V_320 , V_261 -> V_262 , V_318 ) ;
V_261 -> V_262 = V_318 ;
F_24 () ;
V_62 = F_93 ( V_275 [ V_47 ] ) ;
...
static int F_134 ( struct V_251 * V_252 , int V_263 )
{
V_252 -> V_269 = 1 ;
F_105 ( V_252 ) -> V_270 |= V_322 ;
return F_131 ( V_252 , V_263 ) ;
}
int F_135 ( struct V_1 * * V_2 , unsigned short V_323 ,
unsigned short type , unsigned char V_43 ,
struct V_42 * V_42 )
{
struct V_24 * V_1 ;
int V_324 = F_136 ( V_42 , V_323 , type , V_43 , & V_1 ) ;
if ( V_324 == 0 ) {
* V_2 = V_1 -> V_2 ;
( * V_2 ) -> V_325 = V_326 ;
( * V_2 ) -> V_20 -> V_327 ( * V_2 ) ;
...
T_7 F_137 ( void T_8 * V_328 , int V_329 , int V_330 )
{
return * ( ( ( unsigned long * ) F_138 ( V_328 , V_329 ) ) + V_330 ) ;
}
unsigned long F_139 ( void T_8 * V_328 , int V_330 )
{
unsigned long V_331 = 0 ;
int V_332 ;
F_140 (i)
V_331 += F_137 ( V_328 , V_332 , V_330 ) ;
return V_331 ;
}
T_7 F_141 ( void T_8 * V_328 , int V_329 , int V_330 ,
T_3 V_333 )
{
void * V_334 ;
struct V_335 * V_336 ;
T_7 V_337 ;
unsigned int V_338 ;
V_334 = F_138 ( V_328 , V_329 ) ;
V_336 = (struct V_335 * ) ( V_334 + V_333 ) ;
do {
V_338 = F_142 ( V_336 ) ;
V_337 = * ( ( ( T_7 * ) V_334 ) + V_330 ) ;
} while ( F_143 ( V_336 , V_338 ) );
return V_337 ;
}
T_7 F_144 ( void T_8 * V_328 , int V_330 , T_3 V_333 )
{
T_7 V_331 = 0 ;
int V_329 ;
F_140 (cpu) {
V_331 += F_141 ( V_328 , V_329 , V_330 , V_333 ) ;
}
return V_331 ;
}
static T_9 int F_145 ( struct V_42 * V_42 )
{
int V_332 ;
V_42 -> V_328 . V_339 = F_146 ( struct V_340 ) ;
if ( ! V_42 -> V_328 . V_339 )
goto V_341;
V_42 -> V_328 . V_342 = F_146 ( struct V_343 ) ;
if ( ! V_42 -> V_328 . V_342 )
goto V_344;
F_140 (i) {
struct V_343 * V_345 ;
V_345 = F_138 ( V_42 -> V_328 . V_342 , V_332 ) ;
F_147 ( & V_345 -> V_336 ) ;
}
V_42 -> V_328 . V_346 = F_146 ( struct V_347 ) ;
if ( ! V_42 -> V_328 . V_346 )
goto V_348;
V_42 -> V_328 . V_349 = F_146 ( struct V_350 ) ;
if ( ! V_42 -> V_328 . V_349 )
goto V_351;
V_42 -> V_328 . V_352 = F_146 ( struct V_350 ) ;
if ( ! V_42 -> V_328 . V_352 )
goto V_353;
V_42 -> V_328 . V_354 = F_146 ( struct V_355 ) ;
if ( ! V_42 -> V_328 . V_354 )
goto V_356;
V_42 -> V_328 . V_357 = F_148 ( sizeof( struct V_358 ) ,
V_67 ) ;
if ( ! V_42 -> V_328 . V_357 )
goto V_359;
F_149 ( V_42 ) ;
return 0 ;
V_359:
F_150 ( V_42 -> V_328 . V_354 ) ;
V_356:
F_150 ( V_42 -> V_328 . V_352 ) ;
V_353:
F_150 ( V_42 -> V_328 . V_349 ) ;
V_351:
F_150 ( V_42 -> V_328 . V_346 ) ;
V_348:
F_150 ( V_42 -> V_328 . V_342 ) ;
V_344:
F_150 ( V_42 -> V_328 . V_339 ) ;
V_341:
return - V_360 ;
}
static T_10 void F_151 ( struct V_42 * V_42 )
{
...
static T_9 int F_154 ( struct V_42 * V_42 )
{
F_155 ( & V_42 -> V_76 . V_362 . V_363 ) ;
V_42 -> V_76 . V_362 . V_364 [ 0 ] = 32768 ;
V_42 -> V_76 . V_362 . V_364 [ 1 ] = 60999 ;
F_155 ( & V_42 -> V_76 . V_365 . V_363 ) ;
V_42 -> V_76 . V_365 . V_364 [ 0 ] = F_156 ( & V_366 , 1 ) ;
V_42 -> V_76 . V_365 . V_364 [ 1 ] = F_156 ( & V_366 , 0 ) ;
...
F_170 () ;
#endif
if ( F_171 ( & V_385 , V_386 ) < 0 )
F_161 ( L_11 , V_248 ) ;
if ( F_171 ( & V_387 , V_388 ) < 0 )
F_161 ( L_12 , V_248 ) ;
if ( F_171 ( & V_389 , V_158 ) < 0 )
F_161 ( L_13 , V_248 ) ;
#ifdef F_172
if ( F_171 ( & V_390 , V_391 ) < 0 )
F_161 ( L_14 , V_248 ) ;
#endif
