...
static bool F_191 ( struct V_10 * V_11 , T_7 V_271 )
{
struct V_14 * V_272 ;
struct V_24 * V_25 ;
bool V_169 = false ;
if ( V_271 == F_192 ( V_11 -> V_16 , 0 , V_271 ) )
return true ;
F_65 () ;
F_193 (bond->dev, upper, iter) {
if ( V_271 == F_192 ( V_272 , 0 , V_271 ) ) {
V_169 = true ;
break;
}
}
...
static void F_194 ( struct V_14 * V_15 , int V_273 ,
T_7 V_274 , T_7 V_275 ,
struct V_276 * V_277 )
{
struct V_12 * V_13 ;
...
V_13 = F_195 ( V_273 , V_279 , V_274 , V_15 , V_275 ,
NULL , V_15 -> V_86 , NULL ) ;
if ( ! V_13 ) {
F_196 ( L_79 ) ;
return;
...
F_54 ( V_15 , L_80 ,
F_197 ( V_278 -> V_280 ) , V_277 -> V_283 ) ;
V_13 = F_198 ( V_13 , V_277 -> V_280 ,
V_277 -> V_283 ) ;
if ( ! V_13 ) {
F_196 ( L_81 ) ;
return;
...
if ( V_278 -> V_283 ) {
F_54 ( V_15 , L_82 ,
F_197 ( V_278 -> V_280 ) , V_278 -> V_283 ) ;
F_199 ( V_13 , V_278 -> V_280 ,
V_278 -> V_283 ) ;
}
V_282:
F_200 ( V_13 ) ;
}
struct V_276 * F_201 ( struct V_14 * V_284 ,
struct V_14 * V_285 ,
int V_286 )
{
struct V_276 * V_277 ;
...
V_277 = F_201 ( V_272 , V_285 , V_286 + 1 ) ;
if ( F_204 ( V_277 ) ) {
if ( F_205 ( V_277 ) )
return V_277 ;
continue;
...
if ( F_206 ( V_272 ) ) {
V_277 [ V_286 ] . V_280 = F_207 ( V_272 ) ;
V_277 [ V_286 ] . V_283 = F_208 ( V_272 ) ;
}
return V_277 ;
}
return NULL ;
...
V_277 = NULL ;
V_288 = F_210 ( F_211 ( V_11 -> V_16 ) , V_289 [ V_212 ] , 0 ,
V_291 , 0 ) ;
if ( F_205 ( V_288 ) ) {
if ( V_11 -> V_52 . V_292 )
F_212 ( L_84 ,
V_11 -> V_16 -> V_59 ,
& V_289 [ V_212 ] ) ;
F_194 ( V_22 -> V_16 , V_293 , V_289 [ V_212 ] ,
0 , V_277 ) ;
continue;
}
...
goto V_295;
F_65 () ;
V_277 = F_201 ( V_11 -> V_16 , V_288 -> V_294 . V_16 , 0 ) ;
F_67 () ;
if ( ! F_204 ( V_277 ) )
goto V_295;
F_54 ( V_11 -> V_16 , L_85 ,
...
static void F_214 ( struct V_10 * V_11 , struct V_22 * V_22 , T_7 V_296 , T_7 V_297 )
{
int V_212 ;
if ( ! V_296 || ! F_191 ( V_11 , V_297 ) ) {
F_54 ( V_11 -> V_16 , L_86 ,
& V_296 , & V_297 ) ;
return;
}
V_212 = F_215 ( V_11 -> V_52 . V_290 , V_296 ) ;
if ( V_212 == - 1 ) {
F_54 ( V_11 -> V_16 , L_87 ,
& V_296 ) ;
return;
...
unsigned char * V_301 ;
T_7 V_296 , V_297 ;
int V_302 , V_303 = V_13 -> V_304 == F_217 ( V_279 ) ;
if ( ! F_218 ( V_11 , V_22 ) ) {
if ( ( F_219 ( V_11 ) && V_303 ) ||
! F_219 ( V_11 ) )
V_22 -> V_238 = V_116 ;
...
V_302 = F_220 ( V_11 -> V_16 ) ;
F_54 ( V_11 -> V_16 , L_88 ,
V_13 -> V_16 -> V_59 ) ;
if ( V_302 > F_221 ( V_13 ) ) {
V_299 = F_222 ( V_302 , V_171 ) ;
if ( ! V_299 )
goto V_305;
if ( F_223 ( V_13 , 0 , V_299 , V_302 ) < 0 )
goto V_305;
}
if ( V_299 -> V_306 != V_11 -> V_16 -> V_85 ||
V_13 -> V_165 == V_307 ||
V_13 -> V_165 == V_308 ||
V_299 -> V_309 != F_224 ( V_218 ) ||
V_299 -> V_310 != F_224 ( V_311 ) ||
V_299 -> V_312 != 4 )
goto V_305;
...
V_11 -> V_52 . V_292 , F_218 ( V_11 , V_22 ) ,
& V_296 , & V_297 ) ;
V_69 = F_66 ( V_11 -> V_69 ) ;
V_300 = F_66 ( V_11 -> V_256 ) ;
if ( F_136 ( V_22 ) )
F_214 ( V_11 , V_22 , V_296 , V_297 ) ;
else if ( V_69 &&
F_225 ( F_226 ( V_11 , V_69 ) ,
V_69 -> V_115 ) )
F_214 ( V_11 , V_22 , V_297 , V_296 ) ;
else if ( V_300 && ( V_299 -> V_313 == F_224 ( V_314 ) ) &&
F_227 ( V_11 ,
F_228 ( V_300 -> V_16 ) , 1 ) )
F_214 ( V_11 , V_22 , V_296 , V_297 ) ;
V_305:
...
static bool F_227 ( struct V_10 * V_11 , unsigned long V_315 ,
int V_316 )
{
...
F_88 (bond, slave, iter) {
unsigned long V_320 = F_228 ( V_22 -> V_16 ) ;
if ( V_22 -> V_29 != V_30 ) {
if ( F_227 ( V_11 , V_320 , 1 ) &&
F_227 ( V_11 , V_22 -> V_238 , 1 ) ) {
V_22 -> V_29 = V_30 ;
V_319 = 1 ;
if ( ! V_252 ) {
F_71 ( V_11 -> V_16 , L_90 ,
...
if ( ! F_227 ( V_11 , V_320 , 2 ) ||
! F_227 ( V_11 , V_22 -> V_238 , 2 ) ) {
V_22 -> V_29 = V_42 ;
V_319 = 1 ;
if ( V_22 -> V_197 < V_268 )
V_22 -> V_197 ++ ;
...
F_88 (bond, slave, iter) {
V_22 -> V_264 = V_242 ;
V_238 = F_226 ( V_11 , V_22 ) ;
if ( V_22 -> V_29 != V_30 ) {
if ( F_227 ( V_11 , V_238 , 1 ) ) {
V_22 -> V_264 = V_30 ;
V_262 ++ ;
}
continue;
...
static int F_242 ( unsigned long V_327 ,
struct V_14 * V_19 )
{
...
struct V_14 * V_15 )
{
struct V_22 * V_22 = F_244 ( V_15 ) , * V_243 ;
struct V_10 * V_11 ;
struct V_14 * V_19 ;
if ( ! V_22 )
return V_326 ;
...
static int F_246 ( struct V_337 * V_338 ,
unsigned long V_327 , void * V_339 )
{
struct V_14 * V_340 = F_247 ( V_339 ) ;
F_54 ( V_340 , L_98 , V_327 ) ;
if ( ! ( V_340 -> V_160 & V_235 ) )
return V_326 ;
if ( V_340 -> V_82 & V_250 ) {
F_54 ( V_340 , L_99 ) ;
return F_242 ( V_327 , V_340 ) ;
}
if ( V_340 -> V_82 & V_188 ) {
F_54 ( V_340 , L_100 ) ;
...
V_342 = F_249 ( V_13 , 0 , sizeof( V_343 ) , & V_343 ) ;
if ( V_342 )
...
return F_251 ( V_13 , V_347 , 0 ) ;
V_347 -> V_355 . V_355 = 0 ;
V_352 = F_252 ( V_13 ) ;
if ( V_13 -> V_304 == F_224 ( V_311 ) ) {
if ( F_5 ( ! F_253 ( V_13 , V_352 + sizeof( * V_351 ) ) ) )
return false ;
V_351 = F_254 ( V_13 ) ;
F_255 ( V_347 , V_351 ) ;
V_352 += V_351 -> V_356 << 2 ;
if ( ! F_256 ( V_351 ) )
V_20 = V_351 -> V_304 ;
} else if ( V_13 -> V_304 == F_224 ( V_357 ) ) {
if ( F_5 ( ! F_253 ( V_13 , V_352 + sizeof( * V_349 ) ) ) )
return false ;
V_349 = F_257 ( V_13 ) ;
F_258 ( V_347 , V_349 ) ;
V_352 += sizeof( * V_349 ) ;
...
V_347 -> V_355 . V_355 = F_259 ( V_13 , V_352 , V_20 ) ;
return true ;
}
...
V_361 ^= ( V_366 T_8 ) F_261 ( & V_360 ) ^
( V_366 T_8 ) F_262 ( & V_360 ) ;
V_361 ^= ( V_361 >> 16 ) ;
V_361 ^= ( V_361 >> 8 ) ;
return V_361 ;
}
...
if ( F_20 ( V_11 ) == V_4 )
F_134 ( & V_11 -> V_318 , F_236 ) ;
else
F_134 ( & V_11 -> V_318 , F_230 ) ;
...
static void F_271 ( struct V_375 * V_376 ,
...
static struct V_375 * F_178 ( struct V_14 * V_19 ,
struct V_375 * V_383 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_375 V_384 ;
...
static int F_274 ( struct V_14 * V_19 , struct V_48 * V_49 , int V_386 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
...
if ( F_275 ( & V_387 , V_388 , sizeof( V_190 ) ) )
return - V_398 ;
V_26 = F_185 ( V_19 , & V_387 ) ;
if ( V_26 == 0 &&
F_276 ( V_388 , & V_387 , sizeof( V_190 ) ) )
return - V_398 ;
return V_26 ;
case V_399 :
case V_400 :
V_390 = (struct V_195 T_10 * ) V_49 -> V_397 ;
if ( F_275 ( & V_389 , V_390 , sizeof( V_195 ) ) )
return - V_398 ;
V_26 = F_186 ( V_19 , & V_389 ) ;
if ( V_26 == 0 &&
F_276 ( V_390 , & V_389 , sizeof( V_195 ) ) )
return - V_398 ;
return V_26 ;
default:
break;
...
V_393 = F_211 ( V_19 ) ;
if ( ! F_277 ( V_393 -> V_401 , V_402 ) )
return - V_214 ;
V_15 = F_278 ( V_393 , V_49 -> V_403 ) ;
...
case V_410 :
case V_411 :
F_279 ( & V_392 , V_15 -> V_59 ) ;
V_26 = F_280 ( V_11 , V_412 , & V_392 ) ;
break;
default:
V_26 = - V_223 ;
}
...
static void F_281 ( struct V_14 * V_19 , int V_413 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
if ( V_413 & V_83 )
F_32 ( V_11 ,
...
static int F_283 ( struct V_414 * V_415 )
{
...
static int F_286 ( struct V_14 * V_19 , int V_421 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_22 * V_22 , * V_23 ;
struct V_24 * V_25 ;
...
static void F_290 ( struct V_10 * V_11 , struct V_12 * V_13 , int V_260 )
{
struct V_24 * V_25 ;
struct V_22 * V_22 ;
int V_212 = V_260 ;
...
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_350 * V_351 = F_254 ( V_13 ) ;
struct V_22 * V_22 ;
T_8 V_260 ;
if ( V_351 -> V_304 == V_431 && V_13 -> V_304 == F_224 ( V_311 ) ) {
V_22 = F_66 ( V_11 -> V_69 ) ;
if ( V_22 )
F_2 ( V_11 , V_13 , V_22 -> V_16 ) ;
else
...
int V_169 = 0 ;
#ifdef F_301
F_302 ( F_303 ( & V_11 -> V_438 ) ) ;
#endif
V_435 = F_81 ( F_304 ( struct V_434 , V_439 [ V_11 -> V_194 ] ) ,
V_127 ) ;
if ( ! V_435 ) {
V_169 = - V_128 ;
F_305 ( L_111 ) ;
...
break;
if ( F_63 ( V_22 ) && V_22 -> V_29 == V_30 ) {
struct V_12 * V_445 = F_311 ( V_13 , V_171 ) ;
if ( ! V_445 ) {
F_196 ( L_113 ,
V_19 -> V_59 , V_446 ) ;
continue;
...
{
T_2 V_449 = F_314 ( V_13 ) ? F_315 ( V_13 ) : 0 ;
...
struct V_454 * V_455 )
{
F_326 ( V_455 -> V_456 , V_457 , sizeof( V_455 -> V_456 ) ) ;
F_326 ( V_455 -> V_458 , V_459 , sizeof( V_455 -> V_458 ) ) ;
snprintf ( V_455 -> V_460 , sizeof( V_455 -> V_460 ) , L_115 ,
V_461 ) ;
}
...
static int F_336 ( struct V_476 * V_52 )
{
int V_477 , V_478 , V_479 , V_212 ;
struct V_391 V_392 ;
const struct V_391 * V_480 ;
int V_481 ;
T_2 V_482 = 0 ;
T_2 V_483 = 0 ;
if ( V_1 ) {
F_279 ( & V_392 , V_1 ) ;
V_480 = F_337 ( F_338 ( V_484 ) , & V_392 ) ;
if ( ! V_480 ) {
F_305 ( L_117 , V_1 ) ;
return - V_221 ;
}
...
if ( V_492 ) {
F_279 ( & V_392 , V_492 ) ;
V_480 = F_337 ( F_338 ( V_493 ) ,
& V_392 ) ;
if ( ! V_480 ) {
F_305 ( L_122 , V_492 ) ;
return - V_221 ;
}
V_52 -> V_492 = V_480 -> V_485 ;
if ( V_192 != V_7 )
F_340 ( L_123 ) ;
} else {
V_52 -> V_492 = V_494 ;
...
for ( V_505 = 0 , V_212 = 0 ;
( V_505 < V_240 ) && V_506 [ V_212 ] ; V_212 ++ ) {
T_7 V_271 ;
if ( ! F_344 ( V_506 [ V_212 ] , - 1 , ( T_4 * ) & V_271 , - 1 , NULL ) ||
! F_345 ( V_271 ) ) {
F_340 ( L_142 ,
V_506 [ V_212 ] ) ;
V_239 = 0 ;
} else {
if ( F_215 ( V_507 , V_271 ) == - 1 )
V_507 [ V_505 ++ ] = V_271 ;
else
F_340 ( L_143 ,
& V_271 ) ;
...
V_477 ) ;
F_339 ( L_149 ,
V_239 , V_480 -> string , V_505 ) ;
for ( V_212 = 0 ; V_212 < V_505 ; V_212 ++ )
F_347 ( L_150 , V_506 [ V_212 ] ) ;
F_347 ( L_151 ) ;
} else if ( V_495 ) {
F_306 ( L_152 ) ;
}
...
memcpy ( V_52 -> V_290 , V_507 , sizeof( V_507 ) ) ;
return 0 ;
}
static int F_350 ( struct V_14 * V_19 )
{
struct V_10 * V_11 = F_11 ( V_19 ) ;
struct V_520 * V_521 = F_351 ( F_211 ( V_19 ) , V_522 ) ;
F_54 ( V_19 , L_161 ) ;
V_11 -> V_73 = F_352 ( V_19 -> V_59 , V_523 ) ;
if ( ! V_11 -> V_73 )
return - V_128 ;
F_353 ( V_19 ) ;
F_354 ( & V_11 -> V_475 , & V_521 -> V_524 ) ;
F_355 ( V_11 ) ;
F_356 ( V_11 ) ;
if ( F_357 ( V_19 -> V_86 ) &&
V_19 -> V_87 == V_525 )
...
{
struct V_520 * V_521 = F_351 ( V_393 , V_522 ) ;
V_521 -> V_393 = V_393 ;
F_365 ( & V_521 -> V_524 ) ;
F_366 ( V_521 ) ;
F_367 ( V_521 ) ;
...
goto V_537;
F_378 () ;
for ( V_212 = 0 ; V_212 < V_495 ; V_212 ++ ) {
V_26 = F_359 ( & V_538 , NULL ) ;
if ( V_26 )
goto V_67;
}
F_379 ( & V_539 ) ;
