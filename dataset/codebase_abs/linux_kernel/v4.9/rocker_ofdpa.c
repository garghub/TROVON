...
static void F_147 ( struct V_86 * V_86 )
{
struct V_6 * V_6 = V_86 -> V_201 ;
F_107 ( V_6 , NULL , V_139 ) ;
}
static int F_148 ( struct V_86 * V_86 )
{
struct V_6 * V_6 = V_86 -> V_201 ;
return F_128 ( V_6 , 0 ) ;
}
static void F_149 ( struct V_86 * V_86 )
{
struct V_6 * V_6 = V_86 -> V_201 ;
F_129 ( V_6 , V_14 ) ;
}
static int F_150 ( struct V_86 * V_86 ,
T_6 V_248 ,
struct V_15 * V_16 )
{
struct V_6 * V_6 = V_86 -> V_201 ;
...
static int F_155 ( struct V_86 * V_86 ,
...
static int F_157 ( const struct V_86 * V_86 ,
struct V_291 * V_39 ,
T_8 * V_294 )
{
const struct V_6 * V_6 = V_86 -> V_201 ;
...
static int F_158 ( struct V_86 * V_86 ,
...
static int F_160 ( const struct V_86 * V_86 ,
struct V_297 * V_234 ,
T_8 * V_294 )
{
const struct V_6 * V_6 = V_86 -> V_201 ;
...
static int F_164 ( struct V_86 * V_86 ,
struct V_190 * V_302 )
{
struct V_6 * V_6 = V_86 -> V_201 ;
int V_90 = 0 ;
if ( F_165 ( V_302 ) )
V_90 = F_161 ( V_6 , V_302 ) ;
else if ( F_166 ( V_302 ) )
V_90 = F_163 ( V_6 , V_302 ) ;
return V_90 ;
}
static int F_167 ( struct V_86 * V_86 ,
struct V_190 * V_302 )
{
struct V_6 * V_6 = V_86 -> V_201 ;
int V_90 = 0 ;
...
static struct V_6 * F_171 ( struct V_190 * V_186 ,
struct V_199 * V_199 )
{
struct V_86 * V_86 ;
V_86 = F_172 ( V_186 , V_199 ) ;
return V_86 ? V_86 -> V_201 : NULL ;
}
static int F_173 ( struct V_199 * V_199 ,
...
if ( V_127 -> V_306 )
return 0 ;
V_6 = F_171 ( V_305 -> V_161 -> V_276 , V_199 ) ;
if ( ! V_6 )
return 0 ;
V_90 = F_135 ( V_6 , NULL , F_174 ( V_305 -> V_158 ) ,
V_305 -> V_269 , V_305 -> V_161 ,
V_305 -> V_270 , 0 ) ;
if ( V_90 )
return V_90 ;
F_175 ( V_305 -> V_161 ) ;
...
static int F_176 ( struct V_199 * V_199 ,
const struct V_304 * V_305 )
{
struct V_127 * V_127 = V_199 -> V_201 ;
struct V_6 * V_6 ;
...
return 0 ;
F_177 ( V_305 -> V_161 ) ;
return F_135 ( V_6 , NULL , F_174 ( V_305 -> V_158 ) ,
V_305 -> V_269 , V_305 -> V_161 ,
V_305 -> V_270 , V_139 ) ;
}
static void F_178 ( struct V_199 * V_199 )
{
struct V_127 * V_127 = V_199 -> V_201 ;
struct V_6 * V_6 ;
struct V_28 * V_281 ;
