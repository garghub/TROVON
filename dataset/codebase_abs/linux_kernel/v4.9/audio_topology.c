...
int V_30 ;
T_1 * V_31 ;
V_29 = F_13 ( V_26 -> V_10 , sizeof( char * ) * V_28 -> V_19 ,
V_32 ) ;
V_31 = V_28 -> V_33 ;
for ( V_30 = 0 ; V_30 < V_28 -> V_19 ; V_30 ++ ) {
...
case V_49 :
case V_50 :
V_37 -> V_51 . integer . V_52 = V_41 -> V_51 . integer . V_52 ;
V_37 -> V_51 . integer . V_38 = V_41 -> V_51 . integer . V_38 ;
break;
case V_53 :
V_38 = V_41 -> V_51 . V_54 . V_19 ;
...
V_37 -> V_51 . V_54 . V_55 ) ;
F_18 ( V_37 -> V_51 . V_54 . V_4 , V_4 , V_8 ) ;
break;
default:
F_17 ( V_3 -> V_10 , L_8 ,
...
if ( V_6 )
return V_6 ;
V_6 = F_22 ( V_9 -> V_63 , V_31 -> V_56 ,
V_64 , & V_60 ) ;
F_23 ( V_62 ) ;
if ( V_6 ) {
F_24 ( V_3 -> V_10 , L_9 , V_6 ,
V_11 , V_35 -> V_18 . V_4 ) ;
return V_6 ;
}
switch ( V_41 -> type ) {
...
struct V_39 * V_31 ;
struct V_40 * V_41 ;
struct V_69 * V_70 = F_15 ( V_35 ) ;
struct V_71 * V_24 = V_70 -> V_72 [ 0 ] ;
struct V_42 * V_3 = V_24 -> V_3 ;
F_2 ( V_3 -> V_10 , L_6 , V_11 , V_35 -> V_18 . V_4 ) ;
V_31 = (struct V_39 * ) V_35 -> V_44 ;
V_41 = (struct V_40 * ) V_31 -> V_41 ;
V_67 = V_41 -> V_51 . integer . V_38 ;
V_68 = V_41 -> V_51 . integer . V_52 ;
if ( V_67 == 1 &&
! F_28 ( V_35 -> V_18 . V_4 , L_10 , V_8 ) )
V_37 -> type = V_73 ;
else
V_37 -> type = V_74 ;
V_37 -> V_46 = V_31 -> V_47 ;
V_37 -> V_51 . integer . V_52 = 0 ;
if ( V_41 -> V_51 . integer . V_52 < 0 &&
( V_37 -> type == V_74 ) )
V_37 -> V_51 . integer . V_38 = V_67 - V_68 ;
else
...
V_58 -> V_51 . integer . V_51 [ 0 ] = V_60 . V_51 . V_65 [ 0 ] ;
return V_6 ;
}
...
static int F_33 ( struct V_71 * V_82 ,
struct V_34 * V_83 , int V_84 )
{
return 0 ;
}
static int F_34 ( struct V_71 * V_82 ,
struct V_34 * V_83 , int V_84 )
{
return 0 ;
}
...
static int F_36 ( struct V_85 * V_82 )
{
int V_6 = 0 ;
switch ( V_82 -> type ) {
case V_86 :
...
return - V_21 ;
V_60 . V_51 . V_66 [ 0 ] = V_58 -> V_51 . V_54 . V_55 [ 0 ] ;
if ( V_95 -> V_96 != V_95 -> V_97 ) {
...
struct V_27 * V_103 ;
int V_30 ;
V_102 = F_13 ( V_26 -> V_10 , sizeof( * V_102 ) , V_32 ) ;
if ( ! V_102 )
return - V_104 ;
V_103 = & V_101 -> V_41 . V_51 . V_54 ;
V_102 -> V_38 = V_103 -> V_19 ;
V_102 -> V_20 = F_12 ( V_26 , V_103 ) ;
F_2 ( V_26 -> V_10 , L_12 , V_103 -> V_19 ,
V_103 -> V_105 ) ;
for ( V_30 = 0 ; V_30 < V_103 -> V_19 ; V_30 ++ )
F_2 ( V_26 -> V_10 , L_13 , V_30 , V_102 -> V_20 [ V_30 ] ) ;
* V_99 = (struct V_98 )
F_40 ( V_101 -> V_4 , * V_102 , F_37 ,
F_38 ) ;
return 0 ;
}
...
case V_53 :
V_6 = F_39 ( V_26 , V_99 , V_101 ) ;
break;
default:
V_106 = F_13 ( V_26 -> V_10 ,
sizeof( struct V_39 ) ,
V_32 ) ;
if ( ! V_106 )
return - V_104 ;
V_106 -> V_56 = V_101 -> V_18 ;
V_106 -> V_109 = V_101 -> V_109 ;
V_106 -> V_45 = V_101 -> V_45 ;
V_106 -> V_47 = V_101 -> V_110 ;
V_106 -> V_41 = & V_101 -> V_41 ;
* V_99 = (struct V_98 )
F_42 ( V_101 -> V_4 , V_101 -> V_46 , V_106 ) ;
V_106 = NULL ;
break;
}
break;
...
V_24 -> V_51 = V_79 ;
V_24 -> V_75 -> V_81 = NULL ;
F_45 ( V_24 , V_35 , V_111 , V_95 ) ;
}
}
return V_112 ;
}
static int F_46 ( struct V_1 * V_26 ,
struct V_98 * V_99 ,
struct V_100 * V_101 )
{
struct V_94 * V_102 ;
...
F_2 ( V_26 -> V_10 , L_13 , V_30 , V_102 -> V_20 [ V_30 ] ) ;
* V_99 = (struct V_98 )
F_47 ( V_101 -> V_4 , * V_102 , F_43 ,
F_44 ) ;
return 0 ;
}
static int F_48 ( struct V_1 * V_26 ,
struct V_98 * V_99 ,
struct V_100 * V_101 )
{
struct V_39 * V_106 ;
V_106 = F_13 ( V_26 -> V_10 , sizeof( struct V_39 ) ,
V_32 ) ;
if ( ! V_106 )
return - V_104 ;
V_106 -> V_56 = V_101 -> V_18 ;
...
V_106 -> V_41 = & V_101 -> V_41 ;
* V_99 = (struct V_98 )
F_49 ( V_101 -> V_4 , V_101 -> V_46 , V_106 ) ;
return 0 ;
}
static int F_50 ( struct V_1 * V_26 ,
struct V_98 * V_99 ,
struct V_100 * V_101 )
{
int V_6 ;
...
switch ( V_101 -> V_41 . type ) {
case V_53 :
V_6 = F_46 ( V_26 , V_99 , V_101 ) ;
break;
default:
V_6 = F_48 ( V_26 , V_99 , V_101 ) ;
break;
}
break;
default:
...
static int F_51 ( struct V_71 * V_82 ,
...
switch ( V_84 ) {
case V_114 :
V_6 = F_52 ( V_9 -> V_63 , V_113 ) ;
if ( ! V_6 )
V_6 = F_53 ( V_43 , V_82 , V_9 , 1 ) ;
break;
case V_115 :
V_6 = F_54 ( V_9 -> V_63 , V_113 ) ;
if ( ! V_6 )
V_6 = F_53 ( V_43 , V_82 , V_9 , 0 ) ;
break;
}
if ( V_6 )
F_24 ( V_3 -> V_10 ,
...
static int F_55 ( struct V_1 * V_9 ,
struct V_71 * V_116 ,
...
V_119 = F_13 ( V_9 -> V_10 , V_122 , V_32 ) ;
if ( ! V_119 )
return - V_104 ;
}
...
V_118 = F_56 ( struct V_100 , V_41 ) ;
V_118 += F_56 ( struct V_40 , V_51 ) ;
V_118 += F_56 ( struct V_27 , V_33 ) ;
V_118 += V_28 -> V_105 ;
...
F_57 ( & V_16 -> V_124 , & V_9 -> V_125 ) ;
F_2 ( V_9 -> V_10 , L_21 ,
V_119 [ V_30 ] . V_4 , V_119 [ V_30 ] . V_107 ) ;
}
F_18 ( V_123 , V_82 -> V_4 , V_8 ) ;
...
break;
case V_89 :
* V_116 = (struct V_71 ) F_61 ( V_82 -> V_4 ) ;
break;
case V_90 :
* V_116 = (struct V_71 ) F_62 ( V_82 -> V_4 ) ;
break;
case V_92 :
* V_116 = (struct V_71 )
F_63 ( V_82 -> V_4 , V_133 , 0 , 0 ,
V_119 , F_51 ,
V_114 |
V_115 ) ;
break;
case V_134 :
* V_116 = (struct V_71 )
F_64 ( V_82 -> V_4 , V_133 , 0 , 0 , NULL , 0 ,
F_51 ,
V_114 |
V_115 ) ;
break;
...
return 0 ;
error:
F_69 (control, _control, &module->widget_ctl_list,
list) {
F_70 ( & V_16 -> V_124 ) ;
F_71 ( V_9 -> V_10 , V_16 ) ;
}
...
static int F_72 ( struct V_1 * V_9 ,
struct V_100 * V_139 )
{
int V_30 , V_118 , V_6 ;
struct V_98 * V_140 ;
...
V_140 = F_13 ( V_9 -> V_10 , V_122 , V_32 ) ;
if ( ! V_140 )
return - V_104 ;
V_120 = V_139 ;
for ( V_30 = 0 ; V_30 < V_9 -> V_141 ; V_30 ++ ) {
V_6 = F_41 ( V_9 , & V_140 [ V_30 ] ,
V_120 ) ;
if ( V_6 ) {
F_17 ( V_9 -> V_10 , L_24 ,
V_120 -> V_4 , V_120 -> V_107 ) ;
...
V_16 = F_13 ( V_9 -> V_10 , sizeof( struct
V_15 ) ,
V_32 ) ;
if ( ! V_16 ) {
V_6 = - V_104 ;
...
return 0 ;
error:
F_69 (control, _control, &module->ctl_list,
list) {
F_70 ( & V_16 -> V_124 ) ;
F_71 ( V_9 -> V_10 , V_16 ) ;
}
...
static int F_73 ( struct V_1 * V_9 ,
struct V_85 * V_72 )
{
int V_30 , V_6 , V_117 ;
struct V_71 * V_143 ;
...
V_143 = F_13 ( V_9 -> V_10 , V_122 , V_32 ) ;
if ( ! V_143 )
return - V_104 ;
V_120 = V_72 ;
for ( V_30 = 0 ; V_30 < V_9 -> V_145 ; V_30 ++ ) {
V_6 = F_55 ( V_9 , & V_143 [ V_30 ] ,
V_120 , & V_117 ) ;
if ( V_6 ) {
F_17 ( V_9 -> V_10 , L_24 ,
...
V_24 = F_13 ( V_9 -> V_10 , sizeof( struct
V_23 ) ,
V_32 ) ;
if ( ! V_24 ) {
V_6 = - V_104 ;
...
V_24 -> V_4 = V_120 -> V_4 ;
F_57 ( & V_24 -> V_124 , & V_9 -> V_146 ) ;
V_120 = ( void * ) V_120 + V_117 ;
}
V_9 -> V_143 = V_143 ;
return 0 ;
error:
F_69 (widget, _widget, &module->widget_list,
list) {
F_70 ( & V_24 -> V_124 ) ;
F_71 ( V_9 -> V_10 , V_24 ) ;
}
...
static int F_74 ( struct V_1 * V_9 ,
struct V_147 * V_148 )
{
int V_30 , V_6 ;
struct V_149 * V_150 ;
...
V_150 = F_13 ( V_9 -> V_10 , V_122 , V_32 ) ;
if ( ! V_150 )
return - V_104 ;
V_9 -> V_150 = V_150 ;
V_120 = V_148 ;
...
V_9 -> V_160 = V_9 -> V_159 + V_157 -> V_161 ;
V_9 -> V_162 = V_9 -> V_160 +
V_157 -> V_163 ;
V_9 -> V_164 = V_9 -> V_162 +
V_157 -> V_165 ;
...
F_2 ( V_9 -> V_10 , L_41 ) ;
if ( V_157 -> V_166 ) {
V_9 -> V_167 = V_157 -> V_166 & V_168 ;
V_9 -> V_169 = V_157 -> V_166 &
V_170 ;
}
return V_6 ;
}
void F_77 ( struct V_1 * V_9 )
{
struct V_15 * V_16 , * V_121 ;
struct V_23 * V_24 , * V_144 ;
if ( ! V_9 -> V_171 )
