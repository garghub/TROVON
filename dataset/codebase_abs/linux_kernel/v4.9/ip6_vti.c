...
static bool F_127 ( const struct V_30 * V_18 )
{
return V_18 -> V_168 == & V_169 ;
}
static int F_128 ( struct V_196 * V_197 ,
unsigned long V_198 , void * V_199 )
{
struct V_30 * V_18 = F_129 ( V_199 ) ;
struct V_6 * V_10 = F_19 ( V_18 ) ;
if ( ! F_127 ( V_18 ) )
return V_200 ;
switch ( V_198 ) {
case V_201 :
if ( ! F_48 ( V_10 -> V_7 , F_20 ( V_18 ) ) )
F_130 ( V_10 -> V_7 ) ;
break;
}
return V_200 ;
...
goto V_205;
V_202 = L_5 ;
V_32 = F_134 ( & V_206 , V_134 ) ;
if ( V_32 < 0 )
goto V_207;
V_32 = F_134 ( & V_208 , V_135 ) ;
if ( V_32 < 0 )
goto V_209;
V_32 = F_134 ( & V_210 , V_136 ) ;
if ( V_32 < 0 )
goto V_211;
V_202 = L_6 ;
V_32 = F_135 ( & V_36 ) ;
