...
T_1 V_45 , T_3 V_67 )
{
struct V_113 * V_114 = V_4 -> V_4 . V_18 -> V_10 -> V_115 ;
struct V_51 * V_52 = V_2 -> V_3 . V_52 ;
struct V_7 * V_102 = & V_2 -> V_3 . V_4 ;
int V_38 ;
if ( V_114 != V_52 -> V_115 && ! F_80 ( V_52 -> V_115 ) ) {
F_81 ( & V_4 -> V_4 , L_9 ) ;
return - V_85 ;
}
F_82 ( V_102 ) ;
...
if ( V_2 -> V_48 )
V_102 -> V_10 =
& V_116 [ V_117 ] . V_44 . V_10 ;
else
V_102 -> V_10 =
& V_116 [ V_118 ] . V_44 . V_10 ;
V_38 = V_102 -> V_10 -> V_119 ( V_102 ) ;
if ( V_38 >= 0 )
V_38 = F_83 ( V_102 ) ;
if ( V_38 )
goto error;
...
V_2 -> V_15 = NULL ;
F_15 ( V_2 ) ;
for ( V_43 = 0 ; V_43 < F_35 ( V_116 ) ; V_43 ++ ) {
if ( V_2 -> V_3 . V_4 . V_10 ==
& V_116 [ V_43 ] . V_44 . V_10 ) {
F_87 ( & V_2 -> V_3 . V_4 ) ;
break;
}
}
...
V_131 |= F_90 ( V_129 ) ;
if ( V_131 != V_130 ) {
V_38 = F_91 ( V_2 , V_136 , V_131 ) ;
if ( V_38 < 0 )
return V_38 ;
V_133 = 1 ;
}
V_132 = F_74 ( V_2 , V_141 ) ;
if ( V_132 < 0 )
return V_132 ;
if ( ! ( V_132 & V_142 ) )
return V_133 ;
V_131 = F_74 ( V_2 , V_143 ) ;
if ( V_131 < 0 )
return V_131 ;
V_130 = V_131 ;
V_131 &= ~ ( V_144 | V_145 ) ;
...
{
int V_148 = F_74 ( V_2 , V_104 ) ;
V_148 &= V_149 | V_150 | V_151 ;
V_2 -> V_65 = 0 ;
V_2 -> V_66 = 0 ;
if ( V_152 == V_2 -> V_63 )
V_148 |= V_153 ;
else if ( V_154 == V_2 -> V_63 )
V_148 |= V_155 ;
if ( V_156 == V_2 -> V_64 )
V_148 |= V_157 ;
return F_91 ( V_2 , V_104 , V_148 ) ;
}
...
{
int V_161 = F_74 ( V_2 , V_141 ) ;
return ( V_161 < 0 ) ? V_161 : ( V_161 & V_162 ) ;
}
...
V_165 = F_74 ( V_2 , V_171 ) ;
if ( V_165 < 0 )
return V_165 ;
V_2 -> V_169 |= F_101 ( V_165 ) ;
V_131 = F_74 ( V_2 , V_136 ) ;
if ( V_131 < 0 )
return V_131 ;
V_167 = V_165 & V_131 ;
...
V_2 -> V_64 = V_156 ;
if ( V_2 -> V_64 == V_156 ) {
V_2 -> V_65 = V_165 & V_179 ? 1 : 0 ;
V_2 -> V_66 = V_165 & V_180 ? 1 : 0 ;
}
} else {
int V_181 = F_74 ( V_2 , V_104 ) ;
if ( V_181 < 0 )
return V_181 ;
if ( V_181 & V_157 )
V_2 -> V_64 = V_156 ;
...
{
int V_182 , V_183 ;
T_1 V_184 = V_2 -> V_41 . V_49 ;
V_2 -> V_22 = 1 ;
V_2 -> V_63 = V_185 ;
V_2 -> V_64 = V_156 ;
for ( V_182 = 0 ; V_184 ; V_182 ++ , V_184 = V_184 >> 1 ) {
if ( ! ( V_184 & 1 ) )
continue;
F_103 ( V_2 , V_182 , V_186 ) ;
V_183 = F_103 ( V_2 , V_182 , V_186 ) ;
if ( V_183 < 0 || ! ( V_183 & V_187 ) )
V_2 -> V_22 = 0 ;
}
return 0 ;
}
...
int V_211 ;
F_25 ( & V_2 -> V_75 ) ;
V_211 = F_74 ( V_2 , V_104 ) ;
F_91 ( V_2 , V_104 , V_211 | V_151 ) ;
F_27 ( & V_2 -> V_75 ) ;
return 0 ;
}
...
static int F_111 ( struct V_1 * V_2 , T_1 V_212 )
{
V_2 -> V_135 &= V_213 ;
switch ( V_212 ) {
default:
...
int F_112 ( struct V_1 * V_2 , T_1 V_212 )
{
int V_38 ;
V_38 = F_111 ( V_2 , V_212 ) ;
if ( V_38 )
return V_38 ;
V_2 -> V_134 = V_2 -> V_135 ;
return 0 ;
...
{
struct V_218 * V_219 = V_2 -> V_3 . V_4 . V_220 ;
T_1 V_212 ;
if ( ! F_114 ( V_221 ) )
return;
if ( ! V_219 )
return;
if ( ! F_115 ( V_219 , L_11 , & V_212 ) )
F_111 ( V_2 , V_212 ) ;
}
...
V_2 -> V_225 = true ;
F_25 ( & V_2 -> V_75 ) ;
V_2 -> V_135 = V_12 -> V_189 ;
F_113 ( V_2 ) ;
V_2 -> V_134 = V_2 -> V_135 ;
V_2 -> V_23 = V_121 ;
if ( V_2 -> V_9 -> V_119 )
V_38 = V_2 -> V_9 -> V_119 ( V_2 ) ;
F_27 ( & V_2 -> V_75 ) ;
return V_38 ;
}
...
int F_119 ( struct V_11 * V_226 , struct V_113 * V_115 )
{
int V_161 ;
V_226 -> V_44 . V_45 |= V_46 ;
V_226 -> V_44 . V_10 . V_111 = V_226 -> V_111 ;
V_226 -> V_44 . V_10 . V_52 = & V_56 ;
V_226 -> V_44 . V_10 . V_119 = F_116 ;
V_226 -> V_44 . V_10 . remove = F_118 ;
V_226 -> V_44 . V_10 . V_115 = V_115 ;
V_161 = F_120 ( & V_226 -> V_44 . V_10 ) ;
if ( V_161 ) {
F_56 ( L_12 ,
V_226 -> V_111 , V_161 ) ;
return V_161 ;
}
F_121 ( L_13 , V_226 -> V_111 ) ;
return 0 ;
}
int F_122 ( struct V_11 * V_226 , int V_227 ,
struct V_113 * V_115 )
{
int V_43 , V_20 = 0 ;
for ( V_43 = 0 ; V_43 < V_227 ; V_43 ++ ) {
V_20 = F_119 ( V_226 + V_43 , V_115 ) ;
if ( V_20 ) {
while ( V_43 -- > 0 )
F_123 ( V_226 + V_43 ) ;
break;
...
void F_125 ( struct V_11 * V_9 , int V_227 )
{
int V_43 ;
for ( V_43 = 0 ; V_43 < V_227 ; V_43 ++ )
F_123 ( V_9 + V_43 ) ;
