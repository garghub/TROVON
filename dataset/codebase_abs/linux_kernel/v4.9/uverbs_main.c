...
return - V_108 ;
if ( F_85 ( & V_165 , V_90 , sizeof V_165 ) )
return - V_111 ;
V_85 = F_35 ( & V_17 -> V_6 -> V_13 ) ;
V_84 = F_36 ( V_17 -> V_6 -> V_84 ,
& V_17 -> V_6 -> V_13 ) ;
...
if ( F_85 ( & V_178 , V_90 + sizeof( V_165 ) , sizeof( V_178 ) ) ) {
V_5 = - V_111 ;
goto V_158;
}
...
F_88 ( & V_180 , V_90 , ( unsigned long ) V_178 . V_187 ,
...
static int F_89 ( struct V_17 * V_89 , struct V_192 * V_193 )
{
struct V_18 * V_17 = V_89 -> V_93 ;
struct V_83 * V_84 ;
int V_5 = 0 ;
...
static int F_90 ( struct V_120 * V_120 , struct V_17 * V_89 )
{
struct V_11 * V_12 ;
struct V_18 * V_17 ;
struct V_83 * V_84 ;
...
V_89 -> V_93 = V_17 ;
F_94 ( & V_12 -> V_10 ) ;
F_54 ( & V_17 -> V_26 , & V_12 -> V_204 ) ;
F_29 ( & V_12 -> V_123 ) ;
F_38 ( & V_12 -> V_13 , V_85 ) ;
return F_95 ( V_120 , V_89 ) ;
V_201:
F_37 ( V_84 -> V_87 ) ;
V_200:
F_29 ( & V_12 -> V_123 ) ;
...
static int F_96 ( struct V_120 * V_120 , struct V_17 * V_89 )
{
struct V_18 * V_17 = V_89 -> V_93 ;
...
static T_1 F_98 ( struct V_6 * V_6 , struct V_205 * V_206 ,
char * V_90 )
{
int V_5 = - V_194 ;
int V_85 ;
...
V_5 = F_104 ( V_211 , V_210 ) ;
if ( V_5 >= V_210 )
return - 1 ;
return V_5 ;
}
static void F_105 ( struct V_83 * V_6 )
{
int V_212 ;
T_9 V_213 ;
struct V_11 * V_214 ;
...
if ( ! V_6 -> V_215 )
return;
V_214 = F_65 ( sizeof *V_214 , V_149 ) ;
if ( ! V_214 )
return;
V_5 = F_106 ( & V_214 -> V_13 ) ;
if ( V_5 ) {
F_6 ( V_214 ) ;
return;
}
...
V_214 -> V_216 = V_217 ;
F_93 ( & V_214 -> V_73 ) ;
F_109 ( & V_214 -> V_10 , & V_218 ) ;
F_93 ( & V_214 -> V_123 ) ;
F_69 ( & V_214 -> V_204 ) ;
F_69 ( & V_214 -> V_154 ) ;
F_110 ( & V_219 ) ;
V_212 = F_104 ( V_220 , V_210 ) ;
if ( V_212 >= V_210 ) {
F_111 ( & V_219 ) ;
V_212 = F_101 () ;
if ( V_212 < 0 )
...
F_111 ( & V_219 ) ;
F_113 ( V_214 -> V_84 , V_6 ) ;
V_214 -> V_222 = V_6 -> V_222 ;
F_114 ( & V_214 -> V_198 , NULL ) ;
V_214 -> V_198 . V_87 = V_223 ;
V_214 -> V_198 . V_224 = V_6 -> V_195 ? & V_225 : & V_226 ;
V_214 -> V_198 . V_10 . V_227 = & V_214 -> V_10 ;
F_115 ( & V_214 -> V_198 . V_10 , L_6 , V_214 -> V_212 ) ;
if ( F_116 ( & V_214 -> V_198 , V_213 , 1 ) )
goto V_228;
V_214 -> V_12 = F_117 ( V_229 , V_6 -> V_230 ,
V_214 -> V_198 . V_12 , V_214 ,
L_6 , V_214 -> V_212 ) ;
if ( F_73 ( V_214 -> V_12 ) )
goto V_228;
if ( F_118 ( V_214 -> V_12 , & V_231 ) )
goto V_232;
if ( F_118 ( V_214 -> V_12 , & V_233 ) )
goto V_232;
F_119 ( V_6 , & V_234 , V_214 ) ;
return;
V_232:
F_120 ( V_229 , V_214 -> V_198 . V_12 ) ;
V_228:
F_121 ( & V_214 -> V_198 ) ;
...
static void F_124 ( struct V_11 * V_214 ,
struct V_83 * V_84 )
{
struct V_18 * V_17 ;
struct V_16 * V_235 ;
...
V_94 . V_6 = V_84 ;
F_27 ( & V_214 -> V_123 ) ;
while ( ! F_41 ( & V_214 -> V_204 ) ) {
struct V_36 * V_170 ;
V_17 = F_126 ( & V_214 -> V_204 ,
struct V_18 , V_26 ) ;
V_17 -> V_124 = 1 ;
F_11 ( & V_17 -> V_26 ) ;
F_71 ( & V_17 -> V_15 ) ;
...
F_55 ( & V_235 -> V_100 ) ;
F_56 ( & V_235 -> V_119 , V_133 , V_134 ) ;
}
F_29 ( & V_214 -> V_123 ) ;
}
static void F_127 ( struct V_83 * V_6 , void * V_237 )
{
struct V_11 * V_214 = V_237 ;
int V_238 = 1 ;
if ( ! V_214 )
return;
F_128 ( V_214 -> V_12 , NULL ) ;
F_120 ( V_229 , V_214 -> V_198 . V_12 ) ;
F_121 ( & V_214 -> V_198 ) ;
if ( V_214 -> V_212 < V_210 )
F_122 ( V_214 -> V_212 , V_220 ) ;
else
F_122 ( V_214 -> V_212 - V_210 , V_211 ) ;
if ( V_6 -> V_86 ) {
F_113 ( V_214 -> V_84 , NULL ) ;
F_124 ( V_214 , V_6 ) ;
V_238 = 0 ;
}
if ( F_39 ( & V_214 -> V_88 ) )
...
static char * F_129 ( struct V_6 * V_12 , T_10 * V_239 )
{
if ( V_239 )
* V_239 = 0666 ;
return F_130 ( V_149 , L_7 , F_131 ( V_12 ) ) ;
}
static int T_11 F_132 ( void )
{
int V_5 ;
V_5 = F_133 ( V_221 , V_210 ,
L_4 ) ;
if ( V_5 ) {
F_103 ( L_8 ) ;
goto V_158;
}
V_229 = F_134 ( V_223 , L_4 ) ;
if ( F_73 ( V_229 ) ) {
V_5 = F_135 ( V_229 ) ;
F_103 ( L_9 ) ;
goto V_240;
