...
{
V_2 -> V_22 . V_23 = F_95 ( V_24 , V_88 ) ;
if ( ! V_2 -> V_22 . V_23 )
goto exit;
V_2 -> V_122 = F_95 ( V_2 -> V_65 -> V_123 , V_88 ) ;
if ( ! V_2 -> V_122 )
goto exit;
V_2 -> V_121 = F_95 ( V_2 -> V_65 -> V_124 , V_88 ) ;
if ( ! V_2 -> V_121 )
goto exit;
return 0 ;
exit:
...
int F_97 ( struct V_109 * V_125 ,
const struct V_126 * V_65 )
{
struct V_10 * V_11 = F_98 ( V_125 ) ;
struct V_127 * V_128 ;
struct V_1 * V_2 ;
int V_129 ;
V_11 = F_99 ( V_11 ) ;
F_100 ( V_11 ) ;
V_128 = F_101 ( sizeof( struct V_1 ) , V_65 -> V_128 ) ;
if ( ! V_128 ) {
F_96 ( L_8 ) ;
V_129 = - V_25 ;
goto V_130;
...
void F_111 ( struct V_109 * V_125 )
{
struct V_127 * V_128 = F_112 ( V_125 ) ;
...
int F_114 ( struct V_109 * V_125 , T_4 V_139 )
{
struct V_127 * V_128 = F_112 ( V_125 ) ;
struct V_1 * V_2 = V_128 -> V_131 ;
return F_115 ( V_2 , V_139 ) ;
}
int F_116 ( struct V_109 * V_125 )
{
struct V_127 * V_128 = F_112 ( V_125 ) ;
struct V_1 * V_2 = V_128 -> V_131 ;
return F_117 ( V_2 ) ;
