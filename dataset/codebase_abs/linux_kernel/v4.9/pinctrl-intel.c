...
F_55 ( V_3 -> V_110 ) ;
F_56 ( V_3 -> V_11 , L_12 , V_109 ? L_13 : L_14 , V_4 ) ;
return 0 ;
}
static T_4 F_57 ( struct V_2 * V_3 ,
const struct V_1 * V_5 )
{
...
V_15 * 4 ) ;
V_113 &= V_114 ;
F_58 (gpp_offset, &pending, community->gpp_size) {
unsigned V_13 , V_110 ;
V_13 = V_91 + V_15 * V_5 -> V_20 ;
if ( V_13 >= V_5 -> V_10 )
break;
V_110 = F_59 ( V_90 -> V_115 ,
V_5 -> V_9 + V_13 ) ;
F_60 ( V_110 ) ;
V_80 |= V_116 ;
}
...
static T_4 F_61 ( int V_110 , void * V_117 )
{
const struct V_1 * V_5 ;
...
static int F_62 ( struct V_2 * V_3 , int V_110 )
{
int V_80 ;
V_3 -> V_84 = V_118 ;
V_3 -> V_84 . V_119 = V_3 -> V_28 -> V_10 ;
V_3 -> V_84 . V_120 = F_63 ( V_3 -> V_11 ) ;
V_3 -> V_84 . V_121 = V_3 -> V_11 ;
V_3 -> V_84 . V_87 = - 1 ;
V_3 -> V_110 = V_110 ;
V_80 = F_64 ( & V_3 -> V_84 , V_3 ) ;
if ( V_80 ) {
F_65 ( V_3 -> V_11 , L_15 ) ;
return V_80 ;
}
V_80 = F_66 ( & V_3 -> V_84 , F_63 ( V_3 -> V_11 ) ,
0 , 0 , V_3 -> V_28 -> V_10 ) ;
if ( V_80 ) {
F_65 ( V_3 -> V_11 , L_16 ) ;
goto V_122;
}
V_80 = F_67 ( V_3 -> V_11 , V_110 , F_61 ,
V_123 | V_124 ,
F_63 ( V_3 -> V_11 ) , V_3 ) ;
if ( V_80 ) {
F_65 ( V_3 -> V_11 , L_17 ) ;
...
V_80 = F_68 ( & V_3 -> V_84 , & V_125 , 0 ,
V_126 , V_127 ) ;
if ( V_80 ) {
F_65 ( V_3 -> V_11 , L_18 ) ;
goto V_122;
}
F_69 ( & V_3 -> V_84 , & V_125 , V_110 ,
NULL ) ;
return 0 ;
V_122:
F_70 ( & V_3 -> V_84 ) ;
...
struct V_130 * V_131 ;
int V_6 ;
V_131 = F_73 ( V_3 -> V_11 , V_28 -> V_10 , sizeof( * V_131 ) , V_132 ) ;
if ( ! V_131 )
return - V_133 ;
V_8 = F_73 ( V_3 -> V_11 , V_3 -> V_7 ,
sizeof( * V_8 ) , V_132 ) ;
if ( ! V_8 )
return - V_133 ;
for ( V_6 = 0 ; V_6 < V_3 -> V_7 ; V_6 ++ ) {
...
if ( ! V_138 )
return - V_71 ;
V_3 = F_75 ( & V_137 -> V_11 , sizeof( * V_3 ) , V_132 ) ;
if ( ! V_3 )
return - V_133 ;
V_3 -> V_11 = & V_137 -> V_11 ;
V_3 -> V_28 = V_138 ;
...
V_3 -> V_8 = F_73 ( & V_137 -> V_11 , V_3 -> V_7 ,
...
V_140 = F_77 ( V_137 , V_142 ,
V_5 -> V_143 ) ;
V_21 = F_78 ( & V_137 -> V_11 , V_140 ) ;
if ( F_79 ( V_21 ) )
return F_80 ( V_21 ) ;
V_141 = F_7 ( V_21 + V_144 ) ;
V_5 -> V_21 = V_21 ;
V_5 -> V_14 = V_21 + V_141 ;
V_5 -> V_112 = F_81 ( V_5 -> V_10 ,
V_5 -> V_20 ) ;
}
V_110 = F_82 ( V_137 , 0 ) ;
if ( V_110 < 0 ) {
F_65 ( & V_137 -> V_11 , L_19 ) ;
return V_110 ;
}
V_80 = F_71 ( V_3 ) ;
if ( V_80 )
return V_80 ;
V_3 -> V_145 = V_146 ;
V_3 -> V_145 . V_31 = F_63 ( & V_137 -> V_11 ) ;
V_3 -> V_145 . V_32 = V_3 -> V_28 -> V_32 ;
V_3 -> V_145 . V_10 = V_3 -> V_28 -> V_10 ;
V_3 -> V_27 = F_83 ( & V_137 -> V_11 , & V_3 -> V_145 ,
V_3 ) ;
if ( F_79 ( V_3 -> V_27 ) ) {
F_65 ( & V_137 -> V_11 , L_20 ) ;
return F_80 ( V_3 -> V_27 ) ;
}
V_80 = F_62 ( V_3 , V_110 ) ;
if ( V_80 )
return V_80 ;
...
{
const struct V_147 * V_148 = F_88 ( V_3 -> V_27 , V_4 ) ;
...
int F_90 ( struct V_151 * V_11 )
{
struct V_136 * V_137 = F_91 ( V_11 ) ;
struct V_2 * V_3 = F_86 ( V_137 ) ;
struct V_129 * V_8 ;
struct V_130 * V_131 ;
int V_6 ;
