...
static long F_123 ( struct V_216 * V_217 , unsigned int V_218 ,
unsigned long V_219 )
{
return F_114 ( V_217 , V_218 , V_219 , & V_234 ) ;
}
static long F_124 ( struct V_216 * V_217 , unsigned int V_218 ,
unsigned long V_219 )
{
return F_114 ( V_217 , V_218 , V_219 , & V_235 ) ;
}
...
struct V_22 * V_23 = F_93 ( V_72 ) ;
struct V_201 * V_202 = V_201 ( V_200 ) ;
struct V_204 * V_238 = V_23 -> V_155 ;
struct V_204 * V_205 = V_204 ( V_200 -> V_215 ) ;
int V_24 = 0 ;
if ( V_238 ) {
F_8 ( V_238 != & V_23 -> V_152 ) ;
V_24 = F_129 ( & V_238 -> V_153 , false , V_202 -> V_206 ) ;
if ( F_6 ( V_24 != 0 ) )
return V_24 ;
F_59 ( & V_238 -> V_153 , true , V_154 ) ;
V_23 -> V_155 = NULL ;
}
...
static void F_131 ( struct V_81 * V_72 ,
struct V_199 * V_200 )
{
struct V_22 * V_23 = F_93 ( V_72 ) ;
struct V_201 * V_202 = V_201 ( V_200 ) ;
struct V_204 * V_205 = V_204 ( V_200 -> V_215 ) ;
int V_24 ;
V_202 -> V_203 = F_132 ( V_200 -> V_215 ) ;
V_24 = F_129 ( & V_205 -> V_153 , false , V_202 -> V_206 ) ;
F_133 ( V_23 ) ;
if ( F_6 ( ( V_24 != 0 ) ) ) {
F_15 ( L_65 ) ;
F_103 ( & V_202 -> V_203 ) ;
...
static void F_139 ( struct V_242 * V_89 )
{
struct V_81 * V_72 = F_140 ( V_89 ) ;
F_141 ( V_89 ) ;
F_142 ( V_72 ) ;
}
static int V_193 ( struct V_243 * V_244 , unsigned long V_245 ,
void * V_246 )
{
struct V_22 * V_23 =
F_143 ( V_244 , struct V_22 , V_191 ) ;
switch ( V_245 ) {
case V_247 :
if ( V_23 -> V_117 )
F_97 ( V_23 ) ;
...
static int F_149 ( struct V_242 * V_89 , T_4 V_38 )
{
struct V_81 * V_72 = F_140 ( V_89 ) ;
struct V_22 * V_23 = F_93 ( V_72 ) ;
if ( V_23 -> V_251 )
...
static int F_152 ( struct V_242 * V_89 )
{
F_151 ( V_89 , V_254 ) ;
F_153 ( V_89 ) ;
return F_154 ( V_89 ) ;
}
static int F_155 ( struct V_255 * V_256 )
{
struct V_242 * V_89 = F_156 ( V_256 ) ;
struct V_257 V_30 ;
V_30 . V_258 = 0 ;
return F_149 ( V_89 , V_30 ) ;
}
static int F_157 ( struct V_255 * V_256 )
{
struct V_242 * V_89 = F_156 ( V_256 ) ;
return F_152 ( V_89 ) ;
}
static int F_158 ( struct V_255 * V_256 )
{
struct V_242 * V_89 = F_156 ( V_256 ) ;
struct V_81 * V_72 = F_140 ( V_89 ) ;
struct V_22 * V_23 = F_93 ( V_72 ) ;
...
static int F_161 ( struct V_255 * V_256 )
{
struct V_242 * V_89 = F_156 ( V_256 ) ;
struct V_81 * V_72 = F_140 ( V_89 ) ;
struct V_22 * V_23 = F_93 ( V_72 ) ;
...
static int F_162 ( struct V_242 * V_89 , const struct V_261 * V_262 )
{
return F_163 ( V_89 , V_262 , & V_225 ) ;
}
...
if ( F_165 () )
return - V_80 ;
V_24 = F_166 ( & V_225 , & V_263 ) ;
if ( V_24 )
F_15 ( L_68 ) ;
return V_24 ;
}
static void T_6 F_167 ( void )
{
F_168 ( & V_225 , & V_263 ) ;
}
