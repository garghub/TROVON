...
int V_100 ;
struct V_32 * V_33 ;
V_33 = F_36 ( & V_94 -> V_2 , sizeof( * V_33 ) , V_101 ) ;
if ( ! V_33 )
return - V_102 ;
V_103 . V_2 = & V_94 -> V_2 ;
V_97 = V_103 . V_2 -> V_104 ;
F_37 ( & V_103 , V_33 ) ;
V_100 = V_105 + 1 ;
for ( V_99 = 0 ; V_99 < F_20 ( V_106 ) ; V_99 ++ ) {
if ( ! strcmp ( V_106 [ V_99 ] . V_107 , L_24 ) ) {
V_100 = V_99 ;
break;
}
}
V_98 = F_38 ( V_97 -> V_48 ) ;
if ( V_98 != NULL ) {
snprintf ( V_108 , sizeof( V_108 ) ,
L_25 , L_26 , V_98 ) ;
V_106 [ V_100 ] . V_107 = V_108 ;
}
if ( F_33 () ) {
struct V_109 * V_110 = V_97 -> V_111 ;
const struct V_112 * V_113 = V_110 -> V_113 ;
if ( V_113 -> V_114 == 0 ) {
V_3 |= V_13 ;
}
}
...
if ( ( V_3 & V_14 ) && ( F_33 () ) ) {
V_33 -> V_36 = F_40 ( & V_94 -> V_2 , L_30 ) ;
if ( F_41 ( V_33 -> V_36 ) ) {
F_8 ( & V_94 -> V_2 ,
L_31 ,
F_42 ( V_33 -> V_36 ) ) ;
return F_42 ( V_33 -> V_36 ) ;
}
}
V_95 = F_43 ( & V_94 -> V_2 , & V_103 ) ;
if ( V_95 ) {
F_8 ( & V_94 -> V_2 , L_32 ,
V_95 ) ;
return V_95 ;
