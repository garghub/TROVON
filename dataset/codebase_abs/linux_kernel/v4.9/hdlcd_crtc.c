...
T_2 V_80 , V_81 , V_88 , V_89 ;
T_3 V_90 ;
if ( ! V_78 -> V_12 -> V_13 )
return;
F_27 ( V_78 -> V_12 -> V_13 -> V_7 , & V_86 , & V_87 ) ;
V_80 = V_78 -> V_12 -> V_80 >> 16 ;
V_81 = V_78 -> V_12 -> V_81 >> 16 ;
V_88 = V_78 -> V_12 -> V_82 ;
V_89 = V_78 -> V_12 -> V_83 ;
V_85 = F_28 ( V_78 -> V_12 -> V_13 , 0 ) ;
V_90 = V_85 -> V_91 + V_78 -> V_12 -> V_13 -> V_92 [ 0 ] +
V_78 -> V_12 -> V_93 * V_78 -> V_12 -> V_13 -> V_94 [ 0 ] +
V_78 -> V_12 -> V_95 * V_87 / 8 ;
V_4 = V_78 -> V_75 -> V_96 ;
F_3 ( V_4 , V_97 , V_78 -> V_12 -> V_13 -> V_94 [ 0 ] ) ;
F_3 ( V_4 , V_98 , V_78 -> V_12 -> V_13 -> V_94 [ 0 ] ) ;
F_3 ( V_4 , V_99 , V_89 - 1 ) ;
F_3 ( V_4 , V_100 , V_90 ) ;
}
...
static struct V_77 * F_32 ( struct V_101 * V_102 )
{
struct V_3 * V_4 = V_102 -> V_96 ;
struct V_77 * V_78 = NULL ;
T_2 V_103 [ F_6 ( V_14 ) ] , V_10 ;
int V_104 ;
V_78 = F_33 ( V_102 -> V_75 , sizeof( * V_78 ) , V_105 ) ;
if ( ! V_78 )
return F_34 ( - V_106 ) ;
for ( V_10 = 0 ; V_10 < F_6 ( V_14 ) ; V_10 ++ )
V_103 [ V_10 ] = V_14 [ V_10 ] . V_15 ;
V_104 = F_35 ( V_102 , V_78 , 0xff , & V_107 ,
V_103 , F_6 ( V_103 ) ,
V_108 , NULL ) ;
if ( V_104 ) {
F_36 ( V_102 -> V_75 , V_78 ) ;
return F_34 ( V_104 ) ;
}
F_37 ( V_78 , & V_109 ) ;
V_4 -> V_78 = V_78 ;
...
if ( F_39 ( V_11 ) )
return F_40 ( V_11 ) ;
V_104 = F_41 ( V_102 , & V_4 -> V_2 , V_11 , NULL ,
& V_110 , NULL ) ;
if ( V_104 ) {
F_29 ( V_11 ) ;
F_36 ( V_102 -> V_75 , V_11 ) ;
return V_104 ;
}
F_42 ( & V_4 -> V_2 , & V_111 ) ;
return 0 ;
