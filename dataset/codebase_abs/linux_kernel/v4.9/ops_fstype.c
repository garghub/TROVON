...
unsigned int V_124 ;
int error ;
error = F_26 ( V_13 , V_125 >> V_13 -> V_126 , V_71 ) ;
if ( error ) {
if ( ! V_71 )
F_43 ( V_13 , L_4 ) ;
return error ;
...
sizeof( struct V_133 ) )
* V_141 ;
V_120 = F_44 ( sizeof( V_131 ) * F_3 ( V_142 ) ,
V_13 -> V_134 ) ;
V_121 = 0 ;
for ( V_123 = V_120 ; V_123 > V_13 -> V_129 ; ) {
V_123 = F_44 ( V_123 , V_13 -> V_132 ) ;
V_121 += V_123 ;
}
V_122 = 2 + V_142 ;
...
F_48 ( V_13 -> V_161 , V_155 , V_162 ) ;
F_48 ( V_13 -> V_163 , V_156 , V_162 ) ;
V_156 = V_13 -> V_163 ;
while ( ( V_156 = strchr ( V_156 , '/' ) ) )
* V_156 = '_' ;
return error ;
}
static int F_49 ( struct V_10 * V_13 , struct V_164 * V_165 ,
int V_166 )
{
int error = 0 ;
if ( V_166 )
...
error = F_51 ( V_13 , V_179 , & V_169 ,
V_180 , & V_13 -> V_181 ) ;
if ( error ) {
F_43 ( V_13 , L_7 , error ) ;
goto V_182;
}
error = F_51 ( V_13 , V_183 , & V_184 ,
V_180 , & V_13 -> V_185 ) ;
if ( error ) {
F_43 ( V_13 , L_8 , error ) ;
goto V_186;
...
static int F_54 ( struct V_11 * V_12 , struct V_187 * * V_188 ,
V_131 V_99 , const char * V_189 )
{
struct V_10 * V_13 = V_12 -> V_17 ;
struct V_187 * V_187 ;
struct V_190 * V_190 ;
V_190 = F_55 ( V_12 , V_191 , V_99 , 0 ,
V_192 ) ;
if ( F_56 ( V_190 ) ) {
F_43 ( V_13 , L_9 , V_189 , F_57 ( V_190 ) ) ;
return F_57 ( V_190 ) ;
}
V_187 = F_58 ( V_190 ) ;
if ( ! V_187 ) {
F_43 ( V_13 , L_10 , V_189 ) ;
return - V_109 ;
}
* V_188 = V_187 ;
return 0 ;
...
V_131 V_99 ;
int V_194 ;
V_194 = F_50 ( V_13 , V_195 , & V_196 ,
V_175 , 0 , & V_193 ) ;
if ( V_194 ) {
F_43 ( V_13 , L_11 , V_194 ) ;
return V_194 ;
}
V_194 = F_42 ( V_13 , V_71 ) ;
if ( V_194 ) {
F_43 ( V_13 , L_12 , V_194 ) ;
goto V_197;
}
...
V_194 = F_54 ( V_12 , & V_13 -> V_198 , V_99 , L_17 ) ;
if ( V_194 )
goto V_197;
V_99 = V_13 -> V_73 . V_98 . V_99 ;
V_194 = F_54 ( V_12 , & V_13 -> V_199 , V_99 , L_18 ) ;
if ( V_194 ) {
F_62 ( V_13 -> V_198 ) ;
goto V_197;
}
V_12 -> V_200 = F_63 ( V_13 -> V_157 . V_201 ? V_13 -> V_199 : V_13 -> V_198 ) ;
V_197:
F_53 ( & V_193 ) ;
return V_194 ;
}
...
F_66 ( & V_13 -> V_207 , V_208 , V_203 ) ;
}
static int F_67 ( struct V_10 * V_13 , struct V_164 * V_209 )
{
struct V_210 * V_211 = F_68 ( V_13 -> V_212 ) ;
struct V_213 V_189 ;
char V_87 [ 20 ] ;
struct V_214 * V_215 ;
int error ;
...
F_69 ( & V_13 -> V_34 ) ;
for (; ; ) {
error = F_70 ( V_211 -> V_216 , V_175 , 0 , V_209 ) ;
if ( error )
break;
V_189 . V_217 = sprintf ( V_87 , L_21 , V_13 -> V_218 ) ;
V_189 . V_219 = F_71 ( V_189 . V_189 , V_189 . V_217 ) ;
error = F_72 ( V_13 -> V_212 , & V_189 , NULL ) ;
if ( error == - V_220 ) {
error = 0 ;
break;
}
...
break;
error = - V_109 ;
V_215 = F_5 ( sizeof( struct V_214 ) , V_16 ) ;
if ( ! V_215 )
break;
F_12 ( & V_215 -> V_221 ) ;
F_12 ( & V_215 -> V_222 ) ;
F_73 ( & V_215 -> V_223 , V_224 ) ;
V_215 -> V_225 = F_74 ( V_13 -> V_212 , & V_189 , 1 ) ;
if ( ! V_215 -> V_225 || F_56 ( V_215 -> V_225 ) ) {
if ( ! V_215 -> V_225 )
error = - V_220 ;
else
error = F_57 ( V_215 -> V_225 ) ;
F_7 ( V_215 ) ;
break;
}
F_75 ( & V_13 -> V_33 ) ;
V_215 -> V_226 = V_13 -> V_218 ++ ;
F_76 ( & V_215 -> V_227 , & V_13 -> V_32 ) ;
F_77 ( & V_13 -> V_33 ) ;
}
F_78 ( & V_13 -> V_34 ) ;
return error ;
}
static int F_79 ( struct V_10 * V_13 , struct V_214 * V_215 )
{
int error ;
struct V_164 V_228 ;
struct V_229 V_230 ;
struct V_210 * V_231 ;
V_231 = F_68 ( V_215 -> V_225 ) ;
error = F_70 ( V_231 -> V_216 , V_175 , V_171 |
V_176 | V_172 , & V_228 ) ;
if ( error ) {
F_43 ( V_13 , L_22 ) ;
return - V_232 ;
...
static int F_82 ( struct V_10 * V_13 , int V_166 )
{
struct V_190 * V_236 = F_83 ( V_13 -> V_199 ) ;
struct V_164 V_209 ;
struct V_210 * V_231 ;
int V_237 = 1 ;
int error = 0 ;
...
V_13 -> V_212 = F_84 ( V_236 , L_27 ) ;
if ( F_56 ( V_13 -> V_212 ) ) {
F_43 ( V_13 , L_28 , error ) ;
return F_57 ( V_13 -> V_212 ) ;
}
error = F_67 ( V_13 , & V_209 ) ;
if ( error ) {
...
V_13 -> V_242 = F_86 ( V_13 , V_13 -> V_204 . V_247 ) ;
error = F_50 ( V_13 , V_13 -> V_204 . V_247 ,
& V_248 ,
V_170 , V_171 ,
& V_13 -> V_249 ) ;
if ( error ) {
...
V_231 = F_68 ( V_13 -> V_242 -> V_225 ) ;
error = F_70 ( V_231 -> V_216 , V_175 ,
V_171 | V_176 | V_172 ,
& V_13 -> V_250 ) ;
if ( error ) {
F_43 ( V_13 , L_34 ,
...
struct V_214 * V_215 = F_86 ( V_13 , V_124 ) ;
if ( V_13 -> V_157 . V_241 ) {
error = F_79 ( V_13 , V_215 ) ;
if ( error )
goto V_238;
continue;
}
error = F_90 ( V_215 , true ) ;
if ( error ) {
F_43 ( V_13 , L_36 ,
V_124 , error ) ;
goto V_238;
...
static int F_93 ( struct V_10 * V_13 , int V_166 )
{
int error = 0 ;
struct V_190 * V_236 = F_83 ( V_13 -> V_199 ) ;
if ( V_166 )
goto V_257;
error = F_82 ( V_13 , V_166 ) ;
F_94 ( & V_13 -> V_35 ) ;
if ( error )
goto V_173;
V_13 -> V_258 = F_84 ( V_236 , L_38 ) ;
if ( F_56 ( V_13 -> V_258 ) ) {
error = F_57 ( V_13 -> V_258 ) ;
F_43 ( V_13 , L_39 , error ) ;
goto V_259;
}
V_13 -> V_260 = F_84 ( V_236 , L_40 ) ;
if ( F_56 ( V_13 -> V_260 ) ) {
...
static int F_98 ( struct V_10 * V_13 , int V_166 )
{
...
F_92 ( V_268 ) ;
V_268 = NULL ;
V_231 = F_68 ( V_13 -> V_270 ) ;
error = F_70 ( V_231 -> V_216 , V_170 , 0 ,
& V_13 -> V_273 ) ;
if ( error ) {
F_43 ( V_13 , L_50 , error ) ;
goto V_274;
}
V_231 = F_68 ( V_13 -> V_271 ) ;
error = F_70 ( V_231 -> V_216 , V_170 , 0 ,
& V_13 -> V_275 ) ;
if ( error ) {
...
static struct V_187 * F_126 ( struct V_357 * V_358 , int V_49 ,
...
static struct V_187 * F_138 ( struct V_357 * V_358 ,
