...
if ( V_136 == & V_138 . V_43 )
return V_139 | V_140 ;
if ( F_10 ( V_2 ) && V_136 == & V_141 . V_43 )
return 0 ;
return V_136 -> V_131 ;
}
if ( V_136 == & V_142 . V_43 || V_136 == & V_138 . V_43
|| V_136 == & V_143 . V_43
|| V_136 == & V_144 . V_43
|| V_136 == & V_145 . V_43 )
return V_136 -> V_131 ;
...
struct V_146 * V_146 = F_109 ( V_2 ) ? F_116 ( V_2 ) : NULL ;
...
if ( ! V_4 )
return NULL ;
V_149 = F_118 ( 2 , sizeof( struct V_1 * ) , V_52 ) ;
if ( ! V_149 ) {
F_3 ( V_4 ) ;
return NULL ;
}
...
V_15 -> V_29 = V_150 ;
V_15 -> V_30 = V_7 -> V_114 ;
V_15 -> V_86 = V_15 -> V_30 + V_7 -> V_151 - 1 ;
V_149 [ 0 ] = V_2 ;
return V_149 ;
}
...
struct V_153 * V_157 = V_155 -> V_158 ;
T_8 V_159 , V_160 ;
T_7 V_161 ;
if ( ! V_157 )
continue;
V_161 = F_121 ( V_157 -> V_161 ) ;
V_159 = F_122 ( V_157 -> V_159 ) ;
V_160 = F_122 ( V_157 -> V_160 ) ;
if ( V_161 != V_152 )
continue;
if ( memcmp ( V_157 -> V_12 , V_12 , V_24 ) != 0 )
continue;
if ( V_156 ) {
F_56 ( F_42 ( V_58 ) -> V_2 ,
L_51 ,
...
static int F_123 ( struct V_7 * V_7 , T_1 * V_162 )
{
int V_68 ;
if ( ! V_162 )
return - V_147 ;
...
struct V_58 * V_58 = & V_7 -> V_59 [ V_68 ] ;
struct V_60 * V_61 = F_42 ( V_58 ) ;
struct V_153 * V_157 = NULL ;
T_7 V_163 , V_164 , V_165 , V_166 ;
struct V_154 * V_155 ;
F_67 ( ! F_124 ( & V_58 -> V_167 ) ) ;
F_120 (label_ent, &nd_mapping->labels, list) {
V_157 = V_155 -> V_158 ;
if ( ! V_157 )
continue;
if ( memcmp ( V_157 -> V_12 , V_162 , V_24 ) == 0 )
break;
V_157 = NULL ;
}
if ( ! V_157 ) {
...
V_163 = V_58 -> V_30 ;
V_164 = V_163 + V_58 -> V_64 ;
V_165 = F_121 ( V_157 -> V_106 ) ;
V_166 = V_165 + F_121 ( V_157 -> V_168 ) ;
if ( V_165 >= V_163 && V_165 < V_164
&& V_166 <= V_164 && V_166 > V_163 )
;
else {
F_56 ( & V_7 -> V_2 , L_52 ,
F_107 ( V_61 -> V_2 ) , V_157 -> V_12 ) ;
return - V_55 ;
}
F_125 ( & V_155 -> V_169 , & V_58 -> V_128 ) ;
}
return 0 ;
}
...
V_15 -> V_29 = V_150 ;
for ( V_68 = 0 ; V_68 < V_7 -> V_78 ; V_68 ++ )
if ( ! F_119 ( V_7 , V_157 -> V_12 , V_152 , V_68 ) )
break;
if ( V_68 < V_7 -> V_78 ) {
...
V_49 = F_123 ( V_7 , V_157 -> V_12 ) ;
if ( V_49 )
goto V_171;
for ( V_68 = 0 ; V_68 < V_7 -> V_78 ; V_68 ++ ) {
struct V_153 * V_172 ;
V_58 = & V_7 -> V_59 [ V_68 ] ;
V_155 = F_129 ( & V_58 -> V_128 ,
F_130 ( * V_155 ) , V_169 ) ;
V_172 = V_155 ? V_155 -> V_158 : 0 ;
if ( ! V_172 ) {
F_67 ( 1 ) ;
continue;
}
V_64 += F_121 ( V_172 -> V_168 ) ;
if ( F_122 ( V_172 -> V_159 ) != 0 )
continue;
F_67 ( V_6 -> V_11 || V_6 -> V_12 ) ;
V_6 -> V_11 = F_38 ( ( void V_173 * ) V_172 -> V_37 ,
V_54 , V_52 ) ;
V_6 -> V_12 = F_38 ( ( void V_173 * ) V_172 -> V_12 ,
V_24 , V_52 ) ;
}
...
struct V_65 * F_131 ( struct V_7 * V_7 ,
...
static struct V_1 * F_133 ( struct V_7 * V_7 )
{
struct V_13 * V_14 ;
struct V_1 * V_2 ;
if ( ! F_20 ( & V_7 -> V_2 ) )
...
V_2 = & V_14 -> V_57 . V_2 ;
V_2 -> type = & V_17 ;
V_14 -> V_9 = F_134 ( & V_7 -> V_10 , 0 , 0 , V_52 ) ;
if ( V_14 -> V_9 < 0 ) {
F_3 ( V_14 ) ;
return NULL ;
}
F_135 ( V_2 , L_59 , V_7 -> V_9 , V_14 -> V_9 ) ;
V_2 -> V_8 = & V_7 -> V_2 ;
V_2 -> V_174 = V_175 ;
return & V_14 -> V_57 . V_2 ;
}
static struct V_1 * F_136 ( struct V_7 * V_7 )
{
struct V_5 * V_6 ;
struct V_65 * V_15 ;
struct V_1 * V_2 ;
...
V_15 -> V_37 = F_107 ( & V_7 -> V_2 ) ;
V_15 -> V_29 = V_150 ;
V_6 -> V_9 = F_134 ( & V_7 -> V_10 , 0 , 0 , V_52 ) ;
if ( V_6 -> V_9 < 0 ) {
F_3 ( V_6 ) ;
return NULL ;
}
F_135 ( V_2 , L_59 , V_7 -> V_9 , V_6 -> V_9 ) ;
V_2 -> V_8 = & V_7 -> V_2 ;
V_2 -> V_174 = V_175 ;
F_77 ( V_7 , V_6 , 0 ) ;
return V_2 ;
}
void F_137 ( struct V_7 * V_7 )
{
F_67 ( ! F_25 ( & V_7 -> V_2 ) ) ;
if ( F_35 ( V_7 ) == V_176 )
return;
...
static int F_145 ( struct V_7 * V_7 ,
struct V_153 * V_157 , struct V_1 * * V_149 ,
int V_67 )
{
struct V_58 * V_58 = & V_7 -> V_59 [ 0 ] ;
struct V_60 * V_61 = F_42 ( V_58 ) ;
...
T_1 * V_12 = F_91 ( V_149 [ V_68 ] ) ;
struct V_65 * V_15 ;
if ( F_146 ( V_12 ) ) {
F_67 ( 1 ) ;
continue;
}
if ( memcmp ( V_12 , V_157 -> V_12 , V_24 ) != 0 )
continue;
if ( F_11 ( V_149 [ V_68 ] ) ) {
V_15 = F_131 ( V_7 , V_61 ,
F_9 ( V_149 [ V_68 ] ) ,
...
struct V_1 * F_147 ( struct V_7 * V_7 ,
struct V_153 * V_157 , int V_67 )
{
struct V_58 * V_58 = & V_7 -> V_59 [ 0 ] ;
struct V_60 * V_61 = F_42 ( V_58 ) ;
struct V_13 * V_14 ;
...
V_2 -> V_8 = & V_7 -> V_2 ;
V_14 -> V_9 = - 1 ;
V_14 -> V_69 = F_121 ( V_157 -> V_69 ) ;
V_14 -> V_12 = F_38 ( V_157 -> V_12 , V_24 ,
V_52 ) ;
if ( ! V_14 -> V_12 )
goto V_180;
memcpy ( V_37 , V_157 -> V_37 , V_54 ) ;
if ( V_37 [ 0 ] )
V_14 -> V_11 = F_38 ( V_37 , V_54 ,
V_52 ) ;
V_15 = F_131 ( V_7 , V_61 , V_14 ,
F_121 ( V_157 -> V_106 ) ) ;
if ( ! V_15 )
goto V_180;
F_60 ( V_7 , V_61 , V_15 , L_66 , V_67 ) ;
return V_2 ;
V_180:
F_8 ( V_2 ) ;
return F_92 ( - V_50 ) ;
}
static int F_148 ( const void * V_136 , const void * V_181 )
{
const struct V_1 * V_182 = * ( const struct V_1 * * ) V_136 ;
const struct V_1 * V_183 = * ( const struct V_1 * * ) V_181 ;
struct V_13 * V_184 , * V_185 ;
struct V_5 * V_186 , * V_187 ;
if ( F_12 ( V_182 ) )
return 0 ;
if ( F_11 ( V_182 ) ) {
V_184 = F_9 ( V_182 ) ;
V_185 = F_9 ( V_183 ) ;
return memcmp ( & V_184 -> V_15 [ 0 ] -> V_30 , & V_185 -> V_15 [ 0 ] -> V_30 ,
sizeof( T_4 ) ) ;
}
V_186 = F_5 ( V_182 ) ;
V_187 = F_5 ( V_183 ) ;
return memcmp ( & V_186 -> V_4 . V_15 . V_30 , & V_187 -> V_4 . V_15 . V_30 ,
sizeof( T_4 ) ) ;
}
static struct V_1 * * F_149 ( struct V_7 * V_7 )
{
int V_68 , V_67 = 0 ;
struct V_1 * V_2 , * * V_149 = NULL ;
struct V_154 * V_155 , * V_188 ;
struct V_58 * V_58 = & V_7 -> V_59 [ 0 ] ;
T_4 V_189 = V_58 -> V_30 + V_58 -> V_64 - 1 ;
F_150 (label_ent, e, &nd_mapping->labels, list) {
struct V_153 * V_157 = V_155 -> V_158 ;
struct V_1 * * V_190 ;
T_5 V_29 ;
if ( ! V_157 )
continue;
V_29 = F_151 ( V_157 -> V_29 ) ;
if ( F_20 ( & V_7 -> V_2 )
== ! ! ( V_29 & V_66 ) )
;
else
continue;
if ( V_157 -> V_106 < V_58 -> V_30 || V_157 -> V_106 > V_189 )
continue;
V_68 = F_145 ( V_7 , V_157 , V_149 , V_67 ) ;
if ( V_68 < 0 )
goto V_171;
if ( V_68 < V_67 )
continue;
V_190 = F_118 ( V_67 + 2 , sizeof( V_2 ) , V_52 ) ;
if ( ! V_190 )
goto V_171;
memcpy ( V_190 , V_149 , sizeof( V_2 ) * V_67 ) ;
F_3 ( V_149 ) ;
V_149 = V_190 ;
if ( F_20 ( & V_7 -> V_2 ) ) {
V_2 = F_147 ( V_7 , V_157 , V_67 ) ;
if ( F_94 ( V_2 ) )
goto V_171;
V_149 [ V_67 ++ ] = V_2 ;
} else {
...
V_111 = V_67 ;
F_154 (l, e, &nd_mapping->labels) {
if ( ! V_111 -- )
break;
F_155 ( V_192 , & V_169 ) ;
}
F_152 ( V_58 ) ;
F_156 ( & V_169 , & V_58 -> V_128 ) ;
}
}
if ( V_67 > 1 )
F_157 ( V_149 , V_67 , sizeof( struct V_1 * ) , F_148 , NULL ) ;
return V_149 ;
V_171:
if ( V_149 ) {
for ( V_68 = 0 ; V_149 [ V_68 ] ; V_68 ++ )
if ( F_20 ( & V_7 -> V_2 ) )
F_8 ( V_149 [ V_68 ] ) ;
else
F_4 ( V_149 [ V_68 ] ) ;
...
static struct V_1 * * F_158 ( struct V_7 * V_7 )
{
struct V_58 * V_58 = & V_7 -> V_59 [ 0 ] ;
struct V_1 * * V_149 ;
int V_68 ;
...
for ( V_68 = 0 ; V_68 < V_7 -> V_78 ; V_68 ++ ) {
V_58 = & V_7 -> V_59 [ V_68 ] ;
F_159 ( & V_58 -> V_167 , V_68 ) ;
}
V_149 = F_149 ( V_7 ) ;
for ( V_68 = 0 ; V_68 < V_7 -> V_78 ; V_68 ++ ) {
int V_193 = V_7 -> V_78 - 1 - V_68 ;
V_58 = & V_7 -> V_59 [ V_193 ] ;
F_160 ( & V_58 -> V_167 ) ;
}
return V_149 ;
...
F_163 ( V_61 ) ;
V_67 = F_164 ( V_61 ) ;
F_56 ( V_61 -> V_2 , L_69 , V_73 , V_67 ) ;
if ( ! V_67 )
continue;
for ( V_111 = 0 ; V_111 < V_67 ; V_111 ++ ) {
struct V_153 * V_158 ;
V_155 = F_40 ( sizeof( * V_155 ) , V_52 ) ;
if ( ! V_155 )
break;
V_158 = F_165 ( V_61 , V_111 ) ;
V_155 -> V_158 = V_158 ;
F_166 ( & V_58 -> V_167 ) ;
F_167 ( & V_155 -> V_169 , & V_58 -> V_128 ) ;
F_160 ( & V_58 -> V_167 ) ;
}
if ( V_111 >= V_67 )
continue;
...
int F_168 ( struct V_7 * V_7 , int * V_171 )
{
...
return - V_147 ;
for ( V_68 = 0 ; V_149 [ V_68 ] ; V_68 ++ ) {
struct V_1 * V_2 = V_149 [ V_68 ] ;
int V_9 ;
if ( type == V_197 ) {
struct V_13 * V_14 ;
V_14 = F_9 ( V_2 ) ;
V_9 = F_134 ( & V_7 -> V_10 , 0 , 0 ,
V_52 ) ;
V_14 -> V_9 = V_9 ;
} else if ( type == V_196 ) {
struct V_5 * V_6 ;
...
if ( V_149 [ V_68 ] ) {
int V_111 ;
for ( V_111 = V_68 ; V_149 [ V_111 ] ; V_111 ++ ) {
struct V_1 * V_2 = V_149 [ V_111 ] ;
F_169 ( V_2 ) ;
F_170 ( V_2 ) ;
}
* V_171 = V_111 - V_68 ;
