...
if ( ! ( V_214 & V_229 ) )
V_215 = 32 ;
if ( ! F_161 ( & V_25 -> V_9 , F_162 ( V_215 ) ) ) {
F_163 ( & V_25 -> V_9 , F_162 ( V_215 ) ) ;
} else {
F_161 ( & V_25 -> V_9 , F_162 ( 32 ) ) ;
F_163 ( & V_25 -> V_9 , F_162 ( 32 ) ) ;
}
V_2 -> V_233 = ( V_214 >> 8 ) & 0x0f ;
V_2 -> V_234 = ( V_214 >> 12 ) & 0x0f ;
if ( ! V_2 -> V_234 && ! V_2 -> V_233 ) {
switch ( V_2 -> V_14 ) {
case V_217 :
V_2 -> V_234 = V_235 ;
V_2 -> V_233 = V_236 ;
...
if ( V_2 -> V_31 & V_52 )
F_81 ( V_51 ) ;
F_22 ( V_2 , ( V_247 [ V_9 ] & 2 ) == 0 ) ;
if ( ! F_23 ( V_2 ) -> V_183 ) {
F_54 ( V_33 -> V_9 , L_37 ) ;
return - V_248 ;
}
strcpy ( V_33 -> V_249 , L_38 ) ;
F_166 ( V_33 -> V_250 , V_251 [ V_2 -> V_14 ] ,
sizeof( V_33 -> V_250 ) ) ;
snprintf ( V_33 -> V_252 , sizeof( V_33 -> V_252 ) ,
L_39 ,
V_33 -> V_250 , V_51 -> V_131 , V_51 -> V_90 ) ;
return 0 ;
}
static void F_167 ( const struct V_253 * V_152 , void * V_254 )
{
struct V_117 * V_33 = V_254 ;
struct V_1 * V_2 = V_33 -> V_13 ;
struct V_24 * V_25 = V_2 -> V_25 ;
if ( ! V_152 ) {
F_54 ( V_33 -> V_9 , L_40 ) ;
...
static void F_170 ( T_1 V_173 , T_1 T_5 * V_131 )
{
F_171 ( V_173 , V_131 ) ;
}
static T_1 F_172 ( T_1 T_5 * V_131 )
{
return F_173 ( V_131 ) ;
}
static void F_174 ( T_4 V_173 , T_4 T_5 * V_131 )
{
F_175 ( V_173 , V_131 ) ;
}
static T_4 F_176 ( T_4 T_5 * V_131 )
{
return F_61 ( V_131 ) ;
}
static void F_177 ( T_3 V_173 , T_3 T_5 * V_131 )
{
F_178 ( V_173 , V_131 ) ;
}
static T_3 F_179 ( T_3 T_5 * V_131 )
{
return F_180 ( V_131 ) ;
}
...
static int F_182 ( struct V_50 * V_51 ,
int type ,
T_6 V_255 ,
struct V_3 * V_19 )
{
struct V_1 * V_2 = F_183 ( V_51 ) ;
int V_145 ;
V_145 = F_184 ( type ,
V_51 -> V_9 ,
V_255 , V_19 ) ;
...
static void F_185 ( struct V_50 * V_51 , struct V_3 * V_19 )
{
struct V_1 * V_2 = F_183 ( V_51 ) ;
F_8 ( V_2 , V_19 , false ) ;
F_186 ( V_19 ) ;
...
T_6 V_255 )
{
struct V_20 * V_20 = F_188 ( V_22 ) ;
int V_113 ;
F_9 ( V_2 , V_20 , V_22 , false ) ;
V_113 = F_189 ( V_22 , V_255 ) ;
if ( V_113 < 0 )
return V_113 ;
...
static void F_192 ( struct V_21 * V_22 ,
struct V_256 * V_7 )
{
#ifdef F_156
struct V_257 * V_258 = F_193 ( V_22 ) ;
struct V_1 * V_2 = V_258 -> V_2 ;
if ( ! F_2 ( V_2 ) && V_2 -> V_14 != V_15 )
V_7 -> V_259 = F_194 ( V_7 -> V_259 ) ;
#endif
}
static int F_195 ( struct V_24 * V_25 ,
...
V_145 = F_196 ( & V_25 -> V_9 , V_265 [ V_9 ] , V_266 [ V_9 ] , V_267 ,
0 , & V_33 ) ;
if ( V_145 < 0 ) {
F_54 ( & V_25 -> V_9 , L_41 ) ;
return V_145 ;
}
V_145 = F_142 ( V_33 , V_25 , V_9 , V_261 -> V_268 , & V_2 ) ;
if ( V_145 < 0 )
goto V_269;
V_33 -> V_13 = V_2 ;
V_68 = F_35 ( V_2 , struct V_67 , V_2 ) ;
...
V_262 = ! V_2 -> V_115 ;
#ifdef F_124
if ( V_270 [ V_9 ] && * V_270 [ V_9 ] ) {
F_32 ( V_33 -> V_9 , L_45 ,
V_270 [ V_9 ] ) ;
V_145 = F_197 ( V_267 , true , V_270 [ V_9 ] ,
& V_25 -> V_9 , V_200 , V_33 ,
F_167 ) ;
if ( V_145 < 0 )
goto V_269;
...
V_2 -> V_273 = V_273 [ V_9 ] ;
#endif
V_145 = F_202 ( V_2 , V_274 [ V_2 -> V_14 ] ) ;
if ( V_145 < 0 )
goto V_269;
#ifdef F_124
if ( V_2 -> V_152 ) {
V_145 = F_203 ( & V_2 -> V_51 , V_2 -> V_152 -> V_255 ,
V_2 -> V_152 -> V_29 ) ;
if ( V_145 < 0 )
goto V_269;
#ifndef F_204
...
static void F_210 ( struct V_24 * V_25 )
{
struct V_117 * V_33 = F_98 ( V_25 ) ;
struct V_1 * V_2 ;
if ( ! V_33 )
