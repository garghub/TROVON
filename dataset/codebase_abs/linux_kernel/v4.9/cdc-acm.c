...
unsigned long V_33 ;
int V_58 = V_37 -> V_58 ;
F_41 ( & V_1 -> V_43 -> V_16 , L_13 ,
V_97 -> V_89 , V_37 -> V_95 ,
V_58 ) ;
if ( ! V_1 -> V_16 ) {
F_40 ( V_97 -> V_89 , & V_1 -> V_92 ) ;
F_14 ( & V_1 -> V_43 -> V_16 , L_14 , V_21 ) ;
return;
}
if ( V_58 ) {
F_40 ( V_97 -> V_89 , & V_1 -> V_92 ) ;
...
if ( V_22 == V_231 )
return - V_107 ;
memset ( & V_223 , 0x00 , sizeof( struct V_222 ) ) ;
...
if ( ! V_217 -> V_236 || ! V_216 -> V_236 )
return - V_107 ;
if ( V_226 != V_225 )
F_14 ( & V_48 -> V_16 , L_29 ) ;
if ( V_216 == V_217 ) {
F_117 ( & V_48 -> V_16 , L_30 ) ;
V_228 = 1 ;
V_22 |= V_244 ;
...
F_173 (KERN_INFO KBUILD_MODNAME L_39 DRIVER_DESC L_40 ) ;
return 0 ;
}
