...
static int
F_62 ( struct V_25 * V_23 , struct V_124 * V_89 )
{
struct V_26 * V_27 = F_5 ( V_23 ) ;
int V_45 ;
V_45 = - V_70 ;
...
static int
F_65 ( struct V_25 * V_23 , struct V_124 * V_89 )
{
struct V_26 * V_27 = F_5 ( V_23 ) ;
if ( V_27 -> V_56 != NULL )
...
int F_124 ( struct V_5 * V_6 , struct V_206 * V_22 ,
...
if ( V_6 -> V_28 )
V_44 = V_6 -> V_28 ;
V_187 = F_125 ( sizeof( struct V_26 ) , V_14 ,
V_207 , V_208 ) ;
if ( V_187 == NULL )
return - V_175 ;
...
NULL ) ;
F_129 ( V_187 , V_22 ) ;
V_187 -> V_23 . V_219 = V_6 -> V_35 [ V_31 ] . V_198 ;
V_187 -> V_210 = V_44 -> V_210 ;
V_27 = F_5 ( V_187 ) ;
V_27 -> V_22 = V_6 ;
V_27 -> V_31 = V_31 ;
V_27 -> V_123 = V_19 -> V_220 -> V_123 ;
V_27 -> V_181 = - 1 ;
V_27 -> V_178 = - 1 ;
V_27 -> V_179 = - 1 ;
V_6 -> V_35 [ V_31 ] . V_221 = V_187 ;
V_78 = F_130 ( V_187 ) ;
if ( V_78 ) {
F_103 ( V_44 , L_16 ,
V_78 , V_187 -> V_14 ) ;
V_6 -> V_35 [ V_31 ] . V_221 = NULL ;
F_131 ( V_187 ) ;
return V_78 ;
}
F_132 ( V_187 ) ;
...
static bool F_136 ( struct V_25 * V_23 )
{
return V_23 -> V_214 == & V_215 ;
}
static int F_137 ( struct V_25 * V_23 ,
unsigned long V_222 , void * V_223 )
{
struct V_224 * V_225 = V_223 ;
struct V_25 * V_226 = V_225 -> V_227 ;
int V_45 = 0 ;
switch ( V_222 ) {
case V_228 :
if ( F_138 ( V_226 ) ) {
if ( V_225 -> V_229 )
V_45 = F_51 ( V_23 , V_226 ) ;
else
F_52 ( V_23 ) ;
}
break;
...
static int F_140 ( struct V_25 * V_23 , unsigned long V_222 ,
void * V_223 )
{
switch ( V_222 ) {
case V_228 :
return F_137 ( V_23 , V_222 , V_223 ) ;
}
return V_230 ;
}
int F_141 ( struct V_231 * V_232 ,
unsigned long V_222 , void * V_223 )
{
struct V_25 * V_23 = F_142 ( V_223 ) ;
if ( F_136 ( V_23 ) )
return F_140 ( V_23 , V_222 , V_223 ) ;
return V_230 ;
}
