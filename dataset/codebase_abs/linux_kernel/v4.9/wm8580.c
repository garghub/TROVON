...
return 0 ;
V_153:
F_31 ( F_11 ( V_15 -> V_151 ) , V_15 -> V_151 ) ;
V_152:
return V_18 ;
}
...
const struct V_156 * V_75 )
{
struct V_14 * V_15 ;
int V_18 , V_28 ;
V_15 = F_34 ( & V_155 -> V_2 , sizeof( struct V_14 ) ,
V_157 ) ;
if ( V_15 == NULL )
return - V_158 ;
V_15 -> V_19 = F_35 ( V_155 , & V_159 ) ;
if ( F_36 ( V_15 -> V_19 ) )
return F_37 ( V_15 -> V_19 ) ;
for ( V_28 = 0 ; V_28 < F_11 ( V_15 -> V_151 ) ; V_28 ++ )
V_15 -> V_151 [ V_28 ] . V_160 = V_161 [ V_28 ] ;
V_18 = F_38 ( & V_155 -> V_2 , F_11 ( V_15 -> V_151 ) ,
V_15 -> V_151 ) ;
if ( V_18 != 0 ) {
F_20 ( & V_155 -> V_2 , L_14 , V_18 ) ;
return V_18 ;
}
F_39 ( V_155 , V_15 ) ;
V_18 = F_40 ( & V_155 -> V_2 ,
& V_162 , V_163 , F_11 ( V_163 ) ) ;
return V_18 ;
}
static int F_41 ( struct V_154 * V_164 )
{
F_42 ( & V_164 -> V_2 ) ;
return 0 ;
}
