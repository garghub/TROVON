...
{
unsigned long V_124 ;
unsigned long V_125 = 1UL << V_126 ;
V_124 = 0 ;
V_123 = F_45 ( V_123 ) - 18 ;
F_59 ( ( V_126 > 24 ) , L_23 ) ;
V_127 = F_60 ( F_61 ( V_125 , V_125 ,
V_128 ) ) ;
memset ( ( void * ) V_127 , 0 , V_125 ) ;
V_127 -> V_129 = F_62 ( V_124 | V_122 | V_123 ) ;
V_127 -> V_130 = 0 ;
F_21 ( L_24 , V_127 ) ;
if ( F_32 ( V_131 ) )
F_53 () ;
F_56 ( V_132 , F_49 ( V_127 ) | ( V_126 - 12 ) ) ;
}
...
unsigned long V_146 = V_128 ;
#ifdef F_66
if ( F_67 ( V_147 , 0 , L_27 ) > 0 ) {
V_146 = 0x80000000 ;
F_21 ( L_28 ) ;
}
#endif
V_133 = F_61 ( V_140 , V_140 ,
V_146 ) ;
F_4 ( L_29 , V_133 ,
V_140 ) ;
V_143 = F_60 ( V_133 ) ;
V_144 = V_133 + F_45 ( V_140 ) - 18 ;
memset ( ( void * ) V_133 , 0 , V_140 ) ;
if ( ! F_32 ( V_148 ) )
F_56 ( V_149 , V_144 ) ;
else
F_58 ( V_133 , V_140 ) ;
...
#endif
F_68 (memory, reg) {
V_135 = ( unsigned long ) F_60 ( V_137 -> V_135 ) ;
V_59 = V_137 -> V_59 ;
F_4 ( L_30 ,
V_135 , V_59 , V_24 ) ;
F_11 ( F_3 ( V_135 , V_135 + V_59 , F_49 ( V_135 ) ,
V_24 , V_100 , V_116 ) ) ;
}
F_69 ( V_128 ) ;
if ( V_151 ) {
V_151 = ( unsigned long ) F_60 ( V_151 ) ;
V_152 = ( unsigned long ) F_60 ( V_152 ) ;
if ( V_135 + V_59 >= V_151 )
V_151 = V_135 + V_59 + 1 ;
F_11 ( F_3 ( V_151 , V_152 ,
F_49 ( V_151 ) , V_24 ,
V_100 , V_116 ) ) ;
}
F_4 ( L_31 ) ;
...
unsigned int F_80 ( unsigned int V_194 , T_5 V_195 , int V_196 )
{
struct V_187 * V_187 ;
if ( ! F_81 ( F_82 ( V_195 ) ) )
return V_194 ;
V_187 = F_83 ( V_195 ) ;
if ( ! F_84 ( V_197 , & V_187 -> V_198 ) && ! F_85 ( V_187 ) ) {
if ( V_196 == 0x400 ) {
F_86 ( V_187 ) ;
F_87 ( V_197 , & V_187 -> V_198 ) ;
} else
V_194 |= V_4 ;
}
return V_194 ;
}
static unsigned int F_88 ( unsigned long V_199 )
{
T_6 V_200 ;
unsigned char * V_201 ;
...
unsigned int F_88 ( unsigned long V_199 )
{
return F_89 () -> V_207 ;
}
void F_92 ( struct V_208 * V_209 , unsigned long V_199 )
{
if ( F_93 ( V_209 , V_199 ) == V_65 )
return;
F_94 ( V_209 , V_199 , 1 , V_65 ) ;
F_95 ( V_209 ) ;
if ( ( F_88 ( V_199 ) != V_65 ) && ( V_210 -> V_209 == V_209 ) ) {
F_96 ( & V_209 -> V_211 ) ;
F_97 () ;
}
}
static int F_98 ( struct V_208 * V_209 , unsigned long V_212 )
{
...
static inline int F_98 ( struct V_208 * V_209 , unsigned long V_212 )
{
return 0 ;
}
void F_99 ( unsigned long V_212 , unsigned long V_225 ,
...
static void F_101 ( unsigned long V_212 , struct V_208 * V_209 ,
int V_25 , bool V_228 )
{
if ( V_228 ) {
if ( V_25 != F_88 ( V_212 ) ) {
...
int F_103 ( struct V_208 * V_209 , unsigned long V_212 ,
unsigned long V_225 , unsigned long V_196 ,
unsigned long V_198 )
{
bool V_230 ;
enum V_231 V_232 = F_104 () ;
T_8 * V_233 ;
unsigned long V_35 ;
T_5 * V_234 ;
unsigned V_235 ;
...
V_25 = F_93 ( V_209 , V_212 ) ;
V_26 = F_108 ( V_212 ) ;
V_35 = F_109 ( V_209 -> V_211 . V_240 , V_212 , V_26 ) ;
break;
case V_241 :
V_35 = F_5 ( V_212 , V_116 ) ;
if ( V_212 < V_242 )
V_25 = V_102 ;
else
V_25 = V_104 ;
...
F_105 ( L_38 , V_209 , V_209 -> V_243 , V_35 ) ;
if ( ! V_35 ) {
F_105 ( L_39 ) ;
V_48 = 1 ;
goto V_239;
...
V_237 = F_110 ( F_111 () ) ;
if ( V_228 && F_112 ( F_113 ( V_209 ) , V_237 ) )
V_198 |= V_244 ;
#ifndef F_40
if ( V_25 != V_65 )
V_212 &= ~ ( ( 1ul << V_32 [ V_25 ] . V_30 ) - 1 ) ;
#endif
V_234 = F_114 ( V_233 , V_212 , & V_230 , & V_235 ) ;
if ( V_234 == NULL || ! F_115 ( * V_234 ) ) {
F_105 ( L_40 ) ;
V_48 = 1 ;
goto V_239;
}
V_225 |= V_245 ;
if ( ! F_116 ( V_225 , F_117 ( * V_234 ) ) ) {
F_105 ( L_41 ) ;
V_48 = 1 ;
goto V_239;
}
if ( V_235 ) {
if ( V_230 )
V_48 = F_118 ( V_212 , V_225 , V_35 , ( V_246 * ) V_234 ,
V_196 , V_198 , V_26 , V_25 ) ;
#ifdef F_37
else
V_48 = F_119 ( V_212 , V_225 , V_35 , V_234 , V_196 ,
...
F_101 ( V_212 , V_209 , V_25 , V_228 ) ;
goto V_239;
}
#ifndef F_40
F_105 ( L_42 , F_117 ( * V_234 ) ) ;
#else
F_105 ( L_43 , F_117 ( * V_234 ) ,
F_117 ( * ( V_234 + V_247 ) ) ) ;
#endif
#ifdef F_40
if ( ( F_117 ( * V_234 ) & V_248 ) && V_25 == V_66 ) {
F_92 ( V_209 , V_212 ) ;
V_25 = V_65 ;
}
if ( V_105 && V_25 == V_66 && F_120 ( * V_234 ) ) {
if ( V_228 ) {
F_92 ( V_209 , V_212 ) ;
V_25 = V_65 ;
} else if ( V_212 < V_242 ) {
...
#ifdef F_40
if ( V_25 == V_66 )
V_48 = F_121 ( V_212 , V_225 , V_35 , V_234 , V_196 ,
V_198 , V_26 ) ;
else
#endif
{
int V_215 = F_98 ( V_209 , V_212 ) ;
if ( V_225 & V_215 )
V_48 = - 2 ;
else
...
if ( V_48 == - 1 )
F_99 ( V_212 , V_225 , V_35 , V_196 , V_26 , V_25 ,
V_25 , F_117 ( * V_234 ) ) ;
#ifndef F_40
F_105 ( L_47 , F_117 ( * V_234 ) ) ;
#else
F_105 ( L_48 , F_117 ( * V_234 ) ,
F_117 ( * ( V_234 + V_247 ) ) ) ;
#endif
F_105 ( L_49 , V_48 ) ;
V_239:
...
int F_124 ( unsigned long V_212 , unsigned long V_225 , unsigned long V_196 ,
unsigned long V_250 )
{
unsigned long V_198 = 0 ;
struct V_208 * V_209 = V_210 -> V_209 ;
if ( F_107 ( V_212 ) == V_241 )
V_209 = & V_251 ;
if ( V_250 & V_252 )
V_198 |= V_253 ;
return F_103 ( V_209 , V_212 , V_225 , V_196 , V_198 ) ;
}
int F_125 ( unsigned long V_212 , unsigned long V_254 , unsigned long V_196 ,
unsigned long V_250 )
{
...
V_225 |= V_6 ;
V_225 |= V_5 ;
if ( ( V_254 & V_257 ) || ( F_107 ( V_212 ) == V_238 ) )
V_225 &= ~ V_5 ;
if ( V_196 == 0x400 )
V_225 |= V_3 ;
return F_103 ( V_209 , V_212 , V_225 , V_196 , V_198 ) ;
}
static bool F_126 ( struct V_208 * V_209 , unsigned long V_212 )
{
int V_25 = F_93 ( V_209 , V_212 ) ;
if ( F_127 ( V_25 != V_209 -> V_211 . V_258 ) )
return false ;
if ( F_127 ( ( V_25 == V_65 ) && F_98 ( V_209 , V_212 ) ) )
return false ;
return true ;
}
static bool F_126 ( struct V_208 * V_209 , unsigned long V_212 )
...
void F_128 ( struct V_208 * V_209 , unsigned long V_212 ,
unsigned long V_225 , unsigned long V_196 )
{
int V_259 ;
unsigned long V_35 ;
...
F_11 ( F_107 ( V_212 ) != V_238 ) ;
if ( ! F_126 ( V_209 , V_212 ) )
return;
F_105 ( L_50
...
return;
F_129 ( V_198 ) ;
V_234 = F_130 ( V_233 , V_212 , NULL , & V_259 ) ;
if ( ! V_234 )
goto V_261;
F_52 ( V_259 ) ;
#ifdef F_40
if ( ( F_117 ( * V_234 ) & V_248 ) || F_120 ( * V_234 ) )
goto V_261;
#endif
if ( F_112 ( F_113 ( V_209 ) , F_110 ( F_111 () ) ) )
V_260 |= V_244 ;
#ifdef F_40
...
#endif
V_48 = F_122 ( V_212 , V_225 , V_35 , V_234 , V_196 , V_260 ,
V_26 , F_98 ( V_209 , V_212 ) ) ;
if ( V_48 == - 1 )
F_99 ( V_212 , V_225 , V_35 , V_196 , V_26 ,
V_209 -> V_211 . V_258 ,
V_209 -> V_211 . V_258 ,
F_117 ( * V_234 ) ) ;
V_261:
...
static inline void F_132 ( int V_262 )
{
if ( V_262 && F_32 ( V_263 ) && V_210 -> V_264 . V_265 &&
F_133 ( V_210 -> V_264 . V_265 -> V_254 ) ) {
F_134 () ;
F_135 ( V_266 ) ;
}
}
...
void F_136 ( unsigned long V_36 , T_9 V_195 , int V_25 , int V_26 ,
unsigned long V_198 )
{
...
V_33 = F_10 ( V_36 , V_30 , V_26 ) ;
V_267 = F_138 ( V_195 , V_202 ) ;
if ( V_267 & V_269 )
V_33 = ~ V_33 ;
V_268 = ( V_33 & V_40 ) * V_41 ;
V_268 += V_267 & V_270 ;
F_105 ( L_53 , V_202 , V_268 , V_267 ) ;
V_42 . V_271 ( V_268 , V_36 , V_25 , V_25 ,
V_26 , V_262 ) ;
} F_139 () ;
F_132 ( V_262 ) ;
}
void F_140 ( unsigned long V_35 , unsigned long V_199 ,
...
V_275 = F_142 ( V_277 , V_273 ) ;
if ( ! V_275 )
continue;
V_267 = F_143 ( V_277 , V_273 ) ;
...
void F_144 ( unsigned long V_281 , int V_262 )
{
if ( V_42 . F_144 )
V_42 . F_144 ( V_281 , V_262 ) ;
else {
int V_273 ;
struct V_282 * V_283 =
F_145 ( & V_282 ) ;
for ( V_273 = 0 ; V_273 < V_281 ; V_273 ++ )
F_136 ( V_283 -> V_36 [ V_273 ] , V_283 -> V_195 [ V_273 ] ,
V_283 -> V_25 , V_283 -> V_26 , V_262 ) ;
}
}
void F_146 ( struct V_284 * V_265 , unsigned long V_285 , int V_48 )
{
enum V_231 V_232 = F_104 () ;
if ( F_147 ( V_265 ) ) {
#ifdef F_148
if ( V_48 == - 2 )
F_149 ( V_286 , V_265 , V_287 , V_285 ) ;
else
#endif
F_149 ( V_288 , V_265 , V_289 , V_285 ) ;
} else
F_150 ( V_265 , V_285 , V_288 ) ;
F_123 ( V_232 ) ;
}
...
static void F_153 ( unsigned long V_27 , unsigned long V_296 )
{
unsigned long V_33 ;
unsigned long V_35 = F_5 ( V_27 , V_116 ) ;
unsigned long V_36 = F_6 ( V_27 , V_35 , V_116 ) ;
unsigned long V_297 = F_1 ( F_50 ( V_115 ) ) ;
long V_31 ;
V_33 = F_10 ( V_36 , V_45 , V_116 ) ;
if ( ! V_35 )
return;
V_31 = F_151 ( V_33 , V_36 , F_49 ( V_27 ) , V_297 ,
V_44 ,
V_100 , V_116 ) ;
F_11 ( V_31 < 0 ) ;
F_154 ( & V_298 ) ;
...
static void F_156 ( unsigned long V_27 , unsigned long V_296 )
{
...
void F_157 ( struct V_187 * V_187 , int V_299 , int V_300 )
{
unsigned long V_198 , V_27 , V_296 ;
int V_273 ;
F_129 ( V_198 ) ;
for ( V_273 = 0 ; V_273 < V_299 ; V_273 ++ , V_187 ++ ) {
V_27 = ( unsigned long ) F_158 ( V_187 ) ;
V_296 = F_49 ( V_27 ) >> V_45 ;
if ( V_296 >= V_46 )
continue;
if ( V_300 )
F_153 ( V_27 , V_296 ) ;
...
void F_159 ( T_4 V_301 ,
T_4 V_302 )
{
F_11 ( V_301 != 0 ) ;
V_150 = F_160 ( T_6 , V_302 , 0x40000000 ) ;
F_69 ( V_150 ) ;
}
