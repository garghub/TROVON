...
static int F_69 ( struct V_68 * V_4 , int V_90 )
{
...
static void F_70 ( struct V_68 * V_21 )
{
struct V_16 * V_17 = F_45 ( V_21 ) ;
bool V_94 = false ;
int V_18 ;
...
T_1 V_47 = V_17 -> V_47 ;
T_1 V_99 = V_17 -> V_99 ;
bool V_100 = ! ! ( V_99 / V_101 ) ;
int V_9 ;
V_99 &= V_101 - 1 ;
V_9 = V_42 -> V_44 . V_102 . V_103 ( V_42 , V_47 , V_98 , V_99 , V_100 , 0 ) ;
if ( V_9 )
return V_9 ;
return 1 ;
}
...
int V_9 ;
V_99 &= V_101 - 1 ;
V_9 = V_42 -> V_44 . V_102 . V_105 ( V_42 , V_47 , V_104 , V_99 , V_100 ) ;
if ( V_9 )
return V_9 ;
return 1 ;
}
static int F_78 ( struct V_68 * V_21 , T_1 V_99 , bool V_100 )
{
struct V_16 * V_17 = F_45 ( V_21 ) ;
struct V_41 * V_42 = & V_17 -> V_42 ;
T_4 V_9 ;
...
if ( V_42 -> V_44 . V_106 )
return - V_107 ;
F_79 ( V_99 , V_17 -> V_108 ) ;
if ( ! V_100 )
F_80 ( V_99 , V_17 -> V_108 ) ;
for ( V_18 = 0 ; V_18 < V_17 -> V_27 ; V_18 ++ ) {
struct V_1 * V_23 = V_17 -> V_23 [ V_18 ] ;
T_1 V_109 = V_23 -> V_99 & ( V_101 - 1 ) ;
if ( F_81 ( V_109 , V_17 -> V_108 ) )
V_23 -> V_99 |= V_110 ;
else
V_23 -> V_99 &= ~ V_110 ;
}
if ( ! V_100 && V_99 == V_42 -> V_44 . V_111 )
return 0 ;
if ( F_81 ( V_112 , & V_17 -> V_113 ) )
return 0 ;
F_82 ( V_17 ) ;
if ( ! ( V_21 -> V_114 & V_115 ) ) {
V_9 = V_42 -> V_44 . V_102 . V_116 ( V_42 , V_99 , 0 , V_100 ) ;
if ( V_9 )
goto V_117;
}
V_9 = V_42 -> V_44 . V_102 . V_103 ( V_42 , V_17 -> V_47 , V_42 -> V_44 . V_118 ,
V_99 , V_100 , 0 ) ;
if ( V_9 )
goto V_117;
V_17 -> V_99 = V_99 + ( V_100 ? V_101 : 0 ) ;
F_83 ( V_21 , F_76 ) ;
F_84 ( V_21 , F_77 ) ;
V_117:
F_85 ( V_17 ) ;
...
T_5 T_3 V_80 , T_1 V_99 )
{
return F_78 ( V_21 , V_99 , true ) ;
}
static int F_87 ( struct V_68 * V_21 ,
T_5 T_3 V_80 , T_1 V_99 )
{
return F_78 ( V_21 , V_99 , false ) ;
}
static T_1 F_88 ( struct V_16 * V_17 , T_1 V_99 )
{
struct V_41 * V_42 = & V_17 -> V_42 ;
T_1 V_111 = V_42 -> V_44 . V_111 ;
T_1 V_119 = V_99 < V_111 ? V_111 : V_101 ;
V_99 = F_89 ( V_17 -> V_108 , V_119 , ++ V_99 ) ;
return V_99 ;
}
...
for ( V_99 = 0 , V_120 = 0 ;
V_120 < V_101 ;
V_120 = V_99 + 1 , V_99 = F_88 ( V_17 , V_99 ) ) {
if ( V_120 == V_99 )
continue;
V_120 += ( V_99 - V_120 - 1 ) << V_121 ;
V_42 -> V_44 . V_102 . V_116 ( V_42 , V_120 , 0 , false ) ;
}
}
...
struct V_16 * V_17 = F_45 ( V_4 ) ;
struct V_41 * V_42 = & V_17 -> V_42 ;
T_1 V_99 , V_47 = V_17 -> V_47 ;
T_4 V_9 ;
if ( ! F_92 ( V_118 ) )
return - V_123 ;
for ( V_99 = V_42 -> V_44 . V_111 ? F_88 ( V_17 , 0 ) : 1 ;
V_99 < V_101 ;
V_99 = F_88 ( V_17 , V_99 ) ) {
V_9 = V_42 -> V_44 . V_102 . V_103 ( V_42 , V_47 , V_118 ,
V_99 , V_122 , 0 ) ;
if ( V_9 )
return V_9 ;
}
...
V_99 < V_101 ;
V_99 = F_88 ( V_17 , V_99 ) ) {
V_42 -> V_44 . V_102 . V_105 ( V_42 , V_47 , V_118 , V_99 , V_122 ) ;
}
return 0 ;
}
...
if ( V_17 -> V_132 != V_132 ) {
if ( V_132 == V_133 )
V_42 -> V_44 . V_102 . V_116 ( V_42 , V_140 , 0 , true ) ;
if ( V_17 -> V_132 == V_133 )
F_90 ( V_17 ) ;
V_42 -> V_44 . V_102 . V_141 ( V_42 , V_17 -> V_47 , V_132 ) ;
V_17 -> V_132 = V_132 ;
}
F_101 ( V_4 , F_93 , F_94 ) ;
F_102 ( V_4 , F_98 , F_99 ) ;
...
V_132 = V_139 ;
F_82 ( V_17 ) ;
V_42 -> V_44 . V_102 . V_142 ( V_42 , V_47 , V_17 -> V_49 , true ) ;
V_42 -> V_44 . V_102 . V_116 ( V_42 , V_140 , 0 ,
V_132 == V_133 ) ;
V_42 -> V_44 . V_102 . V_116 ( V_42 , 0 , 0 , true ) ;
for ( V_99 = V_42 -> V_44 . V_111 ? F_88 ( V_17 , 0 ) : 1 ;
V_99 < V_101 ;
V_99 = F_88 ( V_17 , V_99 ) ) {
V_42 -> V_44 . V_102 . V_116 ( V_42 , V_99 , 0 , true ) ;
V_42 -> V_44 . V_102 . V_103 ( V_42 , V_47 , V_42 -> V_44 . V_118 ,
V_99 , true , 0 ) ;
}
V_42 -> V_44 . V_102 . V_141 ( V_42 , V_47 , V_132 ) ;
...
struct V_41 * V_42 = & V_17 -> V_42 ;
F_82 ( V_17 ) ;
V_42 -> V_44 . V_102 . V_142 ( V_42 , V_17 -> V_47 ,
V_17 -> V_49 , false ) ;
F_85 ( V_17 ) ;
V_17 -> V_132 = V_139 ;
F_83 ( V_21 , NULL ) ;
...
static struct V_143 * F_105 ( struct V_68 * V_21 ,
struct V_143 * V_144 )
{
struct V_16 * V_17 = F_45 ( V_21 ) ;
struct V_1 * V_29 ;
...
if ( V_17 -> V_49 < 7 )
return F_124 ( - V_167 ) ;
V_5 = F_125 ( struct V_161 , V_168 [ 7 ] ) ;
V_162 = F_126 ( V_5 , V_14 ) ;
if ( ! V_162 )
return F_124 ( - V_15 ) ;
V_162 -> V_5 = 7 ;
V_162 -> V_166 = V_17 -> V_47 ;
F_121 ( V_17 , V_162 ) ;
} else if ( ( V_162 -> V_7 == V_169 ) ||
( V_162 -> V_7 == ( V_17 -> V_49 - 1 ) ) ) {
return F_124 ( - V_167 ) ;
} else if ( V_162 -> V_7 == V_162 -> V_5 ) {
V_164 = V_162 ;
V_5 = F_125 ( struct V_161 ,
V_168 [ ( V_162 -> V_5 * 2 ) + 1 ] ) ;
V_162 = F_126 ( V_5 , V_14 ) ;
if ( ! V_162 )
return F_124 ( - V_15 ) ;
...
F_125 ( struct V_161 ,
V_168 [ V_164 -> V_5 ] ) ) ;
V_162 -> V_5 = ( V_164 -> V_5 * 2 ) + 1 ;
F_121 ( V_17 , V_162 ) ;
F_127 ( V_164 , V_170 ) ;
}
for ( V_18 = 0 ; V_18 < V_162 -> V_5 ; V_18 ++ ) {
if ( ! V_162 -> V_168 [ V_18 ] )
break;
}
V_162 -> V_168 [ V_18 ] = V_163 ;
V_162 -> V_7 ++ ;
V_166 . V_171 = V_172 ;
V_166 . V_173 = 1 ;
V_166 . V_174 = F_128 ( V_17 -> V_175 [ V_176 ] . V_43 ) ;
V_166 . V_177 = F_128 ( V_17 -> V_175 [ V_178 ] . V_43 ) ;
V_166 . V_47 = V_17 -> V_47 ;
V_166 . V_179 = F_128 ( V_162 -> V_5 ) ;
V_42 -> V_44 . V_102 . V_180 ( V_42 , & V_166 ) ;
F_82 ( V_17 ) ;
V_47 = V_162 -> V_166 + 1 + V_18 ;
V_42 -> V_44 . V_102 . V_141 ( V_42 , V_47 , V_138 ) ;
V_42 -> V_44 . V_102 . V_103 ( V_42 , V_47 , V_163 -> V_128 , 0 , true , 0 ) ;
F_85 ( V_17 ) ;
return V_163 ;
}
static void F_129 ( struct V_68 * V_4 , void * V_181 )
{
struct V_16 * V_17 = F_45 ( V_4 ) ;
struct V_161 * V_162 = F_107 ( V_17 -> V_162 ) ;
struct V_165 V_166 = { 0 } ;
struct V_41 * V_42 = & V_17 -> V_42 ;
struct V_68 * V_163 = V_181 ;
int V_18 ;
T_1 V_47 ;
if ( ! V_162 )
return;
for ( V_18 = 0 ; V_18 < V_162 -> V_5 ; V_18 ++ ) {
if ( V_162 -> V_168 [ V_18 ] == V_163 )
break;
}
if ( V_18 == V_162 -> V_5 )
return;
F_82 ( V_17 ) ;
V_47 = V_162 -> V_166 + 1 + V_18 ;
V_42 -> V_44 . V_102 . V_141 ( V_42 , V_47 , V_139 ) ;
V_42 -> V_44 . V_102 . V_103 ( V_42 , V_47 , V_163 -> V_128 , 0 , false , 0 ) ;
F_85 ( V_17 ) ;
V_162 -> V_168 [ V_18 ] = NULL ;
V_162 -> V_7 -- ;
V_166 . V_171 = V_172 ;
V_166 . V_173 = 1 ;
V_166 . V_174 = F_128 ( V_17 -> V_175 [ V_176 ] . V_43 ) ;
...
T_9 V_182 )
{
if ( ! V_30 -> V_183 || F_131 ( V_30 ) )
return V_182 ;
return V_182 & ~ ( V_184 | V_185 ) ;
}
struct V_68 * F_132 ( const struct V_186 * V_187 )
{
T_9 V_188 ;
struct V_16 * V_17 ;
struct V_68 * V_4 ;
V_4 = F_133 ( sizeof( struct V_16 ) , V_189 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_190 = & V_191 ;
F_134 ( V_4 ) ;
V_17 = F_45 ( V_4 ) ;
V_17 -> V_192 = F_135 ( V_193 ) - 1 ;
V_4 -> V_182 |= V_194 |
V_195 |
V_196 |
V_197 |
