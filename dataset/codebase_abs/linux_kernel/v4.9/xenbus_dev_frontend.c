...
if ( V_58 -> V_61 . V_62 == V_7 -> V_7 . V_24 . V_63 )
break;
if ( & V_58 -> V_21 == & V_7 -> V_64 )
return - V_65 ;
}
...
if ( V_54 == V_59 ) {
if ( V_7 -> V_7 . V_24 . type == V_66 )
F_10 ( V_58 ) ;
else {
V_58 -> V_61 . V_62 = F_29 ( V_56 , NULL , 0 ) ;
F_30 ( & V_58 -> V_21 , & V_7 -> V_64 ) ;
}
} else if ( V_7 -> V_7 . V_24 . type == V_60 ) {
F_9 ( & V_58 -> V_21 ) ;
F_10 ( V_58 ) ;
}
F_2 ( & V_7 -> V_13 ) ;
...
F_30 ( & V_35 -> V_21 , & V_7 -> V_72 ) ;
} else {
F_25 (watch, &u->watches, list) {
...
V_12 = F_35 ( V_7 -> V_7 . V_68 + V_7 -> V_4 , V_3 , V_4 ) ;
if ( V_12 != 0 ) {
V_55 = - V_25 ;
goto V_26;
}
...
static int F_36 ( struct V_78 * V_78 , struct V_1 * V_2 )
{
struct V_6 * V_7 ;
if ( V_79 == 0 )
return - V_80 ;
...
static int F_41 ( struct V_78 * V_78 , struct V_1 * V_2 )
{
struct V_6 * V_7 = V_2 -> V_8 ;
struct V_57 * V_58 , * V_81 ;
struct V_34 * V_35 , * V_82 ;
struct V_9 * V_10 , * V_83 ;
F_42 (trans, tmp, &u->transactions, list) {
F_43 ( V_58 -> V_61 , 1 ) ;
F_9 ( & V_58 -> V_21 ) ;
F_10 ( V_58 ) ;
}
F_42 (watch, tmp_watch, &u->watches, list) {
F_33 ( & V_35 -> V_35 ) ;
F_9 ( & V_35 -> V_21 ) ;
F_15 ( V_35 ) ;
}
F_42 (rb, tmp_rb, &u->read_buffers, list) {
F_9 ( & V_10 -> V_21 ) ;
F_10 ( V_10 ) ;
}
F_10 ( V_7 ) ;
