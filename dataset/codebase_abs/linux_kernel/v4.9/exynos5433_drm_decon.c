...
static int F_71 ( struct V_122 * V_114 )
{
struct V_1 * V_2 = F_61 ( V_114 ) ;
int V_84 = F_56 ( V_119 ) ;
while ( -- V_84 >= 0 )
...
{
struct V_122 * V_114 = & V_151 -> V_114 ;
struct V_1 * V_2 ;
struct V_152 * V_153 ;
int V_118 ;
int V_84 ;
V_2 = F_74 ( V_114 , sizeof( * V_2 ) , V_154 ) ;
if ( ! V_2 )
return - V_155 ;
F_75 ( V_9 , & V_2 -> V_10 ) ;
V_2 -> V_114 = V_114 ;
V_2 -> V_14 = ( unsigned long ) F_76 ( V_114 ) ;
if ( V_2 -> V_14 & V_31 ) {
V_2 -> V_85 = 1 ;
} else if ( F_77 ( V_114 -> V_156 , L_6 ) ) {
V_2 -> V_14 |= V_15 ;
}
for ( V_84 = 0 ; V_84 < F_56 ( V_119 ) ; V_84 ++ ) {
struct V_157 * V_157 ;
V_157 = F_78 ( V_2 -> V_114 , V_119 [ V_84 ] ) ;
if ( F_64 ( V_157 ) )
return F_65 ( V_157 ) ;
V_2 -> V_120 [ V_84 ] = V_157 ;
}
V_153 = F_79 ( V_151 , V_158 , 0 ) ;
if ( ! V_153 ) {
F_80 ( V_114 , L_7 ) ;
return - V_159 ;
}
V_2 -> V_6 = F_81 ( V_114 , V_153 ) ;
if ( F_64 ( V_2 -> V_6 ) ) {
F_80 ( V_114 , L_8 ) ;
return F_65 ( V_2 -> V_6 ) ;
}
V_153 = F_82 ( V_151 , V_160 ,
( V_2 -> V_14 & V_15 ) ? L_9 : L_10 ) ;
if ( ! V_153 ) {
F_80 ( V_114 , L_11 ) ;
return - V_159 ;
}
V_118 = F_83 ( V_114 , V_153 -> V_161 , F_69 , 0 ,
L_12 , V_2 ) ;
if ( V_118 < 0 ) {
F_80 ( V_114 , L_13 ) ;
return V_118 ;
