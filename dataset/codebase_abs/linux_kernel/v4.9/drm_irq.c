...
V_9 -> V_20 = V_20 ;
F_23 ( L_16 ,
V_27 -> V_82 . V_83 , V_74 -> V_79 ,
V_74 -> V_80 , V_74 -> V_84 ) ;
F_23 ( L_17 ,
V_27 -> V_82 . V_83 , V_76 , V_20 , V_75 ) ;
}
...
if ( V_2 -> V_16 -> V_28 && ( V_85 > 0 ) ) {
V_38 = V_2 -> V_16 -> V_28 ( V_2 , V_3 , & V_85 ,
V_106 , V_18 ) ;
if ( V_38 > 0 )
return true ;
}
...
F_2 ( & V_2 -> V_116 ) ;
V_112 -> V_3 = V_3 ;
V_112 -> V_113 . V_114 = F_18 ( V_2 , V_3 ) ;
...
{
struct V_1 * V_2 = V_27 -> V_2 ;
unsigned int V_110 , V_3 = F_15 ( V_27 ) ;
struct V_5 V_105 ;
if ( V_2 -> V_35 > 0 ) {
...
int F_94 ( struct V_1 * V_2 , void * V_64 ,
struct V_65 * V_66 )
{
struct F_94 * V_125 = V_64 ;
unsigned int V_3 ;
if ( ! V_2 -> V_35 )
return 0 ;
if ( ! F_26 ( V_2 , V_62 ) )
...
if ( V_18 & V_150 ) {
return F_95 ( V_2 , V_3 , V_130 , V_66 ) ;
}
F_23 ( L_33 ,
V_130 -> V_136 . V_114 , V_3 ) ;
F_99 ( V_38 , V_9 -> V_43 , 3 * V_122 ,
( ( ( F_18 ( V_2 , V_3 ) -
