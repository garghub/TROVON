...
{
char V_6 [ 10 + V_174 ] ;
sprintf ( V_6 , L_18 , V_2 -> T_9 ) ;
V_2 -> V_21 . V_133 = F_69 ( V_6 ,
V_2 -> V_32 -> V_34 . V_35 -> V_175 ) ;
if ( V_2 -> V_21 . V_133 )
V_2 -> V_176 . V_177 = F_69 ( L_19 ,
V_2 -> V_21 . V_133 ) ;
F_73 ( V_2 ) ;
}
...
struct V_131 * V_132 ;
char V_6 [ 10 + V_174 ] ;
V_132 = V_2 -> V_21 . V_133 ;
if ( ! V_132 )
return;
sprintf ( V_6 , L_18 , V_2 -> T_9 ) ;
if ( ! F_79 ( V_132 -> V_178 , V_132 , V_132 -> V_178 , V_6 ) )
F_80 ( V_2 ,
L_20 ,
V_6 ) ;
}
