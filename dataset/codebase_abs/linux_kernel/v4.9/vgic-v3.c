...
void F_16 ( struct V_1 * V_2 , int V_16 )
{
...
void F_18 ( struct V_1 * V_2 , struct V_54 * V_55 )
{
...
static bool F_20 ( struct V_9 * V_9 )
{
...
V_83 = F_27 ( V_9 , V_84 -> V_80 , V_89 ) ;
if ( V_83 ) {
F_25 ( L_3 ) ;
goto V_85;
}
V_83 = F_28 ( V_9 , V_84 -> V_82 ) ;
if ( V_83 ) {
F_25 ( L_4 ) ;
goto V_85;
}
...
int F_32 ( const struct V_91 * V_92 )
{
T_1 V_93 = F_33 ( V_94 ) ;
int V_83 ;
...
F_34 ( L_6 ) ;
V_95 . V_99 = 0 ;
} else if ( ! F_35 ( V_92 -> V_2 . V_98 ) ) {
F_36 ( L_7 ,
( unsigned long long ) V_92 -> V_2 . V_98 ) ;
V_95 . V_99 = 0 ;
} else if ( ! F_35 ( F_37 ( & V_92 -> V_2 ) ) ) {
F_36 ( L_8 ,
( unsigned long long ) F_37 ( & V_92 -> V_2 ) ,
V_100 ) ;
V_95 . V_99 = 0 ;
} else {
