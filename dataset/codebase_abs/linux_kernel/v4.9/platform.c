...
V_2 = F_45 ( & V_6 -> V_6 , sizeof( * V_2 ) , V_55 ) ;
if ( ! V_2 )
return - V_56 ;
V_2 -> V_6 = & V_6 -> V_6 ;
if ( ! V_6 -> V_6 . V_57 )
V_6 -> V_6 . V_57 = & V_6 -> V_6 . V_58 ;
V_50 = F_46 ( & V_6 -> V_6 , F_47 ( 32 ) ) ;
if ( V_50 )
return V_50 ;
V_49 = F_48 ( V_6 , V_59 , 0 ) ;
V_2 -> V_60 = F_49 ( & V_6 -> V_6 , V_49 ) ;
if ( F_24 ( V_2 -> V_60 ) )
return F_25 ( V_2 -> V_60 ) ;
F_32 ( & V_6 -> V_6 , L_14 ,
( unsigned long ) V_49 -> V_61 , V_2 -> V_60 ) ;
V_50 = F_22 ( V_2 ) ;
if ( V_50 )
return V_50 ;
F_50 ( & V_2 -> V_62 ) ;
V_2 -> V_63 = F_45 ( & V_6 -> V_6 ,
sizeof( * V_2 -> V_63 ) , V_55 ) ;
if ( ! V_2 -> V_63 )
return - V_56 ;
F_44 ( V_2 -> V_63 , - 1 ) ;
V_2 -> V_42 = F_51 ( V_6 , 0 ) ;
...
F_57 ( V_2 ) ;
if ( V_2 -> V_5 != V_13 ) {
V_50 = F_58 ( V_2 , V_2 -> V_42 ) ;
if ( V_50 )
goto error;
V_2 -> V_41 = 1 ;
}
if ( V_2 -> V_5 != V_11 ) {
V_50 = F_59 ( V_2 , V_2 -> V_42 ) ;
if ( V_50 ) {
if ( V_2 -> V_41 )
F_38 ( V_2 ) ;
goto error;
...
static int T_1 F_62 ( struct V_66 * V_6 )
{
struct V_1 * V_67 = F_63 ( V_6 ) ;
int V_16 = 0 ;
if ( F_64 ( V_67 ) )
F_65 ( V_67 ) ;
if ( V_67 -> V_24 )
...
static int T_1 F_66 ( struct V_66 * V_6 )
{
struct V_1 * V_67 = F_63 ( V_6 ) ;
int V_16 = 0 ;
if ( V_67 -> V_24 ) {
