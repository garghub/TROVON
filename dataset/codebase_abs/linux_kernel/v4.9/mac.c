...
V_137 = F_64 ( V_134 , & V_135 , sizeof( V_135 ) ) ;
if ( V_137 )
goto V_31;
V_137 = F_65 ( V_134 ) ;
if ( V_137 )
...
static int F_69 ( struct V_130 * V_143 )
{
...
V_11 = & V_143 -> V_11 ;
V_140 = V_11 -> V_151 ;
V_5 = F_70 ( V_11 , sizeof( * V_5 ) , V_152 ) ;
if ( ! V_5 ) {
V_31 = - V_57 ;
F_2 ( V_11 , L_10 , V_31 ) ;
goto V_34;
}
V_7 = F_70 ( V_11 , sizeof( * V_7 ) , V_152 ) ;
if ( ! V_7 ) {
V_31 = - V_57 ;
goto V_34;
}
...
V_7 -> V_30 = F_72 ( V_140 ,
L_12 , 0 ) ;
} else if ( F_71 ( V_140 , L_13 ) ) {
F_59 ( V_5 ) ;
} else if ( F_71 ( V_140 , L_14 ) ) {
F_60 ( V_5 ) ;
V_7 -> V_30 = F_72 ( V_140 ,
L_15 , 0 ) ;
} else {
...
if ( ! F_83 ( V_140 ) ) {
F_84 ( V_11 , V_7 -> V_159 ) ;
F_85 ( V_11 , F_82 ( V_7 -> V_26 ) ,
V_17 . V_18 , V_17 . V_157 + 1 - V_17 . V_18 ) ;
F_86 ( V_11 , V_5 ) ;
F_73 ( V_11 , NULL ) ;
return - V_156 ;
}
V_31 = F_77 ( V_140 , L_19 , & V_150 ) ;
if ( V_31 ) {
F_2 ( V_11 , L_20 ,
V_140 -> V_153 ) ;
V_31 = - V_33 ;
...
if ( V_145 != F_90 ( V_5 -> V_161 ) ) {
F_2 ( V_11 , L_29 ,
V_140 -> V_153 ) ;
V_31 = - V_33 ;
goto V_154;
}
for ( V_144 = 0 ; V_144 < F_90 ( V_5 -> V_161 ) ; V_144 ++ ) {
V_146 = F_72 ( V_140 , L_27 , V_144 ) ;
if ( ! V_146 ) {
F_2 ( V_11 , L_30 ,
V_140 -> V_153 ) ;
V_31 = - V_33 ;
...
V_5 -> V_161 [ V_144 ] = F_91 ( & V_147 -> V_11 ) ;
if ( ! V_5 -> V_161 [ V_144 ] ) {
F_2 ( V_11 , L_31 ,
V_146 -> V_153 ) ;
V_31 = - V_33 ;
...
if ( V_7 -> V_21 == V_39 )
V_5 -> V_97 = V_168 ;
V_7 -> V_95 = F_72 ( V_140 , L_33 , 0 ) ;
if ( ! V_7 -> V_95 && F_94 ( V_140 ) ) {
struct V_41 * V_169 ;
V_31 = F_95 ( V_140 ) ;
if ( V_31 )
goto V_154;
V_7 -> V_40 = F_96 ( sizeof( * V_7 -> V_40 ) ,
V_152 ) ;
if ( ! V_7 -> V_40 )
goto V_154;
V_7 -> V_95 = F_97 ( V_140 ) ;
