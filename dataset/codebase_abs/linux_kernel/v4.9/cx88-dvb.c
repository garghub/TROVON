...
{
struct V_8 * V_9 = V_38 -> V_40 -> V_41 ;
V_9 -> V_80 = V_79 ? 0x04 : 0x00 ;
return 0 ;
}
static int F_35 ( struct V_37 * V_38 , int V_81 )
{
struct V_8 * V_9 = V_38 -> V_40 -> V_41 ;
struct V_56 * V_50 = V_9 -> V_50 ;
...
static int F_47 ( T_1 V_89 , struct V_8 * V_9 )
{
struct V_37 * V_38 ;
...
static int F_52 ( struct V_8 * V_9 , struct V_101 * V_94 )
{
struct V_37 * V_38 ;
struct V_60 * V_90 = NULL ;
V_90 = F_27 ( & V_9 -> V_46 , 1 ) ;
...
V_38 = F_49 ( V_102 , V_90 -> V_40 . V_63 , & V_9 -> V_50 -> V_95 ,
V_94 ) ;
if ( ! V_38 ) {
F_22 ( V_47 L_11 ,
V_9 -> V_50 -> V_98 ) ;
...
if ( F_64 ( & V_9 -> V_50 -> V_95 , & V_114 , 1 ) != 1 )
return - V_117 ;
return 0 ;
}
...
return ( F_64 ( & V_9 -> V_50 -> V_95 , & V_114 , 1 ) == 1 ) ? 0 : - V_117 ;
}
...
V_132 = F_73 ( & V_9 -> V_46 , V_300 , V_9 ,
& V_9 -> V_23 -> V_9 , NULL , V_301 ,
V_131 ) ;
if ( V_132 )
goto V_134;
return V_132 ;
