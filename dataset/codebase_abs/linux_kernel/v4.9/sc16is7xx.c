...
V_7 -> V_85 [ V_19 ] . V_2 . V_229 = V_80 ;
V_7 -> V_85 [ V_19 ] . V_2 . V_103 = V_230 | V_231 ;
V_7 -> V_85 [ V_19 ] . V_2 . V_232 = V_233 ;
V_7 -> V_85 [ V_19 ] . V_2 . V_37 = V_204 ;
V_7 -> V_85 [ V_19 ] . V_2 . V_234 = F_59 ;
V_7 -> V_85 [ V_19 ] . V_2 . V_235 = & V_236 ;
...
F_95 ( & V_238 , & V_7 -> V_85 [ V_19 ] . V_2 ) ;
F_6 ( & V_7 -> V_85 [ V_19 ] . V_2 , V_39 ,
V_40 ) ;
F_9 ( V_7 -> V_10 , true ) ;
F_6 ( & V_7 -> V_85 [ V_19 ] . V_2 , V_41 ,
V_42 ) ;
F_9 ( V_7 -> V_10 , false ) ;
F_6 ( & V_7 -> V_85 [ V_19 ] . V_2 , V_39 , 0x00 ) ;
F_19 ( & V_7 -> V_85 [ V_19 ] . V_2 , 0 ) ;
}
V_206 = F_96 ( V_8 , V_97 , F_40 ,
V_239 | V_103 , F_93 ( V_8 ) , V_7 ) ;
if ( ! V_206 )
return 0 ;
V_237:
for ( V_19 -- ; V_19 >= 0 ; V_19 -- ) {
F_97 ( & V_238 , & V_7 -> V_85 [ V_19 ] . V_2 ) ;
...
static int F_103 ( struct V_240 * V_241 )
{
const struct V_200 * V_95 ;
...
int V_206 ;
V_241 -> V_242 = 8 ;
V_241 -> V_243 = V_241 -> V_243 ? : V_244 ;
V_241 -> V_245 = V_241 -> V_245 ? : 15000000 ;
V_206 = F_104 ( V_241 ) ;
if ( V_206 )
return V_206 ;
if ( V_241 -> V_8 . V_246 ) {
const struct V_247 * V_248 =
F_105 ( V_249 , & V_241 -> V_8 ) ;
if ( ! V_248 )
return - V_250 ;
V_95 = (struct V_200 * ) V_248 -> V_251 ;
} else {
const struct V_252 * V_253 = F_106 ( V_241 ) ;
V_95 = (struct V_200 * ) V_253 -> V_254 ;
V_103 = V_255 ;
}
V_256 . V_257 = ( 0xf << V_11 ) |
( V_95 -> V_96 - 1 ) ;
V_10 = F_107 ( V_241 , & V_256 ) ;
return F_79 ( & V_241 -> V_8 , V_95 , V_10 , V_241 -> V_97 , V_103 ) ;
}
static int F_108 ( struct V_240 * V_241 )
{
return F_102 ( & V_241 -> V_8 ) ;
}
...
if ( V_259 -> V_8 . V_246 ) {
const struct V_247 * V_248 =
F_105 ( V_249 , & V_259 -> V_8 ) ;
if ( ! V_248 )
return - V_250 ;
V_95 = (struct V_200 * ) V_248 -> V_251 ;
} else {
V_95 = (struct V_200 * ) V_261 -> V_254 ;
V_103 = V_255 ;
}
V_256 . V_257 = ( 0xf << V_11 ) |
( V_95 -> V_96 - 1 ) ;
V_10 = F_110 ( V_259 , & V_256 ) ;
return F_79 ( & V_259 -> V_8 , V_95 , V_10 , V_259 -> V_97 , V_103 ) ;
}
static int F_111 ( struct V_258 * V_262 )
{
return F_102 ( & V_262 -> V_8 ) ;
}
