...
goto V_128;
case 0x30 :
if ( ! F_42 ( V_212 , V_124 -> V_37 ) ) {
V_125 -> V_63 |= V_213 ;
F_12 ( V_9 , V_124 -> V_137 ) ;
F_12 ( V_212 , V_124 -> V_37 ) ;
}
F_40 ( V_214 ) ;
break;
case 0x32 :
...
V_133:
if ( V_125 -> V_131 -> V_396 && V_125 -> V_131 -> V_396 ( V_125 ,
...
int V_398 = V_24 -> V_42 ;
int V_399 = V_24 -> V_41 ;
if ( ( V_125 -> V_63 & V_400 ) && ( V_2 -> V_10 == V_47 || V_2 -> V_10 == V_48 ) ) {
V_398 = V_24 -> V_42 = 0 ;
V_399 = V_24 -> V_41 = 255 ;
}
if ( V_24 -> V_141 == V_148 || V_24 -> V_141 == V_145 )
F_45 ( V_124 , V_2 -> V_10 , V_398 , V_399 , ( V_399 - V_398 ) >> 8 , ( V_399 - V_398 ) >> 4 ) ;
else F_45 ( V_124 , V_2 -> V_10 , V_398 , V_399 , 0 , 0 ) ;
F_46 ( V_124 , V_2 -> V_10 ,
F_14 ( V_24 , V_2 -> V_10 ) ) ;
if ( V_2 -> V_10 == V_50 && V_124 -> V_401 == 0 )
F_47 ( V_124 , 60 ) ;
}
if ( V_2 -> type == V_397 &&
...
F_12 ( V_302 , V_124 -> V_37 ) ;
}
if ( V_2 -> type == V_9 ) {
F_12 ( V_221 , V_124 -> V_137 ) ;
F_12 ( V_403 , V_124 -> V_223 ) ;
}
V_128:
return;
}
...
F_49 ( V_124 , V_2 -> type , V_2 -> V_10 , V_404 [ V_177 ] . V_405 ) ;
F_49 ( V_124 , V_2 -> type , V_2 -> V_10 + 1 , V_404 [ V_177 ] . V_406 ) ;
return;
}
if ( V_2 -> V_5 == ( V_211 | 0x003c ) ) {
* V_63 = V_14 ? ( * V_63 | V_407 ) : ( * V_63 & ~ V_407 ) ;
return;
}
if ( V_2 -> V_5 == ( V_211 | 0x0032 ) ) {
if ( V_14 ) {
F_49 ( V_124 , V_2 -> type , ( * V_63 & V_407 ) ? V_218 : V_2 -> V_10 , 1 ) ;
return;
}
F_49 ( V_124 , V_2 -> type , V_2 -> V_10 , 0 ) ;
F_49 ( V_124 , V_2 -> type , V_218 , 0 ) ;
return;
}
if ( V_2 -> V_5 == ( V_211 | 0x0030 ) && ( * V_63 & V_213 ) ) {
int V_398 = V_24 -> V_42 ;
int V_399 = V_24 -> V_41 ;
F_49 ( V_124 , V_9 , V_212 , V_14 > V_398 + ( ( V_399 - V_398 ) >> 3 ) ) ;
}
...
F_49 ( V_124 , V_9 , V_409 , 1 ) ;
F_50 ( V_124 ) ;
F_49 ( V_124 , V_9 , V_409 , 0 ) ;
F_50 ( V_124 ) ;
}
return;
}
...
return;
if ( V_2 -> type == V_9 &&
( ! F_42 ( V_2 -> V_10 , V_124 -> V_413 ) ) == V_14 )
F_49 ( V_124 , V_221 , V_403 , V_2 -> V_5 ) ;
...
{
struct V_425 * V_426 = V_5 -> V_131 ;
struct V_427 * V_428 ;
struct V_19 * V_429 ;
int V_16 , V_17 ;
V_428 = & V_5 -> V_430 [ V_119 ] ;
F_5 (rep, &rep_enum->report_list, list)
for ( V_16 = 0 ; V_16 < V_429 -> V_23 ; V_16 ++ ) {
if ( V_429 -> V_24 [ V_16 ] -> V_129 < 1 )
continue;
for ( V_17 = 0 ; V_17 < V_429 -> V_24 [ V_16 ] -> V_25 ; V_17 ++ ) {
F_23 ( V_5 , V_119 , V_429 -> V_24 [ V_16 ] ) ;
if ( V_426 -> V_431 )
...
V_442 |= V_123 -> V_124 -> V_137 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_444 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_37 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_445 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_446 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_447 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_402 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_448 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_223 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_449 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_450 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_451 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_452 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_453 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_454 [ V_16 ] ;
for ( V_16 = 0 ; V_16 < F_77 ( V_455 ) ; V_16 ++ )
V_442 |= V_123 -> V_124 -> V_456 [ V_16 ] ;
return ! ! V_442 ;
}
...
int F_80 ( struct V_12 * V_5 , unsigned int V_458 )
{
struct V_425 * V_426 = V_5 -> V_131 ;
struct V_19 * V_20 ;
...
F_82 ( & V_5 -> V_418 , F_55 ) ;
if ( ! V_458 ) {
for ( V_16 = 0 ; V_16 < V_5 -> V_459 ; V_16 ++ ) {
struct V_460 * V_461 = & V_5 -> V_462 [ V_16 ] ;
if ( V_461 -> type == V_463 ||
V_461 -> type == V_464 )
if ( F_83 ( V_461 -> V_2 ) )
break;
