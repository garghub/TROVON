...
int F_67 ( struct V_64 * V_65 , const char * V_93 )
{
struct V_52 * V_53 = NULL ;
struct V_94 V_95 ;
struct V_87 * V_88 ;
...
F_70 (note, &sdtlist, note_list) {
V_14 = snprintf ( V_96 , 64 , L_35 , V_88 -> V_97 ) ;
if ( V_14 < 0 )
break;
V_53 = F_64 ( V_65 , V_96 , V_88 -> V_98 ) ;
if ( ! V_53 ) {
V_53 = F_37 ( NULL ) ;
if ( ! V_53 ) {
V_14 = - V_51 ;
...
V_53 -> V_76 = true ;
V_14 = F_71 ( & V_53 -> V_57 , L_36 , V_96 ,
V_88 -> V_98 , V_88 -> V_98 ) ;
if ( V_14 < 0 )
break;
V_53 -> V_56 . V_46 = F_52 ( V_88 -> V_98 ) ;
V_53 -> V_56 . V_45 = F_52 ( V_96 ) ;
F_54 ( & V_53 -> V_54 , & V_65 -> V_77 ) ;
}
V_14 = F_71 ( & V_12 , L_37 ,
V_96 , V_88 -> V_98 , V_93 ,
...
static int F_73 ( struct V_52 * V_53 , int V_22 )
{
struct V_40 * V_99 ;
struct V_100 V_101 ;
struct V_102 V_103 [ 3 ] ;
const char * V_104 = V_53 -> V_76 ? L_38 : L_39 ;
int V_14 ;
V_14 = F_74 ( V_22 , & V_101 ) ;
if ( V_14 < 0 )
return V_14 ;
F_7 ( L_40 , V_104 , V_53 -> V_57 ) ;
V_103 [ 0 ] . V_105 = ( void * ) V_104 ; V_103 [ 0 ] . V_106 = 1 ;
V_103 [ 1 ] . V_105 = V_53 -> V_57 ; V_103 [ 1 ] . V_106 = strlen ( V_53 -> V_57 ) ;
V_103 [ 2 ] . V_105 = ( void * ) L_41 ; V_103 [ 2 ] . V_106 = 1 ;
V_14 = F_75 ( V_22 , V_103 , 3 ) ;
if ( V_14 < ( int ) V_103 [ 1 ] . V_106 + 2 )
goto V_107;
F_20 (snode, entry->tevlist) {
V_103 [ 0 ] . V_105 = ( void * ) V_99 -> V_44 ;
V_103 [ 0 ] . V_106 = strlen ( V_99 -> V_44 ) ;
V_103 [ 1 ] . V_105 = ( void * ) L_41 ; V_103 [ 1 ] . V_106 = 1 ;
V_14 = F_75 ( V_22 , V_103 , 2 ) ;
if ( V_14 < ( int ) V_103 [ 0 ] . V_106 + 1 )
goto V_107;
}
return 0 ;
V_107:
if ( V_14 > 0 )
V_14 = - 1 ;
if ( F_76 ( V_22 , V_101 . V_108 ) < 0 )
V_14 = - 2 ;
return V_14 ;
}
int F_77 ( struct V_64 * V_65 )
{
struct V_52 * V_53 ;
int V_14 = 0 ;
V_14 = F_78 ( V_65 -> V_22 , 0 , V_109 ) ;
if ( V_14 < 0 )
goto V_75;
V_14 = F_76 ( V_65 -> V_22 , 0 ) ;
if ( V_14 < 0 )
goto V_75;
F_63 (entry, pcache) {
V_14 = F_73 ( V_53 , V_65 -> V_22 ) ;
F_7 ( L_42 , V_14 ) ;
if ( V_14 < 0 )
break;
}
...
static bool F_79 ( struct V_52 * V_53 ,
struct V_47 * V_48 )
{
char V_12 [ 128 ] , * V_110 = V_53 -> V_57 ;
if ( V_53 -> V_56 . V_46 ) {
snprintf ( V_12 , 128 , L_17 , V_53 -> V_56 . V_45 , V_53 -> V_56 . V_46 ) ;
V_110 = V_12 ;
}
return F_29 ( V_48 , V_110 ) ;
}
int F_80 ( struct V_64 * V_65 ,
struct V_47 * V_48 )
{
struct V_52 * V_53 , * V_111 ;
...
F_20 (nd, bidlist) {
V_65 = F_60 ( V_113 -> V_44 ) ;
if ( ! V_65 )
continue;
if ( ! F_34 ( & V_65 -> V_77 ) ) {
V_12 = F_86 ( V_113 -> V_44 ) ;
printf ( L_47 , V_12 , V_113 -> V_44 ) ;
free ( V_12 ) ;
F_82 ( V_65 , V_48 ) ;
}
F_59 ( V_65 ) ;
...
bool F_87 ( enum V_114 type )
{
T_1 * V_31 ;
char * V_12 = NULL ;
T_2 V_115 = 0 ;
bool V_116 = false ;
bool V_14 = V_117 [ type ] . V_118 ;
if ( type >= V_119 )
return false ;
if ( V_14 || V_117 [ type ] . V_120 )
return V_14 ;
if ( F_71 ( & V_12 , L_48 , V_15 ) < 0 )
return V_14 ;
V_31 = fopen ( V_12 , L_15 ) ;
if ( ! V_31 )
goto V_121;
F_36 ( & V_12 ) ;
while ( F_88 ( & V_12 , & V_115 , V_31 ) > 0 && ! V_14 ) {
if ( ! V_116 ) {
V_116 = ! ! strstr ( V_12 , L_49 ) ;
if ( ! V_116 )
continue;
} else if ( strstr ( V_12 , L_50 ) != V_12 )
break;
V_14 = F_89 ( V_12 , V_117 [ type ] . V_122 ) ;
}
V_117 [ type ] . V_120 = true ;
V_117 [ type ] . V_118 = V_14 ;
fclose ( V_31 ) ;
V_121:
free ( V_12 ) ;
return V_14 ;
