...
{
int V_41 = - 1 ;
F_78 ( sizeof( struct V_148 ) > F_79 ( struct V_149 , V_150 ) ) ;
F_80 ( & V_151 , sizeof( V_151 ) ) ;
V_151 |= V_152 ;
F_80 ( & V_153 . V_154 ,
sizeof( V_153 . V_154 ) ) ;
V_153 . V_154 &= 0x3fffffff ;
if ( V_153 . V_154 == 0 )
V_153 . V_154 = 1 ;
V_41 = - V_124 ;
V_155 = F_81 (
...
#ifdef F_90
F_91 ( L_28 , 0 , V_114 . V_168 , & V_169 ) ;
F_91 ( L_29 , 0 , V_114 . V_168 ,
& V_170 ) ;
#endif
return 0 ;
V_167:
...
F_102 ( F_2 ( & V_172 ) , == , 0 ) ;
F_103 () ;
F_104 ( L_29 , V_114 . V_168 ) ;
F_104 ( L_28 , V_114 . V_168 ) ;
F_96 ( V_146 ) ;
F_95 () ;
F_97 ( V_155 ) ;
F_26 ( L_30 ) ;
