...
{
return V_8 -> V_9 == V_303 ;
}
static struct V_5 * F_96 ( struct V_304 * V_305 )
{
...
static void F_108 ( struct V_294 * V_8 )
{
struct V_287 * V_288 = V_8 -> V_287 ;
struct V_289 * V_290 ;
if ( ! V_288 || V_288 -> V_299 != & V_312 )
...
static struct V_310 * F_111 ( struct V_294 * V_8 )
{
struct V_310 * V_311 ;
if ( F_112 ( V_8 ) )
V_311 = F_113 ( V_8 ) ;
...
static int F_117 ( struct V_294 * V_8 , struct V_319 * args )
{
return F_118 ( V_8 , args -> args , 1 ) ;
}
...
int V_19 ;
F_70 ( & V_6 -> V_94 . V_102 ) ;
V_19 = F_119 ( V_6 , & V_6 -> V_94 . V_15 , V_332 ,
V_333 , V_36 ) ;
if ( V_19 )
return V_19 ;
V_19 = F_119 ( V_6 , & V_6 -> V_197 . V_15 , V_334 ,
V_335 , V_199 ) ;
if ( V_19 )
return V_19 ;
if ( ! ( V_6 -> V_100 & V_336 ) )
return 0 ;
return F_119 ( V_6 , & V_6 -> V_220 . V_15 , V_337 ,
V_338 , V_221 ) ;
}
...
V_115 -> V_189 = F_122 ( V_6 -> V_8 , V_46 , V_193 ) ;
if ( ! V_115 -> V_189 ) {
F_32 ( V_6 -> V_8 , L_38 ) ;
return - V_195 ;
}
...
V_46 = F_124 ( V_46 , V_6 -> V_341 - V_190 ) ;
}
V_115 -> V_309 = 1 << V_46 ;
V_46 += V_190 ;
if ( V_46 < V_6 -> V_341 )
...
static int F_129 ( struct V_5 * V_6 , T_1 V_104 ,
unsigned int V_355 , unsigned int V_356 )
{
T_1 V_339 ;
F_130 ( V_104 , V_6 -> V_225 + V_355 ) ;
return F_131 ( V_6 -> V_225 + V_356 , V_339 , V_339 == V_104 ,
1 , V_25 ) ;
}
static int F_132 ( struct V_5 * V_6 , T_1 V_357 , T_1 V_358 )
{
int V_19 ;
T_1 V_339 , V_359 * V_360 = V_6 -> V_225 + V_361 ;
V_19 = F_131 ( V_360 , V_339 , ! ( V_339 & V_362 ) ,
1 , V_25 ) ;
if ( V_19 )
return V_19 ;
V_339 &= ~ V_358 ;
V_339 |= V_357 ;
F_130 ( V_339 | V_362 , V_360 ) ;
return F_131 ( V_360 , V_339 , ! ( V_339 & V_362 ) ,
1 , V_25 ) ;
}
static void F_133 ( void * V_303 )
{
struct V_294 * V_8 = V_303 ;
F_134 ( V_8 ) ;
}
static void F_135 ( struct V_363 * V_131 , struct V_364 * V_365 )
{
T_9 V_366 ;
struct V_294 * V_8 = F_136 ( V_131 ) ;
struct V_5 * V_6 = F_99 ( V_8 ) ;
T_9 * V_115 = V_367 [ V_131 -> V_368 . V_369 ] ;
V_366 = ( ( ( T_4 ) V_365 -> V_370 ) << 32 ) | V_365 -> V_371 ;
V_366 &= V_372 << V_373 ;
F_137 ( V_366 , V_6 -> V_225 + V_115 [ 0 ] ) ;
F_130 ( V_365 -> V_303 , V_6 -> V_225 + V_115 [ 1 ] ) ;
F_130 ( V_374 , V_6 -> V_225 + V_115 [ 2 ] ) ;
}
...
F_137 ( 0 , V_6 -> V_225 + V_377 ) ;
F_137 ( 0 , V_6 -> V_225 + V_378 ) ;
if ( V_6 -> V_100 & V_336 )
F_137 ( 0 , V_6 -> V_225 + V_379 ) ;
else
V_375 -- ;
if ( ! ( V_6 -> V_100 & V_380 ) )
return;
V_19 = F_139 ( V_8 , V_375 , F_135 ) ;
if ( V_19 ) {
F_35 ( V_8 , L_42 ) ;
return;
}
...
{
int V_19 ;
V_19 = F_129 ( V_6 , 0 , V_392 , V_393 ) ;
if ( V_19 )
F_32 ( V_6 -> V_8 , L_53 ) ;
return V_19 ;
}
static int F_145 ( struct V_5 * V_6 , bool V_151 )
{
int V_19 ;
T_1 V_339 , V_394 ;
struct V_35 V_34 ;
...
( V_398 << V_402 ) |
( V_398 << V_403 ) ;
F_130 ( V_339 , V_6 -> V_225 + V_404 ) ;
V_339 = V_405 | V_406 | V_407 ;
F_130 ( V_339 , V_6 -> V_225 + V_408 ) ;
F_137 ( V_6 -> V_188 . V_354 ,
V_6 -> V_225 + V_409 ) ;
F_130 ( V_6 -> V_188 . V_349 ,
V_6 -> V_225 + V_410 ) ;
F_137 ( V_6 -> V_94 . V_15 . V_326 , V_6 -> V_225 + V_411 ) ;
F_130 ( V_6 -> V_94 . V_15 . V_16 , V_6 -> V_225 + V_332 ) ;
F_130 ( V_6 -> V_94 . V_15 . V_17 , V_6 -> V_225 + V_333 ) ;
V_394 = V_412 ;
V_19 = F_129 ( V_6 , V_394 , V_392 ,
V_393 ) ;
if ( V_19 ) {
F_32 ( V_6 -> V_8 , L_55 ) ;
return V_19 ;
...
V_34 . V_37 = V_87 ;
F_34 ( V_6 , & V_34 ) ;
F_137 ( V_6 -> V_197 . V_15 . V_326 , V_6 -> V_225 + V_414 ) ;
F_130 ( V_6 -> V_197 . V_15 . V_16 , V_6 -> V_225 + V_334 ) ;
F_130 ( V_6 -> V_197 . V_15 . V_17 , V_6 -> V_225 + V_335 ) ;
V_394 |= V_415 ;
V_19 = F_129 ( V_6 , V_394 , V_392 ,
V_393 ) ;
if ( V_19 ) {
...
if ( V_6 -> V_100 & V_336 ) {
F_137 ( V_6 -> V_220 . V_15 . V_326 ,
V_6 -> V_225 + V_416 ) ;
F_130 ( V_6 -> V_220 . V_15 . V_16 ,
V_6 -> V_225 + V_337 ) ;
F_130 ( V_6 -> V_220 . V_15 . V_17 ,
V_6 -> V_225 + V_338 ) ;
V_394 |= V_417 ;
V_19 = F_129 ( V_6 , V_394 , V_392 ,
V_393 ) ;
...
T_1 V_339 ;
bool V_419 ;
V_339 = F_11 ( V_6 -> V_225 + V_420 ) ;
if ( ( V_339 & V_421 << V_422 ) == V_423 )
V_6 -> V_100 |= V_286 ;
if ( V_339 & V_424 )
V_6 -> V_100 |= V_425 ;
switch ( V_339 & V_426 << V_427 ) {
case V_428 :
V_6 -> V_100 |= V_429 | V_430 ;
break;
#ifdef F_42
case V_431 :
V_6 -> V_100 |= V_430 ;
...
if ( F_147 ( V_433 ) && V_339 & V_434 )
V_6 -> V_100 |= V_336 ;
if ( F_147 ( F_48 ) && V_339 & V_435 )
V_6 -> V_100 |= V_436 ;
if ( V_339 & V_437 )
V_6 -> V_100 |= V_101 ;
if ( V_339 & V_438 )
...
V_6 -> V_94 . V_15 . V_324 = F_124 ( ( T_1 ) V_458 ,
V_339 >> V_459 & V_460 ) ;
if ( ! V_6 -> V_94 . V_15 . V_324 ) {
F_32 ( V_6 -> V_8 , L_68 ) ;
return - V_296 ;
}
V_6 -> V_197 . V_15 . V_324 = F_124 ( ( T_1 ) V_461 ,
V_339 >> V_462 & V_463 ) ;
V_6 -> V_220 . V_15 . V_324 = F_124 ( ( T_1 ) V_464 ,
V_339 >> V_465 & V_466 ) ;
...
if ( F_149 ( V_6 -> V_8 , F_150 ( V_6 -> V_267 ) ) )
F_35 ( V_6 -> V_8 ,
L_70 ) ;
V_6 -> V_266 = F_151 ( V_6 -> V_266 , V_6 -> V_267 ) ;
F_54 ( V_6 -> V_8 , L_71 ,
...
bool V_151 = true ;
T_1 V_498 ;
if ( F_153 ( V_8 -> V_9 , L_72 , & V_498 ) )
F_32 ( V_8 , L_73 ) ;
else if ( V_498 != 1 )
F_32 ( V_8 , L_74 , V_498 ) ;
else
V_151 = false ;
V_6 = F_122 ( V_8 , sizeof( * V_6 ) , V_193 ) ;
if ( ! V_6 ) {
F_32 ( V_8 , L_75 ) ;
return - V_195 ;
}
V_6 -> V_8 = V_8 ;
V_497 = F_154 ( V_495 , V_499 , 0 ) ;
if ( F_155 ( V_497 ) + 1 < V_500 ) {
F_32 ( V_8 , L_76 , V_497 ) ;
return - V_86 ;
}
V_6 -> V_225 = F_156 ( V_8 , V_497 ) ;
if ( F_105 ( V_6 -> V_225 ) )
return F_157 ( V_6 -> V_225 ) ;
V_196 = F_158 ( V_495 , L_77 ) ;
if ( V_196 > 0 )
V_6 -> V_197 . V_15 . V_196 = V_196 ;
V_196 = F_158 ( V_495 , L_78 ) ;
if ( V_196 > 0 )
V_6 -> V_220 . V_15 . V_196 = V_196 ;
V_196 = F_158 ( V_495 , L_79 ) ;
if ( V_196 > 0 )
V_6 -> V_94 . V_15 . V_196 = V_196 ;
V_196 = F_158 ( V_495 , L_80 ) ;
if ( V_196 > 0 )
V_6 -> V_383 = V_196 ;
F_3 ( V_6 ) ;
V_19 = F_146 ( V_6 ) ;
...
return V_19 ;
F_159 ( V_495 , V_6 ) ;
V_19 = F_145 ( V_6 , V_151 ) ;
if ( V_19 )
return V_19 ;
F_160 ( V_8 -> V_9 , & V_312 ) ;
#ifdef F_161
if ( V_501 . V_502 != & V_312 ) {
F_162 () ;
V_19 = F_163 ( & V_501 , & V_312 ) ;
if ( V_19 )
return V_19 ;
}
#endif
#ifdef F_164
if ( V_503 . V_502 != & V_312 ) {
V_19 = F_163 ( & V_503 , & V_312 ) ;
if ( V_19 )
return V_19 ;
}
#endif
if ( V_504 . V_502 != & V_312 ) {
V_19 = F_163 ( & V_504 , & V_312 ) ;
if ( V_19 )
return V_19 ;
}
return 0 ;
}
static int F_165 ( struct V_494 * V_495 )
{
struct V_5 * V_6 = F_166 ( V_495 ) ;
F_59 ( V_6 ) ;
return 0 ;
}
...
static int T_11 F_171 ( struct V_304 * V_305 )
{
int V_19 = F_167 () ;
if ( V_19 )
return V_19 ;
if ( ! F_172 ( V_305 , NULL , V_504 . V_506 ) )
return - V_300 ;
return 0 ;
}
