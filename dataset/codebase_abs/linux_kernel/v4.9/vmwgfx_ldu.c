...
V_107 = sizeof( * V_110 ) * V_105 ;
V_110 = F_47 ( V_8 , V_107 ) ;
if ( F_48 ( V_110 == NULL ) ) {
F_17 ( L_8 ) ;
return - V_73 ;
}
memset ( V_110 , 0 , V_107 ) ;
for ( V_17 = 0 ; V_17 < V_105 ; V_17 ++ , V_104 += V_106 ) {
V_110 [ V_17 ] . V_108 = V_111 ;
V_110 [ V_17 ] . V_109 . V_23 = V_104 -> V_112 ;
V_110 [ V_17 ] . V_109 . V_26 = V_104 -> y1 ;
V_110 [ V_17 ] . V_109 . V_33 = V_104 -> V_113 - V_104 -> V_112 ;
V_110 [ V_17 ] . V_109 . V_34 = V_104 -> V_114 - V_104 -> y1 ;
}
F_49 ( V_8 , V_107 ) ;
return 0 ;
}
