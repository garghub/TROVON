...
static int F_82 ( struct V_157 * V_158 , struct V_159 * V_160 )
{
...
static int F_86 ( struct V_26 * V_26 , struct V_157 * V_158 )
{
struct V_140 * V_141 = F_73 ( V_26 ) ;
struct V_13 * V_14 = F_64 ( V_26 -> V_151 , struct V_13 ,
V_152 ) ;
...
static int F_90 ( struct V_62 * V_63 ,
struct V_172 * V_173 )
{
struct V_13 * V_14 = (struct V_13 * ) V_63 -> V_64 -> V_65 ;
struct V_15 * V_16 = & V_14 -> V_16 -> V_16 ;
...
V_26 = F_96 ( V_141 , & V_14 -> V_152 , & V_176 ) ;
if ( F_27 ( V_176 < 0 ) ) {
V_34 = - V_87 ;
F_23 ( V_16 , L_55 , V_22 ) ;
goto V_139;
}
V_142 = F_97 ( V_173 -> V_5 . V_179 + 1 ) ;
...
V_173 -> V_5 . V_184 = 0 ;
V_173 -> V_6 = V_27 -> V_28 ;
V_173 -> V_186 = V_67 -> V_101 ;
V_173 -> V_187 = sizeof( V_49 -> V_136 -> V_188 [ 0 ] . V_189 ) ;
V_173 -> V_190 = V_67 -> V_99 ;
V_173 -> V_191 = V_63 -> V_64 -> V_192 * V_193 ;
...
F_19 ( V_27 ) ;
F_10 ( V_16 , L_57 ,
V_22 , V_28 , V_176 , V_173 -> V_186 , V_34 , V_173 -> V_190 ) ;
return V_34 ;
V_139:
if ( ! F_94 ( V_141 ) ) {
F_99 ( V_141 ) ;
...
struct V_90 V_91 = { 0 } ;
int V_34 = 0 ;
V_34 = F_34 ( ( const T_4 * ) & V_210 -> V_212 ,
V_213 , & V_91 ) ;
if ( ! V_34 ) {
F_23 ( V_16 , L_65 , V_22 ) ;
V_34 = - V_123 ;
...
V_45:
F_10 ( V_16 , L_68 , V_22 ,
V_91 . V_92 , V_91 . V_97 , V_91 . V_214 , V_34 ) ;
return V_34 ;
}
static int F_113 ( struct V_62 * V_63 ,
struct V_209 * V_210 )
{
int V_34 = 0 ;
struct V_24 * V_27 = NULL ;
...
struct V_103 * V_105 = NULL ;
T_6 V_104 = V_210 -> V_7 ;
T_1 V_28 = F_16 ( V_210 -> V_6 ) ,
V_25 = V_210 -> V_6 ;
T_1 V_190 = 0 ;
F_10 ( V_16 , L_69
L_70 , V_22 , V_28 , V_210 -> V_7 ,
V_210 -> V_215 , V_210 -> V_5 . V_179 ) ;
...
break;
case V_129 :
V_190 = ( ( T_1 ) V_105 -> V_217 * V_218 * V_67 -> V_101 ) ;
V_190 /= V_219 ;
V_190 -- ;
break;
default:
...
F_19 ( V_27 ) ;
F_10 ( V_16 , L_72 ,
V_22 , V_34 , V_210 -> V_190 ) ;
return V_34 ;
}
static char * F_114 ( int V_220 )
{
switch ( V_220 ) {
case V_221 :
return F_115 ( V_221 ) ;
...
static int F_116 ( struct V_62 * V_63 , void * V_29 )
{
struct V_13 * V_14 = (struct V_13 * ) V_63 -> V_64 -> V_65 ;
struct V_15 * V_16 = & V_14 -> V_16 -> V_16 ;
struct V_49 * V_49 = V_14 -> V_49 ;
struct V_32 * V_33 = V_63 -> V_65 ;
struct V_66 * V_67 = V_33 -> V_41 ;
struct V_231 * V_232 = (struct V_231 * ) V_29 ;
T_1 V_28 = F_16 ( V_232 -> V_6 ) ,
V_25 = V_232 -> V_6 ;
T_1 V_233 = 0 ;
T_1 V_190 = 0 ;
T_1 V_7 = - 1 ;
T_5 V_234 = F_117 ( V_63 -> V_178 ) ;
int V_34 = 0 ;
struct V_24 * V_27 = NULL ;
struct V_103 * V_105 = NULL ;
F_39 ( L_74 , V_22 , V_28 , V_233 ) ;
...
V_7 = ( V_105 - V_27 -> V_58 ) ;
F_42 ( V_105 , V_33 -> V_111 [ V_63 -> V_178 ] , V_27 -> V_143 , V_234 ) ;
F_51 ( V_49 , V_28 , V_7 , V_236 ) ;
V_190 = V_67 -> V_99 ;
V_232 -> V_5 . V_184 = 0 ;
V_232 -> V_190 = V_190 ;
V_232 -> V_7 = V_7 ;
...
static int F_118 ( struct V_62 * V_63 , int V_220 )
{
struct V_13 * V_14 = (struct V_13 * ) V_63 -> V_64 -> V_65 ;
struct V_15 * V_16 = & V_14 -> V_16 -> V_16 ;
struct V_32 * V_33 = V_63 -> V_65 ;
...
int F_119 ( struct V_62 * V_63 , int V_220 , void T_7 * V_29 )
{
typedef int (* F_120) ( struct V_62 * , void * );
struct V_13 * V_14 = (struct V_13 * ) V_63 -> V_64 -> V_65 ;
struct V_15 * V_16 = & V_14 -> V_16 -> V_16 ;
struct V_49 * V_49 = V_14 -> V_49 ;
struct V_237 * V_5 ;
char V_238 [ sizeof( union V_239 ) ] ;
T_8 V_128 = 0 ;
bool V_240 = false ;
int V_241 ;
int V_34 = 0 ;
struct V_242 * V_243 = V_63 -> V_64 ;
F_120 V_244 = NULL ;
static const struct {
T_8 V_128 ;
F_120 V_245 ;
} V_246 [] = {
{ sizeof( struct V_172 ) , ( F_120 ) F_90 } ,
{ sizeof( struct V_231 ) , F_116 } ,
{ sizeof( struct V_1 ) , ( F_120 ) F_53 } ,
{ sizeof( struct V_8 ) , ( F_120 ) F_71 } ,
{ sizeof( struct V_209 ) , ( F_120 ) F_113 } ,
{ sizeof( struct V_199 ) , ( F_120 ) F_105 } ,
{ sizeof( struct V_247 ) , ( F_120 ) V_248 } ,
{ sizeof( struct V_249 ) , V_250 } ,
{ sizeof( struct V_3 ) , ( F_120 ) V_251 } ,
{ sizeof( struct V_252 ) , ( F_120 ) V_253 } ,
} ;
F_31 ( & V_14 -> V_84 ) ;
if ( V_49 -> V_254 )
switch ( V_220 ) {
...
case V_228 :
F_10 ( V_16 , L_81 ,
V_22 , F_114 ( V_220 ) , V_220 , V_243 -> V_256 ,
V_63 -> V_178 , V_63 -> V_257 , V_63 -> V_258 ) ;
V_34 = F_118 ( V_63 , V_220 ) ;
if ( F_27 ( V_34 ) )
goto V_255;
case V_230 :
V_240 = true ;
V_241 = F_121 ( V_220 ) - F_121 ( V_221 ) ;
V_128 = V_246 [ V_241 ] . V_128 ;
V_244 = V_246 [ V_241 ] . V_245 ;
if ( F_17 ( V_244 ) )
break;
default:
V_34 = - V_123 ;
...
if ( F_27 ( F_122 ( & V_238 , V_29 , V_128 ) ) ) {
F_23 ( V_16 , L_82
L_83 ,
V_22 , V_128 , V_220 , F_114 ( V_220 ) , V_29 ) ;
V_34 = - V_259 ;
goto V_255;
}
V_5 = (struct V_237 * ) & V_238 ;
if ( V_5 -> V_260 != V_261 ) {
F_10 ( V_16 , L_84 ,
V_22 , V_5 -> V_260 , F_114 ( V_220 ) ) ;
V_34 = - V_123 ;
goto V_255;
}
if ( V_5 -> V_262 [ 0 ] || V_5 -> V_262 [ 1 ] || V_5 -> V_262 [ 2 ] || V_5 -> V_184 ) {
F_10 ( V_16 , L_85 , V_22 ) ;
V_34 = - V_123 ;
goto V_255;
}
V_34 = V_244 ( V_63 , ( void * ) & V_238 ) ;
if ( F_17 ( ! V_34 ) )
if ( F_27 ( F_123 ( V_29 , & V_238 , V_128 ) ) ) {
F_23 ( V_16 , L_86
L_83 ,
V_22 , V_128 , V_220 , F_114 ( V_220 ) , V_29 ) ;
V_34 = - V_259 ;
...
F_23 ( V_16 , L_87
L_88 , V_22 ,
F_114 ( V_220 ) , V_220 , V_243 -> V_256 ,
V_63 -> V_178 , V_63 -> V_257 , V_63 -> V_258 , V_34 ) ;
else
F_10 ( V_16 , L_87
L_88 , V_22 , F_114 ( V_220 ) ,
V_220 , V_243 -> V_256 , V_63 -> V_178 , V_63 -> V_257 ,
V_63 -> V_258 , V_34 ) ;
return V_34 ;
}
