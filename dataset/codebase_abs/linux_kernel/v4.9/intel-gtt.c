...
unsigned int V_69 )
{
V_12 . V_50 -> V_51 ( V_48 , V_170 , V_69 ) ;
if ( V_12 . V_50 -> V_171 )
V_12 . V_50 -> V_171 () ;
}
...
T_4 V_48 = F_90 ( V_7 ) + ( V_173 << V_49 ) ;
V_12 . V_50 -> V_51 ( V_48 , V_174 , V_69 ) ;
V_174 ++ ;
}
}
F_32 () ;
}
static void F_91 ( unsigned int V_175 ,
unsigned int V_3 ,
struct V_1 * * V_2 ,
unsigned int V_69 )
{
int V_8 , V_174 ;
for ( V_8 = 0 , V_174 = V_175 ; V_8 < V_3 ; V_8 ++ , V_174 ++ ) {
...
static int F_92 ( struct V_44 * V_20 ,
T_3 V_45 , int type )
{
int V_142 = - V_46 ;
if ( V_12 . V_167 ) {
int V_176 = V_12 . V_81 / V_11 ;
int V_177 = V_12 . V_128 ;
F_93 ( V_176 , V_177 - V_176 ) ;
V_12 . V_167 = false ;
}
if ( V_82 == 1 && type == V_72 )
...
void F_93 ( unsigned int V_175 , unsigned int V_3 )
{
unsigned int V_8 ;
for ( V_8 = V_175 ; V_8 < ( V_175 + V_3 ) ; V_8 ++ ) {
V_12 . V_50 -> V_51 ( V_12 . V_66 ,
V_8 , 0 ) ;
}
F_32 () ;
}
static int F_94 ( struct V_44 * V_20 ,
T_3 V_45 , int type )
{
if ( V_20 -> V_21 == 0 )
return 0 ;
...
static struct V_44 * F_95 ( T_5 V_52 ,
int type )
{
struct V_44 * V_53 ;
if ( type == V_72 && V_82 == 1 ) {
...
{
int V_142 ;
V_142 = F_97 ( V_12 . V_83 -> V_181 , & V_12 . V_182 , V_11 ,
V_11 , V_183 , 0 ,
V_184 , V_12 . V_83 ) ;
return V_142 ;
}
...
int V_142 ;
T_1 V_185 ;
F_56 ( V_12 . V_83 , V_186 , & V_185 ) ;
if ( ! ( V_185 & 0x1 ) ) {
F_96 () ;
V_12 . V_187 = 1 ;
F_99 ( V_12 . V_83 , V_186 , ( V_12 . V_182 . V_176 & 0xffffffff ) | 0x1 ) ;
} else {
V_185 &= ~ 1 ;
V_12 . V_187 = 1 ;
V_12 . V_182 . V_176 = V_185 ;
V_12 . V_182 . V_177 = V_185 + V_11 ;
V_142 = F_100 ( & V_188 , & V_12 . V_182 ) ;
if ( V_142 )
V_12 . V_187 = 0 ;
}
}
...
T_1 V_189 , V_190 ;
int V_142 ;
F_56 ( V_12 . V_83 , V_191 + 4 , & V_189 ) ;
F_56 ( V_12 . V_83 , V_191 , & V_190 ) ;
if ( ! ( V_190 & 0x1 ) ) {
F_96 () ;
V_12 . V_187 = 1 ;
F_99 ( V_12 . V_83 , V_191 + 4 ,
F_102 ( V_12 . V_182 . V_176 ) ) ;
F_99 ( V_12 . V_83 , V_191 , ( V_12 . V_182 . V_176 & 0xffffffff ) | 0x1 ) ;
} else {
T_9 V_192 ;
V_190 &= ~ 0x1 ;
V_192 = ( ( T_9 ) V_189 << 32 ) | V_190 ;
V_12 . V_187 = 1 ;
V_12 . V_182 . V_176 = V_192 ;
V_12 . V_182 . V_177 = V_192 + V_11 ;
V_142 = F_100 ( & V_188 , & V_12 . V_182 ) ;
if ( V_142 )
V_12 . V_187 = 0 ;
}
...
if ( V_82 == 6 )
return;
V_12 . V_182 . V_193 = L_12 ;
V_12 . V_182 . V_69 = V_194 ;
if ( V_127 || V_82 >= 4 ) {
F_101 () ;
} else {
F_98 () ;
...
if ( V_12 . V_182 . V_176 )
V_12 . V_195 = F_104 ( V_12 . V_182 . V_176 , V_11 ) ;
if ( ! V_12 . V_195 )
F_81 ( & V_12 . V_13 -> V_42 ,
L_13 ) ;
}
...
static int F_110 ( T_6 V_85 )
{
struct V_198 * V_199 ;
V_199 = F_111 ( V_200 , V_85 , NULL ) ;
if ( V_199 && F_112 ( V_199 -> V_201 ) != 0 ) {
V_199 = F_111 ( V_200 ,
V_85 , V_199 ) ;
}
if ( ! V_199 )
...
int F_113 ( struct V_198 * V_202 , struct V_198 * V_203 ,
struct V_23 * V_24 )
{
int V_8 , V_204 ;
for ( V_8 = 0 ; V_205 [ V_8 ] . V_193 != NULL ; V_8 ++ ) {
if ( V_203 ) {
if ( V_203 -> V_85 ==
V_205 [ V_8 ] . V_206 ) {
V_12 . V_13 = F_114 ( V_203 ) ;
V_12 . V_50 =
V_205 [ V_8 ] . V_207 ;
break;
}
} else if ( F_110 ( V_205 [ V_8 ] . V_206 ) ) {
V_12 . V_50 =
V_205 [ V_8 ] . V_207 ;
break;
}
...
if ( V_12 . V_210 ++ )
return 1 ;
V_12 . V_83 = F_114 ( V_202 ) ;
F_27 ( & V_202 -> V_42 , L_14 , V_205 [ V_8 ] . V_193 ) ;
V_204 = V_12 . V_50 -> V_211 ;
if ( F_115 ( V_12 . V_13 , F_116 ( V_204 ) ) )
F_81 ( & V_12 . V_13 -> V_42 ,
L_15 , V_204 ) ;
else
F_117 ( V_12 . V_13 ,
...
void F_119 ( T_9 * V_212 , T_5 * V_81 ,
T_2 * V_213 , T_9 * V_214 )
{
* V_212 = V_12 . V_145 << V_49 ;
* V_81 = V_12 . V_81 ;
* V_213 = V_12 . V_152 ;
* V_214 = V_12 . V_128 << V_49 ;
}
void F_120 ( void )
{
if ( V_12 . V_50 -> V_171 )
