...
if ( F_41 ( V_60 , V_55 -> V_60 ) )
V_55 -> V_60 = V_60 ;
if ( ! F_41 ( V_59 , V_55 -> V_64 ) && ! V_62 )
return;
F_25 ( & V_19 -> V_47 ) ;
V_16 = F_11 ( V_19 , V_20 ) ;
if ( ! V_16 || ! V_16 -> V_33 )
...
V_6 -> V_41 = V_59 ;
V_6 -> V_36 = V_57 ;
V_6 -> V_13 = F_43 ( V_56 -> V_13 ) ;
for ( V_11 = 0 ; V_11 < V_57 ; V_11 ++ )
V_6 -> V_8 [ V_11 ] = F_44 ( V_56 -> V_8 [ V_11 ] ) ;
V_27 = V_16 -> V_32 ;
F_17 ( V_19 , V_16 ) ;
F_16 ( V_16 , & V_26 , V_27 ) ;
F_23 ( V_19 , F_10 ( V_16 ) ) ;
...
void F_45 ( struct V_2 * V_2 , void * V_52 , int * V_53 ,
struct V_54 * V_55 , int V_3 )
{
struct V_1 * V_19 = V_1 ( V_2 , V_3 ) ;
struct V_5 * V_6 = V_52 ;
...
void F_49 ( struct V_2 * V_2 , V_9 V_20 ,
struct V_54 * V_55 ,
int V_3 )
{
struct V_1 * V_19 = V_1 ( V_2 , V_3 ) ;
...
static void F_50 ( unsigned long V_68 )
{
...
F_30 ( & V_19 -> V_47 ) ;
F_51 ( & V_19 -> V_70 , V_71 + V_19 -> V_72 ) ;
}
int F_52 ( struct V_2 * V_2 , int V_3 )
{
struct F_1 * V_23 = F_1 ( V_2 ) ;
struct V_1 * V_19 ;
struct V_15 * V_22 ;
...
V_22 -> V_18 = true ;
F_33 ( & V_22 -> V_17 ) ;
F_55 ( & V_19 -> V_70 , F_50 , ( unsigned long ) V_19 ) ;
V_19 -> V_72 = F_56 ( V_74 + ( V_23 -> V_75 & 0xffff ) ) ;
F_51 ( & V_19 -> V_70 , V_71 + V_19 -> V_72 ) ;
return 0 ;
}
void F_57 ( struct V_2 * V_2 , int V_3 )
{
struct F_1 * V_23 = F_1 ( V_2 ) ;
struct V_1 * V_19 = V_1 ( V_2 , V_3 ) ;
struct V_15 * V_22 = F_14 ( V_2 , V_3 ) ;
...
int F_60 ( struct V_2 * V_2 , V_9 V_77 )
{
struct F_1 * V_23 = F_1 ( V_2 ) ;
if ( V_77 > V_78 )
return - V_79 ;
...
int F_62 ( struct V_15 * V_16 , struct V_80 * V_81 )
{
struct V_5 * V_6 = V_16 -> V_30 ;
struct V_82 * V_83 ;
void * V_84 ;
V_84 = F_63 ( V_81 -> V_85 , V_81 -> V_86 , V_81 -> V_87 , & V_88 ,
V_89 , V_90 ) ;
if ( ! V_84 )
return - V_91 ;
V_83 = F_64 ( V_81 -> V_85 , V_92 ) ;
if ( ! V_83 )
goto V_93;
if ( F_65 ( V_81 -> V_85 , V_94 , V_16 -> V_20 ) )
goto V_95;
if ( F_65 ( V_81 -> V_85 , V_96 , V_16 -> V_32 ) )
goto V_95;
if ( V_16 -> V_33 )
if ( F_66 ( V_81 -> V_85 , V_97 ) )
goto V_95;
if ( V_16 -> V_34 )
if ( F_66 ( V_81 -> V_85 , V_98 ) )
goto V_95;
if ( V_16 -> V_18 )
if ( F_66 ( V_81 -> V_85 , V_99 ) )
goto V_95;
if ( V_6 ) {
if ( F_65 ( V_81 -> V_85 , V_100 , V_6 -> V_41 ) )
goto V_95;
if ( F_67 ( V_81 -> V_85 , V_101 ,
V_6 -> V_13 , V_102 ) )
goto V_95;
if ( F_68 ( V_81 -> V_85 , V_103 ,
...
int F_73 ( struct V_2 * V_2 , struct V_80 * V_81 ,
V_9 V_3 , V_9 * V_104 )
{
struct V_1 * V_19 = V_1 ( V_2 , V_3 ) ;
struct V_15 * V_16 ;
...
if ( ! V_84 )
return - V_91 ;
V_83 = F_64 ( V_81 -> V_85 , V_109 ) ;
if ( ! V_83 )
goto V_93;
F_47 ( & V_19 -> V_47 ) ;
if ( F_65 ( V_81 -> V_85 , V_110 , V_3 ) )
goto V_95;
if ( F_15 ( V_2 , V_19 ) )
if ( F_66 ( V_81 -> V_85 , V_111 ) )
goto V_95;
if ( F_76 ( V_81 -> V_85 , V_112 , V_105 ) )
goto V_95;
if ( F_65 ( V_81 -> V_85 , V_113 , V_19 -> V_24 ) )
goto V_95;
if ( F_65 ( V_81 -> V_85 , V_114 , V_19 -> V_45 ) )
goto V_95;
F_48 ( & V_19 -> V_47 ) ;
F_69 ( V_81 -> V_85 , V_83 ) ;
F_70 ( V_81 -> V_85 , V_84 ) ;
