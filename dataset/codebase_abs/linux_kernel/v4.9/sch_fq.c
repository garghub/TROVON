...
if ( ! V_41 ) {
V_23 -> V_25 = V_2 -> V_3 ;
if ( ( V_23 == & V_8 -> V_68 ) && V_8 -> V_76 . V_25 ) {
F_7 ( & V_8 -> V_76 , V_2 ) ;
} else {
F_1 ( V_2 ) ;
V_8 -> V_37 ++ ;
...
if ( ! V_8 -> V_48 )
return;
for ( V_90 = 0 ; V_90 < ( 1U << V_8 -> V_50 ) ; V_90 ++ ) {
V_29 = & V_8 -> V_48 [ V_90 ] ;
...
struct V_28 * V_94 , V_49 V_95 ,
struct V_28 * V_96 , V_49 V_97 )
{
...
V_101 = & V_96 [ F_18 ( ( V_49 ) ( long ) V_102 -> V_31 , V_97 ) ] ;
V_99 = & V_101 -> V_9 ;
V_12 = NULL ;
while ( * V_99 ) {
V_12 = * V_99 ;
...
{
void * V_106 ;
V_106 = F_48 ( V_104 , V_107 | V_108 | V_56 , V_105 ) ;
if ( ! V_106 )
...
V_111 = V_8 -> V_48 ;
if ( V_111 )
F_45 ( V_8 , V_111 , V_8 -> V_50 , V_110 , log ) ;
V_8 -> V_48 = V_110 ;
V_8 -> V_50 = log ;
F_55 ( V_59 ) ;
F_50 ( V_111 ) ;
...
static int F_56 ( struct V_58 * V_59 , struct V_114 * V_115 )
{
struct V_7 * V_8 = F_26 ( V_59 ) ;
...
if ( V_116 [ V_126 ] )
V_59 -> V_64 = F_58 ( V_116 [ V_126 ] ) ;
if ( V_116 [ V_127 ] )
V_8 -> V_65 = F_58 ( V_116 [ V_127 ] ) ;
if ( V_116 [ V_128 ] ) {
V_49 V_70 = F_58 ( V_116 [ V_128 ] ) ;
if ( V_70 > 0 )
V_8 -> V_70 = V_70 ;
else
V_118 = - V_122 ;
...
static int F_65 ( struct V_58 * V_59 , struct V_114 * V_115 )
{
struct V_7 * V_8 = F_26 ( V_59 ) ;
int V_118 ;
V_59 -> V_64 = 10000 ;
...
F_69 ( & V_8 -> V_81 , V_59 ) ;
if ( V_115 )
V_118 = F_56 ( V_59 , V_115 ) ;
else
V_118 = F_52 ( V_59 , V_8 -> V_50 ) ;
return V_118 ;
}
...
if ( V_138 == NULL )
goto V_140;
if ( F_72 ( V_41 , V_126 , V_59 -> V_64 ) ||
F_72 ( V_41 , V_127 , V_8 -> V_65 ) ||
F_72 ( V_41 , V_128 , V_8 -> V_70 ) ||
F_72 ( V_41 , V_129 , V_8 -> V_54 ) ||
...
F_72 ( V_41 , V_132 ,
V_8 -> V_86 ) ||
F_72 ( V_41 , V_124 , V_8 -> V_50 ) )
goto V_140;
return F_74 ( V_41 , V_138 ) ;
V_140:
return - 1 ;
}
static int F_75 ( struct V_58 * V_59 , struct V_141 * V_142 )
{
struct V_7 * V_8 = F_26 ( V_59 ) ;
struct V_143 V_144 ;
F_54 ( V_59 ) ;
...
V_144 . V_147 = V_8 -> V_67 ;
V_144 . V_20 = V_8 -> V_19 ;
V_144 . V_148 = V_8 -> V_66 ;
V_144 . V_149 = V_8 -> V_89 ;
V_144 . V_150 = V_8 -> V_57 ;
