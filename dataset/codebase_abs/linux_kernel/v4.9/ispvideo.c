...
static int F_109 ( struct V_111 * V_111 )
{
struct V_5 * V_6 = F_61 ( V_111 ) ;
...
static unsigned int F_111 ( struct V_111 * V_111 , T_3 * V_229 )
{
struct V_57 * V_58 = F_64 ( V_111 -> V_227 ) ;
struct V_5 * V_6 = F_61 ( V_111 ) ;
int V_39 ;
F_13 ( & V_6 -> V_110 ) ;
V_39 = F_112 ( & V_58 -> V_60 , V_111 , V_229 ) ;
F_15 ( & V_6 -> V_110 ) ;
return V_39 ;
}
static int F_113 ( struct V_111 * V_111 , struct V_230 * V_231 )
{
struct V_57 * V_58 = F_64 ( V_111 -> V_227 ) ;
return F_114 ( & V_58 -> V_60 , V_231 ) ;
}
int F_115 ( struct V_5 * V_6 , const char * V_118 )
{
const char * V_232 ;
int V_39 ;
switch ( V_6 -> type ) {
...
V_39 = F_116 ( & V_6 -> V_6 . V_28 , 1 , & V_6 -> V_25 ) ;
if ( V_39 < 0 )
return V_39 ;
F_117 ( & V_6 -> V_55 ) ;
F_89 ( & V_6 -> V_238 , 0 ) ;
...
int F_123 ( struct V_5 * V_6 , struct V_248 * V_249 )
{
int V_39 ;
V_6 -> V_6 . V_250 = V_249 ;
V_39 = F_124 ( & V_6 -> V_6 , V_243 , - 1 ) ;
if ( V_39 < 0 )
F_125 ( V_6 -> V_75 -> V_76 ,
L_10 ,
V_251 , V_39 ) ;
