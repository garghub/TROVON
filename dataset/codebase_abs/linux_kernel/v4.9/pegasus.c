...
F_103 ( V_202 , & V_8 -> V_201 ,
V_203 ) ;
F_115 ( & V_216 -> V_6 , L_30 , V_17 -> V_237 ,
V_82 [ V_83 ] . V_237 , V_17 -> V_74 ) ;
return 0 ;
V_236:
F_117 ( V_216 , NULL ) ;
V_235:
...
{
unsigned int V_239 = 0 , V_240 = 0 , V_104 = 0 , V_36 = 0 ;
char * V_241 , * V_237 = NULL ;
if ( ( V_241 = F_129 ( & V_68 , L_32 ) ) != NULL )
V_237 = V_241 ;
if ( ( V_241 = F_129 ( & V_68 , L_32 ) ) != NULL )
...
F_131 ( L_33 ,
V_165 , V_237 , V_239 , V_240 , V_104 ) ;
if ( V_239 > 0x10000 || V_239 == 0 )
return;
if ( V_240 > 0x10000 || V_240 == 0 )
return;
for ( V_36 = 0 ; V_82 [ V_36 ] . V_237 ; V_36 ++ ) ;
V_82 [ V_36 ] . V_237 = V_237 ;
V_82 [ V_36 ] . V_84 = V_239 ;
V_82 [ V_36 ] . V_242 = V_240 ;
V_82 [ V_36 ] . V_234 = V_104 ;
V_218 [ V_36 ] . V_243 = V_244 ;
V_218 [ V_36 ] . V_208 = V_239 ;
V_218 [ V_36 ] . V_210 = V_240 ;
}
