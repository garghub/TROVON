...
T_3 F_84 ( struct V_3 * V_4 , T_3 * V_88 , T_3 V_182 )
{
T_7 V_183 ;
T_7 V_184 ;
...
return F_85 ( V_88 , V_182 , V_103 ,
V_4 -> V_85 , V_184 + 1 ) ;
V_183 = strlen ( V_4 -> V_187 ) ;
if ( V_183 )
return F_85 ( V_88 , V_182 , V_102 ,
V_4 -> V_187 , V_183 + 1 ) ;
if ( V_184 ) {
T_3 V_23 [ V_186 + 1 ] ;
memcpy ( V_23 , V_4 -> V_85 , V_186 ) ;
V_23 [ V_186 ] = '\0' ;
return F_85 ( V_88 , V_182 , V_102 , V_23 ,
sizeof( V_23 ) ) ;
}
return V_182 ;
}
static T_3 F_86 ( struct V_3 * V_4 , T_3 * V_88 , T_3 V_182 )
{
return F_87 ( V_88 , V_182 , V_188 , V_4 -> V_189 ) ;
}
static T_3 F_88 ( struct V_3 * V_4 , T_3 * V_88 )
{
T_3 V_156 = 0 ;
if ( V_4 -> V_189 ) {
V_156 = F_86 ( V_4 , V_88 , V_156 ) ;
}
return F_84 ( V_4 , V_88 , V_156 ) ;
}
static T_3 F_89 ( struct V_3 * V_4 , T_3 V_152 ,
T_3 * V_88 )
{
struct V_154 * V_155 ;
T_5 V_190 ;
...
V_156 += V_155 -> V_156 ;
if ( V_190 & V_193 )
V_156 = F_84 ( V_4 , V_88 , V_156 ) ;
return V_156 ;
}
void F_90 ( struct V_1 * V_2 , T_3 V_152 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_194 V_84 ;
T_3 V_47 ;
...
memset ( & V_84 , 0 , sizeof( V_84 ) ) ;
if ( V_152 )
V_47 = F_89 ( V_4 , V_152 , V_84 . V_87 ) ;
else
V_47 = F_88 ( V_4 , V_84 . V_87 ) ;
if ( V_4 -> V_195 == V_47 &&
...
V_4 -> V_195 = V_47 ;
V_84 . V_196 = V_47 ;
F_46 ( V_2 , V_197 , sizeof( V_84 ) , & V_84 ) ;
}
static T_3 F_91 ( struct V_3 * V_4 , T_3 V_152 , T_3 * V_88 )
{
...
void F_93 ( struct V_1 * V_2 , T_3 V_152 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_205 V_84 ;
T_3 V_47 ;
...
V_4 -> V_203 = V_47 ;
V_84 . V_196 = V_47 ;
F_46 ( V_2 , V_206 , sizeof( V_84 ) , & V_84 ) ;
}
int F_94 ( struct V_3 * V_4 , T_3 V_152 )
{
struct V_1 V_2 ;
F_1 ( & V_2 , V_4 ) ;
F_93 ( & V_2 , V_152 ) ;
...
static void F_95 ( struct V_3 * V_4 , T_3 V_207 , T_4 V_22 )
{
...
static void F_98 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 ,
V_212 . V_211 ) ;
struct V_1 V_2 ;
T_3 V_152 ;
F_4 ( L_4 , V_4 -> V_23 ) ;
...
goto V_214;
F_1 ( & V_2 , V_4 ) ;
F_101 ( V_4 , NULL , & V_2 , V_152 , false ) ;
if ( F_52 ( & V_4 -> V_209 ) )
F_77 ( & V_2 ) ;
F_14 ( & V_2 , NULL ) ;
V_214:
...
int F_97 ( struct V_1 * V_2 , T_3 V_152 ,
bool V_215 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_154 * V_155 = NULL ;
...
void F_101 ( struct V_3 * V_4 , struct V_222 * V_223 ,
...
F_105 ( V_4 ) ;
if ( V_152 && V_4 -> V_153 == V_152 )
V_225 = F_107 ( V_4 , V_152 ) ;
if ( V_152 == 0x00 ) {
F_108 (adv_instance, n, &hdev->adv_instances,
list) {
if ( ! ( V_215 || V_155 -> V_34 ) )
continue;
V_226 = V_155 -> V_152 ;
...
return;
if ( V_225 )
F_97 ( V_2 , V_225 -> V_152 ,
false ) ;
}
static void F_111 ( struct V_1 * V_2 , T_10 * V_227 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
if ( F_48 ( V_4 , V_171 ) ||
F_54 ( V_4 ) ) {
...
F_46 ( V_2 , V_229 , 6 , V_227 ) ;
}
int F_74 ( struct V_1 * V_2 , bool V_230 ,
...
* V_140 = V_233 ;
if ( ! F_113 ( V_4 , V_228 ) &&
! F_114 ( & V_4 -> V_234 , & V_4 -> V_227 ) )
return 0 ;
V_6 = F_115 ( V_4 , V_4 -> V_235 , & V_4 -> V_227 ) ;
if ( V_6 < 0 ) {
F_44 ( L_14 , V_4 -> V_23 ) ;
return V_6 ;
}
F_111 ( V_2 , & V_4 -> V_227 ) ;
V_232 = F_104 ( V_4 -> V_236 * 1000 ) ;
F_103 ( V_4 -> V_19 , & V_4 -> V_237 , V_232 ) ;
return 0 ;
}
if ( V_230 ) {
T_10 V_238 ;
...
if ( F_48 ( V_4 , V_239 ) ||
! F_114 ( & V_4 -> V_126 , V_240 ) ||
( ! F_48 ( V_4 , V_59 ) &&
F_114 ( & V_4 -> V_241 , V_240 ) ) ) {
* V_140 = V_233 ;
if ( F_114 ( & V_4 -> V_241 , & V_4 -> V_234 ) )
F_46 ( V_2 , V_229 , 6 ,
& V_4 -> V_241 ) ;
return 0 ;
}
...
struct V_243 * V_244 ;
V_244 = F_118 ( V_4 , V_245 , & V_130 -> V_126 ) ;
if ( ! V_244 )
return true ;
...
return;
F_46 ( V_2 , V_255 , 1 , & V_248 ) ;
}
static int F_121 ( struct V_1 * V_2 , unsigned long V_41 )
{
F_100 ( V_2 -> V_4 ) ;
F_119 ( V_2 ) ;
F_102 ( V_2 -> V_4 ) ;
...
static void F_122 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 , V_256 ) ;
F_34 ( V_4 , F_121 , 0 , V_257 , NULL ) ;
}
static int F_123 ( struct V_1 * V_2 , unsigned long V_41 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
F_100 ( V_4 ) ;
F_119 ( V_2 ) ;
...
static void F_124 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 ,
F_123 ) ;
T_3 V_207 ;
F_34 ( V_4 , F_123 , 0 , V_257 , & V_207 ) ;
F_125 ( V_4 , V_207 ) ;
}
static T_3 F_126 ( struct V_3 * V_4 )
{
struct V_90 * V_91 ;
T_3 V_258 = 0 ;
F_58 (uuid, &hdev->uuids, list)
...
return;
F_46 ( V_2 , V_264 , sizeof( V_260 ) , V_260 ) ;
}
...
return;
if ( F_48 ( V_4 , V_162 ) ) {
V_84 . V_266 = F_129 ( T_3 , V_4 -> V_266 , 2 ) ;
V_84 . V_267 [ 0 ] = 0x00 ;
V_84 . V_267 [ 1 ] = 0x8b ;
V_84 . V_267 [ 2 ] = 0x9e ;
V_84 . V_267 [ 3 ] = 0x33 ;
...
static int F_130 ( struct V_1 * V_2 , unsigned long V_41 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
F_100 ( V_4 ) ;
if ( F_48 ( V_4 , V_59 ) ) {
...
static void F_131 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 ,
F_130 ) ;
T_3 V_207 ;
F_34 ( V_4 , F_130 , 0 , V_257 , & V_207 ) ;
F_132 ( V_4 , V_207 ) ;
}
void F_133 ( struct V_1 * V_2 , struct V_243 * V_244 ,
T_3 V_269 )
{
switch ( V_244 -> V_78 ) {
case V_246 :
...
if ( V_244 -> type == V_270 ) {
struct V_271 V_84 ;
V_84 . V_272 = F_134 ( V_244 -> V_273 ) ;
V_84 . V_269 = V_269 ;
F_46 ( V_2 , V_274 , sizeof( V_84 ) ,
& V_84 ) ;
} else {
struct V_275 V_276 ;
V_276 . V_273 = F_41 ( V_244 -> V_273 ) ;
V_276 . V_269 = V_269 ;
F_46 ( V_2 , V_277 , sizeof( V_276 ) , & V_276 ) ;
}
V_244 -> V_78 = V_278 ;
break;
case V_279 :
...
static void F_135 ( struct V_3 * V_4 , T_3 V_207 , T_4 V_22 )
{
if ( V_207 )
F_4 ( L_15 , V_207 ) ;
}
int F_136 ( struct V_243 * V_244 , T_3 V_269 )
{
struct V_1 V_2 ;
int V_6 ;
F_1 ( & V_2 , V_244 -> V_4 ) ;
F_133 ( & V_2 , V_244 , V_269 ) ;
V_6 = F_14 ( & V_2 , F_135 ) ;
if ( V_6 && V_6 != - V_12 ) {
F_44 ( L_16 , V_6 ) ;
return V_6 ;
...
T_3 V_207 ;
int V_6 ;
V_6 = F_34 ( V_4 , F_137 , 0 , V_257 , & V_207 ) ;
if ( ! V_6 )
return;
F_100 ( V_4 ) ;
V_244 = F_139 ( V_4 , V_170 , V_279 ) ;
if ( V_244 )
F_140 ( V_244 , V_207 ) ;
F_102 ( V_4 ) ;
}
static int F_141 ( struct V_1 * V_2 , unsigned long V_41 )
{
F_53 ( V_2 ) ;
return 0 ;
}
...
V_84 . V_196 = V_196 ;
F_46 ( V_2 , V_299 , sizeof( V_84 ) , & V_84 ) ;
return 0 ;
}
static void F_144 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 ,
F_141 . V_211 ) ;
T_3 V_207 ;
...
static void F_146 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 ,
V_300 . V_211 ) ;
...
if ( V_6 )
return V_6 ;
return F_142 ( V_2 , V_318 ) ;
}
static void F_150 ( struct V_3 * V_4 , T_3 * V_207 )
{
unsigned long V_34 ;
...
V_34 = F_104 ( V_4 -> V_322 ) ;
F_34 ( V_4 , F_148 , V_321 ,
V_257 , V_207 ) ;
break;
case V_302 :
V_34 = F_104 ( V_320 ) ;
...
if ( * V_207 )
return;
F_4 ( L_21 , V_4 -> V_23 , F_151 ( V_34 ) ) ;
if ( F_35 ( V_311 , & V_4 -> V_306 ) &&
V_4 -> V_77 . V_323 ) {
V_4 -> V_77 . V_301 = V_313 ;
V_4 -> V_77 . V_312 = V_34 ;
}
F_103 ( V_4 -> V_221 , & V_4 -> F_141 ,
V_34 ) ;
}
...
V_328 = F_153 ( V_4 , V_240 ,
V_332 ) ;
if ( ! V_328 )
return V_44 ;
F_68 ( & V_84 . V_126 , & V_328 -> V_87 . V_126 ) ;
F_46 ( V_2 , V_333 , sizeof( V_84 ) ,
& V_84 ) ;
V_44 = true ;
}
return V_44 ;
...
static void F_155 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 ,
F_155 ) ;
T_3 V_207 = 0 ;
...
static void F_158 ( struct V_210 * V_211 )
{
struct V_3 * V_4 = F_99 ( V_211 , struct V_3 ,
F_158 . V_211 ) ;
F_4 ( L_4 , V_4 -> V_23 ) ;
...
V_4 -> V_335 = 0 ;
F_102 ( V_4 ) ;
F_34 ( V_4 , F_130 , 0 , V_257 , NULL ) ;
F_159 ( V_4 ) ;
}
static int F_160 ( struct V_1 * V_2 , unsigned long V_41 )
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_3 V_336 ;
F_100 ( V_4 ) ;
...
! F_161 ( V_4 ) ) {
T_3 V_337 = 0x01 ;
F_46 ( V_2 , V_338 , sizeof( V_337 ) , & V_337 ) ;
if ( F_162 ( V_4 ) && ! F_163 ( V_4 ) ) {
T_3 V_339 = 0x01 ;
F_46 ( V_2 , V_340 ,
sizeof( V_339 ) , & V_339 ) ;
}
...
V_84 . V_342 = 0x01 ;
V_84 . V_343 = 0x00 ;
if ( V_84 . V_342 != F_165 ( V_4 ) ||
V_84 . V_343 != F_166 ( V_4 ) )
F_46 ( V_2 , V_344 ,
sizeof( V_84 ) , & V_84 ) ;
}
if ( F_48 ( V_4 , V_76 ) ) {
...
if ( F_48 ( V_4 , V_208 ) )
F_80 ( V_2 ) ;
} else if ( ! F_52 ( & V_4 -> V_209 ) ) {
struct V_154 * V_155 ;
V_155 = F_167 ( & V_4 -> V_209 ,
struct V_154 , V_345 ) ;
F_97 ( V_2 ,
V_155 -> V_152 ,
true ) ;
...
{
F_169 ( V_4 ) ;
return F_32 ( V_4 , F_160 , 0 , V_257 ,
NULL ) ;
}
void F_170 ( struct V_3 * V_4 )
{
F_171 ( & V_4 -> F_155 , F_155 ) ;
F_171 ( & V_4 -> F_138 , F_138 ) ;
F_171 ( & V_4 -> V_256 , F_122 ) ;
F_171 ( & V_4 -> F_123 , F_124 ) ;
F_171 ( & V_4 -> F_130 , F_131 ) ;
F_172 ( & V_4 -> F_158 , F_158 ) ;
F_172 ( & V_4 -> F_141 , F_144 ) ;
F_172 ( & V_4 -> V_300 , F_146 ) ;
F_172 ( & V_4 -> V_212 , F_98 ) ;
}
