...
if ( ! V_136 )
return - V_142 ;
V_141 = F_82 ( V_137 , V_138 , V_136 , V_143 ) ;
if ( V_141 < 0 )
return V_141 ;
if ( ! V_137 [ V_144 ] )
return - V_142 ;
...
V_190 = V_137 [ V_164 ] ? F_140 ( V_137 [ V_164 ] ) : 0 ;
V_191 = V_137 [ V_166 ] ? F_140 ( V_137 [ V_166 ] ) : 0 ;
F_141 ( & V_14 -> V_96 , & V_189 -> V_96 , V_190 ) ;
F_141 ( & V_14 -> ceil , & V_189 -> ceil , V_191 ) ;
if ( ! V_14 -> V_22 ) {
T_4 V_120 = V_14 -> V_96 . V_163 ;
F_142 ( V_120 , V_6 -> V_149 ) ;
...
static void F_146 ( struct V_3 * V_4 , unsigned long V_154 )
{
struct V_1 * V_14 = (struct V_1 * ) V_154 ;
if ( V_14 )
V_14 -> V_185 -- ;
}
static void F_147 ( struct V_3 * V_4 , struct V_208 * V_154 )
{
struct V_5 * V_6 = F_2 ( V_4 ) ;
struct V_1 * V_14 ;
unsigned int V_111 ;
