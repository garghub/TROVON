...
V_24 = F_41 ( ( V_29 ) V_22 -> V_19 -> V_54 << 32 ,
V_46 , V_48 * V_53 ) ;
if ( V_24 )
break;
}
...
static int F_43 ( struct V_2 * V_4 , unsigned long V_58 ,
...
if ( ! ( V_60 & V_62 ) )
V_23 |= V_63 ;
V_24 = F_35 ( V_1 , ( unsigned long ) V_59 , V_58 ,
V_43 , V_23 ) ;
return V_24 ;
}
...
V_66 = V_1 -> V_12 ;
F_16 ( & V_1 -> V_13 , V_23 ) ;
if ( V_66 && F_48 ( V_66 [ V_67 ] ) ) {
V_64 = F_49 ( V_66 [ V_67 ] ) ;
if ( V_64 && F_48 ( V_64 [ V_68 ] ) ) {
V_65 = F_50 ( V_64 [ V_68 ] ) ;
if ( V_65 && F_51 ( V_65 [ V_69 ] ) )
V_70 = V_65 [ V_69 ] & V_71 ;
}
}
F_18 ( & V_1 -> V_13 , V_23 ) ;
