...
F_54 ( V_34 , L_30 ) ;
if ( F_27 ( V_119 ) )
F_54 ( V_34 , L_31 , V_119 -> V_101 ) ;
F_54 ( V_34 , L_32 , V_119 -> V_53 ) ;
F_54 ( V_34 , L_33 , V_119 -> V_68 ) ;
if ( V_119 -> V_102 )
F_54 ( V_34 , L_34 , V_119 -> V_102 ) ;
if ( V_119 -> V_96 )
F_54 ( V_34 , L_35 ,
V_119 -> V_96 ) ;
if ( V_119 -> V_97 )
...
int F_55 ( struct V_1 * V_2 , char * V_108 )
{
struct V_10 * V_11 = F_2 ( V_2 ) ;
...
static int F_57 ( struct V_118 * V_119 , const char * V_49 )
{
const char * V_26 = V_49 , * V_27 ;
T_3 V_113 = 0 , * V_120 ;
int V_15 = 0 , V_121 ;
V_121 = strlen ( V_49 ) / 8 + 1 ;
V_120 = F_58 ( V_121 , sizeof( V_113 ) , V_16 ) ;
if ( ! V_120 )
return - V_17 ;
...
static int F_59 ( struct V_118 * V_119 , char * V_49 )
{
char * V_123 ;
int V_124 ;
F_11 ( V_119 -> V_57 ) ;
...
static int F_60 ( char * * V_125 , char * V_49 )
{
char * V_123 ;
int V_124 ;
if ( ! V_125 || ! V_49 )
...
static int F_61 ( struct V_118 * V_119 , char * * V_49 )
{
T_1 V_24 ;
char * V_123 = * V_49 ;
char * V_126 ;
...
static int F_62 ( char * V_128 , struct V_118 * V_119 )
{
char * V_26 , * V_27 , * V_28 , * V_129 = NULL ;
...
V_15 = F_59 ( V_119 , V_26 + 7 ) ;
if ( V_15 )
goto V_142;
V_28 = V_27 ;
V_135 ++ ;
} else if ( strncmp ( V_26 , L_57 , 8 ) == 0 ) {
V_15 = F_57 ( V_119 , V_26 + 7 ) ;
if ( V_15 )
goto V_142;
V_135 ++ ;
...
char * V_149 = V_123 + 1 ;
int V_150 = 1 ;
while ( ! F_34 ( V_149 , & V_24 ,
& V_149 ) ) {
V_150 = 0 ;
}
V_124 = V_149 - V_26 - V_150 ;
}
V_124 -= 6 ;
...
F_64 ( V_119 -> V_106 , L_61 , V_134 ) ;
V_28 = V_26 + 6 + V_124 ;
V_135 ++ ;
} else if ( strncmp ( V_26 , L_62 , 4 ) == 0 ) {
V_15 = F_60 ( & V_119 -> V_105 , V_26 + 4 ) ;
if ( V_15 )
goto V_142;
V_135 ++ ;
}
...
static int F_65 ( struct V_1 * V_2 , void * V_39 , int V_153 )
{
struct V_118 * V_119 ;
struct V_154 * V_155 = V_39 ;
struct V_10 * V_11 ;
int V_15 ;
F_15 ( V_34 | V_156 , L_68 , V_2 ) ;
V_11 = F_44 ( V_2 ) ;
if ( ! V_11 )
return - V_17 ;
V_119 = V_11 -> V_52 ;
...
static struct V_165 * F_73 ( struct V_166 * V_167 , int V_67 ,
...
return F_74 ( V_167 , V_67 , & V_155 , F_65 ) ;
}
