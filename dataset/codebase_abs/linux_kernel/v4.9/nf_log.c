...
int F_11 ( T_1 V_2 , struct V_1 * V_9 )
{
int V_4 ;
int V_16 = 0 ;
...
static int F_47 ( struct V_55 * V_55 , struct V_56 * V_56 )
{
return F_48 ( V_55 , V_56 , & V_57 ,
sizeof( struct V_58 ) ) ;
}
static int F_49 ( struct V_59 * V_60 , int V_61 ,
...
V_70 . V_71 = V_45 ;
V_66 = F_50 ( & V_70 , V_61 , V_62 , V_63 , V_64 ) ;
if ( V_66 )
return V_66 ;
if ( ! strcmp ( V_45 , L_9 ) ) {
F_15 ( V_8 , V_67 ) ;
...
V_60 -> V_71 = V_9 -> V_7 ;
V_66 = F_50 ( V_60 , V_61 , V_62 , V_63 , V_64 ) ;
F_7 ( & V_14 ) ;
}
return V_66 ;
}
