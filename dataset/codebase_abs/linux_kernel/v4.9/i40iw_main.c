...
static void F_127 ( struct V_2 * V_3 , struct V_315 * V_160 , T_1 V_340 )
{
struct V_1 * V_4 ;
struct V_11 * V_12 ;
struct V_341 V_342 ;
...
return;
V_12 = & V_4 -> V_316 . V_25 ;
for ( V_60 = 0 ; V_60 < V_347 ; V_60 ++ ) {
if ( ! V_12 -> V_348 [ V_60 ] || ( V_12 -> V_348 [ V_60 ] -> V_340 != V_340 ) )
continue;
V_346 = V_12 -> V_348 [ V_60 ] ;
F_2 ( & V_12 -> V_349 . V_350 , V_5 ) ;
V_12 -> V_348 [ V_60 ] = NULL ;
F_4 ( & V_12 -> V_349 . V_350 , V_5 ) ;
F_31 ( V_12 , & V_346 -> V_70 , false , false ) ;
memset ( & V_342 , 0 , sizeof( V_342 ) ) ;
V_342 . V_340 = V_340 ;
V_342 . V_351 = V_346 -> V_351 ;
V_342 . V_352 = true ;
F_128 ( V_12 , & V_342 ) ;
V_344 . V_92 = V_346 ;
V_344 . V_90 = sizeof( struct V_345 ) +
sizeof( struct V_258 ) * V_259 ;
F_129 ( V_12 -> V_19 , & V_344 ) ;
break;
}
}
...
return;
if ( V_353 > V_347 )
V_4 -> V_316 . V_320 = V_347 ;
else
V_4 -> V_316 . V_320 = V_353 ;
}
...
V_22 = V_12 -> V_333 ;
if ( V_12 -> V_359 . V_360 ) {
V_356 = V_12 -> V_359 . V_360 ( V_12 , V_340 , V_354 , V_355 ) ;
if ( ! V_12 -> V_18 ) {
F_133 ( & V_22 -> V_361 ) ;
F_134 ( & V_22 -> V_330 ) ;
}
...
return true ;
F_138 ( & V_362 ) ;
F_139 ( & V_12 -> V_331 , & V_362 ) ;
if ( ! F_140 ( V_12 -> V_331 ,
( F_137 ( & V_22 -> V_361 ) == 0 ) ,
V_363 ) )
V_12 -> V_364 = false ;
F_141 ( & V_12 -> V_331 , & V_362 ) ;
return V_12 -> V_364 ;
}
...
V_22 = V_12 -> V_333 ;
V_3 = V_22 -> V_3 ;
if ( V_3 && V_3 -> V_158 && V_3 -> V_158 -> V_365 )
return V_3 -> V_158 -> V_365 ( V_3 , & V_163 , V_340 , V_354 , V_355 ) ;
return V_165 ;
}
...
V_163 . V_366 . V_367 = V_368 ;
V_163 . V_366 . V_369 = V_370 ;
V_163 . V_366 . V_371 = V_372 ;
V_163 . V_158 = & V_373 ;
memcpy ( V_163 . V_374 , V_375 , V_376 ) ;
V_163 . type = V_377 ;
F_40 ( & V_6 ) ;
V_169 = F_143 ( & V_163 ) ;
return V_169 ;
