...
F_4 ( 4 , L_26 ) ;
F_43 ( & V_2 -> V_9 . V_10 -> V_11 -> V_65 ,
L_27 ,
V_2 -> V_26 + ( 30 * V_89 ) / 1000 ,
V_21 ) ;
F_44 ( 30 ) ;
}
...
return 3 ;
F_45 ( V_7 -> V_11 ) ;
V_13 = F_1 ( V_2 , V_114 , & V_12 , sizeof( V_12 ) ) ;
if ( V_12 == V_115 ) {
F_4 ( 0 , L_34 ) ;
V_8 = 0 ;
goto V_116;
...
V_12 = V_120 ;
V_13 = F_5 ( V_2 , V_114 , & V_12 , sizeof( V_12 ) ) ;
if ( V_13 ) {
V_8 = 11 ;
goto V_119;
}
...
F_60 ( 10 ) ;
V_13 =
F_1 ( V_2 , V_114 , & V_12 , sizeof( V_12 ) ) ;
if ( V_13 ) {
V_8 = 11 ;
goto V_119;
}
...
if ( ! V_171 ) {
F_74 ( & V_7 -> V_11 -> V_65 , L_51 ) ;
goto V_184;
}
if ( F_75 ( V_171 , L_52 ) < 0 ) {
F_74 ( & V_7 -> V_11 -> V_65 ,
L_53 ) ;
goto V_185;
}
V_2 = F_76 ( V_171 ) ;
V_7 -> V_2 = V_2 ;
F_77 ( V_171 , & V_7 -> V_11 -> V_65 ) ;
V_2 -> V_9 . V_10 = V_7 ;
F_63 ( & V_2 -> V_9 . V_186 ) ;
V_2 -> V_9 . V_107 = NULL ;
V_2 -> V_9 . V_107 = F_56 ( V_187 , V_104 ) ;
if ( ! V_2 -> V_9 . V_107 )
goto V_185;
V_2 -> V_38 = V_188 ;
V_2 -> V_189 = V_171 ;
...
F_4 ( 4 , L_57 , V_12 ) ;
V_2 -> V_38 = V_51 ;
V_2 -> V_9 . V_43 = F_80 ( L_58 ) ;
if ( ! V_2 -> V_9 . V_43 ) {
F_4 ( 1 , L_59 ) ;
goto V_193;
}
F_81 ( & V_2 -> V_9 . V_44 , F_40 ) ;
F_62 ( V_2 ) ;
V_172 = F_82 ( V_2 -> V_189 ) ;
if ( V_172 )
goto V_193;
return 0 ;
V_193:
...
static void F_86 ( struct V_94 * V_11 )
{
int V_172 ;
struct V_6 * V_7 ;
struct V_1 * V_2 ;
...
{
struct V_197 * V_198 ;
V_198 = F_68 ( F_33 ( sizeof( * V_198 ) ) , V_104 ) ;
if ( ! V_198 ) {
F_4 ( 3 , L_64 ) ;
return;
}
...
F_88 ( ( T_1 )
( sizeof( * V_198 ) -
sizeof( V_198 -> V_199 . V_46 ) ) ) ;
V_198 -> V_199 . V_59 = F_88 ( ( T_1 ) V_200 ) ;
F_45 ( V_11 ) ;
F_21 ( V_2 , ( unsigned char * ) V_198 ,
F_33 ( sizeof( * V_198 ) ) ) ;
F_46 ( V_11 ) ;
F_19 ( V_198 ) ;
}
