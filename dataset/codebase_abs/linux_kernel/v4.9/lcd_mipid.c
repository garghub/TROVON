...
static void F_51 ( struct V_40 * V_26 )
{
struct V_1 * V_2 = F_20 ( V_26 ) ;
if ( V_2 -> V_37 )
F_40 ( V_2 ) ;
...
static int F_54 ( struct V_88 * V_15 )
{
struct V_1 * V_2 ;
int V_14 ;
V_2 = F_55 ( sizeof( * V_2 ) , V_89 ) ;
if ( V_2 == NULL ) {
F_32 ( & V_15 -> V_20 , L_17 ) ;
return - V_90 ;
}
...
static int F_58 ( struct V_88 * V_15 )
{
struct V_1 * V_2 = F_59 ( & V_15 -> V_20 ) ;
F_45 ( & V_2 -> V_26 ) ;
F_60 ( V_2 ) ;
return 0 ;
}
