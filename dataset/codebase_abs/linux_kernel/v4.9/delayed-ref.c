...
if ( ! V_84 )
goto V_101;
if ( F_53 ( V_102 , & V_53 -> V_103 ) &&
F_44 ( V_85 ) ) {
V_97 = F_54 ( sizeof( * V_97 ) , V_98 ) ;
if ( ! V_97 )
goto V_104;
}
V_84 -> V_77 = V_77 ;
V_29 = & V_26 -> V_30 -> V_29 ;
F_16 ( & V_29 -> V_31 ) ;
V_84 = F_55 ( V_53 , V_26 , & V_84 -> V_8 , V_97 ,
...
T_1 V_19 , T_1 V_67 ,
T_1 V_6 , T_1 V_85 ,
T_1 V_93 , T_1 V_11 , T_1 V_105 , int V_50 ,
struct V_95 * V_77 )
{
struct V_7 * V_37 ;
struct V_12 * V_84 ;
...
V_29 = & V_26 -> V_30 -> V_29 ;
F_16 ( & V_29 -> V_31 ) ;
F_55 ( V_53 , V_26 , & V_84 -> V_8 , NULL , V_19 ,
V_67 , 0 , 0 , V_106 ,
V_77 -> V_54 ) ;
F_14 ( & V_29 -> V_31 ) ;
return 0 ;
