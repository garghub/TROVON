...
V_8 = V_58 -> V_74 -> V_75 -> V_76 ( V_58 , & V_31 , sizeof( V_31 ) ) ;
if ( V_8 < 0 ) {
if ( ! F_39 ( V_58 ) )
return V_8 ;
V_31 . V_80 = V_81 ;
...
F_43 ( V_32 ) ;
V_32 = NULL ;
if ( F_44 ( & V_58 -> V_79 , NULL , V_29 ) != NULL ) {
F_32 ( V_29 ) ;
goto V_78;
}
return 0 ;
...
{
struct V_28 * V_57 = V_58 -> V_79 ;
if ( ! V_57 ||
( V_57 -> V_56 &&
( V_57 -> V_56 -> V_84 & ( ( 1 << V_96 ) |
( 1 << V_97 ) |
( 1 << V_98 ) ) ) ) )
return F_34 ( V_58 ) ;
return 0 ;
