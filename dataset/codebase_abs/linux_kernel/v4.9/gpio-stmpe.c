...
{
struct V_5 * V_5 = F_33 ( V_98 -> V_85 . V_99 ) ;
struct V_100 * V_101 = V_98 -> V_85 . V_102 ;
struct V_4 * V_4 ;
int V_10 ;
int V_84 = 0 ;
V_84 = F_34 ( V_98 , 0 ) ;
V_4 = F_35 ( sizeof( struct V_4 ) , V_103 ) ;
if ( ! V_4 )
return - V_104 ;
F_36 ( & V_4 -> V_33 ) ;
V_4 -> V_85 = & V_98 -> V_85 ;
...
if ( V_10 ) {
F_42 ( & V_98 -> V_85 , L_19 , V_10 ) ;
goto V_110;
}
if ( V_84 > 0 ) {
V_10 = F_43 ( & V_98 -> V_85 , V_84 , NULL ,
F_27 , V_111 ,
L_20 , V_4 ) ;
if ( V_10 ) {
F_42 ( & V_98 -> V_85 , L_21 , V_10 ) ;
goto V_110;
}
if ( V_4 -> V_16 ) {
int V_52 ;
for ( V_52 = 0 ; V_52 < sizeof( V_112 ) ; V_52 ++ )
if ( V_4 -> V_16 & F_3 ( V_52 ) )
F_44 ( V_52 , V_4 -> V_2 . V_113 ) ;
}
V_10 = F_45 ( & V_4 -> V_2 ,
& V_114 ,
0 ,
