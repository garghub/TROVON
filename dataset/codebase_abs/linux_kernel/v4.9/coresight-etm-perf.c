...
if ( ! V_36 )
goto V_38;
V_22 -> V_26 [ V_6 ] = F_29 ( V_36 ) ;
if ( F_30 ( V_22 -> V_26 [ V_6 ] ) )
goto V_38;
}
V_6 = F_10 ( V_20 ) ;
V_24 = F_11 ( V_22 -> V_26 [ V_6 ] ) ;
...
static void F_31 ( struct V_1 * V_2 , int V_40 )
{
int V_6 = F_32 () ;
struct V_21 * V_22 ;
struct V_41 * V_42 = F_33 ( & V_43 ) ;
struct V_23 * V_24 , * V_36 = F_28 ( V_37 , V_6 ) ;
if ( ! V_36 )
goto V_44;
V_22 = F_34 ( V_42 , V_2 ) ;
if ( ! V_22 )
goto V_44;
V_24 = F_11 ( V_22 -> V_26 [ V_6 ] ) ;
if ( F_35 ( ! V_24 || ! F_12 ( V_24 ) -> V_45 ) )
goto V_46;
if ( F_12 ( V_24 ) -> V_45 ( V_24 , V_42 ,
V_22 -> V_25 ) )
goto V_46;
if ( F_36 ( V_22 -> V_26 [ V_6 ] , V_47 ) )
goto V_46;
V_2 -> V_10 . V_48 = 0 ;
if ( F_37 ( V_36 ) -> F_38 ( V_36 , V_2 , V_47 ) )
goto V_46;
V_16:
return;
V_46:
...
static void F_40 ( struct V_1 * V_2 , int V_50 )
{
bool V_51 ;
int V_6 = F_32 () ;
unsigned long V_28 ;
...
if ( ! V_24 )
return;
F_37 ( V_36 ) -> F_42 ( V_36 , V_2 ) ;
V_2 -> V_10 . V_48 = V_49 ;
if ( V_50 & V_52 ) {
if ( F_35 ( V_42 -> V_2 != V_2 ) )
return;
if ( ! F_12 ( V_24 ) -> V_53 )
return;
...
static int F_44 ( struct V_1 * V_2 , int V_50 )
{
int V_12 = 0 ;
...
static void F_45 ( struct V_1 * V_2 , int V_50 )
{
F_40 ( V_2 , V_52 ) ;
}
static int F_46 ( struct V_30 * V_4 )
{
bool V_59 = false , V_60 = false ;
int V_61 = 0 ;
struct V_62 * V_63 ;
F_47 (filter, filters, entry) {
if ( ++ V_61 > V_64 )
return - V_65 ;
if ( ( V_63 -> V_59 == 1 ) && V_60 )
return - V_65 ;
...
int F_50 ( struct V_23 * V_36 , bool V_81 )
{
char V_82 [ sizeof( L_1 ) ] ;
int V_12 = 0 , V_6 = F_37 ( V_36 ) -> F_51 ( V_36 ) ;
struct V_83 * V_84 = V_14 . V_85 ;
struct V_83 * V_86 = & V_36 -> V_85 ;
sprintf ( V_82 , L_2 , V_6 ) ;
if ( ! V_87 )
return - V_88 ;
if ( V_81 ) {
V_12 = F_52 ( & V_84 -> V_89 , & V_86 -> V_89 , V_82 ) ;
if ( V_12 )
return V_12 ;
F_28 ( V_37 , V_6 ) = V_36 ;
} else {
