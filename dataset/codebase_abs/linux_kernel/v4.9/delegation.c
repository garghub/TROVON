...
V_11 = true ;
if ( F_65 ( V_79 , & V_2 -> V_6 ) && ! V_11 ) {
struct V_9 * V_9 ;
F_16 ( & V_2 -> V_50 ) ;
V_9 = V_2 -> V_9 ;
if ( V_9 && F_66 ( & F_11 ( V_9 ) -> V_80 ) )
V_11 = true ;
F_19 ( & V_2 -> V_50 ) ;
}
V_27:
...
struct V_1 * V_2 )
{
if ( V_2 -> V_18 . type == V_83 )
return;
F_34 ( V_53 , & V_2 -> V_6 ) ;
F_5 ( V_92 , & V_2 -> V_6 ) ;
F_5 ( V_96 , & V_64 -> V_55 -> V_59 ) ;
}
...
{
const struct V_97 * V_98 = V_56 -> V_86 ;
struct V_1 * V_2 ;
struct V_63 * V_64 ;
struct V_9 * V_9 ;
struct V_46 * V_3 ;
