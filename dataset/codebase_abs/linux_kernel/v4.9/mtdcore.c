...
while ( ! V_88 ) {
int V_163 ;
V_163 = V_156 . V_158 > V_162 ? V_162 : V_156 . V_158 ;
...
static int F_105 ( struct V_3 * V_4 , const T_7 * V_11 ,
...
int F_107 ( struct V_3 * V_4 , T_7 * V_165 ,
const T_7 * V_160 , int V_161 , int V_162 )
{
return F_104 ( V_4 , V_165 , V_160 , V_161 , V_162 ,
F_99 ) ;
}
int F_108 ( struct V_3 * V_4 , const T_7 * V_165 ,
T_7 * V_160 , int V_161 , int V_162 )
{
return F_105 ( V_4 , V_165 , V_160 , V_161 , V_162 ,
F_99 ) ;
}
int F_109 ( struct V_3 * V_4 , T_7 * V_166 ,
const T_7 * V_160 , int V_161 , int V_162 )
{
return F_104 ( V_4 , V_166 , V_160 , V_161 , V_162 ,
F_100 ) ;
}
int F_110 ( struct V_3 * V_4 , const T_7 * V_166 ,
T_7 * V_160 , int V_161 , int V_162 )
{
return F_105 ( V_4 , V_166 , V_160 , V_161 , V_162 ,
F_100 ) ;
}
int F_111 ( struct V_3 * V_4 )
{
return F_106 ( V_4 , F_100 ) ;
}
int F_112 ( struct V_3 * V_4 )
{
return F_106 ( V_4 , F_99 ) ;
}
int F_113 ( struct V_3 * V_4 , T_3 V_122 , T_3 * V_129 ,
struct V_167 * V_11 )
{
if ( ! V_4 -> V_168 )
return - V_79 ;
...
int F_114 ( struct V_3 * V_4 , T_4 V_128 , T_3 V_122 ,
T_3 * V_129 , T_6 * V_11 )
{
* V_129 = 0 ;
if ( ! V_4 -> V_169 )
...
int F_115 ( struct V_3 * V_4 , T_3 V_122 , T_3 * V_129 ,
struct V_167 * V_11 )
{
if ( ! V_4 -> V_170 )
return - V_79 ;
...
int F_116 ( struct V_3 * V_4 , T_4 V_128 , T_3 V_122 ,
T_3 * V_129 , T_6 * V_11 )
{
* V_129 = 0 ;
if ( ! V_4 -> V_171 )
...
int F_117 ( struct V_3 * V_4 , T_4 V_139 , T_3 V_122 ,
T_3 * V_129 , T_6 * V_11 )
{
int V_88 ;
* V_129 = 0 ;
...
int F_118 ( struct V_3 * V_4 , T_4 V_128 , T_3 V_122 )
{
if ( ! V_4 -> V_174 )
return - V_79 ;
if ( ! V_122 )
...
int F_119 ( struct V_3 * V_4 , T_4 V_175 , T_8 V_122 )
{
if ( ! V_4 -> V_176 )
return - V_79 ;
...
int F_121 ( struct V_3 * V_4 , T_4 V_175 )
{
...
static int F_124 ( struct V_3 * V_4 , const struct V_182 * V_183 ,
...
int F_125 ( struct V_3 * V_4 , const struct V_182 * V_183 ,
unsigned long V_32 , T_4 V_139 , T_3 * V_129 )
{
* V_129 = 0 ;
if ( ! ( V_4 -> V_21 & V_77 ) )
return - V_123 ;
if ( ! V_4 -> V_188 )
return F_124 ( V_4 , V_183 , V_32 , V_139 , V_129 ) ;
return V_4 -> V_188 ( V_4 , V_183 , V_32 , V_139 , V_129 ) ;
}
void * F_126 ( const struct V_3 * V_4 , T_3 * V_22 )
{
T_9 V_21 = V_189 | V_190 | V_191 ;
T_3 V_192 = F_127 ( T_3 , V_4 -> V_24 , V_20 ) ;
void * V_193 ;
* V_22 = F_128 ( T_3 , * V_22 , V_194 ) ;
while ( * V_22 > V_192 ) {
...
static int T_10 F_136 ( struct V_66 * V_200 , const char * V_29 )
{
int V_88 ;
V_88 = F_137 ( V_200 ) ;
if ( ! V_88 )
V_88 = F_138 ( V_200 , NULL , L_25 , V_29 ) ;
if ( V_88 )
F_139 ( V_200 ) ;
return V_88 ;
}
...
if ( V_88 )
goto V_201;
V_88 = F_136 ( & V_68 , L_26 ) ;
if ( V_88 )
goto V_202;
V_203 = F_142 ( L_26 , 0 , NULL , & V_204 ) ;
V_88 = F_143 () ;
if ( V_88 )
goto V_205;
return 0 ;
