...
V_92 -> V_96 = - 1 ;
V_92 -> V_133 = true ;
V_87 = F_66 ( V_2 -> V_42 , V_92 , V_2 ) ;
if ( V_87 ) {
F_67 ( V_2 -> V_42 , L_10 ) ;
return V_87 ;
}
for ( V_41 = 0 , V_3 = 0 ; V_41 < V_2 -> V_17 -> V_134 ; V_41 ++ ) {
V_54 = & V_2 -> V_17 -> V_135 [ V_41 ] ;
...
const struct V_136 * V_122 ;
T_2 V_108 ;
V_122 = & V_2 -> V_17 -> V_22 [ V_41 ] ;
V_108 = F_4 ( F_1 ( V_2 , V_122 -> V_90 , V_31 ) ) ;
V_108 &= V_101 ;
V_108 >>= V_102 ;
if ( V_108 >= V_2 -> V_17 -> V_137 )
F_69 ( V_41 , V_92 -> V_138 ) ;
}
F_2 ( 0xffff , V_2 -> V_11 + V_103 ) ;
V_87 = F_70 ( V_92 , & V_139 , 0 ,
V_140 , V_106 ) ;
if ( V_87 ) {
F_67 ( V_2 -> V_42 , L_12 ) ;
return V_87 ;
}
F_71 ( V_92 , & V_139 , V_125 ,
F_56 ) ;
return 0 ;
}
...
struct V_145 * V_146 ;
int V_87 , V_125 , V_41 ;
V_144 = F_73 ( & V_142 -> V_42 ) ;
if ( ! V_144 )
return - V_147 ;
V_2 = F_74 ( & V_142 -> V_42 , sizeof( * V_2 ) , V_148 ) ;
if ( ! V_2 )
return - V_149 ;
for ( V_41 = 0 ; V_41 < F_22 ( V_150 ) ; V_41 ++ )
if ( ! strcmp ( V_144 -> V_151 . V_152 , V_150 [ V_41 ] -> V_153 ) ) {
V_2 -> V_17 = V_150 [ V_41 ] ;
break;
}
if ( V_41 == F_22 ( V_150 ) )
...
V_2 -> V_42 = & V_142 -> V_42 ;
#ifdef F_75
V_2 -> V_154 = F_76 ( V_2 -> V_42 ,
V_2 -> V_17 -> V_23 , sizeof( * V_2 -> V_154 ) ,
V_148 ) ;
if ( ! V_2 -> V_154 )
return - V_149 ;
#endif
V_146 = F_77 ( V_142 , V_155 , 0 ) ;
V_2 -> V_11 = F_78 ( & V_142 -> V_42 , V_146 ) ;
if ( F_79 ( V_2 -> V_11 ) )
return F_80 ( V_2 -> V_11 ) ;
V_125 = F_81 ( V_142 , 0 ) ;
if ( V_125 < 0 ) {
F_67 ( & V_142 -> V_42 , L_13 ) ;
return V_125 ;
}
V_2 -> V_156 = V_157 ;
V_2 -> V_156 . V_21 = F_65 ( & V_142 -> V_42 ) ;
V_2 -> V_156 . V_22 = V_2 -> V_17 -> V_22 ;
V_2 -> V_156 . V_23 = V_2 -> V_17 -> V_23 ;
V_2 -> V_16 = F_82 ( & V_142 -> V_42 , & V_2 -> V_156 ,
V_2 ) ;
if ( F_79 ( V_2 -> V_16 ) ) {
F_67 ( & V_142 -> V_42 , L_14 ) ;
...
static int F_84 ( struct V_158 * V_42 )
{
struct V_141 * V_142 = F_85 ( V_42 ) ;
struct V_1 * V_2 = F_86 ( V_142 ) ;
unsigned long V_26 ;
int V_41 ;
F_11 ( & V_30 , V_26 ) ;
V_2 -> V_159 = F_4 ( V_2 -> V_11 + V_105 ) ;
for ( V_41 = 0 ; V_41 < V_2 -> V_17 -> V_23 ; V_41 ++ ) {
const struct V_136 * V_122 ;
struct V_160 * V_161 ;
void T_1 * V_4 ;
...
continue;
V_161 = & V_2 -> V_154 [ V_41 ] ;
V_4 = F_1 ( V_2 , V_122 -> V_90 , V_31 ) ;
V_161 -> V_162 = F_4 ( V_4 ) & ~ V_94 ;
...
static int F_87 ( struct V_158 * V_42 )
{
struct V_141 * V_142 = F_85 ( V_42 ) ;
struct V_1 * V_2 = F_86 ( V_142 ) ;
unsigned long V_26 ;
