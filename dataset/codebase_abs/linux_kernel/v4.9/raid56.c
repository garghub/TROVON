...
V_24 -> V_110 = V_97 + sizeof( struct V_39 * ) * V_105 * 2 ;
if ( V_35 -> V_111 & V_112 )
V_63 = V_73 - 1 ;
...
unsigned long V_117 )
{
struct V_87 * V_65 = V_41 -> V_118 ;
T_1 V_119 = 0 ;
int V_27 ;
struct V_87 * V_87 ;
struct V_120 * V_70 ;
T_1 V_121 ;
V_70 = & V_24 -> V_35 -> V_122 [ V_115 ] ;
V_121 = V_70 -> V_123 + ( V_116 << V_98 ) ;
if ( ! V_70 -> V_124 -> V_125 )
return F_91 ( V_24 , V_115 ) ;
if ( V_65 ) {
V_119 = ( T_1 ) V_65 -> V_126 . V_127 << 9 ;
V_119 += V_65 -> V_126 . V_128 ;
if ( V_119 == V_121 && V_70 -> V_124 -> V_125 &&
! V_65 -> V_89 &&
V_65 -> V_129 == V_70 -> V_124 -> V_125 ) {
V_27 = F_92 ( V_65 , V_39 , V_31 , 0 ) ;
if ( V_27 == V_31 )
return 0 ;
}
}
V_87 = F_93 ( V_107 , V_117 >> V_98 ? : 1 ) ;
if ( ! V_87 )
return - V_17 ;
V_87 -> V_126 . V_128 = 0 ;
V_87 -> V_129 = V_70 -> V_124 -> V_125 ;
V_87 -> V_126 . V_127 = V_121 >> 9 ;
...
{
if ( V_24 -> V_108 >= 0 || V_24 -> V_109 >= 0 ) {
F_31 ( V_24 -> V_108 == V_24 -> V_73 - 1 ) ;
F_96 ( V_24 ) ;
} else {
F_97 ( V_24 ) ;
}
...
V_130 = ( T_1 ) V_87 -> V_126 . V_127 << 9 ;
V_131 = V_130 - V_24 -> V_35 -> V_36 [ 0 ] ;
V_116 = V_131 >> V_98 ;
for ( V_11 = 0 ; V_11 < V_87 -> V_132 ; V_11 ++ ) {
V_97 = V_87 -> V_133 [ V_11 ] . V_134 ;
V_24 -> V_29 [ V_116 + V_11 ] = V_97 ;
}
}
F_81 ( & V_24 -> V_48 ) ;
}
...
F_13 ( V_97 ) ;
V_135 [ V_70 ++ ] = F_11 ( V_97 ) ;
V_138 . V_139 ( V_24 -> V_73 , V_31 ,
V_135 ) ;
} else {
memcpy ( V_135 [ V_63 ] , V_135 [ 0 ] , V_31 ) ;
F_45 ( V_135 + 1 , V_63 - 1 , V_31 ) ;
}
...
struct V_87 * V_87 )
{
T_1 V_123 = V_87 -> V_126 . V_127 ;
T_1 V_145 ;
int V_11 ;
struct V_120 * V_70 ;
V_123 <<= 9 ;
for ( V_11 = 0 ; V_11 < V_24 -> V_35 -> V_103 ; V_11 ++ ) {
V_70 = & V_24 -> V_35 -> V_122 [ V_11 ] ;
V_145 = V_70 -> V_123 ;
if ( V_123 >= V_145 &&
V_123 < V_145 + V_24 -> V_64 &&
V_87 -> V_129 == V_70 -> V_124 -> V_125 ) {
return V_11 ;
}
}
...
struct V_87 * V_87 )
{
T_1 V_146 = V_87 -> V_126 . V_127 ;
T_1 V_145 ;
int V_11 ;
V_146 <<= 9 ;
for ( V_11 = 0 ; V_11 < V_24 -> V_63 ; V_11 ++ ) {
V_145 = V_24 -> V_35 -> V_36 [ V_11 ] ;
if ( V_146 >= V_145 &&
V_146 < V_145 + V_24 -> V_64 ) {
return V_11 ;
}
}
return - 1 ;
}
static int F_91 ( struct V_23 * V_24 , int V_147 )
{
unsigned long V_33 ;
int V_27 = 0 ;
F_35 ( & V_24 -> V_48 , V_33 ) ;
if ( V_24 -> V_108 == V_147 || V_24 -> V_109 == V_147 )
goto V_78;
if ( V_24 -> V_108 == - 1 ) {
V_24 -> V_108 = V_147 ;
F_42 ( & V_24 -> error ) ;
} else if ( V_24 -> V_109 == - 1 ) {
V_24 -> V_109 = V_147 ;
F_42 ( & V_24 -> error ) ;
} else {
V_27 = - V_93 ;
...
struct V_87 * V_87 )
{
int V_147 = F_105 ( V_24 , V_87 ) ;
if ( V_147 < 0 )
return - V_93 ;
return F_91 ( V_24 , V_147 ) ;
}
...
{
F_109 ( & V_24 -> V_148 , V_149 ,
V_150 , NULL , NULL ) ;
F_110 ( V_24 -> V_47 -> V_151 ,
& V_24 -> V_148 ) ;
}
...
static int F_116 ( void * V_157 , struct V_81 * V_158 , struct V_81 * V_159 )
{
struct V_23 * V_160 = F_117 ( V_158 , struct V_23 ,
V_51 ) ;
struct V_23 * V_161 = F_117 ( V_159 , struct V_23 ,
V_51 ) ;
T_1 V_162 = V_160 -> V_41 . V_82 -> V_126 . V_127 ;
T_1 V_163 = V_161 -> V_41 . V_82 -> V_126 . V_127 ;
if ( V_162 < V_163 )
return - 1 ;
if ( V_162 > V_163 )
return 1 ;
...
F_119 ( NULL , & V_165 -> V_166 , F_116 ) ;
while ( ! F_29 ( & V_165 -> V_166 ) ) {
V_7 = F_38 ( V_165 -> V_166 . V_52 ,
struct V_23 , V_51 ) ;
F_27 ( & V_7 -> V_51 ) ;
if ( F_49 ( V_7 ) ) {
F_113 ( V_7 ) ;
...
static void F_120 ( struct V_167 * V_148 )
{
struct V_164 * V_165 ;
V_165 = F_117 ( V_148 , struct V_164 , V_148 ) ;
F_118 ( V_165 ) ;
}
static void F_121 ( struct V_168 * V_169 , bool V_170 )
{
struct V_164 * V_165 ;
V_165 = F_117 ( V_169 , struct V_164 , V_169 ) ;
if ( V_170 ) {
F_109 ( & V_165 -> V_148 , V_149 ,
F_120 , NULL , NULL ) ;
F_110 ( V_165 -> V_2 -> V_151 ,
& V_165 -> V_148 ) ;
return;
}
F_118 ( V_165 ) ;
}
int F_122 ( struct V_100 * V_101 , struct V_87 * V_87 ,
struct V_102 * V_35 , T_1 V_64 )
{
struct V_23 * V_24 ;
...
V_169 = F_127 ( F_121 , V_101 -> V_47 ,
sizeof( * V_165 ) ) ;
if ( V_169 ) {
V_165 = F_117 ( V_169 , struct V_164 , V_169 ) ;
if ( ! V_165 -> V_2 ) {
V_165 -> V_2 = V_101 -> V_47 ;
F_5 ( & V_165 -> V_166 ) ;
}
F_58 ( & V_24 -> V_51 , & V_165 -> V_166 ) ;
V_27 = 0 ;
} else {
V_27 = F_115 ( V_24 ) ;
if ( V_27 )
...
int V_86 ;
int V_11 ;
V_135 = F_129 ( V_24 -> V_73 , sizeof( void * ) , V_107 ) ;
if ( ! V_135 ) {
V_86 = - V_17 ;
goto V_171;
}
...
for ( V_94 = 0 ; V_94 < V_24 -> V_72 ; V_94 ++ ) {
if ( V_24 -> V_67 == V_68 &&
! F_18 ( V_94 , V_24 -> V_110 ) )
continue;
for ( V_70 = 0 ; V_70 < V_24 -> V_73 ; V_70 ++ ) {
if ( ( V_24 -> V_67 == V_83 ||
V_24 -> V_67 == V_69 ) &&
( V_70 == V_108 || V_70 == V_109 ) ) {
V_39 = F_79 ( V_24 , V_70 , V_94 , 0 ) ;
} else {
V_39 = F_52 ( V_24 , V_70 , V_94 ) ;
}
V_135 [ V_70 ] = F_11 ( V_39 ) ;
}
if ( V_24 -> V_35 -> V_111 & V_113 ) {
if ( V_109 < 0 ) {
if ( V_108 == V_24 -> V_63 ) {
V_86 = - V_93 ;
goto V_140;
...
if ( V_24 -> V_35 -> V_36 [ V_109 ] == V_174 ) {
if ( V_24 -> V_35 -> V_36 [ V_108 ] ==
V_175 ) {
V_86 = - V_93 ;
goto V_140;
}
...
V_31 ) ;
V_97 = V_135 [ V_108 ] ;
for ( V_70 = V_108 ; V_70 < V_24 -> V_63 - 1 ; V_70 ++ )
V_135 [ V_70 ] = V_135 [ V_70 + 1 ] ;
V_135 [ V_24 -> V_63 - 1 ] = V_97 ;
F_45 ( V_135 , V_24 -> V_63 - 1 , V_31 ) ;
}
if ( V_24 -> V_67 == V_84 ) {
for ( V_11 = 0 ; V_11 < V_24 -> V_72 ; V_11 ++ ) {
if ( V_108 != - 1 ) {
V_39 = F_52 ( V_24 , V_108 , V_11 ) ;
F_13 ( V_39 ) ;
}
if ( V_109 != - 1 ) {
...
static void F_133 ( struct V_87 * V_87 )
{
struct V_23 * V_24 = V_87 -> V_90 ;
if ( V_87 -> V_89 )
F_77 ( V_24 , V_87 ) ;
...
F_86 ( & V_24 -> error , 0 ) ;
for ( V_70 = 0 ; V_70 < V_24 -> V_73 ; V_70 ++ ) {
if ( V_24 -> V_108 == V_70 || V_24 -> V_109 == V_70 ) {
F_42 ( & V_24 -> error ) ;
continue;
}
for ( V_94 = 0 ; V_94 < V_24 -> V_72 ; V_94 ++ ) {
...
int F_134 ( struct V_100 * V_101 , struct V_87 * V_87 ,
struct V_102 * V_35 , T_1 V_64 ,
int V_176 , int V_177 )
{
struct V_23 * V_24 ;
...
F_94 ( & V_24 -> V_41 , V_87 ) ;
V_24 -> V_42 = V_87 -> V_126 . V_128 ;
V_24 -> V_108 = F_106 ( V_24 , V_87 ) ;
if ( V_24 -> V_108 == - 1 ) {
F_135 ( V_101 -> V_47 ,
L_1 ,
V_178 , ( T_1 ) V_87 -> V_126 . V_127 << 9 ,
( T_1 ) V_87 -> V_126 . V_128 , V_35 -> V_111 ) ;
if ( V_177 )
F_69 ( V_35 ) ;
F_70 ( V_24 ) ;
return - V_93 ;
...
{
struct V_23 * V_24 ;
V_24 = F_117 ( V_148 , struct V_23 , V_148 ) ;
F_111 ( V_24 ) ;
}
...
struct V_23 *
F_137 ( struct V_100 * V_101 , struct V_87 * V_87 ,
struct V_102 * V_35 , T_1 V_64 ,
struct V_179 * V_180 ,
unsigned long * V_110 , int V_181 )
{
struct V_23 * V_24 ;
int V_11 ;
V_24 = F_84 ( V_101 , V_35 , V_64 ) ;
...
return NULL ;
F_94 ( & V_24 -> V_41 , V_87 ) ;
ASSERT ( ! V_87 -> V_126 . V_128 ) ;
V_24 -> V_67 = V_68 ;
for ( V_11 = 0 ; V_11 < V_24 -> V_73 ; V_11 ++ ) {
if ( V_35 -> V_122 [ V_11 ] . V_124 == V_180 ) {
V_24 -> V_182 = V_11 ;
break;
}
}
ASSERT ( V_101 -> V_183 == V_31 ) ;
ASSERT ( V_24 -> V_72 == V_181 ) ;
F_138 ( V_24 -> V_110 , V_110 , V_181 ) ;
return V_24 ;
}
void F_139 ( struct V_23 * V_24 , struct V_39 * V_39 ,
T_1 V_146 )
{
int V_131 ;
int V_71 ;
ASSERT ( V_146 >= V_24 -> V_35 -> V_36 [ 0 ] ) ;
ASSERT ( V_146 + V_31 <= V_24 -> V_35 -> V_36 [ 0 ] +
V_24 -> V_64 * V_24 -> V_63 ) ;
V_131 = ( int ) ( V_146 - V_24 -> V_35 -> V_36 [ 0 ] ) ;
V_71 = V_131 >> V_98 ;
V_24 -> V_29 [ V_71 ] = V_39 ;
}
...
int V_71 ;
struct V_39 * V_39 ;
F_141 (bit, rbio->dbitmap, rbio->stripe_npages) {
for ( V_11 = 0 ; V_11 < V_24 -> V_73 ; V_11 ++ ) {
V_71 = V_11 * V_24 -> V_72 + V_184 ;
if ( V_24 -> V_30 [ V_71 ] )
continue;
V_39 = F_88 ( V_107 | V_114 ) ;
if ( ! V_39 )
...
struct V_102 * V_35 = V_24 -> V_35 ;
void * V_135 [ V_24 -> V_73 ] ;
F_142 ( V_186 , V_24 -> V_72 ) ;
int V_63 = V_24 -> V_63 ;
int V_70 ;
int V_94 ;
int V_136 = - 1 ;
int V_137 = - 1 ;
struct V_39 * V_187 = NULL ;
...
if ( V_35 -> V_104 && V_35 -> V_142 [ V_24 -> V_182 ] ) {
V_189 = 1 ;
F_138 ( V_186 , V_24 -> V_110 , V_24 -> V_72 ) ;
}
F_60 ( V_32 , & V_24 -> V_33 ) ;
if ( ! V_185 )
goto V_190;
V_187 = F_88 ( V_107 | V_114 ) ;
if ( ! V_187 )
goto V_140;
F_13 ( V_187 ) ;
if ( V_137 != - 1 ) {
V_188 = F_88 ( V_107 | V_114 ) ;
if ( ! V_188 ) {
F_20 ( V_187 ) ;
goto V_140;
}
...
F_86 ( & V_24 -> error , 0 ) ;
F_141 (pagenr, rbio->dbitmap, rbio->stripe_npages) {
struct V_39 * V_97 ;
void * V_191 ;
for ( V_70 = 0 ; V_70 < V_63 ; V_70 ++ ) {
V_97 = F_79 ( V_24 , V_70 , V_94 , 0 ) ;
...
V_135 [ V_70 ++ ] = F_11 ( V_187 ) ;
if ( V_137 != - 1 ) {
V_135 [ V_70 ++ ] = F_11 ( V_188 ) ;
V_138 . V_139 ( V_24 -> V_73 , V_31 ,
V_135 ) ;
} else {
memcpy ( V_135 [ V_63 ] , V_135 [ 0 ] , V_31 ) ;
...
V_97 = F_52 ( V_24 , V_24 -> V_182 , V_94 ) ;
V_191 = F_11 ( V_97 ) ;
if ( memcmp ( V_191 , V_135 [ V_24 -> V_182 ] , V_31 ) )
memcpy ( V_191 , V_135 [ V_24 -> V_182 ] , V_31 ) ;
else
F_143 ( V_24 -> V_110 , V_94 , 1 ) ;
F_12 ( V_97 ) ;
for ( V_70 = 0 ; V_70 < V_24 -> V_73 ; V_70 ++ )
F_12 ( F_79 ( V_24 , V_70 , V_94 , 0 ) ) ;
}
...
F_141 (pagenr, rbio->dbitmap, rbio->stripe_npages) {
struct V_39 * V_39 ;
V_39 = F_52 ( V_24 , V_24 -> V_182 , V_94 ) ;
V_27 = F_90 ( V_24 , & V_41 ,
V_39 , V_24 -> V_182 , V_94 , V_24 -> V_64 ) ;
if ( V_27 )
goto V_140;
}
if ( ! V_189 )
goto V_192;
F_141 (pagenr, pbitmap, rbio->stripe_npages) {
struct V_39 * V_39 ;
V_39 = F_52 ( V_24 , V_24 -> V_182 , V_94 ) ;
V_27 = F_90 ( V_24 , & V_41 , V_39 ,
V_35 -> V_142 [ V_24 -> V_182 ] ,
V_94 , V_24 -> V_64 ) ;
if ( V_27 )
goto V_140;
}
...
static inline int F_144 ( struct V_23 * V_24 , int V_70 )
{
...
if ( V_24 -> V_108 >= 0 || V_24 -> V_109 >= 0 ) {
int V_193 = 0 , V_194 = - 1 ;
if ( F_144 ( V_24 , V_24 -> V_108 ) )
V_193 ++ ;
else if ( F_146 ( V_24 -> V_108 ) )
V_194 = V_24 -> V_108 ;
if ( F_144 ( V_24 , V_24 -> V_109 ) )
V_193 ++ ;
else if ( F_146 ( V_24 -> V_109 ) )
V_194 = V_24 -> V_109 ;
if ( V_193 > V_24 -> V_35 -> V_91 - 1 )
goto V_140;
if ( V_193 == 0 ) {
F_132 ( V_24 , 0 ) ;
return;
...
static void F_147 ( struct V_87 * V_87 )
{
struct V_23 * V_24 = V_87 -> V_90 ;
if ( V_87 -> V_89 )
F_77 ( V_24 , V_87 ) ;
...
static void F_149 ( struct V_167 * V_148 )
{
struct V_23 * V_24 ;
V_24 = F_117 ( V_148 , struct V_23 , V_148 ) ;
F_148 ( V_24 ) ;
...
struct V_23 *
F_151 ( struct V_100 * V_101 , struct V_87 * V_87 ,
struct V_102 * V_35 , T_1 V_195 )
{
struct V_23 * V_24 ;
V_24 = F_84 ( V_101 , V_35 , V_195 ) ;
if ( F_123 ( V_24 ) )
return NULL ;
V_24 -> V_67 = V_69 ;
F_94 ( & V_24 -> V_41 , V_87 ) ;
...
static void F_152 ( struct V_167 * V_148 )
{
struct V_23 * V_24 ;
V_24 = F_117 ( V_148 , struct V_23 , V_148 ) ;
F_96 ( V_24 ) ;
...
F_109 ( & V_24 -> V_148 , V_149 ,
F_152 , NULL , NULL ) ;
F_110 ( V_24 -> V_47 -> V_151 , & V_24 -> V_148 ) ;
}
void F_154 ( struct V_23 * V_24 )
{
if ( ! F_55 ( V_24 ) )
F_153 ( V_24 ) ;
}
