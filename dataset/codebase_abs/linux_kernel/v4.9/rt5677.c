...
static int F_66 ( struct V_486 * V_487 ,
...
static void F_69 ( struct V_211 * V_212 , unsigned V_488 ,
int V_214 )
{
int V_274 ;
switch ( V_488 ) {
...
static int F_70 ( struct V_486 * V_487 , unsigned V_488 )
{
struct V_211 * V_212 = F_65 ( V_487 ) ;
...
return F_71 ( V_502 , V_504 ) ;
}
static void F_72 ( struct V_513 * V_514 )
{
struct V_211 * V_212 = F_73 ( V_514 ) ;
int V_218 ;
V_212 -> V_486 = V_515 ;
V_212 -> V_486 . V_516 = V_517 ;
V_212 -> V_486 . V_518 = & V_514 -> V_2 ;
V_212 -> V_486 . V_519 = - 1 ;
V_218 = F_74 ( & V_212 -> V_486 , V_212 ) ;
if ( V_218 != 0 )
F_7 ( & V_514 -> V_2 , L_17 , V_218 ) ;
}
static void F_75 ( struct V_513 * V_514 )
{
struct V_211 * V_212 = F_73 ( V_514 ) ;
F_76 ( & V_212 -> V_486 ) ;
}
...
F_69 ( V_212 , V_4 , V_212 -> V_505 . V_525 [ V_4 ] ) ;
if ( V_212 -> V_503 ) {
...
static int F_82 ( struct V_216 * V_217 )
{
struct V_211 * V_212 = F_14 ( V_217 ) ;
F_6 ( V_212 -> V_230 , V_8 , 0x10ec ) ;
F_83 ( V_212 -> V_533 , 0 ) ;
...
static int F_86 ( void * V_535 , unsigned int V_3 , unsigned int * V_271 )
{
struct V_513 * V_536 = V_535 ;
struct V_211 * V_212 = F_73 ( V_536 ) ;
if ( V_212 -> V_231 ) {
if ( V_3 > 0xff ) {
F_5 ( & V_212 -> V_532 ) ;
F_11 ( V_212 , V_107 ,
...
if ( V_218 )
F_91 ( V_2 , L_18 ) ;
if ( ! F_92 ( V_2 , L_19 , & V_271 ) )
V_212 -> V_505 . V_521 = V_271 ;
V_212 -> V_505 . V_538 = F_93 ( V_2 , L_20 ) ;
V_212 -> V_505 . V_539 = F_93 ( V_2 , L_21 ) ;
V_212 -> V_505 . V_540 = F_93 ( V_2 , L_22 ) ;
V_212 -> V_505 . V_541 = F_93 ( V_2 , L_23 ) ;
V_212 -> V_505 . V_542 = F_93 ( V_2 , L_24 ) ;
F_92 ( V_2 , L_25 , & V_212 -> V_505 . V_506 ) ;
F_92 ( V_2 , L_26 , & V_212 -> V_505 . V_509 ) ;
F_92 ( V_2 , L_27 , & V_212 -> V_505 . V_511 ) ;
}
static void F_94 ( struct V_211 * V_212 ,
struct V_1 * V_2 )
{
V_212 -> V_505 . V_538 = F_93 ( V_2 ,
L_28 ) ;
V_212 -> V_505 . V_539 = F_93 ( V_2 ,
L_29 ) ;
V_212 -> V_505 . V_540 = F_93 ( V_2 ,
L_30 ) ;
V_212 -> V_505 . V_541 = F_93 ( V_2 ,
L_31 ) ;
V_212 -> V_505 . V_542 = F_93 ( V_2 ,
L_32 ) ;
F_95 ( V_2 , L_33 ,
...
V_218 = F_97 ( V_212 -> V_230 , V_514 -> V_504 ,
V_543 | V_544 | V_545 , 0 ,
& V_546 , & V_212 -> V_503 ) ;
if ( V_218 != 0 ) {
F_7 ( & V_514 -> V_2 , L_38 , V_218 ) ;
return V_218 ;
}
return 0 ;
}
static void F_98 ( struct V_513 * V_514 )
{
struct V_211 * V_212 = F_73 ( V_514 ) ;
if ( V_212 -> V_503 )
F_99 ( V_514 -> V_504 , V_212 -> V_503 ) ;
}
static int F_100 ( struct V_513 * V_514 ,
const struct V_547 * V_393 )
{
struct V_548 * V_505 = F_101 ( & V_514 -> V_2 ) ;
struct V_211 * V_212 ;
int V_218 ;
unsigned int V_271 ;
V_212 = F_102 ( & V_514 -> V_2 , sizeof( struct V_211 ) ,
V_549 ) ;
if ( V_212 == NULL )
return - V_550 ;
F_103 ( V_514 , V_212 ) ;
V_212 -> type = V_393 -> V_551 ;
if ( V_505 )
V_212 -> V_505 = * V_505 ;
else if ( V_514 -> V_2 . V_552 )
F_94 ( V_212 , & V_514 -> V_2 ) ;
else if ( F_104 ( & V_514 -> V_2 ) )
F_88 ( V_212 , & V_514 -> V_2 ) ;
else
return - V_304 ;
V_212 -> V_533 = F_105 ( & V_514 -> V_2 ,
L_39 , V_553 ) ;
if ( F_106 ( V_212 -> V_533 ) ) {
V_218 = F_107 ( V_212 -> V_533 ) ;
F_7 ( & V_514 -> V_2 , L_40 , V_218 ) ;
return V_218 ;
}
V_212 -> V_534 = F_105 ( & V_514 -> V_2 ,
L_41 , V_554 ) ;
if ( F_106 ( V_212 -> V_534 ) ) {
V_218 = F_107 ( V_212 -> V_534 ) ;
F_7 ( & V_514 -> V_2 , L_42 , V_218 ) ;
return V_218 ;
}
if ( V_212 -> V_533 || V_212 -> V_534 ) {
F_50 ( 10 ) ;
}
V_212 -> V_220 = F_108 ( V_514 ,
& V_555 ) ;
if ( F_106 ( V_212 -> V_220 ) ) {
V_218 = F_107 ( V_212 -> V_220 ) ;
F_7 ( & V_514 -> V_2 , L_43 ,
V_218 ) ;
return V_218 ;
}
V_212 -> V_230 = F_109 ( & V_514 -> V_2 , NULL , V_514 , & V_556 ) ;
if ( F_106 ( V_212 -> V_230 ) ) {
V_218 = F_107 ( V_212 -> V_230 ) ;
F_7 ( & V_514 -> V_2 , L_43 ,
V_218 ) ;
return V_218 ;
}
...
F_6 ( V_212 -> V_230 , V_8 , 0x10ec ) ;
V_218 = F_110 ( V_212 -> V_230 , V_559 ,
F_2 ( V_559 ) ) ;
if ( V_218 != 0 )
F_91 ( & V_514 -> V_2 , L_45 , V_218 ) ;
...
if ( V_212 -> V_505 . V_569 )
F_15 ( V_212 -> V_230 , V_38 ,
V_570 ,
V_571 ) ;
F_72 ( V_514 ) ;
F_96 ( V_514 ) ;
return F_111 ( & V_514 -> V_2 , & V_572 ,
V_573 , F_2 ( V_573 ) ) ;
}
static int F_112 ( struct V_513 * V_514 )
{
F_113 ( & V_514 -> V_2 ) ;
F_98 ( V_514 ) ;
F_75 ( V_514 ) ;
