...
V_28 = F_10 ( V_7 ) ;
if ( ( V_28 & V_41 ) == 0 )
F_71 ( V_7 -> V_7 , L_24 , V_28 ) ;
if ( ( V_28 & V_42 ) == V_42 )
F_71 ( V_7 -> V_7 , L_25 , V_28 ) ;
if ( ! V_111 ) {
F_25 ( V_7 ) ;
if ( V_2 -> V_32 ) {
V_22 = F_59 ( V_7 ) ;
...
static bool F_84 ( struct V_18 * V_19 )
{
T_1 V_11 ;
unsigned int V_128 ;
V_128 = F_85 ( F_86 ( V_19 -> V_128 ) , 0 ) ;
F_87 ( V_19 -> V_129 , V_128 , V_31 , & V_11 ) ;
F_19 ( & V_19 -> V_7 , L_5 , V_31 , V_11 ) ;
return ( V_11 & 0xf0000 ) == 0xf0000 ;
}
struct V_6 * F_88 ( struct V_18 * V_19 ,
const struct V_130 * V_21 )
{
struct V_6 * V_7 ;
struct V_1 * V_2 ;
V_7 = F_89 ( sizeof( struct V_6 ) +
sizeof( struct V_1 ) , V_131 ) ;
if ( ! V_7 )
return NULL ;
V_2 = F_6 ( V_7 ) ;
F_90 ( V_7 , & V_19 -> V_7 , & V_132 ) ;
V_2 -> V_21 = V_21 ;
return V_7 ;
}
