...
return V_46 ;
V_61 -> V_97 = V_4 [ 0 ] ;
F_10 ( V_3 -> V_28 , L_15 , V_61 -> V_97 ) ;
V_47 [ 0 ] = V_98 ;
V_46 = F_22 ( V_3 , V_47 , 1 , V_47 [ 0 ] , 0 ) ;
if ( V_46 )
return V_46 ;
strncpy ( V_61 -> V_99 , V_4 , 13 ) ;
F_10 ( V_3 -> V_28 , L_16 , V_61 -> V_99 ) ;
return 0 ;
}
...
static int F_31 ( struct V_100 * V_6 , bool V_101 )
{
struct V_3 * V_3 = V_6 -> V_102 ;
T_2 V_47 [ 16 ] ;
int V_46 ;
V_47 [ 0 ] = V_52 ;
V_47 [ 1 ] = V_101 ;
...
static int F_32 ( struct V_100 * V_6 , T_2 V_103 )
{
struct V_3 * V_3 = V_6 -> V_102 ;
T_3 V_104 = 0 ;
T_3 V_62 = V_6 -> V_105 ;
...
V_39 , 0 ) ;
if ( ( V_46 && V_104 != 0 ) || V_3 -> V_109 )
goto V_59;
V_47 [ 0 ] = V_53 ;
V_47 [ 1 ] = V_103 == V_107 ? 0 : 1 ;
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 0 ) ;
if ( V_46 )
goto V_59;
...
goto V_59;
V_47 [ 0 ] = V_121 ;
V_47 [ 1 ] = V_6 -> V_61 . V_97 ;
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 0 ) ;
if ( V_46 )
goto V_59;
if ( V_6 -> V_61 . V_99 [ 0 ] ) {
T_5 V_122 = strlen ( V_6 -> V_61 . V_99 ) ;
char * V_123 = V_47 + 1 ;
V_47 [ 0 ] = V_124 ;
strncpy ( V_47 + 1 , V_6 -> V_61 . V_99 , 13 ) ;
if ( V_122 < 4 ) {
memset ( V_123 + V_122 , ' ' , 4 - V_122 ) ;
V_122 = 4 ;
V_123 [ V_122 ] = '\0' ;
strcpy ( V_6 -> V_61 . V_99 , V_123 ) ;
}
V_46 = F_22 ( V_3 , V_47 , 1 + V_122 ,
V_39 , 0 ) ;
if ( V_46 )
goto V_59;
}
...
static int F_33 ( struct V_100 * V_6 , T_2 V_126 ,
T_6 V_127 , struct V_25 * V_26 )
{
struct V_3 * V_3 = V_6 -> V_102 ;
T_2 V_47 [ 2 ] ;
unsigned int V_128 ;
...
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
V_47 [ 0 ] = V_26 -> V_32 == 1 ? V_131 : V_132 ;
V_47 [ 1 ] = V_26 -> V_26 [ 0 ] ;
if ( ! V_46 )
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
if ( ! V_46 && V_26 -> V_32 > 1 ) {
V_47 [ 0 ] = V_26 -> V_32 == 2 ? V_131 :
V_132 ;
V_47 [ 1 ] = V_26 -> V_26 [ 1 ] ;
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
for ( V_128 = 0 ; ! V_46 && V_128 + 2 < V_26 -> V_32 ; V_128 ++ ) {
V_47 [ 0 ] = ( V_128 + 2 == V_26 -> V_32 - 1 ) ?
V_131 : V_132 ;
V_47 [ 1 ] = V_26 -> V_26 [ V_128 + 2 ] ;
V_46 = F_22 ( V_3 , V_47 , 2 ,
V_39 , 1 ) ;
}
}
...
static int F_35 ( struct V_100 * V_6 , struct V_25 * V_26 )
{
return - V_133 ;
}
static int F_36 ( struct V_16 * V_16 , struct V_134 * V_135 )
{
T_6 V_136 = V_137 | V_138 | V_139 |
V_140 | V_141 | V_142 ;
struct V_3 * V_3 ;
int V_46 = - V_143 ;
struct V_60 V_61 = {} ;
T_3 V_62 = V_67 ;
V_3 = F_37 ( sizeof( * V_3 ) , V_144 ) ;
if ( ! V_3 )
return - V_143 ;
V_3 -> V_16 = V_16 ;
V_3 -> V_6 = F_38 ( & V_145 , V_3 ,
L_17 , V_136 , 1 , & V_16 -> V_28 ) ;
V_46 = F_39 ( V_3 -> V_6 ) ;
if ( V_46 < 0 )
goto V_146;
V_3 -> V_28 = & V_16 -> V_28 ;
