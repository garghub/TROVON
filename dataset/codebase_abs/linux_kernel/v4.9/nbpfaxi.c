...
static T_5 F_88 ( int V_167 , void * V_8 )
{
struct V_1 * V_2 = V_8 ;
bool V_132 = F_9 ( V_2 ) ;
struct V_23 * V_24 ;
...
static T_5 F_93 ( int V_167 , void * V_8 )
{
struct V_10 * V_11 = V_8 ;
T_1 error = F_12 ( V_11 ) ;
F_94 ( V_11 -> V_12 . V_8 , L_18 , V_167 ) ;
if ( ! error )
return V_169 ;
do {
...
static int F_95 ( struct V_10 * V_11 , int V_172 )
{
struct V_173 * V_12 = & V_11 -> V_12 ;
struct V_1 * V_2 = V_11 -> V_2 + V_172 ;
int V_130 ;
V_2 -> V_11 = V_11 ;
V_2 -> V_5 = V_11 -> V_5 + V_174 + V_175 * V_172 ;
F_52 ( & V_2 -> V_125 ) ;
F_96 ( & V_2 -> V_97 ) ;
V_2 -> V_6 . V_7 = V_12 ;
F_97 ( & V_2 -> V_6 ) ;
F_21 ( V_2 ) ;
F_3 ( V_12 -> V_8 , L_19 , V_9 , V_172 , V_2 -> V_5 ) ;
snprintf ( V_2 -> V_162 , sizeof( V_2 -> V_162 ) , L_20 , V_172 ) ;
F_98 ( & V_2 -> V_171 , F_84 , ( unsigned long ) V_2 ) ;
V_130 = F_99 ( V_12 -> V_8 , V_2 -> V_167 ,
F_88 , V_176 ,
V_2 -> V_162 , V_2 ) ;
if ( V_130 < 0 )
return V_130 ;
...
static int F_100 ( struct V_179 * V_180 )
{
struct V_7 * V_8 = & V_180 -> V_8 ;
const struct V_181 * V_182 = F_101 ( V_183 , V_8 ) ;
struct V_177 * V_161 = V_8 -> V_184 ;
struct V_10 * V_11 ;
struct V_173 * V_12 ;
struct V_185 * V_186 , * V_187 ;
const struct F_69 * V_188 ;
int V_189 ;
int V_130 , V_167 , V_190 , V_19 ;
int V_191 [ 9 ] ;
unsigned int V_192 = 0 ;
F_102 ( sizeof( struct V_114 ) > V_193 ) ;
if ( ! V_161 || ! V_182 || ! V_182 -> V_4 )
return - V_194 ;
V_188 = V_182 -> V_4 ;
V_189 = V_188 -> V_189 ;
V_11 = F_103 ( V_8 , sizeof( * V_11 ) + V_189 *
sizeof( V_11 -> V_2 [ 0 ] ) , V_116 ) ;
if ( ! V_11 )
return - V_120 ;
V_12 = & V_11 -> V_12 ;
V_12 -> V_8 = V_8 ;
V_186 = F_104 ( V_180 , V_195 , 0 ) ;
V_11 -> V_5 = F_105 ( V_8 , V_186 ) ;
if ( F_106 ( V_11 -> V_5 ) )
return F_107 ( V_11 -> V_5 ) ;
V_11 -> V_196 = F_108 ( V_8 , NULL ) ;
if ( F_106 ( V_11 -> V_196 ) )
return F_107 ( V_11 -> V_196 ) ;
V_11 -> V_35 = V_188 ;
for ( V_19 = 0 ; V_192 < F_49 ( V_191 ) ; V_19 ++ ) {
V_187 = F_104 ( V_180 , V_197 , V_19 ) ;
if ( ! V_187 )
break;
for ( V_167 = V_187 -> V_198 ; V_167 <= V_187 -> V_199 ;
V_167 ++ , V_192 ++ )
V_191 [ V_192 ] = V_167 ;
}
if ( V_192 != 1 && V_192 != 2 && V_192 != V_189 + 1 )
return - V_200 ;
if ( V_192 == 1 ) {
V_190 = V_191 [ 0 ] ;
for ( V_19 = 0 ; V_19 <= V_189 ; V_19 ++ )
V_11 -> V_2 [ V_19 ] . V_167 = V_191 [ 0 ] ;
} else {
V_190 = F_109 ( V_180 , L_21 ) ;
if ( V_190 < 0 )
return V_190 ;
if ( V_192 == V_189 + 1 ) {
struct V_1 * V_2 ;
for ( V_19 = 0 , V_2 = V_11 -> V_2 ; V_19 <= V_189 ;
V_19 ++ , V_2 ++ ) {
if ( V_191 [ V_19 ] == V_190 )
V_19 ++ ;
V_2 -> V_167 = V_191 [ V_19 ] ;
}
if ( V_2 != V_11 -> V_2 + V_189 )
return - V_90 ;
} else {
if ( V_191 [ 0 ] == V_190 )
V_167 = V_191 [ 1 ] ;
...
V_167 = V_191 [ 0 ] ;
for ( V_19 = 0 ; V_19 <= V_189 ; V_19 ++ )
V_11 -> V_2 [ V_19 ] . V_167 = V_167 ;
}
}
V_130 = F_99 ( V_8 , V_190 , F_93 ,
V_176 , L_22 , V_11 ) ;
if ( V_130 < 0 )
return V_130 ;
V_11 -> V_190 = V_190 ;
F_52 ( & V_12 -> V_178 ) ;
for ( V_19 = 0 ; V_19 < V_189 ; V_19 ++ ) {
V_130 = F_95 ( V_11 , V_19 ) ;
if ( V_130 < 0 )
return V_130 ;
}
F_110 ( V_201 , V_12 -> V_202 ) ;
F_110 ( V_203 , V_12 -> V_202 ) ;
F_110 ( V_204 , V_12 -> V_202 ) ;
F_110 ( V_205 , V_12 -> V_202 ) ;
V_12 -> V_206
= F_78 ;
V_12 -> V_207 = F_79 ;
V_12 -> V_208 = F_76 ;
...
V_12 -> V_216 = V_217 ;
V_12 -> V_218 = V_217 ;
V_12 -> V_219 = F_10 ( V_76 ) | F_10 ( V_84 ) ;
F_111 ( V_180 , V_11 ) ;
V_130 = F_112 ( V_11 -> V_196 ) ;
if ( V_130 < 0 )
return V_130 ;
F_32 ( V_11 ) ;
V_130 = F_113 ( V_12 ) ;
...
{
struct V_10 * V_11 = F_118 ( V_180 ) ;
int V_19 ;
F_119 ( & V_180 -> V_8 , V_11 -> V_190 , V_11 ) ;
for ( V_19 = 0 ; V_19 < V_11 -> V_35 -> V_189 ; V_19 ++ ) {
struct V_1 * V_2 = V_11 -> V_2 + V_19 ;
F_119 ( & V_180 -> V_8 , V_2 -> V_167 , V_2 ) ;
F_120 ( & V_2 -> V_171 ) ;
}
F_121 ( V_180 -> V_8 . V_184 ) ;
F_115 ( & V_11 -> V_12 ) ;
F_116 ( V_11 -> V_196 ) ;
return 0 ;
}
...
{
struct V_10 * V_11 = F_118 ( F_123 ( V_8 ) ) ;
F_116 ( V_11 -> V_196 ) ;
return 0 ;
}
