...
static int F_203 ( struct V_30 * V_31 )
{
struct V_578 * V_585 ;
struct V_586 * V_587 ;
struct V_588 * V_488 ;
...
static int F_204 ( struct V_30 * V_31 , struct V_595 * V_596 )
{
struct V_578 * V_585 ;
struct V_586 * V_587 ;
struct V_588 * V_488 ;
...
F_206 ( V_596 , L_11 , V_587 -> V_598 [ V_358 ] ) ;
F_207 ( V_596 , '\n' ) ;
F_206 ( V_596 , L_135 , V_587 -> V_593 ) ;
memcpy ( & V_597 , & V_587 -> V_599 , sizeof( V_597 ) - 1 ) ;
F_25 ( V_597 , sizeof( V_597 ) ) ;
F_206 ( V_596 , L_136 , V_597 ) ;
F_206 ( V_596 , L_137 , V_587 -> V_600 ) ;
F_206 ( V_596 , L_138 , ( unsigned long )
V_587 -> V_601 ) ;
}
F_47 ( V_585 ) ;
return 0 ;
...
static int
F_208 ( struct V_30 * V_31 , int V_602 ,
T_1 V_603 ,
struct V_604 * V_605 ,
struct V_606 V_607 )
{
...
static struct V_218 * F_209 ( struct V_30 * V_31 ,
T_2 V_576 ,
struct V_614 * V_615 )
{
struct V_32 * V_33 = V_31 -> V_33 ;
...
static int F_210 ( struct V_30 * V_31 , T_2 V_576 ,
struct V_614 * V_615 )
{
struct V_32 * V_33 = V_31 -> V_33 ;
struct V_218 * V_618 ;
...
return V_576 ;
V_618 = F_209 ( V_31 , V_576 , V_615 ) ;
V_211 = 8 - F_211 ( V_615 -> V_623 ) ;
...
static void F_212 ( struct V_30 * V_31 ,
unsigned long V_626 ,
...
F_212 ( V_31 , V_626 , V_607 , V_628 ) ;
return 0 ;
V_346:
return V_622 ;
}
static int F_218 ( struct V_30 * V_31 , T_2 V_576 ,
struct V_606 V_607 ,
struct V_614 * V_615 )
{
struct V_32 * V_33 = V_31 -> V_33 ;
...
F_212 ( V_31 , V_626 , V_607 , V_629 ) ;
return 0 ;
}
static void F_220 ( struct V_30 * V_31 , void * V_575 ,
T_2 V_576 )
{
...
( ( T_3 * ) V_615 ) [ 3 ] ) ;
F_221 ( V_31 -> V_2 , & V_607 ) ;
V_211 = F_53 ( V_576 ) ;
V_605 = F_213 ( V_31 -> V_2 , V_211 ) ;
if ( V_615 -> V_633 == V_628 ) {
if ( F_217 ( V_31 , V_576 , V_607 , V_615 ) )
V_602 = V_634 ;
else
V_602 = V_635 ;
} else if ( V_615 -> V_633 == V_629 ) {
F_218 ( V_31 , V_576 , V_607 , V_615 ) ;
V_602 = V_635 ;
} else
V_602 = V_636 ;
F_208 ( V_31 , V_602 ,
...
static void F_222 ( struct V_228 * V_229 )
{
struct V_639 * V_29 ;
struct V_574 * V_575 ;
struct V_30 * V_31 ;
...
V_575 -> V_120 == V_641 )
F_220 ( V_31 , V_575 , V_29 -> V_576 ) ;
V_372:
F_64 ( V_31 ) ;
F_47 ( V_575 ) ;
F_47 ( V_29 ) ;
}
static int F_223 ( struct V_30 * V_31 , T_2 V_576 )
{
struct V_639 * V_29 ;
V_29 = F_42 ( sizeof( * V_29 ) , V_240 ) ;
if ( ! V_29 )
return - V_197 ;
F_69 ( & V_29 -> V_233 , F_222 ) ;
F_70 ( V_31 ) ;
V_29 -> V_31 = V_31 ;
V_29 -> V_576 = V_576 ;
F_62 ( & V_29 -> V_233 ) ;
