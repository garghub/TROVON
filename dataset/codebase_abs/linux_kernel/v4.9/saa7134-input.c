...
V_4 -> V_14 = V_14 ;
V_4 -> V_44 = V_44 ;
snprintf ( V_4 -> V_168 , sizeof( V_4 -> V_168 ) , L_13 ,
V_169 [ V_2 -> V_8 ] . V_168 ) ;
snprintf ( V_4 -> V_170 , sizeof( V_4 -> V_170 ) , L_14 ,
F_45 ( V_2 -> V_171 ) ) ;
V_71 -> V_47 = V_2 ;
V_71 -> V_172 = F_39 ;
V_71 -> V_173 = F_40 ;
if ( V_44 )
V_71 -> V_174 = V_175 ;
V_71 -> V_176 = V_4 -> V_168 ;
V_71 -> V_177 = V_4 -> V_170 ;
V_71 -> V_178 . V_179 = V_180 ;
V_71 -> V_178 . V_181 = 1 ;
if ( V_2 -> V_171 -> V_182 ) {
V_71 -> V_178 . V_183 = V_2 -> V_171 -> V_182 ;
V_71 -> V_178 . V_184 = V_2 -> V_171 -> V_185 ;
} else {
V_71 -> V_178 . V_183 = V_2 -> V_171 -> V_183 ;
V_71 -> V_178 . V_184 = V_2 -> V_171 -> V_186 ;
}
V_71 -> V_2 . V_187 = & V_2 -> V_171 -> V_2 ;
V_71 -> V_188 = V_72 ;
V_71 -> V_189 = V_190 ;
V_73 = F_46 ( V_71 ) ;
if ( V_73 )
...
F_52 ( V_192 . type , L_16 , V_199 ) ;
switch ( V_2 -> V_8 ) {
case V_200 :
case V_201 :
V_2 -> V_198 . V_168 = L_17 ;
if ( V_202 == 0 ) {
V_2 -> V_198 . V_203 = F_24 ;
V_2 -> V_198 . V_72 = V_204 ;
V_192 . V_34 = 0x47 ;
} else {
V_2 -> V_198 . V_203 = F_23 ;
V_2 -> V_198 . V_72 = V_205 ;
V_192 . V_34 = 0x47 ;
}
break;
case V_206 :
V_2 -> V_198 . V_168 = L_18 ;
V_2 -> V_198 . V_203 = F_16 ;
V_2 -> V_198 . V_72 = V_207 ;
V_192 . V_34 = 0x7a ;
break;
case V_208 :
V_2 -> V_198 . V_168 = L_19 ;
V_2 -> V_198 . V_203 = F_14 ;
V_2 -> V_198 . V_72 = V_209 ;
V_2 -> V_198 . V_210 = 50 ;
V_192 . V_34 = 0x30 ;
V_71 = F_53 ( & V_2 -> V_211 , & V_194 , 1 ) ;
F_6 ( L_20 ,
V_194 . V_34 , V_2 -> V_211 . V_168 ,
( 1 == V_71 ) ? L_21 : L_22 ) ;
break;
case V_212 :
V_2 -> V_198 . V_168 = L_23 ;
V_2 -> V_198 . V_203 = F_14 ;
V_2 -> V_198 . V_72 = V_209 ;
V_2 -> V_198 . V_210 = 50 ;
V_192 . V_34 = 0x30 ;
...
break;
case V_213 :
V_2 -> V_198 . V_168 = L_24 ;
V_2 -> V_198 . V_203 = F_15 ;
V_2 -> V_198 . V_72 = V_214 ;
V_192 . V_34 = 0x30 ;
V_71 = F_53 ( & V_2 -> V_211 , & V_194 , 1 ) ;
F_6 ( L_20 ,
V_194 . V_34 , V_2 -> V_211 . V_168 ,
...
break;
case V_215 :
V_2 -> V_198 . V_168 = L_25 ;
V_2 -> V_198 . V_203 = F_17 ;
V_2 -> V_198 . V_72 = V_162 ;
V_192 . V_34 = 0x71 ;
break;
case V_216 :
case V_217 :
...
case V_229 :
case V_230 :
V_2 -> V_198 . V_168 = L_26 ;
V_2 -> V_198 . V_203 = F_19 ;
V_2 -> V_198 . V_72 = V_231 ;
V_2 -> V_198 . type = V_232 ;
V_192 . V_34 = 0x2d ;
break;
case V_233 :
case V_234 :
...
break;
case V_236 :
V_2 -> V_198 . V_168 = L_27 ;
V_2 -> V_198 . V_203 = F_9 ;
V_2 -> V_198 . V_72 = V_135 ;
V_192 . V_34 = 0x0b ;
break;
default:
F_6 ( L_28 , V_2 -> V_8 ) ;
...
if ( V_2 -> V_198 . V_168 )
V_192 . V_237 = & V_2 -> V_198 ;
F_54 ( & V_2 -> V_211 , & V_192 ) ;
}
...
F_3 ( V_11 , V_12 ) ;
F_2 ( V_11 , V_12 ) ;
V_239 = F_4 ( V_13 >> 2 ) & V_4 -> V_19 ;
F_55 ( V_2 -> V_5 -> V_2 , V_239 ? V_240 : V_241 ) ;
F_56 () ;
if ( ! F_57 ( & V_4 -> V_45 ) ) {
V_238 = V_46 + F_29 ( 15 ) ;
F_28 ( & V_4 -> V_45 , V_238 ) ;
