...
if ( V_105 == NULL )
return - V_110 ;
V_109 = F_61 ( V_107 , V_108 , V_105 , V_111 ) ;
if ( V_109 < 0 )
return V_109 ;
if ( V_107 [ V_112 ] ) {
...
V_2 -> V_26 = V_130 ;
F_65 ( V_86 ) ;
F_73 ( & V_14 -> V_96 , & V_2 -> V_97 ) ;
F_74 ( & V_2 -> V_131 , & V_7 -> V_129 ) ;
if ( V_7 -> V_24 == 0 )
F_48 ( V_86 , V_7 ) ;
F_51 ( V_7 ) ;
F_66 ( V_86 ) ;
...
static void
F_76 ( struct V_85 * V_86 , struct V_1 * V_2 )
{
struct V_13 * V_14 = F_54 ( V_86 ) ;
F_77 ( & V_2 -> V_132 ) ;
F_78 ( V_2 -> V_81 ) ;
F_79 ( & V_2 -> V_117 , & V_2 -> V_118 ) ;
if ( V_2 != & V_14 -> V_120 )
F_70 ( V_2 ) ;
}
static int
F_80 ( struct V_85 * V_86 , unsigned long V_104 )
{
struct V_13 * V_14 = F_54 ( V_86 ) ;
struct V_1 * V_2 = (struct V_1 * ) V_104 ;
...
F_51 ( V_2 -> V_18 ) ;
F_48 ( V_86 , V_2 ) ;
F_82 ( & V_14 -> V_96 , & V_2 -> V_97 ) ;
F_83 ( -- V_2 -> V_125 == 0 ) ;
F_66 ( V_86 ) ;
return 0 ;
}
static struct V_1 *
F_84 ( struct V_87 * V_88 , struct V_85 * V_86 , int * V_135 )
{
struct V_13 * V_14 = F_54 ( V_86 ) ;
...
* V_135 = V_143 | V_144 ;
V_136 = & V_14 -> V_120 ;
V_140 = F_85 ( V_14 -> V_120 . V_132 ) ;
while ( V_140 && ( V_141 = F_86 ( V_88 , V_140 , & V_138 , false ) ) >= 0 ) {
#ifdef F_87
switch ( V_141 ) {
case V_145 :
case V_146 :
...
if ( V_2 -> V_24 == 0 )
return V_2 ;
V_140 = F_85 ( V_2 -> V_132 ) ;
V_136 = V_2 ;
}
V_2 = F_53 ( F_88 ( F_67 ( V_86 -> V_122 ) , V_14 -> V_150 ) , V_86 ) ;
if ( V_2 == NULL || V_2 -> V_24 > 0 )
return NULL ;
return V_2 ;
}
static int
F_89 ( struct V_85 * V_86 , unsigned long V_104 , struct V_85 * V_151 ,
struct V_85 * * V_152 )
{
struct V_1 * V_2 = (struct V_1 * ) V_104 ;
if ( V_2 -> V_24 > 0 )
...
* V_152 = F_90 ( V_86 , V_151 , & V_2 -> V_81 ) ;
return 0 ;
}
static struct V_85 *
F_91 ( struct V_85 * V_86 , unsigned long V_104 )
{
struct V_1 * V_2 = (struct V_1 * ) V_104 ;
if ( V_2 -> V_24 == 0 )
return V_2 -> V_81 ;
...
F_93 ( struct V_85 * V_86 , T_2 V_93 )
{
...
static unsigned long
F_95 ( struct V_85 * V_86 , unsigned long V_7 , T_2 V_93 )
{
...
static int
F_98 ( struct V_87 * V_88 , int V_153 , struct V_44 * V_43 )
{
struct V_42 V_154 ;
V_154 . V_47 = F_26 ( V_43 -> V_46 ) ;
V_154 . V_39 = F_27 ( V_43 -> V_40 ) ;
V_154 . V_51 = F_26 ( V_43 -> V_50 ) ;
if ( F_99 ( V_88 , V_153 , sizeof( V_154 ) , & V_154 ) )
goto V_155;
return V_88 -> V_62 ;
V_155:
return - 1 ;
...
static int
F_100 ( struct V_87 * V_88 , struct V_1 * V_2 )
{
if ( ( V_2 -> V_75 & V_84 ) &&
( F_98 ( V_88 , V_112 , & V_2 -> V_59 ) < 0 ) )
goto V_155;
if ( ( V_2 -> V_75 & V_83 ) &&
( F_98 ( V_88 , V_113 , & V_2 -> V_72 ) < 0 ) )
goto V_155;
if ( ( V_2 -> V_75 & V_76 ) &&
( F_98 ( V_88 , V_114 , & V_2 -> V_78 ) < 0 ) )
goto V_155;
return V_88 -> V_62 ;
V_155:
return - 1 ;
...
static int
F_101 ( struct V_85 * V_86 , unsigned long V_104 , struct V_87 * V_88 ,
struct V_156 * V_157 )
{
struct V_1 * V_2 = (struct V_1 * ) V_104 ;
struct V_102 * V_158 ;
...
V_158 = F_102 ( V_88 , V_106 ) ;
if ( V_158 == NULL )
goto V_155;
if ( F_100 ( V_88 , V_2 ) < 0 )
goto V_155;
return F_103 ( V_88 , V_158 ) ;
V_155:
F_104 ( V_88 , V_158 ) ;
return - V_162 ;
}
static int
F_105 ( struct V_85 * V_86 , unsigned long V_104 ,
struct V_163 * V_39 )
{
struct V_1 * V_2 = (struct V_1 * ) V_104 ;
struct V_164 V_165 ;
...
if ( F_106 ( F_64 ( V_86 ) , V_39 , NULL , & V_2 -> V_117 ) < 0 ||
F_107 ( V_39 , & V_2 -> V_117 , & V_2 -> V_118 ) < 0 ||
F_108 ( V_39 , NULL , & V_2 -> V_92 , V_2 -> V_81 -> V_14 . V_82 ) < 0 )
return - 1 ;
return F_109 ( V_39 , & V_165 , sizeof( V_165 ) ) ;
}
static void
F_110 ( struct V_85 * V_86 , struct V_169 * V_104 )
{
struct V_13 * V_14 = F_54 ( V_86 ) ;
struct V_1 * V_2 ;
unsigned int V_170 ;
...
F_113 ( V_176 == 0 ) ;
F_114 ( & V_14 -> V_177 , V_176 ) ;
}
static int
F_115 ( struct V_85 * V_86 , struct V_102 * V_105 )
{
struct V_13 * V_14 = F_54 ( V_86 ) ;
struct V_178 * V_179 ;
int V_109 ;
if ( V_105 == NULL || F_116 ( V_105 ) < sizeof( * V_179 ) )
return - V_110 ;
V_179 = F_62 ( V_105 ) ;
V_14 -> V_150 = V_179 -> V_150 ;
V_109 = F_117 ( & V_14 -> V_96 ) ;
if ( V_109 < 0 )
return V_109 ;
V_14 -> V_6 = V_130 ;
...
F_72 ( & V_14 -> V_120 . V_129 ) ;
V_14 -> V_120 . V_19 = V_130 ;
V_14 -> V_120 . V_26 = V_130 ;
F_73 ( & V_14 -> V_96 , & V_14 -> V_120 . V_97 ) ;
F_75 ( V_86 , & V_14 -> V_96 ) ;
F_118 ( & V_14 -> V_177 , V_86 ) ;
return 0 ;
}
static int
F_119 ( struct V_85 * V_86 , struct V_102 * V_105 )
{
struct V_13 * V_14 = F_54 ( V_86 ) ;
struct V_178 * V_179 ;
if ( V_105 == NULL || F_116 ( V_105 ) < sizeof( * V_179 ) )
...
{
struct V_13 * V_14 = F_54 ( V_86 ) ;
unsigned char * V_182 = F_127 ( V_88 ) ;
struct V_178 V_179 ;
V_179 . V_150 = V_14 -> V_150 ;
if ( F_99 ( V_88 , V_106 , sizeof( V_179 ) , & V_179 ) )
goto V_155;
return V_88 -> V_62 ;
V_155:
F_128 ( V_88 , V_182 ) ;
...
static int
F_129 ( struct V_87 * V_88 , struct V_85 * V_86 , struct V_87 * * V_183 )
{
struct V_1 * V_2 ;
int V_184 ( V_109 ) ;
V_2 = F_84 ( V_88 , V_86 , & V_109 ) ;
if ( V_2 == NULL ) {
if ( V_109 & V_144 )
F_130 ( V_86 ) ;
F_131 ( V_88 , V_183 ) ;
...
V_109 = F_132 ( V_88 , V_2 -> V_81 , V_183 ) ;
if ( F_45 ( V_109 != V_143 ) ) {
if ( F_133 ( V_109 ) ) {
V_2 -> V_92 . V_185 ++ ;
F_130 ( V_86 ) ;
