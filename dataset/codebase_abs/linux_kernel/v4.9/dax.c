...
static int F_75 ( struct V_9 * V_10 , T_4 V_24 , T_8 V_22 ,
struct V_19 * V_102 , unsigned long V_103 )
{
struct V_11 V_12 = {
. V_24 = V_24 ,
. V_22 = V_22 ,
...
struct V_9 * V_10 , T_4 V_24 , T_8 V_22 ,
void * * V_137 , struct V_138 * V_139 , struct V_95 * V_96 )
{
...
if ( F_16 ( & V_27 ) )
error = F_75 ( V_27 . V_52 , F_20 ( & V_27 , V_29 ) ,
V_27 . V_50 , V_150 , V_103 ) ;
else
F_103 ( V_150 , V_103 ) ;
if ( error )
goto V_148;
...
error = F_100 ( V_5 , V_27 . V_52 , F_20 ( & V_27 , V_29 ) ,
V_27 . V_50 , & V_79 , V_139 , V_96 ) ;
V_148:
F_69 ( V_5 , V_96 -> V_98 , V_79 ) ;
V_147:
if ( error == - V_25 )
...
T_12 * V_179 ;
T_11 V_79 ;
struct V_19 * V_180 = F_115 ( V_139 -> V_153 ) ;
if ( F_62 ( ! V_180 ) ) {
...
static T_6
F_137 ( struct V_29 * V_29 , T_6 V_37 , T_6 V_185 , void * V_192 ,
struct V_193 * V_193 )
{
struct V_32 * V_33 = V_192 ;
T_6 V_35 = V_37 + V_185 , V_53 = 0 ;
T_5 V_83 = 0 ;
if ( F_22 ( V_33 ) == V_45 ) {
V_35 = F_24 ( V_35 , F_23 ( V_29 ) ) ;
if ( V_37 >= V_35 )
return 0 ;
if ( V_193 -> type == V_194 || V_193 -> type == V_195 )
return F_31 ( F_24 ( V_185 , V_35 - V_37 ) , V_33 ) ;
}
if ( F_26 ( V_193 -> type != V_196 ) )
return - V_17 ;
while ( V_37 < V_35 ) {
unsigned V_187 = V_37 & ( V_23 - 1 ) ;
struct V_11 V_12 = { 0 } ;
T_5 V_42 ;
V_12 . V_24 = V_193 -> V_197 +
( ( ( V_37 & V_198 ) - V_193 -> V_187 ) >> 9 ) ;
V_12 . V_22 = ( V_185 + V_187 + V_23 - 1 ) & V_198 ;
V_42 = F_5 ( V_193 -> V_10 , & V_12 ) ;
if ( V_42 < 0 ) {
V_83 = V_42 ;
break;
}
...
V_42 = V_35 - V_37 ;
if ( F_22 ( V_33 ) == V_51 )
V_42 = F_29 ( V_12 . V_18 , V_42 , V_33 ) ;
else
V_42 = F_30 ( V_12 . V_18 , V_42 , V_33 ) ;
F_10 ( V_193 -> V_10 , & V_12 ) ;
if ( V_42 <= 0 ) {
V_83 = V_42 ? V_42 : - V_56 ;
break;
}
...
return V_53 ? V_53 : V_83 ;
}
T_5
F_138 ( struct V_57 * V_58 , struct V_32 * V_33 ,
struct V_199 * V_200 )
{
struct V_4 * V_5 = V_58 -> V_201 -> V_144 ;
struct V_29 * V_29 = V_5 -> V_109 ;
T_6 V_37 = V_58 -> V_63 , V_83 = 0 , V_53 = 0 ;
unsigned V_60 = 0 ;
if ( F_22 ( V_33 ) == V_51 )
V_60 |= V_202 ;
if ( V_5 -> V_203 ) {
V_83 = F_139 ( V_5 ,
V_37 >> V_47 ,
( V_37 + F_33 ( V_33 ) - 1 ) >> V_47 ) ;
F_26 ( V_83 ) ;
}
while ( F_33 ( V_33 ) ) {
V_83 = F_140 ( V_29 , V_37 , F_33 ( V_33 ) , V_60 , V_200 ,
V_33 , F_137 ) ;
if ( V_83 <= 0 )
break;
V_37 += V_83 ;
...
int F_141 ( struct V_138 * V_139 , struct V_95 * V_96 ,
struct V_199 * V_200 )
{
struct V_4 * V_5 = V_139 -> V_143 -> V_144 ;
struct V_29 * V_29 = V_5 -> V_109 ;
unsigned long V_103 = ( unsigned long ) V_96 -> V_140 ;
T_6 V_37 = ( T_6 ) V_96 -> V_98 << V_47 ;
T_4 V_24 ;
struct V_193 V_193 = { 0 } ;
unsigned V_60 = 0 ;
int error , V_145 = 0 ;
void * V_79 ;
if ( V_37 >= F_23 ( V_29 ) )
...
if ( ( V_96 -> V_60 & V_108 ) && ! V_96 -> V_149 )
V_60 |= V_202 ;
error = V_200 -> V_204 ( V_29 , V_37 , V_23 , V_60 , & V_193 ) ;
if ( error )
goto V_148;
if ( F_26 ( V_193 . V_187 + V_193 . V_185 < V_37 + V_23 ) ) {
error = - V_17 ;
goto V_148;
}
V_24 = V_193 . V_197 + ( ( ( V_37 & V_198 ) - V_193 . V_187 ) >> 9 ) ;
if ( V_96 -> V_149 ) {
switch ( V_193 . type ) {
case V_194 :
case V_195 :
F_103 ( V_96 -> V_149 , V_103 ) ;
break;
case V_196 :
error = F_75 ( V_193 . V_10 , V_24 , V_23 ,
V_96 -> V_149 , V_103 ) ;
break;
default:
F_26 ( 1 ) ;
...
error = F_100 ( V_5 , V_193 . V_10 , V_24 ,
V_23 , & V_79 , V_139 , V_96 ) ;
break;
case V_195 :
case V_194 :
if ( ! ( V_96 -> V_60 & V_108 ) )
