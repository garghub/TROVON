...
static void * F_69 ( struct V_70 * V_71 , char * V_128 )
{
T_4 * V_129 ;
V_129 = F_70 ( 64 , V_130 ) ;
if ( ! V_129 ) {
...
static void F_72 ( void * V_131 )
{
F_73 ( V_131 ) ;
}
static void * F_74 ( struct V_70 * V_71 , void * V_131 ,
T_5 V_132 , T_6 * V_133 )
{
return F_75 ( V_131 , V_132 ) ;
}
static void F_76 ( void * V_131 , void * V_134 ,
T_6 V_133 )
{
F_77 ( V_134 , V_131 ) ;
}
...
static int F_89 ( struct V_145 * V_146 , T_7 V_147 )
{
return 0 ;
}
static void F_90 ( struct V_148 * V_143 , T_7 V_147 )
{
}
...
struct V_22 * V_23 ;
int V_66 , V_149 ;
V_17 -> V_24 = F_92 ( V_17 -> V_21 * sizeof( * V_23 ) , V_150 ) ;
if ( ! V_17 -> V_24 )
return - V_72 ;
V_149 = F_93 ( V_17 -> V_21 , V_151 ) / V_151 ;
V_17 -> V_19 = F_92 ( V_149 * sizeof( unsigned long ) , V_150 ) ;
if ( ! V_17 -> V_19 ) {
F_54 ( V_17 -> V_24 ) ;
return - V_72 ;
}
...
{
V_49 -> V_53 = F_92 ( V_154 * sizeof( struct V_16 ) ,
V_150 ) ;
if ( ! V_49 -> V_53 )
return - V_72 ;
V_49 -> V_51 = 0 ;
...
struct V_49 * V_49 ;
int V_135 ;
V_49 = F_101 ( sizeof( * V_49 ) , V_150 , V_155 ) ;
if ( ! V_49 ) {
V_135 = - V_72 ;
goto V_165;
}
...
V_135 = F_103 ( & V_49 -> V_144 ) ;
if ( V_135 )
goto V_175;
V_49 -> V_33 = F_104 ( & V_49 -> V_144 ) ;
if ( F_62 ( V_49 -> V_33 ) ) {
V_135 = - V_72 ;
goto V_176;
}
} else if ( V_10 == V_11 ) {
V_49 -> V_33 = F_105 ( V_150 , V_155 ) ;
if ( ! V_49 -> V_33 ) {
V_135 = - V_72 ;
goto V_175;
}
F_106 ( V_49 -> V_33 , F_40 ) ;
V_135 = F_95 ( V_49 ) ;
if ( V_135 )
goto V_177;
} else {
V_49 -> V_33 = F_107 ( F_43 , & V_49 -> V_166 , V_155 ) ;
if ( ! V_49 -> V_33 ) {
V_135 = - V_72 ;
goto V_175;
}
F_108 ( V_49 -> V_33 , F_41 ) ;
F_109 ( V_49 -> V_33 , F_33 ) ;
V_135 = F_95 ( V_49 ) ;
if ( V_135 )
goto V_177;
}
V_49 -> V_33 -> V_54 = V_49 ;
F_110 ( V_178 , V_49 -> V_33 ) ;
F_111 ( V_179 , V_49 -> V_33 ) ;
F_112 ( & V_166 ) ;
V_49 -> V_50 = V_180 ++ ;
F_113 ( & V_166 ) ;
F_114 ( V_49 -> V_33 , V_108 ) ;
F_115 ( V_49 -> V_33 , V_108 ) ;
sprintf ( V_49 -> V_136 , L_2 , V_49 -> V_50 ) ;
if ( V_142 )
V_135 = F_78 ( V_49 ) ;
else
V_135 = F_96 ( V_49 ) ;
...
return V_159 ;
if ( V_142 ) {
V_130 = F_121 ( L_11 , 64 * sizeof( V_183 ) ,
0 , 0 , NULL ) ;
if ( ! V_130 ) {
F_71 ( L_12 ) ;
V_5 = - V_72 ;
...
V_186:
while ( ! F_123 ( & V_181 ) ) {
V_49 = F_124 ( V_181 . V_153 , struct V_49 , V_141 ) ;
F_83 ( V_49 ) ;
}
F_125 ( V_130 ) ;
V_184:
