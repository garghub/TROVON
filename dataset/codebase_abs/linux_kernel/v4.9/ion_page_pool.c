...
F_7 ( & V_2 -> V_9 ) ;
if ( F_8 ( V_3 ) ) {
F_9 ( & V_3 -> V_10 , & V_2 -> V_11 ) ;
V_2 -> V_12 ++ ;
} else {
F_9 ( & V_3 -> V_10 , & V_2 -> V_13 ) ;
V_2 -> V_14 ++ ;
}
F_10 ( & V_2 -> V_9 ) ;
return 0 ;
}
static struct V_3 * F_11 ( struct V_1 * V_2 , bool V_15 )
{
struct V_3 * V_3 ;
if ( V_15 ) {
F_12 ( ! V_2 -> V_12 ) ;
V_3 = F_13 ( & V_2 -> V_11 , struct V_3 , V_10 ) ;
V_2 -> V_12 -- ;
} else {
F_12 ( ! V_2 -> V_14 ) ;
V_3 = F_13 ( & V_2 -> V_13 , struct V_3 , V_10 ) ;
V_2 -> V_14 -- ;
}
F_14 ( & V_3 -> V_10 ) ;
return V_3 ;
...
static int F_18 ( struct V_1 * V_2 , bool V_15 )
{
int V_17 = V_2 -> V_14 ;
if ( V_15 )
V_17 += V_2 -> V_12 ;
...
bool V_6 )
{
struct V_1 * V_2 = F_22 ( sizeof( * V_2 ) , V_21 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_12 = 0 ;
V_2 -> V_14 = 0 ;
