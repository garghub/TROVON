...
F_26 ( & V_3 -> V_45 . V_31 -> V_73 ) ;
F_27 ( & V_56 -> V_74 ) ;
F_28 ( & V_3 -> V_45 . V_31 -> V_73 ) ;
if ( F_29 ( V_56 ) )
return F_30 ( V_56 ) ;
F_31 ( & V_3 -> V_5 ) ;
F_21 ( V_3 , V_56 ) ;
...
bool F_41 ( struct V_1 * V_3 )
{
const void * V_78 = F_42 ( 0 ) ;
int V_79 = F_43 ( & V_3 -> V_41 , 1 , 0 ) ;
if ( V_79 == 0 )
return false ;
if ( F_44 ( & V_3 -> V_7 ) )
F_45 ( V_3 , V_80 , V_79 + 1 , V_78 ) ;
else
F_33 ( V_3 ) ;
return true ;
}
...
int V_79 = F_43 ( & V_3 -> V_41 , 1 , 0 ) ;
if ( V_79 > 0 )
F_45 ( V_3 , V_82 , V_79 + 1 , V_78 ) ;
else
V_3 = NULL ;
}
return V_3 ;
}
void F_49 ( struct V_1 * V_3 )
{
const void * V_78 = F_42 ( 0 ) ;
int V_79 ;
V_79 = F_50 ( & V_3 -> V_41 ) ;
F_45 ( V_3 , V_83 , V_79 , V_78 ) ;
F_51 ( V_79 , >= , 0 ) ;
if ( V_79 == 0 )
F_52 ( & V_84 , 0 ) ;
}
...
{
struct V_1 * V_3 =
F_53 ( V_76 , struct V_1 , V_76 ) ;
F_2 ( L_9 , V_3 -> V_15 , F_16 ( & V_3 -> V_41 ) ) ;
F_51 ( F_16 ( & V_3 -> V_41 ) , == , 0 ) ;
F_54 ( L_10 , V_3 -> V_15 ) ;
F_39 ( & V_3 -> V_11 ) ;
V_3 -> V_12 -> V_86 ( V_3 ) ;
F_55 ( V_3 -> V_45 . V_87 ) ;
...
V_93 = V_98 ;
F_36 ( & V_75 ) ;
F_61 (conn, _p, &rxrpc_connections, link) {
F_51 ( F_16 ( & V_3 -> V_41 ) , > , 0 ) ;
if ( F_62 ( F_16 ( & V_3 -> V_41 ) > 1 ) )
continue;
if ( V_3 -> V_99 == V_100 )
continue;
V_18 = F_63 ( V_3 -> V_18 ) ;
...
ASSERT ( F_64 ( V_93 , V_94 ) ) ;
F_52 ( & V_84 ,
V_93 - V_94 ) ;
}
while ( ! F_35 ( & V_95 ) ) {
V_3 = F_70 ( V_95 . V_101 , struct V_1 ,
V_10 ) ;
F_37 ( & V_3 -> V_10 ) ;
F_51 ( F_16 ( & V_3 -> V_41 ) , == , 0 ) ;
F_34 ( V_3 ) ;
