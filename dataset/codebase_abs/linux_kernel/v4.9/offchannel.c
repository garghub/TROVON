...
int F_77 ( struct V_78 * V_78 , struct V_102 * V_42 ,
...
V_110 = F_88 ( V_4 -> V_14 . V_151 + V_109 -> V_45 ) ;
if ( ! V_110 ) {
V_77 = - V_97 ;
goto V_107;
}
F_89 ( V_110 , V_4 -> V_14 . V_151 ) ;
V_44 = F_90 ( V_110 , V_109 -> V_45 ) ;
memcpy ( V_44 , V_109 -> V_115 , V_109 -> V_45 ) ;
if ( V_2 -> V_27 . V_152 &&
( V_2 -> V_27 . type == V_128 ||
V_2 -> V_27 . type == V_125 ||
V_2 -> V_27 . type == V_123 ) &&
...
V_132 = F_87 ( V_2 -> V_7 . V_156 . V_132 ) ;
else if ( V_2 -> V_27 . type == V_123 )
V_132 = F_87 ( V_2 -> V_7 . V_157 . V_158 ) ;
else if ( F_79 ( & V_2 -> V_27 ) )
V_132 = F_87 ( V_2 -> V_7 . V_126 . V_132 ) ;
if ( V_132 )
...
F_91 ( V_110 ) -> V_16 = V_16 ;
V_110 -> V_161 = V_2 -> V_161 ;
if ( ! V_109 -> V_117 ) {
V_77 = F_92 ( V_4 , V_110 , V_47 , V_46 ) ;
if ( V_77 ) {
F_93 ( V_110 ) ;
goto V_107;
}
...
int F_95 ( struct V_78 * V_78 ,
struct V_102 * V_42 , T_2 V_47 )
{
struct V_3 * V_4 = F_96 ( V_78 ) ;
