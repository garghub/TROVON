...
int F_77 ( struct V_100 * V_100 , struct V_32 * V_101 , struct V_32 * V_55 ,
char * V_102 , int V_103 , int V_14 , struct V_93 * V_83 )
{
...
V_27 = F_81 ( V_24 , V_122 ,
& V_4 -> V_64 , & V_117 , V_123 ) ;
if ( V_27 < 0 )
goto V_99;
if ( F_82 ( NULL , & V_117 , V_4 -> V_6 , & V_4 -> V_12 ) < 0 ||
F_83 ( & V_117 , & V_4 -> V_12 ,
& V_4 -> V_13 ) < 0 ||
F_84 ( & V_117 , V_4 -> V_7 ,
& V_4 -> V_124 ,
...
static int F_86 ( struct V_23 * V_24 , struct V_93 * V_83 ,
...
unsigned char * V_96 = F_64 ( V_24 ) ;
struct V_32 * V_33 ;
V_133 = F_87 ( V_24 , V_126 , V_127 , V_129 , sizeof( * V_131 ) , V_128 ) ;
if ( ! V_133 )
goto V_134;
V_131 = F_88 ( V_133 ) ;
V_131 -> V_135 = V_136 ;
...
static int
F_89 ( struct V_100 * V_100 , T_1 V_126 , struct V_132 * V_45 ,
struct V_93 * V_83 , int V_129 )
{
struct V_23 * V_24 ;
V_24 = F_90 ( V_142 , V_58 ) ;
if ( ! V_24 )
return - V_143 ;
if ( F_86 ( V_24 , V_83 , V_126 , V_45 -> V_144 , 0 , V_129 ,
0 , 0 ) <= 0 ) {
F_91 ( V_24 ) ;
return - V_41 ;
}
return F_92 ( V_24 , V_100 , V_126 ) ;
}
static struct V_3 * F_93 ( struct V_100 * V_100 , struct V_32 * V_101 ,
...
V_27 = - V_41 ;
if ( V_107 [ V_145 ] == NULL ||
F_94 ( V_107 [ V_145 ] ) < sizeof( V_28 ) )
goto V_109;
V_28 = F_95 ( V_107 [ V_145 ] ) ;
V_27 = - V_41 ;
...
static int F_96 ( struct V_100 * V_100 , struct V_32 * V_101 ,
struct V_132 * V_45 , T_1 V_126 )
{
struct V_23 * V_24 ;
unsigned char * V_96 ;
...
if ( ! V_20 )
goto V_109;
V_133 = F_87 ( V_24 , V_126 , V_45 -> V_144 , V_50 ,
sizeof( * V_131 ) , 0 ) ;
if ( ! V_133 )
goto V_147;
V_131 = F_88 ( V_133 ) ;
...
V_133 -> V_149 |= V_150 ;
F_23 ( V_20 -> V_46 ) ;
V_27 = F_98 ( V_24 , V_100 , V_126 , V_151 ,
V_45 -> V_149 & V_152 ) ;
if ( V_27 > 0 )
return 0 ;
return V_27 ;
...
static int
F_99 ( struct V_100 * V_100 , struct V_132 * V_45 , struct V_93 * V_83 ,
T_1 V_126 )
{
int V_16 ;
struct V_23 * V_24 ;
...
if ( ! V_24 )
return - V_143 ;
if ( F_86 ( V_24 , V_83 , V_126 , V_45 -> V_144 , 0 , V_50 ,
0 , 1 ) <= 0 ) {
F_91 ( V_24 ) ;
return - V_41 ;
}
...
V_16 = F_98 ( V_24 , V_100 , V_126 , V_151 ,
V_45 -> V_149 & V_152 ) ;
if ( V_16 > 0 )
return 0 ;
return V_16 ;
...
static int
F_100 ( struct V_100 * V_100 , struct V_32 * V_101 , struct V_132 * V_45 ,
T_1 V_126 , int V_129 )
{
int V_29 , V_16 ;
struct V_32 * V_107 [ V_39 + 1 ] ;
...
if ( V_107 [ 1 ] != NULL )
return F_96 ( V_100 , V_107 [ 1 ] , V_45 , V_126 ) ;
else
return - V_41 ;
}
for ( V_29 = 1 ; V_29 <= V_39 && V_107 [ V_29 ] ; V_29 ++ ) {
V_72 = F_93 ( V_100 , V_107 [ V_29 ] , V_45 , V_126 ) ;
if ( F_78 ( V_72 ) ) {
V_16 = F_79 ( V_72 ) ;
goto V_27;
}
...
if ( V_129 == V_51 )
V_16 = F_89 ( V_100 , V_126 , V_45 , & V_83 , V_129 ) ;
else {
V_16 = F_99 ( V_100 , V_45 , & V_83 , V_126 ) ;
if ( V_16 )
goto V_27;
return V_16 ;
}
...
static int
F_102 ( struct V_100 * V_100 , struct V_132 * V_45 , struct V_93 * V_83 ,
T_1 V_126 )
{
struct V_23 * V_24 ;
int V_27 = 0 ;
...
if ( ! V_24 )
return - V_143 ;
if ( F_86 ( V_24 , V_83 , V_126 , V_45 -> V_144 , V_45 -> V_149 ,
V_153 , 0 , 0 ) <= 0 ) {
F_91 ( V_24 ) ;
return - V_41 ;
}
...
static int F_103 ( struct V_100 * V_100 , struct V_32 * V_101 ,
struct V_132 * V_45 , T_1 V_126 , int V_103 )
{
int V_16 = 0 ;
F_101 ( V_83 ) ;
V_16 = F_77 ( V_100 , V_101 , NULL , NULL , V_103 , 0 , & V_83 ) ;
if ( V_16 )
return V_16 ;
return F_102 ( V_100 , V_45 , & V_83 , V_126 ) ;
}
static int F_104 ( struct V_23 * V_24 , struct V_132 * V_45 )
{
struct V_100 * V_100 = F_105 ( V_24 -> V_154 ) ;
struct V_32 * V_155 [ V_108 + 1 ] ;
T_1 V_126 = V_24 ? F_106 ( V_24 ) . V_126 : 0 ;
int V_16 = 0 , V_103 = 0 ;
if ( ( V_45 -> V_156 != V_51 ) &&
! F_107 ( V_24 , V_157 ) )
return - V_18 ;
V_16 = F_108 ( V_45 , sizeof( struct V_130 ) , V_155 , V_108 , NULL ) ;
if ( V_16 < 0 )
return V_16 ;
if ( V_155 [ V_139 ] == NULL ) {
F_109 ( L_4 ) ;
...
V_103 = 1 ;
V_159:
V_16 = F_103 ( V_100 , V_155 [ V_139 ] , V_45 , V_126 , V_103 ) ;
if ( V_16 == - V_111 )
goto V_159;
break;
case V_50 :
V_16 = F_100 ( V_100 , V_155 [ V_139 ] , V_45 ,
V_126 , V_50 ) ;
break;
case V_51 :
V_16 = F_100 ( V_100 , V_155 [ V_139 ] , V_45 ,
...
static struct V_32 * F_111 ( const struct V_132 * V_45 )
{
struct V_32 * V_160 , * V_161 [ V_108 + 1 ] ;
struct V_32 * V_107 [ V_39 + 1 ] ;
struct V_32 * V_101 [ V_162 + 1 ] ;
struct V_32 * V_43 ;
if ( F_108 ( V_45 , sizeof( struct V_130 ) , V_101 , V_162 , NULL ) < 0 )
return NULL ;
V_160 = V_101 [ V_139 ] ;
if ( V_160 == NULL )
return NULL ;
if ( F_112 ( V_107 , V_39 , F_113 ( V_160 ) ,
...
static int F_115 ( struct V_23 * V_24 , struct V_25 * V_26 )
{
struct V_100 * V_100 = F_105 ( V_24 -> V_154 ) ;
struct V_132 * V_133 ;
unsigned char * V_96 = F_64 ( V_24 ) ;
...
struct V_40 * V_104 ;
int V_16 = 0 ;
struct V_130 * V_131 = (struct V_130 * ) F_88 ( V_26 -> V_133 ) ;
struct V_32 * V_43 = F_111 ( V_26 -> V_133 ) ;
if ( V_43 == NULL ) {
F_116 ( L_5 ) ;
return 0 ;
}
...
if ( V_104 == NULL )
return 0 ;
V_133 = F_87 ( V_24 , F_106 ( V_26 -> V_24 ) . V_126 , V_26 -> V_133 -> V_144 ,
...
F_118 ( V_164 , V_50 , F_104 , NULL , NULL ) ;
F_118 ( V_164 , V_51 , F_104 , F_115 ,
NULL ) ;
return 0 ;
}
