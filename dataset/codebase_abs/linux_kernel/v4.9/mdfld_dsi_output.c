...
V_47 = F_45 ( sizeof( struct V_46 ) , V_108 ) ;
if ( ! V_47 ) {
F_5 ( L_18 ) ;
return;
}
V_47 -> V_12 = V_12 ;
V_11 = F_45 ( sizeof( struct V_10 ) ,
V_108 ) ;
if ( ! V_11 ) {
F_5 ( L_19 ) ;
goto V_109;
...
V_11 -> V_111 = 1 ;
V_11 -> V_5 = V_5 ;
V_11 -> V_80 = V_102 -> V_112 ( V_5 ) ;
if ( V_102 -> V_113 ( V_5 , V_12 , & V_105 ) )
goto V_109;
V_106 = V_105 . V_106 ;
V_107 = V_105 . V_107 ;
V_11 -> V_41 = V_11 -> V_80 ;
...
V_43 = & V_47 -> V_64 . V_64 ;
V_47 -> V_64 . V_115 = F_17 ;
V_47 -> V_64 . V_116 = F_18 ;
F_46 ( V_5 , V_43 , & V_117 ,
V_118 ) ;
F_47 ( V_43 , & V_119 ) ;
V_43 -> V_120 . V_121 = V_122 ;
V_43 -> V_120 . V_106 = V_106 ;
V_43 -> V_120 . V_107 = V_107 ;
V_43 -> V_123 = false ;
V_43 -> V_124 = false ;
F_48 ( & V_43 -> V_64 ,
V_5 -> V_125 . V_126 ,
