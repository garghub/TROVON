...
static struct V_31 * F_26 ( struct V_6 * V_24 ,
...
V_1 = F_18 ( V_24 ) ;
if ( V_1 != NULL ) {
V_33 = F_28 ( V_1 -> V_35 , V_24 , V_31 ) ;
F_8 ( V_1 ) ;
}
return V_33 ;
}
static int F_29 ( struct V_36 * V_37 , struct V_31 * V_31 ,
struct V_38 * V_39 )
{
...
F_31 ( V_6 , V_39 ) ;
if ( V_1 != NULL ) {
V_39 -> V_40 = V_1 -> V_35 -> V_40 ;
F_8 ( V_1 ) ;
}
return 0 ;
}
static int F_32 ( struct V_8 * V_8 , struct V_41 * V_42 )
{
int V_43 ;
struct V_1 * V_1 ;
V_43 = - V_44 ;
V_1 = F_18 ( F_33 ( V_8 ) ) ;
if ( V_1 != NULL ) {
V_43 = F_34 ( V_1 -> V_35 , V_8 , V_42 ) ;
F_8 ( V_1 ) ;
}
return V_43 ;
}
static T_1 int F_35 ( struct V_1 * V_1 )
{
struct V_2 * V_45 , * V_46 ;
T_2 V_47 ;
T_3 V_48 ;
int V_18 ;
V_18 = - V_16 ;
V_45 = F_36 ( sizeof( * V_45 ) + 4 , V_49 ) ;
if ( ! V_45 )
goto V_50;
V_45 -> V_51 = V_52 ;
V_45 -> V_5 = V_1 ;
...
V_45 -> V_53 = 3 ;
V_45 -> V_4 = & V_54 ;
memcpy ( V_45 -> V_55 , L_1 , 4 ) ;
V_47 = F_37 ( V_1 -> V_56 , 0 ) ;
if ( ! F_38 ( V_47 ) )
V_47 = V_45 -> V_47 ;
V_48 = F_39 ( V_1 -> V_56 , 0 ) ;
if ( ! F_40 ( V_48 ) )
V_48 = V_45 -> V_48 ;
F_41 ( V_45 , V_47 , V_48 ) ;
V_18 = - V_57 ;
V_46 = F_42 ( V_1 , L_2 , V_45 ) ;
if ( ! V_46 )
goto V_58;
V_1 -> V_35 = V_45 ;
V_1 -> V_59 = V_46 ;
...
static T_4 void F_44 ( struct V_1 * V_1 )
{
F_45 ( L_2 , V_1 -> V_35 ) ;
F_43 ( V_1 -> V_35 ) ;
}
