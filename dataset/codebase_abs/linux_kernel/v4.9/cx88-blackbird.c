...
unsigned int V_106 [] , struct V_107 * V_108 [] )
{
struct V_40 * V_41 = V_103 -> V_109 ;
* V_105 = 1 ;
V_41 -> V_110 = 188 * 4 ;
V_41 -> V_111 = 32 ;
V_106 [ 0 ] = V_41 -> V_110 * V_41 -> V_111 ;
return 0 ;
}
static int F_32 ( struct V_112 * V_113 )
{
struct V_114 * V_115 = F_33 ( V_113 ) ;
struct V_40 * V_41 = V_113 -> V_102 -> V_109 ;
...
V_147 -> V_154 . V_155 . V_157 = V_41 -> V_110 * V_41 -> V_111 ;
