...
{
struct V_184 * V_185 =
F_56 ( V_183 , struct V_184 , V_186 . V_183 ) ;
struct V_8 * V_9 =
F_56 ( V_185 , struct V_8 , V_187 ) ;
struct V_124 * V_125 = & V_9 -> V_188 ;
F_57 ( & V_125 -> V_189 ) ;
if ( ++ V_125 -> V_190 == 0 )
++ V_125 -> V_190 ;
if ( V_185 -> V_191 > 0 ) {
...
return false ;
if ( V_47 [ 8 ] != F_14 ( V_193 ) )
return false ;
return true ;
}
void
F_63 ( struct V_184 * V_185 )
{
F_64 ( & V_185 -> V_186 , 0 ) ;
}
void
F_65 ( struct V_182 * V_183 )
{
struct V_157 * V_158 =
F_56 ( V_183 , struct V_157 , V_194 ) ;
struct V_127 * V_128 ;
struct V_70 * V_71 ;
struct V_21 * V_22 ;
struct V_8 * V_9 = V_158 -> V_195 ;
struct V_124 * V_125 = & V_9 -> V_188 ;
V_5 * V_64 ;
int V_196 , V_197 , V_198 ;
unsigned long V_199 ;
F_2 ( L_17 , V_7 , V_158 ) ;
if ( V_158 -> V_172 == V_200 )
goto V_201;
if ( V_158 -> V_172 < V_202 )
goto V_203;
...
V_196 = F_46 ( V_158 , 1 , & V_64 ) ;
if ( V_196 < 0 || * V_64 ++ != V_75 )
goto V_211;
V_158 -> V_172 -=
( ( unsigned char * ) V_64 - ( unsigned char * ) V_128 ) ;
V_197 = V_158 -> V_172 + V_196 ;
V_9 -> V_85 . V_212 += V_196 ;
if ( V_196 &= 3 ) {
V_196 = 4 - V_196 ;
V_197 += V_196 ;
}
...
V_115:
if ( ! F_68 ( & V_71 -> V_81 ) )
V_9 -> V_15 . V_78 -> V_217 ( V_9 , V_71 ) ;
F_57 ( & V_125 -> V_189 ) ;
V_199 = V_125 -> V_199 ;
V_125 -> V_199 = F_69 ( & V_9 -> V_139 . V_218 ) << V_219 ;
if ( V_125 -> V_199 > V_199 )
F_70 ( V_22 -> V_83 ) ;
F_71 ( V_22 -> V_83 , V_197 ) ;
F_61 ( & V_125 -> V_189 ) ;
F_2 ( L_20 ,
V_7 , V_125 , V_22 , V_197 ) ;
return;
V_201:
F_72 ( V_158 ) ;
if ( V_9 -> V_187 . V_191 == 1 ) {
V_9 -> V_187 . V_191 = - V_63 ;
F_63 ( & V_9 -> V_187 ) ;
}
return;
#if F_39 ( V_131 )
...
goto V_115;
V_215:
V_198 = F_47 ( V_128 -> V_152 . V_220 . V_221 ) ;
switch ( V_198 ) {
case V_222 :
F_12 ( L_22 ,
V_7 ,
F_47 ( V_128 -> V_152 . V_220 . V_223 ) ,
F_47 ( V_128 -> V_152 . V_220 . V_224 ) ) ;
break;
case V_225 :
F_12 ( L_23 ,
V_7 ) ;
