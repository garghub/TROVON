...
static int F_4 ( struct V_1 * V_2 , T_2 V_7 )
{
int V_8 ;
T_3 V_9 = 0 , V_10 ;
...
int F_12 ( struct V_1 * V_2 , T_3 V_20 ,
T_3 * V_24 , T_3 V_21 )
{
int V_25 ;
V_25 = F_11 ( V_2 , V_20 , V_21 ) ;
if ( V_25 )
return V_25 ;
* V_24 = F_2 ( V_26 ) ;
return 0 ;
}
static int F_13 ( struct V_1 * V_2 , T_3 V_20 ,
T_3 V_24 , T_3 V_21 )
{
int V_25 ;
V_25 = F_11 ( V_2 , V_20 , V_21 ) ;
...
return - V_15 ;
V_10 = F_2 ( V_70 ) ;
V_10 = F_19 ( V_10 , V_71 , V_72 , 1 ) ;
V_10 = F_19 ( V_10 , V_71 , V_73 , 1 ) ;
F_7 ( V_70 , V_10 ) ;
V_10 = F_2 ( V_74 ) ;
V_10 = F_19 ( V_10 , V_75 , V_76 , 0 ) ;
V_10 = F_19 ( V_10 , V_75 , V_77 , 0 ) ;
V_10 = F_19 ( V_10 , V_75 , V_78 , 0 ) ;
V_10 = F_19 ( V_10 , V_75 , V_79 , 1 ) ;
F_7 ( V_74 , V_10 ) ;
V_68 = F_20 ( V_66 -> V_80 ) &
F_21 ( V_81 , V_82 ) ;
F_7 ( V_83 , V_68 ) ;
...
T_5 V_144 ;
T_1 V_145 ;
T_4 V_146 = F_26 ( V_110 ) ;
enum V_45 V_46 = F_24 ( V_146 ) ;
...
V_145 = F_28 ( V_148 -> V_148 . V_150 ) ;
if ( ( V_110 == V_116 ) ||
( V_110 == V_117 ) ) {
V_144 += F_28 ( V_148 -> V_151 ) << 2 ;
V_145 = F_28 ( V_148 -> V_152 ) << 2 ;
}
V_143 -> V_35 = F_20 ( V_144 ) ;
V_143 -> V_33 = F_22 ( V_144 ) ;
V_143 -> V_145 = V_145 ;
V_143 -> V_153 = V_110 ;
return 0 ;
}
...
V_143 -> V_35 = F_20 ( V_80 ) ;
V_143 -> V_33 = F_22 ( V_80 ) ;
V_143 -> V_153 = V_154 ;
return 0 ;
}
...
int F_43 ( struct V_1 * V_2 , void * * V_194 )
{
T_4 V_8 ;
struct V_4 * V_5 = F_3 ( V_2 ) ;
for ( V_8 = 0 ; V_8 < V_5 -> V_176 ; V_8 ++ )
...
F_48 ( V_206 , 32 ) +
F_48 ( V_207 , 32 ) +
F_48 ( sizeof( struct V_208 ) , 32 ) +
F_48 ( sizeof( struct V_195 ) , 32 ) ;
V_25 = F_49 ( V_2 , V_5 -> V_32 . V_145 , V_209 ,
...
V_25 = F_49 ( V_2 , V_5 -> V_156 . V_145 , V_209 ,
true , V_210 , 0 , NULL , NULL ,
V_193 ) ;
if ( V_25 ) {
...
V_25 = F_50 ( V_2 -> V_6 . V_192 , false ) ;
if ( V_25 ) {
F_40 ( & V_2 -> V_6 . V_192 ) ;
F_9 ( V_2 -> V_18 , L_9 , V_25 ) ;
return V_25 ;
}
V_25 = F_51 ( V_2 -> V_6 . V_192 , V_210 , & V_80 ) ;
if ( V_25 ) {
F_52 ( V_2 -> V_6 . V_192 ) ;
F_40 ( & V_2 -> V_6 . V_192 ) ;
...
V_25 = F_53 ( * V_192 , & V_201 ) ;
if ( V_25 )
goto V_211;
F_52 ( V_2 -> V_6 . V_192 ) ;
V_5 -> V_32 . V_35 = F_20 ( V_80 ) ;
V_5 -> V_32 . V_33 = F_22 ( V_80 ) ;
V_5 -> V_32 . V_158 = V_201 ;
V_25 = F_50 ( V_2 -> V_6 . V_193 , false ) ;
if ( V_25 ) {
F_40 ( & V_2 -> V_6 . V_193 ) ;
F_9 ( V_2 -> V_18 , L_11 , V_25 ) ;
return V_25 ;
}
V_25 = F_51 ( V_2 -> V_6 . V_193 , V_210 , & V_80 ) ;
if ( V_25 ) {
F_52 ( V_2 -> V_6 . V_193 ) ;
F_40 ( & V_2 -> V_6 . V_193 ) ;
...
V_25 = F_53 ( * V_193 , & V_202 ) ;
if ( V_25 )
goto V_211;
F_52 ( V_2 -> V_6 . V_193 ) ;
V_5 -> V_156 . V_35 = F_20 ( V_80 ) ;
V_5 -> V_156 . V_33 = F_22 ( V_80 ) ;
