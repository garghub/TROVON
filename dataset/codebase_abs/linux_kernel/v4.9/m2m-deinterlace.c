...
unsigned int V_140 [] , struct V_50 * V_141 [] )
{
...
static int F_60 ( struct V_143 * V_144 )
{
...
{
struct V_32 * V_145 = F_64 ( V_144 ) ;
struct V_20 * V_21 = F_59 ( V_144 -> V_123 ) ;
F_65 ( V_21 -> V_25 , V_145 ) ;
}
static int F_66 ( void * V_19 , struct V_123 * V_146 ,
struct V_123 * V_147 )
{
struct V_20 * V_21 = V_19 ;
int V_132 ;
...
V_146 -> V_156 = & V_157 ;
V_146 -> V_158 = V_159 ;
V_146 -> V_24 = V_21 -> V_24 -> V_61 . V_24 ;
V_4 [ V_5 ] . V_11 = & V_14 [ 0 ] ;
V_4 [ V_5 ] . V_59 = 640 ;
V_4 [ V_5 ] . V_60 = 480 ;
...
V_147 -> V_156 = & V_157 ;
V_147 -> V_158 = V_159 ;
V_147 -> V_24 = V_21 -> V_24 -> V_61 . V_24 ;
V_4 [ V_7 ] . V_11 = & V_14 [ 0 ] ;
V_4 [ V_7 ] . V_59 = 640 ;
V_4 [ V_7 ] . V_60 = 480 ;
...
V_21 -> V_63 = F_70 ( sizeof( struct V_163 ) +
sizeof( struct V_164 ) , V_160 ) ;
if ( ! V_21 -> V_63 ) {
F_74 ( V_21 ) ;
return - V_161 ;
}
...
int V_132 ;
F_11 ( V_21 ) ;
V_132 = F_78 ( V_100 , V_21 -> V_25 , V_166 ) ;
F_13 ( V_21 ) ;
return V_132 ;
}
static int F_79 ( struct V_100 * V_100 , struct V_167 * V_168 )
{
struct V_20 * V_21 = V_100 -> V_162 ;
return F_80 ( V_100 , V_21 -> V_25 , V_168 ) ;
}
...
T_3 V_173 ;
int V_132 = 0 ;
V_23 = F_82 ( & V_170 -> V_24 , sizeof( * V_23 ) , V_160 ) ;
if ( ! V_23 )
return - V_161 ;
F_83 ( & V_23 -> V_174 ) ;
F_84 ( V_173 ) ;
F_85 ( V_175 , V_173 ) ;
V_23 -> V_46 = F_86 ( V_173 , NULL , V_23 ) ;
if ( ! V_23 -> V_46 )
return - V_176 ;
if ( ! F_87 ( V_175 , V_23 -> V_46 -> V_50 -> V_177 ) ) {
F_88 ( & V_170 -> V_24 , L_24 ) ;
goto V_178;
}
V_132 = F_89 ( & V_170 -> V_24 , & V_23 -> V_61 ) ;
if ( V_132 )
goto V_178;
F_16 ( & V_23 -> V_26 , 0 ) ;
F_90 ( & V_23 -> V_29 ) ;
V_172 = & V_23 -> V_172 ;
* V_172 = V_179 ;
V_172 -> V_180 = & V_23 -> V_29 ;
V_172 -> V_61 = & V_23 -> V_61 ;
V_132 = F_91 ( V_172 , V_181 , 0 ) ;
if ( V_132 ) {
F_24 ( & V_23 -> V_61 , L_25 ) ;
goto V_182;
}
F_92 ( V_172 , V_23 ) ;
snprintf ( V_172 -> V_119 , sizeof( V_172 -> V_119 ) , L_26 , V_179 . V_119 ) ;
F_93 ( & V_23 -> V_61 , V_183
L_27 , V_172 -> V_116 ) ;
F_94 ( V_170 , V_23 ) ;
V_23 -> V_28 = F_95 ( & V_184 ) ;
if ( F_72 ( V_23 -> V_28 ) ) {
F_24 ( & V_23 -> V_61 , L_28 ) ;
...
{
struct V_22 * V_23 = F_100 ( V_170 ) ;
F_93 ( & V_23 -> V_61 , L_29 V_183 ) ;
F_101 ( V_23 -> V_28 ) ;
F_96 ( & V_23 -> V_172 ) ;
F_97 ( & V_23 -> V_61 ) ;
F_98 ( V_23 -> V_46 ) ;
