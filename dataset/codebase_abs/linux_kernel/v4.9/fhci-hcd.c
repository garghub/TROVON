...
if ( F_67 () )
return - V_137 ;
V_134 = F_68 ( V_37 , L_7 , NULL ) ;
if ( V_134 && strcmp ( V_134 , L_8 ) )
return - V_137 ;
...
V_147 , V_132 ) ;
V_2 -> V_4 = F_79 ( V_132 ) ;
for ( V_40 = 0 ; V_40 < V_148 ; V_40 ++ ) {
int V_149 ;
enum V_150 V_98 ;
V_149 = F_80 ( V_37 , V_40 , & V_98 ) ;
V_2 -> V_29 [ V_40 ] = V_149 ;
V_2 -> V_151 [ V_40 ] = V_98 & V_152 ;
if ( ! F_81 ( V_149 ) ) {
if ( V_40 < V_153 ) {
F_71 ( V_104 , L_16 ,
V_40 , V_149 ) ;
...
V_82 = F_83 ( V_149 , F_70 ( V_104 ) ) ;
if ( V_82 ) {
F_71 ( V_104 , L_21 , V_40 ) ;
goto V_154;
}
if ( V_40 >= V_153 ) {
V_82 = F_84 ( V_149 , 0 ) ;
...
for ( V_136 = 0 ; V_136 < V_155 ; V_136 ++ ) {
V_2 -> V_156 [ V_136 ] = F_85 ( V_37 , V_136 ) ;
if ( F_86 ( V_2 -> V_156 [ V_136 ] ) ) {
V_82 = F_87 ( V_2 -> V_156 [ V_136 ] ) ;
F_71 ( V_104 , L_24 , V_136 , V_82 ) ;
goto V_157;
}
}
V_2 -> V_10 = F_88 () ;
if ( F_86 ( V_2 -> V_10 ) ) {
V_82 = F_87 ( V_2 -> V_10 ) ;
F_71 ( V_104 , L_25 , V_82 ) ;
goto V_158;
}
V_82 = F_89 ( V_2 -> V_10 -> V_19 , V_159 ,
0 , L_26 , V_81 ) ;
if ( V_82 ) {
F_71 ( V_104 , L_27 ) ;
goto V_160;
...
V_134 = F_68 ( V_37 , L_29 , NULL ) ;
if ( V_134 ) {
V_2 -> V_163 = F_91 ( V_134 ) ;
if ( V_2 -> V_163 == V_164 ) {
F_71 ( V_104 , L_30 ) ;
V_82 = - V_77 ;
goto V_165;
...
V_134 = F_68 ( V_37 , L_31 , NULL ) ;
if ( V_134 ) {
V_2 -> V_166 = F_91 ( V_134 ) ;
if ( V_2 -> V_166 == V_164 ) {
F_71 ( V_104 , L_32 ) ;
V_82 = - V_77 ;
goto V_165;
...
F_82 ( V_104 , L_34 , V_81 -> V_6 , V_133 ) ;
F_38 ( V_2 , V_58 ) ;
if ( V_2 -> V_163 != V_167 ) {
F_38 ( V_2 , V_26 ) ;
F_92 ( V_2 -> V_163 , V_168 ) ;
} else {
F_38 ( V_2 , V_27 ) ;
F_92 ( V_2 -> V_166 , V_168 >> 3 ) ;
}
F_3 ( & V_2 -> V_6 -> V_20 , 0xffff ) ;
F_3 ( & V_2 -> V_6 -> V_21 , 0 ) ;
V_82 = F_93 ( V_81 , V_133 , 0 ) ;
if ( V_82 < 0 )
goto V_169;
F_94 ( V_81 -> V_139 . V_140 ) ;
F_95 ( V_2 ) ;
return 0 ;
V_169:
V_165:
F_96 ( V_133 ) ;
V_162:
F_97 ( V_2 -> V_10 -> V_19 , V_81 ) ;
V_160:
F_98 ( V_2 -> V_10 ) ;
V_158:
V_157:
while ( -- V_136 >= 0 )
F_99 ( V_2 -> V_156 [ V_136 ] ) ;
V_154:
while ( -- V_40 >= 0 ) {
if ( F_81 ( V_2 -> V_29 [ V_40 ] ) )
F_100 ( V_2 -> V_29 [ V_40 ] ) ;
}
F_101 ( V_132 ) ;
V_144:
...
static int F_104 ( struct V_127 * V_104 )
{
struct V_80 * V_81 = F_105 ( V_104 ) ;
struct V_1 * V_2 = F_46 ( V_81 ) ;
int V_40 ;
int V_136 ;
F_106 ( V_81 ) ;
