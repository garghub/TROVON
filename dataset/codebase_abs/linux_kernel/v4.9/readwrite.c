...
int V_81 ;
V_198 |= V_199 | V_200 ;
V_23 -> V_40 = V_23 -> V_42 = F_167 ( V_23 ) ;
F_9 ( V_12 , & V_1 , & V_2 ) ;
...
static int F_168 ( struct V_23 * V_23 , struct V_69 * V_69 )
{
long V_198 = V_200 ;
int V_81 ;
V_23 -> V_40 = V_23 -> V_42 = F_167 ( V_23 ) ;
...
int F_169 ( struct V_23 * V_23 , T_4 V_12 ,
struct V_90 * V_90 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_69 * V_69 ;
...
return - V_136 ;
F_37 ( V_63 , V_69 , 1 ) ;
V_89 = F_168 ( V_23 , V_69 ) ;
F_40 ( V_63 , V_69 , 1 ) ;
F_44 ( V_69 ) ;
return V_89 ;
}
int F_170 ( struct V_23 * V_23 , T_1 V_1 , T_1 V_142 ,
...
{
T_9 V_209 = V_69 -> V_12 << V_23 -> V_64 -> V_67 ;
T_1 V_1 ;
T_2 V_2 ;
int V_81 ;
if ( V_101 <= V_209 || V_101 - V_209 >= V_130 )
return 0 ;
F_9 ( V_69 -> V_12 , & V_1 , & V_2 ) ;
F_8 ( V_2 != 0 ) ;
V_81 = F_104 ( V_23 , V_69 , V_142 , V_1 , V_2 ) ;
if ( V_81 )
return V_81 ;
F_102 ( V_69 , V_101 - V_209 , V_130 ) ;
return F_156 ( V_23 , V_69 , V_183 ) ;
}
static int F_173 ( struct V_23 * V_23 , struct V_69 * V_69 ,
...
F_8 ( V_2 != 0 ) ;
V_183 = F_142 ( V_23 , V_1 , V_2 , V_197 -> V_142 ) ;
V_81 = F_172 ( V_23 , V_69 , V_197 -> V_142 , V_183 , V_101 ) ;
if ( V_81 ) {
F_144 ( V_23 , V_183 ) ;
return V_81 ;
}
...
static int F_174 ( struct V_23 * V_23 , T_1 V_101 )
{
struct V_24 * V_25 = V_24 ( V_23 ) ;
struct V_196 V_197 ;
struct V_69 * V_69 ;
...
int V_81 ;
F_92 ( V_23 ) ;
for ( V_210 = V_3 - 1 ; V_210 >= 0 ; V_210 -- ) {
if ( V_101 > ( V_210 + 1 ) * V_211 )
break;
V_197 . V_142 = V_25 -> V_58 [ V_210 ] ;
if ( ! V_197 . V_142 )
continue;
V_69 = F_52 ( V_23 , V_210 , 0 ) ;
if ( ! V_69 )
return - V_136 ;
V_81 = F_104 ( V_23 , V_69 , V_197 . V_142 , V_210 , 0 ) ;
if ( V_81 ) {
F_57 ( V_69 ) ;
return V_81 ;
}
V_81 = F_173 ( V_23 , V_69 , & V_197 , V_101 ) ;
F_57 ( V_69 ) ;
if ( V_81 )
return V_81 ;
V_25 -> V_58 [ V_210 ] = V_197 . V_142 ;
}
return 0 ;
}
static inline T_1 F_175 ( T_2 V_2 )
{
return V_212 [ ( V_13 T_3 ) V_2 ] ;
}
static inline T_1 F_176 ( T_3 V_2 )
{
return V_212 [ V_2 ] * V_211 ;
}
static inline T_1 F_177 ( T_2 V_2 )
{
return V_213 [ ( V_13 T_3 ) V_2 ] ;
}
static void F_178 ( T_4 V_12 , T_1 * V_1 , T_2 * V_2 )
{
F_9 ( V_12 , V_1 , V_2 ) ;
if ( * V_1 <= F_177 ( F_106 ( * V_2 ) ) )
* V_1 = 0 ;
}
static int F_179 ( struct V_23 * V_23 , struct V_69 * V_135 ,
...
struct V_69 * V_69 ;
struct V_196 V_207 = { } ;
F_178 ( V_135 -> V_12 , & V_1 , & V_2 ) ;
V_81 = F_104 ( V_23 , V_135 , V_205 -> V_142 , V_1 , V_2 ) ;
if ( V_81 )
return V_81 ;
for ( V_210 = V_107 - 1 ; V_210 >= 0 ; V_210 -- ) {
V_215 = V_1 + V_210 * F_175 ( F_106 ( V_2 ) ) ;
V_216 = V_215 + F_175 ( F_106 ( V_2 ) ) ;
if ( V_101 > V_216 * V_211 )
break;
V_207 . V_142 = F_118 ( F_100 ( V_135 , V_210 ) ) ;
if ( ! V_207 . V_142 )
continue;
V_69 = F_52 ( V_23 , V_215 , F_106 ( V_2 ) ) ;
if ( ! V_69 )
return - V_136 ;
if ( ( V_13 T_3 ) V_2 > 1 )
V_81 = F_179 ( V_23 , V_69 , & V_207 , V_101 ) ;
else
V_81 = F_173 ( V_23 , V_69 , & V_207 , V_101 ) ;
F_57 ( V_69 ) ;
if ( V_81 )
return V_81 ;
V_214 = 1 ;
F_97 ( V_23 , V_135 , 0 ) ;
F_98 ( V_135 , V_210 , V_207 . V_142 ) ;
}
if ( ! V_214 ) {
...
if ( ! V_69 )
return - V_136 ;
V_81 = F_179 ( V_23 , V_69 , & V_197 , V_101 ) ;
F_57 ( V_69 ) ;
if ( V_81 )
return V_81 ;
if ( V_25 -> V_58 [ V_133 ] != V_197 . V_142 )
...
static int F_181 ( struct V_23 * V_23 , T_1 V_101 )
{
int V_89 ;
if ( V_101 >= F_176 ( V_24 ( V_23 ) -> V_29 ) )
return 0 ;
V_89 = F_180 ( V_23 , V_101 ) ;
if ( V_89 )
return V_89 ;
return F_174 ( V_23 , V_101 ) ;
}
int F_182 ( struct V_23 * V_23 , T_1 V_217 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
T_1 V_101 = F_28 ( V_23 ) ;
int V_81 = 0 ;
V_101 = F_30 ( V_101 , V_218 ) ;
while ( V_101 > V_217 ) {
if ( V_101 > V_218 )
V_101 -= V_218 ;
else
...
V_101 = V_217 ;
F_37 ( V_63 , NULL , 1 ) ;
V_81 = F_181 ( V_23 , V_101 ) ;
if ( ! V_81 )
V_81 = F_68 ( V_23 , NULL , 0 ) ;
F_40 ( V_63 , NULL , 1 ) ;
}
if ( ! V_81 ) {
V_81 = F_183 ( V_23 , V_217 ) ;
if ( V_81 )
goto V_208;
F_184 ( V_23 , V_217 ) ;
}
...
static void F_185 ( struct V_23 * V_23 , struct V_69 * V_69 )
{
struct V_24 * V_25 = V_24 ( V_23 ) ;
struct V_95 * V_96 = V_95 ( V_69 ) ;
if ( ! V_96 )
...
static void F_187 ( struct V_69 * V_69 , struct V_23 * V_23 )
{
struct V_24 * V_25 = V_24 ( V_23 ) ;
...
int F_188 ( struct V_23 * V_23 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_71 * V_72 = V_71 ( V_63 ) ;
struct V_23 * V_219 = V_72 -> V_220 ;
struct V_69 * V_69 ;
struct V_21 * V_22 ;
T_1 V_105 = V_23 -> V_98 ;
if ( V_105 << V_63 -> V_67 > F_28 ( V_219 ) )
return - V_221 ;
if ( ! F_109 ( V_219 , V_105 ) )
return - V_221 ;
V_69 = F_189 ( V_219 -> V_75 , V_105 ,
( V_222 * ) V_223 , NULL ) ;
if ( F_126 ( V_69 ) )
return F_190 ( V_69 ) ;
V_22 = F_76 ( V_69 ) ;
...
static struct V_69 * F_191 ( struct V_23 * V_23 )
{
struct V_23 * V_219 = V_71 ( V_23 -> V_64 ) -> V_220 ;
struct V_21 * V_22 ;
struct V_69 * V_69 ;
F_8 ( V_23 -> V_98 == V_99 ) ;
V_69 = F_52 ( V_219 , V_23 -> V_98 , 0 ) ;
if ( ! V_69 )
return NULL ;
V_22 = F_76 ( V_69 ) ;
F_23 ( V_23 , V_22 ) ;
...
static int F_192 ( struct V_23 * V_23 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_23 * V_219 = V_71 ( V_63 ) -> V_220 ;
...
if ( ! V_69 )
return - V_136 ;
V_81 = F_65 ( V_219 , V_69 , 0 ) ;
if ( V_81 )
F_185 ( V_23 , V_69 ) ;
F_57 ( V_69 ) ;
return V_81 ;
}
static void F_194 ( struct V_62 * V_63 , T_8 V_185 ,
int V_224 ,
void (* F_195)( struct V_225 * , long ) ,
long V_226 )
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
struct V_23 * V_23 ;
...
T_4 V_228 ;
int V_194 ;
V_228 = V_185 >> ( V_63 -> V_67 - 3 ) ;
V_194 = V_185 & ( ( V_63 -> V_229 >> 3 ) - 1 ) ;
V_23 = V_72 -> V_230 ;
V_69 = F_52 ( V_23 , V_228 , 0 ) ;
F_8 ( ! V_69 ) ;
if ( ! F_161 ( V_69 ) )
F_107 ( V_23 , V_69 , V_231 ) ;
if ( V_224 )
F_97 ( V_23 , V_69 , 0 ) ;
V_227 = F_76 ( V_69 ) ;
F_195 ( V_227 + V_194 , V_226 ) ;
if ( V_224 ) {
F_151 ( V_63 , V_95 ( V_69 ) , V_194 ) ;
F_8 ( ( int ) F_17 ( V_227 [ V_194 ] . V_232 ) > V_72 -> V_233 ) ;
}
F_77 ( V_227 ) ;
F_57 ( V_69 ) ;
}
static void F_196 ( struct V_225 * V_227 , long V_234 )
{
struct V_225 * V_217 = ( void * ) V_234 ;
* V_217 = * V_227 ;
}
void F_197 ( struct V_62 * V_63 , T_8 V_185 ,
struct V_225 * V_227 )
{
F_194 ( V_63 , V_185 , 0 , F_196 , ( long ) V_227 ) ;
}
static void F_198 ( struct V_225 * V_227 , long V_139 )
{
T_8 V_232 ;
V_232 = F_17 ( V_227 -> V_232 ) ;
V_232 += V_139 ;
V_227 -> V_232 = F_25 ( V_232 ) ;
}
void F_199 ( struct V_62 * V_63 , T_1 V_142 , int V_139 )
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
T_8 V_185 = V_142 >> V_72 -> V_193 ;
if ( ! V_139 )
return;
F_194 ( V_63 , V_185 , 1 , F_198 , V_139 ) ;
}
static void F_200 ( struct V_225 * V_227 , long V_235 )
{
V_227 -> V_235 = F_25 ( V_235 ) ;
}
void F_201 ( struct V_62 * V_63 , T_8 V_185 , T_8 V_236 ,
T_7 V_144 )
{
T_8 V_235 = V_236 << 4 | ( V_13 T_3 ) V_144 ;
F_194 ( V_63 , V_185 , 1 , F_200 , V_235 ) ;
}
static void F_202 ( struct V_225 * V_227 , long V_237 )
{
V_227 -> V_232 = F_25 ( V_238 ) ;
}
void F_203 ( struct V_62 * V_63 , T_8 V_185 )
{
F_194 ( V_63 , V_185 , 1 , F_202 , 0 ) ;
}
static void F_204 ( struct V_225 * V_227 ,
long V_235 )
{
V_227 -> V_232 = 0 ;
V_227 -> V_235 = F_25 ( V_235 ) ;
}
void F_205 ( struct V_62 * V_63 , T_8 V_185 , T_8 V_236 )
{
T_8 V_235 = V_236 << 4 ;
F_194 ( V_63 , V_185 , 1 , F_204 ,
V_235 ) ;
}
...
static int F_206 ( struct V_23 * V_23 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_23 * V_219 = V_71 ( V_63 ) -> V_220 ;
struct V_69 * V_69 ;
...
F_187 ( V_69 , V_23 ) ;
F_37 ( V_63 , V_69 , 1 ) ;
V_89 = F_168 ( V_219 , V_69 ) ;
F_40 ( V_63 , V_69 , 1 ) ;
F_57 ( V_69 ) ;
return V_89 ;
}
void F_207 ( struct V_23 * V_23 )
{
struct V_62 * V_63 = V_23 -> V_64 ;
struct V_24 * V_25 = V_24 ( V_23 ) ;
struct V_95 * V_96 = V_25 -> V_119 ;
...
F_208 ( & V_23 -> V_240 ) ;
F_209 ( V_23 ) ;
F_8 ( V_23 -> V_241 & V_242 && V_23 -> V_61 ) ;
if ( ! V_96 )
return;
if ( ( V_71 ( V_63 ) -> V_243 & V_244 ) ) {
V_96 -> V_113 -> V_189 ( V_23 -> V_64 , V_96 ) ;
return;
}
V_69 = F_191 ( V_23 ) ;
...
F_8 ( V_81 ) ;
F_8 ( F_86 ( V_69 ) || V_69 -> V_245 ) ;
F_57 ( V_69 ) ;
F_127 ( V_23 , V_145 ) ;
}
int F_211 ( struct V_23 * V_23 , const void * V_246 , T_10 V_247 ,
...
return - V_136 ;
V_248 = F_76 ( V_69 ) ;
memcpy ( V_248 , V_246 , V_247 ) ;
F_133 ( V_69 ) ;
F_77 ( V_248 ) ;
if ( F_28 ( V_23 ) < V_104 + V_211 )
F_193 ( V_23 , V_104 + V_211 ) ;
V_81 = F_65 ( V_23 , V_69 , V_198 ) ;
F_57 ( V_69 ) ;
return V_81 ;
}
int F_212 ( struct V_62 * V_63 )
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
struct V_23 * V_23 ;
V_23 = F_213 ( V_63 , V_249 ) ;
if ( F_126 ( V_23 ) )
return F_190 ( V_23 ) ;
V_72 -> V_230 = V_23 ;
return 0 ;
}
int F_214 ( struct V_62 * V_63 )
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
int V_250 = 3 * V_72 -> V_251 ;
F_91 ( & V_72 -> V_195 ) ;
F_91 ( & V_72 -> V_161 ) ;
F_215 ( & V_72 -> V_74 ) ;
V_72 -> V_118 = F_216 ( V_250 ,
sizeof( struct V_95 ) ) ;
V_72 -> V_184 = F_216 ( V_250 ,
sizeof( struct V_181 ) ) ;
return 0 ;
}
void F_217 ( struct V_62 * V_63 )
{
struct V_71 * V_72 = V_71 ( V_63 ) ;
F_218 ( V_72 -> V_118 ) ;
F_218 ( V_72 -> V_184 ) ;
