...
T_2 V_79 = F_45 ( V_74 ) ;
T_3 V_80 = F_46 ( V_74 ) ;
bool V_81 = V_3 -> V_17 -> V_82 &&
F_47 ( V_77 , V_74 ) ;
T_2 V_20 = V_74 + V_77 -> V_78 ;
T_2 V_38 ;
if ( V_81 )
F_36 ( V_3 -> V_83 , V_20 , V_84 ) ;
V_38 = ( F_27 ( V_3 -> V_66 + V_79 ) >> V_80 ) & V_85 ;
if ( V_81 )
F_36 ( V_3 -> V_83 , V_20 , V_86 ) ;
return ! ! V_38 ;
}
static void F_48 ( struct V_76 * V_77 ,
unsigned V_74 , int V_87 )
{
struct V_2 * V_3 = F_44 ( V_77 ) ;
T_2 V_79 = F_45 ( V_74 ) ;
T_3 V_80 = F_46 ( V_74 ) ;
...
T_2 V_88 ;
F_23 ( & V_3 -> V_65 , V_61 ) ;
V_88 = F_27 ( V_3 -> V_66 + V_79 ) ;
if ( V_87 )
V_88 |= F_49 ( V_80 ) ;
else
V_88 &= ~ ( F_49 ( V_80 ) ) ;
F_30 ( V_88 , V_3 -> V_66 + V_79 ) ;
F_26 ( & V_3 -> V_65 , V_61 ) ;
}
...
static int F_52 ( struct V_76 * V_89 ,
const struct V_90 * V_91 ,
T_2 * V_61 )
{
int V_20 , V_78 ;
V_78 = V_92 * V_91 -> args [ 0 ] ;
V_20 = V_78 + V_91 -> args [ 1 ] ;
if ( V_20 > V_89 -> V_93 )
return - V_40 ;
if ( V_61 )
* V_61 = V_91 -> args [ 2 ] ;
...
struct V_2 * V_3 = F_44 ( V_77 ) ;
struct V_14 * V_17 ;
unsigned V_94 = V_3 -> V_17 -> V_62 + V_74 ;
unsigned V_95 ;
if ( V_74 >= V_77 -> V_93 )
return - V_96 ;
V_17 = F_4 ( V_3 , V_94 , L_11 ) ;
if ( ! V_17 )
return - V_40 ;
V_95 = V_17 -> V_97 * V_98 + V_17 -> V_95 ;
F_54 ( V_77 -> V_99 , L_12 ,
V_77 -> V_100 , V_74 + V_77 -> V_78 , V_95 ) ;
return F_55 ( V_3 -> V_101 , V_95 ) ;
}
...
F_36 ( V_3 -> V_83 , V_3 -> V_104 [ V_103 -> V_105 ] , V_11 -> V_71 ) ;
return 0 ;
}
...
{
struct V_2 * V_3 = F_57 ( V_103 ) ;
T_2 V_79 = F_63 ( V_103 -> V_105 , V_3 -> V_17 -> V_106 ) ;
...
V_88 = F_27 ( V_3 -> V_66 + V_79 ) ;
V_88 &= ~ ( V_123 << V_80 ) ;
F_30 ( V_88 | ( V_107 << V_80 ) , V_3 -> V_66 + V_79 ) ;
F_26 ( & V_3 -> V_65 , V_61 ) ;
return 0 ;
}
...
{
struct V_2 * V_3 = F_57 ( V_103 ) ;
T_2 V_124 = F_67 ( V_103 -> V_105 ,
V_3 -> V_17 -> V_106 ) ;
T_3 V_125 = F_68 ( V_103 -> V_105 ) ;
F_30 ( 1 << V_125 , V_3 -> V_66 + V_124 ) ;
}
static void F_69 ( struct V_102 * V_103 )
{
struct V_2 * V_3 = F_57 ( V_103 ) ;
T_2 V_79 = F_70 ( V_103 -> V_105 , V_3 -> V_17 -> V_106 ) ;
T_3 V_126 = F_71 ( V_103 -> V_105 ) ;
unsigned long V_61 ;
T_2 V_38 ;
F_23 ( & V_3 -> V_65 , V_61 ) ;
...
static int F_74 ( struct V_127 * V_103 ,
struct V_27 * V_28 ,
const T_2 * V_128 ,
unsigned int V_129 ,
unsigned long * V_130 ,
...
if ( ! V_17 )
return - V_40 ;
* V_130 = V_17 -> V_97 * V_92 + V_17 -> V_95 ;
* V_131 = V_128 [ 2 ] ;
return 0 ;
}
...
return;
V_79 = F_79 ( V_136 , V_3 -> V_17 -> V_106 ) ;
V_38 = F_27 ( V_3 -> V_66 + V_79 ) ;
if ( V_38 ) {
int V_138 ;
F_80 ( V_77 , V_17 ) ;
F_81 (irqoffset, &val, IRQ_PER_BANK) {
int V_139 = F_55 ( V_3 -> V_101 ,
V_136 * V_98 + V_138 ) ;
F_82 ( V_139 ) ;
}
F_83 ( V_77 , V_17 ) ;
...
int V_95 = V_11 -> V_95 + V_11 -> V_97 * V_98 ;
V_3 -> V_104 [ V_95 ] = V_20 -> V_20 . V_23 ;
}
F_84 ( V_3 , V_11 -> V_9 ) ;
V_11 ++ ;
}
...
V_148 -> V_159 = & V_160 ;
V_148 -> V_161 = & V_162 ;
V_3 -> V_83 = F_98 ( & V_142 -> V_39 , V_148 , V_3 ) ;
if ( F_94 ( V_3 -> V_83 ) ) {
F_11 ( & V_142 -> V_39 , L_15 ) ;
return F_95 ( V_3 -> V_83 ) ;
}
...
V_3 -> V_77 -> V_93 = F_99 ( V_152 , V_92 ) -
V_3 -> V_17 -> V_62 ;
V_3 -> V_77 -> V_100 = F_97 ( & V_142 -> V_39 ) ;
V_3 -> V_77 -> V_99 = & V_142 -> V_39 ;
...
for ( V_5 = 0 ; V_5 < ( V_3 -> V_17 -> V_137 * V_98 ) ; V_5 ++ ) {
