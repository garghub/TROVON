...
static void F_182 ( struct V_411 * V_322 , T_14 V_395 )
{
}
...
V_225 = F_187 ( V_19 -> V_7 , V_14 , V_16 -> V_228 ) ;
F_108 ( V_5 , V_14 , V_16 , V_225 , V_19 ) ;
return 0 ;
}
static bool F_188 ( struct V_18 * V_19 ,
struct V_13 * V_14 )
{
struct V_4 * V_5 = V_19 -> V_7 -> V_343 ;
struct V_12 * V_16 = F_9 ( V_14 ) ;
...
if ( V_16 -> V_297 && F_189 ( & V_5 -> V_23 -> V_344 ) )
return true ;
return false ;
}
...
{
struct V_13 * V_14 = V_415 -> V_14 ;
int V_289 ;
if ( F_17 ( F_188 ( V_19 , V_14 ) ) )
return V_416 ;
F_191 ( V_14 ) ;
...
static void F_192 ( void * V_107 , struct V_13 * V_14 ,
unsigned int V_419 , unsigned int V_420 )
{
struct V_4 * V_5 = V_107 ;
struct V_12 * V_16 = F_9 ( V_14 ) ;
if ( ! V_16 -> V_70 )
return;
F_89 ( & V_5 -> V_2 -> V_10 , V_421 ,
V_16 -> V_70 , V_16 -> V_422 ) ;
}
static int F_193 ( void * V_107 , struct V_13 * V_14 , unsigned int V_419 ,
unsigned int V_420 , unsigned int V_373 )
{
struct V_4 * V_5 = V_107 ;
struct V_12 * V_16 = F_9 ( V_14 ) ;
T_2 V_423 = F_21 ( V_5 -> V_28 + V_44 ) & V_45 ;
if ( V_420 >= V_424 )
return 0 ;
V_16 -> V_70 = F_87 ( & V_5 -> V_2 -> V_10 , V_421 ,
& V_16 -> V_422 , V_143 ) ;
if ( ! V_16 -> V_70 )
return - V_214 ;
memset ( V_16 -> V_70 , 0 , V_421 ) ;
V_16 -> V_157 = V_5 -> V_23 -> V_361 +
( sizeof( struct V_425 ) * V_420 ) ;
V_16 -> V_426 = V_5 -> V_23 -> V_46 +
( sizeof( struct V_425 ) * V_420 ) ;
if ( V_423 )
V_16 -> V_157 -> V_427 = V_158 F_71 ( ( V_16 -> V_422 >> 16 ) >> 16 ) ;
V_16 -> V_157 -> V_428 = V_158 F_71 ( V_16 -> V_422 & 0xFFFFFFFF ) ;
F_194 ( V_16 -> V_228 , V_429 ) ;
return 0 ;
}
static enum V_430 F_195 ( struct V_13 * V_346 ,
bool V_347 )
{
...
V_5 -> V_322 = F_197 ( V_436 , V_5 -> V_373 ) ;
if ( V_5 -> V_322 == NULL ) {
F_37 ( & V_5 -> V_2 -> V_10 ,
L_124 ) ;
V_61 = - V_200 ;
...
do {
if ( ! F_198 ( & V_438 , V_143 ) )
goto V_439;
F_27 ( & V_440 ) ;
V_61 = F_199 ( & V_438 , & V_387 ) ;
F_30 ( & V_440 ) ;
} while ( V_61 == - V_168 );
if ( V_61 )
goto V_439;
...
if ( V_61 )
goto V_442;
V_5 -> V_322 -> V_443 = V_5 -> V_443 ;
V_5 -> V_322 -> V_444 = V_387 * V_436 ;
V_5 -> V_322 -> V_445 = V_436 ;
V_5 -> V_322 -> V_446 = & V_447 ;
V_5 -> V_322 -> V_304 = V_5 ;
V_5 -> V_387 = V_387 ;
F_129 ( V_5 ) ;
memset ( & V_5 -> V_21 , 0 , sizeof( V_5 -> V_21 ) ) ;
V_5 -> V_21 . V_448 = & V_449 ;
V_5 -> V_21 . V_450 = 1 ;
V_5 -> V_21 . V_451 = V_424 ;
V_5 -> V_21 . V_452 = 1 ;
V_5 -> V_21 . V_453 = sizeof( struct V_12 ) ;
...
if ( V_433 == V_341 )
goto V_459;
F_4 ( V_460 , & V_5 -> V_7 -> V_9 ) ;
F_62 ( V_461 , & V_5 -> V_7 -> V_9 ) ;
F_202 ( V_5 -> V_7 , V_429 ) ;
F_203 ( V_5 -> V_7 , 4096 ) ;
F_204 ( V_5 -> V_7 , 0xffff ) ;
F_205 ( V_5 -> V_7 , 0x400000 ) ;
F_206 ( V_5 -> V_7 , 4096 ) ;
F_207 ( V_5 -> V_7 , V_5 -> V_2 -> V_462 ) ;
if ( V_5 -> V_182 == true ) {
...
F_209 ( V_5 -> V_322 , V_407 ) ;
F_210 ( & V_5 -> V_2 -> V_10 , V_5 -> V_322 ) ;
V_5 -> V_468 = F_211 ( V_5 -> V_322 , 0 ) ;
V_318 = F_212 ( & F_213 ( V_5 -> V_322 ) -> V_318 ) ;
if ( V_318 ) {
F_125 ( V_5 , V_318 ) ;
F_214 ( V_318 ) ;
}
...
static void F_223 ( struct V_13 * V_14 , void * V_107 , bool V_472 )
{
struct V_4 * V_5 = (struct V_4 * ) V_107 ;
struct V_12 * V_16 ;
if ( F_45 ( ! V_472 ) )
...
static void F_230 ( int V_473 )
{
V_474 [ V_473 ] -- ;
}
static int F_231 ( int V_475 )
{
int V_473 , V_476 , V_477 ;
...
static void F_237 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
int V_483 ;
unsigned short V_484 ;
V_483 = F_238 ( V_2 , V_485 ) ;
if ( V_483 ) {
F_3 ( V_2 ,
V_483 + V_486 ,
& V_484 ) ;
...
static void F_240 ( struct V_4 * V_5 , struct V_1 * V_2 )
{
if ( V_2 -> V_490 && V_2 -> V_490 -> V_491 ) {
if ( V_2 -> V_490 -> V_491 -> V_487 == V_492 &&
( ( V_2 -> V_490 -> V_491 -> V_192 & 0xff00 ) == 0x5a00 ) ) {
F_237 ( V_5 , V_2 -> V_490 -> V_491 ) ;
} else {
struct V_1 * V_493 = V_2 -> V_490 -> V_491 ;
if ( V_493 -> V_490 &&
V_493 -> V_490 -> V_494 &&
V_493 -> V_490 -> V_494 -> V_491 &&
V_493 -> V_490 -> V_494 -> V_491 -> V_487 ==
V_492 &&
( V_493 -> V_490 -> V_494 -> V_491 -> V_192 &
0xff00 ) == 0x5a00 ) {
F_237 ( V_5 ,
V_493 -> V_490 -> V_494 -> V_491 ) ;
}
...
char V_497 [ 256 ] ;
const struct V_478 * V_479 ;
int V_473 , V_43 = 0 , V_498 = 0 ;
int V_499 = V_500 ;
unsigned long V_86 ;
V_499 = F_242 ( V_2 -> V_490 ) ;
if ( V_499 != V_500 ) {
if ( ! F_243 ( V_499 ) )
V_499 = F_235 () ;
} else {
...
F_47 ( & V_2 -> V_10 , L_137 ,
V_499 , F_242 ( V_2 -> V_490 ) , F_244 ( & V_2 -> V_10 ) ,
F_245 ( F_246 () ) , F_246 () ) ;
V_5 = F_159 ( sizeof( struct V_4 ) , V_143 , V_499 ) ;
if ( V_5 == NULL ) {
F_37 ( & V_2 -> V_10 ,
L_138 ) ;
return - V_214 ;
...
V_61 = F_249 ( V_2 , 1 << V_371 , V_88 ) ;
if ( V_61 < 0 ) {
F_37 ( & V_2 -> V_10 , L_140 ) ;
goto V_501;
}
if ( ! F_250 ( V_2 , F_251 ( 64 ) ) ) {
V_61 = F_252 ( V_2 , F_251 ( 64 ) ) ;
if ( V_61 ) {
V_61 = F_252 ( V_2 ,
F_251 ( 32 ) ) ;
if ( V_61 ) {
...
F_253 ( & V_5 -> V_504 ) ;
F_253 ( & V_5 -> V_505 ) ;
memset ( V_5 -> V_506 , 0 , 32 ) ;
snprintf ( V_5 -> V_506 , 31 , L_142 , V_5 -> V_123 ) ;
V_5 -> V_119 = F_254 ( V_5 -> V_506 ) ;
if ( ! V_5 -> V_119 ) {
...
V_479 = F_232 ( V_5 -> V_373 ) ;
if ( ! F_255 ( V_479 ) ) {
F_234 (cpu, node_mask)
{
snprintf ( & V_497 [ V_498 ] , 256 - V_498 , L_144 , V_473 ) ;
V_498 = strlen ( V_497 ) ;
}
F_47 ( & V_2 -> V_10 , L_145 ,
V_5 -> V_373 ,
...
F_50 ( & V_2 -> V_10 , L_146 ) ;
V_5 -> V_384 = F_231 ( V_5 -> V_373 ) ;
F_47 ( & V_2 -> V_10 , L_147 ,
F_245 ( V_5 -> V_384 ) , V_5 -> V_384 ) ;
V_5 -> V_117 [ 0 ] . V_118 = V_5 -> V_384 ;
V_5 -> V_117 [ 1 ] . V_118 = F_231 ( V_5 -> V_373 ) ;
V_5 -> V_117 [ 2 ] . V_118 = F_231 ( V_5 -> V_373 ) ;
...
F_258 (cpu) {
memset ( V_497 , 0 , sizeof( V_497 ) ) ;
for ( V_43 = 0 , V_498 = 0 ; V_43 < V_116 ; V_43 ++ ) {
if ( V_5 -> V_117 [ V_43 ] . V_118 == V_473 ) {
snprintf ( & V_497 [ V_498 ] , 256 - V_498 , L_144 , V_43 ) ;
V_498 = strlen ( V_497 ) ;
}
}
if ( V_498 )
F_47 ( & V_2 -> V_10 , L_148 , V_473 , V_497 ) ;
}
F_259 ( & V_5 -> V_117 [ 0 ] . V_117 , V_508 ) ;
F_259 ( & V_5 -> V_117 [ 1 ] . V_117 , V_509 ) ;
F_259 ( & V_5 -> V_117 [ 2 ] . V_117 , V_510 ) ;
F_259 ( & V_5 -> V_117 [ 3 ] . V_117 , V_511 ) ;
F_259 ( & V_5 -> V_117 [ 4 ] . V_117 , V_512 ) ;
F_259 ( & V_5 -> V_117 [ 5 ] . V_117 , V_513 ) ;
F_259 ( & V_5 -> V_117 [ 6 ] . V_117 , V_514 ) ;
F_259 ( & V_5 -> V_117 [ 7 ] . V_117 , V_515 ) ;
F_260 ( V_2 ) ;
V_61 = F_261 ( V_2 ) ;
if ( V_61 ) {
F_5 ( & V_2 -> V_10 ,
...
F_264 ( V_5 -> V_119 ) ;
F_265 ( V_5 -> V_119 ) ;
F_230 ( V_5 -> V_117 [ 0 ] . V_118 ) ;
F_230 ( V_5 -> V_117 [ 1 ] . V_118 ) ;
F_230 ( V_5 -> V_117 [ 2 ] . V_118 ) ;
}
V_502:
F_266 ( V_2 , 1 << V_371 ) ;
V_501:
...
static int F_272 ( struct V_1 * V_2 , T_15 V_519 )
{
int V_61 = 0 ;
struct V_4 * V_5 = F_2 ( V_2 ) ;
if ( ! V_5 ) {
