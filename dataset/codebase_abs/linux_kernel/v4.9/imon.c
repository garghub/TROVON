...
L_64 , V_2 -> V_195 , V_2 -> V_64 ) ;
F_78 ( V_2 -> V_30 , V_2 -> V_196 ,
sizeof( V_2 -> V_196 ) ) ;
F_79 ( V_2 -> V_196 , L_65 , sizeof( V_2 -> V_196 ) ) ;
...
sizeof( V_2 -> V_212 ) ) ;
F_79 ( V_2 -> V_212 , L_69 , sizeof( V_2 -> V_212 ) ) ;
...
sizeof( V_2 -> V_225 ) ) ;
F_79 ( V_2 -> V_225 , L_72 , sizeof( V_2 -> V_225 ) ) ;
...
V_2 -> V_5 = V_5 ;
V_2 -> V_188 = false ;
V_2 -> V_195 = F_102 ( V_2 -> V_30 -> V_253 . V_254 ) ;
V_2 -> V_64 = F_102 ( V_2 -> V_30 -> V_253 . V_255 ) ;
...
static struct V_1 * F_106 ( struct V_11 * V_162 ,
struct V_1 * V_2 )
{
struct V_82 * V_250 ;
struct V_228 * V_229 ;
...
int V_192 ;
F_4 ( V_2 -> V_4 , L_88 ) ;
V_192 = F_109 ( & V_162 -> V_4 . V_266 , & V_267 ) ;
if ( V_192 )
F_77 ( V_2 -> V_4 , L_89
L_90 , V_192 ) ;
if ( V_2 -> V_62 == V_63 )
V_192 = F_110 ( V_162 , & V_268 ) ;
else
V_192 = F_110 ( V_162 , & V_269 ) ;
if ( V_192 )
F_33 ( V_2 -> V_4 , L_91
L_92 ) ;
}
...
V_195 = F_102 ( V_271 -> V_253 . V_254 ) ;
V_64 = F_102 ( V_271 -> V_253 . V_255 ) ;
F_4 ( V_4 , L_93 ,
...
F_115 ( & V_12 -> V_4 . V_266 , & V_267 ) ;
F_115 ( & V_12 -> V_4 . V_266 , & V_276 ) ;
F_113 ( V_12 , NULL ) ;
if ( V_2 -> V_44 . V_46 ) {
F_25 ( V_2 -> V_5 ) ;
F_116 ( & V_2 -> V_44 . V_45 ) ;
