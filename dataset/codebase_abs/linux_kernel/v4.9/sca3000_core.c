...
* V_4 = ( F_25 ( ( V_66 * ) V_2 -> V_13 ) >> 3 ) & 0x1FFF ;
...
F_15 ( & V_2 -> V_31 ) ;
V_14 = F_10 ( V_2 , V_65 [ V_79 ] [ 1 ] , V_83 ) ;
F_16 ( & V_2 -> V_31 ) ;
return V_14 ;
}
...
goto V_106;
V_2 -> V_63 ++ ;
} else if ( ! V_105 && ( V_57 & V_65 [ V_79 ] [ 2 ] ) ) {
V_14 = F_10 ( V_2 ,
V_103 ,
V_57 &
~ ( V_65 [ V_79 ] [ 2 ] ) ) ;
