...
{
F_14 ( V_30 , V_52 , ( V_3 [ 0 ] << 9 ) | V_3 [ 1 ] ) ;
F_14 ( V_30 , V_53 , ( V_3 [ 2 ] << 8 ) | V_3 [ 3 ] ) ;
F_14 ( V_30 , V_54 , ( V_3 [ 4 ] << 8 ) | V_3 [ 5 ] ) ;
return 0 ;
}
static int F_24 ( int V_55 )
{
if ( V_55 >= 0 && V_55 < V_27 )
return V_55 ;
return - 1 ;
}
static int F_25 ( struct V_1 * V_2 , int V_55 , int V_56 )
{
int V_3 ;
V_3 = F_24 ( V_55 ) ;
if ( V_3 == - 1 )
return 0xffff ;
return F_1 ( V_2 , V_3 , V_56 ) ;
}
static int
F_26 ( struct V_1 * V_2 , int V_55 , int V_56 , T_1 V_9 )
{
int V_3 ;
V_3 = F_24 ( V_55 ) ;
if ( V_3 == - 1 )
return 0xffff ;
return F_3 ( V_2 , V_3 , V_56 , V_9 ) ;
}
