...
struct V_4 * V_5 = V_2 -> V_4 ;
F_64 ( V_60 -> V_61 , V_62 , sizeof( V_60 -> V_61 ) ) ;
F_64 ( V_60 -> V_63 , V_62 L_6 , sizeof( V_60 -> V_63 ) ) ;
...
static int F_66 ( struct V_57 * V_57 , void * V_32 ,
struct V_72 * V_73 )
{
return F_67 ( V_73 ) ;
}
static int F_68 ( struct V_57 * V_57 , void * V_58 ,
struct V_74 * V_73 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
return F_69 ( V_2 , V_73 ) ;
}
static int F_70 ( struct V_57 * V_57 , void * V_58 ,
struct V_74 * V_73 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
return F_71 ( V_2 , V_73 ) ;
}
static int F_72 ( struct V_57 * V_57 , void * V_58 ,
struct V_74 * V_73 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
struct V_16 * V_43 ;
...
struct V_75 * V_76 ;
int V_50 , V_6 = 0 ;
V_6 = F_70 ( V_57 , V_58 , V_73 ) ;
if ( V_6 )
return V_6 ;
V_43 = F_73 ( V_2 -> V_26 , V_73 -> type ) ;
if ( F_74 ( V_43 ) ) {
F_29 ( L_8 , V_73 -> type ) ;
return - V_77 ;
}
...
V_49 = & V_2 -> V_35 ;
V_76 = & V_73 -> V_51 . V_78 ;
V_49 -> V_51 = F_75 ( & V_76 -> V_79 , NULL , 0 ) ;
V_49 -> V_80 = V_76 -> V_80 ;
if ( ! V_49 -> V_51 )
return - V_52 ;
for ( V_50 = 0 ; V_50 < V_49 -> V_51 -> V_45 ; V_50 ++ )
V_49 -> V_53 [ V_50 ] = V_76 -> V_81 [ V_50 ] . V_82 ;
F_76 ( V_49 , V_76 -> V_83 , V_76 -> V_84 ) ;
if ( V_73 -> type == V_85 )
F_4 ( V_40 | V_86 , V_2 ) ;
else
F_4 ( V_40 | V_87 , V_2 ) ;
F_27 ( L_9 , V_49 -> V_88 , V_49 -> V_89 ) ;
return 0 ;
}
static int F_77 ( struct V_57 * V_57 , void * V_58 ,
struct V_90 * V_91 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
struct V_4 * V_5 = V_2 -> V_4 ;
...
return F_78 ( V_57 , V_2 -> V_26 , V_91 ) ;
}
static int F_79 ( struct V_57 * V_57 , void * V_58 ,
struct V_97 * V_98 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
return F_80 ( V_57 , V_2 -> V_26 , V_98 ) ;
}
static int F_81 ( struct V_57 * V_57 , void * V_58 ,
struct V_99 * V_100 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
return F_82 ( V_57 , V_2 -> V_26 , V_100 ) ;
}
static int F_83 ( struct V_57 * V_57 , void * V_58 ,
struct V_99 * V_100 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
return F_84 ( V_57 , V_2 -> V_26 , V_100 ) ;
}
static int F_85 ( struct V_57 * V_57 , void * V_58 ,
struct V_99 * V_100 )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
return F_86 ( V_57 , V_2 -> V_26 , V_100 ) ;
}
static int F_87 ( struct V_57 * V_57 , void * V_58 ,
enum V_101 type )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
if ( F_57 ( type ) ) {
...
return F_88 ( V_57 , V_2 -> V_26 , type ) ;
}
static int F_89 ( struct V_57 * V_57 , void * V_58 ,
enum V_101 type )
{
struct V_1 * V_2 = F_63 ( V_58 ) ;
return F_90 ( V_57 , V_2 -> V_26 , type ) ;
}
static int F_91 ( struct V_102 * V_103 , struct V_102 * V_104 )
{
...
static int F_93 ( struct V_57 * V_57 , void * V_58 ,
struct V_107 * V_108 )
{
struct V_33 * V_49 ;
struct V_1 * V_2 = F_63 ( V_58 ) ;
...
return V_6 ;
if ( V_108 -> V_30 & V_122 &&
! F_91 ( & V_119 . V_121 , & V_108 -> V_114 ) )
return - V_123 ;
if ( V_108 -> V_30 & V_124 &&
! F_91 ( & V_108 -> V_114 , & V_119 . V_121 ) )
return - V_123 ;
...
if ( V_108 -> type == V_93 ) {
V_6 = F_95 ( V_94 , V_119 . V_121 . V_83 ,
...
static int F_96 ( void * V_32 , struct V_16 * V_129 ,
struct V_16 * V_130 )
{
struct V_1 * V_2 = V_32 ;
int V_6 ;
...
static int F_98 ( struct V_57 * V_57 )
{
struct V_4 * V_5 = F_99 ( V_57 ) ;
struct V_1 * V_2 = NULL ;
int V_6 ;
F_27 ( L_11 , F_100 ( V_144 ) , V_5 -> V_13 ) ;
if ( F_101 ( & V_5 -> V_143 ) )
return - V_145 ;
V_2 = F_102 ( sizeof( * V_2 ) , V_146 ) ;
if ( ! V_2 ) {
V_6 = - V_147 ;
goto V_148;
}
F_103 ( & V_2 -> V_58 , V_5 -> V_7 . V_149 ) ;
V_6 = F_104 ( V_2 ) ;
if ( V_6 )
goto V_150;
...
F_105 ( & V_2 -> V_58 ) ;
V_2 -> V_4 = V_5 ;
V_2 -> V_34 . V_51 = F_106 ( 0 ) ;
V_2 -> V_35 . V_51 = F_106 ( 0 ) ;
V_2 -> V_13 = V_153 ;
V_2 -> V_30 = 0 ;
V_2 -> V_154 = V_155 ;
V_2 -> V_128 = V_155 ;
V_2 -> V_26 = F_107 ( V_5 -> V_7 . V_8 , V_2 , F_96 ) ;
if ( F_54 ( V_2 -> V_26 ) ) {
F_29 ( L_12 ) ;
V_6 = F_55 ( V_2 -> V_26 ) ;
goto V_156;
...
static int F_113 ( struct V_57 * V_57 )
{
struct V_1 * V_2 = F_63 ( V_57 -> V_152 ) ;
struct V_4 * V_5 = V_2 -> V_4 ;
F_27 ( L_14 ,
F_100 ( V_144 ) , V_5 -> V_13 , V_5 -> V_7 . V_157 ) ;
F_114 ( & V_5 -> V_143 ) ;
F_115 ( V_2 -> V_26 ) ;
F_109 ( V_2 ) ;
F_110 ( & V_2 -> V_58 ) ;
F_111 ( & V_2 -> V_58 ) ;
if ( -- V_5 -> V_7 . V_157 <= 0 )
F_116 ( V_158 , & V_5 -> V_13 ) ;
F_112 ( V_2 ) ;
F_108 ( & V_5 -> V_143 ) ;
return 0 ;
}
static unsigned int F_117 ( struct V_57 * V_57 ,
struct V_159 * V_160 )
{
struct V_1 * V_2 = F_63 ( V_57 -> V_152 ) ;
struct V_4 * V_5 = V_2 -> V_4 ;
...
if ( F_101 ( & V_5 -> V_143 ) )
return - V_145 ;
V_6 = F_118 ( V_57 , V_2 -> V_26 , V_160 ) ;
F_108 ( & V_5 -> V_143 ) ;
return V_6 ;
}
static int F_119 ( struct V_57 * V_57 , struct V_161 * V_162 )
{
struct V_1 * V_2 = F_63 ( V_57 -> V_152 ) ;
struct V_4 * V_5 = V_2 -> V_4 ;
int V_6 ;
...
snprintf ( V_5 -> V_165 . V_175 , sizeof( V_5 -> V_165 . V_175 ) , L_15 ,
V_62 , V_5 -> V_176 ) ;
F_122 ( & V_5 -> V_165 , V_5 ) ;
V_5 -> V_7 . V_149 = & V_5 -> V_165 ;
V_5 -> V_7 . V_8 = F_123 ( & V_177 ) ;
if ( F_54 ( V_5 -> V_7 . V_8 ) ) {
F_124 ( & V_20 -> V_21 , L_16 ) ;
V_6 = F_55 ( V_5 -> V_7 . V_8 ) ;
goto V_178;
}
V_6 = F_125 ( & V_5 -> V_165 , V_179 , - 1 ) ;
if ( V_6 ) {
F_124 ( & V_20 -> V_21 ,
L_17 , V_180 ) ;
goto V_181;
}
F_27 ( L_18 , V_5 -> V_165 . V_182 ) ;
return 0 ;
V_181:
F_126 ( V_5 -> V_7 . V_8 ) ;
V_178:
