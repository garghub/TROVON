...
V_127:
for ( V_11 = 0 ; V_11 < V_18 -> V_28 . V_29 ; V_11 ++ )
F_51 ( V_18 , & V_18 -> V_128 [ V_11 ] . V_133 ) ;
return V_68 ;
}
...
F_62 ( V_52 -> V_2 , V_90 ) ;
V_136:
F_63 ( V_52 -> V_2 , V_49 -> V_74 ) ;
return V_68 ;
}
void F_64 ( struct V_51 * V_52 ,
struct V_48 * V_49 )
{
struct V_17 * V_18 = V_49 -> V_74 ;
struct V_1 * V_90 = V_18 -> V_90 ;
F_65 ( V_90 ) ;
F_62 ( V_52 -> V_2 , V_90 ) ;
F_63 ( V_52 -> V_2 , V_18 ) ;
}
