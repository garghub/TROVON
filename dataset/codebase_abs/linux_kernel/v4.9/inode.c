...
V_21 = * V_84 ;
if ( V_21 == NULL ) {
V_25 = F_69 ( V_59 , V_28 , V_82 , V_24 , V_83 , V_84 ,
V_85 ) ;
if ( V_25 ) {
F_20 ( L_46 ) ;
goto V_86;
...
T_2 V_82 , unsigned V_24 , unsigned V_88 ,
struct V_21 * V_21 , void * V_85 )
{
struct V_9 * V_9 = V_28 -> V_32 ;
T_2 V_54 = V_9 -> V_54 ;
int V_25 ;
V_25 = F_72 ( V_59 , V_28 , V_82 , V_24 , V_88 , V_21 , V_85 ) ;
if ( F_14 ( V_25 ) )
F_66 ( V_9 , V_82 + V_24 ) ;
if ( V_54 != V_9 -> V_54 )
F_73 ( V_9 ) ;
...
if ( V_128 . V_95 [ 0 ] )
V_9 -> V_145 =
F_111 ( F_104 ( V_128 . V_95 [ 0 ] ) ) ;
else
V_9 -> V_145 =
F_112 ( F_104 ( V_128 . V_95 [ 1 ] ) ) ;
} else {
...
F_20 ( L_58 ) ;
F_34 ( ! F_120 ( V_45 ) ) ;
F_121 ( V_45 -> V_125 , F_44 ( V_45 ) ) ;
F_20 ( L_59 ) ;
}
return F_14 ( F_122 ( & V_45 -> V_158 ) ) ? - V_71 : 0 ;
}
...
struct V_9 * F_125 ( struct V_9 * V_160 , T_7 V_161 )
{
...
static int F_135 ( struct V_9 * V_9 , int V_166 )
{
struct V_44 * V_45 = F_36 ( V_9 ) ;
...
V_128 -> V_132 = F_137 ( F_138 ( V_9 ) ) ;
V_128 -> V_133 = F_137 ( F_139 ( V_9 ) ) ;
V_128 -> V_134 = F_93 ( V_9 -> V_143 ) ;
V_128 -> V_98 = F_137 ( V_9 -> V_98 . V_135 ) ;
V_128 -> V_136 = F_137 ( V_9 -> V_136 . V_135 ) ;
V_128 -> V_97 = F_137 ( V_9 -> V_97 . V_135 ) ;
V_45 -> V_138 = F_41 ( V_9 ) ;
V_128 -> V_54 = F_140 ( V_45 -> V_138 ) ;
V_128 -> V_141 = F_137 ( V_9 -> V_141 ) ;
if ( F_109 ( V_9 -> V_94 ) || F_110 ( V_9 -> V_94 ) ) {
if ( F_141 ( V_9 -> V_145 ) ) {
V_128 -> V_95 [ 0 ] =
F_137 ( F_142 ( V_9 -> V_145 ) ) ;
V_128 -> V_95 [ 1 ] = 0 ;
} else {
V_128 -> V_95 [ 0 ] = 0 ;
V_128 -> V_95 [ 1 ] =
F_137 ( F_143 ( V_9 -> V_145 ) ) ;
V_128 -> V_95 [ 2 ] = 0 ;
}
} else
...
int F_144 ( struct V_9 * V_9 , struct V_69 * V_72 )
{
return F_135 ( V_9 , 1 ) ;
}
