...
F_71 ( V_13 -> V_62 , V_11 ) ;
if ( V_13 -> V_84 ) {
V_141 = F_72 ( V_11 , V_13 -> V_84 -> V_165 ) ;
if ( V_141 ) {
F_11 ( & V_30 -> V_11 , L_27 ) ;
goto V_164;
}
F_34 ( & V_30 -> V_11 , L_28 , V_11 -> V_60 -> V_166 ) ;
}
F_53 ( V_11 ) ;
if ( V_13 -> V_54 & V_55 ) {
V_13 -> V_57 = F_29 ( V_13 -> V_33 , V_58 ) ;
...
V_11 -> V_60 -> V_167 = & V_168 ;
V_11 -> V_60 -> V_169 [ 0 ] = & V_170 ;
V_11 -> V_60 -> V_171 = & V_172 ;
return 0 ;
V_164:
F_71 ( V_13 -> V_62 , NULL ) ;
F_71 ( V_13 -> V_9 , NULL ) ;
...
static enum V_227 V_148 ( struct V_228 * V_229 )
{
struct V_12 * V_13 =
F_94 ( V_229 , struct V_12 , V_144 ) ;
if ( ! F_91 ( & V_13 -> V_152 ) )
F_95 ( & V_13 -> V_149 ) ;
return V_230 ;
}
static void V_151 ( unsigned long V_231 )
{
...
struct V_182 *
F_96 ( struct V_10 * V_11 , struct V_182 * V_183 , T_8 V_221 )
{
struct V_182 * V_196 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
if ( V_13 == NULL )
...
int F_97 ( struct V_12 * V_13 , struct V_182 * V_234 )
{
...
sizeof( struct V_105 ) ) ) {
F_98 ( V_11 , V_235 , V_11 -> V_60 , L_31 ) ;
goto error;
}
V_190 = (struct V_34 * ) V_234 -> V_9 ;
if ( V_190 -> V_193 != F_33 ( V_206 ) ) {
F_98 ( V_11 , V_235 , V_11 -> V_60 ,
L_32 ,
F_8 ( V_190 -> V_193 ) ) ;
goto error;
}
...
F_98 ( V_11 , V_235 , V_11 -> V_60 , L_37 , V_49 ) ;
V_49 = - V_48 ;
}
error:
return V_49 ;
}
int F_100 ( struct V_10 * V_11 , struct V_182 * V_234 )
{
struct V_182 * V_183 ;
struct V_12 * V_13 = (struct V_12 * ) V_11 -> V_9 [ 0 ] ;
int V_47 ;
...
int V_241 = 50 ;
V_18 V_242 = 0 ;
V_191 = F_97 ( V_13 , V_234 ) ;
if ( V_191 < 0 )
goto error;
V_243:
V_238 = F_99 ( V_234 , V_191 ) ;
if ( V_238 < 0 )
goto error;
V_189 = (struct V_105 * ) ( V_234 -> V_9 + V_191 ) ;
...
static void F_105 ( struct V_10 * V_11 , struct V_253 * V_253 )
{
struct V_12 * V_13 ;
struct V_254 * V_255 ;
...
F_107 ( V_11 , ! ! V_255 -> V_261 , 0 ) ;
break;
case V_262 :
if ( V_253 -> V_256 < ( sizeof( * V_255 ) +
sizeof( struct V_247 ) ) )
F_108 ( V_257 , & V_11 -> V_221 ) ;
else
F_103 ( V_11 ,
