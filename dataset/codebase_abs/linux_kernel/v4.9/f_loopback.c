...
{
return F_24 ( V_39 , V_55 ) ;
}
static int F_25 ( struct V_7 * V_8 ,
struct V_1 * V_9 )
{
struct V_40 * V_45 , * V_56 ;
int V_57 ;
int V_58 = 0 ;
for ( V_57 = 0 ; V_57 < V_9 -> V_59 && V_58 == 0 ; V_57 ++ ) {
V_58 = - V_60 ;
V_45 = F_26 ( V_9 -> V_16 , V_50 ) ;
if ( ! V_45 )
goto V_61;
V_56 = F_23 ( V_9 -> V_22 , V_9 -> V_62 ) ;
if ( ! V_56 )
goto V_63;
V_45 -> V_64 = F_16 ;
V_56 -> V_64 = F_16 ;
...
{
int V_58 ;
V_58 = F_28 ( V_8 -> V_17 , & ( V_9 -> V_4 ) , V_39 ) ;
if ( V_58 )
goto V_67;
V_58 = F_29 ( V_39 ) ;
if ( V_58 < 0 )
...
{
int V_58 = 0 ;
V_58 = F_27 ( V_8 , V_9 , V_9 -> V_16 ) ;
if ( V_58 )
goto V_67;
V_58 = F_27 ( V_8 , V_9 , V_9 -> V_22 ) ;
if ( V_58 )
goto V_68;
V_58 = F_25 ( V_8 , V_9 ) ;
if ( V_58 )
...
int V_58 ;
F_12 ( & V_33 -> V_36 ) ;
V_58 = sprintf ( V_85 , L_12 , V_33 -> V_59 ) ;
F_13 ( & V_33 -> V_36 ) ;
return V_58 ;
}
...
int V_58 ;
F_12 ( & V_33 -> V_36 ) ;
V_58 = sprintf ( V_85 , L_12 , V_33 -> V_75 ) ;
F_13 ( & V_33 -> V_36 ) ;
return V_58 ;
}
