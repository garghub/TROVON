...
{
struct V_1 * V_2 = V_98 -> V_102 -> V_103 ;
char * V_75 ;
T_3 V_49 = 0 ;
F_37 ( & V_95 ) ;
F_37 ( & V_2 -> V_68 ) ;
...
if ( V_49 > 0 )
V_49 = F_62 ( V_99 , V_77 , V_100 , V_75 , V_49 ) ;
F_49 ( V_75 ) ;
V_69:
F_39 ( & V_95 ) ;
return V_49 ;
}
static T_3 F_63 ( struct V_98 * V_98 ,
char T_4 * V_75 ,
T_2 V_77 , T_5 * V_100 )
{
...
F_11 ( V_2 , V_13 ) ;
V_2 -> V_107 =
F_74 ( L_27 , V_108 , V_26 -> V_109 ,
V_2 ,
& V_110 ) ;
V_2 -> V_111 =
F_74 ( L_28 , V_108 , V_26 -> V_109 ,
V_2 ,
& V_112 ) ;
F_75 ( & V_2 -> V_113 , & V_114 ) ;
V_49 = F_65 ( V_2 , V_26 -> V_48 ) ;
if ( V_49 ) {
F_76 ( & V_2 -> V_113 ) ;
F_77 ( V_2 -> V_111 ) ;
F_77 ( V_2 -> V_107 ) ;
...
V_2 -> V_115 . V_118 = V_119 + V_120 ;
V_2 -> V_115 . V_121 = ( unsigned long ) V_2 ;
F_80 ( & V_2 -> V_115 ) ;
V_69:
F_39 ( & V_95 ) ;
return V_49 ;
}
void F_81 ( struct V_44 * V_26 )
{
struct V_1 * V_2 ;
struct V_42 * V_43 ;
struct V_42 * V_122 ;
...
F_37 ( & V_2 -> V_68 ) ;
V_43 -> V_46 = V_46 ;
F_75 ( & V_43 -> V_113 , & V_2 -> V_104 ) ;
V_2 -> V_58 |= 1 << V_46 -> V_123 ;
F_39 ( & V_2 -> V_68 ) ;
V_69:
F_39 ( & V_95 ) ;
return V_49 ;
}
void F_86 ( struct V_45 * V_46 )
{
struct V_1 * V_2 ;
struct V_42 * V_43 ;
if ( ! ( V_46 -> V_93 & V_94 ) )
...
static void V_117 ( unsigned long V_121 )
{
struct V_1 * V_2 =
(struct V_1 * ) V_121 ;
unsigned long V_22 ;
...
int F_92 ( struct V_44 * V_26 , T_1 V_31 ,
struct V_29 * V_30 )
{
struct V_1 * V_2 ;
int V_49 = 0 ;
