...
static struct V_416 * F_228 ( struct V_31 * V_32 , int V_33 ,
struct V_209 * V_417 , T_2 * V_418 )
{
struct V_416 * V_11 ;
...
static int F_229 ( struct V_31 * V_32 , int V_33 , struct V_209 * V_417 ,
...
return - V_90 ;
F_52 ( & V_417 -> V_213 ) ;
if ( F_228 ( V_32 , V_33 , V_417 , V_418 ) ) {
F_31 ( V_11 ) ;
V_44 = - V_17 ;
} else {
...
V_11 -> V_422 = V_422 ;
V_11 -> V_423 = V_423 ;
F_79 ( & V_11 -> V_239 , & V_417 -> V_212 ) ;
V_44 = 0 ;
}
F_54 ( & V_417 -> V_213 ) ;
return V_44 ;
}
static int F_230 ( struct V_31 * V_32 , int V_33 , struct V_209 * V_417 ,
T_2 * V_418 , enum V_419 V_420 ,
enum V_421 V_422 , T_1 * V_423 )
{
struct V_416 * V_11 ;
int V_44 ;
F_52 ( & V_417 -> V_213 ) ;
V_11 = F_228 ( V_32 , V_33 , V_417 , V_418 ) ;
...
static int F_231 ( struct V_31 * V_32 , int V_33 , struct V_424 * V_66 ,
T_2 V_418 [ 16 ] , int V_425 , enum V_419 V_420 ,
enum V_421 type , T_1 * V_423 )
{
switch ( V_32 -> V_62 . V_426 ) {
case V_427 : {
int V_36 = F_135 ( V_32 , V_33 , V_418 [ 5 ] ) ;
if ( V_36 < 0 )
return V_36 ;
return F_232 ( V_32 , V_66 , V_418 , V_36 ,
V_425 , V_420 ,
V_423 ) ;
}
case V_428 :
...
return F_233 ( V_32 , V_66 , V_418 ,
V_425 , V_420 , type ) ;
default:
return - V_45 ;
}
}
static int F_234 ( struct V_31 * V_32 , struct V_424 * V_66 ,
T_2 V_418 [ 16 ] , enum V_419 V_420 ,
enum V_421 type , T_1 V_423 )
{
switch ( V_32 -> V_62 . V_426 ) {
case V_427 :
return F_235 ( V_32 , V_423 ) ;
case V_428 :
return F_236 ( V_32 , V_66 , V_418 , V_420 , type ) ;
default:
return - V_45 ;
}
}
...
enum V_419 V_420 = ( V_291 -> V_296 >> 28 ) & 0x7 ;
int V_44 ;
int V_139 ;
struct V_209 * V_417 ;
T_1 V_423 = 0 ;
int V_431 = V_291 -> V_295 ;
int V_425 = V_291 -> V_296 >> 31 ;
T_2 V_432 = 2 ;
enum V_421 type = ( V_418 [ 7 ] & V_432 ) >> 1 ;
V_139 = V_291 -> V_296 & 0xffffff ;
V_44 = F_51 ( V_32 , V_33 , V_139 , V_20 , & V_417 ) ;
if ( V_44 )
return V_44 ;
V_66 . V_139 = V_139 ;
if ( V_431 ) {
V_44 = F_231 ( V_32 , V_33 , & V_66 , V_418 , V_425 , V_420 ,
type , & V_423 ) ;
if ( V_44 ) {
F_74 ( L_27 , V_139 ) ;
goto V_333;
}
V_44 = F_229 ( V_32 , V_33 , V_417 , V_418 , V_420 , type , V_423 ) ;
if ( V_44 )
goto V_433;
} else {
V_44 = F_237 ( V_32 , V_33 , V_418 , V_420 ) ;
if ( V_44 )
goto V_333;
V_44 = F_230 ( V_32 , V_33 , V_417 , V_418 , V_420 , type , & V_423 ) ;
if ( V_44 )
goto V_333;
V_44 = F_234 ( V_32 , & V_66 , V_418 , V_420 , type , V_423 ) ;
if ( V_44 )
F_74 ( L_28 ,
V_139 , V_423 ) ;
}
...
return V_44 ;
V_433:
F_234 ( V_32 , & V_66 , V_418 , V_420 , type , V_423 ) ;
V_333:
F_56 ( V_32 , V_33 , V_139 , V_20 ) ;
return V_44 ;
}
static int F_239 ( int V_33 , struct V_434 * V_435 ,
struct V_279 * V_436 )
{
struct V_281 * V_11 , * V_204 ;
T_5 V_437 ;
if ( ! F_240 ( V_435 -> V_438 . V_439 ) &&
! F_241 ( V_435 -> V_438 . V_439 ) ) {
F_129 (res, tmp, rlist, list) {
V_437 = F_242 ( V_11 -> V_278 << 16 ) ;
if ( F_243 ( ( T_2 * ) & V_437 , V_435 -> V_438 . V_439 ) )
return 0 ;
}
F_74 ( L_29 ,
...
struct V_442 * V_438 =
(struct V_442 * ) V_435 ;
struct V_434 * V_443 = (struct V_434 * ) ( V_438 + 1 ) ;
bool V_444 = V_443 -> V_324 == 0 && V_443 -> V_196 == 0 &&
V_443 -> V_445 == 0 ;
if ( V_444 )
V_441 -> V_446 = F_204 ( V_447 ) ;
}
}
static int F_245 ( struct V_31 * V_32 , int V_33 ,
struct V_115 * V_116 ,
struct V_279 * V_436 , int V_448 )
{
struct V_281 * V_11 , * V_204 ;
T_2 V_36 ;
struct V_440 * V_441 ;
...
struct V_451 * V_452 ;
T_5 V_437 = 0 ;
T_5 V_453 = F_242 ( V_454 << 16 ) ;
V_441 = (struct V_440 * ) V_116 -> V_118 ;
V_36 = V_441 -> V_36 ;
V_435 = (struct V_442 * ) ( V_441 + 1 ) ;
switch ( V_448 ) {
case V_455 :
V_450 =
(struct V_449 * ) ( V_435 + 1 ) ;
memmove ( V_450 , V_435 ,
sizeof( * V_450 ) + sizeof( * V_452 ) ) ;
break;
case V_456 :
case V_457 :
V_452 = (struct V_451 * )
( V_435 + 1 ) ;
memmove ( V_452 , V_435 , sizeof( * V_452 ) ) ;
break;
default:
return - V_45 ;
}
...
V_435 -> V_324 = sizeof( * V_435 ) >> 2 ;
V_435 -> V_196 = F_204 ( V_458 [ V_459 ] ) ;
memcpy ( V_435 -> V_439 , & V_437 , V_460 ) ;
memcpy ( V_435 -> V_461 , & V_453 , V_460 ) ;
return 0 ;
}
...
struct V_464 * V_269 ;
int V_277 ;
V_269 = (struct V_464 * ) V_116 -> V_118 ;
V_463 = F_162 ( V_269 -> V_465 ) ;
if ( V_269 -> V_466 || V_269 -> V_467 ||
( V_463 & ~ V_468 ) )
return - V_193 ;
if ( ( V_463 &
( 1ULL << V_469 ) ) &&
...
static T_3 F_247 ( void * V_477 )
{
T_3 V_324 = sizeof( struct V_440 ) ;
struct V_434 * V_478 ;
V_478 = (struct V_434 * ) ( V_477 + V_324 ) ;
while ( V_478 -> V_324 ) {
V_324 += V_478 -> V_324 * sizeof( T_3 ) ;
V_478 += 1 ;
}
return V_324 ;
}
...
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_202 * V_203 = & V_38 -> V_41 . V_42 . V_43 ;
struct V_279 * V_436 = & V_203 -> V_87 [ V_33 ] . V_92 [ V_25 ] ;
int V_44 ;
int V_139 ;
struct V_209 * V_417 ;
struct V_440 * V_441 ;
...
V_478 = (struct V_434 * ) ( V_441 + 1 ) ;
V_448 = F_249 ( F_250 ( V_478 -> V_196 ) ) ;
if ( V_448 == V_459 )
F_244 ( V_441 , V_478 ) ;
...
case V_457 :
F_251 ( L_36 ) ;
if ( F_245 ( V_32 , V_33 , V_116 , V_436 , V_448 ) ) {
V_44 = - V_45 ;
goto V_483;
}
V_291 -> V_296 +=
...
V_44 = F_51 ( V_32 , V_33 , V_291 -> V_271 , V_29 , & V_479 ) ;
if ( V_44 )
goto V_486;
V_480 = F_247 ( V_116 -> V_118 ) ;
V_479 -> V_487 = F_25 ( V_480 , V_89 ) ;
if ( ! V_479 -> V_487 ) {
V_44 = - V_90 ;
goto V_488;
}
V_479 -> V_489 = V_480 ;
V_479 -> V_490 = 0 ;
memcpy ( V_479 -> V_487 , V_116 -> V_118 , V_480 ) ;
V_441 = (struct V_440 * ) V_479 -> V_487 ;
if ( V_441 -> V_36 == 1 )
V_441 -> V_36 = 2 ;
else
V_441 -> V_36 = 1 ;
...
static int F_255 ( struct V_31 * V_32 , struct V_229 * V_492 )
{
int V_44 ;
V_44 = F_95 ( V_32 , V_492 -> V_201 . V_192 , V_492 -> V_201 . V_7 , 1 , V_29 , 0 ) ;
if ( V_44 ) {
F_62 ( V_32 , L_39 ) ;
return V_44 ;
}
F_205 ( V_32 , V_492 -> V_201 . V_7 , 0 , 0 , V_491 ,
V_476 , V_400 ) ;
return 0 ;
}
...
V_427 )
return - V_481 ;
V_44 = F_51 ( V_32 , V_33 , V_291 -> V_270 , V_29 , & V_479 ) ;
if ( V_44 )
return V_44 ;
if ( ! V_479 -> V_487 ) {
F_62 ( V_32 , L_40 ) ;
...
F_31 ( V_479 -> V_487 ) ;
F_56 ( V_32 , V_33 , V_291 -> V_270 , V_29 ) ;
V_44 = F_51 ( V_32 , V_33 , V_479 -> V_139 , V_20 , & V_417 ) ;
if ( V_44 )
return V_44 ;
if ( V_493 && F_253 ( V_32 ) ) {
V_44 = F_51 ( V_32 , V_33 , V_493 , V_29 , & V_479 ) ;
if ( V_44 ) {
F_62 ( V_32 , L_41 ) ;
} else {
F_56 ( V_32 , V_33 , V_493 , V_29 ) ;
F_255 ( V_32 , V_479 ) ;
}
}
...
F_177 ( & V_417 -> V_214 ) ;
V_59:
F_56 ( V_32 , V_33 , V_479 -> V_139 , V_20 ) ;
return V_44 ;
}
...
static void F_258 ( struct V_31 * V_32 , int V_33 , struct V_209 * V_417 )
{
struct V_416 * V_494 ;
struct V_416 * V_204 ;
struct V_424 V_66 ;
...
switch ( V_32 -> V_62 . V_426 ) {
case V_427 :
F_235 ( V_32 , V_494 -> V_423 ) ;
break;
case V_428 :
V_66 . V_139 = V_417 -> V_211 ;
( void ) F_236 ( V_32 , & V_66 , V_494 -> V_418 ,
V_494 -> V_420 , V_494 -> V_422 ) ;
break;
}
F_96 ( & V_494 -> V_239 ) ;
F_31 ( V_494 ) ;
...
enum V_18 type , int V_495 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_202 * V_203 =
& V_38 -> V_41 . V_42 . V_43 ;
struct V_279 * V_436 = & V_203 -> V_87 [ V_33 ] . V_92 [ type ] ;
struct V_10 * V_188 ;
struct V_10 * V_204 ;
int V_496 ;
V_496 = 0 ;
...
V_498 = V_499 ;
do {
V_496 = F_259 ( V_32 , V_33 , type , 0 ) ;
if ( F_261 ( V_499 , V_498 + 5 * V_500 ) )
break;
if ( V_496 )
F_262 () ;
} while ( V_496 );
if ( V_496 )
V_496 = F_259 ( V_32 , V_33 , type , 1 ) ;
return V_496 ;
}
...
static int F_254 ( struct V_31 * V_32 , struct V_229 * V_492 )
{
struct V_115 * V_388 ;
int V_44 ;
struct V_229 * V_512 ;
...
memcpy ( V_388 -> V_118 , V_492 -> V_487 , V_492 -> V_489 ) ;
V_44 = F_252 ( V_32 , V_388 -> V_397 , & V_423 , V_492 -> V_489 >> 2 , 0 ,
V_485 , V_476 ,
V_400 ) ;
F_206 ( V_32 , V_388 ) ;
if ( V_44 )
goto V_44;
V_44 = F_78 ( V_32 , V_492 -> V_201 . V_192 , V_423 , 1 , V_29 , V_492 -> V_139 ) ;
if ( V_44 )
goto V_486;
V_44 = F_51 ( V_32 , V_492 -> V_201 . V_192 , V_423 , V_29 , & V_512 ) ;
if ( V_44 )
goto V_513;
V_492 -> V_490 = V_423 ;
V_512 -> V_490 = 0 ;
V_512 -> V_489 = 0 ;
V_512 -> V_487 = NULL ;
F_56 ( V_32 , V_492 -> V_201 . V_192 , V_423 , V_29 ) ;
return 0 ;
V_513:
F_95 ( V_32 , V_492 -> V_201 . V_192 , V_423 , 1 , V_29 , 0 ) ;
V_486:
F_205 ( V_32 , V_423 , 0 , 0 , V_491 ,
V_476 , V_400 ) ;
V_44:
return V_44 ;
}
static int F_269 ( struct V_31 * V_32 , bool V_514 )
{
struct V_37 * V_38 = V_37 ( V_32 ) ;
struct V_202 * V_203 =
& V_38 -> V_41 . V_42 . V_43 ;
...
int V_44 = 0 ;
F_265 ( V_516 ) ;
for ( V_515 = F_270 ( V_6 ) ; V_515 ; V_515 = F_271 ( V_515 ) ) {
V_492 = F_272 ( V_515 , struct V_229 , V_201 . V_9 ) ;
if ( ( V_514 && V_492 -> V_489 ) ||
( ! V_514 && ! V_492 -> V_489 ) )
F_79 ( & V_492 -> V_516 , & V_516 ) ;
}
F_60 (fs_rule, &mirr_list, mirr_list) {
if ( V_514 )
V_44 += F_254 ( V_32 , V_492 ) ;
else
V_44 += F_255 ( V_32 , V_492 ) ;
}
return V_44 ;
}
...
F_54 ( F_53 ( V_32 ) ) ;
if ( V_492 -> V_201 . V_192 == V_33 ) {
V_236 = V_492 -> V_201 . V_7 ;
V_2 = V_492 -> V_201 . V_194 ;
while ( V_2 != 0 ) {
switch ( V_2 ) {
case V_230 :
...
V_400 ) ;
F_52 ( F_53 ( V_32 ) ) ;
F_80 ( & V_492 -> V_201 . V_9 ,
& V_203 -> V_94 [ V_29 ] ) ;
F_96 ( & V_492 -> V_201 . V_239 ) ;
F_54 ( F_53 ( V_32 ) ) ;
F_31 ( V_492 ) ;
V_2 = 0 ;
break;
...
if ( V_522 -> V_201 . V_192 == V_33 ) {
V_289 = V_522 -> V_201 . V_7 ;
F_80 ( & V_522 -> V_201 . V_9 , & V_203 -> V_94 [ V_30 ] ) ;
F_96 ( & V_522 -> V_201 . V_239 ) ;
F_31 ( V_522 ) ;
F_146 ( V_32 , V_289 ) ;
}
}
...
void F_279 ( struct V_523 * V_524 )
{
struct V_525 * V_526 =
F_3 ( V_524 , struct V_525 , V_526 ) ;
struct V_115 * V_388 ;
struct V_464 * V_527 ;
struct V_31 * V_32 = & V_526 -> V_38 -> V_32 ;
struct V_202 * V_203 =
& V_526 -> V_38 -> V_41 . V_42 . V_43 ;
struct V_279 * V_501 =
& V_203 -> V_87 [ V_526 -> V_33 ] . V_92 [ V_20 ] ;
struct V_209 * V_66 ;
struct V_209 * V_204 ;
T_1 V_528 =
( ( 1ULL << V_529 ) |
...
V_157 = V_163 |
V_168 ;
else if ( V_526 -> V_169 == F_48 ( V_170 ) )
V_157 = V_164 |
V_163 |
V_166 |
V_167 ;
...
V_167 ;
V_527 = V_388 -> V_118 ;
V_527 -> V_466 = F_242 ( 1ULL << V_547 ) ;
F_52 ( F_53 ( V_32 ) ) ;
F_129 (qp, tmp, qp_list, com.list) {
F_54 ( F_53 ( V_32 ) ) ;
if ( V_66 -> V_201 . V_192 == V_526 -> V_33 ) {
if ( V_66 -> V_201 . V_194 != V_251 ||
! V_66 -> V_131 ||
...
V_527 -> V_465 = F_242 ( V_535 ) ;
else
V_527 -> V_465 =
F_242 ( V_535 | V_528 ) ;
if ( V_526 -> V_546 == V_146 ) {
V_527 -> V_473 . V_152 = V_66 -> V_152 ;
V_527 -> V_473 . V_130 . V_157 = V_66 -> V_157 ;
V_527 -> V_473 . V_130 . V_171 = V_66 -> V_171 ;
V_527 -> V_473 . V_130 . V_173 = V_66 -> V_173 ;
V_527 -> V_473 . V_130 . V_175 = V_66 -> V_347 ;
V_527 -> V_473 . V_130 . V_179 = V_66 -> V_179 ;
V_527 -> V_473 . V_130 . V_131 =
V_66 -> V_131 ;
} else {
V_527 -> V_473 . V_152 = V_66 -> V_152 & ~ F_46 ( V_153 ) ;
V_527 -> V_473 . V_130 . V_157 = V_157 ;
V_527 -> V_473 . V_130 . V_173 = V_526 -> V_549 ;
V_527 -> V_473 . V_130 . V_171 =
V_66 -> V_171 | V_172 ;
V_527 -> V_473 . V_130 . V_175 =
V_66 -> V_347 | V_176 ;
if ( V_526 -> V_169 == F_48 ( V_170 ) )
V_527 -> V_473 . V_130 . V_175 |= V_177 ;
else
V_527 -> V_473 . V_130 . V_175 |= V_178 ;
V_527 -> V_473 . V_130 . V_179 =
...
if ( V_44 ) {
F_280 ( V_32 , L_59 ,
V_526 -> V_33 , V_36 , V_66 -> V_211 , V_44 ) ;
V_544 ++ ;
}
}
F_52 ( F_53 ( V_32 ) ) ;
...
if ( V_544 )
F_62 ( V_32 , L_60 ,
V_544 , V_526 -> V_33 , V_526 -> V_36 ) ;
if ( V_526 -> V_128 & V_553 && ! V_544 &&
V_554 != V_526 -> V_555 )
F_139 ( & V_526 -> V_38 -> V_32 , V_526 -> V_36 ,
V_526 -> V_556 ) ;
V_59:
F_31 ( V_526 ) ;
return;
