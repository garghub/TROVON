...
static int F_53 ( void * V_73 )
{
struct V_8 * V_9 = V_73 ;
V_9 -> V_12 = F_54 ( V_9 -> V_47 ) ;
return V_9 -> V_12 ? 0 : - V_74 ;
}
static void F_55 ( void * V_73 )
{
struct V_8 * V_9 = V_73 ;
F_56 ( V_9 -> V_47 , V_9 -> V_12 ) ;
V_9 -> V_12 = NULL ;
}
static void F_57 ( void * V_73 )
{
struct V_8 * V_9 = V_73 ;
if ( V_9 -> V_12 )
F_56 ( V_9 -> V_47 , V_9 -> V_12 ) ;
...
static void * F_58 ( struct V_1 * V_2 , struct V_46 * V_47 ,
unsigned long V_4 , enum V_5 V_6 )
{
struct V_8 * V_9 ;
if ( V_47 -> V_4 < V_4 )
