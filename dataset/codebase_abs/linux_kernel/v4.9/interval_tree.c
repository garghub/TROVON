...
static inline T_1 F_9 ( T_1 V_18 , T_1 V_19 )
{
...
if ( F_8 ( V_26 , V_2 ) )
return V_26 ;
if ( V_26 -> V_23 < F_13 ( V_2 ) )
V_26 -> V_23 = F_13 ( V_2 ) ;
if ( F_5 ( & V_2 -> V_17 , & V_26 -> V_17 ) < 0 )
V_30 = & V_26 -> V_4 ;
else
V_30 = & V_26 -> V_5 ;
}
...
struct V_9 * V_39 )
{
return ( V_39 -> V_13 <= V_2 -> V_23 &&
V_39 -> V_14 >= F_26 ( V_2 ) ) ;
}
enum V_40 F_27 ( struct V_1 * V_2 ,
struct V_9 * V_39 ,
T_2 V_41 ,
void * V_42 )
{
...
F_19 ( V_41 ) ;
while ( V_2 ) {
if ( V_39 -> V_14 < F_26 ( V_2 ) ) {
if ( V_2 -> V_4 ) {
V_2 = V_2 -> V_4 ;
continue;
}
} else if ( F_25 ( V_2 , V_39 ) ) {
if ( F_7 ( V_39 , & V_2 -> V_17 ) ) {
V_12 = V_41 ( V_2 , V_42 ) ;
if ( V_12 == V_44 )
break;
}
