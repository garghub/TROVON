...
return F_41 ( V_4 -> V_54 . V_105 . V_106 , V_81 , V_82 , V_70 , V_18 ,
F_9 ( V_11 , V_99 ) , V_99 ) ;
}
T_1
F_42 ( struct V_1 * V_2 ,
...
static void F_48 ( struct V_10 * V_11 , T_2 * V_69 , T_2 * V_113 , T_2 * V_82 )
{
T_6 V_83 ;
T_2 V_86 ;
struct V_8 * V_9 = (struct V_8 * ) V_11 -> V_3 ;
...
return 0 ;
V_70 += V_117 ;
F_48 ( V_11 , V_69 , V_113 , V_82 ) ;
return F_54 ( V_4 -> V_54 . V_118 . V_106 , V_113 , V_82 , V_70 , V_18 ,
F_9 ( V_11 , V_116 ) ) ;
}
T_1
F_55 ( struct V_1 * V_2 )
...
if ( F_5 ( F_8 ( V_11 ) < V_119 &&
F_59 ( V_11 , V_119 , 0 , V_67 ) ) )
return V_21 ;
V_7 = F_4 ( V_9 -> V_19 ) ;
V_70 = F_19 ( V_11 , V_119 ) ;
memmove ( V_70 , V_70 + V_119 , V_7 ) ;
return V_20 ;
}
static inline int F_60 ( T_2 * V_120 , T_2 * V_121 , int V_18 )
{
int V_122 ;
...
if ( F_60 ( V_125 , V_110 , V_124 -> V_130 ) <= 0 )
return V_51 ;
memcpy ( V_110 , V_125 , V_124 -> V_130 ) ;
if ( F_47 ( V_36 -> V_11 , V_36 -> V_11 -> V_18 - V_124 -> V_99 ) )
return V_51 ;
memmove ( V_36 -> V_11 -> V_3 + V_124 -> V_127 , V_36 -> V_11 -> V_3 , V_7 ) ;
F_29 ( V_36 -> V_11 , V_124 -> V_127 ) ;
return V_39 ;
}
...
static inline void F_63 ( T_2 * V_131 , T_5 V_69 )
{
* V_131 ++ = V_69 ;
* V_131 ++ = V_69 >> 8 ;
* V_131 ++ = V_69 >> 16 ;
...
static inline void F_64 ( T_2 * V_131 , const T_2 * V_132 )
{
* V_131 ++ = V_132 [ 5 ] ;
* V_131 ++ = V_132 [ 4 ] ;
* V_131 ++ = V_132 [ 3 ] ;
...
T_2 V_82 [ 20 ] ;
T_5 V_100 ;
if ( F_18 ( F_66 ( & V_2 -> V_135 ) != 1 ) )
return V_21 ;
V_11 = F_67 ( & V_2 -> V_135 ) ;
V_13 = F_2 ( V_11 ) ;
if ( V_13 -> V_24 . V_25 )
return V_20 ;
if ( F_18 ( F_7 ( V_11 ) < sizeof( * V_134 ) ) )
return V_21 ;
V_134 = (struct V_133 * ) F_9 ( V_11 , sizeof( * V_134 ) ) ;
V_134 -> V_136 = V_137 ;
V_134 -> V_138 = sizeof( * V_134 ) - 2 ;
V_134 -> V_98 = F_32 ( V_4 -> V_15 . V_50 ) ;
V_100 = F_20 ( & V_4 -> V_15 . V_73 ) ;
F_63 ( V_134 -> V_139 , V_100 ) ;
F_62 ( V_11 , V_82 ) ;
F_68 ( V_4 -> V_54 . V_140 . V_106 , V_82 ,
...
if ( F_18 ( F_7 ( V_11 ) < sizeof( * V_134 ) ) )
return V_21 ;
V_134 = (struct V_141 * ) F_9 ( V_11 , sizeof( * V_134 ) ) ;
V_134 -> V_136 = V_137 ;
V_134 -> V_138 = sizeof( * V_134 ) - 2 ;
V_134 -> V_98 = F_32 ( V_4 -> V_15 . V_50 ) ;
V_100 = F_20 ( & V_4 -> V_15 . V_73 ) ;
F_63 ( V_134 -> V_139 , V_100 ) ;
F_62 ( V_11 , V_82 ) ;
F_70 ( V_4 -> V_54 . V_140 . V_106 , V_82 ,
V_11 -> V_3 + 24 , V_11 -> V_18 - 24 , V_134 -> V_5 ) ;
return V_20 ;
}
T_4
...
F_14 ( V_11 , V_11 -> V_18 - sizeof( * V_134 ) ) ;
return V_39 ;
}
T_4
...
F_64 ( V_145 + V_93 , V_134 -> V_139 ) ;
if ( F_74 ( V_4 -> V_54 . V_147 . V_106 , V_82 , V_145 ,
