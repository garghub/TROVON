...
static void F_39 ( struct V_1 * V_38 )
{
struct V_8 * V_9 ;
struct V_2 * V_11 ;
ASSERT ( V_38 ) ;
...
V_11 = F_2 ( V_3 , struct V_10 , V_11 ) ;
F_18 ( V_11 , & V_41 ) ;
F_44 ( & V_11 -> V_54 -> V_55 -> V_56 ) ;
V_42 = F_45 ( V_11 -> V_54 -> V_55 ) ;
F_46 ( & V_11 -> V_54 -> V_55 -> V_56 ) ;
F_20 ( V_11 , V_41 ) ;
if ( V_42 == - V_57 )
F_47 ( V_11 ,
L_16
...
const struct V_40 * V_41 ;
int V_42 ;
F_3 ( L_4 , V_59 -> V_9 -> V_43 ) ;
V_9 = F_2 ( V_59 -> V_9 , struct V_8 , V_27 ) ;
V_11 = F_2 ( V_9 -> V_27 . V_11 ,
struct V_10 , V_11 ) ;
F_18 ( V_11 , & V_41 ) ;
V_42 = F_49 ( V_9 ) ;
...
T_3 V_63 ;
int V_42 ;
V_38 -> V_5 -> V_28 -> V_64 ( V_38 -> V_5 -> V_31 , & V_62 ) ;
F_3 ( L_19 ,
V_38 -> V_43 , ( unsigned long long ) V_62 ) ;
V_9 = F_2 ( V_38 , struct V_8 , V_27 ) ;
V_11 = F_2 ( V_9 -> V_27 . V_11 ,
struct V_10 , V_11 ) ;
if ( V_62 == V_9 -> V_65 )
...
if ( ! V_9 -> V_23 )
return - V_46 ;
ASSERT ( F_50 ( V_9 -> V_23 ) ) ;
F_51 ( & V_9 -> V_27 , V_62 ) ;
V_63 = F_52 ( F_35 ( V_9 -> V_23 ) ) ;
if ( V_63 == V_62 )
return 0 ;
F_18 ( V_11 , & V_41 ) ;
F_53 ( F_54 ( V_9 -> V_23 ) ) ;
if ( V_63 & ~ V_66 && V_62 > V_63 ) {
F_34 ( L_20 , V_63 ) ;
V_61 . V_67 = V_68 ;
V_61 . V_69 = V_63 & V_66 ;
V_42 = F_55 ( V_9 -> V_23 , & V_61 , NULL ) ;
if ( V_42 < 0 )
goto V_70;
}
V_61 . V_67 = V_68 ;
...
V_11 = F_2 ( V_9 -> V_27 . V_11 ,
struct V_10 , V_11 ) ;
V_59 -> V_9 -> V_5 -> V_28 -> V_64 ( V_59 -> V_9 -> V_5 -> V_31 ,
& V_62 ) ;
F_3 ( L_19 ,
V_59 -> V_9 -> V_43 , ( unsigned long long ) V_62 ) ;
if ( V_9 -> V_23 ) {
ASSERT ( F_50 ( V_9 -> V_23 ) ) ;
F_51 ( & V_9 -> V_27 , V_62 ) ;
V_71 . V_49 = V_9 -> V_23 ;
