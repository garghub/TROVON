...
{
unsigned int V_13 = V_42 ;
int V_43 , V_44 , V_45 ;
T_2 V_46 , V_47 , V_48 , V_49 , V_50 ;
V_13 ++ ;
V_43 = 15 ;
if ( ! ( V_13 & 0x18000 ) ) {
int V_51 = F_15 ( V_13 & 0x1FFFF ) - 16 ;
V_13 <<= V_51 ;
V_43 = 15 - V_51 ;
}
V_44 = ( V_13 >> 8 ) << 1 ;
V_46 = V_52 [ V_44 - 256 ] ;
V_47 = V_52 [ V_44 + 1 - 256 ] ;
V_49 = ( V_53 ) V_13 * V_46 ;
V_49 >>= 48 ;
V_50 = V_43 ;
V_50 <<= ( 12 + 32 ) ;
...
static int F_16 ( struct V_55 * V_12 ,
int V_13 , int V_14 )
{
...
static int F_18 ( struct V_11 * V_59 , int V_13 , int V_14 )
{
...
int V_101 , int V_13 , int * V_50 , int V_102 ,
const T_1 * V_66 , int V_67 ,
int * V_103 )
{
int V_104 ;
