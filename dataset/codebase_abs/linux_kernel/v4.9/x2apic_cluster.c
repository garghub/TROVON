...
{
if ( ! F_28 ( & F_4 ( V_17 , V_3 ) , V_28 ) )
return - V_29 ;
if ( ! F_28 ( & F_4 ( V_15 , V_3 ) , V_28 ) ) {
F_29 ( F_4 ( V_17 , V_3 ) ) ;
return - V_29 ;
}
return 0 ;
}
static int F_30 ( unsigned int V_13 )
{
int V_3 ;
F_26 (cpu) {
if ( F_3 ( V_13 ) != F_3 ( V_3 ) )
continue;
F_31 ( V_13 , F_4 ( V_17 , V_3 ) ) ;
F_31 ( V_3 , F_4 ( V_17 , V_13 ) ) ;
}
F_29 ( F_4 ( V_17 , V_13 ) ) ;
F_29 ( F_4 ( V_15 , V_13 ) ) ;
return 0 ;
...
static const struct V_8 * F_35 ( void )
{
return V_33 ;
}
static void F_36 ( int V_3 , struct V_8 * V_34 ,
const struct V_8 * V_9 )
{
if ( V_9 == F_35 () )
F_12 ( V_34 , F_37 ( V_3 ) ) ;
else
F_38 ( V_34 , V_9 , F_4 ( V_17 , V_3 ) ) ;
}
