...
return 0 ;
V_140 = F_16 ( V_27 ) ;
V_138 = F_43 ( V_131 -> V_131 , V_27 ) ;
V_142 = & V_138 -> V_142 ;
V_143 = V_131 -> V_151 ;
V_144 = V_131 -> V_152 ;
V_145 = F_44 ( V_131 -> V_153 , 0 , V_142 -> V_154 - V_143 ) ;
V_146 = F_44 ( V_131 -> V_155 , 0 , V_142 -> V_156 - V_144 ) ;
V_147 = V_131 -> V_147 >> 16 ;
V_148 = V_131 -> V_148 >> 16 ;
V_149 = F_44 ( V_131 -> V_149 >> 16 , 0 , V_157 ) ;
V_150 = F_44 ( V_131 -> V_150 >> 16 , 0 , V_157 ) ;
V_6 = F_21 ( V_136 -> V_158 ) ;
if ( V_6 == - 1 ) {
F_24 ( L_53 ,
( char * ) & V_136 -> V_158 ) ;
return - V_79 ;
...
if ( ! V_10 -> V_103 ) {
V_10 -> V_103 = V_134 -> V_103 [ V_140 -> V_49 ] ;
if ( F_46 ( V_10 -> V_103 ,
& V_10 -> V_104 , V_27 ) ) {
F_24 ( L_55 ) ;
return - V_79 ;
...
V_160 = V_10 -> V_126 ;
if ( V_160 )
F_47 ( V_10 -> V_105 , V_160 ) ;
V_162 = F_48 ( V_10 -> V_105 , V_161 ) ;
if ( V_162 < 0 ) {
F_24 ( L_56 ,
V_161 ) ;
return - V_79 ;
...
F_50 ( L_58 ,
V_27 -> V_11 . V_49 , F_15 ( V_140 ) ,
V_24 -> V_11 . V_49 , F_12 ( V_25 ) ) ;
F_50 ( L_59 ,
F_12 ( V_25 ) ,
V_145 , V_146 , V_143 , V_144 ,
...
( char * ) & V_136 -> V_158 ,
( unsigned long ) V_166 -> V_178 ) ;
V_171 = F_52 ( V_136 -> V_158 , 0 ) ;
V_15 -> V_55 = ( T_2 ) V_166 -> V_178 + V_136 -> V_179 [ 0 ] ;
V_15 -> V_55 += V_147 * V_171 ;
V_15 -> V_55 += V_148 * V_136 -> V_180 [ 0 ] ;
V_145 = F_37 ( V_10 -> V_117 , V_145 , V_149 ) ;
V_146 = F_37 ( V_10 -> V_117 , V_146 , V_150 ) ;
V_172 = F_53 ( * V_142 , V_144 ) ;
V_174 = F_53 ( * V_142 , V_144 + V_146 - 1 ) ;
V_173 = F_54 ( * V_142 , V_143 ) ;
V_175 = F_54 ( * V_142 , V_143 + V_145 - 1 ) ;
V_15 -> V_53 = ( V_172 << 16 ) | V_173 ;
V_15 -> V_54 = ( V_174 << 16 ) | V_175 ;
V_149 = V_145 ;
V_15 -> V_56 = V_136 -> V_180 [ 0 ] ;
V_15 -> V_57 = V_150 << 16 | V_149 ;
memcpy ( V_17 , V_15 , sizeof( * V_17 ) ) ;
V_15 -> V_58 = V_167 -> V_16 ;
V_17 -> V_58 = V_167 -> V_14 ;
if ( V_142 -> V_181 & V_182 )
V_17 -> V_55 = V_15 -> V_55 +
V_136 -> V_180 [ 0 ] ;
V_168 = F_25 ( V_10 ) ;
V_169 = V_167 -> V_14 ;
...
if ( V_142 -> V_181 & V_182 ) {
if ( V_10 -> V_113 ) {
V_168 -> V_17 -> V_58 = V_169 ;
} else {
F_55 ( V_169 ,
V_10 -> V_28 + V_41 ) ;
}
} else {
F_55 ( V_169 , V_10 -> V_28 + V_41 ) ;
}
V_102:
...
F_26 ( L_58 ,
V_164 -> V_27 -> V_11 . V_49 ,
F_15 ( F_16 ( V_164 -> V_27 ) ) ,
V_24 -> V_11 . V_49 , F_12 ( V_25 ) ) ;
V_25 -> V_106 = V_185 ;
}
...
struct V_132 * V_25 = F_40 ( V_24 ) ;
struct V_9 * V_10 = F_41 ( V_25 ) ;
return F_19 ( V_10 , V_24 -> V_117 -> V_186 ) ;
}
struct V_24 * F_62 ( struct V_187 * V_188 ,
...
V_10 -> V_25 . V_70 = V_70 ;
V_10 -> V_25 . V_106 = V_107 ;
V_10 -> V_104 . V_192 = F_30 ;
F_32 ( V_10 ) ;
V_162 = F_64 ( V_188 , & V_10 -> V_25 . V_24 ,
V_190 ,
& V_193 ,
V_194 ,
F_3 ( V_194 ) ,
