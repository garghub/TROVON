...
snprintf ( V_55 -> V_44 , V_63 , L_13 , V_40 -> V_59 ,
...
if ( V_52 -> V_65 > F_27 ( & V_42 ) ) {
F_10 ( & V_48 -> V_21 , L_14 ) ;
V_56 = - V_66 ;
goto error;
}
V_7 -> V_9 = V_7 -> V_64 + V_52 -> V_65 ;
V_55 -> V_67 = & V_48 -> V_21 ;
F_28 ( V_48 , V_55 ) ;
if ( V_52 -> V_68 ) {
F_29 (np, tbi) {
...
if ( V_54 ) {
const T_5 * V_69 = F_20 ( V_54 , L_17 , NULL ) ;
T_3 T_2 * V_30 ;
if ( ! V_69 ) {
F_10 ( & V_48 -> V_21 ,
L_18 ,
