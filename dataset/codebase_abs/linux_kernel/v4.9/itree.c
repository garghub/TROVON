...
int F_46 ( struct V_72 * V_73 , struct V_74 * V_74 , struct V_75 * V_76 )
{
struct V_7 * V_67 = V_74 -> V_77 ;
F_47 ( F_48 ( V_74 ) , V_76 ) ;
V_76 -> V_69 = ( V_67 -> V_41 / 512 ) * F_45 ( V_67 , V_76 -> V_68 ) ;
V_76 -> V_78 = V_67 -> V_41 ;
return 0 ;
}
static int F_49 ( struct V_79 * V_79 , struct V_80 * V_81 )
{
return F_50 ( V_79 , F_31 , V_81 ) ;
}
static int F_51 ( struct V_82 * V_82 , struct V_79 * V_79 )
{
return F_52 ( V_79 , F_31 ) ;
}
int F_53 ( struct V_79 * V_79 , T_4 V_83 , unsigned V_84 )
{
return F_54 ( V_79 , V_83 , V_84 , F_31 ) ;
}
static void F_55 ( struct V_85 * V_86 , T_4 V_26 )
{
struct V_3 * V_3 = V_86 -> V_87 ;
if ( V_26 > V_3 -> V_62 ) {
F_56 ( V_3 , V_3 -> V_62 ) ;
F_40 ( V_3 ) ;
}
}
static int F_57 ( struct V_82 * V_82 , struct V_85 * V_86 ,
T_4 V_83 , unsigned V_84 , unsigned V_88 ,
struct V_79 * * V_89 , void * * V_90 )
{
int V_91 ;
V_91 = F_58 ( V_86 , V_83 , V_84 , V_88 , V_89 , F_31 ) ;
if ( F_59 ( V_91 ) )
F_55 ( V_86 , V_83 + V_84 ) ;
return V_91 ;
}
static T_3 F_60 ( struct V_85 * V_86 , T_3 V_4 )
{
return F_61 ( V_86 , V_4 , F_31 ) ;
}
