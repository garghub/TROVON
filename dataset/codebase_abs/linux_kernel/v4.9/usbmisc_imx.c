...
V_73 = F_23 ( V_74 , & V_69 -> V_5 ) ;
if ( ! V_73 )
return - V_75 ;
V_2 = F_24 ( & V_69 -> V_5 , sizeof( * V_2 ) , V_76 ) ;
if ( ! V_2 )
return - V_77 ;
F_25 ( & V_2 -> V_10 ) ;
V_71 = F_26 ( V_69 , V_78 , 0 ) ;
V_2 -> V_11 = F_27 ( & V_69 -> V_5 , V_71 ) ;
if ( F_28 ( V_2 -> V_11 ) )
return F_29 ( V_2 -> V_11 ) ;
V_2 -> V_64 = ( const struct V_79 * ) V_73 -> V_2 ;
F_30 ( V_69 , V_2 ) ;
return 0 ;
}
