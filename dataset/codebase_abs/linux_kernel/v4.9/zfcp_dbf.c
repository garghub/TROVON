...
void F_22 ( char * V_18 , struct V_100 * V_101 )
{
...
void F_23 ( char * V_18 , struct V_111 * V_112 ,
T_2 V_9 )
{
...
if ( ! V_115 )
goto V_122;
V_119 = F_25 (unsigned int, sg->length, ZFCP_DBF_SAN_MAX_PAYLOAD) ;
memcpy ( V_31 -> V_70 , F_26 ( V_115 ) , V_119 ) ;
if ( V_116 <= V_119 )
goto V_122;
F_3 ( & V_5 -> V_13 ) ;
memset ( V_70 , 0 , sizeof( * V_70 ) ) ;
...
V_70 -> V_14 = V_9 ;
V_70 -> V_17 = 0 ;
for (; V_115 && V_120 < V_117 ; V_115 = F_27 ( V_115 ) ) {
T_1 V_123 , V_1 = 0 ;
while ( V_1 < V_115 -> V_7 && V_120 < V_117 ) {
V_123 = F_4 ( ( T_1 ) V_3 ,
( T_1 ) ( V_115 -> V_7 - V_1 ) ) ;
memcpy ( V_70 -> V_6 , F_26 ( V_115 ) + V_1 , V_123 ) ;
F_5 ( V_5 -> V_16 , 1 , V_70 ,
F_1 ( V_123 ) ) ;
V_70 -> V_17 ++ ;
V_1 += V_123 ;
...
void F_28 ( char * V_18 , struct V_20 * V_125 , T_4 V_66 )
{
struct V_4 * V_5 = V_125 -> V_22 -> V_5 ;
struct V_126 * V_127 = V_125 -> V_6 ;
T_1 V_7 ;
V_7 = ( T_1 ) F_29 ( V_127 -> V_21 ) ;
F_24 ( V_18 , V_5 , L_4 , V_127 -> V_21 , V_128 ,
V_7 , V_125 -> V_9 , V_66 , V_7 ) ;
}
static T_1 F_30 ( char * V_18 ,
struct V_20 * V_125 ,
T_1 V_116 )
{
struct V_126 * V_127 = V_125 -> V_6 ;
struct V_129 * V_130 = F_26 ( V_127 -> V_21 ) ;
...
void F_31 ( char * V_18 , struct V_20 * V_125 )
{
struct V_4 * V_5 = V_125 -> V_22 -> V_5 ;
struct V_126 * V_127 = V_125 -> V_6 ;
T_1 V_7 ;
V_7 = ( T_1 ) F_29 ( V_127 -> V_134 ) ;
F_24 ( V_18 , V_5 , L_6 , V_127 -> V_134 , V_165 ,
...
V_7 = ( T_1 ) ( V_61 -> V_7 -
F_12 ( struct V_60 , V_70 ) ) ;
F_33 ( & V_115 , V_61 -> V_70 . V_6 , V_7 ) ;
F_24 ( V_18 , V_5 , L_7 , & V_115 , V_166 , V_7 ,
V_125 -> V_9 , F_11 ( V_61 -> V_66 ) , V_7 ) ;
}
void F_34 ( char * V_18 , int V_19 , struct V_167 * V_168 ,
struct V_20 * V_125 )
{
struct V_76 * V_22 =
(struct V_76 * ) V_168 -> V_169 -> V_170 -> V_171 [ 0 ] ;
struct V_4 * V_5 = V_22 -> V_5 ;
struct F_34 * V_31 = & V_5 -> V_172 ;
struct V_173 * V_174 ;
struct V_175 * V_176 ;
unsigned long V_33 ;
F_8 ( & V_5 -> V_177 , V_33 ) ;
...
static T_5 * F_35 ( const char * V_202 , int V_203 , int V_204 )
{
struct V_205 * V_206 ;
V_206 = F_36 ( V_202 , V_203 , 1 , V_204 ) ;
if ( ! V_206 )
return NULL ;
F_37 ( V_206 , & V_207 ) ;
F_38 ( V_206 , V_208 ) ;
...
int F_42 ( struct V_76 * V_22 )
{
char V_202 [ V_209 ] ;
struct V_4 * V_5 ;
V_5 = F_43 ( sizeof( struct V_4 ) , V_210 ) ;
if ( ! V_5 )
return - V_211 ;
F_44 ( & V_5 -> V_13 ) ;
F_44 ( & V_5 -> V_34 ) ;
...
F_44 ( & V_5 -> V_177 ) ;
F_44 ( & V_5 -> V_95 ) ;
sprintf ( V_202 , L_9 , F_45 ( & V_22 -> V_212 -> V_213 ) ) ;
V_5 -> V_31 = F_35 ( V_202 , V_214 , sizeof( struct V_80 ) ) ;
if ( ! V_5 -> V_31 )
goto V_215;
sprintf ( V_202 , L_10 , F_45 ( & V_22 -> V_212 -> V_213 ) ) ;
V_5 -> V_59 = F_35 ( V_202 , V_214 , sizeof( struct V_30 ) ) ;
if ( ! V_5 -> V_59 )
goto V_215;
sprintf ( V_202 , L_11 , F_45 ( & V_22 -> V_212 -> V_213 ) ) ;
V_5 -> V_16 = F_35 ( V_202 , V_214 * 2 , sizeof( struct V_2 ) ) ;
if ( ! V_5 -> V_16 )
goto V_215;
sprintf ( V_202 , L_12 , F_45 ( & V_22 -> V_212 -> V_213 ) ) ;
V_5 -> V_124 = F_35 ( V_202 , V_214 , sizeof( struct F_24 ) ) ;
if ( ! V_5 -> V_124 )
goto V_215;
sprintf ( V_202 , L_13 , F_45 ( & V_22 -> V_212 -> V_213 ) ) ;
V_5 -> V_201 = F_35 ( V_202 , V_214 , sizeof( struct F_34 ) ) ;
if ( ! V_5 -> V_201 )
goto V_215;
V_22 -> V_5 = V_5 ;
return 0 ;
