...
V_2 -> V_23 . V_33 |= V_48 ;
if ( V_2 -> V_3 . type == F_29 ( V_4 ) )
V_2 -> V_139 . V_140 . V_138 = F_63 ( V_38 ) -> V_141 ;
else if ( V_2 -> V_3 . type == F_29 ( V_6 ) )
memcpy ( & V_2 -> V_142 . V_140 . V_138 , & F_27 ( V_38 ) -> V_141 ,
sizeof( V_2 -> V_142 . V_140 . V_138 ) ) ;
else
return;
if ( V_2 -> V_93 . V_66 == V_143 )
V_138 = F_72 ( V_38 ) -> V_144 ;
else if ( V_2 -> V_93 . V_66 == V_145 )
V_138 = F_73 ( V_38 ) -> V_144 ;
else if ( V_2 -> V_93 . V_66 == V_146 )
V_138 = F_74 ( V_38 ) -> V_144 ;
else
return;
...
V_2 -> V_23 . V_33 |= V_50 ;
if ( V_2 -> V_3 . type == F_29 ( V_4 ) )
V_2 -> V_139 . V_140 . V_148 = F_63 ( V_38 ) -> V_149 ;
else if ( V_2 -> V_3 . type == F_29 ( V_6 ) )
memcpy ( & V_2 -> V_142 . V_140 . V_148 , & F_27 ( V_38 ) -> V_149 ,
sizeof( V_2 -> V_142 . V_140 . V_148 ) ) ;
else
return;
if ( V_2 -> V_93 . V_66 == V_143 )
V_148 = F_72 ( V_38 ) -> V_150 ;
else if ( V_2 -> V_93 . V_66 == V_145 )
V_148 = F_73 ( V_38 ) -> V_150 ;
else if ( V_2 -> V_93 . V_66 == V_146 )
V_148 = F_74 ( V_38 ) -> V_150 ;
else
return;
...
return V_72 ;
if ( V_40 -> V_151 & V_152 && V_10 != V_20 &&
V_23 -> V_46 & V_153 &&
( V_10 != V_18 || V_40 -> V_154 ) ) {
if ( F_78 ( V_10 ) == V_103 )
...
V_123 = V_23 -> V_46 & V_47
? V_126 : V_155 ;
} else if ( V_40 -> V_151 & V_156 ) {
V_123 = V_126 ;
} else if ( V_40 -> V_151 & V_157 ) {
V_123 = V_155 ;
} else {
return V_72 ;
}
...
struct V_37 * V_38 )
{
bool V_158 = F_55 ( V_79 , V_2 , V_40 , V_38 ) ;
enum V_9 V_10 ;
struct V_22 * V_23 ;
if ( ! V_158 ) {
struct V_22 * V_159 = V_40 -> V_23 ;
int V_64 ;
if ( V_159 ) {
if ( V_38 -> V_114 )
F_80 ( V_38 -> V_114 ) ;
F_81 ( & V_159 -> V_115 ) ;
V_38 -> V_114 = & V_159 -> V_115 ;
V_38 -> V_116 = V_20 ;
}
do {
V_64 = F_82 ( V_79 , V_40 -> V_117 ,
V_160 , V_38 ) ;
} while ( V_64 == V_161 );
if ( V_64 != V_72 )
return - V_162 ;
...
V_23 = F_10 ( V_38 , & V_10 ) ;
if ( V_23 ) {
if ( V_40 -> V_151 && ! ( V_2 -> V_23 . V_33 & V_45 ) &&
( F_11 ( V_23 ) || V_40 -> V_154 ) &&
F_75 ( V_79 , V_2 , V_40 , V_38 , V_23 , V_10 ) != V_72 ) {
return - V_163 ;
}
if ( ! F_11 ( V_23 ) && V_40 -> V_154 &&
V_40 -> V_68 && ! F_24 ( V_23 ) ) {
...
static int F_90 ( struct V_39 * V_40 , const char * V_169 ,
const struct V_1 * V_2 , bool log )
{
struct V_67 * V_68 ;
struct V_69 * V_70 ;
V_68 = F_91 ( V_169 , V_40 -> V_117 ,
V_2 -> V_93 . V_66 ) ;
if ( ! V_68 ) {
F_92 ( log , L_5 , V_169 ) ;
return - V_163 ;
}
V_70 = F_93 ( V_40 -> V_23 , V_68 , V_170 ) ;
if ( ! V_70 ) {
F_94 ( V_68 -> V_171 ) ;
return - V_172 ;
}
...
V_40 -> V_151 |= V_152 ;
V_40 -> V_151 |= ( ( type == V_182 )
? V_156 : V_157 ) ;
break;
case V_184 :
F_100 ( & V_40 -> V_121 . V_194 , V_175 ,
sizeof( V_40 -> V_121 . V_194 ) ) ;
V_40 -> V_121 . V_136 |= V_137 ;
break;
case V_187 :
V_177 = true ;
F_100 ( & V_40 -> V_121 . V_195 , V_175 ,
sizeof( V_40 -> V_121 . V_195 ) ) ;
V_40 -> V_121 . V_136 |= V_137 ;
break;
case V_188 :
V_40 -> V_121 . V_196 . V_197 = F_29 ( F_101 ( V_175 ) ) ;
V_40 -> V_121 . V_136 |= V_198 ;
break;
case V_189 :
V_178 = true ;
V_40 -> V_121 . V_199 . V_197 = F_29 ( F_101 ( V_175 ) ) ;
V_40 -> V_121 . V_136 |= V_198 ;
break;
case V_190 :
...
static int F_102 ( const struct V_173 * V_174 , struct V_39 * V_40 ,
...
#endif
#ifdef V_57
if ( ! V_40 -> V_154 && F_86 ( & V_40 -> V_27 . V_60 ) ) {
F_92 ( log ,
L_20 ) ;
return - V_163 ;
}
...
bool F_105 ( struct V_79 * V_79 , enum V_215 V_174 )
{
if ( V_174 == V_52 )
return true ;
if ( F_5 ( V_54 ) &&
...
if ( F_5 ( V_57 ) &&
V_174 == V_58 ) {
struct V_216 * V_216 = F_106 ( V_79 , V_217 ) ;
return V_216 -> V_218 ;
}
return false ;
}
int F_107 ( struct V_79 * V_79 , const struct V_173 * V_174 ,
const struct V_1 * V_2 ,
...
V_221 . V_117 = V_117 ;
F_108 ( & V_221 . V_35 , V_222 ,
V_223 , 0 ) ;
V_64 = F_102 ( V_174 , & V_221 , & V_68 , log ) ;
if ( V_64 )
return V_64 ;
V_221 . V_23 = F_109 ( V_79 , & V_221 . V_35 , V_170 ) ;
if ( ! V_221 . V_23 ) {
F_92 ( log , L_23 ) ;
return - V_172 ;
}
F_110 ( V_224 , & V_221 . V_23 -> V_46 ) ;
F_81 ( & V_221 . V_23 -> V_115 ) ;
if ( V_68 ) {
V_64 = F_90 ( & V_221 , V_68 , V_2 , log ) ;
if ( V_64 )
goto V_225;
}
V_64 = F_111 ( V_220 , V_226 , & V_221 ,
sizeof( V_221 ) , log ) ;
if ( V_64 )
goto V_225;
return 0 ;
...
int F_119 ( const struct V_39 * V_221 ,
struct V_37 * V_38 )
{
struct V_173 * V_227 ;
V_227 = F_114 ( V_38 , V_226 ) ;
if ( ! V_227 )
return - V_53 ;
if ( V_221 -> V_154 && F_115 ( V_38 , V_207 ) )
return - V_53 ;
if ( F_5 ( V_54 ) &&
...
#ifdef F_104
if ( V_221 -> V_151 && ! F_113 ( V_221 , V_38 ) )
return - V_53 ;
#endif
F_118 ( V_38 , V_227 ) ;
return 0 ;
...
{
struct V_39 * V_221 = F_103 ( V_175 ) ;
F_112 ( V_221 ) ;
}
static void F_112 ( struct V_39 * V_221 )
{
if ( V_221 -> V_68 )
F_94 ( V_221 -> V_68 -> V_171 ) ;
if ( V_221 -> V_23 )
F_122 ( V_221 -> V_23 ) ;
}
