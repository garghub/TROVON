...
V_171 -> V_242 = V_241 ;
V_171 -> V_252 = & V_253 ;
V_171 -> V_97 . V_254 = V_255 ;
V_171 -> V_97 . V_230 = & V_256 ;
V_171 -> V_257 = V_258 ;
F_141 ( V_171 , V_14 ) ;
return 0 ;
}
...
{
V_14 -> clock = F_150 ( & V_14 -> V_102 -> V_103 , V_259 ) ;
if ( F_146 ( V_14 -> clock ) )
return F_151 ( V_14 -> clock ) ;
return 0 ;
}
static int F_152 ( struct V_260 * V_102 )
{
struct V_115 * V_261 = NULL ;
...
if ( ! V_103 -> V_266 )
return - V_267 ;
V_14 = F_153 ( V_103 , sizeof( * V_14 ) , V_268 ) ;
if ( ! V_14 )
return - V_269 ;
V_263 = F_154 ( V_270 , V_103 -> V_266 ) ;
if ( V_263 )
V_261 = (struct V_115 * ) V_263 -> V_271 ;
V_14 -> V_5 = F_155 ( V_103 -> V_266 , L_14 ) ;
if ( ! V_261 || V_14 -> V_5 >= V_261 -> V_272 ||
V_14 -> V_5 < 0 ) {
F_156 ( V_103 , L_15 ,
V_103 -> V_266 -> V_273 ) ;
return - V_22 ;
...
F_158 ( & V_14 -> V_23 ) ;
F_159 ( & V_14 -> V_98 ) ;
V_265 = F_160 ( V_102 , V_274 , 0 ) ;
V_14 -> V_275 = F_161 ( V_103 , V_265 ) ;
if ( F_146 ( V_14 -> V_275 ) )
return F_151 ( V_14 -> V_275 ) ;
V_265 = F_160 ( V_102 , V_276 , 0 ) ;
if ( V_265 == NULL ) {
F_156 ( V_103 , L_16 ) ;
return - V_19 ;
}
...
if ( V_71 )
return V_71 ;
V_71 = F_162 ( V_103 , V_265 -> V_277 , F_32 ,
0 , F_85 ( V_103 ) , V_14 ) ;
if ( V_71 ) {
...
static int F_176 ( struct V_260 * V_102 )
{
