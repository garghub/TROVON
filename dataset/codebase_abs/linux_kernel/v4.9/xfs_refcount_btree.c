...
V_2 -> V_100 = & V_101 ;
V_2 -> V_102 = F_5 ( V_15 -> V_22 ) ;
V_2 -> V_5 . V_6 . V_7 = V_7 ;
V_2 -> V_5 . V_6 . V_8 = V_8 ;
V_2 -> V_5 . V_6 . V_9 = V_9 ;
V_2 -> V_103 |= V_104 ;
V_2 -> V_5 . V_6 . V_105 . V_61 . V_106 = 0 ;
V_2 -> V_5 . V_6 . V_105 . V_61 . V_107 = 0 ;
return V_2 ;
}
int
F_48 (
...
V_108 -= V_110 ;
if ( V_109 )
return V_108 / sizeof( struct V_111 ) ;
return V_108 / ( sizeof( struct V_69 ) +
sizeof( V_112 ) ) ;
}
void
F_49 (
...
{
return F_52 ( V_32 , V_32 -> V_55 , V_47 ) ;
}
T_5
F_53 (
struct V_52 * V_32 )
...
if ( V_32 -> V_56 [ 0 ] == 0 )
return 0 ;
return F_51 ( V_32 , V_32 -> V_80 . V_113 ) ;
}
int
F_54 (
struct V_52 * V_32 ,
...
return 0 ;
* V_114 += F_53 ( V_32 ) ;
error = F_55 ( V_32 , NULL , V_8 , 0 , & V_7 ) ;
if ( error )
return error ;
V_15 = F_4 ( V_7 ) ;
V_116 = F_5 ( V_15 -> V_48 ) ;
