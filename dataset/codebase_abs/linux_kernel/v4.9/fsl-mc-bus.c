...
if ( F_4 ( ! V_2 ) ) {
* V_36 = NULL ;
} else if ( F_4 ( ! F_23 ( V_2 ) ) ) {
* V_36 = NULL ;
} else {
* V_36 = V_2 ;
while ( F_23 ( ( * V_36 ) -> V_37 ) )
* V_36 = ( * V_36 ) -> V_37 ;
}
}
...
V_87 = NULL ;
if ( strcmp ( V_14 -> type , L_12 ) == 0 ) {
V_86 = F_37 ( V_67 , sizeof( * V_86 ) , V_71 ) ;
if ( ! V_86 )
return - V_21 ;
V_8 = & V_86 -> V_8 ;
} else {
...
V_8 -> V_2 . V_37 = V_67 ;
V_8 -> V_2 . V_32 = & V_33 ;
F_40 ( & V_8 -> V_2 , L_18 , V_14 -> type , V_14 -> V_6 ) ;
if ( strcmp ( V_14 -> type , L_12 ) == 0 ) {
struct V_38 * V_89 ;
V_8 -> V_80 |= V_90 ;
if ( V_87 ) {
...
error = F_28 ( V_89 , V_14 -> V_6 , & V_8 -> V_44 ) ;
if ( error < 0 )
goto V_91;
} else {
V_8 -> V_44 = V_87 -> V_44 ;
...
* V_95 = F_58 ( V_105 ) ;
V_100 = F_56 ( V_105 , L_23 , NULL ) ;
if ( V_100 )
* V_96 = F_59 ( V_100 ) ;
else
* V_96 = * V_95 ;
V_100 = F_56 ( V_105 , L_24 , NULL ) ;
if ( V_100 )
* V_97 = F_59 ( V_100 ) ;
else
* V_97 = F_60 ( V_105 ) ;
...
V_57 -> V_49 = F_63 ( V_108 , 1 ) ;
V_57 -> V_59 = F_63 ( V_108 + 1 ,
V_96 - 1 ) ;
V_108 += V_96 ;
V_57 -> V_61 = F_63 ( V_108 , V_95 ) ;
V_108 += V_95 ;
V_57 -> V_60 = V_57 -> V_59 +
F_63 ( V_108 , V_97 ) ;
V_108 += V_97 ;
...
struct V_64 V_114 ;
F_65 ( & V_110 -> V_2 , L_26 ) ;
V_54 = F_37 ( & V_110 -> V_2 , sizeof( * V_54 ) , V_71 ) ;
if ( ! V_54 )
return - V_21 ;
F_66 ( V_110 , V_54 ) ;
error = F_67 ( V_110 -> V_2 . V_106 , 0 , & V_114 ) ;
if ( error < 0 ) {
F_12 ( & V_110 -> V_2 ,
L_27 ,
...
V_111 = V_114 . V_78 ;
V_112 = F_68 ( & V_114 ) ;
error = F_69 ( & V_110 -> V_2 , V_111 ,
V_112 , NULL ,
V_116 , & V_39 ) ;
if ( error < 0 )
return error ;
error = F_70 ( V_39 , 0 , & V_113 ) ;
if ( error != 0 ) {
F_12 ( & V_110 -> V_2 ,
L_28 , error ) ;
goto V_117;
...
error = F_61 ( & V_110 -> V_2 ,
& V_54 -> V_58 ,
& V_54 -> V_55 ) ;
if ( error < 0 )
goto V_117;
error = F_71 ( V_39 , 0 , & V_40 ) ;
if ( error < 0 ) {
F_12 ( & V_110 -> V_2 ,
L_30 , error ) ;
goto V_117;
...
V_14 . V_122 = 1 ;
V_14 . V_70 = 0 ;
error = F_36 ( & V_14 , V_39 , & V_110 -> V_2 , & V_63 ) ;
if ( error < 0 )
goto V_117;
V_54 -> V_123 = V_63 ;
return 0 ;
...
{
struct V_53 * V_54 = F_74 ( V_110 ) ;
if ( F_4 ( ! F_6 ( & V_54 -> V_123 -> V_2 ) ) )
return - V_26 ;
F_50 ( V_54 -> V_123 ) ;
F_72 ( V_54 -> V_123 -> V_39 ) ;
