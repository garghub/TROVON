...
int F_36 ( struct V_54 * V_55 , struct V_35 * V_26 ,
struct V_56 * args )
{
struct V_5 * V_23 ;
T_3 V_57 ;
...
int F_40 ( struct V_54 * V_55 , struct V_35 * V_26 ,
T_4 V_57 , T_5 * V_63 )
{
struct V_5 * V_6 ;
int V_13 = 0 ;
...
int F_45 ( struct V_54 * V_55 , struct V_35 * V_26 ,
T_4 V_57 )
{
return F_46 ( V_55 , V_57 ) ;
}
int F_47 ( struct V_35 * V_26 , void * V_67 ,
struct V_54 * V_55 )
{
...
V_8 = F_49 ( V_23 -> V_6 . V_50 , 0 , args -> V_20 , V_71 | V_72 ,
V_73 , args -> V_63 ) ;
F_39 ( & V_23 -> V_6 ) ;
if ( F_50 ( V_8 ) )
return V_8 ;
...
int F_51 ( struct V_35 * V_26 , void * V_67 ,
struct V_54 * V_55 )
{
...
if ( ! F_52 ( V_76 , V_42 , args -> V_20 ) )
return - V_77 ;
V_13 = F_53 ( V_42 , args -> V_20 ) ;
if ( V_13 )
return V_13 ;
V_23 = F_41 ( V_55 , args -> V_57 ) ;
if ( V_23 == NULL )
...
if ( F_54 ( V_23 -> V_8 + args -> V_63 , V_42 , args -> V_20 ) ) {
V_13 = - V_77 ;
} else if ( V_23 -> V_79 ) {
V_23 -> V_79 ( V_23 -> V_80 ) ;
V_13 = 0 ;
...
F_61 ( V_88 , V_29 , V_21 , 0 ) ;
}
if ( F_62 ( V_83 -> V_26 , V_33 -> V_94 , V_33 -> V_95 , V_85 ) == 0 ) {
V_90 = V_33 -> V_95 ;
goto V_93;
}
} else if ( V_23 -> V_29 ) {
if ( F_57 ( V_33 , 1 , V_37 ) )
goto V_92;
F_61 ( V_33 -> V_94 , V_23 -> V_29 , V_23 -> V_6 . V_20 , 0 ) ;
if ( F_62 ( V_83 -> V_26 , V_33 -> V_94 , V_33 -> V_95 , V_85 ) == 0 )
goto V_96;
} else if ( V_23 -> V_31 ) {
if ( F_57 ( V_33 , 1 , V_37 ) )
goto V_92;
F_63 ( V_33 -> V_94 ) = V_23 -> V_46 ;
F_64 ( V_33 -> V_94 ) = V_23 -> V_6 . V_20 ;
} else {
goto V_92;
}
return V_33 ;
...
int V_89 ;
if ( ! V_23 -> V_31 )
F_69 ( V_83 -> V_26 , V_33 -> V_94 , V_33 -> V_95 , V_85 ) ;
if ( V_23 -> V_6 . V_50 ) {
struct V_87 * V_88 ;
...
static void
F_71 ( struct V_97 * V_98 , unsigned long V_99 , void * V_8 )
{
}
static int
...
struct V_97 *
F_73 ( struct V_35 * V_26 , struct V_22 * V_6 ,
int V_100 )
{
F_74 ( V_101 ) ;
V_101 . V_102 = & V_103 ;
...
V_101 . V_100 = V_104 ;
V_101 . V_25 = V_6 ;
return F_75 ( V_26 , & V_101 ) ;
}
struct V_22 *
F_76 ( struct V_35 * V_26 , struct V_97 * V_98 )
{
struct V_82 * V_83 ;
struct V_5 * V_23 ;
if ( V_98 -> V_102 == & V_103 ) {
...
if ( F_64 ( V_23 -> V_33 -> V_94 ) < V_23 -> V_6 . V_20 ) {
F_42 ( L_13 ) ;
return - V_64 ;
}
V_23 -> V_46 = F_63 ( V_23 -> V_33 -> V_94 ) ;
return 0 ;
}
