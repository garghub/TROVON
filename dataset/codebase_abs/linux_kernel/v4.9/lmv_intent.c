...
V_60 -> V_70 = V_24 -> V_71 ;
F_20 ( V_60 , V_24 -> V_66 ) ;
F_21 ( V_60 -> V_72 ) = V_24 -> V_73 ;
F_21 ( V_60 -> V_74 ) = V_24 -> V_75 ;
F_21 ( V_60 -> V_76 ) = V_24 -> V_77 ;
}
F_22 ( V_22 -> V_51 , V_59 , V_60 , NULL ) ;
if ( V_3 . V_35 && V_59 ) {
F_13 ( V_59 , V_3 . V_35 ) ;
V_3 . V_35 = 0 ;
}
...
static int F_23 ( struct V_1 * exp , struct V_19 * V_20 ,
struct V_2 * V_3 ,
struct V_6 * * V_7 ,
T_1 V_8 ,
T_2 V_9 )
...
V_26 = F_25 ( NULL , exp , & V_20 -> V_45 , V_20 ) ;
if ( V_26 != 0 )
return V_26 ;
}
...
static int F_26 ( struct V_1 * exp ,
struct V_19 * V_20 ,
struct V_2 * V_3 ,
struct V_6 * * V_7 ,
T_1 V_8 ,
...
return F_7 ( V_22 ) ;
if ( V_56 && ! F_27 ( V_56 -> V_89 ) ) {
struct V_90 * V_91 = & V_56 -> V_62 [ 0 ] ;
V_20 -> V_43 = V_91 -> V_63 ;
V_20 -> V_81 = V_91 -> V_92 ;
V_22 = F_28 ( V_14 , V_91 -> V_92 , NULL ) ;
if ( F_6 ( V_22 ) )
return F_7 ( V_22 ) ;
}
if ( ! F_4 ( & V_20 -> V_45 ) )
...
int F_31 ( struct V_1 * exp , struct V_19 * V_20 ,
...
V_26 = F_26 ( exp , V_20 , V_3 , V_7 , V_8 ,
V_9 ) ;
else if ( V_3 -> V_32 & V_44 )
V_26 = F_23 ( exp , V_20 , V_3 , V_7 , V_8 ,
V_9 ) ;
else
F_34 () ;
if ( V_26 < 0 ) {
