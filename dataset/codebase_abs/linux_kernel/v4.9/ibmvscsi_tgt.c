...
static void F_85 ( struct V_18 * V_19 , struct V_20 * V_21 )
{
struct V_89 * V_90 ;
struct V_91 * V_92 ;
struct V_264 * V_208 ;
...
switch ( V_208 -> V_212 ) {
case V_267 :
V_24 = F_83 ( V_19 , V_90 , V_21 ) ;
break;
case V_268 :
V_266 = & F_54 ( V_92 ) -> V_208 . V_269 ;
F_6 ( L_78 , V_266 -> V_190 ,
V_266 -> V_190 ) ;
...
static long F_87 ( struct V_18 * V_19 )
{
long V_24 = V_37 ;
switch ( V_19 -> V_68 ) {
case V_108 :
...
static long F_89 ( struct V_18 * V_19 , struct V_20 * V_21 )
{
long V_24 = V_37 ;
F_6 ( L_87 , V_19 -> V_68 ) ;
V_24 = F_90 ( V_19 -> V_31 . V_32 , V_277 ,
...
V_286 ++ ;
V_287 = ( const T_9 * ) F_92 ( V_285 , L_96 ,
NULL ) ;
if ( ! V_287 ) {
F_24 ( L_97 ) ;
V_286 ++ ;
...
V_287 = ( const T_9 * ) F_92 ( V_285 , L_98 ,
NULL ) ;
if ( ! V_287 ) {
F_24 ( L_99 ) ;
V_286 ++ ;
...
static struct V_226 * F_93 ( const char * V_178 )
{
struct V_226 * V_227 = NULL ;
struct V_284 * V_285 ;
struct V_18 * V_19 ;
F_17 ( & V_288 ) ;
F_94 (vscsi, &ibmvscsis_dev_list, list) {
V_285 = V_19 -> V_58 ;
...
V_24 = F_97 ( & V_90 -> V_1 , V_230 -> V_233 , V_208 -> V_308 ,
V_90 -> V_309 , F_98 ( & V_208 -> V_306 ) ,
V_290 , V_293 , V_292 , 0 ) ;
if ( V_24 ) {
F_9 ( & V_19 -> V_42 , L_103 , V_24 ) ;
goto V_295;
}
return;
V_295:
...
F_6 ( L_105 ,
V_310 -> V_313 ) ;
V_24 = F_100 ( & V_90 -> V_1 , V_230 -> V_233 , NULL ,
F_98 ( & V_310 -> V_306 ) , V_310 ,
V_311 , V_158 , V_312 , 0 ) ;
if ( V_24 ) {
F_9 ( & V_19 -> V_42 , L_106 ,
V_24 ) ;
...
static void F_102 ( struct V_105 * V_106 )
{
...
static int F_103 ( struct V_18 * V_19 , int V_330 )
{
struct V_89 * V_90 ;
int V_331 ;
F_104 ( & V_19 -> V_99 ) ;
V_19 -> V_332 = F_105 ( V_330 , sizeof( struct V_89 ) ,
V_158 ) ;
if ( ! V_19 -> V_332 )
return - V_232 ;
...
static enum V_333 F_107 ( struct V_334 * V_200 )
{
...
static long F_108 ( struct V_18 * V_19 )
{
struct V_335 * V_336 ;
V_336 = & V_19 -> V_77 ;
F_109 ( & V_336 -> V_200 , V_338 , V_201 ) ;
V_336 -> V_200 . V_339 = F_107 ;
V_336 -> V_128 = false ;
V_336 -> V_78 = 0 ;
return V_37 ;
}
...
struct V_335 * V_336 ;
V_336 = & V_19 -> V_77 ;
( void ) F_111 ( & V_336 -> V_200 ) ;
V_336 -> V_128 = false ;
V_336 -> V_78 = 0 ;
}
static T_10 F_112 ( int V_340 , void * V_341 )
{
...
static long F_114 ( struct V_18 * V_19 )
{
T_4 V_27 ;
long V_24 ;
V_24 = F_21 ( V_19 , & V_27 ) ;
...
static long F_116 ( struct V_18 * V_19 , int V_345 )
{
long V_24 = 0 ;
int V_346 ;
struct V_284 * V_285 = V_19 -> V_58 ;
...
V_19 -> V_63 . V_66 =
(struct V_20 * ) F_117 ( V_158 ) ;
if ( ! V_19 -> V_63 . V_66 )
return - V_232 ;
V_19 -> V_63 . V_69 = ( ( T_4 ) V_346 * V_347 ) - 1 ;
V_19 -> V_63 . V_86 = F_118 ( & V_285 -> V_42 ,
V_19 -> V_63 . V_66 ,
V_65 , V_348 ) ;
if ( F_119 ( & V_285 -> V_42 , V_19 -> V_63 . V_86 ) ) {
...
F_121 ( & V_285 -> V_42 , V_19 -> V_63 . V_86 ,
V_65 , V_348 ) ;
F_120 ( ( unsigned long ) V_19 -> V_63 . V_66 ) ;
V_24 = - V_238 ;
}
...
{
F_121 ( & V_19 -> V_58 -> V_42 , V_19 -> V_63 . V_86 ,
V_65 , V_348 ) ;
F_120 ( ( unsigned long ) V_19 -> V_63 . V_66 ) ;
V_19 -> V_63 . V_66 = NULL ;
V_19 -> V_68 = V_108 ;
...
struct V_349 V_350 ;
T_5 V_24 = V_1 -> V_351 ;
if ( V_19 -> V_194 && ( F_124 ( V_208 -> V_308 ) || F_125 ( V_208 -> V_308 ) ) )
if ( F_126 ( V_1 -> V_352 ,
V_1 -> V_353 , & V_350 ) )
...
static int F_128 ( struct V_89 * V_90 , struct V_377 * V_378 ,
...
F_104 ( & V_19 -> V_102 ) ;
F_104 ( & V_19 -> V_100 ) ;
snprintf ( V_19 -> V_227 . V_228 , 256 , L_123 , F_62 ( & V_285 -> V_42 ) ) ;
F_6 ( L_124 , V_19 -> V_227 . V_228 ) ;
V_24 = F_91 ( V_19 ) ;
if ( V_24 )
goto V_401;
F_6 ( L_125 ,
V_19 -> V_31 . V_135 [ V_139 ] . V_137 ,
V_19 -> V_31 . V_135 [ V_136 ] . V_137 ) ;
strcpy ( V_19 -> V_402 , L_126 ) ;
strncat ( V_19 -> V_402 , V_285 -> V_178 , V_403 ) ;
V_19 -> V_31 . V_32 = V_285 -> V_205 ;
F_17 ( & V_288 ) ;
F_28 ( & V_19 -> V_98 , & V_404 ) ;
F_16 ( & V_288 ) ;
V_19 -> V_215 = V_405 ;
...
V_19 -> V_278 = F_118 ( & V_285 -> V_42 , V_19 -> V_279 , V_65 ,
V_348 ) ;
if ( F_119 ( & V_285 -> V_42 , V_19 -> V_278 ) ) {
V_24 = - V_232 ;
F_9 ( & V_19 -> V_42 , L_131 ) ;
goto V_411;
}
V_399 = F_90 ( V_19 -> V_31 . V_32 , V_277 ,
( T_2 ) V_19 -> V_278 | ( ( T_2 ) V_65 << 32 ) , 0 , 0 , 0 ,
0 ) ;
if ( V_399 == V_39 )
V_19 -> V_52 . V_160 =
F_51 ( * ( T_2 * ) V_19 -> V_279 ) ;
F_6 ( L_132 ,
V_399 , V_19 -> V_52 . V_160 ) ;
F_138 ( & V_19 -> V_342 , F_133 ,
( unsigned long ) V_19 ) ;
F_139 ( & V_19 -> V_104 ) ;
snprintf ( V_400 , 24 , L_133 , F_62 ( & V_285 -> V_42 ) ) ;
V_19 -> V_120 = F_140 ( V_400 ) ;
if ( ! V_19 -> V_120 ) {
V_24 = - V_232 ;
F_9 ( & V_19 -> V_42 , L_134 ) ;
goto V_412;
}
V_24 = F_141 ( V_285 -> V_413 , F_112 , 0 , L_135 , V_19 ) ;
if ( V_24 ) {
V_24 = - V_414 ;
F_9 ( & V_19 -> V_42 , L_136 , V_24 ) ;
goto V_415;
}
F_17 ( & V_19 -> V_62 ) ;
F_23 ( V_285 ) ;
if ( V_24 ) {
F_9 ( & V_19 -> V_42 , L_137 , V_24 ) ;
V_24 = - V_238 ;
F_16 ( & V_19 -> V_62 ) ;
goto V_416;
}
...
F_15 ( V_285 ) ;
V_416:
V_416 ( V_285 -> V_413 , V_19 ) ;
V_415:
F_143 ( V_19 -> V_120 ) ;
V_412:
F_121 ( & V_285 -> V_42 , V_19 -> V_278 , V_65 ,
V_348 ) ;
V_411:
F_78 ( V_19 -> V_279 ) ;
V_410:
...
static T_12 F_148 ( struct V_418 * V_42 ,
struct V_419 * V_293 , char * V_289 )
{
return snprintf ( V_289 , V_65 , L_140 , V_420 ) ;
}
static T_12 F_149 ( struct V_418 * V_42 ,
struct V_419 * V_293 , char * V_289 )
{
return snprintf ( V_289 , V_65 , L_141 , V_160 ) ;
}
static T_12 F_150 ( struct V_418 * V_42 ,
struct V_419 * V_293 , char * V_289 )
{
struct V_18 * V_19 = F_33 ( V_42 , struct V_18 , V_42 ) ;
return snprintf ( V_289 , V_65 , L_141 , V_19 -> V_58 -> V_205 ) ;
}
static int F_151 ( void )
{
struct V_421 * V_422 , * V_423 ;
const char * V_398 , * V_424 , * V_178 ;
const T_4 * V_330 ;
V_422 = F_152 ( L_142 ) ;
if ( ! V_422 )
return - V_425 ;
V_424 = F_153 ( V_422 , L_143 , NULL ) ;
V_398 = F_153 ( V_422 , L_144 , NULL ) ;
if ( V_424 && V_398 )
snprintf ( V_420 , sizeof( V_420 ) , L_145 , V_424 , V_398 ) ;
V_178 = F_153 ( V_422 , L_146 , NULL ) ;
if ( V_178 )
strncpy ( V_162 , V_178 , sizeof( V_162 ) ) ;
V_330 = F_153 ( V_422 , L_147 , NULL ) ;
if ( V_330 )
V_160 = * V_330 ;
F_154 ( V_422 ) ;
V_423 = F_152 ( L_148 ) ;
...
static char * F_156 ( struct V_427 * V_234 )
{
struct V_226 * V_227 =
F_33 ( V_234 , struct V_226 , V_234 ) ;
return V_227 -> V_228 ;
}
static T_3 F_157 ( struct V_427 * V_234 )
{
struct V_226 * V_227 =
F_33 ( V_234 , struct V_226 , V_234 ) ;
return V_227 -> V_428 ;
}
static T_1 F_158 ( struct V_427 * V_234 )
{
return 1 ;
}
static int F_159 ( struct V_427 * V_234 )
{
return 1 ;
}
static int F_160 ( struct V_427 * V_234 )
{
return 0 ;
}
static T_1 F_161 ( struct V_427 * V_234 )
{
return 1 ;
}
...
struct V_18 * V_19 = V_90 -> V_329 ;
F_17 ( & V_19 -> V_62 ) ;
F_165 ( & V_90 -> V_98 , & V_19 -> V_102 ) ;
F_67 ( V_19 ) ;
F_16 ( & V_19 -> V_62 ) ;
}
static T_1 F_166 ( struct V_237 * V_233 )
{
return 0 ;
}
...
struct V_91 * V_92 = V_90 -> V_92 ;
int V_24 ;
V_24 = F_168 ( V_90 , & F_54 ( V_92 ) -> V_208 . V_90 , F_128 ,
1 , 1 ) ;
if ( V_24 ) {
F_74 ( L_150 , V_24 ) ;
return - V_429 ;
...
static void F_171 ( struct V_430 * V_431 )
{
}
...
T_4 V_131 = 0 ;
int V_24 ;
V_24 = F_168 ( V_90 , & F_54 ( V_92 ) -> V_208 . V_90 , F_128 , 1 ,
1 ) ;
if ( V_24 ) {
F_74 ( L_151 , V_24 ) ;
V_432 = V_1 -> V_352 ;
...
F_174 ( 0 , V_1 -> V_352 , V_433 ,
0x08 , 0x01 ) ;
}
F_127 ( V_19 , V_90 , & V_131 ) ;
V_90 -> V_3 . V_27 = V_263 ;
...
static struct V_434 * F_178 ( struct V_435 * V_436 ,
struct V_437 * V_438 ,
const char * V_178 )
{
struct V_226 * V_227 ;
...
V_227 -> V_439 = V_440 ;
F_6 ( L_155 ,
V_178 , V_227 , V_227 -> V_439 ) ;
return & V_227 -> V_441 ;
}
return F_179 ( - V_442 ) ;
}
static void F_180 ( struct V_434 * V_443 )
{
struct V_226 * V_227 = F_33 ( V_443 ,
struct V_226 ,
V_441 ) ;
F_6 ( L_156 ,
F_181 ( & V_227 -> V_441 . V_444 . V_445 ) ) ;
}
static struct V_427 * F_182 ( struct V_434 * V_443 ,
struct V_437 * V_438 ,
const char * V_178 )
{
struct V_226 * V_227 =
F_33 ( V_443 , struct V_226 , V_441 ) ;
int V_24 ;
V_227 -> V_446 = false ;
V_24 = F_183 ( & V_227 -> V_441 , & V_227 -> V_234 ,
V_227 -> V_439 ) ;
if ( V_24 )
return F_179 ( V_24 ) ;
return & V_227 -> V_234 ;
}
static void F_184 ( struct V_427 * V_234 )
{
...
static T_12 F_186 ( struct V_448 * V_449 ,
char * V_450 )
{
return F_187 ( V_450 , V_65 , L_140 , V_451 ) ;
}
static T_12 F_188 ( struct V_448 * V_449 ,
char * V_450 )
{
struct V_427 * V_234 = F_189 ( V_449 ) ;
struct V_226 * V_227 = F_33 ( V_234 ,
struct V_226 ,
V_234 ) ;
return snprintf ( V_450 , V_65 , L_157 , ( V_227 -> V_447 ) ? 1 : 0 ) ;
}
static T_12 F_190 ( struct V_448 * V_449 ,
...
static void F_192 ( struct V_418 * V_42 ) {}
