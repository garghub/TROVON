...
if ( V_83 . V_41 & V_88 )
V_40 = sizeof( V_89 ) ;
else if ( V_83 . V_41 & V_90 )
V_40 = sizeof( V_91 ) ;
else
return - V_20 ;
if ( V_83 . V_71 - V_64 < V_40 )
return - V_20 ;
V_84 = F_44 ( ( void V_69 * ) ( V_63 + V_64 ) , V_40 ) ;
if ( F_45 ( V_84 ) )
return F_46 ( V_84 ) ;
}
F_2 ( & V_10 -> V_92 ) ;
V_55 = F_47 ( V_10 , V_83 . V_41 , V_83 . V_76 ,
...
static T_6 F_48 ( struct V_32 * V_95 ,
char V_69 * V_96 , T_5 V_79 ,
T_7 V_97 )
{
unsigned int V_98 = 0 ;
if ( ! V_95 -> V_52 ) {
V_95 -> V_52 =
F_49 ( V_95 -> V_38 , V_95 -> V_40 ) ;
if ( ! V_95 -> V_52 )
return - V_34 ;
}
while ( V_79 ) {
...
if ( V_79 >= 4 && ! ( V_97 % 4 ) ) {
T_8 V_100 ;
V_100 = F_50 ( V_95 -> V_52 + V_97 ) ;
if ( F_42 ( V_96 , & V_100 , 4 ) )
goto V_37;
V_99 = 4 ;
} else if ( V_79 >= 2 && ! ( V_97 % 2 ) ) {
T_9 V_100 ;
V_100 = F_51 ( V_95 -> V_52 + V_97 ) ;
if ( F_42 ( V_96 , & V_100 , 2 ) )
goto V_37;
V_99 = 2 ;
} else {
T_4 V_100 ;
V_100 = F_52 ( V_95 -> V_52 + V_97 ) ;
if ( F_42 ( V_96 , & V_100 , 1 ) )
goto V_37;
V_99 = 1 ;
}
V_79 -= V_99 ;
...
static T_6 F_53 ( void * V_53 , char V_69 * V_96 ,
T_5 V_79 , T_7 * V_101 )
{
struct V_9 * V_10 = V_53 ;
unsigned int V_76 = F_54 ( * V_101 ) ;
T_7 V_97 = * V_101 & V_102 ;
if ( V_76 >= V_10 -> V_51 )
return - V_20 ;
if ( ! ( V_10 -> V_31 [ V_76 ] . V_41 & V_44 ) )
return - V_20 ;
if ( V_10 -> V_31 [ V_76 ] . type & V_43 )
return F_48 ( & V_10 -> V_31 [ V_76 ] ,
V_96 , V_79 , V_97 ) ;
else if ( V_10 -> V_31 [ V_76 ] . type & V_50 )
return - V_20 ;
return - V_20 ;
}
static T_6 F_55 ( struct V_32 * V_95 ,
const char V_69 * V_96 , T_5 V_79 ,
T_7 V_97 )
{
unsigned int V_98 = 0 ;
if ( ! V_95 -> V_52 ) {
...
if ( V_79 >= 4 && ! ( V_97 % 4 ) ) {
T_8 V_100 ;
if ( F_41 ( & V_100 , V_96 , 4 ) )
goto V_37;
F_56 ( V_100 , V_95 -> V_52 + V_97 ) ;
V_99 = 4 ;
} else if ( V_79 >= 2 && ! ( V_97 % 2 ) ) {
T_9 V_100 ;
if ( F_41 ( & V_100 , V_96 , 2 ) )
goto V_37;
F_57 ( V_100 , V_95 -> V_52 + V_97 ) ;
V_99 = 2 ;
} else {
T_4 V_100 ;
if ( F_41 ( & V_100 , V_96 , 1 ) )
goto V_37;
F_58 ( V_100 , V_95 -> V_52 + V_97 ) ;
V_99 = 1 ;
}
V_79 -= V_99 ;
V_98 += V_99 ;
...
static T_6 F_59 ( void * V_53 , const char V_69 * V_96 ,
T_5 V_79 , T_7 * V_101 )
{
struct V_9 * V_10 = V_53 ;
unsigned int V_76 = F_54 ( * V_101 ) ;
...
return - V_20 ;
if ( V_10 -> V_31 [ V_76 ] . type & V_43 )
return F_55 ( & V_10 -> V_31 [ V_76 ] ,
V_96 , V_79 , V_97 ) ;
else if ( V_10 -> V_31 [ V_76 ] . type & V_50 )
return - V_20 ;
return - V_20 ;
}
static int F_60 ( struct V_32 V_103 ,
struct V_104 * V_105 )
{
T_10 V_106 , V_107 , V_108 ;
V_106 = V_105 -> V_109 - V_105 -> V_110 ;
V_107 = V_105 -> V_111 &
( ( 1U << ( V_112 - V_113 ) ) - 1 ) ;
V_108 = V_107 << V_113 ;
if ( V_103 . V_40 < V_114 || V_108 + V_106 > V_103 . V_40 )
return - V_20 ;
V_105 -> V_115 = F_61 ( V_105 -> V_115 ) ;
V_105 -> V_111 = ( V_103 . V_38 >> V_113 ) + V_107 ;
return F_62 ( V_105 , V_105 -> V_110 , V_105 -> V_111 ,
V_106 , V_105 -> V_115 ) ;
}
static int F_63 ( void * V_53 , struct V_104 * V_105 )
{
struct V_9 * V_10 = V_53 ;
unsigned int V_76 ;
V_76 = V_105 -> V_111 >> ( V_112 - V_113 ) ;
...
V_105 -> V_120 = V_10 ;
if ( V_10 -> V_31 [ V_76 ] . type & V_43 )
return F_60 ( V_10 -> V_31 [ V_76 ] , V_105 ) ;
else if ( V_10 -> V_31 [ V_76 ] . type & V_50 )
return - V_20 ;
return - V_20 ;
}
...
struct V_9 * F_71 ( struct V_11 * V_12 )
{
struct V_9 * V_10 ;
V_10 = F_72 ( V_12 ) ;
if ( V_10 ) {
F_23 ( V_10 ) ;
F_69 ( V_12 -> V_121 , V_12 ) ;
}
return V_10 ;
}
void F_73 ( struct V_3 * V_124 )
{
F_2 ( & V_6 ) ;
F_74 ( & V_124 -> V_125 , & V_126 ) ;
F_5 ( & V_6 ) ;
}
void F_75 ( const char * V_1 ,
T_1 V_127 )
{
struct V_3 * V_4 , * V_128 ;
F_2 ( & V_6 ) ;
F_76 (iter, temp, &reset_list, link) {
if ( ! strcmp ( V_4 -> V_1 , V_1 ) && ( V_4 -> V_8 == V_127 ) ) {
F_77 ( & V_4 -> V_125 ) ;
break;
}
}
