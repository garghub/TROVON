...
static T_3 F_58 ( int V_116 , void * V_117 )
{
struct V_2 * V_3 = V_117 ;
T_1 V_24 ;
T_1 V_19 = V_3 -> V_107 ;
T_1 V_118 ;
if ( F_59 ( & V_3 -> V_100 -> V_101 ) )
return V_119 ;
V_118 = F_7 ( V_3 , V_23 ) ;
if ( V_118 == ~ 0 )
return V_119 ;
...
static unsigned int F_60 ( int V_122 , T_1 * V_123 )
{
...
V_130 >>= V_128 ;
V_135 >>= V_128 ;
V_133 = abs ( V_126 / ( 1 << ( 24 - F_62 ( V_135 ) ) ) / V_130 - V_122 ) ;
V_131 = F_61 ( V_127 , V_122 ) ;
...
static unsigned int F_65 ( struct V_2 * V_3 , int V_122 )
{
unsigned long V_138 = V_3 -> V_50 -> V_55 ;
const struct V_139 * V_140 = V_3 -> V_140 ;
V_122 = F_66 ( int , V_138 , V_122 ) ;
...
static bool F_68 ( struct V_143 * V_50 ,
struct V_144 * V_52 ,
struct V_79 * V_145 )
{
...
if ( ! F_53 ( V_3 ) )
F_73 ( & V_149 -> V_52 -> V_101 , L_10 ,
V_50 -> V_55
/ ( 1 + ( ( V_157 & F_74 ( 0xfff ) ) >> 8 ) ) ,
V_160 ? L_11 : L_12 ) ;
else
F_73 ( & V_149 -> V_52 -> V_101 , L_10 ,
V_50 -> V_55 / 2
/ ( 1 + ( ( V_157 & F_74 ( 0x0ff ) ) >> 8 ) ) ,
V_160 ? L_11 : L_12 ) ;
if ( F_2 ( V_3 ) ) {
...
static int F_75 ( struct V_143 * V_50 ,
struct V_77 * V_78 )
{
struct V_2 * V_3 = F_76 ( V_50 ) ;
V_78 -> V_93 = V_180 ;
...
static int F_77 ( struct V_143 * V_50 )
{
struct V_2 * V_3 = F_76 ( V_50 ) ;
F_27 ( V_3 , V_99 ,
F_7 ( V_3 , V_99 ) & ~ V_32 ) ;
...
static int F_78 ( struct V_144 * V_52 , struct V_57 * V_58 ,
struct V_181 * V_182 )
{
struct V_2 * V_3 = F_76 ( V_52 -> V_50 ) ;
int V_159 = 0 ;
if ( V_58 == NULL )
return 0 ;
if ( V_3 -> V_183 ) {
...
if ( V_185 ) {
V_58 -> V_62 = F_79 ( V_185 ) ;
V_58 -> V_63 = V_52 -> V_186 & V_187 ;
F_80 ( V_185 , V_58 -> V_63 ) ;
}
return 0 ;
}
if ( V_182 == NULL )
...
V_58 -> V_63 = V_52 -> V_186 & V_187 ;
V_159 = F_83 ( V_58 -> V_62 ,
! V_58 -> V_63 ) ;
}
return V_159 ;
}
static int F_84 ( struct V_144 * V_52 )
{
struct V_181 * V_182 ;
struct V_57 * V_58 ;
const struct V_1 * V_38 ;
...
V_58 = F_26 ( V_52 ) ;
if ( ! V_58 ) {
V_58 = F_85 ( sizeof( struct V_57 ) , V_197 ) ;
if ( ! V_58 )
return - V_198 ;
if ( V_3 -> V_5 == V_13 ) {
if ( V_52 -> V_53 > 4 ) {
...
V_58 -> V_176 = F_87 ( V_190 ) ;
V_58 -> V_178 = F_88 ( V_188 )
| F_89 ( V_189 ) ;
if ( V_58 -> V_44 ) {
if ( F_70 ( V_58 , V_52 ,
V_52 -> V_169 ,
...
if ( V_3 -> V_5 == V_13 )
return 0 ;
return F_78 ( V_52 , V_58 , V_182 ) ;
}
static void F_95 ( struct V_144 * V_52 )
{
struct V_57 * V_58 = F_26 ( V_52 ) ;
struct V_2 * V_3 = F_76 ( V_52 -> V_50 ) ;
if ( ! V_58 )
...
static int F_96 ( struct V_213 * V_214 )
{
unsigned int V_215 ;
int V_216 = - 1 ;
if ( V_214 && V_214 -> V_217 . V_218 &&
! F_97 ( V_214 -> V_217 . V_218 , 0 , & V_215 ) )
V_216 = V_215 ;
return V_216 ;
}
static int F_96 ( struct V_213 * V_214 )
...
static bool F_98 ( struct V_219 * V_220 , void * V_221 )
{
...
int type ;
V_214 = F_100 ( & V_100 -> V_101 ) ;
if ( F_101 ( V_100 -> V_101 . V_223 ) )
V_232 = F_102 ( V_233 ,
F_103 ( V_100 -> V_101 . V_223 ) ) ;
else if ( V_214 )
V_230 = F_104 ( V_100 -> V_101 . V_234 -> V_235 ,
& V_100 -> V_101 ) ;
else
return NULL ;
if ( V_230 )
...
return NULL ;
V_226 = F_105 ( & V_100 -> V_101 , sizeof( * V_226 ) , V_197 ) ;
if ( ! V_226 )
return NULL ;
V_228 = F_106 ( V_100 , V_236 , 0 ) ;
if ( ! V_228 )
return NULL ;
V_140 = & V_226 -> V_140 ;
V_140 -> V_237 = V_228 -> V_238 ;
V_140 -> V_239 = F_107 ( & V_100 -> V_101 , V_228 ) ;
if ( F_108 ( V_140 -> V_239 ) )
return NULL ;
if ( V_232 ) {
...
V_140 -> V_243 = F_109 ( & V_100 -> V_101 , NULL ) ;
V_140 -> V_116 = F_110 ( V_100 , 0 ) ;
V_140 -> type = type ;
V_140 -> V_100 = V_100 ;
V_140 -> V_216 = F_96 ( V_214 ) ;
V_226 -> V_244 = 1 ;
V_226 -> V_44 = true ;
return V_226 ;
}
...
static int F_111 ( struct V_143 * V_50 , unsigned V_48 )
{
struct V_2 * V_3 = F_76 ( V_50 ) ;
if ( F_112 ( & V_3 -> V_100 -> V_101 ) ) {
switch ( V_3 -> V_5 ) {
case V_7 :
case V_8 :
return V_48 - 1 ;
...
static int F_113 ( struct V_225 * V_100 )
{
...
V_140 = F_115 ( V_100 -> V_249 , V_100 -> V_250 ) ;
if ( ! V_140 )
V_140 = & V_245 -> V_140 ;
if ( ! V_140 -> V_239 ) {
...
V_50 = F_116 ( V_101 , sizeof( struct V_2 ) ) ;
if ( ! V_50 ) {
...
switch ( V_3 -> V_5 ) {
case V_11 :
V_50 -> V_264 = F_118 ( 4 , 32 ) ;
break;
default:
V_50 -> V_264 = F_118 ( 4 , 16 ) ;
break;
}
...
V_118 = F_119 ( V_140 -> V_116 , F_58 , V_268 , F_120 ( V_101 ) ,
V_3 ) ;
if ( V_118 < 0 ) {
...
V_247 &= V_272 ;
V_247 >>= V_273 ;
V_245 -> V_244 = F_124 ( V_247 ) ;
} else if ( V_38 -> V_274 ) {
V_245 -> V_244 = V_38 -> V_274 ;
}
}
V_50 -> V_244 = V_245 -> V_244 ;
V_246 = F_125 ( & V_100 -> V_101 , L_22 ) ;
if ( V_246 > 0 ) {
int V_275 ;
V_50 -> V_244 = F_126 ( int , V_246 ,
V_50 -> V_244 ) ;
V_3 -> V_183 = F_127 ( & V_100 -> V_101 ,
...
struct V_184 * V_185 ;
V_185 = F_128 ( V_101 , L_22 , V_275 ,
V_277 ) ;
if ( F_108 ( V_185 ) ) {
if ( F_129 ( V_185 ) == - V_278 )
continue;
V_118 = ( int ) F_129 ( V_185 ) ;
goto V_276;
} else {
...
F_130 ( & V_3 -> V_102 , V_102 ,
( unsigned long ) V_3 ) ;
F_131 ( & V_100 -> V_101 , 50 ) ;
F_132 ( & V_100 -> V_101 ) ;
F_133 ( & V_100 -> V_101 ) ;
F_134 ( & V_100 -> V_101 ) ;
F_135 ( V_100 , V_3 ) ;
V_118 = F_136 ( & V_100 -> V_101 , V_50 ) ;
if ( V_118 != 0 ) {
...
F_137 ( V_140 -> V_243 ) ;
F_138 ( V_3 ) ;
F_139 ( V_140 -> V_116 , V_3 ) ;
V_269:
F_140 ( V_50 ) ;
F_117 ( V_140 ) ;
return V_118 ;
}
static int F_141 ( struct V_225 * V_100 )
{
struct V_2 * V_3 = F_142 ( V_100 ) ;
struct V_139 * V_140 ;
if ( ! V_3 )
return 0 ;
V_140 = V_3 -> V_140 ;
...
static void F_146 ( struct V_225 * V_100 )
{
int V_118 = 0 ;
if ( ( V_118 = F_141 ( V_100 ) ) != 0 )
F_54 ( & V_100 -> V_101 , L_24 , V_118 ) ;
}
static int F_147 ( struct V_222 * V_101 )
{
struct V_2 * V_3 = F_148 ( V_101 ) ;
struct V_139 * V_140 = V_3 -> V_140 ;
int V_118 ;
V_118 = F_149 ( V_3 -> V_50 ) ;
if ( V_118 != 0 )
return V_118 ;
F_27 ( V_3 , V_99 , 0 ) ;
if ( ! F_59 ( V_101 ) )
...
static int F_150 ( struct V_222 * V_101 )
{
struct V_2 * V_3 = F_148 ( V_101 ) ;
struct V_139 * V_140 = V_3 -> V_140 ;
int V_118 ;
...
static int F_152 ( struct V_222 * V_101 )
{
struct V_2 * V_3 = F_148 ( V_101 ) ;
F_137 ( V_3 -> V_140 -> V_243 ) ;
return 0 ;
}
static int F_153 ( struct V_222 * V_101 )
{
struct V_2 * V_3 = F_148 ( V_101 ) ;
F_122 ( V_3 -> V_140 -> V_243 ) ;
return 0 ;
}
