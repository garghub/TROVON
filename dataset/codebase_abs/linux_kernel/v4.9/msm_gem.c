...
unsigned long V_118 =
V_114 & V_119 ? 0 : F_93 ( V_115 ) ;
long V_17 ;
V_17 = F_94 ( V_4 -> V_104 , V_116 ,
true , V_118 ) ;
if ( V_17 == 0 )
return V_118 == 0 ? - V_60 : - V_120 ;
else if ( V_17 < 0 )
return V_17 ;
return 0 ;
}
...
static void F_96 ( struct V_103 * V_103 , const char * type ,
struct V_121 * V_122 )
{
if ( ! F_97 ( V_103 ) )
F_98 ( V_122 , L_6 , type ,
V_103 -> V_123 -> V_124 ( V_103 ) ,
V_103 -> V_123 -> V_125 ( V_103 ) ,
V_103 -> V_126 ) ;
}
void F_99 ( struct V_1 * V_2 , struct V_121 * V_122 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_127 * V_128 = V_4 -> V_104 ;
struct V_101 * V_102 ;
struct V_103 * V_103 ;
T_3 V_129 = F_100 ( & V_2 -> V_63 ) ;
const char * V_92 ;
F_44 ( ! F_45 ( & V_2 -> V_7 -> V_33 ) ) ;
switch ( V_4 -> V_92 ) {
case V_93 :
...
F_98 ( V_122 , L_10 ,
V_4 -> V_27 , F_101 ( V_4 ) ? 'A' : 'I' ,
V_2 -> V_131 , V_2 -> V_132 . V_132 . V_133 ,
V_129 , V_4 -> V_88 , V_2 -> V_25 , V_92 ) ;
F_102 () ;
V_102 = F_103 ( V_128 -> V_103 ) ;
if ( V_102 ) {
unsigned int V_18 , V_105 = V_102 -> V_105 ;
for ( V_18 = 0 ; V_18 < V_105 ; V_18 ++ ) {
V_103 = F_103 ( V_102 -> V_107 [ V_18 ] ) ;
F_96 ( V_103 , L_11 , V_122 ) ;
}
}
V_103 = F_103 ( V_128 -> V_134 ) ;
if ( V_103 )
F_96 ( V_103 , L_12 , V_122 ) ;
F_104 () ;
}
void F_105 ( struct V_135 * V_136 , struct V_121 * V_122 )
{
struct V_3 * V_4 ;
int V_137 = 0 ;
T_6 V_25 = 0 ;
F_106 (msm_obj, list, mm_list) {
struct V_1 * V_2 = & V_4 -> V_138 ;
F_98 ( V_122 , L_13 ) ;
F_99 ( V_2 , V_122 ) ;
V_137 ++ ;
V_25 += V_2 -> V_25 ;
}
F_98 ( V_122 , L_14 , V_137 , V_25 ) ;
}
...
if ( V_17 )
return V_17 ;
V_2 = F_113 ( V_7 , V_25 , V_27 ) ;
F_26 ( & V_7 -> V_33 ) ;
if ( F_12 ( V_2 ) )
return F_14 ( V_2 ) ;
V_17 = F_114 ( V_43 , V_2 , V_85 ) ;
F_62 ( V_2 ) ;
return V_17 ;
}
static int F_115 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_27 ,
struct V_127 * V_104 ,
struct V_1 * * V_2 )
{
...
if ( ! F_52 ( & V_73 ) )
V_142 = true ;
else if ( ( V_27 & V_145 ) && V_6 -> V_12 . V_25 )
V_142 = true ;
if ( F_44 ( V_142 && ! V_6 -> V_12 . V_25 ) )
return - V_74 ;
V_141 = sizeof( * V_4 ) ;
if ( V_142 )
V_141 += sizeof( struct V_146 ) ;
V_4 = F_116 ( V_141 , V_147 ) ;
if ( ! V_4 )
return - V_19 ;
if ( V_142 )
V_4 -> V_9 = ( void * ) & V_4 [ 1 ] ;
...
struct V_1 * F_113 ( struct V_24 * V_7 ,
T_4 V_25 , T_4 V_27 )
{
struct V_1 * V_2 = NULL ;
int V_17 ;
F_44 ( ! F_45 ( & V_7 -> V_33 ) ) ;
V_25 = F_58 ( V_25 ) ;
V_17 = F_115 ( V_7 , V_25 , V_27 , NULL , & V_2 ) ;
if ( V_17 )
goto V_87;
if ( F_3 ( V_2 ) ) {
V_17 = F_119 ( V_7 , V_2 , V_25 ) ;
if ( V_17 )
goto V_87;
} else {
F_120 ( V_7 , V_2 , V_25 ) ;
...
struct V_1 * F_122 ( struct V_24 * V_7 ,
struct V_149 * V_139 , struct V_150 * V_26 )
{
struct V_3 * V_4 ;
struct V_1 * V_2 ;
T_4 V_25 ;
...
V_25 = F_58 ( V_139 -> V_25 ) ;
V_17 = F_115 ( V_7 , V_25 , V_28 , V_139 -> V_104 , & V_2 ) ;
if ( V_17 )
goto V_87;
F_120 ( V_7 , V_2 , V_25 ) ;
V_15 = V_25 / V_22 ;
...
V_17 = F_123 ( V_26 , V_4 -> V_23 , NULL , V_15 ) ;
if ( V_17 )
goto V_87;
return V_2 ;
V_87:
