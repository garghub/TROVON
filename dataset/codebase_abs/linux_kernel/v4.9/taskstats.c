...
static int F_61 ( struct V_4 * V_7 , struct V_1 * V_2 )
{
int V_24 = 0 ;
struct V_4 * V_78 ;
struct V_79 * V_39 ;
...
if ( ! V_66 )
return - V_14 ;
V_80 = F_62 ( V_2 -> V_82 [ V_83 ] ) ;
V_81 = F_63 ( V_80 ) ;
if ( ! V_81 . V_84 )
return 0 ;
V_6 = F_64 ( sizeof( struct V_79 ) ) ;
...
static int F_76 ( struct V_4 * V_7 , struct V_1 * V_2 )
{
if ( V_2 -> V_82 [ V_90 ] )
return F_68 ( V_2 ) ;
...
static struct V_38 * F_77 ( struct V_36 * V_37 )
{
struct V_98 * V_99 = V_37 -> signal ;
struct V_38 * V_39 ;
if ( V_99 -> V_39 || F_78 ( V_37 ) )
goto V_53;
V_39 = F_79 ( V_100 , V_9 ) ;
F_80 ( & V_37 -> V_51 -> V_52 ) ;
if ( ! V_99 -> V_39 ) {
...
void F_83 ( struct V_36 * V_37 , int V_101 )
{
int V_24 ;
struct V_17 * V_18 ;
struct V_38 * V_39 ;
...
{
unsigned int V_105 ;
V_100 = F_89 ( V_38 , V_106 ) ;
F_90 (i) {
F_91 ( & ( F_47 ( V_63 , V_105 ) . V_27 ) ) ;
F_92 ( & ( F_47 ( V_63 , V_105 ) . V_26 ) ) ;
}
}
static int T_6 F_93 ( void )
{
int V_24 ;
V_24 = F_94 ( & V_13 , V_107 ) ;
if ( V_24 )
return V_24 ;
V_103 = 1 ;
F_95 ( L_1 , V_108 ) ;
