...
static inline int
F_230 ( struct V_39 * V_40 , int V_464 )
{
int V_465 = 0 ;
switch ( V_464 ) {
case V_466 :
...
switch ( V_473 ) {
case V_460 :
V_465 = F_35 ( V_40 -> V_59 ) ;
switch ( V_465 ) {
case V_474 :
V_465 = F_37 ( V_40 -> V_59 ) ;
V_464 = V_465 & V_475 ;
V_465 = F_230 ( V_40 , V_464 ) ;
if ( ! V_9 -> V_476 &&
F_39 ( V_40 -> V_59 ) )
F_68 ( & V_9 -> V_477 ) ;
break;
...
static void F_232 ( struct V_8 * V_9 , T_1 V_487 )
{
if ( ( V_487 & V_383 ) && V_9 -> V_106 ) {
V_9 -> V_106 -> V_167 |=
F_33 ( V_9 ) ;
V_9 -> V_106 -> V_168 =
F_34 ( V_9 ) ;
...
if ( F_144 ( V_9 ) )
F_40 ( V_9 ) ;
V_490 = F_12 ( V_9 , V_132 ) ;
V_489 = V_490 ^ V_9 -> V_54 ;
F_233 ( V_9 , V_489 ) ;
}
...
int V_26 ;
T_1 V_381 = 0 ;
V_9 = F_51 ( V_81 , struct V_8 , V_477 ) ;
F_248 ( V_9 -> V_18 ) ;
...
int V_10 ;
bool V_517 = false ;
V_9 = F_51 ( V_81 , struct V_8 , V_518 ) ;
F_248 ( V_9 -> V_18 ) ;
F_63 ( V_9 , false ) ;
F_53 ( V_9 -> V_86 -> V_87 , V_82 ) ;
if ( V_9 -> V_102 == V_248 )
...
V_523:
if ( V_517 ) {
unsigned long V_525 = ( 1UL << V_9 -> V_11 ) - 1 ;
if ( V_9 -> V_54 == V_525 )
F_233 ( V_9 ,
( 1UL << ( V_9 -> V_11 - 1 ) ) ) ;
F_54 ( V_9 -> V_86 -> V_87 , V_82 ) ;
...
if ( ! V_517 ) {
V_9 -> V_102 = V_103 ;
if ( V_9 -> V_506 || V_9 -> V_511 )
F_257 ( V_9 -> V_18 , L_81 ,
V_19 , V_9 -> V_506 , V_9 -> V_511 ) ;
}
F_197 ( V_9 ) ;
V_48:
F_54 ( V_9 -> V_86 -> V_87 , V_82 ) ;
...
{
T_1 V_539 ;
V_539 = F_12 ( V_9 , V_540 ) ;
V_9 -> V_541 = V_539 ^ V_9 -> V_105 ;
F_158 ( & V_9 -> V_542 ) ;
}
static void F_260 ( struct V_8 * V_9 , T_1 V_487 )
{
V_9 -> V_538 = V_543 & V_487 ;
if ( V_9 -> V_538 )
F_259 ( V_9 ) ;
if ( V_487 & V_427 )
F_232 ( V_9 , V_487 ) ;
...
static T_7 V_15 ( int V_14 , void * V_546 )
{
T_1 V_487 , V_547 ;
T_7 V_548 = V_549 ;
struct V_8 * V_9 = V_546 ;
F_261 ( V_9 -> V_86 -> V_87 ) ;
V_487 = F_12 ( V_9 , V_550 ) ;
V_547 =
V_487 & F_12 ( V_9 , V_194 ) ;
if ( V_487 )
F_29 ( V_9 , V_487 , V_550 ) ;
if ( V_547 ) {
F_260 ( V_9 , V_547 ) ;
V_548 = V_551 ;
}
...
static int F_264 ( struct V_8 * V_9 , int V_553 , int V_554 ,
T_2 V_555 , T_2 * V_556 )
{
struct V_45 * V_46 ;
struct V_557 * V_558 ;
...
V_558 -> V_42 . V_61 =
F_130 ( 0 , V_555 , 0 , 0 ) ;
V_558 -> V_562 = F_131 ( V_553 ) ;
V_558 -> V_563 = F_131 ( V_554 ) ;
F_98 ( V_47 , & V_9 -> V_105 ) ;
F_157 () ;
F_29 ( V_9 , 1 << V_47 , V_540 ) ;
F_54 ( V_86 -> V_87 , V_82 ) ;
V_26 = F_265 ( V_9 -> V_542 ,
F_263 ( V_47 , & V_9 -> V_541 ) ,
F_11 ( V_564 ) ) ;
if ( ! V_26 ) {
F_6 ( V_9 -> V_18 , L_83 ,
V_19 , V_555 ) ;
...
V_26 = F_229 ( V_9 , V_47 , V_556 ) ;
}
F_267 ( V_47 , & V_9 -> V_541 ) ;
F_26 ( V_9 , V_47 ) ;
F_158 ( & V_9 -> V_559 ) ;
F_78 ( V_9 ) ;
return V_26 ;
...
V_10 = V_182 -> V_154 -> V_10 ;
V_40 = & V_9 -> V_255 [ V_10 ] ;
V_26 = F_264 ( V_9 , V_40 -> V_221 , 0 , V_565 , & V_260 ) ;
if ( V_26 || V_260 != V_566 ) {
if ( ! V_26 )
V_26 = V_260 ;
goto V_48;
...
V_40 = & V_9 -> V_255 [ V_10 ] ;
for ( V_569 = 100 ; V_569 ; V_569 -- ) {
V_26 = F_264 ( V_9 , V_40 -> V_221 , V_40 -> V_131 ,
V_570 , & V_260 ) ;
if ( ! V_26 && V_260 == V_571 ) {
break;
} else if ( ! V_26 && V_260 == V_566 ) {
V_21 = F_12 ( V_9 , V_132 ) ;
if ( V_21 & ( 1 << V_10 ) ) {
F_13 ( 100 , 200 ) ;
continue;
...
static T_1 F_273 ( int V_575 , T_1 V_576 , char * V_577 )
{
int V_184 ;
int V_578 ;
T_5 V_579 ;
T_5 V_580 ;
for ( V_184 = V_576 ; V_184 >= 0 ; V_184 -- ) {
V_579 = F_100 ( * ( ( T_5 * ) ( V_577 + 2 * V_184 ) ) ) ;
V_580 = ( V_579 & V_581 ) >>
V_582 ;
V_578 = V_579 & V_583 ;
switch ( V_580 ) {
...
{
T_1 V_588 = 0 ;
if ( ! V_9 -> V_589 . V_590 || ! V_9 -> V_589 . V_591 ||
! V_9 -> V_589 . V_592 ) {
F_6 ( V_9 -> V_18 ,
L_91 ,
V_19 , V_588 ) ;
...
if ( V_9 -> V_589 . V_590 )
V_588 = F_273 (
V_9 -> V_589 . V_590 -> V_593 ,
V_594 - 1 ,
& V_298 [ V_595 ] ) ;
if ( V_9 -> V_589 . V_591 )
V_588 = F_273 (
V_9 -> V_589 . V_591 -> V_593 ,
V_588 ,
& V_298 [ V_596 ] ) ;
if ( V_9 -> V_589 . V_592 )
V_588 = F_273 (
V_9 -> V_589 . V_592 -> V_593 ,
V_588 ,
& V_298 [ V_597 ] ) ;
V_48:
return V_588 ;
...
V_607 -> V_612 = V_298 [ V_613 ] << 8 |
V_298 [ V_613 + 1 ] ;
V_608 = V_298 [ V_614 ] ;
V_26 = F_174 ( V_9 , V_608 , V_609 ,
V_610 , V_615 ) ;
if ( V_26 ) {
F_6 ( V_9 -> V_18 , L_96 ,
V_19 , V_26 ) ;
...
V_609 [ V_610 ] = '\0' ;
F_284 ( V_607 -> V_616 , ( V_609 + V_321 ) ,
F_101 ( T_2 , V_609 [ V_312 ] ,
V_617 ) ) ;
V_607 -> V_616 [ V_617 ] = '\0' ;
V_48:
return V_26 ;
...
struct V_606 V_607 ;
V_607 . V_612 = 0 ;
V_26 = F_283 ( V_9 , & V_607 ) ;
if ( V_26 ) {
F_6 ( V_9 -> V_18 , L_97 ,
V_19 , V_26 ) ;
return;
}
for ( V_619 = V_620 ; V_619 -> V_621 ; V_619 ++ ) {
if ( ( ( V_619 -> V_622 . V_612 == V_607 . V_612 ) ||
( V_619 -> V_622 . V_612 == V_623 ) ) &&
( F_286 ( V_619 -> V_622 . V_616 , V_607 . V_616 ) ||
! strcmp ( V_619 -> V_622 . V_616 , V_624 ) ) )
V_9 -> V_519 |= V_619 -> V_621 ;
}
}
...
V_9 -> V_102 = V_103 ;
if ( ! F_65 ( V_9 ) && ! V_9 -> V_476 ) {
bool V_643 ;
memset ( & V_9 -> V_442 , 0 , sizeof( V_9 -> V_442 ) ) ;
if ( ! F_160 ( V_9 , V_288 ,
V_644 , & V_643 ) )
V_9 -> V_442 . V_443 = V_643 ;
if ( ! V_9 -> V_645 )
F_276 ( V_9 ) ;
if ( F_277 ( V_9 ) )
goto V_48;
...
F_61 ( V_9 -> V_92 ) ;
V_48:
if ( V_12 && ! F_65 ( V_9 ) && ! V_9 -> V_476 ) {
F_249 ( V_9 -> V_18 ) ;
F_295 ( V_9 ) ;
}
return V_12 ;
}
static void F_296 ( void * V_579 , T_8 V_646 )
{
struct V_8 * V_9 = (struct V_8 * ) V_579 ;
F_270 ( V_9 ) ;
}
static enum V_647 F_297 ( struct V_181 * V_648 )
{
unsigned long V_82 ;
struct V_247 * V_86 ;
struct V_8 * V_9 ;
int V_276 ;
bool V_649 = false ;
if ( ! V_648 || ! V_648 -> V_111 || ! V_648 -> V_111 -> V_86 )
return V_650 ;
V_86 = V_648 -> V_111 -> V_86 ;
V_9 = F_140 ( V_86 ) ;
if ( ! V_9 )
return V_650 ;
F_53 ( V_86 -> V_87 , V_82 ) ;
F_234 (index, &hba->outstanding_reqs, hba->nutrs) {
if ( V_9 -> V_255 [ V_276 ] . V_182 == V_648 ) {
V_649 = true ;
break;
}
}
...
static int F_298 ( struct V_111 * V_18 , struct V_652 * V_653 ,
int V_654 )
{
int V_12 ;
if ( ! V_653 )
return 0 ;
V_12 = F_299 ( V_653 -> V_21 , V_654 ) ;
if ( V_12 < 0 ) {
F_6 ( V_18 , L_100 ,
V_19 , V_653 -> V_122 , V_654 , V_12 ) ;
}
return V_12 ;
}
...
return F_298 ( V_9 -> V_18 , V_653 , V_653 -> V_593 ) ;
}
static int F_302 ( struct V_111 * V_18 ,
struct V_652 * V_653 , bool V_657 )
{
int V_12 = 0 ;
struct V_658 * V_21 = V_653 -> V_21 ;
const char * V_122 = V_653 -> V_122 ;
int V_659 , V_660 ;
F_162 ( ! V_653 ) ;
if ( F_303 ( V_21 ) > 0 ) {
V_659 = V_657 ? V_653 -> V_659 : 0 ;
V_12 = F_304 ( V_21 , V_659 , V_653 -> V_661 ) ;
if ( V_12 ) {
F_6 ( V_18 , L_101 ,
V_19 , V_122 , V_12 ) ;
goto V_48;
}
V_660 = V_657 ? V_653 -> V_593 : 0 ;
V_12 = F_298 ( V_18 , V_653 , V_660 ) ;
if ( V_12 )
goto V_48;
}
V_48:
...
static int F_305 ( struct V_111 * V_18 , struct V_652 * V_653 )
{
int V_12 = 0 ;
if ( ! V_653 )
goto V_48;
else if ( V_653 -> V_662 || V_653 -> V_655 )
goto V_48;
V_12 = F_302 ( V_18 , V_653 , true ) ;
if ( ! V_12 )
V_12 = F_306 ( V_653 -> V_21 ) ;
if ( ! V_12 )
V_653 -> V_662 = true ;
else
F_6 ( V_18 , L_102 ,
V_19 , V_653 -> V_122 , V_12 ) ;
V_48:
return V_12 ;
}
static int F_307 ( struct V_111 * V_18 , struct V_652 * V_653 )
{
int V_12 = 0 ;
if ( ! V_653 )
goto V_48;
...
goto V_48;
V_12 = F_308 ( V_653 -> V_21 ) ;
if ( ! V_12 ) {
F_302 ( V_18 , V_653 , false ) ;
V_653 -> V_662 = false ;
} else {
F_6 ( V_18 , L_103 ,
V_19 , V_653 -> V_122 , V_12 ) ;
...
static int F_309 ( struct V_8 * V_9 , bool V_657 )
{
int V_12 = 0 ;
struct V_111 * V_18 = V_9 -> V_18 ;
struct V_663 * V_400 = & V_9 -> V_589 ;
if ( ! V_400 )
goto V_48;
V_12 = F_310 ( V_18 , V_400 -> V_590 , V_657 ) ;
if ( V_12 )
goto V_48;
V_12 = F_310 ( V_18 , V_400 -> V_591 , V_657 ) ;
if ( V_12 )
goto V_48;
V_12 = F_310 ( V_18 , V_400 -> V_592 , V_657 ) ;
if ( V_12 )
goto V_48;
V_48:
if ( V_12 ) {
F_310 ( V_18 , V_400 -> V_592 , false ) ;
F_310 ( V_18 , V_400 -> V_591 , false ) ;
F_310 ( V_18 , V_400 -> V_590 , false ) ;
}
return V_12 ;
}
static int F_311 ( struct V_8 * V_9 , bool V_657 )
{
struct V_663 * V_400 = & V_9 -> V_589 ;
if ( V_400 )
return F_310 ( V_9 -> V_18 , V_400 -> V_664 , V_657 ) ;
return 0 ;
}
static int F_312 ( struct V_111 * V_18 , struct V_652 * V_653 )
{
int V_12 = 0 ;
if ( ! V_653 )
goto V_48;
V_653 -> V_21 = F_313 ( V_18 , V_653 -> V_122 ) ;
if ( F_279 ( V_653 -> V_21 ) ) {
V_12 = F_280 ( V_653 -> V_21 ) ;
F_6 ( V_18 , L_104 ,
V_19 , V_653 -> V_122 , V_12 ) ;
}
V_48:
...
struct V_663 * V_400 = & V_9 -> V_589 ;
if ( V_400 )
return F_312 ( V_9 -> V_18 , V_400 -> V_664 ) ;
return 0 ;
}
static int F_292 ( struct V_8 * V_9 , bool V_655 )
{
int V_12 = 0 ;
struct V_663 * V_400 = & V_9 -> V_589 ;
if ( ! V_400 )
...
goto V_48;
if ( V_655 ) {
V_12 = F_310 ( V_9 -> V_18 , V_400 -> V_591 , false ) ;
if ( ! V_12 )
V_400 -> V_591 -> V_655 = true ;
} else {
V_400 -> V_591 -> V_655 = false ;
}
V_48:
return V_12 ;
}
static int F_75 ( struct V_8 * V_9 , bool V_657 ,
bool V_665 )
{
int V_12 = 0 ;
struct V_666 * V_667 ;
struct V_668 * V_669 = & V_9 -> V_670 ;
unsigned long V_82 ;
if ( ! V_669 || F_316 ( V_669 ) )
goto V_48;
F_317 (clki, head, list) {
if ( ! F_318 ( V_667 -> V_671 ) ) {
if ( V_665 && ! strcmp ( V_667 -> V_122 , L_105 ) )
continue;
if ( V_657 && ! V_667 -> V_662 ) {
V_12 = F_319 ( V_667 -> V_671 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 , L_106 ,
V_19 , V_667 -> V_122 , V_12 ) ;
goto V_48;
}
} else if ( ! V_657 && V_667 -> V_662 ) {
F_320 ( V_667 -> V_671 ) ;
}
V_667 -> V_662 = V_657 ;
F_150 ( V_9 -> V_18 , L_107 , V_19 ,
V_667 -> V_122 , V_657 ? L_108 : L_109 ) ;
}
}
V_12 = F_321 ( V_9 , V_657 ) ;
V_48:
if ( V_12 ) {
F_317 (clki, head, list) {
if ( ! F_318 ( V_667 -> V_671 ) && V_667 -> V_662 )
F_320 ( V_667 -> V_671 ) ;
}
} else if ( V_657 ) {
F_53 ( V_9 -> V_86 -> V_87 , V_82 ) ;
...
static int F_55 ( struct V_8 * V_9 , bool V_657 )
{
return F_75 ( V_9 , V_657 , false ) ;
}
...
if ( ! V_667 -> V_122 )
continue;
V_667 -> V_671 = F_323 ( V_18 , V_667 -> V_122 ) ;
if ( F_279 ( V_667 -> V_671 ) ) {
V_12 = F_280 ( V_667 -> V_671 ) ;
F_6 ( V_18 , L_110 ,
V_19 , V_667 -> V_122 , V_12 ) ;
goto V_48;
}
if ( V_667 -> V_672 ) {
V_12 = F_324 ( V_667 -> V_671 , V_667 -> V_672 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 , L_111 ,
V_19 , V_667 -> V_122 ,
V_667 -> V_672 , V_12 ) ;
...
V_667 -> V_673 = V_667 -> V_672 ;
}
F_150 ( V_18 , L_112 , V_19 ,
V_667 -> V_122 , F_325 ( V_667 -> V_671 ) ) ;
}
V_48:
return V_12 ;
}
...
static int
F_333 ( struct V_8 * V_9 , struct V_435 * V_680 )
{
unsigned char V_182 [ 6 ] = { V_681 ,
0 ,
0 ,
0 ,
V_138 ,
...
char * V_682 ;
int V_12 ;
V_682 = F_334 ( V_138 , V_310 ) ;
if ( ! V_682 ) {
V_12 = - V_311 ;
goto V_48;
}
V_12 = F_335 ( V_680 , V_182 , V_203 , V_682 ,
V_138 , NULL ,
F_11 ( 1000 ) , 3 , NULL , V_683 ) ;
if ( V_12 )
...
V_9 -> V_86 -> V_688 = 1 ;
if ( V_9 -> V_642 ) {
V_12 = F_333 ( V_9 , V_680 ) ;
if ( V_12 )
goto V_48;
V_9 -> V_642 = false ;
}
V_182 [ 4 ] = V_407 << 4 ;
V_12 = F_335 ( V_680 , V_182 , V_237 , NULL , 0 , & V_686 ,
V_689 , 0 , NULL , V_683 ) ;
if ( V_12 ) {
F_339 ( V_690 , V_680 ,
L_114 ,
...
F_310 ( V_9 -> V_18 , V_9 -> V_589 . V_590 , false ) ;
if ( ! F_74 ( V_9 ) ) {
F_300 ( V_9 , V_9 -> V_589 . V_591 ) ;
F_300 ( V_9 , V_9 -> V_589 . V_592 ) ;
}
}
}
...
V_12 = F_310 ( V_9 -> V_18 , V_9 -> V_589 . V_590 , true ) ;
if ( ! V_12 && ! F_74 ( V_9 ) ) {
V_12 = F_301 ( V_9 , V_9 -> V_589 . V_591 ) ;
if ( V_12 )
goto V_698;
V_12 = F_301 ( V_9 , V_9 -> V_589 . V_592 ) ;
if ( V_12 )
goto V_699;
}
}
...
static int F_350 ( struct V_8 * V_9 , enum V_700 V_701 )
{
int V_12 = 0 ;
enum V_2 V_702 ;
enum V_1 V_703 ;
...
if ( ( V_703 != V_9 -> V_692 ) &&
( ( F_352 ( V_701 ) && ! V_9 -> V_493 ) ||
! F_352 ( V_701 ) ) ) {
F_240 ( V_9 ) ;
V_12 = F_336 ( V_9 , V_703 ) ;
if ( V_12 )
goto V_710;
}
V_12 = F_342 ( V_9 , V_693 , 1 ) ;
if ( V_12 )
goto V_711;
F_343 ( V_9 ) ;
V_709:
...
static int F_356 ( struct V_8 * V_9 , enum V_700 V_701 )
{
int V_12 ;
enum V_6 V_714 ;
V_9 -> V_476 = 1 ;
...
{
if ( ! V_9 || ! V_9 -> V_679 || F_358 ( V_9 -> V_18 ) )
return 0 ;
return F_356 ( V_9 , V_719 ) ;
}
int F_361 ( struct V_8 * V_9 )
{
if ( ! V_9 || ! V_9 -> V_679 )
return 0 ;
return F_350 ( V_9 , V_721 ) ;
}
...
int F_372 ( struct V_111 * V_18 , struct V_8 * * V_725 )
{
struct V_247 * V_86 ;
struct V_8 * V_9 ;
int V_26 = 0 ;
...
static int F_374 ( struct V_8 * V_9 , bool V_728 )
{
int V_12 = 0 ;
struct V_666 * V_667 ;
struct V_668 * V_669 = & V_9 -> V_670 ;
if ( ! V_669 || F_316 ( V_669 ) )
goto V_48;
V_12 = F_375 ( V_9 , V_728 , V_418 ) ;
if ( V_12 )
return V_12 ;
F_317 (clki, head, list) {
if ( ! F_318 ( V_667 -> V_671 ) ) {
if ( V_728 && V_667 -> V_672 ) {
if ( V_667 -> V_673 == V_667 -> V_672 )
continue;
V_12 = F_324 ( V_667 -> V_671 , V_667 -> V_672 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 , L_111 ,
...
V_667 -> V_673 = V_667 -> V_672 ;
} else if ( ! V_728 && V_667 -> V_729 ) {
if ( V_667 -> V_673 == V_667 -> V_729 )
continue;
V_12 = F_324 ( V_667 -> V_671 , V_667 -> V_729 ) ;
if ( V_12 ) {
F_6 ( V_9 -> V_18 , L_111 ,
V_19 , V_667 -> V_122 ,
V_667 -> V_729 , V_12 ) ;
...
V_667 -> V_673 = V_667 -> V_729 ;
}
}
F_150 ( V_9 -> V_18 , L_112 , V_19 ,
V_667 -> V_122 , F_325 ( V_667 -> V_671 ) ) ;
}
V_12 = F_375 ( V_9 , V_728 , V_415 ) ;
V_48:
return V_12 ;
}
static int F_376 ( struct V_111 * V_18 ,
unsigned long * V_730 , T_1 V_82 )
{
int V_26 = 0 ;
struct V_8 * V_9 = F_80 ( V_18 ) ;
if ( ! F_60 ( V_9 ) )
...
V_129 -> V_130 += F_94 ( F_95 ( F_92 () ,
V_129 -> V_127 ) ) ;
V_733 -> V_735 = F_378 ( ( long ) V_28 -
( long ) V_129 -> V_109 ) ;
V_733 -> V_736 = V_129 -> V_130 ;
V_734:
V_129 -> V_109 = V_28 ;
V_129 -> V_130 = 0 ;
if ( V_9 -> V_54 ) {
...
int F_379 ( struct V_8 * V_9 , void T_9 * V_737 , unsigned int V_14 )
{
int V_26 ;
...
V_86 -> V_743 = V_744 ;
V_86 -> V_745 = V_746 ;
V_86 -> V_747 = V_86 -> V_748 ;
V_86 -> V_749 = V_227 ;
V_9 -> V_399 . V_401 = false ;
F_380 ( & V_9 -> V_542 ) ;
F_380 ( & V_9 -> V_559 ) ;
F_85 ( & V_9 -> V_518 , F_253 ) ;
F_85 ( & V_9 -> V_477 , F_247 ) ;
F_381 ( & V_9 -> V_176 ) ;
F_381 ( & V_9 -> V_141 . V_283 ) ;
F_380 ( & V_9 -> V_141 . V_271 ) ;
F_83 ( V_9 ) ;
F_29 ( V_9 , F_12 ( V_9 , V_550 ) ,
V_550 ) ;
F_29 ( V_9 , 0 , V_194 ) ;
F_382 () ;
