...
int F_166 ( int V_182 , int V_229 , bool V_230 )
{
int V_115 , V_231 = V_228 ;
bool V_232 = F_167 ( V_208 ,
V_233 ) ;
if ( V_234 != V_168 &&
V_234 != F_124 () &&
V_234 == V_182 ) {
...
F_107 ( V_240 , V_115 ) = V_182 ;
F_107 ( V_241 , V_115 ) = V_182 ;
#endif
#ifdef V_2
F_107 ( V_167 , V_115 ) =
V_12 -> V_242 ( V_115 ) ;
...
if ( F_179 ( V_115 , V_249 ) )
break;
}
if ( F_180 ( V_115 < V_228 ) ) {
* V_182 = F_82 ( V_240 , V_115 ) ;
return 0 ;
}
return - V_57 ;
}
...
V_257 . V_261 = F_11 ( V_246 ) ;
V_257 . V_262 = F_11 ( V_244 ) ;
...
F_25 ( V_244 , V_257 . V_262 ) ;
F_25 ( V_246 , V_257 . V_261 ) ;
...
if ( ! V_1 )
return - V_57 ;
if ( ! strncmp ( L_99 , V_1 , 3 ) )
V_153 = V_176 ;
else if ( ! strncmp ( L_100 , V_1 , 4 ) )
V_153 = V_154 ;
else if ( ! strncmp ( L_101 , V_1 , 3 ) )
V_153 = V_287 ;
else {
F_216 ( L_102 , V_1 ) ;
return - V_57 ;
