...
F_58 ( L_12 ,
V_74 , V_32 -> V_75 , V_107 -> V_109 ) ;
if ( ! F_86 ( V_131 ) && V_131 -> V_149 -> V_150 ) {
struct V_134 V_135 = {
. V_136 = V_137 ,
. V_138 = V_131 -> V_139 ,
. V_140 = (struct V_78 * ) & V_107 -> V_104 ,
...
void F_95 ( struct V_125 * V_126 , struct V_72 * V_32 ,
struct V_159 * V_160 , unsigned int V_127 ,
unsigned int V_128 , T_4 V_161 ,
T_4 V_148 , T_3 V_129 )
{
if ( F_96 ( V_121 , & V_32 -> V_120 ) == 0 ) {
int V_162 = 0 ;
if ( V_161 == 3 ) {
V_162 = F_84 ( V_126 , V_32 , V_127 ,
V_128 , V_129 ) ;
} else if ( V_161 == 4 ) {
V_162 = F_90 ( V_126 , V_32 , V_127 ,
V_128 , V_148 ,
V_129 ) ;
} else {
F_58 ( L_14 , V_74 ,
...
struct V_98 *
F_98 ( struct V_138 * V_138 , struct V_164 * V_165 , T_1 V_112 )
{
...
goto V_117;
V_169 = F_101 ( V_115 ++ ) ;
V_115 = F_99 ( V_165 , V_169 ) ;
if ( F_100 ( ! V_115 ) )
goto V_117;
V_171 = F_102 ( V_169 + 1 , V_112 ) ;
if ( F_100 ( ! V_171 ) )
goto V_117;
V_171 [ V_169 ] = '\0' ;
memcpy ( V_171 , V_115 , V_169 ) ;
V_115 = F_99 ( V_165 , 4 ) ;
if ( F_100 ( ! V_115 ) )
goto V_176;
V_170 = F_101 ( V_115 ) ;
V_115 = F_99 ( V_165 , V_170 ) ;
if ( F_100 ( ! V_115 ) )
goto V_176;
...
V_166 = F_102 ( V_170 + 1 , V_112 ) ;
if ( ! V_166 ) {
F_58 ( L_17 , V_74 ) ;
goto V_176;
}
V_166 [ V_170 ] = '\0' ;
memcpy ( V_166 , V_115 , V_170 ) ;
V_167 = strrchr ( V_166 , '.' ) ;
if ( ! V_167 ) {
F_58 ( L_18 ,
V_74 ) ;
...
goto V_179;
F_70 ( & V_107 -> V_108 ) ;
if ( ! F_103 ( V_138 , V_166 , V_167 - V_166 , (struct V_78 * ) & V_107 -> V_104 ,
sizeof( V_107 -> V_104 ) ) ) {
F_58 ( L_21 , V_74 , V_166 ) ;
goto V_180;
}
V_167 ++ ;
sscanf ( V_167 , L_22 , & V_43 [ 0 ] , & V_43 [ 1 ] ) ;
V_168 = F_104 ( ( V_43 [ 0 ] << 8 ) | ( V_43 [ 1 ] ) ) ;
switch ( V_107 -> V_104 . V_181 ) {
case V_87 :
( (struct V_81 * ) & V_107 -> V_104 ) -> V_90 = V_168 ;
V_107 -> V_142 = sizeof( struct V_81 ) ;
V_172 = L_23 ;
V_173 = 3 ;
break;
case V_91 :
( (struct V_83 * ) & V_107 -> V_104 ) -> V_95 = V_168 ;
...
V_114 = strlen ( V_174 ) + strlen ( V_166 ) + strlen ( V_175 ) + 7 ;
V_107 -> V_109 = F_68 ( V_114 , V_112 ) ;
if ( V_107 -> V_109 )
snprintf ( V_107 -> V_109 , V_114 , L_29 , V_174 ,
V_166 , V_175 , F_105 ( V_168 ) ) ;
...
F_42 ( V_56 [ V_182 ] . V_38 != NULL ) ;
V_56 [ V_182 ] . V_38 = F_25 ( V_23 ) ;
}
F_108 ( V_29 , & V_24 -> V_30 ) ;
V_26 -> V_32 -> V_33 ++ ;
F_109 ( V_24 , V_62 , V_26 ) ;
F_29 ( & V_26 -> V_46 -> V_47 ) ;
F_110 ( V_24 -> V_184 , V_26 ) ;
}
int
F_111 ( struct V_46 * V_46 , bool V_185 )
{
int V_44 ;
if ( ! F_112 ( V_46 ) )
return 0 ;
V_44 = F_113 ( V_46 , V_186 ) ;
if ( V_44 < 0 )
return V_44 ;
if ( V_185 )
return 0 ;
return F_114 ( V_46 , true ) ;
}
