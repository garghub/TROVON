...
void F_20 ( struct V_1 * V_2 , T_1 V_19 )
{
unsigned long * V_38 = & V_2 -> V_4 . V_5 ;
unsigned long * V_39 = & V_2 -> V_4 . V_40 ;
unsigned int V_3 ;
if ( ! ( * V_38 ) && ! ( * V_39 ) )
return;
V_3 = F_21 ( * V_39 ) ;
while ( V_3 <= V_41 ) {
if ( V_42 -> V_43 ( V_2 , V_3 , V_19 ) ) {
if ( ! V_44 )
break;
}
V_3 = F_22 ( V_39 ,
