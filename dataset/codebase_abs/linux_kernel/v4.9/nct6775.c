...
F_8 ( V_234 -> V_200 ) ;
F_41 ( V_19 , V_53 ) ;
V_23 = F_23 ( V_19 , & V_403 ,
V_53 -> V_81 ) ;
if ( F_135 ( V_23 ) )
return F_136 ( V_23 ) ;
V_53 -> V_404 [ V_247 ++ ] = V_23 ;
...
return F_136 ( V_23 ) ;
V_53 -> V_404 [ V_247 ++ ] = V_23 ;
V_23 = F_23 ( V_19 , & V_407 ,
F_137 ( V_53 -> V_132 ) ) ;
if ( F_135 ( V_23 ) )
return F_136 ( V_23 ) ;
V_53 -> V_404 [ V_247 ++ ] = V_23 ;
V_53 -> V_404 [ V_247 ++ ] = & V_408 ;
V_246 = F_138 ( V_19 , V_53 -> V_41 ,
V_53 , V_53 -> V_404 ) ;
return F_139 ( V_246 ) ;
}
static void F_140 ( int V_409 )
{
int V_3 ;
V_3 = F_3 ( V_409 , V_410 ) ;
if ( V_3 & 0x10 ) {
...
if ( V_53 -> V_54 == V_56 ) {
V_53 -> V_411 = F_30 ( V_53 , V_70 ) ;
V_53 -> V_412 = F_30 ( V_53 , V_72 ) ;
}
F_52 ( & V_53 -> V_115 ) ;
return 0 ;
}
...
if ( V_53 -> V_54 == V_56 ) {
F_32 ( V_53 , V_70 , V_53 -> V_411 ) ;
F_32 ( V_53 , V_72 , V_53 -> V_412 ) ;
}
abort:
V_53 -> V_119 = false ;
F_52 ( & V_53 -> V_115 ) ;
...
static int T_8 F_144 ( int V_409 , struct V_233 * V_234 )
{
T_2 V_3 ;
int V_151 ;
int V_64 ;
...
struct V_235 V_67 ;
struct V_233 V_234 ;
int V_409 [ 2 ] = { 0x2e , 0x4e } ;
V_151 = F_149 ( & V_428 ) ;
if ( V_151 )
return V_151 ;
for ( V_34 = 0 ; V_34 < F_40 ( V_232 ) ; V_34 ++ ) {
V_427 = F_144 ( V_409 [ V_34 ] , & V_234 ) ;
if ( V_427 <= 0 )
continue;
V_426 = true ;
V_232 [ V_34 ] = F_150 ( V_6 , V_427 ) ;
if ( ! V_232 [ V_34 ] ) {
V_151 = - V_39 ;
goto V_429;
}
...
V_67 . V_41 = V_6 ;
V_67 . V_249 = V_427 + V_431 ;
V_67 . V_432 = V_427 + V_431 + V_250 - 1 ;
V_67 . V_433 = V_248 ;
V_151 = F_152 ( & V_67 ) ;
if ( V_151 ) {
F_153 ( V_232 [ V_34 ] ) ;
