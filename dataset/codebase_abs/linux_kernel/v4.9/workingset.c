...
F_28 () ;
if ( V_33 -> V_19 ) {
V_36 = F_29 ( V_33 -> V_19 , V_33 -> V_14 ,
V_38 ) ;
} else {
V_36 = F_30 ( F_3 ( V_33 -> V_14 ) , V_39 ) +
F_30 ( F_3 ( V_33 -> V_14 ) , V_40 ) ;
}
V_35 = V_36 >> ( 1 + V_41 - 3 ) ;
if ( V_34 <= V_35 )
return 0 ;
...
static enum V_42 F_31 ( struct V_43 * V_44 ,
struct V_45 * V_46 ,
T_2 * V_47 ,
void * V_48 )
{
...
unsigned int V_51 ;
int V_52 ;
V_50 = F_32 ( V_44 , struct V_49 , V_53 ) ;
V_16 = V_50 -> V_54 ;
if ( ! F_33 ( & V_16 -> V_55 ) ) {
F_34 ( V_47 ) ;
V_52 = V_56 ;
...
F_36 ( F_37 ( V_50 ) ) ;
F_21 ( F_6 ( F_41 ( V_50 ) ) , V_60 ) ;
if ( ! F_42 ( & V_16 -> V_61 , V_50 ) )
F_43 () ;
F_34 ( & V_16 -> V_55 ) ;
V_52 = V_62 ;
V_30:
...
static unsigned long F_46 ( struct V_31 * V_31 ,
struct V_32 * V_33 )
{
unsigned long V_52 ;
F_26 () ;
