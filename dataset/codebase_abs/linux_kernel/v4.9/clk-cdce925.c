...
struct V_79 * V_89 ;
char V_90 [ 6 ] ;
F_40 ( & V_76 -> V_50 , L_9 , V_14 ) ;
V_7 = F_49 ( & V_76 -> V_50 , sizeof( * V_7 ) , V_91 ) ;
if ( ! V_7 )
return - V_92 ;
V_7 -> V_51 = V_76 ;
V_7 -> V_28 = F_50 ( & V_76 -> V_50 , & V_93 ,
& V_76 -> V_50 , & V_94 ) ;
if ( F_51 ( V_7 -> V_28 ) ) {
F_52 ( & V_76 -> V_50 , L_10 ) ;
...
F_40 ( & V_76 -> V_50 , L_12 , V_82 ) ;
if ( F_56 ( V_80 , L_13 , & V_87 ) == 0 )
F_18 ( V_7 -> V_28 ,
V_96 , ( V_87 << 3 ) & 0xF8 ) ;
F_15 ( V_7 -> V_28 , V_97 , F_16 ( 4 ) , 0 ) ;
...
V_83 [ V_26 ] = F_57 ( V_91 , L_14 ,
V_76 -> V_50 . V_81 -> V_102 , V_26 ) ;
V_86 . V_102 = V_83 [ V_26 ] ;
V_7 -> V_22 [ V_26 ] . V_27 = V_7 ;
V_7 -> V_22 [ V_26 ] . V_5 . V_86 = & V_86 ;
V_7 -> V_22 [ V_26 ] . V_24 = V_26 ;
V_88 = F_58 ( & V_76 -> V_50 , & V_7 -> V_22 [ V_26 ] . V_5 ) ;
if ( V_88 ) {
F_52 ( & V_76 -> V_50 , L_15 , V_26 ) ;
goto error;
}
sprintf ( V_90 , L_16 , V_26 + 1 ) ;
V_89 = F_59 ( V_80 , V_90 ) ;
if ( ! V_89 )
continue;
if ( ! F_56 ( V_89 ,
...
V_86 . V_101 = 1 ;
V_86 . V_100 = & V_82 ;
V_86 . V_102 = F_57 ( V_91 , L_21 , V_76 -> V_50 . V_81 -> V_102 ) ;
V_7 -> V_18 [ 0 ] . V_27 = V_7 ;
...
V_86 . V_65 = V_106 ;
V_86 . V_101 = 1 ;
for ( V_26 = 1 ; V_26 < V_107 ; ++ V_26 ) {
V_86 . V_102 = F_57 ( V_91 , L_23 ,
V_76 -> V_50 . V_81 -> V_102 , V_26 + 1 ) ;
