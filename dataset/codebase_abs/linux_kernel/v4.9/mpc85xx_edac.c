...
static T_3 F_31 ( struct V_71
* V_72 , char * V_73 )
{
struct V_74 * V_4 = V_72 -> V_5 ;
return sprintf ( V_73 , L_26 ,
F_2 ( V_4 -> V_75 + V_76 ) ) ;
}
static T_3 F_32 ( struct V_71
* V_72 , char * V_73 )
{
struct V_74 * V_4 = V_72 -> V_5 ;
return sprintf ( V_73 , L_26 ,
...
if ( V_6 & V_89 )
F_40 ( V_72 , 0 , 0 , V_72 -> V_17 ) ;
if ( V_6 & V_90 )
F_41 ( V_72 , 0 , 0 , V_72 -> V_17 ) ;
}
static T_2 F_42 ( int V_30 , void * V_31 )
{
...
struct V_40 V_41 ;
int V_42 ;
if ( ! F_13 ( & V_36 -> V_43 , F_43 , V_44 ) )
return - V_45 ;
V_72 = F_44 ( sizeof( * V_4 ) ,
L_34 , 1 , L_35 , 1 , 2 , NULL , 0 ,
V_91 ) ;
if ( ! V_72 ) {
F_30 ( & V_36 -> V_43 , F_43 ) ;
return - V_45 ;
...
{
struct V_71 * V_72 = F_49 ( & V_36 -> V_43 ) ;
struct V_74 * V_4 = V_72 -> V_5 ;
F_22 ( 0 , L_44 ) ;
if ( V_46 == V_48 ) {
F_3 ( V_4 -> V_75 + V_96 , 0 ) ;
