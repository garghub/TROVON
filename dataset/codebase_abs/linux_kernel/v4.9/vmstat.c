...
F_5 () ;
F_2 (cpu)
F_152 ( F_153 ( V_2 ) , V_152 ) ;
F_6 () ;
}
static void F_154 ( int V_63 )
{
int V_2 ;
F_5 () ;
F_2 (cpu)
...
static int F_156 ( struct V_154 * V_155 ,
unsigned long V_156 ,
void * V_157 )
{
long V_2 = ( long ) V_157 ;
...
#endif
#ifdef F_162
F_163 ( L_40 , V_168 , NULL , & V_169 ) ;
F_163 ( L_41 , V_168 , NULL , & V_170 ) ;
F_163 ( L_39 , V_168 , NULL , & V_171 ) ;
F_163 ( L_42 , V_168 , NULL , & V_172 ) ;
#endif
return 0 ;
}
...
for ( V_69 = 0 ; V_69 < V_73 ; ++ V_69 ) {
F_74 ( V_10 , V_69 , & V_68 ) ;
V_173 = F_164 ( V_69 , & V_68 ) ;
F_89 ( V_79 , L_43 , V_173 / 1000 , V_173 % 1000 ) ;
}
F_90 ( V_79 , '\n' ) ;
}
...
if ( ! F_107 ( V_17 -> V_83 , V_99 ) )
return 0 ;
F_83 ( V_79 , V_17 , F_165 ) ;
return 0 ;
}
static int F_167 ( struct V_101 * V_101 , struct V_102 * V_102 )
{
return F_109 ( V_102 , & V_174 ) ;
}
...
{
return F_109 ( V_102 , & V_175 ) ;
}
static int T_7 F_171 ( void )
{
struct V_176 * V_177 ;
V_177 = F_172 ( L_44 , NULL ) ;
if ( ! V_177 )
return - V_121 ;
if ( ! F_173 ( L_45 , 0444 ,
V_177 , NULL , & V_178 ) )
