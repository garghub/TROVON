...
{
if ( V_5 == 0 ) {
V_2 -> V_23 -> V_187 ( V_186 ,
F_45 ( V_2 , V_185 , V_4 ) ) ;
return V_186 ;
}
return F_46 ( V_2 , V_185 , V_4 ) ;
}
int
F_114 (
struct V_1 * V_2 ,
...
V_4 = NULL ;
V_185 = 0 ;
V_2 -> V_23 -> V_190 ( V_2 , & V_52 ) ;
V_183 = & V_52 ;
for ( V_5 = V_2 -> V_67 - 1 , V_188 = 1 ; V_5 >= 0 ; V_5 -- ) {
...
V_186 = F_113 ( V_2 , V_5 ,
V_185 , V_4 , & V_162 ) ;
V_188 = V_2 -> V_23 -> V_195 ( V_2 , V_186 ) ;
if ( V_188 < 0 )
V_192 = V_185 + 1 ;
else if ( V_188 > 0 )
V_191 = V_185 - 1 ;
...
} else if ( V_163 == V_193 && V_188 > 0 )
V_185 -- ;
V_2 -> V_79 [ 0 ] = V_185 ;
if ( V_185 == 0 || V_185 > F_110 ( V_4 ) )
* V_175 = 0 ;
else if ( V_163 != V_197 || V_188 == 0 )
* V_175 = 1 ;
else
* V_175 = 0 ;
F_96 ( V_2 , V_167 ) ;
...
V_2 -> V_23 -> V_187 ( V_162 , V_164 ) ;
if ( V_2 -> V_46 & V_198 ) {
V_2 -> V_23 -> V_201 ( & V_199 , V_164 ) ;
for ( V_91 = 2 ; V_91 <= F_110 ( V_4 ) ; V_91 ++ ) {
V_164 = F_45 ( V_2 , V_91 , V_4 ) ;
V_2 -> V_23 -> V_201 ( & V_200 , V_164 ) ;
if ( V_2 -> V_23 -> V_202 ( V_2 , & V_200 , & V_199 )
> 0 )
V_199 = V_200 ;
}
V_191 = F_115 ( V_2 , V_162 ) ;
memcpy ( V_191 , & V_199 , V_2 -> V_23 -> V_93 / 2 ) ;
}
}
STATIC void
F_117 (
...
V_2 -> V_23 -> V_93 / 2 ) ;
V_199 = F_47 ( V_2 , 1 , V_4 ) ;
for ( V_91 = 2 ; V_91 <= F_110 ( V_4 ) ; V_91 ++ ) {
V_200 = F_47 ( V_2 , V_91 , V_4 ) ;
if ( V_2 -> V_23 -> V_202 ( V_2 , V_200 , V_199 ) > 0 )
V_199 = V_200 ;
}
V_191 = F_115 ( V_2 , V_162 ) ;
memcpy ( V_191 , V_199 , V_2 -> V_23 -> V_93 / 2 ) ;
...
#endif
V_52 = V_2 -> V_79 [ V_5 ] ;
V_206 = F_46 ( V_2 , V_52 , V_4 ) ;
V_207 = F_47 ( V_2 , V_52 , V_4 ) ;
if ( ! V_204 &&
! ( V_2 -> V_23 -> V_202 ( V_2 , V_206 , V_205 ) != 0 ||
V_2 -> V_23 -> V_202 ( V_2 , V_207 , V_200 ) != 0 ) )
break;
F_89 ( V_2 , V_206 , V_205 , 1 ) ;
...
#endif
V_52 = V_2 -> V_79 [ V_5 ] ;
V_186 = F_46 ( V_2 , V_52 , V_4 ) ;
F_89 ( V_2 , V_186 , & V_162 , 1 ) ;
F_95 ( V_2 , V_7 , V_52 , V_52 ) ;
}
F_96 ( V_2 , V_167 ) ;
return 0 ;
...
#endif
V_52 = V_2 -> V_79 [ 0 ] ;
V_209 = F_45 ( V_2 , V_52 , V_4 ) ;
F_90 ( V_2 , V_209 , V_164 , 1 ) ;
F_102 ( V_2 , V_7 , V_52 , V_52 ) ;
if ( F_82 ( V_2 , V_4 , 0 ) ) {
V_2 -> V_23 -> V_210 ( V_2 , V_4 , V_164 ,
V_52 , V_211 ) ;
}
if ( F_119 ( V_2 , V_52 ) ) {
error = F_123 ( V_2 , 0 ) ;
...
int V_216 ;
union V_51 V_217 ;
union V_95 * V_218 = NULL ;
union V_51 * V_219 = NULL ;
union V_94 * V_220 = NULL ;
int error ;
int V_66 ;
F_96 ( V_2 , V_165 ) ;
F_108 ( V_2 , V_5 ) ;
...
V_5 == V_2 -> V_67 - 1 )
goto V_178;
V_123 = F_52 ( V_2 , V_5 , & V_214 ) ;
#ifdef F_109
error = F_17 ( V_2 , V_123 , V_5 , V_214 ) ;
if ( error )
goto V_176;
#endif
F_75 ( V_2 , V_123 , & V_217 , V_127 ) ;
if ( F_73 ( V_2 , & V_217 ) )
goto V_178;
if ( V_2 -> V_79 [ V_5 ] <= 1 )
goto V_178;
error = F_88 ( V_2 , & V_217 , 0 , & V_122 , & V_212 ) ;
if ( error )
goto V_176;
V_213 = F_110 ( V_122 ) ;
if ( V_213 == V_2 -> V_23 -> V_24 ( V_2 , V_5 ) )
goto V_178;
V_216 = F_110 ( V_123 ) ;
V_213 ++ ;
V_216 -- ;
...
union V_95 * V_223 ;
union V_51 * V_224 ;
V_223 = F_46 ( V_2 , V_213 , V_122 ) ;
V_218 = F_46 ( V_2 , 1 , V_123 ) ;
V_224 = F_48 ( V_2 , V_213 , V_122 ) ;
V_219 = F_48 ( V_2 , 1 , V_123 ) ;
#ifdef F_109
error = F_21 ( V_2 , V_219 , 0 , V_5 ) ;
if ( error )
goto V_176;
#endif
F_89 ( V_2 , V_223 , V_218 , 1 ) ;
F_91 ( V_2 , V_224 , V_219 , 1 ) ;
F_95 ( V_2 , V_212 , V_213 , V_213 ) ;
F_103 ( V_2 , V_212 , V_213 , V_213 ) ;
ASSERT ( V_2 -> V_23 -> V_225 ( V_2 ,
F_46 ( V_2 , V_213 - 1 , V_122 ) , V_223 ) ) ;
} else {
union V_94 * V_226 ;
V_226 = F_45 ( V_2 , V_213 , V_122 ) ;
V_220 = F_45 ( V_2 , 1 , V_123 ) ;
F_90 ( V_2 , V_226 , V_220 , 1 ) ;
F_102 ( V_2 , V_212 , V_213 , V_213 ) ;
ASSERT ( V_2 -> V_23 -> V_227 ( V_2 ,
F_45 ( V_2 , V_213 - 1 , V_122 ) , V_226 ) ) ;
}
F_129 ( V_122 , V_213 ) ;
F_104 ( V_2 , V_212 , V_228 ) ;
F_129 ( V_123 , V_216 ) ;
F_104 ( V_2 , V_214 , V_228 ) ;
F_128 ( V_2 , V_222 , V_216 - 1 ) ;
if ( V_5 > 0 ) {
#ifdef F_109
int V_66 ;
for ( V_66 = 0 ; V_66 < V_216 ; V_66 ++ ) {
error = F_21 ( V_2 , V_219 , V_66 + 1 , V_5 ) ;
if ( error )
goto V_176;
}
#endif
...
F_48 ( V_2 , 2 , V_123 ) ,
- 1 , V_216 ) ;
F_95 ( V_2 , V_214 , 1 , V_216 ) ;
F_103 ( V_2 , V_214 , 1 , V_216 ) ;
} else {
F_93 ( V_2 ,
F_45 ( V_2 , 2 , V_123 ) ,
- 1 , V_216 ) ;
F_102 ( V_2 , V_214 , 1 , V_216 ) ;
}
if ( V_2 -> V_46 & V_198 ) {
error = F_36 ( V_2 , & V_215 ) ;
if ( error )
goto V_176;
V_66 = F_59 ( V_215 , V_5 ) ;
F_130 ( V_215 -> V_11 , V_66 == 1 , V_176 ) ;
error = F_111 ( V_215 , V_5 , & V_66 ) ;
if ( error )
goto V_229;
error = F_123 ( V_215 , V_5 ) ;
if ( error )
goto V_229;
F_33 ( V_215 , V_230 ) ;
}
...
( V_5 == V_2 -> V_67 - 1 ) )
goto V_178;
V_122 = F_52 ( V_2 , V_5 , & V_212 ) ;
#ifdef F_109
error = F_17 ( V_2 , V_122 , V_5 , V_212 ) ;
if ( error )
goto V_176;
#endif
F_75 ( V_2 , V_122 , & V_232 , V_128 ) ;
if ( F_73 ( V_2 , & V_232 ) )
goto V_178;
V_213 = F_110 ( V_122 ) ;
if ( V_2 -> V_79 [ V_5 ] >= V_213 )
goto V_178;
error = F_88 ( V_2 , & V_232 , 0 , & V_123 , & V_214 ) ;
if ( error )
goto V_176;
V_216 = F_110 ( V_123 ) ;
if ( V_216 == V_2 -> V_23 -> V_24 ( V_2 , V_5 ) )
goto V_178;
F_32 ( V_2 , V_233 ) ;
F_128 ( V_2 , V_222 , V_216 ) ;
if ( V_5 > 0 ) {
union V_95 * V_223 ;
union V_51 * V_224 ;
union V_51 * V_219 ;
...
V_219 = F_48 ( V_2 , 1 , V_123 ) ;
#ifdef F_109
for ( V_66 = V_216 - 1 ; V_66 >= 0 ; V_66 -- ) {
error = F_21 ( V_2 , V_219 , V_66 , V_5 ) ;
if ( error )
goto V_176;
}
#endif
F_92 ( V_2 , V_218 , 1 , V_216 ) ;
F_94 ( V_2 , V_219 , 1 , V_216 ) ;
#ifdef F_109
error = F_21 ( V_2 , V_224 , 0 , V_5 ) ;
if ( error )
goto V_176;
#endif
F_89 ( V_2 , V_218 , V_223 , 1 ) ;
F_91 ( V_2 , V_219 , V_224 , 1 ) ;
F_95 ( V_2 , V_214 , 1 , V_216 + 1 ) ;
F_103 ( V_2 , V_214 , 1 , V_216 + 1 ) ;
ASSERT ( V_2 -> V_23 -> V_225 ( V_2 , V_218 ,
F_46 ( V_2 , 2 , V_123 ) ) ) ;
} else {
union V_94 * V_226 ;
union V_94 * V_220 ;
V_226 = F_45 ( V_2 , V_213 , V_122 ) ;
V_220 = F_45 ( V_2 , 1 , V_123 ) ;
F_93 ( V_2 , V_220 , 1 , V_216 ) ;
F_90 ( V_2 , V_220 , V_226 , 1 ) ;
F_102 ( V_2 , V_214 , 1 , V_216 + 1 ) ;
}
F_129 ( V_122 , -- V_213 ) ;
F_104 ( V_2 , V_212 , V_228 ) ;
F_129 ( V_123 , ++ V_216 ) ;
...
goto V_176;
#endif
F_83 ( V_2 , V_212 , & V_217 ) ;
error = V_2 -> V_23 -> V_240 ( V_2 , & V_217 , & V_232 , V_175 ) ;
if ( error )
goto V_176;
if ( * V_175 == 0 )
goto V_178;
F_32 ( V_2 , V_241 ) ;
error = F_87 ( V_2 , & V_232 , 0 , & V_123 , & V_214 ) ;
if ( error )
goto V_176;
F_81 ( V_2 , V_214 , F_49 ( V_122 ) , 0 ) ;
V_213 = F_110 ( V_122 ) ;
V_216 = V_213 / 2 ;
if ( ( V_213 & 1 ) && V_2 -> V_79 [ V_5 ] <= V_216 + 1 )
V_216 ++ ;
V_238 = ( V_213 - V_216 + 1 ) ;
F_128 ( V_2 , V_222 , V_216 ) ;
V_213 -= V_216 ;
F_129 ( V_122 , V_213 ) ;
F_129 ( V_123 , F_110 ( V_123 ) + V_216 ) ;
if ( V_5 > 0 ) {
union V_95 * V_223 ;
union V_51 * V_224 ;
union V_95 * V_218 ;
union V_51 * V_219 ;
V_223 = F_46 ( V_2 , V_238 , V_122 ) ;
V_224 = F_48 ( V_2 , V_238 , V_122 ) ;
V_218 = F_46 ( V_2 , 1 , V_123 ) ;
V_219 = F_48 ( V_2 , 1 , V_123 ) ;
#ifdef F_109
for ( V_66 = V_238 ; V_66 < V_216 ; V_66 ++ ) {
error = F_21 ( V_2 , V_224 , V_66 , V_5 ) ;
if ( error )
goto V_176;
}
#endif
F_89 ( V_2 , V_218 , V_223 , V_216 ) ;
F_91 ( V_2 , V_219 , V_224 , V_216 ) ;
F_95 ( V_2 , V_214 , 1 , V_216 ) ;
F_103 ( V_2 , V_214 , 1 , V_216 ) ;
...
union V_94 * V_226 ;
union V_94 * V_220 ;
V_226 = F_45 ( V_2 , V_238 , V_122 ) ;
V_220 = F_45 ( V_2 , 1 , V_123 ) ;
F_90 ( V_2 , V_220 , V_226 , V_216 ) ;
F_102 ( V_2 , V_214 , 1 , V_216 ) ;
F_116 ( V_2 , V_123 , V_162 ) ;
}
F_75 ( V_2 , V_122 , & V_235 , V_128 ) ;
F_76 ( V_2 , V_123 , & V_235 , V_128 ) ;
F_76 ( V_2 , V_123 , & V_217 , V_127 ) ;
F_76 ( V_2 , V_122 , & V_232 , V_128 ) ;
F_104 ( V_2 , V_214 , V_171 ) ;
F_104 ( V_2 , V_212 , V_228 | V_128 ) ;
if ( ! F_73 ( V_2 , & V_235 ) ) {
error = F_88 ( V_2 , & V_235 ,
0 , & V_237 , & V_236 ) ;
if ( error )
goto V_176;
F_76 ( V_2 , V_237 , & V_232 , V_127 ) ;
F_104 ( V_2 , V_236 , V_127 ) ;
}
if ( V_2 -> V_46 & V_198 ) {
error = F_123 ( V_2 , V_5 ) ;
if ( error )
...
if ( V_2 -> V_79 [ V_5 ] > V_213 + 1 ) {
F_72 ( V_2 , V_5 , V_214 ) ;
V_2 -> V_79 [ V_5 ] -= V_213 ;
}
if ( V_5 + 1 < V_2 -> V_67 ) {
error = F_36 ( V_2 , V_234 ) ;
if ( error )
goto V_176;
( * V_234 ) -> V_79 [ V_5 + 1 ] ++ ;
}
...
F_136 ( & V_245 , V_246 ) ;
args -> V_252 = F_132 ( args -> V_2 , args -> V_5 , args -> V_180 ,
args -> V_162 , args -> V_234 , args -> V_175 ) ;
F_137 ( args -> V_253 ) ;
F_138 ( & V_245 , V_246 ) ;
}
STATIC int
...
F_140 ( V_253 ) ;
if ( V_2 -> V_69 != V_70 )
return F_132 ( V_2 , V_5 , V_180 , V_162 , V_234 , V_175 ) ;
args . V_2 = V_2 ;
args . V_5 = V_5 ;
args . V_180 = V_180 ;
args . V_162 = V_162 ;
...
args . V_253 = & V_253 ;
args . V_248 = F_141 () ;
F_142 ( & args . V_243 , F_134 ) ;
F_143 ( V_254 , & args . V_243 ) ;
F_144 ( & V_253 ) ;
F_145 ( & args . V_243 ) ;
return args . V_252 ;
}
...
error = V_2 -> V_23 -> V_240 ( V_2 , V_183 , & V_260 , V_175 ) ;
if ( error )
goto V_176;
if ( * V_175 == 0 ) {
F_96 ( V_2 , V_167 ) ;
...
F_32 ( V_2 , V_241 ) ;
error = F_87 ( V_2 , & V_260 , 0 , & V_257 , & V_256 ) ;
if ( error )
goto V_176;
memcpy ( V_257 , V_4 , F_39 ( V_2 ) ) ;
if ( V_2 -> V_46 & V_84 ) {
if ( V_2 -> V_46 & V_47 )
V_257 -> V_13 . V_14 . V_17 = F_4 ( V_256 -> V_18 ) ;
else
V_257 -> V_13 . V_42 . V_17 = F_4 ( V_256 -> V_18 ) ;
}
F_147 ( & V_4 -> V_21 , 1 ) ;
F_129 ( V_4 , 1 ) ;
V_2 -> V_67 ++ ;
V_2 -> V_79 [ V_5 + 1 ] = 1 ;
V_186 = F_46 ( V_2 , 1 , V_4 ) ;
V_258 = F_46 ( V_2 , 1 , V_257 ) ;
F_89 ( V_2 , V_258 , V_186 , F_110 ( V_257 ) ) ;
V_259 = F_48 ( V_2 , 1 , V_257 ) ;
#ifdef F_109
for ( V_66 = 0 ; V_66 < F_7 ( V_257 -> V_22 ) ; V_66 ++ ) {
error = F_21 ( V_2 , V_183 , V_66 , V_5 ) ;
if ( error )
goto V_176;
}
#endif
F_91 ( V_2 , V_259 , V_183 , F_110 ( V_257 ) ) ;
#ifdef F_109
error = F_21 ( V_2 , & V_260 , 0 , V_5 ) ;
if ( error )
goto V_176;
#endif
F_91 ( V_2 , V_183 , & V_260 , 1 ) ;
F_148 ( V_2 -> V_39 . V_71 . V_98 ,
1 - F_110 ( V_257 ) ,
V_2 -> V_39 . V_71 . V_99 ) ;
F_72 ( V_2 , V_5 , V_256 ) ;
F_104 ( V_2 , V_256 , V_171 ) ;
F_95 ( V_2 , V_256 , 1 , F_7 ( V_257 -> V_22 ) ) ;
F_103 ( V_2 , V_256 , 1 , F_7 ( V_257 -> V_22 ) ) ;
* V_255 |=
V_262 | F_101 ( V_2 -> V_39 . V_71 . V_99 ) ;
* V_175 = 1 ;
F_96 ( V_2 , V_167 ) ;
return 0 ;
V_176:
...
F_96 ( V_2 , V_165 ) ;
F_32 ( V_2 , V_261 ) ;
V_2 -> V_23 -> V_190 ( V_2 , & V_232 ) ;
error = V_2 -> V_23 -> V_240 ( V_2 , & V_232 , & V_217 , V_175 ) ;
if ( error )
goto V_176;
if ( * V_175 == 0 )
goto V_178;
F_32 ( V_2 , V_241 ) ;
error = F_87 ( V_2 , & V_217 , 0 , & V_75 , & V_263 ) ;
if ( error )
goto V_176;
V_2 -> V_23 -> V_264 ( V_2 , & V_217 , 1 ) ;
...
F_81 ( V_2 , V_263 , V_2 -> V_67 , 2 ) ;
F_104 ( V_2 , V_263 , V_171 ) ;
ASSERT ( ! F_73 ( V_2 , & V_217 ) &&
! F_73 ( V_2 , & V_232 ) ) ;
if ( F_49 ( V_122 ) > 0 ) {
F_117 ( V_2 , V_122 ,
F_46 ( V_2 , 1 , V_75 ) ) ;
...
F_95 ( V_2 , V_263 , 1 , 2 ) ;
F_91 ( V_2 ,
F_48 ( V_2 , 1 , V_75 ) , & V_217 , 1 ) ;
F_91 ( V_2 ,
F_48 ( V_2 , 2 , V_75 ) , & V_232 , 1 ) ;
F_103 ( V_2 , V_263 , 1 , 2 ) ;
F_72 ( V_2 , V_2 -> V_67 , V_263 ) ;
V_2 -> V_79 [ V_2 -> V_67 ] = V_260 ;
V_2 -> V_67 ++ ;
F_96 ( V_2 , V_167 ) ;
* V_175 = 1 ;
return 0 ;
...
if ( ( V_2 -> V_46 & V_102 ) &&
V_5 == V_2 -> V_67 - 1 ) {
struct V_266 * V_98 = V_2 -> V_39 . V_71 . V_98 ;
if ( V_132 < V_2 -> V_23 -> V_267 ( V_2 , V_5 ) ) {
F_148 ( V_98 , 1 , V_2 -> V_39 . V_71 . V_99 ) ;
* V_175 = 1 ;
} else {
int V_255 = 0 ;
error = F_146 ( V_2 , & V_255 , V_175 ) ;
if ( error || * V_175 == 0 )
return error ;
F_100 ( V_2 -> V_65 , V_98 , V_255 ) ;
}
return 0 ;
}
...
return error ;
if ( * V_175 ) {
* V_265 = * V_53 = V_2 -> V_79 [ V_5 ] ;
return 0 ;
}
error = F_139 ( V_2 , V_5 , V_260 , V_162 , V_74 , V_175 ) ;
if ( error || * V_175 == 0 )
return error ;
* V_53 = V_2 -> V_79 [ V_5 ] ;
return 0 ;
...
if ( V_52 <= V_132 ) {
if ( V_5 == 0 ) {
ASSERT ( V_2 -> V_23 -> V_227 ( V_2 , V_164 ,
F_45 ( V_2 , V_52 , V_4 ) ) ) ;
} else {
ASSERT ( V_2 -> V_23 -> V_225 ( V_2 , V_162 ,
F_46 ( V_2 , V_52 , V_4 ) ) ) ;
}
}
#endif
...
& V_269 , & V_52 , & V_260 , & V_74 , V_205 , V_175 ) ;
if ( error || * V_175 == 0 )
goto V_176;
}
V_4 = F_52 ( V_2 , V_5 , & V_7 ) ;
...
#ifdef F_109
if ( V_52 < V_132 ) {
ASSERT ( V_2 -> V_23 -> V_225 ( V_2 , V_186 ,
F_46 ( V_2 , V_52 + 1 , V_4 ) ) ) ;
}
#endif
} else {
union V_94 * V_209 ;
V_209 = F_45 ( V_2 , V_52 , V_4 ) ;
F_93 ( V_2 , V_209 , 1 , V_132 - V_52 + 1 ) ;
F_90 ( V_2 , V_209 , V_164 , 1 ) ;
F_129 ( V_4 , ++ V_132 ) ;
F_102 ( V_2 , V_7 , V_52 , V_132 ) ;
#ifdef F_109
if ( V_52 < V_132 ) {
ASSERT ( V_2 -> V_23 -> V_227 ( V_2 , V_209 ,
F_45 ( V_2 , V_52 + 1 , V_4 ) ) ) ;
}
#endif
}
F_104 ( V_2 , V_7 , V_228 ) ;
if ( V_7 && V_7 -> V_18 != V_270 ) {
F_118 ( V_2 , V_4 , V_205 ) ;
} else if ( F_119 ( V_2 , V_269 ) ) {
error = F_123 ( V_2 , V_5 ) ;
if ( error )
goto V_176;
}
...
V_162 = & V_274 ;
F_74 ( V_2 , & V_260 ) ;
V_2 -> V_23 -> V_275 ( V_2 , & V_164 ) ;
V_2 -> V_23 -> V_187 ( V_162 , & V_164 ) ;
do {
error = F_151 ( V_273 , V_5 , & V_260 , & V_164 , V_162 ,
& V_74 , & V_66 ) ;
if ( error ) {
if ( V_273 != V_2 )
F_33 ( V_273 , V_231 ) ;
...
F_147 ( & V_4 -> V_22 , V_53 ) ;
ASSERT ( V_4 -> V_22 == V_257 -> V_22 ) ;
V_186 = F_46 ( V_2 , 1 , V_4 ) ;
V_258 = F_46 ( V_2 , 1 , V_257 ) ;
F_89 ( V_2 , V_186 , V_258 , V_132 ) ;
V_183 = F_48 ( V_2 , 1 , V_4 ) ;
V_259 = F_48 ( V_2 , 1 , V_257 ) ;
#ifdef F_109
for ( V_66 = 0 ; V_66 < V_132 ; V_66 ++ ) {
error = F_21 ( V_2 , V_259 , V_66 , V_5 - 1 ) ;
if ( error ) {
F_96 ( V_2 , V_181 ) ;
return error ;
}
...
#endif
F_91 ( V_2 , V_183 , V_259 , V_132 ) ;
error = F_30 ( V_2 , V_256 ) ;
if ( error ) {
F_96 ( V_2 , V_181 ) ;
return error ;
}
...
F_32 ( V_2 , V_279 ) ;
F_128 ( V_2 , V_222 , V_132 - V_52 ) ;
if ( V_5 > 0 ) {
union V_95 * V_223 ;
union V_51 * V_224 ;
V_223 = F_46 ( V_2 , V_52 + 1 , V_4 ) ;
V_224 = F_48 ( V_2 , V_52 + 1 , V_4 ) ;
#ifdef F_109
...
#endif
if ( V_52 < V_132 ) {
F_92 ( V_2 , V_223 , - 1 , V_132 - V_52 ) ;
F_94 ( V_2 , V_224 , - 1 , V_132 - V_52 ) ;
...
if ( V_132 >= V_2 -> V_23 -> V_281 ( V_2 , V_5 ) ) {
error = F_156 ( V_2 , V_5 , V_175 ) ;
if ( error )
goto V_176;
return 0 ;
...
V_66 = F_60 ( V_215 , V_5 ) ;
F_130 ( V_2 -> V_11 , V_66 == 1 , V_176 ) ;
V_123 = F_52 ( V_215 , V_5 , & V_214 ) ;
#ifdef F_109
error = F_17 ( V_215 , V_123 , V_5 , V_214 ) ;
if ( error )
goto V_176;
#endif
F_75 ( V_215 , V_123 , & V_278 , V_127 ) ;
if ( F_110 ( V_123 ) - 1 >=
V_2 -> V_23 -> V_281 ( V_215 , V_5 ) ) {
error = F_127 ( V_215 , V_5 , & V_66 ) ;
if ( error )
goto V_176;
if ( V_66 ) {
ASSERT ( F_110 ( V_4 ) >=
...
V_66 = F_59 ( V_215 , V_5 ) ;
F_130 ( V_2 -> V_11 , V_66 == 1 , V_176 ) ;
V_122 = F_52 ( V_215 , V_5 , & V_212 ) ;
#ifdef F_109
error = F_17 ( V_2 , V_122 , V_5 , V_212 ) ;
if ( error )
goto V_176;
#endif
F_75 ( V_215 , V_122 , & V_278 , V_128 ) ;
if ( F_110 ( V_122 ) - 1 >=
V_2 -> V_23 -> V_281 ( V_215 , V_5 ) ) {
error = F_131 ( V_215 , V_5 , & V_66 ) ;
if ( error )
goto V_176;
if ( V_66 ) {
ASSERT ( F_110 ( V_4 ) >=
...
union V_95 * V_218 ;
union V_51 * V_219 ;
V_223 = F_46 ( V_2 , V_213 + 1 , V_122 ) ;
V_224 = F_48 ( V_2 , V_213 + 1 , V_122 ) ;
V_218 = F_46 ( V_2 , 1 , V_123 ) ;
V_219 = F_48 ( V_2 , 1 , V_123 ) ;
#ifdef F_109
...
#endif
F_89 ( V_2 , V_223 , V_218 , V_216 ) ;
F_91 ( V_2 , V_224 , V_219 , V_216 ) ;
F_95 ( V_2 , V_212 , V_213 + 1 , V_213 + V_216 ) ;
F_103 ( V_2 , V_212 , V_213 + 1 , V_213 + V_216 ) ;
} else {
union V_94 * V_226 ;
union V_94 * V_220 ;
V_226 = F_45 ( V_2 , V_213 + 1 , V_122 ) ;
V_220 = F_45 ( V_2 , 1 , V_123 ) ;
F_90 ( V_2 , V_226 , V_220 , V_216 ) ;
F_102 ( V_2 , V_212 , V_213 + 1 , V_213 + V_216 ) ;
}
F_32 ( V_2 , V_282 ) ;
F_129 ( V_122 , V_213 + V_216 ) ;
F_75 ( V_2 , V_123 , & V_278 , V_128 ) ,
F_76 ( V_2 , V_122 , & V_278 , V_128 ) ;
F_104 ( V_2 , V_212 , V_228 | V_128 ) ;
F_75 ( V_2 , V_122 , & V_278 , V_128 ) ;
if ( ! F_73 ( V_2 , & V_278 ) ) {
error = F_88 ( V_2 , & V_278 , 0 , & V_237 , & V_236 ) ;
if ( error )
goto V_176;
F_76 ( V_2 , V_237 , & V_217 , V_127 ) ;
F_104 ( V_2 , V_236 , V_127 ) ;
}
error = F_30 ( V_2 , V_214 ) ;
if ( error )
goto V_176;
if ( V_7 != V_212 ) {
V_2 -> V_68 [ V_5 ] = V_212 ;
...
F_69 ( V_2 , V_5 , V_125 ) ;
V_4 = F_52 ( V_2 , V_5 , & V_7 ) ;
error = V_285 ( V_2 , V_5 , V_286 ) ;
if ( error )
return error ;
F_75 ( V_2 , V_4 , & V_232 , V_128 ) ;
if ( F_73 ( V_2 , & V_232 ) )
return - V_287 ;
return F_112 ( V_2 , V_5 , & V_232 , & V_4 ) ;
}
int
F_161 (
struct V_1 * V_2 ,
...
struct V_3 * V_4 = NULL ;
int error = 0 ;
V_2 -> V_23 -> V_190 ( V_2 , & V_217 ) ;
for ( V_5 = V_2 -> V_67 - 1 ; V_5 >= 0 ; V_5 -- ) {
error = F_112 ( V_2 , V_5 , & V_217 , & V_4 ) ;
if ( error )
return error ;
if ( V_5 > 0 ) {
union V_51 * V_52 ;
...
do {
error = F_160 ( V_2 , V_5 , V_285 , V_286 ) ;
} while ( ! error );
if ( error != - V_287 )
return error ;
}
...
void * V_286 )
{
struct V_288 * V_289 = V_286 ;
struct V_3 * V_4 ;
struct V_6 * V_7 ;
V_4 = F_52 ( V_2 , V_5 , & V_7 ) ;
if ( V_2 -> V_46 & V_47 )
V_4 -> V_13 . V_14 . V_135 = F_4 ( V_289 -> V_290 ) ;
else
V_4 -> V_13 . V_42 . V_135 = F_16 ( V_289 -> V_290 ) ;
if ( V_7 ) {
if ( V_2 -> V_65 ) {
F_163 ( V_2 -> V_65 , V_7 ) ;
F_104 ( V_2 , V_7 , V_291 ) ;
} else {
F_164 ( V_7 , V_289 -> V_292 ) ;
}
} else {
ASSERT ( V_2 -> V_46 & V_102 ) ;
...
return false ;
if ( V_295 && F_5 ( V_4 -> V_13 . V_42 . V_135 ) != V_295 -> V_297 )
return false ;
return true ;
}
bool
...
T_8 V_5 ;
unsigned long V_301 ;
V_301 = ( V_300 + V_299 [ 0 ] - 1 ) / V_299 [ 0 ] ;
for ( V_5 = 1 ; V_301 > 1 ; V_5 ++ )
V_301 = ( V_301 + V_299 [ 1 ] - 1 ) / V_299 [ 1 ] ;
return V_5 ;
}
STATIC int
F_169 (
...
bool V_306 = true ;
int error ;
ASSERT ( V_2 -> V_23 -> V_201 ) ;
ASSERT ( V_2 -> V_23 -> V_202 ) ;
V_175 = 0 ;
error = F_114 ( V_2 , V_193 , & V_175 ) ;
if ( error )
goto V_307;
if ( ! V_175 ) {
...
while ( V_175 ) {
error = F_159 ( V_2 , & V_284 , & V_175 ) ;
if ( error || ! V_175 )
break;
if ( V_306 ) {
V_2 -> V_23 -> V_201 ( & V_305 , V_284 ) ;
V_306 = false ;
V_188 = V_2 -> V_23 -> V_202 ( V_2 , V_302 ,
& V_305 ) ;
if ( V_188 > 0 )
goto V_308;
}
V_2 -> V_23 -> V_187 ( & V_305 , V_284 ) ;
V_188 = V_2 -> V_23 -> V_202 ( V_2 , & V_305 , V_303 ) ;
if ( V_188 > 0 )
break;
error = V_285 ( V_2 , V_284 , V_304 ) ;
if ( error < 0 || error == V_309 )
break;
V_308:
error = F_107 ( V_2 , 0 , & V_175 ) ;
if ( error )
...
if ( V_5 == 0 ) {
V_284 = F_45 ( V_2 , V_2 -> V_79 [ 0 ] , V_4 ) ;
V_2 -> V_23 -> V_201 ( & V_310 , V_284 ) ;
V_312 = V_2 -> V_23 -> V_202 ( V_2 , & V_310 ,
V_302 ) ;
V_2 -> V_23 -> V_187 ( & V_305 , V_284 ) ;
V_313 = V_2 -> V_23 -> V_202 ( V_2 , V_303 ,
& V_305 ) ;
if ( V_312 >= 0 && V_313 >= 0 ) {
error = V_285 ( V_2 , V_284 , V_304 ) ;
if ( error < 0 ||
...
V_223 = F_46 ( V_2 , V_2 -> V_79 [ V_5 ] , V_4 ) ;
V_311 = F_47 ( V_2 , V_2 -> V_79 [ V_5 ] , V_4 ) ;
V_183 = F_48 ( V_2 , V_2 -> V_79 [ V_5 ] , V_4 ) ;
V_312 = V_2 -> V_23 -> V_202 ( V_2 , V_311 , V_302 ) ;
V_313 = V_2 -> V_23 -> V_202 ( V_2 , V_303 , V_223 ) ;
if ( V_312 >= 0 && V_313 >= 0 ) {
V_5 -- ;
...
V_2 -> V_78 = * V_317 ;
V_2 -> V_23 -> V_275 ( V_2 , & V_164 ) ;
V_2 -> V_23 -> V_187 ( & V_303 , & V_164 ) ;
V_2 -> V_78 = * V_316 ;
V_2 -> V_23 -> V_275 ( V_2 , & V_164 ) ;
V_2 -> V_23 -> V_187 ( & V_302 , & V_164 ) ;
if ( V_2 -> V_23 -> V_202 ( V_2 , & V_302 , & V_303 ) > 0 )
return - V_318 ;
if ( ! ( V_2 -> V_46 & V_198 ) )
return F_169 ( V_2 , & V_302 ,
& V_303 , V_285 , V_304 ) ;
return F_170 ( V_2 , & V_302 , & V_303 ,
V_285 , V_304 ) ;
}
T_12
F_173 (
