...
static bool
F_32 ( bool (* F_33)( void * V_16 , enum V_58 V_26 ) ,
void * V_16 , enum V_58 V_26 )
{
if ( F_33 && F_33 ( V_16 , V_26 ) ) {
V_59 ++ ;
return true ;
}
return false ;
}
static void F_34 ( void * V_16 , int V_60 )
{
int V_61 ;
static int V_50 ;
if ( V_50 > 4 )
...
static void
F_37 ( void * V_16 , struct V_23 * V_24 , int V_60 )
{
enum V_58 V_26 ;
struct V_17 * V_38 ;
struct V_7 * V_19 ;
