...
int F_7 ( struct V_18 * V_19 , const struct V_20 * V_21 ,
...
V_2 -> V_9 -> V_14 ++ ;
F_14 ( V_36 , L_1 V_37 L_2 ,
F_15 ( V_23 ) , V_21 -> V_31 , V_21 -> V_30 ) ;
return 0 ;
}
void F_16 ( struct V_1 * V_2 , const struct V_20 * V_21 )
{
F_4 ( V_2 -> V_9 && V_2 -> V_35 ) ;
V_2 -> V_9 -> V_14 -- ;
V_2 -> V_9 -> V_12 -= V_2 -> V_33 ;
...
F_14 ( V_36 , L_3 ,
V_21 -> V_31 , V_21 -> V_30 ) ;
if ( ( char * ) V_2 -> V_35 >= ( ( char * ) V_2 -> V_9 +
V_2 -> V_9 -> V_12 ) )
V_2 -> V_35 = NULL ;
}
int F_17 ( struct V_1 * V_2 , const struct V_20 * V_21 ,
const struct V_22 * V_23 )
{
struct V_20 V_38 ;
struct V_22 V_24 ;
...
for ( V_39 = 0 ; V_39 < V_2 -> V_9 -> V_14 ; V_39 ++ ) {
F_10 ( V_2 -> V_35 , & V_2 -> V_33 ,
& V_38 , & V_24 ) ;
if ( V_38 . V_31 == V_21 -> V_31 &&
F_18 ( & V_24 , V_23 ) &&
( strncmp ( V_38 . V_30 , V_21 -> V_30 ,
V_38 . V_31 ) == 0 ) )
break;
V_2 -> V_35 = (struct V_18 * ) ( ( char * ) V_2 -> V_35 +
V_2 -> V_33 ) ;
}
if ( V_39 == V_2 -> V_9 -> V_14 ) {
F_14 ( V_36 , L_4 ,
V_21 -> V_31 , V_21 -> V_30 ) ;
V_2 -> V_35 = NULL ;
V_2 -> V_33 = 0 ;
