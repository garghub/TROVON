...
V_121 = F_7 ( V_16 -> V_67 , V_32 , & V_122 ) ;
if ( ! V_121 ) {
F_20 ( F_17 ( V_12 ) , L_27 ,
V_98 ) ;
return NULL ;
...
static struct V_65 *
F_89 ( struct V_11 * V_12 , struct V_124 * V_92 ,
...
V_54 = F_90 ( V_135 -> V_141 )
| F_91 ( V_135 -> V_142 ) ;
V_95 = V_104 ;
switch ( V_129 ) {
case V_140 :
V_138 = F_92 ( V_135 -> V_143 ) ;
V_54 |= F_78 ( V_138 ) ;
V_95 |= V_144
| V_105
| V_145
| F_93 ( V_7 -> V_146 ) | F_94 ( V_7 -> V_147 ) ;
V_137 = V_135 -> V_148 ;
F_86 (sgl, sg, sg_len, i) {
struct V_5 * V_14 ;
T_5 V_3 ;
...
break;
case V_151 :
V_138 = F_92 ( V_135 -> V_152 ) ;
V_54 |= F_77 ( V_138 ) ;
V_95 |= V_106
| V_119
| V_153
| F_93 ( V_7 -> V_147 ) | F_94 ( V_7 -> V_146 ) ;
V_137 = V_135 -> V_154 ;
F_86 (sgl, sg, sg_len, i) {
struct V_5 * V_14 ;
T_5 V_3 ;
...
static int
F_97 ( unsigned int V_138 , T_1 V_161 ,
T_2 V_162 )
{
if ( V_162 > ( V_56 << V_138 ) )
goto V_163;
...
static int
F_98 ( struct V_11 * V_12 , struct V_5 * V_14 ,
...
static struct V_65 *
F_99 ( struct V_11 * V_12 , T_1 V_161 , T_2 V_165 ,
...
F_104 ( & V_7 -> V_136 . V_141 ) ;
F_104 ( & V_7 -> V_136 . V_142 ) ;
return 0 ;
}
...
V_132 = V_12 -> V_133 ;
if ( V_132 ) {
F_116 ( ! V_132 -> V_181 || V_132 -> V_181 != V_16 -> V_82 . V_83 ) ;
if ( V_132 -> V_178 )
V_178 = V_132 -> V_178 ;
}
if ( ! F_54 ( & V_7 -> V_35 ) )
...
static bool F_120 ( struct V_11 * V_12 , void * V_185 )
{
...
static struct V_11 * F_121 ( struct V_186 * V_187 ,
struct V_188 * V_188 )
{
struct V_11 * V_12 ;
struct V_6 * V_7 ;
...
if ( V_187 -> V_192 != 2 )
return NULL ;
V_191 = F_122 ( V_187 -> V_193 ) ;
F_123 ( V_51 ) ;
F_124 ( V_194 , V_51 ) ;
V_132 = F_125 ( & V_191 -> V_83 , sizeof( * V_132 ) , V_183 ) ;
if ( ! V_132 )
return NULL ;
V_132 -> V_178 = V_195 | V_196 ;
V_189 = V_187 -> args [ 1 ] & V_197 ;
V_132 -> V_178 |= F_126 ( V_189 ) | F_127 ( V_189 )
| F_128 ( V_189 ) | F_129 ( V_189 ) ;
...
static inline const struct V_205 * T_9 F_131 (
struct V_190 * V_206 )
{
if ( V_206 -> V_83 . V_207 ) {
const struct V_208 * V_209 ;
V_209 = F_132 ( V_210 , V_206 -> V_83 . V_207 ) ;
if ( V_209 == NULL )
return NULL ;
return V_209 -> V_72 ;
}
...
static int T_9 F_135 ( struct V_190 * V_206 )
{
struct V_215 * V_216 ;
struct V_15 * V_16 ;
T_2 V_102 ;
...
F_124 ( V_218 , V_219 . V_220 ) ;
F_124 ( V_221 , V_219 . V_220 ) ;
F_124 ( V_222 , V_223 . V_220 ) ;
F_124 ( V_218 , V_223 . V_220 ) ;
F_124 ( V_224 , V_223 . V_220 ) ;
F_124 ( V_225 , V_223 . V_220 ) ;
F_124 ( V_226 , V_223 . V_220 ) ;
F_124 ( V_194 , V_223 . V_220 ) ;
F_124 ( V_221 , V_223 . V_220 ) ;
V_217 = F_131 ( V_206 ) ;
if ( ! V_217 )
return - V_227 ;
V_216 = F_136 ( V_206 , V_228 , 0 ) ;
if ( ! V_216 )
return - V_60 ;
V_75 = F_137 ( V_206 , 0 ) ;
if ( V_75 < 0 )
...
V_16 = F_138 ( V_102 , V_183 ) ;
if ( ! V_16 )
return - V_230 ;
V_16 -> V_82 . V_220 = V_217 -> V_220 ;
V_16 -> V_214 = ( 1 << V_217 -> V_229 ) - 1 ;
V_102 = F_139 ( V_216 ) ;
if ( ! F_140 ( V_216 -> V_231 , V_102 , V_206 -> V_83 . V_232 -> V_233 ) ) {
V_150 = - V_112 ;
goto V_234;
}
V_16 -> V_235 = F_141 ( V_216 -> V_231 , V_102 ) ;
if ( ! V_16 -> V_235 ) {
V_150 = - V_230 ;
goto V_236;
}
V_16 -> V_237 = F_142 ( & V_206 -> V_83 , L_51 ) ;
if ( F_143 ( V_16 -> V_237 ) ) {
V_150 = F_144 ( V_16 -> V_237 ) ;
goto V_238;
}
...
goto V_239;
F_134 ( V_16 ) ;
V_150 = F_146 ( V_75 , F_64 , 0 , L_52 , V_16 ) ;
if ( V_150 )
goto V_240;
F_147 ( V_206 , V_16 ) ;
V_16 -> V_19 = F_148 ( L_53 ,
...
V_16 -> V_82 . V_248 = F_115 ;
V_16 -> V_82 . V_249 = F_119 ;
V_16 -> V_82 . V_250 = F_111 ;
V_16 -> V_82 . V_251 = F_114 ;
V_16 -> V_82 . V_83 = & V_206 -> V_83 ;
if ( F_152 ( V_222 , V_16 -> V_82 . V_220 ) )
V_16 -> V_82 . V_252 = F_73 ;
if ( F_152 ( V_218 , V_16 -> V_82 . V_220 ) )
V_16 -> V_82 . V_253 = F_80 ;
if ( F_152 ( V_224 , V_16 -> V_82 . V_220 ) ) {
V_16 -> V_82 . V_254 = F_83 ;
V_16 -> V_82 . V_255 = F_85 ;
V_16 -> V_82 . V_256 = V_257 ;
}
if ( F_152 ( V_194 , V_16 -> V_82 . V_220 ) ) {
V_16 -> V_82 . V_258 = F_89 ;
F_124 ( V_259 , V_16 -> V_82 . V_220 ) ;
V_16 -> V_82 . V_260 = F_99 ;
V_16 -> V_82 . V_261 = F_103 ;
V_16 -> V_82 . V_262 = F_105 ;
V_16 -> V_82 . V_263 = F_107 ;
V_16 -> V_82 . V_264 = F_109 ;
V_16 -> V_82 . V_265 = V_266 ;
V_16 -> V_82 . V_267 = V_266 ;
V_16 -> V_82 . V_268 = F_153 ( V_151 ) | F_153 ( V_140 ) ;
V_16 -> V_82 . V_269 = V_270 ;
}
if ( F_152 ( V_221 , V_16 -> V_82 . V_220 ) )
V_16 -> V_82 . V_271 = F_95 ;
F_36 ( V_16 , V_212 , V_272 ) ;
F_74 ( & V_206 -> V_83 , L_57 ,
F_152 ( V_218 , V_16 -> V_82 . V_220 ) ? L_58 : L_59 ,
F_152 ( V_224 , V_16 -> V_82 . V_220 ) ? L_60 : L_59 ,
F_152 ( V_194 , V_16 -> V_82 . V_220 ) ? L_61 : L_59 ,
F_152 ( V_221 , V_16 -> V_82 . V_220 ) ? L_62 : L_59 ,
V_217 -> V_229 ) ;
F_154 ( & V_16 -> V_82 ) ;
if ( V_206 -> V_83 . V_207 ) {
V_150 = F_155 ( V_206 -> V_83 . V_207 ,
F_121 , V_16 ) ;
if ( V_150 ) {
...
V_16 -> V_235 = NULL ;
V_236:
F_162 ( V_216 -> V_231 , V_102 ) ;
V_234:
F_163 ( V_16 ) ;
return V_150 ;
}
static int F_164 ( struct V_190 * V_206 )
{
struct V_15 * V_16 = F_165 ( V_206 ) ;
...
V_16 -> V_235 = NULL ;
V_216 = F_136 ( V_206 , V_228 , 0 ) ;
F_162 ( V_216 -> V_231 , F_139 ( V_216 ) ) ;
F_163 ( V_16 ) ;
return 0 ;
}
static void F_168 ( struct V_190 * V_206 )
{
struct V_15 * V_16 = F_165 ( V_206 ) ;
F_134 ( F_165 ( V_206 ) ) ;
F_159 ( V_16 -> V_237 ) ;
}
static int F_169 ( struct V_17 * V_83 )
{
struct V_190 * V_206 = F_170 ( V_83 ) ;
struct V_15 * V_16 = F_165 ( V_206 ) ;
struct V_11 * V_12 , * V_274 ;
F_13 (chan, _chan, &atdma->dma_common.channels,
device_node) {
...
static int F_173 ( struct V_17 * V_83 )
{
struct V_190 * V_206 = F_170 ( V_83 ) ;
struct V_15 * V_16 = F_165 ( V_206 ) ;
struct V_11 * V_12 , * V_274 ;
...
static int F_175 ( struct V_17 * V_83 )
{
struct V_190 * V_206 = F_170 ( V_83 ) ;
struct V_15 * V_16 = F_165 ( V_206 ) ;
struct V_11 * V_12 , * V_274 ;
