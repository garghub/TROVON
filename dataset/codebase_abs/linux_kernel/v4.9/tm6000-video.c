...
static void
F_53 ( struct V_111 * V_112 , struct V_125 * V_11 )
{
struct V_3 * V_4 = F_2 ( V_11 , struct V_3 , V_11 ) ;
struct V_114 * V_115 = V_112 -> V_116 ;
struct V_5 * V_6 = V_115 -> V_6 ;
...
V_4 -> V_11 . V_15 = V_132 ;
F_54 ( & V_4 -> V_11 . V_12 , & V_7 -> V_8 ) ;
}
static void F_55 ( struct V_111 * V_112 , struct V_125 * V_11 )
{
struct V_3 * V_4 = F_2 ( V_11 , struct V_3 , V_11 ) ;
F_45 ( V_112 , V_4 ) ;
}
static bool F_56 ( struct V_5 * V_6 , struct V_114 * V_115 )
{
if ( V_6 -> V_133 == V_115 && V_6 -> F_56 )
return true ;
return false ;
}
...
bool F_56 )
{
if ( V_6 -> V_133 == V_115 && V_6 -> F_56 == F_56 )
return true ;
if ( V_6 -> V_133 )
return false ;
V_6 -> V_133 = V_115 ;
...
static void F_59 ( struct V_5 * V_6 , struct V_114 * V_115 )
{
if ( V_6 -> V_133 != V_115 )
return;
V_6 -> V_133 = NULL ;
...
struct V_139 * V_140 = F_61 ( V_135 ) ;
F_62 ( V_138 -> V_141 , L_28 , sizeof( V_138 -> V_141 ) ) ;
F_62 ( V_138 -> V_142 , L_29 , sizeof( V_138 -> V_142 ) ) ;
F_63 ( V_6 -> V_84 , V_138 -> V_143 , sizeof( V_138 -> V_143 ) ) ;
if ( V_6 -> V_144 != V_145 )
V_138 -> V_146 |= V_147 ;
...
struct V_156 * V_157 )
{
if ( V_157 -> V_158 >= F_65 ( V_159 ) )
return - V_129 ;
F_62 ( V_157 -> V_160 , V_159 [ V_157 -> V_158 ] . V_161 , sizeof( V_157 -> V_160 ) ) ;
...
static struct V_170 * F_67 ( unsigned int V_71 )
{
unsigned int V_14 ;
for ( V_14 = 0 ; V_14 < F_65 ( V_159 ) ; V_14 ++ )
...
struct V_170 * V_117 ;
enum V_126 V_32 ;
V_117 = F_67 ( V_157 -> V_117 . V_164 . V_162 ) ;
if ( NULL == V_117 ) {
F_4 ( V_6 , 2 , L_30
L_31 , V_157 -> V_117 . V_164 . V_162 ) ;
return - V_129 ;
}
...
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
int V_172 = F_68 ( V_135 , V_115 , V_157 ) ;
if ( V_172 < 0 )
return V_172 ;
V_115 -> V_117 = F_67 ( V_157 -> V_117 . V_164 . V_162 ) ;
...
static int F_72 ( struct V_135 * V_135 , void * V_136 ,
struct V_173 * V_65 )
{
struct V_114 * V_115 = V_136 ;
return F_73 ( & V_115 -> V_165 , V_65 ) ;
}
static int F_74 ( struct V_135 * V_135 , void * V_136 ,
struct V_174 * V_65 )
{
struct V_114 * V_115 = V_136 ;
return F_75 ( & V_115 -> V_165 , V_65 ) ;
}
static int F_76 ( struct V_135 * V_135 , void * V_136 , struct V_174 * V_65 )
{
struct V_114 * V_115 = V_136 ;
return F_77 ( & V_115 -> V_165 , V_65 ) ;
}
static int F_78 ( struct V_135 * V_135 , void * V_136 , struct V_174 * V_65 )
{
struct V_114 * V_115 = V_136 ;
return F_79 ( & V_115 -> V_165 , V_65 ,
V_135 -> V_175 & V_176 ) ;
}
static int F_80 ( struct V_135 * V_135 , void * V_136 , enum V_177 V_14 )
{
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
if ( V_115 -> type != V_178 )
...
if ( V_14 != V_115 -> type )
return - V_129 ;
if ( ! F_58 ( V_6 , V_115 , false ) )
return - V_179 ;
return F_81 ( & V_115 -> V_165 ) ;
}
static int F_82 ( struct V_135 * V_135 , void * V_136 , enum V_177 V_14 )
{
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
if ( V_115 -> type != V_178 )
...
static int F_84 ( struct V_135 * V_135 , void * V_136 , T_3 V_180 )
{
int V_27 = 0 ;
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
...
if ( V_27 < 0 )
return V_27 ;
F_86 ( & V_6 -> V_181 , 0 , V_182 , V_183 , V_6 -> V_180 ) ;
return 0 ;
}
static int F_87 ( struct V_135 * V_135 , void * V_136 , T_3 * V_180 )
{
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
* V_180 = V_6 -> V_180 ;
...
static int F_88 ( struct V_135 * V_135 , void * V_136 ,
struct V_184 * V_14 )
{
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
...
static int F_89 ( struct V_135 * V_135 , void * V_136 , unsigned int * V_14 )
{
struct V_114 * V_115 = V_136 ;
struct V_5 * V_6 = V_115 -> V_6 ;
* V_14 = V_6 -> V_193 ;
...
return - V_129 ;
V_6 -> V_193 = V_14 ;
V_27 = F_84 ( V_135 , V_136 , V_6 -> V_180 ) ;
return V_27 ;
}
static int F_91 ( struct V_194 * V_195 )
{
struct V_5 * V_6 = F_2 ( V_195 -> V_196 , struct V_5 , V_197 ) ;
T_1 V_198 = V_195 -> V_198 ;
switch ( V_195 -> V_199 ) {
case V_200 :
F_92 ( V_6 , V_201 , V_198 ) ;
return 0 ;
case V_202 :
F_92 ( V_6 , V_203 , V_198 ) ;
return 0 ;
case V_204 :
F_92 ( V_6 , V_205 , V_198 ) ;
return 0 ;
case V_206 :
F_92 ( V_6 , V_207 , V_198 ) ;
return 0 ;
}
return - V_129 ;
}
static int F_93 ( struct V_194 * V_195 )
{
...
if ( 0 != V_214 -> V_158 )
return - V_129 ;
strcpy ( V_214 -> V_161 , L_32 ) ;
V_214 -> type = V_217 ;
V_214 -> V_218 = V_219 | V_220 ;
V_214 -> V_221 = 0xffffffffUL ;
V_214 -> V_222 = V_223 ;
F_86 ( & V_6 -> V_181 , 0 , V_224 , V_225 , V_214 ) ;
...
F_4 ( V_6 , 3 , L_33 , V_214 -> V_226 ) ;
F_86 ( & V_6 -> V_181 , 0 , V_224 , V_229 , V_214 ) ;
return 0 ;
}
...
F_86 ( & V_6 -> V_181 , 0 , V_224 , V_233 , V_157 ) ;
return 0 ;
}
...
F_86 ( & V_6 -> V_181 , 0 , V_224 , V_234 , V_157 ) ;
return 0 ;
}
...
static int F_102 ( struct V_135 * V_135 )
{
struct V_139 * V_140 = F_61 ( V_135 ) ;
struct V_5 * V_6 = F_103 ( V_135 ) ;
struct V_114 * V_115 ;
...
V_6 -> V_242 ++ ;
F_4 ( V_6 , V_238 , L_36 ,
F_104 ( V_140 ) , V_243 [ type ] ,
V_6 -> V_242 ) ;
V_115 = F_105 ( sizeof( * V_115 ) , V_80 ) ;
if ( NULL == V_115 ) {
V_6 -> V_242 -- ;
return - V_81 ;
}
F_106 ( & V_115 -> V_115 , V_140 ) ;
V_135 -> V_235 = V_115 ;
V_115 -> V_6 = V_6 ;
V_115 -> V_38 = V_38 ;
V_6 -> V_38 = V_38 ;
...
F_4 ( V_6 , V_238 , L_39
L_40 , F_3 ( & V_6 -> V_7 . V_244 ) ) ;
F_4 ( V_6 , V_238 , L_39
L_41 , F_3 ( & V_6 -> V_7 . V_8 ) ) ;
V_27 = F_85 ( V_6 ) ;
if ( V_27 < 0 )
return V_27 ;
V_6 -> V_245 = V_246 ;
if ( ! V_115 -> V_38 ) {
F_107 ( & V_115 -> V_165 , & V_247 ,
NULL , & V_6 -> V_75 ,
V_115 -> type ,
V_171 ,
...
static int F_110 ( struct V_135 * V_135 )
{
struct V_139 * V_140 = F_61 ( V_135 ) ;
int V_250 ;
F_111 ( V_140 -> V_248 ) ;
...
static T_4
F_113 ( struct V_135 * V_135 , char T_5 * V_20 , T_6 V_113 , T_7 * V_34 )
{
struct V_114 * V_115 = V_135 -> V_235 ;
struct V_5 * V_6 = V_115 -> V_6 ;
if ( V_115 -> type == V_178 ) {
int V_250 ;
if ( ! F_58 ( V_115 -> V_6 , V_115 , true ) )
return - V_179 ;
if ( F_114 ( & V_6 -> V_248 ) )
return - V_251 ;
V_250 = F_115 ( & V_115 -> V_165 , V_20 , V_113 , V_34 , 0 ,
V_135 -> V_175 & V_176 ) ;
F_112 ( & V_6 -> V_248 ) ;
return V_250 ;
}
...
static unsigned int
F_116 ( struct V_135 * V_135 , struct V_252 * V_253 )
{
unsigned long V_254 = F_117 ( V_253 ) ;
struct V_114 * V_115 = V_135 -> V_235 ;
struct V_3 * V_4 ;
int V_250 = 0 ;
if ( F_118 ( & V_115 -> V_115 ) )
V_250 = V_255 ;
else if ( V_254 & V_255 )
F_119 ( V_135 , & V_115 -> V_115 . V_253 , V_253 ) ;
if ( V_178 != V_115 -> type )
return V_250 | V_256 ;
if ( ! ! F_57 ( V_115 -> V_6 , V_115 ) )
return V_250 | V_256 ;
if ( ! F_56 ( V_115 -> V_6 , V_115 ) ) {
if ( F_3 ( & V_115 -> V_165 . V_257 ) )
return V_250 | V_256 ;
V_4 = F_5 ( V_115 -> V_165 . V_257 . V_10 , struct V_3 , V_11 . V_257 ) ;
F_119 ( V_135 , & V_4 -> V_11 . V_19 , V_253 ) ;
if ( V_4 -> V_11 . V_15 == V_16 ||
V_4 -> V_11 . V_15 == V_258 )
return V_250 | V_259 | V_260 ;
} else if ( V_254 & ( V_259 | V_260 ) ) {
return V_250 | F_120 ( V_135 , & V_115 -> V_165 , V_253 ) ;
}
return V_250 ;
}
static unsigned int F_121 ( struct V_135 * V_135 , struct V_252 * V_253 )
{
struct V_114 * V_115 = V_135 -> V_235 ;
struct V_5 * V_6 = V_115 -> V_6 ;
unsigned int V_250 ;
F_111 ( & V_6 -> V_248 ) ;
V_250 = F_116 ( V_135 , V_253 ) ;
F_112 ( & V_6 -> V_248 ) ;
return V_250 ;
}
static int F_122 ( struct V_135 * V_135 )
{
struct V_114 * V_115 = V_135 -> V_235 ;
struct V_5 * V_6 = V_115 -> V_6 ;
struct V_139 * V_140 = F_61 ( V_135 ) ;
F_4 ( V_6 , V_238 , L_43 ,
F_104 ( V_140 ) , V_6 -> V_242 ) ;
F_111 ( & V_6 -> V_248 ) ;
V_6 -> V_242 -- ;
F_59 ( V_6 , V_115 ) ;
if ( ! V_6 -> V_242 ) {
...
static int F_127 ( struct V_135 * V_135 , struct V_262 * V_263 )
{
struct V_114 * V_115 = V_135 -> V_235 ;
struct V_5 * V_6 = V_115 -> V_6 ;
int V_250 ;
...
{
* V_264 = * V_265 ;
V_264 -> V_181 = & V_6 -> V_181 ;
V_264 -> V_267 = V_268 ;
V_264 -> V_248 = & V_6 -> V_248 ;
snprintf ( V_264 -> V_161 , sizeof( V_264 -> V_161 ) , L_44 , V_6 -> V_161 , V_266 ) ;
F_130 ( V_264 , V_6 ) ;
}
int F_131 ( struct V_5 * V_6 )
{
int V_172 = 0 ;
F_132 ( & V_6 -> V_197 , 6 ) ;
F_132 ( & V_6 -> V_208 , 2 ) ;
F_133 ( & V_6 -> V_208 , & V_269 ,
V_209 , 0 , 1 , 1 , 0 ) ;
F_133 ( & V_6 -> V_208 , & V_269 ,
V_211 , - 15 , 15 , 1 , 0 ) ;
F_133 ( & V_6 -> V_197 , & V_270 ,
V_202 , 0 , 255 , 1 , 54 ) ;
F_133 ( & V_6 -> V_197 , & V_270 ,
V_200 , 0 , 255 , 1 , 119 ) ;
F_133 ( & V_6 -> V_197 , & V_270 ,
...
if ( V_172 )
goto V_271;
F_129 ( V_6 , & V_6 -> V_264 , & V_272 , L_45 ) ;
V_6 -> V_264 . V_197 = & V_6 -> V_197 ;
F_135 ( & V_6 -> V_7 . V_8 ) ;
F_135 ( & V_6 -> V_7 . V_244 ) ;
V_172 = F_136 ( & V_6 -> V_264 , V_149 , V_273 ) ;
if ( V_172 < 0 ) {
F_137 ( V_274 L_46 ,
V_6 -> V_161 ) ;
goto V_271;
...
F_137 ( V_274 L_47 ,
V_6 -> V_161 , F_104 ( & V_6 -> V_264 ) ) ;
if ( V_6 -> V_275 . V_276 ) {
F_129 ( V_6 , & V_6 -> V_277 , & V_278 ,
L_48 ) ;
V_6 -> V_277 . V_197 = & V_6 -> V_208 ;
V_172 = F_136 ( & V_6 -> V_277 , V_241 ,
V_279 ) ;
if ( V_172 < 0 ) {
F_137 ( V_274 L_49 ,
V_6 -> V_161 ) ;
...
F_137 ( V_274 L_47 ,
V_6 -> V_161 , F_104 ( & V_6 -> V_277 ) ) ;
}
F_137 ( V_274 L_50 , V_172 ) ;
return V_172 ;
V_280:
F_138 ( & V_6 -> V_264 ) ;
V_271:
