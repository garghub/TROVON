...
static int F_48 ( struct V_102 * V_103 [] , struct V_102 * V_33 [] )
{
if ( V_103 [ V_104 ] ) {
if ( F_49 ( V_103 [ V_104 ] ) != V_105 )
return - V_70 ;
if ( ! F_50 ( F_51 ( V_103 [ V_104 ] ) ) )
return - V_106 ;
}
if ( V_103 [ V_107 ] ) {
if ( ! F_35 ( F_52 ( V_103 [ V_107 ] ) ) )
return - V_70 ;
}
return 0 ;
}
static int F_53 ( struct V_108 * V_109 , struct V_1 * V_2 ,
struct V_102 * V_103 [] , struct V_102 * V_33 [] )
{
int V_110 ;
struct V_1 * V_36 ;
struct V_34 * V_35 ;
char V_111 [ V_112 ] ;
struct V_102 * V_113 [ V_114 + 1 ] , * * V_115 ;
unsigned char V_116 ;
struct V_117 * V_118 ;
struct V_108 * V_108 ;
...
V_118 = F_51 ( V_120 ) ;
V_110 = F_54 ( V_113 ,
F_51 ( V_120 ) + sizeof( struct V_117 ) ,
F_49 ( V_120 ) - sizeof( struct V_117 ) ) ;
if ( V_110 < 0 )
return V_110 ;
V_110 = F_48 ( V_113 , NULL ) ;
if ( V_110 < 0 )
return V_110 ;
V_115 = V_113 ;
} else {
...
if ( V_115 [ V_121 ] ) {
F_55 ( V_111 , V_115 [ V_121 ] , V_112 ) ;
V_116 = V_122 ;
} else {
snprintf ( V_111 , V_112 , V_22 L_1 ) ;
V_116 = V_123 ;
}
V_108 = F_56 ( V_109 , V_115 ) ;
if ( F_57 ( V_108 ) )
return F_58 ( V_108 ) ;
V_36 = F_59 ( V_108 , V_111 , V_116 ,
& V_124 , V_115 ) ;
if ( F_57 ( V_36 ) ) {
F_60 ( V_108 ) ;
return F_58 ( V_36 ) ;
...
goto V_126;
F_34 ( V_36 ) ;
V_110 = F_63 ( V_36 , V_118 ) ;
if ( V_110 < 0 )
goto V_127;
if ( V_103 [ V_104 ] == NULL )
F_61 ( V_2 ) ;
if ( V_103 [ V_121 ] )
F_55 ( V_2 -> V_128 , V_103 [ V_121 ] , V_112 ) ;
else
...
static void F_66 ( struct V_1 * V_2 , struct V_130 * V_131 )
{
struct V_34 * V_35 ;
struct V_1 * V_36 ;
V_35 = F_9 ( V_2 ) ;
...
static struct V_108 * F_69 ( const struct V_1 * V_2 )
{
struct V_34 * V_35 = F_9 ( V_2 ) ;
struct V_1 * V_36 = F_10 ( V_35 -> V_36 ) ;
