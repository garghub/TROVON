...
V_34 = F_33 ( V_14 ) ;
V_35 = V_14 -> V_58 . V_59 ;
V_51 = F_34 ( V_33 , V_60 , 0 ) ;
if ( ! V_51 )
return - V_61 ;
V_52 = F_35 ( V_51 ) ;
if ( V_52 < 0x100 )
F_11 ( V_15 , L_7 ) ;
if ( ! F_36 ( V_15 , V_51 -> V_62 , V_52 , F_37 ( V_15 ) ) )
return - V_61 ;
...
V_2 -> V_33 = V_33 ;
V_2 -> V_63 = F_1 ( V_2 , V_64 ) ;
F_42 ( V_33 , V_2 ) ;
V_7 -> V_65 = L_8 ;
V_7 -> V_66 = & V_67 ;
V_7 -> V_68 = F_43 ( V_33 , 0 ) ;
V_7 -> V_69 = F_44 ( V_15 , V_51 -> V_62 ,
F_35 ( V_51 ) ) ;
if ( V_7 -> V_69 == NULL ) {
V_53 = - V_61 ;
goto V_70;
...
if ( V_2 -> V_4 ) {
if ( V_2 -> V_4 -> V_71 ) {
V_53 = V_2 -> V_4 -> V_71 ( V_33 , V_34 , V_35 ) ;
if ( V_53 )
goto V_70;
}
if ( V_2 -> V_4 -> V_72 ) {
V_7 -> V_66 = V_2 -> V_4 -> V_72 -> V_66 ;
V_7 -> V_73 |= V_2 -> V_4 -> V_72 -> V_73 ;
V_7 -> V_74 |= V_2 -> V_4 -> V_72 -> V_74 ;
V_7 -> V_24 -> V_41 |= V_2 -> V_4 -> V_72 -> V_41 ;
V_7 -> V_24 -> V_75 |= V_2 -> V_4 -> V_72 -> V_75 ;
V_7 -> V_24 -> V_76 |= V_2 -> V_4 -> V_72 -> V_76 ;
}
...
if ( F_45 ( V_7 -> V_24 , NULL , 0 , V_79 , 0 , NULL ) ) {
F_46 ( V_15 , L_9 ) ;
V_2 -> V_63 = false ;
}
}
