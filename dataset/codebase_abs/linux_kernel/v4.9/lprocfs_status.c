...
int F_124 ( const char T_2 * V_39 , unsigned long V_2 ,
struct V_270 * V_271 , char * V_58 )
{
char V_49 [ 64 ] , * V_78 , * V_272 ;
...
* V_78 = '\0' ;
V_78 ++ ;
if ( F_125 ( V_49 , 0 , & V_273 ) != 0 ) {
V_272 = L_87 ;
V_74 = - V_45 ;
goto V_276;
}
if ( F_125 ( V_78 , 0 , & V_274 ) != 0 ) {
V_272 = L_88 ;
V_74 = - V_45 ;
goto V_276;
}
...
int F_128 ( const char T_2 * V_39 , unsigned long V_2 ,
struct V_270 * V_271 , char * V_58 )
{
char * V_49 = NULL , * V_272 ;
struct V_279 V_78 ;
int V_220 = V_2 ;
int V_74 ;
if ( V_2 > 4096 ) {
...
if ( V_2 > 0 && V_49 [ V_2 - 1 ] == '\n' )
V_220 = V_2 - 1 ;
if ( ( V_220 == 4 && ! strncmp ( V_49 , L_93 , V_220 ) ) ||
( V_220 == 5 && ! strncmp ( V_49 , L_94 , V_220 ) ) ) {
F_130 ( & V_271 -> V_281 ) ;
if ( ! F_131 ( & V_271 -> V_282 ) )
F_132 ( & V_271 -> V_282 ) ;
F_133 ( & V_271 -> V_281 ) ;
F_126 ( L_95 , V_58 ) ;
F_134 ( V_49 ) ;
...
static T_4 F_138 ( struct V_79 * V_80 ,
struct V_81 * V_82 , char * V_83 )
{
struct V_283 * V_284 = F_33 ( V_82 , struct V_283 , V_82 ) ;
return V_284 -> V_285 ? V_284 -> V_285 ( V_80 , V_82 , V_83 ) : 0 ;
}
static T_4 F_139 ( struct V_79 * V_80 , struct V_81 * V_82 ,
const char * V_83 , T_7 V_220 )
{
struct V_283 * V_284 = F_33 ( V_82 , struct V_283 , V_82 ) ;
return V_284 -> V_286 ? V_284 -> V_286 ( V_80 , V_82 , V_83 , V_220 ) : V_220 ;
}
