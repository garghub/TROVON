...
static bool F_159 ( struct V_1 * V_2 , struct V_173 * V_173 )
{
...
static bool F_160 ( struct V_1 * V_2 , struct V_53 * V_18 ,
struct V_342 * V_343 )
{
bool V_197 = false ;
T_7 V_355 ;
...
static int F_161 ( struct V_1 * V_2 , struct V_173 * V_173 )
{
struct V_53 * V_18 = V_2 -> V_18 ;
int V_197 = - V_198 ;
if ( ! F_159 ( V_2 , V_173 ) ) {
...
if ( F_160 ( V_2 , V_18 , & V_173 -> V_344 ) )
V_197 = 0 ;
V_218:
return V_197 ;
}
static void F_162 ( struct V_1 * V_2 , struct V_173 * V_173 )
{
struct V_342 * V_343 = & V_173 -> V_344 ;
...
static void F_167 ( struct V_1 * V_2 , T_4 V_21 , T_1 V_46 )
{
...
static void F_186 ( struct V_1 * V_2 , T_4 * V_61 )
{
const T_1 V_384 [] = {
V_61 [ 0 ] | ( V_61 [ 1 ] << 8 ) ,
V_61 [ 2 ] | ( V_61 [ 3 ] << 8 ) ,
...
static void F_202 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_156 ( V_2 ) ;
switch ( V_2 -> V_70 ) {
...
if ( V_2 -> V_120 ( V_23 ) )
return;
F_204 ( V_2 , V_192 , V_2 -> V_18 , L_13 ) ;
V_2 -> V_398 ( V_2 ) ;
V_397:
F_119 ( V_229 , V_230 + V_394 ) ;
}
static void F_205 ( struct V_1 * V_2 , enum V_399 V_400 )
{
if ( ! F_206 ( V_400 , V_2 -> V_3 . V_401 ) )
F_207 ( & V_2 -> V_3 . V_402 ) ;
}
static void F_208 ( unsigned long V_403 )
{
struct V_53 * V_18 = (struct V_53 * ) V_403 ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_205 ( V_2 , V_404 ) ;
}
static void F_209 ( struct V_5 * V_6 , struct V_53 * V_18 ,
void T_3 * V_23 )
{
F_210 ( V_23 ) ;
F_211 ( V_6 ) ;
...
static void F_215 ( struct V_53 * V_18 ,
struct V_1 * V_2 )
{
V_2 -> V_398 ( V_2 ) ;
...
static void F_217 ( struct V_53 * V_18 , struct V_1 * V_2 )
{
void T_3 * V_23 = V_2 -> V_24 ;
F_202 ( V_18 ) ;
if ( V_2 -> V_70 <= V_332 ) {
...
F_218 ( V_2 -> V_5 , V_407 , 0x40 ) ;
if ( V_2 -> V_70 <= V_332 )
F_218 ( V_2 -> V_5 , V_408 , 0x08 ) ;
if ( V_2 -> V_70 == V_225 ) {
F_157 ( L_14 ) ;
F_60 ( 0x82 , 0x01 ) ;
F_157 ( L_15 ) ;
...
static void F_219 ( struct V_1 * V_2 , T_4 * V_61 )
{
void T_3 * V_23 = V_2 -> V_24 ;
F_1 ( V_2 ) ;
F_60 ( V_159 , V_160 ) ;
...
static int F_220 ( struct V_53 * V_18 , void * V_51 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
struct V_151 * V_10 = & V_2 -> V_5 -> V_18 ;
...
F_100 ( V_10 ) ;
if ( F_101 ( V_10 ) )
F_219 ( V_2 , V_18 -> V_386 ) ;
F_102 ( V_10 ) ;
return 0 ;
}
static int F_222 ( struct V_53 * V_18 , struct V_415 * V_416 , int V_78 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
struct V_417 * V_22 = F_223 ( V_416 ) ;
...
static int F_225 ( struct V_1 * V_2 , struct V_417 * V_22 , int V_78 )
{
return - V_193 ;
}
static void F_226 ( struct V_5 * V_6 , struct V_1 * V_2 )
{
if ( V_2 -> V_167 & V_426 ) {
F_227 ( V_6 ) ;
V_2 -> V_167 &= ~ V_426 ;
...
{
F_240 ( V_2 , V_2 -> V_439 . V_440 ) ;
}
static void F_243 ( struct V_1 * V_2 )
{
F_240 ( V_2 , V_2 -> V_439 . V_441 ) ;
}
...
if ( ! V_462 )
goto V_464;
V_173 = F_262 ( sizeof( * V_173 ) , V_465 ) ;
if ( ! V_173 )
goto V_466;
V_197 = F_263 ( & V_173 -> V_340 , V_462 , & V_2 -> V_5 -> V_18 ) ;
if ( V_197 < 0 )
goto V_467;
V_197 = F_161 ( V_2 , V_173 ) ;
if ( V_197 < 0 )
goto V_468;
V_2 -> V_173 = V_173 ;
V_218:
...
static T_1 F_271 ( void T_3 * V_23 )
{
T_1 V_78 ;
V_78 = F_74 ( V_249 ) ;
F_76 ( V_249 , V_78 ) ;
...
static void F_272 ( void T_3 * V_23 , unsigned int V_484 )
{
F_76 ( V_485 , V_484 + 1 ) ;
}
static void F_273 ( void T_3 * V_23 , unsigned V_70 )
{
...
T_2 V_155 = 0 ;
if ( V_18 -> V_401 & V_493 ) {
F_155 ( V_2 , V_192 , V_18 , L_18 ) ;
V_492 =
V_433 | V_434 | V_435 |
V_494 ;
V_491 [ 1 ] = V_491 [ 0 ] = 0xffffffff ;
} else if ( ( F_275 ( V_18 ) > V_495 ) ||
( V_18 -> V_401 & V_496 ) ) {
...
V_491 [ 1 ] = V_491 [ 0 ] = 0 ;
F_276 (ha, dev) {
int V_499 = F_277 ( V_500 , V_498 -> V_61 ) >> 26 ;
...
static void F_279 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
...
static void F_282 ( struct V_1 * V_2 , T_2 V_98 )
{
T_2 V_510 ;
V_510 = F_281 ( V_2 , 0x070c ) & 0x00ffffff ;
F_280 ( V_2 , 0x070c , V_510 | V_98 ) ;
}
static void F_283 ( struct V_1 * V_2 )
{
F_282 ( V_2 , 0x17000000 ) ;
}
static void F_284 ( struct V_1 * V_2 )
{
F_282 ( V_2 , 0x27000000 ) ;
}
...
static void F_292 ( struct V_1 * V_2 , const struct V_520 * V_385 ,
int V_91 )
{
T_1 V_384 ;
while ( V_91 -- > 0 ) {
...
static void F_297 ( struct V_1 * V_2 , bool V_451 )
{
void T_3 * V_23 = V_2 -> V_24 ;
T_4 V_22 ;
V_22 = F_61 ( V_127 ) ;
...
static void F_325 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
F_60 ( V_159 , V_160 ) ;
...
static void F_334 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
...
static int F_335 ( struct V_53 * V_18 , int V_587 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
if ( V_587 < V_588 ||
V_587 > V_169 [ V_2 -> V_70 ] . V_589 )
return - V_198 ;
if ( V_587 > V_527 )
F_247 ( V_2 ) ;
else
...
static inline void F_337 ( struct V_253 * V_254 )
{
V_254 -> V_61 = F_338 ( 0x0badbadbadbadbadull ) ;
V_254 -> V_590 &= ~ F_339 ( V_591 | V_592 ) ;
}
static void F_340 ( struct V_1 * V_2 ,
void * * V_593 , struct V_253 * V_254 )
{
F_341 ( & V_2 -> V_5 -> V_18 , F_151 ( V_254 -> V_61 ) , V_484 ,
V_594 ) ;
F_165 ( * V_593 ) ;
* V_593 = NULL ;
F_337 ( V_254 ) ;
}
static inline void F_342 ( struct V_253 * V_254 , T_2 V_484 )
{
T_2 V_595 = F_131 ( V_254 -> V_590 ) & V_596 ;
F_343 () ;
V_254 -> V_590 = F_339 ( V_591 | V_595 | V_484 ) ;
}
static inline void F_344 ( struct V_253 * V_254 , T_6 V_597 ,
T_2 V_484 )
{
V_254 -> V_61 = F_338 ( V_597 ) ;
F_342 ( V_254 , V_484 ) ;
}
static inline void * F_345 ( void * V_22 )
{
return ( void * ) F_346 ( ( long ) V_22 , 16 ) ;
}
static struct V_250 * F_347 ( struct V_1 * V_2 ,
struct V_253 * V_254 )
{
void * V_22 ;
T_6 V_597 ;
struct V_151 * V_10 = & V_2 -> V_5 -> V_18 ;
struct V_53 * V_18 = V_2 -> V_18 ;
int V_598 = V_18 -> V_18 . V_599 ? F_348 ( V_18 -> V_18 . V_599 ) : - 1 ;
V_22 = F_349 ( V_484 , V_465 , V_598 ) ;
if ( ! V_22 )
return NULL ;
if ( F_345 ( V_22 ) != V_22 ) {
F_165 ( V_22 ) ;
V_22 = F_349 ( V_484 + 15 , V_465 , V_598 ) ;
if ( ! V_22 )
return NULL ;
}
V_597 = F_350 ( V_10 , F_345 ( V_22 ) , V_484 ,
V_594 ) ;
if ( F_351 ( F_352 ( V_10 , V_597 ) ) ) {
if ( F_93 () )
F_11 ( V_2 , V_17 , V_2 -> V_18 , L_22 ) ;
goto V_600;
}
F_344 ( V_254 , V_597 , V_484 ) ;
return V_22 ;
V_600:
F_165 ( V_22 ) ;
return NULL ;
...
{
unsigned int V_15 ;
for ( V_15 = 0 ; V_15 < V_601 ; V_15 ++ ) {
if ( V_2 -> V_602 [ V_15 ] ) {
F_340 ( V_2 , V_2 -> V_602 + V_15 ,
V_2 -> V_603 + V_15 ) ;
}
}
}
static inline void F_354 ( struct V_253 * V_254 )
{
V_254 -> V_590 |= F_339 ( V_596 ) ;
}
...
if ( V_2 -> V_602 [ V_15 ] )
continue;
V_22 = F_347 ( V_2 , V_2 -> V_603 + V_15 ) ;
if ( ! V_22 ) {
F_337 ( V_2 -> V_603 + V_15 ) ;
goto V_600;
}
V_2 -> V_602 [ V_15 ] = V_22 ;
}
F_354 ( V_2 -> V_603 + V_601 - 1 ) ;
return 0 ;
V_600:
F_353 ( V_2 ) ;
return - V_463 ;
}
static int F_356 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_246 ( V_2 ) ;
memset ( V_2 -> V_604 , 0x0 , V_605 * sizeof( struct V_606 ) ) ;
memset ( V_2 -> V_602 , 0x0 , V_601 * sizeof( void * ) ) ;
return F_355 ( V_2 ) ;
}
static void F_357 ( struct V_151 * V_10 , struct V_606 * V_604 ,
struct V_607 * V_254 )
{
unsigned int V_91 = V_604 -> V_91 ;
F_341 ( V_10 , F_151 ( V_254 -> V_61 ) , V_91 , V_608 ) ;
V_254 -> V_590 = 0x00 ;
V_254 -> V_255 = 0x00 ;
V_254 -> V_61 = 0x00 ;
V_604 -> V_91 = 0 ;
}
static void F_358 ( struct V_1 * V_2 , T_2 V_348 ,
unsigned int V_13 )
{
unsigned int V_15 ;
for ( V_15 = 0 ; V_15 < V_13 ; V_15 ++ ) {
unsigned int V_609 = ( V_348 + V_15 ) % V_605 ;
struct V_606 * V_604 = V_2 -> V_604 + V_609 ;
unsigned int V_91 = V_604 -> V_91 ;
if ( V_91 ) {
struct V_250 * V_251 = V_604 -> V_251 ;
F_357 ( & V_2 -> V_5 -> V_18 , V_604 ,
V_2 -> V_610 + V_609 ) ;
if ( V_251 ) {
V_2 -> V_18 -> V_294 . V_611 ++ ;
F_359 ( V_251 ) ;
V_604 -> V_251 = NULL ;
}
}
...
static void F_367 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_205 ( V_2 , V_613 ) ;
}
static int F_368 ( struct V_1 * V_2 , struct V_250 * V_251 ,
T_2 * V_614 )
{
struct V_615 * V_172 = F_369 ( V_251 ) ;
unsigned int V_616 , V_609 ;
struct V_607 * V_617 ( V_618 ) ;
struct V_151 * V_10 = & V_2 -> V_5 -> V_18 ;
V_609 = V_2 -> V_448 ;
for ( V_616 = 0 ; V_616 < V_172 -> V_619 ; V_616 ++ ) {
const T_8 * V_620 = V_172 -> V_621 + V_616 ;
T_6 V_597 ;
T_2 V_258 , V_91 ;
void * V_61 ;
V_609 = ( V_609 + 1 ) % V_605 ;
V_618 = V_2 -> V_610 + V_609 ;
V_91 = F_370 ( V_620 ) ;
V_61 = F_371 ( V_620 ) ;
V_597 = F_350 ( V_10 , V_61 , V_91 , V_608 ) ;
if ( F_351 ( F_352 ( V_10 , V_597 ) ) ) {
if ( F_93 () )
...
V_258 = V_614 [ 0 ] | V_91 |
( V_596 * ! ( ( V_609 + 1 ) % V_605 ) ) ;
V_618 -> V_590 = F_339 ( V_258 ) ;
V_618 -> V_255 = F_339 ( V_614 [ 1 ] ) ;
V_618 -> V_61 = F_338 ( V_597 ) ;
V_2 -> V_604 [ V_609 ] . V_91 = V_91 ;
}
if ( V_616 ) {
V_2 -> V_604 [ V_609 ] . V_251 = V_251 ;
V_618 -> V_590 |= F_339 ( V_622 ) ;
}
return V_616 ;
V_600:
F_358 ( V_2 , V_2 -> V_448 + 1 , V_616 ) ;
return - V_623 ;
}
static bool F_372 ( struct V_1 * V_2 , struct V_250 * V_251 )
{
return V_251 -> V_91 < V_588 && V_2 -> V_70 == V_110 ;
}
static void F_373 ( struct V_1 * V_2 ,
struct V_250 * V_251 )
{
if ( F_369 ( V_251 ) -> V_624 ) {
T_5 V_167 = V_2 -> V_18 -> V_167 ;
struct V_250 * V_625 , * V_626 ;
V_167 &= ~ ( V_627 | V_628 | V_629 ) ;
V_625 = F_374 ( V_251 , V_167 ) ;
if ( F_265 ( V_625 ) || ! V_625 )
goto V_630;
do {
V_626 = V_625 ;
V_625 = V_625 -> V_631 ;
V_626 -> V_631 = NULL ;
F_375 ( V_626 , V_2 -> V_18 ) ;
} while ( V_625 );
F_376 ( V_251 ) ;
} else if ( V_251 -> V_632 == V_633 ) {
if ( F_377 ( V_251 ) < 0 )
goto V_630;
F_375 ( V_251 , V_2 -> V_18 ) ;
} else {
struct V_634 * V_294 ;
V_630:
...
static int F_378 ( struct V_250 * V_251 )
{
...
V_638 = F_381 ( V_251 ) ;
V_638 -> V_16 = 0 ;
V_638 -> V_16 = ~ F_382 ( 0 , & V_636 -> V_639 , & V_636 -> V_640 , 0 ) ;
return V_185 ;
}
static inline T_9 F_383 ( struct V_250 * V_251 )
{
T_9 V_641 ;
if ( V_251 -> V_641 == F_133 ( V_257 ) )
V_641 = F_384 ( V_251 ) -> V_642 ;
else
V_641 = V_251 -> V_641 ;
return V_641 ;
}
static bool F_385 ( struct V_1 * V_2 ,
struct V_250 * V_251 , T_2 * V_614 )
{
T_2 V_643 = F_369 ( V_251 ) -> V_624 ;
if ( V_643 ) {
V_614 [ 0 ] |= V_644 ;
V_614 [ 0 ] |= F_386 ( V_643 , V_234 ) << V_645 ;
} else if ( V_251 -> V_632 == V_633 ) {
const struct V_646 * V_647 = F_387 ( V_251 ) ;
...
static bool F_389 ( struct V_1 * V_2 ,
struct V_250 * V_251 , T_2 * V_614 )
{
T_2 V_653 = ( T_2 ) F_390 ( V_251 ) ;
T_2 V_643 = F_369 ( V_251 ) -> V_624 ;
if ( V_643 ) {
if ( V_653 > V_654 ) {
...
V_614 [ 0 ] |= V_653 << V_660 ;
V_614 [ 1 ] |= F_386 ( V_643 , V_234 ) << V_661 ;
} else if ( V_251 -> V_632 == V_633 ) {
T_4 V_662 ;
if ( F_351 ( F_372 ( V_2 , V_251 ) ) )
return ! ( F_377 ( V_251 ) || F_391 ( V_251 ) ) ;
if ( V_653 > V_663 ) {
F_115 ( V_2 , V_655 , V_2 -> V_18 ,
L_25 ,
V_653 ) ;
...
case F_133 ( V_656 ) :
V_614 [ 1 ] |= V_664 ;
V_662 = F_387 ( V_251 ) -> V_641 ;
break;
case F_133 ( V_658 ) :
V_614 [ 1 ] |= V_665 ;
V_662 = F_380 ( V_251 ) -> V_666 ;
break;
default:
V_662 = V_667 ;
break;
...
static T_10 F_375 ( struct V_250 * V_251 ,
struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
unsigned int V_609 = V_2 -> V_448 % V_605 ;
struct V_607 * V_618 = V_2 -> V_610 + V_609 ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_151 * V_10 = & V_2 -> V_5 -> V_18 ;
T_6 V_597 ;
T_2 V_258 , V_91 ;
T_2 V_614 [ 2 ] ;
int V_621 ;
if ( F_351 ( ! F_392 ( V_2 , F_369 ( V_251 ) -> V_619 ) ) ) {
F_11 ( V_2 , V_17 , V_18 , L_26 ) ;
goto V_671;
}
if ( F_351 ( F_131 ( V_618 -> V_590 ) & V_591 ) )
goto V_671;
V_614 [ 1 ] = F_339 ( F_126 ( V_251 ) ) ;
V_614 [ 0 ] = V_591 ;
if ( ! V_2 -> V_672 ( V_2 , V_251 , V_614 ) ) {
F_373 ( V_2 , V_251 ) ;
return V_673 ;
}
V_91 = F_393 ( V_251 ) ;
V_597 = F_350 ( V_10 , V_251 -> V_22 , V_91 , V_608 ) ;
if ( F_351 ( F_352 ( V_10 , V_597 ) ) ) {
if ( F_93 () )
...
F_394 ( V_251 ) ;
F_343 () ;
V_258 = V_614 [ 0 ] | V_91 | ( V_596 * ! ( ( V_609 + 1 ) % V_605 ) ) ;
V_618 -> V_590 = F_339 ( V_258 ) ;
F_395 () ;
V_2 -> V_448 += V_621 + 1 ;
F_60 ( V_677 , V_678 ) ;
...
return V_673 ;
V_675:
F_357 ( V_10 , V_2 -> V_604 + V_609 , V_618 ) ;
V_674:
F_359 ( V_251 ) ;
V_18 -> V_294 . V_611 ++ ;
return V_673 ;
...
static void F_398 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
struct V_5 * V_6 = V_2 -> V_5 ;
T_1 V_681 , V_682 ;
F_399 ( V_6 , V_683 , & V_682 ) ;
F_399 ( V_6 , V_684 , & V_681 ) ;
...
V_682 |= V_688 | V_687 ;
F_400 ( V_6 , V_683 , V_682 ) ;
F_400 ( V_6 , V_684 ,
V_681 & ( V_689 |
V_690 | V_691 |
V_692 | V_693 ) ) ;
if ( ( V_2 -> V_245 & V_694 ) && ! V_2 -> V_449 ) {
void T_3 * V_23 = V_2 -> V_24 ;
...
static void F_401 ( struct V_53 * V_18 , struct V_1 * V_2 )
{
unsigned int V_447 , V_696 ;
V_447 = V_2 -> V_447 ;
F_402 () ;
V_696 = V_2 -> V_448 - V_447 ;
while ( V_696 > 0 ) {
unsigned int V_609 = V_447 % V_605 ;
struct V_606 * V_604 = V_2 -> V_604 + V_609 ;
T_2 V_258 ;
V_258 = F_131 ( V_2 -> V_610 [ V_609 ] . V_590 ) ;
if ( V_258 & V_591 )
break;
F_403 () ;
F_357 ( & V_2 -> V_5 -> V_18 , V_604 ,
V_2 -> V_610 + V_609 ) ;
if ( V_258 & V_622 ) {
F_404 ( & V_2 -> V_697 . V_698 ) ;
V_2 -> V_697 . V_699 ++ ;
V_2 -> V_697 . V_700 += V_604 -> V_251 -> V_91 ;
F_405 ( & V_2 -> V_697 . V_698 ) ;
F_359 ( V_604 -> V_251 ) ;
V_604 -> V_251 = NULL ;
}
V_447 ++ ;
...
static inline int F_407 ( T_2 V_258 )
{
return ( V_258 & ( V_676 | V_622 ) ) != ( V_676 | V_622 ) ;
}
static inline void F_408 ( struct V_250 * V_251 , T_2 V_590 )
{
T_2 V_258 = V_590 & V_701 ;
if ( ( ( V_258 == V_702 ) && ! ( V_590 & V_703 ) ) ||
( ( V_258 == V_704 ) && ! ( V_590 & V_705 ) ) )
V_251 -> V_632 = V_706 ;
else
F_409 ( V_251 ) ;
}
static struct V_250 * F_410 ( void * V_22 ,
struct V_1 * V_2 ,
int V_707 ,
T_6 V_61 )
{
...
struct V_151 * V_10 = & V_2 -> V_5 -> V_18 ;
V_22 = F_345 ( V_22 ) ;
F_411 ( V_10 , V_61 , V_707 , V_594 ) ;
F_412 ( V_22 ) ;
V_251 = F_413 ( & V_2 -> V_612 , V_707 ) ;
if ( V_251 )
memcpy ( V_251 -> V_22 , V_22 , V_707 ) ;
F_414 ( V_10 , V_61 , V_707 , V_594 ) ;
return V_251 ;
}
static int F_415 ( struct V_53 * V_18 , struct V_1 * V_2 , T_2 V_708 )
{
unsigned int V_449 , V_709 ;
unsigned int V_374 ;
V_449 = V_2 -> V_449 ;
for ( V_709 = F_386 ( V_708 , V_601 ) ; V_709 > 0 ; V_709 -- , V_449 ++ ) {
unsigned int V_609 = V_449 % V_601 ;
struct V_253 * V_254 = V_2 -> V_603 + V_609 ;
T_2 V_258 ;
V_258 = F_131 ( V_254 -> V_590 ) & V_2 -> V_710 ;
if ( V_258 & V_591 )
break;
F_403 () ;
if ( F_351 ( V_258 & V_711 ) ) {
F_94 ( V_2 , V_712 , V_18 , L_30 ,
V_258 ) ;
V_18 -> V_294 . V_297 ++ ;
if ( V_258 & ( V_713 | V_714 ) )
V_18 -> V_294 . V_715 ++ ;
if ( V_258 & V_716 )
V_18 -> V_294 . V_717 ++ ;
if ( V_258 & V_718 ) {
...
if ( F_416 ( ! ( V_18 -> V_167 & V_721 ) ) )
V_707 = ( V_258 & 0x00003fff ) - 4 ;
else
V_707 = V_258 & 0x00003fff ;
if ( F_351 ( F_407 ( V_258 ) ) ) {
V_18 -> V_294 . V_722 ++ ;
V_18 -> V_294 . V_715 ++ ;
goto V_723;
}
V_251 = F_410 ( V_2 -> V_602 [ V_609 ] ,
V_2 , V_707 , V_61 ) ;
if ( ! V_251 ) {
V_18 -> V_294 . V_722 ++ ;
goto V_723;
...
F_408 ( V_251 , V_258 ) ;
F_417 ( V_251 , V_707 ) ;
V_251 -> V_641 = F_418 ( V_251 , V_18 ) ;
F_130 ( V_254 , V_251 ) ;
if ( V_251 -> V_724 == V_725 )
V_18 -> V_294 . V_726 ++ ;
F_419 ( & V_2 -> V_612 , V_251 ) ;
F_404 ( & V_2 -> V_727 . V_698 ) ;
V_2 -> V_727 . V_699 ++ ;
V_2 -> V_727 . V_700 += V_707 ;
F_405 ( & V_2 -> V_727 . V_698 ) ;
}
V_723:
V_254 -> V_255 = 0 ;
F_342 ( V_254 , V_484 ) ;
...
static T_11 F_420 ( int V_728 , void * V_729 )
{
...
F_75 ( V_2 , V_258 ) ;
if ( F_351 ( V_258 & V_569 ) ) {
switch ( V_2 -> V_70 ) {
case V_320 :
F_363 ( V_18 ) ;
F_424 ( V_613 , V_2 -> V_3 . V_401 ) ;
default:
break;
}
}
if ( F_351 ( V_258 & V_731 ) )
F_398 ( V_18 ) ;
if ( V_258 & V_732 )
F_90 ( V_18 , V_2 , V_2 -> V_24 , true ) ;
F_80 ( V_2 ) ;
}
static void F_425 ( struct V_733 * V_402 )
{
static const struct {
int V_734 ;
...
struct V_1 * V_2 =
F_426 ( V_402 , struct V_1 , V_3 . V_402 ) ;
struct V_53 * V_18 = V_2 -> V_18 ;
int V_15 ;
F_1 ( V_2 ) ;
if ( ! F_89 ( V_18 ) ||
! F_427 ( V_737 , V_2 -> V_3 . V_401 ) )
goto V_738;
for ( V_15 = 0 ; V_15 < F_104 ( V_735 ) ; V_15 ++ ) {
bool V_739 ;
V_739 = F_428 ( V_735 [ V_15 ] . V_734 , V_2 -> V_3 . V_401 ) ;
if ( V_739 )
V_735 [ V_15 ] . V_356 ( V_2 ) ;
}
V_738:
F_3 ( V_2 ) ;
}
static int F_429 ( struct V_740 * V_612 , int V_708 )
{
struct V_1 * V_2 = F_426 ( V_612 , struct V_1 , V_612 ) ;
struct V_53 * V_18 = V_2 -> V_18 ;
...
if ( V_258 & V_743 )
V_742 = F_415 ( V_18 , V_2 , ( T_2 ) V_708 ) ;
if ( V_258 & V_744 )
F_401 ( V_18 , V_2 ) ;
if ( V_258 & V_2 -> V_101 ) {
V_741 &= ~ V_2 -> V_101 ;
...
static void F_431 ( struct V_53 * V_18 , void T_3 * V_23 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
if ( V_2 -> V_70 > V_332 )
return;
V_18 -> V_294 . V_745 += ( F_20 ( V_507 ) & 0xffffff ) ;
F_18 ( V_507 , 0 ) ;
}
static void F_432 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
F_121 ( & V_2 -> V_229 ) ;
...
static int F_433 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
struct V_5 * V_6 = V_2 -> V_5 ;
F_434 ( & V_6 -> V_18 ) ;
F_147 ( V_18 ) ;
F_1 ( V_2 ) ;
F_435 ( V_737 , V_2 -> V_3 . V_401 ) ;
F_432 ( V_18 ) ;
F_3 ( V_2 ) ;
F_436 ( & V_2 -> V_3 . V_402 ) ;
F_437 ( V_6 -> V_728 , V_18 ) ;
F_438 ( & V_6 -> V_18 , V_746 , V_2 -> V_603 ,
V_2 -> V_482 ) ;
F_438 ( & V_6 -> V_18 , V_747 , V_2 -> V_610 ,
V_2 -> V_479 ) ;
V_2 -> V_610 = NULL ;
V_2 -> V_603 = NULL ;
F_439 ( & V_6 -> V_18 ) ;
...
static void F_440 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
F_420 ( V_2 -> V_5 -> V_728 , V_18 ) ;
}
static int F_441 ( struct V_53 * V_18 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
int V_748 = - V_463 ;
F_434 ( & V_6 -> V_18 ) ;
V_2 -> V_610 = F_442 ( & V_6 -> V_18 , V_747 ,
& V_2 -> V_479 , V_465 ) ;
if ( ! V_2 -> V_610 )
goto V_749;
V_2 -> V_603 = F_442 ( & V_6 -> V_18 , V_746 ,
& V_2 -> V_482 , V_465 ) ;
if ( ! V_2 -> V_603 )
goto V_750;
V_748 = F_356 ( V_18 ) ;
if ( V_748 < 0 )
goto V_751;
F_443 ( & V_2 -> V_3 . V_402 , F_425 ) ;
F_397 () ;
F_264 ( V_2 ) ;
V_748 = F_444 ( V_6 -> V_728 , F_420 ,
( V_2 -> V_167 & V_426 ) ? 0 : V_752 ,
V_18 -> V_462 , V_18 ) ;
if ( V_748 < 0 )
goto V_753;
F_1 ( V_2 ) ;
F_424 ( V_737 , V_2 -> V_3 . V_401 ) ;
F_365 ( & V_2 -> V_612 ) ;
F_217 ( V_18 , V_2 ) ;
...
static struct V_754 *
F_446 ( struct V_53 * V_18 , struct V_754 * V_294 )
{
struct V_1 * V_2 = F_42 ( V_18 ) ;
void T_3 * V_23 = V_2 -> V_24 ;
struct V_5 * V_6 = V_2 -> V_5 ;
...
F_431 ( V_18 , V_23 ) ;
do {
V_348 = F_447 ( & V_2 -> V_727 . V_698 ) ;
V_294 -> V_296 = V_2 -> V_727 . V_699 ;
V_294 -> V_755 = V_2 -> V_727 . V_700 ;
} while ( F_448 ( & V_2 -> V_727 . V_698 , V_348 ) );
do {
V_348 = F_447 ( & V_2 -> V_697 . V_698 ) ;
V_294 -> V_295 = V_2 -> V_697 . V_699 ;
V_294 -> V_756 = V_2 -> V_697 . V_700 ;
} while ( F_448 ( & V_2 -> V_697 . V_698 , V_348 ) );
V_294 -> V_722 = V_18 -> V_294 . V_722 ;
V_294 -> V_611 = V_18 -> V_294 . V_611 ;
V_294 -> V_715 = V_18 -> V_294 . V_715 ;
V_294 -> V_297 = V_18 -> V_294 . V_297 ;
V_294 -> V_717 = V_18 -> V_294 . V_717 ;
V_294 -> V_719 = V_18 -> V_294 . V_719 ;
V_294 -> V_745 = V_18 -> V_294 . V_745 ;
V_294 -> V_726 = V_18 -> V_294 . V_726 ;
if ( F_101 ( & V_6 -> V_18 ) )
F_147 ( V_18 ) ;
V_294 -> V_290 = F_151 ( V_287 -> V_290 ) -
F_151 ( V_2 -> V_288 . V_290 ) ;
V_294 -> V_757 = F_131 ( V_287 -> V_291 ) -
F_131 ( V_2 -> V_288 . V_291 ) ;
V_294 -> V_758 = F_152 ( V_287 -> V_292 ) -
...
static int F_451 ( struct V_151 * V_151 )
{
struct V_5 * V_6 = F_452 ( V_151 ) ;
...
static int F_456 ( struct V_151 * V_151 )
{
struct V_5 * V_6 = F_452 ( V_151 ) ;
struct V_53 * V_18 = F_453 ( V_6 ) ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
static int F_457 ( struct V_151 * V_151 )
{
struct V_5 * V_6 = F_452 ( V_151 ) ;
struct V_53 * V_18 = F_453 ( V_6 ) ;
struct V_1 * V_2 = F_42 ( V_18 ) ;
...
F_466 ( & V_2 -> V_612 ) ;
F_467 ( V_18 ) ;
F_438 ( & V_2 -> V_5 -> V_18 , sizeof( * V_2 -> V_287 ) ,
V_2 -> V_287 , V_2 -> V_277 ) ;
F_163 ( V_2 ) ;
if ( F_468 ( V_6 ) )
F_100 ( & V_6 -> V_18 ) ;
...
V_2 -> V_18 = V_18 ;
V_2 -> V_5 = V_6 ;
V_2 -> V_271 = F_478 ( V_777 . V_271 , V_781 ) ;
V_214 = & V_2 -> V_214 ;
V_214 -> V_18 = V_18 ;
V_214 -> V_782 = F_43 ;
V_214 -> V_783 = F_41 ;
...
if ( F_483 ( V_6 , V_774 ) < V_180 ) {
F_11 ( V_2 , V_337 , V_18 ,
L_37 ) ;
V_197 = - V_419 ;
goto V_792;
}
V_197 = F_484 ( V_6 , V_175 ) ;
if ( V_197 < 0 ) {
F_11 ( V_2 , V_337 , V_18 , L_38 ) ;
goto V_792;
}
V_23 = F_485 ( F_486 ( V_6 , V_774 ) , V_180 ) ;
if ( ! V_23 ) {
...
F_490 ( & V_2 -> V_3 . V_4 ) ;
F_491 ( & V_2 -> V_727 . V_698 ) ;
F_491 ( & V_2 -> V_697 . V_698 ) ;
if ( V_2 -> V_70 == V_114 ||
V_2 -> V_70 == V_115 ||
V_2 -> V_70 == V_116 ||
V_2 -> V_70 == V_111 ||
...
V_18 -> V_800 = & V_801 ;
V_18 -> V_802 = V_803 ;
F_492 ( V_18 , & V_2 -> V_612 , F_429 , V_804 ) ;
V_18 -> V_167 |= V_244 |
V_805 | V_247 ;
...
V_2 -> V_229 . V_812 = F_208 ;
V_2 -> V_173 = V_375 ;
V_2 -> V_287 = F_442 ( & V_6 -> V_18 , sizeof( * V_2 -> V_287 ) ,
& V_2 -> V_277 , V_465 ) ;
if ( ! V_2 -> V_287 ) {
V_197 = - V_463 ;
goto V_813;
...
V_169 [ V_776 ] . V_462 , V_23 , V_18 -> V_386 ,
( T_2 ) ( F_20 ( V_336 ) & 0x9cf0f8ff ) , V_6 -> V_728 ) ;
if ( V_169 [ V_776 ] . V_589 != V_236 ) {
...
return V_197 ;
V_814:
F_438 ( & V_6 -> V_18 , sizeof( * V_2 -> V_287 ) , V_2 -> V_287 ,
V_2 -> V_277 ) ;
V_813:
F_466 ( & V_2 -> V_612 ) ;
F_226 ( V_6 , V_2 ) ;
