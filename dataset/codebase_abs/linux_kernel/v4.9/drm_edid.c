...
if ( V_23 >= 8 ) {
V_41 -> V_276 [ 0 ] = V_241 [ 8 ] >> 7 ;
V_41 -> V_276 [ 1 ] = ( V_241 [ 8 ] >> 6 ) & 1 ;
}
if ( V_23 >= 9 )
V_41 -> V_277 [ 0 ] = V_241 [ 9 ] ;
if ( V_23 >= 10 )
V_41 -> V_278 [ 0 ] = V_241 [ 10 ] ;
if ( V_23 >= 11 )
V_41 -> V_277 [ 1 ] = V_241 [ 11 ] ;
if ( V_23 >= 12 )
V_41 -> V_278 [ 1 ] = V_241 [ 12 ] ;
F_14 ( L_19
L_20
L_21 ,
V_41 -> V_276 [ 0 ] ,
...
{
if ( V_63 -> V_21 . V_191 . type == V_279 )
* ( T_1 * * ) V_21 = V_63 -> V_21 . V_191 . V_21 . V_280 . V_280 ;
}
static int F_132 ( struct V_12 * V_12 , char V_39 [ 13 ] )
{
char * V_281 = NULL ;
int V_282 ;
if ( ! V_12 || ! V_39 )
return 0 ;
F_46 ( ( T_1 * ) V_12 , F_131 , & V_281 ) ;
for ( V_282 = 0 ; V_281 && V_282 < 13 ; V_282 ++ ) {
if ( V_281 [ V_282 ] == 0x0a )
break;
V_39 [ V_282 ] = V_281 [ V_282 ] ;
}
return V_282 ;
}
void F_133 ( struct V_12 * V_12 , char * V_39 , int V_283 )
{
int V_284 ;
char V_22 [ 13 ] ;
if ( V_283 <= 0 )
return;
V_284 = F_45 ( F_132 ( V_12 , V_22 ) , V_283 - 1 ) ;
memcpy ( V_39 , V_22 , V_284 ) ;
V_39 [ V_284 ] = '\0' ;
}
void F_134 ( struct V_40 * V_41 , struct V_12 * V_12 )
{
...
V_282 = F_132 ( V_12 , V_275 + 20 ) ;
V_275 [ 4 ] = ( V_264 [ 1 ] << 5 ) | V_282 ;
F_14 ( L_23 , V_275 + 20 ) ;
V_275 [ 0 ] = 2 << 3 ;
V_275 [ 16 ] = V_12 -> V_56 [ 0 ] ;
V_275 [ 17 ] = V_12 -> V_56 [ 1 ] ;
V_275 [ 18 ] = V_12 -> V_286 [ 0 ] ;
V_275 [ 19 ] = V_12 -> V_286 [ 1 ] ;
if ( F_125 ( V_264 ) >= 3 ) {
int V_2 , V_26 , V_265 ;
if ( F_126 ( V_264 , & V_26 , & V_265 ) ) {
V_26 = 0 ;
...
int V_287 ;
case V_288 :
V_287 = F_45 ( V_272 / 3 , 15 - V_285 ) ;
if ( V_287 >= 1 )
memcpy ( V_275 + 20 + V_282 + V_285 * 3 ,
& V_241 [ 1 ] , V_287 * 3 ) ;
V_285 += V_287 ;
break;
case V_289 :
...
int F_138 ( struct V_12 * V_12 , struct V_291 * * V_292 )
{
int V_293 = 0 ;
...
V_272 = F_123 ( V_241 ) ;
V_293 = V_272 / 3 ;
* V_292 = F_139 ( V_293 , sizeof( * * V_292 ) , V_48 ) ;
if ( ! * V_292 )
return - V_297 ;
for ( V_42 = 0 ; V_42 < V_293 ; V_42 ++ ) {
T_1 * V_298 = & V_241 [ 1 + V_42 * 3 ] ;
( * V_292 ) [ V_42 ] . V_299 = ( V_298 [ 0 ] & 0x78 ) >> 3 ;
( * V_292 ) [ V_42 ] . V_300 = V_298 [ 0 ] & 0x7 ;
( * V_292 ) [ V_42 ] . V_301 = V_298 [ 1 ] & 0x7F ;
( * V_292 ) [ V_42 ] . V_302 = V_298 [ 2 ] ;
}
break;
}
}
...
int F_140 ( struct V_12 * V_12 , T_1 * * V_303 )
{
int V_293 = 0 ;
int V_2 , V_26 , V_265 , V_272 ;
const T_1 * V_264 ;
...
if ( F_124 ( V_241 ) == V_289 ) {
V_272 = F_123 ( V_241 ) ;
if ( V_272 == 3 ) {
* V_303 = F_28 ( & V_241 [ 1 ] , V_272 , V_48 ) ;
if ( ! * V_303 )
return - V_297 ;
V_293 = V_272 ;
break;
...
if ( ! V_41 -> V_276 [ 1 ] )
V_2 = 0 ;
V_110 = V_41 -> V_278 [ V_2 ] ;
V_304 = V_41 -> V_277 [ V_2 ] ;
if ( V_110 == 255 || V_304 == 255 )
return 0 ;
if ( V_110 )
V_110 = F_45 ( 2 * ( V_110 - 1 ) , 500 ) ;
if ( V_304 )
V_304 = F_45 ( 2 * ( V_304 - 1 ) , 500 ) ;
return F_142 ( V_304 - V_110 , 0 ) ;
}
struct V_40 * F_143 ( struct V_305 * V_306 )
{
struct V_40 * V_41 ;
struct V_82 * V_52 = V_306 -> V_52 ;
F_6 ( ! F_144 ( & V_52 -> V_307 . V_308 ) ) ;
F_6 ( ! F_145 ( & V_52 -> V_307 . V_309 ) ) ;
F_146 (connector, dev)
if ( V_41 -> V_306 == V_306 && V_41 -> V_275 [ 0 ] )
return V_41 ;
return NULL ;
}
...
if ( F_124 ( & V_221 [ V_2 ] ) == V_314 &&
F_123 ( & V_221 [ V_2 ] ) == 2 ) {
F_14 ( L_30 , V_221 [ V_2 + 2 ] ) ;
return V_221 [ V_2 + 2 ] & V_315 ;
}
}
return false ;
}
...
static void
F_151 ( struct V_40 * V_41 , const T_1 * V_241 )
{
struct V_316 * V_317 = & V_41 -> V_318 ;
T_1 V_23 = F_123 ( V_241 ) ;
if ( V_23 >= 6 )
V_317 -> V_329 = V_241 [ 6 ] & 1 ;
if ( V_23 >= 7 )
V_317 -> V_330 = V_241 [ 7 ] * 5000 ;
F_14 ( L_38
L_39 ,
V_317 -> V_329 ,
V_317 -> V_330 ) ;
...
{
struct V_316 * V_317 = & V_41 -> V_318 ;
V_317 -> V_166 = V_12 -> V_173 * 10 ;
V_317 -> V_169 = V_12 -> V_174 * 10 ;
V_317 -> V_320 = 0 ;
V_317 -> V_325 = 0 ;
V_317 -> V_331 = 0 ;
V_317 -> V_330 = 0 ;
...
return;
F_152 ( V_41 , V_12 ) ;
if ( ( V_317 -> V_320 == 0 ) && ( V_12 -> V_16 < 4 ) &&
( V_12 -> V_102 & V_335 ) ) {
V_317 -> V_320 = 8 ;
F_7 ( L_40 ,
V_41 -> V_39 , V_317 -> V_320 ) ;
}
if ( V_12 -> V_16 < 4 )
return;
switch ( V_12 -> V_102 & V_336 ) {
case V_337 :
V_317 -> V_320 = 6 ;
break;
case V_338 :
...
static int F_154 ( T_1 * V_346 , int V_8 , int V_347 )
{
int V_2 ;
T_1 V_5 = 0 ;
struct V_348 * V_349 ;
V_349 = (struct V_348 * ) & V_346 [ V_347 ] ;
F_14 ( L_42 ,
V_349 -> V_350 , V_349 -> V_351 , V_349 -> V_352 , V_349 -> V_353 ) ;
if ( V_349 -> V_351 + 5 > V_8 - V_347 )
return - V_354 ;
for ( V_2 = V_347 ; V_2 <= V_349 -> V_351 + 5 ; V_2 ++ ) {
V_5 += V_346 [ V_2 ] ;
}
if ( V_5 ) {
F_8 ( L_43 , V_5 ) ;
...
static struct V_62 * F_155 ( struct V_82 * V_52 ,
struct V_355 * V_206 )
{
struct V_62 * V_75 ;
unsigned V_158 = ( V_206 -> V_158 [ 0 ] |
( V_206 -> V_158 [ 1 ] << 8 ) |
( V_206 -> V_158 [ 2 ] << 16 ) ) ;
unsigned V_135 = ( V_206 -> V_135 [ 0 ] | V_206 -> V_135 [ 1 ] << 8 ) + 1 ;
unsigned V_141 = ( V_206 -> V_141 [ 0 ] | V_206 -> V_141 [ 1 ] << 8 ) + 1 ;
unsigned V_176 = ( V_206 -> V_176 [ 0 ] | ( V_206 -> V_176 [ 1 ] & 0x7f ) << 8 ) + 1 ;
unsigned V_356 = ( V_206 -> V_357 [ 0 ] | V_206 -> V_357 [ 1 ] << 8 ) + 1 ;
unsigned V_138 = ( V_206 -> V_138 [ 0 ] | V_206 -> V_138 [ 1 ] << 8 ) + 1 ;
unsigned V_143 = ( V_206 -> V_143 [ 0 ] | V_206 -> V_143 [ 1 ] << 8 ) + 1 ;
unsigned V_179 = ( V_206 -> V_179 [ 0 ] | ( V_206 -> V_179 [ 1 ] & 0x7f ) << 8 ) + 1 ;
unsigned V_358 = ( V_206 -> V_359 [ 0 ] | V_206 -> V_359 [ 1 ] << 8 ) + 1 ;
bool V_360 = ( V_206 -> V_176 [ 1 ] >> 7 ) & 0x1 ;
bool V_361 = ( V_206 -> V_179 [ 1 ] >> 7 ) & 0x1 ;
V_75 = F_66 ( V_52 ) ;
if ( ! V_75 )
return NULL ;
V_75 -> clock = V_158 * 10 ;
V_75 -> V_77 = V_135 ;
V_75 -> V_79 = V_75 -> V_77 + V_176 ;
V_75 -> V_78 = V_75 -> V_79 + V_356 ;
V_75 -> V_76 = V_75 -> V_77 + V_141 ;
V_75 -> V_81 = V_138 ;
V_75 -> V_80 = V_75 -> V_81 + V_179 ;
V_75 -> V_130 = V_75 -> V_80 + V_358 ;
V_75 -> V_131 = V_75 -> V_81 + V_143 ;
V_75 -> V_35 = 0 ;
V_75 -> V_35 |= V_360 ? V_162 : V_163 ;
V_75 -> V_35 |= V_361 ? V_164 : V_165 ;
V_75 -> type = V_175 ;
if ( V_206 -> V_35 & 0x80 )
V_75 -> type |= V_73 ;
V_75 -> V_74 = F_38 ( V_75 ) ;
...
struct V_362 * V_9 )
{
struct V_363 * V_364 = (struct V_363 * ) V_9 ;
int V_2 ;
int V_365 ;
struct V_62 * V_185 ;
int V_366 = 0 ;
...
return 0 ;
V_365 = V_9 -> V_367 / 20 ;
for ( V_2 = 0 ; V_2 < V_365 ; V_2 ++ ) {
struct V_355 * V_206 = & V_364 -> V_206 [ V_2 ] ;
V_185 = F_155 ( V_41 -> V_52 , V_206 ) ;
if ( ! V_185 )
continue;
F_76 ( V_41 , V_185 ) ;
V_366 ++ ;
...
if ( ! V_346 )
return 0 ;
V_29 = F_154 ( V_346 , V_8 , V_347 ) ;
if ( V_29 )
return 0 ;
V_347 += sizeof( struct V_348 ) ;
while ( V_9 = (struct V_362 * ) & V_346 [ V_347 ] ,
V_347 + sizeof( struct V_362 ) <= V_8 &&
V_347 + sizeof( struct V_362 ) + V_9 -> V_367 <= V_8 &&
V_9 -> V_367 > 0 ) {
V_347 += V_9 -> V_367 + sizeof( struct V_362 ) ;
switch ( V_9 -> V_368 ) {
case V_369 :
V_366 += F_156 ( V_41 , V_9 ) ;
break;
}
}
return V_366 ;
...
if ( ! F_11 ( V_12 ) ) {
F_19 ( V_41 -> V_52 -> V_52 , L_44 ,
V_41 -> V_39 ) ;
return 0 ;
}
V_61 = F_30 ( V_12 ) ;
V_366 += F_93 ( V_41 , V_12 , V_61 ) ;
V_366 += F_90 ( V_41 , V_12 ) ;
V_366 += F_87 ( V_41 , V_12 ) ;
V_366 += F_85 ( V_41 , V_12 ) ;
V_366 += F_128 ( V_41 , V_12 ) ;
V_366 += F_110 ( V_41 , V_12 ) ;
V_366 += F_157 ( V_41 , V_12 ) ;
if ( V_12 -> V_104 & V_105 )
V_366 += F_82 ( V_41 , V_12 ) ;
if ( V_61 & ( V_70 | V_71 ) )
F_33 ( V_41 , V_61 ) ;
F_153 ( V_41 , V_12 ) ;
if ( V_61 & V_370 )
...
if ( V_75 -> V_35 & V_378 )
V_376 -> V_379 = 1 ;
V_376 -> V_231 = F_101 ( V_75 ) ;
V_376 -> V_380 = V_381 ;
if ( V_75 -> V_232 == V_382 ||
V_75 -> V_232 == V_383 )
V_376 -> V_380 = V_75 -> V_232 ;
else if ( V_376 -> V_231 > 0 )
V_376 -> V_380 = F_105 (
V_376 -> V_231 ) ;
V_376 -> V_384 = V_385 ;
V_376 -> V_386 = V_387 ;
...
static enum V_388
F_163 ( const struct V_62 * V_75 )
{
T_3 V_389 = V_75 -> V_35 & V_237 ;
switch ( V_389 ) {
case V_251 :
return V_390 ;
case V_391 :
...
V_376 -> V_406 = F_163 ( V_75 ) ;
return 0 ;
}
static int F_166 ( struct V_40 * V_41 ,
struct V_362 * V_9 )
{
struct V_407 * V_408 = (struct V_407 * ) V_9 ;
T_5 V_125 , V_126 ;
T_1 V_409 , V_410 ;
T_1 V_411 , V_412 ;
struct V_413 * V_414 ;
V_125 = V_408 -> V_415 [ 0 ] | V_408 -> V_415 [ 1 ] << 8 ;
V_126 = V_408 -> V_415 [ 2 ] | V_408 -> V_415 [ 3 ] << 8 ;
V_411 = ( V_408 -> V_416 [ 0 ] & 0xf ) | ( V_408 -> V_416 [ 2 ] & 0x30 ) ;
V_412 = ( V_408 -> V_416 [ 0 ] >> 4 ) | ( ( V_408 -> V_416 [ 2 ] >> 2 ) & 0x30 ) ;
V_409 = ( V_408 -> V_416 [ 1 ] & 0xf ) | ( ( V_408 -> V_416 [ 2 ] & 0x3 ) << 4 ) ;
V_410 = ( V_408 -> V_416 [ 1 ] >> 4 ) | ( ( ( V_408 -> V_416 [ 2 ] >> 2 ) & 0x3 ) << 4 ) ;
V_41 -> V_417 = true ;
if ( V_408 -> V_418 & 0x80 )
V_41 -> V_419 = true ;
V_41 -> V_412 = V_412 + 1 ;
...
V_41 -> V_420 = V_125 + 1 ;
V_41 -> V_421 = V_126 + 1 ;
F_14 ( L_45 , V_408 -> V_418 ) ;
F_14 ( L_46 , V_125 + 1 , V_126 + 1 ) ;
F_14 ( L_47 ,
V_412 + 1 , V_411 + 1 , V_410 , V_409 ) ;
F_14 ( L_48 , V_408 -> V_422 [ 0 ] , V_408 -> V_422 [ 1 ] , V_408 -> V_422 [ 2 ] ) ;
V_414 = F_167 ( V_41 -> V_52 , V_408 -> V_422 ) ;
if ( ! V_414 ) {
V_414 = F_168 ( V_41 -> V_52 , V_408 -> V_422 ) ;
}
if ( ! V_414 )
return - V_297 ;
if ( V_41 -> V_423 != V_414 ) {
if ( V_41 -> V_423 ) {
F_169 ( V_41 -> V_52 , V_41 -> V_423 ) ;
}
V_41 -> V_423 = V_414 ;
} else
F_169 ( V_41 -> V_52 , V_414 ) ;
return 0 ;
}
...
V_29 = F_170 ( V_41 , V_346 , V_6 , true ) ;
if ( V_29 < 0 )
goto V_426;
if ( ! V_41 -> V_417 )
goto V_426;
