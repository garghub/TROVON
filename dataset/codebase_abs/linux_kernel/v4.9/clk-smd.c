...
F_9 ( struct V_8 * V_8 , const char * V_19 ,
const char * * V_20 , T_1 V_21 )
{
struct V_4 * V_5 ;
struct V_1 * V_2 ;
struct V_22 V_23 ;
...
static void T_2 F_14 ( struct V_32 * V_33 )
{
struct V_1 * V_2 ;
unsigned int V_21 ;
const char * V_20 [ V_34 ] ;
const char * V_19 = V_33 -> V_19 ;
struct V_8 * V_8 ;
V_21 = F_15 ( V_33 ) ;
if ( V_21 == 0 || V_21 > V_34 )
return;
