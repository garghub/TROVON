...
V_73 = F_65 ( & V_2 -> V_106 , struct V_102 ,
V_107 ) ;
F_66 ( & V_73 -> V_107 ) ;
F_6 ( & V_2 -> V_105 , V_6 ) ;
F_58 ( V_2 , & V_73 -> V_73 . V_108 , V_85 ) ;
V_104:
F_67 ( & V_2 -> V_103 ) ;
}
...
static int F_74 ( void * V_121 )
{
struct V_3 * V_3 = V_121 ;
F_75 ( V_122 , V_123 ) ;
F_76 () ;
F_77 ( & V_3 -> V_109 , & V_122 ) ;
for (; ; ) {
long V_124 = F_78 ( V_125 ) ;
if ( V_124 == - V_126 || F_79 () )
break;
F_70 ( V_3 ) ;
F_80 () ;
}
F_81 ( & V_3 -> V_109 , & V_122 ) ;
return 0 ;
}
...
{
struct V_74 * V_56 = F_50 ( V_73 ) ;
struct V_127 * V_135 = V_73 -> V_127 ;
struct V_1 * V_2 = F_84 ( V_135 ) ;
struct V_102 * V_136 =
F_85 ( V_56 , struct V_102 , V_73 ) ;
F_86 ( & V_2 -> V_105 ) ;
F_87 ( & V_136 -> V_107 , & V_2 -> V_106 ) ;
F_88 ( & V_2 -> V_105 ) ;
}
static int F_89 ( struct V_3 * V_3 )
{
V_3 -> V_137 = F_90 ( F_74 , V_3 ,
V_138 L_2 ) ;
if ( F_91 ( V_3 -> V_137 ) ) {
int V_139 = F_92 ( V_3 -> V_137 ) ;
V_3 -> V_137 = NULL ;
return V_139 ;
}
F_93 ( V_3 , V_140 ) ;
...
static int F_97 ( struct V_127 * V_128 , unsigned int V_141 )
{
struct V_1 * V_2 = F_84 ( V_128 ) ;
return F_13 ( V_2 ) ;
}
static void F_98 ( struct V_127 * V_128 )
{
struct V_1 * V_2 = F_84 ( V_128 ) ;
unsigned long V_6 ;
F_3 ( & V_2 -> V_105 , V_6 ) ;
F_23 ( V_2 ) ;
while ( ! F_64 ( & V_2 -> V_106 ) ) {
struct V_102 * V_142 = F_99 (
V_2 -> V_106 . V_143 ,
struct V_102 , V_107 ) ;
F_66 ( & V_142 -> V_107 ) ;
F_61 ( & V_142 -> V_73 . V_108 , V_100 ) ;
}
F_6 ( & V_2 -> V_105 , V_6 ) ;
}
static void F_100 ( struct V_72 * V_73 )
{
struct V_74 * V_56 = F_50 ( V_73 ) ;
struct V_1 * V_2 = F_84 ( V_73 -> V_127 ) ;
struct V_55 * V_75 = F_51 ( V_73 , 0 ) ;
switch ( V_2 -> V_86 ) {
case V_87 :
case V_88 :
if ( V_56 -> V_6 & V_77 )
F_101 ( V_75 -> V_144 , V_75 -> V_145 ,
V_2 -> V_16 , V_2 -> V_15 ) ;
break;
default:
F_101 ( V_75 -> V_144 , V_75 -> V_145 ,
...
static int F_102 ( struct V_146 * V_146 , void * V_147 ,
struct V_148 * V_149 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
strcpy ( V_149 -> V_150 , V_138 ) ;
snprintf ( V_149 -> V_151 , sizeof( V_149 -> V_151 ) , L_3 ,
V_2 -> V_5 ) ;
snprintf ( V_149 -> V_152 , sizeof( V_149 -> V_152 ) , L_4 ,
F_104 ( V_3 -> V_117 ) ) ;
V_149 -> V_153 = V_154 |
V_155 | V_156 ;
...
static int F_105 ( struct V_146 * V_146 , void * V_147 ,
struct V_159 * V_160 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
if ( V_160 -> V_161 )
return - V_53 ;
snprintf ( V_160 -> V_162 , sizeof( V_160 -> V_162 ) , L_5 ,
V_2 -> V_5 + 1 ) ;
V_160 -> type = V_163 ;
V_160 -> V_164 = V_2 -> V_99 -> V_165 ;
if ( ! F_106 ( V_3 , V_2 -> V_5 ) )
V_160 -> V_166 = V_167 ;
return 0 ;
}
static int F_107 ( struct V_146 * V_146 , void * V_147 ,
unsigned int V_161 )
{
if ( V_161 )
return - V_53 ;
...
static int F_108 ( struct V_146 * V_146 , void * V_147 ,
unsigned int * V_161 )
{
* V_161 = 0 ;
return 0 ;
}
static int F_109 ( struct V_146 * V_146 , void * V_147 ,
struct V_168 * V_169 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
...
static inline int F_110 ( T_1 V_175 , int V_170 )
{
return ( V_175 == V_88 && V_170 == V_27 )
|| ( V_175 == V_87 && V_170 == V_38 )
|| V_175 == V_173 ? 0 : - V_53 ;
}
static int F_111 ( struct V_146 * V_146 , void * V_147 ,
struct V_176 * V_169 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
struct V_177 * V_178 = & V_169 -> V_86 . V_178 ;
if ( F_110 ( V_178 -> V_171 , V_3 -> type ) )
return - V_53 ;
...
static int F_112 ( struct V_146 * V_146 , void * V_147 ,
struct V_176 * V_169 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
...
V_2 -> V_18 = V_22 ;
V_2 -> V_86 = V_178 -> V_171 ;
F_10 ( V_2 ) ;
return 0 ;
}
static int F_114 ( struct V_146 * V_146 , void * V_147 ,
struct V_176 * V_169 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_177 * V_178 = & V_169 -> V_86 . V_178 ;
...
static int F_115 ( struct V_146 * V_146 , void * V_147 , T_6 * V_61 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
if ( V_3 -> V_28 == V_29 )
...
static int F_116 ( struct V_146 * V_146 , void * V_147 , T_6 V_164 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
return F_117 ( V_2 -> V_3 , V_164 & V_191 ) ;
}
static int F_118 ( struct V_146 * V_146 , void * V_147 ,
struct V_192 * V_193 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
if ( F_110 ( V_193 -> V_194 , V_3 -> type ) )
return - V_53 ;
switch ( V_193 -> V_161 ) {
case 0 :
...
static int F_119 ( struct V_146 * V_146 , void * V_147 ,
struct V_197 * V_198 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
if ( F_110 ( V_198 -> V_194 , V_3 -> type ) )
return - V_53 ;
if ( V_198 -> V_161 )
return - V_53 ;
...
static int F_120 ( struct V_146 * V_146 , void * V_147 ,
struct V_204 * V_205 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
...
static inline int F_121 ( T_2 V_20 , T_1 V_215 , T_1 V_216 )
{
if ( ! V_215 || ! V_216 )
return 1 ;
if ( V_216 == V_20 )
...
static int F_122 ( struct V_146 * V_146 , void * V_147 ,
struct V_204 * V_205 )
{
struct V_1 * V_2 = F_103 ( V_146 ) ;
...
if ( F_123 ( & V_2 -> V_187 ) )
return - V_45 ;
V_2 -> V_21 = F_121 ( V_20 , V_218 -> V_201 , V_218 -> V_202 ) ;
F_10 ( V_2 ) ;
return F_120 ( V_146 , V_147 , V_205 ) ;
}
static int F_124 ( struct V_219 * V_220 )
{
struct V_1 * V_2 =
F_85 ( V_220 -> V_221 , struct V_1 , V_222 ) ;
struct V_3 * V_3 = V_2 -> V_3 ;
int V_139 ;
switch ( V_220 -> V_223 ) {
case V_224 :
...
case V_227 :
case V_228 :
return F_125 ( V_3 , V_220 -> V_223 , V_2 -> V_5 ,
V_220 -> V_229 ) ;
case V_230 :
...
if ( V_220 -> V_229 ) {
if ( V_2 -> V_234 )
V_139 = F_126 ( V_3 , V_2 -> V_5 ,
V_2 -> V_233 ) ;
else
V_139 = F_127 ( V_3 , V_2 -> V_5 ,
...
static int F_129 ( struct V_247 * V_248 ,
const struct V_249 * V_250 )
{
switch ( V_250 -> type ) {
case V_251 :
return F_130 ( V_248 , V_250 ) ;
case V_93 :
return F_131 ( V_248 , V_250 , 30 , NULL ) ;
}
return - V_53 ;
}
static struct V_1 * F_132 ( struct V_3 * V_3 ,
T_2 V_5 , unsigned V_252 )
{
struct V_1 * V_2 ;
struct V_253 * V_222 ;
int V_8 ;
V_2 = F_133 ( sizeof( * V_2 ) , V_254 ) ;
if ( ! V_2 )
return F_134 ( - V_255 ) ;
V_222 = & V_2 -> V_222 ;
F_135 ( V_222 , 10 ) ;
...
V_232 , 0 , 0xff , 1 ,
V_259 >> 8 ) ;
F_139 ( V_222 , & V_260 , NULL ) ;
V_2 -> V_239 =
F_139 ( V_222 , & V_261 , NULL ) ;
if ( V_222 -> error ) {
V_8 = V_222 -> error ;
goto V_262;
}
...
V_2 -> V_187 . V_272 = V_2 ;
V_2 -> V_187 . V_273 = V_274 | V_275 ;
V_2 -> V_187 . V_276 = V_277 ;
V_2 -> V_187 . V_278 = sizeof( struct V_102 ) ;
V_2 -> V_187 . V_103 = & V_2 -> V_103 ;
V_2 -> V_187 . V_118 = & V_3 -> V_117 -> V_118 ;
V_8 = F_143 ( & V_2 -> V_187 ) ;
if ( V_8 )
goto V_262;
F_10 ( V_2 ) ;
...
goto V_279;
* V_2 -> V_99 = V_280 ;
V_2 -> V_99 -> V_281 = & V_3 -> V_281 ;
V_2 -> V_99 -> V_282 = V_222 ;
V_2 -> V_99 -> V_283 = & V_2 -> V_187 ;
V_2 -> V_99 -> V_103 = & V_2 -> V_103 ;
F_146 ( V_2 -> V_99 , V_2 ) ;
V_8 = F_147 ( V_2 -> V_99 , V_284 , V_252 ) ;
if ( V_8 < 0 )
goto V_285;
snprintf ( V_2 -> V_99 -> V_162 , sizeof( V_2 -> V_99 -> V_162 ) ,
L_9 , V_138 , V_3 -> V_99 -> V_286 ,
V_2 -> V_99 -> V_286 ) ;
return V_2 ;
V_285:
F_148 ( V_2 -> V_99 ) ;
...
V_3 -> V_120 = F_144 ( V_3 -> V_117 ,
V_3 -> V_287 ,
& V_3 -> V_119 ) ;
if ( V_3 -> V_120 == NULL )
return - V_255 ;
for ( V_61 = 0 ; V_61 < V_3 -> V_288 ; V_61 ++ ) {
V_3 -> V_116 [ V_61 ] = F_132 ( V_3 , V_61 , V_252 ) ;
if ( F_91 ( V_3 -> V_116 [ V_61 ] ) )
break;
}
if ( V_61 != V_3 -> V_288 ) {
int V_8 = F_92 ( V_3 -> V_116 [ V_61 ] ) ;
while ( V_61 -- )
F_152 ( V_3 -> V_116 [ V_61 ] ) ;
F_149 ( V_3 -> V_117 , V_3 -> V_287 ,
V_3 -> V_120 , V_3 -> V_119 ) ;
V_3 -> V_120 = NULL ;
return V_8 ;
}
...
V_3 -> V_116 [ 0 ] -> V_99 -> V_286 ,
V_3 -> V_116 [ V_3 -> V_288 - 1 ] -> V_99 -> V_286 ) ;
return F_89 ( V_3 ) ;
}
