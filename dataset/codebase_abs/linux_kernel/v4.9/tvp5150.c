...
{
struct V_1 * V_95 = F_1 ( V_3 ) ;
struct V_178 V_146 = V_177 -> V_179 ;
T_2 V_125 ;
int V_180 ;
...
return - V_160 ;
F_8 ( 1 , V_12 , V_3 , L_68 ,
V_105 , V_146 . V_185 , V_146 . V_186 , V_146 . V_169 , V_146 . V_147 ) ;
V_146 . V_185 = F_28 ( V_146 . V_185 , 0 , V_187 ) ;
V_146 . V_169 = F_29 (unsigned int, rect.width,
TVP5150_H_MAX - TVP5150_MAX_CROP_LEFT - rect.left,
TVP5150_H_MAX - rect.left) ;
V_146 . V_186 = F_28 ( V_146 . V_186 , 0 , V_188 ) ;
if ( V_95 -> V_126 == V_128 )
V_125 = F_25 ( V_3 ) ;
else
V_125 = V_95 -> V_126 ;
...
hmax - rect.top) ;
F_9 ( V_3 , V_40 , V_146 . V_186 ) ;
F_9 ( V_3 , V_41 ,
V_146 . V_186 + V_146 . V_147 - V_180 ) ;
F_9 ( V_3 , V_34 ,
V_146 . V_185 >> V_189 ) ;
F_9 ( V_3 , V_35 ,
V_146 . V_185 | ( 1 << V_189 ) ) ;
F_9 ( V_3 , V_36 ,
( V_146 . V_185 + V_146 . V_169 - V_187 ) >>
V_189 ) ;
F_9 ( V_3 , V_37 ,
V_146 . V_185 + V_146 . V_169 - V_187 ) ;
V_95 -> V_146 = V_146 ;
...
struct V_176 * V_177 )
{
struct V_1 * V_95 = F_2 ( V_3 , struct V_1 , V_3 ) ;
T_2 V_125 ;
if ( V_177 -> V_181 != V_182 )
return - V_160 ;
switch ( V_177 -> V_183 ) {
...
V_177 -> V_179 . V_185 = 0 ;
V_177 -> V_179 . V_186 = 0 ;
V_177 -> V_179 . V_169 = V_192 ;
if ( V_95 -> V_126 == V_128 )
V_125 = F_25 ( V_3 ) ;
else
V_125 = V_95 -> V_126 ;
if ( V_125 & V_145 )
V_177 -> V_179 . V_147 = V_148 ;
else
V_177 -> V_179 . V_147 = V_149 ;
return 0 ;
case V_184 :
V_177 -> V_179 = V_95 -> V_146 ;
return 0 ;
default:
return - V_160 ;
}
...
static int F_34 ( struct V_206 * V_207 ,
const struct V_208 * V_209 ,
const struct V_208 * V_210 , T_3 V_123 )
{
#ifdef F_35
struct V_2 * V_3 = F_36 ( V_207 ) ;
struct V_1 * V_95 = F_1 ( V_3 ) ;
int V_18 ;
...
static int F_37 ( struct V_2 * V_3 , int V_100 )
{
struct V_1 * V_95 = F_1 ( V_3 ) ;
int V_97 = 0x09 ;
if ( V_95 -> V_152 == V_153 )
...
static int F_39 ( struct V_2 * V_3 , struct V_215 * V_131 )
{
...
static int F_40 ( struct V_2 * V_3 , struct V_219 * V_220 )
{
int V_18 ;
if ( V_220 -> V_122 != 0 ) {
...
static int F_42 ( struct V_2 * V_3 , struct V_222 * V_108 )
{
int V_223 ;
...
static int F_43 ( struct V_2 * V_3 , const struct V_222 * V_108 )
{
return F_9 ( V_3 , V_108 -> V_108 & 0xff , V_108 -> V_97 & 0xff ) ;
}
static int F_44 ( struct V_2 * V_3 , struct V_225 * V_226 )
{
...
V_130 = F_46 ( V_96 , 1 , V_168 ) ;
if ( V_130 < 0 )
return V_130 ;
V_130 = F_47 ( V_3 -> V_231 -> V_232 , V_96 ) ;
if ( V_130 < 0 )
return V_130 ;
V_130 = F_48 ( V_96 , 0 , & V_3 -> V_207 ,
V_233 , 0 ) ;
if ( V_130 < 0 ) {
F_49 ( V_96 ) ;
return V_130 ;
...
static int F_50 ( struct V_1 * V_234 )
{
...
struct V_236 * V_237 ;
struct V_236 * V_238 ;
V_237 = F_53 ( & V_10 -> V_239 , L_74 , V_240 ) ;
if ( F_54 ( V_237 ) )
return F_55 ( V_237 ) ;
if ( V_237 ) {
F_56 ( V_237 , 0 ) ;
...
V_238 = F_53 ( & V_10 -> V_239 , L_75 , V_240 ) ;
if ( F_54 ( V_238 ) )
return F_55 ( V_238 ) ;
if ( V_238 ) {
F_58 ( 500 ) ;
...
static int F_60 ( struct V_1 * V_95 , struct V_241 * V_242 )
{
struct V_243 V_244 ;
struct V_241 * V_245 ;
#ifdef F_35
...
unsigned int V_123 ;
int V_130 = 0 ;
V_245 = F_61 ( V_242 , NULL ) ;
if ( ! V_245 )
return - V_160 ;
V_130 = F_62 ( V_245 , & V_244 ) ;
if ( V_130 )
goto V_249;
...
#ifdef F_35
V_246 = F_63 ( V_242 , L_76 ) ;
if ( ! V_246 )
goto V_249;
F_64 (connectors, child) {
V_130 = F_65 ( V_247 , L_77 , & V_248 ) ;
if ( V_130 ) {
F_7 ( & V_95 -> V_3 ,
L_78 ,
V_247 -> V_229 ) ;
...
if ( V_223 )
return V_223 ;
V_234 = F_70 ( & V_10 -> V_239 , sizeof( * V_234 ) , V_265 ) ;
if ( ! V_234 )
return - V_266 ;
V_3 = & V_234 -> V_3 ;
if ( F_71 ( V_267 ) && V_242 ) {
V_223 = F_60 ( V_234 , V_242 ) ;
if ( V_223 ) {
F_7 ( V_3 , L_82 , V_223 ) ;
return V_223 ;
}
...
V_3 -> V_123 |= V_272 ;
#if F_73 ( F_35 )
V_234 -> V_273 [ V_233 ] . V_123 = V_274 ;
V_234 -> V_273 [ V_275 ] . V_123 = V_230 ;
V_234 -> V_273 [ V_276 ] . V_123 = V_230 ;
V_3 -> V_207 . V_256 = V_277 ;
V_223 = F_46 ( & V_3 -> V_207 , V_278 , V_234 -> V_273 ) ;
if ( V_223 < 0 )
return V_223 ;
V_3 -> V_207 . V_279 = & V_280 ;
#endif
V_223 = F_50 ( V_234 ) ;
if ( V_223 < 0 )
return V_223 ;
