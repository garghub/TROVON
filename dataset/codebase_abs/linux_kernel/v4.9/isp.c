...
V_311 -> V_350 . V_351 . V_352 . V_309 = F_205 ( V_309 ) ;
F_204 ( V_309 ) ;
...
if ( ! V_2 ) {
F_119 ( & V_307 -> V_24 , L_78 ) ;
return - V_348 ;
}
V_153 = F_214 ( V_307 -> V_24 . V_35 , L_79 ,
& V_2 -> V_363 ) ;
if ( V_153 )
return V_153 ;
...
V_153 = F_216 ( V_307 -> V_24 . V_35 , L_80 , 1 ,
& V_2 -> V_365 ) ;
if ( V_153 )
return V_153 ;
...
goto error;
F_220 ( V_307 , V_2 ) ;
V_2 -> V_367 . V_368 = F_221 ( & V_307 -> V_24 , L_81 ) ;
V_2 -> V_369 . V_368 = F_221 ( & V_307 -> V_24 , L_82 ) ;
