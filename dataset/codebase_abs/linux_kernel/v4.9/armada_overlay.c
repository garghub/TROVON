...
if ( F_21 ( & V_28 -> V_6 , V_81 / 25 ) == 0 )
F_22 ( V_4 , & V_28 -> V_6 ) ;
if ( V_34 -> V_30 != V_30 ) {
struct V_82 * V_83 = F_23 ( V_30 ) ;
T_1 V_84 [ 3 ] , V_85 ;
int V_86 , V_87 , V_88 ;
F_24 ( V_30 ) ;
if ( V_34 -> V_30 )
...
V_47 * V_30 -> V_92 [ V_86 ] +
V_46 * F_27 ( V_85 , V_86 ) ;
for (; V_86 < F_28 ( V_84 ) ; V_86 ++ )
V_84 [ V_86 ] = 0 ;
F_29 ( V_28 -> V_37 . V_38 , V_62 , V_84 [ 0 ] ,
V_93 ) ;
F_29 ( V_28 -> V_37 . V_38 , V_62 , V_84 [ 1 ] ,
V_94 ) ;
F_29 ( V_28 -> V_37 . V_38 , V_62 , V_84 [ 2 ] ,
V_95 ) ;
F_29 ( V_28 -> V_37 . V_38 , V_62 , V_84 [ 0 ] ,
V_96 ) ;
F_29 ( V_28 -> V_37 . V_38 , V_62 , V_84 [ 1 ] ,
...
static int F_45 ( struct V_123 * V_32 )
{
struct V_110 * V_111 = V_32 -> V_112 ;
if ( V_111 -> V_114 )
return 0 ;
V_111 -> V_114 = F_46 ( V_32 , 0 ,
L_1 , 0 , 0xffffff ) ;
V_111 -> V_115 = F_46 ( V_32 , 0 ,
L_2 , 0 , 0xffffff ) ;
V_111 -> V_116 = F_46 ( V_32 , 0 ,
L_3 , 0 , 0xffffff ) ;
V_111 -> V_117 = F_46 ( V_32 , 0 ,
L_4 , 0 , 0xffffff ) ;
V_111 -> V_118 = F_46 ( V_32 , 0 ,
L_5 , 0 , 0xffffff ) ;
V_111 -> V_119 = F_47 ( V_32 , 0 ,
L_6 ,
V_124 ,
F_28 ( V_124 ) ) ;
V_111 -> V_120 = F_46 ( V_32 , 0 ,
L_7 , 0 , 256 + 255 ) ;
V_111 -> V_121 = F_46 ( V_32 , 0 ,
L_8 , 0 , 0x7fff ) ;
V_111 -> V_122 = F_46 ( V_32 , 0 ,
L_9 , 0 , 0x7fff ) ;
if ( ! V_111 -> V_114 )
return - V_125 ;
return 0 ;
}
int F_48 ( struct V_123 * V_32 , unsigned long V_126 )
{
struct V_110 * V_111 = V_32 -> V_112 ;
struct V_127 * V_128 ;
struct V_27 * V_28 ;
...
V_64 = F_51 ( V_32 , & V_28 -> V_6 . V_6 , V_126 ,
& V_131 ,
V_132 ,
F_28 ( V_132 ) ,
V_133 , NULL ) ;
...
V_28 -> V_2 . V_19 = F_44 ( V_134 ) ;
V_28 -> V_2 . V_12 = 0 ;
V_28 -> V_2 . V_13 = 0x4000 ;
V_28 -> V_2 . V_15 = 0x4000 ;
V_128 = & V_28 -> V_6 . V_6 . V_6 ;
F_52 ( V_128 , V_111 -> V_114 ,
0x0101fe ) ;
F_52 ( V_128 , V_111 -> V_115 ,
0x0101fe ) ;
F_52 ( V_128 , V_111 -> V_116 ,
0x0101fe ) ;
F_52 ( V_128 , V_111 -> V_117 ,
0x0101fe ) ;
F_52 ( V_128 , V_111 -> V_118 ,
0x000000 ) ;
F_52 ( V_128 , V_111 -> V_119 ,
V_134 ) ;
F_52 ( V_128 , V_111 -> V_120 , 256 ) ;
F_52 ( V_128 , V_111 -> V_121 ,
V_28 -> V_2 . V_13 ) ;
F_52 ( V_128 , V_111 -> V_122 ,
V_28 -> V_2 . V_15 ) ;
return 0 ;
}
