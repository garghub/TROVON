...
static enum V_127 F_46 (
struct V_5 * V_128 , bool V_129 )
{
return V_130 ;
}
static int F_47 ( struct V_5 * V_128 )
{
struct V_1 * V_11 = F_3 ( V_128 ) ;
return F_48 ( V_11 -> V_115 ) ;
}
static int F_49 ( struct V_131 * V_132 ,
struct V_2 * V_4 )
{
int V_38 ;
if ( ! V_132 )
...
static int F_51 ( struct V_134 * V_135 , struct V_1 * V_11 )
{
int V_38 ;
V_38 = F_52 ( V_135 , & V_11 -> V_7 , & V_136 ,
V_137 ) ;
if ( V_38 ) {
F_37 ( L_8 ) ;
return V_38 ;
...
F_53 ( & V_11 -> V_7 , & V_138 ) ;
V_11 -> V_7 . V_139 = V_140 ;
F_54 ( & V_11 -> V_7 , & V_11 -> V_4 ) ;
if ( V_11 -> V_115 ) {
V_38 = F_55 ( V_11 -> V_115 , & V_11 -> V_7 ) ;
if ( V_38 ) {
F_37 ( L_9 ) ;
goto V_141;
}
...
static int F_57 ( struct V_134 * V_135 , struct V_1 * V_11 )
{
int V_38 ;
V_38 = F_58 ( V_135 , & V_11 -> V_4 , & V_142 ,
V_143 , NULL ) ;
if ( V_38 ) {
F_37 ( L_10 ) ;
return V_38 ;
...
F_59 ( & V_11 -> V_4 , & V_144 ) ;
V_11 -> V_4 . V_145 = 1 ;
V_38 = F_49 ( V_11 -> V_132 , & V_11 -> V_4 ) ;
if ( V_38 ) {
V_38 = F_51 ( V_135 , V_11 ) ;
if ( V_38 )
goto V_146;
}
return 0 ;
...
static void F_61 ( struct V_147 * V_148 )
{
struct V_1 * V_11 = F_2 ( V_148 , struct V_1 , V_149 ) ;
F_13 ( V_11 ) ;
}
...
static int F_63 ( struct V_8 * V_10 ,
struct V_150 * V_36 )
{
...
static int F_65 ( struct V_8 * V_10 ,
struct V_150 * V_36 )
{
struct V_1 * V_11 = F_4 ( V_10 ) ;
if ( V_11 -> V_7 . V_37 )
...
static int F_66 ( struct V_36 * V_37 , struct V_36 * V_151 , void * V_14 )
{
int V_38 ;
struct V_134 * V_135 = V_14 ;
struct V_1 * V_11 = F_67 ( V_37 ) ;
V_38 = F_68 ( V_135 , & V_11 -> V_149 ) ;
if ( V_38 < 0 ) {
F_16 ( V_37 , L_11 ,
V_37 -> V_152 -> V_153 , V_38 ) ;
return V_38 ;
}
V_38 = F_69 ( & V_11 -> V_10 ) ;
if ( V_38 < 0 ) {
...
F_70 ( & V_11 -> V_10 ) ;
V_154:
F_71 ( V_135 , & V_11 -> V_149 ) ;
return V_38 ;
}
static void F_72 ( struct V_36 * V_37 , struct V_36 * V_151 ,
void * V_14 )
{
struct V_134 * V_135 = V_14 ;
struct V_1 * V_11 = F_67 ( V_37 ) ;
...
{
struct V_1 * V_11 ;
struct V_36 * V_37 = & V_157 -> V_37 ;
struct V_158 * V_159 , * V_160 ;
struct V_161 * V_16 ;
int V_162 ;
int V_38 ;
V_11 = F_74 ( V_37 , sizeof( * V_11 ) , V_163 ) ;
if ( ! V_11 )
return - V_164 ;
V_11 -> V_10 . V_165 = & V_166 ;
V_11 -> V_10 . V_37 = V_37 ;
V_160 = F_75 ( V_37 -> V_152 , NULL ) ;
if ( V_160 ) {
V_159 = F_76 ( V_160 ) ;
if ( ! V_159 ) {
F_16 ( V_37 , L_14 ) ;
...
V_11 -> V_132 = F_77 ( V_159 ) ;
V_11 -> V_115 = F_78 ( V_159 ) ;
F_79 ( V_159 ) ;
if ( ! V_11 -> V_132 && ! V_11 -> V_115 ) {
F_80 ( V_37 , L_15 ) ;
return - V_168 ;
}
}
V_11 -> V_62 = F_81 ( V_37 , L_16 ) ;
if ( F_82 ( V_11 -> V_62 ) ) {
V_38 = F_83 ( V_11 -> V_62 ) ;
F_16 ( V_37 , L_17 , V_38 ) ;
return V_38 ;
}
V_11 -> V_64 = F_81 ( V_37 , L_18 ) ;
if ( F_82 ( V_11 -> V_64 ) ) {
V_38 = F_83 ( V_11 -> V_64 ) ;
F_16 ( V_37 , L_19 , V_38 ) ;
return V_38 ;
}
V_11 -> V_59 = F_81 ( V_37 , L_20 ) ;
if ( F_82 ( V_11 -> V_59 ) ) {
V_38 = F_83 ( V_11 -> V_59 ) ;
F_16 ( V_37 , L_21 , V_38 ) ;
return V_38 ;
}
V_16 = F_84 ( V_157 , V_169 , 0 ) ;
V_11 -> V_16 = F_85 ( V_37 , V_16 ) ;
if ( F_82 ( V_11 -> V_16 ) ) {
V_38 = F_83 ( V_11 -> V_16 ) ;
F_16 ( V_37 , L_22 , V_38 ) ;
return V_38 ;
}
V_11 -> V_61 = F_86 ( V_37 , L_23 ) ;
if ( F_82 ( V_11 -> V_61 ) ) {
V_38 = F_83 ( V_11 -> V_61 ) ;
F_16 ( V_37 , L_24 , V_38 ) ;
return V_38 ;
}
V_162 = F_87 ( V_37 -> V_152 , V_170 ) ;
if ( V_162 < 0 ) {
F_16 ( V_37 , L_25 , V_162 ) ;
return V_162 ;
}
V_38 = F_88 ( V_37 , V_37 -> V_152 , & V_11 -> V_149 , V_162 ,
& V_171 ) ;
if ( V_38 ) {
F_16 ( V_37 , L_26 , V_38 ) ;
return V_38 ;
...
F_89 ( V_157 , V_11 ) ;
return F_90 ( & V_157 -> V_37 , & V_172 ) ;
}
static int F_91 ( struct V_156 * V_157 )
{
struct V_1 * V_11 = F_92 ( V_157 ) ;
F_38 ( V_11 ) ;
F_93 ( & V_157 -> V_37 , & V_172 ) ;
return 0 ;
}
