...
static unsigned long F_19 ( struct V_3 * V_4 , T_1 V_34 )
{
struct V_7 * V_8 = F_15 ( V_4 -> V_9 ) ;
struct V_10 * V_11 = V_8 -> V_12 ;
...
static int F_20 ( struct V_38 * V_38 , struct V_3 * V_4 ,
struct V_10 * V_11 ,
...
int V_46 ;
F_21 ( & V_45 , V_47 , 0 ) ;
V_46 = F_22 ( V_38 , V_4 , V_41 , V_42 , & V_45 , V_43 ) ;
if ( V_46 < 0 )
return V_46 ;
if ( V_41 [ V_48 ] ) {
V_11 -> V_6 . V_49 = F_23 ( V_41 [ V_48 ] ) ;
F_24 ( V_4 , & V_11 -> V_6 , V_39 ) ;
}
F_25 ( V_4 , & V_11 -> V_14 , & V_45 ) ;
return 0 ;
}
static int F_26 ( struct V_38 * V_38 , struct V_1 * V_50 ,
...
if ( ! V_11 )
return - V_16 ;
F_21 ( & V_11 -> V_14 , V_47 , 0 ) ;
if ( ! V_34 )
V_34 = 1 ;
V_11 -> V_34 = V_34 ;
V_11 -> V_13 = V_13 ;
V_46 = F_20 ( V_38 , V_4 , V_11 , V_39 , V_41 , V_51 [ V_60 ] , V_43 ) ;
if ( V_46 )
goto V_61;
...
static int F_29 ( struct V_3 * V_4 , unsigned long V_52 )
{
struct V_7 * V_8 = F_15 ( V_4 -> V_9 ) ;
