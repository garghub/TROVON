...
V_37 = (struct V_36 * ) & V_30 -> V_41 . V_43 . V_37 ;
V_38 = V_30 -> V_41 . V_43 . V_38 ;
}
V_34 = V_44 ;
F_17 ( & V_25 -> V_16 -> V_17 ,
V_38 , V_37 -> V_45 ,
...
} else if ( V_26 || ( V_30 -> V_49 &&
F_19 ( V_50 , ( unsigned long ) V_30 -> V_49 ) ) ) {
V_34 = V_51 ;
}
if ( V_34 != V_44 ) {
F_20 ( & V_30 -> V_52 ) ;
...
static void V_21 ( struct V_55 * V_20 )
{
struct V_56 * V_19 = (struct V_56 * ) V_20 ;
