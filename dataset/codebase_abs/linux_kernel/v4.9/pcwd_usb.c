...
V_100 = V_9 -> V_112 ;
if ( ! ( V_100 -> V_113 . V_114 == V_115 ) ) {
F_5 ( L_11 ) ;
return - V_111 ;
}
V_102 = & V_100 -> V_102 [ 0 ] . V_113 ;
if ( ! F_39 ( V_102 ) ) {
F_5 ( L_12 ) ;
return - V_111 ;
}
V_103 = F_40 ( V_30 , V_102 -> V_116 ) ;
V_3 = F_41 ( sizeof( struct V_2 ) , V_29 ) ;
if ( V_3 == NULL )
goto error;
V_55 = V_3 ;
F_42 ( & V_3 -> V_117 ) ;
V_3 -> V_30 = V_30 ;
V_3 -> V_9 = V_9 ;
V_3 -> V_33 = V_100 -> V_113 . V_118 ;
V_3 -> V_93 = ( F_43 ( V_102 -> V_119 ) > 8 ?
F_43 ( V_102 -> V_119 ) : 8 ) ;
V_3 -> V_6 = F_44 ( V_30 , V_3 -> V_93 ,
V_21 , & V_3 -> V_94 ) ;
if ( ! V_3 -> V_6 ) {
F_5 ( L_13 ) ;
goto error;
}
V_3 -> V_92 = F_45 ( 0 , V_29 ) ;
if ( ! V_3 -> V_92 )
goto error;
F_46 ( V_3 -> V_92 , V_30 , V_103 ,
V_3 -> V_6 , V_3 -> V_93 ,
F_1 , V_3 , V_102 -> V_120 ) ;
V_3 -> V_92 -> V_121 = V_3 -> V_94 ;
V_3 -> V_92 -> V_122 |= V_123 ;
...
& V_106 , & V_107 ) ;
if ( V_105 )
sprintf ( V_108 , L_15 , V_106 , V_107 ) ;
else
sprintf ( V_108 , L_16 ) ;
F_47 ( L_17 , V_108 ) ;
F_6 ( V_3 , V_126 , & V_37 ,
...
F_47 ( L_18 ,
V_109 ,
( ( V_109 & 0x10 ) ? L_19 : L_20 ) ,
( ( V_109 & 0x08 ) ? L_19 : L_20 ) ) ;
if ( V_42 == 0 )
V_42 = V_127 [ ( V_109 & 0x07 ) ] ;
if ( F_16 ( V_3 , V_42 ) ) {
F_16 ( V_3 , V_128 ) ;
F_47 ( L_21 ,
V_128 ) ;
...
static void F_53 ( struct V_95 * V_9 )
{
struct V_2 * V_3 ;
F_54 ( & V_136 ) ;
V_3 = F_55 ( V_9 ) ;
