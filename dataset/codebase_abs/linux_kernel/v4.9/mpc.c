...
case V_175 :
F_21 ( L_66 ) ;
F_77 ( V_163 , V_3 , V_176 ) ;
break;
case V_177 :
F_21 ( L_67 ) ;
F_77 ( V_163 , V_3 , V_177 ) ;
break;
case V_178 :
F_21 ( L_68 ) ;
...
V_70 = F_78 ( sizeof( struct V_162 ) , V_182 ) ;
if ( V_70 == NULL )
return - V_148 ;
F_79 ( V_70 , sizeof( struct V_162 ) ) ;
F_32 ( V_70 , V_163 , sizeof( * V_163 ) ) ;
F_80 ( V_3 -> V_9 , V_70 -> V_93 ) ;
V_131 = F_34 ( V_3 -> V_9 ) ;
F_44 ( & V_131 -> V_132 , V_70 ) ;
V_131 -> V_133 ( V_131 ) ;
return 0 ;
}
static int F_81 ( struct V_183 * V_147 ,
unsigned long V_184 , void * V_185 )
{
struct V_10 * V_11 = F_82 ( V_185 ) ;
struct V_1 * V_3 ;
struct V_143 * V_144 ;
if ( ! F_83 ( F_84 ( V_11 ) , & V_32 ) )
return V_186 ;
...
static void F_87 ( struct V_162 * V_197 ,
struct V_1 * V_203 ,
T_6 * V_16 )
{
T_1 V_13 = V_197 -> V_179 . V_198 . V_119 ;
...
static void F_75 ( struct V_162 * V_163 ,
struct V_1 * V_3 )
{
struct V_143 * V_144 ;
int V_101 , V_223 ;
...
static void F_76 ( struct V_162 * V_197 ,
struct V_1 * V_203 )
{
if ( V_203 -> V_61 )
F_9 ( V_203 -> V_66 ) ;
V_203 -> V_61 = 0 ;
V_203 -> V_66 = F_95 ( V_197 -> V_165 , V_64 , V_17 ) ;
if ( V_203 -> V_66 == NULL ) {
F_7 ( L_91 ) ;
return;
}
...
static void F_77 ( struct V_162 * V_197 , struct V_1 * V_3 , int V_229 )
{
T_9 * V_16 ;
V_197 -> type = V_230 ;
F_93 ( & V_3 -> V_34 ) ;
...
static int F_97 ( struct V_243 * V_130 , unsigned int V_244 ,
unsigned long V_108 )
{
int V_145 = 0 ;
struct V_7 * V_8 = F_98 ( V_130 ) ;
