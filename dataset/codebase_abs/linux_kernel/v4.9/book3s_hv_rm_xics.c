...
static void F_41 ( struct V_105 * V_106 , T_1 V_107 , T_1 V_89 )
{
unsigned long V_108 ;
T_4 V_109 ;
V_109 = F_42 ( V_106 , V_107 ) ;
if ( V_109 )
V_110 = V_109 ;
F_43 () ;
V_108 = V_54 -> V_55 . V_108 ;
F_44 ( V_108 + V_111 , V_89 ) ;
}
static int F_40 ( unsigned int V_112 , int V_113 )
{
unsigned int V_114 = F_45 ( V_113 ) << 2 ;
return F_46 ( V_112 , V_114 , V_115 ) ;
}
static inline void F_47 ( unsigned int T_5 * V_116 )
{
unsigned long V_117 ;
unsigned int * V_118 ;
int V_41 = F_13 () ;
V_118 = F_48 ( V_116 , V_41 ) ;
V_117 = ( unsigned long ) V_118 ;
if ( F_49 ( V_117 ) == V_119 ) {
V_117 = F_50 ( V_118 ) ;
...
T_1 V_68 ;
V_68 = V_126 -> V_129 ;
V_2 = V_17 -> V_81 -> V_40 . V_2 ;
V_6 = V_17 -> V_40 . V_6 ;
F_51 ( V_126 -> V_121 ) ;
F_4 ( V_2 , V_6 , V_68 ) ;
F_41 ( F_54 ( V_126 -> V_121 ) , V_126 -> V_130 , V_89 ) ;
if ( F_24 ( V_2 , V_6 ) == V_64 )
return 2 ;
else
return - 2 ;
}
static void F_55 ( int V_27 , void * V_131 )
{
switch ( V_27 ) {
case V_51 :
V_20 -> V_132 ( V_131 ) ;
...
struct V_25 * V_133 ;
V_29 = V_41 >> V_19 ;
V_133 = & V_20 -> V_21 [ V_29 ] ;
if ( V_133 -> V_22 ) {
F_55 ( V_133 -> V_33 . V_35 ,
V_133 -> V_22 ) ;
V_133 -> V_22 = NULL ;
F_11 () ;
V_133 -> V_33 . V_35 = 0 ;
