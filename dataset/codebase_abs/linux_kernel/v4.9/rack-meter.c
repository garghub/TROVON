...
V_58 = F_25 ( F_26 () ) ;
V_60 = ( unsigned int ) ( V_58 - V_56 -> V_65 ) ;
V_56 -> V_65 = V_58 ;
V_59 = F_1 ( V_1 ) ;
V_61 = ( unsigned int ) ( V_59 - V_56 -> V_66 ) ;
V_61 = F_27 ( V_61 , V_60 ) ;
V_56 -> V_66 = V_59 ;
V_63 = ( 9 * ( V_60 - V_61 ) ) / V_60 ;
V_62 = V_1 << 3 ;
V_64 = 0 ;
for ( V_24 = 0 ; V_24 < 8 ; V_24 ++ ) {
T_3 V_67 = ( V_63 > V_24 ) ? 0xff : 0 ;
...
unsigned int V_1 ;
V_9 -> V_1 [ 0 ] . V_9 = V_9 ;
F_33 ( & V_9 -> V_1 [ 0 ] . V_57 , F_22 ) ;
V_9 -> V_1 [ 1 ] . V_9 = V_9 ;
F_33 ( & V_9 -> V_1 [ 1 ] . V_57 , F_22 ) ;
F_34 (cpu) {
struct V_55 * V_56 ;
if ( V_1 > 1 )
continue;
...
static T_4 F_39 ( struct V_8 * V_9 , unsigned int V_72 )
{
int V_73 ;
T_4 V_74 = 0 ;
...
static T_5 F_40 ( int V_75 , void * V_76 )
{
struct V_8 * V_9 = V_76 ;
struct V_27 * V_40 = V_9 -> V_29 ;
...
V_77 [ V_24 ] = F_39 ( V_9 , V_24 ) ;
return V_82 ;
}
static int F_42 ( struct V_83 * V_12 ,
...
int V_90 = - V_91 ;
F_13 ( L_15 ) ;
while ( ( V_18 = F_43 ( V_12 -> V_92 . V_93 . V_94 , V_18 ) ) != NULL )
...
while ( ( V_87 = F_43 ( V_18 , V_87 ) ) != NULL ) {
if ( strcmp ( V_87 -> V_95 , L_18 ) == 0 )
break;
if ( ( strcmp ( V_87 -> V_95 , L_19 ) == 0 ) &&
F_44 ( V_87 , L_20 , NULL ) != NULL )
break;
}
if ( V_87 == NULL ) {
F_13 ( L_21 ) ;
...
V_9 = F_45 ( sizeof( struct V_8 ) , V_97 ) ;
if ( V_9 == NULL ) {
F_38 ( V_81 L_22 ) ;
V_90 = - V_98 ;
goto V_99;
...
#else
V_9 -> V_75 = F_48 ( V_18 , 1 ) ;
if ( ! V_9 -> V_75 ||
F_49 ( V_18 , 0 , & V_89 ) ||
F_49 ( V_18 , 1 , & V_28 ) ) {
F_38 ( V_81
L_23 ,
V_12 -> V_92 . V_93 . V_94 -> V_100 ) ;
V_90 = - V_101 ;
goto V_102;
}
#endif
F_13 ( L_24 , ( unsigned int ) V_89 . V_103 ) ;
F_13 ( L_25 , ( unsigned int ) V_28 . V_103 ) ;
F_13 ( L_26 , V_9 -> V_75 ) ;
V_9 -> V_25 = ( T_3 * ) F_50 ( V_97 ) ;
if ( V_9 -> V_25 == NULL ) {
F_38 ( V_81
L_27 ) ;
V_90 = - V_98 ;
...
#else
V_9 -> V_22 = F_53 ( V_89 . V_103 , 0x1000 ) ;
#endif
if ( V_9 -> V_22 == NULL ) {
F_38 ( V_81
L_29 ) ;
...
#else
V_9 -> V_31 = F_53 ( V_28 . V_103 , 0x100 ) ;
#endif
if ( V_9 -> V_31 == NULL ) {
F_38 ( V_81
L_30 ) ;
...
V_90 = F_54 ( V_9 -> V_75 , F_40 , 0 , L_32 , V_9 ) ;
if ( V_90 != 0 ) {
F_38 ( V_81
L_33 ) ;
goto V_108;
...
F_55 ( V_18 ) ;
F_55 ( V_87 ) ;
F_47 ( & V_12 -> V_92 . V_93 , NULL ) ;
return V_90 ;
}
static int F_60 ( struct V_83 * V_12 )
{
struct V_8 * V_9 = F_61 ( & V_12 -> V_92 . V_93 ) ;
F_35 ( V_9 ) ;
F_47 ( & V_12 -> V_92 . V_93 , NULL ) ;
F_18 ( V_9 -> V_31 ) ;
F_62 ( V_9 -> V_75 , V_9 ) ;
...
static int F_63 ( struct V_83 * V_12 )
{
struct V_8 * V_9 = F_61 ( & V_12 -> V_92 . V_93 ) ;
if ( V_9 == NULL )
return - V_91 ;
