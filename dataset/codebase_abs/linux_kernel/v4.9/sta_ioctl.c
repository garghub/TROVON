...
return F_8 ( V_22 , V_317 , V_144 , 0 , V_316 , true ) ;
}
int
...
V_158 , 0 , & V_335 , true ) ;
if ( ! V_24 )
memcpy ( V_332 , V_335 . V_332 , F_71 ( ( T_1 ) V_338 ,
V_335 . V_336 ) ) ;
return V_24 ;
}
static int
...
V_340 = (struct V_339 * ) V_231 ;
while ( V_340 ) {
if ( V_340 -> V_348 == V_235 ) {
...
if ( V_340 -> V_348 == V_237 ) {
V_344 = 1 ;
break;
}
if ( V_340 -> V_348 == V_241 ) {
...
if ( V_232 < ( sizeof( V_22 -> V_351 ) - V_22 -> V_345 ) ) {
memcpy ( V_22 -> V_351 + V_22 -> V_345 , V_231 ,
V_232 ) ;
V_22 -> V_345 += V_232 ;
} else {
V_24 = - 1 ;
...
case V_354 :
if ( V_144 == V_158 ) {
V_353 -> V_48 = V_22 -> V_234 ;
memcpy ( V_353 -> V_355 , V_22 -> V_233 , V_353 -> V_48 ) ;
} else {
F_72 ( V_22 , V_353 -> V_355 ,
( T_1 ) V_353 -> V_48 ) ;
}
break;
case V_356 :
...
int
F_74 ( struct V_21 * V_22 , const T_2 * V_360 , int V_232 )
{
struct V_352 V_353 ;
if ( V_232 > V_361 )
return - V_362 ;
V_353 . type = V_354 ;
V_353 . V_48 = V_232 ;
memcpy ( V_353 . V_355 , V_360 , V_232 ) ;
if ( F_73 ( V_22 , & V_353 , V_35 ) )
return - V_362 ;
return 0 ;
}
