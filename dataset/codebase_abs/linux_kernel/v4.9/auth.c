...
V_49 -> V_123 = V_124 ;
#endif
V_49 -> V_125 = V_99 -> V_115 ;
}
struct V_48 *
F_72 ( struct V_126 * V_127 , struct V_48 * V_49 , int V_128 )
{
...
static struct V_48 *
F_73 ( struct V_126 * V_127 , int V_128 )
{
...
F_17 ( L_6 ,
V_127 -> V_129 , V_127 -> V_130 -> V_44 -> V_46 -> V_114 ) ;
return V_41 -> V_46 -> V_120 ( V_41 , & V_99 , V_128 ) ;
}
static struct V_48 *
F_74 ( struct V_126 * V_127 , int V_128 )
{
struct V_37 * V_41 = V_127 -> V_130 -> V_44 ;
F_17 ( L_6 ,
V_127 -> V_129 , V_41 -> V_46 -> V_114 ) ;
return F_65 ( V_41 , V_128 ) ;
}
static int
F_75 ( struct V_126 * V_127 , struct V_48 * V_49 , int V_100 )
{
...
V_59 = F_73 ( V_127 , V_128 ) ;
else
V_59 = F_74 ( V_127 , V_128 ) ;
if ( F_20 ( V_59 ) )
return F_76 ( V_59 ) ;
F_41 ( V_134 -> V_139 ) ;
V_134 -> V_139 = V_59 ;
...
T_5 *
F_78 ( struct V_126 * V_127 , T_5 * V_143 )
{
struct V_48 * V_49 = V_127 -> V_135 -> V_139 ;
F_17 ( L_7 ,
V_127 -> V_129 , V_49 -> V_54 -> V_46 -> V_114 , V_49 ) ;
return V_49 -> V_70 -> V_144 ( V_127 , V_143 ) ;
}
T_5 *
F_79 ( struct V_126 * V_127 , T_5 * V_143 )
{
struct V_48 * V_49 = V_127 -> V_135 -> V_139 ;
F_17 ( L_8 ,
V_127 -> V_129 , V_49 -> V_54 -> V_46 -> V_114 , V_49 ) ;
...
static void F_80 ( T_6 V_146 , struct V_133 * V_147 ,
T_5 * V_148 , void * V_149 )
{
struct V_150 V_151 ;
F_81 ( & V_151 , & V_147 -> V_152 , V_148 ) ;
V_146 ( V_147 , & V_151 , V_149 ) ;
}
int
F_82 ( struct V_126 * V_127 , T_6 V_146 , void * V_147 ,
T_5 * V_148 , void * V_149 )
{
struct V_48 * V_49 = V_127 -> V_135 -> V_139 ;
F_17 ( L_9 ,
...
F_80 ( V_146 , V_147 , V_148 , V_149 ) ;
return 0 ;
}
static int
F_83 ( T_7 V_155 , struct V_133 * V_147 ,
T_5 * V_148 , void * V_149 )
{
struct V_150 V_151 ;
F_84 ( & V_151 , & V_147 -> V_156 , V_148 ) ;
return V_155 ( V_147 , & V_151 , V_149 ) ;
}
int
F_85 ( struct V_126 * V_127 , T_7 V_155 , void * V_147 ,
T_5 * V_148 , void * V_149 )
{
struct V_48 * V_49 = V_127 -> V_135 -> V_139 ;
F_17 ( L_10 ,
...
V_148 , V_149 ) ;
return F_83 ( V_155 , V_147 , V_148 , V_149 ) ;
}
int
F_86 ( struct V_126 * V_127 )
{
struct V_48 * V_49 ;
int V_158 ;
V_49 = V_127 -> V_135 -> V_139 ;
if ( V_49 == NULL ) {
V_158 = F_75 ( V_127 , V_127 -> V_159 . V_48 , V_127 -> V_160 ) ;
if ( V_158 < 0 )
goto V_42;
V_49 = V_127 -> V_135 -> V_139 ;
}
