...
if ( ! V_61 -> V_71 )
return - V_64 ;
V_61 -> V_72 = F_35 ( L_5 , V_59 , 16 , 1 , 0 ) ;
if ( ! V_61 -> V_72 )
return - V_64 ;
V_38 -> V_61 = V_61 ;
return 0 ;
}
static int F_36 ( struct V_73 * V_74 , int V_75 )
{
struct V_37 * V_38 = F_37 ( V_74 ) ;
struct V_2 * V_3 = & V_38 -> V_76 [ V_75 ] ;
const char * V_77 = L_6 ;
struct V_78 * V_16 ;
V_3 -> V_79 = F_38 ( V_38 -> V_59 -> V_80 ,
L_7 , V_75 ) ;
if ( V_3 -> V_79 ) {
V_3 -> V_81 = F_39 ( V_3 -> V_79 ,
V_38 -> V_82 ,
& V_3 -> V_83 ) ;
if ( V_3 -> V_81 )
return 0 ;
...
V_16 = F_40 ( V_74 , V_85 ,
V_77 ) ;
if ( ! V_16 || F_41 ( V_16 ) < V_38 -> V_82 )
return - V_86 ;
V_3 -> V_81 = F_42 ( V_38 -> V_59 , V_16 ) ;
if ( F_43 ( V_3 -> V_81 ) )
return F_44 ( V_3 -> V_81 ) ;
V_3 -> V_83 = F_45 ( V_38 -> V_59 ,
( V_87 ) V_16 -> V_88 ) ;
return 0 ;
}
static void F_46 ( struct V_73 * V_74 , int V_75 )
{
struct V_37 * V_38 = F_37 ( V_74 ) ;
struct V_2 * V_3 = & V_38 -> V_76 [ V_75 ] ;
if ( ! V_3 -> V_79 )
return;
F_47 ( V_3 -> V_79 , ( unsigned long ) V_3 -> V_81 ,
V_38 -> V_82 ) ;
}
static int F_48 ( struct V_73 * V_74 )
{
const struct V_89 * V_41 = & V_90 ;
const struct V_48 * V_49 ;
const struct V_91 * V_92 ;
struct V_58 * V_59 = & V_74 -> V_59 ;
struct V_37 * V_38 ;
struct V_2 * V_76 ;
struct V_78 * V_16 ;
int V_22 , V_25 , V_39 ;
...
if ( V_59 -> V_80 ) {
V_92 = F_50 ( V_95 , V_59 -> V_80 ) ;
if ( ! V_92 || ! V_92 -> V_96 )
return - V_97 ;
V_41 = V_92 -> V_96 ;
}
if ( ( V_41 == & V_90 || V_41 == & V_98 ) && ! V_99 )
return - V_97 ;
...
V_38 -> V_59 = V_59 ;
V_82 = V_100 ;
F_51 ( V_38 -> V_59 -> V_80 , L_11 ,
& V_82 ) ;
if ( V_82 < V_101 )
V_82 = V_101 ;
V_38 -> V_82 = V_82 ;
V_38 -> V_76 = F_34 ( V_59 , V_41 -> V_84 * sizeof( * V_76 ) ,
V_63 ) ;
if ( ! V_38 -> V_76 )
return - V_64 ;
F_52 ( & V_38 -> V_9 ) ;
V_16 = F_40 ( V_74 , V_85 , L_12 ) ;
...
V_49 = F_53 () ;
F_54 ( V_74 , V_38 ) ;
for ( V_39 = 0 ; V_39 < V_41 -> V_84 ; V_39 ++ ) {
struct V_2 * V_3 = & V_38 -> V_76 [ V_39 ] ;
char V_77 [ 7 ] ;
V_3 -> V_102 = V_39 ;
F_52 ( & V_3 -> V_9 ) ;
V_25 = F_36 ( V_74 , V_39 ) ;
...
snprintf ( V_77 , sizeof( V_77 ) , L_13 , V_39 ) ;
V_3 -> V_104 = F_56 ( V_59 , V_77 ) ;
if ( F_43 ( V_3 -> V_104 ) ) {
V_3 -> V_104 = F_56 ( V_59 , NULL ) ;
if ( F_43 ( V_3 -> V_104 ) )
V_3 -> V_104 = NULL ;
}
snprintf ( V_77 , sizeof( V_77 ) , L_14 , V_39 ) ;
V_3 -> V_105 = F_56 ( V_59 , V_77 ) ;
if ( F_43 ( V_3 -> V_105 ) )
V_3 -> V_105 = NULL ;
V_25 = F_57 ( V_3 -> V_104 ) ;
if ( V_25 )
...
V_103:
for ( V_39 = 0 ; V_39 < V_41 -> V_84 ; V_39 ++ ) {
F_65 ( V_38 -> V_76 [ V_39 ] . V_105 ) ;
F_65 ( V_38 -> V_76 [ V_39 ] . V_104 ) ;
F_46 ( V_74 , V_39 ) ;
}
return V_25 ;
}
...
int V_39 ;
F_29 ( V_38 ) ;
for ( V_39 = 0 ; V_39 < V_38 -> V_41 -> V_84 ; V_39 ++ ) {
F_65 ( V_38 -> V_76 [ V_39 ] . V_105 ) ;
F_65 ( V_38 -> V_76 [ V_39 ] . V_104 ) ;
F_46 ( V_74 , V_39 ) ;
}
