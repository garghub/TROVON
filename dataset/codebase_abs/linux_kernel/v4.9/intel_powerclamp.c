...
static int F_75 ( struct V_103 * V_104 , void * V_105 )
{
int V_17 = 0 ;
F_76 ( V_104 , L_11 , V_73 ) ;
F_76 ( V_104 , L_12 ) ;
...
static int F_77 ( struct V_107 * V_107 ,
struct V_108 * V_108 )
{
return F_78 ( V_108 , F_75 , V_107 -> V_109 ) ;
}
static inline void F_79 ( void )
{
V_110 = F_80 ( L_14 , NULL ) ;
if ( ! V_110 )
return;
if ( ! F_81 ( L_15 , V_111 , V_110 ,
V_36 , & V_112 ) )
goto V_113;
return;
V_113:
...
int V_114 ;
int V_115 ;
V_115 = F_84 ( F_63 () ) * sizeof( long ) ;
V_62 = F_85 ( V_115 , V_116 ) ;
if ( ! V_62 )
return - V_117 ;
V_114 = F_73 () ;
if ( V_114 )
