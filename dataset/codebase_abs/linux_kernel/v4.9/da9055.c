...
{
struct V_66 * V_67 ;
struct V_180 * V_165 = F_23 ( & V_177 -> V_43 ) ;
int V_181 ;
V_67 = F_24 ( & V_177 -> V_43 , sizeof( struct V_66 ) ,
V_182 ) ;
if ( ! V_67 )
return - V_183 ;
if ( V_165 )
V_67 -> V_165 = V_165 ;
F_25 ( V_177 , V_67 ) ;
V_67 -> V_184 = F_26 ( V_177 , & V_185 ) ;
if ( F_27 ( V_67 -> V_184 ) ) {
V_181 = F_28 ( V_67 -> V_184 ) ;
F_16 ( & V_177 -> V_43 , L_4 , V_181 ) ;
return V_181 ;
}
V_181 = F_29 ( & V_177 -> V_43 ,
& V_186 , & V_187 , 1 ) ;
if ( V_181 < 0 ) {
F_16 ( & V_177 -> V_43 , L_5 ,
V_181 ) ;
...
static int F_30 ( struct V_176 * V_188 )
{
F_31 ( & V_188 -> V_43 ) ;
return 0 ;
}
