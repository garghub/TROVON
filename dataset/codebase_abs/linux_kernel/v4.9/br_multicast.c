...
static void F_120 ( struct V_125 * V_60 )
{
struct V_26 * V_27 = V_60 -> V_27 ;
...
T_1 V_70 ;
V_73 = F_125 ( V_29 ) ;
V_179 = F_126 ( V_73 -> V_180 ) ;
V_42 = F_127 ( V_29 ) + sizeof( * V_73 ) ;
...
int V_179 ;
int V_66 = 0 ;
if ( ! F_128 ( V_29 , sizeof( * V_191 ) ) )
return - V_46 ;
V_191 = F_70 ( V_29 ) ;
V_179 = F_126 ( V_191 -> V_193 . V_194 [ 1 ] ) ;
V_42 = F_127 ( V_29 ) + sizeof( * V_191 ) ;
for ( V_43 = 0 ; V_43 < V_179 ; V_43 ++ ) {
T_6 * V_195 , V_196 ;
V_195 = F_131 ( V_29 ,
V_42 + F_132 ( struct V_192 ,
V_183 ) ,
sizeof( V_196 ) , & V_196 ) ;
if ( ! V_195 )
return - V_46 ;
if ( ! F_128 ( V_29 ,
V_42 + sizeof( * V_178 ) +
sizeof( struct V_19 ) * F_126 ( * V_195 ) ) )
return - V_46 ;
...
goto V_203;
if ( F_135 ( V_91 ) <= F_135 ( V_27 -> V_154 . V_24 . V_7 . V_8 ) )
goto V_203;
return false ;
V_203:
...
static bool F_136 ( struct V_26 * V_27 ,
struct V_125 * V_60 ,
struct V_19 * V_91 )
{
...
goto V_203;
if ( F_137 ( V_91 , & V_27 -> V_155 . V_24 . V_7 . V_11 ) <= 0 )
goto V_203;
return false ;
V_203:
...
switch ( V_91 -> V_4 ) {
case F_2 ( V_6 ) :
return F_134 ( V_27 , V_60 , V_91 -> V_7 . V_8 ) ;
#if F_3 ( V_9 )
case F_2 ( V_10 ) :
return F_136 ( V_27 , V_60 , & V_91 -> V_7 . V_11 ) ;
#endif
}
return false ;
}
...
unsigned long V_204 )
{
if ( ! F_138 ( V_27 , V_60 , V_91 ) )
return;
F_139 ( V_27 , V_151 , V_204 ) ;
F_141 ( V_27 , V_60 ) ;
}
...
goto V_53;
V_204 = V_210 -> V_97 ?
F_145 ( V_210 -> V_97 ) * ( V_100 / V_101 ) : 1 ;
} else {
goto V_53;
}
if ( ! V_70 ) {
...
if ( V_23 -> V_54 &&
( F_31 ( & V_23 -> V_52 ) ?
F_146 ( V_23 -> V_52 . V_213 , V_136 + V_204 ) :
F_119 ( & V_23 -> V_52 ) >= 0 ) )
...
V_58 = & V_48 -> V_59 ) {
if ( F_31 ( & V_48 -> V_52 ) ?
F_146 ( V_48 -> V_52 . V_213 , V_136 + V_204 ) :
F_119 ( & V_48 -> V_52 ) >= 0 )
...
if ( ! F_128 ( V_29 , V_211 + sizeof( * V_214 ) ) ) {
V_66 = - V_46 ;
goto V_53;
}
V_214 = (struct V_106 * ) F_70 ( V_29 ) ;
V_204 = F_148 ( F_126 ( V_214 -> V_122 ) ) ;
if ( V_204 )
V_70 = & V_214 -> V_124 ;
} else {
if ( ! F_128 ( V_29 , V_211 + sizeof( * V_216 ) ) ) {
V_66 = - V_46 ;
goto V_53;
}
...
if ( ! V_216 -> V_218 )
V_70 = & V_216 -> V_219 ;
V_204 = V_18 ( F_148 ( F_149 ( V_216 ) ) , 1UL ) ;
}
V_217 = V_70 && F_71 ( V_70 ) ;
if ( V_217 ) {
V_91 . V_4 = F_2 ( V_10 ) ;
V_91 . V_7 . V_11 = V_105 -> V_91 ;
F_142 ( V_27 , V_60 , & V_27 -> V_166 ,
& V_91 , V_204 ) ;
goto V_53;
} else if ( ! V_70 ) {
goto V_53;
...
V_142 . V_4 = F_2 ( V_6 ) ;
V_142 . V_5 = V_5 ;
F_150 ( V_27 , V_60 , & V_142 , & V_27 -> V_165 ,
V_161 ) ;
}
...
V_142 . V_4 = F_2 ( V_10 ) ;
V_142 . V_5 = V_5 ;
F_150 ( V_27 , V_60 , & V_142 , & V_27 -> V_166 ,
V_161 ) ;
}
...
break;
case V_233 :
V_66 = F_124 ( V_27 , V_60 , V_228 , V_5 ) ;
break;
case V_96 :
V_66 = F_143 ( V_27 , V_60 , V_228 , V_5 ) ;
break;
case V_234 :
F_129 ( V_27 , V_60 , V_73 -> V_70 , V_5 ) ;
break;
}
if ( V_228 && V_228 != V_29 )
F_68 ( V_228 ) ;
...
break;
case V_236 :
V_66 = F_130 ( V_27 , V_60 , V_228 , V_5 ) ;
break;
case V_118 :
V_66 = F_147 ( V_27 , V_60 , V_228 , V_5 ) ;
break;
case V_237 :
F_133 ( V_27 , V_60 , & V_214 -> V_124 , V_5 ) ;
break;
}
if ( V_228 && V_228 != V_29 )
F_68 ( V_228 ) ;
...
int F_160 ( struct V_26 * V_27 , struct V_125 * V_60 ,
struct V_28 * V_29 , T_3 V_5 )
{
int V_238 = 0 ;
F_17 ( V_29 ) -> V_31 = 0 ;
...
switch ( V_29 -> V_32 ) {
case F_2 ( V_6 ) :
V_238 = F_155 ( V_27 , V_60 , V_29 , V_5 ) ;
break;
#if F_3 ( V_9 )
case F_2 ( V_10 ) :
V_238 = F_157 ( V_27 , V_60 , V_29 , V_5 ) ;
break;
#endif
}
return V_238 ;
...
{
struct V_26 * V_27 = ( void * ) V_49 ;
F_161 ( V_27 , & V_27 -> V_152 , & V_27 -> V_154 ) ;
}
static void F_164 ( unsigned long V_49 )
{
struct V_26 * V_27 = ( void * ) V_49 ;
F_161 ( V_27 , & V_27 -> V_153 , & V_27 -> V_155 ) ;
}
...
F_84 ( & V_27 -> V_152 . V_52 , F_163 ,
( unsigned long ) V_27 ) ;
#if F_3 ( V_9 )
F_84 ( & V_27 -> V_166 . V_52 ,
F_100 , ( unsigned long ) V_27 ) ;
F_84 ( & V_27 -> V_153 . V_52 , F_164 ,
( unsigned long ) V_27 ) ;
#endif
}
...
{
F_167 ( V_27 , & V_27 -> V_152 ) ;
#if F_3 ( V_9 )
F_167 ( V_27 , & V_27 -> V_153 ) ;
#endif
}
...
int F_172 ( struct V_26 * V_27 , unsigned long V_241 )
{
int V_66 = - V_46 ;
F_113 ( & V_27 -> V_50 ) ;
switch ( V_241 ) {
...
static void F_173 ( struct V_125 * V_48 )
{
if ( F_44 ( & V_48 -> V_147 ) )
return;
F_94 ( & V_48 -> V_147 ) ;
...
int F_174 ( struct V_125 * V_48 , unsigned long V_241 )
{
...
int F_178 ( struct V_26 * V_27 , unsigned long V_241 )
{
int V_66 = - V_46 ;
V_16 V_37 ;
struct V_12 * V_13 ;
...
bool F_187 ( struct V_244 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_125 * V_60 ;
struct V_74 V_75 ;
...
V_75 . V_81 = F_2 ( V_4 ) ;
V_238 = F_188 ( V_27 , & V_75 ) ;
V_242:
F_186 () ;
return V_238 ;
}
bool F_189 ( struct V_244 * V_51 , int V_4 )
{
struct V_26 * V_27 ;
struct V_125 * V_60 ;
bool V_238 = false ;
...
static void F_190 ( struct V_173 T_7 * V_221 ,
const struct V_28 * V_29 , T_5 type , T_5 V_249 )
{
struct V_173 * V_222 = F_152 ( V_221 ) ;
T_6 V_4 = V_29 -> V_32 ;
unsigned int V_250 ;
F_153 ( & V_222 -> V_224 ) ;
switch ( V_4 ) {
case F_2 ( V_6 ) :
V_250 = F_126 ( F_18 ( V_29 ) -> V_85 ) - F_191 ( V_29 ) ;
switch ( type ) {
case V_231 :
...
if ( F_37 ( ! V_221 ) )
return;
F_190 ( V_221 , V_29 , type , V_249 ) ;
}
int F_193 ( struct V_26 * V_27 )
{
...
static void F_194 ( T_8 * V_21 , T_8 * V_264 )
{
V_21 [ V_160 ] += V_264 [ V_160 ] ;
V_21 [ V_156 ] += V_264 [ V_156 ] ;
}
void F_195 ( const struct V_26 * V_27 ,
const struct V_125 * V_48 ,
struct V_265 * V_266 )
{
struct V_173 T_7 * V_221 ;
...
F_196 (i) {
struct V_173 * V_268 = F_197 ( V_221 , V_43 ) ;
struct V_265 V_269 ;
unsigned int V_270 ;
do {
V_270 = F_198 ( & V_268 -> V_224 ) ;
memcpy ( & V_269 , & V_268 -> V_225 , sizeof( V_269 ) ) ;
} while ( F_199 ( & V_268 -> V_224 , V_270 ) );
F_194 ( V_267 . V_256 , V_269 . V_256 ) ;
F_194 ( V_267 . V_257 , V_269 . V_257 ) ;
F_194 ( V_267 . V_254 , V_269 . V_254 ) ;
F_194 ( V_267 . V_258 , V_269 . V_258 ) ;
F_194 ( V_267 . V_251 , V_269 . V_251 ) ;
F_194 ( V_267 . V_252 , V_269 . V_252 ) ;
F_194 ( V_267 . V_253 , V_269 . V_253 ) ;
V_267 . V_226 += V_269 . V_226 ;
F_194 ( V_267 . V_262 , V_269 . V_262 ) ;
F_194 ( V_267 . V_261 , V_269 . V_261 ) ;
F_194 ( V_267 . V_263 , V_269 . V_263 ) ;
F_194 ( V_267 . V_259 , V_269 . V_259 ) ;
F_194 ( V_267 . V_260 , V_269 . V_260 ) ;
