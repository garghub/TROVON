...
if ( ! V_5 )
return - V_90 ;
if ( F_51 ( args -> V_40 ) != V_91 )
return - V_43 ;
if ( F_52 ( args -> V_40 ) & ~ V_92 )
return - V_43 ;
V_31 = F_53 ( & V_3 -> V_93 ) ;
if ( V_31 )
return V_31 ;
...
struct V_102 V_103 ;
void T_2 * V_39 =
F_18 ( args -> V_104 + ( V_30 * sizeof( V_103 ) ) ) ;
struct V_37 * V_38 ;
T_3 V_45 ;
V_31 = F_22 ( & V_103 , V_39 , sizeof( V_103 ) ) ;
if ( V_31 ) {
V_31 = - V_26 ;
goto V_41;
}
...
if ( ( V_103 . V_75 + V_103 . V_74 ) >=
V_38 -> V_51 . V_75 ) {
F_23 ( L_11 , V_103 . V_75 ) ;
V_31 = - V_43 ;
goto V_41;
}
V_8 -> V_11 [ V_30 ] . type = V_103 . type ;
V_8 -> V_11 [ V_30 ] . V_75 = V_103 . V_75 / 4 ;
V_8 -> V_11 [ V_30 ] . V_45 = V_45 + V_103 . V_74 ;
V_8 -> V_11 [ V_30 ] . V_66 = V_103 . V_108 ;
if ( V_8 -> V_65 )
continue;
V_31 = F_40 ( V_8 , V_38 , V_103 . V_74 ,
V_103 . V_68 , V_103 . V_69 ) ;
if ( V_31 )
goto V_41;
}
V_8 -> V_7 = V_30 ;
V_8 -> V_15 = F_57 ( V_5 -> V_64 ) ;
if ( F_42 ( V_8 -> V_15 ) ) {
V_31 = F_43 ( V_8 -> V_15 ) ;
V_8 -> V_15 = NULL ;
goto V_41;
