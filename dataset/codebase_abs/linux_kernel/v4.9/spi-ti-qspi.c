...
static int F_37 ( struct V_1 * V_2 , struct V_86 V_87 ,
T_6 V_88 )
{
struct V_89 * V_90 ;
...
T_3 V_65 ;
int V_92 , V_67 , V_12 ;
F_38 (rx_sg.sgl, sg, rx_sg.nents, i) {
V_65 = F_39 ( V_90 ) ;
V_67 = F_40 ( V_90 ) ;
...
if ( V_2 -> V_70 ) {
if ( V_101 -> V_113 ) {
V_12 = F_37 ( V_2 , V_101 -> V_87 , V_101 -> V_88 ) ;
if ( V_12 )
goto V_114;
} else {
F_8 ( V_2 -> V_17 , L_20 ) ;
...
F_49 ( V_101 -> V_115 , V_2 -> V_116 + V_101 -> V_88 , V_101 -> V_67 ) ;
}
...
static int F_51 ( struct V_118 * V_8 ,
struct V_119 * V_120 )
{
...
V_2 -> V_45 = 0 ;
if ( V_7 -> V_124 & V_125 )
V_2 -> V_45 |= F_52 ( V_7 -> V_97 ) ;
if ( V_7 -> V_124 & V_126 )
V_2 -> V_45 |= F_53 ( V_7 -> V_97 ) ;
if ( V_7 -> V_124 & V_127 )
V_2 -> V_45 |= F_54 ( V_7 -> V_97 ) ;
V_122 = 0 ;
F_55 (t, &m->transfers, transfer_list)
V_122 += V_35 -> V_67 / ( V_35 -> V_44 >> 3 ) ;
V_122 = F_56 (unsigned int, frame_len_words, QSPI_FRAME) ;
V_2 -> V_39 = 0 ;
V_2 -> V_39 |= F_57 ( V_7 -> V_97 ) ;
V_2 -> V_39 |= F_58 ( V_122 ) ;
...
F_22 ( V_35 -> V_44 ) ) ;
V_37 = V_35 -> V_44 >> 3 ;
V_123 = F_59 ( V_35 -> V_67 / V_37 , V_122 ) ;
...
static int F_61 ( struct V_73 * V_17 )
{
struct V_1 * V_2 ;
V_2 = F_62 ( V_17 ) ;
F_14 ( V_2 ) ;
...
T_7 V_143 ;
V_8 = F_64 ( & V_133 -> V_17 , sizeof( * V_2 ) ) ;
if ( ! V_8 )
return - V_144 ;
...
V_8 -> V_152 = F_65 ( 32 ) | F_65 ( 16 ) |
F_65 ( 8 ) ;
V_8 -> V_153 = F_47 ;
if ( ! F_66 ( V_138 , L_22 , & V_141 ) )
V_8 -> V_154 = V_141 ;
V_2 = F_6 ( V_8 ) ;
V_2 -> V_8 = V_8 ;
V_2 -> V_17 = & V_133 -> V_17 ;
F_67 ( V_133 , V_2 ) ;
V_135 = F_68 ( V_133 , V_155 , L_23 ) ;
if ( V_135 == NULL ) {
V_135 = F_69 ( V_133 , V_155 , 0 ) ;
if ( V_135 == NULL ) {
F_8 ( & V_133 -> V_17 , L_24 ) ;
return - V_156 ;
}
...
V_2 -> V_21 = F_78 ( & V_133 -> V_17 , L_30 ) ;
if ( F_73 ( V_2 -> V_21 ) ) {
V_12 = F_74 ( V_2 -> V_21 ) ;
F_8 ( & V_133 -> V_17 , L_31 , V_12 ) ;
}
F_79 ( & V_133 -> V_17 ) ;
F_80 ( & V_133 -> V_17 , V_158 ) ;
F_81 ( & V_133 -> V_17 ) ;
if ( ! F_66 ( V_138 , L_32 , & V_140 ) )
V_2 -> V_19 = V_140 ;
F_82 ( V_143 ) ;
F_83 ( V_159 , V_143 ) ;
V_2 -> V_70 = F_84 ( & V_143 ) ;
...
V_160:
if ( ! V_2 -> V_70 && V_136 ) {
V_2 -> V_116 = F_72 ( & V_133 -> V_17 , V_136 ) ;
if ( F_73 ( V_2 -> V_116 ) ) {
F_86 ( & V_133 -> V_17 ,
L_34 ,
F_74 ( V_2 -> V_116 ) ) ;
...
static int F_89 ( struct V_132 * V_133 )
{
struct V_1 * V_2 = F_90 ( V_133 ) ;
int V_163 ;
V_163 = F_91 ( V_2 -> V_8 ) ;
if ( V_163 )
return V_163 ;
