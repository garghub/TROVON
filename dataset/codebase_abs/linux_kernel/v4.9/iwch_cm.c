...
V_2 -> V_5 . V_168 , V_165 ) ;
V_2 -> V_116 = F_155 ( V_292 -> V_21 . V_309 , & V_156 , V_2 ) ;
if ( V_2 -> V_116 == - 1 ) {
F_63 (KERN_ERR MOD L_61 , __func__) ;
V_188 = - V_35 ;
goto V_310;
}
V_82 = F_57 ( V_292 -> V_21 . V_309 , V_304 -> V_120 . V_121 ,
...
if ( ! V_188 )
goto V_210;
F_47 ( V_292 -> V_21 . V_309 , V_2 -> V_62 ) ;
V_313:
F_46 ( V_2 -> V_61 ) ;
V_312:
F_101 ( V_2 -> V_5 . V_15 , V_2 -> V_116 ) ;
...
int F_156 ( struct V_287 * V_165 , int V_314 )
{
int V_188 = 0 ;
struct V_291 * V_292 = F_148 ( V_165 -> V_293 ) ;
struct V_227 * V_2 ;
F_157 () ;
if ( V_165 -> V_305 . V_306 != V_307 ) {
V_188 = - V_308 ;
goto V_315;
}
V_2 = F_37 ( sizeof( * V_2 ) , V_27 ) ;
...
memcpy ( & V_2 -> V_5 . V_117 , & V_165 -> V_305 ,
sizeof( V_2 -> V_5 . V_117 ) ) ;
V_2 -> V_230 = F_158 ( V_292 -> V_21 . V_309 , & V_156 , V_2 ) ;
if ( V_2 -> V_230 == - 1 ) {
F_63 (KERN_ERR MOD L_61 , __func__) ;
V_188 = - V_35 ;
goto V_310;
...
int F_138 ( struct V_1 * V_2 , int V_317 , T_3 V_57 )
{
int V_273 = 0 ;
unsigned long V_52 ;
int V_318 = 0 ;
...
F_50 ( V_320 , & V_2 -> V_5 . V_52 ) ;
break;
case V_264 :
if ( ! F_122 ( V_320 , & V_2 -> V_5 . V_52 ) ) {
V_318 = 1 ;
if ( V_317 ) {
F_7 ( V_2 ) ;
V_2 -> V_5 . V_13 = V_161 ;
...
int F_163 ( void * V_153 , struct V_248 * V_321 , struct V_248 * V_54 ,
struct V_18 * V_62 )
{
struct V_1 * V_2 = V_153 ;
if ( V_2 -> V_61 != V_321 )
...
static void F_165 ( struct V_322 * V_323 )
{
struct V_16 * V_17 = NULL ;
void * V_2 ;
struct V_14 * V_15 ;
int V_273 ;
while ( ( V_17 = F_166 ( & V_324 ) ) ) {
V_2 = * ( ( void * * ) ( V_17 -> V_325 ) ) ;
V_15 = * ( (struct V_14 * * ) ( V_17 -> V_325 + sizeof( void * ) ) ) ;
V_273 = V_326 [ F_167 ( F_99 ( ( V_327 T_4 ) V_17 -> V_328 ) ) ] ( V_15 , V_17 , V_2 ) ;
if ( V_273 & V_217 )
F_12 ( V_17 ) ;
F_9 ( (struct V_50 * ) V_2 ) ;
}
...
F_5 ( V_51 ) ;
* ( ( void * * ) V_17 -> V_325 ) = V_153 ;
* ( (struct V_14 * * ) ( V_17 -> V_325 + sizeof( void * ) ) ) = V_15 ;
F_169 ( & V_324 , V_17 ) ;
F_170 ( V_329 , & V_330 ) ;
return 0 ;
}
