...
V_38 -> V_66 = F_47 ( V_38 -> V_66 , V_38 -> V_122 << 1 ) ;
...
if ( F_65 ( F_210 ( V_38 -> V_378 , V_166 , V_38 -> V_117 ) ) )
V_38 -> V_378 = V_38 -> V_117 ;
...
! F_62 ( V_38 -> V_334 . V_379 , V_38 -> V_117 ) ) ) {
F_178 ( V_2 ) ;
}
if ( F_76 ( V_38 ) ) {
F_131 ( V_2 , V_368 ) ;
...
unsigned long V_279 = F_212 ( V_2 , V_262 ) ;
F_143 ( V_2 , V_381 ,
V_279 , V_262 ) ;
}
}
static inline bool F_213 ( const struct V_1 * V_2 , const int V_190 )
{
return ! ( V_190 & V_382 ) || ( V_190 & V_383 ) ||
F_8 ( V_2 ) -> V_144 != V_296 ;
}
...
static void F_215 ( struct V_1 * V_2 , T_2 V_351 , T_2 V_385 ,
int V_190 , const struct V_386 * V_387 )
{
const struct V_10 * V_11 = F_8 ( V_2 ) ;
if ( V_11 -> V_56 -> V_310 ) {
V_11 -> V_56 -> V_310 ( V_2 , V_387 ) ;
return;
}
if ( F_186 ( V_2 ) ) {
F_170 ( V_2 , V_385 , V_190 ) ;
} else if ( F_214 ( V_2 , V_190 ) ) {
F_200 ( V_2 , V_351 , V_385 ) ;
}
F_64 ( V_2 ) ;
}
static inline bool F_216 ( const struct V_37 * V_38 ,
const T_2 V_351 , const T_2 V_170 ,
const T_2 V_388 )
{
return F_62 ( V_351 , V_38 -> V_117 ) ||
F_62 ( V_170 , V_38 -> V_389 ) ||
( V_170 == V_38 -> V_389 && V_388 > V_38 -> V_390 ) ;
}
static void F_217 ( struct V_37 * V_38 , T_2 V_351 )
{
T_2 V_306 = V_351 - V_38 -> V_117 ;
F_218 ( (struct V_1 * ) V_38 ) ;
F_219 ( & V_38 -> V_391 ) ;
V_38 -> V_392 += V_306 ;
F_220 ( & V_38 -> V_391 ) ;
V_38 -> V_117 = V_351 ;
}
static void F_221 ( struct V_37 * V_38 , T_2 V_89 )
{
...
static int F_222 ( struct V_1 * V_2 , const struct V_3 * V_4 , T_2 V_351 ,
T_2 V_170 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
int V_190 = 0 ;
T_2 V_388 = F_161 ( F_14 ( V_4 ) -> V_72 ) ;
if ( F_65 ( ! F_14 ( V_4 ) -> V_53 ) )
V_388 <<= V_38 -> V_60 . V_394 ;
if ( F_216 ( V_38 , V_351 , V_170 , V_388 ) ) {
V_190 |= V_395 ;
F_223 ( V_38 , V_170 ) ;
if ( V_38 -> V_390 != V_388 ) {
V_38 -> V_390 = V_388 ;
...
static bool F_226 ( struct V_241 * V_241 , int V_137 ,
T_2 * V_397 )
{
if ( * V_397 ) {
...
bool F_227 ( struct V_241 * V_241 , const struct V_3 * V_4 ,
int V_137 , T_2 * V_397 )
{
if ( ( F_26 ( V_4 ) -> V_89 != F_26 ( V_4 ) -> V_104 ) &&
! F_14 ( V_4 ) -> V_53 )
return false ;
return F_226 ( V_241 , V_137 , V_397 ) ;
}
static void F_228 ( struct V_1 * V_2 , const struct V_3 * V_4 )
{
static T_2 V_400 ;
...
static void F_233 ( struct V_37 * V_38 )
{
V_38 -> V_60 . V_407 = V_38 -> V_60 . V_408 ;
V_38 -> V_60 . V_409 = F_234 () ;
}
static void F_235 ( struct V_37 * V_38 , T_2 V_89 )
{
if ( V_38 -> V_60 . V_280 && ! F_62 ( V_89 , V_38 -> V_410 ) ) {
if ( F_236 ( & V_38 -> V_60 , 0 ) )
F_233 ( V_38 ) ;
}
}
static void F_237 ( struct V_1 * V_2 , T_2 V_351 , int V_190 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
...
static inline void F_238 ( struct V_1 * V_2 , T_2 V_412 )
{
const struct V_10 * V_11 = F_8 ( V_2 ) ;
if ( V_11 -> V_56 -> V_413 )
V_11 -> V_56 -> V_413 ( V_2 , V_412 ) ;
}
static void F_239 ( struct V_1 * V_2 , int V_324 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
if ( V_324 == V_414 )
return;
...
static int F_241 ( struct V_1 * V_2 , const struct V_3 * V_4 , int V_190 )
{
struct V_10 * V_11 = F_8 ( V_2 ) ;
struct V_37 * V_38 = F_15 ( V_2 ) ;
struct V_181 V_416 ;
struct V_386 V_387 = { . V_417 = 0 } ;
...
V_363 = V_38 -> V_145 ;
V_387 . V_422 = F_127 ( V_38 ) ;
if ( V_190 & V_423 )
F_235 ( V_38 , F_26 ( V_4 ) -> V_89 ) ;
...
F_77 ( F_4 ( V_2 ) , V_430 ) ;
V_190 |= F_222 ( V_2 , V_4 , V_351 , V_170 ) ;
if ( F_26 ( V_4 ) -> V_154 )
...
& V_416 , & V_108 ) ;
if ( F_213 ( V_2 , V_190 ) ) {
V_323 = ! ( V_190 & ( V_326 | V_382 ) ) ;
F_190 ( V_2 , V_240 , V_323 , & V_190 , & V_324 ) ;
}
if ( V_38 -> V_300 )
F_237 ( V_2 , V_351 , V_190 ) ;
if ( ( V_190 & V_384 ) || ! ( V_190 & V_382 ) ) {
...
F_244 ( V_2 , V_196 , V_157 , & V_108 , & V_387 ) ;
F_215 ( V_2 , V_351 , V_196 , V_190 , & V_387 ) ;
F_239 ( V_2 , V_324 ) ;
return 1 ;
V_435:
if ( V_190 & V_230 )
...
return 1 ;
V_421:
F_245 ( V_2 , L_14 , V_351 , V_38 -> V_117 , V_38 -> V_119 ) ;
return - 1 ;
V_420:
if ( F_26 ( V_4 ) -> V_154 ) {
V_190 |= F_122 ( V_2 , V_4 , V_166 ,
...
F_245 ( V_2 , L_15 , V_351 , V_38 -> V_117 , V_38 -> V_119 ) ;
return 0 ;
}
static void F_246 ( int V_15 , const unsigned char * V_436 ,
...
void F_247 ( const struct V_3 * V_4 ,
...
static bool F_252 ( struct V_37 * V_38 , const struct V_20 * V_51 )
{
const T_9 * V_221 = ( const T_9 * ) ( V_51 + 1 ) ;
if ( * V_221 == F_253 ( ( V_451 << 24 ) | ( V_451 << 16 )
| ( V_461 << 8 ) | V_462 ) ) {
V_38 -> V_60 . V_280 = 1 ;
++ V_221 ;
V_38 -> V_60 . V_408 = F_254 ( * V_221 ) ;
++ V_221 ;
if ( * V_221 )
V_38 -> V_60 . V_103 = F_254 ( * V_221 ) - V_38 -> V_477 ;
else
V_38 -> V_60 . V_103 = 0 ;
return true ;
}
...
static bool F_255 ( const struct V_3 * V_4 ,
...
F_247 ( V_4 , & V_38 -> V_60 , 1 , NULL ) ;
if ( V_38 -> V_60 . V_280 && V_38 -> V_60 . V_103 )
V_38 -> V_60 . V_103 -= V_38 -> V_477 ;
return true ;
}
const T_6 * F_256 ( const struct V_20 * V_51 )
{
...
static int F_257 ( const struct V_1 * V_2 , const struct V_3 * V_4 )
{
const struct V_37 * V_38 = F_15 ( V_2 ) ;
const struct V_20 * V_51 = F_14 ( V_4 ) ;
...
V_351 == V_38 -> V_117 &&
! F_216 ( V_38 , V_351 , V_89 , F_161 ( V_51 -> V_72 ) << V_38 -> V_60 . V_394 ) &&
( T_7 ) ( V_38 -> V_60 . V_407 - V_38 -> V_60 . V_408 ) <= ( F_8 ( V_2 ) -> V_110 * 1024 ) / V_339 ) ;
}
static inline bool F_258 ( const struct V_1 * V_2 ,
const struct V_3 * V_4 )
{
const struct V_37 * V_38 = F_15 ( V_2 ) ;
return ! F_236 ( & V_38 -> V_60 , V_480 ) &&
! F_257 ( V_2 , V_4 ) ;
}
static inline bool F_259 ( const struct V_37 * V_38 , T_2 V_89 , T_2 V_104 )
{
return ! F_55 ( V_104 , V_38 -> V_410 ) &&
! F_62 ( V_89 , V_38 -> V_102 + F_260 ( V_38 ) ) ;
}
...
if ( V_2 -> V_491 == V_503 ||
V_2 -> V_481 == V_487 )
F_271 ( V_2 , V_504 , V_505 ) ;
else
F_271 ( V_2 , V_504 , V_506 ) ;
}
}
static inline bool F_272 ( struct V_214 * V_164 , T_2 V_89 ,
T_2 V_104 )
{
...
static void F_274 ( struct V_1 * V_2 , T_2 V_89 , T_2 V_104 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
if ( ! V_38 -> V_60 . V_510 )
F_273 ( V_2 , V_89 , V_104 ) ;
else
F_272 ( V_38 -> V_511 , V_89 , V_104 ) ;
}
static void F_275 ( struct V_1 * V_2 , const struct V_3 * V_4 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
...
V_104 = V_38 -> V_102 ;
F_273 ( V_2 , F_26 ( V_4 ) -> V_89 , V_104 ) ;
}
}
F_232 ( V_2 ) ;
}
static void F_276 ( struct V_37 * V_38 )
{
int V_513 ;
struct V_214 * V_164 = & V_38 -> V_514 [ 0 ] ;
struct V_214 * V_515 = V_164 + 1 ;
for ( V_513 = 1 ; V_513 < V_38 -> V_60 . V_165 ; ) {
if ( F_272 ( V_164 , V_515 -> V_160 , V_515 -> V_104 ) ) {
int V_227 ;
V_38 -> V_60 . V_165 -- ;
...
static void F_277 ( struct V_1 * V_2 , T_2 V_89 , T_2 V_104 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
struct V_214 * V_164 = & V_38 -> V_514 [ 0 ] ;
...
static void F_278 ( struct V_37 * V_38 )
{
struct V_214 * V_164 = & V_38 -> V_514 [ 0 ] ;
...
return false ;
if ( ! F_281 ( V_518 , V_519 , V_520 , & V_306 ) )
return false ;
F_282 ( V_306 , & V_2 -> V_93 ) ;
F_283 ( V_2 , V_306 ) ;
F_77 ( F_4 ( V_2 ) , V_521 ) ;
...
struct V_526 * V_527 ;
V_527 = F_288 ( & V_38 -> V_501 ) ;
while ( V_527 ) {
V_4 = F_289 ( V_527 , struct V_3 , V_528 ) ;
...
F_274 ( V_2 , F_26 ( V_4 ) -> V_89 , V_510 ) ;
}
V_527 = F_290 ( V_527 ) ;
F_291 ( & V_4 -> V_528 , & V_38 -> V_501 ) ;
...
F_26 ( V_4 ) -> V_104 ) ;
V_525 = F_292 ( & V_2 -> V_529 ) ;
V_524 = V_525 && F_280 ( V_2 , V_525 , V_4 , & V_520 ) ;
F_221 ( V_38 , F_26 ( V_4 ) -> V_104 ) ;
...
static int F_295 ( struct V_1 * V_2 , struct V_3 * V_4 ,
unsigned int V_530 )
{
if ( F_51 ( & V_2 -> V_93 ) > V_2 -> V_81 ||
! F_296 ( V_2 , V_4 , V_530 ) ) {
...
bool V_520 ;
F_29 ( V_38 , V_4 ) ;
if ( F_11 ( F_295 ( V_2 , V_4 , V_4 -> V_71 ) ) ) {
F_77 ( F_4 ( V_2 ) , V_534 ) ;
F_284 ( V_2 , V_4 ) ;
return;
}
...
F_300 ( & V_4 -> V_528 , NULL , V_527 ) ;
F_301 ( & V_4 -> V_528 , & V_38 -> V_501 ) ;
V_38 -> V_536 = V_4 ;
goto V_537;
}
if ( F_280 ( V_2 , V_38 -> V_536 , V_4 , & V_520 ) ) {
V_538:
F_39 ( V_2 , V_4 ) ;
F_294 ( V_4 , V_520 ) ;
V_4 = NULL ;
...
while ( * V_527 ) {
V_532 = * V_527 ;
V_533 = F_289 ( V_532 , struct V_3 , V_528 ) ;
...
F_273 ( V_2 , V_89 , F_26 ( V_533 ) -> V_104 ) ;
} else {
F_302 ( & V_533 -> V_528 , & V_4 -> V_528 ,
& V_38 -> V_501 ) ;
F_274 ( V_2 ,
F_26 ( V_533 ) -> V_89 ,
F_26 ( V_533 ) -> V_104 ) ;
...
} else if ( F_280 ( V_2 , V_533 , V_4 , & V_520 ) ) {
goto V_538;
}
V_527 = & V_532 -> V_540 ;
}
V_541:
F_300 ( & V_4 -> V_528 , V_532 , V_527 ) ;
F_301 ( & V_4 -> V_528 , & V_38 -> V_501 ) ;
V_544:
while ( ( V_531 = F_290 ( & V_4 -> V_528 ) ) != NULL ) {
V_533 = F_289 ( V_531 , struct V_3 , V_528 ) ;
if ( ! F_62 ( V_104 , F_26 ( V_533 ) -> V_89 ) )
break;
if ( F_55 ( V_104 , F_26 ( V_533 ) -> V_104 ) ) {
F_274 ( V_2 , F_26 ( V_533 ) -> V_89 ,
V_104 ) ;
break;
}
F_291 ( & V_533 -> V_528 , & V_38 -> V_501 ) ;
F_274 ( V_2 , F_26 ( V_533 ) -> V_89 ,
F_26 ( V_533 ) -> V_104 ) ;
F_77 ( F_4 ( V_2 ) , V_543 ) ;
F_284 ( V_2 , V_533 ) ;
...
static int T_10 F_304 ( struct V_1 * V_2 , struct V_3 * V_4 , int V_545 ,
bool * V_520 )
{
int V_524 ;
struct V_3 * V_525 = F_292 ( & V_2 -> V_529 ) ;
F_305 ( V_4 , V_545 ) ;
V_524 = ( V_525 &&
F_280 ( V_2 , V_525 , V_4 , V_520 ) ) ? 1 : 0 ;
F_221 ( F_15 ( V_2 ) , F_26 ( V_4 ) -> V_104 ) ;
if ( ! V_524 ) {
F_293 ( & V_2 -> V_529 , V_4 ) ;
F_303 ( V_4 , V_2 ) ;
}
...
int F_306 ( struct V_1 * V_2 , struct V_546 * V_282 , T_11 V_530 )
{
struct V_3 * V_4 ;
int V_175 = - V_547 ;
int V_548 = 0 ;
...
V_4 = F_307 ( V_530 - V_548 , V_548 ,
V_554 ,
& V_175 , V_2 -> V_555 ) ;
if ( ! V_4 )
goto V_175;
F_308 ( V_4 , V_530 - V_548 ) ;
V_4 -> V_548 = V_548 ;
V_4 -> V_15 = V_530 ;
if ( F_295 ( V_2 , V_4 , V_4 -> V_71 ) )
goto V_556;
V_175 = F_309 ( V_4 , 0 , & V_282 -> V_557 , V_530 ) ;
if ( V_175 )
goto V_556;
F_26 ( V_4 ) -> V_89 = F_15 ( V_2 ) -> V_102 ;
F_26 ( V_4 ) -> V_104 = F_26 ( V_4 ) -> V_89 + V_530 ;
F_26 ( V_4 ) -> V_170 = F_15 ( V_2 ) -> V_117 - 1 ;
if ( F_304 ( V_2 , V_4 , 0 , & V_520 ) ) {
F_171 ( V_520 ) ;
F_286 ( V_4 ) ;
}
return V_530 ;
...
static void F_311 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
bool V_520 = false ;
int V_524 = - 1 ;
...
F_313 ( V_2 ) && ! V_38 -> V_562 ) {
int V_563 = F_10 (unsigned int, skb->len,
tp->ucopy.len) ;
F_314 ( V_564 ) ;
if ( ! F_315 ( V_4 , 0 , V_38 -> V_559 . V_282 , V_563 ) ) {
...
V_565:
if ( V_524 < 0 ) {
if ( F_316 ( & V_2 -> V_529 ) == 0 )
F_317 ( V_2 , V_4 -> V_71 ) ;
else if ( F_295 ( V_2 , V_4 , V_4 -> V_71 ) )
goto V_566;
}
V_524 = F_304 ( V_2 , V_4 , 0 , & V_520 ) ;
}
F_221 ( V_38 , F_26 ( V_4 ) -> V_104 ) ;
if ( V_4 -> V_15 )
F_58 ( V_2 , V_4 ) ;
...
if ( ! F_62 ( F_26 ( V_4 ) -> V_104 , V_38 -> V_102 ) ) {
F_77 ( F_4 ( V_2 ) , V_512 ) ;
F_273 ( V_2 , F_26 ( V_4 ) -> V_89 , F_26 ( V_4 ) -> V_104 ) ;
V_558:
F_18 ( V_2 ) ;
F_59 ( V_2 ) ;
V_566:
...
if ( ! F_55 ( F_26 ( V_4 ) -> V_89 , V_38 -> V_102 + F_260 ( V_38 ) ) )
goto V_558;
F_18 ( V_2 ) ;
...
V_38 -> V_102 , F_26 ( V_4 ) -> V_89 ,
F_26 ( V_4 ) -> V_104 ) ;
F_273 ( V_2 , F_26 ( V_4 ) -> V_89 , V_38 -> V_102 ) ;
if ( ! F_260 ( V_38 ) )
goto V_558;
goto V_565;
}
...
static struct V_3 * F_318 ( struct V_3 * V_4 , struct V_568 * V_569 )
{
if ( V_569 )
return ! F_319 ( V_569 , V_4 ) ? V_4 -> V_374 : NULL ;
return F_320 ( F_290 ( & V_4 -> V_528 ) , struct V_3 , V_528 ) ;
}
static struct V_3 * F_321 ( struct V_1 * V_2 , struct V_3 * V_4 ,
struct V_568 * V_569 ,
struct V_570 * V_571 )
{
struct V_3 * V_374 = F_318 ( V_4 , V_569 ) ;
if ( V_569 )
F_322 ( V_4 , V_569 ) ;
else
F_291 ( & V_4 -> V_528 , V_571 ) ;
F_286 ( V_4 ) ;
F_77 ( F_4 ( V_2 ) , V_572 ) ;
return V_374 ;
}
static void F_323 ( struct V_570 * V_571 , struct V_3 * V_4 )
{
...
F_300 ( & V_4 -> V_528 , V_532 , V_527 ) ;
F_301 ( & V_4 -> V_528 , V_571 ) ;
}
static void
F_324 ( struct V_1 * V_2 , struct V_568 * V_569 , struct V_570 * V_571 ,
...
V_575 = F_318 ( V_4 , V_569 ) ;
if ( ! F_55 ( V_574 , F_26 ( V_4 ) -> V_104 ) ) {
V_4 = F_321 ( V_2 , V_4 , V_569 , V_571 ) ;
if ( ! V_4 )
break;
goto V_577;
}
...
int V_578 = F_10 ( int , F_326 ( 0 , 0 ) , V_537 - V_574 ) ;
struct V_3 * V_579 ;
V_579 = F_327 ( V_578 , V_180 ) ;
if ( ! V_579 )
break;
memcpy ( V_579 -> V_580 , V_4 -> V_580 , sizeof( V_4 -> V_580 ) ) ;
F_26 ( V_579 ) -> V_89 = F_26 ( V_579 ) -> V_104 = V_574 ;
if ( V_569 )
F_328 ( V_569 , V_4 , V_579 ) ;
else
F_293 ( & V_217 , V_579 ) ;
F_303 ( V_579 , V_2 ) ;
while ( V_578 > 0 ) {
...
if ( F_329 ( V_4 , V_581 , F_308 ( V_579 , V_530 ) , V_530 ) )
F_330 () ;
...
T_2 V_574 , V_537 ;
V_527 = F_288 ( & V_38 -> V_501 ) ;
V_4 = F_320 ( V_527 , struct V_3 , V_528 ) ;
V_582:
if ( ! V_4 ) {
V_527 = F_333 ( & V_38 -> V_501 ) ;
V_38 -> V_536 = F_289 ( V_527 , struct V_3 , V_528 ) ;
return;
}
V_574 = F_26 ( V_4 ) -> V_89 ;
...
do {
V_199 = F_334 ( V_583 ) ;
F_291 ( V_583 , & V_38 -> V_501 ) ;
F_284 ( V_2 , F_289 ( V_583 , struct V_3 , V_528 ) ) ;
F_60 ( V_2 ) ;
if ( F_51 ( & V_2 -> V_93 ) <= V_2 -> V_81 &&
! F_41 ( V_2 ) )
break;
...
V_38 -> V_536 = F_289 ( V_199 , struct V_3 , V_528 ) ;
if ( V_38 -> V_60 . V_132 )
F_250 ( & V_38 -> V_60 ) ;
return true ;
}
...
static bool F_337 ( const struct V_1 * V_2 )
{
const struct V_37 * V_38 = F_15 ( V_2 ) ;
if ( V_2 -> V_83 & V_85 )
return false ;
...
static void F_345 ( struct V_1 * V_2 , int V_591 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
if ( ( ( V_38 -> V_102 - V_38 -> V_410 ) > F_8 ( V_2 ) -> V_13 . V_17 &&
F_346 ( V_2 ) >= V_38 -> V_28 ) ||
F_19 ( V_2 ) ||
( V_591 && ! F_279 ( & V_38 -> V_501 ) ) ) {
F_232 ( V_2 ) ;
} else {
F_347 ( V_2 ) ;
}
}
static inline void F_348 ( struct V_1 * V_2 )
{
if ( ! F_349 ( V_2 ) ) {
return;
}
...
static void F_350 ( struct V_1 * V_2 , const struct V_20 * V_51 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
T_2 V_221 = F_161 ( V_51 -> V_592 ) ;
if ( V_221 && ! V_593 )
V_221 -- ;
V_221 += F_254 ( V_51 -> V_89 ) ;
if ( F_62 ( V_38 -> V_90 , V_221 ) )
return;
if ( F_55 ( V_221 , V_38 -> V_102 ) )
return;
if ( V_38 -> V_562 && ! F_62 ( V_221 , V_38 -> V_594 ) )
return;
F_351 ( V_2 ) ;
if ( V_38 -> V_594 == V_38 -> V_90 && V_38 -> V_562 &&
! F_263 ( V_2 , V_595 ) && V_38 -> V_90 != V_38 -> V_102 ) {
struct V_3 * V_4 = F_336 ( & V_2 -> V_529 ) ;
V_38 -> V_90 ++ ;
...
static void F_352 ( struct V_1 * V_2 , struct V_3 * V_4 , const struct V_20 * V_51 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
if ( V_51 -> V_597 )
F_350 ( V_2 , V_51 ) ;
if ( V_38 -> V_562 == V_596 ) {
T_2 V_221 = V_38 -> V_594 - F_254 ( V_51 -> V_89 ) + ( V_51 -> V_447 * 4 ) -
V_51 -> V_53 ;
if ( V_221 < V_4 -> V_15 ) {
T_6 V_217 ;
if ( F_329 ( V_4 , V_221 , & V_217 , 1 ) )
F_330 () ;
V_38 -> V_562 = V_598 | V_217 ;
if ( ! F_263 ( V_2 , V_489 ) )
V_2 -> V_567 ( V_2 ) ;
}
}
}
static int F_353 ( struct V_1 * V_2 , struct V_3 * V_4 , int V_599 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
int V_563 = V_4 -> V_15 - V_599 ;
int V_175 ;
if ( F_354 ( V_4 ) )
V_175 = F_315 ( V_4 , V_599 , V_38 -> V_559 . V_282 , V_563 ) ;
else
V_175 = F_355 ( V_4 , V_599 , V_38 -> V_559 . V_282 ) ;
if ( ! V_175 ) {
V_38 -> V_559 . V_15 -= V_563 ;
V_38 -> V_90 += V_563 ;
F_57 ( V_2 ) ;
...
const struct V_20 * V_51 , int V_600 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
bool V_601 = false ;
if ( F_255 ( V_4 , V_51 , V_38 ) && V_38 -> V_60 . V_280 &&
F_258 ( V_2 , V_4 ) ) {
if ( ! V_51 -> V_602 ) {
F_77 ( F_4 ( V_2 ) , V_603 ) ;
if ( ! F_227 ( F_4 ( V_2 ) , V_4 ,
V_604 ,
& V_38 -> V_397 ) )
F_275 ( V_2 , V_4 ) ;
goto V_605;
...
if ( ! F_259 ( V_38 , F_26 ( V_4 ) -> V_89 , F_26 ( V_4 ) -> V_104 ) ) {
if ( ! V_51 -> V_602 ) {
if ( V_51 -> V_53 )
goto V_606;
if ( ! F_227 ( F_4 ( V_2 ) , V_4 ,
...
struct V_214 * V_164 = & V_38 -> V_514 [ 0 ] ;
int V_608 = V_164 [ 0 ] . V_104 ;
int V_513 ;
for ( V_513 = 1 ; V_513 < V_38 -> V_60 . V_165 ;
++ V_513 ) {
V_608 = F_62 ( V_164 [ V_513 ] . V_104 ,
V_608 ) ?
V_164 [ V_513 ] . V_104 : V_608 ;
}
if ( F_26 ( V_4 ) -> V_89 == V_608 )
V_601 = true ;
}
if ( V_601 )
F_261 ( V_2 ) ;
...
void F_358 ( struct V_1 * V_2 , struct V_3 * V_4 ,
const struct V_20 * V_51 , unsigned int V_15 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
if ( F_11 ( ! V_2 -> V_611 ) )
F_8 ( V_2 ) -> V_612 -> V_613 ( V_2 , V_4 ) ;
V_38 -> V_60 . V_280 = 0 ;
if ( ( F_13 ( V_51 ) & V_614 ) == V_38 -> V_396 &&
...
V_615:
if ( V_15 < ( V_51 -> V_447 << 2 ) || F_359 ( V_4 ) )
goto V_617;
if ( ! V_51 -> V_351 && ! V_51 -> V_602 && ! V_51 -> V_53 )
goto V_605;
if ( ! F_356 ( V_2 , V_4 , V_51 , 1 ) )
return;
V_619:
if ( F_241 ( V_2 , V_4 , V_424 | V_423 ) < 0 )
goto V_605;
F_56 ( V_2 , V_4 ) ;
F_352 ( V_2 , V_4 , V_51 ) ;
F_311 ( V_2 , V_4 ) ;
...
void F_360 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
struct V_10 * V_11 = F_8 ( V_2 ) ;
F_267 ( V_2 , V_495 ) ;
if ( V_4 ) {
V_11 -> V_612 -> V_613 ( V_2 , V_4 ) ;
F_361 ( V_2 , V_4 ) ;
}
V_11 -> V_612 -> V_623 ( V_2 ) ;
F_362 ( V_2 ) ;
F_363 ( V_2 ) ;
V_38 -> V_624 = V_88 ;
F_45 ( V_2 ) ;
if ( F_263 ( V_2 , V_625 ) )
F_364 ( V_2 , F_365 ( V_38 ) ) ;
if ( ! V_38 -> V_60 . V_394 )
F_366 ( V_38 , V_38 -> V_390 ) ;
else
V_38 -> V_396 = 0 ;
if ( ! F_263 ( V_2 , V_489 ) ) {
V_2 -> V_502 ( V_2 ) ;
F_271 ( V_2 , V_626 , V_627 ) ;
}
}
static bool F_367 ( struct V_1 * V_2 , struct V_3 * V_628 ,
struct V_437 * V_436 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
struct V_3 * V_18 = V_38 -> V_629 ? F_110 ( V_2 ) : NULL ;
T_8 V_78 = V_38 -> V_60 . V_61 , V_630 = 0 ;
bool V_631 = false ;
if ( V_78 == V_38 -> V_60 . V_455 ) {
struct V_443 V_632 ;
F_368 ( & V_632 ) ;
V_632 . V_455 = V_632 . V_61 = 0 ;
F_247 ( V_628 , & V_632 , 0 , NULL ) ;
V_78 = V_632 . V_61 ;
}
if ( ! V_38 -> V_633 ) {
V_436 -> V_15 = - 1 ;
} else if ( V_38 -> V_634 ) {
V_631 = ( V_436 -> V_15 < 0 && V_18 ) ;
} else if ( V_436 -> V_15 < 0 && ! V_38 -> V_629 ) {
V_630 = V_38 -> V_635 ? 2 : 1 ;
}
F_369 ( V_2 , V_78 , V_436 , V_631 , V_630 ) ;
if ( V_18 ) {
F_117 (data, sk) {
if ( V_18 == F_115 ( V_2 ) ||
F_370 ( V_2 , V_18 , 1 ) )
...
static int F_372 ( struct V_1 * V_2 , struct V_3 * V_4 ,
const struct V_20 * V_51 )
{
struct V_10 * V_11 = F_8 ( V_2 ) ;
struct V_37 * V_38 = F_15 ( V_2 ) ;
struct V_437 V_438 = { . V_15 = - 1 } ;
int V_639 = V_38 -> V_60 . V_61 ;
F_247 ( V_4 , & V_38 -> V_60 , 0 , & V_438 ) ;
if ( V_38 -> V_60 . V_280 && V_38 -> V_60 . V_103 )
V_38 -> V_60 . V_103 -= V_38 -> V_477 ;
if ( V_51 -> V_351 ) {
...
goto V_640;
if ( V_38 -> V_60 . V_280 && V_38 -> V_60 . V_103 &&
! F_210 ( V_38 -> V_60 . V_103 , V_38 -> V_281 ,
V_88 ) ) {
F_77 ( F_4 ( V_2 ) ,
V_641 ) ;
goto V_640;
...
goto V_642;
F_30 ( V_38 , V_51 ) ;
F_373 ( V_38 , F_26 ( V_4 ) -> V_89 ) ;
F_241 ( V_2 , V_4 , V_424 ) ;
V_38 -> V_102 = F_26 ( V_4 ) -> V_89 + 1 ;
V_38 -> V_410 = F_26 ( V_4 ) -> V_89 + 1 ;
V_38 -> V_390 = F_161 ( V_51 -> V_72 ) ;
if ( ! V_38 -> V_60 . V_459 ) {
V_38 -> V_60 . V_394 = V_38 -> V_60 . V_643 = 0 ;
...
V_38 -> V_410 = F_26 ( V_4 ) -> V_89 + 1 ;
V_38 -> V_390 = F_161 ( V_51 -> V_72 ) ;
V_38 -> V_389 = F_26 ( V_4 ) -> V_89 ;
V_38 -> V_161 = V_38 -> V_390 ;
F_31 ( V_38 , V_51 ) ;
F_375 ( V_2 ) ;
F_180 ( V_2 , V_11 -> V_317 ) ;
F_52 ( V_2 ) ;
...
int F_379 ( struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_37 * V_38 = F_15 ( V_2 ) ;
struct V_10 * V_11 = F_8 ( V_2 ) ;
const struct V_20 * V_51 = F_14 ( V_4 ) ;
...
V_2 -> V_481 != V_498 ) ;
if ( ! F_381 ( V_2 , V_4 , V_347 , true ) )
goto V_605;
}
if ( ! V_51 -> V_351 && ! V_51 -> V_602 && ! V_51 -> V_53 )
goto V_605;
if ( ! F_356 ( V_2 , V_4 , V_51 , 0 ) )
return 0 ;
V_651 = F_241 ( V_2 , V_4 , V_424 |
V_423 ) > 0 ;
switch ( V_2 -> V_481 ) {
case V_494 :
if ( ! V_651 )
...
V_38 -> V_390 = F_161 ( V_51 -> V_72 ) << V_38 -> V_60 . V_394 ;
F_373 ( V_38 , F_26 ( V_4 ) -> V_89 ) ;
if ( V_38 -> V_60 . V_463 )
V_38 -> V_77 -= V_478 ;
if ( V_347 ) {
...
V_654 = F_384 ( V_2 ) ;
if ( V_654 > V_659 ) {
F_364 ( V_2 , V_654 - V_659 ) ;
} else if ( V_51 -> V_523 || F_313 ( V_2 ) ) {
F_364 ( V_2 , V_654 ) ;
} else {
F_268 ( V_2 , V_499 , V_654 ) ;
goto V_605;
}
break;
}
...
static inline void F_386 ( struct V_346 * V_347 , T_12 V_660 , int V_661 )
{
struct V_662 * V_663 = F_387 ( V_347 ) ;
if ( V_661 == V_286 )
F_388 ( L_23 ,
& V_663 -> V_664 , V_660 ) ;
#if F_163 ( V_289 )
...
static void F_389 ( struct V_346 * V_347 ,
const struct V_3 * V_4 ,
const struct V_1 * V_666 ,
const struct V_34 * V_35 )
{
const struct V_20 * V_51 = F_14 ( V_4 ) ;
const struct V_241 * V_241 = F_4 ( V_666 ) ;
bool V_667 = V_51 -> V_52 && V_51 -> V_42 ;
bool V_668 , V_669 ;
T_2 V_670 ;
if ( ! V_667 )
return;
V_668 = ! F_390 ( F_26 ( V_4 ) -> V_44 ) ;
V_670 = F_391 ( V_35 , V_671 ) ;
V_669 = V_241 -> V_253 . V_672 || V_670 ;
if ( ( ! V_668 && V_669 ) || F_27 ( V_666 ) ||
( V_670 & V_673 ) )
F_387 ( V_347 ) -> V_669 = 1 ;
}
static void F_392 ( struct V_346 * V_347 ,
...
V_347 -> V_674 = 0 ;
V_347 -> V_675 = 0 ;
F_197 ( V_347 ) -> V_676 = F_26 ( V_4 ) -> V_89 ;
F_197 ( V_347 ) -> V_102 = F_26 ( V_4 ) -> V_89 + 1 ;
F_198 ( & F_197 ( V_347 ) -> V_349 ) ;
F_197 ( V_347 ) -> V_397 = 0 ;
V_347 -> V_78 = V_60 -> V_61 ;
V_347 -> V_407 = V_60 -> V_280 ? V_60 -> V_408 : 0 ;
V_663 -> V_463 = V_60 -> V_463 ;
V_663 -> V_132 = V_60 -> V_132 ;
V_663 -> V_394 = V_60 -> V_394 ;
V_663 -> V_459 = V_60 -> V_459 ;
V_663 -> V_240 = 0 ;
V_663 -> V_669 = 0 ;
V_663 -> V_677 = F_14 ( V_4 ) -> V_678 ;
V_663 -> V_679 = F_161 ( F_14 ( V_4 ) -> V_680 ) ;
V_663 -> V_681 = F_393 ( V_2 , V_4 ) ;
}
struct V_346 * F_394 ( const struct V_682 * V_683 ,
struct V_1 * V_684 ,
bool V_685 )
{
struct V_346 * V_347 = F_395 ( V_683 , V_684 ,
V_685 ) ;
if ( V_347 ) {
struct V_662 * V_663 = F_387 ( V_347 ) ;
F_396 ( V_663 , V_412 ) ;
...
F_397 ( & V_663 -> V_687 , 0 ) ;
V_663 -> V_688 = V_689 ;
F_398 ( & V_663 -> V_690 , F_4 ( V_684 ) ) ;
V_663 -> V_691 = V_684 -> V_285 ;
}
return V_347 ;
}
static bool F_399 ( const struct V_1 * V_2 ,
const struct V_3 * V_4 ,
const char * V_692 )
{
struct V_693 * V_694 = & F_8 ( V_2 ) -> V_646 ;
const char * V_282 = L_25 ;
bool V_695 = false ;
struct V_241 * V_241 = F_4 ( V_2 ) ;
#ifdef F_400
if ( V_241 -> V_253 . V_696 ) {
V_282 = L_26 ;
V_695 = true ;
F_401 ( F_4 ( V_2 ) , V_697 ) ;
} else
...
if ( ! V_694 -> V_699 &&
V_241 -> V_253 . V_696 != 2 &&
F_402 ( & V_694 -> V_699 , 1 ) == 0 )
F_403 ( L_27 ,
V_692 , F_161 ( F_14 ( V_4 ) -> V_680 ) , V_282 ) ;
return V_695 ;
}
static void F_404 ( const struct V_1 * V_2 ,
struct V_346 * V_347 ,
const struct V_3 * V_4 )
{
if ( F_15 ( V_2 ) -> V_700 ) {
T_2 V_15 = F_405 ( V_4 ) + F_406 ( V_4 ) ;
T_2 * V_578 ;
V_578 = F_407 ( V_15 + sizeof( T_2 ) , V_180 ) ;
if ( V_578 ) {
V_578 [ 0 ] = V_15 ;
memcpy ( & V_578 [ 1 ] , F_408 ( V_4 ) , V_15 ) ;
V_347 -> V_701 = V_578 ;
}
}
}
int F_409 ( struct V_682 * V_702 ,
const struct V_703 * V_704 ,
struct V_1 * V_2 , struct V_3 * V_4 )
{
struct V_437 V_438 = { . V_15 = - 1 } ;
T_4 V_705 = F_26 ( V_4 ) -> V_706 ;
struct V_443 V_707 ;
struct V_37 * V_38 = F_15 ( V_2 ) ;
struct V_241 * V_241 = F_4 ( V_2 ) ;
struct V_1 * V_708 = NULL ;
struct V_34 * V_35 = NULL ;
struct V_346 * V_347 ;
bool V_695 = false ;
struct V_709 V_710 ;
if ( ( V_241 -> V_253 . V_696 == 2 ||
F_410 ( V_2 ) ) && ! V_705 ) {
V_695 = F_399 ( V_2 , V_4 , V_702 -> V_711 ) ;
if ( ! V_695 )
goto V_566;
}
if ( F_411 ( V_2 ) && F_412 ( V_2 ) > 1 ) {
F_77 ( F_4 ( V_2 ) , V_712 ) ;
goto V_566;
}
V_347 = F_394 ( V_702 , V_2 , ! V_695 ) ;
if ( ! V_347 )
goto V_566;
F_197 ( V_347 ) -> V_713 = V_704 ;
F_368 ( & V_707 ) ;
V_707 . V_61 = V_704 -> V_61 ;
V_707 . V_455 = V_38 -> V_60 . V_455 ;
F_247 ( V_4 , & V_707 , 0 , V_695 ? NULL : & V_438 ) ;
if ( V_695 && ! V_707 . V_280 )
F_368 ( & V_707 ) ;
V_707 . V_463 = V_707 . V_280 ;
F_392 ( V_347 , & V_707 , V_4 , V_2 ) ;
F_387 ( V_347 ) -> V_714 = F_160 ( V_2 ) -> V_715 ;
F_387 ( V_347 ) -> V_716 = F_413 ( V_2 , V_4 ) ;
V_704 -> V_717 ( V_347 , V_2 , V_4 ) ;
if ( F_414 ( V_2 , V_4 , V_347 ) )
goto V_718;
if ( ! V_695 && ! V_705 ) {
if ( V_719 . V_720 ) {
bool V_721 ;
V_35 = V_704 -> V_722 ( V_2 , & V_710 , V_347 , & V_721 ) ;
if ( V_35 && V_721 &&
! F_415 ( V_347 , V_35 , true ,
V_707 . V_280 ) ) {
F_77 ( F_4 ( V_2 ) , V_723 ) ;
goto V_724;
}
}
else if ( ! V_241 -> V_253 . V_696 &&
( V_725 - F_416 ( V_2 ) <
( V_725 >> 2 ) ) &&
! F_415 ( V_347 , V_35 , false ,
V_707 . V_280 ) ) {
F_386 ( V_347 , F_161 ( F_14 ( V_4 ) -> V_678 ) ,
V_702 -> V_661 ) ;
goto V_724;
}
V_705 = V_704 -> V_726 ( V_4 ) ;
}
if ( ! V_35 ) {
V_35 = V_704 -> V_722 ( V_2 , & V_710 , V_347 , NULL ) ;
if ( ! V_35 )
goto V_718;
}
F_389 ( V_347 , V_4 , V_2 , V_35 ) ;
if ( V_695 ) {
V_705 = F_417 ( V_704 , V_2 , V_4 , & V_347 -> V_78 ) ;
V_347 -> V_675 = V_707 . V_463 ;
if ( ! V_707 . V_463 )
F_387 ( V_347 ) -> V_669 = 0 ;
}
F_197 ( V_347 ) -> V_727 = V_705 ;
F_197 ( V_347 ) -> V_728 = F_418 () ;
F_419 ( V_347 , V_2 , V_35 ) ;
if ( ! V_695 ) {
F_404 ( V_2 , V_347 , V_4 ) ;
V_708 = F_420 ( V_2 , V_4 , V_347 , & V_438 , V_35 ) ;
}
if ( V_708 ) {
V_704 -> V_729 ( V_708 , V_35 , & V_710 , V_347 ,
& V_438 , V_730 ) ;
F_421 ( V_2 , V_347 , V_708 ) ;
V_2 -> V_567 ( V_2 ) ;
F_422 ( V_708 ) ;
F_423 ( V_708 ) ;
} else {
F_197 ( V_347 ) -> V_731 = false ;
if ( ! V_695 )
F_424 ( V_2 , V_347 , V_732 ) ;
V_704 -> V_729 ( V_2 , V_35 , & V_710 , V_347 , & V_438 ,
! V_695 ? V_733 :
V_734 ) ;
if ( V_695 ) {
F_425 ( V_347 ) ;
