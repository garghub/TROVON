...
static int
F_10 ( struct V_28 * * V_29 , T_1 * V_2 , T_3 V_30 )
{
...
static void
F_35 ( struct V_13 * V_16 , struct V_81 * V_82 )
{
...
if ( V_82 -> V_166 -> V_189 ( V_82 , V_146 , V_146 -> V_190 ) == V_191 )
continue;
F_33 ( & V_146 -> V_192 ) ;
F_81 ( V_146 , V_82 ) ;
}
F_46 ( V_120 ) ;
F_21 ( V_56 , L_17 ,
F_22 ( V_141 ) , V_82 -> V_166 -> V_193 ,
& V_82 -> V_85 , & V_82 -> V_88 ,
V_82 -> V_194 , V_142 , V_31 ,
( int ) ( V_104 - & V_104 -> V_195 -> V_106 [ 0 ] ) ) ;
if ( V_148 ) {
F_59 ( V_33 , V_82 -> V_194 ,
...
tx_list)
F_91 ( V_82 , V_146 ) ;
F_17 ( & V_82 -> V_181 -> V_197 ) ;
F_50 ( & V_33 -> V_49 ,
& V_82 -> V_158 ) ;
F_18 ( & V_82 -> V_181 -> V_197 ) ;
}
V_33 -> V_43 = NULL ;
V_33 -> V_180 = error ;
if ( F_23 ( & V_33 -> V_48 ) ) {
...
if ( V_146 -> V_206 != V_82 )
continue;
F_2 ( V_146 -> V_207 . V_208 [ 0 ] ) ;
V_146 -> V_207 . V_208 [ 0 ] = 0 ;
V_146 -> V_209 = 1 ;
F_33 ( & V_146 -> V_210 ) ;
F_77 ( & V_146 -> V_210 , & V_205 ) ;
}
F_97 ( & V_33 -> V_51 ) ;
...
& V_82 -> V_88 , V_82 -> V_194 ,
V_82 -> V_220 , V_82 -> V_221 ,
F_104 ( F_105 ( F_74 () ,
V_216 ) ) ) ;
...
int
F_73 ( struct V_28 * V_33 , T_2 V_14 , int V_228 )
{
struct V_81 * V_82 ;
struct V_57 * V_89 ;
struct V_57 * V_90 ;
...
int
F_107 ( struct V_81 * V_82 , int V_228 )
{
struct V_28 * V_33 = V_82 -> V_152 ;
T_2 V_14 = V_82 -> V_88 ;
int V_229 ;
F_45 ( & V_61 . V_62 ) ;
V_229 = F_73 ( V_33 , V_14 , V_228 ) ;
F_46 ( & V_61 . V_62 ) ;
return V_229 ;
}
int
...
void
F_109 ( T_1 * V_2 , T_7 V_230 , int V_231 )
{
T_3 V_30 = { 0 } ;
V_30 . V_32 = V_230 ;
V_30 . V_35 = V_36 ;
F_21 ( V_56 , L_24 , F_110 ( V_230 ) ,
V_231 ? L_25 : L_26 ) ;
if ( ! V_231 ) {
F_108 ( V_30 , 0 ) ;
return;
...
void
F_111 ( T_1 * V_2 , T_7 V_32 , unsigned long * V_232 )
{
int V_233 = 1 ;
unsigned long V_202 = 0 ;
unsigned long V_234 = F_74 () ;
struct V_28 * V_33 = NULL ;
T_4 * V_235 = & V_61 . V_62 ;
T_3 V_30 = {
. V_32 = V_32 ,
...
struct V_57 * V_59 ;
int V_75 = - V_76 ;
unsigned int V_240 = V_61 . V_77 ;
if ( V_30 . V_32 == V_34 ) {
V_238 = & V_61 . V_99 [ 0 ] ;
V_239 = & V_61 . V_99 [ V_240 - 1 ] ;
} else {
V_238 = F_25 ( V_30 . V_32 ) ;
V_239 = F_25 ( V_30 . V_32 ) ;
}
for ( V_59 = V_238 ; V_59 <= V_239 ; V_59 ++ ) {
int V_241 ;
for ( V_241 = 0 ; ; V_241 ++ ) {
struct V_28 * V_33 ;
int V_7 = 0 ;
...
static int
F_119 ( T_1 * V_2 , T_2 V_242 , T_2 V_243 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_1 * V_8 ;
int V_75 ;
...
F_45 ( & V_61 . V_62 ) ;
for ( V_7 = 0 ; V_7 < V_5 -> V_9 ; V_7 ++ ) {
V_245 = V_5 -> V_11 [ V_7 ] . V_12 ;
if ( ! ( ! V_242 || V_242 == V_245 ) )
continue;
V_75 = 0 ;
...
int
F_122 ( T_1 * V_2 , unsigned int V_246 , void * V_247 )
{
T_3 V_30 = { 0 } ;
struct V_248 * V_249 = V_247 ;
int V_75 ;
switch ( V_246 ) {
case V_250 : {
struct V_4 * V_5 = V_2 -> V_6 ;
struct V_1 * V_8 ;
F_29 ( & V_61 . V_62 ) ;
if ( V_249 -> V_251 >= ( T_2 ) V_5 -> V_9 ) {
V_75 = - V_76 ;
} else {
V_75 = 0 ;
V_8 = & V_5 -> V_11 [ V_249 -> V_251 ] ;
V_249 -> V_252 [ 0 ] = V_8 -> V_12 ;
V_249 -> V_252 [ 1 ] = V_8 -> V_117 ;
V_249 -> V_252 [ 2 ] = V_8 -> V_66 ;
V_249 -> V_252 [ 3 ] = V_8 -> V_65 ;
}
F_31 ( & V_61 . V_62 ) ;
return V_75 ;
}
...
int V_70 = 0 ;
int V_71 = 0 ;
V_75 = F_34 ( V_2 , V_249 -> V_251 ,
& V_30 , & V_68 , & V_3 , & V_15 ,
& V_70 , & V_71 ) ;
if ( V_75 )
return V_75 ;
V_249 -> V_256 = V_30 . V_32 ;
V_249 -> V_251 = V_71 ;
V_249 -> V_252 [ 0 ] = V_3 ;
V_249 -> V_252 [ 1 ] = V_15 ;
V_249 -> V_252 [ 2 ] = V_68 ;
V_249 -> V_252 [ 3 ] = V_70 ;
V_249 -> V_252 [ 4 ] = V_30 . V_35 ;
return 0 ;
}
case V_257 :
V_30 . V_32 = V_249 -> V_256 ;
V_30 . V_35 = V_236 ;
...
int V_261 ;
int V_262 ;
struct V_81 * V_82 = F_52 ( V_2 , V_249 -> V_251 ) ;
if ( ! V_82 )
return - V_76 ;
F_123 ( V_82 , & V_260 , & V_261 , & V_262 ) ;
V_249 -> V_251 = V_260 ;
V_249 -> V_256 = V_82 -> V_152 -> V_39 . V_32 ;
V_249 -> V_263 = V_262 ;
V_249 -> V_252 [ 0 ] = V_82 -> V_88 ;
V_249 -> V_252 [ 1 ] = V_82 -> V_194 ;
V_249 -> V_252 [ 2 ] = V_82 -> V_85 ;
V_249 -> V_252 [ 3 ] = V_82 -> V_83 ;
V_249 -> V_252 [ 4 ] = V_82 -> V_181 -> V_195 -> V_264 ;
V_249 -> V_252 [ 5 ] = V_261 ;
V_249 -> V_252 [ 6 ] = V_82 -> V_152 -> V_39 . V_35 ;
F_88 ( V_82 ) ;
return 0 ;
}
case V_265 :
...
struct V_145 * V_146 ;
struct V_145 * V_204 ;
F_77 ( & V_205 , & V_61 . V_271 ) ;
F_89 ( & V_61 . V_271 ) ;
F_97 ( & V_61 . V_270 ) ;
F_80 (tx, temp, &zlist, tx_list) {
F_33 ( & V_146 -> V_192 ) ;
F_9 ( V_146 , V_146 -> V_272 ) ;
}
} else {
F_97 ( & V_61 . V_270 ) ;
}
...
if ( ! V_102 -> V_106 )
continue;
for ( V_74 = 0 ; V_74 < V_102 -> V_269 ; V_74 ++ ) {
...
struct V_100 * V_104 ;
int V_289 ;
V_289 = F_139 ( F_14 () , V_7 ) ;
if ( * V_169 . V_290 > 0 ) {
V_289 = F_58 ( V_289 , * V_169 . V_290 ) ;
} else {
V_289 = F_58 ( F_140 ( V_291 , V_289 >> 1 ) , V_289 ) ;
}
V_102 -> V_269 = V_289 ;
V_102 -> V_264 = V_7 ;
F_13 ( V_102 -> V_106 , F_14 () , V_7 ,
V_102 -> V_269 * sizeof( * V_104 ) ) ;
if ( ! V_102 -> V_106 )
goto V_211;
for (; V_289 > 0 ; V_289 -- ) {
V_104 = & V_102 -> V_106 [ V_289 - 1 ] ;
V_104 -> V_195 = V_102 ;
F_16 ( & V_104 -> V_197 ) ;
F_15 ( & V_104 -> V_280 ) ;
F_15 ( & V_104 -> V_213 ) ;
...
for ( V_7 = 0 ; V_7 < * V_169 . V_295 ; V_7 ++ ) {
char V_298 [ 16 ] ;
F_17 ( & V_61 . V_137 ) ;
V_61 . V_292 ++ ;
F_18 ( & V_61 . V_137 ) ;
snprintf ( V_298 , sizeof( V_298 ) , L_30 , V_7 ) ;
V_75 = F_142 ( V_299 ,
( void * ) ( ( V_300 ) V_7 ) , V_298 ) ;
if ( V_75 ) {
F_17 ( & V_61 . V_137 ) ;
V_61 . V_292 -- ;
F_18 ( & V_61 . V_137 ) ;
...
for ( V_7 = V_74 = 0 ; V_7 < V_307 ; V_7 ++ ) {
int V_308 ;
T_2 V_3 ;
T_2 V_309 ;
if ( ! strcmp ( V_306 [ V_7 ] , L_39 ) )
continue;
V_75 = F_148 ( V_306 [ V_7 ] , & V_308 , & V_3 , & V_309 ) ;
if ( V_75 ) {
F_144 ( L_40 ,
V_306 [ V_7 ] , V_75 ) ;
continue;
...
V_5 -> V_11 [ V_74 ] . V_117 = V_309 ;
F_149 ( V_5 -> V_11 [ V_74 ] . V_310 ,
V_306 [ V_7 ] , sizeof( V_5 -> V_11 [ V_74 ] . V_310 ) ) ;
V_74 ++ ;
}
F_150 ( V_306 , V_307 ) ;
if ( ! V_74 )
...
int V_7 ;
for ( V_7 = 0 ; V_7 < V_5 -> V_9 ; V_7 ++ ) {
char * V_312 = & V_5 -> V_11 [ V_7 ] . V_310 [ 0 ] ;
char * V_313 = strchr ( V_312 , ':' ) ;
int V_314 = 0 ;
struct V_4 * V_59 ;
int V_74 ;
if ( V_313 )
...
for ( V_74 = 0 ; ! V_314 && V_74 < V_59 -> V_9 ; V_74 ++ ) {
char * V_315 =
& V_59 -> V_11 [ V_74 ] . V_310 [ 0 ] ;
char * V_316 = strchr ( V_315 , ':' ) ;
if ( V_316 )
* V_316 = 0 ;
V_314 = ! strcmp ( V_312 , V_315 ) ;
if ( V_316 )
* V_316 = ':' ;
}
if ( V_314 )
...
V_102 -> V_264 ) ;
V_289 = F_58 ( F_140 ( V_291 , V_289 >> 1 ) , V_289 ) ;
V_289 = F_58 ( V_317 , V_289 ) ;
}
V_289 = F_58 ( V_289 , V_102 -> V_269 ) ;
} else {
F_2 ( V_102 -> V_105 <= V_102 -> V_269 ) ;
V_289 = F_58 ( 2 , V_102 -> V_269 - V_102 -> V_105 ) ;
}
for ( V_7 = 0 ; V_7 < V_289 ; V_7 ++ ) {
long V_30 ;
char V_298 [ 20 ] ;
struct V_100 * V_104 ;
V_30 = F_153 ( V_102 -> V_264 , V_102 -> V_105 + V_7 ) ;
V_104 = & V_102 -> V_106 [ F_154 ( V_30 ) ] ;
snprintf ( V_298 , sizeof( V_298 ) , L_44 ,
V_102 -> V_264 , ( int ) ( V_104 - & V_102 -> V_106 [ 0 ] ) ) ;
V_75 = F_142 ( V_318 ,
( void * ) V_30 , V_298 ) ;
if ( ! V_75 )
continue;
F_19 ( L_45 ,
V_102 -> V_264 , V_102 -> V_105 + V_7 , V_75 ) ;
break;
}
V_102 -> V_105 += V_7 ;
return V_75 ;
...
static int
F_155 ( struct V_4 * V_5 , T_2 * V_319 , int V_320 )
{
int V_321 = F_151 ( V_5 ) ;
int V_75 ;
int V_7 ;
F_2 ( V_320 > 0 && V_320 <= F_156 ( F_14 () ) ) ;
for ( V_7 = 0 ; V_7 < V_320 ; V_7 ++ ) {
struct V_101 * V_102 ;
int V_31 = ! V_319 ? V_7 : V_319 [ V_7 ] ;
F_2 ( V_31 < F_156 ( F_14 () ) ) ;
V_102 = V_61 . V_103 [ V_31 ] ;
if ( ! V_321 && V_102 -> V_105 > 0 )
continue;
V_75 = F_152 ( V_102 ) ;
if ( V_75 )
return V_75 ;
...
V_5 -> V_325 = F_132 () ;
V_2 -> V_6 = V_5 ;
V_2 -> V_326 = * V_169 . V_327 ;
V_2 -> V_328 = * V_169 . V_329 ;
V_2 -> V_330 = * V_169 . V_331 ;
V_2 -> V_332 = * V_169 . V_333 ;
if ( ! V_2 -> V_334 [ 0 ] ) {
V_75 = F_146 ( V_5 ) ;
if ( V_75 <= 0 )
goto V_335;
...
if ( ! V_2 -> V_334 [ V_7 ] )
break;
V_75 = F_148 ( V_2 -> V_334 [ V_7 ] , & V_308 ,
& V_5 -> V_11 [ V_7 ] . V_12 ,
& V_5 -> V_11 [ V_7 ] . V_117 ) ;
if ( V_75 ) {
F_19 ( L_40 ,
...
F_149 ( V_5 -> V_11 [ V_7 ] . V_310 ,
V_2 -> V_334 [ V_7 ] ,
sizeof( V_5 -> V_11 [ V_7 ] . V_310 ) ) ;
}
V_5 -> V_9 = V_7 ;
}
V_75 = F_155 ( V_5 , V_2 -> V_336 , V_2 -> V_337 ) ;
if ( V_75 )
goto V_335;
V_2 -> V_173 = F_158 ( F_159 ( V_2 -> V_173 ) ,
V_5 -> V_11 [ 0 ] . V_12 ) ;
F_77 ( & V_5 -> V_305 , & V_61 . V_277 ) ;
V_61 . V_273 ++ ;
return 0 ;
V_335:
F_9 ( V_5 , sizeof( * V_5 ) ) ;
