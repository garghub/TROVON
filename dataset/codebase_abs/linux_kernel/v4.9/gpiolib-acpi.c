...
struct V_20 * F_53 ( struct V_106 * V_105 ,
const char * V_107 ,
unsigned int V_108 ,
enum V_109 V_110 ,
enum V_111 * V_112 )
{
struct V_73 * V_74 = F_54 ( V_105 ) ;
struct V_98 V_96 ;
struct V_20 * V_42 ;
char V_104 [ 32 ] ;
int V_13 ;
for ( V_13 = 0 ; V_13 < F_55 ( V_113 ) ; V_13 ++ ) {
if ( V_107 && strcmp ( V_107 , L_12 ) ) {
...
V_42 = F_49 ( V_74 , V_104 , V_108 , & V_96 ) ;
...
if ( ! F_57 ( V_74 , V_107 ) )
return F_9 ( - V_101 ) ;
V_42 = F_49 ( V_74 , NULL , V_108 , & V_96 ) ;
if ( F_20 ( V_42 ) )
return V_42 ;
...
unsigned int V_117 ;
int V_44 = - V_101 ;
for ( V_13 = 0 , V_108 = 0 ; V_108 <= V_79 ; V_13 ++ ) {
struct V_98 V_96 ;
struct V_20 * V_42 ;
...
if ( V_96 . V_97 && V_108 ++ == V_79 ) {
int V_29 = F_24 ( V_42 ) ;
if ( V_29 < 0 )
return V_29 ;
V_117 = F_61 ( V_96 . V_52 ,
V_96 . V_60 ) ;
if ( V_117 != V_118 &&
V_117 != F_62 ( V_29 ) )
F_63 ( V_29 , V_117 ) ;
...
static T_2
F_64 ( T_5 V_119 , T_6 V_120 ,
T_5 V_121 , T_7 * V_122 , void * V_123 ,
void * V_124 )
{
struct V_36 * V_125 = V_124 ;
struct V_1 * V_22 = V_125 -> V_22 ;
struct V_38 * V_39 ;
struct V_33 * V_34 ;
int V_92 = ( int ) V_120 ;
T_2 V_24 ;
...
int V_127 ;
int V_13 ;
V_24 = F_65 ( V_125 -> V_128 . V_129 ,
V_125 -> V_128 . V_127 , & V_34 ) ;
if ( F_8 ( V_24 ) )
return V_24 ;
...
V_39 = & V_34 -> V_3 . V_47 ;
V_126 = V_39 -> V_130 == V_131 ;
if ( F_37 ( V_39 -> V_132 == V_133 &&
V_119 == V_134 ) ) {
F_66 ( V_34 ) ;
return V_54 ;
}
V_127 = F_67 ( V_39 -> V_93 , ( V_135 ) ( V_92 + V_121 ) ) ;
for ( V_13 = V_92 ; V_13 < V_127 ; ++ V_13 ) {
...
* V_122 |= ( T_7 ) F_72 ( V_42 ) << V_13 ;
}
V_139:
F_66 ( V_34 ) ;
return V_24 ;
}
static void F_73 ( struct V_36 * V_125 )
{
struct V_1 * V_22 = V_125 -> V_22 ;
...
static void F_76 ( struct V_36 * V_125 )
{
struct V_1 * V_22 = V_125 -> V_22 ;
T_1 V_23 = F_2 ( V_22 -> V_4 ) ;
struct V_136 * V_137 , * V_148 ;
T_2 V_24 ;
V_24 = F_77 ( V_23 , V_147 ,
F_64 ) ;
if ( F_8 ( V_24 ) ) {
F_21 ( V_22 -> V_4 ,
L_18 ) ;
...
static unsigned int F_84 ( const union V_149 * V_150 )
{
const union V_149 * V_151 = V_150 -> V_152 . V_153 ;
const union V_149 * V_154 = V_151 + V_150 -> V_152 . V_155 ;
...
static int F_85 ( struct V_33 * V_34 , void * V_3 )
{
unsigned int * V_155 = V_3 ;
if ( V_34 -> type == V_45 )
* V_155 += V_34 -> V_3 . V_47 . V_93 ;
return 1 ;
}
int F_86 ( struct V_106 * V_105 , const char * V_107 )
{
struct V_73 * V_74 = F_54 ( V_105 ) ;
...
snprintf ( V_104 , sizeof( V_104 ) , L_14 ,
V_113 [ V_13 ] ) ;
V_44 = F_87 ( V_74 , V_104 , V_157 ,
& V_150 ) ;
if ( V_44 == 0 ) {
if ( V_150 -> type == V_156 )
V_155 = 1 ;
else if ( V_150 -> type == V_158 )
V_155 = F_84 ( V_150 ) ;
} else if ( V_74 -> V_77 ) {
for ( V_81 = V_74 -> V_77 ; V_81 -> V_78 ; V_81 ++ )
...
bool F_57 ( struct V_73 * V_74 , const char * V_107 )
{
struct V_161 * V_162 , * V_90 = NULL ;
if ( V_74 -> V_3 . V_163 || V_74 -> V_77 )
return false ;
F_68 ( & V_164 ) ;
...
if ( ! V_90 ) {
V_90 = F_88 ( sizeof( * V_90 ) , V_67 ) ;
if ( V_90 ) {
V_90 -> V_74 = V_74 ;
V_90 -> V_107 = F_89 ( V_107 , V_67 ) ;
F_27 ( & V_90 -> V_69 , & V_165 ) ;
}
}
F_69 ( & V_164 ) ;
return V_90 &&
