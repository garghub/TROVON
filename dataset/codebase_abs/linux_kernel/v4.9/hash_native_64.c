...
static void F_41 ( struct V_20 * V_67 , unsigned long V_39 ,
int * V_2 , int * V_3 , int * V_4 , unsigned long * V_1 )
{
unsigned long V_68 , V_69 , V_70 ;
unsigned long V_30 = F_17 ( V_67 -> V_23 ) ;
unsigned long V_31 = F_17 ( V_67 -> V_36 ) ;
unsigned long V_54 , V_71 ;
int V_72 , V_73 , V_12 ;
unsigned int V_74 = ( V_31 >> V_75 ) & ( ( 1 << V_76 ) - 1 ) ;
if ( ! ( V_30 & V_77 ) ) {
V_72 = V_10 ;
V_73 = V_10 ;
} else {
...
* V_1 = V_54 << ( V_84 - V_8 ) | V_71 >> V_8 ;
break;
case V_85 :
V_71 = ( V_68 & 0x1ffff ) << 23 ;
V_54 = V_68 >> 17 ;
if ( V_12 < 23 ) {
V_70 = ( V_54 ^ ( V_54 << 25 ) ^ V_69 ) & V_52 ;
V_71 |= V_70 << V_12 ;
}
* V_1 = V_54 << ( V_86 - V_8 ) | V_71 >> V_8 ;
break;
default:
* V_1 = V_72 = 0 ;
}
...
V_88 = V_52 + 1 ;
V_87 = V_88 * V_34 ;
for ( V_39 = 0 ; V_39 < V_87 ; V_39 ++ , V_21 ++ ) {
V_30 = F_17 ( V_21 -> V_23 ) ;
if ( V_30 & V_35 ) {
F_41 ( V_21 , V_39 , & V_2 , & V_3 , & V_4 , & V_1 ) ;
V_21 -> V_23 = 0 ;
F_1 ( V_1 , V_2 , V_3 , V_4 ) ;
}
}
...
static void F_45 ( unsigned long V_89 , int V_13 )
{
unsigned long V_1 ;
unsigned long V_51 , V_90 , V_62 , V_12 , V_39 ;
struct V_20 * V_21 ;
unsigned long V_30 ;
unsigned long V_43 ;
unsigned long V_42 ;
T_1 V_91 ;
struct V_92 * V_93 = F_46 ( & V_92 ) ;
...
V_1 = V_93 -> V_1 [ V_32 ] ;
V_91 = V_93 -> V_91 [ V_32 ] ;
F_47 (pte, psize, vpn, index, shift) {
V_51 = F_29 ( V_1 , V_12 , V_4 ) ;
V_62 = F_48 ( V_91 , V_90 ) ;
if ( V_62 & V_64 )
V_51 = ~ V_51 ;
...
static int F_50 ( unsigned long V_94 , unsigned long V_95 ,
unsigned long V_96 )
{
