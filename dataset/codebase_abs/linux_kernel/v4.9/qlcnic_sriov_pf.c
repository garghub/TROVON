...
static T_7 F_141 ( struct V_1 * V_2 ,
...
int F_142 ( struct V_105 * V_67 ,
int V_139 , struct V_234 * V_235 )
{
struct V_1 * V_2 = F_134 ( V_67 ) ;
struct V_32 * V_33 = V_2 -> V_34 -> V_33 ;
struct V_44 * V_45 ;
...
memcpy ( & V_235 -> V_129 , V_45 -> V_129 , V_236 ) ;
V_235 -> V_148 = F_141 ( V_2 , V_45 , V_139 ) ;
V_235 -> V_228 = V_45 -> V_228 ;
V_235 -> V_130 = V_45 -> V_130 ;
if ( V_45 -> V_15 == V_54 )
V_235 -> V_225 = 0 ;
else
V_235 -> V_225 = V_45 -> V_15 * 100 ;
if ( V_45 -> V_14 == V_237 )
V_235 -> V_224 = 0 ;
else
V_235 -> V_224 = V_45 -> V_14 * 100 ;
V_235 -> V_139 = V_139 ;
return 0 ;
}
int F_143 ( struct V_105 * V_67 , int V_139 , bool V_238 )
{
struct V_1 * V_2 = F_134 ( V_67 ) ;
struct V_32 * V_33 = V_2 -> V_34 -> V_33 ;
struct V_78 * V_58 ;
