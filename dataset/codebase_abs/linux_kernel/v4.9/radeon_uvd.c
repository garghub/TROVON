...
} while ( V_110 -> V_125 < V_110 -> V_144 -> V_130 );
if ( ! V_120 ) {
F_25 ( L_33 ) ;
return - V_54 ;
}
...
V_134 . V_85 [ 3 ] = V_147 >> 32 ;
V_134 . V_85 [ 4 ] = F_47 ( V_141 , 0 ) ;
V_134 . V_85 [ 5 ] = 0 ;
for ( V_6 = 6 ; V_6 < 16 ; V_6 += 2 ) {
V_134 . V_85 [ V_6 ] = F_47 ( V_143 , 0 ) ;
V_134 . V_85 [ V_6 + 1 ] = 0 ;
}
V_134 . V_130 = 16 ;
V_7 = F_48 ( V_2 , & V_134 , NULL , false ) ;
if ( V_84 )
* V_84 = F_49 ( V_134 . V_84 ) ;
F_50 ( V_2 , & V_134 ) ;
return V_7 ;
}
...
{
T_3 V_149 = F_29 ( V_2 -> V_8 . V_74 ) -
V_150 ;
T_1 * V_97 = V_2 -> V_8 . V_76 + V_149 ;
T_3 V_147 = V_2 -> V_8 . V_75 + V_149 ;
int V_7 , V_6 ;
...
static void V_10 ( struct V_153 * V_154 )
{
struct V_1 * V_2 =
F_54 ( V_154 , struct V_1 , V_8 . V_9 . V_154 ) ;
if ( F_55 ( V_2 , V_81 ) == 0 ) {
if ( ( V_2 -> V_155 . V_156 == V_157 ) && V_2 -> V_155 . V_158 ) {
F_53 ( V_2 , & V_2 -> V_155 . V_159 . V_151 ,
& V_2 -> V_155 . V_159 . V_152 ) ;
F_56 ( V_2 , false ) ;
} else {
F_57 ( V_2 , 0 , 0 ) ;
}
...
{
bool V_161 = false ;
bool V_162 = ! F_60 ( & V_2 -> V_8 . V_9 ) ;
V_162 &= F_58 ( & V_2 -> V_8 . V_9 ,
F_59 ( V_160 ) ) ;
if ( ( V_2 -> V_155 . V_156 == V_157 ) && V_2 -> V_155 . V_158 ) {
unsigned V_152 = 0 , V_151 = 0 ;
F_53 ( V_2 , & V_151 , & V_152 ) ;
if ( ( V_2 -> V_155 . V_159 . V_151 != V_151 ) ||
( V_2 -> V_155 . V_159 . V_152 != V_152 ) ) {
V_2 -> V_155 . V_159 . V_151 = V_151 ;
V_2 -> V_155 . V_159 . V_152 = V_152 ;
}
}
if ( V_162 || V_161 ) {
...
static unsigned F_61 ( unsigned V_163 ,
unsigned V_164 ,
unsigned V_165 ,
unsigned V_166 )
{
unsigned V_167 = V_163 / V_164 ;
if ( V_167 < V_165 )
V_167 = V_165 ;
if ( ( V_163 / V_167 ) > V_164 )
V_167 += 1 ;
if ( V_167 > V_166 && V_167 % 2 )
V_167 += 1 ;
return V_167 ;
}
int F_62 ( struct V_1 * V_2 ,
unsigned V_168 , unsigned V_169 ,
unsigned V_170 , unsigned V_171 ,
unsigned V_172 , unsigned V_173 ,
unsigned V_165 , unsigned V_174 ,
unsigned V_166 ,
unsigned * V_175 ,
unsigned * V_176 ,
unsigned * V_177 )
{
unsigned V_163 , V_178 = V_2 -> clock . V_179 . V_180 ;
unsigned V_181 = ~ 0 ;
V_170 = F_34 ( F_34 ( V_170 , V_168 ) , V_169 ) ;
for ( V_163 = V_170 ; V_163 <= V_171 ; V_163 += 100 ) {
T_3 V_182 = ( T_3 ) V_163 * V_172 ;
unsigned V_183 , V_184 , V_185 ;
F_63 ( V_182 , V_178 ) ;
if ( V_182 > V_173 )
break;
V_182 &= V_173 ;
V_183 = F_61 ( V_163 , V_168 ,
V_165 , V_166 ) ;
if ( V_183 > V_174 )
break;
V_184 = F_61 ( V_163 , V_169 ,
V_165 , V_166 ) ;
if ( V_183 > V_174 )
break;
V_185 = V_168 - ( V_163 / V_183 ) + V_169 - ( V_163 / V_184 ) ;
if ( V_185 < V_181 ) {
* V_175 = V_182 ;
* V_176 = V_183 ;
* V_177 = V_184 ;
...
F_65 ( V_186 , 0 , ~ V_187 ) ;
F_66 ( 10 ) ;
F_65 ( V_186 , V_187 , ~ V_187 ) ;
for ( V_6 = 0 ; V_6 < 100 ; ++ V_6 ) {
T_1 V_188 = V_189 | V_190 ;
if ( ( F_67 ( V_186 ) & V_188 ) == V_188 )
break;
F_66 ( 10 ) ;
}
F_65 ( V_186 , 0 , ~ V_187 ) ;
