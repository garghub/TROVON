...
static bool F_27 ( int V_89 , int V_50 , enum V_90 type ,
enum V_91 * V_92 )
{
if ( V_89 < 0 || V_89 >= sizeof( struct V_12 ) )
return false ;
if ( type != V_93 )
return false ;
if ( V_89 % V_50 != 0 )
...
static bool F_29 ( int V_89 , int V_50 , enum V_90 type ,
enum V_91 * V_92 )
{
if ( V_89 < sizeof( void * ) || V_89 >= V_96 )
return false ;
if ( type != V_93 )
return false ;
if ( V_89 % V_50 != 0 )
...
static bool F_30 ( int V_89 , int V_50 , enum V_90 type ,
enum V_91 * V_92 )
{
if ( V_89 < 0 || V_89 >= sizeof( struct V_97 ) )
return false ;
if ( type != V_93 )
return false ;
if ( V_89 % V_50 != 0 )
return false ;
if ( V_89 == F_31 ( struct V_97 , V_98 ) ) {
if ( V_50 != sizeof( T_2 ) )
return false ;
} else {
if ( V_50 != sizeof( long ) )
...
static T_4 F_32 ( enum V_90 type , int V_99 ,
int V_100 , int V_101 ,
struct V_102 * V_103 ,
struct V_1 * V_2 )
{
struct V_102 * V_104 = V_103 ;
switch ( V_101 ) {
case F_31 ( struct V_97 , V_98 ) :
F_33 ( F_34 ( struct V_24 , V_105 ) != sizeof( T_2 ) ) ;
* V_104 ++ = F_35 ( F_36 ( struct V_106 ,
V_51 ) , V_99 , V_100 ,
F_31 ( struct V_106 , V_51 ) ) ;
* V_104 ++ = F_35 ( V_107 , V_99 , V_99 ,
F_31 ( struct V_24 , V_105 ) ) ;
break;
default:
* V_104 ++ = F_35 ( F_36 ( struct V_106 ,
V_13 ) , V_99 , V_100 ,
F_31 ( struct V_106 , V_13 ) ) ;
* V_104 ++ = F_35 ( F_37 ( long ) , V_99 , V_99 , V_101 ) ;
break;
}
return V_104 - V_103 ;
}
