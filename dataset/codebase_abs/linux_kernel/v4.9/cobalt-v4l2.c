...
static int F_103 ( struct V_18 * V_18 , int V_285 )
{
static const struct V_230 V_286 =
V_287 ;
struct V_8 * V_9 = V_18 -> V_288 + V_285 ;
struct V_289 * V_290 = & V_9 -> V_290 ;
struct V_1 * V_2 = & V_9 -> V_2 ;
int V_32 ;
F_104 ( & V_9 -> V_291 ) ;
F_105 ( & V_9 -> V_55 ) ;
snprintf ( V_290 -> V_257 , sizeof( V_290 -> V_257 ) ,
L_62 , V_18 -> V_292 . V_257 , V_285 ) ;
V_9 -> V_41 = 1920 ;
...
if ( V_9 -> V_294 )
F_106 ( L_63 , V_285 ) ;
V_290 -> V_292 = & V_18 -> V_292 ;
if ( V_9 -> V_294 )
V_290 -> V_295 = & V_296 ;
else
V_290 -> V_295 = V_9 -> V_39 ? & V_297 :
& V_298 ;
V_290 -> V_299 = V_300 ;
V_290 -> V_301 = V_9 -> V_39 ? V_302 : V_303 ;
V_290 -> V_291 = & V_9 -> V_291 ;
if ( V_9 -> V_82 )
V_290 -> V_304 = V_9 -> V_82 -> V_304 ;
V_9 -> V_59 = V_286 ;
F_29 ( V_9 -> V_82 , V_233 , V_234 , & V_9 -> V_59 ) ;
if ( ! V_9 -> V_39 && V_9 -> V_82 )
F_31 ( V_9 ) ;
V_290 -> V_305 = V_9 -> V_294 ? & V_306 :
& V_307 ;
}
F_107 ( & V_9 -> V_56 ) ;
V_2 -> type = V_9 -> V_39 ? V_308 :
V_278 ;
V_2 -> V_309 = V_310 | V_311 | V_312 ;
V_2 -> V_309 |= V_9 -> V_39 ? V_313 : V_314 ;
V_2 -> V_10 = V_9 ;
V_2 -> V_315 = sizeof( struct V_47 ) ;
V_2 -> V_316 = & V_317 ;
V_2 -> V_318 = & V_319 ;
V_2 -> V_320 = V_321 ;
V_2 -> V_322 = 2 ;
...
{
int V_285 , V_32 ;
for ( V_285 = 0 ; V_285 < V_325 ; V_285 ++ ) {
V_32 = F_103 ( V_18 , V_285 ) ;
if ( V_32 )
return V_32 ;
}
return 0 ;
