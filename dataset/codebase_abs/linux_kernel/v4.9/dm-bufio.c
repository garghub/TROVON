...
int V_94 ;
F_56 ( & V_8 -> V_65 ) ;
V_8 -> V_65 . V_95 = V_8 -> V_96 ;
V_8 -> V_65 . V_97 = V_98 ;
V_8 -> V_65 . V_99 . V_100 = V_16 << V_8 -> V_2 -> V_84 ;
V_8 -> V_65 . V_101 = V_8 -> V_2 -> V_82 ;
V_8 -> V_65 . V_68 = F_53 ;
V_8 -> V_65 . V_93 = V_70 ;
...
V_94 = V_8 -> V_2 -> V_45 ;
if ( V_94 >= V_102 )
F_2 ( ( unsigned long ) V_44 & ( V_102 - 1 ) ) ;
else
F_2 ( ( unsigned long ) V_44 & ( V_94 - 1 ) ) ;
do {
if ( ! F_58 ( & V_8 -> V_65 , F_59 ( V_44 ) ,
V_94 < V_102 ? V_94 : V_102 ,
F_60 ( V_44 ) ) ) {
F_2 ( V_8 -> V_2 -> V_45 <= V_102 ) ;
...
T_3 * V_70 )
{
if ( V_69 == V_103 && V_8 -> V_2 -> V_104 )
V_8 -> V_2 -> V_104 ( V_8 ) ;
if ( V_8 -> V_2 -> V_45 <= V_98 * V_102 &&
V_8 -> V_26 != V_52 )
...
struct V_1 * V_2 = V_8 -> V_2 ;
int error = V_65 -> V_66 ;
( void ) F_26 ( & V_2 -> V_106 , 0 , error ) ;
}
F_2 ( ! F_65 ( V_107 , & V_8 -> V_108 ) ) ;
F_66 () ;
F_67 ( V_107 , & V_8 -> V_108 ) ;
F_68 () ;
F_69 ( & V_8 -> V_108 , V_107 ) ;
}
static void F_70 ( struct V_7 * V_8 ,
struct V_109 * V_110 )
{
if ( ! F_65 ( V_111 , & V_8 -> V_108 ) )
return;
F_67 ( V_111 , & V_8 -> V_108 ) ;
F_71 ( & V_8 -> V_108 , V_107 , V_112 ) ;
if ( ! V_110 )
F_62 ( V_8 , V_103 , V_8 -> V_16 , F_63 ) ;
else
F_72 ( & V_8 -> V_110 , V_110 ) ;
}
...
while ( ! F_75 ( V_110 ) ) {
struct V_7 * V_8 =
F_76 ( V_110 -> V_115 , struct V_7 , V_110 ) ;
F_48 ( & V_8 -> V_110 ) ;
F_62 ( V_8 , V_103 , V_8 -> V_16 , F_63 ) ;
F_77 () ;
}
...
if ( ! V_8 -> V_108 )
return;
F_80 ( & V_8 -> V_108 , V_117 , V_112 ) ;
F_70 ( V_8 , NULL ) ;
F_80 ( & V_8 -> V_108 , V_107 , V_112 ) ;
}
...
{
F_84 ( V_118 , V_119 ) ;
F_85 ( & V_2 -> V_120 , & V_118 ) ;
F_86 ( V_119 , V_112 ) ;
F_9 ( V_2 ) ;
F_87 () ;
F_88 ( & V_2 -> V_120 , & V_118 ) ;
F_4 ( V_2 ) ;
}
static struct V_7 * F_89 ( struct V_1 * V_2 , enum V_121 V_122 )
{
struct V_7 * V_8 ;
while ( 1 ) {
if ( V_38 != 1 ) {
...
static struct V_7 * F_90 ( struct V_1 * V_2 , enum V_121 V_122 )
{
struct V_7 * V_8 = F_89 ( V_2 , V_122 ) ;
if ( ! V_8 )
return NULL ;
if ( V_2 -> V_129 )
V_2 -> V_129 ( V_8 ) ;
...
F_2 ( F_65 ( V_117 , & V_8 -> V_108 ) ) ;
if ( ! F_65 ( V_111 , & V_8 -> V_108 ) &&
! F_65 ( V_107 , & V_8 -> V_108 ) ) {
F_49 ( V_8 , V_132 ) ;
continue;
}
if ( V_130 && F_65 ( V_107 , & V_8 -> V_108 ) )
return;
F_70 ( V_8 , V_110 ) ;
F_77 () ;
}
...
if ( V_122 == V_126 )
return NULL ;
if ( V_122 == V_142 && F_64 ( F_65 ( V_117 , & V_8 -> V_108 ) ) )
return NULL ;
V_8 -> V_116 ++ ;
F_49 ( V_8 , F_65 ( V_111 , & V_8 -> V_108 ) ||
F_65 ( V_107 , & V_8 -> V_108 ) ) ;
return V_8 ;
}
...
F_68 () ;
F_69 ( & V_8 -> V_108 , V_117 ) ;
}
static void * F_100 ( struct V_1 * V_2 , T_1 V_16 ,
enum V_121 V_122 , struct V_7 * * V_145 )
{
int V_139 ;
struct V_7 * V_8 ;
F_101 ( V_110 ) ;
F_4 ( V_2 ) ;
V_8 = F_98 ( V_2 , V_16 , V_122 , & V_139 , & V_110 ) ;
#ifdef F_43
if ( V_8 && V_8 -> V_116 == 1 )
F_11 ( V_8 ) ;
#endif
...
if ( ! V_8 -> V_116 ) {
F_92 ( & V_2 -> V_120 ) ;
if ( ( V_8 -> V_143 || V_8 -> V_105 ) &&
! F_65 ( V_117 , & V_8 -> V_108 ) &&
! F_65 ( V_107 , & V_8 -> V_108 ) &&
! F_65 ( V_111 , & V_8 -> V_108 ) ) {
F_47 ( V_8 ) ;
F_91 ( V_8 ) ;
}
}
...
V_152 ++ ;
F_2 ( F_65 ( V_117 , & V_8 -> V_108 ) ) ;
if ( F_65 ( V_107 , & V_8 -> V_108 ) ) {
if ( V_152 < V_2 -> V_58 [ V_138 ] ) {
V_154 = 1 ;
V_8 -> V_116 ++ ;
F_9 ( V_2 ) ;
F_80 ( & V_8 -> V_108 , V_107 ,
V_112 ) ;
F_4 ( V_2 ) ;
V_8 -> V_116 -- ;
} else
...
F_4 ( V_2 ) ;
V_8 = F_13 ( V_2 , V_16 ) ;
if ( V_8 && F_117 ( ! V_8 -> V_116 ) && F_117 ( ! V_8 -> V_108 ) ) {
F_47 ( V_8 ) ;
F_91 ( V_8 ) ;
}
F_9 ( V_2 ) ;
...
V_163 = true ;
F_129 ( L_2 ,
( unsigned long long ) V_8 -> V_16 , V_8 -> V_116 , V_162 ) ;
#ifdef F_43
F_130 ( & V_8 -> V_9 , 1 ) ;
V_8 -> V_116 = 0 ;
#endif
...
struct V_7 * V_8 = F_76 ( V_2 -> V_127 . V_115 ,
struct V_7 , V_60 ) ;
F_48 ( & V_8 -> V_60 ) ;
F_44 ( V_8 ) ;
}
