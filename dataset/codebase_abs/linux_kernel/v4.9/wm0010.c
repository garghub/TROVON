...
static int F_48 ( struct V_4 * V_5 , int V_97 ,
...
static T_4 F_49 ( int V_104 , void * V_21 )
{
struct V_6 * V_7 = V_21 ;
switch ( V_7 -> V_2 ) {
case V_11 :
...
V_7 -> V_19 = & V_37 -> V_19 ;
if ( F_58 ( & V_37 -> V_19 ) )
memcpy ( & V_7 -> V_109 , F_58 ( & V_37 -> V_19 ) ,
sizeof( V_7 -> V_109 ) ) ;
F_25 ( & V_7 -> V_85 ) ;
V_7 -> V_18 [ 0 ] . V_110 = L_55 ;
V_7 -> V_18 [ 1 ] . V_110 = L_56 ;
...
V_108 = V_115 ;
V_108 |= V_116 ;
V_40 = F_64 ( V_104 , NULL , F_49 , V_108 ,
L_63 , V_7 ) ;
if ( V_40 ) {
F_11 ( V_7 -> V_19 , L_64 ,
V_104 , V_40 ) ;
