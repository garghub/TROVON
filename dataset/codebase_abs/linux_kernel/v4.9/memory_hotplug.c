...
return - V_79 ;
if ( V_111 == V_114 )
V_67 = F_115 ( V_45 , V_47 , V_101 ) ;
else if ( V_111 == V_113 )
V_67 = F_115 ( V_45 , V_47 , V_103 ) ;
...
{
unsigned long V_45 , V_148 ;
struct V_52 * V_52 = NULL ;
struct V_23 * V_23 ;
int V_33 ;
for ( V_45 = V_29 , V_148 = F_171 ( V_29 ) ;
V_45 < V_46 ;
V_45 = V_148 + 1 , V_148 += V_38 ) {
if ( ! F_172 ( F_37 ( V_45 ) ) )
continue;
for (; V_45 < V_148 && V_45 < V_46 ;
V_45 += V_149 ) {
V_33 = 0 ;
while ( ( V_33 < V_149 ) &&
! F_173 ( V_45 + V_33 ) )
...
static struct V_23 * F_180 ( struct V_23 * V_23 , unsigned long V_150 ,
int * * V_151 )
{
T_8 V_152 = V_153 | V_154 ;
int V_58 = F_181 ( V_23 ) ;
T_9 V_155 = V_156 [ V_102 ] ;
struct V_23 * V_157 = NULL ;
if ( F_176 ( V_23 ) )
...
int V_63 = 0 ;
F_193 ( V_162 ) ;
for ( V_45 = V_29 ; V_45 < V_46 && V_159 > 0 ; V_45 ++ ) {
if ( ! F_43 ( V_45 ) )
continue;
V_23 = F_58 ( V_45 ) ;
if ( F_176 ( V_23 ) ) {
struct V_23 * V_163 = F_184 ( V_23 ) ;
V_45 = F_166 ( V_163 ) + ( 1 << F_179 ( V_163 ) ) - 1 ;
if ( F_179 ( V_163 ) > V_164 ) {
V_63 = - V_165 ;
break;
}
if ( F_194 ( V_23 , & V_162 ) )
...
long V_170 = 0 ;
int V_63 ;
V_63 = F_120 ( V_29 , V_46 - V_29 , & V_170 ,
F_211 ) ;
if ( V_63 < 0 )
V_170 = ( long ) V_63 ;
return V_170 ;
...
enum V_56 V_171 ;
for ( V_171 = 0 ; V_171 <= V_101 ; V_171 ++ )
V_118 += V_44 -> V_71 [ V_171 ] . V_118 ;
if ( V_118 > V_47 )
return true ;
V_118 = 0 ;
for (; V_171 <= V_103 ; V_171 ++ )
V_118 += V_44 -> V_71 [ V_171 ] . V_118 ;
return V_118 == 0 ;
}
...
struct V_43 * V_44 = V_52 -> V_59 ;
unsigned long V_118 = 0 ;
enum V_56 V_171 , V_100 = V_101 ;
if ( V_102 == V_98 )
V_100 = V_103 ;
for ( V_171 = 0 ; V_171 <= V_100 ; V_171 ++ )
V_118 += V_44 -> V_71 [ V_171 ] . V_118 ;
...
static void F_219 ( int V_48 , struct V_99 * V_96 )
{
if ( V_96 -> V_104 >= 0 )
F_220 ( V_48 , V_98 ) ;
if ( ( V_102 != V_98 ) &&
...
unsigned long V_46 , unsigned long V_173 )
{
unsigned long V_45 , V_47 , V_174 ;
long V_175 ;
int V_63 , V_176 , V_177 , V_48 ;
unsigned long V_17 ;
struct V_52 * V_52 ;
struct V_99 V_96 ;
if ( ! F_222 ( V_29 , V_144 ) )
...
return - V_79 ;
V_63 = F_223 ( V_29 , V_46 ,
V_178 , true ) ;
if ( V_63 )
return V_63 ;
V_96 . V_29 = V_29 ;
V_96 . V_47 = V_47 ;
F_218 ( V_47 , V_52 , & V_96 ) ;
V_63 = V_99 ( V_179 , & V_96 ) ;
V_63 = F_117 ( V_63 ) ;
if ( V_63 )
goto V_180;
V_45 = V_29 ;
...
F_228 () ;
F_227 ( V_52 ) ;
V_63 = F_229 ( V_29 , V_46 ) ;
if ( V_63 )
goto V_180;
V_175 = F_213 ( V_29 , V_46 ) ;
if ( V_175 < 0 ) {
V_63 = - V_165 ;
goto V_180;
}
F_230 ( L_13 , V_175 ) ;
F_210 ( V_29 , V_46 ) ;
F_231 ( V_29 , V_46 , V_178 ) ;
F_104 ( F_58 ( V_29 ) , - V_175 ) ;
V_52 -> V_118 -= V_175 ;
F_63 ( V_52 -> V_59 , & V_17 ) ;
V_52 -> V_59 -> V_119 -= V_175 ;
F_64 ( V_52 -> V_59 , & V_17 ) ;
F_123 () ;
if ( ! F_118 ( V_52 ) ) {
F_121 ( V_52 ) ;
...
{
return F_221 ( V_29 , V_29 + V_47 , 120 * V_186 ) ;
}
int F_156 ( unsigned long V_29 , unsigned long V_46 ,
void * V_96 , int (* F_235)( struct V_137 * , void * ) )
{
...
( V_32 <= V_138 -> V_189 ) )
continue;
V_138 = F_236 ( V_187 , V_138 ) ;
if ( ! V_138 )
continue;
V_63 = F_235 ( V_138 , V_96 ) ;
if ( V_63 ) {
F_237 ( & V_138 -> V_190 . V_191 ) ;
return V_63 ;
}
}
if ( V_138 )
...
static int F_238 ( struct V_137 * V_138 , void * V_96 )
{
int V_63 = ! F_239 ( V_138 ) ;
if ( F_9 ( V_63 ) ) {
T_10 V_192 , V_193 ;
V_192 = F_240 ( F_81 ( V_138 -> V_188 ) ) ;
V_193 = F_240 ( F_81 ( V_138 -> V_189 + 1 ) ) - 1 ;
F_99 ( L_15 ,
& V_192 , & V_193 ) ;
}
return V_63 ;
...
void T_4 F_252 ( int V_58 , T_2 V_10 , T_2 V_11 )
{
int V_63 ;
