...
unsigned int V_119 = V_72 -> V_97 >> 3 ;
...
static T_2 F_70 ( int V_137 , void * V_138 )
{
...
static int F_73 ( struct V_145 * V_22 , struct V_145 * V_146 , void * V_147 )
{
struct V_3 * V_4 = F_74 ( V_22 ) ;
...
static void F_82 ( struct V_145 * V_22 , struct V_145 * V_146 ,
void * V_147 )
{
struct V_3 * V_4 = F_74 ( V_22 ) ;
F_68 ( V_4 -> V_2 ) ;
...
if ( ! V_22 -> V_165 )
return - V_166 ;
V_4 = F_85 ( V_22 , sizeof( * V_4 ) , V_167 ) ;
if ( ! V_4 )
return - V_168 ;
V_4 -> V_22 = V_22 ;
V_4 -> V_5 = true ;
V_162 = F_86 ( V_22 -> V_165 , L_9 ) ;
if ( V_162 )
V_4 -> V_34 = true ;
F_87 ( V_162 ) ;
V_4 -> V_13 = F_88 ( V_22 -> V_165 , 0 ) ;
if ( ! V_4 -> V_13 )
return - V_168 ;
V_4 -> V_169 = F_89 ( V_22 , L_10 ) ;
if ( F_79 ( V_4 -> V_169 ) ) {
F_90 ( V_22 , L_11 ) ;
V_20 = F_80 ( V_4 -> V_169 ) ;
goto V_170;
}
V_4 -> V_171 = F_89 ( V_22 , L_12 ) ;
if ( F_79 ( V_4 -> V_171 ) ) {
F_90 ( V_22 , L_13 ) ;
V_20 = F_80 ( V_4 -> V_171 ) ;
goto V_170;
}
V_4 -> V_172 = F_89 ( V_22 , L_14 ) ;
if ( F_79 ( V_4 -> V_172 ) ) {
F_90 ( V_22 , L_15 ) ;
V_20 = F_80 ( V_4 -> V_172 ) ;
goto V_170;
}
V_4 -> V_30 = F_89 ( V_22 , L_16 ) ;
if ( F_79 ( V_4 -> V_30 ) ) {
F_90 ( V_22 , L_17 ) ;
V_20 = F_80 ( V_4 -> V_30 ) ;
goto V_170;
}
V_164 = F_91 ( V_160 , V_173 ,
V_4 -> V_34 ? L_18 : L_19 ) ;
if ( ! V_164 ) {
F_90 ( V_22 , L_20 ) ;
V_20 = - V_174 ;
...
V_20 = F_92 ( V_22 , V_164 -> V_175 , F_70 ,
0 , L_21 , V_4 ) ;
if ( V_20 ) {
F_90 ( V_22 , L_20 ) ;
goto V_170;
...
{
struct V_3 * V_4 = F_74 ( & V_160 -> V_22 ) ;
F_98 ( & V_160 -> V_22 ) ;
F_99 ( V_4 -> V_13 ) ;
F_101 ( & V_160 -> V_22 , & V_176 ) ;
return 0 ;
}
static int F_102 ( struct V_145 * V_22 )
{
struct V_3 * V_4 = F_74 ( V_22 ) ;
F_103 ( V_4 -> V_30 ) ;
F_103 ( V_4 -> V_172 ) ;
...
static int F_104 ( struct V_145 * V_22 )
{
struct V_3 * V_4 = F_74 ( V_22 ) ;
int V_20 ;
V_20 = F_105 ( V_4 -> V_169 ) ;
if ( V_20 < 0 ) {
F_75 ( L_22 , V_20 ) ;
return V_20 ;
}
V_20 = F_105 ( V_4 -> V_171 ) ;
if ( V_20 < 0 ) {
F_75 ( L_23 , V_20 ) ;
return V_20 ;
}
V_20 = F_105 ( V_4 -> V_172 ) ;
if ( V_20 < 0 ) {
F_75 ( L_24 , V_20 ) ;
return V_20 ;
}
