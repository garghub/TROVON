...
static int T_2 F_34 ( struct V_39 * V_40 ,
unsigned int V_15 ,
struct V_1 * V_2 )
{
struct V_41 V_42 ;
...
return - V_35 ;
V_12 = V_2 -> V_16 [ V_15 ] = F_37 ( sizeof( * V_12 ) + V_4 * sizeof( V_5 ) ,
V_46 ) ;
if ( ! V_12 )
return - V_47 ;
V_12 -> V_22 = F_38 ( V_42 . V_48 , V_43 ) ;
if ( ! V_12 -> V_22 )
return - V_47 ;
...
static int F_42 ( struct V_50 * V_7 , unsigned int V_51 ,
T_1 V_52 )
{
F_43 ( V_51 ,
& V_53 , V_54 ) ;
...
static int T_2 F_45 ( struct V_39 * V_40 ,
struct V_39 * V_56 )
{
struct V_1 * V_2 ;
unsigned int V_15 ;
int V_57 ;
V_2 = F_37 ( sizeof( * V_2 ) , V_46 ) ;
if ( ! V_2 )
return - V_47 ;
F_46 (idx) {
V_57 = F_34 ( V_40 , V_15 , V_2 ) ;
if ( V_57 )
F_40 ( L_2 ,
V_15 , V_57 ) ;
else
...
F_49 ( & V_2 -> V_28 ) ;
V_2 -> V_23 = F_50 ( V_40 , V_18 * V_2 -> V_4 ,
& V_60 ,
V_2 ) ;
if ( ! V_2 -> V_23 ) {
V_57 = - V_47 ;
