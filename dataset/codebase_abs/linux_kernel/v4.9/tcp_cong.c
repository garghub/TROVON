...
{
int V_7 = 0 ;
if ( ! V_4 -> V_8 || ! ( V_4 -> V_9 || V_4 -> V_10 ) ) {
F_11 ( L_2 , V_4 -> V_2 ) ;
return - V_11 ;
}
V_4 -> V_6 = F_12 ( V_4 -> V_2 , sizeof( V_4 -> V_2 ) , strlen ( V_4 -> V_2 ) ) ;
F_13 ( & V_12 ) ;
if ( V_4 -> V_6 == V_13 || F_9 ( V_4 -> V_6 ) ) {
F_14 ( L_3 ,
V_4 -> V_2 ) ;
V_7 = - V_14 ;
} else {
...
T_1 F_21 ( const char * V_2 , bool * V_17 )
{
...
{
struct V_24 * V_25 = F_25 ( V_23 ) ;
struct V_1 * V_4 ;
F_8 () ;
F_2 (ca, &tcp_cong_list, list) {
if ( F_26 ( F_27 ( V_4 -> V_26 ) ) ) {
V_25 -> V_27 = V_4 ;
goto V_28;
}
}
...
F_6 () ;
if ( V_4 -> V_29 )
memset ( V_25 -> V_30 , 0 , sizeof( V_25 -> V_30 ) ) ;
if ( V_4 -> V_18 & V_19 )
F_28 ( V_23 ) ;
else
F_29 ( V_23 ) ;
...
{
const struct V_24 * V_25 = F_25 ( V_23 ) ;
if ( V_25 -> V_27 -> V_31 )
V_25 -> V_27 -> V_31 ( V_23 ) ;
if ( F_31 ( V_23 ) )
F_28 ( V_23 ) ;
...
F_40 ( F_41 ( & V_16 ) ) ;
F_8 () ;
V_4 = F_42 ( V_16 . V_42 , struct V_1 , V_15 ) ;
strncpy ( V_2 , V_4 -> V_2 , V_21 ) ;
F_6 () ;
}
...
int F_49 ( struct V_22 * V_23 , const char * V_2 )
{
struct V_24 * V_25 = F_25 ( V_23 ) ;
const struct V_1 * V_4 ;
int V_48 = 0 ;
...
if ( ! V_4 )
V_48 = - V_36 ;
else if ( ! ( ( V_4 -> V_18 & V_37 ) ||
F_50 ( F_51 ( V_23 ) -> V_51 , V_5 ) ) )
V_48 = - V_50 ;
else if ( ! F_27 ( V_4 -> V_26 ) )
V_48 = - V_52 ;
else
F_32 ( V_23 , V_4 ) ;
V_28:
...
void F_55 ( struct V_22 * V_23 , T_1 V_63 , T_1 V_55 )
{
struct V_53 * V_54 = F_56 ( V_23 ) ;
if ( ! F_57 ( V_23 ) )
return;
if ( F_58 ( V_54 ) ) {
V_55 = F_52 ( V_54 , V_55 ) ;
...
T_1 F_59 ( struct V_22 * V_23 )
{
const struct V_53 * V_54 = F_56 ( V_23 ) ;
