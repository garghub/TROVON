...
void F_57 ( struct V_1 * V_30 , T_1 V_90 ,
T_1 V_91 )
{
int V_92 ;
T_1 V_93 ;
struct V_64 * V_65 = V_30 -> V_10 -> V_66 ;
V_90 = F_73 ( T_1 , V_90 , F_19 ( V_30 ) ) ;
V_91 = F_69 ( T_1 , V_91 , F_20 ( V_30 ) ) ;
F_2 ( & V_30 -> V_3 -> V_4 ) ;
for ( V_93 = V_90 ; V_93 < V_91 ; V_93 += ( T_1 ) V_30 -> V_94 ) {
V_92 = ( V_93 - F_19 ( V_30 ) ) / V_28 ;
if ( V_30 -> V_3 -> V_43 [ V_92 ] ) {
struct V_61 * V_61 = V_30 -> V_3 -> V_43 [ V_92 ] ;
T_2 V_95 = V_30 -> V_3 -> V_45 [ V_92 ] ;
T_2 V_67 = V_95 & V_96 ;
F_74 ( ! V_67 ) ;
F_75 ( V_65 , V_67 , V_28 ,
V_72 ) ;
if ( V_95 & V_85 ) {
struct V_61 * V_97 = F_76 ( V_61 ) ;
F_77 ( V_97 ) ;
}
if ( ! V_30 -> V_10 -> V_21 )
F_66 ( V_61 ) ;
V_30 -> V_3 -> V_43 [ V_92 ] = NULL ;
V_30 -> V_3 -> V_45 [ V_92 ] = 0 ;
}
}
F_4 ( & V_30 -> V_3 -> V_4 ) ;
}
