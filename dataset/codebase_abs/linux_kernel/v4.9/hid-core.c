...
V_62 -> V_130 == V_131 )
V_62 -> V_130 = V_145 ;
if ( ( V_27 -> V_49 . V_85 << 16 ) == V_146 )
for ( V_48 = 0 ; V_48 < V_27 -> V_30 . V_42 ; V_48 ++ )
if ( V_27 -> V_30 . V_23 [ V_48 ] == V_147 )
V_27 -> V_132 |= V_148 ;
if ( ( V_27 -> V_49 . V_85 << 16 ) >= V_149 )
V_27 -> V_132 |= V_150 ;
}
...
if ( V_4 == 0 ) {
V_7 = F_39 (
V_62 -> V_6 [ type ] . V_14 . V_155 ,
struct V_1 , V_13 ) ;
} else {
V_7 = V_62 -> V_6 [ type ] . V_9 [ V_4 ] ;
}
if ( ! V_7 ) {
F_5 ( V_62 , L_25 , V_156 [ type ] , V_4 ) ;
return NULL ;
}
if ( V_7 -> V_19 <= V_153 ) {
F_5 ( V_62 , L_26 ,
...
if ( V_7 -> V_18 [ V_153 ] -> V_55 < V_154 ) {
F_5 ( V_62 , L_27 ,
V_156 [ type ] , V_4 , V_153 ) ;
return NULL ;
}
return V_7 ;
}
...
{
switch ( V_41 ) {
case 8 : return ( ( V_158 ) V_24 ) ;
case 16 : return ( ( V_159 ) V_24 ) ;
...
{
unsigned int V_161 = V_47 / 8 ;
unsigned int V_162 = 0 ;
unsigned int V_163 = V_47 % 8 ;
int V_164 = 8 - V_163 ;
T_1 V_24 = 0 ;
T_1 V_165 = V_41 < 32 ? ( 1U << V_41 ) - 1 : ~ 0U ;
while ( V_41 > 0 ) {
V_24 |= ( ( T_1 ) V_7 [ V_161 ] >> V_163 ) << V_162 ;
V_41 -= V_164 ;
V_162 += V_164 ;
V_164 = 8 ;
V_163 = 0 ;
...
int V_168 = 8 - V_163 ;
while ( V_41 - V_168 >= 0 ) {
V_7 [ V_161 ] &= ~ ( 0xff << V_163 ) ;
V_7 [ V_161 ] |= V_24 << V_163 ;
V_24 >>= V_168 ;
V_41 -= V_168 ;
V_168 = 8 ;
V_163 = 0 ;
...
if ( V_41 ) {
V_72 V_169 = ( ( 1U << V_41 ) - 1 ) ;
V_7 [ V_161 ] &= ~ ( V_169 << V_163 ) ;
V_7 [ V_161 ] |= V_24 << V_163 ;
}
}
...
static int F_49 ( T_2 * V_172 , T_2 V_24 , unsigned V_41 )
{
while ( V_41 -- ) {
if ( * V_172 ++ == V_24 )
return 0 ;
...
{
const struct V_173 * V_4 = V_62 -> V_174 -> V_175 ;
if ( ! V_4 )
return 1 ;
for (; V_4 -> V_45 != V_176 ; V_4 ++ )
if ( V_4 -> V_45 == V_177 ||
V_4 -> V_45 == V_7 -> type )
return 1 ;
return 0 ;
...
{
const struct V_178 * V_4 = V_62 -> V_174 -> V_179 ;
if ( ! V_4 )
return 1 ;
for (; V_4 -> V_180 != V_177 - 1 ; V_4 ++ )
if ( ( V_4 -> V_181 == V_177 ||
V_4 -> V_181 == V_23 -> V_62 ) &&
( V_4 -> V_180 == V_177 ||
V_4 -> V_180 == V_23 -> type ) &&
( V_4 -> V_182 == V_177 ||
V_4 -> V_182 == V_23 -> V_183 ) )
return 1 ;
return 0 ;
}
static void F_52 ( struct V_2 * V_62 , struct V_15 * V_18 ,
struct V_21 * V_23 , T_2 V_24 , int V_184 )
{
struct V_185 * V_186 = V_62 -> V_174 ;
int V_104 ;
if ( ! F_53 ( & V_62 -> V_187 ) )
F_54 ( V_62 , V_23 , V_24 ) ;
if ( V_186 && V_186 -> V_188 && F_51 ( V_62 , V_23 ) ) {
V_104 = V_186 -> V_188 ( V_62 , V_18 , V_23 , V_24 ) ;
if ( V_104 != 0 ) {
if ( V_104 < 0 )
F_5 ( V_62 , L_31 ,
V_186 -> V_189 , V_104 ) ;
...
if ( V_62 -> V_190 & V_192 && V_184 && V_62 -> V_193 )
V_62 -> V_193 ( V_62 , V_18 , V_23 , V_24 ) ;
}
...
T_2 V_195 = V_18 -> V_52 ;
T_2 * V_24 ;
V_24 = F_7 ( sizeof( T_2 ) * V_95 , V_196 ) ;
if ( ! V_24 )
return;
...
if ( ! ( V_18 -> V_46 & V_197 ) &&
V_24 [ V_41 ] >= V_194 && V_24 [ V_41 ] <= V_195 &&
V_24 [ V_41 ] - V_194 < V_18 -> V_63 &&
V_18 -> V_23 [ V_24 [ V_41 ] - V_194 ] . V_62 == V_198 + 1 )
goto exit;
}
for ( V_41 = 0 ; V_41 < V_95 ; V_41 ++ ) {
if ( V_197 & V_18 -> V_46 ) {
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_41 ] , V_24 [ V_41 ] , V_184 ) ;
continue;
}
if ( V_18 -> V_24 [ V_41 ] >= V_194 && V_18 -> V_24 [ V_41 ] <= V_195
&& V_18 -> V_24 [ V_41 ] - V_194 < V_18 -> V_63
&& V_18 -> V_23 [ V_18 -> V_24 [ V_41 ] - V_194 ] . V_62
&& F_49 ( V_24 , V_18 -> V_24 [ V_41 ] , V_95 ) )
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_18 -> V_24 [ V_41 ] - V_194 ] , 0 , V_184 ) ;
if ( V_24 [ V_41 ] >= V_194 && V_24 [ V_41 ] <= V_195
&& V_24 [ V_41 ] - V_194 < V_18 -> V_63
&& V_18 -> V_23 [ V_24 [ V_41 ] - V_194 ] . V_62
&& F_49 ( V_18 -> V_24 , V_24 [ V_41 ] , V_95 ) )
F_52 ( V_62 , V_18 , & V_18 -> V_23 [ V_24 [ V_41 ] - V_194 ] , 1 , V_184 ) ;
}
...
{
int V_199 = F_60 ( V_7 ) + 7 ;
return F_7 ( V_199 , V_46 ) ;
}
...
if ( V_200 == V_201 )
F_58 ( V_7 , V_157 ) ;
V_104 = V_62 -> V_202 -> V_203 ( V_62 , V_7 -> V_4 , V_157 , V_199 ,
V_7 -> type , V_200 ) ;
if ( V_104 < 0 ) {
F_13 ( L_35 , V_104 ) ;
goto V_204;
...
if ( V_200 == V_205 )
F_64 ( V_62 , V_7 -> type , V_157 , V_104 , 0 ) ;
V_204:
F_8 ( V_157 ) ;
}
...
F_13 ( L_36 , V_7 -> V_4 ,
V_206 , V_115 ) ;
memset ( V_207 + V_206 , 0 , V_115 - V_206 ) ;
}
if ( ( V_62 -> V_190 & V_192 ) && V_62 -> V_209 )
V_62 -> V_209 ( V_62 , V_7 ) ;
if ( V_62 -> V_190 & V_210 ) {
...
if ( V_62 -> V_190 != V_210 && V_7 -> V_19 ) {
for ( V_160 = 0 ; V_160 < V_7 -> V_19 ; V_160 ++ )
F_56 ( V_62 , V_7 -> V_18 [ V_160 ] , V_207 , V_184 ) ;
V_186 = V_62 -> V_174 ;
if ( V_186 && V_186 -> V_7 )
V_186 -> V_7 ( V_62 , V_7 ) ;
}
...
int F_64 ( struct V_2 * V_62 , int type , V_72 * V_71 , int V_12 , int V_184 )
{
struct V_5 * V_6 ;
struct V_185 * V_186 ;
struct V_1 * V_7 ;
...
if ( V_186 && V_186 -> V_215 && F_50 ( V_62 , V_7 ) ) {
V_104 = V_186 -> V_215 ( V_62 , V_7 , V_71 , V_12 ) ;
if ( V_104 < 0 )
goto V_214;
}
V_104 = F_65 ( V_62 , type , V_71 , V_12 , V_184 ) ;
V_214:
F_70 ( & V_62 -> V_212 ) ;
return V_104 ;
}
static bool F_71 ( struct V_2 * V_216 ,
const struct V_217 * V_4 )
{
return ( V_4 -> V_218 == V_219 || V_4 -> V_218 == V_216 -> V_218 ) &&
( V_4 -> V_130 == V_220 || V_4 -> V_130 == V_216 -> V_130 ) &&
( V_4 -> V_136 == V_177 || V_4 -> V_136 == V_216 -> V_136 ) &&
( V_4 -> V_138 == V_177 || V_4 -> V_138 == V_216 -> V_138 ) ;
}
const struct V_217 * F_72 ( struct V_2 * V_216 ,
const struct V_217 * V_4 )
{
for (; V_4 -> V_218 ; V_4 ++ )
if ( F_71 ( V_216 , V_4 ) )
...
static bool F_73 ( struct V_2 * V_216 )
{
return ! ! F_72 ( V_216 , V_221 ) ;
}
static T_5
F_74 ( struct V_222 * V_223 , struct V_224 * V_225 ,
struct V_226 * V_227 ,
char * V_157 , T_6 V_228 , T_7 V_95 )
{
struct V_3 * V_103 = F_75 ( V_225 ) ;
struct V_2 * V_216 = F_28 ( V_103 ) ;
if ( V_228 >= V_216 -> V_115 )
return 0 ;
if ( V_228 + V_95 > V_216 -> V_115 )
V_95 = V_216 -> V_115 - V_228 ;
memcpy ( V_157 , V_216 -> V_114 + V_228 , V_95 ) ;
return V_95 ;
}
static T_5
F_76 ( struct V_3 * V_103 , struct V_229 * V_227 ,
char * V_157 )
{
struct V_2 * V_216 = F_28 ( V_103 ) ;
return sprintf ( V_157 , L_38 , V_216 -> V_230 & 0xff ) ;
}
int F_77 ( struct V_2 * V_216 , unsigned int V_231 )
{
static const char * V_232 [] = { L_39 , L_40 , L_41 , L_39 ,
L_42 , L_43 , L_44 , L_45 ,
L_46
} ;
const char * type , * V_218 ;
char V_157 [ 64 ] = L_47 ;
unsigned int V_48 ;
int V_199 ;
int V_104 ;
...
V_231 |= ( V_235 | V_236 ) ;
if ( V_216 -> V_233 & V_237 )
V_231 |= V_238 ;
if ( V_216 -> V_218 != V_239 )
V_231 &= ~ V_236 ;
if ( F_73 ( V_216 ) )
V_231 |= V_235 ;
if ( ( V_231 & V_240 ) && ! F_78 ( V_216 ,
V_231 & V_238 ) )
V_216 -> V_190 |= V_191 ;
if ( ( V_231 & V_236 ) && V_216 -> V_241 &&
! V_216 -> V_241 ( V_216 ,
V_231 & V_235 ) )
V_216 -> V_190 |= V_192 ;
if ( ( V_231 & V_242 ) && ! F_79 ( V_216 ) )
V_216 -> V_190 |= V_210 ;
if ( V_231 & V_243 )
V_216 -> V_190 |= V_244 ;
if ( ! V_216 -> V_190 && ! V_216 -> V_174 -> V_215 ) {
F_5 ( V_216 , L_48 ) ;
return - V_211 ;
}
if ( ( V_216 -> V_190 & V_191 ) &&
( V_231 & V_245 ) && V_216 -> V_246 )
V_216 -> V_246 ( V_216 ) ;
V_199 = 0 ;
if ( V_216 -> V_190 & V_191 )
V_199 += sprintf ( V_157 + V_199 , L_49 ) ;
if ( V_216 -> V_190 & V_192 )
V_199 += sprintf ( V_157 + V_199 , L_50 , V_199 ? L_51 : L_47 ,
V_216 -> V_247 ) ;
if ( V_216 -> V_190 & V_210 )
V_199 += sprintf ( V_157 + V_199 , L_52 , V_199 ? L_51 : L_47 ,
( (struct V_248 * ) V_216 -> V_248 ) -> V_247 ) ;
type = L_39 ;
for ( V_48 = 0 ; V_48 < V_216 -> V_34 ; V_48 ++ ) {
struct V_28 * V_249 = & V_216 -> V_29 [ V_48 ] ;
if ( V_249 -> type == V_39 &&
( V_249 -> V_23 & V_250 ) == V_146 &&
( V_249 -> V_23 & 0xffff ) < F_80 ( V_232 ) ) {
type = V_232 [ V_249 -> V_23 & 0xffff ] ;
break;
}
}
switch ( V_216 -> V_218 ) {
...
V_104 = F_81 ( & V_216 -> V_103 , & V_253 ) ;
if ( V_104 )
F_21 ( V_216 ,
L_57 , V_104 ) ;
F_82 ( V_216 , L_58 ,
V_157 , V_218 , V_216 -> V_254 >> 8 , V_216 -> V_254 & 0xff ,
type , V_216 -> V_189 , V_216 -> V_255 ) ;
return 0 ;
}
void F_83 ( struct V_2 * V_216 )
{
F_84 ( & V_216 -> V_103 , & V_253 ) ;
if ( V_216 -> V_190 & V_191 )
F_85 ( V_216 ) ;
if ( V_216 -> V_190 & V_192 )
V_216 -> V_256 ( V_216 ) ;
...
static T_5 F_87 ( struct V_257 * V_258 , const char * V_157 ,
T_7 V_95 )
{
struct V_185 * V_186 = F_88 ( V_258 ) ;
struct V_259 * V_260 ;
V_53 V_218 , V_136 , V_138 ;
unsigned long V_261 = 0 ;
int V_104 ;
V_104 = sscanf ( V_157 , L_59 ,
& V_218 , & V_136 , & V_138 , & V_261 ) ;
if ( V_104 < 3 )
return - V_33 ;
V_260 = F_2 ( sizeof( * V_260 ) , V_10 ) ;
if ( ! V_260 )
return - V_36 ;
V_260 -> V_4 . V_218 = V_218 ;
V_260 -> V_4 . V_130 = V_220 ;
V_260 -> V_4 . V_136 = V_136 ;
V_260 -> V_4 . V_138 = V_138 ;
V_260 -> V_4 . V_261 = V_261 ;
F_89 ( & V_186 -> V_262 ) ;
F_3 ( & V_260 -> V_13 , & V_186 -> V_263 ) ;
F_90 ( & V_186 -> V_262 ) ;
V_104 = F_91 ( & V_186 -> V_174 ) ;
return V_104 ? : V_95 ;
}
static void F_92 ( struct V_185 * V_186 )
{
struct V_259 * V_260 , * V_41 ;
F_89 ( & V_186 -> V_262 ) ;
...
static const struct V_217 * F_95 ( struct V_2 * V_216 ,
struct V_185 * V_186 )
{
struct V_259 * V_260 ;
F_89 ( & V_186 -> V_262 ) ;
F_96 (dynid, &hdrv->dyn_list, list) {
if ( F_71 ( V_216 , & V_260 -> V_4 ) ) {
F_90 ( & V_186 -> V_262 ) ;
return & V_260 -> V_4 ;
}
}
F_90 ( & V_186 -> V_262 ) ;
return F_72 ( V_216 , V_186 -> V_264 ) ;
}
static int F_97 ( struct V_3 * V_103 , struct V_257 * V_258 )
{
struct V_185 * V_186 = F_88 ( V_258 ) ;
struct V_2 * V_216 = F_28 ( V_103 ) ;
return F_95 ( V_216 , V_186 ) != NULL ;
}
static int F_98 ( struct V_3 * V_103 )
{
struct V_185 * V_186 = F_88 ( V_103 -> V_174 ) ;
struct V_2 * V_216 = F_28 ( V_103 ) ;
const struct V_217 * V_4 ;
int V_104 = 0 ;
if ( F_99 ( & V_216 -> V_265 ) )
...
V_216 -> V_174 = V_186 ;
if ( V_186 -> V_269 ) {
V_104 = V_186 -> V_269 ( V_216 , V_4 ) ;
} else {
V_104 = F_40 ( V_216 ) ;
if ( ! V_104 )
V_104 = F_100 ( V_216 , V_270 ) ;
}
if ( V_104 ) {
F_25 ( V_216 ) ;
V_216 -> V_174 = NULL ;
...
static T_5 F_103 ( struct V_3 * V_103 , struct V_229 * V_160 ,
char * V_157 )
{
struct V_2 * V_216 = F_104 ( V_103 , struct V_2 , V_103 ) ;
return F_105 ( V_157 , V_271 , L_60 ,
V_216 -> V_218 , V_216 -> V_130 , V_216 -> V_136 , V_216 -> V_138 ) ;
}
static int F_106 ( struct V_3 * V_103 , struct V_272 * V_273 )
{
struct V_2 * V_216 = F_28 ( V_103 ) ;
if ( F_107 ( V_273 , L_61 ,
V_216 -> V_218 , V_216 -> V_136 , V_216 -> V_138 ) )
return - V_36 ;
if ( F_107 ( V_273 , L_62 , V_216 -> V_189 ) )
return - V_36 ;
if ( F_107 ( V_273 , L_63 , V_216 -> V_255 ) )
return - V_36 ;
if ( F_107 ( V_273 , L_64 , V_216 -> V_274 ) )
return - V_36 ;
if ( F_107 ( V_273 , L_65 ,
V_216 -> V_218 , V_216 -> V_130 , V_216 -> V_136 , V_216 -> V_138 ) )
return - V_36 ;
...
bool F_108 ( struct V_2 * V_216 )
{
if ( V_216 -> V_233 & V_275 )
return false ;
if ( V_216 -> V_233 & V_276 )
return true ;
switch ( V_216 -> V_136 ) {
case V_277 :
if ( V_216 -> V_138 >= V_278 &&
V_216 -> V_138 <= V_279 )
return true ;
break;
case V_280 :
if ( V_216 -> V_138 >= V_281 &&
V_216 -> V_138 <= V_282 )
return true ;
if ( V_216 -> V_138 == V_283 &&
! strcmp ( V_216 -> V_189 , L_66 ) )
return true ;
break;
case V_284 :
if ( V_216 -> V_138 >= V_285 &&
V_216 -> V_138 <= V_286 )
return true ;
break;
case V_287 :
if ( V_216 -> V_138 >= V_288 &&
V_216 -> V_138 <= V_289 )
return true ;
break;
case V_290 :
if ( V_216 -> V_138 == V_291 &&
V_216 -> type == V_292 )
return true ;
break;
case V_293 :
if ( ( V_216 -> V_138 >= V_294 &&
V_216 -> V_138 <= V_295 ) ||
( V_216 -> V_138 >= V_296 &&
V_216 -> V_138 <= V_297 ) )
return true ;
break;
case V_298 :
if ( V_216 -> V_138 == V_299 &&
V_216 -> V_218 == V_239 &&
strncmp ( V_216 -> V_189 , L_67 , 22 ) == 0 )
return true ;
break;
}
if ( V_216 -> type == V_300 &&
F_72 ( V_216 , V_301 ) )
return true ;
return ! ! F_72 ( V_216 , V_302 ) ;
}
int F_109 ( struct V_2 * V_216 )
{
static T_8 V_4 = F_110 ( 0 ) ;
int V_104 ;
if ( F_48 ( V_216 -> V_116 & V_303 ) )
return - V_213 ;
if ( F_108 ( V_216 ) )
return - V_211 ;
if ( ! V_216 -> V_202 -> V_203 ) {
F_5 ( V_216 , L_68 ) ;
return - V_33 ;
}
V_104 = V_216 -> V_202 -> V_304 ( V_216 ) ;
if ( V_104 )
return V_104 ;
if ( ! V_216 -> V_118 )
return - V_211 ;
...
V_104 = F_36 ( V_216 ) ;
if ( V_104 )
F_21 ( V_216 , L_69 , V_104 ) ;
}
F_111 ( & V_216 -> V_103 , L_70 , V_216 -> V_218 ,
V_216 -> V_136 , V_216 -> V_138 , F_112 ( & V_4 ) ) ;
F_113 ( V_216 , F_20 ( & V_216 -> V_103 ) ) ;
V_104 = F_114 ( & V_216 -> V_103 ) ;
if ( ! V_104 )
V_216 -> V_116 |= V_303 ;
else
F_115 ( V_216 ) ;
...
struct V_2 * V_216 ;
int V_104 = - V_36 ;
V_216 = F_2 ( sizeof( * V_216 ) , V_10 ) ;
if ( V_216 == NULL )
return F_117 ( V_104 ) ;
F_118 ( & V_216 -> V_103 ) ;
V_216 -> V_103 . V_307 = F_27 ;
V_216 -> V_103 . V_218 = & V_308 ;
F_119 ( & V_216 -> V_103 ) ;
F_25 ( V_216 ) ;
F_120 ( & V_216 -> V_309 ) ;
F_26 ( & V_216 -> V_187 ) ;
...
static void F_123 ( struct V_2 * V_216 )
{
if ( V_216 -> V_116 & V_303 ) {
F_124 ( & V_216 -> V_103 ) ;
F_115 ( V_216 ) ;
V_216 -> V_116 &= ~ V_303 ;
}
...
void F_125 ( struct V_2 * V_216 )
{
F_123 ( V_216 ) ;
F_126 ( & V_216 -> V_103 ) ;
}
int F_127 ( struct V_185 * V_186 , struct V_311 * V_312 ,
const char * V_313 )
{
int V_104 ;
V_186 -> V_174 . V_189 = V_186 -> V_189 ;
V_186 -> V_174 . V_218 = & V_308 ;
V_186 -> V_174 . V_312 = V_312 ;
V_186 -> V_174 . V_313 = V_313 ;
F_26 ( & V_186 -> V_263 ) ;
F_121 ( & V_186 -> V_262 ) ;
V_104 = F_128 ( & V_186 -> V_174 ) ;
if ( V_104 )
return V_104 ;
V_104 = F_129 ( & V_186 -> V_174 , & V_314 ) ;
if ( V_104 )
F_130 ( & V_186 -> V_174 ) ;
return V_104 ;
}
void F_131 ( struct V_185 * V_186 )
{
F_132 ( & V_186 -> V_174 , & V_314 ) ;
F_130 ( & V_186 -> V_174 ) ;
F_92 ( V_186 ) ;
}
...
for ( V_48 = 0 ; V_48 < F_134 ( V_317 ) ; V_48 ++ )
if ( V_316 -> V_318 -> V_319 [ V_48 ] )
return 1 ;
}
return 0 ;
}
