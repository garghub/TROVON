...
{
F_51 ( F_2 ( V_11 , struct V_9 , V_11 ) ) ;
}
static int F_52 ( struct V_109 * V_110 )
{
struct V_2 * V_3 ;
struct V_1 * V_12 ;
struct V_111 * V_112 ;
...
int V_115 ;
int V_83 ;
V_12 = F_53 ( & V_110 -> V_116 , sizeof( * V_12 ) , V_117 ) ;
if ( ! V_12 )
return - V_55 ;
V_112 = & V_12 -> V_6 ;
V_114 = F_54 ( V_110 , V_118 , 0 ) ;
V_12 -> V_14 = F_55 ( & V_110 -> V_116 , V_114 ) ;
if ( F_56 ( V_12 -> V_14 ) )
return F_57 ( V_12 -> V_14 ) ;
V_12 -> V_119 = F_58 ( & V_110 -> V_116 , L_1 ) ;
if ( F_56 ( V_12 -> V_119 ) )
return F_57 ( V_12 -> V_119 ) ;
F_59 ( V_12 -> V_119 ) ;
F_60 ( V_120 , V_112 -> V_121 ) ;
F_60 ( V_122 , V_112 -> V_121 ) ;
V_112 -> V_123 = F_47 ;
V_112 -> V_124 = F_44 ;
V_112 -> V_125 = F_35 ;
V_112 -> V_126 = F_37 ;
...
V_112 -> V_130 = V_131 ;
V_112 -> V_132 = V_131 ;
V_112 -> V_133 = F_61 ( V_51 ) | F_61 ( V_46 ) ;
V_112 -> V_134 = V_135 ;
...
return V_115 ;
V_83 = F_65 ( V_110 , 0 ) ;
V_115 = F_66 ( V_83 , F_34 , 0 , F_67 ( & V_110 -> V_116 ) , V_12 ) ;
if ( V_115 )
goto V_139;
F_68 ( V_110 , V_12 ) ;
return 0 ;
...
static void F_70 ( struct V_111 * V_12 )
{
struct V_2 * V_3 , * V_140 ;
F_71 (chan, _chan,
&dmadev->channels, vchan.chan.device_node) {
F_31 ( & V_3 -> V_4 . V_3 . V_141 ) ;
F_72 ( & V_3 -> V_4 . V_142 ) ;
}
}
static int F_73 ( struct V_109 * V_110 )
{
struct V_1 * V_12 = F_74 ( V_110 ) ;
int V_83 = F_65 ( V_110 , 0 ) ;
F_75 ( V_83 , V_12 ) ;
F_70 ( & V_12 -> V_6 ) ;
F_69 ( & V_12 -> V_6 ) ;
F_76 ( V_12 -> V_119 ) ;
