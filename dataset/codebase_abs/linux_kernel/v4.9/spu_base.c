...
int V_56 ;
V_3 = V_1 -> V_3 ;
for ( V_56 = 0 ; V_56 < F_31 ( V_95 ) ; V_56 ++ ) {
int V_94 ;
F_4 ( & V_3 -> V_97 , V_95 [ V_56 ] . V_93 ) ;
for ( V_94 = 0 ; V_94 < V_95 [ V_56 ] . V_94 ; V_94 ++ )
F_4 ( & V_3 -> V_98 , 0 ) ;
}
for ( V_56 = 0 ; V_56 < F_31 ( V_96 ) ; V_56 ++ ) {
F_4 ( & V_3 -> V_97 , V_96 [ V_56 ] . V_93 ) ;
F_4 ( & V_3 -> V_99 , V_96 [ V_56 ] . V_94 ) ;
}
}
...
V_152 [ V_56 ] . V_160 = F_37 ( V_1 ) ;
V_152 [ V_56 ] . V_161 = F_40 ( V_1 ) ;
V_150 = F_3 ( V_1 ) ;
V_152 [ V_56 ] . V_162 = V_150 ;
V_150 &= ~ V_163 ;
F_69 ( V_1 , V_150 ) ;
F_80 ( 200 ) ;
}
...
{
int V_56 , V_30 = 0 ;
for ( V_56 = 0 ; V_56 < V_166 ; V_56 ++ ) {
F_86 ( & V_123 [ V_56 ] . V_124 ) ;
F_72 ( & V_123 [ V_56 ] . V_126 ) ;
}
if ( ! V_167 )
goto V_116;
