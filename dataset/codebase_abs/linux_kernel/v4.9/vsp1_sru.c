...
struct V_1 * F_20 ( struct V_76 * V_77 )
{
struct V_1 * V_2 ;
int V_29 ;
V_2 = F_21 ( V_77 -> V_78 , sizeof( * V_2 ) , V_79 ) ;
if ( V_2 == NULL )
return F_22 ( - V_80 ) ;
V_2 -> V_30 . V_81 = & V_82 ;
V_2 -> V_30 . type = V_83 ;
V_29 = F_23 ( V_77 , & V_2 -> V_30 , L_1 , 2 , & V_84 ,
V_85 ) ;
if ( V_29 < 0 )
return F_22 ( V_29 ) ;
F_24 ( & V_2 -> V_10 , 1 ) ;
F_25 ( & V_2 -> V_10 , & V_86 , NULL ) ;
V_2 -> V_13 = 1 ;
V_2 -> V_30 . V_16 . V_87 = & V_2 -> V_10 ;
if ( V_2 -> V_10 . error ) {
F_26 ( V_77 -> V_78 , L_2 ) ;
V_29 = V_2 -> V_10 . error ;
F_27 ( & V_2 -> V_30 ) ;
