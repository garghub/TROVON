...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_4 , F_41 ( & V_6 -> V_38 ) ) ;
}
...
static int F_97 ( struct V_5 * V_6 , unsigned long V_8 )
{
...
static int F_100 ( struct V_5 * V_6 , unsigned long V_8 )
{
...
static int F_103 ( struct V_5 * V_6 , unsigned long V_8 )
{
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_8 , F_108 ( V_6 -> V_68 ) ) ;
}
...
{
struct V_5 * V_6 = F_3 ( V_2 ) ;
return sprintf ( V_3 , L_7 , V_6 -> V_72 ) ;
}
static T_1 F_113 ( struct V_1 * V_2 ,
struct V_15 * V_16 ,
const char * V_3 , T_2 V_4 )
{
return F_1 ( V_2 , V_3 , V_4 , V_73 ) ;
}
static T_1 F_114 ( struct V_74 * V_75 , struct V_76 * V_77 ,
struct V_78 * V_79 ,
char * V_3 , T_4 V_80 , T_2 V_81 )
{
struct V_1 * V_10 = F_115 ( V_77 ) ;
struct V_5 * V_6 = F_3 ( V_10 ) ;
int V_82 ;
if ( V_80 % sizeof( struct V_83 ) != 0 )
return - V_14 ;
V_82 = F_116 ( V_6 , V_3 ,
V_81 / sizeof( struct V_83 ) ,
V_80 / sizeof( struct V_83 ) ) ;
if ( V_82 > 0 )
V_82 *= sizeof( struct V_83 ) ;
return V_82 ;
}
int F_117 ( struct V_84 * V_10 )
{
struct V_76 * V_85 = & V_10 -> V_10 . V_77 ;
struct V_5 * V_6 = F_118 ( V_10 ) ;
int V_9 ;
V_9 = F_119 ( V_85 , & V_86 ) ;
if ( V_9 ) {
F_120 ( L_9 ,
V_87 , V_10 -> V_88 , V_86 . V_88 ) ;
goto V_89;
}
V_9 = F_121 ( V_85 , & V_90 ) ;
if ( V_9 ) {
F_120 ( L_10 ,
V_87 , V_10 -> V_88 , V_90 . V_16 . V_88 ) ;
goto V_91;
}
V_6 -> V_92 = F_122 ( V_93 , V_85 ) ;
if ( ! V_6 -> V_92 ) {
F_120 ( L_11 ,
V_87 , V_10 -> V_88 , V_93 ) ;
V_9 = - V_94 ;
...
return 0 ;
V_95:
F_123 ( & V_10 -> V_10 . V_77 , & V_90 ) ;
V_91:
F_124 ( & V_10 -> V_10 . V_77 , & V_86 ) ;
V_89:
return V_9 ;
}
void F_125 ( struct V_84 * V_10 )
{
struct V_76 * V_77 = & V_10 -> V_10 . V_77 ;
struct V_5 * V_6 = F_118 ( V_10 ) ;
F_126 ( V_6 -> V_92 ) ;
F_123 ( V_77 , & V_90 ) ;
F_124 ( V_77 , & V_86 ) ;
