...
V_230 . V_241 = V_242 ;
V_3 = ( V_230 . V_241 & 3 ) << 4 | ( V_230 . V_231 & 3 ) ;
if ( V_230 . V_243 & 15 )
V_3 |= V_244 ;
...
static T_4 F_90 ( int V_416 , void * V_417 )
{
...
static T_4 F_91 ( int V_416 , void * V_417 )
{
struct V_1 * V_2 = V_417 ;
...
static int F_93 ( struct V_434 * V_435 , struct V_1 * V_2 )
{
struct V_436 * V_437 = V_2 -> V_437 ;
struct V_395 * V_396 ;
int V_212 ;
V_396 = F_94 ( V_435 -> V_29 , sizeof( * V_396 ) , V_438 ) ;
if ( ! V_396 ) {
F_95 ( L_15 ) ;
return - V_439 ;
}
...
F_97 ( & V_2 -> V_402 ,
& V_444 ) ;
F_98 ( V_435 , & V_2 -> V_402 ,
& V_445 ,
V_446 ) ;
F_99 ( & V_2 -> V_402 , V_437 ) ;
return 0 ;
}
int F_100 ( struct V_447 * V_29 , struct V_447 * V_448 ,
...
int V_212 ;
T_3 V_3 = 1 ;
V_2 = F_94 ( V_29 , sizeof( * V_2 ) , V_438 ) ;
if ( ! V_2 )
return - V_439 ;
V_2 -> V_402 . V_459 = 1 ;
V_2 -> V_178 = V_178 ;
...
V_456 = F_104 ( V_452 , L_19 , 0 ) ;
if ( V_456 ) {
V_2 -> V_407 = F_105 ( V_456 ) ;
F_106 ( V_456 ) ;
if ( ! V_2 -> V_407 ) {
F_17 ( V_2 -> V_29 , L_20 ) ;
return - V_460 ;
...
V_2 -> V_5 = F_107 ( V_29 , V_450 ) ;
if ( F_108 ( V_2 -> V_5 ) )
return F_109 ( V_2 -> V_5 ) ;
V_2 -> V_461 = F_110 ( V_2 -> V_29 , L_22 ) ;
if ( F_108 ( V_2 -> V_461 ) ) {
V_212 = F_109 ( V_2 -> V_461 ) ;
F_55 ( V_2 -> V_29 , L_23 , V_212 ) ;
return V_212 ;
}
V_212 = F_111 ( V_2 -> V_461 ) ;
if ( V_212 ) {
F_55 ( V_2 -> V_29 , L_24 , V_212 ) ;
return V_212 ;
}
V_2 -> V_462 = F_110 ( V_2 -> V_29 , L_25 ) ;
if ( F_108 ( V_2 -> V_462 ) ) {
V_212 = F_109 ( V_2 -> V_462 ) ;
F_55 ( V_2 -> V_29 , L_26 , V_212 ) ;
goto V_463;
}
V_212 = F_111 ( V_2 -> V_462 ) ;
if ( V_212 ) {
...
V_455 . V_481 = F_115 ( 32 ) ;
V_2 -> V_458 = F_116 ( & V_455 ) ;
}
F_117 ( V_29 , V_2 ) ;
return 0 ;
V_469:
...
void F_119 ( struct V_447 * V_29 , struct V_447 * V_448 , void * V_8 )
{
struct V_1 * V_2 = F_120 ( V_29 ) ;
if ( V_2 -> V_458 && ! F_108 ( V_2 -> V_458 ) )
F_121 ( V_2 -> V_458 ) ;
F_9 ( V_2 , ~ 0 , V_379 ) ;
F_118 ( V_2 -> V_462 ) ;
F_118 ( V_2 -> V_461 ) ;
