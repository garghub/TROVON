...
static void * F_16 ( struct V_13 * V_5 , void * V_34 )
{
return NULL ;
}
int F_17 ( struct V_13 * V_5 , void * V_34 , void * V_35 )
{
struct V_1 * V_2 = F_18 ( V_5 , struct V_1 , V_5 ) ;
struct V_4 * V_36 , * V_37 ;
T_1 V_38 = * ( T_1 * ) V_34 , V_39 ;
if ( F_19 ( V_38 >= V_2 -> V_17 ) )
return - V_40 ;
V_36 = F_20 ( & V_2 -> V_41 [ V_38 ] , NULL ) ;
if ( ! V_36 )
return - V_40 ;
V_39 = V_36 -> V_42 * sizeof( T_2 ) ;
memcpy ( V_35 , V_36 -> V_43 , V_39 ) ;
memset ( V_35 + V_39 , 0 , V_5 -> V_6 - V_39 ) ;
V_37 = F_20 ( & V_2 -> V_41 [ V_38 ] , V_36 ) ;
if ( V_37 )
F_21 ( & V_2 -> V_11 , & V_37 -> V_44 ) ;
return 0 ;
}
static int F_22 ( struct V_13 * V_5 , void * V_34 , void * V_45 )
{
return - V_21 ;
}
static int F_23 ( struct V_13 * V_5 , void * V_34 , void * V_35 ,
T_2 V_20 )
{
return - V_21 ;
}
static int F_24 ( struct V_13 * V_5 , void * V_34 )
{
struct V_1 * V_2 = F_18 ( V_5 , struct V_1 , V_5 ) ;
struct V_4 * V_37 ;
T_1 V_38 = * ( T_1 * ) V_34 ;
...
static void F_25 ( struct V_13 * V_5 )
{
struct V_1 * V_2 = F_18 ( V_5 , struct V_1 , V_5 ) ;
F_26 () ;
F_5 ( V_2 -> V_8 ) ;
