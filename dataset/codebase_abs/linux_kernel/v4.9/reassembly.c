...
V_81 -> V_64 = F_65 ( V_81 -> V_64 , V_80 -> V_64 ) ;
if ( F_66 ( V_81 , V_80 , & V_96 , & V_97 ) ) {
F_67 ( V_80 , V_96 ) ;
} else {
if ( ! F_58 ( V_81 ) -> V_91 )
F_58 ( V_81 ) -> V_91 = V_80 ;
...
F_68 ( V_15 -> V_13 . V_26 , V_82 ) ;
V_81 -> V_52 = NULL ;
V_81 -> V_30 = V_30 ;
V_81 -> V_73 = V_15 -> V_13 . V_72 ;
F_35 ( V_81 ) -> V_57 = F_41 ( V_57 ) ;
F_69 ( F_35 ( V_81 ) , 0xff , V_25 ) ;
F_70 ( V_81 ) -> V_50 = V_50 ;
F_70 ( V_81 ) -> V_32 |= V_99 ;
F_71 ( V_81 , F_38 ( V_81 ) ,
F_72 ( V_81 ) ) ;
...
struct V_26 * V_26 = F_32 ( F_33 ( V_47 ) -> V_30 ) ;
if ( F_70 ( V_47 ) -> V_32 & V_99 )
goto V_102;
F_18 ( V_26 , F_36 ( F_33 ( V_47 ) ) , V_103 ) ;
if ( V_101 -> V_57 == 0 )
goto V_102;
if ( ! F_75 ( V_47 , ( F_76 ( V_47 ) +
sizeof( struct V_48 ) ) ) )
goto V_102;
V_101 = F_35 ( V_47 ) ;
...
F_70 ( V_47 ) -> V_50 = ( T_1 * ) V_49 - F_38 ( V_47 ) ;
F_70 ( V_47 ) -> V_32 |= V_99 ;
return 1 ;
}
...
int V_106 ;
F_14 ( & V_15 -> V_13 . V_31 ) ;
V_106 = F_31 ( V_15 , V_47 , V_49 , F_70 ( V_47 ) -> V_50 ) ;
F_23 ( & V_15 -> V_13 . V_31 ) ;
F_24 ( & V_15 -> V_13 , & V_8 ) ;
return V_106 ;
}
...
F_18 ( V_26 , F_36 ( F_33 ( V_47 ) ) ,
V_59 ) ;
F_37 ( V_47 , V_60 , F_72 ( V_47 ) ) ;
return - 1 ;
}
static int T_3 F_77 ( struct V_26 * V_26 )
{
struct V_107 * V_108 ;
struct V_109 * V_101 ;
V_108 = V_110 ;
if ( ! F_78 ( V_26 , & V_111 ) ) {
V_108 = F_79 ( V_108 , sizeof( V_110 ) , V_112 ) ;
if ( ! V_108 )
goto V_113;
...
static void T_4 F_82 ( struct V_26 * V_26 )
{
struct V_107 * V_108 ;
V_108 = V_26 -> V_43 . V_123 . V_124 -> V_126 ;
F_83 ( V_26 -> V_43 . V_123 . V_124 ) ;
if ( ! F_78 ( V_26 , & V_111 ) )
F_81 ( V_108 ) ;
}
static int F_84 ( void )
{
V_127 = F_80 ( & V_111 , L_3 ,
V_128 ) ;
