...
static bool F_201 ( struct V_2 * V_4 , bool V_85 )
{
unsigned long V_33 ;
int V_15 ;
do {
...
bool F_202 ( struct V_2 * V_4 )
{
return F_201 ( V_4 , false ) ;
}
bool F_203 ( struct V_11 * V_86 )
{
return F_201 ( & V_86 -> V_4 , true ) ;
}
bool F_204 ( struct V_11 * V_86 )
{
...
int F_213 ( T_1 V_200 , struct V_201 * V_202 )
{
if ( ! F_214 () ) {
V_200 ( & V_202 -> V_4 ) ;
return 0 ;
}
F_209 ( & V_202 -> V_4 , V_200 ) ;
F_78 ( & V_202 -> V_4 ) ;
return 1 ;
}
void F_215 ( struct V_203 * V_125 )
{
if ( V_125 ) {
F_216 ( V_125 -> V_126 ) ;
F_146 ( V_125 ) ;
...
struct V_203 * F_217 ( T_4 V_204 )
{
struct V_203 * V_125 ;
V_125 = F_218 ( sizeof( * V_125 ) , V_204 ) ;
if ( ! V_125 )
goto V_88;
if ( ! F_219 ( & V_125 -> V_126 , V_204 ) )
goto V_88;
F_220 ( V_125 -> V_126 , V_205 ) ;
return V_125 ;
V_88:
F_215 ( V_125 ) ;
return NULL ;
}
static void F_221 ( struct V_203 * V_206 ,
const struct V_203 * V_207 )
{
V_206 -> V_134 = V_207 -> V_134 ;
F_220 ( V_206 -> V_126 , V_207 -> V_126 ) ;
V_206 -> V_208 = V_207 -> V_208 ;
}
static T_5 F_222 ( const struct V_203 * V_125 )
{
T_5 V_209 = 0 ;
V_209 = F_223 ( V_125 -> V_134 , V_209 ) ;
V_209 = F_224 ( F_225 ( V_125 -> V_126 ) ,
F_226 ( V_210 ) * sizeof( long ) , V_209 ) ;
return V_209 ;
}
static bool F_227 ( const struct V_203 * V_211 ,
const struct V_203 * V_212 )
{
if ( V_211 -> V_134 != V_212 -> V_134 )
return false ;
if ( ! F_228 ( V_211 -> V_126 , V_212 -> V_126 ) )
return false ;
return true ;
}
...
F_236 ( & V_14 -> V_214 ) ;
V_14 -> V_69 = 1 ;
V_14 -> V_125 = F_217 ( V_19 ) ;
if ( ! V_14 -> V_125 )
return - V_199 ;
return 0 ;
}
static void F_237 ( struct V_215 * V_216 )
{
struct V_22 * V_23 =
...
static void F_238 ( struct V_215 * V_216 )
{
...
static void F_240 ( struct V_13 * V_14 )
{
F_241 ( V_130 ) ;
struct V_51 * V_51 ;
F_20 ( & V_16 ) ;
...
F_200 ( & V_14 -> V_119 ) ;
F_200 ( & V_14 -> V_143 ) ;
F_244 ( & V_14 -> V_216 , F_238 ) ;
}
static struct V_13 * F_245 ( const struct V_203 * V_125 )
{
T_5 V_209 = F_222 ( V_125 ) ;
struct V_13 * V_14 ;
int V_24 ;
int V_218 = V_25 ;
F_20 ( & V_16 ) ;
F_72 (unbound_pool_hash, pool, hash_node, hash) {
if ( F_227 ( V_14 -> V_125 , V_125 ) ) {
V_14 -> V_69 ++ ;
return V_14 ;
}
}
...
if ( ! V_14 || F_229 ( V_14 ) < 0 )
goto V_88;
F_248 ( & V_14 -> V_68 , 1 ) ;
F_221 ( V_14 -> V_125 , V_125 ) ;
V_14 -> V_24 = V_218 ;
...
static void F_250 ( struct V_215 * V_216 )
{
F_251 ( V_222 ,
F_168 ( V_216 , struct V_21 , V_216 ) ) ;
}
static void F_252 ( struct V_2 * V_4 )
{
...
F_240 ( V_14 ) ;
F_136 ( & V_16 ) ;
F_244 ( & V_34 -> V_216 , F_250 ) ;
if ( V_223 )
F_244 ( & V_23 -> V_216 , F_237 ) ;
}
static void F_254 ( struct V_21 * V_34 )
{
struct V_22 * V_23 = V_34 -> V_23 ;
...
static void F_255 ( struct V_21 * V_34 , struct V_22 * V_23 ,
struct V_13 * V_14 )
{
F_256 ( ( unsigned long ) V_34 & V_229 ) ;
...
F_132 ( & V_34 -> V_224 ) ;
F_132 ( & V_34 -> V_141 ) ;
F_209 ( & V_34 -> V_71 , F_252 ) ;
}
static void F_257 ( struct V_21 * V_34 )
{
struct V_22 * V_23 = V_34 -> V_23 ;
F_20 ( & V_23 -> V_179 ) ;
if ( ! F_51 ( & V_34 -> V_224 ) )
...
F_254 ( V_34 ) ;
F_258 ( & V_34 -> V_224 , & V_23 -> V_225 ) ;
}
static struct V_21 * F_259 ( struct V_22 * V_23 ,
...
if ( ! V_14 )
return NULL ;
V_34 = F_260 ( V_222 , V_19 , V_14 -> V_24 ) ;
if ( ! V_34 ) {
F_240 ( V_14 ) ;
return NULL ;
}
F_255 ( V_34 , V_23 , V_14 ) ;
return V_34 ;
}
static bool F_261 ( const struct V_203 * V_125 , int V_24 ,
int V_230 , T_6 * V_126 )
{
if ( ! V_219 || V_125 -> V_208 )
goto V_231;
F_262 ( V_126 , F_263 ( V_24 ) , V_125 -> V_126 ) ;
if ( V_230 >= 0 )
F_264 ( V_230 , V_126 ) ;
if ( F_105 ( V_126 ) )
goto V_231;
F_262 ( V_126 , V_125 -> V_126 , V_220 [ V_24 ] ) ;
return ! F_228 ( V_126 , V_125 -> V_126 ) ;
V_231:
F_220 ( V_126 , V_125 -> V_126 ) ;
return false ;
}
static struct V_21 * F_265 ( struct V_22 * V_23 ,
int V_24 ,
struct V_21 * V_34 )
{
struct V_21 * V_232 ;
...
F_20 ( & V_23 -> V_179 ) ;
F_257 ( V_34 ) ;
V_232 = F_266 ( V_23 -> V_27 [ V_24 ] ) ;
F_267 ( V_23 -> V_27 [ V_24 ] , V_34 ) ;
return V_232 ;
}
...
int V_24 ;
F_20 ( & V_16 ) ;
V_234 = F_218 ( sizeof( * V_234 ) + V_238 * sizeof( V_234 -> V_235 [ 0 ] ) ,
V_19 ) ;
V_236 = F_217 ( V_19 ) ;
V_237 = F_217 ( V_19 ) ;
...
goto V_239;
F_221 ( V_236 , V_125 ) ;
F_262 ( V_236 -> V_126 , V_236 -> V_126 , V_96 ) ;
if ( F_24 ( F_105 ( V_236 -> V_126 ) ) )
F_220 ( V_236 -> V_126 , V_96 ) ;
F_221 ( V_237 , V_236 ) ;
V_234 -> V_26 = F_259 ( V_23 , V_236 ) ;
if ( ! V_234 -> V_26 )
goto V_239;
F_246 (node) {
if ( F_261 ( V_236 , V_24 , - 1 , V_237 -> V_126 ) ) {
V_234 -> V_235 [ V_24 ] = F_259 ( V_23 , V_237 ) ;
if ( ! V_234 -> V_235 [ V_24 ] )
goto V_239;
} else {
V_234 -> V_26 -> V_69 ++ ;
...
F_221 ( V_236 , V_125 ) ;
F_262 ( V_236 -> V_126 , V_236 -> V_126 , V_205 ) ;
V_234 -> V_125 = V_236 ;
V_234 -> V_23 = V_23 ;
F_215 ( V_237 ) ;
return V_234 ;
...
static void F_270 ( struct V_233 * V_234 )
{
int V_24 ;
F_134 ( & V_234 -> V_23 -> V_179 ) ;
F_221 ( V_234 -> V_23 -> V_217 , V_234 -> V_125 ) ;
F_246 (node)
V_234 -> V_235 [ V_24 ] = F_265 ( V_234 -> V_23 , V_24 ,
V_234 -> V_235 [ V_24 ] ) ;
F_257 ( V_234 -> V_26 ) ;
F_271 ( V_234 -> V_23 -> V_26 , V_234 -> V_26 ) ;
...
static int F_274 ( struct V_22 * V_23 ,
const struct V_203 * V_125 )
{
struct V_233 * V_234 ;
...
int F_275 ( struct V_22 * V_23 ,
const struct V_203 * V_125 )
{
int V_15 ;
F_272 () ;
V_15 = F_274 ( V_23 , V_125 ) ;
F_273 () ;
return V_15 ;
}
static void F_276 ( struct V_22 * V_23 , int V_56 ,
bool V_242 )
{
int V_24 = F_113 ( V_56 ) ;
...
V_244 = V_245 ;
V_126 = V_244 -> V_126 ;
F_221 ( V_244 , V_23 -> V_217 ) ;
V_34 = F_22 ( V_23 , V_24 ) ;
if ( F_261 ( V_23 -> V_26 -> V_14 -> V_125 , V_24 , V_243 , V_126 ) ) {
if ( F_228 ( V_126 , V_34 -> V_14 -> V_125 -> V_126 ) )
return;
} else {
goto V_246;
}
V_34 = F_259 ( V_23 , V_244 ) ;
if ( ! V_34 ) {
F_104 ( L_12 ,
V_23 -> V_107 ) ;
goto V_246;
...
V_232 = F_265 ( V_23 , V_24 , V_23 -> V_26 ) ;
V_181:
F_136 ( & V_23 -> V_179 ) ;
F_79 ( V_232 ) ;
}
static int F_277 ( struct V_22 * V_23 )
{
bool V_247 = V_23 -> V_33 & V_248 ;
int V_56 , V_15 ;
if ( ! ( V_23 -> V_33 & V_70 ) ) {
V_23 -> V_106 = F_206 ( struct V_21 ) ;
if ( ! V_23 -> V_106 )
return - V_199 ;
F_278 (cpu) {
struct V_21 * V_34 =
...
V_15 = F_275 ( V_23 , V_251 [ V_247 ] ) ;
F_280 ( ! V_15 && ( V_23 -> V_225 . V_116 != & V_23 -> V_26 -> V_224 ||
V_23 -> V_225 . V_138 != & V_23 -> V_26 -> V_224 ) ,
L_13 , V_23 -> V_107 ) ;
return V_15 ;
} else {
return F_275 ( V_23 , V_252 [ V_247 ] ) ;
}
}
static int F_281 ( int V_80 , unsigned int V_33 ,
const char * V_107 )
{
...
F_104 ( L_14 ,
V_80 , V_107 , 1 , V_253 ) ;
return F_282 ( V_80 , 1 , V_253 ) ;
}
struct V_22 * F_283 ( const char * V_256 ,
unsigned int V_33 ,
int V_80 ,
struct V_257 * V_192 ,
const char * V_258 , ... )
...
V_23 = F_218 ( sizeof( * V_23 ) + V_259 , V_19 ) ;
if ( ! V_23 )
return NULL ;
if ( V_33 & V_70 ) {
V_23 -> V_217 = F_217 ( V_19 ) ;
if ( ! V_23 -> V_217 )
goto V_262;
}
va_start ( args , V_258 ) ;
...
va_end ( args ) ;
V_80 = V_80 ? : V_263 ;
V_80 = F_281 ( V_80 , V_33 , V_23 -> V_107 ) ;
V_23 -> V_33 = V_33 ;
V_23 -> V_189 = V_80 ;
F_234 ( & V_23 -> V_179 ) ;
F_174 ( & V_23 -> V_82 , 0 ) ;
...
F_132 ( & V_23 -> V_180 ) ;
F_132 ( & V_23 -> V_142 ) ;
F_284 ( & V_23 -> V_178 , V_258 , V_192 , 0 ) ;
F_132 ( & V_23 -> V_176 ) ;
if ( F_277 ( V_23 ) < 0 )
goto V_262;
if ( V_33 & V_162 ) {
...
goto V_264;
V_140 -> V_153 = V_23 ;
V_140 -> V_54 = F_285 ( F_162 , V_140 , L_15 ,
V_23 -> V_107 ) ;
if ( F_142 ( V_140 -> V_54 ) ) {
F_146 ( V_140 ) ;
goto V_264;
...
F_289 ( V_23 ) ;
if ( V_23 -> V_140 )
F_290 ( V_23 -> V_140 -> V_54 ) ;
if ( ! ( V_23 -> V_33 & V_70 ) ) {
F_244 ( & V_23 -> V_216 , F_237 ) ;
} else {
F_246 (node) {
V_34 = F_266 ( V_23 -> V_27 [ V_24 ] ) ;
F_291 ( V_23 -> V_27 [ V_24 ] , NULL ) ;
F_79 ( V_34 ) ;
}
V_34 = V_23 -> V_26 ;
V_23 -> V_26 = NULL ;
...
void F_292 ( struct V_22 * V_23 , int V_80 )
{
struct V_21 * V_34 ;
if ( F_116 ( V_23 -> V_33 & V_241 ) )
return;
V_80 = F_281 ( V_80 , V_23 -> V_33 , V_23 -> V_107 ) ;
F_134 ( & V_23 -> V_179 ) ;
V_23 -> V_189 = V_80 ;
F_175 (pwq, wq)
F_254 ( V_34 ) ;
...
bool F_294 ( int V_56 , struct V_22 * V_23 )
{
struct V_21 * V_34 ;
bool V_15 ;
F_295 () ;
...
unsigned int F_298 ( struct V_2 * V_4 )
{
struct V_13 * V_14 ;
unsigned long V_33 ;
unsigned int V_15 = 0 ;
...
void F_300 ( const char * V_272 , struct V_55 * V_54 )
{
T_1 * V_200 = NULL ;
char V_107 [ V_273 ] = { } ;
char V_270 [ V_274 ] = { } ;
...
return;
V_51 = F_301 ( V_54 ) ;
F_302 ( & V_200 , & V_51 -> V_62 , sizeof( V_200 ) ) ;
F_302 ( & V_34 , & V_51 -> V_92 , sizeof( V_34 ) ) ;
F_302 ( & V_23 , & V_34 -> V_23 , sizeof( V_23 ) ) ;
F_302 ( V_107 , V_23 -> V_107 , sizeof( V_107 ) - 1 ) ;
F_302 ( & V_271 , & V_51 -> V_271 , sizeof( V_271 ) ) ;
if ( V_271 )
F_302 ( V_270 , V_51 -> V_270 , sizeof( V_270 ) - 1 ) ;
if ( V_200 || V_107 [ 0 ] || V_270 [ 0 ] ) {
F_303 ( L_16 , V_272 , V_107 , V_200 ) ;
if ( V_270 [ 0 ] )
F_304 ( L_17 , V_270 ) ;
F_304 ( L_18 ) ;
}
}
static void F_305 ( struct V_13 * V_14 )
{
F_304 ( L_19 , V_210 , V_14 -> V_125 -> V_126 ) ;
if ( V_14 -> V_24 != V_25 )
F_304 ( L_20 , V_14 -> V_24 ) ;
F_304 ( L_21 , V_14 -> V_33 , V_14 -> V_125 -> V_134 ) ;
}
static void F_306 ( bool V_275 , struct V_2 * V_4 )
{
if ( V_4 -> V_3 == F_167 ) {
struct V_167 * V_168 ;
V_168 = F_168 ( V_4 , struct V_167 , V_4 ) ;
F_304 ( L_22 , V_275 ? L_23 : L_5 ,
F_307 ( V_168 -> V_54 ) ) ;
} else {
F_304 ( L_24 , V_275 ? L_23 : L_5 , V_4 -> V_3 ) ;
}
}
static void F_308 ( struct V_21 * V_34 )
{
struct V_13 * V_14 = V_34 -> V_14 ;
struct V_2 * V_4 ;
struct V_51 * V_51 ;
...
int V_278 ;
F_309 ( L_25 , V_14 -> V_20 ) ;
F_305 ( V_14 ) ;
F_304 ( L_26 , V_34 -> V_75 , V_34 -> V_80 ,
! F_51 ( & V_34 -> V_141 ) ? L_27 : L_5 ) ;
F_310 (pool->busy_hash, bkt, worker, hentry) {
if ( V_51 -> V_92 == V_34 ) {
V_276 = true ;
break;
}
...
if ( V_280 )
continue;
F_309 ( L_34 , V_23 -> V_107 , V_23 -> V_33 ) ;
F_175 (pwq, wq) {
F_313 ( & V_34 -> V_14 -> V_68 , V_33 ) ;
if ( V_34 -> V_75 || ! F_51 ( & V_34 -> V_76 ) )
F_308 ( V_34 ) ;
F_314 ( & V_34 -> V_14 -> V_68 , V_33 ) ;
}
}
F_315 (pool, pi) {
struct V_51 * V_51 ;
bool V_157 = true ;
F_313 ( & V_14 -> V_68 , V_33 ) ;
if ( V_14 -> V_49 == V_14 -> V_45 )
goto V_281;
F_309 ( L_35 , V_14 -> V_20 ) ;
F_305 ( V_14 ) ;
F_304 ( L_36 ,
...
if ( V_14 -> V_145 )
F_304 ( L_37 ,
F_307 ( V_14 -> V_145 -> V_54 ) ) ;
F_153 (worker, &pool->idle_list, entry) {
F_304 ( L_38 , V_157 ? L_39 : L_5 ,
F_307 ( V_51 -> V_54 ) ) ;
V_157 = false ;
}
F_304 ( L_18 ) ;
V_281:
F_314 ( & V_14 -> V_68 , V_33 ) ;
}
F_297 () ;
}
...
return;
F_262 ( & V_126 , V_14 -> V_125 -> V_126 , V_98 ) ;
F_319 (worker, pool)
...
long F_327 ( int V_56 , long (* V_200)( void * ) , void * V_287 )
{
struct V_285 V_286 = { . V_200 = V_200 , . V_287 = V_287 } ;
F_170 ( & V_286 . V_4 , F_326 ) ;
F_210 ( V_56 , & V_286 . V_4 ) ;
F_189 ( & V_286 . V_4 ) ;
F_16 ( & V_286 . V_4 ) ;
return V_286 . V_15 ;
}
...
static struct V_22 * F_335 ( struct V_291 * V_292 )
{
struct V_293 * V_294 = F_168 ( V_292 , struct V_293 , V_292 ) ;
return V_294 -> V_23 ;
}
static T_10 F_336 ( struct V_291 * V_292 , struct V_295 * V_296 ,
char * V_297 )
{
struct V_22 * V_23 = F_335 ( V_292 ) ;
return F_337 ( V_297 , V_298 , L_40 , ( bool ) ! ( V_23 -> V_33 & V_70 ) ) ;
}
static T_10 F_338 ( struct V_291 * V_292 ,
struct V_295 * V_296 , char * V_297 )
{
struct V_22 * V_23 = F_335 ( V_292 ) ;
return F_337 ( V_297 , V_298 , L_40 , V_23 -> V_189 ) ;
}
static T_10 F_339 ( struct V_291 * V_292 ,
...
static T_10 F_340 ( struct V_291 * V_292 ,
struct V_295 * V_296 , char * V_297 )
{
struct V_22 * V_23 = F_335 ( V_292 ) ;
...
F_295 () ;
F_246 (node) {
V_302 += F_337 ( V_297 + V_302 , V_298 - V_302 ,
L_42 , V_301 , V_24 ,
F_22 ( V_23 , V_24 ) -> V_14 -> V_20 ) ;
V_301 = L_43 ;
}
V_302 += F_337 ( V_297 + V_302 , V_298 - V_302 , L_18 ) ;
F_297 () ;
return V_302 ;
}
...
int V_302 ;
F_134 ( & V_23 -> V_179 ) ;
V_302 = F_337 ( V_297 , V_298 , L_40 , V_23 -> V_217 -> V_134 ) ;
F_136 ( & V_23 -> V_179 ) ;
return V_302 ;
}
static struct V_203 * F_342 ( struct V_22 * V_23 )
{
struct V_203 * V_125 ;
F_20 ( & V_16 ) ;
V_125 = F_217 ( V_19 ) ;
if ( ! V_125 )
return NULL ;
F_221 ( V_125 , V_23 -> V_217 ) ;
return V_125 ;
}
static T_10 F_343 ( struct V_291 * V_292 , struct V_295 * V_296 ,
...
int V_302 ;
F_134 ( & V_23 -> V_179 ) ;
V_302 = F_337 ( V_297 , V_298 , L_44 ,
F_345 ( V_23 -> V_217 -> V_126 ) ) ;
F_136 ( & V_23 -> V_179 ) ;
return V_302 ;
}
static T_10 F_346 ( struct V_291 * V_292 ,
struct V_295 * V_296 ,
const char * V_297 , T_7 V_299 )
{
struct V_22 * V_23 = F_335 ( V_292 ) ;
...
static T_10 F_348 ( struct V_291 * V_292 , struct V_295 * V_296 ,
char * V_297 )
{
struct V_22 * V_23 = F_335 ( V_292 ) ;
int V_302 ;
F_134 ( & V_23 -> V_179 ) ;
V_302 = F_337 ( V_297 , V_298 , L_40 ,
! V_23 -> V_217 -> V_208 ) ;
F_136 ( & V_23 -> V_179 ) ;
return V_302 ;
}
static T_10 F_349 ( struct V_291 * V_292 , struct V_295 * V_296 ,
const char * V_297 , T_7 V_299 )
{
struct V_22 * V_23 = F_335 ( V_292 ) ;
struct V_203 * V_125 ;
...
static T_10 F_350 ( struct V_291 * V_292 ,
struct V_295 * V_296 , char * V_297 )
{
int V_302 ;
F_134 ( & V_16 ) ;
...
static T_10 F_351 ( struct V_291 * V_292 ,
...
if ( ! F_334 ( & V_126 , V_19 ) )
return - V_199 ;
V_15 = F_347 ( V_297 , V_126 ) ;
if ( ! V_15 )
V_15 = F_333 ( V_126 ) ;
F_216 ( V_126 ) ;
return V_15 ? V_15 : V_299 ;
}
static int T_11 F_352 ( void )
{
int V_306 ;
V_306 = F_353 ( & V_307 , NULL ) ;
if ( V_306 )
return V_306 ;
return F_354 ( V_307 . V_308 , & V_309 ) ;
}
static void F_355 ( struct V_291 * V_292 )
{
struct V_293 * V_294 = F_168 ( V_292 , struct V_293 , V_292 ) ;
F_146 ( V_294 ) ;
}
int F_286 ( struct V_22 * V_23 )
{
struct V_293 * V_294 ;
int V_15 ;
if ( F_116 ( V_23 -> V_33 & V_241 ) )
return - V_240 ;
V_23 -> V_294 = V_294 = F_218 ( sizeof( * V_294 ) , V_19 ) ;
if ( ! V_294 )
return - V_199 ;
V_294 -> V_23 = V_23 ;
V_294 -> V_292 . V_310 = & V_307 ;
V_294 -> V_292 . V_311 = F_355 ;
F_356 ( & V_294 -> V_292 , L_15 , V_23 -> V_107 ) ;
F_357 ( & V_294 -> V_292 , true ) ;
V_15 = F_358 ( & V_294 -> V_292 ) ;
if ( V_15 ) {
F_146 ( V_294 ) ;
V_23 -> V_294 = NULL ;
return V_15 ;
...
F_357 ( & V_294 -> V_292 , false ) ;
F_360 ( & V_294 -> V_292 . V_313 , V_314 ) ;
return 0 ;
}
...
V_315 = V_73 ;
F_278 (cpu)
F_279 ( V_316 , V_56 ) = V_73 ;
}
static void F_362 ( unsigned long V_32 )
{
unsigned long V_317 = F_363 ( V_318 ) * V_319 ;
bool V_320 = false ;
struct V_13 * V_14 ;
int V_279 ;
if ( ! V_317 )
...
if ( F_51 ( & V_14 -> V_44 ) )
continue;
V_321 = F_363 ( V_14 -> V_72 ) ;
V_322 = F_363 ( V_315 ) ;
if ( F_365 ( V_321 , V_322 ) )
V_323 = V_321 ;
else
V_323 = V_322 ;
if ( V_14 -> V_56 >= 0 ) {
...
F_363 ( F_279 ( V_316 ,
V_14 -> V_56 ) ) ;
if ( F_365 ( V_324 , V_323 ) )
V_323 = V_324 ;
}
if ( F_365 ( V_73 , V_323 + V_317 ) ) {
V_320 = true ;
F_366 ( L_45 ) ;
F_305 ( V_14 ) ;
F_304 ( L_46 ,
F_316 ( V_73 - V_321 ) / 1000 ) ;
}
}
F_367 () ;
if ( V_320 )
...
static void F_369 ( unsigned long V_317 )
{
V_318 = 0 ;
F_200 ( & V_325 ) ;
if ( V_317 ) {
...
static int F_370 ( const char * V_300 ,
const struct V_326 * V_327 )
{
unsigned long V_317 ;
int V_15 ;
V_15 = F_371 ( V_300 , 0 , & V_317 ) ;
if ( V_15 )
return V_15 ;
if ( V_328 )
F_369 ( V_317 ) ;
...
static inline void F_372 ( void ) { }
static void T_11 F_373 ( void )
{
T_9 * V_329 ;
int V_24 , V_56 ;
if ( F_374 () <= 1 )
...
V_245 = F_217 ( V_19 ) ;
F_256 ( ! V_245 ) ;
V_329 = F_218 ( V_238 * sizeof( V_329 [ 0 ] ) , V_19 ) ;
F_256 ( ! V_329 ) ;
F_246 (node)
F_256 ( ! F_375 ( & V_329 [ V_24 ] , V_19 ,
F_376 ( V_24 ) ? V_24 : V_25 ) ) ;
F_278 (cpu) {
V_24 = F_113 ( V_56 ) ;
if ( F_116 ( V_24 == V_25 ) ) {
F_104 ( L_48 , V_56 ) ;
...
F_377 ( V_56 , V_329 [ V_24 ] ) ;
}
V_220 = V_329 ;
V_219 = true ;
}
static int T_11 F_378 ( void )
{
int V_331 [ V_332 ] = { 0 , V_333 } ;
int V_267 , V_56 ;
F_116 ( F_379 ( struct V_21 ) < F_379 (long long) ) ;
F_256 ( ! F_219 ( & V_96 , V_19 ) ) ;
F_220 ( V_96 , V_205 ) ;
V_222 = F_380 ( V_21 , V_334 ) ;
F_373 () ;
F_278 (cpu) {
struct V_13 * V_14 ;
V_267 = 0 ;
...
F_256 ( F_229 ( V_14 ) ) ;
V_14 -> V_56 = V_56 ;
F_220 ( V_14 -> V_125 -> V_126 , F_381 ( V_56 ) ) ;
...
V_328 = F_382 ( L_49 , 0 , 0 ) ;
V_284 = F_382 ( L_50 , V_248 , 0 ) ;
V_335 = F_382 ( L_51 , 0 , 0 ) ;
V_336 = F_382 ( L_52 , V_70 ,
V_254 ) ;
V_337 = F_382 ( L_53 ,
V_227 , 0 ) ;
V_338 = F_382 ( L_54 ,
