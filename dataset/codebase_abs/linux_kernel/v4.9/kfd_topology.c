...
static void F_44 ( struct V_158 * V_159 , struct V_160 * V_161 )
{
F_45 ( V_159 , V_161 ) ;
F_46 ( V_159 ) ;
F_47 ( V_159 ) ;
}
static void F_48 ( struct V_3 * V_21 )
{
struct V_105 * V_104 ;
struct V_80 * V_79 ;
struct V_59 * V_58 ;
...
if ( V_21 -> V_195 ) {
F_45 ( V_21 -> V_195 , & V_21 -> V_174 ) ;
F_45 ( V_21 -> V_195 , & V_21 -> V_175 ) ;
F_45 ( V_21 -> V_195 , & V_21 -> V_164 ) ;
F_46 ( V_21 -> V_195 ) ;
F_47 ( V_21 -> V_195 ) ;
V_21 -> V_195 = NULL ;
}
}
static int F_49 ( struct V_3 * V_21 ,
T_1 V_81 )
{
struct V_105 * V_104 ;
struct V_80 * V_79 ;
...
F_13 ( ! V_21 ) ;
F_13 ( V_21 -> V_195 ) ;
V_21 -> V_195 = F_18 ( V_21 -> V_195 ) ;
if ( ! V_21 -> V_195 )
return - V_62 ;
V_132 = F_50 ( V_21 -> V_195 , & V_196 ,
V_140 . V_197 , L_71 , V_81 ) ;
if ( V_132 < 0 )
return V_132 ;
...
V_21 -> V_174 . V_198 = V_199 ;
F_52 ( & V_21 -> V_174 ) ;
V_21 -> V_175 . V_173 = L_45 ;
V_21 -> V_175 . V_198 = V_199 ;
F_52 ( & V_21 -> V_175 ) ;
V_21 -> V_164 . V_173 = L_75 ;
V_21 -> V_164 . V_198 = V_199 ;
F_52 ( & V_21 -> V_164 ) ;
...
V_52 = 0 ;
F_3 (mem, &dev->mem_props, list) {
V_58 -> V_159 = F_54 ( sizeof( struct V_158 ) , V_200 ) ;
if ( ! V_58 -> V_159 )
return - V_62 ;
V_132 = F_50 ( V_58 -> V_159 , & V_201 ,
V_21 -> V_194 , L_71 , V_52 ) ;
if ( V_132 < 0 )
return V_132 ;
V_58 -> V_161 . V_173 = L_75 ;
V_58 -> V_161 . V_198 = V_199 ;
F_52 ( & V_58 -> V_161 ) ;
...
V_52 = 0 ;
F_3 (cache, &dev->cache_props, list) {
V_79 -> V_159 = F_54 ( sizeof( struct V_158 ) , V_200 ) ;
if ( ! V_79 -> V_159 )
return - V_62 ;
...
V_52 = 0 ;
F_3 (iolink, &dev->io_link_props, list) {
V_104 -> V_159 = F_54 ( sizeof( struct V_158 ) , V_200 ) ;
if ( ! V_104 -> V_159 )
return - V_62 ;
...
if ( ! V_140 . V_202 )
return - V_62 ;
V_132 = F_50 ( V_140 . V_202 ,
& V_203 , & V_204 -> V_159 ,
L_77 ) ;
if ( V_132 < 0 )
return V_132 ;
V_140 . V_197 = F_51 ( L_78 ,
V_140 . V_202 ) ;
if ( ! V_140 . V_197 )
return - V_62 ;
V_140 . V_163 . V_173 = L_79 ;
V_140 . V_163 . V_198 = V_199 ;
F_52 ( & V_140 . V_163 ) ;
V_132 = F_53 ( V_140 . V_202 ,
& V_140 . V_163 ) ;
if ( V_132 < 0 )
return V_132 ;
V_140 . V_164 . V_173 = L_80 ;
V_140 . V_164 . V_198 = V_199 ;
F_52 ( & V_140 . V_164 ) ;
V_132 = F_53 ( V_140 . V_202 ,
& V_140 . V_164 ) ;
if ( V_132 < 0 )
...
V_157 = 0 ;
memset ( & V_140 , 0 , sizeof( V_140 ) ) ;
V_132 = F_6 ( V_10 , & V_205 ) ;
if ( V_132 == 0 && V_205 > 0 ) {
F_14 ( L_81 , V_205 ) ;
V_10 = F_61 ( V_205 , V_200 ) ;
if ( ! V_10 ) {
V_132 = - V_62 ;
F_11 ( L_82 ) ;
goto V_19;
...
if ( ! V_7 )
return 0 ;
V_208 = V_7 -> V_187 -> V_209 ( V_7 -> V_189 ) ;
V_207 [ 0 ] = V_7 -> V_9 -> V_210 ;
V_207 [ 1 ] = V_7 -> V_9 -> V_211 ;
V_207 [ 2 ] = V_7 -> V_9 -> V_212 ;
V_207 [ 3 ] = V_7 -> V_9 -> V_5 ;
V_207 [ 4 ] = V_7 -> V_9 -> V_213 -> V_214 ;
V_207 [ 5 ] = F_67 ( V_208 ) ;
V_207 [ 6 ] = F_68 ( V_208 ) ;
for ( V_52 = 0 , V_206 = 0 ; V_52 < 7 ; V_52 ++ )
V_206 ^= F_69 ( V_207 [ V_52 ] , V_215 ) ;
return V_206 ;
}
static struct V_3 * F_70 ( struct V_1 * V_7 )
{
struct V_3 * V_21 ;
struct V_3 * V_216 = NULL ;
F_13 ( ! V_7 ) ;
F_3 (dev, &topology_device_list, list)
...
static void F_71 ( T_1 V_2 , int V_217 )
{
}
...
V_21 -> V_2 = V_2 ;
V_7 -> V_81 = V_2 ;
V_21 -> V_24 . V_179 = V_7 -> V_9 -> V_219 ;
V_21 -> V_24 . V_180 = V_7 -> V_9 -> V_5 ;
V_21 -> V_24 . V_181 = ( V_7 -> V_9 -> V_213 -> V_214 << 24 ) +
( V_7 -> V_9 -> V_210 & 0xffffff ) ;
if ( V_21 -> V_7 -> V_182 -> V_220 == V_221 ) {
V_21 -> V_24 . V_31 |= V_222 ;
F_14 ( L_94 ) ;
}
V_218 = 0 ;
V_19:
