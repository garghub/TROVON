...
V_2 -> V_12 = V_12 ;
V_3 = F_55 ( & V_12 -> V_13 , L_7 ) ;
if ( F_56 ( V_3 ) ) {
V_6 = F_57 ( V_3 ) ;
if ( V_6 != - V_109 )
F_4 ( & V_12 -> V_13 , L_8 , V_6 ) ;
return V_6 ;
}
V_6 = F_58 ( V_3 ) ;
if ( V_6 ) {
...
V_113 = F_59 ( V_114 , & V_12 -> V_13 ) ;
if ( V_113 ) {
V_2 -> V_59 = ( int ) ( V_115 ) V_113 -> V_116 ;
} else {
V_111 = F_60 ( V_117 , & V_12 -> V_13 ) ;
if ( ! V_111 ) {
V_6 = - V_118 ;
goto V_119;
}
...
if ( V_6 )
goto V_119;
V_6 = F_64 ( & V_12 -> V_13 , & V_2 -> V_8 , V_2 ) ;
if ( V_6 )
goto V_119;
V_6 = F_43 ( V_2 , V_85 ) ;
if ( V_6 )
goto V_119;
if ( V_104 && V_104 -> V_123 ) {
V_6 = V_104 -> V_123 ( V_12 , V_2 -> V_8 . V_42 ,
V_2 -> V_8 . V_9 , V_104 -> V_124 ) ;
if ( V_6 < 0 )
F_49 ( & V_12 -> V_13 , L_10 , V_6 ) ;
}
F_65 ( V_12 , V_2 ) ;
return 0 ;
V_119:
...
static int F_67 ( struct V_86 * V_12 )
{
struct V_103 * V_104 = F_54 ( & V_12 -> V_13 ) ;
struct V_1 * V_2 = F_68 ( V_12 ) ;
int V_6 ;
if ( V_104 && V_104 -> V_125 ) {
V_6 = V_104 -> V_125 ( V_12 , V_2 -> V_8 . V_42 ,
V_2 -> V_8 . V_9 , V_104 -> V_124 ) ;
if ( V_6 < 0 )
F_4 ( & V_12 -> V_13 , L_11 ,
L_12 , V_6 ) ;
