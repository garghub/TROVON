...
if ( V_17 && V_17 -> V_22 && ( V_17 -> V_22 -> V_58 || V_17 -> V_22 -> V_59 ) ) {
if ( V_77 . V_78 && V_17 -> V_22 -> V_59 )
V_76 = V_17 -> V_22 -> V_59 ;
else if ( V_17 -> V_22 -> V_58 )
V_76 = V_17 -> V_22 -> V_58 ;
}
...
struct V_17 * V_109 = F_43 ( V_99 ) ;
if ( V_109 == NULL ) {
V_108 = - V_110 ;
goto V_111;
}
V_109 -> V_20 = V_17 -> V_19 ;
F_78 ( V_99 -> V_29 , V_109 ) ;
if ( V_106 >= 2 )
F_46 ( V_109 , V_74 ) ;
F_23 ( V_109 ) ;
}
if ( V_17 -> V_20 < V_99 -> V_20 ) {
struct V_17 * V_112 = F_43 ( V_99 ) ;
if ( V_112 == NULL ) {
V_108 = - V_110 ;
goto V_111;
}
V_112 -> V_19 = V_17 -> V_20 ;
F_78 ( V_99 -> V_29 , V_112 ) ;
if ( V_106 >= 2 )
F_46 ( V_112 , V_74 ) ;
F_23 ( V_112 ) ;
}
...
struct V_93 * V_113 , enum V_18 type )
{
...
struct V_17 * V_114 = F_43 ( V_17 ) ;
if ( V_114 == NULL )
goto V_115;
V_108 = F_84 ( V_40 , V_114 , NULL ) ;
if ( V_108 )
goto V_115;
F_85 ( V_94 , V_114 ) ;
F_23 ( V_114 ) ;
...
{
struct V_28 * * V_116 = & V_89 -> V_90 . V_28 ;
struct V_28 * V_113 = NULL ;
const T_3 V_88 = V_17 -> V_19 ;
struct V_17 * V_117 ;
while ( * V_116 != NULL ) {
V_113 = * V_116 ;
V_117 = F_27 ( V_113 , struct V_17 , V_28 ) ;
if ( V_88 < V_117 -> V_19 )
V_116 = & ( * V_116 ) -> V_118 ;
else
V_116 = & ( * V_116 ) -> V_119 ;
}
F_86 ( & V_17 -> V_28 , V_113 , V_116 ) ;
...
{
struct V_28 * * V_116 , * V_113 = NULL ;
struct V_17 * V_117 ;
F_71 ( & V_89 -> V_92 ) ;
V_116 = & V_89 -> V_90 . V_28 ;
while ( * V_116 != NULL ) {
V_113 = * V_116 ;
V_117 = F_27 ( V_113 , struct V_17 , V_28 ) ;
if ( V_88 < V_117 -> V_19 )
V_116 = & ( * V_116 ) -> V_118 ;
else if ( V_88 >= V_117 -> V_20 )
V_116 = & ( * V_116 ) -> V_119 ;
else
goto V_101;
}
...
{
struct V_28 * V_120 = F_26 ( & V_89 -> V_90 ) ;
if ( V_120 )
return F_27 ( V_120 , struct V_17 , V_28 ) ;
return NULL ;
}
