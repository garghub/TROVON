...
{
struct V_98 * V_99 = F_86 ( V_13 , V_100 ) ;
if ( ! V_99 )
return;
F_64 ( & V_70 , & V_13 -> V_72 ,
V_71 ) ;
...
const struct V_4 * V_48 ;
int V_32 ;
V_32 = F_88 ( V_131 , V_132 , V_130 , V_133 ) ;
if ( V_32 < 0 )
return V_32 ;
V_48 = F_3 ( F_38 ( V_13 ) , F_63 ( V_13 ) ) ;
if ( V_48 -> V_134 )
V_32 = V_48 -> V_134 ( V_131 , V_50 ) ;
return V_32 ;
}
static int
F_89 ( const struct V_129 * V_99 ,
...
V_32 = F_88 ( V_131 , V_135 , V_99 , V_136 ) ;
if ( V_32 < 0 )
return V_32 ;
V_32 = V_11 -> V_134 ( V_131 , V_50 ) ;
if ( V_32 < 0 )
return V_32 ;
if ( ! V_131 [ V_137 ] )
return 0 ;
return F_87 ( V_131 [ V_137 ] , V_13 , V_50 ) ;
}
static int
...
V_32 = F_89 ( V_130 , V_13 , & V_50 , V_11 ) ;
if ( V_32 < 0 )
return V_32 ;
