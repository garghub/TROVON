...
static void
F_170 ( struct V_6 * V_14 , struct V_321 * V_322 )
{
...
void F_171 ( struct V_6 * V_14 , unsigned int V_205 ,
unsigned int V_342 )
{
...
static void
F_172 ( struct V_6 * V_14 , unsigned int V_205 ,
unsigned int V_342 )
{
if ( V_14 -> V_343 )
V_14 -> V_343 ( V_14 , V_205 , V_342 ) ;
else
F_171 ( V_14 , V_205 , V_342 ) ;
}
static unsigned int F_173 ( struct V_1 * V_344 )
{
if ( V_344 -> V_14 . V_345 )
return V_344 -> V_14 . V_345 ;
if ( V_344 -> V_14 . V_19 == V_25 ) {
if ( V_344 -> V_14 . type == V_346 )
return 0x100 ;
return 0x1000 ;
}
if ( F_174 ( V_344 ) )
return 0x16 << V_344 -> V_14 . V_12 ;
return 8 << V_344 -> V_14 . V_12 ;
}
static int F_175 ( struct V_1 * V_2 )
{
unsigned int V_347 = F_173 ( V_2 ) ;
struct V_6 * V_14 = & V_2 -> V_14 ;
int V_233 = 0 ;
switch ( V_14 -> V_19 ) {
case V_25 :
...
if ( ! V_14 -> V_138 )
break;
if ( ! F_176 ( V_14 -> V_138 , V_347 , L_24 ) ) {
V_233 = - V_349 ;
break;
}
if ( V_14 -> V_43 & V_350 ) {
V_14 -> V_11 = F_177 ( V_14 -> V_138 , V_347 ) ;
if ( ! V_14 -> V_11 ) {
F_178 ( V_14 -> V_138 , V_347 ) ;
V_233 = - V_52 ;
}
}
break;
...
case V_20 :
case V_351 :
F_182 ( V_14 -> V_16 , V_347 ) ;
break;
}
}
static void F_183 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
F_180 ( V_2 ) ;
}
static int F_184 ( struct V_6 * V_14 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
return F_175 ( V_2 ) ;
}
...
{
const struct V_352 * V_353 = & V_147 [ V_2 -> V_14 . type ] ;
unsigned char V_354 ;
V_354 = V_353 -> V_355 [ F_186 ( V_2 -> V_46 ) ] ;
return V_354 ? V_354 : - V_356 ;
}
static int F_187 ( struct V_1 * V_2 , unsigned char V_354 )
{
const struct V_352 * V_353 = & V_147 [ V_2 -> V_14 . type ] ;
int V_357 ;
if ( ! V_353 -> V_355 [ F_186 ( V_358 ) ] )
return - V_356 ;
for ( V_357 = 1 ; V_357 < V_359 ; V_357 ++ ) {
if ( V_354 < V_353 -> V_355 [ V_357 ] )
return ( -- V_357 ) << V_360 ;
}
return V_361 ;
}
static int F_188 ( struct V_362 * V_14 )
{
struct V_363 * V_205 = F_189 ( V_14 , struct V_363 , V_14 ) ;
struct V_6 * V_364 = V_205 -> V_6 ;
struct V_1 * V_2 = F_35 ( V_364 ) ;
if ( ! ( V_2 -> V_35 & V_36 ) || V_364 -> V_146 <= 1 )
return - V_365 ;
return F_185 ( V_2 ) ;
}
static int F_190 ( struct V_362 * V_14 )
{
int V_355 ;
F_191 ( & V_14 -> V_366 ) ;
V_355 = F_188 ( V_14 ) ;
...
static T_2 F_193 ( struct V_367 * V_48 ,
struct V_368 * V_369 , char * V_210 )
{
struct V_362 * V_14 = F_194 ( V_48 ) ;
int V_355 ;
V_355 = F_190 ( V_14 ) ;
if ( V_355 < 0 )
return V_355 ;
return snprintf ( V_210 , V_370 , L_25 , V_355 ) ;
}
static int F_195 ( struct V_362 * V_14 , unsigned char V_354 )
{
struct V_363 * V_205 = F_189 ( V_14 , struct V_363 , V_14 ) ;
struct V_6 * V_364 = V_205 -> V_6 ;
struct V_1 * V_2 = F_35 ( V_364 ) ;
...
V_2 -> V_314 )
return - V_365 ;
V_371 = F_187 ( V_2 , V_354 ) ;
if ( V_371 < 0 )
return V_371 ;
F_40 ( V_2 ) ;
V_2 -> V_46 &= ~ V_324 ;
V_2 -> V_46 |= ( unsigned char ) V_371 ;
F_4 ( V_2 , V_37 , V_2 -> V_46 ) ;
return 0 ;
}
static int F_196 ( struct V_362 * V_14 , unsigned char V_354 )
{
int V_233 ;
F_191 ( & V_14 -> V_366 ) ;
V_233 = F_195 ( V_14 , V_354 ) ;
F_192 ( & V_14 -> V_366 ) ;
return V_233 ;
}
static T_2 F_197 ( struct V_367 * V_48 ,
struct V_368 * V_369 , const char * V_210 , T_3 V_88 )
{
struct V_362 * V_14 = F_194 ( V_48 ) ;
unsigned char V_354 ;
int V_233 ;
if ( ! V_88 )
return - V_365 ;
V_233 = F_198 ( V_210 , 10 , & V_354 ) ;
if ( V_233 < 0 )
return V_233 ;
V_233 = F_196 ( V_14 , V_354 ) ;
if ( V_233 < 0 )
return V_233 ;
return V_88 ;
}
...
const struct V_352 * V_353 = & V_147 [ V_2 -> V_14 . type ] ;
if ( V_353 -> V_355 [ 0 ] )
V_2 -> V_14 . V_372 = & V_373 ;
}
static void F_200 ( struct V_6 * V_14 , int V_43 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
int V_233 ;
V_233 = F_175 ( V_2 ) ;
...
static int
F_201 ( struct V_6 * V_14 , struct V_377 * V_378 )
{
if ( V_378 -> V_156 >= V_379 || V_378 -> V_156 < 0 ||
V_378 -> V_380 < 9600 || V_378 -> type < V_142 ||
V_378 -> type >= F_6 ( V_147 ) || V_378 -> type == V_381 ||
V_378 -> type == V_382 )
return - V_365 ;
return 0 ;
}
static const char * F_202 ( struct V_6 * V_14 )
{
int type = V_14 -> type ;
if ( type >= F_6 ( V_147 ) )
type = 0 ;
...
if ( V_2 -> V_174 ) {
if ( ! V_2 -> V_174 -> V_175 )
V_2 -> V_174 -> V_175 = V_385 ;
if ( ! V_2 -> V_174 -> V_230 )
V_2 -> V_174 -> V_230 = V_386 ;
}
}
static void F_206 ( struct V_6 * V_14 , int V_186 )
{
struct V_1 * V_2 = F_35 ( V_14 ) ;
F_138 ( V_2 , V_179 ) ;
...
struct V_321 V_322 ;
unsigned int V_295 , V_124 , V_296 = 0 ;
V_322 . V_299 = V_14 -> V_387 -> V_388 ;
if ( V_14 -> V_205 -> V_14 . V_389 && V_322 . V_299 == 0 )
V_322 . V_299 = V_14 -> V_205 -> V_14 . V_389 -> V_322 . V_299 ;
...
void F_208 ( struct V_1 * V_2 , const char * V_390 ,
unsigned int V_88 )
{
struct V_6 * V_14 = & V_2 -> V_14 ;
unsigned long V_43 ;
...
F_94 ( V_14 , V_72 , 0 ) ;
if ( V_2 -> V_394 && ( V_2 -> V_394 != F_129 ( V_14 , V_30 ) ) ) {
F_207 ( V_2 ) ;
V_2 -> V_394 = 0 ;
}
F_210 ( V_14 , V_390 , V_88 , F_206 ) ;
F_138 ( V_2 , V_172 ) ;
F_94 ( V_14 , V_72 , V_161 ) ;
if ( V_2 -> V_216 )
F_122 ( V_2 ) ;
...
static unsigned int F_211 ( struct V_6 * V_14 )
{
unsigned char V_61 , V_395 , V_396 ;
unsigned int V_124 ;
V_61 = F_129 ( V_14 , V_29 ) ;
F_94 ( V_14 , V_29 , V_61 | V_320 ) ;
V_395 = F_129 ( V_14 , V_3 ) ;
V_396 = F_129 ( V_14 , V_4 ) ;
F_94 ( V_14 , V_29 , V_61 ) ;
V_124 = ( V_396 << 8 ) | V_395 ;
return ( V_14 -> V_78 / 16 ) / V_124 ;
}
int F_212 ( struct V_6 * V_14 , char * V_397 , bool V_144 )
{
int V_295 = 9600 ;
int V_255 = 8 ;
int V_196 = 'n' ;
...
return - V_266 ;
if ( V_397 )
F_213 ( V_397 , & V_295 , & V_196 , & V_255 , & V_398 ) ;
else if ( V_144 )
V_295 = F_211 ( V_14 ) ;
return F_214 ( V_14 , V_14 -> V_387 , V_295 , V_196 , V_255 , V_398 ) ;
}
