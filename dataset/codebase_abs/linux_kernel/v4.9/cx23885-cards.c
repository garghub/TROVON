...
const T_3 V_113 = F_24 ( V_100 ) ;
static struct V_99 V_114 [] = {
{
. V_101 = V_102 ,
. V_103 = V_104 ,
. V_105 = V_106 ,
...
if ( V_118 )
break;
V_2 -> V_119 = F_26 ( V_2 , V_120 ) ;
F_27 ( V_2 -> V_121 , V_122 , V_123 ,
V_115 , V_114 ) ;
break;
case V_80 :
case V_81 :
...
F_27 ( V_2 -> V_121 , V_122 , V_123 ,
V_113 , V_100 ) ;
F_27 ( V_2 -> V_119 , V_124 , V_125 , & V_117 ) ;
V_117 . V_126 = false ;
V_117 . V_127 = false ;
V_117 . V_128 = true ;
F_27 ( V_2 -> V_119 , V_124 , V_129 , & V_117 ) ;
V_117 . V_127 = true ;
F_27 ( V_2 -> V_119 , V_124 , V_129 , & V_117 ) ;
break;
case V_130 :
...
static int F_32 ( void * V_137 , int V_138 , int V_139 , int V_140 )
{
int V_141 ;
int V_142 = 0 ;
struct V_1 * V_2 = (struct V_1 * ) V_137 ;
V_141 = ( ( F_33 ( V_24 ) ) & ( ~ 0x00000002 ) ) ;
V_141 |= ( V_138 ? 0x00020002 : 0x00020000 ) ;
F_22 ( V_24 , V_141 ) ;
V_141 = ( ( F_33 ( V_63 ) ) & ( ~ 0x0000a000 ) ) ;
V_141 |= ( V_139 ? 0x00008000 : 0 ) ;
F_22 ( V_63 , V_141 ) ;
if ( V_140 )
V_142 = ( V_141 & 0x00004000 ) ? 1 : 0 ;
F_22 ( V_63 , V_141 | 0x00002000 ) ;
F_34 ( 1 ) ;
F_22 ( V_63 , V_141 ) ;
return V_142 ;
}
...
{
struct V_29 * V_143 = & V_2 -> V_143 ;
struct V_29 * V_144 = & V_2 -> V_144 ;
static T_1 V_145 [ 256 ] ;
if ( V_2 -> V_17 [ 0 ] . V_146 == 0 ) {
V_2 -> V_17 [ 0 ] . V_18 . V_147 = 0xa0 >> 1 ;
...
case V_97 :
case V_98 :
V_2 -> V_121 = F_39 ( & V_2 -> V_160 ,
& V_2 -> V_17 [ 2 ] . V_161 ,
L_19 , 0x88 >> 1 , NULL ) ;
if ( V_2 -> V_121 ) {
V_2 -> V_121 -> V_162 = V_133 ;
F_27 ( V_2 -> V_121 , V_122 , V_163 ) ;
}
break;
}
switch ( V_2 -> V_14 ) {
...
F_2 ( V_7 L_24 ,
V_169 . V_174 , V_166 ) ;
V_118 = F_42 ( & V_165 , V_166 , & V_2 -> V_4 -> V_2 ) ;
if ( V_118 != 0 )
F_2 ( V_34 L_25
L_26
L_27 , V_166 ) ;
