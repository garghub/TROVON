...
V_53 = ( V_34 -> V_34 & V_54 ) >>
V_55 ;
if ( V_53 >= F_24 ( & V_32 -> V_1 -> V_56 ) )
return - V_7 ;
V_52 -> V_57 = F_25 ( V_32 -> V_1 , V_53 ) ;
V_52 -> V_3 = V_34 -> V_34 & V_58 ;
return 0 ;
}
static void F_26 ( struct V_1 * V_1 , int V_59 )
{
struct V_60 * V_61 ;
for (; V_59 >= 0 ; V_59 -- ) {
V_61 = F_25 ( V_1 , V_59 ) ;
...
if ( F_9 ( V_64 , V_37 ) )
return - V_38 ;
return F_31 ( V_32 , V_34 , & V_64 , true ) ;
}
}
return - V_39 ;
}
...
T_4 T_3 * V_37 = ( T_4 T_3 * ) ( long ) V_34 -> V_3 ;
T_4 V_64 = 0 ;
V_42 = F_31 ( V_32 , V_34 , & V_64 , false ) ;
if ( V_42 )
return V_42 ;
