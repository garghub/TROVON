...
V_20 = F_21 ( V_43 , V_42 ) ;
if ( V_20 == 0 )
V_43 -> V_44 = V_42 -> V_45 ? V_40 -> V_46 : NULL ;
return V_20 ;
}
...
int V_20 = 0 ;
unsigned int V_49 ;
V_43 = F_3 ( V_3 , V_48 -> type ) ;
V_20 = F_23 ( V_43 , V_48 ) ;
if ( V_48 -> V_50 == V_51 && ! F_2 ( V_43 -> type ) ) {
if ( F_24 ( V_43 -> type ) ) {
for ( V_49 = 0 ; V_49 < V_48 -> V_52 ; ++ V_49 )
V_48 -> V_53 . V_54 [ V_49 ] . V_53 . V_55
+= V_56 ;
} else {
V_48 -> V_53 . V_57 += V_56 ;
}
...
struct V_7 * V_43 ;
V_43 = F_3 ( V_3 , V_48 -> type ) ;
return F_28 ( V_43 , V_48 , V_40 -> V_58 & V_59 ) ;
}
...
{
struct V_7 * V_43 ;
V_43 = F_3 ( V_3 , V_64 -> type ) ;
return F_34 ( V_43 , V_64 ) ;
}
...
int F_37 ( struct V_40 * V_40 , struct V_2 * V_3 ,
enum V_4 type )
{
struct V_18 * V_19 ;
struct V_1 * V_8 ;
...
unsigned int F_40 ( struct V_40 * V_40 , struct V_2 * V_3 ,
struct V_65 * V_66 )
{
struct V_67 * V_68 = F_41 ( V_40 ) ;
unsigned long V_69 = F_42 ( V_66 ) ;
struct V_7 * V_70 , * V_71 ;
struct V_72 * V_73 = NULL , * V_74 = NULL ;
unsigned int V_75 = 0 ;
unsigned long V_12 ;
if ( F_43 ( V_76 , & V_68 -> V_12 ) ) {
struct V_77 * V_78 = V_40 -> V_46 ;
if ( F_44 ( V_78 ) )
V_75 = V_79 ;
else if ( V_69 & V_79 )
F_45 ( V_40 , & V_78 -> V_66 , V_66 ) ;
if ( ! ( V_69 & ( V_80 | V_81 | V_82 | V_83 ) ) )
return V_75 ;
}
V_70 = F_46 ( V_3 ) ;
V_71 = F_47 ( V_3 ) ;
if ( ( ! V_70 -> V_33 || F_6 ( & V_70 -> V_84 ) )
&& ( ! V_71 -> V_33 || F_6 ( & V_71 -> V_84 ) ) ) {
V_75 |= V_85 ;
goto V_86;
}
F_5 ( & V_70 -> V_87 , V_12 ) ;
if ( F_6 ( & V_70 -> V_88 ) )
F_45 ( V_40 , & V_70 -> V_89 , V_66 ) ;
F_7 ( & V_70 -> V_87 , V_12 ) ;
F_5 ( & V_71 -> V_87 , V_12 ) ;
if ( F_6 ( & V_71 -> V_88 ) ) {
if ( V_71 -> V_90 ) {
F_7 ( & V_71 -> V_87 , V_12 ) ;
return V_75 | V_82 | V_83 ;
}
F_45 ( V_40 , & V_71 -> V_89 , V_66 ) ;
}
F_7 ( & V_71 -> V_87 , V_12 ) ;
F_5 ( & V_70 -> V_87 , V_12 ) ;
if ( ! F_6 ( & V_70 -> V_88 ) )
V_73 = F_8 ( & V_70 -> V_88 , struct V_72 ,
V_91 ) ;
if ( V_73 && ( V_73 -> V_92 == V_93
|| V_73 -> V_92 == V_94 ) )
V_75 |= V_80 | V_81 ;
F_7 ( & V_70 -> V_87 , V_12 ) ;
F_5 ( & V_71 -> V_87 , V_12 ) ;
if ( ! F_6 ( & V_71 -> V_88 ) )
V_74 = F_8 ( & V_71 -> V_88 , struct V_72 ,
V_91 ) ;
if ( V_74 && ( V_74 -> V_92 == V_93
|| V_74 -> V_92 == V_94 ) )
V_75 |= V_82 | V_83 ;
F_7 ( & V_71 -> V_87 , V_12 ) ;
V_86:
...
struct V_95 * V_96 )
{
unsigned long V_57 = V_96 -> V_97 << V_98 ;
struct V_7 * V_43 ;
if ( V_57 < V_56 ) {
V_43 = F_46 ( V_3 ) ;
} else {
...
if ( V_20 )
goto V_106;
if ( V_5 -> V_9 . V_107 == V_6 -> V_9 . V_107 )
V_3 -> V_108 = V_5 -> V_9 . V_107 ;
return V_3 ;
V_106:
F_56 ( V_3 ) ;
return F_52 ( V_20 ) ;
...
struct V_109 * V_110 )
{
struct V_10 * V_11 = F_63 ( V_110 ,
struct V_10 , V_16 ) ;
struct V_1 * V_8 ;
unsigned long V_12 ;
V_8 = F_1 ( V_3 , V_110 -> V_111 . V_7 -> type ) ;
if ( ! V_8 )
return;
F_5 ( & V_8 -> V_13 , V_12 ) ;
...
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_20 ( V_40 , V_78 -> V_3 , V_112 ) ;
}
int F_65 ( struct V_40 * V_40 , void * V_23 ,
struct V_60 * V_61 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_31 ( V_40 , V_78 -> V_3 , V_61 ) ;
}
int F_66 ( struct V_40 * V_40 , void * V_23 ,
struct V_47 * V_48 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_22 ( V_40 , V_78 -> V_3 , V_48 ) ;
}
int F_67 ( struct V_40 * V_40 , void * V_23 ,
struct V_47 * V_48 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_25 ( V_40 , V_78 -> V_3 , V_48 ) ;
}
int F_68 ( struct V_40 * V_40 , void * V_23 ,
struct V_47 * V_48 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_27 ( V_40 , V_78 -> V_3 , V_48 ) ;
}
int F_69 ( struct V_40 * V_40 , void * V_23 ,
struct V_47 * V_48 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_29 ( V_40 , V_78 -> V_3 , V_48 ) ;
}
int F_70 ( struct V_40 * V_40 , void * V_23 ,
struct V_63 * V_64 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_33 ( V_40 , V_78 -> V_3 , V_64 ) ;
}
int F_71 ( struct V_40 * V_40 , void * V_23 ,
enum V_4 type )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_35 ( V_40 , V_78 -> V_3 , type ) ;
}
int F_72 ( struct V_40 * V_40 , void * V_23 ,
enum V_4 type )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_37 ( V_40 , V_78 -> V_3 , type ) ;
}
int F_73 ( struct V_40 * V_40 , struct V_95 * V_96 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
return F_48 ( V_40 , V_78 -> V_3 , V_96 ) ;
}
unsigned int F_74 ( struct V_40 * V_40 , T_1 * V_66 )
{
struct V_77 * V_78 = V_40 -> V_46 ;
