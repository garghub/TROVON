...
int V_116 = F_79 () ;
int V_117 = type - 1 ;
struct V_107 * V_110 = & V_109 [ V_117 ] . V_110 ;
T_8 * V_111 = & V_109 [ V_117 ] . V_111 ;
T_9 * V_112 = & V_109 [ V_117 ] . V_112 ;
T_10 * V_113 = & V_109 [ V_117 ] . V_113 ;
int * V_115 = & V_109 [ V_117 ] . V_115 ;
V_118:
F_80 ( V_111 ) ;
if ( ! F_81 ( V_110 ) ) {
V_108 = V_110 -> V_86 ;
...
F_85 ( V_119 ) ;
F_83 ( V_111 ) ;
F_86 ( V_113 , & V_119 , V_120 ) ;
if ( F_84 ( V_112 ) > V_116 && ! * V_115 )
F_87 () ;
F_88 ( V_113 , & V_119 ) ;
goto V_118;
}
...
static int F_16 ( int type , struct V_19 * * V_129 ,
...
int V_18 ;
V_108 = F_78 ( type ) ;
V_18 = V_114 [ type - 1 ] -> F_99 ( V_108 , V_129 ,
V_17 ,
V_50 , V_130 , V_131 ) ;
F_93 ( type , V_108 ) ;
return V_18 ;
}
int F_100 ( int type , unsigned char * V_132 , struct V_19 * V_133 ,
unsigned long V_134 , T_6 V_131 , T_6 V_135 )
{
struct V_107 * V_108 ;
int V_18 ;
V_108 = F_78 ( type ) ;
V_18 = V_114 [ type - 1 ] -> F_101 ( V_108 , V_132 ,
V_133 , V_134 ,
V_131 , V_135 ) ;
F_93 ( type , V_108 ) ;
return V_18 ;
...
int F_103 ( char * V_136 , unsigned long V_137 ,
unsigned long V_127 , T_2 V_17 ,
struct V_49 * V_50 , int V_130 ,
unsigned long * V_63 ,
unsigned long * V_138 )
{
unsigned long V_139 ;
unsigned long V_140 ;
unsigned long V_134 ;
unsigned long V_141 = V_127 - V_137 ;
unsigned long V_142 ;
char * V_21 ;
struct V_19 * V_143 = V_50 [ * V_63 ] . V_51 ;
V_134 = F_46 ( V_143 ) - V_17 ;
if ( V_127 <= V_134 )
return 1 ;
if ( V_127 > V_134 && V_137 < V_134 ) {
V_139 = V_134 - V_137 ;
V_141 -= V_139 ;
} else {
V_139 = 0 ;
...
V_140 = V_137 ;
while ( V_141 > 0 ) {
V_142 = F_104 ( V_29 - * V_138 ,
V_29 - V_139 ) ;
V_142 = F_104 ( V_142 , V_141 ) ;
V_21 = F_8 ( V_143 ) ;
memcpy ( V_21 + * V_138 , V_136 + V_139 , V_142 ) ;
F_11 ( V_21 ) ;
F_63 ( V_143 ) ;
* V_138 += V_142 ;
V_139 += V_142 ;
...
void F_105 ( struct V_49 * V_50 , int V_130 ,
unsigned long V_63 ,
unsigned long V_138 )
{
while ( V_63 < V_130 ) {
struct V_19 * V_19 = V_50 [ V_63 ] . V_51 ;
unsigned long V_144 = V_50 [ V_63 ] . V_145 ;
unsigned long V_54 = V_50 [ V_63 ] . V_146 ;
if ( V_138 < V_144 )
V_138 = V_144 ;
if ( V_138 < V_144 + V_54 ) {
unsigned long V_142 = V_144 + V_54 - V_138 ;
char * V_21 ;
V_21 = F_8 ( V_19 ) ;
memset ( V_21 + V_138 , 0 , V_142 ) ;
F_11 ( V_21 ) ;
}
V_63 ++ ;
V_138 = 0 ;
