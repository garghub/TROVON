...
static int F_54 ( struct V_233 * V_15 )
{
int V_73 = 0 ;
struct V_75 * V_76 ;
for ( V_73 = 0 ; V_73 < F_55 ( V_234 ) ; V_73 ++ ) {
...
int F_58 ( struct V_154 * V_155 , int V_241 , int V_102 )
{
struct V_1 * V_2 = F_43 ( V_155 ) ;
struct V_121 * V_70 ;
...
struct V_84 * V_85 = V_70 -> V_123 ;
int V_19 = 0 ;
V_251 = F_56 ( V_62 -> V_15 , sizeof( * V_251 ) , V_78 ) ;
if ( ! V_251 )
return - V_79 ;
if ( type == V_252 ) {
...
V_95 -> V_70 = V_70 ;
V_251 -> V_88 = V_88 ;
F_62 ( & V_251 -> V_253 , & V_85 -> V_254 ) ;
} else if ( type == V_255 ) {
struct V_75 * V_76 = ( void * ) V_88 -> V_49 ;
V_76 -> V_70 = V_70 ;
V_251 -> V_88 = V_88 ;
F_62 ( & V_251 -> V_253 , & V_85 -> V_256 ) ;
} else {
F_2 ( V_62 -> V_15 , L_40 ,
type , V_88 -> V_72 . V_57 ) ;
V_19 = - V_16 ;
...
V_19 = F_61 ( V_88 , V_70 , V_252 ) ;
else if ( strstr ( V_88 -> V_72 . V_57 , L_42 ) )
V_19 = F_61 ( V_88 , V_70 , V_255 ) ;
...
static void F_66 ( struct V_257 * V_258 ,
struct V_84 * V_85 )
{
struct V_121 * V_70 ;
...
static int F_67 ( struct V_257 * V_258 )
{
struct V_121 * V_70 ;
int V_19 = 0 ;
F_23 (w, &platform->component.card->widgets, list) {
...
int F_69 ( struct V_257 * V_258 )
{
int V_73 , V_19 = 0 ;
struct V_266 * V_122 =
F_70 ( & V_258 -> V_90 ) ;
struct V_1 * V_2 = F_71 ( V_258 ) ;
unsigned int V_267 = F_55 ( V_268 ) / 3 ;
V_2 -> V_11 = F_56 ( V_258 -> V_15 ,
V_13 , V_78 ) ;
if ( ! V_2 -> V_11 )
return - V_79 ;
F_72 ( V_122 , V_269 ,
...
V_19 = F_75 ( V_258 , V_268 ,
F_55 ( V_268 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_54 ( V_258 -> V_15 ) ;
if ( V_19 )
return V_19 ;
V_19 = F_75 ( V_258 , V_234 ,
F_55 ( V_234 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_75 ( V_258 , V_275 ,
F_55 ( V_275 ) ) ;
if ( V_19 )
return V_19 ;
V_19 = F_67 ( V_258 ) ;
