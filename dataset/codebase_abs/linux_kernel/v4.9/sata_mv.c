...
V_436 = F_197 ( V_126 -> V_162 . V_560 , L_59 ,
& V_86 ) ;
if ( V_436 ) {
F_132 ( & V_126 -> V_162 ,
L_60 , V_436 ) ;
...
V_403 = F_198 ( V_126 -> V_162 . V_560 , 0 ) ;
} else {
V_552 = F_199 ( & V_126 -> V_162 ) ;
V_86 = V_552 -> V_86 ;
V_403 = F_200 ( V_126 , 0 ) ;
}
V_16 = F_201 ( & V_126 -> V_162 , V_553 , V_86 ) ;
...
V_18 -> V_499 = V_516 ;
V_16 -> V_565 = NULL ;
V_18 -> V_6 = F_202 ( & V_126 -> V_162 , V_556 -> V_121 ,
F_203 ( V_556 ) ) ;
V_18 -> V_6 -= V_8 ;
V_18 -> V_562 = F_204 ( & V_126 -> V_162 , NULL ) ;
if ( F_205 ( V_18 -> V_562 ) )
...
V_18 -> V_561 [ V_3 ] = F_204 ( & V_126 -> V_162 , V_566 ) ;
if ( ! F_205 ( V_18 -> V_561 [ V_3 ] ) )
F_207 ( V_18 -> V_561 [ V_3 ] ) ;
sprintf ( V_566 , L_64 , V_3 ) ;
V_18 -> V_563 [ V_3 ] = F_208 ( & V_126 -> V_162 ,
V_566 ) ;
if ( F_205 ( V_18 -> V_563 [ V_3 ] ) ) {
V_436 = F_209 ( V_18 -> V_563 [ V_3 ] ) ;
V_18 -> V_563 [ V_3 ] = NULL ;
if ( V_436 != - V_567 )
...
goto V_120;
if ( V_126 -> V_162 . V_560 &&
F_212 ( V_126 -> V_162 . V_560 ,
L_66 ) )
V_18 -> V_147 |= V_148 ;
V_436 = F_188 ( V_16 ) ;
if ( V_436 )
goto V_120;
F_213 ( & V_126 -> V_162 , L_67 ,
( unsigned ) V_201 , V_16 -> V_86 ) ;
V_436 = F_214 ( V_16 , V_403 , F_135 , V_568 , & V_569 ) ;
if ( ! V_436 )
return 0 ;
V_120:
if ( ! F_205 ( V_18 -> V_562 ) ) {
...
F_216 ( V_18 -> V_561 [ V_3 ] ) ;
}
F_217 ( V_18 -> V_563 [ V_3 ] ) ;
}
return V_436 ;
}
static int F_218 ( struct V_550 * V_126 )
{
struct V_15 * V_16 = F_219 ( V_126 ) ;
struct V_17 * V_18 = V_16 -> V_19 ;
int V_3 ;
F_220 ( V_16 ) ;
if ( ! F_205 ( V_18 -> V_562 ) ) {
...
static int F_221 ( struct V_550 * V_126 , T_8 V_570 )
{
struct V_15 * V_16 = F_219 ( V_126 ) ;
if ( V_16 )
return F_222 ( V_16 , V_570 ) ;
else
return 0 ;
}
static int F_223 ( struct V_550 * V_126 )
{
struct V_15 * V_16 = F_219 ( V_126 ) ;
const struct V_542 * V_543 ;
int V_571 ;
...
{
int V_436 ;
if ( ! F_226 ( & V_126 -> V_162 , F_227 ( 64 ) ) ) {
V_436 = F_228 ( & V_126 -> V_162 , F_227 ( 64 ) ) ;
if ( V_436 ) {
V_436 = F_228 ( & V_126 -> V_162 , F_227 ( 32 ) ) ;
if ( V_436 ) {
F_132 ( & V_126 -> V_162 ,
L_69 ) ;
return V_436 ;
...
V_436 = F_226 ( & V_126 -> V_162 , F_227 ( 32 ) ) ;
if ( V_436 ) {
...
static void F_229 ( struct V_15 * V_16 )
{
struct V_125 * V_126 = F_133 ( V_16 -> V_162 ) ;
struct V_17 * V_18 = V_16 -> V_19 ;
T_3 V_572 ;
const char * V_573 , * V_574 ;
F_230 ( V_126 , V_575 , & V_572 ) ;
if ( V_572 == 0 )
V_573 = L_72 ;
else if ( V_572 == 0x01 )
V_573 = L_73 ;
...
if ( V_436 )
return V_436 ;
V_436 = F_233 ( V_126 , 1 << V_579 , V_336 ) ;
if ( V_436 == - V_580 )
F_234 ( V_126 ) ;
if ( V_436 )
return V_436 ;
V_16 -> V_565 = F_235 ( V_126 ) ;
...
F_236 ( V_21 , V_579 , - 1 , L_81 ) ;
F_236 ( V_21 , V_579 , V_217 , L_82 ) ;
}
V_436 = F_188 ( V_16 ) ;
if ( V_436 )
return V_436 ;
if ( V_581 && F_237 ( V_126 ) == 0 )
V_18 -> V_147 |= V_406 ;
F_37 ( V_126 , 0x68 ) ;
F_229 ( V_16 ) ;
F_238 ( V_126 ) ;
F_239 ( V_126 ) ;
return F_214 ( V_16 , V_126 -> V_403 , F_135 , V_568 ,
F_25 ( V_18 ) ? & V_582 : & V_569 ) ;
}
static int F_240 ( struct V_125 * V_126 )
{
struct V_15 * V_16 = F_241 ( V_126 ) ;
int V_436 ;
V_436 = F_242 ( V_126 ) ;
if ( V_436 )
return V_436 ;
