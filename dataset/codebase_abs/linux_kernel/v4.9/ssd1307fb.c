...
V_14 -> V_104 = F_36 ( V_6 -> V_8 . V_100 ,
L_6 , 0 ) ;
if ( ! F_37 ( V_14 -> V_104 ) ) {
V_7 = - V_38 ;
goto V_105;
}
if ( F_38 ( V_99 , L_7 , & V_14 -> V_21 ) )
V_14 -> V_21 = 96 ;
if ( F_38 ( V_99 , L_8 , & V_14 -> V_22 ) )
V_14 -> V_22 = 16 ;
if ( F_38 ( V_99 , L_9 , & V_14 -> V_88 ) )
V_14 -> V_88 = 1 ;
if ( F_38 ( V_99 , L_10 , & V_14 -> V_70 ) )
V_14 -> V_70 = 0 ;
if ( F_38 ( V_99 , L_11 , & V_14 -> V_75 ) )
V_14 -> V_75 = 2 ;
if ( F_38 ( V_99 , L_12 , & V_14 -> V_76 ) )
V_14 -> V_76 = 2 ;
V_14 -> V_66 = ! F_39 ( V_99 , L_13 ) ;
V_14 -> V_78 = F_39 ( V_99 , L_14 ) ;
V_14 -> V_79 = F_39 ( V_99 , L_15 ) ;
V_14 -> V_55 = F_39 ( V_99 , L_16 ) ;
V_14 -> V_65 = 127 ;
V_14 -> V_81 = V_14 -> V_59 -> V_106 ;
V_14 -> V_72 = V_14 -> V_59 -> V_107 ;
V_14 -> V_73 = V_14 -> V_59 -> V_108 ;
V_103 = V_14 -> V_21 * V_14 -> V_22 / 8 ;
V_15 = ( void * ) F_40 ( V_4 | V_109 ,
F_41 ( V_103 ) ) ;
if ( ! V_15 ) {
F_5 ( & V_6 -> V_8 , L_17 ) ;
V_7 = - V_11 ;
...
V_16 -> V_114 = & V_115 ;
V_16 -> V_36 = V_116 ;
V_16 -> V_36 . V_117 = V_14 -> V_21 / 8 ;
V_16 -> V_118 = V_102 ;
V_16 -> V_119 = V_120 ;
V_16 -> V_119 . V_121 = V_14 -> V_21 ;
V_16 -> V_119 . V_122 = V_14 -> V_21 ;
V_16 -> V_119 . V_123 = V_14 -> V_22 ;
V_16 -> V_119 . V_124 = V_14 -> V_22 ;
V_16 -> V_119 . V_125 . V_126 = 1 ;
V_16 -> V_119 . V_125 . V_127 = 0 ;
V_16 -> V_119 . V_128 . V_126 = 1 ;
V_16 -> V_119 . V_128 . V_127 = 0 ;
V_16 -> V_119 . V_129 . V_126 = 1 ;
V_16 -> V_119 . V_129 . V_127 = 0 ;
V_16 -> V_17 = ( T_2 V_39 T_7 * ) V_15 ;
V_16 -> V_36 . V_130 = F_43 ( V_15 ) ;
V_16 -> V_36 . V_37 = V_103 ;
F_44 ( V_16 ) ;
V_7 = F_45 ( & V_6 -> V_8 , V_14 -> V_104 ,
V_131 ,
L_19 ) ;
if ( V_7 ) {
F_5 ( & V_6 -> V_8 ,
...
snprintf ( V_97 , sizeof( V_97 ) , L_22 , V_16 -> V_99 ) ;
...
V_96 -> V_92 . V_136 = V_137 ;
V_16 -> V_93 = V_96 ;
F_51 ( & V_6 -> V_8 , L_24 , V_16 -> V_99 , V_16 -> V_36 . V_95 , V_103 ) ;
return 0 ;
V_135:
F_52 ( V_16 ) ;
V_133:
...
F_55 ( V_16 ) ;
F_60 ( F_61 ( V_16 -> V_36 . V_130 ) , F_41 ( V_16 -> V_36 . V_37 ) ) ;
F_56 ( V_16 ) ;
return 0 ;
}
