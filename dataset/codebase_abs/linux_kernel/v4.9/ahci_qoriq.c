...
if ( ! V_67 )
return - V_71 ;
V_20 = F_18 ( V_64 , sizeof( * V_20 ) , V_72 ) ;
if ( ! V_20 )
return - V_73 ;
V_20 -> type = (enum V_74 ) V_67 -> V_75 ;
if ( V_20 -> type == V_30 ) {
V_69 = F_19 ( V_61 , V_76 ,
L_3 ) ;
V_20 -> V_42 = F_20 ( V_64 , V_69 ) ;
if ( F_15 ( V_20 -> V_42 ) )
...
static int F_24 ( struct V_33 * V_64 )
{
struct V_80 * V_18 = F_25 ( V_64 ) ;
