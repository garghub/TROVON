...
goto V_147;
V_96 = - V_130 ;
V_2 = F_126 ( sizeof( * V_2 ) + V_146 , V_108 ) ;
if ( ! V_2 )
goto V_147;
...
V_2 -> V_3 = V_4 ;
V_3 = F_39 ( V_41 . V_40 ) -> V_151 & ( V_4 - 1 ) ;
F_29 ( & V_31 ) ;
V_35 -> V_41 = V_41 ;
V_30 = & V_5 [ V_3 ] ;
} else {
...
static int F_133 ( struct V_94 * V_13 , struct V_144 * V_2 ,
int V_154 , int V_44 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
struct V_32 * V_32 = F_36 ( V_14 ) ;
...
static int F_141 ( struct V_94 * V_13 , struct V_144 * V_145 ,
int V_146 , int V_44 )
{
struct V_22 * V_23 = (struct V_22 * ) V_145 ;
struct V_13 * V_14 = V_13 -> V_14 ;
...
static int F_160 ( struct V_94 * V_13 , struct V_144 * V_145 , int * V_184 , int V_19 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
struct V_34 * V_35 ;
F_161 ( struct V_22 * , V_23 , V_145 ) ;
int V_96 = 0 ;
if ( V_19 ) {
V_14 = F_13 ( V_14 ) ;
V_96 = - V_185 ;
...
V_260 = F_229 ( V_14 , V_44 & V_261 , V_227 ) ;
...
F_232 ( V_9 ) ;
V_262 = V_77 -> V_267 ( V_9 , V_250 , V_262 , V_77 ) ;
V_263 = ! F_227 ( V_9 ) ;
F_202 ( V_9 ) ;
if ( V_262 < 0 ) {
if ( V_257 == 0 )
...
{
int V_269 ;
V_269 = F_216 ( V_9 , F_3 ( V_9 ) . V_88 + V_250 ,
V_77 -> V_206 , V_262 ) ;
return V_269 ? : V_262 ;
}
...
F_3 ( V_9 ) . V_88 + V_250 ,
V_77 -> V_270 , V_262 , V_77 -> V_271 ) ;
}
static T_7 F_238 ( struct V_94 * V_13 , T_8 * V_272 ,
struct V_273 * V_270 ,
...
if ( F_130 ( * V_272 ) )
return - V_274 ;
if ( V_13 -> V_275 -> V_276 & V_169 ||
V_44 & V_277 )
V_77 . V_44 = V_220 ;
return F_228 ( & V_77 , false ) ;
}
static int F_239 ( struct V_94 * V_13 , int V_43 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
struct V_13 * V_50 ;
if ( V_43 < V_278 || V_43 > V_279 )
return - V_26 ;
++ V_43 ;
F_14 ( V_14 ) ;
V_14 -> V_78 |= V_43 ;
...
static int F_244 ( struct V_94 * V_13 , unsigned int V_283 , unsigned long V_284 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
long V_282 = 0 ;
int V_96 ;
...
case V_285 :
V_282 = F_242 ( V_14 ) ;
V_96 = F_245 ( V_282 , ( int V_286 * ) V_284 ) ;
break;
case V_287 :
V_282 = F_240 ( V_14 ) ;
if ( V_282 < 0 )
...
static unsigned int F_246 ( struct V_275 * V_275 , struct V_94 * V_13 , T_9 * V_65 )
{
struct V_13 * V_14 = V_13 -> V_14 ;
unsigned int V_289 ;
F_247 ( V_275 , F_43 ( V_14 ) , V_65 ) ;
V_289 = 0 ;
if ( V_14 -> V_69 )
V_289 |= V_290 ;
if ( V_14 -> V_78 == V_79 )
...
V_289 |= V_291 ;
if ( F_50 ( V_14 ) )
V_289 |= V_54 | V_55 | V_56 ;
return V_289 ;
}
static unsigned int F_248 ( struct V_275 * V_275 , struct V_94 * V_13 ,
T_9 * V_65 )
{
struct V_13 * V_14 = V_13 -> V_14 , * V_50 ;
unsigned int V_289 , V_295 ;
F_247 ( V_275 , F_43 ( V_14 ) , V_65 ) ;
V_289 = 0 ;
if ( V_14 -> V_69 || ! F_60 ( & V_14 -> V_296 ) )
V_289 |= V_290 |
( F_63 ( V_14 , V_297 ) ? V_298 : 0 ) ;
if ( V_14 -> V_78 & V_164 )
V_289 |= V_292 | V_293 | V_294 ;
if ( V_14 -> V_78 == V_79 )
V_289 |= V_291 ;
...
static struct V_13 * F_250 ( struct V_301 * V_302 , T_8 * V_303 )
{
unsigned long V_238 = F_251 ( * V_303 ) ;
unsigned long V_304 = F_252 ( * V_303 ) ;
struct V_13 * V_14 ;
unsigned long V_187 = 0 ;
for ( V_14 = F_253 ( & V_5 [ V_304 ] ) ; V_14 ; V_14 = F_254 ( V_14 ) ) {
if ( F_36 ( V_14 ) != F_255 ( V_302 ) )
continue;
if ( ++ V_187 == V_238 )
break;
}
...
static struct V_13 * F_256 ( struct V_301 * V_302 ,
struct V_13 * V_14 ,
T_8 * V_303 )
{
unsigned long V_304 ;
while ( V_14 > (struct V_13 * ) V_305 ) {
V_14 = F_254 ( V_14 ) ;
if ( ! V_14 )
goto V_306;
if ( F_36 ( V_14 ) == F_255 ( V_302 ) )
...
do {
V_14 = F_250 ( V_302 , V_303 ) ;
if ( V_14 )
return V_14 ;
V_306:
V_304 = F_252 ( * V_303 ) + 1 ;
* V_303 = F_257 ( V_304 , 1 ) ;
} while ( V_304 < F_258 ( V_5 ) );
return NULL ;
}
static void * F_259 ( struct V_301 * V_302 , T_8 * V_303 )
__acquires( V_31 )
{
F_29 ( & V_31 ) ;
if ( ! * V_303 )
return V_305 ;
if ( F_252 ( * V_303 ) >= F_258 ( V_5 ) )
return NULL ;
return F_256 ( V_302 , NULL , V_303 ) ;
}
static void * F_260 ( struct V_301 * V_302 , void * V_307 , T_8 * V_303 )
{
++ * V_303 ;
return F_256 ( V_302 , V_307 , V_303 ) ;
}
static void F_261 ( struct V_301 * V_302 , void * V_307 )
__releases( V_31 )
{
F_30 ( & V_31 ) ;
}
static int F_262 ( struct V_301 * V_302 , void * V_307 )
{
if ( V_307 == V_305 )
F_263 ( V_302 , L_4
L_5 ) ;
else {
struct V_13 * V_18 = V_307 ;
struct V_34 * V_35 = F_34 ( V_18 ) ;
F_14 ( V_18 ) ;
F_264 ( V_302 , L_6 ,
V_18 ,
F_51 ( & V_18 -> V_308 ) ,
0 ,
V_18 -> V_58 == V_59 ? V_309 : 0 ,
V_18 -> V_82 ,
V_18 -> V_72 ?
( V_18 -> V_58 == V_171 ? V_174 : V_122 ) :
( V_18 -> V_58 == V_171 ? V_310 : V_311 ) ,
F_265 ( V_18 ) ) ;
if ( V_35 -> V_2 ) {
int V_39 , V_24 ;
F_266 ( V_302 , ' ' ) ;
...
for ( ; V_39 < V_24 ; V_39 ++ )
F_266 ( V_302 , V_35 -> V_2 -> V_36 -> V_29 [ V_39 ] ? :
'@' ) ;
}
F_16 ( V_18 ) ;
F_266 ( V_302 , '\n' ) ;
...
static int F_268 ( struct V_38 * V_38 , struct V_275 * V_275 )
{
return F_269 ( V_38 , V_275 , & V_312 ,
sizeof( struct V_313 ) ) ;
}
static int T_10 F_270 ( struct V_32 * V_32 )
{
int error = - V_130 ;
V_32 -> V_114 . V_115 = 10 ;
if ( F_271 ( V_32 ) )
goto V_100;
#ifdef F_272
if ( ! F_273 ( L_7 , 0 , V_32 -> V_314 , & V_315 ) ) {
F_274 ( V_32 ) ;
goto V_100;
}
#endif
...
static void T_11 F_275 ( struct V_32 * V_32 )
{
F_274 ( V_32 ) ;
F_276 ( L_7 , V_32 -> V_314 ) ;
}
static int T_12 F_277 ( void )
{
int V_52 = - 1 ;
F_188 ( sizeof( struct V_208 ) > F_278 ( struct V_8 , V_316 ) ) ;
V_52 = F_279 ( & V_109 , 1 ) ;
if ( V_52 != 0 ) {
F_280 ( L_8 , V_317 ) ;
goto V_100;
