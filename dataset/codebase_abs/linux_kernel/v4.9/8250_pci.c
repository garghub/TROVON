...
static int F_90 ( struct V_155 * V_11 ,
struct V_156 * V_157 )
{
struct V_2 * V_2 = F_91 ( V_11 -> V_3 ) ;
T_2 V_158 ;
...
F_93 ( V_168 , V_169 + 4 , & V_21 ) ;
F_16 ( & V_168 -> V_3 , L_21 , V_170 , V_27 , V_21 ) ;
V_11 -> V_11 . V_19 = V_24 ;
V_11 -> V_11 . V_21 = V_21 ;
V_11 -> V_11 . V_171 = F_90 ;
V_54 = F_94 ( & V_168 -> V_3 , sizeof( T_2 ) , V_172 ) ;
if ( ! V_54 )
return - V_18 ;
* V_54 = V_27 ;
...
static void F_99 ( struct V_155 * V_44 )
{
struct V_10 * V_177 = F_100 ( V_44 ) ;
F_101 ( V_177 ) ;
}
static unsigned int F_102 ( struct V_155 * V_44 , int V_13 )
{
struct V_10 * V_177 = F_100 ( V_44 ) ;
unsigned int V_122 ;
...
V_11 -> V_11 . V_181 = F_102 ;
V_11 -> V_11 . V_182 = F_99 ;
return F_98 ( V_9 , V_26 , V_11 , V_27 ) ;
}
static int F_104 ( struct V_2 * V_3 )
{
#if F_105 ( V_183 ) || F_105 ( V_184 )
return - V_42 ;
#else
return 0 ;
#endif
...
static inline int F_113 ( T_1 V_212 , T_1 V_186 )
{
return V_212 == V_213 || V_212 == V_186 ;
}
static struct V_214 * F_114 ( struct V_2 * V_3 )
{
struct V_214 * V_215 ;
for ( V_215 = V_216 ; ; V_215 ++ )
if ( F_113 ( V_215 -> V_4 , V_3 -> V_4 ) &&
F_113 ( V_215 -> V_5 , V_3 -> V_5 ) &&
F_113 ( V_215 -> V_217 , V_3 -> V_6 ) &&
F_113 ( V_215 -> V_218 , V_3 -> V_7 ) )
break;
return V_215 ;
}
static inline int F_115 ( struct V_2 * V_3 ,
const struct V_25 * V_26 )
{
if ( V_26 -> V_29 & V_219 )
return 0 ;
...
static int
F_116 ( struct V_2 * V_3 , struct V_25 * V_26 )
{
...
struct V_8 *
F_118 ( struct V_2 * V_3 , const struct V_25 * V_26 )
{
struct V_10 V_231 ;
struct V_8 * V_9 ;
struct V_214 * V_215 ;
...
V_231 . V_11 . V_175 = F_115 ( V_3 , V_26 ) ;
...
static int
F_129 ( struct V_2 * V_3 , const struct V_220 * V_241 )
{
struct V_214 * V_215 ;
struct V_8 * V_9 ;
const struct V_25 * V_26 ;
...
static int F_136 ( struct V_5 * V_3 )
{
struct V_2 * V_168 = F_91 ( V_3 ) ;
struct V_8 * V_9 = F_96 ( V_168 ) ;
if ( V_9 )
F_125 ( V_9 ) ;
return 0 ;
}
static int F_137 ( struct V_5 * V_3 )
{
struct V_2 * V_168 = F_91 ( V_3 ) ;
struct V_8 * V_9 = F_96 ( V_168 ) ;
int V_246 ;
...
static T_5 F_139 ( struct V_2 * V_3 ,
T_6 V_247 )
{
struct V_8 * V_9 = F_96 ( V_3 ) ;
if ( V_247 == V_248 )
