...
int F_30 ( struct V_41 * V_42 , struct V_39 * V_40 )
{
if ( F_28 ( & V_62 ) )
return - V_63 ;
F_31 ( & V_42 -> V_67 , V_40 ) ;
...
int F_38 ( struct V_41 * V_42 , T_7 V_30 ,
...
if ( F_28 ( & V_62 ) )
return - V_63 ;
if ( V_40 && F_39 ( V_27 , V_20 , V_40 , false ) ) {
F_29 ( & V_62 ) ;
return - V_69 ;
}
V_58 = F_17 ( V_30 , V_31 + F_6 ( V_27 , 1024 ) ) ;
if ( V_58 == V_65 || V_58 == V_37 )
V_58 = V_35 -> V_68 ( V_27 , & V_20 ,
V_30 , V_31 , V_21 ) ;
F_29 ( & V_62 ) ;
return F_36 ( V_58 ) ;
}
static int
F_40 ( T_1 * V_27 , T_5 V_20 ,
...
int F_42 ( T_1 * V_27 , T_5 V_20 , T_7 V_30 ,
...
V_58 = V_35 -> V_68 ( V_27 , & V_20 , V_30 , V_31 , V_21 ) ;
F_29 ( & V_62 ) ;
return F_36 ( V_58 ) ;
}
struct V_41 * F_39 ( T_1 * V_27 , T_5 V_75 ,
...
int F_43 ( struct V_41 * V_42 , unsigned long * V_31 )
{
const struct V_32 * V_35 = V_34 -> V_35 ;
T_6 V_58 ;
* V_31 = 0 ;
...
int F_44 ( struct V_41 * V_42 , T_7 * V_30 ,
...
int F_45 ( struct V_41 * V_42 , T_7 * V_30 ,
unsigned long * V_31 , void * V_21 )
{
const struct V_32 * V_35 = V_34 -> V_35 ;
T_6 V_58 ;
...
int F_46 ( struct V_41 * V_42 , T_7 V_30 ,
...
int F_49 ( int (* F_27)( struct V_41 * , void * ) ,
...
int F_51 ( int (* F_27)( struct V_41 * , void * ) ,
struct V_39 * V_40 , void * V_21 )
{
int V_59 = 0 ;
V_59 = F_47 () ;
if ( V_59 )
return V_59 ;
V_59 = F_49 ( F_27 , V_40 , V_21 , NULL ) ;
F_48 () ;
return V_59 ;
}
struct V_84 * F_52 ( void )
{
if ( ! V_34 )
return NULL ;
return V_34 -> V_84 ;
