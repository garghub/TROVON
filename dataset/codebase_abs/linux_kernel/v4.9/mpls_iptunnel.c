...
static int F_34 ( struct V_46 * V_65 , struct V_46 * V_66 )
{
struct V_1 * V_67 = F_10 ( V_65 ) ;
struct V_1 * V_68 = F_10 ( V_66 ) ;
int V_69 ;
if ( V_67 -> V_3 != V_68 -> V_3 )
return 1 ;
for ( V_69 = 0 ; V_69 < V_57 ; V_69 ++ )
if ( V_67 -> V_35 [ V_69 ] != V_68 -> V_35 [ V_69 ] )
return 1 ;
return 0 ;
}
static int T_1 F_35 ( void )
{
return F_36 ( & V_70 , V_59 ) ;
}
