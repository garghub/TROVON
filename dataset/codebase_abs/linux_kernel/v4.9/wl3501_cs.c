...
static int F_20 ( struct V_18 * V_19 , T_1 V_53 , void * V_54 )
{
struct V_55 V_50 = {
. V_56 = V_57 ,
. V_58 = V_53 ,
...
static int F_23 ( struct V_18 * V_19 , T_1 V_53 ,
void * V_54 , int V_33 )
{
int V_4 ;
V_4 = F_20 ( V_19 , V_53 , V_54 ) ;
if ( V_4 )
return V_4 ;
V_4 = F_24 ( V_19 -> V_63 ,
V_19 -> V_61 . V_62 != 255 ) ;
if ( V_4 )
return V_4 ;
memcpy ( V_54 , V_19 -> V_61 . V_64 , V_33 ) ;
return 0 ;
}
static int F_25 ( struct V_18 * V_19 , int V_65 )
{
struct V_66 V_50 = {
. V_56 = V_67 ,
. V_68 = V_65 ,
...
static int F_27 ( struct V_18 * V_19 , T_1 * V_15 , T_2 V_14 )
{
...
static inline int F_31 ( struct V_18 * V_19 )
{
return V_19 -> V_88 == V_89 ? V_92 :
V_93 ;
}
static int F_32 ( struct V_18 * V_19 , T_2 V_94 )
{
struct V_95 V_50 = {
. V_56 = V_96 ,
. V_97 = V_98 ,
...
static int F_33 ( struct V_18 * V_19 , T_2 V_105 )
{
struct V_106 V_50 = {
. V_56 = V_107 ,
. V_108 = 10 ,
...
static void F_35 ( struct V_18 * V_19 , T_2 V_131 )
{
T_2 V_3 = 0 ;
int V_132 = 0 ;
struct V_133 V_50 ;
...
if ( F_37 ( V_19 -> V_113 [ V_3 ] . V_137 , V_50 . V_137 ) ) {
V_132 = 0 ;
break;
}
}
...
static T_2 F_40 ( struct V_18 * V_19 , T_1 * V_54 , T_2 V_33 )
{
T_2 V_148 , V_149 ;
T_1 * V_15 = V_54 + 12 ;
V_33 -= 12 ;
...
static void F_49 ( struct V_155 * V_156 , T_2 V_131 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
struct V_166 V_50 ;
F_36 ( L_4 ) ;
...
static inline void F_54 ( struct V_155 * V_156 ,
...
F_13 ( V_19 ,
V_50 . V_15 + F_28 ( struct V_152 , V_138 ) ,
& V_138 , sizeof( V_138 ) ) ;
V_19 -> V_138 = V_138 <= 63 ? ( V_138 * 100 ) / 64 : 255 ;
F_13 ( V_19 ,
V_50 . V_15 +
F_28 ( struct V_152 , V_83 ) ,
& V_83 , sizeof( V_83 ) ) ;
...
V_170 -> V_156 = V_156 ;
F_56 ( V_170 , 2 ) ;
F_57 ( V_170 , ( unsigned char * ) & V_50 . V_82 , 12 ) ;
F_40 ( V_19 , V_170 -> V_15 , V_171 ) ;
F_58 ( V_170 , V_171 ) ;
V_170 -> V_175 = F_59 ( V_170 , V_156 ) ;
V_156 -> V_173 . V_176 ++ ;
V_156 -> V_173 . V_177 += V_170 -> V_14 ;
F_60 ( V_170 ) ;
}
}
static inline void F_61 ( struct V_18 * V_19 ,
...
static inline void F_65 ( struct V_155 * V_156 )
{
int V_181 ;
T_2 V_131 ;
T_1 V_56 ;
...
T_1 V_46 = 0 ;
int V_3 , V_4 = 0 ;
F_71 ( V_199 , V_19 -> V_21 + V_143 ) ;
F_71 ( 0 , V_19 -> V_21 + V_143 ) ;
F_71 ( V_199 , V_19 -> V_21 + V_143 ) ;
...
static T_4 F_78 ( struct V_169 * V_170 ,
struct V_155 * V_156 )
{
int V_212 , V_4 ;
struct V_18 * V_19 = F_44 ( V_156 ) ;
...
F_21 ( & V_19 -> V_60 , V_59 ) ;
V_212 = F_38 ( V_19 ) ;
V_4 = F_27 ( V_19 , V_170 -> V_15 , V_170 -> V_14 ) ;
if ( V_212 )
F_39 ( V_19 ) ;
if ( V_4 ) {
++ V_156 -> V_173 . V_213 ;
...
static int F_80 ( struct V_155 * V_156 )
{
int V_4 = - V_200 ;
struct V_18 * V_19 = F_44 ( V_156 ) ;
unsigned long V_59 ;
...
return V_4 ;
V_201:
F_26 ( V_172 L_22 , V_156 -> V_157 ) ;
goto V_42;
}
static struct V_217 * F_83 ( struct V_155 * V_156 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
struct V_217 * V_218 = & V_19 -> V_218 ;
T_5 V_13 ;
memset ( V_218 , 0 , sizeof( * V_218 ) ) ;
V_218 -> V_72 = F_84 ( V_156 ) ;
if ( ! F_23 ( V_19 , V_219 ,
& V_13 , sizeof( V_13 ) ) )
V_218 -> V_220 . V_221 += V_13 ;
if ( ! F_23 ( V_19 , V_222 ,
& V_13 , sizeof( V_13 ) ) )
V_218 -> V_220 . V_221 += V_13 ;
if ( ! F_23 ( V_19 , V_223 ,
...
if ( ! F_23 ( V_19 , V_224 ,
& V_13 , sizeof( V_13 ) ) )
V_218 -> V_220 . V_225 = V_13 ;
if ( ! F_23 ( V_19 , V_226 ,
& V_13 , sizeof( V_13 ) ) )
V_218 -> V_220 . V_227 += V_13 ;
if ( ! F_23 ( V_19 , V_228 ,
& V_13 , sizeof( V_13 ) ) )
V_218 -> V_220 . V_227 += V_13 ;
if ( ! F_23 ( V_19 , V_229 ,
...
{
struct V_155 * V_156 = V_206 -> V_231 ;
while ( V_206 -> V_208 > 0 )
F_73 ( V_156 ) ;
F_86 ( V_156 ) ;
F_87 ( V_206 ) ;
...
static int F_90 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
F_91 ( V_235 -> V_157 , L_23 , sizeof( V_235 -> V_157 ) ) ;
return 0 ;
}
static int F_92 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
int V_2 = V_235 -> V_237 . V_238 ;
int V_4 = - V_239 ;
if ( F_1 ( V_19 -> V_1 , V_2 ) ) {
V_19 -> V_111 = V_2 ;
V_4 = F_74 ( V_156 ) ;
...
static int F_93 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
V_235 -> V_237 . V_238 = 100000 *
F_94 ( V_19 -> V_111 , V_240 ) ;
V_235 -> V_237 . V_241 = 1 ;
return 0 ;
}
static int F_95 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
int V_4 = - V_239 ;
if ( V_235 -> V_242 == V_89 ||
...
V_235 -> V_242 == V_136 ) {
struct V_18 * V_19 = F_44 ( V_156 ) ;
V_19 -> V_88 = V_235 -> V_242 ;
V_4 = F_74 ( V_156 ) ;
}
return V_4 ;
}
static int F_96 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
V_235 -> V_242 = V_19 -> V_88 ;
return 0 ;
}
static int F_97 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
V_235 -> V_243 . V_13 = V_19 -> V_138 ;
V_235 -> V_243 . V_244 = ! V_235 -> V_243 . V_13 ;
V_235 -> V_243 . V_245 = 1 ;
return 0 ;
}
...
union V_234 * V_235 , char * V_236 )
{
struct V_246 * V_247 = (struct V_246 * ) V_236 ;
V_235 -> V_15 . V_248 = sizeof( * V_247 ) ;
memset ( V_247 , 0 , sizeof( * V_247 ) ) ;
V_247 -> V_249 = V_250 ;
V_247 -> V_251 = 1 ;
V_247 -> V_252 = 2 * 1000 * 1000 ;
return 0 ;
}
static int F_99 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
int V_4 = - V_239 ;
if ( V_235 -> V_253 . V_254 != V_255 )
goto V_42;
if ( F_100 ( V_235 -> V_253 . V_256 ) ) {
} else
memcpy ( V_19 -> V_137 , V_235 -> V_253 . V_256 , V_84 ) ;
V_4 = 0 ;
V_42:
return V_4 ;
}
static int F_101 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
V_235 -> V_253 . V_254 = V_255 ;
memcpy ( V_235 -> V_253 . V_256 , V_19 -> V_137 , V_84 ) ;
return 0 ;
}
static int F_102 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
return F_74 ( V_156 ) ;
}
static int F_103 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
int V_3 ;
...
for ( V_3 = 0 ; V_3 < V_19 -> V_103 ; ++ V_3 ) {
V_259 . V_260 = V_261 ;
V_259 . V_262 . V_253 . V_254 = V_255 ;
memcpy ( V_259 . V_262 . V_253 . V_256 , V_19 -> V_113 [ V_3 ] . V_137 , V_84 ) ;
V_257 = F_104 ( V_233 , V_257 ,
V_236 + V_263 ,
& V_259 , V_264 ) ;
V_259 . V_260 = V_265 ;
V_259 . V_262 . V_15 . V_59 = 1 ;
V_259 . V_262 . V_15 . V_248 = V_19 -> V_113 [ V_3 ] . V_128 . V_12 . V_14 ;
V_257 = F_105 ( V_233 , V_257 ,
V_236 + V_263 ,
& V_259 ,
V_19 -> V_113 [ V_3 ] . V_128 . V_129 ) ;
V_259 . V_260 = V_266 ;
V_259 . V_262 . V_242 = V_19 -> V_113 [ V_3 ] . V_102 ;
V_257 = F_104 ( V_233 , V_257 ,
V_236 + V_263 ,
& V_259 , V_267 ) ;
V_259 . V_260 = V_268 ;
V_259 . V_262 . V_237 . V_238 = V_19 -> V_113 [ V_3 ] . V_109 . V_111 ;
V_259 . V_262 . V_237 . V_241 = 0 ;
V_257 = F_104 ( V_233 , V_257 ,
V_236 + V_263 ,
& V_259 , V_269 ) ;
V_259 . V_260 = V_270 ;
if ( V_19 -> V_113 [ V_3 ] . V_127 & V_271 )
V_259 . V_262 . V_15 . V_59 = V_272 | V_273 ;
else
V_259 . V_262 . V_15 . V_59 = V_274 ;
V_259 . V_262 . V_15 . V_248 = 0 ;
V_257 = F_105 ( V_233 , V_257 ,
V_236 + V_263 ,
& V_259 , NULL ) ;
}
V_235 -> V_15 . V_248 = ( V_257 - V_236 ) ;
V_235 -> V_15 . V_59 = 0 ;
return 0 ;
}
static int F_106 ( struct V_155 * V_156 ,
struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
...
F_21 ( & V_19 -> V_60 , V_59 ) ;
V_235 -> V_129 . V_59 = 1 ;
V_235 -> V_129 . V_248 = V_19 -> V_129 . V_12 . V_14 ;
memcpy ( V_236 , V_19 -> V_129 . V_129 , V_19 -> V_129 . V_12 . V_14 ) ;
F_22 ( & V_19 -> V_60 , V_59 ) ;
return 0 ;
}
static int F_108 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
if ( V_235 -> V_15 . V_248 > sizeof( V_19 -> V_276 ) )
return - V_277 ;
F_91 ( V_19 -> V_276 , V_236 , V_235 -> V_15 . V_248 ) ;
return 0 ;
}
static int F_109 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
struct V_18 * V_19 = F_44 ( V_156 ) ;
F_91 ( V_236 , V_19 -> V_276 , 32 ) ;
V_235 -> V_15 . V_248 = strlen ( V_236 ) ;
return 0 ;
}
static int F_110 ( struct V_155 * V_156 , struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
V_235 -> V_278 . V_13 = 2000000 ;
V_235 -> V_278 . V_245 = 1 ;
return 0 ;
}
...
T_2 V_279 ;
struct V_18 * V_19 = F_44 ( V_156 ) ;
int V_4 = F_23 ( V_19 , V_280 ,
& V_279 , sizeof( V_279 ) ) ;
if ( ! V_4 ) {
V_235 -> V_281 . V_13 = V_279 ;
V_235 -> V_281 . V_244 = V_279 >= 2347 ;
V_235 -> V_281 . V_245 = 1 ;
}
return V_4 ;
}
...
T_2 V_279 ;
struct V_18 * V_19 = F_44 ( V_156 ) ;
int V_4 = F_23 ( V_19 , V_282 ,
& V_279 , sizeof( V_279 ) ) ;
if ( ! V_4 ) {
V_235 -> V_283 . V_13 = V_279 ;
V_235 -> V_283 . V_244 = V_279 >= 2346 ;
V_235 -> V_283 . V_245 = 1 ;
}
return V_4 ;
}
...
& V_284 , sizeof( V_284 ) ) ;
if ( ! V_4 ) {
V_235 -> V_286 . V_13 = V_284 ;
V_235 -> V_286 . V_244 = 0 ;
V_235 -> V_286 . V_245 = 0 ;
V_235 -> V_286 . V_59 = V_287 ;
}
return V_4 ;
}
...
if ( V_4 )
goto V_42;
if ( V_235 -> V_288 . V_59 & V_290 ) {
V_235 -> V_288 . V_59 = V_291 | V_290 ;
goto V_292;
}
V_4 = F_23 ( V_19 , V_293 ,
& V_288 , sizeof( V_288 ) ) ;
if ( V_4 )
goto V_42;
V_235 -> V_288 . V_59 = V_291 | V_294 ;
V_292:
V_235 -> V_288 . V_13 = V_288 ;
V_235 -> V_288 . V_244 = 0 ;
V_42:
return V_4 ;
}
...
union V_234 * V_235 , char * V_236 )
{
T_1 V_295 , V_296 , V_297 [ 100 ] , V_298 , V_299 ;
struct V_18 * V_19 = F_44 ( V_156 ) ;
int V_4 = F_23 ( V_19 ,
V_300 ,
& V_295 , sizeof( V_295 ) ) ;
...
if ( V_4 )
goto V_42;
V_299 = F_116 ( T_2 , V_298 , V_235 -> V_301 . V_248 ) ;
V_299 = F_116 ( T_1 , V_299 , 100 ) ;
V_235 -> V_301 . V_248 = V_299 ;
memcpy ( V_236 , V_297 , V_299 ) ;
V_42:
return V_4 ;
}
static int F_117 ( struct V_155 * V_156 ,
struct V_232 * V_233 ,
union V_234 * V_235 , char * V_236 )
{
T_1 V_307 ;
...
if ( V_4 )
goto V_42;
V_235 -> V_309 . V_244 = ! V_307 ;
V_235 -> V_309 . V_59 = V_310 ;
V_42:
return V_4 ;
}
static int F_118 ( struct V_205 * V_207 )
{
struct V_155 * V_156 ;
struct V_18 * V_19 ;
V_207 -> V_311 [ 0 ] -> V_312 = 16 ;
V_207 -> V_311 [ 0 ] -> V_59 = V_313 ;
V_207 -> V_314 = V_315 ;
V_207 -> V_316 = 1 ;
V_156 = F_119 ( sizeof( struct V_18 ) ) ;
if ( ! V_156 )
goto V_317;
V_156 -> V_318 = & V_319 ;
V_156 -> V_320 = 5 * V_321 ;
V_19 = F_44 ( V_156 ) ;
V_19 -> V_322 . V_323 = & V_19 -> V_323 ;
V_19 -> V_207 = V_207 ;
V_156 -> V_322 = & V_19 -> V_322 ;
V_156 -> V_324 = & V_325 ;
F_51 ( V_156 ) ;
V_207 -> V_231 = V_156 ;
return F_120 ( V_207 ) ;
...
{
struct V_155 * V_156 = V_206 -> V_231 ;
int V_3 = 0 , V_326 , V_40 ;
struct V_18 * V_19 ;
V_206 -> V_327 = 5 ;
for ( V_326 = 0x280 ; V_326 < 0x400 ; V_326 += 0x20 ) {
V_206 -> V_311 [ 0 ] -> V_328 = V_326 ;
V_206 -> V_311 [ 1 ] -> V_328 = V_206 -> V_311 [ 0 ] -> V_328 + 0x10 ;
V_3 = F_121 ( V_206 ) ;
if ( V_3 == 0 )
break;
}
...
V_156 -> V_21 = V_206 -> V_311 [ 0 ] -> V_328 ;
F_124 ( V_156 , & V_206 -> V_156 ) ;
if ( F_125 ( V_156 ) ) {
F_26 ( V_330 L_24 ) ;
goto V_329;
}
...
for ( V_3 = 0 ; V_3 < 6 ; V_3 ++ )
V_156 -> V_331 [ V_3 ] = ( ( char * ) & V_19 -> V_26 ) [ V_3 ] ;
F_26 ( V_73 L_26
L_27 ,
...
V_19 -> V_104 = 0 ;
V_19 -> V_140 = 0 ;
F_4 ( V_275 , & V_19 -> V_129 . V_12 ,
L_6 , 3 ) ;
V_19 -> V_202 [ 0 ] = '\0' ;
V_19 -> V_203 [ 0 ] = '\0' ;
V_19 -> V_138 = 255 ;
V_19 -> V_111 = F_3 ( V_19 -> V_1 ) ;
F_91 ( V_19 -> V_276 , L_28 , sizeof( V_19 -> V_276 ) ) ;
F_126 ( & V_19 -> V_60 ) ;
F_127 ( & V_19 -> V_63 ) ;
F_128 ( V_156 ) ;
return 0 ;
...
static int F_130 ( struct V_205 * V_206 )
{
struct V_155 * V_156 = V_206 -> V_231 ;
F_25 ( F_44 ( V_156 ) , V_332 ) ;
if ( V_206 -> V_208 )
F_86 ( V_156 ) ;
return 0 ;
}
static int F_131 ( struct V_205 * V_206 )
{
struct V_155 * V_156 = V_206 -> V_231 ;
F_25 ( F_44 ( V_156 ) , V_333 ) ;
if ( V_206 -> V_208 ) {
F_74 ( V_156 ) ;
F_82 ( V_156 ) ;
}
