...
T_5 V_374 ;
int V_375 = 0 ;
if ( V_148 -> V_157 [ 0 ] . V_212 == sizeof( T_13 ) ) {
V_353 = V_148 -> V_157 [ 0 ] . V_158 ;
} else {
V_353 = F_92 ( sizeof( T_13 ) , V_186 ) ;
V_375 = 1 ;
...
struct V_176 * V_148 )
{
T_14 * V_409 = V_148 -> V_157 [ 0 ] . V_158 ;
ASSERT ( V_409 ) ;
...
int error ;
T_27 V_598 ;
V_598 = F_268 ( log , V_79 , V_533 , F_28 ( V_79 -> V_64 ) ) ;
if ( V_147 == V_88 ) {
if ( V_79 -> V_599 && V_598 != V_79 -> V_599 )
return - V_94 ;
return 0 ;
}
if ( V_598 != V_79 -> V_599 ) {
if ( V_79 -> V_599 || F_101 ( & log -> V_7 -> V_27 ) ) {
F_105 ( log -> V_7 ,
L_87 ,
F_269 ( V_79 -> V_599 ) ,
F_269 ( V_598 ) ) ;
...
if ( F_31 (
( ! V_79 -> V_102 ||
( F_28 ( V_79 -> V_102 ) & ( ~ V_601 ) ) ) ) ) {
F_3 ( log -> V_7 , L_89 ,
V_8 , F_28 ( V_79 -> V_102 ) ) ;
return - V_61 ;
}
V_600 = F_28 ( V_79 -> V_64 ) ;
if ( F_31 ( V_600 <= 0 || V_600 > V_73 ) ) {
F_4 ( L_90 ,
V_144 , log -> V_7 ) ;
return - V_16 ;
}
...
int V_24 = 0 ;
int V_604 , V_605 ;
int V_101 , V_606 , V_607 ;
struct V_550 V_551 [ V_608 ] ;
F_76 ( V_152 ) ;
ASSERT ( V_66 != V_75 ) ;
V_89 = 0 ;
if ( F_46 ( & log -> V_7 -> V_27 ) ) {
...
if ( ! V_602 )
return - V_52 ;
error = F_18 ( log , V_75 , 1 , V_602 , & V_13 ) ;
if ( error )
goto V_609;
V_79 = ( T_4 * ) V_13 ;
...
error = F_18 ( log , V_12 , V_101 , V_602 ,
& V_13 ) ;
if ( error )
goto V_612;
} else {
...
if ( error )
goto V_612;
V_604 = ( int ) F_47 ( F_28 ( V_79 -> V_64 ) ) ;
V_12 += V_101 ;
if ( V_12 + V_604 <= log -> V_3 ) {
error = F_18 ( log , V_12 , V_604 , V_603 ,
& V_13 ) ;
if ( error )
goto V_612;
} else {
...
while ( V_12 < V_66 ) {
error = F_18 ( log , V_12 , V_101 , V_602 , & V_13 ) ;
if ( error )
goto V_612;
V_79 = ( T_4 * ) V_13 ;
...
goto V_612;
V_604 = ( int ) F_47 ( F_28 ( V_79 -> V_64 ) ) ;
error = F_18 ( log , V_12 + V_101 , V_604 , V_603 ,
& V_13 ) ;
if ( error )
goto V_612;
...
int error , V_48 ;
ASSERT ( V_66 != V_75 ) ;
log -> V_191 = F_211 ( V_613 *
sizeof( struct V_177 ) ,
V_186 ) ;
for ( V_48 = 0 ; V_48 < V_613 ; V_48 ++ )
...
F_274 ( V_25 ) ;
V_6 = F_275 ( V_25 , 0 ) ;
V_6 -> V_18 &= ~ ( V_615 | V_616 ) ;
ASSERT ( ! ( V_6 -> V_18 & V_617 ) ) ;
V_6 -> V_18 |= V_19 ;
V_6 -> V_203 = & V_321 ;
error = F_15 ( V_6 ) ;
if ( error ) {
...
V_614 = & V_25 -> V_27 ;
F_276 ( V_614 , F_277 ( V_6 ) ) ;
F_25 ( V_6 ) ;
F_278 ( V_25 ) ;
error = F_279 ( V_25 , V_614 -> V_507 , & V_25 -> V_618 ) ;
if ( error ) {
F_3 ( V_25 , L_93 , error ) ;
return error ;
}
V_25 -> V_619 = F_280 ( V_25 ) ;
F_281 ( log ) ;
log -> V_620 &= ~ V_621 ;
return 0 ;
}
...
return error ;
if ( F_101 ( & log -> V_7 -> V_27 ) &&
! F_282 ( log -> V_7 , log -> V_7 -> V_27 . V_261 ) )
return - V_125 ;
if ( V_75 != V_66 ) {
if ( ( error = F_283 ( log -> V_7 , L_94 ) ) ) {
return error ;
}
if ( F_284 ( & log -> V_7 -> V_27 ) == V_622 &&
F_285 ( & log -> V_7 -> V_27 ,
V_623 ) ) {
F_3 ( log -> V_7 ,
L_95 ,
...
L_98 ,
V_625 . V_626 ) ;
F_287 ( V_625 . V_626 * 1000 ) ;
}
F_286 ( log -> V_7 , L_99 ,
log -> V_7 -> V_627 ? log -> V_7 -> V_627
: L_100 ) ;
error = F_273 ( log , V_66 , V_75 ) ;
log -> V_620 |= V_628 ;
}
return error ;
}
...
V_634 = 0LL ;
for ( V_497 = 0 ; V_497 < V_25 -> V_27 . V_507 ; V_497 ++ ) {
error = F_292 ( V_25 , NULL , V_497 , 0 , & V_631 ) ;
if ( error ) {
F_105 ( V_25 , L_104 ,
V_8 , V_497 , error ) ;
} else {
V_630 = F_293 ( V_631 ) ;
V_632 += F_28 ( V_630 -> V_635 ) +
F_28 ( V_630 -> V_636 ) ;
F_25 ( V_631 ) ;
}
error = F_252 ( V_25 , NULL , V_497 , & V_575 ) ;
...
V_633 += F_28 ( V_574 -> V_637 ) ;
V_634 += F_28 ( V_574 -> V_638 ) ;
F_25 ( V_575 ) ;
}
}
}
