...
if ( V_5 [ 4 ] - 1 < F_3 ( V_14 ) ) {
F_2 ( L_3 , V_13 , V_5 [ 4 ] ) ;
F_4 ( V_3 -> V_15 , V_14 [ V_5 [ 4 ] - 1 ] , 1 ) ;
F_5 ( V_3 -> V_15 ) ;
F_4 ( V_3 -> V_15 , V_14 [ V_5 [ 4 ] - 1 ] , 0 ) ;
F_5 ( V_3 -> V_15 ) ;
}
}
exit:
...
static T_1 F_8 ( T_1 V_17 , const T_2 * V_18 , T_3 V_19 )
{
T_1 V_20 ;
while ( V_19 -- ) {
V_17 ^= * V_18 ++ ;
...
static int F_9 ( struct V_2 * V_3 , const T_2 V_21 ,
...
T_2 * V_29 ;
F_2 ( L_5 , V_13 ) ;
V_29 = F_10 ( V_30 + 4 , V_31 ) ;
if ( ! V_29 )
return - V_32 ;
if ( ( V_26 = F_11 ( & V_3 -> V_33 ) ) ) {
F_12 ( V_29 ) ;
F_7 ( L_6 , V_13 ) ;
return V_26 ;
}
...
V_26 = F_13 ( V_3 -> V_36 , V_3 -> V_37 , V_29 ,
V_30 + 4 , & V_27 , 1000 ) ;
if ( V_26 ) {
F_7 ( L_10 ,
V_13 , V_26 ) ;
...
V_26 = F_13 ( V_3 -> V_36 , V_3 -> V_38 , V_29 ,
V_30 + 4 , & V_27 , 1000 ) ;
if ( V_26 ) {
F_7 ( L_11 ,
V_13 , V_26 ) ;
...
static int F_15 ( struct V_2 * V_3 , unsigned int * V_39 ,
...
T_4 V_20 ;
F_2 ( L_5 , V_13 ) ;
V_26 = F_9 ( V_3 , 0x08 , 0 , NULL , & V_43 , V_42 ) ;
if ( V_26 )
return V_26 ;
if ( V_43 >= 0x0c ) {
if ( V_39 != NULL ) {
...
static int F_18 ( void * V_44 , unsigned char * V_45 )
{
struct V_2 * V_3 = V_44 ;
...
0x00 , 0x00 , 0xff , 0xff ,
0xff , 0xff , 0xff , 0xff } ;
T_5 V_51 = F_20 ( V_3 -> V_52 [ V_53 ] ) ;
T_5 V_54 = F_20 ( V_3 -> V_52 [ V_55 ] ) ;
T_5 V_56 = F_20 ( V_3 -> V_52 [ V_57 ] ) ;
F_2 ( L_5 , V_13 ) ;
memcpy ( & V_29 [ 0 ] , & V_51 , 2 ) ;
memcpy ( & V_29 [ 2 ] , & V_54 , 2 ) ;
memcpy ( & V_29 [ 4 ] , & V_56 , 2 ) ;
F_9 ( V_3 , 0x50 , sizeof( V_29 ) , V_29 , NULL , NULL ) ;
F_21 ( & V_3 -> V_58 , V_3 -> V_52 [ V_55 ] ,
F_17 , V_3 ) ;
F_21 ( & V_3 -> V_59 , V_3 -> V_52 [ V_57 ] ,
F_18 , V_3 ) ;
V_3 -> V_60 = 0 ;
V_3 -> V_61 = 0 ;
}
static void F_22 ( struct V_2 * V_3 , T_2 * V_62 , int V_63 )
{
if ( V_63 < 8 ) {
F_7 ( L_13 , V_13 ) ;
return;
...
static void F_24 ( struct V_2 * V_3 , T_2 * V_70 ,
int V_63 )
{
struct V_71 * V_72 ;
struct V_73 * V_74 ;
...
V_72 = V_72 -> V_81 ) {
V_74 = F_26 ( V_72 , struct V_73 , V_80 ) ;
if ( V_74 -> V_82 == V_78 ) {
V_76 = V_74 -> V_76 ;
break;
}
...
static void F_29 ( T_2 * V_29 , int V_63 )
{
V_63 -= V_63 % 2 ;
for (; V_63 ; V_29 += 2 , V_63 -= 2 )
F_30 ( * V_29 , * ( V_29 + 1 ) ) ;
}
static void F_31 ( struct V_2 * V_3 , T_2 * V_29 ,
int V_63 )
{
F_29 ( V_29 , V_63 ) ;
while ( V_63 ) {
...
V_63 = V_104 -> V_108 ;
if ( ( V_99 = F_10 ( sizeof( struct V_98 ) ,
V_16 ) ) ) {
unsigned long V_77 ;
...
switch ( V_129 ) {
case V_130 :
V_26 = F_41 ( V_3 -> V_36 , 0 , 0 ) ;
break;
case V_131 :
V_26 = F_9 ( V_3 , 0x80 , sizeof( V_29 ) ,
V_29 , NULL , NULL ) ;
if ( V_26 )
return V_26 ;
V_26 = F_41 ( V_3 -> V_36 , 0 , 8 ) ;
break;
case V_132 :
V_26 = F_41 ( V_3 -> V_36 , 0 , 1 ) ;
break;
}
if ( V_26 )
return V_26 ;
...
V_3 -> V_87 = 0 ;
for ( V_28 = 0 ; V_28 < V_113 ; V_28 ++ ) {
if ( ( V_26 = F_6 ( V_3 -> V_115 [ V_28 ] ,
V_16 ) ) ) {
F_7 ( L_23
L_24 , V_13 , V_28 , V_26 ) ;
while ( V_28 ) {
F_39 ( V_3 -> V_115 [ V_28 - 1 ] ) ;
V_28 -- ;
}
F_14 ( & V_3 -> V_127 ) ;
return V_26 ;
...
V_26 = F_9 ( V_3 , 0x80 , sizeof( V_139 ) , V_139 , NULL , NULL ) ;
if ( V_26 )
return V_26 ;
V_3 -> V_90 ++ ;
return F_42 ( V_3 ) ;
...
T_2 V_149 = 1 ;
F_2 ( L_5 , V_13 ) ;
V_52 = F_20 ( V_135 -> V_52 ) ;
memcpy ( & V_139 [ 0 ] , & V_52 , 2 ) ;
memcpy ( & V_139 [ 4 ] , & V_149 , 1 ) ;
memcpy ( & V_139 [ 5 ] , & V_135 -> V_76 -> V_76 . V_150 [ 0 ] , 1 ) ;
V_26 = F_9 ( V_3 , 0x60 , sizeof( V_139 ) , V_139 ,
& V_43 , V_42 ) ;
if ( ! V_26 ) {
if ( V_43 == 2 ) {
if ( ! ( V_74 = F_10 ( sizeof( struct V_73 ) ,
V_16 ) ) )
return - V_32 ;
V_74 -> V_82 = V_42 [ 1 ] ;
...
struct V_2 * V_3 = V_135 -> V_138 -> V_44 ;
T_2 V_139 [] = { 0x00 } ;
F_9 ( V_3 , 0x81 , sizeof( V_139 ) , V_139 , NULL , NULL ) ;
V_3 -> V_90 -- ;
F_38 ( V_3 ) ;
return 0 ;
}
...
F_27 ( & V_3 -> V_79 , V_77 ) ;
F_12 ( V_74 ) ;
F_9 ( V_3 , 0x62 , sizeof( V_139 ) , V_139 , NULL , NULL ) ;
V_3 -> V_93 -- ;
F_38 ( V_3 ) ;
return 0 ;
}
...
int V_28 ;
int V_157 ;
F_60 ( V_3 -> V_36 , V_3 -> V_158 , sizeof( V_3 -> V_158 ) ) ;
F_61 ( V_3 -> V_158 , L_38 , sizeof( V_3 -> V_158 ) ) ;
V_156 = F_62 () ;
if ( ! V_156 )
return - V_32 ;
V_156 -> V_159 = L_39 ;
V_156 -> V_160 = V_3 -> V_158 ;
V_156 -> V_161 [ 0 ] = F_63 ( V_162 ) ;
V_156 -> V_163 = sizeof( T_1 ) ;
V_156 -> V_164 = 0x1a ;
V_156 -> V_165 = V_14 ;
for ( V_28 = 0 ; V_28 < F_3 ( V_14 ) ; V_28 ++ )
F_64 ( V_14 [ V_28 ] , V_156 -> V_166 ) ;
V_157 = F_65 ( V_156 ) ;
if ( V_157 ) {
F_66 ( V_156 ) ;
return V_157 ;
...
V_3 -> V_15 = V_156 ;
if ( F_6 ( V_3 -> V_167 , V_31 ) )
F_7 ( L_40 , V_13 ) ;
F_9 ( V_3 , 0xb0 , sizeof( V_29 ) , V_29 , NULL , NULL ) ;
return 0 ;
}
...
V_182 [ 20 ] = '\0' ;
F_7 ( V_193 L_45 , V_182 ) ;
V_187 = F_82 ( V_184 ) ;
memcpy ( V_139 , & V_187 , 4 ) ;
V_185 = F_8 ( ~ 0 , V_183 , V_184 ) ^ ~ 0 ;
V_186 = F_20 ( V_185 ) ;
memcpy ( & V_139 [ 6 ] , & V_186 , 2 ) ;
V_26 = F_9 ( V_3 , 0x41 , sizeof( V_139 ) , V_139 , NULL , NULL ) ;
if ( V_26 ) {
F_80 ( V_190 ) ;
return V_26 ;
}
...
V_26 = F_9 ( V_3 , 0x43 , sizeof( V_181 ) , V_181 , NULL , NULL ) ;
F_80 ( V_190 ) ;
F_12 ( V_29 ) ;
return V_26 ;
}
...
V_3 -> V_138 . V_206 = 31 ;
V_3 -> V_138 . V_207 = 31 ;
V_3 -> V_138 . V_208 = F_45 ;
V_3 -> V_138 . V_209 = F_48 ;
...
V_99 = F_26 ( V_72 , struct V_98 , V_101 ) ;
F_33 ( & V_99 -> V_101 ) ;
F_12 ( V_99 ) ;
}
}
...
return F_9 ( V_3 , V_21 , V_22 , V_23 , V_24 , V_25 ) ;
}
