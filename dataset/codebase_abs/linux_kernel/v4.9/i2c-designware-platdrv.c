...
if ( V_52 < 0 )
return V_52 ;
V_2 = F_20 ( & V_5 -> V_2 , sizeof( struct V_1 ) , V_56 ) ;
if ( ! V_2 )
return - V_57 ;
V_51 = F_21 ( V_5 , V_58 , 0 ) ;
V_2 -> V_59 = F_22 ( & V_5 -> V_2 , V_51 ) ;
if ( F_13 ( V_2 -> V_59 ) )
return F_14 ( V_2 -> V_59 ) ;
V_2 -> V_2 = & V_5 -> V_2 ;
V_2 -> V_52 = V_52 ;
F_23 ( V_5 , V_2 ) ;
V_2 -> V_60 = 400000 ;
...
if ( F_26 ( & V_5 -> V_2 ) )
F_9 ( V_5 ) ;
if ( V_2 -> V_60 != 100000 && V_2 -> V_60 != 400000
&& V_2 -> V_60 != 1000000 && V_2 -> V_60 != 3400000 ) {
F_27 ( & V_5 -> V_2 ,
L_9 ) ;
return - V_64 ;
}
...
if ( ! V_2 -> V_34 && V_55 )
V_2 -> V_34 = F_30 (
( V_80 ) V_2 -> V_79 ( V_2 ) * V_55 + 500000 ,
1000000 ) ;
}
if ( ! V_2 -> V_28 ) {
T_1 V_81 = F_31 ( V_2 ) ;
V_2 -> V_28 = ( ( V_81 >> 16 ) & 0xff ) + 1 ;
V_2 -> V_29 = ( ( V_81 >> 8 ) & 0xff ) + 1 ;
V_2 -> V_26 . V_27 = V_5 -> V_25 ;
}
V_49 = & V_2 -> V_26 ;
V_49 -> V_82 = V_83 ;
V_49 -> V_84 = V_85 ;
F_32 ( & V_49 -> V_2 , F_33 ( & V_5 -> V_2 ) ) ;
V_49 -> V_2 . V_86 = V_5 -> V_2 . V_86 ;
if ( V_2 -> V_87 ) {
F_34 ( & V_5 -> V_2 ) ;
} else {
F_35 ( & V_5 -> V_2 , 1000 ) ;
...
static int F_47 ( struct V_88 * V_2 )
{
return F_48 ( V_2 ) ;
}
static void F_49 ( struct V_88 * V_2 )
{
if ( V_2 -> V_89 . V_90 )
F_50 ( V_2 ) ;
}
...
static int F_53 ( struct V_88 * V_2 )
{
struct V_4 * V_5 = F_52 ( V_2 ) ;
struct V_1 * V_44 = F_10 ( V_5 ) ;
F_12 ( V_44 , true ) ;
