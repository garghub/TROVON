...
struct V_9 * V_10 = V_93 -> V_98 [ 0 ] -> V_11 ;
unsigned long V_95 ;
unsigned long V_15 ;
int V_73 ;
F_40 ( V_3 , V_91 ) ;
for ( V_73 = 0 ; V_73 < V_93 -> V_75 ; ++ V_73 ) {
struct V_7 * V_59 = V_93 -> V_98 [ V_73 ] ;
V_95 = F_7 ( V_10 -> V_18 + V_59 -> V_2 -> V_21
+ V_59 -> V_14 ) ;
V_15 = F_7 ( V_10 -> V_18 + V_59 -> V_2 -> V_13
+ V_59 -> V_14 ) ;
F_42 ( V_95 & ~ V_15 , V_59 -> V_55 ) ;
}
F_41 ( V_3 , V_91 ) ;
}
...
V_61 = F_51 ( V_8 -> V_78 , V_105 ) ;
if ( ! V_61 ) {
F_18 ( V_72 , L_12 ,
V_8 -> V_48 , V_105 ) ;
continue;
}
V_102 [ V_105 ] . V_61 = V_105 ;
V_102 [ V_105 ] . V_8 = V_8 ;
F_52 ( V_61 ,
F_37 ,
& V_102 [ V_105 ] ) ;
...
struct V_7 * V_8 )
{
struct V_83 * V_112 = V_8 -> V_82 ;
void T_4 * V_113 = V_11 -> V_18 ;
V_112 -> V_28 = F_7 ( V_113 + V_114
+ V_8 -> V_14 ) ;
V_112 -> V_115 = F_7 ( V_113 + V_116
+ 2 * V_8 -> V_14 ) ;
V_112 -> V_117 = F_7 ( V_113 + V_116
+ 2 * V_8 -> V_14 + 4 ) ;
F_54 ( L_15 , V_8 -> V_48 , V_112 -> V_28 ) ;
F_54 ( L_16 , V_8 -> V_48 , V_112 -> V_115 ) ;
F_54 ( L_17 , V_8 -> V_48 , V_112 -> V_117 ) ;
}
...
F_54 ( L_19 , V_8 -> V_48 ,
F_7 ( V_113 + V_116
+ 2 * V_8 -> V_14 ) , V_112 -> V_115 ) ;
F_54 ( L_20 , V_8 -> V_48 ,
F_7 ( V_113 + V_116
+ 2 * V_8 -> V_14 + 4 ) , V_112 -> V_117 ) ;
F_8 ( V_112 -> V_28 , V_113 + V_114
+ V_8 -> V_14 ) ;
