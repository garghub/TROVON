...
F_8 ( V_130 -> V_139 ) ) ;
F_6 ( V_2 , V_125 , L_93 ,
F_8 ( V_130 -> V_140 . V_141 . V_142 ) ,
F_8 ( V_130 -> V_140 . V_141 . V_143 ) ) ;
F_6 ( V_2 , V_125 , L_94 ,
F_8 ( V_130 -> V_140 . V_144 . V_145 ) ,
F_8 ( V_130 -> V_140 . V_144 . V_146 ) ) ;
if ( ( V_127 != NULL ) && ( V_130 -> V_136 != 0 ) ) {
T_2 V_147 = F_7 ( V_130 -> V_136 ) ;
F_6 ( V_2 , V_125 , L_95 ) ;
if ( V_128 < V_147 )
V_147 = V_128 ;
for ( V_132 = 0 ; V_132 < ( V_147 - 16 ) ; V_132 += 16 )
F_6 ( V_2 , V_125 , L_96 , V_132 , V_131 + V_132 ) ;
if ( V_132 < V_147 )
F_6 ( V_2 , V_125 , L_97 ,
V_132 , V_147 - V_132 , V_131 + V_132 ) ;
}
}
bool F_9 ( struct V_1 * V_2 )
{
if ( V_2 -> V_148 . V_149 . V_147 )
return ! ! ( F_10 ( V_2 , V_2 -> V_148 . V_149 . V_147 ) &
V_150 ) ;
else
return false ;
}
...
struct V_129 V_126 ;
struct V_152 * V_153 =
(struct V_152 * ) & V_126 . V_140 . V_154 ;
T_1 V_3 ;
F_12 ( & V_126 ,
V_155 ) ;
if ( V_151 )
...
struct V_129 V_126 ;
struct V_163 * V_164 =
(struct V_163 * ) & V_126 . V_140 . V_154 ;
if ( V_162 )
F_12 ( & V_126 ,
V_165 ) ;
else
F_12 ( & V_126 ,
V_166 ) ;
V_126 . V_135 |= F_16 ( ( T_2 ) V_167 ) ;
V_126 . V_135 |= F_16 ( ( T_2 ) V_168 ) ;
V_164 -> V_158 =
F_16 ( ( T_2 ) ( ( V_158 <<
V_169 ) &
V_170 ) ) ;
...
struct V_129 V_126 ;
struct V_178 * V_164 =
(struct V_178 * ) & V_126 . V_140 . V_154 ;
...
struct V_129 V_126 ;
struct V_189 * V_164 =
(struct V_189 * ) & V_126 . V_140 . V_154 ;
T_1 V_3 ;
if ( ! V_186 )
return V_64 ;
F_12 ( & V_126 ,
...
T_1 V_3 ;
F_12 ( & V_126 , V_207 ) ;
V_126 . V_135 |= F_16 ( ( T_2 ) V_208 ) ;
V_126 . V_138 = F_13 ( V_202 ) ;
V_126 . V_139 = F_13 ( V_203 ) ;
if ( V_205 ) {
V_126 . V_135 |= F_16 ( ( T_2 ) ( V_167
| V_168 ) ) ;
if ( V_205 > V_209 )
V_126 . V_135 |= F_16 ( ( T_2 ) V_210 ) ;
V_126 . V_136 = F_16 ( V_205 ) ;
}
if ( ! V_188 ) {
...
V_226 ) ? 1 : 0 ;
for ( V_132 = 0 ; V_132 < V_204 -> V_216 ; V_132 ++ ) {
