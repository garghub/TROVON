...
static inline int F_74 ( struct V_1 * V_4 , struct V_110 * V_111 )
{
return V_4 -> V_67 . F_8 == V_111 -> V_121 . V_143 . V_144 . V_145 ;
}
static struct V_51 * F_75 ( struct V_1 * V_4 , struct V_110 * V_111 ,
...
V_146 = V_147 + sizeof( struct V_53 ) +
sizeof( struct V_100 ) ;
V_52 = F_76 ( V_63 + V_146 + F_77 ( V_4 -> V_3 ) ,
V_138 ) ;
if ( F_21 ( ! V_52 ) )
return NULL ;
F_78 ( V_52 , V_146 + F_77 ( V_4 -> V_3 ) ) ;
V_52 -> V_16 = V_4 -> V_3 ;
if ( V_111 -> V_126 == V_127 )
...
static enum V_150 F_81 ( struct V_1 * V_4 ,
unsigned int V_58 )
{
return V_151 ;
}
...
V_4 -> V_152 = & V_152 ;
V_4 -> V_3 = V_3 ;
V_20 = F_84 ( V_4 , V_3 -> V_153 ) ;
if ( V_20 ) {
F_85 ( & V_4 -> V_8 ) ;
return NULL ;
}
F_2 ( & V_6 ) ;
F_86 ( & V_154 , & V_4 -> V_155 ) ;
F_4 ( & V_6 ) ;
return V_4 ;
}
void F_87 ( void )
