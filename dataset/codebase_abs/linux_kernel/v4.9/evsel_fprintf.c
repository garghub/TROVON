...
if ( V_41 )
V_12 += fprintf ( V_1 , L_17 V_60 , V_55 , V_40 -> V_61 ) ;
if ( V_40 -> V_62 )
V_59 = V_40 -> V_62 -> V_63 ( V_40 -> V_62 , V_40 -> V_61 ) ;
if ( V_43 ) {
V_12 += fprintf ( V_1 , L_16 ) ;
V_58 . V_59 = V_59 ;
V_58 . V_62 = V_40 -> V_62 ;
if ( V_47 ) {
V_12 += F_11 ( V_40 -> V_64 , & V_58 ,
V_53 , V_1 ) ;
} else {
V_12 += F_12 ( V_40 -> V_64 , & V_58 ,
V_53 , V_1 ) ;
}
}
if ( V_45 ) {
V_12 += fprintf ( V_1 , L_18 ) ;
V_12 += F_13 ( V_40 -> V_62 , V_1 ) ;
V_12 += fprintf ( V_1 , L_19 ) ;
}
if ( V_51 )
V_12 += F_14 ( V_40 -> V_62 , V_59 , L_20 , V_1 ) ;
if ( ! V_49 )
...
int F_16 ( struct V_33 * V_34 , struct V_57 * V_65 ,
...
V_12 += fprintf ( V_1 , L_15 , V_35 , V_35 , L_16 ) ;
if ( V_41 )
V_12 += fprintf ( V_1 , L_22 V_60 , V_34 -> V_61 ) ;
if ( V_43 ) {
V_12 += fprintf ( V_1 , L_16 ) ;
if ( V_47 ) {
V_12 += F_11 ( V_65 -> V_64 , V_65 ,
V_53 , V_1 ) ;
} else {
V_12 += F_12 ( V_65 -> V_64 , V_65 ,
V_53 , V_1 ) ;
}
}
if ( V_45 ) {
V_12 += fprintf ( V_1 , L_18 ) ;
V_12 += F_13 ( V_65 -> V_62 , V_1 ) ;
V_12 += fprintf ( V_1 , L_19 ) ;
}
if ( V_51 )
V_12 += F_14 ( V_65 -> V_62 , V_65 -> V_59 , L_20 , V_1 ) ;
}
return V_12 ;
}
