...
struct V_44 * V_45 ;
F_23 ( & V_27 -> V_46 , V_42 ) ;
V_45 = F_24 ( V_21 , V_39 -> V_43 -> V_47 ) ;
F_25 ( V_45 , V_39 -> V_48 , V_27 -> V_49 ) ;
V_39 -> V_48 = - 1 ;
}
V_40 = & V_27 -> V_30 [ V_27 -> V_50 ] ;
F_12 ( V_27 -> V_31 == V_27 -> V_50 ) ;
V_27 -> V_50 ^= 1 ;
if ( ! V_21 -> V_22 )
F_26 ( V_21 , V_39 ) ;
F_27 (rq, n, running, flush.list) {
...
struct V_28 * V_29 = & V_27 -> V_30 [ V_27 -> V_31 ] ;
struct V_2 * V_52 =
F_31 ( V_29 , struct V_2 , V_13 . V_37 ) ;
struct V_2 * V_39 = V_27 -> V_39 ;
if ( V_27 -> V_31 != V_27 -> V_50 || F_14 ( V_29 ) )
return false ;
if ( ! F_14 ( & V_27 -> V_38 ) &&
F_32 ( V_36 ,
V_27 -> V_35 + V_53 ) )
...
V_39 -> V_48 = V_52 -> V_48 ;
V_27 -> V_49 = V_52 ;
V_45 = F_24 ( V_21 , V_52 -> V_43 -> V_47 ) ;
F_25 ( V_45 , V_52 -> V_48 , V_39 ) ;
}
V_39 -> V_54 = V_55 ;
F_34 ( V_39 , V_56 , V_57 | V_17 ) ;
V_39 -> V_58 = V_52 -> V_58 ;
V_39 -> V_18 = F_21 ;
return F_6 ( V_39 , false ) ;
}
static void F_35 ( struct V_2 * V_3 , int error )
{
struct V_23 * V_21 = V_3 -> V_21 ;
...
struct V_23 * V_21 = V_3 -> V_21 ;
struct V_44 * V_45 ;
struct V_60 * V_61 = V_3 -> V_43 ;
unsigned long V_42 ;
struct V_26 * V_27 = F_22 ( V_21 , V_61 ) ;
V_45 = F_24 ( V_21 , V_61 -> V_47 ) ;
F_23 ( & V_27 -> V_46 , V_42 ) ;
if ( F_11 ( V_3 , V_27 , V_5 , error ) )
F_37 ( V_45 , true ) ;
F_30 ( & V_27 -> V_46 , V_42 ) ;
...
int F_44 ( struct V_64 * V_65 , T_1 V_66 ,
T_2 * V_67 )
{
struct V_23 * V_21 ;
struct V_15 * V_15 ;
...
struct V_26 * F_50 ( struct V_23 * V_21 ,
int V_76 , int V_77 )
{
struct V_26 * V_27 ;
int V_78 = sizeof( struct V_2 ) ;
V_27 = F_51 ( sizeof( * V_27 ) , V_79 , V_76 ) ;
if ( ! V_27 )
goto V_80;
if ( V_21 -> V_22 ) {
F_52 ( & V_27 -> V_46 ) ;
V_78 = F_53 ( V_78 + V_77 , F_54 () ) ;
}
V_27 -> V_39 = F_51 ( V_78 , V_79 , V_76 ) ;
if ( ! V_27 -> V_39 )
goto V_81;
F_41 ( & V_27 -> V_30 [ 0 ] ) ;
F_41 ( & V_27 -> V_30 [ 1 ] ) ;
