...
if ( V_25 && V_20 == & V_25 -> V_28 && V_25 -> V_29 )
return;
...
{
F_3 ( ! V_20 -> V_37 || V_20 -> V_37 == V_32 ) ;
F_3 ( F_9 ( V_32 ) ) ;
V_20 -> V_37 = V_32 ;
}
T_1 F_12 ( struct V_19 * V_20 ,
enum V_26 V_34 )
{
...
static T_2 F_16 ( const struct V_19 * V_20 ,
const struct V_12 * V_13 ,
enum V_26 V_34 )
{
T_2 V_42 ;
V_42 = V_13 -> V_18 [ V_20 -> V_37 -> V_7 ] [ V_34 ] ;
F_17 ( V_42 > 0 , L_2 , V_20 -> V_37 -> V_41 ,
V_13 -> V_43 , V_42 , V_34 ) ;
V_42 -- ;
...
T_2 V_45 ;
T_2 V_42 ;
void * (* F_24)( struct V_33 * V_55 , T_2 V_48 , T_2 V_56 );
...
V_45 = F_27 ( F_4 ( V_13 -> V_17 ) , V_13 -> V_17 , 0 ) ;
}
...
const struct V_12 * V_13 ,
enum V_26 V_34 , T_2 V_62 )
{
F_3 ( V_34 == V_23 || V_34 == V_22 ) ;
if ( ( V_62 != ( T_2 ) V_13 -> V_17 ) &&
( V_13 -> V_17 != - 1 ) &&
! ( V_13 -> V_15 & V_63 ) &&
( V_62 > 0 ) ) {
T_2 V_17 = ( T_2 ) V_13 -> V_17 ;
if ( ( V_13 -> V_15 & V_16 ) &&
( V_62 % V_17 != 0 ) ) {
F_26 ( L_13 ,
V_13 -> V_43 , V_62 , V_17 , V_34 ) ;
F_37 () ;
...
T_2 F_38 ( const struct V_19 * V_20 ,
const struct V_12 * V_13 ,
enum V_26 V_34 )
{
F_3 ( V_34 == V_23 || V_34 == V_22 ) ;
...
T_2 F_39 ( struct V_19 * V_20 , enum V_26 V_34 )
{
return F_40 ( V_20 -> V_30 -> V_64 -> V_65 ,
V_20 -> V_37 -> V_9 [ V_34 ] . V_10 ,
V_20 -> V_21 [ V_34 ] ) ;
}
T_2 F_41 ( T_3 V_66 , const struct V_4 * V_32 ,
enum V_26 V_34 )
{
T_1 V_1 = 0 ;
T_2 V_62 ;
V_62 = F_42 ( V_66 , V_32 -> V_9 [ V_34 ] . V_10 ) ;
if ( ! V_62 )
return V_62 ;
for (; V_1 < V_32 -> V_9 [ V_34 ] . V_10 ; ++ V_1 )
if ( V_32 -> V_9 [ V_34 ] . V_14 [ V_1 ] -> V_17 != - 1 )
V_62 += F_43 ( V_32 -> V_9 [ V_34 ] . V_14 [ V_1 ] ->
V_17 ) ;
return V_62 ;
}
void F_44 ( struct V_19 * V_20 , const struct V_4 * V_32 )
{
int V_1 ;
T_1 V_2 ;
...
const struct V_12 * V_68 = F_45 ( V_67 , V_1 , V_2 ) ;
if ( ! V_68 -> V_51 &&
( V_68 -> V_15 & ~ V_63 ) == 0 &&
( V_68 -> V_17 == - 1 ||
V_68 -> V_15 == V_63 ) )
continue;
F_3 ( F_45 ( V_32 , V_1 , V_2 ) == F_45 ( V_67 , V_1 , V_2 ) ) ;
}
F_3 ( F_45 ( V_32 , V_1 , V_2 ) -> V_17 >=
F_45 ( V_67 , V_1 , V_2 ) -> V_17 ) ;
}
V_20 -> V_37 = V_32 ;
}
int F_46 ( const struct V_19 * V_20 ,
const struct V_12 * V_13 ,
enum V_26 V_34 )
{
F_3 ( V_34 == V_23 || V_34 == V_22 ) ;
...
static int F_47 ( const struct V_19 * V_20 ,
const struct V_12 * V_13 ,
enum V_26 V_34 )
{
T_2 V_42 ;
F_3 ( V_34 == V_23 || V_34 == V_22 ) ;
F_3 ( F_46 ( V_20 , V_13 , V_34 ) ) ;
V_42 = F_16 ( V_20 , V_13 , V_34 ) ;
return F_28 ( F_10 ( V_20 , V_34 ) ) > V_42 ;
}
void F_48 ( struct V_19 * V_20 ,
const struct V_12 * V_13 ,
T_2 V_69 , enum V_26 V_34 )
{
const struct V_4 * V_32 ;
struct V_33 * V_54 ;
T_2 V_45 ;
...
if ( V_34 == V_22 )
V_20 -> V_30 -> V_70 = F_49 ( V_54 , V_42 , V_69 ,
1 ) ;
else
V_20 -> V_30 -> V_71 = F_49 ( V_54 , V_42 , V_69 ,
1 ) ;
}
