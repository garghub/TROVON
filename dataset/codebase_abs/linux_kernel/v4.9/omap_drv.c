...
static int F_64 ( struct V_1 * V_2 , void * V_88 ,
struct V_89 * V_90 )
{
struct V_3 * V_4 = V_2 -> V_5 ;
...
return F_68 ( V_2 , V_90 , args -> V_100 , V_98 ,
& args -> V_102 ) ;
}
static int F_69 ( struct V_1 * V_2 , void * V_88 ,
struct V_89 * V_90 )
{
struct V_103 * args = V_88 ;
struct V_104 * V_105 ;
int V_14 ;
F_67 ( L_13 , V_2 , V_90 , args -> V_102 , args -> V_106 ) ;
V_105 = F_70 ( V_90 , args -> V_102 ) ;
if ( ! V_105 )
return - V_107 ;
V_14 = F_71 ( V_105 , args -> V_106 ) ;
if ( ! V_14 )
V_14 = F_72 ( V_105 , args -> V_106 ) ;
F_73 ( V_105 ) ;
return V_14 ;
}
static int F_74 ( struct V_1 * V_2 , void * V_88 ,
struct V_89 * V_90 )
{
struct V_108 * args = V_88 ;
struct V_104 * V_105 ;
int V_14 ;
F_67 ( L_14 , V_2 , V_90 , args -> V_102 ) ;
V_105 = F_70 ( V_90 , args -> V_102 ) ;
if ( ! V_105 )
return - V_107 ;
V_14 = 0 ;
if ( ! V_14 )
V_14 = F_75 ( V_105 , args -> V_106 ) ;
F_73 ( V_105 ) ;
return V_14 ;
}
static int F_76 ( struct V_1 * V_2 , void * V_88 ,
struct V_89 * V_90 )
{
...
if ( ! V_105 )
return - V_107 ;
args -> V_100 = F_77 ( V_105 ) ;
args -> V_110 = F_78 ( V_105 ) ;
F_73 ( V_105 ) ;
return V_14 ;
}
static int F_79 ( struct V_1 * V_2 , unsigned long V_98 )
{
...
static int F_97 ( struct V_1 * V_2 , struct V_89 * V_117 )
{
V_117 -> V_118 = NULL ;
F_2 ( L_20 , V_2 , V_117 ) ;
return 0 ;
...
if ( V_2 -> V_56 . V_57 ) {
for ( V_13 = 0 ; V_13 < V_4 -> V_40 ; V_13 ++ ) {
F_99 ( & V_4 -> V_21 [ V_13 ] -> V_119 ,
V_2 -> V_56 . V_57 , 0 ) ;
}
for ( V_13 = 0 ; V_13 < V_4 -> V_54 ; V_13 ++ ) {
F_99 ( & V_4 -> V_53 [ V_13 ] -> V_119 ,
V_2 -> V_56 . V_57 , 0 ) ;
}
}
if ( V_4 -> V_6 ) {
...
static int F_101 ( struct V_120 * V_121 )
{
int V_43 ;
if ( F_102 () == false )
return - V_46 ;
...
F_2 ( L_23 , V_121 -> V_48 ) ;
return F_105 ( & V_122 , V_121 ) ;
}
static int F_106 ( struct V_120 * V_121 )
{
F_2 ( L_24 ) ;
F_107 ( F_108 ( V_121 ) ) ;
F_34 () ;
...
static int F_111 ( struct V_121 * V_2 )
{
struct V_1 * V_126 = F_112 ( V_2 ) ;
F_113 ( V_126 ) ;
F_114 ( V_126 ) ;
F_109 () ;
F_115 ( V_126 ) ;
...
static int F_116 ( struct V_121 * V_2 )
{
struct V_1 * V_126 = F_112 ( V_2 ) ;
F_114 ( V_126 ) ;
F_110 () ;
...
{
F_2 ( L_25 ) ;
return F_120 ( V_127 , F_44 ( V_127 ) ) ;
}
static void T_3 F_121 ( void )
{
F_2 ( L_26 ) ;
F_122 ( V_127 , F_44 ( V_127 ) ) ;
}
