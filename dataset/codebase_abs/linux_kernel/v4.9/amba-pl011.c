...
static void F_169 ( struct V_127 * V_8 , int V_183 )
{
while ( F_170 ( V_8 -> V_9 + V_321 ) & V_126 )
F_90 () ;
if ( V_8 -> V_10 == V_11 )
F_171 ( V_183 , V_8 -> V_9 + V_322 ) ;
else
F_172 ( V_183 , V_8 -> V_9 + V_322 ) ;
while ( F_170 ( V_8 -> V_9 + V_321 ) & V_323 )
F_90 () ;
}
static void F_173 ( struct V_303 * V_324 , const char * V_305 , unsigned V_325 )
{
struct V_326 * V_2 = V_324 -> V_89 ;
F_161 ( & V_2 -> V_8 , V_305 , V_325 , F_169 ) ;
}
static int T_10 F_174 ( struct V_326 * V_46 ,
const char * V_327 )
{
if ( ! V_46 -> V_8 . V_9 )
return - V_319 ;
V_46 -> V_324 -> V_328 = F_173 ;
return 0 ;
}
static int F_175 ( int V_307 , struct V_46 * V_2 )
{
struct V_329 * V_330 ;
static bool V_331 = false ;
static bool V_332 = false ;
int V_125 = V_307 ;
if ( ! F_176 ( V_333 ) )
return V_125 ;
V_330 = V_2 -> V_87 ;
if ( ! V_330 )
return V_125 ;
V_125 = F_177 ( V_330 , L_26 ) ;
if ( V_125 < 0 ) {
V_332 = true ;
V_125 = V_307 ;
} else {
V_331 = true ;
if ( V_125 >= F_178 ( V_306 ) || V_306 [ V_125 ] != NULL ) {
F_68 ( V_2 , L_27 , V_125 ) ;
V_125 = V_307 ;
}
}
...
int V_242 ;
bool V_334 = false ;
for ( V_242 = 0 ; V_242 < F_178 ( V_306 ) ; V_242 ++ ) {
if ( V_306 [ V_242 ] == V_4 )
V_306 [ V_242 ] = NULL ;
else if ( V_306 [ V_242 ] )
V_334 = true ;
...
struct V_336 * V_337 , int V_307 )
{
void T_1 * V_338 ;
V_338 = F_183 ( V_2 , V_337 ) ;
if ( F_30 ( V_338 ) )
return F_31 ( V_338 ) ;
V_307 = F_175 ( V_307 , V_2 ) ;
V_4 -> V_246 = 0 ;
V_4 -> V_8 . V_2 = V_2 ;
V_4 -> V_8 . V_55 = V_337 -> V_339 ;
V_4 -> V_8 . V_9 = V_338 ;
V_4 -> V_8 . V_61 = V_4 -> V_61 ;
V_4 -> V_8 . V_91 = V_340 ;
V_4 -> V_8 . line = V_307 ;
...
V_125 = F_186 ( & V_335 , & V_4 -> V_8 ) ;
if ( V_125 )
F_179 ( V_4 ) ;
return V_125 ;
}
static int F_187 ( struct V_1 * V_2 , const struct V_341 * V_342 )
{
struct V_3 * V_4 ;
struct V_343 * V_167 = V_342 -> V_89 ;
int V_344 , V_125 ;
V_344 = F_181 () ;
if ( V_344 < 0 )
return V_344 ;
...
V_4 -> V_6 = V_167 -> V_6 ;
V_4 -> V_167 = V_167 ;
V_4 -> V_61 = V_167 -> V_345 ( V_2 ) ;
V_4 -> V_8 . V_10 = V_167 -> V_346 ? V_11 : V_347 ;
V_4 -> V_8 . V_195 = V_2 -> V_195 [ 0 ] ;
V_4 -> V_8 . V_252 = & V_348 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_30 , F_2 ( V_2 ) ) ;
V_125 = F_182 ( & V_2 -> V_2 , V_4 , & V_2 -> V_349 , V_344 ) ;
if ( V_125 )
return V_125 ;
F_190 ( V_2 , V_4 ) ;
return F_184 ( V_4 ) ;
...
if ( ! V_4 )
return - V_300 ;
return F_198 ( & V_335 , & V_4 -> V_8 ) ;
}
static int F_199 ( struct V_350 * V_351 )
{
struct V_3 * V_4 ;
struct V_336 * V_352 ;
int V_344 , V_125 ;
int V_353 ;
if ( V_351 -> V_2 . V_87 ) {
struct V_329 * V_330 = V_351 -> V_2 . V_87 ;
V_125 = F_43 ( V_330 , L_31 , & V_353 ) ;
if ( V_125 )
return V_125 ;
} else {
V_353 = 115200 ;
...
if ( V_344 < 0 )
return V_344 ;
V_4 = F_188 ( & V_351 -> V_2 , sizeof( struct V_3 ) ,
V_48 ) ;
if ( ! V_4 )
return - V_49 ;
V_125 = F_200 ( V_351 , 0 ) ;
...
V_4 -> V_167 = & V_354 ;
V_4 -> V_61 = 32 ;
V_4 -> V_8 . V_10 = V_354 . V_346 ? V_11 : V_347 ;
V_4 -> V_8 . V_252 = & V_355 ;
V_4 -> V_291 = V_353 ;
snprintf ( V_4 -> type , sizeof( V_4 -> type ) , L_33 ) ;
V_352 = F_201 ( V_351 , V_356 , 0 ) ;
V_125 = F_182 ( & V_351 -> V_2 , V_4 , V_352 , V_344 ) ;
if ( V_125 )
return V_125 ;
F_202 ( V_351 , V_4 ) ;
return F_184 ( V_4 ) ;
}
static int F_203 ( struct V_350 * V_351 )
{
struct V_3 * V_4 = F_204 ( V_351 ) ;
F_193 ( & V_335 , & V_4 -> V_8 ) ;
F_179 ( V_4 ) ;
return 0 ;
}
