...
memset ( V_19 , 0 , V_20 ) ;
V_199 = V_19 ;
V_199 -> V_21 . V_22 = 0x0010 ;
V_199 -> V_21 . V_23 = 0x0010 ;
V_192 = F_4 ( V_199 ) ;
if ( V_192 ) {
V_192 = ( V_192 == 3 ) ? - V_28 : - V_4 ;
goto exit;
}
V_192 = F_1 ( V_199 -> V_1 . V_23 ) ;
if ( V_192 == 0 ) {
memcpy ( & V_53 , V_199 -> V_197 ,
sizeof( V_53 ) ) ;
...
int F_77 ( void * V_164 , unsigned int V_115 , T_5 V_200 , T_1 * V_201 )
{
struct {
struct V_147 V_21 ;
unsigned int V_202 ;
...
memset ( V_164 , 0 , V_20 ) ;
V_207 = V_164 ;
V_207 -> V_21 . V_22 = 0x0020 ;
V_207 -> V_21 . V_23 = 0x0033 ;
V_207 -> V_115 = V_115 ;
V_207 -> V_200 = V_200 ;
V_208 = F_4 ( V_207 ) ;
if ( V_208 )
return - V_6 ;
V_208 = ( V_207 -> V_1 . V_23 == 0x0001 ) ? 0 : - V_6 ;
if ( V_201 )
* V_201 = V_207 -> V_201 ;
return V_208 ;
}
...
memset ( V_164 , 0 , V_20 ) ;
V_207 = V_164 ;
V_207 -> V_21 . V_22 = 0x0010 ;
V_207 -> V_21 . V_23 = 0x0038 ;
V_208 = F_4 ( V_207 ) ;
if ( V_208 )
return - V_6 ;
memcpy ( V_192 , & V_207 -> V_58 , V_209 ) ;
return ( V_207 -> V_1 . V_23 == 0x0001 ) ? 0 : - V_6 ;
}
...
memset ( V_19 , 0 , V_20 ) ;
V_214 = V_19 ;
V_214 -> V_21 . V_22 = 0x0010 ;
V_214 -> V_21 . V_23 = 0x0046 ;
...
V_215 -> V_21 . V_22 = 0x0020 ;
V_215 -> V_21 . V_23 = 0x004C ;
V_215 -> V_217 = V_216 ;
V_14 = F_4 ( V_215 ) ;
if ( V_14 > 0 ) {
V_15 = ( V_14 == 3 ) ? - V_28 : - V_4 ;
...
V_219 -> V_21 . V_22 = 0x0030 ;
V_219 -> V_21 . V_23 = 0x003d ;
