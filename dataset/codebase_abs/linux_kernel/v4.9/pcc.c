...
V_71 = F_41 ( V_88 , sizeof( void * ) , V_93 ) ;
if ( ! V_71 ) {
V_60 = - V_79 ;
goto V_94;
}
V_41 = F_41 ( V_88 , sizeof( void * ) , V_93 ) ;
if ( ! V_41 ) {
V_60 = - V_79 ;
goto V_95;
}
V_59 = F_41 ( V_88 , sizeof( int ) , V_93 ) ;
if ( ! V_59 ) {
V_60 = - V_79 ;
goto V_96;
}
V_83 = (struct V_72 * ) (
( unsigned long ) V_82 + sizeof( struct V_84 ) ) ;
V_85 = (struct V_84 * ) V_82 ;
if ( V_85 -> V_13 & V_97 )
V_3 . V_98 = true ;
...
V_99 = & V_27 -> V_68 ;
if ( V_99 -> V_101 == V_102 )
V_71 [ V_87 ] = F_34 ( V_99 -> V_78 ,
V_99 -> V_9 / 8 ) ;
V_83 = (struct V_72 * )
( ( unsigned long ) V_83 + V_83 -> V_103 ) ;
}
V_3 . V_4 = V_88 ;
F_42 ( L_13 , V_3 . V_4 ) ;
return 0 ;
