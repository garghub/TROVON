...
return - V_77 ;
if ( V_219 . V_75 >= F_131 ( V_221 ) )
return - V_8 ;
if ( V_219 . V_222 + sizeof( V_219 ) > V_216 )
return - V_8 ;
if ( ! V_221 [ V_219 . V_75 ] )
return - V_162 ;
V_60 = V_221 [ V_219 . V_75 ] ( V_4 , V_215 + sizeof( V_219 ) , V_219 . V_222 , V_219 . V_67 ) ;
if ( ! V_60 )
V_60 = V_216 ;
return V_60 ;
}
static unsigned int F_132 ( struct V_4 * V_78 , struct V_223 * V_224 )
{
struct V_3 * V_4 = V_78 -> V_32 ;
unsigned int V_225 = 0 ;
V_70 ( V_78 , & V_4 -> V_70 , V_224 ) ;
if ( ! F_40 ( & V_4 -> V_69 ) )
V_225 = V_226 | V_227 ;
return V_225 ;
}
static int F_133 ( struct V_228 * V_228 , struct V_4 * V_78 )
{
struct V_3 * V_4 ;
V_4 = F_134 ( sizeof *V_4 , V_20 ) ;
if ( ! V_4 )
return - V_66 ;
V_4 -> V_58 = F_135 ( L_2 ,
V_229 ) ;
...
V_78 -> V_32 = V_4 ;
V_4 -> V_78 = V_78 ;
return F_138 ( V_228 , V_78 ) ;
}
static int F_139 ( struct V_228 * V_228 , struct V_4 * V_78 )
{
struct V_3 * V_4 = V_78 -> V_32 ;
...
static T_1 F_141 ( struct V_135 * V_230 ,
struct V_231 * V_232 ,
char * V_215 )
{
return sprintf ( V_215 , L_3 , V_233 ) ;
}
...
if ( V_60 )
return V_60 ;
V_60 = F_144 ( V_234 . V_235 , & V_236 ) ;
if ( V_60 ) {
F_35 ( L_4 ) ;
goto V_99;
}
V_237 = F_145 ( & V_238 , L_5 , V_239 ) ;
if ( ! V_237 ) {
F_35 ( L_6 ) ;
V_60 = - V_66 ;
goto V_100;
