...
static int
F_82 ( struct V_1 * V_2 , int V_27 )
{
return 0 ;
}
static enum V_60
F_83 ( struct V_1 * V_2 , bool V_142 )
{
return V_66 ;
}
static int
...
if ( V_8 -> V_81 && V_187 -> V_195 ) {
if ( V_8 -> V_81 -> V_160 . V_161 == V_187 -> V_161 ) {
V_8 -> V_154 = true ;
V_154 = true ;
}
if ( V_8 -> V_196 && V_78 -> V_79 &&
( V_8 -> V_78 . V_197 == V_78 -> V_197 ) ) {
V_8 -> V_154 = false ;
V_154 = false ;
}
}
...
V_8 = F_87 ( sizeof( struct V_8 ) , V_74 ) ;
if ( ! V_8 )
return;
V_2 = & V_8 -> V_111 ;
V_8 -> V_184 = V_184 ;
...
V_8 -> V_9 = * V_9 ;
V_8 -> V_78 = * V_78 ;
if ( V_78 -> V_79 || V_78 -> V_198 ) {
V_8 -> V_196 = F_88 ( V_6 , & V_78 -> V_199 ) ;
if ( ! V_8 -> V_196 )
F_64 ( L_15 ) ;
}
if ( V_193 ) {
V_172 = F_87 ( sizeof( struct V_15 ) , V_74 ) ;
if ( ! V_172 )
goto V_200;
V_8 -> V_17 = V_172 ;
if ( V_187 -> V_195 ) {
V_8 -> V_81 = F_88 ( V_6 , V_187 ) ;
if ( V_8 -> V_81 )
V_82 = true ;
else
F_64 ( L_16 ) ;
...
switch ( V_13 ) {
case V_162 :
F_89 ( V_4 , & V_8 -> V_111 , & V_212 , V_13 ) ;
F_90 ( & V_8 -> V_111 , & V_213 ) ;
if ( V_187 -> V_195 ) {
V_8 -> V_81 = F_88 ( V_6 , V_187 ) ;
if ( ! V_8 -> V_81 )
F_64 ( L_17 ) ;
...
goto V_200;
V_8 -> V_17 = V_172 ;
F_89 ( V_4 , & V_8 -> V_111 , & V_214 , V_13 ) ;
F_90 ( & V_8 -> V_111 , & V_215 ) ;
if ( V_187 -> V_195 ) {
V_8 -> V_81 = F_88 ( V_6 , V_187 ) ;
if ( ! V_8 -> V_81 )
F_64 ( L_19 ) ;
...
goto V_200;
V_8 -> V_17 = V_172 ;
F_89 ( V_4 , & V_8 -> V_111 , & V_202 , V_13 ) ;
F_90 ( & V_8 -> V_111 , & V_203 ) ;
if ( V_187 -> V_195 ) {
V_8 -> V_81 = F_88 ( V_6 , V_187 ) ;
if ( V_8 -> V_81 )
V_82 = true ;
...
goto V_200;
V_8 -> V_17 = V_172 ;
F_89 ( V_4 , & V_8 -> V_111 , & V_216 , V_13 ) ;
F_90 ( & V_8 -> V_111 , & V_217 ) ;
if ( V_187 -> V_195 ) {
V_8 -> V_81 = F_88 ( V_6 , V_187 ) ;
if ( ! V_8 -> V_81 )
F_64 ( L_21 ) ;
...
goto V_200;
V_8 -> V_17 = V_172 ;
F_89 ( V_4 , & V_8 -> V_111 , & V_219 , V_13 ) ;
F_90 ( & V_8 -> V_111 , & V_220 ) ;
V_191 = V_210 ;
V_2 -> V_204 = false ;
V_2 -> V_205 = false ;
break;
