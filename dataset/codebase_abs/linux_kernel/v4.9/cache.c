...
void
F_78 ( unsigned long V_77 , unsigned long V_92 )
{
if ( ( V_92 - V_77 ) < V_82 )
F_75 ( V_77 , V_92 ) ;
else
...
void
F_79 ( unsigned long V_77 , unsigned long V_92 )
{
if ( ( V_92 - V_77 ) < V_82 )
F_76 ( V_77 , V_92 ) ;
else
...
void
F_82 ( struct V_3 * V_4 , unsigned long V_56 , unsigned long V_7 )
{
F_81 ( ! V_4 -> V_104 -> V_103 ) ;
if ( F_7 ( V_7 ) ) {
F_39 ( V_4 , V_56 ) ;
