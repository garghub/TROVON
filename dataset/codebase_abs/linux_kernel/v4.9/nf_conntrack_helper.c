...
#endif
if ( V_32 != NULL && ! F_17 ( V_32 -> V_37 ) )
V_32 = NULL ;
return V_32 ;
}
struct V_38 *
F_18 ( struct V_39 * V_8 ,
...
int F_22 ( struct V_39 * V_8 , struct V_39 * V_45 ,
T_3 V_46 )
{
...
if ( V_41 == NULL ) {
V_41 = F_18 ( V_8 , V_29 , V_46 ) ;
if ( V_41 == NULL )
return - V_15 ;
} else {
struct V_28 * V_52 = F_30 ( V_41 -> V_29 ) ;
...
{
struct V_39 * V_8 = F_33 ( V_35 ) ;
struct V_38 * V_41 = F_25 ( V_8 ) ;
if ( V_41 && F_34 ( V_41 -> V_29 ) == V_37 ) {
F_35 ( V_54 , V_8 ) ;
F_29 ( V_41 -> V_29 , NULL ) ;
}
return 0 ;
}
void F_36 ( struct V_39 * V_8 )
{
struct V_38 * V_41 = F_25 ( V_8 ) ;
struct V_28 * V_29 ;
if ( V_41 ) {
...
struct V_38 * V_41 = F_25 ( exp -> V_92 ) ;
if ( ( F_65 (
V_41 -> V_29 ,
F_66 ( & V_58 )
) == V_37 || exp -> V_29 == V_37 ) &&
