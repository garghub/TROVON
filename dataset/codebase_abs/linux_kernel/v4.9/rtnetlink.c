...
const char * V_407 , unsigned char V_443 ,
...
V_316 = V_25 -> V_445 () ;
V_32 = - V_423 ;
V_35 = F_201 ( V_25 -> V_446 , V_407 , V_443 ,
...
if ( 1 ) {
struct V_47 * V_204 [ V_25 ? V_25 -> V_453 + 1 : 1 ] ;
struct V_47 * V_454 [ V_450 ? V_450 -> V_455 + 1 : 1 ] ;
struct V_47 * * V_63 = NULL ;
struct V_47 * * V_57 = NULL ;
struct V_33 * V_456 , * V_335 = NULL ;
if ( V_25 ) {
if ( V_25 -> V_453 && V_69 [ V_67 ] ) {
V_32 = F_138 ( V_204 , V_25 -> V_453 ,
V_69 [ V_67 ] ,
V_25 -> V_457 ) ;
if ( V_32 < 0 )
return V_32 ;
...
! V_25 -> V_464 )
return - V_199 ;
V_32 = V_25 -> V_464 ( V_35 , V_357 , V_63 ) ;
if ( V_32 < 0 )
return V_32 ;
V_408 |= V_419 ;
}
if ( V_69 [ V_61 ] ) {
if ( ! V_450 || ! V_450 -> V_465 )
return - V_199 ;
V_32 = V_450 -> V_465 ( V_45 , V_35 ,
V_357 , V_57 ) ;
if ( V_32 < 0 )
return V_32 ;
V_408 |= V_419 ;
...
if ( V_357 [ V_277 ] || V_357 [ V_318 ] || V_357 [ V_467 ] )
return - V_199 ;
if ( ! V_25 ) {
#ifdef F_206
if ( V_24 [ 0 ] ) {
...
V_456 = F_154 ( V_33 , V_357 ) ;
if ( F_168 ( V_456 ) )
return F_169 ( V_456 ) ;
V_32 = - V_412 ;
if ( ! F_170 ( V_56 , V_456 -> V_410 , V_411 ) )
goto V_71;
if ( V_357 [ V_336 ] ) {
int V_102 = F_189 ( V_357 [ V_336 ] ) ;
V_335 = F_208 ( V_456 , V_102 ) ;
if ( ! V_335 ) {
V_32 = - V_376 ;
goto V_71;
}
...
if ( V_25 -> V_469 ) {
V_32 = V_25 -> V_469 ( V_335 ? : V_33 , V_35 , V_357 , V_63 ) ;
if ( V_32 < 0 ) {
if ( V_35 -> V_470 == V_471 )
F_209 ( V_35 ) ;
goto V_71;
...
if ( V_35 == NULL )
return - V_418 ;
V_473 = F_213 ( F_99 ( V_35 , V_53 ) , V_20 ) ;
if ( V_473 == NULL )
return - V_21 ;
V_32 = F_122 ( V_473 , V_35 , V_369 , F_64 ( V_56 ) . V_370 ,
V_82 -> V_371 , 0 , 0 , V_53 ) ;
if ( V_32 < 0 ) {
F_149 ( V_32 == - V_59 ) ;
F_6 ( V_473 ) ;
} else
V_32 = F_68 ( V_473 , V_33 , F_64 ( V_56 ) . V_370 ) ;
return V_32 ;
}
...
int type = V_350 -> V_82 -> V_476 - V_9 ;
if ( V_354 < V_355 || V_354 == V_477 )
continue;
if ( V_15 [ V_354 ] == NULL ||
...
int V_32 = - V_21 ;
T_4 V_479 ;
V_56 = F_213 ( ( V_479 = F_99 ( V_35 , 0 ) ) , V_83 ) ;
if ( V_56 == NULL )
goto V_409;
...
V_409:
if ( V_32 < 0 )
F_73 ( V_33 , V_480 , V_32 ) ;
return NULL ;
}
void F_219 ( struct V_2 * V_56 , struct V_34 * V_35 , T_6 V_83 )
{
struct V_33 * V_33 = F_132 ( V_35 ) ;
F_70 ( V_56 , V_33 , 0 , V_480 , NULL , V_83 ) ;
}
...
struct V_34 * V_35 ,
T_10 * V_482 , T_9 V_483 , T_5 V_73 , T_5 V_287 ,
int type , unsigned int V_83 ,
int V_484 , T_9 V_485 )
{
struct V_81 * V_82 ;
struct V_486 * V_487 ;
V_82 = F_124 ( V_56 , V_73 , V_287 , type , sizeof( * V_487 ) , V_484 ) ;
if ( ! V_82 )
return - V_59 ;
V_487 = F_125 ( V_82 ) ;
V_487 -> V_488 = V_489 ;
...
V_487 -> V_492 = V_83 ;
V_487 -> V_493 = 0 ;
V_487 -> V_494 = V_35 -> V_296 ;
V_487 -> V_485 = V_485 ;
if ( F_84 ( V_56 , V_495 , V_496 , V_482 ) )
goto V_95;
if ( V_483 )
if ( F_84 ( V_56 , V_497 , sizeof( T_9 ) , & V_483 ) )
goto V_95;
F_135 ( V_56 , V_82 ) ;
return 0 ;
V_95:
...
{
return F_100 ( sizeof( struct V_486 ) ) +
F_48 ( V_496 ) +
F_48 ( sizeof( T_9 ) ) +
0 ;
}
static void F_223 ( struct V_34 * V_35 , T_10 * V_482 , T_9 V_483 , int type ,
T_9 V_485 )
{
struct V_33 * V_33 = F_132 ( V_35 ) ;
struct V_2 * V_56 ;
int V_32 = - V_21 ;
V_56 = F_213 ( F_222 () , V_498 ) ;
if ( ! V_56 )
goto V_409;
V_32 = F_221 ( V_56 , V_35 , V_482 , V_483 ,
0 , 0 , type , V_499 , 0 , V_485 ) ;
if ( V_32 < 0 ) {
F_6 ( V_56 ) ;
goto V_409;
}
F_70 ( V_56 , V_33 , 0 , V_500 , NULL , V_498 ) ;
return;
V_409:
F_73 ( V_33 , V_500 , V_32 ) ;
}
int F_224 ( struct V_486 * V_487 ,
struct V_47 * V_357 [] ,
struct V_34 * V_35 ,
const unsigned char * V_482 , T_9 V_483 ,
T_9 V_83 )
{
int V_32 = - V_376 ;
if ( V_487 -> V_485 && ! ( V_487 -> V_485 & V_501 ) ) {
F_225 ( L_6 , V_35 -> V_94 ) ;
return V_32 ;
}
if ( V_483 ) {
...
if ( F_226 ( V_482 ) || F_227 ( V_482 ) )
V_32 = F_228 ( V_35 , V_482 ) ;
else if ( F_229 ( V_482 ) )
V_32 = F_230 ( V_35 , V_482 ) ;
if ( V_32 == - V_26 && ! ( V_83 & V_462 ) )
V_32 = 0 ;
return V_32 ;
}
static int F_231 ( struct V_47 * V_502 , T_9 * V_503 )
{
T_9 V_483 = 0 ;
if ( V_502 ) {
if ( F_159 ( V_502 ) != sizeof( T_9 ) ) {
F_225 ( L_8 ) ;
return - V_376 ;
}
V_483 = F_232 ( V_502 ) ;
if ( ! V_483 || V_483 >= V_504 ) {
F_225 ( L_9 ,
V_483 ) ;
return - V_376 ;
}
...
struct V_33 * V_33 = F_144 ( V_56 -> V_351 ) ;
struct V_486 * V_487 ;
struct V_47 * V_357 [ V_505 + 1 ] ;
struct V_34 * V_35 ;
T_10 * V_482 ;
T_9 V_483 ;
int V_32 ;
V_32 = F_146 ( V_82 , sizeof( * V_487 ) , V_357 , V_505 , NULL ) ;
if ( V_32 < 0 )
return V_32 ;
V_487 = F_125 ( V_82 ) ;
if ( V_487 -> V_494 == 0 ) {
...
V_35 = F_166 ( V_33 , V_487 -> V_494 ) ;
if ( V_35 == NULL ) {
F_225 ( L_11 ) ;
return - V_418 ;
}
if ( ! V_357 [ V_495 ] || F_159 ( V_357 [ V_495 ] ) != V_496 ) {
F_225 ( L_12 ) ;
return - V_376 ;
}
V_482 = F_112 ( V_357 [ V_495 ] ) ;
V_32 = F_231 ( V_357 [ V_497 ] , & V_483 ) ;
if ( V_32 )
return V_32 ;
V_32 = - V_199 ;
if ( ( ! V_487 -> V_492 || V_487 -> V_492 & V_506 ) &&
( V_35 -> V_507 & V_508 ) ) {
struct V_34 * V_509 = F_47 ( V_35 ) ;
const struct V_384 * V_25 = V_509 -> V_179 ;
V_32 = V_25 -> V_510 ( V_487 , V_357 , V_35 , V_482 , V_483 ,
V_82 -> V_461 ) ;
if ( V_32 )
goto V_71;
else
...
if ( ( V_487 -> V_492 & V_499 ) ) {
if ( V_35 -> V_179 -> V_510 )
V_32 = V_35 -> V_179 -> V_510 ( V_487 , V_357 , V_35 , V_482 ,
V_483 ,
V_82 -> V_461 ) ;
else
V_32 = F_224 ( V_487 , V_357 , V_35 , V_482 , V_483 ,
V_82 -> V_461 ) ;
if ( ! V_32 ) {
F_223 ( V_35 , V_482 , V_483 , V_511 ,
V_487 -> V_485 ) ;
V_487 -> V_492 &= ~ V_499 ;
}
}
...
int F_234 ( struct V_486 * V_487 ,
struct V_47 * V_357 [] ,
struct V_34 * V_35 ,
const unsigned char * V_482 , T_9 V_483 )
{
int V_32 = - V_376 ;
if ( ! ( V_487 -> V_485 & V_501 ) ) {
F_225 ( L_6 , V_35 -> V_94 ) ;
return V_32 ;
}
if ( F_226 ( V_482 ) || F_227 ( V_482 ) )
V_32 = F_235 ( V_35 , V_482 ) ;
else if ( F_229 ( V_482 ) )
V_32 = F_236 ( V_35 , V_482 ) ;
return V_32 ;
}
...
const struct V_384 * V_25 = V_509 -> V_179 ;
if ( V_25 -> V_512 )
V_32 = V_25 -> V_512 ( V_487 , V_357 , V_35 , V_482 , V_483 ) ;
if ( V_32 )
goto V_71;
else
V_487 -> V_492 &= ~ V_506 ;
...
if ( V_487 -> V_492 & V_499 ) {
if ( V_35 -> V_179 -> V_512 )
V_32 = V_35 -> V_179 -> V_512 ( V_487 , V_357 , V_35 , V_482 ,
V_483 ) ;
else
V_32 = F_234 ( V_487 , V_357 , V_35 , V_482 , V_483 ) ;
if ( ! V_32 ) {
F_223 ( V_35 , V_482 , V_483 , V_513 ,
V_487 -> V_485 ) ;
V_487 -> V_492 &= ~ V_499 ;
}
}
...
goto V_517;
V_32 = F_221 ( V_56 , V_35 , V_516 -> V_482 , 0 ,
V_370 , V_287 ,
V_511 , V_499 ,
V_359 , V_501 ) ;
if ( V_32 < 0 )
...
int V_32 ;
F_241 ( V_35 ) ;
V_32 = F_239 ( V_56 , V_350 , V_35 , V_354 , & V_35 -> V_519 ) ;
if ( V_32 )
goto V_71;
F_239 ( V_56 , V_350 , V_35 , V_354 , & V_35 -> V_520 ) ;
V_71:
F_242 ( V_35 ) ;
return V_32 ;
}
...
struct V_34 * V_35 ;
struct V_47 * V_357 [ V_358 + 1 ] ;
struct V_34 * V_509 = NULL ;
const struct V_384 * V_25 = NULL ;
const struct V_384 * V_521 = NULL ;
...
V_363 ) == 0 ) {
if ( V_357 [ V_318 ] )
V_523 = F_147 ( V_357 [ V_318 ] ) ;
}
V_522 = V_127 -> V_295 ;
if ( V_523 ) {
V_509 = F_166 ( V_33 , V_523 ) ;
if ( ! V_509 )
return - V_418 ;
V_25 = V_509 -> V_179 ;
}
...
goto V_368;
if ( V_35 -> V_507 & V_508 ) {
if ( V_521 && V_521 -> V_526 ) {
V_32 = V_521 -> V_526 ( V_56 , V_350 ,
V_509 , V_35 ,
& V_524 ) ;
if ( V_32 == - V_59 )
goto V_71;
...
if ( V_35 -> V_179 -> V_526 )
V_32 = V_35 -> V_179 -> V_526 ( V_56 , V_350 ,
V_35 , NULL ,
& V_524 ) ;
else
...
static int F_244 ( struct V_2 * V_56 , T_5 V_83 , T_5 V_527 ,
unsigned int V_528 , unsigned int V_529 )
{
if ( V_527 & V_529 )
return F_121 ( V_56 , V_528 , ! ! ( V_83 & V_529 ) ) ;
return 0 ;
}
int F_245 ( struct V_2 * V_56 , T_5 V_73 , T_5 V_287 ,
struct V_34 * V_35 , T_9 V_530 ,
T_5 V_83 , T_5 V_527 , int V_484 ,
T_5 V_531 ,
...
struct V_34 * V_509 = F_47 ( V_35 ) ;
int V_32 = 0 ;
V_82 = F_124 ( V_56 , V_73 , V_287 , V_369 , sizeof( * V_127 ) , V_484 ) ;
if ( V_82 == NULL )
return - V_59 ;
V_127 = F_125 ( V_82 ) ;
V_127 -> V_291 = V_489 ;
...
( V_509 &&
F_78 ( V_56 , V_318 , V_509 -> V_296 ) ) ||
( V_35 -> V_328 &&
F_84 ( V_56 , V_329 , V_35 -> V_328 , V_35 -> V_330 ) ) ||
( V_35 -> V_296 != F_129 ( V_35 ) &&
F_78 ( V_56 , V_317 , F_129 ( V_35 ) ) ) )
goto V_95;
V_532 = F_58 ( V_56 , V_337 ) ;
if ( ! V_532 )
goto V_95;
if ( F_247 ( V_56 , V_534 , V_535 ) ) {
F_60 ( V_56 , V_532 ) ;
goto V_95;
}
if ( V_530 != V_536 ) {
if ( F_247 ( V_56 , V_537 , V_530 ) ) {
F_60 ( V_56 , V_532 ) ;
goto V_95;
}
}
if ( F_246 ) {
V_32 = F_246 ( V_56 , V_35 , V_531 ) ;
if ( V_32 ) {
F_60 ( V_56 , V_532 ) ;
goto V_95;
}
...
F_59 ( V_56 , V_532 ) ;
V_533 = F_58 ( V_56 , V_467 | V_538 ) ;
if ( ! V_533 )
goto V_95;
if ( F_244 ( V_56 , V_83 , V_527 ,
V_539 , V_540 ) ||
F_244 ( V_56 , V_83 , V_527 ,
V_541 , V_542 ) ||
F_244 ( V_56 , V_83 , V_527 ,
V_543 ,
V_544 ) ||
...
struct V_47 * V_555 ;
V_555 = F_249 ( V_350 -> V_82 , sizeof( struct V_126 ) ,
V_364 ) ;
if ( V_555 ) {
if ( F_159 ( V_555 ) < sizeof( V_531 ) )
return - V_376 ;
V_531 = F_147 ( V_555 ) ;
}
}
...
const struct V_384 * V_25 = V_35 -> V_179 ;
struct V_34 * V_509 = F_47 ( V_35 ) ;
if ( V_509 && V_509 -> V_179 -> V_556 ) {
if ( V_354 >= V_350 -> args [ 0 ] ) {
V_32 = V_509 -> V_179 -> V_556 (
...
if ( ! V_35 -> V_179 -> V_556 )
return 0 ;
V_56 = F_213 ( F_253 () , V_498 ) ;
if ( ! V_56 ) {
V_32 = - V_423 ;
goto V_409;
}
V_32 = V_35 -> V_179 -> V_556 ( V_56 , 0 , 0 , V_35 , 0 , 0 ) ;
if ( V_32 < 0 )
goto V_409;
if ( ! V_56 -> V_372 )
goto V_409;
F_70 ( V_56 , V_33 , 0 , V_480 , NULL , V_498 ) ;
return 0 ;
V_409:
F_149 ( V_32 == - V_59 ) ;
F_6 ( V_56 ) ;
...
V_557 = F_249 ( V_82 , sizeof( struct V_126 ) , V_337 ) ;
if ( V_557 ) {
F_160 (attr, br_spec, rem) {
if ( F_161 ( V_204 ) == V_534 ) {
...
if ( ! V_83 || ( V_83 & V_560 ) ) {
struct V_34 * V_509 = F_47 ( V_35 ) ;
if ( ! V_509 || ! V_509 -> V_179 -> V_561 ) {
V_32 = - V_199 ;
goto V_71;
}
V_32 = V_509 -> V_179 -> V_561 ( V_35 , V_82 , V_83 ) ;
if ( V_32 )
goto V_71;
V_83 &= ~ V_560 ;
}
...
V_32 = V_35 -> V_179 -> V_561 ( V_35 , V_82 ,
V_83 ) ;
if ( ! V_32 ) {
V_83 &= ~ V_535 ;
V_32 = F_254 ( V_35 ) ;
...
if ( ! V_83 || ( V_83 & V_560 ) ) {
struct V_34 * V_509 = F_47 ( V_35 ) ;
if ( ! V_509 || ! V_509 -> V_179 -> V_562 ) {
V_32 = - V_199 ;
goto V_71;
}
V_32 = V_509 -> V_179 -> V_562 ( V_35 , V_82 , V_83 ) ;
if ( V_32 )
goto V_71;
V_83 &= ~ V_560 ;
}
...
V_32 = V_35 -> V_179 -> V_562 ( V_35 , V_82 ,
V_83 ) ;
if ( ! V_32 ) {
V_83 &= ~ V_535 ;
V_32 = F_254 ( V_35 ) ;
...
static bool F_257 ( unsigned int V_527 , int V_563 , int V_564 )
{
return ( V_527 & F_258 ( V_563 ) ) &&
( ! V_564 || V_564 == V_563 ) ;
}
static int F_259 ( int V_565 )
{
switch ( V_565 ) {
case V_566 :
...
void * V_568 ;
int V_32 ;
if ( ! ( V_35 -> V_179 && V_35 -> V_179 -> V_569 &&
V_35 -> V_179 -> V_570 ) )
return - V_340 ;
for ( V_565 = V_571 ;
V_565 <= V_572 ; V_565 ++ ) {
...
if ( ! V_48 )
continue;
if ( ! V_35 -> V_179 -> V_569 ( V_565 ) )
continue;
V_204 = F_111 ( V_56 , V_565 , V_48 ,
V_573 ) ;
if ( ! V_204 )
goto V_95;
V_568 = F_112 ( V_204 ) ;
memset ( V_568 , 0 , V_48 ) ;
V_32 = V_35 -> V_179 -> V_570 ( V_565 , V_35 ,
V_568 ) ;
if ( V_32 )
goto V_574;
}
...
int type , T_5 V_73 , T_5 V_287 , T_5 V_288 ,
unsigned int V_83 , unsigned int V_531 ,
int * V_564 , int * V_567 )
{
struct V_576 * V_577 ;
struct V_81 * V_82 ;
...
int V_32 ;
F_123 () ;
V_82 = F_124 ( V_56 , V_73 , V_287 , type , sizeof( * V_577 ) , V_83 ) ;
if ( ! V_82 )
return - V_59 ;
V_577 = F_125 ( V_82 ) ;
V_577 -> V_296 = V_35 -> V_296 ;
V_577 -> V_531 = V_531 ;
if ( F_257 ( V_531 , V_579 , * V_564 ) ) {
struct V_132 * V_210 ;
V_204 = F_111 ( V_56 , V_579 ,
sizeof( struct V_132 ) ,
V_580 ) ;
if ( ! V_204 )
goto V_95;
...
if ( ! V_204 )
goto V_95;
V_32 = V_25 -> V_582 ( V_56 , V_35 , V_567 , * V_564 ) ;
F_59 ( V_56 , V_204 ) ;
if ( V_32 )
goto V_95;
* V_564 = 0 ;
...
if ( F_257 ( V_531 , V_584 ,
* V_564 ) ) {
* V_564 = V_584 ;
V_204 = F_58 ( V_56 , V_584 ) ;
if ( ! V_204 )
goto V_95;
V_32 = F_260 ( V_56 , V_35 , V_567 ) ;
if ( V_32 == - V_340 )
F_60 ( V_56 , V_204 ) ;
else
F_59 ( V_56 , V_204 ) ;
...
{
T_4 V_48 = 0 ;
if ( F_257 ( V_531 , V_579 , 0 ) )
V_48 += F_96 ( sizeof( struct V_132 ) ) ;
if ( F_257 ( V_531 , V_581 , 0 ) ) {
const struct V_23 * V_25 = V_35 -> V_23 ;
int V_204 = V_581 ;
if ( V_25 && V_25 -> V_585 ) {
V_48 += F_48 ( V_25 -> V_585 ( V_35 ,
V_204 ) ) ;
V_48 += F_48 ( 0 ) ;
}
}
if ( F_257 ( V_531 , V_583 , 0 ) ) {
struct V_34 * V_586 = (struct V_34 * ) V_35 ;
const struct V_23 * V_25 = NULL ;
const struct V_34 * V_347 ;
V_347 = F_47 ( V_586 ) ;
if ( V_347 )
...
if ( ! V_531 )
return - V_376 ;
V_473 = F_213 ( F_263 ( V_35 , V_531 ) , V_20 ) ;
if ( ! V_473 )
return - V_21 ;
V_32 = F_262 ( V_473 , V_35 , V_587 ,
...
{
int V_352 , V_353 , V_32 , V_355 , V_588 , V_578 ;
struct V_33 * V_33 = F_144 ( V_56 -> V_351 ) ;
unsigned int V_83 = V_359 ;
struct V_576 * V_577 ;
struct V_356 * V_3 ;
...
return 0 ;
V_52 = ( (struct V_362 * ) F_125 ( V_82 ) ) -> V_590 ;
V_24 = type & 3 ;
if ( V_24 != 2 && ! F_267 ( V_56 , V_411 ) )
return - V_412 ;
if ( V_24 == 2 && V_82 -> V_461 & V_591 ) {
struct V_76 * V_77 ;
T_2 V_18 ;
T_3 V_19 ;
T_9 V_592 = 0 ;
...
V_32 = F_268 ( V_77 , V_56 , V_82 , & V_594 ) ;
}
F_1 () ;
return V_32 ;
}
...
static int F_271 ( struct V_596 * V_597 , unsigned long V_598 , void * V_599 )
{
struct V_34 * V_35 = F_272 ( V_599 ) ;
switch ( V_598 ) {
case V_600 :
case V_601 :
case V_602 :
...
F_24 ( L_17 ) ;
F_279 ( & V_623 ) ;
F_23 ( V_17 , V_624 , F_212 ,
F_143 , F_214 ) ;
F_23 ( V_17 , V_625 , F_191 , NULL , NULL ) ;
F_23 ( V_17 , V_369 , F_205 , NULL , NULL ) ;
F_23 ( V_17 , V_626 , F_196 , NULL , NULL ) ;
F_23 ( V_17 , V_627 , NULL , F_217 , NULL ) ;
F_23 ( V_17 , V_628 , NULL , F_217 , NULL ) ;
F_23 ( V_629 , V_511 , F_233 , NULL , NULL ) ;
F_23 ( V_629 , V_513 , F_237 , NULL , NULL ) ;
F_23 ( V_629 , V_630 , NULL , F_243 , NULL ) ;
F_23 ( V_629 , V_624 , NULL , F_248 , NULL ) ;
F_23 ( V_629 , V_626 , F_256 , NULL , NULL ) ;
F_23 ( V_629 , V_625 , F_255 , NULL , NULL ) ;
F_23 ( V_17 , V_631 , F_264 , F_265 ,
NULL ) ;
}
