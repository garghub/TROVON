...
F_50 ( V_2 ) ;
F_76 ( V_94 , V_95 , V_22 , V_40 , V_2 ,
V_82 , V_2 -> V_10 , V_96 , 1 ) ;
return 0 ;
}
static unsigned int F_77 ( void * V_76 ,
struct V_1 * V_2 ,
const struct V_77 * V_78 )
{
struct V_14 * V_8 ;
...
V_2 -> V_3 = F_3 ( V_92 ) ;
F_69 ( V_98 , V_102 , V_78 -> V_22 , NULL , V_2 ,
F_56 ( V_2 , V_78 -> V_82 ) ,
V_97 , F_72 ) ;
return V_91 ;
}
static unsigned int F_79 ( void * V_76 ,
struct V_1 * V_2 ,
const struct V_77 * V_78 )
{
struct V_11 * V_79 ;
struct V_80 * V_13 ;
struct V_9 * * V_103 = (struct V_9 * * ) ( V_2 -> V_93 ) ;
V_79 = F_10 ( V_78 -> V_99 ) ;
if ( V_79 == NULL )
return V_85 ;
V_13 = V_79 -> V_13 ;
...
* V_103 = V_78 -> V_82 ;
F_69 ( V_107 , V_108 , V_78 -> V_22 , V_78 -> V_40 , V_2 ,
V_78 -> V_82 , V_78 -> V_99 , F_72 ) ;
return V_91 ;
}
static int F_81 ( struct V_22 * V_22 , struct V_39 * V_40 , struct V_1 * V_2 )
{
struct V_109 * V_110 ;
int V_58 ;
V_110 = F_82 ( & V_111 ) ;
V_58 = F_83 ( V_2 , V_110 -> V_112 ) ;
if ( V_58 ) {
F_39 ( V_2 ) ;
return 0 ;
}
...
F_7 ( V_2 ) ;
return F_86 ( V_22 , V_40 , V_2 ) ;
}
static int
F_87 ( struct V_22 * V_22 , struct V_39 * V_40 , struct V_1 * V_2 ,
int (* V_53)( struct V_22 * , struct V_39 * , struct V_1 * ) )
{
unsigned int V_116 = F_88 ( V_40 , V_2 ) ;
struct V_23 * V_24 = F_23 ( V_2 ) ;
...
return F_90 ( V_22 , V_40 , V_2 , V_53 ) ;
}
...
static int F_92 ( struct V_22 * V_22 , struct V_39 * V_40 , struct V_1 * V_2 )
{
struct V_14 * V_8 ;
unsigned int V_122 ;
V_122 = F_91 ( V_2 ) ;
if ( F_93 ( V_2 ) || V_2 -> V_20 + V_122 <= V_2 -> V_10 -> V_116 ) {
F_7 ( V_2 ) ;
return F_86 ( V_22 , V_40 , V_2 ) ;
}
V_8 = F_34 ( V_2 ) ;
...
V_110 -> V_112 ) ;
return F_87 ( V_22 , V_40 , V_2 , F_81 ) ;
}
if ( F_94 ( V_124 ) &&
V_2 -> V_3 == F_3 ( V_92 ) ) {
const struct V_125 * V_126 = F_95 () ;
struct V_109 * V_110 ;
if ( F_78 ( V_22 , V_2 ) )
goto V_31;
F_75 ( V_2 ) -> V_59 = V_8 -> V_59 ;
...
V_110 -> V_112 ) ;
if ( V_126 )
return V_126 -> V_127 ( V_22 , V_40 , V_2 , F_81 ) ;
F_39 ( V_2 ) ;
return - V_121 ;
}
F_7 ( V_2 ) ;
...
V_2 -> V_3 = F_3 ( V_92 ) ;
F_69 ( V_98 , V_129 , V_78 -> V_22 , V_78 -> V_40 , V_2 ,
NULL , V_128 ,
F_92 ) ;
return V_91 ;
}
static unsigned int F_97 ( void * V_76 ,
struct V_1 * V_2 ,
const struct V_77 * V_78 )
{
...
F_18 ( V_2 , V_6 ) ;
V_8 -> V_52 = 0 ;
F_99 ( sizeof( V_8 -> V_51 ) != ( V_6 - V_50 ) ) ;
F_84 ( V_2 , - ( V_6 - V_50 ) ,
V_8 -> V_51 ,
V_6 - V_50 ) ;
V_2 -> V_10 = V_8 -> V_49 ;
V_8 -> V_101 = NULL ;
F_36 ( F_100 ( V_2 -> V_10 ) , NULL , V_2 ) ;
}
...
static int F_103 ( struct V_131 * V_132 , unsigned long V_133 ,
void * V_134 )
{
struct V_9 * V_10 = F_104 ( V_134 ) ;
struct V_135 * V_136 ;
struct V_22 * V_22 ;
int V_46 ;
...
F_105 () ;
V_22 = F_100 ( V_10 ) ;
V_136 = F_106 ( V_22 , V_141 ) ;
if ( V_136 -> V_142 )
return V_143 ;
V_46 = F_107 ( V_22 , V_144 , F_108 ( V_144 ) ) ;
if ( V_46 )
return V_145 ;
V_136 -> V_142 = true ;
return V_143 ;
}
static void T_5 F_109 ( struct V_22 * V_22 )
{
struct V_135 * V_136 = F_106 ( V_22 , V_141 ) ;
if ( ! V_136 -> V_142 )
return;
F_110 ( V_22 , V_144 , F_108 ( V_144 ) ) ;
V_136 -> V_142 = false ;
}
int F_51 ( unsigned int V_146 , struct V_22 * V_22 ,
struct V_39 * V_40 , struct V_1 * V_2 ,
struct V_9 * V_147 ,
struct V_9 * V_148 ,
int (* F_111)( struct V_22 * , struct V_39 * ,
struct V_1 * ) )
{
struct V_149 * V_150 ;
struct V_77 V_78 ;
int V_46 ;
V_150 = F_112 ( V_22 -> V_151 . V_152 [ V_94 ] [ V_146 ] ) ;
while ( V_150 && ( V_150 -> V_153 . V_154 <= V_155 ) )
V_150 = F_112 ( V_150 -> V_156 ) ;
if ( ! V_150 )
return F_111 ( V_22 , V_40 , V_2 ) ;
F_113 () ;
F_114 ( & V_78 , V_150 , V_146 , V_155 + 1 ,
V_94 , V_147 , V_148 , V_40 , V_22 , F_111 ) ;
V_46 = F_115 ( V_2 , & V_78 ) ;
F_116 () ;
if ( V_46 == 1 )
V_46 = F_111 ( V_22 , V_40 , V_2 ) ;
return V_46 ;
}
static
int F_117 ( struct V_157 * V_158 , int V_159 ,
void T_6 * V_160 , T_7 * V_161 , T_8 * V_162 )
{
int V_46 ;
V_46 = F_118 ( V_158 , V_159 , V_160 , V_161 , V_162 ) ;
if ( V_159 && * ( int * ) ( V_158 -> V_110 ) )
* ( int * ) ( V_158 -> V_110 ) = 1 ;
return V_46 ;
}
