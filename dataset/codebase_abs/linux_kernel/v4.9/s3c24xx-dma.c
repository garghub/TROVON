...
if ( V_19 ) {
V_40 -> V_19 = true ;
V_40 -> V_92 = F_73 ( V_149 , L_14 , V_26 ) ;
if ( ! V_40 -> V_92 )
return - V_150 ;
} else {
...
L_16 ,
V_40 -> V_92 ) ;
V_40 -> V_41 . V_151 = F_44 ;
F_74 ( & V_40 -> V_41 , V_148 ) ;
}
F_75 ( V_148 -> V_34 , L_17 ,
V_26 , V_19 ? L_18 : L_19 ) ;
return V_26 ;
}
...
F_24 ( & V_40 -> V_41 . V_40 . V_152 ) ;
F_77 ( & V_40 -> V_41 . V_153 ) ;
}
}
static struct V_154 * F_78 ( struct V_155 * V_33 )
{
return (struct V_154 * )
F_79 ( V_33 ) -> V_156 ;
}
static int F_80 ( struct V_155 * V_33 )
{
...
V_10 -> V_13 = V_13 ;
V_10 -> V_20 = V_20 ;
V_158 = F_82 ( V_33 , V_161 , 0 ) ;
V_10 -> V_4 = F_83 ( & V_33 -> V_34 , V_158 ) ;
if ( F_84 ( V_10 -> V_4 ) )
...
V_2 -> V_11 = V_10 ;
V_2 -> V_100 = F_86 ( V_33 , V_26 ) ;
if ( V_2 -> V_100 < 0 ) {
F_9 ( & V_33 -> V_34 , L_22 ,
V_26 , V_2 -> V_100 ) ;
continue;
}
V_27 = F_87 ( & V_33 -> V_34 , V_2 -> V_100 , F_46 ,
0 , V_33 -> V_92 , V_2 ) ;
if ( V_27 ) {
F_9 ( & V_33 -> V_34 , L_23 ,
V_26 , V_27 ) ;
...
if ( V_20 -> V_35 ) {
sprintf ( V_162 , L_24 , V_26 ) ;
V_2 -> V_36 = F_88 ( & V_33 -> V_34 , V_162 ) ;
...
V_2 -> V_30 = true ;
F_38 ( & V_33 -> V_34 , L_27 ,
V_26 , F_1 ( V_2 ) ? L_28 : L_29 ) ;
}
F_91 ( V_164 , V_10 -> memcpy . V_165 ) ;
F_91 ( V_166 , V_10 -> memcpy . V_165 ) ;
...
F_91 ( V_173 , V_10 -> V_19 . V_165 ) ;
F_91 ( V_174 , V_10 -> V_19 . V_165 ) ;
F_91 ( V_166 , V_10 -> V_19 . V_165 ) ;
...
V_10 -> V_19 . V_177 . V_178 = V_13 -> V_179 ;
V_10 -> V_19 . V_177 . V_180 = V_13 -> V_181 ;
V_10 -> V_19 . V_177 . V_182 = V_183 ;
...
static void F_96 ( struct V_155 * V_33 ,
struct V_9 * V_10 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_10 -> V_13 -> V_28 ; V_26 ++ ) {
struct V_1 * V_2 = & V_10 -> V_29 [ V_26 ] ;
F_97 ( & V_33 -> V_34 , V_2 -> V_100 , V_2 ) ;
}
}
static int F_98 ( struct V_155 * V_33 )
{
const struct V_12 * V_13 = F_81 ( & V_33 -> V_34 ) ;
struct V_9 * V_10 = F_99 ( V_33 ) ;
struct V_154 * V_20 = F_78 ( V_33 ) ;
int V_26 ;
F_94 ( & V_10 -> V_19 ) ;
F_94 ( & V_10 -> memcpy ) ;
F_96 ( V_33 , V_10 ) ;
...
bool V_183 ( struct V_39 * V_40 , void * V_190 )
{
struct V_7 * V_8 ;
if ( V_40 -> V_191 -> V_34 -> V_192 != & V_193 . V_192 )
return false ;
V_8 = F_14 ( V_40 ) ;
return V_8 -> V_17 == ( V_194 ) V_190 ;
}
