...
F_84 (it, widgets)
V_133 ++ ;
* V_25 = F_29 ( sizeof( * * V_25 ) + V_133 * sizeof( * V_14 ) , V_12 ) ;
if ( * V_25 == NULL )
return - V_51 ;
F_18 ( V_14 , V_80 , V_27 )
( * V_25 ) -> V_80 [ V_94 ++ ] = V_14 ;
...
if ( ( V_40 -> V_36 & F_89 ( V_20 ) ) && V_40 -> V_136 ) {
...
if ( V_81 -> V_30 ) {
V_81 -> V_138 = 1 ;
V_134 += F_86 ( V_81 -> V_22 [ V_20 ] , V_25 , F_87 ) ;
V_81 -> V_138 = 0 ;
}
}
V_40 -> V_26 [ V_20 ] = V_134 ;
return V_134 ;
}
...
int F_93 ( struct V_139 * V_140 , int V_141 ,
struct V_76 * * V_25 ,
bool (* F_87)( struct V_13 * ,
enum V_19 ) )
{
struct V_35 * V_3 = V_140 -> V_88 -> V_3 ;
struct V_13 * V_14 ;
F_17 ( V_80 ) ;
int V_52 ;
int V_50 ;
...
if ( V_141 == V_143 )
V_52 = F_91 ( V_140 -> V_144 , & V_80 ,
F_87 ) ;
else
V_52 = F_92 ( V_140 -> V_145 , & V_80 ,
F_87 ) ;
F_95 ( V_80 . V_146 ) ;
V_50 = F_83 ( V_25 , & V_80 ) ;
if ( V_50 )
...
struct V_41 * V_42 , int V_147 )
{
int V_50 ;
F_56 ( V_14 -> V_2 ) ;
if ( F_98 ( V_147 ) ) {
if ( V_14 -> V_67 & V_148 ) {
V_50 = F_99 ( V_14 -> V_149 , false ) ;
if ( V_50 != 0 )
F_100 ( V_14 -> V_2 -> V_8 ,
L_12 ,
V_14 -> V_17 , V_50 ) ;
}
return F_101 ( V_14 -> V_149 ) ;
} else {
if ( V_14 -> V_67 & V_148 ) {
V_50 = F_99 ( V_14 -> V_149 , true ) ;
if ( V_50 != 0 )
F_100 ( V_14 -> V_2 -> V_8 ,
L_13 ,
V_14 -> V_17 , V_50 ) ;
}
return F_102 ( V_14 -> V_149 , V_14 -> V_64 ) ;
}
}
...
int V_153 , V_99 ;
F_88 ( V_14 , V_154 ) ;
V_153 = F_92 ( V_14 , NULL , NULL ) ;
V_99 = F_91 ( V_14 , NULL , NULL ) ;
return V_99 != 0 && V_153 != 0 ;
}
...
continue;
if ( V_81 -> V_136 &&
! V_81 -> V_136 ( V_81 -> V_33 , V_81 -> V_34 ) )
continue;
if ( F_107 ( V_81 -> V_34 ) )
return 1 ;
}
...
static int F_112 ( struct V_13 * V_155 ,
struct V_13 * V_156 ,
bool V_157 )
{
int * V_158 ;
...
V_158 = V_160 ;
if ( V_158 [ V_155 -> V_53 ] != V_158 [ V_156 -> V_53 ] )
return V_158 [ V_155 -> V_53 ] - V_158 [ V_156 -> V_53 ] ;
...
if ( V_155 -> V_61 != V_156 -> V_61 )
return V_155 -> V_61 - V_156 -> V_61 ;
if ( V_155 -> V_2 != V_156 -> V_2 )
return ( unsigned long ) V_155 -> V_2 - ( unsigned long ) V_156 -> V_2 ;
return 0 ;
}
static void F_113 ( struct V_13 * V_162 ,
struct V_84 * V_25 ,
bool V_157 )
{
struct V_13 * V_14 ;
F_18 (w, list, power_list)
if ( F_112 ( V_162 , V_14 , V_157 ) < 0 ) {
F_14 ( & V_162 -> V_163 , & V_14 -> V_163 ) ;
return;
}
F_14 ( & V_162 -> V_163 , V_25 ) ;
}
static void F_114 ( struct V_35 * V_3 ,
struct V_13 * V_14 , int V_147 )
{
const char * V_164 ;
int V_83 , V_50 ;
switch ( V_147 ) {
...
if ( V_14 -> V_86 != V_83 )
return;
if ( V_14 -> V_147 && ( V_14 -> V_171 & V_147 ) ) {
F_6 ( V_14 -> V_2 -> V_8 , V_3 -> V_6 , L_21 ,
V_14 -> V_17 , V_164 ) ;
F_56 ( V_14 -> V_2 ) ;
F_116 ( V_14 , V_147 ) ;
V_50 = V_14 -> V_147 ( V_14 , NULL , V_147 ) ;
F_117 ( V_14 , V_147 ) ;
if ( V_50 < 0 )
F_74 ( V_14 -> V_2 -> V_8 , L_22 ,
V_164 , V_14 -> V_17 , V_50 ) ;
}
}
...
unsigned int V_69 = 0 ;
unsigned int V_62 = 0 ;
V_14 = F_119 ( V_172 , struct V_13 , V_163 ) ;
V_61 = V_14 -> V_61 ;
V_2 = V_14 -> V_2 ;
...
struct V_84 * V_25 , int V_147 , bool V_157 )
{
...
V_50 = 0 ;
if ( V_158 [ V_14 -> V_53 ] != V_174 || V_14 -> V_61 != V_176 ||
V_14 -> V_2 != V_177 || V_14 -> V_161 != V_175 ) {
if ( ! F_11 ( & V_172 ) )
F_118 ( V_3 , & V_172 ) ;
if ( V_177 && V_177 -> V_178 ) {
for ( V_94 = 0 ; V_94 < F_123 ( V_159 ) ; V_94 ++ )
if ( V_158 [ V_94 ] == V_174 )
V_177 -> V_178 ( V_177 ,
V_94 ,
V_175 ) ;
}
if ( V_177 && V_14 -> V_2 != V_177 )
F_56 ( V_177 ) ;
F_30 ( & V_172 ) ;
V_174 = - 1 ;
V_175 = V_179 ;
...
break;
default:
V_174 = V_158 [ V_14 -> V_53 ] ;
V_175 = V_14 -> V_161 ;
V_176 = V_14 -> V_61 ;
V_177 = V_14 -> V_2 ;
F_125 ( & V_14 -> V_163 , & V_172 ) ;
break;
}
if ( V_50 < 0 )
F_74 ( V_14 -> V_2 -> V_8 ,
...
{
struct V_184 * V_185 = V_3 -> V_185 ;
struct V_76 * V_75 ;
struct V_13 * V_14 = NULL ;
unsigned int V_186 ;
int V_50 ;
if ( ! V_185 || ! F_42 ( V_185 -> V_42 ) )
return;
V_75 = F_38 ( V_185 -> V_42 ) ;
for ( V_186 = 0 ; V_186 < V_75 -> V_79 ; V_186 ++ ) {
V_14 = V_75 -> V_80 [ V_186 ] ;
if ( V_14 -> V_147 && ( V_14 -> V_171 & V_187 ) ) {
V_50 = V_14 -> V_147 ( V_14 , V_185 -> V_42 , V_187 ) ;
if ( V_50 != 0 )
...
if ( ! V_14 )
return;
V_50 = F_52 ( V_14 -> V_2 , V_185 -> V_61 , V_185 -> V_62 ,
V_185 -> V_104 ) ;
if ( V_50 < 0 )
...
for ( V_186 = 0 ; V_186 < V_75 -> V_79 ; V_186 ++ ) {
V_14 = V_75 -> V_80 [ V_186 ] ;
if ( V_14 -> V_147 && ( V_14 -> V_171 & V_188 ) ) {
V_50 = V_14 -> V_147 ( V_14 , V_185 -> V_42 , V_188 ) ;
if ( V_50 != 0 )
...
static void F_127 ( void * V_45 , T_5 V_189 )
{
struct V_1 * V_173 = V_45 ;
int V_50 ;
if ( V_173 -> V_98 == V_190 &&
V_173 -> V_191 != V_190 ) {
if ( V_173 -> V_8 )
F_128 ( V_173 -> V_8 ) ;
V_50 = F_62 ( V_173 , V_192 ) ;
if ( V_50 != 0 )
F_74 ( V_173 -> V_8 ,
L_29 , V_50 ) ;
}
if ( ( V_173 -> V_191 == V_193 &&
V_173 -> V_98 != V_193 ) ||
( V_173 -> V_191 != V_193 &&
V_173 -> V_98 == V_193 ) ) {
V_50 = F_62 ( V_173 , V_194 ) ;
if ( V_50 != 0 )
F_74 ( V_173 -> V_8 ,
L_30 , V_50 ) ;
}
}
static void F_129 ( void * V_45 , T_5 V_189 )
{
struct V_1 * V_173 = V_45 ;
int V_50 ;
if ( V_173 -> V_98 == V_194 &&
...
if ( V_173 -> V_98 == V_194 &&
V_173 -> V_191 == V_193 ) {
V_50 = F_62 ( V_173 , V_193 ) ;
if ( V_50 != 0 )
F_74 ( V_173 -> V_8 , L_33 ,
V_50 ) ;
}
}
static void F_131 ( struct V_13 * V_195 ,
bool V_83 , bool V_30 )
{
if ( ! V_30 )
return;
...
if ( V_83 )
F_113 ( V_14 , V_196 , true ) ;
else
F_113 ( V_14 , V_197 , false ) ;
}
...
static int F_136 ( struct V_35 * V_3 , int V_147 )
{
struct V_13 * V_14 ;
struct V_1 * V_173 ;
F_17 ( V_196 ) ;
...
F_114 ( V_3 , V_14 , V_170 ) ;
}
F_18 (w, &up_list, power_list) {
F_114 ( V_3 , V_14 , V_169 ) ;
}
F_121 ( V_3 , & V_197 , V_147 , false ) ;
F_126 ( V_3 ) ;
F_121 ( V_3 , & V_196 , V_147 , true ) ;
F_18 (d, &card->dapm_list, list) {
if ( V_173 != & V_3 -> V_2 )
F_141 ( F_129 , V_173 ,
& V_200 ) ;
...
static T_6 F_144 ( struct V_209 * V_209 ,
char T_7 * V_210 ,
T_4 V_211 , T_8 * V_212 )
{
struct V_13 * V_14 = V_209 -> V_73 ;
...
V_14 -> V_151 ? L_39 : L_40 , V_153 , V_99 ) ;
if ( V_14 -> V_61 >= 0 )
...
V_14 -> V_213 ,
V_14 -> V_214 ? L_44 : L_45 ) ;
F_145 (dir) {
V_21 = F_16 ( V_20 ) ;
F_19 (w, dir, p) {
if ( V_24 -> V_136 && ! V_24 -> V_136 ( V_14 , V_24 -> V_22 [ V_21 ] ) )
continue;
if ( ! V_24 -> V_30 )
continue;
V_50 += snprintf ( V_10 + V_50 , V_11 - V_50 ,
...
F_25 ( & V_3 -> V_5 ) ;
V_50 = F_146 ( V_210 , V_211 , V_212 , V_10 , V_50 ) ;
F_9 ( V_10 ) ;
return V_50 ;
}
static T_6 F_147 ( struct V_209 * V_209 , char T_7 * V_210 ,
T_4 V_211 , T_8 * V_212 )
{
struct V_1 * V_2 = V_209 -> V_73 ;
char * V_96 ;
switch ( V_2 -> V_98 ) {
case V_193 :
V_96 = L_50 ;
...
return F_146 ( V_210 , V_211 , V_212 , V_96 ,
strlen ( V_96 ) ) ;
}
...
if ( ! V_216 )
return;
V_2 -> V_217 = F_149 ( L_56 , V_216 ) ;
if ( ! V_2 -> V_217 ) {
F_100 ( V_2 -> V_8 ,
L_57 ) ;
return;
}
V_173 = F_150 ( L_58 , 0444 ,
V_2 -> V_217 , V_2 ,
& V_218 ) ;
if ( ! V_173 )
F_100 ( V_2 -> V_8 ,
...
struct V_1 * V_2 = V_14 -> V_2 ;
struct V_215 * V_173 ;
if ( ! V_2 -> V_217 || ! V_14 -> V_17 )
return;
V_173 = F_150 ( V_14 -> V_17 , 0444 ,
V_2 -> V_217 , V_14 ,
& V_219 ) ;
if ( ! V_173 )
F_100 ( V_14 -> V_2 -> V_8 ,
...
struct V_41 * V_42 , int V_220 , struct V_48 * V_49 )
{
struct V_23 * V_81 ;
int V_221 = 0 ;
bool V_30 ;
...
F_156 (path, kcontrol) {
V_221 = 1 ;
if ( ! ( strcmp ( V_81 -> V_17 , V_49 -> V_108 [ V_220 ] ) ) )
V_30 = true ;
else
V_30 = false ;
...
F_94 ( & V_3 -> V_5 , V_142 ) ;
V_3 -> V_185 = V_185 ;
V_50 = F_155 ( V_3 , V_42 , V_220 , V_49 ) ;
V_3 -> V_185 = NULL ;
F_25 ( & V_3 -> V_5 ) ;
if ( V_50 > 0 )
F_158 ( V_3 ) ;
...
static T_6 F_161 ( struct V_223 * V_224 ,
char * V_10 )
{
struct V_1 * V_2 = F_162 ( V_224 ) ;
struct V_13 * V_14 ;
int V_211 = 0 ;
char * V_225 = L_63 ;
if ( ! V_224 -> V_3 )
...
V_211 += sprintf ( V_10 + V_211 , L_67 , V_225 ) ;
return V_211 ;
}
...
struct V_223 * V_224 = V_235 -> V_237 [ V_94 ] -> V_88 ;
V_211 += F_161 ( V_224 , V_10 + V_211 ) ;
}
F_25 ( & V_235 -> V_3 -> V_5 ) ;
return V_211 ;
}
...
if ( ! V_2 -> V_3 || ! V_2 -> V_3 -> V_4 )
return 0 ;
return F_136 ( V_2 -> V_3 , V_222 ) ;
}
int F_175 ( struct V_1 * V_2 )
{
int V_50 ;
F_94 ( & V_2 -> V_3 -> V_5 , V_142 ) ;
V_50 = F_174 ( V_2 ) ;
F_25 ( & V_2 -> V_3 -> V_5 ) ;
return V_50 ;
}
...
V_247 = V_38 ;
F_76 (w, p) {
if ( V_24 -> V_33 -> V_53 == V_207 ||
V_24 -> V_33 -> V_53 == V_227 ||
V_24 -> V_33 -> V_53 == V_229 ||
...
V_247 = V_37 ;
F_110 (w, p) {
if ( V_24 -> V_34 -> V_53 == V_228 ||
V_24 -> V_34 -> V_53 == V_226 ||
V_24 -> V_34 -> V_53 == V_229 ||
...
F_145 (dir)
F_178 ( & V_81 -> V_238 [ V_20 ] , & V_80 [ V_20 ] -> V_127 [ V_20 ] ) ;
F_145 (dir) {
F_176 ( V_80 [ V_20 ] ) ;
F_12 ( V_80 [ V_20 ] , L_75 ) ;
}
...
return - V_124 ;
V_104 |= F_34 ( V_49 , V_105 [ 1 ] ) << V_49 -> V_275 ;
...
switch ( V_14 -> V_53 ) {
case V_205 :
V_14 -> V_149 = F_198 ( V_2 -> V_8 , V_14 -> V_17 ) ;
if ( F_199 ( V_14 -> V_149 ) ) {
...
case V_206 :
#ifdef F_201
V_14 -> V_150 = F_202 ( V_2 -> V_8 , V_14 -> V_17 ) ;
if ( F_199 ( V_14 -> V_150 ) ) {
V_50 = F_200 ( V_14 -> V_150 ) ;
F_74 ( V_2 -> V_8 , L_92 ,
V_14 -> V_17 , V_50 ) ;
return NULL ;
}
...
int V_50 ;
if ( F_120 ( ! V_288 ) ||
F_120 ( F_11 ( & V_14 -> V_127 [ V_32 ] ) ||
F_11 ( & V_14 -> V_127 [ V_31 ] ) ) )
return - V_124 ;
V_285 = F_119 ( & V_14 -> V_127 [ V_32 ] ,
struct V_23 ,
V_238 [ V_32 ] ) ;
V_286 = F_119 ( & V_14 -> V_127 [ V_31 ] ,
struct V_23 ,
V_238 [ V_31 ] ) ;
...
return 0 ;
if ( V_270 -> V_69 . V_274 . V_105 [ 0 ] >= V_14 -> V_128 )
return - V_124 ;
...
V_316:
for ( V_211 = 0 ; V_211 < V_128 ; V_211 ++ )
F_220 ( V_3 -> V_8 , ( void * ) V_313 [ V_211 ] ) ;
F_220 ( V_3 -> V_8 , V_313 ) ;
return V_50 ;
}
...
struct V_13 V_59 ;
struct V_13 * V_14 ;
F_120 ( V_2 -> V_8 != V_140 -> V_8 ) ;
memset ( & V_59 , 0 , sizeof( V_59 ) ) ;
V_59 . V_61 = V_106 ;
if ( V_140 -> V_306 -> V_322 . V_317 ) {
V_59 . V_53 = V_284 ;
V_59 . V_17 = V_140 -> V_306 -> V_322 . V_317 ;
V_59 . V_213 = V_140 -> V_306 -> V_322 . V_317 ;
F_82 ( V_140 -> V_8 , L_101 ,
V_59 . V_17 ) ;
V_14 = F_33 ( V_2 , & V_59 ) ;
if ( ! V_14 ) {
F_74 ( V_2 -> V_8 , L_102 ,
V_140 -> V_306 -> V_322 . V_317 ) ;
return - V_51 ;
}
V_14 -> V_296 = V_140 ;
V_140 -> V_144 = V_14 ;
}
if ( V_140 -> V_306 -> V_323 . V_317 ) {
V_59 . V_53 = V_283 ;
V_59 . V_17 = V_140 -> V_306 -> V_323 . V_317 ;
V_59 . V_213 = V_140 -> V_306 -> V_323 . V_317 ;
F_82 ( V_140 -> V_8 , L_101 ,
V_59 . V_17 ) ;
V_14 = F_33 ( V_2 , & V_59 ) ;
if ( ! V_14 ) {
F_74 ( V_2 -> V_8 , L_102 ,
V_140 -> V_306 -> V_323 . V_317 ) ;
return - V_51 ;
}
V_14 -> V_296 = V_140 ;
V_140 -> V_145 = V_14 ;
...
if ( ! V_14 -> V_213 || ! strstr ( V_14 -> V_213 , V_324 -> V_213 ) )
continue;
if ( V_324 -> V_53 == V_284 ) {
V_325 = V_324 ;
V_34 = V_14 ;
...
F_82 ( V_140 -> V_8 , L_103 , V_325 -> V_17 , V_34 -> V_17 ) ;
...
struct V_234 * V_235 )
{
struct V_139 * V_326 = V_235 -> V_326 ;
struct V_13 * V_34 , * V_33 ;
int V_94 ;
for ( V_94 = 0 ; V_94 < V_235 -> V_236 ; V_94 ++ ) {
struct V_139 * V_327 = V_235 -> V_237 [ V_94 ] ;
...
static void F_224 ( struct V_139 * V_140 , int V_141 ,
int V_147 )
{
struct V_13 * V_14 ;
unsigned int V_247 ;
...
static void F_226 ( struct V_234 * V_235 , int V_141 ,
int V_147 )
{
int V_94 ;
F_224 ( V_235 -> V_326 , V_141 , V_147 ) ;
for ( V_94 = 0 ; V_94 < V_235 -> V_236 ; V_94 ++ )
F_224 ( V_235 -> V_237 [ V_94 ] , V_141 , V_147 ) ;
F_136 ( V_235 -> V_3 , V_147 ) ;
}
void F_227 ( struct V_234 * V_235 , int V_141 ,
int V_147 )
{
struct V_35 * V_3 = V_235 -> V_3 ;
F_94 ( & V_3 -> V_5 , V_142 ) ;
F_226 ( V_235 , V_141 , V_147 ) ;
F_25 ( & V_3 -> V_5 ) ;
}
