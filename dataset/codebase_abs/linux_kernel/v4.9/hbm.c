...
struct V_131 * V_150 ;
struct V_124 * V_126 ;
F_81 ( V_39 -> V_40 >= sizeof( V_34 -> V_181 ) ) ;
F_82 ( V_34 , V_34 -> V_181 , V_39 -> V_40 ) ;
V_173 = (struct V_172 * ) V_34 -> V_181 ;
V_180 = (struct V_51 * ) V_173 ;
if ( V_34 -> V_36 == V_37 ) {
F_35 ( V_34 -> V_34 , L_22 ) ;
return 0 ;
}
...
case V_188 :
F_35 ( V_34 -> V_34 , L_29 ) ;
F_64 ( V_34 , V_180 , V_144 ) ;
break;
case V_134 :
F_35 ( V_34 -> V_34 , L_30 ) ;
F_64 ( V_34 , V_180 , V_145 ) ;
break;
case V_125 :
F_35 ( V_34 -> V_34 , L_31 ) ;
V_126 = (struct V_124 * ) V_173 ;
F_57 ( V_34 , V_126 ) ;
break;
case V_189 :
F_35 ( V_34 -> V_34 , L_32 ) ;
...
F_29 ( V_34 , V_176 ) ;
if ( F_47 ( V_34 , V_176 -> V_42 + 1 ) )
return - V_186 ;
break;
case V_193 :
F_35 ( V_34 -> V_34 , L_37 ) ;
V_34 -> V_35 = 0 ;
V_178 = (struct V_177 * ) V_173 ;
F_37 ( sizeof( V_34 -> V_112 )
< sizeof( V_178 -> V_194 ) ) ;
memcpy ( V_34 -> V_112 , V_178 -> V_194 ,
sizeof( V_178 -> V_194 ) ) ;
if ( V_34 -> V_97 != V_187 ||
V_34 -> V_36 != V_77 ) {
F_25 ( V_34 -> V_34 , L_38 ,
...
V_179 = (struct V_94 * ) V_173 ;
V_54 = F_36 ( V_34 , V_179 ) ;
if ( V_54 ) {
F_25 ( V_34 -> V_34 , L_47 ,
V_54 ) ;
return - V_186 ;
