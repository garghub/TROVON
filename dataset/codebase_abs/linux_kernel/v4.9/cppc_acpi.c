...
if ( ! V_125 )
goto V_131;
V_17 = F_52 ( & V_7 -> V_2 , & V_150 , & V_125 -> V_2 ,
L_27 ) ;
if ( V_17 )
goto V_131;
F_32 ( V_119 . V_70 ) ;
...
int __weak F_56 ( int V_151 , struct V_122 * V_147 , T_8 * V_152 )
{
return - V_153 ;
}
int __weak F_57 ( int V_151 , struct V_122 * V_147 , T_8 V_152 )
{
return - V_153 ;
}
static int F_58 ( int V_154 , struct V_155 * V_156 , T_8 * V_152 )
{
int V_157 = 0 ;
void T_2 * V_158 = 0 ;
struct V_122 * V_147 = & V_156 -> V_135 . V_147 ;
if ( V_156 -> type == V_129 ) {
* V_152 = V_156 -> V_135 . V_136 ;
return V_157 ;
}
* V_152 = 0 ;
if ( V_147 -> V_138 == V_139 )
V_158 = F_59 ( V_147 -> V_142 ) ;
else if ( V_147 -> V_138 == V_141 )
V_158 = V_156 -> V_145 ;
else if ( V_147 -> V_138 == V_146 )
return F_56 ( V_154 , V_147 , V_152 ) ;
else
return F_60 ( ( V_159 ) V_147 -> V_142 ,
V_152 , V_147 -> V_144 ) ;
switch ( V_147 -> V_144 ) {
case 8 :
* V_152 = F_61 ( V_158 ) ;
...
static int F_64 ( int V_154 , struct V_155 * V_156 , T_8 V_152 )
{
int V_157 = 0 ;
void T_2 * V_158 = 0 ;
struct V_122 * V_147 = & V_156 -> V_135 . V_147 ;
...
return F_57 ( V_154 , V_147 , V_152 ) ;
else
return F_65 ( ( V_159 ) V_147 -> V_142 ,
V_152 , V_147 -> V_144 ) ;
switch ( V_147 -> V_144 ) {
case 8 :
F_66 ( V_152 , V_158 ) ;
...
int F_69 ( int V_151 , struct V_160 * V_161 )
{
struct V_6 * V_6 = F_25 ( V_47 , V_151 ) ;
struct V_155 * V_162 , * V_163 , * V_164 ,
* V_165 ;
T_8 V_166 , V_167 , V_168 ;
int V_17 = 0 , V_169 = 0 ;
if ( ! V_6 ) {
F_18 ( L_30 , V_151 ) ;
return - V_69 ;
}
V_162 = & V_6 -> V_134 [ V_170 ] ;
V_163 = & V_6 -> V_134 [ V_171 ] ;
V_164 = & V_6 -> V_134 [ V_172 ] ;
V_165 = & V_6 -> V_134 [ V_173 ] ;
if ( F_70 ( V_162 ) || F_70 ( V_163 ) ||
F_70 ( V_164 ) || F_70 ( V_165 ) ) {
V_169 = 1 ;
F_71 ( & V_22 . V_149 ) ;
if ( F_15 ( V_35 ) < 0 ) {
V_17 = - V_18 ;
...
F_58 ( V_151 , V_162 , & V_166 ) ;
V_161 -> V_175 = V_166 ;
F_58 ( V_151 , V_163 , & V_167 ) ;
V_161 -> V_176 = V_167 ;
F_58 ( V_151 , V_165 , & V_168 ) ;
V_161 -> V_177 = V_168 ;
...
int F_3 ( int V_151 , struct V_8 * V_178 )
{
struct V_6 * V_6 = F_25 ( V_47 , V_151 ) ;
struct V_155 * V_179 , * V_180 ,
* V_181 , * V_182 ;
T_8 V_13 , V_12 , V_164 , V_15 ;
int V_17 = 0 , V_169 = 0 ;
if ( ! V_6 ) {
F_18 ( L_30 , V_151 ) ;
return - V_69 ;
}
V_179 = & V_6 -> V_134 [ V_183 ] ;
V_180 = & V_6 -> V_134 [ V_184 ] ;
V_181 = & V_6 -> V_134 [ V_172 ] ;
V_182 = & V_6 -> V_134 [ V_185 ] ;
if ( ! F_73 ( V_181 ) )
V_181 = & V_6 -> V_134 [ V_173 ] ;
if ( F_70 ( V_179 ) || F_70 ( V_180 ) ||
F_70 ( V_182 ) || F_70 ( V_181 ) ) {
F_71 ( & V_22 . V_149 ) ;
V_169 = 1 ;
if ( F_15 ( V_35 ) < 0 ) {
V_17 = - V_18 ;
...
F_58 ( V_151 , V_179 , & V_13 ) ;
F_58 ( V_151 , V_180 , & V_12 ) ;
F_58 ( V_151 , V_181 , & V_164 ) ;
V_15 = ( T_8 ) ( ~ ( ( T_8 ) 0 ) ) ;
if ( F_73 ( V_182 ) )
F_58 ( V_151 , V_182 , & V_15 ) ;
if ( ! V_13 || ! V_12 || ! V_164 ) {
V_17 = - V_57 ;
goto V_174;
}
...
int F_74 ( int V_154 , struct V_186 * V_187 )
{
struct V_6 * V_6 = F_25 ( V_47 , V_154 ) ;
struct V_155 * V_188 ;
int V_17 = 0 ;
if ( ! V_6 ) {
F_18 ( L_30 , V_154 ) ;
...
return V_193 ;
if ( V_22 . V_40 )
V_192 = 60 * ( 1000 * 1000 * 1000 / V_22 . V_40 ) ;
V_192 = F_80 ( V_192 , V_22 . V_115 * 1000 ) ;
V_192 = F_80 ( V_192 , V_22 . V_39 * 1000 ) ;
return V_192 ;
}
