...
static void F_46 ( T_1 V_65 , struct V_66 * V_67 )
{
F_47 ( sizeof( V_65 ) == sizeof( V_68 ) ) ;
V_67 -> V_69 = V_65 & 0xffffffff ;
V_67 -> V_70 = ( V_65 >> V_71 ) & 0xf ;
V_67 -> V_72 = ( unsigned long long ) V_65 >> V_73 ;
}
static T_1 F_48 ( struct V_66 * V_67 )
{
return
( ( V_68 ) V_67 -> V_69 ) |
( ( V_68 ) V_67 -> V_70 << V_71 ) |
...
static int F_49 ( struct V_74 * V_75 , struct V_76 * V_77 ,
struct V_78 * V_79 , void * V_10 )
{
struct V_66 * V_67 = V_10 ;
struct V_80 * V_81 = F_50 ( V_75 , V_79 ) ;
if ( V_67 -> V_82 -- > 0 )
return 0 ;
if ( F_51 ( V_81 ) )
return 1 ;
...
static struct V_84 * F_53 ( const struct V_17 * V_18 ,
struct V_16 * V_85 ,
struct V_66 * V_67 )
{
F_24 ( F_54 ( V_85 ) ) ;
...
V_67 -> V_83 = NULL ;
V_67 -> V_82 = V_67 -> V_70 ;
F_55 ( V_85 -> V_24 -> V_86 , V_67 -> V_72 ,
F_49 , V_67 ) ;
if ( V_67 -> V_83 ) {
struct V_87 * V_88 ;
V_88 = F_56 ( V_67 -> V_83 , V_85 -> V_41 ) ;
if ( V_88 ) {
F_57 ( V_88 , L_4 , V_89 ) ;
return F_58 ( V_88 ) ;
}
F_59 ( V_18 , F_60 ( V_67 -> V_83 ) ) ;
} else if ( V_67 -> V_82 > 0 ) {
V_67 -> V_70 = 0xf ;
}
return NULL ;
}
static T_1 F_61 ( const struct V_17 * V_18 ,
...
F_46 ( V_65 , & V_67 ) ;
while ( 1 ) {
if ( V_67 . V_72 >= F_62 ( V_23 -> V_86 ) )
return ~ 0ULL ;
V_90 = F_53 ( V_18 , V_85 , & V_67 ) ;
if ( V_90 ) {
struct V_92 * V_92 = F_63 ( V_90 ) ;
struct V_93 * V_94 ;
int V_95 ;
V_95 = F_64 ( V_92 -> V_96 ,
V_67 . V_69 , 1 , & V_94 ) ;
...
struct V_93 * V_94 ;
int V_104 ;
V_103 = F_69 ( F_70 ( V_93 , & V_48 ) ) ;
V_94 = V_103 -> V_105 ;
F_71 ( V_100 , L_5 V_106 L_6 ,
0 ,
V_103 , V_93 ,
L_7 ,
V_103 -> V_107 ? L_8 : L_9 ,
...
F_72 ( V_94 ) ? L_11 : L_12 ,
V_94 , F_73 ( F_74 ( V_94 -> V_109 -> V_110 ) ) ,
V_94 -> V_109 -> V_110 , V_94 -> V_97 ,
F_75 ( V_94 ) ) ;
V_104 = 0 ;
F_76 ( V_100 , V_94 , V_111 , V_104 ) ;
F_76 ( V_100 , V_94 , error , V_104 ) ;
F_76 ( V_100 , V_94 , V_112 , V_104 ) ;
F_76 ( V_100 , V_94 , V_113 , V_104 ) ;
F_76 ( V_100 , V_94 , V_114 , V_104 ) ;
F_76 ( V_100 , V_94 , V_115 , V_104 ) ;
F_71 ( V_100 , L_13 , V_104 ? L_14 : L_12 ) ;
}
static int F_77 ( struct V_99 * V_116 , void * V_117 )
{
T_1 V_65 ;
struct V_52 * V_53 ;
struct V_84 * V_90 ;
...
F_46 ( V_65 , & V_67 ) ;
V_53 = V_116 -> V_118 ;
V_90 = F_53 ( V_18 , & V_53 -> V_61 -> V_34 , & V_67 ) ;
if ( V_90 ) {
struct V_92 * V_92 = F_63 ( V_90 ) ;
...
F_71 ( V_116 , L_15 V_106 L_16 , V_67 . V_69 ,
F_73 ( F_81 ( & V_90 -> V_98 ) ) ) ;
if ( V_93 ) {
F_68 ( V_18 , V_116 , V_93 ) ;
F_82 ( V_18 , V_93 ) ;
} else {
F_83 ( V_116 , L_17 ) ;
}
...
static void * F_84 ( struct V_99 * V_116 , T_1 * V_65 )
{
struct V_52 * V_53 ;
struct V_17 * V_18 ;
int V_56 ;
...
static void * F_85 ( struct V_99 * V_116 , void * V_117 , T_1 * V_65 )
{
struct V_52 * V_53 ;
struct V_17 * V_18 ;
int V_56 ;
...
if ( ! F_39 ( V_18 ) ) {
V_53 = V_116 -> V_118 ;
* V_65 = F_61 ( V_18 , & V_53 -> V_61 -> V_34 , * V_65 + 1 ) ;
if ( * V_65 == ~ 0ULL )
V_65 = NULL ;
F_42 ( V_18 , & V_56 ) ;
}
...
static void F_86 ( struct V_99 * V_116 , void * V_117 )
{
}
static int F_87 ( struct V_92 * V_92 , struct V_121 * V_122 )
{
struct V_99 * V_100 ;
int V_32 ;
V_32 = F_88 ( V_122 , & V_123 ) ;
if ( V_32 )
return V_32 ;
V_100 = V_122 -> V_124 ;
