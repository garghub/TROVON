...
V_14 -> V_31 . V_35 = 4096 ;
V_14 -> V_31 . V_36 = & V_37 ;
V_19 = F_27 ( V_14 -> V_28 , V_14 ) ;
if ( V_19 )
goto V_38;
V_19 = F_28 ( V_14 , V_39 , F_29 ( V_39 ) ) ;
if ( V_19 < 0 )
goto V_40;
V_19 = F_28 ( V_14 , V_41 , F_29 ( V_41 ) ) ;
if ( V_19 < 0 )
goto V_40;
...
static int F_38 ( struct V_47 * V_28 , void * V_48 )
{
...
static void F_46 ( struct V_47 * V_28 )
{
struct V_1 * V_2 = F_40 ( V_28 ) ;
F_47 ( V_2 -> V_14 ) ;
V_2 -> V_14 = NULL ;
...
int V_19 ;
int V_11 ;
V_2 = F_49 ( V_28 , sizeof( * V_2 ) , V_58 ) ;
if ( ! V_2 )
return - V_59 ;
F_50 ( & V_2 -> V_5 . V_20 ) ;
F_51 ( & V_2 -> V_5 . V_6 , F_13 ) ;
V_54 = F_52 ( V_22 , V_60 , 0 ) ;
V_2 -> V_61 = F_53 ( V_28 , V_54 ) ;
if ( F_42 ( V_2 -> V_61 ) ) {
V_19 = F_43 ( V_2 -> V_61 ) ;
F_24 ( V_28 , L_3 ,
V_19 ) ;
...
F_61 ( V_28 , L_6 ,
V_55 -> V_29 ) ;
F_62 ( V_28 , & V_57 , F_38 , V_55 ) ;
} else {
struct V_73 * V_74 ;
V_74 = F_49 ( V_28 , sizeof( * V_74 ) , V_58 ) ;
if ( ! V_74 ) {
V_19 = - V_59 ;
goto V_75;
}
V_19 = F_63 ( V_28 , V_55 , V_74 , V_66 , NULL ) ;
if ( V_19 )
goto V_75;
V_2 -> V_76 [ V_66 ] = V_74 ;
}
