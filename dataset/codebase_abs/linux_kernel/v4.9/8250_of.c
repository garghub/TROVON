...
{
struct V_65 * V_66 = F_34 ( V_14 -> line ) ;
struct V_1 * V_10 = & V_66 -> V_10 ;
F_35 ( V_14 -> line ) ;
if ( V_14 -> V_20 && ( ! F_36 ( V_10 ) || V_73 ) )
F_20 ( V_14 -> V_20 ) ;
}
...
static int F_39 ( struct V_74 * V_18 )
{
...
static int F_41 ( struct V_74 * V_18 )
{
struct V_13 * V_14 = F_40 ( V_18 ) ;
switch ( V_14 -> type ) {
case V_62 ... V_63 :
