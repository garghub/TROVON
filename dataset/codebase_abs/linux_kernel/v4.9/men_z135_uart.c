...
{
struct V_1 * V_2 = F_44 ( V_6 ) ;
struct V_144 * V_38 = V_2 -> V_38 ;
struct V_145 * V_143 ;
V_143 = F_65 ( V_2 -> V_38 , F_66 ( & V_38 -> V_39 ) ) ;
if ( F_67 ( V_143 ) )
return F_68 ( V_143 ) ;
V_6 -> V_146 = V_143 -> V_147 ;
V_2 -> V_143 = V_143 ;
V_6 -> V_10 = F_69 ( V_143 -> V_147 , F_70 ( V_143 ) ) ;
if ( V_6 -> V_10 == NULL ) {
F_63 ( V_143 ) ;
return - V_148 ;
}
...
static void F_71 ( struct V_5 * V_6 , int type )
{
V_6 -> type = V_149 ;
F_64 ( V_6 ) ;
}
...
static int F_73 ( struct V_144 * V_38 ,
...
int V_76 ;
V_39 = & V_38 -> V_39 ;
V_2 = F_74 ( V_39 , sizeof( struct V_1 ) , V_155 ) ;
if ( ! V_2 )
return - V_148 ;
V_2 -> V_40 = ( unsigned char * ) F_75 ( V_155 ) ;
if ( ! V_2 -> V_40 )
return - V_148 ;
V_143 = & V_38 -> V_143 ;
F_76 ( V_38 , V_2 ) ;
V_2 -> V_6 . V_156 = V_140 * 16 ;
V_2 -> V_6 . V_157 = V_158 ;
V_2 -> V_6 . V_159 = V_160 ;
V_2 -> V_6 . V_161 = & V_162 ;
V_2 -> V_6 . V_66 = F_77 ( V_38 ) ;
V_2 -> V_6 . V_159 = V_160 ;
V_2 -> V_6 . V_7 = V_163 | V_164 ;
V_2 -> V_6 . line = line ++ ;
V_2 -> V_6 . V_39 = V_39 ;
V_2 -> V_6 . type = V_149 ;
V_2 -> V_6 . V_146 = V_143 -> V_147 ;
V_2 -> V_6 . V_10 = NULL ;
V_2 -> V_38 = V_38 ;
F_78 ( & V_2 -> V_9 ) ;
V_76 = F_79 ( & V_165 , & V_2 -> V_6 ) ;
if ( V_76 )
goto V_76;
return 0 ;
V_76:
F_80 ( ( unsigned long ) V_2 -> V_40 ) ;
F_24 ( V_39 , L_7 , V_76 ) ;
return V_76 ;
}
static void F_81 ( struct V_144 * V_38 )
{
struct V_1 * V_2 = F_82 ( V_38 ) ;
line -- ;
F_83 ( & V_165 , & V_2 -> V_6 ) ;
F_80 ( ( unsigned long ) V_2 -> V_40 ) ;
}
