...
if ( ( V_62 & F_38 ( 0xF00FFFFF ) ) ||
memcmp ( & V_50 -> V_14 , & V_61 -> V_14 ,
V_55 - F_39 ( struct V_18 , V_14 ) ) ) {
F_36 ( V_54 ) -> V_63 = 0 ;
continue;
}
F_36 ( V_54 ) -> V_58 |= ! ! ( V_62 & F_38 ( 0x0FF00000 ) ) ;
F_36 ( V_54 ) -> V_58 |= V_58 ;
if ( F_36 ( V_2 ) -> V_64 )
F_36 ( V_54 ) -> V_65 = 0 ;
}
...
F_36 ( V_2 ) -> V_58 |= V_58 ;
F_40 ( V_2 , V_50 , V_55 ) ;
V_53 = F_41 ( V_5 -> V_40 . V_59 , V_46 , V_2 ) ;
V_60:
F_42 () ;
V_30:
F_36 ( V_2 ) -> V_58 |= V_58 ;
...
static struct V_1 * * F_43 ( struct V_1 * * V_46 ,
struct V_1 * V_2 )
{
if ( F_36 ( V_2 ) -> V_66 ) {
F_36 ( V_2 ) -> V_58 = 1 ;
...
static struct V_1 * * F_44 ( struct V_1 * * V_46 ,
struct V_1 * V_2 )
{
if ( F_36 ( V_2 ) -> V_66 ) {
F_36 ( V_2 ) -> V_58 = 1 ;
...
if ( F_48 ( ! V_5 || ! V_5 -> V_40 . V_69 ) )
goto V_60;
V_67 = V_5 -> V_40 . V_69 ( V_2 , V_28 ) ;
V_60:
F_42 () ;
return V_67 ;
}
