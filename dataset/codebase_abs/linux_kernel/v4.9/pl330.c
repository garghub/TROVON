...
F_58 ( & V_208 -> V_201 , V_193 ) ;
if ( V_273 ) {
F_103 ( V_208 -> V_5 -> V_89 . V_90 ) ;
F_104 ( V_208 -> V_5 -> V_89 . V_90 ) ;
}
}
bool F_105 ( struct V_264 * V_74 , void * V_282 )
{
T_2 * V_283 ;
...
static struct V_264 * F_106 ( struct V_289 * V_290 ,
struct V_291 * V_292 )
{
...
return NULL ;
return F_107 ( & V_137 -> V_298 [ V_296 ] . V_74 ) ;
}
...
if ( V_300 -> V_307 )
V_208 -> V_304 = F_110 ( V_300 -> V_307 ) ;
if ( V_300 -> V_308 )
V_208 -> V_306 = V_300 -> V_308 ;
}
return 0 ;
}
static int F_111 ( struct V_264 * V_74 )
{
struct V_207 * V_208 = F_87 ( V_74 ) ;
struct V_120 * V_4 ;
unsigned long V_193 ;
...
F_114 ( & V_208 -> V_310 , & V_137 -> V_281 ) ;
F_114 ( & V_208 -> V_277 , & V_137 -> V_281 ) ;
F_114 ( & V_208 -> V_276 , & V_137 -> V_281 ) ;
F_58 ( & V_208 -> V_201 , V_193 ) ;
F_103 ( V_137 -> V_89 . V_90 ) ;
F_104 ( V_137 -> V_89 . V_90 ) ;
return 0 ;
}
static int F_115 ( struct V_264 * V_74 )
{
struct V_207 * V_208 = F_87 ( V_74 ) ;
struct V_136 * V_137 = V_208 -> V_5 ;
unsigned long V_193 ;
...
static void F_116 ( struct V_264 * V_74 )
{
struct V_207 * V_208 = F_87 ( V_74 ) ;
unsigned long V_193 ;
F_86 ( & V_208 -> V_212 ) ;
F_113 ( V_208 -> V_5 -> V_89 . V_90 ) ;
F_57 ( & V_208 -> V_201 , V_193 ) ;
F_71 ( V_208 -> V_270 ) ;
V_208 -> V_270 = NULL ;
if ( V_208 -> V_274 )
F_114 ( & V_208 -> V_277 , & V_208 -> V_5 -> V_281 ) ;
F_58 ( & V_208 -> V_201 , V_193 ) ;
F_103 ( V_208 -> V_5 -> V_89 . V_90 ) ;
F_104 ( V_208 -> V_5 -> V_89 . V_90 ) ;
}
static int F_117 ( struct V_207 * V_208 ,
struct V_120 * V_4 )
{
...
V_17 = V_75 = 0 ;
if ( V_4 -> V_125 . V_168 ) {
V_17 = F_30 ( V_79 + F_118 ( V_2 -> V_86 ) ) ;
V_75 = V_4 -> V_156 . V_160 ;
} else {
V_17 = F_30 ( V_79 + F_119 ( V_2 -> V_86 ) ) ;
...
static enum V_311
F_120 ( struct V_264 * V_74 , T_5 V_271 ,
struct V_312 * V_313 )
{
enum V_311 V_194 ;
unsigned long V_193 ;
struct V_120 * V_4 , * V_314 = NULL , * V_315 = NULL ;
struct V_207 * V_208 = F_87 ( V_74 ) ;
unsigned int V_316 , V_317 = 0 ;
V_194 = F_121 ( V_74 , V_271 , V_313 ) ;
if ( ! V_313 )
return V_194 ;
if ( V_194 == V_318 )
goto V_319;
...
V_315 = V_208 -> V_270 -> V_3 [ V_208 -> V_270 -> V_123 ] . V_4 ;
F_91 (desc, &pch->work_list, node) {
if ( V_4 -> V_210 == V_211 )
V_316 = V_4 -> V_320 ;
...
static void F_124 ( struct V_264 * V_74 )
{
struct V_207 * V_208 = F_87 ( V_74 ) ;
unsigned long V_193 ;
F_57 ( & V_208 -> V_201 , V_193 ) ;
if ( F_95 ( & V_208 -> V_277 ) ) {
F_122 ( F_95 ( & V_208 -> V_310 ) ) ;
F_113 ( V_208 -> V_5 -> V_89 . V_90 ) ;
}
F_114 ( & V_208 -> V_310 , & V_208 -> V_277 ) ;
F_58 ( & V_208 -> V_201 , V_193 ) ;
F_92 ( ( unsigned long ) V_208 ) ;
}
static T_5 F_125 ( struct V_266 * V_267 )
{
struct V_120 * V_4 , * V_322 = F_89 ( V_267 ) ;
struct V_207 * V_208 = F_87 ( V_267 -> V_74 ) ;
T_5 V_271 ;
unsigned long V_193 ;
F_57 ( & V_208 -> V_201 , V_193 ) ;
while ( ! F_95 ( & V_322 -> V_275 ) ) {
V_4 = F_126 ( V_322 -> V_275 . V_323 , struct V_120 , V_275 ) ;
if ( V_208 -> V_274 ) {
...
V_322 -> V_322 = true ;
V_271 = F_127 ( & V_322 -> V_268 ) ;
F_64 ( & V_322 -> V_275 , & V_208 -> V_310 ) ;
F_58 ( & V_208 -> V_201 , V_193 ) ;
return V_271 ;
}
static inline void F_128 ( struct V_120 * V_4 )
{
V_4 -> V_125 . V_190 = V_326 ;
V_4 -> V_125 . V_186 = V_327 ;
V_4 -> V_125 . V_188 = V_327 ;
V_4 -> V_268 . V_328 = F_125 ;
F_81 ( & V_4 -> V_275 ) ;
}
static int F_129 ( struct V_136 * V_137 , T_6 V_329 , int V_293 )
{
struct V_120 * V_4 ;
unsigned long V_193 ;
int V_214 ;
V_4 = F_130 ( V_293 , sizeof( * V_4 ) , V_329 ) ;
if ( ! V_4 )
return 0 ;
F_57 ( & V_137 -> V_330 , V_193 ) ;
for ( V_214 = 0 ; V_214 < V_293 ; V_214 ++ ) {
F_128 ( & V_4 [ V_214 ] ) ;
F_64 ( & V_4 [ V_214 ] . V_275 , & V_137 -> V_281 ) ;
}
F_58 ( & V_137 -> V_330 , V_193 ) ;
return V_293 ;
}
static struct V_120 * F_131 ( struct V_136 * V_137 )
{
struct V_120 * V_4 = NULL ;
unsigned long V_193 ;
F_57 ( & V_137 -> V_330 , V_193 ) ;
if ( ! F_95 ( & V_137 -> V_281 ) ) {
V_4 = F_126 ( V_137 -> V_281 . V_323 ,
struct V_120 , V_275 ) ;
F_132 ( & V_4 -> V_275 ) ;
V_4 -> V_210 = V_280 ;
...
static struct V_120 * F_133 ( struct V_207 * V_208 )
{
struct V_136 * V_137 = V_208 -> V_5 ;
...
F_135 ( & V_4 -> V_268 , & V_208 -> V_74 ) ;
return V_4 ;
}
static inline void F_136 ( struct V_154 * V_156 ,
T_7 V_47 , T_7 V_332 , T_8 V_333 )
{
V_156 -> V_159 = V_333 ;
V_156 -> V_161 = V_47 ;
V_156 -> V_160 = V_332 ;
...
static struct V_120 *
F_137 ( struct V_207 * V_208 , T_7 V_47 ,
T_7 V_332 , T_8 V_333 )
{
struct V_120 * V_4 = F_133 ( V_208 ) ;
if ( ! V_4 ) {
F_35 ( V_208 -> V_5 -> V_89 . V_90 , L_41 ,
V_127 , __LINE__ ) ;
return NULL ;
}
F_136 ( & V_4 -> V_156 , V_47 , V_332 , V_333 ) ;
return V_4 ;
}
static inline int F_138 ( struct V_120 * V_4 , T_8 V_333 )
{
...
V_306 = 16 ;
while ( V_306 > 1 ) {
if ( ! ( V_333 % ( V_306 << V_4 -> V_125 . V_183 ) ) )
break;
V_306 -- ;
}
return V_306 ;
}
static struct V_266 * F_139 (
struct V_264 * V_74 , T_7 V_334 , T_8 V_333 ,
T_8 V_335 , enum V_336 V_301 ,
unsigned long V_193 )
{
struct V_120 * V_4 = NULL , * V_337 = NULL ;
struct V_207 * V_208 = F_87 ( V_74 ) ;
struct V_136 * V_137 = V_208 -> V_5 ;
unsigned int V_214 ;
T_7 V_47 ;
...
for ( V_214 = 0 ; V_214 < V_333 / V_335 ; V_214 ++ ) {
V_4 = F_133 ( V_208 ) ;
if ( ! V_4 ) {
F_35 ( V_208 -> V_5 -> V_89 . V_90 , L_41 ,
V_127 , __LINE__ ) ;
...
return NULL ;
F_57 ( & V_137 -> V_330 , V_193 ) ;
while ( ! F_95 ( & V_337 -> V_275 ) ) {
V_4 = F_126 ( V_337 -> V_275 . V_323 ,
struct V_120 , V_275 ) ;
F_94 ( & V_4 -> V_275 , & V_137 -> V_281 ) ;
}
F_94 ( & V_337 -> V_275 , & V_137 -> V_281 ) ;
F_58 ( & V_137 -> V_330 , V_193 ) ;
return NULL ;
}
switch ( V_301 ) {
...
V_4 -> V_125 . V_180 = 1 ;
V_4 -> V_320 = V_335 ;
F_136 ( & V_4 -> V_156 , V_47 , V_332 , V_335 ) ;
if ( ! V_337 )
V_337 = V_4 ;
else
F_64 ( & V_4 -> V_275 , & V_337 -> V_275 ) ;
V_334 += V_335 ;
}
if ( ! V_4 )
return NULL ;
...
static struct V_266 *
F_141 ( struct V_264 * V_74 , T_7 V_47 ,
T_7 V_332 , T_8 V_333 , unsigned long V_193 )
{
struct V_120 * V_4 ;
struct V_207 * V_208 = F_87 ( V_74 ) ;
struct V_136 * V_137 ;
int V_338 ;
if ( F_142 ( ! V_208 || ! V_333 ) )
return NULL ;
V_137 = V_208 -> V_5 ;
V_4 = F_137 ( V_208 , V_47 , V_332 , V_333 ) ;
if ( ! V_4 )
return NULL ;
V_4 -> V_125 . V_168 = 1 ;
V_4 -> V_125 . V_170 = 1 ;
V_4 -> V_140 = V_143 ;
V_338 = V_137 -> V_7 . V_241 / 8 ;
while ( ( V_332 | V_47 | V_333 ) & ( V_338 - 1 ) )
V_338 /= 2 ;
V_4 -> V_125 . V_183 = 0 ;
while ( V_338 != ( 1 << V_4 -> V_125 . V_183 ) )
V_4 -> V_125 . V_183 ++ ;
if ( V_4 -> V_125 . V_183 * 8 < V_137 -> V_7 . V_241 )
V_4 -> V_125 . V_180 = 1 ;
V_4 -> V_125 . V_180 = F_138 ( V_4 , V_333 ) ;
V_4 -> V_320 = V_333 ;
V_4 -> V_268 . V_193 = V_193 ;
return & V_4 -> V_268 ;
}
static void F_143 ( struct V_136 * V_137 ,
struct V_120 * V_337 )
{
unsigned long V_193 ;
struct V_120 * V_4 ;
...
static struct V_266 *
F_144 ( struct V_264 * V_74 , struct V_339 * V_340 ,
unsigned int V_341 , enum V_336 V_301 ,
unsigned long V_329 , void * V_342 )
{
struct V_120 * V_337 , * V_4 = NULL ;
struct V_207 * V_208 = F_87 ( V_74 ) ;
struct V_339 * V_343 ;
int V_214 ;
T_7 V_75 ;
if ( F_142 ( ! V_208 || ! V_340 || ! V_341 ) )
return NULL ;
V_75 = V_208 -> V_302 ;
V_337 = NULL ;
F_145 (sgl, sg, sg_len, i) {
V_4 = F_133 ( V_208 ) ;
if ( ! V_4 ) {
struct V_136 * V_137 = V_208 -> V_5 ;
F_35 ( V_208 -> V_5 -> V_89 . V_90 ,
...
V_4 -> V_125 . V_170 = 0 ;
F_136 ( & V_4 -> V_156 ,
V_75 , F_146 ( V_343 ) , F_147 ( V_343 ) ) ;
} else {
V_4 -> V_125 . V_168 = 0 ;
V_4 -> V_125 . V_170 = 1 ;
F_136 ( & V_4 -> V_156 ,
F_146 ( V_343 ) , V_75 , F_147 ( V_343 ) ) ;
}
V_4 -> V_125 . V_183 = V_208 -> V_304 ;
V_4 -> V_125 . V_180 = 1 ;
V_4 -> V_140 = V_301 ;
V_4 -> V_320 = F_147 ( V_343 ) ;
}
V_4 -> V_268 . V_193 = V_329 ;
return & V_4 -> V_268 ;
}
static T_9 F_148 ( int V_344 , void * V_213 )
{
if ( F_62 ( V_213 ) )
return V_345 ;
else
...
static int T_10 F_149 ( struct V_284 * V_90 )
{
struct V_347 * V_348 = F_150 ( V_90 ) ;
F_151 ( V_90 ) ;
if ( ! F_152 ( V_90 ) ) {
F_153 ( V_348 ) ;
}
...
static int T_10 F_155 ( struct V_284 * V_90 )
{
struct V_347 * V_348 = F_150 ( V_90 ) ;
int V_194 ;
V_194 = F_156 ( V_348 ) ;
...
static int
F_159 ( struct V_347 * V_349 , const struct V_350 * V_86 )
{
struct V_351 * V_352 ;
struct V_133 * V_7 ;
struct V_136 * V_137 ;
struct V_207 * V_208 , * V_353 ;
struct V_354 * V_355 ;
struct V_356 * V_357 ;
int V_214 , V_194 , V_344 ;
int V_217 ;
struct V_358 * V_359 = V_349 -> V_90 . V_360 ;
V_352 = F_160 ( & V_349 -> V_90 ) ;
V_194 = F_161 ( & V_349 -> V_90 , F_162 ( 32 ) ) ;
if ( V_194 )
return V_194 ;
V_137 = F_163 ( & V_349 -> V_90 , sizeof( * V_137 ) , V_259 ) ;
if ( ! V_137 )
return - V_204 ;
V_355 = & V_137 -> V_89 ;
V_355 -> V_90 = & V_349 -> V_90 ;
V_137 -> V_203 = V_352 ? V_352 -> V_361 : 0 ;
for ( V_214 = 0 ; V_214 < F_164 ( V_362 ) ; V_214 ++ )
if ( F_165 ( V_359 , V_362 [ V_214 ] . V_363 ) )
V_137 -> V_138 |= V_362 [ V_214 ] . V_86 ;
V_357 = & V_349 -> V_357 ;
V_137 -> V_80 = F_166 ( & V_349 -> V_90 , V_357 ) ;
if ( F_167 ( V_137 -> V_80 ) )
return F_168 ( V_137 -> V_80 ) ;
F_169 ( V_349 , V_137 ) ;
for ( V_214 = 0 ; V_214 < V_364 ; V_214 ++ ) {
V_344 = V_349 -> V_344 [ V_214 ] ;
if ( V_344 ) {
V_194 = F_170 ( & V_349 -> V_90 , V_344 ,
F_148 , 0 ,
F_171 ( & V_349 -> V_90 ) , V_137 ) ;
if ( V_194 )
return V_194 ;
} else {
break;
...
F_81 ( & V_137 -> V_281 ) ;
F_80 ( & V_137 -> V_330 ) ;
if ( ! F_129 ( V_137 , V_259 , V_366 ) )
F_172 ( & V_349 -> V_90 , L_43 ) ;
F_81 ( & V_355 -> V_218 ) ;
if ( V_352 )
V_217 = F_173 ( int , V_352 -> V_367 , V_7 -> V_217 ) ;
else
V_217 = F_173 ( int , V_7 -> V_200 , V_7 -> V_217 ) ;
V_137 -> V_297 = V_217 ;
...
if ( ! V_349 -> V_90 . V_360 )
V_208 -> V_74 . V_288 = V_352 ? & V_352 -> V_283 [ V_214 ] : NULL ;
else
V_208 -> V_74 . V_288 = V_349 -> V_90 . V_360 ;
F_81 ( & V_208 -> V_310 ) ;
F_81 ( & V_208 -> V_277 ) ;
F_81 ( & V_208 -> V_276 ) ;
F_80 ( & V_208 -> V_201 ) ;
V_208 -> V_270 = NULL ;
V_208 -> V_74 . V_284 = V_355 ;
V_208 -> V_5 = V_137 ;
F_64 ( & V_208 -> V_74 . V_358 , & V_355 -> V_218 ) ;
}
if ( V_352 ) {
V_355 -> V_369 = V_352 -> V_369 ;
} else {
F_174 ( V_370 , V_355 -> V_369 ) ;
if ( V_7 -> V_200 ) {
F_174 ( V_371 , V_355 -> V_369 ) ;
F_174 ( V_372 , V_355 -> V_369 ) ;
F_174 ( V_373 , V_355 -> V_369 ) ;
}
}
V_355 -> V_374 = F_108 ;
V_355 -> V_375 = F_116 ;
...
V_355 -> V_384 = V_385 ;
V_355 -> V_386 = V_385 ;
V_355 -> V_387 = F_175 ( V_142 ) | F_175 ( V_141 ) ;
V_355 -> V_388 = V_389 ;
V_355 -> V_390 = ( ( V_137 -> V_138 & V_139 ) ?
1 : V_391 ) ;
V_194 = F_176 ( V_355 ) ;
if ( V_194 ) {
F_35 ( & V_349 -> V_90 , L_44 ) ;
goto V_392;
}
if ( V_349 -> V_90 . V_360 ) {
V_194 = F_177 ( V_349 -> V_90 . V_360 ,
F_106 , V_137 ) ;
if ( V_194 ) {
F_35 ( & V_349 -> V_90 ,
L_45 ) ;
...
V_349 -> V_90 . V_393 = & V_137 -> V_393 ;
V_194 = F_178 ( & V_349 -> V_90 , 1900800 ) ;
if ( V_194 )
F_35 ( & V_349 -> V_90 , L_46 ) ;
F_41 ( & V_349 -> V_90 ,
L_47 , V_349 -> V_365 ) ;
F_41 ( & V_349 -> V_90 ,
L_48 ,
...
static int F_182 ( struct V_347 * V_349 )
{
struct V_136 * V_137 = F_183 ( V_349 ) ;
struct V_207 * V_208 , * V_353 ;
int V_214 , V_344 ;
F_184 ( V_137 -> V_89 . V_90 ) ;
if ( V_349 -> V_90 . V_360 )
F_185 ( V_349 -> V_90 . V_360 ) ;
for ( V_214 = 0 ; V_214 < V_364 ; V_214 ++ ) {
V_344 = V_349 -> V_344 [ V_214 ] ;
F_186 ( & V_349 -> V_90 , V_344 , V_137 ) ;
}
F_187 ( & V_137 -> V_89 ) ;
F_65 (pch, _p, &pl330->ddma.channels,
chan.device_node) {
