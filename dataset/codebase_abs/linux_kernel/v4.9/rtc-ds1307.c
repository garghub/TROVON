...
if ( ! V_108 -> V_109 )
goto V_28;
if ( F_40 ( V_2 -> V_11 . V_110 , L_26 , & V_99 ) )
goto V_28;
if ( F_41 ( V_2 -> V_11 . V_110 , L_27 ) )
V_100 = false ;
...
static int F_42 ( struct V_35 * V_11 , T_1 * V_112 )
{
struct V_20 * V_20 = F_19 ( V_11 ) ;
T_2 V_113 [ 2 ] ;
T_8 V_114 ;
...
if ( V_9 )
return V_9 ;
return sprintf ( V_63 , L_28 , V_114 ) ;
}
...
static int F_48 ( struct V_20 * V_20 , T_2 V_119 , T_2 V_120 )
{
...
static unsigned long F_49 ( struct V_121 * V_122 ,
unsigned long V_123 )
{
struct V_20 * V_20 = F_50 ( V_122 ) ;
int V_26 ;
int V_124 = 0 ;
...
static long F_51 ( struct V_121 * V_122 , unsigned long V_128 ,
unsigned long * V_129 )
{
int V_6 ;
for ( V_6 = F_52 ( V_127 ) - 1 ; V_6 >= 0 ; V_6 -- ) {
if ( V_127 [ V_6 ] <= V_128 )
return V_127 [ V_6 ] ;
}
return 0 ;
}
static int F_53 ( struct V_121 * V_122 , unsigned long V_128 ,
unsigned long V_123 )
{
struct V_20 * V_20 = F_50 ( V_122 ) ;
int V_26 = 0 ;
int V_124 ;
for ( V_124 = 0 ; V_124 < F_52 ( V_127 ) ;
V_124 ++ ) {
...
if ( V_124 & 2 )
V_26 |= V_126 ;
return F_48 ( V_20 , V_125 | V_126 ,
V_26 ) ;
}
static int F_54 ( struct V_121 * V_122 )
{
struct V_20 * V_20 = F_50 ( V_122 ) ;
return F_48 ( V_20 , V_130 , 0 ) ;
}
static void F_55 ( struct V_121 * V_122 )
{
struct V_20 * V_20 = F_50 ( V_122 ) ;
F_48 ( V_20 , V_130 , V_130 ) ;
}
...
static unsigned long F_57 ( struct V_121 * V_122 ,
unsigned long V_123 )
{
return 32768 ;
}
static int F_58 ( struct V_20 * V_20 , bool V_131 )
{
struct V_1 * V_2 = V_20 -> V_2 ;
struct V_21 * V_22 = & V_20 -> V_23 -> V_24 ;
int V_76 ;
...
int V_148 = - V_149 ;
int V_38 , V_150 ;
struct V_107 * V_108 = & V_151 [ V_147 -> V_152 ] ;
struct V_153 * V_154 = F_71 ( V_2 -> V_11 . V_155 ) ;
bool V_156 = false ;
bool V_157 = false ;
unsigned char * V_63 ;
struct V_158 * V_159 = F_72 ( & V_2 -> V_11 ) ;
struct V_36 V_160 ;
unsigned long V_161 ;
T_9 V_162 = F_13 ;
...
F_74 ( V_2 , V_20 ) ;
V_20 -> V_2 = V_2 ;
V_20 -> type = V_147 -> V_152 ;
if ( ! V_159 && V_2 -> V_11 . V_110 )
F_39 ( V_2 , V_108 ) ;
else if ( V_159 && V_159 -> V_111 )
V_108 -> V_111 = V_159 -> V_111 ;
if ( V_108 -> V_111 && V_108 -> V_171 ) {
F_4 ( & V_2 -> V_11 , L_32 ,
V_172 | V_108 -> V_111 ,
V_108 -> V_171 ) ;
F_7 ( V_2 , V_108 -> V_171 ,
...
#ifdef F_75
if ( F_41 ( V_2 -> V_11 . V_110 , L_33 ) ) {
V_157 = true ;
}
if ( F_41 ( V_2 -> V_11 . V_110 ,
L_34 ) ) {
V_157 = true ;
}
#endif
...
if ( V_20 -> V_41 [ 0 ] & V_173 )
V_20 -> V_41 [ 0 ] &= ~ V_173 ;
if ( V_108 -> V_174 && ( V_20 -> V_2 -> V_18 > 0 ||
V_157 ) ) {
V_20 -> V_41 [ 0 ] |= V_130
| V_163 [ V_20 -> type ] ;
...
V_183 = F_20 ( V_20 -> V_41 [ V_46 ] ) ;
if ( V_183 == 12 )
V_183 = 0 ;
if ( V_20 -> V_41 [ V_46 ] & V_184 )
V_183 += 12 ;
F_7 ( V_2 ,
V_46 << 4 | 0x08 ,
V_183 ) ;
...
case V_66 :
V_167 = & V_186 ;
if ( V_20 -> V_2 -> V_18 > 0 && V_108 -> V_174 ) {
V_162 = F_30 ;
V_156 = true ;
}
break;
...
V_20 -> V_23 = F_80 ( & V_2 -> V_11 , V_2 -> V_117 ,
V_167 , V_200 ) ;
if ( F_46 ( V_20 -> V_23 ) ) {
...
if ( V_108 -> V_204 ) {
V_20 -> V_205 = F_64 ( & V_2 -> V_11 ,
sizeof( struct V_94 ) ,
V_137 ) ;
if ( ! V_20 -> V_205 ) {
F_5 ( & V_2 -> V_11 , L_43 ) ;
} else {
V_20 -> V_205 -> V_95 . V_117 = L_44 ;
V_20 -> V_205 -> V_95 . V_206 = V_207 | V_208 ;
F_84 ( V_20 -> V_205 ) ;
V_20 -> V_205 -> V_209 = F_34 ;
V_20 -> V_205 -> V_210 = F_36 ;
V_20 -> V_205 -> V_211 = V_108 -> V_204 ;
V_20 -> V_98 = V_108 -> V_98 ;
V_148 = F_85 ( & V_2 -> V_11 . V_93 ,
V_20 -> V_205 ) ;
if ( V_148 ) {
F_5 ( & V_2 -> V_11 ,
L_45 ,
V_20 -> V_205 -> V_95 . V_117 ) ;
} else {
F_79 ( V_212 , & V_20 -> V_72 ) ;
F_81 ( & V_2 -> V_11 , L_46 ,
V_20 -> V_205 -> V_211 ) ;
}
}
...
{
struct V_20 * V_20 = F_14 ( V_2 ) ;
if ( F_87 ( V_212 , & V_20 -> V_72 ) )
F_88 ( & V_2 -> V_11 . V_93 , V_20 -> V_205 ) ;
return 0 ;
}
