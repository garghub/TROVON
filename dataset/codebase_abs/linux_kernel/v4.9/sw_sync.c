...
static bool F_35 ( struct V_2 * V_2 )
{
struct V_6 * V_23 = F_30 ( V_2 ) ;
...
static int F_39 ( struct V_27 * V_27 , struct V_28 * V_28 )
{
struct V_6 * V_8 ;
char V_29 [ V_30 ] ;
F_40 ( V_29 , V_31 ) ;
...
static int F_41 ( struct V_27 * V_27 , struct V_28 * V_28 )
{
...
static long F_43 ( struct V_6 * V_8 ,
unsigned long V_34 )
{
int V_35 = F_44 ( V_36 ) ;
int V_37 ;
...
if ( V_35 < 0 )
return V_35 ;
if ( F_45 ( & V_40 , ( void V_41 * ) V_34 , sizeof( V_40 ) ) ) {
V_37 = - V_42 ;
goto V_37;
}
...
V_40 . V_2 = V_35 ;
if ( F_48 ( ( void V_41 * ) V_34 , & V_40 , sizeof( V_40 ) ) ) {
F_49 ( V_38 -> V_28 ) ;
V_37 = - V_42 ;
goto V_37;
}
...
static long F_52 ( struct V_6 * V_8 , unsigned long V_34 )
{
T_1 V_19 ;
if ( F_45 ( & V_19 , ( void V_41 * ) V_34 , sizeof( V_19 ) ) )
return - V_42 ;
F_18 ( V_8 , V_19 ) ;
return 0 ;
}
static long F_53 ( struct V_28 * V_28 , unsigned int V_43 ,
unsigned long V_34 )
{
struct V_6 * V_8 = V_28 -> V_33 ;
switch ( V_43 ) {
case V_44 :
return F_43 ( V_8 , V_34 ) ;
case V_45 :
return F_52 ( V_8 , V_34 ) ;
default:
return - V_46 ;
}
}
