...
V_2 -> V_7 = V_7 ;
V_2 -> V_52 = V_52 ;
V_2 -> V_183 = F_69 ( & V_7 -> V_8 , L_29 ) ;
V_2 -> V_184 = F_69 ( & V_7 -> V_8 , L_30 ) ;
...
V_179 [ 1 ] = V_197 [ 1 ] ;
V_2 -> V_201 = F_57 ( & V_7 -> V_8 , V_181 *
sizeof( * V_2 -> V_201 ) , V_157 ) ;
V_2 -> V_163 = F_57 ( & V_7 -> V_8 , V_181 *
sizeof( * V_2 -> V_163 ) , V_157 ) ;
V_2 -> V_173 = V_181 ;
if ( F_76 ( ! V_2 -> V_201 || ! V_2 -> V_163 ) ) {
V_5 = - V_158 ;
goto V_193;
}
...
int V_5 ;
V_5 = F_77 ( V_2 -> V_163 [ V_182 ] . V_28 . V_206 ,
