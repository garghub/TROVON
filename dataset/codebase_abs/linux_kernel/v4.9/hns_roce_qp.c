...
if ( V_72 < V_73 )
return;
F_31 ( & V_6 -> V_43 , V_72 , V_40 ) ;
}
static int F_32 ( struct V_1 * V_2 ,
struct V_74 * V_75 , int V_76 , int V_77 ,
struct V_10 * V_16 )
{
T_1 V_78 ;
struct V_7 * V_8 = & V_2 -> V_9 -> V_8 ;
if ( V_75 -> V_79 > V_2 -> V_63 . V_80 ||
V_75 -> V_81 > V_2 -> V_63 . V_82 ) {
F_18 ( V_8 , L_6 ,
V_75 -> V_79 , V_75 -> V_81 ) ;
return - V_61 ;
}
...
V_16 -> V_83 . V_84 = V_16 -> V_83 . V_85 = 0 ;
} else {
if ( V_76 && ( ! V_75 -> V_79 || ! V_75 -> V_81 ) ) {
F_18 ( V_8 , L_8 ) ;
return - V_61 ;
}
V_78 = V_75 -> V_79 > V_86 ?
V_75 -> V_79 : V_86 ;
V_16 -> V_83 . V_84 = F_33 ( V_78 ) ;
if ( ( T_1 ) V_16 -> V_83 . V_84 > V_2 -> V_63 . V_80 ) {
F_18 ( V_8 , L_9 ) ;
return - V_61 ;
}
V_78 = F_34 ( 1U , V_75 -> V_81 ) ;
V_16 -> V_83 . V_85 = F_33 ( V_78 ) ;
V_16 -> V_83 . V_87 = F_35 ( V_2 -> V_63 . V_88 ) ;
}
V_75 -> V_79 = V_16 -> V_83 . V_89 = V_16 -> V_83 . V_84 ;
V_75 -> V_81 = V_16 -> V_83 . V_85 ;
return 0 ;
}
...
struct V_90 * V_91 )
{
T_1 V_92 = F_33 ( V_2 -> V_63 . V_93 ) ;
T_2 V_94 = F_35 ( V_92 ) ;
if ( ( T_1 ) ( 1 << V_91 -> V_95 ) > V_2 -> V_63 . V_80 ||
V_91 -> V_96 > V_94 ||
V_91 -> V_96 < V_97 ) {
F_18 ( & V_2 -> V_9 -> V_8 , L_10 ) ;
return - V_61 ;
}
V_16 -> V_98 . V_84 = 1 << V_91 -> V_95 ;
V_16 -> V_98 . V_87 = V_91 -> V_96 ;
V_16 -> V_99 = F_37 ( ( V_16 -> V_83 . V_84 <<
V_16 -> V_83 . V_87 ) , V_100 ) +
F_37 ( ( V_16 -> V_98 . V_84 <<
V_16 -> V_98 . V_87 ) , V_100 ) ;
V_16 -> V_98 . V_101 = 0 ;
V_16 -> V_83 . V_101 = F_37 ( ( V_16 -> V_98 . V_84 <<
V_16 -> V_98 . V_87 ) , V_100 ) ;
return 0 ;
}
...
struct V_7 * V_8 = & V_2 -> V_9 -> V_8 ;
T_1 V_78 ;
if ( V_75 -> V_102 > V_2 -> V_63 . V_80 ||
V_75 -> V_103 > V_2 -> V_63 . V_104 ||
V_75 -> V_105 > V_2 -> V_63 . V_106 ) {
F_18 ( V_8 , L_11 ) ;
return - V_61 ;
}
V_16 -> V_98 . V_87 = F_35 ( V_2 -> V_63 . V_93 ) ;
V_16 -> V_107 = 1 ;
V_16 -> V_108 = 0 ;
V_78 = V_75 -> V_102 > V_86 ?
V_75 -> V_102 : V_86 ;
V_16 -> V_98 . V_84 = F_33 ( V_78 ) ;
if ( ( T_1 ) V_16 -> V_98 . V_84 > V_2 -> V_63 . V_80 ) {
F_18 ( V_8 , L_12 ) ;
return - V_61 ;
}
V_78 = F_34 ( 1U , V_75 -> V_103 ) ;
V_16 -> V_98 . V_85 = F_33 ( V_78 ) ;
V_16 -> V_99 = F_37 ( ( V_16 -> V_83 . V_84 <<
V_16 -> V_83 . V_87 ) , V_100 ) +
F_37 ( ( V_16 -> V_98 . V_84 <<
V_16 -> V_98 . V_87 ) , V_100 ) ;
...
V_16 -> V_83 . V_101 = F_37 ( ( V_16 -> V_98 . V_84 <<
V_16 -> V_98 . V_87 ) , V_100 ) ;
V_75 -> V_102 = V_16 -> V_98 . V_89 = V_16 -> V_98 . V_84 ;
V_75 -> V_103 = V_16 -> V_98 . V_85 ;
V_75 -> V_105 = 0 ;
return 0 ;
}
...
V_16 -> V_118 = V_119 ;
V_60 = F_32 ( V_2 , & V_111 -> V_75 , ! ! V_109 -> V_120 ,
! ! V_111 -> V_121 , V_16 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_13 ) ;
goto V_66;
...
if ( V_109 -> V_120 ) {
if ( F_42 ( & V_91 , V_113 , sizeof( V_91 ) ) ) {
F_18 ( V_8 , L_14 ) ;
V_60 = - V_122 ;
goto V_66;
}
V_60 = F_36 ( V_2 , V_16 , & V_91 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_15 ) ;
goto V_66;
}
V_16 -> V_123 = F_43 ( V_109 -> V_120 -> V_124 ,
V_91 . V_125 , V_16 -> V_99 , 0 ,
0 ) ;
if ( F_44 ( V_16 -> V_123 ) ) {
F_18 ( V_8 , L_16 ) ;
V_60 = F_45 ( V_16 -> V_123 ) ;
goto V_66;
}
V_60 = F_46 ( V_2 , F_47 ( V_16 -> V_123 ) ,
F_35 ( ( unsigned int ) V_16 -> V_123 -> V_126 ) ,
& V_16 -> V_127 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_17 ) ;
goto V_128;
}
V_60 = F_48 ( V_2 , & V_16 -> V_127 ,
V_16 -> V_123 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_18 ) ;
goto V_129;
...
if ( V_111 -> V_130 & V_132 ) {
F_18 ( V_8 , L_19 ) ;
V_60 = - V_61 ;
goto V_66;
}
V_60 = F_38 ( V_2 , & V_111 -> V_75 ,
V_16 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_20 ) ;
goto V_66;
}
V_16 -> V_98 . V_133 = V_2 -> V_134 + V_135 +
V_136 * V_2 -> V_137 . V_138 ;
V_16 -> V_83 . V_133 = V_2 -> V_134 +
V_139 +
V_136 * V_2 -> V_137 . V_138 ;
if ( F_49 ( V_2 , V_16 -> V_99 , V_100 * 2 ,
& V_16 -> V_140 ) ) {
F_18 ( V_8 , L_21 ) ;
V_60 = - V_141 ;
goto V_66;
}
V_60 = F_46 ( V_2 , V_16 -> V_140 . V_142 ,
V_16 -> V_140 . V_143 , & V_16 -> V_127 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_22 ) ;
goto V_128;
}
V_60 = F_50 ( V_2 , & V_16 -> V_127 ,
& V_16 -> V_140 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_23 ) ;
goto V_129;
}
V_16 -> V_98 . V_144 = F_51 ( V_16 -> V_98 . V_84 , sizeof( V_145 ) ,
V_146 ) ;
V_16 -> V_83 . V_144 = F_51 ( V_16 -> V_83 . V_84 , sizeof( V_145 ) ,
V_146 ) ;
if ( ! V_16 -> V_98 . V_144 || ! V_16 -> V_83 . V_144 ) {
V_60 = - V_141 ;
goto V_147;
}
}
...
F_30 ( V_2 , V_3 , 1 ) ;
V_147:
F_53 ( V_16 -> V_98 . V_144 ) ;
F_53 ( V_16 -> V_83 . V_144 ) ;
V_129:
F_54 ( V_2 , & V_16 -> V_127 ) ;
V_128:
if ( V_109 -> V_120 )
...
F_56 ( V_2 , V_16 -> V_99 , & V_16 -> V_140 ) ;
V_66:
return V_60 ;
}
struct V_18 * F_57 ( struct V_109 * V_150 ,
struct V_110 * V_111 ,
struct V_112 * V_113 )
{
...
if ( ! V_16 )
return F_60 ( - V_141 ) ;
V_60 = F_39 ( V_2 , V_150 , V_111 , V_113 , 0 ,
V_16 ) ;
if ( V_60 ) {
F_18 ( V_8 , L_26 ) ;
F_53 ( V_16 ) ;
...
static void * F_72 ( struct V_10 * V_16 , int V_101 )
{
return F_73 ( & V_16 -> V_140 , V_101 ) ;
}
void * F_74 ( struct V_10 * V_16 , int V_212 )
{
return F_72 ( V_16 , V_16 -> V_83 . V_101 + ( V_212 << V_16 -> V_83 . V_87 ) ) ;
}
void * F_75 ( struct V_10 * V_16 , int V_212 )
{
return F_72 ( V_16 , V_16 -> V_98 . V_101 + ( V_212 << V_16 -> V_98 . V_87 ) ) ;
}
...
if ( F_77 ( V_218 + V_215 < V_214 -> V_89 ) )
return 0 ;
V_217 = F_78 ( V_216 ) ;
F_2 ( & V_217 -> V_12 ) ;
V_218 = V_214 -> V_219 - V_214 -> V_220 ;
F_5 ( & V_217 -> V_12 ) ;
return V_218 + V_215 >= V_214 -> V_89 ;
}
