...
#endif
V_2 -> type = V_99 ;
V_2 -> V_100 = V_101 + V_41 ;
V_2 -> V_102 = V_103 ;
V_2 -> V_52 = V_91 ;
}
static int F_58 ( struct V_1 * V_104 )
{
int V_105 ;
struct V_1 * V_106 ;
struct V_10 * V_11 ;
V_106 = F_59 ( sizeof( struct V_10 ) , L_7 , V_107 ,
F_56 ) ;
if ( ! V_106 )
return - V_108 ;
V_11 = F_6 ( V_106 ) ;
...
V_11 -> V_12 = V_104 ;
V_11 -> V_13 = V_106 ;
memcpy ( V_11 -> V_44 , V_109 , sizeof( V_110 ) ) ;
memcpy ( V_11 -> V_30 , V_109 , sizeof( V_110 ) ) ;
V_105 = F_61 ( V_106 ) ;
if ( V_105 )
goto error;
F_3 ( V_106 ) ;
...
static void F_64 ( struct V_1 * V_106 )
{
struct V_10 * V_11 = F_6 ( V_106 ) ;
F_63 ( V_11 -> V_12 ) ;
F_65 ( & V_11 -> V_81 ) ;
F_66 ( V_106 ) ;
}
static int F_67 ( struct V_111 * V_112 ,
unsigned long V_113 , void * V_22 )
{
...
F_80 () ;
while ( ! F_81 ( & V_80 ) ) {
V_11 = F_48 ( V_80 . V_126 , struct V_10 , V_81 ) ;
F_64 ( V_11 -> V_13 ) ;
}
F_82 () ;
}
