...
if ( ! V_25 -> V_10 )
return - V_18 ;
V_32 = F_27 ( sizeof( struct V_31 ) , V_17 ) ;
if ( ! V_32 ) {
F_28 ( V_25 -> V_10 ) ;
return - V_18 ;
}
...
{
int V_21 ;
V_21 = F_35 ( V_2 , & V_77 -> V_78 ) ;
if ( V_21 )
return V_21 ;
V_21 = F_37 ( V_2 , & V_77 -> V_79 ) ;
if ( V_21 )
return V_21 ;
...
if ( V_21 )
return V_21 ;
V_21 = F_35 ( V_2 , & V_54 -> V_86 ) ;
if ( V_21 )
return V_21 ;
V_21 = F_35 ( V_2 , & V_54 -> V_87 ) ;
if ( V_21 )
return V_21 ;
V_4 = F_2 ( V_2 , 8 + 8 ) ;
if ( ! V_4 )
return - V_5 ;
V_4 = F_40 ( V_4 , V_54 -> V_88 ) ;
V_4 = F_40 ( V_4 , V_54 -> V_89 ) ;
...
if ( F_3 ( V_4 == NULL ) )
return - V_5 ;
V_4 = F_30 ( V_4 , & V_54 -> V_88 ) ;
V_4 = F_30 ( V_4 , & V_54 -> V_89 ) ;
...
void F_43 ( struct V_99 * V_100 ,
struct V_1 * V_2 ,
struct V_101 * V_102 )
{
int V_21 ;
V_21 = F_31 ( V_2 , & V_102 -> V_103 ) ;
if ( V_21 )
goto V_104;
if ( V_102 -> V_105 )
V_21 = F_39 ( V_2 , V_102 -> V_105 ) ;
else
V_21 = F_1 ( V_2 , 0 ) ;
if ( V_21 )
goto V_104;
if ( V_102 -> V_106 )
V_21 = F_38 ( V_2 , V_102 -> V_106 ) ;
else
V_21 = F_1 ( V_2 , 0 ) ;
if ( V_21 )
goto V_104;
...
if ( ! V_117 )
return - V_18 ;
F_48 ( V_2 , F_49 ( V_117 ) , V_111 ) ;
V_21 = F_29 ( V_2 , & V_30 -> V_45 ) ;
if ( V_21 )
goto V_118;
V_21 = F_4 ( V_2 , & V_115 ) ;
if ( V_21 )
