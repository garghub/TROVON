...
static void F_170 ( struct V_123 * V_124 )
{
struct V_19 * V_20 = F_78 ( V_124 ) ;
enum V_344 type ;
switch ( V_20 -> V_345 ) {
...
static void F_172 ( struct V_353 * V_159 , int V_199 )
{
struct V_123 * V_124 = F_173 ( V_159 -> V_160 . V_354 ) ;
struct V_19 * V_20 = F_78 ( V_124 ) ;
struct V_75 * V_76 = & V_20 -> V_77 [ V_159 -> V_65 ] ;
V_76 -> V_185 . V_199 = V_199 ;
V_76 -> V_185 . V_186 = 1 ;
}
static void F_174 ( struct V_353 * V_159 , int V_202 )
{
struct V_123 * V_124 = F_173 ( V_159 -> V_160 . V_354 ) ;
struct V_19 * V_20 = F_78 ( V_124 ) ;
struct V_75 * V_76 = & V_20 -> V_77 [ V_159 -> V_65 ] ;
if ( V_202 <= V_20 -> V_204 && F_175 ( V_159 ) )
V_76 -> V_185 . V_197 = 1 ;
V_76 -> V_185 . V_202 = V_202 ;
V_76 -> V_185 . V_186 = 1 ;
}
static void F_176 ( struct V_353 * V_159 , int V_201 )
{
struct V_123 * V_124 = F_173 ( V_159 -> V_160 . V_354 ) ;
struct V_19 * V_20 = F_78 ( V_124 ) ;
struct V_75 * V_76 = & V_20 -> V_77 [ V_159 -> V_65 ] ;
...
static void F_177 ( struct V_353 * V_159 , int V_197 )
{
struct V_123 * V_124 = F_173 ( V_159 -> V_160 . V_354 ) ;
struct V_19 * V_20 = F_78 ( V_124 ) ;
struct V_75 * V_76 = & V_20 -> V_77 [ V_159 -> V_65 ] ;
