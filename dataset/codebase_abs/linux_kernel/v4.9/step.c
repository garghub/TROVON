...
V_22 = F_9 ( V_2 , V_5 , V_23 , sizeof( V_23 ) ,
V_24 ) ;
...
void F_17 ( struct V_1 * V_30 , bool V_31 )
{
unsigned long V_32 ;
F_18 () ;
V_32 = F_19 () ;
...
static void F_22 ( struct V_1 * V_2 , bool V_36 )
{
if ( F_12 ( V_2 ) && V_36 )
F_17 ( V_2 , true ) ;
else if ( F_14 ( V_2 , V_34 ) )
F_17 ( V_2 , false ) ;
}
