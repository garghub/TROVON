...
if ( V_59 -> V_51 )
continue;
error = F_91 ( V_43 , V_45 -> V_62 , V_45 -> V_153 ,
...
F_42 ( L_18 ,
V_45 -> V_62 , V_46 ) ;
F_94 ( V_43 , V_45 -> V_153 , V_46 , V_45 -> V_62 ) ;
}
}
F_96 ( & V_159 -> V_160 -> V_161 , V_157 ) ;
F_97 () ;
F_98 ( & V_159 -> V_160 -> V_161 , V_157 ) ;
}
int
F_99 ( struct V_39 * V_40 , struct V_162 * V_163 ,
struct V_86 * V_87 )
{
struct V_164 * V_165 = & V_87 -> V_166 . V_167 [ 0 ] ;
struct V_164 * V_168 = & V_87 -> V_169 . V_167 [ 0 ] ;
struct V_170 * V_37 ;
int V_171 ;
int error ;
F_42 ( L_19 , V_156 , V_163 ) ;
V_87 -> V_172 = V_40 -> V_173 ;
V_87 -> V_174 = V_163 -> V_174 ;
V_87 -> V_175 = V_163 -> V_172 -> V_176 ;
V_87 -> V_98 = V_40 ;
V_87 -> V_177 = sizeof( V_163 -> V_172 -> V_178 ) ;
memcpy ( & V_87 -> V_179 , & V_163 -> V_172 -> V_178 , V_87 -> V_177 ) ;
memcpy ( & V_87 -> V_166 , & V_163 -> V_180 , sizeof( V_87 -> V_166 ) ) ;
memcpy ( & V_87 -> V_169 , & V_163 -> V_181 , sizeof( V_87 -> V_169 ) ) ;
V_87 -> V_166 . V_182 = V_163 -> V_183 . V_182 ;
if ( V_87 -> V_166 . V_182 <= V_87 -> V_166 . V_167 [ 0 ] . V_184 ) {
V_87 -> V_166 . V_167 [ 0 ] . V_184 = V_87 -> V_166 . V_182 ;
V_87 -> V_166 . V_185 = 0 ;
} else if ( V_87 -> V_166 . V_182 <= V_87 -> V_166 . V_167 [ 0 ] . V_184 +
V_87 -> V_166 . V_185 )
V_87 -> V_166 . V_185 = V_87 -> V_166 . V_182 -
V_87 -> V_166 . V_167 [ 0 ] . V_184 ;
else
V_87 -> V_166 . V_182 = V_87 -> V_166 . V_167 [ 0 ] . V_184 +
V_87 -> V_166 . V_185 ;
V_168 -> V_184 = 0 ;
F_100 ( V_165 ) ;
F_101 ( V_165 ) ;
V_171 = F_102 ( V_87 , V_165 , V_168 ) ;
F_103 ( & V_163 -> V_172 -> V_186 ) ;
if ( ! V_171 ) {
F_104 ( V_163 ) ;
return 0 ;
}
memcpy ( & V_163 -> V_181 , & V_87 -> V_169 , sizeof( V_163 -> V_181 ) ) ;
V_37 = F_105 ( V_163 ) ;
if ( F_75 ( V_37 ) ) {
error = F_76 ( V_37 ) ;
goto V_12;
}
F_21 ( F_106 ( & V_37 -> V_187 ) != 1 ) ;
error = V_37 -> V_188 ;
F_107 ( V_37 ) ;
V_12:
F_42 ( L_20 , V_156 , error ) ;
return error ;
}
T_1 F_108 ( const struct V_86 * V_87 )
{
T_1 V_189 = V_87 -> V_172 -> V_190 -> V_191 ;
if ( V_87 -> V_98 -> V_67 < V_189 )
V_189 = V_87 -> V_98 -> V_67 ;
return V_189 ;
}
