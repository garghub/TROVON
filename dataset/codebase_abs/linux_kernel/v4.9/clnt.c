...
int (* F_90)( struct V_1 * , struct V_38 * , void * ) ,
void * V_154 )
{
struct V_151 V_152 ;
int V_155 ;
...
return V_155 ;
for (; ; ) {
struct V_38 * V_39 = F_91 ( & V_152 ) ;
if ( ! V_39 )
break;
V_155 = F_90 ( V_2 , V_39 , V_154 ) ;
F_67 ( V_39 ) ;
if ( V_155 < 0 )
break;
}
...
struct V_1 * F_108 ( struct V_1 * V_42 ,
...
V_57 = F_130 ( V_219 , V_215 , V_216 , 0 ) ;
if ( V_57 < 0 ) {
F_45 ( L_24 , V_57 ) ;
goto V_225;
}
V_57 = F_131 ( V_219 , V_208 , & V_217 ) ;
if ( V_57 < 0 ) {
F_45 ( L_25 , V_57 ) ;
goto V_225;
}
...
V_3 = F_135 ( V_39 -> V_229 ) ;
F_80 () ;
F_136 ( V_215 , 0 ) ;
V_57 = F_127 ( V_3 , V_215 , V_216 , V_208 , V_217 ) ;
F_137 ( V_3 ) ;
if ( V_57 != 0 )
...
if ( V_275 == NULL )
return;
V_165 -> V_190 = F_165 ( V_165 , V_275 , V_194 , V_276 ,
V_165 -> V_175 . V_177 ) ;
}
static void
...
return;
if ( V_305 )
V_165 -> V_166 -> V_87 -> V_308 ++ ;
V_307 ( V_165 ) ;
if ( F_174 ( V_165 ) )
return;
V_165 -> V_183 = V_309 ;
F_98 ( & V_165 -> V_199 -> V_260 -> V_310 , V_165 ) ;
}
static void
...
if ( V_194 -> V_315 != V_194 -> V_260 -> V_316 )
V_194 -> V_274 = 0 ;
F_173 ( V_165 ) ;
if ( V_165 -> V_190 == - V_153 )
goto V_317;
...
F_98 ( & V_194 -> V_260 -> V_310 , V_165 ) ;
V_314:
V_165 -> V_183 = V_309 ;
return;
V_317:
V_194 -> V_315 = V_194 -> V_260 -> V_316 ;
V_312:
V_165 -> V_190 = 0 ;
}
static void
V_306 ( struct V_156 * V_165 )
{
struct V_1 * V_2 = V_165 -> V_166 ;
struct V_193 * V_194 = V_165 -> V_199 ;
int V_187 ;
...
F_182 ( memcmp ( & V_194 -> V_277 , & V_194 -> V_325 ,
...
V_165 -> V_183 = V_309 ;
if ( V_324 ) {
V_165 -> V_190 = F_184 ( V_165 , V_324 , V_194 , V_276 ,
V_165 -> V_175 . V_178 ) ;
}
...
V_276 = F_185 ( V_194 -> V_260 , V_276 ) ;
* V_276 ++ = V_194 -> V_328 ;
* V_276 ++ = F_186 ( V_329 ) ;
* V_276 ++ = F_186 ( V_330 ) ;
* V_276 ++ = F_186 ( V_2 -> V_83 ) ;
* V_276 ++ = F_186 ( V_2 -> V_86 ) ;
* V_276 ++ = F_186 ( V_165 -> V_175 . V_176 -> V_263 ) ;
V_276 = F_187 ( V_165 , V_276 ) ;
V_194 -> V_331 = F_188 ( & V_194 -> V_326 [ 0 ] , V_276 ) ;
return V_276 ;
}
static T_6 *
...
goto V_335;
V_276 += 1 ;
if ( ( V_334 = F_189 ( * V_276 ++ ) ) != V_336 ) {
F_45 ( L_64 ,
V_165 -> V_242 , V_30 , V_334 ) ;
error = - V_160 ;
goto V_337;
}
if ( ( V_334 = F_189 ( * V_276 ++ ) ) != V_338 ) {
if ( -- V_200 < 0 )
goto V_335;
switch ( ( V_334 = F_189 ( * V_276 ++ ) ) ) {
case V_339 :
break;
case V_340 :
F_45 ( L_65 ,
...
V_57 = F_119 ( V_2 , & V_174 , V_169 | V_198 ) ;
F_193 ( V_174 . V_179 ) ;
return V_57 ;
}
static
...
V_154 -> V_39 = F_75 ( V_39 ) ;
V_362 = V_360 . V_361 ( NULL , NULL , 0 ) ;
V_165 = F_194 ( V_2 , V_39 , V_362 ,
V_169 | V_198 | V_188 ,
& V_367 , V_154 ) ;
F_193 ( V_362 ) ;
if ( F_18 ( V_165 ) )
...
void * V_154 )
{
unsigned long V_41 = * ( ( unsigned long * ) V_154 ) ;
if ( V_41 < V_39 -> V_373 )
V_39 -> V_373 = V_41 ;
return 0 ;
}
void
F_208 ( struct V_1 * V_2 , unsigned long V_376 )
{
F_89 ( V_2 ,
F_207 ,
& V_376 ) ;
...
{
F_78 () ;
F_59 ( F_79 ( V_2 -> V_93 . V_144 ) ) ;
F_80 () ;
}
void F_210 ( struct V_1 * V_2 , struct V_38 * V_39 )
{
F_78 () ;
F_197 ( F_79 ( V_2 -> V_93 . V_144 ) ,
V_39 ) ;
F_80 () ;
}
...
{
const char * V_377 = L_88 ;
if ( F_97 ( V_165 ) )
V_377 = F_214 ( V_165 -> V_161 ) ;
F_20 ( V_21 L_89 ,
