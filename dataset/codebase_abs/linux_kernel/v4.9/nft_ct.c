...
static int F_27 ( const struct V_91 * V_92 ,
...
if ( V_94 [ V_97 ] == NULL )
return - V_98 ;
switch ( V_92 -> V_100 -> V_86 ) {
case V_71 :
V_95 = F_30 ( struct V_30 ,
V_68 . V_69 . V_101 ) ;
break;
case V_89 :
case V_87 :
...
if ( V_94 [ V_97 ] == NULL )
return - V_98 ;
V_95 = F_30 ( struct V_30 , V_68 . V_77 . V_70 ) ;
break;
case V_8 :
case V_58 :
if ( V_94 [ V_97 ] == NULL )
...
V_20 -> V_23 = F_32 ( V_94 [ V_105 ] ) ;
V_40 = F_33 ( V_92 , V_20 -> V_23 , NULL ,
V_106 , V_95 ) ;
if ( V_40 < 0 )
return V_40 ;
V_40 = F_23 ( V_92 -> V_100 -> V_86 ) ;
if ( V_40 < 0 )
return V_40 ;
if ( V_20 -> V_36 == V_8 || V_20 -> V_36 == V_58 )
F_34 ( V_92 -> V_107 , true ) ;
return 0 ;
}
static int F_35 ( const struct V_91 * V_92 ,
const struct V_13 * V_14 ,
const struct V_93 * const V_94 [] )
{
struct V_19 * V_20 = F_4 ( V_14 ) ;
...
return - V_98 ;
V_95 = V_57 ;
V_40 = F_36 ( V_92 -> V_107 , ( V_95 * V_109 ) - 1 ) ;
if ( V_40 )
return V_40 ;
V_108 = true ;
break;
...
V_20 -> V_84 = F_32 ( V_94 [ V_110 ] ) ;
V_40 = F_37 ( V_20 -> V_84 , V_95 ) ;
if ( V_40 < 0 )
goto V_88;
V_40 = F_23 ( V_92 -> V_100 -> V_86 ) ;
if ( V_40 < 0 )
...
static void F_39 ( const struct V_91 * V_92 ,
const struct V_13 * V_14 )
{
F_26 ( V_92 -> V_100 -> V_86 ) ;
}
static void F_40 ( const struct V_91 * V_92 ,
const struct V_13 * V_14 )
{
struct V_19 * V_20 = F_4 ( V_14 ) ;
switch ( V_20 -> V_36 ) {
...
{
const struct V_19 * V_20 = F_4 ( V_14 ) ;
if ( F_42 ( V_35 , V_105 , V_20 -> V_23 ) )
goto V_111;
if ( F_43 ( V_35 , V_96 , F_44 ( V_20 -> V_36 ) ) )
goto V_111;
switch ( V_20 -> V_36 ) {
case V_67 :
case V_72 :
case V_74 :
case V_78 :
if ( F_45 ( V_35 , V_97 , V_20 -> V_63 ) )
goto V_111;
break;
case V_8 :
case V_58 :
if ( V_20 -> V_63 < V_7 &&
F_45 ( V_35 , V_97 , V_20 -> V_63 ) )
goto V_111;
break;
default:
break;
...
F_47 ( const struct V_91 * V_92 ,
const struct V_93 * const V_94 [] )
{
if ( V_94 [ V_96 ] == NULL )
return F_48 ( - V_98 ) ;
if ( V_94 [ V_105 ] && V_94 [ V_110 ] )
return F_48 ( - V_98 ) ;
if ( V_94 [ V_105 ] )
return & V_113 ;
if ( V_94 [ V_110 ] )
