...
static int F_81 ( struct V_132 * V_8 ,
enum V_121 V_122 )
{
struct V_7 * V_133 = F_21 ( V_8 ) ;
struct V_140 * V_141 = & V_133 -> V_141 ;
T_7 V_120 ;
T_5 V_142 ;
enum V_143 V_144 ;
if ( V_122 == V_105 ) {
V_120 = V_133 -> V_109 . V_145 ;
V_142 = V_133 -> V_109 . V_103 ;
V_144 = V_146 ;
} else {
V_120 = V_133 -> V_113 . V_145 ;
V_142 = V_133 -> V_113 . V_103 ;
V_144 = V_147 ;
}
if ( V_120 == V_141 -> V_148 . V_145 &&
V_142 == V_141 -> V_148 . V_103 &&
V_144 == V_141 -> V_122 )
return 0 ;
if ( V_141 -> V_148 . V_103 )
F_82 ( V_8 -> V_22 -> V_23 , V_141 -> V_149 ,
V_141 -> V_148 . V_103 , V_141 -> V_122 , 0 ) ;
V_141 -> V_148 . V_103 = 0 ;
V_141 -> V_149 = F_83 ( V_8 -> V_22 -> V_23 , V_120 , V_142 ,
V_144 , 0 ) ;
if ( F_84 ( V_8 -> V_22 -> V_23 , V_141 -> V_149 ) ) {
F_85 ( V_8 -> V_22 -> V_23 ,
L_6 , V_133 -> V_24 ,
V_142 , & V_120 ) ;
return - V_62 ;
...
V_133 -> V_24 , V_142 , & V_120 , & V_141 -> V_149 ,
V_144 == V_146 ? L_8 : L_9 ) ;
V_141 -> V_148 . V_145 = V_120 ;
V_141 -> V_148 . V_103 = V_142 ;
V_141 -> V_122 = V_144 ;
return 0 ;
}
static struct V_63 *
...
if ( F_81 ( V_8 , V_122 ) )
return NULL ;
return F_60 ( V_133 , V_118 , V_119 , V_133 -> V_141 . V_149 ,
V_122 , V_65 , false ) ;
}
static struct V_63 *
...
F_77 ( & V_118 [ V_73 ] , F_78 ( F_79 ( V_109 ) ) , V_154 ,
F_80 ( V_109 ) ) ;
F_62 ( & V_118 [ V_73 ] ) = V_109 ;
F_63 ( & V_118 [ V_73 ] ) = V_154 ;
}
V_15 = F_60 ( V_133 , V_118 , V_119 , V_133 -> V_141 . V_149 ,
V_122 , V_65 , true ) ;
F_89 ( V_118 ) ;
return V_15 ;
}
...
{
struct V_7 * V_133 = F_21 ( V_8 ) ;
V_133 -> V_109 . V_145 = V_157 -> V_49 ;
V_133 -> V_113 . V_145 = V_157 -> V_35 ;
...
return false ;
return ! F_113 ( V_179 -> args [ 0 ] , V_2 -> V_136 ) ;
}
