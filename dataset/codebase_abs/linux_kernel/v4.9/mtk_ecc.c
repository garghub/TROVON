...
T_1 V_52 ;
int V_8 ;
V_58 = F_40 ( V_2 -> V_6 , V_87 , V_88 , V_89 ) ;
...
F_43 ( V_2 -> V_92 , V_2 -> V_9 + F_44 ( 0 ) , F_45 ( V_52 , 4 ) ) ;
memcpy ( V_87 + V_88 , V_2 -> V_92 , V_52 ) ;
V_91:
F_42 ( V_2 -> V_6 , V_58 , V_88 , V_89 ) ;
F_34 ( V_2 ) ;
return V_8 ;
...
40 , 44 , 48 , 52 , 56 , 60 } ;
int V_67 ;
for ( V_67 = 0 ; V_67 < F_47 ( V_2 ) ; V_67 ++ ) {
if ( * V_93 <= V_2 [ V_67 ] ) {
if ( ! V_67 )
* V_93 = V_2 [ V_67 ] ;
else if ( * V_93 != V_2 [ V_67 ] )
* V_93 = V_2 [ V_67 - 1 ] ;
return;
}
}
...
struct V_94 * V_95 ;
int V_13 , V_8 ;
V_2 = F_49 ( V_6 , sizeof( * V_2 ) , V_96 ) ;
if ( ! V_2 )
return - V_97 ;
V_95 = F_50 ( V_81 , V_98 , 0 ) ;
V_2 -> V_9 = F_51 ( V_6 , V_95 ) ;
if ( F_52 ( V_2 -> V_9 ) ) {
F_12 ( V_6 , L_9 , F_53 ( V_2 -> V_9 ) ) ;
return F_53 ( V_2 -> V_9 ) ;
}
V_2 -> V_74 = F_54 ( V_6 , NULL ) ;
if ( F_52 ( V_2 -> V_74 ) ) {
F_12 ( V_6 , L_10 , F_53 ( V_2 -> V_74 ) ) ;
return F_53 ( V_2 -> V_74 ) ;
}
V_13 = F_55 ( V_81 , 0 ) ;
if ( V_13 < 0 ) {
F_12 ( V_6 , L_11 ) ;
...
V_8 = F_56 ( V_6 , F_57 ( 32 ) ) ;
if ( V_8 ) {
F_12 ( V_6 , L_12 ) ;
return V_8 ;
}
V_8 = F_58 ( V_6 , V_13 , F_5 , 0x0 , L_13 , V_2 ) ;
if ( V_8 ) {
F_12 ( V_6 , L_14 ) ;
return - V_90 ;
}
