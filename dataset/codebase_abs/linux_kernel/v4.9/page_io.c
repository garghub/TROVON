...
int F_32 ( struct V_3 * V_3 , struct V_56 * V_57 )
{
int V_45 = 0 ;
if ( F_33 ( V_3 ) ) {
F_25 ( V_3 ) ;
...
V_45 = F_36 ( V_3 , V_57 , F_6 ) ;
V_28:
return V_45 ;
}
static T_4 F_37 ( struct V_3 * V_3 )
{
return ( T_4 ) F_38 ( V_3 ) << ( V_8 - 9 ) ;
}
int F_36 ( struct V_3 * V_3 , struct V_56 * V_57 ,
T_2 V_58 )
{
struct V_1 * V_1 ;
int V_45 ;
...
struct V_65 V_66 ;
F_40 ( & V_66 , V_67 | V_68 , & V_62 , 1 , V_10 ) ;
F_41 ( & V_60 , V_30 ) ;
V_60 . V_69 = F_42 ( V_3 ) ;
F_35 ( V_3 ) ;
F_25 ( V_3 ) ;
V_45 = V_33 -> V_70 -> V_71 ( & V_60 , & V_66 ) ;
if ( V_45 == V_10 ) {
F_43 ( V_72 ) ;
V_45 = 0 ;
} else {
...
V_45 = F_45 ( V_17 -> V_22 , F_37 ( V_3 ) , V_3 , V_57 ) ;
if ( ! V_45 ) {
F_43 ( V_72 ) ;
return 0 ;
}
V_45 = 0 ;
V_1 = F_1 ( V_73 , V_3 , V_58 ) ;
if ( V_1 == NULL ) {
F_8 ( V_3 ) ;
F_25 ( V_3 ) ;
V_45 = - V_74 ;
...
struct V_29 * V_30 = V_17 -> V_30 ;
struct V_32 * V_33 = V_30 -> V_34 ;
V_45 = V_33 -> V_70 -> V_79 ( V_30 , V_3 ) ;
if ( ! V_45 )
F_43 ( V_80 ) ;
return V_45 ;
}
V_45 = F_52 ( V_17 -> V_22 , F_37 ( V_3 ) , V_3 ) ;
if ( ! V_45 ) {
if ( F_53 ( V_3 ) ) {
F_15 ( V_3 ) ;
F_25 ( V_3 ) ;
