...
struct V_112 * V_112 , bool V_113 ,
struct V_6 * V_7 )
{
struct V_26 * V_27 = V_2 -> V_27 ;
struct V_6 * V_10 = & V_2 -> V_3 ;
struct V_19 * V_115 = & V_27 -> V_20 [ V_10 -> V_12 ] ;
struct V_19 * V_116 = & V_27 -> V_20 [ V_7 -> V_12 ] ;
int V_11 ;
F_73 ( V_2 -> V_86 , V_112 ) ;
if ( ! V_113 ) {
struct V_1 * V_114 ;
...
F_76 ( V_114 ) ;
F_77 ( & V_114 ) ;
} else if ( V_115 -> V_71 & V_72 ) {
F_79 ( & V_115 -> V_117 ) ;
if ( ! V_115 -> V_118 || F_80 ( V_112 , V_115 -> V_118 ) ) {
F_74 ( V_115 -> V_118 ) ;
V_115 -> V_118 = F_75 ( V_112 ) ;
}
F_81 ( & V_115 -> V_117 ) ;
F_1 ( V_2 ) ;
F_74 ( V_2 -> V_79 ) ;
