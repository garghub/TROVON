...
if ( V_11 -> V_144 )
V_11 -> V_144 = 0 ;
if ( ! F_102 ( V_133 , & V_83 -> V_134 ) )
F_103 ( V_166 , & V_83 -> V_146 ) ;
}
F_64 ( & V_8 -> V_136 ) ;
}
...
static inline void F_106 ( struct V_6 * V_11 , struct V_150 * V_151 )
{
struct V_82 * V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
T_4 V_73 , V_167 ;
char * V_168 ;
...
static void F_107 ( struct V_82 * V_83 )
{
...
static inline void F_108 ( struct V_82 * V_83 , struct V_150 * V_151 )
{
T_4 V_73 , V_167 ;
char * V_168 ;
...
static inline void F_109 ( struct V_82 * V_83 ,
struct V_150 * V_151 )
{
T_4 V_73 , V_167 ;
T_1 V_59 ;
...
static inline void F_110 ( struct V_6 * V_11 ,
struct V_150 * V_151 ,
struct V_88 * V_89 )
{
struct V_82 * V_83 =
...
static inline int F_111 ( struct V_6 * V_11 ,
struct V_150 * V_151 )
{
struct V_82 * V_83 =
F_28 ( V_11 , struct V_82 , V_11 ) ;
...
F_110 ( V_11 , V_151 , V_89 ) ;
if ( ! ( V_83 -> V_172 & V_176 ) )
F_88 ( V_89 -> V_159 , V_83 -> V_178 ) ;
F_33 ( & V_11 -> V_95 ) ;
return 0 ;
}
static int F_112 ( struct V_6 * V_11 ,
struct V_150 * V_151 )
{
struct V_82 * V_83 =
F_28 ( V_11 , struct V_82 , V_11 ) ;
...
F_110 ( V_11 , V_151 , V_89 ) ;
if ( ! ( V_83 -> V_172 & V_176 ) )
F_115 ( V_89 , V_83 -> V_178 ) ;
F_33 ( & V_11 -> V_95 ) ;
return 0 ;
}
static inline int F_116 ( struct V_6 * V_11 ,
struct V_150 * V_151 )
{
struct V_82 * V_83 =
F_28 ( V_11 , struct V_82 , V_11 ) ;
...
static int F_117 ( struct V_191 * V_192 , struct V_193 * V_193 )
{
int V_90 ;
V_90 = F_118 ( V_192 , L_41 , V_193 , V_194 , 0 ,
V_195 ) ;
if ( V_90 < 0 )
return V_90 ;
return 0 ;
}
static T_4 F_119 ( struct V_6 * V_11 )
{
return V_196 ;
}
static inline int F_116 ( struct V_6 * V_11 ,
...
struct V_82 * V_83 =
F_28 ( V_11 , struct V_82 , V_11 ) ;
if ( F_116 ( V_11 , V_151 ) == 0 )
F_107 ( V_83 ) ;
else {
V_83 -> V_172 &= ~ V_176 ;
}
}
static inline void F_121 ( struct V_82 * V_83 , struct V_150 * V_151 )
{
T_4 V_73 ;
V_73 = V_83 -> V_171 - V_83 -> V_170 ;
if ( V_73 > V_151 -> V_3 )
...
static int F_122 ( T_6 * V_197 , struct V_148 * V_149 , unsigned int V_59 , T_4 V_73 )
{
...
static void F_124 ( struct V_82 * V_83 )
{
struct V_6 * V_11 = & V_83 -> V_11 ;
struct V_7 * V_8 ;
T_6 V_197 = {
...
V_78:
F_73 ( & V_83 -> V_143 ) ;
F_128 ( V_11 , V_201 , V_200 ) ;
}
static void F_129 ( struct V_162 * V_163 )
{
struct V_82 * V_83 =
F_28 ( V_163 , struct V_82 , V_146 ) ;
F_124 ( V_83 ) ;
...
if ( F_150 ( V_7 , (struct V_10 * ) & V_4 , & V_161 ) < 0 )
goto V_78;
switch ( V_4 . V_231 ) {
case V_28 :
...
static void F_168 ( struct V_162 * V_163 )
{
}
...
F_2 ( L_61 ,
V_11 , V_11 -> V_22 [ V_23 ] ) ;
V_106 = F_172 ( V_11 , V_7 ) ;
F_176 ( V_11 , V_7 , V_106 ) ;
switch ( V_106 ) {
case 0 :
F_2 ( L_62 ,
V_11 , V_11 -> V_22 [ V_23 ] ) ;
...
if ( F_186 ( & V_11 -> V_141 ) != 1 )
return 0 ;
if ( F_187 ( & V_11 -> V_125 , V_258 , V_259 ) )
return - V_260 ;
if ( V_257 -> V_86 )
F_184 ( V_257 -> V_86 ) ;
F_50 ( V_11 , NULL ) ;
...
static void F_191 ( struct V_162 * V_163 )
{
struct V_82 * V_83 =
...
static void F_200 ( struct V_162 * V_163 )
{
struct V_82 * V_83 =
F_28 ( V_163 , struct V_82 , V_145 . V_163 ) ;
struct V_39 * V_7 = V_83 -> V_7 ;
...
static void F_216 ( struct V_80 * V_81 )
{
void * V_314 = V_81 -> V_84 -> V_312 ;
struct V_310 * V_4 ;
V_4 = F_28 ( V_314 , struct V_310 , V_199 ) ;
F_217 ( ( unsigned long ) V_4 ) ;
}
static int F_218 ( struct V_88 * V_89 )
{
int V_73 ;
...
V_73 = F_219 ( V_7 , V_315 ,
F_220 ( V_315 -> V_77 [ 0 ] . V_52 ) , V_316 ,
...
static int F_221 ( struct V_80 * V_81 )
{
struct V_88 * V_89 = V_81 -> V_84 ;
struct V_319 * V_11 ;
int V_73 ;
...
if ( ! F_222 ( & V_11 -> V_321 ) ) {
F_223 ( & V_11 -> V_322 , V_81 , NULL ) ;
if ( ! F_222 ( & V_11 -> V_321 ) )
return - V_91 ;
F_224 ( & V_11 -> V_322 , V_81 ) ;
}
...
static int F_227 ( const int V_243 , struct V_10 * V_16 )
{
static const struct V_14 sin = {
. V_325 = V_25 ,
. V_26 . V_27 = F_228 ( V_326 ) ,
} ;
...
static struct V_6 * F_229 ( struct V_330 * args ,
unsigned int V_331 ,
unsigned int V_332 )
{
struct V_6 * V_11 ;
...
V_11 = F_230 ( args -> V_193 , sizeof( * V_333 ) , V_331 ,
V_332 ) ;
if ( V_11 == NULL ) {
F_2 ( L_84
L_85 ) ;
...
static struct V_6 * F_232 ( struct V_330 * args )
{
struct V_13 * V_18 = (struct V_13 * ) args -> V_335 ;
struct V_82 * V_83 ;
struct V_6 * V_11 ;
struct V_6 * V_90 ;
V_11 = F_229 ( args , V_336 ,
V_337 ) ;
if ( F_192 ( V_11 ) )
return V_11 ;
V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
...
static struct V_6 * F_236 ( struct V_330 * args )
{
struct V_10 * V_12 = args -> V_335 ;
struct V_6 * V_11 ;
struct V_82 * V_83 ;
struct V_6 * V_90 ;
V_11 = F_229 ( args , V_351 ,
V_351 ) ;
if ( F_192 ( V_11 ) )
return V_11 ;
V_83 = F_28 ( V_11 , struct V_82 , V_11 ) ;
...
V_11 -> V_70 = & V_354 ;
V_11 -> V_265 = & V_355 ;
F_233 ( & V_83 -> V_146 , F_100 ) ;
F_234 ( & V_83 -> V_145 , F_191 ) ;
switch ( V_12 -> V_19 ) {
case V_25 :
if ( ( (struct V_14 * ) V_12 ) -> V_233 != F_237 ( 0 ) )
F_160 ( V_11 ) ;
F_16 ( V_11 , L_89 , V_356 ) ;
break;
case V_28 :
if ( ( (struct V_15 * ) V_12 ) -> V_232 != F_237 ( 0 ) )
F_160 ( V_11 ) ;
...
static struct V_6 * F_238 ( struct V_330 * args )
{
struct V_10 * V_12 = args -> V_335 ;
struct V_6 * V_11 ;
struct V_82 * V_83 ;
...
F_233 ( & V_83 -> V_146 , F_129 ) ;
F_234 ( & V_83 -> V_145 , F_200 ) ;
switch ( V_12 -> V_19 ) {
case V_25 :
if ( ( (struct V_14 * ) V_12 ) -> V_233 != F_237 ( 0 ) )
F_160 ( V_11 ) ;
...
static int F_249 ( const char * V_380 ,
...
if ( ! V_380 )
return - V_261 ;
V_90 = F_250 ( V_380 , 0 , & V_385 ) ;
if ( V_90 == - V_261 || V_385 < V_383 || V_385 > V_384 )
return - V_261 ;
* ( ( unsigned int * ) V_382 -> V_198 ) = V_385 ;
return 0 ;
}
static int F_251 ( const char * V_380 , const struct V_381 * V_382 )
{
if ( V_382 -> V_198 == & V_225 )
return F_249 ( V_380 , V_382 ,
V_386 ,
V_224 ) ;
return F_249 ( V_380 , V_382 ,
V_225 ,
...
static int F_252 ( const char * V_380 ,
const struct V_381 * V_382 )
{
return F_249 ( V_380 , V_382 ,
V_388 ,
