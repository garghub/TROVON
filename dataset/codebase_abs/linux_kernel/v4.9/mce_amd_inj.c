...
V_54 . V_46 = V_53 ;
V_54 . V_48 = V_12 ;
F_41 ( V_1 , F_24 , & V_54 , 0 ) ;
F_1 ( V_1 , false ) ;
switch ( V_12 ) {
case V_49 :
F_41 ( V_1 , F_15 , NULL , 0 ) ;
break;
case V_66 :
F_41 ( V_1 , F_16 , NULL , 0 ) ;
break;
default:
F_41 ( V_1 , F_14 , NULL , 0 ) ;
}
V_5:
F_42 () ;
}
static int F_43 ( void * V_23 , T_6 V_24 )
{
struct V_25 * V_26 = (struct V_25 * ) V_23 ;
if ( V_24 >= V_67 ) {
F_3 ( L_9 , V_24 ) ;
...
static T_2
F_44 ( struct V_14 * V_15 , char T_3 * V_16 ,
T_4 V_17 , T_5 * V_18 )
{
...
if ( ! V_72 )
return - V_13 ;
for ( V_9 = 0 ; V_9 < F_48 ( V_73 ) ; V_9 ++ ) {
V_73 [ V_9 ] . V_74 = F_49 ( V_73 [ V_9 ] . V_75 ,
V_73 [ V_9 ] . V_76 ,
V_72 ,
& V_54 ,
V_73 [ V_9 ] . V_77 ) ;
