...
void
F_42 ( struct V_5 * V_6 , const char * V_87 , const char * V_88 , ... )
{
struct V_89 V_90 ;
T_6 args ;
va_start ( args , V_88 ) ;
...
void
F_45 ( struct V_5 * V_6 , const char * V_87 , const char * V_88 , ... )
{
struct V_89 V_90 ;
T_6 args ;
va_start ( args , V_88 ) ;
V_90 . V_88 = V_88 ;
V_90 . V_91 = & args ;
F_44 ( L_6 , V_6 -> V_92 , V_87 , & V_90 ) ;
va_end ( args ) ;
}
bool
F_46 ( const struct V_28 * V_28 )
{
return F_47 ( F_31 ( V_28 -> V_95 ) -> V_93 , V_96 ) ;
}
int
F_48 ( const unsigned char * V_13 , int V_97 , bool V_98 )
{
int V_99 ;
if ( V_97 > V_100 ) {
if ( V_98 )
...
int
F_49 ( unsigned char * V_103 , struct V_28 * V_28 )
{
T_1 V_97 = F_50 ( V_28 -> V_104 . V_97 , V_100 ) ;
* V_103 ++ = V_97 ;
memcpy ( V_103 , V_28 -> V_104 . V_13 , V_97 ) ;
return V_97 ;
}
