...
unsigned int * V_123 ,
unsigned int * V_124 , unsigned int V_125 [] , struct V_126 * V_127 [] )
{
struct V_1 * V_1 = F_50 ( V_122 ) ;
unsigned V_46 = V_13 * V_1 -> V_12 * 2 * sizeof( T_3 ) ;
if ( V_122 -> V_128 + * V_123 < 2 )
* V_123 = 2 - V_122 -> V_128 ;
if ( * V_124 )
...
static void F_51 ( struct V_129 * V_43 )
{
struct V_130 * V_131 = F_52 ( V_43 ) ;
struct V_1 * V_1 = F_50 ( V_43 -> V_121 ) ;
struct V_36 * V_37 = F_53 ( V_131 , struct V_36 , V_43 ) ;
unsigned long V_38 ;
if ( V_1 -> V_76 == NULL ) {
F_21 ( V_43 , V_50 ) ;
return;
...
static int F_55 ( struct V_121 * V_122 , unsigned int V_132 )
{
struct V_1 * V_1 = F_50 ( V_122 ) ;
if ( V_1 -> V_76 == NULL )
return - V_59 ;
...
static void F_57 ( struct V_133 * V_134 )
{
struct V_1 * V_1 = F_53 ( V_134 , struct V_1 , V_134 ) ;
F_58 ( & V_1 -> V_134 ) ;
F_59 ( & V_1 -> V_135 ) ;
F_33 ( V_1 ) ;
}
...
F_62 ( & V_1 -> V_137 ) ;
F_63 ( & V_1 -> V_41 ) ;
V_1 -> V_135 . type = V_138 ;
V_1 -> V_135 . V_139 = V_140 | V_141 | V_142 ;
V_1 -> V_135 . V_143 = V_1 ;
V_1 -> V_135 . V_144 = sizeof( struct V_36 ) ;
V_1 -> V_135 . V_145 = & V_146 ;
V_1 -> V_135 . V_147 = & V_148 ;
V_1 -> V_135 . V_149 = V_150 ;
V_1 -> V_135 . V_151 = & V_1 -> V_137 ;
V_4 = F_64 ( & V_1 -> V_135 ) ;
if ( V_4 < 0 ) {
F_24 ( V_1 -> V_63 , L_7 ) ;
return V_4 ;
}
V_1 -> V_134 . V_152 = F_57 ;
V_4 = F_65 ( V_1 -> V_63 , & V_1 -> V_134 ) ;
if ( V_4 < 0 ) {
F_24 ( V_1 -> V_63 , L_8 ) ;
goto V_153;
}
F_40 ( V_1 -> V_107 . V_104 , L_3 , sizeof( V_1 -> V_107 . V_104 ) ) ;
V_1 -> V_107 . V_134 = & V_1 -> V_134 ;
V_1 -> V_107 . V_152 = V_154 ;
V_1 -> V_107 . V_155 = & V_156 ;
V_1 -> V_107 . V_157 = & V_158 ;
V_1 -> V_107 . V_108 = V_159 ;
V_1 -> V_107 . V_160 = & V_1 -> V_135 ;
V_1 -> V_107 . V_151 = & V_1 -> V_136 ;
F_66 ( & V_1 -> V_107 , V_1 ) ;
V_4 = F_67 ( & V_1 -> V_107 , V_161 , - 1 ) ;
if ( V_4 < 0 ) {
F_24 ( V_1 -> V_63 , L_9 ) ;
goto V_162;
}
