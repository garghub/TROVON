...
{
F_186 () ;
V_9 -> V_12 . V_329 . V_330 = V_134 -> V_331 . V_332 . V_330 ;
V_9 -> V_12 . V_329 . V_333 = V_134 -> V_331 . V_332 . V_333 ;
if ( V_123 )
V_134 -> V_331 . V_332 . V_333 = V_9 -> V_314 -> V_302 . V_333 . V_334 ;
else
V_134 -> V_331 . V_332 . V_333 = V_9 -> V_314 -> V_302 . V_333 . V_335 ;
V_134 -> V_331 . V_332 . V_330 = V_9 -> V_314 -> V_302 . V_333 . V_330 ;
if ( F_187 ( V_134 -> V_331 . V_332 . V_330 ) )
V_134 -> V_331 . V_332 . V_330 = 0 ;
F_188 ( V_9 -> V_12 . V_336 ) ;
F_189 ( V_9 -> V_314 -> V_302 . V_333 . V_337 ) ;
F_190 ( V_9 -> V_12 . V_338 ) ;
F_191 ( V_339 , & V_9 -> V_12 . V_14 -> V_340 ) ;
if ( V_9 -> V_12 . V_15 && ! F_192 ( V_9 ) )
F_166 ( V_9 ) ;
V_9 -> V_293 = V_293 ;
}
...
if ( V_9 -> V_12 . V_15 && ! F_192 ( V_9 ) )
F_171 ( V_9 ) ;
F_194 ( V_339 , & V_9 -> V_12 . V_14 -> V_340 ) ;
V_9 -> V_12 . V_338 = F_195 () ;
F_196 ( V_9 -> V_12 . V_338 ) ;
F_186 () ;
V_9 -> V_314 -> V_302 . V_333 . V_330 = V_134 -> V_331 . V_332 . V_330 ;
V_134 -> V_331 . V_332 . V_330 = V_9 -> V_12 . V_329 . V_330 ;
V_134 -> V_331 . V_332 . V_333 = V_9 -> V_12 . V_329 . V_333 ;
F_188 ( V_9 -> V_314 -> V_302 . V_333 . V_337 ) ;
F_189 ( V_9 -> V_12 . V_336 ) ;
}
static void F_197 ( struct V_8 * V_9 )
{
V_9 -> V_12 . V_14 -> V_341 . V_342 = 0UL ;
V_9 -> V_12 . V_14 -> V_341 . V_166 = 0UL ;
F_165 ( V_9 , 0 ) ;
F_178 ( V_9 , 0 ) ;
V_9 -> V_12 . V_14 -> V_343 = 0UL ;
V_9 -> V_12 . V_14 -> V_344 = 0 ;
memset ( V_9 -> V_12 . V_14 -> V_345 , 0 , 16 * sizeof( V_296 ) ) ;
V_9 -> V_12 . V_14 -> V_345 [ 0 ] = 0xE0UL ;
V_9 -> V_12 . V_14 -> V_345 [ 14 ] = 0xC2000000UL ;
F_186 () ;
V_134 -> V_331 . V_332 . V_330 = 0 ;
V_9 -> V_12 . V_14 -> V_346 = 1 ;
...
V_9 -> V_12 . V_338 = V_9 -> V_12 . V_130 ;
}
static void F_62 ( struct V_8 * V_9 )
{
if ( ! F_60 ( V_9 -> V_7 , 76 ) )
return;
V_9 -> V_12 . V_14 -> V_350 &= ~ ( V_351 | V_352 ) ;
if ( V_9 -> V_7 -> V_12 . V_182 . V_185 )
V_9 -> V_12 . V_14 -> V_350 |= V_351 ;
if ( V_9 -> V_7 -> V_12 . V_182 . V_188 )
V_9 -> V_12 . V_14 -> V_350 |= V_352 ;
V_9 -> V_12 . V_14 -> V_252 = V_9 -> V_7 -> V_12 . V_182 . V_252 ;
}
void F_141 ( struct V_8 * V_9 )
{
F_118 ( V_9 -> V_12 . V_14 -> V_353 ) ;
V_9 -> V_12 . V_14 -> V_353 = 0 ;
}
int F_201 ( struct V_8 * V_9 )
{
V_9 -> V_12 . V_14 -> V_353 = F_123 ( V_199 ) ;
if ( ! V_9 -> V_12 . V_14 -> V_353 )
return - V_78 ;
...
{
struct V_354 * V_154 = & V_9 -> V_7 -> V_12 . V_154 ;
V_9 -> V_12 . V_14 -> V_201 = V_154 -> V_201 ;
if ( F_60 ( V_9 -> V_7 , 7 ) )
V_9 -> V_12 . V_14 -> V_355 = ( T_7 ) ( V_164 ) V_154 -> V_156 ;
}
int F_203 ( struct V_8 * V_9 )
{
int V_262 = 0 ;
F_145 ( & V_9 -> V_12 . V_14 -> V_340 , V_356 |
V_357 |
V_358 ) ;
if ( F_60 ( V_9 -> V_7 , 78 ) )
F_191 ( V_359 , & V_9 -> V_12 . V_14 -> V_340 ) ;
else if ( F_60 ( V_9 -> V_7 , 8 ) )
F_191 ( V_360 , & V_9 -> V_12 . V_14 -> V_340 ) ;
F_202 ( V_9 ) ;
if ( V_56 )
V_9 -> V_12 . V_14 -> V_361 |= 0x02 ;
if ( F_60 ( V_9 -> V_7 , 9 ) )
V_9 -> V_12 . V_14 -> V_361 |= 0x04 ;
if ( F_60 ( V_9 -> V_7 , 73 ) )
V_9 -> V_12 . V_14 -> V_361 |= 0x10 ;
if ( F_60 ( V_9 -> V_7 , 8 ) && V_58 . V_362 )
V_9 -> V_12 . V_14 -> V_298 |= 0x08 ;
V_9 -> V_12 . V_14 -> V_363 = 0x1002000U ;
if ( V_58 . V_72 )
V_9 -> V_12 . V_14 -> V_363 |= 0x80000000U ;
if ( V_58 . V_70 )
V_9 -> V_12 . V_14 -> V_363 |= 0x40000000U ;
if ( V_58 . V_64 )
V_9 -> V_12 . V_14 -> V_363 |= 1 ;
if ( V_58 . V_364 )
V_9 -> V_12 . V_14 -> V_363 |= 0x10000000U ;
if ( F_60 ( V_9 -> V_7 , 129 ) ) {
V_9 -> V_12 . V_14 -> V_363 |= 0x00020000 ;
V_9 -> V_12 . V_14 -> V_365 |= 0x20000000 ;
}
V_9 -> V_12 . V_14 -> V_366 = ( unsigned long ) & V_9 -> V_314 -> V_302 . V_333 . V_367 ;
V_9 -> V_12 . V_14 -> V_348 |= V_368 | V_369 | V_370 ;
if ( V_9 -> V_7 -> V_12 . V_172 ) {
V_262 = F_201 ( V_9 ) ;
if ( V_262 )
return V_262 ;
}
F_204 ( & V_9 -> V_12 . V_371 , V_372 , V_373 ) ;
V_9 -> V_12 . V_371 . V_374 = V_375 ;
F_62 ( V_9 ) ;
return V_262 ;
}
struct V_8 * F_205 ( struct V_7 * V_7 ,
unsigned int V_311 )
{
struct V_8 * V_9 ;
struct V_376 * V_376 ;
...
goto V_142;
V_262 = - V_78 ;
V_9 = F_206 ( V_290 , V_199 ) ;
if ( ! V_9 )
goto V_142;
V_376 = (struct V_376 * ) F_123 ( V_199 ) ;
if ( ! V_376 )
goto V_377;
V_9 -> V_12 . V_14 = & V_376 -> V_14 ;
V_9 -> V_12 . V_14 -> V_378 = ( unsigned long ) & V_376 -> V_379 ;
V_9 -> V_12 . V_14 -> V_380 = 0 ;
V_9 -> V_12 . V_14 -> V_381 = V_58 . V_283 ;
V_9 -> V_12 . V_14 -> V_382 = V_311 ;
F_126 ( & V_9 -> V_12 . V_383 . V_151 ) ;
V_9 -> V_12 . V_383 . V_278 = & V_7 -> V_12 . V_278 ;
V_9 -> V_12 . V_383 . V_384 = & V_9 -> V_384 ;
V_9 -> V_12 . V_383 . V_340 = & V_9 -> V_12 . V_14 -> V_340 ;
F_207 ( & V_9 -> V_12 . V_325 ) ;
V_262 = F_208 ( V_9 , V_7 , V_311 ) ;
if ( V_262 )
goto V_385;
F_47 ( V_7 , 3 , L_33 , V_311 , V_9 ,
V_9 -> V_12 . V_14 ) ;
F_209 ( V_311 , V_9 , V_9 -> V_12 . V_14 ) ;
return V_9 ;
V_385:
F_118 ( ( unsigned long ) ( V_9 -> V_12 . V_14 ) ) ;
V_377:
...
int F_211 ( struct V_8 * V_9 )
{
return F_212 ( V_9 , 0 ) ;
}
void F_213 ( struct V_8 * V_9 )
{
F_191 ( V_386 , & V_9 -> V_12 . V_14 -> V_387 ) ;
F_63 ( V_9 ) ;
}
void F_214 ( struct V_8 * V_9 )
{
F_194 ( V_386 , & V_9 -> V_12 . V_14 -> V_387 ) ;
}
static void F_215 ( struct V_8 * V_9 )
{
F_191 ( V_388 , & V_9 -> V_12 . V_14 -> V_387 ) ;
F_63 ( V_9 ) ;
}
static void F_216 ( struct V_8 * V_9 )
{
F_194 ( V_388 , & V_9 -> V_12 . V_14 -> V_387 ) ;
}
void F_63 ( struct V_8 * V_9 )
{
F_191 ( V_389 , & V_9 -> V_12 . V_14 -> V_340 ) ;
while ( V_9 -> V_12 . V_14 -> V_390 & V_391 )
F_217 () ;
}
void F_45 ( int V_392 , struct V_8 * V_9 )
{
F_218 ( V_392 , V_9 ) ;
F_215 ( V_9 ) ;
}
static void V_21 ( struct V_130 * V_130 , unsigned long V_393 ,
unsigned long V_394 )
{
...
F_7 (i, vcpu, kvm) {
V_395 = F_220 ( V_9 ) ;
if ( V_395 <= V_394 && V_393 <= V_395 + 2 * V_274 - 1 ) {
F_136 ( V_9 , 2 , L_34 ,
V_393 , V_394 ) ;
F_45 ( V_396 , V_9 ) ;
}
...
switch ( V_398 -> V_311 ) {
case V_399 :
V_89 = F_50 ( V_9 -> V_12 . V_14 -> V_344 ,
( T_7 V_165 * ) V_398 -> V_166 ) ;
break;
case V_400 :
V_89 = F_50 ( V_9 -> V_12 . V_14 -> V_13 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_401 :
V_89 = F_50 ( F_179 ( V_9 ) ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
...
break;
case V_404 :
V_89 = F_50 ( V_9 -> V_12 . V_405 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_406 :
V_89 = F_50 ( V_9 -> V_12 . V_407 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_408 :
V_89 = F_50 ( V_9 -> V_12 . V_14 -> V_347 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_409 :
V_89 = F_50 ( V_9 -> V_12 . V_14 -> V_346 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
default:
break;
...
break;
case V_401 :
V_89 = F_56 ( V_5 , ( V_164 V_165 * ) V_398 -> V_166 ) ;
if ( ! V_89 )
F_178 ( V_9 , V_5 ) ;
break;
case V_402 :
V_89 = F_56 ( V_9 -> V_12 . V_14 -> V_343 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_403 :
...
break;
case V_404 :
V_89 = F_56 ( V_9 -> V_12 . V_405 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_406 :
V_89 = F_56 ( V_9 -> V_12 . V_407 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_408 :
V_89 = F_56 ( V_9 -> V_12 . V_14 -> V_347 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
case V_409 :
V_89 = F_56 ( V_9 -> V_12 . V_14 -> V_346 ,
( V_164 V_165 * ) V_398 -> V_166 ) ;
break;
default:
break;
...
int F_226 ( struct V_8 * V_9 , struct V_410 * V_333 )
{
memcpy ( & V_9 -> V_314 -> V_302 . V_333 . V_411 , & V_333 -> V_411 , sizeof( V_333 -> V_411 ) ) ;
return 0 ;
}
int F_227 ( struct V_8 * V_9 , struct V_410 * V_333 )
{
memcpy ( & V_333 -> V_411 , & V_9 -> V_314 -> V_302 . V_333 . V_411 , sizeof( V_333 -> V_411 ) ) ;
return 0 ;
}
int F_228 ( struct V_8 * V_9 ,
struct V_412 * V_413 )
{
memcpy ( & V_9 -> V_314 -> V_302 . V_333 . V_337 , & V_413 -> V_337 , sizeof( V_413 -> V_337 ) ) ;
memcpy ( & V_9 -> V_12 . V_14 -> V_345 , & V_413 -> V_414 , sizeof( V_413 -> V_414 ) ) ;
F_189 ( V_9 -> V_314 -> V_302 . V_333 . V_337 ) ;
return 0 ;
}
int F_229 ( struct V_8 * V_9 ,
struct V_412 * V_413 )
{
memcpy ( & V_413 -> V_337 , & V_9 -> V_314 -> V_302 . V_333 . V_337 , sizeof( V_413 -> V_337 ) ) ;
memcpy ( & V_413 -> V_414 , & V_9 -> V_12 . V_14 -> V_345 , sizeof( V_413 -> V_414 ) ) ;
return 0 ;
}
int F_230 ( struct V_8 * V_9 , struct V_415 * V_332 )
{
F_186 () ;
if ( F_187 ( V_332 -> V_330 ) )
return - V_87 ;
V_134 -> V_331 . V_332 . V_330 = V_332 -> V_330 ;
if ( V_123 )
F_231 ( ( V_416 * ) V_9 -> V_314 -> V_302 . V_333 . V_334 ,
( V_417 * ) V_332 -> V_335 ) ;
else
memcpy ( V_9 -> V_314 -> V_302 . V_333 . V_335 , & V_332 -> V_335 , sizeof( V_332 -> V_335 ) ) ;
return 0 ;
}
int F_232 ( struct V_8 * V_9 , struct V_415 * V_332 )
{
F_186 () ;
if ( V_123 )
F_233 ( ( V_417 * ) V_332 -> V_335 ,
( V_416 * ) V_9 -> V_314 -> V_302 . V_333 . V_334 ) ;
else
memcpy ( V_332 -> V_335 , V_9 -> V_314 -> V_302 . V_333 . V_335 , sizeof( V_332 -> V_335 ) ) ;
V_332 -> V_330 = V_134 -> V_331 . V_332 . V_330 ;
return 0 ;
}
static int F_234 ( struct V_8 * V_9 , T_9 V_418 )
{
int V_262 = 0 ;
if ( ! F_235 ( V_9 ) )
V_262 = - V_153 ;
else {
V_9 -> V_314 -> V_419 = V_418 . V_342 ;
V_9 -> V_314 -> V_420 = V_418 . V_166 ;
}
return V_262 ;
}
int F_236 ( struct V_8 * V_9 ,
struct V_421 * V_422 )
{
return - V_87 ;
}
...
V_9 -> V_425 = 0 ;
F_238 ( V_9 ) ;
if ( V_424 -> V_426 & ~ V_427 )
return - V_87 ;
if ( ! V_58 . V_66 )
return - V_87 ;
if ( V_424 -> V_426 & V_428 ) {
V_9 -> V_425 = V_424 -> V_426 ;
F_191 ( V_429 , & V_9 -> V_12 . V_14 -> V_340 ) ;
if ( V_424 -> V_426 & V_430 )
V_262 = F_239 ( V_9 , V_424 ) ;
} else {
F_194 ( V_429 , & V_9 -> V_12 . V_14 -> V_340 ) ;
V_9 -> V_12 . V_431 . V_432 = 0 ;
}
if ( V_262 ) {
V_9 -> V_425 = 0 ;
F_238 ( V_9 ) ;
...
struct V_433 * V_434 )
{
return F_235 ( V_9 ) ? V_435 :
V_436 ;
}
int F_241 ( struct V_8 * V_9 ,
struct V_433 * V_434 )
{
int V_262 = 0 ;
V_9 -> V_7 -> V_12 . V_437 = 1 ;
switch ( V_434 -> V_434 ) {
case V_435 :
F_199 ( V_9 ) ;
break;
...
static bool F_243 ( struct V_8 * V_9 )
{
return F_79 ( & V_9 -> V_12 . V_14 -> V_340 ) & V_440 ;
}
...
F_248 ( V_448 , & V_9 -> V_442 ) ;
return 0 ;
}
void F_67 ( struct V_7 * V_7 , V_164 V_449 )
{
struct V_8 * V_9 ;
int V_10 ;
F_39 ( & V_7 -> V_151 ) ;
F_175 () ;
V_7 -> V_12 . V_13 = V_449 - F_249 () ;
F_159 ( V_7 ) ;
F_7 (i, vcpu, kvm)
...
long F_250 ( struct V_8 * V_9 , T_10 V_450 , int V_451 )
{
return F_251 ( V_9 -> V_12 . V_130 , V_450 ,
V_451 ? V_452 : 0 ) ;
}
static void F_252 ( struct V_8 * V_9 , bool V_453 ,
unsigned long V_454 )
{
struct V_238 V_455 ;
struct V_456 V_457 ;
if ( V_453 ) {
V_457 . V_458 . V_88 . V_459 = V_454 ;
V_457 . type = V_460 ;
F_167 ( F_253 ( V_9 , & V_457 ) ) ;
} else {
V_455 . type = V_461 ;
V_455 . V_462 = V_454 ;
F_167 ( F_108 ( V_9 -> V_7 , & V_455 ) ) ;
}
}
void F_254 ( struct V_8 * V_9 ,
struct V_463 * V_464 )
{
F_255 ( V_9 , V_464 -> V_12 . V_312 ) ;
F_252 ( V_9 , true , V_464 -> V_12 . V_312 ) ;
}
void F_256 ( struct V_8 * V_9 ,
struct V_463 * V_464 )
{
F_257 ( V_9 , V_464 -> V_12 . V_312 ) ;
F_252 ( V_9 , false , V_464 -> V_12 . V_312 ) ;
}
void F_258 ( struct V_8 * V_9 ,
struct V_463 * V_464 )
{
}
bool F_259 ( struct V_8 * V_9 )
{
return true ;
}
...
if ( V_9 -> V_12 . V_312 == V_313 )
return 0 ;
if ( ( V_9 -> V_12 . V_14 -> V_341 . V_342 & V_9 -> V_12 . V_407 ) !=
V_9 -> V_12 . V_405 )
return 0 ;
if ( F_261 ( V_9 ) )
return 0 ;
if ( F_212 ( V_9 , 0 ) )
return 0 ;
if ( ! ( V_9 -> V_12 . V_14 -> V_345 [ 0 ] & 0x200ul ) )
return 0 ;
if ( ! V_9 -> V_12 . V_130 -> V_286 )
return 0 ;
V_227 = F_99 ( V_9 -> V_7 , F_262 ( V_134 -> V_331 . V_466 ) ) ;
V_227 += V_134 -> V_331 . V_466 & ~ V_467 ;
if ( F_263 ( V_9 , V_9 -> V_12 . V_312 , & V_12 . V_312 , 8 ) )
return 0 ;
V_262 = F_264 ( V_9 , V_134 -> V_331 . V_466 , V_227 , & V_12 ) ;
return V_262 ;
}
...
int V_262 , V_340 ;
F_266 ( V_9 ) ;
V_9 -> V_12 . V_14 -> V_468 = V_9 -> V_314 -> V_302 . V_333 . V_411 [ 14 ] ;
V_9 -> V_12 . V_14 -> V_469 = V_9 -> V_314 -> V_302 . V_333 . V_411 [ 15 ] ;
if ( F_267 () )
F_268 () ;
if ( F_269 ( V_470 ) )
F_270 () ;
...
V_9 -> V_12 . V_14 -> V_471 = 0 ;
V_340 = F_79 ( & V_9 -> V_12 . V_14 -> V_340 ) ;
F_136 ( V_9 , 6 , L_35 , V_340 ) ;
F_275 ( V_9 , V_340 ) ;
return 0 ;
}
static int F_276 ( struct V_8 * V_9 )
{
struct V_472 V_473 = {
. V_474 = V_475 ,
} ;
...
F_277 ( V_9 ) ;
V_262 = F_278 ( V_9 , & V_476 , 1 ) ;
V_477 = F_279 ( V_476 ) ;
if ( V_262 < 0 ) {
return V_262 ;
} else if ( V_262 ) {
V_473 = V_9 -> V_12 . V_478 ;
V_477 = 4 ;
}
V_473 . V_148 = V_477 | V_479 ;
F_280 ( V_9 , V_477 ) ;
return F_281 ( V_9 , & V_473 ) ;
}
static int F_282 ( struct V_8 * V_9 , int V_480 )
{
F_136 ( V_9 , 6 , L_37 ,
V_9 -> V_12 . V_14 -> V_471 ) ;
F_283 ( V_9 , V_9 -> V_12 . V_14 -> V_471 ) ;
if ( F_272 ( V_9 ) )
F_284 ( V_9 ) ;
V_9 -> V_314 -> V_302 . V_333 . V_411 [ 14 ] = V_9 -> V_12 . V_14 -> V_468 ;
V_9 -> V_314 -> V_302 . V_333 . V_411 [ 15 ] = V_9 -> V_12 . V_14 -> V_469 ;
if ( V_9 -> V_12 . V_14 -> V_471 > 0 ) {
int V_262 = F_285 ( V_9 ) ;
if ( V_262 != - V_481 )
return V_262 ;
V_9 -> V_314 -> V_480 = V_482 ;
V_9 -> V_314 -> V_483 . V_471 = V_9 -> V_12 . V_14 -> V_471 ;
V_9 -> V_314 -> V_483 . V_484 = V_9 -> V_12 . V_14 -> V_484 ;
V_9 -> V_314 -> V_483 . V_485 = V_9 -> V_12 . V_14 -> V_485 ;
return - V_486 ;
} else if ( V_480 != - V_167 ) {
V_9 -> V_487 . V_488 ++ ;
return 0 ;
} else if ( F_55 ( V_9 -> V_7 ) ) {
V_9 -> V_314 -> V_480 = V_489 ;
V_9 -> V_314 -> V_490 . V_491 =
V_134 -> V_331 . V_466 ;
V_9 -> V_314 -> V_490 . V_492 = 0x10 ;
return - V_486 ;
} else if ( V_134 -> V_331 . V_493 ) {
F_286 ( V_9 ) ;
V_134 -> V_331 . V_493 = 0 ;
if ( F_260 ( V_9 ) )
return 0 ;
return F_250 ( V_9 , V_134 -> V_331 . V_466 , 1 ) ;
}
return F_276 ( V_9 ) ;
}
...
{
int V_262 , V_480 ;
V_9 -> V_494 = F_52 ( & V_9 -> V_7 -> V_174 ) ;
do {
V_262 = F_265 ( V_9 ) ;
if ( V_262 )
break;
F_54 ( & V_9 -> V_7 -> V_174 , V_9 -> V_494 ) ;
F_288 () ;
F_289 () ;
F_173 ( V_9 ) ;
F_290 () ;
V_480 = F_291 ( V_9 -> V_12 . V_14 ,
V_9 -> V_314 -> V_302 . V_333 . V_411 ) ;
F_288 () ;
F_172 ( V_9 ) ;
F_292 () ;
F_290 () ;
V_9 -> V_494 = F_52 ( & V_9 -> V_7 -> V_174 ) ;
V_262 = F_282 ( V_9 , V_480 ) ;
} while ( ! F_293 ( V_134 ) && ! F_294 ( V_9 ) && ! V_262 );
F_54 ( & V_9 -> V_7 -> V_174 , V_9 -> V_494 ) ;
return V_262 ;
}
static void F_295 ( struct V_8 * V_9 , struct V_495 * V_495 )
{
V_9 -> V_12 . V_14 -> V_341 . V_342 = V_495 -> V_419 ;
V_9 -> V_12 . V_14 -> V_341 . V_166 = V_495 -> V_420 ;
if ( V_495 -> V_496 & V_316 )
F_165 ( V_9 , V_495 -> V_302 . V_333 . V_395 ) ;
if ( V_495 -> V_496 & V_319 ) {
memcpy ( & V_9 -> V_12 . V_14 -> V_345 , & V_495 -> V_302 . V_333 . V_414 , 128 ) ;
F_218 ( V_444 , V_9 ) ;
}
if ( V_495 -> V_496 & V_320 ) {
F_178 ( V_9 , V_495 -> V_302 . V_333 . V_326 ) ;
V_9 -> V_12 . V_14 -> V_343 = V_495 -> V_302 . V_333 . V_343 ;
V_9 -> V_12 . V_14 -> V_344 = V_495 -> V_302 . V_333 . V_344 ;
V_9 -> V_12 . V_14 -> V_347 = V_495 -> V_302 . V_333 . V_347 ;
V_9 -> V_12 . V_14 -> V_346 = V_495 -> V_302 . V_333 . V_346 ;
}
if ( V_495 -> V_496 & V_321 ) {
V_9 -> V_12 . V_312 = V_495 -> V_302 . V_333 . V_497 ;
V_9 -> V_12 . V_407 = V_495 -> V_302 . V_333 . V_498 ;
V_9 -> V_12 . V_405 = V_495 -> V_302 . V_333 . V_499 ;
if ( V_9 -> V_12 . V_312 == V_313 )
F_139 ( V_9 ) ;
}
if ( ( V_495 -> V_496 & V_322 ) &&
F_60 ( V_9 -> V_7 , 64 ) ) {
struct V_500 * V_367 =
(struct V_500 * ) & V_495 -> V_302 . V_333 . V_367 ;
if ( V_367 -> V_501 )
V_9 -> V_12 . V_14 -> V_350 |= 0x01 ;
}
V_495 -> V_496 = 0 ;
}
static void F_296 ( struct V_8 * V_9 , struct V_495 * V_495 )
{
V_495 -> V_419 = V_9 -> V_12 . V_14 -> V_341 . V_342 ;
V_495 -> V_420 = V_9 -> V_12 . V_14 -> V_341 . V_166 ;
V_495 -> V_302 . V_333 . V_395 = F_220 ( V_9 ) ;
memcpy ( & V_495 -> V_302 . V_333 . V_414 , & V_9 -> V_12 . V_14 -> V_345 , 128 ) ;
V_495 -> V_302 . V_333 . V_326 = F_179 ( V_9 ) ;
V_495 -> V_302 . V_333 . V_343 = V_9 -> V_12 . V_14 -> V_343 ;
V_495 -> V_302 . V_333 . V_344 = V_9 -> V_12 . V_14 -> V_344 ;
V_495 -> V_302 . V_333 . V_347 = V_9 -> V_12 . V_14 -> V_347 ;
V_495 -> V_302 . V_333 . V_346 = V_9 -> V_12 . V_14 -> V_346 ;
V_495 -> V_302 . V_333 . V_497 = V_9 -> V_12 . V_312 ;
V_495 -> V_302 . V_333 . V_498 = V_9 -> V_12 . V_407 ;
V_495 -> V_302 . V_333 . V_499 = V_9 -> V_12 . V_405 ;
}
int F_297 ( struct V_8 * V_9 , struct V_495 * V_495 )
{
int V_262 ;
T_12 V_502 ;
if ( F_294 ( V_9 ) ) {
...
int F_302 ( struct V_8 * V_9 , unsigned long V_450 )
{
...
V_450 -= V_515 ;
if ( V_123 ) {
F_233 ( V_335 , ( V_416 * ) V_9 -> V_314 -> V_302 . V_333 . V_334 ) ;
V_262 = F_303 ( V_9 , V_450 + V_515 ,
V_335 , 128 ) ;
} else {
V_262 = F_303 ( V_9 , V_450 + V_515 ,
V_9 -> V_314 -> V_302 . V_333 . V_335 , 128 ) ;
}
V_262 |= F_303 ( V_9 , V_450 + V_516 ,
V_9 -> V_314 -> V_302 . V_333 . V_411 , 128 ) ;
V_262 |= F_303 ( V_9 , V_450 + V_517 ,
& V_9 -> V_12 . V_14 -> V_341 , 16 ) ;
V_262 |= F_303 ( V_9 , V_450 + V_518 ,
& V_511 , 4 ) ;
V_262 |= F_303 ( V_9 , V_450 + V_519 ,
& V_9 -> V_314 -> V_302 . V_333 . V_330 , 4 ) ;
V_262 |= F_303 ( V_9 , V_450 + V_520 ,
& V_9 -> V_12 . V_14 -> V_344 , 4 ) ;
V_326 = F_179 ( V_9 ) ;
V_262 |= F_303 ( V_9 , V_450 + V_521 ,
& V_326 , 8 ) ;
V_512 = V_9 -> V_12 . V_14 -> V_343 >> 8 ;
V_262 |= F_303 ( V_9 , V_450 + V_522 ,
& V_512 , 8 ) ;
V_262 |= F_303 ( V_9 , V_450 + V_523 ,
& V_9 -> V_314 -> V_302 . V_333 . V_337 , 64 ) ;
V_262 |= F_303 ( V_9 , V_450 + V_524 ,
& V_9 -> V_12 . V_14 -> V_345 , 128 ) ;
...
F_194 ( V_358 , & V_9 -> V_12 . V_14 -> V_340 ) ;
F_218 ( V_444 , V_9 ) ;
...
V_207 = F_79 ( & V_9 -> V_7 -> V_207 ) ;
F_310 ( V_9 ) ;
F_191 ( V_358 , & V_9 -> V_12 . V_14 -> V_340 ) ;
F_306 ( V_9 ) ;
for ( V_10 = 0 ; V_10 < V_207 ; V_10 ++ ) {
if ( ! F_235 ( V_9 -> V_7 -> V_291 [ V_10 ] ) ) {
V_525 ++ ;
...
F_54 ( & V_9 -> V_7 -> V_174 , V_494 ) ;
if ( V_89 > 0 && ( V_528 -> V_148 & V_533 ) != 0 )
F_281 ( V_9 , & V_9 -> V_12 . V_478 ) ;
F_317 ( V_531 ) ;
return V_89 ;
}
...
T_9 V_418 ;
V_89 = - V_167 ;
if ( F_65 ( & V_418 , V_236 , sizeof( V_418 ) ) )
break;
V_89 = F_234 ( V_9 , V_418 ) ;
break;
}
case V_547 :
V_89 = F_225 ( V_9 ) ;
...
struct V_397 V_398 ;
V_89 = - V_167 ;
if ( F_65 ( & V_398 , V_236 , sizeof( V_398 ) ) )
break;
if ( V_84 == V_548 )
V_89 = F_224 ( V_9 , & V_398 ) ;
else
V_89 = F_223 ( V_9 , & V_398 ) ;
break;
}
#ifdef F_30
case V_550 : {
...
#endif
case V_557 : {
V_89 = F_251 ( V_9 -> V_12 . V_130 , V_85 , 0 ) ;
break;
}
case V_240 :
{
...
V_562 . V_563 == 0 ||
V_562 . V_563 % sizeof( struct V_456 ) > 0 ) {
V_89 = - V_87 ;
break;
}
V_89 = F_322 ( V_9 ,
