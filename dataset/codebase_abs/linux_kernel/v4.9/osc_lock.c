...
struct V_57 * V_58 = F_77 ( & V_158 -> V_160 ) ;
T_4 V_161 ;
int V_42 ;
V_147 -> V_162 = V_58 ;
V_147 -> V_163 = 1 ;
V_42 = F_78 ( V_26 , V_147 , V_164 , V_147 -> V_162 ) ;
if ( V_42 != 0 )
return V_42 ;
V_161 = F_34 ( V_58 , V_125 -> V_93 ) ;
do {
V_42 = F_79 ( V_26 , V_147 , V_158 ,
V_161 ,
F_34 ( V_58 , V_125 -> V_76 ) ,
F_71 , ( void * ) & V_161 ) ;
if ( V_42 == V_156 )
...
F_81 ( V_26 , V_147 ) ;
return V_42 == V_156 ? 1 : 0 ;
}
unsigned long F_82 ( struct V_6 * V_54 )
{
struct V_98 V_99 ;
struct V_25 * V_26 ;
struct V_52 * V_58 ;
...
V_166 = F_76 ( V_26 , V_58 , & V_54 -> V_75 . V_38 ) ;
V_111:
F_46 ( & V_99 , V_26 ) ;
return V_166 ;
}
...
const struct V_186 * V_187 = F_90 ( V_58 -> V_188 . V_189 ) ;
struct V_190 * V_191 ;
...
F_86 ( & V_53 -> V_170 ) ;
F_84 ( & V_80 -> V_208 ) ;
while ( ! F_98 ( & V_80 -> V_209 ) ) {
struct V_1 * V_210 ;
V_210 = F_99 ( V_80 -> V_209 . V_211 , struct V_1 ,
V_212 ) ;
F_97 ( & V_210 -> V_212 ) ;
...
bool V_231 = false ;
int V_42 ;
F_105 ( F_7 ( V_80 -> V_85 , V_9 -> V_34 . V_92 <= V_120 ) ,
L_8 , V_9 , V_80 ) ;
if ( V_80 -> V_19 == V_21 )
return 0 ;
if ( V_80 -> V_94 & V_51 )
goto V_232;
if ( V_80 -> V_85 ) {
F_12 ( F_106 ( V_80 -> V_233 , ! V_223 ) ) ;
V_231 = true ;
goto V_232;
}
F_100 ( V_26 , V_53 , V_80 ) ;
if ( F_1 ( V_80 ) ) {
V_80 -> V_19 = V_21 ;
V_182 -> V_234 = 1 ;
return 0 ;
...
F_108 ( & V_53 -> V_61 -> V_236 , V_227 ) ;
F_87 ( V_26 , V_9 , V_53 , & V_80 -> V_86 ) ;
F_14 ( V_26 , V_9 , V_31 ) ;
if ( V_80 -> V_233 ) {
...
V_42 = F_109 ( F_92 ( V_53 ) , V_227 , & V_80 -> V_94 ,
V_31 , & V_80 -> V_108 ,
V_53 -> V_61 -> V_237 ,
V_230 , V_18 ,
...
if ( V_2 -> V_24 ) {
V_2 -> V_24 = 0 ;
F_111 ( & V_2 -> V_11 , V_2 -> V_86 . V_87 ) ;
V_2 -> V_11 . V_18 = 0ULL ;
}
V_2 -> V_13 = NULL ;
F_12 ( V_2 -> V_84 ) ;
F_112 ( & V_54 -> V_83 , L_3 , V_2 ) ;
F_113 ( V_54 ) ;
V_2 -> V_84 = 0 ;
}
...
V_263 |= V_265 ;
V_266:
V_113 = F_130 ( F_92 ( V_58 ) -> V_267 -> V_268 ,
