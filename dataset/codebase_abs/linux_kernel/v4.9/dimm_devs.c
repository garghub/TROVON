...
{
struct V_3 * V_3 = F_20 ( V_2 , struct V_3 , V_2 ) ;
F_21 ( ! F_19 ( V_2 ) ) ;
return V_3 ;
}
struct V_3 * F_22 ( struct V_47 * V_48 )
{
struct V_49 * V_49 = & V_48 -> V_49 ;
struct V_50 * V_50 = & V_49 -> V_51 [ 0 ] ;
return V_50 -> V_3 ;
}
struct V_10 * F_23 ( struct V_50 * V_50 )
{
struct V_3 * V_3 = V_50 -> V_3 ;
F_24 ( ! F_25 ( & V_3 -> V_2 ) ) ;
return F_26 ( & V_3 -> V_2 ) ;
}
void F_27 ( struct V_52 * V_52 )
{
struct V_10 * V_11 = F_20 ( V_52 , F_28 ( * V_11 ) , V_52 ) ;
...
struct V_56 * F_41 ( struct V_3 * V_3 )
{
return & V_3 -> V_2 . V_57 ;
}
unsigned long F_42 ( struct V_3 * V_3 )
{
return V_3 -> V_4 ;
}
...
F_45 (cmd, &nvdimm->cmd_mask, BITS_PER_LONG)
V_38 += sprintf ( V_37 + V_38 , L_6 , F_46 ( V_16 ) ) ;
V_38 += sprintf ( V_37 + V_38 , L_5 ) ;
return V_38 ;
}
static T_3 F_47 ( struct V_1 * V_2 , struct V_59 * V_60 ,
char * V_37 )
{
struct V_3 * V_3 = F_2 ( V_2 ) ;
F_29 ( V_2 ) ;
F_32 ( V_2 ) ;
return sprintf ( V_37 , L_4 , F_48 ( & V_3 -> V_61 )
? L_7 : L_8 ) ;
}
...
struct V_3 * F_52 ( struct V_18 * V_18 , void * V_58 ,
...
F_54 ( & V_3 -> V_61 , 0 ) ;
V_2 = & V_3 -> V_2 ;
F_55 ( V_2 , L_11 , V_3 -> V_45 ) ;
V_2 -> V_67 = & V_18 -> V_2 ;
V_2 -> type = & V_46 ;
V_2 -> V_68 = F_56 ( V_69 , V_3 -> V_45 ) ;
V_2 -> V_64 = V_64 ;
F_57 ( V_2 ) ;
return V_3 ;
}
int F_58 ( struct V_1 * V_2 , void * V_27 )
{
...
V_74 -> V_54 -> V_77 = F_62 ( V_74 -> V_54 -> V_77 , V_71 ) ;
...
static int F_63 ( struct V_1 * V_2 , void * V_27 )
{
struct V_73 * V_74 = V_27 ;
struct V_50 * V_50 ;
struct V_49 * V_49 ;
...
if ( ! V_11 )
return 0 ;
F_65 ( & V_18 -> V_2 , & V_74 , F_58 ) ;
F_61 (ndd, res) {
if ( strncmp ( V_54 -> V_81 , L_13 , 3 ) != 0 )
continue;
V_74 . V_54 = V_54 ;
V_74 . V_61 = F_66 ( V_54 ) ;
F_65 ( & V_18 -> V_2 , & V_74 , F_63 ) ;
V_74 . V_82 -= V_74 . V_61 ;
}
return V_74 . V_82 ;
}
...
void F_31 ( struct V_10 * V_11 , struct V_53 * V_54 )
{
F_24 ( ! F_25 ( V_11 -> V_2 ) ) ;
F_15 ( V_54 -> V_81 ) ;
...
T_4 V_90 )
{
char * V_81 = F_71 ( V_89 , sizeof( * V_89 ) , V_31 ) ;
struct V_53 * V_54 ;
if ( ! V_81 )
return NULL ;
F_24 ( ! F_25 ( V_11 -> V_2 ) ) ;
V_54 = F_72 ( & V_11 -> V_87 , V_77 , V_90 , V_81 , 0 ) ;
if ( ! V_54 )
F_15 ( V_81 ) ;
return V_54 ;
}
