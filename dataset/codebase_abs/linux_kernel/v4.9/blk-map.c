...
if ( V_14 )
V_18 = true ;
else if ( F_22 ( V_16 ) & V_24 )
V_18 = true ;
else if ( F_23 ( V_4 ) )
V_18 = F_23 ( V_4 ) & F_24 ( V_16 ) ;
V_26 = * V_16 ;
do {
...
int F_26 ( struct V_19 * V_4 , struct V_1 * V_2 ,
struct V_13 * V_14 , void T_2 * V_31 ,
unsigned long V_32 , T_1 V_17 )
{
struct V_33 V_34 ;
struct V_15 V_26 ;
int V_11 = F_27 ( F_28 ( V_2 ) , V_31 , V_32 , & V_34 , & V_26 ) ;
if ( F_29 ( V_11 < 0 ) )
return V_11 ;
...
int F_31 ( struct V_19 * V_4 , struct V_1 * V_2 , void * V_39 ,
unsigned int V_32 , T_1 V_17 )
{
int V_40 = F_28 ( V_2 ) == V_41 ;
...
if ( ! V_32 || ! V_39 )
return - V_5 ;
V_43 = ! F_33 ( V_4 , V_42 , V_32 ) || F_34 ( V_39 ) ;
if ( V_43 )
V_3 = F_35 ( V_4 , V_39 , V_32 , V_17 , V_40 ) ;
else
V_3 = F_36 ( V_4 , V_39 , V_32 , V_17 ) ;
if ( F_11 ( V_3 ) )
return F_12 ( V_3 ) ;
if ( ! V_40 )
F_37 ( V_3 , V_44 , 0 ) ;
