...
F_79 ( V_7 ) ;
F_82 ( V_7 ) ;
V_7 -> V_245 = F_100 ( & V_7 -> V_11 -> V_11 , V_7 ,
V_246 , L_45 ,
V_7 -> V_180 ) ;
return F_101 ( V_7 -> V_11 ) ;
}
...
F_62 ( L_57 ,
V_7 -> V_210 ) ;
for ( V_57 = 0 ; V_57 < F_104 ( V_247 ) ; ++ V_57 ) {
if ( F_53 ( V_7 , ( 1ULL << V_57 ) ) )
F_105 ( L_58 , V_247 [ V_57 ] ) ;
}
if ( V_7 -> V_210 & V_101 )
F_105 ( L_59 ) ;
F_105 ( L_60 ) ;
...
{
int V_250 ;
V_250 = F_111 ( V_7 -> V_11 ) ;
if ( V_250 )
return V_250 ;
V_250 = F_112 ( V_7 -> V_11 -> V_251 ,
V_252 ,
V_253 ,
0 , L_63 ,
V_7 ) ;
...
F_116 (entry, next, &amd_iommu_unity_map, list) {
F_77 ( & V_17 -> V_130 ) ;
F_78 ( V_17 ) ;
}
}
static int T_6 F_117 ( struct V_146 * V_147 )
{
int V_57 ;
switch ( V_147 -> type ) {
case V_258 :
...
static int T_6 F_118 ( struct V_146 * V_147 )
{
...
V_156 -> V_264 = F_119 ( V_147 -> V_150 ) ;
V_156 -> V_265 = V_156 -> V_264 + F_119 ( V_147 -> V_151 ) ;
...
static int T_6 F_120 ( struct V_55 * V_56 )
{
T_3 * V_46 = ( T_3 * ) V_56 , * V_37 = ( T_3 * ) V_56 ;
struct V_146 * V_147 ;
V_37 += V_56 -> V_49 ;
...
T_8 V_307 ;
T_9 V_90 ;
int V_57 , V_308 , V_63 = 0 ;
if ( ! V_309 )
return - V_60 ;
V_90 = F_142 ( L_73 , 0 , & V_306 , & V_307 ) ;
if ( V_90 == V_310 )
return - V_60 ;
else if ( F_143 ( V_90 ) ) {
const char * V_311 = F_144 ( V_90 ) ;
F_24 ( L_74 , V_311 ) ;
return - V_48 ;
}
V_63 = F_33 ( V_306 ) ;
...
V_63 = - V_68 ;
if ( ! F_146 ( V_94 ) )
V_308 = V_317 * sizeof( T_2 ) ;
else
V_308 = V_317 * ( sizeof( T_4 ) * 2 ) ;
V_296 = F_147 ( L_76 ,
V_308 ,
V_318 ,
0 , NULL ) ;
...
case V_328 :
V_63 = F_106 () ;
V_319 = V_63 ? V_323 : V_329 ;
F_127 () ;
break;
case V_329 :
V_63 = F_131 () ;
V_319 = V_63 ? V_323 : V_330 ;
break;
case V_330 :
V_63 = F_153 () ;
V_319 = V_63 ? V_323 : V_331 ;
break;
case V_331 :
V_319 = V_332 ;
break;
...
static int T_6 F_155 ( enum V_333 V_334 )
{
int V_63 = 0 ;
while ( V_319 != V_334 ) {
V_63 = F_151 () ;
...
V_309 = true ;
V_337 = 1 ;
V_340 . V_7 . V_341 = F_161 ;
return 1 ;
}
static int T_6 F_163 ( char * V_342 )
{
V_343 = true ;
return 1 ;
}
static int T_6 F_164 ( char * V_342 )
{
for (; * V_342 ; ++ V_342 ) {
if ( strncmp ( V_342 , L_77 , 6 ) == 0 ) {
V_94 = V_191 ;
break;
}
if ( strncmp ( V_342 , L_78 , 5 ) == 0 ) {
V_94 = F_51 ;
break;
}
}
...
static int T_6 F_165 ( char * V_342 )
{
for (; * V_342 ; ++ V_342 ) {
if ( strncmp ( V_342 , L_79 , 9 ) == 0 )
V_344 = true ;
if ( strncmp ( V_342 , L_80 , 3 ) == 0 )
V_339 = true ;
if ( strncmp ( V_342 , L_81 , 15 ) == 0 )
V_345 = true ;
}
return 1 ;
}
static int T_6 F_166 ( char * V_342 )
{
unsigned int V_239 , V_11 , V_346 ;
int V_63 , V_126 , V_57 ;
T_1 V_1 ;
V_63 = sscanf ( V_342 , L_82 , & V_126 , & V_239 , & V_11 , & V_346 ) ;
if ( V_63 != 4 ) {
F_24 ( L_83 , V_342 ) ;
return 1 ;
}
...
V_1 = ( ( V_239 & 0xff ) << 8 ) | ( ( V_11 & 0x1f ) << 3 ) | ( V_346 & 0x7 ) ;
V_301 = true ;
V_57 = V_140 ++ ;
...
static int T_6 F_167 ( char * V_342 )
{
unsigned int V_239 , V_11 , V_346 ;
int V_63 , V_126 , V_57 ;
T_1 V_1 ;
...
static int T_6 F_168 ( char * V_342 )
{
T_2 V_239 , V_11 , V_346 ;
char * V_135 , * V_136 , * V_46 ;
char V_348 [ V_167 + V_166 ] = { 0 } ;
int V_63 , V_57 ;
V_63 = sscanf ( V_342 , L_87 , & V_239 , & V_11 , & V_346 , V_348 ) ;
if ( V_63 != 4 ) {
F_24 ( L_88 , V_342 ) ;
return 1 ;
}
V_46 = V_348 ;
V_135 = F_169 ( & V_46 , L_89 ) ;
V_136 = V_46 ;
...
V_145 [ V_57 ] . V_1 =
( ( V_239 & 0xff ) << 8 ) | ( ( V_11 & 0x1f ) << 3 ) | ( V_346 & 0x7 ) ;
...
T_3 V_349 , T_3 V_350 , T_3 V_351 ,
T_4 * V_174 , bool V_352 )
{
T_2 V_353 ;
T_2 V_354 ;
if ( F_32 ( ( V_351 > 0x28 ) || ( V_351 & 7 ) ) )
return - V_60 ;
V_353 = ( T_2 ) ( ( ( 0x40 | V_349 ) << 12 ) | ( V_350 << 8 ) | V_351 ) ;
V_354 = ( T_2 ) ( ( ( 0x40 | V_7 -> V_203 ) << 12 ) |
( V_7 -> V_204 << 8 ) | 0x28 ) ;
if ( ( V_353 < V_355 ) ||
( V_353 > V_354 ) )
return - V_48 ;
if ( V_352 ) {
F_17 ( ( T_2 ) * V_174 , V_7 -> V_19 + V_353 ) ;
F_17 ( ( * V_174 >> 32 ) , V_7 -> V_19 + V_353 + 4 ) ;
} else {
* V_174 = F_16 ( V_7 -> V_19 + V_353 + 4 ) ;
* V_174 <<= 32 ;
* V_174 = F_16 ( V_7 -> V_19 + V_353 ) ;
}
return 0 ;
}
int F_174 ( T_1 V_1 , T_3 V_349 , T_3 V_350 , T_3 V_351 ,
T_4 * V_174 , bool V_352 )
{
struct V_6 * V_7 = V_111 [ V_1 ] ;
if ( ! V_202 || V_7 == NULL )
return - V_60 ;
return F_91 ( V_7 , V_349 , V_350 , V_351 ,
V_174 , V_352 ) ;
}
