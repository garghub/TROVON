...
int V_39 ;
int V_89 ;
V_15 -> V_515 = V_15 -> V_518 [ 0 ] ;
for ( V_39 = 0 ; V_39 < V_15 -> V_519 ; V_39 ++ ) {
V_89 = F_172 ( V_15 -> V_518 [ V_39 ] ,
F_168 , 0 ,
V_520 , V_15 -> V_521 [ V_39 ] ) ;
if ( V_89 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
L_57 ,
V_15 -> V_518 [ V_39 ] , V_89 ) ;
return V_89 ;
}
V_15 -> V_522 ++ ;
}
...
static void F_173 ( struct V_8 * V_15 )
{
int V_39 ;
for ( V_39 = 0 ; V_39 < V_15 -> V_522 ; V_39 ++ )
F_174 ( V_15 -> V_518 [ V_39 ] ,
V_15 -> V_521 [ V_39 ] ) ;
}
static int F_175 ( struct V_8 * V_15 )
{
unsigned int V_39 ;
int V_523 ;
int V_524 ;
...
V_526 [ V_39 ] . V_528 = V_39 ;
V_524 = F_176 ( V_15 -> V_23 ,
V_526 , V_529 , V_523 ) ;
if ( V_524 < 0 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
L_58 ,
...
V_15 -> V_519 = V_524 ;
for ( V_39 = 0 ; V_39 < V_524 ; V_39 ++ ) {
V_15 -> V_518 [ V_39 ] = V_526 [ V_39 ] . V_530 ;
V_15 -> V_521 [ V_39 ] = & V_15 -> V_453 [ V_39 ] ;
}
return 0 ;
}
static void F_177 ( struct V_8 * V_15 )
{
int V_39 ;
int V_89 ;
int V_531 ;
V_531 = F_178 ( V_532 ) ;
for ( V_39 = 0 ; V_39 < V_15 -> V_522 ; V_39 ++ ) {
V_89 = F_179 ( V_15 -> V_518 [ V_39 ] ,
F_180 ( V_531 ) ) ;
if ( V_89 )
F_33 ( & V_15 -> V_23 -> V_75 ,
L_59 ,
V_89 , V_15 -> V_518 [ V_39 ] ) ;
V_531 = F_181 ( V_531 , V_532 ) ;
}
}
static void F_182 ( struct V_8 * V_15 )
{
int V_39 ;
for ( V_39 = 0 ; V_39 < V_15 -> V_522 ; V_39 ++ )
F_179 ( V_15 -> V_518 [ V_39 ] , NULL ) ;
}
static int F_183 ( struct V_8 * V_15 )
{
unsigned int V_39 ;
T_2 V_533 ;
T_2 V_534 ;
...
V_539 = V_15 -> V_478 * 2 ;
V_540 = V_15 -> V_478 ;
V_541 = ( V_15 -> V_478 * 3 ) + 1 ;
V_538 = NULL ;
for ( V_39 = 0 ; V_39 < V_539 ; V_39 ++ ) {
V_538 = F_184 ( V_538 ,
V_542 ) ;
V_538 += V_534 ;
}
for ( V_39 = 0 ; V_39 < V_540 ; V_39 ++ ) {
V_538 = F_184 ( V_538 ,
V_542 ) ;
V_538 += V_535 ;
}
...
V_15 -> V_546 = V_533 ;
V_536 = F_184 ( V_15 -> V_544 ,
V_542 ) ;
for ( V_39 = 0 ; V_39 < V_15 -> V_478 ; V_39 ++ ) {
V_306 = & V_15 -> V_453 [ V_39 ] ;
V_306 -> V_462 [ V_459 ] = V_536 ;
V_306 -> V_547 [ V_459 ] =
V_15 -> V_545 +
( V_536 - V_15 -> V_544 ) ;
V_536 += V_534 ;
...
V_15 -> V_505 . V_426 = V_537 ;
V_15 -> V_505 . V_550 =
V_15 -> V_545 +
( V_537 - V_15 -> V_544 ) ;
return 0 ;
}
static void F_186 ( struct V_8 * V_15 )
{
unsigned int V_39 ;
T_4 V_551 = V_552 ;
T_4 V_553 = V_552 ;
...
V_15 -> V_505 . V_455 = V_553 ++ ;
for ( V_39 = 0 ; V_39 < V_15 -> V_478 ; V_39 ++ ) {
V_15 -> V_453 [ V_39 ] . V_554 [ V_459 ] = V_551 ++ ;
V_15 -> V_453 [ V_39 ] . V_554 [ V_516 ] = V_551 ++ ;
V_15 -> V_453 [ V_39 ] . V_455 = V_553 ++ ;
}
V_15 -> V_505 . V_555 = 0 ;
for ( V_39 = 0 ; V_39 < V_15 -> V_478 ; V_39 ++ )
V_15 -> V_453 [ V_39 ] . V_555 = V_39 ;
for ( V_39 = 0 ; V_39 < V_15 -> V_478 ; V_39 ++ ) {
F_187 ( & V_15 -> V_453 [ V_39 ] . V_458 [ 0 ] ) ;
F_187 ( & V_15 -> V_453 [ V_39 ] . V_458 [ 1 ] ) ;
F_106 ( & V_15 -> V_453 [ V_39 ] . V_556 [ 0 ] ) ;
F_106 ( & V_15 -> V_453 [ V_39 ] . V_556 [ 1 ] ) ;
}
}
static int F_188 ( struct V_8 * V_15 )
{
T_2 V_533 ;
struct V_557 * V_558 ;
struct V_559 * V_560 ;
V_533 = sizeof( struct V_557 ) +
V_542 ;
V_15 -> V_561 =
F_185 ( & V_15 -> V_23 -> V_75 ,
V_533 ,
...
V_15 -> V_563 = V_533 ;
V_560 = & V_15 -> V_560 ;
V_558 = F_184 ( V_15 -> V_561 ,
V_542 ) ;
V_560 -> V_462 =
& V_558 -> V_462 ;
V_560 -> V_431 =
& V_558 -> V_431 ;
V_560 -> V_451 = & V_558 -> V_451 ;
V_560 -> V_426 = & V_558 -> V_426 ;
V_560 -> V_547 =
V_15 -> V_562 +
( V_560 -> V_462 -
V_15 -> V_561 ) ;
...
static int F_189 ( struct V_8 * V_15 )
{
struct V_354 T_7 * V_355 ;
struct V_559 * V_560 ;
unsigned long V_356 ;
...
V_355 = V_15 -> V_355 ;
V_560 = & V_15 -> V_560 ;
F_190 ( ( V_32 ) V_560 -> V_547 ,
& V_355 -> V_565 ) ;
F_190 ( ( V_32 ) V_560 -> V_548 ,
& V_355 -> V_566 ) ;
F_190 ( ( V_32 ) V_560 -> V_549 ,
& V_355 -> V_567 ) ;
F_190 ( ( V_32 ) V_560 -> V_550 ,
& V_355 -> V_568 ) ;
V_564 = V_569 |
( V_570 ) << 8 |
( V_560 -> V_555 << 16 ) ;
F_153 ( V_564 , & V_355 -> V_571 ) ;
F_153 ( V_572 ,
& V_355 -> V_364 ) ;
V_356 = V_573 + V_360 ;
while ( 1 ) {
...
V_560 -> V_450 = V_15 -> V_575 +
V_576 +
F_133 ( & V_355 -> V_577 ) ;
V_560 -> V_427 = V_15 -> V_575 +
V_576 +
F_133 ( & V_355 -> V_578 ) ;
return 0 ;
}
static void F_191 ( struct V_8 * V_15 ,
struct V_579 * V_41 )
{
struct V_559 * V_560 ;
void * V_452 ;
...
V_450 = ( V_450 + 1 ) % V_569 ;
V_560 -> V_460 = V_450 ;
F_153 ( V_450 , V_560 -> V_450 ) ;
}
static int F_192 ( struct V_8 * V_15 ,
struct V_581 * V_420 )
{
struct V_559 * V_560 ;
T_8 V_426 ;
...
memcpy ( V_420 , V_560 -> V_431 +
( V_427 * V_582 ) , sizeof( * V_420 ) ) ;
V_427 = ( V_427 + 1 ) % V_570 ;
V_560 -> V_430 = V_427 ;
F_153 ( V_427 , V_560 -> V_427 ) ;
return 0 ;
}
static void F_170 ( struct V_8 * V_15 ,
struct V_305 * V_306 , enum V_583 V_477 ,
struct V_80 * V_81 )
{
struct V_80 * V_269 ;
void * V_452 ;
...
static void F_195 ( struct V_80 * V_81 ,
void * V_442 )
{
struct V_588 * V_589 = V_442 ;
F_196 ( V_589 ) ;
}
static int F_197 (
...
struct V_587 * V_41 , unsigned int V_36 ,
struct V_373 * V_87 , unsigned long V_590 )
{
int V_89 ;
struct V_80 * V_81 ;
unsigned long V_592 ;
...
static int F_207 (
struct V_581 * V_420 , T_1 V_598 )
{
if ( V_420 -> V_47 . V_48 != V_599 )
return - V_172 ;
if ( F_69 ( & V_420 -> V_47 . V_52 ) !=
V_600 )
return - V_172 ;
if ( V_420 -> V_601 != V_598 )
return - V_172 ;
if ( V_420 -> V_86 != V_602 )
return - V_172 ;
return 0 ;
...
int V_89 ;
F_191 ( V_15 , V_41 ) ;
V_89 = F_192 ( V_15 , V_420 ) ;
if ( V_89 == 0 )
V_89 = F_207 ( V_420 ,
V_41 -> V_601 ) ;
return V_89 ;
}
static int F_209 ( struct V_8 * V_15 )
{
int V_89 ;
struct V_579 V_41 ;
struct V_581 V_420 ;
struct V_603 * V_604 ;
struct V_605 * V_606 ;
V_604 = F_49 ( sizeof( * V_604 ) , V_95 ) ;
if ( ! V_604 )
return - V_31 ;
memset ( & V_41 , 0 , sizeof( V_41 ) ) ;
V_41 . V_47 . V_48 = V_607 ;
F_29 ( V_600 ,
& V_41 . V_47 . V_52 ) ;
V_41 . V_601 =
V_608 ;
F_23 ( sizeof( * V_604 ) ,
& V_41 . V_386 . V_609 . V_27 ) ;
V_89 = F_19 ( V_15 -> V_23 ,
& V_41 . V_386 . V_609 . V_25 ,
V_604 , sizeof( * V_604 ) ,
V_76 ) ;
if ( V_89 )
goto V_96;
V_89 = F_208 ( V_15 , & V_41 ,
& V_420 ) ;
F_24 ( V_15 -> V_23 ,
& V_41 . V_386 . V_609 . V_25 , 1 ,
V_76 ) ;
if ( V_89 )
goto V_96;
if ( V_420 . V_86 != V_602 ) {
...
static int F_210 ( struct V_8 * V_15 )
{
if ( V_15 -> V_612 <
V_463 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
...
static int F_211 ( struct V_8 * V_15 ,
bool V_622 , T_4 V_623 )
{
struct V_579 V_41 ;
struct V_581 V_420 ;
memset ( & V_41 , 0 , sizeof( V_41 ) ) ;
...
V_625 ;
F_29 ( V_623 ,
& V_41 . V_386 . V_626 . V_623 ) ;
return F_208 ( V_15 , & V_41 ,
& V_420 ) ;
}
...
V_41 . V_601 = V_627 ;
F_29 ( V_505 -> V_455 ,
& V_41 . V_386 . V_628 . V_623 ) ;
F_22 ( ( V_32 ) V_505 -> V_548 ,
& V_41 . V_386 . V_628 . V_629 ) ;
F_22 ( ( V_32 ) V_505 -> V_550 ,
& V_41 . V_386 . V_628 . V_630 ) ;
F_29 ( V_511 ,
& V_41 . V_386 . V_628 . V_631 ) ;
F_29 ( V_509 / 16 ,
& V_41 . V_386 . V_628 . V_632 ) ;
V_41 . V_386 . V_628 . V_633 = V_617 ;
F_29 ( V_505 -> V_555 ,
& V_41 . V_386 . V_628 . V_555 ) ;
V_89 = F_208 ( V_15 , & V_41 ,
& V_420 ) ;
if ( V_89 )
return V_89 ;
V_505 -> V_427 = V_15 -> V_575 +
V_576 +
F_26 (
& V_420 . V_386 . V_628 . V_634 ) ;
return 0 ;
}
static int F_213 ( struct V_8 * V_15 )
{
unsigned int V_39 ;
int V_89 ;
struct V_305 * V_306 ;
...
& V_41 . V_47 . V_52 ) ;
V_41 . V_601 = V_636 ;
F_29 ( V_306 -> V_554 [ V_459 ] ,
& V_41 . V_386 . V_637 . V_623 ) ;
F_22 (
( V_32 ) V_306 -> V_547 [ V_459 ] ,
& V_41 . V_386 . V_637 . V_629 ) ;
F_22 ( ( V_32 ) V_306 -> V_549 [ V_459 ] ,
& V_41 . V_386 . V_637 . V_638 ) ;
F_29 ( V_15 -> V_461 ,
& V_41 . V_386 . V_637 . V_631 ) ;
F_29 ( V_463 / 16 ,
& V_41 . V_386 . V_637 . V_632 ) ;
V_41 . V_386 . V_637 . V_633 = V_617 ;
V_89 = F_208 ( V_15 , & V_41 ,
& V_420 ) ;
if ( V_89 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
...
V_306 -> V_450 [ V_459 ] = V_15 -> V_575 +
V_576 +
F_26 (
& V_420 . V_386 . V_637 . V_639 ) ;
memset ( & V_41 , 0 , sizeof( V_41 ) ) ;
V_41 . V_47 . V_48 = V_607 ;
F_29 ( V_600 ,
& V_41 . V_47 . V_52 ) ;
V_41 . V_601 = V_636 ;
F_29 ( V_306 -> V_554 [ V_516 ] ,
& V_41 . V_386 . V_637 . V_623 ) ;
F_22 ( ( V_32 ) V_306 ->
V_547 [ V_516 ] ,
& V_41 . V_386 . V_637 . V_629 ) ;
F_22 ( ( V_32 ) V_306 -> V_549 [ V_516 ] ,
& V_41 . V_386 . V_637 . V_638 ) ;
F_29 ( V_15 -> V_461 ,
& V_41 . V_386 . V_637 . V_631 ) ;
F_29 ( V_463 / 16 ,
...
V_41 . V_601 = V_641 ;
F_29 ( V_306 -> V_554 [ V_516 ] ,
& V_41 . V_386 . V_642 . V_623 ) ;
F_23 ( V_643 ,
& V_41 . V_386 . V_642 . V_644 ) ;
V_89 = F_208 ( V_15 , & V_41 ,
& V_420 ) ;
if ( V_89 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
...
F_29 ( V_306 -> V_455 ,
& V_41 . V_386 . V_628 . V_623 ) ;
F_22 ( ( V_32 ) V_306 -> V_548 ,
& V_41 . V_386 . V_628 . V_629 ) ;
F_22 ( ( V_32 ) V_306 -> V_550 ,
& V_41 . V_386 . V_628 . V_630 ) ;
F_29 ( V_15 -> V_443 ,
& V_41 . V_386 . V_628 . V_631 ) ;
F_29 ( V_432 / 16 ,
...
static int F_214 ( struct V_8 * V_15 )
{
int V_89 ;
unsigned int V_39 ;
V_89 = F_212 ( V_15 ) ;
...
static int F_215 ( struct V_8 * V_15 )
{
int V_89 ;
unsigned int V_39 ;
struct V_646 * V_647 ;
...
return - V_31 ;
memset ( & V_41 , 0 , sizeof( V_41 ) ) ;
V_41 . V_47 . V_48 = V_650 ;
F_29 ( F_30 ( struct V_648 ,
V_386 . V_651 . V_50 [ 1 ] ) -
V_51 , & V_41 . V_47 . V_52 ) ;
F_23 ( V_649 ,
& V_41 . V_386 . V_651 . V_27 ) ;
V_89 = F_19 ( V_15 -> V_23 ,
V_41 . V_386 . V_651 . V_50 ,
V_647 , V_649 ,
V_76 ) ;
if ( V_89 )
goto V_96;
...
0 , NULL , V_90 ) ;
F_24 ( V_15 -> V_23 ,
V_41 . V_386 . V_651 . V_50 , 1 ,
V_76 ) ;
if ( V_89 )
goto V_96;
for ( V_39 = 0 ; V_39 < V_647 -> V_652 ; V_39 ++ )
F_29 ( V_15 -> V_505 . V_455 ,
& V_647 -> V_37 [ V_39 ] . V_455 ) ;
memset ( & V_41 , 0 , sizeof( V_41 ) ) ;
V_41 . V_47 . V_48 = V_653 ;
F_29 ( F_30 ( struct V_648 ,
V_386 . V_651 . V_50 [ 1 ] ) -
V_51 , & V_41 . V_47 . V_52 ) ;
F_23 ( V_649 ,
...
static inline int F_218 ( struct V_8 * V_15 )
{
V_15 -> V_438 = F_185 ( & V_15 -> V_23 -> V_75 ,
V_15 -> V_657 ,
& V_15 -> V_658 , V_95 ) ;
if ( ! V_15 -> V_438 )
return - V_31 ;
...
static int F_219 ( struct V_8 * V_15 )
{
unsigned int V_39 ;
void * V_655 ;
T_2 V_654 ;
...
static void F_221 ( struct V_8 * V_15 )
{
T_6 V_659 ;
T_6 V_660 ;
V_15 -> V_661 =
V_15 -> V_662 - V_663 ;
V_15 -> V_85 = V_15 -> V_662 ;
V_15 -> V_657 =
V_15 -> V_85 * V_440 ;
V_659 =
F_222 ( V_15 -> V_659 , V_664 ) ;
V_660 = V_659 / V_665 ;
V_660 ++ ;
V_660 = F_222 ( V_15 -> V_660 , V_660 ) ;
V_659 = ( V_660 - 1 ) * V_665 ;
V_15 -> V_654 =
V_660 * sizeof( struct V_24 ) ;
V_15 -> V_666 = V_660 ;
V_15 -> V_667 = V_659 / 512 ;
}
static void F_223 ( struct V_8 * V_15 )
{
int V_668 ;
int V_669 ;
int V_478 ;
T_4 V_461 ;
T_4 V_443 ;
V_669 = F_222 ( V_15 -> V_610 / 2 ,
V_15 -> V_613 - 1 ) ;
V_669 = F_222 ( V_669 , V_670 ) ;
V_668 = F_224 () ;
V_478 = F_222 ( V_668 , V_15 -> V_671 ) ;
V_478 = F_222 ( V_478 , V_669 ) ;
V_15 -> V_478 = V_478 ;
V_15 -> V_619 =
( V_15 -> V_618 /
V_463 ) *
...
static inline void F_225 (
struct V_24 * V_25 , struct V_674 * V_675 )
{
V_32 V_33 = ( V_32 ) F_226 ( V_675 ) ;
unsigned int V_34 = F_227 ( V_675 ) ;
F_22 ( V_33 , & V_25 -> V_33 ) ;
F_23 ( V_34 , & V_25 -> V_34 ) ;
F_23 ( 0 , & V_25 -> V_36 ) ;
}
...
F_23 ( V_35 , & V_25 -> V_36 ) ;
V_41 -> V_680 = V_677 ;
V_52 += V_678 * sizeof( * V_25 ) ;
V_96:
F_29 ( V_52 , & V_41 -> V_47 . V_52 ) ;
return 0 ;
}
static int F_232 ( struct V_8 * V_15 ,
struct V_681 * V_41 , struct V_3 * V_4 ,
struct V_80 * V_81 )
{
int V_39 ;
T_4 V_52 ;
...
static void F_233 ( struct V_80 * V_81 ,
void * V_442 )
{
struct V_3 * V_4 ;
V_4 = V_81 -> V_4 ;
...
static int F_235 ( struct V_8 * V_15 ,
struct V_12 * V_13 , struct V_3 * V_4 ,
struct V_305 * V_306 )
{
int V_89 ;
...
sizeof( V_41 -> V_53 ) ) ;
V_334 = F_236 ( T_2 , V_4 -> V_684 , sizeof( V_41 -> V_45 ) ) ;
...
static void F_237 ( struct V_80 * V_81 ,
void * V_442 )
{
struct V_3 * V_4 ;
V_4 = V_81 -> V_4 ;
...
static inline int F_238 ( struct V_8 * V_15 ,
struct V_12 * V_13 , struct V_3 * V_4 ,
struct V_305 * V_306 )
{
return F_131 ( V_15 , V_4 , V_13 -> V_236 ,
V_4 -> V_338 , V_4 -> V_684 , V_306 , NULL ) ;
}
...
V_4 -> V_395 = 0 ;
V_700 = F_240 ( F_241 ( V_4 -> V_41 ) ) ;
if ( V_700 >= V_15 -> V_478 )
V_700 = 0 ;
V_306 = & V_15 -> V_453 [ V_700 ] ;
if ( F_7 ( V_13 ) ) {
V_701 = false ;
if ( V_13 -> V_242 &&
V_4 -> V_41 -> V_702 == V_703 ) {
...
if ( ! V_701 )
V_89 = F_235 ( V_15 , V_13 , V_4 ,
V_306 ) ;
} else {
if ( V_13 -> V_260 )
V_89 = F_238 ( V_15 , V_13 , V_4 ,
V_306 ) ;
else
V_89 = F_235 ( V_15 , V_13 , V_4 ,
V_306 ) ;
...
static void F_242 ( struct V_80 * V_81 ,
void * V_442 )
{
struct V_588 * V_589 = V_442 ;
F_196 ( V_589 ) ;
}
static int F_243 ( struct V_8 * V_15 ,
struct V_12 * V_13 , struct V_588 * V_591 )
{
int V_89 ;
...
L_78 ,
V_15 -> V_234 -> V_235 , V_13 -> V_142 ,
V_13 -> V_143 , V_13 -> V_144 , V_705 ) ;
}
return V_89 ;
}
static int F_244 ( struct V_8 * V_15 ,
struct V_12 * V_13 )
{
int V_89 ;
struct V_80 * V_81 ;
...
static int F_245 ( struct V_8 * V_15 ,
struct V_12 * V_13 )
{
int V_89 ;
F_9 ( V_15 ) ;
if ( F_8 ( V_15 ) )
return V_712 ;
V_89 = F_244 ( V_15 , V_13 ) ;
return V_89 == 0 ? V_713 : V_712 ;
}
...
V_89 = F_245 ( V_15 , V_13 ) ;
F_33 ( & V_15 -> V_23 -> V_75 ,
L_80 ,
V_15 -> V_234 -> V_235 ,
V_13 -> V_142 , V_13 -> V_143 , V_13 -> V_144 ,
V_89 == V_713 ? L_81 : L_82 ) ;
return V_89 ;
}
static int F_247 ( struct V_368 * V_244 )
{
struct V_12 * V_13 ;
unsigned long V_36 ;
struct V_8 * V_15 ;
...
V_15 = F_5 ( V_244 -> V_370 ) ;
F_102 ( & V_15 -> V_263 , V_36 ) ;
if ( F_248 ( V_244 ) == V_149 ) {
V_715 = V_714 ( V_244 ) ;
V_717 = F_249 ( V_715 ) ;
V_13 = F_250 ( V_15 , V_717 ) ;
if ( V_13 ) {
V_13 -> V_143 = F_251 ( V_244 ) ;
V_13 -> V_144 = V_244 -> V_144 ;
V_13 -> V_147 = true ;
}
} else {
V_13 = F_94 ( V_15 , F_248 ( V_244 ) ,
F_251 ( V_244 ) , V_244 -> V_144 ) ;
}
if ( V_13 && V_13 -> V_256 ) {
V_244 -> V_11 = V_13 ;
V_13 -> V_244 = V_244 ;
...
static int F_252 ( struct V_368 * V_244 )
{
struct V_12 * V_13 ;
V_13 = V_244 -> V_11 ;
if ( ! V_13 -> V_256 )
...
static int F_253 ( struct V_8 * V_15 ,
void T_10 * V_718 )
{
struct V_23 * V_23 ;
T_6 V_719 ;
...
return - V_172 ;
V_23 = V_15 -> V_23 ;
V_721 . V_722 = F_254 ( V_23 -> V_142 ) ;
V_721 . V_142 = V_23 -> V_142 -> V_723 ;
V_721 . V_724 = V_23 -> V_725 ;
V_719 = V_23 -> V_719 ;
V_720 = V_23 -> V_720 ;
V_721 . V_726 = ( ( V_720 << 16 ) & 0xffff0000 ) |
V_719 ;
if ( F_255 ( V_718 , & V_721 , sizeof( V_721 ) ) )
return - V_727 ;
return 0 ;
}
static int F_256 ( void T_10 * V_718 )
{
T_6 V_728 ;
if ( ! V_718 )
return - V_172 ;
V_728 = ( V_729 << 28 ) | ( V_730 << 24 ) |
( V_731 << 16 ) | V_732 ;
if ( F_255 ( V_718 , & V_728 , sizeof( V_728 ) ) )
return - V_727 ;
return 0 ;
}
static void F_257 ( struct V_373 * V_733 ,
struct V_734 * V_734 )
{
int V_735 ;
T_2 V_374 ;
...
F_69 ( & V_733 -> V_385 ) ;
if ( V_374 )
if ( V_374 > sizeof( V_733 -> V_386 ) )
V_374 = sizeof( V_733 -> V_386 ) ;
V_734 -> V_371 = V_733 -> V_86 ;
V_734 -> V_765 = V_735 ;
V_734 -> V_374 = V_374 ;
}
static int F_258 ( struct V_8 * V_15 , void T_10 * V_718 )
{
int V_89 ;
char * V_766 = NULL ;
T_4 V_52 ;
...
if ( ! F_259 ( V_768 ) )
return - V_769 ;
if ( F_260 ( & V_767 , V_718 , sizeof( V_767 ) ) )
return - V_727 ;
if ( V_767 . V_770 < 1 &&
V_767 . V_771 . Type . V_772 != V_773 )
return - V_172 ;
if ( V_767 . V_771 . V_774 > sizeof( V_41 . V_45 ) )
return - V_172 ;
if ( V_767 . V_771 . Type . Type != V_775 )
return - V_172 ;
switch ( V_767 . V_771 . Type . V_772 ) {
case V_773 :
case V_776 :
case V_777 :
break;
...
if ( V_767 . V_770 > 0 ) {
V_766 = F_49 ( V_767 . V_770 , V_95 ) ;
if ( ! V_766 )
return - V_31 ;
if ( V_767 . V_771 . Type . V_772 & V_776 ) {
if ( F_260 ( V_766 , V_767 . V_778 ,
V_767 . V_770 ) ) {
V_89 = - V_727 ;
goto V_96;
}
} else {
memset ( V_766 , 0 , V_767 . V_770 ) ;
}
}
memset ( & V_41 , 0 , sizeof( V_41 ) ) ;
V_41 . V_47 . V_48 = V_49 ;
V_52 = F_30 ( struct V_40 , V_50 ) -
V_51 ;
memcpy ( V_41 . V_53 , V_767 . V_779 . V_780 ,
sizeof( V_41 . V_53 ) ) ;
memcpy ( V_41 . V_45 , V_767 . V_771 . V_781 , V_767 . V_771 . V_774 ) ;
V_41 . V_56 = V_57 ;
switch ( V_767 . V_771 . Type . V_772 ) {
case V_773 :
V_41 . V_28 = V_78 ;
...
F_24 ( V_15 -> V_23 , V_41 . V_50 , 1 ,
V_79 ) ;
memset ( & V_767 . V_87 , 0 , sizeof( V_767 . V_87 ) ) ;
if ( V_89 == 0 ) {
F_257 ( & V_733 , & V_734 ) ;
V_767 . V_87 . V_782 = V_734 . V_371 ;
V_767 . V_87 . V_783 =
V_734 . V_765 ;
V_374 = V_734 . V_374 ;
if ( V_374 ) {
if ( V_374 >
sizeof( V_767 . V_87 . V_784 ) )
V_374 =
sizeof( V_767 . V_87 . V_784 ) ;
memcpy ( V_767 . V_87 . V_784 ,
V_733 . V_386 , V_374 ) ;
V_767 . V_87 . V_785 = V_374 ;
}
}
if ( F_255 ( V_718 , & V_767 , sizeof( V_767 ) ) ) {
V_89 = - V_727 ;
goto V_96;
}
if ( V_89 == 0 && V_767 . V_770 > 0 &&
( V_767 . V_771 . Type . V_772 & V_777 ) ) {
if ( F_255 ( V_767 . V_778 , V_766 ,
V_767 . V_770 ) ) {
V_89 = - V_727 ;
}
}
...
static int F_261 ( struct V_368 * V_244 , int V_42 , void T_10 * V_718 )
{
int V_89 ;
struct V_8 * V_15 ;
V_15 = F_5 ( V_244 -> V_370 ) ;
...
break;
case V_789 :
V_89 = F_253 ( V_15 , V_718 ) ;
break;
case V_790 :
V_89 = F_256 ( V_718 ) ;
break;
case V_791 :
V_89 = F_258 ( V_15 , V_718 ) ;
break;
default:
V_89 = - V_172 ;
break;
...
V_10 = F_263 ( V_75 ) ;
V_15 = F_5 ( V_10 ) ;
V_794 += snprintf (buffer + count, PAGE_SIZE - count,
L_83 , DRIVER_VERSION BUILD_TIMESTAMP) ;
V_794 += snprintf ( V_26 + V_794 , V_665 - V_794 ,
L_84 , V_15 -> V_795 ) ;
return V_794 ;
}
static T_13 F_264 ( struct V_13 * V_75 ,
struct V_792 * V_793 , const char * V_26 , T_2 V_794 )
{
struct V_9 * V_10 = F_263 ( V_75 ) ;
F_120 ( V_10 ) ;
return V_794 ;
}
static T_13 F_265 ( struct V_13 * V_75 ,
struct V_792 * V_793 , char * V_26 )
{
struct V_8 * V_15 ;
struct V_368 * V_244 ;
...
V_261 = V_13 -> V_261 ;
F_104 ( & V_15 -> V_263 , V_36 ) ;
return snprintf ( V_26 , V_665 , L_85 , V_261 ) ;
}
static T_13 F_267 ( struct V_13 * V_75 ,
struct V_792 * V_793 , char * V_26 )
{
struct V_8 * V_15 ;
struct V_368 * V_244 ;
...
static int F_268 ( struct V_8 * V_15 )
{
int V_89 ;
struct V_9 * V_10 ;
V_10 = F_269 ( & V_797 , sizeof( V_15 ) ) ;
if ( ! V_10 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
L_86 ,
V_15 -> V_798 ) ;
...
V_10 -> V_806 = ~ 0 ;
V_10 -> V_807 = ~ 0 ;
V_10 -> V_667 = V_15 -> V_667 ;
V_10 -> V_808 = V_15 -> V_661 ;
V_10 -> V_809 = V_10 -> V_808 ;
V_10 -> V_666 = V_15 -> V_666 ;
V_10 -> V_810 = V_811 ;
V_10 -> V_512 = V_15 -> V_518 [ 0 ] ;
V_10 -> V_812 = V_10 -> V_512 ;
V_10 -> V_813 = V_15 -> V_478 ;
V_10 -> V_11 [ 0 ] = ( unsigned long ) V_15 ;
V_89 = F_270 ( V_10 , & V_15 -> V_23 -> V_75 ) ;
if ( V_89 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
L_87 ,
V_15 -> V_798 ) ;
...
static void F_274 ( struct V_8 * V_15 )
{
struct V_9 * V_10 ;
F_275 ( V_15 ) ;
V_10 = V_15 -> V_234 ;
...
int V_89 ;
struct V_88 * V_820 ;
V_820 = F_49 ( sizeof( * V_820 ) , V_95 ) ;
if ( ! V_820 )
return - V_31 ;
V_89 = F_39 ( V_15 , V_820 ) ;
if ( V_89 )
goto V_96;
memcpy ( V_15 -> V_795 , V_820 -> V_795 ,
sizeof( V_820 -> V_795 ) ) ;
V_15 -> V_795 [ sizeof( V_820 -> V_795 ) ] = '\0' ;
snprintf ( V_15 -> V_795 +
strlen ( V_15 -> V_795 ) ,
sizeof( V_15 -> V_795 ) ,
L_90 , F_69 ( & V_820 -> V_821 ) ) ;
V_96:
F_46 ( V_820 ) ;
return V_89 ;
}
static int F_278 ( struct V_8 * V_15 )
{
if ( ! F_10 ( V_15 ) )
return - V_93 ;
if ( F_13 ( V_15 ) == V_822 ) {
...
static int F_281 ( struct V_8 * V_15 )
{
int V_89 ;
if ( V_823 ) {
V_89 = F_278 ( V_15 ) ;
...
static int F_287 ( struct V_8 * V_15 )
{
int V_89 ;
V_32 V_826 ;
V_89 = F_288 ( V_15 -> V_23 ) ;
if ( V_89 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
L_103 ) ;
return V_89 ;
...
V_826 = F_289 ( 32 ) ;
V_89 = F_290 ( & V_15 -> V_23 -> V_75 , V_826 ) ;
if ( V_89 ) {
F_33 ( & V_15 -> V_23 -> V_75 , L_104 ) ;
goto V_827;
}
V_89 = F_291 ( V_15 -> V_23 , V_520 ) ;
if ( V_89 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
L_105 ) ;
goto V_827;
}
V_15 -> V_575 = F_292 ( F_293 (
V_15 -> V_23 , 0 ) ,
sizeof( struct V_828 ) ) ;
if ( ! V_15 -> V_575 ) {
F_33 ( & V_15 -> V_23 -> V_75 ,
...
V_15 -> V_830 = V_15 -> V_575 ;
V_15 -> V_355 = & V_15 -> V_830 -> V_355 ;
F_294 ( V_15 -> V_23 ) ;
F_295 ( V_15 -> V_23 , V_15 ) ;
return 0 ;
V_829:
F_296 ( V_15 -> V_23 ) ;
V_827:
...
static void F_298 ( struct V_8 * V_15 )
{
F_299 ( V_15 -> V_575 ) ;
F_296 ( V_15 -> V_23 ) ;
F_297 ( V_15 -> V_23 ) ;
F_295 ( V_15 -> V_23 , NULL ) ;
}
static struct V_8 * F_300 ( int V_831 )
{
struct V_8 * V_15 ;
V_15 = F_301 ( sizeof( struct V_8 ) ,
V_95 , V_831 ) ;
if ( ! V_15 )
return NULL ;
F_302 ( & V_15 -> V_296 ) ;
F_106 ( & V_15 -> V_275 ) ;
F_187 ( & V_15 -> V_263 ) ;
F_303 ( & V_15 -> V_472 , F_157 ) ;
F_304 ( & V_15 -> V_480 , 0 ) ;
F_305 ( & V_15 -> V_21 , F_86 ) ;
F_305 ( & V_15 -> V_124 , F_54 ) ;
F_306 ( & V_15 -> V_595 ,
V_832 ) ;
F_306 ( & V_15 -> V_708 , V_833 ) ;
V_15 -> V_798 = F_36 ( & V_834 ) - 1 ;
V_15 -> V_671 = V_527 ;
return V_15 ;
}
static inline void F_307 ( struct V_8 * V_15 )
{
F_46 ( V_15 ) ;
}
...
static void F_310 ( struct V_8 * V_15 )
{
F_164 ( V_15 ) ;
F_308 ( V_15 ) ;
if ( V_15 -> V_544 )
F_217 ( & V_15 -> V_23 -> V_75 ,
V_15 -> V_546 ,
V_15 -> V_544 ,
V_15 -> V_545 ) ;
if ( V_15 -> V_561 )
...
static void F_311 ( struct V_8 * V_15 )
{
F_312 ( & V_15 -> V_21 ) ;
F_312 ( & V_15 -> V_124 ) ;
F_117 ( V_15 ) ;
...
static void F_313 ( struct V_23 * V_835 ,
const struct V_836 * V_837 )
{
char * V_838 ;
if ( V_837 -> V_839 ) {
V_838 = ( char * ) V_837 -> V_839 ;
} else {
switch ( V_837 -> V_840 ) {
case V_841 :
V_838 = V_842 ;
...
F_80 ( & V_835 -> V_75 , L_107 , V_838 ) ;
}
static int F_314 ( struct V_23 * V_835 , const struct V_836 * V_837 )
{
int V_89 ;
int V_845 ;
struct V_8 * V_15 ;
...
if ( V_837 -> V_840 == V_847 || V_837 -> V_848 == V_847 )
F_57 ( & V_835 -> V_75 ,
L_109 ) ;
V_845 = F_315 ( & V_835 -> V_75 ) ;
if ( V_845 == V_849 )
F_316 ( & V_835 -> V_75 , 0 ) ;
V_15 = F_300 ( V_845 ) ;
if ( ! V_15 ) {
...
static void F_317 ( struct V_23 * V_835 )
{
struct V_8 * V_15 ;
V_15 = F_318 ( V_835 ) ;
if ( ! V_15 )
...
static void F_319 ( struct V_23 * V_835 )
{
int V_89 ;
struct V_8 * V_15 ;
V_15 = F_318 ( V_835 ) ;
