...
if ( ! V_60 ) {
V_199 = F_18 ( V_9 -> V_68 ) ;
V_199 -> V_201 = V_198 / 10000 ;
}
return V_60 ;
}
int F_43 ( struct V_1 * V_9 , T_1 V_202 )
{
struct V_8 * V_12 ;
struct V_15 * V_16 ;
struct V_147 * V_55 ;
...
if ( V_43 == V_81 ) {
V_9 -> V_6 = V_211 ;
V_120 -> V_212 = V_42 -> V_48 ;
V_120 -> V_213 = 1 << V_42 -> V_49 ;
V_60 = 0 ;
} else {
V_9 -> V_6 = V_7 ;
V_60 = - V_128 ;
...
static void F_45 ( struct V_1 * V_9 )
{
struct V_8 * V_12 ;
struct V_214 * V_215 ;
struct V_66 * V_67 = F_18 ( V_9 -> V_68 ) ;
struct V_118 * V_120 = V_67 -> V_120 ;
struct V_29 * V_216 = V_67 -> V_76 ;
V_98 V_17 ;
V_12 = F_5 ( V_9 , V_217 ,
F_33 ( struct V_214 ) ) ;
if ( ! V_12 )
goto V_130;
V_215 = & V_12 -> V_19 . V_23 . V_218 ;
V_215 -> V_25 = F_7 ( & V_9 -> V_26 ) ;
F_17 ( V_9 , V_12 ) ;
V_9 -> V_6 = V_7 ;
V_130:
F_8 ( & V_216 -> V_103 -> V_219 , V_17 ) ;
V_120 -> V_220 = true ;
F_10 ( & V_216 -> V_103 -> V_219 , V_17 ) ;
V_18 ( V_120 -> V_221 ,
F_46 ( & V_120 -> V_222 ) == 0 &&
F_46 ( & V_120 -> V_223 ) == 0 ) ;
if ( V_12 )
...
static void F_49 ( struct V_102 * V_229 )
{
struct V_31 * V_68 =
F_15 ( V_229 -> V_230 -> V_231 ) ;
struct V_118 * V_232 = F_37 ( V_68 ) ;
T_2 V_233 = V_229 -> V_234 . V_235 . V_236 ;
int V_60 ;
unsigned long V_17 ;
if ( V_233 >= V_232 -> V_237 )
return;
F_50 ( V_229 , V_232 -> V_238 + ( V_233 - 1 ) *
V_239 ) ;
V_232 -> V_240 [ V_233 ] . V_241 = F_51 ( V_242 *
sizeof( struct V_243 ) ) ;
V_60 = F_52 ( V_229 , V_232 -> V_244 * V_75 ,
V_232 -> V_244 * V_75 , NULL , 0 ,
V_245 , V_229 ) ;
if ( V_60 == 0 )
V_232 -> V_246 [ V_233 ] = V_229 ;
F_8 ( & V_232 -> V_247 , V_17 ) ;
V_232 -> V_248 -- ;
F_10 ( & V_232 -> V_247 , V_17 ) ;
if ( V_232 -> V_248 == 0 )
F_25 ( & V_232 -> V_249 ) ;
}
int F_53 ( struct V_29 * V_9 ,
void * V_250 )
{
int V_60 ;
struct V_31 * V_251 = F_15 ( V_9 ) ;
struct V_66 * V_67 = F_18 ( V_251 ) ;
struct V_118 * V_31 ;
struct V_1 * V_1 ;
...
V_266 ,
& V_259 , & V_100 ) ;
if ( V_60 == 0 && V_100 == sizeof( T_1 ) && V_259 < V_251 -> V_259 )
V_251 -> V_259 = V_259 ;
V_60 = F_35 ( V_1 ) ;
if ( V_60 != 0 ) {
F_55 ( V_9 ) ;
...
memcpy ( V_253 -> V_267 , V_1 -> V_141 , V_139 ) ;
memset ( & V_254 , 0 , sizeof( struct V_161 ) ) ;
V_254 . V_268 = V_269 ;
V_254 . V_270 = V_269 ;
V_254 . V_168 = V_269 ;
V_254 . V_271 = V_269 ;
...
F_56 ( & V_9 -> V_2 , L_32 ,
V_1 -> V_141 ,
V_253 -> V_82 ? L_33 : L_34 ) ;
if ( V_31 -> V_165 < V_275 )
return 0 ;
F_42 ( V_1 ) ;
memset ( & V_257 , 0 , V_258 ) ;
V_60 = F_32 ( V_1 ,
V_132 ,
& V_257 , & V_258 ) ;
if ( V_60 || V_257 . V_276 < 2 )
goto V_277;
V_31 -> V_265 = F_57 ( T_1 , V_278 , V_257 . V_276 ) ;
V_260 = F_58 ( V_253 -> V_279 , V_31 -> V_265 ) ;
V_263 = F_59 ( F_60 ( V_9 -> V_103 -> V_280 ) ) ;
V_264 = F_61 ( V_263 ) ;
if ( V_253 -> V_237 && V_253 -> V_237 < V_31 -> V_265 )
V_31 -> V_237 = V_253 -> V_237 ;
else
V_31 -> V_237 = F_58 ( V_264 , V_260 ) ;
V_260 = V_31 -> V_237 - 1 ;
V_31 -> V_248 = V_260 ;
if ( V_31 -> V_237 == 1 )
goto V_277;
V_31 -> V_238 = F_51 ( ( V_31 -> V_237 - 1 ) *
V_239 ) ;
if ( ! V_31 -> V_238 ) {
V_31 -> V_237 = 1 ;
F_56 ( & V_9 -> V_2 , L_35 ) ;
...
V_256 -> V_135 . V_10 = V_282 ;
V_256 -> V_23 . V_283 . V_284 . V_285 = V_286 ;
V_256 -> V_23 . V_283 . V_284 . V_287 =
V_31 -> V_237 - 1 ;
V_60 = F_63 ( V_9 -> V_103 , V_256 ,
sizeof( struct V_255 ) ,
( unsigned long ) V_256 ,
V_288 ,
V_289 ) ;
...
goto V_277;
F_34 ( & V_31 -> V_249 ) ;
if ( V_256 -> V_23 . V_283 . V_290 . V_43 !=
V_291 ) {
V_60 = - V_228 ;
goto V_277;
}
V_31 -> V_237 = 1 +
V_256 -> V_23 . V_283 . V_290 . V_287 ;
V_60 = F_40 ( V_1 , V_31 -> V_237 ) ;
F_8 ( & V_31 -> V_247 , V_17 ) ;
V_261 = V_260 - ( V_31 -> V_237 - 1 ) ;
V_31 -> V_248 -= V_261 ;
F_10 ( & V_31 -> V_247 , V_17 ) ;
V_277:
if ( V_60 ) {
V_31 -> V_265 = 1 ;
V_31 -> V_237 = 1 ;
...
void F_55 ( struct V_29 * V_9 )
{
struct V_118 * V_119 = F_64 ( V_9 ) ;
...
if ( ! V_120 )
return - V_128 ;
if ( F_7 ( & V_120 -> V_292 ) != 1 )
return 0 ;
return F_47 ( V_120 -> V_122 ) ;
}
int F_67 ( struct V_118 * V_120 )
{
if ( ! V_120 )
return - V_128 ;
if ( F_68 ( & V_120 -> V_292 ) != 0 )
return 0 ;
return F_48 ( V_120 -> V_122 ) ;
}
