...
return V_20 ;
V_90 = V_20 ;
V_20 = (struct V_19 * ) F_57 ( V_2 , & V_20 -> V_25 ,
F_48 ( V_22 ) , NULL , 0 ) ;
if ( ! F_50 ( V_20 ) ) {
if ( V_20 != V_90 )
return V_20 ;
} else if ( F_58 ( V_20 ) == - V_95 ) {
V_20 = NULL ;
} else
return V_20 ;
V_92 = F_59 ( V_88 , F_48 ( & V_91 ) , V_96 ) ;
if ( V_92 )
goto V_97;
if ( F_60 ( V_2 , F_55 ( V_88 ) -> V_30 ,
V_91 . V_68 ) == V_98 ) {
V_90 = F_61 ( V_2 , & V_91 ) ;
if ( F_50 ( V_90 ) )
V_92 = F_58 ( V_90 ) ;
...
V_100 = V_88 -> V_101 ;
F_62 ( V_88 , NULL ) ;
V_92 = F_63 ( V_88 , V_91 . V_38 , V_91 . V_68 ,
...
if ( V_92 )
goto V_97;
V_90 = (struct V_19 * ) F_57 ( V_2 , & V_90 -> V_25 ,
F_48 ( & V_91 ) , NULL ,
V_102 ) ;
if ( ! F_50 ( V_90 ) ) {
F_64 ( & V_20 -> V_25 ) ;
...
void F_66 ( struct V_46 * V_88 , int type , int V_23 , T_3 V_103 )
{
struct V_86 * V_87 ;
int V_104 ;
struct V_48 * V_49 ;
...
if ( F_74 ( V_20 ) &&
V_2 -> V_3 . V_121 )
V_30 = F_75 ( V_2 , F_76 ( V_88 ) ) ;
if ( V_30 )
V_68 = F_77 ( V_30 , 0 , V_122 ) ;
else
V_68 = 0 ;
F_78 () ;
}
...
static void F_82 ( struct V_46 * V_47 , T_1 V_103 )
{
const struct V_86 * V_87 = ( const struct V_86 * ) V_47 -> V_52 ;
const struct V_128 * V_129 ;
int V_113 = V_87 -> V_113 ;
if ( ! F_83 ( V_47 , V_87 -> V_116 * 4 + 8 ) ) {
F_29 ( F_27 ( V_47 -> V_30 ) , V_130 ) ;
return;
}
F_84 ( V_47 , V_113 , V_103 ) ;
V_129 = F_85 ( V_131 [ V_113 ] ) ;
...
struct V_2 * V_2 ;
T_1 V_103 = 0 ;
V_2 = F_27 ( F_55 ( V_47 ) -> V_30 ) ;
if ( ! F_83 ( V_47 , sizeof( struct V_86 ) ) )
goto V_136;
V_53 = F_33 ( V_47 ) ;
...
if ( ! V_2 -> V_3 . V_147 &&
F_60 ( V_2 , V_47 -> V_30 , V_87 -> V_38 ) == V_148 ) {
F_91 ( L_3 ,
& F_44 ( V_47 ) -> V_68 ,
V_53 -> type , V_53 -> V_23 ,
...
F_82 ( V_47 , F_33 ( V_47 ) -> V_125 . V_126 ) ;
return true ;
}
...
return true ;
V_136:
F_29 ( F_27 ( F_55 ( V_47 ) -> V_30 ) , V_130 ) ;
return false ;
}
...
V_161 ) )
goto V_162;
if ( ! F_83 ( V_47 , sizeof( * V_53 ) + sizeof( struct V_86 ) ) )
goto V_162;
V_158 = F_79 ( V_47 ) ;
