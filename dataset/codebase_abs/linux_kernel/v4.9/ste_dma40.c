...
{
int V_179 ;
F_154 ( V_8 , & V_8 -> V_352 , V_8 -> V_353 ,
0 , V_8 -> V_207 ) ;
F_124 ( V_8 -> V_352 . V_238 ) ;
F_125 ( V_240 , V_8 -> V_352 . V_238 ) ;
F_125 ( V_341 , V_8 -> V_352 . V_238 ) ;
F_157 ( V_8 , & V_8 -> V_352 ) ;
V_179 = F_159 ( & V_8 -> V_352 ) ;
if ( V_179 ) {
F_96 ( V_8 -> V_5 , L_46 ) ;
goto exit;
}
F_154 ( V_8 , & V_8 -> V_354 , V_8 -> V_353 ,
V_8 -> V_207 , V_8 -> V_355 ) ;
F_124 ( V_8 -> V_354 . V_238 ) ;
F_125 ( V_239 , V_8 -> V_354 . V_238 ) ;
F_125 ( V_339 , V_8 -> V_354 . V_238 ) ;
F_157 ( V_8 , & V_8 -> V_354 ) ;
V_179 = F_159 ( & V_8 -> V_354 ) ;
if ( V_179 ) {
F_96 ( V_8 -> V_5 ,
L_47 ) ;
goto V_356;
}
F_154 ( V_8 , & V_8 -> V_357 , V_8 -> V_358 ,
0 , V_351 ) ;
F_124 ( V_8 -> V_357 . V_238 ) ;
F_125 ( V_240 , V_8 -> V_357 . V_238 ) ;
F_125 ( V_239 , V_8 -> V_357 . V_238 ) ;
F_125 ( V_339 , V_8 -> V_357 . V_238 ) ;
F_125 ( V_341 , V_8 -> V_352 . V_238 ) ;
F_157 ( V_8 , & V_8 -> V_357 ) ;
...
{
struct V_360 * V_361 = F_162 ( V_5 ) ;
struct V_189 * V_8 = F_163 ( V_361 ) ;
int V_34 ;
V_34 = F_164 ( V_5 ) ;
if ( V_34 )
return V_34 ;
if ( V_8 -> V_362 )
V_34 = F_165 ( V_8 -> V_362 ) ;
return V_34 ;
}
...
int V_34 = 0 ;
if ( V_8 -> V_362 ) {
V_34 = F_167 ( V_8 -> V_362 ) ;
if ( V_34 )
return V_34 ;
}
return F_168 ( V_5 ) ;
}
static void F_169 ( void T_1 * V_363 , T_2 * V_364 ,
T_2 * V_365 , int V_12 , bool V_366 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < V_12 ; V_33 ++ ) {
void T_1 * V_124 = V_363 + V_365 [ V_33 ] ;
if ( V_366 )
V_364 [ V_33 ] = F_170 ( V_124 ) ;
else
F_171 ( V_364 [ V_33 ] , V_124 ) ;
}
}
static void F_172 ( struct V_189 * V_8 , bool V_366 )
{
int V_33 ;
for ( V_33 = 0 ; V_33 < V_8 -> V_208 ; V_33 ++ ) {
void T_1 * V_124 ;
int V_39 ;
if ( V_8 -> V_228 [ V_33 ] . V_367 )
continue;
V_124 = V_8 -> V_9 + V_10 + V_33 * V_13 ;
V_39 = V_33 * F_173 ( V_368 ) ;
F_169 ( V_124 , & V_8 -> V_369 [ V_39 ] ,
V_368 ,
F_173 ( V_368 ) ,
V_366 ) ;
}
F_169 ( V_8 -> V_9 , V_8 -> V_370 ,
V_371 , F_173 ( V_371 ) ,
V_366 ) ;
if ( V_8 -> V_191 . V_364 )
F_169 ( V_8 -> V_9 , V_8 -> V_372 ,
V_8 -> V_191 . V_364 ,
V_8 -> V_191 . V_373 ,
V_366 ) ;
}
...
int V_378 = - 2 ;
int V_379 = V_380 ;
V_134 [ 0 ] = F_53 ( V_8 -> V_9 + V_381 ) ;
V_134 [ 1 ] = F_53 ( V_8 -> V_9 + V_382 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_208 ; V_33 ++ ) {
V_8 -> V_228 [ V_33 ] . V_12 = V_33 ;
V_378 += 2 * ( ( V_33 % 2 ) == 0 ) ;
if ( ( ( V_134 [ V_33 % 2 ] >> V_378 ) & 3 ) == 1 ) {
V_8 -> V_228 [ V_33 ] . V_215 = V_218 ;
V_8 -> V_228 [ V_33 ] . V_216 = V_218 ;
V_8 -> V_228 [ V_33 ] . V_367 = true ;
V_379 |= F_177 ( F_178 ( V_33 ) ,
V_383 ) ;
V_379 |= F_177 ( F_178 ( V_33 ) ,
V_384 ) ;
} else {
...
V_8 -> V_228 [ V_33 ] . V_367 = false ;
V_377 ++ ;
}
F_155 ( & V_8 -> V_228 [ V_33 ] . V_37 ) ;
}
for ( V_33 = 0 ; V_8 -> V_74 -> V_385 [ V_33 ] != - 1 ; V_33 ++ ) {
int V_4 = V_8 -> V_74 -> V_385 [ V_33 ] ;
V_8 -> V_228 [ V_4 ] . V_215 = V_218 ;
V_8 -> V_228 [ V_4 ] . V_216 = V_218 ;
V_8 -> V_228 [ V_4 ] . V_367 = true ;
V_379 |= F_177 ( F_178 ( V_4 ) ,
V_383 ) ;
V_379 |= F_177 ( F_178 ( V_4 ) ,
V_384 ) ;
V_377 -- ;
}
for ( V_33 = 0 ; V_33 < V_8 -> V_74 -> V_386 ; V_33 ++ ) {
int V_4 = V_8 -> V_74 -> V_387 [ V_33 ] ;
V_8 -> V_228 [ V_4 ] . V_76 = true ;
}
F_179 ( V_8 -> V_5 , L_49 ,
V_377 , V_8 -> V_208 ) ;
V_134 [ 0 ] = F_53 ( V_8 -> V_9 + V_388 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_208 ; V_33 ++ ) {
...
F_30 ( V_376 , V_8 -> V_9 + V_375 ) ;
V_8 -> V_374 = V_379 ;
return V_377 ;
}
static struct V_189 * T_8 F_180 ( struct V_360 * V_361 )
{
struct V_389 * V_74 = F_181 ( & V_361 -> V_5 ) ;
struct V_390 * V_390 ;
void T_1 * V_9 ;
struct V_391 * V_174 ;
struct V_189 * V_8 ;
...
V_174 = F_185 ( V_361 , V_397 , L_53 ) ;
if ( ! V_174 )
goto V_396;
if ( F_186 ( V_174 -> V_398 , F_187 ( V_174 ) ,
V_399 L_54 ) == NULL )
goto V_400;
V_9 = F_188 ( V_174 -> V_398 , F_187 ( V_174 ) ) ;
if ( ! V_9 )
goto V_400;
for ( V_393 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_393 |= ( F_53 ( V_9 + F_187 ( V_174 ) - 0x20 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
for ( V_394 = 0 , V_33 = 0 ; V_33 < 4 ; V_33 ++ )
V_394 |= ( F_53 ( V_9 + F_187 ( V_174 ) - 0x10 + 4 * V_33 )
& 255 ) << ( V_33 * 8 ) ;
if ( V_394 != V_401 ) {
F_96 ( & V_361 -> V_5 , L_55 ) ;
goto V_402;
}
if ( F_189 ( V_393 ) != V_403 ) {
F_96 ( & V_361 -> V_5 , L_56 ,
F_189 ( V_393 ) ,
V_403 ) ;
goto V_402;
...
V_281 = F_190 ( V_393 ) ;
if ( V_281 < 2 ) {
F_96 ( & V_361 -> V_5 , L_57 , V_281 ) ;
goto V_402;
}
if ( V_74 -> V_404 )
V_208 = V_74 -> V_404 ;
else
V_208 = 4 * ( F_53 ( V_9 + V_405 ) & 0x7 ) + 4 ;
if ( V_74 -> V_406 )
V_355 = V_74 -> V_406 ;
else
V_355 = F_173 ( V_242 ) ;
...
V_8 -> V_208 = V_208 ;
V_8 -> V_207 = V_207 ;
V_8 -> V_409 = V_174 -> V_398 ;
V_8 -> V_410 = F_187 ( V_174 ) ;
V_8 -> V_9 = V_9 ;
V_8 -> V_74 = V_74 ;
V_8 -> V_5 = & V_361 -> V_5 ;
V_8 -> V_358 = ( ( void * ) V_8 ) + F_47 ( sizeof( struct V_189 ) , 4 ) ;
V_8 -> V_353 = & V_8 -> V_358 [ V_208 ] ;
if ( V_8 -> V_74 -> V_404 == 14 ) {
V_8 -> V_191 . V_364 = V_411 ;
V_8 -> V_191 . V_373 = V_412 ;
V_8 -> V_191 . V_413 = V_414 ;
V_8 -> V_191 . V_415 = V_416 ;
V_8 -> V_191 . V_277 = V_417 ;
V_8 -> V_191 . V_278 = V_418 ;
V_8 -> V_191 . V_279 = V_419 ;
V_8 -> V_191 . V_280 = V_420 ;
V_8 -> V_191 . V_194 = V_421 ;
V_8 -> V_191 . V_192 = F_173 ( V_421 ) ;
V_8 -> V_191 . V_422 = V_423 ;
V_8 -> V_191 . V_424 = F_173 ( V_423 ) ;
} else {
if ( V_8 -> V_281 >= 3 ) {
V_8 -> V_191 . V_364 = V_425 ;
V_8 -> V_191 . V_373 = V_426 ;
}
V_8 -> V_191 . V_413 = V_427 ;
V_8 -> V_191 . V_415 = V_428 ;
V_8 -> V_191 . V_277 = V_429 ;
V_8 -> V_191 . V_278 = V_430 ;
V_8 -> V_191 . V_279 = V_431 ;
V_8 -> V_191 . V_280 = V_432 ;
V_8 -> V_191 . V_194 = V_433 ;
V_8 -> V_191 . V_192 = F_173 ( V_433 ) ;
V_8 -> V_191 . V_422 = V_434 ;
V_8 -> V_191 . V_424 = F_173 ( V_434 ) ;
}
...
if ( ! V_8 -> V_36 . V_40 )
goto V_439;
V_8 -> V_48 = F_193 ( V_399 , sizeof( struct V_14 ) ,
0 , V_440 ,
NULL ) ;
if ( V_8 -> V_48 == NULL )
goto V_441;
...
int V_33 ;
T_2 V_442 [ 2 ] = { 0 , 0 } ;
T_2 V_443 [ 2 ] = { 0xFFFFFFFF , 0xFFFFFFFF } ;
T_2 V_444 = 0 ;
T_2 V_445 = 0 ;
struct V_446 * V_447 = V_8 -> V_191 . V_422 ;
T_2 V_448 = V_8 -> V_191 . V_424 ;
for ( V_33 = 0 ; V_33 < V_448 ; V_33 ++ )
F_30 ( V_447 [ V_33 ] . V_134 ,
V_8 -> V_9 + V_447 [ V_33 ] . V_123 ) ;
for ( V_33 = 0 ; V_33 < V_8 -> V_208 ; V_33 ++ ) {
V_443 [ V_33 % 2 ] = V_443 [ V_33 % 2 ] << 2 ;
...
F_30 ( V_442 [ 1 ] , V_8 -> V_9 + V_154 ) ;
F_30 ( V_442 [ 0 ] , V_8 -> V_9 + V_449 ) ;
F_30 ( V_443 [ 1 ] , V_8 -> V_9 + V_112 ) ;
F_30 ( V_443 [ 0 ] , V_8 -> V_9 + V_113 ) ;
F_30 ( V_444 , V_8 -> V_9 + V_8 -> V_191 . V_413 ) ;
F_30 ( V_445 , V_8 -> V_9 + V_8 -> V_191 . V_415 ) ;
V_8 -> V_191 . V_422 = NULL ;
V_8 -> V_191 . V_424 = 0 ;
}
...
if ( ! V_450 )
return - V_25 ;
V_8 -> V_36 . V_452 = V_453 * V_8 -> V_208 / V_454 ;
for ( V_33 = 0 ; V_33 < V_451 ; V_33 ++ ) {
V_450 [ V_33 ] = F_200 ( V_408 ,
V_8 -> V_36 . V_452 ) ;
if ( ! V_450 [ V_33 ] ) {
F_96 ( V_8 -> V_5 , L_59 ,
V_8 -> V_36 . V_452 ) ;
...
F_201 ( V_450 [ V_227 ] , V_8 -> V_36 . V_452 ) ;
goto V_455;
}
if ( ( F_114 ( ( void * ) V_450 [ V_33 ] ) &
( V_456 - 1 ) ) == 0 )
break;
}
for ( V_227 = 0 ; V_227 < V_33 ; V_227 ++ )
F_201 ( V_450 [ V_227 ] , V_8 -> V_36 . V_452 ) ;
if ( V_33 < V_451 ) {
V_8 -> V_36 . V_8 = ( void * ) V_450 [ V_33 ] ;
} else {
F_202 ( V_8 -> V_5 ,
L_60 ,
V_129 , V_8 -> V_36 . V_452 ) ;
V_8 -> V_36 . V_457 = F_6 ( V_453 *
V_8 -> V_208 +
V_456 ,
V_408 ) ;
if ( ! V_8 -> V_36 . V_457 ) {
...
V_8 -> V_36 . V_8 = F_7 ( V_8 -> V_36 . V_457 ,
V_456 ) ;
}
...
static int T_8 F_203 ( struct V_360 * V_361 ,
struct V_334 * V_459 )
{
struct V_389 * V_460 ;
int V_461 = 0 , V_462 = 0 , V_463 = 0 ;
const T_10 * V_464 ;
V_460 = F_204 ( & V_361 -> V_5 , sizeof( * V_460 ) , V_408 ) ;
if ( ! V_460 )
return - V_25 ;
F_205 ( V_459 , L_61 , & V_461 ) ;
if ( V_461 > 0 )
V_460 -> V_404 = V_461 ;
V_464 = F_206 ( V_459 , L_62 , & V_462 ) ;
V_462 /= sizeof( * V_464 ) ;
if ( V_462 > V_465 || V_462 <= 0 ) {
F_96 ( & V_361 -> V_5 ,
L_63 ,
V_462 ) ;
return - V_35 ;
...
V_242 ,
V_462 ) ;
V_464 = F_206 ( V_459 , L_64 , & V_463 ) ;
V_463 /= sizeof( * V_464 ) ;
if ( V_463 >= V_466 || V_463 < 0 ) {
F_96 ( & V_361 -> V_5 ,
L_65 ,
V_463 ) ;
return - V_35 ;
...
V_463 ) ;
V_460 -> V_385 [ V_463 ] = - 1 ;
V_361 -> V_5 . V_467 = V_460 ;
return 0 ;
}
static int T_8 F_208 ( struct V_360 * V_361 )
{
struct V_389 * V_74 = F_181 ( & V_361 -> V_5 ) ;
struct V_334 * V_459 = V_361 -> V_5 . V_468 ;
int V_34 = - V_469 ;
struct V_189 * V_8 ;
struct V_391 * V_174 ;
int V_351 ;
...
F_155 ( & V_8 -> V_195 ) ;
F_155 ( & V_8 -> V_111 ) ;
V_174 = F_185 ( V_361 , V_397 , L_67 ) ;
if ( ! V_174 ) {
V_34 = - V_469 ;
F_96 ( & V_361 -> V_5 , L_68 ) ;
goto V_471;
}
V_8 -> V_472 = F_187 ( V_174 ) ;
V_8 -> V_473 = V_174 -> V_398 ;
if ( F_186 ( V_174 -> V_398 , F_187 ( V_174 ) ,
V_399 L_69 ) == NULL ) {
V_34 = - V_117 ;
F_96 ( & V_361 -> V_5 , L_70 , V_174 ) ;
goto V_471;
}
V_134 = F_53 ( V_8 -> V_9 + V_474 ) ;
if ( V_174 -> V_398 != V_134 && V_134 != 0 ) {
F_202 ( & V_361 -> V_5 ,
L_71 ,
V_129 , V_134 , & V_174 -> V_398 ) ;
} else
F_30 ( V_174 -> V_398 , V_8 -> V_9 + V_474 ) ;
V_8 -> V_289 = F_188 ( V_174 -> V_398 , F_187 ( V_174 ) ) ;
if ( ! V_8 -> V_289 ) {
V_34 = - V_25 ;
F_96 ( & V_361 -> V_5 , L_72 ) ;
goto V_471;
...
V_8 -> V_36 . V_8 = F_188 ( V_174 -> V_398 ,
F_187 ( V_174 ) ) ;
if ( ! V_8 -> V_36 . V_8 ) {
V_34 = - V_25 ;
F_96 ( & V_361 -> V_5 , L_75 ) ;
...
F_30 ( V_174 -> V_398 , V_8 -> V_9 + V_458 ) ;
} else {
V_34 = F_199 ( V_8 ) ;
if ( V_34 ) {
F_96 ( & V_361 -> V_5 , L_76 ) ;
...
F_155 ( & V_8 -> V_36 . V_37 ) ;
V_8 -> V_187 = F_210 ( V_361 , 0 ) ;
V_34 = F_211 ( V_8 -> V_187 , F_92 , 0 , V_399 , V_8 ) ;
if ( V_34 ) {
F_96 ( & V_361 -> V_5 , L_77 ) ;
goto V_471;
}
if ( V_8 -> V_74 -> V_73 ) {
V_8 -> V_362 = F_212 ( V_8 -> V_5 , L_73 ) ;
if ( F_183 ( V_8 -> V_362 ) ) {
F_96 ( & V_361 -> V_5 , L_78 ) ;
V_34 = F_213 ( V_8 -> V_362 ) ;
V_8 -> V_362 = NULL ;
goto V_471;
}
V_34 = F_167 ( V_8 -> V_362 ) ;
...
F_218 ( V_8 -> V_5 ) ;
F_219 ( V_8 -> V_5 ) ;
V_34 = F_158 ( V_8 , V_351 ) ;
if ( V_34 )
goto V_471;
V_8 -> V_5 -> V_476 = & V_8 -> V_476 ;
...
V_453 * V_8 -> V_208 ,
V_31 ) ;
if ( ! V_8 -> V_36 . V_457 && V_8 -> V_36 . V_8 )
