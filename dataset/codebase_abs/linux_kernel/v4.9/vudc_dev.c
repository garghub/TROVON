...
V_7 -> V_7 . V_57 . V_93 = true ;
V_7 -> V_7 . V_57 . V_94 = true ;
} else {
V_7 -> V_7 . V_57 . V_95 = true ;
...
V_47 -> V_16 = V_80 ;
V_47 -> V_107 = V_108 ;
V_47 -> V_109 . V_110 = F_52 ;
V_47 -> V_109 . V_111 = F_58 ;
V_47 -> V_109 . V_112 = F_60 ;
V_10 -> V_40 . V_113 = & V_10 -> V_7 [ 0 ] . V_7 ;
F_12 ( & V_10 -> V_7 [ 0 ] . V_7 . V_89 ) ;
F_70 ( V_10 ) ;
return 0 ;
V_88:
return - V_114 ;
...
goto V_85;
V_10 -> V_40 . V_92 = V_87 ;
V_10 -> V_40 . V_98 = & V_116 ;
V_10 -> V_40 . V_44 = V_42 ;
V_10 -> V_40 . V_46 . V_117 = & V_74 -> V_46 ;
V_10 -> V_74 = V_74 ;
V_37 = F_65 ( V_10 ) ;
if ( V_37 )
goto V_118;
...
if ( V_37 < 0 )
goto V_119;
V_37 = F_74 ( & V_74 -> V_46 . V_120 , & V_121 ) ;
if ( V_37 ) {
...
int F_77 ( struct V_115 * V_74 )
{
struct V_9 * V_10 = F_78 ( V_74 ) ;
F_79 ( & V_74 -> V_46 . V_120 , & V_121 ) ;
F_76 ( & V_10 -> V_40 ) ;
F_71 ( V_10 ) ;
F_2 ( V_10 ) ;
return 0 ;
