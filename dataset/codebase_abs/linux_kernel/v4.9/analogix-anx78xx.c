...
static T_3 F_78 ( int V_207 , void * V_208 )
{
...
static int F_79 ( struct V_1 * V_1 , T_1 V_207 )
{
int V_12 ;
F_44 ( L_37 , V_207 ) ;
...
static bool F_80 ( struct V_1 * V_1 , T_1 V_207 )
{
bool V_211 = false ;
int V_12 ;
F_44 ( L_39 , V_207 ) ;
...
static void F_82 ( struct V_1 * V_1 , T_1 V_207 )
{
unsigned int V_11 ;
int V_12 ;
F_44 ( L_43 , V_207 ) ;
...
static T_3 F_83 ( int V_217 , void * V_208 )
{
struct V_1 * V_1 = V_208 ;
bool V_211 = false ;
unsigned int V_207 ;
...
if ( V_1 -> V_219 [ V_218 ] )
F_86 ( V_1 -> V_219 [ V_218 ] ) ;
}
static int F_87 ( struct V_220 * V_144 ,
...
bool V_226 = false ;
int V_12 ;
V_1 = F_88 ( & V_144 -> V_143 , sizeof( * V_1 ) , V_227 ) ;
if ( ! V_1 )
return - V_228 ;
V_129 = & V_1 -> V_129 ;
F_89 ( & V_1 -> V_186 ) ;
...
V_1 -> V_219 [ V_218 ] = F_93 ( V_144 -> V_234 ,
V_235 [ V_218 ] >> 1 ) ;
if ( ! V_1 -> V_219 [ V_218 ] ) {
V_12 = - V_228 ;
F_12 ( L_56 ,
...
V_1 -> V_8 [ V_218 ] = F_94 ( V_1 -> V_219 [ V_218 ] ,
& V_237 ) ;
...
V_12 = F_96 ( & V_144 -> V_143 , V_129 -> V_231 , NULL ,
F_78 ,
V_243 | V_244 ,
L_60 , V_1 ) ;
if ( V_12 ) {
...
V_12 = F_96 ( & V_144 -> V_143 , V_129 -> V_232 , NULL ,
F_83 ,
V_243 | V_244 ,
L_62 , V_1 ) ;
if ( V_12 ) {
...
static int F_98 ( struct V_220 * V_144 )
{
