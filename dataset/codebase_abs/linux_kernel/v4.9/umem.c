...
V_4 -> V_51 = NULL ;
V_4 -> V_52 = 1 ;
V_21 = (struct V_8 * * ) F_16 ( V_37 ) ;
if ( ! V_21 ) {
F_15 ( V_4 ) ;
return F_9 ( - V_38 ) ;
}
V_23 = (struct V_22 * * ) F_16 ( V_37 ) ;
if ( ! V_23 )
V_4 -> V_52 = 0 ;
V_27 = F_17 ( V_4 ) ;
F_18 ( & V_44 -> V_53 -> V_54 ) ;
V_24 = V_27 + V_44 -> V_53 -> V_55 ;
V_25 = F_19 ( V_56 ) >> V_57 ;
if ( ( V_24 > V_25 ) && ! F_20 ( V_58 ) ) {
V_28 = - V_38 ;
goto V_59;
}
V_26 = V_17 & V_60 ;
...
V_4 -> V_52 = 0 ;
F_25 ( V_7 , V_21 [ V_9 ] , V_42 , 0 ) ;
}
V_30 = V_7 ;
}
V_4 -> V_10 = F_26 ( V_16 -> V_63 ,
V_4 -> V_11 . V_12 ,
V_4 -> V_27 ,
V_13 ,
V_29 ) ;
