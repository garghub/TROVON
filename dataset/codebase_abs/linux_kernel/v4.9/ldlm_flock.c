...
void F_48 ( const T_2 * V_110 ,
T_3 * V_111 )
{
memset ( V_111 , 0 , sizeof( * V_111 ) ) ;
V_111 -> V_5 . V_8 = V_110 -> V_5 . V_112 ;
V_111 -> V_5 . V_9 = V_110 -> V_5 . V_113 ;
V_111 -> V_5 . V_41 = V_110 -> V_5 . V_114 ;
V_111 -> V_5 . V_6 = V_110 -> V_5 . V_114 ;
}
void F_49 ( const T_2 * V_110 ,
T_3 * V_111 )
{
memset ( V_111 , 0 , sizeof( * V_111 ) ) ;
V_111 -> V_5 . V_8 = V_110 -> V_5 . V_112 ;
V_111 -> V_5 . V_9 = V_110 -> V_5 . V_113 ;
V_111 -> V_5 . V_41 = V_110 -> V_5 . V_114 ;
V_111 -> V_5 . V_6 = V_110 -> V_5 . V_115 ;
}
void F_50 ( const T_3 * V_111 ,
T_2 * V_110 )
{
memset ( V_110 , 0 , sizeof( * V_110 ) ) ;
V_110 -> V_5 . V_112 = V_111 -> V_5 . V_8 ;
V_110 -> V_5 . V_113 = V_111 -> V_5 . V_9 ;
V_110 -> V_5 . V_114 = V_111 -> V_5 . V_41 ;
V_110 -> V_5 . V_115 = V_111 -> V_5 . V_6 ;
}
