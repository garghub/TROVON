...
+ F_50 ( sizeof( V_115 ) ) ;
if ( V_75 -> V_118 . V_119 )
V_94 += F_50 ( sizeof( struct V_120 ) ) ;
V_94 += F_47 ( V_37 ) ;
if ( V_37 -> V_77 . V_121 <= V_122 ||
( V_37 -> V_77 . V_121 == V_123 && V_75 -> V_59 == NULL ) )
V_49 = ! F_60 ( V_75 ) ;
else
V_49 = false ;
V_107 = V_37 -> V_77 . V_124 ;
switch ( (enum V_125 ) F_61 ( V_35 -> V_25 ) ) {
case V_126 :
case V_26 :
break;
case V_127 :
...
if ( V_35 -> V_50 & V_129 ) {
if ( V_114 != NULL ) {
V_109 = V_114 -> V_130 ( V_75 , & V_112 ) ;
if ( V_109 != NULL )
V_94 += V_114 -> V_131 ( V_109 ) ;
}
}
if ( V_35 -> V_50 & V_132 ) {
...
* V_93 = F_37 ( V_37 -> V_40 ) ;
V_14 = F_86 ( V_178 , V_2 , V_35 -> V_20 , V_186 ) ;
if ( V_14 < 0 ) {
if ( V_35 -> V_50 & V_182 ) {
V_180 = 1 ;
V_14 = 0 ;
...
static struct V_36 *
F_87 ( struct V_36 * V_190 )
{
struct V_36 * V_37 = F_88 ( V_190 , V_190 -> V_94 , V_18 ) ;
if ( V_37 )
F_89 ( V_37 ) ;
return V_37 ;
}
...
static int
F_97 ( struct V_36 * V_37 , unsigned int V_195 )
{
unsigned int V_196 ;
struct V_6 * V_35 ;
...
static int
F_100 ( void * V_43 , int V_95 , struct V_36 * V_190 , int V_205 )
{
struct V_46 * V_178 ;
if ( V_205 < 0 ) {
if ( F_101 ( V_190 -> V_57 , V_95 ) )
return - V_19 ;
} else if ( V_205 > 0 ) {
if ( V_95 > 0xFFFF )
return - V_199 ;
if ( V_205 > F_79 ( V_190 -> V_57 ) ) {
V_178 = F_102 ( V_190 -> V_57 , F_103 ( V_190 -> V_57 ) ,
V_205 , V_18 ) ;
if ( ! V_178 ) {
F_104 ( V_206 L_3
L_4 ) ;
...
if ( ! F_105 ( V_190 -> V_57 , V_95 ) )
return - V_19 ;
F_106 ( V_190 -> V_57 , V_43 , V_95 ) ;
...
static int
F_108 ( struct V_36 * V_37 , unsigned long V_146 )
{
if ( V_37 -> V_77 . V_144 )
if ( V_37 -> V_77 . V_144 -> V_146 == V_146 )
return 1 ;
if ( V_37 -> V_77 . V_124 )
if ( V_37 -> V_77 . V_124 -> V_146 == V_146 )
return 1 ;
#if F_45 ( V_116 )
if ( V_37 -> V_57 -> V_191 ) {
int V_150 , V_153 ;
...
static void
F_109 ( struct V_2 * V_2 , int V_146 )
{
int V_41 ;
struct V_1 * V_7 = F_1 ( V_2 ) ;
F_110 () ;
...
F_5 (inst, head, hlist)
F_18 ( V_10 , F_108 , V_146 ) ;
}
F_111 () ;
}
static int
F_112 ( struct V_211 * V_212 ,
unsigned long V_213 , void * V_214 )
{
struct V_105 * V_149 = F_113 ( V_214 ) ;
if ( V_213 == V_215 )
F_109 ( F_114 ( V_149 ) , V_149 -> V_146 ) ;
return V_216 ;
}
static int F_115 ( struct V_36 * V_37 , unsigned long V_217 )
{
return F_116 ( V_37 -> V_77 . V_218 ) ==
(struct V_219 * ) V_217 ;
}
static void F_117 ( struct V_2 * V_2 ,
const struct V_219 * V_121 )
{
struct V_1 * V_7 = F_1 ( V_2 ) ;
int V_41 ;
F_110 () ;
...
struct V_8 * V_9 = & V_7 -> V_11 [ V_41 ] ;
F_5 (inst, head, hlist)
F_18 ( V_10 , F_115 , ( unsigned long ) V_121 ) ;
}
F_111 () ;
}
static int
...
unsigned long V_213 , void * V_214 )
{
struct V_220 * V_221 = V_214 ;
struct V_1 * V_7 = F_1 ( V_221 -> V_2 ) ;
if ( V_213 == V_222 && V_221 -> V_142 == V_223 ) {
int V_41 ;
F_7 ( & V_7 -> V_15 ) ;
for ( V_41 = 0 ; V_41 < V_5 ; V_41 ++ ) {
struct V_224 * V_225 ;
...
static struct V_6 *
F_120 ( struct V_1 * V_7 , T_8 V_4 , T_3 V_226 )
{
struct V_6 * V_35 ;
V_35 = F_4 ( V_7 , V_4 ) ;
if ( ! V_35 )
...
static struct V_229 *
F_121 ( const struct V_83 * const V_230 [] )
{
struct V_229 * V_231 ;
unsigned int V_232 ;
if ( ! V_230 [ V_233 ] )
return NULL ;
V_231 = F_72 ( V_230 [ V_233 ] ) ;
V_232 = F_122 ( V_231 -> V_232 ) & V_234 ;
if ( V_232 > V_235 || V_232 == V_236 )
return NULL ;
return V_231 ;
}
static int F_123 ( unsigned int V_40 , unsigned int V_237 )
{
return ( int ) ( V_40 - V_237 ) > 0 ;
}
static int F_124 ( struct V_2 * V_2 , struct V_58 * V_238 ,
struct V_46 * V_57 ,
const struct V_101 * V_102 ,
const struct V_83 * const V_230 [] )
{
struct V_103 * V_104 = F_70 ( V_102 ) ;
struct V_36 * V_37 , * V_239 ;
unsigned int V_232 , V_240 ;
struct V_229 * V_231 ;
struct V_6 * V_35 ;
F_125 ( V_241 ) ;
...
if ( ! V_231 )
return - V_199 ;
V_232 = F_122 ( V_231 -> V_232 ) ;
V_240 = F_122 ( V_231 -> V_40 ) ;
F_29 ( & V_35 -> V_27 ) ;
F_32 (entry, tmp, &queue->queue_list, list) {
if ( F_123 ( V_37 -> V_40 , V_240 ) )
break;
F_26 ( V_35 , V_37 ) ;
F_25 ( & V_37 -> V_38 , & V_241 ) ;
}
F_31 ( & V_35 -> V_27 ) ;
if ( F_130 ( & V_241 ) )
return - V_242 ;
...
if ( V_230 [ V_155 ] )
V_37 -> V_57 -> V_154 = F_122 ( F_131 ( V_230 [ V_155 ] ) ) ;
F_33 ( V_37 , V_232 ) ;
}
return 0 ;
}
...
{
struct V_108 * V_109 ;
V_109 = V_114 -> V_130 ( V_37 -> V_57 , V_112 ) ;
if ( V_109 == NULL )
return NULL ;
if ( V_114 -> V_243 ( V_230 [ V_171 ] , V_109 ) < 0 )
return NULL ;
if ( V_230 [ V_244 ] )
V_114 -> V_245 ( V_230 [ V_244 ] , V_109 ,
...
{
if ( V_230 [ V_85 ] ) {
struct V_83 * V_246 [ V_247 + 1 ] ;
int V_14 ;
V_14 = F_135 ( V_246 , V_247 , V_230 [ V_85 ] ,
V_248 ) ;
if ( V_14 < 0 )
return V_14 ;
if ( ! V_246 [ V_87 ] || ! V_246 [ V_89 ] )
return - V_199 ;
V_37 -> V_57 -> V_88 = F_126 ( F_136 ( V_246 [ V_87 ] ) ) ;
V_37 -> V_57 -> V_90 = F_136 ( V_246 [ V_89 ] ) ;
}
if ( V_230 [ V_92 ] ) {
int V_249 = V_37 -> V_57 -> V_81 -
V_37 -> V_57 -> V_82 ;
if ( V_249 != V_176 ( V_230 [ V_92 ] ) )
return - V_199 ;
else if ( V_249 > 0 )
...
static int F_137 ( struct V_2 * V_2 , struct V_58 * V_238 ,
struct V_46 * V_57 ,
const struct V_101 * V_102 ,
const struct V_83 * const V_230 [] )
{
...
return - V_199 ;
V_232 = F_122 ( V_231 -> V_232 ) ;
V_37 = F_28 ( V_35 , F_122 ( V_231 -> V_40 ) ) ;
if ( V_37 == NULL )
return - V_242 ;
V_114 = F_65 ( V_113 ) ;
if ( V_230 [ V_171 ] ) {
if ( V_114 != NULL )
V_109 = F_132 ( V_114 , V_102 , V_230 , V_37 , & V_112 ) ;
}
if ( V_37 -> V_77 . V_78 == V_79 ) {
V_14 = F_134 ( V_37 , V_230 ) ;
if ( V_14 < 0 )
return V_14 ;
}
if ( V_230 [ V_175 ] ) {
T_8 V_250 = V_176 ( V_230 [ V_175 ] ) ;
int V_205 = V_250 - V_37 -> V_57 -> V_91 ;
if ( F_100 ( F_72 ( V_230 [ V_175 ] ) ,
V_250 , V_37 , V_205 ) < 0 )
V_232 = V_45 ;
if ( V_109 && V_205 )
V_114 -> V_251 ( V_37 -> V_57 , V_109 , V_112 , V_205 ) ;
}
if ( V_230 [ V_155 ] )
V_37 -> V_57 -> V_154 = F_122 ( F_131 ( V_230 [ V_155 ] ) ) ;
F_33 ( V_37 , V_232 ) ;
...
static int F_138 ( struct V_2 * V_2 , struct V_58 * V_238 ,
struct V_46 * V_57 , const struct V_101 * V_102 ,
const struct V_83 * const V_230 [] )
{
return - V_252 ;
}
static int F_139 ( struct V_2 * V_2 , struct V_58 * V_238 ,
struct V_46 * V_57 , const struct V_101 * V_102 ,
const struct V_83 * const V_230 [] )
{
struct V_103 * V_104 = F_70 ( V_102 ) ;
...
V_50 = F_122 ( F_131 ( V_230 [ V_260 ] ) ) ;
V_255 = F_122 ( F_131 ( V_230 [ V_261 ] ) ) ;
if ( V_50 >= V_262 )
return - V_263 ;
#if ! F_45 ( V_73 )
if ( V_50 & V_255 & V_133 )
...
struct V_268 * V_269 =
F_72 ( V_230 [ V_267 ] ) ;
F_107 ( V_35 , V_269 -> V_25 ,
F_122 ( V_269 -> V_23 ) ) ;
}
if ( V_230 [ V_270 ] ) {
T_6 * V_21 = F_72 ( V_230 [ V_270 ] ) ;
F_29 ( & V_35 -> V_27 ) ;
...
static struct V_224 * F_144 ( struct V_271 * V_272 )
{
struct V_273 * V_274 = V_272 -> V_275 ;
struct V_2 * V_2 ;
struct V_1 * V_7 ;
if ( ! V_274 )
return NULL ;
V_2 = F_145 ( V_272 ) ;
V_7 = F_1 ( V_2 ) ;
for ( V_274 -> V_276 = 0 ; V_274 -> V_276 < V_5 ; V_274 -> V_276 ++ ) {
if ( ! F_146 ( & V_7 -> V_11 [ V_274 -> V_276 ] ) )
return V_7 -> V_11 [ V_274 -> V_276 ] . V_277 ;
}
return NULL ;
}
static struct V_224 * F_147 ( struct V_271 * V_272 , struct V_224 * V_13 )
{
struct V_273 * V_274 = V_272 -> V_275 ;
struct V_2 * V_2 = F_145 ( V_272 ) ;
V_13 = V_13 -> V_44 ;
while ( ! V_13 ) {
struct V_1 * V_7 ;
if ( ++ V_274 -> V_276 >= V_5 )
return NULL ;
V_7 = F_1 ( V_2 ) ;
V_13 = V_7 -> V_11 [ V_274 -> V_276 ] . V_277 ;
}
return V_13 ;
}
static struct V_224 * F_148 ( struct V_271 * V_272 , T_9 V_278 )
{
struct V_224 * V_9 ;
V_9 = F_144 ( V_272 ) ;
if ( V_9 )
while ( V_278 && ( V_9 = F_147 ( V_272 , V_9 ) ) )
V_278 -- ;
return V_278 ? NULL : V_9 ;
}
static void * F_149 ( struct V_271 * V_279 , T_9 * V_278 )
__acquires( nfnl_queue_pernet( seq_file_net( V_279 )
static void * F_150 ( struct V_271 * V_279 , void * V_280 , T_9 * V_278 )
{
( * V_278 ) ++ ;
return F_147 ( V_279 , V_280 ) ;
}
static void F_151 ( struct V_271 * V_279 , void * V_280 )
__releases( nfnl_queue_pernet( seq_file_net( V_279 )
static int F_152 ( struct V_271 * V_279 , void * V_280 )
{
const struct V_6 * V_10 = V_280 ;
F_153 ( V_279 , L_6 ,
V_10 -> V_4 ,
V_10 -> V_20 , V_10 -> V_39 ,
V_10 -> V_25 , V_10 -> V_23 ,
...
static int F_154 ( struct V_281 * V_281 , struct V_63 * V_63 )
{
return F_155 ( V_281 , V_63 , & V_282 ,
sizeof( struct V_273 ) ) ;
}
...
F_162 ( V_2 ) ;
#ifdef F_158
F_163 ( L_7 , V_2 -> V_283 . V_284 ) ;
#endif
}
static void F_164 ( struct V_287 * V_288 )
{
F_165 () ;
}
