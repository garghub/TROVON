...
{
struct V_94 * V_95 = F_59 ( & V_93 -> V_96 ) ;
struct V_1 * V_2 ;
struct V_97 * V_98 ;
struct V_97 * V_99 ;
int V_100 = V_93 -> V_101 ;
int V_72 ;
if ( V_100 == - 1 ) {
for ( V_100 = 0 ; V_100 < V_89 ; V_100 ++ )
if ( V_83 [ V_100 ] . V_2 . V_102 == 0 )
break;
}
if ( V_100 < 0 || V_100 >= V_89 )
return - V_77 ;
V_2 = & V_83 [ V_100 ] . V_2 ;
V_98 = F_60 ( V_93 , V_103 , 0 ) ;
if ( V_98 )
V_2 -> V_102 = V_98 -> V_104 ;
else if ( V_95 )
V_2 -> V_102 = V_95 -> V_102 ;
else
return - V_77 ;
V_99 = F_60 ( V_93 , V_105 , 0 ) ;
if ( V_99 )
V_2 -> V_66 = V_99 -> V_104 ;
else if ( V_95 )
V_2 -> V_66 = V_95 -> V_66 ;
...
V_72 = F_61 ( V_93 -> V_96 . V_106 , L_4 ,
& V_2 -> V_30 ) ;
if ( V_72 )
return V_72 ;
}
V_2 -> V_4 = F_62 ( V_2 -> V_102 , V_107 ) ;
if ( ! V_2 -> V_4 )
return - V_108 ;
if ( V_95 )
V_2 -> V_5 = V_95 -> V_109 ;
