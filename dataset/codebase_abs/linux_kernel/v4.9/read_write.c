...
V_36 = - V_81 ;
if ( V_119 -> V_30 -> V_126 )
V_36 = V_119 -> V_30 -> V_126 ( V_117 , V_118 , V_119 ,
V_120 , V_54 , V_77 ) ;
if ( V_36 == - V_81 )
...
return - V_6 ;
if ( F_24 ( V_17 -> V_47 && F_25 ( V_17 ) ) ) {
T_1 V_127 = V_54 ? V_45 + V_54 - 1 : V_24 ;
int V_26 ;
V_26 = F_26 ( V_17 , V_1 , V_45 , V_127 ,
V_68 ? V_49 : V_48 ) ;
if ( V_26 < 0 )
return V_26 ;
}
...
int F_91 ( struct V_1 * V_117 , T_1 V_118 ,
...
int V_36 ;
if ( V_121 -> V_20 != V_122 -> V_20 ||
V_117 -> V_128 . V_129 != V_119 -> V_128 . V_129 )
return - V_125 ;
if ( F_92 ( V_121 -> V_130 ) || F_92 ( V_122 -> V_130 ) )
return - V_131 ;
if ( ! F_93 ( V_121 -> V_130 ) || ! F_93 ( V_122 -> V_130 ) )
return - V_6 ;
if ( ! ( V_117 -> V_2 & V_60 ) ||
! ( V_119 -> V_2 & V_72 ) ||
( V_119 -> V_123 & V_124 ) )
...
if ( V_36 )
return V_36 ;
V_36 = V_117 -> V_30 -> V_132 ( V_117 , V_118 ,
V_119 , V_120 , V_54 ) ;
if ( ! V_36 ) {
F_33 ( V_117 ) ;
F_42 ( V_119 ) ;
...
int F_94 ( struct V_1 * V_1 , struct V_133 * V_134 )
{
struct V_135 * V_136 ;
struct V_17 * V_137 = F_14 ( V_1 ) ;
T_10 V_138 ;
T_10 V_54 ;
int V_139 ;
int V_36 ;
bool V_140 = F_95 ( V_141 ) ;
T_11 V_44 = V_134 -> V_142 ;
struct V_1 * V_143 ;
T_1 V_144 ;
T_2 V_145 ;
if ( ! ( V_1 -> V_2 & V_60 ) )
return - V_6 ;
if ( V_134 -> V_146 || V_134 -> V_147 )
return - V_6 ;
V_138 = V_134 -> V_148 ;
V_54 = V_134 -> V_149 ;
V_36 = - V_131 ;
...
if ( ! F_93 ( V_137 -> V_130 ) )
goto V_27;
V_36 = F_90 ( V_1 , V_138 , V_54 , false ) ;
if ( V_36 < 0 )
goto V_27;
V_36 = 0 ;
for ( V_139 = 0 ; V_139 < V_44 ; V_139 ++ ) {
V_134 -> V_136 [ V_139 ] . V_150 = 0ULL ;
V_134 -> V_136 [ V_139 ] . V_151 = V_152 ;
}
for ( V_139 = 0 , V_136 = V_134 -> V_136 ; V_139 < V_44 ; V_139 ++ , V_136 ++ ) {
struct V_17 * V_153 ;
struct V_100 V_154 = F_73 ( V_136 -> V_155 ) ;
V_143 = V_154 . V_1 ;
if ( ! V_143 ) {
V_136 -> V_151 = - V_61 ;
goto V_156;
...
V_144 = V_136 -> V_157 ;
V_36 = F_90 ( V_143 , V_144 , V_54 , true ) ;
if ( V_36 < 0 ) {
V_136 -> V_151 = V_36 ;
goto V_158;
}
...
if ( V_136 -> V_159 ) {
V_136 -> V_151 = - V_6 ;
} else if ( ! ( V_140 || ( V_143 -> V_2 & V_72 ) ) ) {
V_136 -> V_151 = - V_6 ;
} else if ( V_1 -> V_128 . V_129 != V_143 -> V_128 . V_129 ) {
V_136 -> V_151 = - V_125 ;
} else if ( F_92 ( V_153 -> V_130 ) ) {
V_136 -> V_151 = - V_131 ;
} else if ( V_143 -> V_30 -> V_160 == NULL ) {
V_136 -> V_151 = - V_6 ;
} else {
V_145 = V_143 -> V_30 -> V_160 ( V_1 , V_138 ,
V_54 , V_143 ,
V_136 -> V_157 ) ;
if ( V_145 == - V_161 )
V_136 -> V_151 = V_162 ;
