...
V_55 -> V_137 = F_21 ( V_4 , & V_7 , & V_55 -> V_151 , L_19 ,
NULL ) ;
...
V_55 -> V_74 = NULL ;
V_55 -> V_154 = 0 ;
V_55 -> V_136 = F_21 ( V_4 , & V_7 , & V_55 -> V_155 , L_21 ,
& V_55 -> V_154 ) ;
...
|| ( ! V_182 && V_162 -> V_158 ) ) {
F_88 ( L_25 V_204 L_26
L_27 V_204 L_28 V_204 L_29 , V_9 ,
...
char V_283 [ V_189 ] ;
char V_284 [ V_189 ] ;
F_115 ( V_283 , V_189 , L_36 , V_281 , V_35 ) ;
F_115 ( V_284 , V_189 , L_36 , V_282 , V_35 ) ;
return F_128 ( V_283 , V_284 , 0400 ) ;
}
static int F_129 ( const char * V_272 , const char * V_35 )
{
char V_106 [ V_189 ] ;
F_115 ( V_106 , V_189 , L_36 , V_272 , V_35 ) ;
return F_57 ( V_106 ) ;
}
...
char V_291 [ V_189 ] ;
char V_292 [ V_189 ] ;
if ( F_127 ( V_281 , V_282 , L_37 ) )
return - 1 ;
if ( F_127 ( V_281 , V_282 , L_38 ) )
goto V_293;
F_115 ( V_291 , V_189 , L_39 , V_281 ) ;
F_115 ( V_292 , V_189 , L_39 , V_282 ) ;
