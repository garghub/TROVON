...
static int F_105 ( struct V_106 * V_106 )
{
struct V_5 * V_6 = F_59 ( V_106 ) ;
...
static unsigned int F_107 ( struct V_106 * V_106 , T_3 * V_201 )
{
struct V_49 * V_50 = F_63 ( V_106 -> V_199 ) ;
return F_108 ( & V_50 -> V_88 , V_106 , V_201 ) ;
}
static int F_109 ( struct V_106 * V_106 , struct V_202 * V_203 )
{
struct V_49 * V_50 = F_63 ( V_106 -> V_199 ) ;
return F_110 ( & V_50 -> V_88 , V_203 ) ;
}
int F_111 ( struct V_5 * V_6 , const char * V_113 )
{
const char * V_204 ;
int V_43 ;
switch ( V_6 -> type ) {
...
V_43 = F_112 ( & V_6 -> V_6 . V_29 , 1 , & V_6 -> V_26 ) ;
if ( V_43 < 0 )
return V_43 ;
F_113 ( & V_6 -> V_76 ) ;
F_114 ( & V_6 -> V_47 ) ;
...
int F_119 ( struct V_5 * V_6 , struct V_217 * V_218 )
{
int V_43 ;
V_6 -> V_6 . V_219 = V_218 ;
V_43 = F_120 ( & V_6 -> V_6 , V_212 , - 1 ) ;
if ( V_43 < 0 )
F_121 ( V_6 -> V_70 -> V_71 ,
L_7 , V_43 ) ;
return V_43 ;
