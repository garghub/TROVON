...
V_42 = F_49 ( V_38 ) ;
F_50 ( V_41 -> V_59 , L_14 ,
F_51 ( V_38 ) , V_42 , F_52 ( V_41 , V_38 ) ) ;
for ( V_6 = 0 ; V_6 < V_42 ; V_6 ++ ) {
V_44 = F_53 ( V_6 ) ;
F_54 ( V_38 , & V_20 , V_6 ) ;
type = V_20 . type ;
F_3 ( L_15 ,
V_6 , V_20 . V_60 , type , V_20 . V_25 ,
...
void F_77 ( struct V_40 * V_41 , struct V_1 * V_79 )
{
int V_6 ; T_1 V_42 ;
struct V_57 V_20 ;
int V_80 ;
...
F_80 ( V_79 , & V_20 , V_6 ) ;
F_3 ( L_35 ,
V_6 , V_20 . V_60 , V_20 . type , V_20 . V_25 ,
F_81 ( V_79 , V_6 ) ) ;
}
for ( V_6 = 0 ; V_6 < V_42 ; V_6 ++ ) {
struct V_1 * V_81 = F_82 ( V_41 ,
F_81 ( V_79 , V_6 ) ,
F_83 ( V_79 , V_6 ) ) ;
if ( F_84 ( V_81 ) ) {
continue;
