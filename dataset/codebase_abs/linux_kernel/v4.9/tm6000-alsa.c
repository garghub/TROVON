...
if ( ! V_59 [ V_53 ] )
return - V_60 ;
V_36 = F_34 ( & V_50 -> V_61 -> V_50 , V_62 [ V_53 ] , L_13 ,
V_63 , 0 , & V_52 ) ;
if ( V_36 < 0 ) {
F_35 ( V_64 L_14 , V_53 ) ;
return V_36 ;
}
strcpy ( V_52 -> V_65 , L_15 ) ;
strcpy ( V_52 -> V_66 , L_16 ) ;
sprintf ( V_52 -> V_67 , L_17 ,
V_50 -> V_61 -> V_68 -> V_69 , V_50 -> V_61 -> V_70 ) ;
sprintf ( V_54 , L_18 ,
F_36 ( V_50 -> V_61 -> V_71 . V_72 ) ,
F_36 ( V_50 -> V_61 -> V_71 . V_73 ) ) ;
F_37 ( V_52 , V_54 ) ;
V_2 = F_38 ( sizeof( struct V_1 ) , V_74 ) ;
if ( ! V_2 ) {
V_36 = - V_12 ;
goto error;
}
...
V_50 -> V_22 = V_2 ;
F_39 ( & V_2 -> V_75 ) ;
V_36 = F_40 ( V_52 , L_19 , 0 , 0 , 1 , & V_56 ) ;
if ( V_36 < 0 )
goto V_76;
V_56 -> V_77 = 0 ;
V_56 -> V_78 = V_2 ;
...
static int F_46 ( struct V_3 * V_50 )
{
struct V_1 * V_2 ;
if ( ! V_50 )
return 0 ;
