...
V_55 -> V_304 = F_256 ( V_55 ) ;
V_59 -> V_304 = F_87 ( V_55 -> V_304 . V_305 ) ;
V_59 -> V_306 = F_88 ( V_55 -> V_304 . V_307 ) ;
F_90 ( V_71 , V_57 ) ;
V_86:
...
static int F_257 ( struct V_55 * V_55 ,
struct V_7 * V_57 )
{
int V_50 , V_308 = 0 ;
struct V_7 * V_51 = NULL ;
...
static int F_259 ( struct V_55 * V_55 ,
struct V_143 * V_144 ,
struct V_2 * V_244 ,
struct V_7 * V_51 ,
T_2 V_116 , T_2 V_242 , T_2 V_243 ,
...
static int F_260 ( struct V_55 * V_312 ,
struct V_7 * V_313 ,
struct V_55 * V_314 ,
struct V_7 * V_315 )
{
int V_50 ;
T_3 * V_71 ;
struct V_27 * V_28 = F_13 ( V_312 -> V_76 ) ;
struct V_58 * V_316 = (struct V_58 * ) V_313 -> V_12 ;
struct V_58 * V_317 = (struct V_58 * ) V_315 -> V_12 ;
F_5 ( ! ( F_61 ( V_312 ) -> V_60 & V_310 ) ) ;
...
V_50 = F_80 ( V_71 , F_81 ( V_314 ) , V_315 ,
V_85 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_86;
}
V_317 -> V_291 . V_318 . V_319 = V_316 -> V_291 . V_318 . V_319 ;
memcpy ( V_317 -> V_291 . V_318 . V_320 , V_316 -> V_291 . V_318 . V_320 ,
F_97 ( V_316 -> V_291 . V_318 . V_319 ) ) ;
F_19 ( & F_61 ( V_314 ) -> V_98 ) ;
F_61 ( V_314 ) -> V_60 |= V_310 ;
V_317 -> V_99 = F_86 ( F_61 ( V_314 ) -> V_60 ) ;
F_21 ( & F_61 ( V_314 ) -> V_98 ) ;
F_90 ( V_71 , V_315 ) ;
V_86:
F_92 ( V_28 , V_71 ) ;
V_17:
...
static int F_261 ( struct V_55 * V_312 ,
struct V_55 * V_314 ,
struct V_7 * V_315 ,
struct V_2 * V_244 ,
struct V_7 * V_51 ,
...
unsigned int V_271 ;
struct V_143 V_144 ;
F_245 ( & V_144 , F_81 ( V_314 ) , V_315 ) ;
V_190 = F_207 ( V_312 ) ;
V_221 = F_190 ( V_312 -> V_76 , V_190 ) ;
V_116 = 0 ;
while ( V_116 < V_221 ) {
V_50 = F_234 ( V_312 , V_116 , & V_242 ,
& V_243 , & V_271 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
...
static int F_262 ( struct V_55 * V_312 ,
struct V_7 * V_313 ,
struct V_55 * V_314 ,
struct V_7 * V_315 ,
bool V_321 )
...
T_6 V_190 = F_207 ( V_312 ) ;
V_71 = F_77 ( F_13 ( V_314 -> V_76 ) ,
V_303 ) ;
if ( F_78 ( V_71 ) ) {
V_50 = F_79 ( V_71 ) ;
F_56 ( V_50 ) ;
...
F_19 ( & F_61 ( V_314 ) -> V_98 ) ;
F_61 ( V_314 ) -> V_130 = F_61 ( V_312 ) -> V_130 ;
F_61 ( V_314 ) -> V_322 = F_61 ( V_312 ) -> V_322 ;
F_61 ( V_314 ) -> V_60 = F_61 ( V_312 ) -> V_60 ;
F_21 ( & F_61 ( V_314 ) -> V_98 ) ;
F_263 ( V_314 , V_190 ) ;
V_314 -> V_323 = V_312 -> V_323 ;
V_59 -> V_324 = V_316 -> V_324 ;
V_59 -> V_325 = V_316 -> V_325 ;
V_59 -> V_326 = V_316 -> V_326 ;
V_59 -> V_99 = V_316 -> V_99 ;
V_59 -> V_327 = V_316 -> V_327 ;
if ( V_321 ) {
V_314 -> V_328 = V_312 -> V_328 ;
V_314 -> V_329 = V_312 -> V_329 ;
V_314 -> V_330 = V_312 -> V_330 ;
V_59 -> V_328 = V_316 -> V_328 ;
V_59 -> V_329 = V_316 -> V_329 ;
V_59 -> V_330 = V_316 -> V_330 ;
V_314 -> V_304 = F_256 ( V_314 ) ;
V_59 -> V_304 = F_87 ( V_314 -> V_304 . V_305 ) ;
V_59 -> V_306 = F_88 ( V_314 -> V_304 . V_307 ) ;
V_314 -> V_331 = V_312 -> V_331 ;
V_59 -> V_331 = V_316 -> V_331 ;
V_59 -> V_332 = V_316 -> V_332 ;
}
F_90 ( V_71 , V_315 ) ;
V_86:
F_92 ( F_13 ( V_314 -> V_76 ) , V_71 ) ;
return V_50 ;
}
static int F_264 ( struct V_55 * V_312 ,
struct V_7 * V_313 ,
struct V_55 * V_314 ,
struct V_7 * V_315 ,
bool V_321 )
...
struct V_27 * V_28 = F_13 ( V_312 -> V_76 ) ;
struct V_10 * V_11 ;
struct V_58 * V_59 = (struct V_58 * ) V_313 -> V_12 ;
struct V_1 * V_101 ;
F_239 ( & V_207 ) ;
V_50 = F_94 ( V_314 , V_315 ,
F_11 ( V_59 -> V_62 ) ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
if ( F_61 ( V_312 ) -> V_60 & V_310 ) {
V_50 = F_260 ( V_312 , V_313 ,
V_314 , V_315 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
goto V_17;
...
static int F_265 ( struct V_334 * V_335 ,
struct V_7 * V_270 ,
struct V_55 * V_336 ,
bool V_321 )
{
int V_50 ;
struct V_55 * V_55 = F_266 ( V_335 ) ;
struct V_7 * V_77 = NULL ;
if ( F_61 ( V_55 ) -> V_337 & V_338 ) {
V_50 = - V_339 ;
F_56 ( V_50 ) ;
goto V_17;
}
V_50 = F_267 ( V_55 -> V_261 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
V_50 = F_257 ( V_55 , V_270 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_17;
}
F_268 ( V_336 , V_340 ) ;
V_50 = F_269 ( V_336 , & V_77 , 1 ,
V_341 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto V_114;
}
V_50 = F_264 ( V_55 , V_270 ,
V_336 , V_77 , V_321 ) ;
if ( V_50 ) {
F_56 ( V_50 ) ;
goto F_104;
...
V_17:
if ( ! V_50 ) {
V_50 = F_271 ( V_55 -> V_261 ) ;
if ( V_50 )
F_56 ( V_50 ) ;
}
return V_50 ;
}
static int F_272 ( struct V_334 * V_335 , struct V_55 * V_342 ,
struct V_334 * V_343 , bool V_321 )
{
int error ;
struct V_55 * V_55 = F_266 ( V_335 ) ;
struct V_7 * V_270 = NULL ;
struct V_55 * V_344 = NULL ;
if ( ! V_1 ( F_13 ( V_55 -> V_76 ) ) )
return - V_345 ;
error = F_273 ( V_342 , V_55 -> V_330 ,
& V_344 ) ;
if ( error ) {
F_56 ( error ) ;
goto V_17;
...
static inline int F_279 ( struct V_55 * V_342 , struct V_334 * V_347 )
{
if ( F_280 ( V_347 ) )
return - V_348 ;
if ( F_281 ( V_342 ) )
return - V_349 ;
return F_282 ( V_342 , V_350 | V_351 ) ;
}
static int F_283 ( struct V_334 * V_335 , struct V_55 * V_342 ,
struct V_334 * V_343 , bool V_321 )
{
struct V_55 * V_55 = F_266 ( V_335 ) ;
int error ;
if ( ! V_55 )
return - V_349 ;
error = F_279 ( V_342 , V_343 ) ;
if ( error )
return error ;
if ( V_342 -> V_76 != V_55 -> V_76 )
return - V_352 ;
if ( F_284 ( V_55 ) || F_285 ( V_55 ) )
return - V_353 ;
if ( ! F_286 ( V_55 -> V_330 ) )
return - V_353 ;
if ( V_321 ) {
if ( ! F_287 ( F_288 () , V_55 -> V_328 ) && ! F_289 ( V_354 ) )
return - V_353 ;
if ( ! F_290 ( V_55 -> V_329 ) && ! F_289 ( V_354 ) )
return - V_353 ;
}
if ( ! V_321 ) {
error = F_282 ( V_55 , V_355 ) ;
if ( error )
return error ;
}
F_100 ( V_55 ) ;
error = F_291 ( V_342 ) ;
if ( ! error )
error = F_272 ( V_335 , V_342 , V_343 , V_321 ) ;
F_104 ( V_55 ) ;
if ( ! error )
F_292 ( V_342 , V_343 ) ;
return error ;
}
int F_293 ( struct V_55 * V_55 ,
const char T_7 * V_356 ,
const char T_7 * V_357 ,
bool V_321 )
{
struct V_334 * V_343 ;
struct V_204 V_358 , V_359 ;
int error ;
if ( ! V_1 ( F_13 ( V_55 -> V_76 ) ) )
return - V_345 ;
error = F_294 ( V_360 , V_356 , 0 , & V_358 ) ;
if ( error ) {
F_56 ( error ) ;
return error ;
}
V_343 = F_295 ( V_360 , V_357 , & V_359 , 0 ) ;
error = F_79 ( V_343 ) ;
if ( F_78 ( V_343 ) ) {
F_56 ( error ) ;
goto V_17;
...
error = - V_352 ;
if ( V_358 . V_361 != V_359 . V_361 ) {
F_56 ( error ) ;
goto V_362;
}
error = F_283 ( V_358 . V_334 ,
F_266 ( V_359 . V_334 ) ,
V_343 , V_321 ) ;
V_362:
F_296 ( & V_359 , V_343 ) ;
