...
static struct V_58 * F_31 ( struct V_54 * V_51 )
{
...
static int F_103 ( struct V_56 * V_51 , const struct V_115 * V_116 )
{
struct V_1 * V_5 ;
int V_37 , V_117 ;
...
V_117 = F_113 ( & V_51 -> V_51 , F_21 ( V_51 , V_37 ) ,
...
if ( V_117 )
return V_117 ;
F_116 ( & V_5 -> V_51 -> V_51 , L_7 ,
V_5 -> V_4 . V_44 ) ;
return 0 ;
}
static void F_117 ( struct V_56 * V_51 )
{
struct V_1 * V_5 = F_118 ( V_51 ) ;
F_81 ( V_5 ) ;
F_115 ( V_51 , NULL ) ;
F_119 ( & V_5 -> V_51 -> V_51 . V_113 , L_4 ) ;
F_120 ( V_5 -> V_3 ) ;
F_121 ( V_5 -> V_3 ) ;
F_62 ( V_5 ) ;
F_94 ( V_5 -> V_43 ) ;
}
static int F_122 ( struct V_54 * V_51 )
{
struct V_56 * V_57 = F_28 ( V_51 ) ;
F_123 ( V_57 ) ;
return 0 ;
}
static int F_124 ( struct V_54 * V_51 )
{
struct V_56 * V_57 = F_28 ( V_51 ) ;
F_125 ( V_57 ) ;
return 0 ;
