...
static T_9 int F_264 ( struct V_20 * V_20 )
{
F_14 ( V_20 ) ;
return 0 ;
}
static void T_10 F_265 ( struct V_20 * V_20 )
{
...
if ( V_37 < 0 )
goto V_611;
for ( V_147 = 0 ; V_147 < V_597 ; V_147 ++ ) {
struct V_398 V_399 = { 0 } ;
V_399 . V_362 = V_362 ;
switch ( V_612 ) {
case V_613 :
if ( V_147 < F_113 ( V_614 ) )
V_399 . V_402 = V_614 [ V_147 ] ;
break;
case V_615 :
if ( ! V_147 )
V_399 . V_402 = V_614 [ 0 ] ;
