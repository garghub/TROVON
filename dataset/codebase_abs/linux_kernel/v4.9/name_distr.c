...
T_1 V_38 = ( ( F_16 ( V_10 , V_34 , 0 ) - V_17 ) /
V_30 ) * V_30 ;
T_1 V_39 = V_38 ;
...
F_20 ( V_37 , V_17 + ( V_38 - V_39 ) ) ;
F_19 ( V_33 , V_37 ) ;
}
}
void F_21 ( struct V_10 * V_10 , T_1 V_34 )
{
struct V_13 * V_14 = F_4 ( V_10 , V_15 ) ;
struct V_32 V_40 ;
F_22 ( & V_40 ) ;
...
& V_14 -> V_25 -> V_26 [ V_42 ] ) ;
F_24 () ;
F_25 ( V_10 , & V_40 , V_34 , 0 ) ;
}
static void F_26 ( struct V_10 * V_10 , struct V_3 * V_22 , T_1 V_43 )
{
struct V_13 * V_14 = F_4 ( V_10 , V_15 ) ;
struct V_3 * V_4 ;
F_27 ( & V_14 -> V_44 ) ;
V_4 = F_28 ( V_10 , V_22 -> type , V_22 -> V_5 ,
V_22 -> V_45 , V_22 -> V_7 , V_22 -> V_8 ) ;
if ( V_4 )
F_29 ( V_10 , & V_4 -> V_46 , V_43 ) ;
F_30 ( & V_14 -> V_44 ) ;
if ( V_4 != V_22 ) {
F_31 ( L_4
L_5 ,
...
static void F_33 ( struct V_10 * V_10 , T_1 V_43 )
{
struct V_13 * V_14 = F_4 ( V_10 , V_15 ) ;
...
void F_36 ( struct V_10 * V_10 , struct V_35 * V_52 , T_1 V_43 )
{
...
if ( V_53 == V_29 ) {
V_22 = F_38 ( V_10 , F_39 ( V_2 -> type ) ,
F_39 ( V_2 -> V_5 ) ,
F_39 ( V_2 -> V_6 ) ,
V_41 , V_45 ,
F_39 ( V_2 -> V_7 ) , F_39 ( V_2 -> V_8 ) ) ;
if ( V_22 ) {
F_40 ( V_10 , & V_22 -> V_46 , V_45 ) ;
return true ;
}
} else if ( V_53 == V_31 ) {
V_22 = F_28 ( V_10 , F_39 ( V_2 -> type ) ,
F_39 ( V_2 -> V_5 ) ,
V_45 , F_39 ( V_2 -> V_7 ) ,
F_39 ( V_2 -> V_8 ) ) ;
if ( V_22 ) {
F_29 ( V_10 , & V_22 -> V_46 , V_45 ) ;
F_32 ( V_22 , V_47 ) ;
return true ;
}
} else {
...
struct V_48 * V_49 ;
struct V_13 * V_14 = F_4 ( V_10 , V_15 ) ;
unsigned long V_54 = F_42 () ;
V_49 = F_43 ( sizeof( * V_49 ) , V_55 ) ;
if ( ! V_49 )
return;
V_49 -> V_53 = type ;
V_49 -> V_45 = V_45 ;
V_49 -> V_56 = V_54 + F_44 ( V_57 ) ;
memcpy ( V_49 , V_2 , sizeof( * V_2 ) ) ;
F_45 ( & V_49 -> V_51 , & V_14 -> V_58 ) ;
}
...
unsigned long V_54 = F_42 () ;
F_34 (e, tmp, &tn->dist_queue, next) {
if ( F_47 ( V_49 -> V_56 , V_54 ) ) {
if ( ! F_37 ( V_10 , & V_49 -> V_2 , V_49 -> V_45 , V_49 -> V_53 ) )
continue;
} else {
F_48 ( V_43 , V_49 -> V_45 ) ;
F_49 ( L_7 ,
V_49 -> V_53 , F_39 ( V_49 -> V_2 . type ) ,
F_39 ( V_49 -> V_2 . V_5 ) ,
F_39 ( V_49 -> V_2 . V_6 ) ,
V_43 , F_39 ( V_49 -> V_2 . V_8 ) ) ;
}
F_14 ( & V_49 -> V_51 ) ;
F_35 ( V_49 ) ;
}
}
void F_50 ( struct V_10 * V_10 , struct V_32 * V_59 )
{
struct V_13 * V_14 = F_4 ( V_10 , V_15 ) ;
struct V_18 * V_19 ;
struct V_1 * V_23 ;
...
int V_61 ;
F_27 ( & V_14 -> V_44 ) ;
for ( V_37 = F_51 ( V_59 ) ; V_37 ; V_37 = F_51 ( V_59 ) ) {
F_52 ( V_37 ) ;
V_19 = F_6 ( V_37 ) ;
V_61 = F_53 ( V_19 ) ;
...
V_45 = F_55 ( V_19 ) ;
while ( V_60 -- ) {
if ( ! F_37 ( V_10 , V_23 , V_45 , V_61 ) )
F_41 ( V_10 , V_23 , V_61 , V_45 ) ;
V_23 ++ ;
}
F_56 ( V_37 ) ;
F_46 ( V_10 ) ;
