...
int V_322 = - 1 ;
int V_250 , V_302 ;
int V_323 = F_197 ( V_4 , V_34 -> V_61 ) ;
V_250 = V_178 -> V_209 ;
V_178 -> V_159 . V_9 . V_215 ++ ;
V_178 -> V_159 . V_9 . V_293 += V_34 -> V_110 ;
V_178 -> V_159 . V_9 . V_182 = V_173 ;
if ( V_178 -> V_204 == F_110 ( V_206 ) && V_323 >= 0 ) {
struct V_152 * V_324 ;
V_324 = F_109 ( V_4 , V_250 ) ;
if ( V_324 &&
...
if ( V_322 != - 1 ) {
struct V_33 * V_329 = F_200 ( V_34 , V_212 ) ;
if ( V_329 )
F_187 ( V_2 , V_4 , V_329 , V_178 ,
V_322 ) ;
}
V_322 = V_302 ;
}
...
struct V_33 * V_329 = F_200 ( V_34 , V_212 ) ;
if ( V_329 )
F_187 ( V_2 , V_4 , V_329 , V_178 , V_322 ) ;
} else {
F_187 ( V_2 , V_4 , V_34 , V_178 , V_322 ) ;
return;
}
}
V_326:
...
int V_192 = F_199 ( V_34 ) -> V_331 & V_332 ;
struct V_1 * V_4 ;
...
struct V_2 * V_2 = F_35 ( V_34 -> V_61 ) ;
struct V_1 * V_4 ;
if ( ! F_207 ( V_34 , sizeof( * V_335 ) + sizeof( struct V_117 ) ) )
goto V_336;
V_335 = F_208 ( V_34 ) ;
V_4 = F_201 ( V_2 , V_34 ) ;
if ( F_13 ( V_4 ) )
goto V_336;
if ( ! V_4 -> V_273 ||
V_335 -> V_337 != V_338 || V_335 -> V_225 != V_339 )
goto V_336;
if ( F_61 ( V_4 , V_34 , sizeof( * V_335 ) ) ) {
V_336:
F_51 ( V_34 ) ;
}
return 0 ;
...
if ( ! F_207 ( V_34 , sizeof( * V_335 ) + sizeof( struct V_117 ) ) )
goto V_336;
V_335 = (struct V_340 * ) F_62 ( V_34 ) ;
if ( V_335 -> type != ( ( V_341 << 4 ) | ( V_342 ) ) ||
( V_335 -> V_13 & V_343 ) ||
( F_210 ( ( void * ) V_335 , sizeof( * V_335 ) ) != 0 &&
...
struct V_152 * V_153 , struct V_344 * V_345 )
{
struct V_346 V_347 ;
struct V_37 * V_348 ;
struct V_349 * V_350 ;
...
F_213 ( V_34 , V_351 , V_4 -> V_130 [ V_153 -> V_209 ] . V_61 -> V_101 ) < 0 )
return - V_214 ;
if ( ! ( V_348 = F_214 ( V_34 , V_352 ) ) )
return - V_214 ;
for ( V_302 = V_153 -> V_159 . V_9 . V_180 ; V_302 < V_153 -> V_159 . V_9 . V_144 ; V_302 ++ ) {
if ( F_73 ( V_4 , V_302 ) && V_153 -> V_159 . V_9 . V_179 [ V_302 ] < 255 ) {
if ( ! ( V_350 = F_215 ( V_34 , sizeof( * V_350 ) ) ) ) {
F_216 ( V_34 , V_348 ) ;
return - V_214 ;
}
V_350 -> V_353 = 0 ;
V_350 -> V_354 = V_153 -> V_159 . V_9 . V_179 [ V_302 ] ;
V_350 -> V_355 = V_4 -> V_130 [ V_302 ] . V_61 -> V_101 ;
V_350 -> V_356 = sizeof( * V_350 ) ;
}
}
F_217 ( V_34 , V_348 ) ;
V_182 = F_218 ( V_153 -> V_159 . V_9 . V_182 ) ;
V_182 = F_219 ( V_173 , V_182 ) ? V_173 - V_182 : 0 ;
V_347 . V_357 = V_153 -> V_159 . V_9 . V_215 ;
V_347 . V_358 = V_153 -> V_159 . V_9 . V_293 ;
V_347 . V_359 = V_153 -> V_159 . V_9 . V_294 ;
if ( F_220 ( V_34 , V_360 , sizeof( V_347 ) , & V_347 , V_361 ) ||
F_221 ( V_34 , V_362 , F_222 ( V_182 ) ,
V_361 ) )
return - V_214 ;
V_345 -> V_363 = V_364 ;
return 1 ;
...
T_6 V_74 , T_6 V_71 ,
struct V_344 * V_345 , int V_365 , T_1 V_169 )
{
struct V_152 * V_178 ;
struct V_1 * V_4 ;
int V_7 ;
...
V_329 = F_200 ( V_34 , V_212 ) ;
if ( ! V_329 ) {
F_54 ( & V_107 ) ;
F_135 () ;
return - V_53 ;
}
F_93 ( V_329 ) . V_169 = V_169 ;
F_124 ( V_329 , sizeof( struct V_117 ) ) ;
F_66 ( V_329 ) ;
V_70 = F_88 ( V_329 ) ;
...
V_70 -> V_71 = V_71 ;
V_70 -> V_76 = 0 ;
V_7 = F_138 ( V_4 , V_250 , V_329 ) ;
F_54 ( & V_107 ) ;
F_135 () ;
return V_7 ;
}
F_52 ( & V_107 ) ;
V_7 = F_118 ( V_4 , V_34 , V_178 , V_345 ) ;
F_54 ( & V_107 ) ;
F_135 () ;
return V_7 ;
}
static int F_224 ( struct V_1 * V_4 , struct V_33 * V_34 ,
T_1 V_169 , T_1 V_366 , struct V_152 * V_153 , int V_278 ,
int V_13 )
{
struct V_162 * V_163 ;
struct V_344 * V_345 ;
int V_7 ;
V_163 = F_225 ( V_34 , V_169 , V_366 , V_278 , sizeof( * V_345 ) , V_13 ) ;
if ( ! V_163 )
return - V_214 ;
V_345 = F_91 ( V_163 ) ;
V_345 -> V_367 = V_368 ;
...
V_345 -> V_377 = V_379 ;
V_345 -> V_380 = 0 ;
if ( F_226 ( V_34 , V_381 , V_153 -> V_204 ) ||
F_226 ( V_34 , V_382 , V_153 -> V_205 ) )
goto V_374;
V_7 = F_118 ( V_4 , V_34 , V_153 , V_345 ) ;
if ( V_7 < 0 && V_7 != - V_236 )
goto V_374;
F_227 ( V_34 , V_163 ) ;
return 0 ;
...
+ F_231 ( 4 )
+ F_231 ( 0 )
+ V_144 * F_232 ( sizeof( struct V_349 ) )
+ F_233 ( sizeof( struct V_346 ) )
;
return V_110 ;
}
...
if ( V_7 < 0 )
goto V_383;
F_235 ( V_34 , V_2 , 0 , V_384 , NULL , V_212 ) ;
return;
V_383:
F_51 ( V_34 ) ;
if ( V_7 < 0 )
...
static int F_237 ( struct V_33 * V_34 , struct V_385 * V_386 )
{
...
if ( V_387 > V_388 )
V_390 = 0 ;
for ( V_389 = V_390 ; V_389 < V_54 ; V_389 ++ ) {
F_108 (mfc, &mrt->mfc_cache_array[h], list) {
if ( V_157 < V_391 )
goto V_393;
if ( F_224 ( V_4 , V_34 ,
F_93 ( V_386 -> V_34 ) . V_169 ,
V_386 -> V_163 -> V_394 ,
V_232 , V_229 ,
V_395 ) < 0 )
goto V_396;
...
static bool F_238 ( unsigned char V_377 )
{
switch ( V_377 ) {
case V_378 :
case V_379 :
...
static int F_239 ( const struct V_37 * V_398 , struct V_231 * V_399 )
{
struct V_349 * V_400 = F_240 ( V_398 ) ;
int V_401 = F_241 ( V_398 ) , V_139 = 0 ;
while ( F_242 ( V_400 , V_401 ) ) {
V_399 -> V_239 [ V_139 ] = V_400 -> V_354 ;
if ( ++ V_139 == V_181 )
break;
V_400 = F_243 ( V_400 , & V_401 ) ;
}
return V_401 > 0 ? - V_28 : V_139 ;
}
static int F_244 ( struct V_2 * V_2 , struct V_162 * V_163 ,
struct V_231 * V_399 , int * V_184 ,
struct V_1 * * V_402 )
{
...
struct V_344 * V_345 ;
int V_221 , V_405 ;
V_221 = F_245 ( V_163 , sizeof( * V_345 ) , V_406 , V_407 ) ;
if ( V_221 < 0 )
goto V_175;
V_345 = F_91 ( V_163 ) ;
V_221 = - V_28 ;
if ( V_345 -> V_367 != V_368 || V_345 -> V_369 != 32 ||
V_345 -> V_363 != V_364 ||
V_345 -> V_375 != V_376 ||
! F_238 ( V_345 -> V_377 ) )
goto V_175;
...
switch ( F_247 ( V_404 ) ) {
case V_381 :
V_399 -> V_235 . V_73 = F_248 ( V_404 ) ;
break;
case V_382 :
V_399 -> V_234 . V_73 = F_248 ( V_404 ) ;
break;
case V_351 :
V_61 = F_249 ( V_2 , F_250 ( V_404 ) ) ;
if ( ! V_61 ) {
V_221 = - V_334 ;
goto V_175;
}
...
* V_402 = V_4 ;
* V_184 = V_345 -> V_377 == V_379 ? 1 : 0 ;
if ( V_61 )
V_399 -> V_237 = F_197 ( V_4 , V_61 ) ;
V_175:
return V_221 ;
}
...
V_184 = 0 ;
V_409 = NULL ;
V_221 = F_244 ( V_2 , V_163 , & V_399 , & V_184 , & V_409 ) ;
if ( V_221 < 0 )
return V_221 ;
V_233 = V_221 ? V_399 . V_237 : - 1 ;
if ( V_163 -> V_164 == V_229 )
return F_148 ( V_2 , V_409 , & V_399 , V_184 , V_233 ) ;
else
return F_146 ( V_409 , & V_399 , V_233 ) ;
}
static struct V_143 * F_252 ( struct V_2 * V_2 ,
struct V_410 * V_411 ,
T_9 V_412 )
{
struct V_1 * V_4 = V_411 -> V_4 ;
for ( V_411 -> V_302 = 0 ; V_411 -> V_302 < V_4 -> V_144 ; ++ V_411 -> V_302 ) {
if ( ! F_73 ( V_4 , V_411 -> V_302 ) )
continue;
if ( V_412 -- == 0 )
return & V_4 -> V_130 [ V_411 -> V_302 ] ;
}
return NULL ;
}
static void * F_253 ( struct V_413 * V_366 , T_9 * V_412 )
__acquires( V_107 )
{
struct V_410 * V_411 = V_366 -> V_414 ;
struct V_2 * V_2 = F_254 ( V_366 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , V_46 ) ;
if ( ! V_4 )
return F_25 ( - V_236 ) ;
V_411 -> V_4 = V_4 ;
F_52 ( & V_107 ) ;
return * V_412 ? F_252 ( V_2 , V_366 -> V_414 , * V_412 - 1 )
: V_415 ;
}
static void * F_255 ( struct V_413 * V_366 , void * V_63 , T_9 * V_412 )
{
struct V_410 * V_411 = V_366 -> V_414 ;
struct V_2 * V_2 = F_254 ( V_366 ) ;
struct V_1 * V_4 = V_411 -> V_4 ;
++ * V_412 ;
if ( V_63 == V_415 )
return F_252 ( V_2 , V_411 , 0 ) ;
while ( ++ V_411 -> V_302 < V_4 -> V_144 ) {
if ( ! F_73 ( V_4 , V_411 -> V_302 ) )
continue;
return & V_4 -> V_130 [ V_411 -> V_302 ] ;
}
...
static void F_256 ( struct V_413 * V_366 , void * V_63 )
__releases( V_107 )
{
F_54 ( & V_107 ) ;
}
static int F_257 ( struct V_413 * V_366 , void * V_63 )
{
struct V_410 * V_411 = V_366 -> V_414 ;
struct V_1 * V_4 = V_411 -> V_4 ;
if ( V_63 == V_415 ) {
...
static int F_260 ( struct V_416 * V_416 , struct V_417 * V_417 )
{
return F_261 ( V_416 , V_417 , & V_418 ,
sizeof( struct V_410 ) ) ;
}
static struct V_152 * F_262 ( struct V_2 * V_2 ,
struct V_419 * V_420 , T_9 V_412 )
{
struct V_1 * V_4 = V_420 -> V_4 ;
struct V_152 * V_232 ;
F_133 () ;
for ( V_420 -> V_302 = 0 ; V_420 -> V_302 < V_54 ; V_420 -> V_302 ++ ) {
V_420 -> V_178 = & V_4 -> V_55 [ V_420 -> V_302 ] ;
...
static void * F_263 ( struct V_413 * V_366 , T_9 * V_412 )
{
struct V_419 * V_420 = V_366 -> V_414 ;
struct V_2 * V_2 = F_254 ( V_366 ) ;
struct V_1 * V_4 ;
V_4 = F_1 ( V_2 , V_46 ) ;
if ( ! V_4 )
...
V_420 -> V_178 = NULL ;
V_420 -> V_302 = 0 ;
return * V_412 ? F_262 ( V_2 , V_366 -> V_414 , * V_412 - 1 )
: V_415 ;
}
static void * F_264 ( struct V_413 * V_366 , void * V_63 , T_9 * V_412 )
{
...
++ * V_412 ;
if ( V_63 == V_415 )
return F_262 ( V_2 , V_366 -> V_414 , 0 ) ;
if ( V_232 -> V_50 . V_49 != V_420 -> V_178 )
return F_265 ( V_232 -> V_50 . V_49 , struct V_152 , V_50 ) ;
if ( V_420 -> V_178 == & V_4 -> V_56 )
goto V_421;
F_266 ( V_420 -> V_178 != & V_4 -> V_55 [ V_420 -> V_302 ] ) ;
while ( ++ V_420 -> V_302 < V_54 ) {
V_420 -> V_178 = & V_4 -> V_55 [ V_420 -> V_302 ] ;
if ( F_96 ( V_420 -> V_178 ) )
continue;
return F_267 ( V_420 -> V_178 , struct V_152 , V_50 ) ;
}
F_135 () ;
V_420 -> V_178 = & V_4 -> V_56 ;
V_420 -> V_302 = 0 ;
...
static void F_268 ( struct V_413 * V_366 , void * V_63 )
{
struct V_419 * V_420 = V_366 -> V_414 ;
struct V_1 * V_4 = V_420 -> V_4 ;
if ( V_420 -> V_178 == & V_4 -> V_56 )
F_142 ( & V_172 ) ;
else if ( V_420 -> V_178 == & V_4 -> V_55 [ V_420 -> V_302 ] )
F_135 () ;
}
static int F_269 ( struct V_413 * V_366 , void * V_63 )
{
int V_422 ;
if ( V_63 == V_415 ) {
F_258 ( V_366 ,
...
const struct V_419 * V_420 = V_366 -> V_414 ;
const struct V_1 * V_4 = V_420 -> V_4 ;
F_259 ( V_366 , L_10 ,
...
for ( V_422 = V_232 -> V_159 . V_9 . V_180 ;
V_422 < V_232 -> V_159 . V_9 . V_144 ; V_422 ++ ) {
if ( F_73 ( V_4 , V_422 ) &&
V_232 -> V_159 . V_9 . V_179 [ V_422 ] < 255 )
F_259 ( V_366 ,
L_12 ,
V_422 , V_232 -> V_159 . V_9 . V_179 [ V_422 ] ) ;
}
} else {
F_259 ( V_366 , L_11 , 0ul , 0ul , 0ul ) ;
}
F_270 ( V_366 , '\n' ) ;
}
return 0 ;
}
static int F_271 ( struct V_416 * V_416 , struct V_417 * V_417 )
{
return F_261 ( V_416 , V_417 , & V_423 ,
sizeof( struct V_419 ) ) ;
}
...
#ifdef F_273
V_7 = - V_53 ;
if ( ! F_274 ( L_13 , 0 , V_2 -> V_425 , & V_426 ) )
goto V_427;
if ( ! F_274 ( L_14 , 0 , V_2 -> V_425 , & V_428 ) )
goto V_429;
#endif
return 0 ;
#ifdef F_273
V_429:
F_275 ( L_13 , V_2 -> V_425 ) ;
V_427:
F_20 ( V_2 ) ;
#endif
V_424:
