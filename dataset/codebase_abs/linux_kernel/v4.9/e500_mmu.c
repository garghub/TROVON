...
V_125 -> V_139 / V_83 ;
V_128 = F_81 ( V_133 , sizeof( * V_128 ) , V_140 ) ;
if ( ! V_128 )
return - V_141 ;
...
V_130 [ 0 ] = F_84 ( V_118 . V_121 [ 0 ] , sizeof( * V_130 [ 0 ] ) , V_140 ) ;
if ( ! V_130 [ 0 ] ) {
V_134 = - V_141 ;
goto V_143;
}
V_130 [ 1 ] = F_84 ( V_118 . V_121 [ 1 ] , sizeof( * V_130 [ 1 ] ) , V_140 ) ;
if ( ! V_130 [ 1 ] ) {
V_134 = - V_141 ;
goto V_146;
}
V_131 = F_84 ( V_118 . V_121 [ 1 ] ,
sizeof( * V_131 ) ,
V_140 ) ;
if ( ! V_131 ) {
V_134 = - V_141 ;
...
struct V_150 * V_118 )
{
V_12 -> V_15 . V_89 = F_87 ( V_151 ) & ~ V_152 ;
V_12 -> V_15 . V_90 [ 0 ] = F_87 ( V_153 ) &
~ ( V_119 | V_120 ) ;
V_12 -> V_15 . V_90 [ 0 ] |= V_118 [ 0 ] . V_18 ;
V_12 -> V_15 . V_90 [ 0 ] |= V_118 [ 0 ] . V_6 << V_123 ;
V_12 -> V_15 . V_90 [ 1 ] = F_87 ( V_154 ) &
~ ( V_119 | V_120 ) ;
V_12 -> V_15 . V_90 [ 1 ] |= V_118 [ 1 ] . V_18 ;
V_12 -> V_15 . V_90 [ 1 ] |= V_118 [ 1 ] . V_6 << V_123 ;
if ( F_88 ( V_12 , V_155 ) ) {
V_12 -> V_15 . V_114 [ 0 ] = F_87 ( V_156 ) ;
V_12 -> V_15 . V_114 [ 1 ] = F_87 ( V_157 ) ;
V_12 -> V_15 . V_89 &= ~ V_158 ;
V_12 -> V_15 . V_105 = 0 ;
V_12 -> V_15 . V_90 [ 0 ] &= ~ V_159 ;
V_12 -> V_15 . V_90 [ 1 ] &= ~ V_160 ;
}
return 0 ;
}
...
if ( F_90 ( V_2 ) )
goto V_161;
V_2 -> V_5 [ 0 ] . V_18 = V_162 ;
V_2 -> V_5 [ 1 ] . V_18 = V_163 ;
V_2 -> V_5 [ 0 ] . V_6 = V_164 ;
V_2 -> V_5 [ 0 ] . V_8 =
V_162 / V_164 ;
V_2 -> V_5 [ 1 ] . V_6 = V_163 ;
...
V_2 -> V_27 [ 0 ] = 0 ;
V_2 -> V_27 [ 1 ] = V_162 ;
V_2 -> V_80 [ 0 ] = F_84 ( V_2 -> V_5 [ 0 ] . V_18 ,
sizeof( struct V_165 ) ,
V_140 ) ;
if ( ! V_2 -> V_80 [ 0 ] )
goto V_161;
V_2 -> V_80 [ 1 ] = F_84 ( V_2 -> V_5 [ 1 ] . V_18 ,
sizeof( struct V_165 ) ,
V_140 ) ;
if ( ! V_2 -> V_80 [ 1 ] )
goto V_161;
V_2 -> V_79 = F_84 ( V_2 -> V_5 [ 1 ] . V_18 ,
sizeof( * V_2 -> V_79 ) ,
V_140 ) ;
if ( ! V_2 -> V_79 )
goto V_161;
