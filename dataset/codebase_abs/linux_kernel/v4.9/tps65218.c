...
int V_7 ;
unsigned int V_24 ;
V_23 = F_12 ( V_25 , & V_19 -> V_16 ) ;
if ( ! V_23 ) {
F_6 ( & V_19 -> V_16 ,
L_3 ) ;
return - V_13 ;
}
V_2 = F_13 ( & V_19 -> V_16 , sizeof( * V_2 ) , V_26 ) ;
if ( ! V_2 )
return - V_27 ;
F_14 ( V_19 , V_2 ) ;
V_2 -> V_16 = & V_19 -> V_16 ;
V_2 -> V_28 = V_19 -> V_28 ;
V_2 -> V_5 = F_15 ( V_19 , & V_29 ) ;
if ( F_16 ( V_2 -> V_5 ) ) {
V_7 = F_17 ( V_2 -> V_5 ) ;
F_6 ( V_2 -> V_16 , L_4 ,
V_7 ) ;
...
F_18 ( & V_2 -> V_17 ) ;
V_7 = F_19 ( V_2 -> V_5 , V_2 -> V_28 ,
V_30 , 0 , & V_31 ,
& V_2 -> V_32 ) ;
if ( V_7 < 0 )
return V_7 ;
V_7 = F_1 ( V_2 , V_33 , & V_24 ) ;
if ( V_7 ) {
F_6 ( V_2 -> V_16 , L_5 , V_7 ) ;
return V_7 ;
}
V_2 -> V_34 = V_24 & V_35 ;
V_7 = F_20 ( V_19 -> V_16 . V_36 , NULL , NULL ,
& V_19 -> V_16 ) ;
if ( V_7 < 0 )
goto V_37;
return 0 ;
V_37:
F_21 ( V_2 -> V_28 , V_2 -> V_32 ) ;
return V_7 ;
}
