...
static int F_21 ( struct V_1 * V_1 , T_3 V_55 )
{
switch ( V_55 ) {
case V_56 :
V_1 -> V_16 &= ~ V_54 ;
...
V_156 , V_1 ) ) {
F_86 ( V_1 -> V_115 -> V_153 , L_3 , V_34 -> V_93 ) ;
return - V_75 ;
}
V_1 -> V_93 = V_34 -> V_93 ;
...
{
struct V_1 * V_1 = F_100 ( V_184 ) ;
static const char * const V_192 [ 4 ] = {
L_37 , L_38 , L_39 , L_40
} ;
int V_193 ;
...
return F_104 ( V_191 , 1 , V_193 , V_192 ) ;
}
static int
...
F_25 ( & V_1 -> V_71 ) ;
V_186 -> V_187 . V_196 . V_197 [ 0 ] = F_19 ( V_1 ) ;
switch ( V_1 -> V_34 -> V_35 ) {
case V_171 :
case V_194 :
V_195 = 3 ;
...
if ( V_186 -> V_187 . V_196 . V_197 [ 0 ] >= V_195 ) {
V_186 -> V_187 . V_196 . V_197 [ 0 ] = V_195 - 1 ;
}
F_27 ( & V_1 -> V_71 ) ;
return 0 ;
}
...
V_188 = V_186 -> V_187 . V_196 . V_197 [ 0 ] % V_195 ;
F_25 ( & V_1 -> V_71 ) ;
...
struct V_190 * V_191 )
{
static const char * const V_192 [ 4 ] = { L_41 ,
L_42 ,
L_43 ,
L_44 } ;
return F_104 ( V_191 , 1 , 4 , V_192 ) ;
}
static int
...
struct V_1 * V_1 = F_100 ( V_184 ) ;
F_25 ( & V_1 -> V_71 ) ;
V_186 -> V_187 . V_196 . V_197 [ 0 ] = F_17 ( V_1 ) ;
F_27 ( & V_1 -> V_71 ) ;
return 0 ;
}
static int
...
unsigned int V_188 ;
int V_189 ;
V_188 = V_186 -> V_187 . V_196 . V_197 [ 0 ] % 3 ;
F_25 ( & V_1 -> V_71 ) ;
...
static T_6 F_110 ( struct V_198 * V_199 )
{
T_6 V_188 = 0 ;
...
static void F_111 ( struct V_198 * V_199 , T_6 V_188 )
{
...
int V_208 , V_60 ;
struct V_183 * V_209 ;
for ( V_208 = 0 ; V_208 < ( int ) F_120 ( V_210 ) ; V_208 ++ ) {
if ( ( V_60 = F_121 ( V_115 , V_209 = F_122 ( & V_210 [ V_208 ] , V_1 ) ) ) < 0 )
return V_60 ;
if ( V_208 == 1 )
V_1 -> V_111 = V_209 ;
}
...
static void F_123 ( struct V_207 * V_115 )
{
F_73 ( V_115 -> V_146 ) ;
}
static int
F_124 ( struct V_151 * V_34 , const struct V_211 * V_212 )
{
static int V_153 ;
struct V_1 * V_1 ;
struct V_207 * V_115 ;
...
V_60 = F_125 ( & V_34 -> V_153 , V_217 [ V_153 ] , V_118 [ V_153 ] , V_218 ,
...
V_115 -> V_221 , V_1 -> V_157 , V_1 -> V_68 , V_1 -> V_93 ) ;
