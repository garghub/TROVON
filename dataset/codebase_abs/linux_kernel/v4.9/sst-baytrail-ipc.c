...
V_84 = F_37 ( & V_14 -> V_26 , V_6 , NULL , 0 , NULL , 0 ) ;
if ( V_84 < 0 ) {
F_38 ( V_14 -> V_31 , L_3 ,
V_16 -> V_4 ) ;
return - V_88 ;
...
V_93 = & V_92 ;
V_78 = sizeof( V_92 ) ;
V_84 = F_42 ( & V_14 -> V_26 , V_6 , V_93 , V_78 ) ;
if ( V_84 < 0 )
F_38 ( V_14 -> V_31 , L_4 ,
V_16 -> V_4 ) ;
return V_84 ;
...
T_7 V_108 )
{
* ( T_5 * ) V_18 -> V_107 = ( T_5 ) ( V_18 -> V_6 & ( T_5 ) - 1 ) ;
memcpy ( V_18 -> V_107 + sizeof( T_5 ) , V_107 , V_108 ) ;
V_18 -> V_108 += sizeof( T_5 ) ;
}
static T_1 F_66 ( T_1 V_6 , T_1 * V_116 )
{
* V_116 = V_7 |
V_9 << V_8 ;
V_6 &= * V_116 ;
