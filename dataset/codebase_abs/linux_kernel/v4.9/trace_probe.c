...
V_31 = - V_32 ;
} else if ( strcmp ( V_33 , L_9 ) == 0 ) {
if ( strcmp ( V_34 -> V_3 , L_10 ) != 0 &&
strcmp ( V_34 -> V_3 , L_11 ) != 0 )
return - V_32 ;
...
V_49 = F_12 ( NULL , V_15 ) ;
* V_30 = '\0' ;
V_48 = F_26 ( sizeof( struct V_8 ) , V_50 ) ;
if ( ! V_48 )
return - V_51 ;
V_48 -> V_29 = V_29 ;
V_48 -> V_27 = V_34 -> V_27 [ V_45 ] ;
V_48 -> V_52 = F_18 ( V_34 ,
V_48 -> V_27 , V_15 ) ;
V_31 = F_22 ( V_33 , V_49 , & V_48 -> V_10 , V_37 ,
V_38 , V_15 ) ;
if ( V_31 )
F_9 ( V_48 ) ;
else {
V_36 -> V_11 = V_34 -> V_27 [ V_53 ] ;
V_36 -> V_4 = ( void * ) V_48 ;
}
}
break;
...
static int F_28 ( const char * V_54 ,
...
if ( * V_54 != 'b' )
return 0 ;
V_55 = F_26 ( sizeof( * V_55 ) , V_50 ) ;
if ( ! V_55 )
return - V_51 ;
V_55 -> V_10 = * V_36 ;
V_36 -> V_11 = V_34 -> V_27 [ V_59 ] ;
V_36 -> V_4 = ( void * ) V_55 ;
V_56 = F_29 ( V_54 + 1 , & V_58 , 0 ) ;
if ( V_56 == 0 || * V_58 != '@' )
return - V_32 ;
V_54 = V_58 + 1 ;
V_57 = F_29 ( V_54 , & V_58 , 0 ) ;
if ( V_58 == V_54 || * V_58 != '/' )
return - V_32 ;
V_55 -> V_60 = F_30 ( V_34 -> V_61 ) - ( V_56 + V_57 ) ;
V_55 -> V_62 = V_55 -> V_60 + V_57 ;
return ( F_30 ( V_34 -> V_61 ) < ( V_56 + V_57 ) ) ? - V_32 : 0 ;
}
int F_31 ( char * V_33 , T_3 * V_61 ,
struct V_63 * V_64 , bool V_37 , bool V_38 ,
const struct V_14 * V_15 )
{
const char * V_34 ;
int V_31 ;
...
V_64 -> V_67 = F_32 ( V_33 , V_50 ) ;
if ( ! V_64 -> V_67 ) {
F_27 ( L_14 , V_33 ) ;
return - V_51 ;
}
V_34 = strchr ( V_64 -> V_67 , ':' ) ;
if ( V_34 ) {
V_33 [ V_34 - V_64 -> V_67 ] = '\0' ;
V_34 ++ ;
}
if ( ! V_34 && strcmp ( V_33 , L_15 ) == 0 )
V_34 = L_10 ;
V_64 -> type = F_12 ( V_34 , V_15 ) ;
if ( ! V_64 -> type ) {
F_27 ( L_16 , V_34 ) ;
return - V_32 ;
}
V_64 -> V_29 = * V_61 ;
* V_61 += V_64 -> type -> V_61 ;
V_31 = F_22 ( V_33 , V_64 -> type , & V_64 -> V_27 , V_37 ,
V_38 , V_15 ) ;
if ( V_31 >= 0 && V_34 != NULL )
V_31 = F_28 ( V_34 , V_64 -> type , & V_64 -> V_27 ) ;
if ( V_31 >= 0 ) {
V_64 -> V_52 . V_11 = F_18 ( V_64 -> type ,
V_64 -> V_27 . V_11 ,
V_15 ) ;
V_64 -> V_52 . V_4 = V_64 -> V_27 . V_4 ;
}
return V_31 ;
}
int F_33 ( const char * V_3 ,
struct V_63 * args , int V_68 )
{
int V_16 ;
for ( V_16 = 0 ; V_16 < F_34 ( V_69 ) ; V_16 ++ )
if ( strcmp ( V_69 [ V_16 ] , V_3 ) == 0 )
return 1 ;
...
void F_35 ( struct V_63 * V_33 )
{
if ( F_5 ( V_70 , V_33 -> V_27 . V_11 ) )
F_10 ( V_33 -> V_27 . V_4 ) ;
...
int F_37 ( const char * V_71 , int (* F_38)( int , char * * ) )
{
char * * V_72 ;
int V_73 , V_31 ;
V_73 = 0 ;
V_31 = 0 ;
V_72 = F_39 ( V_50 , V_71 , & V_73 ) ;
if ( ! V_72 )
return - V_51 ;
if ( V_73 )
V_31 = F_38 ( V_73 , V_72 ) ;
...
T_3 F_41 ( struct V_74 * V_74 , const char T_4 * V_75 ,
T_5 V_76 , T_6 * V_77 ,
int (* F_38)( int , char * * ) )
{
char * V_78 , * V_30 ;
...
static int F_45 ( struct V_83 * V_84 , char * V_71 , int V_6 ,
bool V_37 )
{
int V_16 ;
int V_85 = 0 ;
const char * V_86 , * V_33 ;
if ( ! V_37 ) {
V_86 = L_18 ;
V_33 = L_19 V_87 ;
} else {
V_86 = L_20 ;
V_33 = L_19 V_88 L_21 V_89 ;
}
#define F_46 (len ? len - pos : 0)
V_85 += snprintf ( V_71 + V_85 , F_46 , L_22 , V_86 ) ;
for ( V_16 = 0 ; V_16 < V_84 -> V_90 ; V_16 ++ ) {
V_85 += snprintf ( V_71 + V_85 , F_46 , L_23 ,
V_84 -> args [ V_16 ] . V_3 , V_84 -> args [ V_16 ] . type -> V_86 ) ;
}
V_85 += snprintf ( V_71 + V_85 , F_46 , L_24 , V_33 ) ;
for ( V_16 = 0 ; V_16 < V_84 -> V_90 ; V_16 ++ ) {
if ( strcmp ( V_84 -> args [ V_16 ] . type -> V_3 , L_10 ) == 0 )
V_85 += snprintf ( V_71 + V_85 , F_46 ,
L_25 ,
V_84 -> args [ V_16 ] . V_3 ) ;
else
V_85 += snprintf ( V_71 + V_85 , F_46 , L_26 ,
V_84 -> args [ V_16 ] . V_3 ) ;
}
#undef F_46
return V_85 ;
}
int F_47 ( struct V_83 * V_84 , bool V_37 )
{
int V_6 ;
char * V_91 ;
V_6 = F_45 ( V_84 , NULL , 0 , V_37 ) ;
V_91 = F_42 ( V_6 + 1 , V_50 ) ;
if ( ! V_91 )
return - V_51 ;
F_45 ( V_84 , V_91 , V_6 + 1 , V_37 ) ;
V_84 -> V_92 . V_91 = V_91 ;
return 0 ;
}
