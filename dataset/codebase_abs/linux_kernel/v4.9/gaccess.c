...
case V_81 :
V_70 -> V_82 = V_64 >> V_83 ;
V_70 -> V_84 = V_25 == V_61 ? V_85 : V_86 ;
V_70 -> V_87 = F_21 ( V_2 -> V_3 . V_4 -> V_88 ) . V_87 ;
case V_46 :
case V_51 :
case V_53 :
case V_55 :
...
{
int V_6 ;
struct F_21 V_91 = F_21 ( V_2 -> V_3 . V_4 -> V_88 ) ;
if ( ! V_91 . V_92 ) {
V_22 -> V_19 = 0 ;
V_22 -> V_93 = 1 ;
return 0 ;
...
if ( V_25 == V_94 )
V_91 . V_87 = V_91 . V_87 == V_95 ? V_95 : V_96 ;
switch ( V_91 . V_87 ) {
case V_96 :
V_22 -> V_19 = V_2 -> V_3 . V_4 -> V_40 [ 1 ] ;
return 0 ;
...
if ( V_6 > 0 )
return F_20 ( V_2 , V_6 , V_90 , V_23 , V_25 , V_72 ) ;
return V_6 ;
}
return 0 ;
}
...
enum V_24 V_25 )
{
union V_100 V_101 = { . V_82 = V_64 } ;
union V_102 V_103 = { . V_82 = V_64 } ;
union V_104 V_105 ;
int V_106 = 0 ;
union V_107 V_107 ;
unsigned long V_108 ;
...
V_112:
V_103 . V_82 = F_28 ( V_2 , V_103 . V_82 ) ;
V_146:
if ( V_25 == V_61 && V_106 )
return V_62 ;
if ( F_27 ( V_2 -> V_7 , V_103 . V_82 ) )
return V_48 ;
* V_99 = V_103 . V_82 ;
return 0 ;
}
...
if ( V_6 )
return F_20 ( V_2 , V_6 , V_90 , V_23 , V_25 , V_74 ) ;
V_90 += V_165 ;
V_160 ++ ;
V_161 -- ;
}
...
if ( V_6 )
return V_6 ;
V_161 = ( ( ( V_90 & ~ V_164 ) + V_167 - 1 ) >> V_83 ) + 1 ;
V_160 = V_170 ;
if ( V_161 > F_34 ( V_170 ) )
...
if ( V_6 > 0 )
return F_20 ( V_2 , V_6 , V_64 , 0 , V_25 , V_74 ) ;
} else {
* V_99 = F_28 ( V_2 , V_64 ) ;
