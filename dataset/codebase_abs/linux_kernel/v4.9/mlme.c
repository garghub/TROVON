...
bool F_94 ( struct V_8 * V_9 , int V_140 , int V_141 ,
...
F_76 ( V_106 | V_108 ) ;
T_3 V_124 ;
F_95 ( V_9 , V_140 , V_141 ) ;
V_124 = ( F_4 ( V_15 -> V_34 ) & V_108 ) >> 4 ;
if ( ! ( V_144 -> V_110 & F_72 ( V_124 ) ) ) {
F_96 ( false ) ;
return false ;
}
V_44 = V_5 + F_97 ( V_15 -> V_34 ) ;
V_145 = V_6 - F_97 ( V_15 -> V_34 ) ;
F_62 ( & V_9 -> V_112 ) ;
F_74 (reg, &wdev->mgmt_registrations, list) {
if ( V_90 -> V_95 != V_147 )
continue;
...
void F_99 ( struct V_96 * V_149 )
{
struct V_150 * V_150 = F_100 ( V_149 ) ;
struct V_12 * V_13 ;
struct V_151 V_152 ;
struct V_153 * V_154 ;
struct V_47 * V_155 ;
...
continue;
V_157 = V_155 -> V_167 + F_101 (
V_168 ) ;
if ( F_102 ( V_169 , V_157 ) ) {
V_155 -> V_165 = V_170 ;
V_155 -> V_167 = V_169 ;
F_103 ( & V_152 , V_155 ,
V_171 ) ;
...
V_158 = F_75 ( V_158 , V_157 - V_169 ) ;
V_156 = true ;
}
}
F_70 () ;
if ( V_156 )
F_105 ( V_173 , & V_13 -> V_160 ,
V_158 ) ;
}
...
unsigned long V_157 ;
F_107 ( V_11 , V_152 ) ;
F_108 ( V_11 , V_152 , V_166 ) ;
V_157 = F_101 ( V_168 ) ;
F_105 ( V_173 , & V_13 -> V_160 ,
V_157 ) ;
F_104 ( V_13 , V_152 , V_174 , NULL , V_40 ) ;
}
...
V_157 = V_9 -> V_179 +
F_101 ( V_9 -> V_180 ) ;
F_22 ( ! F_102 ( V_169 , V_157 ) ) ;
F_108 ( V_11 , V_152 , V_181 ) ;
break;
case V_182 :
break;
default:
...
V_9 -> V_177 = false ;
F_104 ( V_13 , V_152 , V_176 , V_25 , V_40 ) ;
}
