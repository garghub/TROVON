...
static long F_82 ( void T_3 * V_152 , struct V_59 * V_60 , T_2 V_153 )
{
struct V_154 T_3 * V_155 = V_152 ;
T_2 V_38 ;
if ( F_83 ( V_60 -> V_132 , & V_155 -> V_141 ) )
return - V_85 ;
V_38 = ( V_153 > V_60 -> V_139 ) ? V_60 -> V_139 : V_153 ;
if ( F_84 ( V_155 -> V_142 , V_60 , V_38 ) )
return - V_85 ;
return V_38 ;
}
static inline struct V_59 * F_85 ( void T_3 * V_64 , T_2 V_153 )
{
struct V_59 * V_156 ;
V_156 = F_72 ( V_64 , V_153 ) ;
if ( ! F_4 ( V_156 ) )
V_156 -> V_139 = V_153 ;
return V_156 ;
}
static inline void F_86 ( struct V_59 * V_156 )
{
if ( V_156 )
F_41 ( V_156 ) ;
}
...
return V_158 ? : F_36 ( - V_102 ) ;
}
long F_89 ( int V_89 , void T_3 * V_64 , T_2 V_153 , long V_149 , int V_19 ,
long (* F_90)( void T_3 * , struct V_59 * , T_2 ) )
{
int V_22 ;
struct V_1 * V_14 ;
struct V_2 * V_3 ;
struct V_59 * V_60 , * V_156 = NULL ;
F_38 ( V_47 ) ;
V_3 = V_42 -> V_143 -> V_144 ;
if ( V_89 < 0 || ( long ) V_153 < 0 )
return - V_84 ;
if ( V_19 & V_150 ) {
if ( ( V_19 & V_151 ) || ! ( V_19 & V_146 ) )
return - V_84 ;
V_156 = F_85 ( V_64 , F_91 ( T_2 , V_153 , V_3 -> V_109 ) ) ;
if ( F_4 ( V_156 ) )
return F_54 ( V_156 ) ;
}
...
if ( ! F_4 ( V_60 ) ) {
if ( ( V_153 < V_60 -> V_139 ) && ! ( V_19 & V_161 ) ) {
V_60 = F_36 ( - V_140 ) ;
goto V_101;
}
if ( V_19 & V_150 ) {
V_60 = F_92 ( V_60 , V_156 ) ;
goto V_101;
}
F_29 ( & V_60 -> V_148 ) ;
V_14 -> V_29 -- ;
...
V_160 . V_138 = V_153 ;
V_160 . V_58 = F_36 ( - V_102 ) ;
F_26 ( V_43 ) ;
F_22 ( & V_14 -> V_7 ) ;
F_23 () ;
F_76 () ;
F_52 () ;
V_60 = F_93 ( V_160 . V_58 ) ;
if ( V_60 != F_36 ( - V_102 ) )
goto V_96;
F_56 ( & V_14 -> V_7 ) ;
V_60 = V_160 . V_58 ;
...
F_95 ( & V_3 -> V_63 , 0 ) ;
F_95 ( & V_3 -> V_62 , 0 ) ;
F_96 ( & V_3 -> V_167 [ V_168 ] ) ;
}
void F_97 ( struct V_2 * V_3 )
{
F_98 ( V_3 , & F_3 ( V_3 ) , F_37 ) ;
F_99 ( & V_3 -> V_167 [ V_168 ] . V_169 ) ;
}
static int F_100 ( struct V_170 * V_8 , void * V_171 )
{
struct V_172 * V_173 = F_101 ( V_8 ) ;
struct V_1 * V_14 = V_171 ;
F_102 ( V_8 ,
L_1 ,
V_14 -> V_7 . V_18 ,
V_14 -> V_7 . V_4 ,
...
V_14 -> V_32 ,
V_14 -> V_33 ,
F_103 ( V_173 , V_14 -> V_7 . V_87 ) ,
F_104 ( V_173 , V_14 -> V_7 . V_88 ) ,
F_103 ( V_173 , V_14 -> V_7 . V_174 ) ,
F_104 ( V_173 , V_14 -> V_7 . V_175 ) ,
V_14 -> V_25 ,
V_14 -> V_26 ,
V_14 -> V_27 ) ;
return 0 ;
