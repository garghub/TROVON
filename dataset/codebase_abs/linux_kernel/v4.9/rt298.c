...
struct V_85 * V_87 )
{
struct V_53 * V_54 = F_24 ( V_86 -> V_64 ) ;
struct V_55 * V_56 = F_7 ( V_54 ) ;
if ( V_56 -> V_88 == V_89 )
return 1 ;
else
...
static int F_25 ( struct V_85 * V_90 ,
struct V_91 * V_92 , int V_93 )
{
struct V_53 * V_54 = F_24 ( V_90 -> V_64 ) ;
switch ( V_93 ) {
case V_94 :
F_8 ( V_54 ,
V_25 , V_95 ) ;
...
static int F_26 ( struct V_85 * V_90 ,
struct V_91 * V_92 , int V_93 )
{
struct V_53 * V_54 = F_24 ( V_90 -> V_64 ) ;
switch ( V_93 ) {
...
static int F_27 ( struct V_85 * V_90 ,
struct V_91 * V_92 , int V_93 )
{
struct V_53 * V_54 = F_24 ( V_90 -> V_64 ) ;
unsigned int V_98 ;
V_98 = ( V_90 -> V_3 >> 20 ) & 0xff ;
switch ( V_93 ) {
case V_94 :
F_28 ( V_54 ,
F_3 ( V_99 , V_98 , 0 ) ,
0x7080 , 0x7000 ) ;
if ( ! ( F_29 ( V_54 , V_100 ) & 0x200 ) ) {
F_30 ( L_5 ) ;
switch ( V_98 ) {
case V_50 :
F_28 ( V_54 ,
...
static int F_32 ( struct V_85 * V_90 ,
struct V_91 * V_92 , int V_93 )
{
struct V_53 * V_54 = F_24 ( V_90 -> V_64 ) ;
switch ( V_93 ) {
...
int V_88 , unsigned int V_124 , int V_125 )
{
struct V_53 * V_54 = V_111 -> V_54 ;
struct V_55 * V_56 = F_7 ( V_54 ) ;
F_38 ( V_54 -> V_2 , L_10 , V_126 , V_124 ) ;
if ( V_89 == V_88 ) {
F_28 ( V_54 ,
V_127 , 0x0100 , 0x0 ) ;
F_28 ( V_54 ,
...
static int F_41 ( struct V_110 * V_111 , unsigned int V_130 )
{
struct V_53 * V_54 = V_111 -> V_54 ;
F_38 ( V_54 -> V_2 , L_13 , V_126 , V_130 ) ;
if ( 50 == V_130 )
F_28 ( V_54 ,
V_114 , 0x1000 , 0x1000 ) ;
else
...
static T_1 F_44 ( int V_137 , void * V_138 )
{
struct V_55 * V_56 = V_138 ;
bool V_61 = false ;
bool V_62 = false ;
int V_139 , V_80 = 0 ;
V_139 = F_9 ( V_56 , & V_61 , & V_62 ) ;
F_12 ( V_56 -> V_70 , V_140 , 0x1 , 0x1 ) ;
if ( V_139 == 0 ) {
if ( V_61 == true )
V_80 |= V_81 ;
if ( V_62 == true )
...
V_56 -> V_71 = - 1 ;
if ( V_56 -> V_141 -> V_137 ) {
V_139 = F_68 ( V_56 -> V_141 -> V_137 , NULL , F_44 ,
