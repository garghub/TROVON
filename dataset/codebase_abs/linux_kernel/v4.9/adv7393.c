...
int V_18 = 0 ;
int V_19 ;
for ( V_19 = 0 ; V_19 < F_8 ( V_72 ) ; V_19 += 2 ) {
V_18 = F_4 ( V_3 , V_72 [ V_19 ] ,
V_72 [ V_19 + 1 ] ) ;
if ( V_18 ) {
F_10 ( V_3 , L_10 ) ;
return V_18 ;
...
struct V_1 * V_13 ;
int V_18 ;
if ( ! F_19 ( V_11 -> V_74 , V_75 ) )
return - V_76 ;
F_20 ( V_11 , L_13 ,
V_11 -> V_77 << 1 , V_11 -> V_74 -> V_78 ) ;
V_13 = F_21 ( & V_11 -> V_79 , sizeof( * V_13 ) , V_80 ) ;
if ( V_13 == NULL )
return - V_81 ;
V_13 -> V_44 = V_82 ;
V_13 -> V_29 = 0x00 ;
