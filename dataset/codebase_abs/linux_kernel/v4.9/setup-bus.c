...
int F_49 ( struct V_7 * V_62 , int V_20 )
{
...
if ( ! V_27 )
V_12 = V_125 ;
else if ( F_58 ( V_27 + V_12 , V_12 ) < V_125 )
V_12 = V_125 >> 1 ;
V_27 += V_122 [ V_124 ] ;
}
return V_12 ;
...
V_120 = F_59 ( V_110 , V_111 , 0 , F_24 ( V_100 ) , V_12 ) ;
V_56 = F_62 ( V_12 , V_56 ) ;
if ( V_121 > V_11 )
V_11 = V_121 ;
V_112 = ( ! V_36 || ( V_36 && ! V_11 ) ) ? V_120 :
...
void F_71 ( struct V_60 * V_61 , struct V_1 * V_36 )
{
struct V_7 * V_8 ;
...
static void F_74 ( struct V_60 * V_147 , struct V_9 * V_22 )
{
int V_20 ;
struct V_9 * V_153 ;
...
{
if ( ! strncmp ( V_163 , L_16 , 3 ) )
V_164 = V_165 ;
else if ( ! strncmp ( V_163 , L_17 , 2 ) )
V_164 = V_166 ;
}
