...
struct V_186 * V_187 ;
int V_168 ;
V_187 = F_112 ( V_12 -> V_47 ) ;
for ( V_168 = 0 ; V_168 < V_187 -> V_188 ; V_168 ++ ) {
...
V_203 . V_163 = V_150 ;
V_203 . V_2 = V_2 ;
V_204 = V_147 ? V_205 : V_206 ;
F_126 ( V_204 , V_8 , & V_203 . V_203 ) ;
}
}
static void F_127 ( struct V_12 * V_12 ,
char * V_207 , int V_208 ,
bool V_147 )
{
struct V_1 * V_1 ;
char V_150 [ V_192 ] ;
...
bool V_209 = true ;
int V_34 ;
F_128 ( V_207 , V_208 , V_150 , & V_5 , & V_46 ) ;
V_1 = V_12 -> V_171 [ V_46 ] ;
if ( ! V_1 ) {
F_129 ( V_12 -> V_210 -> V_8 , L_20 ) ;
goto V_211;
}
if ( F_120 ( V_5 ) ) {
struct V_1 * V_9 ;
...
bool V_209 = true ;
int V_34 ;
F_133 ( V_207 , V_208 , V_150 , & V_5 , & V_158 ) ;
V_1 = F_111 ( V_12 , V_158 ) ;
if ( ! V_1 ) {
F_129 ( V_12 -> V_210 -> V_8 , L_23 ) ;
goto V_211;
}
if ( F_120 ( V_5 ) ) {
struct V_1 * V_9 ;
...
{
F_138 ( & V_12 -> V_217 . V_218 ,
F_139 ( V_12 -> V_217 . V_219 ) ) ;
}
static void F_140 ( struct V_220 * V_221 )
{
struct V_12 * V_12 ;
char * V_207 ;
T_2 V_193 ;
int V_168 ;
int V_34 ;
V_207 = F_12 ( V_222 , V_44 ) ;
if ( ! V_207 )
return;
V_12 = F_141 ( V_221 , struct V_12 , V_217 . V_218 . V_221 ) ;
F_142 () ;
F_143 ( V_207 ) ;
V_34 = F_116 ( V_12 -> V_47 , F_19 ( V_223 ) , V_207 ) ;
if ( V_34 ) {
F_129 ( V_12 -> V_210 -> V_8 , L_24 ) ;
goto V_197;
}
V_193 = F_144 ( V_207 ) ;
for ( V_168 = 0 ; V_168 < V_193 ; V_168 ++ )
F_135 ( V_12 , V_207 , V_168 ) ;
V_197:
F_145 () ;
F_20 ( V_207 ) ;
F_137 ( V_12 ) ;
...
{
int V_34 ;
V_34 = F_32 ( V_12 , V_224 ) ;
if ( V_34 ) {
F_147 ( V_12 -> V_210 -> V_8 , L_25 ) ;
return V_34 ;
}
F_148 ( & V_12 -> V_217 . V_218 , F_140 ) ;
V_12 -> V_217 . V_219 = V_225 ;
F_137 ( V_12 ) ;
return 0 ;
}
static void F_149 ( struct V_12 * V_12 )
{
F_150 ( & V_12 -> V_217 . V_218 ) ;
}
