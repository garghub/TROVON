...
V_27 = F_27 ( V_112 ) ;
F_112 ( V_27 ) ;
if ( V_112 && F_113 ( & V_112 -> V_98 ) <= 1 )
F_97 ( V_112 ) ;
if ( V_53 == NULL )
V_53 = & V_114 ;
V_21 -> V_113 = V_53 ;
F_114 ( V_21 -> V_53 , & V_114 ) ;
F_115 ( V_27 ) ;
return V_112 ;
}
...
{
struct V_3 * V_53 ;
const struct V_81 * V_82 = V_116 ;
if ( V_22 -> V_117 & V_118 )
V_82 = & V_119 ;
V_53 = F_92 ( V_21 , V_82 , V_120 ) ;
if ( ! V_53 ) {
F_117 ( V_22 , L_3 ) ;
return;
}
if ( ! F_118 ( V_22 ) )
V_53 -> V_24 |= V_25 | V_121 ;
V_21 -> V_113 = V_53 ;
}
...
V_22 -> V_53 = V_10 -> V_113 ;
F_59 ( & V_22 -> V_53 -> V_98 ) ;
} else {
V_53 = F_92 ( V_10 , & V_122 , V_120 ) ;
if ( V_53 ) {
V_22 -> V_53 = V_53 ;
V_53 -> V_82 -> V_123 ( V_53 ) ;
}
}
#ifdef F_105
if ( V_22 -> V_53 )
...
int * V_126 = V_124 ;
if ( ! ( V_125 -> V_24 & V_107 ) )
F_123 ( V_127 , & V_125 -> V_49 ) ;
F_114 ( V_21 -> V_53 , V_125 ) ;
if ( V_126 ) {
V_21 -> V_36 = 0 ;
* V_126 = 1 ;
}
...
F_112 ( F_27 ( V_53 ) ) ;
if ( ! ( V_53 -> V_24 & V_107 ) )
F_128 ( V_127 , & V_53 -> V_49 ) ;
F_114 ( V_21 -> V_53 , V_130 ) ;
F_97 ( V_53 ) ;
F_115 ( F_27 ( V_53 ) ) ;
}
}
...
{
V_22 -> V_53 = & V_114 ;
F_120 ( V_22 , F_140 , & V_114 ) ;
if ( F_125 ( V_22 ) )
F_140 ( V_22 , F_125 ( V_22 ) , & V_114 ) ;
...
{
F_120 ( V_22 , F_143 , & V_114 ) ;
if ( F_125 ( V_22 ) )
F_143 ( V_22 , F_125 ( V_22 ) , & V_114 ) ;
F_96 ( V_22 -> V_53 ) ;
V_22 -> V_53 = & V_114 ;
F_145 ( F_146 ( & V_22 -> V_46 ) ) ;
}
void F_147 ( struct V_138 * V_139 ,
const struct V_140 * V_141 ,
T_2 V_142 )
{
memset ( V_139 , 0 , sizeof( * V_139 ) ) ;
V_139 -> V_143 = V_141 -> V_143 ;
V_139 -> V_144 = F_148 ( T_2 , V_141 -> V_145 , V_142 ) ;
V_139 -> V_146 = ( V_141 -> V_146 & V_147 ) ;
V_139 -> V_148 = 1 ;
if ( V_139 -> V_144 > 0 ) {
T_2 V_149 = V_150 ;
for (; ; ) {
V_139 -> V_148 = F_149 ( V_149 , V_139 -> V_144 ) ;
