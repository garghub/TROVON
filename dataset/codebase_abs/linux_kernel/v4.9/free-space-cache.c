...
F_101 ( V_94 , V_167 ) ;
if ( V_6 == V_167 -> V_6 ) {
T_1 V_220 = F_128 ( V_85 , V_167 -> V_85 ) ;
V_167 -> V_85 -= V_220 ;
V_167 -> V_6 += V_220 ;
if ( V_167 -> V_85 ) {
V_16 = F_103 ( V_94 , V_167 ) ;
...
T_1 V_221 = V_167 -> V_85 + V_167 -> V_6 ;
...
if ( V_167 -> V_85 >= V_85 && ! V_28 -> V_222 )
V_183 ++ ;
F_187 ( V_28 -> V_22 ,
L_12 ,
V_167 -> V_6 , V_167 -> V_85 ,
( V_167 -> V_86 ) ? L_13 : L_14 ) ;
}
F_19 ( V_28 -> V_22 , L_15 ,
F_45 ( & V_28 -> V_133 ) ? L_14 : L_13 ) ;
F_19 ( V_28 -> V_22 ,
L_16 , V_183 ) ;
}
...
F_171 ( & V_94 -> V_223 ) ;
F_193 ( & V_94 -> V_156 ) ;
V_94 -> V_182 = ( V_224 / 2 ) / sizeof( struct V_91 ) ;
}
static int
F_194 (
struct V_27 * V_28 ,
...
V_238 = F_147 ( V_85 , V_94 -> V_161 ) ;
V_239 = F_147 ( V_237 , V_94 -> V_161 ) ;
if ( V_88 -> V_191 &&
V_88 -> V_191 < V_236 )
return - V_50 ;
V_98:
...
V_240 += V_186 ;
if ( V_128 -> V_235 < V_186 * V_94 -> V_161 )
V_128 -> V_235 = V_186 * V_94 -> V_161 ;
if ( V_240 < V_238 || V_128 -> V_235 < V_236 ) {
V_76 = V_189 + 1 ;
goto V_98;
}
V_128 -> V_225 = V_135 * V_94 -> V_161 + V_88 -> V_6 ;
...
F_17 ( & V_28 -> V_32 ) ;
F_17 ( & V_254 -> V_32 ) ;
V_16 = F_216 ( V_22 -> V_201 ,
V_135 , V_85 , & V_256 ) ;
if ( ! V_16 )
* V_250 += V_256 ;
F_44 ( & V_94 -> V_156 ) ;
F_189 ( V_28 , V_251 , V_252 ) ;
F_217 ( & V_132 -> V_112 ) ;
F_54 ( & V_94 -> V_156 ) ;
if ( V_255 ) {
F_15 ( & V_254 -> V_32 ) ;
...
V_132 . V_135 = V_141 ;
V_132 . V_85 = V_177 ;
F_110 ( & V_132 . V_112 , & V_94 -> V_223 ) ;
F_54 ( & V_94 -> V_156 ) ;
V_16 = F_215 ( V_28 , V_250 , V_135 , V_85 ,
V_141 , V_177 , & V_132 ) ;
if ( V_16 )
break;
V_102:
...
bool V_270 ;
F_15 ( & V_28 -> V_32 ) ;
V_270 = ( F_224 ( & V_28 -> V_265 ) &&
V_28 -> V_271 ) ;
F_17 ( & V_28 -> V_32 ) ;
if ( V_270 ) {
F_225 ( V_28 -> V_22 -> V_272 ) ;
V_267 = & V_28 -> V_22 -> V_273 . V_274 ;
F_226 ( & V_267 -> V_32 ) ;
V_269 = F_227 ( V_267 , V_28 -> V_8 . V_17 ,
1 ) ;
F_228 ( ! V_269 ) ;
F_229 ( V_267 , V_269 ) ;
F_230 ( & V_267 -> V_32 ) ;
F_231 ( V_28 -> V_22 -> V_272 ) ;
F_232 ( V_269 ) ;
F_232 ( V_269 ) ;
F_112 ( V_28 -> V_114 ) ;
}
...
F_222 ( V_28 ) ;
F_17 ( & V_28 -> V_32 ) ;
V_16 = F_218 ( V_28 , V_256 , V_135 , V_194 , V_259 ) ;
if ( V_16 )
goto V_107;
V_16 = F_221 ( V_28 , V_256 , V_135 , V_194 , V_259 ) ;
V_107:
F_223 ( V_28 ) ;
return V_16 ;
}
T_1 F_234 ( struct V_2 * V_275 )
{
...
int F_239 ( struct V_113 * V_22 , struct V_2 * V_3 )
{
struct V_93 * V_94 = V_3 -> V_276 ;
struct V_4 * V_5 ;
struct V_1 * V_1 ;
int V_16 = 0 ;
T_1 V_279 = F_240 ( & V_3 -> V_280 ) ;
if ( ! F_211 ( V_3 -> V_22 , V_281 ) )
return 0 ;
if ( F_237 ( V_22 ) )
return 0 ;
V_5 = F_43 () ;
...
V_287 = V_6 ;
V_288 = V_94 -> V_161 ;
V_16 = F_166 ( V_94 , V_167 , & V_287 , & V_288 , false ) ;
if ( ! V_16 ) {
if ( V_287 == V_6 ) {
V_16 = 1 ;
goto V_107;
