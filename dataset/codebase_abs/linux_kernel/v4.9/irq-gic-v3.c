...
static int T_7 F_113 ( void T_1 * V_5 ,
struct V_132 * V_133 ,
T_2 V_54 ,
T_3 V_65 ,
struct V_134 * V_135 )
...
V_4 . V_137 . V_138 = F_116 ( V_53 ) ;
V_136 = F_117 ( V_53 ) ;
if ( V_136 > 1020 )
V_136 = 1020 ;
V_4 . V_25 = V_136 ;
V_4 . V_44 = F_118 ( V_135 , & V_139 ,
& V_4 ) ;
V_4 . V_137 . V_140 = F_119 ( F_120 ( * V_4 . V_137 . V_140 ) ) ;
if ( F_71 ( ! V_4 . V_44 ) || F_71 ( ! V_4 . V_137 . V_140 ) ) {
V_42 = - V_141 ;
goto V_142;
}
F_121 ( F_39 ) ;
if ( F_67 ( V_76 ) && F_64 () )
F_122 ( V_135 , & V_4 . V_137 , V_4 . V_44 ) ;
F_81 () ;
F_46 () ;
F_65 () ;
F_88 () ;
...
if ( V_4 . V_44 )
F_123 ( V_4 . V_44 ) ;
F_124 ( V_4 . V_137 . V_140 ) ;
return V_42 ;
}
static int T_7 F_125 ( void T_1 * V_5 )
{
T_2 V_24 = F_6 ( V_5 + V_143 ) & V_59 ;
if ( V_24 != V_60 && V_24 != V_61 )
return - V_69 ;
return 0 ;
}
static int F_126 ( struct V_129 * V_144 )
{
const T_10 * V_145 ;
T_3 V_146 ;
int V_46 ;
V_145 = F_127 ( V_144 , L_14 , NULL ) ;
if ( ! V_145 )
return - 1 ;
V_146 = F_128 ( V_145 , F_129 ( V_144 ) ) ;
if ( V_146 & ~ V_147 )
return - 1 ;
...
static void T_7 F_131 ( struct V_129 * V_148 )
{
struct V_129 * V_149 , * V_150 ;
int V_151 = 0 , V_46 ;
int V_152 ;
struct V_153 * V_154 ;
V_149 = F_132 ( V_148 , L_15 ) ;
if ( ! V_149 )
return;
V_152 = F_133 ( V_149 ) ;
if ( ! V_152 )
return;
V_154 = F_134 ( sizeof( * V_154 ) * V_152 , V_155 ) ;
if ( F_71 ( ! V_154 ) )
return;
...
int V_157 ;
V_156 = & V_154 [ V_151 ] ;
V_156 -> V_158 = F_108 ( V_150 ) ;
F_55 ( L_16 ,
V_150 -> V_159 , V_151 ) ;
V_157 = F_136 ( V_150 , L_17 ,
sizeof( T_2 ) ) ;
F_71 ( V_157 <= 0 ) ;
for ( V_46 = 0 ; V_46 < V_157 ; V_46 ++ ) {
int V_42 , V_77 ;
T_2 V_160 ;
struct V_129 * V_161 ;
V_42 = F_137 ( V_150 , L_17 ,
V_46 , & V_160 ) ;
if ( F_71 ( V_42 ) )
continue;
V_161 = F_106 ( V_160 ) ;
...
if ( F_71 ( V_77 == - 1 ) )
continue;
F_138 ( L_18 , V_161 -> V_162 , V_77 ) ;
F_139 ( V_77 , & V_156 -> V_18 ) ;
}
F_138 ( L_19 ) ;
V_151 ++ ;
}
...
if ( F_71 ( ! V_33 ) )
continue;
V_164 = F_141 ( V_4 . V_116 , V_154 , V_152 ,
V_33 , & V_166 ) ;
if ( F_71 ( ! V_164 ) )
continue;
V_4 . V_128 [ V_46 ] = V_164 ;
}
}
static void T_7 F_142 ( struct V_129 * V_167 )
{
int V_124 ;
struct V_168 V_169 ;
T_2 V_170 ;
V_171 . type = V_172 ;
V_171 . V_173 = F_143 ( V_167 , 0 ) ;
if ( ! V_171 . V_173 )
return;
if ( F_144 ( V_167 , L_20 ,
& V_170 ) )
V_170 = 1 ;
V_170 += 3 ;
V_124 = F_145 ( V_167 , V_170 , & V_169 ) ;
if ( ! V_124 )
V_171 . V_36 = V_169 ;
F_146 ( & V_171 ) ;
}
static int T_7 F_147 ( struct V_129 * V_167 , struct V_129 * V_174 )
{
void T_1 * V_5 ;
struct V_132 * V_133 ;
T_3 V_65 ;
...
if ( F_144 ( V_167 , L_20 , & V_54 ) )
V_54 = 1 ;
V_133 = F_134 ( sizeof( * V_133 ) * V_54 , V_155 ) ;
if ( ! V_133 ) {
V_42 = - V_141 ;
goto V_176;
}
...
struct V_168 V_177 ;
int V_124 ;
V_124 = F_145 ( V_167 , 1 + V_46 , & V_177 ) ;
V_133 [ V_46 ] . V_57 = F_148 ( V_167 , 1 + V_46 ) ;
...
if ( F_149 ( V_167 , L_24 , & V_65 ) )
V_65 = 0 ;
V_42 = F_113 ( V_5 , V_133 , V_54 ,
V_65 , & V_167 -> V_116 ) ;
if ( V_42 )
goto V_178;
F_131 ( V_167 ) ;
...
struct V_189 * V_190 =
(struct V_189 * ) V_183 ;
T_2 V_24 = F_6 ( V_180 . V_5 + V_143 ) & V_59 ;
...
V_42 = F_113 ( V_180 . V_5 , V_180 . V_181 ,
V_180 . V_54 , 0 , V_216 ) ;
if ( V_42 )
goto V_220;
F_168 ( V_221 , V_216 ) ;
