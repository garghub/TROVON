...
int F_37 ( struct V_3 * V_4 , unsigned V_43 ,
struct V_23 * V_44 )
{
if ( V_43 >= V_22 )
return - V_45 ;
...
T_2 * V_46 ;
V_46 = F_38 ( V_44 -> V_28 , sizeof( T_2 ) ,
V_47 ) ;
if ( ! V_46 )
return - V_48 ;
V_44 -> V_29 = V_46 ;
...
return - V_45 ;
if ( F_47 ( & V_24 -> V_29 [ type ] ) == 1 )
return F_43 ( V_4 , V_24 , type ) ;
return 0 ;
}
bool F_48 ( struct V_3 * V_4 ,
struct V_23 * V_24 ,
unsigned type )
{
if ( ( type >= V_24 -> V_28 ) || ! V_24 -> V_29 )
return false ;
return F_47 ( & V_24 -> V_29 [ type ] ) == 1 ;
}
int F_49 ( struct V_3 * V_4 , struct V_23 * V_24 ,
unsigned type )
{
if ( ! V_4 -> V_8 -> V_57 )
return - V_58 ;
...
if ( ! V_24 -> V_29 || ! V_24 -> V_26 -> V_27 )
return - V_45 ;
if ( F_50 ( & V_24 -> V_29 [ type ] ) )
return F_43 ( V_4 , V_24 , type ) ;
return 0 ;
}
bool F_44 ( struct V_3 * V_4 , struct V_23 * V_24 ,
unsigned type )
{
if ( ! V_4 -> V_8 -> V_57 )
return false ;
...
unsigned F_60 ( struct V_3 * V_4 , unsigned V_43 )
{
V_4 -> V_20 . V_51 [ V_43 ] = F_61 ( V_4 -> V_20 . V_52 , V_43 ) ;
