...
if ( ! V_157 [ V_208 ] )
return - V_129 ;
V_88 = F_175 ( V_205 , F_170 ( V_157 [ V_208 ] ) ) ;
if ( V_88 == NULL )
return - V_209 ;
if ( F_176 ( V_88 ) )
V_88 = F_177 ( V_88 ) ;
...
void F_189 ( struct V_5 * V_6 , struct V_214 * V_202 )
{
struct V_8 * V_10 = F_73 ( V_6 ) ;
if ( V_10 -> V_41 == V_192 )
F_59 ( V_10 -> V_9 , V_10 ) ;
...
return 0 ;
return F_195 ( 0 )
+ V_10 -> V_21 * F_195 ( sizeof( V_218 ) * V_25 ) ;
}
...
static int F_207 ( struct V_232 * V_233 ,
unsigned long V_234 , void * V_235 )
{
struct V_5 * V_6 = F_208 ( V_235 ) ;
...
V_10 -> V_6 -> V_106 -> V_248 ( V_10 -> V_6 , & V_237 ) ;
F_215 ( & V_237 ) ;
break;
case V_249 :
return V_244 ;
