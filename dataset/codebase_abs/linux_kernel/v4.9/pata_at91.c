...
{
struct V_70 * V_71 = F_43 ( & V_69 -> V_10 ) ;
...
V_73 = F_44 ( V_69 , V_79 , 0 ) ;
if ( ! V_73 ) {
F_5 ( V_10 , L_14 ) ;
return - V_78 ;
}
V_76 = V_71 -> V_80 ;
V_67 = F_45 ( V_69 -> V_10 . V_81 , L_15 ) ;
if ( F_36 ( V_67 ) )
return F_37 ( V_67 ) ;
V_32 = F_32 ( V_10 ) ;
if ( V_32 < 0 )
...
V_29 = F_49 ( V_10 , sizeof( * V_29 ) , V_90 ) ;
if ( ! V_29 ) {
F_5 ( V_10 , L_17 ) ;
return - V_82 ;
}
...
V_46 -> V_47 = V_29 ;
V_32 = F_53 ( V_46 , F_47 ( V_76 ) ? F_54 ( V_76 ) : 0 ,
F_47 ( V_76 ) ? V_107 : NULL ,
V_75 , & V_108 ) ;
if ( V_32 )
goto V_100;
return 0 ;
