...
if ( ! V_4 )
return - V_31 ;
V_25 = F_19 ( V_23 , V_32 , 0 ) ;
if ( V_25 ) {
V_4 -> V_17 = ( unsigned int ) V_25 -> V_33 ;
V_28 = V_25 -> V_34 ;
}
if ( ! V_4 -> V_17 )
return - V_35 ;
...
F_10 ( V_4 -> V_9 , V_4 -> V_7 + V_14 ) ;
F_10 ( 0 , V_4 -> V_7 + V_8 ) ;
V_26 = F_25 ( & V_23 -> V_29 , V_4 -> V_17 , F_1 ,
V_28 , F_26 ( & V_23 -> V_29 ) , V_4 ) ;
if ( V_26 == - V_37 )
return - V_38 ;
if ( V_26 ) {
F_27 ( & V_23 -> V_29 , L_1 ,
...
F_28 ( V_4 -> V_17 , 1 ) ;
V_4 -> V_10 = F_29 ( V_23 -> V_29 . V_39 ,
V_40 ,
& V_41 , V_4 ) ;
if ( ! V_4 -> V_10 )
return - V_35 ;
if ( V_27 ) {
V_26 = F_30 ( V_4 -> V_10 , V_27 , 0 ,
V_40 ) ;
if ( V_26 ) {
F_27 ( & V_23 -> V_29 , L_2 ,
V_27 , V_27 + V_40 ) ;
