...
continue;
if ( V_156 && ( V_156 -> V_159 / sizeof( T_2 ) ) >= V_160 ) {
V_98 ++ ;
} else {
...
static int F_110 ( struct V_166 * V_167 , unsigned type )
{
struct V_89 * V_168 = F_108 ( V_167 ) ;
struct V_7 * V_8 = F_42 ( V_168 ) ;
unsigned long V_172 ;
...
F_114 ( & V_8 -> V_180 , V_172 ) ;
V_8 -> V_181 &= ~ ( V_182 << (
V_4 * V_183 ) ) ;
V_8 -> V_181 |= V_174 ;
F_115 ( & V_8 -> V_180 , V_172 ) ;
...
if ( V_188 == 0 )
break;
F_117 (n, &active_irqs, BITS_PER_LONG) {
V_191 = F_118 ( V_189 , V_190 ) ;
if ( V_191 ) {
...
F_119 ( F_120 ( V_8 -> V_89 . V_197 , V_190 ) ) ;
}
}
}
static void F_121 ( struct V_198 * V_199 )
{
struct V_200 * V_90 = F_122 ( V_199 ) ;
struct V_89 * V_168 = F_123 ( V_199 ) ;
struct V_7 * V_8 = F_42 ( V_168 ) ;
F_124 ( V_90 , V_199 ) ;
F_116 ( V_8 ) ;
F_125 ( V_90 , V_199 ) ;
}
static void F_126 ( struct V_198 * V_199 )
{
struct V_200 * V_90 = F_122 ( V_199 ) ;
struct V_50 * V_51 = F_123 ( V_199 ) ;
unsigned long V_201 ;
int V_190 ;
F_124 ( V_90 , V_199 ) ;
V_201 = F_43 ( V_51 -> V_202 ) ;
F_117 (n, &status, info->nbanks)
F_116 ( & V_51 -> V_152 [ V_190 ] ) ;
F_125 ( V_90 , V_199 ) ;
}
...
struct V_140 * V_110 = V_51 -> V_110 ;
int V_204 = F_128 ( V_102 , L_17 ) ;
struct V_205 V_206 , V_207 ;
int V_208 = 0 , V_209 ;
if ( F_129 ( V_102 , 0 , & V_206 ) )
return - V_210 ;
V_8 -> V_85 = F_130 ( V_110 , & V_206 ) ;
if ( F_94 ( V_8 -> V_85 ) )
return F_131 ( V_8 -> V_85 ) ;
V_8 -> V_89 = V_211 ;
...
return - V_112 ;
V_51 -> V_141 = F_140 ( V_102 , L_27 ) ;
if ( F_94 ( V_51 -> V_141 ) ) {
F_57 ( V_51 -> V_110 , L_28 ) ;
return F_131 ( V_51 -> V_141 ) ;
}
V_51 -> V_34 = F_141 ( V_230 , V_102 ) -> V_34 ;
V_229 = F_142 ( V_223 , 0 ) ;
if ( V_229 > 0 ) {
V_206 = F_143 ( V_223 ,
V_231 , L_29 ) ;
V_51 -> V_202 = F_130 ( & V_223 -> V_110 , V_206 ) ;
if ( F_94 ( V_51 -> V_202 ) )
return F_131 ( V_51 -> V_202 ) ;
F_144 ( V_229 , F_126 ,
V_51 ) ;
}
...
static int F_146 ( struct V_222 * V_223 )
{
struct V_50 * V_51 ;
struct V_224 * V_225 ;
int V_165 , V_37 ;
...
V_225 -> V_238 = & V_239 ;
V_225 -> V_240 = & V_241 ;
V_225 -> V_96 = F_148 ( & V_223 -> V_110 ) ;
V_51 -> V_242 = F_149 ( & V_223 -> V_110 , V_225 , V_51 ) ;
if ( F_94 ( V_51 -> V_242 ) ) {
F_57 ( & V_223 -> V_110 , L_33 ) ;
return F_131 ( V_51 -> V_242 ) ;
}
for ( V_37 = 0 ; V_37 < V_51 -> V_139 ; V_37 ++ )
F_150 ( V_51 -> V_242 , & V_51 -> V_152 [ V_37 ] . V_6 ) ;
return 0 ;
}
