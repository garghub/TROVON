...
return;
V_2 -> V_120 = F_59 ( V_84 ) ;
if ( ! ( V_2 -> V_7 -> V_33 & V_151 ) )
F_61 ( V_2 ) ;
F_62 () ;
V_134 = F_63 ( V_84 , V_152 ) ;
if ( ! V_134 ) {
F_64 () ;
return;
}
V_134 = F_43 ( V_134 , 2 + V_134 [ 1 ] , V_153 ) ;
F_64 () ;
if ( ! V_134 )
return;
...
if ( V_130 ) {
V_156 -> V_161 . V_129 = ( ( T_1 * ) V_156 ) + sizeof( * V_156 ) ;
V_156 -> V_161 . V_130 = V_130 ;
memcpy ( ( void * ) V_156 -> V_161 . V_129 , V_129 , V_130 ) ;
}
if ( V_132 ) {
V_156 -> V_161 . V_131 = ( ( T_1 * ) V_156 ) + sizeof( * V_156 ) + V_130 ;
V_156 -> V_161 . V_132 = V_132 ;
memcpy ( ( void * ) V_156 -> V_161 . V_131 , V_131 , V_132 ) ;
}
if ( V_84 )
F_58 ( F_59 ( V_84 ) ) ;
V_156 -> V_161 . V_84 = V_84 ;
V_156 -> V_161 . V_103 = V_103 ;
F_68 ( & V_2 -> V_162 , V_33 ) ;
...
V_156 -> type = V_166 ;
V_156 -> V_167 . V_129 = ( ( T_1 * ) V_156 ) + sizeof( * V_156 ) ;
V_156 -> V_167 . V_130 = V_130 ;
memcpy ( ( void * ) V_156 -> V_167 . V_129 , V_129 , V_130 ) ;
V_156 -> V_167 . V_131 = ( ( T_1 * ) V_156 ) + sizeof( * V_156 ) + V_130 ;
V_156 -> V_167 . V_132 = V_132 ;
memcpy ( ( void * ) V_156 -> V_167 . V_131 , V_131 , V_132 ) ;
V_156 -> V_167 . V_84 = V_84 ;
F_68 ( & V_2 -> V_162 , V_33 ) ;
F_69 ( & V_156 -> V_159 , & V_2 -> V_163 ) ;
F_70 ( & V_2 -> V_162 , V_33 ) ;
F_71 ( V_164 , & V_6 -> V_165 ) ;
...
V_2 -> V_120 = NULL ;
V_2 -> V_37 = 0 ;
F_77 ( V_6 , V_88 , V_125 , V_4 , V_65 , V_168 ) ;
...
V_181 == V_183 ) {
V_119 -> V_57 = V_180 ;
V_119 -> V_55 = V_177 -> V_15 [ V_180 ] . V_55 ;
V_119 -> V_56 = V_177 -> V_15 [ V_180 ] . V_56 ;
if ( V_119 -> V_69 . V_184 == 0 )
V_119 -> V_69 . V_184 = V_181 ;
if ( V_119 -> V_69 . V_185 == 0 ) {
V_119 -> V_69 . V_185 = 1 ;
V_119 -> V_69 . V_186 [ 0 ] = V_181 ;
}
}
V_119 -> V_69 . V_187 = V_177 -> V_15 ;
V_119 -> V_69 . V_188 = V_177 -> V_179 ;
} else {
if ( F_14 ( V_177 ) )
return - V_26 ;
}
