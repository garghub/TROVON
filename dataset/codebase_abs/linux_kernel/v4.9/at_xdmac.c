...
struct V_243 * V_244 ;
struct V_1 * V_2 ;
int V_211 , V_152 , V_245 , V_119 , V_120 ;
void T_1 * V_246 ;
T_2 V_34 ;
V_244 = F_113 ( V_233 , V_247 , 0 ) ;
if ( ! V_244 )
return - V_25 ;
V_211 = F_114 ( V_233 , 0 ) ;
if ( V_211 < 0 )
return V_211 ;
V_246 = F_115 ( & V_233 -> V_11 , V_244 ) ;
if ( F_116 ( V_246 ) )
return F_117 ( V_246 ) ;
V_34 = F_118 ( V_246 + V_248 ) ;
V_245 = F_119 ( V_34 ) ;
if ( V_245 > V_249 ) {
...
V_152 = sizeof( * V_2 ) ;
V_152 += V_245 * sizeof( struct V_6 ) ;
V_2 = F_120 ( & V_233 -> V_11 , V_152 , V_250 ) ;
if ( ! V_2 ) {
...
F_125 ( V_254 , V_2 -> V_14 . V_255 ) ;
F_125 ( V_256 , V_2 -> V_14 . V_255 ) ;
F_125 ( V_257 , V_2 -> V_14 . V_255 ) ;
F_125 ( V_258 , V_2 -> V_14 . V_255 ) ;
F_125 ( V_259 , V_2 -> V_14 . V_255 ) ;
F_125 ( V_260 , V_2 -> V_14 . V_255 ) ;
F_125 ( V_261 , V_2 -> V_14 . V_255 ) ;
V_2 -> V_14 . V_11 = & V_233 -> V_11 ;
V_2 -> V_14 . V_262 = F_100 ;
V_2 -> V_14 . V_263 = F_103 ;
V_2 -> V_14 . V_264 = F_77 ;
V_2 -> V_14 . V_265 = F_94 ;
V_2 -> V_14 . V_266 = F_65 ;
V_2 -> V_14 . V_267 = F_72 ;
...
V_2 -> V_14 . V_274 = F_97 ;
V_2 -> V_14 . V_275 = F_99 ;
V_2 -> V_14 . V_276 = V_277 ;
V_2 -> V_14 . V_278 = V_277 ;
V_2 -> V_14 . V_279 = F_126 ( V_94 ) | F_126 ( V_104 ) ;
V_2 -> V_14 . V_280 = V_281 ;
F_15 ( V_2 ) ;
F_33 ( & V_2 -> V_14 . V_282 ) ;
for ( V_119 = 0 ; V_119 < V_245 ; V_119 ++ ) {
struct V_6 * V_19 = & V_2 -> V_9 [ V_119 ] ;
V_19 -> V_9 . V_10 = & V_2 -> V_14 ;
F_28 ( & V_19 -> V_9 . V_283 ,
& V_2 -> V_14 . V_282 ) ;
V_19 -> V_284 = F_1 ( V_2 , V_119 ) ;
V_19 -> V_30 = 1 << V_119 ;
F_127 ( & V_19 -> V_68 ) ;
F_33 ( & V_19 -> V_70 ) ;
F_33 ( & V_19 -> V_78 ) ;
