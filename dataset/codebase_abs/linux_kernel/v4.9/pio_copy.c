...
static inline void F_5 ( T_4 * V_8 , const T_4 * V_24 , V_20 V_25 )
{
switch ( V_25 ) {
case 7 :
* V_8 ++ = * V_24 ++ ;
...
T_1 V_30 , V_31 ;
V_30 = * ( T_1 * ) V_24 ;
V_31 = V_4 -> V_27 . V_18 | ( V_30 << F_9 ( V_4 -> V_29 ) ) ;
F_2 ( V_31 , V_8 ) ;
V_4 -> V_27 . V_18 = V_30 >> F_10 ( V_4 -> V_29 ) ;
}
static inline void F_11 ( union V_16 V_27 , void T_3 * V_8 )
{
F_2 ( V_27 . V_18 , V_8 ) ;
}
