...
V_143 . V_145 = 0 ;
V_143 . V_146 . V_147 = 0 ;
V_143 . V_146 . V_148 = V_149 ;
V_143 . V_146 . V_150 = 1 ;
for ( V_144 = 0 ; V_144 < V_151 ; V_144 ++ )
F_9 ( V_152 [ V_144 * V_153 +
V_154 ] , V_143 . V_145 ) ;
return 0 ;
}
...
unsigned int V_170 )
{
return V_152 [ V_155 * V_153 + V_170 ] ;
}
...
static T_5 F_42 ( struct V_4 * V_5 , enum V_173 type )
{
struct V_3 * V_10 = (struct V_3 * ) V_5 ;
...
switch ( type ) {
case V_176 :
V_175 = ( const union V_174 * )
V_10 -> V_177 . V_178 -> V_163 ;
break;
case V_179 :
V_175 = ( const union V_174 * )
V_10 -> V_177 . V_180 -> V_163 ;
break;
case V_181 :
V_175 = ( const union V_174 * )
V_10 -> V_177 . V_182 -> V_163 ;
break;
case V_183 :
V_175 = ( const union V_174 * )
V_10 -> V_177 . V_184 -> V_163 ;
break;
case V_185 :
V_175 = ( const union V_174 * )
V_10 -> V_177 . V_186 -> V_163 ;
break;
case V_187 :
V_175 = ( const union V_174 * )
V_10 -> V_177 . V_188 -> V_163 ;
break;
case V_189 :
V_175 = ( const union V_174 * )
V_10 -> V_190 . V_191 [ 0 ] . V_192 -> V_163 ;
break;
case V_193 :
V_175 = ( const union V_174 * )
V_10 -> V_190 . V_191 [ 1 ] . V_192 -> V_163 ;
break;
default:
return 0 ;
}
