...
if ( F_55 ( V_9 ) )
return - V_192 ;
V_190 -> V_168 . V_193 = V_190 -> V_168 . V_185 = 0 ;
switch ( V_190 -> V_194 ) {
case V_195 :
if ( ! V_9 -> V_165 )
return - V_18 ;
...
int F_90 ( struct V_137 * V_137 , void * V_201 , struct V_189 * V_202 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
struct V_167 * V_176 = & V_9 -> V_121 ;
struct V_167 * V_177 = & V_9 -> V_123 ;
...
if ( ! V_9 -> V_165 )
return - V_18 ;
V_180 = F_91 ( V_202 -> V_37 , & V_202 -> V_168 ) ;
if ( V_180 )
return V_180 ;
F_69 ( & V_202 -> V_168 , & V_169 ) ;
F_70 ( & V_202 -> V_168 , & V_9 -> V_83 ) ;
F_74 ( & V_202 -> V_168 , & V_9 -> V_122 ) ;
V_202 -> V_168 . V_185 /= V_158 ;
V_202 -> V_168 . V_14 /= V_158 ;
if ( V_9 -> V_164 ) {
struct V_167 V_143 = V_9 -> V_13 ;
struct V_167 V_203 = {
0 , 0 ,
V_202 -> V_168 . V_84 * V_172 ,
V_202 -> V_168 . V_14 * V_172
} ;
struct V_167 V_204 = {
0 , 0 ,
V_202 -> V_168 . V_84 / V_172 ,
...
struct V_167 V_143 = V_9 -> V_13 ;
F_69 ( & V_143 , & V_202 -> V_168 ) ;
if ( ! F_92 ( & V_9 -> V_13 , & V_143 ) &&
F_73 ( & V_9 -> V_179 ) )
return - V_181 ;
V_9 -> V_13 = V_143 ;
F_77 ( & V_9 -> V_11 , V_143 . V_14 ) ;
F_75 ( V_177 , & V_202 -> V_168 ) ;
F_74 ( V_177 , & V_9 -> V_13 ) ;
} else {
if ( ! F_92 ( & V_202 -> V_168 , & V_9 -> V_13 ) &&
F_73 ( & V_9 -> V_179 ) )
return - V_181 ;
F_75 ( & V_9 -> V_13 , & V_202 -> V_168 ) ;
F_75 ( V_177 , & V_202 -> V_168 ) ;
F_74 ( V_177 , & V_9 -> V_13 ) ;
...
F_70 ( & V_202 -> V_168 , & V_203 ) ;
if ( V_9 -> V_165 ) {
struct V_167 V_204 = {
0 , 0 ,
V_202 -> V_168 . V_84 / V_172 ,
( V_202 -> V_168 . V_14 * V_158 ) / V_172
} ;
struct V_167 V_203 = {
0 , 0 ,
V_202 -> V_168 . V_84 * V_172 ,
...
V_202 -> V_168 . V_14 *= V_158 ;
F_70 ( & V_202 -> V_168 , & V_9 -> V_83 ) ;
F_75 ( V_176 , & V_202 -> V_168 ) ;
F_74 ( V_176 , & V_9 -> V_122 ) ;
V_202 -> V_168 . V_185 /= V_158 ;
V_202 -> V_168 . V_14 /= V_158 ;
} else {
F_75 ( & V_202 -> V_168 , & V_9 -> V_83 ) ;
V_202 -> V_168 . V_14 /= V_158 ;
}
F_74 ( & V_202 -> V_168 , & V_9 -> V_13 ) ;
if ( V_9 -> V_205 && ( V_177 -> V_84 != V_202 -> V_168 . V_84 ||
V_177 -> V_14 != V_202 -> V_168 . V_14 ) ) {
F_93 ( V_9 -> V_205 ) ;
V_9 -> V_205 = NULL ;
}
* V_177 = V_202 -> V_168 ;
...
switch ( F_39 ( V_9 ) ) {
case V_81 :
V_207 -> V_208 . V_209 = 11 ;
V_207 -> V_208 . V_210 = 10 ;
break;
case V_82 :
V_207 -> V_208 . V_209 = 54 ;
V_207 -> V_208 . V_210 = 59 ;
break;
case V_85 :
V_207 -> V_208 . V_209 = 1 ;
V_207 -> V_208 . V_210 = 1 ;
...
if ( V_9 -> V_187 )
return - V_188 ;
if ( V_140 -> V_212 >= F_76 ( V_213 ) )
return - V_18 ;
V_143 = & V_213 [ V_140 -> V_212 ] ;
...
struct V_214 * V_215 = & V_140 -> V_143 . V_215 ;
unsigned V_216 = V_215 -> V_216 ;
if ( V_9 -> V_187 )
return - V_188 ;
V_215 -> V_159 . V_185 = V_9 -> V_217 ;
V_215 -> V_159 . V_193 = V_9 -> V_218 ;
V_215 -> V_159 . V_84 = V_177 -> V_84 ;
V_215 -> V_159 . V_14 = V_177 -> V_14 ;
V_215 -> V_125 = V_9 -> V_219 ;
V_215 -> V_216 = V_9 -> V_220 ;
if ( V_216 > V_9 -> V_220 )
V_216 = V_9 -> V_220 ;
if ( V_9 -> V_205 == NULL )
V_215 -> V_221 = NULL ;
else if ( V_215 -> V_221 ) {
if ( F_97 ( V_215 -> V_221 , V_9 -> V_205 ,
( ( V_177 -> V_84 + 7 ) / 8 ) * V_177 -> V_14 ) )
return - V_222 ;
}
if ( V_216 && V_215 -> V_223 ) {
if ( F_97 ( V_215 -> V_223 , V_9 -> V_224 ,
V_216 * sizeof( V_9 -> V_224 [ 0 ] ) ) )
return - V_222 ;
}
return 0 ;
}
...
if ( V_9 -> V_187 )
return - V_188 ;
V_215 -> V_159 . V_193 = F_99 ( int , V_215 -> V_159 . V_193 ,
- V_9 -> V_183 . V_143 . V_84 , V_9 -> V_183 . V_143 . V_84 ) ;
V_215 -> V_159 . V_185 = F_99 ( int , V_215 -> V_159 . V_185 ,
- V_9 -> V_183 . V_143 . V_14 , V_9 -> V_183 . V_143 . V_14 ) ;
V_215 -> V_159 . V_84 = V_177 -> V_84 ;
V_215 -> V_159 . V_14 = V_177 -> V_14 ;
if ( V_215 -> V_125 != V_131 && V_215 -> V_125 != V_130 )
V_215 -> V_125 = V_226 ;
V_215 -> V_227 = 0 ;
V_215 -> V_228 = 0 ;
if ( V_215 -> V_216 && ! V_215 -> V_223 )
V_215 -> V_216 = 0 ;
if ( V_215 -> V_216 > V_229 )
V_215 -> V_216 = V_229 ;
if ( V_215 -> V_216 ) {
if ( F_100 ( V_9 -> V_230 , V_215 -> V_223 ,
V_215 -> V_216 * sizeof( V_9 -> V_224 [ 0 ] ) ) )
return - V_222 ;
for ( V_53 = 0 ; V_53 < V_215 -> V_216 ; V_53 ++ ) {
struct V_167 * V_168 = & V_9 -> V_230 [ V_53 ] . V_231 ;
...
V_168 -> V_193 = F_99 ( V_112 , V_168 -> V_193 , 0 , V_9 -> V_183 . V_143 . V_84 - 1 ) ;
V_168 -> V_84 = F_99 ( V_112 , V_168 -> V_84 , 1 , V_9 -> V_183 . V_143 . V_84 - V_168 -> V_193 ) ;
}
for ( V_53 = 0 ; V_53 < V_215 -> V_216 - 1 ; V_53 ++ ) {
struct V_167 * V_232 = & V_9 -> V_230 [ V_53 ] . V_231 ;
for ( V_225 = V_53 + 1 ; V_225 < V_215 -> V_216 ; V_225 ++ ) {
struct V_167 * V_233 = & V_9 -> V_230 [ V_225 ] . V_231 ;
if ( F_101 ( V_232 , V_233 ) )
return - V_18 ;
}
}
if ( F_97 ( V_215 -> V_223 , V_9 -> V_230 ,
V_215 -> V_216 * sizeof( V_9 -> V_224 [ 0 ] ) ) )
return - V_222 ;
}
return 0 ;
...
unsigned V_234 = ( ( V_177 -> V_84 + 7 ) / 8 ) * V_177 -> V_14 ;
unsigned V_235 = V_215 -> V_216 * sizeof( V_9 -> V_224 [ 0 ] ) ;
void * V_236 = NULL ;
if ( V_180 )
return V_180 ;
if ( V_215 -> V_221 ) {
...
if ( V_236 == NULL )
return - V_237 ;
if ( F_100 ( V_236 , V_215 -> V_221 , V_234 ) ) {
F_104 ( V_236 ) ;
return - V_222 ;
}
}
V_9 -> V_217 = V_215 -> V_159 . V_185 ;
V_9 -> V_218 = V_215 -> V_159 . V_193 ;
V_9 -> V_219 = V_215 -> V_125 ;
F_104 ( V_9 -> V_205 ) ;
V_9 -> V_205 = V_236 ;
V_9 -> V_220 = V_215 -> V_216 ;
if ( V_9 -> V_220 )
memcpy ( V_9 -> V_224 , V_9 -> V_230 , V_235 ) ;
return 0 ;
}
int F_105 ( struct V_137 * V_137 , void * V_201 , unsigned V_53 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( V_9 -> V_187 )
return - V_188 ;
if ( V_53 && V_9 -> V_238 == NULL )
return - V_18 ;
if ( V_53 && V_9 -> V_183 . V_143 . V_145 != V_9 -> V_20 -> V_146 ) {
F_6 ( V_9 , 1 , L_8 ) ;
return - V_18 ;
}
if ( V_9 -> V_182 && V_9 -> V_182 != V_201 )
return - V_181 ;
V_9 -> V_182 = V_53 ? V_201 : NULL ;
return 0 ;
}
int F_106 ( struct V_137 * V_137 , void * V_201 ,
struct V_239 * V_240 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( V_9 -> V_187 )
...
V_243 ;
V_240 -> V_37 = V_244 ;
V_240 -> V_143 . V_125 = V_99 ;
V_240 -> V_143 . V_114 = V_245 ;
V_240 -> V_143 . V_138 = 0 ;
return 0 ;
}
int F_107 ( struct V_137 * V_137 , void * V_201 ,
...
if ( V_9 -> V_187 )
return - V_188 ;
if ( ! F_108 ( V_246 ) && ! F_108 ( V_247 ) )
return - V_248 ;
if ( V_9 -> V_182 )
return - V_181 ;
if ( V_240 -> V_249 == NULL ) {
V_9 -> V_183 . V_249 = NULL ;
V_9 -> V_238 = NULL ;
return 0 ;
}
if ( V_240 -> V_143 . V_84 < 48 || V_240 -> V_143 . V_14 < 32 )
return - V_18 ;
V_143 = F_67 ( V_9 , V_240 -> V_143 . V_145 ) ;
if ( ! V_143 || ! V_143 -> V_250 )
return - V_18 ;
if ( V_240 -> V_143 . V_152 < ( V_240 -> V_143 . V_84 * V_143 -> V_173 [ 0 ] ) / 8 )
return - V_18 ;
if ( V_240 -> V_143 . V_14 * V_240 -> V_143 . V_152 < V_240 -> V_143 . V_153 )
return - V_18 ;
V_9 -> V_238 = F_109 ( ( unsigned long ) V_240 -> V_249 ) ;
V_9 -> V_183 = * V_240 ;
V_9 -> V_218 = F_99 ( int , V_9 -> V_218 ,
- V_9 -> V_183 . V_143 . V_84 , V_9 -> V_183 . V_143 . V_84 ) ;
...
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( V_252 -> V_212 >= V_9 -> V_253 )
return - V_18 ;
V_252 -> type = V_254 ;
switch ( V_9 -> V_91 [ V_252 -> V_212 ] ) {
case V_93 :
snprintf ( V_252 -> V_255 , sizeof( V_252 -> V_255 ) , L_9 ,
V_9 -> V_256 [ V_252 -> V_212 ] ) ;
V_252 -> V_257 = 0 ;
break;
case V_101 :
snprintf ( V_252 -> V_255 , sizeof( V_252 -> V_255 ) , L_10 ,
V_9 -> V_256 [ V_252 -> V_212 ] ) ;
V_252 -> type = V_258 ;
V_252 -> V_259 = V_260 ;
if ( V_9 -> V_261 )
V_252 -> V_262 = ( 1 << F_76 ( V_263 ) ) - 1 ;
V_252 -> V_257 = V_264 ;
break;
case V_102 :
snprintf ( V_252 -> V_255 , sizeof( V_252 -> V_255 ) , L_11 ,
V_9 -> V_256 [ V_252 -> V_212 ] ) ;
V_252 -> V_259 = V_260 ;
if ( V_9 -> V_261 )
V_252 -> V_262 = ( 1 << F_76 ( V_263 ) ) - 1 ;
...
break;
case V_109 :
snprintf ( V_252 -> V_255 , sizeof( V_252 -> V_255 ) , L_12 ,
V_9 -> V_256 [ V_252 -> V_212 ] ) ;
V_252 -> V_257 = V_265 ;
if ( V_9 -> V_266 == 0 ||
V_9 -> V_69 == V_267 )
V_252 -> V_268 |= V_269 ;
else if ( V_9 -> V_69 == V_270 ||
V_9 -> V_69 == V_271 )
V_252 -> V_268 |= V_272 ;
break;
}
...
if ( V_9 -> V_275 )
V_252 -> V_268 |= V_276 ;
if ( V_9 -> V_92 == V_252 -> V_212 && F_13 ( V_9 ) ) {
if ( V_9 -> V_70 == V_267 ) {
V_252 -> V_268 |= V_269 ;
} else if ( V_9 -> V_70 == V_270 ) {
V_252 -> V_268 |= V_272 ;
} else if ( F_34 ( V_9 ) ) {
...
if ( V_53 == V_9 -> V_92 )
return 0 ;
if ( F_73 ( & V_9 -> V_179 ) || F_73 ( & V_9 -> V_279 ) )
return - V_181 ;
V_9 -> V_92 = V_53 ;
V_9 -> V_280 . V_281 = 0 ;
if ( V_9 -> V_91 [ V_53 ] == V_101 || V_9 -> V_91 [ V_53 ] == V_102 ) {
V_9 -> V_282 = ( V_9 -> V_91 [ V_53 ] == V_101 ) ? 0 : 1 ;
V_9 -> V_280 . V_281 = V_260 ;
}
V_9 -> V_283 . V_281 = V_9 -> V_280 . V_281 ;
F_40 ( V_9 , false ) ;
if ( V_9 -> V_114 ) {
...
V_278 = 128 * V_53 + V_9 -> V_284 [ V_53 ] ;
F_113 ( V_9 -> V_278 ,
128 * V_53 , 255 + 128 * V_53 , 1 , 128 + 128 * V_53 ) ;
F_46 ( V_9 -> V_278 , V_278 ) ;
return 0 ;
}
int F_114 ( struct V_137 * V_137 , void * V_201 , struct V_285 * V_286 )
{
if ( V_286 -> V_212 >= F_76 ( V_263 ) )
return - V_18 ;
* V_286 = V_263 [ V_286 -> V_212 ] ;
return 0 ;
}
int F_115 ( struct V_137 * V_137 , void * V_201 , struct V_285 * V_286 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( ! F_13 ( V_9 ) )
return - V_18 ;
* V_286 = V_263 [ V_9 -> V_282 ] ;
return 0 ;
}
int F_116 ( struct V_137 * V_137 , void * V_201 , const struct V_285 * V_286 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( ! F_13 ( V_9 ) )
return - V_18 ;
if ( V_286 -> V_212 >= F_76 ( V_263 ) )
return - V_18 ;
V_9 -> V_282 = V_286 -> V_212 ;
return 0 ;
}
int F_117 ( struct V_137 * V_137 , void * V_201 , struct V_287 * V_288 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( V_288 -> V_289 != 0 )
return - V_18 ;
V_288 -> V_290 = V_9 -> V_72 ;
return 0 ;
}
int F_118 ( struct V_137 * V_137 , void * V_201 , const struct V_287 * V_288 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( V_288 -> V_289 != 0 )
return - V_18 ;
V_9 -> V_72 = F_99 ( unsigned , V_288 -> V_290 , V_291 , V_292 ) ;
if ( F_34 ( V_9 ) )
F_29 ( V_9 ) ;
return 0 ;
}
int F_119 ( struct V_137 * V_137 , void * V_201 , const struct V_293 * V_294 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( V_294 -> V_212 != 0 )
return - V_18 ;
...
return - V_18 ;
V_9 -> V_297 = V_294 -> V_295 ;
return 0 ;
}
int F_120 ( struct V_137 * V_137 , void * V_201 , struct V_293 * V_294 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
enum V_74 V_298 ;
if ( V_294 -> V_212 != 0 )
return - V_18 ;
V_294 -> V_241 = V_299 | V_300 |
V_301 | V_302 ;
V_294 -> V_295 = V_9 -> V_297 ;
V_294 -> V_303 = V_291 ;
V_294 -> V_304 = V_292 ;
V_298 = F_36 ( V_9 , & V_294 -> V_75 ) ;
if ( V_298 == V_71 )
V_294 -> signal = 0xffff ;
else if ( V_298 == V_73 )
V_294 -> signal = 0x8000 ;
...
unsigned V_307 = V_9 -> V_72 / ( 6 * 16 ) ;
unsigned V_308 = ( V_9 -> V_39 & V_309 ) ? 4 : 3 ;
switch ( V_307 % V_308 ) {
case 0 :
V_294 -> V_305 = V_306 ;
break;
...
case 2 :
if ( V_9 -> V_39 & V_309 )
V_294 -> V_305 = V_306 | V_311 ;
else
V_294 -> V_305 = V_312 | V_313 ;
break;
case 3 :
V_294 -> V_305 = V_310 | V_311 ;
break;
}
}
F_121 ( V_294 -> V_255 , L_13 , sizeof( V_294 -> V_255 ) ) ;
return 0 ;
}
int F_122 ( struct V_137 * V_137 , void * V_138 , T_3 * V_314 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( ! F_13 ( V_9 ) )
return - V_192 ;
...
* V_314 = V_319 [ V_9 -> V_320 ] ;
V_9 -> V_320 = ( V_9 -> V_320 + 1 ) % F_76 ( V_319 ) ;
}
return 0 ;
}
int F_123 ( struct V_137 * V_137 , void * V_138 , T_3 V_314 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
if ( ! F_13 ( V_9 ) )
return - V_192 ;
...
int F_138 ( struct V_137 * V_137 , void * V_201 ,
struct V_359 * V_360 )
{
struct V_8 * V_9 = F_64 ( V_137 ) ;
...
return - V_18 ;
if ( F_55 ( V_9 ) ) {
if ( V_360 -> V_212 >= F_76 ( V_94 ) )
return - V_18 ;
V_360 -> type = V_362 ;
V_360 -> V_363 = V_94 [ V_360 -> V_212 ] ;
return 0 ;
}
if ( V_360 -> V_212 )
return - V_18 ;
...
if ( V_53 == F_76 ( V_94 ) )
return - V_18 ;
if ( V_376 -> V_212 >= 2 * ( V_186 - V_53 ) )
return - V_18 ;
V_376 -> type = V_377 ;
V_376 -> V_363 = V_97 [ V_376 -> V_212 ] ;
return 0 ;
}
