...
if ( ( V_1 [ 2 ] + V_1 [ 3 ] ) == 0xff ) {
if ( ( V_1 [ 0 ] + V_1 [ 1 ] ) == 0xff ) {
V_181 = F_65 ( V_1 [ 0 ] , V_1 [ 2 ] ) ;
V_180 = V_182 ;
} else {
V_181 = F_66 ( V_1 [ 0 ] << 8 | V_1 [ 1 ] , V_1 [ 2 ] ) ;
V_180 = V_183 ;
}
} else {
V_181 = F_67 ( V_1 [ 0 ] << 24 | V_1 [ 1 ] << 16 |
V_1 [ 2 ] << 8 | V_1 [ 3 ] ) ;
V_180 = V_184 ;
}
F_11 ( & V_11 -> V_18 , L_40 , 4 , V_1 ) ;
F_68 ( V_6 -> V_185 , V_180 , V_181 , 0 ) ;
return 0 ;
V_48:
F_11 ( & V_11 -> V_18 , L_4 , V_12 ) ;
return V_12 ;
}
static int F_69 ( struct V_5 * V_6 , struct V_186 * V_187 )
{
struct V_9 * V_9 = F_7 ( V_6 ) ;
struct V_10 * V_11 = V_6 -> V_11 ;
int V_12 ;
T_2 V_35 ;
V_12 = F_17 ( V_6 , V_9 -> V_71 + V_188 , & V_35 ) ;
if ( V_12 < 0 )
goto V_48;
F_11 ( & V_11 -> V_18 , L_41 , V_35 ) ;
if ( V_35 == 5 ) {
V_12 = F_17 ( V_6 , V_9 -> V_71 + V_189 ,
& V_35 ) ;
if ( V_12 < 0 )
goto V_48;
...
static int F_70 ( struct V_151 * V_142 , T_2 * V_199 ,
struct V_200 * V_201 )
{
...
V_201 -> V_202 . V_203 . V_204 = 5 * 188 ;
return 0 ;
}
static int F_73 ( struct V_140 * V_51 , int V_205 )
{
struct V_9 * V_9 = F_51 ( V_51 ) ;
return V_9 -> V_143 . V_206 ( V_51 -> V_142 [ 0 ] , V_205 ) ;
}
static int F_74 ( struct V_140 * V_51 , int V_207 , T_1 V_208 ,
int V_205 )
{
struct V_9 * V_9 = F_51 ( V_51 ) ;
return V_9 -> V_143 . V_209 ( V_51 -> V_142 [ 0 ] , V_207 , V_208 , V_205 ) ;
}
static int F_75 ( struct V_10 * V_11 ,
const struct V_210 * V_141 )
{
struct V_211 * V_125 = F_76 ( V_11 ) ;
char V_212 [ sizeof( L_44 ) ] ;
memset ( V_212 , 0 , sizeof( V_212 ) ) ;
F_77 ( V_125 , V_125 -> V_126 . V_213 ,
V_212 , sizeof( V_212 ) ) ;
if ( ( F_44 ( V_125 -> V_126 . V_127 ) == V_214 ) &&
( F_44 ( V_125 -> V_126 . V_129 ) == 0x0099 ) ) {
if ( ! strcmp ( L_44 , V_212 ) ) {
