...
struct V_143 * V_144 ;
int V_38 ;
V_144 = F_71 ( V_142 , V_147 -> V_151 , 0 , V_405 , sizeof( * V_404 ) , 0 ) ;
if ( V_144 == NULL )
return - V_167 ;
V_404 = F_44 ( V_144 ) ;
F_127 ( V_273 , & V_404 -> V_272 , V_254 ) ;
V_38 = F_137 ( V_273 , V_142 ) ;
if ( ! V_38 )
V_38 = F_139 ( V_273 , V_142 ) ;
if ( ! V_38 )
...
V_165 = F_63 ( V_142 , V_406 , sizeof( * V_24 ) ) ;
V_38 = - V_167 ;
if ( V_165 == NULL )
goto V_392;
V_24 = F_2 ( V_165 ) ;
...
goto V_392;
F_74 ( V_142 , V_144 ) ;
return F_86 ( V_118 , V_142 , 0 , V_407 ) ;
V_392:
F_85 ( V_142 ) ;
return V_38 ;
}
...
if ( V_142 == NULL )
return - V_69 ;
V_144 = F_71 ( V_142 , V_147 -> V_151 , V_147 -> V_133 , V_408 , 0 , 0 ) ;
V_38 = - V_167 ;
if ( V_144 == NULL )
goto V_392;
...
{
return F_90 ( sizeof( struct V_410 ) ) ;
}
static int F_213 ( struct V_141 * V_142 , T_2 V_34 ,
struct V_359 * V_93 , T_1 * V_411 )
{
struct V_410 * V_412 ;
struct V_143 * V_144 ;
V_144 = F_71 ( V_142 , 0 , 0 , V_413 , sizeof( * V_412 ) , 0 ) ;
if ( V_144 == NULL )
return - V_167 ;
V_412 = F_44 ( V_144 ) ;
V_412 -> V_34 = V_34 ;
...
if ( V_411 ) {
int V_38 = F_67 ( V_142 , V_53 , sizeof( * V_411 ) , V_411 ) ;
if ( V_38 ) {
F_73 ( V_142 , V_144 ) ;
return V_38 ;
}
...
if ( V_142 == NULL )
return - V_69 ;
if ( F_213 ( V_142 , V_34 , V_93 , V_411 ) < 0 )
F_101 () ;
return F_86 ( V_118 , V_142 , 0 , V_414 ) ;
}
static inline T_4 F_215 ( void )
{
return F_90 ( sizeof( struct V_415 ) ) ;
}
...
struct V_415 * V_340 ;
struct V_143 * V_144 ;
V_144 = F_71 ( V_142 , 0 , 0 , V_417 , sizeof( * V_340 ) , 0 ) ;
if ( V_144 == NULL )
return - V_167 ;
V_340 = F_44 ( V_144 ) ;
...
V_340 -> V_416 = V_416 ;
V_340 -> V_418 = V_58 -> V_128 -> V_419 ;
V_340 -> V_95 = V_58 -> V_64 . V_95 ;
F_74 ( V_142 , V_144 ) ;
return 0 ;
}
static int F_217 ( struct V_57 * V_58 , T_1 * V_420 ,
T_7 V_421 )
{
struct V_118 * V_118 = F_193 ( V_58 ) ;
struct V_141 * V_142 ;
...
if ( V_142 == NULL )
return - V_69 ;
if ( F_216 ( V_142 , V_58 , V_420 , V_421 ) < 0 )
F_101 () ;
return F_86 ( V_118 , V_142 , 0 , V_422 ) ;
}
...
V_202 = F_221 ( V_118 , V_428 , & V_424 ) ;
if ( V_202 == NULL )
return - V_69 ;
V_118 -> V_134 . V_429 = V_202 ;
F_222 ( V_118 -> V_134 . V_202 , V_202 ) ;
return 0 ;
}
static void T_9 F_223 ( struct V_430 * V_431 )
{
struct V_118 * V_118 ;
