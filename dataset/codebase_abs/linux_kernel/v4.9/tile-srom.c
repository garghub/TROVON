...
V_19 -> V_1 = V_44 ;
F_30 ( & V_19 -> V_21 ) ;
if ( F_1 ( V_44 , & V_19 -> V_34 ,
V_45 , sizeof( V_19 -> V_34 ) ) < 0 )
return - V_12 ;
if ( F_1 ( V_44 , & V_19 -> V_39 ,
V_46 , sizeof( V_19 -> V_39 ) ) < 0 )
return - V_12 ;
if ( F_1 ( V_44 , & V_19 -> V_40 ,
V_47 , sizeof( V_19 -> V_40 ) ) < 0 )
return - V_12 ;
return 0 ;
}
...
{
int V_48 , V_49 ;
T_6 V_36 = F_32 ( V_50 , 0 ) ;
V_17 = F_13 ( 4 * sizeof( struct V_18 ) , V_26 ) ;
for ( V_49 = 0 ; ; V_49 ++ ) {
int V_44 ;
char V_2 [ 20 ] ;
struct V_18 * V_51 =
F_33 ( V_17 , ( V_49 + 1 ) * sizeof( struct V_18 ) ,
V_26 ) ;
if ( ! V_51 ) {
V_48 = - V_27 ;
goto V_52;
...
if ( V_50 )
V_48 = F_36 ( V_36 , V_54 , L_7 ) ;
else {
V_48 = F_37 ( & V_36 , 0 , V_54 , L_7 ) ;
V_50 = F_38 ( V_36 ) ;
}
if ( V_48 < 0 )
goto V_52;
...
V_56 . V_58 = V_59 ;
V_56 . V_60 = & V_57 ;
V_48 = F_40 ( & V_56 , V_36 , V_54 ) ;
if ( V_48 < 0 )
goto V_61;
V_62 = F_41 ( L_7 , - 1 , NULL , 0 ) ;
if ( F_42 ( V_62 ) ) {
V_48 = F_43 ( V_62 ) ;
goto V_63;
}
