...
V_4 -> V_4 . V_46 = F_156 ( V_11 , L_79 , V_4 -> V_119 ) ;
...
if ( V_246 < 0 )
return V_246 ;
V_268 = F_165 ( & V_60 -> V_61 , L_81 ) ;
if ( F_34 ( V_268 ) )
return F_166 ( V_268 ) ;
V_269 = F_165 ( & V_60 -> V_61 , L_82 ) ;
if ( F_34 ( V_269 ) )
return F_166 ( V_269 ) ;
F_167 ( & V_13 -> V_14 ) ;
F_168 ( & V_13 -> V_273 ) ;
...
V_40 = F_171 ( & V_60 -> V_61 , V_246 , F_123 , 0 ,
L_88 , V_13 ) ;
if ( V_40 ) {
F_31 ( & V_60 -> V_61 , L_89 ,
V_246 , V_40 ) ;
...
V_13 -> V_246 = V_246 ;
if ( F_44 ( V_13 -> V_75 ) ) {
if ( ! F_172 ( & V_60 -> V_61 , V_13 -> V_75 , L_88 ) ) {
F_173 ( F_139 ( V_13 -> V_75 ) ,
V_312 ) ;
