...
F_18 ( V_18 , V_26 , V_35 ) ;
F_19 ( V_18 , V_26 , V_12 ) ;
F_20 ( V_18 , V_26 , V_3 -> V_36 ) ;
F_21 ( V_18 , V_26 , V_25 ) ;
V_27 = ( unsigned long ) ( V_26 + 1 ) ;
V_28 = ( unsigned long ) ( ( char * ) V_27 + V_12 ) ;
F_22 ( V_18 , V_11 , V_27 , V_12 ) ;
F_22 ( V_18 , V_24 , V_28 , V_25 ) ;
F_23 ( V_7 -> V_21 [ 0 ] ) ;
return V_13 ;
}
...
F_27 ( V_7 ) ;
V_40 = F_28 ( V_3 , V_5 , V_11 , V_12 , V_38 ,
& V_32 , type , V_39 ) ;
V_45:
F_29 ( V_7 ) ;
if ( V_13 )
...
V_29 . type = V_41 ;
V_29 . V_34 = F_13 ( V_11 , V_12 ) ;
V_13 = F_31 ( V_3 , V_5 , & V_29 , V_7 , V_49 , V_50 ) ;
if ( V_13 < 0 )
return F_4 ( V_13 ) ;
if ( V_13 > 0 )
return NULL ;
...
int F_32 ( struct V_4 * V_5 , T_2 V_38 ,
const char * V_11 , int V_12 )
{
int V_13 ;
struct V_8 V_29 ;
...
V_29 . type = V_41 ;
V_29 . V_34 = F_13 ( V_11 , V_12 ) ;
V_13 = F_31 ( NULL , V_5 , & V_29 , V_7 , 0 , 0 ) ;
if ( V_13 < 0 )
goto V_52;
if ( V_13 > 0 ) {
V_13 = 0 ;
...
V_10 = sizeof( * V_20 ) + V_12 ;
V_18 = V_7 -> V_21 [ 0 ] ;
V_51 = V_7 -> V_22 [ 0 ] ;
if ( V_10 + F_33 ( V_18 , V_51 ) +
sizeof( struct V_15 ) > F_34 ( V_5 ) ) {
V_13 = - V_53 ;
} else {
V_13 = 0 ;
}
...
if ( F_41 ( V_5 , V_18 , V_26 ) )
return NULL ;
V_58 = F_33 ( V_18 , V_7 -> V_22 [ 0 ] ) ;
while ( V_59 < V_58 ) {
V_60 = sizeof( * V_26 ) +
F_42 ( V_18 , V_26 ) +
F_43 ( V_18 , V_26 ) ;
V_27 = ( unsigned long ) ( V_26 + 1 ) ;
if ( F_42 ( V_18 , V_26 ) == V_12 &&
F_44 ( V_18 , V_11 , V_27 , V_12 ) == 0 )
return V_26 ;
V_59 += V_60 ;
...
int V_13 = 0 ;
V_18 = V_7 -> V_21 [ 0 ] ;
V_61 = sizeof( * V_20 ) + F_42 ( V_18 , V_20 ) +
F_43 ( V_18 , V_20 ) ;
V_62 = F_33 ( V_18 , V_7 -> V_22 [ 0 ] ) ;
if ( V_61 == V_62 ) {
V_13 = F_46 ( V_3 , V_5 , V_7 ) ;
} else {
unsigned long V_14 = ( unsigned long ) V_20 ;
unsigned long V_63 ;
V_63 = F_47 ( V_18 , V_7 -> V_22 [ 0 ] ) ;
F_48 ( V_18 , V_14 , V_14 + V_61 ,
V_62 - ( V_14 + V_61 - V_63 ) ) ;
F_49 ( V_5 , V_7 , V_62 - V_61 , 1 ) ;
}
return V_13 ;
}
...
if ( type == V_35 )
V_64 = V_67 ;
if ( F_42 ( V_18 , V_26 ) > V_64 ) {
F_51 ( V_5 -> V_46 , L_2 ,
( unsigned ) F_43 ( V_18 , V_26 ) ) ;
return 1 ;
}
if ( ( F_43 ( V_18 , V_26 ) +
F_42 ( V_18 , V_26 ) ) > F_12 ( V_5 ) ) {
F_51 ( V_5 -> V_46 ,
L_3 ,
( unsigned ) F_42 ( V_18 , V_26 ) ,
( unsigned ) F_43 ( V_18 , V_26 ) ) ;
return 1 ;
}
return 0 ;
