...
static void F_42 ( struct V_3 * V_54 )
{
...
V_16 -> V_57 = F_44 ( V_54 , 32 ,
V_54 -> V_55 . V_58 ,
V_54 -> V_55 . V_56 ) ;
if ( F_9 ( V_16 -> V_57 ) )
V_16 -> V_57 = NULL ;
}
static void F_45 ( struct V_3 * V_17 )
{
V_17 -> V_55 . V_59 = 0 ;
V_17 -> V_55 . V_60 = 0 ;
V_17 -> V_55 . V_61 = V_62 ;
...
static int F_46 ( struct V_67 * V_17 , void * V_1 )
{
return V_17 -> V_68 == V_1 ;
}
static int F_47 ( struct V_3 * V_54 )
{
struct V_44 * V_16 ;
V_16 = F_48 ( sizeof( * V_16 ) , V_30 ) ;
if ( ! V_16 )
return - V_31 ;
V_54 -> V_52 = ( void * ) V_16 ;
F_49 ( V_54 -> V_17 , V_54 ) ;
V_16 -> V_4 = V_54 ;
F_50 ( & V_16 -> V_47 . V_53 ) ;
F_51 ( & V_16 -> V_47 . V_48 , F_32 ) ;
F_52 ( V_54 ) ;
F_45 ( V_54 ) ;
F_53 ( V_54 ) ;
return 0 ;
}
static void F_54 ( struct V_3 * V_54 )
{
struct V_44 * V_16 = V_54 -> V_52 ;
if ( V_16 -> V_57 ) {
F_55 ( V_16 -> V_57 ) ;
...
static int F_59 ( struct V_67 * V_17 )
{
struct V_3 * V_54 ;
int V_37 ;
V_54 = F_60 ( & V_69 , V_17 ) ;
...
static void F_67 ( struct V_67 * V_17 )
{
struct V_3 * V_54 = F_68 ( V_17 ) ;
F_69 ( V_54 ) ;
F_54 ( V_54 ) ;
F_66 ( V_54 ) ;
}
...
F_71 ( V_17 , F_72 ( 32 ) ) ;
F_73 ( V_15 , NULL , NULL , V_17 ) ;
V_77 = F_74 ( V_15 , NULL ) ;
while ( V_77 ) {
F_75 ( V_17 , & V_79 , F_46 , V_77 ) ;
F_76 ( V_77 ) ;
V_77 = F_74 ( V_15 , V_77 ) ;
}
