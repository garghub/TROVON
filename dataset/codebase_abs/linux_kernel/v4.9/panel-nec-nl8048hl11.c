...
struct V_12 * V_13 ;
int V_17 ;
F_27 ( & V_2 -> V_39 , L_5 , V_44 ) ;
V_2 -> V_45 = V_46 ;
V_2 -> V_47 = 32 ;
V_17 = F_28 ( V_2 ) ;
if ( V_17 < 0 ) {
F_22 ( & V_2 -> V_39 , L_6 , V_17 ) ;
return V_17 ;
}
F_4 ( V_2 ) ;
V_15 = F_29 ( & V_2 -> V_39 , sizeof( * V_15 ) , V_48 ) ;
if ( V_15 == NULL )
return - V_49 ;
F_30 ( & V_2 -> V_39 , V_15 ) ;
V_15 -> V_2 = V_2 ;
...
return V_17 ;
if ( F_13 ( V_15 -> V_42 ) ) {
V_17 = F_31 ( & V_2 -> V_39 , V_15 -> V_42 ,
V_50 , L_7 ) ;
if ( V_17 )
goto V_51;
}
if ( F_13 ( V_15 -> V_28 ) ) {
V_17 = F_31 ( & V_2 -> V_39 , V_15 -> V_28 ,
V_52 , L_8 ) ;
if ( V_17 )
goto V_51;
}
...
static int F_36 ( struct V_60 * V_39 )
{
struct V_1 * V_2 = F_37 ( V_39 ) ;
F_1 ( V_2 , 2 , 0x01 ) ;
F_38 ( 40 ) ;
return 0 ;
}
static int F_39 ( struct V_60 * V_39 )
{
struct V_1 * V_2 = F_37 ( V_39 ) ;
F_28 ( V_2 ) ;
F_1 ( V_2 , 2 , 0x00 ) ;
