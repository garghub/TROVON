...
T_6 V_162 = 0 ;
F_67 ( V_157 ) ;
V_2 = F_68 ( V_11 , sizeof( * V_2 ) , V_105 ) ;
if ( ! V_2 )
return - V_92 ;
V_2 -> V_11 = V_11 ;
V_2 -> V_142 = V_163 ;
...
V_107 = F_69 ( V_96 , 0 , 0xff , & V_157 , & V_162 ) ;
if ( V_107 ) {
F_9 ( V_11 , L_41 ) ;
return V_107 ;
}
V_107 = F_70 ( V_11 , & V_157 ) ;
if ( V_107 )
goto error;
V_107 = F_48 ( V_2 ) ;
if ( V_107 ) {
