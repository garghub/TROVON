...
V_27 = F_47 ( & V_2 -> V_46 , V_141 , V_144 ,
& signal , V_32 , V_2 -> V_151 ) ;
if ( ( ( V_27 == 0 ) && V_135 && signal ) ||
( V_27 && ! F_48 ( V_2 ) ) )
F_1 ( V_2 ) ;
return V_27 ;
}
int F_49 ( struct V_1 * V_2 , void * V_131 ,
T_1 V_132 , V_95 V_133 ,
...
V_137 . V_26 = V_26 ;
V_137 . V_158 = V_155 >> 3 ;
V_137 . V_159 = ( V_147 ) ( V_139 >> 3 ) ;
V_137 . V_160 = V_133 ;
V_137 . V_98 = V_80 ;
for ( V_79 = 0 ; V_79 < V_80 ; V_79 ++ ) {
V_137 . V_100 [ V_79 ] . V_161 = V_153 [ V_79 ] . V_161 ;
V_137 . V_100 [ V_79 ] . V_162 = V_153 [ V_79 ] . V_162 ;
V_137 . V_100 [ V_79 ] . V_106 = V_153 [ V_79 ] . V_106 ;
}
V_141 [ 0 ] . V_149 = & V_137 ;
V_141 [ 0 ] . V_150 = V_155 ;
V_141 [ 1 ] . V_149 = V_131 ;
...
V_141 [ 2 ] . V_149 = & V_142 ;
V_141 [ 2 ] . V_150 = ( V_139 - V_138 ) ;
V_27 = F_47 ( & V_2 -> V_46 , V_141 , 3 ,
& signal , V_32 , V_2 -> V_151 ) ;
if ( ( ( V_27 == 0 ) && V_135 && signal ) || ( V_27 ) )
F_1 ( V_2 ) ;
return V_27 ;
}
...
V_137 . V_160 = V_133 ;
V_137 . V_98 = 1 ;
V_137 . V_100 . V_161 = V_167 -> V_161 ;
V_137 . V_100 . V_162 = V_167 -> V_162 ;
memcpy ( V_137 . V_100 . V_103 , V_167 -> V_103 ,
V_89 * sizeof( V_95 ) ) ;
V_141 [ 0 ] . V_149 = & V_137 ;
V_141 [ 0 ] . V_150 = V_155 ;
V_141 [ 1 ] . V_149 = V_131 ;
...
static inline int
F_55 ( struct V_1 * V_2 , void * V_131 ,
T_1 V_132 , T_1 * V_170 , V_95 * V_133 ,
bool V_171 )
{
int V_27 ;
bool signal = false ;
V_27 = F_56 ( & V_2 -> V_48 , V_131 , V_132 ,
V_170 , V_133 , & signal , V_171 ) ;
if ( signal )
F_1 ( V_2 ) ;
return V_27 ;
}
...
int F_58 ( struct V_1 * V_2 , void * V_131 ,
T_1 V_132 , T_1 * V_170 ,
V_95 * V_133 )
{
return F_55 ( V_2 , V_131 , V_132 ,
