...
if ( F_39 ( V_74 ) == NULL )
return NULL ;
while ( F_40 ( V_74 ) != & F_39 ( V_74 ) -> V_62 ) {
struct V_66 * V_51 = F_39 ( V_74 ) ;
struct V_42 * V_43 ;
struct V_66 * V_78 ;
V_43 = F_41 ( F_40 ( V_74 ) , F_42 ( * V_43 ) , V_59 ) ;
if ( ! ( V_43 -> V_48 & V_79 ) ) {
F_40 ( V_74 ) = F_40 ( V_74 ) -> V_78 ;
continue;
}
V_78 = F_28 ( V_51 , V_43 ) ;
...
? V_43 -> V_72 : V_43 -> V_71 ;
F_48 ( V_88 , V_47 -> V_52 , 1 ) ;
if ( ! ( V_47 -> V_48 & V_93 ) ||
V_43 -> V_48 & V_79 )
F_49 ( V_86 , V_47 -> V_52 , 1 ) ;
if ( V_43 -> V_72 != V_47 ||
! ( V_43 -> V_48 & V_79 ) )
continue;
...
F_50 ( V_86 , V_86 , V_88 , V_51 -> V_67 ) ;
if ( ! F_51 ( V_86 , V_51 -> V_67 ) ) {
V_83 = - V_95 ;
F_12 ( V_51 -> V_68 . V_39 -> V_40 ,
L_36 ,
V_51 -> V_41 ,
...
struct V_66 * F_56 ( struct V_66 * V_51 )
{
if ( V_51 == NULL )
return NULL ;
if ( V_51 -> V_68 . V_39 -> V_40 &&
! F_57 ( V_51 -> V_68 . V_39 -> V_40 -> V_96 -> V_97 ) )
return NULL ;
return V_51 ;
}
...
static struct V_42 * F_60 ( struct V_98 * V_99 )
{
struct V_42 * V_43 ;
V_43 = F_61 ( sizeof( * V_43 ) , V_32 ) ;
if ( V_43 == NULL )
return NULL ;
F_22 ( & V_43 -> V_59 , V_99 ) ;
return V_43 ;
}
static void F_62 ( struct V_66 * V_51 ,
struct V_42 * V_43 )
{
...
int
F_64 ( struct V_66 * V_71 , T_2 V_106 ,
...
int F_65 ( const struct V_57 * V_39 ,
const T_3 V_111 ,
struct V_66 * V_71 ,
const T_2 V_106 ,
const T_3 V_112 ,
...
static int F_69 ( struct V_42 * V_43 , T_3 V_48 )
{
int V_83 ;
V_83 = F_70 ( V_43 -> V_71 -> V_51 , V_116 ,
V_43 -> V_71 , V_43 -> V_72 , V_48 ) ;
if ( V_83 < 0 && V_83 != - V_94 )
return V_83 ;
V_83 = F_70 ( V_43 -> V_72 -> V_51 , V_116 ,
V_43 -> V_72 , V_43 -> V_71 , V_48 ) ;
if ( V_83 < 0 && V_83 != - V_94 ) {
F_70 ( V_43 -> V_71 -> V_51 , V_116 ,
...
int F_71 ( struct V_42 * V_43 , T_3 V_48 )
{
...
int F_72 ( struct V_42 * V_43 , T_3 V_48 )
{
int V_83 ;
...
struct V_42 *
F_73 ( struct V_46 * V_71 , struct V_46 * V_72 )
{
struct V_42 * V_43 ;
...
struct V_46 * F_74 ( struct V_46 * V_47 )
{
struct V_42 * V_43 ;
...
static void F_75 ( struct V_57 * V_39 ,
struct V_6 * V_7 ,
T_3 F_1 ,
T_3 F_2 , T_3 V_48 )
{
...
struct V_53 * F_77 ( struct V_57 * V_39 ,
T_3 type , T_3 V_48 ,
T_3 V_55 , T_3 V_56 )
{
struct V_53 * V_54 ;
V_54 = F_61 ( sizeof( * V_54 ) , V_32 ) ;
if ( ! V_54 )
return NULL ;
V_54 -> V_55 = V_55 ;
V_54 -> V_56 = V_56 ;
F_75 ( V_39 , & V_54 -> V_7 , V_5 ,
type , V_48 ) ;
return V_54 ;
}
void F_78 ( struct V_53 * V_54 )
{
F_79 ( & V_54 -> V_7 ) ;
F_23 ( & V_54 -> V_7 . V_68 ) ;
F_8 ( V_54 ) ;
}
struct V_42 * F_80 ( struct V_66 * V_51 ,
struct V_6 * V_7 ,
T_3 V_48 )
{
struct V_42 * V_43 ;
