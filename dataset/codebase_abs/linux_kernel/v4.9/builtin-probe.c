...
static int
F_54 ( int V_20 , const char * * V_21 , const char * T_2 V_27 )
{
...
int V_7 ;
F_64 ( V_68 , 'a' , L_45 , V_86 ) ;
F_64 ( V_68 , 'd' , L_43 , V_86 ) ;
F_64 ( V_68 , 'D' , L_59 , V_86 ) ;
F_64 ( V_68 , 'l' , L_40 , V_86 ) ;
#ifdef F_55
F_64 ( V_68 , 'L' , L_64 , V_86 ) ;
F_64 ( V_68 , 'V' , L_67 , V_86 ) ;
#else
# define F_65 ( V_57 , T_3 , T_4 ) set_option_nobuild(options, s, l, "NO_DWARF=1", c)
F_65 ( 'L' , L_64 , false ) ;
F_65 ( 'V' , L_67 , false ) ;
F_65 ( '\0' , L_70 , false ) ;
F_65 ( '\0' , L_72 , false ) ;
...
# undef F_65
#endif
F_64 ( V_68 , 'F' , L_84 , V_86 ) ;
V_20 = F_66 ( V_20 , V_21 , V_68 , V_67 ,
V_87 ) ;
if ( V_20 > 0 ) {
if ( strcmp ( V_21 [ 0 ] , L_104 ) == 0 ) {
F_67 ( V_67 , V_68 ,
L_105 ) ;
}
...
if ( V_64 . V_81 == 0 )
V_64 . V_81 = V_8 ;
V_76 . V_88 = ( V_76 . V_77 == NULL ) ;
if ( ! strchr ( L_109 , V_4 . V_31 ) && V_76 . V_77 )
V_76 . V_89 = true ;
switch ( V_4 . V_31 ) {
case 'l' :
if ( V_4 . V_9 ) {
F_3 ( L_110 ) ;
F_68 ( V_67 , V_68 , L_111 , true ) ;
F_68 ( NULL , V_68 , L_112 , true ) ;
return - V_16 ;
}
V_7 = F_69 ( V_4 . V_15 ) ;
if ( V_7 < 0 )
...
int F_74 ( int V_20 , const char * * V_21 , const char * T_2 )
{
int V_7 ;
V_7 = F_22 () ;
if ( ! V_7 ) {
V_7 = F_54 ( V_20 , V_21 , T_2 ) ;
F_24 () ;
}
return V_7 < 0 ? V_7 : 0 ;
}
