...
F_63 ( & V_198 -> V_2 , L_13 ,
F_62 ( V_19 -> V_115 ) ) ;
V_19 -> V_182 . V_205 = V_19 -> V_162 - 2 ;
V_19 -> V_184 . V_205 = V_19 -> V_162 - 2 ;
V_19 -> V_182 . V_206 = V_19 -> V_207 + V_6 ;
V_19 -> V_184 . V_206 = V_19 -> V_207 + V_8 ;
V_90 = F_64 ( V_201 , L_14 , V_203 , 4 ) ;
if ( V_19 -> V_62 && ! V_90 && V_203 [ 2 ] == V_208 ) {
V_19 -> V_92 = true ;
V_19 -> V_182 . V_205 &= ~ 0x1 ;
V_19 -> V_184 . V_205 &= ~ 0x1 ;
}
if ( ! V_19 -> V_62 ) {
V_19 -> V_209 . V_26 = V_19 -> V_26 ;
V_19 -> V_209 . V_210 = V_199 ;
V_19 -> V_209 . V_184 =
& V_19 -> V_184 ;
V_19 -> V_209 . V_182 =
& V_19 -> V_182 ;
V_90 = F_65 ( V_198 , & V_19 -> V_209 ) ;
if ( V_90 )
goto V_211;
} else {
V_90 = F_66 ( V_198 , V_212 ) ;
if ( V_90 )
goto V_211;
}
return 0 ;
...
const char * V_195 , * V_215 ;
const T_7 * V_216 ;
struct V_217 * V_218 ;
void T_6 * V_199 ;
char V_219 [ 64 ] ;
struct V_220 V_221 = V_222 ;
V_214 = F_70 ( V_223 , & V_198 -> V_2 ) ;
if ( ! V_214 || ! V_214 -> V_224 )
return - V_116 ;
...
V_19 -> V_32 = V_214 -> V_224 ;
V_19 -> V_2 = & V_198 -> V_2 ;
V_215 = F_72 ( V_201 , L_16 , NULL ) ;
if ( V_215 ) {
if ( ! strcmp ( V_215 , L_17 ) )
V_19 -> V_20 = V_22 ;
}
V_19 -> V_62 = ! F_73 ( V_201 ,
L_18 ) ;
if ( F_5 ( V_19 ) ) {
memcpy ( & V_19 -> V_98 , & V_227 ,
sizeof( V_227 ) ) ;
V_187 = V_19 ;
V_90 = F_74 ( & V_228 , V_198 ) ;
if ( V_90 ) {
F_18 ( & V_198 -> V_2 , L_19 ) ;
return V_90 ;
}
} else {
memcpy ( & V_19 -> V_98 , & V_229 ,
sizeof( V_229 ) ) ;
}
V_19 -> V_98 . V_219 = F_75 ( & V_198 -> V_2 ) ;
V_218 = F_76 ( V_198 , V_230 , 0 ) ;
V_199 = F_77 ( & V_198 -> V_2 , V_218 ) ;
if ( F_35 ( V_199 ) )
return F_62 ( V_199 ) ;
V_19 -> V_207 = V_218 -> V_231 ;
if ( V_19 -> V_32 -> V_81 ) {
V_221 . V_232 = V_172 ;
V_221 . V_233 =
V_172 / sizeof( T_7 ) + 1 ;
...
if ( V_19 -> V_26 < 0 ) {
F_18 ( & V_198 -> V_2 , L_22 , V_198 -> V_219 ) ;
return V_19 -> V_26 ;
}
...
V_216 = F_72 ( V_201 , L_24 , NULL ) ;
if ( V_216 )
V_19 -> V_162 = F_83 ( V_216 ) ;
else
V_19 -> V_162 = 8 ;
F_84 ( & V_198 -> V_2 , V_19 ) ;
if ( V_19 -> V_32 -> V_180 ) {
...
goto V_238;
V_215 = F_72 ( F_88 ( L_28 ) , L_29 , NULL ) ;
V_195 = strrchr ( V_215 , ',' ) ;
if ( V_195 )
V_215 = V_195 + 1 ;
snprintf ( V_219 , sizeof( V_219 ) , L_30 , V_215 ) ;
F_59 ( V_219 ) ;
V_19 -> V_198 =
F_89 ( & V_198 -> V_2 , V_219 , 0 , NULL , 0 ) ;
if ( F_35 ( V_19 -> V_198 ) ) {
