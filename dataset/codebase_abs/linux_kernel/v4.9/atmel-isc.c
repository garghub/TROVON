...
unsigned long V_44 ;
F_57 ( & V_30 -> V_117 , V_44 ) ;
F_70 ( & V_106 -> V_123 , & V_30 -> V_122 ) ;
F_61 ( & V_30 -> V_117 , V_44 ) ;
}
static int F_71 ( struct V_128 * V_128 , void * V_129 ,
struct V_130 * V_131 )
{
struct V_29 * V_30 = F_72 ( V_128 ) ;
...
static int F_74 ( struct V_128 * V_128 , void * V_129 ,
struct V_142 * V_58 )
{
struct V_29 * V_30 = F_72 ( V_128 ) ;
* V_58 = V_30 -> V_58 ;
...
static struct V_80 * F_75 ( struct V_29 * V_30 ,
unsigned int V_141 )
{
...
static int F_76 ( struct V_29 * V_30 , struct V_142 * V_137 ,
struct V_80 * * V_81 )
{
struct V_80 * V_144 ;
...
static int F_80 ( struct V_29 * V_30 , struct V_142 * V_137 )
{
struct V_147 V_148 = {
. V_149 = V_163 ,
} ;
struct V_80 * V_81 ;
int V_49 ;
V_49 = F_76 ( V_30 , V_137 , & V_81 ) ;
if ( V_49 )
return V_49 ;
F_78 ( & V_148 . V_148 , & V_137 -> V_58 . V_59 ,
V_81 -> V_156 ) ;
...
if ( F_82 ( & V_30 -> V_164 ) )
return - V_165 ;
return F_80 ( V_30 , V_137 ) ;
}
static int F_83 ( struct V_128 * V_128 , void * V_129 ,
struct V_142 * V_137 )
{
struct V_29 * V_30 = F_72 ( V_128 ) ;
return F_76 ( V_30 , V_137 , NULL ) ;
}
...
static int F_85 ( struct V_128 * V_128 , void * V_129 , unsigned int * V_20 )
{
* V_20 = 0 ;
return 0 ;
}
...
static int F_87 ( struct V_128 * V_128 , void * V_170 , struct V_171 * V_172 )
{
struct V_29 * V_30 = F_72 ( V_128 ) ;
if ( V_172 -> type != V_151 )
return - V_18 ;
...
static int F_89 ( struct V_128 * V_128 , void * V_170 ,
struct V_175 * V_176 )
{
struct V_29 * V_30 = F_72 ( V_128 ) ;
...
static int F_91 ( struct V_128 * V_128 )
{
struct V_29 * V_30 = F_72 ( V_128 ) ;
...
static int F_97 ( struct V_128 * V_128 )
{
struct V_29 * V_30 = F_72 ( V_128 ) ;
struct V_193 * V_107 = V_30 -> V_84 -> V_107 ;
bool V_199 ;
...
F_98 ( & V_30 -> V_194 ) ;
V_199 = F_94 ( V_128 ) ;
V_49 = F_99 ( V_128 , NULL ) ;
if ( V_199 )
F_54 ( V_107 , V_197 , V_198 , 0 ) ;
F_96 ( & V_30 -> V_194 ) ;
return V_49 ;
}
static T_4 F_100 ( int V_200 , void * V_201 )
{
...
if ( ! F_104 ( & V_30 -> V_122 ) && ! V_30 -> V_119 ) {
V_30 -> V_121 = F_59 ( & V_30 -> V_122 ,
struct V_67 , V_123 ) ;
F_60 ( & V_30 -> V_121 -> V_123 ) ;
F_46 ( V_5 , V_30 -> V_121 ,
...
F_63 (subdev_entity, &isc->subdev_entities, list) {
V_214 -> V_211 . V_295 = & V_214 -> V_213 ;
V_214 -> V_211 . V_296 = 1 ;
V_214 -> V_211 . V_297 = F_107 ;
V_214 -> V_211 . V_298 = F_109 ;
