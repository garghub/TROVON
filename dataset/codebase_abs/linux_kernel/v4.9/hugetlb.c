...
V_265 = F_317 ( V_251 , V_50 , V_264 ) ;
F_318 ( V_283 , V_264 , V_50 ) ;
if ( F_319 ( V_265 ) )
F_320 ( V_74 ) ;
F_321 ( F_114 ( V_8 ) , V_251 ) ;
F_322 ( V_74 , true ) ;
F_2 ( V_286 ) ;
F_323 ( V_283 , V_74 , F_121 ( V_8 ) ) ;
if ( V_284 )
break;
}
...
void F_326 ( struct V_18 * V_19 , unsigned long V_255 ,
unsigned long V_256 , struct V_74 * V_284 )
{
struct V_250 * V_251 ;
struct V_282 V_283 ;
V_251 = V_19 -> V_285 ;
F_327 ( & V_283 , V_251 , V_255 , V_256 ) ;
F_312 ( & V_283 , V_19 , V_255 , V_256 , V_284 ) ;
F_328 ( & V_283 , V_255 , V_256 ) ;
}
static void F_329 ( struct V_250 * V_251 , struct V_18 * V_19 ,
...
V_65 = V_19 -> V_20 -> V_66 ;
F_330 ( V_65 ) ;
F_331 (iter_vma, &mapping->i_mmap, pgoff, pgoff) {
if ( V_288 == V_19 )
continue;
if ( V_288 -> V_62 & V_63 )
continue;
...
static int F_333 ( struct V_250 * V_251 , struct V_18 * V_19 ,
unsigned long V_50 , T_9 * V_264 , T_9 V_265 ,
...
F_138 ( V_291 ) ;
F_10 ( F_287 ( V_265 ) ) ;
F_329 ( V_251 , V_19 , V_291 , V_50 ) ;
F_10 ( F_287 ( V_265 ) ) ;
F_9 ( V_286 ) ;
V_264 = F_296 ( V_251 , V_50 & F_313 ( V_8 ) ) ;
if ( F_336 ( V_264 &&
F_337 ( F_283 ( V_264 ) , V_265 ) ) )
goto V_294;
return 0 ;
}
V_13 = ( F_338 ( V_292 ) == - V_14 ) ?
V_295 : V_296 ;
goto V_297;
}
if ( F_72 ( F_339 ( V_19 ) ) ) {
...
F_9 ( V_286 ) ;
V_264 = F_296 ( V_251 , V_50 & F_313 ( V_8 ) ) ;
if ( F_336 ( V_264 && F_337 ( F_283 ( V_264 ) , V_265 ) ) ) {
F_128 ( V_292 ) ;
F_342 ( V_19 , V_50 , V_264 ) ;
F_306 ( V_251 , V_274 , V_275 ) ;
F_304 ( V_251 , V_50 , V_264 ,
F_274 ( V_19 , V_292 , 1 ) ) ;
F_322 ( V_291 , true ) ;
F_343 ( V_292 , V_19 , V_50 ) ;
V_292 = V_291 ;
}
F_2 ( V_286 ) ;
F_311 ( V_251 , V_274 , V_275 ) ;
...
static struct V_74 * F_344 ( struct V_7 * V_8 ,
struct V_18 * V_19 , unsigned long V_50 )
{
struct V_64 * V_65 ;
T_1 V_164 ;
...
return F_345 ( V_65 , V_164 ) ;
}
static bool F_346 ( struct V_7 * V_8 ,
struct V_18 * V_19 , unsigned long V_50 )
{
struct V_64 * V_65 ;
T_1 V_164 ;
...
V_65 = V_19 -> V_20 -> V_66 ;
V_164 = F_34 ( V_8 , V_19 , V_50 ) ;
V_74 = F_347 ( V_65 , V_164 ) ;
if ( V_74 )
F_138 ( V_74 ) ;
return V_74 != NULL ;
}
int F_348 ( struct V_74 * V_74 , struct V_64 * V_65 ,
T_1 V_164 )
{
struct V_16 * V_16 = V_65 -> V_67 ;
struct V_7 * V_8 = F_30 ( V_16 ) ;
int V_94 = F_349 ( V_74 , V_65 , V_164 , V_10 ) ;
if ( V_94 )
return V_94 ;
F_128 ( V_74 ) ;
F_9 ( & V_16 -> V_299 ) ;
V_16 -> V_300 += F_350 ( V_8 ) ;
F_2 ( & V_16 -> V_299 ) ;
return 0 ;
}
static int F_351 ( struct V_250 * V_251 , struct V_18 * V_19 ,
...
V_42:
V_74 = F_345 ( V_65 , V_164 ) ;
if ( ! V_74 ) {
V_124 = F_353 ( V_65 -> V_67 ) >> F_35 ( V_8 ) ;
if ( V_164 >= V_124 )
goto V_45;
...
F_354 ( V_74 , V_50 , F_114 ( V_8 ) ) ;
F_341 ( V_74 ) ;
F_125 ( V_74 ) ;
if ( V_19 -> V_62 & V_63 ) {
int V_94 = F_348 ( V_74 , V_65 , V_164 ) ;
if ( V_94 ) {
F_138 ( V_74 ) ;
if ( V_94 == - V_304 )
goto V_42;
...
if ( ( V_70 & V_307 ) && ! ( V_19 -> V_62 & V_276 ) ) {
V_13 = F_333 ( V_251 , V_19 , V_50 , V_264 , V_302 , V_74 , V_286 ) ;
}
F_2 ( V_286 ) ;
F_358 ( V_74 ) ;
V_45:
...
V_311 = F_360 ( ( T_12 * ) & V_310 , sizeof( V_310 ) / sizeof( T_12 ) , 0 ) ;
...
int F_361 ( struct V_250 * V_251 , struct V_18 * V_19 ,
...
V_65 = V_19 -> V_20 -> V_66 ;
V_164 = F_34 ( V_8 , V_19 , V_50 ) ;
V_311 = F_359 ( V_8 , V_251 , V_19 , V_65 , V_164 , V_50 ) ;
F_363 ( & V_227 [ V_311 ] ) ;
V_262 = F_283 ( V_264 ) ;
if ( F_287 ( V_262 ) ) {
V_13 = F_351 ( V_251 , V_19 , V_65 , V_164 , V_50 , V_264 , V_70 ) ;
goto V_314;
}
V_13 = 0 ;
if ( ! F_288 ( V_262 ) )
goto V_314;
if ( ( V_70 & V_307 ) && ! F_364 ( V_262 ) ) {
if ( F_176 ( V_8 , V_19 , V_50 ) < 0 ) {
V_13 = V_295 ;
goto V_314;
}
...
V_286 = F_298 ( V_8 , V_251 , V_264 ) ;
if ( F_72 ( ! F_337 ( V_262 , F_283 ( V_264 ) ) ) )
goto V_315;
V_74 = F_307 ( V_262 ) ;
if ( V_74 != V_290 )
if ( ! F_365 ( V_74 ) ) {
...
if ( V_70 & V_307 ) {
if ( ! F_364 ( V_262 ) ) {
V_13 = F_333 ( V_251 , V_19 , V_50 , V_264 , V_262 ,
V_290 , V_286 ) ;
goto V_316;
}
V_262 = F_276 ( V_262 ) ;
...
long F_368 ( struct V_250 * V_251 , struct V_18 * V_19 ,
...
if ( V_323 && ( V_70 & V_324 ) &&
! F_346 ( V_8 , V_19 , V_321 ) ) {
if ( V_265 )
F_2 ( V_286 ) ;
V_322 = 0 ;
break;
}
if ( V_323 || F_370 ( F_283 ( V_265 ) ) ||
( ( V_70 & V_325 ) &&
! F_364 ( F_283 ( V_265 ) ) ) ) {
int V_13 ;
if ( V_265 )
F_2 ( V_286 ) ;
V_13 = F_361 ( V_251 , V_19 , V_321 ,
( V_70 & V_325 ) ? V_307 : 0 ) ;
if ( ! ( V_13 & V_326 ) )
continue;
V_322 = 0 ;
...
unsigned long F_372 ( struct V_18 * V_19 ,
...
F_10 ( V_50 >= V_256 ) ;
F_373 ( V_19 , V_50 , V_256 ) ;
F_295 ( V_251 , V_255 , V_256 ) ;
F_330 ( V_19 -> V_20 -> V_66 ) ;
...
F_375 ( V_19 , V_255 , V_256 ) ;
F_306 ( V_251 , V_255 , V_256 ) ;
F_332 ( V_19 -> V_20 -> V_66 ) ;
F_311 ( V_251 , V_255 , V_256 ) ;
return V_317 << V_8 -> V_100 ;
}
int F_376 ( struct V_16 * V_16 ,
long V_35 , long V_33 ,
struct V_18 * V_19 ,
T_14 V_62 )
{
...
long F_377 ( struct V_16 * V_16 , long V_255 , long V_256 ,
long V_332 )
{
struct V_7 * V_8 = F_30 ( V_16 ) ;
...
F_9 ( & V_16 -> V_299 ) ;
V_16 -> V_300 -= ( F_350 ( V_8 ) * V_332 ) ;
F_2 ( & V_16 -> V_299 ) ;
V_257 = F_12 ( V_2 , ( V_41 - V_332 ) ) ;
F_3 ( V_8 , - V_257 ) ;
return 0 ;
}
static unsigned long F_378 ( struct V_18 * V_333 ,
struct V_18 * V_19 ,
...
if ( F_379 ( V_147 ) != F_379 ( V_334 ) ||
V_62 != V_340 ||
V_335 < V_333 -> V_51 || V_333 -> V_258 < V_337 )
return 0 ;
return V_334 ;
}
static bool F_380 ( struct V_18 * V_19 , unsigned long V_147 )
{
...
T_9 * F_381 ( struct V_250 * V_251 , unsigned long V_147 , T_15 * V_342 )
{
struct V_18 * V_19 = F_382 ( V_251 , V_147 ) ;
struct V_64 * V_65 = V_19 -> V_20 -> V_66 ;
...
T_11 * V_286 ;
if ( ! F_380 ( V_19 , V_147 ) )
return ( T_9 * ) F_383 ( V_251 , V_342 , V_147 ) ;
F_330 ( V_65 ) ;
F_331 (svma, &mapping->i_mmap, idx, idx) {
if ( V_333 == V_19 )
continue;
V_334 = F_378 ( V_333 , V_19 , V_147 , V_164 ) ;
if ( V_334 ) {
...
if ( ! V_343 )
goto V_45;
V_286 = F_299 ( F_38 ( V_19 ) , V_251 , V_343 ) ;
F_9 ( V_286 ) ;
if ( F_384 ( * V_342 ) ) {
F_385 ( V_251 , V_342 ,
...
F_2 ( V_286 ) ;
V_45:
V_265 = ( T_9 * ) F_383 ( V_251 , V_342 , V_147 ) ;
F_332 ( V_65 ) ;
return V_265 ;
}
int F_315 ( struct V_250 * V_251 , unsigned long * V_147 , T_9 * V_264 )
{
T_16 * V_346 = F_387 ( V_251 , * V_147 ) ;
T_15 * V_342 = F_388 ( V_346 , * V_147 ) ;
...
T_15 * V_342 ;
T_9 * V_265 = NULL ;
V_346 = F_387 ( V_251 , V_147 ) ;
V_342 = F_391 ( V_251 , V_346 , V_147 ) ;
if ( V_342 ) {
if ( V_273 == V_338 ) {
V_265 = ( T_9 * ) V_342 ;
} else {
F_10 ( V_273 != V_348 ) ;
if ( F_392 () && F_384 ( * V_342 ) )
V_265 = F_381 ( V_251 , V_147 , V_342 ) ;
else
V_265 = ( T_9 * ) F_383 ( V_251 , V_342 , V_147 ) ;
}
}
F_10 ( V_265 && F_288 ( * V_265 ) && ! F_393 ( * V_265 ) ) ;
return V_265 ;
}
...
V_346 = F_387 ( V_251 , V_147 ) ;
if ( F_394 ( * V_346 ) ) {
V_342 = F_388 ( V_346 , V_147 ) ;
if ( F_395 ( * V_342 ) ) {
if ( F_396 ( * V_342 ) )
return ( T_9 * ) V_342 ;
V_349 = F_397 ( V_342 , V_147 ) ;
}
}
return ( T_9 * ) V_349 ;
}
struct V_74 * __weak
F_398 ( struct V_250 * V_251 , unsigned long V_50 ,
int V_242 )
{
return F_182 ( - V_202 ) ;
}
...
T_11 * V_286 ;
V_42:
V_286 = F_400 ( V_251 , V_349 ) ;
F_9 ( V_286 ) ;
if ( ! F_401 ( * V_349 ) )
goto V_45;
if ( F_402 ( * V_349 ) ) {
V_74 = F_403 ( * V_349 ) + ( ( V_50 & ~ V_350 ) >> V_184 ) ;
if ( V_70 & V_351 )
F_308 ( V_74 ) ;
} else {
if ( F_286 ( F_283 ( ( T_9 * ) V_349 ) ) ) {
F_2 ( V_286 ) ;
F_404 ( V_251 , ( T_9 * ) V_349 , V_286 ) ;
goto V_42;
}
}
V_45:
...
bool F_408 ( struct V_74 * V_74 , struct V_25 * V_181 )
{
bool V_13 = true ;
F_115 ( ! F_123 ( V_74 ) , V_74 ) ;
F_9 ( & V_126 ) ;
if ( ! F_122 ( V_74 ) || ! F_409 ( V_74 ) ) {
V_13 = false ;
goto V_353;
}
F_127 ( V_74 ) ;
F_410 ( & V_74 -> V_76 , V_181 ) ;
V_353:
F_2 ( & V_126 ) ;
return V_13 ;
}
void F_411 ( struct V_74 * V_74 )
{
F_115 ( ! F_123 ( V_74 ) , V_74 ) ;
F_9 ( & V_126 ) ;
F_125 ( V_74 ) ;
F_410 ( & V_74 -> V_76 , & ( F_130 ( V_74 ) ) -> V_80 ) ;
F_2 ( & V_126 ) ;
F_138 ( V_74 ) ;
}
