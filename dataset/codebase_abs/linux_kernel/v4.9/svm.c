...
return F_238 ( & V_10 -> V_9 ) ;
}
static unsigned long F_239 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
return V_10 -> V_24 . V_454 ;
}
static T_1 F_240 ( struct V_8 * V_9 , int V_152 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_1 V_291 = V_10 -> V_24 . V_454 ;
T_1 V_455 ;
int V_72 ;
V_72 = F_241 ( V_9 , F_242 ( V_291 ) , & V_455 ,
F_243 ( V_291 ) + V_152 * 8 , 8 ) ;
if ( V_72 )
return 0 ;
return V_455 ;
}
...
F_75 ( F_248 ( V_9 ) ) ;
F_249 ( V_9 ) ;
V_9 -> V_46 . V_463 . V_464 = F_244 ;
V_9 -> V_46 . V_463 . V_465 = F_239 ;
V_9 -> V_46 . V_463 . V_466 = F_240 ;
V_9 -> V_46 . V_463 . V_467 = F_245 ;
V_9 -> V_46 . V_463 . V_468 = F_28 () ;
F_250 ( V_9 , & V_9 -> V_46 . V_463 ) ;
...
V_10 -> V_24 . V_474 = true ;
F_256 ( V_10 -> V_1 -> V_65 . V_91 ) ;
return false ;
}
return true ;
}
static inline bool F_257 ( struct V_7 * V_10 )
{
if ( ! F_10 ( & V_10 -> V_9 ) )
return true ;
...
static void * F_258 ( struct V_7 * V_10 , T_1 V_479 , struct V_182 * * V_480 )
{
struct V_182 * V_182 ;
F_259 () ;
V_182 = F_260 ( & V_10 -> V_9 , V_479 >> V_141 ) ;
if ( F_261 ( V_182 ) )
goto error;
* V_480 = V_182 ;
return F_262 ( V_182 ) ;
...
static void F_263 ( struct V_182 * V_182 )
{
F_264 ( V_182 ) ;
F_265 ( V_182 ) ;
}
...
V_104 = 0 ;
if ( F_267 ( & V_10 -> V_9 , V_479 , & V_104 , V_481 ) )
return V_473 ;
...
return V_473 ;
V_50 *= 4 ;
if ( F_267 ( & V_10 -> V_9 , V_10 -> V_24 . V_486 + V_50 , & V_413 , 4 ) )
return V_473 ;
...
static inline void F_271 ( struct V_1 * V_497 , struct V_1 * V_498 )
{
...
V_1 -> V_2 . V_503 ,
V_505 ) ;
V_504 = F_258 ( V_10 , V_10 -> V_24 . V_1 , & V_182 ) ;
if ( ! V_504 )
return 1 ;
F_273 ( & V_10 -> V_9 ) ;
V_10 -> V_24 . V_1 = 0 ;
...
( void ) F_278 ( & V_10 -> V_9 , V_25 -> V_65 . V_291 ) ;
}
...
if ( F_267 ( & V_10 -> V_9 , V_50 , & V_413 , 4 ) )
return false ;
...
static bool F_281 ( struct V_1 * V_1 )
{
...
static bool F_282 ( struct V_7 * V_10 )
{
struct V_1 * V_504 ;
struct V_1 * V_25 = V_10 -> V_24 . V_25 ;
struct V_1 * V_1 = V_10 -> V_1 ;
...
V_504 = F_258 ( V_10 , V_10 -> V_1 -> V_65 . V_507 , & V_182 ) ;
if ( ! V_504 )
return false ;
if ( ! F_281 ( V_504 ) ) {
...
F_283 ( V_10 -> V_1 -> V_65 . V_91 , V_514 ,
V_504 -> V_65 . V_91 ,
V_504 -> V_2 . V_222 ,
V_504 -> V_2 . V_97 ,
V_504 -> V_2 . V_288 ) ;
F_284 ( V_504 -> V_2 . V_26 & 0xffff ,
V_504 -> V_2 . V_26 >> 16 ,
V_504 -> V_2 . V_28 ,
V_504 -> V_2 . V_29 ) ;
F_276 ( & V_10 -> V_9 ) ;
...
V_25 -> V_65 . V_393 = F_274 ( & V_10 -> V_9 ) ;
V_25 -> V_65 . V_286 = V_10 -> V_9 . V_46 . V_286 ;
V_25 -> V_65 . V_358 = F_275 ( & V_10 -> V_9 ) ;
...
( void ) F_278 ( & V_10 -> V_9 , V_504 -> V_65 . V_291 ) ;
F_121 ( & V_10 -> V_9 ) ;
...
static void F_287 ( struct V_1 * V_498 , struct V_1 * V_517 )
{
...
{
struct V_8 * V_9 = & V_10 -> V_9 ;
F_294 ( V_10 -> V_1 -> V_65 . V_91 , F_295 ( & V_10 -> V_9 , V_485 ) ,
F_295 ( & V_10 -> V_9 , V_511 ) ) ;
F_296 ( V_9 , F_295 ( & V_10 -> V_9 , V_511 ) ) ;
V_10 -> V_78 = F_39 ( & V_10 -> V_9 ) + 3 ;
F_34 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
{
F_298 ( V_10 -> V_1 -> V_65 . V_91 , F_295 ( & V_10 -> V_9 , V_511 ) ) ;
F_216 ( & V_10 -> V_9 , V_235 ) ;
return 1 ;
}
...
{
T_1 V_530 = F_302 ( & V_10 -> V_9 ) ;
T_2 V_152 = F_295 ( & V_10 -> V_9 , V_485 ) ;
if ( F_303 ( & V_10 -> V_9 , V_152 , V_530 ) == 0 ) {
V_10 -> V_78 = F_39 ( & V_10 -> V_9 ) + 3 ;
F_34 ( & V_10 -> V_9 ) ;
}
return 1 ;
...
if ( V_533 != V_550 )
V_535 = - 1 ;
if ( F_305 ( & V_10 -> V_9 , V_531 , V_535 , V_532 ,
V_87 , V_88 ) == V_552 ) {
...
F_296 ( & V_10 -> V_9 , V_10 -> V_1 -> V_2 . V_421 ) ;
F_34 ( & V_10 -> V_9 ) ;
return 1 ;
}
...
if ( ! F_36 ( V_79 ) )
return F_310 ( V_10 ) ;
V_103 = F_312 ( & V_10 -> V_9 ) ;
F_313 ( & V_10 -> V_9 , V_103 ) ;
return 1 ;
}
static bool F_314 ( struct V_7 * V_10 ,
unsigned long V_104 )
{
...
V_72 = ( F_270 ( V_10 ) == V_473 ) ;
}
return V_72 ;
}
static int F_315 ( struct V_7 * V_10 )
{
int V_360 , V_564 ;
unsigned long V_104 ;
int V_103 ;
...
if ( V_568 >= 16 ) {
if ( ! F_323 ( & V_10 -> V_9 , V_568 - 16 ) )
return 1 ;
V_104 = F_295 ( & V_10 -> V_9 , V_360 ) ;
F_324 ( & V_10 -> V_9 , V_568 - 16 , V_104 ) ;
} else {
if ( ! F_323 ( & V_10 -> V_9 , V_568 ) )
return 1 ;
F_325 ( & V_10 -> V_9 , V_568 , & V_104 ) ;
F_152 ( & V_10 -> V_9 , V_360 , V_104 ) ;
}
F_34 ( & V_10 -> V_9 ) ;
return 1 ;
...
struct V_426 * V_426 = V_10 -> V_9 . V_427 ;
int V_148 ;
T_4 V_569 = F_321 ( & V_10 -> V_9 ) ;
V_148 = F_315 ( V_10 ) ;
if ( F_327 ( & V_10 -> V_9 ) )
return V_148 ;
if ( V_569 <= F_321 ( & V_10 -> V_9 ) )
return V_148 ;
V_426 -> V_433 = V_570 ;
return 0 ;
}
static int F_328 ( struct V_8 * V_9 , struct V_571 * V_572 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
switch ( V_572 -> V_152 ) {
case V_573 : {
...
static int F_334 ( struct V_7 * V_10 )
{
T_2 V_594 = F_295 ( & V_10 -> V_9 , V_485 ) ;
struct V_571 V_572 ;
V_572 . V_152 = V_594 ;
V_572 . V_595 = false ;
if ( F_328 ( & V_10 -> V_9 , & V_572 ) ) {
F_335 ( V_594 ) ;
F_253 ( & V_10 -> V_9 , 0 ) ;
} else {
F_336 ( V_594 , V_572 . V_11 ) ;
...
static int F_337 ( struct V_8 * V_9 , T_1 V_11 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
int V_596 , V_597 ;
if ( V_11 & ~ V_598 )
...
static int F_338 ( struct V_8 * V_9 , struct V_571 * V_49 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
break;
case V_588 :
return F_337 ( V_9 , V_11 ) ;
case V_604 :
F_340 ( V_9 , L_15 , V_594 , V_11 ) ;
break;
case V_605 :
if ( F_117 ( V_9 ) )
F_6 ( F_4 ( V_9 ) , V_11 ) ;
default:
return F_341 ( V_9 , V_49 ) ;
}
return 0 ;
}
...
struct V_571 V_49 ;
T_2 V_594 = F_295 ( & V_10 -> V_9 , V_485 ) ;
T_1 V_11 = F_302 ( & V_10 -> V_9 ) ;
V_49 . V_11 = V_11 ;
V_49 . V_152 = V_594 ;
V_49 . V_595 = false ;
V_10 -> V_78 = F_39 ( & V_10 -> V_9 ) + 2 ;
if ( F_343 ( & V_10 -> V_9 , & V_49 ) ) {
F_344 ( V_594 , V_11 ) ;
F_253 ( & V_10 -> V_9 , 0 ) ;
} else {
F_345 ( V_594 , V_11 ) ;
...
F_355 ( V_10 -> V_9 . V_175 , V_608 , V_609 , V_300 , V_152 ) ;
switch ( V_300 ) {
case V_611 :
F_356 ( V_301 , V_612 , V_608 ) ;
F_356 ( V_301 , V_613 , V_609 ) ;
break;
case V_614 : {
int V_51 ;
struct V_8 * V_9 ;
...
static T_2 * F_361 ( struct V_8 * V_9 , T_2 V_620 , bool V_621 )
{
struct V_172 * V_178 = & V_9 -> V_177 -> V_46 ;
int V_152 ;
T_2 * V_622 ;
int V_623 = F_362 ( V_620 ) ;
if ( ! V_623 )
return NULL ;
if ( V_621 ) {
V_152 = F_363 ( V_623 ) - 1 ;
...
static int F_364 ( struct V_8 * V_9 , T_4 V_625 , T_2 V_620 ,
bool V_626 )
{
bool V_621 ;
T_2 * V_15 , V_299 ;
V_621 = F_365 ( V_9 -> V_46 . V_301 , V_627 ) == V_628 ;
V_15 = F_361 ( V_9 , V_620 , V_621 ) ;
if ( ! V_15 )
return - V_129 ;
V_299 = F_8 ( * V_15 ) ;
V_299 &= ~ V_629 ;
...
int V_72 ;
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_2 V_620 = F_365 ( V_9 -> V_46 . V_301 , V_631 ) ;
if ( ! V_620 )
return 1 ;
V_72 = F_364 ( V_9 , V_9 -> V_175 , V_620 , true ) ;
if ( V_72 && V_10 -> V_632 ) {
F_364 ( V_9 , 0 , V_10 -> V_632 , false ) ;
V_10 -> V_632 = 0 ;
} else {
V_10 -> V_632 = V_620 ;
}
...
T_1 * V_633 , * V_634 ;
struct V_7 * V_10 = F_4 ( V_9 ) ;
T_2 V_635 = F_365 ( V_9 -> V_46 . V_301 , V_636 ) ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
struct V_172 * V_178 = & V_9 -> V_177 -> V_46 ;
T_2 V_637 = F_365 ( V_9 -> V_46 . V_301 , V_627 ) ;
...
F_356 ( V_301 , V_50 , F_365 ( V_301 , V_50 ) ) ;
return 1 ;
}
static bool F_370 ( T_2 V_50 )
{
bool V_72 = false ;
switch ( V_50 ) {
case V_636 :
...
static int F_371 ( struct V_7 * V_10 )
{
int V_72 = 0 ;
T_2 V_50 = V_10 -> V_1 -> V_2 . V_421 &
V_640 ;
...
V_655 ;
bool V_656 = F_370 ( V_50 ) ;
F_372 ( V_10 -> V_9 . V_175 , V_50 ,
V_656 , V_156 , V_653 ) ;
if ( V_656 ) {
F_360 ( ! V_156 , L_20 ) ;
V_72 = F_369 ( V_10 ) ;
...
static void F_374 ( struct V_8 * V_9 , T_1 * V_657 , T_1 * V_658 )
{
...
if ( F_10 ( V_9 ) ) {
int V_470 ;
F_377 ( V_10 -> V_1 -> V_65 . V_91 , V_460 ,
V_10 -> V_1 -> V_2 . V_421 ,
V_10 -> V_1 -> V_2 . V_419 ,
V_10 -> V_1 -> V_2 . V_502 ,
V_10 -> V_1 -> V_2 . V_503 ,
...
static void F_382 ( struct V_7 * V_10 )
{
int V_147 = F_57 () ;
struct V_120 * V_121 = F_60 ( V_130 , V_147 ) ;
...
static inline void F_384 ( struct V_7 * V_10 , int V_667 )
{
struct V_18 * V_2 ;
V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_501 = V_667 ;
...
struct V_7 * V_10 = F_4 ( V_9 ) ;
F_76 ( ! ( F_23 ( V_10 ) ) ) ;
F_386 ( V_9 -> V_46 . V_670 . V_86 ) ;
++ V_9 -> V_352 . V_671 ;
V_10 -> V_1 -> V_2 . V_97 = V_9 -> V_46 . V_670 . V_86 |
V_70 | V_71 ;
}
static inline bool F_387 ( struct V_8 * V_9 )
{
return F_10 ( V_9 ) && ( V_9 -> V_46 . V_47 & V_475 ) ;
}
static void F_388 ( struct V_8 * V_9 , int V_672 , int V_673 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( F_387 ( V_9 ) ||
F_117 ( V_9 ) )
...
static void F_389 ( struct V_8 * V_9 , bool V_674 )
{
return;
}
static bool F_390 ( void )
{
return V_198 ;
}
static void F_391 ( struct V_8 * V_9 , int V_675 )
{
}
static void F_392 ( struct V_8 * V_9 , int V_676 )
{
}
static void F_393 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
struct V_1 * V_1 = V_10 -> V_1 ;
if ( ! V_198 )
...
static void F_394 ( struct V_8 * V_9 , T_1 * V_677 )
{
return;
}
static void F_395 ( struct V_8 * V_9 )
{
return;
}
static void F_396 ( struct V_8 * V_9 , int V_678 )
{
F_397 ( V_678 , V_9 -> V_46 . V_301 ) ;
F_398 () ;
if ( F_7 ( V_9 ) )
F_53 ( V_679 ,
F_146 ( V_9 -> V_147 ) ) ;
...
static void F_399 ( struct V_7 * V_10 , struct V_680 * V_681 )
{
unsigned long V_171 ;
struct V_313 * V_682 ;
F_89 ( & V_10 -> V_315 , V_171 ) ;
...
static int F_401 ( struct V_7 * V_10 , struct V_680 * V_681 )
{
int V_72 = 0 ;
unsigned long V_171 ;
struct V_313 * V_314 ;
...
F_89 ( & V_10 -> V_315 , V_171 ) ;
F_402 ( & V_314 -> V_684 , & V_10 -> V_316 ) ;
F_92 ( & V_10 -> V_315 , V_171 ) ;
V_317:
return V_72 ;
}
static int
F_403 ( struct V_177 * V_177 , struct V_688 * V_689 ,
struct V_690 * V_691 , struct V_7 * * V_10 )
{
struct V_692 V_667 ;
struct V_8 * V_9 = NULL ;
F_404 ( V_177 , V_689 , & V_667 ) ;
if ( ! F_405 ( V_177 , & V_667 , & V_9 ) ) {
F_88 ( L_99 ,
V_83 , V_667 . V_653 ) ;
return - 1 ;
}
...
static int F_406 ( struct V_177 * V_177 , unsigned int V_694 ,
...
V_698 = F_408 ( & V_177 -> V_700 ) ;
V_697 = F_409 ( V_177 -> V_701 , & V_177 -> V_700 ) ;
F_75 ( V_695 >= V_697 -> V_702 ) ;
F_410 (e, &irq_rt->map[guest_irq], link) {
struct V_690 V_691 ;
struct V_7 * V_10 = NULL ;
if ( V_689 -> type != V_703 )
continue;
if ( ! F_403 ( V_177 , V_689 , & V_691 , & V_10 ) && V_674 &&
F_117 ( & V_10 -> V_9 ) ) {
struct V_680 V_681 ;
V_681 . V_95 = F_115 ( V_10 -> V_213 ) & V_218 ;
V_681 . V_170 = F_411 ( V_177 -> V_46 . V_179 ,
V_10 -> V_9 . V_175 ) ;
V_681 . F_10 = true ;
V_681 . V_690 = & V_691 ;
V_72 = F_412 ( V_694 , & V_681 ) ;
if ( ! V_72 && V_681 . F_10 )
F_401 ( V_10 , & V_681 ) ;
} else {
struct V_680 V_681 ;
...
V_72 = V_72 && F_23 ( V_10 ) && F_257 ( V_10 ) ;
return V_72 ;
}
static bool F_416 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
return ! ! ( V_10 -> V_9 . V_46 . V_47 & V_665 ) ;
}
static void F_417 ( struct V_8 * V_9 , bool V_705 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( V_705 ) {
V_10 -> V_9 . V_46 . V_47 |= V_665 ;
...
static int F_418 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
struct V_1 * V_1 = V_10 -> V_1 ;
int V_72 ;
...
static int F_421 ( struct V_177 * V_177 , unsigned int V_57 )
{
return 0 ;
}
...
static inline void F_423 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
if ( F_387 ( V_9 ) )
return;
...
static void F_378 ( struct V_7 * V_10 )
{
T_4 V_653 ;
int type ;
...
F_427 ( & V_10 -> V_9 , V_653 , V_103 ) ;
} else
F_428 ( & V_10 -> V_9 , V_653 ) ;
break;
case V_549 :
F_429 ( & V_10 -> V_9 , V_653 , false ) ;
break;
default:
break;
}
}
static void F_430 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
struct V_18 * V_2 = & V_10 -> V_1 -> V_2 ;
V_2 -> V_502 = V_2 -> V_97 ;
...
static void F_435 ( struct V_8 * V_9 , unsigned long V_456 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void
F_438 ( struct V_8 * V_9 , unsigned char * V_718 )
{
V_718 [ 0 ] = 0x0f ;
V_718 [ 1 ] = 0x01 ;
V_718 [ 2 ] = 0xd9 ;
}
static void F_439 ( void * V_719 )
{
* ( int * ) V_719 = 0 ;
}
static bool F_440 ( void )
{
return false ;
}
...
static T_1 F_442 ( struct V_8 * V_9 , T_11 V_720 , bool V_721 )
{
return 0 ;
}
static void F_443 ( struct V_8 * V_9 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
struct V_722 * V_15 ;
V_10 -> V_508 = ! ! F_444 ( & V_10 -> V_9 ) ;
if ( ! F_117 ( V_9 ) )
return;
V_15 = F_445 ( V_9 , 1 , 0 ) ;
if ( V_15 )
...
static void F_446 ( T_2 V_724 , struct V_722 * V_15 )
{
switch ( V_724 ) {
case 0x1 :
if ( V_198 )
...
static int F_454 ( struct V_8 * V_9 ,
struct V_730 * V_68 ,
enum V_731 V_732 )
{
struct V_7 * V_10 = F_4 ( V_9 ) ;
...
static void F_457 ( struct V_8 * V_9 , int V_147 )
{
}
static inline void F_458 ( struct V_8 * V_9 )
{
if ( F_367 ( V_9 ) != 0 )
return;
if ( F_368 ( V_9 ) != 0 )
...
static int T_5 F_459 ( void )
{
return F_460 ( & V_760 , sizeof( struct V_7 ) ,
F_461 ( struct V_7 ) , V_761 ) ;
}
static void T_6 F_462 ( void )
{
F_463 () ;
}
