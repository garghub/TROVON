...
V_3 -> V_21 = & V_90 -> V_21 ;
if ( V_3 -> V_103 ) {
V_102 = F_42 ( V_3 -> V_103 ) ;
if ( ! F_43 ( V_102 ) )
F_44 ( & V_90 -> V_21 , V_102 , & V_31 ) ;
}
...
V_100 = F_46 ( V_90 , V_104 , 0 ) ;
V_12 -> V_55 = F_47 ( & V_90 -> V_21 , V_100 ) ;
if ( F_43 ( V_12 -> V_55 ) )
...
V_98 = F_33 ( & V_90 -> V_21 , sizeof( * V_98 ) ,
V_33 ) ;
if ( ! V_98 )
return - V_34 ;
V_98 -> V_4 = F_8 ( & V_90 -> V_21 ) ;
V_98 -> V_14 = V_3 -> V_14 ;
V_98 -> V_15 = V_3 -> V_15 ;
V_98 -> V_105 = & V_106 ,
V_98 -> V_107 = & V_108 ,
...
V_12 -> V_21 = V_3 -> V_21 ;
F_51 ( V_90 , V_12 ) ;
V_12 -> V_113 = F_52 ( & V_90 -> V_21 ,
V_98 , V_12 ) ;
if ( F_43 ( V_12 -> V_113 ) ) {
F_10 ( & V_90 -> V_21 , L_29 ) ;
return F_48 ( V_12 -> V_113 ) ;
}
F_53 ( & V_90 -> V_21 , L_30 ) ;
return 0 ;
}
