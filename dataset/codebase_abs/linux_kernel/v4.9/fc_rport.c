...
struct V_98 * V_99 )
{
unsigned long V_101 = F_45 ( V_102 ) ;
if ( F_43 ( V_99 ) == - V_103 )
goto V_91;
...
unsigned int V_25 ;
T_3 V_106 ;
V_105 = F_48 ( V_99 , sizeof( * V_105 ) ) ;
if ( ! V_105 )
return - V_107 ;
V_106 = F_19 ( V_105 -> V_50 . V_108 ) ;
if ( F_49 ( V_99 ) == V_109 ) {
if ( V_106 & V_110 ) {
F_22 ( V_5 , L_18 ) ;
return - V_107 ;
...
V_25 = F_50 ( V_105 -> V_50 . V_111 ) ;
if ( V_106 & V_112 )
V_25 /= 1000000 ;
if ( V_25 > V_5 -> V_25 )
V_5 -> V_25 = V_25 ;
}
V_5 -> V_27 = F_18 ( V_105 , V_3 -> V_49 ) ;
return 0 ;
}
static void F_51 ( struct V_113 * V_114 , struct V_98 * V_99 ,
void * V_115 )
{
...
if ( ! V_105 )
goto V_119;
V_26 = F_50 ( V_105 -> V_50 . V_120 ) ;
if ( V_26 > V_5 -> V_26 )
V_5 -> V_26 = V_26 ;
if ( V_5 -> V_7 . V_14 < V_3 -> V_121 )
F_38 ( V_5 ) ;
else
F_20 ( V_5 , V_97 ) ;
V_91:
...
if ( ! V_3 -> V_9 . V_122 ( V_3 , V_5 -> V_7 . V_4 , V_99 , V_109 ,
F_51 , V_5 ,
2 * V_3 -> V_26 ) )
F_44 ( V_5 , NULL ) ;
else
...
static void F_61 ( struct V_113 * V_114 , struct V_98 * V_99 ,
void * V_144 )
{
...
V_5 -> V_108 = F_19 ( V_145 -> V_50 . V_108 ) ;
if ( V_3 -> V_100 )
F_47 ( V_5 , V_99 ) ;
...
static void F_64 ( struct V_113 * V_114 , struct V_98 * V_99 ,
void * V_144 )
{
struct V_1 * V_5 = V_144 ;
struct {
...
static void F_68 ( struct V_113 * V_114 , struct V_98 * V_99 ,
void * V_144 )
{
struct V_1 * V_5 = V_144 ;
T_2 V_148 ;
...
static void F_69 ( struct V_113 * V_114 , struct V_98 * V_99 ,
void * V_202 )
{
struct V_2 * V_3 = V_202 ;
F_58 ( V_3 , F_70 ( V_114 ) -> V_203 ,
L_39 , F_52 ( V_99 ) ) ;
if ( F_42 ( V_99 ) )
return;
F_54 ( V_99 ) ;
...
static void F_71 ( struct V_113 * V_114 , struct V_98 * V_99 ,
void * V_144 )
{
struct V_1 * V_5 = V_144 ;
struct V_206 * V_207 ;
