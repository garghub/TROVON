...
return;
V_42 -> V_112 &= ~ V_113 ;
if ( F_11 ( V_114 , & V_42 -> V_47 ) ||
F_11 ( V_115 , & V_42 -> V_47 ) )
return;
F_8 ( & V_116 ) ;
F_9 (client, &i40e_clients, list) {
if ( ! F_11 ( V_117 , & V_43 -> V_47 ) )
continue;
if ( ! ( V_43 -> V_112 & V_118 ) ) {
if ( F_11 ( V_114 , & V_42 -> V_9 [ V_42 -> V_75 ] -> V_47 ) )
continue;
} else {
...
V_49 = V_43 -> V_44 -> V_50 ( & V_39 -> V_41 , V_43 ) ;
F_38 ( & V_39 -> V_119 ) ;
if ( ! V_49 ) {
F_15 ( V_46 , & V_39 -> V_47 ) ;
} else {
...
static int F_47 ( struct V_71 * V_43 )
{
struct V_120 * V_52 ;
struct V_56 * V_42 ;
int V_49 = 0 ;
...
( V_142 <<
V_143 ) ) ;
F_18 ( V_15 , F_51 ( V_58 -> V_134 ) , V_132 ) ;
}
if ( V_58 -> V_144 != V_135 ) {
V_132 = ( V_145 |
( V_60 << V_146 ) |
...
V_129 = F_55 ( & V_42 -> V_15 , & V_157 , NULL ) ;
V_157 . V_112 = V_162 ;
if ( V_129 ) {
F_33 ( & V_42 -> V_29 -> V_30 ,
L_25 ,
F_56 ( & V_42 -> V_15 , V_129 ) ,
F_57 ( & V_42 -> V_15 ,
...
if ( V_158 ) {
V_129 = F_59 ( & V_9 -> V_14 -> V_15 , & V_157 , NULL ) ;
if ( V_129 ) {
F_33 ( & V_42 -> V_29 -> V_30 ,
L_27 ,
F_56 ( & V_42 -> V_15 , V_129 ) ,
