...
if ( ! V_2 -> V_66 ) {
F_31 ( & V_29 -> V_40 ) ;
F_68 ( & V_29 -> V_40 , & V_2 -> V_48 ) ;
V_2 -> V_106 ++ ;
V_2 -> V_93 -- ;
if ( V_2 -> V_106 == V_2 -> V_97 )
V_2 -> V_106 = 0 ;
} else {
F_69 ( & V_2 -> V_46 , & V_2 -> V_48 ) ;
V_2 -> V_93 = 0 ;
}
}
...
V_124 = F_65 ( & V_113 -> V_31 ,
struct V_27 , V_40 ) ;
V_125 = V_2 -> V_54 ;
V_125 -> V_16 = V_124 -> V_16 ;
F_72 ( & V_124 -> V_40 , & V_125 -> V_40 ) ;
V_2 -> V_54 = V_124 ;
...
static T_7 F_80 ( int V_134 , void * V_61 )
{
struct V_1 * V_2 = V_61 ;
T_1 V_76 ;
V_76 = F_6 ( V_2 , V_78 ) ;
...
V_147:
F_68 ( & V_29 -> V_40 , & V_2 -> V_46 ) ;
V_2 -> V_93 ++ ;
if ( V_2 -> V_66 && ( V_2 -> V_4 -> V_37 -> V_38 == V_39 )
&& F_85 ( V_2 -> V_93 > V_2 -> V_97 ) ) {
F_39 ( V_2 -> V_51 , L_12 ) ;
V_2 -> V_93 = V_2 -> V_97 ;
}
}
static T_6 F_86 ( struct V_148 * V_149 )
{
struct V_28 * V_29 = F_87 ( V_149 ) ;
...
if ( ! V_29 )
return NULL ;
F_91 ( & V_29 -> V_57 , & V_2 -> V_160 ) ;
V_29 -> V_57 . V_161 = F_86 ;
F_92 ( & V_29 -> V_57 ) ;
V_22 = F_18 ( V_2 ) ;
if ( ! V_22 )
goto error;
...
static struct V_148 *
F_93 ( struct V_49 * V_50 , T_3 V_168 ,
T_3 V_169 , T_4 V_170 , unsigned long V_44 )
{
struct V_1 * V_2 = F_38 ( V_50 ) ;
struct V_28 * V_29 ;
struct V_26 * V_22 , * V_153 ;
struct V_118 * V_16 ;
if ( ! V_170 || V_170 > V_77 )
return NULL ;
V_29 = F_26 ( V_2 ) ;
...
V_18 = 0 ;
while ( V_18 < F_96 ( V_178 ) ) {
struct V_15 * V_16 ;
V_22 = F_21 ( V_2 ) ;
if ( ! V_22 )
goto error;
V_179 = F_97 ( T_4 , F_96 ( V_178 ) - V_18 ,
V_77 ) ;
V_16 = & V_22 -> V_16 ;
F_15 ( V_2 , V_16 , F_98 ( V_178 ) ,
V_18 , 0 ) ;
V_16 -> V_75 = V_179 ;
if ( V_2 -> V_98 == V_99 ) {
if ( V_177 )
...
static int F_101 ( struct V_49 * V_50 )
{
struct V_1 * V_2 = F_38 ( V_50 ) ;
T_1 V_3 ;
if ( V_2 -> V_60 )
...
return F_79 ( V_2 ) ;
V_196 = F_6 ( V_2 , V_64 ) ;
V_2 -> V_86 . V_164 = V_195 -> V_164 ;
V_2 -> V_86 . V_94 = V_195 -> V_94 ;
V_2 -> V_86 . V_198 = V_195 -> V_198 ;
V_2 -> V_86 . V_199 = V_195 -> V_199 ;
if ( V_195 -> V_198 && V_2 -> V_200 ) {
V_196 |= V_201 ;
V_196 |= V_195 -> V_199 << V_202 ;
}
V_2 -> V_86 . V_90 = V_195 -> V_90 ;
if ( V_195 -> V_94 )
V_2 -> V_86 . V_96 = V_195 -> V_96 ;
else
V_2 -> V_86 . V_96 = - 1 ;
V_2 -> V_86 . V_203 = V_195 -> V_203 ;
V_2 -> V_86 . V_204 = V_195 -> V_204 ;
if ( V_195 -> V_203 <= V_205 ) {
V_196 |= V_195 -> V_203 << V_206 ;
V_2 -> V_86 . V_203 = V_195 -> V_203 ;
}
if ( V_195 -> V_204 <= V_207 ) {
V_196 |= V_195 -> V_204 << V_208 ;
V_2 -> V_86 . V_204 = V_195 -> V_204 ;
}
V_196 &= ~ V_209 ;
V_196 |= V_195 -> V_210 << V_211 ;
F_7 ( V_2 , V_64 , V_196 ) ;
return 0 ;
}
...
F_104 ( V_2 -> V_134 , V_2 ) ;
F_105 ( & V_2 -> V_143 ) ;
F_31 ( & V_2 -> V_160 . V_212 ) ;
}
static int F_106 ( struct V_213 * V_214 , struct V_215 * * V_216 ,
struct V_215 * * V_217 , struct V_215 * * V_218 ,
struct V_215 * * V_219 , struct V_215 * * V_220 )
{
int V_82 ;
* V_220 = NULL ;
* V_216 = F_107 ( & V_214 -> V_51 , L_13 ) ;
if ( F_108 ( * V_216 ) ) {
V_82 = F_109 ( * V_216 ) ;
F_51 ( & V_214 -> V_51 , L_14 , V_82 ) ;
return V_82 ;
}
* V_217 = F_107 ( & V_214 -> V_51 , L_15 ) ;
if ( F_108 ( * V_217 ) )
* V_217 = NULL ;
* V_218 = F_107 ( & V_214 -> V_51 , L_16 ) ;
if ( F_108 ( * V_218 ) )
* V_218 = NULL ;
* V_219 = F_107 ( & V_214 -> V_51 , L_17 ) ;
if ( F_108 ( * V_219 ) )
* V_219 = NULL ;
V_82 = F_110 ( * V_216 ) ;
if ( V_82 ) {
F_51 ( & V_214 -> V_51 , L_18 , V_82 ) ;
return V_82 ;
}
V_82 = F_110 ( * V_217 ) ;
if ( V_82 ) {
F_51 ( & V_214 -> V_51 , L_19 , V_82 ) ;
goto V_221;
}
V_82 = F_110 ( * V_218 ) ;
if ( V_82 ) {
F_51 ( & V_214 -> V_51 , L_20 , V_82 ) ;
goto V_222;
}
V_82 = F_110 ( * V_219 ) ;
if ( V_82 ) {
F_51 ( & V_214 -> V_51 , L_21 , V_82 ) ;
goto V_223;
}
return 0 ;
V_223:
...
static int F_112 ( struct V_213 * V_214 , struct V_215 * * V_216 ,
struct V_215 * * V_224 , struct V_215 * * V_220 ,
struct V_215 * * V_225 , struct V_215 * * V_226 )
{
int V_82 ;
* V_220 = NULL ;
* V_225 = NULL ;
...
if ( F_108 ( * V_216 ) ) {
V_82 = F_109 ( * V_216 ) ;
F_51 ( & V_214 -> V_51 , L_22 , V_82 ) ;
return V_82 ;
}
* V_224 = F_107 ( & V_214 -> V_51 , L_23 ) ;
if ( F_108 ( * V_224 ) ) {
V_82 = F_109 ( * V_224 ) ;
F_51 ( & V_214 -> V_51 , L_24 , V_82 ) ;
return V_82 ;
}
V_82 = F_110 ( * V_216 ) ;
if ( V_82 ) {
...
static int F_113 ( struct V_213 * V_214 , struct V_215 * * V_216 ,
struct V_215 * * V_217 , struct V_215 * * V_227 ,
struct V_215 * * V_218 , struct V_215 * * V_228 )
{
int V_82 ;
* V_216 = F_107 ( & V_214 -> V_51 , L_13 ) ;
if ( F_108 ( * V_216 ) ) {
...
if ( F_108 ( * V_217 ) )
* V_217 = NULL ;
* V_227 = F_107 ( & V_214 -> V_51 , L_26 ) ;
if ( F_108 ( * V_227 ) )
* V_227 = NULL ;
* V_218 = F_107 ( & V_214 -> V_51 , L_16 ) ;
if ( F_108 ( * V_218 ) )
* V_218 = NULL ;
* V_228 = F_107 ( & V_214 -> V_51 , L_27 ) ;
if ( F_108 ( * V_228 ) )
* V_228 = NULL ;
V_82 = F_110 ( * V_216 ) ;
if ( V_82 ) {
...
static void F_114 ( struct V_230 * V_4 )
{
F_111 ( V_4 -> V_228 ) ;
F_111 ( V_4 -> V_218 ) ;
F_111 ( V_4 -> V_227 ) ;
...
static int F_115 ( struct V_230 * V_4 ,
struct V_212 * V_40 , int V_231 )
{
struct V_1 * V_2 ;
bool V_232 = false ;
T_1 V_6 , V_233 ;
int V_82 ;
V_2 = F_116 ( V_4 -> V_51 , sizeof( * V_2 ) , V_30 ) ;
if ( ! V_2 )
return - V_63 ;
V_2 -> V_51 = V_4 -> V_51 ;
V_2 -> V_4 = V_4 ;
...
F_28 ( & V_2 -> V_47 ) ;
F_28 ( & V_2 -> V_48 ) ;
V_232 = F_118 ( V_40 , L_30 ) ;
V_2 -> V_200 = F_118 ( V_40 , L_31 ) ;
V_82 = F_119 ( V_40 , L_32 , & V_6 ) ;
if ( V_82 ) {
F_51 ( V_4 -> V_51 , L_33 ) ;
return V_82 ;
}
...
V_2 -> V_134 = F_122 ( V_40 , 0 ) ;
V_82 = F_123 ( V_2 -> V_134 , F_80 , V_245 ,
L_40 , V_2 ) ;
if ( V_82 ) {
...
V_2 -> V_130 = F_63 ;
F_124 ( & V_2 -> V_143 , F_47 ,
( unsigned long ) V_2 ) ;
V_2 -> V_160 . V_246 = & V_4 -> V_160 ;
F_68 ( & V_2 -> V_160 . V_212 , & V_4 -> V_160 . V_247 ) ;
...
static int F_125 ( struct V_230 * V_4 ,
struct V_212 * V_40 ) {
int V_72 , V_105 , V_240 = 1 ;
V_72 = F_119 ( V_40 , L_43 , & V_240 ) ;
if ( ( V_72 < 0 ) && V_4 -> V_126 )
F_126 ( V_4 -> V_51 , L_44 ) ;
for ( V_105 = 0 ; V_105 < V_240 ; V_105 ++ )
F_115 ( V_4 , V_40 , V_4 -> V_231 ++ ) ;
V_4 -> V_240 += V_240 ;
return 0 ;
}
static struct V_49 * F_127 ( struct V_248 * V_249 ,
struct V_250 * V_251 )
{
struct V_230 * V_4 = V_251 -> V_252 ;
int V_231 = V_249 -> args [ 0 ] ;
if ( V_231 >= V_4 -> V_240 || ! V_4 -> V_2 [ V_231 ] )
return NULL ;
return F_128 ( & V_4 -> V_2 [ V_231 ] -> V_160 ) ;
}
static int F_129 ( struct V_213 * V_214 )
{
int (* F_130)( struct V_213 * , struct V_215 * * , struct V_215 * * ,
struct V_215 * * , struct V_215 * * , struct V_215 * * )
= F_113 ;
struct V_212 * V_40 = V_214 -> V_51 . V_253 ;
struct V_230 * V_4 ;
struct V_212 * V_254 , * V_255 = V_214 -> V_51 . V_253 ;
struct V_256 * V_257 ;
T_1 V_258 , V_259 ;
int V_105 , V_82 ;
V_4 = F_116 ( & V_214 -> V_51 , sizeof( * V_4 ) , V_30 ) ;
if ( ! V_4 )
return - V_63 ;
V_4 -> V_51 = & V_214 -> V_51 ;
if ( V_255 ) {
const struct V_260 * V_261 ;
V_261 = F_131 ( V_262 , V_255 ) ;
if ( V_261 && V_261 -> V_61 ) {
V_4 -> V_37 = V_261 -> V_61 ;
F_130 = V_4 -> V_37 -> F_130 ;
}
}
V_82 = F_130 ( V_214 , & V_4 -> V_216 , & V_4 -> V_217 , & V_4 -> V_227 ,
& V_4 -> V_218 , & V_4 -> V_228 ) ;
if ( V_82 )
return V_82 ;
V_257 = F_132 ( V_214 , V_263 , 0 ) ;
V_4 -> V_5 = F_133 ( & V_214 -> V_51 , V_257 ) ;
if ( F_108 ( V_4 -> V_5 ) )
return F_109 ( V_4 -> V_5 ) ;
V_4 -> V_66 = F_118 ( V_40 , L_45 ) ;
if ( V_4 -> V_37 -> V_38 == V_52 )
V_4 -> V_126 = F_118 ( V_40 , L_46 ) ;
if ( V_4 -> V_37 -> V_38 == V_39 ) {
V_82 = F_119 ( V_40 , L_47 ,
& V_258 ) ;
if ( V_82 < 0 ) {
F_51 ( V_4 -> V_51 ,
L_48 ) ;
...
V_82 = F_119 ( V_40 , L_49 ,
& V_4 -> V_140 ) ;
if ( V_82 < 0 )
F_126 ( V_4 -> V_51 ,
L_50 ) ;
}
V_82 = F_119 ( V_40 , L_51 , & V_259 ) ;
if ( V_82 < 0 )
F_126 ( V_4 -> V_51 , L_52 ) ;
if ( V_259 > 32 )
V_4 -> V_14 = true ;
...
V_4 -> V_14 = false ;
F_134 ( V_4 -> V_51 , F_135 ( V_259 ) ) ;
V_4 -> V_160 . V_51 = & V_214 -> V_51 ;
F_28 ( & V_4 -> V_160 . V_247 ) ;
if ( ! ( V_4 -> V_37 -> V_38 == V_41 ) ) {
F_136 ( V_264 , V_4 -> V_160 . V_265 ) ;
F_136 ( V_266 , V_4 -> V_160 . V_265 ) ;
}
V_4 -> V_160 . V_267 =
F_48 ;
V_4 -> V_160 . V_268 =
F_37 ;
V_4 -> V_160 . V_269 = F_101 ;
V_4 -> V_160 . V_270 = F_53 ;
V_4 -> V_160 . V_271 = F_75 ;
if ( V_4 -> V_37 -> V_38 == V_52 ) {
F_136 ( V_272 , V_4 -> V_160 . V_265 ) ;
V_4 -> V_160 . V_273 = F_94 ;
V_4 -> V_160 . V_274 =
F_99 ;
V_4 -> V_160 . V_275 =
F_100 ;
...
F_136 ( V_278 , V_4 -> V_160 . V_265 ) ;
V_4 -> V_160 . V_279 = F_93 ;
} else {
V_4 -> V_160 . V_275 =
F_89 ;
}
F_137 ( V_214 , V_4 ) ;
F_138 (node, child) {
V_82 = F_125 ( V_4 , V_254 ) ;
if ( V_82 < 0 )
goto V_280;
}
if ( V_4 -> V_37 -> V_38 == V_39 ) {
for ( V_105 = 0 ; V_105 < V_4 -> V_240 ; V_105 ++ )
if ( V_4 -> V_2 [ V_105 ] )
V_4 -> V_2 [ V_105 ] -> V_97 = V_258 ;
}
F_139 ( & V_4 -> V_160 ) ;
V_82 = F_140 ( V_40 , F_127 ,
V_4 ) ;
if ( V_82 < 0 ) {
F_51 ( & V_214 -> V_51 , L_53 ) ;
F_141 ( & V_4 -> V_160 ) ;
goto error;
}
F_142 ( & V_214 -> V_51 , L_54 ) ;
return 0 ;
V_280:
F_114 ( V_4 ) ;
error:
...
{
struct V_230 * V_4 = F_144 ( V_214 ) ;
int V_105 ;
F_145 ( V_214 -> V_51 . V_253 ) ;
F_141 ( & V_4 -> V_160 ) ;
for ( V_105 = 0 ; V_105 < V_4 -> V_240 ; V_105 ++ )
if ( V_4 -> V_2 [ V_105 ] )
F_103 ( V_4 -> V_2 [ V_105 ] ) ;
