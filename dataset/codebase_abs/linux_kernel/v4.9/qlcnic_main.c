...
for ( V_307 = 0 ; V_307 < V_2 -> V_96 ; V_307 ++ ) {
V_11 = & V_2 -> V_11 [ V_307 ] ;
V_11 -> V_404 = V_2 -> V_236 ;
V_11 -> V_405 = F_227 ( V_22 , V_307 ) ;
V_402 = F_81 ( F_228 ( V_11 ) ) ;
if ( V_402 == NULL ) {
F_225 ( V_2 ) ;
return - V_57 ;
}
...
T_1 V_460 = 0 ;
T_3 V_154 = 0 ;
if ( V_2 -> V_346 . V_461 && V_2 -> V_346 . V_462 )
return;
V_154 = V_2 -> V_4 -> V_145 ;
F_229 ( & V_2 -> V_463 ) ;
F_229 ( & V_2 -> V_464 ) ;
if ( F_20 ( V_2 ) ) {
V_460 = V_465 - 1 ;
V_2 -> V_346 . V_466 = V_467 ;
} else if ( F_57 ( V_2 ) ) {
V_460 = V_369 ;
V_2 -> V_346 . V_466 = V_468 ;
} else {
V_460 = V_469 ;
V_2 -> V_346 . V_466 = V_470 ;
}
V_34 = F_66 ( V_2 -> V_346 . V_466 ,
sizeof( struct V_471 ) , V_472 ) ;
if ( ! V_34 )
return;
V_2 -> V_346 . V_461 = ( V_460 / V_154 ) ;
V_2 -> V_346 . V_462 = V_34 ;
F_68 ( V_22 , L_57 ,
V_154 , V_2 -> V_346 . V_461 ) ;
for ( V_134 = 0 ; V_134 < V_2 -> V_346 . V_466 ; V_134 ++ )
F_293 ( & V_2 -> V_346 . V_462 [ V_134 ] ) ;
V_2 -> V_473 . V_466 = V_2 -> V_346 . V_466 ;
V_34 = F_66 ( V_2 -> V_473 . V_466 ,
sizeof( struct V_471 ) , V_472 ) ;
if ( ! V_34 )
return;
V_2 -> V_473 . V_461 = ( V_460 / V_154 ) ;
V_2 -> V_473 . V_462 = V_34 ;
for ( V_134 = 0 ; V_134 < V_2 -> V_473 . V_466 ; V_134 ++ )
F_293 ( & V_2 -> V_473 . V_462 [ V_134 ] ) ;
}
static void F_279 ( struct V_1 * V_2 )
{
if ( V_2 -> V_346 . V_461 )
F_7 ( V_2 -> V_346 . V_462 ) ;
V_2 -> V_346 . V_462 = NULL ;
V_2 -> V_346 . V_461 = 0 ;
if ( V_2 -> V_473 . V_461 )
F_7 ( V_2 -> V_473 . V_462 ) ;
V_2 -> V_473 . V_461 = 0 ;
V_2 -> V_473 . V_462 = NULL ;
}
int F_294 ( struct V_1 * V_2 )
{
struct V_21 * V_22 = V_2 -> V_22 ;
T_1 V_474 , V_475 , V_248 = 0 ;
int V_476 = 0 ;
if ( F_65 ( V_2 ) )
V_248 = F_295 ( V_2 -> V_4 , V_477 ) ;
if ( F_57 ( V_2 ) )
V_248 = F_97 ( V_2 , V_478 ) ;
V_474 = F_296 ( V_248 ) ;
V_475 = F_297 ( V_248 ) ;
if ( V_474 == V_479 ) {
F_83 ( & V_22 -> V_30 ,
...
int V_134 ;
struct V_482 * V_483 ;
for ( V_134 = 0 ; V_134 < V_11 -> V_404 ; V_134 ++ ) {
V_483 = & V_11 -> V_484 [ V_134 ] ;
F_37 ( L_65 , V_134 ) ;
F_299 ( V_485 , L_66 , V_486 , 16 , 1 ,
& V_11 -> V_484 [ V_134 ] ,
sizeof( struct V_482 ) , true ) ;
}
}
...
F_68 ( V_22 ,
L_67 ,
V_307 , F_301 ( V_337 -> V_487 ) ,
V_337 -> V_12 , V_337 -> V_404 ) ;
}
for ( V_307 = 0 ; V_307 < V_2 -> V_98 ; V_307 ++ ) {
V_306 = & ( V_15 -> V_19 [ V_307 ] ) ;
if ( ! V_306 )
...
F_68 ( V_22 ,
L_68 ,
V_307 , F_301 ( V_306 -> V_488 ) ,
V_306 -> V_489 , F_301 ( V_306 -> V_490 ) ,
V_306 -> V_404 ) ;
}
for ( V_307 = 0 ; V_307 < V_2 -> V_96 ; V_307 ++ ) {
V_11 = & V_2 -> V_11 [ V_307 ] ;
...
L_72 ,
F_301 ( V_11 -> V_13 ) ,
V_11 -> V_12 , V_11 -> V_497 ,
F_302 ( * ( V_11 -> V_498 ) ) ) ;
F_68 ( V_22 , L_73 ,
V_11 -> V_404 , F_303 ( V_11 ) ) ;
if ( F_304 ( V_2 -> V_4 ) )
F_298 ( V_11 ) ;
}
}
...
static struct V_502 * F_307 ( struct V_21 * V_22 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
struct V_502 * V_355 = & V_22 -> V_355 ;
if ( F_21 ( V_45 , & V_2 -> V_46 ) )
F_308 ( V_2 ) ;
V_355 -> V_333 = V_2 -> V_355 . V_503 + V_2 -> V_355 . V_504 ;
V_355 -> V_329 = V_2 -> V_355 . V_505 ;
V_355 -> V_506 = V_2 -> V_355 . V_507 + V_2 -> V_355 . V_508 ;
V_355 -> V_509 = V_2 -> V_355 . V_510 ;
V_355 -> V_511 = V_2 -> V_355 . V_512 ;
V_355 -> V_513 = V_2 -> V_355 . V_514 ;
return V_355 ;
}
static T_10 F_309 ( struct V_1 * V_2 )
{
T_1 V_515 ;
V_515 = F_301 ( V_2 -> V_129 ) ;
if ( ! ( V_515 & V_2 -> V_4 -> V_127 ) )
return V_516 ;
V_515 = F_301 ( V_2 -> V_131 ) ;
if ( ! F_310 ( V_515 ) )
return V_516 ;
...
static void
F_154 ( struct V_1 * V_2 , T_2 V_521 )
{
T_1 V_522 ;
V_522 = V_2 -> V_439 & 0xf ;
V_522 |= V_521 << 7 ;
V_522 |= ( V_429 - V_2 -> V_428 ) << 8 ;
F_99 ( V_2 , V_523 , V_522 ) ;
V_2 -> V_428 = V_429 ;
}
static int
...
if ( F_96 ( V_2 ) )
return - V_116 ;
V_522 = F_97 ( V_2 , V_526 ) ;
if ( V_46 == V_524 )
F_317 ( V_522 , V_2 -> V_439 ) ;
else if ( V_46 == V_525 )
F_318 ( V_522 , V_2 -> V_439 ) ;
F_99 ( V_2 , V_526 , V_522 ) ;
F_100 ( V_2 ) ;
return 0 ;
}
static int
...
return - V_363 ;
V_522 = F_97 ( V_2 , V_526 ) ;
F_320 ( V_522 , V_2 -> V_439 ) ;
F_99 ( V_2 , V_526 , V_522 ) ;
F_100 ( V_2 ) ;
return 0 ;
}
void F_265 ( struct V_1 * V_2 , T_2 V_527 )
{
T_1 V_522 ;
if ( F_96 ( V_2 ) )
goto V_52;
V_522 = F_97 ( V_2 , V_528 ) ;
F_321 ( V_522 , V_2 -> V_439 ) ;
F_99 ( V_2 , V_528 , V_522 ) ;
if ( V_527 ) {
F_99 ( V_2 , V_302 ,
V_304 ) ;
F_71 ( & V_2 -> V_5 -> V_30 ,
L_76 ) ;
} else if ( ! ( V_522 & 0x11111111 ) )
F_99 ( V_2 , V_302 ,
V_529 ) ;
V_522 = F_97 ( V_2 , V_526 ) ;
F_320 ( V_522 , V_2 -> V_439 ) ;
...
V_2 -> V_530 = 0 ;
V_2 -> V_41 &= ~ V_531 ;
F_126 ( V_532 , & V_2 -> V_46 ) ;
F_126 ( V_64 , & V_2 -> V_46 ) ;
}
static int
F_322 ( struct V_1 * V_2 )
{
int V_533 , V_46 , V_534 ;
struct V_3 * V_4 = V_2 -> V_4 ;
V_46 = F_97 ( V_2 , V_526 ) ;
V_533 = F_97 ( V_2 , V_528 ) ;
if ( V_2 -> V_41 & V_535 ) {
V_534 = ( ~ ( 1 << ( V_4 -> V_27 * 4 ) ) ) ;
V_533 = V_533 & V_534 ;
}
if ( ( ( V_46 & 0x11111111 ) == ( V_533 & 0x11111111 ) ) ||
( ( V_533 & 0x11111111 ) == ( ( V_46 >> 1 ) & 0x11111111 ) ) )
return 0 ;
else
return 1 ;
}
...
V_538 = F_97 ( V_2 , V_302 ) ;
F_325 ( V_2 , V_540 , L_79 , V_538 ) ;
switch ( V_538 ) {
case V_529 :
F_99 ( V_2 , V_302 ,
V_541 ) ;
...
F_99 ( V_2 , V_302 ,
V_541 ) ;
F_123 ( V_532 , & V_2 -> V_46 ) ;
F_325 ( V_2 , V_550 , L_85 ) ;
F_154 ( V_2 , 0 ) ;
V_522 = F_97 ( V_2 ,
V_526 ) ;
F_317 ( V_522 , V_2 -> V_439 ) ;
...
if ( F_328 ( V_2 ) &&
( V_2 -> V_41 & V_535 ) ) {
F_325 ( V_2 , V_550 , L_86 ) ;
F_329 ( V_2 ) ;
V_2 -> V_41 |= V_531 ;
}
F_176 () ;
V_2 -> V_41 &= ~ V_535 ;
if ( ! V_2 -> V_184 -> V_551 ( V_2 ) ) {
F_259 ( V_2 , V_552 , 0 ) ;
V_2 -> V_548 = 0 ;
return;
}
...
L_89 , V_544 , V_2 -> V_548 ) ;
F_25 ( V_2 -> V_22 ) ;
F_265 ( V_2 , 0 ) ;
}
static void
F_330 ( struct V_543 * V_66 )
{
struct V_1 * V_2 = F_327 ( V_66 ,
struct V_1 , V_65 . V_66 ) ;
struct V_21 * V_22 = V_2 -> V_22 ;
...
F_189 ( V_2 , V_22 ) ;
V_515 = F_97 ( V_2 , V_553 ) ;
if ( V_515 & V_554 ) {
F_83 ( & V_2 -> V_5 -> V_30 ,
L_90 ,
V_515 ) ;
if ( F_331 ( V_515 ) == V_555 ) {
F_83 ( & V_2 -> V_5 -> V_30 ,
L_91
L_92 ) ;
F_83 ( & V_2 -> V_5 -> V_30 ,
...
if ( V_2 -> V_4 -> V_248 == V_479 ) {
F_83 ( & V_2 -> V_5 -> V_30 , L_94 ,
V_2 -> V_4 -> V_248 ) ;
goto V_545;
}
if ( ! ( V_2 -> V_41 & V_535 ) ) {
if ( F_315 ( V_2 , V_2 -> V_544 ) ) {
F_83 ( & V_2 -> V_5 -> V_30 ,
L_95
L_96 ) ;
goto V_545;
...
T_1 V_557 )
{
T_1 V_46 , V_558 = 0 , V_559 = 0 ;
F_334 ( V_558 ) ;
F_335 ( V_558 ) ;
F_152 ( V_2 , V_560 , V_558 ) ;
F_336 ( V_559 ) ;
F_337 ( V_559 ) ;
F_338 ( V_559 ) ;
F_339 ( V_559 ) ;
F_152 ( V_2 , V_561 , V_559 ) ;
...
F_99 ( V_2 , V_293 ,
V_294 ) ;
F_325 ( V_2 , V_550 , L_100 ) ;
F_100 ( V_2 ) ;
}
void F_259 ( struct V_1 * V_2 ,
T_11 V_67 , int V_562 )
{
if ( F_21 ( V_563 , & V_2 -> V_46 ) )
return;
F_340 ( & V_2 -> V_65 , V_67 ) ;
F_341 ( V_2 -> V_425 , & V_2 -> V_65 ,
F_342 ( V_562 ) ) ;
}
static void
V_552 ( struct V_543 * V_66 )
{
struct V_1 * V_2 = F_327 ( V_66 ,
struct V_1 , V_65 . V_66 ) ;
struct V_21 * V_22 = V_2 -> V_22 ;
...
F_344 ( V_2 , 0 ) ;
if ( V_569 )
F_126 ( V_571 , & V_2 -> V_46 ) ;
F_83 ( & V_2 -> V_5 -> V_30 , L_102 ) ;
V_566 = F_97 ( V_2 , V_553 ) ;
...
L_109 ) ;
V_567:
V_2 -> V_544 = ( V_46 == V_525 ) ? V_46 :
V_524 ;
if ( V_569 && ! F_45 ( V_64 ,
& V_2 -> V_46 ) ) {
F_259 ( V_2 , F_330 , 0 ) ;
F_325 ( V_2 , V_550 , L_110 ) ;
} else if ( ! V_569 && V_217 -> V_578 &&
V_2 -> V_41 & V_535 ) {
F_329 ( V_2 ) ;
}
return 1 ;
}
void V_448 ( struct V_543 * V_66 )
{
struct V_1 * V_2 = F_327 ( V_66 ,
struct V_1 , V_65 . V_66 ) ;
if ( F_21 ( V_64 , & V_2 -> V_46 ) )
...
while ( V_522 -- > 0 ) {
V_580 = F_347 ( F_348
( V_5 -> V_582 ) , V_5 -> V_582 -> V_583 ,
F_349 ( F_350 ( V_5 -> V_581 ) , V_522 ) ) ;
if ( ! V_580 )
continue;
if ( V_580 -> V_584 != V_585 ) {
F_351 ( V_580 ) ;
return 0 ;
}
F_351 ( V_580 ) ;
...
{
struct V_1 * V_2 = F_271 ( V_5 ) ;
struct V_594 * V_418 = V_2 -> V_4 -> V_418 ;
if ( V_418 -> V_595 ) {
return V_418 -> V_595 ( V_5 , V_46 ) ;
} else {
F_83 ( & V_5 -> V_30 , L_111 ) ;
return V_590 ;
}
...
struct V_21 * V_30 , unsigned long V_603 )
{
struct V_604 * V_605 ;
V_605 = F_369 ( V_30 ) ;
if ( ! V_605 )
...
void F_125 ( struct V_21 * V_22 , unsigned long V_603 )
{
struct V_1 * V_2 = F_19 ( V_22 ) ;
struct V_21 * V_30 ;
T_3 V_51 ;
F_368 ( V_2 , V_22 , V_603 ) ;
F_374 () ;
F_375 (vid, adapter->vlans, VLAN_N_VID) {
V_30 = F_376 ( V_22 , F_377 ( V_610 ) , V_51 ) ;
if ( ! V_30 )
continue;
F_368 ( V_2 , V_30 , V_603 ) ;
}
F_378 () ;
}
static int F_379 ( struct V_611 * V_612 ,
unsigned long V_603 , void * V_613 )
{
struct V_1 * V_2 ;
struct V_21 * V_30 = F_380 ( V_613 ) ;
V_614:
if ( V_30 == NULL )
goto V_518;
if ( V_30 -> V_399 & V_615 ) {
...
static int
F_383 ( struct V_611 * V_612 ,
unsigned long V_603 , void * V_613 )
{
struct V_1 * V_2 ;
struct V_21 * V_30 ;
struct V_617 * V_606 = (struct V_617 * ) V_613 ;
V_30 = V_606 -> V_618 ? V_606 -> V_618 -> V_30 : NULL ;
V_614:
if ( V_30 == NULL )
goto V_518;
if ( V_30 -> V_399 & V_615 ) {
...
switch ( V_603 ) {
case V_364 :
F_371 ( V_2 , V_606 -> V_607 , V_608 ) ;
break;
case V_268 :
F_371 ( V_2 , V_606 -> V_607 , V_609 ) ;
break;
default:
break;
}
...
void F_125 ( struct V_21 * V_30 , unsigned long V_603 )
{ }
static int T_15 F_384 ( void )
{
int V_26 ;
F_385 ( V_485 L_120 , V_619 ) ;
#ifdef F_386
F_387 ( & V_620 ) ;
F_388 ( & V_621 ) ;
#endif
