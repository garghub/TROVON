...
static void F_25 ( struct V_39 * V_4 )
{
...
bool V_56 )
{
T_1 V_1 = 0 , V_57 = 0 , V_58 = 0x8000 ;
struct V_7 * V_44 ;
unsigned int V_35 ;
struct V_20 * V_21 ;
struct V_59 V_60 ;
int V_61 ;
V_61 = F_37 ( & V_60 , V_62 , V_63 ) ;
if ( V_61 < 0 )
return V_61 ;
V_61 = F_38 ( V_50 , V_14 , V_53 , V_54 , & V_60 , V_56 ) ;
if ( V_61 < 0 )
goto V_64;
V_61 = - V_47 ;
if ( V_53 [ V_65 ] ) {
...
unsigned int V_36 = F_19 ( V_58 >> 16 ) ;
V_61 = - V_68 ;
...
struct V_13 * V_14 , unsigned long V_51 , T_1 V_32 ,
struct V_52 * * V_71 , unsigned long * V_43 , bool V_56 )
{
struct V_3 * V_4 = F_21 ( V_14 -> V_17 ) ;
struct V_7 T_2 * * V_44 ;
...
V_61 = F_36 ( V_50 , V_14 , V_51 , V_8 , V_32 , V_4 , V_53 ,
V_71 [ V_80 ] , V_55 , V_56 ) ;
if ( V_61 < 0 )
goto V_64;
