...
static int F_53 ( struct V_99 * V_94 , struct V_99 * V_100 ,
void * V_101 )
{
struct V_102 * V_103 = F_54 ( V_94 ) ;
struct V_104 * V_105 = V_101 ;
struct V_34 * V_35 = V_105 -> V_106 ;
struct V_1 * V_33 ;
struct V_107 * V_108 ;
void T_1 * V_38 ;
int V_109 ;
V_33 = F_55 ( V_94 , sizeof( * V_33 ) , V_110 ) ;
if ( ! V_33 )
return - V_111 ;
V_33 -> V_35 = V_35 ;
F_56 ( V_94 , V_33 ) ;
V_108 = F_57 ( V_103 , V_112 , 0 ) ;
V_38 = F_58 ( V_94 , V_108 ) ;
if ( F_59 ( V_38 ) ) {
F_60 ( V_94 , L_7 ) ;
return F_61 ( V_38 ) ;
}
V_33 -> V_38 = F_62 ( V_94 , V_38 ,
& V_113 ) ;
if ( F_59 ( V_33 -> V_38 ) ) {
F_60 ( V_94 , L_8 ) ;
return F_61 ( V_33 -> V_38 ) ;
}
V_33 -> V_114 = F_63 ( V_94 , NULL ) ;
if ( F_59 ( V_33 -> V_114 ) ) {
F_60 ( V_94 , L_9 ) ;
...
V_33 -> V_3 . V_121 = F_21 ( 0 ) ;
F_69 ( & V_33 -> V_5 ,
& V_122 ) ;
V_109 = F_70 ( V_105 , & V_33 -> V_5 ,
& V_123 ,
V_124 ) ;
if ( V_109 ) {
F_60 ( V_94 ,
...
static void F_74 ( struct V_99 * V_94 , struct V_99 * V_100 ,
void * V_101 )
{
struct V_1 * V_33 = F_75 ( V_94 ) ;
F_52 ( & V_33 -> V_5 ) ;
F_44 ( & V_33 -> V_3 ) ;
F_72 ( V_33 -> V_115 ) ;
}
...
{
return F_77 ( & V_103 -> V_94 , & V_127 ) ;
}
static int F_78 ( struct V_102 * V_103 )
{
F_79 ( & V_103 -> V_94 , & V_127 ) ;
return 0 ;
}
