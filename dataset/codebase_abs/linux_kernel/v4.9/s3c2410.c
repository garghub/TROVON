...
F_81 ( V_107 , V_12 ) ;
F_82 ( & V_12 -> V_123 ) ;
V_12 -> V_21 = F_83 ( & V_107 -> V_14 , L_19 ) ;
if ( F_70 ( V_12 -> V_21 ) ) {
...
V_12 -> V_27 = V_26 ;
V_12 -> V_29 = V_29 ;
V_12 -> V_46 = F_85 ( & V_107 -> V_14 , V_152 ) ;
if ( F_70 ( V_12 -> V_46 ) ) {
V_153 = F_86 ( V_12 -> V_46 ) ;
goto V_159;
}
...
static int F_89 ( struct V_13 * V_14 , T_3 V_163 )
{
struct V_11 * V_12 = F_8 ( V_14 ) ;
if ( V_12 ) {
V_12 -> V_164 = F_33 ( V_12 -> V_55 ) ;
F_34 ( V_12 -> V_164 | V_12 -> V_56 , V_12 -> V_55 ) ;
F_13 ( V_12 , V_112 ) ;
}
return 0 ;
}
...
F_13 ( V_12 , V_20 ) ;
F_37 ( V_12 ) ;
V_165 = F_33 ( V_12 -> V_55 ) ;
V_165 &= ~ V_12 -> V_56 ;
V_165 |= V_12 -> V_164 & V_12 -> V_56 ;
F_34 ( V_165 , V_12 -> V_55 ) ;
F_13 ( V_12 , V_18 ) ;
}
return 0 ;
}
