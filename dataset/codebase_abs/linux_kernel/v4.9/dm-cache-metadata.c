...
static bool F_91 ( struct V_23 * V_24 )
{
F_92 ( & V_24 -> V_99 ) ;
if ( V_24 -> V_100 || F_93 ( V_24 -> V_26 ) ) {
F_94 ( & V_24 -> V_99 ) ;
return false ;
}
return true ;
...
int F_98 ( struct V_23 * V_24 , T_8 V_110 )
{
int V_31 ;
bool V_111 ;
T_3 V_112 = F_66 ( 0 , 0 ) ;
...
V_31 = F_102 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_24 -> V_66 ) ,
F_65 ( V_110 ) ,
& V_112 , & V_24 -> V_58 ) ;
if ( ! V_31 )
V_24 -> V_66 = V_110 ;
...
int F_104 ( struct V_23 * V_24 ,
T_4 V_61 ,
T_9 V_114 )
{
int V_31 ;
F_99 ( V_24 ) ;
V_31 = F_105 ( & V_24 -> V_72 ,
V_24 -> V_60 ,
F_30 ( V_24 -> V_62 ) ,
F_30 ( V_114 ) ,
false , & V_24 -> V_60 ) ;
...
static int F_106 ( struct V_23 * V_24 , T_9 V_4 )
{
return F_107 ( & V_24 -> V_72 , V_24 -> V_60 ,
F_30 ( V_4 ) , & V_24 -> V_60 ) ;
}
static int F_108 ( struct V_23 * V_24 , T_9 V_4 )
{
return F_109 ( & V_24 -> V_72 , V_24 -> V_60 ,
F_30 ( V_4 ) , & V_24 -> V_60 ) ;
}
static int F_110 ( struct V_23 * V_24 , T_9 V_4 ,
bool * V_115 )
{
return F_111 ( & V_24 -> V_72 , V_24 -> V_60 ,
F_30 ( V_4 ) , & V_24 -> V_60 ,
V_115 ) ;
}
...
{
int V_31 ;
V_31 = ( V_117 ? F_106 : F_108 ) ( V_24 , V_116 ) ;
if ( V_31 )
return V_31 ;
V_24 -> V_90 = true ;
return 0 ;
...
int F_115 ( struct V_23 * V_24 ,
T_10 V_118 , void * V_37 )
{
int V_31 ;
F_116 ( V_24 ) ;
V_31 = F_114 ( V_24 , V_118 , V_37 ) ;
F_117 ( V_24 ) ;
return V_31 ;
}
int F_118 ( struct V_23 * V_24 , T_8 * V_30 )
{
F_116 ( V_24 ) ;
* V_30 = V_24 -> V_66 ;
F_117 ( V_24 ) ;
...
static int F_119 ( struct V_23 * V_24 , T_8 V_119 )
{
int V_31 ;
T_3 V_92 = F_66 ( 0 , 0 ) ;
F_100 ( & V_92 ) ;
V_31 = F_120 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_119 ) ,
& V_92 , & V_24 -> V_58 ) ;
if ( V_31 )
return V_31 ;
V_24 -> V_90 = true ;
...
int F_121 ( struct V_23 * V_24 , T_8 V_119 )
{
int V_31 ;
F_99 ( V_24 ) ;
V_31 = F_119 ( V_24 , V_119 ) ;
F_103 ( V_24 ) ;
return V_31 ;
}
...
int F_123 ( struct V_23 * V_24 ,
T_8 V_119 , T_6 V_120 )
{
int V_31 ;
F_99 ( V_24 ) ;
V_31 = F_122 ( V_24 , V_119 , V_120 ) ;
F_103 ( V_24 ) ;
return V_31 ;
}
static bool F_124 ( struct V_23 * V_24 ,
struct V_121 * V_122 )
{
const char * V_55 = F_125 ( V_122 ) ;
const unsigned * V_56 = F_126 ( V_122 ) ;
T_1 V_44 = F_127 ( V_122 ) ;
...
static bool F_128 ( struct V_23 * V_24 )
{
return V_24 -> V_59 && V_24 -> V_44 ;
}
static bool F_129 ( struct V_23 * V_24 ,
struct V_121 * V_122 )
{
return V_24 -> V_73 && F_124 ( V_24 , V_122 ) &&
F_128 ( V_24 ) ;
}
static int F_130 ( struct V_23 * V_24 ,
T_7 V_123 , bool V_124 ,
struct V_125 * V_126 ,
struct V_125 * V_127 ,
...
T_6 V_120 ;
unsigned V_10 ;
F_131 ( V_126 , ( void * * ) & V_130 ) ;
memcpy ( & V_128 , V_130 , sizeof( V_128 ) ) ;
F_68 ( V_128 , & V_120 , & V_10 ) ;
if ( V_10 & V_106 ) {
if ( V_124 ) {
F_131 ( V_127 , ( void * * ) & V_131 ) ;
memcpy ( & V_129 , V_131 , sizeof( V_129 ) ) ;
}
V_31 = V_118 ( V_37 , V_120 , F_58 ( V_123 ) , V_10 & V_107 ,
F_8 ( V_129 ) , V_124 ) ;
if ( V_31 )
F_9 ( L_17 ) ;
}
...
int V_31 ;
T_7 V_123 ;
bool V_124 = F_129 ( V_24 , V_122 ) ;
if ( F_65 ( V_24 -> V_66 ) == 0 )
return 0 ;
V_31 = F_133 ( & V_24 -> V_42 , V_24 -> V_58 , & V_24 -> V_126 ) ;
if ( V_31 )
return V_31 ;
if ( V_124 ) {
V_31 = F_133 ( & V_24 -> V_45 , V_24 -> V_59 , & V_24 -> V_127 ) ;
if ( V_31 ) {
F_134 ( & V_24 -> V_126 ) ;
return V_31 ;
}
...
for ( V_123 = 0 ; ; V_123 ++ ) {
V_31 = F_130 ( V_24 , V_123 , V_124 ,
& V_24 -> V_126 , & V_24 -> V_127 ,
V_118 , V_37 ) ;
if ( V_31 )
goto V_113;
if ( V_123 >= ( F_65 ( V_24 -> V_66 ) - 1 ) )
break;
V_31 = F_135 ( & V_24 -> V_126 ) ;
if ( V_31 ) {
F_9 ( L_18 ) ;
goto V_113;
}
if ( V_124 ) {
V_31 = F_135 ( & V_24 -> V_127 ) ;
if ( V_31 ) {
F_9 ( L_19 ) ;
goto V_113;
}
...
int V_31 ;
F_116 ( V_24 ) ;
V_31 = F_132 ( V_24 , V_122 , V_118 , V_37 ) ;
F_117 ( V_24 ) ;
return V_31 ;
}
static int F_137 ( void * V_37 , T_7 V_119 , void * V_132 )
{
int V_31 = 0 ;
T_3 V_92 ;
T_6 V_120 ;
unsigned V_10 ;
memcpy ( & V_92 , V_132 , sizeof( V_92 ) ) ;
F_68 ( V_92 , & V_120 , & V_10 ) ;
return V_31 ;
}
static int F_138 ( struct V_23 * V_24 )
{
return F_139 ( & V_24 -> V_42 , V_24 -> V_58 , F_137 , NULL ) ;
}
void F_140 ( struct V_23 * V_24 )
{
F_141 ( V_24 ) ;
F_138 ( V_24 ) ;
F_117 ( V_24 ) ;
}
int F_142 ( struct V_23 * V_24 )
{
int V_31 ;
F_116 ( V_24 ) ;
V_31 = V_24 -> V_90 ;
...
static int F_143 ( struct V_23 * V_24 , T_8 V_119 , bool V_133 )
{
int V_31 ;
unsigned V_10 ;
T_6 V_120 ;
...
return V_31 ;
F_68 ( V_92 , & V_120 , & V_10 ) ;
if ( ( ( V_10 & V_107 ) && V_133 ) || ( ! ( V_10 & V_107 ) && ! V_133 ) )
return 0 ;
V_92 = F_66 ( V_120 , ( V_10 & ~ V_107 ) | ( V_133 ? V_107 : 0 ) ) ;
F_100 ( & V_92 ) ;
V_31 = F_120 ( & V_24 -> V_42 , V_24 -> V_58 , F_65 ( V_119 ) ,
& V_92 , & V_24 -> V_58 ) ;
if ( V_31 )
...
int F_144 ( struct V_23 * V_24 ,
T_8 V_119 , bool V_133 )
{
int V_31 ;
F_99 ( V_24 ) ;
V_31 = F_143 ( V_24 , V_119 , V_133 ) ;
F_103 ( V_24 ) ;
return V_31 ;
}
...
int F_148 ( struct V_23 * V_24 , bool V_135 )
{
int V_31 ;
T_5 V_88 = ( V_135 ? F_52 :
F_54 ) ;
...
int V_31 = - V_17 ;
F_116 ( V_24 ) ;
V_31 = F_152 ( V_24 -> V_47 , V_30 ) ;
F_117 ( V_24 ) ;
return V_31 ;
}
static int F_153 ( T_2 V_136 , void * V_94 , void * V_37 )
{
T_2 V_92 ;
struct V_121 * V_122 = V_37 ;
V_92 = F_154 ( V_122 , F_58 ( V_136 ) ) ;
* ( ( V_11 * ) V_94 ) = F_5 ( V_92 ) ;
return 0 ;
}
static int F_155 ( struct V_23 * V_24 , struct V_121 * V_122 )
{
int V_31 ;
T_1 V_137 ;
const char * V_55 = F_125 ( V_122 ) ;
...
V_24 -> V_44 = V_137 ;
if ( V_24 -> V_59 ) {
V_31 = F_156 ( & V_24 -> V_45 , V_24 -> V_59 ) ;
if ( V_31 )
return V_31 ;
}
return F_157 ( & V_24 -> V_45 , & V_24 -> V_59 ,
F_65 ( V_24 -> V_66 ) ,
F_153 , V_122 ) ;
}
int F_158 ( struct V_23 * V_24 , struct V_121 * V_122 )
{
int V_31 ;
F_99 ( V_24 ) ;
V_31 = F_155 ( V_24 , V_122 ) ;
F_103 ( V_24 ) ;
return V_31 ;
}
int F_159 ( struct V_23 * V_24 , bool * V_30 )
{
int V_31 ;
F_116 ( V_24 ) ;
V_31 = F_90 ( V_24 , 0 , V_24 -> V_66 , V_30 ) ;
F_117 ( V_24 ) ;
return V_31 ;
}
...
int F_164 ( struct V_23 * V_24 )
{
int V_31 ;
struct V_3 * V_25 ;
struct V_6 * V_7 ;
F_99 ( V_24 ) ;
F_53 ( V_138 , & V_24 -> V_10 ) ;
V_31 = F_16 ( V_24 , & V_25 ) ;
if ( V_31 ) {
F_9 ( L_20 ) ;
goto V_113;
...
int F_165 ( struct V_23 * V_24 , bool * V_30 )
{
F_116 ( V_24 ) ;
* V_30 = ! ! F_43 ( V_138 , & V_24 -> V_10 ) ;
F_117 ( V_24 ) ;
return 0 ;
}
