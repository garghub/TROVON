...
static T_1 F_21 ( struct V_44 * V_44 ,
const char T_3 * V_13 ,
T_2 V_14 , T_4 * V_45 )
{
struct V_6 * V_7 = ( (struct V_37 * ) V_44 -> V_46 ) -> V_40 ;
struct V_19 * V_10 = & V_7 -> V_9 . V_10 ;
long V_34 , V_15 ;
char V_47 [ 128 ] ;
int V_30 ;
...
if ( V_14 >= sizeof( V_47 ) )
return - V_48 ;
if ( F_22 ( V_47 , V_13 , V_14 ) )
return - V_49 ;
V_47 [ V_14 ] = 0 ;
V_30 = 1 << ( 20 - V_32 ) ;
V_13 += F_23 ( V_47 , L_6 , & V_14 ) -
V_47 ;
...
int V_54 ;
F_11 ( & V_10 -> V_29 ) ;
V_54 = sprintf ( V_5 , L_7 , V_10 -> V_55 << V_32 ) ;
F_13 ( & V_10 -> V_29 ) ;
return V_54 ;
}
...
{
struct V_6 * V_57 = V_38 -> V_40 ;
int V_63 ;
V_64 ;
if ( ! V_57 )
return 0 ;
for ( V_63 = 0 ; V_63 < F_40 ( V_65 ) ; V_63 ++ ) {
if ( ( ( 1 << V_63 ) & V_57 -> V_9 . V_10 . V_66 ) == 0 )
continue;
if ( V_57 -> V_9 . V_10 . V_67 == ( 1 << V_63 ) )
F_19 ( V_38 , L_8 , V_65 [ V_63 ] ) ;
else
F_19 ( V_38 , L_9 , V_65 [ V_63 ] ) ;
}
F_41 ( V_38 , '\n' ) ;
return 0 ;
}
static T_1 F_42 ( struct V_44 * V_44 ,
const char T_3 * V_13 ,
T_2 V_14 , T_4 * V_45 )
{
struct V_6 * V_57 = ( (struct V_37 * ) V_44 -> V_46 ) -> V_40 ;
int V_63 ;
V_64 ;
char V_47 [ 10 ] ;
if ( ! V_57 )
return 0 ;
if ( V_14 > sizeof( V_47 ) - 1 )
return - V_48 ;
if ( F_22 ( V_47 , V_13 , V_14 ) )
return - V_49 ;
if ( V_14 > 0 && V_47 [ V_14 - 1 ] == '\n' )
V_47 [ V_14 - 1 ] = '\0' ;
else
V_47 [ V_14 ] = '\0' ;
for ( V_63 = 0 ; V_63 < F_40 ( V_65 ) ; V_63 ++ ) {
...
if ( V_16 >= V_79 )
V_16 >>= V_32 ;
V_78 = ~ ( ( 1 << ( V_10 -> V_80 - V_32 ) ) - 1 ) ;
V_16 = ( V_16 + ~ V_78 ) & V_78 ;
if ( V_16 == 0 || V_16 > V_76 -> V_81 >> V_32 ) {
return - V_17 ;
}
F_11 ( & V_10 -> V_29 ) ;
V_10 -> V_74 = V_16 ;
...
static int F_57 ( struct V_37 * V_85 , void * V_39 )
{
struct V_86 V_87 ;
struct V_6 * V_7 = V_85 -> V_40 ;
struct V_19 * V_10 = & V_7 -> V_9 . V_10 ;
...
V_91 += V_104 ;
F_19 ( V_85 , L_20 ,
1 << V_63 , V_102 , F_61 ( V_102 , V_88 ) ,
F_61 ( V_90 , V_88 ) , V_104 ,
F_61 ( V_104 , V_89 ) ,
F_61 ( V_91 , V_89 ) ) ;
...
F_19 ( V_85 , L_20 ,
( V_63 == 0 ) ? 0 : 1 << ( V_63 - 1 ) ,
V_102 , F_61 ( V_102 , V_88 ) , F_61 ( V_90 , V_88 ) ,
V_104 , F_61 ( V_104 , V_89 ) , F_61 ( V_91 , V_89 ) ) ;
if ( V_90 == V_88 && V_91 == V_89 )
break;
}
F_13 ( & V_10 -> V_29 ) ;
...
static T_1 F_62 ( struct V_44 * V_44 ,
const char T_3 * V_5 ,
T_2 V_54 , T_4 * V_45 )
{
struct V_37 * V_85 = V_44 -> V_46 ;
struct V_6 * V_7 = V_85 -> V_40 ;
struct V_19 * V_10 = & V_7 -> V_9 . V_10 ;
F_63 ( & V_10 -> V_105 ) ;
F_63 ( & V_10 -> V_106 ) ;
...
static int F_64 ( struct V_37 * V_85 , void * V_39 )
{
struct V_86 V_87 ;
struct V_6 * V_7 = V_85 -> V_40 ;
struct V_109 * V_110 = & F_47 ( V_7 ) -> V_111 ;
F_58 ( & V_87 ) ;
F_19 ( V_85 , L_12 ,
( V_92 ) V_87 . V_93 , ( unsigned long ) V_87 . V_94 ) ;
F_19 ( V_85 , L_23 ,
...
static T_1 F_65 ( struct V_44 * V_44 ,
const char T_3 * V_5 ,
T_2 V_54 , T_4 * V_45 )
{
struct V_37 * V_85 = V_44 -> V_46 ;
...
{
int V_15 ;
V_15 = F_67 ( V_7 -> V_115 , L_26 , 0644 ,
& V_116 , V_7 ) ;
if ( V_15 == 0 )
V_15 = F_68 ( V_7 , L_27 , 0644 ,
& V_117 , V_7 ) ;
return V_15 ;
}
void F_69 ( struct V_118 * V_119 )
{
V_119 -> V_120 = & V_121 ;
V_119 -> V_122 = V_123 ;
}
