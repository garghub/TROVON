...
static void F_147 ( struct V_23 * V_29 , T_1 V_294 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
V_2 -> V_293 = V_294 ;
}
...
static void
F_149 ( struct V_23 * V_29 , struct V_298 * V_299 ,
void * V_15 )
{
struct V_1 * V_2 = F_24 ( V_29 ) ;
struct V_93 * V_94 = V_29 -> V_95 ;
...
static int F_151 ( struct V_1 * V_2 , T_1 V_301 )
{
int V_179 = 100 ;
T_1 V_302 ;
...
int V_33 ;
F_150 ( V_2 ) ;
V_263 = F_156 ( V_311 -> V_263 , V_309 ) ;
for ( V_33 = 0 ; V_33 < V_263 ; V_33 ++ ) {
int V_25 = F_152 ( V_2 , V_33 , V_312 ) ;
if ( V_25 < 0 ) {
V_311 -> V_263 = 0 ;
return V_25 ;
}
...
return - V_134 ;
V_29 -> V_5 |= V_320 ;
F_162 ( V_29 , & V_2 -> V_183 , F_81 , V_321 ) ;
V_29 -> V_322 = & V_323 ;
V_29 -> V_324 = & V_325 ;
return 0 ;
}
...
F_76 ( V_2 -> V_43 ) ;
F_167 ( V_29 ) ;
V_327 = F_168 ( V_22 , V_328 ,
L_106 ) ;
if ( ! V_327 )
V_327 = F_169 ( V_22 , V_328 , 0 ) ;
F_170 ( V_327 -> V_329 , F_171 ( V_327 ) ) ;
F_172 ( V_2 -> V_7 ) ;
( void ) F_30 ( V_22 ) ;
F_39 ( V_22 ) ;
F_173 ( V_29 ) ;
...
static int F_176 ( struct V_330 * V_4 ,
struct V_331 * V_29 )
{
int V_137 ;
T_1 V_332 = 0 ;
...
V_137 = V_333 ;
V_4 -> V_137 = V_137 ;
F_178 ( V_29 , V_4 -> V_334 , V_198 ) ;
V_143 = F_179 ( V_29 , L_107 , & V_332 ) ;
if ( V_143 == - V_144 )
return V_143 ;
if ( ! V_143 && V_332 == 4 )
V_4 -> V_5 |= V_6 ;
...
struct V_23 * V_29 ;
struct V_1 * V_2 ;
struct V_330 * V_4 = F_182 ( & V_22 -> V_29 ) ;
struct V_326 * V_327 ;
int V_338 , V_218 ;
int V_235 ;
V_327 = F_168 ( V_22 , V_328 ,
...
if ( ! F_185 ( V_327 -> V_329 , V_338 , V_289 ) ) {
V_235 = - V_279 ;
goto V_339;
}
V_29 = F_186 ( sizeof( struct V_1 ) ) ;
if ( ! V_29 ) {
V_235 = - V_145 ;
goto V_340;
}
F_187 ( V_29 , & V_22 -> V_29 ) ;
V_2 = F_24 ( V_29 ) ;
V_29 -> V_218 = V_218 ;
V_2 -> V_7 = F_188 ( V_327 -> V_329 , V_338 ) ;
V_2 -> V_29 = V_29 ;
V_2 -> V_293 = ( ( 1 << V_341 ) - 1 ) ;
F_189 ( V_22 , V_29 ) ;
V_235 = F_33 ( V_22 ) ;
...
static int F_195 ( struct V_331 * V_29 )
{
struct V_23 * V_24 = F_196 ( V_29 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
F_14 ( V_2 , V_91 ,
V_347 | V_348 |
V_349 | V_350 ) ;
...
static int F_197 ( struct V_331 * V_29 )
{
struct V_23 * V_24 = F_196 ( V_29 ) ;
struct V_1 * V_2 = F_24 ( V_24 ) ;
unsigned int V_316 = 100 ;
