...
static int F_64 ( struct V_3 * V_3 , void * V_137 )
{
struct V_1 * V_27 = V_137 ;
F_62 ( V_3 , V_27 ) ;
return 0 ;
}
static int F_65 ( struct V_105 * V_23 , struct V_24 * V_27 ,
T_7 V_136 )
{
struct V_4 * V_4 ;
struct V_1 * V_2 ;
...
static int F_74 ( struct V_105 * V_23 , struct V_24 * V_2 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
...
static int F_77 ( struct V_105 * V_23 , int V_39 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
T_3 V_52 = V_4 -> V_36 ;
struct V_3 * V_3 = V_4 -> V_3 ;
...
static int F_78 ( struct V_105 * V_23 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
if ( ! V_23 )
return - V_109 ;
...
static int F_80 ( struct V_105 * V_23 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
...
static void F_81 ( struct V_105 * V_23 )
{
struct V_4 * V_4 = F_46 ( V_23 ) ;
struct V_3 * V_3 = V_4 -> V_3 ;
T_3 V_52 = V_4 -> V_36 ;
...
goto V_144;
case V_160 :
V_152 = F_85 ( V_74 , V_161 ) ;
F_20 ( V_3 , L_46 , V_152 ) ;
V_152 |= V_162 ;
F_86 ( V_74 , V_161 , V_152 ) ;
V_152 = F_85 ( V_74 , V_161 ) ;
V_153 = 100 ;
while ( ! ( V_152 & V_162 ) ) {
V_152 = F_85 ( V_74 , V_161 ) ;
...
default:
F_20 ( V_3 , L_47 ,
F_90 ( V_3 -> V_154 -> V_155 -> V_156 ) ) ;
goto V_144;
}
V_25 = 0 ;
V_151 = F_85 ( V_74 , V_165 ) ;
V_151 |= V_166 ;
F_86 ( V_74 , V_165 , V_151 ) ;
F_20 ( V_3 , L_48 ) ;
F_91 ( 2 ) ;
V_151 = F_85 ( V_74 , V_165 ) ;
V_151 &= ~ V_166 ;
...
static int
F_92 ( struct V_148 * V_149 , int V_167 )
{
V_149 -> V_167 = ! ! V_167 ;
return 0 ;
}
static void F_93 ( struct V_3 * V_3 , int V_168 )
{
T_3 V_151 ;
V_151 = F_85 ( V_3 -> V_74 , V_165 ) ;
if ( V_168 )
V_151 |= V_169 ;
else
V_151 &= ~ V_169 ;
F_20 ( V_3 , L_49 ,
V_168 ? L_50 : L_51 ) ;
F_86 ( V_3 -> V_74 , V_165 , V_151 ) ;
}
static int F_94 ( struct V_148 * V_149 , unsigned V_170 )
{
struct V_3 * V_3 = F_83 ( V_149 ) ;
if ( ! V_3 -> V_154 -> V_171 )
return - V_172 ;
return F_95 ( V_3 -> V_154 , V_170 ) ;
}
static void F_96 ( struct V_173 * V_174 )
{
struct V_3 * V_3 ;
unsigned long V_107 ;
V_3 = F_97 ( V_174 , struct V_3 , V_175 . V_174 ) ;
F_98 ( V_3 -> V_17 ) ;
F_47 ( & V_3 -> V_26 , V_107 ) ;
F_93 ( V_3 , V_3 -> V_176 ) ;
F_54 ( & V_3 -> V_26 , V_107 ) ;
...
static int F_99 ( struct V_148 * V_149 , int V_168 )
{
struct V_3 * V_3 = F_83 ( V_149 ) ;
unsigned long V_107 ;
V_168 = ! ! V_168 ;
...
static struct V_105 * F_100 ( struct V_148 * V_31 ,
struct V_106 * V_56 ,
struct V_177 * V_178 )
{
...
case V_179 :
if ( F_51 ( V_56 ) )
V_23 = F_101 ( V_31 , L_52 ) ;
else
V_23 = F_101 ( V_31 , L_53 ) ;
break;
case V_128 :
if ( F_51 ( V_56 ) )
V_23 = F_101 ( V_31 , L_54 ) ;
else
V_23 = F_101 ( V_31 , L_55 ) ;
break;
default:
break;
}
if ( V_23 && F_102 ( V_31 , V_23 , V_56 , V_178 ) )
return V_23 ;
return NULL ;
}
static void
F_103 ( struct V_3 * V_3 , struct V_4 * V_23 , T_3 V_52 , int V_40 )
{
struct V_82 * V_50 = V_3 -> V_35 + V_52 ;
...
static inline void F_106 ( struct V_3 * V_3 )
{
T_3 V_52 ;
struct V_82 * V_50 ;
unsigned V_192 = 0 ;
F_104 ( & ( V_3 -> V_31 . V_180 ) ) ;
for ( V_52 = 0 , V_50 = V_3 -> V_35 ;
V_52 < V_3 -> V_193 ;
V_52 ++ , V_50 ++ ) {
if ( V_50 -> V_84 ) {
F_103 ( V_3 , & V_50 -> V_75 , V_52 , 0 ) ;
V_192 ++ ;
} else {
if ( V_50 -> V_51 ) {
F_103 ( V_3 , & V_50 -> V_75 ,
...
V_3 -> V_31 . V_202 = 0 ;
#endif
F_110 ( & V_3 -> V_175 , F_96 ) ;
F_106 ( V_3 ) ;
V_3 -> V_204 = 0 ;
F_88 ( V_3 , 0 ) ;
V_25 = F_111 ( V_3 -> V_17 , & V_3 -> V_31 ) ;
if ( V_25 )
goto V_205;
return 0 ;
V_205:
...
static int F_116 ( struct V_148 * V_31 ,
struct V_209 * V_210 )
{
struct V_3 * V_3 = F_83 ( V_31 ) ;
...
static int F_120 ( struct V_148 * V_31 )
{
struct V_3 * V_3 = F_83 ( V_31 ) ;
unsigned long V_107 ;
F_98 ( V_3 -> V_17 ) ;
F_47 ( & V_3 -> V_26 , V_107 ) ;
F_121 ( V_3 ) ;
( void ) F_94 ( & V_3 -> V_31 , 0 ) ;
V_3 -> V_154 -> V_155 -> V_156 = V_215 ;
F_122 ( V_3 ) ;
F_117 ( V_3 -> V_154 -> V_155 , NULL ) ;
V_3 -> V_204 = 0 ;
V_3 -> V_212 = NULL ;
F_88 ( V_3 , 0 ) ;
F_54 ( & V_3 -> V_26 , V_107 ) ;
...
{
void T_2 * V_74 = V_3 -> V_74 ;
T_3 V_152 = F_85 ( V_74 , V_161 ) ;
F_20 ( V_3 , L_62 , V_152 ) ;
F_86 ( V_74 , V_161 , V_152 & V_162 ) ;
( void ) F_94 ( & V_3 -> V_31 , 0 ) ;
V_3 -> V_31 . V_197 = V_198 ;
...
void F_129 ( struct V_3 * V_3 )
__releases( V_3 -> V_26 )
__acquires( V_3 -> V_26 )
{
void T_2 * V_73 = V_3 -> V_74 ;
T_3 V_152 = F_85 ( V_73 , V_161 ) ;
T_3 V_151 ;
F_20 ( V_3 , L_64 ,
( V_152 & V_226 )
? L_65 : L_66 ,
...
F_14 ( & V_3 -> V_26 ) ;
F_130 ( & V_3 -> V_31 , V_3 -> V_212 ) ;
F_17 ( & V_3 -> V_26 ) ;
}
else if ( V_152 & V_227 )
F_86 ( V_73 , V_161 , V_162 ) ;
V_151 = F_85 ( V_73 , V_165 ) ;
