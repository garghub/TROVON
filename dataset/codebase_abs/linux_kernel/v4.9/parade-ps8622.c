...
static enum V_51 F_26 ( struct V_4 * V_5 ,
bool V_52 )
{
return V_53 ;
}
...
{
struct V_63 * V_32 = & V_7 -> V_32 ;
struct V_64 * V_65 , * V_66 ;
struct V_1 * V_22 ;
int V_11 ;
V_22 = F_35 ( V_32 , sizeof( * V_22 ) , V_67 ) ;
if ( ! V_22 )
return - V_68 ;
V_65 = F_36 ( V_32 -> V_69 , NULL ) ;
if ( V_65 ) {
V_66 = F_37 ( V_65 ) ;
if ( V_66 ) {
V_22 -> V_42 = F_38 ( V_66 ) ;
...
V_22 -> V_7 = V_7 ;
V_22 -> V_41 = F_40 ( V_32 , L_10 ) ;
if ( F_41 ( V_22 -> V_41 ) ) {
F_42 ( V_32 , L_11 ) ;
V_22 -> V_41 = NULL ;
}
V_22 -> V_43 = F_43 ( V_32 , L_12 , V_71 ) ;
if ( F_41 ( V_22 -> V_43 ) ) {
V_11 = F_44 ( V_22 -> V_43 ) ;
F_45 ( V_32 , L_13 , V_11 ) ;
return V_11 ;
}
V_22 -> V_40 = F_43 ( V_32 , L_14 , V_71 ) ;
if ( F_41 ( V_22 -> V_40 ) ) {
V_11 = F_44 ( V_22 -> V_40 ) ;
F_45 ( V_32 , L_15 , V_11 ) ;
return V_11 ;
