...
T_2 V_186 , const void * V_111 , int V_210 )
{
static const int V_211 [ V_212 + 1 ] = {
V_213 , V_214 , V_215 , V_216 ,
} ;
struct V_145 * V_154 ;
struct V_158 * V_146 ;
int V_217 = V_218 ;
V_154 = F_108 ( V_26 , V_157 , V_210 + 2 ) ;
if ( ! V_154 )
return - V_219 ;
if ( V_186 <= V_212 )
V_217 = V_211 [ V_186 ] ;
V_146 = F_109 ( V_154 ) ;
V_146 -> V_220 = V_217 ;
memcpy ( V_146 -> V_159 , V_111 , V_210 ) ;
return 0 ;
}
int F_110 ( struct V_25 * V_26 , int V_221 ,
T_2 V_222 , const T_3 V_36 [] )
{
struct V_145 * V_154 ;
struct V_23 * V_223 ;
bool V_28 ;
int V_85 ;
V_154 = F_108 ( V_26 , V_221 , V_222 * 4 ) ;
if ( ! V_154 )
return - V_219 ;
V_223 = F_109 ( V_154 ) ;
V_28 = true ;
for ( V_85 = V_222 - 1 ; V_85 >= 0 ; V_85 -- ) {
V_223 [ V_85 ] = F_45 ( V_36 [ V_85 ] , 0 , 0 , V_28 ) ;
V_28 = false ;
}
return 0 ;
}
int F_79 ( const struct V_145 * V_154 ,
T_3 V_224 , T_2 * V_222 , T_3 V_36 [] )
{
...
V_223 = F_109 ( V_154 ) ;
V_28 = true ;
for ( V_85 = V_225 - 1 ; V_85 >= 0 ; V_85 -- , V_28 = false ) {
struct V_29 V_30 ;
V_30 = F_18 ( V_223 + V_85 ) ;
if ( ( V_30 . V_28 != V_28 ) || V_30 . V_64 || V_30 . V_226 )
return - V_128 ;
switch ( V_30 . V_36 ) {
case V_227 :
return - V_128 ;
...
memcpy ( V_229 , V_146 -> V_159 , V_210 ) ;
* V_160 = V_210 ;
V_76 = 0 ;
V_127:
return V_76 ;
...
{
struct V_230 * V_231 ;
struct V_145 * V_232 [ V_233 + 1 ] ;
int V_3 ;
int V_76 ;
V_76 = F_112 ( V_103 , sizeof( * V_231 ) , V_232 , V_233 , V_234 ) ;
if ( V_76 < 0 )
goto V_127;
V_76 = - V_128 ;
V_231 = F_113 ( V_103 ) ;
...
goto V_127;
if ( V_231 -> V_244 != V_245 )
goto V_127;
if ( V_231 -> V_246 != 0 )
goto V_127;
V_134 -> V_171 = V_110 ;
V_134 -> V_180 = V_231 -> V_247 ;
V_134 -> V_141 = V_88 ;
V_134 -> V_172 = V_103 -> V_248 ;
V_134 -> V_135 . V_104 = F_114 ( V_26 ) . V_104 ;
V_134 -> V_135 . V_103 = V_103 ;
V_134 -> V_135 . V_136 = F_115 ( V_26 -> V_249 ) ;
for ( V_3 = 0 ; V_3 <= V_233 ; V_3 ++ ) {
struct V_145 * V_154 = V_232 [ V_3 ] ;
if ( ! V_154 )
continue;
switch ( V_3 ) {
case V_250 :
...
static int F_119 ( struct V_25 * V_26 , T_3 V_104 , T_3 V_254 , int V_105 ,
T_3 V_36 , struct V_1 * V_4 , int V_12 )
{
struct V_9 * V_10 ;
struct V_102 * V_103 ;
struct V_230 * V_231 ;
V_103 = F_120 ( V_26 , V_104 , V_254 , V_105 , sizeof( * V_231 ) , V_12 ) ;
if ( V_103 == NULL )
return - V_219 ;
V_231 = F_113 ( V_103 ) ;
V_231 -> V_235 = V_236 ;
...
V_231 -> V_239 = 0 ;
V_231 -> V_240 = V_241 ;
V_231 -> V_247 = V_4 -> V_179 ;
V_231 -> V_242 = V_243 ;
V_231 -> V_244 = V_245 ;
V_231 -> V_246 = 0 ;
if ( F_110 ( V_26 , V_251 , 1 , & V_36 ) )
goto V_255;
if ( V_4 -> V_18 == 1 ) {
...
goto V_255;
V_10 = F_58 ( V_15 -> V_82 ) ;
if ( V_10 && F_121 ( V_26 , V_250 , V_10 -> V_256 ) )
goto V_255;
if ( V_15 -> V_52 & V_54 )
V_231 -> V_246 |= V_54 ;
if ( V_15 -> V_52 & V_53 )
...
V_15 -> V_130 ) )
goto V_255;
V_149 -> V_260 = F_124 ( V_26 ) - ( void * ) V_149 ;
} F_27 ( V_4 ) ;
if ( V_259 == V_4 -> V_18 )
V_231 -> V_246 |= V_54 ;
if ( V_258 == V_4 -> V_18 )
...
static int F_128 ( struct V_25 * V_26 , struct V_261 * V_262 )
{
struct V_2 * V_2 = F_115 ( V_26 -> V_249 ) ;
struct V_1 T_1 * * V_7 ;
T_4 V_6 ;
unsigned int V_3 ;
F_57 () ;
...
if ( ! V_4 )
continue;
if ( F_119 ( V_26 , F_114 ( V_262 -> V_26 ) . V_104 ,
V_262 -> V_103 -> V_263 , V_106 ,
V_3 , V_4 , V_264 ) < 0 )
break;
}
V_262 -> args [ 0 ] = V_3 ;
...
V_265 += F_131 ( 4 ) ;
if ( V_15 -> V_87 != V_88 )
V_265 += F_131 ( 2 + V_15 -> V_130 ) ;
if ( V_15 -> V_22 )
V_265 += F_131 ( V_15 -> V_22 * 4 ) ;
} else {
T_4 V_266 = 0 ;
F_26 (rt) {
V_266 += F_131 ( sizeof( struct V_148 ) ) ;
if ( V_15 -> V_87 != V_88 )
V_266 += F_131 ( 2 + V_15 -> V_130 ) ;
if ( V_15 -> V_22 )
...
{
struct V_25 * V_26 ;
T_3 V_254 = V_103 ? V_103 -> V_263 : 0 ;
int V_76 = - V_192 ;
V_26 = F_132 ( F_129 ( V_4 ) , V_96 ) ;
if ( V_26 == NULL )
goto V_127;
V_76 = F_119 ( V_26 , V_104 , V_254 , V_105 , V_36 , V_4 , V_108 ) ;
if ( V_76 < 0 ) {
F_133 ( V_76 == - V_219 ) ;
F_48 ( V_26 ) ;
goto V_127;
}
F_134 ( V_26 , V_2 , V_104 , V_267 , V_103 , V_96 ) ;
return;
V_127:
if ( V_76 < 0 )
F_135 ( V_2 , V_267 , V_76 ) ;
}
static int F_136 ( struct V_2 * V_2 , T_4 V_268 )
{
T_4 V_269 = sizeof( struct V_1 * ) * V_268 ;
T_4 V_270 ;
T_4 V_271 ;
struct V_1 T_1 * * V_222 = NULL , * * V_98 ;
struct V_1 * V_272 = NULL , * V_273 = NULL ;
unsigned V_3 ;
if ( V_269 ) {
V_222 = F_51 ( V_269 , V_96 | V_274 | V_275 ) ;
if ( ! V_222 )
V_222 = F_137 ( V_269 ) ;
if ( ! V_222 )
goto V_276;
...
if ( V_268 > V_277 ) {
struct V_9 * V_278 = V_2 -> V_279 ;
V_272 = F_49 ( 1 , V_278 -> V_129 ) ;
if ( ! V_272 )
goto V_280;
F_75 ( V_272 -> V_17 -> V_82 , V_278 ) ;
V_272 -> V_179 = V_281 ;
V_272 -> V_58 = V_60 ;
V_272 -> V_17 -> V_87 = V_89 ;
V_272 -> V_17 -> V_130 = V_278 -> V_129 ;
memcpy ( F_7 ( V_272 , V_272 -> V_17 ) , V_278 -> V_90 ,
V_278 -> V_129 ) ;
}
if ( V_268 > V_282 ) {
struct V_9 * V_278 = V_2 -> V_279 ;
V_273 = F_49 ( 1 , V_278 -> V_129 ) ;
if ( ! V_273 )
goto V_283;
F_75 ( V_273 -> V_17 -> V_82 , V_278 ) ;
V_273 -> V_179 = V_281 ;
V_273 -> V_58 = V_65 ;
V_273 -> V_17 -> V_87 = V_89 ;
V_273 -> V_17 -> V_130 = V_278 -> V_129 ;
memcpy ( F_7 ( V_273 , V_273 -> V_17 ) , V_278 -> V_90 ,
V_278 -> V_129 ) ;
}
F_138 () ;
V_98 = F_58 ( V_2 -> V_5 . V_7 ) ;
V_270 = V_2 -> V_5 . V_6 ;
for ( V_3 = V_268 ; V_3 < V_270 ; V_3 ++ )
F_56 ( V_2 , V_3 , NULL , NULL ) ;
V_271 = V_269 ;
if ( V_270 < V_268 )
V_271 = V_270 * sizeof( struct V_1 * ) ;
memcpy ( V_222 , V_98 , V_271 ) ;
if ( ( V_270 <= V_282 ) &&
( V_268 > V_282 ) ) {
F_75 ( V_222 [ V_282 ] , V_273 ) ;
V_273 = NULL ;
}
if ( ( V_270 <= V_277 ) &&
( V_268 > V_277 ) ) {
F_75 ( V_222 [ V_277 ] , V_272 ) ;
V_272 = NULL ;
}
V_2 -> V_5 . V_6 = V_268 ;
F_59 ( V_2 -> V_5 . V_7 , V_222 ) ;
F_139 () ;
F_52 ( V_273 ) ;
F_52 ( V_272 ) ;
if ( V_98 ) {
...
static int F_142 ( struct V_185 * V_186 , int V_284 ,
void T_5 * V_285 , T_4 * V_286 , T_6 * V_287 )
{
...
V_288 = F_143 ( & V_289 , V_284 , V_285 , V_286 , V_287 ) ;
if ( V_284 && V_288 == 0 )
V_288 = F_136 ( V_2 , V_6 ) ;
return V_288 ;
}
...
V_2 -> V_5 . V_6 = 0 ;
V_2 -> V_5 . V_7 = NULL ;
V_186 = F_95 ( V_297 , sizeof( V_297 ) , V_96 ) ;
if ( V_186 == NULL )
return - V_137 ;
V_186 [ 0 ] . V_188 = V_2 ;
V_2 -> V_5 . V_298 = F_97 ( V_2 , L_4 , V_186 ) ;
if ( V_2 -> V_5 . V_298 == NULL ) {
F_98 ( V_186 ) ;
return - V_137 ;
}
return 0 ;
...
goto V_301;
F_150 ( & V_302 ) ;
F_151 ( V_303 , V_106 , F_118 , NULL , NULL ) ;
F_151 ( V_303 , V_107 , F_117 , NULL , NULL ) ;
F_151 ( V_303 , V_304 , NULL , F_128 , NULL ) ;
V_76 = 0 ;
V_51:
return V_76 ;
V_301:
