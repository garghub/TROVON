...
{
struct V_3 * V_4 = F_63 ( V_291 -> V_146 ) ;
...
static int F_137 ( struct V_3 * V_4 , unsigned int V_283 )
{
struct V_303 * V_304 ;
struct V_64 * V_65 ;
struct V_1 * V_2 ;
...
static int F_140 ( struct V_290 * V_291 )
{
struct V_3 * V_4 = F_63 ( V_291 -> V_146 ) ;
struct V_169 * V_170 = V_291 -> V_170 ;
struct V_312 * V_10 ;
struct V_1 * V_2 ;
union V_305 V_306 ;
unsigned long V_39 , V_283 = - 1 ;
unsigned int V_313 = V_291 -> V_314 -> V_315 ;
int V_47 = 0 , V_316 , V_317 , V_307 = 0 ;
T_3 V_318 , V_258 ;
V_92 ;
V_291 -> V_319 -> V_320 = 0 ;
if ( V_170 )
...
switch ( V_313 ) {
case V_321 :
V_283 = ( V_291 -> V_314 -> V_322 . V_323 . V_283 [ 0 ] << 16 ) |
( V_291 -> V_314 -> V_322 . V_323 . V_283 [ 1 ] << 8 ) |
V_291 -> V_314 -> V_322 . V_323 . V_283 [ 2 ] ;
case V_324 :
V_318 = V_325 ;
break;
case V_326 :
V_307 = 1 ;
V_283 = ( V_291 -> V_314 -> V_322 . V_327 . V_283 [ 0 ] << 16 ) |
( V_291 -> V_314 -> V_322 . V_327 . V_283 [ 1 ] << 8 ) |
V_291 -> V_314 -> V_322 . V_327 . V_283 [ 2 ] ;
case V_328 :
V_318 = V_329 ;
break;
default:
...
V_316 = F_142 ( V_4 -> V_98 , V_291 -> V_333 . V_334 ,
V_291 -> V_333 . V_335 , V_240 ) ;
if ( ! V_316 ) {
F_143 ( & V_4 -> V_331 ) ;
return - V_214 ;
}
V_317 = F_142 ( V_4 -> V_98 , V_291 -> V_336 . V_334 ,
V_291 -> V_336 . V_335 , V_337 ) ;
if ( ! V_317 ) {
F_144 ( V_4 -> V_98 , V_291 -> V_333 . V_334 ,
V_291 -> V_333 . V_335 , V_240 ) ;
F_143 ( & V_4 -> V_331 ) ;
return - V_214 ;
}
...
V_10 -> V_295 . V_32 = F_89 ( V_340 ) ;
V_10 -> V_295 . V_298 = F_52 ( sizeof( * V_10 ) - sizeof( V_10 -> V_341 ) - sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_342 . V_207 = F_90 ( F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_312 , V_7 ) ) ;
V_10 -> V_342 . V_208 = F_89 ( sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_7 . V_284 = F_89 ( V_291 -> V_333 . V_279 ) ;
V_10 -> V_7 . V_258 = F_89 ( V_291 -> V_336 . V_279 ) ;
V_10 -> V_7 . V_39 = F_89 ( V_318 ) ;
V_10 -> V_7 . V_281 = F_89 ( V_299 ) ;
V_10 -> V_7 . V_8 . V_207 = F_90 ( F_106 ( V_291 -> V_333 . V_334 ) ) ;
V_10 -> V_7 . V_8 . V_208 = F_89 ( F_107 ( V_291 -> V_333 . V_334 ) ) ;
V_10 -> V_7 . V_38 . V_207 = F_90 ( F_106 ( V_291 -> V_336 . V_334 ) ) ;
V_10 -> V_7 . V_38 . V_208 = F_89 ( F_107 ( V_291 -> V_336 . V_334 ) ) ;
...
F_139 ( & V_2 -> V_311 ) ;
if ( V_306 . V_339 . V_295 . V_36 )
V_47 = - V_179 ;
else
V_291 -> V_319 -> V_320 = V_258 ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_44 ( V_2 ) ;
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
V_291 -> V_319 -> V_56 = V_47 ;
V_291 -> V_343 ( V_291 ) ;
V_47 = 0 ;
V_338:
F_144 ( V_4 -> V_98 , V_291 -> V_333 . V_334 ,
V_291 -> V_333 . V_335 , V_240 ) ;
F_144 ( V_4 -> V_98 , V_291 -> V_336 . V_334 ,
V_291 -> V_336 . V_335 , V_337 ) ;
F_143 ( & V_4 -> V_331 ) ;
V_95 ;
return V_47 ;
}
static int F_145 ( struct V_256 * V_257 , int type , char * V_344 )
{
struct V_3 * V_4 = F_63 ( V_257 -> V_89 ) ;
struct V_169 * V_170 = F_124 ( V_143 ( V_257 ) ) ;
struct V_5 * V_294 ;
struct V_1 * V_2 = NULL ;
union V_305 V_306 ;
struct V_51 * V_345 = & V_306 . V_8 . V_38 ;
int V_346 = - V_332 ;
unsigned long V_39 ;
int V_40 = 0 ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
...
V_294 -> V_39 = F_52 ( ( V_235 | V_347 ) ) ;
V_294 -> V_7 . V_27 = type ;
V_2 -> V_223 = & V_306 ;
F_138 ( & V_2 -> V_311 ) ;
V_346 = F_115 ( V_2 , V_4 , V_302 ) ;
}
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
if ( V_346 != 0 ) {
F_146 ( V_238 , V_257 , L_27 ,
V_344 , V_346 ) ;
return - V_179 ;
}
F_146 ( V_348 , V_257 , L_28 , V_344 ) ;
F_139 ( & V_2 -> V_311 ) ;
if ( V_306 . V_8 . V_36 )
V_40 = F_10 ( & V_306 . V_8 ) ;
if ( V_40 ) {
if ( V_345 -> V_39 & V_54 )
V_40 = V_345 -> V_41 . V_42 . V_40 ;
F_146 ( V_238 , V_257 , L_29
L_30 , V_344 ,
F_9 ( F_6 ( V_306 . V_8 . V_36 ) , F_6 ( V_306 . V_8 . error ) ) ,
V_306 . V_8 . V_36 , V_306 . V_8 . error , V_345 -> V_39 , V_40 ,
V_345 -> V_43 ) ;
V_346 = - V_179 ;
} else
F_146 ( V_348 , V_257 , L_31 , V_344 ) ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_44 ( V_2 ) ;
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
return V_346 ;
...
struct V_169 * V_349 ;
if ( V_2 -> V_132 ) {
V_349 = F_124 ( V_143 ( V_2 -> V_132 -> V_231 ) ) ;
if ( V_349 == V_170 )
return 1 ;
}
return 0 ;
...
static int F_154 ( struct V_256 * V_257 , int type )
{
struct V_3 * V_4 = F_63 ( V_257 -> V_89 ) ;
...
if ( ! ( F_2 ( V_4 -> V_152 -> V_153 . V_204 ) & V_355 ) )
type &= ~ V_356 ;
if ( V_4 -> V_72 == V_151 )
V_294 -> V_39 = F_89 ( ( type | V_357 ) ) ;
else
V_294 -> V_39 = F_89 ( ( ( type & V_356 ) | V_357 ) ) ;
V_294 -> V_281 = F_89 ( ( unsigned long ) V_257 -> V_282 ) ;
...
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
if ( V_346 != 0 ) {
F_146 ( V_238 , V_257 , L_25 , V_346 ) ;
return 0 ;
}
F_146 ( V_348 , V_257 , L_34 ) ;
F_139 ( & V_2 -> V_311 ) ;
...
static int F_157 ( struct V_256 * V_257 )
{
struct V_3 * V_4 = F_63 ( V_257 -> V_89 ) ;
struct V_169 * V_170 = F_124 ( V_143 ( V_257 ) ) ;
struct V_5 * V_294 ;
...
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
if ( V_346 != 0 ) {
F_146 ( V_238 , V_257 , L_38 , V_346 ) ;
return - V_179 ;
}
F_146 ( V_348 , V_257 , L_39 ) ;
V_171 = F_153 ( & V_2 -> V_311 , V_171 ) ;
if ( ! V_171 ) {
V_47 = F_154 ( V_257 , 0 ) ;
if ( ! V_47 ) {
V_47 = F_150 ( V_4 , V_257 -> V_282 , F_155 ) ;
if ( V_47 == V_353 )
V_47 = 0 ;
}
if ( V_47 ) {
F_146 ( V_348 , V_257 , L_40 ) ;
F_59 ( V_4 ) ;
V_346 = - V_179 ;
V_47 = F_150 ( V_4 , V_257 -> V_282 , F_155 ) ;
if ( V_47 == V_353 )
...
F_81 ( V_4 ) ;
if ( V_363 != V_364 ) {
V_362 = F_154 ( V_257 , V_365 ) ;
F_157 ( V_257 ) ;
} else
V_362 = F_154 ( V_257 , V_356 ) ;
if ( ! V_362 )
V_47 = F_150 ( V_4 , V_257 , F_149 ) ;
if ( V_363 == V_364 && V_47 != V_352 )
V_47 = V_364 ;
V_95 ;
return V_47 ;
}
...
struct V_256 * V_257 = V_8 -> V_231 ;
struct V_3 * V_4 = F_63 ( V_257 -> V_89 ) ;
int V_362 , V_363 , V_366 = 0 ;
int V_47 = V_352 ;
V_92 ;
V_363 = F_159 ( V_8 ) ;
F_81 ( V_4 ) ;
if ( V_363 != V_364 ) {
V_362 = F_154 ( V_257 , V_367 ) ;
V_366 = F_145 ( V_257 , V_368 , L_43 ) ;
} else
V_362 = F_154 ( V_257 , V_356 ) ;
if ( ! V_362 && ! V_366 )
V_47 = F_150 ( V_4 , V_257 , F_149 ) ;
...
static void F_161 ( struct V_256 * V_257 , void * V_41 )
{
unsigned long * V_47 = V_41 ;
* V_47 |= F_154 ( V_257 , V_356 ) ;
}
static void F_162 ( struct V_256 * V_257 , void * V_41 )
{
unsigned long * V_47 = V_41 ;
* V_47 |= F_154 ( V_257 , V_369 ) ;
}
...
F_81 ( V_4 ) ;
if ( V_363 != V_364 ) {
F_164 ( V_144 , & V_362 , F_162 ) ;
V_366 = F_145 ( V_257 , V_370 , L_44 ) ;
} else
F_164 ( V_144 , & V_362 , F_161 ) ;
if ( ! V_362 && ! V_366 )
...
static const struct V_372 * F_169 ( T_2 V_373 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_8 ( V_374 ) ; V_44 ++ )
if ( V_374 [ V_44 ] . V_373 == V_373 )
return & V_374 [ V_44 ] ;
return & V_375 ;
}
static const char * F_170 ( enum V_376 V_72 )
{
int V_44 ;
for ( V_44 = 0 ; V_44 < F_8 ( V_377 ) ; V_44 ++ )
if ( V_377 [ V_44 ] . V_72 == V_72 )
return V_377 [ V_44 ] . V_344 ;
return L_46 ;
}
static void F_171 ( struct V_378 * V_18 ,
struct V_3 * V_4 )
{
const struct V_372 * V_344 = F_169 ( F_2 ( V_18 -> V_379 ) ) ;
struct V_64 * V_65 ;
F_68 ( V_4 , V_344 -> V_236 , L_47
L_48 , V_344 -> V_344 , F_2 ( V_18 -> V_24 ) ,
F_2 ( V_18 -> V_380 ) , F_2 ( V_18 -> V_174 ) ,
F_170 ( V_18 -> V_381 ) ) ;
switch ( F_2 ( V_18 -> V_379 ) ) {
case V_382 :
switch ( V_18 -> V_381 ) {
case V_383 :
F_21 ( V_4 , V_140 ) ;
...
case V_396 :
F_22 (tgt, &vhost->targets, queue) {
if ( ! V_18 -> V_24 && ! V_18 -> V_380 && ! V_18 -> V_174 )
break;
if ( V_18 -> V_24 && F_90 ( V_65 -> V_24 ) != V_18 -> V_24 )
continue;
if ( V_18 -> V_380 && F_90 ( V_65 -> V_173 . V_175 ) != V_18 -> V_380 )
continue;
if ( V_18 -> V_174 && F_90 ( V_65 -> V_173 . V_174 ) != V_18 -> V_174 )
continue;
if ( V_65 -> V_397 && F_2 ( V_18 -> V_379 ) == V_394 )
V_65 -> V_398 = 1 ;
if ( ! V_65 -> V_397 || F_2 ( V_18 -> V_379 ) == V_396 ) {
F_15 ( V_65 , V_68 ) ;
F_18 ( V_4 ) ;
}
}
...
break;
default:
F_24 ( V_4 -> V_98 , L_49 , V_18 -> V_379 ) ;
break;
} ;
}
static void F_172 ( struct V_403 * V_18 , struct V_3 * V_4 )
{
long V_47 ;
...
static int F_174 ( struct V_256 * V_257 )
{
...
return - V_412 ;
F_40 ( V_146 -> V_122 , V_39 ) ;
V_257 -> V_282 = ( void * ) ( unsigned long ) V_4 -> V_413 ++ ;
F_42 ( V_146 -> V_122 , V_39 ) ;
return 0 ;
}
...
unsigned long V_39 = 0 ;
F_40 ( V_146 -> V_122 , V_39 ) ;
V_144 -> V_282 = ( void * ) ( unsigned long ) V_4 -> V_413 ++ ;
F_42 ( V_146 -> V_122 , V_39 ) ;
return 0 ;
}
static int F_176 ( struct V_256 * V_257 )
{
struct V_145 * V_146 = V_257 -> V_89 ;
unsigned long V_39 = 0 ;
F_40 ( V_146 -> V_122 , V_39 ) ;
...
static int F_177 ( struct V_256 * V_257 , int V_416 )
{
if ( V_416 > V_417 )
V_416 = V_417 ;
return F_178 ( V_257 , V_416 ) ;
}
static T_6 F_179 ( struct V_231 * V_98 ,
struct V_418 * V_419 , char * V_420 )
{
struct V_145 * V_146 = F_180 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
return snprintf ( V_420 , V_101 , L_61 ,
...
struct V_145 * V_146 = F_180 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
return snprintf ( V_420 , V_101 , L_62 , V_4 -> V_152 -> V_153 . V_296 ) ;
}
...
struct V_145 * V_146 = F_180 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
return snprintf ( V_420 , V_101 , L_63 , V_4 -> V_152 -> V_153 . V_204 ) ;
}
...
int V_208 ;
F_40 ( V_146 -> V_122 , V_39 ) ;
V_208 = snprintf ( V_420 , V_101 , L_62 , V_4 -> V_236 ) ;
F_42 ( V_146 -> V_122 , V_39 ) ;
return V_208 ;
}
static T_6 F_187 ( struct V_231 * V_98 ,
struct V_418 * V_419 ,
const char * V_420 , T_7 V_422 )
{
struct V_145 * V_146 = F_180 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
unsigned long V_39 = 0 ;
F_40 ( V_146 -> V_122 , V_39 ) ;
V_4 -> V_236 = F_188 ( V_420 , NULL , 10 ) ;
F_42 ( V_146 -> V_122 , V_39 ) ;
return strlen ( V_420 ) ;
}
static T_6 F_189 ( struct V_423 * V_424 , struct V_425 * V_426 ,
struct V_427 * V_428 ,
char * V_420 , T_8 V_429 , T_7 V_422 )
{
struct V_231 * V_98 = F_73 ( V_426 , struct V_231 , V_426 ) ;
struct V_145 * V_146 = F_180 ( V_98 ) ;
struct V_3 * V_4 = F_63 ( V_146 ) ;
unsigned long V_39 = 0 ;
int V_129 = V_430 ;
char * V_431 = ( char * ) V_4 -> V_14 ;
if ( V_429 > V_129 )
return 0 ;
if ( V_429 + V_422 > V_129 ) {
V_129 -= V_429 ;
V_422 = V_129 ;
}
F_40 ( V_146 -> V_122 , V_39 ) ;
memcpy ( V_420 , & V_431 [ V_429 ] , V_422 ) ;
F_42 ( V_146 -> V_122 , V_39 ) ;
return V_422 ;
}
static struct V_378 * F_190 ( struct V_3 * V_4 )
{
struct V_432 * V_99 = & V_4 -> V_99 ;
struct V_378 * V_18 ;
...
static struct V_403 * F_192 ( struct V_3 * V_4 )
{
...
static T_9 F_193 ( int V_112 , void * V_433 )
{
struct V_3 * V_4 = (struct V_3 * ) V_433 ;
unsigned long V_39 ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_194 ( F_26 ( V_4 -> V_98 ) ) ;
F_195 ( & V_4 -> V_113 ) ;
...
{
int V_44 ;
int V_313 = ( V_39 & 0x0f00 ) >> 8 ;
for ( V_44 = 0 ; V_44 < F_8 ( V_437 ) ; V_44 ++ )
if ( V_437 [ V_44 ] . V_313 == V_313 )
return V_44 ;
return 0 ;
}
...
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_438 * V_38 = & V_2 -> V_33 -> V_439 ;
struct V_440 * V_441 = & V_38 -> V_441 ;
T_3 V_36 = F_6 ( V_38 -> V_295 . V_36 ) ;
int V_127 , V_442 = V_237 ;
V_4 -> V_443 -- ;
F_15 ( V_65 , V_444 ) ;
switch ( V_36 ) {
case V_358 :
F_203 ( V_65 , L_64 ,
V_441 -> type , V_441 -> V_39 , V_441 -> V_445 ) ;
if ( V_441 -> type == V_278 ) {
V_127 = F_201 ( F_6 ( V_441 -> V_39 ) ) ;
if ( V_437 [ V_127 ] . V_117 ) {
if ( F_6 ( V_441 -> V_39 ) & V_446 ) {
V_65 -> V_397 = 0 ;
V_65 -> V_173 . V_447 = 0 ;
if ( F_4 ( V_441 -> V_445 ) & V_448 )
V_65 -> V_173 . V_447 |= V_449 ;
if ( F_4 ( V_441 -> V_445 ) & V_450 )
V_65 -> V_173 . V_447 |= V_451 ;
V_65 -> V_70 = 1 ;
} else
F_15 ( V_65 , V_68 ) ;
} else if ( V_437 [ V_127 ] . V_57 )
F_200 ( V_65 , V_452 ) ;
else
F_15 ( V_65 , V_68 ) ;
} else
...
V_442 += F_200 ( V_65 , V_454 ) ;
else if ( V_65 -> V_398 )
V_442 += F_200 ( V_65 , V_454 ) ;
else if ( F_11 ( F_6 ( V_38 -> V_36 ) , F_6 ( V_38 -> error ) ) )
V_442 += F_200 ( V_65 , V_452 ) ;
else
F_15 ( V_65 , V_68 ) ;
F_204 ( V_65 , V_442 , L_65 ,
...
V_439 -> V_295 . V_296 = F_89 ( 1 ) ;
V_439 -> V_295 . V_32 = F_89 ( V_456 ) ;
V_439 -> V_295 . V_298 = F_52 ( sizeof( * V_439 ) ) ;
V_439 -> V_24 = F_90 ( V_65 -> V_24 ) ;
V_439 -> V_441 . type = V_278 ;
V_439 -> V_441 . V_39 = F_52 ( V_446 ) ;
V_439 -> V_441 . V_445 = F_89 ( V_450 ) ;
V_439 -> V_441 . V_445 |= F_89 ( V_457 ) ;
if ( V_233 )
V_439 -> V_441 . V_445 |= F_89 ( V_458 ) ;
F_15 ( V_65 , V_459 ) ;
...
F_203 ( V_65 , L_67 ) ;
if ( V_65 -> V_173 . V_175 &&
V_65 -> V_173 . V_175 != F_206 ( V_38 -> V_445 . V_175 ) ) {
V_4 -> V_90 = 1 ;
F_203 ( V_65 , L_68 ) ;
break;
}
V_65 -> V_173 . V_174 = F_206 ( V_38 -> V_445 . V_174 ) ;
V_65 -> V_173 . V_175 = F_206 ( V_38 -> V_445 . V_175 ) ;
V_65 -> V_173 . V_283 = V_65 -> V_24 ;
memcpy ( & V_65 -> V_445 , & V_38 -> V_445 ,
sizeof( V_65 -> V_445 ) ) ;
memcpy ( & V_65 -> V_460 , & V_38 -> V_460 ,
sizeof( V_65 -> V_460 ) ) ;
F_199 ( V_65 , V_452 ) ;
break;
case V_137 :
...
static void V_454 ( struct V_64 * V_65 )
{
struct V_303 * V_304 ;
struct V_3 * V_4 = V_65 -> V_4 ;
struct V_1 * V_2 ;
...
struct V_64 * V_65 = V_2 -> V_65 ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_461 * V_38 = & V_2 -> V_33 -> V_462 ;
T_3 V_36 = F_6 ( V_38 -> V_295 . V_36 ) ;
V_4 -> V_443 -- ;
F_44 ( V_2 ) ;
F_15 ( V_65 , V_444 ) ;
...
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_295 . V_296 = F_89 ( 1 ) ;
V_10 -> V_295 . V_32 = F_89 ( V_464 ) ;
V_10 -> V_295 . V_298 = F_52 ( sizeof( * V_10 ) ) ;
V_10 -> V_465 = F_90 ( V_65 -> V_24 ) ;
F_15 ( V_65 , V_459 ) ;
if ( F_115 ( V_2 , V_4 , V_302 ) ) {
V_4 -> V_443 -- ;
F_15 ( V_65 , V_444 ) ;
...
static int F_210 ( struct V_312 * V_10 ,
struct V_64 * V_65 )
{
if ( memcmp ( & V_10 -> V_341 . V_466 [ 2 ] , & V_65 -> V_173 . V_175 ,
sizeof( V_65 -> V_173 . V_175 ) ) )
return 1 ;
if ( memcmp ( & V_10 -> V_341 . V_466 [ 4 ] , & V_65 -> V_173 . V_174 ,
sizeof( V_65 -> V_173 . V_174 ) ) )
return 1 ;
if ( F_4 ( V_10 -> V_341 . V_466 [ 6 ] ) != V_65 -> V_24 )
return 1 ;
return 0 ;
}
...
struct V_64 * V_65 = V_2 -> V_65 ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_312 * V_10 = & V_2 -> V_33 -> V_339 ;
...
default:
F_15 ( V_65 , V_68 ) ;
V_467 = ( F_4 ( V_10 -> V_341 . V_466 [ 1 ] ) & 0x00ff0000 ) >> 16 ;
V_59 = ( F_4 ( V_10 -> V_341 . V_466 [ 1 ] ) & 0x0000ff00 ) >> 8 ;
F_212 ( V_65 , L_75 ,
...
{
struct V_312 * V_10 = & V_2 -> V_7 . V_339 ;
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_295 . V_296 = F_89 ( 1 ) ;
V_10 -> V_295 . V_32 = F_89 ( V_340 ) ;
V_10 -> V_295 . V_298 = F_52 ( sizeof( * V_10 ) - sizeof( V_10 -> V_341 ) - sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_342 . V_207 = F_90 ( ( T_2 ) F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_312 , V_7 ) ) ;
V_10 -> V_342 . V_208 = F_89 ( sizeof( V_10 -> V_7 ) ) ;
V_10 -> V_7 . V_284 = F_89 ( sizeof( V_10 -> V_341 . V_468 ) ) ;
V_10 -> V_7 . V_258 = F_89 ( sizeof( V_10 -> V_341 . V_466 ) ) ;
V_10 -> V_7 . V_8 . V_207 = F_90 ( ( T_2 ) F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_312 , V_341 ) +
F_131 ( struct V_469 , V_468 ) ) ;
V_10 -> V_7 . V_8 . V_208 = F_89 ( sizeof( V_10 -> V_341 . V_468 ) ) ;
V_10 -> V_7 . V_38 . V_207 = F_90 ( ( T_2 ) F_2 ( V_2 -> V_18 . V_218 ) +
F_131 ( struct V_312 , V_341 ) +
F_131 ( struct V_469 , V_466 ) ) ;
V_10 -> V_7 . V_38 . V_208 = F_89 ( sizeof( V_10 -> V_341 . V_466 ) ) ;
}
...
F_213 ( V_2 ) ;
V_10 = & V_2 -> V_7 . V_339 ;
V_10 -> V_7 . V_39 = F_89 ( V_325 ) ;
V_10 -> V_7 . V_24 = F_90 ( V_65 -> V_24 ) ;
V_10 -> V_7 . V_281 = F_89 ( V_65 -> V_281 ) ;
V_10 -> V_341 . V_468 [ 0 ] = F_89 ( V_471 ) ;
memcpy ( & V_10 -> V_341 . V_468 [ 2 ] , & V_4 -> V_152 -> V_153 . V_175 ,
sizeof( V_4 -> V_152 -> V_153 . V_175 ) ) ;
memcpy ( & V_10 -> V_341 . V_468 [ 4 ] , & V_4 -> V_152 -> V_153 . V_174 ,
sizeof( V_4 -> V_152 -> V_153 . V_174 ) ) ;
V_10 -> V_341 . V_468 [ 6 ] = F_89 ( F_2 ( V_4 -> V_152 -> V_153 . V_24 ) & 0x00ffffff ) ;
if ( F_217 ( & V_65 -> V_138 ) )
F_218 ( & V_65 -> V_138 , V_16 + ( V_472 * V_178 ) ) ;
else {
V_65 -> V_138 . V_41 = ( unsigned long ) V_65 ;
V_65 -> V_138 . V_251 = V_16 + ( V_472 * V_178 ) ;
V_65 -> V_138 . V_252 = ( void (*) ( unsigned long ) ) F_215 ;
F_118 ( & V_65 -> V_138 ) ;
}
F_15 ( V_65 , V_459 ) ;
if ( F_115 ( V_2 , V_4 , V_473 ) ) {
V_4 -> V_443 -- ;
F_54 ( & V_65 -> V_138 ) ;
F_15 ( V_65 , V_444 ) ;
F_77 ( & V_65 -> V_150 , F_72 ) ;
...
struct V_64 * V_65 = V_2 -> V_65 ;
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_474 * V_38 = & V_2 -> V_33 -> V_475 ;
T_3 V_36 = F_6 ( V_38 -> V_295 . V_36 ) ;
int V_442 = V_237 ;
V_4 -> V_443 -- ;
F_15 ( V_65 , V_444 ) ;
...
case V_453 :
default:
if ( ( F_6 ( V_38 -> V_36 ) & V_477 ) == V_477 &&
F_6 ( V_38 -> error ) == V_478 &&
F_6 ( V_38 -> V_59 ) == V_479 )
F_15 ( V_65 , V_68 ) ;
else if ( F_11 ( F_6 ( V_38 -> V_36 ) , F_6 ( V_38 -> error ) ) )
V_442 += F_200 ( V_65 , V_476 ) ;
else
F_15 ( V_65 , V_68 ) ;
F_204 ( V_65 , V_442 , L_82 ,
F_9 ( F_6 ( V_38 -> V_36 ) , F_6 ( V_38 -> error ) ) ,
...
static void V_476 ( struct V_64 * V_65 )
{
struct V_474 * V_475 ;
struct V_3 * V_4 = V_65 -> V_4 ;
struct V_1 * V_2 ;
...
V_475 -> V_295 . V_296 = F_89 ( 1 ) ;
V_475 -> V_295 . V_32 = F_89 ( V_480 ) ;
V_475 -> V_295 . V_298 = F_52 ( sizeof( * V_475 ) ) ;
V_475 -> V_380 = F_90 ( V_65 -> V_173 . V_175 ) ;
F_15 ( V_65 , V_459 ) ;
if ( F_115 ( V_2 , V_4 , V_302 ) ) {
V_4 -> V_443 -- ;
F_15 ( V_65 , V_444 ) ;
...
V_65 -> V_4 = V_4 ;
V_65 -> V_397 = 1 ;
V_65 -> V_281 = V_4 -> V_413 ++ ;
F_117 ( & V_65 -> V_138 ) ;
F_222 ( & V_65 -> V_150 ) ;
F_199 ( V_65 , F_209 ) ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_47 ( & V_65 -> V_130 , & V_4 -> V_483 ) ;
V_308:
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
return 0 ;
}
...
{
int V_44 , V_47 ;
for ( V_44 = 0 , V_47 = 0 ; ! V_47 && V_44 < V_4 -> V_484 ; V_44 ++ )
V_47 = F_220 ( V_4 ,
F_4 ( V_4 -> V_485 -> V_24 [ V_44 ] ) &
V_486 ) ;
return V_47 ;
}
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
struct V_487 * V_38 = & V_2 -> V_33 -> V_488 ;
T_3 V_489 = F_6 ( V_38 -> V_295 . V_36 ) ;
int V_442 = V_237 ;
switch ( V_489 ) {
case V_358 :
F_29 ( V_4 , L_85 ) ;
V_4 -> V_484 = F_4 ( V_38 -> V_490 ) ;
F_17 ( V_4 , V_75 ) ;
break;
case V_453 :
V_442 += F_60 ( V_4 ) ;
...
static void V_487 ( struct V_3 * V_4 )
{
struct V_487 * V_10 ;
...
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_295 . V_296 = F_89 ( 1 ) ;
V_10 -> V_295 . V_32 = F_89 ( V_491 ) ;
V_10 -> V_295 . V_298 = F_52 ( sizeof( * V_10 ) ) ;
V_10 -> V_492 = F_89 ( V_4 -> V_493 ) ;
V_10 -> V_494 . V_207 = F_90 ( V_4 -> V_495 ) ;
V_10 -> V_494 . V_208 = F_89 ( V_4 -> V_493 ) ;
F_17 ( V_4 , V_76 ) ;
if ( ! F_115 ( V_2 , V_4 , V_302 ) )
F_29 ( V_4 , L_88 ) ;
else
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_3 V_489 = F_6 ( V_2 -> V_33 -> V_496 . V_295 . V_36 ) ;
struct V_497 * V_38 = & V_4 -> V_152 -> V_153 ;
unsigned int V_498 ;
int V_442 = V_237 ;
switch ( V_489 ) {
case V_358 :
...
return;
default:
F_24 ( V_4 -> V_98 , L_90 , V_489 ) ;
F_21 ( V_4 , V_164 ) ;
F_44 ( V_2 ) ;
return;
}
V_4 -> V_199 = 0 ;
if ( ! ( F_4 ( V_38 -> V_39 ) & V_499 ) ) {
F_24 ( V_4 -> V_98 , L_91 ,
V_38 -> V_39 ) ;
F_21 ( V_4 , V_164 ) ;
F_20 ( & V_4 -> V_91 ) ;
...
V_4 -> V_117 = 1 ;
V_498 = F_226 ( ( V_500 ) ( F_2 ( V_38 -> V_190 ) >> 9 ) , V_191 ) ;
F_135 ( V_4 -> V_98 , L_93 ,
V_38 -> V_183 , V_38 -> V_210 , V_38 -> V_421 ,
V_38 -> V_212 , V_498 ) ;
F_227 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_174 ) ;
F_228 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_174 ) ;
F_229 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_175 ) ;
F_230 ( V_4 -> V_89 ) = F_2 ( V_38 -> V_24 ) ;
F_231 ( V_4 -> V_89 ) = V_501 ;
F_232 ( V_4 -> V_89 ) = 0 ;
if ( F_4 ( V_38 -> V_445 . V_502 [ 0 ] ) & 0x80000000 )
F_232 ( V_4 -> V_89 ) |= V_503 ;
if ( F_4 ( V_38 -> V_445 . V_504 [ 0 ] ) & 0x80000000 )
F_232 ( V_4 -> V_89 ) |= V_505 ;
if ( F_4 ( V_38 -> V_445 . V_506 [ 0 ] ) & 0x80000000 )
F_232 ( V_4 -> V_89 ) |= V_507 ;
F_233 ( V_4 -> V_89 ) =
F_6 ( V_38 -> V_445 . V_295 . V_508 ) & 0x0fff ;
V_4 -> V_89 -> V_509 = F_4 ( V_38 -> V_201 ) - V_203 ;
V_4 -> V_89 -> V_510 = V_498 ;
F_17 ( V_4 , V_80 ) ;
F_20 ( & V_4 -> V_91 ) ;
}
...
V_10 = & V_2 -> V_7 . V_496 ;
memset ( V_10 , 0 , sizeof( struct V_511 ) ) ;
V_10 -> V_295 . V_296 = F_89 ( 1 ) ;
V_10 -> V_295 . V_32 = F_89 ( V_512 ) ;
V_10 -> V_295 . V_298 = F_52 ( sizeof( struct V_511 ) ) ;
V_10 -> V_494 . V_207 = F_90 ( V_4 -> V_513 ) ;
V_10 -> V_494 . V_208 = F_89 ( sizeof( * V_4 -> V_152 ) ) ;
F_17 ( V_4 , V_76 ) ;
if ( ! F_115 ( V_2 , V_4 , V_302 ) )
F_29 ( V_4 , L_94 ) ;
else
...
{
struct V_3 * V_4 = V_2 -> V_4 ;
T_3 V_489 = F_6 ( V_2 -> V_33 -> V_514 . V_295 . V_36 ) ;
F_44 ( V_2 ) ;
switch ( V_489 ) {
case V_358 :
if ( F_101 ( & V_4 -> V_250 ) &&
...
memset ( V_10 , 0 , sizeof( * V_10 ) ) ;
V_10 -> V_295 . V_296 = F_89 ( 1 ) ;
V_10 -> V_295 . V_32 = F_89 ( V_517 ) ;
V_10 -> V_295 . V_298 = F_52 ( sizeof( struct V_516 ) ) ;
F_17 ( V_4 , V_77 ) ;
if ( ! F_115 ( V_2 , V_4 , V_302 ) )
F_29 ( V_4 , L_96 ) ;
else
...
{
if ( V_128 & V_391 )
F_240 ( V_4 -> V_89 , F_241 () , V_518 , 0 ) ;
if ( ( V_128 & V_94 ) &&
V_4 -> V_72 >= V_166 )
F_240 ( V_4 -> V_89 , F_241 () , V_519 , 0 ) ;
if ( ( V_128 & V_387 ) &&
V_4 -> V_72 == V_88 )
F_240 ( V_4 -> V_89 , F_241 () , V_520 , 0 ) ;
}
...
F_203 ( V_65 , L_99 ) ;
V_65 -> V_170 = V_170 ;
V_170 -> V_521 = F_6 ( V_65 -> V_445 . V_295 . V_508 ) & 0x0fff ;
V_170 -> V_522 = 0 ;
V_65 -> V_148 = V_170 -> V_523 ;
if ( F_4 ( V_65 -> V_445 . V_502 [ 0 ] ) & 0x80000000 )
V_170 -> V_522 |= V_503 ;
if ( F_4 ( V_65 -> V_445 . V_504 [ 0 ] ) & 0x80000000 )
V_170 -> V_522 |= V_505 ;
if ( F_4 ( V_65 -> V_445 . V_506 [ 0 ] ) & 0x80000000 )
V_170 -> V_522 |= V_507 ;
if ( V_170 -> V_524 )
F_246 ( V_170 -> V_524 , 1 ) ;
} else
...
{
int V_47 , V_528 = - V_214 ;
struct V_231 * V_98 = V_4 -> V_98 ;
struct V_107 * V_108 = F_26 ( V_98 ) ;
struct V_111 * V_18 = & V_4 -> V_18 ;
V_92 ;
V_18 -> V_100 = (struct V_403 * ) F_255 ( V_213 ) ;
if ( ! V_18 -> V_100 )
return - V_214 ;
...
goto V_529;
V_528 = V_47 = F_27 ( V_123 , V_108 -> V_110 ,
V_18 -> V_118 , V_101 ) ;
if ( V_47 == V_530 )
V_528 = V_47 = F_39 ( V_4 ) ;
if ( V_47 == V_124 )
...
if ( ( V_47 = F_259 ( V_108 -> V_112 , F_193 , 0 , V_532 , V_4 ) ) ) {
...
{
struct V_432 * V_534 = & V_4 -> V_99 ;
V_92 ;
F_261 ( V_4 -> V_481 ) ;
F_74 ( V_4 -> V_14 ) ;
F_99 ( V_4 -> V_98 , V_4 -> V_493 , V_4 -> V_485 ,
V_4 -> V_495 ) ;
F_99 ( V_4 -> V_98 , sizeof( * V_4 -> V_152 ) ,
V_4 -> V_152 , V_4 -> V_513 ) ;
F_262 ( V_4 -> V_220 ) ;
F_36 ( V_4 -> V_98 , V_534 -> V_118 ,
V_534 -> V_129 * sizeof( * V_534 -> V_100 ) , V_119 ) ;
F_37 ( ( unsigned long ) V_534 -> V_100 ) ;
V_95 ;
}
...
struct V_231 * V_98 = V_4 -> V_98 ;
V_92 ;
V_534 -> V_100 = (struct V_378 * ) F_255 ( V_213 ) ;
if ( ! V_534 -> V_100 ) {
F_24 ( V_98 , L_107 ) ;
goto V_535;
}
V_534 -> V_129 = V_101 / sizeof( struct V_378 ) ;
V_534 -> V_118 = F_256 ( V_98 , V_534 -> V_100 ,
V_534 -> V_129 * sizeof( * V_534 -> V_100 ) ,
V_119 ) ;
if ( F_257 ( V_98 , V_534 -> V_118 ) ) {
F_24 ( V_98 , L_108 ) ;
goto V_536;
}
V_4 -> V_220 = F_264 ( V_532 , V_98 ,
V_537 * sizeof( struct V_226 ) ,
...
V_4 -> V_493 = sizeof( V_4 -> V_485 -> V_24 [ 0 ] ) * V_540 ;
V_4 -> V_485 = F_94 ( V_98 , V_4 -> V_493 ,
& V_4 -> V_495 , V_213 ) ;
if ( ! V_4 -> V_485 ) {
F_24 ( V_98 , L_111 ) ;
goto V_541;
...
static void F_266 ( struct V_546 * V_547 )
{
struct V_3 * V_4 = F_73 ( V_547 , struct V_3 ,
V_525 ) ;
struct V_64 * V_65 ;
struct V_169 * V_170 ;
unsigned long V_39 ;
...
static int F_270 ( struct V_107 * V_108 , const struct V_549 * V_149 )
{
struct V_3 * V_4 ;
struct V_145 * V_146 ;
...
V_146 -> V_510 = V_191 ;
V_146 -> V_555 = V_556 ;
V_146 -> V_557 = V_146 -> V_558 ;
V_4 = F_63 ( V_146 ) ;
F_272 ( & V_4 -> V_250 ) ;
F_272 ( & V_4 -> free ) ;
F_272 ( & V_4 -> V_483 ) ;
sprintf ( V_4 -> V_48 , V_532 ) ;
V_4 -> V_89 = V_146 ;
V_4 -> V_98 = V_98 ;
V_4 -> V_184 = - 1 ;
V_4 -> V_236 = V_236 ;
...
F_273 ( & V_4 -> V_91 ) ;
F_273 ( & V_4 -> V_176 ) ;
F_274 ( & V_4 -> V_525 , F_266 ) ;
F_275 ( & V_4 -> V_331 ) ;
if ( ( V_47 = F_263 ( V_4 ) ) )
goto V_559;
V_4 -> V_560 = F_276 ( F_251 , V_4 , L_116 , V_532 ,
V_146 -> V_558 ) ;
if ( F_277 ( V_4 -> V_560 ) ) {
F_24 ( V_98 , L_117 ,
F_278 ( V_4 -> V_560 ) ) ;
...
goto V_564;
F_280 ( V_146 ) = V_565 ;
if ( ( V_47 = F_281 ( & V_146 -> V_566 . V_426 ,
& V_567 ) ) ) {
F_24 ( V_98 , L_120 , V_47 ) ;
goto V_568;
}
if ( F_282 ( V_146 ) -> V_524 )
F_246 ( F_282 ( V_146 ) -> V_524 , 1 ) ;
F_283 ( V_98 , V_4 ) ;
F_284 ( & V_569 ) ;
F_47 ( & V_4 -> V_130 , & V_570 ) ;
F_285 ( & V_569 ) ;
F_28 ( V_4 ) ;
F_286 ( V_146 ) ;
return 0 ;
...
unsigned long V_39 ;
V_92 ;
F_291 ( & V_4 -> V_89 -> V_566 . V_426 , & V_567 ) ;
F_40 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_21 ( V_4 , V_73 ) ;
F_42 ( V_4 -> V_89 -> V_122 , V_39 ) ;
F_81 ( V_4 ) ;
...
{
unsigned long V_571 = V_202 * sizeof( union V_305 ) ;
return V_571 + ( ( 512 * 1024 ) * V_550 . V_572 ) ;
}
