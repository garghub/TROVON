...
static int F_44 ( struct V_1 * V_33 )
{
struct V_54 V_55 = {
. V_59 = & V_60 ,
. V_61 = V_33 -> V_62 ,
...
int V_57 ;
unsigned clock , V_64 ;
for ( V_56 = 0 ; V_56 < F_45 ( V_33 -> V_62 ) ; ++ V_56 ) {
struct V_38 * V_15 = F_46 ( & V_33 -> V_7 -> V_8 ,
V_65 [ V_56 ] ) ;
if ( F_47 ( V_15 ) ) {
V_33 -> V_62 [ V_56 ] = V_65 [ V_56 ] ;
} else {
V_33 -> V_62 [ V_56 ] = F_48 ( V_15 ) ;
V_33 -> V_40 [ V_56 ] = V_15 ;
}
}
V_57 = F_1 ( V_33 , V_66 , & V_64 ) ;
if ( V_57 < 0 )
return V_57 ;
if ( ( V_64 & V_67 ) ==
V_68 ) {
V_57 = F_1 ( V_33 , V_69 , & clock ) ;
if ( V_57 < 0 )
return V_57 ;
V_33 -> V_41 [ 0 ] . V_15 = ! ! ( clock & V_70 ) ;
}
V_57 = F_42 ( V_33 , V_33 -> V_41 ,
F_45 ( V_33 -> V_41 ) ,
V_71 , & V_55 ) ;
return V_57 ;
}
static int F_49 ( struct V_1 * V_33 )
{
struct V_54 V_55 = {
. V_59 = & V_72 ,
. V_61 = V_71 ,
...
int V_57 ;
unsigned V_19 ;
V_57 = F_1 ( V_33 , V_73 , & V_19 ) ;
if ( V_57 < 0 )
return V_57 ;
for ( V_56 = 0 ; V_56 < F_45 ( V_33 -> V_74 ) ; ++ V_56 ) {
unsigned V_46 , V_45 , V_75 ;
V_57 = F_1 ( V_33 , F_18 ( V_56 ) , & V_46 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_1 ( V_33 , F_19 ( V_56 ) , & V_45 ) ;
if ( V_57 < 0 )
return V_57 ;
V_57 = F_1 ( V_33 , F_17 ( V_56 ) , & V_75 ) ;
if ( V_57 < 0 )
return V_57 ;
V_33 -> V_74 [ V_56 ] . div = V_46 | ( ( V_75 & V_26 ) << 8 ) ;
V_33 -> V_74 [ V_56 ] . V_20 = V_45 | ( ( V_75 & V_27 ) <<
( 8 - V_28 ) ) ;
V_33 -> V_74 [ V_56 ] . V_19 = V_19 & F_50 ( V_56 ) ;
F_12 ( & V_33 -> V_7 -> V_8 ,
L_12 , V_17 , V_56 ,
V_33 -> V_74 [ V_56 ] . div , V_33 -> V_74 [ V_56 ] . V_20 , V_33 -> V_74 [ V_56 ] . V_19 ) ;
}
V_57 = F_42 ( V_33 , V_33 -> V_74 ,
F_45 ( V_33 -> V_74 ) ,
V_76 , & V_55 ) ;
return V_57 ;
}
static int F_51 ( struct V_1 * V_33 )
{
struct V_54 V_55 = {
. V_59 = & V_77 ,
. V_61 = V_78 ,
...
unsigned V_56 ;
int V_57 ;
for ( V_56 = 0 ; V_56 < F_45 ( V_33 -> V_80 ) ; ++ V_56 ) {
unsigned V_4 ;
V_57 = F_1 ( V_33 , F_22 ( V_56 ) , & V_4 ) ;
if ( V_57 < 0 )
return V_57 ;
V_33 -> V_80 [ V_56 ] . V_15 =
( V_4 & F_23 ( V_56 ) ) >>
F_24 ( V_56 ) ;
V_57 = F_1 ( V_33 , F_33 ( V_56 ) , & V_4 ) ;
if ( V_57 < 0 )
return V_57 ;
...
unsigned V_56 ;
int V_57 ;
for ( V_56 = 0 ; V_56 < F_45 ( V_33 -> V_83 ) ; ++ V_56 ) {
unsigned V_4 ;
V_57 = F_1 ( V_33 , F_35 ( V_56 ) , & V_4 ) ;
if ( V_57 < 0 )
return V_57 ;
...
return F_42 ( V_33 , V_33 -> V_83 ,
F_45 ( V_33 -> V_83 ) ,
V_85 , & V_55 ) ;
}
static struct V_10 *
F_53 ( struct V_86 * V_87 , void * V_88 )
{
struct V_1 * V_33 = V_88 ;
unsigned int V_18 = V_87 -> args [ 0 ] ;
if ( V_18 >= F_45 ( V_33 -> V_83 ) ) {
F_54 ( L_15 , V_17 , V_18 ) ;
return F_55 ( - V_89 ) ;
}
return & V_33 -> V_83 [ V_18 ] . V_11 ;
}
static int F_56 ( struct V_90 * V_7 ,
const struct V_91 * V_92 )
{
struct V_93 * V_94 = F_57 ( V_7 -> V_8 . V_15 ) ;
struct V_1 * V_33 ;
int V_57 ;
if ( ! F_58 ( V_94 , V_95 ) )
return - V_96 ;
V_33 = F_59 ( & V_7 -> V_8 , sizeof( * V_33 ) , V_97 ) ;
if ( ! V_33 )
return - V_98 ;
V_33 -> V_7 = V_7 ;
V_33 -> V_6 = F_60 ( V_7 , & V_99 ) ;
if ( F_47 ( V_33 -> V_6 ) ) {
F_3 ( & V_7 -> V_8 , L_16 ) ;
return - V_89 ;
}
...
if ( V_57 < 0 )
return V_57 ;
return F_62 ( V_7 -> V_8 . V_100 , F_53 ,
V_33 ) ;
}
static int F_63 ( struct V_90 * V_7 )
{
F_64 ( V_7 -> V_8 . V_100 ) ;
return 0 ;
}
