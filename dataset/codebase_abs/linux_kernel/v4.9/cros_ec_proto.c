...
struct V_3 * V_4 ;
int V_23 ;
V_4 = F_4 ( sizeof( * V_4 ) + F_13 ( sizeof( * V_65 ) , sizeof( * V_63 ) ) ,
V_31 ) ;
if ( ! V_4 )
return - V_32 ;
V_4 -> V_19 = 0 ;
V_4 -> V_17 = V_66 ;
V_4 -> V_34 = sizeof( * V_65 ) ;
V_4 -> V_12 = sizeof( * V_63 ) ;
V_63 = (struct V_62 * ) V_4 -> V_22 ;
V_63 -> V_60 = V_60 ;
V_23 = F_16 ( V_2 , V_4 ) ;
if ( V_23 > 0 ) {
V_65 = (struct V_64 * ) V_4 -> V_22 ;
* V_61 = V_65 -> V_67 ;
}
F_6 ( V_4 ) ;
return V_23 ;
...
T_3 V_71 = 0 ;
int V_23 ;
V_69 = F_18 ( sizeof( * V_69 ) + sizeof( * V_70 ) ,
V_31 ) ;
if ( ! V_69 )
return - V_32 ;
V_2 -> V_10 = 3 ;
V_23 = F_10 ( V_2 , 0 , V_69 ) ;
if ( V_23 == 0 ) {
V_70 = (struct V_48 * )
V_69 -> V_22 ;
V_2 -> V_72 = V_70 -> V_73 -
...
F_21 ( V_43 , V_2 -> V_84 ) ;
F_21 ( V_43 , V_2 -> V_14 ) ;
V_2 -> V_84 = F_22 ( V_43 , V_2 -> V_78 , V_31 ) ;
if ( ! V_2 -> V_84 ) {
V_23 = - V_32 ;
goto exit;
}
...
{
T_1 V_90 [ sizeof( struct V_3 ) + sizeof( V_2 -> V_91 ) ] ;
struct V_3 * V_4 = (struct V_3 * ) & V_90 ;
int V_23 ;
V_4 -> V_19 = 0 ;
V_4 -> V_17 = V_85 ;
V_4 -> V_34 = sizeof( V_2 -> V_91 ) ;
V_4 -> V_12 = 0 ;
V_23 = F_16 ( V_2 , V_4 ) ;
if ( V_23 > 0 ) {
V_2 -> V_92 = V_23 - 1 ;
memcpy ( & V_2 -> V_91 , V_4 -> V_22 ,
sizeof( V_2 -> V_91 ) ) ;
}
return V_23 ;
}
...
{
T_1 V_90 [ sizeof( struct V_3 ) +
sizeof( V_2 -> V_91 . V_22 ) ] ;
struct V_3 * V_4 = (struct V_3 * ) & V_90 ;
V_4 -> V_19 = 0 ;
V_4 -> V_17 = V_93 ;
V_4 -> V_34 = sizeof( V_2 -> V_91 . V_22 ) ;
V_4 -> V_12 = 0 ;
V_2 -> V_92 = F_16 ( V_2 , V_4 ) ;
V_2 -> V_91 . V_94 = V_95 ;
memcpy ( & V_2 -> V_91 . V_22 , V_4 -> V_22 ,
sizeof( V_2 -> V_91 . V_22 ) ) ;
return V_2 -> V_92 ;
}
