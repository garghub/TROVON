...
struct V_191 * V_192 = F_56 ( V_4 -> V_14 . V_14 . V_199 . V_200 ) ;
V_192 -> V_28 = V_201 ;
...
V_183 = F_59 ( F_26 ( V_2 -> V_46 . V_50 ) , V_2 , & V_121 , V_122 ) ;
if ( V_183 ) {
V_2 -> V_177 = 1 ;
F_60 ( V_122 ) ;
