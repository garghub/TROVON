...
if ( ! V_23 -> V_62 -> V_52 . V_98 ) {
V_87 = - V_99 ;
goto V_14;
}
V_23 -> V_62 -> V_52 . V_98 ( V_80 , V_82 , V_23 , V_86 ) ;
V_87 = V_80 -> V_100 ;
V_14:
if ( V_86 )
F_27 ( V_86 ) ;
...
F_49 ( & V_8 -> V_128 [ V_110 ] . V_108 ) ;
F_50 ( & V_8 -> V_128 [ V_110 ] . V_129 ) ;
...
struct V_43 * V_34 )
{
struct V_41 * V_136 = NULL , * V_52 ;
struct V_137 * V_138 = V_23 -> V_62 ;
F_5 () ;
F_6 (neigh, &orig_node->neigh_list, list) {
if ( V_136 && ( V_138 -> V_52 . V_139 ( V_52 , V_34 , V_136 ,
V_34 ) <= 0 ) )
continue;
if ( ! F_7 ( & V_52 -> V_12 ) )
continue;
...
static void V_28 ( struct V_144 * V_145 )
{
struct V_146 * V_146 ;
struct V_22 * V_23 ;
V_146 = F_98 ( V_145 ) ;
V_23 = F_2 ( V_146 , struct V_22 , V_27 ) ;
F_94 ( V_23 ) ;
F_24 ( V_29 ,
& V_23 -> V_27 ,
F_25 ( V_30 ) ) ;
...
if ( ! V_23 -> V_62 -> V_67 . V_98 ) {
V_87 = - V_99 ;
goto V_14;
}
V_23 -> V_62 -> V_67 . V_98 ( V_80 , V_82 , V_23 , V_86 ) ;
V_87 = V_80 -> V_100 ;
V_14:
if ( V_86 )
F_27 ( V_86 ) ;
...
V_87 = 0 ;
if ( V_138 -> V_67 . V_148 )
V_87 = V_138 -> V_67 . V_148 ( V_8 , V_147 ) ;
if ( V_87 == - V_31 )
goto V_25;
}
F_8 () ;
...
V_87 = 0 ;
if ( V_138 -> V_67 . V_150 )
V_87 = V_138 -> V_67 . V_150 ( V_8 , V_147 ,
V_55 -> V_151 ) ;
if ( V_87 == - V_31 )
goto V_25;
}
...
if ( V_55 == V_149 )
continue;
if ( V_55 -> V_60 != V_149 -> V_60 )
continue;
if ( V_149 -> V_151 > V_55 -> V_151 )
V_149 -> V_151 -- ;
}
F_8 () ;
V_55 -> V_151 = - 1 ;
