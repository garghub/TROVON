...
if ( ! F_28 ( V_7 , V_53 ) )
return - V_39 ;
V_64 = F_46 ( V_7 , V_46 -> V_85 ) ;
if ( ! V_64 )
return - V_55 ;
if ( V_46 -> V_68 == V_64 -> V_68 ) {
V_84 = ( void T_3 * ) ( unsigned long ) V_46 -> V_42 ;
if ( F_31 ( V_84 , V_64 -> V_42 , V_64 -> V_68 ) ) {
V_10 = - V_58 ;
goto V_86;
}
}
...
return F_51 ( V_64 ) ;
V_84 = ( void T_3 * ) ( unsigned long ) V_46 -> V_42 ;
if ( F_55 ( V_64 -> V_42 , V_84 , V_46 -> V_68 ) ) {
V_10 = - V_58 ;
goto V_88;
}
F_35 ( & V_7 -> V_20 . V_66 ) ;
V_46 -> V_85 = V_64 -> V_15 . V_74 ;
F_7 ( & V_64 -> V_70 , & V_44 -> V_89 ) ;
F_36 ( & V_7 -> V_20 . V_66 ) ;
return 0 ;
V_88:
F_40 ( V_64 ) ;
...
T_1 V_96 = F_58 ( V_36 ) ;
if ( V_96 < F_58 ( V_2 -> V_12 [ 0 ] ) ||
V_96 > F_58 ( V_2 -> V_12 [ 1 ] ) )
return false ;
return true ;
} else if ( F_21 ( V_2 , V_29 ) ) {
V_13 V_97 = 0 ;
for ( V_24 = 0 ; V_24 < V_2 -> V_9 ; V_24 ++ )
V_97 |= ( 1ULL << V_2 -> V_12 [ V_24 ] ) ;
return ! ( V_36 & ~ V_97 ) ;
