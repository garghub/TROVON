...
F_21 ( V_2 -> V_10 , V_132 ) ;
F_23 ( V_2 -> V_10 ) ;
F_97 ( & V_6 -> V_139 , V_137 ) ;
F_95 ( V_6 , V_137 , true ) ;
F_96 ( V_6 , V_137 , true ) ;
}
V_2 -> V_140 ( & V_12 -> V_3 , false , NULL ) ;
F_68 ( V_2 , false ) ;
}
...
if ( F_103 ( V_6 ) )
return 165000 ;
else if ( F_104 ( V_6 ) || F_105 ( V_6 ) -> V_141 >= 8 )
return 300000 ;
else
return 225000 ;
}
...
int V_143 = F_102 ( F_4 ( V_4 ) ) ;
if ( V_142 ) {
struct V_144 * V_17 = V_15 -> V_145 ;
const struct V_146 * V_147 = & V_17 -> V_3 . V_82 ;
if ( V_15 -> V_100 . V_143 )
V_143 = F_107 ( V_143 ,
V_15 -> V_100 . V_143 ) ;
if ( V_147 -> V_143 )
...
V_143 = F_107 ( V_143 , 165000 ) ;
}
return V_143 ;
}
static enum V_148
F_108 ( struct V_2 * V_15 ,
int clock , bool V_142 )
{
struct V_1 * V_4 = F_1 ( V_15 ) ;
if ( clock < 25000 )
return V_149 ;
if ( clock > F_106 ( V_15 , V_142 ) )
return V_150 ;
...
enum V_148 V_153 ;
int clock ;
int V_154 = F_4 ( V_17 -> V_4 ) -> V_155 ;
if ( V_85 -> V_93 & V_156 )
return V_157 ;
clock = V_85 -> clock ;
if ( ( V_85 -> V_93 & V_158 ) == V_159 )
clock *= 2 ;
if ( clock > V_154 )
return V_150 ;
if ( V_85 -> V_93 & V_160 )
clock *= 2 ;
V_153 = F_108 ( V_15 , clock , true ) ;
if ( ! F_111 ( V_4 ) && V_153 != V_152 )
V_153 = F_108 ( V_15 , clock * 3 / 2 , true ) ;
return V_153 ;
}
static bool F_112 ( struct V_46 * V_161 )
{
struct V_1 * V_4 = V_161 -> V_3 . V_51 -> V_4 ;
if ( F_111 ( V_4 ) )
return false ;
return V_161 -> V_162 == 1 << V_163 ;
}
...
struct V_5 * V_6 = F_4 ( V_17 -> V_4 ) ;
int V_68 ;
V_68 = F_135 ( & V_17 -> V_3 , V_194 , V_38 ) ;
if ( V_68 )
return V_68 ;
if ( V_194 == V_6 -> V_195 ) {
enum V_196 V_33 = V_38 ;
bool V_124 ;
if ( V_33 == V_2 -> V_183 )
return 0 ;
V_2 -> V_183 = V_33 ;
...
struct V_130 * V_131 )
{
struct V_13 * V_212 = F_25 ( & V_12 -> V_3 ) ;
struct V_2 * V_2 = & V_212 -> V_15 ;
struct V_1 * V_4 = V_12 -> V_3 . V_4 ;
struct V_5 * V_6 = F_4 ( V_4 ) ;
struct V_50 * V_50 =
F_28 ( V_12 -> V_3 . V_51 ) ;
...
enum V_49 V_49 )
{
const struct V_214 * V_147 =
& V_6 -> V_215 . V_216 [ V_49 ] ;
T_7 V_217 ;
if ( V_147 -> V_218 ) {
F_51 ( L_21 ,
V_147 -> V_218 , F_165 ( V_49 ) ) ;
return V_147 -> V_218 ;
}
switch ( V_49 ) {
case V_219 :
...
if ( F_6 ( V_14 -> V_228 < 4 ,
L_24 ,
V_14 -> V_228 , F_165 ( V_49 ) ) )
return;
F_167 ( V_4 , V_17 , & V_229 ,
V_230 ) ;
F_168 ( V_17 , & V_231 ) ;
V_17 -> V_232 = 1 ;
V_17 -> V_233 = 0 ;
...
F_170 ( V_144 , V_102 ) ;
V_2 -> V_145 = V_144 ;
if ( F_103 ( V_4 ) && ! F_171 ( V_4 ) ) {
T_2 V_132 = F_7 ( V_246 ) ;
F_21 ( V_246 , ( V_132 & ~ 0xf ) | 0xd ) ;
}
}
...
V_102 = & V_14 -> V_3 ;
F_175 ( V_4 , & V_102 -> V_3 , & V_248 ,
V_249 , L_25 , F_165 ( V_49 ) ) ;
V_102 -> V_250 = F_113 ;
if ( F_62 ( V_4 ) ) {
V_102 -> V_251 = F_100 ;
V_102 -> V_252 = F_101 ;
