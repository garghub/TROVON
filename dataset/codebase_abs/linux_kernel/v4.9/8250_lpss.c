...
static void F_16 ( struct V_7 * V_8 , struct V_1 * V_29 ) {}
static void F_19 ( struct V_7 * V_8 ) {}
static int F_21 ( struct V_7 * V_8 , struct V_1 * V_29 )
{
struct V_38 * V_39 = F_12 ( V_29 -> V_40 ) ;
int V_30 ;
V_30 = F_22 ( V_39 , 1 , 1 , V_76 ) ;
if ( V_30 < 0 )
return V_30 ;
V_29 -> V_69 = F_23 ( V_39 , 0 ) ;
F_16 ( V_8 , V_29 ) ;
return 0 ;
}
...
static bool F_25 ( struct V_77 * V_78 , void * V_34 )
{
...
static int F_26 ( struct V_7 * V_8 , struct V_36 * V_29 )
{
struct V_64 * V_65 = & V_8 -> V_65 ;
...
if ( ! V_8 -> V_35 . V_43 )
return 0 ;
V_81 = F_27 ( V_40 , sizeof( * V_81 ) , V_83 ) ;
if ( ! V_81 )
return - V_84 ;
V_82 = F_27 ( V_40 , sizeof( * V_82 ) , V_83 ) ;
if ( ! V_82 )
return - V_84 ;
* V_81 = V_8 -> V_35 ;
...
static int F_28 ( struct V_38 * V_39 , const struct V_90 * V_91 )
{
struct V_36 V_92 ;
struct V_7 * V_8 ;
int V_30 ;
...
return V_30 ;
F_30 ( V_39 ) ;
V_8 = F_27 ( & V_39 -> V_40 , sizeof( * V_8 ) , V_83 ) ;
if ( ! V_8 )
return - V_84 ;
...
V_92 . V_29 . V_107 = F_31 ( V_39 , 0 ) ;
V_92 . V_29 . V_21 = F_32 ( V_39 , 0 , 0 ) ;
if ( ! V_92 . V_29 . V_21 )
return - V_84 ;
