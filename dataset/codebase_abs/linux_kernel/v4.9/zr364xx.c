...
F_15 ( L_46 , V_21 -> V_63 . V_64 [ V_79 ] . V_65 ) ;
...
if ( V_79 == 0 ) {
F_28 (KERN_INFO KBUILD_MODNAME L_55 ) ;
F_6 ( V_21 -> V_162 -> V_9 ) ;
V_21 -> V_162 -> V_9 = NULL ;
return - V_12 ;
} else
...
int V_79 ;
F_15 ( L_57 ) ;
F_40 ( & V_184 -> V_11 , V_111 L_58 ) ;
F_40 ( & V_184 -> V_11 , L_59 ,
...
V_101 [ 440 ] = V_21 -> V_23 % 256 ;
V_21 -> V_105 = 0 ;
F_15 ( L_66 , V_21 , V_21 -> V_2 , V_184 ) ;
V_187 = V_184 -> V_200 ;
F_15 ( L_67 , V_187 -> V_201 . V_202 ) ;
