...
V_168 = F_98 ( V_23 , V_30 -> V_186 ) ;
F_99 ( V_168 , V_169 , V_170 ) ;
...
unsigned int V_188 ;
unsigned long V_9 ;
F_103 ( & V_30 -> V_189 , V_9 ) ;
V_188 = F_90 ( V_23 , V_30 ) ;
F_104 ( & V_30 -> V_189 , V_9 ) ;
return V_188 ;
}
static int F_105 ( struct V_190 * V_191 , int V_192 )
{
struct V_149 * V_30 =
F_106 ( V_191 , struct V_149 , V_191 ) ;
unsigned int V_193 = 0 ;
V_193 = F_102 ( V_30 -> V_2 -> V_23 , V_30 ) ;
if ( V_193 == 0 ) {
F_107 ( V_191 ) ;
V_30 -> V_194 ( V_30 ) ;
return 0 ;
...
if ( F_109 ( V_23 ) ) {
for ( V_70 = 0 ; V_70 < V_2 -> V_8 -> V_79 ; V_70 ++ )
F_102 ( V_23 , & V_2 -> V_195 [ V_70 ] ) ;
}
F_102 ( V_23 , & V_2 -> V_195 [ V_65 ] ) ;
}
...
V_150 -> V_156 = V_156 ;
V_198 = F_113 ( V_156 ) ;
V_199 = F_114 ( V_165 , V_156 -> V_90 , V_198 , V_182 ) ;
V_59 = F_115 ( V_165 , V_199 ) ;
if ( V_59 ) {
V_2 -> V_201 . V_202 ++ ;
...
V_150 -> V_156 = NULL ;
V_213 = F_119 ( V_212 ) ;
V_199 = F_120 ( V_165 , V_212 , 0 , V_213 , V_182 ) ;
V_59 = F_115 ( V_165 , V_199 ) ;
if ( V_59 ) {
V_2 -> V_201 . V_202 ++ ;
...
F_79 ( V_150 , V_157 , V_199 ) ;
F_117 ( V_150 , V_181 , V_213 ) ;
F_9 ( V_2 , V_150 -> V_211 , V_199 ,
( V_213 << V_204 ) | V_197 |
( V_2 -> V_8 -> V_205 << V_206 ) ) ;
return 0 ;
}
static struct V_196 * F_121 ( struct V_34 * V_23 ,
struct V_196 * V_156 )
{
...
static T_8 F_129 ( struct V_196 * V_156 , struct V_34 * V_23 )
{
struct V_1 * V_2 = F_23 ( V_23 ) ;
...
if ( V_231 == 0 )
V_197 |= V_238 ;
V_59 = F_110 ( V_23 , V_156 , V_197 , V_30 ) ;
if ( V_59 ) {
V_59 = V_235 ;
goto V_233;
}
...
V_30 -> V_240 += V_231 + 1 ;
V_30 -> V_240 &= V_241 ;
F_136 ( V_168 , F_93 ( V_156 ) -> V_180 ) ;
if ( V_30 -> V_183 <= ( V_187 + 1 ) )
F_132 ( V_168 ) ;
if ( ! V_156 -> V_242 || F_137 ( V_168 ) )
F_30 ( V_2 , V_30 -> V_163 ,
V_30 -> V_240 , V_243 ) ;
V_233:
F_104 ( & V_30 -> V_189 , V_9 ) ;
...
static struct V_196 * F_138 ( struct V_1 * V_2 ,
struct V_148 * V_155 )
{
struct V_22 * V_165 = & V_2 -> V_166 -> V_23 ;
struct V_196 * V_156 ;
...
V_199 = F_114 ( V_165 , V_156 -> V_90 , V_2 -> V_245 ,
V_249 ) ;
if ( F_115 ( V_165 , V_199 ) ) {
V_2 -> V_201 . V_250 ++ ;
F_78 ( V_156 ) ;
F_61 ( V_2 , V_248 , V_2 -> V_23 ,
L_9 , V_177 ) ;
...
static int F_146 ( struct V_190 * V_191 , int V_192 )
{
struct V_158 * V_30 = F_106 ( V_191 ,
struct V_158 , V_191 ) ;
unsigned int V_193 ;
V_193 = F_140 ( V_30 , V_192 ) ;
if ( V_193 < V_192 ) {
F_147 ( V_191 , V_193 ) ;
V_30 -> V_194 ( V_30 ) ;
}
...
struct V_196 * V_156 ;
int V_70 ;
F_92 ( V_2 , V_131 , V_2 -> V_23 , L_15 , V_177 ) ;
...
for ( V_70 = 0 ; V_70 < V_2 -> V_8 -> V_79 ; ++ V_70 ) {
V_30 = & V_2 -> V_195 [ V_70 ] ;
F_166 ( V_2 -> V_23 , & V_30 -> V_191 , F_105 , 64 ) ;
}
V_30 = & V_2 -> V_195 [ V_65 ] ;
F_166 ( V_2 -> V_23 , & V_30 -> V_191 , F_105 , 64 ) ;
}
...
for ( V_70 = 0 ; V_70 < V_2 -> V_8 -> V_80 ; ++ V_70 ) {
V_30 = & V_2 -> V_328 [ V_70 ] ;
F_177 ( V_2 -> V_23 , & V_30 -> V_191 , F_146 , 64 ) ;
}
V_30 = & V_2 -> V_328 [ V_65 ] ;
F_177 ( V_2 -> V_23 , & V_30 -> V_191 , F_146 , 64 ) ;
}
...
F_116 ( V_2 -> V_178 [ V_70 ] . V_156 ) ;
V_2 -> V_178 [ V_70 ] . V_156 = NULL ;
}
}
for ( V_70 = 0 ; V_70 < V_2 -> V_8 -> V_79 ; V_70 ++ ) {
V_168 = F_98 ( V_2 -> V_23 , V_2 -> V_195 [ V_70 ] . V_186 ) ;
F_185 ( V_168 ) ;
}
V_168 = F_98 ( V_2 -> V_23 , V_2 -> V_195 [ V_65 ] . V_186 ) ;
F_185 ( V_168 ) ;
F_149 ( V_2 ) ;
F_186 ( V_2 -> V_265 ) ;
F_186 ( V_2 -> V_178 ) ;
...
V_2 -> V_357 = V_347 ;
V_2 -> V_178 = F_188 ( V_2 -> V_357 , sizeof( struct V_148 ) ,
V_360 ) ;
if ( ! V_2 -> V_178 ) {
F_186 ( V_2 -> V_265 ) ;
return - V_287 ;
...
F_92 ( V_2 , V_369 , V_2 -> V_23 , L_15 , V_177 ) ;
if ( V_2 -> V_370 & V_371 ) {
V_2 -> V_370 &= ~ V_371 ;
...
static void F_212 ( struct V_34 * V_23 )
{
struct V_1 * V_2 = F_23 ( V_23 ) ;
F_178 ( V_2 ) ;
F_167 ( V_2 ) ;
F_150 ( V_2 , V_399 | V_400 , true ) ;
F_213 ( V_23 ) ;
F_156 ( V_2 ) ;
F_214 ( V_2 -> V_38 ) ;
}
static int F_215 ( struct V_34 * V_23 )
{
struct V_1 * V_2 = F_23 ( V_23 ) ;
unsigned long V_336 ;
T_2 V_71 ;
int V_59 ;
F_92 ( V_2 , V_401 , V_23 , L_25 ) ;
F_55 ( V_2 -> V_402 ) ;
if ( V_2 -> V_296 )
F_71 ( V_2 , V_136 ) ;
F_204 ( V_2 ) ;
...
if ( V_59 )
goto V_403;
F_150 ( V_2 , V_399 | V_400 , false ) ;
V_71 = F_51 ( V_2 , V_290 ) ;
V_2 -> V_47 = ! ! ( V_71 & V_404 ) ;
F_205 ( V_2 , V_23 -> V_405 ) ;
if ( V_2 -> V_296 ) {
V_71 = F_68 ( V_2 , V_138 ) ;
V_71 |= V_406 ;
F_69 ( V_2 , V_71 , V_138 ) ;
...
F_207 ( V_2 , V_336 ) ;
F_211 ( V_2 ) ;
V_59 = F_216 ( V_2 -> V_387 , F_195 , V_407 ,
V_23 -> V_408 , V_2 ) ;
if ( V_59 < 0 ) {
F_133 ( V_23 , L_27 , V_2 -> V_387 ) ;
goto V_409;
}
V_59 = F_216 ( V_2 -> V_388 , F_191 , V_407 ,
V_23 -> V_408 , V_2 ) ;
if ( V_59 < 0 ) {
...
static int F_223 ( struct V_34 * V_23 )
{
struct V_1 * V_2 = F_23 ( V_23 ) ;
int V_59 ;
F_92 ( V_2 , V_416 , V_23 , L_29 ) ;
F_219 ( V_23 ) ;
F_224 ( V_2 -> V_38 ) ;
F_150 ( V_2 , V_400 , false ) ;
V_59 = F_182 ( V_2 ) ;
if ( V_59 )
return V_59 ;
F_150 ( V_2 , V_399 , false ) ;
F_108 ( V_23 ) ;
F_184 ( V_2 ) ;
F_218 ( V_2 -> V_387 , V_2 ) ;
F_218 ( V_2 -> V_388 , V_2 ) ;
...
static void F_225 ( struct V_149 * V_30 )
{
struct V_1 * V_2 = V_30 -> V_2 ;
...
if ( ! F_226 ( V_2 ) )
return;
V_168 = F_98 ( V_2 -> V_23 , V_30 -> V_186 ) ;
F_103 ( & V_30 -> V_189 , V_9 ) ;
if ( V_30 -> V_163 == V_65 ) {
V_417 = ~ F_196 ( V_2 , V_380 ) ;
V_418 = V_164 | V_420 ;
} else {
V_417 = ~ F_192 ( V_2 , V_380 ) ;
V_418 = 1 << V_30 -> V_163 ;
}
V_171 = F_29 ( V_2 , V_30 -> V_163 , V_174 ) ;
...
F_225 ( & V_2 -> V_195 [ V_421 ] ) ;
F_225 ( & V_2 -> V_195 [ V_65 ] ) ;
F_108 ( V_23 ) ;
for ( V_421 = 0 ; V_421 < V_2 -> V_8 -> V_79 ; V_421 ++ )
V_302 |= ( 1 << V_421 ) ;
V_295 = V_164 ;
...
int V_70 , V_423 ;
T_2 V_71 ;
F_92 ( V_2 , V_131 , V_23 , L_42 , V_177 , V_23 -> V_9 ) ;
V_71 = F_51 ( V_2 , V_290 ) ;
if ( V_23 -> V_9 & V_429 ) {
V_71 |= V_430 ;
F_52 ( V_2 , V_71 , V_290 ) ;
...
V_70 = 0 ;
V_423 = 0 ;
F_230 ( V_2 , V_23 -> V_432 , & V_70 , & V_423 ) ;
F_230 ( V_2 , V_23 -> V_405 , & V_70 , & V_423 ) ;
if ( F_232 ( V_23 ) > ( V_426 - V_423 ) )
return;
if ( ! F_233 ( V_23 ) )
F_234 (ha, dev)
F_230 ( V_2 , V_428 -> V_6 , & V_70 , & V_423 ) ;
if ( F_235 ( V_23 ) || F_236 ( V_23 ) >= ( V_426 - V_423 ) )
return;
F_237 (ha, dev)
F_230 ( V_2 , V_428 -> V_6 , & V_70 , & V_423 ) ;
}
...
V_438 = 1 ;
if ( V_438 != V_2 -> V_85 ) {
F_154 ( & V_2 -> V_166 -> V_23 ,
L_44 ,
V_438 , V_2 -> V_85 ) ;
}
F_243 ( & V_2 -> V_166 -> V_23 , L_45 V_452 ,
...
static int F_246 ( struct V_455 * V_166 )
{
...
struct V_465 * V_25 ;
int V_466 = - V_467 ;
V_23 = F_247 ( sizeof( * V_2 ) , V_468 + 1 ,
V_468 + 1 ) ;
if ( ! V_23 ) {
F_154 ( & V_166 -> V_23 , L_55 ) ;
return - V_287 ;
}
if ( V_460 ) {
V_463 = F_248 ( V_469 , V_460 ) ;
if ( ! V_463 )
return - V_37 ;
}
V_2 = F_23 ( V_23 ) ;
V_2 -> V_387 = F_249 ( V_166 , 0 ) ;
V_2 -> V_388 = F_249 ( V_166 , 1 ) ;
V_2 -> V_470 = F_249 ( V_166 , 2 ) ;
if ( ! V_2 -> V_387 || ! V_2 -> V_388 ) {
F_154 ( & V_166 -> V_23 , L_56 ) ;
V_466 = - V_37 ;
goto V_466;
}
if ( V_460 ) {
...
V_25 = F_251 ( V_166 , V_472 , 0 ) ;
V_2 -> V_17 = F_252 ( & V_166 -> V_23 , V_25 ) ;
if ( F_253 ( V_2 -> V_17 ) ) {
V_466 = F_254 ( V_2 -> V_17 ) ;
goto V_466;
}
F_255 ( V_23 , & V_166 -> V_23 ) ;
F_256 ( & V_166 -> V_23 , V_23 ) ;
F_239 ( V_23 -> V_405 , V_464 ) ;
V_23 -> V_473 = 2 * V_474 ;
V_23 -> V_475 = & V_476 ;
V_23 -> V_477 = & V_478 ;
V_2 -> V_60 = F_257 ( - 1 , V_479 ) ;
V_23 -> V_480 |= V_481 | V_53 |
V_54 | V_43 ;
V_2 -> V_482 = true ;
V_466 = F_258 ( & V_166 -> V_23 , V_2 -> V_470 , F_199 , 0 ,
V_23 -> V_408 , V_2 ) ;
if ( ! V_466 )
F_259 ( & V_166 -> V_23 , 1 ) ;
V_23 -> V_483 += 64 ;
...
V_2 -> V_402 = F_261 ( & V_2 -> V_166 -> V_23 , L_58 ) ;
if ( F_253 ( V_2 -> V_402 ) ) {
F_262 ( & V_2 -> V_166 -> V_23 , L_59 ) ;
V_2 -> V_402 = NULL ;
}
F_55 ( V_2 -> V_402 ) ;
F_240 ( V_2 ) ;
F_263 ( & V_2 -> V_386 ) ;
V_2 -> V_245 = V_322 ;
F_264 ( & V_2 -> V_368 , F_189 ) ;
V_2 -> V_486 = F_261 ( & V_2 -> V_166 -> V_23 , L_60 ) ;
if ( F_253 ( V_2 -> V_486 ) ) {
F_262 ( & V_2 -> V_166 -> V_23 , L_61 ) ;
V_2 -> V_486 = NULL ;
}
V_2 -> V_116 = F_261 ( & V_2 -> V_166 -> V_23 , L_62 ) ;
if ( F_253 ( V_2 -> V_116 ) ) {
F_262 ( & V_2 -> V_166 -> V_23 , L_63 ) ;
V_2 -> V_116 = NULL ;
}
V_466 = F_152 ( V_2 ) ;
if ( V_466 )
...
static int F_271 ( struct V_455 * V_166 )
{
struct V_1 * V_2 = F_22 ( & V_166 -> V_23 ) ;
F_256 ( & V_166 -> V_23 , NULL ) ;
F_272 ( V_2 -> V_23 ) ;
F_273 ( V_2 -> V_23 ) ;
F_270 ( V_2 -> V_23 ) ;
return 0 ;
