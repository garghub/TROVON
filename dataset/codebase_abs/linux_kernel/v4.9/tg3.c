...
static struct V_1952 * F_601 ( struct V_359 * V_111 ,
...
int V_75 ;
bool V_1533 = false ;
if ( V_2231 < V_2232 || V_2231 > F_468 ( V_5 ) )
return - V_64 ;
if ( ! F_146 ( V_111 ) ) {
...
return;
V_2233 = 0x10 ;
while ( V_2233 < V_5 -> V_1970 ) {
if ( F_170 ( V_5 , V_2233 , & V_7 ) != 0 )
return;
if ( V_7 == V_1978 )
break;
V_2233 <<= 1 ;
...
static void F_610 ( struct V_4 * V_5 , T_1 V_2256 )
{
switch ( V_2256 & V_2257 ) {
case V_2258 :
V_5 -> V_610 = 256 ;
break;
case V_2259 :
...
if ( V_2236 == V_2273 ||
V_2236 == V_2276 )
V_5 -> V_1970 = ( V_2272 ? 0x3e200 :
V_2235 ) ;
else if ( V_2236 == V_2274 )
V_5 -> V_1970 = ( V_2272 ? 0x1f200 :
V_2277 ) ;
else
V_5 -> V_1970 = ( V_2272 ? 0x1f200 :
V_2278 ) ;
...
static struct V_2369 * F_620 ( struct V_4 * V_5 )
{
int V_42 ;
for ( V_42 = 0 ; V_42 < F_582 ( V_2370 ) ; V_42 ++ ) {
if ( ( V_2370 [ V_42 ] . V_2371 ==
V_5 -> V_12 -> V_2372 ) &&
( V_2370 [ V_42 ] . V_2373 ==
V_5 -> V_12 -> V_2374 ) )
return & V_2370 [ V_42 ] ;
...
if ( V_7 == V_1432 ) {
T_1 V_1433 , V_2381 ;
T_1 V_2382 = 0 , V_2383 = 0 , V_2384 = 0 ;
T_1 V_2385 , V_2386 , V_2387 ;
int V_2388 = 0 ;
F_32 ( V_5 , V_1434 , & V_1433 ) ;
V_5 -> V_545 = V_1433 ;
F_32 ( V_5 , V_2389 , & V_2386 ) ;
V_2386 >>= V_2390 ;
if ( F_30 ( V_5 ) != V_531 &&
F_30 ( V_5 ) != V_532 &&
F_30 ( V_5 ) != V_494 &&
( V_2386 > 0 ) && ( V_2386 < 0x100 ) )
...
F_30 ( V_5 ) == V_472 ||
F_30 ( V_5 ) == V_528 )
F_32 ( V_5 , V_2393 , & V_2384 ) ;
if ( ( V_1433 & V_2394 ) ==
V_2395 )
V_2388 = 1 ;
F_32 ( V_5 , V_2396 , & V_2385 ) ;
if ( V_2385 != 0 ) {
T_1 V_2397 = V_2385 & V_2398 ;
T_1 V_2399 = V_2385 & V_2400 ;
V_2387 = ( V_2397 >> 16 ) << 10 ;
V_2387 |= ( V_2399 & 0xfc00 ) << 16 ;
V_2387 |= ( V_2399 & 0x03ff ) << 0 ;
} else
V_2387 = 0 ;
V_5 -> V_215 = V_2387 ;
if ( V_2388 ) {
...
if ( F_23 ( V_5 , 5750_PLUS ) )
V_2381 = V_2382 & ( V_2401 |
V_2402 ) ;
else
V_2381 = V_1433 & V_2401 ;
switch ( V_2381 ) {
default:
case V_2403 :
V_5 -> V_558 = V_816 ;
...
if ( ( V_5 -> V_12 -> V_2372 ==
V_2418 ) &&
( V_5 -> V_12 -> V_2374 == 0x205a ||
V_5 -> V_12 -> V_2374 == 0x2063 ) )
F_86 ( V_5 , V_638 ) ;
} else {
F_86 ( V_5 , V_638 ) ;
F_84 ( V_5 , V_527 ) ;
...
{
int V_42 , V_75 ;
T_1 V_2429 , V_6 = V_590 * 8 ;
V_75 = F_159 ( V_5 ) ;
if ( V_75 )
return V_75 ;
F_11 ( V_5 , V_2430 , V_6 | V_2431 ) ;
F_11 ( V_5 , V_2432 , V_2433 |
V_2434 | V_2435 ) ;
F_12 ( V_5 , V_2432 ) ;
F_24 ( 10 ) ;
for ( V_42 = 0 ; V_42 < 100 ; V_42 ++ ) {
V_2429 = F_12 ( V_5 , V_2436 ) ;
if ( V_2429 & V_2437 ) {
* V_7 = F_12 ( V_5 , V_2438 ) ;
break;
}
...
return 0 ;
V_2443 = F_33 ( V_2451 ) ;
return ( ( V_2444 & 0x0000ffff ) << 16 ) | ( V_2443 >> 16 ) ;
}
...
V_75 = 0 ;
if ( F_23 ( V_5 , V_303 ) || F_23 ( V_5 , V_60 ) ) {
V_2455 = V_2456 = V_2375 ;
} else {
V_75 |= F_57 ( V_5 , V_2457 , & V_2453 ) ;
V_75 |= F_57 ( V_5 , V_2458 , & V_2454 ) ;
V_2455 = ( V_2453 & 0xffff ) << 10 ;
V_2455 |= ( V_2454 & 0xfc00 ) << 16 ;
V_2455 |= ( V_2454 & 0x03ff ) << 0 ;
V_2456 = V_2455 & V_395 ;
}
if ( ! V_75 && F_628 ( V_2456 ) ) {
V_5 -> V_215 = V_2455 ;
if ( V_2456 == V_936 )
V_5 -> V_178 |= V_562 ;
else
...
{
T_4 * V_2462 ;
unsigned int V_2463 , V_2464 , V_74 ;
T_1 V_2068 ;
int V_622 , V_42 = 0 ;
V_2462 = ( T_4 * ) F_565 ( V_5 , & V_2068 ) ;
if ( ! V_2462 )
goto V_2465;
V_42 = F_570 ( V_2462 , 0 , V_2068 , V_2111 ) ;
if ( V_42 < 0 )
goto V_2466;
V_2464 = F_571 ( & V_2462 [ V_42 ] ) ;
V_2463 = V_42 + V_2112 + V_2464 ;
V_42 += V_2112 ;
if ( V_2463 > V_2068 )
goto V_2466;
V_622 = F_572 ( V_2462 , V_42 , V_2464 ,
V_2467 ) ;
if ( V_622 > 0 ) {
V_74 = F_630 ( & V_2462 [ V_622 ] ) ;
V_622 += V_2114 ;
if ( V_622 + V_74 > V_2463 || V_74 != 4 ||
memcmp ( & V_2462 [ V_622 ] , L_82 , 4 ) )
goto V_2468;
V_622 = F_572 ( V_2462 , V_42 , V_2464 ,
V_2469 ) ;
if ( V_622 < 0 )
...
V_2468:
V_42 = F_572 ( V_2462 , V_42 , V_2464 ,
V_2470 ) ;
if ( V_42 < 0 )
goto V_2466;
V_74 = F_630 ( & V_2462 [ V_42 ] ) ;
V_42 += V_2114 ;
if ( V_74 > V_2471 ||
( V_74 + V_42 ) > V_2068 )
goto V_2466;
memcpy ( V_5 -> V_2472 , & V_2462 [ V_42 ] , V_74 ) ;
V_2466:
F_177 ( V_2462 ) ;
if ( V_5 -> V_2472 [ 0 ] )
return;
V_2465:
if ( F_30 ( V_5 ) == V_471 ) {
if ( V_5 -> V_12 -> V_538 == V_2473 ||
V_5 -> V_12 -> V_538 == V_2474 )
strcpy ( V_5 -> V_2472 , L_84 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2475 )
strcpy ( V_5 -> V_2472 , L_85 ) ;
else
goto V_2476;
} else if ( F_30 ( V_5 ) == V_1406 ) {
if ( V_5 -> V_12 -> V_538 == V_2477 )
strcpy ( V_5 -> V_2472 , L_86 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2478 )
strcpy ( V_5 -> V_2472 , L_87 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2479 )
strcpy ( V_5 -> V_2472 , L_88 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2480 )
strcpy ( V_5 -> V_2472 , L_89 ) ;
else
goto V_2476;
} else if ( F_30 ( V_5 ) == V_760 ) {
if ( V_5 -> V_12 -> V_538 == V_2481 )
strcpy ( V_5 -> V_2472 , L_90 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2482 )
strcpy ( V_5 -> V_2472 , L_91 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2483 )
strcpy ( V_5 -> V_2472 , L_92 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2484 )
strcpy ( V_5 -> V_2472 , L_93 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2485 )
strcpy ( V_5 -> V_2472 , L_94 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2486 )
strcpy ( V_5 -> V_2472 , L_95 ) ;
else
goto V_2476;
} else if ( F_30 ( V_5 ) == V_662 ) {
if ( V_5 -> V_12 -> V_538 == V_2487 )
strcpy ( V_5 -> V_2472 , L_96 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2488 )
strcpy ( V_5 -> V_2472 , L_97 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2489 )
strcpy ( V_5 -> V_2472 , L_98 ) ;
else if ( V_5 -> V_12 -> V_538 == V_2490 )
strcpy ( V_5 -> V_2472 , L_99 ) ;
else
goto V_2476;
} else if ( F_30 ( V_5 ) == V_36 ) {
strcpy ( V_5 -> V_2472 , L_100 ) ;
} else {
V_2476:
strcpy ( V_5 -> V_2472 , L_101 ) ;
}
}
...
V_2492 = strlen ( V_5 -> V_2012 ) ;
if ( V_2493 ) {
if ( V_2494 - V_2492 < 16 ||
F_170 ( V_5 , V_590 + 8 , & V_2491 ) )
return;
V_590 = V_590 + V_2491 - V_1023 ;
for ( V_42 = 0 ; V_42 < 16 ; V_42 += 4 ) {
T_5 V_619 ;
if ( F_171 ( V_5 , V_590 + V_42 , & V_619 ) )
return;
memcpy ( V_5 -> V_2012 + V_2492 + V_42 , & V_619 , sizeof( V_619 ) ) ;
}
} else {
T_1 V_2495 , V_2496 ;
if ( F_170 ( V_5 , V_2497 , & V_2491 ) )
return;
V_2495 = ( V_2491 & V_2498 ) >>
V_2499 ;
V_2496 = V_2491 & V_2500 ;
snprintf ( & V_5 -> V_2012 [ V_2492 ] , V_2494 - V_2492 ,
L_102 , V_2495 , V_2496 ) ;
}
}
static void F_633 ( struct V_4 * V_5 )
{
T_1 V_7 , V_2495 , V_2496 ;
if ( F_170 ( V_5 , V_2501 , & V_7 ) )
return;
V_2495 = ( V_7 & V_2502 ) >>
V_2503 ;
V_2496 = ( V_7 & V_2504 ) >>
V_2505 ;
snprintf ( & V_5 -> V_2012 [ 0 ] , 32 , L_103 , V_2495 , V_2496 ) ;
}
static void F_634 ( struct V_4 * V_5 , T_1 V_7 )
{
T_1 V_590 , V_2495 , V_2496 , V_2506 ;
strncat ( V_5 -> V_2012 , L_104 , V_2494 - strlen ( V_5 -> V_2012 ) - 1 ) ;
...
V_2516 ;
V_2496 = V_7 & V_2517 ;
if ( V_2496 > 99 || V_2506 > 26 )
return;
V_590 = strlen ( V_5 -> V_2012 ) ;
snprintf ( & V_5 -> V_2012 [ V_590 ] , V_2494 - V_590 ,
L_105 , V_2495 , V_2496 ) ;
if ( V_2506 > 0 ) {
V_590 = strlen ( V_5 -> V_2012 ) ;
if ( V_590 < V_2494 - 1 )
V_5 -> V_2012 [ V_590 ] = 'a' + V_2506 - 1 ;
}
}
...
return;
V_590 += sizeof( V_619 ) ;
if ( V_2518 > V_2494 - sizeof( V_619 ) ) {
memcpy ( & V_5 -> V_2012 [ V_2518 ] , & V_619 , V_2494 - V_2518 ) ;
break;
}
memcpy ( & V_5 -> V_2012 [ V_2518 ] , & V_619 , sizeof( V_619 ) ) ;
V_2518 += sizeof( V_619 ) ;
}
}
...
T_1 V_69 ;
char * V_2522 ;
V_69 = F_12 ( V_5 , V_2523 ) ;
if ( F_23 ( V_5 , V_79 ) )
V_2522 = L_106 ;
else if ( V_5 -> V_12 -> V_538 == V_2524 )
V_2522 = L_107 ;
else
V_2522 = L_108 ;
V_2518 = strlen ( V_5 -> V_2012 ) ;
snprintf ( & V_5 -> V_2012 [ V_2518 ] , V_2494 - V_2518 , L_109 ,
V_2522 ,
( V_69 & V_2525 ) >> V_2526 ,
( V_69 & V_2527 ) >> V_2528 ,
( V_69 & V_2529 ) >> V_2530 ,
...
if ( F_30 ( V_5 ) != V_762 )
return;
if ( ! F_623 ( V_5 , V_2532 , & V_7 ) &&
! F_623 ( V_5 , V_2532 + 4 , & V_2429 ) &&
F_639 ( V_7 ) ) {
T_6 V_2533 = ( T_6 ) V_7 << 32 | V_2429 ;
T_1 V_2386 = 0 ;
int V_42 , V_2518 ;
...
V_2518 = strlen ( V_5 -> V_2012 ) ;
snprintf ( & V_5 -> V_2012 [ V_2518 ] , V_2494 - V_2518 , L_110 , V_2386 ) ;
}
}
...
{
struct V_1786 * V_2538 ;
unsigned int V_2539 , V_2540 = V_5 -> V_12 -> V_273 & ~ 7 ;
for ( V_2539 = 0 ; V_2539 < 8 ; V_2539 ++ ) {
V_2538 = F_643 ( V_5 -> V_12 -> V_271 , V_2540 | V_2539 ) ;
if ( V_2538 && V_2538 != V_5 -> V_12 )
break;
F_644 ( V_2538 ) ;
}
if ( ! V_2538 ) {
...
static void F_645 ( struct V_4 * V_5 , T_1 V_2541 )
{
V_5 -> V_2542 = V_2541 >> V_2543 ;
if ( F_30 ( V_5 ) == V_2544 ) {
T_1 V_161 ;
F_84 ( V_5 , V_152 ) ;
if ( V_5 -> V_12 -> V_538 == V_2473 ||
V_5 -> V_12 -> V_538 == V_2474 ||
V_5 -> V_12 -> V_538 == V_2475 ||
V_5 -> V_12 -> V_538 == V_2545 ||
V_5 -> V_12 -> V_538 == V_2546 ||
V_5 -> V_12 -> V_538 == V_2547 ||
V_5 -> V_12 -> V_538 == V_2548 ||
V_5 -> V_12 -> V_538 == V_2549 ||
V_5 -> V_12 -> V_538 == V_2524 ||
...
V_161 = V_2554 ;
F_19 ( V_5 -> V_12 , V_161 , & V_5 -> V_2542 ) ;
}
if ( F_77 ( V_5 ) == V_2555 )
V_5 -> V_2542 = V_2556 ;
if ( F_77 ( V_5 ) == V_2557 )
...
const struct V_2558 * V_2559 )
{
T_1 V_2560 = F_33 ( V_492 ) & V_2561 ;
if ( ( F_30 ( V_5 ) == V_494 &&
( V_2560 == 0x8000 || V_2560 == 0x4000 ) ) ||
( V_5 -> V_178 & V_179 ) )
return true ;
if ( V_2559 -> V_2562 & V_2563 ) {
if ( F_30 ( V_5 ) == V_496 ) {
if ( V_2559 -> V_2562 & V_2564 )
return true ;
} else {
return true ;
}
...
static int F_647 ( struct V_4 * V_5 , const struct V_2558 * V_2559 )
{
T_1 V_2541 ;
T_1 V_2565 , V_2560 ;
T_1 V_7 ;
...
struct V_2569 * V_2579 = & V_2572 [ 0 ] ;
struct V_1786 * V_2580 = NULL ;
while ( V_2579 -> V_2570 != 0 ) {
V_2580 = F_648 ( V_2579 -> V_2570 , V_2579 -> V_538 ,
V_2580 ) ;
if ( ! V_2580 ) {
V_2579 ++ ;
continue;
}
if ( V_2579 -> V_2571 != V_2575 ) {
if ( V_2580 -> V_2581 > V_2579 -> V_2571 )
continue;
}
if ( V_2580 -> V_2582 &&
( V_2580 -> V_2582 -> V_272 ==
...
struct V_2569 * V_2579 = & V_2583 [ 0 ] ;
struct V_1786 * V_2580 = NULL ;
while ( V_2579 -> V_2570 != 0 ) {
V_2580 = F_648 ( V_2579 -> V_2570 ,
V_2579 -> V_538 ,
V_2580 ) ;
if ( ! V_2580 ) {
V_2579 ++ ;
...
F_23 ( V_5 , 5780_CLASS ) ) {
V_5 -> V_1392 = F_650 ( V_5 -> V_12 , V_2599 ) ;
if ( ! V_5 -> V_1392 ) {
F_117 ( & V_5 -> V_12 -> V_111 ,
L_111 ) ;
return - V_210 ;
...
F_30 ( V_5 ) == V_528 ) {
F_32 ( V_5 , V_2613 , & V_7 ) ;
if ( ( V_7 & V_2614 ) != V_2615 )
V_7 = F_33 ( V_1863 ) ;
if ( F_30 ( V_5 ) == V_471 )
V_5 -> V_54 = ( V_7 & V_2616 ) ? 1 : 0 ;
else
V_5 -> V_54 = ( V_7 & V_2617 ) >>
V_2618 ;
}
...
F_30 ( V_5 ) == V_408 ||
F_30 ( V_5 ) == V_45 ) {
if ( V_5 -> V_12 -> V_538 != V_2623 &&
V_5 -> V_12 -> V_538 != V_2624 )
V_5 -> V_178 |= V_512 ;
if ( V_5 -> V_12 -> V_538 == V_2625 )
V_5 -> V_178 |= V_513 ;
} else
V_5 -> V_178 |= V_511 ;
}
...
F_77 ( V_5 ) == V_2637 ) {
void T_2 * V_2638 ;
V_2638 = V_5 -> V_8 + V_2639 + V_37 ;
F_8 ( 0x00000000 , V_2638 ) ;
F_8 ( 0x00000000 , V_2638 + 4 ) ;
F_8 ( 0xffffffff , V_2638 + 4 ) ;
if ( F_10 ( V_2638 ) != 0x00000000 )
F_84 ( V_5 , V_25 ) ;
}
}
F_24 ( 50 ) ;
...
struct V_359 * V_111 = V_5 -> V_111 ;
struct V_1786 * V_12 = V_5 -> V_12 ;
struct V_2650 * V_2019 = F_657 ( V_12 ) ;
...
{
struct V_359 * V_111 = V_5 -> V_111 ;
memcpy ( V_111 -> V_689 , V_2651 -> V_2652 , V_1526 ) ;
return 0 ;
}
static int F_660 ( struct V_4 * V_5 )
{
struct V_359 * V_111 = V_5 -> V_111 ;
T_1 V_2653 , V_2654 , V_2655 ;
int V_2656 = 0 ;
int V_75 ;
#ifdef F_661
if ( ! F_656 ( V_5 ) )
...
if ( ( V_2653 >> 16 ) == 0x484b ) {
V_111 -> V_689 [ 0 ] = ( V_2653 >> 8 ) & 0xff ;
V_111 -> V_689 [ 1 ] = ( V_2653 >> 0 ) & 0xff ;
F_32 ( V_5 , V_2659 , & V_2654 ) ;
V_111 -> V_689 [ 2 ] = ( V_2654 >> 24 ) & 0xff ;
V_111 -> V_689 [ 3 ] = ( V_2654 >> 16 ) & 0xff ;
V_111 -> V_689 [ 4 ] = ( V_2654 >> 8 ) & 0xff ;
V_111 -> V_689 [ 5 ] = ( V_2654 >> 0 ) & 0xff ;
V_2656 = F_439 ( & V_111 -> V_689 [ 0 ] ) ;
}
if ( ! V_2656 ) {
if ( ! F_23 ( V_5 , V_676 ) &&
! F_171 ( V_5 , V_2655 + 0 , & V_2653 ) &&
! F_171 ( V_5 , V_2655 + 4 , & V_2654 ) ) {
memcpy ( & V_111 -> V_689 [ 0 ] , ( ( char * ) & V_2653 ) + 2 , 2 ) ;
memcpy ( & V_111 -> V_689 [ 2 ] , ( char * ) & V_2654 , sizeof( V_2654 ) ) ;
}
else {
V_2653 = F_33 ( V_684 ) ;
V_2654 = F_33 ( V_685 ) ;
V_111 -> V_689 [ 5 ] = V_2654 & 0xff ;
V_111 -> V_689 [ 4 ] = ( V_2654 >> 8 ) & 0xff ;
V_111 -> V_689 [ 3 ] = ( V_2654 >> 16 ) & 0xff ;
V_111 -> V_689 [ 2 ] = ( V_2654 >> 24 ) & 0xff ;
V_111 -> V_689 [ 1 ] = V_2653 & 0xff ;
V_111 -> V_689 [ 0 ] = ( V_2653 >> 8 ) & 0xff ;
}
}
...
! F_23 ( V_5 , V_1074 ) )
goto V_497;
#if F_362 ( V_2663 ) || F_362 ( V_2664 ) || F_362 ( V_2665 )
V_2662 = V_2666 ;
#else
#if F_362 ( V_2667 ) || F_362 ( V_2668 )
V_2662 = V_2669 ;
#else
V_2662 = 0 ;
#endif
...
static int F_664 ( struct V_4 * V_5 , T_1 * V_621 , T_9 V_2693 ,
int V_629 , bool V_2694 )
{
struct V_2695 V_2696 ;
T_1 V_2697 ;
int V_42 , V_56 ;
V_2697 = V_1592 ;
F_46 ( V_2698 , 0 ) ;
...
F_46 ( V_1059 , 0 ) ;
F_46 ( V_1069 , 0 ) ;
V_2696 . V_1143 = ( ( T_6 ) V_2693 ) >> 32 ;
V_2696 . V_1144 = V_2693 & 0xffffffff ;
V_2696 . V_2700 = 0x00002100 ;
V_2696 . V_74 = V_629 ;
if ( V_2694 ) {
V_2696 . V_2701 = ( 13 << 8 ) | 2 ;
F_31 ( V_1060 , V_1371 ) ;
F_24 ( 40 ) ;
} else {
V_2696 . V_2701 = ( 16 << 8 ) | 7 ;
F_31 ( V_1061 , V_1375 ) ;
F_24 ( 40 ) ;
}
V_2696 . V_10 = 0x00000005 ;
for ( V_42 = 0 ; V_42 < ( sizeof( V_2696 ) / sizeof( T_1 ) ) ; V_42 ++ ) {
T_1 V_7 ;
V_7 = * ( ( ( T_1 * ) & V_2696 ) + V_42 ) ;
F_15 ( V_5 -> V_12 , V_40 ,
V_2697 + ( V_42 * sizeof( T_1 ) ) ) ;
F_15 ( V_5 -> V_12 , V_41 , V_7 ) ;
}
F_15 ( V_5 -> V_12 , V_40 , 0 ) ;
if ( V_2694 )
...
T_1 * V_621 , V_2704 ;
int V_56 = 0 ;
V_621 = F_410 ( & V_5 -> V_12 -> V_111 , V_2705 ,
& V_2693 , V_627 ) ;
if ( ! V_621 ) {
V_56 = - V_267 ;
goto V_2706;
}
V_5 -> V_1575 = ( ( 0x7 << V_2707 ) |
( 0x6 << V_2708 ) ) ;
...
if ( F_30 ( V_5 ) == V_494 ||
F_30 ( V_5 ) == V_495 ) {
T_1 V_2709 = ( F_33 ( V_153 ) & 0x1f ) ;
T_1 V_2710 = 0x7 ;
if ( F_23 ( V_5 , 40BIT_DMA_BUG ) &&
F_30 ( V_5 ) == V_495 )
V_5 -> V_1575 |= 0x8000 ;
else if ( V_2709 == 0x6 || V_2709 == 0x7 )
V_5 -> V_1575 |= V_2711 ;
if ( F_30 ( V_5 ) == V_494 )
V_2710 = 4 ;
V_5 -> V_1575 |=
...
for ( V_42 = 0 ; V_42 < V_2705 / sizeof( T_1 ) ; V_42 ++ )
V_1441 [ V_42 ] = V_42 ;
V_56 = F_664 ( V_5 , V_621 , V_2693 , V_2705 , true ) ;
if ( V_56 ) {
F_117 ( & V_5 -> V_12 -> V_111 ,
L_114 ,
V_652 , V_56 ) ;
...
V_56 = F_664 ( V_5 , V_621 , V_2693 , V_2705 , false ) ;
if ( V_56 ) {
...
V_497:
F_408 ( & V_5 -> V_12 -> V_111 , V_2705 , V_621 , V_2693 ) ;
V_2706:
return V_56 ;
}
...
V_5 -> V_1598 . V_1608 = V_2737 ;
V_5 -> V_1598 . V_1610 = V_2738 ;
}
static char * F_667 ( struct V_4 * V_5 )
{
switch ( V_5 -> V_215 & V_395 ) {
case V_2739 : return L_119 ;
case V_396 : return L_120 ;
case V_560 : return L_121 ;
case V_2740 : return L_122 ;
case V_2741 : return L_123 ;
case V_2742 : return L_124 ;
case V_2743 : return L_125 ;
case V_2744 : return L_126 ;
case V_2745 : return L_127 ;
case V_2746 : return L_128 ;
case V_2747 : return L_129 ;
case V_2748 : return L_130 ;
case V_2749 : return L_131 ;
case V_2750 : return L_132 ;
case V_2751 : return L_133 ;
case V_2752 : return L_134 ;
case V_2753 : return L_135 ;
case V_2754 : return L_136 ;
case V_2755 : return L_137 ;
case V_2756 : return L_138 ;
case V_2757 : return L_139 ;
case V_2758 : return L_140 ;
case V_2759 : return L_141 ;
case V_936 : return L_142 ;
case 0 : return L_143 ;
default: return L_144 ;
}
}
static char * F_668 ( struct V_4 * V_5 , char * V_2760 )
{
if ( F_23 ( V_5 , V_1074 ) ) {
strcpy ( V_2760 , L_145 ) ;
return V_2760 ;
...
V_1460 -> V_637 = V_2762 ;
V_1460 -> V_1471 = V_2763 ;
V_1460 -> V_1462 = V_2764 ;
V_1460 -> V_1473 = V_2765 ;
V_1460 -> V_1464 = V_2766 ;
V_1460 -> V_1479 = V_2767 ;
V_1460 -> V_1481 = V_2768 ;
V_1460 -> V_1475 = V_2769 ;
V_1460 -> V_1466 = V_2770 ;
V_1460 -> V_968 = V_2771 ;
if ( V_5 -> V_127 & ( V_2642 |
V_2643 ) ) {
V_1460 -> V_1471 = V_2772 ;
V_1460 -> V_1479 = V_2773 ;
V_1460 -> V_1462 = V_2774 ;
V_1460 -> V_1481 = V_2775 ;
}
if ( F_23 ( V_5 , 5705_PLUS ) ) {
V_1460 -> V_1479 = 0 ;
V_1460 -> V_1481 = 0 ;
...
struct V_4 * V_5 ;
int V_42 , V_75 ;
T_1 V_2776 , V_2777 , V_2778 ;
char V_2760 [ 40 ] ;
T_6 V_2779 , V_2780 ;
T_15 V_1184 = 0 ;
F_671 ( V_2781 L_155 , V_1969 ) ;
V_75 = F_672 ( V_12 ) ;
if ( V_75 ) {
...
if ( F_23 ( V_5 , V_1643 ) )
V_2780 = V_2779 = F_363 ( 32 ) ;
else if ( F_23 ( V_5 , 40BIT_DMA_BUG ) ) {
V_2780 = V_2779 = F_363 ( 40 ) ;
#ifdef V_1240
V_2779 = F_363 ( 64 ) ;
#endif
} else
V_2780 = V_2779 = F_363 ( 64 ) ;
if ( V_2779 > F_363 ( 32 ) ) {
V_75 = F_686 ( V_12 , V_2779 ) ;
if ( ! V_75 ) {
V_1184 |= V_2810 ;
V_75 = F_687 ( V_12 ,
V_2780 ) ;
...
F_98 ( V_111 , L_174 ,
V_5 -> V_1575 ,
V_12 -> V_2779 == F_363 ( 32 ) ? 32 :
( ( T_6 ) V_12 -> V_2779 ) == F_363 ( 40 ) ? 40 : 64 ) ;
F_691 ( V_12 ) ;
return 0 ;
V_2809:
if ( V_5 -> V_9 ) {
...
T_22 V_843 )
{
struct V_359 * V_2829 = F_154 ( V_12 ) ;
struct V_4 * V_5 = F_111 ( V_2829 ) ;
T_21 V_75 = V_2830 ;
F_98 ( V_2829 , L_175 ) ;
F_492 () ;
if ( ! V_2829 || ! F_146 ( V_2829 ) )
goto V_186;
if ( V_843 == V_2831 )
V_5 -> V_1906 = true ;
F_124 ( V_5 ) ;
...
V_623 = V_2834 ;
V_186:
if ( V_623 != V_2834 && V_2829 && F_146 ( V_2829 ) ) {
F_337 ( V_5 ) ;
F_490 ( V_2829 ) ;
}
F_493 () ;
