...
T_3 V_218 , V_34 ;
V_197 = L_286 ;
V_218 = F_2 ( L_78 , 1 , 1 , F_4 ( V_197 ) ) ;
if ( ! F_44 ( V_218 ) )
return;
if ( F_14 ( V_218 , L_287 ) != V_10 )
return;
F_10 ( L_288 ) ;
F_17 ( V_218 , V_197 , L_287 , & V_16 , 0 ) ;
V_217 = L_289 ;
V_34 = F_2 ( L_78 , 1 , 1 , F_4 ( V_217 ) ) ;
V_212 = F_4 ( V_218 ) ;
for( ; F_12 ( & V_34 ) ; ) {
if ( ! F_44 ( V_34 ) )
continue;
V_216 = F_14 ( V_34 , L_238 ) ;
if ( V_216 == 0 || V_216 == V_10 )
continue;
F_13 ( V_34 , L_238 , & V_211 , sizeof( V_211 ) ) ;
...
if ( V_211 [ 0 ] == 222 )
V_211 [ 0 ] = 8 ;
F_17 ( V_34 , V_217 , L_238 , V_211 ,
sizeof( V_211 ) ) ;
F_17 ( V_34 , V_217 , L_246 , & V_212 ,
sizeof( V_212 ) ) ;
}
V_197 = L_290 ;
V_218 = F_2 ( L_78 , 1 , 1 , F_4 ( V_197 ) ) ;
...
return;
F_10 ( L_291 ) ;
F_17 ( V_218 , V_197 , L_25 , L_292 , sizeof( L_292 ) ) ;
}
...
return;
V_219 = F_5 ( V_216 ) ;
V_220 = F_2 ( L_185 , 1 , 1 , V_219 ) ;
F_13 ( V_220 , L_67 , & V_216 , sizeof( V_216 ) ) ;
V_15 . V_131 = F_5 ( V_216 ) ;
F_26 ( L_293 , V_15 . V_131 ) ;
}
...
if ( V_58 ) {
T_9 V_16 = F_37 ( V_58 ) ;
F_17 ( V_15 . V_54 , L_171 , L_301 ,
& V_16 , sizeof( V_16 ) ) ;
}
#ifdef F_23
if ( V_56 )
F_17 ( V_15 . V_54 , L_171 , L_302 ,
NULL , 0 ) ;
if ( V_57 )
F_17 ( V_15 . V_54 , L_171 , L_303 ,
NULL , 0 ) ;
if ( V_119 ) {
F_17 ( V_15 . V_54 , L_171 , L_304 ,
& V_119 ,
sizeof( V_119 ) ) ;
F_17 ( V_15 . V_54 , L_171 , L_305 ,
& V_120 ,
sizeof( V_120 ) ) ;
}
#endif
