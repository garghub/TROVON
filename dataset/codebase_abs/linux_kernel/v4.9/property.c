...
int F_35 ( struct V_64 * V_18 ,
const char * V_60 , T_4 V_68 , T_4 V_69 ,
struct V_70 * args )
{
...
T_5 V_76 , V_27 ;
if ( V_71 -> type == V_40 ) {
V_26 = F_36 ( V_71 -> V_75 . V_11 ,
& V_73 ) ;
if ( V_26 )
return - V_77 ;
V_76 = 0 ;
V_71 ++ ;
for ( V_27 = 0 ; V_71 + V_27 < V_72 && V_27 < V_69 ; V_27 ++ ) {
...
static int F_37 ( struct V_31 * V_20 ,
const char * V_60 ,
...
return - V_87 ;
* ( V_88 * ) V_83 = V_58 -> integer . V_37 ;
break;
case V_89 :
if ( V_58 -> integer . V_37 > V_90 )
return - V_87 ;
* ( V_91 * ) V_83 = V_58 -> integer . V_37 ;
break;
case V_92 :
if ( V_58 -> integer . V_37 > V_93 )
return - V_87 ;
* ( T_5 * ) V_83 = V_58 -> integer . V_37 ;
break;
default:
* ( V_94 * ) V_83 = V_58 -> integer . V_37 ;
break;
}
} else if ( V_82 == V_95 ) {
...
if ( V_26 )
return V_26 ;
* ( char * * ) V_83 = V_58 -> string . V_17 ;
} else {
V_26 = - V_59 ;
}
return V_26 ;
}
int F_38 ( struct V_43 * V_44 , const char * V_60 ,
enum V_81 V_82 , void * V_83 )
{
return V_44 ? F_37 ( & V_44 -> V_20 , V_60 , V_82 , V_83 ) : - V_59 ;
}
static int F_39 ( const union V_2 * V_96 , V_88 * V_83 ,
T_4 V_97 )
{
int V_27 ;
for ( V_27 = 0 ; V_27 < V_97 ; V_27 ++ ) {
if ( V_96 [ V_27 ] . type != V_39 )
return - V_63 ;
if ( V_96 [ V_27 ] . integer . V_37 > V_86 )
return - V_87 ;
V_83 [ V_27 ] = V_96 [ V_27 ] . integer . V_37 ;
}
return 0 ;
}
static int F_40 ( const union V_2 * V_96 ,
V_91 * V_83 , T_4 V_97 )
{
int V_27 ;
for ( V_27 = 0 ; V_27 < V_97 ; V_27 ++ ) {
if ( V_96 [ V_27 ] . type != V_39 )
return - V_63 ;
if ( V_96 [ V_27 ] . integer . V_37 > V_90 )
return - V_87 ;
V_83 [ V_27 ] = V_96 [ V_27 ] . integer . V_37 ;
}
return 0 ;
}
static int F_41 ( const union V_2 * V_96 ,
T_5 * V_83 , T_4 V_97 )
{
int V_27 ;
for ( V_27 = 0 ; V_27 < V_97 ; V_27 ++ ) {
if ( V_96 [ V_27 ] . type != V_39 )
return - V_63 ;
if ( V_96 [ V_27 ] . integer . V_37 > V_93 )
return - V_87 ;
V_83 [ V_27 ] = V_96 [ V_27 ] . integer . V_37 ;
}
return 0 ;
}
static int F_42 ( const union V_2 * V_96 ,
V_94 * V_83 , T_4 V_97 )
{
int V_27 ;
for ( V_27 = 0 ; V_27 < V_97 ; V_27 ++ ) {
...
static int F_43 ( const union V_2 * V_96 ,
char * * V_83 , T_4 V_97 )
{
int V_27 ;
for ( V_27 = 0 ; V_27 < V_97 ; V_27 ++ ) {
if ( V_96 [ V_27 ] . type != V_29 )
return - V_63 ;
V_83 [ V_27 ] = V_96 [ V_27 ] . string . V_17 ;
}
return 0 ;
}
static int F_44 ( struct V_31 * V_20 ,
const char * V_60 ,
enum V_81 V_82 ,
void * V_83 , T_4 V_97 )
{
const union V_2 * V_58 ;
const union V_2 * V_96 ;
int V_26 ;
if ( V_83 && V_97 == 1 ) {
V_26 = F_37 ( V_20 , V_60 , V_82 , V_83 ) ;
if ( ! V_26 )
return V_26 ;
}
...
switch ( V_82 ) {
case V_84 :
V_26 = F_39 ( V_96 , ( V_88 * ) V_83 , V_97 ) ;
break;
case V_89 :
V_26 = F_40 ( V_96 , ( V_91 * ) V_83 , V_97 ) ;
break;
case V_92 :
V_26 = F_41 ( V_96 , ( T_5 * ) V_83 , V_97 ) ;
break;
case V_85 :
V_26 = F_42 ( V_96 , ( V_94 * ) V_83 , V_97 ) ;
break;
case V_95 :
V_26 = F_43 ( V_96 , ( char * * ) V_83 , V_97 ) ;
break;
default:
V_26 = - V_59 ;
break;
...
int F_45 ( struct V_43 * V_44 , const char * V_60 ,
enum V_81 V_82 , void * V_83 , T_4 V_97 )
{
return V_44 ? F_44 ( & V_44 -> V_20 , V_60 , V_82 , V_83 , V_97 ) : - V_59 ;
}
int F_46 ( struct V_64 * V_18 , const char * V_60 ,
enum V_81 V_82 , void * V_83 , T_4 V_97 )
{
return F_44 ( F_31 ( V_18 ) ,
V_60 , V_82 , V_83 , V_97 ) ;
}
struct V_64 * F_47 ( struct V_73 * V_98 ,
struct V_64 * V_99 )
{
struct V_43 * V_44 = F_48 ( V_98 ) ;
struct V_4 * V_100 , * V_56 ;
if ( ! V_44 )
return NULL ;
if ( ! V_99 || V_99 -> type == V_65 ) {
V_100 = & V_44 -> V_101 ;
if ( F_25 ( V_100 ) )
goto V_102;
if ( V_99 ) {
V_44 = F_32 ( V_99 ) ;
V_56 = V_44 -> V_103 . V_56 ;
if ( V_56 == V_100 ) {
V_99 = NULL ;
V_44 = F_48 ( V_98 ) ;
goto V_102;
}
V_44 = F_49 ( V_56 , struct V_43 , V_103 ) ;
} else {
V_44 = F_50 ( V_100 , struct V_43 , V_103 ) ;
}
return F_51 ( V_44 ) ;
}
V_102:
if ( ! V_99 || V_99 -> type == V_19 ) {
struct V_9 * V_10 ;
V_100 = & V_44 -> V_20 . V_21 ;
if ( F_25 ( V_100 ) )
return NULL ;
if ( V_99 ) {
V_10 = F_33 ( V_99 ) ;
...
if ( V_56 == V_100 )
return NULL ;
V_10 = F_49 ( V_56 , struct V_9 , V_24 ) ;
} else {
V_10 = F_50 ( V_100 , struct V_9 , V_24 ) ;
}
return & V_10 -> V_18 ;
}
return NULL ;
