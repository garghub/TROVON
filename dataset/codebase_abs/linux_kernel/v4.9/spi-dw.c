...
int V_10 ;
V_6 -> V_78 = 0 ;
V_6 -> V_46 = ( void * ) V_74 -> V_79 ;
V_6 -> V_45 = V_6 -> V_46 + V_74 -> V_9 ;
V_6 -> V_50 = V_74 -> V_80 ;
V_6 -> V_49 = V_6 -> V_50 + V_74 -> V_9 ;
V_6 -> V_9 = V_74 -> V_9 ;
F_36 ( V_6 , 0 ) ;
if ( V_74 -> V_81 != V_6 -> V_82 ) {
if ( V_74 -> V_81 != V_39 -> V_81 ) {
V_39 -> V_83 = ( F_37 ( V_6 -> V_84 , V_74 -> V_81 ) + 1 ) & 0xfffe ;
V_39 -> V_81 = V_74 -> V_81 ;
}
V_6 -> V_82 = V_74 -> V_81 ;
F_38 ( V_6 , V_39 -> V_83 ) ;
...
F_15 ( V_6 , V_15 , V_77 ) ;
if ( V_13 -> V_97 && V_13 -> V_97 ( V_13 , V_36 , V_74 ) )
V_6 -> V_78 = V_13 -> V_98 ;
F_30 ( V_6 , 0xff ) ;
if ( V_6 -> V_78 ) {
V_10 = V_6 -> V_99 -> V_100 ( V_6 , V_74 ) ;
if ( V_10 < 0 ) {
F_36 ( V_6 , 1 ) ;
return V_10 ;
}
...
static void F_39 ( struct V_70 * V_13 ,
struct V_103 * V_57 )
{
struct V_5 * V_6 = F_13 ( V_13 ) ;
if ( V_6 -> V_78 )
...
if ( V_106 ) {
if ( V_106 -> V_40 )
V_39 -> V_40 = V_106 -> V_40 ;
V_39 -> V_101 = V_106 -> V_101 ;
V_39 -> type = V_106 -> type ;
}
V_39 -> V_91 = V_93 ;
if ( F_42 ( V_36 -> V_108 ) ) {
V_10 = F_43 ( V_36 -> V_108 ,
! ( V_36 -> V_89 & V_109 ) ) ;
if ( V_10 )
return V_10 ;
}
...
static void F_45 ( struct V_110 * V_14 , struct V_5 * V_6 )
{
F_26 ( V_6 ) ;
if ( ! V_6 -> V_48 ) {
T_5 V_111 ;
for ( V_111 = 1 ; V_111 < 256 ; V_111 ++ ) {
F_15 ( V_6 , V_20 , V_111 ) ;
if ( V_111 != F_4 ( V_6 , V_20 ) )
break;
}
F_15 ( V_6 , V_20 , 0 ) ;
V_6 -> V_48 = ( V_111 == 1 ) ? 0 : V_111 ;
F_46 ( V_14 , L_22 , V_6 -> V_48 ) ;
}
}
int F_47 ( struct V_110 * V_14 , struct V_5 * V_6 )
{
struct V_70 * V_13 ;
int V_10 ;
F_48 ( V_6 == NULL ) ;
...
V_6 -> type = V_112 ;
V_6 -> V_113 = 0 ;
V_6 -> V_114 = ( V_115 ) ( V_6 -> V_116 + V_55 ) ;
snprintf ( V_6 -> V_117 , sizeof( V_6 -> V_117 ) , L_23 , V_6 -> V_118 ) ;
V_10 = F_50 ( V_6 -> V_68 , F_32 , V_119 , V_6 -> V_117 , V_13 ) ;
if ( V_10 < 0 ) {
F_27 ( V_14 , L_24 ) ;
goto V_120;
}
...
F_45 ( V_14 , V_6 ) ;
if ( V_6 -> V_99 && V_6 -> V_99 -> V_135 ) {
V_10 = V_6 -> V_99 -> V_135 ( V_6 ) ;
if ( V_10 ) {
F_52 ( V_14 , L_25 ) ;
V_6 -> V_113 = 0 ;
} else {
V_13 -> V_97 = V_6 -> V_99 -> V_97 ;
}
}
F_53 ( V_13 , V_6 ) ;
V_10 = F_54 ( V_14 , V_13 ) ;
