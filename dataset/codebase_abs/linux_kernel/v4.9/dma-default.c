...
static int F_51 ( struct V_6 * V_7 , struct V_54 * V_55 ,
int V_56 , enum V_45 V_46 , unsigned long V_26 )
{
int V_57 ;
struct V_54 * V_58 ;
F_52 (sglist, sg, nents, i) {
if ( ! F_8 ( V_7 ) )
F_45 ( F_53 ( V_58 ) , V_58 -> V_49 , V_58 -> V_59 ,
V_46 ) ;
#ifdef F_54
V_58 -> V_60 = V_58 -> V_59 ;
#endif
V_58 -> V_61 = F_55 ( V_7 , F_53 ( V_58 ) ) +
V_58 -> V_49 ;
}
return V_56 ;
}
...
static void F_57 ( struct V_6 * V_7 , struct V_54 * V_55 ,
...
F_45 ( F_53 ( V_58 ) , V_58 -> V_49 , V_58 -> V_59 ,
V_46 ) ;
F_28 ( V_7 , V_58 -> V_61 , V_58 -> V_59 , V_46 ) ;
}
}
...
int F_63 ( struct V_6 * V_7 , T_5 V_64 )
{
return F_64 ( V_7 , V_64 ) ;
}
