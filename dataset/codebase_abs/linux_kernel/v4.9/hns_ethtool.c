...
return - V_48 ;
if ( V_185 -> V_193 != V_185 -> V_192 )
return - V_48 ;
if ( ( ! V_12 -> V_203 ) ||
( ! V_12 -> V_204 ) )
return - V_45 ;
V_40 = V_12 -> V_203 ( V_4 -> V_9 ,
V_185 -> V_191 ) ;
if ( V_40 )
return V_40 ;
V_40 = V_12 -> V_204 (
...
void F_64 ( struct V_1 * V_2 , struct V_205 * V_206 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
V_206 -> V_207 = V_4 -> V_9 -> V_141 ;
V_206 -> V_208 = V_4 -> V_9 -> V_141 ;
V_206 -> V_209 = V_4 -> V_9 -> V_141 ;
V_206 -> V_210 = V_4 -> V_9 -> V_141 ;
}
void F_65 ( struct V_1 * V_129 ,
struct V_211 * V_122 , T_5 * V_116 )
{
T_5 * V_212 = V_116 ;
...
struct V_213 V_215 ;
if ( ! V_8 -> V_11 -> V_12 -> V_216 || ! V_8 -> V_11 -> V_12 -> V_217 ) {
F_10 ( V_129 , L_9 ) ;
return;
}
V_8 -> V_11 -> V_12 -> V_217 ( V_8 , & V_129 -> V_122 ) ;
V_214 = F_66 ( V_129 , & V_215 ) ;
V_212 [ 0 ] = V_214 -> V_123 ;
V_212 [ 1 ] = V_214 -> V_218 ;
V_212 [ 2 ] = V_214 -> V_124 ;
V_212 [ 3 ] = V_214 -> V_219 ;
...
V_212 [ 8 ] = V_214 -> V_224 ;
V_212 [ 9 ] = V_214 -> V_225 ;
V_212 [ 10 ] = V_214 -> V_226 ;
V_212 [ 11 ] = V_214 -> V_227 ;
V_212 [ 12 ] = V_214 -> V_125 ;
V_212 [ 13 ] = V_214 -> V_228 ;
V_212 [ 14 ] = V_214 -> V_229 ;
V_212 [ 15 ] = V_214 -> V_230 ;
V_212 [ 16 ] = V_214 -> V_231 ;
V_212 [ 17 ] = V_214 -> V_232 ;
V_212 [ 18 ] = V_214 -> V_233 ;
V_212 [ 19 ] = V_214 -> V_234 ;
V_212 [ 20 ] = V_214 -> V_235 ;
V_212 [ 21 ] = V_214 -> V_236 ;
V_212 [ 22 ] = V_214 -> V_237 ;
V_212 [ 23 ] = V_129 -> V_222 . V_238 ;
V_212 [ 24 ] = V_129 -> V_223 . V_238 ;
V_212 [ 25 ] = V_4 -> V_239 ;
V_8 -> V_11 -> V_12 -> V_216 ( V_8 , & V_212 [ 26 ] ) ;
}
void F_67 ( struct V_1 * V_129 , T_1 V_240 , T_2 * V_116 )
{
struct V_3 * V_4 = F_2 ( V_129 ) ;
struct V_7 * V_8 = V_4 -> V_9 ;
char * V_114 = ( char * ) V_116 ;
if ( ! V_8 -> V_11 -> V_12 -> V_241 ) {
F_10 ( V_129 , L_10 ) ;
return;
}
if ( V_240 == V_242 ) {
...
snprintf ( V_114 , V_243 , L_11 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_12 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_13 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_14 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_15 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_16 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_17 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_18 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_19 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_20 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_21 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_22 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_23 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_24 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_25 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_26 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_27 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_28 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_29 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_30 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_31 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_32 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_33 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_34 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_35 ) ;
V_114 = V_114 + V_243 ;
snprintf ( V_114 , V_243 , L_36 ) ;
V_114 = V_114 + V_243 ;
V_8 -> V_11 -> V_12 -> V_241 ( V_8 , V_240 , ( T_2 * ) V_114 ) ;
}
}
int F_68 ( struct V_1 * V_129 , int V_240 )
{
struct V_3 * V_4 = F_2 ( V_129 ) ;
struct V_7 * V_8 = V_4 -> V_9 ;
...
return ( V_247 + V_12 -> V_244 ( V_8 , V_240 ) ) ;
}
}
int F_69 ( struct V_1 * V_129 , int V_248 )
{
int V_18 ;
struct V_20 * V_21 = V_129 -> V_10 ;
V_18 = F_5 ( V_21 , V_28 , V_249 ) ;
V_18 |= F_5 ( V_21 , V_250 , V_248 ) ;
...
int F_70 ( struct V_1 * V_129 , enum V_251 V_150 )
{
struct V_3 * V_4 = F_2 ( V_129 ) ;
struct V_7 * V_8 = V_4 -> V_9 ;
struct V_20 * V_21 = V_129 -> V_10 ;
...
switch ( V_150 ) {
case V_252 :
return V_8 -> V_11 -> V_12 -> V_259 ( V_8 , V_260 ) ;
case V_254 :
return V_8 -> V_11 -> V_12 -> V_259 ( V_8 , V_261 ) ;
case V_256 :
return V_8 -> V_11 -> V_12 -> V_259 ( V_8 , V_262 ) ;
case V_258 :
return V_8 -> V_11 -> V_12 -> V_259 ( V_8 , V_263 ) ;
default:
return - V_48 ;
}
return 0 ;
}
void F_71 ( struct V_1 * V_2 , struct V_264 * V_15 ,
void * V_116 )
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
struct V_166 * V_12 ;
...
V_267 = V_12 -> V_268 ( V_4 -> V_9 ) ;
if ( V_267 > 0 )
return V_267 * sizeof( T_1 ) ;
else
return V_267 ;
}
...
V_12 = V_4 -> V_9 -> V_11 -> V_12 ;
return V_12 -> V_271 ( V_4 -> V_9 ) ;
}
static int
F_77 ( struct V_1 * V_129 , T_1 * V_272 , T_2 * V_273 , T_2 * V_274 )
{
struct V_3 * V_4 = F_2 ( V_129 ) ;
struct V_166 * V_12 ;
if ( F_13 ( V_4 -> V_69 ) ) {
...
if ( ! V_272 )
return 0 ;
return V_12 -> V_275 ( V_4 -> V_9 , V_272 , V_273 , V_274 ) ;
}
static int
F_78 ( struct V_1 * V_129 , const T_1 * V_272 , const T_2 * V_273 ,
const T_2 V_274 )
{
struct V_3 * V_4 = F_2 ( V_129 ) ;
struct V_166 * V_12 ;
...
V_12 = V_4 -> V_9 -> V_11 -> V_12 ;
if ( V_273 ||
( V_274 != V_276 && V_274 != V_277 ) )
return - V_245 ;
if ( ! V_272 )
return 0 ;
return V_12 -> V_278 ( V_4 -> V_9 , V_272 , V_273 , V_274 ) ;
}
