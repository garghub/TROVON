...
static void F_10 ( struct V_11 * V_12 , int V_13 ,
int V_14 )
{
struct V_1 * V_2 = F_7 ( V_12 -> V_15 . V_16 ) ;
F_9 ( V_2 , V_13 ) ;
F_8 ( V_2 -> V_15 , L_2 , V_13 ) ;
}
static T_2 F_11 ( struct V_17 * V_15 ,
...
static T_2 F_12 ( struct V_17 * V_15 ,
struct V_18 * V_19 ,
...
static T_2 F_15 ( struct V_17 * V_15 ,
struct V_18 * V_19 , char * V_20 )
{
T_1 V_21 ;
struct V_1 * V_2 = F_7 ( V_15 -> V_16 ) ;
...
static int F_28 ( struct V_17 * V_15 )
{
...
static int F_30 ( struct V_17 * V_15 )
{
struct V_1 * V_2 = F_7 ( V_15 ) ;
if ( V_2 && ! F_20 ( V_2 -> V_40 ) )
F_24 ( V_2 -> V_40 ) ;
