...
V_56 . V_12 = F_24 ( V_47 , NULL , V_49 ) ;
if ( F_25 ( V_56 . V_12 ) ) {
F_26 ( V_49 ) ;
return F_27 ( V_56 . V_12 ) ;
}
V_22 = F_28 ( V_49 , L_2 , & V_56 . V_27 ) ;
if ( V_22 && F_29 ( V_59 ) && V_58 )
V_56 . V_27 = V_58 -> V_27 ;
if ( ! V_56 . V_27 ) {
F_26 ( V_49 ) ;
return F_20 ( - V_30 ) ;
...
{
struct V_62 * V_63 = F_32 ( & V_46 -> V_47 ) ;
struct V_44 * V_50 ;
int V_64 , V_22 = 0 ;
if ( V_63 && V_63 -> V_43 ) {
V_50 = F_21 ( & V_46 -> V_47 ,
...
int V_64 ;
for ( V_64 = 0 ; V_64 < V_50 -> V_43 ; V_64 ++ ) {
struct V_1 * V_56 = & V_50 -> V_55 [ V_64 ] ;
F_3 ( & V_56 -> V_4 , V_9 ) ;
}
}
