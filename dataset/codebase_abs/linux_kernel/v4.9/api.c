...
if ( V_8 -> V_18 == V_19 )
goto V_53;
V_9 = F_35 ( V_8 -> V_7 -> V_36 ) ;
if ( V_9 )
goto V_53;
if ( V_48 ) {
V_8 -> V_54 = F_36 ( V_48 , V_55 ) ;
V_8 -> V_56 = F_36 ( V_48 -> V_57 , V_55 ) ;
V_49 = false ;
V_8 -> V_58 = false ;
}
F_37 () ;
...
int F_42 ( struct V_1 * V_8 )
{
return V_8 -> V_60 ;
}
int F_43 ( struct V_1 * V_8 )
{
return F_44 ( V_8 ) ;
}
void F_45 ( struct V_1 * V_8 )
{
V_8 -> V_61 = true ;
}
int F_46 ( struct V_1 * V_8 , bool V_58 )
{
if ( V_8 -> V_18 == V_19 ) {
return - V_20 ;
}
...
int F_49 ( struct V_62 * V_62 , struct V_63 * V_63 )
{
return F_50 ( V_62 , V_63 ) ;
}
long F_51 ( struct V_63 * V_63 , unsigned int V_64 , unsigned long V_65 )
{
return F_52 ( V_63 , V_64 , V_65 ) ;
}
int F_53 ( struct V_63 * V_63 , struct V_66 * V_67 )
{
return F_54 ( V_63 , V_67 ) ;
}
unsigned int F_55 ( struct V_63 * V_63 , struct V_68 * V_69 )
{
return F_56 ( V_63 , V_69 ) ;
}
T_5 F_57 ( struct V_63 * V_63 , char T_6 * V_70 , T_7 V_71 ,
T_8 * V_72 )
{
return F_58 ( V_63 , V_70 , V_71 , V_72 ) ;
}
struct V_63 * F_59 ( struct V_1 * V_8 , struct V_73 * V_74 ,
int * V_75 )
{
struct V_63 * V_63 ;
int V_9 , V_76 , V_77 ;
...
struct V_1 * F_64 ( struct V_63 * V_63 )
{
return V_63 -> V_89 ;
}
...
void T_9 * F_74 ( struct V_1 * V_8 )
{
if ( V_8 -> V_18 != V_19 )
return NULL ;
F_33 ( L_5 ,
V_50 , V_8 -> V_105 , V_8 -> V_106 ) ;
return F_75 ( V_8 -> V_105 , V_8 -> V_106 ) ;
}
void F_76 ( void T_9 * V_107 )
{
F_77 ( V_107 ) ;
}
...
T_5 F_80 ( struct V_2 * V_3 , void * V_70 , T_7 V_71 )
{
...
int F_81 ( struct V_2 * V_3 , int V_25 )
{
struct V_6 * V_7 = F_2 ( V_3 ) ;
if ( F_3 ( V_7 ) )
return - V_112 ;
...
int F_82 ( struct V_2 * V_27 , int V_115 , int type )
{
...
V_118 = V_115 ;
while ( V_118 > 0 ) {
V_9 = F_21 ( V_8 , F_83 ( V_118 , V_8 -> V_7 -> V_102 ) ) ;
if ( V_9 ) {
F_84 ( L_6 , F_85 ( V_27 ) ) ;
return V_9 ;
}
...
F_87 ( & V_116 -> V_29 , & V_8 -> V_29 ) ;
V_8 = V_116 ;
}
}
return 0 ;
}
void F_88 ( struct V_2 * V_27 )
{
...
return;
F_26 ( V_8 ) ;
F_89 (pos, tmp, &ctx->extra_irq_contexts, extra_irq_contexts) {
F_43 ( V_122 ) ;
F_26 ( V_122 ) ;
F_90 ( & V_122 -> V_29 ) ;
F_13 ( V_122 ) ;
