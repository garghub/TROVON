...
F_135 ( V_115 -> V_116 . V_3 , NULL ) ;
F_136 ( V_115 -> V_125 , V_115 -> V_116 . V_3 ) ;
F_28 ( V_115 -> V_125 ) ;
V_115 -> V_125 = NULL ;
}
if ( F_3 ( V_2 , & V_115 -> V_3 . V_3 ) && V_115 -> V_133 && ! V_115 -> V_128 )
F_137 ( V_2 , V_115 -> V_134 ) ;
F_109 ( V_115 ) ;
if ( V_115 -> V_116 . V_3 &&
! F_71 ( V_142 , & V_115 -> V_116 . V_25 -> V_91 ) ) {
F_54 ( ! V_115 -> V_116 . V_23 ) ;
F_138 ( & V_115 -> V_116 . V_18 , F_56 , NULL , V_18 ) ;
}
F_15 ( V_18 , F_127 , NULL ) ;
}
...
struct V_114 * V_115 = F_11 ( V_18 , struct V_114 , V_18 ) ;
struct V_1 * V_2 = F_11 ( V_115 -> V_12 , struct V_1 , V_85 ) ;
F_140 ( V_115 -> V_116 . V_25 , V_115 -> V_12 ,
! V_115 -> V_125 , V_115 -> V_116 . V_57 ) ;
F_141 ( V_115 -> V_134 , ! V_115 -> V_125 , V_115 -> V_116 . V_57 ) ;
if ( V_115 -> V_116 . error )
F_142 ( V_18 , F_130 , V_132 ) ;
else if ( V_115 -> V_116 . V_3 || F_3 ( V_2 , & V_115 -> V_3 . V_3 ) )
F_142 ( V_18 , F_133 , V_132 ) ;
else
F_142 ( V_18 , F_125 , NULL ) ;
}
static int F_143 ( struct V_121 * V_113 , struct V_114 * V_115 ,
...
F_135 ( V_145 , NULL ) ;
if ( F_148 ( V_145 , V_154 | V_68 ) )
goto V_155;
if ( V_143 )
F_149 ( V_115 -> V_116 . V_25 , V_115 -> V_12 ) ;
V_115 -> V_125 = V_144 ;
V_115 -> V_116 . V_3 = V_145 ;
F_59 ( V_145 ) ;
F_132 ( V_145 , & V_115 -> V_18 ) ;
return V_24 ;
V_155:
F_28 ( V_145 ) ;
V_146:
...
F_132 ( V_144 , & V_115 -> V_18 ) ;
return V_24 ;
}
static void F_150 ( struct V_1 * V_2 , struct V_114 * V_115 )
{
struct V_17 * V_18 = & V_115 -> V_18 ;
F_138 ( & V_115 -> V_116 . V_18 , F_104 , NULL , V_18 ) ;
...
if ( ( F_72 ( V_3 ) != V_95 ) ||
F_157 ( F_158 ( V_2 -> V_161 ) ) )
F_132 ( V_3 , V_18 ) ;
} else if ( V_115 -> V_116 . V_55 ) {
F_159 ( V_2 ) ;
V_115 -> V_116 . V_3 = V_3 ;
if ( V_3 -> V_58 & V_59 ) {
struct V_3 * V_162 = F_146 ( V_68 , 0 ,
V_2 -> V_85 . V_64 ) ;
...
V_115 -> V_116 . V_3 = F_160 ( V_3 , V_68 , V_2 -> V_85 . V_64 ) ;
F_132 ( V_3 , V_18 ) ;
}
F_138 ( & V_115 -> V_116 . V_18 , F_56 , NULL , V_18 ) ;
...
struct V_3 * V_3 = & V_115 -> V_3 . V_3 ;
if ( V_115 -> V_116 . V_27 )
F_162 ( V_115 -> V_116 . V_25 , V_18 ) ;
F_132 ( V_3 , V_18 ) ;
F_15 ( V_18 , F_125 , NULL ) ;
}
static T_4 F_163 ( struct V_164 * V_165 ,
struct V_3 * V_3 )
{
struct V_114 * V_115 ;
...
int V_168 = F_111 ( V_3 ) ;
F_164 ( V_168 , F_24 ( V_3 ) , & V_12 -> V_85 -> V_135 ) ;
V_3 -> V_140 = V_2 -> V_161 ;
V_3 -> V_41 . V_42 += V_2 -> V_4 . V_169 ;
if ( F_165 ( V_2 ) ) {
V_115 = F_121 ( V_3 , V_12 ) ;
F_166 ( V_115 -> V_12 , V_3 ) ;
if ( ! V_3 -> V_41 . V_46 ) {
F_142 ( & V_115 -> V_18 ,
F_161 ,
V_132 ) ;
...
static int F_168 ( struct V_137 * V_12 , T_5 V_86 ,
unsigned int V_171 , unsigned long V_172 )
{
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_85 ) ;
return F_169 ( V_2 -> V_161 , V_86 , V_171 , V_172 ) ;
}
static int F_170 ( void * V_173 , int V_174 )
{
struct V_137 * V_12 = V_173 ;
struct V_1 * V_2 = F_11 ( V_12 , struct V_1 , V_85 ) ;
struct V_164 * V_165 = F_158 ( V_2 -> V_161 ) ;
int V_24 = 0 ;
if ( F_171 ( & V_165 -> V_175 , V_174 ) )
return 1 ;
if ( F_165 ( V_2 ) ) {
unsigned V_61 ;
struct V_176 * V_177 ;
F_172 (ca, d->c, i) {
V_165 = F_158 ( V_177 -> V_161 ) ;
V_24 |= F_171 ( & V_165 -> V_175 , V_174 ) ;
}
F_126 ( V_2 ) ;
}
return V_24 ;
...
V_179 -> V_180 -> V_181 = F_163 ;
V_179 -> V_180 -> V_175 . V_182 = F_170 ;
V_2 -> V_85 . V_125 = F_143 ;
V_2 -> V_85 . V_183 = F_168 ;
}
static int F_174 ( struct V_121 * V_113 , struct V_114 * V_115 ,
struct V_3 * V_3 , unsigned V_43 )
{
unsigned V_184 = F_25 ( V_43 , F_24 ( V_3 ) ) << 9 ;
F_175 ( V_3 -> V_41 . V_46 , V_184 ) ;
F_176 ( V_3 ) ;
F_175 ( V_3 -> V_41 . V_46 , V_184 ) ;
F_177 ( V_3 , V_184 ) ;
if ( ! V_3 -> V_41 . V_46 )
...
static T_4 F_179 ( struct V_164 * V_165 ,
struct V_3 * V_3 )
{
struct V_114 * V_115 ;
struct V_17 * V_18 ;
...
static int F_180 ( struct V_137 * V_12 , T_5 V_86 ,
unsigned int V_171 , unsigned long V_172 )
{
return - V_185 ;
}
static int F_181 ( void * V_173 , int V_174 )
{
struct V_137 * V_12 = V_173 ;
struct V_164 * V_165 ;
struct V_176 * V_177 ;
...
void F_182 ( struct V_137 * V_12 )
{
struct V_178 * V_179 = V_12 -> V_85 ;
V_179 -> V_180 -> V_181 = F_179 ;
V_179 -> V_180 -> V_175 . V_182 = F_181 ;
V_12 -> V_125 = F_174 ;
V_12 -> V_183 = F_180 ;
}
void F_183 ( void )
