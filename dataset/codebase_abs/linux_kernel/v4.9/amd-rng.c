...
if ( V_22 == 0 )
return - V_25 ;
V_8 = F_13 ( & V_19 -> V_26 , sizeof( * V_8 ) , V_27 ) ;
if ( ! V_8 )
return - V_28 ;
if ( ! F_14 ( & V_19 -> V_26 , V_22 + V_29 ,
V_30 , V_31 ) ) {
F_15 ( & V_19 -> V_26 , V_31 L_1 ,
V_22 + 0xF0 ) ;
return - V_32 ;
}
V_8 -> V_11 = F_16 ( & V_19 -> V_26 , V_22 + V_29 ,
V_30 ) ;
if ( ! V_8 -> V_11 ) {
F_17 ( V_31 L_2 ) ;
return - V_28 ;
}
V_33 . V_8 = ( unsigned long ) V_8 ;
V_8 -> V_15 = V_19 ;
F_18 ( V_31 L_3 ) ;
return F_19 ( & V_19 -> V_26 , & V_33 ) ;
}
