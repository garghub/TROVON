...
static struct V_71 * F_23 ( struct V_72 * V_15 )
{
struct V_24 * V_70 = F_24 ( V_15 ) ;
return V_70 -> V_27 . V_26 -> V_71 ;
}
static int F_25 ( struct V_73 * V_74 )
{
struct V_26 * V_26 = F_24 ( V_74 -> V_15 . V_75 ) ;
struct V_24 * V_25 ;
int V_76 ;
V_25 = F_26 ( & V_74 -> V_15 , sizeof( struct V_24 ) ,
V_77 ) ;
if ( ! V_25 )
return - V_78 ;
F_27 ( V_74 , V_25 ) ;
V_25 -> V_27 . V_26 = V_26 ;
V_25 -> V_27 . V_79 = 3 ;
for ( V_76 = 0 ; V_76 < F_28 ( V_25 -> V_66 ) ; V_76 ++ )
...
V_85 , V_86 ,
& V_25 -> V_66 [ 1 ] ) ;
for ( V_76 = 0 ; V_76 < F_28 ( V_87 ) ; V_76 ++ )
F_30 ( & V_25 -> V_27 , V_76 ) ;
for ( V_76 = 0 ; V_76 < F_28 ( V_88 ) ; V_76 ++ )
F_31 ( V_26 -> V_71 , V_88 [ V_76 ] ,
V_89 , V_89 ) ;
F_32 ( & V_74 -> V_15 ) ;
F_33 ( & V_74 -> V_15 ) ;
return F_34 ( & V_74 -> V_15 , & V_90 ,
V_87 , F_28 ( V_87 ) ) ;
}
