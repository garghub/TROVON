...
F_6 ( V_2 -> V_4 , V_51 , 0x50000000 ) ;
F_6 ( V_2 -> V_4 , V_52 , 0xffffffff ) ;
F_6 ( V_2 -> V_4 , V_52 , 0 ) ;
return V_3 ;
}
...
return -1;) ;
V_54 = V_53 +
F_19 ( struct V_58 , V_59 ) ;
V_55 = V_53 +
F_19 ( struct V_58 , V_60 ) ;
V_3 = F_20 ( V_2 , V_54 ,
( V_61 * ) ( & V_56 ) , sizeof( V_56 ) , 0x40000 ) ;
F_10 ( 0 == result,
L_9
L_10 , return -1;) ;
V_3 = F_20 ( V_2 , V_55 ,
( V_61 * ) ( & V_57 ) , sizeof( V_57 ) , 0x40000 ) ;
F_10 ( 0 == result, L_11
L_12 , return -1;) ;
return V_3 ;
}
...
int F_24 ( struct V_1 * V_2 , bool V_73 )
{
struct V_32 * V_33 = (struct V_32 * ) ( V_2 -> V_34 ) ;
...
{
T_1 V_94 = 0 ;
T_1 V_95 = ( 1 << ( ( V_96 - V_97 ) + 1 ) ) - 1 ;
if ( ! F_31 ( V_2 -> V_4 , V_97 , V_96 ,
V_95 , & V_94 ) ) {
if ( V_94 )
return true ;
}
...
{
struct V_32 * V_100 = NULL ;
V_100 = F_35 ( sizeof( struct V_32 ) , V_101 ) ;
if ( V_100 == NULL )
return - V_102 ;
V_2 -> V_34 = V_100 ;
V_2 -> V_103 = & V_104 ;
