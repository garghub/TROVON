...
struct V_81 * V_28 = & V_2 -> V_28 ;
F_2 ( V_2 , & V_10 , V_39 , - 1 , - 1 ) ;
V_113 = F_35 ( T_1 , V_28 -> V_117 , V_28 -> V_118 ) ;
V_113 = ( V_113 - V_2 -> V_119 ) / V_79 ;
V_114 = ( V_28 -> V_118 - V_2 -> V_120 ) / V_79 ;
if ( V_2 -> V_36 & V_121 )
...
int F_45 ( struct V_85 * V_86 , int V_79 )
{
struct V_31 * V_21 = F_46 ( V_86 ) ;
struct V_1 * V_2 = F_11 ( V_21 ) ;
if ( ! ( V_2 -> V_36 & V_161 ) ) {
F_42 ( V_21 , L_13 ) ;
return 0 ;
...
if ( ! F_55 ( V_4 -> V_44 ) ||
F_56 ( ( const T_3 * ) V_10 -> V_187 , V_4 -> V_44 ) )
return F_53 ( V_2 , V_4 , V_168 ) ;
else
...
while ( 1 ) {
V_24 = F_60 ( V_2 -> V_28 . V_87 , V_29 , V_80 ) ;
if ( V_24 >= V_29 )
break;
F_61 ( V_24 , V_2 -> V_28 . V_87 ) ;
F_58 ( V_2 , & V_2 -> V_28 . V_4 [ V_24 ] ) ;
V_80 = V_24 + 1 ;
}
}
...
goto V_212;
if ( ! F_56 ( V_7 -> V_213 , V_2 -> V_4 . V_44 ) )
memcpy ( V_2 -> V_4 . V_44 , V_7 -> V_213 , V_45 ) ;
if ( F_55 ( V_2 -> V_4 . V_44 ) )
memcpy ( V_2 -> V_21 -> V_214 , V_2 -> V_4 . V_44 , V_45 ) ;
V_212:
F_7 ( & V_2 -> V_19 ) ;
}
int F_63 ( struct V_1 * V_2 , T_3 * V_43 )
{
struct V_215 V_10 = { 0 } ;
int V_13 = 0 ;
if ( ! F_64 ( V_2 ) )
