...
static int F_20 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_21 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
return F_22 ( V_22 , true , true , false ) ;
}
static int F_23 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_21 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
if ( F_24 ( V_22 ) ) {
...
return F_28 ( V_22 , true , true ) ;
}
static int F_29 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_21 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
return F_22 ( V_22 , false , true , true ) ;
}
static int F_30 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_21 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
return F_28 ( V_22 , false , true ) ;
}
...
F_33 ( V_22 ) ;
F_34 ( V_2 , V_26 ) ;
V_16 = F_22 ( V_22 , false , false , false ) ;
F_35 ( V_2 ) ;
F_36 ( V_2 ) ;
F_37 ( V_2 ) ;
if ( F_4 () )
...
static int F_39 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_21 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
int V_16 ;
...
return V_16 ;
F_42 ( V_2 ) ;
V_16 = F_28 ( V_22 , false , false ) ;
F_43 ( V_22 ) ;
F_34 ( V_2 , V_32 ) ;
V_22 -> V_24 = V_33 ;
return 0 ;
}
static int F_44 ( struct V_21 * V_20 )
{
struct V_1 * V_2 = F_21 ( V_20 ) ;
struct V_19 * V_22 = F_17 ( V_2 ) ;
struct V_34 * V_35 ;
...
F_45 (crtc, &drm_dev->mode_config.crtc_list, head) {
if ( V_35 -> V_36 ) {
F_46 ( L_2 ) ;
return - V_23 ;
}
