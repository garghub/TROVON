...
V_139 . V_145 = V_146 ;
F_69 ( L_17 , V_5 -> V_31 , V_5 , NULL ,
V_147 ,
V_147 ) ;
V_18 = F_70 ( V_5 -> V_31 -> V_52 , 0 , & V_139 ) ;
if ( ! V_18 ) {
...
V_18 -> V_149 = V_5 -> V_149 ;
V_5 -> V_18 = V_18 ;
V_5 -> V_150 = V_18 -> V_151 ;
F_71 ( V_5 ) ;
}
...
void F_74 ( struct V_34 * V_5 )
{
F_75 ( & V_5 -> V_6 ) ;
V_5 -> V_153 = V_154 ;
if ( ! F_76 ( V_5 -> V_31 -> V_155 , & V_5 -> V_156 ) )
F_4 ( & V_5 -> V_6 ) ;
}
void F_77 ( struct V_34 * V_5 )
{
F_75 ( & V_5 -> V_6 ) ;
V_5 -> V_153 = V_157 ;
if ( V_5 -> V_18 && F_76 ( V_5 -> V_31 -> V_155 ,
& V_5 -> V_156 ) )
return;
F_4 ( & V_5 -> V_6 ) ;
}
...
{
struct V_34 * V_5 = F_82 ( V_159 , struct V_34 ,
V_156 ) ;
while ( V_5 -> V_153 ) {
if ( V_5 -> V_153 == V_154 ) {
V_5 -> V_153 = V_160 ;
...
V_161 |= V_169 ;
F_84 ( V_15 , V_170 ) ;
V_15 -> V_171 = V_31 -> V_126 -> V_172 / 2 ;
V_15 -> V_173 = V_31 -> V_126 -> V_172 / 2 ;
V_15 -> V_174 = V_15 -> V_173 * 8 ;
}
F_85 ( V_15 , V_161 ) ;
}
void F_86 ( struct V_10 * V_175 , int V_176 )
{
F_87 ( 1 , V_175 -> V_177 ,
V_178 , 0x10 , V_176 ) ;
F_88 ( V_175 , V_179 ) ;
