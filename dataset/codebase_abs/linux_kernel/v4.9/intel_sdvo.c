...
if ( ! F_49 ( V_1 , V_215 ) )
return;
if ( F_74 ( V_10 ) -> V_225 >= 4 ) {
V_212 = V_226 | V_227 ;
if ( ! F_9 ( V_10 ) && V_209 -> V_169 )
V_212 |= V_205 ;
if ( F_74 ( V_10 ) -> V_225 < 5 )
V_212 |= V_228 ;
} else {
V_212 = F_13 ( V_1 -> V_16 ) ;
if ( V_1 -> V_17 == V_18 )
...
if ( F_75 ( V_10 ) >= V_231 )
V_212 |= F_76 ( V_211 -> V_232 ) ;
else
V_212 |= F_77 ( V_211 -> V_232 ) ;
if ( V_1 -> V_233 )
V_212 |= V_234 ;
if ( F_74 ( V_10 ) -> V_225 >= 4 ) {
...
if ( V_182 . V_95 . V_184 & V_236 &&
F_74 ( V_10 ) -> V_225 < 5 )
V_212 |= V_237 ;
F_7 ( V_1 , V_212 ) ;
}
static bool F_81 ( struct V_238 * V_6 )
{
struct V_7 * V_7 =
F_5 ( & V_6 -> V_4 ) ;
...
V_249 &= ~ V_241 ;
F_7 ( V_1 , V_249 ) ;
if ( F_12 ( V_12 ) && V_211 -> V_232 == V_250 ) {
F_91 ( V_12 , V_251 , false ) ;
F_92 ( V_12 , V_251 , false ) ;
V_249 &= ~ V_252 ;
V_249 |= V_241 ;
F_7 ( V_1 , V_249 ) ;
V_249 &= ~ V_241 ;
F_7 ( V_1 , V_249 ) ;
F_93 ( & V_12 -> V_253 , V_251 ) ;
F_91 ( V_12 , V_251 , true ) ;
F_92 ( V_12 , V_251 , true ) ;
}
}
...
F_7 ( V_1 , V_249 ) ;
for ( V_15 = 0 ; V_15 < 2 ; V_15 ++ )
F_97 ( V_10 , V_210 -> V_232 ) ;
V_257 = F_35 ( V_1 , & V_255 , & V_256 ) ;
if ( V_257 && ! V_255 ) {
F_16 ( L_22
L_23 , F_22 ( V_1 ) ) ;
}
...
int V_259 = F_8 ( V_6 -> V_10 ) -> V_260 ;
if ( V_73 -> V_26 & V_261 )
return V_262 ;
if ( V_1 -> V_263 > V_73 -> clock )
return V_264 ;
if ( V_1 -> V_265 < V_73 -> clock )
return V_266 ;
if ( V_73 -> clock > V_259 )
return V_266 ;
if ( V_1 -> V_103 ) {
...
static bool F_99 ( struct V_1 * V_1 , struct V_269 * V_270 )
{
F_36 ( sizeof( * V_270 ) != 8 ) ;
if ( ! F_33 ( V_1 ,
V_271 ,
...
{
return F_104 ( V_1 -> V_270 . V_283 ) > 1 ;
}
static struct V_288 *
F_105 ( struct V_5 * V_6 )
{
struct V_1 * V_289 = F_3 ( V_6 ) ;
return F_106 ( V_6 , & V_289 -> V_290 ) ;
}
static struct V_288 *
...
struct V_288 * V_288 ;
V_288 = F_105 ( V_6 ) ;
if ( V_288 == NULL && F_103 ( V_1 ) ) {
T_2 V_290 , V_294 = V_1 -> V_57 ;
for ( V_290 = V_1 -> V_57 >> 1 ; V_290 > 1 ; V_290 >>= 1 ) {
V_1 -> V_57 = V_290 ;
V_288 = F_105 ( V_6 ) ;
if ( V_288 )
break;
...
V_38 = V_298 ;
if ( V_1 -> V_206 ) {
V_1 -> V_202 = F_110 ( V_288 ) ;
V_1 -> V_233 = F_111 ( V_288 ) ;
V_1 -> V_168 =
F_112 ( V_288 ) ;
}
} else
...
if ( V_7 -> V_300 != V_301 )
V_1 -> V_233 = ( V_7 -> V_300 == V_302 ) ;
}
return V_38 ;
}
static bool
F_113 ( struct V_7 * V_289 ,
struct V_288 * V_288 )
{
bool V_303 = ! ! ( V_288 -> V_296 & V_297 ) ;
bool V_304 = ! ! F_114 ( V_289 ) ;
F_16 ( L_37 ,
V_304 , V_303 ) ;
return V_304 == V_303 ;
}
static enum V_293
F_115 ( struct V_5 * V_6 , bool V_305 )
{
T_4 V_44 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
V_177 = 1 << V_1 -> V_178 ;
memcpy ( & V_311 , & V_177 ,
V_89 ( sizeof( V_177 ) , sizeof( struct V_310 ) ) ) ;
...
if ( ! F_27 ( V_1 , & V_312 , 3 ) )
return;
for ( V_15 = 0 ; V_15 < F_20 ( V_314 ) ; V_15 ++ )
if ( V_312 & ( 1 << V_15 ) ) {
struct V_54 * V_315 ;
V_315 = F_121 ( V_6 -> V_10 ,
& V_314 [ V_15 ] ) ;
if ( V_315 )
F_122 ( V_6 , V_315 ) ;
}
...
F_16 ( L_38 ,
V_6 -> V_4 . V_306 , V_6 -> V_37 ) ;
if ( V_12 -> V_291 . V_317 != NULL ) {
V_316 = F_121 ( V_6 -> V_10 ,
V_12 -> V_291 . V_317 ) ;
if ( V_316 != NULL ) {
V_316 -> type = ( V_318 |
V_319 ) ;
...
return false ;
V_288 = F_105 ( V_6 ) ;
if ( V_288 != NULL && V_288 -> V_296 & V_297 )
V_321 = F_111 ( V_288 ) ;
F_26 ( V_288 ) ;
return V_321 ;
}
...
return - V_333 ;
V_351:
if ( ! F_32 ( V_1 , V_32 , & V_324 , 2 ) )
return - V_358 ;
V_326:
if ( V_1 -> V_4 . V_4 . V_211 )
F_137 ( V_1 -> V_4 . V_4 . V_211 ) ;
return 0 ;
#undef F_135
}
static int
...
if ( V_30 )
return V_30 ;
return F_140 ( & V_6 -> V_359 -> V_360 ,
& V_289 -> V_290 . V_10 . V_360 ,
V_289 -> V_290 . V_10 . V_360 . V_37 ) ;
}
static void
F_141 ( struct V_5 * V_6 )
{
struct V_1 * V_289 = F_3 ( V_6 ) ;
F_142 ( & V_6 -> V_359 -> V_360 ,
V_289 -> V_290 . V_10 . V_360 . V_37 ) ;
F_143 ( V_6 ) ;
}
static void F_144 ( struct V_361 * V_3 )
{
...
struct V_371 * V_372 ;
if ( V_289 -> V_17 == V_18 )
V_372 = & V_12 -> V_291 . V_373 [ 0 ] ;
else
V_372 = & V_12 -> V_291 . V_373 [ 1 ] ;
if ( V_372 -> V_374 )
V_289 -> V_57 = 1 << ( ( V_372 -> V_375 & 0xf0 ) >> 4 ) ;
else
F_149 ( V_289 ) ;
}
static void
...
V_372 = & V_12 -> V_291 . V_373 [ 1 ] ;
if ( V_372 -> V_374 &&
F_152 ( V_12 , V_372 -> V_377 ) )
V_376 = V_372 -> V_377 ;
else
V_376 = V_378 ;
V_289 -> V_31 = F_108 ( V_12 , V_376 ) ;
F_153 ( V_289 -> V_31 , true ) ;
}
static void
F_154 ( struct V_1 * V_289 )
{
F_153 ( V_289 -> V_31 , false ) ;
}
static bool
F_155 ( struct V_1 * V_1 , int V_379 )
{
return F_54 ( V_1 ) ;
}
static T_2
F_156 ( struct V_9 * V_10 , struct V_1 * V_289 )
{
struct V_11 * V_12 = F_8 ( V_10 ) ;
struct V_371 * V_380 , * V_381 ;
if ( V_289 -> V_17 == V_18 ) {
V_380 = & V_12 -> V_291 . V_373 [ 0 ] ;
V_381 = & V_12 -> V_291 . V_373 [ 1 ] ;
} else {
V_380 = & V_12 -> V_291 . V_373 [ 1 ] ;
V_381 = & V_12 -> V_291 . V_373 [ 0 ] ;
}
if ( V_380 -> V_25 )
return V_380 -> V_25 ;
if ( V_381 -> V_25 ) {
...
F_162 ( & V_6 -> V_4 . V_4 ) ;
if ( F_74 ( V_10 ) -> V_225 >= 4 && F_163 ( V_10 ) ) {
F_164 ( & V_6 -> V_4 . V_4 ) ;
V_1 -> V_203 = true ;
}
F_165 ( & V_6 -> V_4 . V_4 ) ;
...
{
struct V_7 * V_391 ;
V_391 = F_24 ( sizeof( * V_391 ) , V_39 ) ;
if ( ! V_391 )
return NULL ;
if ( F_167 ( & V_391 -> V_4 ) < 0 ) {
F_26 ( V_391 ) ;
return NULL ;
}
return V_391 ;
...
static bool
F_168 ( struct V_1 * V_1 , int V_379 )
{
struct V_361 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
...
static bool
F_172 ( struct V_1 * V_1 , int V_379 )
{
struct V_361 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_238 * V_238 ;
...
static bool
F_173 ( struct V_1 * V_1 , int V_379 )
{
struct V_361 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_238 * V_238 ;
...
return false ;
if ( ( V_26 & V_412 ) == 0 ) {
unsigned char V_413 [ 2 ] ;
V_1 -> V_364 = 0 ;
memcpy ( V_413 , & V_1 -> V_270 . V_283 , 2 ) ;
F_16 ( L_44 ,
F_22 ( V_1 ) ,
V_413 [ 0 ] , V_413 [ 1 ] ) ;
return false ;
}
V_1 -> V_4 . V_414 = ( 1 << 0 ) | ( 1 << 1 ) | ( 1 << 2 ) ;
return true ;
}
...
return false ;
V_7 -> V_416 = 0 ;
for ( V_15 = 0 ; V_15 < V_343 ; V_15 ++ )
if ( V_177 & ( 1 << V_15 ) )
V_7 -> V_344 [ V_7 -> V_416 ++ ] = V_15 ;
V_7 -> V_342 =
F_178 ( V_10 , V_417 ,
L_45 , V_7 -> V_416 ) ;
if ( ! V_7 -> V_342 )
return false ;
for ( V_15 = 0 ; V_15 < V_7 -> V_416 ; V_15 ++ )
F_179 (
V_7 -> V_342 , V_15 ,
V_15 , V_418 [ V_7 -> V_344 [ V_15 ] ] ) ;
V_1 -> V_178 = V_7 -> V_344 [ 0 ] ;
...
return false ;
V_7 -> V_349 = V_421 [ 0 ] ;
V_7 -> V_347 = V_421 [ 0 ] - V_44 ;
V_7 -> V_348 = V_7 -> V_347 ;
V_7 -> V_345 =
F_182 ( V_10 , 0 , L_46 , 0 , V_421 [ 0 ] ) ;
if ( ! V_7 -> V_345 )
return false ;
F_180 ( & V_6 -> V_4 ,
V_7 -> V_345 ,
...
if ( F_127 ( V_7 ) )
return F_181 ( V_1 , V_7 , V_420 . V_312 ) ;
else if ( F_128 ( V_7 ) )
return F_184 ( V_1 , V_7 , V_420 . V_312 ) ;
else
return true ;
}
static int F_185 ( struct V_457 * V_458 ,
struct V_23 * V_24 ,
int V_459 )
{
struct V_1 * V_289 = V_458 -> V_460 ;
if ( ! F_31 ( V_289 , V_289 -> V_57 ) )
return - V_358 ;
return V_289 -> V_31 -> V_461 -> V_462 ( V_289 -> V_31 , V_24 , V_459 ) ;
}
static T_1 F_186 ( struct V_457 * V_458 )
{
struct V_1 * V_289 = V_458 -> V_460 ;
return V_289 -> V_31 -> V_461 -> V_463 ( V_289 -> V_31 ) ;
}
static bool
F_187 ( struct V_1 * V_289 ,
struct V_9 * V_10 )
{
struct V_464 * V_465 = V_10 -> V_465 ;
V_289 -> V_290 . V_466 = V_467 ;
V_289 -> V_290 . V_468 = V_469 ;
snprintf ( V_289 -> V_290 . V_37 , V_470 , L_56 ) ;
V_289 -> V_290 . V_10 . V_471 = & V_465 -> V_10 ;
V_289 -> V_290 . V_460 = V_289 ;
V_289 -> V_290 . V_461 = & V_472 ;
return F_188 ( & V_289 -> V_290 ) == 0 ;
}
...
V_2 -> V_390 = F_82 ;
V_2 -> V_483 = F_86 ;
if ( ! F_99 ( V_1 , & V_1 -> V_270 ) )
goto V_402;
if ( F_174 ( V_1 ,
V_1 -> V_270 . V_283 ) != true ) {
F_16 ( L_59 ,
F_22 ( V_1 ) ) ;
goto V_484;
}
...
L_63 ,
F_22 ( V_1 ) ,
V_1 -> V_270 . V_272 , V_1 -> V_270 . V_273 ,
V_1 -> V_270 . V_274 ,
V_1 -> V_263 / 1000 ,
V_1 -> V_265 / 1000 ,
( V_1 -> V_270 . V_277 & 0x1 ) ? 'Y' : 'N' ,
( V_1 -> V_270 . V_277 & 0x2 ) ? 'Y' : 'N' ,
V_1 -> V_270 . V_283 &
( V_368 | V_370 ) ? 'Y' : 'N' ,
V_1 -> V_270 . V_283 &
( V_367 | V_369 ) ? 'Y' : 'N' ) ;
