...
static int F_30 ( struct V_59 * V_59 )
{
struct V_5 * V_6 = F_31 ( V_59 ) ;
F_5 ( V_6 -> V_11 , L_9 , V_50 ) ;
return 0 ;
}
static int F_32 ( struct V_59 * V_59 )
{
struct V_5 * V_6 = F_31 ( V_59 ) ;
F_5 ( V_6 -> V_11 , L_9 , V_50 ) ;
F_33 ( V_6 -> V_11 ) ;
...
F_3 ( V_55 , 0x14 , V_64 ) ;
F_3 ( V_55 , 0 , V_65 ) ;
V_6 -> V_53 = F_38 ( V_6 -> V_11 , L_13 ) ;
if ( F_39 ( V_6 -> V_53 ) )
return - V_66 ;
F_3 ( V_55 , 0 , V_67 ) ;
F_3 ( V_55 , 0 , V_68 ) ;
V_6 -> V_51 = F_38 ( V_6 -> V_11 , L_14 ) ;
if ( F_39 ( V_6 -> V_51 ) )
return - V_66 ;
F_3 ( V_55 , 0 , V_69 ) ;
F_3 ( V_55 , 0 , V_70 ) ;
V_6 -> V_52 = F_38 ( V_6 -> V_11 , L_15 ) ;
if ( F_39 ( V_6 -> V_52 ) )
return - V_66 ;
F_3 ( V_55 , 0 , V_71 ) ;
F_3 ( V_26 , 0 ,
...
static T_3 F_40 ( struct V_49 * V_11 ,
...
static T_4 F_43 ( int V_77 , void * V_78 )
{
struct V_5 * V_6 = V_78 ;
enum V_1 V_22 ;
bool V_79 = false ;
...
if ( V_22 == V_4 && F_45 ( V_6 -> V_11 ) ) {
F_46 ( & V_6 -> V_60 ) ;
F_34 ( & V_6 -> V_60 , V_45 ) ;
}
if ( V_77 )
F_47 ( & V_6 -> V_11 -> V_82 , NULL , L_18 ) ;
return V_83 ;
}
static void F_48 ( struct V_84 * V_85 )
{
struct V_5 * V_6 = F_49 ( V_85 , struct V_5 ,
V_60 . V_85 ) ;
F_43 ( 0 , V_6 ) ;
}
...
static int F_52 ( struct V_86 * V_87 , struct V_92 * V_93 )
{
if ( ! V_87 )
return - V_66 ;
V_87 -> V_93 = V_93 ;
...
{
struct V_96 * V_97 = F_54 ( & V_95 -> V_11 ) ;
struct V_5 * V_6 ;
struct V_59 * V_59 ;
int V_22 , V_80 ;
struct V_86 * V_87 ;
struct V_98 * V_99 = V_95 -> V_11 . V_100 ;
struct V_101 * V_101 ;
V_6 = F_55 ( & V_95 -> V_11 , sizeof( * V_6 ) , V_102 ) ;
if ( ! V_6 )
return - V_103 ;
if ( V_99 )
F_56 ( V_99 , L_19 ,
...
V_87 = F_55 ( & V_95 -> V_11 , sizeof( * V_87 ) , V_102 ) ;
if ( ! V_87 )
return - V_103 ;
V_6 -> V_11 = & V_95 -> V_11 ;
V_6 -> V_77 = F_57 ( V_95 , 0 ) ;
V_6 -> V_25 = false ;
V_6 -> V_23 = V_24 ;
V_6 -> V_81 = false ;
...
F_71 ( & V_95 -> V_11 ) ;
F_33 ( & V_95 -> V_11 ) ;
V_22 = F_72 ( V_6 -> V_11 , V_6 -> V_77 , NULL ,
F_43 , V_114 |
V_115 | V_116 , L_25 , V_6 ) ;
if ( V_22 < 0 ) {
F_5 ( & V_95 -> V_11 , L_26 ,
V_6 -> V_77 , V_22 ) ;
return V_22 ;
...
static int F_75 ( struct V_94 * V_95 )
{
struct V_5 * V_6 = F_76 ( V_95 ) ;
int V_41 ;
F_77 ( & V_6 -> V_59 ) ;
F_33 ( V_6 -> V_11 ) ;
F_46 ( & V_6 -> V_60 ) ;
