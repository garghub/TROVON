...
{
int V_76 = V_44 -> V_45 . V_36 >> V_77 ;
int V_74 ;
if ( V_44 -> V_78 == NULL )
return;
for ( V_74 = 0 ; V_74 < V_76 ; V_74 ++ ) {
char V_79 = F_29 ( V_44 -> V_80 [ V_74 ] ) >> 17 ;
if ( ( V_79 & 0x1 ) !=
( F_30 ( V_74 , V_44 -> V_78 ) != 0 ) ) {
F_25 ( V_44 -> V_80 [ V_74 ] ) ;
F_31 ( V_44 -> V_80 [ V_74 ] ) ;
}
}
