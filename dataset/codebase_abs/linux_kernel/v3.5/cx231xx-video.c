...
static int F_68 ( struct V_126 * V_126 , void * V_127 , struct V_172 * V_173 )
{
struct V_88 * V_89 = V_127 ;
struct V_1 * V_2 = V_89 -> V_2 ;
int V_20 = 0 ;
...
static int F_119 ( struct V_126 * V_126 , void * V_89 , struct V_172 * V_173 )
{
return 0 ;
}
...
if ( V_89 -> V_198 ) {
F_54 ( L_35 ) ;
F_59 ( V_2 , V_202 , V_303 ) ;
}
V_2 -> V_295 ++ ;
if ( V_89 -> type == V_121 )
F_130 ( & V_89 -> V_144 , & V_304 ,
NULL , & V_2 -> V_14 . V_97 ,
V_89 -> type , V_138 ,
sizeof( struct V_5 ) ,
V_89 , & V_2 -> V_305 ) ;
...
static int F_137 ( struct V_126 * V_286 )
{
struct V_88 * V_89 = V_286 -> V_298 ;
struct V_1 * V_2 = V_89 -> V_2 ;
F_54 ( L_37 , V_2 -> V_295 ) ;
F_54 ( L_37 , V_2 -> V_295 ) ;
if ( F_44 ( V_89 ) )
...
static T_5
F_148 ( struct V_126 * V_286 , char T_6 * V_6 , T_7 V_87 ,
T_8 * V_74 )
{
struct V_88 * V_89 = V_286 -> V_298 ;
struct V_1 * V_2 = V_89 -> V_2 ;
...
if ( F_71 ( V_39 < 0 ) )
return V_39 ;
return F_149 ( & V_89 -> V_144 , V_6 , V_87 , V_74 , 0 ,
V_286 -> V_281 & V_282 ) ;
}
return 0 ;
}
static unsigned int F_150 ( struct V_126 * V_286 , T_9 * V_321 )
{
struct V_88 * V_89 = V_286 -> V_298 ;
struct V_1 * V_2 = V_89 -> V_2 ;
int V_39 ;
...
if ( ( V_121 == V_89 -> type ) ||
( V_123 == V_89 -> type ) )
return F_151 ( V_286 , & V_89 -> V_144 , V_321 ) ;
else
return V_322 ;
}
static int F_152 ( struct V_126 * V_286 , struct V_323 * V_324 )
{
struct V_88 * V_89 = V_286 -> V_298 ;
struct V_1 * V_2 = V_89 -> V_2 ;
int V_39 ;
...
if ( F_71 ( V_39 < 0 ) )
return V_39 ;
V_39 = F_153 ( & V_89 -> V_144 , V_324 ) ;
F_54 ( L_38 ,
( unsigned long ) V_324 -> V_325 ,
( unsigned long ) V_324 -> V_326 -
( unsigned long ) V_324 -> V_325 , V_39 ) ;
return V_39 ;
}
static struct V_288 * F_154 ( struct V_1 * V_2 ,
const struct V_288
* V_327 , const char * V_328 )
{
struct V_288 * V_329 ;
V_329 = F_155 () ;
if ( NULL == V_329 )
return NULL ;
* V_329 = * V_327 ;
V_329 -> V_330 = & V_2 -> V_330 ;
V_329 -> V_331 = F_135 ;
V_329 -> V_332 = V_333 ;
V_329 -> V_305 = & V_2 -> V_305 ;
F_156 ( V_334 , & V_329 -> V_96 ) ;
snprintf ( V_329 -> V_158 , sizeof( V_329 -> V_158 ) , L_39 , V_2 -> V_158 , V_328 ) ;
F_157 ( V_329 , V_2 ) ;
return V_329 ;
}
...
V_2 -> V_337 = 1 ;
V_2 -> V_338 = 0x1f ;
V_2 -> V_164 = F_154 ( V_2 , & V_339 , L_41 ) ;
if ( ! V_2 -> V_164 ) {
F_47 ( L_42 ) ;
return - V_125 ;
}
V_154 = F_159 ( V_2 -> V_164 , V_291 ,
V_340 [ V_2 -> V_341 ] ) ;
if ( V_154 ) {
F_47 ( L_43 ,
V_154 ) ;
...
memcpy ( & V_342 , & V_339 ,
sizeof( V_342 ) ) ;
strcpy ( V_342 . V_158 , L_45 ) ;
V_2 -> V_311 = F_154 ( V_2 , & V_342 , L_46 ) ;
V_154 = F_159 ( V_2 -> V_311 , V_292 ,
V_343 [ V_2 -> V_341 ] ) ;
if ( V_154 < 0 ) {
F_47 ( L_47 ) ;
return V_154 ;
...
F_41 ( L_48 ,
V_2 -> V_158 , F_125 ( V_2 -> V_311 ) ) ;
if ( V_248 [ V_2 -> V_249 ] . V_198 . type == V_344 ) {
V_2 -> V_310 = F_154 ( V_2 , & V_345 ,
L_49 ) ;
if ( ! V_2 -> V_310 ) {
F_47 ( L_42 ) ;
return - V_125 ;
}
V_154 = F_159 ( V_2 -> V_310 , V_293 ,
V_346 [ V_2 -> V_341 ] ) ;
if ( V_154 < 0 ) {
F_47 ( L_50 ) ;
return V_154 ;
