...
{
struct V_47 * V_52 = F_44 ( V_79 , struct V_47 , V_24 ) ;
F_42 ( & V_52 -> V_60 -> V_56 ,
V_52 -> V_55 >> V_19 ) ;
F_21 ( V_52 ) ;
}
...
static void F_47 ( struct V_47 * V_52 , int V_25 )
{
int V_9 ;
...
V_94 -> V_92 . V_103 = F_52 ;
V_94 -> V_15 = V_15 ;
F_60 ( & V_15 -> V_104 , & V_94 -> V_92 ) ;
}
static void F_61 ( struct V_14 * V_15 , int V_105 )
{
struct V_20 * V_60 ;
struct V_98 * V_99 = V_15 -> V_99 ;
unsigned long V_18 ;
...
V_13 -> V_77 [ V_9 ] -> V_5 ,
V_13 -> V_77 [ V_9 ] -> V_55 ) ;
for ( V_106 = 0 ; V_106 < V_13 -> V_77 [ V_9 ] -> V_64 ; ++ V_106 ) {
F_15 ( V_109 L_8 ,
V_13 -> V_77 [ V_9 ] -> V_62 [ V_106 ] -> V_108 ) ;
}
}
F_15 ( V_109 L_10 ) ;
...
F_15 ( V_37
L_13 ,
V_13 -> V_49 , V_13 -> V_71 , F_18 ( & V_13 -> V_26 ) ,
...
while ( F_58 ( & V_36 -> V_42 ) ) {
F_68 ( V_36 -> V_44 , F_58 ( & V_36 -> V_42 ) == 0 ,
5 * V_115 ) ;
F_61 ( V_36 -> V_2 -> V_15 , V_36 -> V_42 < 10 ? 1 : 0 ) ;
}
F_61 ( V_36 -> V_2 -> V_15 , V_36 -> V_42 < 10 ? 1 : 0 ) ;
F_23 ( & V_36 -> V_24 , V_43 ) ;
return 0 ;
...
struct V_35 * V_36 = V_114 ;
while ( F_58 ( & V_36 -> V_42 ) ) {
F_69 ( V_36 -> V_44 , F_58 ( & V_36 -> V_42 ) == 0 ) ;
}
F_23 ( & V_36 -> V_24 , V_43 ) ;
return 0 ;
}
void F_70 ( void * V_114 )
{
struct V_35 * V_36 = V_114 ;
F_23 ( & V_36 -> V_24 , V_43 ) ;
}
