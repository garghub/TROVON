...
static long F_4 ( struct V_2 * V_3 , unsigned long V_9 ,
unsigned long * V_10 )
{
struct V_1 * div = F_1 ( V_3 ) ;
return div -> V_7 -> V_11 ( & div -> V_5 . V_3 , V_9 , V_10 ) ;
}
static int F_5 ( struct V_2 * V_3 , unsigned long V_9 ,
unsigned long V_6 )
{
struct V_1 * div = F_1 ( V_3 ) ;
int V_12 ;
...
if ( ! V_12 )
V_12 = F_6 ( div -> V_14 , div -> V_15 ) ;
return V_12 ;
}
struct V_16 * F_7 ( const char * V_17 , const char * V_18 ,
void T_1 * V_14 , T_2 V_19 , T_2 V_20 , T_2 V_15 )
{
struct V_1 * div ;
struct V_16 * V_16 ;
struct V_21 V_22 ;
div = F_8 ( sizeof( * div ) , V_23 ) ;
if ( ! div )
return F_9 ( - V_24 ) ;
V_22 . V_17 = V_17 ;
V_22 . V_7 = & V_25 ;
