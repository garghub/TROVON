...
static T_1 void F_52 ( struct V_21 * V_21 , struct V_17 * V_18 )
{
if ( ! F_53 ( & V_21 -> V_29 . V_123 ) &&
( V_18 -> V_113 & ( V_114 | V_124 ) ) )
F_54 ( & V_21 -> V_29 . V_123 ,
...
int F_56 ( struct V_14 * V_60 , struct V_17 * V_18 , struct V_96 * V_97 )
{
...
V_18 -> V_129 . V_78 , F_57 ( struct V_17 , V_129 ) ,
V_80 , V_81 ) ;
if ( F_58 ( V_15 ) ) {
V_128 = F_59 ( V_15 ) ;
V_15 = NULL ;
...
if ( ! V_128 ) {
F_52 ( V_97 -> V_119 , V_18 ) ;
if ( ! ( V_18 -> V_113 & V_124 ) )
F_61 ( V_97 -> V_119 , V_84 , V_18 ) ;
}
V_75:
if ( V_128 ) {
#ifdef F_60
...
V_84 -> V_35 = F_63 ( V_97 -> V_119 , V_84 ) ;
#if V_136 >= 2
if ( ! V_84 -> V_35 ) {
F_28 ( V_84 -> V_35 == NULL ) ;
...
F_64 ( V_97 -> V_119 , V_15 ) ;
F_13 ( & V_18 -> V_20 ) ;
return V_128 ;
#endif
}
static struct V_14 * F_65 ( struct V_14 * V_60 ,
struct V_137 * args )
{
struct V_14 * V_15 ;
T_3 V_88 ;
...
struct V_14 * F_68 ( struct V_14 * V_60 , const struct V_130 * V_138 ,
const struct V_130 * V_139 )
{
struct V_14 * V_15 ;
struct V_137 args [] = {
{
. V_79 = F_57 ( struct V_17 , V_129 ) ,
. V_11 = V_138 ,
} ,
#ifdef F_60
{
. V_79 = F_57 ( struct V_17 , V_131 ) ,
. V_11 = V_139 ,
} ,
#endif
{
...
V_15 = F_65 ( V_60 , V_138 ? args : args + 1 ) ;
if ( ! V_15 || V_15 -> V_37 & V_39 )
V_15 = V_60 ;
return V_15 ;
}
static struct V_14 * F_69 ( struct V_14 * V_60 ,
...
struct V_14 * F_70 ( struct V_14 * V_60 ,
const struct V_130 * V_138 , int V_140 ,
const struct V_130 * V_139 , int V_141 )
{
struct V_14 * V_15 ;
V_15 = F_69 ( V_60 , V_138 , V_140 ,
F_57 ( struct V_17 , V_129 ) ) ;
#ifdef F_60
if ( V_141 ) {
F_28 ( V_139 == NULL ) ;
if ( V_15 && V_15 -> V_133 )
V_15 = F_69 ( V_15 -> V_133 , V_139 , V_141 ,
F_57 ( struct V_17 , V_131 ) ) ;
}
#endif
if ( V_15 && V_15 -> V_37 & V_40 )
...
static struct V_17 * F_63 ( struct V_21 * V_21 , struct V_14 * V_15 )
{
if ( V_15 -> V_37 & V_38 )
...
static struct V_14 * F_64 ( struct V_21 * V_21 ,
struct V_14 * V_15 )
{
int V_142 ;
int V_143 ;
...
if ( V_142 == 3 || F_67 ( V_15 )
#ifdef F_60
|| ( V_142 && V_15 -> V_37 & V_38 )
#endif
) {
V_15 -> V_35 = F_63 ( V_21 , V_15 ) ;
#if V_136 >= 2
if ( ! V_15 -> V_35 ) {
F_28 ( ! V_15 -> V_35 ) ;
...
static void F_74 ( struct V_14 * V_15 , struct V_17 * * V_149 ,
struct V_96 * V_97 )
{
struct V_1 * V_2 ;
...
F_76 ( F_75 ( & V_18 -> V_19 ) != 1 ) ;
}
F_51 ( V_151 , V_18 , V_97 ) ;
F_11 ( V_18 ) ;
}
int F_77 ( struct V_17 * V_18 , struct V_96 * V_97 )
{
struct V_21 * V_21 = V_97 -> V_119 ;
...
int V_53 ;
struct V_17 * V_18 ;
struct V_155 * V_156 = F_79 ( V_2 , struct V_155 , V_2 ) ;
struct V_96 V_97 = {
. V_119 = V_156 -> V_21 ,
} ;
for ( V_18 = V_2 -> V_35 ; V_18 ; V_18 = V_18 -> V_20 . V_54 ) {
...
static void F_81 ( struct V_21 * V_21 , struct V_14 * V_60 ,
...
void F_82 ( struct V_21 * V_21 , int (* V_73)( struct V_17 * , void * V_71 ) ,
int V_153 , void * V_71 )
{
struct V_22 * V_32 ;
struct V_44 * V_45 ;
...
void F_83 ( struct V_21 * V_21 , int (* V_73)( struct V_17 * , void * V_71 ) ,
int V_153 , void * V_71 )
{
struct V_22 * V_32 ;
struct V_44 * V_45 ;
...
static int F_84 ( struct V_17 * V_18 , void * V_71 )
{
if ( V_18 -> V_113 & V_124 ) {
F_40 ( L_14 , V_18 ) ;
return - 1 ;
...
static void F_61 ( struct V_21 * V_21 , struct V_14 * V_15 ,
struct V_17 * V_18 )
{
F_81 ( V_21 , V_15 , F_84 , 1 , V_18 ) ;
}
static int F_85 ( struct V_17 * V_18 , void * V_71 )
{
unsigned long V_158 = V_125 ;
if ( V_18 -> V_113 & V_114 && V_18 -> V_20 . V_115 ) {
if ( F_86 ( V_158 , V_18 -> V_20 . V_115 ) ) {
F_40 ( L_15 , V_18 ) ;
return - 1 ;
}
V_159 . V_160 ++ ;
} else if ( V_18 -> V_113 & V_124 ) {
if ( F_75 ( & V_18 -> V_20 . V_161 ) == 0 &&
F_87 ( V_158 , V_18 -> V_20 . V_162 + V_159 . V_163 ) ) {
F_40 ( L_16 , V_18 ) ;
return - 1 ;
} else if ( V_18 -> V_113 & V_164 ) {
struct V_165 * V_166 ;
T_7 V_167 = 0 ;
V_166 = F_88 ( & V_18 -> V_20 , & V_18 -> V_112 ) ;
if ( V_166 ) {
V_167 = V_166 -> V_51 ;
F_89 ( V_166 ) ;
}
...
void F_90 ( unsigned long V_115 , struct V_21 * V_21 )
{
if ( V_115 != ~ 0UL ) {
F_91 ( & V_169 ) ;
...
if ( ! F_92 ( & V_169 ) ) {
F_54 ( & V_21 -> V_29 . V_123 , V_125 + V_170 ) ;
return;
}
V_159 . V_163 = V_21 -> V_29 . V_126 . V_127 ;
}
V_159 . V_160 = F_93 () ;
F_83 ( V_21 , F_85 , 0 , NULL ) ;
if ( V_159 . V_160 )
F_54 ( & V_21 -> V_29 . V_123 ,
F_94 ( V_125
+ V_21 -> V_29 . V_126 . V_127 ) ) ;
else
F_95 ( & V_21 -> V_29 . V_123 ) ;
F_96 ( & V_169 ) ;
}
static void F_97 ( unsigned long V_71 )
{
F_90 ( 0 , (struct V_21 * ) V_71 ) ;
}
static int T_4 F_98 ( struct V_21 * V_21 )
{
T_8 V_171 = sizeof( struct V_42 ) * V_27 ;
F_99 ( & V_21 -> V_29 . V_123 , F_97 , ( unsigned long ) V_21 ) ;
V_21 -> V_29 . V_120 = F_18 ( sizeof( * V_21 -> V_29 . V_120 ) , V_172 ) ;
if ( ! V_21 -> V_29 . V_120 )
goto V_173;
V_171 = F_100 ( T_8 , V_171 , V_174 ) ;
V_21 -> V_29 . V_30 = F_18 ( V_171 , V_172 ) ;
if ( ! V_21 -> V_29 . V_30 )
goto V_175;
...
static void F_102 ( struct V_21 * V_21 )
{
F_103 ( V_21 , NULL ) ;
F_104 ( & V_21 -> V_29 . V_123 ) ;
#ifdef F_101
F_30 ( V_21 -> V_29 . V_47 ) ;
#endif
F_30 ( V_21 -> V_29 . V_46 ) ;
...
if ( V_179 )
goto V_182;
V_179 = F_108 ( V_183 , V_184 , NULL , F_37 ,
NULL ) ;
if ( V_179 )
goto V_185;
V_75:
