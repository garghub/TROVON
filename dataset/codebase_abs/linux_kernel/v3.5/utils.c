...
int F_13 ( const char * V_18 , T_2 * V_43 )
{
int V_5 ;
if ( strlen ( V_18 ) < 3 * V_44 - 1 )
return 0 ;
for ( V_5 = 0 ; V_5 < V_44 ; V_5 ++ ) {
if ( ! strchr ( L_1 , V_18 [ V_5 * 3 ] ) )
return 0 ;
if ( ! strchr ( L_1 , V_18 [ V_5 * 3 + 1 ] ) )
return 0 ;
if ( V_5 != V_44 - 1 && V_18 [ V_5 * 3 + 2 ] != ':' )
return 0 ;
}
for ( V_5 = 0 ; V_5 < V_44 ; V_5 ++ ) {
V_43 [ V_5 ] = ( F_6 ( V_18 [ V_5 * 3 ] ) << 4 ) | F_6 ( V_18 [ V_5 * 3 + 1 ] ) ;
}
return 1 ;
}
