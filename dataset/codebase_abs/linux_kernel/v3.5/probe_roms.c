...
struct V_1 * F_12 ( struct V_2 * V_3 , const struct V_23 * V_24 )
{
struct V_1 * V_25 = NULL , * V_26 ;
int V_7 , V_8 ;
if ( F_13 ( & V_24 , V_27 , & V_3 -> V_14 ) != 0 )
return NULL ;
...
if ( F_14 ( V_3 ) || F_15 ( V_3 ) )
goto V_29;
for ( V_7 = 0 ; V_7 < F_16 ( V_25 -> V_30 ) ; V_7 ++ )
for ( V_8 = 0 ; V_8 < F_16 ( V_25 -> V_30 [ V_7 ] . V_31 ) ; V_8 ++ ) {
