...
if ( F_26 ( V_27 + 5 , 0 , & V_24 ) == 0 )
V_28 . V_31 = V_24 ;
return NULL ;
}
return V_27 ;
}
void T_1 F_27 ( struct V_3 T_2 * V_4 ,
...
>> 4 ,
& V_4 -> V_44 ) ;
F_31 ((channel->io_resource->start +
...
- V_2 -> V_50 -> V_43 ) >> 4 ,
& V_4 -> V_47 [ 0 ] ) ;
F_31 (channel->mem_resource->start |
#ifdef F_12
...
F_7 ( 0 , & V_4 -> V_54 ) ;
F_7 ( 0 , & V_4 -> V_55 ) ;
F_31 (TX4927_PCIC_P2GMnGBASE_TMEMEN |
#ifdef F_12
...
static void F_33 ( struct V_3 T_2 * V_4 )
{
T_7 V_15 = ( T_7 ) ( F_8 ( & V_4 -> V_15 ) >> 16 ) ;
T_8 V_68 = F_8 ( & V_4 -> V_68 ) ;
T_8 V_19 = F_8 ( & V_4 -> V_19 ) ;
static struct {
T_8 V_81 ;
const char * V_27 ;
} V_82 [] = {
...
static void F_35 ( struct V_3 T_2 * V_4 )
{
int V_5 ;
T_8 T_2 * V_102 = ( T_8 T_2 * ) V_4 ;
F_28 ( V_35 L_34 , V_4 ) ;
...
if ( V_5 == F_36 ( struct V_3 , V_103 )
|| V_5 == F_36 ( struct V_3 , V_104 )
|| V_5 == F_36 ( struct V_3 , V_14 )
|| V_5 == F_36 ( struct V_3 , V_23 ) ) {
F_28 ( V_101 L_36 ) ;
continue;
}
F_28 ( V_101 L_37 , F_8 ( V_102 ) ) ;
}
F_28 ( V_101 L_33 ) ;
}
void F_37 ( void )
...
T_9 F_38 ( int V_105 , void * V_106 )
{
struct V_107 * V_108 = F_39 () ;
struct V_3 T_2 * V_4 =
...
static void T_6 F_42 ( struct V_117 * V_118 )
{
