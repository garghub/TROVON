...
V_33 = F_23 ( F_20 ( V_5 -> V_16 ) , V_33 , & V_34 ,
V_30 , V_31 ) ;
if ( V_33 > 0 )
* V_32 += V_33 ;
V_38:
...
V_41 = F_38 () ;
V_41 <<= V_59 ;
error = F_33 ( V_41 , ( T_4 T_2 * ) V_40 ) ;
break;
case V_60 :
V_41 = F_39 ( V_5 -> V_19 , 1 ) ;
V_41 <<= V_59 ;
error = F_33 ( V_41 , ( T_4 T_2 * ) V_40 ) ;
break;
case V_61 :
...
static long
F_47 ( struct V_2 * V_2 , unsigned int V_39 , unsigned long V_40 )
{
F_48 ( sizeof( T_4 ) != sizeof( V_77 ) ) ;
switch ( V_39 ) {
case V_58 :
case V_60 :
case V_61 : {
V_77 T_2 * V_78 = F_49 ( V_40 ) ;
T_4 V_42 ;
T_7 V_79 ;
int V_80 ;
V_79 = F_50 () ;
...
F_51 ( V_79 ) ;
if ( ! V_80 && F_33 ( V_42 , V_78 ) )
V_80 = - V_74 ;
return V_80 ;
}
case V_51 :
return F_24 ( V_2 , V_39 ,
( unsigned long ) F_49 ( V_40 ) ) ;
case V_70 : {
...
T_7 V_79 ;
int V_80 ;
V_80 = F_52 ( V_72 . V_42 , & V_83 -> V_42 ) ;
V_80 |= F_52 ( V_72 . V_75 , & V_83 -> V_75 ) ;
if ( V_80 )
return - V_74 ;
V_79 = F_50 () ;
F_51 ( V_81 ) ;
