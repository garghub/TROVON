...
static void T_2 F_13 ( struct V_1 * type , unsigned long V_28 )
{
...
static int T_2 F_19 ( struct V_1 * type ,
T_1 V_33 ,
T_1 V_34 )
{
...
F_24 ( L_5 ,
F_1 ( type ) , type -> F_8 * 2 , ( T_3 ) V_30 , ( T_3 ) V_30 + V_40 - 1 ) ;
...
static void T_2 F_29 ( struct V_1 * type )
{
int V_12 = 0 ;
...
static void T_2 F_31 ( struct V_1 * type ,
int V_50 , T_1 V_5 ,
T_1 V_6 , int V_20 )
{
...
static int T_2 F_32 ( struct V_1 * type ,
...
static int T_2 F_36 ( struct V_1 * type ,
T_1 V_5 , T_1 V_6 )
{
int V_59 , V_60 ;
int V_12 , V_61 ;
...
int T_2 F_37 ( T_1 V_5 , T_1 V_6 )
{
return F_36 ( & V_2 . V_3 , V_5 , V_6 ) ;
}
int T_2 F_26 ( T_1 V_5 , T_1 V_6 )
{
F_24 ( L_6 ,
...
void T_2 F_38 ( T_3 * V_50 , int V_20 ,
T_1 * V_64 ,
T_1 * V_65 , int * V_66 )
{
...
T_1 V_72 = V_71 -> V_5 ;
T_1 V_73 = V_71 -> V_5 + V_71 -> V_6 ;
if ( V_20 != V_27 && V_20 != F_30 ( V_71 ) )
continue;
for ( ; V_70 < V_68 -> V_13 + 1 ; V_70 ++ ) {
struct V_32 * V_28 = & V_68 -> V_15 [ V_70 ] ;
T_1 V_74 = V_70 ? V_28 [ - 1 ] . V_5 + V_28 [ - 1 ] . V_6 : 0 ;
T_1 V_75 = V_70 < V_68 -> V_13 ? V_28 -> V_5 : V_7 ;
if ( V_74 >= V_73 )
break;
if ( V_72 < V_75 ) {
if ( V_64 )
...
void T_2 F_39 ( T_3 * V_50 , int V_20 ,
T_1 * V_64 ,
T_1 * V_65 , int * V_66 )
{
struct V_1 * V_67 = & V_2 . V_3 ;
...
void T_2 F_40 ( int * V_50 , int V_20 ,
unsigned long * V_77 ,
...
T_1 T_4 F_46 ( T_1 V_6 , T_1 V_19 , int V_20 )
{
return F_44 ( V_6 , V_19 , V_24 , V_20 ) ;
}
T_1 T_4 F_47 ( T_1 V_6 , T_1 V_19 , T_1 V_79 )
{
return F_44 ( V_6 , V_19 , V_79 , V_27 ) ;
}
T_1 T_4 F_48 ( T_1 V_6 , T_1 V_19 , T_1 V_79 )
{
T_1 V_81 ;
...
T_1 T_4 F_50 ( T_1 V_6 , T_1 V_19 )
{
return F_48 ( V_6 , V_19 , V_24 ) ;
}
T_1 T_4 F_51 ( T_1 V_6 , T_1 V_19 , int V_20 )
{
T_1 V_82 = F_46 ( V_6 , V_19 , V_20 ) ;
if ( V_82 )
return V_82 ;
return F_48 ( V_6 , V_19 , V_24 ) ;
}
...
F_36 ( & V_2 . V_3 , V_79 , ( T_1 ) V_7 ) ;
F_36 ( & V_2 . V_4 , V_79 , ( T_1 ) V_7 ) ;
}
static int T_2 F_56 ( struct V_1 * type , T_1 V_30 )
{
...
int T_4 F_57 ( T_1 V_30 )
{
return F_56 ( & V_2 . V_4 , V_30 ) != - 1 ;
}
int T_2 F_58 ( T_1 V_30 )
{
...
int T_2 F_60 ( T_1 V_5 , T_1 V_6 )
{
F_2 ( V_5 , & V_6 ) ;
return F_5 ( & V_2 . V_4 , V_5 , V_6 ) >= 0 ;
}
void T_2 F_61 ( T_1 V_83 )
{
V_2 . V_25 = V_83 ;
}
static void T_2 F_62 ( struct V_1 * type , char * V_87 )
{
unsigned long long V_5 , V_6 ;
int V_12 ;
F_63 ( L_9 , V_87 , type -> V_13 ) ;
for ( V_12 = 0 ; V_12 < type -> V_13 ; V_12 ++ ) {
struct V_32 * V_51 = & type -> V_15 [ V_12 ] ;
char V_88 [ 32 ] = L_10 ;
V_5 = V_51 -> V_5 ;
...
#ifdef F_64
if ( F_30 ( V_51 ) != V_27 )
snprintf ( V_88 , sizeof( V_88 ) , L_11 ,
F_30 ( V_51 ) ) ;
#endif
F_63 ( L_12 ,
V_87 , V_12 , V_5 , V_5 + V_6 - 1 , V_6 , V_88 ) ;
}
}
void T_2 F_65 ( void )
{
...
static int T_4 F_67 ( char * V_89 )
{
if ( V_89 && strstr ( V_89 , L_15 ) )
V_90 = 1 ;
return 0 ;
}
static int F_68 ( struct V_91 * V_71 , void * V_92 )
{
struct V_1 * type = V_71 -> V_92 ;
struct V_32 * V_93 ;
int V_12 ;
for ( V_12 = 0 ; V_12 < type -> V_13 ; V_12 ++ ) {
V_93 = & type -> V_15 [ V_12 ] ;
...
if ( sizeof( T_1 ) == 4 )
F_69 ( V_71 , L_17 ,
( unsigned long ) V_93 -> V_5 ,
( unsigned long ) ( V_93 -> V_5 + V_93 -> V_6 - 1 ) ) ;
else
F_69 ( V_71 , L_18 ,
( unsigned long long ) V_93 -> V_5 ,
( unsigned long long ) ( V_93 -> V_5 + V_93 -> V_6 - 1 ) ) ;
}
return 0 ;
}
static int F_70 ( struct V_94 * V_94 , struct V_95 * V_95 )
{
return F_71 ( V_95 , F_68 , V_94 -> V_96 ) ;
}
static int T_4 F_72 ( void )
{
struct V_97 * V_98 = F_73 ( L_19 , NULL ) ;
if ( ! V_98 )
return - V_99 ;
F_74 ( L_1 , V_100 , V_98 , & V_2 . V_3 , & V_101 ) ;
F_74 ( L_2 , V_100 , V_98 , & V_2 . V_4 , & V_101 ) ;
return 0 ;
}
