...
V_49 -> V_58 = F_64 ( V_49 -> V_57 ) ;
V_49 -> V_69 = F_65 ( V_49 -> V_57 ) ;
memset ( V_49 -> V_58 , 0 , F_61 ( V_49 -> V_68 * 8 ) ) ;
V_70:
for ( V_24 = 0 ; V_24 < V_2 -> V_41 . V_71 ; V_24 ++ ) {
...
V_15 = V_2 -> V_41 . V_46 -> V_72 ( V_2 , V_49 , V_52 ) ;
if ( V_15 ) {
F_44 ( V_2 , & V_49 -> V_57 , NULL ) ;
return V_15 ;
}
...
V_49 -> V_52 = V_52 ;
F_59 ( & V_49 -> V_56 , & V_2 -> V_41 . V_66 ) ;
return F_66 ( V_2 , V_49 , V_2 -> V_73 . V_60 ,
& V_2 -> V_73 . V_60 -> V_74 . V_75 ) ;
}
...
F_56 ( & V_49 -> V_64 ) ;
if ( V_68 > V_49 -> V_68 ) {
unsigned V_86 = ( ( 32 << 20 ) >> 12 ) - 1 ;
F_40 ( V_2 , V_49 ) ;
V_49 -> V_68 = ( V_68 + V_86 ) & ~ V_86 ;
}
F_53 ( & V_2 -> V_63 ) ;
}
V_79 = & V_49 -> V_87 ;
...
if ( V_51 -> V_82 >= V_81 && V_51 -> V_83 < V_62 -> V_82 ) {
break;
}
if ( V_51 -> V_82 >= V_62 -> V_82 && V_51 -> V_82 < V_62 -> V_83 ) {
F_39 ( V_2 -> V_45 , L_7 ,
V_60 , ( unsigned ) V_51 -> V_82 , V_62 -> V_60 ,
( unsigned ) V_62 -> V_82 , ( unsigned ) V_62 -> V_83 ) ;
F_35 ( V_51 ) ;
F_57 ( & V_49 -> V_64 ) ;
return - V_35 ;
}
...
V_89 = V_51 -> V_82 / V_28 ;
V_77 = V_2 -> V_41 . V_46 -> V_100 ( V_2 , V_51 -> V_49 , V_51 -> V_77 ) ;
for ( V_24 = 0 , V_31 = 0 ; V_24 < V_96 ; V_24 ++ ) {
if ( V_75 && V_51 -> V_59 ) {
V_31 = F_71 ( V_2 , V_75 , V_24 ) ;
}
V_2 -> V_41 . V_46 -> V_101 ( V_2 , V_51 -> V_49 , V_24 + V_89 , V_31 , V_77 ) ;
}
V_2 -> V_41 . V_46 -> V_102 ( V_2 , V_51 -> V_49 ) ;
return 0 ;
}
...
{
struct V_50 * V_51 ;
F_76 ( ! F_77 ( & V_60 -> V_74 . V_103 ) ) ;
F_45 (bo_va, &bo->va, bo_list) {
V_51 -> V_59 = false ;
}
}
int F_78 ( struct V_1 * V_2 , struct V_48 * V_49 )
{
int V_15 ;
V_49 -> V_52 = - 1 ;
V_49 -> V_53 = NULL ;
...
F_69 ( & V_49 -> V_87 ) ;
if ( V_2 -> V_9 >= V_104 )
V_49 -> V_68 = V_2 -> V_41 . V_44 ;
else
V_49 -> V_68 = 0 ;
V_15 = F_67 ( V_2 , V_49 , V_2 -> V_73 . V_60 , 0 ,
V_105 | V_106 ) ;
return V_15 ;
}
void F_80 ( struct V_1 * V_2 , struct V_48 * V_49 )
{
struct V_50 * V_51 , * V_62 ;
int V_15 ;
F_51 ( & V_2 -> V_63 ) ;
...
F_40 ( V_2 , V_49 ) ;
F_53 ( & V_2 -> V_63 ) ;
V_15 = F_11 ( V_2 -> V_73 . V_60 , false ) ;
if ( ! V_15 ) {
V_51 = V_50 ( V_2 -> V_73 . V_60 , V_49 ) ;
F_43 ( & V_51 -> V_84 ) ;
F_43 ( & V_51 -> V_85 ) ;
F_14 ( V_2 -> V_73 . V_60 ) ;
F_35 ( V_51 ) ;
