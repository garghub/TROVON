...
static int F_81 ( struct V_208 * V_44 , T_7 V_209 )
{
struct V_210 * V_134 = F_82 ( V_44 ) ;
...
F_72 ( V_44 ) ;
F_87 ( V_44 ) ;
F_88 ( V_44 , F_89 ( V_44 , V_209 ) ) ;
return 0 ;
}
static int F_90 ( struct V_208 * V_44 )
{
struct V_210 * V_134 = F_82 ( V_44 ) ;
struct V_24 * V_25 = V_134 -> V_56 ;
void T_2 * V_180 = V_25 -> V_180 ;
...
int V_49 ;
for ( V_49 = 0 ; V_49 < V_176 ; V_49 ++ ) {
V_25 -> V_45 [ V_49 ] = F_99 ( 4096 , V_216 ) ;
if ( ! V_25 -> V_45 [ V_49 ] )
return - V_58 ;
}
memset ( V_25 -> V_45 [ 0 ] , 0 , 4096 ) ;
...
if ( V_116 )
goto V_221;
if ( F_93 ( V_44 -> V_22 , F_8 , V_213 , V_214 ,
V_25 ) ) {
...
V_116 = F_111 ( V_134 , V_223 , V_25 , & V_169 ) ;
if ( V_116 )
goto V_221;
...
static int T_6 F_113 ( struct V_208 * V_44 ,
...
if ( ! V_186 )
V_186 = V_173 ;
V_116 = F_114 ( V_228 , V_229 , V_230 , sizeof( * V_25 ) , & V_134 ) ;
if ( V_116 < 0 )
goto V_219;
...
L_13 ,
V_134 -> V_232 , F_115 ( V_25 -> V_114 [ 0 ] ) ,
V_25 -> V_27 , V_25 -> V_22 ) ;
V_116 = F_116 ( V_134 ) ;
if ( V_116 )
goto V_233;
...
static void T_8 F_119 ( struct V_208 * V_44 )
{
F_118 ( F_82 ( V_44 ) ) ;
F_117 ( V_44 , NULL ) ;
}
