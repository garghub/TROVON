...
if ( F_1 ( V_2 ) )
return - V_29 ;
V_23 = F_4 ( V_30 , V_2 -> V_31 , V_32 ) ;
V_24 = F_4 ( V_30 , V_2 -> V_31 , V_33 ) ;
...
V_27 = F_7 ( V_36 , ( V_37 * ) V_3 ,
F_8 ( struct V_14 , V_38 ) ) ;
if ( V_27 == V_3 -> V_38 ) {
...
V_15 = F_12 ( sizeof( * V_15 ) * V_12 + 10 * V_12 , V_49 ) ;
if ( ! V_15 ) {
F_6 ( V_3 ) ;
return - V_34 ;
}
...
F_9 ( L_11 , V_26 ,
V_15 [ V_26 ] . V_50 , ( long unsigned int ) ( V_15 [ V_26 ] . V_51 ) ,
( long unsigned int ) ( V_15 [ V_26 ] . V_48 ) ) ;
F_9 ( L_12 , V_18 ,
V_21 ) ;
* V_9 = V_15 ;
F_6 ( V_3 ) ;
