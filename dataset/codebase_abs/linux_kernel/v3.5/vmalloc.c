...
void T_7 F_138 ( struct V_107 * V_108 )
{
...
void T_7 F_139 ( struct V_107 * V_108 , T_8 V_41 )
{
static T_8 T_9 V_110 ;
unsigned long V_2 ;
V_2 = F_58 ( V_62 + T_9 , V_41 ) ;
T_9 = F_140 ( V_2 + V_108 -> V_40 ) - V_62 ;
V_108 -> V_2 = ( void * ) V_2 ;
F_138 ( V_108 ) ;
}
void T_7 F_141 ( void )
...
V_30 = F_142 ( sizeof( struct V_26 ) , V_111 ) ;
V_30 -> V_59 = V_112 ;
...
int F_143 ( unsigned long V_2 , unsigned long V_40 ,
T_5 V_11 , struct V_12 * * V_13 )
{
...
int F_146 ( struct V_107 * V_113 , T_5 V_11 , struct V_12 * * * V_13 )
{
...
static void F_147 ( struct V_107 * V_108 , struct V_26 * V_30 ,
...
static void F_148 ( struct V_107 * V_108 )
{
struct V_107 * V_35 , * * V_33 ;
V_108 -> V_59 &= ~ V_115 ;
F_149 ( & V_116 ) ;
...
static void F_151 ( struct V_107 * V_108 , struct V_26 * V_30 ,
unsigned long V_59 , void * V_114 )
{
F_147 ( V_108 , V_30 , V_59 , V_114 ) ;
F_148 ( V_108 ) ;
}
static struct V_107 * F_152 ( unsigned long V_40 ,
...
if ( F_55 ( ! V_40 ) )
return NULL ;
V_113 = F_155 ( sizeof( * V_113 ) , V_45 & V_49 , V_44 ) ;
if ( F_55 ( ! V_113 ) )
return NULL ;
V_40 += V_7 ;
...
if ( V_59 & V_115 )
F_147 ( V_113 , V_30 , V_59 , V_114 ) ;
else
F_151 ( V_113 , V_30 , V_59 , V_114 ) ;
return V_113 ;
}
struct V_107 * F_156 ( unsigned long V_40 , unsigned long V_59 ,
unsigned long V_17 , unsigned long V_3 )
{
return F_152 ( V_40 , 1 , V_59 , V_17 , V_3 , - 1 , V_106 ,
F_157 ( 0 ) ) ;
}
...
{
return F_152 ( V_40 , 1 , V_59 , V_62 , V_63 ,
- 1 , V_106 , F_157 ( 0 ) ) ;
}
...
static struct V_107 * F_161 ( const void * V_2 )
{
struct V_26 * V_30 ;
...
static void F_163 ( const void * V_2 , int V_120 )
{
struct V_107 * V_113 ;
if ( ! V_2 )
return;
if ( ( V_7 - 1 ) & ( unsigned long ) V_2 ) {
F_164 ( 1 , V_121 L_3 , V_2 ) ;
return;
}
V_113 = F_162 ( V_2 ) ;
if ( F_55 ( ! V_113 ) ) {
...
void * F_171 ( struct V_12 * * V_13 , unsigned int V_105 ,
...
if ( V_105 > V_124 )
return NULL ;
V_113 = F_160 ( ( V_105 << V_73 ) , V_59 ,
F_157 ( 0 ) ) ;
if ( ! V_113 )
return NULL ;
if ( F_146 ( V_113 , V_11 , & V_13 ) ) {
F_169 ( V_113 -> V_2 ) ;
return NULL ;
}
return V_113 -> V_2 ;
}
static void * F_172 ( struct V_107 * V_113 , T_6 V_45 ,
...
V_113 -> V_122 = V_122 ;
if ( V_125 > V_7 ) {
V_13 = F_173 ( V_125 , 1 , V_126 | V_128 ,
V_129 , V_44 , V_114 ) ;
V_113 -> V_59 |= V_123 ;
} else {
...
goto V_132;
V_113 = F_152 ( V_40 , V_41 , V_134 | V_115 ,
V_17 , V_3 , V_44 , V_45 , V_114 ) ;
if ( ! V_113 )
goto V_132;
V_2 = F_172 ( V_113 , V_45 , V_11 , V_44 , V_114 ) ;
if ( ! V_2 )
return NULL ;
F_148 ( V_113 ) ;
F_178 ( V_2 , V_133 , 3 , V_45 ) ;
return V_2 ;
V_132:
F_176 ( V_45 , 0 ,
L_6 ,
...
int V_44 , void * V_114 )
{
return F_177 ( V_40 , V_41 , V_62 , V_63 ,
...
int V_44 , T_6 V_59 )
{
return F_173 ( V_40 , 1 , V_59 , V_129 ,
V_44 , F_157 ( 0 ) ) ;
}
void * F_181 ( unsigned long V_40 )
{
return F_180 ( V_40 , - 1 , V_106 | V_128 ) ;
}
...
{
return F_173 ( V_40 , 1 , V_106 | V_128 , V_129 ,
V_44 , F_157 ( 0 ) ) ;
}
...
{
return F_173 ( V_40 , 1 , V_106 | V_128 , V_137 ,
- 1 , F_157 ( 0 ) ) ;
}
void * F_187 ( unsigned long V_40 )
{
return F_173 ( V_40 , 1 , V_138 , V_129 ,
- 1 , F_157 ( 0 ) ) ;
}
...
struct V_107 * V_113 ;
void * V_19 ;
V_19 = F_173 ( V_40 , 1 , V_138 | V_127 , V_129 ,
- 1 , F_157 ( 0 ) ) ;
if ( V_19 ) {
V_113 = F_161 ( V_19 ) ;
V_113 -> V_59 |= V_136 ;
...
static int F_192 ( char * V_139 , char * V_2 , unsigned long V_105 )
{
struct V_12 * V_33 ;
int V_140 = 0 ;
while ( V_105 ) {
...
long F_196 ( char * V_139 , char * V_2 , unsigned long V_105 )
{
struct V_107 * V_35 ;
char * V_143 ;
...
int F_197 ( struct V_147 * V_148 , void * V_2 ,
unsigned long V_149 )
{
struct V_107 * V_113 ;
...
static int F_199 ( T_2 * V_4 , T_10 V_157 , unsigned long V_2 , void * V_158 )
{
T_2 * * * V_33 = V_158 ;
if ( V_33 ) {
* ( * V_33 ) = V_4 ;
...
struct V_107 * F_200 ( T_8 V_40 , T_2 * * V_159 )
{
struct V_107 * V_113 ;
V_113 = F_160 ( V_40 , V_117 ,
F_157 ( 0 ) ) ;
if ( V_113 == NULL )
return NULL ;
if ( F_201 ( & V_6 , ( unsigned long ) V_113 -> V_2 ,
V_40 , F_199 , V_159 ? & V_159 : NULL ) ) {
F_202 ( V_113 ) ;
return NULL ;
}
return V_113 ;
}
void F_202 ( struct V_107 * V_113 )
{
struct V_107 * V_19 ;
V_19 = F_162 ( V_113 -> V_2 ) ;
F_16 ( V_19 != V_113 ) ;
F_64 ( V_113 ) ;
}
...
if ( V_30 -> va_end > V_3 ) {
* V_160 = V_30 ;
* V_161 = F_203 ( F_50 ( & ( * V_160 ) -> V_27 ) ) ;
} else {
* V_161 = V_30 ;
* V_160 = F_203 ( F_59 ( & ( * V_161 ) -> V_27 ) ) ;
}
return true ;
}
static unsigned long F_205 ( struct V_26 * * V_160 ,
struct V_26 * * V_161 ,
unsigned long V_41 )
{
...
unsigned long V_2 ;
if ( * V_160 )
V_2 = F_206 ( ( * V_160 ) -> va_start & ~ ( V_41 - 1 ) , V_162 ) ;
else
V_2 = V_162 ;
...
struct V_107 * * F_207 ( const unsigned long * V_163 ,
...
F_16 ( ! F_208 ( V_163 [ V_113 ] , V_41 ) ) ;
F_16 ( ! F_208 ( V_164 [ V_113 ] , V_41 ) ) ;
if ( V_17 > V_163 [ V_170 ] )
V_170 = V_113 ;
...
V_168 = F_209 ( V_165 , sizeof( V_168 [ 0 ] ) , V_106 ) ;
V_167 = F_209 ( V_165 , sizeof( V_167 [ 0 ] ) , V_106 ) ;
if ( ! V_167 || ! V_168 )
goto V_176;
for ( V_113 = 0 ; V_113 < V_165 ; V_113 ++ ) {
V_167 [ V_113 ] = F_142 ( sizeof( struct V_26 ) , V_106 ) ;
V_168 [ V_113 ] = F_142 ( sizeof( struct V_107 ) , V_106 ) ;
...
V_17 = V_163 [ V_113 ] ;
V_3 = V_17 + V_164 [ V_113 ] ;
if ( ! F_204 ( V_64 , & V_9 , & V_37 ) ) {
V_172 = V_162 - V_173 ;
goto V_58;
}
V_172 = F_205 ( & V_9 , & V_37 , V_41 ) - V_3 ;
while ( true ) {
...
F_60 ( & V_51 ) ;
for ( V_113 = 0 ; V_113 < V_165 ; V_113 ++ )
F_151 ( V_168 [ V_113 ] , V_167 [ V_113 ] , V_134 ,
F_207 ) ;
F_64 ( V_167 ) ;
return V_168 ;
V_177:
...
void F_210 ( struct V_107 * * V_168 , int V_165 )
{
int V_97 ;
...
static void * F_211 ( struct V_178 * V_179 , T_11 * V_180 )
__acquires( &vmlist_lock
static void * F_212 ( struct V_178 * V_179 , void * V_33 , T_11 * V_180 )
{
struct V_107 * V_181 = V_33 ;
++ * V_180 ;
return V_181 -> V_9 ;
}
static void F_213 ( struct V_178 * V_179 , void * V_33 )
__releases( &vmlist_lock
static void F_214 ( struct V_178 * V_179 , struct V_107 * V_181 )
{
if ( V_182 ) {
...
V_183 [ F_215 ( V_181 -> V_13 [ V_14 ] ) ] ++ ;
F_216 (nr, N_HIGH_MEMORY)
if ( V_183 [ V_14 ] )
F_217 ( V_179 , L_7 , V_14 , V_183 [ V_14 ] ) ;
}
}
static int F_218 ( struct V_178 * V_179 , void * V_33 )
{
struct V_107 * V_181 = V_33 ;
F_217 ( V_179 , L_8 ,
V_181 -> V_2 , V_181 -> V_2 + V_181 -> V_40 , V_181 -> V_40 ) ;
if ( V_181 -> V_114 )
F_217 ( V_179 , L_9 , V_181 -> V_114 ) ;
if ( V_181 -> V_122 )
F_217 ( V_179 , L_10 , V_181 -> V_122 ) ;
if ( V_181 -> V_186 )
F_217 ( V_179 , L_11 , ( unsigned long long ) V_181 -> V_186 ) ;
if ( V_181 -> V_59 & V_117 )
F_217 ( V_179 , L_12 ) ;
if ( V_181 -> V_59 & V_134 )
F_217 ( V_179 , L_13 ) ;
...
static int F_220 ( struct V_188 * V_188 , struct V_189 * V_189 )
{
unsigned int * V_190 = NULL ;
int V_19 ;
if ( V_182 ) {
V_190 = F_221 ( V_185 * sizeof( unsigned int ) , V_106 ) ;
if ( V_190 == NULL )
return - V_15 ;
}
V_19 = F_222 ( V_189 , & V_191 ) ;
if ( ! V_19 ) {
