...
V_7 -> V_135 = V_135 ;
F_111 ( & V_7 -> V_199 ) ;
F_112 ( V_230 , & V_7 -> V_135 -> V_105 ) ;
V_7 -> V_135 -> V_199 = & V_7 -> V_199 ;
F_85 ( & V_7 -> V_107 ) ;
F_113 ( V_7 -> V_135 , V_7 ) ;
F_114 ( & V_7 -> V_199 ) ;
V_94 = F_115 ( V_7 -> V_135 , V_231 , - 1 ) ;
if ( V_94 < 0 ) {
F_116 ( V_7 -> V_135 ) ;
goto V_228;
}
V_7 -> V_232 = F_117 ( & V_211 -> V_8 , L_56 ) ;
if ( F_118 ( V_7 -> V_232 ) ) {
...
F_95 ( V_7 -> V_10 ) ;
if ( F_120 ( V_7 -> V_168 , F_80 , 0 , L_20 , ( void * ) V_7 ) ) {
F_100 ( & V_211 -> V_8 , L_58 ) ;
V_94 = - V_219 ;
goto V_234;
}
F_121 ( & V_7 -> V_199 ) ;
F_122 ( & V_211 -> V_8 , L_59 ) ;
return V_94 ;
V_234:
F_123 ( V_7 -> V_232 ) ;
F_124 ( V_7 -> V_232 ) ;
...
static int T_10 F_129 ( struct V_210 * V_211 )
{
struct V_235 * V_224 = F_130 ( & V_211 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_224 , struct V_7 , V_224 ) ;
struct V_236 * V_237 = F_9 ( V_224 -> V_238 . V_25 ,
struct V_236 , V_239 ) ;
struct V_240 * V_241 = F_131 ( V_237 ) ;
...
static int F_133 ( struct V_210 * V_211 , T_11 V_28 )
{
struct V_235 * V_224 = F_130 ( & V_211 -> V_8 ) ;
struct V_7 * V_8 = F_26 ( V_224 , struct V_7 , V_224 ) ;
F_123 ( V_8 -> V_232 ) ;
