...
V_55 = & F_17 ( V_22 , V_41 ) ;
if ( V_55 -> V_24 ) {
struct V_24 * V_25 = V_55 -> V_24 ;
if ( V_25 -> V_26 == - 1 || -- V_25 -> V_54 == 0 )
F_23 ( V_25 ) ;
V_55 -> V_24 = NULL ;
}
}
