...
{
F_7 ( V_2 , V_169 , 0xffff0000 ) ;
F_7 ( V_2 , V_170 , 0xffffffff ) ;
...
static void F_52 ( struct V_1 * V_2 , bool V_176 )
{
struct V_27 * V_28 = & V_2 -> V_29 . V_28 ;
T_1 V_177 ;
if ( V_176 ) {
...
void F_55 ( struct V_1 * V_2 , bool V_187 , bool V_70 ,
bool V_188 )
{
struct V_8 * V_9 = F_5 ( V_2 ) ;
struct V_27 * V_28 = & V_2 -> V_29 . V_28 ;
...
if ( F_6 ( V_2 , V_183 ) == 0xdeadbeef ) {
F_8 ( V_9 , V_17 , L_17 ) ;
return;
}
F_7 ( V_2 , V_192 , V_28 -> V_190 ) ;
F_7 ( V_2 , V_193 , V_28 -> V_194 ) ;
...
F_2 ( V_2 , V_206 ,
V_207 , 20 ) ;
F_2 ( V_2 , V_116 , V_208 , 1 ) ;
F_2 ( V_2 , V_209 , V_210 , 0 ) ;
V_189 = F_53 ( V_28 -> V_96 , V_211 ) ;
F_2 ( V_2 , V_174 , V_212 , V_189 ) ;
F_36 ( V_2 , V_183 , V_213 ) ;
V_189 = F_6 ( V_2 , V_3 ) ;
V_189 |= F_56 ( 1 , V_214 ) ;
F_7 ( V_2 , V_3 , V_189 ) ;
F_3 ( 1 ) ;
...
void F_57 ( struct V_1 * V_2 , bool V_219 )
{
struct V_27 * V_136 = & V_2 -> V_29 . V_28 ;
F_26 ( V_2 ) ;
if ( V_136 -> V_75 && ! V_219 ) {
...
static void F_59 ( struct V_1 * V_2 , V_37 V_231 ,
T_1 * V_19 , bool V_232 )
{
struct V_27 * V_28 = & V_2 -> V_29 . V_28 ;
V_37 type , V_128 ;
...
bool F_10 ( struct V_1 * V_2 , V_37 V_231 , T_1 V_235 ,
T_1 * V_19 , V_37 V_236 , bool V_18 ,
bool V_237 )
{
struct V_8 * V_9 = F_5 ( V_2 ) ;
struct V_27 * V_28 = & V_2 -> V_29 . V_28 ;
...
V_59 = F_6 ( V_2 , V_61 ) ;
V_189 = F_6 ( V_2 , V_183 ) ;
if ( ( V_189 == 0xdeadbeef ) || ! ( V_189 & V_213 ) ) {
F_8 ( V_9 , V_17 ,
L_18 ,
V_231 , ( V_2 -> V_240 == V_241 ) ? 1 : 0 ) ;
F_59 ( V_2 , V_231 , V_19 , true ) ;
return false ;
} else if ( V_237 && ( V_28 -> V_31 == V_32 ) ) {
F_8 ( V_9 , V_17 ,
L_19 ,
V_231 ) ;
F_59 ( V_2 , V_231 , V_19 , true ) ;
...
V_243 ) ) ;
if ( V_19 ) {
for ( V_239 = 0 ; ( V_239 * 4 ) < V_236 ; V_239 ++ )
F_7 ( V_2 , ( V_244 + V_239 * 4 ) ,
* ( V_19 + V_239 ) ) ;
}
F_7 ( V_2 , V_245 ,
( F_56 ( ( V_235 & V_23 ) ,
...
void F_60 ( struct V_1 * V_2 , bool * V_249 )
{
struct V_8 * V_9 = F_5 ( V_2 ) ;
struct V_27 * V_136 = & V_2 -> V_29 . V_28 ;
T_1 V_130 [ 4 ] = { 0 , 0 , 0 , 0 } ;
...
return;
F_46 ( V_130 , V_254 ) ;
V_130 [ V_252 ] = V_136 -> V_255 ++ ;
F_10 ( V_2 , V_35 , 0 , V_130 , 16 , true , false ) ;
}
void F_62 ( struct V_1 * V_2 , T_1 V_190 , void * V_94 ,
T_2 V_236 , T_1 V_191 )
{
struct V_27 * V_28 = & V_2 -> V_29 . V_28 ;
V_28 -> V_190 = V_190 ;
...
T_1 F_25 ( struct V_1 * V_2 , T_1 V_256 , T_1 * V_140 )
{
struct V_8 * V_9 = F_5 ( V_2 ) ;
struct V_27 * V_28 = & V_2 -> V_29 . V_28 ;
T_1 V_257 = 0 , V_258 = 0 , V_259 ;
V_37 V_45 ;
switch ( V_256 ) {
case V_73 :
if ( V_28 -> V_75 ) {
V_257 = F_6 ( V_2 , V_183 ) ;
if ( ( V_257 == 0xdeadbeef ) || ( V_257 == 0xffffffff ) )
V_257 = 0 ;
}
V_257 &= V_213 ;
break;
case V_216 :
V_257 = F_53 ( F_6 ( V_2 , V_193 ) , V_260 ) ;
V_28 -> V_261 = V_257 ;
break;
case V_154 :
case V_262 :
F_7 ( V_2 , V_10 ,
V_153 ) ;
V_259 = F_53 ( F_6 ( V_2 , V_193 ) , V_260 ) ;
V_257 = V_259 ;
if ( V_257 == 0 )
V_257 = V_28 -> V_194 - 1 ;
else if ( V_257 >= V_28 -> V_194 ) {
if ( V_257 != 0xFFFF )
V_257 = 0 ;
} else {
V_257 -- ;
...
break;
case V_268 :
V_257 = F_53 ( V_28 -> V_88 , V_269 ) ;
break;
case V_270 :
V_257 = F_53 ( V_28 -> V_88 , V_271 ) ;
break;
case V_272 :
V_257 = F_53 ( V_28 -> V_88 , V_273 ) ;
break;
case V_274 :
V_257 = V_28 -> V_31 ;
break;
...
break;
case V_288 :
V_257 = ! ( V_28 -> V_96 & V_289 ) ;
break;
case V_290 :
V_257 = ! ( V_28 -> V_96 & V_291 ) ;
break;
default:
break;
}
