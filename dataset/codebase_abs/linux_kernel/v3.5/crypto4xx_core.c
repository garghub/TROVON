...
static int F_50 ( struct V_143 * V_177 , int V_140 )
{
struct V_143 * V_147 = V_177 ;
int V_178 = 0 ;
while ( V_140 ) {
V_178 ++ ;
...
T_1 F_54 ( struct V_180 * V_181 ,
struct V_76 * V_77 ,
struct V_143 * V_182 ,
struct V_143 * V_144 ,
unsigned int V_183 ,
void * V_184 , T_1 V_185 )
{
...
T_1 V_188 = 0xffffffff ;
T_1 V_174 ;
unsigned long V_111 ;
struct V_92 * V_92 = NULL ;
unsigned int V_140 = V_183 , V_110 ;
unsigned int V_189 = 0 ;
T_1 V_190 = 0 ;
V_158 = F_50 ( V_182 , V_183 ) ;
if ( V_158 == 1 )
V_158 = 0 ;
if ( F_55 ( V_144 ) || V_77 -> V_191 ) {
V_160 = 0 ;
} else {
if ( V_183 > V_54 ) {
V_160 = V_183 / V_54 ;
...
memcpy ( ( void * ) V_151 + V_77 -> V_195 ,
& V_92 -> V_104 , 4 ) ;
if ( V_185 )
F_44 ( V_92 -> V_103 , V_184 , V_185 ) ;
} else {
if ( V_77 -> V_193 == V_194 ) {
...
V_92 -> V_159 = V_187 ;
V_92 -> V_158 = V_158 ;
V_186 = F_24 ( V_2 , & V_124 , V_190 ) ;
V_142 -> V_182 = V_124 ;
V_151 -> V_152 . V_19 . V_196 = 1 ;
V_110 = 0 ;
V_182 = & V_182 [ 0 ] ;
while ( V_140 ) {
V_147 = & V_182 [ V_110 ] ;
...
V_142 -> V_182 = ( T_1 ) F_33 ( V_2 -> V_80 -> V_81 , F_34 ( V_182 ) ,
V_182 -> V_139 , V_182 -> V_138 , V_149 ) ;
V_151 -> V_152 . V_19 . V_196 = 0 ;
V_92 -> V_159 = 0xffffffff ;
V_92 -> V_158 = 0 ;
}
if ( V_77 -> V_191 || F_55 ( V_144 ) ) {
V_92 -> V_166 = 0 ;
V_92 -> V_148 = 0xffffffff ;
V_92 -> V_160 = 0 ;
V_92 -> V_155 = V_144 ;
V_151 -> V_152 . V_19 . V_200 = 0 ;
if ( V_77 -> V_191 )
V_142 -> V_201 = F_56 ( ( void * ) V_144 ) ;
else
V_142 -> V_201 = ( T_1 ) F_33 ( V_2 -> V_80 -> V_81 ,
F_34 ( V_144 ) , V_144 -> V_139 ,
V_144 -> V_138 , V_149 ) ;
} else {
struct V_125 * V_202 = NULL ;
T_1 V_203 = V_188 ;
V_140 = V_183 ;
V_151 -> V_152 . V_19 . V_200 = 1 ;
V_92 -> V_166 = 1 ;
V_92 -> V_155 = V_144 ;
V_92 -> V_148 = V_188 ;
V_92 -> V_160 = V_160 ;
V_202 = F_29 ( V_2 , & V_136 , V_203 ) ;
V_142 -> V_201 = V_136 ;
V_202 -> V_204 . V_198 = 0 ;
V_202 -> V_204 . V_205 = 1 ;
V_110 = 0 ;
...
V_151 -> V_206 . V_19 . V_207 = 0 ;
V_142 -> V_175 . V_18 = V_77 -> V_175 ;
V_142 -> V_176 . V_18 = 0x00400000 | ( V_77 -> V_208 << 24 ) | V_183 ;
V_92 -> V_114 = V_209 ;
F_57 () ;
F_2 ( 1 , V_2 -> V_16 + V_210 ) ;
return - V_211 ;
}
static int F_58 ( struct V_212 * V_165 )
{
struct V_213 * V_214 = V_165 -> V_215 ;
struct V_216 * V_217 = F_59 ( V_214 ) ;
...
V_77 -> V_86 = 0 ;
V_77 -> V_87 = 0 ;
switch ( V_214 -> V_218 & V_219 ) {
default:
V_165 -> V_220 . V_221 = sizeof( struct V_76 ) ;
break;
case V_222 :
F_60 ( F_61 ( V_165 ) ,
sizeof( struct V_76 ) ) ;
...
static void F_62 ( struct V_212 * V_165 )
{
struct V_76 * V_77 = F_39 ( V_165 ) ;
F_8 ( V_77 ) ;
F_10 ( V_77 ) ;
}
int F_63 ( struct V_1 * V_223 ,
struct V_224 * V_213 ,
int V_225 )
{
struct V_216 * V_214 ;
int V_91 ;
int V_226 = 0 ;
for ( V_91 = 0 ; V_91 < V_225 ; V_91 ++ ) {
V_214 = F_12 ( sizeof( struct V_216 ) , V_96 ) ;
if ( ! V_214 )
return - V_84 ;
V_214 -> V_214 = V_213 [ V_91 ] ;
V_214 -> V_2 = V_223 ;
switch ( V_214 -> V_214 . type ) {
case V_222 :
V_226 = F_64 ( & V_214 -> V_214 . V_227 . V_228 ) ;
break;
default:
V_226 = F_65 ( & V_214 -> V_214 . V_227 . V_229 ) ;
break;
}
if ( V_226 ) {
F_66 ( & V_214 -> V_230 ) ;
...
F_67 ( & V_214 -> V_230 , & V_223 -> V_231 ) ;
}
}
return 0 ;
}
static void F_68 ( struct V_1 * V_223 )
{
struct V_216 * V_214 , * V_106 ;
F_69 (alg, tmp, &sec_dev->alg_list, entry) {
F_66 ( & V_214 -> V_230 ) ;
switch ( V_214 -> V_214 . type ) {
case V_222 :
F_70 ( & V_214 -> V_214 . V_227 . V_228 ) ;
break;
default:
F_71 ( & V_214 -> V_214 . V_227 . V_229 ) ;
}
F_14 ( V_214 ) ;
}
}
static void F_72 ( unsigned long V_232 )
{
struct V_81 * V_2 = (struct V_81 * ) V_232 ;
struct V_173 * V_80 = F_73 ( V_2 ) ;
struct V_92 * V_92 ;
struct V_94 * V_142 ;
T_1 V_233 ;
while ( V_80 -> V_2 -> V_107 != V_80 -> V_2 -> V_108 ) {
V_233 = V_80 -> V_2 -> V_108 ;
V_92 = V_80 -> V_2 -> V_95 +
sizeof( struct V_92 ) * V_233 ;
V_142 = V_80 -> V_2 -> V_93 + sizeof( struct V_94 ) * V_233 ;
if ( ( V_92 -> V_114 == V_209 ) &&
V_142 -> V_175 . V_19 . V_234 &&
! V_142 -> V_175 . V_19 . V_235 ) {
V_142 -> V_175 . V_19 . V_234 = 0 ;
F_42 ( V_80 -> V_2 , V_233 ) ;
F_16 ( V_80 -> V_2 , V_233 ) ;
V_92 -> V_114 = V_115 ;
} else {
...
static T_4 F_74 ( int V_236 , void * V_232 )
{
struct V_81 * V_2 = (struct V_81 * ) V_232 ;
struct V_173 * V_80 = F_73 ( V_2 ) ;
if ( V_80 -> V_2 -> V_16 == 0 )
...
static int T_5 F_76 ( struct V_239 * V_240 )
{
int V_226 ;
struct V_241 V_242 ;
struct V_81 * V_2 = & V_240 -> V_2 ;
struct V_173 * V_80 ;
V_226 = F_77 ( V_240 -> V_2 . V_243 , 0 , & V_242 ) ;
if ( V_226 )
return - V_244 ;
if ( F_78 ( NULL , NULL , L_1 ) ) {
F_79 ( V_245 , V_246 ,
F_80 ( V_245 , V_246 ) | V_247 ) ;
F_79 ( V_245 , V_246 ,
F_80 ( V_245 , V_246 ) & ~ V_247 ) ;
} else if ( F_78 ( NULL , NULL ,
L_2 ) ) {
F_79 ( V_245 , V_248 ,
F_80 ( V_245 , V_248 ) | V_249 ) ;
F_79 ( V_245 , V_248 ,
F_80 ( V_245 , V_248 ) & ~ V_249 ) ;
} else if ( F_78 ( NULL , NULL ,
L_3 ) ) {
F_79 ( V_245 , V_250 ,
F_80 ( V_245 , V_250 ) | V_251 ) ;
F_79 ( V_245 , V_250 ,
F_80 ( V_245 , V_250 ) & ~ V_251 ) ;
} else {
F_81 ( V_252 L_4 ) ;
...
if ( V_226 )
goto V_257;
F_84 ( & V_80 -> V_237 , F_72 ,
( unsigned long ) V_2 ) ;
V_80 -> V_236 = F_85 ( V_240 -> V_2 . V_243 , 0 ) ;
V_226 = F_86 ( V_80 -> V_236 , F_74 , 0 ,
V_80 -> V_2 -> V_258 , V_2 ) ;
if ( V_226 )
goto V_259;
V_80 -> V_2 -> V_16 = F_87 ( V_240 -> V_2 . V_243 , 0 ) ;
if ( ! V_80 -> V_2 -> V_16 ) {
F_88 ( V_2 , L_5 ) ;
goto V_260;
}
F_1 ( V_80 -> V_2 ) ;
V_226 = F_63 ( V_80 -> V_2 , V_216 ,
F_89 ( V_216 ) ) ;
if ( V_226 )
goto V_261;
return 0 ;
...
static int T_6 F_93 ( struct V_239 * V_240 )
{
struct V_81 * V_2 = & V_240 -> V_2 ;
struct V_173 * V_80 = F_73 ( V_2 ) ;
F_90 ( V_80 -> V_236 , V_2 ) ;
