...
V_2 -> V_167 = F_69 ( V_32 -> V_30 - 1 ) + 1 ;
V_2 -> V_168 = V_32 -> V_68 + V_32 -> V_119 ;
V_2 -> V_169 = V_32 -> V_57 - 1 ;
V_2 -> V_170 = V_32 -> V_57 >> V_171 ;
V_2 -> V_172 = V_2 -> V_170 - 1 ;
V_2 -> V_173 [ 0 ] = F_70 ( V_2 , V_32 -> V_57 , 1 ) ;
V_2 -> V_173 [ 1 ] = F_70 ( V_2 , V_32 -> V_57 , 0 ) ;
V_2 -> V_174 [ 0 ] = V_2 -> V_173 [ 0 ] / 2 ;
V_2 -> V_174 [ 1 ] = V_2 -> V_173 [ 1 ] / 2 ;
V_2 -> V_175 [ 0 ] = F_71 ( V_2 , V_32 -> V_57 , 1 ) ;
V_2 -> V_175 [ 1 ] = F_71 ( V_2 , V_32 -> V_57 , 0 ) ;
V_2 -> V_176 [ 0 ] = V_2 -> V_175 [ 0 ] / 2 ;
V_2 -> V_176 [ 1 ] = V_2 -> V_175 [ 1 ] / 2 ;
V_2 -> V_177 [ 0 ] = F_72 ( V_2 , V_32 -> V_57 , 1 ) ;
V_2 -> V_177 [ 1 ] = F_72 ( V_2 , V_32 -> V_57 , 0 ) ;
V_2 -> V_178 [ 0 ] = V_2 -> V_177 [ 0 ] / 2 ;
V_2 -> V_178 [ 1 ] = V_2 -> V_177 [ 1 ] / 2 ;
V_2 -> V_179 = F_73 ( V_2 , 1 ) ;
V_2 -> V_180 = ( int ) F_74 ( ( V_181 ) V_182 ,
V_32 -> V_117 ) ;
V_2 -> V_183 = V_2 -> V_180 >> V_32 -> V_68 ;
}
STATIC int
F_75 ( T_3 * V_2 , T_2 V_80 )
{
T_2 V_82 ;
T_6 * V_18 ;
T_4 * V_32 = & V_2 -> V_4 ;
...
int error ;
for ( V_82 = 0 ; V_82 < V_80 ; V_82 ++ ) {
error = F_76 ( V_2 , NULL , V_82 , 0 ) ;
if ( error )
return error ;
error = F_77 ( V_2 , NULL , V_82 ) ;
if ( error )
return error ;
V_18 = F_10 ( V_2 , V_82 ) ;
V_184 += V_18 -> V_189 ;
...
T_4 * V_32 = & ( V_2 -> V_4 ) ;
if ( V_2 -> V_195 ) {
if ( ( F_79 ( V_2 -> V_195 ) & V_2 -> V_169 ) ||
( F_79 ( V_2 -> V_196 ) & V_2 -> V_169 ) ) {
if ( V_2 -> V_8 & V_197 ) {
F_3 ( V_2 , L_19
L_20 ) ;
return F_4 ( V_10 ) ;
...
T_13 * V_153 ;
T_15 V_220 ;
V_220 = ( T_15 ) F_73 ( V_2 , V_2 -> V_4 . V_73 ) ;
if ( F_89 ( V_2 , V_220 ) != V_2 -> V_4 . V_73 ) {
F_3 ( V_2 , L_25 ) ;
return F_4 ( V_40 ) ;
}
V_153 = F_62 ( V_2 -> V_50 ,
...
V_220 = ( T_15 ) F_73 ( V_2 , V_2 -> V_4 . V_115 ) ;
if ( F_89 ( V_2 , V_220 ) != V_2 -> V_4 . V_115 ) {
F_3 ( V_2 , L_27 ) ;
return F_4 ( V_40 ) ;
}
V_153 = F_62 ( V_2 -> V_49 ,
...
! F_116 ( V_2 ) &&
! V_2 -> V_4 . V_79 ) {
error = F_75 ( V_2 , V_32 -> V_30 ) ;
if ( error )
goto V_248;
}
error = F_117 ( V_2 , NULL , V_32 -> V_111 , 0 , V_249 , & V_230 ) ;
if ( error ) {
F_3 ( V_2 , L_36 ) ;
goto V_250;
}
ASSERT ( V_230 != NULL ) ;
if ( F_34 ( ! F_118 ( V_230 -> V_251 . V_252 ) ) ) {
F_3 ( V_2 , L_37 ,
( unsigned long long ) V_230 -> V_253 ) ;
F_119 ( V_230 , V_249 ) ;
F_112 ( L_38 , V_74 ,
V_2 ) ;
error = F_4 ( V_75 ) ;
...
return;
V_2 = V_222 -> V_267 ;
V_153 = F_149 ( V_222 , V_2 , 0 ) ;
V_23 = sizeof( T_4 ) ;
V_266 = 0 ;
F_55 ( F_64 ( V_153 ) , & V_2 -> V_4 , V_139 ) ;
V_142 = ( T_12 ) F_150 ( ( T_5 ) V_139 ) ;
ASSERT ( ( 1LL << V_142 ) & V_268 ) ;
V_266 = V_144 [ V_142 + 1 ] . V_145 - 1 ;
V_142 = ( T_12 ) F_56 ( ( T_5 ) V_139 ) ;
ASSERT ( ( 1LL << V_142 ) & V_268 ) ;
V_23 = V_144 [ V_142 ] . V_145 ;
F_151 ( V_222 , V_153 , V_23 , V_266 ) ;
}
STATIC int
F_152 (
T_3 * V_2 ,
...
int V_272 ;
long long V_273 ;
long long V_274 , V_275 ;
switch ( V_269 ) {
case V_276 :
V_273 = ( long long ) V_2 -> V_4 . V_121 ;
V_273 += V_270 ;
if ( V_273 < 0 ) {
ASSERT ( 0 ) ;
return F_4 ( V_10 ) ;
...
case V_278 :
V_273 = ( long long )
V_2 -> V_4 . V_123 - F_153 ( V_2 ) ;
V_274 = ( long long ) ( V_2 -> V_279 - V_2 -> V_280 ) ;
if ( V_270 > 0 ) {
if ( V_274 > V_270 ) {
V_2 -> V_280 += V_270 ;
} else {
...
if ( ! V_271 )
return F_4 ( V_281 ) ;
V_273 = ( long long ) V_2 -> V_280 + V_270 ;
if ( V_273 >= 0 ) {
V_2 -> V_280 = V_273 ;
return 0 ;
}
...
V_2 -> V_4 . V_123 = V_273 + F_153 ( V_2 ) ;
return 0 ;
case V_284 :
V_273 = ( long long ) V_2 -> V_4 . V_124 ;
V_273 += V_270 ;
if ( V_273 < 0 ) {
return F_4 ( V_281 ) ;
}
...
int V_293 ;
#ifdef F_156
ASSERT ( V_269 < V_276 || V_269 > V_278 ) ;
#endif
F_27 ( & V_2 -> V_194 ) ;
V_293 = F_152 ( V_2 , V_269 , V_270 , V_271 ) ;
F_29 ( & V_2 -> V_194 ) ;
return V_293 ;
}
int
...
int error = 0 ;
F_27 ( & V_2 -> V_194 ) ;
for ( V_296 = V_294 ; V_296 < ( V_294 + V_295 ) ; V_296 ++ ) {
ASSERT ( V_296 -> V_297 < V_276 ||
V_296 -> V_297 > V_278 ) ;
error = F_152 ( V_2 , V_296 -> V_297 ,
V_296 -> V_298 , V_271 ) ;
if ( error )
goto V_299;
}
...
T_18 * V_222 ;
int error ;
ASSERT ( V_139 & ( V_199 | V_200 | V_302 |
V_233 | V_234 |
V_237 ) ) ;
V_222 = F_92 ( V_2 , V_303 ) ;
error = F_93 ( V_222 , 0 , V_2 -> V_4 . V_51 + 128 , 0 , 0 ,
V_226 ) ;
if ( error ) {
F_94 ( V_222 , 0 ) ;
...
if ( F_165 ( V_2 -> V_50 ) ||
F_165 ( V_2 -> V_49 ) ||
( V_2 -> V_305 && F_165 ( V_2 -> V_305 ) ) ) {
F_125 ( V_2 , L_49 , V_304 ) ;
F_125 ( V_2 , L_50 ) ;
return V_306 ;
}
return 0 ;
...
T_21 * V_311 ;
T_3 * V_2 ;
V_2 = ( T_3 * ) F_24 ( V_308 , T_3 , V_312 ) ;
V_311 = ( T_21 * )
F_167 ( V_2 -> V_313 , ( unsigned long ) V_310 ) ;
switch ( V_309 ) {
case V_314 :
case V_315 :
memset ( V_311 , 0 , sizeof( T_21 ) ) ;
break;
case V_316 :
case V_317 :
F_168 ( V_2 ) ;
...
F_171 ( V_2 , V_277 ) ;
F_171 ( V_2 , V_278 ) ;
V_2 -> V_4 . V_121 += V_311 -> V_320 ;
V_2 -> V_4 . V_122 += V_311 -> V_321 ;
V_2 -> V_4 . V_123 += V_311 -> V_322 ;
memset ( V_311 , 0 , sizeof( T_21 ) ) ;
F_172 ( V_2 , V_276 , 0 ) ;
F_172 ( V_2 , V_277 , 0 ) ;
F_172 ( V_2 , V_278 , 0 ) ;
...
T_21 * V_311 ;
int V_7 ;
V_2 -> V_313 = F_174 ( T_21 ) ;
if ( V_2 -> V_313 == NULL )
return - V_87 ;
#ifdef F_175
V_2 -> V_312 . V_324 = F_166 ;
V_2 -> V_312 . V_325 = 0 ;
F_176 ( & V_2 -> V_312 ) ;
#endif
F_177 (i) {
V_311 = ( T_21 * ) F_167 ( V_2 -> V_313 , V_7 ) ;
memset ( V_311 , 0 , sizeof( T_21 ) ) ;
}
F_42 ( & V_2 -> V_326 ) ;
V_2 -> V_327 = - 1 ;
...
T_21 * V_311 ;
int V_7 ;
memset ( V_331 , 0 , sizeof( T_21 ) ) ;
if ( ! ( V_42 & V_332 ) )
F_187 ( V_2 ) ;
F_177 (i) {
V_311 = ( T_21 * ) F_167 ( V_2 -> V_313 , V_7 ) ;
V_331 -> V_320 += V_311 -> V_320 ;
V_331 -> V_321 += V_311 -> V_321 ;
V_331 -> V_322 += V_311 -> V_322 ;
}
if ( ! ( V_42 & V_332 ) )
F_188 ( V_2 ) ;
}
...
return;
F_187 ( V_2 ) ;
if ( ! F_183 ( V_269 , & V_2 -> V_327 ) ) {
F_189 ( V_2 , & V_331 , V_332 ) ;
switch( V_269 ) {
case V_276 :
V_2 -> V_4 . V_121 = V_331 . V_320 ;
break;
case V_277 :
V_2 -> V_4 . V_122 = V_331 . V_321 ;
break;
case V_278 :
V_2 -> V_4 . V_123 = V_331 . V_322 ;
break;
default:
F_46 () ;
}
...
F_187 ( V_2 ) ;
F_177 (i) {
V_311 = F_167 ( V_2 -> V_313 , V_7 ) ;
switch ( V_269 ) {
case V_276 :
V_311 -> V_320 = V_333 + V_334 ;
break;
case V_277 :
V_311 -> V_321 = V_333 + V_334 ;
break;
case V_278 :
V_311 -> V_322 = V_333 + V_334 ;
break;
default:
F_46 () ;
break;
...
T_14 V_333 , V_334 ;
int V_336 = F_194 () ;
T_14 V_337 = ( T_14 ) V_335 ;
F_171 ( V_2 , V_269 ) ;
switch ( V_269 ) {
case V_276 :
V_333 = V_2 -> V_4 . V_121 ;
V_334 = F_50 ( V_333 , V_336 ) ;
if ( V_333 < F_195 ( V_337 , V_338 ) )
return;
break;
case V_277 :
V_333 = V_2 -> V_4 . V_122 ;
...
V_333 = V_2 -> V_4 . V_123 ;
V_334 = F_50 ( V_333 , V_336 ) ;
if ( V_333 < F_195 ( V_337 , F_196 ( V_2 ) ) )
return;
break;
default:
F_46 () ;
...
V_340:
F_199 () ;
V_328 = F_200 ( V_2 -> V_313 ) ;
if ( F_34 ( F_190 ( V_2 , V_269 ) ) )
goto V_341;
F_182 ( V_328 ) ;
if ( F_34 ( F_190 ( V_2 , V_269 ) ) ) {
F_185 ( V_328 ) ;
...
break;
case V_278 :
F_201 ( ( V_2 -> V_279 - V_2 -> V_280 ) != 0 ) ;
V_273 = V_328 -> V_322 - F_153 ( V_2 ) ;
V_273 += V_270 ;
if ( F_34 ( V_273 < 0 ) )
goto V_342;
V_328 -> V_322 = V_273 + F_153 ( V_2 ) ;
break;
default:
F_46 () ;
break;
...
F_27 ( & V_2 -> V_194 ) ;
V_339 = F_152 ( V_2 , V_269 , V_270 , V_271 ) ;
F_29 ( & V_2 -> V_194 ) ;
if ( V_339 != V_281 )
F_169 ( V_2 , V_269 , 0 ) ;
F_170 ( V_2 ) ;
