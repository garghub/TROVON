...
V_346 [ V_15 -> V_24 ] = V_347 ;
V_256:
F_135 (dev, &ap->link, ALL) {
V_15 -> V_243 = V_348 ;
if ( V_5 -> V_213 -> V_349 )
V_5 -> V_213 -> V_349 ( V_5 , V_15 ) ;
}
V_5 -> V_213 -> V_350 ( V_5 ) ;
F_135 (dev, &ap->link, ALL) {
if ( V_15 -> V_181 != V_141 )
V_344 [ V_15 -> V_24 ] = V_15 -> V_181 ;
else
V_344 [ V_15 -> V_24 ] = V_351 ;
V_15 -> V_181 = V_141 ;
}
F_135 (dev, &ap->link, ALL_REVERSE) {
if ( V_346 [ V_15 -> V_24 ] )
V_15 -> V_181 = V_344 [ V_15 -> V_24 ] ;
if ( ! F_8 ( V_15 ) )
continue;
...
break;
case - V_259 :
V_346 [ V_15 -> V_24 ] = F_111 ( V_346 [ V_15 -> V_24 ] , 1 ) ;
case - V_165 :
if ( V_346 [ V_15 -> V_24 ] == 1 ) {
F_137 ( & V_5 -> V_3 , 0 ) ;
F_138 ( V_15 , V_354 ) ;
}
}
...
{
T_1 V_1 , V_355 , V_356 ;
if ( F_124 ( V_3 , V_357 , & V_1 ) )
return;
F_124 ( V_3 , V_358 , & V_355 ) ;
if ( F_140 ( V_3 ) ) {
V_356 = ( V_1 >> 4 ) & 0xf ;
F_141 ( V_3 , L_106 ,
F_38 ( V_356 ) , V_1 , V_355 ) ;
} else {
F_141 ( V_3 , L_107 ,
V_1 , V_355 ) ;
}
...
struct V_14 * V_359 = & V_3 -> V_21 [ 1 - V_240 -> V_24 ] ;
if ( ! F_8 ( V_359 ) )
return NULL ;
return V_359 ;
}
...
static int F_145 ( struct V_2 * V_3 , T_1 * V_355 )
{
struct V_2 * V_363 = & V_3 -> V_5 -> V_3 ;
T_1 V_364 , V_274 , V_135 ;
V_364 = V_3 -> V_277 ;
if ( ! F_13 ( V_3 ) && V_363 -> V_278 )
V_364 &= ( 1 << V_363 -> V_278 ) - 1 ;
if ( V_364 == V_365 )
V_274 = 0 ;
else
V_274 = F_33 ( V_364 ) ;
V_135 = ( * V_355 >> 4 ) & 0xf ;
* V_355 = ( * V_355 & ~ 0xf0 ) | ( ( V_274 & 0xf ) << 4 ) ;
return V_135 != V_274 ;
}
static int F_146 ( struct V_2 * V_3 )
{
T_1 V_355 ;
if ( F_124 ( V_3 , V_358 , & V_355 ) )
return 1 ;
return F_145 ( V_3 , & V_355 ) ;
}
int F_147 ( struct V_2 * V_3 )
{
T_1 V_355 ;
int V_180 ;
if ( ( V_180 = F_124 ( V_3 , V_358 , & V_355 ) ) )
return V_180 ;
if ( ! F_145 ( V_3 , & V_355 ) )
return 0 ;
if ( ( V_180 = F_148 ( V_3 , V_358 , V_355 ) ) )
return V_180 ;
return 1 ;
}
static void F_149 ( const struct V_366 * V_367 , struct V_366 * V_368 , int V_369 , int V_370 )
{
V_368 -> V_371 = F_150 ( V_367 -> V_371 * 1000 , V_369 ) ;
V_368 -> V_372 = F_150 ( V_367 -> V_372 * 1000 , V_369 ) ;
V_368 -> V_373 = F_150 ( V_367 -> V_373 * 1000 , V_369 ) ;
V_368 -> V_374 = F_150 ( V_367 -> V_374 * 1000 , V_369 ) ;
V_368 -> V_375 = F_150 ( V_367 -> V_375 * 1000 , V_369 ) ;
V_368 -> V_376 = F_150 ( V_367 -> V_376 * 1000 , V_369 ) ;
V_368 -> V_377 = F_150 ( V_367 -> V_377 * 1000 , V_369 ) ;
V_368 -> V_378 = F_150 ( V_367 -> V_378 * 1000 , V_369 ) ;
V_368 -> V_379 = F_150 ( V_367 -> V_379 * 1000 , V_370 ) ;
}
void F_151 ( const struct V_366 * V_380 , const struct V_366 * V_381 ,
struct V_366 * V_382 , unsigned int V_383 )
{
if ( V_383 & V_384 ) V_382 -> V_371 = V_312 ( V_380 -> V_371 , V_381 -> V_371 ) ;
if ( V_383 & V_385 ) V_382 -> V_372 = V_312 ( V_380 -> V_372 , V_381 -> V_372 ) ;
if ( V_383 & V_386 ) V_382 -> V_373 = V_312 ( V_380 -> V_373 , V_381 -> V_373 ) ;
if ( V_383 & V_387 ) V_382 -> V_374 = V_312 ( V_380 -> V_374 , V_381 -> V_374 ) ;
if ( V_383 & V_388 ) V_382 -> V_375 = V_312 ( V_380 -> V_375 , V_381 -> V_375 ) ;
if ( V_383 & V_389 ) V_382 -> V_376 = V_312 ( V_380 -> V_376 , V_381 -> V_376 ) ;
if ( V_383 & V_390 ) V_382 -> V_377 = V_312 ( V_380 -> V_377 , V_381 -> V_377 ) ;
if ( V_383 & V_391 ) V_382 -> V_378 = V_312 ( V_380 -> V_378 , V_381 -> V_378 ) ;
if ( V_383 & V_392 ) V_382 -> V_379 = V_312 ( V_380 -> V_379 , V_381 -> V_379 ) ;
}
const struct V_366 * F_152 ( T_2 V_133 )
{
const struct V_366 * V_367 = V_366 ;
while ( V_133 > V_367 -> V_7 )
V_367 ++ ;
if ( V_133 == V_367 -> V_7 )
return V_367 ;
return NULL ;
}
int F_153 ( struct V_14 * V_240 , unsigned short V_393 ,
struct V_366 * V_367 , int V_369 , int V_370 )
{
const T_4 * V_142 = V_240 -> V_142 ;
const struct V_366 * V_143 ;
struct V_366 V_147 ;
if ( ! ( V_143 = F_152 ( V_393 ) ) )
return - V_117 ;
memcpy ( V_367 , V_143 , sizeof( * V_143 ) ) ;
if ( V_142 [ V_184 ] & 2 ) {
memset ( & V_147 , 0 , sizeof( V_147 ) ) ;
if ( V_393 >= V_348 && V_393 < V_394 ) {
if ( V_393 <= V_246 )
V_147 . V_378 = V_147 . V_374 = V_142 [ V_247 ] ;
else if ( ( V_393 <= V_395 ) ||
( V_393 == V_244 && ! F_62 ( V_142 ) ) )
V_147 . V_378 = V_147 . V_374 = V_142 [ V_396 ] ;
} else if ( V_393 >= V_397 && V_393 <= V_398 )
V_147 . V_378 = V_142 [ V_399 ] ;
F_151 ( & V_147 , V_367 , V_367 , V_391 | V_387 ) ;
}
F_149 ( V_367 , V_367 , V_369 , V_370 ) ;
if ( V_393 > V_245 ) {
F_153 ( V_240 , V_240 -> V_243 , & V_147 , V_369 , V_370 ) ;
F_151 ( & V_147 , V_367 , V_367 , V_400 ) ;
}
if ( V_367 -> V_372 + V_367 -> V_373 < V_367 -> V_374 ) {
V_367 -> V_372 += ( V_367 -> V_374 - ( V_367 -> V_372 + V_367 -> V_373 ) ) / 2 ;
V_367 -> V_373 = V_367 -> V_374 - V_367 -> V_372 ;
}
if ( V_367 -> V_375 + V_367 -> V_376 < V_367 -> V_378 ) {
V_367 -> V_375 += ( V_367 -> V_378 - ( V_367 -> V_375 + V_367 -> V_376 ) ) / 2 ;
V_367 -> V_376 = V_367 -> V_378 - V_367 -> V_375 ;
}
if ( V_367 -> V_375 + V_367 -> V_376 > V_367 -> V_378 )
V_367 -> V_378 = V_367 -> V_375 + V_367 -> V_376 ;
return 0 ;
}
T_2 F_154 ( unsigned int V_401 , int V_378 )
{
T_2 V_402 = 0xff , V_403 = 0xff ;
const struct V_127 * V_128 ;
const struct V_366 * V_367 ;
for ( V_128 = V_129 ; V_128 -> V_130 >= 0 ; V_128 ++ )
if ( V_128 -> V_130 == V_401 )
V_402 = V_128 -> V_132 ;
for ( V_367 = F_152 ( V_402 ) ;
V_367 && F_35 ( V_367 -> V_7 ) == V_401 ; V_367 ++ ) {
unsigned short V_404 ;
switch ( V_401 ) {
case V_120 :
case V_122 :
V_404 = V_367 -> V_378 ;
...
int F_138 ( struct V_14 * V_15 , unsigned int V_405 )
{
char V_238 [ 32 ] ;
unsigned long V_406 , V_47 ;
unsigned long V_44 , V_45 , V_46 ;
int V_407 , V_126 ;
V_407 = ! ! ( V_405 & V_408 ) ;
V_405 &= ~ V_408 ;
V_47 = V_406 = F_31 ( V_15 -> V_44 ,
V_15 -> V_45 ,
V_15 -> V_46 ) ;
...
struct V_4 * V_5 = V_15 -> V_3 -> V_5 ;
struct V_171 * V_172 = & V_15 -> V_3 -> V_173 ;
const bool V_414 = V_15 -> V_48 & V_415 ;
const char * V_416 = L_67 ;
int V_417 = 0 ;
unsigned int V_157 = 0 ;
int V_180 ;
V_15 -> V_42 &= ~ V_91 ;
if ( V_15 -> V_401 == V_120 )
V_15 -> V_42 |= V_91 ;
if ( V_414 && V_5 -> V_42 & V_418 && F_107 ( V_15 -> V_142 ) )
V_416 = L_112 ;
else {
if ( V_414 )
F_24 ( V_15 ,
...
int F_158 ( struct V_2 * V_3 , struct V_14 * * V_421 )
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_14 * V_15 ;
int V_180 = 0 , V_422 = 0 , V_423 = 0 ;
F_135 (dev, link, ENABLED) {
unsigned long V_44 , V_424 ;
unsigned int V_425 ;
V_425 = V_426 ;
if ( V_15 -> V_181 == V_138 )
V_425 = V_427 ;
...
if ( V_429 & V_425 )
V_424 = F_31 ( 0 , V_15 -> V_45 ,
V_15 -> V_46 ) ;
else
V_424 = 0 ;
V_15 -> V_243 = F_32 ( V_44 ) ;
V_15 -> V_420 = F_32 ( V_424 ) ;
V_423 = 1 ;
if ( F_160 ( V_15 ) )
V_422 = 1 ;
}
...
if ( ! F_160 ( V_15 ) )
continue;
V_15 -> V_133 = V_15 -> V_420 ;
V_15 -> V_401 = F_35 ( V_15 -> V_420 ) ;
if ( V_5 -> V_213 -> V_431 )
V_5 -> V_213 -> V_431 ( V_5 , V_15 ) ;
}
F_135 (dev, link, ENABLED) {
V_180 = F_155 ( V_15 ) ;
if ( V_180 )
...
int F_161 ( struct V_2 * V_3 , unsigned long V_434 ,
int (* F_162)( struct V_2 * V_3 ) )
{
unsigned long V_435 = V_436 ;
unsigned long V_437 ;
int V_438 = 0 ;
if ( V_3 -> V_5 -> V_269 -> V_42 & V_439 )
V_437 = F_163 ( V_435 , V_440 ) ;
else
V_437 = F_163 ( V_435 , V_441 ) ;
F_87 ( V_3 == V_3 -> V_5 -> V_12 ) ;
if ( F_164 ( V_437 , V_434 ) )
V_437 = V_434 ;
while ( 1 ) {
unsigned long V_442 = V_436 ;
int V_443 , V_356 ;
V_443 = V_356 = F_162 ( V_3 ) ;
if ( V_443 > 0 )
return 0 ;
if ( V_443 == - V_259 ) {
if ( F_165 ( V_3 ) )
V_443 = 0 ;
else if ( ( V_3 -> V_5 -> V_42 & V_418 ) &&
! F_166 ( V_3 ) &&
F_167 ( V_442 , V_437 ) )
V_443 = 0 ;
}
if ( V_443 )
return V_443 ;
if ( F_164 ( V_442 , V_434 ) )
return - V_444 ;
if ( ! V_438 && F_164 ( V_442 , V_435 + 5 * V_445 ) &&
( V_434 - V_442 > 3 * V_445 ) ) {
F_144 ( V_3 ,
L_120
L_121 , V_356 ) ;
...
int F_169 ( struct V_2 * V_3 , unsigned long V_434 ,
int (* F_162)( struct V_2 * V_3 ) )
{
F_168 ( V_3 -> V_5 , V_446 ) ;
return F_161 ( V_3 , V_434 , F_162 ) ;
}
int F_170 ( struct V_2 * V_3 , const unsigned long * V_447 ,
unsigned long V_434 )
{
unsigned long V_448 = V_447 [ 0 ] ;
unsigned long V_449 = V_447 [ 1 ] ;
unsigned long V_450 , V_367 ;
T_1 V_451 , V_452 ;
int V_180 ;
V_367 = F_163 ( V_436 , V_447 [ 2 ] ) ;
if ( F_167 ( V_367 , V_434 ) )
V_434 = V_367 ;
if ( ( V_180 = F_124 ( V_3 , V_357 , & V_452 ) ) )
return V_180 ;
V_452 &= 0xf ;
V_451 = V_452 ;
V_450 = V_436 ;
...
V_451 = V_452 ;
V_450 = V_436 ;
if ( F_164 ( V_436 , V_434 ) )
return - V_453 ;
}
}
int F_171 ( struct V_2 * V_3 , const unsigned long * V_447 ,
unsigned long V_434 )
{
int V_346 = V_454 ;
T_1 V_355 , V_455 ;
...
return V_180 ;
do {
V_355 = ( V_355 & 0x0f0 ) | 0x300 ;
if ( ( V_180 = F_148 ( V_3 , V_358 , V_355 ) ) )
return V_180 ;
F_168 ( V_3 -> V_5 , 200 ) ;
if ( ( V_180 = F_124 ( V_3 , V_358 , & V_355 ) ) )
return V_180 ;
} while ( ( V_355 & 0xf0f ) != 0x300 && -- V_346 );
if ( ( V_355 & 0xf0f ) != 0x300 ) {
F_144 ( V_3 , L_122 ,
V_355 ) ;
return 0 ;
}
...
F_144 ( V_3 , L_123 ,
V_454 - V_346 ) ;
if ( ( V_180 = F_170 ( V_3 , V_447 , V_434 ) ) )
return V_180 ;
if ( ! ( V_180 = F_124 ( V_3 , V_456 , & V_455 ) ) )
V_180 = F_148 ( V_3 , V_456 , V_455 ) ;
return V_180 != - V_117 ? V_180 : 0 ;
}
int F_172 ( struct V_2 * V_3 , enum V_457 V_458 ,
bool V_459 )
{
...
V_180 = F_148 ( V_3 , V_358 , V_355 ) ;
if ( V_180 )
return V_180 ;
if ( V_460 )
F_174 ( 10 ) ;
V_172 -> V_25 . V_455 &= ~ V_464 ;
return F_148 ( V_3 , V_456 , V_464 ) ;
}
int F_175 ( struct V_2 * V_3 , unsigned long V_434 )
{
struct V_4 * V_5 = V_3 -> V_5 ;
struct V_171 * V_172 = & V_3 -> V_173 ;
const unsigned long * V_465 = F_176 ( V_172 ) ;
int V_180 ;
if ( V_172 -> V_25 . V_466 & V_467 )
return 0 ;
if ( V_5 -> V_42 & V_418 ) {
V_180 = F_171 ( V_3 , V_465 , V_434 ) ;
if ( V_180 && V_180 != - V_362 )
F_144 ( V_3 ,
L_124 ,
V_180 ) ;
}
if ( F_177 ( V_3 ) )
V_172 -> V_25 . V_466 &= ~ V_468 ;
return 0 ;
}
int F_178 ( struct V_2 * V_3 , const unsigned long * V_465 ,
unsigned long V_434 ,
bool * V_469 , int (* F_162)( struct V_2 * ) )
{
T_1 V_355 ;
int V_180 ;
F_30 ( L_125 ) ;
...
if ( ( V_180 = F_124 ( V_3 , V_358 , & V_355 ) ) )
goto V_430;
V_355 = ( V_355 & 0x0f0 ) | 0x301 ;
if ( ( V_180 = F_179 ( V_3 , V_358 , V_355 ) ) )
goto V_430;
F_168 ( V_3 -> V_5 , 1 ) ;
V_180 = F_171 ( V_3 , V_465 , V_434 ) ;
if ( V_180 )
...
V_470 = F_163 ( V_436 ,
V_471 ) ;
if ( F_164 ( V_470 , V_434 ) )
V_470 = V_434 ;
F_161 ( V_3 , V_470 , F_162 ) ;
}
V_180 = - V_279 ;
goto V_430;
}
V_180 = 0 ;
if ( F_162 )
V_180 = F_161 ( V_3 , V_434 , F_162 ) ;
V_430:
if ( V_180 && V_180 != - V_279 ) {
if ( V_469 )
* V_469 = false ;
F_181 ( V_3 , L_126 , V_180 ) ;
}
F_30 ( L_127 , V_180 ) ;
return V_180 ;
}
...
unsigned long V_434 )
{
const unsigned long * V_465 = F_176 ( & V_3 -> V_173 ) ;
bool V_469 ;
int V_180 ;
V_180 = F_178 ( V_3 , V_465 , V_434 , & V_469 , NULL ) ;
return V_469 ? - V_279 : V_180 ;
}
void F_183 ( struct V_2 * V_3 , unsigned int * V_344 )
{
T_1 V_455 ;
F_30 ( L_125 ) ;
if ( ! F_124 ( V_3 , V_456 , & V_455 ) )
F_148 ( V_3 , V_456 , V_455 ) ;
F_139 ( V_3 ) ;
F_30 ( L_128 ) ;
}
static int F_184 ( struct V_14 * V_15 , unsigned int V_472 ,
const T_4 * V_473 )
{
const T_4 * V_474 = V_15 -> V_142 ;
unsigned char V_475 [ 2 ] [ V_301 + 1 ] ;
unsigned char V_476 [ 2 ] [ V_477 + 1 ] ;
if ( V_15 -> V_181 != V_472 ) {
F_57 ( V_15 , L_129 ,
V_15 -> V_181 , V_472 ) ;
return 0 ;
}
F_41 ( V_474 , V_475 [ 0 ] , V_310 , sizeof( V_475 [ 0 ] ) ) ;
F_41 ( V_473 , V_475 [ 1 ] , V_310 , sizeof( V_475 [ 1 ] ) ) ;
F_41 ( V_474 , V_476 [ 0 ] , V_478 , sizeof( V_476 [ 0 ] ) ) ;
F_41 ( V_473 , V_476 [ 1 ] , V_478 , sizeof( V_476 [ 1 ] ) ) ;
...
int F_58 ( struct V_14 * V_15 , unsigned int V_479 )
{
unsigned int V_181 = V_15 -> V_181 ;
T_4 * V_142 = ( void * ) V_15 -> V_3 -> V_5 -> V_480 ;
int V_180 ;
V_180 = F_94 ( V_15 , & V_181 , V_479 , V_142 ) ;
if ( V_180 )
return V_180 ;
...
int F_157 ( struct V_14 * V_15 , unsigned int V_472 ,
unsigned int V_479 )
{
...
static int F_186 ( const char * V_481 , const char * V_482 )
{
do {
if ( * V_481 == * V_482 || * V_482 == '?' ) {
if ( ! * V_482 ++ )
return 0 ;
} else {
if ( ! * V_481 || * V_482 != '[' )
break;
while ( * ++ V_482 && * V_482 != ']' && * V_481 != * V_482 ) {
if ( * V_482 == '-' && * ( V_482 - 1 ) != '[' )
if ( * V_481 > * ( V_482 - 1 ) && * V_481 < * ( V_482 + 1 ) ) {
++ V_482 ;
break;
}
}
...
{
unsigned char V_483 [ V_301 + 1 ] ;
unsigned char V_484 [ V_299 + 1 ] ;
const struct V_485 * V_486 = V_487 ;
F_41 ( V_15 -> V_142 , V_483 , V_310 , sizeof( V_483 ) ) ;
F_41 ( V_15 -> V_142 , V_484 , V_309 , sizeof( V_484 ) ) ;
while ( V_486 -> V_483 ) {
if ( ! F_186 ( V_483 , V_486 -> V_483 ) ) {
if ( V_486 -> V_484 == NULL )
return V_486 -> V_48 ;
if ( ! F_186 ( V_484 , V_486 -> V_484 ) )
return V_486 -> V_48 ;
}
V_486 ++ ;
}
...
{
if ( ( V_15 -> V_3 -> V_5 -> V_42 & V_488 ) &&
( V_15 -> V_42 & V_327 ) )
return 1 ;
return ( V_15 -> V_48 & V_489 ) ? 1 : 0 ;
}
...
if ( V_5 -> V_33 == V_340 )
return 1 ;
if ( V_5 -> V_33 == V_341 || V_5 -> V_33 == V_281 )
return 0 ;
if ( V_5 -> V_33 == V_491 )
return 0 ;
F_192 (link, ap, EDGE) {
...
V_47 &= F_92 ( V_15 ) ;
if ( V_5 -> V_213 -> V_493 )
V_47 = V_5 -> V_213 -> V_493 ( V_15 , V_47 ) ;
if ( V_47 & ( 0xF8 << V_124 ) )
if ( F_191 ( V_5 ) ) {
F_24 ( V_15 ,
L_141 ) ;
...
unsigned int F_100 ( struct V_14 * V_15 , T_2 V_496 , T_2 V_72 )
{
struct V_67 V_68 ;
unsigned int V_157 ;
F_30 ( L_144 ) ;
...
int V_499 = V_193 -> V_198 ;
F_194 ( V_225 == NULL ) ;
F_195 ( L_146 , V_193 -> V_201 ) ;
if ( V_193 -> V_201 )
F_196 ( V_5 -> V_15 , V_225 , V_193 -> V_500 , V_499 ) ;
V_193 -> V_42 &= ~ V_501 ;
V_193 -> V_225 = NULL ;
}
...
{
struct V_4 * V_5 = V_193 -> V_5 ;
if ( ! ( V_193 -> V_15 -> V_48 & V_502 ) &&
F_5 ( V_193 -> V_227 & 15 ) )
return 1 ;
if ( V_5 -> V_213 -> V_503 )
return V_5 -> V_213 -> V_503 ( V_193 ) ;
return 0 ;
}
...
V_193 -> V_225 = V_225 ;
V_193 -> V_201 = V_201 ;
V_193 -> V_505 = V_193 -> V_225 ;
}
static int F_201 ( struct V_192 * V_193 )
{
struct V_4 * V_5 = V_193 -> V_5 ;
unsigned int V_201 ;
F_195 ( L_147 , V_5 -> V_31 ) ;
V_201 = F_202 ( V_5 -> V_15 , V_193 -> V_225 , V_193 -> V_201 , V_193 -> V_198 ) ;
if ( V_201 < 1 )
return - 1 ;
F_30 ( L_148 , V_201 ) ;
V_193 -> V_500 = V_193 -> V_201 ;
V_193 -> V_201 = V_201 ;
V_193 -> V_42 |= V_501 ;
return 0 ;
}
void F_98 ( T_4 * V_238 , unsigned int V_506 )
{
#ifdef F_203
unsigned int V_25 ;
for ( V_25 = 0 ; V_25 < V_506 ; V_25 ++ )
...
if ( V_5 -> V_213 -> V_214 ) {
struct V_14 * V_15 = V_193 -> V_15 ;
struct V_511 * V_512 = & V_15 -> V_3 -> V_513 ;
if ( F_5 ( V_193 -> V_157 ) )
V_193 -> V_42 |= V_233 ;
...
case V_494 :
if ( V_193 -> V_68 . V_72 != V_514 &&
V_193 -> V_68 . V_72 != V_515 )
break;
case V_498 :
case V_516 :
V_512 -> V_517 [ V_15 -> V_24 ] |= V_518 ;
F_215 ( V_5 ) ;
break;
case V_519 :
V_15 -> V_42 |= V_520 ;
...
while ( V_523 ) {
struct V_192 * V_193 ;
unsigned int V_107 = F_218 ( V_523 ) ;
...
V_193 -> V_42 |= V_230 ;
V_5 -> V_219 |= 1 << V_193 -> V_107 ;
if ( F_194 ( F_221 ( V_524 ) &&
( ! V_193 -> V_225 || ! V_193 -> V_201 || ! V_193 -> V_227 ) ) )
goto V_525;
if ( F_222 ( V_524 ) || ( F_212 ( V_524 ) &&
( V_5 -> V_42 & V_526 ) ) )
if ( F_201 ( V_193 ) )
goto V_525;
if ( F_5 ( V_193 -> V_15 -> V_42 & V_520 ) ) {
V_3 -> V_513 . V_466 |= V_527 ;
F_223 ( & V_3 -> V_513 , L_150 ) ;
F_224 ( V_3 ) ;
return;
}
V_5 -> V_213 -> V_528 ( V_193 ) ;
V_193 -> V_157 |= V_5 -> V_213 -> V_529 ( V_193 ) ;
if ( F_5 ( V_193 -> V_157 ) )
goto V_530;
return;
V_525:
...
{
struct V_4 * V_5 = V_3 -> V_5 ;
return ( V_5 -> V_42 & V_418 ) && V_5 -> V_213 -> V_531 ;
}
int F_124 ( struct V_2 * V_3 , int V_532 , T_1 * V_533 )
{
if ( F_13 ( V_3 ) ) {
if ( F_104 ( V_3 ) )
return V_3 -> V_5 -> V_213 -> V_531 ( V_3 , V_532 , V_533 ) ;
return - V_362 ;
}
return F_225 ( V_3 , V_532 , V_533 ) ;
}
int F_148 ( struct V_2 * V_3 , int V_532 , T_1 V_533 )
{
if ( F_13 ( V_3 ) ) {
if ( F_104 ( V_3 ) )
return V_3 -> V_5 -> V_213 -> V_534 ( V_3 , V_532 , V_533 ) ;
return - V_362 ;
}
return F_226 ( V_3 , V_532 , V_533 ) ;
}
int F_179 ( struct V_2 * V_3 , int V_532 , T_1 V_533 )
{
if ( F_13 ( V_3 ) ) {
int V_180 ;
if ( F_104 ( V_3 ) ) {
V_180 = V_3 -> V_5 -> V_213 -> V_534 ( V_3 , V_532 , V_533 ) ;
if ( V_180 == 0 )
V_180 = V_3 -> V_5 -> V_213 -> V_531 ( V_3 , V_532 , & V_533 ) ;
return V_180 ;
}
return - V_362 ;
}
...
static int F_227 ( struct V_4 * V_5 , T_6 V_536 ,
unsigned int V_466 , unsigned int V_537 ,
int V_208 )
{
struct V_2 * V_3 ;
unsigned long V_42 ;
...
V_3 -> V_513 . V_466 |= V_466 ;
V_3 -> V_513 . V_42 |= V_537 ;
}
F_215 ( V_5 ) ;
F_68 ( V_5 -> V_209 , V_42 ) ;
if ( V_208 ) {
...
static int F_229 ( struct V_21 * V_15 , T_6 V_536 )
{
struct V_4 * V_5 = F_230 ( V_15 ) ;
unsigned int V_537 = V_541 ;
int V_180 ;
if ( V_536 . V_542 == V_543 )
V_537 |= V_544 | V_545 ;
V_180 = F_227 ( V_5 , V_536 , 0 , V_537 , 1 ) ;
return V_180 ;
}
...
if ( F_232 ( V_15 ) )
return 0 ;
return F_229 ( V_15 , V_548 ) ;
}
static int F_236 ( struct V_21 * V_15 )
{
struct V_4 * V_5 = F_230 ( V_15 ) ;
int V_180 ;
V_180 = F_227 ( V_5 , V_549 , V_527 ,
V_544 | V_541 , 1 ) ;
return V_180 ;
}
...
int F_243 ( struct V_492 * V_269 , T_6 V_536 )
{
V_269 -> V_15 -> V_550 . V_551 = V_536 ;
return 0 ;
}
void F_244 ( struct V_492 * V_269 )
{
V_269 -> V_15 -> V_550 . V_551 = V_549 ;
}
...
T_2 V_135 ;
int V_180 ;
V_180 = F_124 ( V_3 , V_358 , & V_3 -> V_559 ) ;
if ( V_180 )
return V_180 ;
V_135 = ( V_3 -> V_559 >> 4 ) & 0xf ;
if ( V_135 )
V_3 -> V_40 &= ( 1 << V_135 ) - 1 ;
F_12 ( V_3 ) ;
V_3 -> V_277 = V_3 -> V_40 ;
...
struct V_4 * F_249 ( struct V_492 * V_269 )
{
struct V_4 * V_5 ;
F_30 ( L_125 ) ;
V_5 = F_250 ( sizeof( * V_5 ) , V_560 ) ;
if ( ! V_5 )
return NULL ;
V_5 -> V_210 |= V_561 | V_211 ;
...
V_5 -> V_563 = 0x00FF ;
#elif F_251 ( V_564 )
V_5 -> V_563 = V_565 | V_566 | V_567 | V_568 | V_569 ;
#else
V_5 -> V_563 = V_565 | V_569 | V_568 ;
#endif
F_252 ( & V_5 -> V_570 ) ;
F_253 ( & V_5 -> V_571 , V_572 ) ;
F_254 ( & V_5 -> V_573 , V_574 ) ;
F_255 ( & V_5 -> V_575 ) ;
F_256 ( & V_5 -> V_576 ) ;
F_257 ( & V_5 -> V_577 ) ;
F_258 ( & V_5 -> V_578 ) ;
V_5 -> V_578 . V_579 = V_580 ;
V_5 -> V_578 . V_581 = ( unsigned long ) V_5 ;
V_5 -> V_33 = V_34 ;
F_246 ( V_5 , & V_5 -> V_3 , 0 ) ;
#ifdef F_259
V_5 -> V_582 . V_583 = 1 ;
...
static void F_261 ( struct V_21 * V_585 , void * V_586 )
{
struct V_492 * V_269 = F_262 ( V_585 ) ;
int V_25 ;
for ( V_25 = 0 ; V_25 < V_269 -> V_587 ; V_25 ++ ) {
struct V_4 * V_5 = V_269 -> V_588 [ V_25 ] ;
if ( ! V_5 )
continue;
if ( V_5 -> V_289 )
F_263 ( V_5 -> V_289 ) ;
...
F_264 ( V_5 -> V_12 ) ;
F_264 ( V_5 ) ;
V_269 -> V_588 [ V_25 ] = NULL ;
}
F_265 ( V_585 , NULL ) ;
}
struct V_492 * F_266 ( struct V_21 * V_15 , int V_589 )
{
struct V_492 * V_269 ;
T_5 V_590 ;
int V_25 ;
F_30 ( L_125 ) ;
if ( ! F_267 ( V_15 , NULL , V_560 ) )
return NULL ;
V_590 = sizeof( struct V_492 ) + ( V_589 + 1 ) * sizeof( void * ) ;
V_269 = F_268 ( F_261 , V_590 , V_560 ) ;
if ( ! V_269 )
goto V_260;
F_269 ( V_15 , V_269 ) ;
F_265 ( V_15 , V_269 ) ;
...
struct V_492 * F_273 ( struct V_21 * V_15 ,
...
struct V_492 * V_269 ;
int V_25 , V_596 ;
V_269 = F_266 ( V_15 , V_587 ) ;
if ( ! V_269 )
return NULL ;
for ( V_25 = 0 , V_596 = 0 , V_595 = NULL ; V_25 < V_269 -> V_587 ; V_25 ++ ) {
struct V_4 * V_5 = V_269 -> V_588 [ V_25 ] ;
if ( V_594 [ V_596 ] )
V_595 = V_594 [ V_596 ++ ] ;
V_5 -> V_44 = V_595 -> V_44 ;
...
V_5 -> V_46 = V_595 -> V_46 ;
V_5 -> V_42 |= V_595 -> V_42 ;
V_5 -> V_3 . V_42 |= V_595 -> V_597 ;
V_5 -> V_213 = V_595 -> V_598 ;
if ( ! V_269 -> V_213 && ( V_595 -> V_598 != & V_599 ) )
V_269 -> V_213 = V_595 -> V_598 ;
}
return V_269 ;
}
...
static void F_275 ( struct V_21 * V_585 , void * V_586 )
{
struct V_492 * V_269 = F_262 ( V_585 ) ;
int V_25 ;
F_87 ( ! ( V_269 -> V_42 & V_602 ) ) ;
for ( V_25 = 0 ; V_25 < V_269 -> V_587 ; V_25 ++ ) {
struct V_4 * V_5 = V_269 -> V_588 [ V_25 ] ;
if ( V_5 -> V_213 -> V_603 )
V_5 -> V_213 -> V_603 ( V_5 ) ;
}
if ( V_269 -> V_213 -> V_604 )
V_269 -> V_213 -> V_604 ( V_269 ) ;
}
static void F_276 ( struct V_605 * V_213 )
{
static F_277 ( V_209 ) ;
const struct V_605 * V_452 ;
void * * V_606 = ( void * * ) V_213 ;
void * * V_607 = ( void * * ) & V_213 -> V_608 ;
void * * V_609 ;
if ( ! V_213 || ! V_213 -> V_608 )
return;
F_278 ( & V_209 ) ;
for ( V_452 = V_213 -> V_608 ; V_452 ; V_452 = V_452 -> V_608 ) {
void * * V_610 = ( void * * ) V_452 ;
...
void F_286 ( struct V_492 * V_269 , struct V_21 * V_15 ,
unsigned long V_42 , struct V_605 * V_213 )
{
F_270 ( & V_269 -> V_209 ) ;
F_252 ( & V_269 -> V_591 ) ;
V_269 -> V_15 = V_15 ;
...
{
struct V_511 * V_512 = & V_5 -> V_3 . V_513 ;
unsigned long V_42 ;
F_67 ( V_5 -> V_209 , V_42 ) ;
V_512 -> V_614 |= V_615 ;
V_512 -> V_466 |= V_527 ;
V_512 -> V_42 |= V_544 | V_541 ;
V_5 -> V_210 &= ~ V_561 ;
V_5 -> V_210 |= V_616 ;
F_215 ( V_5 ) ;
F_68 ( V_5 -> V_209 , V_42 ) ;
...
static void F_289 ( void * V_581 , T_7 V_617 )
{
struct V_4 * V_5 = V_581 ;
if ( ! ( V_5 -> V_269 -> V_42 & V_439 ) && V_5 -> V_592 != 0 )
F_290 ( V_617 ) ;
( void ) F_288 ( V_5 ) ;
F_290 ( V_617 ) ;
F_291 ( V_5 , 1 ) ;
}
int F_292 ( struct V_492 * V_269 , struct V_618 * V_619 )
{
int V_25 , V_180 ;
if ( ! ( V_269 -> V_42 & V_602 ) ) {
F_283 ( V_269 -> V_15 , L_154 ) ;
F_87 ( 1 ) ;
return - V_117 ;
}
for ( V_25 = V_269 -> V_587 ; V_269 -> V_588 [ V_25 ] ; V_25 ++ )
F_264 ( V_269 -> V_588 [ V_25 ] ) ;
for ( V_25 = 0 ; V_25 < V_269 -> V_587 ; V_25 ++ )
V_269 -> V_588 [ V_25 ] -> V_31 = F_293 ( & V_620 ) ;
for ( V_25 = 0 ; V_25 < V_269 -> V_587 ; V_25 ++ ) {
V_180 = F_294 ( V_269 -> V_15 , V_269 -> V_588 [ V_25 ] ) ;
if ( V_180 ) {
goto V_621;
}
}
V_180 = F_295 ( V_269 , V_619 ) ;
if ( V_180 )
goto V_621;
F_296 ( V_269 ) ;
for ( V_25 = 0 ; V_25 < V_269 -> V_587 ; V_25 ++ ) {
struct V_4 * V_5 = V_269 -> V_588 [ V_25 ] ;
unsigned long V_47 ;
if ( V_5 -> V_33 == V_34 && ( V_5 -> V_42 & V_418 ) )
V_5 -> V_33 = V_281 ;
F_248 ( & V_5 -> V_3 ) ;
if ( V_5 -> V_12 )
F_248 ( V_5 -> V_12 ) ;
...
V_621:
while ( -- V_25 >= 0 ) {
F_299 ( V_269 -> V_588 [ V_25 ] ) ;
}
return V_180 ;
}
int F_300 ( struct V_492 * V_269 , int V_622 ,
...
if ( ! V_622 ) {
F_87 ( V_623 ) ;
return F_292 ( V_269 , V_619 ) ;
}
V_180 = F_301 ( V_269 -> V_15 , V_622 , V_623 , V_624 ,
F_302 ( V_269 -> V_15 ) , V_269 ) ;
if ( V_180 )
return V_180 ;
for ( V_25 = 0 ; V_25 < V_269 -> V_587 ; V_25 ++ )
F_303 ( V_269 -> V_588 [ V_25 ] , L_157 , V_622 ) ;
V_180 = F_292 ( V_269 , V_619 ) ;
if ( V_180 )
F_304 ( V_269 -> V_15 , V_622 , V_269 ) ;
return V_180 ;
}
...
void F_309 ( struct V_492 * V_269 )
{
int V_25 ;
for ( V_25 = 0 ; V_25 < V_269 -> V_587 ; V_25 ++ )
F_305 ( V_269 -> V_588 [ V_25 ] ) ;
F_310 ( V_269 ) ;
}
void F_311 ( struct V_629 * V_630 )
{
struct V_21 * V_15 = & V_630 -> V_15 ;
struct V_492 * V_269 = F_262 ( V_15 ) ;
F_309 ( V_269 ) ;
}
int F_312 ( struct V_629 * V_630 , const struct V_631 * V_131 )
{
unsigned long V_356 = 0 ;
switch ( V_131 -> V_632 ) {
case 1 : {
T_2 V_633 = 0 ;
F_313 ( V_630 , V_131 -> V_532 , & V_633 ) ;
V_356 = V_633 ;
break;
}
case 2 : {
T_4 V_634 = 0 ;
F_314 ( V_630 , V_131 -> V_532 , & V_634 ) ;
V_356 = V_634 ;
break;
}
case 4 : {
T_1 V_635 = 0 ;
F_315 ( V_630 , V_131 -> V_532 , & V_635 ) ;
V_356 = V_635 ;
break;
}
default:
...
V_356 &= V_131 -> V_360 ;
return ( V_356 == V_131 -> V_533 ) ? 1 : 0 ;
}
void F_316 ( struct V_629 * V_630 , T_6 V_536 )
{
F_317 ( V_630 ) ;
F_318 ( V_630 ) ;
if ( V_536 . V_542 & V_636 )
F_319 ( V_630 , V_637 ) ;
}
int F_320 ( struct V_629 * V_630 )
{
int V_180 ;
F_319 ( V_630 , V_638 ) ;
F_321 ( V_630 ) ;
...
int F_324 ( struct V_629 * V_630 , T_6 V_536 )
{
struct V_492 * V_269 = F_262 ( & V_630 -> V_15 ) ;
int V_180 = 0 ;
V_180 = F_243 ( V_269 , V_536 ) ;
if ( V_180 )
return V_180 ;
F_316 ( V_630 , V_536 ) ;
return 0 ;
}
int F_325 ( struct V_629 * V_630 )
{
struct V_492 * V_269 = F_262 ( & V_630 -> V_15 ) ;
int V_180 ;
V_180 = F_320 ( V_630 ) ;
...
static int T_9 F_326 ( char * * V_452 ,
struct V_27 * V_639 ,
const char * * V_251 )
{
...
{ L_204 , . V_41 = V_643 } ,
{ L_205 , . V_41 = V_644 } ,
{ L_206 , . V_41 = V_643 | V_644 } ,
} ;
char * V_435 = * V_452 , * V_147 = * V_452 ;
char * V_142 , * V_533 , * V_645 ;
...
if ( V_147 ) {
* V_147 ++ = '\0' ;
V_639 -> V_21 = F_328 ( V_147 , & V_645 , 10 ) ;
if ( V_147 == V_645 || * V_645 != '\0' ) {
* V_251 = L_207 ;
return - V_117 ;
}
}
V_639 -> V_30 = F_328 ( V_142 , & V_645 , 10 ) ;
if ( V_147 == V_645 || * V_645 != '\0' ) {
* V_251 = L_208 ;
return - V_117 ;
}
V_648:
for ( V_25 = 0 ; V_25 < F_37 ( V_641 ) ; V_25 ++ ) {
const struct V_640 * V_649 = & V_641 [ V_25 ] ;
if ( strncasecmp ( V_533 , V_649 -> V_35 , strlen ( V_533 ) ) )
continue;
V_647 ++ ;
V_646 = V_649 ;
if ( strcasecmp ( V_533 , V_649 -> V_35 ) == 0 ) {
V_647 = 1 ;
break;
}
}
...
int V_650 = 0 , V_651 = 1 ;
int V_652 = - 1 , V_653 = - 1 ;
char * V_147 , * V_452 , * V_23 ;
for ( V_147 = V_654 ; * V_147 ; V_147 ++ )
if ( * V_147 == ',' )
V_651 ++ ;
V_29 = F_250 ( sizeof( V_29 [ 0 ] ) * V_651 , V_560 ) ;
if ( ! V_29 ) {
F_330 ( V_655 L_211
L_212 ) ;
return;
}
for ( V_452 = V_654 ; * V_452 != '\0' ; V_452 = V_23 ) {
const char * V_251 = L_67 ;
struct V_27 V_656 = { . V_30 = - 1 , . V_21 = - 1 } ;
V_23 = V_452 ;
if ( F_326 ( & V_23 , & V_656 , & V_251 ) ) {
F_330 ( V_655 L_213
L_214 ,
V_452 , V_251 ) ;
continue;
...
void F_168 ( struct V_4 * V_5 , unsigned int V_660 )
{
bool V_661 = V_5 && V_5 -> V_269 -> V_662 == V_663 ;
if ( V_661 )
F_77 ( V_5 ) ;
F_174 ( V_660 ) ;
if ( V_661 )
...
T_1 F_341 ( struct V_4 * V_5 , void T_11 * V_532 , T_1 V_360 , T_1 V_533 ,
unsigned long V_448 , unsigned long V_202 )
{
unsigned long V_434 ;
T_1 V_356 ;
V_356 = F_342 ( V_532 ) ;
V_434 = F_163 ( V_436 , V_202 ) ;
while ( ( V_356 & V_360 ) == V_533 && F_167 ( V_436 , V_434 ) ) {
F_168 ( V_5 , V_448 ) ;
V_356 = F_342 ( V_532 ) ;
}
return V_356 ;
...
int F_345 ( const struct V_4 * V_5 , const char * V_664 ,
const char * V_665 , ... )
{
struct V_666 V_667 ;
T_12 args ;
...
V_667 . V_665 = V_665 ;
V_667 . V_669 = & args ;
V_668 = F_330 ( L_217 , V_664 , V_5 -> V_31 , & V_667 ) ;
va_end ( args ) ;
return V_668 ;
}
int F_346 ( const struct V_2 * V_3 , const char * V_664 ,
const char * V_665 , ... )
{
struct V_666 V_667 ;
T_12 args ;
...
V_668 = F_330 ( L_218 ,
V_664 , V_3 -> V_5 -> V_31 , V_3 -> V_38 , & V_667 ) ;
else
V_668 = F_330 ( L_217 ,
V_664 , V_3 -> V_5 -> V_31 , & V_667 ) ;
va_end ( args ) ;
return V_668 ;
}
int F_347 ( const struct V_14 * V_15 , const char * V_664 ,
const char * V_665 , ... )
{
struct V_666 V_667 ;
T_12 args ;
...
V_667 . V_669 = & args ;
V_668 = F_330 ( L_218 ,
V_664 , V_15 -> V_3 -> V_5 -> V_31 , V_15 -> V_3 -> V_38 + V_15 -> V_24 ,
& V_667 ) ;
va_end ( args ) ;
return V_668 ;
}
void F_348 ( const struct V_21 * V_15 , const char * V_670 )
{
F_349 ( V_267 , V_15 , L_219 , V_670 ) ;
}
