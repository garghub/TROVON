...
F_21 ( V_46 , V_55 + V_50 + 1 - V_46 -> V_60 ) ) {
V_55 = F_19 ( V_46 ) ;
...
F_21 ( V_46 , V_55 + V_50 + 4 - V_46 -> V_60 ) ) ) {
T_4 * V_70 = ( T_4 * ) V_54 ;
V_7 -> V_71 = V_70 [ ! ! V_47 ] ;
V_7 -> V_72 = V_70 [ ! V_47 ] ;
}
...
return;
case V_74 :
if ( ! V_49 && F_21 ( V_46 , V_55 + V_50 + 2 - V_46 -> V_60 ) ) {
T_3 * V_75 = ( T_3 * ) V_54 ;
V_7 -> V_76 = V_75 [ 0 ] ;
V_7 -> V_77 = V_75 [ 1 ] ;
}
V_7 -> V_73 = V_56 ;
return;
#if F_23 ( V_78 ) || F_23 ( V_79 )
case V_80 :
if ( ! V_49 && F_21 ( V_46 , V_55 + V_50 + 3 - V_46 -> V_60 ) ) {
struct V_81 * V_82 ;
...
static inline int F_24 ( struct V_89 * V_20 )
{
struct V_2 * V_2 = F_25 ( V_20 , struct V_2 , V_90 . V_91 ) ;
V_92 . V_93 ( V_2 ) ;
return F_26 ( V_20 ) > V_20 -> V_94 * 2 ;
}
static void F_27 ( struct V_1 * V_8 , T_5 V_95 )
{
...
{
struct V_17 * V_31 = (struct V_17 * ) V_8 ;
if ( F_29 ( V_31 -> V_28 . V_29 . V_33 ) )
F_30 ( V_31 -> V_28 . V_29 . V_33 ) ;
F_31 ( V_8 ) ;
if ( F_29 ( V_31 -> V_28 . V_29 . V_35 ) )
F_32 ( V_31 -> V_28 . V_29 . V_35 ) ;
F_33 ( V_31 ) ;
}
static void F_34 ( struct V_1 * V_8 , struct V_10 * V_11 ,
int V_97 )
{
struct V_17 * V_31 ;
if ( ! V_97 )
