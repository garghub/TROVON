...
bool F_42 ( struct V_1 * V_2 , const struct V_4 * V_84 ,
...
bool F_77 ( struct V_126 * V_127 , int V_128 )
{
struct V_129 * V_130 ;
if ( V_128 != V_131 )
return false ;
...
bool F_80 ( struct V_6 * V_7 , const struct V_4 * V_35 ,
const struct V_4 * V_85 )
{
struct V_30 * V_31 ;
struct V_87 * V_86 ;
...
static bool F_88 ( struct V_87 * V_43 , int V_148 ,
...
static bool F_99 ( struct V_87 * V_43 , struct V_103 * V_104 , int type ,
int V_184 , int V_185 )
{
switch ( type ) {
case V_186 :
