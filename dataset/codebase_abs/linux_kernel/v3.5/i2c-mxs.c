...
if ( F_24 ( V_67 ) )
return F_25 ( V_67 ) ;
V_2 = F_26 ( V_34 , sizeof( struct V_1 ) , V_72 ) ;
if ( ! V_2 )
return - V_73 ;
V_69 = F_27 ( V_65 , V_74 , 0 ) ;
if ( ! V_69 )
return - V_75 ;
V_70 = F_28 ( V_69 ) ;
if ( ! F_29 ( V_34 , V_69 -> V_76 , V_70 , V_69 -> V_77 ) )
return - V_78 ;
V_2 -> V_3 = F_30 ( V_34 , V_69 -> V_76 , V_70 ) ;
if ( ! V_2 -> V_3 )
return - V_78 ;
V_71 = F_31 ( V_65 , 0 ) ;
if ( V_71 < 0 )
return V_71 ;
V_45 = F_32 ( V_34 , V_71 , F_20 , 0 , F_33 ( V_34 ) , V_2 ) ;
if ( V_45 )
return V_45 ;
V_2 -> V_34 = V_34 ;
F_34 ( V_65 , V_2 ) ;
F_1 ( V_2 ) ;
V_29 = & V_2 -> V_79 ;
F_35 ( V_29 -> V_77 , L_4 , sizeof( V_29 -> V_77 ) ) ;
V_29 -> V_80 = V_81 ;
V_29 -> V_82 = & V_83 ;
V_29 -> V_34 . V_84 = V_34 ;
V_29 -> V_85 = V_65 -> V_86 ;
V_29 -> V_34 . V_87 = V_65 -> V_34 . V_87 ;
F_36 ( V_29 , V_2 ) ;
V_45 = F_37 ( V_29 ) ;
if ( V_45 ) {
F_38 ( V_34 , L_5 , V_45 ) ;
...
static int T_6 F_40 ( struct V_64 * V_65 )
{
struct V_1 * V_2 = F_41 ( V_65 ) ;
int V_33 ;
V_33 = F_42 ( & V_2 -> V_79 ) ;
if ( V_33 )
return - V_78 ;
F_3 ( V_88 , V_2 -> V_3 + V_89 ) ;
F_34 ( V_65 , NULL ) ;
return 0 ;
}
static int T_7 F_43 ( void )
{
return F_44 ( & V_90 , F_22 ) ;
}
