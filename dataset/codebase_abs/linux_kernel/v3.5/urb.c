...
V_98 = F_53 ( V_12 -> V_15 . V_99 , struct V_2 ,
V_6 ) ;
F_12 ( V_98 ) ;
F_54 ( & V_12 -> V_14 ) ;
F_43 ( V_98 ) ;
...
struct V_2 * V_100 ;
F_15 ( & V_12 -> V_14 , V_13 ) ;
F_57 (lazarus, &anchor->urb_list, anchor_list) {
F_49 ( V_100 ) ;
}
V_12 -> V_16 = 0 ;
F_19 ( & V_12 -> V_14 , V_13 ) ;
...
unsigned int V_101 )
{
return F_61 ( V_12 -> V_18 , F_23 ( & V_12 -> V_15 ) ,
F_62 ( V_101 ) ) ;
}
struct V_2 * F_59 ( struct V_11 * V_12 )
{
struct V_2 * V_98 ;
unsigned long V_13 ;
F_15 ( & V_12 -> V_14 , V_13 ) ;
if ( ! F_23 ( & V_12 -> V_15 ) ) {
V_98 = F_53 ( V_12 -> V_15 . V_102 , struct V_2 ,
V_6 ) ;
F_12 ( V_98 ) ;
F_20 ( V_98 , V_12 ) ;
} else {
