...
goto V_186;
if ( V_148 &&
F_103 ( V_28 , V_192 , V_148 ) )
goto V_186;
V_49 = F_102 ( V_28 , V_193 , V_171 -> V_194 ,
V_171 -> V_89 ) ;
if ( V_49 < 0 && V_181 )
goto error;
...
static int F_111 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
struct V_67 * * V_90 = V_152 -> V_86 ;
struct V_65 * V_65 = V_152 -> V_153 ;
struct V_33 V_34 ;
...
if ( ! V_90 [ V_185 ] )
goto error;
error = F_112 ( & V_34 , & V_36 , V_90 [ V_185 ] ) ;
if ( error )
goto error;
if ( V_90 [ V_193 ] ) {
...
F_115 ( V_19 , V_30 ) ;
V_196 = F_108 ( V_30 , V_3 , V_152 -> V_202 ,
V_152 -> V_203 ,
V_198 ) ;
} else {
struct V_154 * V_204 ;
...
if ( ! F_17 ( V_196 ) )
F_117 ( V_196 , F_118 ( V_152 ) , V_152 -> V_202 ,
...
static int F_120 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
struct V_67 * * V_90 = V_152 -> V_86 ;
struct V_65 * V_65 = V_152 -> V_153 ;
struct V_33 V_34 ;
...
if ( ! V_90 [ V_185 ] )
return - V_92 ;
V_49 = F_112 ( & V_34 , & V_36 , V_90 [ V_185 ] ) ;
if ( V_49 )
return V_49 ;
V_3 = F_1 ( V_65 -> V_2 ) ;
if ( ! V_3 )
...
static int F_125 ( struct V_27 * V_28 , struct V_217 * V_218 )
{
struct V_65 * V_65 = F_126 ( F_127 ( V_218 -> V_219 ) ) ;
struct V_1 * V_3 ;
struct V_18 * V_19 ;
V_3 = F_1 ( V_65 -> V_2 ) ;
if ( ! V_3 )
...
V_220 = V_218 -> args [ 0 ] ;
V_221 = V_218 -> args [ 1 ] ;
V_30 = F_128 ( V_19 , & V_220 , & V_221 ) ;
if ( ! V_30 )
break;
if ( F_96 ( V_30 , V_3 , V_28 ,
F_129 ( V_218 -> V_28 ) . V_42 ,
...
V_65 -> V_2 = F_8 ( V_3 ) ;
F_2 () ;
V_49 = F_131 ( V_28 , V_226 , F_6 ( V_3 ) ) ;
F_5 () ;
if ( V_49 )
goto V_186;
F_91 ( V_3 , & V_224 ) ;
if ( F_102 ( V_28 , V_227 , sizeof( struct V_173 ) , & V_224 ) )
goto V_186;
return F_104 ( V_28 , V_65 ) ;
V_186:
F_105 ( V_28 , V_65 ) ;
...
struct V_27 * V_28 ;
int V_195 ;
V_28 = F_133 ( V_228 , V_161 ) ;
if ( ! V_28 )
return F_109 ( - V_71 ) ;
V_195 = F_130 ( V_3 , V_28 , V_42 , V_179 , 0 , V_39 ) ;
if ( V_195 < 0 ) {
F_29 ( V_28 ) ;
return F_109 ( V_195 ) ;
}
...
struct V_7 * V_7 ;
F_2 () ;
V_7 = F_135 ( F_59 ( V_90 [ V_226 ] ) ) ;
V_3 = V_7 && V_7 -> V_23 == V_9 ? V_7 -> V_3 : NULL ;
F_5 () ;
}
return V_3 ? V_3 : F_109 ( - V_51 ) ;
}
static int F_136 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
struct V_67 * * V_90 = V_152 -> V_86 ;
struct V_21 V_22 ;
struct V_27 * V_196 ;
...
V_196 = F_132 ( V_3 , V_152 -> V_202 ,
V_152 -> V_203 , V_241 ) ;
V_49 = F_42 ( V_196 ) ;
if ( F_17 ( V_196 ) )
goto V_242;
F_142 ( & V_3 -> V_243 , & V_244 ) ;
F_143 () ;
F_117 ( V_196 , F_118 ( V_152 ) , V_152 -> V_202 ,
...
static int F_146 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
...
int V_49 ;
F_137 () ;
V_3 = F_134 ( V_152 -> V_153 , V_152 -> V_86 ) ;
V_49 = F_42 ( V_3 ) ;
if ( F_17 ( V_3 ) )
goto V_247;
V_196 = F_132 ( V_3 , V_152 -> V_202 ,
...
static int F_149 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
struct V_27 * V_196 ;
struct V_1 * V_3 ;
int V_49 ;
...
static int F_150 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
struct V_27 * V_196 ;
struct V_1 * V_3 ;
V_3 = F_134 ( V_152 -> V_153 , V_152 -> V_86 ) ;
...
static int F_151 ( struct V_27 * V_28 , struct V_217 * V_218 )
{
struct V_1 * V_3 ;
...
if ( V_174 >= V_249 &&
F_130 ( V_3 , V_28 , F_129 ( V_218 -> V_28 ) . V_42 ,
V_218 -> V_219 -> V_222 , V_223 ,
V_241 ) < 0 )
break;
V_174 ++ ;
...
if ( F_154 ( V_28 , V_253 , V_7 -> V_23 ) ||
F_154 ( V_28 , V_254 , V_7 -> V_10 -> type ) ||
F_131 ( V_28 , V_255 , V_7 -> V_10 -> V_11 ( V_7 ) ) ||
F_154 ( V_28 , V_256 , V_7 -> V_43 ) )
goto V_186;
F_155 ( V_7 , & V_251 ) ;
if ( F_102 ( V_28 , V_257 , sizeof( struct V_250 ) ,
& V_251 ) )
goto V_186;
V_49 = F_156 ( V_7 , V_28 ) ;
if ( V_49 == - V_184 )
...
struct V_27 * V_28 ;
int V_195 ;
V_28 = F_133 ( V_228 , V_70 ) ;
if ( ! V_28 )
return F_109 ( - V_71 ) ;
V_195 = F_153 ( V_7 , V_28 , V_42 , V_179 , 0 , V_39 ) ;
if ( V_195 < 0 ) {
F_29 ( V_28 ) ;
return F_109 ( V_195 ) ;
}
...
static int F_159 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
struct V_67 * * V_90 = V_152 -> V_86 ;
struct V_65 * V_65 = V_152 -> V_153 ;
struct V_21 V_22 ;
...
if ( F_17 ( V_7 ) )
goto V_247;
V_196 = F_157 ( V_7 , V_152 -> V_202 , V_152 -> V_203 ,
V_260 ) ;
if ( F_17 ( V_196 ) ) {
V_49 = F_42 ( V_196 ) ;
F_20 ( V_7 ) ;
...
static int F_160 ( struct V_27 * V_28 , struct V_151 * V_152 )
{
struct V_67 * * V_90 = V_152 -> V_86 ;
struct V_27 * V_196 ;
struct V_7 * V_7 ;
...
static int F_164 ( struct V_27 * V_28 , struct V_217 * V_218 )
{
struct V_65 * V_65 = F_126 ( F_127 ( V_218 -> V_219 ) ) ;
struct V_1 * V_3 ;
V_94 V_23 ;
...
if ( ! V_7 )
continue;
if ( F_153 ( V_7 , V_28 , F_129 ( V_218 -> V_28 ) . V_42 ,
V_218 -> V_219 -> V_222 , V_223 ,
V_260 ) < 0 )
break;
}
...
static void F_170 ( int V_267 )
{
int V_174 ;
for ( V_174 = 0 ; V_174 < V_267 ; V_174 ++ )
F_171 ( V_268 [ V_174 ] . V_269 ) ;
}
...
int V_174 ;
V_270 = 0 ;
for ( V_174 = 0 ; V_174 < F_173 ( V_268 ) ; V_174 ++ ) {
const struct V_271 * V_272 = & V_268 [ V_174 ] ;
V_49 = F_174 ( V_272 -> V_269 , V_272 -> V_10 ,
V_272 -> V_273 ) ;
if ( V_49 )
goto error;
V_270 ++ ;
if ( V_272 -> V_274 ) {
V_49 = F_175 ( V_272 -> V_269 , V_272 -> V_274 ) ;
if ( V_49 )
goto error;
}
}
...
struct V_27 * V_275 ;
int V_49 ;
F_177 ( sizeof( struct V_276 ) > sizeof( V_275 -> V_218 ) ) ;
F_178 ( L_1 ) ;
V_49 = F_179 () ;
if ( V_49 )
goto error;
