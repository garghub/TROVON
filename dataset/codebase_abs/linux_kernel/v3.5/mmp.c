...
{
F_24 ( V_2 , V_25 , line , V_26 ) ;
F_24 ( V_2 , V_25 , line ,
L_2
L_3 ,
( long long unsigned int ) F_25 ( V_4 -> V_27 ) ,
V_4 -> V_28 , V_4 -> V_29 ) ;
}
static int F_26 ( void * V_30 )
{
...
V_45 ) ;
V_4 -> V_39 = F_31 ( V_39 ) ;
F_32 ( V_13 -> V_46 , V_4 -> V_29 ) ;
memcpy ( V_4 -> V_28 , F_33 () -> V_47 ,
sizeof( V_4 -> V_28 ) ) ;
while ( ! F_34 () ) {
if ( ++ V_35 > V_48 )
V_35 = 1 ;
...
struct V_31 * V_31 ;
T_3 V_35 ;
unsigned int V_39 = F_27 ( V_33 -> V_38 ) ;
unsigned int V_63 = 0 ;
int V_42 ;
if ( V_18 < F_22 ( V_33 -> V_64 ) ||
V_18 >= F_44 ( V_33 ) ) {
F_21 ( V_2 , L_14 ) ;
goto V_54;
}
V_42 = F_17 ( V_2 , & V_13 , V_18 ) ;
if ( V_42 )
goto V_54;
V_4 = (struct V_3 * ) ( V_13 -> V_14 ) ;
if ( V_39 < V_45 )
V_39 = V_45 ;
if ( F_27 ( V_4 -> V_39 ) > V_39 )
V_39 = F_27 ( V_4 -> V_39 ) ;
V_35 = F_22 ( V_4 -> V_49 ) ;
if ( V_35 == V_61 )
goto V_65;
...
V_31 = F_45 ( sizeof( struct V_31 ) , V_67 ) ;
if ( ! V_31 ) {
F_21 ( V_2 , L_20 ) ;
goto V_54;
}
V_31 -> V_2 = V_2 ;
V_31 -> V_13 = V_13 ;
F_2 ( V_2 ) -> V_53 = F_46 ( F_26 , V_31 , L_21 ,
F_32 ( V_13 -> V_46 ,
V_4 -> V_29 ) ) ;
if ( F_47 ( F_2 ( V_2 ) -> V_53 ) ) {
F_2 ( V_2 ) -> V_53 = NULL ;
F_40 ( V_31 ) ;
F_21 ( V_2 , L_22 ,
V_2 -> V_68 ) ;
