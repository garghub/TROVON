...
static int F_45 ( struct V_46 * V_20 )
{
...
static void F_47 ( struct V_51 * V_16 , int V_39 )
{
struct V_1 * V_2 = F_48 ( & V_16 -> V_33 ) ;
F_5 ( V_2 -> V_6 -> V_11 ) ;
if ( V_39 )
F_1 ( V_2 ) ;
else
...
static void F_49 ( struct V_51 * V_16 )
{
struct V_1 * V_2 = F_48 ( & V_16 -> V_33 ) ;
F_34 ( V_2 ) ;
F_26 ( V_2 ) ;
...
static int F_50 ( struct V_51 * V_16 )
{
struct V_1 * V_2 ;
int V_3 ;
T_1 V_34 [ 3 ] = { 0 , } ;
V_2 = F_51 ( sizeof( struct V_1 ) , V_54 ) ;
if ( ! V_2 ) {
F_39 ( & V_16 -> V_33 , L_6 ) ;
return - V_55 ;
}
...
V_2 -> V_33 = & V_16 -> V_33 ;
F_52 ( & V_2 -> V_7 ) ;
V_3 = F_53 ( V_2 -> V_33 , F_4 ( V_9 ) , V_9 ) ;
if ( V_3 ) {
F_39 ( V_2 -> V_33 , L_7 , V_3 ) ;
goto V_57;
}
V_2 -> V_32 = F_54 ( L_8 , V_2 -> V_33 , V_2 ,
& V_58 ) ;
if ( F_55 ( V_2 -> V_32 ) ) {
F_39 ( V_2 -> V_33 , L_9 ) ;
V_3 = F_56 ( V_2 -> V_32 ) ;
...
V_2 -> V_20 = F_57 ( L_10 , V_2 -> V_33 , V_2 ,
& V_59 , NULL ) ;
if ( F_55 ( V_2 -> V_20 ) ) {
F_39 ( V_2 -> V_33 , L_11 ) ;
V_3 = F_56 ( V_2 -> V_20 ) ;
...
static int F_63 ( struct V_51 * V_16 )
{
struct V_1 * V_2 = F_48 ( & V_16 -> V_33 ) ;
F_24 ( V_2 ) ;
F_5 ( V_2 -> V_6 -> V_61 ) ;
...
static int F_64 ( struct V_51 * V_16 )
{
struct V_1 * V_2 = F_48 ( & V_16 -> V_33 ) ;
F_25 ( V_2 ) ;
F_5 ( V_2 -> V_6 -> V_11 ) ;
