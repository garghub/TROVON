...
if ( ! F_39 ( V_1 , V_177 ) )
return;
if ( F_55 ( V_10 ) -> V_188 >= 4 ) {
V_173 = V_189 | V_190 ;
if ( V_1 -> V_191 )
V_173 |= V_1 -> V_192 ;
if ( F_55 ( V_10 ) -> V_188 < 5 )
V_173 |= V_193 ;
} else {
V_173 = F_9 ( V_1 -> V_17 ) ;
switch ( V_1 -> V_17 ) {
...
if ( F_56 ( V_10 ) >= V_196 )
V_173 |= F_57 ( V_172 -> V_197 ) ;
else
V_173 |= F_58 ( V_172 -> V_197 ) ;
if ( V_1 -> V_198 )
V_173 |= V_199 ;
if ( F_55 ( V_10 ) -> V_188 >= 4 ) {
} else if ( F_59 ( V_10 ) || F_60 ( V_10 ) || F_61 ( V_10 ) ) {
} else {
V_173 |= ( V_176 - 1 ) << V_200 ;
}
...
static void F_62 ( struct V_2 * V_3 , int V_52 )
{
struct V_9 * V_10 = V_3 -> V_10 ;
struct V_11 * V_12 = V_10 -> V_13 ;
struct V_1 * V_1 = F_1 ( V_3 ) ;
...
static bool F_65 ( struct V_1 * V_1 , struct V_215 * V_216 )
{
F_29 ( sizeof( * V_216 ) != 8 ) ;
if ( ! F_26 ( V_1 ,
V_217 ,
...
struct V_9 * V_10 = V_1 -> V_4 . V_4 . V_10 ;
T_2 V_42 [ 2 ] ;
if ( F_59 ( V_10 ) || F_60 ( V_10 ) )
return false ;
return F_26 ( V_1 , V_230 ,
& V_42 , 2 ) && V_42 [ 0 ] ;
}
static void F_67 ( struct V_231 * V_3 )
{
...
F_68 ( struct V_1 * V_1 )
{
return F_69 ( V_1 -> V_216 . V_229 ) > 1 ;
}
static struct V_234 *
F_70 ( struct V_5 * V_6 )
{
struct V_1 * V_235 = F_3 ( V_6 ) ;
return F_71 ( V_6 , & V_235 -> V_236 ) ;
}
static struct V_234 *
F_72 ( struct V_5 * V_6 )
{
...
V_36 = V_243 ;
if ( V_1 -> V_191 ) {
V_1 -> V_181 = F_75 ( V_234 ) ;
V_1 -> V_198 = F_76 ( V_234 ) ;
}
} else
V_36 = V_244 ;
...
static bool
F_77 ( struct V_7 * V_235 ,
struct V_234 * V_234 )
{
bool V_250 = ! ! ( V_234 -> V_241 & V_242 ) ;
bool V_251 = ! ! F_78 ( V_235 ) ;
F_12 ( L_29 ,
V_251 , V_250 ) ;
return V_251 == V_250 ;
}
static enum V_238
F_79 ( struct V_5 * V_6 , bool V_252 )
{
T_4 V_42 ;
struct V_1 * V_1 = F_3 ( V_6 ) ;
struct V_7 * V_7 = F_5 ( V_6 ) ;
...
V_266:
F_91 (newmode, &connector->probed_modes, head) {
if ( V_264 -> type & V_268 ) {
V_1 -> V_97 =
F_86 ( V_6 -> V_10 , V_264 ) ;
V_1 -> V_96 = true ;
...
F_103 (hpos, HPOS)
F_103 (vpos, VPOS)
F_103 (saturation, SATURATION)
F_103 (contrast, CONTRAST)
F_103 (hue, HUE)
F_103 (brightness, BRIGHTNESS)
F_103 (sharpness, SHARPNESS)
F_103 (flicker_filter, FLICKER_FILTER)
F_103 (flicker_filter_2d, FLICKER_FILTER_2D)
F_103 (flicker_filter_adaptive, FLICKER_FILTER_ADAPTIVE)
F_103 (tv_chroma_filter, TV_CHROMA_FILTER)
F_103 (tv_luma_filter, TV_LUMA_FILTER)
F_103 (dot_crawl, DOT_CRAWL)
}
return - V_297 ;
V_303:
...
F_105 ( V_171 , & V_171 -> V_52 , V_171 -> V_309 ,
...
V_328 = V_323 -> V_330 ;
if ( F_113 ( V_328 ) ) {
V_235 -> V_31 = F_73 ( V_12 , V_328 ) ;
F_114 ( V_235 -> V_31 , V_331 ) ;
F_115 ( V_235 -> V_31 , true ) ;
} else {
V_235 -> V_31 = F_73 ( V_12 , V_329 ) ;
}
}
static bool
F_116 ( struct V_1 * V_1 , int V_332 )
{
return F_43 ( V_1 ) ;
}
static T_2
F_117 ( struct V_9 * V_10 , struct V_1 * V_235 )
{
struct V_11 * V_12 = V_10 -> V_13 ;
...
static void
F_118 ( struct V_7 * V_6 ,
struct V_1 * V_3 )
{
F_119 ( V_3 -> V_4 . V_4 . V_10 ,
& V_6 -> V_4 . V_4 ,
& V_335 ,
V_6 -> V_4 . V_4 . V_336 ) ;
F_120 ( & V_6 -> V_4 . V_4 ,
...
F_121 ( & V_6 -> V_4 , & V_3 -> V_4 ) ;
F_122 ( & V_6 -> V_4 . V_4 ) ;
}
static void
F_123 ( struct V_7 * V_6 )
{
struct V_9 * V_10 = V_6 -> V_4 . V_4 . V_10 ;
F_124 ( & V_6 -> V_4 . V_4 ) ;
if ( F_55 ( V_10 ) -> V_188 >= 4 && F_125 ( V_10 ) )
F_126 ( & V_6 -> V_4 . V_4 ) ;
}
static bool
F_127 ( struct V_1 * V_1 , int V_332 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_231 * V_231 = F_128 ( V_3 ) ;
struct V_342 * V_342 ;
struct V_7 * V_7 ;
...
static bool
F_132 ( struct V_1 * V_1 , int V_332 )
{
struct V_2 * V_3 = & V_1 -> V_4 . V_4 ;
struct V_5 * V_6 ;
struct V_342 * V_342 ;
...
if ( F_93 ( V_7 ) )
return F_138 ( V_1 , V_7 , V_377 . V_260 ) ;
else if ( F_94 ( V_7 ) )
return F_141 ( V_1 , V_7 , V_377 . V_260 ) ;
else
return true ;
}
static int F_142 ( struct V_401 * V_402 ,
struct V_23 * V_24 ,
int V_403 )
{
...
V_12 -> V_419 |= V_421 ;
F_148 ( & V_231 -> V_4 , & V_422 ) ;
if ( ! F_65 ( V_1 , & V_1 -> V_216 ) )
goto V_358;
F_26 ( V_1 , V_423 ,
& V_1 -> V_233 , 2 ) ;
V_1 -> V_233 [ 0 ] &= ~ 0x3 ;
