...
V_4 -> V_5 + V_45 ) ;
V_20 = F_41 ( V_22 -> V_46 , V_47 , V_2 ,
true , V_22 -> V_48 , F_16 , F_37 , V_52 ) ;
if ( ! V_20 ) {
V_53 = - V_57 ;
goto V_65;
}
...
{
struct V_3 * V_4 = F_2 ( V_2 ) ;
return V_4 -> V_50 -> V_52 ;
}
static int T_5 F_50 ( struct V_72 * V_50 )
{
struct V_3 * V_4 ;
struct V_73 * V_74 ;
unsigned long V_75 ;
V_74 = F_51 ( V_50 , V_76 , 0 ) ;
if ( ! V_74 )
return - V_77 ;
if ( ! F_52 ( & V_50 -> V_30 , V_74 -> V_78 ,
F_53 ( V_74 ) , V_50 -> V_52 ) )
return - V_79 ;
V_4 = F_54 ( & V_50 -> V_30 , sizeof( * V_4 ) , V_56 ) ;
if ( ! V_4 )
return - V_57 ;
...
F_55 ( & V_4 -> V_66 ) ;
F_56 ( & V_4 -> V_41 ) ;
V_4 -> V_5 = F_57 ( & V_50 -> V_30 , V_74 -> V_78 , F_53 ( V_74 ) ) ;
if ( V_4 -> V_5 == NULL )
return - V_83 ;
V_75 = F_4 ( V_4 -> V_5 + V_84 ) ;
if ( memcmp ( & V_75 , L_1 , 4 ) != 0 ) {
F_58 ( & V_50 -> V_30 , L_2 , V_75 ) ;
return - V_85 ;
}
...
static int T_6 F_62 ( struct V_72 * V_50 )
{
struct V_3 * V_4 = F_63 ( V_50 ) ;
F_64 ( & V_4 -> V_2 ) ;
return 0 ;
}
static int F_65 ( const char * V_90 ,
...
V_98 [ 0 ] . V_32 = V_76 ;
V_98 [ 1 ] . V_32 = V_102 ;
V_98 [ 0 ] . V_103 = F_66 ( V_90 , & V_99 ) - 1 ;
V_100 = sscanf ( V_99 , L_4 ,
& V_5 , & V_98 [ 1 ] . V_78 , & V_101 ,
& V_104 , & V_101 ) ;
if ( V_100 < 2 || V_100 > 3 || V_99 [ V_101 ] )
return - V_77 ;
V_98 [ 0 ] . V_78 = V_5 ;
V_98 [ 0 ] . V_103 += V_5 ;
V_98 [ 1 ] . V_103 = V_98 [ 1 ] . V_78 ;
if ( ! V_105 ) {
V_53 = F_67 ( & V_106 ) ;
if ( V_53 ) {
F_68 ( L_5 ) ;
...
F_69 ( L_6 ,
V_104 ,
( unsigned long long ) V_98 [ 0 ] . V_78 ,
( unsigned long long ) V_98 [ 0 ] . V_103 ,
( int ) V_98 [ 1 ] . V_78 ) ;
V_50 = F_70 ( & V_106 ,
L_7 , V_104 ++ ,
V_98 , F_7 ( V_98 ) , NULL , 0 ) ;
if ( F_47 ( V_50 ) )
return F_48 ( V_50 ) ;
return 0 ;
}
static int F_71 ( struct V_90 * V_30 , void * V_107 )
{
char * V_108 = V_107 ;
unsigned int V_14 = strlen ( V_108 ) ;
struct V_72 * V_50 = F_72 ( V_30 ) ;
snprintf ( V_108 + V_14 , V_94 - V_14 , L_8 ,
V_50 -> V_73 [ 0 ] . V_103 - V_50 -> V_73 [ 0 ] . V_78 + 1ULL ,
( unsigned long long ) V_50 -> V_73 [ 0 ] . V_78 ,
( unsigned long long ) V_50 -> V_73 [ 1 ] . V_78 ,
V_50 -> V_89 ) ;
return 0 ;
}
static int F_73 ( char * V_108 , const struct V_96 * V_97 )
{
V_108 [ 0 ] = '\0' ;
F_74 ( & V_106 , V_108 ,
F_71 ) ;
return strlen ( V_108 ) + 1 ;
}
static int F_75 ( struct V_90 * V_30 ,
void * V_107 )
{
F_76 ( F_72 ( V_30 ) ) ;
return 0 ;
