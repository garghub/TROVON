...
struct V_39 * V_40 ;
int * V_41 ;
V_41 = F_16 ( sizeof( int ) * F_17 ( 1 , V_36 ) , V_42 ) ;
if ( ! V_41 )
return - V_43 ;
if ( type == V_44 )
...
static void F_24 ( struct V_1 * V_45 , unsigned int V_5 ,
struct V_46 * V_47 )
{
V_47 -> V_48 = V_49 | F_25 ( V_5 ) ;
V_47 -> V_50 =
V_51 |
V_52 |
V_53 |
...
V_79 . V_61 = V_2 -> V_61 ;
V_37 = F_8 ( V_80 , & V_79 ) ;
F_40 ( V_37 && V_37 != - V_77 , L_22 , V_37 ) ;
}
}
static void F_41 ( struct V_1 * V_2 )
{
struct V_39 * V_40 ;
V_40 = F_42 ( V_2 -> V_81 . V_82 , struct V_39 , V_83 ) ;
if ( V_40 -> V_69 . V_84 )
F_43 ( V_2 ) ;
else
F_44 ( V_2 ) ;
...
static struct V_100 * F_59 ( struct V_1 * V_2 )
{
struct V_100 * V_101 ;
...
int F_62 ( struct V_1 * V_2 , T_5 V_102 )
{
struct V_100 * V_101 ;
V_101 = F_16 ( sizeof( struct V_100 ) , V_42 ) ;
if ( ! V_101 )
return - V_57 ;
F_60 ( & V_103 ) ;
if ( F_59 ( V_2 ) ) {
