...
static T_2 F_45 ( int V_31 , void * V_108 )
{
struct V_1 * V_2 = F_31 ( V_108 ) ;
V_2 -> V_27 = true ;
F_46 ( & V_2 -> V_32 ) ;
F_36 ( V_31 ) ;
V_2 -> V_30 = true ;
...
F_36 ( V_2 -> V_17 -> V_31 ) ;
V_2 -> V_30 = true ;
V_2 -> V_96 -> V_40 . V_114 = & V_2 -> V_17 -> V_40 ;
V_2 -> V_96 -> V_115 = V_42 ;
V_18 = F_53 ( V_2 -> V_96 ) ;
V_42 -> V_96 = V_2 -> V_96 ;
if ( V_18 )
...
static T_5 F_58 ( struct V_117 * V_40 ,
struct V_118 * V_119 ,
char * V_120 )
{
struct V_41 * V_42 = F_59 ( V_40 ) ;
struct V_1 * V_2 = F_31 ( V_42 ) ;
return sprintf ( V_120 , L_6 , V_2 -> V_53 /
( V_2 -> V_66 * 1024 * F_27 ( V_2 -> V_23 ) ) ) ;
}
static T_5 F_60 ( struct V_117 * V_40 ,
struct V_118 * V_119 ,
const char * V_120 ,
T_6 V_12 )
{
...
div = V_2 -> V_53 / ( V_121 * V_2 -> V_66 * 1024 ) ;
if ( div < 1 || div > 1023 ) {
V_18 = - V_16 ;
goto V_29;
}
...
static T_5 F_65 ( struct V_117 * V_40 ,
...
int V_38 , V_12 = 0 ;
for ( V_38 = 0 ; V_38 < F_19 ( V_2 -> V_73 ) ; V_38 ++ )
V_12 += sprintf ( V_120 + V_12 , L_7 , V_2 -> V_73 [ V_38 ] [ 0 ] ,
V_2 -> V_73 [ V_38 ] [ 1 ] ) ;
V_12 += sprintf ( V_120 + V_12 , L_8 ) ;
return V_12 ;
}
static T_5 F_66 ( struct V_117 * V_40 ,
struct V_118 * V_119 ,
char * V_120 )
{
struct V_41 * V_42 = F_59 ( V_40 ) ;
struct V_1 * V_2 = F_31 ( V_42 ) ;
return sprintf ( V_120 , L_6 , ! ! ( V_2 -> V_23 & V_124 ) ) ;
}
static T_5 F_67 ( struct V_117 * V_40 ,
struct V_118 * V_119 ,
char * V_120 )
{
struct V_41 * V_42 = F_59 ( V_40 ) ;
struct V_1 * V_2 = F_31 ( V_42 ) ;
return sprintf ( V_120 , L_6 , ! ! ( V_2 -> V_125 & V_126 ) ) ;
}
static T_5 F_68 ( struct V_117 * V_40 ,
struct V_118 * V_119 ,
const char * V_120 ,
T_6 V_12 )
{
...
switch ( ( V_129 ) V_128 -> V_83 ) {
case V_130 :
if ( V_7 )
V_2 -> V_125 |= V_126 ;
else
V_2 -> V_125 &= ~ V_126 ;
F_7 ( V_2 , V_130 , 1 , V_2 -> V_125 ) ;
break;
case V_28 :
if ( V_7 )
V_2 -> V_23 |= V_124 ;
...
V_18 = F_10 ( V_2 , V_132 -> V_83 ,
V_132 -> V_77 . V_78 / 8 , & V_134 ) ;
F_64 ( & V_42 -> V_122 ) ;
if ( V_18 < 0 )
return V_18 ;
* V_7 = ( V_134 >> V_132 -> V_77 . V_137 ) &
( ( 1 << ( V_132 -> V_77 . V_78 ) ) - 1 ) ;
switch ( V_132 -> type ) {
case V_138 :
if ( ! V_135 )
* V_7 -= ( 1 << ( V_132 -> V_77 . V_78 - 1 ) ) ;
break;
case V_139 :
* V_7 -= 0x800000 ;
* V_7 /= 2815 ;
...
* V_133 = V_2 -> V_73 [ F_28 ( V_2 -> V_22 ) ] [ 1 ] ;
F_64 ( & V_42 -> V_122 ) ;
return V_142 ;
case V_139 :
* V_7 = 1000 ;
...
static int T_7 F_75 ( struct V_146 * V_17 )
{
struct V_43 * V_44 = V_17 -> V_40 . V_147 ;
struct V_1 * V_2 ;
struct V_41 * V_42 ;
int V_18 , V_38 , V_148 = 0 ;
if ( ! V_44 ) {
F_20 ( & V_17 -> V_40 , L_9 ) ;
return - V_149 ;
}
...
F_81 ( V_17 , V_42 ) ;
V_2 -> V_17 = V_17 ;
V_2 -> V_34 = F_51 ( V_17 ) -> V_152 ;
V_42 -> V_40 . V_114 = & V_17 -> V_40 ;
V_42 -> V_109 = F_51 ( V_17 ) -> V_109 ;
V_42 -> V_106 = V_153 ;
V_42 -> V_76 = V_154 ;
V_42 -> V_155 = F_19 ( V_154 ) ;
V_42 -> V_156 = V_2 -> V_156 ;
if ( V_2 -> V_34 == V_35 )
V_42 -> V_157 = & V_158 ;
else
V_42 -> V_157 = & V_159 ;
for ( V_38 = 0 ; V_38 < V_42 -> V_155 ; V_38 ++ )
V_2 -> V_156 [ V_38 ] = ( 1 << V_38 ) | ( 1 <<
V_42 -> V_76 [ V_42 -> V_155 - 1 ] .
V_160 ) ;
F_82 ( & V_2 -> V_32 ) ;
V_18 = F_39 ( V_42 ) ;
if ( V_18 )
...
static int F_89 ( struct V_146 * V_17 )
{
