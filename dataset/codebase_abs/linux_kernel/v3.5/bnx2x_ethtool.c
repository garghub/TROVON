...
static const struct V_124 * F_35 ( struct V_1 * V_2 )
{
if ( F_24 ( V_2 ) )
return V_135 ;
else if ( F_31 ( V_2 ) )
...
static void F_39 ( struct V_1 * V_2 , T_1 * V_151 )
{
...
static void F_42 ( struct V_1 * V_2 , T_1 * V_151 )
{
T_1 V_144 , V_145 ;
for ( V_144 = 0 ; V_144 < V_147 ; V_144 ++ )
if ( F_19 ( V_2 , & V_148 [ V_144 ] ) )
...
static void F_104 ( struct V_1 * V_2 , T_2 V_34 , T_2 V_375 )
{
int V_376 = 1400 ;
if ( V_34 ) {
while ( F_105 ( V_2 , V_375 ) && V_376 -- )
F_91 ( 20 ) ;
if ( V_376 <= 0 && F_105 ( V_2 , V_375 ) )
F_10 ( V_79 , L_52 ) ;
}
}
static int F_106 ( struct V_1 * V_2 , int V_377 )
{
...
int V_224 = - V_290 ;
T_2 * V_410 ;
struct V_411 * V_412 = F_107 ( V_2 -> V_22 , V_388 -> V_413 ) ;
switch ( V_377 ) {
case V_414 :
...
V_381 = F_108 ( V_2 -> V_22 , V_384 -> V_425 ) ;
if ( ! V_381 ) {
F_10 ( V_79 , L_53 ) ;
V_224 = - V_426 ;
goto V_427;
}
V_382 = F_109 ( V_381 , V_378 ) ;
...
V_403 = F_110 ( & V_2 -> V_189 -> V_22 , V_381 -> V_410 ,
F_111 ( V_381 ) , V_430 ) ;
if ( F_112 ( F_113 ( & V_2 -> V_189 -> V_22 , V_403 ) ) ) {
V_224 = - V_426 ;
F_114 ( V_381 ) ;
F_10 ( V_79 , L_54 ) ;
goto V_427;
...
V_379 = 0 ;
V_389 = F_115 ( * V_388 -> V_431 ) ;
V_391 = F_115 ( * V_384 -> V_432 ) ;
F_116 ( V_412 , V_381 -> V_163 ) ;
V_393 = V_388 -> V_433 ++ ;
V_396 = & V_388 -> V_434 [ F_117 ( V_393 ) ] ;
V_396 -> V_435 = V_388 -> V_436 ;
V_396 -> V_381 = V_381 ;
V_396 -> V_35 = 0 ;
V_394 = F_117 ( V_388 -> V_436 ) ;
V_398 = & V_388 -> V_437 [ V_394 ] . V_438 ;
V_398 -> V_439 = F_118 ( F_119 ( V_403 ) ) ;
V_398 -> V_440 = F_118 ( F_120 ( V_403 ) ) ;
V_398 -> V_441 = F_121 ( 2 ) ;
V_398 -> V_442 = F_121 ( F_111 ( V_381 ) ) ;
V_398 -> V_443 = F_121 ( V_393 ) ;
...
F_125 () ;
F_126 ( V_2 , V_388 -> V_455 , V_388 -> V_453 . V_456 ) ;
F_127 () ;
F_125 () ;
V_379 ++ ;
V_388 -> V_436 += 2 ;
F_66 ( 100 ) ;
V_390 = F_115 ( * V_388 -> V_431 ) ;
...
V_392 = F_115 ( * V_384 -> V_432 ) ;
if ( V_392 != V_391 + V_379 )
goto V_427;
V_405 = & V_384 -> V_459 [ F_131 ( V_384 -> V_460 ) ] ;
V_406 = V_405 -> V_461 . V_462 ;
V_407 = V_406 & V_463 ;
if ( ! F_132 ( V_407 ) || ( V_406 & V_464 ) )
goto V_465;
V_163 = F_115 ( V_405 -> V_461 . V_466 ) ;
if ( V_163 != V_378 )
goto V_465;
V_409 = & V_384 -> V_467 [ F_133 ( V_384 -> V_468 ) ] ;
F_134 ( & V_2 -> V_189 -> V_22 ,
F_135 ( V_409 , V_403 ) ,
V_384 -> V_425 , V_469 ) ;
...
V_224 = 0 ;
V_465:
V_384 -> V_468 = F_136 ( V_384 -> V_468 ) ;
V_384 -> V_472 = F_136 ( V_384 -> V_472 ) ;
V_384 -> V_460 = F_137 ( V_384 -> V_460 ) ;
V_384 -> V_473 = F_137 ( V_384 -> V_473 ) ;
F_138 ( V_2 , V_384 , V_384 -> V_472 , V_384 -> V_473 ,
V_384 -> V_474 ) ;
V_427:
V_2 -> V_5 . V_377 = V_475 ;
return V_224 ;
...
F_140 ( V_2 , 1 ) ;
F_82 ( V_2 ) ;
V_476 = F_106 ( V_2 , V_414 ) ;
if ( V_476 ) {
F_10 ( V_79 , L_55 , V_476 ) ;
V_224 |= V_478 ;
}
V_476 = F_106 ( V_2 , V_416 ) ;
if ( V_476 ) {
...
V_482 = F_144 ( V_480 [ V_144 ] . V_149 , V_410 ) ;
if ( V_482 != V_485 ) {
F_10 ( V_79 | V_215 ,
L_61 , V_144 , V_482 ) ;
V_224 = - V_290 ;
...
V_487 . V_24 = V_489 ;
F_147 ( V_490 , & V_487 . V_491 ) ;
return F_148 ( V_2 , & V_487 ) ;
}
...
static int F_157 ( struct V_21 * V_22 , int V_501 )
{
struct V_1 * V_2 = F_4 ( V_22 ) ;
int V_144 , V_502 ;
switch ( V_501 ) {
...
static void F_161 ( struct V_21 * V_22 , T_1 V_501 , T_2 * V_481 )
{
struct V_1 * V_2 = F_4 ( V_22 ) ;
int V_144 , V_145 , V_146 ;
char V_506 [ V_507 + 1 ] ;
...
V_481 [ V_146 + V_145 ] = F_165 ( * V_221 , * ( V_221 + 1 ) ) ;
}
V_146 += V_504 ;
}
}
...
static int F_166 ( struct V_21 * V_22 ,
enum V_517 V_31 )
{
struct V_1 * V_2 = F_4 ( V_22 ) ;
if ( ! F_16 ( V_22 ) ) {
...
static int F_168 ( struct V_21 * V_22 , struct V_526 * V_126 ,
T_1 * T_6 V_527 )
{
struct V_1 * V_2 = F_4 ( V_22 ) ;
switch ( V_126 -> V_24 ) {
case V_528 :
V_126 -> V_410 = F_156 ( V_2 ) ;
return 0 ;
default:
F_10 ( V_79 , L_39 ) ;
return - V_518 ;
...
static T_1 F_169 ( struct V_21 * V_22 )
{
return V_529 ;
}
static int F_170 ( struct V_21 * V_22 , T_1 * V_530 )
{
struct V_1 * V_2 = F_4 ( V_22 ) ;
T_2 V_531 [ V_529 ] = { 0 } ;
T_7 V_144 ;
F_171 ( & V_2 -> V_532 , V_531 ) ;
for ( V_144 = 0 ; V_144 < V_529 ; V_144 ++ )
V_530 [ V_144 ] = V_531 [ V_144 ] - V_2 -> V_385 -> V_533 ;
return 0 ;
}
static int F_172 ( struct V_21 * V_22 , const T_1 * V_530 )
{
struct V_1 * V_2 = F_4 ( V_22 ) ;
T_7 V_144 ;
T_2 V_531 [ V_529 ] = { 0 } ;
for ( V_144 = 0 ; V_144 < V_529 ; V_144 ++ ) {
V_531 [ V_144 ] = V_530 [ V_144 ] + V_2 -> V_385 -> V_533 ;
}
return F_173 ( V_2 , V_531 , false ) ;
}
void F_174 ( struct V_21 * V_534 )
{
F_175 ( V_534 , & V_535 ) ;
}
