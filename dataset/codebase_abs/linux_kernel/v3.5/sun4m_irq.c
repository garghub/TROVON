...
static void F_27 ( int V_5 , unsigned int V_43 )
{
unsigned int V_44 = V_43 ? F_28 ( V_43 ) : 0 ;
F_4 ( V_44 , & V_41 [ V_5 ] -> V_42 ) ;
}
static void T_1 F_29 ( void )
{
struct V_45 * V_46 = F_30 ( NULL , L_12 ) ;
...
V_62 = & V_27 -> V_63 ;
V_15 = F_11 ( NULL , V_64 ) ;
V_48 = F_34 ( V_15 , V_65 , V_66 , L_16 , NULL ) ;
if ( V_48 ) {
F_23 ( V_34 L_17 ,
V_48 ) ;
return;
...
void T_1 F_35 ( void )
{
struct V_45 * V_46 = F_30 ( NULL , L_18 ) ;
...
F_36 () ;
F_4 ( ~ V_81 , & V_11 -> V_12 ) ;
for ( V_47 = 0 ; ! F_37 ( V_47 , NULL , & V_79 ) ; V_47 ++ )
F_4 ( ~ 0x17fff , & V_9 [ V_79 ] -> V_13 ) ;
if ( V_80 == 4 )
F_4 ( 0 , & V_11 -> V_82 ) ;
V_54 . V_83 = F_29 ;
V_54 . V_84 = F_11 ;
