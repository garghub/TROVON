...
V_5 -> V_37 = & V_43 -> V_37 ;
V_5 -> V_8 = V_8 ;
strncpy ( V_5 -> V_41 , V_43 -> V_49 -> V_41 , V_50 ) ;
switch ( V_43 -> V_49 -> V_51 ) {
case V_52 :
V_5 -> V_27 = V_53 ;
V_5 -> V_28 = F_15 ( V_53 ) ;
break;
...
F_16 ( V_43 , V_5 ) ;
V_45 = F_17 ( & V_5 -> V_37 -> V_56 , & V_57 ) ;
if ( V_45 ) {
F_12 ( V_5 -> V_37 , L_9 ) ;
return V_45 ;
}
V_5 -> V_58 = F_18 ( V_5 -> V_37 ) ;
if ( F_19 ( V_5 -> V_58 ) ) {
F_12 ( V_5 -> V_37 , L_10 ) ;
V_45 = F_20 ( V_5 -> V_58 ) ;
goto V_59;
...
F_21 ( & V_43 -> V_37 , L_11 ,
V_43 -> V_41 , V_43 -> V_60 , V_43 -> V_49 -> V_41 ,
V_43 -> V_49 -> V_51 ) ;
return 0 ;
V_59:
F_22 ( & V_5 -> V_37 -> V_56 , & V_57 ) ;
return V_45 ;
}
static int T_4 F_23 ( struct V_42 * V_43 )
{
struct V_4 * V_5 = F_24 ( V_43 ) ;
F_25 ( V_5 -> V_58 ) ;
F_22 ( & V_5 -> V_37 -> V_56 , & V_57 ) ;
F_16 ( V_43 , NULL ) ;
return 0 ;
