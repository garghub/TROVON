...
V_143 = V_174 - V_172 ;
if ( V_143 > 0 ) {
V_172 += F_110 (unsigned int, goal >> 1 , rt_hash_mask + 1 ) ;
V_143 = V_174 - V_172 ;
}
} else {
...
V_48 = F_113 ( V_4 , * ( V_30 T_1 * ) V_183 ) ;
if ( V_48 )
return V_48 ;
return F_114 ( & V_187 , V_183 , V_4 ) ;
}
...
static struct V_7 * F_119 ( unsigned int V_188 , struct V_7 * V_8 ,
...
F_121 ( & V_111 -> V_2 , V_173 ) ;
F_87 ( F_83 ( V_188 ) ) ;
F_65 ( V_8 ) ;
if ( V_190 )
F_122 ( V_190 , & V_111 -> V_2 ) ;
return V_111 ;
}
if ( ! F_15 ( & V_111 -> V_2 . V_56 ) ) {
...
static void F_135 ( unsigned int V_188 , struct V_7 * V_8 )
{
struct V_7 T_7 * * V_144 ;
struct V_7 * V_140 ;
V_144 = & V_41 [ V_188 ] . V_42 ;
...
struct V_7 * V_8 = (struct V_7 * ) V_2 ;
T_3 V_217 = V_8 -> V_54 ;
struct V_47 * V_48 , * V_218 ;
F_137 ( & V_8 -> V_2 ) ;
V_8 -> V_54 = V_10 -> V_219 . V_220 ;
V_48 = F_112 ( & V_8 -> V_2 , & V_8 -> V_54 ) ;
if ( F_116 ( V_48 ) ) {
V_8 -> V_54 = V_217 ;
return;
}
V_218 = F_138 ( & V_8 -> V_2 . V_221 , V_48 ) ;
if ( V_218 )
F_139 ( V_218 ) ;
if ( ! ( V_48 -> V_51 & V_222 ) ) {
F_140 ( V_48 , NULL ) ;
...
void F_142 ( T_3 V_224 , T_3 V_26 , T_3 V_225 ,
T_3 V_27 , struct V_3 * V_4 )
{
int V_226 , V_21 ;
struct V_227 * V_228 = F_143 ( V_4 ) ;
T_3 V_229 [ 2 ] = { V_27 , 0 } ;
int V_230 [ 2 ] = { V_4 -> V_191 , 0 } ;
struct V_9 * V_10 ;
struct V_32 * V_32 ;
if ( ! V_228 )
return;
V_32 = F_20 ( V_4 ) ;
if ( V_225 == V_224 || ! F_144 ( V_228 ) ||
F_145 ( V_225 ) || F_146 ( V_225 ) ||
F_147 ( V_225 ) )
goto V_231;
if ( ! F_148 ( V_228 ) ) {
if ( ! F_149 ( V_228 , V_225 , V_224 ) )
goto V_231;
if ( F_150 ( V_228 ) && F_151 ( V_225 , V_4 ) )
goto V_231;
} else {
if ( F_152 ( V_32 , V_225 ) != V_200 )
goto V_231;
}
for ( V_226 = 0 ; V_226 < 2 ; V_226 ++ ) {
for ( V_21 = 0 ; V_21 < 2 ; V_21 ++ ) {
unsigned int V_188 ;
struct V_7 T_7 * * V_144 ;
struct V_7 * V_8 ;
V_188 = F_12 ( V_26 , V_229 [ V_226 ] , V_230 [ V_21 ] , F_14 ( V_32 ) ) ;
V_144 = & V_41 [ V_188 ] . V_42 ;
while ( ( V_8 = F_153 ( * V_144 ) ) != NULL ) {
V_144 = & V_8 -> V_2 . V_43 ;
if ( V_8 -> V_130 != V_26 ||
V_8 -> V_131 != V_229 [ V_226 ] ||
V_8 -> V_134 != V_230 [ V_21 ] ||
F_68 ( V_8 ) ||
F_78 ( V_8 ) ||
...
V_10 = V_8 -> V_10 ;
if ( V_10 ) {
if ( V_10 -> V_219 . V_220 != V_225 ) {
V_10 -> V_219 . V_220 = V_225 ;
F_154 ( & V_207 ) ;
}
F_136 ( & V_8 -> V_2 , V_10 ) ;
}
...
{
unsigned long V_232 = F_159 ( V_10 -> V_116 ) ;
return V_232 &&
F_160 ( V_122 , V_232 ) &&
F_6 ( & V_10 -> V_116 , V_232 , 0 ) == V_232 ;
}
...
unsigned int V_188 = F_12 ( V_8 -> V_130 , V_8 -> V_131 ,
V_8 -> V_134 ,
F_14 ( F_20 ( V_2 -> V_4 ) ) ) ;
F_135 ( V_188 , V_8 ) ;
V_120 = NULL ;
} else if ( V_8 -> V_10 && F_158 ( V_8 -> V_10 ) ) {
F_163 ( V_2 , V_234 , V_8 -> V_10 -> V_235 ) ;
}
}
return V_120 ;
}
...
int V_236 ;
F_31 () ;
V_228 = F_143 ( V_8 -> V_2 . V_4 ) ;
if ( ! V_228 || ! F_166 ( V_228 ) ) {
F_33 () ;
return;
}
V_236 = F_156 ( V_228 ) ;
...
V_10 = V_8 -> V_10 ;
if ( ! V_10 ) {
F_167 ( V_190 , V_237 , V_238 , V_8 -> V_54 ) ;
return;
}
if ( F_168 ( V_122 , V_10 -> V_239 + V_240 ) )
V_10 -> V_241 = 0 ;
if ( V_10 -> V_241 >= V_242 ) {
V_10 -> V_239 = V_122 ;
return;
...
if ( V_245 )
F_167 ( V_190 , V_257 , V_246 , 0 ) ;
V_121: F_172 ( V_190 ) ;
return 0 ;
}
static inline unsigned short F_173 ( unsigned short V_258 )
{
int V_21 ;
for ( V_21 = 0 ; V_21 < F_174 ( V_259 ) ; V_21 ++ )
if ( V_258 > V_259 [ V_21 ] )
return V_259 [ V_21 ] ;
return 68 ;
}
...
struct V_3 * V_4 )
{
unsigned short V_258 = F_176 ( V_210 -> V_261 ) ;
unsigned short V_262 = 0 ;
struct V_9 * V_10 ;
V_10 = F_125 ( V_210 -> V_26 , 1 ) ;
if ( V_10 ) {
unsigned short V_263 = V_260 ;
if ( V_260 < 68 || V_260 >= V_258 ) {
if ( V_263 == 0 &&
V_258 >= 68 + ( V_210 -> V_264 << 2 ) )
V_258 -= V_210 -> V_264 << 2 ;
V_263 = F_173 ( V_258 ) ;
}
if ( V_263 < V_265 )
V_263 = V_265 ;
if ( ! V_10 -> V_116 || V_263 < V_10 -> V_266 ) {
unsigned long V_116 ;
V_116 = V_122 + V_267 ;
if ( ! V_116 )
V_116 = 1UL ;
...
if ( V_10 -> V_266 < V_268 ) {
if ( ! V_10 -> V_235 )
V_10 -> V_235 = F_180 ( V_2 , V_234 ) ;
F_163 ( V_2 , V_234 , V_10 -> V_266 ) ;
}
} else if ( F_6 ( & V_10 -> V_116 , V_155 , 0 ) == V_155 )
F_163 ( V_2 , V_234 , V_10 -> V_235 ) ;
}
static void F_181 ( struct V_1 * V_2 , T_1 V_263 )
{
struct V_7 * V_8 = (struct V_7 * ) V_2 ;
struct V_9 * V_10 ;
F_137 ( V_2 ) ;
...
F_177 ( & V_8 -> V_2 , V_10 ) ;
if ( V_10 -> V_219 . V_220 &&
V_10 -> V_219 . V_220 != V_8 -> V_54 )
F_136 ( & V_8 -> V_2 , V_10 ) ;
}
V_8 -> F_124 = F_124 () ;
}
}
static struct V_1 * F_183 ( struct V_1 * V_2 , T_1 V_269 )
{
struct V_7 * V_8 = (struct V_7 * ) V_2 ;
if ( F_78 ( V_8 ) )
return NULL ;
...
{
struct V_7 * V_8 ;
F_167 ( V_190 , V_257 , V_249 , 0 ) ;
V_8 = F_165 ( V_190 ) ;
if ( V_8 && V_8 -> V_10 && F_161 ( V_8 -> V_10 ) )
F_163 ( & V_8 -> V_2 , V_234 , V_8 -> V_10 -> V_235 ) ;
}
static int F_186 ( struct V_189 * V_190 )
{
F_133 ( L_25 ,
V_270 , & F_169 ( V_190 ) -> V_27 , & F_169 ( V_190 ) -> V_26 ,
...
unsigned int V_263 = F_180 ( V_2 , V_234 ) ;
if ( V_263 && F_72 ( V_8 ) )
return V_263 ;
V_263 = V_2 -> V_4 -> V_263 ;
if ( F_196 ( F_197 ( V_2 , V_234 ) ) ) {
if ( V_8 -> V_54 != V_8 -> V_12 && V_263 > 576 )
V_263 = 576 ;
}
if ( V_263 > V_287 )
V_263 = V_287 ;
...
#ifdef F_212
if ( ! F_209 ( V_26 ) && F_213 ( V_228 ) )
V_111 -> V_2 . V_314 = V_316 ;
#endif
F_109 ( V_73 ) ;
V_188 = F_12 ( V_26 , V_27 , V_4 -> V_191 , F_14 ( F_20 ( V_4 ) ) ) ;
V_111 = F_119 ( V_188 , V_111 , V_190 , V_4 -> V_191 ) ;
return F_116 ( V_111 ) ? F_117 ( V_111 ) : 0 ;
V_311:
return - V_204 ;
V_307:
return - V_247 ;
...
F_109 ( V_77 ) ;
#ifdef F_155
if ( F_156 ( V_228 ) && F_215 () ) {
F_123 ( L_27 ,
& V_26 , & V_27 , V_4 -> V_53 ) ;
if ( V_4 -> V_317 && F_216 ( V_190 ) ) {
F_217 ( V_318 , L_28 ,
V_319 , 16 , 1 ,
F_218 ( V_190 ) ,
V_4 -> V_317 , true ) ;
...
static int F_219 ( struct V_189 * V_190 ,
const struct V_272 * V_273 ,
struct V_227 * V_228 ,
...
T_3 V_304 ;
T_1 V_294 ;
V_321 = F_143 ( F_220 ( * V_273 ) ) ;
if ( V_321 == NULL ) {
F_221 ( L_29 ) ;
return - V_247 ;
}
V_201 = F_210 ( V_190 , V_27 , V_26 , V_277 , F_222 ( * V_273 ) ,
V_228 -> V_4 , & V_304 , & V_294 ) ;
if ( V_201 < 0 ) {
F_214 ( V_228 -> V_4 , V_228 , V_190 , V_26 ,
V_27 ) ;
goto V_322;
}
if ( V_201 )
V_184 |= V_323 ;
if ( V_321 == V_228 && V_201 &&
( F_148 ( V_321 ) ||
...
V_111 -> V_12 = V_26 ;
V_111 -> V_58 = V_27 ;
V_111 -> V_132 = V_228 -> V_4 -> V_191 ;
V_111 -> V_244 = V_228 -> V_4 -> V_191 ;
V_111 -> V_134 = 0 ;
V_111 -> V_133 = V_190 -> V_281 ;
V_111 -> V_54 = V_26 ;
V_111 -> V_63 = V_304 ;
...
static int F_224 ( struct V_189 * V_190 ,
struct V_272 * V_273 ,
...
F_226 ( V_273 ) ;
#endif
V_201 = F_219 ( V_190 , V_273 , V_228 , V_26 , V_27 , V_277 , & V_111 ) ;
if ( V_201 )
return V_201 ;
V_188 = F_12 ( V_26 , V_27 , V_275 -> V_279 ,
F_14 ( F_20 ( V_111 -> V_2 . V_4 ) ) ) ;
V_111 = F_119 ( V_188 , V_111 , V_190 , V_275 -> V_279 ) ;
if ( F_116 ( V_111 ) )
return F_117 ( V_111 ) ;
return 0 ;
}
static int F_227 ( struct V_189 * V_190 , T_3 V_26 , T_3 V_27 ,
...
if ( V_273 . type != V_200 )
goto V_331;
V_201 = F_224 ( V_190 , & V_273 , & V_275 , V_228 , V_26 , V_27 , V_277 ) ;
V_121: return V_201 ;
V_330:
if ( V_190 -> V_305 != F_130 ( V_306 ) )
goto V_307;
...
V_201 = - V_247 ;
V_337:
F_214 ( V_4 , V_228 , V_190 , V_26 , V_27 ) ;
goto V_121;
}
int F_229 ( struct V_189 * V_190 , T_3 V_26 , T_3 V_27 ,
...
F_182 ( V_111 ) ;
if ( V_341 ) {
F_230 ( & V_111 -> V_2 , V_122 ) ;
F_231 ( V_190 , & V_111 -> V_2 ) ;
} else {
F_121 ( & V_111 -> V_2 , V_122 ) ;
F_122 ( V_190 , & V_111 -> V_2 ) ;
}
F_109 ( V_71 ) ;
F_33 () ;
...
struct V_227 * V_228 = F_143 ( V_4 ) ;
if ( V_228 ) {
int V_303 = F_232 ( V_228 , V_26 , V_27 ,
F_169 ( V_190 ) -> V_305 ) ;
if ( V_303
#ifdef F_212
||
...
V_273 = F_227 ( V_190 , V_26 , V_27 , V_277 , V_4 ) ;
F_33 () ;
return V_273 ;
}
static struct V_7 * F_233 ( const struct V_272 * V_273 ,
const struct V_274 * V_275 ,
T_3 V_345 , T_3 V_346 ,
...
V_184 |= V_113 | V_125 ;
if ( ! F_232 ( V_228 , V_275 -> V_26 , V_275 -> V_27 ,
V_275 -> V_350 ) )
V_184 &= ~ V_125 ;
...
static struct V_7 * F_234 ( struct V_32 * V_32 , struct V_274 * V_275 )
{
struct V_3 * V_349 = NULL ;
T_11 V_277 = F_235 ( V_275 ) ;
unsigned int V_184 = 0 ;
struct V_272 V_273 ;
struct V_7 * V_111 ;
T_3 V_345 ;
...
( F_145 ( V_275 -> V_26 ) ||
F_146 ( V_275 -> V_26 ) ) ) {
V_349 = F_236 ( V_32 , V_275 -> V_27 , false ) ;
if ( V_349 == NULL )
goto V_121;
...
if ( ! F_236 ( V_32 , V_275 -> V_27 , false ) )
goto V_121;
}
}
if ( V_275 -> V_278 ) {
V_349 = F_237 ( V_32 , V_275 -> V_278 ) ;
V_111 = F_120 ( - V_356 ) ;
if ( V_349 == NULL )
goto V_121;
...
if ( ! V_275 -> V_26 )
V_275 -> V_26 = V_275 -> V_27 = F_238 ( V_359 ) ;
V_349 = V_32 -> V_309 ;
...
V_275 -> V_278 = V_349 -> V_191 ;
V_354:
V_111 = F_233 ( & V_273 , V_275 , V_345 , V_346 , V_347 ,
V_277 , V_349 , V_184 ) ;
if ( ! F_116 ( V_111 ) ) {
unsigned int V_188 ;
V_188 = F_12 ( V_345 , V_346 , V_347 ,
F_14 ( F_20 ( V_349 ) ) ) ;
V_111 = F_119 ( V_188 , V_111 , NULL , V_347 ) ;
}
V_121:
F_33 () ;
return V_111 ;
}
struct V_7 * F_240 ( struct V_32 * V_32 , struct V_274 * V_363 )
{
struct V_7 * V_111 ;
unsigned int V_188 ;
if ( ! F_73 ( V_32 ) )
...
F_22 () ;
V_364:
return F_234 ( V_32 , V_363 ) ;
}
static struct V_1 * F_241 ( struct V_1 * V_2 , T_1 V_269 )
{
return NULL ;
}
...
{
unsigned int V_263 = F_180 ( V_2 , V_234 ) ;
return V_263 ? : V_2 -> V_4 -> V_263 ;
}
static void F_243 ( struct V_1 * V_2 , T_1 V_263 )
{
}
static T_1 * F_244 ( struct V_1 * V_2 ,
unsigned long V_6 )
{
return NULL ;
}
struct V_1 * F_245 ( struct V_32 * V_32 , struct V_1 * V_365 )
{
...
F_249 ( V_365 ) ;
return V_8 ? & V_8 -> V_2 : F_120 ( - V_92 ) ;
}
struct V_7 * F_250 ( struct V_32 * V_32 , struct V_274 * V_363 ,
struct V_370 * V_371 )
{
struct V_7 * V_8 = F_240 ( V_32 , V_363 ) ;
if ( F_116 ( V_8 ) )
return V_8 ;
if ( V_363 -> V_350 )
V_8 = (struct V_7 * ) F_251 ( V_32 , & V_8 -> V_2 ,
F_252 ( V_363 ) ,
V_371 , 0 ) ;
return V_8 ;
}
static int F_253 ( struct V_32 * V_32 ,
...
V_377 = F_254 ( V_190 , V_372 , V_35 , V_373 , sizeof( * V_39 ) , V_184 ) ;
if ( V_377 == NULL )
return - V_380 ;
V_39 = F_255 ( V_377 ) ;
V_39 -> V_381 = V_165 ;
...
V_39 -> V_384 = V_8 -> V_62 ;
V_39 -> V_385 = V_386 ;
if ( F_256 ( V_190 , V_387 , V_386 ) )
goto V_388;
V_39 -> V_389 = V_8 -> V_199 ;
V_39 -> V_390 = V_282 ;
V_39 -> V_391 = V_392 ;
V_39 -> V_393 = ( V_8 -> V_55 & ~ 0xFFFF ) | V_394 ;
if ( V_8 -> V_55 & V_115 )
V_39 -> V_393 |= V_395 ;
if ( F_257 ( V_190 , V_396 , V_8 -> V_12 ) )
goto V_388;
if ( V_8 -> V_131 ) {
V_39 -> V_383 = 32 ;
if ( F_257 ( V_190 , V_397 , V_8 -> V_131 ) )
goto V_388;
}
if ( V_8 -> V_2 . V_4 &&
F_256 ( V_190 , V_398 , V_8 -> V_2 . V_4 -> V_191 ) )
goto V_388;
#ifdef F_58
if ( V_8 -> V_2 . V_284 &&
F_256 ( V_190 , V_399 , V_8 -> V_2 . V_284 ) )
goto V_388;
#endif
if ( F_68 ( V_8 ) ) {
if ( F_257 ( V_190 , V_400 , V_8 -> V_63 ) )
goto V_388;
} else if ( V_8 -> V_58 != V_8 -> V_131 ) {
if ( F_257 ( V_190 , V_400 , V_8 -> V_58 ) )
goto V_388;
}
if ( V_8 -> V_12 != V_8 -> V_54 &&
F_257 ( V_190 , V_401 , V_8 -> V_54 ) )
goto V_388;
if ( F_258 ( V_190 , F_259 ( & V_8 -> V_2 ) ) < 0 )
goto V_388;
if ( V_8 -> V_133 &&
F_257 ( V_190 , V_402 , V_8 -> V_133 ) )
goto V_388;
error = V_8 -> V_2 . error ;
if ( V_10 ) {
F_260 ( V_8 -> V_10 ) ;
...
#endif
if ( F_256 ( V_190 , V_407 , V_8 -> V_244 ) )
goto V_388;
}
if ( F_264 ( V_190 , & V_8 -> V_2 , V_214 , V_378 , V_379 ,
V_155 , error ) < 0 )
goto V_388;
return F_265 ( V_190 , V_377 ) ;
V_388:
F_266 ( V_190 , V_377 ) ;
return - V_380 ;
}
static int F_267 ( struct V_189 * V_408 , struct V_376 * V_377 , void * V_409 )
{
struct V_32 * V_32 = F_268 ( V_408 -> V_371 ) ;
struct V_375 * V_410 ;
...
int V_281 ;
struct V_189 * V_190 ;
V_201 = F_269 ( V_377 , sizeof( * V_410 ) , V_412 , V_413 , V_414 ) ;
if ( V_201 < 0 )
goto V_415;
V_410 = F_255 ( V_377 ) ;
V_190 = F_270 ( V_416 , V_25 ) ;
if ( V_190 == NULL ) {
V_201 = - V_204 ;
goto V_415;
}
...
F_273 ( V_190 , V_418 + sizeof( struct V_209 ) ) ;
V_90 = V_412 [ V_397 ] ? F_274 ( V_412 [ V_397 ] ) : 0 ;
V_2 = V_412 [ V_396 ] ? F_274 ( V_412 [ V_396 ] ) : 0 ;
V_342 = V_412 [ V_407 ] ? F_275 ( V_412 [ V_407 ] ) : 0 ;
V_281 = V_412 [ V_402 ] ? F_275 ( V_412 [ V_402 ] ) : 0 ;
if ( V_342 ) {
struct V_3 * V_4 ;
V_4 = F_276 ( V_32 , V_342 ) ;
if ( V_4 == NULL ) {
V_201 = - V_356 ;
goto V_419;
}
...
V_190 -> V_281 = V_281 ;
F_277 () ;
V_201 = F_278 ( V_190 , V_2 , V_90 , V_410 -> V_384 , V_4 ) ;
F_279 () ;
V_8 = F_165 ( V_190 ) ;
...
. V_27 = V_90 ,
. V_276 = V_410 -> V_384 ,
. V_278 = V_412 [ V_398 ] ? F_275 ( V_412 [ V_398 ] ) : 0 ,
. V_280 = V_281 ,
} ;
V_8 = F_280 ( V_32 , & V_275 ) ;
V_201 = 0 ;
if ( F_116 ( V_8 ) )
V_201 = F_117 ( V_8 ) ;
}
...
goto V_419;
F_122 ( V_190 , & V_8 -> V_2 ) ;
if ( V_410 -> V_393 & V_395 )
V_8 -> V_55 |= V_115 ;
V_201 = F_253 ( V_32 , V_190 , F_281 ( V_408 ) . V_372 , V_377 -> V_420 ,
V_421 , 0 , 0 ) ;
if ( V_201 <= 0 )
goto V_419;
V_201 = F_282 ( V_190 , V_32 , F_281 ( V_408 ) . V_372 ) ;
V_415:
return V_201 ;
V_419:
F_172 ( V_190 ) ;
...
int F_283 ( struct V_189 * V_190 , struct V_422 * V_423 )
{
struct V_7 * V_8 ;
int V_424 , V_425 ;
int V_28 , V_426 ;
struct V_32 * V_32 ;
V_32 = F_268 ( V_190 -> V_371 ) ;
V_425 = V_423 -> args [ 0 ] ;
if ( V_425 < 0 )
V_425 = 0 ;
...
continue;
F_231 ( V_190 , & V_8 -> V_2 ) ;
if ( F_253 ( V_32 , V_190 , F_281 ( V_423 -> V_190 ) . V_372 ,
...
void F_285 ( struct V_227 * V_228 )
{
F_102 ( F_20 ( V_228 -> V_4 ) , 0 ) ;
}
static int F_286 ( T_12 * V_429 , int V_430 ,
void T_13 * V_431 ,
...
V_435 . V_436 = & V_434 ;
F_287 ( & V_435 , V_430 , V_431 , V_432 , V_433 ) ;
...
static T_5 int F_288 ( struct V_32 * V_32 )
{
struct T_12 * V_438 ;
V_438 = V_439 ;
if ( ! F_77 ( V_32 , & V_440 ) ) {
V_438 = F_289 ( V_438 , sizeof( V_439 ) , V_25 ) ;
if ( V_438 == NULL )
goto V_441;
}
V_438 [ 0 ] . V_437 = V_32 ;
V_32 -> V_33 . V_442 = F_290 ( V_32 , L_31 , V_438 ) ;
...
static T_6 void F_291 ( struct V_32 * V_32 )
{
struct T_12 * V_438 ;
V_438 = V_32 -> V_33 . V_442 -> V_444 ;
F_292 ( V_32 -> V_33 . V_442 ) ;
F_293 ( V_438 == V_439 ) ;
F_52 ( V_438 ) ;
}
static T_5 int F_294 ( struct V_32 * V_32 )
{
F_99 ( & V_32 -> V_33 . F_14 ,
sizeof( V_32 -> V_33 . F_14 ) ) ;
F_99 ( & V_32 -> V_33 . V_445 ,
sizeof( V_32 -> V_33 . V_445 ) ) ;
return 0 ;
}
static int T_2 F_295 ( char * V_446 )
{
T_15 V_120 ;
if ( ! V_446 )
return 0 ;
V_120 = F_296 ( V_446 , 0 , & V_447 ) ;
if ( V_120 )
return 0 ;
return 1 ;
}
...
int V_448 = 0 ;
#ifdef F_58
V_89 = F_298 ( 256 * sizeof( struct V_89 ) , F_299 ( struct V_89 ) ) ;
if ( ! V_89 )
F_10 ( L_32 ) ;
#endif
V_70 . V_449 =
F_300 ( L_33 , sizeof( struct V_7 ) , 0 ,
V_450 | V_451 , NULL ) ;
V_366 . V_449 = V_70 . V_449 ;
if ( F_301 ( & V_70 ) < 0 )
F_10 ( L_34 ) ;
if ( F_301 ( & V_366 ) < 0 )
F_10 ( L_35 ) ;
...
0 ,
V_447 ? 0 : 512 * 1024 ) ;
memset ( V_41 , 0 , ( V_31 + 1 ) * sizeof( struct V_452 ) ) ;
F_8 () ;
V_70 . V_178 = ( V_31 + 1 ) ;
V_176 = ( V_31 + 1 ) * 16 ;
F_303 () ;
...
F_310 ( V_176 ) ;
#endif
F_311 ( V_454 , V_455 , F_267 , NULL , NULL ) ;
#ifdef F_312
F_62 ( & V_456 ) ;
#endif
F_62 ( & V_457 ) ;
