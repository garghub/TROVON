...
V_3 -> V_352 ) ;
F_176 ( V_332 , L_59 ,
V_3 -> V_179 , V_3 -> V_353 , ( unsigned long ) V_3 -> V_6 ) ;
F_176 ( V_332 , L_60 ) ;
F_176 ( V_332 ,
L_61 ,
V_25 & V_354 ,
...
{
struct V_3 * V_3 = V_330 -> V_165 ;
unsigned int V_379 , V_26 , V_380 , V_333 , V_16 ;
unsigned int V_22 , V_282 ;
V_379 = F_4 ( V_3 , V_223 ) ;
V_26 = F_4 ( V_3 , V_225 ) ;
V_380 = F_4 ( V_3 , V_283 ) ;
V_333 = V_3 -> V_70 ;
F_176 ( V_332 , L_128 , V_379 ) ;
F_176 ( V_332 , L_129 , V_26 ) ;
F_176 ( V_332 , L_130 , V_380 ) ;
F_176 ( V_332 , L_131 ) ;
F_176 ( V_332 , L_132 ,
...
static T_4 F_188 ( int V_179 , void * V_383 )
{
struct V_3 * V_3 = (struct V_3 * ) V_383 ;
unsigned int V_25 ;
int V_16 , V_384 , V_147 , V_385 = 0 ;
V_25 = F_4 ( V_3 , V_34 ) ;
V_384 = V_25 & V_354 ;
...
static T_1 F_191 ( struct V_392
* V_162 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
return F_20 ( V_3 ) ;
}
static int F_193 ( struct V_392 * V_162 )
{
struct V_393 * V_394 = V_162 -> V_394 ;
struct V_3 * V_3 = F_192 ( V_162 ) ;
struct V_392 * V_395 ;
if ( V_162 -> V_396 == V_397 )
V_395 = V_3 -> V_388 ;
else
V_395 = V_3 -> V_389 ;
if ( V_3 -> V_398 )
V_394 -> V_25 -> V_399 = F_20 ( V_3 ) ;
else
V_394 -> V_25 -> V_399 = 0 ;
if ( V_395 ) {
struct V_392 * V_77 ;
struct V_393 * V_400 = V_395 -> V_394 ;
F_194 (s, substream) {
if ( V_77 == V_395 ) {
V_400 -> V_25 -> V_399 =
V_394 -> V_25 -> V_399 ;
...
static int F_195 ( struct V_392 * V_162 ,
struct V_401 * V_402 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
int V_173 ;
...
if ( V_404 > 0 && V_403 != V_404 ) {
if ( F_196 ( V_402 ) != V_3 -> V_99 ) {
F_27 ( & V_3 -> V_22 ) ;
F_197 ( V_402 ,
V_406 ) ;
return - V_115 ;
}
if ( F_198 ( V_402 ) != V_3 -> V_73 / 4 ) {
F_27 ( & V_3 -> V_22 ) ;
F_197 ( V_402 ,
V_407 ) ;
return - V_115 ;
...
F_27 ( & V_3 -> V_22 ) ;
F_25 ( & V_3 -> V_22 ) ;
V_173 = F_33 ( V_3 , F_196 ( V_402 ) , 0 ) ;
if ( V_173 < 0 ) {
F_34 ( V_408 L_149 , V_173 ) ;
F_27 ( & V_3 -> V_22 ) ;
F_197 ( V_402 ,
V_406 ) ;
return V_173 ;
...
F_199 ( V_162 , V_409 ) ;
if ( V_173 < 0 ) {
F_34 ( V_408 L_151 , V_173 ) ;
return V_173 ;
}
if ( V_162 -> V_396 == V_397 ) {
F_200 ( V_3 , V_162 , V_410 ,
F_201 ( V_402 ) ) ;
for ( V_16 = 0 ; V_16 < F_201 ( V_402 ) ; ++ V_16 )
F_11 ( V_3 , V_16 , 1 ) ;
V_3 -> V_82 =
( unsigned char * ) V_162 -> V_394 -> V_411 ;
F_202 ( L_152 ,
V_3 -> V_82 ) ;
} else {
F_200 ( V_3 , V_162 , V_412 ,
F_201 ( V_402 ) ) ;
for ( V_16 = 0 ; V_16 < F_201 ( V_402 ) ; ++ V_16 )
F_10 ( V_3 , V_16 , 1 ) ;
V_3 -> V_413 =
...
if ( V_414 == F_203 ( V_402 ) ) {
if ( ! ( V_3 -> V_70 & V_415 ) )
F_34 ( V_408 L_154 ) ;
V_3 -> V_70 |= V_415 ;
} else if ( V_416 == F_203 ( V_402 ) ) {
if ( V_3 -> V_70 & V_415 )
F_34 ( V_408 L_155 ) ;
V_3 -> V_70 &= ~ V_415 ;
}
...
static int F_204 ( struct V_392 * V_162 )
{
int V_16 ;
struct V_3 * V_3 = F_192 ( V_162 ) ;
if ( V_162 -> V_396 == V_397 ) {
...
static int F_206 ( struct V_392 * V_162 ,
struct V_417 * V_418 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
if ( V_162 -> V_396 == V_397 ) {
if ( F_32 ( V_418 -> V_279 >= V_3 -> V_124 ) ) {
F_34 ( V_408 L_156 , V_418 -> V_279 ) ;
return - V_112 ;
}
if ( V_3 -> V_120 [ V_418 -> V_279 ] < 0 ) {
F_34 ( V_408 L_157 , V_418 -> V_279 ) ;
return - V_112 ;
}
V_418 -> V_419 = V_3 -> V_120 [ V_418 -> V_279 ] *
V_84 ;
} else {
if ( F_32 ( V_418 -> V_279 >= V_3 -> V_122 ) ) {
F_34 ( V_408 L_158 , V_418 -> V_279 ) ;
return - V_112 ;
}
if ( V_3 -> V_118 [ V_418 -> V_279 ] < 0 ) {
F_34 ( V_408 L_159 , V_418 -> V_279 ) ;
return - V_112 ;
}
V_418 -> V_419 = V_3 -> V_118 [ V_418 -> V_279 ] *
V_84 ;
}
V_418 -> V_420 = 0 ;
V_418 -> V_220 = 32 ;
...
static int F_207 ( struct V_392 * V_162 ,
unsigned int V_421 , void * V_208 )
{
switch ( V_421 ) {
case V_422 :
return F_193 ( V_162 ) ;
case V_423 :
{
struct V_417 * V_418 = V_208 ;
return F_206 ( V_162 , V_418 ) ;
}
default:
break;
}
return F_208 ( V_162 , V_421 , V_208 ) ;
}
static int F_209 ( struct V_392 * V_162 , int V_421 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
struct V_392 * V_395 ;
int V_398 ;
...
if ( ! V_3 -> V_398 && V_398 )
F_21 ( V_3 ) ;
else if ( V_3 -> V_398 && ! V_398 )
F_22 ( V_3 ) ;
V_3 -> V_398 = V_398 ;
F_211 ( & V_3 -> V_22 ) ;
return 0 ;
}
static int F_213 ( struct V_392 * V_162 )
{
return 0 ;
}
static int F_214 ( struct V_401 * V_402 ,
struct V_428 * V_429 )
{
struct V_3 * V_3 = V_429 -> V_430 ;
struct V_431 * V_432 =
F_215 ( V_402 , V_433 ) ;
struct V_431 * V_434 =
F_215 ( V_402 , V_406 ) ;
if ( V_434 -> V_218 > 96000 && V_434 -> V_219 <= 192000 ) {
struct V_431 V_435 = {
. V_218 = V_3 -> V_138 ,
. V_219 = V_3 -> V_138 ,
. integer = 1 ,
} ;
return F_216 ( V_432 , & V_435 ) ;
} else if ( V_434 -> V_218 > 48000 && V_434 -> V_219 <= 96000 ) {
struct V_431 V_435 = {
. V_218 = V_3 -> V_132 ,
. V_219 = V_3 -> V_132 ,
. integer = 1 ,
...
static int F_217 ( struct V_401 * V_402 ,
struct V_428 * V_429 )
{
struct V_3 * V_3 = V_429 -> V_430 ;
struct V_431 * V_432 =
...
static int F_218 ( struct V_401 * V_402 ,
struct V_428 * V_429 )
{
struct V_3 * V_3 = V_429 -> V_430 ;
struct V_431 * V_432 =
...
struct V_431 * V_434 =
F_215 ( V_402 , V_406 ) ;
if ( V_432 -> V_218 >= V_3 -> V_123 ) {
struct V_431 V_435 = {
. V_218 = 32000 ,
. V_219 = 48000 ,
. integer = 1 ,
} ;
return F_216 ( V_434 , & V_435 ) ;
} else if ( V_432 -> V_219 <= V_3 -> V_138 ) {
struct V_431 V_435 = {
. V_218 = 128000 ,
. V_219 = 192000 ,
. integer = 1 ,
...
static int F_219 ( struct V_401 * V_402 ,
struct V_428 * V_429 )
{
struct V_3 * V_3 = V_429 -> V_430 ;
struct V_431 * V_432 =
...
static int F_220 ( struct V_401 * V_402 ,
struct V_428 * V_429 )
{
unsigned int V_321 [ 3 ] ;
struct V_3 * V_3 = V_429 -> V_430 ;
struct V_431 * V_432 = F_215 ( V_402 ,
V_433 ) ;
V_321 [ 0 ] = V_3 -> V_138 ;
V_321 [ 1 ] = V_3 -> V_132 ;
V_321 [ 2 ] = V_3 -> V_123 ;
return F_221 ( V_432 , 3 , V_321 , 0 ) ;
}
static int F_222 ( struct V_401 * V_402 ,
struct V_428 * V_429 )
{
unsigned int V_321 [ 3 ] ;
struct V_3 * V_3 = V_429 -> V_430 ;
...
static int F_223 ( struct V_392 * V_162 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
struct V_393 * V_394 = V_162 -> V_394 ;
F_25 ( & V_3 -> V_22 ) ;
...
static int F_230 ( struct V_392 * V_162 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
F_25 ( & V_3 -> V_22 ) ;
V_3 -> V_23 = - 1 ;
...
static int F_231 ( struct V_392 * V_162 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
struct V_393 * V_394 = V_162 -> V_394 ;
F_25 ( & V_3 -> V_22 ) ;
...
static int F_232 ( struct V_392 * V_162 )
{
struct V_3 * V_3 = F_192 ( V_162 ) ;
F_25 ( & V_3 -> V_22 ) ;
V_3 -> V_24 = - 1 ;
...
static int F_233 ( struct V_445 * V_436 , struct V_446 * V_446 )
{
return 0 ;
}
static inline int F_234 ( void T_6 * V_447 , void T_7 * V_448 )
{
V_15 V_5 = F_5 ( V_448 ) ;
return F_235 ( V_447 , & V_5 , 4 ) ;
}
static int F_236 ( struct V_445 * V_436 , struct V_446 * V_446 ,
unsigned int V_421 , unsigned long V_208 )
{
void T_6 * V_449 = ( void T_6 * ) V_208 ;
struct V_3 * V_3 = V_436 -> V_165 ;
struct V_450 V_10 ;
struct V_451 V_418 ;
struct V_452 V_25 ;
struct V_453 V_453 ;
...
V_77 = F_235 ( V_449 , V_455 , sizeof( struct V_454 ) ) ;
if ( 0 != V_77 ) {
return - V_479 ;
}
break;
case V_480 :
V_342 . V_342 = F_4 ( V_3 , V_358 ) ;
V_16 = F_4 ( V_3 , V_358 + 4 ) ;
if ( V_16 & V_359 ) {
switch ( V_16 & ( V_292 |
V_293 ) ) {
case 0 :
...
V_77 = F_235 ( V_449 , & V_342 , sizeof( struct V_456 ) ) ;
if ( 0 != V_77 ) {
return - V_479 ;
}
break;
...
F_25 ( & V_3 -> V_22 ) ;
V_418 . V_335 = F_81 ( V_3 ) ;
V_418 . V_495 = F_143 ( V_3 ) ;
V_418 . V_99 = V_3 -> V_99 ;
V_418 . V_496 =
F_15 ( V_3 ) ;
V_418 . V_337 = F_71 ( V_3 ) ;
V_418 . V_497 = F_76 ( V_3 ) ;
V_418 . V_336 = F_16 ( V_3 ) ;
V_418 . V_498 = F_88 ( V_3 ) ;
V_418 . V_499 = 0 ;
F_27 ( & V_3 -> V_22 ) ;
if ( F_235 ( V_449 , & V_418 , sizeof( V_418 ) ) )
return - V_479 ;
break;
case V_500 :
...
if ( F_235 ( V_449 , & V_25 , sizeof( V_25 ) ) )
return - V_479 ;
break;
case V_514 :
memset ( & V_453 , 0 , sizeof( V_453 ) ) ;
V_453 . V_501 = V_3 -> V_31 ;
strncpy ( V_453 . V_515 , V_3 -> V_346 ,
sizeof( V_453 . V_515 ) ) ;
V_453 . V_352 = V_3 -> V_352 ;
V_453 . V_348 = V_3 -> V_348 ;
V_453 . V_516 = 0 ;
if ( V_3 -> V_224 )
V_453 . V_516 |= V_517 ;
if ( F_235 ( V_449 , & V_453 ,
sizeof( V_453 ) ) )
return - V_479 ;
break;
case V_518 :
if ( F_237 ( & V_10 , V_449 , sizeof( V_10 ) ) )
return - V_479 ;
...
struct V_445 * V_436 ;
int V_173 ;
V_173 = F_239 ( V_172 , L_160 , 0 , & V_436 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 -> V_520 = V_436 ;
V_436 -> V_165 = V_3 ;
strcpy ( V_436 -> V_199 , L_161 ) ;
V_436 -> V_521 . V_522 = F_233 ;
V_436 -> V_521 . V_523 = F_236 ;
V_436 -> V_521 . V_524 = F_236 ;
V_436 -> V_521 . V_525 = F_233 ;
return 0 ;
}
...
struct V_526 * V_527 ;
int V_173 ;
V_173 = F_245 ( V_172 , V_3 -> V_346 , 0 , 1 , 1 , & V_527 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 -> V_527 = V_527 ;
V_527 -> V_165 = V_3 ;
strcpy ( V_527 -> V_199 , V_3 -> V_346 ) ;
F_246 ( V_527 , V_397 ,
& V_532 ) ;
F_246 ( V_527 , V_427 ,
& V_533 ) ;
...
F_251 ( V_3 -> V_530 ,
V_539 , & V_3 -> V_348 ) ;
strcpy ( V_172 -> V_540 , L_171 ) ;
strcpy ( V_172 -> V_541 , L_172 ) ;
switch ( V_3 -> V_348 ) {
case V_542 :
V_3 -> V_31 = V_48 ;
V_3 -> V_346 = L_173 ;
...
return V_173 ;
F_253 ( V_3 -> V_530 ) ;
V_173 = F_254 ( V_530 , L_145 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 -> V_353 = F_255 ( V_530 , 0 ) ;
V_538 = F_256 ( V_530 , 0 ) ;
F_202 ( L_179 ,
V_3 -> V_353 , V_3 -> V_353 + V_538 - 1 ) ;
V_3 -> V_6 = F_257 ( V_3 -> V_353 , V_538 ) ;
if ( ! V_3 -> V_6 ) {
F_34 ( V_113 L_1
L_180 ,
V_3 -> V_353 , V_3 -> V_353 + V_538 - 1 ) ;
...
F_202 ( L_181 ,
( unsigned long ) V_3 -> V_6 , V_3 -> V_353 ,
V_3 -> V_353 + V_538 - 1 ) ;
if ( F_258 ( V_530 -> V_179 , F_188 ,
V_546 , V_547 , V_3 ) ) {
F_34 ( V_113 L_182 , V_530 -> V_179 ) ;
return - V_115 ;
}
F_202 ( L_183 , V_530 -> V_179 ) ;
V_3 -> V_179 = V_530 -> V_179 ;
F_202 ( L_184 ,
sizeof( struct V_519 ) ) ;
V_3 -> V_10 = F_259 ( sizeof( struct V_519 ) , V_548 ) ;
if ( ! V_3 -> V_10 ) {
F_34 ( V_113 L_1
L_185 ,
...
switch ( V_3 -> V_31 ) {
case V_32 :
V_3 -> V_123 = V_3 -> V_125 = V_549 ;
V_3 -> V_132 = V_3 -> V_133 = V_549 ;
V_3 -> V_138 = V_3 -> V_139 = V_549 ;
V_3 -> V_119 = V_3 -> V_121 =
V_550 ;
V_3 -> V_130 = V_3 -> V_131 =
V_550 ;
...
V_585 ) {
V_3 -> V_209 ++ ;
V_3 -> V_224 = F_259 ( sizeof( struct V_586 ) ,
V_548 ) ;
if ( NULL != V_3 -> V_224 ) {
F_150 ( V_3 ) ;
}
...
V_3 -> V_352 = ( F_4 ( V_3 ,
V_182 ) >> 8 ) & 0xFFFFFF ;
if ( NULL == V_146 [ V_3 -> V_595 ] && V_3 -> V_352 != 0xFFFFFF ) {
sprintf ( V_172 -> V_146 , L_189 , V_3 -> V_352 ) ;
F_261 ( V_172 , V_172 -> V_146 ) ;
}
}
F_202 ( L_190 ) ;
...
static void F_268 ( struct V_171 * V_172 )
{
struct V_3 * V_3 = V_172 -> V_165 ;
if ( V_3 )
F_262 ( V_3 ) ;
}
static int T_3 F_269 ( struct V_537 * V_530 ,
...
V_173 = F_270 ( V_233 [ V_595 ] , V_146 [ V_595 ] ,
V_601 , sizeof( struct V_3 ) , & V_172 ) ;
if ( V_173 < 0 )
return V_173 ;
V_3 = V_172 -> V_165 ;
V_172 -> V_602 = F_268 ;
...
V_3 -> V_346 ,
V_3 -> V_352 ) ;
sprintf ( V_172 -> V_603 , L_192 ,
V_3 -> V_346 ,
V_3 -> V_352 ,
V_3 -> V_353 , V_3 -> V_179 ) ;
} else {
sprintf ( V_172 -> V_198 , L_193 , V_3 -> V_346 ) ;
sprintf ( V_172 -> V_603 , L_194 ,
V_3 -> V_346 , V_3 -> V_353 , V_3 -> V_179 ) ;
}
V_173 = F_249 ( V_172 ) ;
if ( V_173 < 0 ) {
F_272 ( V_172 ) ;
...
static void T_9 F_274 ( struct V_537 * V_530 )
{
F_272 ( F_275 ( V_530 ) ) ;
F_273 ( V_530 , NULL ) ;
}
