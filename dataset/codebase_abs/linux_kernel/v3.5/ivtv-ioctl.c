...
{
struct V_55 * V_56 = F_30 ( V_88 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
struct V_97 * V_98 = & V_17 -> V_17 . V_99 ;
V_98 -> V_100 = V_23 -> V_37 . V_100 ;
V_98 -> V_101 = V_23 -> V_37 . V_101 ;
V_98 -> V_102 = V_103 ;
V_98 -> V_9 = V_104 ;
V_98 -> V_105 = 0 ;
if ( V_56 -> type == V_106 ) {
...
if ( V_153 )
return V_153 ;
if ( V_23 -> V_37 . V_100 == V_147 && V_23 -> V_37 . V_101 == V_151 )
return 0 ;
if ( F_12 ( & V_23 -> V_156 ) > 0 )
return - V_75 ;
V_23 -> V_37 . V_100 = V_147 ;
V_23 -> V_37 . V_101 = V_151 ;
...
{
struct V_55 * V_56 = F_30 ( V_87 -> V_215 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
...
F_95 ( & V_23 -> V_37 , V_23 -> V_122 ) ;
V_23 -> V_37 . V_100 = 720 ;
V_23 -> V_37 . V_101 = V_23 -> V_122 ? 576 : 480 ;
...
F_14 ( & V_23 -> V_285 , & V_35 ,
V_286 ) ;
if ( ( F_97 ( V_287 ) >> 16 ) < 100 )
break;
F_98 ( F_99 ( 25 ) ) ;
}
F_18 ( & V_23 -> V_285 , & V_35 ) ;
F_19 ( & V_23 -> V_43 ) ;
if ( V_19 == 4 )
F_100 ( L_10 ) ;
...
case V_355 :
case V_356 :
return F_117 ( V_88 , V_354 , 0 , NULL ) ;
case V_357 :
return F_117 ( V_88 , V_354 , 0 , & V_358 ) ;
default:
return - V_65 ;
}
}
...
struct V_22 * V_23 = F_30 ( V_88 ) -> V_23 ;
T_2 V_32 [ V_33 ] ;
int V_359 = V_23 -> V_63 & V_64 ;
struct V_233 V_360 ;
struct V_226 V_361 ;
int V_15 ;
F_119 ( L_19 , V_362 , V_23 -> V_219 ) ;
if ( V_23 -> V_278 & V_363 ) {
struct V_364 V_365 ;
F_120 ( V_23 , & V_365 ) ;
}
F_60 ( V_23 , V_190 , V_366 ) ;
F_75 ( V_23 , V_23 -> V_257 , & V_360 ) ;
F_66 ( V_23 , V_23 -> V_229 , & V_361 ) ;
F_119 ( L_20 , V_360 . V_297 ) ;
F_119 ( L_21 , V_361 . V_297 ,
( V_23 -> V_367 & ~ 0x300 ) == 0x200 ? L_22 : L_23 ) ;
if ( V_359 ) {
struct V_234 V_368 ;
struct V_232 V_369 ;
int V_370 = V_23 -> V_82 ;
static const char * const V_371 [ 5 ] = {
L_24 ,
L_25 ,
L_26 ,
L_27 ,
...
static const char * const V_372 [ 4 ] = {
L_24 ,
L_29 ,
L_30 ,
L_31
...
F_77 ( V_23 , V_23 -> V_262 , & V_368 ) ;
F_71 ( V_23 , 0 , & V_369 ) ;
F_119 ( L_48 , V_368 . V_297 ) ;
if ( V_370 < 0 || V_370 > V_373 )
V_370 = V_83 ;
F_119 ( L_49 , V_371 [ V_370 ] ) ;
F_113 ( V_23 , V_32 , V_341 , 0 ) ;
V_32 [ 0 ] |= ( F_97 ( 0x2a00 ) >> 7 ) & 0x40 ;
F_119 ( L_50 ,
V_32 [ 0 ] & 1 ? L_51 : L_52 ,
...
F_119 ( L_53 ,
F_15 ( V_291 , & V_23 -> V_47 ) ? L_54 : L_55 ) ;
F_121 ( & V_23 -> V_37 . V_374 , V_23 -> V_375 . V_297 ) ;
F_119 ( L_56 , V_23 -> V_47 ) ;
for ( V_15 = 0 ; V_15 < V_376 ; V_15 ++ ) {
struct V_60 * V_54 = & V_23 -> V_61 [ V_15 ] ;
if ( V_54 -> V_377 == NULL || V_54 -> V_378 == 0 )
continue;
F_119 ( L_57 , V_54 -> V_297 , V_54 -> V_379 ,
( V_54 -> V_378 - V_54 -> V_380 . V_378 ) * 100 / V_54 -> V_378 ,
( V_54 -> V_378 * V_54 -> V_381 ) / 1024 , V_54 -> V_378 ) ;
}
F_119 ( L_58 ,
( long long ) V_23 -> V_382 ,
( long long ) V_23 -> V_383 ) ;
return 0 ;
}
static int F_122 ( struct V_87 * V_87 , void * V_88 , struct V_57 * V_384 )
{
struct V_55 * V_56 = F_30 ( V_87 -> V_215 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
F_107 ( L_59 , V_384 -> V_66 ) ;
return F_23 ( V_23 , V_56 , V_384 , false ) ;
}
static int F_123 ( struct V_87 * V_87 , void * V_88 , struct V_57 * V_384 )
{
struct V_55 * V_56 = F_30 ( V_87 -> V_215 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
F_107 ( L_60 , V_384 -> V_66 ) ;
return F_23 ( V_23 , V_56 , V_384 , true ) ;
}
static int F_124 ( struct V_87 * V_385 , unsigned int V_66 , void * V_192 )
{
struct V_55 * V_56 = F_30 ( V_385 -> V_215 ) ;
struct V_22 * V_23 = V_56 -> V_23 ;
int V_386 = V_385 -> V_387 & V_388 ;
struct V_60 * V_54 = & V_23 -> V_61 [ V_56 -> type ] ;
unsigned long V_389 = ( unsigned long ) V_192 ;
switch ( V_66 ) {
case V_390 : {
struct V_391 * args = V_192 ;
F_107 ( L_61 ) ;
if ( ! ( V_23 -> V_63 & V_64 ) )
return - V_65 ;
if ( args -> type != V_238 )
return - V_65 ;
if ( V_23 -> V_82 == V_392 && args -> V_393 == NULL )
return 0 ;
if ( F_26 ( V_56 , V_56 -> type ) ) {
return - V_75 ;
}
if ( F_24 ( V_23 , V_392 ) != V_392 ) {
F_125 ( V_54 ) ;
return - V_75 ;
}
V_56 -> V_394 = 1 ;
...
case V_406 : {
struct V_407 * V_408 = V_192 ;
F_10 ( V_35 ) ;
F_107 ( L_71 ) ;
if ( ! ( V_23 -> V_63 & V_64 ) )
return - V_65 ;
memset ( V_408 , 0 , sizeof( * V_408 ) ) ;
F_28 ( V_409 , & V_23 -> V_47 ) ;
while ( 1 ) {
if ( F_25 ( V_410 , & V_23 -> V_47 ) )
V_408 -> type = V_411 ;
else if ( F_25 ( V_412 , & V_23 -> V_47 ) ) {
V_408 -> type = V_413 ;
V_408 -> V_414 . V_415 = F_15 ( V_416 , & V_23 -> V_47 ) ?
V_417 : V_418 ;
if ( V_23 -> V_82 == V_392 &&
...
return - V_420 ;
F_13 ( & V_23 -> V_43 ) ;
F_14 ( & V_23 -> V_421 , & V_35 , V_45 ) ;
if ( ! F_15 ( V_410 , & V_23 -> V_47 ) &&
! F_15 ( V_412 , & V_23 -> V_47 ) )
F_17 () ;
F_18 ( & V_23 -> V_421 , & V_35 ) ;
F_19 ( & V_23 -> V_43 ) ;
if ( F_16 ( V_48 ) ) {
F_21 ( L_72 ) ;
return - V_49 ;
...
if ( V_389 > V_426 )
return - V_65 ;
return F_129 ( V_23 -> V_427 , V_389 + 1 ) ;
case V_428 :
F_107 ( L_76 ) ;
if ( V_389 > V_426 )
return - V_65 ;
return F_129 ( V_23 -> V_429 , V_389 + 1 ) ;
default:
return - V_65 ;
}
return 0 ;
}
static long F_130 ( struct V_87 * V_87 , void * V_88 , bool V_430 ,
int V_66 , void * V_192 )
{
struct V_22 * V_23 = F_30 ( V_88 ) -> V_23 ;
if ( ! V_430 ) {
...
case V_431 : {
T_2 V_209 = * ( T_2 * ) V_192 ;
if ( ( V_209 == 0 && V_23 -> V_432 . V_433 ) || ( V_209 & 0x01 ) )
F_131 ( V_23 ) ;
if ( V_209 & 0x02 )
F_34 ( V_23 -> V_123 , V_190 , V_434 , 0 ) ;
break;
}
case V_390 :
case V_395 :
...
long F_132 ( struct V_87 * V_385 , unsigned int V_66 , unsigned long V_192 )
{
struct V_436 * V_437 = F_133 ( V_385 ) ;
long V_153 ;
if ( V_438 & V_439 )
V_437 -> V_440 = V_441 | V_442 ;
V_153 = F_134 ( V_385 , V_66 , V_192 ) ;
V_437 -> V_440 = 0 ;
return V_153 ;
}
void F_135 ( struct V_436 * V_377 )
{
V_377 -> V_443 = & V_444 ;
}
