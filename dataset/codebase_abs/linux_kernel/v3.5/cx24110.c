...
struct V_72 * V_73 = & V_42 -> V_74 ;
struct V_1 * V_2 = V_42 -> V_43 ;
T_9 V_81 ; unsigned V_82 ;
V_82 = F_4 ( V_2 , 0x07 ) & 0x03 ;
if ( V_82 == 0 ) V_82 = 90999000L / 2L ;
else if ( V_82 == 1 ) V_82 = 60666000L ;
else if ( V_82 == 2 ) V_82 = 80888000L ;
else V_82 = 90999000L ;
V_82 >>= 8 ;
V_81 = V_82 * ( F_4 ( V_2 , 0x44 ) & 0x1f ) +
( ( V_82 * F_4 ( V_2 , 0x45 ) ) >> 8 ) +
( ( V_82 * F_4 ( V_2 , 0x46 ) ) >> 16 ) ;
V_73 -> V_83 += V_81 ;
V_73 -> V_21 = ( F_4 ( V_2 , 0x22 ) & 0x10 ) ?
V_23 : V_22 ;
V_73 -> V_79 = F_7 ( V_2 ) ;
return 0 ;
}
static int F_25 ( struct V_41 * V_42 , T_10 V_84 )
{
struct V_1 * V_2 = V_42 -> V_43 ;
return F_1 ( V_2 , 0x76 , ( F_4 ( V_2 , 0x76 ) & ~ 0x10 ) | ( ( ( V_84 == V_85 ) ) ? 0x10 : 0 ) ) ;
}
...
struct V_41 * F_28 ( const struct V_86 * V_9 ,
struct V_87 * V_14 )
{
struct V_1 * V_2 = NULL ;
int V_17 ;
V_2 = F_29 ( sizeof( struct V_1 ) , V_88 ) ;
...
memcpy ( & V_2 -> V_89 . V_75 , & V_90 , sizeof( struct V_91 ) ) ;
V_2 -> V_89 . V_43 = V_2 ;
return & V_2 -> V_89 ;
error:
F_27 ( V_2 ) ;
