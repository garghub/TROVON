...
T_2 V_113 ;
int V_85 ;
V_85 = F_31 ( V_6 -> V_116 , L_15 ) ;
if ( V_85 < 0 )
return V_85 ;
V_113 = F_32 ( V_6 -> V_116 , 0 ) ;
V_6 -> V_117 = V_113 ;
V_6 -> V_7 = F_33 ( V_6 -> V_117 , V_118 ) ;
if ( ! V_6 -> V_7 )
return - V_119 ;
#if F_10
F_15 ( L_16 ,
( unsigned long long ) V_6 -> V_117 , V_6 -> V_7 ) ;
#endif
return 0 ;
}
static struct V_116 * F_34 ( struct V_116 * V_120 , int * V_121 )
{
int V_4 ;
for ( V_120 = F_35 ( V_122 , V_123 , V_120 ) ;
V_120 != NULL ;
V_120 = F_35 ( V_122 , V_123 , V_120 ) ) {
...
static int F_36 ( struct V_1 * V_2 , int V_128 , int V_129 )
{
int V_121 ;
int V_85 ;
struct V_116 * V_130 ;
V_130 = NULL ;
while ( ( V_130 = F_34 ( V_130 , & V_121 ) ) != NULL ) {
if ( ( V_128 == 0 && V_129 == 0 ) ||
( V_130 -> V_128 -> V_131 == V_128 &&
F_37 ( V_130 -> V_132 ) == V_129 ) ) {
break;
}
}
V_6 -> V_116 = V_130 ;
if ( V_121 >= 0 )
V_2 -> V_133 = V_126 + V_121 ;
if ( ! V_6 -> V_116 )
return 0 ;
V_85 = F_30 ( V_2 ) ;
if ( V_85 < 0 )
...
static int F_38 ( struct V_1 * V_2 , struct V_134 * V_135 )
{
struct V_24 * V_25 ;
int V_128 , V_129 ;
int V_85 = 0 ;
...
V_128 = V_135 -> V_136 [ 0 ] ;
V_129 = V_135 -> V_136 [ 1 ] ;
V_85 = F_39 ( V_2 , sizeof( struct V_137 ) ) ;
if ( V_85 < 0 )
return V_85 ;
V_85 = F_36 ( V_2 , V_128 , V_129 ) ;
if ( V_85 < 0 )
return V_85 ;
if ( V_85 == 0 ) {
F_40 ( V_2 -> V_13 , L_19 ) ;
...
V_2 -> V_139 = V_66 -> V_140 ;
if ( F_41 ( V_6 -> V_116 -> V_22 , F_9 , V_141 ,
L_15 , V_2 ) ) {
F_42 ( V_2 -> V_13 , L_20 ,
V_6 -> V_116 -> V_22 ) ;
return - V_110 ;
}
V_2 -> V_22 = V_6 -> V_116 -> V_22 ;
V_85 = F_43 ( V_2 , 4 ) ;
if ( V_85 < 0 )
return V_85 ;
V_25 = V_2 -> V_28 ;
V_2 -> V_142 = V_25 ;
V_25 -> type = V_143 ;
V_25 -> V_144 = V_145 | V_146 | V_147 | V_148 ;
V_25 -> V_149 = V_66 -> V_150 ;
V_25 -> V_151 = F_23 ;
V_25 -> V_152 = ( 1 << V_66 -> V_153 ) - 1 ;
V_25 -> V_154 = 512 ;
V_25 -> V_155 = & V_156 ;
V_25 -> V_157 = F_19 ;
V_25 -> V_158 = F_17 ;
...
V_25 -> V_151 = F_25 ;
V_25 -> V_162 = F_24 ;
V_25 -> V_152 = ( 1 << V_66 -> V_163 ) - 1 ;
V_25 -> V_154 = 1 ;
V_25 -> V_155 = & V_164 ;
V_25 ++ ;
V_25 -> type = V_165 ;
V_25 -> V_144 = V_145 | V_161 ;
V_25 -> V_149 = 8 ;
V_25 -> V_166 = F_27 ;
V_25 -> V_167 = F_28 ;
V_25 -> V_152 = 1 ;
