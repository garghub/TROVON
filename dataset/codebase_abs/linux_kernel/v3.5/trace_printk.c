...
static void *
F_25 ( struct V_33 * V_34 , T_1 * V_3 )
{
F_15 () ;
return F_24 ( NULL , V_3 ) ;
}
static void * F_26 ( struct V_33 * V_34 , void * V_22 , T_1 * V_3 )
{
( * V_3 ) ++ ;
return F_24 ( V_22 , V_3 ) ;
}
static int F_27 ( struct V_33 * V_34 , void * V_22 )
{
const char * * V_2 = V_22 ;
const char * V_35 = * V_2 ;
int V_36 ;
F_28 ( V_34 , L_1 , * ( unsigned long * ) V_2 ) ;
...
static void F_31 ( struct V_33 * V_34 , void * V_24 )
{
F_16 () ;
}
static int
F_32 ( struct V_37 * V_37 , struct V_38 * V_38 )
{
return F_33 ( V_38 , & V_39 ) ;
}
