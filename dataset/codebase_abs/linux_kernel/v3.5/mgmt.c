...
F_15 ( V_40 [ V_42 ] , V_18 ) ;
V_15 = F_10 ( V_5 , V_34 , V_45 , 0 , V_21 ,
V_41 ) ;
F_16 ( V_21 ) ;
return V_15 ;
}
...
if ( F_22 ( V_53 , & V_49 -> V_54 ) )
continue;
V_21 -> V_6 [ V_42 ++ ] = F_7 ( V_49 -> V_55 ) ;
F_4 ( L_3 , V_49 -> V_55 ) ;
}
F_20 ( & V_51 ) ;
...
void (* F_52)( struct V_132 * V_7 , void * V_25 ) ,
void * V_25 )
{
struct V_47 * V_48 , * V_136 ;
F_53 (p, n, &hdev->mgmt_pending) {
struct V_132 * V_7 ;
V_7 = F_54 ( V_48 , struct V_132 , V_134 ) ;
...
V_191 = 0 ;
F_53 (p, n, &hdev->uuids) {
struct V_88 * V_193 = F_54 ( V_48 , struct V_88 , V_134 ) ;
...
static T_1 F_94 ( T_1 V_235 , T_1 V_210 )
{
switch ( V_235 ) {
case V_224 :
switch ( V_210 ) {
...
if ( F_22 ( V_242 , & V_240 -> V_164 ) )
V_42 ++ ;
}
V_22 = sizeof( * V_21 ) + ( V_42 * sizeof( struct V_243 ) ) ;
V_21 = F_14 ( V_22 , V_16 ) ;
if ( ! V_21 ) {
V_15 = - V_17 ;
goto V_178;
...
if ( ! F_22 ( V_242 , & V_240 -> V_164 ) )
continue;
F_44 ( & V_21 -> V_208 [ V_42 ] . V_125 , & V_240 -> V_244 ) ;
V_21 -> V_208 [ V_42 ] . type = F_94 ( V_240 -> type , V_240 -> V_245 ) ;
...
V_21 -> V_248 = F_7 ( V_42 ) ;
V_22 = sizeof( * V_21 ) + ( V_42 * sizeof( struct V_243 ) ) ;
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_241 , 0 , V_21 ,
V_22 ) ;
F_16 ( V_21 ) ;
V_178:
F_38 ( V_27 ) ;
...
struct V_132 * V_7 ;
int V_15 ;
V_7 = F_48 ( V_5 , V_250 , V_27 , V_107 ,
sizeof( * V_107 ) ) ;
if ( ! V_7 )
return - V_17 ;
V_15 = F_30 ( V_27 , V_251 ,
...
if ( V_218 -> V_256 == V_257 && V_107 -> V_209 != 16 ) {
struct V_249 V_258 ;
memcpy ( & V_258 . V_208 , & V_107 -> V_208 , sizeof( V_258 . V_208 ) ) ;
F_86 ( L_10 ) ;
V_15 = F_96 ( V_5 , V_27 , & V_258 ) ;
if ( V_15 >= 0 )
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_255 ,
V_152 ) ;
goto V_141;
}
V_7 = F_48 ( V_5 , V_255 , V_27 , V_25 , V_20 ) ;
if ( ! V_7 ) {
V_15 = - V_17 ;
goto V_141;
}
F_44 ( & V_254 . V_125 , & V_107 -> V_208 . V_125 ) ;
V_254 . V_209 = V_107 -> V_209 ;
memcpy ( V_254 . V_259 , V_107 -> V_259 , sizeof( V_254 . V_259 ) ) ;
V_15 = F_30 ( V_27 , V_260 , sizeof( V_254 ) , & V_254 ) ;
if ( V_15 < 0 )
F_56 ( V_7 ) ;
V_141:
F_38 ( V_27 ) ;
...
static int F_98 ( struct V_4 * V_5 , struct V_26 * V_27 ,
void * V_25 , T_2 V_20 )
{
struct V_249 * V_107 = V_25 ;
int V_15 ;
F_4 ( L_9 ) ;
F_37 ( V_27 ) ;
if ( ! F_25 ( V_27 ) ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_250 ,
V_153 ) ;
goto V_141;
}
V_15 = F_96 ( V_5 , V_27 , V_107 ) ;
V_141:
F_38 ( V_27 ) ;
return V_15 ;
}
static int F_99 ( struct V_4 * V_5 , struct V_26 * V_27 , void * V_25 ,
T_2 V_20 )
{
struct V_261 * V_107 = V_25 ;
F_4 ( L_9 ) ;
F_37 ( V_27 ) ;
V_27 -> V_262 = V_107 -> V_262 ;
F_4 ( L_11 , V_27 -> V_114 ,
V_27 -> V_262 ) ;
F_38 ( V_27 ) ;
return F_10 ( V_5 , V_27 -> V_55 , V_263 , 0 , NULL ,
0 ) ;
}
static inline struct V_132 * F_100 ( struct V_217 * V_218 )
{
...
static void F_101 ( struct V_132 * V_7 , T_1 V_8 )
{
struct V_266 V_21 ;
struct V_217 * V_218 = V_7 -> V_265 ;
F_44 ( & V_21 . V_208 . V_125 , & V_218 -> V_244 ) ;
V_21 . V_208 . type = F_94 ( V_218 -> type , V_218 -> V_245 ) ;
F_10 ( V_7 -> V_5 , V_7 -> V_6 , V_264 , V_8 ,
& V_21 , sizeof( V_21 ) ) ;
V_218 -> V_267 = NULL ;
V_218 -> V_268 = NULL ;
V_218 -> V_269 = NULL ;
...
static void F_104 ( struct V_217 * V_218 , T_1 V_8 )
{
struct V_132 * V_7 ;
F_4 ( L_12 , V_8 ) ;
if ( ! V_8 )
...
V_272 = V_276 ;
if ( V_107 -> V_208 . type == V_220 )
V_218 = F_106 ( V_27 , V_223 , & V_107 -> V_208 . V_125 ,
V_107 -> V_208 . type , V_271 , V_272 ) ;
else
V_218 = F_106 ( V_27 , V_224 , & V_107 -> V_208 . V_125 ,
V_107 -> V_208 . type , V_271 , V_272 ) ;
memset ( & V_21 , 0 , sizeof( V_21 ) ) ;
F_44 ( & V_21 . V_208 . V_125 , & V_107 -> V_208 . V_125 ) ;
V_21 . V_208 . type = V_107 -> V_208 . type ;
if ( F_107 ( V_218 ) ) {
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_264 ,
V_277 , & V_21 ,
sizeof( V_21 ) ) ;
goto V_178;
}
...
V_7 = F_48 ( V_5 , V_264 , V_27 , V_25 , V_20 ) ;
if ( ! V_7 ) {
V_15 = - V_17 ;
F_102 ( V_218 ) ;
goto V_178;
...
V_218 -> V_268 = F_103 ;
V_218 -> V_269 = F_103 ;
V_218 -> V_262 = V_107 -> V_274 ;
V_7 -> V_265 = V_218 ;
if ( V_218 -> V_231 == V_278 &&
F_108 ( V_218 , V_271 , V_272 ) )
F_101 ( V_7 , 0 ) ;
V_15 = 0 ;
V_178:
F_38 ( V_27 ) ;
...
V_218 = V_7 -> V_265 ;
if ( F_110 ( & V_208 -> V_125 , & V_218 -> V_244 ) != 0 ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_279 ,
V_152 ) ;
goto V_178;
}
F_101 ( V_7 , V_280 ) ;
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_279 , 0 ,
V_208 , sizeof( * V_208 ) ) ;
V_178:
F_38 ( V_27 ) ;
return V_15 ;
...
V_7 = F_48 ( V_5 , V_281 , V_27 , V_125 , sizeof( * V_125 ) ) ;
if ( ! V_7 ) {
V_15 = - V_17 ;
goto V_284;
}
...
V_107 . V_283 = V_283 ;
V_15 = F_30 ( V_27 , V_282 , sizeof( V_107 ) , & V_107 ) ;
} else
V_15 = F_30 ( V_27 , V_282 , sizeof( * V_125 ) , V_125 ) ;
if ( V_15 < 0 )
F_56 ( V_7 ) ;
V_284:
F_38 ( V_27 ) ;
...
void * V_25 , T_2 V_20 )
{
struct V_291 * V_107 = V_25 ;
F_4 ( L_9 ) ;
return F_111 ( V_5 , V_27 , & V_107 -> V_208 . V_125 , V_107 -> V_208 . type ,
V_292 ,
V_293 , 0 ) ;
}
static int F_115 ( struct V_4 * V_5 , struct V_26 * V_27 , void * V_25 ,
T_2 V_20 )
{
struct V_294 * V_107 = V_25 ;
F_4 ( L_9 ) ;
return F_111 ( V_5 , V_27 , & V_107 -> V_208 . V_125 , V_107 -> V_208 . type ,
V_295 ,
V_286 , V_107 -> V_283 ) ;
}
static int F_116 ( struct V_4 * V_5 , struct V_26 * V_27 ,
void * V_25 , T_2 V_20 )
{
...
static int F_117 ( struct V_26 * V_27 , const char * V_114 )
{
struct V_299 V_107 ;
memcpy ( V_107 . V_114 , V_114 , sizeof( V_107 . V_114 ) ) ;
return F_30 ( V_27 , V_300 , sizeof( V_107 ) , & V_107 ) ;
}
static int F_118 ( struct V_4 * V_5 , struct V_26 * V_27 , void * V_25 ,
T_2 V_20 )
{
struct V_301 * V_107 = V_25 ;
struct V_132 * V_7 ;
int V_15 ;
F_4 ( L_9 ) ;
F_37 ( V_27 ) ;
...
if ( V_15 < 0 )
goto V_141;
V_15 = F_63 ( V_303 , V_27 , V_25 , V_20 ,
V_5 ) ;
goto V_141;
}
V_7 = F_48 ( V_5 , V_302 , V_27 , V_25 , V_20 ) ;
if ( ! V_7 ) {
V_15 = - V_17 ;
goto V_141;
}
V_15 = F_117 ( V_27 , V_107 -> V_114 ) ;
if ( V_15 < 0 )
F_56 ( V_7 ) ;
V_141:
F_38 ( V_27 ) ;
...
static int F_119 ( struct V_4 * V_5 , struct V_26 * V_27 ,
void * V_25 , T_2 V_28 )
{
struct V_132 * V_7 ;
int V_15 ;
...
V_7 = F_48 ( V_5 , V_304 , V_27 , NULL , 0 ) ;
if ( ! V_7 ) {
V_15 = - V_17 ;
goto V_178;
}
V_15 = F_30 ( V_27 , V_305 , 0 , NULL ) ;
if ( V_15 < 0 )
F_56 ( V_7 ) ;
V_178:
F_38 ( V_27 ) ;
...
void * V_25 , T_2 V_20 )
{
struct V_306 * V_107 = V_25 ;
T_1 V_8 ;
int V_15 ;
F_4 ( L_14 , V_27 -> V_114 ) ;
F_37 ( V_27 ) ;
if ( ! F_25 ( V_27 ) ) {
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_307 ,
V_153 , & V_107 -> V_208 ,
sizeof( V_107 -> V_208 ) ) ;
goto V_178;
}
V_15 = F_121 ( V_27 , & V_107 -> V_208 . V_125 , V_107 -> V_308 ,
V_107 -> V_309 ) ;
if ( V_15 < 0 )
V_8 = V_3 ;
else
V_8 = 0 ;
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_307 , V_8 ,
& V_107 -> V_208 , sizeof( V_107 -> V_208 ) ) ;
V_178:
F_38 ( V_27 ) ;
return V_15 ;
}
static int F_122 ( struct V_4 * V_5 , struct V_26 * V_27 ,
void * V_25 , T_2 V_20 )
{
struct V_310 * V_107 = V_25 ;
T_1 V_8 ;
int V_15 ;
F_4 ( L_4 , V_27 -> V_114 ) ;
F_37 ( V_27 ) ;
...
V_15 = F_123 ( V_27 , & V_107 -> V_208 . V_125 ) ;
if ( V_15 < 0 )
V_8 = V_152 ;
else
V_8 = 0 ;
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_311 ,
...
F_4 ( L_4 , V_27 -> V_114 ) ;
F_37 ( V_27 ) ;
V_15 = F_125 ( V_27 , V_312 ) ;
if ( V_15 < 0 )
F_126 ( V_27 , V_313 ) ;
F_38 ( V_27 ) ;
return V_15 ;
}
static int F_127 ( struct V_4 * V_5 , struct V_26 * V_27 ,
void * V_25 , T_2 V_20 )
{
struct V_314 * V_107 = V_25 ;
struct V_132 * V_7 ;
int V_15 ;
F_4 ( L_4 , V_27 -> V_114 ) ;
F_37 ( V_27 ) ;
if ( ! F_25 ( V_27 ) ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_315 ,
V_153 ) ;
goto V_141;
}
if ( F_22 ( V_316 , & V_27 -> V_54 ) ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_315 ,
V_142 ) ;
goto V_141;
}
if ( V_27 -> V_317 . V_231 != V_313 ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_315 ,
V_142 ) ;
goto V_141;
}
V_7 = F_48 ( V_5 , V_315 , V_27 , NULL , 0 ) ;
if ( ! V_7 ) {
V_15 = - V_17 ;
goto V_141;
}
V_27 -> V_317 . type = V_107 -> type ;
switch ( V_27 -> V_317 . type ) {
case V_318 :
if ( F_128 ( V_27 ) )
V_15 = F_125 ( V_27 , V_319 ) ;
else
V_15 = - V_320 ;
break;
case V_321 :
if ( F_129 ( V_27 ) )
V_15 = F_130 ( V_27 , V_322 , V_323 ,
V_324 , V_325 ) ;
else
V_15 = - V_320 ;
break;
case V_326 :
if ( F_129 ( V_27 ) && F_128 ( V_27 ) )
V_15 = F_130 ( V_27 , V_322 , V_323 ,
V_324 ,
V_327 ) ;
else
...
static int F_131 ( struct V_4 * V_5 , struct V_26 * V_27 , void * V_25 ,
T_2 V_20 )
{
struct V_330 * V_331 = V_25 ;
struct V_132 * V_7 ;
struct V_332 V_107 ;
struct V_333 * V_334 ;
int V_15 ;
...
F_37 ( V_27 ) ;
if ( ! F_132 ( V_27 ) ) {
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_335 ,
V_155 , & V_331 -> type ,
sizeof( V_331 -> type ) ) ;
goto V_178;
}
if ( V_27 -> V_317 . type != V_331 -> type ) {
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_335 ,
V_152 , & V_331 -> type ,
sizeof( V_331 -> type ) ) ;
goto V_178;
}
V_7 = F_48 ( V_5 , V_335 , V_27 , NULL , 0 ) ;
if ( ! V_7 ) {
V_15 = - V_17 ;
goto V_178;
}
switch ( V_27 -> V_317 . V_231 ) {
case V_336 :
if ( F_22 ( V_337 , & V_27 -> V_164 ) )
V_15 = F_133 ( V_27 ) ;
else
V_15 = F_134 ( V_27 ) ;
break;
case V_338 :
V_334 = F_135 ( V_27 , V_339 ,
V_340 ) ;
if ( ! V_334 ) {
F_56 ( V_7 ) ;
V_15 = F_10 ( V_5 , V_27 -> V_55 ,
...
F_44 ( & V_107 . V_125 , & V_334 -> V_25 . V_125 ) ;
V_15 = F_30 ( V_27 , V_341 ,
sizeof( V_107 ) , & V_107 ) ;
break;
default:
F_4 ( L_15 , V_27 -> V_317 . V_231 ) ;
V_15 = - V_342 ;
}
if ( V_15 < 0 )
F_56 ( V_7 ) ;
...
T_2 V_20 )
{
struct V_344 * V_107 = V_25 ;
struct V_333 * V_334 ;
int V_15 ;
F_4 ( L_4 , V_27 -> V_114 ) ;
F_37 ( V_27 ) ;
if ( ! F_132 ( V_27 ) ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_345 ,
V_3 ) ;
goto V_141;
}
V_334 = F_137 ( V_27 , & V_107 -> V_208 . V_125 ) ;
if ( ! V_334 ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_345 ,
V_152 ) ;
goto V_141;
...
static int F_139 ( struct V_4 * V_5 , struct V_26 * V_27 , void * V_25 ,
T_2 V_20 )
{
struct V_350 * V_107 = V_25 ;
T_1 V_8 ;
int V_15 ;
F_4 ( L_4 , V_27 -> V_114 ) ;
F_37 ( V_27 ) ;
V_15 = F_140 ( V_27 , & V_107 -> V_208 . V_125 , V_107 -> V_208 . type ) ;
if ( V_15 < 0 )
V_8 = V_3 ;
else
V_8 = 0 ;
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_351 , V_8 ,
& V_107 -> V_208 , sizeof( V_107 -> V_208 ) ) ;
F_38 ( V_27 ) ;
return V_15 ;
}
static int F_141 ( struct V_4 * V_5 , struct V_26 * V_27 , void * V_25 ,
T_2 V_20 )
{
...
F_4 ( L_4 , V_27 -> V_114 ) ;
F_37 ( V_27 ) ;
V_15 = F_142 ( V_27 , & V_107 -> V_208 . V_125 , V_107 -> V_208 . type ) ;
if ( V_15 < 0 )
V_8 = V_152 ;
else
V_8 = 0 ;
...
T_8 V_355 ;
F_4 ( L_4 , V_27 -> V_114 ) ;
V_355 = F_68 ( V_107 -> V_355 ) ;
if ( V_355 > 0x0002 )
return F_3 ( V_5 , V_27 -> V_55 , V_356 ,
V_152 ) ;
F_37 ( V_27 ) ;
V_27 -> V_96 = V_355 ;
V_27 -> V_98 = F_68 ( V_107 -> V_357 ) ;
V_27 -> V_99 = F_68 ( V_107 -> V_358 ) ;
V_27 -> V_100 = F_68 ( V_107 -> V_30 ) ;
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_356 , 0 , NULL , 0 ) ;
F_29 ( V_27 ) ;
F_38 ( V_27 ) ;
return V_15 ;
}
static int F_144 ( struct V_4 * V_5 , struct V_26 * V_27 ,
void * V_25 , T_2 V_20 )
{
struct V_137 * V_107 = V_25 ;
struct V_359 V_360 ;
...
F_4 ( L_4 , V_27 -> V_114 ) ;
if ( ! F_25 ( V_27 ) )
return F_3 ( V_5 , V_27 -> V_55 , V_361 ,
V_153 ) ;
if ( ! F_22 ( V_73 , & V_27 -> V_54 ) )
return F_3 ( V_5 , V_27 -> V_55 , V_361 ,
V_155 ) ;
...
if ( V_107 -> V_81 ) {
type = V_362 ;
V_360 . V_363 = F_12 ( 0x0024 ) ;
} else {
type = V_364 ;
V_360 . V_363 = F_12 ( 0x0800 ) ;
}
V_360 . V_365 = F_12 ( 0x0012 ) ;
V_15 = F_30 ( V_27 , V_366 , sizeof( V_360 ) ,
& V_360 ) ;
if ( V_15 < 0 ) {
...
V_15 = F_30 ( V_27 , V_367 , 1 , & type ) ;
if ( V_15 < 0 ) {
V_15 = F_3 ( V_5 , V_27 -> V_55 , V_361 ,
V_3 ) ;
goto V_284;
}
V_15 = F_10 ( V_5 , V_27 -> V_55 , V_361 , 0 ,
NULL , 0 ) ;
V_284:
F_38 ( V_27 ) ;
return V_15 ;
...
F_86 ( L_16 ,
V_20 , V_200 ) ;
return F_3 ( V_5 , V_27 -> V_55 , V_371 ,
V_328 ) ;
}
...
F_146 ( V_27 ) ;
for ( V_42 = 0 ; V_42 < V_199 ; V_42 ++ ) {
struct V_370 * V_206 = & V_107 -> V_207 [ V_42 ] ;
T_1 type ;
if ( V_206 -> V_372 )
type = V_373 ;
else
type = V_374 ;
F_147 ( V_27 , & V_206 -> V_208 . V_125 ,
F_148 ( V_206 -> V_208 . type ) ,
type , 0 , V_206 -> V_375 , V_206 -> V_81 ,
V_206 -> V_376 , V_206 -> V_377 , V_206 -> rand ) ;
}
F_38 ( V_27 ) ;
return 0 ;
}
int F_149 ( struct V_4 * V_5 , struct V_378 * V_379 , T_3 V_380 )
{
void * V_381 ;
T_1 * V_107 ;
struct V_11 * V_12 ;
...
int V_15 ;
F_4 ( L_18 , V_380 ) ;
if ( V_380 < sizeof( * V_12 ) )
return - V_328 ;
V_381 = F_14 ( V_380 , V_43 ) ;
if ( ! V_381 )
return - V_17 ;
if ( F_150 ( V_381 , V_379 -> V_384 , V_380 ) ) {
V_15 = - V_342 ;
goto V_284;
}
V_12 = V_381 ;
...
V_383 = & V_386 [ V_18 ] ;
if ( ( V_383 -> V_389 && V_20 < V_383 -> V_28 ) ||
( ! V_383 -> V_389 && V_20 != V_383 -> V_28 ) ) {
V_15 = F_3 ( V_5 , V_6 , V_18 ,
V_152 ) ;
goto V_284;
}
if ( V_27 )
F_39 ( V_5 , V_27 ) ;
V_107 = V_381 + sizeof( * V_12 ) ;
V_15 = V_383 -> V_387 ( V_5 , V_27 , V_107 , V_20 ) ;
if ( V_15 < 0 )
goto V_284;
V_15 = V_380 ;
V_284:
...
static void F_153 ( struct V_132 * V_7 , void * V_25 )
{
T_1 * V_8 = V_25 ;
...
{
return F_63 ( V_390 , V_27 , NULL , 0 , NULL ) ;
}
int F_155 ( struct V_26 * V_27 )
{
T_1 V_8 = V_385 ;
F_51 ( 0 , V_27 , F_153 , & V_8 ) ;
return F_63 ( V_391 , V_27 , NULL , 0 , NULL ) ;
}
static void F_156 ( struct V_132 * V_7 , void * V_25 )
{
struct V_392 * V_193 = V_25 ;
...
int F_61 ( struct V_26 * V_27 , T_1 V_393 )
{
struct V_392 V_193 = { NULL , V_27 } ;
int V_15 ;
if ( ! F_22 ( V_123 , & V_27 -> V_54 ) )
return 0 ;
F_51 ( V_140 , V_27 , F_156 , & V_193 ) ;
if ( V_393 ) {
T_1 V_150 = 0 ;
if ( F_22 ( V_73 , & V_27 -> V_54 ) )
V_150 |= V_160 ;
...
int F_157 ( struct V_26 * V_27 , T_1 V_394 )
{
struct V_392 V_193 = { NULL , V_27 } ;
bool V_156 = false ;
int V_15 = 0 ;
...
int F_158 ( struct V_26 * V_27 , T_1 V_395 )
{
struct V_392 V_193 = { NULL , V_27 } ;
bool V_156 = false ;
int V_15 = 0 ;
...
int F_159 ( struct V_26 * V_27 , T_1 V_150 , T_1 V_8 )
{
T_1 V_396 = F_1 ( V_8 ) ;
if ( V_150 & V_160 )
F_51 ( V_154 , V_27 ,
...
int F_160 ( struct V_26 * V_27 , struct V_397 * V_206 ,
bool V_398 )
{
struct V_399 V_14 ;
...
memcpy ( V_14 . V_206 . V_81 , V_206 -> V_81 , 16 ) ;
V_14 . V_206 . V_209 = V_206 -> V_209 ;
return F_63 ( V_401 , V_27 , & V_14 , sizeof( V_14 ) , NULL ) ;
}
int F_161 ( struct V_26 * V_27 , struct V_402 * V_206 , T_1 V_398 )
{
struct V_403 V_14 ;
memset ( & V_14 , 0 , sizeof( V_14 ) ) ;
V_14 . V_400 = V_398 ;
F_44 ( & V_14 . V_206 . V_208 . V_125 , & V_206 -> V_125 ) ;
V_14 . V_206 . V_208 . type = F_94 ( V_224 , V_206 -> V_404 ) ;
V_14 . V_206 . V_375 = V_206 -> V_375 ;
V_14 . V_206 . V_376 = V_206 -> V_376 ;
...
return F_63 ( V_405 , V_27 , & V_14 , sizeof( V_14 ) ,
NULL ) ;
}
int F_162 ( struct V_26 * V_27 , T_7 * V_125 , T_1 V_235 ,
T_1 V_210 , T_5 V_164 , T_1 * V_114 , T_1 V_90 ,
T_1 * V_117 )
{
char V_381 [ 512 ] ;
struct V_406 * V_14 = ( void * ) V_381 ;
T_2 V_84 = 0 ;
F_44 ( & V_14 -> V_208 . V_125 , V_125 ) ;
V_14 -> V_208 . type = F_94 ( V_235 , V_210 ) ;
V_14 -> V_164 = F_163 ( V_164 ) ;
if ( V_90 > 0 )
V_84 = F_164 ( V_14 -> V_110 , 0 , V_93 ,
V_114 , V_90 ) ;
if ( V_117 && memcmp ( V_117 , L_20 , 3 ) != 0 )
V_84 = F_164 ( V_14 -> V_110 , V_84 ,
V_407 , V_117 , 3 ) ;
V_14 -> V_84 = F_7 ( V_84 ) ;
return F_63 ( V_408 , V_27 , V_381 ,
sizeof( * V_14 ) + V_84 , NULL ) ;
}
static void F_165 ( struct V_132 * V_7 , void * V_25 )
{
...
int F_167 ( struct V_26 * V_27 , T_7 * V_125 ,
T_1 V_235 , T_1 V_210 )
{
struct V_243 V_14 ;
struct V_4 * V_5 = NULL ;
int V_15 ;
F_51 ( V_230 , V_27 , F_165 , & V_5 ) ;
F_44 ( & V_14 . V_125 , V_125 ) ;
V_14 . type = F_94 ( V_235 , V_210 ) ;
V_15 = F_63 ( V_410 , V_27 , & V_14 , sizeof( V_14 ) ,
V_5 ) ;
if ( V_5 )
F_47 ( V_5 ) ;
F_51 ( V_219 , V_27 , F_166 ,
V_27 ) ;
return V_15 ;
}
int F_168 ( struct V_26 * V_27 , T_7 * V_125 ,
T_1 V_235 , T_1 V_210 , T_1 V_8 )
{
struct V_409 V_21 ;
struct V_132 * V_7 ;
int V_15 ;
...
V_21 . V_208 . type = F_94 ( V_235 , V_210 ) ;
...
int F_169 ( struct V_26 * V_27 , T_7 * V_125 , T_1 V_235 ,
T_1 V_210 , T_1 V_8 )
{
struct V_412 V_14 ;
F_44 ( & V_14 . V_208 . V_125 , V_125 ) ;
V_14 . V_208 . type = F_94 ( V_235 , V_210 ) ;
V_14 . V_8 = F_1 ( V_8 ) ;
return F_63 ( V_413 , V_27 , & V_14 , sizeof( V_14 ) , NULL ) ;
}
int F_170 ( struct V_26 * V_27 , T_7 * V_125 , T_1 V_414 )
{
struct V_415 V_14 ;
F_44 ( & V_14 . V_208 . V_125 , V_125 ) ;
V_14 . V_208 . type = V_220 ;
V_14 . V_414 = V_414 ;
return F_63 ( V_416 , V_27 , & V_14 , sizeof( V_14 ) ,
NULL ) ;
}
int F_171 ( struct V_26 * V_27 , T_7 * V_125 ,
T_1 V_8 )
{
struct V_132 * V_7 ;
struct V_417 V_21 ;
...
V_15 = F_10 ( V_7 -> V_5 , V_27 -> V_55 , V_255 ,
F_1 ( V_8 ) , & V_21 , sizeof( V_21 ) ) ;
F_56 ( V_7 ) ;
return V_15 ;
}
...
F_44 ( & V_21 . V_208 . V_125 , V_125 ) ;
V_21 . V_208 . type = V_220 ;
V_15 = F_10 ( V_7 -> V_5 , V_27 -> V_55 , V_250 ,
F_1 ( V_8 ) , & V_21 , sizeof( V_21 ) ) ;
F_56 ( V_7 ) ;
return V_15 ;
}
int F_173 ( struct V_26 * V_27 , T_7 * V_125 ,
T_1 V_235 , T_1 V_210 , T_6 V_418 ,
T_1 V_419 )
{
struct V_420 V_14 ;
F_4 ( L_4 , V_27 -> V_114 ) ;
...
V_14 . V_419 = V_419 ;
V_14 . V_418 = V_418 ;
return F_63 ( V_421 , V_27 , & V_14 , sizeof( V_14 ) ,
NULL ) ;
}
...
F_44 ( & V_14 . V_208 . V_125 , V_125 ) ;
V_14 . V_208 . type = F_94 ( V_235 , V_210 ) ;
return F_63 ( V_423 , V_27 , & V_14 , sizeof( V_14 ) ,
NULL ) ;
}
static int F_175 ( struct V_26 * V_27 , T_7 * V_125 ,
T_1 V_235 , T_1 V_210 , T_1 V_8 ,
T_1 V_18 )
{
struct V_132 * V_7 ;
...
int F_176 ( struct V_26 * V_27 , T_7 * V_125 ,
T_1 V_235 , T_1 V_210 , T_1 V_8 )
{
return F_175 ( V_27 , V_125 , V_235 , V_210 ,
V_8 , V_289 ) ;
}
...
int F_180 ( struct V_26 * V_27 , T_7 * V_125 , T_1 V_235 ,
T_1 V_210 , T_1 V_8 )
{
struct V_425 V_14 ;
F_44 ( & V_14 . V_208 . V_125 , V_125 ) ;
V_14 . V_208 . type = F_94 ( V_235 , V_210 ) ;
V_14 . V_8 = F_1 ( V_8 ) ;
return F_63 ( V_426 , V_27 , & V_14 , sizeof( V_14 ) , NULL ) ;
}
int F_181 ( struct V_26 * V_27 , T_1 V_8 )
{
struct V_392 V_193 = { NULL , V_27 } ;
bool V_156 = false ;
int V_15 = 0 ;
...
int F_183 ( struct V_26 * V_27 , T_1 V_427 , T_1 V_8 )
{
struct V_392 V_193 = { NULL , V_27 } ;
bool V_156 = false ;
int V_15 = 0 ;
...
static void F_184 ( struct V_132 * V_7 , void * V_25 )
{
struct V_392 * V_193 = V_25 ;
...
int F_185 ( struct V_26 * V_27 , T_1 * V_117 ,
T_1 V_8 )
{
struct V_392 V_193 = { NULL , V_27 , F_1 (status) } ;
int V_15 = 0 ;
F_42 ( V_119 , & V_27 -> V_54 ) ;
F_51 ( V_195 , V_27 , F_184 , & V_193 ) ;
F_51 ( V_186 , V_27 , F_184 , & V_193 ) ;
F_51 ( V_192 , V_27 , F_184 , & V_193 ) ;
if ( ! V_8 )
V_15 = F_63 ( V_428 , V_27 , V_117 ,
3 , NULL ) ;
if ( V_193 . V_5 )
F_47 ( V_193 . V_5 ) ;
return V_15 ;
}
int F_186 ( struct V_26 * V_27 , T_1 * V_114 , T_1 V_8 )
{
struct V_132 * V_7 ;
struct V_301 V_14 ;
bool V_156 = false ;
...
memset ( & V_14 , 0 , sizeof( V_14 ) ) ;
memcpy ( V_14 . V_114 , V_114 , V_429 ) ;
memcpy ( V_14 . V_130 , V_27 -> V_130 , V_430 ) ;
V_7 = F_55 ( V_302 , V_27 ) ;
if ( ! V_7 )
goto V_431;
V_156 = true ;
if ( V_8 ) {
V_15 = F_3 ( V_7 -> V_5 , V_27 -> V_55 , V_302 ,
F_1 ( V_8 ) ) ;
goto V_141;
}
V_15 = F_10 ( V_7 -> V_5 , V_27 -> V_55 , V_302 , 0 , & V_14 ,
sizeof( V_14 ) ) ;
if ( V_15 < 0 )
goto V_141;
V_431:
if ( V_156 )
V_15 = F_63 ( V_303 , V_27 , & V_14 ,
...
int F_187 ( struct V_26 * V_27 , T_1 * V_308 ,
T_1 * V_309 , T_1 V_8 )
{
struct V_132 * V_7 ;
int V_15 ;
...
struct V_432 V_21 ;
memcpy ( V_21 . V_308 , V_308 , sizeof( V_21 . V_308 ) ) ;
memcpy ( V_21 . V_309 , V_309 , sizeof( V_21 . V_309 ) ) ;
...
int F_188 ( struct V_26 * V_27 , T_1 V_427 , T_1 V_8 )
{
struct V_392 V_193 = { NULL , V_27 } ;
bool V_156 = false ;
int V_15 = 0 ;
...
int F_189 ( struct V_26 * V_27 , T_7 * V_125 , T_1 V_235 ,
T_1 V_210 , T_1 * V_117 , T_9 V_433 , T_1 V_434 , T_1
V_435 , T_1 * V_110 , T_2 V_84 )
{
char V_381 [ 512 ] ;
struct V_436 * V_14 = ( void * ) V_381 ;
T_3 V_437 ;
if ( sizeof( * V_14 ) + V_84 + 5 > sizeof( V_381 ) )
return - V_328 ;
...
if ( V_117 && ! F_190 ( V_14 -> V_110 , V_84 , V_407 ) )
V_84 = F_164 ( V_14 -> V_110 , V_84 , V_407 ,
V_117 , 3 ) ;
V_14 -> V_84 = F_7 ( V_84 ) ;
V_437 = sizeof( * V_14 ) + V_84 ;
return F_63 ( V_440 , V_27 , V_14 , V_437 , NULL ) ;
}
int F_191 ( struct V_26 * V_27 , T_7 * V_125 , T_1 V_235 ,
T_1 V_210 , T_9 V_433 , T_1 * V_114 , T_1 V_90 )
{
struct V_436 * V_14 ;
char V_381 [ sizeof( * V_14 ) + V_429 + 2 ] ;
T_2 V_84 ;
V_14 = (struct V_436 * ) V_381 ;
memset ( V_381 , 0 , sizeof( V_381 ) ) ;
F_44 ( & V_14 -> V_208 . V_125 , V_125 ) ;
V_14 -> V_208 . type = F_94 ( V_235 , V_210 ) ;
V_14 -> V_433 = V_433 ;
V_84 = F_164 ( V_14 -> V_110 , 0 , V_93 , V_114 ,
V_90 ) ;
V_14 -> V_84 = F_7 ( V_84 ) ;
return F_63 ( V_440 , V_27 , V_14 ,
sizeof( * V_14 ) + V_84 , NULL ) ;
}
int F_192 ( struct V_26 * V_27 , T_1 V_8 )
{
struct V_132 * V_7 ;
T_1 type ;
int V_15 ;
...
return - V_411 ;
V_15 = F_10 ( V_7 -> V_5 , V_27 -> V_55 , V_7 -> V_18 , F_1 ( V_8 ) ,
& V_27 -> V_317 . type , sizeof( V_27 -> V_317 . type ) ) ;
F_56 ( V_7 ) ;
return V_15 ;
}
int F_194 ( struct V_26 * V_27 , T_1 V_441 )
{
struct V_442 V_14 ;
struct V_132 * V_7 ;
F_4 ( L_22 , V_27 -> V_114 , V_441 ) ;
if ( V_441 )
V_7 = F_55 ( V_315 , V_27 ) ;
else
V_7 = F_55 ( V_335 , V_27 ) ;
if ( V_7 != NULL ) {
T_1 type = V_27 -> V_317 . type ;
F_10 ( V_7 -> V_5 , V_27 -> V_55 , V_7 -> V_18 , 0 , & type ,
sizeof( type ) ) ;
F_56 ( V_7 ) ;
}
memset ( & V_14 , 0 , sizeof( V_14 ) ) ;
V_14 . type = V_27 -> V_317 . type ;
V_14 . V_441 = V_441 ;
return F_63 ( V_443 , V_27 , & V_14 , sizeof( V_14 ) , NULL ) ;
}
int F_195 ( struct V_26 * V_27 , T_7 * V_125 , T_1 type )
{
struct V_132 * V_7 ;
struct V_444 V_14 ;
V_7 = F_55 ( V_351 , V_27 ) ;
...
return F_63 ( V_445 , V_27 , & V_14 , sizeof( V_14 ) ,
V_7 ? V_7 -> V_5 : NULL ) ;
}
...
F_44 ( & V_14 . V_208 . V_125 , V_125 ) ;
V_14 . V_208 . type = type ;
return F_63 ( V_447 , V_27 , & V_14 , sizeof( V_14 ) ,
V_7 ? V_7 -> V_5 : NULL ) ;
}
