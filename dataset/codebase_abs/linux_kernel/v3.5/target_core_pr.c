...
V_179 = V_2 -> V_143 ;
if ( V_2 -> V_5 )
snprintf ( V_244 , 32 , L_86 ,
V_2 -> V_6 ) ;
if ( V_15 -> V_118 == V_2 ) {
snprintf ( V_243 , 512 , L_87
L_88
L_89
L_90
L_91
...
snprintf ( V_243 , 512 , L_100
L_101
L_102 , V_51 -> V_57 -> V_58 () ,
V_51 -> V_57 -> V_180 ( V_51 ) ,
...
snprintf ( V_259 , 512 , L_106 , & V_250 -> V_260 [ 0 ] ) ;
V_251 = F_73 ( V_259 , V_255 , 0600 ) ;
if ( F_74 ( V_251 ) || ! V_251 || ! V_251 -> V_261 ) {
F_10 ( L_107
L_79 , V_259 ) ;
return F_74 ( V_251 ) ? F_75 ( V_251 ) : - V_262 ;
}
V_253 [ 0 ] . V_263 = & V_3 [ 0 ] ;
if ( ! V_131 )
...
V_254 = F_76 () ;
F_77 ( F_78 () ) ;
V_20 = F_79 ( V_251 , & V_253 [ 0 ] , 1 , & V_251 -> V_265 ) ;
F_77 ( V_254 ) ;
if ( V_20 < 0 ) {
F_12 ( L_108 , V_259 ) ;
F_80 ( V_251 , NULL ) ;
...
V_3 = NULL ;
F_12 ( L_200
L_201 , V_293 -> V_58 () , ( V_227 != NULL ) ?
L_202 : L_203 , V_295 , ( V_227 != NULL ) ?
V_227 : L_29 ) ;
V_120 = V_2 -> V_120 ;
V_298 = ( ! strcmp ( V_295 ,
V_120 -> V_63 ) ) ? 1 : 0 ;
...
L_213 , V_293 -> V_58 () ,
V_211 -> V_63 ) ;
V_212 = F_68 ( V_211 , V_299 ) ;
if ( ! V_212 ) {
F_10 ( L_214
L_192 , V_293 -> V_58 () , V_299 ) ;
V_8 -> V_47 = V_236 ;
V_20 = - V_24 ;
goto V_54;
}
