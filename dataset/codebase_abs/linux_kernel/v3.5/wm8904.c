...
{
return F_4 ( V_108 , V_4 , 0 ) ;
}
static int F_5 ( struct V_107 * V_108 )
{
struct V_109 * V_110 = F_6 ( V_108 ) ;
unsigned int V_111 , V_112 , V_113 ;
V_112 = F_7 ( V_108 , V_26 ) ;
F_8 ( V_108 , V_26 ,
V_114 , 0 ) ;
switch ( V_110 -> V_115 ) {
case V_116 :
F_9 ( V_108 -> V_2 , L_1 , V_110 -> V_117 ) ;
V_112 &= ~ V_114 ;
V_113 = V_110 -> V_117 ;
F_8 ( V_108 , V_65 ,
V_118 | V_119 , 0 ) ;
...
F_8 ( V_108 , V_24 , V_123 ,
V_111 ) ;
F_8 ( V_108 , V_26 ,
V_125 | V_114 , V_112 ) ;
F_9 ( V_108 -> V_2 , L_4 , V_110 -> V_124 ) ;
return 0 ;
}
static void F_11 ( struct V_107 * V_108 )
{
struct V_109 * V_110 = F_6 ( V_108 ) ;
struct V_126 * V_127 = V_110 -> V_127 ;
int V_128 , V_129 ;
V_128 = F_7 ( V_108 , V_39 ) ;
for ( V_129 = 0 ; V_129 < V_130 ; V_129 ++ )
F_8 ( V_108 , V_39 + V_129 , 0xffff ,
...
static void F_15 ( struct V_107 * V_108 )
{
struct V_109 * V_110 = F_6 ( V_108 ) ;
struct V_126 * V_127 = V_110 -> V_127 ;
...
V_110 -> V_154 ) ;
V_128 = F_7 ( V_108 , V_78 ) ;
for ( V_129 = 0 ; V_129 < V_155 ; V_129 ++ )
F_8 ( V_108 , V_78 + V_129 , 0xffff ,
V_127 -> V_151 [ V_144 ] . V_133 [ V_129 ] ) ;
F_8 ( V_108 , V_78 , V_156 , V_128 ) ;
}
static int F_16 ( struct V_136 * V_137 ,
struct V_138 * V_139 )
{
struct V_107 * V_108 = F_13 ( V_137 ) ;
struct V_109 * V_110 = F_6 ( V_108 ) ;
...
static int F_17 ( struct V_136 * V_137 ,
struct V_138 * V_139 )
{
struct V_107 * V_108 = F_13 ( V_137 ) ;
struct V_109 * V_110 = F_6 ( V_108 ) ;
...
static int F_18 ( struct V_107 * V_108 )
{
struct V_109 * V_110 = F_6 ( V_108 ) ;
int V_157 , V_129 , V_144 ;
if ( V_110 -> V_158 ) {
V_144 = 1 ;
for ( V_129 = 2 ; V_129 < F_19 ( V_159 ) ; V_129 ++ ) {
...
F_9 ( V_108 -> V_2 , L_6 , V_157 ) ;
return F_8 ( V_108 , V_34 ,
V_161 , V_157 ) ;
}
...
static int F_21 ( struct V_136 * V_137 ,
struct V_138 * V_139 )
{
struct V_107 * V_108 = F_13 ( V_137 ) ;
struct V_109 * V_110 = F_6 ( V_108 ) ;
...
static int F_22 ( struct V_136 * V_137 ,
struct V_138 * V_139 )
{
struct V_107 * V_108 = F_13 ( V_137 ) ;
unsigned int V_157 ;
int V_162 ;
V_162 = F_23 ( V_137 , V_139 ) ;
if ( V_162 < 0 )
return V_162 ;
...
static int F_24 ( struct V_165 * V_166 ,
...
static int F_28 ( struct V_165 * V_166 ,
struct V_136 * V_137 , int V_167 )
{
struct V_107 * V_108 = V_166 -> V_108 ;
struct V_109 * V_110 = F_6 ( V_108 ) ;
...
break;
case V_170 :
V_110 -> V_189 [ V_172 ] = F_7 ( V_108 , V_174 ) ;
V_110 -> V_189 [ V_173 ] = F_7 ( V_108 , V_175 ) ;
F_8 ( V_108 , V_52 ,
V_171 , 0 ) ;
F_8 ( V_108 , V_3 ,
V_185 | V_186 |
...
F_9 ( V_108 -> V_2 , L_12 , V_110 -> V_228 ) ;
V_162 = F_5 ( V_108 ) ;
if ( V_162 != 0 )
return V_162 ;
V_144 = 0 ;
...
- V_110 -> V_154 ) ;
for ( V_129 = 1 ; V_129 < F_19 ( V_233 ) ; V_129 ++ ) {
...
for ( V_129 = 1 ; V_129 < F_19 ( V_237 ) ; V_129 ++ ) {
...
V_144 = 0 ;
V_145 = V_149 ;
for ( V_129 = 0 ; V_129 < F_19 ( V_241 ) ; V_129 ++ ) {
...
F_9 ( V_108 -> V_2 , L_16 , V_110 -> V_228 / V_110 -> V_154 ) ;
...
static int F_42 ( struct V_218 * V_219 , int V_248 ,
unsigned int V_249 , int V_250 )
{
struct V_107 * V_108 = V_219 -> V_108 ;
struct V_109 * V_251 = F_6 ( V_108 ) ;
switch ( V_248 ) {
case V_116 :
V_251 -> V_115 = V_248 ;
V_251 -> V_117 = V_249 ;
...
F_9 ( V_219 -> V_2 , L_17 , V_248 , V_249 ) ;
F_5 ( V_108 ) ;
return 0 ;
}
static int F_43 ( struct V_218 * V_219 , unsigned int V_252 )
{
struct V_107 * V_108 = V_219 -> V_108 ;
unsigned int V_221 = 0 ;
unsigned int V_223 = 0 ;
...
static int F_44 ( struct V_218 * V_219 , unsigned int V_274 ,
...
static int F_45 ( struct V_283 * V_284 , unsigned int V_285 ,
unsigned int V_286 )
{
T_1 V_287 ;
...
V_284 -> V_293 = div - 1 ;
F_47 ( L_21 , V_291 ) ;
for ( V_129 = 0 ; V_129 < F_19 ( V_294 ) ; V_129 ++ ) {
...
static int F_49 ( struct V_218 * V_219 , int V_301 , int V_302 ,
...
break;
default:
F_10 ( V_108 -> V_2 , L_27 , V_301 ) ;
return - V_122 ;
}
V_303 = F_7 ( V_108 , V_65 ) ;
F_8 ( V_108 , V_26 ,
V_125 , 0 ) ;
F_8 ( V_108 , V_65 ,
V_118 | V_119 , 0 ) ;
...
( V_284 . V_293 << V_316 ) |
( V_284 . V_297 << V_317 ) ) ;
F_4 ( V_108 , V_67 , V_284 . V_300 ) ;
F_8 ( V_108 , V_68 , V_318 ,
V_284 . V_298 << V_319 ) ;
F_8 ( V_108 , V_69 ,
V_320 ,
V_284 . V_292
<< V_321 ) ;
F_9 ( V_108 -> V_2 , L_28 , V_285 , V_286 ) ;
V_110 -> V_305 = V_285 ;
V_110 -> V_121 = V_286 ;
V_110 -> V_304 = V_302 ;
F_8 ( V_108 , V_65 ,
...
static int F_50 ( struct V_218 * V_322 , int V_323 )
{
...
F_8 ( V_108 , V_13 ,
V_338 , 0 ) ;
F_53 ( V_110 -> V_337 , true ) ;
F_55 ( V_110 -> V_337 ) ;
F_56 ( F_19 ( V_110 -> V_336 ) ,
V_110 -> V_336 ) ;
break;
}
...
F_9 ( V_108 -> V_2 , L_33 , V_127 -> V_141 ) ;
if ( V_127 -> V_141 ) {
struct V_340 V_341 =
F_60 ( L_34 , V_110 -> V_348 ,
F_14 , F_12 ) ;
V_110 -> V_349 = F_63 ( sizeof( char * )
* V_127 -> V_141 , V_345 ) ;
if ( ! V_110 -> V_349 ) {
F_10 ( V_108 -> V_2 ,
L_35 ,
...
V_162 = F_65 ( V_108 , 8 , 16 , V_353 ) ;
if ( V_162 != 0 ) {
F_10 ( V_108 -> V_2 , L_39 , V_162 ) ;
return V_162 ;
}
for ( V_129 = 0 ; V_129 < F_19 ( V_110 -> V_336 ) ; V_129 ++ )
V_110 -> V_336 [ V_129 ] . V_354 = V_355 [ V_129 ] ;
V_162 = F_66 ( V_108 -> V_2 , F_19 ( V_110 -> V_336 ) ,
V_110 -> V_336 ) ;
if ( V_162 != 0 ) {
F_10 ( V_108 -> V_2 , L_40 , V_162 ) ;
return V_162 ;
}
V_162 = F_52 ( F_19 ( V_110 -> V_336 ) ,
V_110 -> V_336 ) ;
if ( V_162 != 0 ) {
F_10 ( V_108 -> V_2 , L_29 , V_162 ) ;
goto V_356;
}
V_162 = F_7 ( V_108 , V_4 ) ;
if ( V_162 < 0 ) {
...
V_366 , 0 ) ;
if ( V_110 -> V_127 ) {
for ( V_129 = 0 ; V_129 < V_367 ; V_129 ++ ) {
if ( ! V_127 -> V_368 [ V_129 ] )
continue;
F_68 ( V_110 -> V_337 ,
V_70 + V_129 ,
0xffff ,
...
V_372 , 0 ) ;
F_51 ( V_108 , V_333 ) ;
F_56 ( F_19 ( V_110 -> V_336 ) , V_110 -> V_336 ) ;
F_62 ( V_108 ) ;
F_32 ( V_108 ) ;
return 0 ;
V_357:
F_56 ( F_19 ( V_110 -> V_336 ) , V_110 -> V_336 ) ;
V_356:
F_69 ( F_19 ( V_110 -> V_336 ) , V_110 -> V_336 ) ;
return V_162 ;
}
...
static T_2 int F_72 ( struct V_373 * V_374 ,
const struct V_375 * V_376 )
{
struct V_109 * V_110 ;
int V_162 ;
V_110 = F_73 ( & V_374 -> V_2 , sizeof( struct V_109 ) ,
V_345 ) ;
if ( V_110 == NULL )
return - V_377 ;
V_110 -> V_337 = F_74 ( V_374 , & V_378 ) ;
if ( F_75 ( V_110 -> V_337 ) ) {
V_162 = F_76 ( V_110 -> V_337 ) ;
F_10 ( & V_374 -> V_2 , L_46 ,
V_162 ) ;
return V_162 ;
}
V_110 -> V_201 = V_376 -> V_379 ;
F_77 ( V_374 , V_110 ) ;
V_110 -> V_127 = V_374 -> V_2 . V_380 ;
V_162 = F_78 ( & V_374 -> V_2 ,
& V_381 , & V_351 , 1 ) ;
if ( V_162 != 0 )
goto V_382;
return 0 ;
...
static T_3 int F_80 ( struct V_373 * V_383 )
{
struct V_109 * V_110 = F_81 ( V_383 ) ;
F_82 ( & V_383 -> V_2 ) ;
F_79 ( V_110 -> V_337 ) ;
return 0 ;
}
