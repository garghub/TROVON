...
{
V_39 -> V_40 -> V_41 = 0 ;
V_39 -> V_40 -> V_41 &= ~ ( V_42 | V_43 | V_44 | V_45 | V_46 ) ;
V_39 -> V_40 -> V_47 = V_48 | V_49 | V_50 ;
V_39 -> V_40 -> V_51 &= ~ V_52 ;
}
static int F_13 ( struct V_38 * V_39 , struct V_53 * V_29 )
{
int V_54 = 0 ;
struct V_4 * V_5 ;
unsigned char * V_55 ;
...
static void F_20 ( struct V_53 * V_29 )
{
if ( V_29 -> V_58 ) {
F_21 ( V_29 -> V_58 ) ;
F_10 ( V_29 -> V_58 -> V_55 ) ;
...
{
int V_54 ;
struct V_53 * V_29 = V_76 -> V_77 ;
struct V_38 * V_39 ;
unsigned char * V_78 = V_76 -> V_55 ;
int V_79 = V_76 -> V_79 ;
if ( V_79 ) {
F_7 ( L_16 ,
V_33 , V_29 -> V_59 , V_79 ) ;
...
static int F_29 ( struct V_38 * V_39 , struct V_53 * V_29 ,
...
struct V_53 * V_29 , struct V_105 * V_106 )
{
struct V_4 * V_5 ;
int V_54 ;
unsigned short V_107 = 0 ;
int V_108 = V_39 -> V_40 -> V_108 ;
T_1 V_109 ;
V_5 = F_11 ( V_29 ) ;
if ( V_5 -> V_20 == V_27 ||
V_5 -> V_20 == V_28 ) {
...
V_107 |= V_116 ;
V_39 -> V_40 -> V_108 &= ~ V_117 ;
F_39 ( V_39 , V_109 , V_109 ) ;
V_54 = F_17 ( V_29 -> V_2 -> V_21 ,
F_18 ( V_29 -> V_2 -> V_21 , 0 ) ,
V_67 ,
V_61 | V_62 | V_68 ,
...
F_7 ( L_26 , V_33 , V_29 -> V_59 , V_54 ) ;
F_10 ( V_55 ) ;
return ( V_54 < 0 ) ? - V_123 : 0 ;
default:
return - V_120 ;
}
}
