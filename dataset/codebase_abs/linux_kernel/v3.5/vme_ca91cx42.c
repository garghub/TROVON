...
V_295 = F_81 ( sizeof( struct V_1 ) , V_206 ) ;
if ( V_295 == NULL ) {
F_8 ( & V_47 -> V_48 , L_41
L_23 ) ;
V_116 = - V_125 ;
...
V_294 = F_7 ( V_295 -> V_19 + V_303 ) & 0x0000FFFF ;
if ( V_294 != V_304 ) {
F_8 ( & V_47 -> V_48 , L_45 ) ;
V_116 = - V_302 ;
goto V_305;
...
V_296 = F_35 ( sizeof( struct V_114 ) ,
V_206 ) ;
if ( V_296 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_48 ) ;
...
V_296 -> V_310 = 0 ;
V_296 -> V_82 = V_6 ;
V_296 -> V_311 = V_83 | V_85 | V_87 |
V_94 | V_89 | V_91 ;
V_296 -> V_312 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
V_296 -> V_313 = V_147 | V_149 | V_151 | V_153 ;
memset ( & V_296 -> V_117 , 0 ,
sizeof( struct V_122 ) ) ;
V_296 -> V_120 = NULL ;
F_54 ( & V_296 -> V_194 ,
& V_16 -> V_307 ) ;
...
V_297 -> V_310 = 0 ;
V_297 -> V_82 = V_6 ;
V_297 -> V_311 = V_85 | V_87 | V_89 |
V_91 ;
if ( V_6 == 0 || V_6 == 4 )
V_297 -> V_311 |= V_83 ;
V_297 -> V_312 = V_171 | V_142 | V_144 |
V_105 | V_107 | V_109 | V_111 ;
F_54 ( & V_297 -> V_194 ,
& V_16 -> V_314 ) ;
}
...
V_298 = F_35 ( sizeof( struct V_239 ) ,
V_206 ) ;
if ( V_298 == NULL ) {
F_8 ( & V_47 -> V_48 , L_47
L_50 ) ;
...
V_16 -> V_343 = F_71 ;
V_16 -> V_344 = F_73 ;
V_294 = F_7 ( V_295 -> V_19 + V_345 ) ;
F_78 ( & V_47 -> V_48 , L_52 ,
( V_294 & V_346 ) ? L_53 : L_54 ) ;
F_78 ( & V_47 -> V_48 , L_55 ,
F_70 ( V_16 ) ) ;
if ( F_77 ( V_16 , V_47 ) )
F_8 ( & V_47 -> V_48 , L_56 ) ;
...
V_298 = F_55 ( V_259 , struct V_239 , V_194 ) ;
F_62 ( V_259 ) ;
F_33 ( V_298 ) ;
}
V_316:
F_89 (pos, &ca91cx42_bridge->slave_resources) {
V_297 = F_55 ( V_259 , struct V_69 , V_194 ) ;
F_62 ( V_259 ) ;
F_33 ( V_297 ) ;
}
V_309:
F_89 (pos, &ca91cx42_bridge->master_resources) {
V_296 = F_55 ( V_259 , struct V_114 ,
V_194 ) ;
F_62 ( V_259 ) ;
F_33 ( V_296 ) ;
}
