...
static int F_92 ( struct V_26 * V_8 , unsigned int V_164 ,
unsigned long V_165 )
{
return - V_166 ;
}
static int F_93 ( struct V_26 * V_8 , int V_167 , int V_168 ,
...
int V_10 = - V_57 ;
F_22 ( V_9 ) ;
if ( F_8 ( V_167 != V_118 || V_170 != sizeof( int ) ) )
goto V_42;
V_10 = F_94 ( V_171 , ( int T_6 * ) V_169 ) ;
if ( V_10 )
goto V_42;
V_10 = - V_57 ;
switch ( V_168 ) {
...
static int F_95 ( struct V_26 * V_8 , int V_167 , int V_168 ,
char T_6 * V_169 , int T_6 * V_170 )
{
struct V_8 * V_9 = V_8 -> V_9 ;
struct V_20 * V_21 = F_7 ( V_9 ) ;
int V_197 = 0 , V_127 = 0 , V_10 = - V_57 ;
F_22 ( V_9 ) ;
if ( F_8 ( V_167 != V_118 ) )
goto V_42;
V_10 = F_94 ( V_127 , V_170 ) ;
if ( V_10 )
goto V_42;
V_10 = - V_57 ;
if ( V_127 != sizeof( int ) )
...
V_10 = 0 ;
if ( F_96 ( V_127 , V_170 ) || F_97 ( V_169 , & V_197 , V_127 ) )
V_10 = - V_149 ;
V_42:
F_28 ( V_9 ) ;
return V_10 ;
