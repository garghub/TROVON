...
V_8 -> V_80 . V_81 [ V_118 ] . V_127 = 0 ;
break;
} else if ( V_8 -> V_80 . V_81 [ V_118 ] . V_82 < 0 ) {
break;
} else if ( V_118 >= V_2 -> V_128 ) {
V_8 -> V_80 . V_81 [ V_118 ] . V_82 = - 1 ;
V_8 -> V_80 . V_81 [ V_118 ] . V_127 = 0 ;
break;
}
V_86 += V_8 -> V_80 . V_81 [ V_118 ] . V_127 ;
}
V_119 = V_118 - 1 ;
if ( V_86 < 0 )
V_86 = 0 ;
F_39 () ;
V_85 = V_6 -> V_2 . V_48 -> V_129 [ V_8 -> V_130 ] ;
V_115 = V_22 -> V_33 ;
F_40 (local, hdr->addr1, sta, tmp) {
if ( ! F_41 ( V_22 -> V_131 , V_20 -> V_28 -> V_27 . V_49 ) )
continue;
if ( V_8 -> V_12 & V_132 )
F_42 ( V_20 , V_133 ) ;
V_121 = ! ! ( V_8 -> V_12 & V_98 ) ;
...
( V_119 != - 1 ) )
V_20 -> V_135 = V_8 -> V_80 . V_81 [ V_119 ] ;
if ( ( V_8 -> V_12 & V_136 ) &&
( F_12 ( V_115 ) ) ) {
T_2 V_36 , V_77 ;
T_1 * V_58 ;
...
if ( V_165 -> type != V_166 )
continue;
if ( V_165 -> V_167 . V_168 != V_4 )
continue;
V_165 -> V_167 . V_80 = true ;
break;
}
F_43 () ;
if ( V_6 -> V_169 == V_4 ) {
...
F_61 (
V_4 -> V_150 , V_163 , V_4 -> V_23 , V_4 -> V_78 ,
! ! ( V_8 -> V_12 & V_98 ) ,
V_151 ) ;
}
}
...
F_68 ( V_4 ) ;
V_120 = ! ! ( V_8 -> V_12 & V_146 ) ||
! ( F_53 ( V_115 ) ) ;
if ( ! V_6 -> V_175 && ( ! V_120 || ! V_6 -> V_176 ) ) {
F_24 ( V_4 ) ;
return;
}
V_87 = F_32 ( V_8 ) ;
...
void F_77 ( struct V_187 * V_188 , T_5 V_189 )
{
struct V_19 * V_20 = F_78 ( V_188 , struct V_19 , V_20 ) ;
F_50 ( V_20 -> V_28 -> V_150 , V_20 -> V_20 . V_49 ,
V_189 , V_151 ) ;
}
