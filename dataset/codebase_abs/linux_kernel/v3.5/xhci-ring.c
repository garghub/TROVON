...
if ( F_123 ( & V_223 -> V_67 -> V_50 -> V_69 ) )
V_120 = F_110 ( V_10 , V_223 , V_224 , V_107 , V_50 ,
& V_91 ) ;
else if ( F_122 ( & V_223 -> V_67 -> V_50 -> V_69 ) )
...
T_7 F_126 ( struct V_93 * V_94 )
{
struct V_9 * V_10 = F_127 ( V_94 ) ;
T_2 V_91 ;
union V_3 * V_4 ;
T_5 V_283 ;
union V_3 * V_284 ;
...
F_15 ( V_10 , L_140
L_141 ) ;
V_283 = F_128 ( V_10 , & V_10 -> V_291 -> V_293 ) ;
F_129 ( V_10 , V_283 | V_294 ,
& V_10 -> V_291 -> V_293 ) ;
F_43 ( & V_10 -> V_105 ) ;
return V_295 ;
}
...
V_283 |= V_294 ;
F_129 ( V_10 , V_283 , & V_10 -> V_291 -> V_293 ) ;
F_43 ( & V_10 -> V_105 ) ;
return V_295 ;
}
T_7 F_130 ( int V_289 , struct V_93 * V_94 )
{
return F_126 ( V_94 ) ;
}
static void F_131 ( struct V_9 * V_10 , struct V_11 * V_12 ,
bool V_28 ,
...
static int F_132 ( struct V_9 * V_10 , struct V_11 * V_75 ,
...
F_135 ( & V_223 -> V_113 ) ;
if ( V_309 == 0 ) {
V_120 = F_136 ( F_38 ( V_67 -> V_68 -> V_98 ) , V_67 ) ;
if ( F_48 ( V_120 ) )
return V_120 ;
}
V_223 -> V_67 = V_67 ;
F_137 ( & V_223 -> V_58 , & V_75 -> V_58 ) ;
V_223 -> V_63 = V_75 -> V_33 ;
V_223 -> V_86 = V_75 -> V_20 ;
V_95 -> V_223 [ V_309 ] = V_223 ;
return 0 ;
}
static unsigned int F_138 ( struct V_9 * V_10 , struct V_67 * V_67 )
{
...
V_191 = V_67 -> V_241 ;
V_39 = 0 ;
F_139 (urb->sg, sg, num_sgs, i) {
unsigned int V_248 = F_140 ( V_313 ) ;
V_311 = V_315 -
( F_141 ( V_313 ) & ( V_315 - 1 ) ) ;
V_311 &= V_315 - 1 ;
if ( V_311 != 0 )
V_39 ++ ;
while ( V_311 < F_140 ( V_313 ) && V_311 < V_191 ) {
V_39 ++ ;
V_311 += V_315 ;
}
V_248 = F_142 ( int , V_248 , V_191 ) ;
V_191 -= V_248 ;
if ( V_191 == 0 )
break;
}
...
static void F_143 ( struct V_67 * V_67 , int V_39 , int V_311 )
{
if ( V_39 != 0 )
F_144 ( & V_67 -> V_68 -> V_68 , L_153
L_154 , V_316 ,
V_67 -> V_50 -> V_69 . V_261 , V_39 ) ;
if ( V_311 != V_67 -> V_241 )
F_144 ( & V_67 -> V_68 -> V_68 , L_155
L_156 ,
V_316 ,
...
static void F_145 ( struct V_9 * V_10 , int V_45 ,
...
int F_146 ( struct V_9 * V_10 , T_8 V_301 ,
...
return F_150 ( V_10 , V_301 , V_67 , V_45 , V_46 ) ;
}
static T_2 F_151 ( unsigned int V_323 )
{
...
static T_2 F_152 ( int V_311 , int V_325 ,
...
return 0 ;
V_327 = ( V_311 + V_325 ) /
F_153 ( & V_67 -> V_50 -> V_69 ) ;
return F_151 ( V_326 - V_327 ) ;
}
static int F_154 ( struct V_9 * V_10 , T_8 V_301 ,
struct V_67 * V_67 , int V_45 , unsigned int V_46 )
{
struct V_11 * V_75 ;
unsigned int V_39 ;
...
if ( ! V_75 )
return - V_305 ;
V_39 = F_138 ( V_10 , V_67 ) ;
V_310 = V_67 -> V_314 ;
V_326 = F_155 ( V_67 -> V_241 ,
F_153 ( & V_67 -> V_50 -> V_69 ) ) ;
V_325 = F_134 ( V_10 , V_10 -> V_51 [ V_45 ] ,
V_46 , V_67 -> V_47 ,
V_39 , V_67 , 0 , V_301 ) ;
if ( V_325 < 0 )
return V_325 ;
...
V_311 = 0 ;
V_313 = V_67 -> V_313 ;
V_21 = ( T_5 ) F_141 ( V_313 ) ;
V_328 = F_140 ( V_313 ) ;
V_325 = V_315 - ( V_21 & ( V_315 - 1 ) ) ;
V_325 = F_142 ( int , V_325 , V_328 ) ;
if ( V_325 > V_67 -> V_241 )
V_325 = V_67 -> V_241 ;
V_86 = true ;
do {
...
F_143 ( V_67 , V_39 , V_311 ) ;
F_145 ( V_10 , V_45 , V_46 , V_67 -> V_47 ,
V_317 , V_217 ) ;
return 0 ;
}
int F_150 ( struct V_9 * V_10 , T_8 V_301 ,
struct V_67 * V_67 , int V_45 , unsigned int V_46 )
{
struct V_11 * V_75 ;
struct V_95 * V_95 ;
...
T_5 V_21 ;
if ( V_67 -> V_310 )
return F_154 ( V_10 , V_301 , V_67 , V_45 , V_46 ) ;
V_75 = F_25 ( V_10 , V_67 ) ;
if ( ! V_75 )
return - V_305 ;
V_39 = 0 ;
...
V_120 = F_134 ( V_10 , V_10 -> V_51 [ V_45 ] ,
V_46 , V_67 -> V_47 ,
V_39 , V_67 , 0 , V_301 ) ;
if ( V_120 < 0 )
return V_120 ;
...
int F_159 ( struct V_9 * V_10 , T_8 V_301 ,
struct V_67 * V_67 , int V_45 , unsigned int V_46 )
{
struct V_11 * V_75 ;
int V_39 ;
...
F_131 ( V_10 , V_75 , true ,
V_336 -> V_340 | V_336 -> V_344 << 8 | F_161 ( V_336 -> V_345 ) << 16 ,
F_161 ( V_336 -> V_346 ) | F_161 ( V_336 -> V_347 ) << 16 ,
F_111 ( 8 ) | F_157 ( 0 ) ,
V_31 ) ;
if ( F_156 ( V_67 ) )
...
V_31 = V_349 ;
F_131 ( V_10 , V_75 , false ,
0 ,
0 ,
F_157 ( 0 ) ,
V_31 | V_330 | F_32 ( V_350 ) | V_75 -> V_27 ) ;
F_145 ( V_10 , V_45 , V_46 , 0 ,
V_317 , V_217 ) ;
return 0 ;
}
...
static int F_166 ( struct V_9 * V_10 , T_8 V_301 ,
struct V_67 * V_67 , int V_45 , unsigned int V_46 )
{
struct V_11 * V_75 ;
struct V_95 * V_95 ;
...
if ( V_326 == 0 )
V_326 ++ ;
V_363 = F_164 ( V_10 , V_67 -> V_68 , V_67 ,
V_326 ) ;
V_357 = F_165 ( V_10 ,
V_67 -> V_68 , V_67 , V_326 ) ;
V_359 = F_162 ( V_10 , V_67 , V_121 ) ;
V_120 = F_134 ( V_10 , V_10 -> V_51 [ V_45 ] , V_46 ,
...
int F_170 ( struct V_9 * V_10 , T_8 V_301 ,
struct V_67 * V_67 , int V_45 , unsigned int V_46 )
{
struct V_74 * V_233 ;
struct V_11 * V_75 ;
...
V_358 = V_67 -> V_362 ;
for ( V_121 = 0 ; V_121 < V_358 ; V_121 ++ )
V_39 += F_162 ( V_10 , V_67 , V_121 ) ;
V_120 = F_132 ( V_10 , V_75 , F_3 ( V_77 -> V_137 ) & V_138 ,
V_39 , V_301 ) ;
if ( V_120 )
return V_120 ;
...
return F_166 ( V_10 , V_301 , V_67 , V_45 , V_46 ) ;
}
static int F_171 ( struct V_9 * V_10 , T_2 V_297 , T_2 V_298 ,
...
if ( ! V_371 )
V_372 ++ ;
V_120 = F_132 ( V_10 , V_10 -> V_112 , V_307 ,
V_372 , V_374 ) ;
if ( V_120 < 0 ) {
F_117 ( V_10 , L_166 ) ;
if ( V_371 )
...
F_131 ( V_10 , V_10 -> V_112 , false , V_297 , V_298 , V_299 ,
V_300 | V_10 -> V_112 -> V_27 ) ;
return 0 ;
}
int F_172 ( struct V_9 * V_10 , T_2 V_177 , T_2 V_45 )
{
return F_171 ( V_10 , 0 , 0 , 0 ,
F_32 ( V_177 ) | F_173 ( V_45 ) , false ) ;
}
int F_174 ( struct V_9 * V_10 , T_1 V_375 ,
T_2 V_45 )
{
return F_171 ( V_10 , F_118 ( V_375 ) ,
F_119 ( V_375 ) , 0 ,
F_32 ( V_169 ) | F_173 ( V_45 ) ,
false ) ;
}
int F_175 ( struct V_9 * V_10 ,
T_2 V_297 , T_2 V_298 , T_2 V_299 , T_2 V_300 )
{
return F_171 ( V_10 , V_297 , V_298 , V_299 , V_300 , false ) ;
}
int F_176 ( struct V_9 * V_10 , T_2 V_45 )
{
return F_171 ( V_10 , 0 , 0 , 0 ,
F_32 ( V_174 ) | F_173 ( V_45 ) ,
false ) ;
}
...
return F_171 ( V_10 , F_118 ( V_375 ) ,
F_119 ( V_375 ) , 0 ,
F_32 ( V_161 ) | F_173 ( V_45 ) ,
V_371 ) ;
}
int F_177 ( struct V_9 * V_10 , T_1 V_375 ,
T_2 V_45 , bool V_371 )
{
return F_171 ( V_10 , F_118 ( V_375 ) ,
F_119 ( V_375 ) , 0 ,
F_32 ( V_168 ) | F_173 ( V_45 ) ,
V_371 ) ;
}
int F_178 ( struct V_9 * V_10 , int V_45 ,
unsigned int V_46 , int V_376 )
{
T_2 V_377 = F_173 ( V_45 ) ;
T_2 V_378 = F_179 ( V_46 ) ;
T_2 type = F_32 ( V_170 ) ;
T_2 V_379 = F_180 ( V_376 ) ;
return F_171 ( V_10 , 0 , 0 , 0 ,
...
V_50 -> V_141 = V_24 ;
V_50 -> V_130 = V_380 ;
return F_171 ( V_10 , F_118 ( V_21 ) | V_27 ,
F_119 ( V_21 ) , V_381 ,
...
T_2 V_378 = F_179 ( V_46 ) ;
T_2 type = F_32 ( V_173 ) ;
return F_171 ( V_10 , 0 , 0 , 0 , V_377 | V_378 | type ,
false ) ;
}
