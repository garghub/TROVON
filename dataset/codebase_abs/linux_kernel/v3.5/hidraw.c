...
static long F_32 ( struct V_1 * V_1 , unsigned int V_62 ,
unsigned long V_63 )
{
...
switch ( V_62 ) {
case V_65 :
if ( F_33 ( V_34 -> V_38 -> V_66 , ( int T_2 * ) V_63 ) )
V_8 = - V_26 ;
break;
case V_67 :
{
T_7 V_9 ;
if ( F_34 ( V_9 , ( int T_2 * ) V_63 ) )
V_8 = - V_26 ;
else if ( V_9 > V_68 - 1 )
V_8 = - V_41 ;
else if ( F_10 ( V_64 + F_35 (
struct V_69 ,
V_25 [ 0 ] ) ,
V_34 -> V_38 -> V_70 ,
F_36 ( V_34 -> V_38 -> V_66 , V_9 ) ) )
V_8 = - V_26 ;
break;
}
case V_71 :
{
struct V_72 V_73 ;
V_73 . V_74 = V_34 -> V_38 -> V_75 ;
V_73 . V_76 = V_34 -> V_38 -> V_76 ;
V_73 . V_77 = V_34 -> V_38 -> V_77 ;
if ( F_10 ( V_64 , & V_73 , sizeof( V_73 ) ) )
V_8 = - V_26 ;
break;
}
default:
...
if ( F_38 ( V_62 ) == F_38 ( F_39 ( 0 ) ) ) {
int V_9 = F_40 ( V_62 ) ;
V_8 = F_12 ( V_1 , V_64 , V_9 , V_78 ) ;
break;
}
if ( F_38 ( V_62 ) == F_38 ( F_41 ( 0 ) ) ) {
int V_9 = F_40 ( V_62 ) ;
V_8 = F_19 ( V_1 , V_64 , V_9 , V_78 ) ;
break;
}
if ( F_42 ( V_62 ) != V_79 ) {
V_8 = - V_41 ;
...
if ( F_38 ( V_62 ) == F_38 ( F_43 ( 0 ) ) ) {
int V_9 = strlen ( V_38 -> V_80 ) + 1 ;
if ( V_9 > F_40 ( V_62 ) )
V_9 = F_40 ( V_62 ) ;
V_8 = F_10 ( V_64 , V_38 -> V_80 , V_9 ) ?
- V_26 : V_9 ;
break;
}
if ( F_38 ( V_62 ) == F_38 ( F_44 ( 0 ) ) ) {
int V_9 = strlen ( V_38 -> V_81 ) + 1 ;
if ( V_9 > F_40 ( V_62 ) )
V_9 = F_40 ( V_62 ) ;
V_8 = F_10 ( V_64 , V_38 -> V_81 , V_9 ) ?
- V_26 : V_9 ;
break;
}
}
...
int F_45 ( struct V_33 * V_38 , T_8 * V_83 , int V_9 )
{
struct V_15 * V_34 = V_38 -> V_15 ;
struct V_5 * V_6 ;
int V_8 = 0 ;
F_46 (list, &dev->list, node) {
if ( ! ( V_6 -> V_2 [ V_6 -> V_13 ] . V_25 = F_47 ( V_83 , V_9 , V_84 ) ) ) {
V_8 = - V_43 ;
break;
}
V_6 -> V_2 [ V_6 -> V_13 ] . V_9 = V_9 ;
V_6 -> V_13 = ( V_6 -> V_13 + 1 ) & ( V_27 - 1 ) ;
F_48 ( & V_6 -> V_85 , V_86 , V_87 ) ;
}
F_49 ( & V_34 -> V_10 ) ;
return V_8 ;
}
...
V_34 -> V_34 = F_51 ( V_90 , & V_38 -> V_34 , F_52 ( V_91 , V_29 ) ,
NULL , L_5 , L_6 , V_29 ) ;
if ( F_53 ( V_34 -> V_34 ) ) {
V_36 [ V_29 ] = NULL ;
F_7 ( & V_45 ) ;
