...
struct V_17 * V_18 = (struct V_17 * ) V_16 ;
T_1 V_19 = F_3 ( V_18 -> V_20 ) ;
if ( ( V_18 -> V_23 < V_2 -> V_6 ) ||
( ( V_18 -> V_23 + V_19 ) > V_2 -> V_8 ) ) {
F_5 ( L_3
L_4
L_5 , V_2 -> V_37 ,
V_18 -> V_23 , V_19 , V_2 -> V_6 ,
V_2 -> V_8 ) ;
return V_27 ;
}
V_36 = ( V_2 -> V_36 + V_19 ) ;
...
struct V_25 * V_26 = V_2 -> V_28 ;
if ( V_18 -> V_23 > V_26 -> V_23 ) {
F_5 ( L_29
L_31 , V_2 -> V_37 ,
V_18 -> V_23 , V_26 -> V_23 ) ;
V_45 = 1 ;
goto V_46;
} else if ( V_18 -> V_23 < V_26 -> V_23 ) {
F_5 ( L_29
L_32 ,
V_2 -> V_37 , V_18 -> V_23 , V_26 -> V_23 ) ;
V_24 = 1 ;
goto V_24;
}
}
...
L_34 , V_2 -> V_37 ,
V_18 -> V_23 , V_19 ) ;
return F_6 ( V_2 -> V_4 , V_19 , 1 ) ;
default:
return V_27 ;
}
return V_35 ;
}
static int F_15 ( struct V_1 * V_2 , T_1 V_23 , T_1 V_55 )
{
struct V_56 * V_57 ;
if ( V_2 -> V_5 )
return 0 ;
V_57 = F_16 ( V_2 , V_23 , V_55 ) ;
if ( ! V_57 )
return - 1 ;
F_17 ( & V_2 -> V_58 ) ;
V_57 -> V_59 = 1 ;
...
V_46:
return F_12 ( V_2 , V_18 -> V_23 , V_19 ) ;
}
extern int F_23 (
struct V_1 * V_2 ,
unsigned char * V_16 )
...
extern void F_32 ( struct V_70 * V_11 )
{
int V_94 ;
F_29 ( & F_27 ( V_11 ) -> V_95 ) ;
V_94 = ( F_27 ( V_11 ) -> V_96 == V_97 ) ;
F_30 ( & F_27 ( V_11 ) -> V_95 ) ;
if ( ! V_94 )
return;
if ( V_11 -> V_77 & V_98 )
...
F_34 ( & V_11 -> V_100 ) ;
V_11 -> V_100 . V_101 =
( F_35 () + V_11 -> V_12 -> V_99 * V_102 ) ;
V_11 -> V_100 . V_69 = ( unsigned long ) V_11 ;
V_11 -> V_100 . V_103 = F_26 ;
V_11 -> V_77 &= ~ V_78 ;
V_11 -> V_77 |= V_98 ;
F_36 ( & V_11 -> V_100 ) ;
}
extern int F_37 ( struct V_70 * V_11 )
{
struct V_71 * V_72 = F_27 ( V_11 ) ;
struct V_73 * V_74 = & V_72 -> V_75 ;
if ( V_11 -> V_77 & V_80 )
...
void F_43 ( struct V_3 * V_4 , int V_106 )
{
F_17 ( & V_4 -> V_104 ) ;
if ( F_28 ( & V_4 -> V_105 ) ) {
F_18 ( & V_4 -> V_104 ) ;
