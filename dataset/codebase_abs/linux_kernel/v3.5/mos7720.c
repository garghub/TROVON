...
return;
if ( ! F_18 ( & V_21 -> V_8 -> V_38 ) ) {
F_19 ( L_2 , V_39 ) ;
F_20 ( & V_21 -> V_40 ) ;
return;
}
if ( F_17 ( V_21 -> V_8 -> V_41 ) ) {
F_21 ( & V_21 -> V_8 -> V_38 ) ;
return;
}
F_22 ( & V_21 -> V_42 , V_34 ) ;
...
struct V_10 * V_11 = V_8 -> V_12 ;
V_30 = F_34 ( sizeof( struct V_29 ) , V_45 ) ;
if ( V_30 == NULL ) {
F_6 ( & V_11 -> V_12 , L_7 ) ;
return - V_50 ;
}
...
V_31 = F_36 ( 0 , V_86 ) ;
V_117 -> V_133 [ V_130 ] = V_31 ;
if ( V_31 == NULL ) {
F_6 ( & V_110 -> V_12 , L_31 ) ;
continue;
}
V_31 -> V_104 = F_34 ( V_134 ,
V_86 ) ;
if ( ! V_31 -> V_104 ) {
F_6 ( & V_110 -> V_12 ,
L_32 ,
V_39 ) ;
F_14 ( V_117 -> V_133 [ V_130 ] ) ;
...
memcpy ( V_31 -> V_104 , V_158 , V_157 ) ;
F_96 ( V_159 , & V_110 -> V_12 , V_39 , V_157 ,
V_31 -> V_104 ) ;
F_97 ( V_31 , V_8 -> V_12 ,
F_62 ( V_8 -> V_12 ,
V_110 -> V_160 ) ,
...
F_19 ( L_58 , V_39 , V_110 -> V_135 , V_173 ) ;
V_18 = F_104 ( V_173 , & V_174 ) ;
if ( V_18 ) {
F_6 ( & V_110 -> V_12 , L_59 , V_39 ) ;
return V_18 ;
}
V_117 -> V_141 = V_117 -> V_141 | V_170 ;
...
if ( V_117 == NULL )
return - V_56 ;
F_19 ( L_77 , V_39 , V_110 -> V_135 , V_241 ) ;
switch ( V_241 ) {
case V_258 :
F_19 ( L_78 , V_39 , V_110 -> V_135 ) ;
...
( unsigned int T_5 * ) V_242 ) ;
case V_259 :
F_19 ( L_80 , V_39 , V_110 -> V_135 ) ;
return F_122 ( V_117 ,
(struct V_245 T_5 * ) V_242 ) ;
case V_260 :
F_19 ( L_81 , V_39 , V_110 -> V_135 ) ;
V_257 = V_117 -> V_147 ;
while ( 1 ) {
if ( F_124 ( V_261 ) )
return - V_262 ;
