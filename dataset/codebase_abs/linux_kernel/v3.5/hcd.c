...
int F_97 ( struct V_22 * V_22 , T_5 V_172 )
{
int V_36 ;
struct V_11 * V_12 = F_41 ( V_22 -> V_49 -> V_115 ) ;
F_98 ( V_22 ) ;
F_99 ( & V_22 -> V_203 ) ;
F_99 ( & V_22 -> V_49 -> V_204 ) ;
F_100 ( & V_12 -> V_15 , V_22 ) ;
if ( F_1 ( V_22 -> V_49 ) ) {
V_36 = F_32 ( V_12 , V_22 ) ;
} else {
...
if ( F_22 ( V_36 ) ) {
F_102 ( & V_12 -> V_15 , V_22 , V_36 ) ;
V_22 -> V_40 = NULL ;
F_44 ( & V_22 -> V_167 ) ;
F_103 ( & V_22 -> V_203 ) ;
F_103 ( & V_22 -> V_49 -> V_204 ) ;
if ( F_71 ( & V_22 -> V_160 ) )
F_104 ( & V_206 ) ;
F_105 ( V_22 ) ;
}
...
static int F_106 ( struct V_11 * V_12 , struct V_22 * V_22 , int V_36 )
{
int V_207 ;
if ( F_1 ( V_22 -> V_49 ) )
...
int F_107 ( struct V_22 * V_22 , int V_36 )
{
struct V_11 * V_12 ;
int V_103 = - V_170 ;
unsigned long V_92 ;
...
F_8 ( & V_159 ) ;
V_215:
F_113 (urb, &ep->urb_list, urb_list) {
int V_216 ;
if ( V_22 -> V_166 )
continue;
F_98 ( V_22 ) ;
...
F_10 ( & V_159 ) ;
while ( ! F_114 ( & V_107 -> V_167 ) ) {
F_8 ( & V_159 ) ;
V_22 = NULL ;
if ( ! F_114 ( & V_107 -> V_167 ) ) {
V_22 = F_115 ( V_107 -> V_167 . V_217 , struct V_22 ,
V_167 ) ;
F_98 ( V_22 ) ;
}
F_10 ( & V_159 ) ;
...
int V_248 = F_123 ( & V_107 -> V_108 ) ;
int V_249 = F_34 ( & V_107 -> V_108 ) ;
F_124 ( V_2 , V_247 , V_248 , 0 ) ;
if ( V_249 )
F_124 ( V_2 , V_247 , ! V_248 , 0 ) ;
}
}
int F_125 ( struct V_241 * V_250 ,
...
if ( ! F_127 ( & V_251 [ V_224 ] -> V_108 ) )
return - V_105 ;
return V_12 -> V_20 -> V_254 ( V_12 , V_49 , V_251 , V_252 ,
V_253 , V_172 ) ;
}
void F_128 ( struct V_241 * V_250 ,
struct V_214 * * V_251 , unsigned int V_252 ,
T_5 V_172 )
{
struct V_11 * V_12 ;
...
return;
for ( V_224 = 0 ; V_224 < V_252 ; V_224 ++ )
if ( ! V_251 [ V_224 ] || ! F_127 ( & V_251 [ V_224 ] -> V_108 ) )
return;
...
int F_131 ( struct V_1 * V_257 , T_7 V_258 )
{
struct V_11 * V_12 = F_132 ( V_257 -> V_115 , struct V_11 , V_15 ) ;
int V_36 ;
int V_259 = V_12 -> V_260 ;
F_15 ( & V_257 -> V_49 , L_24 ,
( F_133 ( V_258 ) ? L_25 : L_20 ) ,
V_257 -> V_261 ) ;
if ( F_64 ( V_12 ) ) {
...
int F_134 ( struct V_1 * V_257 , T_7 V_258 )
{
struct V_11 * V_12 = F_132 ( V_257 -> V_115 , struct V_11 , V_15 ) ;
int V_36 ;
int V_259 = V_12 -> V_260 ;
...
static void F_136 ( struct V_274 * V_275 )
{
struct V_11 * V_12 = F_132 ( V_275 , struct V_11 , V_276 ) ;
...
F_141 ( V_277 , & V_12 -> V_276 ) ;
}
F_26 ( & V_39 , V_92 ) ;
}
int F_142 ( struct V_114 * V_115 , unsigned V_278 )
{
struct V_11 * V_12 ;
int V_36 = - V_279 ;
V_12 = F_132 ( V_115 , struct V_11 , V_15 ) ;
if ( V_278 && V_12 -> V_20 -> V_280 )
V_36 = V_12 -> V_20 -> V_280 ( V_12 , V_278 ) ;
if ( V_36 == 0 )
F_28 ( & V_12 -> V_99 , V_100 + F_143 ( 10 ) ) ;
return V_36 ;
}
T_8 F_144 ( int V_281 , void * V_282 )
{
struct V_11 * V_12 = V_282 ;
unsigned long V_92 ;
T_8 V_109 ;
F_145 ( V_92 ) ;
if ( F_22 ( F_64 ( V_12 ) || ! F_146 ( V_12 ) ) )
V_109 = V_283 ;
...
F_57 ( V_12 -> V_15 . V_48 ,
V_287 ) ;
F_148 ( V_12 -> V_15 . V_48 ) ;
}
if ( F_149 ( V_12 ) && V_12 -> V_288 ) {
V_12 = V_12 -> V_288 ;
if ( V_12 -> V_149 ) {
F_24 ( V_286 , & V_12 -> V_92 ) ;
F_57 ( V_12 -> V_15 . V_48 ,
...
struct V_11 * F_150 ( const struct V_289 * V_20 ,
struct V_110 * V_49 , const char * V_16 ,
struct V_11 * V_290 )
{
struct V_11 * V_12 ;
V_12 = F_151 ( sizeof( * V_12 ) + V_20 -> V_291 , V_292 ) ;
if ( ! V_12 ) {
F_15 ( V_49 , L_33 ) ;
return NULL ;
}
if ( V_290 == NULL ) {
V_12 -> V_293 = F_152 ( sizeof( * V_12 -> V_293 ) ,
V_292 ) ;
if ( ! V_12 -> V_293 ) {
F_153 ( V_12 ) ;
F_15 ( V_49 , L_34 ) ;
...
struct V_11 * F_160 ( const struct V_289 * V_20 ,
struct V_110 * V_49 , const char * V_16 )
{
return F_150 ( V_20 , V_49 , V_16 , NULL ) ;
}
static void F_161 ( struct V_294 * V_294 )
{
struct V_11 * V_12 = F_132 ( V_294 , struct V_11 , V_294 ) ;
if ( F_149 ( V_12 ) )
F_153 ( V_12 -> V_293 ) ;
else
...
if ( ( V_103 = F_169 ( V_12 ) ) != 0 ) {
F_15 ( V_12 -> V_15 . V_76 , L_43 ) ;
return V_103 ;
}
if ( ( V_103 = F_45 ( & V_12 -> V_15 ) ) < 0 )
goto V_307;
if ( ( V_257 = F_170 ( NULL , & V_12 -> V_15 , 0 ) ) == NULL ) {
...
V_257 -> V_314 = F_172 ( 500u , V_12 -> V_315 ) ;
if ( ( V_103 = F_56 ( V_12 ) ) != 0 )
goto V_316;
V_103 = F_173 ( & V_257 -> V_49 . V_317 , & V_318 ) ;
if ( V_103 < 0 ) {
F_48 ( V_134 L_48 ,
V_103 ) ;
goto V_319;
...
F_178 ( & V_12 -> V_99 ) ;
V_313:
if ( F_149 ( V_12 ) && V_12 -> V_281 > 0 )
F_179 ( V_298 , V_12 ) ;
V_311:
V_310:
V_309:
F_109 ( V_12 -> V_15 . V_48 ) ;
V_308:
F_53 ( & V_12 -> V_15 ) ;
V_307:
F_180 ( V_12 ) ;
...
void
F_183 ( struct V_322 * V_49 )
{
struct V_11 * V_12 = F_184 ( V_49 ) ;
if ( V_12 -> V_20 -> V_323 )
V_12 -> V_20 -> V_323 ( V_12 ) ;
}
int F_185 ( struct V_324 * V_325 )
{
if ( V_326 )
return - V_171 ;
V_326 = V_325 ;
