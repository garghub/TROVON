...
V_6 = V_5 -> V_18 ;
if ( V_6 == 0 ) {
F_9 ( V_2 -> V_74 >= V_2 -> V_75 ) ;
V_70 = V_2 -> V_74 >> V_2 -> V_76 ;
V_71 = ( V_2 -> V_75 - 1 ) >>
V_2 -> V_76 ;
V_72 = V_71 - V_70 + 1 ;
V_69 -> V_77 = 0 ;
V_69 -> V_78 = V_72 << V_5 -> V_31 -> V_79 ;
V_73 = V_5 -> V_12 & V_16 ;
if ( V_5 -> V_35 & V_80 ) {
if ( V_2 -> V_74 < ( F_39 ( V_5 -> V_31 ) >>
V_2 -> V_81 ) )
V_73 = 0 ;
}
...
return;
V_103 = 1 << V_2 -> V_76 ;
V_104 = V_2 -> V_74 & ( V_103 - 1 ) ;
if ( ! V_104 )
return;
if ( V_102 )
V_104 = V_103 - V_104 ;
V_105 = V_104 << V_2 -> V_81 ;
V_17 = F_5 ( 0 ) ;
...
struct V_68 * V_69 )
{
const unsigned V_81 = V_2 -> V_81 ;
const unsigned V_108 = V_20 >> V_81 ;
struct V_17 * V_17 ;
unsigned V_109 ;
int V_6 = 0 ;
V_109 = V_2 -> V_110 ;
while ( V_2 -> V_74 < V_2 -> V_75 ) {
V_17 = F_7 ( V_5 , V_2 ) ;
if ( F_52 ( V_17 ) ) {
V_6 = F_53 ( V_17 ) ;
goto V_19;
...
F_49 ( V_5 , V_2 , 0 , V_69 ) ;
V_104 = V_2 -> V_15 ;
V_112 = ( V_20 - V_111 ) >> V_81 ;
if ( V_104 > V_112 )
V_104 = V_112 ;
V_112 = V_2 -> V_75 - V_2 -> V_74 ;
if ( V_104 > V_112 )
V_104 = V_112 ;
V_105 = V_104 << V_81 ;
F_9 ( V_105 == 0 ) ;
...
T_7 V_124 ;
unsigned long V_125 ;
unsigned V_81 = V_31 -> V_79 ;
unsigned V_126 = ( 1 << V_81 ) - 1 ;
T_1 V_127 = - V_128 ;
T_2 V_102 = V_21 ;
struct V_5 * V_5 ;
struct V_1 V_2 = { 0 , } ;
...
V_125 = ( unsigned long ) V_121 [ V_123 ] . V_132 ;
V_124 = V_121 [ V_123 ] . V_133 ;
V_102 += V_124 ;
if ( F_57 ( ( V_125 & V_126 ) ||
( V_124 & V_126 ) ) ) {
if ( V_43 )
...
if ( ! V_5 )
goto V_19;
memset ( V_5 , 0 , F_64 ( struct V_5 , V_14 ) ) ;
V_5 -> V_35 = V_35 ;
if ( V_5 -> V_35 & V_135 ) {
if ( V_12 == V_13 ) {
struct V_136 * V_137 =
...
F_68 ( & V_31 -> V_141 ) ;
V_5 -> V_22 = ! F_69 ( V_29 ) && ! ( ( V_12 & V_16 ) &&
( V_102 > F_39 ( V_31 ) ) ) ;
V_127 = 0 ;
V_5 -> V_31 = V_31 ;
V_5 -> V_12 = V_12 ;
V_2 . V_81 = V_81 ;
V_2 . V_76 = V_31 -> V_79 - V_81 ;
V_2 . V_74 = V_21 >> V_81 ;
V_2 . V_82 = V_82 ;
V_5 -> V_28 = V_28 ;
V_2 . V_52 = V_52 ;
...
V_2 . V_86 = 2 ;
for ( V_123 = 0 ; V_123 < V_122 ; V_123 ++ ) {
V_129 = ( unsigned long ) V_121 [ V_123 ] . V_132 ;
V_2 . V_86 +=
( ( V_129 + V_121 [ V_123 ] . V_133 + V_20 - 1 ) /
V_20 - V_129 / V_20 ) ;
}
for ( V_123 = 0 ; V_123 < V_122 ; V_123 ++ ) {
V_129 = ( unsigned long ) V_121 [ V_123 ] . V_132 ;
V_2 . V_124 += V_130 = V_121 [ V_123 ] . V_133 ;
V_2 . V_110 = ( V_129 & ~ V_142 ) >> V_81 ;
V_2 . V_75 = V_2 . V_74 +
( V_130 >> V_81 ) ;
V_2 . V_4 = 0 ;
V_2 . V_3 = 0 ;
...
T_1
F_71 ( int V_12 , struct V_119 * V_29 , struct V_31 * V_31 ,
struct V_42 * V_43 , const struct V_120 * V_121 , T_2 V_21 ,
unsigned long V_122 , T_4 V_82 , T_5 V_28 ,
T_6 V_52 , int V_35 )
{
F_72 ( & V_43 -> V_143 -> V_144 ) ;
F_72 ( V_43 -> V_145 ) ;
F_72 ( ( char * ) V_43 -> V_145 + V_146 ) ;
return F_60 ( V_12 , V_29 , V_31 , V_43 , V_121 , V_21 ,
V_122 , V_82 , V_28 ,
V_52 , V_35 ) ;
}
static T_8 int F_73 ( void )
{
V_40 = F_74 ( V_5 , V_147 ) ;
return 0 ;
}
