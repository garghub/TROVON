...
V_97 = - V_106 ;
for ( V_103 = V_124 ; ; V_103 ++ ) {
if ( ( V_2 -> V_30 & V_103 -> V_125 ) == V_103 -> V_97 ) {
...
V_127 = & F_115 ( V_126 ) ;
F_116 ( & V_127 -> V_131 , V_128 ) ;
if ( F_117 ( & V_127 -> V_132 , & V_130 ) )
F_118 ( F_119 () , & V_127 -> V_133 ) ;
else
F_120 ( L_31 ,
V_29 ) ;
F_121 ( & V_127 -> V_131 , V_128 ) ;
F_122 ( V_126 ) ;
}
static void F_123 ( struct V_134 * V_133 )
{
struct V_126 * V_127 ;
...
int V_136 ;
F_127 (cpu) {
V_127 = & F_128 ( V_126 , V_136 ) ;
F_129 ( & V_127 -> V_131 ) ;
F_130 ( V_127 -> V_132 ) ;
F_131 ( & V_127 -> V_133 , F_123 ) ;
}
return 0 ;
}
...
static struct V_1 * F_133 ( struct V_1 * V_2 , unsigned long V_138 , int * * V_139 )
{
int V_140 = F_134 ( V_2 ) ;
if ( F_89 ( V_2 ) )
...
if ( ! F_107 ( F_17 ( V_2 ) ) ) {
if ( F_89 ( V_2 ) ) {
F_30 ( L_36 , V_142 , V_29 ) ;
V_33 = F_74 ( F_17 ( V_2 ) ) ;
} else if ( F_24 ( V_2 ) ) {
F_30 ( L_37 , V_142 , V_29 ) ;
F_99 ( V_2 ) ;
V_33 = 0 ;
} else {
F_30 ( L_38 ,
...
F_144 ( & V_98 -> V_146 , & V_144 ) ;
V_33 = F_145 ( & V_144 , F_133 , V_147 , 0 ,
true ) ;
if ( V_33 ) {
struct V_1 * V_148 , * V_149 ;
F_35 (page1, page2, &pagelist, lru)
F_111 ( V_148 ) ;
F_30 ( L_40 ,
V_29 , V_33 , V_1 -> V_30 ) ;
if ( V_33 > 0 )
...
F_147 ( V_1 , V_150 +
F_148 ( V_1 ) ) ;
F_144 ( & V_1 -> V_146 , & V_144 ) ;
V_33 = F_149 ( & V_144 , F_133 , V_147 ,
0 , V_151 ) ;
if ( V_33 ) {
F_150 ( & V_144 ) ;
F_30 ( L_40 ,
