...
{
if ( F_41 ( V_10 , V_12 , & V_11 -> V_5 . V_60 ) )
goto V_13;
return 0 ;
V_13:
return 1 ;
...
if ( F_41 ( V_10 , V_12 , & V_65 -> V_5 . V_60 ) ||
F_8 ( V_10 , V_16 ,
F_9 ( F_10 ( V_65 -> V_17 ) ) ) )
goto V_13;
return 0 ;
...
return - V_74 ;
V_34 = V_23 -> V_71 == V_72 ? 32 : 128 ;
F_49 ( L_1 ,
V_23 -> V_75 , V_23 -> V_71 == V_72 ? L_2 : L_3 ) ;
if ( F_18 ( ! F_19 ( V_38 , V_76 ) ||
! F_19 ( V_38 , V_77 ) ||
! F_19 ( V_38 , V_16 ) ) )
return - V_45 ;
if ( V_38 [ V_76 ] ) {
...
if ( V_38 [ V_79 ] ) {
V_34 = F_26 ( V_38 [ V_79 ] ) ;
if ( ( V_23 -> V_71 == V_72 && V_34 > 32 ) ||
( V_23 -> V_71 == V_73 && V_34 > 128 ) ||
V_34 == 0 )
return - V_80 ;
}
V_19 = F_51 ( sizeof( * V_19 ) , V_81 ) ;
if ( ! V_19 )
return - V_82 ;
V_19 -> V_58 = V_58 ;
V_19 -> V_34 = V_34 ;
F_52 ( & V_19 -> V_83 , sizeof( V_19 -> V_83 ) ) ;
V_19 -> V_17 = V_84 ;
V_69 = F_53 ( V_66 ) ;
V_70 = F_54 ( V_69 ) ;
if ( V_70 == 0 ) {
...
F_49 ( L_4 ,
V_23 -> V_75 , F_59 ( V_19 -> V_85 -> F_53 ) ,
V_19 -> V_85 -> F_53 , V_19 -> V_58 , V_23 -> V_11 , V_19 -> V_85 ) ;
return 0 ;
}
static int T_6
F_60 ( void )
