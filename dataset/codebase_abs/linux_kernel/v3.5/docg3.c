...
V_116 [ 4 ] , V_116 [ 5 ] , V_116 [ 6 ] ) ;
F_22 ( L_24 , V_116 [ 7 ] ) ;
F_22 ( L_25 ,
V_116 [ 8 ] , V_116 [ 9 ] , V_116 [ 10 ] , V_116 [ 11 ] ,
V_116 [ 12 ] , V_116 [ 13 ] , V_116 [ 14 ] ) ;
F_22 ( L_26 , V_116 [ 15 ] ) ;
}
F_22 ( L_27 , V_121 ) ;
F_22 ( L_28 ,
...
static struct V_1 * F_71 ( struct V_184 * V_185 ,
struct V_186 * V_187 )
{
int floor ;
struct V_188 * V_189 = F_72 ( V_185 ) ;
struct V_110 * * V_190 = F_73 ( V_189 ) ;
floor = V_187 -> V_187 . V_191 [ 1 ] - '0' ;
if ( floor < 0 || floor >= V_192 )
return NULL ;
else
return V_190 [ floor ] -> V_114 ;
}
static T_8 F_74 ( struct V_184 * V_185 ,
struct V_186 * V_187 , char * V_26 )
{
struct V_1 * V_1 = F_71 ( V_185 , V_187 ) ;
int V_193 ;
F_52 ( & V_1 -> V_4 -> V_129 ) ;
F_28 ( V_1 , V_1 -> V_99 ) ;
V_193 = F_13 ( V_1 , V_194 ) ;
F_28 ( V_1 , 0 ) ;
F_55 ( & V_1 -> V_4 -> V_129 ) ;
return sprintf ( V_26 , L_38 , ! ( V_193 & V_195 ) ) ;
}
static T_8 F_75 ( struct V_184 * V_185 ,
struct V_186 * V_187 , char * V_26 )
{
struct V_1 * V_1 = F_71 ( V_185 , V_187 ) ;
int V_196 ;
F_52 ( & V_1 -> V_4 -> V_129 ) ;
F_28 ( V_1 , V_1 -> V_99 ) ;
V_196 = F_13 ( V_1 , V_197 ) ;
F_28 ( V_1 , 0 ) ;
F_55 ( & V_1 -> V_4 -> V_129 ) ;
return sprintf ( V_26 , L_38 , ! ( V_196 & V_195 ) ) ;
}
static T_8 F_76 ( struct V_184 * V_185 ,
struct V_186 * V_187 ,
const char * V_26 , T_6 V_198 )
{
struct V_1 * V_1 = F_71 ( V_185 , V_187 ) ;
int V_14 ;
if ( V_198 != V_199 )
...
static T_8 F_77 ( struct V_184 * V_185 ,
struct V_186 * V_187 ,
const char * V_26 , T_6 V_198 )
{
struct V_1 * V_1 = F_71 ( V_185 , V_187 ) ;
...
struct V_184 * V_185 = & V_189 -> V_185 ;
for ( floor = 0 ; ! V_23 && floor < V_192 &&
V_4 -> V_203 [ floor ] ; floor ++ )
for ( V_14 = 0 ; ! V_23 && V_14 < 4 ; V_14 ++ )
V_23 = F_79 ( V_185 , & V_204 [ floor ] [ V_14 ] ) ;
if ( ! V_23 )
return 0 ;
do {
while ( -- V_14 >= 0 )
F_80 ( V_185 , & V_204 [ floor ] [ V_14 ] ) ;
V_14 = 4 ;
} while ( -- floor >= 0 );
return V_23 ;
}
static void F_81 ( struct V_188 * V_189 ,
struct V_202 * V_4 )
{
struct V_184 * V_185 = & V_189 -> V_185 ;
int floor , V_14 ;
for ( floor = 0 ; floor < V_192 && V_4 -> V_203 [ floor ] ;
floor ++ )
...
switch ( V_45 ) {
case V_215 :
V_209 += F_83 ( V_206 , L_49 ) ;
break;
case V_216 :
V_209 += F_83 ( V_206 , L_9 ) ;
break;
case V_214 :
V_209 += F_83 ( V_206 , L_50 ) ;
break;
}
V_209 += F_83 ( V_206 , L_51 ) ;
return V_209 ;
}
static int F_85 ( struct V_205 * V_206 , void * V_207 )
{
struct V_1 * V_1 = (struct V_1 * ) V_206 -> V_208 ;
int V_209 = 0 ;
int V_50 ;
...
struct V_1 * V_1 = (struct V_1 * ) V_206 -> V_208 ;
int V_209 = 0 ;
int V_217 , V_193 , V_218 , V_219 , V_196 , V_220 , V_221 ;
F_52 ( & V_1 -> V_4 -> V_129 ) ;
V_217 = F_13 ( V_1 , V_222 ) ;
V_193 = F_13 ( V_1 , V_194 ) ;
V_218 = F_15 ( V_1 , V_223 ) ;
V_219 = F_15 ( V_1 , V_224 ) ;
V_196 = F_13 ( V_1 , V_197 ) ;
V_220 = F_15 ( V_1 , V_225 ) ;
V_221 = F_15 ( V_1 , V_226 ) ;
F_55 ( & V_1 -> V_4 -> V_129 ) ;
V_209 += F_83 ( V_206 , L_53 ,
V_217 ) ;
if ( V_217 & V_227 )
V_209 += F_83 ( V_206 , L_54 ) ;
if ( V_217 & V_228 )
V_209 += F_83 ( V_206 , L_55 ) ;
if ( V_217 & V_229 )
V_209 += F_83 ( V_206 , L_56 ) ;
if ( V_217 & V_230 )
V_209 += F_83 ( V_206 , L_57 ) ;
if ( V_217 & V_231 )
V_209 += F_83 ( V_206 , L_58 ) ;
if ( V_217 & V_232 )
V_209 += F_83 ( V_206 , L_59 ) ;
if ( V_217 & V_233 )
V_209 += F_83 ( V_206 , L_60 ) ;
else
V_209 += F_83 ( V_206 , L_61 ) ;
V_209 += F_83 ( V_206 , L_51 ) ;
V_209 += F_83 ( V_206 , L_62
L_63
L_64 ,
V_193 , V_218 , V_219 ,
! ! ( V_193 & V_234 ) ,
...
static int T_9 F_87 ( struct V_1 * V_1 )
{
struct V_238 * V_239 , * V_240 ;
V_239 = F_88 ( L_66 , NULL ) ;
if ( ! V_239 )
return - V_241 ;
V_240 = F_89 ( L_67 , V_242 , V_239 , V_1 ,
& V_243 ) ;
if ( V_240 )
V_240 = F_89 ( L_68 , V_242 , V_239 ,
V_1 , & V_244 ) ;
if ( V_240 )
V_240 = F_89 ( L_69 , V_242 , V_239 ,
V_1 , & V_245 ) ;
if ( V_240 )
V_240 = F_89 ( L_70 , V_242 , V_239 ,
V_1 , & V_246 ) ;
if ( V_240 ) {
V_1 -> V_247 = V_239 ;
return 0 ;
...
static void T_10 F_91 ( struct V_1 * V_1 )
{
F_90 ( V_1 -> V_247 ) ;
}
static void T_9 F_92 ( int V_248 , struct V_110 * V_111 )
{
struct V_1 * V_1 = V_111 -> V_114 ;
int V_249 ;
V_249 = F_13 ( V_1 , V_250 ) ;
V_1 -> V_251 = ( V_249 & V_252 ? 1 : 0 ) ;
V_1 -> V_40 = V_253 ;
switch ( V_248 ) {
case V_254 :
V_111 -> V_191 = F_93 ( V_255 , L_71 ,
V_1 -> V_99 ) ;
V_1 -> V_145 = 2047 ;
break;
}
V_111 -> type = V_256 ;
V_111 -> V_257 = V_258 ;
V_111 -> V_126 = ( V_1 -> V_145 + 1 ) * V_259 ;
if ( V_1 -> V_40 == 2 )
V_111 -> V_126 /= 2 ;
V_111 -> V_160 = V_259 * V_109 ;
if ( V_1 -> V_40 == 2 )
V_111 -> V_160 /= 2 ;
V_111 -> V_260 = V_111 -> V_261 = V_63 ;
V_111 -> V_181 = V_125 ;
V_111 -> V_262 = V_263 ;
V_111 -> V_264 = F_64 ;
V_111 -> V_265 = F_56 ;
...
F_94 ( struct V_202 * V_4 , int floor , struct V_184 * V_185 )
{
int V_23 , V_272 ;
T_2 V_248 , V_273 ;
struct V_1 * V_1 ;
struct V_110 * V_111 ;
V_23 = - V_241 ;
V_1 = F_95 ( sizeof( struct V_1 ) , V_255 ) ;
if ( ! V_1 )
goto V_274;
V_111 = F_95 ( sizeof( struct V_110 ) , V_255 ) ;
if ( ! V_111 )
goto V_275;
V_111 -> V_114 = V_1 ;
V_272 = F_58 ( V_1 -> V_145 + 1 ,
8 * V_63 ) ;
V_1 -> V_144 = F_95 ( V_272 * V_63 , V_255 ) ;
if ( ! V_1 -> V_144 )
goto V_276;
V_1 -> V_185 = V_185 ;
V_1 -> V_99 = floor ;
...
F_27 ( V_1 , V_215 ) ;
F_27 ( V_1 , V_216 ) ;
V_248 = F_15 ( V_1 , V_277 ) ;
V_273 = F_15 ( V_1 , V_278 ) ;
V_23 = 0 ;
if ( V_248 != ( T_2 ) ( ~ V_273 ) ) {
goto V_276;
}
...
static int F_101 ( struct V_188 * V_189 )
{
int V_14 ;
struct V_202 * V_4 ;
struct V_110 * * V_190 , * V_111 ;
struct V_1 * V_1 ;
V_4 = F_73 ( V_189 ) ;
V_190 = V_4 -> V_203 ;
V_111 = V_190 [ 0 ] ;
...
static int F_102 ( struct V_188 * V_189 , T_11 V_157 )
{
int floor , V_14 ;
struct V_202 * V_4 ;
struct V_110 * * V_190 , * V_111 ;
...
static int T_9 F_104 ( struct V_188 * V_189 )
{
struct V_184 * V_185 = & V_189 -> V_185 ;
struct V_110 * V_111 ;
struct V_282 * V_283 ;
void T_12 * V_5 ;
int V_23 , floor , V_284 = 0 ;
struct V_202 * V_4 ;
V_23 = - V_285 ;
V_283 = F_105 ( V_189 , V_286 , 0 ) ;
if ( ! V_283 ) {
F_106 ( V_185 , L_77 ) ;
goto V_287;
}
V_5 = F_107 ( V_283 -> V_288 , V_289 ) ;
V_23 = - V_241 ;
V_4 = F_95 ( sizeof( * V_4 ) * V_192 ,
V_255 ) ;
if ( ! V_4 )
goto V_274;
V_4 -> V_5 = V_5 ;
F_108 ( & V_4 -> V_129 ) ;
V_4 -> V_92 = F_109 ( V_290 , V_90 ,
V_291 ) ;
if ( ! V_4 -> V_92 )
goto V_275;
for ( floor = 0 ; floor < V_192 ; floor ++ ) {
V_111 = F_94 ( V_4 , floor , V_185 ) ;
if ( F_110 ( V_111 ) ) {
V_23 = F_111 ( V_111 ) ;
goto V_292;
}
...
V_4 -> V_203 [ floor ] = V_111 ;
V_23 = F_112 ( V_111 , V_294 , NULL , NULL ,
0 ) ;
if ( V_23 )
goto V_292;
V_284 ++ ;
...
static int T_10 F_116 ( struct V_188 * V_189 )
{
struct V_202 * V_4 = F_73 ( V_189 ) ;
struct V_1 * V_1 = V_4 -> V_203 [ 0 ] -> V_114 ;
