...
struct V_52 * V_53 ;
int V_17 ;
V_2 = F_22 ( & V_16 -> V_55 , sizeof( struct V_1 ) , V_56 ) ;
if ( ! V_2 )
return - V_57 ;
V_2 -> V_16 = V_16 ;
V_2 -> V_51 = V_58 ;
V_2 -> V_12 = F_22 ( & V_16 -> V_55 , 8 , V_56 ) ;
if ( ! V_2 -> V_12 )
return - V_57 ;
V_53 = F_23 ( L_1 , & V_16 -> V_55 , V_2 , & V_59 ) ;
if ( F_24 ( V_53 ) )
return F_25 ( V_53 ) ;
V_2 -> V_53 = V_53 ;
V_17 = F_16 ( V_2 , V_60 ) ;
...
static int T_4 F_28 ( struct V_54 * V_16 )
{
struct V_1 * V_2 = F_29 ( & V_16 -> V_55 ) ;
F_16 ( V_2 , V_58 ) ;
F_27 ( V_2 -> V_53 ) ;
return 0 ;
}
static int F_30 ( struct V_54 * V_16 , T_5 V_62 )
{
struct V_1 * V_2 = F_29 ( & V_16 -> V_55 ) ;
return F_16 ( V_2 , V_58 ) ;
}
static int F_31 ( struct V_54 * V_16 )
{
struct V_1 * V_2 = F_29 ( & V_16 -> V_55 ) ;
return F_16 ( V_2 , V_60 ) ;
}
static void F_32 ( struct V_54 * V_16 )
{
struct V_1 * V_2 = F_29 ( & V_16 -> V_55 ) ;
F_16 ( V_2 , V_58 ) ;
}
