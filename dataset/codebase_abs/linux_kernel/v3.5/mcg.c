...
goto V_43;
V_30 = F_22 ( V_29 -> V_30 ) & 0xffffff ;
for ( V_64 = - 1 , V_54 = 0 ; V_54 < V_30 ; ++ V_54 )
if ( ( F_22 ( V_29 -> V_46 [ V_54 ] ) & V_47 ) == V_24 )
V_64 = V_54 ;
V_29 -> V_30 = F_23 ( -- V_30 |
( V_61 << 30 ) ) ;
V_29 -> V_46 [ V_64 ] = V_29 -> V_46 [ V_54 - 1 ] ;
V_29 -> V_46 [ V_54 - 1 ] = 0 ;
V_19 = F_6 ( V_2 , V_49 -> V_5 , V_7 ) ;
if ( V_19 )
goto V_43;
...
T_1 * V_65 , enum V_66 V_34 ,
struct V_6 * V_67 ,
int * V_68 , int * V_5 )
{
struct V_6 * V_7 ;
struct V_28 * V_29 = V_67 -> V_42 ;
T_1 * V_69 ;
int V_19 ;
T_3 V_16 ;
T_1 V_17 = ( V_34 == V_61 ) ?
! ! ( V_2 -> V_44 . V_70 & V_71 ) : 0 ;
V_7 = F_20 ( V_2 ) ;
if ( F_21 ( V_7 ) )
return - V_36 ;
V_69 = V_7 -> V_42 ;
...
return V_19 ;
if ( 0 )
F_38 ( V_2 , L_4 , V_65 , V_16 ) ;
* V_5 = V_16 ;
* V_68 = - 1 ;
do {
V_19 = F_4 ( V_2 , * V_5 , V_67 ) ;
if ( V_19 )
return V_19 ;
...
if ( ! memcmp ( V_29 -> V_65 , V_65 , 16 ) &&
F_22 ( V_29 -> V_30 ) >> 30 == V_34 )
return V_19 ;
* V_68 = * V_5 ;
* V_5 = F_22 ( V_29 -> V_72 ) >> 6 ;
} while ( * V_5 );
* V_5 = - 1 ;
return V_19 ;
}
int F_40 ( struct V_1 * V_2 , struct V_73 * V_46 , T_1 V_65 [ 16 ] ,
int V_74 , enum V_66 V_34 ,
enum V_23 V_14 )
{
struct F_12 * V_57 = F_12 ( V_2 ) ;
struct V_6 * V_7 ;
...
if ( ! ( F_22 ( V_29 -> V_30 ) & 0xffffff ) ) {
V_32 = 1 ;
memcpy ( V_29 -> V_65 , V_65 , 16 ) ;
}
} else {
V_75 = 1 ;
V_5 = F_42 ( & V_57 -> V_58 . V_76 ) ;
if ( V_5 == - 1 ) {
F_39 ( V_2 , L_6 ) ;
V_19 = - V_36 ;
goto V_55;
...
if ( ! V_75 )
goto V_55;
V_19 = F_4 ( V_2 , V_68 , V_7 ) ;
if ( V_19 )
goto V_55;
V_29 -> V_72 = F_23 ( V_5 << 6 ) ;
V_19 = F_6 ( V_2 , V_68 , V_7 ) ;
if ( V_19 )
goto V_55;
V_55:
if ( V_34 == V_61 ) {
...
int F_44 ( struct V_1 * V_2 , struct V_73 * V_46 , T_1 V_65 [ 16 ] ,
enum V_66 V_34 , enum V_23 V_14 )
{
struct F_12 * V_57 = F_12 ( V_2 ) ;
struct V_6 * V_7 ;
struct V_28 * V_29 ;
...
V_29 -> V_46 [ V_54 - 1 ] = 0 ;
if ( V_34 == V_61 )
V_79 = F_32 ( V_2 , V_13 , V_14 ,
V_5 , V_46 -> V_24 ) ;
if ( V_54 != 1 && ( V_34 != V_61 || ! V_79 ) ) {
V_19 = F_6 ( V_2 , V_5 , V_7 ) ;
goto V_55;
}
V_29 -> V_30 = F_23 ( ( T_2 ) V_34 << 30 ) ;
if ( V_68 == - 1 ) {
int V_80 = F_22 ( V_29 -> V_72 ) >> 6 ;
if ( V_80 ) {
V_19 = F_4 ( V_2 , V_80 , V_7 ) ;
if ( V_19 )
goto V_55;
} else
memset ( V_29 -> V_65 , 0 , 16 ) ;
V_19 = F_6 ( V_2 , V_5 , V_7 ) ;
if ( V_19 )
goto V_55;
if ( V_80 ) {
if ( V_80 < V_2 -> V_44 . V_77 )
F_29 ( V_2 , L_12 ,
V_5 , V_80 , V_2 -> V_44 . V_77 ) ;
else
F_43 ( & V_57 -> V_58 . V_76 ,
V_80 - V_2 -> V_44 . V_77 ) ;
}
} else {
int V_81 = F_22 ( V_29 -> V_72 ) >> 6 ;
V_19 = F_4 ( V_2 , V_68 , V_7 ) ;
if ( V_19 )
goto V_55;
V_29 -> V_72 = F_23 ( V_81 << 6 ) ;
V_19 = F_6 ( V_2 , V_68 , V_7 ) ;
if ( V_19 )
goto V_55;
if ( V_5 < V_2 -> V_44 . V_77 )
F_29 ( V_2 , L_13 ,
V_68 , V_5 , V_2 -> V_44 . V_77 ) ;
else
F_43 ( & V_57 -> V_58 . V_76 ,
V_5 - V_2 -> V_44 . V_77 ) ;
}
...
static int F_45 ( struct V_1 * V_2 , struct V_73 * V_46 ,
T_1 V_65 [ 16 ] , T_1 V_82 , T_1 V_83 ,
enum V_66 V_34 )
{
struct V_6 * V_7 ;
int V_19 = 0 ;
...
if ( F_21 ( V_7 ) )
return F_41 ( V_7 ) ;
memcpy ( V_7 -> V_42 , V_65 , 16 ) ;
V_24 = V_46 -> V_24 ;
V_24 |= ( V_34 << 28 ) ;
if ( V_82 && V_83 )
V_24 |= ( 1 << 31 ) ;
V_19 = F_7 ( V_2 , V_7 -> V_8 , V_24 , V_82 ,
V_85 , V_10 ,
V_86 ) ;
F_24 ( V_2 , V_7 ) ;
return V_19 ;
}
int F_47 ( struct V_1 * V_2 , struct V_73 * V_46 , T_1 V_65 [ 16 ] ,
int V_74 , enum V_66 V_34 )
{
if ( V_34 == V_61 &&
! ( V_2 -> V_44 . V_70 & V_71 ) )
...
V_65 [ 7 ] |= ( V_87 << 1 ) ;
if ( F_46 ( V_2 ) )
return F_45 ( V_2 , V_46 , V_65 , 1 ,
V_74 , V_34 ) ;
return F_40 ( V_2 , V_46 , V_65 , V_74 ,
V_34 , V_87 ) ;
}
int F_48 ( struct V_1 * V_2 , struct V_73 * V_46 , T_1 V_65 [ 16 ] ,
enum V_66 V_34 )
{
if ( V_34 == V_61 &&
! ( V_2 -> V_44 . V_70 & V_71 ) )
...
V_65 [ 7 ] |= ( V_87 << 1 ) ;
if ( F_46 ( V_2 ) )
return F_45 ( V_2 , V_46 , V_65 , 0 , 0 , V_34 ) ;
return F_44 ( V_2 , V_46 , V_65 , V_34 , V_87 ) ;
}
int F_49 ( struct V_1 * V_2 ,
struct V_73 * V_46 , T_1 V_65 [ 16 ] ,
int V_74 , enum V_66 V_34 )
{
if ( V_34 == V_61 &&
! ( V_2 -> V_44 . V_70 & V_88 ) )
...
int F_50 ( struct V_1 * V_2 , struct V_73 * V_46 ,
T_1 V_65 [ 16 ] , enum V_66 V_34 )
{
if ( V_34 == V_61 &&
! ( V_2 -> V_44 . V_70 & V_88 ) )
return 0 ;
...
if ( F_46 ( V_2 ) )
return F_45 ( V_2 , V_46 , V_65 , 0 , 0 , V_34 ) ;
return F_44 ( V_2 , V_46 , V_65 , V_34 , V_89 ) ;
}
int F_51 ( struct V_1 * V_2 , int V_90 ,
struct V_91 * V_92 ,
struct V_6 * V_93 ,
struct V_6 * V_94 ,
struct V_95 * V_96 )
{
T_2 V_24 = ( T_2 ) V_92 -> V_97 & 0xffffffff ;
T_1 V_13 = V_92 -> V_97 >> 62 ;
enum V_23 V_14 = V_92 -> V_98 ;
if ( F_46 ( V_2 ) && V_14 == V_89 )
return 0 ;
if ( V_92 -> V_99 )
...
enum V_23 V_14 , T_1 V_100 , T_1 V_13 )
{
return F_7 ( V_2 , ( T_4 ) V_24 | ( T_4 ) V_13 << 62 , ( T_2 ) V_14 , V_100 ,
V_101 , V_10 ,
V_86 ) ;
}
int F_53 ( struct V_1 * V_2 , T_2 V_24 , T_1 V_13 )
{
if ( ! ( V_2 -> V_44 . V_70 & V_71 ) )
return 0 ;
if ( F_46 ( V_2 ) )
return F_52 ( V_2 , V_24 , V_87 , 1 , V_13 ) ;
return F_33 ( V_2 , V_13 , V_87 , V_24 ) ;
}
...
return 0 ;
if ( F_46 ( V_2 ) )
return F_52 ( V_2 , V_24 , V_87 , 0 , V_13 ) ;
return F_36 ( V_2 , V_13 , V_87 , V_24 ) ;
}
int F_55 ( struct V_1 * V_2 , T_2 V_24 , T_1 V_13 )
{
if ( ! ( V_2 -> V_44 . V_70 & V_88 ) )
return 0 ;
if ( F_46 ( V_2 ) )
return F_52 ( V_2 , V_24 , V_89 , 1 , V_13 ) ;
...
return 0 ;
if ( F_46 ( V_2 ) )
return F_52 ( V_2 , V_24 , V_89 , 0 , V_13 ) ;
...
struct F_12 * V_57 = F_12 ( V_2 ) ;
int V_19 ;
V_19 = F_58 ( & V_57 -> V_58 . V_76 , V_2 -> V_44 . V_102 ,
V_2 -> V_44 . V_102 - 1 , 0 , 0 ) ;
if ( V_19 )
return V_19 ;
F_59 ( & V_57 -> V_58 . V_59 ) ;
return 0 ;
