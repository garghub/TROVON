...
static int F_62 ( struct V_120 * V_20 )
{
struct V_1 * V_1 ;
struct V_5 * V_6 ;
if ( V_120 [ 0 ] != - 1 ) {
int V_2 , V_135 = 0 ;
for ( V_2 = 0 ; V_2 < V_136 && V_120 [ V_2 ] != - 1 ; V_2 ++ ) {
if ( V_120 [ 0 ] == V_20 -> V_137 )
V_135 = 1 ;
}
if ( ! V_135 )
return - V_138 ;
...
F_25 ( V_1 ) ;
F_45 ( V_1 -> V_19 ) ;
if ( F_64 ( & V_1 -> V_125 , V_141 , V_142 ) < 0 ) {
F_11 ( V_6 , L_19 ,
V_1 -> V_3 -> V_70 ) ;
F_63 ( V_1 -> V_19 ) ;
F_54 ( V_1 ) ;
...
static void F_70 ( struct V_120 * V_20 )
{
}
