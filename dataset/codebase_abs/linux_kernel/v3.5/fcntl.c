...
F_8 () ;
V_40 = F_49 ( V_85 ) ;
V_51 = ( ( F_50 ( V_87 -> V_42 , V_89 ) ||
F_50 ( V_87 -> V_42 , V_40 -> V_90 ) || F_50 ( V_87 -> V_42 , V_40 -> V_41 ) ||
F_50 ( V_87 -> V_41 , V_40 -> V_90 ) || F_50 ( V_87 -> V_41 , V_40 -> V_41 ) ) &&
! F_51 ( V_85 , V_87 , V_88 ) ) ;
F_10 () ;
return V_51 ;
}
...
int F_64 ( struct V_10 * V_11 , struct V_113 * * V_115 )
{
...
{
return F_69 ( V_112 , V_122 ) ;
}
void F_70 ( struct V_113 * V_123 )
{
F_62 ( V_112 , V_123 ) ;
}
struct V_113 * F_71 ( int V_1 , struct V_10 * V_11 , struct V_113 * * V_115 , struct V_113 * V_123 )
{
struct V_113 * V_116 , * * V_117 ;
F_2 ( & V_11 -> V_33 ) ;
F_2 ( & V_118 ) ;
...
static int F_74 ( int V_1 , struct V_10 * V_11 , struct V_113 * * V_115 )
{
struct V_113 * V_123 ;
V_123 = F_68 () ;
if ( ! V_123 )
return - V_127 ;
if ( F_71 ( V_1 , V_11 , V_115 , V_123 ) ) {
F_70 ( V_123 ) ;
return 0 ;
}
return 1 ;
}
int F_75 ( int V_1 , struct V_10 * V_11 , int V_128 , struct V_113 * * V_115 )
{
if ( ! V_128 )
return F_64 ( V_11 , V_115 ) ;
return F_74 ( V_1 , V_11 , V_115 ) ;
}
...
if ( V_116 -> V_120 ) {
V_87 = & V_116 -> V_120 -> V_38 ;
if ( ! ( V_88 == V_109 && V_87 -> V_77 == 0 ) )
F_56 ( V_87 , V_116 -> V_124 , V_106 ) ;
}
F_79 ( & V_116 -> V_121 , V_129 ) ;
V_116 = F_80 ( V_116 -> V_119 ) ;
}
}
