...
static int F_199 ( struct V_14 * V_15 , struct V_218 * V_219 )
{
F_168 () ;
return 0 ;
}
static T_10 F_200 ( struct V_14 * V_15 , struct V_60 * V_60 ,
int V_220 )
{
T_10 V_221 ;
if ( V_220 ) {
V_221 =
F_201 ( F_202 ( F_203 ( V_60 , V_15 -> V_222 ) ) ) ;
} else {
V_221 = F_204 ( F_203 ( V_60 , V_15 -> V_222 ) ) ;
}
V_221 = F_205 ( V_221 ) ;
V_221 = F_206 ( V_221 ) ;
V_221 = F_207 ( V_221 , V_15 , V_60 , V_220 ) ;
return V_221 ;
}
...
{
T_10 V_221 ;
V_221 = F_201 ( F_202 ( F_209 ( V_223 ) ) ) ;
if ( F_210 ( V_15 , V_38 , V_223 , V_221 , 1 ) )
F_211 ( V_15 , V_38 , V_223 ) ;
}
int F_212 ( struct V_224 * V_61 , struct V_224 * V_62 ,
struct V_14 * V_15 )
{
...
V_225 = F_213 ( V_62 , V_129 ) ;
if ( ! V_225 )
continue;
V_226 = F_214 ( V_61 , V_129 , V_229 ) ;
if ( ! V_226 )
goto V_232;
if ( V_226 == V_225 )
continue;
F_8 ( & V_61 -> V_233 ) ;
F_215 ( & V_62 -> V_233 , V_234 ) ;
if ( ! F_216 ( F_209 ( V_225 ) ) ) {
if ( V_228 )
F_217 ( V_62 , V_129 , V_225 ) ;
V_221 = F_209 ( V_225 ) ;
V_227 = F_218 ( V_221 ) ;
F_219 ( V_227 ) ;
F_220 ( V_227 ) ;
F_221 ( V_61 , V_129 , V_226 , V_221 ) ;
}
F_2 ( & V_62 -> V_233 ) ;
F_2 ( & V_61 -> V_233 ) ;
}
...
static int F_222 ( T_10 V_235 )
{
T_11 V_236 ;
if ( F_216 ( V_235 ) || F_223 ( V_235 ) )
return 0 ;
V_236 = F_224 ( V_235 ) ;
if ( F_225 ( V_236 ) && F_226 ( V_236 ) )
return 1 ;
else
return 0 ;
}
static int F_227 ( T_10 V_235 )
{
T_11 V_236 ;
if ( F_216 ( V_235 ) || F_223 ( V_235 ) )
return 0 ;
V_236 = F_224 ( V_235 ) ;
if ( F_225 ( V_236 ) && F_228 ( V_236 ) )
return 1 ;
else
return 0 ;
}
void F_229 ( struct V_14 * V_15 , unsigned long V_216 ,
...
F_230 ( V_240 ) ;
F_132 ( ! F_34 ( V_15 ) ) ;
F_9 ( V_216 & ~ F_231 ( V_37 ) ) ;
F_9 ( V_32 & ~ F_231 ( V_37 ) ) ;
F_232 ( V_238 , V_216 , V_32 ) ;
F_8 ( & V_238 -> V_233 ) ;
for ( V_38 = V_216 ; V_38 < V_32 ; V_38 += V_229 ) {
V_223 = F_213 ( V_238 , V_38 ) ;
if ( ! V_223 )
continue;
if ( F_233 ( V_238 , & V_38 , V_223 ) )
continue;
V_235 = F_209 ( V_223 ) ;
if ( F_216 ( V_235 ) )
continue;
...
F_237 ( V_15 , V_216 , V_32 ) ;
F_2 ( & V_238 -> V_233 ) ;
F_238 ( V_238 , V_216 , V_32 ) ;
...
void F_240 ( struct V_14 * V_15 , unsigned long V_216 ,
unsigned long V_32 , struct V_60 * V_237 )
{
F_241 ( & V_15 -> V_16 -> V_131 -> V_242 ) ;
F_229 ( V_15 , V_216 , V_32 , V_237 ) ;
F_242 ( & V_15 -> V_16 -> V_131 -> V_242 ) ;
}
...
struct V_244 V_245 ;
T_1 V_246 ;
V_38 = V_38 & F_231 ( V_37 ) ;
V_246 = F_28 ( V_37 , V_15 , V_38 ) ;
V_96 = V_15 -> V_16 -> V_17 -> V_18 -> V_134 ;
F_241 ( & V_96 -> V_242 ) ;
F_244 (iter_vma, &iter, &mapping->i_mmap, pgoff, pgoff) {
if ( V_243 == V_15 )
continue;
if ( ! F_46 ( V_243 , V_59 ) )
F_229 ( V_243 ,
...
static int F_245 ( struct V_224 * V_238 , struct V_14 * V_15 ,
...
if ( V_250 ) {
if ( F_246 ( V_248 ) )
F_247 ( V_248 , V_15 , V_38 ) ;
F_208 ( V_15 , V_38 , V_223 ) ;
return 0 ;
}
if ( ! ( V_15 -> V_51 & V_52 ) &&
F_46 ( V_15 , V_59 ) &&
...
if ( V_251 ) {
F_9 ( F_216 ( V_235 ) ) ;
if ( F_243 ( V_238 , V_15 , V_248 , V_38 ) ) {
F_9 ( F_216 ( V_235 ) ) ;
F_8 ( & V_238 -> V_233 ) ;
V_223 = F_213 ( V_238 , V_38 & F_231 ( V_37 ) ) ;
if ( F_251 ( F_252 ( F_209 ( V_223 ) , V_235 ) ) )
goto V_252;
return 0 ;
}
F_253 ( 1 ) ;
...
F_232 ( V_238 ,
V_38 & F_231 ( V_37 ) ,
( V_38 & F_231 ( V_37 ) ) + F_78 ( V_37 ) ) ;
F_258 ( V_15 , V_38 , V_223 ) ;
F_221 ( V_238 , V_38 , V_223 ,
F_200 ( V_15 , V_249 , 1 ) ) ;
F_239 ( V_248 ) ;
F_259 ( V_249 , V_15 , V_38 ) ;
V_249 = V_248 ;
F_238 ( V_238 ,
V_38 & F_231 ( V_37 ) ,
( V_38 & F_231 ( V_37 ) ) + F_78 ( V_37 ) ) ;
...
static struct V_60 * F_260 ( struct V_36 * V_37 ,
struct V_14 * V_15 , unsigned long V_38 )
{
struct V_130 * V_96 ;
T_1 V_133 ;
...
V_96 = V_15 -> V_16 -> V_131 ;
V_133 = F_28 ( V_37 , V_15 , V_38 ) ;
V_60 = F_263 ( V_96 , V_133 ) ;
if ( V_60 )
F_85 ( V_60 ) ;
return V_60 != NULL ;
}
static int F_264 ( struct V_224 * V_238 , struct V_14 * V_15 ,
...
if ( ! V_60 ) {
V_95 = F_265 ( V_96 -> V_132 ) >> F_29 ( V_37 ) ;
if ( V_133 >= V_95 )
goto V_153;
...
F_266 ( V_60 , V_38 , F_52 ( V_37 ) ) ;
F_257 ( V_60 ) ;
if ( V_15 -> V_51 & V_52 ) {
int V_83 ;
struct V_12 * V_12 = V_96 -> V_132 ;
V_83 = F_267 ( V_60 , V_96 , V_133 , V_7 ) ;
if ( V_83 ) {
F_85 ( V_60 ) ;
if ( V_83 == - V_256 )
goto V_125;
...
goto V_262;
V_10 = 0 ;
if ( ! F_216 ( F_209 ( V_223 ) ) )
goto V_262;
if ( V_253 )
F_259 ( V_60 , V_15 , V_38 ) ;
else
F_220 ( V_60 ) ;
V_254 = F_200 ( V_15 , V_60 , ( ( V_15 -> V_51 & V_263 )
&& ( V_15 -> V_51 & V_230 ) ) ) ;
F_221 ( V_238 , V_38 , V_223 , V_254 ) ;
if ( ( V_55 & V_261 ) && ! ( V_15 -> V_51 & V_230 ) ) {
V_10 = F_245 ( V_238 , V_15 , V_38 , V_223 , V_254 , V_60 ) ;
}
F_2 ( & V_238 -> V_233 ) ;
F_272 ( V_60 ) ;
V_153:
...
int F_273 ( struct V_224 * V_238 , struct V_14 * V_15 ,
...
V_221 = F_209 ( V_223 ) ;
if ( F_57 ( F_222 ( V_221 ) ) ) {
F_275 ( V_238 , ( V_265 * ) V_223 , V_38 ) ;
return 0 ;
} else if ( F_57 ( F_227 ( V_221 ) ) )
return V_266 |
F_271 ( V_37 - V_160 ) ;
}
V_223 = F_214 ( V_238 , V_38 , F_78 ( V_37 ) ) ;
if ( ! V_223 )
return V_137 ;
F_241 ( & V_264 ) ;
V_221 = F_209 ( V_223 ) ;
if ( F_216 ( V_221 ) ) {
V_10 = F_264 ( V_238 , V_15 , V_38 , V_223 , V_55 ) ;
goto V_267;
}
V_10 = 0 ;
if ( ( V_55 & V_261 ) && ! F_276 ( V_221 ) ) {
if ( F_115 ( V_37 , V_15 , V_38 ) < 0 ) {
V_10 = V_137 ;
goto V_267;
}
...
F_269 ( V_60 ) ;
F_8 ( & V_238 -> V_233 ) ;
if ( F_57 ( ! F_252 ( V_221 , F_209 ( V_223 ) ) ) )
goto V_268;
if ( V_55 & V_261 ) {
if ( ! F_276 ( V_221 ) ) {
V_10 = F_245 ( V_238 , V_15 , V_38 , V_223 , V_221 ,
V_247 ) ;
goto V_268;
}
V_221 = F_202 ( V_221 ) ;
...
V_221 = F_205 ( V_221 ) ;
if ( F_210 ( V_15 , V_38 , V_223 , V_221 ,
V_55 & V_261 ) )
F_211 ( V_15 , V_38 , V_223 ) ;
V_268:
F_2 ( & V_238 -> V_233 ) ;
...
struct V_60 *
F_277 ( struct V_224 * V_238 , unsigned long V_38 ,
T_12 * V_269 , int V_205 )
{
F_168 () ;
return NULL ;
}
int F_278 ( struct V_224 * V_238 , struct V_14 * V_15 ,
...
int V_276 ;
struct V_60 * V_60 ;
V_235 = F_213 ( V_238 , V_274 & F_231 ( V_37 ) ) ;
V_276 = ! V_235 || F_216 ( F_209 ( V_235 ) ) ;
if ( V_276 && ( V_55 & V_277 ) &&
! F_262 ( V_37 , V_15 , V_274 ) ) {
V_275 = 0 ;
break;
}
if ( V_276 ||
( ( V_55 & V_278 ) && ! F_276 ( F_209 ( V_235 ) ) ) ) {
int V_10 ;
F_2 ( & V_238 -> V_233 ) ;
V_10 = F_273 ( V_238 , V_15 , V_274 ,
( V_55 & V_278 ) ? V_261 : 0 ) ;
F_8 ( & V_238 -> V_233 ) ;
if ( ! ( V_10 & V_279 ) )
continue;
...
V_273 = ( V_274 & ~ F_231 ( V_37 ) ) >> V_43 ;
V_60 = F_218 ( F_209 ( V_235 ) ) ;
V_280:
if ( V_270 ) {
V_270 [ V_63 ] = F_279 ( V_60 , V_273 ) ;
F_219 ( V_270 [ V_63 ] ) ;
}
if ( V_271 )
V_271 [ V_63 ] = V_15 ;
...
if ( ! F_216 ( F_209 ( V_223 ) ) ) {
V_235 = F_234 ( V_238 , V_38 , V_223 ) ;
V_235 = F_206 ( F_282 ( V_235 , V_282 ) ) ;
F_221 ( V_238 , V_38 , V_223 , V_235 ) ;
}
}
F_2 ( & V_238 -> V_233 ) ;
F_242 ( & V_15 -> V_16 -> V_131 -> V_242 ) ;
...
int F_283 ( struct V_12 * V_12 ,
long V_28 , long V_27 ,
struct V_14 * V_15 ,
T_14 V_51 )
{
long V_10 , V_30 ;
struct V_36 * V_37 = F_284 ( V_12 ) ;
...
void F_285 ( struct V_12 * V_12 , long V_285 , long V_286 )
{
struct V_36 * V_37 = F_284 ( V_12 ) ;
long V_30 = F_22 ( & V_12 -> V_134 -> V_135 , V_285 ) ;
struct V_1 * V_2 = F_12 ( V_12 ) ;
F_8 ( & V_12 -> V_257 ) ;
V_12 -> V_258 -= ( F_268 ( V_37 ) * V_286 ) ;
F_2 ( & V_12 -> V_257 ) ;
F_11 ( V_2 , ( V_30 - V_286 ) ) ;
F_193 ( V_37 , - ( V_30 - V_286 ) ) ;
}
static int F_286 ( struct V_60 * V_287 )
{
struct V_60 * V_60 ;
struct V_60 * V_121 ;
struct V_36 * V_37 = F_51 ( V_287 ) ;
int V_67 = F_60 ( V_287 ) ;
