...
{
int V_106 , V_88 ;
const void * V_20 = V_10 -> V_107 -> V_20 ;
T_4 V_21 = V_10 -> V_107 -> V_108 ;
T_5 V_109 = V_110 ;
...
V_10 -> V_121 , ( unsigned long ) V_10 -> V_107 -> V_108 ) ;
return 0 ;
}
...
{
struct V_136 * V_137 = V_10 -> V_18 -> V_65 . V_137 ;
F_87 ( & V_10 -> V_138 ) ;
if ( V_137 )
F_88 ( V_137 ) ;
F_89 ( & V_10 -> V_18 -> V_65 ) ;
...
static void F_91 ( const struct V_107 * V_139 , void * V_4 )
{
...
static int F_96 ( struct V_146 * V_124 )
{
struct V_147 * V_18 = F_97 ( V_124 ) ;
struct V_122 * V_148 = & V_124 -> V_125 [ 0 ] ;
struct V_126 * V_130 ;
unsigned char * V_3 ;
T_3 V_149 ;
int V_150 ;
for ( V_150 = 1 ; V_150 >= 0 ; V_150 -- ) {
V_130 = & V_148 -> V_130 [ V_150 ] . V_128 ;
if ( F_98 ( V_130 ) &&
F_99 ( V_130 ) ) {
V_149 = V_130 -> V_151 ;
break;
...
V_3 [ 19 ] = 0x2 ;
F_83 ( & V_18 -> V_65 , L_9 ) ;
V_150 = F_100 ( V_18 , F_10 ( V_18 , V_149 ) ,
V_3 , 31 , NULL , 2000 ) ;
F_3 ( V_3 ) ;
if ( V_150 )
return V_150 ;
...
static int F_102 ( struct V_146 * V_124 ,
const struct V_115 * V_152 )
{
struct V_147 * V_18 = F_97 ( V_124 ) ;
struct V_13 * V_10 ;
int V_15 = 0 ;
...
V_10 -> V_121 = V_157 ;
V_15 = F_106 ( V_158 , true , V_10 -> V_121 ,
& V_10 -> V_18 -> V_65 , V_16 ,
V_10 , F_91 ) ;
if ( V_15 ) {
F_45 ( & V_10 -> V_18 -> V_65 ,
...
static void F_108 ( struct V_147 * V_18 )
{
T_5 V_160 = 0xffffffff ;
void * V_47 ;
int V_15 ;
V_47 = F_109 ( & V_160 , 4 , V_16 ) ;
if ( ! V_47 )
return;
...
static void F_110 ( struct V_146 * V_124 )
{
struct V_147 * V_18 = F_97 ( V_124 ) ;
struct V_13 * V_10 = F_58 ( V_124 ) ;
bool V_161 = ( V_18 -> V_162 == V_163 ) ? true : false ;
if ( ! V_10 )
return;
F_111 ( & V_10 -> V_138 ) ;
if ( V_10 -> V_107 ) {
F_112 ( V_10 -> V_11 , V_161 ) ;
F_94 ( V_10 -> V_11 ) ;
F_85 ( V_10 ) ;
F_95 ( V_10 -> V_107 ) ;
}
F_101 ( V_124 , NULL ) ;
if ( ! V_161 && ( V_10 -> V_26 & V_62 ) )
F_108 ( V_18 ) ;
F_3 ( V_10 ) ;
F_83 ( & V_18 -> V_65 , L_13 ) ;
F_107 ( V_18 ) ;
}
static int F_113 ( struct V_146 * V_124 ,
T_6 V_164 )
{
struct V_13 * V_10 = F_58 ( V_124 ) ;
if ( ! ( V_10 -> V_26 & V_62 ) )
...
static int F_115 ( struct V_146 * V_124 )
{
struct V_13 * V_10 = F_58 ( V_124 ) ;
struct V_165 * V_11 = V_10 -> V_11 ;
int V_15 ;
V_15 = F_77 ( V_10 ) ;
if ( V_15 )
return V_15 ;
