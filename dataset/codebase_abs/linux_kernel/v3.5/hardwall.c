...
char V_142 [ 64 ] ;
snprintf ( V_142 , sizeof( V_142 ) , L_14 , V_29 -> V_93 ) ;
F_97 ( V_142 , V_29 -> type -> V_146 ) ;
}
int F_98 ( struct V_42 * V_102 , char * V_148 )
{
int V_80 ;
int V_149 = 0 ;
for ( V_80 = 0 ; V_80 < V_81 ; ++ V_80 ) {
...
continue;
if ( V_152 == NULL )
V_152 = F_100 ( L_16 , V_151 ) ;
V_25 -> V_146 = F_100 ( V_25 -> V_51 , V_152 ) ;
}
}
static long F_101 ( struct V_144 * V_144 , unsigned int V_153 , unsigned long V_154 )
{
struct V_7 * V_29 = V_144 -> V_155 ;
int V_156 = F_102 ( V_144 -> V_157 -> V_158 ) ;
struct V_24 * V_25 ;
if ( F_103 ( V_153 ) != V_159 )
return - V_21 ;
F_104 ( V_81 != V_160 ) ;
F_104 ( V_81 !=
...
{
return F_101 ( V_144 , V_153 , ( unsigned long ) F_111 ( V_154 ) ) ;
}
static int F_112 ( struct V_144 * V_144 , T_5 V_167 )
{
struct V_7 * V_29 = V_144 -> V_155 ;
struct V_42 * V_102 , * V_168 ;
unsigned long V_46 ;
if ( V_29 ) {
struct V_24 * V_25 = V_29 -> type ;
F_31 ( & V_25 -> V_48 , V_46 ) ;
...
thread.hardwall[hwt->index].list) {
if ( V_102 -> V_169 == V_167 || V_102 -> V_169 == NULL )
F_64 ( V_25 , V_102 ) ;
}
F_37 ( & V_25 -> V_48 , V_46 ) ;
}
...
int V_85 ;
T_6 V_170 ;
V_85 = F_116 ( & V_170 , 0 , V_81 , L_16 ) ;
if ( V_85 < 0 )
return V_85 ;
F_117 ( & V_171 , & V_172 ) ;
V_85 = F_118 ( & V_171 , V_170 , V_81 ) ;
if ( V_85 < 0 )
return V_85 ;
return 0 ;
}
