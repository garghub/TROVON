...
unsigned long V_46 )
{
V_3 = F_23 ( V_3 , V_44 , V_45 , V_6 , V_46 ) ;
if ( ! F_19 ( ( void * ) V_3 ) )
F_9 () ;
return V_3 ;
}
T_1 long
F_24 ( unsigned long V_47 , unsigned long V_48 , unsigned long V_42 , unsigned long V_4 ,
void * V_49 )
{
return - V_50 ;
}
T_1 long
F_25 ( unsigned long V_47 , unsigned long V_48 , unsigned long V_42 , unsigned long V_4 ,
void * V_49 )
{
return - V_50 ;
}
