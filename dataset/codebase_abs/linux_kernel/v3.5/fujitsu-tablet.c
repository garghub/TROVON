...
static T_3 F_20 ( int V_40 , void * V_41 )
{
...
static void T_2 F_26 ( const struct V_48 * V_49 )
{
F_27 ( L_1 , V_49 -> V_50 ) ;
memcpy ( V_1 . V_7 . V_31 , V_49 -> V_51 ,
sizeof( V_1 . V_7 . V_31 ) ) ;
}
static int T_2 F_28 ( const struct V_48 * V_49 )
{
F_26 ( V_49 ) ;
V_1 . V_7 . V_8 |= V_11 ;
return 1 ;
}
static int T_2 F_29 ( const struct V_48 * V_49 )
{
F_26 ( V_49 ) ;
V_1 . V_7 . V_8 |= V_10 ;
V_1 . V_7 . V_8 |= V_9 ;
...
static T_4 T_2
F_30 ( struct V_52 * V_53 , void * V_54 )
{
switch ( V_53 -> type ) {
case V_55 :
...
static int T_2 F_31 ( struct V_66 * V_67 )
{
T_4 V_68 ;
int error ;
if ( ! V_67 )
...
static int T_5 F_40 ( struct V_66 * V_67 , int type )
{
F_41 ( V_1 . V_40 , F_20 ) ;
F_39 ( V_1 . V_2 , V_1 . V_61 ) ;
F_18 () ;
