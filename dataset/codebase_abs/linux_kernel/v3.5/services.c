...
for ( V_345 = V_1 . V_348 ; V_345 ; V_345 = V_345 -> V_59 ) {
V_178 = F_119 ( & V_1 , V_345 ) ;
if ( V_178 )
goto V_114;
}
V_191 = ++ V_192 ;
...
{
int V_178 , V_349 = 0 , * V_350 = NULL , V_10 ;
char * * V_351 = NULL ;
struct V_352 * V_353 ;
struct V_344 * V_345 ;
V_178 = F_115 ( & V_349 , & V_351 , & V_350 ) ;
if ( V_178 )
goto V_114;
for ( V_10 = 0 ; V_10 < V_349 ; V_10 ++ ) {
V_353 = F_57 ( V_217 -> V_338 . V_113 , V_351 [ V_10 ] ) ;
if ( V_353 )
V_353 -> V_341 = V_350 [ V_10 ] ;
}
for ( V_345 = V_217 -> V_348 ; V_345 ; V_345 = V_345 -> V_59 ) {
V_178 = F_119 ( V_217 , V_345 ) ;
if ( V_178 )
goto V_114;
}
V_114:
...
int F_121 ( T_3 V_206 , T_3 V_354 , T_3 * V_186 )
{
struct V_40 * V_355 ;
struct V_40 * V_356 ;
struct V_40 V_357 ;
...
V_178 = - V_14 ;
V_356 = F_40 ( & V_183 , V_354 ) ;
if ( ! V_356 ) {
F_4 ( V_181 L_17 ,
V_182 , V_354 ) ;
goto V_210;
}
V_357 . V_67 = V_355 -> V_67 ;
V_357 . V_70 = V_355 -> V_70 ;
V_357 . type = V_355 -> type ;
V_178 = F_122 ( & V_357 , V_356 ) ;
if ( V_178 )
goto V_210;
if ( ! F_59 ( & V_1 , & V_357 ) ) {
V_178 = F_78 ( & V_357 ) ;
if ( V_178 ) {
if ( ! F_22 ( & V_357 , & V_56 , & V_201 ) ) {
F_37 ( V_115 -> V_116 , V_16 , V_117 ,
L_44 , V_56 ) ;
F_6 ( V_56 ) ;
}
...
V_178 = - V_14 ;
V_363 = F_40 ( & V_183 , V_360 ) ;
if ( ! V_363 ) {
F_4 ( V_181 L_17 ,
V_182 , V_360 ) ;
goto V_114;
}
V_178 = ( F_124 ( V_362 , V_363 ) ? 0 : - V_230 ) ;
if ( V_178 )
goto V_114;
* V_361 = V_360 ;
V_114:
...
char * V_15 = V_12 , * * V_365 = args ;
int V_21 = V_155 -> V_21 - 1 ;
V_365 [ V_21 ] = F_46 ( V_15 , V_16 ) ;
if ( ! V_365 [ V_21 ] )
return - V_17 ;
return 0 ;
}
int F_126 ( char * * * V_365 , int * V_366 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = - V_17 ;
* V_366 = V_1 . V_143 . V_144 ;
* V_365 = F_2 ( * V_366 , sizeof( * * V_365 ) , V_16 ) ;
if ( ! * V_365 )
goto V_114;
...
int F_128 ( char * V_367 , char * * * V_25 , int * V_368 )
{
int V_178 , V_10 ;
struct V_100 * V_369 ;
F_39 ( & V_180 ) ;
V_178 = - V_14 ;
V_369 = F_57 ( V_1 . V_143 . V_113 , V_367 ) ;
if ( ! V_369 ) {
F_4 ( V_181 L_45 ,
V_182 , V_367 ) ;
goto V_114;
...
V_178 = - V_17 ;
* V_368 = V_369 -> V_96 . V_144 ;
* V_25 = F_2 ( * V_368 , sizeof( * * V_25 ) , V_16 ) ;
if ( ! * V_25 )
goto V_114;
if ( V_369 -> V_112 ) {
V_178 = F_21 ( V_369 -> V_112 -> V_96 . V_113 ,
F_127 , * V_25 ) ;
if ( V_178 )
goto V_24;
}
V_178 = F_21 ( V_369 -> V_96 . V_113 , F_127 ,
* V_25 ) ;
if ( V_178 )
goto V_24;
V_114:
...
int F_131 ( unsigned int V_370 )
{
int V_178 ;
F_39 ( & V_180 ) ;
V_178 = F_13 ( & V_1 . V_271 , V_370 ) ;
F_41 ( & V_180 ) ;
return V_178 ;
}
void F_132 ( void * V_371 )
{
...
int F_133 ( T_3 V_375 , T_3 V_72 , char * V_376 , void * * V_371 )
{
struct V_372 * V_377 ;
struct V_49 * V_378 ;
struct V_122 * V_379 ;
struct V_215 * V_380 ;
struct V_372 * * V_373 = (struct V_372 * * ) V_371 ;
int V_178 = 0 ;
* V_373 = NULL ;
if ( ! V_179 )
return - V_381 ;
...
V_377 = F_134 ( sizeof( struct V_372 ) , V_227 ) ;
if ( ! V_377 )
return - V_17 ;
F_56 ( & V_377 -> V_374 ) ;
F_39 ( & V_180 ) ;
...
case V_385 :
V_178 = - V_14 ;
V_380 = F_57 ( V_1 . V_219 . V_113 , V_376 ) ;
if ( ! V_380 )
goto V_114;
V_377 -> V_374 . V_67 = V_380 -> V_21 ;
break;
case V_383 :
case V_386 :
V_178 = - V_14 ;
V_378 = F_57 ( V_1 . V_220 . V_113 , V_376 ) ;
if ( ! V_378 )
goto V_114;
V_377 -> V_374 . V_70 = V_378 -> V_21 ;
break;
case V_384 :
case V_387 :
V_178 = - V_14 ;
V_379 = F_57 ( V_1 . V_221 . V_113 , V_376 ) ;
if ( ! V_379 )
goto V_114;
V_377 -> V_374 . type = V_379 -> V_21 ;
break;
case V_390 :
case V_391 :
case V_392 :
case V_393 :
V_178 = F_135 ( V_376 , & V_377 -> V_374 , V_16 ) ;
if ( V_178 )
goto V_114;
break;
}
...
int F_136 ( struct V_395 * V_373 )
{
int V_10 ;
for ( V_10 = 0 ; V_10 < V_373 -> V_396 ; V_10 ++ ) {
struct V_397 * V_398 = & V_373 -> V_399 [ V_10 ] ;
switch ( V_398 -> type ) {
case V_382 :
case V_383 :
case V_384 :
...
int F_137 ( T_3 V_206 , T_3 V_375 , T_3 V_72 , void * V_371 ,
struct V_116 * V_400 )
{
struct V_40 * V_401 ;
struct V_52 * V_79 ;
...
int V_369 = 0 ;
if ( ! V_373 ) {
F_37 ( V_400 , V_16 , V_117 ,
L_46 ) ;
return - V_329 ;
}
F_39 ( & V_180 ) ;
if ( V_373 -> V_394 < V_192 ) {
F_37 ( V_400 , V_16 , V_117 ,
L_47 ) ;
V_369 = - V_402 ;
goto V_114;
}
V_401 = F_40 ( & V_183 , V_206 ) ;
if ( ! V_401 ) {
F_37 ( V_400 , V_16 , V_117 ,
L_48 ,
V_206 ) ;
...
switch ( V_72 ) {
case V_388 :
V_369 = ( V_401 -> V_67 == V_373 -> V_374 . V_67 ) ;
break;
case V_389 :
V_369 = ( V_401 -> V_67 != V_373 -> V_374 . V_67 ) ;
break;
...
switch ( V_72 ) {
case V_388 :
V_369 = ( V_401 -> V_70 == V_373 -> V_374 . V_70 ) ;
break;
case V_389 :
V_369 = ( V_401 -> V_70 != V_373 -> V_374 . V_70 ) ;
break;
...
switch ( V_72 ) {
case V_388 :
V_369 = ( V_401 -> type == V_373 -> V_374 . type ) ;
break;
case V_389 :
V_369 = ( V_401 -> type != V_373 -> V_374 . type ) ;
break;
...
V_79 = ( ( V_375 == V_390 ||
V_375 == V_392 ) ?
& V_401 -> V_78 . V_79 [ 0 ] : & V_401 -> V_78 . V_79 [ 1 ] ) ;
switch ( V_72 ) {
case V_388 :
V_369 = F_14 ( & V_373 -> V_374 . V_78 . V_79 [ 0 ] ,
V_79 ) ;
break;
case V_389 :
V_369 = ! F_14 ( & V_373 -> V_374 . V_78 . V_79 [ 0 ] ,
...
break;
case V_403 :
V_369 = ( F_15 ( & V_373 -> V_374 . V_78 . V_79 [ 0 ] ,
V_79 ) &&
! F_14 ( & V_373 -> V_374 . V_78 . V_79 [ 0 ] ,
V_79 ) ) ;
break;
case V_404 :
V_369 = F_15 ( & V_373 -> V_374 . V_78 . V_79 [ 0 ] ,
...
{
T_3 * V_412 ;
V_412 = F_48 ( sizeof( * V_412 ) , V_16 ) ;
if ( V_412 == NULL )
return;
V_411 -> V_413 = F_143 ( V_16 ) ;
if ( V_411 -> V_413 == NULL ) {
F_6 ( V_412 ) ;
return;
}
* V_412 = V_206 ;
V_411 -> V_413 -> free = F_6 ;
V_411 -> V_413 -> V_156 = V_412 ;
V_411 -> V_193 |= V_414 ;
}
int F_144 ( struct V_410 * V_411 ,
T_3 * V_206 )
{
int V_178 ;
struct V_40 * V_212 ;
...
F_39 ( & V_180 ) ;
if ( V_411 -> V_193 & V_414 )
* V_206 = * ( T_3 * ) V_411 -> V_413 -> V_156 ;
else if ( V_411 -> V_193 & V_416 )
* V_206 = V_411 -> V_65 . V_417 ;
else if ( V_411 -> V_193 & V_418 ) {
V_178 = - V_419 ;
V_212 = F_40 ( & V_183 , V_420 ) ;
if ( V_212 == NULL )
goto V_114;
F_56 ( & V_415 ) ;
V_415 . V_67 = V_212 -> V_67 ;
V_415 . V_70 = V_212 -> V_70 ;
V_415 . type = V_212 -> type ;
F_145 ( & V_415 , V_411 ) ;
if ( V_411 -> V_193 & V_421 ) {
V_178 = F_146 ( & V_415 . V_78 . V_79 [ 0 ] . V_422 ,
V_411 -> V_65 . V_423 . V_422 ) ;
if ( V_178 )
goto V_114;
memcpy ( & V_415 . V_78 . V_79 [ 1 ] . V_422 ,
& V_415 . V_78 . V_79 [ 0 ] . V_422 ,
sizeof( V_415 . V_78 . V_79 [ 0 ] . V_422 ) ) ;
}
V_178 = - V_419 ;
if ( ! F_147 ( & V_1 , & V_415 ) )
goto V_424;
V_178 = F_62 ( & V_183 , & V_415 , V_206 ) ;
if ( V_178 )
goto V_424;
F_142 ( V_411 , * V_206 ) ;
F_148 ( & V_415 . V_78 . V_79 [ 0 ] . V_422 ) ;
} else
* V_206 = V_226 ;
F_41 ( & V_180 ) ;
return 0 ;
...
int F_149 ( T_3 V_206 , struct V_410 * V_411 )
{
int V_178 ;
struct V_40 * V_212 ;
if ( ! V_179 )
...
goto V_114;
V_178 = - V_17 ;
V_411 -> V_298 = F_46 ( F_20 ( & V_1 , V_205 , V_212 -> type - 1 ) ,
V_16 ) ;
if ( V_411 -> V_298 == NULL )
goto V_114;
V_411 -> V_65 . V_417 = V_206 ;
V_411 -> V_193 |= V_425 | V_416 ;
F_150 ( V_212 , V_411 ) ;
V_178 = F_151 ( V_212 , V_411 ) ;
V_114:
F_41 ( & V_180 ) ;
return V_178 ;
}
