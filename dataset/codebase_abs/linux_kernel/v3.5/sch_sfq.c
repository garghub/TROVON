...
static int F_70 ( struct V_23 * V_24 , struct V_101 * V_102 )
{
struct V_2 * V_3 = F_7 ( V_24 ) ;
int V_91 ;
V_3 -> V_99 . V_126 = F_43 ;
...
static int F_74 ( struct V_23 * V_24 , struct V_9 * V_10 )
{
struct V_2 * V_3 = F_7 ( V_24 ) ;
unsigned char * V_131 = F_75 ( V_10 ) ;
struct V_105 V_102 ;
...
V_102 . V_60 = V_3 -> V_60 ;
if ( F_76 ( V_10 , V_133 , sizeof( V_102 ) , & V_102 ) )
goto V_134;
return V_10 -> V_51 ;
V_134:
F_77 ( V_10 , V_131 ) ;
...
static struct V_23 * F_78 ( struct V_23 * V_24 , unsigned long V_96 )
{
return NULL ;
}
static unsigned long F_79 ( struct V_23 * V_24 , V_16 V_38 )
{
return 0 ;
}
static unsigned long F_80 ( struct V_23 * V_24 , unsigned long V_135 ,
V_16 V_38 )
{
V_24 -> V_60 &= ~ V_130 ;
return 0 ;
}
static void F_81 ( struct V_23 * V_3 , unsigned long V_136 )
{
}
static struct V_137 * * F_82 ( struct V_23 * V_24 , unsigned long V_136 )
{
struct V_2 * V_3 = F_7 ( V_24 ) ;
if ( V_136 )
return NULL ;
...
static int F_84 ( struct V_23 * V_24 , unsigned long V_136 ,
struct V_141 * V_47 )
{
struct V_2 * V_3 = F_7 ( V_24 ) ;
...
if ( F_85 ( V_47 , & V_144 ) < 0 )
return - 1 ;
return F_86 ( V_47 , & V_146 , sizeof( V_146 ) ) ;
}
static void F_87 ( struct V_23 * V_24 , struct V_148 * V_96 )
{
struct V_2 * V_3 = F_7 ( V_24 ) ;
unsigned int V_91 ;
if ( V_96 -> V_149 )
