...
if ( F_90 ( V_104 , struct V_4 , V_89 ) == V_5 ) {
V_105 = true ;
break;
}
}
...
if ( F_93 ( V_3 ) ) {
unsigned long * V_107 ;
V_107 = F_55 ( V_108 , V_109 ) ;
F_9 ( ( unsigned long ) V_107 & ( V_108 - 1 ) ) ;
if ( ! V_107 )
return NULL ;
* V_3 = F_94 ( F_86 ( V_107 ) ) ;
* V_106 = V_110 ;
F_72 ( V_107 , V_107 + V_110 ) ;
F_72 ( V_3 , V_3 + 1 ) ;
}
return F_3 ( V_3 , V_2 ) ;
}
static int F_95 ( unsigned long * V_3 , T_4 V_111 , short * V_112 )
{
if ( F_96 ( V_3 ) )
return - V_113 ;
if ( F_31 ( V_3 ) ) {
...
static int F_98 ( unsigned long * V_107 , T_4 V_111 , T_5 V_20 ,
short * V_112 )
{
if ( V_20 == V_114 ) {
if ( ! F_99 ( V_107 ) )
...
int V_10 ;
for ( V_10 = 0 ; V_10 < V_115 ; V_10 ++ , V_107 ++ ) {
if ( ! F_99 ( V_107 ) ) {
memset ( V_107 , 0 , sizeof( * V_107 ) * V_10 ) ;
return - V_113 ;
}
* V_107 = F_101 ( V_111 ) ;
}
F_72 ( V_107 - V_115 , V_107 ) ;
* V_112 -= V_115 ;
}
return 0 ;
}
static int F_102 ( struct V_73 * V_66 , unsigned long V_2 ,
T_4 V_111 , T_5 V_20 , int V_116 )
{
struct V_93 * V_94 = V_66 -> V_94 ;
unsigned long * V_117 ;
unsigned long V_32 ;
...
V_117 = F_1 ( V_94 -> V_1 , V_2 ) ;
if ( V_20 == V_118 ) {
V_58 = F_95 ( V_117 , V_111 ,
& V_94 -> V_97 [ F_2 ( V_2 ) ] ) ;
} else {
unsigned long * V_107 ;
V_107 = F_92 ( V_117 , V_2 ,
& V_94 -> V_97 [ F_2 ( V_2 ) ] ) ;
if ( ! V_107 )
V_58 = - V_76 ;
else
V_58 = F_98 ( V_107 , V_111 , V_20 ,
& V_94 -> V_97 [ F_2 ( V_2 ) ] ) ;
}
if ( V_58 ) {
F_103 ( L_27 ,
...
F_9 ( V_20 < V_120 ) ;
memset ( V_46 , 0 , sizeof( * V_46 ) * V_115 ) ;
V_20 = V_120 ;
V_94 -> V_97 [ F_2 ( V_2 ) ] += V_115 ;
V_119:
F_84 ( & V_94 -> V_100 , V_32 ) ;
F_82 ( & V_94 -> V_33 , V_32 ) ;
F_83 (data, &priv->clients, node)
...
V_117 = F_1 ( V_94 -> V_1 , V_2 ) ;
if ( F_96 ( V_117 ) ) {
V_121 = F_108 ( V_117 ) + F_109 ( V_2 ) ;
} else if ( F_31 ( V_117 ) ) {
V_117 = F_3 ( V_117 , V_2 ) ;
if ( F_110 ( V_117 ) )
V_121 = F_111 ( V_117 ) + F_112 ( V_2 ) ;
else if ( F_106 ( V_117 ) )
V_121 = F_113 ( V_117 ) + F_114 ( V_2 ) ;
}
F_84 ( & V_94 -> V_100 , V_32 ) ;
return V_121 ;
}
