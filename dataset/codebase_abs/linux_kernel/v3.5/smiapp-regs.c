...
goto V_34;
if ( V_9 == V_28 && ! V_32 )
V_30 = F_3 ( V_7 , ( T_4 ) V_8 , V_9 , V_10 ) ;
else
V_30 = F_7 ( V_7 , ( T_4 ) V_8 , V_9 , V_10 ) ;
if ( V_30 < 0 )
return V_30 ;
V_34:
if ( V_8 & V_35 )
...
int F_10 ( struct V_6 * V_7 , T_5 V_8 , T_5 * V_10 )
{
return F_8 (
V_7 , V_8 , V_10 ,
F_11 ( V_7 ,
...
int F_12 ( struct V_6 * V_7 , T_5 V_8 , T_5 * V_10 )
{
