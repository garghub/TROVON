...
void T_1 F_35 ( T_2 V_190 ) {}
static inline void F_36 ( unsigned V_201 )
{
if ( V_201 & V_202 )
F_10 ( V_121 , 1 ) ;
if ( V_201 & V_203 )
...
static inline void F_37 ( unsigned V_201 )
{
if ( V_201 & V_202 )
F_9 ( V_208 , 1 ) ;
if ( V_201 & V_203 )
...
void T_1 F_38 ( unsigned V_211 , unsigned V_201 )
{
struct V_71 * V_72 ;
switch ( V_211 ) {
case V_212 :
...
static inline void F_40 ( unsigned V_201 )
{
F_9 ( V_218 , 1 ) ;
F_9 ( V_219 , 0 ) ;
if ( V_201 & V_220 )
...
static inline void F_41 ( unsigned V_201 )
{
F_9 ( V_224 , 1 ) ;
F_9 ( V_225 , 0 ) ;
if ( V_201 & V_220 )
...
static inline void F_42 ( unsigned V_201 )
{
F_9 ( V_226 , 1 ) ;
F_9 ( V_227 , 0 ) ;
if ( V_201 & V_220 )
...
void T_1 F_43 ( unsigned V_211 , unsigned V_228 , unsigned V_201 )
{
struct V_71 * V_72 ;
struct V_229 * V_230 ;
switch ( V_211 ) {
