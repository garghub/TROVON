...
static int V_26 ( struct V_68 * V_69 , const struct V_39 * V_40 ,
struct V_70 * V_71 )
{
int V_9 = 0 , V_72 = 0 ;
struct V_26 * V_27 = V_40 -> V_67 ;
...
static int F_33 ( struct V_68 * V_69 , struct V_39 * V_40 , int V_28 , int V_93 )
{
unsigned char * V_94 = F_34 ( V_69 ) ;
struct V_26 * V_27 = V_40 -> V_67 ;
struct V_1 * V_2 ;
struct V_95 V_96 ;
struct V_97 V_98 ;
...
if ( F_35 ( V_69 , V_53 , V_27 -> V_31 -> V_11 . V_12 . V_22 , V_2 ) ||
F_36 ( V_69 , V_54 , V_27 -> V_102 ) ||
F_36 ( V_69 , V_52 , V_27 -> V_66 ) ||
F_35 ( V_69 , V_103 , sizeof( struct V_97 ) , & V_98 ) ||
F_37 ( V_69 , V_62 , V_27 -> V_32 ) )
goto V_99;
V_96 . V_104 = F_38 ( V_78 - V_27 -> V_76 . V_104 ) ;
V_96 . V_77 = F_38 ( V_78 - V_27 -> V_76 . V_77 ) ;
V_96 . V_105 = F_38 ( V_27 -> V_76 . V_105 ) ;
if ( F_35 ( V_69 , V_106 , sizeof ( V_96 ) , & V_96 ) )
goto V_99;
F_9 ( V_2 ) ;
return V_69 -> V_107 ;
V_99:
