...
return - V_32 ;
V_25 -> V_33 = V_2 ;
V_28 = F_14 ( V_2 -> V_8 , sizeof( * V_29 ) , V_34 ) ;
if ( ! V_28 )
return - V_35 ;
V_28 -> V_8 = V_8 ;
F_15 ( & V_2 -> V_36 ) ;
...
V_42 = F_28 ( V_40 ) ;
if ( ! F_29 ( V_42 ) ) {
F_17 ( V_2 -> V_8 , L_11 , V_40 ) ;
F_11 ( & V_2 -> V_14 , V_13 ) ;
return - V_32 ;
}
F_1 ( V_2 , V_11 , F_30 ( V_42 ) ) ;
F_8 ( V_2 ) ;
F_11 ( & V_2 -> V_14 , V_13 ) ;
return 0 ;
}
...
return - V_51 ;
F_38 ( V_52 != V_53 ) ;
V_48 = F_39 ( V_46 , V_54 , 0 ) ;
V_49 = F_39 ( V_46 , V_54 , 1 ) ;
if ( ! V_48 || ! V_49 ) {
F_17 ( V_8 , L_13 ) ;
return - V_55 ;
}
V_2 = F_14 ( V_8 , sizeof( * V_2 ) , V_34 ) ;
if ( ! V_2 ) {
F_17 ( V_8 , L_14 ) ;
return - V_35 ;
}
V_50 = F_40 ( V_8 , V_48 -> V_56 , F_41 ( V_48 ) ) ;
if ( ! V_50 ) {
F_17 ( V_8 , L_15 ) ;
V_30 = - V_55 ;
goto V_37;
...
F_43 ( & V_2 -> V_28 ) ;
V_2 -> V_5 = V_50 ;
V_2 -> V_21 = ( V_57 ) V_49 -> V_56 ;
V_2 -> V_22 = ( F_41 ( V_49 ) >> V_53 ) ;
