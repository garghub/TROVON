...
static int F_144 ( struct V_90 * V_90 , T_2 V_55 )
{
...
static void F_145 ( struct V_155 * V_156 ,
struct V_92 * V_93 ,
struct V_90 * V_90 ,
T_2 V_55 )
{
...
if ( V_93 -> V_157 < V_158 * 10 )
V_93 -> V_157 ++ ;
if ( V_93 -> V_157 > V_158 )
return;
V_94 = F_148 ( V_93 -> V_94 ) ;
V_93 -> V_17 = F_149 ( long , 0 , V_55 - V_94 / 2 ) ;
V_93 -> V_123 = V_94 ;
V_93 -> V_159 = V_94 / 4 ;
F_150 ( V_93 , V_3 , V_90 ) ;
}
static void F_151 ( struct V_155 * V_156 ,
struct V_92 * V_93 ,
struct V_90 * V_90 ,
struct V_1 * V_1 ,
T_2 V_55 )
...
int F_152 ( struct V_155 * V_156 , struct V_160 * V_161 )
{
int error ;
struct V_90 * V_90 = V_156 -> V_162 ;
struct V_2 * V_3 = V_90 -> V_98 ;
struct V_92 * V_93 = & V_90 -> V_100 ;
struct V_99 * V_99 = V_3 -> V_46 ;
T_2 V_55 = V_161 -> V_163 ;
struct V_1 * V_1 ;
T_2 V_123 ;
int V_20 = 0 ;
...
V_1 = F_96 ( V_3 , V_55 ) ;
if ( F_56 ( V_1 ) ) {
F_151 ( V_156 , V_93 , V_90 , V_1 , V_55 ) ;
} else {
F_145 ( V_156 , V_93 , V_90 , V_55 ) ;
F_153 ( V_165 ) ;
F_154 ( V_156 -> V_166 , V_165 ) ;
V_20 = V_167 ;
V_168:
V_1 = F_96 ( V_3 , V_55 ) ;
if ( ! V_1 )
...
if ( ! F_155 ( V_1 , V_156 -> V_166 , V_161 -> V_42 ) ) {
F_21 ( V_1 ) ;
return V_20 | V_169 ;
}
if ( F_100 ( V_1 -> V_3 != V_3 ) ) {
...
int F_157 ( struct V_90 * V_90 , struct V_155 * V_156 )
{
struct V_2 * V_3 = V_90 -> V_98 ;
if ( ! V_3 -> V_12 -> V_119 )
return - V_173 ;
...
int F_158 ( struct V_90 * V_90 , struct V_155 * V_156 )
{
if ( ( V_156 -> V_176 & V_178 ) && ( V_156 -> V_176 & V_179 ) )
return - V_140 ;
return F_157 ( V_90 , V_156 ) ;
}
int F_157 ( struct V_90 * V_90 , struct V_155 * V_156 )
{
return - V_180 ;
...
static struct V_1 * F_159 ( struct V_2 * V_3 ,
T_2 V_5 ,
int (* F_160)( void * , struct V_1 * ) ,
void * V_181 ,
T_3 V_59 )
{
struct V_1 * V_1 ;
...
int V_47 ;
V_183:
V_1 = F_159 ( V_3 , V_5 , F_160 , V_181 , V_59 ) ;
if ( F_163 ( V_1 ) )
return V_1 ;
if ( F_2 ( V_1 ) )
goto V_58;
...
struct V_1 * F_164 ( struct V_2 * V_3 ,
T_2 V_5 ,
int (* F_160)( void * , struct V_1 * ) ,
void * V_181 )
{
return F_162 ( V_3 , V_5 , F_160 , V_181 , F_117 ( V_3 ) ) ;
}
static struct V_1 * F_165 ( struct V_1 * V_1 )
{
if ( ! F_163 ( V_1 ) ) {
F_95 ( V_1 ) ;
if ( ! F_2 ( V_1 ) ) {
...
T_3 V_59 )
{
T_9 * F_160 = ( T_9 * ) V_3 -> V_12 -> V_119 ;
return F_165 ( F_162 ( V_3 , V_5 , F_160 , NULL , V_59 ) ) ;
}
...
void * V_181 )
{
return F_165 ( F_164 ( V_3 , V_5 , F_160 , V_181 ) ) ;
}
static T_8 F_168 ( char * V_184 ,
const struct V_131 * V_132 , T_8 V_185 , T_8 V_186 )
{
T_8 V_187 = 0 , V_125 = 0 ;
while ( V_186 ) {
char T_10 * V_127 = V_132 -> V_141 + V_185 ;
int V_188 = F_36 ( V_186 , V_132 -> V_138 - V_185 ) ;
V_185 = 0 ;
V_125 = F_169 ( V_184 , V_127 , V_188 ) ;
V_187 += V_188 ;
V_186 -= V_188 ;
V_184 += V_188 ;
V_132 ++ ;
...
T_8 F_170 ( struct V_1 * V_1 ,
struct V_189 * V_38 , unsigned long V_55 , T_8 V_186 )
{
char * V_124 ;
T_8 V_187 ;
F_9 ( ! F_171 () ) ;
...
int V_125 ;
char T_10 * V_127 = V_38 -> V_132 -> V_141 + V_38 -> V_190 ;
V_125 = F_169 ( V_124 + V_55 , V_127 , V_186 ) ;
V_187 = V_186 - V_125 ;
} else {
V_187 = F_168 ( V_124 + V_55 ,
V_38 -> V_132 , V_38 -> V_190 , V_186 ) ;
}
F_134 ( V_124 ) ;
return V_187 ;
}
T_8 F_172 ( struct V_1 * V_1 ,
struct V_189 * V_38 , unsigned long V_55 , T_8 V_186 )
{
char * V_124 ;
T_8 V_187 ;
...
int V_125 ;
char T_10 * V_127 = V_38 -> V_132 -> V_141 + V_38 -> V_190 ;
V_125 = F_173 ( V_124 + V_55 , V_127 , V_186 ) ;
V_187 = V_186 - V_125 ;
} else {
V_187 = F_168 ( V_124 + V_55 ,
V_38 -> V_132 , V_38 -> V_190 , V_186 ) ;
...
void F_174 ( struct V_189 * V_38 , T_8 V_186 )
{
F_9 ( V_38 -> V_106 < V_186 ) ;
if ( F_56 ( V_38 -> V_133 == 1 ) ) {
V_38 -> V_190 += V_186 ;
V_38 -> V_106 -= V_186 ;
} else {
const struct V_131 * V_132 = V_38 -> V_132 ;
T_8 V_185 = V_38 -> V_190 ;
unsigned long V_133 = V_38 -> V_133 ;
while ( V_186 || F_100 ( V_38 -> V_106 && ! V_132 -> V_138 ) ) {
int V_188 ;
V_188 = F_36 ( V_186 , V_132 -> V_138 - V_185 ) ;
F_9 ( ! V_38 -> V_106 || V_38 -> V_106 < V_188 ) ;
V_38 -> V_106 -= V_188 ;
V_186 -= V_188 ;
V_185 += V_188 ;
if ( V_132 -> V_138 == V_185 ) {
V_132 ++ ;
V_133 -- ;
V_185 = 0 ;
}
...
int F_175 ( struct V_189 * V_38 , T_8 V_186 )
{
char T_10 * V_127 = V_38 -> V_132 -> V_141 + V_38 -> V_190 ;
V_186 = F_36 ( V_186 , V_38 -> V_132 -> V_138 - V_38 -> V_190 ) ;
return F_176 ( V_127 , V_186 ) ;
}
T_8 F_177 ( struct V_189 * V_38 )
{
const struct V_131 * V_132 = V_38 -> V_132 ;
if ( V_38 -> V_133 == 1 )
return V_38 -> V_106 ;
else
return F_36 ( V_38 -> V_106 , V_132 -> V_138 - V_38 -> V_190 ) ;
}
inline int F_178 ( struct V_90 * V_90 , T_1 * V_144 , T_8 * V_106 , int V_191 )
{
struct V_99 * V_99 = V_90 -> V_98 -> V_46 ;
unsigned long V_192 = F_179 ( V_193 ) ;
if ( F_100 ( * V_144 < 0 ) )
return - V_140 ;
if ( ! V_191 ) {
if ( V_90 -> V_149 & V_194 )
...
if ( * V_106 > V_192 - ( F_181 ( V_192 ) ) * V_144 ) {
* V_106 = V_192 - ( F_181 ( V_192 ) ) * V_144 ;
}
}
}
if ( F_100 ( * V_144 + * V_106 > V_198 &&
! ( V_90 -> V_149 & V_199 ) ) ) {
if ( * V_144 >= V_198 ) {
return - V_197 ;
}
if ( * V_106 > V_198 - ( unsigned long ) * V_144 ) {
* V_106 = V_198 - ( unsigned long ) * V_144 ;
}
}
if ( F_56 ( ! V_191 ) ) {
if ( F_100 ( * V_144 >= V_99 -> V_200 -> V_201 ) ) {
if ( * V_106 || * V_144 > V_99 -> V_200 -> V_201 ) {
return - V_197 ;
}
}
if ( F_100 ( * V_144 + * V_106 > V_99 -> V_200 -> V_201 ) )
* V_106 = V_99 -> V_200 -> V_201 - * V_144 ;
} else {
#ifdef F_182
T_1 V_109 ;
if ( F_183 ( F_184 ( V_99 ) ) )
...
int F_185 ( struct V_90 * V_90 , struct V_2 * V_3 ,
T_1 V_144 , unsigned V_203 , unsigned V_42 ,
struct V_1 * * V_80 , void * * V_204 )
{
const struct V_205 * V_206 = V_3 -> V_12 ;
return V_206 -> V_207 ( V_90 , V_3 , V_144 , V_203 , V_42 ,
V_80 , V_204 ) ;
}
int F_186 ( struct V_90 * V_90 , struct V_2 * V_3 ,
T_1 V_144 , unsigned V_203 , unsigned V_187 ,
struct V_1 * V_1 , void * V_204 )
{
const struct V_205 * V_206 = V_3 -> V_12 ;
F_125 ( V_1 ) ;
return V_206 -> V_208 ( V_90 , V_3 , V_144 , V_203 , V_187 , V_1 , V_204 ) ;
}
V_139
F_187 ( struct V_142 * V_143 , const struct V_131 * V_132 ,
...
T_2 V_18 ;
if ( V_106 != V_209 )
* V_133 = F_188 ( (struct V_131 * ) V_132 , * V_133 , V_106 ) ;
V_210 = F_141 ( V_132 , * V_133 ) ;
V_18 = ( V_144 + V_210 - 1 ) >> V_32 ;
V_130 = F_45 ( V_3 , V_144 , V_144 + V_210 - 1 ) ;
if ( V_130 )
goto V_58;
if ( V_3 -> V_6 ) {
V_130 = F_189 ( V_3 ,
...
V_130 = V_3 -> V_12 -> V_153 ( V_212 , V_143 , V_132 , V_144 , * V_133 ) ;
if ( V_3 -> V_6 ) {
F_189 ( V_3 ,
V_144 >> V_32 , V_18 ) ;
}
if ( V_130 > 0 ) {
V_144 += V_130 ;
if ( V_144 > F_43 ( V_99 ) && ! F_190 ( V_99 -> V_213 ) ) {
F_191 ( V_99 , V_144 ) ;
F_192 ( V_99 ) ;
}
* V_95 = V_144 ;
...
struct V_1 * F_193 ( struct V_2 * V_3 ,
...
static V_139 F_194 ( struct V_90 * V_90 ,
struct V_189 * V_38 , T_1 V_144 )
{
struct V_2 * V_3 = V_90 -> V_98 ;
const struct V_205 * V_12 = V_3 -> V_12 ;
long V_214 = 0 ;
V_139 V_130 = 0 ;
unsigned int V_42 = 0 ;
if ( F_195 ( F_196 () , V_219 ) )
V_42 |= V_220 ;
do {
struct V_1 * V_1 ;
unsigned long V_55 ;
...
void * V_204 ;
V_55 = ( V_144 & ( V_105 - 1 ) ) ;
V_186 = F_197 (unsigned long, PAGE_CACHE_SIZE - offset,
iov_iter_count(i)) ;
V_221:
if ( F_100 ( F_175 ( V_38 , V_186 ) ) ) {
V_214 = - V_129 ;
break;
}
V_214 = V_12 -> V_207 ( V_90 , V_3 , V_144 , V_186 , V_42 ,
& V_1 , & V_204 ) ;
if ( F_100 ( V_214 ) )
break;
if ( F_123 ( V_3 ) )
F_124 ( V_1 ) ;
F_198 () ;
V_187 = F_170 ( V_1 , V_38 , V_55 , V_186 ) ;
F_199 () ;
F_124 ( V_1 ) ;
F_125 ( V_1 ) ;
V_214 = V_12 -> V_208 ( V_90 , V_3 , V_144 , V_186 , V_187 ,
V_1 , V_204 ) ;
if ( F_100 ( V_214 < 0 ) )
break;
V_187 = V_214 ;
...
return V_130 ? V_130 : V_214 ;
}
V_139
F_202 ( struct V_142 * V_143 , const struct V_131 * V_132 ,
unsigned long V_133 , T_1 V_144 , T_1 * V_95 ,
...
V_139 V_214 ;
struct V_189 V_38 ;
F_203 ( & V_38 , V_132 , V_133 , V_106 , V_130 ) ;
V_214 = F_194 ( V_90 , & V_38 , V_144 ) ;
if ( F_56 ( V_214 >= 0 ) ) {
V_130 += V_214 ;
* V_95 = V_144 + V_214 ;
}
...
V_139 F_204 ( struct V_142 * V_143 , const struct V_131 * V_132 ,
...
V_139 V_47 ;
V_209 = 0 ;
V_47 = F_138 ( V_132 , & V_133 , & V_209 , V_222 ) ;
if ( V_47 )
return V_47 ;
V_106 = V_209 ;
V_144 = * V_95 ;
F_205 ( V_99 -> V_200 , V_223 ) ;
V_15 -> V_10 = V_3 -> V_10 ;
V_130 = 0 ;
V_47 = F_178 ( V_90 , & V_144 , & V_106 , F_190 ( V_99 -> V_213 ) ) ;
if ( V_47 )
goto V_58;
if ( V_106 == 0 )
goto V_58;
...
T_1 V_224 ;
V_139 V_225 ;
V_130 = F_187 ( V_143 , V_132 , & V_133 , V_144 ,
V_95 , V_106 , V_209 ) ;
if ( V_130 < 0 || V_130 == V_106 )
goto V_58;
V_144 += V_130 ;
V_106 -= V_130 ;
V_225 = F_202 ( V_143 , V_132 ,
...
V_224 = V_144 + V_225 - V_130 - 1 ;
V_47 = F_45 ( V_90 -> V_98 , V_144 , V_224 ) ;
if ( V_47 == 0 ) {
V_130 = V_225 ;
F_208 ( V_3 ,
V_144 >> V_32 ,
...
V_139 F_209 ( struct V_142 * V_143 , const struct V_131 * V_132 ,
unsigned long V_133 , T_1 V_144 )
{
struct V_90 * V_90 = V_143 -> V_145 ;
struct V_99 * V_99 = V_90 -> V_98 -> V_46 ;
...
F_210 ( & V_99 -> V_226 ) ;
F_142 ( & V_152 ) ;
V_20 = F_204 ( V_143 , V_132 , V_133 , & V_143 -> V_147 ) ;
F_211 ( & V_99 -> V_226 ) ;
if ( V_20 > 0 || V_20 == - V_227 ) {
V_139 V_47 ;
V_47 = F_212 ( V_90 , V_144 , V_20 ) ;
if ( V_47 < 0 && V_20 > 0 )
V_20 = V_47 ;
}
F_143 ( & V_152 ) ;
...
int F_213 ( struct V_1 * V_1 , T_3 V_53 )
{
...
return V_3 -> V_12 -> V_228 ( V_1 , V_53 ) ;
return F_215 ( V_1 ) ;
}
