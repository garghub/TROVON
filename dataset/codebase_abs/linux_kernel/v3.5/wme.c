...
const T_2 * V_20 = NULL ;
bool V_21 = false ;
if ( V_5 -> V_11 . V_12 < V_13 || V_2 -> V_22 < 6 ) {
V_2 -> V_3 = 0 ;
return 0 ;
}
F_10 () ;
switch ( V_17 -> V_23 . type ) {
case V_24 :
V_19 = F_11 ( V_17 -> V_25 . V_26 . V_19 ) ;
if ( V_19 ) {
V_21 = F_12 ( V_19 , V_27 ) ;
break;
}
