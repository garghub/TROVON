...
goto V_101;
V_85 . V_102 = F_46 ( V_83 - V_11 -> V_68 ) ;
V_85 . V_103 = 0 ;
V_85 . V_104 = F_46 ( V_83 - V_11 -> V_13 ) ;
V_85 . V_105 = 0 ;
if ( F_63 ( V_79 , V_106 , sizeof( V_85 ) , & V_85 ) )
goto V_101;
return F_64 ( V_79 , V_87 ) ;
V_101:
F_65 ( V_79 , V_87 ) ;
return - V_90 ;
}
static inline T_4 F_66 ( void )
{
return F_67 ( sizeof( struct V_88 ) )
+ F_68 ( V_61 )
+ F_68 ( sizeof( struct V_84 ) ) ;
}
static void F_17 ( struct V_6 * V_7 ,
const struct V_2 * V_11 , int type )
{
struct V_107 * V_107 = F_69 ( V_7 -> V_35 ) ;
struct V_78 * V_79 ;
int V_108 = - V_109 ;
V_79 = F_70 ( F_66 () , V_67 ) ;
if ( V_79 == NULL )
...
F_73 ( V_79 , V_107 , 0 , V_111 , NULL , V_67 ) ;
return;
V_110:
if ( V_108 < 0 )
F_74 ( V_107 , V_111 , V_108 ) ;
}
int F_75 ( struct V_78 * V_79 ,
struct V_112 * V_113 ,
struct V_48 * V_35 ,
int V_114 )
{
struct V_6 * V_7 = F_76 ( V_35 ) ;
int V_28 ;
if ( ! ( V_35 -> V_115 & V_116 ) )
goto V_59;
for ( V_28 = 0 ; V_28 < V_17 ; V_28 ++ ) {
...
static int F_78 ( struct V_25 * V_66 , const T_5 * V_37 ,
T_6 V_51 , T_6 V_82 )
{
...
int F_79 ( struct V_88 * V_89 , struct V_48 * V_35 ,
unsigned char * V_37 , T_7 V_123 )
{
struct V_25 * V_26 ;
int V_108 = 0 ;
...
F_20 ( & V_26 -> V_7 -> V_29 ) ;
V_108 = F_78 ( V_26 , V_37 , V_89 -> V_99 , V_123 ) ;
F_26 ( & V_26 -> V_7 -> V_29 ) ;
}
return V_108 ;
}
static int F_82 ( struct V_25 * V_26 , T_3 * V_37 )
{
struct V_6 * V_7 = V_26 -> V_7 ;
struct V_65 * V_19 = & V_7 -> V_69 [ F_9 ( V_37 ) ] ;
struct V_2 * V_11 ;
...
int F_83 ( struct V_88 * V_89 , struct V_48 * V_35 ,
unsigned char * V_37 )
{
struct V_25 * V_26 ;
int V_108 ;
