...
static void F_103 ( struct V_176 * V_16 )
{
struct V_130 * V_131 = F_104 ( V_16 ) ;
struct V_177 * V_178 =
F_105 ( V_131 -> V_172 ) ;
F_106 ( & V_178 -> V_179 , V_180 ) ;
F_20 ( V_131 ) ;
}
static int F_107 ( struct V_176 * V_16 , struct V_181 * V_182 )
{
struct V_22 * V_23 ;
struct V_130 * V_131 ;
struct V_132 * V_133 ;
...
L_22
L_23 ,
F_109 ( V_23 -> V_122 . V_186 ) ,
F_109 ( V_23 -> V_122 . V_187 ) ,
F_109 ( V_23 -> V_122 . V_188 ) ,
V_23 -> V_122 . V_189 ,
V_23 -> V_122 . V_190 ,
V_23 -> V_122 . V_191 ,
V_133 -> V_20 . V_183 ,
...
static struct V_192 * F_110 ( struct V_22 * V_16 ,
struct V_170 * V_171 ,
V_96 V_193 )
{
...
static void F_111 ( struct V_200 * V_201 )
{
int V_103 ;
struct V_130 * V_163 =
F_112 ( V_201 , struct V_130 , V_202 ) ;
struct V_22 * V_117 = F_68 ( V_163 ) ;
V_103 = F_113 ( V_117 , V_163 ) ;
if ( V_103 >= 0 ) {
V_163 -> V_203 = 1 ;
F_114 ( V_117 ) ;
V_163 -> V_203 = 0 ;
...
int F_116 ( struct V_22 * V_16 , int V_204 )
{
int V_61 , V_38 ;
...
V_133 = & V_131 -> V_172 [ 0 ] ;
V_131 -> V_194 =
F_110 ( V_16 , V_205 , V_133 -> V_20 . V_215 ) ;
V_131 -> V_134 = V_133 ;
F_91 ( V_16 , V_131 , true ) ;
...
F_122 ( & V_131 -> V_202 , F_111 ) ;
V_131 -> V_222 = - 1 ;
F_123 ( & V_131 -> V_16 ) ;
F_124 ( & V_131 -> V_16 ) ;
F_125 ( & V_131 -> V_16 , L_30 ,
V_16 -> V_58 -> V_223 , V_16 -> V_60 ,
V_204 , V_133 -> V_20 . V_215 ) ;
}
F_20 ( V_206 ) ;
...
V_131 -> V_134 -> V_20 . V_215 ) ;
F_126 ( & V_131 -> V_16 ) ;
V_38 = F_127 ( & V_131 -> V_16 ) ;
if ( V_38 != 0 ) {
F_29 ( & V_16 -> V_16 , L_32 ,
...
static void F_128 ( struct V_200 * V_226 )
{
struct V_227 * V_228 =
F_112 ( V_226 , struct V_227 , V_226 ) ;
...
F_30 ( & V_229 ) ;
if ( V_228 -> V_171 >= - 1 )
F_116 ( V_117 , V_228 -> V_171 ) ;
F_115 ( V_117 ) ;
F_131 ( V_117 ) ;
F_20 ( V_228 ) ;
}
static void F_119 ( struct V_22 * V_117 )
{
struct V_227 * V_228 ;
F_28 ( & V_229 ) ;
F_132 (req, &set_config_list, node) {
if ( V_228 -> V_117 == V_117 )
V_228 -> V_171 = - 999 ;
}
F_30 ( & V_229 ) ;
}
int F_133 ( struct V_22 * V_117 , int V_171 )
{
struct V_227 * V_228 ;
...
V_228 -> V_117 = V_117 ;
V_228 -> V_171 = V_171 ;
F_122 ( & V_228 -> V_226 , F_128 ) ;
F_28 ( & V_229 ) ;
F_134 ( & V_228 -> V_230 , & V_231 ) ;
F_30 ( & V_229 ) ;
F_135 ( V_117 ) ;
F_136 ( & V_228 -> V_226 ) ;
return 0 ;
