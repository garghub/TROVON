...
F_40 ( V_10 , V_10 -> V_97 + V_93 + V_3 ) ;
if ( ( V_52 -> V_58 & V_96 ) == 0 )
F_39 ( V_10 , V_52 ) ;
return 1 ;
}
static
int F_45 ( struct V_9 * V_10 , struct V_51 * V_52 )
{
T_1 V_98 ;
char * V_71 = V_52 -> V_71 ;
V_71 [ 0 ] = '\0' ;
...
if ( V_98 ) {
F_46 ( V_10 , V_98 ) ;
F_47 ( V_10 , V_71 , V_10 -> V_97 + V_98 , 252 ) ;
V_71 [ 252 ] = '\0' ;
F_46 ( V_10 , V_99 ) ;
}
if ( ( V_52 -> V_58 & V_96 ) == 0 )
...
V_103 = & V_52 -> V_12 ;
for ( V_3 = 0 ; V_3 < 4 ; V_3 ++ )
( & V_103 -> V_2 ) [ V_3 ] = F_40 ( V_10 , & V_12 -> V_2 + V_3 ) ;
for ( V_3 = 0 ; V_3 < 2 ; V_3 ++ )
( & V_103 -> V_18 ) [ V_3 ] = F_40 ( V_10 , & V_12 -> V_18 + V_3 ) ;
...
V_113 = F_19 ( ( V_107 -> V_58 & V_126 ) ? 10 : 20 ) ;
F_60 ( L_32 ,
V_108 , V_107 -> V_13 ) ;
F_61 ( V_70 , & V_114 , V_127 ) ;
F_43 ( V_10 , V_108 , V_128 , V_108 , V_108 ) ;
V_112 = V_48 ;
...
return 0 ;
case V_140 :
return F_68 ( V_10 , V_141 , 6 ,
V_21 -> V_53 , 0 , 0 , 0 , 0 , V_5 [ 0 ] ) ;
case V_142 :
return F_68 ( V_10 , V_143 , 3 ,
V_21 -> V_53 , V_5 [ 1 ] , V_5 [ 0 ] ) ;
case V_144 :
return F_68 ( V_10 , V_145 , 2 ,
V_21 -> V_53 , V_5 [ 0 ] ) ;
case V_146 :
return F_68 ( V_10 , V_147 , 2 ,
V_21 -> V_53 , V_5 [ 0 ] ) ;
case V_148 :
return F_68 ( V_10 , V_149 , 3 ,
V_21 -> V_53 , V_5 [ 0 ] , V_5 [ 1 ] ) ;
case V_150 :
return 0 ;
case V_151 :
return F_68 ( V_10 , V_152 , 2 ,
V_21 -> V_53 , V_5 [ 0 ] ) ;
case V_153 :
return F_68 ( V_10 , V_154 , 2 ,
V_21 -> V_53 , V_5 [ 0 ] ) ;
case V_155 :
return F_68 ( V_10 , V_156 , 5 ,
V_21 -> V_53 , V_5 [ 0 ] , V_5 [ 1 ] , V_5 [ 2 ] , V_5 [ 3 ] ) ;
case V_157 :
return F_68 ( V_10 , V_158 , 2 ,
V_21 -> V_53 , V_5 [ 0 ] ) ;
case V_159 :
return F_68 ( V_10 , V_160 , 2 ,
V_21 -> V_53 , V_5 [ 0 ] ) ;
case V_161 :
return F_68 ( V_10 , V_162 , 4 ,
...
return F_67 ( V_21 ) ;
case V_165 :
return F_68 ( V_10 , V_166 , 3 ,
V_21 -> V_53 , V_5 [ 0 ] , V_5 [ 1 ] ) ;
case V_167 :
return F_68 ( V_10 , V_168 , 5 ,
V_21 -> V_53 , V_5 [ 0 ] , V_5 [ 1 ] , V_5 [ 2 ] , V_5 [ 3 ] ) ;
}
F_24 ( L_43 , V_2 ) ;
return 0 ;
