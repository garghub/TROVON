...
unsigned int F_36 ( struct V_10 * V_11 , T_6 * V_75 )
{
unsigned int V_76 = 0 ;
...
V_80 = F_39 ( & V_22 . V_81 , 0 , 1 , L_10 ) ;
if ( V_80 < 0 )
return V_80 ;
F_7 ( L_11 , F_40 ( V_22 . V_81 ) ,
F_41 ( V_22 . V_81 ) ) ;
F_42 ( & V_22 . V_15 , & V_82 ) ;
V_22 . V_15 . V_83 = V_84 ;
V_22 . V_15 . V_85 = & V_82 ;
F_43 ( & V_22 . V_23 ) ;
F_44 ( & V_22 . V_79 ) ;
V_80 = F_45 ( & V_22 . V_15 , V_22 . V_81 , 1 ) ;
return 0 ;
}
int F_46 ( void )
{
...
int F_53 ( struct V_2 * V_3 , int V_87 )
{
struct V_1 * V_4 ;
struct V_1 * V_88 = 0 ;
F_50 ( V_86 , 3 , V_6 , 0 , V_87 ) ;
if ( V_87 ) {
F_7 ( L_12 ) ;
return 0 ;
}
V_4 = F_54 ( sizeof( struct V_1 ) , V_89 ) ;
if ( V_4 == 0 )
return - V_90 ;
F_55 ( & V_4 -> V_8 , 1 ) ;
V_4 -> V_47 = 1 ;
...
F_21 ( & V_22 . V_23 ) ;
if ( ( V_22 . V_24 == 0 ) &&
( memcmp ( V_3 -> V_91 , V_22 . V_51 , V_52 ) == 0 ) ) {
F_15 ( V_3 ) ;
V_22 . V_24 = V_3 ;
F_7 ( L_13 ) ;
}
...
void F_56 ( struct V_2 * V_3 , int V_92 )
{
struct V_1 * V_4 ;
F_50 ( V_86 , 4 , V_6 , 0 , V_92 ) ;
if ( V_92 ) {
F_7 ( L_15 ) ;
return;
}
...
void F_57 ( struct V_2 * V_3 , struct V_35 * V_36 )
{
struct V_1 * V_4 ;
struct V_37 * V_38 ;
T_5 * V_41 ;
...
V_4 -> V_96 = V_38 -> V_46 ;
V_93 = V_36 -> V_42 - sizeof( struct V_37 ) ;
V_41 = ( ( T_5 * ) ( V_36 + 1 ) ) + sizeof( struct V_37 ) ;
if ( V_93 <= 0 )
goto V_40;
V_94 = V_4 -> V_27 - V_4 -> V_26 - 1 ;
if ( V_94 < 0 )
V_94 += V_28 ;
if ( V_93 > V_94 ) {
F_7 ( L_20 , V_93 , V_94 ) ;
...
if ( V_95 > V_93 )
V_95 = V_93 ;
memcpy ( & V_4 -> V_29 [ V_21 ] , V_41 , V_95 ) ;
V_93 -= V_95 ;
V_21 += V_95 ;
if ( V_21 == V_28 )
V_21 = 0 ;
if ( V_93 ) {
memcpy ( V_4 -> V_29 , V_41 + V_95 , V_93 ) ;
V_21 = V_93 ;
}
V_4 -> V_26 = V_21 ;
F_58 ( & V_22 . V_79 ) ;
