...
V_9 = F_22 ( sizeof( * V_9 ) , V_54 ) ;
if ( ! V_9 )
return - V_55 ;
V_9 -> V_56 = F_22 ( sizeof( * V_13 ) * V_33 -> V_1 , V_54 ) ;
if ( ! V_9 -> V_56 ) {
V_39 = - V_55 ;
goto V_57;
}
...
snprintf ( V_13 -> V_50 ,
sizeof( V_13 -> V_50 ) , L_6 ,
V_37 -> V_56 [ V_38 ] . V_50 ) ;
if ( V_37 -> V_56 [ V_38 ] . V_58 )
V_13 -> V_27 . V_58 =
V_37 -> V_56 [ V_38 ] . V_58 ;
} else {
snprintf ( V_13 -> V_50 , sizeof( V_13 -> V_50 ) ,
L_7 , V_38 ) ;
}
V_13 -> V_27 . V_50 = V_13 -> V_50 ;
V_13 -> V_27 . V_59 = F_15 ;
F_25 ( & V_13 -> V_12 , F_11 ) ;
V_39 = F_26 ( & V_6 -> V_42 ,
& V_13 -> V_27 ) ;
...
exit:
while ( V_38 -- ) {
F_27 ( & V_9 -> V_56 [ V_38 ] . V_27 ) ;
F_28 ( & V_9 -> V_56 [ V_38 ] . V_12 ) ;
}
F_29 ( V_9 -> V_56 ) ;
V_57:
F_29 ( V_9 ) ;
