...
F_346 () ) ;
V_13 -> V_152 = F_348 ( V_105 , V_24 -> V_7 . V_8 ) ;
} else
...
static void T_13 F_349 ( struct V_1 * V_24 , int V_108 )
{
int V_105 ;
struct V_14 * V_26 ;
...
static int T_13 F_350 ( struct V_1 * V_24 )
{
int V_728 = 0 ;
...
while ( ( V_114 = F_351 ( V_24 -> V_96 , V_732 , V_729 ) ) >= V_730 )
V_729 = V_114 ;
if ( ! V_114 ) {
...
static int T_13 F_352 ( struct V_1 * V_24 )
{
unsigned int V_105 , V_106 ;
F_46 (adap, i) {
struct V_14 * V_26 = F_59 ( V_24 , V_105 ) ;
V_26 -> V_127 = F_353 ( V_26 -> V_130 , sizeof( T_2 ) , V_131 ) ;
if ( ! V_26 -> V_127 )
return - V_132 ;
for ( V_106 = 0 ; V_106 < V_26 -> V_130 ; V_106 ++ )
V_26 -> V_127 [ V_106 ] = F_354 ( V_106 , V_26 -> V_113 ) ;
}
return 0 ;
}
static void T_13 F_355 ( const struct V_10 * V_11 )
{
...
static void T_13 F_356 ( struct V_459 * V_11 )
{
T_2 V_100 ;
int V_376 ;
V_376 = F_357 ( V_11 ) ;
if ( V_376 > 0 ) {
F_358 ( V_11 , V_376 + V_746 , & V_100 ) ;
V_100 |= V_747 ;
...
F_361 ( V_1 -> V_23 [ V_105 ] ) ;
}
if ( V_1 -> V_45 & V_693 )
F_327 ( V_1 , V_1 -> V_41 ) ;
}
static int T_13 F_362 ( struct V_459 * V_96 ,
...
bool V_751 = false ;
struct V_1 * V_1 = NULL ;
F_363 ( V_752 L_70 , V_753 , V_184 ) ;
V_114 = F_364 ( V_96 , V_182 ) ;
if ( V_114 ) {
F_82 ( & V_96 -> V_11 , L_71 ) ;
return V_114 ;
}
V_750 = F_365 ( V_96 -> V_754 ) ;
...
if ( ! F_366 ( V_96 , F_367 ( 64 ) ) ) {
V_751 = true ;
V_114 = F_368 ( V_96 , F_367 ( 64 ) ) ;
if ( V_114 ) {
F_34 ( & V_96 -> V_11 , L_73
L_74 ) ;
goto V_758;
...
F_193 ( & V_1 -> V_463 ) ;
F_193 ( & V_1 -> V_429 ) ;
F_371 ( & V_1 -> V_433 , F_185 ) ;
F_371 ( & V_1 -> V_496 , F_249 ) ;
F_371 ( & V_1 -> V_503 , F_251 ) ;
V_114 = F_372 ( V_1 ) ;
if ( V_114 )
goto V_762;
V_114 = F_315 ( V_1 ) ;
...
F_46 (adapter, i) {
struct V_10 * V_136 ;
V_136 = F_373 ( sizeof( struct V_14 ) ,
V_724 ) ;
if ( ! V_136 ) {
V_114 = - V_132 ;
goto V_763;
}
F_374 ( V_136 , & V_96 -> V_11 ) ;
...
if ( V_118 > 1 && F_350 ( V_1 ) == 0 )
V_1 -> V_45 |= V_95 ;
else if ( V_118 > 0 && F_379 ( V_96 ) == 0 )
V_1 -> V_45 |= V_97 ;
V_114 = F_352 ( V_1 ) ;
if ( V_114 )
goto V_763;
F_46 (adapter, i) {
V_26 = F_59 ( V_1 , V_105 ) ;
F_380 ( V_1 -> V_23 [ V_105 ] , V_26 -> V_113 ) ;
F_381 ( V_1 -> V_23 [ V_105 ] , V_26 -> V_113 ) ;
V_114 = F_382 ( V_1 -> V_23 [ V_105 ] ) ;
if ( V_114 )
break;
V_1 -> V_761 [ V_26 -> V_52 ] = V_105 ;
F_355 ( V_1 -> V_23 [ V_105 ] ) ;
}
if ( V_105 == 0 ) {
F_34 ( & V_96 -> V_11 , L_80 ) ;
goto V_763;
...
static void T_18 F_388 ( struct V_459 * V_96 )
{
...
static int T_19 F_392 ( void )
{
int V_34 ;
V_432 = F_393 ( L_83 ) ;
if ( ! V_432 )
return - V_132 ;
V_779 = F_383 ( V_182 , NULL ) ;
if ( ! V_779 )
F_394 ( L_84 ) ;
V_34 = F_395 ( & V_482 ) ;
if ( V_34 < 0 )
