...
union V_21 * V_66 ;
T_1 V_6 ;
V_6 = F_34 ( V_4 -> V_7 -> V_8 , L_18 , NULL ,
& V_64 ) ;
if ( F_4 ( V_6 ) ) {
F_5 ( ( V_9 , V_6 , L_19 ) ) ;
return - V_10 ;
...
T_4 * V_103 ;
T_1 V_6 ;
V_6 = F_34 ( V_4 -> V_7 -> V_8 , L_24 , NULL ,
& V_64 ) ;
if ( F_4 ( V_6 ) ) {
F_5 ( ( V_9 , V_6 , L_25 ) ) ;
return - V_10 ;
...
* V_103 = F_36 ( sizeof( V_110 ) * ( V_75 -> string . V_106 + 1 ) ,
V_72 ) ;
if ( ! * V_103 ) {
V_25 = - V_73 ;
goto error;
...
static void F_51 ( struct V_17 * V_12 , T_6 V_111 )
{
struct V_3 * V_4 ;
int V_25 ;
if ( ! V_12 || ! F_52 ( V_12 ) )
...
break;
case V_113 :
F_53 ( & V_12 -> V_13 . V_62 , NULL , V_114 ) ;
F_18 ( V_4 ) ;
break;
case V_115 :
F_53 ( & V_12 -> V_13 . V_62 , NULL , V_116 ) ;
F_12 ( V_4 ) ;
break;
case V_117 :
F_53 ( & V_12 -> V_13 . V_62 , NULL , V_118 ) ;
F_2 ( V_4 ) ;
break;
case V_119 :
F_53 ( & V_12 -> V_13 . V_62 , NULL , V_120 ) ;
F_50 ( & V_12 -> V_13 , L_30 ) ;
break;
default:
F_23 () ;
...
V_4 -> V_7 = V_12 ;
F_57 ( & V_4 -> V_19 ) ;
strcpy ( F_58 ( V_12 ) , V_122 ) ;
strcpy ( F_59 ( V_12 ) , V_121 ) ;
V_12 -> V_18 = V_4 ;
F_47 ( V_4 ) ;
V_25 = F_48 ( V_4 ) ;
if ( V_25 )
...
static int T_7 F_66 ( const struct V_125 * V_126 )
{
V_2 = 1 ;
return 0 ;
}
