...
struct V_135 * V_136 ;
struct V_137 * V_137 ;
int V_11 , V_138 , V_139 ;
if ( ! V_127 && ! V_133 ) {
F_57 ( & V_125 -> V_123 , L_4 ) ;
return - V_140 ;
}
V_138 = F_58 ( V_127 , L_5 , & V_139 ) ;
if ( V_138 < 0 ) {
if ( V_133 )
V_139 = V_133 -> V_141 ;
else
...
sizeof( struct V_1 ) + sizeof( int ) * V_139 ) ;
if ( ! V_92 )
return - V_142 ;
F_60 ( V_125 , V_92 ) ;
...
V_92 -> V_141 = V_139 ;
V_18 = F_40 ( V_92 ) ;
V_18 -> V_145 . V_92 = F_61 ( V_92 ) ;
for ( V_11 = 0 ; V_11 < V_92 -> V_141 ; V_11 ++ ) {
int V_146 = F_62 ( V_127 , L_6 , V_11 ) ;
if ( V_146 < 0 && V_133 )
V_146 = V_133 -> V_56 [ V_11 ] ;
V_18 -> V_56 [ V_11 ] = V_146 ;
if ( V_146 < 0 )
continue;
V_138 = F_63 ( V_18 -> V_56 [ V_11 ] , V_147 ) ;
if ( V_138 ) {
F_57 ( & V_125 -> V_123 , L_7 ) ;
goto V_148;
}
}
V_18 -> V_145 . V_56 = F_39 ;
V_18 -> V_145 . V_149 = F_45 ;
V_18 -> V_145 . V_150 = F_47 ;
V_18 -> V_145 . V_92 -> V_151 = F_50 ;
V_18 -> V_145 . V_92 -> V_152 = F_53 ;
V_18 -> V_145 . V_92 -> V_153 = V_43 | V_42 | V_44 ;
F_48 ( & V_18 -> V_108 ) ;
V_18 -> V_3 = V_130 ? V_130 -> V_154 :
(struct V_155 * ) V_125 -> V_156 -> V_157 ;
V_136 = F_64 ( V_125 , V_158 , 0 ) ;
if ( ! V_136 ) {
F_57 ( & V_125 -> V_123 , L_8 ) ;
V_138 = - V_142 ;
goto V_148;
}
if ( ! F_65 ( V_136 -> V_159 , F_66 ( V_136 ) , V_125 -> V_160 ) ) {
F_57 ( & V_125 -> V_123 , L_9 ) ;
V_138 = - V_161 ;
goto V_148;
}
V_18 -> V_25 = F_67 ( V_136 -> V_159 , F_66 ( V_136 ) ) ;
if ( ! V_18 -> V_25 ) {
V_138 = - V_140 ;
goto V_162;
}
...
V_138 = F_69 ( V_18 -> V_102 , F_43 , 0 , V_147 , V_18 ) ;
if ( V_138 ) {
F_57 ( & V_125 -> V_123 , L_10 , V_18 -> V_102 , V_138 ) ;
goto V_163;
}
V_137 = F_70 ( & V_125 -> V_123 ) ;
if ( F_71 ( V_137 ) ) {
V_138 = F_72 ( V_137 ) ;
goto V_164;
}
V_18 -> V_165 = F_73 ( & V_125 -> V_123 , L_11 ) ;
if ( F_71 ( V_18 -> V_165 ) ) {
V_138 = F_72 ( V_18 -> V_165 ) ;
goto V_164;
}
V_18 -> V_166 = F_73 ( & V_125 -> V_123 , L_12 ) ;
if ( F_71 ( V_18 -> V_166 ) ) {
V_138 = F_72 ( V_18 -> V_166 ) ;
goto V_164;
}
F_74 ( V_18 -> V_166 ) ;
F_74 ( V_18 -> V_165 ) ;
V_18 -> V_36 = F_75 ( V_18 -> V_166 ) ;
V_18 -> V_3 -> V_167 ( V_18 ) ;
V_18 -> V_3 -> V_107 ( V_18 , 0 ) ;
V_92 -> V_123 . V_128 = V_125 -> V_123 . V_128 ;
V_138 = F_76 ( & V_18 -> V_145 ) ;
if ( V_138 ) {
F_57 ( & V_125 -> V_123 , L_13 , V_138 ) ;
goto V_168;
}
F_77 ( & V_125 -> V_123 , L_14 ) ;
return V_138 ;
V_168:
F_78 ( V_18 -> V_166 ) ;
F_78 ( V_18 -> V_165 ) ;
...
struct V_135 * V_136 = F_64 ( V_125 , V_158 , 0 ) ;
