...
static T_4
F_118 ( struct V_134 * V_134 , char T_5 * V_24 , T_6 V_112 , T_7 * V_38 )
{
struct V_113 * V_114 = V_134 -> V_226 ;
if ( V_114 -> type == V_171 ) {
if ( ! F_58 ( V_114 -> V_11 , V_114 , true ) )
return - V_172 ;
return F_119 ( & V_114 -> V_157 , V_24 , V_112 , V_38 , 0 ,
V_134 -> V_168 & V_169 ) ;
}
return 0 ;
}
static unsigned int
F_120 ( struct V_134 * V_134 , struct V_260 * V_261 )
{
struct V_113 * V_114 = V_134 -> V_226 ;
struct V_8 * V_9 ;
if ( V_171 != V_114 -> type )
...
if ( F_4 ( & V_114 -> V_157 . V_263 ) )
return V_262 ;
V_9 = F_6 ( V_114 -> V_157 . V_263 . V_15 , struct V_8 , V_16 . V_263 ) ;
} else {
return F_121 ( V_134 , & V_114 -> V_157 , V_261 ) ;
}
F_122 ( V_134 , & V_9 -> V_16 . V_23 , V_261 ) ;
if ( V_9 -> V_16 . V_19 == V_20 ||
V_9 -> V_16 . V_19 == V_264 )
return V_265 | V_266 ;
return 0 ;
}
static int F_123 ( struct V_134 * V_134 )
{
struct V_113 * V_114 = V_134 -> V_226 ;
struct V_10 * V_11 = V_114 -> V_11 ;
struct V_242 * V_243 = F_112 ( V_134 ) ;
...
{
struct V_113 * V_114 = V_134 -> V_226 ;
return F_127 ( & V_114 -> V_157 , V_269 ) ;
}
...
F_130 ( V_276 , & V_187 -> V_122 ) ;
snprintf ( V_187 -> V_153 , sizeof( V_187 -> V_153 ) , L_48 , V_11 -> V_153 , V_271 ) ;
F_131 ( V_187 , V_11 ) ;
return V_187 ;
}
...
{
int V_165 = - 1 ;
V_11 -> V_187 = F_128 ( V_11 , & V_277 , L_49 ) ;
if ( ! V_11 -> V_187 ) {
F_133 ( V_278 L_50 ,
V_11 -> V_153 ) ;
return - V_99 ;
}
F_134 ( & V_11 -> V_12 . V_13 ) ;
F_134 ( & V_11 -> V_12 . V_252 ) ;
V_165 = F_135 ( V_11 -> V_187 , V_246 , V_279 ) ;
if ( V_165 < 0 ) {
F_133 ( V_278 L_50 ,
V_11 -> V_153 ) ;
return V_165 ;
...
F_133 ( V_278 L_51 ,
V_11 -> V_153 , F_114 ( V_11 -> V_282 ) ) ;
}
F_133 ( V_278 L_54 , V_165 ) ;
return V_165 ;
}
