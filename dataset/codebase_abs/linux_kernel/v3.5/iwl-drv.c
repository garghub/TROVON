...
int V_133 ;
struct V_38 V_39 ;
const unsigned int V_134 = V_2 -> V_26 -> V_32 ;
unsigned int V_135 = V_2 -> V_26 -> V_136 ;
const unsigned int V_137 = V_2 -> V_26 -> V_33 ;
T_2 V_54 ;
int V_12 ;
V_16 -> V_138 . V_94 = 200 ;
V_16 -> V_138 . V_118 =
...
if ( V_53 -> V_60 )
V_133 = F_22 ( V_2 , V_51 , & V_39 ) ;
else
V_133 = F_27 ( V_2 , V_51 , & V_39 ,
& V_16 -> V_138 ) ;
if ( V_133 )
goto V_140;
V_54 = F_23 ( V_2 -> V_16 . V_59 ) ;
if ( V_2 -> V_29 != V_30 ) {
if ( V_54 < V_137 || V_54 > V_134 ) {
F_9 ( V_2 ,
L_32
L_33 ,
V_134 , V_54 ) ;
...
V_145 ;
F_35 ( V_51 ) ;
V_2 -> V_146 = V_147 . V_148 ( V_2 -> V_6 , V_2 -> V_26 , & V_2 -> V_16 ) ;
if ( ! V_2 -> V_146 )
goto V_149;
F_36 ( & V_2 -> V_150 ) ;
return;
...
struct V_1 * F_38 ( struct V_151 * V_6 ,
const struct V_128 * V_26 )
{
struct V_1 * V_2 ;
int V_152 ;
V_2 = F_39 ( sizeof( * V_2 ) , V_20 ) ;
if ( ! V_2 )
return NULL ;
V_2 -> V_6 = V_6 ;
V_2 -> V_7 = V_6 -> V_7 ;
