...
V_5 |= F_4 ( V_2 , V_78 ,
V_29 -> V_79 ) ;
V_5 |= F_4 ( V_2 , V_80 , V_29 -> V_81 ) ;
V_5 |= F_4 ( V_2 , V_82 , V_29 -> V_83 ) ;
V_5 |= F_4 ( V_2 , V_84 , V_29 -> V_85 ) ;
V_5 |= F_4 ( V_2 , V_86 , V_29 -> V_87 ) ;
V_5 |= F_4 ( V_2 , V_88 , V_89 | V_90 |
F_29 ( V_29 -> V_91 ) ) ;
}
V_5 |= F_4 ( V_2 , V_92 ,
F_30 ( V_29 -> V_93 , 0 ) ) ;
V_5 |= F_4 ( V_2 , V_94 , F_18 ( V_29 -> V_95 ,
V_29 -> V_96 ) ) ;
V_5 |= F_6 ( V_2 , V_58 , V_97 | V_63 | V_98 |
( V_9 -> V_99 ? V_100 : 0 ) ) ;
return V_5 ;
}
static T_5 F_31 ( struct V_101 * V_6 , char * V_102 , int V_3 )
{
...
if ( error < 0 )
return error ;
return sprintf ( V_102 , L_7 , V_10 ) ;
}
static T_5 F_33 ( struct V_101 * V_6 , const char * V_102 ,
T_6 V_103 , int V_3 )
{
struct V_8 * V_9 = F_32 ( V_6 ) ;
unsigned long V_4 ;
int V_5 ;
V_5 = F_34 ( V_102 , 10 , & V_4 ) ;
if ( V_5 )
return V_5 ;
F_8 ( & V_9 -> V_11 ) ;
F_4 ( V_9 -> V_2 , V_3 , V_4 ) ;
...
static T_5 F_35 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
return F_31 ( V_6 , V_102 , V_76 ) ;
}
static T_5 F_36 ( struct V_101 * V_6 ,
struct V_104 * V_105 , const char * V_102 , T_6 V_103 )
{
return F_33 ( V_6 , V_102 , V_103 , V_76 ) ;
}
static T_5 F_37 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
return F_31 ( V_6 , V_102 , V_72 ) ;
}
static T_5 F_38 ( struct V_101 * V_6 ,
struct V_104 * V_105 , const char * V_102 , T_6 V_103 )
{
return F_33 ( V_6 , V_102 , V_103 , V_72 ) ;
}
static T_5 F_39 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
return F_31 ( V_6 , V_102 , V_60 ) ;
}
static T_5 F_40 ( struct V_101 * V_6 ,
struct V_104 * V_105 , const char * V_102 , T_6 V_103 )
{
struct V_8 * V_9 = F_32 ( V_6 ) ;
int V_5 = F_34 ( V_102 , 10 , & V_9 -> V_61 ) ;
if ( V_5 )
return V_5 ;
return F_33 ( V_6 , V_102 , V_103 , V_60 ) ;
}
static T_5 F_41 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
return F_31 ( V_6 , V_102 , V_78 ) ;
}
static T_5 F_42 ( struct V_101 * V_6 ,
struct V_104 * V_105 ,
const char * V_102 , T_6 V_103 )
{
return F_33 ( V_6 , V_102 , V_103 , V_78 ) ;
}
static T_5 F_43 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
return F_31 ( V_6 , V_102 , V_74 ) ;
}
static T_5 F_44 ( struct V_101 * V_6 ,
struct V_104 * V_105 ,
const char * V_102 , T_6 V_103 )
{
return F_33 ( V_6 , V_102 , V_103 , V_74 ) ;
}
static T_5 F_45 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
return F_31 ( V_6 , V_102 , V_70 ) ;
}
static T_5 F_46 ( struct V_101 * V_6 ,
struct V_104 * V_105 ,
const char * V_102 , T_6 V_103 )
{
return F_33 ( V_6 , V_102 , V_103 , V_70 ) ;
}
static T_5 F_47 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
struct V_8 * V_9 = F_32 ( V_6 ) ;
int error ;
...
return error ;
V_106 += ( V_10 & 0x1F ) << 8 ;
return sprintf ( V_102 , L_7 , V_106 ) ;
}
static T_5 F_48 ( struct V_101 * V_6 ,
struct V_104 * V_105 , char * V_102 )
{
struct V_8 * V_9 = F_32 ( V_6 ) ;
int error ;
T_1 V_10 ;
F_8 ( & V_9 -> V_11 ) ;
error = F_1 ( V_9 -> V_2 , V_92 , & V_10 ) ;
F_9 ( & V_9 -> V_11 ) ;
if ( error < 0 )
return error ;
return sprintf ( V_102 , L_7 ,
( ( V_10 >> V_109 ) & V_110 ) + 1 ) ;
}
static T_5 F_49 ( struct V_101 * V_6 ,
struct V_104 * V_105 ,
const char * V_102 , T_6 V_103 )
{
struct V_8 * V_9 = F_32 ( V_6 ) ;
...
F_8 ( & V_9 -> V_11 ) ;
F_1 ( V_9 -> V_2 , V_92 , & V_10 ) ;
V_10 &= ~ ( V_110 << V_109 ) ;
V_10 |= ( V_4 - 1 ) << V_109 ;
F_4 ( V_9 -> V_2 , V_92 , V_10 ) ;
F_9 ( & V_9 -> V_11 ) ;
}
return V_103 ;
}
static int T_3 F_50 ( struct V_1 * V_2 ,
const struct V_111 * V_17 )
{
struct V_54 * V_55 ;
struct V_8 * V_9 ;
struct V_28 * V_29 =
...
V_64 . V_125 = V_57 ;
F_55 ( & V_9 -> V_11 ) ;
V_55 = F_56 ( F_57 ( & V_2 -> V_6 ) ,
& V_2 -> V_6 , V_9 , & V_126 , & V_64 ) ;
if ( F_58 ( V_55 ) ) {
F_3 ( & V_2 -> V_6 , L_11 ) ;
return F_59 ( V_55 ) ;
}
...
static int F_66 ( struct V_1 * V_2 , T_8 V_131 )
{
F_10 ( V_2 , V_58 , V_98 ) ;
return 0 ;
}
