...
if ( V_28 -> V_91 == V_50 ) {
int V_92 ;
V_92 = ( V_28 -> V_93 [ V_94 ] . V_27 << 2 ) - 1 ;
F_10 ( V_11 , V_95 , V_92 ) ;
F_10 ( V_11 , V_96 , V_92 >> 8 ) ;
if ( V_28 -> V_32 == V_33 )
F_10 ( V_11 , V_97 ,
V_28 -> V_93 [ V_98 ] . V_27 >> 8 ) ;
F_10 ( V_11 , V_99 , V_28 -> V_93 [ V_98 ] . V_27 ) ;
if ( V_28 -> V_32 == V_33 )
F_10 ( V_11 , V_100 ,
V_28 -> V_93 [ V_98 ] . V_27 >> 8 ) ;
F_10 ( V_11 , V_101 , V_28 -> V_93 [ V_98 ] . V_27 ) ;
if ( V_28 -> V_32 == V_33 )
F_10 ( V_11 , V_102 ,
V_28 -> V_93 [ V_103 ] . V_27 >> 8 ) ;
F_10 ( V_11 , V_104 , V_28 -> V_93 [ V_103 ] . V_27 ) ;
if ( V_28 -> V_32 == V_33 )
F_10 ( V_11 , V_105 ,
V_28 -> V_93 [ V_106 ] . V_27 >> 8 ) ;
F_10 ( V_11 , V_107 , V_28 -> V_93 [ V_106 ] . V_27 ) ;
F_10 ( V_11 , V_74 ,
...
static void F_22 ( struct V_11 * V_11 , T_1 V_108 )
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
F_23 ( V_109 , L_4 , V_28 -> V_6 , V_108 ) ;
V_28 -> V_6 = V_108 ;
if ( V_108 > 16 )
V_108 = 16 ;
if ( V_28 -> V_91 == V_49 )
F_2 ( V_28 -> V_1 , V_110 [ V_108 ] ) ;
else
memcpy ( & V_28 -> V_1 [ V_9 - 1 ] ,
V_111 [ V_108 ] , sizeof V_111 [ 0 ] ) ;
}
static void F_24 ( struct V_11 * V_11 )
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
T_2 V_108 ;
V_108 = V_28 -> V_93 [ V_112 ] . V_27 ;
if ( V_108 != 16 )
V_108 = 15 - V_108 ;
F_3 ( V_11 , V_113 , 0x00 ) ;
F_3 ( V_11 , V_114 , 0x04 ) ;
F_3 ( V_11 , V_114 , V_108 ) ;
if ( V_108 == 15 && V_28 -> V_32 == V_115 ) {
F_11 ( 4 ) ;
F_3 ( V_11 , V_113 , 0x19 ) ;
}
}
...
int gamma ;
#define F_26 6
static const T_1 V_116 [ F_26 ] [ 3 ] [ 1024 ] = {
{
...
if ( V_28 -> V_32 == V_115 )
F_3 ( V_11 , 0x02 , 0x28 ) ;
gamma = V_28 -> V_93 [ GAMMA ] . V_27 ;
F_14 ( V_11 , 0x00 , V_116 [ gamma ] [ 0 ] , 1024 ) ;
F_14 ( V_11 , 0x01 , V_116 [ gamma ] [ 1 ] , 1024 ) ;
F_14 ( V_11 , 0x02 , V_116 [ gamma ] [ 2 ] , 1024 ) ;
if ( V_28 -> V_32 == V_115 ) {
int V_7 ;
F_3 ( V_11 , 0x02 , 0x2b ) ;
F_3 ( V_11 , 0x02 , 0x28 ) ;
...
V_27 = ( V_28 -> V_93 [ V_120 ] . V_27 << 5 ) | 0x08 ;
F_3 ( V_11 , 0x59 , V_27 ) ;
}
}
...
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
if ( V_11 -> V_122 & ( 1 << V_123 ) )
return;
if ( V_28 -> V_93 [ V_123 ] . V_27 ) {
V_28 -> V_124 = V_125 ;
V_11 -> V_126 |= ( 1 << V_94 ) | ( 1 << V_98 ) ;
} else {
V_28 -> V_124 = - 1 ;
V_11 -> V_126 &= ~ ( ( 1 << V_94 ) | ( 1 << V_98 ) ) ;
}
...
int V_7 ;
if ( V_28 -> V_32 == V_33 ) {
for ( V_7 = 0 ; V_7 < F_19 ( V_128 ) - 1 ; V_7 ++ ) {
if ( V_28 -> V_129 >= V_128 [ V_7 ] )
break;
}
V_7 = 6 - V_7 ;
if ( V_7 == 6
...
for ( V_7 = 0 ; V_7 < F_19 ( V_130 ) - 1 ; V_7 ++ ) {
if ( V_28 -> V_129 >= V_130 [ V_7 ] )
break;
}
V_7 = 7 - V_7 ;
if ( V_7 == 7
...
F_7 ( V_11 , 0x7b ) ;
F_3 ( V_11 , 0x7b ,
V_28 -> V_91 == V_50 ? 0x10 : 0x90 ) ;
if ( V_28 -> V_93 [ V_94 ] . V_27 >= 128 )
V_131 = 0xf0 ;
}
F_3 ( V_11 , V_54 , V_131 ) ;
if ( V_28 -> V_91 == V_50 )
...
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
int V_132 ;
V_132 = V_28 -> V_93 [ V_106 ] . V_27 ;
F_10 ( V_11 , V_105 , V_132 >> 8 ) ;
F_10 ( V_11 , V_107 , V_132 ) ;
F_10 ( V_11 , V_74 , 0x80 ) ;
}
static int F_33 ( struct V_11 * V_11 , T_3 V_27 )
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
if ( V_28 -> V_91 == V_50 ) {
V_28 -> V_93 [ V_103 ] . V_27 = V_28 -> V_93 [ V_103 ] . V_27
* V_27 / V_28 -> V_93 [ V_98 ] . V_27 ;
if ( V_28 -> V_93 [ V_103 ] . V_27 > 4095 )
V_28 -> V_93 [ V_103 ] . V_27 = 4095 ;
V_28 -> V_93 [ V_106 ] . V_27 = V_28 -> V_93 [ V_106 ] . V_27
* V_27 / V_28 -> V_93 [ V_98 ] . V_27 ;
if ( V_28 -> V_93 [ V_106 ] . V_27 > 4095 )
V_28 -> V_93 [ V_106 ] . V_27 = 4095 ;
}
V_28 -> V_93 [ V_98 ] . V_27 = V_27 ;
if ( V_11 -> V_133 )
F_21 ( V_11 ) ;
return V_11 -> V_17 ;
}
...
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
int V_134 ;
V_134 = V_28 -> V_93 [ V_103 ] . V_27 ;
F_10 ( V_11 , V_102 , V_134 >> 8 ) ;
F_10 ( V_11 , V_104 , V_134 ) ;
F_10 ( V_11 , V_74 , 0x80 ) ;
}
...
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
V_28 -> V_32 = V_136 -> V_137 ;
V_11 -> V_138 . V_139 = V_140 ;
V_11 -> V_138 . V_141 = F_19 ( V_140 ) ;
V_11 -> V_138 . V_142 = V_28 -> V_32 == V_33 ?
V_143 : V_144 ;
V_28 -> V_129 = 30 ;
V_11 -> V_138 . V_93 = V_28 -> V_93 ;
return 0 ;
}
static int F_36 ( struct V_11 * V_11 )
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
static const struct V_23 V_145 [] = {
{ V_46 , 0x01 } ,
{ V_29 , 0x01 } ,
{ V_146 , 0x9f } ,
{ V_147 , 0x9f } ,
...
static const struct V_23 V_149 [] = {
{ V_52 , 0x2f } ,
{ V_146 , 0x6f } ,
{ V_147 , 0x40 } ,
{ V_148 , 0x9f } ,
...
if ( V_28 -> V_91 == V_49 ) {
F_38 ( L_7 ) ;
V_28 -> V_93 [ GAMMA ] . V_152 = V_28 -> V_32 == V_33 ? 0 : 1 ;
V_28 -> V_93 [ V_98 ] . V_153 = 15 ;
V_28 -> V_93 [ V_98 ] . V_152 = 3 ;
V_11 -> V_122 = ( 1 << V_106 ) | ( 1 << V_103 ) ;
if ( V_28 -> V_32 == V_115 ) {
F_20 ( V_11 ) ;
#if V_154
V_11 -> V_126 |= ( 1 << V_94 ) | ( 1 << V_98 ) ;
...
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
static const struct V_23 V_155 [] = {
{ V_86 , 0x81 } ,
{ V_95 , 0x37 } ,
{ V_96 , 0x01 } ,
{ V_101 , 0x00 } ,
...
static const struct V_23 V_156 [] = {
{ 0x4d , 0x00 } ,
{ 0x4c , 0xff } ,
{ 0x4e , 0xff } ,
{ 0x4f , 0x00 } ,
} ;
static const struct V_23 V_157 [] = {
{ 0x10 , 0x75 } ,
{ 0x76 , 0x03 } ,
{ 0x00 , 0x00 } ,
} ;
...
F_9 ( V_11 , V_156 ,
F_19 ( V_156 ) ) ;
F_14 ( V_11 , 0x03 , V_159 , sizeof V_159 ) ;
F_3 ( V_11 , 0x59 , 0x40 ) ;
} else {
F_3 ( V_11 , V_47 , 0x21 ) ;
F_12 ( V_11 , V_157 ,
...
F_3 ( V_11 , V_56 ,
V_11 -> V_160 ? 0x00 : 0x01 ) ;
return V_11 -> V_17 ;
}
static void F_40 ( struct V_11 * V_11 , int V_161 )
{
T_1 V_39 ;
F_7 ( V_11 , V_45 ) ;
V_39 = V_11 -> V_22 [ 0 ] ;
...
{
static const struct V_23 V_162 [] = {
{ V_148 , 0x9f } ,
{ V_147 , 0x40 } ,
{ V_46 , 0x00 } ,
{ V_163 , 0x00 } ,
...
static const struct V_23 V_187 [] = {
{ V_86 , 0x81 } ,
{ V_95 , 0x6f } ,
{ V_96 , 0x02 } ,
{ V_101 , 0x00 } ,
...
static const struct V_23 V_188 [] = {
{ 0x4d , 0x00 } ,
{ 0x4c , 0xff } ,
{ 0x4e , 0xff } ,
{ 0x4f , 0x00 } ,
} ;
static const struct V_23 V_189 [] = {
{ V_95 , 0xd3 } ,
{ V_96 , 0x01 } ,
{ V_101 , 0x40 } ,
{ V_99 , 0x40 } ,
...
F_3 ( V_11 , 0x22 , V_11 -> V_191 ) ;
F_12 ( V_11 , V_184 , F_19 ( V_184 ) ) ;
F_9 ( V_11 , V_185 , F_19 ( V_185 ) ) ;
F_9 ( V_11 , V_88 ,
F_19 ( V_88 ) ) ;
F_9 ( V_11 , V_186 , F_19 ( V_186 ) ) ;
if ( V_11 -> V_160 ) {
F_3 ( V_11 , 0x4a , 0x7f ) ;
F_3 ( V_11 , 0x07 , 0x05 ) ;
F_3 ( V_11 , V_56 , 0x00 ) ;
...
F_19 ( V_127 [ 0 ] ) ) ;
F_3 ( V_11 , V_54 , 0x87 ) ;
F_12 ( V_11 , V_187 , F_19 ( V_187 ) ) ;
F_9 ( V_11 , V_188 , F_19 ( V_188 ) ) ;
F_12 ( V_11 , V_189 , F_19 ( V_189 ) ) ;
F_9 ( V_11 , V_188 , F_19 ( V_188 ) ) ;
F_12 ( V_11 , V_190 , F_19 ( V_190 ) ) ;
F_40 ( V_11 , 1 ) ;
}
...
static const struct V_23 V_193 [] = {
{ 0x08 , 0xff } ,
{ 0x09 , 0xff } ,
{ 0x0a , 0x5f } ,
{ 0x0b , 0x80 } ,
...
F_3 ( V_11 , V_54 , 0xf0 ) ;
F_21 ( V_11 ) ;
F_9 ( V_11 , V_193 , F_19 ( V_193 ) ) ;
}
static int F_45 ( struct V_11 * V_11 )
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
F_1 ( V_28 -> V_1 , V_11 -> V_2 , V_11 -> V_3 ) ;
F_22 ( V_11 , V_28 -> V_6 ) ;
if ( V_28 -> V_32 == V_33 ) {
if ( V_28 -> V_91 == V_50 )
F_41 ( V_11 ) ;
...
F_19 ( V_194 ) ) ;
F_3 ( V_11 , 0x80 , 0x03 ) ;
F_3 ( V_11 , 0x82 , V_11 -> V_160 ? 0x0a : 0x0e ) ;
F_21 ( V_11 ) ;
F_24 ( V_11 ) ;
F_28 ( V_11 ) ;
}
...
V_203 = ( ( V_11 -> V_22 [ 8 ] << 8 ) + V_11 -> V_22 [ 7 ] +
...
V_203 /= 4 ;
F_3 ( V_11 , 0x7d , 0x00 ) ;
V_92 = V_28 -> V_93 [ V_94 ] . V_27 ;
V_16 = F_52 ( V_11 , V_203 ,
60 ,
6 ,
2 ,
70 ) ;
V_28 -> V_124 = V_125 ;
if ( V_28 -> V_32 == V_115 ) {
if ( ( V_92 >= 128 && V_28 -> V_93 [ V_94 ] . V_27 < 128 )
|| ( V_92 < 128 && V_28 -> V_93 [ V_94 ] . V_27 >= 128 ) )
F_31 ( V_11 ) ;
}
break;
}
...
{
struct V_28 * V_28 = (struct V_28 * ) V_11 ;
struct V_206 * V_207 = & V_205 -> V_205 . V_208 ;
...
if ( V_7 & 0x80 ) {
if ( V_28 -> V_32 == V_33 )
V_212 = V_128 [ 6 - ( V_7 & 0x07 ) ] ;
else
V_212 = V_130 [ 7 - ( V_7 & 0x07 ) ] ;
} else {
V_212 = V_128 [ 6 - V_7 ] ;
}
V_210 -> V_216 = V_212 ;
...
struct V_209 * V_210 = & V_207 -> V_211 ;
int V_212 , V_7 ;
V_28 -> V_129 = V_210 -> V_216 / V_210 -> V_215 ;
if ( V_11 -> V_133 )
F_31 ( V_11 ) ;
V_7 = F_30 ( V_11 ) ;
if ( V_7 & 0x80 )
...
V_218 -> V_6 = V_110 [ V_28 -> V_6 ] ;
V_218 -> V_219 = V_220
| V_221 ;
return 0 ;
}
static int F_57 ( struct V_222 * V_223 ,
const struct V_135 * V_136 )
{
return F_58 ( V_223 , V_136 , & V_224 , sizeof( struct V_28 ) ,
V_225 ) ;
}
