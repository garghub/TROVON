...
struct V_23 * V_24 = V_2 -> V_74 ;
struct V_26 * V_27 ;
struct V_29 * V_30 = V_2 -> V_13 -> V_17 ;
if ( F_19 ( ! V_24 ) ) {
F_42 ( V_2 ) ;
F_44 ( V_2 ) ;
return;
...
static void F_53 ( int V_93 , unsigned short V_94 , void * V_95 )
{
struct V_1 * V_2 = V_95 ;
struct V_23 * V_24 = V_2 -> V_74 ;
unsigned long V_96 ;
...
static T_4 F_56 ( int V_98 , void * V_95 )
{
struct V_1 * V_2 = V_95 ;
struct V_29 * V_30 = V_2 -> V_13 -> V_17 ;
struct V_23 * V_24 = V_2 -> V_74 ;
...
static void F_60 ( struct V_1 * V_2 , bool V_106 )
{
if ( V_2 -> V_107 & V_108 )
F_40 ( V_2 , V_109 , V_106 ) ;
else if ( V_2 -> V_107 & V_110 )
F_40 ( V_2 , V_109 , ! V_106 ) ;
}
...
break;
case 8000000 :
V_75 |= V_113 | V_119 | V_115 ;
break;
case 9600000 :
V_75 |= V_113 | V_120 | V_115 ;
break;
case 12000000 :
V_75 |= V_113 | V_121 ;
break;
case 24000000 :
V_75 |= V_113 | V_122 | V_115 ;
default:
break;
}
...
F_60 ( V_2 , true ) ;
V_75 = F_39 ( V_2 , V_76 ) ;
V_75 &= ~ ( V_114 | V_115 | V_113 ) ;
F_40 ( V_2 , V_76 , V_75 ) ;
V_75 = ( V_75 & ~ V_116 ) | V_121 ;
F_40 ( V_2 , V_76 , V_75 ) ;
F_40 ( V_2 , V_76 , V_75 | V_114 ) ;
F_40 ( V_2 , V_76 , V_75 & ~ V_114 ) ;
F_64 ( V_2 -> V_112 ) ;
V_2 -> V_13 = NULL ;
F_8 ( V_13 -> V_17 ,
...
{
struct V_127 * V_128 = F_66 ( V_13 ) ;
struct V_29 * V_30 = V_13 -> V_17 ;
int V_129 = 0 , V_37 ;
enum V_130 V_41 ;
const struct V_131 * V_132 ;
V_37 = F_67 ( V_128 , V_133 , V_134 , V_124 , & V_41 ) ;
if ( V_37 < 0 )
return 0 ;
V_132 = F_68 ( V_41 ) ;
if ( ! V_132 ) {
...
static bool F_71 ( T_5 V_147 , unsigned int V_44 ,
enum V_25 V_20 )
{
int V_11 = V_147 * V_44 ;
return F_72 ( V_147 , V_59 ) &&
F_72 ( V_11 , F_27 ( V_20 ) * V_59 ) ;
}
static int F_73 ( int * V_42 , int * V_44 ,
const struct V_131 * V_132 ,
enum V_25 V_20 , bool V_148 )
{
T_5 V_147 = F_74 ( * V_42 , V_132 ) ;
if ( V_147 < 0 )
return V_147 ;
if ( ! F_71 ( V_147 , * V_44 , V_20 ) ) {
unsigned int V_149 = F_75 ( V_147 / * V_42 ) ;
unsigned int V_150 = F_31 ( V_20 ) +
V_64 - V_149 ;
unsigned int V_151 = V_148 << V_150 ;
F_76 ( V_42 , 1 , * V_42 + V_151 , 0 ,
V_44 , 1 , * V_44 + V_151 , 0 , V_150 ) ;
return 0 ;
}
return 1 ;
}
static int F_77 ( struct V_1 * V_2 , struct V_29 * V_30 ,
struct V_12 * V_13 , struct V_127 * V_128 ,
struct V_152 * V_153 ,
const struct V_125 * V_126 )
{
T_5 V_147 ;
int V_37 = F_78 ( V_2 , V_30 , V_13 , V_128 , V_154 , V_153 ) ;
if ( V_37 < 0 ) {
F_79 ( V_30 , L_20 , V_22 ) ;
return V_37 ;
}
...
V_147 = F_74 ( V_153 -> V_42 , V_126 -> V_144 ) ;
if ( V_147 < 0 ) {
F_79 ( V_30 , L_22 ,
V_22 ) ;
return V_147 ;
}
if ( ! F_71 ( V_147 , V_153 -> V_44 , V_2 -> V_20 ) ) {
F_79 ( V_30 , L_23 ,
...
struct V_152 V_153 ;
int V_37 ;
V_37 = F_78 ( V_2 , V_30 , V_13 , V_128 , V_160 , V_156 ) ;
if ( V_37 < 0 ) {
F_58 ( V_30 , L_24 , V_22 ,
V_158 -> V_42 , V_158 -> V_44 , V_158 -> V_161 , V_158 -> V_162 ) ;
return V_37 ;
}
V_37 = F_67 ( V_128 , V_133 , V_163 , & V_153 ) ;
if ( V_37 < 0 ) {
F_58 ( V_30 , L_25 , V_22 ) ;
return V_37 ;
}
V_37 = F_73 ( & V_153 . V_42 , & V_153 . V_44 , V_126 -> V_144 , V_2 -> V_20 ,
false ) ;
if ( V_37 < 0 ) {
F_79 ( V_30 , L_26 ,
V_22 , V_153 . V_42 , V_153 . V_44 ,
...
if ( ! V_37 ) {
V_37 = F_77 ( V_2 , V_30 , V_13 , V_128 , & V_153 , V_126 ) ;
if ( V_37 < 0 ) {
F_79 ( V_30 , L_27 , V_22 ) ;
return V_37 ;
}
...
V_153 . V_169 = V_167 -> V_169 ;
V_153 . V_41 = V_126 -> V_41 ;
V_37 = F_67 ( V_128 , V_133 , V_170 , & V_153 ) ;
if ( V_37 < 0 )
return V_37 ;
V_167 -> V_42 = V_153 . V_42 ;
V_167 -> V_44 = V_153 . V_44 ;
...
static int F_84 ( struct V_8 * V_171 ,
struct V_26 * V_24 ,
struct V_172 * V_173 )
{
...
static void F_85 ( struct V_8 * V_171 ,
struct V_12 * V_13 )
{
struct V_15 * V_16 = F_6 ( V_13 -> V_17 ) ;
struct V_1 * V_2 = V_16 -> V_18 ;
...
V_13 -> V_17 , & V_2 -> V_97 ,
V_178 , V_179 ,
sizeof( struct V_23 ) , V_13 , & V_13 -> V_180 ) ;
else
F_87 ( V_171 , & V_177 ,
V_13 -> V_17 , & V_2 -> V_97 ,
V_178 , V_179 ,
...
if ( ! V_176 && V_171 -> V_181 -> V_174 != F_84 ) {
V_2 -> V_174 = V_171 -> V_181 -> V_174 ;
V_171 -> V_181 -> V_174 = F_84 ;
}
}
...
struct V_187 * V_188 )
{
F_91 ( V_188 -> V_189 , L_30 , sizeof( V_188 -> V_189 ) ) ;
...
T_2 V_75 , V_77 ;
int V_37 ;
V_37 = F_67 ( V_128 , V_133 , V_199 , & V_196 ) ;
if ( ! V_37 ) {
V_198 = F_93 ( & V_196 , V_200 ) ;
if ( ! V_198 ) {
F_58 ( V_30 ,
L_31 ,
V_196 . V_96 , V_200 ) ;
...
( V_198 & V_203 ) ) {
if ( ! V_2 -> V_204 ||
V_2 -> V_204 -> V_96 & V_205 )
V_198 &= ~ V_203 ;
else
V_198 &= ~ V_202 ;
}
V_196 . V_96 = V_198 ;
V_37 = F_67 ( V_128 , V_133 , V_206 , & V_196 ) ;
...
static unsigned int F_94 ( struct V_211 * V_211 , T_6 * V_212 )
{
struct V_12 * V_13 = V_211 -> V_213 ;
struct V_23 * V_24 ;
V_24 = F_33 ( V_13 -> V_185 . V_214 . V_68 , struct V_23 ,
V_27 . V_214 ) ;
F_95 ( V_211 , & V_24 -> V_27 . V_90 , V_212 ) ;
if ( V_24 -> V_27 . V_33 == V_72 ||
V_24 -> V_27 . V_33 == V_57 )
return V_215 | V_216 ;
return 0 ;
}
static int T_7 F_96 ( struct V_217 * V_218 )
{
struct V_1 * V_2 ;
struct V_219 * V_220 ;
struct V_112 * V_112 ;
...
unsigned int V_98 ;
int V_221 = 0 ;
V_220 = F_97 ( V_218 , V_222 , 0 ) ;
V_98 = F_98 ( V_218 , 0 ) ;
if ( ! V_220 || ( int ) V_98 <= 0 ) {
V_221 = - V_223 ;
goto exit;
}
V_112 = F_99 ( & V_218 -> V_30 , L_37 ) ;
if ( F_100 ( V_112 ) ) {
V_221 = F_101 ( V_112 ) ;
goto exit;
}
V_2 = F_102 ( sizeof( * V_2 ) + F_103 ( V_220 ) , V_224 ) ;
if ( ! V_2 ) {
F_79 ( & V_218 -> V_30 , L_38 ) ;
V_221 = - V_175 ;
goto V_225;
}
V_2 -> V_220 = V_220 ;
...
if ( V_2 -> V_204 ) {
V_2 -> V_107 = V_2 -> V_204 -> V_96 ;
V_2 -> V_117 = V_2 -> V_204 -> V_227 * 1000 ;
}
switch ( V_2 -> V_117 ) {
case 6000000 :
case 8000000 :
...
V_2 -> V_117 = 0 ;
case 0 :
F_104 ( & V_218 -> V_30 , L_42 ) ;
}
F_89 ( & V_2 -> V_67 ) ;
F_105 ( & V_2 -> V_97 ) ;
if ( ! F_106 ( V_220 -> V_228 , F_103 ( V_220 ) , V_229 ) ) {
V_221 = - V_111 ;
goto V_230;
}
V_6 = F_107 ( V_220 -> V_228 , F_103 ( V_220 ) ) ;
if ( ! V_6 ) {
V_221 = - V_175 ;
goto V_231;
}
...
V_2 -> V_6 = V_6 ;
F_60 ( V_2 , true ) ;
V_221 = F_108 ( V_232 , V_229 ,
F_53 , ( void * ) V_2 , & V_2 -> V_52 ) ;
if ( V_221 < 0 ) {
F_79 ( & V_218 -> V_30 , L_43 ) ;
V_221 = - V_111 ;
goto V_233;
}
F_8 ( & V_218 -> V_30 , L_44 , V_2 -> V_52 ) ;
F_109 ( V_2 -> V_52 , V_234 ,
V_235 , V_220 -> V_228 + V_236 ,
0 , 0 ) ;
F_110 ( V_2 -> V_52 , V_237 ) ;
F_111 ( V_2 -> V_52 , V_2 -> V_52 ) ;
V_221 = F_112 ( V_2 -> V_98 , F_56 , 0 , V_229 , V_2 ) ;
if ( V_221 ) {
F_79 ( & V_218 -> V_30 , L_45 ) ;
goto V_238;
}
V_2 -> V_239 . V_240 = V_229 ;
V_2 -> V_239 . V_241 = & V_242 ;
V_2 -> V_239 . V_18 = V_2 ;
V_2 -> V_239 . V_243 . V_30 = & V_218 -> V_30 ;
V_2 -> V_239 . V_244 = V_218 -> V_245 ;
V_221 = F_113 ( & V_2 -> V_239 ) ;
if ( V_221 )
goto V_246;
F_104 ( & V_218 -> V_30 , L_46 ) ;
return 0 ;
V_246:
F_114 ( V_2 -> V_98 , V_2 ) ;
V_238:
...
static int T_9 F_120 ( struct V_217 * V_218 )
{
struct V_15 * V_239 = F_6 ( & V_218 -> V_30 ) ;
struct V_1 * V_2 = F_18 ( V_239 ,
struct V_1 , V_239 ) ;
struct V_219 * V_220 ;
F_114 ( V_2 -> V_98 , V_2 ) ;
F_115 ( V_2 -> V_52 ) ;
