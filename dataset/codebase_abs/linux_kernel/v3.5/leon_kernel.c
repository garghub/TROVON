...
void T_5 F_55 ( struct V_52 * V_96 , struct V_52 * * * V_100 )
{
if ( V_101 &&
strcmp ( V_96 -> type , L_25 ) == 0 &&
strcmp ( V_96 -> V_33 , L_26 ) == 0 ) {
V_101 ( V_96 , V_100 ) ;
}
}
void F_37 ( int V_1 )
...
void F_56 ( unsigned int V_102 , unsigned int V_1 )
{
unsigned long V_9 , V_22 , * V_103 ;
V_9 = F_12 ( V_102 ) ;
F_20 ( & V_27 , V_22 ) ;
V_103 = ( unsigned long * ) F_10 ( V_1 ) ;
F_11 ( V_103 , ( F_2 ( V_103 ) | V_9 ) ) ;
F_21 ( & V_27 , V_22 ) ;
}
void T_5 F_57 ( void )
{
