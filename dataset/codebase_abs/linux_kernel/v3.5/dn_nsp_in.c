...
int V_41 ;
int V_115 ;
if ( F_36 ( & V_15 -> V_116 ) + V_2 -> V_117 >=
( unsigned int ) V_15 -> V_118 ) {
V_41 = - V_119 ;
goto V_53;
}
V_41 = F_37 ( V_15 , V_2 ) ;
...
F_11 ( V_2 , 2 ) ;
if ( F_31 ( V_18 -> V_104 , V_99 ) ) {
if ( F_35 ( V_15 , V_2 , V_122 , & V_18 -> V_123 ) == 0 ) {
F_32 ( & V_18 -> V_104 , 1 ) ;
V_18 -> V_124 = 0 ;
V_121 = 1 ;
}
...
V_9 -> V_99 = V_99 = F_4 ( * ( T_1 * ) V_2 -> V_28 ) ;
F_11 ( V_2 , 2 ) ;
if ( F_31 ( V_18 -> V_125 , V_99 ) ) {
if ( F_35 ( V_15 , V_2 , V_126 , & V_15 -> V_52 ) == 0 ) {
F_32 ( & V_18 -> V_125 , 1 ) ;
V_121 = 1 ;
}
if ( ( V_18 -> V_127 == V_110 ) && F_41 ( V_15 ) ) {
V_18 -> V_127 = V_109 ;
F_24 ( V_15 , V_109 , 0 ) ;
}
}
...
if ( V_9 -> V_131 & V_132 )
goto V_53;
if ( ( V_34 != V_133 ) && ( ( V_9 -> V_134 & 0x0c ) == 0x08 ) ) {
switch ( V_9 -> V_134 & 0x70 ) {
case 0x10 :
case 0x60 :
F_45 ( V_2 , V_135 , V_34 ) ;
V_129 = V_136 ;
...
V_9 -> V_134 = * V_27 ++ ;
if ( V_138 & 2 )
F_48 ( V_139 L_3 , ( int ) V_9 -> V_134 ) ;
if ( V_9 -> V_134 & 0x83 )
goto V_137;
if ( ( V_9 -> V_134 & 0x0c ) == 0x08 ) {
switch ( V_9 -> V_134 & 0x70 ) {
case 0x00 :
case 0x70 :
case 0x50 :
...
{
return F_54 ( V_143 , V_144 , V_2 , V_2 -> V_6 , NULL ,
F_46 ) ;
}
...
struct V_8 * V_9 = F_2 ( V_2 ) ;
if ( V_9 -> V_131 & V_132 ) {
if ( V_9 -> V_134 == 0x18 || V_9 -> V_134 == 0x68 )
F_43 ( V_15 , V_2 ) ;
else
F_19 ( V_2 ) ;
return V_136 ;
