...
F_199 ( V_32 , V_320 , 4 , & V_4 -> V_72 [ V_161 -> V_93 ] . V_81 -> V_109 ) ;
...
V_314 -> V_351 = 0 ;
V_314 -> V_352 = V_4 -> V_3 ;
if ( F_208 ( V_32 , V_353 , V_4 -> V_3 ) )
goto V_354;
V_314 -> V_355 = V_356 ;
V_314 -> V_357 = V_358 ;
V_314 -> V_342 = 0 ;
if ( F_209 ( V_32 , V_359 , 16 , & V_161 -> V_92 ) ||
F_209 ( V_32 , V_360 , 16 , & V_161 -> V_91 ) )
goto V_354;
if ( F_124 ( V_4 , V_32 , V_161 , V_314 ) < 0 )
goto V_354;
return F_210 ( V_32 , V_168 ) ;
V_354:
F_211 ( V_32 , V_168 ) ;
return - V_200 ;
}
