...
struct V_30 * V_31 ;
if ( V_26 ) {
V_25 -> V_19 = F_13 ( V_22 , 0 ) ;
if ( V_25 -> V_19 == NULL )
return - 1 ;
V_25 -> V_18 = F_13 ( V_23 , 0 ) ;
if ( V_25 -> V_18 == NULL )
return - 1 ;
} else {
V_29 = F_14 ( V_22 , 0 ) ;
...
V_25 -> V_20 = 0 ;
for ( V_29 = V_24 , V_28 = 0 ; * V_29 && ! V_28 ; V_29 ++ ) {
switch ( * V_29 ) {
case '-' :
break;
case 'r' :
...
static int F_17 ( const char * V_38 , struct V_10 * V_25 , int V_26 )
{
int V_27 ;
V_27 = F_12 ( V_38 , V_38 + V_39 ,
V_38 + V_39 + V_39 , V_25 , V_26 ) ;
return V_27 ;
}
static int F_18 ( const char * V_38 , struct V_10 * V_25 ,
int V_26 )
{
char * V_22 ;
char * V_23 ;
...
if ( V_24 == NULL )
goto V_43;
if ( sscanf ( V_38 , L_1 , V_22 , V_23 , V_24 ) == 3 )
V_27 = F_12 ( V_22 , V_23 , V_24 , V_25 , V_26 ) ;
F_16 ( V_24 ) ;
V_43:
F_16 ( V_23 ) ;
V_42:
...
struct V_4 V_80 ;
F_2 ( & V_80 ) ;
V_27 = F_39 ( NULL , V_81 , NULL , NULL , & V_80 ) ;
if ( V_27 != 0 )
F_40 ( V_82 L_3 ,
V_83 , __LINE__ , V_27 ) ;
...
V_27 = F_44 ( V_79 -> V_86 , NULL , NULL , NULL , & V_80 ) ;
if ( V_27 != 0 ) {
F_40 ( V_82 L_6 ,
V_83 , __LINE__ , V_27 ) ;
F_16 ( V_79 ) ;
...
F_2 ( & V_80 ) ;
if ( V_93 != NULL ) {
V_27 = F_39 ( V_93 , V_81 , NULL , NULL , & V_80 ) ;
if ( V_27 != 0 )
F_40 ( V_82 L_3 ,
V_83 , __LINE__ , V_27 ) ;
}
...
struct V_12 * V_21 = V_72 ;
struct V_30 * V_31 =
F_33 ( V_21 , struct V_30 , V_21 ) ;
struct V_97 * V_98 = V_31 -> V_99 . V_100 . V_101 . V_1 ;
char V_102 = '/' ;
int V_103 ;
if ( strlen ( V_31 -> V_32 ) >= V_39 )
return 0 ;
F_28 ( V_66 , L_8 , V_31 -> V_32 , V_31 -> V_99 . V_100 . V_101 . V_104 ) ;
...
V_27 = F_54 ( V_109 , V_108 , & V_107 , V_3 ) ;
if ( V_27 >= 0 ) {
F_55 ( V_31 -> V_99 . V_100 . V_101 . V_1 ) ;
V_31 -> V_99 . V_100 . V_101 . V_1 = V_107 . V_100 . V_101 . V_1 ;
V_31 -> V_99 . V_100 . V_101 . V_104 = V_107 . V_100 . V_101 . V_104 ;
V_27 = V_46 ;
}
V_58:
F_11 ( & V_115 ) ;
...
unsigned char * V_123 = ( char * ) & V_31 -> V_124 . V_125 . V_126 ;
int V_127 ;
T_5 V_128 = F_63 ( V_31 -> V_129 . V_126 ) ;
for ( V_127 = 0 ; V_128 ; V_128 <<= 1 , V_127 ++ ) ;
F_28 ( V_66 , L_12 ,
V_123 [ 0 ] , V_123 [ 1 ] , V_123 [ 2 ] , V_123 [ 3 ] , V_127 , V_31 -> V_130 ) ;
return 0 ;
}
...
if ( V_31 -> V_124 . V_125 . V_126 == V_143 &&
V_31 -> V_129 . V_126 == V_141 . V_126 ) {
V_17 = 1 ;
break;
}
}
F_2 ( & V_139 ) ;
if ( V_17 == 0 ) {
V_31 = F_19 ( sizeof( * V_31 ) , V_41 ) ;
if ( V_31 == NULL )
V_27 = - V_56 ;
else {
V_27 = 0 ;
V_31 -> V_124 . V_125 . V_126 = V_136 . V_125 . V_126 ;
V_31 -> V_129 . V_126 = V_141 . V_126 ;
V_31 -> V_130 = V_16 ;
F_65 ( V_31 ) ;
}
...
if ( V_31 -> V_130 != V_148 )
V_27 = F_69 ( & V_150 , NULL ,
& V_31 -> V_124 . V_125 , & V_31 -> V_129 ,
V_81 , & V_139 ) ;
else
V_27 = 0 ;
V_31 -> V_130 = V_16 ;
}
if ( V_27 == 0 && V_16 != V_148 )
V_27 = F_70 ( & V_150 , NULL ,
& V_31 -> V_124 . V_125 , & V_31 -> V_129 , V_81 ,
F_5 ( V_31 -> V_130 ) , & V_139 ) ;
if ( V_27 == 0 )
V_27 = V_46 ;
F_11 ( & V_149 ) ;
V_146:
...
V_27 = F_72 ( V_45 , V_46 , V_47 , V_152 , strlen ( V_152 ) ) ;
return V_27 ;
}
...
if ( V_31 -> V_99 . V_100 . V_101 . V_104 ==
V_153 )
V_31 -> V_99 . V_100 . V_101 . V_104 = V_103 ;
V_153 = V_103 ;
F_11 ( & V_154 ) ;
}
return V_46 ;
...
if ( V_156 >= V_157 )
V_27 = F_72 ( V_45 , V_156 , V_47 , V_137 , V_157 ) ;
return V_27 ;
}
...
char * V_166 ;
int V_167 ;
V_38 = F_92 ( V_44 , V_45 , V_46 ) ;
if ( F_93 ( V_38 ) )
return F_94 ( V_38 ) ;
if ( V_48 == V_53 ) {
if ( V_46 < V_55 )
return - V_51 ;
V_167 = F_17 ( V_38 , & V_25 , 0 ) ;
} else {
V_166 = F_19 ( V_46 + 1 , V_41 ) ;
if ( V_166 == NULL )
return - V_56 ;
memcpy ( V_166 , V_38 , V_46 ) ;
V_166 [ V_46 ] = '\0' ;
...
static int F_106 ( struct V_171 * V_172 , void * V_38 , int V_173 )
{
int V_27 ;
struct V_74 * V_174 ;
...
V_27 = F_107 ( V_172 , V_210 , V_176 ) ;
if ( V_27 != 0 ) {
F_40 ( V_211 L_32 ,
V_83 , V_27 ) ;
return V_27 ;
}
V_174 = V_172 -> V_212 -> V_213 ;
V_174 -> V_214 = F_108 ( V_95 . V_32 ) ;
return 0 ;
}
static struct V_215 * F_109 ( struct V_216 * V_217 ,
int V_218 , const char * V_219 , void * V_38 )
{
return F_110 ( V_217 , V_218 , V_38 , F_106 ) ;
}
static int T_7 F_111 ( struct V_30 * V_31 )
{
V_31 -> V_99 . V_220 = V_31 -> V_32 ;
V_31 -> V_99 . V_218 =
V_221 | V_222 ;
return F_54 ( V_153 , V_31 -> V_32 ,
& V_31 -> V_99 , strlen ( V_31 -> V_32 ) ) ;
}
