...
F_29 ( V_43 , V_60 -> V_65 , V_64 ) ;
}
static T_3 F_30 ( int V_91 , void * V_92 )
{
T_1 V_93 , V_94 ;
struct V_1 * V_2 = V_92 ;
...
static void F_41 ( struct V_42 * V_43 , int V_119 )
{
if ( V_119 )
F_3 ( V_120 ,
V_43 -> V_7 + V_113 ) ;
...
static void F_43 ( struct V_42 * V_5 , int V_122 )
{
...
static void
F_44 ( struct V_124 * V_125 , const char * V_126 , unsigned int V_127 )
{
struct V_1 * V_2 ;
struct V_42 * V_5 ;
...
static int T_4
F_49 ( struct V_124 * V_125 , char * V_142 )
{
struct V_1 * V_2 ;
int V_64 = 9600 ;
int V_134 = 8 ;
...
int V_143 = 'n' ;
int V_144 ;
if ( V_125 -> V_130 == - 1 || V_125 -> V_130 >= F_50 ( V_132 ) )
V_125 -> V_130 = 0 ;
V_2 = V_132 [ V_125 -> V_130 ] ;
if ( ! V_2 )
return - V_145 ;
F_35 ( V_2 -> V_107 ) ;
if ( V_142 )
F_51 ( V_142 , & V_64 , & V_30 , & V_134 , & V_143 ) ;
else
F_48 ( & V_2 -> V_5 , & V_64 , & V_30 , & V_134 ) ;
V_144 = F_52 ( & V_2 -> V_5 , V_125 , V_64 , V_30 , V_134 , V_143 ) ;
F_37 ( V_2 -> V_107 ) ;
return V_144 ;
}
static int T_5 F_53 ( struct V_146 * V_147 )
{
struct V_1 * V_2 ;
T_1 V_148 ;
int V_144 = 0 ;
struct V_149 * V_150 ;
struct V_151 * V_151 ;
V_2 = F_54 ( sizeof( struct V_1 ) , V_152 ) ;
if ( ! V_2 ) {
V_144 = - V_153 ;
goto V_28;
}
V_151 = F_55 ( & V_147 -> V_50 ) ;
if ( F_56 ( V_151 ) ) {
V_144 = F_57 ( V_151 ) ;
goto V_154;
}
V_2 -> V_107 = F_58 ( & V_147 -> V_50 , NULL ) ;
if ( F_56 ( V_2 -> V_107 ) ) {
V_144 = F_57 ( V_2 -> V_107 ) ;
goto V_154;
}
V_150 = F_59 ( V_147 , V_155 , 0 ) ;
if ( ! V_150 ) {
V_144 = - V_156 ;
goto V_157;
}
V_2 -> V_5 . V_158 = V_150 -> V_159 ;
V_2 -> V_5 . V_7 = F_60 ( V_150 -> V_159 , F_61 ( V_150 ) ) ;
V_2 -> V_5 . V_160 = & V_161 ;
V_2 -> V_5 . V_162 = V_163 ;
V_2 -> V_5 . line = V_147 -> V_164 < 0 ? 0 : V_147 -> V_164 ;
V_2 -> V_5 . V_165 = 16 ;
V_2 -> V_5 . V_89 = F_62 ( V_2 -> V_107 ) ;
V_2 -> V_5 . type = V_47 ;
V_2 -> V_5 . V_50 = V_2 -> V_50 = F_63 ( & V_147 -> V_50 ) ;
V_2 -> V_49 = 0 ;
V_2 -> V_52 = 0 ;
V_2 -> V_91 = F_64 ( V_147 , 0 ) ;
V_2 -> V_5 . V_91 = V_2 -> V_91 ;
V_144 = F_65 ( V_2 -> V_91 , F_30 , 0 , F_20 ( & V_147 -> V_50 ) , V_2 ) ;
if ( V_144 )
goto V_157;
F_66 ( V_147 , V_2 ) ;
V_132 [ V_147 -> V_164 ] = V_2 ;
F_32 ( & V_2 -> V_5 ) ;
V_144 = F_67 ( & V_166 , & V_2 -> V_5 ) ;
if ( V_144 )
goto V_167;
V_148 = F_2 ( V_2 -> V_5 . V_7 + V_168 ) ;
F_68 ( & V_147 -> V_50 , L_1 ,
( V_148 >> 24 ) & 0xff ,
( V_148 >> 16 ) & 0xff , V_148 & 0xffff ) ;
return 0 ;
V_167:
V_132 [ V_147 -> V_164 ] = NULL ;
F_69 ( V_2 -> V_91 , V_2 ) ;
V_157:
F_70 ( V_2 -> V_107 ) ;
V_154:
...
static int T_6 F_72 ( struct V_146 * V_147 )
{
struct V_1 * V_2 = F_73 ( V_147 ) ;
F_74 ( & V_166 , & V_2 -> V_5 ) ;
V_132 [ V_147 -> V_164 ] = NULL ;
F_70 ( V_2 -> V_107 ) ;
F_69 ( V_2 -> V_91 , V_2 ) ;
