...
static int F_36 ( struct V_2 * V_21 ,
const struct V_22 * V_23 , T_1 * V_24 )
{
T_1 V_25 = V_23 -> args [ 0 ] ;
if ( ( V_25 > F_37 ( V_26 ) ||
( V_21 != & V_26 [ V_25 ] . V_4 ) ) )
return - V_20 ;
if ( V_24 )
...
static int T_3 F_38 ( struct V_27 * V_28 )
{
int V_29 ;
for ( V_29 = 0 ; V_29 < F_37 ( V_26 ) ; V_29 ++ ) {
if ( V_28 -> V_30 . V_31 ) {
V_26 [ V_29 ] . V_4 . V_32 = F_36 ;
V_26 [ V_29 ] . V_4 . V_33 = 3 ;
V_26 [ V_29 ] . V_4 . V_31 = V_28 -> V_30 . V_31 ;
}
F_39 ( & V_26 [ V_29 ] . V_4 ) ;
}
return 0 ;
