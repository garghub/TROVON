...
V_15 > V_25 ) {
V_37 = V_24 - 1 ;
F_13 ( V_4 , V_14 , V_37 , V_38 , 0 ) ;
F_14 ( V_16 , V_17 , V_14 ,
V_37 + 1 ) ;
F_12 ( V_39 L_6 , V_14 , V_37 ) ;
V_14 = V_25 + 1 ;
V_36 = 1 ;
}
if ( V_36 ) {
if ( V_14 <= V_15 ) {
F_12 ( V_39 L_7 , V_37 ? L_8 : L_9 , V_14 , V_15 ) ;
} else {
F_12 ( V_39 L_10 , V_37 ? L_11 : L_12 ) ;
continue;
}
}
}
...
V_42 = V_4 -> V_45 ;
F_12 ( V_32 L_15 ,
V_4 -> V_45 , V_4 -> V_46 , V_4 -> V_2 , V_4 -> V_3 ) ;
...
static void T_5 F_18 ( void * V_48 )
{
T_3 V_13 ;
F_16 ( V_49 , V_13 ) ;
if ( ! ( V_13 & V_50 ) ) {
...
{
#ifdef F_23
unsigned int V_8 , V_59 ;
for ( V_59 = V_8 = 0 ; ! V_59 && V_60 [ V_8 ] . V_61 ; ++ V_8 ) {
T_6 V_9 = V_60 [ V_8 ] . V_9 ;
T_6 V_10 = V_60 [ V_8 ] . V_62 ;
T_6 V_63 = V_60 [ V_8 ] . V_61 ;
for (; V_10 < V_63 ; ++ V_10 ) {
