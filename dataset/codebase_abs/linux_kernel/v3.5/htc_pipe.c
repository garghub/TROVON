...
static struct V_1 * F_29 ( void )
{
struct V_1 * V_2 = NULL ;
struct V_47 * V_7 ;
V_2 = F_30 ( sizeof( struct V_1 ) , V_80 ) ;
if ( V_2 == NULL )
return NULL ;
V_7 = F_31 ( V_81 , V_80 ) ;
if ( V_7 == NULL ) {
...
static void F_32 ( struct V_21 * V_18 ,
struct V_1 * V_2 )
{
F_26 ( V_2 ) ;
}
static struct V_1 * F_33 ( struct V_21 * V_18 )
{
return F_29 () ;
}
static void F_34 ( struct V_21 * V_18 ,
struct V_1 * V_2 )
{
F_32 ( V_18 , V_2 ) ;
}
static int F_35 ( struct V_21 * V_18 )
{
...
static void F_36 ( struct V_21 * V_18 ,
struct V_97 * V_98 ,
int V_99 ,
enum V_100 V_101 )
{
...
static struct V_1 * F_38 ( struct V_21 * V_18 ,
struct V_9 * V_10 ,
struct V_47 * V_7 )
{
struct V_1 * V_2 , * V_62 , * V_104 = NULL ;
F_18 ( & V_18 -> V_52 ) ;
F_24 (packet, tmp_pkt, &ep->pipe.tx_lookup_queue,
list) {
if ( V_7 == V_2 -> V_7 ) {
F_9 ( & V_2 -> V_19 ) ;
V_104 = V_2 ;
...
static int F_39 ( struct V_63 * V_57 , struct V_47 * V_7 )
{
...
static int F_41 ( struct V_21 * V_18 ,
struct V_11 * V_44 )
{
struct V_9 * V_10 ;
struct V_1 * V_2 , * V_62 ;
...
F_22 ( V_18 , V_10 , V_44 ) ;
if ( ! F_4 ( V_44 ) ) {
F_24 (packet, tmp_pkt, pkt_queue, list) {
V_2 -> V_45 = - V_59 ;
}
F_3 ( V_10 , V_44 ) ;
}
...
static struct V_1 * F_42 ( struct V_21 * V_18 )
{
struct V_1 * V_2 ;
F_18 ( & V_18 -> V_110 ) ;
...
static void F_43 ( struct V_21 * V_18 ,
struct V_1 * V_2 )
{
struct V_11 * V_113 ;
F_18 ( & V_18 -> V_110 ) ;
...
static int F_44 ( struct V_21 * V_18 , T_1 * V_114 ,
...
static int F_47 ( struct V_63 * V_57 , struct V_47 * V_7 ,
T_1 V_71 )
{
struct V_21 * V_18 = V_57 -> V_21 ;
...
V_18 -> V_53 . V_132 = F_50 ( int , V_107 ,
V_133 ) ;
...
static void F_52 ( struct V_21 * V_18 ,
struct V_9 * V_10 )
{
struct V_11 V_23 ;
struct V_1 * V_2 ;
...
static int F_53 ( struct V_21 * V_18 )
{
int V_140 = V_141 ;
while ( V_140 > 0 ) {
F_18 ( & V_18 -> V_110 ) ;
...
static void F_55 ( struct V_21 * V_144 ,
struct V_1 * V_2 )
{
F_5 ( V_15 , L_25 , V_16 ) ;
}
static void F_56 ( struct V_21 * V_18 )
{
struct V_9 * V_10 ;
int V_69 ;
...
F_7 ( & V_10 -> V_137 ) ;
V_10 -> V_18 = V_18 ;
V_10 -> V_53 . V_77 = ( bool ) 1 ;
}
}
static int F_57 ( struct V_21 * V_18 )
{
return 0 ;
}
static T_1 F_58 ( struct V_21 * V_18 , T_2 V_89 )
{
T_1 V_147 = 0 ;
int V_69 ;
for ( V_69 = 0 ; V_69 < V_96 ; V_69 ++ ) {
...
memset ( V_155 , 0 ,
sizeof( struct V_154 ) ) ;
V_155 -> V_163 = F_61 ( V_164 ) ;
V_155 -> V_145 = F_61 ( V_149 -> V_145 ) ;
V_155 -> V_165 = F_61 ( V_149 -> V_165 &
~ V_166 ) ;
V_5 = V_160 << V_167 ;
V_155 -> V_165 |= F_61 ( V_5 ) ;
if ( V_149 -> V_165 &
V_168 ) {
V_157 = true ;
}
F_62 ( V_2 , NULL , ( T_1 * ) V_155 ,
V_159 ,
V_35 , V_169 ) ;
V_45 = F_63 ( V_18 , V_2 ) ;
V_2 = NULL ;
...
static void * F_65 ( struct V_63 * V_57 )
{
int V_45 = 0 ;
...
struct V_1 * V_2 ;
int V_69 ;
V_18 = F_30 ( sizeof( struct V_21 ) , V_80 ) ;
if ( V_18 == NULL ) {
F_40 ( L_31 ) ;
V_45 = - V_59 ;
goto V_179;
...
V_18 -> V_56 = F_30 ( sizeof( * V_18 -> V_56 ) , V_80 ) ;
if ( ! V_18 -> V_56 ) {
F_40 ( L_32 ) ;
V_45 = - V_59 ;
goto V_179;
...
static void F_68 ( struct V_21 * V_18 )
{
struct V_1 * V_2 ;
while ( true ) {
V_2 = F_42 ( V_18 ) ;
...
static int F_69 ( struct V_21 * V_18 )
{
struct V_47 * V_7 ;
struct V_183 * V_184 ;
struct V_1 * V_2 ;
...
V_7 = V_2 -> V_7 ;
V_184 = (struct V_183 * ) F_60 ( V_7 ,
sizeof( * V_184 ) ) ;
memset ( V_184 , 0 , sizeof( struct V_183 ) ) ;
V_184 -> V_163 = F_61 ( V_185 ) ;
F_5 ( V_15 , L_33 ) ;
F_62 ( V_2 , NULL , ( T_1 * ) V_184 ,
sizeof( struct V_183 ) ,
V_35 , V_169 ) ;
V_18 -> V_129 |= V_130 ;
return F_63 ( V_18 , V_2 ) ;
}
...
static int F_63 ( struct V_21 * V_18 ,
struct V_1 * V_2 )
{
struct V_11 V_24 ;
F_5 ( V_15 ,
...
F_7 ( & V_24 ) ;
F_11 ( & V_2 -> V_19 , & V_24 ) ;
return F_41 ( V_18 , & V_24 ) ;
}
static int F_72 ( struct V_21 * V_18 )
{
struct V_188 * V_189 ;
struct V_148 V_190 ;
struct V_150 V_191 ;
...
if ( V_189 -> V_192 . V_163 != F_61 ( V_193 ) ) {
F_5 ( V_15 , L_36 ,
V_189 -> V_192 . V_163 ) ;
return - V_143 ;
}
...
V_189 -> V_192 . V_194 ,
V_189 -> V_192 . V_175 ) ;
V_18 -> V_87 = F_48 ( V_189 -> V_192 . V_194 ) ;
V_18 -> V_32 = F_48 ( V_189 -> V_192 . V_175 ) ;
if ( ( V_18 -> V_87 == 0 ) || ( V_18 -> V_32 == 0 ) )
return - V_143 ;
F_35 ( V_18 ) ;
memset ( & V_190 , 0 , sizeof( V_190 ) ) ;
memset ( & V_191 , 0 , sizeof( V_191 ) ) ;
V_190 . V_13 . V_20 = F_34 ;
V_190 . V_13 . V_123 = F_55 ;
V_190 . V_73 = V_195 ;
V_190 . V_145 = V_162 ;
V_45 = F_59 ( V_18 , & V_190 , & V_191 ) ;
return V_45 ;
}
static void F_73 ( struct V_21 * V_18 ,
...
F_37 ( V_18 , V_10 , V_103 ) ;
}
static int F_74 ( struct V_21 * V_18 ,
struct V_11 * V_44 )
{
struct V_1 * V_2 , * V_62 , * V_196 ;
struct V_9 * V_10 ;
int V_45 = 0 ;
if ( F_4 ( V_44 ) )
return - V_49 ;
V_196 = F_8 ( V_44 , struct V_1 , V_19 ) ;
if ( V_196 -> V_22 >= V_96 ) {
F_15 ( 1 ) ;
return - V_49 ;
}
F_5 ( V_15 , L_38 ,
V_16 , V_196 -> V_22 , F_6 ( V_44 ) ,
V_196 -> V_139 ) ;
V_10 = & V_18 -> V_22 [ V_196 -> V_22 ] ;
F_18 ( & V_18 -> V_110 ) ;
...
static void F_76 ( struct V_21 * V_18 )
{
}
static int F_77 ( struct V_21 * V_18 ,
struct V_198 * V_3 )
{
return 0 ;
}
void F_78 ( struct V_63 * V_57 )
{
V_57 -> V_199 = & V_200 ;
}
