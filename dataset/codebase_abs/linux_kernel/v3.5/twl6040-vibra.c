...
struct V_65 * V_66 = V_61 -> V_9 . V_67 ;
struct V_3 * V_4 ;
int V_68 = 0 ;
int V_69 = 0 ;
int V_15 ;
...
V_4 = F_33 ( sizeof( * V_4 ) , V_71 ) ;
if ( ! V_4 ) {
F_8 ( & V_61 -> V_9 , L_7 ) ;
return - V_72 ;
}
V_4 -> V_9 = & V_61 -> V_9 ;
V_4 -> V_5 = F_34 ( V_61 -> V_9 . V_73 ) ;
if ( V_63 ) {
V_4 -> V_35 = V_63 -> V_35 ;
V_4 -> V_38 = V_63 -> V_38 ;
V_4 -> V_36 = V_63 -> V_36 ;
...
F_35 ( V_66 , L_8 , & V_4 -> V_35 ) ;
F_35 ( V_66 , L_9 , & V_4 -> V_38 ) ;
F_35 ( V_66 , L_10 ,
& V_4 -> V_36 ) ;
F_35 ( V_66 , L_11 ,
& V_4 -> V_39 ) ;
...
F_39 ( V_4 -> V_47 , V_4 ) ;
V_4 -> V_47 -> V_75 = L_17 ;
V_4 -> V_47 -> V_76 . V_77 = 1 ;
V_4 -> V_47 -> V_9 . V_73 = V_61 -> V_9 . V_73 ;
V_4 -> V_47 -> V_78 = F_27 ;
F_40 ( V_79 , V_4 -> V_47 -> V_80 ) ;
V_15 = F_41 ( V_4 -> V_47 , NULL , F_22 ) ;
if ( V_15 < 0 ) {
F_8 ( V_4 -> V_9 , L_18 ) ;
goto V_81;
}
...
F_43 ( V_61 , V_4 ) ;
V_15 = F_44 ( V_4 -> V_1 , NULL , F_1 , 0 ,
L_20 , V_4 ) ;
if ( V_15 ) {
F_8 ( V_4 -> V_9 , L_21 , V_15 ) ;
goto V_83;
}
V_4 -> V_16 [ 0 ] . V_84 = L_22 ;
V_4 -> V_16 [ 1 ] . V_84 = L_23 ;
V_15 = F_45 ( V_4 -> V_9 , F_7 ( V_4 -> V_16 ) ,
V_4 -> V_16 ) ;
if ( V_15 ) {
F_8 ( V_4 -> V_9 , L_24 , V_15 ) ;
goto V_85;
}
if ( V_68 ) {
V_15 = F_46 ( V_4 -> V_16 [ 0 ] . V_34 ,
V_68 , V_68 ) ;
if ( V_15 ) {
F_8 ( V_4 -> V_9 , L_25 ,
V_15 ) ;
...
static int T_4 F_55 ( struct V_60 * V_61 )
{
struct V_3 * V_4 = F_31 ( V_61 ) ;
F_51 ( V_4 -> V_47 ) ;
F_50 ( V_4 -> V_1 , V_4 ) ;
