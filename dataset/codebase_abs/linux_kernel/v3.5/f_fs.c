...
break;
case V_231 : {
struct V_232 * V_205 = ( void * ) V_211 ;
F_14 ( L_25 ) ;
if ( V_24 != sizeof *V_205 )
goto V_220;
if ( V_205 -> V_233 )
F_130 ( STRING , V_205 -> V_233 ) ;
}
break;
case V_234 :
case V_235 :
...
if ( V_101 == V_63 )
V_13 = NULL ;
V_16 = V_208 ( V_241 , ( T_7 * ) V_101 , ( void * ) V_13 , V_209 ) ;
if ( F_10 ( V_16 < 0 ) ) {
F_16 ( L_29 ,
V_101 , V_16 ) ;
return V_16 ;
...
static int F_132 ( enum V_242 type ,
T_7 * V_243 , struct V_210 * V_207 ,
void * V_209 )
{
...
break;
case V_246 :
if ( ( * V_243 & V_247 ) > V_10 -> V_165 )
V_10 -> V_165 = ( * V_243 & V_247 ) ;
break;
}
return 0 ;
}
...
{
unsigned V_248 , V_249 ;
int V_250 , V_16 = - V_46 ;
char * V_13 = V_131 ;
F_18 () ;
if ( F_10 ( F_133 ( V_13 ) != V_251 ||
F_133 ( V_13 + 4 ) != V_14 ) )
goto error;
V_248 = F_133 ( V_13 + 8 ) ;
V_249 = F_133 ( V_13 + 12 ) ;
...
{
struct {
struct V_177 * V_168 [ V_255 + 1 ] ;
struct V_177 V_257 [ V_255 ] ;
struct V_181 V_183 [ V_255 * ( V_254 + 1 ) ] ;
} * V_258 ;
unsigned V_59 = 0 ;
V_258 = F_39 ( sizeof *V_258 , V_67 ) ;
if ( F_10 ( ! V_258 ) ) {
F_33 ( V_131 ) ;
return - V_68 ;
}
...
V_14 -= 16 ;
do {
unsigned V_259 = V_254 ;
if ( F_10 ( V_14 < 3 ) )
goto V_260;
V_157 -> V_261 = F_134 ( V_13 ) ;
V_157 -> V_183 = V_185 ;
++ V_157 ;
V_13 += 2 ;
V_14 -= 2 ;
...
{
T_7 * V_18 = V_10 -> V_18 . V_60 , * V_272 = V_18 ;
unsigned V_56 = V_10 -> V_18 . V_63 ;
for (; V_56 ; -- V_56 , ++ V_18 )
if ( ( * V_18 == V_263 || * V_18 == V_264 ) == V_265 )
* V_272 ++ = * V_18 ;
else
F_14 ( L_31 , * V_18 ) ;
V_10 -> V_18 . V_63 = V_272 - V_10 -> V_18 . V_60 ;
}
F_14 ( L_32 , type ) ;
...
static int F_140 ( enum V_242 type , T_7 * V_243 ,
struct V_210 * V_207 ,
void * V_209 )
{
...
struct V_82 * V_82 ;
const int V_273 = V_76 -> V_4 . V_274 != NULL ;
unsigned V_275 ;
if ( type != V_241 )
return 0 ;
if ( V_273 )
V_76 -> V_4 . V_274 [ ( long ) V_243 ] = V_207 ;
else
V_76 -> V_4 . V_276 [ ( long ) V_243 ] = V_207 ;
if ( ! V_207 || V_207 -> V_213 != V_224 )
return 0 ;
V_275 = ( V_205 -> V_228 & V_247 ) - 1 ;
V_82 = V_76 -> V_203 + V_275 ;
if ( F_10 ( V_82 -> V_206 [ V_273 ] ) ) {
F_14 ( L_33 ,
V_273 ? L_34 : L_35 ,
V_205 -> V_228 & V_247 ) ;
return - V_46 ;
}
V_82 -> V_206 [ V_273 ] = V_205 ;
F_141 ( L_36 , V_205 , V_205 -> V_212 ) ;
if ( V_82 -> V_6 ) {
V_205 -> V_228 = V_82 -> V_206 [ 0 ] -> V_228 ;
if ( ! V_205 -> V_277 )
V_205 -> V_277 = V_82 -> V_206 [ 0 ] -> V_277 ;
} else {
struct V_7 * V_8 ;
struct V_5 * V_6 ;
F_14 ( L_37 ) ;
...
if ( F_10 ( ! V_6 ) )
return - V_278 ;
V_6 -> V_83 = V_76 -> V_203 + V_275 ;
V_8 = F_107 ( V_6 , V_67 ) ;
if ( F_10 ( ! V_8 ) )
return - V_68 ;
V_82 -> V_6 = V_6 ;
V_82 -> V_8 = V_8 ;
V_76 -> V_279 [ V_205 -> V_228 &
V_247 ] = V_275 + 1 ;
}
F_141 ( L_38 , V_205 , V_205 -> V_212 ) ;
return 0 ;
}
static int F_143 ( enum V_242 type , T_7 * V_243 ,
struct V_210 * V_207 ,
void * V_209 )
{
struct V_1 * V_76 = V_209 ;
...
case V_244 :
V_275 = * V_243 ;
if ( V_76 -> V_281 [ V_275 ] < 0 ) {
int V_184 = F_144 ( V_76 -> V_202 , & V_76 -> V_4 ) ;
if ( F_10 ( V_184 < 0 ) )
return V_184 ;
V_76 -> V_281 [ V_275 ] = V_184 ;
}
V_280 = V_76 -> V_281 [ V_275 ] ;
break;
case V_245 :
V_280 = V_76 -> V_10 -> V_168 [ 0 ] -> V_183 [ * V_243 - 1 ] . V_184 ;
break;
case V_246 :
if ( V_207 -> V_213 == V_224 )
return 0 ;
V_275 = ( * V_243 & V_247 ) - 1 ;
if ( F_10 ( ! V_76 -> V_203 [ V_275 ] . V_6 ) )
return - V_46 ;
{
struct V_204 * * V_206 ;
V_206 = V_76 -> V_203 [ V_275 ] . V_206 ;
V_280 = V_206 [ V_206 [ 0 ] ? 0 : 1 ] -> V_228 ;
}
break;
}
F_14 ( L_39 , * V_243 , V_280 ) ;
* V_243 = V_280 ;
return 0 ;
}
...
struct V_9 * V_10 = V_76 -> V_10 ;
const int V_282 = ! ! V_76 -> V_10 -> V_171 ;
const int V_283 = F_145 ( V_76 -> V_25 ) &&
V_76 -> V_10 -> V_172 ;
int V_16 ;
struct {
struct V_82 V_203 [ V_10 -> V_165 ] ;
struct V_210
* V_284 [ V_282 ? V_10 -> V_171 + 1 : 0 ] ;
struct V_210
* V_285 [ V_283 ? V_10 -> V_172 + 1 : 0 ] ;
short V_286 [ V_10 -> V_174 ] ;
char V_166 [ V_283 ? V_10 -> V_169
: V_10 -> V_170 ] ;
} * V_13 ;
F_18 () ;
if ( F_10 ( ! ( V_282 | V_283 ) ) )
...
memset ( V_13 -> V_286 , 0xff , sizeof V_13 -> V_286 ) ;
for ( V_16 = V_10 -> V_165 ; V_16 ; -- V_16 )
V_13 -> V_203 [ V_16 ] . V_101 = - 1 ;
V_76 -> V_203 = V_13 -> V_203 ;
V_76 -> V_281 = V_13 -> V_286 ;
if ( F_38 ( V_282 ) ) {
V_76 -> V_4 . V_276 = V_13 -> V_284 ;
...
int V_16 ;
F_18 () ;
F_14 ( L_40 , V_291 -> V_53 ) ;
F_14 ( L_41 , V_291 -> V_292 ) ;
F_14 ( L_42 , F_6 ( V_291 -> V_293 ) ) ;
F_14 ( L_43 , F_6 ( V_291 -> V_294 ) ) ;
F_14 ( L_44 , F_6 ( V_291 -> V_20 ) ) ;
if ( V_10 -> V_43 != V_48 )
return - V_77 ;
switch ( V_291 -> V_53 & V_295 ) {
case V_296 :
V_16 = F_45 ( V_76 , F_6 ( V_291 -> V_294 ) ) ;
if ( F_10 ( V_16 < 0 ) )
return V_16 ;
break;
case V_297 :
V_16 = F_146 ( V_76 , F_6 ( V_291 -> V_294 ) ) ;
if ( F_10 ( V_16 < 0 ) )
return V_16 ;
break;
default:
...
F_117 ( & V_10 -> V_18 . V_21 . V_22 , V_50 ) ;
V_10 -> V_18 . V_19 = * V_291 ;
V_10 -> V_18 . V_19 . V_294 = F_147 ( V_16 ) ;
F_136 ( V_10 , V_61 ) ;
F_118 ( & V_10 -> V_18 . V_21 . V_22 , V_50 ) ;
return 0 ;
}
...
{
F_18 () ;
F_139 ( F_1 ( V_3 ) -> V_10 , V_267 ) ;
}
static void V_201 ( struct V_2 * V_3 )
{
F_18 () ;
F_139 ( F_1 ( V_3 ) -> V_10 , V_266 ) ;
}
static int F_146 ( struct V_1 * V_76 , T_7 V_101 )
{
V_101 = V_76 -> V_279 [ V_101 & V_247 ] ;
return V_101 ? V_101 : - V_299 ;
}
static int F_45 ( struct V_1 * V_76 , T_7 V_289 )
{
short * V_300 = V_76 -> V_281 ;
unsigned V_63 = V_76 -> V_10 -> V_174 ;
for (; V_63 ; -- V_63 , ++ V_300 ) {
if ( * V_300 >= 0 && * V_300 == V_289 )
return V_300 - V_76 -> V_281 ;
}
return - V_299 ;
}
static int F_20 ( struct V_40 * V_40 , unsigned V_301 )
{
return V_301
