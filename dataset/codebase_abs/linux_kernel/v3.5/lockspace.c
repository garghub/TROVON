...
V_73 = V_49 . V_105 ;
V_2 -> V_106 = V_73 ;
V_2 -> V_107 = F_74 ( sizeof( struct V_108 ) * V_73 ) ;
if ( ! V_2 -> V_107 )
goto V_109;
for ( V_72 = 0 ; V_72 < V_73 ; V_72 ++ ) {
F_34 ( & V_2 -> V_107 [ V_72 ] . V_110 ) ;
F_35 ( & V_2 -> V_107 [ V_72 ] . V_102 ) ;
}
F_34 ( & V_2 -> V_111 ) ;
F_33 ( & V_2 -> V_112 ) ;
F_34 ( & V_2 -> V_113 ) ;
...
V_2 -> V_23 . V_33 = V_41 ;
error = F_85 ( & V_2 -> V_23 , & V_163 , NULL ,
L_21 , V_2 -> V_36 ) ;
if ( error )
goto V_164;
F_25 ( & V_2 -> V_23 , V_165 ) ;
...
{
struct V_167 * V_168 = V_54 ;
if ( V_168 -> V_170 && V_168 -> V_171 & V_172 )
F_101 ( V_168 -> V_170 ) ;
F_102 ( V_168 ) ;
return 0 ;
}
static int F_103 ( struct V_1 * V_2 , int V_173 )
{
int V_174 ;
F_41 ( & V_2 -> V_104 ) ;
if ( V_173 == 0 ) {
V_174 = F_104 ( & V_2 -> V_103 , F_99 , V_2 ) ;
} else if ( V_173 == 1 ) {
V_174 = F_104 ( & V_2 -> V_103 , F_98 , V_2 ) ;
} else {
V_174 = 0 ;
}
F_44 ( & V_2 -> V_104 ) ;
...
static int F_105 ( struct V_1 * V_2 , int V_173 )
{
struct V_126 * V_175 ;
struct V_100 * V_6 ;
int V_72 , V_176 , V_174 ;
V_176 = F_103 ( V_2 , V_173 ) ;
F_41 ( & V_40 ) ;
if ( V_2 -> V_60 == 1 ) {
if ( V_176 ) {
V_174 = - V_177 ;
...
F_108 ( V_2 ) ;
F_91 ( V_2 -> V_107 ) ;
F_104 ( & V_2 -> V_103 , F_100 , V_2 ) ;
F_109 ( & V_2 -> V_103 ) ;
F_92 ( & V_2 -> V_103 ) ;
for ( V_72 = 0 ; V_72 < V_2 -> V_95 ; V_72 ++ ) {
while ( ( V_6 = F_110 ( & V_2 -> V_96 [ V_72 ] . V_99 ) ) ) {
V_175 = F_111 ( V_6 , struct V_126 , V_178 ) ;
F_112 ( V_6 , & V_2 -> V_96 [ V_72 ] . V_99 ) ;
F_113 ( V_175 ) ;
}
while ( ( V_6 = F_110 ( & V_2 -> V_96 [ V_72 ] . V_101 ) ) ) {
V_175 = F_111 ( V_6 , struct V_126 , V_178 ) ;
F_112 ( V_6 , & V_2 -> V_96 [ V_72 ] . V_101 ) ;
F_113 ( V_175 ) ;
}
}
F_91 ( V_2 -> V_96 ) ;
while ( ! F_114 ( & V_2 -> V_117 ) ) {
V_175 = F_115 ( & V_2 -> V_117 , struct V_126 ,
V_179 ) ;
F_63 ( & V_175 -> V_179 ) ;
F_113 ( V_175 ) ;
}
