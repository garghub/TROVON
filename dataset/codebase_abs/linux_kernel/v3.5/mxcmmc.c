...
V_2 -> V_145 = V_179 ;
V_2 -> V_120 = V_120 ;
V_2 -> V_198 = F_75 ( & V_176 -> V_47 , L_17 ) ;
if ( F_4 ( V_2 -> V_198 ) ) {
V_156 = F_76 ( V_2 -> V_198 ) ;
goto V_199;
}
V_2 -> V_139 = F_75 ( & V_176 -> V_47 , L_18 ) ;
if ( F_4 ( V_2 -> V_139 ) ) {
...
F_77 ( V_2 -> V_198 ) ;
F_10 ( V_2 ) ;
V_2 -> V_200 = F_33 ( V_2 -> V_17 + V_201 ) ;
if ( V_2 -> V_200 != 0x400 ) {
V_156 = - V_202 ;
F_24 ( F_3 ( V_2 -> V_4 ) , L_19 ,
V_2 -> V_200 ) ;
goto V_203;
}
V_4 -> V_204 = F_54 ( V_2 -> V_139 ) >> 16 ;
V_4 -> V_205 = F_54 ( V_2 -> V_139 ) >> 1 ;
F_12 ( 0x2db4 , V_2 -> V_17 + V_206 ) ;
F_26 ( V_2 -> V_57 , V_2 -> V_17 + V_72 ) ;
V_179 = F_68 ( V_176 , V_207 , 0 ) ;
if ( V_179 ) {
V_2 -> V_208 = V_179 -> V_146 ;
V_2 -> V_174 . V_209 = V_210 ;
V_2 -> V_174 . V_211 = V_212 ;
V_2 -> V_174 . V_213 = V_2 -> V_208 ;
F_78 ( V_101 ) ;
F_79 ( V_214 , V_101 ) ;
...
if ( ! V_2 -> V_45 )
F_82 ( F_3 ( V_2 -> V_4 ) , L_20 ) ;
F_83 ( & V_2 -> V_117 , F_43 ) ;
V_156 = F_84 ( V_2 -> V_120 , F_48 , 0 , V_215 , V_2 ) ;
if ( V_156 )
goto V_216;
F_85 ( V_176 , V_4 ) ;
if ( V_2 -> V_6 && V_2 -> V_6 -> V_217 ) {
V_156 = V_2 -> V_6 -> V_217 ( & V_176 -> V_47 , F_59 ,
V_2 -> V_4 ) ;
if ( V_156 )
goto V_218;
}
...
F_90 ( V_4 ) ;
V_184:
F_91 ( V_178 -> V_146 , F_71 ( V_178 ) ) ;
return V_156 ;
}
static int F_92 ( struct V_175 * V_176 )
{
struct V_129 * V_4 = F_93 ( V_176 ) ;
struct V_1 * V_2 = F_53 ( V_4 ) ;
F_85 ( V_176 , NULL ) ;
F_94 ( V_4 ) ;
if ( V_2 -> V_3 )
...
F_88 ( V_2 -> V_139 ) ;
F_88 ( V_2 -> V_198 ) ;
F_91 ( V_2 -> V_145 -> V_146 , F_71 ( V_2 -> V_145 ) ) ;
F_90 ( V_4 ) ;
return 0 ;
}
static int F_96 ( struct V_46 * V_47 )
{
struct V_129 * V_4 = F_97 ( V_47 ) ;
struct V_1 * V_2 = F_53 ( V_4 ) ;
int V_156 = 0 ;
if ( V_4 )
V_156 = F_98 ( V_4 ) ;
