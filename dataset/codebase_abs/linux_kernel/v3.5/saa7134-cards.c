...
T_1 V_209 [ 3 ] ;
int V_36 , V_210 ;
struct V_211 V_212 [] = { { . V_181 = 0x50 , . V_213 = 0 , . V_204 = & V_208 , . V_214 = 1 } ,
{ . V_181 = 0x50 , . V_213 = V_215 , . V_204 = V_209 , . V_214 = 3 } } ;
V_208 = 0x14 ;
V_210 = 0 ;
V_36 = F_27 ( & V_2 -> V_216 , V_212 , 2 ) ;
if ( V_36 != 2 ) {
F_2 ( V_50 L_16 ) ;
} else if ( ( V_209 [ 0 ] != 0 ) && ( V_209 [ 0 ] != 0xff ) ) {
V_208 = V_209 [ 0 ] + 2 ;
V_212 [ 1 ] . V_214 = 2 ;
F_27 ( & V_2 -> V_216 , V_212 , 2 ) ;
V_210 = ( V_209 [ 0 ] << 8 ) + V_209 [ 1 ] ;
switch ( V_210 ) {
case 0x0103 :
V_2 -> V_46 = V_217 ;
break;
...
case V_220 :
if ( V_2 -> V_221 && ( V_2 -> V_222 [ 0x41 ] == 0x1c ) ) {
V_2 -> V_8 = V_223 ;
V_2 -> V_46 = V_178 [ V_2 -> V_8 ] . V_46 ;
F_2 ( V_57 L_21 ,
...
{
T_1 V_209 [] = { 0x07 , 0x02 } ;
struct V_211 V_212 = { . V_181 = 0x08 , . V_213 = 0 , . V_204 = V_209 , . V_214 = sizeof( V_209 ) } ;
F_27 ( & V_2 -> V_216 , & V_212 , 1 ) ;
break;
}
case V_227 :
case V_228 :
...
struct V_211 V_212 = { . V_181 = 0x08 , . V_213 = 0 , . V_204 = V_209 , . V_214 = sizeof( V_209 ) } ;
if ( V_2 -> V_221 && ( V_2 -> V_222 [ 0x49 ] == 0x50 ) ) {
V_2 -> V_8 = V_228 ;
F_2 ( V_57 L_21 ,
V_2 -> V_3 , V_178 [ V_2 -> V_8 ] . V_3 ) ;
}
...
case V_229 :
if ( V_2 -> V_221 && ( V_2 -> V_222 [ 0x27 ] == 0x03 ) ) {
V_2 -> V_8 = V_102 ;
F_2 ( V_57 L_22
L_23 ,
V_2 -> V_3 , V_178 [ V_2 -> V_8 ] . V_3 ) ;
...
{
T_1 V_209 [] = { 0x3c , 0x33 , 0x60 } ;
struct V_211 V_212 = { . V_181 = 0x0b , . V_213 = 0 , . V_204 = V_209 ,
. V_214 = sizeof( V_209 ) } ;
F_27 ( & V_2 -> V_216 , & V_212 , 1 ) ;
break;
}
...
struct V_211 V_212 = { . V_181 = 0x09 , . V_213 = 0 , . V_204 = V_209 , . V_214 = sizeof( V_209 ) } ;
F_27 ( & V_2 -> V_216 , & V_212 , 1 ) ;
V_212 . V_204 = & V_239 ;
V_212 . V_181 = 0x0b ;
V_212 . V_214 = 1 ;
if ( 1 != F_27 ( & V_2 -> V_216 , & V_212 , 1 ) ) {
F_2 ( V_56 L_24
L_25 , V_2 -> V_3 ) ;
} else {
V_212 . V_213 = V_215 ;
V_240 = F_27 ( & V_2 -> V_216 , & V_212 , 1 ) ;
F_2 ( V_57 L_26 ,
V_2 -> V_3 , V_212 . V_181 ,
( 1 == V_240 ) ? L_27 : L_28 ) ;
if ( V_240 == 1 )
...
case V_89 :
case V_90 :
if ( ! V_2 -> V_221 || ( V_2 -> V_222 [ 0x41 ] == 0xd0 ) )
break;
if ( V_2 -> V_222 [ 0x41 ] == 0x02 ) {
V_2 -> V_8 = V_90 ;
V_2 -> V_46 = V_178 [ V_2 -> V_8 ] . V_46 ;
...
case V_244 :
{
struct V_211 V_212 = { . V_181 = 0x0a , . V_213 = 0 } ;
int V_245 ;
static T_1 V_246 [] [ 2 ] = {
{ 0x10 , 0x12 } ,
{ 0x13 , 0x04 } ,
...
for ( V_245 = 0 ; V_245 < F_29 ( V_246 ) ; V_245 ++ ) {
V_212 . V_204 = & V_246 [ V_245 ] [ 0 ] ;
V_212 . V_214 = F_29 ( V_246 [ 0 ] ) ;
if ( F_27 ( & V_2 -> V_216 , & V_212 , 1 ) != 1 )
F_2 ( V_56
L_30 ,
V_2 -> V_3 , V_245 ) ;
}
...
struct V_211 V_212 = { . V_181 = 0x61 , . V_213 = 0 , . V_204 = V_209 ,
. V_214 = sizeof( V_209 ) } ;
if ( F_27 ( & V_2 -> V_216 , & V_212 , 1 ) != 1 )
F_2 ( V_56
L_31 ,
