...
char * T_4 F_48 ( char * V_112 )
{
return V_112 ;
}
T_5 F_49 ( void * V_113 , const struct V_68 * V_114 ,
T_5 V_15 , T_5 V_115 )
{
return V_114 -> V_69 ;
}
int F_50 ( struct V_59 * V_60 , int V_116 )
{
return 0 ;
}
void F_51 ( unsigned int V_117 , struct V_118 * V_21 )
{
V_117 = F_52 ( V_117 ) ;
if ( ! V_10 || ( V_117 & V_119 ) == 0 ) {
F_20 ( L_32 ,
V_117 , ( int ) V_21 -> V_120 , V_10 ) ;
for (; ; ) { }
}
V_10 = 0 ;
V_11 = 1 ;
V_21 -> V_120 = V_21 -> V_121 ;
V_21 -> V_121 += 4 ;
}
static inline unsigned long F_53 ( int V_122 )
{
return 1 << V_122 ;
}
static void F_54 ( struct V_123 * V_113 )
{
unsigned long V_116 , V_7 ;
V_116 = ( unsigned long ) V_113 -> V_124 ;
F_2 ( V_7 ) ;
F_3 ( V_116 , V_8 . V_33 + V_125 ) ;
F_7 ( V_7 ) ;
}
static void F_55 ( struct V_123 * V_113 )
{
unsigned long V_116 , V_7 ;
V_116 = ( unsigned long ) V_113 -> V_124 ;
F_2 ( V_7 ) ;
F_3 ( V_116 , V_8 . V_33 + V_126 ) ;
F_7 ( V_7 ) ;
}
static unsigned int F_56 ( struct V_123 * V_113 )
{
F_57 ( V_113 -> V_77 ) ;
F_55 ( V_113 ) ;
return 0 ;
}
unsigned int F_34 ( struct V_127 * V_128 ,
unsigned int V_74 )
{
unsigned int V_77 ;
unsigned long V_116 ;
...
F_59 ( V_77 , & V_130 ,
V_131 , L_33 ) ;
F_60 ( V_77 , ( void * ) V_116 ) ;
V_129:
return V_77 ;
}
static void F_61 ( int V_132 , unsigned int V_133 )
{
...
int F_63 ( struct V_59 * V_60 , int V_68 )
{
return - V_137 ;
}
void F_64 ( unsigned long V_138 , const void * V_139 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 1 ;
F_65 ( * ( const char * ) V_139 , V_138 ) ;
V_139 += 1 ;
}
}
void F_66 ( unsigned long V_138 , const void * V_139 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 2 ;
F_67 ( * ( const short * ) V_139 , V_138 ) ;
V_139 += 2 ;
}
}
void F_68 ( unsigned long V_138 , const void * V_139 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 4 ;
F_69 ( * ( const long * ) V_139 , V_138 ) ;
V_139 += 4 ;
}
}
void F_70 ( unsigned long V_138 , void * V_140 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 1 ;
* ( unsigned char * ) V_140 = F_71 ( V_138 ) ;
V_140 += 1 ;
}
}
void F_72 ( unsigned long V_138 , void * V_140 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 2 ;
* ( unsigned short * ) V_140 = F_73 ( V_138 ) ;
V_140 += 2 ;
}
}
void F_74 ( unsigned long V_138 , void * V_140 , unsigned long V_95 )
{
while ( V_95 ) {
V_95 -= 4 ;
* ( unsigned long * ) V_140 = F_75 ( V_138 ) ;
V_140 += 4 ;
}
}
