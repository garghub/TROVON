...
if ( ! V_80 ) {
T_2 V_20 , V_22 ;
V_102 -> V_109 -> V_226 ( V_102 , & V_20 , & V_22 ) ;
if ( V_27 -> V_39 == V_40 ) {
...
static int F_83 ( const char * V_227 , int V_228 ,
unsigned long * V_229 , unsigned long * V_230 )
{
int V_231 ;
unsigned long V_80 ;
...
static int F_86 ( struct V_201 * V_202 )
{
int V_57 , V_16 ;
unsigned long V_232 [ 10 ] ;
unsigned long V_233 [ 10 ] ;
memset ( & V_232 , 0 , sizeof( V_232 ) ) ;
memset ( & V_233 , 0 , sizeof( V_233 ) ) ;
if ( V_234 && F_83 ( V_234 , 10 ,
V_232 , V_233 ) ) {
...
for ( V_57 = 0 ; V_57 < V_202 -> V_222 ; V_57 ++ ) {
if ( V_57 == 0 || V_232 [ V_57 ] != 0 ) {
V_16 = F_80 ( V_202 -> V_223 [ V_57 ] ,
V_232 [ V_57 ] , V_233 [ V_57 ] ) ;
if ( V_16 )
return V_16 ;
}
}
...
struct V_101 * V_102 = F_32 ( V_2 ) ;
struct V_82 * V_83 = V_27 -> V_30 ;
unsigned long V_235 = V_83 -> V_80 ;
unsigned long V_236 = V_83 -> V_41 ;
int V_237 = V_83 -> type ;
int V_16 ;
if ( type != V_238 )
return - V_60 ;
V_80 = F_75 ( V_80 ) ;
if ( V_235 == V_80 && V_237 == type )
return 0 ;
...
if ( V_243 -> V_133 )
V_243 -> V_133 ( V_241 ) ;
V_243 -> V_226 ( V_241 , & V_20 , & V_22 ) ;
V_243 -> V_246 ( V_241 , 0 , 0 , V_20 , V_22 ) ;
V_244 = V_247 ;
if ( V_244 == 0 )
V_244 = 20 ;
F_91 ( V_202 -> V_248 ,
& V_204 -> V_245 , V_249 / V_244 ) ;
}
...
V_204 = F_63 ( V_202 , V_102 ) ;
F_93 ( & V_204 -> V_245 , F_89 ) ;
V_204 -> V_212 = true ;
F_89 ( & V_204 -> V_245 . V_240 ) ;
}
...
static int F_88 ( struct V_201 * V_202 , struct V_1 * V_2 )
{
struct V_6 * V_7 = & V_2 -> V_7 ;
struct V_101 * V_102 = F_32 ( V_2 ) ;
struct V_26 * V_27 = F_25 ( V_2 ) ;
...
if ( V_16 )
goto V_147;
V_16 = F_95 ( & V_2 -> V_196 , 256 , 0 ) ;
if ( V_16 )
F_69 ( V_202 -> V_219 , L_46 ) ;
V_147:
return V_16 ;
}
static void F_96 ( struct V_201 * V_202 , struct V_1 * V_2 )
{
F_97 ( & V_2 -> V_196 ) ;
}
static void F_98 ( struct V_201 * V_202 )
{
int V_57 ;
F_6 ( L_47 ) ;
if ( V_202 == NULL )
return;
for ( V_57 = 0 ; V_57 < V_202 -> V_222 ; V_57 ++ )
F_99 ( V_202 -> V_223 [ V_57 ] ) ;
F_73 ( V_202 ) ;
for ( V_57 = 0 ; V_57 < V_202 -> V_222 ; V_57 ++ ) {
F_96 ( V_202 , V_202 -> V_223 [ V_57 ] ) ;
F_100 ( V_202 -> V_223 [ V_57 ] ) ;
}
for ( V_57 = 0 ; V_57 < V_202 -> V_257 ; V_57 ++ ) {
struct V_101 * V_241 = V_202 -> V_258 [ V_57 ] . V_241 ;
if ( V_202 -> V_258 [ V_57 ] . V_212 )
F_65 ( V_202 , V_241 ) ;
if ( V_241 -> V_206 != V_259 )
V_241 -> V_109 -> V_260 ( V_241 ) ;
F_101 ( V_241 ) ;
}
if ( V_202 -> V_248 != NULL ) {
F_102 ( V_202 -> V_248 ) ;
...
V_27 -> V_202 = V_202 ;
V_27 -> V_103 = V_57 ;
V_27 -> V_30 = & V_202 -> V_262 [ V_57 ] ;
V_27 -> V_30 -> V_103 = V_57 ;
F_108 ( & V_27 -> V_30 -> V_263 ) ;
V_27 -> V_39 = V_264 ? V_40 :
V_265 ;
V_27 -> V_146 = V_266 ;
V_202 -> V_222 ++ ;
}
F_6 ( L_50 ) ;
for ( V_57 = 0 ; V_57 < F_109 ( V_202 -> V_222 , V_202 -> V_105 ) ; V_57 ++ ) {
struct V_26 * V_27 = F_25 ( V_202 -> V_223 [ V_57 ] ) ;
...
static int F_111 ( const char * V_267 ,
struct V_115 * V_116 , T_3 * V_268 )
{
struct V_1 * V_2 ;
struct V_6 * V_7 ;
struct V_269 * V_252 ;
int V_16 ;
#ifdef F_112
if ( strcmp ( V_267 , L_60 ) == 0 ) {
* V_116 = V_270 ;
* V_268 = 24 ;
return 0 ;
} else if ( strcmp ( V_267 , L_61 ) == 0 ) {
* V_116 = V_271 ;
* V_268 = 24 ;
return 0 ;
}
...
V_7 = NULL ;
V_252 = NULL ;
V_2 = F_113 ( sizeof( * V_2 ) , V_272 ) ;
if ( V_2 == NULL ) {
V_16 = - V_225 ;
goto V_147;
}
V_7 = F_113 ( sizeof( * V_7 ) , V_272 ) ;
if ( V_7 == NULL ) {
V_16 = - V_225 ;
goto V_147;
}
V_252 = F_113 ( sizeof( * V_252 ) , V_272 ) ;
if ( V_252 == NULL ) {
V_16 = - V_225 ;
goto V_147;
}
V_2 -> V_252 = V_252 ;
V_16 = F_114 ( V_7 , V_2 , V_267 , NULL , 0 , NULL , 24 ) ;
if ( V_16 == 0 ) {
V_16 = - V_60 ;
goto V_147;
}
...
V_116 -> V_273 = V_7 -> V_75 ;
V_116 -> V_274 = V_7 -> V_76 ;
switch ( V_7 -> V_13 ) {
case 16 :
* V_268 = 16 ;
break;
...
static int F_116 ( struct V_201 * V_202 ,
struct V_101 * V_102 , char * V_267 )
{
int V_16 ;
T_3 V_268 ;
struct V_115 V_116 , V_275 ;
struct V_203 * V_204 ;
V_16 = F_111 ( V_267 , & V_116 , & V_268 ) ;
if ( V_16 )
return V_16 ;
V_204 = F_63 ( V_202 , V_102 ) ;
V_204 -> V_276 = V_268 ;
if ( V_102 -> V_109 -> V_277 ) {
V_16 = V_102 -> V_109 -> V_277 ( V_102 , & V_116 ) ;
if ( V_16 )
return V_16 ;
} else {
if ( V_102 -> V_109 -> V_114 ) {
V_102 -> V_109 -> V_114 ( V_102 , & V_275 ) ;
if ( V_275 . V_273 != V_116 . V_273 ||
V_275 . V_274 != V_116 . V_274 )
return - V_60 ;
}
}
if ( V_102 -> V_109 -> V_278 )
V_102 -> V_109 -> V_278 ( V_102 , & V_116 ) ;
return 0 ;
}
...
{
struct V_203 * V_204 ;
F_117 ( V_241 -> V_109 -> V_279 == NULL ) ;
V_204 = F_63 ( V_202 , V_241 ) ;
if ( V_204 -> V_276 != 0 )
return V_204 -> V_276 ;
return V_241 -> V_109 -> V_279 ( V_241 ) ;
}
static int F_118 ( struct V_201 * V_202 )
{
char * V_280 , * V_281 , * V_282 ;
int V_16 = 0 ;
V_280 = F_119 ( V_283 , V_272 ) ;
if ( ! V_280 )
return - V_225 ;
V_281 = V_280 ;
while ( ! V_16 && ( V_282 = F_120 ( & V_281 , L_62 ) ) != NULL ) {
char * V_19 , * V_284 , * V_267 ;
struct V_101 * V_102 ;
int V_57 ;
V_19 = strchr ( V_282 , ':' ) ;
if ( ! V_19 ) {
...
V_102 = NULL ;
for ( V_57 = 0 ; V_57 < V_202 -> V_257 ; ++ V_57 ) {
if ( strcmp ( V_202 -> V_258 [ V_57 ] . V_241 -> V_285 ,
V_284 ) == 0 ) {
V_102 = V_202 -> V_258 [ V_57 ] . V_241 ;
break;
}
}
if ( ! V_102 ) {
...
static void F_121 ( struct V_286 * V_59 ,
struct V_115 * V_24 )
{
V_24 -> V_273 = V_59 -> V_75 ;
V_24 -> V_274 = V_59 -> V_76 ;
...
struct V_287 * V_288 ;
T_3 * V_289 ;
int V_16 , V_57 , V_290 , V_291 , V_169 ;
if ( ! V_102 -> V_109 -> V_292 )
return - V_293 ;
V_169 = 0x80 * 2 ;
V_289 = F_123 ( V_169 , V_272 ) ;
V_16 = V_102 -> V_109 -> V_292 ( V_102 , V_289 , V_169 ) ;
if ( V_16 < 0 )
goto V_294;
V_288 = F_113 ( sizeof( * V_288 ) , V_272 ) ;
F_124 ( V_289 , V_288 ) ;
if ( V_289 [ 126 ] > 0 )
F_125 ( V_289 + 0x80 , V_288 ) ;
V_290 = 0 ;
V_291 = - 1 ;
for ( V_57 = 0 ; V_57 < V_288 -> V_295 ; ++ V_57 ) {
struct V_286 * V_59 ;
struct V_115 V_24 ;
V_59 = & V_288 -> V_296 [ V_57 ] ;
if ( V_59 -> V_117 == 0 )
continue;
if ( V_59 -> V_75 == 2880 || V_59 -> V_75 == 1440 )
continue;
F_121 ( V_59 , & V_24 ) ;
V_16 = V_102 -> V_109 -> V_277 ( V_102 , & V_24 ) ;
if ( V_16 == 0 && V_290 < V_59 -> V_75 ) {
V_290 = V_59 -> V_75 ;
V_291 = V_57 ;
}
}
...
static int F_127 ( struct V_201 * V_202 ,
struct V_101 * V_241 )
{
struct V_242 * V_243 = V_241 -> V_109 ;
struct V_203 * V_204 ;
int V_16 ;
V_16 = V_243 -> V_298 ( V_241 ) ;
if ( V_16 ) {
F_128 ( V_202 -> V_219 , L_63 ,
V_241 -> V_285 ) ;
return V_16 ;
}
V_204 = F_63 ( V_202 , V_241 ) ;
V_204 -> V_202 = V_202 ;
if ( V_241 -> V_159 & V_209 ) {
T_2 V_20 , V_22 ;
if ( V_299 ) {
F_64 ( V_202 , V_241 ) ;
V_204 -> V_210 = V_211 ;
...
V_243 -> V_226 ( V_241 , & V_20 , & V_22 ) ;
V_16 = V_243 -> V_246 ( V_241 , 0 , 0 , V_20 , V_22 ) ;
if ( V_16 ) {
F_69 ( V_202 -> V_219 ,
L_65 ) ;
return V_16 ;
...
static int T_6 F_129 ( struct V_302 * V_303 )
{
...
F_6 ( L_66 ) ;
if ( V_303 -> V_305 != 0 ) {
F_69 ( & V_303 -> V_219 , L_67 ) ;
V_16 = - V_293 ;
goto V_306;
}
V_202 = F_113 ( sizeof( struct V_201 ) , V_272 ) ;
if ( V_202 == NULL ) {
V_16 = - V_225 ;
goto V_306;
}
if ( V_264 && ! F_130 () && ! F_131 () ) {
V_264 = 0 ;
F_128 ( & V_303 -> V_219 , L_68
L_69 ) ;
}
F_132 ( & V_202 -> V_307 ) ;
V_202 -> V_219 = & V_303 -> V_219 ;
F_133 ( V_303 , V_202 ) ;
V_16 = 0 ;
V_202 -> V_257 = 0 ;
V_241 = NULL ;
...
F_135 ( V_241 ) ;
if ( ! V_241 -> V_109 ) {
F_128 ( & V_303 -> V_219 , L_70 ,
V_241 -> V_285 ) ;
F_101 ( V_241 ) ;
continue;
}
V_204 = & V_202 -> V_258 [ V_202 -> V_257 ++ ] ;
V_204 -> V_241 = V_241 ;
if ( V_241 -> V_159 & V_209 )
V_204 -> V_210 = V_300 ;
else
...
goto V_308;
if ( V_202 -> V_257 == 0 ) {
F_69 ( & V_303 -> V_219 , L_71 ) ;
V_16 = - V_60 ;
goto V_308;
}
V_202 -> V_105 = F_136 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_105 ; V_57 ++ )
V_202 -> V_106 [ V_57 ] = F_137 ( V_57 ) ;
V_202 -> V_309 = F_138 () ;
for ( V_57 = 0 ; V_57 < V_202 -> V_309 ; V_57 ++ )
V_202 -> V_310 [ V_57 ] = F_139 ( V_57 ) ;
V_138 = F_137 ( 0 ) ;
if ( V_138 -> V_157 && V_138 -> V_157 -> V_311 ) {
V_304 = V_138 -> V_157 -> V_311 ;
} else {
F_128 ( & V_303 -> V_219 , L_72 ) ;
V_304 = NULL ;
}
if ( V_283 && strlen ( V_283 ) > 0 ) {
if ( F_118 ( V_202 ) )
F_128 ( & V_303 -> V_219 , L_73 ) ;
} else if ( V_304 && V_304 -> V_109 -> V_278 &&
V_304 -> V_109 -> V_277 ) {
struct V_115 V_24 ;
V_16 = F_122 ( V_304 , & V_24 ) ;
if ( V_16 == 0 )
V_304 -> V_109 -> V_278 ( V_304 , & V_24 ) ;
}
V_16 = F_106 ( V_202 ) ;
if ( V_16 )
goto V_308;
for ( V_57 = 0 ; V_57 < V_202 -> V_309 ; V_57 ++ ) {
struct V_312 * V_313 ;
V_313 = V_202 -> V_310 [ V_57 ] ;
V_16 = V_313 -> V_158 ( V_313 ) ;
if ( V_16 )
F_128 ( V_202 -> V_219 , L_74 ) ;
}
F_6 ( L_75 ) ;
if ( V_304 ) {
V_16 = F_127 ( V_202 , V_304 ) ;
if ( V_16 ) {
F_69 ( V_202 -> V_219 ,
L_76
L_77 ) ;
...
F_98 ( V_202 ) ;
V_306:
F_69 ( & V_303 -> V_219 , L_80 ) ;
return V_16 ;
}
static int T_7 F_141 ( struct V_302 * V_303 )
{
struct V_201 * V_202 = F_142 ( V_303 ) ;
F_143 ( V_202 ) ;
F_98 ( V_202 ) ;
return 0 ;
}
