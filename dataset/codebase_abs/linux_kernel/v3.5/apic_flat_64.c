...
static int F_32 ( char * V_1 , char * V_2 )
{
#ifdef F_33
...
static const struct V_3 * F_35 ( void )
{
return V_4 ;
}
static void F_36 ( int V_5 , struct V_3 * V_6 )
{
F_4 ( V_6 ) ;
F_37 ( V_5 , V_6 ) ;
}
static void F_38 ( const struct V_3 * V_3 , int V_16 )
{
F_39 ( V_3 , V_16 ) ;
}
static void F_40 ( const struct V_3 * V_3 ,
int V_16 )
{
F_41 ( V_3 , V_16 ) ;
}
...
static unsigned int F_44 ( const struct V_3 * V_3 )
{
int V_5 ;
V_5 = F_45 ( V_3 ) ;
if ( ( unsigned ) V_5 < V_36 )
return F_46 ( V_37 , V_5 ) ;
else
return V_38 ;
}
static unsigned int
F_47 ( const struct V_3 * V_3 ,
const struct V_3 * V_39 )
{
int V_5 ;
F_48 (cpu, cpumask, andmask) {
if ( F_49 ( V_5 , V_4 ) )
break;
}
return F_46 ( V_37 , V_5 ) ;
