...
goto V_38;
memcpy ( F_30 ( V_10 , V_25 ) , V_27 , V_25 ) ;
break;
case V_30 :
...
F_31 ( V_10 -> V_21 , & F_32 ( F_27 ( V_10 ) -> V_34 ) -> V_40 ) ;
...
static int F_33 ( struct V_5 * V_6 , unsigned int V_44 ,
unsigned long V_8 )
{
switch ( V_44 ) {
case V_45 :
return F_34 ( F_2 ( V_6 ) -> V_35 , ( int V_46 * ) V_8 )
? - V_47 : 0 ;
case V_48 :
...
static int F_36 ( struct V_2 * V_3 , void V_46 * V_8 )
{
struct V_50 V_51 ;
struct V_1 * V_11 ;
int V_52 ;
static const F_37 ( V_53 , F_3 , 0 ) ;
if ( F_38 ( & V_51 , V_8 , sizeof V_51 ) )
return - V_47 ;
if ( V_51 . V_22 != V_54 &&
V_51 . V_22 != V_55 && V_51 . V_22 != V_56 )
return - V_57 ;
V_11 = F_39 ( sizeof( * V_11 ) , V_58 ) ;
if ( V_11 == NULL )
return - V_59 ;
V_11 -> V_3 = V_3 ;
F_40 ( & V_11 -> V_13 , V_33 ) ;
...
static int F_44 ( struct V_67 * V_68 , unsigned int V_44 ,
unsigned long V_8 )
{
struct V_2 * V_3 = F_45 ( V_68 ) ;
...
case V_70 : {
T_1 V_72 ;
if ( F_35 ( V_72 , ( T_1 V_46 * ) V_69 ) )
return - V_47 ;
if ( V_72 != V_73 )
return - V_71 ;
if ( ! F_46 ( V_74 ) )
return - V_75 ;
return F_36 ( V_3 , V_69 ) ;
}
case V_76 :
return F_34 ( F_47 ( & F_1 ( V_3 ) ->
V_6 ) , ( int V_46 * ) V_69 ) ? - V_47 : 0 ;
case V_77 :
return F_34 ( F_48 ( & F_1 ( V_3 ) ->
V_6 ) , ( int V_46 * ) V_69 ) ? - V_47 : 0 ;
}
return - V_71 ;
}
