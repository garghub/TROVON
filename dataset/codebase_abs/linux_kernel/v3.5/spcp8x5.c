...
F_27 ( & V_22 -> V_9 , L_9 ,
V_66 , V_5 ) ;
F_4 ( & V_22 -> V_9 , L_10 , V_5 ) ;
if ( V_64 & V_72 ) {
F_18 ( V_2 -> V_9 , 0x000a ,
V_92 , V_4 -> type ) ;
}
}
static int F_28 ( struct V_50 * V_51 , struct V_41 * V_22 )
{
struct V_62 V_93 ;
struct V_1 * V_2 = V_22 -> V_2 ;
struct V_3 * V_4 = F_9 ( V_22 ) ;
...
unsigned long V_45 ;
T_2 V_31 = 0x30 ;
F_29 ( V_2 -> V_9 , V_22 -> V_94 -> V_95 ) ;
F_29 ( V_2 -> V_9 , V_22 -> V_96 -> V_95 ) ;
...
F_22 ( & V_4 -> V_20 , V_45 ) ;
V_22 -> V_22 . V_97 = 256 ;
return F_30 ( V_51 , V_22 ) ;
}
static void F_31 ( struct V_98 * V_98 )
{
struct V_41 * V_22 = V_98 -> V_99 ;
struct V_3 * V_4 = F_9 ( V_22 ) ;
struct V_50 * V_51 ;
unsigned char * V_100 = V_98 -> V_101 ;
unsigned long V_45 ;
T_2 V_31 ;
char V_102 ;
V_102 = V_103 ;
...
F_36 ( V_51 , V_100 , V_102 ,
V_98 -> V_105 ) ;
F_37 ( V_51 ) ;
F_38 ( V_51 ) ;
}
static int F_39 ( struct V_41 * V_22 ,
unsigned int V_115 )
{
struct V_3 * V_4 = F_9 ( V_22 ) ;
unsigned long V_45 ;
...
F_22 ( & V_4 -> V_20 , V_45 ) ;
V_117 = V_116 ^ V_31 ;
if ( ( ( V_115 & V_120 ) && ( V_117 & V_121 ) ) ||
( ( V_115 & V_122 ) && ( V_117 & V_123 ) ) ||
( ( V_115 & V_124 ) && ( V_117 & V_43 ) ) ||
( ( V_115 & V_125 ) && ( V_117 & V_126 ) ) )
return 0 ;
V_116 = V_31 ;
}
return 0 ;
...
unsigned int V_127 , unsigned long V_115 )
{
struct V_41 * V_22 = V_51 -> V_128 ;
F_4 ( & V_22 -> V_9 , L_12 , V_129 ,
V_22 -> V_130 , V_127 ) ;
switch ( V_127 ) {
case V_131 :
F_4 ( & V_22 -> V_9 , L_13 , V_129 ,
V_22 -> V_130 ) ;
return F_39 ( V_22 , V_115 ) ;
default:
F_4 ( & V_22 -> V_9 , L_14 , V_129 ,
V_127 ) ;
break;
}
return - V_132 ;
