...
goto V_83;
F_14 ( & V_18 ) ;
F_8 ( V_88 , V_80 , V_2 , V_3 ) ;
return V_81 ;
V_83:
F_14 ( & V_18 ) ;
return V_81 ;
}
static struct V_36 * F_63 ( struct V_89 * V_90 )
{
struct V_7 * V_7 = F_64 ( V_90 ) ;
struct V_91 * V_92 = V_90 -> V_93 ;
struct V_36 * V_37 ;
for ( V_92 -> V_94 = 0 ; V_92 -> V_94 < V_33 ; V_92 -> V_94 ++ ) {
V_37 = F_65 ( F_66 ( & V_7 -> V_10 . V_71 [ V_92 -> V_94 ] ) ) ;
if ( V_37 )
return V_37 ;
}
return NULL ;
}
static struct V_36 * F_67 ( struct V_89 * V_90 ,
struct V_36 * V_67 )
{
struct V_7 * V_7 = F_64 ( V_90 ) ;
struct V_91 * V_92 = V_90 -> V_93 ;
...
if ( ++ V_92 -> V_94 >= V_33 )
return NULL ;
V_67 = F_65 ( F_66 ( & V_7 -> V_10 . V_71 [ V_92 -> V_94 ] ) ) ;
}
return V_67 ;
}
static struct V_36 * F_69 ( struct V_89 * V_90 , T_5 V_95 )
{
struct V_36 * V_67 = F_63 ( V_90 ) ;
if ( V_67 )
while ( V_95 && ( V_67 = F_67 ( V_90 , V_67 ) ) )
V_95 -- ;
return V_95 ? NULL : V_67 ;
}
static void * F_70 ( struct V_89 * V_90 , T_5 * V_95 )
__acquires( T_6 )
{
F_25 () ;
return F_69 ( V_90 , * V_95 ) ;
}
static void * F_71 ( struct V_89 * V_90 , void * V_96 , T_5 * V_95 )
{
( * V_95 ) ++ ;
return F_67 ( V_90 , V_96 ) ;
}
static void F_72 ( struct V_89 * V_90 , void * V_96 )
__releases( T_6 )
{
F_27 () ;
}
static int F_73 ( struct V_89 * V_97 , void * V_96 )
{
struct V_1 * V_80 ;
struct V_69 * V_65 ;
struct V_36 * V_37 = V_96 ;
char * V_98 = L_2 ;
V_80 = F_74 ( V_37 , struct V_1 , V_9 ) ;
if ( V_80 -> V_8 . V_99 )
F_75 ( V_97 , L_3 , F_5 ( & V_80 -> V_8 )
...
if ( V_80 -> V_41 & V_100 )
F_75 ( V_97 , L_9 , V_98 ) ;
V_65 = F_65 ( F_2 ( V_80 -> V_6 ) -> V_65 ) ;
if ( V_65 ) {
F_75 ( V_97 , L_10 , V_80 -> V_41 ? L_11 : L_2 , V_65 -> V_101 ) ;
if ( V_65 -> V_74 [ V_80 -> V_14 ] . V_101 )
F_75 ( V_97 , L_12 ,
V_65 -> V_74 [ V_80 -> V_14 ] . V_101 ) ;
}
return F_79 ( V_97 , '\n' ) ;
}
static int F_80 ( struct V_102 * V_102 , struct V_103 * V_103 )
{
return F_81 ( V_102 , V_103 , & V_104 ,
sizeof( struct V_91 ) ) ;
}
...
#ifdef F_83
struct V_105 * V_106 ;
V_106 = F_84 ( V_7 , L_13 , 0440 , & V_107 ) ;
if ( ! V_106 )
return - V_108 ;
#endif
return 0 ;
...
F_91 ( V_55 ) ;
V_113:
F_92 ( V_7 -> V_10 . V_71 , V_33 ) ;
V_112:
return V_109 ;
}
void F_93 ( struct V_7 * V_7 )
{
F_85 ( V_7 ) ;
if ( F_88 ( V_7 , & V_110 ) ) {
F_94 () ;
