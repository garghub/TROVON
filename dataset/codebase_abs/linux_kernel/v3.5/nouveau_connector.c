...
if ( V_18 -> V_26 &&
V_18 -> type == V_153 )
V_147 = ( ( V_154 * ) V_18 -> V_26 ) [ 121 ] == 2 ;
else
V_147 = V_107 -> clock >= V_146 -> V_151 . V_155 ;
if ( ( ! V_147 && ( V_146 -> V_151 . V_156 & 1 ) ) ||
( V_147 && ( V_146 -> V_151 . V_156 & 2 ) ) )
V_3 -> V_148 . V_149 = 8 ;
}
static int
F_50 ( struct V_2 * V_3 )
...
case V_157 :
case V_153 : return V_104 ;
case V_187 :
case V_188 :
case V_189 : return V_190 ;
case V_150 : return V_191 ;
case V_192 :
