...
V_33 , V_35 ) ;
if ( V_40 != V_22 ) {
F_17 ( V_42 , V_28 , V_2 , V_30 , V_31 , NULL ,
L_4 , V_39 -> V_43 ) ;
return V_40 ;
}
if ( F_18 ( V_44 , & V_33 -> V_45 ) &&
! F_19 ( V_2 ) ) {
F_20 (nf_nat_seq_adjust_hook) V_46 ;
V_46 = F_14 ( V_47 ) ;
...
int (* F_11)( struct V_1 * ) )
{
return F_25 ( F_26 ( V_30 ) , V_50 , V_28 , V_2 ) ;
}
...
return V_22 ;
return F_25 ( F_26 ( V_31 ) , V_50 , V_28 , V_2 ) ;
}
static int
F_28 ( struct V_51 * V_52 , int V_53 , void T_3 * V_54 , int * V_27 )
{
const struct V_55 * V_56 = F_29 ( V_52 ) ;
...
if ( ( unsigned int ) * V_27 < sizeof( struct V_71 ) ) {
F_9 ( L_6 ,
* V_27 , sizeof( struct V_71 ) ) ;
return - V_72 ;
}
...
const struct V_4 * V_5 )
{
if ( F_37 ( V_2 , V_84 , V_5 -> V_11 . V_12 . V_13 ) ||
