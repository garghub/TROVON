...
V_114 -> V_121 = F_67 ( 0 ) ;
V_114 -> V_122 = F_61 ( V_2 -> V_54 -> V_123 ) ;
V_2 -> V_124 ++ ;
F_25 ( & V_6 -> V_118 , & V_2 -> V_125 ) ;
V_116 -> V_126 ++ ;
V_119:
F_68 ( V_2 ) ;
F_26 ( V_6 -> V_26 ) ;
...
F_70 ( V_4 ) ;
V_127 = F_71 ( V_4 -> V_99 ) ;
V_128 = V_127 + F_33 ( V_4 ) ;
if ( * V_128 == F_61 ( V_107 ) )
F_72 ( V_4 ) ;
F_73 ( V_127 ) ;
}
static void F_74 ( struct V_1 * V_2 , unsigned int V_129 ,
unsigned int V_130 , struct V_131 * V_132 ,
bool V_133 )
{
struct V_103 * V_104 ;
struct V_5 * V_134 = NULL , * V_135 ;
struct V_67 * V_67 ;
unsigned int V_136 ;
unsigned V_137 ;
T_4 * V_128 ;
F_63 ( V_2 ) ;
V_134 = V_135 = F_75 ( V_134 , V_132 , V_118 ) ;
while( V_130 ) {
V_136 = V_130 ;
if ( V_130 > V_129 )
V_136 = V_129 ;
F_68 ( V_2 ) ;
V_67 = F_57 ( V_2 , V_138 , V_136 + 1 , V_136 ) ;
V_104 = F_59 ( V_67 ) ;
F_63 ( V_2 ) ;
V_128 = ( T_4 * ) ( V_104 + 1 ) ;
V_137 = 0 ;
F_76 (bd1, blist, bd_list) {
* V_128 ++ = F_67 ( V_134 -> V_26 -> V_27 ) ;
if ( V_133 ) {
F_69 ( V_134 -> V_26 ) ;
* V_128 ++ = F_67 ( F_77 ( V_134 -> V_26 ) ? 1 : 0 ) ;
}
if ( ++ V_137 >= V_136 )
break;
}
...
V_67 = F_58 ( V_78 , V_89 ) ;
V_128 = F_59 ( V_67 ) ;
V_127 = F_71 ( V_135 -> V_26 -> V_99 ) ;
memcpy ( V_128 , V_127 + F_33 ( V_135 -> V_26 ) ,
V_135 -> V_26 -> V_73 ) ;
F_73 ( V_127 ) ;
* ( T_3 * ) V_128 = 0 ;
F_70 ( V_135 -> V_26 ) ;
...
{
unsigned int V_129 = F_79 ( V_2 ) ;
F_74 ( V_2 , V_129 , V_2 -> V_124 ,
& V_2 -> V_125 , 0 ) ;
}
static void F_80 ( struct V_1 * V_2 , struct V_43 * V_44 )
{
struct V_131 * V_139 = & V_2 -> V_125 ;
struct V_5 * V_6 ;
while ( ! F_64 ( V_139 ) ) {
V_6 = F_81 ( V_139 -> V_66 , struct V_5 , V_118 ) ;
F_82 ( & V_6 -> V_118 ) ;
V_2 -> V_124 -- ;
...
{
struct V_1 * V_2 = F_85 ( V_141 -> V_144 ) ;
if ( V_143 != 0 )
return;
V_2 -> V_145 = 0 ;
V_2 -> V_146 = 0 ;
}
static int F_86 ( struct V_140 * V_141 , unsigned int V_147 ,
struct V_103 * V_104 , T_4 * V_128 ,
int V_143 )
{
struct V_148 * V_149 = F_87 ( V_141 -> V_144 ) ;
struct V_1 * V_2 = F_85 ( V_141 -> V_144 ) ;
struct V_19 * V_20 = V_149 -> V_150 ;
unsigned int V_151 = F_88 ( V_104 -> V_102 ) ;
struct V_3 * V_152 , * V_153 ;
T_1 V_83 ;
int error = 0 ;
if ( V_143 != 1 || F_88 ( V_104 -> V_100 ) != V_138 )
return 0 ;
F_89 ( V_2 , & V_147 ) ;
for (; V_151 ; F_89 ( V_2 , & V_147 ) , V_151 -- ) {
V_83 = F_90 ( * V_128 ++ ) ;
V_2 -> V_145 ++ ;
if ( F_91 ( V_2 , V_83 , V_147 ) )
continue;
error = F_92 ( V_141 , V_147 , & V_152 ) ;
if ( error )
return error ;
V_153 = F_93 ( V_20 , V_83 ) ;
memcpy ( V_153 -> V_37 , V_152 -> V_37 , V_152 -> V_73 ) ;
if ( F_66 ( V_2 , V_153 ) )
error = - V_154 ;
else
F_21 ( V_153 ) ;
...
static void F_94 ( struct V_140 * V_141 , int error , int V_143 )
{
struct V_148 * V_149 = F_87 ( V_141 -> V_144 ) ;
struct V_1 * V_2 = F_85 ( V_141 -> V_144 ) ;
if ( error ) {
...
F_95 ( V_149 -> V_150 ) ;
F_96 ( V_2 , L_2 ,
V_141 -> V_123 , V_2 -> V_146 , V_2 -> V_145 ) ;
}
static void F_97 ( struct V_1 * V_2 , struct V_5 * V_6 )
{
struct V_19 * V_20 = V_6 -> V_15 ;
struct V_115 * V_116 ;
V_116 = V_7 -> V_8 ;
...
struct V_113 * V_114 ;
unsigned int V_97 ;
struct V_131 * V_139 = & V_2 -> V_158 ;
struct V_5 * V_6 ;
struct V_67 * V_67 ;
unsigned int V_159 ;
if ( ! V_2 -> V_156 )
return;
V_159 = F_99 ( V_2 , V_2 -> V_156 , sizeof( T_1 ) ) ;
V_67 = F_57 ( V_2 , V_160 , V_159 , V_2 -> V_156 ) ;
V_104 = F_59 ( V_67 ) ;
V_97 = sizeof( struct V_103 ) ;
F_30 (bd, head, bd_list) {
V_2 -> V_156 -- ;
if ( V_97 + sizeof( T_1 ) > V_2 -> V_161 . V_162 ) {
F_56 ( V_2 , V_67 ) ;
V_67 = F_58 ( V_78 , V_89 ) ;
V_114 = F_59 ( V_67 ) ;
F_60 ( V_114 ) ;
V_114 -> V_106 = F_61 ( V_107 ) ;
V_114 -> V_108 = F_61 ( V_163 ) ;
V_114 -> V_110 = F_61 ( V_164 ) ;
V_97 = sizeof( struct V_113 ) ;
}
* ( T_4 * ) ( F_59 ( V_67 ) + V_97 ) = F_67 ( V_6 -> V_165 ) ;
V_97 += sizeof( T_1 ) ;
}
F_5 ( V_2 , ! V_2 -> V_156 ) ;
F_56 ( V_2 , V_67 ) ;
...
return;
V_2 -> V_167 = 0 ;
V_2 -> V_168 = V_139 -> V_169 ;
}
static int F_103 ( struct V_140 * V_141 , unsigned int V_147 ,
struct V_103 * V_104 , T_4 * V_128 ,
int V_143 )
{
struct V_1 * V_2 = F_85 ( V_141 -> V_144 ) ;
unsigned int V_151 = F_88 ( V_104 -> V_101 ) ;
unsigned int V_170 = F_88 ( V_104 -> V_102 ) ;
struct V_3 * V_4 ;
unsigned int V_97 ;
T_1 V_83 ;
int V_171 = 1 ;
int error ;
if ( V_143 != 0 || F_88 ( V_104 -> V_100 ) != V_160 )
return 0 ;
V_97 = sizeof( struct V_103 ) ;
for (; V_151 ; F_89 ( V_2 , & V_147 ) , V_151 -- ) {
error = F_92 ( V_141 , V_147 , & V_4 ) ;
if ( error )
return error ;
if ( ! V_171 )
F_104 ( V_2 , V_4 , V_163 ) ;
while ( V_97 + sizeof( T_1 ) <= V_2 -> V_161 . V_162 ) {
V_83 = F_90 ( * ( T_4 * ) ( V_4 -> V_37 + V_97 ) ) ;
error = F_105 ( V_2 , V_83 , V_147 ) ;
if ( error < 0 ) {
F_24 ( V_4 ) ;
return error ;
}
...
return;
F_96 ( V_2 , L_3 ,
V_141 -> V_123 , V_2 -> V_167 ) ;
F_107 ( V_2 ) ;
}
static void F_108 ( struct V_1 * V_2 , struct V_5 * V_6 )
{
struct V_115 * V_116 = V_7 -> V_8 ;
struct V_172 * V_173 = V_6 -> V_26 -> V_99 -> V_173 ;
struct V_148 * V_149 = F_87 ( V_173 -> V_174 ) ;
F_20 ( V_6 -> V_26 ) ;
F_63 ( V_2 ) ;
if ( V_116 )
V_116 -> V_117 = 1 ;
...
V_116 -> V_175 ++ ;
V_2 -> V_176 ++ ;
F_110 ( & V_6 -> V_118 , & V_2 -> V_177 ) ;
} else {
F_110 ( & V_6 -> V_118 , & V_2 -> V_178 ) ;
}
V_119:
F_68 ( V_2 ) ;
F_26 ( V_6 -> V_26 ) ;
...
{
unsigned int V_129 = F_79 ( V_2 ) / 2 ;
F_74 ( V_2 , V_129 , V_2 -> V_176 ,
& V_2 -> V_177 , 1 ) ;
}
static int F_112 ( struct V_140 * V_141 , unsigned int V_147 ,
struct V_103 * V_104 ,
T_4 * V_128 , int V_143 )
{
struct V_148 * V_149 = F_87 ( V_141 -> V_144 ) ;
...
T_1 V_179 ;
int error = 0 ;
if ( V_143 != 1 || F_88 ( V_104 -> V_100 ) != V_180 )
return 0 ;
F_89 ( V_2 , & V_147 ) ;
for (; V_151 ; F_89 ( V_2 , & V_147 ) , V_151 -- ) {
V_83 = F_90 ( * V_128 ++ ) ;
...
static void F_113 ( struct V_140 * V_141 , int error , int V_143 )
{
struct V_148 * V_149 = F_87 ( V_141 -> V_144 ) ;
struct V_1 * V_2 = F_85 ( V_141 -> V_144 ) ;
if ( error ) {
