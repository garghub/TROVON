...
static int F_37 ( T_3 * V_9 , unsigned int V_85 , int V_86 , void * V_87 )
{
struct V_6 * V_7 =
...
F_9 ( V_52 , L_23 ,
V_2 , V_101 , V_14 -> V_80 , V_14 -> V_80 -> V_102 ) ;
if ( V_2 -> V_12 < 0 )
return V_2 -> V_12 ;
F_24 ( & V_18 -> V_19 ) ;
V_14 -> V_20 = V_103 ;
...
{
F_9 ( V_52 , L_29 ,
V_2 , V_2 -> V_96 . V_130 , V_2 -> V_96 . V_78 ) ;
F_1 ( V_2 ) ;
F_73 ( & V_2 -> V_51 ) ;
F_73 ( & V_2 -> V_74 ) ;
F_7 ( V_2 , - V_100 ) ;
...
static void F_74 ( struct V_24 * V_18 )
{
struct V_29 * V_30 ;
if ( ! V_18 )
return;
...
static inline int F_75 ( const char * V_131 )
{
...
static int
F_76 ( struct V_24 * V_18 , const char * V_135 , char * args )
{
int V_12 ;
struct V_123 * V_124 ;
struct V_136 V_137 ;
...
V_124 = NULL ;
V_137 . V_138 = V_139 ;
V_137 . V_140 . V_141 = F_77 ( V_135 ) ;
V_137 . V_142 = F_78 ( V_107 . V_112 ) ;
V_12 = F_79 ( F_80 ( & V_101 -> V_143 -> V_144 ) , V_145 ,
V_146 , V_147 , & V_124 , 1 ) ;
if ( V_12 ) {
F_64 ( L_31 ,
V_129 , F_65 ( V_101 ) ) ;
...
V_12 = F_79 ( F_80 ( & V_101 -> V_143 -> V_144 ) , V_156 ,
V_146 , 0 , & V_124 , 1 ) ;
if ( V_12 < 0 ) {
F_64 ( L_31 ,
V_129 , F_65 ( V_101 ) ) ;
...
static int
F_82 ( struct V_24 * V_18 , const char * V_135 , char * args )
{
int V_12 ;
struct V_106 V_107 ;
struct V_29 * V_94 ;
