...
V_19 -> V_104 = F_35 ( & V_84 -> V_87 , L_7 ) ;
if ( F_32 ( V_19 -> V_104 ) ) {
V_95 = F_33 ( V_19 -> V_104 ) ;
goto V_103;
}
V_19 -> V_105 = F_35 ( & V_84 -> V_87 , L_8 ) ;
if ( F_32 ( V_19 -> V_105 ) ) {
V_95 = F_33 ( V_19 -> V_105 ) ;
goto V_103;
}
V_18 -> V_71 = V_19 -> V_105 ;
F_36 ( V_19 -> V_105 ) ;
F_36 ( V_19 -> V_102 ) ;
F_36 ( V_19 -> V_104 ) ;
V_19 -> V_106 = F_37 ( & V_84 -> V_87 ) ;
if ( F_32 ( V_19 -> V_106 ) ) {
V_95 = F_33 ( V_19 -> V_106 ) ;
goto V_107;
}
V_10 -> V_108 |= V_109 ;
...
V_19 -> V_41 |= V_42 ;
if ( F_5 ( V_19 ) )
F_7 ( 0x08100810 , V_10 -> V_15 + V_112 ) ;
V_22 = & V_19 -> V_22 ;
if ( F_26 ( V_84 , V_22 ) < 0 ) {
if ( ! V_10 -> V_113 -> V_114 -> V_115 ) {
F_38 ( F_39 ( V_10 -> V_113 ) , L_9 ) ;
V_95 = - V_116 ;
goto V_117;
}
V_19 -> V_22 = * ( (struct V_21 * )
V_10 -> V_113 -> V_114 -> V_115 ) ;
}
if ( V_22 -> V_72 == V_73 ) {
V_95 = F_40 ( V_22 -> V_74 , V_118 , L_10 ) ;
if ( V_95 ) {
F_41 ( F_39 ( V_10 -> V_113 ) ,
L_11 ) ;
V_22 -> V_74 = - V_116 ;
}
} else {
...
switch ( V_22 -> V_34 ) {
case V_35 :
V_95 = F_40 ( V_22 -> V_24 , V_118 , L_12 ) ;
if ( V_95 ) {
F_38 ( F_39 ( V_10 -> V_113 ) ,
L_13 ) ;
goto V_119;
}
V_95 = F_42 ( F_43 ( V_22 -> V_24 ) , F_24 ,
V_120 | V_121 ,
F_44 ( V_10 -> V_113 ) , V_10 ) ;
if ( V_95 ) {
F_38 ( F_39 ( V_10 -> V_113 ) , L_14 ) ;
goto V_122;
}
case V_91 :
V_10 -> V_108 &= ~ V_123 ;
...
struct V_1 * V_19 = V_18 -> V_20 ;
struct V_21 * V_22 = & V_19 -> V_22 ;
int V_128 = ( F_8 ( V_10 -> V_15 + V_29 ) == 0xffffffff ) ;
F_53 ( V_10 , V_128 ) ;
if ( F_12 ( V_22 -> V_74 ) )
F_47 ( V_22 -> V_74 ) ;
if ( F_12 ( V_22 -> V_24 ) ) {
