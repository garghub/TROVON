...
unsigned long F_32 ( const volatile void T_4 * V_34 , unsigned long V_74 )
{
unsigned long V_75 ;
struct V_7 * V_8 ;
struct V_5 * V_6 ;
...
int F_36 ( struct V_7 * V_8 , enum V_83 V_84 )
{
struct V_5 * V_6 = F_34 ( V_8 ) ;
switch ( V_84 ) {
case V_85 :
V_15 -> V_86 ( V_6 , V_87 ) ;
break;
...
void F_37 ( struct V_5 * V_41 , unsigned int * V_93 )
{
struct V_5 * V_6 ;
F_8 (parent, dn) {
if ( F_9 ( V_6 ) ) {
...
void F_38 ( struct V_5 * V_6 , unsigned int * V_93 )
{
struct V_7 * V_8 ;
V_6 = F_16 ( V_6 ) ;
if ( ! F_19 ( V_6 ) && F_9 ( V_6 -> V_41 ) )
...
#define F_45 ( T_5 ) (8*((OFF)/4)+3-(OFF))
#define F_46 ( T_5 ) (((u8 *)(edev->config_space))[BYTE_SWAP(OFF)])
...
if ( ! V_2 )
return;
if ( ( V_2 -> V_42 & V_43 ) && ! F_47 ( V_2 -> V_103 ) )
F_44 ( V_2 ) ;
...
static void * F_49 ( struct V_5 * V_6 , void * V_104 )
{
int V_52 ;
const T_2 * V_103 = F_27 ( V_6 , L_32 , NULL ) ;
const T_2 * V_105 = F_27 ( V_6 , L_33 , NULL ) ;
const T_2 * V_106 = F_27 ( V_6 , L_34 , NULL ) ;
const T_2 * V_107 ;
int V_108 ;
...
return NULL ;
if ( V_6 -> type && ! strcmp ( V_6 -> type , L_35 ) ) {
V_2 -> V_42 |= V_59 ;
return NULL ;
}
V_2 -> V_103 = * V_103 ;
V_107 = F_27 ( V_6 , L_36 , NULL ) ;
if ( V_107 ) {
...
int T_6 F_51 ( struct V_15 * V_112 )
{
if ( ! V_112 -> V_113 ) {
F_52 ( L_39 ,
V_114 , V_112 ) ;
...
F_55 ( & V_51 ) ;
F_56 (hose, tmp, &hose_list, list_node) {
V_96 = V_117 -> V_6 ;
F_57 ( V_96 , F_49 , NULL ) ;
}
if ( V_57 )
...
F_56 (child, tmp, &bus->devices, bus_list)
F_72 ( V_26 ) ;
}
}
static int F_73 ( struct V_130 * V_131 , void * V_132 )
{
if ( 0 == V_57 ) {
F_74 ( V_131 , L_50 ) ;
F_74 ( V_131 , L_51 , V_55 . V_56 ) ;
} else {
F_74 ( V_131 , L_52 ) ;
F_74 ( V_131 ,
L_53
...
static int F_75 ( struct V_133 * V_133 , struct V_134 * V_134 )
{
return F_76 ( V_134 , F_73 , NULL ) ;
}
static int T_6 F_77 ( void )
{
if ( F_78 ( V_135 ) )
F_79 ( L_59 , 0 , NULL , & V_136 ) ;
return 0 ;
}
