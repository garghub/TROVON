...
{
int V_78 ;
struct V_79 * V_80 = F_44 ( V_16 , V_67 , V_68 ) ;
V_80 -> V_51 = V_51 ;
V_80 -> V_16 = V_16 ;
V_78 = F_45 ( V_80 -> V_51 , V_81 ) ;
F_46 ( & V_80 -> V_21 , & V_2 -> V_9 [ V_78 ] ) ;
}
void F_47 ( struct V_1 * V_2 , struct V_15 * V_16 ,
int V_67 , int V_68 , T_2 V_51 )
{
F_43 ( V_2 , V_16 , V_67 , V_68 , V_51 ) ;
...
F_31 ( V_48 , & V_83 , sizeof( V_83 ) ) == - 1 )
return - 1 ;
if ( V_16 -> V_23 . V_85 & V_87 )
++ V_84 ;
if ( V_16 -> V_23 . V_85 & V_88 )
++ V_84 ;
F_47 ( V_2 , V_16 , V_67 , V_68 , V_83 [ V_84 ] ) ;
return 0 ;
}
...
union V_91 * F_52 ( struct V_1 * V_2 , int V_92 )
{
unsigned int V_93 = F_53 ( V_94 ) ;
struct V_95 * V_96 = & V_2 -> V_28 [ V_92 ] ;
unsigned int V_42 = F_54 ( V_96 ) ;
...
unsigned int V_109 = F_55 ( sizeof( * V_101 ) , V_106 ) , V_110 ;
void * V_111 = & V_2 -> V_112 ;
do {
V_110 = F_55 ( V_96 -> V_104 + 1 - ( V_108 & V_96 -> V_104 ) , V_109 ) ;
...
F_58 ( V_2 -> V_28 [ V_7 ] . V_100 , V_2 -> V_114 ) ;
...
if ( F_37 ( V_48 , V_120 , V_118 ) != 0 )
goto V_119;
}
if ( ( V_16 -> V_23 . V_85 & V_86 ) &&
F_48 ( V_2 , V_16 , V_67 , V_68 , V_48 ) < 0 )
goto V_119;
}
}
}
...
F_58 ( V_2 -> V_28 [ V_67 ] . V_100 , V_2 -> V_114 ) ;
V_2 -> V_28 [ V_67 ] . V_100 = NULL ;
}
}
return - 1 ;
}
static int F_62 ( struct V_1 * V_2 , int V_115 , int V_104 )
{
struct V_15 * V_16 ;
int V_68 ;
for ( V_68 = 0 ; V_68 < V_2 -> V_6 -> V_69 ; V_68 ++ ) {
...
F_58 ( V_2 -> V_28 [ V_68 ] . V_100 , V_2 -> V_114 ) ;
V_2 -> V_28 [ V_68 ] . V_100 = NULL ;
}
}
return - 1 ;
}
int F_63 ( struct V_1 * V_2 , unsigned int V_121 ,
bool V_102 )
{
unsigned int V_93 = F_53 ( V_94 ) ;
struct V_15 * V_16 ;
...
if ( ( V_16 -> V_23 . V_85 & V_86 ) &&
V_16 -> V_126 == NULL &&
F_65 ( V_16 , V_4 -> V_69 , V_6 -> V_69 ) < 0 )
return - V_39 ;
}
if ( V_2 -> V_4 -> V_18 [ 0 ] == - 1 )
return F_62 ( V_2 , V_115 , V_104 ) ;
return F_61 ( V_2 , V_115 , V_104 ) ;
}
int F_66 ( struct V_1 * V_2 ,
struct V_127 * V_128 )
{
V_2 -> V_6 = F_67 ( V_128 -> V_12 , V_128 -> V_129 ,
V_128 -> V_130 ) ;
if ( V_2 -> V_6 == NULL )
return - 1 ;
if ( F_68 ( V_128 ) )
V_2 -> V_4 = F_69 () ;
else if ( ! F_70 ( V_128 ) && ! V_128 -> V_131 )
V_2 -> V_4 = F_69 () ;
else
V_2 -> V_4 = F_71 ( V_128 -> V_132 ) ;
if ( V_2 -> V_4 == NULL )
goto V_133;
return 0 ;
V_133:
...
V_48 = F_38 ( V_16 , V_67 , V_68 ) ;
V_47 = F_37 ( V_48 , V_135 , V_134 ) ;
if ( V_47 )
return V_47 ;
}
}
...
V_24 = V_17 -> V_23 . V_24 ;
if ( V_24 & V_138 )
V_106 += sizeof( V_99 -> V_129 ) * 2 ;
if ( V_24 & V_57 )
V_106 += sizeof( V_99 -> time ) ;
if ( V_24 & V_25 )
V_106 += sizeof( V_99 -> V_51 ) ;
if ( V_24 & V_139 )
V_106 += sizeof( V_99 -> V_140 ) ;
if ( V_24 & V_58 )
...
V_26 = V_17 = F_8 ( V_2 -> V_10 . V_20 , struct V_15 , V_21 ) ;
F_77 (pos, &evlist->entries, node) {
if ( V_17 -> V_23 . V_137 != V_26 -> V_23 . V_137 )
return false ;
}
return true ;
}
...
int F_82 ( struct V_1 * V_2 , bool V_142 )
{
struct V_15 * V_16 , * V_17 ;
int V_47 , V_143 , V_144 ;
V_17 = F_8 ( V_2 -> V_10 . V_20 , struct V_15 , V_21 ) ;
F_9 (evsel, &evlist->entries, node) {
...
return 0 ;
V_147:
V_143 = V_2 -> V_4 ? V_2 -> V_4 -> V_69 : 1 ;
V_144 = V_2 -> V_6 ? V_2 -> V_6 -> V_69 : 1 ;
F_84 (evsel, &evlist->entries, node)
F_85 ( V_16 , V_143 , V_144 ) ;
V_148 = - V_47 ;
return V_47 ;
}
...
F_32 ( V_150 [ 0 ] ) ;
F_32 ( V_151 [ 1 ] ) ;
F_42 ( V_151 [ 0 ] , V_156 , V_157 ) ;
F_90 ( L_7 , ( char * * ) V_149 ) ;
F_32 ( V_150 [ 1 ] ) ;
if ( F_31 ( V_151 [ 0 ] , & V_152 , 1 ) == - 1 )
perror ( L_8 ) ;
F_90 ( V_149 [ 0 ] , ( char * * ) V_149 ) ;
perror ( V_149 [ 0 ] ) ;
F_91 ( F_92 () , V_158 ) ;
exit ( - 1 ) ;
}
...
F_32 ( V_150 [ 1 ] ) ;
F_32 ( V_151 [ 0 ] ) ;
if ( F_31 ( V_150 [ 0 ] , & V_152 , 1 ) == - 1 ) {
perror ( L_8 ) ;
goto V_154;
}
V_2 -> V_11 . V_159 = V_151 [ 1 ] ;
F_32 ( V_150 [ 0 ] ) ;
return 0 ;
V_154:
F_32 ( V_151 [ 0 ] ) ;
