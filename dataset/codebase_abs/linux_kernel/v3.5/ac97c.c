...
static int F_97 ( struct V_166 * V_20 , T_6 V_208 )
{
...
static int F_99 ( struct V_166 * V_20 )
{
struct V_167 * V_130 = F_98 ( V_20 ) ;
struct V_2 * V_3 = V_130 -> V_141 ;
F_72 ( V_3 -> V_172 ) ;
...
static int T_7 F_100 ( struct V_166 * V_20 )
{
struct V_167 * V_130 = F_98 ( V_20 ) ;
