...
V_7 -> V_232 = V_232 ;
V_7 -> V_12 . V_13 . V_232 = & V_232 -> V_232 ;
...
F_9 ( V_298 , - V_20 ) ;
F_50 ( & V_7 -> V_23 , V_131 ) ;
V_7 -> V_12 . V_13 . V_232 = NULL ;
V_7 -> V_232 = NULL ;
F_127 ( V_7 -> V_13 , L_39 ,
V_232 -> V_232 . V_21 ) ;
return 0 ;
}
static struct V_6 T_8 * F_129 ( struct V_299 * V_300 )
{
struct V_6 * V_7 ;
...
static int T_8 F_133 ( struct V_6 * V_7 )
{
...
static int T_8 F_134 ( struct V_6 * V_7 , unsigned char V_77 )
{
struct V_1 * V_2 = & V_7 -> V_40 [ V_77 ] ;
V_2 -> V_7 = V_7 ;
...
static int T_8 F_136 ( struct V_299 * V_300 )
{
struct V_6 * V_7 ;
...
V_7 -> V_12 . V_21 = V_327 ;
F_140 ( & V_7 -> V_12 . V_13 ) ;
F_141 ( & V_7 -> V_12 . V_13 , L_44 ) ;
V_7 -> V_12 . V_13 . V_328 = F_135 ;
V_7 -> V_12 . V_13 . V_14 = & V_300 -> V_13 ;
for ( V_64 = 0 ; V_64 < V_176 ; V_64 ++ ) {
F_134 ( V_7 , ( unsigned char ) V_64 ) ;
}
V_237 = F_47 ( V_7 , 0 , & V_329 ) ;
if ( V_237 )
goto V_330;
...
F_142 ( & V_7 -> V_183 , F_73 ,
( unsigned long ) V_7 ) ;
V_7 -> V_335 = F_143 ( V_302 , 0 ) ;
if ( ! V_7 -> V_335 ) {
V_237 = - V_104 ;
goto V_336;
}
V_237 = F_144 ( V_7 -> V_335 , F_125 , 0 ,
V_327 , V_7 ) ;
if ( V_237 ) {
F_39 ( V_7 -> V_13 , L_46 ,
V_7 -> V_335 , V_237 ) ;
...
V_237 = F_145 ( & V_7 -> V_12 . V_13 ) ;
if ( V_237 )
goto V_338;
V_237 = F_146 ( & V_300 -> V_13 , & V_7 -> V_12 ) ;
if ( V_237 )
goto V_339;
F_147 ( & V_300 -> V_13 , V_7 ) ;
F_127 ( V_7 -> V_13 ,
L_47 ,
( V_7 -> V_54 == V_340 ) ? L_48 : L_49 ) ;
return 0 ;
V_339:
F_148 ( & V_7 -> V_12 . V_13 ) ;
V_338:
...
static int F_152 ( struct V_299 * V_13 , T_10 V_44 )
{
return - V_341 ;
}
static int F_153 ( struct V_299 * V_13 )
{
return - V_341 ;
}
static int T_11 F_154 ( struct V_299 * V_300 )
{
struct V_6 * V_7 = F_155 ( & V_300 -> V_13 ) ;
struct V_1 * V_2 ;
unsigned int V_102 ;
F_156 ( F_1 ) ;
F_157 ( & V_7 -> V_12 ) ;
