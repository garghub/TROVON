...
{
struct V_189 * V_190 = V_1 -> V_12 -> V_191 ;
int V_192 , V_193 ;
enum V_194 V_195 ;
int V_10 , V_184 ;
F_24 ( & V_1 -> V_13 ) ;
...
F_26 ( V_1 -> V_12 , L_12 , 'A' + V_192 ) ;
break;
case V_209 :
V_195 = V_209 ;
V_1 -> V_203 = 12 ;
F_26 ( V_1 -> V_12 , L_13 , 'A' + V_192 ) ;
break;
case V_210 :
V_195 = V_210 ;
V_1 -> V_203 = 12 ;
F_26 ( V_1 -> V_12 , L_14 , 'A' + V_192 ) ;
break;
case V_211 :
V_195 = V_211 ;
V_1 -> V_203 = 12 ;
F_26 ( V_1 -> V_12 , L_15 , 'A' + V_192 ) ;
break;
case V_212 :
V_195 = V_212 ;
V_1 -> V_203 = 12 ;
F_26 ( V_1 -> V_12 , L_16 , 'A' + V_192 ) ;
break;
default:
...
V_1 -> V_3 = 1 ;
if ( V_190 && V_190 -> V_213 ) {
V_10 = V_190 -> V_213 ( V_1 ) ;
if ( V_10 != 0 ) {
...
if ( V_190 ) {
for ( V_184 = 0 ; V_184 < F_28 ( V_190 -> V_214 ) ; V_184 ++ ) {
if ( ! V_190 -> V_214 [ V_184 ] )
continue;
F_3 ( V_1 ,
V_62 + V_184 ,
V_190 -> V_214 [ V_184 ] & 0xffff ) ;
}
}
if ( V_190 && V_190 -> V_193 )
V_193 = V_190 -> V_193 * 10 ;
else
V_193 = - 1 ;
V_10 = F_29 ( V_1 , V_188 ) ;
if ( V_10 != 0 )
...
if ( V_190 && V_190 -> V_224 ) {
V_10 = F_31 ( V_1 -> V_12 , V_193 , V_225 ,
F_28 ( V_225 ) , NULL ,
0 ) ;
if ( V_10 < 0 )
F_8 ( V_1 -> V_12 , L_26 ,
...
F_33 ( V_1 ) ;
if ( V_190 && V_190 -> V_226 ) {
V_10 = V_190 -> V_226 ( V_1 ) ;
if ( V_10 != 0 ) {
