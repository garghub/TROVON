...
F_5 ( V_2 , 0x00 , 0x01 ) ;
V_97 = 0 ;
if ( V_42 -> V_103 < 1146000 ) {
F_5 ( V_2 , 0x10 , 0x11 ) ;
V_97 = 1 ;
V_100 = ( ( V_42 -> V_103 * ( 6 + 8 ) * 4 ) +
( V_104 / 2 ) ) /
V_104 - 1024 ;
} else {
F_5 ( V_2 , 0x10 , 0x01 ) ;
V_100 = ( ( V_42 -> V_103 * ( 6 + 8 ) * 2 ) +
( V_104 / 2 ) ) /
V_104 - 1024 ;
}
F_5 ( V_2 , 0x01 , ( V_100 & 0x0f00 ) >> 8 ) ;
F_5 ( V_2 , 0x02 , V_100 & 0x00ff ) ;
F_5 ( V_2 , 0x03 , 0x06 ) ;
F_5 ( V_2 , 0x51 , 0x0f ) ;
F_5 ( V_2 , 0x51 , 0x1f ) ;
F_5 ( V_2 , 0x50 , 0x10 ) ;
...
F_5 ( V_2 , 0x50 , 0x00 ) ;
F_23 ( 5 ) ;
V_101 = ( ( V_42 -> V_105 / 1000 ) << 2 ) / 5 + 2000 ;
if ( ( V_42 -> V_105 / 1000 ) < 5000 )
V_101 += 3000 ;
if ( V_101 < 7000 )
V_101 = 7000 ;
if ( V_101 > 40000 )
V_101 = 40000 ;
V_99 = F_10 ( V_2 , 0x26 ) ;
V_92 = 0x2e * 207 / ( ( V_99 << 1 ) + 151 ) ;
V_94 = V_92 * 135 / 100 ;
V_95 = V_92 * 78 / 100 ;
if ( V_94 > 63 )
V_94 = 63 ;
V_96 = ( ( V_92 * V_101 * 1000 ) + ( 2766 * V_104 / 2 ) )
/ ( 2766 * V_104 ) ;
if ( V_96 > 23 )
V_96 = 23 ;
if ( V_96 < 1 )
V_96 = 1 ;
V_93 = ( ( V_104 * V_96 * 2766 ) +
( 1000 * V_101 / 2 ) ) / ( 1000 * V_101 ) ;
if ( V_93 < V_95 ) {
V_96 ++ ;
V_93 = ( ( V_104 * V_96 * 2766 ) +
( 1000 * V_101 / 2 ) ) / ( 1000 * V_101 ) ;
...
F_5 ( V_2 , 0x50 , 0x00 ) ;
F_23 ( 60 ) ;
V_98 = ( V_100 - V_100 % 2 + 1024 ) * V_104
/ ( 6 + 8 ) / ( V_97 + 1 ) / 2 - V_42 -> V_103 ;
F_1 ( V_2 , 0x07 , 0x80 ) ;
F_1 ( V_2 , 0x07 , 0x00 ) ;
F_1 ( V_2 , 0xb2 , 0x01 ) ;
F_1 ( V_2 , 0x00 , 0x01 ) ;
...
F_1 ( V_2 , 0xc4 , 0x10 ) ;
F_1 ( V_2 , 0xc7 , 0x0e ) ;
} else if ( ( V_42 -> V_105 / 1000 ) <= 10000 ) {
V_99 = 92166 / ( V_42 -> V_105 / 1000 ) + 1 ;
if ( V_99 % 2 != 0 )
V_99 ++ ;
F_1 ( V_2 , 0xc3 , 0x07 ) ;
F_1 ( V_2 , 0xc8 , V_99 ) ;
F_1 ( V_2 , 0xc4 , 0x09 ) ;
F_1 ( V_2 , 0xc7 , 0x12 ) ;
} else if ( ( V_42 -> V_105 / 1000 ) <= 20000 ) {
V_99 = 64516 / ( V_42 -> V_105 / 1000 ) + 1 ;
F_1 ( V_2 , 0xc3 , V_99 ) ;
F_1 ( V_2 , 0xc8 , 0x0e ) ;
F_1 ( V_2 , 0xc4 , 0x07 ) ;
F_1 ( V_2 , 0xc7 , 0x18 ) ;
} else {
V_99 = 129032 / ( V_42 -> V_105 / 1000 ) + 1 ;
F_1 ( V_2 , 0xc3 , V_99 ) ;
F_1 ( V_2 , 0xc8 , 0x0a ) ;
F_1 ( V_2 , 0xc4 , 0x05 ) ;
F_1 ( V_2 , 0xc7 , 0x24 ) ;
}
V_99 = ( ( ( V_42 -> V_105 / 1000 ) << 16 ) +
( V_91 / 2 ) ) / V_91 ;
F_1 ( V_2 , 0x61 , V_99 & 0x00ff ) ;
F_1 ( V_2 , 0x62 , ( V_99 & 0xff00 ) >> 8 ) ;
F_1 ( V_2 , 0x56 , 0x00 ) ;
F_1 ( V_2 , 0x76 , 0x00 ) ;
if ( V_2 -> V_9 -> V_108 ) {
switch ( V_42 -> V_45 ) {
...
static enum V_113 F_31 ( struct V_25 * V_26 )
{
F_2 ( L_10 , V_14 ) ;
return V_114 ;
}
