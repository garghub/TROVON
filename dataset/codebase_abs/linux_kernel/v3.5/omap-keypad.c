...
F_41 ( & V_1 -> V_38 , F_12 , ( unsigned long ) V_1 ) ;
F_42 ( & V_15 ) ;
V_15 . V_17 = ( unsigned long ) V_1 ;
V_59 = F_43 ( & V_51 -> V_41 , & V_67 ) ;
if ( V_59 < 0 )
goto V_66;
V_52 -> V_68 = L_12 ;
V_52 -> V_69 = L_13 ;
V_52 -> V_41 . V_70 = & V_51 -> V_41 ;
V_52 -> V_71 . V_72 = V_73 ;
V_52 -> V_71 . V_74 = 0x0001 ;
V_52 -> V_71 . V_75 = 0x0001 ;
V_52 -> V_71 . V_76 = 0x0100 ;
if ( V_54 -> V_77 )
F_44 ( V_78 , V_52 -> V_79 ) ;
V_59 = F_45 ( V_54 -> V_61 , NULL ,
V_54 -> V_7 , V_54 -> V_4 ,
V_1 -> V_80 , V_52 ) ;
if ( V_59 < 0 )
goto V_81;
