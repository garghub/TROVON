...
static bool F_123 ( struct V_160 * V_161 , void * V_192 )
{
...
V_4 -> line ) ;
if ( V_39 -> V_14 -> V_199 <= 0 || V_39 -> V_14 -> V_200 <= 0 )
return;
F_127 ( V_197 ) ;
F_128 ( V_201 , V_197 ) ;
V_194 = & V_39 -> V_202 ;
V_194 -> V_195 = V_39 -> V_14 -> V_199 ;
V_39 -> V_149 = - V_27 ;
V_161 = F_129 ( V_197 , F_123 , V_194 ) ;
F_49 ( V_4 -> V_28 , L_30 , V_146 , V_161 ) ;
if ( V_161 ) {
V_39 -> V_112 = V_161 ;
F_130 ( & V_39 -> V_147 , 1 ) ;
F_118 ( ( int ) V_4 -> V_57 -> V_56 . V_64 & ~ V_203 ) ;
F_131 ( & V_39 -> V_147 , F_132 ( V_4 -> V_57 -> V_56 . V_64 ) ,
V_66 , ( int ) V_4 -> V_57 -> V_56 . V_64 & ~ V_203 ) ;
V_198 = F_133 ( V_4 -> V_28 , & V_39 -> V_147 , 1 , V_186 ) ;
if ( ! V_198 )
F_105 ( V_39 , false ) ;
else
...
V_205 [ 1 ] = V_205 [ 0 ] + V_39 -> V_157 ;
for ( V_72 = 0 ; V_72 < 2 ; V_72 ++ ) {
struct V_162 * V_163 = & V_39 -> V_156 [ V_72 ] ;
F_130 ( V_163 , 1 ) ;
F_131 ( V_163 , F_132 ( V_64 [ V_72 ] ) , V_39 -> V_157 ,
( int ) V_64 [ V_72 ] & ~ V_203 ) ;
F_102 ( V_163 ) = V_205 [ V_72 ] ;
}
...
static unsigned int F_143 ( unsigned int V_206 , unsigned int V_207 ,
unsigned long V_208 )
{
switch ( V_206 ) {
case V_209 :
return ( ( V_208 + 16 * V_207 ) / ( 16 * V_207 ) - 1 ) ;
case V_210 :
return ( ( V_208 + 16 * V_207 ) / ( 32 * V_207 ) - 1 ) ;
case V_211 :
return ( ( ( V_208 * 2 ) + 16 * V_207 ) / ( 16 * V_207 ) - 1 ) ;
case V_212 :
return ( ( ( V_208 * 2 ) + 16 * V_207 ) / ( 32 * V_207 ) - 1 ) ;
case V_213 :
return ( ( ( V_208 * 1000 / 32 ) / V_207 ) - 1 ) ;
}
F_144 ( 1 ) ;
return ( ( V_208 + 16 * V_207 ) / ( 32 * V_207 ) - 1 ) ;
}
...
V_8 = F_4 ( V_4 , V_142 ) ;
if ( V_8 -> V_9 )
F_23 ( V_4 , V_142 , V_214 | V_215 ) ;
}
static void F_146 ( struct V_2 * V_4 , struct V_216 * V_217 ,
struct V_216 * V_218 )
{
struct V_1 * V_39 = F_1 ( V_4 ) ;
struct V_7 * V_8 ;
unsigned int V_219 , V_220 , V_221 ;
int V_222 = - 1 ;
V_221 = V_4 -> V_30 ? V_4 -> V_30 / 16 : 115200 ;
V_219 = F_147 ( V_4 , V_217 , V_218 , 0 , V_221 ) ;
if ( F_148 ( V_219 && V_4 -> V_30 ) )
V_222 = F_143 ( V_39 -> V_14 -> V_223 , V_219 , V_4 -> V_30 ) ;
F_13 ( V_39 ) ;
F_145 ( V_4 ) ;
V_220 = F_21 ( V_4 , V_224 ) & 3 ;
if ( ( V_217 -> V_225 & V_226 ) == V_227 )
V_220 |= 0x40 ;
if ( V_217 -> V_225 & V_228 )
V_220 |= 0x20 ;
if ( V_217 -> V_225 & V_229 )
V_220 |= 0x30 ;
if ( V_217 -> V_225 & V_230 )
V_220 |= 0x08 ;
F_149 ( V_4 , V_217 -> V_225 , V_219 ) ;
F_23 ( V_4 , V_224 , V_220 ) ;
F_49 ( V_4 -> V_28 , L_34 , V_146 , V_220 , V_222 ,
V_39 -> V_14 -> V_105 ) ;
if ( V_222 > 0 ) {
if ( V_222 >= 256 ) {
F_23 ( V_4 , V_224 , ( F_21 ( V_4 , V_224 ) & ~ 3 ) | 1 ) ;
V_222 >>= 2 ;
} else
F_23 ( V_4 , V_224 , F_21 ( V_4 , V_224 ) & ~ 3 ) ;
F_23 ( V_4 , V_231 , V_222 ) ;
F_150 ( ( 1000000 + ( V_219 - 1 ) ) / V_219 ) ;
}
F_31 ( V_4 , V_217 -> V_225 ) ;
V_8 = F_4 ( V_4 , V_142 ) ;
if ( V_8 -> V_9 ) {
...
#ifdef F_63
if ( V_39 -> V_96 ) {
V_39 -> V_100 = ( V_4 -> V_233 - V_234 / 50 ) * V_39 -> V_157 * 3 /
V_4 -> V_52 / 2 ;
F_49 ( V_4 -> V_28 ,
L_35 ,
V_39 -> V_100 * 1000 / V_234 , V_4 -> V_233 ) ;
if ( V_39 -> V_100 < F_151 ( 20 ) )
V_39 -> V_100 = F_151 ( 20 ) ;
}
#endif
if ( ( V_217 -> V_225 & V_235 ) != 0 )
F_104 ( V_4 ) ;
F_17 ( V_39 ) ;
}
...
return 0 ;
if ( V_4 -> V_103 & V_236 ) {
V_4 -> V_10 = F_155 ( V_4 -> V_237 , V_9 ) ;
if ( F_76 ( ! V_4 -> V_10 ) ) {
F_79 ( V_4 -> V_28 , L_41 , V_4 -> line ) ;
return - V_238 ;
}
} else {
V_4 -> V_10 = ( void V_239 * ) V_4 -> V_237 ;
}
return 0 ;
}
...
struct V_240 * V_241 ;
int V_110 ;
V_241 = F_160 ( V_4 -> V_237 , V_9 , F_78 ( V_4 -> V_28 ) ) ;
if ( F_76 ( V_241 == NULL ) )
return - V_242 ;
V_110 = F_154 ( V_4 ) ;
if ( F_76 ( V_110 != 0 ) ) {
...
{
if ( V_103 & V_243 ) {
struct V_1 * V_244 = F_1 ( V_4 ) ;
V_4 -> type = V_244 -> V_14 -> type ;
F_159 ( V_4 ) ;
}
}
static int F_163 ( struct V_2 * V_4 , struct V_245 * V_246 )
{
struct V_1 * V_39 = F_1 ( V_4 ) ;
if ( V_246 -> V_94 != V_39 -> V_14 -> V_126 [ V_247 ] || V_246 -> V_94 > V_248 )
return - V_27 ;
if ( V_246 -> V_249 < 2400 )
return - V_27 ;
return 0 ;
}
static int T_3 F_164 ( struct V_250 * V_28 ,
struct V_1 * V_1 ,
unsigned int V_133 ,
struct V_13 * V_5 )
{
...
F_170 ( & V_1 -> V_83 ) ;
if ( ! V_5 -> V_256 )
V_5 -> V_256 = ( V_5 -> type == V_15 ) ?
V_257 : V_258 ;
if ( V_5 -> V_87 != V_88 ) {
if ( V_5 -> type == V_15 )
V_5 -> V_87 = 5 ;
else if ( V_5 -> V_223 == V_212 )
V_5 -> V_87 = 9 ;
else
V_5 -> V_87 = 0 ;
V_5 -> V_256 |= ( 1 << V_5 -> V_87 ) ;
}
V_4 -> V_237 = V_5 -> V_237 ;
V_4 -> type = V_5 -> type ;
V_4 -> V_103 = V_5 -> V_103 ;
V_4 -> V_11 = V_5 -> V_11 ;
V_4 -> V_94 = V_5 -> V_126 [ V_259 ] ;
V_4 -> V_131 = 0 ;
V_4 -> V_260 = F_3 ;
V_4 -> V_261 = F_8 ;
...
static void F_174 ( struct V_2 * V_4 , int V_262 )
{
F_27 ( V_4 , V_262 ) ;
}
static void F_175 ( struct V_263 * V_264 , const char * V_39 ,
unsigned V_60 )
{
struct V_1 * V_1 = & V_265 [ V_264 -> V_133 ] ;
struct V_2 * V_4 = & V_1 -> V_4 ;
unsigned short V_266 ;
F_13 ( V_1 ) ;
F_176 ( V_4 , V_39 , V_60 , F_174 ) ;
V_266 = F_28 ( V_4 ) | F_30 ( V_4 ) ;
while ( ( F_21 ( V_4 , V_34 ) & V_266 ) != V_266 )
F_177 () ;
F_17 ( V_1 ) ;
}
static int T_3 F_178 ( struct V_263 * V_264 , char * V_267 )
{
struct V_1 * V_1 ;
struct V_2 * V_4 ;
int V_219 = 115200 ;
...
int V_268 = 'n' ;
int V_110 ;
if ( V_264 -> V_133 < 0 || V_264 -> V_133 >= V_269 )
return - V_270 ;
V_1 = & V_265 [ V_264 -> V_133 ] ;
V_4 = & V_1 -> V_4 ;
if ( ! V_4 -> V_42 )
return - V_270 ;
V_110 = F_154 ( V_4 ) ;
...
F_13 ( V_1 ) ;
if ( V_267 )
F_179 ( V_267 , & V_219 , & V_81 , & V_266 , & V_268 ) ;
F_17 ( V_1 ) ;
return F_180 ( V_4 , V_264 , V_219 , V_81 , V_266 , V_268 ) ;
}
static int T_3 F_181 ( struct V_250 * V_271 )
{
struct V_13 * V_14 = V_271 -> V_28 . V_272 ;
if ( V_273 . V_86 )
return - V_274 ;
V_273 . V_133 = V_271 -> V_275 ;
F_164 ( NULL , & V_265 [ V_271 -> V_275 ] , V_271 -> V_275 , V_14 ) ;
F_178 ( & V_273 , V_276 ) ;
if ( ! strstr ( V_276 , L_47 ) )
V_273 . V_103 |= V_277 ;
F_182 ( & V_273 ) ;
return 0 ;
}
...
if ( F_185 ( V_4 ) ) {
struct V_7 * V_8 ;
V_1 -> V_278 = F_21 ( V_4 , V_224 ) ;
V_1 -> V_279 = F_21 ( V_4 , V_231 ) ;
V_8 = F_4 ( V_4 , V_142 ) ;
if ( V_8 -> V_9 )
V_1 -> V_280 = F_21 ( V_4 , V_142 ) ;
else
V_1 -> V_280 = 0 ;
}
return 0 ;
}
static int F_186 ( struct V_177 * V_28 )
{
struct V_1 * V_1 = F_184 ( V_28 ) ;
struct V_2 * V_4 = & V_1 -> V_4 ;
if ( F_185 ( V_4 ) ) {
F_145 ( V_4 ) ;
F_23 ( V_4 , V_224 , V_1 -> V_278 ) ;
F_23 ( V_4 , V_231 , V_1 -> V_279 ) ;
if ( V_1 -> V_280 )
F_23 ( V_4 , V_142 , V_1 -> V_280 ) ;
F_23 ( V_4 , V_61 , V_1 -> V_14 -> V_105 ) ;
}
return 0 ;
}
static inline int T_3 F_181 ( struct V_250 * V_271 )
{
return - V_27 ;
}
static int F_187 ( struct V_250 * V_28 )
{
...
static int T_3 F_191 ( struct V_250 * V_28 ,
unsigned int V_133 ,
struct V_13 * V_5 ,
struct V_1 * V_283 )
{
...
V_110 = F_164 ( V_28 , V_283 , V_133 , V_5 ) ;
if ( V_110 )
return V_110 ;
V_110 = F_192 ( & V_282 , & V_283 -> V_4 ) ;
if ( V_110 ) {
F_171 ( V_283 ) ;
return V_110 ;
}
...
static int T_3 F_193 ( struct V_250 * V_28 )
{
struct V_13 * V_5 = V_28 -> V_28 . V_272 ;
struct V_1 * V_284 = & V_265 [ V_28 -> V_275 ] ;
int V_110 ;
if ( F_194 ( V_28 ) )
return F_181 ( V_28 ) ;
F_195 ( V_28 , V_284 ) ;
V_110 = F_191 ( V_28 , V_28 -> V_275 , V_5 , V_284 ) ;
if ( V_110 )
return V_110 ;
V_284 -> V_116 . V_285 = F_73 ;
V_110 = F_196 ( & V_284 -> V_116 ,
V_281 ) ;
if ( F_76 ( V_110 < 0 ) ) {
F_171 ( V_284 ) ;
return V_110 ;
...
static int F_199 ( struct V_177 * V_28 )
{
struct V_1 * V_244 = F_184 ( V_28 ) ;
if ( V_244 )
F_200 ( & V_282 , & V_244 -> V_4 ) ;
return 0 ;
}
static int F_201 ( struct V_177 * V_28 )
{
struct V_1 * V_244 = F_184 ( V_28 ) ;
if ( V_244 )
F_202 ( & V_282 , & V_244 -> V_4 ) ;
return 0 ;
}
