...
if ( V_78 > V_85 ) {
V_53 = F_53 ( V_78 * sizeof( struct V_52 ) , V_89 ) ;
if ( V_53 == NULL ) {
V_56 = - V_90 ;
goto V_27;
}
...
V_36 F_59 ( struct V_1 * V_1 , const struct V_52 T_3 * V_95 ,
...
return - V_7 ;
return F_56 ( V_39 , V_1 , V_95 , V_96 , V_35 ) ;
}
V_36 F_60 ( struct V_1 * V_1 , const struct V_52 T_3 * V_95 ,
unsigned long V_96 , T_1 * V_35 )
{
if ( ! ( V_1 -> V_2 & V_70 ) )
return - V_64 ;
...
return - V_7 ;
return F_56 ( V_73 , V_1 , V_95 , V_96 , V_35 ) ;
}
static inline T_1 F_61 ( unsigned long V_97 , unsigned long V_98 )
{
#define F_62 (BITS_PER_LONG / 2)
return ( ( ( T_1 ) V_97 << F_62 ) << F_62 ) | V_98 ;
}
static V_36 F_63 ( int V_99 , int V_100 , T_1 * V_33 ,
T_2 V_34 , T_1 V_101 )
{
...
if ( ! ( V_102 -> V_2 & V_76 ) )
goto V_109;
V_25 = F_15 ( V_39 , V_102 , V_33 , V_34 ) ;
if ( V_25 < 0 )
goto V_109;
V_34 = V_25 ;
V_25 = - V_64 ;
V_103 = F_42 ( V_99 , & V_107 ) ;
if ( ! V_103 )
goto V_109;
if ( ! ( V_103 -> V_2 & V_70 ) )
goto V_110;
V_25 = - V_7 ;
V_104 = V_102 -> V_22 . V_23 -> V_24 ;
V_105 = V_103 -> V_22 . V_23 -> V_24 ;
V_25 = F_15 ( V_73 , V_103 , & V_103 -> V_8 , V_34 ) ;
if ( V_25 < 0 )
goto V_110;
V_34 = V_25 ;
if ( ! V_101 )
V_101 = F_64 ( V_104 -> V_19 -> V_20 , V_105 -> V_19 -> V_20 ) ;
V_35 = * V_33 ;
if ( F_16 ( V_35 + V_34 > V_101 ) ) {
V_25 = - V_37 ;
if ( V_35 >= V_101 )
goto V_110;
V_34 = V_101 - V_35 ;
...
#endif
V_25 = F_65 ( V_102 , V_33 , V_103 , V_34 , V_108 ) ;
if ( V_25 > 0 ) {
F_32 ( V_68 , V_25 ) ;
F_37 ( V_68 , V_25 ) ;
}
