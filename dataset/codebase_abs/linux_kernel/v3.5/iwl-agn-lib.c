...
int F_15 ( struct V_4 * V_5 , T_3 V_50 )
{
struct V_51 V_52 ;
struct V_53 V_54 = {
. V_55 = V_56 ,
...
V_71 | V_72 |
V_73 ;
if ( V_5 -> V_74 . V_75 & V_76 )
V_52 . V_60 |= V_77 ;
F_18 ( V_5 , L_2 ,
V_52 . V_60 ) ;
V_52 . V_50 = F_19 ( V_50 ) ;
return F_20 ( V_5 , & V_54 ) ;
}
void F_21 ( struct V_4 * V_5 , T_3 V_50 )
{
F_22 ( & V_5 -> V_78 ) ;
F_23 ( V_5 -> V_79 ) ;
if ( F_15 ( V_5 , V_80 ) ) {
...
sizeof( V_84 ) ) ;
V_97 = F_6 ( V_5 , V_128 ,
V_24 , sizeof( V_96 ) , & V_96 ) ;
} else {
memcpy ( & V_94 . V_84 , & V_84 ,
sizeof( V_84 ) ) ;
V_97 = F_6 ( V_5 , V_128 ,
V_24 , sizeof( V_94 ) , & V_94 ) ;
}
if ( V_97 )
F_24 ( V_5 , L_12 ) ;
}
void F_32 ( struct V_4 * V_5 , bool V_129 )
{
struct V_130 * V_46 , * V_131 = NULL ;
bool V_132 = false ;
F_8 ( & V_5 -> V_78 ) ;
if ( V_129 ) {
F_33 (priv, ctx) {
if ( V_46 -> V_41 && V_46 -> V_41 -> type == V_133 &&
F_34 ( V_46 ) ) {
V_132 = true ;
break;
}
...
F_33 (priv, ctx) {
if ( V_46 -> V_41 && V_46 -> V_41 -> type == V_135 &&
F_34 ( V_46 ) ) {
V_131 = V_46 ;
break;
}
...
static bool F_37 ( struct V_138 * V_139 )
{
return V_140 & V_139 -> V_141 >>
V_142 ;
}
static void F_38 ( struct V_143 * V_144 )
{
struct V_4 * V_5 =
F_39 ( V_144 , struct V_4 , V_145 ) ;
struct V_130 * V_46 ;
int V_146 = - 1 ;
if ( V_5 -> V_125 == V_118 ) {
return;
...
{
bool V_210 = false ;
struct V_130 * V_46 = & V_5 -> V_223 [ V_59 ] ;
int V_224 ;
V_224 = F_46 ( V_46 -> V_41 ) ;
if ( ! V_224 ) {
F_31 ( V_5 , L_27 ) ;
return V_210 ;
}
...
struct V_233 * V_234 = ( void * ) V_232 -> V_58 ;
struct V_138 * V_139 = & V_234 -> V_235 ;
if ( V_5 -> V_125 == V_118 ) {
return 0 ;
}
F_31 ( V_5 , L_28 ) ;
F_31 ( V_5 , L_29 , V_234 -> V_149 ) ;
F_31 ( V_5 , L_30 , V_234 -> V_147 ) ;
F_31 ( V_5 , L_31 ,
V_234 -> V_236 ) ;
F_43 ( V_5 , V_139 ) ;
V_5 -> V_237 = V_5 -> V_147 ;
V_5 -> V_159 = F_37 ( V_139 ) ;
if ( V_5 -> V_116 != V_117 ) {
...
void F_61 ( struct V_4 * V_5 , struct V_130 * V_46 )
{
bool V_251 = F_56 ( V_5 ) ;
...
V_258 |= V_255 << V_262 ;
V_258 |= V_254 << V_263 ;
V_46 -> V_264 . V_258 = F_19 ( V_258 ) ;
if ( ! V_251 && ( V_255 >= V_244 ) && V_252 )
V_46 -> V_264 . V_258 |= V_265 ;
else
V_46 -> V_264 . V_258 &= ~ V_265 ;
F_63 ( V_5 , L_33 ,
V_46 -> V_264 . V_258 ,
V_255 , V_254 ) ;
F_64 ( V_255 == 0 || V_254 == 0 ||
V_255 < V_254 ) ;
}
...
struct V_279 * V_58 = V_278 ;
struct V_130 * V_46 = V_58 -> V_46 ;
...
V_277 -> V_290 == V_292 ) &&
! V_275 && ! V_46 -> V_293 )
V_97 = F_69 ( V_5 , V_46 , V_277 ) ;
else
V_97 = F_70 ( V_5 , V_46 , V_277 , V_275 ) ;
if ( V_97 ) {
F_24 ( V_5 , L_34 ) ;
V_58 -> error = true ;
}
...
case V_294 :
if ( V_275 ) {
V_282 = V_58 -> V_295 -> V_296 . V_297 . V_298 ;
V_283 = & V_58 -> V_295 -> V_296 . V_297 . V_299 ;
V_285 = V_58 -> V_297 -> V_300 ;
F_71 ( V_277 , & V_288 ) ;
V_283 -> V_301 = F_19 ( V_288 . V_297 . V_301 ) ;
V_283 -> V_302 = F_30 ( V_288 . V_297 . V_302 ) ;
F_72 ( V_277 , V_288 . V_297 . V_302 , V_271 ) ;
F_66 ( V_271 , V_58 -> V_297 -> V_303 . V_271 ) ;
memcpy ( V_58 -> V_297 -> V_304 . V_303 ,
& V_277 -> V_277 [ V_305 ] ,
V_306 ) ;
V_286 = V_58 -> V_297 -> V_304 . V_307 ;
} else {
V_282 =
V_58 -> V_295 -> V_296 . V_297 . V_308 ;
V_285 = V_58 -> V_297 -> V_309 ;
V_286 = V_58 -> V_297 -> V_304 . V_310 ;
}
...
F_74 ( V_277 , V_58 -> V_48 , V_289 , V_271 ) ;
F_66 ( V_271 , V_285 [ 0 ] . V_271 ) ;
F_74 ( V_277 , V_58 -> V_48 ,
V_289 + 1 , V_271 ) ;
...
V_280 = V_58 -> V_295 -> V_296 . V_318 . V_298 ;
V_281 = & V_58 -> V_295 -> V_296 . V_318 . V_299 ;
F_71 ( V_277 , & V_288 ) ;
V_281 -> V_316 = F_75 (
( V_319 ) V_316 [ 5 ] |
( ( V_319 ) V_316 [ 4 ] << 8 ) |
...
V_280 = V_58 -> V_295 -> V_296 . V_318 . V_308 ;
for ( V_267 = 0 ; V_267 < V_311 ; V_267 ++ ) {
T_2 * V_316 = V_288 . V_317 . V_316 ;
F_73 ( V_277 , V_267 , & V_288 ) ;
V_280 -> V_316 = F_75 (
...
if ( ! V_321 -> V_328 )
return 0 ;
V_54 . V_57 [ 0 ] = sizeof( * V_323 ) +
V_321 -> V_328 * sizeof( struct V_329 ) ;
V_323 = F_77 ( V_54 . V_57 [ 0 ] , V_330 ) ;
if ( ! V_323 )
return - V_331 ;
...
F_30 ( V_375 ) ;
F_83 ( V_5 , 200 ) ;
memcpy ( & V_342 , & V_46 -> V_350 , sizeof( V_342 ) ) ;
V_5 -> V_376 = false ;
F_84 ( V_5 -> V_82 ) ;
V_5 -> V_321 = true ;
V_97 = F_85 ( V_5 , V_377 ) ;
...
if ( V_97 )
goto V_156;
memcpy ( & V_46 -> V_264 , & V_342 , sizeof( V_342 ) ) ;
V_97 = F_87 ( V_5 , V_46 ) ;
if ( V_97 )
goto V_156;
V_97 = F_88 ( V_5 , true ) ;
...
int F_20 ( struct V_4 * V_5 , struct V_53 * V_54 )
{
...
return F_95 ( V_5 -> V_82 , V_54 ) ;
}
int F_6 ( struct V_4 * V_5 , T_2 V_55 ,
T_1 V_16 , T_3 V_57 , const void * V_58 )
{
struct V_53 V_54 = {
. V_55 = V_55 ,
. V_57 = { V_57 , } ,
