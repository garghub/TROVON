...
void F_82 ( struct V_1 * V_2 , struct V_112 * V_113 )
{
}
int F_83 ( struct V_1 * V_2 , struct V_78 * V_79 )
{
struct V_125 * V_126 ;
struct V_112 * V_113 ;
struct V_162 * V_163 ;
const T_2 V_164 = F_84 ( V_79 ) -> V_165 ;
struct V_166 * V_167 = F_85 ( V_79 ) ;
...
if ( F_87 ( V_2 ) )
goto V_170;
if ( F_52 ( V_2 ) && F_88 ( V_2 ) > 1 )
goto V_170;
V_113 = F_89 ( & V_172 ) ;
if ( V_113 == NULL )
goto V_170;
if ( F_90 ( V_113 , F_3 ( V_2 ) , V_79 ) )
goto V_173;
V_163 = F_39 ( V_113 ) ;
if ( F_91 ( V_2 , V_163 , V_79 ) )
goto V_173;
if ( F_92 ( V_2 , V_79 , V_113 ) )
goto V_173;
V_126 = F_54 ( V_113 ) ;
...
int F_95 ( struct V_1 * V_2 , struct V_78 * V_79 )
{
struct V_84 * V_85 = V_84 ( V_79 ) ;
if ( V_2 -> V_67 == V_179 ) {
if ( F_96 ( V_2 , V_79 , V_85 , V_79 -> V_90 ) )
goto V_180;
return 0 ;
}
if ( V_2 -> V_67 == V_68 ) {
...
goto V_181;
if ( V_139 != V_2 ) {
if ( F_97 ( V_2 , V_139 , V_79 ) )
goto V_180;
return 0 ;
}
}
if ( F_98 ( V_2 , V_79 , V_85 , V_79 -> V_90 ) )
goto V_180;
return 0 ;
V_180:
F_74 ( V_2 , V_79 ) ;
...
int F_100 ( struct V_78 * V_79 )
{
const struct V_84 * V_85 ;
unsigned int V_182 ;
if ( V_79 -> V_183 != V_184 )
return 1 ;
if ( ! F_101 ( V_79 , sizeof( struct V_84 ) ) ) {
F_102 ( L_1 ) ;
return 1 ;
}
V_85 = V_84 ( V_79 ) ;
...
if ( V_85 -> V_186 < F_103 ( V_79 ) / sizeof( T_3 ) ) {
F_102 ( L_3 , V_85 -> V_186 ) ;
return 1 ;
}
if ( ! F_101 ( V_79 , V_85 -> V_186 * sizeof( T_3 ) ) ) {
F_102 ( L_4 , V_85 -> V_186 ) ;
return 1 ;
}
if ( ( V_85 -> V_155 < V_187 ||
...
V_79 -> V_123 = F_106 ( V_79 , 0 , V_182 , 0 ) ;
return 0 ;
}
static int F_107 ( struct V_78 * V_79 )
{
const struct V_84 * V_85 ;
const struct V_63 * V_64 ;
struct V_1 * V_2 ;
...
V_85 = V_84 ( V_79 ) ;
F_85 ( V_79 ) -> V_175 = F_35 ( V_85 ) ;
F_85 ( V_79 ) -> V_193 = V_85 -> V_155 ;
F_108 ( L_8 ,
F_104 ( V_85 -> V_155 ) ,
& V_64 -> V_47 , F_109 ( V_85 -> V_94 ) ,
& V_64 -> V_14 , F_109 ( V_85 -> V_93 ) ,
( unsigned long long ) F_85 ( V_79 ) -> V_175 ) ;
if ( F_110 ( V_79 ) ) {
F_85 ( V_79 ) -> V_194 = V_195 ;
F_111 ( L_9 ) ;
} else {
F_85 ( V_79 ) -> V_194 = F_112 ( V_79 ) ;
F_111 ( L_10 , ( unsigned long long )
F_85 ( V_79 ) -> V_194 ) ;
}
V_2 = F_113 ( & V_92 , V_79 ,
V_85 -> V_94 , V_85 -> V_93 ) ;
...
if ( ! F_114 ( V_2 , V_199 , V_79 ) )
goto V_198;
F_115 ( V_79 ) ;
return F_116 ( V_2 , V_79 , 1 ) ;
V_196:
if ( ! F_114 ( NULL , V_199 , V_79 ) )
goto V_192;
if ( V_85 -> V_155 != V_156 ) {
F_85 ( V_79 ) -> V_168 =
V_200 ;
...
static int T_9 F_120 ( struct V_88 * V_88 )
{
if ( V_92 . V_204 == NULL )
return - V_205 ;
return F_121 ( & V_88 -> V_153 . V_154 , V_206 ,
V_207 , V_42 , V_88 ) ;
}
static void T_10 F_122 ( struct V_88 * V_88 )
{
F_123 ( V_88 -> V_153 . V_154 ) ;
}
static int T_11 F_124 ( void )
{
int V_20 = F_125 ( & V_208 , 1 ) ;
if ( V_20 != 0 )
goto V_60;
V_20 = F_126 ( & V_209 , V_42 ) ;
if ( V_20 != 0 )
goto V_210;
F_127 ( & V_211 ) ;
V_20 = F_128 ( & V_212 ) ;
