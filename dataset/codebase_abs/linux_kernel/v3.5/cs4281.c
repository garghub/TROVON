...
static int T_2 F_38 ( struct V_1 * V_2 , int V_103 ,
struct V_104 * * V_105 )
{
struct V_104 * V_106 ;
int V_107 ;
...
static int T_2 F_49 ( struct V_1 * V_2 )
{
...
static T_3 F_55 ( struct V_148 * V_149 ,
void * V_154 ,
struct V_155 * V_155 , char T_4 * V_156 ,
T_5 V_10 , T_6 V_157 )
{
struct V_1 * V_2 = V_149 -> V_9 ;
...
static T_3 F_57 ( struct V_148 * V_149 ,
void * V_154 ,
struct V_155 * V_155 , char T_4 * V_156 ,
T_5 V_10 , T_6 V_157 )
{
...
static void T_2 F_58 ( struct V_1 * V_2 )
{
struct V_148 * V_149 ;
...
static int T_2 F_67 ( struct V_1 * V_2 )
{
struct V_168 * V_188 ;
...
static int T_2 F_87 ( struct V_138 * V_108 ,
struct V_204 * V_116 ,
struct V_1 * * V_205 ,
int V_145 )
{
...
static int T_2 F_116 ( struct V_1 * V_2 , int V_103 ,
struct V_290 * * V_291 )
{
struct V_290 * V_274 ;
int V_107 ;
...
static T_7 V_212 ( int V_198 , void * V_299 )
{
...
static int T_2 F_122 ( struct V_204 * V_116 ,
...
static void T_9 F_130 ( struct V_204 * V_116 )
{
F_124 ( F_131 ( V_116 ) ) ;
F_129 ( V_116 , NULL ) ;
}
static int F_132 ( struct V_204 * V_116 , T_10 V_329 )
{
struct V_138 * V_108 = F_131 ( V_116 ) ;
...
F_1 ( V_2 , V_200 , V_330 ) ;
F_1 ( V_2 , V_266 , V_334 ) ;
for ( V_331 = 0 ; V_331 < F_136 ( V_335 ) ; V_331 ++ )
if ( V_335 [ V_331 ] )
...
F_84 ( V_116 ) ;
F_137 ( V_116 ) ;
F_80 ( V_116 , F_138 ( V_116 , V_329 ) ) ;
return 0 ;
}
static int F_139 ( struct V_204 * V_116 )
{
struct V_138 * V_108 = F_131 ( V_116 ) ;
struct V_1 * V_2 = V_108 -> V_9 ;
unsigned int V_331 ;
