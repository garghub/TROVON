...
static int T_3 F_35 ( struct V_43 * V_44 )
{
struct V_1 * V_4 ;
int V_6 , V_51 , V_7 , V_52 [ 2 ] ;
char V_53 [ 4 ] ;
V_4 = F_36 ( sizeof( struct V_1 ) , V_54 ) ;
if ( ! V_4 )
return - V_55 ;
V_4 -> V_14 = F_37 ( V_44 , V_56 , 0 ) -> V_57 ;
F_38 ( & V_4 -> V_8 ) ;
F_33 ( V_44 , V_4 ) ;
for ( V_6 = 0 ; V_6 < 3 ; V_6 ++ ) {
V_7 = F_5 ( V_4 -> V_14 ,
...
V_4 -> V_46 = F_42 ( & V_44 -> V_3 ) ;
if ( F_17 ( V_4 -> V_46 ) ) {
V_51 = F_18 ( V_4 -> V_46 ) ;
V_4 -> V_46 = NULL ;
goto error;
}
V_4 -> V_45 = F_43 ( & V_44 -> V_3 , V_4 -> V_14 ,
( V_52 [ 0 ] << 8 ) | V_52 [ 1 ] ,
& V_4 -> V_8 , 0 ) ;
return 0 ;
error:
