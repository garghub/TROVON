...
struct V_101 * V_198 ;
F_15 ( & V_91 -> V_96 ) ;
while ( ( V_198 = V_27 -> V_137 . V_99 ) !=
& V_27 -> V_137 ) {
V_127 = F_111 ( V_198 , struct V_126 ,
V_138 ) ;
...
T_1 V_6 , T_1 V_82 , T_1 V_199 )
{
struct V_90 * V_91 = V_27 -> V_112 ;
struct V_88 * V_85 = NULL ;
T_1 V_200 = V_82 + V_199 ;
T_1 V_16 = 0 ;
F_15 ( & V_91 -> V_96 ) ;
V_85 = F_152 ( V_91 , & V_6 , & V_200 ) ;
if ( ! V_85 )
goto V_105;
V_16 = V_6 ;
if ( V_85 -> V_83 ) {
...
V_205 = F_130 ( V_82 , V_27 -> V_167 ) ;
V_206 = F_130 ( V_204 , V_27 -> V_167 ) ;
V_95:
V_173 = 0 ;
...
V_207 += V_173 ;
if ( V_127 -> V_202 < V_173 * V_27 -> V_167 )
V_127 -> V_202 = V_173 * V_27 -> V_167 ;
if ( V_207 < V_205 || V_127 -> V_202 < V_203 ) {
V_72 = V_175 + 1 ;
goto V_95;
}
V_127 -> V_196 = V_131 * V_27 -> V_167 +
V_85 -> V_6 ;
...
if ( ! V_85 )
return - V_53 ;
while ( V_85 -> V_83 || V_85 -> V_82 < V_204 ) {
...
if ( V_210 < V_82 || V_211 < V_203 )
return - V_53 ;
V_127 -> V_196 = V_208 -> V_6 ;
V_122 = & V_208 -> V_98 ;
do {
int V_16 ;
V_85 = F_91 ( V_122 , struct V_88 , V_98 ) ;
V_122 = F_90 ( & V_85 -> V_98 ) ;
if ( V_85 -> V_83 || V_85 -> V_82 < V_204 )
continue;
F_140 ( & V_85 -> V_98 , & V_91 -> V_97 ) ;
V_16 = F_133 ( & V_127 -> V_3 , V_85 -> V_6 ,
& V_85 -> V_98 , 0 ) ;
V_212 += V_85 -> V_82 ;
F_60 ( V_16 ) ;
} while ( V_122 && V_85 != V_209 );
V_127 -> V_202 = V_211 ;
F_179 ( V_27 , V_127 , V_212 , 0 ) ;
return 0 ;
}
static T_7 int
...
struct V_88 * V_85 ;
int V_16 = - V_53 ;
T_1 V_213 = F_131 ( V_91 , V_6 ) ;
if ( V_91 -> V_107 == 0 )
return - V_53 ;
V_85 = F_182 ( V_102 , struct V_88 , V_110 ) ;
if ( V_85 -> V_6 != V_213 ) {
V_85 = F_137 ( V_91 , V_213 , 1 , 0 ) ;
...
int V_16 ;
if ( F_187 ( V_3 , V_214 ) ) {
V_203 = V_204 = V_82 + V_199 ;
} else if ( V_27 -> V_28 & V_215 ) {
V_203 = V_82 ;
V_204 = V_27 -> V_167 ;
} else {
V_203 = F_114 ( V_82 , ( V_82 + V_199 ) >> 2 ) ;
V_204 = V_27 -> V_167 ;
}
F_15 ( & V_91 -> V_96 ) ;
if ( V_91 -> V_120 < V_82 ) {
...
T_1 * V_217 , T_1 V_131 , T_1 V_82 ,
T_1 V_218 , T_1 V_219 )
{
struct V_220 * V_221 = V_27 -> V_221 ;
...
T_1 * V_217 , T_1 V_131 , T_1 V_176 , T_1 V_228 )
{
struct V_90 * V_91 = V_27 -> V_112 ;
struct V_88 * V_85 ;
struct V_93 * V_122 ;
...
F_93 ( V_100 , V_85 ) ;
F_17 ( & V_91 -> V_96 ) ;
V_16 = F_191 ( V_27 , V_217 , V_131 , V_82 ,
V_132 , V_165 ) ;
if ( V_16 )
break;
V_99:
...
T_1 * V_223 , T_1 V_131 , T_1 V_176 , T_1 V_228 )
{
int V_16 ;
* V_223 = 0 ;
V_16 = F_193 ( V_27 , V_223 , V_131 , V_176 , V_228 ) ;
if ( V_16 )
return V_16 ;
V_16 = F_195 ( V_27 , V_223 , V_131 , V_176 , V_228 ) ;
return V_16 ;
}
