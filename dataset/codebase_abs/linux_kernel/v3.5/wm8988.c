...
if ( V_87 >= 0 )
F_4 ( V_44 , V_10 , V_86 |
( V_49 [ V_87 ] . V_92 << 1 ) | V_49 [ V_87 ] . V_93 ) ;
return 0 ;
}
static int F_16 ( struct V_51 * V_81 , int V_94 )
{
struct V_43 * V_44 = V_81 -> V_44 ;
T_1 V_95 = F_3 ( V_44 , V_8 ) & 0xfff7 ;
if ( V_94 )
F_4 ( V_44 , V_8 , V_95 | 0x8 ) ;
else
F_4 ( V_44 , V_8 , V_95 ) ;
return 0 ;
}
...
{
struct V_56 * V_57 = F_8 ( V_44 ) ;
T_1 V_98 = F_3 ( V_44 , V_25 ) & ~ 0x1c1 ;
switch ( V_97 ) {
case V_99 :
break;
case V_100 :
F_4 ( V_44 , V_25 , V_98 | 0x00c0 ) ;
break;
case V_101 :
if ( V_44 -> V_102 . V_103 == V_104 ) {
F_18 ( V_57 -> V_105 ) ;
F_4 ( V_44 , V_25 , V_98 | 0x1c1 ) ;
F_19 ( 100 ) ;
}
F_4 ( V_44 , V_25 , V_98 | 0x0141 ) ;
break;
case V_104 :
F_4 ( V_44 , V_25 , 0x0000 ) ;
break;
}
V_44 -> V_102 . V_103 = V_97 ;
return 0 ;
}
...
struct V_56 * V_57 = F_8 ( V_44 ) ;
int V_106 = 0 ;
V_44 -> V_107 = V_57 -> V_105 ;
V_106 = F_24 ( V_44 , 7 , 9 , V_108 ) ;
if ( V_106 < 0 ) {
F_11 ( V_44 -> V_2 , L_3 , V_106 ) ;
return V_106 ;
}
V_106 = F_25 ( V_44 ) ;
if ( V_106 < 0 ) {
...
static int T_2 F_28 ( struct V_109 * V_110 )
{
struct V_56 * V_57 ;
int V_106 ;
V_57 = F_29 ( & V_110 -> V_2 , sizeof( struct V_56 ) ,
V_111 ) ;
if ( V_57 == NULL )
return - V_112 ;
V_57 -> V_105 = F_30 ( V_110 , & V_113 ) ;
if ( F_31 ( V_57 -> V_105 ) ) {
V_106 = F_32 ( V_57 -> V_105 ) ;
F_11 ( & V_110 -> V_2 , L_5 , V_106 ) ;
return V_106 ;
}
F_33 ( V_110 , V_57 ) ;
V_106 = F_34 ( & V_110 -> V_2 ,
& V_114 , & V_115 , 1 ) ;
if ( V_106 != 0 )
F_35 ( V_57 -> V_105 ) ;
return V_106 ;
}
static int T_3 F_36 ( struct V_109 * V_110 )
{
struct V_56 * V_57 = F_37 ( V_110 ) ;
F_38 ( & V_110 -> V_2 ) ;
F_35 ( V_57 -> V_105 ) ;
return 0 ;
}
static T_2 int F_39 ( struct V_116 * V_117 ,
const struct V_118 * V_119 )
{
struct V_56 * V_57 ;
int V_106 ;
V_57 = F_29 ( & V_117 -> V_2 , sizeof( struct V_56 ) ,
V_111 ) ;
if ( V_57 == NULL )
return - V_112 ;
F_40 ( V_117 , V_57 ) ;
V_57 -> V_105 = F_41 ( V_117 , & V_113 ) ;
if ( F_31 ( V_57 -> V_105 ) ) {
V_106 = F_32 ( V_57 -> V_105 ) ;
F_11 ( & V_117 -> V_2 , L_5 , V_106 ) ;
return V_106 ;
}
V_106 = F_34 ( & V_117 -> V_2 ,
& V_114 , & V_115 , 1 ) ;
if ( V_106 != 0 )
F_35 ( V_57 -> V_105 ) ;
return V_106 ;
}
static T_3 int F_42 ( struct V_116 * V_120 )
{
struct V_56 * V_57 = F_43 ( V_120 ) ;
F_38 ( & V_120 -> V_2 ) ;
F_35 ( V_57 -> V_105 ) ;
return 0 ;
}
