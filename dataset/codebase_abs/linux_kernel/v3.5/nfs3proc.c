...
{
struct V_14 * V_14 = V_86 -> V_166 -> V_14 ;
if ( F_5 ( V_13 , V_14 ) )
return - V_167 ;
F_51 ( V_14 ) ;
F_21 ( V_14 , & V_86 -> V_29 ) ;
...
static int F_62 ( struct V_12 * V_13 , struct V_169 * V_86 )
{
struct V_14 * V_14 = V_86 -> V_166 -> V_14 ;
if ( F_5 ( V_13 , V_14 ) )
return - V_167 ;
...
static void F_64 ( struct V_169 * V_86 , struct V_3 * V_4 )
{
V_4 -> V_22 = & V_23 [ V_170 ] ;
}
static void F_65 ( struct V_12 * V_13 , struct V_169 * V_86 )
{
F_39 ( V_13 ) ;
}
static void F_66 ( struct V_12 * V_13 , struct V_171 * V_86 )
{
F_39 ( V_13 ) ;
}
static int F_67 ( struct V_12 * V_13 , struct V_171 * V_86 )
{
...
static void F_68 ( struct V_171 * V_86 , struct V_3 * V_4 )
{
V_4 -> V_22 = & V_23 [ V_172 ] ;
}
static int
...
{
struct V_14 * V_14 = V_174 -> V_178 . V_38 -> V_41 ;
return F_70 ( F_71 ( V_14 ) -> V_179 , V_175 , V_177 ) ;
}
