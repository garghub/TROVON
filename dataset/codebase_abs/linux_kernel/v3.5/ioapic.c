...
bool F_19 ( struct V_34 * V_34 , int V_28 )
{
struct V_1 * V_2 = V_34 -> V_55 . V_56 ;
F_20 () ;
return F_21 ( V_28 , V_2 -> V_26 ) ;
}
void F_22 ( struct V_34 * V_34 , int V_28 , int V_53 )
{
struct V_1 * V_2 = V_34 -> V_55 . V_56 ;
F_14 ( & V_2 -> V_49 ) ;
F_17 ( V_2 , V_28 , V_53 ) ;
...
static inline struct V_1 * F_23 ( struct V_57 * V_58 )
{
return F_24 ( V_58 , struct V_1 , V_58 ) ;
}
static inline int F_25 ( struct V_1 * V_2 , T_3 V_3 )
{
return ( ( V_3 >= V_2 -> V_59 &&
( V_3 < V_2 -> V_59 + V_60 ) ) ) ;
}
static int F_26 ( struct V_57 * V_61 , T_3 V_3 , int V_62 ,
void * V_29 )
{
...
static int F_28 ( struct V_57 * V_61 , T_3 V_3 , int V_62 ,
const void * V_29 )
{
struct V_1 * V_2 = F_23 ( V_61 ) ;
T_1 V_67 ;
...
int F_31 ( struct V_34 * V_34 )
{
struct V_1 * V_2 ;
int V_48 ;
V_2 = F_32 ( sizeof( struct V_1 ) , V_72 ) ;
if ( ! V_2 )
return - V_73 ;
F_33 ( & V_2 -> V_49 ) ;
V_34 -> V_55 . V_56 = V_2 ;
...
struct V_1 * V_2 = V_34 -> V_55 . V_56 ;
if ( V_2 ) {
F_40 ( V_34 , V_76 , & V_2 -> V_58 ) ;
V_34 -> V_55 . V_56 = NULL ;
F_38 ( V_2 ) ;
}
}
int F_41 ( struct V_34 * V_34 , struct V_77 * V_78 )
{
...
int F_43 ( struct V_34 * V_34 , struct V_77 * V_78 )
{
struct V_1 * V_2 = F_42 ( V_34 ) ;
if ( ! V_2 )
return - V_79 ;
