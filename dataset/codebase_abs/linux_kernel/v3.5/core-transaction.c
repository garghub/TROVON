...
void F_55 ( struct V_80 * V_83 )
{
F_53 ( & V_94 ) ;
F_11 ( & V_83 -> V_12 ) ;
F_54 ( & V_94 ) ;
}
static void F_56 ( struct V_26 * V_21 ,
struct V_6 * V_7 , int V_27 )
{
struct V_96 * V_97 ;
...
int F_58 ( struct V_96 * V_99 )
{
int V_39 , V_47 , V_100 ;
V_39 = F_59 ( V_99 -> V_101 [ 0 ] ) ;
switch ( V_39 ) {
case V_55 :
case V_57 :
return 0 ;
...
return 4 ;
case V_59 :
V_100 = F_60 ( V_99 -> V_101 [ 3 ] ) ;
return V_100 ;
case V_53 :
V_47 = F_61 ( V_99 -> V_101 [ 3 ] ) ;
V_100 = F_60 ( V_99 -> V_101 [ 3 ] ) ;
switch ( V_47 ) {
case V_102 :
case V_103 :
...
void F_62 ( struct V_26 * V_98 , V_56 * V_101 ,
...
static V_56 F_67 ( struct V_6 * V_7 ,
V_56 V_110 )
{
unsigned int V_111 ;
V_56 V_112 ;
...
static struct V_96 * F_68 ( struct V_6 * V_7 ,
struct V_26 * V_114 )
{
struct V_96 * V_97 ;
V_56 * V_23 , V_46 ;
int V_115 ;
V_115 = F_59 ( V_114 -> V_49 [ 0 ] ) ;
switch ( V_115 ) {
case V_55 :
V_23 = & V_114 -> V_49 [ 3 ] ;
V_46 = 4 ;
...
V_97 = F_70 ( sizeof( * V_97 ) + V_46 , V_116 ) ;
if ( V_97 == NULL )
return NULL ;
V_97 -> V_98 . V_43 = V_114 -> V_43 ;
V_97 -> V_98 . V_112 =
F_67 ( V_7 , V_114 -> V_112 ) ;
...
V_106 = F_64 ( V_114 -> V_49 [ 0 ] ) ;
V_105 = F_65 ( V_114 -> V_49 [ 1 ] ) ;
V_39 = F_59 ( V_114 -> V_49 [ 0 ] ) ;
if ( V_39 == V_53 )
V_39 = 0x10 + F_61 ( V_114 -> V_49 [ 3 ] ) ;
F_53 ( & V_94 ) ;
V_83 = F_50 ( & V_95 ,
V_44 , V_97 -> V_46 ) ;
if ( V_83 )
...
void F_77 ( struct V_6 * V_7 , struct V_26 * V_114 )
{
struct V_96 * V_97 ;
unsigned long long V_44 ;
if ( V_114 -> V_60 != V_30 && V_114 -> V_60 != V_28 )
return;
if ( F_78 ( F_59 ( V_114 -> V_49 [ 0 ] ) ) ) {
F_79 ( V_7 , V_114 ) ;
return;
}
V_97 = F_68 ( V_7 , V_114 ) ;
...
V_44 = ( ( T_3 ) F_80 ( V_114 -> V_49 [ 1 ] ) << 32 ) |
V_114 -> V_49 [ 2 ] ;
if ( ! F_51 ( V_44 , V_97 -> V_46 ) )
F_75 ( V_7 , V_114 , V_97 , V_44 ) ;
else
F_76 ( V_7 , V_114 , V_97 , V_44 ) ;
}
void F_81 ( struct V_6 * V_7 , struct V_26 * V_114 )
{
struct V_1 * V_2 ;
unsigned long V_9 ;
V_56 * V_23 ;
...
V_39 = F_59 ( V_114 -> V_49 [ 0 ] ) ;
V_14 = F_63 ( V_114 -> V_49 [ 0 ] ) ;
V_105 = F_65 ( V_114 -> V_49 [ 1 ] ) ;
V_8 = F_82 ( V_114 -> V_49 [ 1 ] ) ;
F_4 ( & V_7 -> V_10 , V_9 ) ;
F_5 (t, &card->transaction_list, link) {
...
if ( ( unsigned int ) V_8 < F_84 ( V_123 ) && V_123 [ V_8 ] )
return V_123 [ V_8 ] ;
else
return L_15 ;
}
static void F_85 ( struct V_6 * V_7 , struct V_96 * V_97 ,
...
V_111 = F_88 ( V_111 , 800u , 3u * 8000u ) ;
V_7 -> V_113 = V_111 ;
V_7 -> V_25 = F_40 ( V_111 * V_73 , 8000 ) ;
}
static void F_89 ( struct V_6 * V_7 , struct V_96 * V_97 ,
int V_39 , int V_106 , int V_105 , int V_42 ,
unsigned long long V_44 , void * V_45 , T_1 V_46 ,
void * V_17 )
{
...
case V_139 :
if ( V_39 == V_58 )
* V_23 = F_90 ( V_7 -> V_19 -> V_140 ( V_7 , V_131 ) ) ;
else if ( V_39 == V_55 )
V_7 -> V_19 -> V_141 ( V_7 , V_131 , F_91 ( * V_23 ) ) ;
else
V_8 = V_38 ;
break;
case V_142 :
