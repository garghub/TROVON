...
static unsigned int * F_35 ( struct V_74 * V_74 )
{
return V_122 ;
}
...
F_13 ( V_111 == NULL ) ;
F_8 ( & V_20 -> V_23 ) ;
V_125 = V_20 -> V_24 . V_11 . V_22 ;
V_68 = F_37 ( V_109 ) ;
V_72 = F_10 ( V_111 ) ;
V_124 = V_127 [ V_68 ] [ V_72 ] [ V_125 ] ;
...
struct V_40 V_76 = {} ;
V_20 -> V_24 . V_11 . V_135 =
V_20 -> V_24 . V_11 . V_134 = 0 ;
F_12 ( V_2 , V_3 , V_111 , & V_76 ) ;
if ( V_76 . V_45 & V_56 ) {
V_20 -> V_24 . V_11 . V_135 |=
V_56 ;
V_20 -> V_24 . V_11 . V_134 = V_76 . V_44 ;
}
if ( V_76 . V_45 & V_52 ) {
V_20 -> V_24 . V_11 . V_135 |=
V_52 ;
...
if ( V_72 == V_28
&& ( ( F_39 ( V_138 , & V_20 -> V_139 )
&& V_20 -> V_24 . V_11 . V_130 == V_32 )
|| ( ! F_39 ( V_140 , & V_20 -> V_139 )
&& V_20 -> V_24 . V_11 . V_130 == V_35 ) )
&& F_23 ( V_111 -> V_84 ) == V_20 -> V_24 . V_11 . V_101 ) {
goto V_141;
}
default:
...
V_125 , V_124 ) ;
V_20 -> V_24 . V_11 . V_22 = V_124 ;
if ( V_125 != V_124
&& V_124 == V_142 )
V_20 -> V_24 . V_11 . V_76 [ V_68 ] . V_45 |= V_129 ;
if ( V_20 -> V_24 . V_11 . V_103 >= V_143 &&
V_123 [ V_124 ] > V_123 [ V_144 ] )
V_126 = V_123 [ V_144 ] ;
else if ( ( V_20 -> V_24 . V_11 . V_76 [ 0 ] . V_45 | V_20 -> V_24 . V_11 . V_76 [ 1 ] . V_45 ) &
V_95 &&
V_123 [ V_124 ] > V_123 [ V_145 ] )
V_126 = V_123 [ V_145 ] ;
else
V_126 = V_123 [ V_124 ] ;
F_9 ( & V_20 -> V_23 ) ;
if ( V_124 != V_125 )
F_40 ( V_146 , V_20 ) ;
if ( ! F_39 ( V_138 , & V_20 -> V_139 ) ) {
if ( V_111 -> V_27 ) {
F_41 ( V_20 , V_109 , V_2 ) ;
return V_115 ;
}
} else if ( ! F_39 ( V_140 , & V_20 -> V_139 )
&& ( V_125 == V_91
|| V_125 == V_147 )
&& V_124 == V_147 ) {
F_42 ( V_140 , & V_20 -> V_139 ) ;
F_40 ( V_148 , V_20 ) ;
}
F_43 ( V_20 , V_109 , V_2 , V_126 ) ;
return V_115 ;
}
static bool F_44 ( struct V_19 * V_20 , const struct V_1 * V_2 ,
unsigned int V_3 , unsigned int * V_123 )
{
enum V_21 V_124 ;
const struct V_6 * V_111 ;
struct V_6 V_112 ;
...
V_111 = F_2 ( V_2 , V_3 , sizeof( V_112 ) , & V_112 ) ;
F_13 ( V_111 == NULL ) ;
V_124 = V_127 [ 0 ] [ F_10 ( V_111 ) ] [ V_149 ] ;
if ( V_124 >= V_136 ) {
F_25 ( L_28 ) ;
return false ;
}
...
struct V_154 V_58 = {} ;
F_8 ( & V_20 -> V_23 ) ;
V_153 = F_46 ( V_2 , V_155 | V_156 ) ;
if ( ! V_153 )
goto V_157;
if ( F_47 ( V_2 , V_158 , V_20 -> V_24 . V_11 . V_22 ) ||
F_47 ( V_2 , V_159 ,
...
static int F_50 ( struct V_151 * V_163 [] , struct V_19 * V_20 )
{
struct V_151 * V_164 = V_163 [ V_155 ] ;
struct V_151 * V_165 [ V_166 + 1 ] ;
int V_167 ;
if ( ! V_164 )
return 0 ;
V_167 = F_51 ( V_165 , V_166 , V_164 , V_168 ) ;
if ( V_167 < 0 )
return V_167 ;
if ( V_165 [ V_158 ] &&
F_52 ( V_165 [ V_158 ] ) >= V_136 )
return - V_169 ;
F_8 ( & V_20 -> V_23 ) ;
if ( V_165 [ V_158 ] )
V_20 -> V_24 . V_11 . V_22 = F_52 ( V_165 [ V_158 ] ) ;
if ( V_165 [ V_161 ] ) {
struct V_154 * V_170 =
F_53 ( V_165 [ V_161 ] ) ;
V_20 -> V_24 . V_11 . V_76 [ 0 ] . V_45 &= ~ V_170 -> V_171 ;
V_20 -> V_24 . V_11 . V_76 [ 0 ] . V_45 |= V_170 -> V_45 & V_170 -> V_171 ;
}
if ( V_165 [ V_162 ] ) {
struct V_154 * V_170 =
F_53 ( V_165 [ V_162 ] ) ;
V_20 -> V_24 . V_11 . V_76 [ 1 ] . V_45 &= ~ V_170 -> V_171 ;
V_20 -> V_24 . V_11 . V_76 [ 1 ] . V_45 |= V_170 -> V_45 & V_170 -> V_171 ;
}
if ( V_165 [ V_159 ] &&
V_165 [ V_160 ] &&
...
{
return F_56 ( V_172 , V_173 + 1 ) ;
}
static int F_58 ( struct V_151 * V_165 [] , void * V_174 )
{
unsigned int * V_123 = V_174 ;
int V_63 ;
for ( V_63 = 0 ; V_63 < V_175 ; V_63 ++ )
V_123 [ V_63 ] = V_122 [ V_63 ] ;
if ( V_165 [ V_176 ] ) {
V_123 [ V_89 ] =
F_23 ( F_59 ( V_165 [ V_176 ] ) ) * V_177 ;
}
if ( V_165 [ V_178 ] ) {
V_123 [ V_91 ] =
F_23 ( F_59 ( V_165 [ V_178 ] ) ) * V_177 ;
}
if ( V_165 [ V_179 ] ) {
V_123 [ V_147 ] =
F_23 ( F_59 ( V_165 [ V_179 ] ) ) * V_177 ;
}
if ( V_165 [ V_180 ] ) {
V_123 [ V_142 ] =
F_23 ( F_59 ( V_165 [ V_180 ] ) ) * V_177 ;
}
if ( V_165 [ V_181 ] ) {
V_123 [ V_182 ] =
F_23 ( F_59 ( V_165 [ V_181 ] ) ) * V_177 ;
}
if ( V_165 [ V_183 ] ) {
V_123 [ V_184 ] =
F_23 ( F_59 ( V_165 [ V_183 ] ) ) * V_177 ;
}
if ( V_165 [ V_185 ] ) {
V_123 [ V_128 ] =
F_23 ( F_59 ( V_165 [ V_185 ] ) ) * V_177 ;
}
if ( V_165 [ V_186 ] ) {
V_123 [ V_137 ] =
F_23 ( F_59 ( V_165 [ V_186 ] ) ) * V_177 ;
}
if ( V_165 [ V_187 ] ) {
V_123 [ V_188 ] =
F_23 ( F_59 ( V_165 [ V_187 ] ) ) * V_177 ;
}
if ( V_165 [ V_189 ] ) {
V_123 [ V_144 ] =
F_23 ( F_59 ( V_165 [ V_189 ] ) ) * V_177 ;
}
if ( V_165 [ V_190 ] ) {
V_123 [ V_145 ] =
F_23 ( F_59 ( V_165 [ V_190 ] ) ) * V_177 ;
}
return 0 ;
}
static int
F_60 ( struct V_1 * V_2 , const void * V_174 )
{
const unsigned int * V_123 = V_174 ;
if ( F_61 ( V_2 , V_176 ,
F_15 ( V_123 [ V_89 ] / V_177 ) ) ||
F_61 ( V_2 , V_178 ,
F_15 ( V_123 [ V_91 ] / V_177 ) ) ||
F_61 ( V_2 , V_179 ,
F_15 ( V_123 [ V_147 ] / V_177 ) ) ||
F_61 ( V_2 , V_180 ,
F_15 ( V_123 [ V_142 ] / V_177 ) ) ||
F_61 ( V_2 , V_181 ,
F_15 ( V_123 [ V_182 ] / V_177 ) ) ||
F_61 ( V_2 , V_183 ,
F_15 ( V_123 [ V_184 ] / V_177 ) ) ||
F_61 ( V_2 , V_185 ,
F_15 ( V_123 [ V_128 ] / V_177 ) ) ||
F_61 ( V_2 , V_186 ,
F_15 ( V_123 [ V_137 ] / V_177 ) ) ||
F_61 ( V_2 , V_187 ,
F_15 ( V_123 [ V_188 ] / V_177 ) ) ||
F_61 ( V_2 , V_189 ,
F_15 ( V_123 [ V_144 ] / V_177 ) ) ||
F_61 ( V_2 , V_190 ,
F_15 ( V_123 [ V_145 ] / V_177 ) ) )
goto V_157;
return 0 ;
V_157:
return - V_191 ;
