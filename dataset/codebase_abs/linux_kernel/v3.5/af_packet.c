...
F_160 ( sizeof( * F_129 ( V_135 ) ) + V_260 - 8 >
sizeof( V_135 -> V_261 ) ) ;
...
V_248 -> V_270 = F_161 ( V_135 , V_248 -> V_271 ) ;
F_129 ( V_135 ) -> V_272 = V_135 -> V_140 ;
if ( F_162 ( V_135 , V_251 ) )
goto V_258;
F_163 ( V_135 , V_3 ) ;
V_135 -> V_50 = NULL ;
F_127 ( V_135 ) ;
...
unsigned int V_289 = F_156 ( V_135 ) ;
...
memcpy ( & V_461 . V_85 , & V_4 -> V_113 ,
sizeof( struct V_458 ) ) ;
V_461 . V_85 . V_86 =
V_4 -> V_84 . V_85 . V_86 ;
V_461 . V_85 . V_273 += V_4 -> V_113 . V_114 ;
V_43 = & V_461 . V_85 ;
} else {
V_457 = sizeof( struct V_458 ) ;
V_459 = V_4 -> V_113 ;
V_459 . V_273 += V_459 . V_114 ;
V_43 = & V_459 ;
}
memset ( & V_4 -> V_113 , 0 , sizeof( V_459 ) ) ;
F_201 ( & V_3 -> V_94 . V_41 ) ;
break;
case V_410 :
V_449 = V_4 -> V_407 ;
...
static int F_256 ( struct V_465 * V_466 , unsigned long V_205 , void * V_43 )
{
struct V_2 * V_3 ;
struct V_467 * V_468 ;
...
static int F_258 ( struct V_203 * V_2 , unsigned int V_473 ,
unsigned long V_474 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
switch ( V_473 ) {
...
{
int V_476 = F_259 ( V_3 ) ;
return F_254 ( V_476 , ( int T_7 * ) V_474 ) ;
}
case V_477 :
{
struct V_141 * V_135 ;
...
case V_478 :
return F_260 ( V_3 , (struct V_281 T_7 * ) V_474 ) ;
case V_479 :
return F_261 ( V_3 , (struct V_123 T_7 * ) V_474 ) ;
#ifdef F_262
case V_480 :
case V_481 :
case V_482 :
...
static unsigned int F_263 ( struct V_497 * V_497 , struct V_203 * V_2 ,
T_8 * V_498 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
unsigned int V_499 = F_264 ( V_497 , V_2 , V_498 ) ;
F_198 ( & V_3 -> V_94 . V_41 ) ;
if ( V_4 -> V_40 . V_29 ) {
...
F_201 ( & V_3 -> V_94 . V_41 ) ;
F_198 ( & V_3 -> V_502 . V_41 ) ;
if ( V_4 -> V_36 . V_29 ) {
if ( F_23 ( V_4 , & V_4 -> V_36 , V_311 ) )
V_499 |= V_503 | V_504 ;
}
F_201 ( & V_3 -> V_502 . V_41 ) ;
return V_499 ;
}
static void F_265 ( struct V_505 * V_506 )
{
...
static void F_266 ( struct V_505 * V_506 )
{
struct V_497 * V_497 = V_506 -> V_507 ;
struct V_203 * V_2 = V_497 -> V_508 ;
struct V_2 * V_3 = V_2 -> V_3 ;
...
static void F_267 ( struct V_70 * V_29 , unsigned int V_510 ,
unsigned int V_140 )
{
int V_173 ;
...
static char * F_271 ( unsigned long V_510 )
{
char * V_30 = NULL ;
T_9 V_511 = V_182 | V_512 |
V_513 | V_514 | V_515 ;
V_30 = ( char * ) F_272 ( V_511 , V_510 ) ;
if ( V_30 )
return V_30 ;
V_30 = F_273 ( ( 1 << V_510 ) * V_104 ) ;
if ( V_30 )
return V_30 ;
V_511 &= ~ V_515 ;
V_30 = ( char * ) F_272 ( V_511 , V_510 ) ;
...
static struct V_70 * F_274 ( struct V_516 * V_447 , int V_510 )
{
unsigned int V_517 = V_447 -> V_79 ;
struct V_70 * V_29 ;
int V_173 ;
V_29 = F_275 ( V_517 , sizeof( struct V_70 ) , V_182 ) ;
if ( F_35 ( ! V_29 ) )
goto V_95;
for ( V_173 = 0 ; V_173 < V_517 ; V_173 ++ ) {
V_29 [ V_173 ] . V_30 = F_271 ( V_510 ) ;
...
T_6 V_151 ;
int V_56 = - V_178 ;
struct V_516 * V_447 = & V_66 -> V_447 ;
if ( ! V_519 && V_36 && ( V_4 -> V_18 > V_21 ) ) {
F_17 ( 1 , L_9 ) ;
goto V_95;
}
V_24 = V_36 ? & V_4 -> V_36 : & V_4 -> V_40 ;
V_38 = V_36 ? & V_3 -> V_502 : & V_3 -> V_94 ;
V_56 = - V_329 ;
if ( ! V_519 ) {
if ( F_47 ( & V_4 -> V_509 ) )
goto V_95;
...
goto V_95;
if ( F_35 ( V_447 -> V_524 < V_4 -> V_81 +
V_4 -> V_288 ) )
goto V_95;
if ( F_35 ( V_447 -> V_524 & ( V_525 - 1 ) ) )
goto V_95;
V_24 -> V_28 = V_447 -> V_77 / V_447 -> V_524 ;
if ( F_35 ( V_24 -> V_28 <= 0 ) )
goto V_95;
...
goto V_95;
V_56 = - V_181 ;
V_510 = F_276 ( V_447 -> V_77 ) ;
V_29 = F_274 ( V_447 , V_510 ) ;
if ( F_35 ( ! V_29 ) )
goto V_95;
switch ( V_4 -> V_18 ) {
case V_22 :
...
V_56 = - V_329 ;
F_111 ( & V_4 -> V_328 ) ;
if ( V_519 || F_47 ( & V_4 -> V_509 ) == 0 ) {
V_56 = 0 ;
F_198 ( & V_38 -> V_41 ) ;
F_277 ( V_24 -> V_29 , V_29 ) ;
V_24 -> V_143 = ( V_447 -> V_526 - 1 ) ;
V_24 -> V_32 = 0 ;
V_24 -> V_31 = V_447 -> V_524 ;
F_201 ( & V_38 -> V_41 ) ;
F_277 ( V_24 -> V_527 , V_510 ) ;
F_277 ( V_24 -> V_528 , V_447 -> V_79 ) ;
V_24 -> V_529 = V_447 -> V_77 / V_104 ;
...
F_209 ( V_3 ) ;
if ( V_29 )
F_267 ( V_29 , V_510 , V_447 -> V_79 ) ;
V_95:
return V_56 ;
}
static int F_278 ( struct V_497 * V_497 , struct V_203 * V_2 ,
struct V_505 * V_506 )
{
struct V_2 * V_3 = V_2 -> V_3 ;
struct V_1 * V_4 = F_1 ( V_3 ) ;
...
if ( V_24 -> V_29 == NULL )
continue;
for ( V_173 = 0 ; V_173 < V_24 -> V_528 ; V_173 ++ ) {
struct V_320 * V_320 ;
void * V_535 = V_24 -> V_29 [ V_173 ] . V_30 ;
int V_536 ;
for ( V_536 = 0 ; V_536 < V_24 -> V_529 ; V_536 ++ ) {
V_320 = F_16 ( V_535 ) ;
V_56 = F_279 ( V_506 , V_102 , V_320 ) ;
if ( F_35 ( V_56 ) )
goto V_95;
V_102 += V_104 ;
V_535 += V_104 ;
...
static void * F_280 ( struct V_539 * V_540 , T_10 * V_541 )
__acquires( T_11 )
{
struct V_167 * V_167 = F_281 ( V_540 ) ;
F_135 () ;
return F_282 ( & V_167 -> V_364 . V_387 , * V_541 ) ;
}
static void * F_283 ( struct V_539 * V_540 , void * V_542 , T_10 * V_541 )
{
struct V_167 * V_167 = F_281 ( V_540 ) ;
return F_284 ( V_542 , & V_167 -> V_364 . V_387 , V_541 ) ;
}
static void F_285 ( struct V_539 * V_540 , void * V_542 )
__releases( T_11 )
{
F_139 () ;
}
static int F_286 ( struct V_539 * V_540 , void * V_542 )
{
if ( V_542 == V_543 )
F_287 ( V_540 , L_11 ) ;
else {
struct V_2 * V_544 = F_288 ( V_542 ) ;
...
static int F_292 ( struct V_546 * V_546 , struct V_497 * V_497 )
{
return F_293 ( V_546 , V_497 , & V_547 ,
sizeof( struct V_548 ) ) ;
}
