...
static int T_5 F_38 ( const struct V_50 * V_51 )
{
F_20 ( L_6 , V_51 -> V_52 ) ;
return 1 ;
}
static int T_5 F_39 ( const struct V_50 * V_51 )
{
V_16 = ( unsigned long ) V_51 -> V_53 ;
F_20 ( L_7 , V_16 ) ;
return F_38 ( V_51 ) ;
}
...
if ( V_7 )
goto V_60;
V_61 = F_45 ( L_9 , - 1 , NULL , 0 ) ;
if ( F_46 ( V_61 ) ) {
V_7 = F_47 ( V_61 ) ;
goto V_62;
}
V_7 = F_48 ( & V_61 -> V_29 . V_63 , & V_64 ) ;
if ( V_7 )
goto V_65;
V_66 = F_49 () ;
if ( ! V_66 ) {
...
V_54 -> V_73 = L_10 ;
V_54 -> V_51 . V_74 = V_75 ;
V_54 -> V_29 . V_76 = & V_61 -> V_29 ;
V_54 -> V_77 [ 0 ] = F_50 ( V_78 ) ;
F_51 ( V_54 , V_35 ,
- 256 , 256 , V_79 , V_80 ) ;
F_51 ( V_54 , V_36 ,
- 256 , 256 , V_79 , V_80 ) ;
