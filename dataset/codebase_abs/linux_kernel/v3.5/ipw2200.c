...
F_196 ( V_23 , V_387 + V_7 , V_23 -> V_123 [ V_7 ] ) ;
F_35 ( V_23 , V_388 , 0 ) ;
} else {
F_74 ( L_152 ) ;
F_35 ( V_23 , V_388 , 1 ) ;
...
static void F_197 ( struct V_17 * V_23 , T_3 V_389 , T_3 V_2 )
{
V_2 >>= 2 ;
if ( ! V_2 )
return;
...
static inline void F_198 ( struct V_17 * V_23 )
{
F_197 ( V_23 , V_390 ,
V_391 *
sizeof( struct V_392 ) ) ;
}
static int F_199 ( struct V_17 * V_23 )
{
F_146 ( L_154 ) ;
F_198 ( V_23 ) ;
...
static void F_200 ( struct V_17 * V_23 )
{
T_3 V_394 = 0 ;
F_146 ( L_154 ) ;
V_394 = V_395 | V_396 ;
...
static int F_201 ( struct V_17 * V_23 , int V_400 ,
struct V_392 * V_401 )
{
T_3 V_402 =
V_390 +
...
F_146 ( L_154 ) ;
F_202 ( V_23 , V_402 , ( T_2 * ) V_401 ,
( int ) sizeof( struct V_392 ) ) ;
F_146 ( L_155 ) ;
return 0 ;
}
static int F_203 ( struct V_17 * V_23 )
{
T_3 V_394 = 0 ;
T_3 V_400 = 0 ;
F_146 ( L_154 ) ;
...
static void F_204 ( struct V_17 * V_23 )
{
T_3 V_402 ;
T_3 V_408 = 0 ;
T_3 V_409 = 0 ;
...
static int F_208 ( struct V_17 * V_23 , T_9 * V_413 ,
...
F_210 (element, safe, &priv->ieee->network_list) {
V_441 = F_211 ( V_438 , struct V_440 , V_442 ) ;
...
static inline int F_214 ( struct V_17 * V_23 )
{
return F_36 ( V_23 , 0x90 ) == 0xd55555d5 ;
}
static int F_215 ( struct V_17 * V_23 , T_3 V_32 , T_3 V_36 ,
int V_444 )
{
int V_7 = 0 ;
do {
...
static int F_217 ( struct V_17 * V_23 )
{
int V_155 ;
F_195 ( L_150 ) ;
F_34 ( V_23 , V_404 , V_406 ) ;
V_155 = F_215 ( V_23 , V_404 ,
V_405 , 100 ) ;
if ( V_155 < 0 ) {
F_46 ( L_170 ) ;
return - 1 ;
...
static void F_218 ( struct V_17 * V_23 )
{
F_195 ( L_150 ) ;
F_216 ( 5 ) ;
...
static int F_219 ( struct V_17 * V_23 , T_2 * V_3 , T_1 V_4 )
{
...
V_473 = F_223 ( L_176 , V_23 -> V_477 , V_433 , 0 , 0 ) ;
if ( ! V_473 ) {
F_46 ( L_177 ) ;
F_87 ( V_475 ) ;
F_87 ( V_474 ) ;
...
V_478 = F_225 ( V_470 -> V_415 ) ;
V_389 = V_3 + V_468 ;
V_431 = ( V_478 + V_433 - 1 ) / V_433 ;
for ( V_7 = 0 ; V_7 < V_431 ; V_7 ++ ) {
V_474 [ V_471 ] = F_226 ( V_473 , V_148 ,
& V_475 [ V_471 ] ) ;
if ( ! V_474 [ V_471 ] ) {
V_432 = - V_476 ;
goto V_6;
...
V_432 = F_208 ( V_23 , & V_475 [ V_471 - V_431 ] ,
V_431 , F_225 ( V_470 -> V_402 ) ,
V_478 ) ;
if ( V_432 ) {
F_74 ( L_178 ) ;
goto V_6;
...
F_227 ( V_473 , V_474 [ V_7 ] , V_475 [ V_7 ] ) ;
F_228 ( V_473 ) ;
F_87 ( V_475 ) ;
F_87 ( V_474 ) ;
return V_432 ;
}
static int F_229 ( struct V_17 * V_23 )
{
int V_155 = 0 ;
...
static void F_230 ( struct V_17 * V_23 )
{
F_195 ( L_150 ) ;
F_37 ( V_23 , V_404 ,
V_405 |
...
struct V_489 * V_490 ;
int V_155 ;
V_155 = F_234 ( V_488 , V_158 , & V_23 -> V_477 -> V_166 ) ;
if ( V_155 < 0 ) {
...
if ( ( * V_488 ) -> V_15 < sizeof( * V_490 ) + F_225 ( V_490 -> V_491 ) +
F_225 ( V_490 -> V_492 ) + F_225 ( V_490 -> V_493 ) ) {
F_46 ( L_185 ,
V_158 , ( * V_488 ) -> V_15 ) ;
return - V_75 ;
}
F_74 ( L_186 ,
V_158 ,
F_225 ( V_490 -> V_494 ) >> 16 ,
F_225 ( V_490 -> V_494 ) & 0xff ,
( * V_488 ) -> V_15 - sizeof( * V_490 ) ) ;
return 0 ;
}
static void F_235 ( struct V_17 * V_23 ,
struct V_495 * V_496 )
{
unsigned long V_41 ;
int V_7 ;
...
F_237 ( V_23 -> V_477 , V_496 -> V_473 [ V_7 ] . V_502 ,
V_503 , V_504 ) ;
F_238 ( V_496 -> V_473 [ V_7 ] . V_501 ) ;
V_496 -> V_473 [ V_7 ] . V_501 = NULL ;
}
F_213 ( & V_496 -> V_473 [ V_7 ] . V_442 , & V_496 -> V_498 ) ;
}
...
static int F_241 ( struct V_17 * V_23 )
{
#ifndef F_242
...
V_490 = ( void * ) V_488 -> V_3 ;
V_509 = & V_490 -> V_3 [ 0 ] ;
V_510 = & V_490 -> V_3 [ F_225 ( V_490 -> V_491 ) ] ;
V_511 = & V_490 -> V_3 [ F_225 ( V_490 -> V_491 ) +
F_225 ( V_490 -> V_492 ) ] ;
if ( V_155 < 0 )
goto error;
if ( ! V_23 -> V_496 )
V_23 -> V_496 = F_244 ( V_23 ) ;
else
F_235 ( V_23 , V_23 -> V_496 ) ;
if ( ! V_23 -> V_496 ) {
F_46 ( L_190 ) ;
goto error;
}
...
F_197 ( V_23 , V_518 ,
V_519 - V_518 ) ;
V_155 = F_222 ( V_23 , V_509 , F_225 ( V_490 -> V_491 ) ) ;
if ( V_155 < 0 ) {
F_46 ( L_192 , V_155 ) ;
goto error;
}
F_230 ( V_23 ) ;
V_155 = F_215 ( V_23 , V_222 ,
V_237 , 500 ) ;
if ( V_155 < 0 ) {
F_46 ( L_193 ) ;
goto error;
...
V_155 = F_219 ( V_23 , V_510 , F_225 ( V_490 -> V_492 ) ) ;
if ( V_155 < 0 ) {
F_46 ( L_195 , V_155 ) ;
goto error;
}
F_229 ( V_23 ) ;
V_155 = F_222 ( V_23 , V_511 , F_225 ( V_490 -> V_493 ) ) ;
if ( V_155 < 0 ) {
F_46 ( L_196 , V_155 ) ;
goto error;
}
...
static int F_249 ( const struct V_495 * V_521 )
{
...
static inline int F_250 ( const struct V_523 * V_521 )
{
...
static inline int F_251 ( int V_400 , int V_526 )
{
return ( ++ V_400 == V_526 ) ? 0 : V_400 ;
}
static void F_252 ( struct V_17 * V_23 , struct V_523 * V_521 ,
...
static int F_253 ( struct V_17 * V_23 ,
struct V_531 * V_521 ,
int V_2 , T_3 V_505 , T_3 V_506 , T_3 V_137 , T_3 V_15 )
{
...
V_521 -> V_533 =
F_254 ( V_166 , sizeof( V_521 -> V_533 [ 0 ] ) * V_2 , & V_521 -> V_521 . V_502 ) ;
if ( ! V_521 -> V_533 ) {
F_46 ( L_203 ,
...
F_252 ( V_23 , & V_521 -> V_521 , V_2 , V_505 , V_506 , V_137 , V_15 ) ;
return 0 ;
}
static void F_255 ( struct V_17 * V_23 ,
struct V_531 * V_230 )
{
...
return;
if ( F_225 ( V_533 -> V_538 . V_3 . V_539 ) > V_540 ) {
F_46 ( L_204 ,
F_225 ( V_533 -> V_538 . V_3 . V_539 ) ) ;
return;
}
for ( V_7 = 0 ; V_7 < F_225 ( V_533 -> V_538 . V_3 . V_539 ) ; V_7 ++ ) {
F_237 ( V_166 , F_225 ( V_533 -> V_538 . V_3 . V_541 [ V_7 ] ) ,
F_220 ( V_533 -> V_538 . V_3 . V_478 [ V_7 ] ) ,
V_542 ) ;
if ( V_230 -> V_532 [ V_230 -> V_521 . V_524 ] ) {
F_256 ( V_230 -> V_532 [ V_230 -> V_521 . V_524 ] ) ;
V_230 -> V_532 [ V_230 -> V_521 . V_524 ] = NULL ;
}
}
}
static void F_257 ( struct V_17 * V_23 , struct V_531 * V_230 )
{
...
V_521 -> V_524 = F_251 ( V_521 -> V_524 , V_521 -> V_526 ) ) {
F_255 ( V_23 , V_230 ) ;
}
F_258 ( V_166 , sizeof( V_230 -> V_533 [ 0 ] ) * V_521 -> V_526 , V_230 -> V_533 ,
V_521 -> V_502 ) ;
F_87 ( V_230 -> V_532 ) ;
memset ( V_230 , 0 , sizeof( * V_230 ) ) ;
}
static void F_248 ( struct V_17 * V_23 )
{
F_257 ( V_23 , & V_23 -> V_226 ) ;
F_257 ( V_23 , & V_23 -> V_230 [ 0 ] ) ;
F_257 ( V_23 , & V_23 -> V_230 [ 1 ] ) ;
F_257 ( V_23 , & V_23 -> V_230 [ 2 ] ) ;
F_257 ( V_23 , & V_23 -> V_230 [ 3 ] ) ;
}
static void F_259 ( struct V_17 * V_23 , T_2 * V_216 )
{
...
static void F_262 ( struct V_17 * V_23 , int V_556 )
{
int V_557 ;
if ( V_23 -> V_37 & V_240 ) {
F_263 ( L_206 ) ;
...
static const char * F_269 ( T_4 V_37 )
{
int V_7 ;
for ( V_7 = 0 ; V_7 < F_221 ( V_569 ) ; V_7 ++ )
if ( V_569 [ V_7 ] . V_37 == ( V_37 & 0xff ) )
return V_569 [ V_7 ] . V_570 ;
return L_211 ;
}
static void inline F_270 ( struct V_571 * V_572 )
{
memset ( V_572 , 0 , sizeof( * V_572 ) ) ;
}
static T_10 F_271 ( T_10 V_573 , T_10 V_21 , T_2 V_574 )
{
return ( ( V_574 - 1 ) * V_573 + V_21 ) / V_574 ;
}
static void F_272 ( struct V_571 * V_572 , T_10 V_21 )
{
...
static T_10 F_273 ( struct V_571 * V_572 )
{
if ( ! F_29 ( V_572 -> V_578 ) ) {
if ( V_572 -> V_194 )
...
static void F_274 ( struct V_17 * V_23 )
{
T_3 V_4 = sizeof( T_3 ) ;
V_23 -> V_579 = 0 ;
F_270 ( & V_23 -> V_580 ) ;
...
if ( V_23 -> V_559 . V_640 ) {
V_630 = V_631 *
( V_192 * F_220 ( V_23 -> V_559 . V_640 ) ) /
( V_641 * 10 ) ;
} else {
V_630 = 0 ;
}
F_272 ( & V_23 -> V_580 , V_630 ) ;
...
V_633 = ( V_633 - F_278 ) * 100 /
( 100 - F_278 ) ;
F_279 ( L_213 ,
V_633 , V_630 ) ;
V_23 -> V_583 = F_276 ( V_23 ) ;
V_638 = F_275 ( V_23 ) ;
...
static void F_280 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
static void F_281 ( struct V_17 * V_23 ,
int V_645 )
{
V_23 -> V_646 = V_645 ;
if ( V_645 > V_23 -> V_647 &&
...
if ( V_23 -> V_37 & V_321 &&
V_645 > V_656 ) {
F_282 ( V_648 | V_649 | V_650 ,
L_224 ) ;
F_128 ( & V_23 -> V_653 ) ;
}
F_283 ( L_228 , V_645 ) ;
}
static void F_284 ( struct V_106 * V_107 )
{
union V_210 V_211 ;
struct V_17 * V_23 =
...
static void F_285 ( struct V_17 * V_23 )
{
if ( ! V_23 -> V_658 ) {
if ( ! F_286 ( & V_23 -> V_189 ) )
F_56 ( & V_23 -> V_189 ,
...
{
F_289 ( V_311 ) ;
T_4 V_15 = F_220 ( V_659 -> V_15 ) ;
F_283 ( L_229 , V_659 -> V_660 , V_15 ) ;
switch ( V_659 -> V_660 ) {
case V_661 : {
struct V_662 * V_663 = & V_659 -> V_538 . V_663 ;
switch ( V_663 -> V_664 ) {
case V_665 : {
F_282 ( V_649 | V_650 |
V_651 ,
L_230 ,
F_290 ( V_311 , V_23 -> V_666 ,
V_23 -> V_667 ) ,
V_23 -> V_216 ) ;
switch ( V_23 -> V_163 -> V_513 ) {
case V_516 :
...
case V_682 : {
struct V_677 * V_678 = & V_659 -> V_538 . V_678 ;
switch ( V_678 -> V_664 ) {
case V_676 :
F_282 ( V_649 | V_650 ,
L_237 ,
...
case V_696 : {
struct V_697 * T_11 = & V_659 -> V_538 . V_698 ;
if ( V_15 == sizeof( * T_11 ) ) {
F_166
( L_258
L_259 , T_11 -> V_699 ,
...
V_23 -> V_37 &= ~ V_652 ;
} else if ( V_23 -> V_37 & V_706 )
F_56 ( & V_23 -> V_186 , 0 ) ;
else if ( V_23 -> V_59 & V_707
&& V_23 -> V_37 & V_103 )
F_56 ( & V_23 -> V_186 ,
F_129 ( V_192 ) ) ;
if ( T_11 -> V_37 == V_704 )
...
case V_708 : {
struct V_709 * T_11 = & V_659 -> V_538 . V_710 ;
if ( V_15 == sizeof( * T_11 ) )
F_46 ( L_261 ,
F_220 ( T_11 -> V_711 ) ) ;
else
...
F_46 ( L_265 ) ;
if ( V_23 -> V_719
&& V_23 -> V_719 -> V_153 != V_720 )
F_46 ( L_266 ) ;
break;
}
case V_721 : {
struct V_722 * T_11 = & V_659 -> V_538 . V_723 ;
if ( V_15 != sizeof( * T_11 ) ) {
F_46
( L_267
...
case V_726 : {
struct V_727 * T_11 = & V_659 -> V_538 . V_728 ;
if ( V_15 == sizeof( * T_11 ) ) {
F_46 ( L_269
L_270 ,
T_11 -> V_729 , T_11 -> V_730 ,
T_11 -> V_731 ) ;
break;
}
F_46
...
case V_732 : {
struct V_733 * T_11 = & V_659 -> V_538 . V_734 ;
if ( V_15 == sizeof( * T_11 ) ) {
...
V_23 -> V_582 =
F_271 ( V_23 -> V_582 ,
( T_2 ) ( F_225 ( V_659 -> V_538 . V_736 . V_25 ) & 0xff ) ,
V_737 ) ;
break;
}
F_46
...
F_283 ( L_275
L_276 ,
V_659 -> V_660 , V_659 -> V_41 , V_15 ) ;
}
}
static int F_245 ( struct V_17 * V_23 )
{
int V_155 = 0 ;
int V_738 = 64 , V_739 = 8 ;
F_248 ( V_23 ) ;
V_155 = F_253 ( V_23 , & V_23 -> V_226 , V_739 ,
V_740 ,
V_741 ,
V_742 ,
V_743 ) ;
...
V_155 = F_253 ( V_23 , & V_23 -> V_230 [ 0 ] , V_738 ,
V_744 ,
V_745 ,
V_746 , V_747 ) ;
if ( V_155 ) {
...
V_155 = F_253 ( V_23 , & V_23 -> V_230 [ 1 ] , V_738 ,
V_748 ,
V_749 ,
V_750 , V_751 ) ;
if ( V_155 ) {
...
V_155 = F_253 ( V_23 , & V_23 -> V_230 [ 2 ] , V_738 ,
V_752 ,
V_753 ,
V_754 , V_755 ) ;
if ( V_155 ) {
...
V_155 = F_253 ( V_23 , & V_23 -> V_230 [ 3 ] , V_738 ,
V_756 ,
V_757 ,
V_758 , V_759 ) ;
if ( V_155 ) {
...
struct V_531 * V_230 , int V_762 )
{
T_3 V_763 ;
int V_764 ;
struct V_523 * V_521 = & V_230 -> V_521 ;
V_763 = F_36 ( V_23 , V_521 -> V_529 ) ;
if ( V_763 >= V_521 -> V_526 ) {
F_46
( L_282 ,
V_763 , V_521 -> V_526 ) ;
goto V_765;
}
for (; V_521 -> V_524 != V_763 ;
V_521 -> V_524 = F_251 ( V_521 -> V_524 , V_521 -> V_526 ) ) {
F_255 ( V_23 , V_230 ) ;
V_23 -> V_592 ++ ;
}
V_765:
if ( ( F_250 ( V_521 ) > V_521 -> V_527 ) &&
( V_762 >= 0 ) )
F_295 ( V_23 -> V_167 ) ;
V_764 = V_521 -> V_525 - V_521 -> V_524 ;
if ( V_764 < 0 )
V_764 += V_521 -> V_526 ;
return V_764 ;
}
static int F_151 ( struct V_17 * V_23 , int V_719 , void * V_1 ,
int V_4 , int V_766 )
{
struct V_531 * V_230 = & V_23 -> V_226 ;
struct V_523 * V_521 = & V_230 -> V_521 ;
struct V_534 * V_767 ;
if ( F_250 ( V_521 ) < ( V_766 ? 1 : 2 ) ) {
F_46 ( L_283 ) ;
return - V_768 ;
}
V_767 = & V_230 -> V_533 [ V_521 -> V_525 ] ;
V_230 -> V_532 [ V_521 -> V_525 ] = NULL ;
memset ( V_767 , 0 , sizeof( * V_767 ) ) ;
V_767 -> V_535 . V_536 = V_537 ;
V_767 -> V_535 . V_769 = V_770 ;
V_23 -> V_771 ++ ;
V_767 -> V_538 . V_153 . V_400 = V_719 ;
V_767 -> V_538 . V_153 . V_415 = V_4 ;
memcpy ( V_767 -> V_538 . V_153 . V_142 , V_1 , V_4 ) ;
V_521 -> V_525 = F_251 ( V_521 -> V_525 , V_521 -> V_526 ) ;
...
F_41 ( & V_496 -> V_98 , V_41 ) ;
V_506 = V_496 -> V_506 ;
while ( ( F_249 ( V_496 ) > 0 ) && ( V_496 -> V_507 ) ) {
V_438 = V_496 -> V_497 . V_774 ;
V_773 = F_211 ( V_438 , struct V_772 , V_442 ) ;
F_212 ( V_438 ) ;
F_35 ( V_23 , V_775 + V_496 -> V_506 * V_776 ,
V_773 -> V_502 ) ;
V_496 -> V_777 [ V_496 -> V_506 ] = V_773 ;
V_496 -> V_506 = ( V_496 -> V_506 + 1 ) % V_500 ;
V_496 -> V_507 -- ;
}
F_42 ( & V_496 -> V_98 , V_41 ) ;
if ( V_496 -> V_507 <= V_778 )
F_128 ( & V_23 -> V_779 ) ;
if ( V_506 != V_496 -> V_506 )
F_35 ( V_23 , V_780 , V_496 -> V_506 ) ;
}
static void F_246 ( void * V_3 )
{
struct V_17 * V_23 = V_3 ;
struct V_495 * V_496 = V_23 -> V_496 ;
struct V_437 * V_438 ;
...
V_438 = V_496 -> V_498 . V_774 ;
V_773 = F_211 ( V_438 , struct V_772 , V_442 ) ;
V_773 -> V_501 = F_298 ( V_503 , V_139 ) ;
if ( ! V_773 -> V_501 ) {
F_4 ( V_781 L_284 ,
V_23 -> V_167 -> V_158 ) ;
break;
...
F_212 ( V_438 ) ;
V_773 -> V_502 =
F_299 ( V_23 -> V_477 , V_773 -> V_501 -> V_3 ,
V_503 , V_504 ) ;
F_213 ( & V_773 -> V_442 , & V_496 -> V_497 ) ;
V_496 -> V_507 ++ ;
}
F_42 ( & V_496 -> V_98 , V_41 ) ;
F_296 ( V_23 ) ;
...
{
struct V_17 * V_23 =
F_58 ( V_107 , struct V_17 , V_779 ) ;
F_59 ( & V_23 -> V_109 ) ;
F_246 ( V_23 ) ;
F_60 ( & V_23 -> V_109 ) ;
}
static void F_247 ( struct V_17 * V_23 , struct V_495 * V_496 )
{
int V_7 ;
if ( ! V_496 )
return;
...
static struct V_495 * F_244 ( struct V_17 * V_23 )
{
struct V_495 * V_496 ;
int V_7 ;
...
V_795 = F_3 ( V_441 -> V_796 , ( T_2 ) V_797 ) ;
V_336 -> V_795 = 0 ;
for ( V_7 = 0 ; V_7 < V_795 ; V_7 ++ ) {
if ( ! F_302 ( V_23 , V_441 -> V_118 ,
V_441 -> V_336 [ V_7 ] ) ) {
if ( V_441 -> V_336 [ V_7 ] & V_782 ) {
F_166 ( L_286
L_287 ,
V_441 -> V_336 [ V_7 ] ) ;
V_336 -> V_798 [ V_336 -> V_795 ++ ] =
V_441 -> V_336 [ V_7 ] ;
continue;
}
F_166 ( L_288 ,
...
V_336 -> V_798 [ V_336 -> V_795 ++ ] = V_441 -> V_336 [ V_7 ] ;
}
V_795 = F_3 ( V_441 -> V_799 ,
( T_2 ) ( V_797 - V_795 ) ) ;
for ( V_7 = 0 ; V_7 < V_795 ; V_7 ++ ) {
if ( ! F_302 ( V_23 , V_441 -> V_118 ,
V_441 -> V_800 [ V_7 ] ) ) {
if ( V_441 -> V_800 [ V_7 ] & V_782 ) {
F_166 ( L_286
L_287 ,
V_441 -> V_800 [ V_7 ] ) ;
V_336 -> V_798 [ V_336 -> V_795 ++ ] =
...
static void F_304 ( struct V_335 * V_801 ,
const struct V_335 * V_802 )
{
T_2 V_7 ;
for ( V_7 = 0 ; V_7 < V_802 -> V_795 ; V_7 ++ )
V_801 -> V_798 [ V_7 ] = V_802 -> V_798 [ V_7 ] ;
V_801 -> V_795 = V_802 -> V_795 ;
}
static void F_305 ( struct V_335 * V_336 ,
T_2 V_803 , T_3 V_804 )
{
T_2 V_805 = ( V_806 == V_803 ) ?
V_782 : 0 ;
if ( V_804 & V_596 )
V_336 -> V_798 [ V_336 -> V_795 ++ ] =
V_782 | V_791 ;
...
F_308 ( L_289
L_290 ,
F_290 ( V_311 , V_441 -> V_311 ,
V_441 -> V_809 ) ,
V_441 -> V_216 ) ;
return 0 ;
}
if ( F_29 ( V_654 ) ) {
if ( ( V_441 -> V_809 != V_808 -> V_441 -> V_809 ) ||
memcmp ( V_441 -> V_311 , V_808 -> V_441 -> V_311 ,
V_441 -> V_809 ) ) {
F_308 ( L_291
L_292 ,
F_290 ( V_311 , V_441 -> V_311 ,
...
if ( ( V_23 -> V_59 & V_810 ) &&
( ( V_441 -> V_809 != V_23 -> V_667 ) ||
memcmp ( V_441 -> V_311 , V_23 -> V_666 ,
F_3 ( V_441 -> V_809 , V_23 -> V_667 ) ) ) ) {
char V_811 [ V_313 * 2 + 1 ] ;
strncpy ( V_811 ,
F_290 ( V_311 , V_441 -> V_311 ,
V_441 -> V_809 ) ,
sizeof( V_811 ) ) ;
...
if ( V_441 -> V_467 [ 0 ] < V_808 -> V_441 -> V_467 [ 0 ] ) {
F_308 ( L_294
L_295 ,
F_290 ( V_311 , V_808 -> V_441 -> V_311 ,
V_808 -> V_441 -> V_809 ) ) ;
return 0 ;
} else if ( V_441 -> V_467 [ 1 ] < V_808 -> V_441 -> V_467 [ 1 ] ) {
F_308 ( L_294
L_295 ,
F_290 ( V_311 , V_808 -> V_441 -> V_311 ,
V_808 -> V_441 -> V_809 ) ) ;
...
F_304 ( & V_808 -> V_336 , & V_336 ) ;
V_808 -> V_441 = V_441 ;
F_308 ( L_308 ,
F_290 ( V_311 , V_441 -> V_311 , V_441 -> V_809 ) ,
V_441 -> V_216 ) ;
return 1 ;
}
...
if ( V_441 != V_23 -> V_117 )
F_307 ( V_23 , & V_808 , V_441 ,
1 ) ;
}
F_42 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
if ( V_808 . V_441 == V_23 -> V_117 ) {
F_308 ( L_309
L_310 ) ;
return;
}
...
if ( V_808 -> V_441 && V_808 -> V_441 -> V_673 . V_632 > V_441 -> V_673 . V_632 ) {
char V_811 [ V_313 * 2 + 1 ] ;
strncpy ( V_811 ,
F_290 ( V_311 , V_441 -> V_311 , V_441 -> V_809 ) ,
sizeof( V_811 ) ) ;
...
V_441 -> V_197 = V_23 -> V_197 ;
V_23 -> V_59 |= V_550 ;
F_259 ( V_23 , V_441 -> V_216 ) ;
V_441 -> V_809 = V_23 -> V_667 ;
memcpy ( V_441 -> V_311 , V_23 -> V_666 , V_23 -> V_667 ) ;
memset ( & V_441 -> V_673 , 0 , sizeof( V_441 -> V_673 ) ) ;
V_441 -> V_317 = V_318 ;
if ( ! ( V_23 -> V_59 & V_821 ) )
V_441 -> V_317 |= V_822 ;
if ( V_23 -> V_317 & V_813 )
V_441 -> V_317 |= V_814 ;
V_441 -> V_796 = F_3 ( V_23 -> V_336 . V_795 , V_823 ) ;
memcpy ( V_441 -> V_336 , V_23 -> V_336 . V_798 , V_441 -> V_796 ) ;
V_441 -> V_799 = V_23 -> V_336 . V_795 - V_441 -> V_796 ;
memcpy ( V_441 -> V_800 ,
& V_23 -> V_336 . V_798 [ V_441 -> V_796 ] ,
V_441 -> V_799 ) ;
V_441 -> V_812 = 0 ;
V_441 -> V_41 = 0 ;
V_441 -> V_817 = 0 ;
...
F_56 ( & V_23 -> V_668 ,
F_220 ( V_23 -> V_559 . V_640 ) ) ;
}
static void F_322 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
F_58 ( V_107 , struct V_17 , V_668 . V_107 ) ;
F_59 ( & V_23 -> V_109 ) ;
F_321 ( V_23 ) ;
F_60 ( & V_23 -> V_109 ) ;
}
...
if ( V_23 -> V_59 & V_810 )
F_74 ( L_323 ,
F_290 ( V_311 , V_23 -> V_666 , V_23 -> V_667 ) ) ;
else
F_74 ( L_324 ) ;
if ( V_23 -> V_59 & V_818 )
...
&& ( V_23 -> V_59 & V_810 )
&& ( F_225 ( V_865 . V_874 ) % 2 ) ) ) {
V_557 = F_158 ( V_23 , V_23 -> V_666 , V_23 -> V_667 ) ;
if ( V_557 ) {
F_142 ( L_340
L_65 ) ;
goto V_765;
...
V_767 -> V_1013 &= ~ V_1014 ;
V_767 -> V_767 . V_1015 . V_1016 . V_1017 |= F_173 ( V_1018 ) ;
}
return 0 ;
}
...
if ( ! ( V_23 -> V_59 & V_810 ) ) {
V_23 -> V_667 = F_3 ( V_441 -> V_809 ,
( T_2 ) V_313 ) ;
memcpy ( V_23 -> V_666 , V_441 -> V_311 , V_23 -> V_667 ) ;
}
V_441 -> V_817 = V_140 ;
...
V_441 -> V_317 &
V_822 ? L_362 : L_361 ,
V_23 -> V_317 & V_813 ? L_363 : L_300 ,
V_23 -> V_317 & V_813 ?
( V_23 -> V_317 & V_1035 ? L_364 :
L_365 ) : L_108 ,
V_23 -> V_317 & V_813 ? L_366 : L_108 ,
V_23 -> V_317 & V_813 ?
...
if ( V_23 -> V_163 -> V_513 == V_514 ) {
memset ( & V_23 -> V_559 . V_801 , 0xFF , V_217 ) ;
V_23 -> V_559 . V_825 = F_173 ( V_441 -> V_825 ) ;
} else {
memcpy ( V_23 -> V_559 . V_801 , V_441 -> V_216 , V_217 ) ;
V_23 -> V_559 . V_825 = 0 ;
}
...
F_263 ( L_369 , V_441 -> V_673 . V_632 ) ;
V_557 = F_172 ( V_23 , V_441 -> V_673 . V_632 + V_1045 ) ;
if ( V_557 ) {
F_142 ( L_370 ) ;
return V_557 ;
}
...
if ( V_23 -> V_37 & V_103 ) {
unsigned long V_41 ;
T_2 V_632 = V_23 -> V_117 -> V_673 . V_632 ;
V_23 -> V_117 -> V_673 . V_632 = - 128 ;
F_41 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
F_312 (network, &priv->ieee->network_list, list) {
if ( V_441 != V_23 -> V_117 )
F_313 ( V_23 , & V_808 , V_441 , 1 ) ;
}
F_42 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
V_23 -> V_117 -> V_673 . V_632 = V_632 ;
if ( V_808 . V_441 == V_23 -> V_117 ) {
F_263 ( L_372
L_373 ) ;
V_23 -> V_37 &= ~ V_652 ;
...
F_303 ( V_23 , V_23 -> V_117 , & V_808 . V_336 ) ;
F_370 ( V_23 , V_23 -> V_117 , & V_808 . V_336 , 1 ) ;
V_23 -> V_37 &= ~ V_652 ;
}
static void F_372 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
F_58 ( V_107 , struct V_17 , V_705 ) ;
F_59 ( & V_23 -> V_109 ) ;
F_371 ( V_23 ) ;
F_60 ( & V_23 -> V_109 ) ;
}
...
if ( ! ( V_23 -> V_59 & V_1047 ) &&
! ( V_23 -> V_59 & ( V_810 | V_818 ) ) ) {
F_263 ( L_381 ) ;
return 0 ;
}
F_41 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
F_312 (network, &priv->ieee->network_list, list)
F_313 ( V_23 , & V_808 , V_441 , 0 ) ;
V_441 = V_808 . V_441 ;
V_336 = & V_808 . V_336 ;
if ( V_441 == NULL &&
V_23 -> V_163 -> V_513 == V_514 &&
...
F_263 ( L_382
L_383 ,
F_290 ( V_311 , V_1050 -> V_311 ,
V_1050 -> V_809 ) ,
V_1050 -> V_216 ) ;
F_213 ( & V_1050 -> V_442 ,
& V_23 -> V_163 -> V_443 ) ;
}
V_438 = V_23 -> V_163 -> V_443 . V_774 ;
V_441 = F_211 ( V_438 , struct V_440 , V_442 ) ;
F_314 ( V_23 , V_441 ) ;
V_336 = & V_23 -> V_336 ;
F_212 ( V_438 ) ;
F_213 ( & V_441 -> V_442 , & V_23 -> V_163 -> V_1051 ) ;
}
F_42 ( & V_23 -> V_163 -> V_98 , V_41 ) ;
if ( ! V_441 ) {
F_323 ( V_23 ) ;
...
struct V_165 * V_166 = V_23 -> V_167 ;
struct V_674 * V_1054 ;
struct V_1060 * V_1061 = (struct V_1060 * ) V_773 -> V_501 -> V_3 ;
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) + V_1064 ) >
F_377 ( V_773 -> V_501 ) ) ) {
V_166 -> V_673 . V_1065 ++ ;
...
F_379 ( V_773 -> V_501 , F_380 ( struct V_1060 , V_538 . V_1063 . V_3 ) ) ;
F_381 ( V_773 -> V_501 , F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) ) ;
F_382 ( L_387 , V_773 -> V_501 -> V_4 ) ;
V_1054 = (struct V_674 * ) V_773 -> V_501 -> V_3 ;
if ( V_23 -> V_163 -> V_513 != V_515 &&
( F_364 ( V_1054 -> V_1070 ) ?
! V_23 -> V_163 -> V_853 : ! V_23 -> V_163 -> V_845 ) )
F_374 ( V_23 , V_773 -> V_501 ) ;
if ( ! F_383 ( V_23 -> V_163 , V_773 -> V_501 , V_673 ) )
V_166 -> V_673 . V_1065 ++ ;
else {
V_773 -> V_501 = NULL ;
F_63 ( V_23 ) ;
...
unsigned short V_4 = F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) ;
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) + V_1064 ) >
F_377 ( V_773 -> V_501 ) ) ) {
V_166 -> V_673 . V_1065 ++ ;
...
memmove ( V_773 -> V_501 -> V_3 + sizeof( struct V_1077 ) ,
V_773 -> V_501 -> V_3 + V_1064 , V_4 ) ;
V_1078 = (struct V_1077 * ) V_773 -> V_501 -> V_3 ;
...
V_1078 -> V_1097 = ( T_7 ) F_220 ( V_1063 -> V_736 ) ;
...
F_381 ( V_773 -> V_501 , V_4 + sizeof( struct V_1077 ) ) ;
F_382 ( L_387 , V_773 -> V_501 -> V_4 ) ;
if ( ! F_383 ( V_23 -> V_163 , V_773 -> V_501 , V_673 ) )
V_166 -> V_673 . V_1065 ++ ;
else {
...
T_7 V_736 = ( T_7 ) F_220 ( V_1063 -> V_736 ) ;
...
return;
V_166 -> V_1062 = V_140 ;
if ( F_29 ( ( V_4 + V_1064 ) > F_377 ( V_773 -> V_501 ) ) ) {
V_166 -> V_673 . V_1065 ++ ;
F_378 ( L_385 ) ;
return;
}
...
V_1054 = ( void * ) V_773 -> V_501 -> V_3 + V_1064 ;
if ( F_387 ( F_220 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1110 )
return;
if ( V_161 & V_1111 )
V_1108 = 1 ;
} else if ( F_388 ( F_220 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1112 )
return;
if ( V_161 & V_1113 )
V_1108 = 1 ;
} else if ( F_389 ( F_220 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1114 )
return;
if ( V_161 & V_1115 )
V_1108 = 1 ;
}
V_501 = F_390 ( V_773 -> V_501 , V_139 ) ;
if ( V_501 == NULL ) {
F_46 ( L_389 ) ;
return;
}
...
if ( V_1107 & ( 1 << 6 ) )
V_1078 -> V_1092 |= V_1106 ;
F_382 ( L_387 , V_501 -> V_4 ) ;
if ( ! F_383 ( V_23 -> V_159 -> V_163 , V_501 , V_673 ) ) {
V_166 -> V_673 . V_1065 ++ ;
F_392 ( V_501 ) ;
}
}
...
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
if ( ! memcmp ( V_1116 -> V_1117 , V_23 -> V_167 -> V_1118 , V_217 ) )
return 0 ;
if ( F_364 ( V_1116 -> V_1070 ) )
return ! memcmp ( V_1116 -> V_1119 , V_23 -> V_216 , V_217 ) ;
return ! memcmp ( V_1116 -> V_1070 , V_23 -> V_167 -> V_1118 ,
V_217 ) ;
case V_516 :
if ( ! memcmp ( V_1116 -> V_1119 , V_23 -> V_167 -> V_1118 , V_217 ) )
return 0 ;
if ( F_364 ( V_1116 -> V_1070 ) )
return ! memcmp ( V_1116 -> V_1117 , V_23 -> V_216 , V_217 ) ;
return ! memcmp ( V_1116 -> V_1070 , V_23 -> V_167 -> V_1118 ,
V_217 ) ;
}
return 1 ;
...
struct V_674 * V_1116 )
{
T_4 V_1120 = F_220 ( V_1116 -> V_1121 ) ;
...
V_545 =
F_211 ( V_134 , struct V_1126 , V_442 ) ;
...
struct V_672 * V_673 )
{
struct V_1005 * V_501 = V_773 -> V_501 ;
struct V_1060 * V_1061 = (struct V_1060 * ) V_501 -> V_3 ;
struct V_674 * V_1116 = (struct V_674 * )
( V_501 -> V_3 + V_1064 ) ;
F_294 ( V_23 -> V_163 , V_1116 , V_673 ) ;
if ( V_23 -> V_163 -> V_513 == V_514 &&
( ( F_400 ( F_220 ( V_1116 -> V_1136 ) ) ==
V_1137 ) ||
( F_400 ( F_220 ( V_1116 -> V_1136 ) ) ==
V_1138 ) ) ) {
if ( ! memcmp ( V_1116 -> V_1119 , V_23 -> V_216 , V_217 ) )
F_260 ( V_23 , V_1116 -> V_1117 ) ;
}
if ( V_23 -> V_59 & V_200 ) {
F_142 ( L_391 ) ;
F_381 ( V_501 , F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) +
V_1064 ) ;
F_401 ( V_501 , V_1064 ) ;
memcpy ( F_402 ( V_501 , sizeof( * V_673 ) ) , V_673 , sizeof( * V_673 ) ) ;
V_501 -> V_166 = V_23 -> V_163 -> V_166 ;
F_403 ( V_501 ) ;
V_501 -> V_1139 = V_1140 ;
V_501 -> V_1141 = F_404 ( V_1142 ) ;
memset ( V_501 -> V_401 , 0 , sizeof( V_773 -> V_501 -> V_401 ) ) ;
F_405 ( V_501 ) ;
V_773 -> V_501 = NULL ;
}
}
...
V_1143 = F_36 ( V_23 , V_780 ) ;
V_7 = V_23 -> V_496 -> V_505 ;
if ( F_249 ( V_23 -> V_496 ) > ( V_500 / 2 ) )
V_1145 = 1 ;
while ( V_7 != V_381 ) {
V_773 = V_23 -> V_496 -> V_777 [ V_7 ] ;
if ( F_29 ( V_773 == NULL ) ) {
F_4 ( V_781 L_392 ) ;
break;
}
V_23 -> V_496 -> V_777 [ V_7 ] = NULL ;
F_406 ( V_23 -> V_477 , V_773 -> V_502 ,
V_503 ,
V_504 ) ;
V_1061 = (struct V_1060 * ) V_773 -> V_501 -> V_3 ;
F_382 ( L_393 ,
V_1061 -> V_1116 . V_536 ,
V_1061 -> V_1116 . V_1146 , V_1061 -> V_1116 . V_769 ) ;
...
V_1045 + 0x100 ,
. V_736 =
F_220 ( V_1061 -> V_538 . V_1063 . V_736 ) ,
...
V_820 :
V_819 ,
. V_4 = F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) ,
} ;
if ( V_673 . V_632 != 0 )
V_673 . V_36 |= V_1150 ;
if ( V_673 . signal != 0 )
...
#endif
V_1116 =
(struct V_674 * ) ( V_773 -> V_501 ->
V_3 +
V_1064 ) ;
V_1144 =
F_393 ( V_23 , V_1116 ) ;
if ( V_1144 && V_23 -> V_117 ) {
V_23 -> V_117 -> V_673 . V_632 =
V_673 . V_632 ;
V_23 -> V_581 =
F_271 ( V_23 -> V_581 ,
V_673 . V_632 , V_1154 ) ;
...
F_382 ( L_394 ,
F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) ) ;
if ( F_220 ( V_1061 -> V_538 . V_1063 . V_415 ) <
F_391 ( F_220 (
V_1116 -> V_1136 ) ) ) {
F_378
( L_395
L_396 ) ;
V_23 -> V_167 -> V_673 . V_1065 ++ ;
V_23 -> V_1066 . V_1067 . V_1068 ++ ;
break;
}
switch ( F_408
...
F_382
( L_400 ,
V_1061 -> V_538 . V_1159 . V_660 ,
V_1061 -> V_538 . V_1159 . V_41 ,
F_220 ( V_1061 -> V_538 . V_1159 . V_15 ) ) ;
F_288 ( V_23 , & V_1061 -> V_538 . V_1159 ) ;
break;
}
default:
F_382 ( L_401 ,
...
F_237 ( V_23 -> V_477 , V_773 -> V_502 ,
V_503 , V_504 ) ;
F_213 ( & V_773 -> V_442 , & V_23 -> V_496 -> V_498 ) ;
V_7 = ( V_7 + 1 ) % V_500 ;
if ( V_1145 ) {
...
V_1188 -> V_1190 . V_736 = 0 ;
V_1188 -> V_1190 . V_1192 = 7 ;
V_1188 -> V_1193 . V_1191 = 70 ;
V_1188 -> V_1193 . V_11 = 0 ;
V_1188 -> V_1193 . V_736 = 0 ;
V_1188 -> V_1193 . V_1192 = 7 ;
F_59 ( & V_23 -> V_109 ) ;
V_1188 -> V_1194 = F_3 ( V_23 -> V_336 . V_795 , ( T_2 ) V_1195 ) ;
for ( V_7 = 0 ; V_7 < V_1188 -> V_1194 ; V_7 ++ )
V_1188 -> V_1196 [ V_7 ] = ( V_23 -> V_336 . V_798 [ V_7 ] & 0x7F ) *
500000 ;
...
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
static const unsigned char V_1223 [] = {
0xff , 0xff , 0xff , 0xff , 0xff , 0xff
} ;
static const unsigned char V_1224 [] = {
0x00 , 0x00 , 0x00 , 0x00 , 0x00 , 0x00
} ;
if ( V_211 -> V_212 . V_213 != V_214 )
return - V_75 ;
F_59 ( & V_23 -> V_109 ) ;
if ( ! memcmp ( V_1223 , V_211 -> V_212 . V_215 , V_217 ) ||
! memcmp ( V_1224 , V_211 -> V_212 . V_215 , V_217 ) ) {
F_325 ( L_427 ) ;
V_23 -> V_59 &= ~ V_818 ;
F_263 ( L_411
L_412 ) ;
...
V_415 = F_3 ( ( int ) V_211 -> V_666 . V_415 , V_313 ) ;
V_23 -> V_59 |= V_810 ;
if ( V_23 -> V_667 == V_415 && ! memcmp ( V_23 -> V_666 , V_903 , V_415 )
&& ( V_23 -> V_37 & ( V_103 | V_240 ) ) ) {
F_325 ( L_433 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
...
F_325 ( L_434 ,
F_290 ( V_311 , V_903 , V_415 ) , V_415 ) ;
V_23 -> V_667 = V_415 ;
memcpy ( V_23 -> V_666 , V_903 , V_23 -> V_667 ) ;
F_263 ( L_435 ) ;
if ( ! F_264 ( V_23 ) )
V_332 ( V_23 ) ;
F_60 ( & V_23 -> V_109 ) ;
...
F_325 ( L_436 ,
F_290 ( V_311 , V_23 -> V_666 , V_23 -> V_667 ) ) ;
memcpy ( V_903 , V_23 -> V_666 , V_23 -> V_667 ) ;
V_211 -> V_666 . V_415 = V_23 -> V_667 ;
V_211 -> V_666 . V_41 = 1 ;
} else {
F_325 ( L_437 ) ;
V_211 -> V_666 . V_415 = 0 ;
...
return - V_905 ;
F_59 ( & V_23 -> V_109 ) ;
V_211 -> V_3 . V_415 = F_3 ( ( T_1 ) V_211 -> V_3 . V_415 , sizeof( V_23 -> V_1225 ) ) ;
memset ( V_23 -> V_1225 , 0 , sizeof( V_23 -> V_1225 ) ) ;
memcpy ( V_23 -> V_1225 , V_903 , V_211 -> V_3 . V_415 ) ;
F_195 ( L_153 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
F_325 ( L_439 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_211 -> V_3 . V_415 = strlen ( V_23 -> V_1225 ) ;
memcpy ( V_903 , V_23 -> V_1225 , V_211 -> V_3 . V_415 ) ;
V_211 -> V_3 . V_41 = 1 ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
int V_557 = 0 ;
F_325 ( L_440 , V_211 -> V_327 . V_25 ) ;
F_325 ( L_441 , 3 * V_211 -> V_327 . V_25 ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( V_211 -> V_327 . V_1226 == 0 )
{
V_23 -> V_655 = V_1176 ;
V_23 -> V_647 = V_1175 ;
goto V_6;
}
if ( ( V_211 -> V_327 . V_25 > V_1227 ) ||
( V_211 -> V_327 . V_25 < V_1228 ) ) {
V_557 = - V_75 ;
goto V_6;
}
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_211 -> V_327 . V_1226 = 1 ;
V_211 -> V_327 . V_25 = V_23 -> V_655 ;
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_442 ,
V_211 -> V_343 . V_1229 ? L_96 : L_97 , V_211 -> V_343 . V_25 ) ;
return 0 ;
}
...
V_36 = 0 ;
V_1226 = V_211 -> V_1196 . V_1226 ;
if ( V_1230 == 1000000 || ! V_1226 )
V_36 |= V_596 ;
if ( V_1230 == 1000000 )
goto V_1231;
if ( V_1230 == 2000000 || ! V_1226 )
V_36 |= V_597 ;
if ( V_1230 == 2000000 )
goto V_1231;
if ( V_1230 == 5500000 || ! V_1226 )
V_36 |= V_598 ;
if ( V_1230 == 5500000 )
goto V_1231;
if ( V_1230 == 6000000 || ! V_1226 )
V_36 |= V_599 ;
if ( V_1230 == 6000000 )
goto V_1231;
if ( V_1230 == 9000000 || ! V_1226 )
V_36 |= V_600 ;
if ( V_1230 == 9000000 )
goto V_1231;
if ( V_1230 == 11000000 || ! V_1226 )
V_36 |= V_601 ;
if ( V_1230 == 11000000 )
goto V_1231;
if ( V_1230 == 12000000 || ! V_1226 )
V_36 |= V_602 ;
if ( V_1230 == 12000000 )
goto V_1231;
if ( V_1230 == 18000000 || ! V_1226 )
V_36 |= V_603 ;
if ( V_1230 == 18000000 )
goto V_1231;
if ( V_1230 == 24000000 || ! V_1226 )
V_36 |= V_604 ;
if ( V_1230 == 24000000 )
goto V_1231;
if ( V_1230 == 36000000 || ! V_1226 )
V_36 |= V_605 ;
if ( V_1230 == 36000000 )
goto V_1231;
if ( V_1230 == 48000000 || ! V_1226 )
V_36 |= V_606 ;
if ( V_1230 == 48000000 )
goto V_1231;
if ( V_1230 == 54000000 || ! V_1226 )
V_36 |= V_607 ;
if ( V_1230 == 54000000 )
goto V_1231;
F_325 ( L_443 ) ;
...
V_211 -> V_1196 . V_1226 = ( V_23 -> V_59 & V_1024 ) ? 1 : 0 ;
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_449 , V_211 -> V_1196 . V_25 ) ;
return 0 ;
}
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( V_211 -> V_355 . V_1229 || ! V_211 -> V_355 . V_1226 )
V_23 -> V_357 = V_1177 ;
else {
if ( V_211 -> V_355 . V_25 < V_1232 ||
V_211 -> V_355 . V_25 > V_1233 ) {
F_60 ( & V_23 -> V_109 ) ;
return - V_75 ;
}
...
V_211 -> V_355 . V_1226 = 0 ;
V_211 -> V_355 . V_1229 = ( V_211 -> V_355 . V_25 == V_1177 ) ;
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_451 , V_211 -> V_355 . V_25 ) ;
return 0 ;
}
...
int V_557 = 0 ;
F_59 ( & V_23 -> V_109 ) ;
if ( F_126 ( V_23 , V_211 -> V_343 . V_1229 ) ) {
V_557 = - V_1234 ;
goto V_6;
}
if ( ! V_211 -> V_343 . V_1226 )
V_211 -> V_343 . V_25 = V_1181 ;
if ( V_211 -> V_343 . V_41 != V_1235 ) {
V_557 = - V_75 ;
goto V_6;
}
if ( ( V_211 -> V_343 . V_25 > V_1236 ) ||
( V_211 -> V_343 . V_25 < V_1237 ) ) {
V_557 = - V_75 ;
goto V_6;
}
...
V_211 -> V_343 . V_41 = V_1235 ;
V_211 -> V_343 . V_1229 = ( V_23 -> V_37 & V_99 ) ? 1 : 0 ;
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_452 ,
V_211 -> V_343 . V_1229 ? L_96 : L_97 , V_211 -> V_343 . V_25 ) ;
return 0 ;
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( V_211 -> V_359 . V_1229 || ! V_211 -> V_359 . V_1226 )
V_23 -> V_163 -> V_1238 = V_1239 ;
else {
...
V_23 -> V_163 -> V_1238 = V_211 -> V_359 . V_25 & ~ 0x1 ;
}
F_183 ( V_23 , V_211 -> V_359 . V_25 ) ;
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_453 , V_211 -> V_359 . V_25 ) ;
return 0 ;
}
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_211 -> V_359 . V_25 = V_23 -> V_163 -> V_1238 ;
V_211 -> V_359 . V_1226 = 0 ;
V_211 -> V_359 . V_1229 = ( V_211 -> V_359 . V_25 == V_1239 ) ;
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_454 , V_211 -> V_359 . V_25 ) ;
return 0 ;
}
...
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
if ( V_211 -> V_517 . V_41 & V_1240 || V_211 -> V_517 . V_1229 )
return - V_75 ;
...
else if ( V_211 -> V_517 . V_41 & V_1243 )
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_211 -> V_517 . V_1229 = 0 ;
if ( ( V_211 -> V_517 . V_41 & V_1244 ) == V_1240 ) {
F_60 ( & V_23 -> V_109 ) ;
return - V_75 ;
}
if ( V_211 -> V_517 . V_41 & V_1243 ) {
V_211 -> V_517 . V_41 = V_1241 | V_1243 ;
V_211 -> V_517 . V_25 = V_23 -> V_373 ;
} else if ( V_211 -> V_517 . V_41 & V_1242 ) {
V_211 -> V_517 . V_41 = V_1241 | V_1242 ;
V_211 -> V_517 . V_25 = V_23 -> V_372 ;
} else {
V_211 -> V_517 . V_41 = V_1241 ;
V_211 -> V_517 . V_25 = V_23 -> V_372 ;
}
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_456 , V_211 -> V_517 . V_25 ) ;
return 0 ;
}
...
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
struct V_1245 * V_1246 = (struct V_1245 * ) V_903 ;
struct V_1247 * V_107 = NULL ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_658 = 1 ;
if ( V_211 -> V_3 . V_415 == sizeof( struct V_1245 ) ) {
if ( V_211 -> V_3 . V_41 & V_1248 ) {
int V_4 = F_3 ( ( int ) V_1246 -> V_667 ,
( int ) sizeof( V_23 -> V_882 ) ) ;
memcpy ( V_23 -> V_882 , V_1246 -> V_666 , V_4 ) ;
V_23 -> V_873 = V_4 ;
V_107 = & V_23 -> V_187 ;
} else if ( V_1246 -> V_699 == V_875 ) {
V_107 = & V_23 -> V_188 ;
}
} else {
V_107 = & V_23 -> V_186 ;
...
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
return F_438 ( V_23 -> V_163 , V_902 , V_211 , V_903 ) ;
}
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
int V_432 ;
T_3 V_1249 = V_23 -> V_317 ;
F_59 ( & V_23 -> V_109 ) ;
V_432 = F_440 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
if ( V_1249 != V_23 -> V_317 &&
V_23 -> V_163 -> V_513 == V_514 &&
V_23 -> V_37 & V_103 )
F_264 ( V_23 ) ;
F_60 ( & V_23 -> V_109 ) ;
...
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
return F_442 ( V_23 -> V_163 , V_902 , V_211 , V_829 ) ;
}
...
int V_557 ;
F_59 ( & V_23 -> V_109 ) ;
if ( V_211 -> V_343 . V_1229 ) {
V_23 -> V_1180 = F_444 ( V_23 -> V_1180 ) ;
...
switch ( V_211 -> V_343 . V_41 & V_1250 ) {
case V_1251 :
case V_1250 :
case V_1252 :
break;
...
if ( F_444 ( V_23 -> V_1180 ) == V_365 )
V_23 -> V_1180 = V_1253 | V_363 ;
else
V_23 -> V_1180 = V_1253 | V_23 -> V_1180 ;
V_557 = F_184 ( V_23 , F_444 ( V_23 -> V_1180 ) ) ;
if ( V_557 ) {
F_325 ( L_458 ) ;
F_60 ( & V_23 -> V_109 ) ;
return V_557 ;
}
F_325 ( L_461 , V_23 -> V_1180 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
struct V_17 * V_23 = F_340 ( V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( ! ( V_23 -> V_1180 & V_1253 ) )
V_211 -> V_343 . V_1229 = 1 ;
else
V_211 -> V_343 . V_1229 = 0 ;
F_60 ( & V_23 -> V_109 ) ;
F_325 ( L_462 , V_23 -> V_1180 ) ;
return 0 ;
}
...
int V_557 ;
F_59 ( & V_23 -> V_109 ) ;
if ( ( V_118 < 1 ) || ( V_118 > V_1254 ) )
V_118 = V_365 ;
if ( F_444 ( V_23 -> V_1180 ) != V_118 ) {
...
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
int V_11 = F_444 ( V_23 -> V_1180 ) ;
char * V_134 = V_903 ;
V_134 += snprintf ( V_134 , V_1255 , L_463 , V_11 ) ;
switch ( V_11 ) {
case V_365 :
V_134 += snprintf ( V_134 , V_1255 - ( V_134 - V_903 ) , L_464 ) ;
break;
case V_363 :
V_134 += snprintf ( V_134 , V_1255 - ( V_134 - V_903 ) , L_465 ) ;
break;
default:
V_134 += snprintf ( V_134 , V_1255 - ( V_134 - V_903 ) ,
L_466 ,
V_1256 [ V_11 - 1 ] / 1000 ,
V_1257 [ V_11 - 1 ] / 1000 ) ;
}
if ( ! ( V_23 -> V_1180 & V_1253 ) )
V_134 += snprintf ( V_134 , V_1255 - ( V_134 - V_903 ) , L_467 ) ;
...
case V_119 :
strncpy ( V_903 , L_473 , V_1255 ) ;
break;
case V_608 :
strncpy ( V_903 , L_474 , V_1255 ) ;
break;
case V_119 | V_608 :
strncpy ( V_903 , L_475 , V_1255 ) ;
break;
case V_121 :
strncpy ( V_903 , L_476 , V_1255 ) ;
break;
case V_119 | V_121 :
strncpy ( V_903 , L_477 , V_1255 ) ;
break;
case V_608 | V_121 :
strncpy ( V_903 , L_478 , V_1255 ) ;
break;
case V_119 | V_608 | V_121 :
strncpy ( V_903 , L_479 , V_1255 ) ;
break;
default:
strncpy ( V_903 , L_480 , V_1255 ) ;
break;
}
F_325 ( L_481 , V_903 ) ;
...
F_59 ( & V_23 -> V_109 ) ;
if ( V_23 -> V_59 & V_821 )
snprintf ( V_211 -> V_158 , V_1259 , L_483 ) ;
else
snprintf ( V_211 -> V_158 , V_1259 , L_484 ) ;
F_60 ( & V_23 -> V_109 ) ;
return 0 ;
}
...
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
int * V_1260 = ( int * ) V_903 ;
int V_999 = ( V_1260 [ 0 ] > 0 ) ;
F_59 ( & V_23 -> V_109 ) ;
F_325 ( L_485 , V_999 , V_1260 [ 1 ] ) ;
if ( V_999 ) {
if ( V_23 -> V_163 -> V_513 != V_515 ) {
#ifdef F_407
V_23 -> V_167 -> type = V_1168 ;
...
F_60 ( & V_23 -> V_109 ) ;
F_440 ( V_23 -> V_163 , V_902 , & V_1261 , NULL ) ;
F_59 ( & V_23 -> V_109 ) ;
if ( ! ( V_23 -> V_37 & V_99 ) ) {
F_263 ( L_488
L_489 ) ;
...
static struct V_1264 * F_456 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
struct V_1264 * V_1066 ;
V_1066 = & V_23 -> V_1066 ;
if ( ! ( V_23 -> V_37 & V_103 ) ) {
V_1066 -> V_1265 . V_1266 = 0 ;
V_1066 -> V_1067 . V_512 = 0 ;
V_1066 -> V_1191 . V_1191 = 0 ;
V_1066 -> V_1191 . V_11 = 0 ;
V_1066 -> V_1191 . V_736 = 0 ;
V_1066 -> V_1191 . V_1192 = 7 ;
V_1066 -> V_1191 . V_1192 |= V_1267 |
V_1268 | V_1269 ;
return V_1066 ;
}
V_1066 -> V_1191 . V_1191 = V_23 -> V_579 ;
V_1066 -> V_1191 . V_11 = V_23 -> V_581 ;
V_1066 -> V_1191 . V_736 = V_23 -> V_582 ;
V_1066 -> V_1191 . V_1192 = V_1270 | V_1271 |
V_1272 | V_1273 ;
V_1066 -> V_1265 . V_1266 = F_273 ( & V_23 -> V_580 ) ;
V_1066 -> V_1067 . V_512 = V_23 -> V_587 ;
V_1066 -> V_1067 . V_1274 = V_23 -> V_163 -> V_1275 . V_1276 ;
return V_1066 ;
}
static void F_457 ( struct V_1277 * V_310 )
{
memset ( V_310 , 0 , sizeof( struct V_1277 ) ) ;
V_310 -> V_1278 = 0 ;
V_310 -> V_1044 = 0 ;
V_310 -> V_565 = 0 ;
V_310 -> V_566 = 1 ;
...
V_310 -> V_1280 = 0 ;
V_310 -> V_849 = 1 ;
if ( V_1281 < V_1282 || V_1281 > V_1283 )
V_1281 = V_1282 ;
V_310 -> V_1284 = V_1281 ;
V_310 -> V_1285 = 0 ;
V_310 -> V_1043 = 0 ;
...
static int F_462 ( struct V_17 * V_23 , struct V_1290 * V_532 ,
int V_1291 )
{
struct V_1292 * V_1054 = (struct V_1292 * )
V_532 -> V_1293 [ 0 ] -> V_3 ;
int V_7 = 0 ;
struct V_534 * V_767 ;
#ifdef F_291
int V_1294 = F_362 ( V_23 , V_1291 ) ;
struct V_531 * V_230 = & V_23 -> V_230 [ V_1294 ] ;
#else
struct V_531 * V_230 = & V_23 -> V_230 [ 0 ] ;
#endif
struct V_523 * V_521 = & V_230 -> V_521 ;
T_2 V_1295 , V_1296 , V_1007 ;
int V_1055 ;
if ( ! ( V_23 -> V_37 & V_103 ) )
goto V_1135;
V_1296 = F_391 ( F_220 ( V_1054 -> V_1136 ) ) ;
switch ( V_23 -> V_163 -> V_513 ) {
case V_514 :
V_1007 = ! F_364 ( V_1054 -> V_1070 ) ;
V_1295 = F_261 ( V_23 , V_1054 -> V_1070 ) ;
if ( V_1295 == V_552 ) {
V_1295 = F_260 ( V_23 , V_1054 -> V_1070 ) ;
if ( V_1295 == V_552 ) {
F_93 ( L_492
L_493 ,
V_1054 -> V_1070 ) ;
...
memset ( V_767 , 0 , sizeof( * V_767 ) ) ;
V_767 -> V_538 . V_3 . V_1297 = V_1295 ;
V_767 -> V_535 . V_536 = V_1298 ;
V_767 -> V_535 . V_769 = V_770 ;
V_767 -> V_538 . V_3 . V_836 = V_1299 ;
V_767 -> V_538 . V_3 . V_4 = F_173 ( V_532 -> V_1300 ) ;
if ( V_23 -> V_559 . V_347 == V_352 )
V_767 -> V_538 . V_3 . V_1010 |= V_1301 ;
else
V_767 -> V_538 . V_3 . V_1010 |= V_1302 ;
if ( V_23 -> V_559 . V_1030 == V_1031 )
V_767 -> V_538 . V_3 . V_1013 |= V_1031 ;
V_1055 = F_220 ( V_1054 -> V_1136 ) ;
V_1054 -> V_1136 = F_173 ( V_1055 & ~ V_1303 ) ;
memcpy ( & V_767 -> V_538 . V_3 . V_767 . V_1304 . V_1016 , V_1054 , V_1296 ) ;
if ( F_463 ( V_1007 ) )
V_767 -> V_538 . V_3 . V_1013 |= V_1014 ;
if ( V_532 -> V_1305 && ! V_23 -> V_163 -> V_842 ) {
switch ( V_23 -> V_163 -> V_244 . V_11 ) {
case V_843 :
V_767 -> V_538 . V_3 . V_767 . V_1304 . V_1016 . V_1136 |=
F_173 ( V_1057 ) ;
if ( ! V_1007 )
V_767 -> V_538 . V_3 . V_1013 |= V_1014 ;
V_767 -> V_538 . V_3 . V_1013 &= ~ V_1306 ;
V_767 -> V_538 . V_3 . V_1010 |= V_851 ;
V_767 -> V_538 . V_3 . V_839 = 0 ;
V_767 -> V_538 . V_3 . V_839 |= V_1307 ;
break;
case V_846 :
V_767 -> V_538 . V_3 . V_767 . V_1304 . V_1016 . V_1136 |=
F_173 ( V_1057 ) ;
V_767 -> V_538 . V_3 . V_1013 &= ~ V_1306 ;
V_767 -> V_538 . V_3 . V_1010 |= V_855 ;
V_767 -> V_538 . V_3 . V_839 = V_1307 ;
break;
case V_847 :
V_767 -> V_538 . V_3 . V_767 . V_1304 . V_1016 . V_1136 |=
F_173 ( V_1057 ) ;
V_767 -> V_538 . V_3 . V_839 = V_23 -> V_163 -> V_921 . V_922 ;
if ( V_23 -> V_163 -> V_244 . V_841 [ V_23 -> V_163 -> V_921 . V_922 ] <=
40 )
V_767 -> V_538 . V_3 . V_839 |= V_1308 ;
else
V_767 -> V_538 . V_3 . V_839 |= V_1309 ;
break;
case V_848 :
break;
default:
...
#ifdef F_291
if ( V_1055 & V_1310 )
F_365 ( V_23 , V_1291 , & ( V_767 -> V_538 . V_3 ) ) ;
#endif
V_767 -> V_538 . V_3 . V_539 = F_179 ( F_3 ( ( T_2 ) ( V_540 - 2 ) ,
V_532 -> V_1311 ) ) ;
F_464 ( L_494 ,
V_532 -> V_1311 , F_225 ( V_767 -> V_538 . V_3 . V_539 ) ) ;
for ( V_7 = 0 ; V_7 < F_225 ( V_767 -> V_538 . V_3 . V_539 ) ; V_7 ++ ) {
F_464 ( L_495 ,
V_7 , F_225 ( V_767 -> V_538 . V_3 . V_539 ) ,
V_532 -> V_1293 [ V_7 ] -> V_4 - V_1296 ) ;
F_145 ( L_496 ,
V_7 , V_767 -> V_538 . V_3 . V_539 ,
V_532 -> V_1293 [ V_7 ] -> V_4 - V_1296 ) ;
F_2 ( V_1312 , V_532 -> V_1293 [ V_7 ] -> V_3 + V_1296 ,
V_532 -> V_1293 [ V_7 ] -> V_4 - V_1296 ) ;
V_767 -> V_538 . V_3 . V_541 [ V_7 ] =
F_179 ( F_299
( V_23 -> V_477 ,
V_532 -> V_1293 [ V_7 ] -> V_3 + V_1296 ,
V_532 -> V_1293 [ V_7 ] -> V_4 - V_1296 ,
V_542 ) ) ;
V_767 -> V_538 . V_3 . V_478 [ V_7 ] =
F_173 ( V_532 -> V_1293 [ V_7 ] -> V_4 - V_1296 ) ;
}
if ( V_7 != V_532 -> V_1311 ) {
struct V_1005 * V_501 ;
T_4 V_1313 = 0 ;
int V_8 ;
for ( V_8 = V_7 ; V_8 < V_532 -> V_1311 ; V_8 ++ )
V_1313 += V_532 -> V_1293 [ V_8 ] -> V_4 - V_1296 ;
F_4 ( V_1314 L_497 ,
V_1313 ) ;
V_501 = F_298 ( V_1313 , V_139 ) ;
if ( V_501 != NULL ) {
V_767 -> V_538 . V_3 . V_478 [ V_7 ] = F_173 ( V_1313 ) ;
for ( V_8 = V_7 ; V_8 < V_532 -> V_1311 ; V_8 ++ ) {
int V_15 = V_532 -> V_1293 [ V_8 ] -> V_4 - V_1296 ;
F_4 ( V_1314 L_498 ,
V_8 , V_15 ) ;
memcpy ( F_381 ( V_501 , V_15 ) ,
V_532 -> V_1293 [ V_8 ] -> V_3 + V_1296 , V_15 ) ;
}
F_392 ( V_532 -> V_1293 [ V_7 ] ) ;
V_532 -> V_1293 [ V_7 ] = V_501 ;
V_767 -> V_538 . V_3 . V_541 [ V_7 ] =
F_179 ( F_299
( V_23 -> V_477 , V_501 -> V_3 ,
V_1313 ,
V_542 ) ) ;
F_465 ( & V_767 -> V_538 . V_3 . V_539 , 1 ) ;
}
}
V_521 -> V_525 = F_251 ( V_521 -> V_525 , V_521 -> V_526 ) ;
F_35 ( V_23 , V_521 -> V_530 , V_521 -> V_525 ) ;
if ( F_250 ( V_521 ) < V_521 -> V_528 )
F_461 ( V_23 -> V_167 ) ;
return V_1315 ;
V_1135:
F_378 ( L_499 ) ;
...
static int F_466 ( struct V_165 * V_166 , int V_1291 )
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
#ifdef F_291
int V_1294 = F_362 ( V_23 , V_1291 ) ;
...
struct V_531 * V_230 = & V_23 -> V_230 [ 0 ] ;
#endif
if ( F_250 ( & V_230 -> V_521 ) < V_230 -> V_521 . V_528 )
return 1 ;
return 0 ;
}
static void F_467 ( struct V_17 * V_23 ,
struct V_1290 * V_532 )
{
struct V_672 V_1316 ;
struct V_1053 * V_1054 ;
...
V_1054 = ( void * ) V_532 -> V_1293 [ 0 ] -> V_3 ;
if ( F_387 ( F_220 ( V_1054 -> V_1056 ) ) ) {
if ( V_161 & V_1110 )
return;
if ( V_161 & V_1111 )
...
for( V_172 = 0 ; V_172 < V_532 -> V_1311 ; ++ V_172 ) {
struct V_1005 * V_802 = V_532 -> V_1293 [ V_172 ] ;
struct V_1005 * V_1318 ;
struct V_1319 * V_1079 ;
int V_4 ;
if ( V_1108 ) {
V_1054 = ( void * ) V_802 -> V_3 ;
V_4 = F_391 ( F_220 ( V_1054 -> V_1056 ) ) ;
} else
V_4 = V_802 -> V_4 ;
V_1318 = F_298 ( V_4 + sizeof( * V_1079 ) , V_139 ) ;
if ( ! V_1318 )
continue;
V_1079 = ( void * ) F_381 ( V_1318 , sizeof( * V_1079 ) ) ;
V_1079 -> V_1080 = V_1081 ;
V_1079 -> V_1082 = 0 ;
V_1079 -> V_1084 = 0 ;
V_1079 -> V_1084 |= F_179 ( 1 << V_1088 ) ;
* ( T_8 * ) F_381 ( V_1318 , sizeof( T_4 ) ) = F_173 (
F_385 ( V_23 -> V_197 ) ) ;
if ( V_23 -> V_197 > 14 )
* ( T_8 * ) F_381 ( V_1318 , sizeof( T_4 ) ) =
F_173 ( V_1100 |
V_1101 ) ;
...
F_173 ( V_1100 |
V_1103 ) ;
V_1079 -> V_1083 = F_173 ( V_1318 -> V_4 ) ;
F_468 ( V_802 , F_381 ( V_1318 , V_4 ) , V_4 ) ;
if ( ! F_383 ( V_23 -> V_159 -> V_163 , V_1318 , & V_1316 ) )
F_392 ( V_1318 ) ;
}
}
static T_12 F_469 ( struct V_1290 * V_532 ,
struct V_165 * V_166 , int V_1291 )
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
unsigned long V_41 ;
T_12 V_432 ;
F_145 ( L_500 , V_532 -> V_1300 ) ;
F_41 ( & V_23 -> V_98 , V_41 ) ;
#ifdef F_268
if ( V_156 && F_92 ( V_23 -> V_157 ) )
F_467 ( V_23 , V_532 ) ;
#endif
V_432 = F_462 ( V_23 , V_532 , V_1291 ) ;
if ( V_432 == V_1315 )
F_63 ( V_23 ) ;
F_42 ( & V_23 -> V_98 , V_41 ) ;
return V_432 ;
}
static void F_470 ( struct V_165 * V_166 )
{
}
static int F_471 ( struct V_165 * V_166 , void * V_134 )
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
struct V_1320 * V_32 = V_134 ;
if ( ! F_472 ( V_32 -> V_215 ) )
return - V_1321 ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_59 |= V_1322 ;
...
char V_1325 [ 32 ] ;
T_3 V_4 ;
F_474 ( V_902 -> V_1326 , V_1327 , sizeof( V_902 -> V_1326 ) ) ;
F_474 ( V_902 -> V_983 , V_1328 , sizeof( V_902 -> V_983 ) ) ;
V_4 = sizeof( V_1324 ) ;
F_48 ( V_134 , V_1329 , V_1324 , & V_4 ) ;
V_4 = sizeof( V_1325 ) ;
F_48 ( V_134 , V_1330 , V_1325 , & V_4 ) ;
snprintf ( V_902 -> V_1331 , sizeof( V_902 -> V_1331 ) , L_501 ,
V_1324 , V_1325 ) ;
F_474 ( V_902 -> V_1332 , F_475 ( V_134 -> V_477 ) ,
sizeof( V_902 -> V_1332 ) ) ;
V_902 -> V_1333 = V_386 ;
}
static T_3 F_476 ( struct V_165 * V_166 )
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
...
static int F_478 ( struct V_165 * V_166 ,
struct V_1334 * V_123 , T_2 * V_1335 )
{
struct V_17 * V_134 = F_340 ( V_166 ) ;
if ( V_123 -> V_468 + V_123 -> V_4 > V_386 )
return - V_75 ;
F_59 ( & V_134 -> V_109 ) ;
memcpy ( V_1335 , & V_134 -> V_123 [ V_123 -> V_468 ] , V_123 -> V_4 ) ;
F_60 ( & V_134 -> V_109 ) ;
return 0 ;
}
...
return - V_75 ;
F_59 ( & V_134 -> V_109 ) ;
memcpy ( & V_134 -> V_123 [ V_123 -> V_468 ] , V_1335 , V_123 -> V_4 ) ;
for ( V_7 = 0 ; V_7 < V_386 ; V_7 ++ )
F_196 ( V_134 , V_7 + V_387 , V_134 -> V_123 [ V_7 ] ) ;
F_60 ( & V_134 -> V_109 ) ;
return 0 ;
}
static T_13 F_480 ( int V_1336 , void * V_3 )
{
struct V_17 * V_23 = V_3 ;
T_3 V_219 , V_220 ;
if ( ! V_23 )
...
static void F_485 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
static void F_486 ( struct V_17 * V_23 )
{
V_23 -> V_1131 = - 1 ;
V_23 -> V_1132 = - 1 ;
V_23 -> V_1133 = 0 ;
...
static int T_14 F_491 ( struct V_17 * V_23 )
{
int V_432 = 0 ;
F_492 ( & V_23 -> V_228 ) ;
F_492 ( & V_23 -> V_486 ) ;
F_493 ( & V_23 -> V_668 , F_322 ) ;
F_494 ( & V_23 -> V_333 , F_373 ) ;
F_494 ( & V_23 -> V_558 , F_266 ) ;
F_494 ( & V_23 -> V_564 , F_267 ) ;
F_494 ( & V_23 -> V_779 , F_300 ) ;
F_494 ( & V_23 -> V_246 , F_164 ) ;
F_493 ( & V_23 -> V_191 , F_485 ) ;
F_494 ( & V_23 -> V_193 , V_1342 ) ;
F_494 ( & V_23 -> V_190 , V_1343 ) ;
F_493 ( & V_23 -> V_186 , F_332 ) ;
F_493 ( & V_23 -> V_187 , F_333 ) ;
F_493 ( & V_23 -> V_188 , F_331 ) ;
F_493 ( & V_23 -> V_189 , F_284 ) ;
F_493 ( & V_23 -> V_644 , F_280 ) ;
F_494 ( & V_23 -> V_653 , F_334 ) ;
F_494 ( & V_23 -> V_705 , F_372 ) ;
F_493 ( & V_23 -> V_322 , F_169 ) ;
F_494 ( & V_23 -> V_675 , F_488 ) ;
F_494 ( & V_23 -> V_241 , F_490 ) ;
F_493 ( & V_23 -> V_108 , F_57 ) ;
F_493 ( & V_23 -> V_104 , F_62 ) ;
F_493 ( & V_23 -> V_114 , F_66 ) ;
F_494 ( & V_23 -> V_815 , F_311 ) ;
#ifdef F_291
F_494 ( & V_23 -> V_961 , F_366 ) ;
#endif
F_495 ( & V_23 -> V_1339 , ( void (*) ( unsigned long ) )
F_140 , ( unsigned long ) V_23 ) ;
return V_432 ;
}
static void F_496 ( struct V_165 * V_166 ,
struct V_886 * V_244 )
{
struct V_17 * V_23 = F_340 ( V_166 ) ;
int V_7 ;
for ( V_7 = 0 ; V_7 < 4 ; V_7 ++ ) {
if ( V_244 -> V_41 & ( 1 << V_7 ) ) {
V_23 -> V_163 -> V_244 . V_1344 [ V_7 ] = V_244 -> V_1344 [ V_7 ] ;
...
if ( ! V_23 -> V_163 -> V_842 && ( V_244 -> V_41 & V_1345 ) )
F_320 ( V_23 ) ;
#if 0
...
static int F_449 ( struct V_17 * V_23 ,
struct V_335 * V_336 )
{
memset ( V_336 , 0 , sizeof( * V_336 ) ) ;
switch ( V_23 -> V_163 -> V_860 ) {
...
static int F_497 ( struct V_17 * V_23 )
{
if ( F_181 ( V_23 ) )
goto error;
...
F_457 ( & V_23 -> V_310 ) ;
if ( V_1349 ) {
unsigned char V_1350 = V_23 -> V_123 [ V_1351 ] ;
if ( V_1350 & V_1352 )
V_23 -> V_310 . V_1278
|= V_1353 ;
if ( V_1350 & V_1354 )
...
int V_155 , V_7 , V_8 ;
if ( V_23 -> V_1356 ) {
F_498 ( V_23 -> V_163 , V_23 -> V_1356 ) ;
V_23 -> V_1356 = 0 ;
}
if ( V_23 -> V_37 & V_700 )
return - V_306 ;
if ( V_149 && ! V_23 -> V_149 ) {
V_23 -> V_149 = F_499 ( V_149 , sizeof( * V_23 -> V_149 ) ,
V_148 ) ;
if ( V_23 -> V_149 == NULL ) {
F_46 ( L_509 ,
V_149 ) ;
...
memcpy ( V_23 -> V_167 -> V_1358 , V_23 -> V_543 , V_217 ) ;
for ( V_8 = 0 ; V_8 < F_221 ( V_1359 ) ; V_8 ++ ) {
if ( ! memcmp ( & V_23 -> V_123 [ V_1360 ] ,
V_1359 [ V_8 ] . V_158 , 3 ) )
break;
}
if ( V_8 == F_221 ( V_1359 ) ) {
...
if ( F_500 ( V_23 -> V_163 , & V_1359 [ V_8 ] ) ) {
F_93 ( L_511 ) ;
return 0 ;
}
if ( V_23 -> V_37 & V_184 ) {
...
V_23 -> V_37 &= ~ V_700 ;
F_43 ( V_23 ) ;
V_23 -> V_37 &= V_99 | V_700 ;
F_265 ( V_23 -> V_167 ) ;
F_229 ( V_23 ) ;
F_70 ( V_23 ) ;
}
static void V_1343 ( struct V_106 * V_107 )
{
struct V_17 * V_23 =
...
static int F_502 ( struct V_165 * V_166 )
{
int V_7 , V_155 = 0 ;
struct V_17 * V_23 = F_340 ( V_166 ) ;
const struct V_201 * V_202 = F_137 ( V_23 -> V_163 ) ;
struct V_1362 * V_182 = & V_23 -> V_163 -> V_182 ;
memcpy ( V_182 -> V_183 -> V_1358 , V_23 -> V_543 , V_217 ) ;
if ( V_202 -> V_203 ) {
struct V_1363 * V_1364 = & V_23 -> V_163 -> V_1364 ;
V_1364 -> V_881 = V_1365 ;
V_1364 -> V_1366 = V_202 -> V_203 ;
V_1364 -> V_869 = F_499 ( V_202 -> V_203 ,
sizeof( struct V_1367 ) ,
V_148 ) ;
if ( ! V_1364 -> V_869 ) {
V_155 = - V_476 ;
goto V_6;
...
for ( V_7 = 0 ; V_7 < V_202 -> V_203 ; V_7 ++ ) {
V_1364 -> V_869 [ V_7 ] . V_881 = V_1365 ;
V_1364 -> V_869 [ V_7 ] . V_1368 = V_202 -> V_204 [ V_7 ] . V_1149 ;
V_1364 -> V_869 [ V_7 ] . V_1369 = V_202 -> V_204 [ V_7 ] . V_197 ;
V_1364 -> V_869 [ V_7 ] . V_346 = V_202 -> V_204 [ V_7 ] . V_346 ;
if ( V_202 -> V_204 [ V_7 ] . V_41 & V_207 )
V_1364 -> V_869 [ V_7 ] . V_41 |=
V_1370 ;
...
V_1364 -> V_1373 = V_1374 ;
V_1364 -> V_1375 = V_1376 ;
V_182 -> V_183 -> V_1377 [ V_1365 ] = V_1364 ;
}
if ( V_202 -> V_209 ) {
struct V_1363 * V_1378 = & V_23 -> V_163 -> V_1378 ;
V_1378 -> V_881 = V_1379 ;
V_1378 -> V_1366 = V_202 -> V_209 ;
V_1378 -> V_869 = F_499 ( V_202 -> V_209 ,
sizeof( struct V_1367 ) ,
V_148 ) ;
if ( ! V_1378 -> V_869 ) {
V_155 = - V_476 ;
...
for ( V_7 = 0 ; V_7 < V_202 -> V_209 ; V_7 ++ ) {
V_1378 -> V_869 [ V_7 ] . V_881 = V_1379 ;
V_1378 -> V_869 [ V_7 ] . V_1368 = V_202 -> V_18 [ V_7 ] . V_1149 ;
V_1378 -> V_869 [ V_7 ] . V_1369 = V_202 -> V_18 [ V_7 ] . V_197 ;
V_1378 -> V_869 [ V_7 ] . V_346 = V_202 -> V_18 [ V_7 ] . V_346 ;
if ( V_202 -> V_18 [ V_7 ] . V_41 & V_207 )
V_1378 -> V_869 [ V_7 ] . V_41 |=
V_1370 ;
...
V_1378 -> V_1373 = V_1380 ;
V_1378 -> V_1375 = V_1381 ;
V_182 -> V_183 -> V_1377 [ V_1379 ] = V_1378 ;
}
V_182 -> V_183 -> V_1382 = V_1383 ;
V_182 -> V_183 -> V_1384 = F_221 ( V_1383 ) ;
F_503 ( V_182 -> V_183 , & V_23 -> V_477 -> V_166 ) ;
if ( F_504 ( V_182 -> V_183 ) )
V_155 = - V_306 ;
V_6:
return V_155 ;
}
...
{
struct V_1385 * V_159 = F_340 ( V_166 ) ;
...
static T_12 F_507 ( struct V_1005 * V_501 ,
struct V_165 * V_166 )
{
F_74 ( L_526 ) ;
F_238 ( V_501 ) ;
...
static int T_14 F_514 ( struct V_477 * V_1388 ,
const struct V_1389 * V_1390 )
{
int V_557 = 0 ;
struct V_165 * V_167 ;
void T_15 * V_137 ;
...
struct V_17 * V_23 ;
int V_7 ;
V_167 = F_508 ( sizeof( struct V_17 ) , 0 ) ;
if ( V_167 == NULL ) {
V_557 = - V_476 ;
goto V_6;
}
V_23 = F_340 ( V_167 ) ;
V_23 -> V_163 = F_509 ( V_167 ) ;
V_23 -> V_167 = V_167 ;
V_23 -> V_477 = V_1388 ;
V_12 = V_1391 ;
F_301 ( & V_23 -> V_42 ) ;
...
F_517 ( V_1388 ) ;
V_557 = F_518 ( V_1388 , F_519 ( 32 ) ) ;
if ( ! V_557 )
V_557 = F_520 ( V_1388 , F_519 ( 32 ) ) ;
if ( V_557 ) {
F_4 (KERN_WARNING DRV_NAME L_528 ) ;
goto V_1394;
}
F_521 ( V_1388 , V_23 ) ;
V_557 = F_522 ( V_1388 , V_1327 ) ;
if ( V_557 )
goto V_1394;
F_523 ( V_1388 , 0x40 , & V_21 ) ;
if ( ( V_21 & 0x0000ff00 ) != 0 )
F_524 ( V_1388 , 0x40 , V_21 & 0xffff00ff ) ;
V_415 = F_525 ( V_1388 , 0 ) ;
V_23 -> V_1395 = V_415 ;
V_137 = F_526 ( V_1388 , 0 ) ;
if ( ! V_137 ) {
V_557 = - V_1392 ;
goto V_1396;
}
...
F_409 ( V_23 , 1 ) ;
V_557 = F_527 ( V_1388 -> V_1336 , F_480 , V_1398 , V_1327 , V_23 ) ;
if ( V_557 ) {
F_46 ( L_532 , V_1388 -> V_1336 ) ;
goto V_1397;
}
F_510 ( V_167 , & V_1388 -> V_166 ) ;
F_59 ( & V_23 -> V_109 ) ;
V_23 -> V_163 -> V_1399 = F_469 ;
V_23 -> V_163 -> V_896 = F_496 ;
V_23 -> V_163 -> V_1400 = F_466 ;
#ifdef F_291
V_23 -> V_163 -> V_1401 = F_363 ;
V_23 -> V_163 -> V_1402 = F_368 ;
V_23 -> V_163 -> V_1403 = F_367 ;
V_23 -> V_163 -> V_1404 = F_369 ;
#endif
V_23 -> V_163 -> V_642 = - 20 ;
V_23 -> V_163 -> V_643 = - 85 ;
V_167 -> V_1386 = & V_1405 ;
V_23 -> V_1406 . V_1407 = & V_23 -> V_163 -> V_1407 ;
V_167 -> V_1406 = & V_23 -> V_1406 ;
V_167 -> V_1408 = & V_1409 ;
V_167 -> V_1410 = & V_1411 ;
V_557 = F_528 ( & V_1388 -> V_166 . V_1412 , & V_1413 ) ;
if ( V_557 ) {
F_46 ( L_533 ) ;
F_60 ( & V_23 -> V_109 ) ;
goto V_1414;
...
#endif
F_4 (KERN_INFO DRV_NAME L_536
L_537 ,
priv->ieee->geo.name, priv->ieee->geo.bg_channels,
priv->ieee->geo.a_channels) ;
return 0 ;
V_1416:
F_529 ( V_23 -> V_163 -> V_182 . V_183 ) ;
F_87 ( V_23 -> V_163 -> V_1378 . V_869 ) ;
F_87 ( V_23 -> V_163 -> V_1364 . V_869 ) ;
V_1415:
F_530 ( & V_1388 -> V_166 . V_1412 , & V_1413 ) ;
V_1414:
F_531 ( V_1388 -> V_1336 , V_23 ) ;
V_1397:
F_532 ( V_23 -> V_22 ) ;
V_1396:
F_533 ( V_1388 ) ;
...
static void T_16 F_535 ( struct V_477 * V_1388 )
{
struct V_17 * V_23 = F_536 ( V_1388 ) ;
...
F_538 ( & V_23 -> V_815 ) ;
for ( V_7 = 0 ; V_7 < V_1127 ; V_7 ++ ) {
F_210 (p, q, &priv->ibss_mac_hash[i]) {
F_212 ( V_134 ) ;
F_87 ( F_211 ( V_134 , struct V_1126 , V_442 ) ) ;
}
}
F_87 ( V_23 -> error ) ;
V_23 -> error = NULL ;
...
static int F_539 ( struct V_477 * V_1388 , T_17 V_664 )
{
struct V_17 * V_23 = F_536 ( V_1388 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
F_4 ( V_1314 L_538 , V_166 -> V_158 ) ;
F_161 ( V_23 ) ;
F_540 ( V_166 ) ;
F_541 ( V_1388 ) ;
F_534 ( V_1388 ) ;
F_542 ( V_1388 , F_543 ( V_1388 , V_664 ) ) ;
V_23 -> V_1417 = F_544 () ;
return 0 ;
}
static int F_545 ( struct V_477 * V_1388 )
{
struct V_17 * V_23 = F_536 ( V_1388 ) ;
struct V_165 * V_166 = V_23 -> V_167 ;
int V_557 ;
T_3 V_21 ;
F_4 ( V_1314 L_539 , V_166 -> V_158 ) ;
F_542 ( V_1388 , V_1418 ) ;
V_557 = F_516 ( V_1388 ) ;
if ( V_557 ) {
F_4 ( V_1059 L_540 ,
...
F_524 ( V_1388 , 0x40 , V_21 & 0xffff00ff ) ;
F_547 ( V_166 ) ;
V_23 -> V_1356 = F_544 () - V_23 -> V_1417 ;
F_128 ( & V_23 -> V_193 ) ;
return 0 ;
}
static void F_548 ( struct V_477 * V_1388 )
{
struct V_17 * V_23 = F_536 ( V_1388 ) ;
F_161 ( V_23 ) ;
F_534 ( V_1388 ) ;
}
static int T_18 F_549 ( void )
{
int V_432 ;
F_4 (KERN_INFO DRV_NAME L_541 DRV_DESCRIPTION L_542 DRV_VERSION L_68 ) ;
F_4 (KERN_INFO DRV_NAME L_541 DRV_COPYRIGHT L_68 ) ;
V_432 = F_550 ( & V_1419 ) ;
if ( V_432 ) {
F_46 ( L_543 ) ;
return V_432 ;
}
V_432 = F_551 ( & V_1419 . V_1326 , & V_1420 ) ;
if ( V_432 ) {
F_46 ( L_544 ) ;
F_552 ( & V_1419 ) ;
return V_432 ;
...
static void T_19 F_553 ( void )
{
F_554 ( & V_1419 . V_1326 , & V_1420 ) ;
F_552 ( & V_1419 ) ;
}
