...
V_168 = F_45 ( V_24 , V_18 ) ;
V_19 = F_50 ( V_24 , V_79 ) ;
error = F_47 ( V_2 , V_168 , V_19 - V_168 , V_165 , & V_166 ,
V_171 ) ;
if ( error )
goto V_136;
if ( V_165 [ 0 ] . V_87 != V_88 ) {
V_12 = F_89 ( T_1 , V_18 ,
F_51 ( V_24 , V_165 [ 0 ] . V_99 ) ) ;
} else {
if ( V_166 == 1 ) {
error = V_170 ;
goto V_136;
...
V_168 = F_45 ( V_24 , V_18 ) ;
error = F_92 ( NULL , V_2 , 1 , & V_168 , V_149 ) ;
if ( error )
goto V_136;
V_172 = F_51 ( V_24 , V_168 ) ;
if ( V_172 <= V_18 )
V_12 = V_18 ;
else {
V_12 = F_82 ( T_1 , V_172 , V_79 ) ;
}
if ( V_12 != V_17 -> V_155 )
V_17 -> V_155 = V_12 ;
V_136:
...
case V_175 :
case V_176 :
return F_94 ( V_17 , V_12 , V_173 ) ;
case V_177 :
return F_88 ( V_17 , V_12 , V_173 ) ;
case V_178 :
return F_91 ( V_17 , V_12 , V_173 ) ;
default:
return - V_63 ;
}
}
