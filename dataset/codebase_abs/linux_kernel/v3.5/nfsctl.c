...
static T_1 F_58 ( char * V_2 )
{
char * V_82 ;
int V_43 = 0 ;
V_82 = F_59 ( V_2 + 1 , V_60 ) ;
if ( V_82 == NULL )
return - V_50 ;
if ( V_71 != NULL )
V_43 = F_60 ( V_71 , V_2 ,
...
return 0 ;
V_93:
V_85 = F_63 ( V_71 , V_83 , V_80 , V_88 , V_86 ) ;
if ( V_85 != NULL ) {
F_64 ( V_85 ) ;
F_65 ( V_85 ) ;
}
...
return - V_13 ;
V_85 = F_63 ( V_71 , V_83 , & V_21 , V_94 , V_86 ) ;
if ( V_85 == NULL )
return - V_95 ;
F_64 ( V_85 ) ;
F_65 ( V_85 ) ;
...
static T_1 F_71 ( struct V_1 * V_1 , char * V_2 , T_3 V_3 , T_6 * time )
{
T_1 V_11 ;
F_37 ( & V_59 ) ;
V_11 = F_70 ( V_1 , V_2 , V_3 , time ) ;
F_39 ( & V_59 ) ;
return V_11 ;
}
static T_1 F_72 ( struct V_1 * V_1 , char * V_2 , T_3 V_3 )
{
return F_71 ( V_1 , V_2 , V_3 , & V_99 ) ;
}
static T_1 F_73 ( struct V_1 * V_1 , char * V_2 , T_3 V_3 )
{
return F_71 ( V_1 , V_2 , V_3 , & V_100 ) ;
}
...
T_1 V_11 ;
F_37 ( & V_59 ) ;
V_11 = F_74 ( V_1 , V_2 , V_3 ) ;
F_39 ( & V_59 ) ;
return V_11 ;
}
static int F_78 ( struct V_104 * V_105 , void * V_10 , int V_106 )
{
...
return F_81 ( V_105 , 0x6e667364 , V_108 ) ;
}
static struct V_7 * F_82 ( struct V_134 * V_135 ,
int V_136 , const char * V_137 , void * V_10 )
{
return F_83 ( V_135 , V_136 , V_10 , F_78 ) ;
}
static int F_84 ( void )
{
struct V_138 * V_139 ;
V_139 = F_85 ( L_28 , NULL ) ;
if ( ! V_139 )
return - V_50 ;
V_139 = F_86 ( L_13 , 0 , V_139 , & V_110 ) ;
if ( ! V_139 )
return - V_50 ;
return 0 ;
}
...
static T_7 int F_87 ( struct V_80 * V_80 )
{
int V_140 ;
V_140 = F_88 ( V_80 ) ;
if ( V_140 )
...
static T_8 void F_91 ( struct V_80 * V_80 )
{
F_92 ( V_80 ) ;
F_90 ( V_80 ) ;
}
