...
V_2 -> V_155 , V_2 -> V_107 , V_83 -> V_115 ) < 0 ) {
F_52 ( V_83 ) ;
F_36 ( L_20 ) ;
return;
}
...
static int T_1 F_73 ( char * V_144 , char * V_156 , int V_115 , int V_157 )
{
if ( ! V_115 )
return 0 ;
if ( V_115 > V_157 - 1 )
V_115 = V_157 - 1 ;
memcpy ( V_144 , V_156 , V_115 ) ;
V_144 [ V_115 ] = '\0' ;
return 1 ;
}
static void T_1 F_74 ( T_4 * V_158 )
{
T_4 V_159 ;
int V_119 ;
T_2 V_17 ;
...
if ( V_159 > V_120 )
V_159 = V_120 ;
for ( V_119 = 0 ; V_119 < V_159 ; V_119 ++ ) {
if ( V_121 [ V_119 ] == V_65 )
memcpy ( & V_121 [ V_119 ] , V_158 + 1 + 4 * V_119 , 4 ) ;
}
break;
case 12 :
F_73 ( F_57 () -> V_75 , V_158 + 1 , * V_158 ,
V_161 ) ;
V_74 = 1 ;
break;
case 15 :
F_73 ( V_162 , V_158 + 1 , * V_158 , sizeof( V_162 ) ) ;
break;
case 17 :
if ( ! V_163 [ 0 ] )
F_73 ( V_163 , V_158 + 1 , * V_158 ,
sizeof( V_163 ) ) ;
break;
case 26 :
...
goto V_94;
V_115 = F_47 ( V_125 -> V_142 . V_115 ) - sizeof( struct V_168 ) ;
V_165 = V_115 - ( sizeof( * V_125 ) -
sizeof( struct V_126 ) -
sizeof( struct V_168 ) -
sizeof( V_125 -> V_154 ) ) ;
if ( V_165 < 0 )
...
static int F_86 ( struct V_193 * V_194 , void * V_195 )
{
int V_119 ;
if ( V_196 & V_197 )
F_87 ( V_194 , L_44 ,
...
static int F_89 ( struct V_198 * V_199 , struct V_200 * V_200 )
{
return F_90 ( V_200 , F_86 , NULL ) ;
}
...
static int T_1 F_105 ( char * V_214 )
{
...
* V_202 ++ = '\0' ;
if ( strlen ( V_215 ) > 0 ) {
F_11 ( ( L_67 , V_217 , V_215 ) ) ;
switch ( V_217 ) {
case 0 :
if ( ( V_55 = F_92 ( V_215 ) ) == V_219 )
V_55 = V_65 ;
break;
case 1 :
if ( ( V_77 = F_92 ( V_215 ) ) == V_219 )
V_77 = V_65 ;
break;
case 2 :
if ( ( V_64 = F_92 ( V_215 ) ) == V_219 )
V_64 = V_65 ;
break;
case 3 :
if ( ( V_57 = F_92 ( V_215 ) ) == V_219 )
V_57 = V_65 ;
break;
case 4 :
if ( ( V_216 = strchr ( V_215 , '.' ) ) ) {
* V_216 ++ = '\0' ;
F_106 ( F_57 () -> V_164 , V_216 ,
sizeof( F_57 () -> V_164 ) ) ;
}
F_106 ( F_57 () -> V_75 , V_215 ,
sizeof( F_57 () -> V_75 ) ) ;
V_74 = 1 ;
break;
case 5 :
F_106 ( V_5 , V_215 , sizeof( V_5 ) ) ;
break;
case 6 :
if ( F_101 ( V_215 ) == 0 &&
V_55 == V_65 ) {
...
static int T_1 F_107 ( char * V_214 )
{
return F_105 ( V_214 ) ;
}
static int T_1 F_108 ( char * V_214 )
{
if ( F_106 ( V_118 , V_214 ,
sizeof( V_118 ) )
>= sizeof( V_118 ) )
F_7 ( L_68 ,
V_118 ) ;
