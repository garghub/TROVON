...
V_12 -> V_196 = V_7 * sizeof( struct V_3 ) ;
if ( V_6 ) {
V_25 = F_10 ( V_15 , V_6 , V_12 -> V_196 ) ;
if ( V_25 < 0 ) {
F_30 ( L_67 ) ;
return V_25 ;
}
...
static int F_130 ( struct V_164 * T_11 ,
struct V_11 * V_29 ,
...
static int F_131 ( struct V_182 * V_12 ,
struct V_11 * V_29 , int V_15 ,
bool V_213 )
{
int V_18 ;
...
static int F_134 ( struct V_105 * V_220 )
{
struct V_221 * V_222 = F_135 ( V_220 -> V_106 . V_141 ) ;
char V_20 [ 128 ] ;
if ( V_222 == NULL )
return - 1 ;
snprintf ( V_20 , sizeof( V_20 ) , L_78 , V_222 -> system , V_222 -> V_2 ) ;
V_220 -> V_2 = F_136 ( V_20 ) ;
if ( V_222 -> V_2 == NULL )
return - 1 ;
return 0 ;
}
...
return - V_215 ;
V_225 = V_183 . V_198 . V_17 / V_183 . V_197 ;
F_102 ( V_15 , V_183 . V_198 . V_155 , V_162 ) ;
for ( V_10 = 0 ; V_10 < V_225 ; V_10 ++ ) {
struct V_105 * V_220 ;
V_163 V_228 ;
if ( F_133 ( V_15 , V_12 , & V_189 ) < 0 )
goto V_229;
if ( V_12 -> V_31 )
F_89 ( & V_189 . V_106 ) ;
V_228 = F_102 ( V_15 , 0 , V_174 ) ;
V_220 = F_140 ( & V_189 . V_106 , V_10 ) ;
if ( V_220 == NULL )
goto V_230;
F_141 ( V_58 -> V_84 , V_220 ) ;
V_226 = V_189 . V_109 . V_17 / sizeof( T_1 ) ;
if ( F_142 ( V_220 , 1 , V_226 ) )
goto V_230;
F_102 ( V_15 , V_189 . V_109 . V_155 , V_162 ) ;
for ( V_134 = 0 ; V_134 < V_226 ; V_134 ++ ) {
if ( F_116 ( V_12 , V_15 , & V_224 , sizeof( V_224 ) ) )
goto V_229;
F_143 ( V_58 -> V_84 , V_220 , 0 , V_134 , V_224 ) ;
}
F_102 ( V_15 , V_228 , V_162 ) ;
}
V_71 . V_231 = V_225 ;
if ( V_183 . V_200 . V_17 ) {
F_102 ( V_15 , V_183 . V_200 . V_155 , V_162 ) ;
V_6 = malloc ( V_183 . V_200 . V_17 ) ;
if ( V_6 == NULL )
return - V_8 ;
if ( F_116 ( V_12 , V_15 , V_6 ,
V_183 . V_200 . V_17 ) )
goto V_229;
V_7 = V_183 . V_200 . V_17 / sizeof( struct V_3 ) ;
}
...
if ( V_235 == NULL )
return - V_8 ;
V_235 -> V_106 . V_106 = * V_106 ;
memcpy ( V_235 -> V_106 . V_1 , V_1 , V_109 * sizeof( T_1 ) ) ;
V_235 -> V_106 . V_12 . type = V_236 ;
V_235 -> V_106 . V_12 . V_17 = V_17 ;
V_25 = F_119 ( V_233 , V_235 , NULL , NULL ) ;
free ( V_235 ) ;
return V_25 ;
}
int F_146 ( struct V_232 * V_233 ,
struct V_57 * V_58 ,
T_12 F_119 )
{
struct V_105 * V_106 ;
...
V_25 = F_145 ( V_233 , & V_106 -> V_106 , V_106 -> V_109 ,
V_106 -> V_1 , F_119 ) ;
if ( V_25 ) {
F_30 ( L_79 ) ;
return V_25 ;
...
int F_147 ( union V_234 * V_222 ,
struct V_83 * * V_237 )
{
unsigned int V_10 , V_109 , V_238 ;
struct V_105 * V_220 ;
struct V_83 * V_84 = * V_237 ;
if ( V_84 == NULL ) {
* V_237 = V_84 = F_139 ( NULL , NULL ) ;
if ( V_84 == NULL )
return - V_8 ;
}
V_220 = F_140 ( & V_222 -> V_106 . V_106 , V_84 -> V_199 ) ;
if ( V_220 == NULL )
return - V_8 ;
F_141 ( V_84 , V_220 ) ;
V_109 = V_222 -> V_12 . V_17 ;
V_109 -= ( void * ) & V_222 -> V_106 . V_1 - ( void * ) V_222 ;
V_238 = V_109 / sizeof( T_1 ) ;
if ( F_142 ( V_220 , 1 , V_238 ) )
return - V_8 ;
for ( V_10 = 0 ; V_10 < V_238 ; V_10 ++ ) {
F_143 ( V_84 , V_220 , 0 , V_10 , V_222 -> V_106 . V_1 [ V_10 ] ) ;
}
return 0 ;
}
int F_148 ( struct V_232 * V_233 ,
T_1 V_9 , char * V_2 ,
T_12 F_119 ,
struct V_48 * V_48 )
{
...
V_235 . V_239 . V_239 . V_9 = V_9 ;
memset ( V_235 . V_239 . V_239 . V_2 , 0 , V_5 ) ;
strncpy ( V_235 . V_239 . V_239 . V_2 , V_2 , V_5 - 1 ) ;
V_235 . V_239 . V_12 . type = V_240 ;
V_17 = strlen ( V_235 . V_239 . V_239 . V_2 ) ;
V_17 = F_14 ( V_17 , sizeof( T_1 ) ) ;
V_235 . V_239 . V_12 . V_17 = sizeof( V_235 . V_239 ) -
( sizeof( V_235 . V_239 . V_239 . V_2 ) - V_17 ) ;
V_25 = F_119 ( V_233 , & V_235 , NULL , V_48 ) ;
return V_25 ;
}
int F_149 ( struct V_232 * V_233 ,
T_12 F_119 ,
struct V_48 * V_48 )
{
struct V_3 * type ;
...
int F_150 ( struct V_232 * V_233 V_165 ,
union V_234 * V_222 )
{
if ( F_1 ( V_222 -> V_239 . V_239 . V_9 ,
V_222 -> V_239 . V_239 . V_2 ) < 0 )
return - V_8 ;
return 0 ;
}
int F_151 ( struct V_232 * V_233 , int V_15 ,
struct V_83 * V_84 ,
T_12 F_119 )
{
union V_234 V_235 ;
struct V_241 * V_242 ;
T_4 V_17 = 0 , V_243 = 0 , V_244 ;
int V_25 V_82 = 0 ;
V_242 = F_152 ( & V_84 -> V_85 , V_15 , true ) ;
if ( ! V_242 )
return - 1 ;
memset ( & V_235 , 0 , sizeof( V_235 ) ) ;
V_235 . V_241 . V_12 . type = V_245 ;
V_17 = V_242 -> V_17 ;
V_243 = F_14 ( V_17 , sizeof( T_1 ) ) ;
V_244 = V_243 - V_17 ;
V_235 . V_241 . V_12 . V_17 = sizeof( V_235 . V_241 ) ;
V_235 . V_241 . V_17 = V_243 ;
F_119 ( V_233 , & V_235 , NULL , NULL ) ;
F_153 ( V_242 ) ;
F_12 ( V_15 , NULL , 0 , V_244 ) ;
return V_243 ;
}
int F_154 ( union V_234 * V_222 ,
struct V_57 * V_58 )
{
T_4 V_246 , V_244 , V_17 = V_222 -> V_241 . V_17 ;
V_163 V_155 = F_102 ( V_58 -> V_15 , 0 , V_174 ) ;
char V_16 [ V_247 ] ;
F_102 ( V_58 -> V_15 , V_155 + sizeof( struct V_248 ) ,
V_162 ) ;
V_246 = F_104 ( V_58 -> V_15 , V_58 -> V_213 ) ;
V_244 = F_14 ( V_246 , sizeof( T_1 ) ) - V_246 ;
if ( F_16 ( V_58 -> V_15 , V_16 , V_244 ) < 0 )
F_155 ( L_81 ) ;
if ( V_58 -> V_213 ) {
int V_249 = F_11 ( V_214 , V_16 , V_244 ) ;
if ( V_249 <= 0 || V_249 != V_244 )
F_155 ( L_82 ) ;
}
if ( V_246 + V_244 != V_17 )
F_155 ( L_83 ) ;
...
V_27 = V_41 -> V_45 + 1 ;
V_27 = F_14 ( V_27 , V_24 ) ;
memcpy ( & V_235 . V_46 . V_46 , V_41 -> V_46 , sizeof( V_41 -> V_46 ) ) ;
V_235 . V_46 . V_12 . type = V_250 ;
V_235 . V_46 . V_12 . V_39 = V_39 ;
V_235 . V_46 . V_38 = V_48 -> V_38 ;
V_235 . V_46 . V_12 . V_17 = sizeof( V_235 . V_46 ) + V_27 ;
memcpy ( & V_235 . V_46 . V_68 , V_41 -> V_47 , V_41 -> V_45 ) ;
V_25 = F_119 ( V_233 , & V_235 , NULL , V_48 ) ;
return V_25 ;
}
int F_157 ( struct V_232 * V_233 V_82 ,
union V_234 * V_222 ,
struct V_57 * V_58 )
{
F_95 ( & V_222 -> V_46 ,
