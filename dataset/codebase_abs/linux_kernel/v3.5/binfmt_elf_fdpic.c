...
{
int V_221 ;
if ( V_219 -> V_222 & ( V_223 | V_224 ) ) {
F_62 ( L_25 , V_219 -> V_225 , V_219 -> V_222 ) ;
return 0 ;
}
if ( ! ( V_219 -> V_222 & V_226 ) ) {
F_62 ( L_26 , V_219 -> V_225 , V_219 -> V_222 ) ;
return 0 ;
}
if ( V_219 -> V_222 & V_227 ) {
if ( V_219 -> V_228 -> V_192 . V_193 -> V_194 -> V_229 == 0 ) {
V_221 = F_63 ( V_230 , & V_220 ) ;
F_62 ( L_27 , V_219 -> V_225 ,
V_219 -> V_222 , V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
V_221 = F_63 ( V_231 , & V_220 ) ;
F_62 ( L_27 , V_219 -> V_225 ,
V_219 -> V_222 , V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
...
F_62 ( L_30 , V_219 -> V_225 ,
V_219 -> V_222 , V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
#endif
V_221 = F_63 ( V_234 , & V_220 ) ;
F_62 ( L_31 , V_219 -> V_225 , V_219 -> V_222 ,
V_221 ? L_28 : L_29 ) ;
return V_221 ;
}
static int F_64 ( struct V_235 * V_236 )
{
int V_237 ;
V_237 = sizeof( struct V_238 ) ;
V_237 += F_65 ( strlen ( V_236 -> V_239 ) + 1 , 4 ) ;
V_237 += F_65 ( V_236 -> V_240 , 4 ) ;
return V_237 ;
}
static int F_66 ( struct V_4 * V_4 , T_8 * V_241 )
{
static const char V_52 [ 4 ] = { 0 , } ;
F_67 ( V_52 , F_65 ( * V_241 , 4 ) - * V_241 , V_241 ) ;
return 1 ;
}
static int F_68 ( struct V_235 * V_242 , struct V_4 * V_4 ,
T_8 * V_241 )
{
struct V_238 V_236 ;
...
F_67 ( & V_236 , sizeof( V_236 ) , V_241 ) ;
F_67 ( V_242 -> V_239 , V_236 . V_243 , V_241 ) ;
if ( ! F_66 ( V_4 , V_241 ) )
return 0 ;
F_67 ( V_242 -> V_246 , V_242 -> V_240 , V_241 ) ;
if ( ! F_66 ( V_4 , V_241 ) )
return 0 ;
return 1 ;
}
static inline void F_69 ( struct V_2 * V_247 , int V_183 )
{
memcpy ( V_247 -> V_5 , V_6 , V_7 ) ;
V_247 -> V_5 [ V_248 ] = V_249 ;
V_247 -> V_5 [ V_250 ] = V_251 ;
V_247 -> V_5 [ V_252 ] = V_253 ;
V_247 -> V_5 [ V_254 ] = V_255 ;
memset ( V_247 -> V_5 + V_256 , 0 , V_257 - V_256 ) ;
V_247 -> V_8 = V_258 ;
V_247 -> V_259 = V_260 ;
V_247 -> V_261 = V_253 ;
V_247 -> V_186 = 0 ;
V_247 -> V_26 = sizeof( struct V_2 ) ;
V_247 -> V_262 = 0 ;
V_247 -> V_263 = V_264 ;
V_247 -> V_265 = sizeof( struct V_2 ) ;
V_247 -> V_20 = sizeof( struct V_21 ) ;
V_247 -> V_23 = V_183 ;
V_247 -> V_266 = 0 ;
V_247 -> V_267 = 0 ;
V_247 -> V_268 = 0 ;
...
static inline void F_70 ( struct V_21 * V_16 , int V_237 , T_8 V_269 )
{
V_16 -> V_28 = V_270 ;
V_16 -> V_59 = V_269 ;
V_16 -> V_63 = 0 ;
...
static inline void F_71 ( struct V_235 * V_273 , const char * V_239 , int type ,
...
static void F_72 ( struct V_274 * V_275 ,
struct V_276 * V_116 , long V_277 )
{
V_275 -> V_278 . V_279 = V_275 -> V_280 = V_277 ;
V_275 -> V_281 = V_116 -> V_282 . signal . V_283 [ 0 ] ;
V_275 -> V_284 = V_116 -> V_285 . V_283 [ 0 ] ;
F_73 () ;
V_275 -> V_286 = F_74 ( F_75 ( V_116 -> V_287 ) ) ;
F_76 () ;
V_275 -> V_288 = F_74 ( V_116 ) ;
V_275 -> V_289 = F_77 ( V_116 ) ;
V_275 -> V_290 = F_78 ( V_116 ) ;
if ( F_79 ( V_116 ) ) {
struct V_291 V_292 ;
F_80 ( V_116 , & V_292 ) ;
F_81 ( V_292 . V_293 , & V_275 -> V_294 ) ;
F_81 ( V_292 . V_295 , & V_275 -> V_296 ) ;
} else {
F_81 ( V_116 -> V_293 , & V_275 -> V_294 ) ;
F_81 ( V_116 -> V_295 , & V_275 -> V_296 ) ;
}
F_81 ( V_116 -> signal -> V_297 , & V_275 -> V_298 ) ;
F_81 ( V_116 -> signal -> V_299 , & V_275 -> V_300 ) ;
V_275 -> V_301 = V_116 -> V_72 -> V_78 . V_79 ;
V_275 -> V_302 = V_116 -> V_72 -> V_78 . V_80 ;
}
static int F_82 ( struct V_303 * V_304 , struct V_276 * V_116 ,
struct V_103 * V_72 )
{
...
if ( V_304 -> V_306 [ V_49 ] == 0 )
V_304 -> V_306 [ V_49 ] = ' ' ;
V_304 -> V_306 [ V_111 ] = 0 ;
F_73 () ;
V_304 -> V_286 = F_74 ( F_75 ( V_116 -> V_287 ) ) ;
F_76 () ;
V_304 -> V_288 = F_74 ( V_116 ) ;
V_304 -> V_289 = F_77 ( V_116 ) ;
V_304 -> V_290 = F_78 ( V_116 ) ;
V_49 = V_116 -> V_307 ? F_84 ( ~ V_116 -> V_307 ) + 1 : 0 ;
V_304 -> V_308 = V_49 ;
V_304 -> V_309 = ( V_49 > 5 ) ? '.' : L_32 [ V_49 ] ;
V_304 -> V_310 = V_304 -> V_309 == 'Z' ;
V_304 -> V_311 = F_85 ( V_116 ) ;
V_304 -> V_312 = V_116 -> V_32 ;
F_73 () ;
V_104 = F_86 ( V_116 ) ;
F_87 ( V_304 -> V_313 , F_47 ( V_104 -> V_150 , V_104 -> V_151 ) ) ;
F_88 ( V_304 -> V_314 , F_48 ( V_104 -> V_150 , V_104 -> V_155 ) ) ;
F_76 () ;
strncpy ( V_304 -> V_315 , V_116 -> V_316 , sizeof( V_304 -> V_315 ) ) ;
return 0 ;
}
static int F_89 ( long V_277 , struct V_317 * V_318 )
{
struct V_276 * V_116 = V_318 -> V_319 ;
int V_237 = 0 ;
V_318 -> V_320 = 0 ;
F_72 ( & V_318 -> V_275 , V_116 , V_277 ) ;
F_90 ( V_116 , & V_318 -> V_275 . V_321 ) ;
F_71 ( & V_318 -> V_322 [ 0 ] , L_33 , V_323 , sizeof( V_318 -> V_275 ) ,
& V_318 -> V_275 ) ;
V_318 -> V_320 ++ ;
V_237 += F_64 ( & V_318 -> V_322 [ 0 ] ) ;
V_318 -> V_275 . V_324 = F_91 ( V_116 , NULL , & V_318 -> V_325 ) ;
if ( V_318 -> V_275 . V_324 ) {
F_71 ( & V_318 -> V_322 [ 1 ] , L_33 , V_326 , sizeof( V_318 -> V_325 ) ,
& V_318 -> V_325 ) ;
V_318 -> V_320 ++ ;
V_237 += F_64 ( & V_318 -> V_322 [ 1 ] ) ;
}
#ifdef F_92
if ( F_93 ( V_116 , & V_318 -> V_327 ) ) {
F_71 ( & V_318 -> V_322 [ 2 ] , L_34 , V_328 ,
sizeof( V_318 -> V_327 ) , & V_318 -> V_327 ) ;
V_318 -> V_320 ++ ;
V_237 += F_64 ( & V_318 -> V_322 [ 2 ] ) ;
}
#endif
return V_237 ;
}
static void F_94 ( struct V_2 * V_247 , struct V_329 * V_330 ,
V_133 V_262 , int V_183 )
{
V_247 -> V_262 = V_262 ;
V_247 -> V_266 = sizeof( * V_330 ) ;
V_247 -> V_267 = 1 ;
V_247 -> V_268 = V_331 ;
memset ( V_330 , 0 , sizeof( * V_330 ) ) ;
V_330 -> V_332 = V_333 ;
V_330 -> V_334 = V_247 -> V_267 ;
V_330 -> V_335 = V_247 -> V_268 ;
V_330 -> V_336 = V_183 ;
}
static int F_95 ( struct V_4 * V_4 , T_5 * V_17 ,
unsigned long * V_337 , unsigned long V_220 )
{
struct V_218 * V_219 ;
int V_338 = 0 ;
for ( V_219 = V_50 -> V_72 -> V_12 ; V_219 ; V_219 = V_219 -> V_339 ) {
unsigned long V_187 ;
if ( ! F_61 ( V_219 , V_220 ) )
continue;
for ( V_187 = V_219 -> V_225 ; V_187 < V_219 -> V_340 ;
V_187 += V_86 ) {
struct V_174 * V_174 = F_96 ( V_187 ) ;
if ( V_174 ) {
void * V_341 = F_54 ( V_174 ) ;
* V_17 += V_86 ;
if ( * V_17 > * V_337 )
V_338 = - V_342 ;
else if ( ! F_97 ( V_4 , V_341 , V_86 ) )
V_338 = - V_343 ;
F_55 ( V_174 ) ;
F_98 ( V_174 ) ;
...
if ( ( * V_17 += V_86 ) > * V_337 )
return - V_342 ;
if ( ! F_97 ( V_4 , ( void * ) V_219 -> V_225 ,
V_219 -> V_340 - V_219 -> V_225 ) )
return - V_343 ;
}
return 0 ;
}
...
for ( V_219 = V_50 -> V_72 -> V_12 ; V_219 ; V_219 = V_219 -> V_339 )
if ( F_61 ( V_219 , V_220 ) )
V_17 += V_219 -> V_340 - V_219 -> V_225 ;
return V_17 ;
}
static int F_101 ( struct V_344 * V_345 )
{
#define F_102 6
int V_346 = 0 ;
T_9 V_347 ;
...
T_8 V_269 = 0 , V_348 , V_241 ;
int V_349 ;
struct V_235 * V_322 = NULL ;
...
int V_352 = 0 ;
V_133 * V_353 ;
struct V_21 * V_354 = NULL ;
struct V_329 * V_330 = NULL ;
T_12 V_23 ;
V_133 V_262 ;
V_247 = F_9 ( sizeof( * V_247 ) , V_25 ) ;
if ( ! V_247 )
goto V_355;
V_275 = F_56 ( sizeof( * V_275 ) , V_25 ) ;
if ( ! V_275 )
goto V_355;
V_304 = F_9 ( sizeof( * V_304 ) , V_25 ) ;
if ( ! V_304 )
goto V_355;
V_322 = F_9 ( F_102 * sizeof( struct V_235 ) , V_25 ) ;
if ( ! V_322 )
goto V_355;
...
if ( ! V_180 )
goto V_355;
V_180 -> V_319 = V_357 -> V_361 ;
F_104 ( & V_180 -> V_362 , & V_350 ) ;
}
F_105 (t, &thread_list) {
struct V_317 * V_180 ;
int V_237 ;
V_180 = F_106 ( V_318 , struct V_317 , V_362 ) ;
V_237 = F_89 ( V_345 -> V_277 , V_180 ) ;
V_352 += V_237 ;
}
}
F_72 ( V_275 , V_50 , V_345 -> V_277 ) ;
F_107 ( & V_275 -> V_321 , V_345 -> V_40 ) ;
...
V_346 = 1 ;
V_50 -> V_32 |= V_365 ;
F_71 ( V_322 + 0 , L_33 , V_323 , sizeof( * V_275 ) , V_275 ) ;
F_82 ( V_304 , V_50 -> V_366 , V_50 -> V_72 ) ;
F_71 ( V_322 + 1 , L_33 , V_367 , sizeof( * V_304 ) , V_304 ) ;
V_349 = 2 ;
V_353 = ( V_133 * ) V_50 -> V_72 -> V_368 ;
V_49 = 0 ;
do
V_49 += 2 ;
while ( V_353 [ V_49 - 2 ] != V_131 );
F_71 ( & V_322 [ V_349 ++ ] , L_33 , V_369 ,
V_49 * sizeof( V_133 ) , V_353 ) ;
if ( ( V_275 -> V_324 =
F_91 ( V_50 , V_345 -> V_40 , V_325 ) ) )
F_71 ( V_322 + V_349 ++ ,
L_33 , V_326 , sizeof( * V_325 ) , V_325 ) ;
#ifdef F_92
if ( F_93 ( V_50 , V_327 ) )
F_71 ( V_322 + V_349 ++ ,
L_34 , V_328 , sizeof( * V_327 ) , V_327 ) ;
#endif
V_347 = F_109 () ;
F_110 ( V_370 ) ;
V_269 += sizeof( * V_247 ) ;
V_269 += V_183 * sizeof( struct V_21 ) ;
V_241 = V_269 ;
{
int V_237 = 0 ;
for ( V_49 = 0 ; V_49 < V_349 ; V_49 ++ )
V_237 += F_64 ( V_322 + V_49 ) ;
V_237 += V_352 ;
V_354 = F_9 ( sizeof( * V_354 ) , V_25 ) ;
if ( ! V_354 )
goto V_371;
F_70 ( V_354 , V_237 , V_269 ) ;
V_269 += V_237 ;
}
V_348 = V_269 = F_65 ( V_269 , V_372 ) ;
V_269 += F_100 ( V_345 -> V_220 ) ;
V_269 += F_111 () ;
V_262 = V_269 ;
if ( V_23 == V_364 ) {
...
if ( ! V_330 )
goto V_371;
F_94 ( V_247 , V_330 , V_262 , V_183 ) ;
}
V_269 = V_348 ;
V_17 += sizeof( * V_247 ) ;
if ( V_17 > V_345 -> V_337 || ! F_97 ( V_345 -> V_4 , V_247 , sizeof( * V_247 ) ) )
goto V_371;
V_17 += sizeof( * V_354 ) ;
if ( V_17 > V_345 -> V_337
|| ! F_97 ( V_345 -> V_4 , V_354 , sizeof( * V_354 ) ) )
goto V_371;
for ( V_219 = V_50 -> V_72 -> V_12 ; V_219 ; V_219 = V_219 -> V_339 ) {
struct V_21 V_16 ;
T_5 V_237 ;
V_237 = V_219 -> V_340 - V_219 -> V_225 ;
V_16 . V_28 = V_61 ;
V_16 . V_59 = V_269 ;
V_16 . V_63 = V_219 -> V_225 ;
V_16 . V_271 = 0 ;
V_16 . V_56 = F_61 ( V_219 , V_345 -> V_220 ) ? V_237 : 0 ;
V_16 . V_36 = V_237 ;
V_269 += V_16 . V_56 ;
V_16 . V_30 = V_219 -> V_222 & V_226 ? V_210 : 0 ;
...
V_17 += sizeof( V_16 ) ;
if ( V_17 > V_345 -> V_337
|| ! F_97 ( V_345 -> V_4 , & V_16 , sizeof( V_16 ) ) )
goto V_371;
}
if ( ! F_112 ( V_345 -> V_4 , V_269 , & V_17 , V_345 -> V_337 ) )
goto V_371;
for ( V_49 = 0 ; V_49 < V_349 ; V_49 ++ )
if ( ! F_68 ( V_322 + V_49 , V_345 -> V_4 , & V_241 ) )
goto V_371;
F_105 (t, &thread_list) {
struct V_317 * V_180 =
F_106 ( V_318 , struct V_317 , V_362 ) ;
for ( V_49 = 0 ; V_49 < V_180 -> V_320 ; V_49 ++ )
if ( ! F_68 ( & V_180 -> V_322 [ V_49 ] , V_345 -> V_4 , & V_241 ) )
goto V_371;
}
if ( ! F_99 ( V_345 -> V_4 , V_348 - V_241 ) )
goto V_371;
if ( F_95 ( V_345 -> V_4 , & V_17 , & V_345 -> V_337 ,
V_345 -> V_220 ) < 0 )
goto V_371;
if ( ! F_113 ( V_345 -> V_4 , & V_17 , V_345 -> V_337 ) )
goto V_371;
if ( V_23 == V_364 ) {
V_17 += sizeof( * V_330 ) ;
if ( V_17 > V_345 -> V_337
|| ! F_97 ( V_345 -> V_4 , V_330 ,
sizeof( * V_330 ) ) )
goto V_371;
}
if ( V_345 -> V_4 -> V_374 != V_269 ) {
F_30 ( V_375
L_35 ,
V_345 -> V_4 -> V_374 , V_269 ) ;
}
V_371:
F_110 ( V_347 ) ;
V_355:
while ( ! F_114 ( & V_350 ) ) {
struct V_351 * V_180 = V_350 . V_360 ;
F_115 ( V_180 ) ;
F_39 ( F_106 ( V_180 , struct V_317 , V_362 ) ) ;
}
F_39 ( V_354 ) ;
F_39 ( V_247 ) ;
F_39 ( V_275 ) ;
