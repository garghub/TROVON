...
static void F_17 ( unsigned long * V_2 , T_1 V_34 ,
T_1 V_3 , T_1 * V_22 , T_1 * V_23 )
{
int V_32 = V_34 ;
V_32 = F_22 ( V_2 , V_3 , V_34 ) ;
if ( V_32 < V_3 )
* V_22 = V_32 ;
if ( * V_22 ) {
V_32 = F_23 ( V_2 , V_3 , V_32 ) ;
if ( V_32 < V_3 )
* V_23 = V_32 - 1 ;
}
}
...
& V_22 ,
& V_23 ) ) {
V_36 [ V_37 ] . V_22 = F_27 ( V_22 ) ;
V_36 [ V_37 ] . V_23 = F_27 ( V_23 ) ;
V_37 ++ ;
if ( V_37 >= V_38 )
break;
}
...
if ( V_12 >= V_13 )
return 0 ;
V_40 = F_28 ( ( V_12 - V_2 -> V_3 ) , V_41 ) + V_42 ;
V_3 = F_29 ( T_5 , V_2 -> V_3 + V_40 , V_13 ) ;
V_39 = F_2 ( V_3 >> 3 , V_43 ) ;
if ( ! V_39 )
return 0 ;
F_30 ( V_39 , V_2 -> V_6 , V_2 -> V_9 - V_2 -> V_7 ) ;
F_5 ( V_2 -> V_6 ) ;
V_2 -> V_6 = V_39 ;
V_2 -> V_3 = V_3 ;
return 1 ;
