...
static struct V_3 * F_21 ( struct V_60 * V_61 , struct V_17 * V_18 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
struct V_33 * V_34 ;
struct V_3 * V_4 = NULL ;
V_34 = F_22 ( V_61 , struct V_33 , V_53 ) ;
if ( V_34 -> V_35 ) {
V_4 = F_10 ( V_34 ) ;
...
static struct V_3 * F_23 ( struct V_17 * V_18 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
struct V_3 * V_4 ;
struct V_33 * V_34 ;
...
V_34 = F_24 ( V_35 , struct V_33 , V_51 ) ;
if ( V_34 -> V_55 <= 0 ) {
V_34 -> V_55 += V_2 -> V_56 ;
F_25 ( & V_34 -> V_51 , & V_2 -> V_66 ) ;
goto V_65;
}
V_63 = V_2 -> V_67 . V_68 ;
V_64 = V_2 -> V_67 . V_69 ;
V_4 = F_26 ( V_18 , & V_2 -> V_70 , & V_34 -> V_53 , & V_2 -> V_67 ,
F_21 ) ;
...
{
struct V_3 * V_4 ;
while ( ( V_4 = F_23 ( V_18 ) ) != NULL )
F_14 ( V_4 ) ;
}
static int F_30 ( struct V_17 * V_18 , struct V_71 * V_72 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
...
if ( ! V_72 )
return - V_76 ;
V_75 = F_31 ( V_73 , V_74 , V_72 , V_77 ) ;
if ( V_75 < 0 )
return V_75 ;
if ( V_73 [ V_78 ] ) {
if ( V_2 -> V_43 )
return - V_76 ;
V_2 -> V_16 = F_32 ( V_73 [ V_78 ] ) ;
if ( ! V_2 -> V_16 ||
V_2 -> V_16 > 65536 )
return - V_76 ;
}
F_33 ( V_18 ) ;
if ( V_73 [ V_79 ] ) {
V_15 V_80 = F_32 ( V_73 [ V_79 ] ) ;
V_2 -> V_70 . V_80 = ( V_80 * V_81 ) >> V_82 ;
}
if ( V_73 [ V_83 ] ) {
V_15 V_84 = F_32 ( V_73 [ V_83 ] ) ;
V_2 -> V_70 . V_84 = ( V_84 * V_81 ) >> V_82 ;
}
if ( V_73 [ V_85 ] )
V_18 -> V_57 = F_32 ( V_73 [ V_85 ] ) ;
if ( V_73 [ V_86 ] )
V_2 -> V_70 . V_87 = ! ! F_32 ( V_73 [ V_86 ] ) ;
if ( V_73 [ V_88 ] )
V_2 -> V_56 = F_34 ( 256U , F_32 ( V_73 [ V_88 ] ) ) ;
while ( V_18 -> V_2 . V_44 > V_18 -> V_57 ) {
...
static void * F_36 ( T_1 V_89 )
{
void * V_90 = F_37 ( V_89 , V_91 | V_92 ) ;
if ( ! V_90 )
V_90 = F_38 ( V_89 ) ;
return V_90 ;
}
static void F_39 ( void * V_93 )
{
if ( V_93 ) {
if ( F_40 ( V_93 ) )
F_41 ( V_93 ) ;
...
static int F_45 ( struct V_17 * V_18 , struct V_71 * V_72 )
{
struct V_1 * V_2 = F_5 ( V_18 ) ;
int V_40 ;
V_18 -> V_57 = 10 * 1024 ;
V_2 -> V_16 = 1024 ;
V_2 -> V_56 = F_46 ( F_47 ( V_18 ) ) ;
V_2 -> V_14 = F_48 () ;
F_49 ( & V_2 -> V_52 ) ;
F_49 ( & V_2 -> V_66 ) ;
F_50 ( & V_2 -> V_70 ) ;
...
V_2 -> V_70 . V_87 = true ;
if ( V_72 ) {
int V_75 = F_30 ( V_18 , V_72 ) ;
if ( V_75 )
return V_75 ;
}
if ( ! V_2 -> V_43 ) {
V_2 -> V_43 = F_36 ( V_2 -> V_16 *
sizeof( struct V_33 ) ) ;
if ( ! V_2 -> V_43 )
return - V_94 ;
V_2 -> V_42 = F_36 ( V_2 -> V_16 * sizeof( V_9 ) ) ;
if ( ! V_2 -> V_42 ) {
F_39 ( V_2 -> V_43 ) ;
return - V_94 ;
}
...
V_103 . V_106 . V_58 = V_2 -> V_58 ;
V_103 . V_106 . V_69 = V_2 -> V_67 . V_69 ;
V_103 . V_106 . V_54 = V_2 -> V_54 ;
...
V_119 . type = V_120 ;
V_119 . V_121 . V_55 = V_34 -> V_55 ;
V_119 . V_121 . V_122 =
F_55 ( V_34 -> V_53 . V_122 ) ;
V_119 . V_121 . V_123 = V_34 -> V_53 . V_123 ;
V_119 . V_121 . V_124 = V_34 -> V_53 . V_124 ;
V_119 . V_121 . V_125 = V_34 -> V_53 . V_125 ;
if ( V_34 -> V_53 . V_125 ) {
T_2 V_126 = V_34 -> V_53 . V_127 -
F_67 () ;
