...
static int F_38 ( struct V_9 * V_10 , unsigned long V_83 ,
struct V_18 * V_19 ,
...
int V_87 ;
struct V_88 V_89 ;
V_87 = F_39 ( V_10 , V_85 , V_86 , & V_89 , & V_90 ) ;
if ( V_87 < 0 )
return V_87 ;
V_87 = - V_81 ;
if ( V_85 [ V_91 ] ) {
T_4 V_65 = F_40 ( V_85 [ V_91 ] ) ;
...
if ( V_85 [ V_94 ] ) {
V_21 -> V_12 . V_95 = F_40 ( V_85 [ V_94 ] ) ;
F_41 ( V_10 , & V_21 -> V_12 , V_83 ) ;
}
#ifdef F_9
if ( V_85 [ V_96 ] ) {
V_87 = F_42 ( V_10 , V_21 -> V_50 , V_85 [ V_96 ] ) ;
if ( V_87 < 0 )
goto V_93;
}
#endif
F_43 ( V_10 , & V_21 -> V_52 , & V_89 ) ;
return 0 ;
V_93:
F_27 ( V_10 , & V_89 ) ;
return V_87 ;
}
static int F_44 ( struct V_9 * V_10 , unsigned long V_83 , T_4 V_65 ,
struct V_84 * * V_97 ,
unsigned long * V_80 )
{
struct V_63 * V_64 = V_10 -> V_41 ;
...
if ( V_99 == NULL )
return V_65 ? - V_81 : 0 ;
V_87 = F_45 ( V_85 , V_101 , V_99 , V_103 ) ;
if ( V_87 < 0 )
return V_87 ;
...
if ( F_19 ( V_21 -> V_65 ) == 0 )
return - V_81 ;
return F_38 ( V_10 , V_83 , V_21 -> V_62 , V_21 , V_85 , V_97 [ V_104 ] ) ;
}
if ( V_85 [ V_105 ] ) {
unsigned int V_54 = F_40 ( V_85 [ V_105 ] ) ;
if ( -- V_54 > 0x100 )
return - V_81 ;
if ( F_19 ( V_65 ) )
return - V_81 ;
...
if ( V_85 [ V_107 ] ) {
V_102 = F_40 ( V_85 [ V_107 ] ) ;
if ( F_18 ( V_102 ) == V_67 ) {
V_19 = V_10 -> V_20 ;
V_102 = V_19 -> V_65 ;
} else {
V_19 = F_14 ( V_10 -> V_41 , F_18 ( V_102 ) ) ;
if ( V_19 == NULL )
return - V_81 ;
}
} else {
...
if ( V_19 -> V_54 < F_16 ( V_102 ) )
return - V_81 ;
if ( V_65 ) {
if ( F_18 ( V_65 ) && F_18 ( V_65 ^ V_102 ) )
return - V_81 ;
V_65 = V_102 | F_37 ( V_65 ) ;
} else
V_65 = F_36 ( V_19 , V_102 ) ;
if ( V_85 [ V_108 ] == NULL )
return - V_81 ;
V_98 = F_46 ( V_85 [ V_108 ] ) ;
V_21 = F_23 ( sizeof( * V_21 ) + V_98 -> V_38 * sizeof( struct V_29 ) , V_73 ) ;
if ( V_21 == NULL )
return - V_74 ;
#ifdef F_5
V_21 -> V_31 = F_23 ( sizeof( struct V_109 ) + V_98 -> V_38 * sizeof( V_110 ) , V_73 ) ;
if ( V_21 -> V_31 == NULL ) {
F_24 ( V_21 ) ;
return - V_74 ;
}
...
V_21 -> V_62 = V_19 ;
V_21 -> V_65 = V_65 ;
V_21 -> V_4 = V_98 -> V_6 ? F_47 ( F_2 ( V_98 -> V_6 ) ) - 1 : 0 ;
#ifdef F_6
if ( V_85 [ V_111 ] ) {
struct V_112 * V_33 ;
V_33 = F_46 ( V_85 [ V_111 ] ) ;
memcpy ( & V_21 -> V_33 , V_33 , sizeof( struct V_112 ) ) ;
V_21 -> V_33 . V_37 = 0 ;
}
#endif
V_87 = F_38 ( V_10 , V_83 , V_19 , V_21 , V_85 , V_97 [ V_104 ] ) ;
if ( V_87 == 0 ) {
struct V_13 * * V_113 ;
for ( V_113 = & V_19 -> V_19 [ F_16 ( V_65 ) ] ; * V_113 ; V_113 = & ( * V_113 ) -> V_36 )
if ( F_37 ( V_65 ) < F_37 ( ( * V_113 ) -> V_65 ) )
break;
V_21 -> V_36 = * V_113 ;
F_29 ( V_10 ) ;
* V_113 = V_21 ;
...
static void F_48 ( struct V_9 * V_10 , struct V_114 * V_80 )
{
struct V_63 * V_64 = V_10 -> V_41 ;
struct V_18 * V_19 ;
struct V_13 * V_21 ;
...
static int F_49 ( struct V_9 * V_10 , unsigned long V_119 ,
...
if ( F_51 ( V_8 , V_107 , V_102 ) )
goto V_124;
}
if ( V_21 -> V_12 . V_95 &&
F_51 ( V_8 , V_94 , V_21 -> V_12 . V_95 ) )
goto V_124;
if ( V_21 -> V_46 &&
F_51 ( V_8 , V_91 , V_21 -> V_46 -> V_65 ) )
goto V_124;
#ifdef F_6
if ( ( V_21 -> V_33 . V_35 || V_21 -> V_33 . V_34 ) &&
F_52 ( V_8 , V_111 , sizeof( V_21 -> V_33 ) , & V_21 -> V_33 ) )
goto V_124;
#endif
if ( F_53 ( V_8 , & V_21 -> V_52 , & V_90 ) < 0 )
goto V_124;
#ifdef F_9
if ( strlen ( V_21 -> V_50 ) &&
F_54 ( V_8 , V_96 , V_21 -> V_50 ) )
goto V_124;
#endif
#ifdef F_5
if ( F_52 ( V_8 , V_125 ,
