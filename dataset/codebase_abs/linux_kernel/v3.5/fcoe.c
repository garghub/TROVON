...
V_154 = F_76 ( V_152 ) ;
V_67 = F_157 ( V_152 ) ;
V_259 = V_67 -> V_239 / V_269 ;
if ( ! V_75 -> V_79 ) {
F_128 ( V_67 ) ;
return 0 ;
}
if ( F_136 ( V_154 -> V_270 == V_271 ) &&
F_158 ( V_47 , V_75 , V_67 ) )
return 0 ;
V_266 = F_159 ( V_152 ) ;
V_267 = F_160 ( V_152 ) ;
V_265 = sizeof( struct V_236 ) ;
V_264 = sizeof( struct V_110 ) ;
V_258 = sizeof( struct V_111 ) ;
V_259 = ( V_67 -> V_239 - V_258 + sizeof( V_260 ) ) / V_269 ;
if ( F_117 ( V_75 -> V_91 ) ) {
V_67 -> V_272 = V_273 ;
V_67 -> V_274 = F_161 ( V_67 ) ;
V_67 -> V_275 = V_67 -> V_239 ;
V_260 = 0 ;
} else {
V_67 -> V_272 = V_276 ;
V_260 = F_162 ( V_152 ) ;
...
V_277 = & F_164 ( V_67 ) -> V_278 [ F_164 ( V_67 ) -> V_279 - 1 ] ;
V_261 = F_165 ( F_166 ( V_277 ) )
+ V_277 -> V_280 ;
} else {
...
V_261 -> V_281 = V_267 ;
V_261 -> V_282 = F_168 ( ~ V_260 ) ;
if ( F_163 ( V_67 ) ) {
F_169 ( V_261 ) ;
V_261 = NULL ;
}
F_170 ( V_67 , V_265 + V_264 ) ;
F_171 ( V_67 ) ;
F_172 ( V_67 ) ;
V_67 -> V_283 = V_265 ;
V_67 -> V_284 = F_13 ( V_38 ) ;
V_67 -> V_285 = V_72 -> V_285 ;
if ( V_2 -> V_4 -> V_16 & V_21 &&
V_2 -> V_22 -> V_97 & V_286 ) {
V_67 -> V_287 = V_288 |
F_173 ( V_2 -> V_4 ) ;
...
V_47 = F_2 ( V_2 ) ;
if ( F_140 ( V_47 ) && F_180 ( V_152 ) == V_303 &&
F_145 ( V_154 -> V_304 ) == V_305 ) {
F_18 ( L_50 ) ;
return - V_112 ;
}
if ( ! ( F_179 ( V_152 ) & V_300 ) ||
...
V_72 = F_43 ( V_75 ) ;
F_185 ( V_67 ) ;
V_268 = (struct V_110 * ) F_186 ( V_67 ) ;
V_263 = F_149 ( V_75 -> V_256 , F_125 () ) ;
if ( F_136 ( F_187 ( V_268 ) != V_292 ) ) {
if ( V_263 -> V_257 < 5 )
F_66 ( V_307 L_55
L_56
L_57
...
V_263 -> V_310 ++ ;
V_263 -> V_311 += F_156 / V_269 ;
V_152 = (struct V_151 * ) V_67 ;
F_189 ( V_152 ) ;
V_249 ( V_152 ) = V_75 ;
F_159 ( V_152 ) = V_268 -> V_293 ;
if ( F_190 ( V_67 , F_156 , & V_215 , sizeof( V_215 ) ) )
goto V_309;
F_160 ( V_152 ) = V_215 . V_281 ;
F_182 ( V_152 ) = V_215 . V_282 ;
if ( F_191 ( V_67 , F_156 ) )
goto V_309;
if ( ! F_178 ( V_75 , V_152 ) ) {
F_129 () ;
...
static int V_211 ( void * V_312 )
{
struct V_206 * V_207 = V_312 ;
struct V_66 * V_67 ;
struct V_313 V_314 ;
F_53 ( & V_314 ) ;
F_193 ( V_315 , - 20 ) ;
while ( ! F_194 () ) {
F_121 ( & V_207 -> V_212 . V_213 ) ;
F_195 ( & V_207 -> V_212 , & V_314 ) ;
F_122 ( & V_207 -> V_212 . V_213 ) ;
while ( ( V_67 = F_126 ( & V_314 ) ) != NULL )
F_184 ( V_67 ) ;
F_121 ( & V_207 -> V_212 . V_213 ) ;
if ( ! F_196 ( & V_207 -> V_212 ) ) {
F_197 ( V_255 ) ;
F_122 ( & V_207 -> V_212 . V_213 ) ;
F_198 () ;
F_197 ( V_316 ) ;
...
V_324 = F_208 ( V_323 -> V_325 . V_285 ) - 1 ;
else
...
V_72 -> V_285 = F_208 ( V_351 ) ? F_208 ( V_351 ) - 1 : 0 ;
V_47 -> V_285 = F_208 ( V_350 ) ? F_208 ( V_350 ) - 1 : V_72 -> V_285 ;
}
#endif
}
...
static void F_248 ( struct V_379 * V_380 , struct V_151 * V_152 , void * V_312 )
{
...
static void F_253 ( struct V_379 * V_380 , struct V_151 * V_152 , void * V_312 )
{
...
V_6 , V_389 ) ;
case V_303 :
if ( F_145 ( V_154 -> V_248 ) != V_305 )
break;
return F_257 ( V_75 , V_387 , V_152 , V_388 , F_253 ,
V_75 , V_389 ) ;
}
return F_257 ( V_75 , V_387 , V_152 , V_388 , F_256 , V_312 , V_389 ) ;
}
