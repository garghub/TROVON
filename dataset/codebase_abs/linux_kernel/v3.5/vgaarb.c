...
static inline void F_7 ( struct V_9 * V_12 , bool V_14 )
{
if ( V_12 -> V_15 )
...
static struct V_9 * F_10 ( struct V_9 * V_12 ,
unsigned int V_18 )
{
...
if ( V_34 )
V_24 |= V_41 ;
F_14 ( V_22 -> V_11 , false , V_23 , V_24 ) ;
V_22 -> V_29 &= ~ V_33 ;
if ( V_33 & V_3 )
V_22 -> V_29 &= ~ V_27 ;
if ( V_33 & V_2 )
...
static void F_15 ( struct V_9 * V_12 , unsigned int V_18 )
{
...
int F_17 ( struct V_10 * V_11 , unsigned int V_18 , int V_48 )
{
...
int F_26 ( struct V_10 * V_11 , unsigned int V_18 )
{
struct V_9 * V_12 ;
unsigned long V_24 ;
int V_50 = 0 ;
...
void F_27 ( struct V_10 * V_11 , unsigned int V_18 )
{
struct V_9 * V_12 ;
unsigned long V_24 ;
if ( V_11 == NULL )
...
static void F_28 ( struct V_9 * V_12 )
{
struct V_9 * V_60 ;
...
if ( ( V_11 -> V_69 >> 8 ) != V_70 )
return false ;
V_12 = F_31 ( sizeof( struct V_9 ) , V_71 ) ;
if ( V_12 == NULL ) {
F_32 ( L_8 ) ;
return false ;
}
...
if ( ( V_83 != V_12 ) &&
( V_83 -> V_26 & V_31 ) ) {
F_38 ( L_11 , F_39 ( V_12 -> V_11 ) , F_39 ( V_83 -> V_11 ) ) ;
V_22 = F_10 ( V_83 , V_31 ) ;
if ( ! V_22 )
F_15 ( V_83 , V_31 ) ;
break;
...
static unsigned int F_59 ( struct V_92 * V_92 , T_8 * V_49 )
{
struct V_94 * V_95 = V_92 -> V_96 ;
F_11 ( L_7 , V_28 ) ;
if ( V_95 == NULL )
...
static int F_61 ( struct V_119 * V_119 , struct V_92 * V_92 )
{
struct V_94 * V_95 ;
unsigned long V_24 ;
F_11 ( L_7 , V_28 ) ;
V_95 = F_62 ( sizeof( * V_95 ) , V_71 ) ;
if ( V_95 == NULL )
return - V_99 ;
F_63 ( & V_95 -> V_120 ) ;
V_92 -> V_96 = V_95 ;
F_18 ( & V_121 , V_24 ) ;
F_37 ( & V_95 -> V_78 , & V_122 ) ;
F_19 ( & V_121 , V_24 ) ;
V_95 -> V_100 = F_5 () ;
...
static int F_64 ( struct V_119 * V_119 , struct V_92 * V_92 )
{
struct V_94 * V_95 = V_92 -> V_96 ;
struct V_104 * V_105 ;
unsigned long V_24 ;
...
static int F_65 ( struct V_124 * V_125 , unsigned long V_126 ,
void * V_127 )
{
struct V_128 * V_129 = V_127 ;
struct V_10 * V_11 = F_66 ( V_129 ) ;
bool V_130 = false ;
F_11 ( L_7 , V_28 ) ;
if ( V_126 == V_131 )
V_130 = F_30 ( V_11 ) ;
...
F_4 (vgadev, &vga_list, list) {
if ( V_12 -> V_37 )
F_38 ( L_39 , F_39 ( V_12 -> V_11 ) ) ;
else
F_38 ( L_40 , F_39 ( V_12 -> V_11 ) ) ;
}
return V_50 ;
}
