...
if ( V_32 )
memcpy ( F_15 ( V_24 , V_32 ) , V_33 , V_32 ) ;
V_25 = V_5 -> V_26 -> V_29 ( V_5 -> V_26 , V_24 ) ;
if ( V_25 ) {
F_2 ( V_30 L_2 , V_31 ,
F_3 ( & V_5 -> V_13 ) , V_25 ) ;
...
memcpy ( F_15 ( V_24 , V_65 ) , V_106 , V_65 ) ;
F_38 ( V_5 , V_24 ) ;
}
inline T_3
...
F_2 ( V_30
L_17 ,
F_3 ( & V_5 -> V_13 ) , V_65 , V_69 ) ;
V_153 = V_46 ;
V_46 = F_13 ( V_153 -> V_32 + V_65 , V_36 ) ;
if ( ! V_46 ) {
F_11 ( V_153 ) ;
F_2 ( V_30 L_18 ,
F_3 ( & V_5 -> V_13 ) , V_31 ) ;
...
memcpy ( F_15 ( V_46 , V_65 ) , V_75 , V_65 ) ;
memcpy ( F_15 ( V_46 , V_153 -> V_32 ) , V_153 -> V_85 , V_153 -> V_32 ) ;
F_11 ( V_153 ) ;
}
...
static void
F_135 ( struct V_1 * V_2 , int V_51 , void * V_33 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
F_27 ( V_5 , V_123 , V_33 ) ;
F_69 ( V_2 ) ;
...
static int
F_136 ( struct V_4 * V_5 , struct V_34 * V_35 , struct V_23 * V_24 )
{
T_3 * V_100 = V_24 -> V_85 ;
int V_37 = - V_158 ;
int V_159 , V_160 ;
...
if ( ( V_160 != V_5 -> V_15 ) && ( V_160 != V_155 ) ) {
if ( * V_10 & V_101 )
F_2 ( V_12 L_21 ,
F_3 ( & V_5 -> V_13 ) , V_160 , V_5 -> V_15 ) ;
F_11 ( V_24 ) ;
return 0 ;
}
} else
...
V_58 = F_54 ( V_5 , V_24 ) ;
if ( ! V_58 )
V_37 = F_25 ( & V_5 -> V_49 , V_170 , V_24 ) ;
} else
V_58 = 'L' ;
if ( V_58 ) {
F_2 ( V_30 L_22 ,
F_3 ( & V_5 -> V_13 ) , V_58 ) ;
F_25 ( & V_5 -> V_49 , V_162 , ( void * ) ( long ) V_58 ) ;
}
return V_37 ;
}
static int
F_137 ( struct V_171 * V_13 , struct V_23 * V_24 )
{
struct V_4 * V_5 = F_138 ( V_13 , struct V_4 , V_13 ) ;
struct V_34 * V_35 = F_14 ( V_24 ) ;
int V_37 = - V_158 ;
if ( * V_10 & V_40 )
F_2 ( V_12 L_23 ,
...
case V_180 :
F_24 ( V_177 , & V_5 -> V_18 ) ;
F_12 ( V_5 , V_181 , 0 , NULL ) ;
V_37 = F_25 ( & V_5 -> V_49 , V_182 , V_24 ) ;
break;
case V_183 :
if ( ! V_5 -> V_26 )
break;
...
break;
case V_184 :
V_37 = F_25 ( & V_5 -> V_49 , V_185 , V_24 ) ;
break;
case V_186 :
V_37 = F_25 ( & V_5 -> V_49 , V_187 , V_24 ) ;
break;
case V_188 :
if ( F_5 ( V_117 , & V_5 -> V_18 ) )
F_18 ( V_80 , & V_5 -> V_18 ) ;
if ( F_5 ( V_177 , & V_5 -> V_18 ) ) {
if ( F_5 ( V_19 , & V_5 -> V_18 ) ||
F_5 ( V_80 , & V_5 -> V_18 ) )
V_37 = F_25 ( & V_5 -> V_49 ,
V_179 , V_24 ) ;
...
int
F_139 ( struct V_4 * V_5 , T_2 V_104 , V_60 V_33 )
{
int V_37 = - V_158 ;
if ( * V_10 & V_194 )
F_2 ( V_12 L_26 ,
...
switch ( V_104 ) {
case ( V_195 ) :
V_37 = F_25 ( & V_5 -> V_49 , V_196 , ( void * ) V_33 ) ;
break;
case ( V_197 ) :
V_37 = F_25 ( & V_5 -> V_49 , V_198 , NULL ) ;
break;
case ( V_123 ) :
V_37 = F_25 ( & V_5 -> V_49 , V_199 , NULL ) ;
break;
case ( V_200 ) :
F_2 ( V_201 L_27 ,
F_3 ( & V_5 -> V_13 ) ) ;
...
F_141 ( V_5 ) ;
if ( V_5 -> V_13 . V_56 )
V_5 -> V_13 . V_56 -> V_202 -> V_203 . V_204 ( & V_5 -> V_13 . V_56 -> V_202 -> V_203 ,
V_205 , NULL ) ;
}
F_142 ( V_5 ) ;
}
static int
F_143 ( struct V_171 * V_13 , T_2 V_104 , void * V_33 )
{
struct V_4 * V_5 = F_138 ( V_13 , struct V_4 , V_13 ) ;
T_2 V_147 ;
if ( * V_10 & V_206 )
...
case V_205 :
if ( V_5 -> V_13 . V_39 )
V_5 -> V_13 . V_39 -> V_204 ( V_5 -> V_13 . V_39 , V_205 , NULL ) ;
F_140 ( V_5 ) ;
break;
}
return 0 ;
...
struct V_4 *
F_144 ( struct V_171 * V_13 , T_2 V_208 , V_60 V_209 , int V_15 ,
int V_14 )
{
struct V_4 * V_5 ;
struct V_210 V_211 ;
V_5 = F_145 ( sizeof( struct V_4 ) , V_212 ) ;
if ( ! V_5 ) {
F_2 ( V_213 L_29 ) ;
return NULL ;
}
...
V_211 . V_208 = V_221 ;
V_211 . V_222 . V_223 = 0 ;
V_5 -> V_13 . V_56 -> V_202 -> V_203 . V_204 ( & V_5 -> V_13 . V_56 -> V_202 -> V_203 , V_207 , & V_211 ) ;
break;
case V_224 :
F_18 ( V_19 , & V_5 -> V_18 ) ;
F_18 ( V_17 , & V_5 -> V_18 ) ;
...
F_146 ( & V_5 -> V_103 ) ;
F_32 ( V_5 ) ;
V_5 -> V_49 . V_229 = & V_230 ;
if ( F_5 ( V_117 , & V_5 -> V_18 ) ||
F_5 ( V_218 , & V_5 -> V_18 ) ||
F_5 ( V_79 , & V_5 -> V_18 ) )
V_5 -> V_49 . V_146 = V_138 ;
else
V_5 -> V_49 . V_146 = V_156 ;
V_5 -> V_49 . V_10 = * V_10 ;
V_5 -> V_49 . V_6 = V_5 ;
V_5 -> V_49 . V_231 = 0 ;
V_5 -> V_49 . V_232 = F_1 ;
F_147 ( & V_5 -> V_49 , & V_5 -> V_109 ) ;
F_147 ( & V_5 -> V_49 , & V_5 -> V_121 ) ;
return V_5 ;
}
static int
F_148 ( struct V_210 * V_233 )
{
struct V_4 * V_5 ;
if ( V_233 -> V_208 != V_227 )
return - V_234 ;
V_5 = F_144 ( V_233 -> V_13 , V_233 -> V_208 , 0 , 0 , 0 ) ;
if ( ! V_5 )
return - V_45 ;
V_233 -> V_13 = & V_5 -> V_13 ;
V_233 -> V_208 = V_235 ;
