...
F_4 ( V_1 ) ) ;
F_83 ( V_70 L_23 ,
V_1 -> V_49 , V_1 -> V_41 , V_1 -> V_50 , V_1 -> V_43 ) ;
F_83 ( V_70 L_24 ,
V_1 -> V_52 , V_1 -> V_42 , V_1 -> V_53 , V_1 -> V_44 ) ;
#ifdef F_48
...
void F_84 ( const struct V_1 * V_1 , const char * V_71 , unsigned line )
{
F_83 ( V_70 L_27 ) ;
F_83 ( V_70 L_28 , V_71 , line ) ;
F_82 ( V_1 , L_29 , V_21 ) ;
F_85 () ;
}
void F_86 ( struct V_23 * V_24 ,
const char * V_71 , unsigned line )
{
if ( V_24 -> V_1 == V_24 -> V_22 ) {
if ( F_87 ( F_4 ( V_24 -> V_1 ) < 2 ||
F_79 ( V_24 -> V_1 ) ) )
goto V_72;
} else {
if ( F_87 ( F_4 ( V_24 -> V_22 ) < 1 ||
F_4 ( V_24 -> V_1 ) < 1 ||
F_79 ( V_24 -> V_22 ) ||
F_79 ( V_24 -> V_1 ) ) )
goto V_72;
