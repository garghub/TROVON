...
unsigned int V_74 , V_32 , V_31 , V_75 ;
unsigned int V_33 , V_34 , V_35 ;
unsigned int V_36 ;
int V_45 ;
V_34 = V_35 = V_33 = 0 ;
...
void F_20 ( struct V_1 * V_2 , unsigned V_92 )
{
struct V_6 * V_7 = V_2 -> V_5 -> V_8 ;
T_2 V_93 ;
int V_18 ;
...
while ( F_7 ( V_66 ) < V_18 ) ;
V_93 = V_92 >> 2 ;
F_21 ( 0x0d , ( T_1 ) ( V_93 & 0xff ) ) ;
F_21 ( 0x0c , ( T_1 ) ( V_93 >> 8 ) & 0xff ) ;
F_21 ( 0xaf , ( T_1 ) ( V_93 >> 16 ) & 0xf ) ;
}
...
if ( V_105 )
return V_105 ;
V_105 = F_28 ( V_104 , V_107 , & V_106 ) ;
if ( V_105 ) {
F_27 ( V_104 ) ;
return V_105 ;
}
if ( & V_7 -> V_108 -> V_109 == V_102 ) {
V_105 = F_29 ( & V_104 -> V_104 , 0 , V_104 -> V_104 . V_110 , & V_104 -> V_111 ) ;
if ( V_105 )
F_30 ( L_2 ) ;
}
F_27 ( V_104 ) ;
...
static int F_32 ( struct V_1 * V_2 , int V_96 , int V_97 ,
struct V_94 * V_112 )
{
return F_22 ( V_2 , V_112 , V_96 , V_97 , 0 ) ;
}
static int F_33 ( struct V_1 * V_2 ,
struct V_21 * V_22 ,
struct V_21 * V_23 ,
int V_96 , int V_97 , struct V_94 * V_112 )
{
struct V_4 * V_5 = V_2 -> V_5 ;
struct V_6 * V_7 = V_5 -> V_8 ;
...
V_128 = V_7 -> V_130 [ ( V_2 -> V_95 -> V_131 >> 3 ) - 1 ] ;
switch ( V_7 -> type ) {
case V_79 :
case V_80 :
V_129 [ V_56 ] = 0x03 ;
...
switch ( V_2 -> V_95 -> V_131 ) {
case 8 :
V_129 [ V_137 ] = V_138 ;
break;
case 16 :
if ( V_2 -> V_95 -> V_139 == 15 )
V_129 [ V_137 ] = V_140 ;
else
V_129 [ V_137 ] = V_141 ;
break;
...
continue;
if ( ( V_7 -> type == V_82 || V_7 -> type == V_81 || V_7 -> type == V_83 ) &&
( V_9 >= 0x44 ) && ( V_9 <= 0x4e ) )
continue;
F_11 ( V_9 , V_129 [ V_9 ] ) ;
}
...
if ( V_122 )
F_35 ( V_5 -> V_147 , V_148 , V_122 ) ;
if ( V_123 )
F_35 ( V_5 -> V_147 , V_149 , V_123 ) ;
F_36 ( 2 , 0xf ) ;
F_36 ( 3 , 0 ) ;
F_36 ( 4 , 0xe ) ;
V_121 = V_2 -> V_95 -> V_150 [ 0 ] / ( V_2 -> V_95 -> V_131 / 8 ) ;
if ( V_2 -> V_95 -> V_131 == 24 )
V_121 = V_121 >> ( 4 - V_128 ) ;
else
V_121 = V_121 >> ( 4 - V_128 ) ;
V_113 = V_22 -> V_113 / 8 - 1 ;
V_114 = V_22 -> V_151 / 8 - 1 ;
V_115 = V_22 -> V_152 / 8 - 1 ;
V_116 = V_22 -> V_116 / 8 - 1 ;
if ( ( V_116 & 0x07 ) == 0x06 || ( V_116 & 0x07 ) == 0x04 )
V_116 ++ ;
V_117 = V_22 -> V_117 - 1 ;
V_118 = V_22 -> V_153 - 1 ;
V_119 = V_22 -> V_154 - 1 ;
...
F_21 ( 1 , V_113 ) ;
F_21 ( 2 , V_113 ) ;
F_21 ( 3 , ( V_116 & 0x1F ) | 0x80 ) ;
F_21 ( 4 , V_114 ) ;
F_21 ( 5 , ( ( V_116 & 0x20 ) << 2 ) | ( V_115 & 0x1F ) ) ;
F_21 ( 6 , V_120 & 0xFF ) ;
F_21 ( 7 , ( ( V_120 & 0x100 ) >> 8 ) |
( ( V_117 & 0x100 ) >> 7 ) |
( ( V_118 & 0x100 ) >> 6 ) |
( ( V_117 & 0x100 ) >> 5 ) |
( ( V_117 & 0x100 ) >> 4 ) |
...
F_21 ( 15 , 0 ) ;
F_21 ( 16 , V_118 & 0xFF ) ;
F_21 ( 17 , ( V_119 & 0x0F ) | 0x20 ) ;
F_21 ( 18 , V_117 & 0xFF ) ;
F_21 ( 19 , V_121 & 0xFF ) ;
F_21 ( 20 , 0 ) ;
F_21 ( 21 , V_117 & 0xFF ) ;
F_21 ( 22 , ( V_120 + 1 ) & 0xFF ) ;
F_21 ( 23 , 0xc3 ) ;
F_21 ( 24 , V_117 & 0xFF ) ;
V_125 [ 0 ] = 0 ;
V_125 [ 5 ] = 0 ;
V_125 [ 0 ] |= ( V_121 & 0x300 ) >> 4 ;
V_125 [ 1 ] = ( ( ( V_116 - 4 ) & 0x100 ) >> 8 ) |
( ( V_113 & 0x100 ) >> 7 ) |
( ( V_114 & 0x100 ) >> 6 ) |
( V_116 & 0x40 ) ;
V_125 [ 2 ] = ( ( V_120 & 0xc00 ) >> 10 ) |
( ( V_117 & 0x400 ) >> 8 ) |
( ( V_117 & 0xc00 ) >> 7 ) |
( ( V_118 & 0xc00 ) >> 5 ) |
( ( V_117 & 0x400 ) >> 3 ) ;
if ( V_2 -> V_95 -> V_131 == 24 )
V_125 [ 3 ] = ( ( ( 1 << V_128 ) * 3 ) - 1 ) | 0x80 ;
else
V_125 [ 3 ] = ( ( 1 << V_128 ) - 1 ) | 0x80 ;
V_125 [ 4 ] = 0 ;
if ( V_7 -> type == V_81 )
V_125 [ 1 ] |= 0x88 ;
V_126 = 0x05 ;
...
T_2 V_161 ;
T_2 V_162 ;
if ( V_2 -> V_95 -> V_131 > 16 )
V_161 = 32 ;
else if ( V_2 -> V_95 -> V_131 > 8 )
V_161 = 16 ;
else
V_161 = 8 ;
...
V_45 = F_7 ( V_47 ) ;
F_21 ( 0x11 , V_45 | 0x80 ) ;
if ( V_7 -> type == V_79 || V_7 -> type == V_80 ) {
F_36 ( 0 , 1 ) ;
F_41 ( 50 ) ;
F_36 ( 1 , 0x20 ) ;
F_41 ( 20 ) ;
...
if ( V_196 ) {
F_69 ( V_194 , V_196 ) ;
V_105 = F_70 ( V_194 , V_196 ) ;
V_194 -> V_199 . V_200 = NULL ;
F_47 ( V_196 ) ;
}
return V_105 ;
}
...
struct V_21 * V_22 )
{
if ( V_22 -> V_201 > 2048 || V_22 -> V_202 > 4096 ||
V_22 -> V_203 > 4096 || V_22 -> V_204 > 4096 ||
V_22 -> V_205 > 2048 || V_22 -> V_206 > 4096 ||
...
* V_194 )
{
int V_211 = V_194 -> V_212 [ 0 ] ;
struct V_213 * V_100 ;
struct V_186 * V_187 ;
if ( V_211 ) {
V_100 =
F_73 ( V_194 -> V_5 , V_211 ,
V_214 ) ;
if ( ! V_100 )
return NULL ;
V_187 = F_74 ( V_100 ) ;
...
static enum V_215 F_75 ( struct V_179
* V_194 , bool V_216 )
{
return V_217 ;
}
...
struct V_179 * V_194 ;
int V_105 ;
V_7 -> V_183 . V_221 = true ;
V_7 -> V_5 -> V_222 . V_223 = V_224 ;
V_7 -> V_5 -> V_222 . V_225 = V_226 ;
V_7 -> V_5 -> V_222 . V_227 = V_7 -> V_228 . V_229 ;
F_48 ( V_7 -> V_5 ) ;
V_187 = F_63 ( V_7 -> V_5 ) ;
if ( ! V_187 ) {
F_30 ( L_5 ) ;
