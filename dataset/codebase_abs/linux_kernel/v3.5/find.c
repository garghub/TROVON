...
static int F_29 ( const struct V_3 * * V_70 ,
const struct V_3 * * V_71 )
{
const struct V_3 * V_72 = * V_70 ;
const struct V_3 * V_73 = * V_71 ;
return V_72 -> V_17 + V_72 -> free - V_73 -> V_17 - V_73 -> free ;
}
static void F_30 ( struct V_3 * * V_70 , struct V_3 * * V_71 ,
int V_74 )
{
struct V_3 * V_75 = * V_70 ;
* V_70 = * V_71 ;
* V_71 = V_75 ;
}
...
int V_43 ;
F_11 ( V_2 ) ;
V_2 -> V_76 . V_15 = V_2 -> V_14 [ V_12 - 1 ] . V_15 ;
memcpy ( V_2 -> V_76 . V_44 , V_2 -> V_14 [ V_12 - 1 ] . V_44 ,
sizeof( void * ) * V_2 -> V_76 . V_15 ) ;
F_32 ( V_2 -> V_76 . V_44 , V_2 -> V_76 . V_15 , sizeof( void * ) ,
( int ( * ) ( const void * , const void * ) ) F_29 ,
( void ( * ) ( void * , void * , int ) ) F_30 ) ;
F_16 ( L_5 , V_2 -> V_76 . V_15 ) ;
if ( V_2 -> V_76 . V_15 )
F_16 ( L_6 ,
V_2 -> V_76 . V_44 [ V_2 -> V_76 . V_15 - 1 ] -> V_40 ,
V_2 -> V_76 . V_44 [ V_2 -> V_76 . V_15 - 1 ] -> V_17 ,
V_2 -> V_76 . V_44 [ V_2 -> V_76 . V_15 - 1 ] -> free ) ;
for ( V_43 = 0 ; V_43 < V_2 -> V_76 . V_15 ; V_43 ++ )
V_2 -> V_76 . V_44 [ V_43 ] = ( void * ) ( V_77 ) V_2 -> V_76 . V_44 [ V_43 ] -> V_40 ;
F_19 ( V_2 ) ;
return 0 ;
}
...
return F_17 ( V_4 ) ;
F_7 ( V_4 -> V_40 == V_29 . V_40 ) ;
F_7 ( V_4 -> free + V_4 -> V_17 >= V_2 -> V_78 ) ;
F_7 ( ! ( V_4 -> V_7 & V_32 ) ) ;
F_7 ( ( V_4 -> V_7 & V_36 ) ) ;
F_16 ( L_7 ,
...
if ( ! V_2 -> V_76 . V_15 )
return - V_47 ;
V_40 = ( V_77 ) V_2 -> V_76 . V_44 [ -- V_2 -> V_76 . V_15 ] ;
V_54 = F_38 ( V_2 , V_40 ) ;
if ( F_9 ( V_54 ) )
return F_17 ( V_54 ) ;
