...
T_1 V_3 ;
V_36 = F_16 ( & V_6 -> V_37 , & V_54 ,
sizeof( struct V_31 ) ) ;
V_36 |= F_18 ( V_46 ,
( V_44 T_2 * ) ( V_29 + V_49
- V_45 ) ) ;
V_36 |= F_4 ( V_3 , & V_53 -> V_55 . V_3 ) ;
V_3 |= V_56 ;
V_36 |= F_18 ( V_3 , & V_53 -> V_55 . V_3 ) ;
if ( V_36 )
return V_36 ;
}
return 1 ;
...
V_58:
F_22 ( V_28 , V_13 & ~ V_56 ) ;
return F_23 ( ( V_59 struct V_5 * ) V_29 ) ;
}
...
V_73 = F_34 ( V_13 ) ;
V_25 = F_35 ( V_73 * sizeof( int ) ) ;
V_27 = F_35 ( V_73 * sizeof( int ) ) ;
do {
F_36 ( V_74 , V_72 , & V_68 , & V_69 , & V_70 , & V_71 ) ;
if ( V_68 == 0 )
break;
V_25 [ V_72 ] = V_69 ;
V_27 [ V_72 ] = V_68 ;
...
F_36 ( V_74 , 0 , & V_68 , & V_69 , & V_70 , & V_71 ) ;
...
void T_4 F_47 ( void )
{
static T_5 void (* F_48)( void ) = F_43 ;
void (* F_49)( void );
if ( ! V_84 )
return;
F_49 = F_48 ;
