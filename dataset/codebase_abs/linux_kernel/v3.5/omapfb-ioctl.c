...
V_23 = V_65 -> V_40 -> V_170 ( V_65 -> V_40 ) ;
break;
case V_171 :
F_5 ( L_19 ) ;
if ( ! V_65 ) {
...
if ( ! V_65 || ! V_65 -> V_68 -> V_173 ) {
V_23 = - V_25 ;
break;
}
V_23 = V_65 -> V_68 -> V_173 ( V_65 , V_145 . V_137 ) ;
break;
case V_174 :
F_5 ( L_21 ) ;
if ( F_46 ( V_145 . V_137 , ( int V_149 * ) V_128 ) ) {
...
break;
case V_176 : {
unsigned long V_177 , free , V_178 ;
F_5 ( L_23 ) ;
F_48 ( & V_177 , & free , & V_178 ) ;
V_145 . V_139 . V_179 = V_177 ;
...
if ( ! V_65 || ! V_65 -> V_68 -> V_182 ) {
V_23 = - V_71 ;
break;
}
V_23 = V_65 -> V_68 -> V_182 ( V_65 ,
! ! V_145 . V_141 . V_28 ) ;
break;
}
case V_183 : {
...
V_65 -> V_68 -> V_69 ( V_65 , & V_184 , & V_185 ) ;
V_145 . V_143 . V_184 = V_184 ;
V_145 . V_143 . V_185 = V_185 ;
if ( V_65 -> V_68 -> V_186 ) {
T_3 V_62 , V_63 ;
V_65 -> V_68 -> V_186 ( V_65 , & V_62 , & V_63 ) ;
