...
if ( ~ F_6 ( V_2 , V_21 ) & V_107 )
F_52 ( V_108 , & V_2 -> V_106 ) ;
F_53 ( & V_2 -> V_109 ) ;
V_6 &= ~ V_104 ;
V_6 |= V_110 ;
}
...
{
T_1 V_6 ;
V_6 = V_39 == 0 ? V_113 : V_114 ;
F_8 ( V_2 , V_21 , V_6 , V_115 ) ;
}
void F_56 ( struct V_1 * V_2 )
{
unsigned long V_18 ;
F_14 ( & V_2 -> V_19 , V_18 ) ;
F_8 ( V_2 , V_11 , ~ 0 , V_116 ) ;
F_51 ( V_108 , & V_2 -> V_106 ) ;
F_21 ( & V_2 -> V_19 , V_18 ) ;
}
...
V_117 = F_60 ( V_2 -> V_109 ,
F_54 ( V_105 , & V_2 -> V_106 ) ,
F_61 ( 1000 ) ) ;
if ( V_117 > 0 )
return 0 ;
if ( V_117 < 0 )
