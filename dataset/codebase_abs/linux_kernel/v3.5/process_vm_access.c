...
struct V_10 V_61 [ V_60 ] ;
struct V_10 * V_62 = V_59 ;
struct V_10 * V_63 = V_61 ;
T_2 V_24 ;
if ( V_43 != 0 )
return - V_64 ;
if ( V_15 )
V_24 = F_27 ( V_65 , V_11 , V_40 , V_60 ,
V_59 , & V_62 ) ;
else
V_24 = F_27 ( V_66 , V_11 , V_40 , V_60 ,
V_59 , & V_62 ) ;
if ( V_24 <= 0 )
goto V_67;
V_24 = F_27 ( V_68 , V_41 , V_42 , V_60 ,
V_61 , & V_63 ) ;
if ( V_24 <= 0 )
goto V_67;
V_24 = F_14 ( V_39 , V_62 , V_40 , V_63 , V_42 , V_43 ,
V_15 ) ;
V_67:
if ( V_63 != V_61 )
F_25 ( V_63 ) ;
...
if ( V_43 != 0 )
return - V_64 ;
if ( ! F_29 ( V_70 , V_11 , V_40 * sizeof( * V_11 ) ) )
goto V_71;
if ( ! F_29 ( V_70 , V_41 , V_42 * sizeof( * V_41 ) ) )
goto V_71;
if ( V_15 )
V_24 = F_30 ( V_65 , V_11 , V_40 ,
V_60 , V_59 ,
& V_62 ) ;
else
V_24 = F_30 ( V_66 , V_11 , V_40 ,
V_60 , V_59 ,
& V_62 ) ;
if ( V_24 <= 0 )
goto V_67;
V_24 = F_30 ( V_68 , V_41 , V_42 ,
V_60 , V_61 ,
& V_63 ) ;
if ( V_24 <= 0 )
goto V_67;
...
unsigned long V_43 )
{
return F_28 ( V_39 , V_11 , V_40 , V_41 ,
V_42 , V_43 , 0 ) ;
}
T_5 T_2
F_32 ( T_6 V_39 ,
