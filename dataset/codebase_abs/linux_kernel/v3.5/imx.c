...
V_251 = F_95 ( & V_188 -> V_141 ) ;
if ( F_96 ( V_251 ) ) {
V_193 = F_97 ( V_251 ) ;
goto V_260;
}
V_2 -> V_261 = F_98 ( & V_188 -> V_141 , L_8 ) ;
if ( F_96 ( V_2 -> V_261 ) ) {
V_193 = F_97 ( V_2 -> V_261 ) ;
goto V_260;
}
V_2 -> V_110 = F_98 ( & V_188 -> V_141 , L_9 ) ;
if ( F_96 ( V_2 -> V_110 ) ) {
...
if ( V_140 && V_140 -> V_262 ) {
V_193 = V_140 -> V_262 ( V_188 ) ;
if ( V_193 )
goto V_263;
}
V_193 = F_100 ( & V_235 , & V_2 -> V_8 ) ;
if ( V_193 )
goto V_264;
F_101 ( V_188 , & V_2 -> V_8 ) ;
return 0 ;
