...
static bool F_70 ( struct V_147 * V_148 , void * V_149 )
{
struct V_41 * V_42 = V_149 ;
return ( V_42 -> V_86 -> V_87 ==
F_71 ( V_148 -> V_150 , struct V_1 , V_151 ) ) ;
}
struct V_147 * F_72 ( struct V_41 * V_42 )
{
T_4 V_152 ;
struct V_147 * V_153 ;
F_73 ( V_152 ) ;
F_74 ( V_154 , V_152 ) ;
V_153 = F_75 ( V_152 , F_70 , V_42 ) ;
return V_153 ;
}
void F_76 ( struct V_147 * V_153 )
{
F_77 ( V_153 ) ;
}
struct V_155 * F_78 ( struct V_41 * V_42 ,
struct V_147 * V_153 , struct V_156 * V_157 ,
enum V_158 V_159 , unsigned long V_160 )
{
struct V_155 * V_161 = NULL ;
struct V_162 V_163 ;
if ( V_153 -> V_150 -> V_164 == NULL ) {
F_56 ( L_23 , V_113 ) ;
return NULL ;
}
V_163 . V_48 = V_42 -> V_48 ;
V_163 . V_165 = V_157 -> V_165 ;
V_163 . V_166 = V_157 -> V_166 ;
V_163 . V_167 = V_157 -> V_167 ;
V_161 = F_79 ( V_153 , V_157 -> V_168 , V_157 -> V_169 ,
V_159 , V_160 , & V_163 ) ;
return V_161 ;
}
static void F_80 ( struct V_41 * V_170 )
{
}
static int T_5 F_81 ( void )
{
struct V_41 * V_170 = NULL ;
while ( ( V_170 = F_65 ( V_132 , V_132 , V_170 ) ) != NULL ) {
F_80 ( V_170 ) ;
}
return 0 ;
}
...
static int F_85 ( int V_172 )
{
if ( ! V_173 [ 0 ] || V_173 [ 0 ] <= V_172 || V_172 >= V_174 )
return - 1 ;
return V_173 [ V_172 + 1 ] ;
}
static int F_86 ( char * V_175 )
{
( void ) F_87 ( V_175 , F_88 ( V_173 ) , V_173 ) ;
return 1 ;
}
