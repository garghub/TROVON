...
static int F_50 ( struct V_4 * V_23 , struct V_21 * V_22 )
{
struct V_1 * V_25 = F_21 ( V_23 ) ;
struct V_5 * V_6 = & V_25 -> V_8 . V_9 ;
int V_83 , V_68 , V_65 ;
...
goto V_87;
V_85 = (struct V_26 * ) ( V_22 -> V_33 ) ;
V_57 = F_54 ( V_85 -> V_58 ) ? V_85 -> V_57 : V_85 -> V_65 ;
V_57 = F_55 ( V_57 ) ;
if ( V_57 > V_6 -> V_89 )
V_6 -> V_89 = V_57 ;
if ( F_56 ( V_57 , V_6 -> V_89 ) )
V_6 -> V_89 = V_57 ;
} else {
...
V_68 = F_57 ( V_85 -> V_68 ) ;
V_65 = F_55 ( V_85 -> V_65 ) ;
if ( ! F_53 ( V_22 , V_83 + V_68 ) )
goto V_87;
V_84 = V_22 -> V_33 + V_83 ;
if ( V_65 < V_6 -> V_34 + 1 || F_56 ( V_6 -> V_34 , V_65 ) ) {
...
F_43 ( V_22 ) ;
F_45 ( V_22 ) ;
return F_65 ( F_5 ( V_25 ) , V_22 , 0 ) ;
}
V_87:
F_49 ( V_22 ) ;
return V_94 ;
}
static int F_66 ( struct V_97 * V_4 , struct V_98 * V_99 ,
int V_100 )
{
...
int error = 0 ;
F_67 ( V_23 ) ;
V_6 -> V_16 = V_102 -> V_103 . V_9 ;
if ( F_9 ( V_25 ) )
error = - V_104 ;
F_68 ( V_23 ) ;
return error ;
}
static int F_69 ( struct V_97 * V_4 , struct V_98 * V_99 ,
int V_100 , int V_58 )
{
struct V_4 * V_23 = V_4 -> V_23 ;
struct V_101 * V_102 = (struct V_101 * ) V_99 ;
...
if ( ! V_6 -> V_16 . V_11 . V_3 || ! V_102 -> V_103 . V_9 . V_11 . V_3 ) {
error = - V_107 ;
goto V_109;
}
V_25 -> V_20 . V_24 = V_23 ;
...
static int F_75 ( struct V_97 * V_4 , struct V_98 * V_117 ,
int * V_118 , int V_119 )
{
...
V_102 . V_120 = V_121 ;
V_102 . V_105 = V_106 ;
V_102 . V_103 . V_9 = F_21 ( V_4 -> V_23 ) -> V_8 . V_9 . V_16 ;
memcpy ( V_117 , & V_102 , V_32 ) ;
* V_118 = V_32 ;
return 0 ;
}
static int F_76 ( struct V_97 * V_4 )
{
struct V_4 * V_23 = V_4 -> V_23 ;
struct V_1 * V_25 ;
struct V_5 * V_6 ;
...
static void F_81 ( struct V_4 * V_23 )
{
if ( ! ( V_23 -> V_42 & V_43 ) ) {
F_16 ( F_21 ( V_23 ) ) ;
F_78 ( V_23 ) ;
...
static int F_83 ( struct V_125 * V_125 , struct V_97 * V_4 )
{
int error = - V_126 ;
struct V_4 * V_23 ;
struct V_1 * V_25 ;
struct V_5 * V_6 ;
V_23 = F_84 ( V_125 , V_127 , V_128 , & V_129 ) ;
if ( ! V_23 )
goto V_130;
F_85 ( V_4 , V_23 ) ;
V_4 -> V_131 = V_132 ;
...
static int F_86 ( struct V_19 * V_20 , unsigned int V_141 ,
unsigned long V_142 )
{
struct V_4 * V_23 = (struct V_4 * ) V_20 -> V_24 ;
struct V_1 * V_25 = F_21 ( V_23 ) ;
...
int V_145 = 0 ;
F_90 ( L_2 V_152 L_3 ) ;
V_7 = F_91 ( ( V_14 + 1 ) * sizeof( void * ) ) ;
if ( ! V_7 )
return - V_126 ;
V_145 = F_92 ( & V_153 , V_154 ) ;
if ( V_145 ) {
F_74 ( L_4 ) ;
goto V_155;
}
