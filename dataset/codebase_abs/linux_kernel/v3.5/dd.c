...
int F_46 ( struct V_28 * V_29 , struct V_3 * V_4 )
{
int V_26 = 0 ;
if ( ! F_47 ( V_4 ) )
return - V_37 ;
...
static int F_51 ( struct V_28 * V_29 , void * V_41 )
{
struct V_3 * V_4 = V_41 ;
if ( ! F_52 ( V_29 , V_4 ) )
return 0 ;
return F_46 ( V_29 , V_4 ) ;
}
...
F_48 ( V_4 ) ;
V_26 = F_55 ( V_4 -> V_23 , NULL , V_4 , F_51 ) ;
F_50 ( V_4 ) ;
}
V_42:
F_56 ( V_4 ) ;
...
static int F_57 ( struct V_3 * V_4 , void * V_41 )
{
...
{
return F_59 ( V_29 -> V_23 , NULL , V_29 , F_57 ) ;
}
...
F_66 ( & V_29 -> V_9 -> V_22 . V_47 ) ;
break;
}
V_46 = F_67 ( V_29 -> V_9 -> V_22 . V_48 . V_49 ,
struct V_5 ,
V_16 . V_50 ) ;
V_4 = V_46 -> V_3 ;
F_7 ( V_4 ) ;
...
void * F_68 ( const struct V_3 * V_4 )
{
if ( V_4 && V_4 -> V_9 )
return V_4 -> V_9 -> V_51 ;
return NULL ;
}
int F_69 ( struct V_3 * V_4 , void * V_41 )
{
int error ;
if ( ! V_4 -> V_9 ) {
error = F_70 ( V_4 ) ;
