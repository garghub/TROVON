...
V_60 & V_139 , V_60 & V_140 , V_60 & V_141 ) ;
if ( V_43 < 0 )
error = V_43 ;
else
error = F_68 ( V_2 , V_10 ) ;
...
int F_80 ( struct V_4 * V_143 , struct V_2 * V_18 , struct V_4 * V_92 )
{
char * V_144 , * V_145 ;
int V_31 ;
if ( ( V_144 = F_10 ( V_92 ) ) == NULL )
return - V_23 ;
V_145 = F_10 ( V_143 ) ;
if ( V_145 == NULL ) {
F_8 ( V_144 ) ;
...
int F_84 ( struct V_2 * V_18 , struct V_4 * V_4 , const char * V_143 )
{
char * V_52 ;
int V_31 ;
if ( ( V_52 = F_10 ( V_4 ) ) == NULL )
return - V_23 ;
V_31 = F_85 ( V_52 , V_143 ) ;
F_8 ( V_52 ) ;
return V_31 ;
}
...
static int F_90 ( struct V_2 * V_55 , struct V_4 * V_4 , T_8 V_60 , T_7 V_147 )
{
struct V_2 * V_2 ;
char * V_10 ;
int V_31 ;
...
goto V_132;
F_71 ( V_2 , V_60 , V_147 ) ;
V_31 = F_91 ( V_10 , V_60 , F_92 ( V_147 ) , F_93 ( V_147 ) ) ;
if ( ! V_31 )
goto V_26;
V_31 = F_68 ( V_2 , V_10 ) ;
F_8 ( V_10 ) ;
...
int F_94 ( struct V_2 * V_148 , struct V_4 * V_92 ,
struct V_2 * V_149 , struct V_4 * V_143 )
{
char * V_144 , * V_145 ;
int V_31 ;
if ( ( V_144 = F_10 ( V_92 ) ) == NULL )
return - V_23 ;
if ( ( V_145 = F_10 ( V_143 ) ) == NULL ) {
F_8 ( V_144 ) ;
return - V_23 ;
}
V_31 = F_95 ( V_144 , V_145 ) ;
F_8 ( V_144 ) ;
F_8 ( V_145 ) ;
return V_31 ;
}
int F_96 ( struct V_2 * V_18 , int V_150 )
{
char * V_10 ;
int V_61 = 0 , V_62 = 0 , V_151 = 0 , V_31 ;
if ( V_150 & V_152 )
return - V_153 ;
if ( V_150 & V_154 ) V_61 = 1 ;
if ( V_150 & V_155 ) V_62 = 1 ;
if ( V_150 & V_156 ) V_151 = 1 ;
V_10 = F_12 ( V_18 ) ;
if ( V_10 == NULL )
return - V_23 ;
...
V_31 = F_101 ( V_10 , V_61 , V_62 , V_151 ) ;
F_8 ( V_10 ) ;
if ( ! V_31 )
V_31 = F_102 ( V_18 , V_150 ) ;
return V_31 ;
}
int F_103 ( struct V_4 * V_4 , struct V_157 * V_158 )
{
struct V_2 * V_2 = V_4 -> V_159 ;
struct V_160 V_161 ;
char * V_10 ;
int V_31 ;
int V_43 = F_1 ( V_2 ) -> V_43 ;
V_31 = F_104 ( V_2 , V_158 ) ;
if ( V_31 )
return V_31 ;
if ( V_9 )
V_158 -> V_162 &= ~ V_163 ;
V_161 . V_162 = 0 ;
if ( V_158 -> V_162 & V_164 ) {
V_161 . V_162 |= V_165 ;
V_161 . V_166 = V_158 -> V_166 ;
}
if ( V_158 -> V_162 & V_167 ) {
V_161 . V_162 |= V_168 ;
V_161 . V_169 = V_158 -> V_169 ;
}
if ( V_158 -> V_162 & V_170 ) {
V_161 . V_162 |= V_171 ;
V_161 . V_172 = V_158 -> V_172 ;
}
if ( V_158 -> V_162 & V_163 ) {
V_161 . V_162 |= V_173 ;
V_161 . V_174 = V_158 -> V_174 ;
}
if ( V_158 -> V_162 & V_175 ) {
V_161 . V_162 |= V_176 ;
V_161 . V_177 = V_158 -> V_177 ;
}
if ( V_158 -> V_162 & V_178 ) {
V_161 . V_162 |= V_179 ;
V_161 . V_180 = V_158 -> V_180 ;
}
if ( V_158 -> V_162 & V_181 ) {
V_161 . V_162 |= V_182 ;
V_161 . V_183 = V_158 -> V_183 ;
}
if ( V_158 -> V_162 & V_184 ) {
V_161 . V_162 |= V_185 ;
}
if ( V_158 -> V_162 & V_186 ) {
V_161 . V_162 |= V_187 ;
}
V_10 = F_10 ( V_4 ) ;
if ( V_10 == NULL )
return - V_23 ;
V_31 = F_105 ( V_10 , & V_161 , V_43 ) ;
F_8 ( V_10 ) ;
if ( V_31 )
return V_31 ;
if ( ( V_158 -> V_162 & V_163 ) &&
V_158 -> V_174 != F_106 ( V_2 ) ) {
int error ;
error = F_107 ( V_2 , V_158 -> V_174 ) ;
if ( V_31 )
return V_31 ;
}
F_108 ( V_2 , V_158 ) ;
...
static void * F_110 ( struct V_4 * V_4 , struct V_129 * V_130 )
{
char * V_19 = F_11 () ;
if ( V_19 ) {
char * V_188 = F_10 ( V_4 ) ;
...
static void F_112 ( struct V_4 * V_4 , struct V_129 * V_130 , void * V_190 )
{
char * V_17 = F_113 ( V_130 ) ;
if ( ! F_7 ( V_17 ) )
F_8 ( V_17 ) ;
}
static int F_114 ( struct V_27 * V_28 , void * V_191 , int V_192 )
{
struct V_2 * V_193 ;
...
static struct V_4 * F_117 ( struct V_206 * type ,
int V_88 , const char * V_207 ,
void * V_208 )
{
return F_118 ( type , V_88 , V_208 , F_114 ) ;
}
