...
static bool F_33 ( struct V_5 * V_5 , unsigned long V_42 )
{
bool V_43 = F_34 ( V_5 -> V_36 , V_42 ) ;
#ifndef F_35
V_43 = V_43 && F_36 ( V_5 -> V_36 , V_37 ) ;
#endif
return V_43 ;
}
static int F_37 ( struct V_13 * V_44 ,
struct V_13 * V_45 ,
struct V_19 * V_20 )
{
F_38 ( V_46 ) ;
...
int V_50 ;
F_25 ( & V_16 -> V_31 ) ;
F_42 ( & V_16 -> V_38 , & V_16 -> V_54 ) ;
V_50 = F_37 ( & V_16 -> V_33 , & V_16 -> V_54 , V_20 ) ;
F_43 ( V_16 , V_20 , V_50 ) ;
}
static int F_44 ( struct V_5 * V_5 , struct V_55 * V_56 )
{
if ( V_5 -> V_8 -> V_57 -> F_44 && ! F_45 ( V_5 ) )
return V_5 -> V_8 -> V_57 -> F_44 ( V_5 , V_56 ) ;
return 0 ;
}
...
__acquires( V_5 -> V_58 )
{
F_47 ( V_59 , & V_5 -> V_39 , V_41 ) ;
T_1 * V_60 ;
V_60 = F_48 ( & V_5 -> V_39 , V_41 ) ;
while ( V_5 -> V_39 & V_40 ) {
F_23 ( & V_5 -> V_58 ) ;
F_49 ( V_60 , & V_59 , V_61 , V_62 ) ;
F_21 ( & V_5 -> V_58 ) ;
}
}
...
static void F_56 ( struct V_5 * V_5 , struct V_32 * V_16 ,
struct V_55 * V_56 )
{
if ( V_5 -> V_39 & V_65 )
return;
...
static int
F_58 ( struct V_5 * V_5 , struct V_32 * V_16 ,
struct V_55 * V_56 )
{
...
static int
F_63 ( struct V_5 * V_5 , struct V_32 * V_16 ,
struct V_55 * V_56 )
{
int V_43 = 0 ;
F_21 ( & V_5 -> V_58 ) ;
if ( ! F_64 ( & V_5 -> V_79 ) )
F_59 ( ! ( V_5 -> V_39 & ( V_80 | V_65 ) ) ) ;
else
F_59 ( V_5 -> V_39 & V_80 ) ;
if ( V_5 -> V_39 & V_40 ) {
if ( V_56 -> V_29 != V_67 )
...
V_81 = F_66 ( V_2 -> V_83 / 2 ,
V_84 / V_85 ) ;
V_81 = F_66 ( V_81 , V_20 -> V_24 ) ;
V_81 = F_67 ( V_81 + V_86 ,
V_86 ) ;
}
return V_81 ;
}
static long F_68 ( struct V_6 * V_7 ,
struct V_32 * V_16 ,
struct V_19 * V_20 )
{
struct V_55 V_56 = {
...
static long F_72 ( struct V_32 * V_16 ,
struct V_19 * V_20 )
{
unsigned long V_92 = V_37 ;
long V_94 = 0 ;
...
long F_75 ( struct V_32 * V_16 , long V_24 ,
enum V_26 V_27 )
{
struct V_19 V_20 = {
. V_24 = V_24 ,
...
static void F_81 ( struct V_32 * V_16 ,
unsigned long V_92 )
{
F_82 ( V_16 -> V_2 , 0 , 0 , 0 , 0 , 0 , V_92 ) ;
}
static long F_83 ( struct V_32 * V_16 ,
struct V_19 * V_20 )
{
...
F_41 ( V_16 , V_20 ) ;
if ( V_20 -> V_7 )
V_104 = F_68 ( V_20 -> V_7 , V_16 , V_20 ) ;
else
V_104 = F_72 ( V_16 , V_20 ) ;
F_86 ( V_16 -> V_2 , V_20 ) ;
F_81 ( V_16 , V_102 ) ;
if ( V_104 )
continue;
...
static unsigned long F_89 ( void )
{
return F_78 ( V_99 ) +
F_78 ( V_100 ) +
F_90 () ;
}
static long F_91 ( struct V_32 * V_16 )
{
if ( F_76 ( V_16 -> V_2 ) ) {
struct V_19 V_20 = {
. V_24 = V_82 ,
...
long F_93 ( struct V_32 * V_16 , int V_111 )
{
struct V_1 * V_2 = V_16 -> V_2 ;
struct V_19 * V_20 ;
long V_94 = 0 ;
F_94 ( V_3 , & V_16 -> V_2 -> V_4 ) ;
while ( ( V_20 = F_88 ( V_2 ) ) != NULL ) {
if ( V_111 )
V_20 -> V_29 = V_67 ;
F_95 ( V_2 , V_20 ) ;
V_94 += F_83 ( V_16 , V_20 ) ;
...
void F_112 ( long V_24 , enum V_26 V_27 )
{
struct V_1 * V_2 ;
if ( ! V_24 ) {
V_24 = F_78 ( V_99 ) +
...
F_119 ( V_127
L_3 ,
V_115 -> V_128 , F_120 ( V_115 ) , V_5 -> V_122 ,
V_10 , V_5 -> V_8 -> V_123 ) ;
if ( V_124 ) {
F_23 ( & V_124 -> V_125 ) ;
F_121 ( V_124 ) ;
...
F_59 ( ! F_130 ( & V_7 -> V_137 ) ) ;
F_21 ( & V_138 ) ;
F_131 (inode, &sb->s_inodes, i_sb_list) {
struct V_72 * V_73 = V_5 -> V_11 ;
F_21 ( & V_5 -> V_58 ) ;
...
void F_138 ( struct V_6 * V_7 , enum V_26 V_27 )
{
return F_135 ( V_7 , F_89 () , V_27 ) ;
}
int F_139 ( struct V_6 * V_7 , enum V_26 V_27 )
{
if ( ! F_1 ( V_7 -> V_12 ) ) {
F_140 ( & V_7 -> V_137 ) ;
F_138 ( V_7 , V_27 ) ;
...
int F_144 ( struct V_5 * V_5 , int V_142 )
{
...
V_56 . V_71 = 0 ;
F_146 () ;
return F_63 ( V_5 , V_16 , & V_56 ) ;
}
int F_147 ( struct V_5 * V_5 , struct V_55 * V_56 )
{
return F_63 ( V_5 , & F_3 ( V_5 ) -> V_16 , V_56 ) ;
}
int F_148 ( struct V_5 * V_5 , int V_63 )
{
struct V_55 V_56 = {
. V_29 = V_63 ? V_67 : V_30 ,
. V_71 = 0 ,
} ;
return F_147 ( V_5 , & V_56 ) ;
}
