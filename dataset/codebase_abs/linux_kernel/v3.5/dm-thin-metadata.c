...
V_7 -> V_113 = F_5 ( V_114 ) ;
V_7 -> time = 0 ;
V_7 -> V_115 = F_5 ( V_110 >> V_108 ) ;
V_7 -> V_116 = F_3 ( V_106 >> V_117 ) ;
V_7 -> V_80 = F_5 ( V_80 ) ;
V_39 = F_26 ( V_50 ) ;
if ( V_39 < 0 )
goto V_52;
...
V_94 = 1 ;
V_123 . V_96 = 0 ;
V_123 . V_97 = F_3 ( V_45 -> V_75 ) ;
V_123 . V_98 = F_5 ( V_45 -> time ) ;
V_123 . V_99 = F_5 ( V_45 -> time ) ;
}
* V_90 = F_60 ( sizeof( * * V_90 ) , V_126 ) ;
if ( ! * V_90 )
return - V_60 ;
( * V_90 ) -> V_45 = V_45 ;
( * V_90 ) -> V_95 = V_121 ;
( * V_90 ) -> V_100 = 1 ;
( * V_90 ) -> V_94 = V_94 ;
( * V_90 ) -> V_96 = F_8 ( V_123 . V_96 ) ;
( * V_90 ) -> V_97 = F_8 ( V_123 . V_97 ) ;
( * V_90 ) -> V_98 = F_10 ( V_123 . V_98 ) ;
( * V_90 ) -> V_99 = F_10 ( V_123 . V_99 ) ;
...
if ( V_39 ) {
F_21 ( & V_45 -> V_69 , V_127 ) ;
return V_39 ;
}
V_39 = F_70 ( V_45 , V_121 , 1 , & V_90 ) ;
if ( V_39 ) {
...
int F_77 ( struct V_44 * V_45 , T_8 V_121 )
{
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
V_39 = F_75 ( V_45 , V_121 ) ;
F_79 ( & V_45 -> V_72 ) ;
return V_39 ;
}
...
int V_39 ;
struct V_89 * V_90 ;
V_39 = F_70 ( V_45 , V_129 , 0 , & V_90 ) ;
if ( V_39 )
return V_39 ;
V_90 -> V_94 = 1 ;
V_90 -> V_99 = time ;
V_128 -> V_96 = V_90 -> V_96 ;
V_128 -> V_99 = time ;
F_74 ( V_90 ) ;
return 0 ;
}
...
return V_39 ;
V_130 = F_8 ( V_30 ) ;
F_19 ( V_45 -> V_35 , V_130 ) ;
V_30 = F_3 ( V_130 ) ;
F_46 ( & V_30 ) ;
V_93 = V_121 ;
V_39 = F_47 ( & V_45 -> V_68 , V_45 -> V_34 , & V_93 , & V_30 , & V_45 -> V_34 ) ;
if ( V_39 ) {
F_82 ( V_45 -> V_35 , V_130 ) ;
return V_39 ;
}
V_45 -> time ++ ;
V_39 = F_70 ( V_45 , V_121 , 1 , & V_90 ) ;
if ( V_39 )
goto V_52;
V_39 = F_80 ( V_45 , V_90 , V_129 , V_45 -> time ) ;
F_74 ( V_90 ) ;
if ( V_39 )
goto V_52;
return 0 ;
...
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
V_39 = F_81 ( V_45 , V_121 , V_129 ) ;
F_79 ( & V_45 -> V_72 ) ;
return V_39 ;
}
static int F_84 ( struct V_44 * V_45 , T_8 V_121 )
{
int V_39 ;
T_2 V_93 = V_121 ;
struct V_89 * V_90 ;
V_39 = F_70 ( V_45 , V_121 , 0 , & V_90 ) ;
if ( V_39 )
return V_39 ;
if ( V_90 -> V_100 > 1 ) {
F_74 ( V_90 ) ;
...
int V_39 , V_64 ;
struct V_6 * V_7 ;
struct V_3 * V_134 , * V_50 ;
T_3 V_135 ;
F_14 ( V_45 -> V_58 , V_43 ) ;
V_39 = F_89 ( V_45 -> V_35 , V_43 ,
& V_51 , & V_134 , & V_64 ) ;
if ( V_39 )
return V_39 ;
F_90 ( ! V_64 ) ;
...
if ( F_8 ( V_7 -> V_135 ) ) {
F_67 ( L_23 ) ;
F_82 ( V_45 -> V_35 , V_135 ) ;
F_31 ( V_45 -> V_35 , V_134 ) ;
V_45 -> V_73 = 1 ;
return - V_120 ;
}
memset ( & V_7 -> V_56 , 0 ,
...
memset ( & V_7 -> V_54 , 0 ,
sizeof( V_7 -> V_54 ) ) ;
F_19 ( V_45 -> V_35 , F_8 ( V_7 -> V_78 ) ) ;
F_19 ( V_45 -> V_35 , F_8 ( V_7 -> V_79 ) ) ;
F_31 ( V_45 -> V_35 , V_134 ) ;
V_39 = F_55 ( V_45 -> V_37 , V_43 ,
& V_51 , & V_50 ) ;
if ( V_39 ) {
...
V_39 = F_93 ( V_45 -> V_35 , V_135 , & V_51 , & V_134 ) ;
if ( V_39 )
return V_39 ;
V_7 = F_2 ( V_134 ) ;
F_16 ( V_45 -> V_58 , F_8 ( V_7 -> V_78 ) ) ;
F_16 ( V_45 -> V_58 , F_8 ( V_7 -> V_79 ) ) ;
F_16 ( V_45 -> V_58 , V_135 ) ;
return F_31 ( V_45 -> V_35 , V_134 ) ;
}
int F_94 ( struct V_44 * V_45 )
{
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
V_39 = F_92 ( V_45 ) ;
...
int F_97 ( struct V_44 * V_45 , T_8 V_121 ,
struct V_89 * * V_90 )
{
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
...
T_8 F_99 ( struct V_89 * V_90 )
{
return V_90 -> V_95 ;
}
static int F_100 ( struct V_89 * V_90 , T_4 time )
{
return V_90 -> V_99 > time ;
}
int F_101 ( struct V_89 * V_90 , T_3 V_136 ,
int V_137 , struct V_138 * V_38 )
{
int V_39 ;
T_2 V_139 = 0 ;
T_5 V_30 ;
struct V_44 * V_45 = V_90 -> V_45 ;
T_3 V_140 [ 2 ] = { V_90 -> V_95 , V_136 } ;
if ( V_137 ) {
F_68 ( & V_45 -> V_72 ) ;
V_39 = F_72 ( & V_45 -> V_32 , V_45 -> V_34 , V_140 , & V_30 ) ;
if ( ! V_39 )
V_139 = F_8 ( V_30 ) ;
F_69 ( & V_45 -> V_72 ) ;
} else if ( F_102 ( & V_45 -> V_72 ) ) {
V_39 = F_72 ( & V_45 -> V_67 , V_45 -> V_34 , V_140 , & V_30 ) ;
if ( ! V_39 )
V_139 = F_8 ( V_30 ) ;
F_69 ( & V_45 -> V_72 ) ;
} else
...
& V_143 ) ;
V_38 -> V_136 = V_142 ;
V_38 -> V_144 = F_100 ( V_90 , V_143 ) ;
}
return V_39 ;
}
static int F_103 ( struct V_89 * V_90 , T_3 V_136 ,
T_3 V_145 )
{
int V_39 , V_146 ;
T_5 V_30 ;
...
T_3 V_140 [ 2 ] = { V_90 -> V_95 , V_136 } ;
V_45 -> V_73 = 1 ;
V_30 = F_3 ( F_11 ( V_145 , V_45 -> time ) ) ;
F_46 ( & V_30 ) ;
V_39 = F_104 ( & V_45 -> V_32 , V_45 -> V_34 , V_140 , & V_30 ,
& V_45 -> V_34 , & V_146 ) ;
if ( V_39 )
return V_39 ;
if ( V_146 ) {
...
int F_105 ( struct V_89 * V_90 , T_3 V_136 ,
T_3 V_145 )
{
int V_39 ;
F_78 ( & V_90 -> V_45 -> V_72 ) ;
V_39 = F_103 ( V_90 , V_136 , V_145 ) ;
F_79 ( & V_90 -> V_45 -> V_72 ) ;
return V_39 ;
}
static int F_106 ( struct V_89 * V_90 , T_3 V_136 )
{
int V_39 ;
struct V_44 * V_45 = V_90 -> V_45 ;
T_3 V_140 [ 2 ] = { V_90 -> V_95 , V_136 } ;
V_39 = F_76 ( & V_45 -> V_32 , V_45 -> V_34 , V_140 , & V_45 -> V_34 ) ;
if ( V_39 )
return V_39 ;
V_90 -> V_96 -- ;
V_90 -> V_94 = 1 ;
...
int F_107 ( struct V_89 * V_90 , T_3 V_136 )
{
int V_39 ;
F_78 ( & V_90 -> V_45 -> V_72 ) ;
V_39 = F_106 ( V_90 , V_136 ) ;
F_79 ( & V_90 -> V_45 -> V_72 ) ;
return V_39 ;
}
int F_108 ( struct V_44 * V_45 , T_3 * V_38 )
{
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
V_39 = F_109 ( V_45 -> V_48 , V_38 ) ;
V_45 -> V_73 = 1 ;
F_79 ( & V_45 -> V_72 ) ;
return V_39 ;
}
...
int F_110 ( struct V_44 * V_45 , T_3 * V_38 )
{
int V_39 ;
F_68 ( & V_45 -> V_72 ) ;
V_39 = F_111 ( V_45 -> V_48 , V_38 ) ;
F_69 ( & V_45 -> V_72 ) ;
return V_39 ;
}
int F_112 ( struct V_44 * V_45 ,
T_3 * V_38 )
{
int V_39 ;
F_68 ( & V_45 -> V_72 ) ;
V_39 = F_111 ( V_45 -> V_58 , V_38 ) ;
F_69 ( & V_45 -> V_72 ) ;
return V_39 ;
}
int F_113 ( struct V_44 * V_45 ,
T_3 * V_38 )
{
int V_39 ;
F_68 ( & V_45 -> V_72 ) ;
V_39 = F_114 ( V_45 -> V_58 , V_38 ) ;
F_69 ( & V_45 -> V_72 ) ;
return V_39 ;
}
int F_115 ( struct V_44 * V_45 , T_7 * V_38 )
{
F_68 ( & V_45 -> V_72 ) ;
* V_38 = V_45 -> V_80 ;
F_69 ( & V_45 -> V_72 ) ;
...
int F_116 ( struct V_44 * V_45 , T_3 * V_38 )
{
int V_39 ;
F_68 ( & V_45 -> V_72 ) ;
V_39 = F_114 ( V_45 -> V_48 , V_38 ) ;
F_69 ( & V_45 -> V_72 ) ;
return V_39 ;
}
int F_117 ( struct V_89 * V_90 , T_3 * V_38 )
{
struct V_44 * V_45 = V_90 -> V_45 ;
F_68 ( & V_45 -> V_72 ) ;
* V_38 = V_90 -> V_96 ;
...
static int F_118 ( struct V_89 * V_90 , T_3 * V_38 )
{
int V_39 ;
T_5 V_20 ;
T_3 V_147 ;
...
return V_39 ;
V_147 = F_8 ( V_20 ) ;
return F_119 ( & V_45 -> V_69 , V_147 , V_38 ) ;
}
int F_120 ( struct V_89 * V_90 ,
T_3 * V_38 )
{
int V_39 ;
struct V_44 * V_45 = V_90 -> V_45 ;
F_68 ( & V_45 -> V_72 ) ;
V_39 = F_118 ( V_90 , V_38 ) ;
F_69 ( & V_45 -> V_72 ) ;
return V_39 ;
}
static int F_121 ( struct V_44 * V_45 , T_3 V_148 )
{
int V_39 ;
T_3 V_149 ;
V_39 = F_114 ( V_45 -> V_48 , & V_149 ) ;
if ( V_39 )
return V_39 ;
if ( V_148 == V_149 )
return 0 ;
...
V_39 = F_122 ( V_45 -> V_48 , V_148 - V_149 ) ;
if ( ! V_39 )
V_45 -> V_73 = 1 ;
return V_39 ;
}
int F_123 ( struct V_44 * V_45 , T_3 V_148 )
{
int V_39 ;
F_78 ( & V_45 -> V_72 ) ;
V_39 = F_121 ( V_45 , V_148 ) ;
F_79 ( & V_45 -> V_72 ) ;
return V_39 ;
}
