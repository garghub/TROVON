...
void F_79 ( struct V_95 * V_12 )
{
struct V_1 * V_2 = V_12 -> V_13 ;
F_80 ( & V_2 -> V_180 ) ;
F_81 ( V_2 -> V_181 ) ;
}
int F_82 ( struct V_95 * V_12 )
{
F_76 ( V_12 ) ;
F_40 ( V_12 ) ;
F_55 ( V_12 ) ;
...
void F_83 ( struct V_95 * V_12 )
{
F_79 ( V_12 ) ;
}
static int F_84 ( void * V_183 )
{
struct V_184 * V_160 = V_183 ;
struct V_1 * V_2 = V_160 -> V_12 -> V_13 ;
T_5 V_185 ;
V_185 = F_85 ( V_2 , V_74 , 0xb7 , 0x10 ) >> 4 ;
return V_185 & 1 ? 1 : 0 ;
}
static int F_86 ( void * V_183 )
{
struct V_184 * V_160 = V_183 ;
struct V_1 * V_2 = V_160 -> V_12 -> V_13 ;
T_5 V_185 ;
V_185 = F_85 ( V_2 , V_74 , 0xb7 , 0x20 ) >> 5 ;
return V_185 & 1 ? 1 : 0 ;
}
static void F_87 ( void * V_183 , int clock )
{
struct V_184 * V_160 = V_183 ;
struct V_1 * V_2 = V_160 -> V_12 -> V_13 ;
int V_15 ;
...
V_187 = F_85 ( V_2 , V_74 , 0xb7 , 0x01 ) ;
if ( V_186 == V_187 )
break;
}
}
static void F_88 ( void * V_183 , int V_188 )
{
struct V_184 * V_160 = V_183 ;
struct V_1 * V_2 = V_160 -> V_12 -> V_13 ;
int V_15 ;
...
V_160 -> V_197 . V_200 = F_88 ;
V_160 -> V_197 . V_201 = F_87 ;
V_160 -> V_197 . V_202 = F_86 ;
V_160 -> V_197 . V_203 = F_84 ;
V_128 = F_90 ( & V_160 -> V_161 ) ;
if ( V_128 ) {
F_28 ( L_6 ) ;
goto V_204;
}
...
static T_2 F_94 ( T_1 * V_205 , T_1 * V_206 , int V_207 , int V_208 )
{
union {
T_2 V_209 ;
T_1 V_210 [ 4 ] ;
...
return - V_136 ;
V_123 = F_98 ( V_11 -> V_12 , V_226 , V_227 ) ;
if ( ! V_123 ) {
F_28 ( L_7 , V_227 ) ;
return - V_232 ;
}
...
V_205 = F_99 ( & V_229 , & V_230 ) ;
V_206 = F_99 ( & V_2 -> V_180 , & V_231 ) ;
if ( V_230 == true )
F_28 ( L_8 ) ;
if ( V_231 == false )
F_28 ( L_9 ) ;
V_206 += ( V_176 + V_177 ) * V_2 -> V_233 ;
V_215 = F_94 ( V_205 , V_206 , V_207 , V_208 ) ;
F_80 ( & V_229 ) ;
F_25 ( V_127 ) ;
{
T_1 * V_206 = ( T_1 * ) V_2 -> V_180 . V_234 + ( V_176 + V_177 ) * V_2 -> V_233 + V_176 ;
F_95 ( V_215 , V_206 ) ;
F_95 ( V_207 , V_206 + V_235 ) ;
F_95 ( V_208 , V_206 + V_236 ) ;
F_95 ( 0 , V_206 + V_237 ) ;
F_95 ( 0 , V_206 + V_238 ) ;
V_129 = V_2 -> V_182 ;
...
F_95 ( V_119 , V_245 + V_246 ) ;
F_95 ( V_120 , V_245 + V_247 ) ;
V_243 = V_14 -> V_241 ;
V_244 = V_14 -> V_242 ;
if ( V_119 < 0 ) {
