...
V_156 -> V_164 = V_14 -> V_52 -> V_164 ;
V_154 = V_14 -> V_52 -> V_164 -> V_165 ( V_14 -> V_52 , V_156 , V_166 ) ;
if ( V_154 < 0 )
goto V_163;
memset ( & V_155 , 0 , sizeof( V_155 ) ) ;
if ( V_156 -> V_164 -> V_167 ( V_156 , (struct V_35 * ) & V_155 ,
& V_4 , 2 ) ) {
V_154 = - V_168 ;
goto V_163;
}
...
static void F_70 ( struct V_170 * V_171 )
{
F_42 ( V_171 -> V_172 ) ;
F_71 ( V_171 ) ;
}
...
if ( V_14 -> V_89 ++ > V_177 )
return;
if ( F_23 ( V_14 -> V_8 , (struct V_35 * ) & V_173 ) ) {
F_50 ( L_19 , V_14 -> V_8 ) ;
return;
}
V_174 = F_19 ( 0 , 0 ) ;
F_45 ( V_174 == NULL ) ;
F_38 ( & V_173 , V_68 . V_178 , & V_176 ) ;
V_94 . V_99 = & V_173 ;
V_94 . V_100 = V_176 ;
V_94 . V_101 = V_91 ;
V_94 . V_102 = sizeof( V_91 ) ;
...
V_171 = F_76 ( & V_14 -> V_20 , struct V_170 , V_17 ) ;
V_4 = V_171 -> V_4 ;
V_175 = V_171 -> V_175 ;
F_75 ( & V_14 -> V_21 ) ;
V_139 [ 0 ] . V_149 = F_62 ( V_171 -> V_172 ) + V_175 ;
V_139 [ 0 ] . V_148 = V_4 ;
V_96 = F_46 ( & V_94 ) ;
V_96 -> V_105 = V_106 ;
V_96 -> V_107 = V_108 ;
...
V_97 = F_48 ( V_96 ) ;
memset ( V_97 , 0x00 , sizeof( struct V_92 ) ) ;
V_97 -> V_179 = F_77 ( F_36 () ) ;
V_94 . V_102 = V_96 -> V_109 ;
V_98 = F_49 ( V_174 -> V_52 , & V_94 , V_139 , 1 , V_4 ) ;
if ( V_98 < 0 ) {
F_50 ( L_21 ,
V_14 -> V_8 , V_98 ) ;
F_30 ( V_65 , & V_14 -> V_56 ) ;
...
V_14 -> V_27 = F_79 ;
F_37 ( V_52 , V_14 ) ;
memcpy ( & V_182 , V_40 [ 0 ] , sizeof( V_182 ) ) ;
F_38 ( & V_182 , 0 , & V_80 ) ;
V_154 = V_52 -> V_164 -> V_186 ( V_52 , (struct V_35 * ) & V_182 ,
V_80 ) ;
if ( V_154 < 0 ) {
F_50 ( L_23 , V_154 ) ;
}
F_38 ( & V_78 , V_68 . V_178 , & V_80 ) ;
F_50 ( L_24 , V_14 -> V_8 ) ;
F_80 ( V_52 , V_187 , V_188 , ( char * ) & V_183 ,
sizeof( V_183 ) ) ;
V_154 =
V_52 -> V_164 -> V_189 ( V_52 , (struct V_35 * ) & V_78 , V_80 ,
V_166 ) ;
if ( V_154 == - V_190 )
V_154 = 0 ;
if ( V_154 == 0 )
...
if ( V_154 != - V_181 && V_154 != - V_191 &&
V_154 != - V_192 && V_154 != - V_193
&& V_154 != - V_194 ) {
F_32 ( V_14 ) ;
V_154 = 0 ;
}
...
F_80 ( V_52 , V_187 , V_188 , ( char * ) & V_183 ,
sizeof( V_183 ) ) ;
V_154 = F_80 ( V_52 , V_196 , V_197 ,
( char * ) & V_183 , sizeof( V_183 ) ) ;
if ( V_154 < 0 ) {
F_50 ( L_26 , V_154 ) ;
}
V_52 -> V_53 -> V_76 = V_14 ;
...
V_14 -> V_52 = V_52 ;
F_38 ( V_78 , V_68 . V_178 , & V_80 ) ;
V_154 = V_52 -> V_164 -> V_186 ( V_52 , (struct V_35 * ) V_78 , V_80 ) ;
if ( V_154 < 0 ) {
F_50 ( L_27 , V_68 . V_178 ) ;
F_41 ( V_52 ) ;
V_52 = NULL ;
V_14 -> V_52 = NULL ;
goto V_195;
}
V_154 = F_80 ( V_52 , V_196 , V_198 ,
( char * ) & V_183 , sizeof( V_183 ) ) ;
if ( V_154 < 0 ) {
F_50 ( L_28 , V_154 ) ;
}
V_154 = V_52 -> V_164 -> V_199 ( V_52 , 5 ) ;
if ( V_154 < 0 ) {
F_50 ( L_29 , V_68 . V_178 ) ;
F_41 ( V_52 ) ;
V_52 = NULL ;
goto V_195;
}
...
{
struct V_37 V_200 , * V_38 ;
int V_30 ;
V_39 = 0 ;
for ( V_30 = 0 ; V_30 < V_201 ; V_30 ++ ) {
if ( F_83 ( & V_200 , V_30 ) )
break;
V_38 = F_84 ( sizeof( * V_38 ) , V_70 ) ;
if ( ! V_38 )
break;
memcpy ( V_38 , & V_200 , sizeof( * V_38 ) ) ;
V_40 [ V_39 ++ ] = V_38 ;
}
}
static int F_85 ( struct V_10 * V_202 ,
struct V_37 * V_38 ,
int V_80 , int V_203 )
{
int V_154 = 0 ;
if ( V_203 == 1 )
V_154 = F_86 ( V_202 -> V_52 ,
(struct V_35 * ) V_38 ,
V_80 ) ;
else
V_154 = F_80 ( V_202 -> V_52 , V_204 ,
V_205 ,
( char * ) V_38 , V_80 ) ;
if ( V_154 < 0 )
F_50 ( L_30 ,
...
struct V_37 V_206 ;
struct V_207 V_208 ;
int V_154 = - V_193 , V_203 = 1 , V_30 , V_80 ;
struct V_10 * V_14 = F_19 ( 0 , V_70 ) ;
int V_209 = V_210 ;
if ( ! V_14 )
return - V_71 ;
F_50 ( L_31 ) ;
V_154 = F_66 ( V_40 [ 0 ] -> V_41 , V_211 ,
V_106 , & V_52 ) ;
if ( V_154 < 0 ) {
F_50 ( L_32 ) ;
goto V_184;
...
V_208 . V_215 = 1 ;
V_208 . V_216 = 1 ;
V_154 = F_80 ( V_52 , V_196 , V_217 ,
( char * ) & V_209 , sizeof( V_209 ) ) ;
if ( V_154 )
F_50 ( L_33 , V_154 ) ;
V_154 = F_80 ( V_52 , V_204 , V_218 ,
...
memcpy ( & V_206 , V_40 [ V_30 ] , sizeof( V_206 ) ) ;
F_38 ( & V_206 , V_68 . V_178 , & V_80 ) ;
V_154 = F_85 ( V_14 , & V_206 , V_80 , V_203 ) ;
if ( V_154 )
goto V_219;
++ V_203 ;
}
...
static struct V_170 * F_89 ( struct V_10 * V_14 ,
T_1 V_31 )
{
struct V_170 * V_221 ;
V_221 = F_84 ( sizeof( struct V_170 ) , V_31 ) ;
if ( ! V_221 )
return NULL ;
V_221 -> V_172 = F_61 ( V_31 ) ;
if ( ! V_221 -> V_172 ) {
F_71 ( V_221 ) ;
return NULL ;
}
...
void * F_90 ( int V_8 , int V_4 , T_1 V_31 , char * * V_223 )
{
struct V_10 * V_14 ;
struct V_170 * V_171 ;
int V_175 = 0 ;
...
return NULL ;
F_73 ( & V_14 -> V_21 ) ;
V_171 = F_91 ( V_14 -> V_20 . V_224 , struct V_170 , V_17 ) ;
if ( ( & V_171 -> V_17 == & V_14 -> V_20 ) ||
( V_147 - V_171 -> V_222 < V_4 ) ) {
V_171 = NULL ;
} else {
V_175 = V_171 -> V_222 ;
V_171 -> V_222 += V_4 ;
...
if ( V_171 ) {
V_225:
* V_223 = F_62 ( V_171 -> V_172 ) + V_175 ;
return V_171 ;
}
V_171 = F_89 ( V_14 , V_31 ) ;
if ( V_171 ) {
F_73 ( & V_14 -> V_21 ) ;
V_175 = V_171 -> V_222 ;
V_171 -> V_222 += V_4 ;
V_180 = V_171 -> V_180 ++ ;
F_92 ( & V_171 -> V_17 , & V_14 -> V_20 ) ;
F_75 ( & V_14 -> V_21 ) ;
goto V_225;
}
return NULL ;
}
void F_93 ( void * V_226 )
{
struct V_170 * V_171 = (struct V_170 * ) V_226 ;
struct V_10 * V_14 = V_171 -> V_14 ;
int V_180 ;
F_73 ( & V_14 -> V_21 ) ;
V_180 = -- V_171 -> V_180 ;
if ( V_180 )
goto V_184;
V_171 -> V_4 = V_171 -> V_222 - V_171 -> V_175 ;
F_75 ( & V_14 -> V_21 ) ;
if ( ! F_27 ( V_62 , & V_14 -> V_56 ) ) {
F_28 ( V_63 , & V_14 -> V_22 ) ;
}
...
F_73 ( & V_14 -> V_21 ) ;
for (; ; ) {
V_171 = F_91 ( V_14 -> V_20 . V_229 , struct V_170 ,
V_17 ) ;
if ( (struct V_230 * ) V_171 == & V_14 -> V_20 )
break;
V_4 = V_171 -> V_4 ;
V_175 = V_171 -> V_175 ;
F_45 ( V_4 == 0 && V_171 -> V_180 == 0 ) ;
F_75 ( & V_14 -> V_21 ) ;
V_98 = 0 ;
if ( V_4 ) {
V_98 = F_95 ( V_14 -> V_52 , V_171 -> V_172 , V_175 , V_4 ,
V_103 ) ;
...
static void V_25 ( struct V_234 * V_235 )
{
struct V_10 * V_14 = F_101 ( V_235 , struct V_10 , V_24 ) ;
int V_236 ;
F_30 ( V_55 , & V_14 -> V_56 ) ;
do {
V_236 = V_14 -> V_28 ( V_14 ) ;
} while ( ! V_236 );
}
static void V_23 ( struct V_234 * V_235 )
{
struct V_10 * V_14 = F_101 ( V_235 , struct V_10 , V_22 ) ;
if ( F_31 ( V_65 , & V_14 -> V_56 ) ) {
V_14 -> V_27 ( V_14 ) ;
F_68 ( V_62 , & V_14 -> V_56 ) ;
}
