...
static void F_14 ( struct V_40 * V_24 )
{
struct V_2 * V_3 =
F_15 ( V_24 , struct V_2 , V_24 . V_24 ) ;
int V_10 ;
V_10 = F_12 ( V_3 -> V_28 ) ;
if ( V_10 >= 0 )
V_3 -> V_28 -> V_30 . V_31 = V_10 ;
if ( V_3 -> V_22 )
F_16 ( & V_3 -> V_24 , V_41 / 8 ) ;
}
...
V_3 = F_20 ( sizeof( struct V_2 ) , V_61 ) ;
if ( ! V_3 ) {
V_10 = - V_54 ;
F_2 ( & V_43 -> V_6 , L_6 ) ;
goto error;
...
snprintf ( V_55 , sizeof( V_55 ) , L_11 ,
F_28 ( & V_64 ) - 1 ) ;
memset ( & V_30 , 0 , sizeof( struct V_46 ) ) ;
V_30 . type = V_65 ;
V_30 . V_66 = 0xff ;
V_3 -> V_28 = F_29 ( V_55 , NULL , V_3 ,
& V_67 , & V_30 ) ;
if ( F_30 ( V_3 -> V_28 ) ) {
F_2 ( & V_43 -> V_6 , L_12 ) ;
V_10 = F_31 ( V_3 -> V_28 ) ;
