...
F_38 ( V_25 , V_54 , & V_25 -> V_36 -> V_37 . V_59 ) ;
V_25 -> V_29 &= ~ V_60 ;
} else if ( F_39 () ) {
F_17 ( V_25 ) -> V_49 = 0 ;
}
...
static int F_42 ( const struct V_61 * V_62 ,
struct V_63 * V_64 )
{
int V_65 , V_66 ;
struct V_41 * V_42 = 0 ;
...
V_5 = F_44 ( & V_64 -> V_72 , L_8 ) ;
if ( F_45 ( V_5 ) )
return F_46 ( V_5 ) ;
if ( ! F_32 () )
V_4 = F_44 ( & V_64 -> V_72 , L_9 ) ;
else
V_4 = F_44 ( & V_64 -> V_72 , L_10 ) ;
if ( F_45 ( V_4 ) ) {
F_47 ( V_5 ) ;
return F_46 ( V_4 ) ;
}
V_42 = F_48 ( V_62 , & V_64 -> V_72 , F_49 ( & V_64 -> V_72 ) ) ;
if ( ! V_42 ) {
V_65 = - V_73 ;
goto V_74;
}
V_42 -> V_75 = V_64 -> V_69 [ 0 ] . V_76 ;
V_42 -> V_77 = V_64 -> V_69 [ 0 ] . V_78 - V_64 -> V_69 [ 0 ] . V_76 + 1 ;
if ( ! F_50 ( V_42 -> V_75 , V_42 -> V_77 , V_79 ) ) {
F_24 ( & V_64 -> V_72 , L_11 ) ;
V_65 = - V_80 ;
goto V_81;
}
V_42 -> V_36 = F_51 ( V_42 -> V_75 , V_42 -> V_77 ) ;
if ( ! V_42 -> V_36 ) {
F_31 ( & V_64 -> V_72 , L_12 ) ;
V_65 = - V_73 ;
goto V_82;
...
static inline void
F_58 ( struct V_41 * V_42 , struct V_63 * V_64 )
{
struct V_24 * V_25 = F_23 ( V_42 ) ;
F_59 ( V_42 ) ;
if ( V_25 -> V_31 ) {
( void ) F_29 ( V_25 -> V_31 -> V_32 , 0 ) ;
F_30 ( V_25 -> V_31 ) ;
}
if ( F_11 () )
F_60 ( 9 ) ;
...
if ( V_44 -> V_32 || V_44 -> V_87 ) {
V_25 -> V_88 = V_89 ;
F_20 ( V_89 , & V_25 -> V_36 -> V_90 ) ;
}
if ( ( V_48 = F_62 ( V_25 ) ) < 0 ) {
F_31 ( V_42 -> V_27 . V_45 , L_13 ) ;
F_41 ( V_42 ) ;
return V_48 ;
}
return 0 ;
}
static int F_63 ( struct V_63 * V_72 )
{
return F_42 ( & V_91 , V_72 ) ;
}
static int F_64 ( struct V_63 * V_72 )
{
struct V_41 * V_42 = F_65 ( V_72 ) ;
F_58 ( V_42 , V_72 ) ;
F_66 ( V_72 , NULL ) ;
return 0 ;
}
static int F_67 ( struct V_63 * V_72 , T_2 V_92 )
{
struct V_24 * V_25 = F_23 ( F_65 ( V_72 ) ) ;
if ( F_68 ( V_93 , V_25 -> V_94 ) )
F_69 ( 5 ) ;
V_25 -> V_94 = V_93 ;
F_2 ( 0 ) ;
return 0 ;
}
static int F_70 ( struct V_63 * V_72 )
{
struct V_41 * V_42 = F_65 ( V_72 ) ;
struct V_24 * V_25 = F_23 ( V_42 ) ;
if ( F_68 ( V_93 , V_25 -> V_94 ) )
