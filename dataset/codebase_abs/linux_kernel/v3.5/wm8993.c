...
static T_4 int F_56 ( struct V_141 * V_142 ,
...
static T_5 int F_70 ( struct V_141 * V_142 )
{
struct V_139 * V_140 = F_71 ( V_142 ) ;
F_72 ( & V_142 -> V_2 ) ;
if ( V_142 -> V_162 )
F_68 ( V_142 -> V_162 , V_140 ) ;
F_69 ( V_140 -> V_192 ) ;
