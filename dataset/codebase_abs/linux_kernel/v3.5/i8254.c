...
T_7 V_111 ;
int V_102 ;
V_50 = F_59 ( sizeof( struct V_56 ) , V_112 ) ;
if ( ! V_50 )
return NULL ;
V_50 -> V_66 = F_60 ( V_12 ) ;
if ( V_50 -> V_66 < 0 ) {
...
F_51 ( & V_50 -> V_18 . V_20 ) ;
F_63 ( & V_50 -> V_18 . V_48 ) ;
V_110 = F_64 ( F_65 ( V_113 ) ) ;
V_111 = F_66 ( V_110 ) ;
F_67 ( V_110 ) ;
F_68 ( & V_50 -> V_51 ) ;
V_50 -> V_114 = F_69 ( V_115 , & V_50 -> V_51 ,
L_4 , V_111 ) ;
if ( F_70 ( V_50 -> V_114 ) ) {
F_52 ( & V_50 -> V_18 . V_20 ) ;
F_71 ( V_12 , V_50 -> V_66 ) ;
...
V_116 , V_58 ) ;
V_18 -> V_46 . V_117 = 0 ;
V_18 -> V_46 . V_118 = F_18 ;
F_74 ( V_12 , & V_18 -> V_46 ) ;
V_18 -> V_28 . V_71 = true ;
F_52 ( & V_50 -> V_18 . V_20 ) ;
F_56 ( V_50 ) ;
V_50 -> V_109 . V_119 = F_57 ;
F_75 ( V_12 , 0 , & V_50 -> V_109 ) ;
F_76 ( & V_50 -> V_84 , & V_120 ) ;
V_102 = F_77 ( V_12 , V_121 , V_87 ,
V_88 , & V_50 -> V_84 ) ;
if ( V_102 < 0 )
goto V_122;
if ( V_77 & V_123 ) {
F_76 ( & V_50 -> V_85 , & V_124 ) ;
V_102 = F_77 ( V_12 , V_121 ,
V_103 , 4 ,
& V_50 -> V_85 ) ;
if ( V_102 < 0 )
goto V_125;
...
return V_50 ;
V_125:
F_78 ( V_12 , V_121 , & V_50 -> V_84 ) ;
V_122:
F_79 ( V_12 , 0 , & V_50 -> V_109 ) ;
F_80 ( V_12 , & V_18 -> V_46 ) ;
F_71 ( V_12 , V_50 -> V_66 ) ;
F_81 ( V_50 -> V_114 ) ;
F_61 ( V_50 ) ;
...
struct V_57 * V_30 ;
if ( V_12 -> V_16 . V_17 ) {
F_78 ( V_12 , V_121 , & V_12 -> V_16 . V_17 -> V_84 ) ;
F_78 ( V_12 , V_121 ,
& V_12 -> V_16 . V_17 -> V_85 ) ;
F_79 ( V_12 , 0 ,
...
F_81 ( V_12 -> V_16 . V_17 -> V_114 ) ;
F_71 ( V_12 , V_12 -> V_16 . V_17 -> V_66 ) ;
