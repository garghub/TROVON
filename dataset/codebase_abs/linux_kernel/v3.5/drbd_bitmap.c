...
V_138 = V_5 -> V_88 ;
F_68 ( V_8 , L_32 ,
F_112 ( V_139 , V_138 << ( V_143 - 10 ) ) , V_138 ) ;
F_95 ( & V_104 -> V_102 , & F_87 ) ;
return V_84 ;
}
int F_113 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_103 ( V_2 , V_144 , 0 , 0 ) ;
}
int F_114 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_103 ( V_2 , V_130 , 0 , 0 ) ;
}
int F_115 ( struct V_1 * V_2 , unsigned V_145 ) __must_hold( T_4 )
{
return F_103 ( V_2 , V_130 , V_112 , V_145 ) ;
}
int F_116 ( struct V_1 * V_2 ) __must_hold( T_4 )
{
return F_103 ( V_2 , V_130 , V_112 , 0 ) ;
}
int F_117 ( struct V_1 * V_2 , unsigned int V_25 ) __must_hold( T_4 )
{
struct V_103 * V_104 ;
int V_84 ;
...
static unsigned long F_118 ( struct V_1 * V_2 , unsigned long V_148 ,
const int V_149 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_40 ;
...
unsigned V_43 ;
if ( V_148 > V_5 -> V_63 ) {
F_3 ( V_8 , L_35 , V_148 , V_5 -> V_63 ) ;
V_148 = V_151 ;
} else {
while ( V_148 < V_5 -> V_63 ) {
V_150 = V_148 & ~ V_64 ;
V_40 = F_33 ( V_5 , F_32 ( V_5 , V_148 ) ) ;
if ( V_149 )
V_43 = F_119 ( V_40 ,
V_96 * 8 , V_148 & V_64 ) ;
else
...
unsigned long V_148 , const int V_149 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long V_43 = V_151 ;
F_55 (!b) return V_43 ;
F_55 (!b->bm_pages) return V_43 ;
F_69 ( & V_5 -> V_57 ) ;
if ( V_153 & V_5 -> V_23 )
F_122 ( V_2 ) ;
V_43 = F_118 ( V_2 , V_148 , V_149 ) ;
F_70 ( & V_5 -> V_57 ) ;
return V_43 ;
}
unsigned long F_123 ( struct V_1 * V_2 , unsigned long V_148 )
{
return F_121 ( V_2 , V_148 , 0 ) ;
}
unsigned long F_124 ( struct V_1 * V_2 , unsigned long V_148 )
{
return F_118 ( V_2 , V_148 , 0 ) ;
}
unsigned long F_125 ( struct V_1 * V_2 , unsigned long V_148 )
{
return F_118 ( V_2 , V_148 , 1 ) ;
}
static int F_126 ( struct V_1 * V_2 , const unsigned long V_98 ,
unsigned long V_154 , int V_155 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_40 = NULL ;
unsigned long V_39 ;
unsigned int V_156 = - 1U ;
int V_71 = 0 ;
int V_157 = 0 ;
if ( V_154 >= V_5 -> V_63 ) {
F_3 ( V_8 , L_36 ,
V_98 , V_154 , V_5 -> V_63 ) ;
V_154 = V_5 -> V_63 ? V_5 -> V_63 - 1 : 0 ;
}
for ( V_39 = V_98 ; V_39 <= V_154 ; V_39 ++ ) {
...
static int F_129 ( struct V_1 * V_2 , const unsigned long V_98 ,
const unsigned long V_154 , int V_155 )
{
unsigned long V_19 ;
struct V_4 * V_5 = V_2 -> V_6 ;
int V_71 = 0 ;
...
F_55 (!b->bm_pages) return 0 ;
F_77 ( & V_5 -> V_57 , V_19 ) ;
if ( ( V_155 ? V_158 : V_159 ) & V_5 -> V_23 )
F_122 ( V_2 ) ;
V_71 = F_126 ( V_2 , V_98 , V_154 , V_155 ) ;
F_78 ( & V_5 -> V_57 , V_19 ) ;
return V_71 ;
}
int F_130 ( struct V_1 * V_2 , const unsigned long V_98 , const unsigned long V_154 )
{
return F_129 ( V_2 , V_98 , V_154 , 1 ) ;
}
int F_131 ( struct V_1 * V_2 , const unsigned long V_98 , const unsigned long V_154 )
{
return - F_129 ( V_2 , V_98 , V_154 , 0 ) ;
}
static inline void F_132 ( struct V_4 * V_5 ,
int V_27 , int V_160 , int V_68 )
{
int V_43 ;
int V_67 ;
unsigned long * V_161 = F_34 ( V_5 -> V_29 [ V_27 ] ) ;
for ( V_43 = V_160 ; V_43 < V_68 ; V_43 ++ ) {
V_67 = F_59 ( V_161 [ V_43 ] ) ;
V_161 [ V_43 ] = ~ 0UL ;
V_5 -> V_88 += V_66 - V_67 ;
}
F_37 ( V_161 ) ;
}
void F_133 ( struct V_1 * V_2 , const unsigned long V_98 , const unsigned long V_154 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long V_162 = F_65 ( V_98 , V_66 ) ;
unsigned long V_163 = ( V_154 + 1 ) & ~ ( ( unsigned long ) V_66 - 1 ) ;
int V_164 ;
int V_165 ;
int V_27 ;
int V_160 ;
int V_68 ;
if ( V_154 - V_98 <= 3 * V_66 ) {
F_69 ( & V_5 -> V_57 ) ;
F_126 ( V_2 , V_98 , V_154 , 1 ) ;
F_70 ( & V_5 -> V_57 ) ;
return;
}
F_69 ( & V_5 -> V_57 ) ;
if ( V_162 )
F_126 ( V_2 , V_98 , V_162 - 1 , 1 ) ;
V_164 = V_162 >> ( 3 + V_36 ) ;
V_165 = V_163 >> ( 3 + V_36 ) ;
V_160 = F_66 ( V_162 >> V_37 ) ;
V_68 = V_69 ;
for ( V_27 = V_164 ; V_27 < V_165 ; V_27 ++ ) {
F_132 ( V_2 -> V_6 , V_27 , V_160 , V_68 ) ;
F_70 ( & V_5 -> V_57 ) ;
F_62 () ;
V_160 = 0 ;
F_69 ( & V_5 -> V_57 ) ;
}
V_68 = F_66 ( V_163 >> V_37 ) ;
if ( V_68 )
F_132 ( V_2 -> V_6 , V_165 , V_160 , V_68 ) ;
if ( V_163 <= V_154 )
F_126 ( V_2 , V_163 , V_154 , 1 ) ;
F_70 ( & V_5 -> V_57 ) ;
}
int F_134 ( struct V_1 * V_2 , const unsigned long V_39 )
{
unsigned long V_19 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_40 ;
...
int F_136 ( struct V_1 * V_2 , const unsigned long V_98 , const unsigned long V_154 )
{
unsigned long V_19 ;
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_40 = NULL ;
...
V_71 += ( 0 != F_135 ( V_39 - ( V_27 << ( V_36 + 3 ) ) , V_40 ) ) ;
}
}
if ( V_40 )
F_38 ( V_40 ) ;
...
int F_137 ( struct V_1 * V_2 , unsigned long V_166 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
int V_137 , V_98 , V_154 ;
unsigned long V_19 ;
unsigned long * V_40 , * V_60 ;
F_55 (!b) return 0 ;
F_55 (!b->bm_pages) return 0 ;
...
F_122 ( V_2 ) ;
V_98 = F_138 ( V_166 ) ;
V_154 = F_139 ( ( T_3 ) F_138 ( V_166 + 1 ) , V_5 -> V_75 ) ;
V_137 = 0 ;
if ( V_98 < V_5 -> V_75 ) {
int V_167 = V_154 - V_98 ;
...
unsigned long F_140 ( struct V_1 * V_2 , unsigned long V_168 )
{
struct V_4 * V_5 = V_2 -> V_6 ;
unsigned long * V_40 , * V_60 ;
unsigned long V_169 ;
unsigned long V_98 , V_154 ;
int V_137 , V_43 , V_73 ;
F_55 (!b) return 0 ;
F_55 (!b->bm_pages) return 0 ;
F_69 ( & V_5 -> V_57 ) ;
...
V_169 = V_5 -> V_88 ;
V_98 = V_168 * V_170 ;
V_154 = F_64 ( T_3 , V_98 + V_170 , V_5 -> V_75 ) ;
F_74 ( ( V_154 - 1 ) >> ( V_36 - V_37 + 3 )
== V_98 >> ( V_36 - V_37 + 3 ) ) ;
V_137 = 0 ;
if ( V_98 < V_5 -> V_75 ) {
V_43 = V_73 = V_154 - V_98 ;
V_40 = F_35 ( V_5 , F_31 ( V_5 , V_98 ) ) ;
V_60 = V_40 + F_66 ( V_98 ) ;
while ( V_43 -- ) {
V_137 += F_59 ( * V_60 ) ;
