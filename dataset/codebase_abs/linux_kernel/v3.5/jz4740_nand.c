...
V_6 = F_25 ( sizeof( * V_6 ) , V_71 ) ;
if ( ! V_6 ) {
F_19 ( & V_57 -> V_63 , L_4 ) ;
return - V_72 ;
}
V_61 = F_17 ( V_57 , L_5 , & V_6 -> V_73 , & V_6 -> V_18 ) ;
if ( V_61 )
goto V_74;
V_61 = F_17 ( V_57 , L_6 , & V_6 -> V_75 ,
& V_6 -> V_15 ) ;
if ( V_61 )
goto V_76;
...
static int T_6 F_38 ( struct V_56 * V_57 )
{
struct V_1 * V_6 = F_39 ( V_57 ) ;
F_34 ( & V_6 -> V_3 ) ;
F_7 ( 0 , V_6 -> V_18 + V_19 ) ;
F_36 ( V_6 -> V_15 ) ;
F_23 ( V_6 -> V_75 -> V_66 , F_21 ( V_6 -> V_75 ) ) ;
F_36 ( V_6 -> V_18 ) ;
F_23 ( V_6 -> V_73 -> V_66 , F_21 ( V_6 -> V_73 ) ) ;
F_28 ( V_57 , NULL ) ;
F_37 ( V_6 ) ;
return 0 ;
}
