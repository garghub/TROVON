...
{
if ( ! V_124 ) {
F_26 ( V_2 , V_125 , V_126 ) ;
if ( V_2 -> V_127 . V_128 )
F_27 ( V_2 , V_129 , V_2 -> V_127 . V_128 ) ;
else
F_27 ( V_2 , V_129 , V_2 -> V_130 ) ;
}
if ( V_2 -> V_127 . V_131 ) {
unsigned int V_132 ;
struct V_133 * V_134 ;
V_134 = V_124 ? & V_2 -> V_59 :
& V_2 -> V_61 ;
for ( V_132 = 0 ; V_132 < V_134 -> V_135 ; V_132 ++ ) {
F_27 ( V_2 ,
F_28 ( V_134 , V_132 , 0 ) ,
F_28 ( V_134 , V_132 , 1 ) ) ;
}
...
{
struct V_136 * V_137 = F_30 ( V_2 ) ;
struct V_138 * V_139 = F_31 ( V_2 ) ;
V_137 -> V_140 = F_1 ;
V_137 -> V_141 = F_24 ;
V_139 -> V_142 = F_25 ;
F_32 ( V_2 ) ;
