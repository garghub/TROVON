...
T_6 V_94 , T_6 V_95 , T_6 V_96 , int V_97 )
{
F_20 ( L_11 ) ;
}
...
static void F_3 ( struct V_1 * V_2 , int V_99 , int V_100 , int V_101 , int V_102 )
{
struct V_32 * V_33 = F_14 ( V_2 ) ;
if ( ! V_33 )
return;
F_44 ( L_13 , V_99 , V_100 , V_101 , V_102 , V_2 ) ;
F_45 ( V_33 -> V_45 , V_99 , V_100 , V_101 , V_102 ) ;
}
struct V_32 * F_46 ( struct V_43 * V_38 )
{
struct V_36 * V_37 = V_38 -> V_39 ;
struct V_22 * V_23 = NULL ;
struct V_32 * V_33 ;
int V_51 = 0 ;
V_23 = F_47 ( sizeof( * V_23 ) , V_103 ) ;
if ( ! V_23 ) {
F_26 ( V_38 -> V_38 , L_14 ) ;
goto V_68;
}
...
V_33 -> V_90 = & V_104 ;
V_51 = F_49 ( V_38 , V_33 ,
V_37 -> V_105 , V_37 -> V_106 ) ;
if ( V_51 ) {
F_26 ( V_38 -> V_38 , L_15 , V_51 ) ;
goto V_68;
}
F_50 ( V_33 ) ;
F_51 ( V_33 , 32 ) ;
