...
static int T_5 F_24 ( struct V_55 * V_9 )
{
struct V_1 * V_2 ;
struct V_27 * V_28 ;
int V_19 , V_56 = 0 , V_57 = 0 ;
V_28 = F_25 ( sizeof( * V_2 ) ) ;
if ( V_28 == NULL )
return - V_58 ;
V_2 = F_13 ( V_28 ) ;
F_26 ( V_9 , V_28 ) ;
V_2 -> V_59 = F_27 ( & V_9 -> V_23 , L_7 ) ;
if ( ! F_28 ( V_2 -> V_59 ) ) {
V_19 = F_29 ( V_2 -> V_59 ) ;
if ( V_19 )
goto V_60;
...
V_2 -> V_49 = V_2 -> V_61 -> V_64 ;
V_2 -> V_9 = V_9 ;
V_28 -> V_23 . V_65 = & V_9 -> V_23 ;
V_28 -> V_66 = F_31 ( V_9 ) -> V_66 ;
V_28 -> V_67 = & V_68 ;
V_28 -> V_69 = V_70 ;
V_28 -> V_71 = V_2 -> V_61 -> V_72 ;
V_28 -> V_73 = V_74 ;
V_56 = 1 ;
V_19 = F_1 ( V_2 , V_75 , 0 ,
! ! V_57 , 0 ) ;
...
static int T_6 F_36 ( struct V_55 * V_9 )
{
