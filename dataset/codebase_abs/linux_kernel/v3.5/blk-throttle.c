...
struct V_8 * V_9 ;
int V_127 ;
V_9 = F_131 ( sizeof( * V_9 ) , V_134 , V_41 -> V_52 ) ;
if ( ! V_9 )
return - V_135 ;
V_9 -> V_58 = V_136 ;
V_9 -> V_28 = false ;
F_132 ( & V_9 -> V_106 , F_101 ) ;
V_41 -> V_9 = V_9 ;
V_9 -> V_10 = V_41 ;
V_127 = F_133 ( V_41 , & V_6 ) ;
if ( V_127 )
F_134 ( V_9 ) ;
return V_127 ;
}
void F_135 ( struct V_40 * V_41 )
{
F_57 ( ! V_41 -> V_9 ) ;
F_119 ( V_41 ) ;
F_136 ( V_41 , & V_6 ) ;
