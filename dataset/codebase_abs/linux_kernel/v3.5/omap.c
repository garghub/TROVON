...
F_136 ( V_4 ) ;
V_248:
F_137 ( V_241 -> V_245 , F_119 ( V_241 ) ) ;
return V_242 ;
}
static int T_6 F_138 ( struct V_236 * V_237 )
{
struct V_7 * V_4 = F_139 ( V_237 ) ;
int V_32 ;
F_124 ( V_237 , NULL ) ;
F_18 ( V_4 == NULL ) ;
for ( V_32 = 0 ; V_32 < V_4 -> V_35 ; V_32 ++ )
...
F_134 ( V_4 -> V_252 ) ;
F_135 ( V_4 -> V_134 ) ;
F_137 ( V_237 -> V_240 [ 0 ] . V_245 ,
V_237 -> V_240 [ 0 ] . V_263 - V_237 -> V_240 [ 0 ] . V_245 + 1 ) ;
F_132 ( V_4 -> V_38 ) ;
F_136 ( V_4 ) ;
return 0 ;
}
static int F_140 ( struct V_236 * V_237 , T_7 V_264 )
{
int V_32 , V_242 = 0 ;
struct V_7 * V_4 = F_139 ( V_237 ) ;
if ( V_4 == NULL || V_4 -> V_265 )
return 0 ;
for ( V_32 = 0 ; V_32 < V_4 -> V_35 ; V_32 ++ ) {
struct V_1 * V_2 ;
V_2 = V_4 -> V_37 [ V_32 ] ;
V_242 = F_141 ( V_2 -> V_15 ) ;
if ( V_242 < 0 ) {
while ( -- V_32 >= 0 ) {
V_2 = V_4 -> V_37 [ V_32 ] ;
F_142 ( V_2 -> V_15 ) ;
...
static int F_143 ( struct V_236 * V_237 )
{
int V_32 , V_242 = 0 ;
struct V_7 * V_4 = F_139 ( V_237 ) ;
if ( V_4 == NULL || ! V_4 -> V_265 )
