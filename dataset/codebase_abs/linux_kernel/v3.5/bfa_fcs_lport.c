...
void
F_55 ( struct V_1 * V_36 ,
struct V_43 * V_47 , T_2 V_52 )
{
T_3 V_73 = V_47 -> V_54 ;
struct V_16 * V_17 = NULL ;
struct V_111 * V_112 = (struct V_111 * ) ( V_47 + 1 ) ;
F_56 ( V_36 , V_113 ) ;
...
if ( ( V_47 -> type == V_115 ) &&
( V_112 -> V_116 == V_117 ) ) {
F_25 ( V_36 , V_47 , (struct V_65 * ) V_112 ) ;
return;
}
if ( ( V_47 -> type == V_115 ) && ( V_112 -> V_116 == V_118 ) ) {
F_36 ( V_36 , V_47 ,
(struct V_77 * ) V_112 , V_52 ) ;
return;
}
if ( ( V_47 -> type == V_115 ) && ( V_112 -> V_116 == V_119 ) ) {
F_38 ( V_36 , V_47 ,
(struct V_81 * ) V_112 , V_52 ) ;
return;
}
if ( V_47 -> type == V_120 ) {
if ( ( V_47 -> V_121 == V_122 ) &&
...
F_2 ( V_36 -> V_5 , V_112 -> V_116 ) ;
if ( V_112 -> V_116 == V_129 ) {
F_59 ( V_36 , V_47 , V_52 ) ;
return;
}
if ( V_112 -> V_116 == V_130 ) {
return;
}
if ( V_112 -> V_116 == V_131 ) {
return;
}
F_17 ( V_36 , V_47 , V_132 ,
V_133 ) ;
}
struct V_16 *
...
struct V_16 *
F_62 ( struct V_1 * V_2 , V_71 V_134 )
{
struct V_16 * V_17 ;
struct V_18 * V_19 ;
F_60 (qe, &port->rport_q) {
V_17 = (struct V_16 * ) V_19 ;
if ( F_61 ( V_17 -> V_134 , V_134 ) )
return V_17 ;
}
F_2 ( V_2 -> V_5 , V_134 ) ;
return NULL ;
...
void
F_71 ( struct V_1 * V_36 , struct V_136 * V_5 ,
T_2 V_37 , struct V_137 * V_14 )
{
V_36 -> V_5 = V_5 ;
V_36 -> V_23 = F_72 ( V_5 , V_37 ) ;
V_36 -> V_14 = V_14 ;
V_36 -> V_56 = ( V_14 ) ? V_14 -> V_74 -> V_138 :
V_36 -> V_23 -> V_74 -> V_138 ;
F_73 ( & V_36 -> V_135 ) ;
V_36 -> V_25 = 0 ;
}
void
F_74 ( struct V_1 * V_36 ,
struct V_139 * V_6 )
{
struct V_137 * V_14 = V_36 -> V_14 ;
struct V_31 * V_32 = (struct V_31 * ) V_36 -> V_5 -> V_32 ;
char V_96 [ V_97 ] ;
V_36 -> V_6 = * V_6 ;
V_36 -> V_140 = F_75 ( V_36 -> V_5 -> V_32 , V_36 ,
V_36 -> V_6 . V_38 ,
V_36 -> V_23 -> V_141 ,
V_14 ? V_14 -> V_142 : NULL ) ;
F_45 ( V_96 , F_14 ( V_36 ) ) ;
F_46 ( V_108 , V_32 , V_100 ,
L_6 ,
V_96 , L_2 ) ;
...
if ( ! V_49 ) {
F_104 ( V_2 -> V_5 -> V_202 , & V_171 -> V_181 ,
F_96 , V_171 ) ;
return;
}
V_171 -> V_49 = V_49 ;
V_201 = F_20 ( V_49 ) ;
memset ( V_201 , 0 , V_59 ) ;
V_52 = F_105 ( & V_47 , V_201 , F_21 ( V_2 ) ,
V_203 ) ;
V_200 =
F_106 ( V_171 ,
...
static T_2
F_106 ( struct V_170 * V_171 , T_1 * V_201 )
{
struct V_1 * V_2 = V_171 -> V_173 -> V_2 ;
struct V_206 V_207 ;
...
V_249 = (struct V_60 * ) F_110 ( V_49 ) ;
V_249 -> V_251 = F_111 ( V_249 -> V_251 ) ;
...
static void
F_95 ( void * V_198 , struct V_48 * V_199 )
{
struct V_170 * V_171 = V_198 ;
struct V_1 * V_2 = V_171 -> V_173 -> V_2 ;
struct V_43 V_47 ;
...
++ V_214 ;
V_212 -> V_52 =
F_108 ( V_215 + sizeof( V_212 -> type ) +
sizeof( V_215 ) ) ;
V_212 = (struct V_211 * ) V_213 ;
V_212 -> type = F_108 ( V_262 ) ;
...
static T_2
F_112 ( struct V_170 * V_171 , T_1 * V_201 )
{
struct V_1 * V_2 = V_171 -> V_173 -> V_2 ;
...
static void
F_100 ( void * V_198 , struct V_48 * V_199 )
{
struct V_170 * V_171 = V_198 ;
struct V_1 * V_2 = V_171 -> V_173 -> V_2 ;
struct V_43 V_47 ;
...
static T_2
F_115 ( struct V_170 * V_171 , T_1 * V_201 )
{
struct V_1 * V_2 = V_171 -> V_173 -> V_2 ;
...
F_122 ( V_2 -> V_5 -> V_202 , & V_289 ) ;
F_123 ( V_290 , V_145 -> V_261 ) ;
switch ( V_289 . V_291 ) {
case V_292 :
V_145 -> V_263 =
F_42 ( V_293 ) ;
...
V_49 = V_199 ? V_199 : F_18 ( V_2 -> V_5 ) ;
if ( ! V_49 ) {
F_104 ( V_2 -> V_5 -> V_202 , & V_173 -> V_181 ,
F_130 , V_173 ) ;
return;
}
V_173 -> V_49 = V_49 ;
V_52 = F_132 ( & V_47 , F_20 ( V_49 ) ,
F_21 ( V_2 ) ,
V_2 -> V_23 -> V_74 -> V_334 ) ;
F_22 ( V_49 , NULL , V_2 -> V_23 -> V_37 , V_2 -> V_56 , V_57 ,
V_58 , V_52 , & V_47 ,
...
if ( V_249 -> V_251 == V_252 ) {
V_350 = ( V_71 * ) ( V_249 + 1 ) ;
if ( ( memcmp ( ( void * ) & F_77 ( V_2 ) ,
V_350 , sizeof( V_71 ) ) != 0 ) ) {
F_135 ( V_2 -> V_23 , * V_350 ) ;
}
F_11 ( V_173 , V_324 ) ;
return;
}
...
static void
F_129 ( void * V_333 , struct V_48 * V_199 )
{
struct V_311 * V_173 = V_333 ;
...
V_173 -> V_49 = V_49 ;
V_52 = F_136 ( & V_47 , F_20 ( V_49 ) ,
F_137 ( V_352 ) ,
F_21 ( V_2 ) , 0 ,
V_2 -> V_6 . V_7 , V_2 -> V_6 . V_134 ,
F_138 ( V_2 -> V_5 -> V_202 ) ,
F_139 ( V_2 -> V_5 -> V_202 ) ) ;
F_22 ( V_49 , NULL , V_2 -> V_23 -> V_37 , V_2 -> V_56 , V_57 ,
V_58 , V_52 , & V_47 ,
...
static void
F_144 ( void * V_398 , struct V_48 * V_199 )
{
...
if ( ! V_49 ) {
V_2 -> V_321 . V_399 ++ ;
F_104 ( V_2 -> V_5 -> V_202 , & V_367 -> V_181 ,
F_144 , V_367 ) ;
return;
}
V_367 -> V_49 = V_49 ;
...
strncat ( ( char * ) V_409 ,
( char * ) & ( F_151 ( V_2 ) ) ,
strlen ( ( char * ) & F_151 ( V_2 ) ) ) ;
} else {
V_409 = ( T_1 * ) & ( F_151 ( V_2 ) ) ;
}
V_52 = F_152 ( & V_47 , F_20 ( V_49 ) ,
F_21 ( V_2 ) , 0 , V_409 ) ;
F_22 ( V_49 , NULL , V_2 -> V_23 -> V_37 , V_2 -> V_56 , V_57 ,
V_58 , V_52 , & V_47 ,
V_411 , ( void * ) V_367 ,
...
static void
F_150 ( void * V_398 , struct V_48 * V_199 )
{
struct V_366 * V_367 = V_398 ;
struct V_1 * V_2 = V_367 -> V_2 ;
struct V_43 V_47 ;
...
static void
F_158 ( struct V_1 * V_2 , T_3 * V_442 ,
T_3 V_433 )
{
struct V_443 * V_444 ;
struct V_16 * V_17 ;
...
V_71 V_448 [ V_449 ] ;
int V_445 ;
F_162 ( V_2 -> V_5 -> V_202 , & V_447 , V_448 ) ;
for ( V_445 = 0 ; V_445 < V_447 ; ++ V_445 ) {
V_17 = F_163 ( V_2 , V_448 [ V_445 ] ) ;
F_35 ( ! V_17 ) ;
}
}
static void
F_164 ( struct V_450 * V_451 ,
enum V_452 V_4 )
{
switch ( V_4 ) {
case V_453 :
...
case V_455 :
F_3 ( V_451 , F_164 ) ;
F_97 ( V_451 -> V_2 -> V_5 -> V_202 , & V_451 -> V_181 ) ;
break;
default:
F_4 ( V_451 -> V_2 -> V_5 , V_4 ) ;
}
...
case V_460 :
F_3 ( V_451 , V_461 ) ;
F_99 ( V_2 -> V_5 -> V_202 , & V_451 -> V_185 ,
V_462 , V_451 ,
V_187 ) ;
break;
case V_455 :
...
static void
F_165 ( void * V_464 , struct V_48 * V_199 )
{
...
V_49 = V_199 ? V_199 : F_18 ( V_2 -> V_5 ) ;
if ( ! V_49 ) {
F_104 ( V_2 -> V_5 -> V_202 , & V_451 -> V_181 ,
F_165 , V_451 ) ;
return;
}
V_451 -> V_49 = V_49 ;
if ( ( ! V_2 -> V_14 ) && F_166 ( & V_2 -> V_5 -> V_202 -> V_282 ) ) {
V_52 = F_167 ( & V_47 , F_20 ( V_49 ) ,
V_2 -> V_23 -> V_74 -> V_465 ,
V_2 -> V_73 , 0 ) ;
} else {
V_52 = F_167 ( & V_47 , F_20 ( V_49 ) ,
...
static void
F_170 ( struct V_1 * V_2 , T_3 V_467 )
{
struct V_16 * V_17 ;
F_2 ( V_2 -> V_5 , V_467 ) ;
V_17 = F_33 ( V_2 , V_467 ) ;
...
struct V_1 *
F_15 ( struct V_136 * V_5 )
{
return & V_5 -> V_23 . V_491 ;
}
V_71
F_173 ( struct V_1 * V_2 , V_71 V_492 , int V_493 ,
int V_494 , T_4 V_495 )
{
...
struct V_288 V_145 ;
T_6 V_499 , V_500 ;
T_4 V_501 = F_179 ( V_2 -> V_5 -> V_202 ) ;
if ( V_2 == NULL )
return 0 ;
V_5 = V_2 -> V_5 ;
F_122 ( V_2 -> V_5 -> V_202 , & V_145 ) ;
V_499 = V_145 . V_300 ;
F_2 ( V_5 , V_499 ) ;
V_496 = & V_2 -> V_135 ;
V_19 = F_174 ( V_496 ) ;
...
struct V_1 *
F_182 ( struct V_136 * V_5 , T_2 V_37 , V_71 V_40 )
{
struct V_137 * V_14 ;
T_8 * V_508 ;
F_35 ( V_5 == NULL ) ;
...
static void
F_188 ( struct V_137 * V_14 ,
enum V_526 V_4 )
{
F_2 ( F_189 ( V_14 ) , F_190 ( V_14 ) ) ;
F_2 ( F_189 ( V_14 ) , V_4 ) ;
switch ( V_4 ) {
case V_527 :
F_3 ( V_14 , V_528 ) ;
F_191 ( F_192 ( V_14 ) , V_14 ) ;
break;
default:
F_4 ( F_189 ( V_14 ) , V_4 ) ;
}
...
static void
F_194 ( struct V_137 * V_14 )
{
F_199 ( V_14 -> V_74 , V_14 ,
F_138 ( F_195 ( V_14 ) ) ,
F_190 ( V_14 ) , F_200 ( V_14 ) ) ;
V_14 -> V_531 . V_557 ++ ;
}
static void
F_201 ( struct V_137 * V_14 )
{
T_1 V_558 = V_14 -> V_74 -> V_558 ;
T_1 V_559 = V_14 -> V_74 -> V_559 ;
F_2 ( F_189 ( V_14 ) , V_558 ) ;
F_2 ( F_189 ( V_14 ) , V_559 ) ;
...
V_546 ( void * V_567 )
{
struct V_137 * V_14 = (struct V_137 * ) V_567 ;
V_14 -> V_531 . V_568 ++ ;
F_11 ( V_14 , V_550 ) ;
}
static void
F_197 ( struct V_137 * V_14 )
{
struct V_569 * V_142 =
(struct V_569 * ) V_14 -> V_142 ;
F_203 ( F_192 ( V_14 ) , V_14 ) ;
F_204 ( V_14 -> V_74 ) ;
if ( V_142 -> V_570 ) {
F_205 ( V_142 -> V_570 ) ;
return;
...
if ( V_142 )
F_206 ( V_142 -> V_571 . V_32 ,
& V_142 -> V_571 ) ;
}
void
F_207 ( struct V_137 * V_14 )
{
V_14 -> V_531 . V_572 ++ ;
if ( F_193 ( F_192 ( V_14 ) ) )
F_11 ( V_14 , V_536 ) ;
...
void
F_208 ( struct V_137 * V_14 )
{
V_14 -> V_531 . V_573 ++ ;
F_11 ( V_14 , V_537 ) ;
}
void
F_209 ( struct V_137 * V_14 )
{
V_14 -> V_531 . V_574 ++ ;
}
void
F_210 ( struct V_137 * V_14 )
{
F_11 ( V_14 , V_534 ) ;
}
void
F_7 ( struct V_137 * V_14 )
{
F_11 ( V_14 , V_553 ) ;
}
void
F_53 ( struct V_137 * V_14 )
{
F_11 ( V_14 , V_555 ) ;
}
T_5
F_211 ( struct V_137 * V_14 , struct V_136 * V_5 ,
T_2 V_37 , struct V_139 * V_575 ,
struct V_569 * V_142 )
{
if ( V_575 -> V_7 == 0 )
return V_576 ;
if ( F_14 ( & V_5 -> V_23 . V_491 ) == V_575 -> V_7 )
return V_577 ;
if ( F_212 ( V_5 , V_37 , V_575 -> V_7 ) != NULL )
return V_578 ;
if ( V_5 -> V_23 . V_518 ==
F_185 ( V_5 -> V_202 ) )
return V_579 ;
...
V_575 -> V_580 = V_57 ;
F_3 ( V_14 , F_188 ) ;
F_71 ( & V_14 -> V_36 , V_5 , V_37 , V_14 ) ;
F_74 ( & V_14 -> V_36 , V_575 ) ;
F_11 ( V_14 , V_527 ) ;
return V_250 ;
}
T_5
F_214 ( struct V_137 * V_14 , struct V_136 * V_5 ,
T_2 V_37 , struct V_139 * V_575 ,
struct V_569 * V_142 )
{
T_5 V_581 ;
V_581 = F_211 ( V_14 , V_5 , V_37 , V_575 , V_142 ) ;
V_14 -> V_36 . V_6 . V_580 = V_105 ;
return V_581 ;
}
T_4
F_215 ( struct V_137 * V_14 )
{
if ( V_14 && ( V_14 -> V_36 . V_6 . V_580 == V_105 ) )
return V_105 ;
else
return V_57 ;
}
T_5
F_216 ( struct V_137 * V_14 )
{
F_11 ( V_14 , V_529 ) ;
return V_250 ;
}
T_5
F_217 ( struct V_137 * V_14 )
{
F_11 ( V_14 , V_539 ) ;
return V_250 ;
}
T_5
F_218 ( struct V_137 * V_14 )
{
if ( V_14 -> V_36 . V_6 . V_580 )
return V_582 ;
F_11 ( V_14 , V_534 ) ;
return V_250 ;
}
void
F_219 ( struct V_137 * V_14 ,
struct V_583 * V_212 )
{
if ( V_14 == NULL || V_212 == NULL )
return;
memset ( V_212 , 0 , sizeof( struct V_583 ) ) ;
F_76 ( & V_14 -> V_36 , & V_212 -> V_145 ) ;
V_212 -> V_584 = F_220 ( V_585 , V_14 -> V_586 ) ;
}
struct V_137 *
F_212 ( struct V_136 * V_5 , T_2 V_37 , V_71 V_587 )
{
struct V_137 * V_14 ;
struct V_588 * V_23 ;
F_2 ( V_5 , V_37 ) ;
...
V_14 = F_183 ( V_23 , V_587 ) ;
return V_14 ;
}
void
F_221 ( void * V_32 , void * V_589 , T_5 V_590 )
{
struct V_137 * V_14 = V_589 ;
F_2 ( F_189 ( V_14 ) , F_190 ( V_14 ) ) ;
F_2 ( F_189 ( V_14 ) , V_590 ) ;
switch ( V_590 ) {
case V_250 :
F_222 ( V_14 ) = V_14 -> V_74 -> V_591 ;
V_14 -> V_531 . V_592 ++ ;
F_11 ( V_14 , V_542 ) ;
break;
case V_593 :
...
void
F_223 ( void * V_32 , void * V_589 )
{
struct V_137 * V_14 = V_589 ;
F_11 ( V_14 , V_542 ) ;
}
void
F_224 ( void * V_32 , void * V_589 )
{
struct V_137 * V_14 = V_589 ;
F_11 ( V_14 , V_537 ) ;
F_11 ( V_14 , V_536 ) ;
