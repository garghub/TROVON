...
static struct V_57 * F_30 ( struct V_1 * V_2 ,
struct V_58 * V_59 )
{
struct V_57 * V_60 ;
struct V_61 * V_62 ;
V_62 = F_31 ( & V_2 -> V_39 , V_2 -> V_39 . V_63 ++ ) ;
V_60 = V_59 -> V_60 + V_59 -> V_64 ++ ;
V_60 -> V_53 = 0 ;
V_60 -> V_46 = 0 ;
V_60 -> V_65 = V_62 -> V_65 ;
V_59 -> V_52 = 0 ;
...
struct V_68 * V_69 ;
struct V_57 * V_60 ;
unsigned int V_70 ( V_14 ) , V_70 ( V_10 ) ;
int V_71 = F_12 ( V_12 , & V_14 , & V_10 ) ;
unsigned long V_56 ;
F_29 ( V_46 + V_45 > V_31 ) ;
V_60 = V_59 -> V_60 + V_59 -> V_64 - 1 ;
while ( V_46 > 0 ) {
F_29 ( V_59 -> V_52 > V_48 ) ;
if ( F_24 ( V_59 -> V_52 , V_46 , * V_47 ) ) {
F_29 ( * V_47 ) ;
V_60 = F_30 ( V_2 , V_59 ) ;
}
V_56 = V_46 ;
if ( V_59 -> V_52 + V_56 > V_48 )
V_56 = V_48 - V_59 -> V_52 ;
V_69 = V_59 -> V_72 + V_59 -> V_73 ++ ;
V_69 -> V_74 = V_75 ;
if ( V_71 ) {
struct V_6 * V_7 = & V_6 [ V_14 ] ;
struct V_76 * V_77 ;
V_77 = & V_7 -> V_76 [ V_10 ] ;
V_69 -> V_78 . V_79 = V_77 -> V_2 -> V_79 ;
V_69 -> V_78 . V_80 . V_81 = V_77 -> V_62 . V_67 ;
V_69 -> V_74 |= V_82 ;
} else {
void * V_83 = F_33 ( V_12 ) ;
V_69 -> V_78 . V_79 = V_84 ;
V_69 -> V_78 . V_80 . V_85 = F_34 ( V_83 ) ;
}
V_69 -> V_78 . V_45 = V_45 ;
V_69 -> V_86 . V_79 = V_2 -> V_79 ;
V_69 -> V_86 . V_45 = V_59 -> V_52 ;
V_69 -> V_86 . V_80 . V_81 = V_59 -> V_66 ;
V_69 -> V_87 = V_56 ;
V_59 -> V_52 += V_56 ;
V_60 -> V_46 += V_56 ;
V_45 += V_56 ;
...
V_59 -> V_66 = V_62 -> V_67 ;
V_88 = V_50 -> V_88 ;
while ( V_88 < F_37 ( V_50 ) ) {
unsigned int V_45 = F_38 ( V_88 ) ;
unsigned int V_87 = V_31 - V_45 ;
if ( V_88 + V_87 > F_37 ( V_50 ) )
V_87 = F_37 ( V_50 ) - V_88 ;
F_32 ( V_2 , V_50 , V_59 ,
F_39 ( V_88 ) , V_87 , V_45 , & V_47 ) ;
V_88 += V_87 ;
}
for ( V_3 = 0 ; V_3 < V_54 ; V_3 ++ ) {
F_32 ( V_2 , V_50 , V_59 ,
F_40 ( & F_27 ( V_50 ) -> V_55 [ V_3 ] ) ,
F_28 ( & F_27 ( V_50 ) -> V_55 [ V_3 ] ) ,
F_27 ( V_50 ) -> V_55 [ V_3 ] . V_23 ,
& V_47 ) ;
}
return V_59 -> V_64 - V_89 ;
}
...
V_74 = V_97 ;
V_45 = 0 ;
F_44 ( V_2 , V_60 [ V_3 ] . V_65 , V_92 , V_45 ,
V_60 [ V_3 ] . V_46 , V_74 ) ;
}
}
...
V_107 -> V_111 = F_35 ( V_50 , & V_59 ) ;
V_51 += V_54 + 1 ;
F_49 ( & V_103 , V_50 ) ;
if ( V_51 + V_35 >= V_43 )
break;
}
F_29 ( V_59 . V_64 > F_50 ( V_7 -> V_60 ) ) ;
if ( ! V_59 . V_73 )
return;
F_29 ( V_59 . V_73 > F_50 ( V_7 -> V_108 ) ) ;
...
V_107 = (struct V_106 * ) V_50 -> V_110 ;
V_2 = F_36 ( V_50 -> V_29 ) ;
if ( V_7 -> V_60 [ V_59 . V_113 ] . V_53 && V_2 -> V_34 ) {
V_101 = F_53 ( & V_2 -> V_39 ,
V_2 -> V_39 . V_42 ++ ) ;
V_101 -> V_74 = V_114 | V_97 ;
V_101 -> V_45 = V_7 -> V_60 [ V_59 . V_113 ] . V_53 ;
V_101 -> V_65 = V_7 -> V_60 [ V_59 . V_113 ] . V_65 ;
V_101 -> V_92 = V_107 -> V_111 ;
V_59 . V_113 ++ ;
V_107 -> V_111 -- ;
}
V_2 -> V_29 -> V_115 . V_116 += V_50 -> V_87 ;
V_2 -> V_29 -> V_115 . V_117 ++ ;
V_92 = F_41 ( V_2 , V_107 -> V_111 , & V_59 ) ;
if ( V_107 -> V_111 == 1 )
V_74 = 0 ;
else
V_74 = V_97 ;
...
V_74 |= V_121 ;
V_45 = 0 ;
V_101 = F_44 ( V_2 , V_7 -> V_60 [ V_59 . V_113 ] . V_65 ,
V_92 , V_45 ,
V_7 -> V_60 [ V_59 . V_113 ] . V_46 ,
V_74 ) ;
if ( V_7 -> V_60 [ V_59 . V_113 ] . V_53 && ! V_2 -> V_34 ) {
struct V_123 * V_33 =
(struct V_123 * )
...
V_2 -> V_39 . V_42 ++ ) ;
V_101 -> V_74 |= V_124 ;
V_33 -> V_80 . V_33 . V_46 = V_7 -> V_60 [ V_59 . V_113 ] . V_53 ;
V_33 -> V_80 . V_33 . type = V_125 ;
V_33 -> V_80 . V_33 . V_126 = 0 ;
V_33 -> V_80 . V_33 . V_127 = 0 ;
V_33 -> type = V_128 ;
V_33 -> V_74 = 0 ;
}
F_43 ( V_2 , V_92 ,
V_7 -> V_60 + V_59 . V_113 + 1 ,
V_107 -> V_111 ) ;
F_54 ( & V_2 -> V_39 , V_105 ) ;
V_99 = V_2 -> V_99 ;
...
static void F_67 ( unsigned long V_88 )
{
...
V_138 = F_31 ( & V_2 -> V_137 , V_2 -> V_137 . V_63 ) -> V_46 ;
...
static void F_86 ( unsigned long V_88 )
{
...
{
T_4 V_146 = V_2 -> V_137 . V_63 ;
do {
F_88 ( V_2 , V_144 , V_96 ) ;
if ( V_146 >= V_145 )
break;
V_144 = F_31 ( & V_2 -> V_137 , V_146 ++ ) ;
} while ( 1 );
V_2 -> V_137 . V_63 = V_146 ;
F_82 ( V_2 ) ;
F_58 ( V_2 ) ;
}
...
memcpy ( V_144 , F_31 ( & V_2 -> V_137 , V_146 + V_55 ) ,
sizeof( * V_144 ) ) ;
...
static struct V_68 * F_93 ( struct V_6 * V_7 ,
struct V_1 * V_2 ,
struct V_49 * V_50 ,
struct V_143 * V_144 ,
struct V_68 * V_152 )
{
struct V_153 * V_154 = F_27 ( V_50 ) ;
T_2 * V_55 = V_154 -> V_55 ;
T_1 V_24 = * ( ( T_1 * ) V_50 -> V_88 ) ;
int V_3 , V_155 ;
V_155 = ( F_13 ( & V_154 -> V_55 [ 0 ] ) == V_24 ) ;
for ( V_3 = V_155 ; V_3 < V_154 -> V_54 ; V_3 ++ , V_144 ++ ) {
struct V_12 * V_12 ;
T_3 V_156 ;
struct V_76 * V_76 =
V_7 -> V_76 ;
...
if ( ! V_12 )
return NULL ;
V_152 -> V_78 . V_80 . V_81 = V_144 -> V_67 ;
V_152 -> V_78 . V_79 = V_2 -> V_79 ;
V_152 -> V_78 . V_45 = V_144 -> V_45 ;
V_152 -> V_86 . V_80 . V_85 = F_34 ( F_33 ( V_12 ) ) ;
V_152 -> V_86 . V_79 = V_84 ;
V_152 -> V_86 . V_45 = V_144 -> V_45 ;
V_152 -> V_87 = V_144 -> V_46 ;
V_152 -> V_74 = V_82 ;
V_152 ++ ;
memcpy ( & V_76 [ V_24 ] . V_62 , V_144 , sizeof( * V_144 ) ) ;
F_74 ( V_2 ) ;
V_76 [ V_24 ] . V_2 = V_2 ;
F_14 ( & V_55 [ V_3 ] , V_24 ) ;
}
...
struct V_68 * * V_158 )
{
struct V_68 * V_152 = * V_158 ;
T_1 V_24 = * ( ( T_1 * ) V_50 -> V_88 ) ;
struct V_76 * V_76 = V_7 -> V_76 ;
struct V_1 * V_2 = V_76 [ V_24 ] . V_2 ;
struct V_143 * V_144 ;
struct V_153 * V_154 = F_27 ( V_50 ) ;
int V_54 = V_154 -> V_54 ;
int V_3 , V_159 , V_155 ;
...
T_3 V_156 ;
V_156 = F_15 ( V_7 -> V_25 ++ ) ;
V_144 = & V_76 [ V_24 ] . V_62 ;
F_88 ( V_2 , V_144 , V_96 ) ;
V_7 -> V_157 [ V_156 ] = V_24 ;
F_58 ( V_2 ) ;
}
V_155 = ( F_13 ( & V_154 -> V_55 [ 0 ] ) == V_24 ) ;
for ( V_3 = V_155 ; V_3 < V_54 ; V_3 ++ ) {
int V_160 , V_161 ;
T_3 V_156 ;
V_24 = F_13 ( & V_154 -> V_55 [ V_3 ] ) ;
V_161 = ( ++ V_152 ) -> V_92 ;
if ( F_70 ( ! V_161 ) ) {
if ( F_90 ( V_159 ) )
F_95 ( V_7 , V_24 ) ;
...
memcpy ( & V_165 , F_31 ( & V_2 -> V_137 , V_146 ) ,
sizeof( V_165 ) ) ;
if ( F_90 ( ! V_165 . type ||
V_165 . type >= V_167 ) ) {
V_2 -> V_137 . V_63 = ++ V_146 ;
...
struct V_123 * V_33 )
{
if ( ! V_33 -> V_80 . V_33 . V_46 ) {
F_42 ( V_2 -> V_29 , L_8 ) ;
return - V_168 ;
}
if ( V_33 -> V_80 . V_33 . type != V_125 ) {
F_42 ( V_2 -> V_29 , L_9 , V_33 -> V_80 . V_33 . type ) ;
return - V_168 ;
}
F_27 ( V_50 ) -> V_53 = V_33 -> V_80 . V_33 . V_46 ;
F_27 ( V_50 ) -> V_170 = V_171 ;
F_27 ( V_50 ) -> V_170 |= V_172 ;
F_27 ( V_50 ) -> V_173 = 0 ;
return 0 ;
}
...
goto V_134;
V_175 = ( void * ) V_50 -> V_88 ;
V_176 = V_50 -> V_88 + 4 * V_175 -> V_182 ;
if ( V_176 >= F_37 ( V_50 ) )
goto V_134;
...
if ( ( V_176 + V_50 -> V_185 + 2 ) > F_37 ( V_50 ) )
goto V_134;
V_159 = 0 ;
V_134:
return V_159 ;
...
{
struct V_68 * V_152 = V_7 -> V_201 , * V_202 ;
struct V_49 * V_50 ;
int V_105 ;
...
V_10 = V_2 -> V_137 . V_63 ;
F_113 () ;
memcpy ( & V_203 , F_31 ( & V_2 -> V_137 , V_10 ) , sizeof( V_203 ) ) ;
...
V_152 -> V_78 . V_80 . V_81 = V_203 . V_67 ;
V_152 -> V_78 . V_79 = V_2 -> V_79 ;
V_152 -> V_78 . V_45 = V_203 . V_45 ;
V_152 -> V_86 . V_80 . V_85 = F_34 ( F_33 ( V_12 ) ) ;
V_152 -> V_86 . V_79 = V_84 ;
V_152 -> V_86 . V_45 = V_203 . V_45 ;
V_152 -> V_87 = V_203 . V_46 ;
V_152 -> V_74 = V_82 ;
V_152 ++ ;
memcpy ( & V_7 -> V_76 [ V_24 ] . V_62 ,
& V_203 , sizeof( V_203 ) ) ;
V_7 -> V_76 [ V_24 ] . V_2 = V_2 ;
* ( ( T_1 * ) V_50 -> V_88 ) = V_24 ;
F_117 ( V_50 , V_162 ) ;
F_27 ( V_50 ) -> V_54 = V_105 ;
if ( V_162 < V_203 . V_46 ) {
F_27 ( V_50 ) -> V_54 ++ ;
...
if ( V_144 -> V_74 & V_215 )
V_50 -> V_118 = V_119 ;
else if ( V_144 -> V_74 & V_216 )
V_50 -> V_118 = V_122 ;
F_96 ( V_7 , V_50 ) ;
if ( F_26 ( V_50 ) < V_208 && F_119 ( V_50 ) ) {
int V_217 = F_120 ( int , V_50 -> V_87 , V_208 ) ;
F_121 ( V_50 , V_217 - F_26 ( V_50 ) ) ;
}
V_50 -> V_29 = V_2 -> V_29 ;
...
V_2 -> V_29 -> V_115 . V_218 += V_50 -> V_87 ;
...
F_47 ( & V_7 -> V_214 ) ;
F_142 ( & V_7 -> V_130 ) ;
V_7 -> V_130 . V_88 = ( unsigned long ) V_7 ;
...
V_7 -> V_157 [ V_3 ] = V_3 ;
F_143 ( & V_7 -> V_27 ) ;
V_7 -> V_235 = F_144 ( F_128 ,
( void * ) V_7 ,
L_16 , V_14 ) ;
if ( F_145 ( V_7 -> V_235 ) ) {
F_146 ( V_236 L_17 ) ;
F_147 ( & V_7 -> V_130 ) ;
V_233 = F_148 ( V_7 -> V_235 ) ;
goto V_237;
}
F_149 ( V_7 -> V_235 , V_14 ) ;
F_150 ( & V_7 -> V_133 ) ;
F_151 ( & V_7 -> V_132 ) ;
F_152 ( & V_7 -> V_8 , 0 ) ;
F_153 ( V_7 -> V_235 ) ;
