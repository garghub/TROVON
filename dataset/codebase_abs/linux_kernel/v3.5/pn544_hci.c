...
static int F_39 ( struct V_44 * V_43 , T_4 V_76 )
{
struct V_50 * V_51 = F_32 ( V_43 ) ;
T_1 V_77 = 0 ;
int V_21 ;
...
static int F_40 ( struct V_44 * V_43 , T_1 V_86 ,
struct V_87 * V_88 )
{
switch ( V_86 ) {
case V_89 :
...
int V_21 = 0 ;
if ( V_88 -> V_90 & V_82 ) {
if ( V_88 -> V_94 != 4 && V_88 -> V_94 != 7 &&
V_88 -> V_94 != 10 )
return - V_60 ;
V_21 = F_34 ( V_51 , V_66 ,
V_95 ,
V_88 -> V_96 , V_88 -> V_94 , NULL ) ;
} else if ( V_88 -> V_90 & V_84 ) {
V_21 = F_37 ( V_51 , V_89 ,
V_97 , & V_93 ) ;
if ( V_21 < 0 )
return V_21 ;
...
V_21 = F_34 ( V_51 , V_89 ,
V_95 ,
V_93 -> V_38 , V_93 -> V_20 , NULL ) ;
F_20 ( V_93 ) ;
} else if ( V_88 -> V_90 & V_81 ) {
if ( V_88 -> V_92 == 0x4403 )
V_21 = F_34 ( V_51 , V_66 ,
V_98 ,
NULL , 0 , NULL ) ;
...
V_30 -> V_38 [ 0 ] == V_102 ) ) {
T_1 V_103 [ V_104 ] ;
T_1 * V_38 = V_30 -> V_38 + V_105 ;
memcpy ( V_103 , V_38 + V_106 ,
V_104 ) ;
memmove ( V_38 + V_104 , V_38 ,
V_106 ) ;
memcpy ( V_38 , V_103 , V_104 ) ;
}
return F_34 ( V_51 , V_88 -> V_99 ,
V_107 ,
V_30 -> V_38 , V_30 -> V_20 , V_56 ) ;
} else
return 1 ;
case V_89 :
* F_43 ( V_30 , 1 ) = 0 ;
* F_43 ( V_30 , 1 ) = 0 ;
V_21 = F_34 ( V_51 , V_88 -> V_99 ,
V_108 ,
V_30 -> V_38 , V_30 -> V_20 , V_56 ) ;
if ( V_21 == 0 )
F_21 ( * V_56 , 1 ) ;
...
V_21 = V_114 -> V_123 ( V_18 ) ;
if ( V_21 ) {
F_8 ( & V_18 -> V_11 , L_23 ) ;
goto V_122;
}
V_2 -> V_14 = V_114 -> V_124 ( V_125 ) ;
V_2 -> V_12 = V_114 -> V_124 ( V_126 ) ;
V_2 -> V_127 = V_114 -> V_124 ( V_128 ) ;
F_1 ( V_2 ) ;
...
V_116 . V_131 = F_33 ( V_132 ) ;
memcpy ( V_116 . V_133 , V_132 ,
F_33 ( V_132 ) ) ;
strcpy ( V_116 . V_134 , L_25 ) ;
V_76 = V_83 |
V_82 |
V_84 |
V_81 |
...
struct V_113 * V_114 = V_18 -> V_11 . V_121 ;
F_6 ( & V_18 -> V_11 , L_17 , V_9 ) ;
F_58 ( V_2 -> V_43 ) ;
if ( V_2 -> V_46 != V_47 ) {
if ( V_114 -> V_141 )
