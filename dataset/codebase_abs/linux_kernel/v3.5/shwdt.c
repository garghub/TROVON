...
if ( V_26 -> V_30 != - 1 )
return - V_21 ;
V_28 = F_26 ( V_26 , V_31 , 0 ) ;
if ( F_21 ( ! V_28 ) )
return - V_21 ;
V_4 = F_27 ( & V_26 -> V_7 , sizeof( struct V_3 ) , V_32 ) ;
if ( F_21 ( ! V_4 ) )
return - V_33 ;
V_4 -> V_7 = & V_26 -> V_7 ;
V_4 -> V_8 = F_28 ( & V_26 -> V_7 , NULL ) ;
if ( F_29 ( V_4 -> V_8 ) ) {
V_4 -> V_8 = NULL ;
}
...
V_29 = F_35 ( & V_37 ) ;
if ( F_21 ( V_29 ) ) {
F_36 ( & V_26 -> V_7 , L_5 , V_29 ) ;
goto V_36;
}
F_37 ( & V_4 -> V_14 ) ;
V_4 -> V_14 . V_40 = F_22 ;
V_4 -> V_14 . V_23 = ( unsigned long ) V_4 ;
V_4 -> V_14 . V_41 = F_7 ( V_15 ) ;
F_38 ( V_26 , V_4 ) ;
F_34 ( & V_26 -> V_7 , L_6 ) ;
F_39 ( & V_26 -> V_7 ) ;
return 0 ;
...
static int T_3 F_41 ( struct V_25 * V_26 )
{
struct V_3 * V_4 = F_42 ( V_26 ) ;
F_38 ( V_26 , NULL ) ;
F_43 ( & V_37 ) ;
F_44 ( & V_26 -> V_7 ) ;
F_40 ( V_4 -> V_8 ) ;
