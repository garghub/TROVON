...
V_147 = F_124 ( sizeof( * V_12 ) , V_20 ) ;
if ( V_147 == NULL )
return - V_105 ;
V_147 -> V_21 = V_21 ;
V_147 -> V_18 = V_18 ;
V_147 -> V_13 = V_13 ;
F_125 ( & V_147 -> V_27 , & V_93 -> V_16 . V_27 ) ;
return 1 ;
}
static int F_126 ( struct V_3 * V_93 , T_2 * V_148 )
{
struct V_149 * V_149 ;
unsigned V_150 ;
unsigned long V_151 ;
...
int V_157 = 0 ;
int V_8 ;
V_149 = V_93 -> V_158 -> V_159 -> V_160 ;
if ( F_127 ( V_149 -> V_161 ) ) {
...
V_153 = 0 ;
V_151 = 0 ;
V_154 = F_128 ( V_149 ) >> V_152 ;
while ( ( V_153 + V_150 ) <= V_154 &&
V_151 < V_93 -> V_46 ) {
unsigned V_163 ;
T_2 V_164 ;
V_164 = F_129 ( V_149 , V_153 ) ;
if ( V_164 == 0 )
goto V_165;
if ( V_164 & ( V_150 - 1 ) ) {
V_153 ++ ;
...
for ( V_163 = 1 ; V_163 < V_150 ;
V_163 ++ ) {
T_2 V_167 ;
V_167 = F_129 ( V_149 , V_153 + V_163 ) ;
if ( V_167 == 0 )
goto V_165;
if ( V_167 != V_164 + V_163 ) {
V_153 ++ ;
goto V_166;
}
}
...
static unsigned F_133 ( struct V_172 * V_172 , T_10 * V_173 )
{
struct V_174 * V_175 = V_172 -> V_176 ;
F_134 ( V_172 , & V_177 , V_173 ) ;
if ( V_175 -> V_178 != F_105 ( & V_179 ) ) {
V_175 -> V_178 = F_105 ( & V_179 ) ;
return V_180 | V_181 | V_182 | V_183 ;
}
return V_180 | V_181 ;
}
static void * F_135 ( struct V_174 * V_184 , T_11 * V_185 )
{
struct V_3 * V_4 ;
int type ;
T_11 V_186 = * V_185 ;
...
static void * F_138 ( struct V_174 * V_184 , void * V_189 , T_11 * V_185 )
{
...
static void F_139 ( struct V_174 * V_184 , void * V_189 )
{
F_140 ( & V_187 ) ;
}
static int F_141 ( struct V_174 * V_184 , void * V_189 )
{
struct V_3 * V_4 = V_189 ;
struct V_172 * V_172 ;
int V_190 ;
...
V_172 = V_4 -> V_158 ;
V_190 = F_143 ( V_184 , & V_172 -> V_191 , L_4 ) ;
F_144 ( V_184 , L_5 ,
V_190 < 40 ? 40 - V_190 : 1 , L_6 ,
F_127 ( V_172 -> V_191 . V_192 -> V_193 -> V_161 ) ?
L_7 : L_8 ,
V_4 -> V_40 << ( V_17 - 10 ) ,
V_4 -> V_41 << ( V_17 - 10 ) ,
V_4 -> V_64 ) ;
...
static int F_145 ( struct V_149 * V_149 , struct V_172 * V_172 )
{
struct V_174 * V_175 ;
int V_8 ;
V_8 = F_146 ( V_172 , & V_194 ) ;
if ( V_8 )
return V_8 ;
V_175 = V_172 -> V_176 ;
V_175 -> V_178 = F_105 ( & V_179 ) ;
...
{
F_148 ( L_9 , 0 , NULL , & V_195 ) ;
return 0 ;
}
static int T_12 F_149 ( void )
{
F_150 () ;
return 0 ;
}
static struct V_3 * F_151 ( void )
{
struct V_3 * V_66 ;
unsigned int type ;
V_66 = F_152 ( sizeof( * V_66 ) , V_20 ) ;
if ( ! V_66 )
return F_153 ( - V_105 ) ;
F_20 ( & V_48 ) ;
for ( type = 0 ; type < V_68 ; type ++ ) {
...
F_155 ( & V_66 -> V_16 . V_27 ) ;
V_66 -> V_36 = V_70 ;
V_66 -> V_28 = - 1 ;
F_19 ( & V_48 ) ;
return V_66 ;
}
static int F_156 ( struct V_3 * V_66 , struct V_149 * V_149 )
{
int error ;
if ( F_127 ( V_149 -> V_161 ) ) {
V_66 -> V_19 = F_56 ( F_157 ( V_149 ) ) ;
error = F_158 ( V_66 -> V_19 ,
V_198 | V_199 | V_200 ,
V_201 ) ;
if ( error < 0 ) {
V_66 -> V_19 = NULL ;
...
V_66 -> V_202 = F_159 ( V_66 -> V_19 ) ;
error = F_160 ( V_66 -> V_19 , V_112 ) ;
if ( error < 0 )
return error ;
V_66 -> V_36 |= V_87 ;
} else if ( F_161 ( V_149 -> V_161 ) ) {
V_66 -> V_19 = V_149 -> V_203 -> V_204 ;
F_136 ( & V_149 -> V_205 ) ;
if ( F_162 ( V_149 ) )
return - V_206 ;
} else
...
static unsigned long F_163 ( struct V_3 * V_66 ,
union V_207 * V_207 ,
struct V_149 * V_149 )
{
int V_126 ;
...
if ( F_164 ( V_207 -> V_211 . V_212 ) == 1 ) {
F_165 ( & V_207 -> V_211 . V_212 ) ;
F_165 ( & V_207 -> V_211 . V_213 ) ;
F_165 ( & V_207 -> V_211 . V_214 ) ;
for ( V_126 = 0 ; V_126 < V_207 -> V_211 . V_214 ; V_126 ++ )
F_165 ( & V_207 -> V_211 . V_215 [ V_126 ] ) ;
}
...
if ( ! V_208 )
return 0 ;
V_209 = F_128 ( V_149 ) >> V_17 ;
if ( V_209 && V_208 > V_209 ) {
F_31 ( V_216
L_13 ) ;
return 0 ;
}
if ( V_207 -> V_211 . V_214 && F_161 ( V_149 -> V_161 ) )
return 0 ;
...
V_219 = V_208 - 1 ;
for ( V_126 = 0 ; V_126 < V_207 -> V_211 . V_214 ; V_126 ++ ) {
unsigned int V_220 = V_207 -> V_211 . V_215 [ V_126 ] ;
...
if ( ! ( V_79 & V_82 ) )
goto V_67;
V_237 = F_177 ( V_231 ) + V_5 ;
V_79 = * V_237 ;
F_178 ( V_237 ) ;
if ( ( V_79 & ~ V_82 ) != V_238 )
goto V_67;
}
F_125 ( & V_7 -> V_235 , & V_65 -> V_235 ) ;
V_7 = NULL ;
V_67:
F_19 ( & V_48 ) ;
V_233:
...
V_5 &= ~ V_234 ;
V_7 = F_14 ( V_65 -> V_235 . V_28 , struct V_7 , V_235 ) ;
V_237 = F_177 ( V_7 ) + V_5 ;
if ( V_79 == V_83 )
goto V_239;
if ( V_79 == ( V_83 | V_82 ) ) {
while ( * V_237 == ( V_238 | V_82 ) ) {
F_178 ( V_237 ) ;
V_7 = F_14 ( V_7 -> V_235 . V_28 , struct V_7 , V_235 ) ;
F_117 ( V_7 == V_65 ) ;
V_237 = F_177 ( V_7 ) + V_5 ;
}
if ( * V_237 == V_238 ) {
...
* V_237 += 1 ;
F_178 ( V_237 ) ;
V_7 = F_14 ( V_7 -> V_235 . V_124 , struct V_7 , V_235 ) ;
while ( V_7 != V_65 ) {
V_237 = F_177 ( V_7 ) + V_5 ;
* V_237 = V_82 ;
F_178 ( V_237 ) ;
...
V_65 = F_175 ( V_4 -> V_52 + V_5 ) ;
if ( F_41 ( V_65 ) ) {
struct V_24 * V_240 , * V_28 ;
F_115 (this, next, &head->lru) {
struct V_7 * V_7 ;
V_7 = F_14 ( V_240 , struct V_7 , V_235 ) ;
F_121 ( V_240 ) ;
F_179 ( V_7 ) ;
}
}
