...
struct V_77 * V_78 ;
struct V_54 * V_79 ;
struct V_4 * V_80 [ V_18 ] = { NULL , NULL } ;
int V_81 [ V_18 ] = { 1 , 1 } ;
F_33 ( L_8 ) ;
F_34 (rb, aeb, &av->root, u.rb) {
V_80 [ V_79 -> V_65 ] = F_35 ( V_2 -> V_19 ) ;
if ( ! V_80 [ V_79 -> V_65 ] ) {
V_7 = - V_57 ;
goto V_59;
}
V_7 = F_36 ( V_2 , V_80 [ V_79 -> V_65 ] , V_79 -> V_68 , 0 ,
V_2 -> V_19 ) ;
if ( V_7 == V_82 || F_37 ( V_7 ) )
V_79 -> V_83 = 1 ;
else if ( V_7 )
goto V_59;
}
V_7 = - V_47 ;
if ( V_80 [ 0 ] ) {
V_81 [ 0 ] = F_12 ( V_2 , V_80 [ 0 ] ) ;
if ( V_81 [ 0 ] < 0 )
goto V_59;
}
if ( ! V_81 [ 0 ] ) {
if ( V_80 [ 1 ] )
V_81 [ 1 ] = memcmp ( V_80 [ 0 ] , V_80 [ 1 ] ,
V_2 -> V_19 ) ;
if ( V_81 [ 1 ] ) {
F_38 ( L_9 ) ;
V_7 = F_19 ( V_2 , V_49 , 1 , V_80 [ 0 ] ) ;
if ( V_7 )
goto V_59;
F_20 ( L_10 ) ;
}
...
if ( V_76 -> V_93 != V_76 -> V_64 ) {
F_38 ( L_15 ,
V_76 -> V_26 , V_76 -> V_64 - V_76 -> V_93 ) ;
V_24 -> V_94 = 1 ;
continue;
}
V_24 -> V_64 = V_76 -> V_64 ;
V_24 -> V_92 =
( long long ) ( V_24 -> V_64 - 1 ) * V_24 -> V_86 ;
V_24 -> V_92 += V_76 -> V_95 ;
V_24 -> V_91 = V_76 -> V_95 ;
}
V_24 = F_43 ( sizeof( struct V_9 ) , V_56 ) ;
...
V_24 -> V_34 = V_96 ;
V_24 -> V_36 = V_84 ;
V_24 -> V_27 = sizeof( V_97 ) - 1 ;
memcpy ( V_24 -> V_29 , V_97 , V_24 -> V_27 + 1 ) ;
V_24 -> V_86 = V_2 -> V_40 ;
V_24 -> V_64 = V_24 -> V_33 ;
V_24 -> V_91 = V_24 -> V_33 ;
V_24 -> V_92 =
...
static int F_45 ( const struct V_9 * V_24 ,
const struct V_75 * V_76 )
{
int V_7 ;
if ( V_76 -> V_102 >= V_24 -> V_33 ) {
V_7 = 1 ;
goto V_39;
}
if ( V_76 -> V_93 > V_24 -> V_33 ) {
V_7 = 2 ;
goto V_39;
}
if ( V_76 -> V_36 != V_24 -> V_36 ) {
V_7 = 3 ;
goto V_39;
}
if ( V_76 -> V_64 > V_24 -> V_33 ) {
V_7 = 4 ;
goto V_39;
}
if ( V_76 -> V_35 != V_24 -> V_35 ) {
V_7 = 5 ;
goto V_39;
}
return 0 ;
...
struct V_75 * V_76 ;
struct V_9 * V_24 ;
if ( V_49 -> V_103 > V_104 + V_2 -> V_11 ) {
F_16 ( L_19 ,
V_49 -> V_103 , V_104 , V_2 -> V_11 ) ;
return - V_47 ;
}
if ( V_49 -> V_105 >= V_2 -> V_11 + V_104 &&
V_49 -> V_105 < V_106 ) {
F_16 ( L_20 , V_49 -> V_105 ) ;
return - V_47 ;
}
for ( V_6 = 0 ; V_6 < V_2 -> V_11 + V_104 ; V_6 ++ ) {
F_13 () ;
V_76 = F_44 ( V_49 , V_6 ) ;
V_24 = V_2 -> V_12 [ V_6 ] ;
if ( ! V_24 ) {
...
int F_50 ( struct V_1 * V_2 , struct V_48 * V_49 )
{
int V_6 , V_7 ;
struct V_75 * V_76 ;
...
V_2 -> V_19 = F_51 ( V_2 -> V_19 , V_2 -> V_41 ) ;
V_76 = F_44 ( V_49 , V_13 ) ;
if ( ! V_76 ) {
if ( V_49 -> V_108 ) {
...
V_2 -> V_17 = F_32 ( V_2 , V_49 , V_76 ) ;
if ( F_23 ( V_2 -> V_17 ) )
return F_24 ( V_2 -> V_17 ) ;
}
V_2 -> V_99 = V_2 -> V_44 - V_2 -> V_100 ;
