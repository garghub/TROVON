...
T_2 V_196 ;
T_1 V_5 ;
T_3 V_137 , V_197 = V_18 -> V_87 ;
F_43 ( V_2 ) ;
V_5 = V_18 -> V_13 . V_198 ( V_2 ) ;
if ( V_5 )
F_3 ( L_13 ) ;
F_3 ( L_14 ) ;
V_18 -> V_13 . V_199 ( V_2 ) ;
...
F_46 ( V_2 , V_200 , V_137 , 0 ) ;
V_5 = V_18 -> V_13 . V_201 ( V_2 ) ;
V_196 = F_5 ( F_47 ( 0 ) ) ;
V_196 = ( V_196 & ~ V_202 ) |
V_203 |
V_204 ;
...
case V_24 :
case V_25 :
if ( V_2 -> V_219 . V_220 != 0 ) {
V_217 = ( V_2 -> V_219 . V_220 >>
V_221 ) &
V_222 ;
V_218 = 1 << ( V_2 -> V_219 . V_220 &
V_223 ) ;
}
break;
default:
...
for ( V_154 = 0 ; V_154 < V_224 ; V_154 ++ ) {
V_216 = ( V_154 == V_217 ) ? V_218 : 0 ;
F_46 ( V_2 , V_225 , V_154 , V_216 ) ;
F_28 () ;
}
}
...
{
T_3 V_146 ;
F_52 ( V_2 , V_226 , 1 , & V_146 ) ;
return ( V_146 & V_227 ) != 0 ;
}
static T_1 V_103 ( struct V_1 * V_2 )
{
T_2 V_181 ;
T_2 V_137 ;
V_181 = V_2 -> V_18 . V_228 ;
if ( ! ( V_229 & F_5 ( V_115 ) ) ) {
for ( V_137 = 0 ; V_137 < 4 ; V_137 ++ )
if ( ( ( V_2 -> V_18 . V_228 >> ( V_137 * 8 ) ) & 0xFF ) ==
V_230 )
V_181 |= ( V_231 << ( V_137 * 8 ) ) ;
}
F_6 ( V_232 , V_181 ) ;
...
T_3 V_234 = 0 ;
T_1 V_5 = 0 ;
V_5 = F_10 ( V_2 , V_235 , & V_234 ) ;
if ( V_5 )
return false ;
if ( V_234 == V_236 ) {
V_5 = F_10 ( V_2 , V_237 , & V_233 ) ;
if ( V_5 )
return false ;
if ( ( V_233 & V_238 ) ==
V_238 )
...
F_6 ( V_260 , V_18 -> V_250 ) ;
F_6 ( V_187 , ( V_181 & ~ V_243 ) ) ;
V_18 -> V_194 =
V_255 ;
V_18 -> V_256 = false ;
F_3 ( L_17 ) ;
...
void F_41 ( struct V_1 * V_2 , bool V_271 )
{
if ( V_2 -> V_18 . type != V_19 )
return;
