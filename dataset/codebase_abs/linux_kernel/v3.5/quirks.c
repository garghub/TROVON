...
static int F_182 ( struct V_1 * V_2 , int V_292 )
{
void T_6 * V_299 ;
unsigned long V_300 ;
T_2 V_64 ;
...
if ( ! V_299 )
return - V_301 ;
F_183 ( 0x00000002 , V_299 + V_302 ) ;
F_183 ( 0x00000005 , V_299 + V_303 ) ;
V_64 = F_184 ( V_299 + V_304 ) & 0xfffffffe ;
F_183 ( V_64 , V_299 + V_304 ) ;
V_300 = V_305 + F_185 ( V_306 ) ;
do {
V_64 = F_184 ( V_299 + V_307 ) ;
if ( ( V_64 & 0xb0000000 ) == 0 )
goto V_308;
F_180 ( 10 ) ;
} while ( F_186 ( V_305 , V_300 ) );
F_47 ( & V_2 -> V_2 , L_116 ) ;
V_308:
F_183 ( 0x00000002 , V_299 + V_309 ) ;
F_173 ( V_2 , V_299 ) ;
return 0 ;
}
int F_187 ( struct V_1 * V_2 , int V_292 )
{
