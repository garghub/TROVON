...
if ( V_12 -> V_44 < V_45 )
return 0 ;
F_10 ( & V_12 -> V_46 . V_47 , V_16 ) ;
for ( V_28 = 0 ; V_28 < V_42 -> V_46 ; V_28 ++ ) {
if ( ! V_12 -> V_46 . V_48 [ V_28 ] )
continue;
V_15 = V_12 -> V_46 . V_48 [ V_28 ] -> V_9 [ V_49 ] ;
if ( V_15 && V_15 -> V_22 == V_24 )
break;
}
F_14 ( & V_12 -> V_46 . V_47 , V_16 ) ;
return V_28 ;
}
static void
...
{
struct V_11 * V_12 = V_6 -> V_13 ;
struct V_50 * V_51 = & V_12 -> V_51 . V_52 [ V_28 ] ;
F_13 ( V_6 , 0x00b008 + ( V_28 * 0x10 ) , V_51 -> V_53 ) ;
F_13 ( V_6 , 0x00b004 + ( V_28 * 0x10 ) , V_51 -> V_54 ) ;
F_13 ( V_6 , 0x00b000 + ( V_28 * 0x10 ) , V_51 -> V_55 ) ;
}
static void
F_28 ( struct V_10 * V_6 )
{
T_1 V_24 = ( F_12 ( V_6 , 0x00b318 ) & 0x000fffff ) << 4 ;
T_1 V_56 = F_26 ( V_6 , V_24 ) ;
T_1 V_57 = F_12 ( V_6 , 0x00b100 ) ;
...
if ( type == 0x00000010 ) {
if ( ! F_29 ( V_6 , V_56 , 0x3174 , V_34 , V_35 ) )
V_58 &= ~ 0x01000000 ;
}
}
F_13 ( V_6 , 0x00b100 , V_57 ) ;
F_13 ( V_6 , 0x00b230 , 0x00000001 ) ;
if ( V_58 && F_30 () ) {
F_31 ( V_6 , L_3 ,
V_56 , V_24 , V_57 , type , V_34 , V_35 ) ;
}
}
static void
...
T_1 V_57 = F_12 ( V_6 , 0x00b800 ) ;
F_31 ( V_6 , L_4 , V_57 ) ;
F_13 ( V_6 , 0xb800 , V_57 ) ;
}
}
static void
...
V_5 -> V_31 . V_32 = F_27 ;
F_40 ( V_6 , 0 , F_32 ) ;
F_41 ( V_6 , V_59 , & V_5 -> V_31 ) ;
F_42 ( V_6 , 0x3174 , V_59 ) ;
