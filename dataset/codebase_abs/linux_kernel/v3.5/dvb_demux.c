...
static int F_41 ( struct V_100 * V_101 , T_1 V_61 , int V_55 ,
enum V_102 V_103 ,
...
static void F_54 ( struct V_3 * V_132 )
{
int V_20 ;
struct V_18 * V_4 ;
struct V_131 * V_136 ;
...
static int F_61 ( struct V_122 * V_31 )
{
struct V_30 * V_133 = (struct V_30 * ) V_31 ;
if ( V_133 -> V_143 == 0 )
return - V_119 ;
...
static int F_62 ( struct V_122 * V_31 , const char T_8 * V_1 , T_4 V_12 )
{
struct V_30 * V_133 = (struct V_30 * ) V_31 ;
void * V_13 ;
...
F_37 ( & ( V_146 -> V_154 ) , V_152 ) ;
return 0 ;
}
static int F_69 ( struct V_122 * V_31 ,
struct V_151 * V_146 )
{
struct V_30 * V_133 = (struct V_30 * ) V_31 ;
...
static struct V_98 * F_72 ( struct V_122 * V_31 )
{
struct V_30 * V_133 = (struct V_30 * ) V_31 ;
if ( F_73 ( & V_133 -> V_153 ) )
return NULL ;
...
static int F_75 ( struct V_122 * V_31 )
{
struct V_30 * V_133 = (struct V_30 * ) V_31 ;
F_48 ( & V_133 -> V_108 ) ;
V_31 -> V_146 = NULL ;
...
static int F_76 ( struct V_122 * V_31 , T_1 * V_112 )
{
struct V_30 * V_133 = (struct V_30 * ) V_31 ;
memcpy ( V_112 , V_133 -> V_112 , 5 * sizeof( T_1 ) ) ;
return 0 ;
}
int F_77 ( struct V_30 * V_133 )
{
int V_20 ;
struct V_122 * V_123 = & V_133 -> V_123 ;
V_133 -> V_75 = NULL ;
V_133 -> V_143 = 0 ;
V_133 -> V_23 = F_45 ( V_133 -> V_89 * sizeof( struct V_18 ) ) ;
if ( ! V_133 -> V_23 )
return - V_115 ;
V_133 -> V_7 = F_45 ( V_133 -> V_93 * sizeof( struct V_3 ) ) ;
if ( ! V_133 -> V_7 ) {
F_51 ( V_133 -> V_23 ) ;
V_133 -> V_23 = NULL ;
return - V_115 ;
