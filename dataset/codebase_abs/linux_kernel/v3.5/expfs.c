...
static int F_28 ( struct V_15 * V_15 , struct V_61 * V_61 ,
int * V_62 , struct V_15 * V_18 )
{
int V_40 = * V_62 ;
int type = V_63 ;
if ( V_18 && ( V_40 < 4 ) ) {
...
V_40 = 2 ;
V_61 -> V_64 . V_42 = V_15 -> V_37 ;
V_61 -> V_64 . V_65 = V_15 -> V_66 ;
if ( V_18 ) {
V_61 -> V_64 . V_67 = V_18 -> V_37 ;
V_61 -> V_64 . V_68 = V_18 -> V_66 ;
V_40 = 4 ;
type = V_69 ;
}
* V_62 = V_40 ;
...
struct V_15 * V_15 = V_3 -> V_16 , * V_18 = NULL ;
if ( V_70 && ! F_23 ( V_15 -> V_52 ) ) {
V_71 = F_11 ( V_3 ) ;
V_18 = V_71 -> V_16 ;
}
if ( V_8 -> V_72 )
error = V_8 -> V_72 ( V_15 , V_61 -> V_73 , V_62 , V_18 ) ;
else
error = F_28 ( V_15 , V_61 , V_62 , V_18 ) ;
F_8 ( V_71 ) ;
return error ;
}
