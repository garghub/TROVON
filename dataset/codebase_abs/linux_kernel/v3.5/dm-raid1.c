...
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
if ( V_15 == V_20 ) {
V_149 -> V_152 = F_52 ( V_3 -> V_76 , V_14 ) ;
F_10 ( V_3 , V_14 , V_15 ) ;
return V_153 ;
}
V_69 = log -> type -> V_37 ( log , F_52 ( V_3 -> V_76 , V_14 ) , 0 ) ;
if ( V_69 < 0 && V_69 != - V_154 )
return V_69 ;
if ( ! V_69 || ( V_69 == - V_154 ) ) {
if ( V_15 == V_155 )
return - V_154 ;
...
if ( F_31 ( ! V_27 ) )
return - V_62 ;
V_151 = F_118 ( V_3 -> V_123 , V_156 ) ;
if ( F_49 ( V_151 ) ) {
F_119 ( & V_151 -> V_157 , V_14 ) ;
V_149 -> V_54 = V_151 ;
V_151 -> V_27 = V_27 ;
}
F_55 ( V_27 , V_14 ) ;
...
int error , union V_148 * V_149 )
{
int V_15 = F_64 ( V_14 ) ;
struct V_2 * V_3 = (struct V_2 * ) V_42 -> V_43 ;
struct V_25 * V_27 = NULL ;
struct V_159 * V_160 = NULL ;
struct V_150 * V_151 = V_149 -> V_54 ;
if ( V_15 == V_20 ) {
if ( ! ( V_14 -> V_50 & ( V_113 | V_108 ) ) )
F_121 ( V_3 -> V_76 , V_149 -> V_152 ) ;
return error ;
}
if ( error == - V_161 )
goto V_36;
if ( ( error == - V_154 ) && ( V_14 -> V_50 & V_162 ) )
goto V_36;
if ( F_31 ( error ) ) {
if ( ! V_151 ) {
F_35 ( L_29 ) ;
...
struct V_82 * log = F_44 ( V_3 -> V_76 ) ;
F_21 ( & V_3 -> V_89 , 0 ) ;
if ( log -> type -> V_165 && log -> type -> V_165 ( log ) )
F_27 ( L_34 ) ;
F_130 ( V_3 -> V_76 ) ;
}
...
V_169 [ V_27 ] = F_131 ( & ( V_3 -> V_25 [ V_27 ] ) ) ;
}
V_169 [ V_27 ] = '\0' ;
F_133 ( L_37 ,
