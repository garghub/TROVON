...
static void F_40 ( struct V_99 * V_131 , struct V_132 * V_132 )
{
struct V_133 V_41 ;
V_41 . V_132 = V_132 ;
...
static int F_43 ( struct V_99 * V_131 , struct V_138 * V_41 )
{
const struct V_9 * V_16 = V_41 -> V_139 ;
int V_14 ;
V_41 -> V_103 = V_131 -> V_58 . V_59 . V_103 ;
V_41 -> V_104 = V_131 -> V_62 ;
V_14 = F_44 ( V_41 , V_131 -> V_58 . V_140 - sizeof( * V_131 ) ,
...
static int
F_45 ( struct V_99 * V_131 , struct V_138 * V_41 )
{
struct V_141 * V_103 ;
int V_14 ;
V_103 = F_46 ( V_96 , V_131 -> V_58 . V_124 . V_60 ,
...
V_14 = F_43 ( V_131 , V_41 ) ;
if ( V_14 )
goto V_143;
return 0 ;
V_143:
F_41 ( V_131 -> V_58 . V_59 . V_103 -> V_135 ) ;
return V_14 ;
}
static int F_49 ( struct V_44 * V_49 , struct V_132 * V_132 , const char * V_60 )
{
...
int V_14 ;
V_56 = F_17 ( V_49 ) ;
V_14 = F_50 ( & V_41 , V_56 -> V_58 . V_137 - sizeof( * V_56 ) ,
...
static int
F_51 ( struct V_44 * V_49 , struct V_132 * V_132 , const char * V_60 ,
unsigned int V_126 )
{
struct V_48 * V_56 ;
struct V_146 * V_57 ;
...
V_148 . V_95 = V_96 ;
F_30 (ematch, e) {
V_14 = F_45 ( V_100 , & V_148 ) ;
if ( V_14 != 0 )
goto V_149;
++ V_147 ;
}
V_56 = F_17 ( V_49 ) ;
V_57 = F_52 ( V_96 , V_56 -> V_58 . V_124 . V_60 ,
...
V_14 = F_49 ( V_49 , V_132 , V_60 ) ;
if ( V_14 )
goto V_143;
return 0 ;
V_143:
F_41 ( V_56 -> V_58 . V_59 . V_57 -> V_135 ) ;
V_149:
F_30 (ematch, e) {
if ( V_147 -- == 0 )
break;
...
static void F_56 ( struct V_44 * V_49 , struct V_132 * V_132 )
{
struct V_155 V_41 ;
struct V_48 * V_56 ;
struct V_99 * V_100 ;
...
F_41 ( V_41 . V_57 -> V_135 ) ;
}
static int
F_57 ( struct V_132 * V_132 , struct V_74 * V_117 , void * V_118 ,
...
if ( ! F_37 ( V_117 , V_157 -> V_98 , V_118 ) )
return - V_161 ;
V_158 = 0 ;
F_21 (iter, entry0, newinfo->size) {
V_14 = F_51 ( V_78 , V_132 , V_157 -> V_60 , V_157 -> V_126 ) ;
if ( V_14 != 0 )
break;
++ V_158 ;
}
...
} while ( F_62 ( V_50 , V_164 ) );
F_31 ( V_105 [ V_158 ] , V_163 , V_121 ) ;
++ V_158 ;
}
}
}
static struct V_154 * F_63 ( const struct V_1 * V_85 )
{
unsigned int V_165 ;
struct V_154 * V_105 ;
...
if ( F_47 ( V_105 ) )
return F_48 ( V_105 ) ;
V_171 = V_75 -> V_79 [ F_67 () ] ;
if ( F_68 ( V_168 , V_171 , V_167 ) != 0 ) {
V_14 = - V_172 ;
goto V_173;
}
...
if ( V_175 > 0 )
V_175 -= F_72 ( V_83 , V_175 ) ;
return F_68 ( V_23 , & V_175 , sizeof( V_175 ) ) ? - V_172 : 0 ;
}
...
F_30 (ematch, e)
V_169 += F_75 ( V_100 -> V_58 . V_59 . V_103 ) ;
V_56 = F_16 ( V_49 ) ;
V_169 += F_76 ( V_56 -> V_58 . V_59 . V_57 ) ;
V_117 -> V_126 -= V_169 ;
V_14 = F_77 ( V_83 , V_176 , V_169 ) ;
if ( V_14 )
return V_14 ;
for ( V_158 = 0 ; V_158 < V_119 ; V_158 ++ ) {
if ( V_2 -> V_80 [ V_158 ] &&
...
if ( ! V_117 || ! V_2 )
return - V_136 ;
memcpy ( V_117 , V_2 , F_69 ( struct V_74 , V_79 ) ) ;
V_117 -> V_178 = 0 ;
V_171 = V_2 -> V_79 [ F_67 () ] ;
F_79 ( V_83 , V_2 -> V_159 ) ;
F_21 (iter, loc_cpu_entry, info->size) {
V_14 = F_74 ( V_78 , V_2 , V_171 , V_117 ) ;
if ( V_14 != 0 )
return V_14 ;
}
return 0 ;
}
static int F_80 ( struct V_132 * V_132 , void T_4 * V_124 ,
...
if ( F_81 ( V_60 , V_124 , sizeof( V_60 ) ) != 0 )
return - V_172 ;
V_60 [ V_180 - 1 ] = '\0' ;
#ifdef F_82
if ( V_179 )
F_83 ( V_83 ) ;
#endif
V_56 = F_84 ( F_85 ( V_132 , V_83 , V_60 ) ,
L_36 , V_60 ) ;
if ( V_56 && ! F_47 ( V_56 ) ) {
struct V_181 V_2 ;
...
static int
F_89 ( struct V_132 * V_132 , struct V_184 T_4 * V_185 ,
const int * V_106 )
{
int V_14 ;
struct V_184 V_186 ;
...
if ( F_81 ( & V_186 , V_185 , sizeof( V_186 ) ) != 0 )
return - V_172 ;
...
static int
F_90 ( struct V_132 * V_132 , const char * V_60 , unsigned int V_98 ,
...
struct V_44 * V_78 ;
V_14 = 0 ;
V_105 = F_64 ( V_189 * sizeof( struct V_154 ) ) ;
if ( ! V_105 ) {
V_14 = - V_166 ;
goto V_72;
}
...
V_191 = F_91 ( V_56 , V_189 , V_117 , & V_14 ) ;
if ( ! V_191 )
goto V_194;
F_11 ( L_42 ,
...
static int
F_93 ( struct V_132 * V_132 , const void T_4 * V_124 , unsigned int V_106 )
{
int V_14 ;
struct V_156 V_182 ;
struct V_74 * V_117 ;
void * V_171 ;
struct V_44 * V_78 ;
if ( F_81 ( & V_182 , V_124 , sizeof( V_182 ) ) != 0 )
return - V_172 ;
if ( V_182 . V_189 >= V_195 / sizeof( struct V_154 ) )
return - V_166 ;
V_182 . V_60 [ sizeof( V_182 . V_60 ) - 1 ] = 0 ;
V_117 = F_94 ( V_182 . V_126 ) ;
if ( ! V_117 )
return - V_166 ;
V_171 = V_117 -> V_79 [ F_67 () ] ;
if ( F_81 ( V_171 , V_124 + sizeof( V_182 ) ,
V_182 . V_126 ) != 0 ) {
V_14 = - V_172 ;
goto V_196;
}
V_14 = F_57 ( V_132 , V_117 , V_171 , & V_182 ) ;
if ( V_14 != 0 )
goto V_196;
F_11 ( L_43 ) ;
V_14 = F_90 ( V_132 , V_182 . V_60 , V_182 . V_98 , V_117 ,
...
static int
F_95 ( struct V_132 * V_132 , const void T_4 * V_124 , unsigned int V_106 ,
int V_179 )
{
...
return - V_136 ;
V_200 = F_96 ( V_106 - V_126 ) ;
if ( ! V_200 )
return - V_166 ;
if ( F_81 ( V_200 , V_124 + V_126 , V_106 - V_126 ) != 0 ) {
V_14 = - V_172 ;
goto free;
}
V_56 = F_85 ( V_132 , V_83 , V_60 ) ;
if ( ! V_56 || F_47 ( V_56 ) ) {
V_14 = V_56 ? F_48 ( V_56 ) : - V_183 ;
goto free;
}
...
F_31 ( V_78 -> V_105 , V_200 [ V_158 ] . V_163 , V_200 [ V_158 ] . V_121 ) ;
++ V_158 ;
}
F_34 ( V_94 ) ;
V_204:
...
static int
F_97 ( struct V_44 * V_49 , void T_4 * * V_205 ,
...
if ( F_68 ( V_206 , V_49 , sizeof( struct V_44 ) ) != 0 ||
F_68 ( & V_206 -> V_105 , & V_105 [ V_158 ] ,
sizeof( V_105 [ V_158 ] ) ) != 0 )
return - V_172 ;
* V_205 += sizeof( struct V_177 ) ;
* V_126 -= sizeof( struct V_44 ) - sizeof( struct V_177 ) ;
F_30 (ematch, e) {
V_14 = F_98 ( V_100 , V_205 , V_126 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_63 = V_49 -> V_63 - ( V_207 - * V_126 ) ;
V_56 = F_17 ( V_49 ) ;
V_14 = F_99 ( V_56 , V_205 , V_126 ) ;
if ( V_14 )
return V_14 ;
V_129 = V_49 -> V_129 - ( V_207 - * V_126 ) ;
if ( F_100 ( V_63 , & V_206 -> V_63 ) != 0 ||
F_100 ( V_129 , & V_206 -> V_129 ) != 0 )
return - V_172 ;
return 0 ;
}
static int
F_101 ( struct V_99 * V_131 ,
const char * V_60 ,
...
static void F_102 ( struct V_177 * V_49 )
{
struct V_48 * V_56 ;
struct V_99 * V_100 ;
F_30 (ematch, e)
F_41 ( V_100 -> V_58 . V_59 . V_103 -> V_135 ) ;
V_56 = F_103 ( V_49 ) ;
F_41 ( V_56 -> V_58 . V_59 . V_57 -> V_135 ) ;
}
static int
F_104 ( struct V_177 * V_49 ,
struct V_74 * V_117 ,
unsigned int * V_126 ,
const unsigned char * V_45 ,
const unsigned char * V_150 ,
...
F_11 ( L_45 , V_49 ) ;
if ( ( unsigned long ) V_49 % F_55 ( struct V_177 ) != 0 ||
...
static int
F_105 ( struct V_177 * V_49 , void * * V_205 ,
...
* V_126 += sizeof( struct V_44 ) - sizeof( struct V_177 ) ;
F_30 (ematch, e) {
V_14 = F_106 ( V_100 , V_205 , V_126 ) ;
if ( V_14 != 0 )
return V_14 ;
}
V_211 -> V_63 = V_49 -> V_63 - ( V_207 - * V_126 ) ;
V_56 = F_103 ( V_49 ) ;
F_107 ( V_56 , V_205 , V_126 ) ;
...
static int F_108 ( struct V_44 * V_49 , struct V_132 * V_132 ,
const char * V_60 )
{
unsigned int V_147 ;
int V_14 = 0 ;
...
V_214 = V_117 -> V_79 [ F_67 () ] ;
V_120 = V_214 ;
V_126 = V_167 ;
F_21 (iter0, entry0, total_size) {
V_14 = F_105 ( V_215 , & V_120 , & V_126 ,
V_60 , V_117 , V_214 ) ;
if ( V_14 != 0 )
break;
}
...
goto V_196;
V_14 = - V_161 ;
if ( ! F_37 ( V_117 , V_98 , V_214 ) )
goto V_196;
V_158 = 0 ;
F_21 (iter1, entry1, newinfo->size) {
V_14 = F_108 ( V_216 , V_132 , V_60 ) ;
if ( V_14 != 0 )
break;
++ V_158 ;
if ( strcmp ( F_17 ( V_216 ) -> V_58 . V_124 . V_60 ,
V_61 ) == 0 )
++ V_117 -> V_114 ;
}
if ( V_14 ) {
...
static int
F_110 ( struct V_132 * V_132 , void T_4 * V_124 , unsigned int V_106 )
{
int V_14 ;
struct V_219 V_182 ;
struct V_74 * V_117 ;
...
V_14 = F_109 ( V_132 , V_182 . V_60 , V_182 . V_98 ,
...
static int
F_113 ( struct V_220 * V_221 , int V_222 , void T_4 * V_124 ,
unsigned int V_106 )
{
int V_14 ;
if ( ! F_114 ( V_223 ) )
...
switch ( V_222 ) {
case V_225 :
V_14 = F_110 ( F_115 ( V_221 ) , V_124 , V_106 ) ;
break;
case V_226 :
V_14 = F_95 ( F_115 ( V_221 ) , V_124 , V_106 , 1 ) ;
break;
default:
F_11 ( L_51 , V_222 ) ;
V_14 = - V_136 ;
...
static int
F_116 ( unsigned int V_167 , struct V_1 * V_85 ,
void T_4 * V_168 )
{
struct V_154 * V_105 ;
const struct V_74 * V_75 = V_85 -> V_75 ;
...
static int
F_117 ( struct V_132 * V_132 , struct V_227 T_4 * V_185 ,
int * V_106 )
{
int V_14 ;
struct V_227 V_186 ;
...
static int
F_118 ( struct V_220 * V_221 , int V_222 , void T_4 * V_124 , int * V_106 )
{
int V_14 ;
if ( ! F_114 ( V_223 ) )
return - V_224 ;
switch ( V_222 ) {
case V_228 :
V_14 = F_80 ( F_115 ( V_221 ) , V_124 , V_106 , 1 ) ;
break;
case V_229 :
V_14 = F_117 ( F_115 ( V_221 ) , V_124 , V_106 ) ;
break;
default:
V_14 = F_119 ( V_221 , V_222 , V_124 , V_106 ) ;
}
return V_14 ;
}
static int
F_120 ( struct V_220 * V_221 , int V_222 , void T_4 * V_124 , unsigned int V_106 )
{
int V_14 ;
if ( ! F_114 ( V_223 ) )
return - V_224 ;
switch ( V_222 ) {
case V_225 :
V_14 = F_93 ( F_115 ( V_221 ) , V_124 , V_106 ) ;
break;
case V_226 :
V_14 = F_95 ( F_115 ( V_221 ) , V_124 , V_106 , 0 ) ;
break;
default:
F_11 ( L_51 , V_222 ) ;
V_14 = - V_136 ;
...
switch ( V_222 ) {
case V_228 :
V_14 = F_80 ( F_115 ( V_221 ) , V_124 , V_106 , 0 ) ;
break;
case V_229 :
V_14 = F_89 ( F_115 ( V_221 ) , V_124 , V_106 ) ;
break;
case V_230 :
case V_231 : {
struct V_232 V_233 ;
...
if ( F_81 ( & V_233 , V_124 , sizeof( V_233 ) ) != 0 ) {
V_14 = - V_172 ;
break;
}
...
struct V_1 * F_122 ( struct V_132 * V_132 ,
const struct V_1 * V_85 ,
const struct V_156 * V_157 )
{
int V_14 ;
...
V_14 = F_57 ( V_132 , V_117 , V_171 , V_157 ) ;
if ( V_14 != 0 )
goto V_236;
V_235 = F_123 ( V_132 , V_85 , & V_234 , V_117 ) ;
if ( F_47 ( V_235 ) ) {
V_14 = F_48 ( V_235 ) ;
goto V_236;
}
...
void F_124 ( struct V_132 * V_132 , struct V_1 * V_85 )
{
struct V_74 * V_75 ;
void * V_171 ;
...
static int F_129 ( const struct V_138 * V_41 )
{
const struct V_247 * V_248 = V_41 -> V_104 ;
return ( V_248 -> V_28 & ~ V_251 ) ? - V_136 : 0 ;
}
static int T_8 F_130 ( struct V_132 * V_132 )
{
return F_131 ( V_132 , V_96 ) ;
}
static void T_9 F_132 ( struct V_132 * V_132 )
{
F_133 ( V_132 , V_96 ) ;
}
...
int V_57 , unsigned short * V_12 , int * V_32 )
{
...
* V_12 = 0 ;
if ( * V_46 ) {
struct V_15 V_261 , * V_262 ;
V_262 = F_128 ( V_6 , * V_46 , sizeof( V_261 ) , & V_261 ) ;
if ( ! V_262 || ( V_262 -> V_263 != 6 ) ) {
F_147 ( V_264 L_59 ) ;
return - V_265 ;
}
V_164 = * V_46 + sizeof( struct V_15 ) ;
V_260 = V_262 -> V_260 ;
}
V_106 = V_6 -> V_106 - V_164 ;
while ( V_260 != V_57 ) {
struct V_266 V_267 , * V_268 ;
unsigned int V_269 ;
if ( ( ! F_148 ( V_260 ) ) || V_260 == V_270 ) {
if ( V_57 < 0 )
break;
return - V_183 ;
}
V_268 = F_128 ( V_6 , V_164 , sizeof( V_267 ) , & V_267 ) ;
if ( V_268 == NULL )
return - V_265 ;
if ( V_260 == V_271 ) {
unsigned short V_35 ;
...
* V_32 |= V_273 ;
V_272 = F_128 ( V_6 ,
V_164 + F_69 ( struct V_274 ,
V_275 ) ,
sizeof( V_35 ) ,
& V_35 ) ;
if ( V_272 == NULL )
return - V_265 ;
V_35 = F_149 ( * V_272 ) & ~ 0x7 ;
if ( V_35 ) {
if ( V_57 < 0 &&
( ( ! F_148 ( V_268 -> V_260 ) ) ||
V_268 -> V_260 == V_270 ) ) {
...
if ( V_32 && ( * V_32 & V_277 ) && ( V_57 < 0 ) )
break;
V_269 = ( V_268 -> V_269 + 2 ) << 2 ;
} else
V_269 = F_150 ( V_268 ) ;
V_260 = V_268 -> V_260 ;
V_106 -= V_269 ;
