...
char V_169 [ V_170 ] ;
F_79 ( V_110 , V_111 ) ;
V_118 = F_80 ( NULL , NULL ) ;
if ( V_118 == NULL )
return - V_167 ;
V_2 -> V_33 = V_118 ;
V_110 = F_81 ( V_110 , V_111 , V_171 , V_172 ,
V_173 ) ;
if ( ! V_110 && F_82 ( & V_2 -> V_54 . V_79 ) )
F_83 ( V_172 , V_171 ) ;
...
V_73 = F_88 ( & V_2 -> V_54 . V_79 ) ;
if ( V_73 ) {
F_89 ( & V_2 -> V_54 . V_79 , V_73 , V_169 , V_170 ) ;
F_26 ( L_64 , V_169 ) ;
}
V_73 = F_90 ( & V_2 -> V_54 . V_79 ) ;
if ( V_73 ) {
int V_181 = V_74 ;
F_89 ( & V_2 -> V_54 . V_79 , V_73 , V_169 , V_170 ) ;
F_27 ( L_64 , V_169 ) ;
...
V_73 = - V_167 ;
if ( F_91 ( V_118 , & V_2 -> V_54 . V_79 ) < 0 )
F_83 ( V_172 , V_171 ) ;
F_20 (pos, &evsel_list->entries, node) {
if ( F_92 ( V_43 -> V_49 . V_87 , F_28 ( V_43 ) ) )
goto V_182;
}
