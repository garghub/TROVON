...
static void F_15 ( struct V_13 * V_49 , int error )
{
struct V_1 * V_6 = V_49 -> V_50 ;
struct V_51 V_52 ;
unsigned V_32 = V_53 ;
if ( error || F_16 ( V_49 -> V_45 ) != V_54 ||
F_17 ( V_49 -> V_45 ) != V_55 ) {
V_32 = V_46 ;
goto V_35;
}
if ( V_6 -> V_42 > 0 ) {
V_32 = F_18 ( V_6 -> V_39 , V_40 ,
& V_52 ) ;
if ( ! V_32 ) {
V_32 = V_46 ;
goto V_35;
}
V_32 = F_19 ( V_6 -> V_3 , & V_52 ) ;
if ( V_32 == V_56 ) {
V_32 = V_57 ;
goto V_35;
}
...
return V_56 ;
if ( V_52 -> V_59 == 0x2a && V_52 -> V_60 == 0x01 )
return V_56 ;
if ( V_52 -> V_59 == 0x2a && V_52 -> V_60 == 0x06 )
return V_56 ;
if ( V_52 -> V_59 == 0x2a && V_52 -> V_60 == 0x07 )
return V_56 ;
if ( V_52 -> V_59 == 0x3f && V_52 -> V_60 == 0x03 )
return V_56 ;
...
static int F_32 ( struct V_2 * V_3 , const char * V_107 )
{
struct V_1 * V_6 = F_1 ( V_3 ) ;
unsigned int V_108 = 0 , V_109 ;
const char * V_110 = V_107 ;
int V_111 = V_53 ;
if ( ( sscanf ( V_107 , L_18 , & V_109 ) != 1 ) || ( V_109 != 1 ) )
return - V_112 ;
while ( * V_110 ++ )
;
if ( ( sscanf ( V_110 , L_18 , & V_108 ) != 1 ) || ( V_108 > 1 ) )
return - V_112 ;
if ( V_108 )
V_6 -> V_113 |= V_114 ;
else
...
static int F_34 ( struct V_2 * V_3 , struct V_13 * V_49 )
{
struct V_1 * V_6 = F_1 ( V_3 ) ;
int V_118 = V_119 ;
if ( V_6 -> V_61 == V_85 )
...
V_6 -> V_3 = V_3 ;
V_32 = F_31 ( V_3 , V_6 ) ;
if ( ( V_32 != V_53 ) && ( V_32 != V_105 ) )
goto V_129;
if ( ! F_38 ( V_130 ) )
goto V_129;
F_39 ( V_3 -> V_18 -> V_131 , V_113 ) ;
V_3 -> V_4 = V_4 ;
F_40 ( V_3 -> V_18 -> V_131 , V_113 ) ;
F_8 ( V_132 , V_3 , L_20 , V_44 ) ;
return 0 ;
V_129:
F_4 ( V_4 ) ;
F_8 ( V_124 , V_3 , L_21 , V_44 ) ;
return - V_112 ;
}
