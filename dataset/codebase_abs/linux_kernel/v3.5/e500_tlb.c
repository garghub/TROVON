...
if ( V_2 -> V_61 )
memset ( V_2 -> V_61 ,
sizeof( V_52 ) * V_2 -> V_5 [ 1 ] . V_8 , 0 ) ;
if ( V_2 -> V_63 )
memset ( V_2 -> V_63 ,
sizeof( unsigned int ) * V_7 [ 1 ] . V_8 , 0 ) ;
}
...
V_46 = F_72 ( V_2 -> V_39 . V_98 , V_102 , V_100 ) ;
if ( F_73 ( V_46 ) ) {
F_74 ( V_128 L_1 ,
( long ) V_100 ) ;
F_49 ( V_46 ) ;
...
if ( F_2 ( F_83 ( V_56 ) ) )
return - 1 ;
if ( V_36 == 1 && F_79 ( V_2 , V_56 ) )
F_78 ( V_2 ) ;
V_56 -> V_28 = 0 ;
return 0 ;
}
int F_84 ( struct V_1 * V_2 , T_3 V_131 )
{
int V_55 ;
if ( V_131 & V_132 )
...
int F_85 ( struct V_38 * V_39 , int V_135 , int V_136 )
{
struct V_1 * V_2 = F_22 ( V_39 ) ;
unsigned int V_137 ;
int V_55 , V_36 ;
T_5 V_138 ;
V_138 = ( ( V_135 ) ? F_86 ( V_39 , V_135 ) : 0 ) + F_86 ( V_39 , V_136 ) ;
V_137 = ( V_138 >> 2 ) & 0x1 ;
V_36 = ( V_138 >> 3 ) & 0x1 ;
if ( V_137 ) {
...
static void F_87 ( struct V_1 * V_2 , int V_36 ,
int V_67 , int V_139 )
{
struct V_10 * V_11 ;
int V_76 , V_55 ;
...
static void F_88 ( struct V_1 * V_2 , int V_67 ,
int V_135 , int V_136 )
{
int V_36 , V_55 ;
T_5 V_138 ;
V_138 = F_86 ( & V_2 -> V_39 , V_136 ) ;
if ( V_135 )
V_138 += F_86 ( & V_2 -> V_39 , V_135 ) ;
...
int F_89 ( struct V_38 * V_39 , int V_139 , int V_135 , int V_136 )
{
struct V_1 * V_2 = F_22 ( V_39 ) ;
int V_67 = F_90 ( V_39 ) ;
if ( V_139 == 0 || V_139 == 1 ) {
F_87 ( V_2 , 0 , V_67 , V_139 ) ;
F_87 ( V_2 , 1 , V_67 , V_139 ) ;
} else if ( V_139 == 3 ) {
F_88 ( V_2 , V_67 , V_135 , V_136 ) ;
}
return V_134 ;
}
int F_91 ( struct V_38 * V_39 )
{
struct V_1 * V_2 = F_22 ( V_39 ) ;
int V_36 , V_55 ;
struct V_10 * V_56 ;
...
int F_93 ( struct V_38 * V_39 , int V_136 )
{
struct V_1 * V_2 = F_22 ( V_39 ) ;
int V_68 = ! ! F_94 ( V_39 ) ;
unsigned int V_67 = F_90 ( V_39 ) ;
int V_55 , V_36 ;
struct V_10 * V_56 = NULL ;
T_5 V_138 ;
V_138 = F_86 ( V_39 , V_136 ) ;
for ( V_36 = 0 ; V_36 < 2 ; V_36 ++ ) {
...
F_100 ( V_39 -> V_42 . V_43 -> V_24 , V_56 -> V_28 ,
V_56 -> V_20 , V_56 -> V_12 ) ;
if ( V_36 == 1 ) {
if ( V_142 )
F_78 ( V_2 ) ;
...
if ( V_55 >= 0 )
return F_104 ( V_36 , V_55 ) ;
}
return - 1 ;
}
int F_105 ( struct V_38 * V_39 ,
struct V_145 * V_146 )
{
int V_147 ;
T_5 V_34 ;
...
V_147 = F_103 ( V_39 , V_34 , V_67 , V_68 ) ;
if ( V_147 < 0 ) {
V_146 -> V_149 = 0 ;
return 0 ;
}
V_146 -> V_150 = F_106 ( V_39 , V_147 , V_34 ) ;
V_146 -> V_149 = 1 ;
return 0 ;
}
int F_107 ( struct V_38 * V_39 , T_5 V_34 )
{
unsigned int V_68 = ! ! ( V_39 -> V_42 . V_43 -> V_95 & V_151 ) ;
return F_103 ( V_39 , V_34 , F_57 ( V_39 ) , V_68 ) ;
}
...
T_8 F_106 ( struct V_38 * V_39 , unsigned int V_147 ,
T_5 V_34 )
{
struct V_1 * V_2 = F_22 ( V_39 ) ;
struct V_10 * V_56 ;
V_52 V_155 ;
V_56 = F_32 ( V_2 , F_111 ( V_147 ) , F_112 ( V_147 ) ) ;
V_155 = F_80 ( V_56 ) - 1 ;
return F_76 ( V_56 ) | ( V_34 & V_155 ) ;
}
void F_113 ( struct V_38 * V_39 )
{
}
void F_114 ( struct V_38 * V_39 , V_52 V_34 , T_8 V_156 ,
unsigned int V_147 )
{
struct V_1 * V_2 = F_22 ( V_39 ) ;
struct V_157 * V_158 ;
struct V_10 * V_56 , V_23 ;
int V_36 = F_111 ( V_147 ) ;
int V_55 = F_112 ( V_147 ) ;
int V_80 , V_37 ;
V_56 = F_32 ( V_2 , V_36 , V_55 ) ;
switch ( V_36 ) {
case 0 :
...
F_116 ( V_2 -> V_57 [ 1 ] ) ;
if ( V_2 -> V_159 ) {
F_117 ( ( void * ) ( F_118 ( ( V_160 ) V_2 -> V_75 ,
V_161 ) ) ) ;
for ( V_71 = 0 ; V_71 < V_2 -> V_162 ; V_71 ++ ) {
F_119 ( V_2 -> V_159 [ V_71 ] ) ;
...
void F_121 ( struct V_38 * V_39 , struct V_163 * V_164 )
{
...
int F_122 ( struct V_38 * V_39 , struct V_163 * V_164 )
{
...
return - V_185 ;
if ( F_124 ( & V_174 , ( void V_186 * ) ( V_160 ) V_172 -> V_174 ,
sizeof( V_174 ) ) )
return - V_187 ;
if ( V_174 . V_188 [ 1 ] > 64 )
return - V_185 ;
...
return - V_185 ;
if ( ! F_125 ( V_174 . V_189 [ 0 ] ) )
return - V_185 ;
V_65 = V_174 . V_188 [ 0 ] >> F_126 ( V_174 . V_189 [ 0 ] ) ;
if ( ! F_125 ( V_65 ) )
return - V_185 ;
...
return - V_185 ;
V_181 = F_127 ( V_172 -> V_190 + V_180 - 1 , V_161 ) -
V_172 -> V_190 / V_161 ;
V_177 = F_128 ( sizeof( struct V_176 * ) * V_181 , V_191 ) ;
if ( ! V_177 )
return - V_192 ;
V_182 = F_129 ( V_172 -> V_190 , V_181 , 1 , V_177 ) ;
if ( V_182 < 0 )
goto V_193;
if ( V_182 != V_181 ) {
V_181 = V_182 ;
...
V_175 = F_130 ( V_177 , V_181 , V_195 , V_196 ) ;
if ( ! V_175 )
goto V_194;
V_178 [ 0 ] = F_131 ( sizeof( struct V_157 ) * V_174 . V_188 [ 0 ] ,
V_191 ) ;
V_178 [ 1 ] = F_131 ( sizeof( struct V_157 ) * V_174 . V_188 [ 1 ] ,
V_191 ) ;
if ( ! V_178 [ 0 ] || ! V_178 [ 1 ] )
goto V_194;
V_179 = F_131 ( sizeof( V_52 ) * V_174 . V_188 [ 1 ] ,
V_191 ) ;
if ( ! V_179 )
goto V_194;
F_115 ( V_2 ) ;
...
V_2 -> V_5 [ 1 ] . V_6 = V_206 ;
V_2 -> V_5 [ 1 ] . V_65 = 1 ;
V_2 -> V_75 = F_128 ( V_8 * V_204 , V_191 ) ;
if ( ! V_2 -> V_75 )
return - V_192 ;
V_2 -> V_74 [ 0 ] = 0 ;
V_2 -> V_74 [ 1 ] = V_205 ;
V_2 -> V_81 [ 0 ] =
F_131 ( sizeof( struct V_77 ) * V_7 [ 0 ] . V_8 ,
V_191 ) ;
if ( ! V_2 -> V_81 [ 0 ] )
goto V_212;
V_2 -> V_81 [ 1 ] =
F_131 ( sizeof( struct V_77 ) * V_7 [ 1 ] . V_8 ,
V_191 ) ;
if ( ! V_2 -> V_81 [ 1 ] )
goto V_212;
V_2 -> V_57 [ 0 ] = F_131 ( sizeof( struct V_77 ) *
V_2 -> V_5 [ 0 ] . V_8 ,
V_191 ) ;
if ( ! V_2 -> V_57 [ 0 ] )
goto V_212;
V_2 -> V_57 [ 1 ] = F_131 ( sizeof( struct V_77 ) *
V_2 -> V_5 [ 1 ] . V_8 ,
V_191 ) ;
if ( ! V_2 -> V_57 [ 1 ] )
goto V_212;
V_2 -> V_61 = F_131 ( sizeof( unsigned int ) *
V_2 -> V_5 [ 1 ] . V_8 ,
V_191 ) ;
if ( ! V_2 -> V_61 )
goto V_212;
V_2 -> V_63 = F_131 ( sizeof( unsigned int ) *
V_7 [ 1 ] . V_8 ,
V_191 ) ;
if ( ! V_2 -> V_63 )
goto V_212;
