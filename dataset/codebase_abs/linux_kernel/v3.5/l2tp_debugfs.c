...
F_14 ( V_9 , L_10 ,
V_3 -> V_50 ,
( unsigned long long ) V_3 -> V_51 . V_52 ,
( unsigned long long ) V_3 -> V_51 . V_53 ,
( unsigned long long ) V_3 -> V_51 . V_54 ,
( unsigned long long ) V_3 -> V_51 . V_55 ,
( unsigned long long ) V_3 -> V_51 . V_56 ,
( unsigned long long ) V_3 -> V_51 . V_57 ) ;
if ( V_3 -> V_58 != NULL )
V_3 -> V_58 ( V_9 , V_3 ) ;
}
static void F_20 ( struct V_8 * V_9 , void * V_15 )
{
...
F_14 ( V_9 , L_27 ,
V_6 -> V_65 , V_6 -> V_66 ,
( unsigned long long ) V_6 -> V_51 . V_52 ,
( unsigned long long ) V_6 -> V_51 . V_53 ,
( unsigned long long ) V_6 -> V_51 . V_54 ,
( unsigned long long ) V_6 -> V_51 . V_55 ,
( unsigned long long ) V_6 -> V_51 . V_56 ,
( unsigned long long ) V_6 -> V_51 . V_57 ) ;
if ( V_6 -> V_58 != NULL )
V_6 -> V_58 ( V_9 , V_6 ) ;
}
static int F_22 ( struct V_8 * V_9 , void * V_15 )
{
struct V_1 * V_2 = V_15 ;
if ( V_15 == V_11 ) {
F_23 ( V_9 , L_28 ) ;
...
static int F_24 ( struct V_79 * V_79 , struct V_80 * V_80 )
{
struct V_1 * V_2 ;
struct V_8 * V_81 ;
int V_82 = - V_83 ;
V_2 = F_25 ( sizeof( * V_2 ) , V_84 ) ;
if ( V_2 == NULL )
goto V_13;
V_2 -> V_4 = F_26 ( V_85 -> V_86 ) ;
if ( F_27 ( V_2 -> V_4 ) ) {
V_82 = F_28 ( V_2 -> V_4 ) ;
goto V_87;
}
...
static int F_32 ( struct V_79 * V_79 , struct V_80 * V_80 )
{
struct V_1 * V_2 ;
struct V_8 * V_81 ;
V_81 = V_80 -> V_90 ;
...
V_92 = F_36 ( L_40 , 0600 , V_91 , NULL , & V_93 ) ;
if ( V_92 == NULL )
V_82 = - V_94 ;
F_37 ( L_41 ) ;
V_13:
