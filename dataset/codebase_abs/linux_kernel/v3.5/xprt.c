...
V_20 = F_105 ( & V_16 -> free , struct V_19 , V_110 ) ;
F_97 ( & V_20 -> V_110 ) ;
F_94 ( V_20 ) ;
}
}
struct V_15 * F_106 ( struct V_143 * V_143 , T_4 V_144 ,
unsigned int V_145 ,
unsigned int V_146 )
{
struct V_15 * V_16 ;
...
F_117 ( V_18 , V_18 -> V_65 -> V_157 ) ;
F_24 ( & V_16 -> V_42 ) ;
V_16 -> V_43 -> V_47 ( V_16 , V_18 ) ;
if ( V_16 -> V_43 -> V_158 )
V_16 -> V_43 -> V_158 ( V_18 ) ;
if ( ! F_64 ( & V_20 -> V_110 ) )
F_97 ( & V_20 -> V_110 ) ;
V_16 -> V_159 = V_80 ;
if ( F_64 ( & V_16 -> V_90 ) && F_81 ( V_16 ) )
F_118 ( & V_16 -> V_59 ,
V_16 -> V_159 + V_16 -> V_114 ) ;
F_25 ( & V_16 -> V_42 ) ;
if ( V_20 -> V_152 )
V_16 -> V_43 -> V_160 ( V_20 -> V_152 ) ;
if ( V_20 -> V_161 != NULL )
F_119 ( V_20 -> V_161 ) ;
V_18 -> V_21 = NULL ;
if ( V_20 -> V_153 )
...
static void F_107 ( struct V_15 * V_16 , struct V_143 * V_143 )
{
F_108 ( & V_16 -> V_162 , 1 ) ;
F_123 ( & V_16 -> V_42 ) ;
F_123 ( & V_16 -> V_142 ) ;
...
V_16 -> V_50 = V_166 ;
V_16 -> V_167 = 0 ;
F_125 ( & V_16 -> V_168 , L_31 ) ;
F_125 ( & V_16 -> V_55 , L_32 ) ;
F_126 ( & V_16 -> V_36 , L_33 ) ;
F_126 ( & V_16 -> V_129 , L_34 ) ;
F_113 ( V_16 ) ;
V_16 -> V_150 = F_127 ( V_143 ) ;
}
struct V_15 * F_128 ( struct V_169 * args )
{
struct V_15 * V_16 ;
struct V_1 * V_3 ;
F_2 ( & V_6 ) ;
...
F_129 ( & V_16 -> V_40 , F_55 ) ;
if ( F_81 ( V_16 ) )
F_130 ( & V_16 -> V_59 , F_63 ,
( unsigned long ) V_16 ) ;
else
F_131 ( & V_16 -> V_59 ) ;
if ( strlen ( args -> V_99 ) > V_173 ) {
F_132 ( V_16 ) ;
return F_89 ( - V_174 ) ;
}
V_16 -> V_99 = F_133 ( args -> V_99 , V_148 ) ;
if ( V_16 -> V_99 == NULL ) {
F_132 ( V_16 ) ;
return F_89 ( - V_136 ) ;
}
...
struct V_15 * F_139 ( struct V_15 * V_16 )
{
if ( F_140 ( & V_16 -> V_162 ) )
return V_16 ;
return NULL ;
