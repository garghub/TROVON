...
V_2 -> V_29 . V_4 = F_1 ;
if ( ! V_2 -> V_18 ) {
F_11 ( V_2 -> V_20 , & V_2 -> V_48 , V_49 , 64 ) ;
F_12 ( & V_2 -> V_48 ) ;
}
return 0 ;
}
void F_13 ( struct V_5 * V_6 , struct V_7 * V_2 )
{
struct V_12 * V_13 = V_6 -> V_13 ;
F_14 ( & V_2 -> V_21 . V_23 ) ;
F_6 ( V_13 -> V_20 , & V_2 -> V_21 , V_2 -> V_16 ) ;
if ( V_6 -> V_13 -> V_20 -> V_34 . V_35 && V_2 -> V_36 )
F_15 ( V_6 -> V_13 -> V_20 , V_2 -> V_36 ) ;
V_2 -> V_36 = 0 ;
V_2 -> V_16 = 0 ;
V_2 -> V_23 = NULL ;
}
void F_16 ( struct V_5 * V_6 , struct V_7 * V_2 )
{
if ( ! V_2 -> V_18 ) {
F_17 ( & V_2 -> V_48 ) ;
F_18 ( & V_2 -> V_48 ) ;
}
F_19 ( V_6 -> V_13 -> V_20 , & V_2 -> V_29 ) ;
}
int F_20 ( struct V_5 * V_6 , struct V_7 * V_2 )
{
return F_21 ( V_6 -> V_13 -> V_20 , & V_2 -> V_29 ,
V_2 -> V_50 , V_2 -> V_51 ) ;
}
int F_22 ( struct V_5 * V_6 , struct V_7 * V_2 )
{
F_23 ( & V_2 -> V_29 , V_52 , V_6 -> V_13 -> V_53 ,
& V_6 -> V_13 -> V_54 ) ;
return 0 ;
}
