...
V_28 -> V_51 = V_52 ;
V_28 -> V_53 = 0xffff ;
V_28 -> V_54 = F_14 ( V_2 -> V_29 ) ;
V_28 -> V_54 = V_28 -> V_54 | ( F_14 ( V_2 -> V_29 ) << 8 ) ;
...
static int F_12 ( unsigned V_22 , unsigned long V_56 ,
unsigned long V_57 )
{
if ( ! V_56 || ! F_20 ( V_56 , V_57 , V_32 ) ) {
F_5 ( V_21 L_12 ,
V_22 , V_56 , V_57 ) ;
return - V_24 ;
}
...
F_21 ( V_28 -> V_54 & 0xFF , V_2 -> V_29 ) ;
F_21 ( V_28 -> V_54 >> 8 , V_2 -> V_29 + 1 ) ;
}
V_60 [ 1 ] = V_28 -> V_54 ;
return 2 ;
}
...
static int T_1 F_22 ( struct V_5 * V_2 ,
const struct V_62
* V_63 )
{
return F_23 ( V_2 , & V_64 ) ;
}
static void T_2 F_24 ( struct V_5 * V_2 )
{
F_25 ( V_2 ) ;
}
