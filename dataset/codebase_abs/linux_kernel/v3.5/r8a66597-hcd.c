...
continue;
F_50 ( & V_100 -> V_65 -> V_65 , L_5 , V_102 ) ;
V_1 -> V_115 |= 1 << V_102 ;
...
if ( ! V_65 )
return;
F_50 ( & V_65 -> V_63 -> V_65 , L_7 , V_65 -> V_68 ) ;
V_65 -> V_107 = V_117 ;
...
struct V_1 * V_1 = F_155 ( V_251 ) ;
int V_13 ;
F_50 ( & V_1 -> V_101 . V_63 -> V_65 , L_20 , V_355 ) ;
for ( V_13 = 0 ; V_13 < V_1 -> V_57 ; V_13 ++ ) {
struct V_198 * V_199 = & V_1 -> V_113 [ V_13 ] ;
unsigned long V_289 = F_157 ( V_13 ) ;
if ( ! ( V_199 -> V_13 & V_216 ) )
continue;
F_50 ( & V_199 -> V_65 -> V_63 -> V_65 , L_21 , V_13 ) ;
F_3 ( V_1 , V_291 , V_289 ) ;
V_199 -> V_13 |= V_356 ;
...
if ( ! ( V_199 -> V_13 & V_356 ) )
continue;
F_50 ( & V_199 -> V_65 -> V_63 -> V_65 , L_22 , V_13 ) ;
V_199 -> V_13 &= ~ V_356 ;
V_199 -> V_13 |= V_359 << 16 ;
...
V_366 = F_199 ( V_363 , V_373 , 0 ) ;
if ( ! V_366 ) {
V_37 = - V_188 ;
F_49 ( & V_363 -> V_65 , L_24 ) ;
goto V_372;
}
V_367 = F_199 ( V_363 , V_374 , 0 ) ;
if ( ! V_367 ) {
V_37 = - V_188 ;
F_49 ( & V_363 -> V_65 ,
L_25 ) ;
...
V_3 = F_200 ( V_366 -> V_375 , F_201 ( V_366 ) ) ;
if ( V_3 == NULL ) {
V_37 = - V_106 ;
...
V_251 = F_202 ( & V_378 , & V_363 -> V_65 , ( char * ) V_379 ) ;
if ( ! V_251 ) {
V_37 = - V_106 ;
...
V_1 -> V_19 = F_203 ( & V_363 -> V_65 , V_364 ) ;
if ( F_204 ( V_1 -> V_19 ) ) {
