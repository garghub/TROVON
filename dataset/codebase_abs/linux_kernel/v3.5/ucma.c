...
static int F_92 ( struct V_1 * V_5 , int V_146 ,
void * V_147 , T_4 V_148 )
{
int V_12 ;
switch ( V_146 ) {
case V_162 :
V_12 = F_89 ( V_5 , V_147 , V_148 ) ;
break;
default:
V_12 = - V_152 ;
}
...
break;
case V_165 :
V_12 = F_92 ( V_5 , V_146 , V_147 , V_148 ) ;
break;
default:
V_12 = - V_152 ;
}
...
V_12 = F_93 ( V_5 , V_65 . V_163 , V_65 . V_146 , V_147 ,
V_65 . V_148 ) ;
V_168:
F_20 ( V_147 ) ;
V_167:
...
if ( F_6 ( V_5 ) )
return F_39 ( V_5 ) ;
V_12 = F_97 ( V_5 -> V_49 , (enum V_170 ) V_65 . V_39 ) ;
F_9 ( V_5 ) ;
return V_12 ;
}
...
V_12 = F_99 ( V_5 -> V_49 , (struct V_92 * ) & V_19 -> V_93 , V_19 ) ;
if ( V_12 )
goto V_87;
V_46 . V_2 = V_19 -> V_2 ;
if ( F_34 ( ( void T_2 * ) ( unsigned long ) V_65 . V_75 ,
...
return 0 ;
V_172:
F_100 ( V_5 -> V_49 , (struct V_92 * ) & V_19 -> V_93 ) ;
F_44 ( V_19 ) ;
V_87:
F_5 ( & V_9 ) ;
F_41 ( & V_20 , V_19 -> V_2 ) ;
...
F_100 ( V_19 -> V_5 -> V_49 , (struct V_92 * ) & V_19 -> V_93 ) ;
...
static void F_103 ( struct V_3 * V_173 , struct V_3 * V_174 )
{
if ( V_173 < V_174 ) {
F_8 ( & V_174 -> V_9 ) ;
F_8 ( & V_173 -> V_9 ) ;
