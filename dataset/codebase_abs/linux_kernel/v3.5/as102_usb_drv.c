...
static void F_27 ( struct V_47 * V_47 )
{
struct V_22 * V_31 ;
F_2 () ;
V_31 = F_28 ( V_47 , struct V_22 , V_47 ) ;
if ( V_31 != NULL ) {
F_29 ( V_31 -> V_2 . V_8 ) ;
F_30 ( V_31 ) ;
}
...
V_31 = F_41 ( sizeof( struct V_22 ) , V_41 ) ;
if ( V_31 == NULL ) {
F_42 ( & V_49 -> V_23 , L_14 , V_30 ) ;
return - V_42 ;
}
for ( V_36 = 0 ; V_36 < F_39 ( V_54 ) ; V_36 ++ ) {
if ( V_53 == & V_54 [ V_36 ] ) {
V_31 -> V_56 = V_55 [ V_36 ] ;
V_31 -> V_57 = V_58 [ V_36 ] ;
}
...
static int F_48 ( struct V_68 * V_68 , struct V_69 * V_69 )
{
int V_7 = 0 , V_70 = 0 ;
