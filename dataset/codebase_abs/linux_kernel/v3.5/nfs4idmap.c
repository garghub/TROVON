...
static int
F_54 ( struct V_64 * V_65 , int type , T_4 V_8 , char * V_9 )
{
struct V_4 * V_49 , V_71 = {
. V_8 = V_8 ,
. type = type ,
...
struct V_54 * V_55 = F_42 ( V_65 -> V_73 -> V_74 , V_56 ) ;
F_3 ( V_71 . V_10 , F_50 ( V_65 ) , sizeof( V_71 . V_10 ) ) ;
V_72 = F_52 ( V_65 , F_26 , & V_71 , V_55 -> V_57 , & V_49 ) ;
if ( V_72 == - V_51 )
...
static bool
F_56 ( struct V_64 * V_65 , int type , const char * V_9 , T_3 V_70 , T_4 * V_8 )
{
int V_72 ;
char V_35 [ 11 ] ;
...
V_35 [ V_70 ] = '\0' ;
V_72 = F_57 ( V_9 , 10 , V_8 ) ;
return V_72 == 0 ;
}
static T_2
F_58 ( struct V_64 * V_65 , int type , const char * V_9 , T_3 V_70 , T_4 * V_8 )
{
if ( V_76 && V_65 -> V_77 . V_78 < V_79 )
if ( F_56 ( V_65 , type , V_9 , V_70 , V_8 ) )
return 0 ;
return F_51 ( V_65 , type , V_9 , V_70 , V_8 ) ;
}
static int
F_59 ( struct V_64 * V_65 , int type , T_4 V_8 , char * V_9 )
{
if ( V_76 && V_65 -> V_77 . V_78 < V_79 )
return sprintf ( V_9 , L_1 , V_8 ) ;
return F_54 ( V_65 , type , V_8 , V_9 ) ;
}
T_2
F_60 ( struct V_64 * V_65 , const char * V_9 , T_5 V_70 ,
T_6 * V_8 )
{
return F_58 ( V_65 , V_45 , V_9 , V_70 , V_8 ) ;
}
T_2
F_61 ( struct V_64 * V_65 , const char * V_9 , T_5 V_70 ,
T_6 * V_8 )
{
return F_58 ( V_65 , V_18 , V_9 , V_70 , V_8 ) ;
}
int
F_62 ( struct V_64 * V_65 , T_6 V_8 , char * V_9 )
{
return F_59 ( V_65 , V_45 , V_8 , V_9 ) ;
}
int
F_63 ( struct V_64 * V_65 , T_6 V_8 , char * V_9 )
{
return F_59 ( V_65 , V_18 , V_8 , V_9 ) ;
}
