...
#endif
if ( V_4 -> V_138 & V_190 ) {
error = F_28 ( NULL , 0 , V_191 , V_126 | V_130 ,
V_131 | V_119 , 0 ) ;
}
#ifdef F_62
F_62 ( V_143 , T_5 ) ;
...
V_83 = V_104 ;
error = - V_161 ;
V_107 = F_34 ( V_81 , V_157 . V_48 , ( char * ) V_83 , V_193 ) ;
if ( V_107 != V_193 )
goto V_165;
...
return 0 ;
if ( V_38 -> V_197 & V_199 ) {
if ( ( V_38 -> V_197 & V_200 ) && F_69 ( V_201 ) )
goto V_196;
if ( ! ( V_38 -> V_197 & V_200 ) && F_69 ( V_202 ) )
goto V_196;
}
...
F_69 ( V_210 ) : F_69 ( V_211 ) )
goto V_196;
return 0 ;
}
if ( V_38 -> V_212 && F_69 ( V_213 ) )
goto V_196;
if ( V_38 -> V_205 == NULL )
return 0 ;
if ( F_69 ( V_214 ) )
...
static int F_74 ( struct V_235 * V_236 )
{
int V_237 ;
V_237 = sizeof( struct V_238 ) ;
V_237 += F_75 ( strlen ( V_236 -> V_239 ) + 1 , 4 ) ;
V_237 += F_75 ( V_236 -> V_240 , 4 ) ;
return V_237 ;
}
static int F_76 ( struct V_81 * V_81 , T_8 * V_241 )
{
static const char V_160 [ 4 ] = { 0 , } ;
F_77 ( V_160 , F_75 ( * V_241 , 4 ) - * V_241 , V_241 ) ;
return 1 ;
}
static int F_78 ( struct V_235 * V_242 , struct V_81 * V_81 ,
T_8 * V_241 )
{
struct V_238 V_236 ;
...
F_77 ( & V_236 , sizeof( V_236 ) , V_241 ) ;
F_77 ( V_242 -> V_239 , V_236 . V_243 , V_241 ) ;
if ( ! F_76 ( V_81 , V_241 ) )
return 0 ;
F_77 ( V_242 -> V_246 , V_242 -> V_240 , V_241 ) ;
if ( ! F_76 ( V_81 , V_241 ) )
return 0 ;
return 1 ;
}
static void F_79 ( struct V_15 * V_247 , int V_248 ,
...
static void F_80 ( struct V_50 * V_264 , int V_237 , T_8 V_265 )
{
V_264 -> V_97 = V_266 ;
V_264 -> V_91 = V_265 ;
V_264 -> V_89 = 0 ;
...
static void F_81 ( struct V_235 * V_269 , const char * V_239 , int type ,
...
static void F_82 ( struct V_270 * V_271 ,
...
F_83 () ;
V_271 -> V_282 = F_84 ( F_85 ( V_19 -> V_283 ) ) ;
F_86 () ;
V_271 -> V_284 = F_84 ( V_19 ) ;
V_271 -> V_285 = F_87 ( V_19 ) ;
V_271 -> V_286 = F_88 ( V_19 ) ;
if ( F_89 ( V_19 ) ) {
struct V_287 V_288 ;
F_90 ( V_19 , & V_288 ) ;
F_91 ( V_288 . V_289 , & V_271 -> V_290 ) ;
F_91 ( V_288 . V_291 , & V_271 -> V_292 ) ;
} else {
F_91 ( V_19 -> V_289 , & V_271 -> V_290 ) ;
F_91 ( V_19 -> V_291 , & V_271 -> V_292 ) ;
}
F_91 ( V_19 -> signal -> V_293 , & V_271 -> V_294 ) ;
F_91 ( V_19 -> signal -> V_295 , & V_271 -> V_296 ) ;
}
static int F_92 ( struct V_297 * V_298 , struct V_272 * V_19 ,
struct V_299 * V_5 )
{
...
V_298 -> V_301 [ V_39 ] = 0 ;
F_83 () ;
V_298 -> V_282 = F_84 ( F_85 ( V_19 -> V_283 ) ) ;
F_86 () ;
V_298 -> V_284 = F_84 ( V_19 ) ;
V_298 -> V_285 = F_87 ( V_19 ) ;
V_298 -> V_286 = F_88 ( V_19 ) ;
V_94 = V_19 -> V_302 ? F_94 ( ~ V_19 -> V_302 ) + 1 : 0 ;
V_298 -> V_303 = V_94 ;
V_298 -> V_304 = ( V_94 > 5 ) ? '.' : L_1 [ V_94 ] ;
V_298 -> V_305 = V_298 -> V_304 == 'Z' ;
V_298 -> V_306 = F_95 ( V_19 ) ;
V_298 -> V_307 = V_19 -> V_136 ;
F_83 () ;
V_36 = F_96 ( V_19 ) ;
F_97 ( V_298 -> V_308 , F_16 ( V_36 -> V_58 , V_36 -> V_59 ) ) ;
F_98 ( V_298 -> V_309 , F_17 ( V_36 -> V_58 , V_36 -> V_63 ) ) ;
F_86 () ;
strncpy ( V_298 -> V_310 , V_19 -> V_311 , sizeof( V_298 -> V_310 ) ) ;
return 0 ;
}
static void F_99 ( struct V_235 * V_269 , struct V_299 * V_5 )
{
...
F_81 ( V_269 , L_2 , V_314 , V_94 * sizeof( T_1 ) , V_312 ) ;
}
static void F_100 ( struct V_272 * V_315 ,
const struct V_316 * V_317 )
{
if ( V_317 -> V_318 )
V_317 -> V_318 ( V_315 , V_317 , 1 ) ;
}
static int F_101 ( struct V_319 * V_320 ,
const struct V_321 * V_322 ,
long V_273 , T_2 * V_323 )
{
unsigned int V_94 ;
F_82 ( & V_320 -> V_271 , V_320 -> V_315 , V_273 ) ;
( void ) V_322 -> V_324 [ 0 ] . F_102 ( V_320 -> V_315 , & V_322 -> V_324 [ 0 ] ,
0 , F_103 ( V_320 -> V_271 . V_325 ) ,
F_104 ( & V_320 -> V_271 ) , NULL ) ;
F_81 ( & V_320 -> V_326 [ 0 ] , L_2 , V_327 ,
F_105 ( V_320 -> V_271 ) , & V_320 -> V_271 ) ;
* V_323 += F_74 ( & V_320 -> V_326 [ 0 ] ) ;
F_100 ( V_320 -> V_315 , & V_322 -> V_324 [ 0 ] ) ;
for ( V_94 = 1 ; V_94 < V_322 -> V_328 ; ++ V_94 ) {
const struct V_316 * V_317 = & V_322 -> V_324 [ V_94 ] ;
F_100 ( V_320 -> V_315 , V_317 ) ;
if ( V_317 -> V_329 && V_317 -> F_102 &&
...
if ( F_50 ( ! V_246 ) )
return 0 ;
V_331 = V_317 -> F_102 ( V_320 -> V_315 , V_317 ,
0 , V_87 , V_246 , NULL ) ;
if ( F_50 ( V_331 ) )
F_35 ( V_246 ) ;
else {
if ( V_317 -> V_329 != V_332 )
F_81 ( & V_320 -> V_326 [ V_94 ] , L_3 ,
V_317 -> V_329 ,
V_87 , V_246 ) ;
else {
F_106 ( & V_320 -> V_271 , 1 ) ;
F_81 ( & V_320 -> V_326 [ V_94 ] , L_2 ,
V_332 , V_87 , V_246 ) ;
}
* V_323 += F_74 ( & V_320 -> V_326 [ V_94 ] ) ;
}
}
}
return 1 ;
}
static int F_107 ( struct V_15 * V_247 , int V_333 ,
struct V_334 * V_335 ,
long V_273 , struct V_142 * V_143 )
{
struct V_272 * V_336 = V_4 ;
const struct V_321 * V_322 = F_108 ( V_336 ) ;
struct V_319 * V_320 ;
struct V_297 * V_298 ;
struct V_337 * V_338 ;
unsigned int V_94 ;
...
if ( V_298 == NULL )
return 0 ;
F_81 ( & V_335 -> V_298 , L_2 , V_340 , sizeof( * V_298 ) , V_298 ) ;
V_335 -> V_341 = 0 ;
...
V_320 = F_110 ( F_111 ( struct V_319 ,
V_326 [ V_335 -> V_341 ] ) ,
V_115 ) ;
if ( F_50 ( ! V_320 ) )
return 0 ;
...
if ( ! F_101 ( V_320 , V_322 , V_273 , & V_335 -> V_87 ) )
return 0 ;
F_92 ( V_298 , V_336 -> V_346 , V_336 -> V_5 ) ;
V_335 -> V_87 += F_74 ( & V_335 -> V_298 ) ;
F_99 ( & V_335 -> V_312 , V_4 -> V_5 ) ;
V_335 -> V_87 += F_74 ( & V_335 -> V_312 ) ;
return 1 ;
}
static T_2 F_112 ( struct V_334 * V_335 )
{
return V_335 -> V_87 ;
}
static int F_113 ( struct V_334 * V_335 ,
...
do {
int V_94 ;
if ( ! F_78 ( & V_320 -> V_326 [ 0 ] , V_81 , V_241 ) )
return 0 ;
if ( V_347 && ! F_78 ( & V_335 -> V_298 , V_81 , V_241 ) )
return 0 ;
if ( V_347 && ! F_78 ( & V_335 -> V_312 , V_81 , V_241 ) )
return 0 ;
for ( V_94 = 1 ; V_94 < V_335 -> V_341 ; ++ V_94 )
if ( V_320 -> V_326 [ V_94 ] . V_246 &&
! F_78 ( & V_320 -> V_326 [ V_94 ] , V_81 , V_241 ) )
return 0 ;
V_347 = 0 ;
V_320 = V_320 -> V_345 ;
} while ( V_320 );
...
static void F_114 ( struct V_334 * V_335 )
{
...
V_348 = V_320 -> V_345 ;
F_109 ( V_320 -> V_326 [ 0 ] . V_246 && V_320 -> V_326 [ 0 ] . V_246 != & V_320 -> V_271 ) ;
for ( V_94 = 1 ; V_94 < V_335 -> V_341 ; ++ V_94 )
...
static int F_115 ( long V_273 , struct V_349 * V_320 )
{
int V_237 = 0 ;
struct V_272 * V_19 = V_320 -> V_339 ;
V_320 -> V_350 = 0 ;
F_82 ( & V_320 -> V_271 , V_19 , V_273 ) ;
F_116 ( V_19 , & V_320 -> V_271 . V_325 ) ;
F_81 ( & V_320 -> V_326 [ 0 ] , L_2 , V_327 , sizeof( V_320 -> V_271 ) ,
& ( V_320 -> V_271 ) ) ;
V_320 -> V_350 ++ ;
V_237 += F_74 ( & V_320 -> V_326 [ 0 ] ) ;
if ( ( V_320 -> V_271 . V_351 = F_117 ( V_19 , NULL ,
& V_320 -> V_352 ) ) ) {
F_81 ( & V_320 -> V_326 [ 1 ] , L_2 , V_332 , sizeof( V_320 -> V_352 ) ,
& ( V_320 -> V_352 ) ) ;
V_320 -> V_350 ++ ;
V_237 += F_74 ( & V_320 -> V_326 [ 1 ] ) ;
}
#ifdef F_118
if ( F_119 ( V_19 , & V_320 -> V_353 ) ) {
F_81 ( & V_320 -> V_326 [ 2 ] , L_3 , V_354 ,
sizeof( V_320 -> V_353 ) , & V_320 -> V_353 ) ;
V_320 -> V_350 ++ ;
V_237 += F_74 ( & V_320 -> V_326 [ 2 ] ) ;
}
#endif
return V_237 ;
}
static int F_120 ( struct V_334 * V_335 )
{
...
V_361 = F_110 ( sizeof( * V_361 ) , V_115 ) ;
if ( ! V_361 )
return 0 ;
V_361 -> V_339 = V_338 -> V_315 ;
F_122 ( & V_361 -> V_362 , & V_335 -> V_355 ) ;
}
F_123 (t, &info->thread_list) {
int V_237 ;
V_361 = F_124 ( V_320 , struct V_349 , V_362 ) ;
V_237 = F_115 ( V_273 , V_361 ) ;
V_335 -> V_363 += V_237 ;
}
}
memset ( V_335 -> V_271 , 0 , sizeof( * V_335 -> V_271 ) ) ;
F_82 ( V_335 -> V_271 , V_4 , V_273 ) ;
F_125 ( & V_335 -> V_271 -> V_325 , V_143 ) ;
F_79 ( V_247 , V_333 , V_364 , V_365 , V_258 ) ;
F_81 ( V_335 -> V_326 + 0 , L_2 , V_327 ,
sizeof( * V_335 -> V_271 ) , V_335 -> V_271 ) ;
F_92 ( V_335 -> V_298 , V_4 -> V_346 , V_4 -> V_5 ) ;
F_81 ( V_335 -> V_326 + 1 , L_2 , V_340 ,
sizeof( * V_335 -> V_298 ) , V_335 -> V_298 ) ;
V_335 -> V_366 = 2 ;
F_99 ( & V_335 -> V_326 [ V_335 -> V_366 ++ ] , V_4 -> V_5 ) ;
V_335 -> V_271 -> V_351 = F_117 ( V_4 , V_143 ,
V_335 -> V_352 ) ;
if ( V_335 -> V_271 -> V_351 )
F_81 ( V_335 -> V_326 + V_335 -> V_366 ++ ,
L_2 , V_332 , sizeof( * V_335 -> V_352 ) , V_335 -> V_352 ) ;
#ifdef F_118
if ( F_119 ( V_4 , V_335 -> V_353 ) )
F_81 ( V_335 -> V_326 + V_335 -> V_366 ++ ,
L_3 , V_354 ,
...
struct V_360 * V_320 ;
for ( V_94 = 0 ; V_94 < V_335 -> V_366 ; V_94 ++ )
if ( ! F_78 ( V_335 -> V_326 + V_94 , V_81 , V_241 ) )
return 0 ;
F_123 (t, &info->thread_list) {
struct V_349 * V_367 =
F_124 ( V_320 , struct V_349 , V_362 ) ;
for ( V_94 = 0 ; V_94 < V_367 -> V_350 ; V_94 ++ )
if ( ! F_78 ( & V_367 -> V_326 [ V_94 ] , V_81 , V_241 ) )
return 0 ;
}
return 1 ;
}
static void F_114 ( struct V_334 * V_335 )
{
while ( ! F_126 ( & V_335 -> V_355 ) ) {
struct V_360 * V_367 = V_335 -> V_355 . V_345 ;
F_127 ( V_367 ) ;
F_35 ( F_124 ( V_367 , struct V_349 , V_362 ) ) ;
}
F_35 ( V_335 -> V_271 ) ;
F_35 ( V_335 -> V_298 ) ;
F_35 ( V_335 -> V_326 ) ;
...
static struct V_37 * F_128 ( struct V_272 * V_368 ,
struct V_37 * V_369 )
{
...
static struct V_37 * F_129 ( struct V_37 * V_370 ,
struct V_37 * V_369 )
{
struct V_37 * V_331 ;
V_331 = V_370 -> V_371 ;
...
static void F_130 ( struct V_15 * V_247 , struct V_372 * V_373 ,
T_1 V_374 , int V_248 )
{
V_247 -> V_374 = V_374 ;
...
static T_2 F_131 ( struct V_37 * V_369 ,
unsigned long V_195 )
{
struct V_37 * V_38 ;
T_2 V_87 = 0 ;
for ( V_38 = F_128 ( V_4 , V_369 ) ; V_38 != NULL ;
V_38 = F_129 ( V_38 , V_369 ) )
V_87 += F_68 ( V_38 , V_195 ) ;
return V_87 ;
}
static int F_132 ( struct V_384 * V_385 )
{
int V_386 = 0 ;
T_7 V_221 ;
int V_248 ;
...
if ( ! F_107 ( V_247 , V_52 , & V_335 , V_385 -> V_273 , V_385 -> V_143 ) )
goto V_391;
V_386 = 1 ;
V_4 -> V_136 |= V_392 ;
V_221 = F_70 () ;
...
V_241 = V_265 ;
{
T_2 V_237 = F_112 ( & V_335 ) ;
V_237 += F_134 () ;
V_388 = F_33 ( sizeof( * V_388 ) , V_115 ) ;
if ( ! V_388 )
goto V_394;
F_80 ( V_388 , V_237 , V_265 ) ;
V_265 += V_237 ;
}
V_387 = V_265 = F_75 ( V_265 , V_44 ) ;
V_265 += F_131 ( V_369 , V_385 -> V_195 ) ;
V_265 += F_135 () ;
V_374 = V_265 ;
if ( V_52 == V_390 ) {
...
if ( ! V_373 )
goto V_394;
F_130 ( V_247 , V_373 , V_374 , V_248 ) ;
}
V_265 = V_387 ;
V_87 += sizeof( * V_247 ) ;
if ( V_87 > V_385 -> V_395 || ! F_136 ( V_385 -> V_81 , V_247 , sizeof( * V_247 ) ) )
goto V_394;
V_87 += sizeof( * V_388 ) ;
if ( V_87 > V_385 -> V_395
|| ! F_136 ( V_385 -> V_81 , V_388 , sizeof( * V_388 ) ) )
goto V_394;
for ( V_38 = F_128 ( V_4 , V_369 ) ; V_38 != NULL ;
V_38 = F_129 ( V_38 , V_369 ) ) {
struct V_50 V_264 ;
V_264 . V_97 = V_98 ;
V_264 . V_91 = V_265 ;
V_264 . V_89 = V_38 -> V_219 ;
V_264 . V_267 = 0 ;
V_264 . V_88 = F_68 ( V_38 , V_385 -> V_195 ) ;
...
V_87 += sizeof( V_264 ) ;
if ( V_87 > V_385 -> V_395
|| ! F_136 ( V_385 -> V_81 , & V_264 , sizeof( V_264 ) ) )
goto V_394;
}
if ( ! F_137 ( V_385 -> V_81 , V_265 , & V_87 , V_385 -> V_395 ) )
goto V_394;
if ( ! F_113 ( & V_335 , V_385 -> V_81 , & V_241 ) )
goto V_394;
if ( F_138 ( V_385 -> V_81 , & V_241 ) )
goto V_394;
if ( ! F_139 ( V_385 -> V_81 , V_387 - V_241 ) )
goto V_394;
for ( V_38 = F_128 ( V_4 , V_369 ) ; V_38 != NULL ;
V_38 = F_129 ( V_38 , V_369 ) ) {
unsigned long V_3 ;
unsigned long V_2 ;
V_2 = V_38 -> V_219 + F_68 ( V_38 , V_385 -> V_195 ) ;
for ( V_3 = V_38 -> V_219 ; V_3 < V_2 ; V_3 += V_191 ) {
struct V_398 * V_398 ;
int V_399 ;
V_398 = F_140 ( V_3 ) ;
if ( V_398 ) {
void * V_400 = F_141 ( V_398 ) ;
V_399 = ( ( V_87 += V_191 ) > V_385 -> V_395 ) ||
! F_136 ( V_385 -> V_81 , V_400 ,
V_191 ) ;
F_142 ( V_398 ) ;
F_143 ( V_398 ) ;
} else
V_399 = ! F_139 ( V_385 -> V_81 , V_191 ) ;
if ( V_399 )
goto V_394;
}
}
if ( ! F_144 ( V_385 -> V_81 , & V_87 , V_385 -> V_395 ) )
goto V_394;
if ( V_52 == V_390 ) {
V_87 += sizeof( * V_373 ) ;
if ( V_87 > V_385 -> V_395
|| ! F_136 ( V_385 -> V_81 , V_373 ,
sizeof( * V_373 ) ) )
goto V_394;
}
V_394:
