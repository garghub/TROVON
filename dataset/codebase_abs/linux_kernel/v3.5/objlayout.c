...
static void F_25 ( struct V_11 * V_28 ,
...
F_5 ( L_10 , V_8 ) ;
V_69 = F_36 ( V_67 , struct V_68 , V_72 . V_73 ) ;
V_90 = F_36 ( V_69 , struct V_89 , V_69 ) ;
F_45 ( V_90 ) ;
}
void
...
F_39 ( & V_90 -> V_69 . V_72 . V_73 , F_44 ) ;
F_40 ( & V_90 -> V_69 . V_72 . V_73 ) ;
}
}
enum V_81
F_47 ( struct V_89 * V_90 ,
int V_93 )
{
struct V_82 * V_83 = V_90 -> V_78 ;
int V_32 ;
F_25 ( V_83 -> V_28 , & V_90 -> args . V_21 ,
& V_90 -> args . V_85 ,
...
( F_53 ( V_120 -> V_62 ) > F_53 ( V_119 -> V_62 ) ) ) {
...
V_138 . V_142 = V_30 ;
V_138 . V_143 = 0 ;
V_32 = F_63 ( F_64 ( V_12 -> V_144 ) , & V_138 ) ;
F_5 ( L_24 , V_8 , V_32 ) ;
if ( V_32 )
goto V_145;
V_104 = F_15 ( V_26 ) ;
...
void F_66 ( struct V_133 * V_134 )
{
struct V_135 * V_136 = F_36 ( V_134 ,
struct V_135 ,
V_146 ) ;
F_18 ( V_136 -> V_26 ) ;
F_10 ( V_136 ) ;
}
static int F_67 ( struct V_147 * V_148 )
{
...
V_150 [ 6 ] = V_148 -> V_156 ;
V_150 [ 7 ] = NULL ;
V_151 = F_68 ( V_150 [ 0 ] , V_150 , V_149 , V_157 ) ;
...
static void F_71 ( struct V_159 V_160 ,
char V_165 [ V_166 ] )
{
int V_125 ;
char * V_167 ;
...
V_167 = F_72 ( V_167 , V_160 . V_164 [ V_125 ] ) ;
}
int F_73 ( struct V_133 * V_134 )
{
int V_169 ;
struct V_147 V_148 ;
