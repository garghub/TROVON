...
static bool F_63 ( struct V_52 * V_53 , void * V_103 )
{
V_53 -> V_104 = V_103 ;
return true ;
}
...
return;
V_2 -> V_61 = V_108 -> V_61 ;
if ( V_108 -> V_111 && V_108 -> V_112 ) {
F_65 ( V_110 ) ;
F_66 ( V_113 , V_110 ) ;
V_2 -> V_114 . V_115 = V_108 -> V_111 ;
V_2 -> V_83 = F_67 ( V_110 , F_63 ,
& V_2 -> V_114 ) ;
if ( V_2 -> V_83 )
F_68 ( & V_106 -> V_44 , L_3 ) ;
}
...
F_65 ( V_110 ) ;
F_66 ( V_113 , V_110 ) ;
V_2 -> V_116 . V_115 = V_108 -> V_112 ;
V_2 -> V_64 = F_67 ( V_110 , F_63 ,
& V_2 -> V_116 ) ;
if ( V_2 -> V_64 )
F_68 ( & V_106 -> V_44 , L_4 ) ;
}
}
static void T_6 F_69 ( struct V_1 * V_2 )
{
if ( V_2 -> V_64 )
F_70 ( V_2 -> V_64 ) ;
if ( V_2 -> V_83 )
...
static int T_6 F_71 ( struct V_105 * V_106 )
{
struct V_1 * V_2 = F_72 ( & V_106 -> V_44 ) ;
F_73 ( V_2 -> V_43 ) ;
F_69 ( V_2 ) ;
F_74 ( F_75 ( V_106 , 0 ) , V_2 ) ;
F_76 ( V_2 -> V_8 ) ;
F_77 ( V_2 -> V_5 ) ;
F_78 ( V_2 -> V_43 ) ;
return 0 ;
}
static int T_4 F_79 ( struct V_105 * V_106 )
{
struct V_117 * V_118 ;
struct V_119 * V_43 ;
struct V_1 * V_2 ;
...
V_43 = F_82 ( & V_106 -> V_44 , sizeof( struct V_1 ) ) ;
if ( V_43 == NULL ) {
F_21 ( & V_106 -> V_44 , L_7 ) ;
return - V_63 ;
}
...
F_83 ( & V_106 -> V_44 , V_2 ) ;
V_2 -> V_43 = V_43 ;
V_2 -> V_5 = F_84 ( V_118 -> V_124 , F_85 ( V_118 ) ) ;
if ( V_2 -> V_5 == NULL ) {
F_21 ( & V_106 -> V_44 , L_8 ) ;
V_15 = - V_63 ;
goto V_125;
}
snprintf ( V_120 , sizeof( V_120 ) , L_9 , V_106 -> V_126 ) ;
V_2 -> V_8 = F_86 ( & V_106 -> V_44 , V_120 ) ;
if ( F_87 ( V_2 -> V_8 ) ) {
F_21 ( & V_106 -> V_44 , L_10 ) ;
V_15 = F_88 ( V_2 -> V_8 ) ;
goto V_127;
}
F_89 ( V_2 -> V_8 ) ;
...
F_93 ( & V_2 -> V_18 ) ;
V_43 -> V_128 = 2 ;
V_43 -> V_129 = V_106 -> V_126 ;
V_43 -> V_130 = F_55 ;
V_43 -> V_131 = F_57 ;
V_43 -> V_132 = F_60 ;
V_15 = F_94 ( V_72 , F_61 , 0 , F_95 ( & V_106 -> V_44 ) , V_2 ) ;
if ( V_15 < 0 ) {
F_21 ( & V_106 -> V_44 , L_11 ) ;
goto V_133;
}
V_2 -> V_72 = V_72 ;
F_64 ( V_2 , V_106 ) ;
V_15 = F_96 ( V_43 ) ;
if ( V_15 < 0 ) {
F_21 ( & V_106 -> V_44 , L_12 ) ;
goto V_134;
}
F_68 ( & V_106 -> V_44 , L_13 ) ;
return 0 ;
V_134:
F_69 ( V_2 ) ;
F_74 ( V_72 , V_2 ) ;
