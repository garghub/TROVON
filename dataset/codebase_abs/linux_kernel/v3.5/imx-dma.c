...
V_11 -> V_172 = F_75 ( NULL , L_26 ) ;
if ( F_76 ( V_11 -> V_172 ) )
return F_77 ( V_11 -> V_172 ) ;
F_78 ( V_11 -> V_172 ) ;
F_6 ( V_11 , V_173 , V_174 ) ;
if ( F_71 () ) {
V_168 = F_79 ( V_175 , F_36 , 0 , L_27 , V_11 ) ;
if ( V_168 ) {
F_44 ( V_11 -> V_26 , L_28 ) ;
F_60 ( V_11 ) ;
return V_168 ;
}
V_168 = F_79 ( V_176 , F_29 , 0 , L_27 , V_11 ) ;
if ( V_168 ) {
F_44 ( V_11 -> V_26 , L_29 ) ;
F_80 ( V_175 , NULL ) ;
F_60 ( V_11 ) ;
...
F_6 ( V_11 , V_177 , V_174 ) ;
F_6 ( V_11 , ( 1 << V_49 ) - 1 , V_29 ) ;
F_6 ( V_11 , ( 1 << V_49 ) - 1 , V_30 ) ;
F_61 ( & V_11 -> V_178 . V_179 ) ;
F_81 ( V_180 , V_11 -> V_178 . V_181 ) ;
F_81 ( V_182 , V_11 -> V_178 . V_181 ) ;
F_81 ( V_183 , V_11 -> V_178 . V_181 ) ;
F_81 ( V_184 , V_11 -> V_178 . V_181 ) ;
for ( V_41 = 0 ; V_41 < V_61 ; V_41 ++ )
...
V_11 -> V_178 . V_26 = & V_167 -> V_26 ;
V_11 -> V_178 . V_190 = F_53 ;
V_11 -> V_178 . V_191 = F_58 ;
V_11 -> V_178 . V_192 = F_49 ;
V_11 -> V_178 . V_193 = F_62 ;
V_11 -> V_178 . V_194 = F_64 ;
V_11 -> V_178 . V_195 = F_67 ;
V_11 -> V_178 . V_196 = F_68 ;
V_11 -> V_178 . V_197 = F_45 ;
V_11 -> V_178 . V_198 = F_69 ;
F_86 ( V_167 , V_11 ) ;
V_11 -> V_178 . V_199 = 2 ;
V_11 -> V_178 . V_26 -> V_200 = & V_11 -> V_200 ;
F_87 ( V_11 -> V_178 . V_26 , 0xffffff ) ;
V_168 = F_88 ( & V_11 -> V_178 ) ;
if ( V_168 ) {
F_40 ( & V_167 -> V_26 , L_32 ) ;
goto V_186;
}
return 0 ;
V_186:
...
static int T_7 F_89 ( struct V_166 * V_167 )
{
struct V_10 * V_11 = F_90 ( V_167 ) ;
int V_41 ;
F_91 ( & V_11 -> V_178 ) ;
if ( F_22 () || F_11 () ) {
for ( V_41 = 0 ; V_41 < V_49 ; V_41 ++ )
