...
struct V_9 * V_10 = F_4 ( & V_2 -> V_11 -> V_12 ) ;
int V_20 ;
for ( V_20 = 0 ; V_16 [ V_20 ] . V_17 ; V_20 ++ ) {
if ( ( V_16 [ V_20 ] . V_17 & 0xffff ) != V_3 )
continue;
F_6 ( V_2 , V_20 , V_4 ) ;
return 0 ;
}
F_7 ( & V_10 -> V_14 , L_3 , V_3 ) ;
return - V_21 ;
}
...
if ( ! V_2 -> V_24 . V_25 )
return false ;
V_23 = V_2 -> V_24 . V_25 -> V_7 ;
if ( ! V_23 )
return false ;
while ( V_23 -> type ) {
T_1 type = V_3 >> 16 ;
T_1 V_26 = V_3 ;
if ( V_23 -> type != type || V_23 -> V_3 != V_26 ) {
V_23 ++ ;
continue;
}
switch ( ( T_2 ) type ) {
