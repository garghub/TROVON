...
static int F_29 ( struct V_46 * V_47 , int V_48 ,
void T_1 * V_49 , T_2 * V_50 , T_3 * V_51 )
{
int V_4 ;
if ( V_48 && ! F_30 ( V_39 ) )
return - V_40 ;
V_4 = F_31 ( V_47 , V_48 , V_49 , V_50 , V_51 ) ;
if ( V_4 )
return V_4 ;
if ( V_48 && * ( int * ) V_47 -> V_52 == * ( int * ) V_47 -> V_53 )
V_47 -> V_54 = V_47 -> V_53 ;
return V_4 ;
}
