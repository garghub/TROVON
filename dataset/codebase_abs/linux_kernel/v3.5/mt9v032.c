...
static int F_14 ( struct V_1 * V_1 , bool V_24 )
{
struct V_5 * V_6 = F_9 ( & V_1 -> V_4 ) ;
int V_15 ;
if ( ! V_24 ) {
...
static int F_20 ( struct V_2 * V_4 , int V_18 )
{
const T_3 V_40 = V_41
| V_42
| V_43 ;
...
int V_15 ;
if ( ! V_18 )
return F_8 ( V_1 , V_40 , 0 ) ;
V_44 = F_21 ( V_39 -> V_46 , V_37 -> V_46 ) ;
V_45 = F_21 ( V_39 -> V_47 , V_37 -> V_47 ) ;
V_15 = F_6 ( V_6 , V_48 ,
( V_44 - 1 ) << V_49 |
( V_45 - 1 ) << V_50 ) ;
if ( V_15 < 0 )
return V_15 ;
V_15 = F_6 ( V_6 , V_51 , V_39 -> V_52 ) ;
if ( V_15 < 0 )
return V_15 ;
V_15 = F_6 ( V_6 , V_53 , V_39 -> V_54 ) ;
if ( V_15 < 0 )
return V_15 ;
V_15 = F_6 ( V_6 , V_55 , V_39 -> V_46 ) ;
if ( V_15 < 0 )
return V_15 ;
V_15 = F_6 ( V_6 , V_56 , V_39 -> V_47 ) ;
if ( V_15 < 0 )
return V_15 ;
V_15 = F_6 ( V_6 , V_57 ,
F_22 ( 43 , 660 - V_39 -> V_46 ) ) ;
if ( V_15 < 0 )
return V_15 ;
return F_8 ( V_1 , 0 , V_40 ) ;
}
...
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
V_37 -> V_37 = * F_16 ( V_1 , V_32 , V_37 -> V_33 ,
V_37 -> V_17 ) ;
return 0 ;
}
...
unsigned int V_44 ;
unsigned int V_45 ;
V_73 = F_18 ( V_1 , V_32 , V_37 -> V_33 ,
V_37 -> V_17 ) ;
V_46 = F_27 (unsigned int, ALIGN(format->format.width, 2),
max(__crop->width / 8, MT9V032_WINDOW_WIDTH_MIN),
__crop->width) ;
V_47 = F_27 (unsigned int, ALIGN(format->format.height, 2),
max(__crop->height / 8, MT9V032_WINDOW_HEIGHT_MIN),
__crop->height) ;
V_44 = F_21 ( V_73 -> V_46 , V_46 ) ;
V_45 = F_21 ( V_73 -> V_47 , V_47 ) ;
V_72 = F_16 ( V_1 , V_32 , V_37 -> V_33 ,
V_37 -> V_17 ) ;
...
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
V_39 -> V_75 = * F_18 ( V_1 , V_32 , V_39 -> V_33 ,
V_39 -> V_17 ) ;
return 0 ;
}
...
struct V_38 * V_73 ;
struct V_38 V_75 ;
V_75 . V_52 = F_30 ( F_31 ( V_39 -> V_75 . V_52 + 1 , 2 ) - 1 ,
V_76 ,
V_77 ) ;
V_75 . V_54 = F_30 ( F_31 ( V_39 -> V_75 . V_54 + 1 , 2 ) - 1 ,
V_78 ,
V_79 ) ;
V_75 . V_46 = F_30 ( F_31 ( V_39 -> V_75 . V_46 , 2 ) ,
V_80 ,
V_81 ) ;
V_75 . V_47 = F_30 ( F_31 ( V_39 -> V_75 . V_47 , 2 ) ,
V_82 ,
V_83 ) ;
V_75 . V_46 = F_32 ( V_75 . V_46 , V_84 - V_75 . V_52 ) ;
V_75 . V_47 = F_32 ( V_75 . V_47 , V_85 - V_75 . V_54 ) ;
V_73 = F_18 ( V_1 , V_32 , V_39 -> V_33 , V_39 -> V_17 ) ;
if ( V_75 . V_46 != V_73 -> V_46 || V_75 . V_47 != V_73 -> V_47 ) {
V_72 = F_16 ( V_1 , V_32 , V_39 -> V_33 ,
V_39 -> V_17 ) ;
V_72 -> V_46 = V_75 . V_46 ;
V_72 -> V_47 = V_75 . V_47 ;
}
...
switch ( V_87 -> V_89 ) {
case V_90 :
return F_10 ( V_1 , V_91 ,
V_87 -> V_92 ) ;
case V_93 :
return F_6 ( V_6 , V_94 , V_87 -> V_92 ) ;
case V_95 :
return F_10 ( V_1 , V_96 ,
! V_87 -> V_92 ) ;
case V_97 :
return F_6 ( V_6 , V_98 ,
V_87 -> V_92 ) ;
...
return F_6 ( V_6 , V_107 , V_8 ) ;
}
return 0 ;
}
static int F_34 ( struct V_2 * V_4 , int V_24 )
{
struct V_1 * V_1 = F_1 ( V_4 ) ;
int V_15 = 0 ;
F_35 ( & V_1 -> V_108 ) ;
...
static int F_41 ( struct V_2 * V_4 , struct V_31 * V_32 )
{
struct V_30 * V_37 ;
struct V_38 * V_39 ;
V_39 = F_19 ( V_32 , 0 ) ;
...
V_1 = F_46 ( sizeof( * V_1 ) , V_128 ) ;
if ( ! V_1 )
return - V_129 ;
F_47 ( & V_1 -> V_108 ) ;
V_1 -> V_21 = V_6 -> V_9 . V_130 ;
F_48 ( & V_1 -> V_29 , F_49 ( V_131 ) + 4 ) ;
F_50 ( & V_1 -> V_29 , & V_132 ,
V_90 , 0 , 1 , 1 , 1 ) ;
F_50 ( & V_1 -> V_29 , & V_132 ,
V_93 , V_133 ,
...
V_139 , 1 ,
V_140 ) ;
for ( V_124 = 0 ; V_124 < F_49 ( V_131 ) ; ++ V_124 )
F_52 ( & V_1 -> V_29 , & V_131 [ V_124 ] , NULL ) ;
...
V_1 -> V_19 = V_96 | V_91 ;
F_54 ( & V_1 -> V_4 , V_6 , & V_143 ) ;
V_1 -> V_4 . V_144 = & V_145 ;
V_1 -> V_4 . V_146 |= V_147 ;
V_1 -> V_33 . V_146 = V_148 ;
V_15 = F_55 ( & V_1 -> V_4 . V_149 , 1 , & V_1 -> V_33 , 0 ) ;
if ( V_15 < 0 )
F_56 ( V_1 ) ;
return V_15 ;
}
