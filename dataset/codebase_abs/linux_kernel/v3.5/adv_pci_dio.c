...
for ( V_154 = V_156 , V_155 = NULL ; V_154 != NULL ; V_155 = V_154 , V_154 = V_154 -> V_157 ) {
if ( V_154 -> V_152 == V_152 )
return 0 ;
}
if ( V_155 ) {
V_50 -> V_155 = V_155 ;
...
{
struct V_3 * V_4 ;
int V_23 , V_125 , V_158 , V_11 , V_159 ;
unsigned long V_13 ;
struct V_151 * V_152 = NULL ;
V_23 = F_37 ( V_2 , sizeof( struct V_153 ) ) ;
if ( V_23 < 0 )
return - V_160 ;
F_38 (pcidev) {
for ( V_11 = 0 ; V_11 < F_39 ( V_161 ) ; ++ V_11 ) {
if ( V_161 [ V_11 ] . V_162 != V_152 -> V_163 )
continue;
if ( V_161 [ V_11 ] . V_164 != V_152 -> V_165 )
continue;
if ( V_124 -> V_166 [ 0 ] || V_124 -> V_166 [ 1 ] ) {
if ( V_152 -> V_167 -> V_168 != V_124 -> V_166 [ 0 ] ||
F_40 ( V_152 -> V_169 ) != V_124 -> V_166 [ 1 ] ) {
continue;
}
}
V_23 = F_35 ( V_2 , V_124 , V_152 ) ;
if ( V_23 != 1 )
continue;
V_2 -> V_170 = V_161 + V_11 ;
break;
}
if ( V_2 -> V_170 )
break;
...
if ( F_42 ( V_152 , V_2 -> V_173 -> V_174 ) ) {
F_41 ( V_2 -> V_171 , L_6 ) ;
return - V_172 ;
}
V_13 = F_43 ( V_152 , V_74 -> V_175 ) ;
F_44 ( V_2 -> V_171 , L_7 ,
V_152 -> V_167 -> V_168 , F_40 ( V_152 -> V_169 ) ,
F_45 ( V_152 -> V_169 ) , V_13 ) ;
V_2 -> V_13 = V_13 ;
V_2 -> V_176 = V_74 -> V_177 ;
if ( V_74 -> V_75 == V_120 ) {
V_158 = 4 ;
} else {
V_158 = 0 ;
for ( V_11 = 0 ; V_11 < V_178 ; V_11 ++ )
if ( V_74 -> V_179 [ V_11 ] . V_146 )
V_158 ++ ;
for ( V_11 = 0 ; V_11 < V_180 ; V_11 ++ )
if ( V_74 -> V_181 [ V_11 ] . V_146 )
V_158 ++ ;
for ( V_11 = 0 ; V_11 < V_182 ; V_11 ++ )
V_158 += V_74 -> V_183 [ V_11 ] . V_12 ;
if ( V_74 -> V_184 . V_146 )
V_158 ++ ;
for ( V_11 = 0 ; V_11 < V_185 ; V_11 ++ )
if ( V_74 -> V_186 [ V_11 ] . V_146 )
V_158 ++ ;
}
V_23 = F_46 ( V_2 , V_158 ) ;
if ( V_23 < 0 )
...
if ( V_74 -> V_179 [ V_11 ] . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
F_32 ( V_2 , V_4 , & V_74 -> V_179 [ V_11 ] , V_125 ) ;
V_125 ++ ;
}
for ( V_11 = 0 ; V_11 < V_180 ; V_11 ++ )
if ( V_74 -> V_181 [ V_11 ] . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
F_33 ( V_2 , V_4 , & V_74 -> V_181 [ V_11 ] , V_125 ) ;
V_125 ++ ;
}
for ( V_11 = 0 ; V_11 < V_182 ; V_11 ++ )
for ( V_159 = 0 ; V_159 < V_74 -> V_183 [ V_11 ] . V_12 ; V_159 ++ ) {
V_4 = V_2 -> V_126 + V_125 ;
F_47 ( V_2 , V_4 , NULL ,
V_2 -> V_13 +
V_74 -> V_183 [ V_11 ] . V_14 +
V_187 * V_159 ) ;
V_125 ++ ;
}
if ( V_74 -> V_184 . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
V_4 -> type = V_127 ;
F_32 ( V_2 , V_4 , & V_74 -> V_184 , V_125 ) ;
V_125 ++ ;
}
for ( V_11 = 0 ; V_11 < V_185 ; V_11 ++ )
if ( V_74 -> V_186 [ V_11 ] . V_146 ) {
V_4 = V_2 -> V_126 + V_125 ;
F_34 ( V_2 , V_4 , & V_74 -> V_186 [ V_11 ] , V_125 ) ;
V_125 ++ ;
}
if ( V_74 -> V_75 == V_120 )
F_31 ( V_2 , V_124 ) ;
...
if ( V_74 -> V_186 [ V_11 ] . V_146 )
V_125 ++ ;
for ( V_11 = 0 ; V_11 < V_2 -> V_158 ; V_11 ++ ) {
V_4 = V_2 -> V_126 + V_11 ;
V_4 -> V_10 = NULL ;
}
if ( V_50 -> V_152 ) {
...
if ( V_50 -> V_155 )
V_50 -> V_155 -> V_157 = V_50 -> V_157 ;
else
V_156 = V_50 -> V_157 ;
if ( V_50 -> V_157 )
V_50 -> V_157 -> V_155 = V_50 -> V_155 ;
}
}
static int T_1 F_52 ( struct V_151 * V_2 ,
const struct V_189 * V_190 )
{
return F_53 ( V_2 , & V_191 ) ;
}
