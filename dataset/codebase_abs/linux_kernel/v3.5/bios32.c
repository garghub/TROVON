...
static int F_26 ( const struct V_5 * V_6 , T_6 V_69 , T_6 V_65 )
{
struct V_66 * V_67 = V_6 -> V_68 ;
int V_32 = - 1 ;
if ( V_67 -> V_72 )
...
static void T_5 F_27 ( struct V_73 * V_74 , struct V_12 * V_75 )
{
...
void T_5 F_37 ( struct V_73 * V_74 )
{
struct V_66 * V_67 ;
F_38 ( V_75 ) ;
F_39 ( V_91 ) ;
...
char * T_5 F_47 ( char * V_95 )
{
if ( ! strcmp ( V_95 , L_10 ) ) {
V_33 = 1 ;
return NULL ;
} else if ( ! strcmp ( V_95 , L_11 ) ) {
F_39 ( V_94 ) ;
return NULL ;
}
return V_95 ;
}
T_7 F_48 ( void * V_96 , const struct V_18 * V_97 ,
T_7 V_98 , T_7 V_99 )
{
T_7 V_20 = V_97 -> V_20 ;
if ( V_97 -> V_25 & V_100 && V_20 & 0x300 )
V_20 = ( V_20 + 0x3ff ) & ~ 0x3ff ;
V_20 = ( V_20 + V_99 - 1 ) & ~ ( V_99 - 1 ) ;
return V_20 ;
}
int F_49 ( struct V_5 * V_6 , int V_101 )
{
T_2 V_57 , V_102 ;
int V_103 ;
struct V_18 * V_26 ;
...
int F_50 ( struct V_5 * V_6 , struct V_109 * V_110 ,
enum V_111 V_112 , int V_113 )
{
struct V_66 * V_114 = V_6 -> V_68 ;
unsigned long V_115 ;
if ( V_112 == V_116 ) {
return - V_105 ;
} else {
V_115 = V_110 -> V_117 + ( V_114 -> V_87 >> V_118 ) ;
}
V_110 -> V_119 = F_51 ( V_110 -> V_119 ) ;
if ( F_52 ( V_110 , V_110 -> V_120 , V_115 ,
V_110 -> V_121 - V_110 -> V_120 ,
V_110 -> V_119 ) )
return - V_122 ;
return 0 ;
}
