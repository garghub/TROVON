...
F_26 ( V_78 -> V_103 , F_20 ( V_71 -> V_22 ) , 1 ) ;
V_102 = F_14 ( V_78 ) ;
...
static inline bool F_29 ( const struct V_25 * V_66 )
{
static const struct V_25 V_114 ;
return memcmp ( V_66 , & V_114 , sizeof( V_114 ) ) == 0 ;
}
static int F_30 ( const struct V_90 * V_115 ,
...
static inline int F_32 ( const struct V_77 * V_78 , const char * V_94 )
{
const struct V_76 * V_102 ;
if ( ! F_10 ( & V_78 -> V_66 ) ) {
F_11 ( L_27 , V_78 , V_94 ) ;
...
static inline int F_33 ( struct V_77 * V_78 , const char * V_94 )
{
...
V_10 = F_34 ( & V_73 , V_102 -> V_104 . V_131 - sizeof( * V_102 ) , 0 , false ) ;
if ( V_10 < 0 ) {
F_11 ( L_28 ,
...
static inline int
F_35 ( struct V_77 * V_78 , const char * V_94 , unsigned int V_126 )
{
struct V_76 * V_102 ;
struct V_135 * V_106 ;
int V_10 ;
...
return V_10 ;
V_102 = F_15 ( V_78 ) ;
V_106 = F_36 ( V_100 , V_102 -> V_104 . V_123 . V_94 ,
...
return 0 ;
V_137:
F_39 ( V_102 -> V_104 . V_105 . V_106 -> V_138 ) ;
V_83:
return V_10 ;
}
static bool F_40 ( const struct V_77 * V_78 )
{
const struct V_76 * V_102 ;
unsigned int V_87 ;
if ( ! F_29 ( & V_78 -> V_66 ) )
...
static inline int F_41 ( struct V_77 * V_78 ,
struct V_90 * V_115 ,
...
{
unsigned int V_143 ;
if ( ( unsigned long ) V_78 % F_42 ( struct V_77 ) != 0 ||
...
if ( ! F_30 ( V_115 , V_148 -> V_116 , V_117 ) ) {
F_11 ( L_40 ) ;
return - V_154 ;
}
V_9 = 0 ;
F_46 (iter, entry0, newinfo->size) {
V_10 = F_35 ( V_149 , V_148 -> V_94 , V_148 -> V_126 ) ;
if ( V_10 != 0 )
break;
++ V_9 ;
}
...
F_26 ( V_149 -> V_103 , V_197 [ V_9 ] . V_158 , V_197 [ V_9 ] . V_120 ) ;
++ V_9 ;
}
F_27 ( V_93 ) ;
V_201:
...
F_11 ( L_50 , V_78 ) ;
if ( ( unsigned long ) V_78 % F_42 ( struct V_173 ) != 0 ||
...
V_10 = F_32 ( (struct V_77 * ) V_78 , V_94 ) ;
if ( V_10 )
return V_10 ;
V_164 = sizeof( struct V_77 ) - sizeof( struct V_173 ) ;
...
goto V_193;
V_10 = - V_154 ;
if ( ! F_30 ( V_115 , V_116 , V_210 ) )
goto V_193;
V_9 = 0 ;
F_46 (iter1, entry1, newinfo->size) {
V_10 = F_33 ( V_212 , V_94 ) ;
if ( V_10 != 0 )
break;
++ V_9 ;
