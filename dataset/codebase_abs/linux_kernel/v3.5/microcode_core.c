...
return sprintf ( V_16 , L_3 , V_12 -> V_7 . V_43 ) ;
}
...
static int F_33 ( struct V_38 * V_37 , struct V_49 * V_50 )
{
int V_4 , V_8 = V_37 -> V_42 ;
if ( ! F_25 ( V_8 ) )
return 0 ;
F_30 ( L_6 , V_8 ) ;
V_4 = F_34 ( & V_37 -> V_51 , & V_52 ) ;
if ( V_4 )
return V_4 ;
if ( F_31 ( V_8 ) == V_21 )
return - V_29 ;
...
static int F_35 ( struct V_38 * V_37 , struct V_49 * V_50 )
{
int V_8 = V_37 -> V_42 ;
if ( ! F_25 ( V_8 ) )
return 0 ;
