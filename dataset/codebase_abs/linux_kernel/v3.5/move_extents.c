...
{
int V_133 ;
struct V_11 * V_11 = V_178 -> V_180 . V_181 -> V_182 ;
struct V_107 V_67 ;
struct V_2 * V_3 = NULL ;
V_133 = F_88 ( V_178 ) ;
if ( V_133 )
return V_133 ;
if ( ( ! F_89 ( V_11 -> V_183 ) ) || ! ( V_178 -> V_184 & V_185 ) )
goto V_27;
if ( V_11 -> V_186 & ( V_187 | V_188 ) ) {
V_133 = - V_189 ;
goto V_27;
}
V_3 = F_90 ( sizeof( struct V_2 ) , V_190 ) ;
if ( ! V_3 ) {
V_133 = - V_31 ;
F_6 ( V_133 ) ;
goto V_27;
...
V_3 -> V_26 = V_178 ;
if ( V_179 ) {
if ( F_91 ( & V_67 , V_179 , sizeof( V_67 ) ) ) {
V_133 = - V_191 ;
goto V_27;
}
} else {
...
if ( V_67 . V_163 > F_92 ( V_11 ) )
goto V_27;
if ( V_67 . V_163 + V_67 . V_113 > F_92 ( V_11 ) )
V_67 . V_113 = F_92 ( V_11 ) - V_67 . V_163 ;
V_3 -> V_67 = & V_67 ;
if ( V_67 . V_68 & V_192 ) {
V_3 -> V_162 = 1 ;
if ( ! V_67 . V_142 )
V_67 . V_142 = 1024 * 1024 ;
if ( V_67 . V_142 > F_92 ( V_11 ) )
V_67 . V_142 = F_92 ( V_11 ) ;
if ( V_67 . V_68 & V_193 )
V_3 -> V_54 = 1 ;
} else {
...
V_27:
if ( V_179 ) {
if ( F_93 ( V_179 , & V_67 , sizeof( V_67 ) ) )
V_133 = - V_191 ;
}
F_94 ( V_3 ) ;
F_95 ( V_178 ) ;
