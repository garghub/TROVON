...
struct V_6 * F_63 ( const char * V_51 , ... )
{
T_5 V_52 ;
struct V_6 * V_7 ;
V_7 = F_64 ( sizeof *V_7 , V_15 ) ;
if ( V_7 ) {
int V_24 ;
V_7 -> V_2 . type = & V_68 ;
V_7 -> V_2 . V_69 = & V_70 ;
F_65 ( & V_7 -> V_2 ) ;
F_66 ( & V_7 -> V_2 , ( void * ) V_7 ) ;
F_67 ( & V_7 -> V_35 ) ;
V_7 -> V_29
= F_68 ( - 1 , 0 ,
V_26 ,
...
{
return F_34 ( V_40 -> V_7 ,
V_40 -> V_77 ) ;
}
int F_75 ( struct V_50 * V_40 )
{
return F_39 ( V_40 -> V_7 ,
V_40 -> V_77 ) ;
}
