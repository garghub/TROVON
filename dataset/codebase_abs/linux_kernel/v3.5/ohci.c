...
int V_28 , V_27 , V_254 , V_50 , V_255 ;
T_1 V_168 ;
void * V_256 = NULL ;
T_2 V_257 = 0 ;
bool V_258 ;
...
F_47 () ;
for ( V_50 = 1 , V_255 = 0 ; V_255 < V_28 ; V_50 += 2 , V_255 ++ ) {
...
V_256 , V_257 ) ;
F_6 ( V_4 , V_27 , V_28 ) ;
F_124 ( & V_4 -> V_3 , V_4 -> V_30 , V_27 ,
V_28 , V_4 -> V_31 ,
V_4 -> V_278 ) ;
V_4 -> V_278 = false ;
}
static T_8 F_125 ( int V_279 , void * V_45 )
{
struct V_1 * V_4 = V_45 ;
T_1 V_280 , V_281 ;
int V_50 ;
...
F_2 ( V_4 , V_280 ) ;
if ( V_280 & V_11 )
F_126 ( V_283 , & V_4 -> F_120 ) ;
if ( V_280 & V_12 )
F_127 ( & V_4 -> V_118 . V_126 ) ;
if ( V_280 & V_13 )
F_127 ( & V_4 -> V_284 . V_126 ) ;
if ( V_280 & V_14 )
F_127 ( & V_4 -> V_216 . V_126 ) ;
if ( V_280 & V_15 )
F_127 ( & V_4 -> V_222 . V_126 ) ;
if ( V_280 & V_16 ) {
...
static void F_133 ( V_42 * V_294 , const V_42 * V_295 , T_9 V_94 )
{
T_9 V_296 = V_94 * 4 ;
...
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
struct V_308 * V_309 = F_137 ( V_3 -> V_10 ) ;
...
F_82 ( V_4 -> V_3 . V_10 , V_198 ,
V_270 , V_272 ) ;
F_144 ( & V_4 -> V_3 , true , true ) ;
return 0 ;
}
static void F_146 ( struct V_2 * V_3 , struct V_91 * V_170 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
...
static int F_148 ( struct V_2 * V_3 , struct V_91 * V_170 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
...
static T_1 F_150 ( struct V_2 * V_3 , int V_350 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
T_1 V_351 ;
...
static void F_152 ( struct V_2 * V_3 , int V_350 , T_1 V_351 )
{
struct V_1 * V_4 = V_1 ( V_3 ) ;
unsigned long V_154 ;
switch ( V_350 ) {
...
static void F_153 ( struct V_363 * V_64 )
{
...
static void F_154 ( struct V_363 * V_64 , const T_1 * V_368 )
{
T_1 * V_369 ;
...
V_369 [ 0 ] = F_155 ( V_368 [ 1 ] ) ;
if ( V_64 -> V_364 . V_370 > 4 )
V_369 [ 1 ] = F_155 ( V_368 [ 0 ] ) ;
...
F_157 ( V_143 -> V_4 -> V_3 . V_10 ,
V_373 & V_374 ,
V_373 & ~ V_374 ,
F_48 ( V_68 -> V_134 ) ,
V_80 ) ;
}
F_154 ( V_64 , ( T_1 * ) ( V_85 + 1 ) ) ;
...
static void F_159 ( struct V_363 * V_64 )
{
F_157 ( V_64 -> V_143 . V_4 -> V_3 . V_10 ,
V_64 -> V_376 & V_374 ,
V_64 -> V_376 & ~ V_374 ,
V_64 -> V_377 , V_80 ) ;
V_64 -> V_364 . V_153 . V_378 ( & V_64 -> V_364 ,
...
static inline void F_160 ( struct V_143 * V_143 ,
struct V_67 * V_372 )
{
T_3 V_135 ;
T_1 V_373 ;
...
static int F_161 ( struct V_143 * V_143 ,
struct V_67 * V_68 ,
struct V_67 * V_85 )
{
struct V_363 * V_64 =
...
static void F_162 ( struct V_1 * V_4 , T_6 V_379 )
{
...
static struct V_387 * F_164 ( struct V_2 * V_3 ,
...
V_389 = & V_4 -> V_394 ;
V_153 = F_156 ;
V_66 = * V_379 & 1ULL << V_388 ? F_128 ( * V_389 ) - 1 : - 1 ;
if ( V_66 >= 0 ) {
* V_379 &= ~ ( 1ULL << V_388 ) ;
* V_389 &= ~ ( 1 << V_66 ) ;
V_75 = F_113 ( V_66 ) ;
...
V_389 = & V_4 -> V_394 ;
V_153 = F_158 ;
V_66 = ! V_4 -> V_396 ? F_128 ( * V_389 ) - 1 : - 1 ;
if ( V_66 >= 0 ) {
V_4 -> V_396 = true ;
* V_389 &= ~ ( 1 << V_66 ) ;
V_75 = F_113 ( V_66 ) ;
...
F_11 ( V_4 , F_169 ( V_64 -> V_143 . V_75 ) , V_403 ) ;
...
static int F_170 ( struct V_387 * V_364 )
{
...
F_15 ( V_4 ) ;
F_86 ( & V_64 -> V_143 ) ;
F_171 ( & V_64 -> V_143 . V_126 ) ;
return 0 ;
}
static void F_172 ( struct V_387 * V_364 )
{
struct V_1 * V_4 = V_1 ( V_364 -> V_3 ) ;
struct V_363 * V_64 = F_1 ( V_364 , struct V_363 , V_364 ) ;
unsigned long V_154 ;
...
static int F_173 ( struct V_387 * V_364 , T_6 * V_379 )
{
struct V_1 * V_4 = V_1 ( V_364 -> V_3 ) ;
unsigned long V_154 ;
int V_58 ;
...
V_64 = & V_4 -> V_286 [ V_50 ] ;
if ( V_64 -> V_143 . V_167 )
F_168 ( & V_64 -> V_364 , 0 , V_64 -> V_400 , V_64 -> V_401 ) ;
}
...
static int F_175 ( struct V_363 * V_64 ,
struct V_416 * V_170 ,
struct V_417 * V_77 ,
unsigned long V_109 )
{
...
if ( V_92 -> V_98 > 0 )
V_141 ++ ;
V_424 = F_176 ( V_421 + V_92 -> V_99 ) >> V_426 ;
if ( V_92 -> V_99 > 0 )
V_420 = V_424 - ( V_421 >> V_426 ) ;
else
V_420 = 0 ;
V_141 += V_420 ;
V_419 = F_177 ( V_92 -> V_98 , sizeof( * V_68 ) ) ;
...
V_35 = ( T_4 * ) & V_68 [ 1 ] ;
V_35 [ 0 ] = F_32 ( F_178 ( V_92 -> V_427 ) |
F_179 ( V_92 -> V_428 ) |
F_180 ( V_177 ) |
F_181 ( V_64 -> V_364 . V_388 ) |
F_182 ( V_64 -> V_364 . V_32 ) ) ;
V_35 [ 1 ] =
F_32 ( F_183 ( V_92 -> V_98 +
V_92 -> V_99 ) ) ;
}
if ( V_92 -> V_98 > 0 ) {
...
V_370 = F_187 ( V_64 -> V_364 . V_370 , ( T_9 ) 8 ) ;
V_419 = F_177 ( V_370 , sizeof( * V_68 ) ) ;
V_60 = V_109 >> V_426 ;
V_44 = V_109 & ~ V_374 ;
V_433 = V_170 -> V_99 / V_432 ;
for ( V_50 = 0 ; V_50 < V_432 ; V_50 ++ ) {
V_141 = F_177 ( V_433 + V_44 , V_72 ) + 1 ;
...
static int F_188 ( struct V_363 * V_64 ,
struct V_416 * V_170 ,
struct V_417 * V_77 ,
unsigned long V_109 )
{
...
V_44 = V_109 & ~ V_374 ;
V_431 = V_170 -> V_99 ;
V_141 = F_177 ( V_44 + V_431 , V_72 ) ;
if ( F_151 ( V_44 & 3 || V_431 & 3 || V_60 + V_141 > V_77 -> V_436 ) )
return - V_437 ;
...
switch ( V_364 -> type ) {
case V_390 :
V_58 = F_175 ( V_64 , V_170 , V_77 , V_109 ) ;
break;
case V_392 :
...
static void F_190 ( struct V_387 * V_364 )
{
struct V_143 * V_64 =
& F_1 ( V_364 , struct V_363 , V_364 ) -> V_143 ;
F_11 ( V_64 -> V_4 , F_35 ( V_64 -> V_75 ) , V_76 ) ;
}
static int F_191 ( struct V_387 * V_364 )
{
struct V_363 * V_64 = F_1 ( V_364 , struct V_363 , V_364 ) ;
int V_58 = 0 ;
F_95 ( & V_64 -> V_143 . V_126 ) ;
if ( ! F_192 ( 0 , & V_64 -> V_438 ) ) {
...
static void F_195 ( struct V_308 * V_309 )
{
if ( F_196 ( V_439 ) ) {
struct V_440 * V_441 = F_197 ( V_309 ) ;
if ( V_441 ) {
F_198 ( V_442 , V_441 , 0 , 1 ) ;
F_198 ( V_443 , V_441 , 0 , 1 ) ;
}
}
}
static void F_199 ( struct V_308 * V_309 )
{
if ( F_196 ( V_439 ) ) {
struct V_440 * V_441 = F_197 ( V_309 ) ;
if ( V_441 ) {
F_198 ( V_443 , V_441 , 0 , 0 ) ;
F_198 ( V_442 , V_441 , 0 , 0 ) ;
}
}
}
static inline void F_195 ( struct V_308 * V_309 ) {}
static inline void F_199 ( struct V_308 * V_309 ) {}
static int T_11 F_200 ( struct V_308 * V_309 ,
...
V_4 = F_201 ( sizeof( * V_4 ) , V_127 ) ;
if ( V_4 == NULL ) {
V_450 = - V_140 ;
goto V_453;
}
F_202 ( & V_4 -> V_3 , & V_454 , & V_309 -> V_309 ) ;
F_195 ( V_309 ) ;
V_450 = F_203 ( V_309 ) ;
if ( V_450 ) {
...
F_207 ( & V_4 -> V_155 ) ;
F_208 ( & V_4 -> V_62 ) ;
F_209 ( & V_4 -> F_120 , F_120 ) ;
V_450 = F_210 ( V_309 , 0 , V_339 ) ;
if ( V_450 ) {
F_20 ( & V_309 -> V_309 , L_66 ) ;
goto V_457;
}
V_4 -> V_46 = F_211 ( V_309 , 0 , V_458 ) ;
if ( V_4 -> V_46 == NULL ) {
...
F_11 ( V_4 , V_412 , ~ 0 ) ;
V_4 -> V_394 = V_4 -> V_231 ;
V_4 -> V_414 = F_212 ( V_4 -> V_394 ) ;
V_296 = sizeof( struct V_363 ) * V_4 -> V_414 ;
V_4 -> V_286 = F_201 ( V_296 , V_127 ) ;
F_11 ( V_4 , V_406 , ~ 0 ) ;
V_4 -> V_230 = F_13 ( V_4 , V_406 ) ;
F_11 ( V_4 , V_411 , ~ 0 ) ;
V_4 -> V_391 = V_4 -> V_230 ;
V_4 -> V_415 = F_212 ( V_4 -> V_391 ) ;
V_296 = sizeof( struct V_363 ) * V_4 -> V_415 ;
V_4 -> V_288 = F_201 ( V_296 , V_127 ) ;
...
F_13 ( V_4 , V_477 ) ;
V_450 = F_213 ( & V_4 -> V_3 , V_447 , V_448 , V_449 ) ;
if ( V_450 )
goto V_475;
V_312 = F_13 ( V_4 , V_47 ) & 0x00ff00ff ;
F_4 ( & V_309 -> V_309 ,
...
static void F_218 ( struct V_308 * V_309 )
{
struct V_1 * V_4 ;
V_4 = F_219 ( V_309 ) ;
F_11 ( V_4 , V_332 , ~ 0 ) ;
...
static int F_223 ( struct V_308 * V_309 , T_12 V_478 )
{
struct V_1 * V_4 = F_219 ( V_309 ) ;
int V_450 ;
F_132 ( V_4 ) ;
F_222 ( V_309 -> V_279 , V_4 ) ;
F_143 ( V_309 ) ;
...
V_450 = F_225 ( V_309 , F_226 ( V_309 , V_478 ) ) ;
if ( V_450 )
F_20 ( & V_309 -> V_309 , L_73 , V_450 ) ;
F_199 ( V_309 ) ;
return 0 ;
}
static int F_227 ( struct V_308 * V_309 )
{
struct V_1 * V_4 = F_219 ( V_309 ) ;
int V_450 ;
F_195 ( V_309 ) ;
