...
static void F_5 ( struct V_7 * V_4 , T_2 V_8 )
{
T_1 V_10 , V_9 ;
V_8 >>= V_13 ;
V_10 = V_8 >> 32 ;
...
int F_18 ( T_3 * V_28 , struct V_16 * V_17 )
{
T_4 V_29 ;
struct V_1 * V_2 = F_8 ( V_17 ) ;
if ( ( V_2 -> V_4 == 0 ) || V_28 == ( T_3 * ) NULL ) {
F_19 ( & V_17 -> V_30 ,
L_1 ) ;
return V_31 ;
}
...
static T_5 F_22 ( int V_35 , void * V_36 )
{
struct V_1 * V_1 = V_36 ;
struct V_7 * V_4 = V_1 -> V_4 ;
struct V_37 V_38 ;
...
static int F_23 ( struct V_55 * V_56 , T_4 V_57 )
{
T_2 V_58 ;
T_1 V_59 , V_60 ;
int V_61 = 0 ;
...
static int F_26 ( struct V_55 * V_56 , T_6 V_64 )
{
T_6 V_65 ;
unsigned long V_66 ;
struct V_1 * V_1 = F_24 ( V_56 , struct V_1 , V_62 ) ;
...
static T_4 F_33 ( struct V_16 * V_17 , T_7 V_80 )
{
F_34 ( V_17 ) ;
F_35 ( V_17 , V_81 , 0 ) ;
if ( F_36 ( V_17 ) != 0 ) {
...
static T_4 F_39 ( struct V_16 * V_17 )
{
T_4 V_83 ;
F_37 ( V_17 , V_84 ) ;
F_40 ( V_17 ) ;
...
static void T_8 F_42 ( struct V_16 * V_17 )
{
struct V_1 * V_2 = F_8 ( V_17 ) ;
F_43 ( V_2 -> V_47 ) ;
if ( V_17 -> V_35 != 0 )
...
V_2 -> V_62 = V_97 ;
V_2 -> V_47 = F_55 ( & V_2 -> V_62 ) ;
if ( F_56 ( V_2 -> V_47 ) )
return F_57 ( V_2 -> V_47 ) ;
F_58 ( & V_2 -> V_67 ) ;
V_83 = F_59 ( V_17 -> V_35 , & F_22 , V_98 , V_99 , V_2 ) ;
if ( V_83 != 0 ) {
...
F_1 ( V_2 ) ;
if ( strcmp ( V_103 . V_104 , L_12 ) != 0 ) {
if ( F_18 ( V_103 . V_104 , V_17 ) != 0 ) {
F_19 ( & V_17 -> V_30 ,
L_13
L_14
) ;
