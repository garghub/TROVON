...
F_24 ( V_193 ,
L_19 ,
V_84 , V_10 , V_265 , V_5 , V_145 -> V_173 ,
V_145 -> V_171 , V_76 ) ;
...
F_98 ( V_10 ) ;
V_261 = sizeof( struct V_11 ) + sizeof( struct V_17 ) +
sizeof( struct V_41 ) ;
V_260 = (struct V_17 * ) V_5 -> V_16 ;
if ( V_34 -> V_112 != V_113 &&
( ( V_145 -> V_171 < V_261 ) ||
( V_145 -> V_171 > V_276 ) ) ) {
F_100 ( L_21 ) ;
...
if ( V_34 -> V_112 == V_113 ) {
V_262 = F_101 ( V_260 ) ;
V_267 = ! ! ( ( V_260 -> V_149 >> V_279 ) &
V_280 ) ;
V_271 = sizeof( struct V_17 ) ;
V_268 = ! ! ( F_102 ( V_260 -> V_281 ) & V_282 ) ;
switch ( V_262 ) {
case 0 :
break;
case V_283 :
...
V_230 = F_105 ( V_260 ) ? true : false ;
V_215 = F_106 ( V_260 ) ;
V_216 = F_107 ( V_260 ) ;
V_262 = F_101 ( V_260 ) ;
V_263 = F_108 ( V_260 ) ;
V_264 =
( F_102 ( V_260 -> V_281 ) >> V_295 )
& V_296 ;
...
break;
case V_126 :
V_102 = (struct V_259 * ) V_5 -> V_16 ;
if ( V_102 -> V_124 & 0x1 ) {
V_5 -> V_106 = V_297 ;
V_5 -> V_105 = ( V_298 V_299 ) V_102 -> V_105 ;
}
F_97 ( V_5 , sizeof( struct V_259 ) ) ;
break;
default:
break;
}
...
V_270 = V_34 -> V_301 -> V_270 ;
if ( F_93 ( V_270 , V_215 , V_216 ,
V_230 , V_5 ) ) {
return;
}
...
static void F_113 ( unsigned long V_303 )
{
T_1 V_13 , V_304 ;
struct V_213 * V_270 = (struct V_213 * ) V_303 ;
struct V_203 * V_203 ;
struct V_223 * V_224 ;
for ( V_13 = 0 ; V_13 < V_305 ; V_13 ++ ) {
V_203 = & V_270 -> V_225 [ V_13 ] ;
V_224 = & V_270 -> V_226 [ V_13 ] ;
if ( ! V_203 -> V_240 || ! V_203 -> V_252 || V_203 -> V_247 )
continue;
V_224 -> V_306 ++ ;
F_24 ( V_307 ,
L_22 ,
...
for ( V_304 = 0 ; V_304 < V_203 -> V_228 ; V_304 ++ ) {
if ( V_203 -> V_229 [ V_304 ] . V_5 ) {
V_270 -> V_246 = true ;
V_203 -> V_252 = true ;
V_203 -> V_247 = false ;
break;
...
static void F_115 ( struct V_213 * V_270 , T_1 V_215 )
{
struct V_203 * V_203 ;
struct V_223 * V_224 ;
if ( ! V_270 || V_215 >= V_305 )
return;
V_203 = & V_270 -> V_225 [ V_215 ] ;
V_224 = & V_270 -> V_226 [ V_215 ] ;
if ( V_203 -> V_240 )
F_90 ( V_270 , V_215 , 0 , 0 ) ;
V_203 -> V_240 = false ;
V_203 -> V_247 = false ;
V_203 -> V_252 = false ;
V_203 -> V_308 = 0 ;
...
F_115 ( V_270 , V_215 ) ;
V_203 -> V_227 = V_216 ;
V_310 = F_118 ( V_308 ) * sizeof( struct V_218 ) ;
V_203 -> V_229 = F_119 ( V_310 , V_313 ) ;
if ( ! V_203 -> V_229 )
return;
V_203 -> V_308 = V_308 ;
V_203 -> V_228 = F_118 ( V_308 ) ;
if ( ! F_8 ( & V_203 -> V_182 ) )
return;
V_203 -> V_240 = true ;
}
...
F_121 ( & V_270 -> V_248 ) ;
V_270 -> V_248 . V_316 = F_113 ;
V_270 -> V_248 . V_16 = ( unsigned long ) V_270 ;
V_270 -> V_185 = V_185 ;
V_270 -> V_246 = false ;
for ( V_13 = 0 ; V_13 < V_305 ; V_13 ++ ) {
V_203 = & V_270 -> V_225 [ V_13 ] ;
...
V_186 = F_119 ( sizeof( struct V_185 ) , V_313 ) ;
if ( ! V_186 ) {
F_25 ( L_24 ) ;
return NULL ;
}
V_186 -> V_270 = F_119 ( sizeof( struct V_213 ) , V_313 ) ;
if ( ! V_186 -> V_270 ) {
F_25 ( L_25 ) ;
F_104 ( V_186 ) ;
return NULL ;
}
F_120 ( V_34 , V_186 , V_186 -> V_270 ) ;
F_51 ( & V_186 -> V_187 ) ;
