...
int F_214 ( struct V_1 * V_2 , struct V_420 * V_274 )
{
return F_40 ( V_2 , V_274 -> V_91 ) ;
}
int F_215 ( struct V_320 * V_313 , T_11 V_421 )
{
return V_313 -> V_2 -> V_333 == V_421 ;
}
int F_216 ( struct V_320 * V_313 , T_12 V_422 )
{
return 0 ;
}
int F_217 ( struct V_1 * V_423 , struct V_1 * V_424 )
{
return V_423 -> V_6 . V_245 - V_424 -> V_6 . V_245 ;
}
int F_218 ( struct V_1 * V_2 , struct V_320 * V_425 ,
int V_426 , int V_421 , int V_427 )
{
struct V_320 * V_428 = V_2 -> V_6 . V_313 ;
return ( V_427 == 0 ) ?
F_215 ( V_428 , V_421 ) :
F_216 ( V_428 , V_421 ) ;
}
static int F_219 ( int * V_429 )
{
T_5 V_430 , V_431 ;
int V_12 ;
...
return V_432 ;
if ( V_24 -> V_92 [ 0 ] & ( 1UL << V_433 ) )
return V_433 ;
return F_219 ( ( int * ) & V_24 -> V_92 [ 0 ] ) ;
}
