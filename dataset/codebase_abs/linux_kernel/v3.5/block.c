...
struct V_1 * V_4 = V_158 -> V_77 ;
struct V_20 * V_21 = V_4 -> V_12 . V_21 ;
unsigned int V_159 , V_160 , V_88 , V_172 , V_173 ;
int V_59 = 0 , type = V_174 ;
...
V_59 = F_76 ( V_21 , V_159 , V_160 , V_181 ) ;
if ( V_59 == - V_170 )
goto V_179;
if ( V_59 )
goto V_41;
...
static int F_85 ( struct V_157 * V_158 , struct V_127 * V_128 )
{
struct V_1 * V_4 = V_158 -> V_77 ;
struct V_20 * V_21 = V_4 -> V_12 . V_21 ;
int V_19 = 0 ;
...
static inline void F_88 ( struct V_138 * V_139 ,
struct V_20 * V_21 ,
struct V_127 * V_128 )
{
if ( ! ( V_21 -> V_23 . V_183 & V_184 ) ) {
if ( ! F_89 ( V_139 -> V_75 . V_88 , V_21 -> V_23 . V_185 ) )
V_139 -> V_77 . V_68 = 1 ;
if ( V_139 -> V_77 . V_68 > V_21 -> V_23 . V_185 )
V_139 -> V_77 . V_68 = V_21 -> V_23 . V_185 ;
else if ( V_139 -> V_77 . V_68 < V_21 -> V_23 . V_185 )
V_139 -> V_77 . V_68 = 1 ;
}
}
...
struct V_186 * V_187 )
{
struct V_188 * V_189 = F_91 ( V_187 , struct V_188 ,
V_190 ) ;
struct V_138 * V_139 = & V_189 -> V_139 ;
struct V_127 * V_128 = V_189 -> V_128 ;
int V_140 = 0 ;
...
if ( V_139 -> V_75 . V_104 [ 0 ] & V_194 ) {
F_19 ( L_18 ,
V_128 -> V_132 -> V_36 , V_139 -> V_75 . V_104 [ 0 ] ) ;
return V_192 ;
}
if ( ! F_57 ( V_21 -> V_32 ) && F_92 ( V_128 ) != V_195 ) {
T_6 V_121 ;
do {
...
if ( ! V_139 -> V_77 . V_201 )
return V_191 ;
if ( F_79 ( V_128 ) != V_139 -> V_77 . V_201 )
return V_202 ;
return V_203 ;
}
static void F_93 ( struct V_188 * V_204 ,
struct V_20 * V_21 ,
int V_205 ,
struct V_157 * V_158 )
{
T_6 V_206 , V_207 ;
struct V_138 * V_139 = & V_204 -> V_139 ;
struct V_127 * V_128 = V_204 -> V_128 ;
struct V_1 * V_4 = V_158 -> V_77 ;
bool V_208 ;
bool V_209 = ( ( V_128 -> V_210 & V_211 ) ||
( V_128 -> V_210 & V_212 ) ) &&
( F_92 ( V_128 ) == V_213 ) &&
( V_4 -> V_89 & V_214 ) ;
...
if ( V_139 -> V_77 . V_68 > V_21 -> V_32 -> V_215 )
V_139 -> V_77 . V_68 = V_21 -> V_32 -> V_215 ;
if ( V_139 -> V_77 . V_68 > 1 ) {
if ( V_205 )
V_139 -> V_77 . V_68 = 1 ;
if ( V_21 -> V_32 -> V_216 & V_217 &&
F_92 ( V_128 ) == V_195 )
V_139 -> V_77 . V_68 = 1 ;
}
if ( V_139 -> V_77 . V_68 > 1 || V_209 ) {
if ( ! F_57 ( V_21 -> V_32 ) ||
F_92 ( V_128 ) == V_195 )
...
V_139 -> V_75 . V_87 = V_207 ;
V_139 -> V_77 . V_89 |= V_92 ;
}
if ( V_209 )
F_88 ( V_139 , V_21 , V_128 ) ;
V_208 = ( V_21 -> V_23 . V_222 ) &&
( V_128 -> V_210 & V_212 ) &&
( F_92 ( V_128 ) == V_213 ) &&
( ( V_139 -> V_77 . V_68 * V_139 -> V_77 . V_67 ) >=
V_21 -> V_23 . V_222 ) ;
if ( ( V_4 -> V_89 & V_223 ) && F_95 ( V_139 -> V_75 . V_87 ) &&
( V_209 || ! ( V_21 -> V_165 & V_224 ) ||
V_208 ) ) {
V_139 -> V_149 . V_87 = V_225 ;
...
V_139 -> V_77 . V_81 = V_204 -> V_81 ;
V_139 -> V_77 . V_90 = F_96 ( V_158 , V_204 ) ;
if ( V_139 -> V_77 . V_68 != F_73 ( V_128 ) ) {
int V_226 , V_227 = V_139 -> V_77 . V_68 << 9 ;
struct V_80 * V_81 ;
...
V_139 -> V_77 . V_90 = V_226 ;
}
V_204 -> V_190 . V_79 = & V_139 -> V_79 ;
V_204 -> V_190 . V_229 = F_90 ;
F_98 ( V_204 ) ;
}
...
if ( V_68 != ( T_6 ) - 1 ) {
F_77 ( & V_4 -> V_171 ) ;
V_19 = F_78 ( V_128 , 0 , V_68 << 9 ) ;
F_80 ( & V_4 -> V_171 ) ;
}
} else {
F_77 ( & V_4 -> V_171 ) ;
V_19 = F_78 ( V_128 , 0 , V_139 -> V_77 . V_201 ) ;
F_80 ( & V_4 -> V_171 ) ;
}
return V_19 ;
}
static int F_101 ( struct V_157 * V_158 , struct V_127 * V_230 )
{
struct V_1 * V_4 = V_158 -> V_77 ;
struct V_20 * V_21 = V_4 -> V_12 . V_21 ;
struct V_138 * V_139 = & V_158 -> V_231 -> V_139 ;
int V_19 = 1 , V_205 = 0 , V_143 = 0 , type ;
enum V_232 V_121 ;
struct V_188 * V_233 ;
struct V_127 * V_128 = V_230 ;
struct V_186 * V_187 ;
if ( ! V_230 && ! V_158 -> V_234 -> V_128 )
return 0 ;
do {
if ( V_230 ) {
if ( ( V_139 -> V_77 . V_68 & 0x07 ) &&
( V_21 -> V_23 . V_235 == 4096 ) ) {
F_19 ( L_21 ,
V_128 -> V_132 -> V_36 ) ;
goto V_236;
}
F_93 ( V_158 -> V_231 , V_21 , 0 , V_158 ) ;
V_187 = & V_158 -> V_231 -> V_190 ;
} else
V_187 = NULL ;
V_187 = F_102 ( V_21 -> V_32 , V_187 , ( int * ) & V_121 ) ;
if ( ! V_187 )
return 0 ;
V_233 = F_91 ( V_187 , struct V_188 , V_190 ) ;
V_139 = & V_233 -> V_139 ;
V_128 = V_233 -> V_128 ;
type = F_92 ( V_128 ) == V_195 ? V_237 : V_238 ;
F_103 ( V_233 ) ;
switch ( V_121 ) {
case V_203 :
case V_202 :
...
break;
case V_196 :
V_19 = F_99 ( V_4 , V_21 , V_139 , V_128 , V_19 ) ;
...
if ( V_19 ) {
F_93 ( V_233 , V_21 , V_205 , V_158 ) ;
F_102 ( V_21 -> V_32 , & V_233 -> V_190 , NULL ) ;
}
} while ( V_19 );
return 1 ;
V_236:
...
V_128 -> V_210 |= V_240 ;
while ( V_19 )
V_19 = F_78 ( V_128 , - V_170 , F_105 ( V_128 ) ) ;
F_80 ( & V_4 -> V_171 ) ;
V_239:
if ( V_230 ) {
F_93 ( V_158 -> V_231 , V_21 , 0 , V_158 ) ;
F_102 ( V_21 -> V_32 , & V_158 -> V_231 -> V_190 , NULL ) ;
}
return 0 ;
}
static int F_106 ( struct V_157 * V_158 , struct V_127 * V_128 )
{
int V_19 ;
struct V_1 * V_4 = V_158 -> V_77 ;
struct V_20 * V_21 = V_4 -> V_12 . V_21 ;
if ( V_128 && ! V_158 -> V_234 -> V_128 )
F_17 ( V_21 -> V_32 ) ;
V_19 = F_52 ( V_21 , V_4 ) ;
if ( V_19 ) {
if ( V_128 ) {
...
if ( V_128 && V_128 -> V_210 & V_241 ) {
if ( V_21 -> V_32 -> V_187 )
F_101 ( V_158 , NULL ) ;
if ( V_128 -> V_210 & V_242 )
V_19 = F_81 ( V_158 , V_128 ) ;
else
V_19 = F_70 ( V_158 , V_128 ) ;
} else if ( V_128 && V_128 -> V_210 & V_243 ) {
if ( V_21 -> V_32 -> V_187 )
F_101 ( V_158 , NULL ) ;
V_19 = F_85 ( V_158 , V_128 ) ;
} else {
V_19 = F_101 ( V_158 , V_128 ) ;
}
V_41:
if ( ! V_128 )
F_20 ( V_21 -> V_32 ) ;
...
if ( ! V_250 ) {
V_4 -> V_253 = F_110 ( V_254 , V_251 ) ;
F_111 ( V_4 -> V_253 , V_254 ) ;
} else
...
F_114 ( & V_4 -> V_256 ) ;
V_4 -> V_7 = 1 ;
V_19 = F_115 ( & V_4 -> V_12 , V_21 , & V_4 -> V_171 , V_250 ) ;
if ( V_19 )
goto V_257;
V_4 -> V_12 . V_258 = F_106 ;
V_4 -> V_12 . V_77 = V_4 ;
V_4 -> V_3 -> V_259 = V_260 ;
...
if ( F_54 ( V_21 ) ||
( F_100 ( V_21 ) &&
V_21 -> V_264 . V_265 & V_266 ) )
V_4 -> V_89 |= V_223 ;
}
if ( F_54 ( V_21 ) &&
V_4 -> V_89 & V_223 &&
( ( V_21 -> V_23 . V_183 & V_184 ) ||
V_21 -> V_23 . V_185 ) ) {
V_4 -> V_89 |= V_214 ;
F_119 ( V_4 -> V_12 . V_12 , V_243 | V_211 ) ;
}
return V_4 ;
V_257:
F_11 ( V_4 -> V_3 ) ;
...
V_248 = V_21 -> V_244 . V_267 << ( V_21 -> V_244 . V_268 - 9 ) ;
}
V_4 = F_109 ( V_21 , & V_21 -> V_15 , V_248 , false , NULL ,
V_269 ) ;
return V_4 ;
}
...
char V_270 [ 10 ] ;
struct V_1 * V_29 ;
V_29 = F_109 ( V_21 , F_122 ( V_4 -> V_3 ) , V_248 , V_249 ,
V_250 , V_37 ) ;
if ( F_39 ( V_29 ) )
return F_40 ( V_29 ) ;
V_29 -> V_108 = V_108 ;
F_123 ( & V_29 -> V_256 , & V_4 -> V_256 ) ;
F_124 ( ( V_66 ) F_32 ( V_29 -> V_3 ) << 9 , V_271 ,
V_270 , sizeof( V_270 ) ) ;
F_21 ( L_26 ,
V_29 -> V_3 -> V_36 , F_125 ( V_21 ) ,
F_126 ( V_21 ) , V_29 -> V_108 , V_270 ) ;
return 0 ;
}
...
if ( ! F_54 ( V_21 ) )
return 0 ;
for ( V_272 = 0 ; V_272 < V_21 -> V_273 ; V_272 ++ ) {
if ( V_21 -> V_256 [ V_272 ] . V_248 ) {
V_19 = F_121 ( V_21 , V_4 ,
V_21 -> V_256 [ V_272 ] . V_274 ,
V_21 -> V_256 [ V_272 ] . V_248 >> 9 ,
V_21 -> V_256 [ V_272 ] . V_275 ,
V_21 -> V_256 [ V_272 ] . V_129 ,
V_21 -> V_256 [ V_272 ] . V_37 ) ;
if ( V_19 )
return V_19 ;
}
}
...
if ( V_4 ) {
V_21 = V_4 -> V_12 . V_21 ;
if ( V_4 -> V_3 -> V_89 & V_276 ) {
F_129 ( F_122 ( V_4 -> V_3 ) , & V_4 -> V_275 ) ;
if ( ( V_4 -> V_37 & V_38 ) &&
V_21 -> V_23 . V_277 )
F_129 ( F_122 ( V_4 -> V_3 ) ,
& V_4 -> V_278 ) ;
...
F_133 (pos, q, &md->part) {
V_29 = F_134 ( V_280 , struct V_1 , V_256 ) ;
F_135 ( V_280 ) ;
F_128 ( V_29 ) ;
}
}
...
struct V_20 * V_21 = V_4 -> V_12 . V_21 ;
F_137 ( V_4 -> V_3 ) ;
V_4 -> V_275 . V_282 = F_24 ;
V_4 -> V_275 . V_283 = F_26 ;
F_138 ( & V_4 -> V_275 . V_17 ) ;
V_4 -> V_275 . V_17 . V_129 = L_27 ;
V_4 -> V_275 . V_17 . V_44 = V_284 | V_285 ;
V_19 = F_139 ( F_122 ( V_4 -> V_3 ) , & V_4 -> V_275 ) ;
if ( V_19 )
goto V_286;
if ( ( V_4 -> V_37 & V_38 ) &&
V_21 -> V_23 . V_277 ) {
T_9 V_44 ;
if ( V_21 -> V_23 . V_24 & V_287 )
V_44 = V_284 ;
else
V_44 = V_284 | V_285 ;
V_4 -> V_278 . V_282 = F_13 ;
V_4 -> V_278 . V_283 = F_15 ;
F_138 ( & V_4 -> V_278 . V_17 ) ;
V_4 -> V_278 . V_17 . V_44 = V_44 ;
V_4 -> V_278 . V_17 . V_129 =
L_28 ;
...
struct V_1 * V_4 , * V_29 ;
char V_270 [ 10 ] ;
if ( ! ( V_21 -> V_244 . V_245 & V_289 ) )
return - V_156 ;
V_4 = F_120 ( V_21 ) ;
if ( F_39 ( V_4 ) )
return F_40 ( V_4 ) ;
F_124 ( ( V_66 ) F_32 ( V_4 -> V_3 ) << 9 , V_271 ,
V_270 , sizeof( V_270 ) ) ;
F_21 ( L_29 ,
V_4 -> V_3 -> V_36 , F_125 ( V_21 ) , F_126 ( V_21 ) ,
V_270 , V_4 -> V_39 ? L_30 : L_25 ) ;
if ( F_127 ( V_21 , V_4 ) )
goto V_41;
F_141 ( V_21 , V_4 ) ;
F_142 ( V_21 , V_290 ) ;
