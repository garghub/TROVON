...
V_18 = F_92 ( V_17 -> V_18 . V_102 , V_98 ) ;
if ( V_18 == NULL ) {
F_89 ( & V_17 -> V_18 . V_99 ) ;
return F_91 ( - V_101 ) ;
}
...
V_18 = F_88 ( V_17 , V_3 , V_2 , & V_113 , V_109 ,
V_14 ) ;
if ( F_105 ( V_18 ) )
return (struct V_63 * ) V_18 ;
V_119 = V_112 ? F_106 ( V_112 ) : NULL ;
if ( V_119 )
V_120 = F_107 ( V_119 ) ;
else
...
if ( V_119 )
F_108 ( V_18 , V_119 -> V_46 , V_109 ) ;
F_109 ( V_18 , V_109 ) ;
F_110 ( V_18 , V_109 ) ;
V_115 = V_112 ? F_111 ( V_112 ) : NULL ;
F_112 ( V_18 , V_115 ? V_115 -> V_123 : 0 ,
V_115 ? V_115 -> V_124 : 0 ,
V_109 ) ;
F_25 ( & V_48 ) ;
...
F_15 ( L_8 ,
V_18 , exp ) ;
F_114 ( V_125 , & V_18 -> V_58 ) ;
V_18 -> V_50 = exp -> V_50 ;
if ( exp -> V_85 ) {
V_78 = F_115 ( V_18 , V_109 ) ;
if ( V_78 )
F_116 ( V_78 -> V_85 , exp -> V_85 ) ;
}
#ifdef F_117
...
F_121 ( struct V_17 * V_17 , struct V_39 * V_112 ,
struct V_20 * V_21 ,
unsigned int V_23 ,
T_4 V_24 ,
T_5 V_13 ,
...
if ( F_50 ( V_133 , & V_18 -> V_58 ) ) {
F_15 ( L_10 , V_18 ) ;
* V_80 = V_134 ;
} else if ( F_50 ( V_125 , & V_18 -> V_58 ) ) {
F_15 ( L_11 ,
V_18 ) ;
* V_80 = V_135 ;
} else {
...
if ( V_28 -> error != NULL ) {
V_33 = V_28 -> error ( V_17 , V_112 , V_21 , V_23 , & V_80 ,
V_138 , V_139 ) ;
if ( V_33 <= 0 ) {
F_84 ( V_17 , error ) ;
F_84 ( V_17 , V_141 ) ;
...
V_18 = F_121 ( V_17 , V_112 , V_21 , V_23 , V_138 , V_13 ,
V_26 , V_28 , & V_131 , & V_80 ) ;
if ( ! V_18 ) {
F_84 ( V_17 , V_141 ) ;
V_33 = V_35 ;
goto V_73;
...
V_120 = V_28 -> V_121 ( V_17 ) ;
V_33 = V_28 -> V_143 ( V_18 , V_21 , V_23 , V_80 , V_138 , V_139 , V_120 ) ;
if ( V_33 <= 0 ) {
F_15 ( L_14 ) ;
F_126 ( V_21 -> V_44 ) ;
V_21 -> V_44 = NULL ;
...
if ( V_131 && ! F_127 ( V_133 , & V_18 -> V_58 ) )
F_76 ( V_144 , V_18 ) ;
V_73:
if ( V_112 ) {
if ( V_33 == V_145 )
...
if ( V_18 -> V_50 || ( V_78 && ! F_131 ( & V_78 -> V_147 ) ) )
return;
F_9 () ;
F_119 ( V_18 , NULL , V_109 ) ;
F_11 () ;
}
void F_132 ( struct V_39 * V_18 ,
enum V_79 V_80 ,
...
F_20 ( V_21 ) ;
if ( F_50 ( V_151 , & V_18 -> V_58 ) )
goto V_152;
if ( ! F_26 ( V_18 ) ) {
V_18 -> V_46 . V_54 = V_148 ;
} else {
unsigned long V_153 = V_55 + V_148 ;
if ( V_153 - V_18 -> V_46 . V_54 >= V_154 )
F_133 ( & V_18 -> V_46 , V_153 ) ;
}
V_152:
if ( V_149 ) {
struct V_155 * V_152 ;
V_152 = F_134 ( V_18 ) ;
if ( V_152 ) {
F_135 ( & V_152 [ F_72 ( V_80 ) ] . V_156 ) ;
F_136 ( V_21 -> V_157 , & V_152 [ F_72 ( V_80 ) ] . V_158 ) ;
}
}
}
bool F_137 ( struct V_39 * V_18 ,
enum V_79 V_80 ,
const struct V_20 * V_21 ,
int V_149 )
{
...
if ( V_152 ) {
F_135 ( & V_152 [ F_72 ( V_80 ) ] . V_156 ) ;
F_136 ( V_21 -> V_157 - F_122 ( V_21 ) ,
& V_152 [ F_72 ( V_80 ) ] . V_158 ) ;
}
}
if ( F_83 ( & V_18 -> V_46 ) ) {
...
const struct V_1 * V_2 )
{
if ( F_139 ( V_21 , V_160 , V_2 -> V_5 . V_11 . V_161 . V_162 ) ||
F_139 ( V_21 , V_163 , V_2 -> V_6 . V_11 . V_161 . V_162 ) )
goto V_164;
return 0 ;
V_164:
return - 1 ;
}
int F_140 ( struct V_165 * V_166 [] ,
struct V_1 * V_167 )
{
if ( ! V_166 [ V_160 ] || ! V_166 [ V_163 ] )
return - V_168 ;
V_167 -> V_5 . V_11 . V_161 . V_162 = F_141 ( V_166 [ V_160 ] ) ;
V_167 -> V_6 . V_11 . V_161 . V_162 = F_141 ( V_166 [ V_163 ] ) ;
return 0 ;
}
int F_142 ( void )
{
return F_143 ( V_169 , V_170 + 1 ) ;
}
static void F_144 ( struct V_20 * V_171 , struct V_20 * V_21 )
{
struct V_39 * V_18 ;
enum V_79 V_80 ;
V_18 = F_71 ( V_21 , & V_80 ) ;
...
V_80 = V_135 ;
V_171 -> V_44 = & V_18 -> V_71 ;
V_171 -> V_137 = V_80 ;
F_69 ( V_171 -> V_44 ) ;
}
static struct V_39 *
F_145 ( struct V_17 * V_17 , int (* F_146)( struct V_39 * V_92 , void * V_150 ) ,
void * V_150 , unsigned int * V_66 )
{
struct V_63 * V_64 ;
struct V_39 * V_18 ;
struct V_65 * V_4 ;
...
void F_147 ( struct V_17 * V_17 ,
int (* F_146)( struct V_39 * V_92 , void * V_150 ) ,
void * V_150 )
{
struct V_39 * V_18 ;
unsigned int V_66 = 0 ;
while ( ( V_18 = F_145 ( V_17 , F_146 , V_150 , & V_66 ) ) != NULL ) {
if ( F_83 ( & V_18 -> V_46 ) )
F_46 ( ( unsigned long ) V_18 ) ;
F_31 ( V_18 ) ;
}
}
static int F_148 ( struct V_39 * V_92 , void * V_150 )
{
...
static int F_150 ( struct V_39 * V_92 , void * V_150 )
{
return 1 ;
}
void F_151 ( void * V_14 , unsigned int V_15 )
{
if ( F_152 ( V_14 ) )
F_153 ( V_14 ) ;
else
F_154 ( ( unsigned long ) V_14 ,
F_155 ( sizeof( struct V_177 ) * V_15 ) ) ;
}
void F_156 ( struct V_17 * V_17 , T_1 V_175 , int V_176 )
{
struct V_173 V_174 = {
. V_175 = V_175 ,
. V_176 = V_176 ,
} ;
F_147 ( V_17 , F_148 , & V_174 ) ;
}
static void F_157 ( struct V_17 * V_17 )
{
struct V_63 * V_64 ;
struct V_39 * V_18 ;
struct V_65 * V_4 ;
...
int V_93 = 0 , V_178 ;
F_160 (cpu) {
struct V_39 * V_18 = & F_161 ( V_179 , V_178 ) ;
...
{
V_181:
F_147 ( V_17 , F_150 , NULL ) ;
F_157 ( V_17 ) ;
if ( F_21 ( & V_17 -> V_18 . V_99 ) != 0 ) {
F_163 () ;
goto V_181;
}
F_151 ( V_17 -> V_18 . V_14 , V_17 -> V_18 . V_19 ) ;
F_167 ( V_17 ) ;
F_168 ( V_17 ) ;
F_169 ( V_17 ) ;
F_170 ( V_17 ) ;
...
void * F_180 ( unsigned int * V_187 , int V_188 )
{
struct V_189 * V_14 ;
unsigned int V_190 , V_92 ;
T_8 V_191 ;
F_181 ( sizeof( struct V_189 ) != sizeof( struct V_177 ) ) ;
V_190 = * V_187 = F_182 ( * V_187 , V_192 / sizeof( struct V_189 ) ) ;
V_191 = V_190 * sizeof( struct V_189 ) ;
V_14 = ( void * ) F_183 ( V_193 | V_194 | V_195 ,
F_155 ( V_191 ) ) ;
if ( ! V_14 ) {
F_184 ( V_196 L_16 ) ;
V_14 = F_185 ( V_191 ) ;
...
return - V_101 ;
F_25 ( & V_48 ) ;
for ( V_92 = 0 ; V_92 < V_184 . V_18 . V_19 ; V_92 ++ ) {
while ( ! F_190 ( & V_184 . V_18 . V_14 [ V_92 ] ) ) {
V_64 = F_191 ( V_184 . V_18 . V_14 [ V_92 ] . V_208 ,
struct V_63 , V_41 ) ;
V_18 = F_57 ( V_64 ) ;
F_16 ( & V_64 -> V_41 ) ;
...
{
int V_33 ;
F_99 ( & V_17 -> V_18 . V_99 , 0 ) ;
F_186 ( & V_17 -> V_18 . V_129 , V_218 ) ;
F_186 ( & V_17 -> V_18 . V_59 , V_219 ) ;
V_17 -> V_18 . V_183 = F_197 ( struct V_220 ) ;
if ( ! V_17 -> V_18 . V_183 ) {
V_33 = - V_101 ;
goto V_221;
}
...
V_17 -> V_18 . V_102 = F_199 ( V_17 -> V_18 . V_182 ,
...
V_17 -> V_18 . V_14 = F_180 ( & V_17 -> V_18 . V_19 , 1 ) ;
if ( ! V_17 -> V_18 . V_14 ) {
V_33 = - V_101 ;
F_184 ( V_224 L_20 ) ;
goto V_226;
