...
T_3 * V_38 , int V_71 , int V_72 )
{
int V_28 , V_73 = V_16 -> V_74 . V_30 ;
int V_75 = V_16 -> V_74 . V_76 ;
int V_77 = V_16 -> V_74 . V_78 ;
T_3 * V_79 = V_38 ;
struct V_1 * V_2 = F_13 ( V_12 ) ;
for ( V_28 = 0 ; V_77 ; V_77 -- , V_28 += V_75 , V_79 += V_73 )
V_16 -> V_80 ( V_12 , V_79 , V_73 ) ;
for ( V_28 = 0 ; V_77 ; V_77 -- , V_28 += V_75 , V_79 += V_73 ) {
if ( V_2 -> V_81 [ V_28 ] )
V_12 -> V_82 . V_83 ++ ;
else
...
V_86 = 1 ;
F_2 ( F_17 ( F_38 ( V_2 ) ) | V_87 | V_88 ,
F_38 ( V_2 ) ) ;
F_37 ( V_12 , V_58 ,
( V_89 << 8 ) | V_58 ) ;
for ( V_43 = 0 ; V_43 < V_86 ; V_43 ++ ) {
int V_90 ;
F_1 ( V_2 ) ;
...
{
struct V_1 * V_2 = F_13 ( V_12 ) ;
int V_28 , V_14 = V_2 -> V_92 ;
int V_43 , V_86 ;
if ( V_2 -> V_19 )
V_86 = 4 ;
else
V_86 = 1 ;
F_2 ( F_17 ( F_38 ( V_2 ) ) | V_87 , F_38 ( V_2 ) ) ;
F_37 ( V_12 , V_63 ,
( V_63 << 8 ) | V_62 ) ;
for ( V_43 = 0 ; V_43 < V_86 ; V_43 ++ ) {
F_1 ( V_2 ) ;
...
static void F_47 ( struct V_11 * V_12 , unsigned int V_93 ,
int V_13 , int V_14 )
{
struct V_1 * V_2 = F_13 ( V_12 ) ;
T_1 V_94 = 0 ;
...
if ( V_2 -> V_19 )
F_37 ( V_12 , V_93 , ( V_89 << 8 )
| V_93 ) ;
else
F_37 ( V_12 , V_93 , V_93 ) ;
F_12 ( V_12 , 0 , V_14 ) ;
V_2 -> V_95 = V_12 -> V_91 + V_12 -> V_98 ;
if ( V_2 -> V_16 . V_17 & V_18 )
V_13 >>= 1 ;
V_2 -> V_35 += V_13 ;
goto V_99;
...
break;
if ( V_2 -> V_19 )
F_37 ( V_12 , V_93 , ( V_100 << 8 )
| V_93 ) ;
else
F_37 ( V_12 , V_93 , V_93 ) ;
F_12 ( V_12 , V_13 , 0 ) ;
V_2 -> V_95 = V_12 -> V_91 + V_12 -> V_98 - V_13 ;
goto V_99;
case V_65 :
F_37 ( V_12 , V_93 , V_93 ) ;
if ( V_2 -> V_16 . V_17 & V_18 )
...
F_37 ( V_12 , V_93 , ( V_93 << 8 ) | V_62 ) ;
F_12 ( V_12 , V_2 -> V_103 , V_2 -> V_92 ) ;
...
static void F_51 ( struct V_11 * V_12 , int V_107 )
{
struct V_1 * V_2 = F_13 ( V_12 ) ;
int V_90 ;
switch ( V_107 ) {
...
V_2 -> V_19 = 1 ;
if ( V_16 -> V_114 > ( 128 << 20 ) ) {
V_2 -> V_20 = V_21 ;
V_2 -> V_56 = V_116 ;
} else if ( V_16 -> V_114 > ( 8 << 16 ) ) {
V_2 -> V_20 = V_115 ;
V_2 -> V_56 = V_117 ;
} else {
V_2 -> V_20 = V_116 ;
...
if ( V_2 -> V_97 ) {
if ( V_12 -> V_91 == 512 ) {
V_16 -> V_74 . V_118 = & V_119 ;
V_16 -> V_120 = & V_121 ;
} else {
V_16 -> V_74 . V_118 = & V_122 ;
V_16 -> V_120 = & V_123 ;
}
V_16 -> V_74 . V_30 = 512 ;
V_16 -> V_74 . V_76 = 10 ;
V_16 -> V_74 . V_124 = 4 ;
V_16 -> V_74 . V_125 = F_41 ;
V_16 -> V_74 . V_126 = F_42 ;
V_16 -> V_74 . V_127 = V_128 ;
V_2 -> V_48 |= V_129 | V_130 | V_131 ;
} else {
V_16 -> V_74 . V_127 = V_132 ;
}
return 0 ;
}
static int T_6 F_62 ( struct V_133 * V_5 )
{
struct V_134 * V_135 ;
struct V_1 * V_2 ;
struct V_11 * V_136 ;
...
V_2 = F_63 ( sizeof( struct V_1 ) , V_143 ) ;
if ( ! V_2 ) {
F_8 ( & V_5 -> V_6 , L_5 ) ;
return - V_144 ;
}
V_135 = F_64 ( V_5 , V_145 , 0 ) ;
if ( ! V_135 ) {
F_8 ( & V_5 -> V_6 , L_6 ) ;
goto V_146;
}
V_2 -> V_147 = F_65 ( V_135 -> V_148 , F_66 ( V_135 ) ) ;
if ( V_2 -> V_147 == NULL ) {
F_8 ( & V_5 -> V_6 , L_7 ) ;
goto V_146;
}
...
V_2 -> V_5 = V_5 ;
V_2 -> V_48 = V_139 -> V_47 ;
V_2 -> V_97 = V_139 -> V_150 ;
V_2 -> V_111 = V_139 -> V_151 ;
V_137 -> V_152 = 20 ;
V_137 -> V_153 = F_57 ;
V_137 -> V_85 = F_56 ;
V_137 -> V_80 = F_59 ;
...
if ( V_90 )
goto V_158;
F_72 ( V_136 , V_139 -> V_159 , V_139 -> V_160 ) ;
return 0 ;
V_158:
F_73 ( & V_5 -> V_6 ) ;
V_146:
...
static int T_7 F_75 ( struct V_133 * V_5 )
{
