...
int V_55 = 0 ;
V_20 = F_2 ( V_2 ) ;
F_9 ( F_21 ( V_20 -> V_21 ) , V_54 -> V_56 ) ;
F_9 ( F_22 ( V_20 -> V_21 ) , V_54 -> V_57 ) ;
F_9 ( F_23 ( V_20 -> V_21 ) , V_54 -> V_58 ) ;
...
static void
F_24 ( struct V_1 * V_2 , struct V_53 * V_54 )
{
struct V_15 * V_16 = V_2 -> V_16 ;
struct V_17 * V_18 = V_16 -> V_19 ;
struct V_20 * V_20 ;
T_2 V_22 ;
V_20 = F_2 ( V_2 ) ;
V_54 -> V_56 = F_3 ( F_21 ( V_20 -> V_21 ) ) ;
V_54 -> V_57 = F_3 ( F_22 ( V_20 -> V_21 ) ) ;
V_54 -> V_58 = F_3 ( F_23 ( V_20 -> V_21 ) ) ;
V_54 -> V_61 = 0 ;
V_22 = F_3 ( F_4 ( V_20 -> V_21 ) ) ;
if ( V_22 & V_60 )
V_54 -> V_61 = V_62 ;
...
int V_55 = 0 ;
V_20 = F_2 ( V_2 ) ;
F_9 ( F_42 ( V_20 -> V_21 ) , V_54 -> V_56 ) ;
F_9 ( F_43 ( V_20 -> V_21 ) , V_54 -> V_57 ) ;
F_9 ( F_44 ( V_20 -> V_21 ) , V_54 -> V_58 ) ;
V_65 = F_3 ( F_26 ( V_20 -> V_21 ) ) ;
V_65 &= ~ ( V_84 | V_85 ) ;
if ( V_54 -> V_61 & V_62 )
V_65 |= V_85 ;
else if ( V_54 -> V_61 & V_63 )
V_65 |= V_84 ;
F_9 ( F_26 ( V_20 -> V_21 ) , V_65 ) ;
F_18 ( F_44 ( V_20 -> V_21 ) ) ;
return V_55 ;
}
static void
F_45 ( struct V_1 * V_2 , struct V_53 * V_54 )
{
struct V_15 * V_16 = V_2 -> V_16 ;
struct V_17 * V_18 = V_16 -> V_19 ;
struct V_20 * V_20 ;
T_2 V_65 ;
V_20 = F_2 ( V_2 ) ;
V_54 -> V_56 = F_3 ( F_42 ( V_20 -> V_21 ) ) ;
V_54 -> V_57 = F_3 ( F_43 ( V_20 -> V_21 ) ) ;
V_54 -> V_58 = F_3 ( F_44 ( V_20 -> V_21 ) ) ;
V_54 -> V_61 = 0 ;
V_65 = F_3 ( F_26 ( V_20 -> V_21 ) ) ;
if ( V_65 & V_85 )
V_54 -> V_61 = V_62 ;
...
return - V_98 ;
F_49 ( & V_16 -> V_113 . V_114 ) ;
V_6 = F_59 ( V_16 , V_109 -> V_115 , V_116 ) ;
if ( ! V_6 ) {
V_55 = - V_98 ;
goto V_102;
}
V_2 = F_60 ( V_6 ) ;
V_20 = F_2 ( V_2 ) ;
V_55 = V_20 -> V_117 ( V_2 , V_109 ) ;
V_102:
F_51 ( & V_16 -> V_113 . V_114 ) ;
return V_55 ;
}
int F_61 ( struct V_15 * V_16 , void * V_106 ,
struct V_107 * V_108 )
{
struct V_53 * V_118 = V_106 ;
struct V_110 * V_6 ;
struct V_1 * V_2 ;
struct V_20 * V_20 ;
int V_55 = 0 ;
...
return - V_112 ;
F_49 ( & V_16 -> V_113 . V_114 ) ;
V_6 = F_59 ( V_16 , V_118 -> V_115 , V_116 ) ;
if ( ! V_6 ) {
V_55 = - V_98 ;
goto V_102;
}
...
int
F_62 ( struct V_15 * V_16 , enum V_21 V_21 )
{
struct V_20 * V_20 ;
unsigned long V_120 ;
const T_1 * V_121 ;
int V_122 ;
int V_55 ;
if ( F_63 ( V_16 ) -> V_123 < 5 )
return - V_112 ;
V_20 = F_64 ( sizeof( struct V_20 ) , V_124 ) ;
if ( ! V_20 )
return - V_125 ;
switch ( F_63 ( V_16 ) -> V_123 ) {
case 5 :
case 6 :
V_20 -> V_100 = 16 ;
V_20 -> V_104 = F_25 ;
...
V_20 -> V_21 = V_21 ;
V_120 = ( 1 << V_21 ) ;
V_55 = F_66 ( V_16 , & V_20 -> V_128 , V_120 ,
& V_129 ,
V_121 , V_122 ,
false ) ;
if ( V_55 )
