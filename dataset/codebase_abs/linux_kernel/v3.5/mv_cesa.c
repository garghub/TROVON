...
static int F_76 ( struct V_78 * V_44 )
{
const struct V_79 * V_80 = F_5 ( V_44 -> V_46 . V_18 ) ;
...
static void F_77 ( struct V_79 * V_2 , const void * V_166 ,
const void * V_167 )
{
const struct V_113 * V_168 = V_166 , * V_169 = V_167 ;
int V_112 ;
for ( V_112 = 0 ; V_112 < 5 ; V_112 ++ ) {
V_2 -> V_89 [ V_112 ] = F_78 ( V_168 -> V_104 [ V_112 ] ) ;
V_2 -> V_89 [ V_112 + 5 ] = F_78 ( V_169 -> V_104 [ V_112 ] ) ;
}
}
static int F_79 ( struct V_170 * V_18 , const T_1 * V_15 ,
unsigned int V_171 )
{
int V_119 ;
...
if ( ! V_2 -> V_175 )
return 0 ;
V_119 = F_80 ( V_2 -> V_118 , V_15 , V_171 ) ;
if ( V_119 )
return V_119 ;
V_172 = F_81 ( V_2 -> V_175 ) ;
V_173 = F_82 ( V_2 -> V_175 ) ;
V_174 = F_83 ( V_2 -> V_175 ) ;
{
struct {
struct V_110 V_117 ;
...
V_111 . V_117 . V_120 = F_84 ( V_2 -> V_175 ) &
V_121 ;
if ( V_171 > V_172 ) {
int V_178 ;
V_178 =
F_85 ( & V_111 . V_117 , V_15 , V_171 , V_176 ) ;
if ( V_178 )
return V_178 ;
V_171 = V_173 ;
} else
...
F_86 ( & V_111 . V_117 , V_176 ) ? :
F_36 ( & V_111 . V_117 ) ? :
F_37 ( & V_111 . V_117 , V_177 , V_172 ) ? :
F_86 ( & V_111 . V_117 , V_177 ) ;
if ( V_119 == 0 )
F_77 ( V_2 , V_176 , V_177 ) ;
return V_119 ;
}
}
static int F_87 ( struct V_17 * V_18 , const char * V_179 ,
...
{
return F_87 ( V_18 , NULL , V_83 , 0 ) ;
}
static int F_97 ( struct V_17 * V_18 )
{
return F_87 ( V_18 , L_3 , V_86 , V_151 ) ;
}
T_3 F_98 ( int V_188 , void * V_189 )
{
V_91 V_190 ;
...
static int F_99 ( struct V_196 * V_197 )
{
struct V_198 * V_199 ;
struct V_200 * V_201 ;
int V_188 ;
int V_26 ;
if ( V_34 ) {
F_90 (KERN_ERR MV_CESA L_4 ) ;
return - V_202 ;
}
V_201 = F_100 ( V_197 , V_203 , L_5 ) ;
if ( ! V_201 )
return - V_204 ;
V_199 = F_101 ( sizeof( * V_199 ) , V_205 ) ;
if ( ! V_199 )
return - V_185 ;
F_102 ( & V_199 -> V_156 ) ;
F_103 ( & V_199 -> V_157 , 50 ) ;
V_199 -> V_75 = F_104 ( V_201 -> V_206 , F_105 ( V_201 ) ) ;
if ( ! V_199 -> V_75 ) {
V_26 = - V_185 ;
goto V_178;
}
V_201 = F_100 ( V_197 , V_203 , L_6 ) ;
if ( ! V_201 ) {
V_26 = - V_204 ;
goto V_207;
}
V_199 -> V_208 = F_105 ( V_201 ) ;
V_199 -> V_38 = V_199 -> V_208 - V_209 ;
V_199 -> V_39 = F_104 ( V_201 -> V_206 , V_199 -> V_208 ) ;
if ( ! V_199 -> V_39 ) {
V_26 = - V_185 ;
goto V_207;
}
...
F_107 ( V_197 , V_199 ) ;
V_34 = V_199 ;
V_199 -> V_162 = F_108 ( F_51 , V_199 , L_7 ) ;
if ( F_89 ( V_199 -> V_162 ) ) {
V_26 = F_91 ( V_199 -> V_162 ) ;
goto V_211;
}
V_26 = F_109 ( V_188 , F_98 , V_212 , F_110 ( & V_197 -> V_213 ) ,
V_199 ) ;
if ( V_26 )
goto V_214;
V_199 -> V_215 = F_111 ( & V_197 -> V_213 , NULL ) ;
if ( ! F_89 ( V_199 -> V_215 ) )
F_112 ( V_199 -> V_215 ) ;
F_19 ( V_192 , V_34 -> V_75 + V_216 ) ;
F_19 ( V_217 , V_34 -> V_75 + V_218 ) ;
F_19 ( V_73 , V_34 -> V_75 + V_219 ) ;
V_26 = F_113 ( & V_220 ) ;
if ( V_26 ) {
F_90 (KERN_WARNING MV_CESA
L_8 ) ;
...
F_90 (KERN_WARNING MV_CESA L_10 ) ;
V_26 = F_114 ( & V_226 ) ;
if ( V_26 == 0 ) {
V_34 -> V_227 = 1 ;
} else {
...
{
struct V_198 * V_199 = F_121 ( V_197 ) ;
F_115 ( & V_220 ) ;
F_115 ( & V_222 ) ;
if ( V_199 -> V_225 )
F_122 ( & V_224 ) ;
