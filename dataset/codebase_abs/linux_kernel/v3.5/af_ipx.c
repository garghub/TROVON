...
static int F_90 ( unsigned int V_160 , void T_1 * V_10 )
{
int V_2 = - V_111 ;
struct V_161 V_162 ;
int V_6 ;
...
struct V_126 V_166 ;
V_2 = - V_13 ;
if ( F_91 ( & V_162 , V_10 , sizeof( V_162 ) ) )
break;
...
sizeof( V_166 . V_143 ) ) ;
memcpy ( V_166 . V_36 , V_165 -> V_172 , V_39 ) ;
...
T_2 F_93 ( struct V_59 * V_181 , int V_182 )
{
T_7 * V_183 = ( T_7 * ) V_181 ;
T_8 V_184 = V_183 [ 1 ] + ( V_183 [ 2 ] & ( V_185 V_186 ) F_64 ( 0x00ff ) ) ;
T_8 V_23 = ( V_182 >> 1 ) - 3 ;
V_183 += 3 ;
while ( V_23 -- )
V_184 += * V_183 ++ ;
if ( V_181 -> V_116 & F_64 ( 1 ) )
V_184 += ( V_185 V_186 ) F_64 ( 0xff00 ) & * V_183 ;
...
static int F_94 ( struct V_189 * V_14 , int V_190 , int V_191 ,
...
goto V_17;
V_2 = - V_13 ;
if ( F_92 ( V_194 , ( unsigned int T_1 * ) V_192 ) )
goto V_17;
V_2 = - V_195 ;
...
static int F_97 ( struct V_189 * V_14 , int V_190 , int V_191 ,
...
goto V_17;
V_2 = - V_13 ;
if ( F_99 ( V_79 , V_193 ) || F_6 ( V_192 , & V_6 , V_79 ) )
goto V_17;
V_2 = 0 ;
V_17:
F_96 ( V_15 ) ;
...
static int F_100 ( struct V_27 * V_27 , struct V_189 * V_14 , int V_100 ,
int V_198 )
{
int V_2 = - V_199 ;
struct V_14 * V_15 ;
...
goto V_17;
V_2 = - V_66 ;
V_15 = F_101 ( V_27 , V_202 , V_203 , & V_204 ) ;
if ( ! V_15 )
goto V_17;
F_102 ( V_15 ) ;
F_103 ( V_14 , V_15 ) ;
...
static int F_104 ( struct V_189 * V_14 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
if ( ! V_15 )
goto V_17;
...
static int F_108 ( struct V_189 * V_14 ,
...
int V_2 = - V_111 ;
if ( ! F_105 ( V_15 , V_44 ) || V_86 != sizeof( struct V_164 ) )
goto V_17;
...
goto V_17;
if ( ! V_214 -> V_215 ) {
V_214 -> V_215 = F_107 ( V_16 ) ;
V_2 = - V_111 ;
if ( ! V_214 -> V_215 )
goto V_74;
}
V_2 = - V_216 ;
if ( F_52 ( V_214 -> V_215 ) < V_125 &&
! F_109 ( V_217 ) )
goto V_74;
V_38 -> V_32 = V_214 -> V_215 ;
#ifdef F_110
if ( V_16 == V_45 ) {
V_2 = - V_111 ;
if ( ! memcmp ( V_214 -> V_172 , V_63 , V_39 ) )
goto V_74;
if ( ! memcmp ( V_214 -> V_172 , V_218 , V_39 ) )
memcpy ( V_38 -> V_5 , V_16 -> V_97 , V_39 ) ;
else
memcpy ( V_38 -> V_5 , V_214 -> V_172 , V_39 ) ;
V_2 = - V_131 ;
...
static int F_113 ( struct V_189 * V_14 , struct V_212 * V_213 , int V_86 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
int V_2 ;
F_95 ( V_15 ) ;
V_2 = F_108 ( V_14 , V_213 , V_86 ) ;
F_96 ( V_15 ) ;
return V_2 ;
}
static int F_114 ( struct V_189 * V_14 , struct V_212 * V_213 ,
int V_86 , int V_95 )
{
struct V_14 * V_15 = V_14 -> V_15 ;
struct V_37 * V_38 = F_8 ( V_15 ) ;
...
if ( ! V_38 -> V_16 )
goto V_17;
memcpy ( V_213 . V_172 , V_38 -> V_16 -> V_97 ,
V_39 ) ;
#endif
V_2 = F_108 ( V_14 , (struct V_212 * ) & V_213 ,
sizeof( struct V_164 ) ) ;
if ( V_2 )
goto V_17;
}
V_220 = F_115 ( V_214 -> V_170 ) ;
V_2 = - V_225 ;
if ( ! V_220 && ! ( ! V_214 -> V_170 && V_8 ) )
goto V_17;
V_38 -> V_226 . V_27 = V_214 -> V_170 ;
V_38 -> V_226 . V_14 = V_214 -> V_215 ;
memcpy ( V_38 -> V_226 . V_5 , V_214 -> V_172 , V_39 ) ;
V_38 -> type = V_214 -> V_173 ;
if ( V_14 -> type == V_201 ) {
V_14 -> V_223 = V_227 ;
V_15 -> V_221 = V_228 ;
}
...
static int F_117 ( struct V_189 * V_14 , struct V_212 * V_213 ,
int * V_229 , int V_230 )
{
struct V_231 * V_214 ;
struct V_164 V_165 ;
...
memcpy ( V_165 . V_172 , V_214 -> V_5 , V_39 ) ;
} else {
if ( V_38 -> V_16 ) {
V_165 . V_170 = V_38 -> V_16 -> V_28 ;
#ifdef F_110
memcpy ( V_165 . V_172 , V_38 -> V_5 , V_39 ) ;
#else
memcpy ( V_165 . V_172 , V_38 -> V_16 -> V_97 ,
V_39 ) ;
#endif
} else {
V_165 . V_170 = 0 ;
memset ( V_165 . V_172 , '\0' , V_39 ) ;
}
V_165 . V_215 = V_38 -> V_32 ;
}
V_165 . V_168 = V_169 ;
V_165 . V_173 = V_38 -> type ;
V_165 . V_233 = 0 ;
...
static int F_118 ( struct V_56 * V_57 , struct V_20 * V_21 , struct V_234 * V_235 , struct V_20 * V_236 )
{
struct V_1 * V_16 ;
struct V_59 * V_60 ;
V_186 V_116 ;
...
static int F_121 ( struct V_241 * V_242 , struct V_189 * V_14 ,
...
V_245 = & V_247 ;
V_245 -> V_168 = V_169 ;
V_245 -> V_173 = V_38 -> type ;
V_245 -> V_215 = V_38 -> V_226 . V_14 ;
V_245 -> V_170 = V_38 -> V_226 . V_27 ;
memcpy ( V_245 -> V_172 , V_38 -> V_226 . V_5 , V_39 ) ;
}
V_2 = F_122 ( V_15 , V_245 , V_244 -> V_252 , V_79 ,
V_95 & V_249 ) ;
if ( V_2 >= 0 )
V_2 = V_79 ;
V_17:
...
static int F_123 ( struct V_241 * V_242 , struct V_189 * V_14 ,
...
if ( ! V_38 -> V_16 )
goto V_17;
memcpy ( V_213 . V_172 , V_38 -> V_16 -> V_97 , V_39 ) ;
#endif
V_2 = F_108 ( V_14 , (struct V_212 * ) & V_213 ,
sizeof( struct V_164 ) ) ;
if ( V_2 )
...
if ( F_105 ( V_15 , V_44 ) )
goto V_17;
V_57 = F_124 ( V_15 , V_95 & ~ V_249 ,
V_95 & V_249 , & V_2 ) ;
if ( ! V_57 )
goto V_17;
V_60 = F_49 ( V_57 ) ;
V_254 = F_52 ( V_60 -> V_116 ) - sizeof( struct V_59 ) ;
if ( V_254 > V_253 ) {
V_254 = V_253 ;
V_244 -> V_248 |= V_255 ;
}
V_2 = F_125 ( V_57 , sizeof( struct V_59 ) , V_244 -> V_252 ,
V_254 ) ;
if ( V_2 )
goto V_256;
if ( V_57 -> V_257 . V_258 )
...
memcpy ( V_165 -> V_172 , V_60 -> V_89 . V_5 , V_39 ) ;
V_165 -> V_170 = F_61 ( V_57 ) -> V_90 ;
...
static int F_127 ( struct V_189 * V_14 , unsigned int V_160 , unsigned long V_10 )
{
int V_2 = 0 ;
long V_260 = 0 ;
struct V_14 * V_15 = V_14 -> V_15 ;
...
switch ( V_160 ) {
case V_262 :
V_260 = V_15 -> V_263 - F_128 ( V_15 ) ;
if ( V_260 < 0 )
V_260 = 0 ;
V_2 = F_99 ( V_260 , ( int T_1 * ) V_261 ) ;
break;
case V_264 : {
...
static int F_132 ( struct V_189 * V_14 , unsigned int V_160 , unsigned long V_10 )
{
switch ( V_160 ) {
case V_179 :
case V_180 :
...
F_71 ( V_282 ) ;
V_146 = F_139 ( V_283 , F_118 ) ;
if ( ! V_146 )
F_71 ( V_284 ) ;
V_149 = F_140 ( V_285 , F_118 ) ;
if ( ! V_149 )
F_71 ( V_286 ) ;
F_141 ( & V_287 ) ;
F_142 () ;
