...
if ( V_41 )
goto V_67;
V_5 = F_33 ( sizeof( struct V_4 ) , V_68 ) ;
if ( ! V_5 ) {
V_41 = - V_69 ;
goto V_70;
}
V_5 -> V_8 = F_34 ( V_61 -> V_71 . V_72 , F_35 ( & V_61 -> V_71 ) ) ;
if ( ! V_5 -> V_8 ) {
V_41 = - V_69 ;
goto V_73;
}
...
V_5 -> V_74 = F_36 ( V_61 ) ;
V_5 -> V_75 = F_37 ( V_61 ) ;
F_38 ( & V_61 -> V_2 , L_2 , V_5 -> V_74 ) ;
F_38 ( & V_61 -> V_2 , L_3 , V_5 -> V_75 ) ;
if ( V_5 -> V_74 == V_76 )
...
V_5 -> V_57 = F_39 ( L_4 , & V_61 -> V_2 , V_65 ,
V_79 ) ;
if ( F_40 ( V_5 -> V_57 ) ) {
V_41 = F_41 ( V_5 -> V_57 ) ;
goto V_80;
