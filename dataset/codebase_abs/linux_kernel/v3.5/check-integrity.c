...
struct V_168 * const V_169 = (struct V_168 * ) V_125 -> V_139 ;
if ( - 1 == V_125 -> V_48 ) {
V_125 -> V_145 = F_61 ( V_169 -> V_146 . V_147 ) ;
if ( V_42 -> V_82 & V_148 )
F_31 ( V_76 L_22
L_23 ,
( unsigned long long )
V_125 -> V_138 -> V_96 ,
V_169 -> V_146 . V_142 , V_125 -> V_145 ,
( unsigned long long )
F_60 ( V_169 -> V_146 . V_8 ) ,
( unsigned long long )
F_60 ( V_169 -> V_146 . V_149 ) ) ;
}
V_170:
if ( 0 == V_125 -> V_80 || V_125 -> V_18 > V_125 -> V_80 ) {
V_125 -> V_48 ++ ;
...
T_2 V_173 ;
T_1 V_81 ;
V_173 = ( V_52 ) ( V_169 -> V_174 + V_125 -> V_48 ) -
( V_52 ) V_169 ;
if ( V_173 + sizeof( struct V_171 ) >
V_125 -> V_138 -> V_156 ) {
F_31 ( V_76
L_24 ,
V_125 -> V_138 -> V_96 ,
...
F_62 (
V_125 -> V_138 , & V_172 , V_173 ,
sizeof( struct V_171 ) ) ;
V_81 = F_60 ( V_172 . V_175 ) ;
V_125 -> error = F_64 (
V_42 ,
V_125 -> V_137 ,
V_125 -> V_138 ,
...
static void F_62 (
struct V_90 * V_138 ,
void * V_176 , T_2 V_12 , T_4 V_156 )
{
T_4 V_177 ;
T_4 V_178 ;
char * V_179 ;
char * V_180 = ( char * ) V_176 ;
T_4 V_181 = V_138 -> V_96 & ( ( T_1 ) V_95 - 1 ) ;
unsigned long V_48 = ( V_181 + V_12 ) >> V_182 ;
F_66 ( V_12 + V_156 > V_138 -> V_156 ) ;
V_178 = ( V_181 + V_12 ) &
( ( unsigned long ) V_95 - 1 ) ;
while ( V_156 > 0 ) {
V_177 = F_67 ( V_156 , ( ( T_4 ) V_95 - V_178 ) ) ;
F_6 ( V_48 >= ( V_138 -> V_156 + V_95 - 1 ) >>
V_182 ) ;
V_179 = V_138 -> V_135 [ V_48 ] ;
memcpy ( V_180 , V_179 + V_178 , V_177 ) ;
V_180 += V_177 ;
V_156 -= V_177 ;
V_178 = 0 ;
V_48 ++ ;
...
if ( V_136 > 0 && V_187 ) {
V_67 = F_41 ( V_42 , V_164 ) ;
if ( V_67 < ( int ) V_164 -> V_156 ) {
F_31 ( V_76
L_32 ,
( unsigned long long ) V_81 ) ;
F_42 ( V_164 ) ;
...
T_1 V_8 ;
struct V_30 * V_31 ;
V_191 = F_63 ( struct V_143 , V_154 ) +
V_155 ;
if ( V_191 +
F_63 ( struct V_189 , V_193 ) >
V_138 -> V_156 ) {
F_31 ( V_76
L_33 ,
...
V_191 ,
sizeof( struct V_189 ) ) ;
V_81 = F_60 ( V_190 . V_195 ) +
F_60 ( V_190 . V_12 ) ;
V_8 = F_60 ( V_190 . V_8 ) ;
V_192 = F_60 ( V_190 . V_192 ) ;
V_8 = F_60 ( V_190 . V_8 ) ;
if ( V_42 -> V_82 & V_196 )
F_31 ( V_76 L_35
L_36 ,
...
( unsigned long long )
F_60 ( V_190 . V_195 ) ,
( unsigned long long ) F_60 ( V_190 . V_12 ) ,
...
static int F_40 ( struct V_64 * V_42 , T_1 V_163 , T_2 V_156 ,
struct V_90 * V_198 ,
int V_18 )
{
int V_67 ;
...
struct V_72 * V_73 ;
V_199 = V_156 ;
V_67 = F_70 ( & V_42 -> V_84 -> V_85 -> V_86 , V_202 ,
V_163 , & V_199 , & V_201 , V_18 ) ;
V_73 = V_201 -> V_203 [ 0 ] . V_92 ;
V_198 -> V_92 = F_33 ( V_73 -> V_41 ) ;
V_198 -> V_6 = V_201 -> V_203 [ 0 ] . V_204 ;
V_198 -> V_96 = V_163 ;
V_198 -> V_156 = V_156 ;
V_198 -> V_135 = NULL ;
V_198 -> V_205 = NULL ;
...
static int F_71 ( struct V_64 * V_42 , T_1 V_163 ,
T_2 V_156 , struct V_53 * V_41 ,
struct V_90 * V_198 )
{
V_198 -> V_92 = F_33 ( V_41 ) ;
V_198 -> V_6 = V_163 ;
V_198 -> V_96 = V_163 ;
V_198 -> V_156 = V_156 ;
V_198 -> V_135 = NULL ;
...
F_6 ( ! V_138 -> V_135 ) ;
F_6 ( ! V_138 -> V_205 ) ;
V_208 = ( V_138 -> V_156 + ( T_1 ) V_95 - 1 ) >>
V_182 ;
while ( V_208 > 0 ) {
V_208 -- ;
if ( V_138 -> V_135 [ V_208 ] ) {
F_72 ( V_138 -> V_205 [ V_208 ] ) ;
V_138 -> V_135 [ V_208 ] = NULL ;
}
if ( V_138 -> V_205 [ V_208 ] ) {
F_73 ( V_138 -> V_205 [ V_208 ] ) ;
V_138 -> V_205 [ V_208 ] = NULL ;
}
}
F_7 ( V_138 -> V_206 ) ;
V_138 -> V_206 = NULL ;
...
V_208 = ( V_138 -> V_156 + ( T_1 ) V_95 - 1 ) >>
V_182 ;
V_138 -> V_206 = F_4 ( ( sizeof( * V_138 -> V_135 ) +
sizeof( * V_138 -> V_205 ) ) *
V_208 , V_29 ) ;
if ( ! V_138 -> V_206 )
return - 1 ;
V_138 -> V_135 = V_138 -> V_206 ;
V_138 -> V_205 = (struct V_209 * * ) ( V_138 -> V_135 + V_208 ) ;
for ( V_48 = 0 ; V_48 < V_208 ; V_48 ++ ) {
V_138 -> V_205 [ V_48 ] = F_74 ( V_29 ) ;
if ( ! V_138 -> V_205 [ V_48 ] )
return - 1 ;
}
V_6 = V_138 -> V_6 ;
for ( V_48 = 0 ; V_48 < V_208 ; ) {
struct V_22 * V_22 ;
unsigned int V_210 ;
F_75 ( V_211 ) ;
V_22 = F_76 ( V_29 , V_208 - V_48 ) ;
if ( ! V_22 ) {
F_31 ( V_76
L_50 ,
V_208 - V_48 ) ;
...
V_22 -> V_212 = V_138 -> V_92 -> V_41 ;
V_22 -> V_213 = V_6 >> 9 ;
V_22 -> V_214 = V_215 ;
V_22 -> V_216 = & V_211 ;
for ( V_210 = V_48 ; V_210 < V_208 ; V_210 ++ ) {
V_67 = F_77 ( V_22 , V_138 -> V_205 [ V_210 ] ,
V_95 , 0 ) ;
if ( V_95 != V_67 )
break;
}
...
for ( V_48 = 0 ; V_48 < V_208 ; V_48 ++ ) {
V_138 -> V_135 [ V_48 ] = F_82 ( V_138 -> V_205 [ V_48 ] ) ;
if ( ! V_138 -> V_135 [ V_48 ] ) {
F_31 ( V_76 L_53 ,
V_138 -> V_92 -> V_43 ) ;
return - 1 ;
...
static void V_215 ( struct V_22 * V_22 , int V_219 )
{
V_211 ( (struct V_220 * ) V_22 -> V_216 ) ;
}
...
const struct V_1 * const V_222 =
F_21 ( V_221 , struct V_1 ,
V_24 ) ;
struct V_54 * V_223 ;
struct V_54 * V_224 ;
F_31 ( V_76 L_55 ,
F_68 ( V_42 , V_222 ) ,
( unsigned long long ) V_222 -> V_7 ,
V_222 -> V_5 -> V_43 ,
( unsigned long long ) V_222 -> V_6 ,
V_222 -> V_18 ) ;
...
char * * V_135 , unsigned int V_208 )
{
struct V_133 * V_47 ;
T_3 V_225 [ V_226 ] ;
T_2 V_227 = ~ ( T_2 ) 0 ;
unsigned int V_48 ;
if ( V_208 * V_95 < V_42 -> V_87 )
return 1 ;
V_208 = V_42 -> V_87 >> V_182 ;
V_47 = (struct V_133 * ) V_135 [ 0 ] ;
if ( memcmp ( V_47 -> V_228 , V_42 -> V_84 -> V_85 -> V_228 , V_111 ) )
return 1 ;
for ( V_48 = 0 ; V_48 < V_208 ; V_48 ++ ) {
T_3 * V_229 = V_48 ? V_135 [ V_48 ] : ( V_135 [ V_48 ] + V_226 ) ;
T_4 V_230 = V_48 ? V_95 :
( V_95 - V_226 ) ;
V_227 = F_85 ( V_227 , V_229 , V_230 ) ;
}
F_86 ( V_227 , V_225 ) ;
if ( memcmp ( V_225 , V_47 -> V_225 , V_42 -> V_79 ) )
return 1 ;
return 0 ;
}
...
if ( V_137 -> V_14 )
V_67 = F_71 ( V_42 , V_163 ,
V_233 ,
V_41 , & V_138 ) ;
else
V_67 = F_40 ( V_42 , V_163 , V_233 ,
& V_138 , 0 ) ;
if ( V_67 ) {
F_31 ( V_76
L_73
L_74 , ( unsigned long long ) V_163 ) ;
goto V_237;
}
V_138 . V_135 = V_231 ;
V_138 . V_92 = V_5 ;
...
V_137 -> V_15 = 0 ;
V_137 -> V_20 = V_101 -> V_240 ;
V_137 -> V_21 . V_101 = V_101 -> V_241 ;
V_137 -> V_19 = NULL ;
V_101 -> V_240 = V_137 ;
V_101 -> V_241 = V_242 ;
} else {
...
F_6 ( NULL == V_232 ) ;
if ( ! * V_232 ) {
V_137 -> V_20 = V_22 -> V_216 ;
V_137 -> V_21 . V_22 = V_22 -> V_214 ;
V_137 -> V_19 = NULL ;
V_22 -> V_216 = V_137 ;
V_22 -> V_214 = V_238 ;
* V_232 = 1 ;
...
static void V_238 ( struct V_22 * V_244 , int V_245 )
{
struct V_1 * V_137 = (struct V_1 * ) V_244 -> V_216 ;
int V_16 ;
V_16 = 0 ;
if ( V_245 )
V_16 = 1 ;
F_6 ( NULL == V_137 ) ;
V_244 -> V_216 = V_137 -> V_20 ;
V_244 -> V_214 = V_137 -> V_21 . V_22 ;
do {
struct V_1 * V_89 ;
...
V_244 -> V_214 ( V_244 , V_245 ) ;
}
static void V_242 ( struct V_100 * V_101 , int V_249 )
{
struct V_1 * V_137 = (struct V_1 * ) V_101 -> V_240 ;
int V_16 = ! V_249 ;
struct V_38 * V_5 ;
F_6 ( NULL == V_137 ) ;
V_5 = V_137 -> V_5 ;
if ( ( V_5 -> V_42 -> V_82 & V_246 ) )
F_31 ( V_76
L_86 ,
V_16 ,
F_68 ( V_5 -> V_42 , V_137 ) ,
...
if ( V_137 -> V_27 & V_248 )
V_137 -> V_28 = 0 ;
V_101 -> V_240 = V_137 -> V_20 ;
V_101 -> V_241 = V_137 -> V_21 . V_101 ;
V_137 -> V_15 = 1 ;
V_101 -> V_241 ( V_101 , V_249 ) ;
}
static int F_94 (
struct V_64 * V_42 ,
struct V_1 * const V_250 ,
struct V_68 * const V_251 )
{
int V_75 ;
V_250 -> V_8 = F_51 ( V_251 ) ;
if ( ! ( V_250 -> V_8 > V_42 -> V_115 ||
0 == V_42 -> V_115 ) ) {
if ( V_42 -> V_82 & V_113 )
F_31 ( V_76
L_88
L_89 ,
( unsigned long long ) V_250 -> V_7 ,
V_250 -> V_5 -> V_43 ,
( unsigned long long ) V_250 -> V_6 ,
V_250 -> V_18 ,
( unsigned long long )
F_51 ( V_251 ) ,
( unsigned long long )
...
struct V_54 * V_223 ;
int V_255 ;
static char V_256 [ 80 ] ;
int V_257 ;
V_255 = sprintf ( V_256 , L_112 ,
F_68 ( V_42 , V_137 ) ,
( unsigned long long ) V_137 -> V_7 ,
V_137 -> V_5 -> V_43 ,
( unsigned long long ) V_137 -> V_6 ,
...
if ( V_31 -> V_33 > 1 )
V_255 = sprintf ( V_256 , L_116 , V_31 -> V_33 ) ;
else
V_255 = sprintf ( V_256 , L_117 ) ;
if ( V_254 + V_255 >
V_258 ) {
F_31 ( L_113 ) ;
V_257 = 0 ;
...
V_163 , V_42 -> V_87 ) ;
for ( V_18 = 1 ; V_18 <= V_80 ; V_18 ++ ) {
V_67 = F_40 ( V_42 , V_163 , V_42 -> V_87 ,
& V_138 , V_18 ) ;
if ( V_67 ) {
F_31 ( V_76 L_7
L_121
L_9 ,
( unsigned long long ) V_163 , V_18 ) ;
continue;
}
...
L_123
L_124 ,
( unsigned long long ) V_163 , V_5 -> V_43 ,
( unsigned long long ) V_6 ) ;
for ( V_18 = 1 ; V_18 <= V_80 ; V_18 ++ ) {
V_67 = F_40 ( V_42 , V_163 ,
V_42 -> V_87 ,
& V_138 , V_18 ) ;
if ( V_67 )
continue;
...
int F_96 ( int V_262 , struct V_100 * V_101 )
{
struct V_38 * V_5 ;
if ( ! V_263 )
return F_97 ( V_262 , V_101 ) ;
F_98 ( & V_264 ) ;
V_5 = F_33 ( V_101 -> V_265 ) ;
if ( NULL != V_5 &&
( V_262 & V_266 ) && V_101 -> V_267 > 0 ) {
T_1 V_6 ;
V_6 = 4096 * V_101 -> V_268 ;
if ( V_5 -> V_42 -> V_82 &
V_269 )
F_31 ( V_76
L_127
L_128 ,
V_262 , ( unsigned long ) V_101 -> V_268 ,
( unsigned long long ) V_6 ,
( unsigned long ) V_101 -> V_267 , V_101 -> V_106 ,
V_101 -> V_265 ) ;
F_87 ( V_5 , V_6 ,
& V_101 -> V_106 , 1 , NULL ,
NULL , V_101 , V_262 ) ;
} else if ( NULL != V_5 && ( V_262 & V_247 ) ) {
if ( V_5 -> V_42 -> V_82 &
V_269 )
F_31 ( V_76
L_129 ,
...
void F_100 ( int V_262 , struct V_22 * V_22 )
{
struct V_38 * V_5 ;
if ( ! V_263 ) {
F_78 ( V_262 , V_22 ) ;
...
L_133
L_134 ,
V_262 , V_22 -> V_271 , ( unsigned long ) V_22 -> V_213 ,
( unsigned long long ) V_6 ,
V_22 -> V_212 ) ;
V_231 = F_101 ( sizeof( * V_231 ) * V_22 -> V_271 ,
V_29 ) ;
if ( ! V_231 )
goto V_272;
for ( V_48 = 0 ; V_48 < V_22 -> V_271 ; V_48 ++ ) {
F_6 ( V_22 -> V_270 [ V_48 ] . V_273 != V_95 ) ;
V_231 [ V_48 ] = F_82 ( V_22 -> V_270 [ V_48 ] . V_274 ) ;
if ( ! V_231 [ V_48 ] ) {
while ( V_48 > 0 ) {
V_48 -- ;
F_72 ( V_22 -> V_270 [ V_48 ] . V_274 ) ;
}
F_7 ( V_231 ) ;
goto V_272;
}
...
F_31 ( V_76
L_135 ,
V_48 , V_22 -> V_270 [ V_48 ] . V_274 ,
V_22 -> V_270 [ V_48 ] . V_273 ,
V_22 -> V_270 [ V_48 ] . V_275 ) ;
}
F_87 ( V_5 , V_6 ,
V_231 , V_22 -> V_271 ,
V_22 , & V_232 ,
...
struct V_54 * V_70 = & V_66 -> V_71 ;
struct V_72 * V_73 ;
if ( V_84 -> V_278 != V_84 -> V_279 ) {
F_31 ( V_76
L_138 ,
V_84 -> V_278 , V_84 -> V_279 ) ;
return - 1 ;
}
if ( V_84 -> V_278 & ( ( T_1 ) V_95 - 1 ) ) {
F_31 ( V_76
L_139 ,
V_84 -> V_278 , ( unsigned long ) V_95 ) ;
return - 1 ;
}
if ( V_84 -> V_279 & ( ( T_1 ) V_95 - 1 ) ) {
F_31 ( V_76
L_140 ,
V_84 -> V_279 , ( unsigned long ) V_95 ) ;
return - 1 ;
}
...
V_42 -> V_167 = V_277 ;
V_42 -> V_79 = 0 ;
V_42 -> V_87 = V_84 -> V_278 ;
V_42 -> V_112 = V_84 -> V_280 ;
F_2 ( & V_42 -> V_114 ) ;
F_14 ( & V_42 -> V_93 ) ;
F_22 ( & V_42 -> V_94 ) ;
V_42 -> V_115 = 0 ;
...
V_39 -> V_43 [ V_282 - 1 ] = '\0' ;
for ( V_281 = V_39 -> V_43 ; * V_281 != '\0' ; V_281 ++ ) ;
while ( V_281 > V_39 -> V_43 && * V_281 != '/' )
V_281 -- ;
if ( * V_281 == '/' )
V_281 ++ ;
F_105 ( V_39 -> V_43 , V_281 , sizeof( V_39 -> V_43 ) ) ;
F_27 ( V_39 ,
& V_62 ) ;
}
V_67 = F_30 ( V_42 , V_66 ) ;
