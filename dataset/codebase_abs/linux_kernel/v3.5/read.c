...
const struct V_30 * V_31 )
{
if ( ! F_26 ( V_28 , V_29 , V_31 ) )
F_21 ( V_28 , V_29 , V_31 ) ;
}
int F_27 ( struct V_37 * V_38 , struct V_29 * V_29 ,
struct V_25 * V_25 )
{
struct V_39 * V_40 ;
unsigned int V_41 ;
...
if ( V_41 == 0 )
return F_17 ( V_25 ) ;
V_40 = F_29 ( V_38 , V_29 , V_25 , 0 , V_41 ) ;
if ( F_30 ( V_40 ) ) {
F_20 ( V_25 ) ;
return F_31 ( V_40 ) ;
}
...
static int F_58 ( struct V_12 * V_14 ,
const struct V_65 * V_66 )
{
struct V_29 * V_29 = V_14 -> V_7 -> V_29 ;
return F_48 ( F_59 ( V_29 ) , V_14 , V_66 , 0 ) ;
}
static int
...
while ( ! F_45 ( V_97 ) ) {
int V_99 ;
V_14 = F_61 ( V_97 , struct V_12 , V_100 ) ;
F_62 ( & V_14 -> V_100 ) ;
V_99 = F_58 ( V_14 , V_66 ) ;
if ( V_98 == 0 )
V_98 = V_99 ;
...
static void F_64 ( struct V_27 * V_101 ,
struct V_5 * V_6 )
{
F_65 ( V_54 , & V_6 -> V_55 ) ;
while ( ! F_45 ( & V_6 -> V_9 ) ) {
struct V_12 * V_14 = F_61 ( & V_6 -> V_9 ,
struct V_12 , V_100 ) ;
F_66 ( & V_14 -> V_100 ) ;
F_14 ( V_14 ) ;
}
...
static int F_67 ( struct V_27 * V_101 ,
struct V_5 * V_6 )
{
...
static int F_71 ( struct V_27 * V_101 ,
struct V_5 * V_6 )
{
struct V_39 * V_45 ;
struct V_25 * * V_8 ;
...
F_54 ( V_14 , V_101 -> V_106 , 0 ) ;
F_69 ( & V_14 -> V_100 , & V_6 -> V_9 ) ;
V_101 -> V_108 = & V_109 ;
return 0 ;
}
int F_73 ( struct V_27 * V_101 ,
struct V_5 * V_6 )
{
if ( V_101 -> V_35 < V_26 )
return F_67 ( V_101 , V_6 ) ;
return F_71 ( V_101 , V_6 ) ;
}
static int F_74 ( struct V_27 * V_101 )
{
struct V_1 * V_2 ;
struct V_5 * V_6 ;
int V_98 ;
...
int F_76 ( struct V_69 * V_70 , struct V_12 * V_14 )
{
struct V_29 * V_29 = V_14 -> V_7 -> V_29 ;
int V_111 ;
F_39 ( L_4 , V_112 , V_70 -> V_86 ,
V_70 -> V_113 ) ;
V_111 = F_50 ( V_29 ) -> F_77 ( V_70 , V_14 ) ;
if ( V_111 != 0 )
return V_111 ;
F_78 ( V_29 , V_114 , V_14 -> V_75 . V_87 ) ;
if ( V_70 -> V_113 == - V_115 ) {
F_65 ( V_116 , & F_35 ( V_29 ) -> V_55 ) ;
F_79 ( V_29 ) ;
}
return 0 ;
}
static void F_80 ( struct V_69 * V_70 , struct V_12 * V_14 )
{
struct V_117 * V_118 = & V_14 -> args ;
struct V_119 * V_120 = & V_14 -> V_75 ;
F_81 ( V_14 -> V_7 -> V_29 , V_121 ) ;
if ( V_120 -> V_87 == 0 ) {
F_82 ( V_14 -> V_7 , - V_122 , V_118 -> V_88 ) ;
return;
}
...
static void F_84 ( struct V_69 * V_70 , void * V_124 )
{
...
return;
if ( V_70 -> V_113 < 0 )
F_82 ( V_6 , V_70 -> V_113 , V_14 -> args . V_88 ) ;
...
static void F_88 ( void * V_124 )
{
F_14 ( V_124 ) ;
}
void F_89 ( struct V_69 * V_70 , void * V_124 )
{
struct V_12 * V_14 = V_124 ;
F_50 ( V_14 -> V_7 -> V_29 ) -> F_90 ( V_70 , V_14 ) ;
}
int F_91 ( struct V_127 * V_127 , struct V_25 * V_25 )
{
struct V_37 * V_38 ;
struct V_29 * V_29 = V_25 -> V_128 -> V_129 ;
int error ;
F_39 ( L_5 ,
V_25 , V_26 , V_25 -> V_130 ) ;
F_81 ( V_29 , V_131 ) ;
F_78 ( V_29 , V_132 , 1 ) ;
error = F_92 ( V_29 , V_25 ) ;
if ( error )
goto V_133;
if ( F_37 ( V_25 ) )
goto V_133;
...
if ( V_127 == NULL ) {
error = - V_134 ;
V_38 = F_94 ( V_29 , NULL , V_135 ) ;
if ( V_38 == NULL )
goto V_133;
} else
V_38 = F_56 ( F_95 ( V_127 ) ) ;
if ( ! F_96 ( V_29 ) ) {
error = F_97 ( V_38 , V_29 , V_25 ) ;
if ( error == 0 )
goto V_17;
}
error = F_27 ( V_38 , V_29 , V_25 ) ;
V_17:
F_15 ( V_38 ) ;
return error ;
V_133:
...
static int
F_98 ( void * V_14 , struct V_25 * V_25 )
{
struct V_136 * V_101 = (struct V_136 * ) V_14 ;
struct V_29 * V_29 = V_25 -> V_128 -> V_129 ;
struct V_39 * V_40 ;
unsigned int V_41 ;
int error ;
...
if ( V_41 == 0 )
return F_17 ( V_25 ) ;
V_40 = F_29 ( V_101 -> V_38 , V_29 , V_25 , 0 , V_41 ) ;
if ( F_30 ( V_40 ) )
goto V_137;
if ( V_41 < V_26 )
F_32 ( V_25 , V_41 , V_26 ) ;
if ( ! F_33 ( V_101 -> V_28 , V_40 ) ) {
error = V_101 -> V_28 -> V_138 ;
goto V_133;
}
return 0 ;
V_137:
...
int F_99 ( struct V_127 * V_139 , struct V_140 * V_128 ,
struct V_96 * V_8 , unsigned V_141 )
{
struct V_27 V_28 ;
struct V_136 V_101 = {
. V_28 = & V_28 ,
} ;
struct V_29 * V_29 = V_128 -> V_129 ;
unsigned long V_142 ;
int V_98 = - V_115 ;
F_39 ( L_6 ,
V_29 -> V_50 -> V_51 ,
...
goto V_17;
if ( V_139 == NULL ) {
V_101 . V_38 = F_94 ( V_29 , NULL , V_135 ) ;
if ( V_101 . V_38 == NULL )
return - V_134 ;
} else
V_101 . V_38 = F_56 ( F_95 ( V_139 ) ) ;
V_98 = F_100 ( V_101 . V_38 , V_29 , V_128 ,
V_8 , & V_141 ) ;
if ( V_98 == 0 )
goto V_144;
F_25 ( & V_28 , V_29 , & V_42 ) ;
V_98 = F_101 ( V_128 , V_8 , F_98 , & V_101 ) ;
F_34 ( & V_28 ) ;
F_35 ( V_29 ) -> V_43 += V_28 . V_44 ;
V_142 = ( V_28 . V_44 + V_26 - 1 ) >> V_145 ;
F_78 ( V_29 , V_132 , V_142 ) ;
V_144:
F_15 ( V_101 . V_38 ) ;
V_17:
return V_98 ;
