...
{
int V_51 ;
if ( V_52 && V_45 -> V_53 < V_45 -> V_49 )
return;
if ( V_54 > 0 && V_45 -> V_47 > V_54 )
V_51 = V_54 >> 1 ;
else
V_51 = V_45 -> V_47 ;
if ( V_52 > 1 && V_45 -> V_53 >= 2 * V_45 -> V_49 )
V_51 <<= 1 ;
V_45 -> V_53 = 0 ;
V_45 -> V_55 += V_51 ;
while ( V_45 -> V_55 >= V_45 -> V_47 ) {
V_45 -> V_55 -= V_45 -> V_47 ;
if ( V_45 -> V_47 < V_45 -> V_56 )
V_45 -> V_47 ++ ;
}
}
void F_42 ( struct V_44 * V_45 , T_3 V_57 )
{
if ( V_45 -> V_55 >= V_57 ) {
if ( V_45 -> V_47 < V_45 -> V_56 )
V_45 -> V_47 ++ ;
...
void F_43 ( struct V_13 * V_14 , T_3 V_58 , T_3 V_43 )
{
struct V_44 * V_45 = F_38 ( V_14 ) ;
if ( ! F_37 ( V_14 , V_43 ) )
return;
if ( V_45 -> V_47 <= V_45 -> V_59 )
F_41 ( V_45 ) ;
else if ( V_52 ) {
if ( V_45 -> V_53 >= V_45 -> V_47 * V_45 -> V_49 ) {
V_45 -> V_53 -= V_45 -> V_47 * V_45 -> V_49 ;
if ( V_45 -> V_47 < V_45 -> V_56 )
V_45 -> V_47 ++ ;
}
} else {
...
{
const struct V_44 * V_45 = F_38 ( V_14 ) ;
return F_45 ( V_45 -> V_47 >> 1U , 2U ) ;
}
T_3 F_46 ( const struct V_13 * V_14 )
{
const struct V_44 * V_45 = F_38 ( V_14 ) ;
return V_45 -> V_59 / 2 ;
}
