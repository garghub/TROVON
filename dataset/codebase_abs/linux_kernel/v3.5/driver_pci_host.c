...
F_6 ( V_2 , V_116 , V_117 ) ;
V_81 = ( unsigned long ) F_14 ( V_50 -> V_85 . V_91 ,
F_32 ( & V_50 -> V_85 ) ) ;
V_50 -> V_83 . V_81 = V_81 ;
F_33 ( V_50 -> V_83 . V_81 ) ;
F_34 ( 10 ) ;
...
static void F_36 ( struct V_118 * V_18 )
{
...
static void F_41 ( struct V_118 * V_18 )
{
struct V_120 * V_121 ;
int V_122 ;
if ( V_18 -> V_4 -> V_51 -> V_88 != F_19 ) {
...
V_52 ) ;
F_2 ( L_10 , F_37 ( V_18 ) ) ;
V_18 -> V_124 = F_44 ( V_50 -> V_53 -> V_5 ) + 2 ;
F_45 ( V_18 , V_125 , V_18 -> V_124 ) ;
return 0 ;
}
int F_46 ( const struct V_118 * V_18 )
{
struct V_49 * V_50 ;
if ( V_18 -> V_4 -> V_51 -> V_88 != F_19 ) {
return - V_123 ;
