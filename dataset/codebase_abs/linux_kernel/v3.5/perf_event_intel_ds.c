...
if ( F_29 ( & V_55 , V_49 , V_57 . V_65 * ( V_53 - V_52 ) ) )
return 1 ;
for (; V_52 < V_53 ; V_52 ++ ) {
V_59 . V_64 = V_52 -> V_45 ;
V_59 . V_66 = V_52 -> V_46 ;
...
unsigned long V_64 = V_61 -> V_64 ;
int V_87 = 0 ;
if ( ! V_12 . V_88 . V_89 )
return 1 ;
if ( ! V_43 -> V_90 . V_91 || ! V_45 || ! V_46 )
return 0 ;
if ( F_40 ( V_64 ) != F_40 ( V_46 ) )
return 0 ;
if ( ( V_64 - V_46 ) > V_92 )
return 0 ;
if ( V_64 == V_46 ) {
...
if ( ! F_40 ( V_64 ) ) {
int V_97 , V_65 = V_95 ;
V_97 = F_41 ( V_94 , ( void V_98 * ) V_46 , V_65 ) ;
if ( V_97 != V_65 )
return 0 ;
V_96 = V_94 ;
} else
...
static void F_51 ( struct V_60 * V_101 )
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
struct V_2 * V_3 = V_43 -> V_3 ;
...
F_53 ( V_108 > 1 ) ;
V_52 += V_108 - 1 ;
F_46 ( V_49 , V_101 , V_52 ) ;
}
static void F_54 ( struct V_60 * V_101 )
{
struct V_4 * V_43 = & F_25 ( V_4 ) ;
struct V_2 * V_3 = V_43 -> V_3 ;
...
if ( ! F_52 ( V_112 , V_43 -> V_109 ) )
continue;
F_53 ( ! V_49 ) ;
if ( ! V_49 -> V_72 . V_73 )
continue;
if ( F_56 ( V_112 , ( unsigned long * ) & V_111 ) )
continue;
break;
}
if ( ! V_49 || V_112 >= V_113 )
