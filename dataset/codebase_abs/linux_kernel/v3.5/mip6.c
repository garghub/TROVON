...
{
if ( V_30 -> V_105 . V_106 ) {
F_40 ( L_4 , V_107 , V_30 -> V_105 . V_106 ) ;
return - V_108 ;
}
if ( V_30 -> V_49 . V_109 != V_110 ) {
F_40 ( L_5 ,
V_107 , V_110 , V_30 -> V_49 . V_109 ) ;
return - V_108 ;
}
...
{
const struct V_31 * V_32 = F_13 ( V_8 ) ;
struct V_111 * V_112 = (struct V_111 * ) V_8 -> V_3 ;
int V_35 = V_112 -> V_113 . V_36 ;
F_14 ( & V_30 -> V_37 ) ;
...
V_36 = * F_21 ( V_8 ) ;
* F_21 ( V_8 ) = V_114 ;
V_112 = (struct V_111 * ) F_9 ( V_8 ) ;
V_112 -> V_113 . V_36 = V_36 ;
V_112 -> V_113 . V_51 = ( V_30 -> V_49 . V_50 >> 3 ) - 1 ;
V_112 -> V_113 . type = V_115 ;
V_112 -> V_113 . V_116 = 1 ;
memset ( & V_112 -> V_117 , 0 , sizeof( V_112 -> V_117 ) ) ;
F_25 ( V_112 -> V_113 . V_51 != 2 ) ;
memcpy ( & V_112 -> V_48 , & V_32 -> V_80 , sizeof( V_112 -> V_48 ) ) ;
F_23 ( & V_30 -> V_37 ) ;
...
V_30 -> V_49 . V_50 = sizeof( struct V_111 ) ;
return 0 ;
}
...
{
F_40 ( L_6 ) ;
if ( F_48 ( & V_120 , V_85 ) < 0 ) {
F_40 ( L_7 , V_107 ) ;
goto V_121;
}
if ( F_48 ( & V_122 , V_85 ) < 0 ) {
F_40 ( L_8 , V_107 ) ;
goto V_123;
}
if ( F_49 ( F_6 ) < 0 ) {
...
if ( F_52 ( F_6 ) < 0 )
F_40 ( L_10 , V_107 ) ;
if ( F_50 ( & V_122 , V_85 ) < 0 )
F_40 ( L_11 , V_107 ) ;
if ( F_50 ( & V_120 , V_85 ) < 0 )
F_40 ( L_12 , V_107 ) ;
}
