...
V_2 = F_38 ( & V_87 -> V_63 , sizeof( struct V_1 ) , V_99 ) ;
if ( ! V_2 ) {
F_34 ( & V_87 -> V_63 , L_7 ) ;
return - V_100 ;
}
...
V_2 -> V_65 = V_90 ;
V_2 -> V_20 = ( V_92 ) ? V_92 -> V_102 : V_22 ;
memset ( & V_75 , 0 , sizeof( struct V_95 ) ) ;
V_75 . type = V_103 ;
V_75 . V_104 = V_92 -> V_105 ;
...
static int T_4 F_46 ( struct V_86 * V_87 )
{
struct V_1 * V_2 = F_19 ( & V_87 -> V_63 ) ;
V_2 -> V_85 -> V_75 . V_65 = V_77 ;
