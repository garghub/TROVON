...
for ( V_30 = 0 ; V_30 < F_12 ( V_6 -> V_9 ) ; V_30 ++ ) {
...
V_31 = F_13 ( V_6 -> V_9 , F_12 ( V_6 -> V_9 ) ) ;
if ( V_31 != 0 ) {
F_11 ( & V_28 -> V_7 , L_2 , V_31 ) ;
goto V_34;
}
F_14 ( & V_28 -> V_7 , V_6 ) ;
return V_31 ;
...
if ( V_6 )
F_16 ( V_6 -> V_9 , F_12 ( V_6 -> V_9 ) ) ;
}
static int T_1 F_17 ( struct V_27 * V_28 ,
...
V_43 = F_18 ( V_28 , 0 ) ;
if ( V_43 < 0 ) {
F_11 ( & V_28 -> V_7 , L_3 , V_43 ) ;
return V_43 ;
}
V_42 = ( V_43 & 0xfe ) >> 2 ;
V_44 = V_43 & 0x3 ;
if ( V_42 != 1 ) {
F_11 ( & V_28 -> V_7 , L_4 , V_42 ) ;
return - V_45 ;
}
F_19 ( & V_28 -> V_7 , L_5 , V_44 + 1 ) ;
V_31 = F_8 ( V_28 ) ;
if ( V_31 != 0 )
return V_31 ;
...
& V_47 , 1 ) ;
if ( V_31 != 0 ) {
F_11 ( & V_28 -> V_7 , L_6 , V_31 ) ;
F_15 ( V_28 ) ;
return V_31 ;
}
return 0 ;
}
static int T_2 F_21 ( struct V_27 * V_28 )
{
F_22 ( & V_28 -> V_7 ) ;
F_15 ( V_28 ) ;
return 0 ;
