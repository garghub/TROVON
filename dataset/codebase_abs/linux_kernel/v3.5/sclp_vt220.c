...
static void F_60 ( struct F_51 * V_109 ,
enum V_110 V_110 )
{
switch ( V_110 ) {
case V_111 :
...
static void
F_61 ( struct V_114 * V_115 , const char * V_56 , unsigned int V_50 )
{
F_24 ( ( const unsigned char * ) V_56 , V_50 , 1 , 1 , 0 ) ;
}
static struct V_88 *
F_62 ( struct V_114 * V_53 , int * V_116 )
{
* V_116 = 0 ;
return V_108 ;
}
