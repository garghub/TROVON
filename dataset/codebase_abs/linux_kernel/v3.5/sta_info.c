...
if ( F_44 ( ! F_45 ( V_12 ) ) )
return - V_59 ;
if ( F_46 ( F_9 ( V_4 -> V_4 . V_7 , V_12 -> V_60 . V_7 ) ||
F_47 ( V_4 -> V_4 . V_7 ) ) )
return - V_61 ;
return 0 ;
}
...
( V_4 -> V_12 -> V_60 . type == V_125 &&
! V_4 -> V_12 -> V_126 . V_127 . V_4 ) )
F_95 ( & V_4 -> V_12 -> V_13 -> V_210 ) ;
...
( V_4 -> V_12 -> V_60 . type == V_125 &&
! V_4 -> V_12 -> V_126 . V_127 . V_4 ) )
F_159 ( & V_4 -> V_12 -> V_13 -> V_210 ) ;
F_156 ( V_211 , & V_4 -> V_207 ) ;
}
break;
default:
break;
