...
if ( V_77 >= F_46 ( V_76 ) )
return 0 ;
V_78 = ( F_46 ( V_76 ) < V_77 + V_61 ) ?
F_46 ( V_76 ) - V_77 :
V_61 ;
if ( F_49 ( ( unsigned long ) F_50 ( V_77 ) , V_78 , V_69 ) < 0 ) {
F_2 ( V_3 L_14
L_15 ,
V_56 -> V_57 , V_56 -> V_58 ,
F_27 ( V_69 ) ,
...
static int F_51 ( T_2 V_59 , unsigned long V_61 , T_5 * V_65 ,
int V_79 )
{
int V_80 = 0 ;
int V_31 ;
...
static void F_52 ( T_2 V_59 , unsigned long V_61 )
{
int V_80 ;
V_80 = F_14 ( V_59 , V_59 + V_61 ) ;
if ( V_80 == 0 )
...
V_89 = F_47 ( V_85 ) ;
return F_51 ( V_59 , V_86 , & V_89 , 1 ) ;
}
return 0 ;
}
int F_56 ( struct V_83 * V_84 , T_5 * V_85 ,
unsigned long V_39 , unsigned long V_61 )
{
unsigned long V_69 ;
T_4 V_59 ;
unsigned long V_86 = V_84 -> V_87 - V_84 -> V_88 ;
if ( F_54 ( V_84 ) ) {
V_59 = ( T_4 ) V_84 -> V_90 << V_33 ;
return F_51 ( V_59 , V_86 , V_85 , 0 ) ;
}
if ( ! V_2 )
return 0 ;
V_69 = F_33 ( V_39 << V_33 ) ;
* V_85 = F_47 ( ( F_48 ( V_84 -> V_91 ) & ( ~ V_48 ) ) |
V_69 ) ;
return 0 ;
}
void F_57 ( struct V_83 * V_84 , unsigned long V_39 ,
unsigned long V_61 )
{
T_4 V_59 ;
unsigned long V_86 = V_84 -> V_87 - V_84 -> V_88 ;
...
static struct V_42 * F_60 ( T_6 V_92 )
{
struct V_42 * V_93 ;
int V_31 ;
V_93 = F_24 ( sizeof( struct V_42 ) , V_52 ) ;
if ( ! V_93 )
return NULL ;
F_25 ( & V_54 ) ;
V_31 = F_61 ( V_93 , V_92 ) ;
...
static void * F_62 ( struct V_94 * V_95 , T_6 * V_92 )
{
if ( * V_92 == 0 ) {
++ * V_92 ;
F_63 ( V_95 , L_19 ) ;
...
static void * F_64 ( struct V_94 * V_95 , void * V_96 , T_6 * V_92 )
{
++ * V_92 ;
return F_60 ( * V_92 ) ;
}
static void F_65 ( struct V_94 * V_95 , void * V_96 )
{
}
static int F_66 ( struct V_94 * V_95 , void * V_96 )
{
struct V_42 * V_93 = (struct V_42 * ) V_96 ;
F_63 ( V_95 , L_20 , F_27 ( V_93 -> type ) ,
V_93 -> V_16 , V_93 -> V_17 ) ;
F_28 ( V_93 ) ;
return 0 ;
}
static int F_67 ( struct V_97 * V_97 , struct V_64 * V_64 )
{
return F_68 ( V_64 , & V_98 ) ;
}
