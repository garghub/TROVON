...
F_14 ( V_110 , V_114 ,
& V_111 ) ;
F_30 ( & V_110 -> V_46 , L_19
L_20 , V_111 ) ;
}
static void T_4 F_59 ( struct V_37 * V_40 )
{
void T_5 * V_41 ;
int V_115 ;
void T_5 * V_78 ;
...
if ( ! F_36 ( V_40 , 0 ) )
return;
V_41 = F_60 ( F_35 ( V_40 , 0 ) ,
F_61 ( V_40 , 0 ) ) ;
if ( V_41 == NULL )
return;
V_115 = F_62 ( V_41 , V_117 ) ;
do {
if ( ! V_115 )
goto V_118;
...
V_23 = F_40 ( V_41 + V_115 + V_122 ) ;
V_23 &= V_123 ;
V_23 |= V_124 ;
F_43 ( V_23 , V_41 + V_115 + V_122 ) ;
if ( F_55 ( V_40 ) )
F_56 ( V_40 ) ;
V_118:
V_78 = V_41 + F_64 ( F_40 ( V_41 ) ) ;
V_116 = F_52 ( V_78 + V_125 , V_126 , 0 ,
5000 , 10 ) ;
if ( V_116 ) {
V_23 = F_40 ( V_78 + V_125 ) ;
F_27 ( & V_40 -> V_46 ,
L_23
L_24 , V_23 ) ;
}
V_23 = F_40 ( V_78 + V_127 ) ;
V_23 &= ~ ( V_128 | V_129 ) ;
F_43 ( V_23 , V_78 + V_127 ) ;
V_116 = F_52 ( V_78 + V_125 , V_130 , 1 ,
V_131 , 125 ) ;
if ( V_116 ) {
V_23 = F_40 ( V_78 + V_125 ) ;
F_27 ( & V_40 -> V_46 ,
...
static void T_4 F_65 ( struct V_37 * V_40 )
{
if ( V_40 -> V_83 == 0x184e )
return;
if ( V_40 -> V_105 != V_132 &&
...
if ( V_40 -> V_105 == V_132 )
F_32 ( V_40 ) ;
else if ( V_40 -> V_105 == V_133 )
F_38 ( V_40 ) ;
else if ( V_40 -> V_105 == V_134 )
F_49 ( V_40 ) ;
