...
static int F_30 ( struct V_61 * V_62 , struct V_27 * V_63 )
{
struct V_47 * V_48 = F_31 ( V_63 ) ;
struct V_51 * V_52 = V_48 -> V_48 ;
struct V_1 * V_2 ;
int V_44 ;
if ( V_52 -> V_64 ) {
struct V_47 * V_65 = F_31 ( V_52 -> V_64 ) ;
struct V_51 * V_66 = V_65 -> V_48 ;
V_2 = V_66 -> V_53 ;
if ( ! V_2 )
return - V_67 ;
} else {
V_2 = F_32 ( sizeof( struct V_1 ) , V_68 ) ;
if ( ! V_2 ) {
F_33 ( & V_62 -> V_63 ,
L_1 ) ;
return - V_69 ;
...
static inline int F_30 ( struct V_61 * V_62 , struct V_27 * V_63 )
{
return - V_67 ;
}
...
static T_1 F_39 ( const struct V_47 * V_48 , int V_49 )
{
return F_2 ( V_48 -> V_55 + ( V_49 << 2 ) ) ;
}
static void F_29 ( const struct V_47 * V_48 ,
int V_49 , T_1 V_50 )
{
...
struct V_51 * V_52 = V_48 -> V_48 ;
T_2 V_82 ;
V_82 = F_41 ( V_52 -> V_4 + V_83 ) ;
if ( V_82 & V_52 -> V_84 )
F_42 ( V_52 -> V_84 , V_52 -> V_4 + V_83 ) ;
}
static int T_3 F_43 ( struct V_61 * V_62 ,
...
if ( V_44 )
goto V_90;
V_44 = F_46 ( V_62 , 0x2e , & V_87 ) ;
if ( V_44 )
goto V_91;
F_47 ( & V_62 -> V_63 , L_5 ,
V_62 -> V_92 , V_62 -> V_93 , V_87 ) ;
V_44 = F_48 ( V_62 , 0x44 , 0 ) ;
if ( V_44 )
goto V_91;
if ( V_87 >= 12 )
V_88 = 4 ;
...
V_88 = 1 ;
V_4 = F_49 ( V_62 , 0 , V_94 ) ;
if ( ! V_4 ) {
F_33 ( & V_62 -> V_63 , L_6 ) ;
goto V_91;
}
V_55 = F_49 ( V_62 , 1 , V_56 * V_88 ) ;
if ( ! V_55 ) {
F_33 ( & V_62 -> V_63 , L_7 ) ;
goto V_95;
}
F_42 ( 0x0005 , V_4 + V_96 + 2 ) ;
F_3 ( 0x00 , V_4 + V_96 ) ;
F_3 ( 0x05 , V_4 + V_97 + 3 ) ;
F_50 ( 5 ) ;
F_3 ( 0x04 , V_4 + V_97 + 3 ) ;
V_82 = F_41 ( V_4 + V_83 + 2 ) ;
for ( V_30 = 0 ; V_30 < V_88 ; V_30 ++ ) {
V_63 = F_51 ( sizeof( struct V_51 ) ) ;
if ( ! V_63 ) {
V_44 = - V_69 ;
goto V_98;
}
...
F_42 ( 0x0 , V_4 + V_83 + 2 ) ;
V_52 = NULL ;
for ( V_63 = F_53 ( V_62 ) ; V_63 ; V_63 = V_52 -> V_64 ) {
F_58 ( V_63 ) ;
F_57 ( V_63 ) ;
V_48 = F_31 ( V_63 ) ;
V_52 = V_48 -> V_48 ;
...
static void T_5 F_62 ( struct V_61 * V_62 )
{
struct V_27 * V_63 = F_53 ( V_62 ) ;
struct V_47 * V_48 = F_31 ( V_63 ) ;
struct V_51 * V_52 = V_48 -> V_48 ;
void T_4 * V_4 = V_52 -> V_4 ;
void T_4 * V_55 = V_48 -> V_55 ;
F_42 ( 0x0 , V_4 + V_83 + 2 ) ;
while ( 1 ) {
F_56 ( & V_62 -> V_63 , L_11 , V_63 -> V_75 ) ;
F_58 ( V_63 ) ;
F_57 ( V_63 ) ;
V_63 = V_52 -> V_64 ;
if ( ! V_63 ) {
