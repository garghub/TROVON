...
F_70 ( & V_21 -> V_52 [ V_86 ] ) ;
F_96 ( V_21 -> V_25 ) ;
F_97 ( & V_231 -> V_116 , sizeof( struct V_20 ) , V_21 ,
V_21 -> V_235 ) ;
return V_140 ;
}
static int F_98 ( struct V_222 * V_231 )
{
struct V_20 * V_21 ;
int V_86 ;
...
static int T_18 F_99 ( char * V_249 )
{
char * V_250 ;
unsigned long V_5 ;
if ( ! V_249 || ! * V_249 )
return 0 ;
while ( ( V_250 = F_100 ( & V_249 , L_25 ) ) != NULL ) {
if ( ! * V_250 )
continue;
