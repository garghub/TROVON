...
if ( ! ( V_18 -> V_39 [ V_8 ] & V_40 ) )
V_38 ++ ;
}
V_36 = F_12 ( sizeof( struct V_33 ) * V_38 , V_41 ) ;
if ( ! V_36 )
return - V_42 ;
* V_34 = V_36 ;
* V_35 = V_38 ;
...
V_36 [ 0 ] . type = V_43 ;
V_36 [ 0 ] . V_44 . V_6 . V_45 = V_37 -> V_16 ;
V_36 [ 0 ] . V_44 . V_6 . V_46 = V_32 -> V_16 ;
F_15 ( V_37 ) ;
V_36 ++ ;
for ( V_8 = 0 ; V_8 < V_18 -> V_26 ; V_8 ++ ) {
if ( ! ( V_18 -> V_39 [ V_8 ] & V_40 ) ) {
V_36 [ V_8 ] . type = V_47 ;
V_36 [ V_8 ] . V_44 . V_39 . V_48 =
F_16 ( V_22 , V_18 -> V_15 [ V_8 ] ) ;
V_36 [ V_8 ] . V_44 . V_39 . V_39 = & V_18 -> V_39 [ V_8 ] ;
V_36 [ V_8 ] . V_44 . V_39 . V_49 = 1 ;
}
}
F_17 ( V_22 -> V_14 , L_4 ,
( * V_34 ) -> V_44 . V_6 . V_45 , ( * V_34 ) -> V_44 . V_6 . V_46 , V_38 ) ;
return 0 ;
}
...
unsigned int V_26 , V_50 ;
int V_8 ;
V_15 = V_3 -> V_20 [ V_46 ] . V_15 ;
V_26 = V_3 -> V_20 [ V_46 ] . V_26 ;
V_6 = V_3 -> V_20 [ V_46 ] . V_12 ;
F_20 ( ! V_15 || ! V_26 || ! V_6 ) ;
F_17 ( V_24 -> V_14 , L_5 ,
V_3 -> V_51 [ V_25 ] . V_16 , V_3 -> V_20 [ V_46 ] . V_16 ) ;
for ( V_8 = 0 ; V_8 < V_26 ; V_8 ++ ) {
V_50 = V_15 [ V_8 ] ;
V_7 = F_1 ( V_3 , V_50 , 1 , V_6 [ V_8 ] ) ;
if ( ! V_7 )
return - V_27 ;
if ( ! V_7 -> V_52 ) {
F_2 ( V_24 -> V_14 , L_6 ,
...
F_21 ( V_6 [ V_8 ] , V_24 -> V_53 + V_7 -> V_52 ) ;
F_17 ( V_24 -> V_14 , L_7 ,
V_7 -> V_52 , V_6 [ V_8 ] ) ;
if ( V_7 -> V_54 ) {
F_21 ( V_7 -> V_55 , V_24 -> V_53 + V_7 -> V_54 ) ;
F_17 ( V_24 -> V_14 ,
L_8 ,
V_7 -> V_54 , V_7 -> V_55 ) ;
}
...
struct V_23 * V_24 = F_5 ( V_22 ) ;
const struct V_2 * V_3 = V_24 -> V_3 ;
* V_20 = V_3 -> V_51 [ V_25 ] . V_20 ;
* V_57 = V_3 -> V_51 [ V_25 ] . V_57 ;
return 0 ;
}
static int F_25 ( struct V_21 * V_22 ,
unsigned V_50 , unsigned long * V_58 )
{
struct V_23 * V_24 = F_5 ( V_22 ) ;
const struct V_2 * V_3 = V_24 -> V_3 ;
const struct V_1 * V_7 ;
V_7 = F_1 ( V_3 , V_50 , 0 , 0 ) ;
if ( ! V_7 )
return - V_27 ;
if ( ! V_7 -> V_59 ) {
F_2 ( V_3 -> V_14 , L_9 ,
...
F_17 ( V_24 -> V_14 , L_10 ,
V_3 -> V_15 [ V_50 ] . V_16 ) ;
F_21 ( V_58 , V_24 -> V_53 + V_7 -> V_59 ) ;
F_17 ( V_24 -> V_14 , L_11 ,
V_7 -> V_59 , V_58 ) ;
return 0 ;
}
static void F_28 ( struct V_21 * V_22 ,
struct V_28 * V_29 , unsigned V_50 )
{
struct V_23 * V_24 = F_5 ( V_22 ) ;
const struct V_2 * V_3 = V_24 -> V_3 ;
const struct V_1 * V_7 ;
...
struct V_28 * V_29 , unsigned V_46 )
{
struct V_23 * V_24 = F_5 ( V_22 ) ;
const struct V_2 * V_3 = V_24 -> V_3 ;
struct V_17 * V_18 ;
...
V_60 = F_25 ( V_22 , V_18 -> V_15 [ V_8 ] , & V_58 ) ;
if ( V_60 )
return;
F_9 ( V_29 , L_15 , V_16 , V_58 ) ;
}
}
static int F_30 ( const struct V_2 * V_3 ,
unsigned int V_61 , unsigned int * V_50 ,
unsigned int * V_6 )
{
if ( V_61 > V_3 -> V_9 )
return - V_27 ;
* V_50 = V_3 -> V_10 [ V_61 ] . V_11 ;
* V_6 = V_3 -> V_10 [ V_61 ] . V_12 ;
return 0 ;
}
...
unsigned int V_61 ;
int V_60 , V_63 ;
const const T_3 * V_64 ;
int V_8 , V_65 ;
T_2 V_58 ;
F_17 ( V_3 -> V_14 , L_16 , V_62 , V_32 -> V_16 ) ;
V_18 -> V_16 = V_32 -> V_16 ;
V_64 = F_32 ( V_32 , L_17 , & V_63 ) ;
V_63 /= sizeof( * V_64 ) ;
if ( ! V_63 || V_63 % 2 ) {
F_2 ( V_3 -> V_14 , L_18 ) ;
return - V_27 ;
...
V_41 ) ;
V_18 -> V_39 = F_33 ( V_3 -> V_14 , V_18 -> V_26 * sizeof( unsigned long ) ,
V_41 ) ;
for ( V_8 = 0 , V_65 = 0 ; V_8 < V_63 ; V_8 += 2 , V_65 ++ ) {
V_61 = F_34 ( * V_64 ++ ) ;
V_60 = F_30 ( V_3 , V_61 ,
& V_18 -> V_15 [ V_65 ] , & V_18 -> V_12 [ V_65 ] ) ;
if ( V_60 ) {
F_2 ( V_3 -> V_14 , L_19 ) ;
return - V_27 ;
}
...
if ( V_58 & V_66 )
V_18 -> V_12 [ V_65 ] |= V_67 ;
V_18 -> V_39 [ V_65 ] = V_58 & ~ V_66 ;
}
#ifdef F_35
F_36 ( V_3 , V_18 -> V_15 , V_18 -> V_12 , V_18 -> V_39 , V_18 -> V_26 ) ;
#endif
return 0 ;
}
static int T_1 F_37 ( struct V_31 * V_32 ,
struct V_2 * V_3 , T_2 V_62 )
{
struct V_31 * V_68 ;
struct V_69 * V_70 ;
struct V_17 * V_18 ;
...
static T_2 V_71 ;
T_2 V_8 = 0 ;
F_17 ( V_3 -> V_14 , L_20 , V_62 , V_32 -> V_16 ) ;
V_70 = & V_3 -> V_51 [ V_62 ] ;
V_70 -> V_16 = V_32 -> V_16 ;
V_70 -> V_57 = F_38 ( V_32 ) ;
if ( V_70 -> V_57 <= 0 ) {
...
V_70 -> V_57 * sizeof( char * ) , V_41 ) ;
F_39 (np, child) {
V_70 -> V_20 [ V_8 ] = V_68 -> V_16 ;
V_18 = & V_3 -> V_20 [ V_71 ++ ] ;
V_60 = F_31 ( V_68 , V_18 , V_3 , V_8 ++ ) ;
if ( V_60 )
return V_60 ;
}
return 0 ;
}
static int T_1 F_40 ( struct V_72 * V_73 ,
struct V_2 * V_3 )
{
...
V_3 -> V_56 = V_75 ;
V_3 -> V_51 = F_33 ( & V_73 -> V_14 , V_75 * sizeof( struct V_69 ) ,
V_41 ) ;
if ( ! V_3 -> V_51 )
return - V_42 ;
V_3 -> V_19 = 0 ;
...
V_3 -> V_14 = & V_73 -> V_14 ;
V_24 = F_33 ( & V_73 -> V_14 , sizeof( * V_24 ) , V_41 ) ;
if ( ! V_24 )
return - V_42 ;
V_78 = F_42 ( V_73 , V_79 , 0 ) ;
if ( ! V_78 )
return - V_80 ;
V_24 -> V_53 = F_43 ( & V_73 -> V_14 , V_78 ) ;
if ( ! V_24 -> V_53 )
return - V_81 ;
