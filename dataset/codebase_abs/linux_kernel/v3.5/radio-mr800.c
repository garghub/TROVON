...
if ( V_71 -> V_72 != 0 )
return - V_51 ;
return F_10 ( V_4 , F_29 ( unsigned , V_71 -> V_73 ,
V_55 * V_56 , V_58 * V_56 ) ) ;
}
...
{
struct V_1 * V_4 =
F_2 ( V_88 -> V_89 , struct V_1 , V_90 ) ;
switch ( V_88 -> V_91 ) {
case V_92 :
return F_9 ( V_4 , V_88 -> V_93 ) ;
}
return - V_51 ;
}
...
static int F_38 ( struct V_33 * V_34 , T_3 V_95 )
{
struct V_1 * V_4 = F_1 ( F_15 ( V_34 ) ) ;
F_16 ( & V_4 -> V_35 ) ;
if ( ! V_4 -> V_23 ) {
...
const struct V_96 * V_91 )
{
struct V_1 * V_4 ;
int V_10 = 0 ;
V_4 = F_46 ( sizeof( struct V_1 ) , V_97 ) ;
if ( ! V_4 ) {
F_47 ( & V_34 -> V_17 , L_9 ) ;
V_10 = - V_98 ;
goto V_99;
}
V_4 -> V_12 = F_48 ( V_14 , V_97 ) ;
if ( ! V_4 -> V_12 ) {
F_47 ( & V_34 -> V_17 , L_10 ) ;
V_10 = - V_98 ;
goto V_100;
...
F_52 ( & V_4 -> V_35 ) ;
V_4 -> V_3 . V_104 = & V_4 -> V_90 ;
V_4 -> V_3 . V_105 = F_41 ;
F_24 ( V_4 -> V_16 . V_52 , V_4 -> V_3 . V_52 ,
sizeof( V_4 -> V_16 . V_52 ) ) ;
V_4 -> V_16 . V_3 = & V_4 -> V_3 ;
V_4 -> V_16 . V_106 = & V_107 ;
V_4 -> V_16 . V_108 = & V_109 ;
V_4 -> V_16 . V_105 = V_110 ;
V_4 -> V_16 . V_35 = & V_4 -> V_35 ;
F_53 ( V_111 , & V_4 -> V_16 . V_112 ) ;
V_4 -> V_13 = F_54 ( V_34 ) ;
V_4 -> V_34 = V_34 ;
F_18 ( V_34 , & V_4 -> V_3 ) ;
V_4 -> V_28 = 95.16 * V_56 ;
