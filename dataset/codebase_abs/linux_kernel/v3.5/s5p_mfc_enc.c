...
F_47 ( & V_95 -> V_97 , 8 , 1920 , 1 ,
& V_95 -> V_98 , 4 , 1080 , 1 , 0 ) ;
} else {
F_45 ( L_13 ) ;
return - V_91 ;
}
...
V_18 -> V_110 = F_54 ( V_18 -> V_107 ,
V_129 ) ;
V_18 -> V_111 = F_54 ( V_18 -> V_107 ,
V_129 ) * F_54 ( V_18 -> V_108 ,
V_130 ) ;
V_18 -> V_112 = F_54 ( V_18 -> V_107 ,
V_129 ) * F_54 ( ( V_18 -> V_108
>> 1 ) , V_131 ) ;
V_18 -> V_111 = F_54 ( V_18 -> V_111 ,
V_132 ) ;
...
static int F_61 ( struct V_68 * V_68 , void * V_69 , struct V_147 * V_148 )
{
struct V_17 * V_18 = F_44 ( V_69 ) ;
if ( V_18 -> V_21 == V_153 ) {
F_45 ( L_31 ) ;
...
if ( V_148 -> type == V_106 )
return F_62 ( & V_18 -> V_114 , V_148 ) ;
else if ( V_148 -> type == V_96 )
return F_62 ( & V_18 -> V_116 , V_148 ) ;
return - V_91 ;
}
static int F_63 ( struct V_68 * V_68 , void * V_69 , struct V_147 * V_148 )
{
struct V_17 * V_18 = F_44 ( V_69 ) ;
if ( V_18 -> V_21 == V_153 ) {
F_45 ( L_32 ) ;
...
if ( V_148 -> type == V_106 )
return F_64 ( & V_18 -> V_114 , V_148 , V_68 -> V_154 & V_155 ) ;
else if ( V_148 -> type == V_96 )
return F_64 ( & V_18 -> V_116 , V_148 , V_68 -> V_154 & V_155 ) ;
return - V_91 ;
}
...
struct V_17 * V_18 = F_44 ( V_69 ) ;
if ( type == V_106 )
return F_66 ( & V_18 -> V_114 , type ) ;
else if ( type == V_96 )
return F_66 ( & V_18 -> V_116 , type ) ;
return - V_91 ;
}
...
struct V_17 * V_18 = F_44 ( V_69 ) ;
if ( type == V_106 )
return F_68 ( & V_18 -> V_114 , type ) ;
else if ( type == V_96 )
return F_68 ( & V_18 -> V_116 , type ) ;
return - V_91 ;
}
static inline int F_69 ( enum V_157 V_158 )
{
...
static inline int F_70 ( enum V_160 V_158 )
{
...
static inline int F_71 ( enum V_162 V_163 )
{
...
static int F_72 ( struct V_165 * V_166 )
{
struct V_17 * V_18 = F_73 ( V_166 ) ;
struct V_35 * V_36 = V_18 -> V_36 ;
struct V_43 * V_44 = & V_18 -> V_45 ;
int V_113 = 0 ;
switch ( V_166 -> V_12 ) {
...
V_44 -> V_194 . V_195 . V_213 = F_69 ( V_166 -> V_169 ) ;
...
V_44 -> V_194 . V_215 . V_213 = F_70 ( V_166 -> V_169 ) ;
...
break;
case V_260 :
V_44 -> V_194 . V_195 . F_71 = F_71 ( V_166 -> V_169 ) ;
break;
case V_261 :
...
static int F_76 ( struct V_1 * V_9 , struct V_286 * V_287 )
{
int V_5 ;
if ( ! V_9 )
return - V_91 ;
...
static int F_77 ( struct V_288 * V_289 ,
const struct V_2 * V_9 ,
unsigned int * V_290 , unsigned int * V_291 ,
unsigned int V_292 [] , void * V_293 [] )
{
...
static void F_78 ( struct V_288 * V_301 )
{
struct V_17 * V_18 = F_44 ( V_301 -> V_294 ) ;
struct V_35 * V_36 = V_18 -> V_36 ;
F_79 ( & V_36 -> V_302 ) ;
}
static void F_80 ( struct V_288 * V_301 )
{
struct V_17 * V_18 = F_44 ( V_301 -> V_294 ) ;
struct V_35 * V_36 = V_18 -> V_36 ;
F_81 ( & V_36 -> V_302 ) ;
...
static int F_84 ( struct V_288 * V_301 , unsigned int V_145 )
{
struct V_17 * V_18 = F_44 ( V_301 -> V_294 ) ;
struct V_35 * V_36 = V_18 -> V_36 ;
unsigned long V_40 ;
...
static int F_86 ( struct V_288 * V_301 )
{
unsigned long V_40 ;
struct V_17 * V_18 = F_44 ( V_301 -> V_294 ) ;
struct V_35 * V_36 = V_18 -> V_36 ;
...
F_13 ( & V_36 -> V_41 , V_40 ) ;
if ( V_301 -> type == V_96 ) {
F_87 ( & V_18 -> V_42 , & V_18 -> V_116 ) ;
F_11 ( & V_18 -> V_42 ) ;
V_18 -> V_20 = 0 ;
}
if ( V_301 -> type == V_106 ) {
F_5 ( V_18 ) ;
F_87 ( & V_18 -> V_34 , & V_18 -> V_114 ) ;
F_11 ( & V_18 -> V_34 ) ;
V_18 -> V_19 = 0 ;
}
F_16 ( & V_36 -> V_41 , V_40 ) ;
...
static void F_88 ( struct V_286 * V_287 )
{
struct V_288 * V_289 = V_287 -> V_288 ;
struct V_17 * V_18 = F_44 ( V_289 -> V_294 ) ;
struct V_35 * V_36 = V_18 -> V_36 ;
...
struct V_320 * F_89 ( void )
{
return & V_321 ;
}
struct V_322 * F_90 ( void )
{
return & V_323 ;
}
const struct V_324 * F_91 ( void )
{
return & V_325 ;
}
...
V_18 -> V_342 [ V_5 ] = F_95 ( & V_18 -> V_310 ,
& V_327 , NULL ) ;
} else {
