...
const struct V_4 * V_5 )
{
if ( F_30 ( V_2 , V_56 , sizeof( T_1 ) * 4 ,
& V_5 -> V_10 . V_11 . V_12 ) ||
F_30 ( V_2 , V_57 , sizeof( T_1 ) * 4 ,
& V_5 -> V_13 . V_11 . V_12 ) )
goto V_58;
return 0 ;
V_58:
...
return - V_62 ;
memcpy ( & V_61 -> V_10 . V_11 . V_12 , F_32 ( V_60 [ V_56 ] ) ,
sizeof( T_1 ) * 4 ) ;
memcpy ( & V_61 -> V_13 . V_11 . V_12 , F_32 ( V_60 [ V_57 ] ) ,
sizeof( T_1 ) * 4 ) ;
return 0 ;
}
static int F_33 ( void )
{
return F_34 ( V_63 , V_64 + 1 ) ;
}
