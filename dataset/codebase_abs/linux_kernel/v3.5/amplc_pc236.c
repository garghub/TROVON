...
static void F_28 ( struct V_10 * V_2 )
{
if ( V_44 )
F_25 ( V_2 ) ;
if ( V_2 -> V_36 )
...
static int F_22 ( unsigned V_29 , unsigned long V_72 ,
unsigned long V_73 )
{
if ( ! V_72 || ! F_34 ( V_72 , V_73 , V_40 ) ) {
F_15 ( V_28 L_15 ,
V_29 , V_72 , V_73 ) ;
return - V_30 ;
}
...
static void F_25 ( struct V_10 * V_2 )
{
unsigned long V_52 ;
F_35 ( & V_2 -> V_74 , V_52 ) ;
V_44 -> V_75 = 0 ;
#ifdef F_17
if ( V_44 -> V_47 )
F_36 ( V_76 , V_44 -> V_47 + V_77 ) ;
#endif
F_37 ( & V_2 -> V_74 , V_52 ) ;
}
static void F_38 ( struct V_10 * V_2 )
{
unsigned long V_52 ;
F_35 ( & V_2 -> V_74 , V_52 ) ;
V_44 -> V_75 = 1 ;
