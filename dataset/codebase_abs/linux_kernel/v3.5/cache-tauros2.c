...
static inline int T_2 F_14 ( void )
{
extern int V_7 ;
return ! ! ( ( V_7 & 0x000f0000 ) == 0x000f0000 ) ;
}
static inline T_1 T_2 F_15 ( void )
{
T_1 V_8 ;
__asm__("mrc p15, 0, %0, c0, c1, 7\n" : "=r" (mmfr3));
return V_8 ;
}
static inline T_1 T_2 F_16 ( void )
{
T_1 V_9 ;
__asm__("mrc p15, 0, %0, c1, c0, 1\n" : "=r" (actlr));
return V_9 ;
}
static inline void T_2 F_17 ( T_1 V_9 )
{
