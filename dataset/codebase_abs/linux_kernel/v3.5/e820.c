...
if ( V_93 ) {
T_3 V_97 = V_4 . V_5 ;
if ( F_10 ( V_4 . V_8 , F_4 ( V_4 . V_8 ) , & V_97 ) < 0 )
F_38 ( L_25 ) ;
V_4 . V_5 = V_97 ;
F_5 ( V_23 L_26 ) ;
F_8 ( L_27 ) ;
...
static inline const char * F_48 ( int V_98 )
{
switch ( V_98 ) {
case V_16 :
...
struct V_99 * V_100 ;
T_1 V_2 ;
V_100 = F_50 ( sizeof( struct V_99 ) * V_4 . V_5 ) ;
V_101 = V_100 ;
for ( V_3 = 0 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
...
V_100 -> V_103 = F_48 ( V_4 . V_8 [ V_3 ] . type ) ;
V_100 -> V_1 = V_4 . V_8 [ V_3 ] . V_9 ;
V_100 -> V_2 = V_2 ;
V_100 -> V_104 = V_105 ;
if ( V_4 . V_8 [ V_3 ] . type != V_18 || V_100 -> V_1 < ( 1ULL << 20 ) ) {
V_100 -> V_104 |= V_106 ;
F_51 ( & V_107 , V_100 ) ;
}
V_100 ++ ;
...
struct V_6 * V_108 = & V_58 . V_8 [ V_3 ] ;
F_52 ( V_108 -> V_9 ,
V_108 -> V_9 + V_108 -> V_10 - 1 ,
F_48 ( V_108 -> type ) ) ;
}
}
static unsigned long F_53 ( V_102 V_109 )
{
unsigned long V_110 = V_109 >> 20 ;
if ( ! V_110 )
return 64 * 1024 ;
if ( V_110 < 16 )
return 1024 * 1024 ;
...
V_100 = V_101 ;
for ( V_3 = 0 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
if ( ! V_100 -> V_111 && V_100 -> V_2 )
F_55 ( & V_107 , V_100 ) ;
V_100 ++ ;
}
for ( V_3 = 0 ; V_3 < V_4 . V_5 ; V_3 ++ ) {
struct V_6 * V_108 = & V_4 . V_8 [ V_3 ] ;
T_1 V_1 , V_2 ;
if ( V_108 -> type != V_15 )
continue;
V_1 = V_108 -> V_9 + V_108 -> V_10 ;
...
& V_48 ) ;
V_113 . V_114 = V_48 ;
if ( F_14 ( V_113 . V_115 , V_113 . V_114 )
< 0 ) {
T_1 V_89 ;
if ( V_113 . V_116
< V_113 . V_117 . V_118 ) {
V_89 = V_113 . V_117 . V_118 ;
V_22 = L_35 ;
} else {
V_89 = V_113 . V_116 ;
V_22 = L_36 ;
...
int V_3 ;
T_1 V_125 ;
F_66 (i, MAX_NUMNODES, &start_pfn, &end_pfn, NULL) {
V_85 = F_67 (unsigned long, start_pfn, MAX_DMA_PFN) ;
V_86 = F_67 (unsigned long, end_pfn, MAX_DMA_PFN) ;
V_123 += V_86 - V_85 ;
}
F_68 (u, MAX_NUMNODES, &start, &end, NULL) {
V_85 = F_67 (unsigned long, PFN_UP(start), MAX_DMA_PFN) ;
V_86 = F_67 (unsigned long, PFN_DOWN(end), MAX_DMA_PFN) ;
if ( V_85 < V_86 )
V_124 += V_86 - V_85 ;
}
F_69 ( V_123 - V_124 ) ;
