...
static void F_62 ( struct V_102 * V_5 )
{
struct V_1 * V_2 ;
if ( V_5 ) {
V_2 = F_41 ( V_5 ) ;
...
static int F_65 ( struct V_122 * V_36 )
{
struct V_102 * V_5 = F_66 ( V_36 ) ;
struct V_1 * V_2 ;
struct V_71 * V_72 ;
T_5 V_137 ;
struct V_79 * V_82 ;
...
V_82 = V_72 -> V_81 . V_82 ;
F_15 ( L_67 , V_82 -> V_144 ) ;
F_70 ( V_82 ) ;
F_71 ( & V_72 -> V_140 -> V_145 ) ;
V_72 -> V_140 -> V_146 = true ;
if ( V_72 -> V_140 -> V_141 == V_142 ) {
F_15 ( L_68 ) ;
return F_72 ( V_5 , V_138 ) ;
} else {
F_15 ( L_69 ) ;
return 0 ;
}
}
static int F_73 ( struct V_122 * V_36 )
{
struct V_102 * V_5 = F_66 ( V_36 ) ;
struct V_1 * V_2 ;
struct V_71 * V_72 ;
...
V_72 -> V_140 -> V_146 = false ;
V_82 = V_72 -> V_81 . V_82 ;
F_15 ( L_72 , V_82 -> V_144 ) ;
F_74 ( V_82 ) ;
V_72 -> V_131 ( V_72 ) ;
V_72 -> V_140 -> V_141 = V_147 ;
F_15 ( L_73 , V_82 -> V_144 ) ;
return 0 ;
}
