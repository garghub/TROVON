...
struct V_40 * F_73 ( struct V_6 * V_7 )
{
...
struct V_70 * V_71 ;
F_75 ( & V_72 ) ;
F_76 (devinfo, &__i2c_board_list, list) {
...
static int F_81 ( struct V_8 * V_77 , void * V_78 )
{
return F_78 ( F_5 ( V_77 ) , V_78 ) ;
}
static int F_82 ( struct V_40 * V_46 )
{
int V_63 = 0 ;
if ( F_83 ( F_84 ( ! V_56 . V_79 ) ) ) {
V_63 = - V_80 ;
goto V_81;
}
if ( F_83 ( V_46 -> V_5 [ 0 ] == '\0' ) ) {
F_85 ( L_27
L_28 ) ;
return - V_37 ;
}
...
return - V_16 ;
F_66 ( & V_87 ) ;
V_17 = F_95 ( & V_88 , V_46 , V_46 -> V_74 , & V_2 ) ;
...
static int F_99 ( struct V_6 * V_7 , void * V_93 )
{
struct V_3 * V_4 = F_3 ( V_7 ) ;
if ( V_4 )
F_57 ( V_4 ) ;
...
static int F_100 ( struct V_8 * V_77 , void * V_78 )
{
return F_97 ( F_5 ( V_77 ) , V_78 ) ;
}
int F_101 ( struct V_40 * V_46 )
{
int V_63 = 0 ;
struct V_40 * V_94 ;
struct V_3 * V_4 , * V_68 ;
F_66 ( & V_87 ) ;
V_94 = F_102 ( & V_88 , V_46 -> V_74 ) ;
F_68 ( & V_87 ) ;
if ( V_94 != V_46 ) {
F_103 ( L_38
L_39 , V_46 -> V_5 ) ;
...
int F_107 ( void * V_78 , int (* F_108)( struct V_6 * , void * ) )
{
int V_63 ;
F_66 ( & V_87 ) ;
V_63 = F_109 ( & V_56 , NULL , V_78 , F_108 ) ;
F_68 ( & V_87 ) ;
return V_63 ;
}
static int F_110 ( struct V_6 * V_7 , void * V_78 )
{
if ( V_7 -> type != & V_44 )
return 0 ;
return F_78 ( V_78 , F_33 ( V_7 ) ) ;
}
int F_111 ( struct V_95 * V_96 , struct V_10 * V_11 )
{
int V_63 ;
if ( F_83 ( F_84 ( ! V_56 . V_79 ) ) )
return - V_80 ;
...
F_113 ( L_42 ,
V_11 -> V_11 . V_5 ) ;
F_103 ( L_43 , V_11 -> V_11 . V_5 ) ;
F_88 ( & V_11 -> V_97 ) ;
F_107 ( V_11 , F_110 ) ;
return 0 ;
}
static int F_114 ( struct V_6 * V_7 , void * V_78 )
{
if ( V_7 -> type != & V_44 )
return 0 ;
return F_97 ( V_78 , F_33 ( V_7 ) ) ;
}
void F_115 ( struct V_10 * V_11 )
{
F_107 ( V_11 , F_114 ) ;
F_116 ( & V_11 -> V_11 ) ;
F_103 ( L_44 , V_11 -> V_11 . V_5 ) ;
}
struct V_3 * F_117 ( struct V_3 * V_4 )
{
if ( V_4 && F_118 ( & V_4 -> V_7 ) )
return V_4 ;
return NULL ;
}
...
static int F_121 ( struct V_6 * V_7 , void * V_98 )
{
struct V_3 * V_4 = F_3 ( V_7 ) ;
...
void F_122 ( struct V_40 * V_46 , unsigned int V_102 , void * V_100 )
{
struct V_99 V_103 ;
V_103 . V_102 = V_102 ;
V_103 . V_100 = V_100 ;
F_40 ( & V_46 -> V_7 , & V_103 , F_121 ) ;
}
...
int F_130 ( struct V_40 * V_46 , struct V_108 * V_109 , int V_110 )
{
unsigned long V_111 ;
int V_112 , V_113 ;
if ( V_46 -> V_82 -> V_114 ) {
...
if ( V_112 != - V_80 )
break;
if ( F_134 ( V_118 , V_111 + V_46 -> V_83 ) )
break;
}
F_47 ( V_46 ) ;
return V_112 ;
...
int F_135 ( const struct V_3 * V_4 , const char * V_33 , int V_60 )
{
int V_112 ;
...
V_112 = F_130 ( V_46 , & V_121 , 1 ) ;
return ( V_112 == 1 ) ? V_60 : V_112 ;
}
int F_136 ( const struct V_3 * V_4 , char * V_33 , int V_60 )
{
struct V_40 * V_46 = V_4 -> V_41 ;
struct V_108 V_121 ;
int V_112 ;
...
static int F_137 ( struct V_40 * V_46 , unsigned short V_36 )
{
int V_123 ;
union V_124 V_93 ;
#ifdef F_138
...
&& F_139 ( V_46 , V_127 ) )
V_123 = F_140 ( V_46 , V_36 , 0 , V_128 , 0 ,
V_129 , & V_93 ) ;
else
#endif
if ( ! ( ( V_36 & ~ 0x07 ) == 0x30 || ( V_36 & ~ 0x0f ) == 0x50 )
&& F_139 ( V_46 , V_130 ) )
V_123 = F_140 ( V_46 , V_36 , 0 , V_131 , 0 ,
V_132 , NULL ) ;
else if ( F_139 ( V_46 , V_133 ) )
V_123 = F_140 ( V_46 , V_36 , 0 , V_128 , 0 ,
V_134 , & V_93 ) ;
else {
F_80 ( & V_46 -> V_7 , L_51 ) ;
...
static int F_141 ( struct V_3 * V_135 ,
struct V_10 * V_11 )
{
struct V_47 V_48 ;
...
static int F_79 ( struct V_40 * V_41 , struct V_10 * V_11 )
{
...
int F_142 ( struct V_40 * V_46 , unsigned short V_36 )
{
return F_140 ( V_46 , V_36 , 0 , V_128 , 0 ,
V_132 , NULL ) >= 0 ;
}
struct V_3 *
F_143 ( struct V_40 * V_46 ,
struct V_47 * V_48 ,
...
struct V_40 * F_144 ( int V_74 )
{
struct V_40 * V_41 ;
F_66 ( & V_87 ) ;
V_41 = F_102 ( & V_88 , V_74 ) ;
if ( V_41 && ! F_145 ( V_41 -> V_96 ) )
V_41 = NULL ;
F_68 ( & V_87 ) ;
return V_41 ;
}
void F_146 ( struct V_40 * V_46 )
{
F_147 ( V_46 -> V_96 ) ;
}
static T_7 F_148 ( T_3 V_78 )
{
int V_138 ;
...
static T_7 F_149 ( T_7 V_143 , T_7 * V_79 , T_4 V_60 )
{
int V_138 ;
for ( V_138 = 0 ; V_138 < V_60 ; V_138 ++ )
V_143 = F_148 ( ( V_143 ^ V_79 [ V_138 ] ) << 8 ) ;
return V_143 ;
}
static T_7 F_150 ( T_7 V_144 , struct V_108 * V_121 )
{
T_7 V_36 = ( V_121 -> V_36 << 1 ) | ! ! ( V_121 -> V_20 & V_115 ) ;
V_144 = F_149 ( V_144 , & V_36 , 1 ) ;
return F_149 ( V_144 , V_121 -> V_33 , V_121 -> V_116 ) ;
}
static inline void F_151 ( struct V_108 * V_121 )
{
V_121 -> V_33 [ V_121 -> V_116 ] = F_150 ( 0 , V_121 ) ;
V_121 -> V_116 ++ ;
}
static int F_152 ( T_7 V_145 , struct V_108 * V_121 )
{
T_7 V_146 = V_121 -> V_33 [ -- V_121 -> V_116 ] ;
V_145 = F_150 ( V_145 , V_121 ) ;
if ( V_146 != V_145 ) {
F_103 ( L_64 ,
V_146 , V_145 ) ;
return - V_147 ;
...
T_8 F_153 ( const struct V_3 * V_4 )
{
union V_124 V_78 ;
int V_17 ;
V_17 = F_140 ( V_4 -> V_41 , V_4 -> V_36 , V_4 -> V_20 ,
V_128 , 0 ,
V_134 , & V_78 ) ;
return ( V_17 < 0 ) ? V_17 : V_78 . V_148 ;
}
T_8 F_154 ( const struct V_3 * V_4 , T_7 V_149 )
{
return F_140 ( V_4 -> V_41 , V_4 -> V_36 , V_4 -> V_20 ,
...
T_8 F_163 ( const struct V_3 * V_4 , T_7 V_101 ,
T_7 V_156 , const T_7 * V_153 )
{
union V_124 V_78 ;
if ( V_156 > V_157 )
...
static T_8 F_164 ( struct V_40 * V_41 , T_3 V_36 ,
unsigned short V_20 ,
...
V_163 = F_150 ( 0 , & V_121 [ 0 ] ) ;
}
if ( V_121 [ V_110 - 1 ] . V_20 & V_115 )
V_121 [ V_110 - 1 ] . V_116 ++ ;
}
V_17 = F_130 ( V_41 , V_121 , V_110 ) ;
if ( V_17 < 0 )
return V_17 ;
if ( V_138 && ( V_121 [ V_110 - 1 ] . V_20 & V_115 ) ) {
V_17 = F_152 ( V_163 , & V_121 [ V_110 - 1 ] ) ;
if ( V_17 < 0 )
return V_17 ;
}
if ( V_159 == V_128 )
...
T_8 F_140 ( struct V_40 * V_41 , T_3 V_36 , unsigned short V_20 ,
...
V_63 = F_164 ( V_41 , V_36 , V_20 , V_159 ,
V_101 , V_166 , V_78 ) ;
return V_63 ;
}
