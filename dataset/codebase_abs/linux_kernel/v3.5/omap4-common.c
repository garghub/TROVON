...
V_50 -> V_54 [ 0 ] . V_55 = V_46 ;
V_50 -> V_54 [ 0 ] . V_56 = V_57 ;
}
return 0 ;
}
static T_1 void F_33 ( struct V_44 * V_45 )
{
struct V_49 * V_50 ;
if ( ! V_45 ) {
F_34 ( L_3 , V_53 ) ;
...
int T_1 F_35 ( struct V_59 * V_60 )
{
struct V_59 * V_61 ;
F_36 ( V_60 ) ;
for ( V_61 = V_60 ; V_61 -> V_62 ; V_61 ++ ) {
if ( ! V_61 -> V_48 )
continue;
F_33 ( & V_61 -> V_48 -> V_45 ) ;
}
