...
F_2 ( L_10 ,
F_43 ( V_88 ) , V_71 , V_77 ,
( long ) F_44 ( V_54 -> V_60 -> V_89 ) ,
V_54 -> V_90 ) ;
if ( ( V_77 >= V_91 ) &&
( ( V_77 < V_92 ) || ( V_77 >= V_93 ) ) )
goto V_94;
if ( ( V_77 >= V_92 ) && ( V_77 < V_93 ) &&
( V_77 < V_92 + V_2 -> V_7 -> V_95 ) ) {
T_5 V_96 ;
V_75 = & V_2 -> V_7 -> V_97 [ V_77 - V_92 ] ;
V_96 = F_45 ( V_75 -> V_98 ) ;
V_82 = V_83 = F_45 ( V_71 ) ;
if ( V_96 > V_83 )
V_83 = V_96 ;
}
else if ( ( V_77 >= V_93 ) || ( V_77 < V_92 ) ) {
V_75 = & V_99 [ V_77 ] ;
V_71 = V_75 -> V_71 ;
V_82 = V_83 = F_45 ( V_71 ) ;
} else
goto V_94;
V_76 = V_75 -> V_76 ;
if ( ( V_77 == F_40 ( V_100 ) ) && V_2 -> V_7 -> V_101 )
V_76 = V_2 -> V_7 -> V_101 ;
if ( ! V_76 ) {
F_2 ( L_11 ) ;
V_78 = - V_79 ;
} else if ( ( ( V_75 -> V_102 & V_103 ) && ! F_46 ( V_104 ) ) ||
( ( V_75 -> V_102 & V_105 ) && ! V_54 -> V_90 ) ||
( ( V_75 -> V_102 & V_106 ) && ! V_54 -> V_107 ) ||
( ! ( V_75 -> V_102 & V_108 ) && ( V_54 -> V_60 -> type == V_109 ) ) ) {
V_78 = - V_110 ;
} else {
if ( V_71 & ( V_111 | V_112 ) ) {
if ( V_83 <= sizeof( V_80 ) ) {
...
struct V_117 * F_50 ( struct V_1 * V_2 )
{
struct V_118 * V_14 ;
F_51 (entry, &dev->maplist, head) {
if ( V_14 -> V_119 && V_14 -> V_119 -> type == V_120 &&
( V_14 -> V_119 -> V_102 & V_121 ) ) {
return V_14 -> V_119 ;
}
}
return NULL ;
