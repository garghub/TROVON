...
static int T_3 F_24 ( struct V_171 * V_172 ,
...
static int T_4 F_34 ( struct V_171 * V_182 )
{
struct V_43 * V_44 = F_35 ( V_182 ) ;
F_36 ( & V_182 -> V_10 ) ;
F_33 ( V_44 -> V_126 ) ;
return 0 ;
}
static int T_3 F_37 ( struct V_183 * V_184 )
{
struct V_43 * V_44 ;
int V_123 ;
V_44 = F_25 ( & V_184 -> V_10 , sizeof( struct V_43 ) ,
V_175 ) ;
if ( ! V_44 )
return - V_176 ;
F_38 ( V_184 , V_44 ) ;
V_44 -> V_126 = F_39 ( V_184 , & V_185 ) ;
if ( F_28 ( V_44 -> V_126 ) ) {
V_123 = F_29 ( V_44 -> V_126 ) ;
F_18 ( & V_184 -> V_10 , L_10 , V_123 ) ;
return V_123 ;
}
V_123 = F_30 ( V_44 -> V_126 , V_186 ,
F_20 ( V_186 ) ) ;
if ( V_123 != 0 )
F_31 ( & V_184 -> V_10 , L_8 , V_123 ) ;
V_123 = F_32 ( & V_184 -> V_10 ,
& V_179 , & V_180 , 1 ) ;
if ( V_123 < 0 )
goto V_181;
return V_123 ;
...
static int T_4 F_40 ( struct V_183 * V_184 )
{
struct V_43 * V_44 = F_41 ( V_184 ) ;
F_36 ( & V_184 -> V_10 ) ;
F_33 ( V_44 -> V_126 ) ;
return 0 ;
}
