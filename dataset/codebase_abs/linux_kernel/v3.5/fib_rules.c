...
if ( V_80 )
V_2 -> V_98 ++ ;
F_58 ( V_100 , V_20 , V_2 , V_76 , F_59 ( V_74 ) . V_101 ) ;
F_16 ( V_2 ) ;
F_14 ( V_2 ) ;
return 0 ;
V_97:
...
static int F_60 ( struct V_73 * V_74 , struct V_75 * V_76 , void * V_55 )
{
struct V_22 * V_22 = F_44 ( V_74 -> V_77 ) ;
struct V_64 * V_65 = F_45 ( V_76 ) ;
struct V_1 * V_2 = NULL ;
...
continue;
if ( V_67 [ V_85 ] &&
F_61 ( V_67 [ V_85 ] , V_20 -> V_88 ) )
continue;
if ( V_67 [ V_91 ] &&
F_61 ( V_67 [ V_91 ] , V_20 -> V_92 ) )
continue;
if ( V_67 [ V_93 ] &&
( V_20 -> V_50 != F_48 ( V_67 [ V_93 ] ) ) )
continue;
...
if ( V_20 -> V_12 == V_57 ) {
V_2 -> V_99 -- ;
if ( F_56 ( V_20 -> V_59 ) == NULL )
V_2 -> V_98 -- ;
}
if ( V_2 -> V_99 > 0 ) {
F_19 (tmp, &ops->rules_list, list) {
if ( F_56 ( V_38 -> V_59 ) == V_20 ) {
F_52 ( V_38 -> V_59 , NULL ) ;
V_2 -> V_98 ++ ;
}
}
}
F_58 ( V_104 , V_20 , V_2 , V_76 ,
F_59 ( V_74 ) . V_101 ) ;
F_30 ( V_20 ) ;
F_16 ( V_2 ) ;
F_14 ( V_2 ) ;
...
struct V_6 * V_20 )
{
T_2 V_106 = F_63 ( sizeof( struct V_64 ) )
+ F_64 ( V_89 )
+ F_64 ( V_89 )
+ F_64 ( 4 )
+ F_64 ( 4 )
...
static int F_65 ( struct V_73 * V_74 , struct V_6 * V_20 ,
T_1 V_101 , T_1 V_108 , int type , int V_5 ,
struct V_1 * V_2 )
{
struct V_75 * V_76 ;
struct V_64 * V_65 ;
V_76 = F_66 ( V_74 , V_101 , V_108 , type , sizeof( * V_65 ) , V_5 ) ;
if ( V_76 == NULL )
return - V_109 ;
V_65 = F_45 ( V_76 ) ;
V_65 -> V_23 = V_2 -> V_23 ;
V_65 -> V_4 = V_20 -> V_4 ;
if ( F_67 ( V_74 , V_110 , V_20 -> V_4 ) )
goto V_111;
V_65 -> V_112 = 0 ;
V_65 -> V_113 = 0 ;
V_65 -> V_12 = V_20 -> V_12 ;
...
V_65 -> V_5 |= V_114 ;
if ( V_20 -> V_88 [ 0 ] ) {
if ( F_69 ( V_74 , V_85 , V_20 -> V_88 ) )
goto V_111;
if ( V_20 -> V_45 == - 1 )
V_65 -> V_5 |= V_115 ;
}
if ( V_20 -> V_92 [ 0 ] ) {
if ( F_69 ( V_74 , V_91 , V_20 -> V_92 ) )
goto V_111;
if ( V_20 -> V_48 == - 1 )
V_65 -> V_5 |= V_116 ;
}
if ( ( V_20 -> V_3 &&
F_67 ( V_74 , V_84 , V_20 -> V_3 ) ) ||
( V_20 -> V_50 &&
F_67 ( V_74 , V_93 , V_20 -> V_50 ) ) ||
( ( V_20 -> V_52 || V_20 -> V_50 ) &&
F_67 ( V_74 , V_94 , V_20 -> V_52 ) ) ||
( V_20 -> V_58 &&
F_67 ( V_74 , V_96 , V_20 -> V_58 ) ) )
goto V_111;
if ( V_2 -> V_33 ( V_20 , V_74 , V_65 ) < 0 )
goto V_111;
return F_70 ( V_74 , V_76 ) ;
V_111:
F_71 ( V_74 , V_76 ) ;
return - V_109 ;
}
static int F_72 ( struct V_73 * V_74 , struct V_117 * V_118 ,
struct V_1 * V_2 )
{
int V_119 = 0 ;
struct V_6 * V_20 ;
...
goto V_120;
if ( F_65 ( V_74 , V_20 , F_59 ( V_118 -> V_74 ) . V_101 ,
...
struct V_1 * V_2 ;
int V_119 = 0 , V_23 ;
V_23 = F_74 ( V_118 -> V_76 ) ;
if ( V_23 != V_124 ) {
V_2 = F_9 ( V_22 , V_23 ) ;
if ( V_2 == NULL )
return - V_82 ;
return F_72 ( V_74 , V_118 , V_2 ) ;
}
F_10 () ;
F_11 (ops, &net->rules_ops, list) {
if ( V_119 < V_118 -> args [ 0 ] || ! F_12 ( V_2 -> V_24 ) )
goto V_120;
if ( F_72 ( V_74 , V_118 , V_2 ) < 0 )
break;
V_118 -> args [ 1 ] = 0 ;
V_120:
V_119 ++ ;
...
static void F_58 ( int V_125 , struct V_6 * V_20 ,
...
int V_26 = - V_126 ;
V_22 = V_2 -> V_15 ;
V_74 = F_75 ( F_62 ( V_2 , V_20 ) , V_9 ) ;
if ( V_74 == NULL )
goto V_35;
V_26 = F_65 ( V_74 , V_20 , V_101 , V_76 -> V_121 , V_125 , 0 , V_2 ) ;
if ( V_26 < 0 ) {
F_76 ( V_26 == - V_109 ) ;
F_77 ( V_74 ) ;
goto V_35;
}
F_78 ( V_74 , V_22 , V_101 , V_2 -> V_127 , V_76 , V_9 ) ;
return;
V_35:
if ( V_26 < 0 )
F_79 ( V_22 , V_2 -> V_127 , V_26 ) ;
}
static void F_80 ( struct V_18 * V_128 , struct V_86 * V_87 )
{
struct V_6 * V_20 ;
...
static int F_82 ( struct V_130 * V_131 , unsigned long V_125 ,
void * V_132 )
{
struct V_86 * V_87 = V_132 ;
struct V_22 * V_22 = F_83 ( V_87 ) ;
struct V_1 * V_2 ;
F_84 () ;
switch ( V_125 ) {
case V_133 :
...
{
int V_26 ;
F_88 ( V_136 , V_100 , F_43 , NULL , NULL ) ;
F_88 ( V_136 , V_104 , F_60 , NULL , NULL ) ;
F_88 ( V_136 , V_137 , NULL , F_73 , NULL ) ;
V_26 = F_89 ( & V_138 ) ;
if ( V_26 < 0 )
goto V_139;
V_26 = F_90 ( & V_140 ) ;
