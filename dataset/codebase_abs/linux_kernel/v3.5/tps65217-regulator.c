...
{
struct V_7 * V_8 = F_7 ( V_5 ) ;
unsigned int V_26 , V_10 = F_8 ( V_5 ) ;
int V_6 ;
if ( V_10 == V_27 )
return - V_3 ;
if ( V_10 < V_11 || V_10 > V_12 )
return - V_3 ;
if ( V_24 < V_8 -> V_14 [ V_10 ] -> V_24 || V_24 > V_8 -> V_14 [ V_10 ] -> V_25 )
return - V_3 ;
if ( V_25 < V_8 -> V_14 [ V_10 ] -> V_24 || V_25 > V_8 -> V_14 [ V_10 ] -> V_25 )
return - V_3 ;
V_6 = V_8 -> V_14 [ V_10 ] -> F_17 ( V_24 , & V_26 ) ;
if ( V_6 )
return V_6 ;
return V_26 ;
}
...
struct V_36 V_37 = { } ;
V_8 = F_21 ( V_31 -> V_5 . V_38 ) ;
V_8 -> V_14 [ V_31 -> V_35 ] = V_14 ;
V_37 . V_5 = & V_31 -> V_5 ;
V_37 . V_39 = V_31 -> V_5 . V_40 ;
V_37 . V_41 = V_8 ;
V_32 = F_22 ( & V_42 [ V_31 -> V_35 ] , & V_37 ) ;
if ( F_23 ( V_32 ) )
return F_24 ( V_32 ) ;
F_25 ( V_31 , V_32 ) ;
return 0 ;
