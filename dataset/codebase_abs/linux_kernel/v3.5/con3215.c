...
static int F_80 ( struct V_51 * V_52 , struct V_111 * V_112 )
{
struct V_8 * V_9 ;
int V_113 ;
V_9 = V_89 [ V_52 -> V_98 ] ;
...
static void F_82 ( struct V_51 * V_52 , struct V_111 * V_112 )
{
struct V_8 * V_9 ;
...
static int F_86 ( struct V_51 * V_52 , unsigned char V_72 )
{
struct V_8 * V_9 ;
if ( ! V_52 )
return 0 ;
...
V_118 -> V_127 = V_128 ;
V_118 -> V_129 = V_130 ;
V_118 -> V_129 . V_131 = V_132 | V_133 ;
V_118 -> V_129 . V_134 = V_135 | V_136 ;
V_118 -> V_129 . V_137 = V_138 ;
V_118 -> V_3 = V_139 ;
F_98 ( V_118 , & V_140 ) ;
V_119 = F_99 ( V_118 ) ;
if ( V_119 ) {
