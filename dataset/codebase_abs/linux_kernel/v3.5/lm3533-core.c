...
static int T_5 F_26 ( struct V_1 * V_1 )
{
struct V_55 * V_56 = V_1 -> V_7 -> V_57 ;
int V_5 ;
if ( ! V_56 -> V_58 )
return 0 ;
V_59 [ 0 ] . V_57 = V_56 -> V_58 ;
V_59 [ 0 ] . V_60 = sizeof( * V_56 -> V_58 ) ;
V_5 = F_27 ( V_1 -> V_7 , 0 , V_59 , 1 , NULL , 0 ) ;
if ( V_5 ) {
F_3 ( V_1 -> V_7 , L_12 ) ;
return V_5 ;
}
...
return 0 ;
if ( V_56 -> V_64 > F_29 ( V_65 ) )
V_56 -> V_64 = F_29 ( V_65 ) ;
for ( V_62 = 0 ; V_62 < V_56 -> V_64 ; ++ V_62 ) {
V_65 [ V_62 ] . V_57 = & V_56 -> V_63 [ V_62 ] ;
V_65 [ V_62 ] . V_60 = sizeof( V_56 -> V_63 [ V_62 ] ) ;
}
V_5 = F_27 ( V_1 -> V_7 , 0 , V_65 ,
V_56 -> V_64 , NULL , 0 ) ;
if ( V_5 ) {
F_3 ( V_1 -> V_7 , L_13 ) ;
return V_5 ;
...
static int T_5 F_30 ( struct V_1 * V_1 )
{
struct V_55 * V_56 = V_1 -> V_7 -> V_57 ;
int V_62 ;
int V_5 ;
...
return 0 ;
if ( V_56 -> V_67 > F_29 ( V_68 ) )
V_56 -> V_67 = F_29 ( V_68 ) ;
for ( V_62 = 0 ; V_62 < V_56 -> V_67 ; ++ V_62 ) {
V_68 [ V_62 ] . V_57 = & V_56 -> V_66 [ V_62 ] ;
V_68 [ V_62 ] . V_60 = sizeof( V_56 -> V_66 [ V_62 ] ) ;
}
V_5 = F_27 ( V_1 -> V_7 , 0 , V_68 ,
V_56 -> V_67 , NULL , 0 ) ;
if ( V_5 ) {
F_3 ( V_1 -> V_7 , L_14 ) ;
return V_5 ;
...
static void T_6 F_38 ( struct V_1 * V_1 )
{
F_4 ( V_1 -> V_7 , L_15 , V_71 ) ;
...
static int T_5 F_43 ( struct V_76 * V_77 ,
...
static int T_6 F_49 ( struct V_76 * V_77 )
{
