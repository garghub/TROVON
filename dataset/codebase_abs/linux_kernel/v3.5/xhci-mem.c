...
for ( V_141 = 0 ; V_141 < V_149 ; V_141 ++ ) {
struct V_126 * V_83 = & V_269 -> V_150 [ V_141 ] . V_151 ;
while ( ! F_66 ( V_83 ) )
F_128 ( V_83 -> V_16 ) ;
}
}
for ( V_8 = 0 ; V_8 < V_140 ; V_8 ++ ) {
struct V_128 * V_139 , * V_270 ;
...
T_2 V_282 ,
struct V_1 * V_283 ,
char * V_284 , int V_285 )
{
unsigned long long V_286 ;
unsigned long long V_287 ;
struct V_1 * V_6 ;
V_286 = F_55 ( V_279 , V_280 ) ;
V_287 = F_55 ( V_279 , V_281 ) ;
V_6 = F_130 ( V_279 , V_280 , V_281 , V_282 ) ;
if ( V_6 != V_283 ) {
F_43 ( V_3 , L_44 ,
V_284 , V_285 ) ;
F_43 ( V_3 , L_45
...
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = V_3 -> V_263 -> V_37 -> V_9 ,
. V_281 = & V_3 -> V_263 -> V_37 -> V_9 [ V_12 - 1 ] ,
. V_282 = V_3 -> V_265 -> V_37 -> V_7 ,
. V_283 = NULL ,
} ,
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = V_3 -> V_263 -> V_37 -> V_9 ,
. V_281 = & V_3 -> V_265 -> V_37 -> V_9 [ V_12 - 1 ] ,
. V_282 = V_3 -> V_265 -> V_37 -> V_7 ,
. V_283 = NULL ,
} ,
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = V_3 -> V_265 -> V_37 -> V_9 ,
. V_281 = & V_3 -> V_265 -> V_37 -> V_9 [ V_12 - 1 ] ,
. V_282 = V_3 -> V_265 -> V_37 -> V_7 ,
. V_283 = NULL ,
} ,
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = & V_3 -> V_263 -> V_37 -> V_9 [ 0 ] ,
. V_281 = & V_3 -> V_263 -> V_37 -> V_9 [ 3 ] ,
. V_282 = V_3 -> V_263 -> V_37 -> V_7 + 4 * 16 ,
. V_283 = NULL ,
} ,
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = & V_3 -> V_263 -> V_37 -> V_9 [ 3 ] ,
. V_281 = & V_3 -> V_263 -> V_37 -> V_9 [ 6 ] ,
. V_282 = V_3 -> V_263 -> V_37 -> V_7 + 2 * 16 ,
. V_283 = NULL ,
} ,
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = & V_3 -> V_263 -> V_37 -> V_9 [ V_12 - 3 ] ,
. V_281 = & V_3 -> V_263 -> V_37 -> V_9 [ 1 ] ,
. V_282 = V_3 -> V_263 -> V_37 -> V_7 + 2 * 16 ,
. V_283 = NULL ,
} ,
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = & V_3 -> V_263 -> V_37 -> V_9 [ V_12 - 3 ] ,
. V_281 = & V_3 -> V_263 -> V_37 -> V_9 [ 1 ] ,
. V_282 = V_3 -> V_263 -> V_37 -> V_7 + ( V_12 - 4 ) * 16 ,
. V_283 = NULL ,
} ,
{ . V_279 = V_3 -> V_263 -> V_37 ,
. V_280 = & V_3 -> V_263 -> V_37 -> V_9 [ V_12 - 3 ] ,
. V_281 = & V_3 -> V_263 -> V_37 -> V_9 [ 1 ] ,
. V_282 = V_3 -> V_265 -> V_37 -> V_7 + 2 * 16 ,
. V_283 = NULL ,
} ,
} ;
unsigned int V_290 ;
...
F_43 ( V_3 , L_53
L_54 ) ;
V_291 = F_135 ( V_3 , & V_3 -> V_292 -> V_293 ) ;
V_291 &= V_294 ;
V_291 &= ~ V_295 ;
F_21 ( V_3 , L_55
L_56 ) ;
F_136 ( V_3 , ( ( T_4 ) V_120 & ( T_4 ) ~ V_294 ) | V_291 ,
& V_3 -> V_292 -> V_293 ) ;
}
static void F_137 ( struct V_2 * V_3 , unsigned int V_140 ,
T_6 T_7 * V_96 , T_5 V_296 )
{
T_3 V_291 , V_297 , V_298 ;
int V_8 ;
if ( V_296 > 0x03 ) {
F_43 ( V_3 , L_57
L_58 ,
...
V_291 = F_138 ( V_3 , V_96 + 2 ) ;
V_297 = F_139 ( V_291 ) ;
V_298 = F_140 ( V_291 ) ;
F_21 ( V_3 , L_59
L_60 ,
V_96 , V_297 , V_298 , V_296 ) ;
if ( V_297 == 0 || ( V_297 + V_298 - 1 ) > V_140 )
return;
if ( ( V_3 -> V_221 == 0x96 ) && ( V_296 != 0x03 ) &&
( V_291 & V_299 ) ) {
F_21 ( V_3 , L_61 ) ;
V_3 -> V_300 = 1 ;
}
if ( ( V_3 -> V_221 >= 0x100 ) && ( V_296 != 0x03 ) ) {
F_21 ( V_3 , L_62 ) ;
V_3 -> V_300 = 1 ;
if ( V_291 & V_301 ) {
F_21 ( V_3 , L_63 ) ;
...
V_297 -- ;
for ( V_8 = V_297 ; V_8 < ( V_297 + V_298 ) ; V_8 ++ ) {
if ( V_3 -> V_172 [ V_8 ] != 0 ) {
F_43 ( V_3 , L_64
L_65 , V_96 , V_8 ) ;
F_43 ( V_3 , L_66
...
V_96 = & V_3 -> V_305 -> V_307 + V_303 ;
while ( 1 ) {
T_3 V_308 ;
V_308 = F_138 ( V_3 , V_96 ) ;
if ( F_144 ( V_308 ) == V_309 )
F_137 ( V_3 , V_140 , V_96 ,
( T_5 ) F_145 ( V_308 ) ) ;
V_303 = F_146 ( V_308 ) ;
if ( ! V_303 || ( V_3 -> V_271 + V_3 -> V_272 )
== V_140 )
break;
V_96 += V_303 ;
}
...
if ( V_3 -> V_271 ) {
V_3 -> V_274 = F_147 ( sizeof( * V_3 -> V_274 ) *
V_3 -> V_271 , V_5 ) ;
if ( ! V_3 -> V_274 )
return - V_43 ;
V_304 = 0 ;
...
if ( V_3 -> V_272 ) {
V_3 -> V_275 = F_147 ( sizeof( * V_3 -> V_275 ) *
V_3 -> V_272 , V_5 ) ;
if ( ! V_3 -> V_275 )
return - V_43 ;
V_304 = 0 ;
...
T_2 V_7 ;
struct V_235 * V_77 = F_34 ( V_3 ) -> V_74 . V_75 ;
unsigned int V_20 , V_314 ;
T_4 V_315 ;
struct V_1 * V_6 ;
T_3 V_248 , V_291 ;
int V_8 ;
V_248 = F_138 ( V_3 , & V_3 -> V_311 -> V_248 ) ;
F_21 ( V_3 , L_77 , V_248 ) ;
...
F_43 ( V_3 , L_79 ) ;
V_3 -> V_276 = 12 ;
V_3 -> V_248 = 1 << V_3 -> V_276 ;
F_21 ( V_3 , L_80 , V_3 -> V_248 / 1024 ) ;
V_20 = F_149 ( F_138 ( V_3 , & V_3 -> V_305 -> V_132 ) ) ;
F_21 ( V_3 , L_81 ,
( unsigned int ) V_20 ) ;
V_314 = F_138 ( V_3 , & V_3 -> V_311 -> V_316 ) ;
V_20 |= ( V_314 & ~ V_317 ) ;
F_21 ( V_3 , L_82 ,
( unsigned int ) V_20 ) ;
F_150 ( V_3 , V_20 , & V_3 -> V_311 -> V_316 ) ;
...
goto V_46;
V_3 -> V_265 = F_18 ( V_3 , 1 , 1 , V_320 , V_5 ) ;
if ( ! V_3 -> V_265 )
goto V_46;
F_21 ( V_3 , L_88 , V_3 -> V_265 ) ;
F_21 ( V_3 , L_89 ,
( unsigned long long ) V_3 -> V_265 -> V_37 -> V_7 ) ;
V_315 = F_135 ( V_3 , & V_3 -> V_311 -> V_265 ) ;
V_315 = ( V_315 & ( T_4 ) V_321 ) |
( V_3 -> V_265 -> V_37 -> V_7 & ( T_4 ) ~ V_321 ) |
V_3 -> V_265 -> V_4 ;
F_21 ( V_3 , L_90 , V_20 ) ;
F_136 ( V_3 , V_315 , & V_3 -> V_311 -> V_265 ) ;
F_152 ( V_3 ) ;
V_3 -> V_264 = F_45 ( V_3 , true , true , V_5 ) ;
if ( ! V_3 -> V_264 )
goto V_46;
V_3 -> V_101 ++ ;
V_20 = F_138 ( V_3 , & V_3 -> V_305 -> V_322 ) ;
V_20 &= V_323 ;
F_21 ( V_3 , L_91
L_92 , V_20 ) ;
V_3 -> V_324 = ( void T_7 * ) V_3 -> V_305 + V_20 ;
F_153 ( V_3 ) ;
F_154 ( V_3 ) ;
V_3 -> V_292 = & V_3 -> V_325 -> V_292 [ 0 ] ;
F_21 ( V_3 , L_93 ) ;
V_3 -> V_263 = F_18 ( V_3 , V_326 , 1 , V_21 ,
V_5 ) ;
if ( ! V_3 -> V_263 )
goto V_46;
if ( F_131 ( V_3 , V_5 ) < 0 )
...
sizeof( struct V_258 ) * V_326 , & V_7 ,
V_318 ) ;
if ( ! V_3 -> V_259 . V_261 )
goto V_46;
F_21 ( V_3 , L_94 ,
( unsigned long long ) V_7 ) ;
memset ( V_3 -> V_259 . V_261 , 0 , sizeof( struct V_258 ) * V_326 ) ;
V_3 -> V_259 . V_260 = V_326 ;
V_3 -> V_259 . V_262 = V_7 ;
F_21 ( V_3 , L_95 ,
V_3 -> V_259 . V_260 ,
V_3 -> V_259 . V_261 ,
( unsigned long long ) V_3 -> V_259 . V_262 ) ;
for ( V_20 = 0 , V_6 = V_3 -> V_263 -> V_37 ; V_20 < V_326 ; V_20 ++ ) {
struct V_258 * V_327 = & V_3 -> V_259 . V_261 [ V_20 ] ;
V_327 -> V_328 = F_9 ( V_6 -> V_7 ) ;
V_327 -> V_329 = F_13 ( V_12 ) ;
V_327 -> V_330 = 0 ;
V_6 = V_6 -> V_16 ;
}
V_20 = F_138 ( V_3 , & V_3 -> V_292 -> V_331 ) ;
V_20 &= V_332 ;
V_20 |= V_326 ;
F_21 ( V_3 , L_96 ,
V_20 ) ;
F_150 ( V_3 , V_20 , & V_3 -> V_292 -> V_331 ) ;
F_21 ( V_3 , L_97 ) ;
F_21 ( V_3 , L_98 ,
( unsigned long long ) V_3 -> V_259 . V_262 ) ;
V_315 = F_135 ( V_3 , & V_3 -> V_292 -> V_333 ) ;
V_315 &= V_294 ;
V_315 |= ( V_3 -> V_259 . V_262 & ( T_4 ) ~ V_294 ) ;
F_136 ( V_3 , V_315 , & V_3 -> V_292 -> V_333 ) ;
F_133 ( V_3 ) ;
F_21 ( V_3 , L_99 ) ;
F_155 ( V_3 , 0 ) ;
F_69 ( & V_3 -> V_334 ) ;
for ( V_8 = 0 ; V_8 < V_266 ; ++ V_8 )
V_3 -> V_153 [ V_8 ] = NULL ;
for ( V_8 = 0 ; V_8 < V_310 ; ++ V_8 ) {
V_3 -> V_277 [ 0 ] . V_335 [ V_8 ] = 0 ;
V_3 -> V_277 [ 1 ] . V_335 [ V_8 ] = 0 ;
}
if ( F_120 ( V_3 , V_5 ) )
goto V_46;
if ( F_141 ( V_3 , V_5 ) )
goto V_46;
F_19 ( & V_3 -> V_336 ) ;
V_291 = F_138 ( V_3 , & V_3 -> V_311 -> V_337 ) ;
V_291 &= ~ V_338 ;
V_291 |= V_339 ;
F_150 ( V_3 , V_291 , & V_3 -> V_311 -> V_337 ) ;
return 0 ;
V_46:
F_43 ( V_3 , L_100 ) ;
F_156 ( V_3 ) ;
