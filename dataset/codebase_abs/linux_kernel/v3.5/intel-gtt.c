...
{
#ifdef F_109
const unsigned short V_227 = V_15 . V_16 -> V_86 ;
if ( ( V_227 == V_228 ||
V_227 == V_229 ) &&
V_230 )
return 1 ;
...
int F_114 ( struct V_235 * V_239 ,
struct V_23 * V_24 )
{
int V_10 , V_240 ;
V_15 . V_50 = NULL ;
for ( V_10 = 0 ; V_241 [ V_10 ] . V_215 != NULL ; V_10 ++ ) {
if ( F_111 ( V_241 [ V_10 ] . V_242 ) ) {
V_15 . V_50 =
V_241 [ V_10 ] . V_243 ;
break;
}
...
V_24 -> V_245 = & V_15 ;
V_24 -> V_42 = V_239 ;
V_15 . V_84 = F_115 ( V_239 ) ;
F_30 ( & V_239 -> V_42 , L_15 , V_241 [ V_10 ] . V_215 ) ;
V_240 = V_15 . V_50 -> V_246 ;
if ( F_116 ( V_15 . V_16 , F_117 ( V_240 ) ) )
F_76 ( & V_15 . V_16 -> V_42 ,
L_16 , V_240 ) ;
else
F_118 ( V_15 . V_16 ,
