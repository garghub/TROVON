...
int F_45 ( struct V_92 V_33 * V_93 ,
struct V_94 V_33 * V_95 )
{
struct V_2 * V_3 = F_11 () ;
struct V_96 * V_97 = & V_3 -> V_4 . V_5 ;
int V_98 = 0 ;
F_12 ( V_3 ) ;
V_98 |= F_46 ( & V_93 -> V_99 , & V_97 -> V_99 ,
sizeof( V_97 -> V_99 ) ) ;
F_47 ( V_97 -> V_13 , & V_93 -> V_13 , V_98 ) ;
F_47 ( V_97 -> V_12 , & V_95 -> V_12 , V_98 ) ;
F_47 ( V_97 -> V_100 , & V_95 -> V_100 , V_98 ) ;
F_47 ( V_97 -> V_101 , & V_95 -> V_101 , V_98 ) ;
if ( V_98 )
return - V_102 ;
F_44 ( V_3 ) ;
V_97 -> V_13 &= ~ ( V_79 | V_103 ) ;
return 0 ;
}
int F_48 ( struct V_92 V_33 * V_93 ,
struct V_94 V_33 * V_95 )
{
struct V_2 * V_3 = F_11 () ;
struct V_96 * V_97 = & V_3 -> V_4 . V_5 ;
...
int V_98 = 0 ;
F_44 ( V_3 ) ;
V_98 |= F_49 ( & V_97 -> V_99 , & V_93 -> V_99 ,
sizeof( V_97 -> V_99 ) ) ;
F_50 ( V_97 -> V_13 , & V_93 -> V_13 , V_98 ) ;
F_50 ( V_12 , & V_95 -> V_12 , V_98 ) ;
V_12 |= V_8 ;
V_12 &= ~ ( V_66 | V_68 ) ;
V_97 -> V_12 = V_12 ;
F_50 ( V_97 -> V_100 , & V_95 -> V_100 , V_98 ) ;
F_50 ( V_97 -> V_101 , & V_95 -> V_101 , V_98 ) ;
return V_98 ? - V_102 : 0 ;
}
static int F_51 ( struct V_16 * V_104 , unsigned long V_105 ,
void * V_106 )
{
if ( V_105 == V_107 || V_105 == V_108 ) {
F_3 ( ( long ) V_106 , F_11 () ) ;
} else if ( V_105 == V_109 || V_105 == V_110 )
F_33 ( NULL ) ;
return V_90 ;
}
...
if ( V_117 >= 2 ) {
V_129 |= V_131 ;
if ( ( ( F_5 ( V_132 ) & V_133 ) ) == 1 )
V_129 |= V_134 ;
}
#endif
if ( ( F_60 () & 0x000f0000 ) == 0x000f0000 ) {
#ifdef F_61
if ( ( F_5 ( V_135 ) & 0x000fff00 ) == 0x00011100 )
V_129 |= V_136 ;
#endif
if ( ( F_5 ( V_135 ) & 0xf0000000 ) == 0x10000000 )
V_129 |= V_137 ;
}
}
return 0 ;
