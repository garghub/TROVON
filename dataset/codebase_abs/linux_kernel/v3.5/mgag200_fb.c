...
struct V_37 V_38 ;
struct V_49 * V_50 = V_41 -> V_51 ;
struct V_25 * V_26 ;
struct V_52 * V_53 ;
struct V_8 * V_45 = NULL ;
struct V_54 * V_54 = & V_41 -> V_55 -> V_41 ;
struct V_10 * V_11 ;
int V_18 ;
void * V_24 ;
int V_44 ;
V_38 . V_5 = V_48 -> V_56 ;
V_38 . V_6 = V_48 -> V_57 ;
V_38 . V_23 [ 0 ] = V_38 . V_5 * ( ( V_48 -> V_58 + 7 ) / 8 ) ;
V_38 . V_46 = F_19 ( V_48 -> V_58 ,
V_48 -> V_59 ) ;
V_44 = V_38 . V_23 [ 0 ] * V_38 . V_6 ;
...
V_2 -> V_42 . V_53 = V_53 ;
V_2 -> V_42 . V_61 = V_26 ;
V_18 = F_23 ( & V_26 -> V_62 , 256 , 0 ) ;
if ( V_18 ) {
F_4 ( L_4 , V_26 -> V_63 . V_64 ) ;
V_18 = - V_60 ;
goto V_65;
}
...
V_26 -> V_71 -> V_72 [ 0 ] . V_16 = V_50 -> V_41 -> V_73 . V_74 ;
V_26 -> V_71 -> V_72 [ 0 ] . V_44 = V_50 -> V_75 . V_76 ;
F_25 ( V_26 , V_53 -> V_23 [ 0 ] , V_53 -> V_43 ) ;
F_26 ( V_26 , & V_2 -> V_42 , V_48 -> V_77 ,
V_48 -> V_78 ) ;
V_26 -> V_79 = V_24 ;
V_26 -> V_80 = V_44 ;
V_26 -> V_81 . V_66 = V_82 ;
...
static int F_28 ( struct V_83 * V_42 ,
struct V_47
* V_48 )
{
...
struct V_1 * V_2 ;
int V_18 ;
V_2 = F_38 ( sizeof( struct V_1 ) , V_87 ) ;
if ( ! V_2 )
return - V_60 ;
V_50 -> V_2 = V_2 ;
V_2 -> V_42 . V_88 = & V_89 ;
V_18 = F_39 ( V_50 -> V_41 , & V_2 -> V_42 ,
V_50 -> V_90 , V_91 ) ;
if ( V_18 ) {
F_40 ( V_2 ) ;
return V_18 ;
...
void F_43 ( struct V_49 * V_50 )
{
if ( ! V_50 -> V_2 )
return;
F_29 ( V_50 -> V_41 , V_50 -> V_2 ) ;
F_40 ( V_50 -> V_2 ) ;
V_50 -> V_2 = NULL ;
}
