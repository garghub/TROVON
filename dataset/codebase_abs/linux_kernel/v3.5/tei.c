...
V_25 = F_61 ( V_5 -> V_55 , V_126 , V_116 , V_40 , V_39 ) ;
if ( ! V_25 ) {
F_2 ( V_44 L_29 , V_45 ) ;
return NULL ;
}
...
V_25 = F_60 ( V_5 , V_40 , V_133 ) ;
if ( ! V_25 )
goto V_132;
else
F_30 ( & V_25 -> V_38 -> V_82 , V_134 , V_91 ) ;
return;
V_132:
...
int
F_72 ( struct V_24 * V_25 , T_4 V_137 , T_2 V_18 )
{
...
case V_142 :
if ( F_11 ( V_71 , & V_38 -> V_5 -> V_31 ) )
F_30 ( & V_38 -> V_5 -> V_64 , V_143 , NULL ) ;
break;
case V_144 :
if ( F_11 ( V_71 , & V_38 -> V_5 -> V_31 ) )
F_30 ( & V_38 -> V_5 -> V_64 , V_145 , NULL ) ;
break;
case V_146 :
if ( F_11 ( V_71 , & V_38 -> V_5 -> V_31 ) )
...
static int
F_74 ( struct V_4 * V_5 , struct V_117 * V_147 )
{
struct V_24 * V_25 ;
unsigned long V_116 = 0 ;
unsigned long V_26 ;
...
V_5 -> V_55 = V_147 -> V_13 ;
V_16 = V_153 ;
F_20 ( V_5 , V_154 , sizeof( V_16 ) , & V_16 ) ;
if ( F_11 ( V_60 , & V_5 -> V_31 ) )
F_20 ( V_5 , V_155 , 0 , NULL ) ;
V_147 -> V_13 = NULL ;
if ( ! F_76 ( & V_5 -> V_24 ) ) {
F_8 ( & V_5 -> V_27 , V_26 ) ;
F_9 (l2, &mgr->layer2, list) {
...
V_25 = F_61 ( V_147 -> V_13 , V_147 -> V_124 , V_116 ,
...
static int
F_77 ( struct V_160 * V_13 , struct V_50 * V_51 )
{
struct V_4 * V_5 ;
...
F_28 ( V_60 , & V_5 -> V_31 ) ;
if ( V_5 -> V_55 )
F_20 ( V_5 , V_165 , 0 , NULL ) ;
F_30 ( & V_5 -> V_64 , V_166 , NULL ) ;
V_135 = 0 ;
break;
case V_167 :
...
F_80 ( & V_5 -> V_13 . V_14 -> V_169 ) ;
F_53 ( & V_25 -> V_13 . V_101 ) ;
F_81 ( & V_5 -> V_13 . V_14 -> V_169 ) ;
V_25 -> V_13 . V_102 ( & V_25 -> V_13 , V_103 , NULL ) ;
}
F_28 ( V_71 , & V_5 -> V_31 ) ;
} else {
...
F_53 ( & V_5 -> V_13 . V_101 ) ;
F_53 ( & V_5 -> V_177 . V_101 ) ;
F_85 ( & V_5 -> V_62 ) ;
F_63 ( V_5 ) ;
}
static int
F_86 ( struct V_160 * V_13 , T_4 V_137 , void * V_18 )
{
struct V_4 * V_5 ;
int V_135 = - V_72 ;
V_5 = F_78 ( V_13 , struct V_4 , V_13 ) ;
...
static int
F_87 ( struct V_160 * V_13 , struct V_50 * V_51 )
{
struct V_4 * V_5 = F_78 ( V_13 , struct V_4 , V_177 ) ;
struct V_52 * V_180 , * V_53 = F_22 ( V_51 ) ;
...
static int
F_90 ( struct V_160 * V_13 , T_4 V_137 , void * V_18 )
{
return - V_72 ;
}
int
F_91 ( struct V_186 * V_15 )
{
struct V_4 * V_5 ;
...
F_96 ( & V_5 -> V_13 , V_15 -> V_170 . V_14 ) ;
V_5 -> V_177 . V_56 = F_87 ;
V_5 -> V_177 . V_102 = F_90 ;
V_5 -> V_177 . V_14 = V_15 -> V_170 . V_14 ;
F_95 ( & V_5 -> V_177 , 0 , V_58 ) ;
F_96 ( & V_5 -> V_177 , V_15 -> V_170 . V_14 ) ;
...
V_158 . V_194 = V_195 ;
V_158 . V_196 = V_197 ;
F_98 ( & V_158 , V_198 , F_99 ( V_198 ) ) ;
V_128 . V_190 = V_191 ;
V_128 . V_192 = V_193 ;
V_128 . V_194 = V_195 ;
V_128 . V_196 = V_197 ;
F_98 ( & V_128 , V_199 , F_99 ( V_199 ) ) ;
V_188 . V_190 = V_200 ;
V_188 . V_192 = V_201 ;
V_188 . V_194 = V_202 ;
V_188 . V_196 = V_203 ;
F_98 ( & V_188 , V_204 , F_99 ( V_204 ) ) ;
return 0 ;
}
void F_100 ( void )
{
