...
if ( V_29 )
return V_29 ;
V_62 = ( V_11 & V_65 ) ? V_66 : V_67 ;
V_29 = F_34 ( V_4 , V_62 , V_68 ,
V_51 , V_31 , V_61 ) ;
return V_29 ;
}
int F_35 ( struct V_3 * V_4 , T_3 V_31 , T_5 V_51 ,
T_5 V_11 , struct V_69 * V_70 )
{
T_5 V_62 ;
T_5 V_52 ;
int V_29 = 0 ;
...
return V_29 ;
V_62 = ( V_11 & V_65 ) ? V_66 : V_67 ;
V_29 = F_36 ( V_4 , V_62 , V_68 , V_51 , V_31 ,
V_70 ) ;
return V_29 ;
}
int
...
if ( V_52 == 4 )
V_31 |= V_48 ;
return F_34 ( V_4 , V_62 , V_36 , V_51 ,
V_31 , V_61 ) ;
}
int F_39 ( struct V_3 * V_4 , T_5 V_72 , T_3 V_31 ,
T_2 * V_56 , T_5 V_57 )
{
struct V_58 * V_59 ;
bool V_39 = V_72 ? V_36 : V_68 ;
int V_29 ;
V_31 &= V_46 ;
V_31 |= V_48 ;
V_59 = F_31 ( V_57 ) ;
...
void F_47 ( struct V_3 * V_4 , bool V_79 )
{
if ( V_79 )
F_48 ( V_4 -> V_7 , V_80 ) ;
else
