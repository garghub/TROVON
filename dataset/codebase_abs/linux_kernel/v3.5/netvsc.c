...
static void F_48 ( void * V_120 )
{
struct V_75 * V_87 = V_120 ;
struct V_2 * V_3 = (struct V_2 * ) V_87 -> V_3 ;
struct V_1 * V_4 ;
T_2 V_114 = 0 ;
bool V_121 = false ;
unsigned long V_78 ;
...
F_49 ( & V_87 -> V_123 -> V_80 ,
& V_4 -> V_127 ) ;
}
F_49 ( & V_87 -> V_80 , & V_4 -> V_127 ) ;
F_28 ( & V_4 -> V_122 , V_78 ) ;
if ( V_121 )
F_46 ( V_3 , V_114 ) ;
}
...
F_27 ( & V_4 -> V_122 , V_78 ) ;
while ( ! F_52 ( & V_4 -> V_127 ) ) {
F_53 ( V_4 -> V_127 . V_135 , & V_132 ) ;
...
V_5 = V_4 -> V_5 ;
do {
V_15 = F_56 ( V_3 -> V_25 , V_148 , V_149 ,
& V_145 , & V_146 ) ;
if ( V_15 == 0 ) {
if ( V_145 > 0 ) {
...
int F_58 ( struct V_2 * V_3 , void * V_154 )
{
int V_15 = 0 ;
int V_131 ;
int V_155 =
...
F_61 ( & V_4 -> V_42 ) ;
V_15 = F_62 ( V_3 -> V_25 , V_155 * V_161 ,
V_155 * V_161 , NULL , 0 ,
F_55 , V_3 ) ;
if ( V_15 != 0 ) {
F_11 ( V_5 , L_33 , V_15 ) ;
