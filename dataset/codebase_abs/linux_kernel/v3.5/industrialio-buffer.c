...
static unsigned char * F_56 ( struct V_9 * V_11 ,
unsigned char * V_111 )
{
struct V_112 * V_113 ;
if ( F_57 ( & V_11 -> V_21 ) )
...
memcpy ( V_11 -> V_114 + V_113 -> V_115 ,
V_111 + V_113 -> V_116 , V_113 -> V_102 ) ;
return V_11 -> V_114 ;
}
int F_58 ( struct V_9 * V_11 , unsigned char * V_117 ,
T_7 V_99 )
{
unsigned char * V_118 = F_56 ( V_11 , V_117 ) ;
return V_11 -> V_12 -> V_119 ( V_11 , V_118 , V_99 ) ;
}
static void F_59 ( struct V_9 * V_11 )
{
struct V_112 * V_55 , * V_120 ;
...
V_7 -> V_68 ,
V_122 + 1 ) ;
V_100 = F_47 ( V_7 , V_122 ) ;
V_102 = V_100 -> V_30 . V_38 / 8 ;
V_124 += V_102 ;
if ( V_124 % V_102 )
V_124 += V_102 - V_124 % V_102 ;
}
V_55 = F_52 ( sizeof( * V_55 ) , V_71 ) ;
if ( V_55 == NULL ) {
V_40 = - V_72 ;
goto V_126;
}
...
V_102 = V_100 -> V_30 . V_38 / 8 ;
if ( V_125 % V_102 )
V_125 += V_102 - V_125 % V_102 ;
if ( V_124 % V_102 )
V_124 += V_102 - V_124 % V_102 ;
V_55 -> V_116 = V_124 ;
V_55 -> V_115 = V_125 ;
V_55 -> V_102 = V_102 ;
F_63 ( & V_55 -> V_121 , & V_11 -> V_21 ) ;
V_125 += V_102 ;
V_124 += V_102 ;
}
if ( V_11 -> V_49 ) {
