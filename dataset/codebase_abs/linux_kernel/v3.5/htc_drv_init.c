...
if ( V_26 )
return - V_125 ;
V_2 -> V_222 = F_76 ( V_220 . V_223 ) ;
V_2 -> V_224 = F_76 ( V_220 . V_225 ) ;
...
if ( error != 0 )
goto V_233;
error = F_78 ( & V_55 -> V_234 , V_2 -> V_12 -> V_13 ,
F_23 ) ;
if ( error )
goto V_235;
V_57 = & V_55 -> V_234 ;
...
goto V_242;
if ( ! F_84 ( V_57 ) ) {
error = F_85 ( V_12 -> V_13 , V_57 -> V_243 ) ;
if ( error )
goto V_244;
}
error = F_86 ( V_2 -> V_10 ) ;
...
V_2 -> V_45 ,
V_2 -> V_47 ) ;
F_87 ( V_2 -> V_10 , V_231 , sizeof( V_231 ) ) ;
F_88 ( V_12 -> V_13 , L_21 , V_231 ) ;
F_89 ( V_2 ) ;
F_90 ( V_2 ) ;
return 0 ;
V_244:
...
int F_91 ( struct V_245 * V_246 , struct V_247 * V_8 ,
T_1 V_24 , char * V_144 , T_2 V_25 )
{
struct V_11 * V_12 ;
struct V_1 * V_2 ;
int V_26 ;
V_12 = F_92 ( sizeof( struct V_1 ) , & V_248 ) ;
if ( ! V_12 )
return - V_148 ;
V_2 = V_12 -> V_2 ;
V_2 -> V_12 = V_12 ;
...
void F_97 ( struct V_245 * V_246 , bool V_251 )
{
if ( V_246 -> V_249 ) {
if ( V_251 )
...
F_9 ( V_246 -> V_249 ) ;
F_95 ( V_246 -> V_249 ) ;
F_96 ( V_246 -> V_249 -> V_12 ) ;
}
}
void F_98 ( struct V_245 * V_246 )
{
F_99 ( V_246 -> V_249 , V_253 ) ;
}
int F_100 ( struct V_245 * V_246 )
{
