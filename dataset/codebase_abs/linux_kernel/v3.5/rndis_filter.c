...
V_133 ,
& V_132 , & V_98 ) ;
V_9 -> V_134 = ( V_132 != 0 ) ? true : false ;
return V_61 ;
}
int F_35 ( struct V_1 * V_9 , T_1 V_135 )
{
struct V_8 * V_12 ;
struct V_15 * V_16 ;
struct V_136 * V_56 ;
...
if ( ! V_12 )
goto V_124;
V_149 = & V_12 -> V_19 . V_21 . V_151 ;
V_149 -> V_23 = F_7 ( & V_9 -> V_24 ) ;
F_17 ( V_9 , V_12 ) ;
V_9 -> V_6 = V_7 ;
V_124:
if ( V_12 )
...
memcpy ( V_158 -> V_159 , V_1 -> V_131 , V_129 ) ;
F_34 ( V_1 ) ;
V_158 -> V_134 = V_1 -> V_134 ;
F_42 ( & V_9 -> V_2 , L_29 ,
V_1 -> V_131 ,
V_158 -> V_134 ? L_30 : L_31 ) ;
return V_61 ;
}
void F_43 ( struct V_27 * V_9 )
{
struct V_31 * V_79 = F_15 ( V_9 ) ;
...
if ( ! V_29 )
return - V_111 ;
return F_38 ( V_29 -> V_112 ) ;
}
int F_46 ( struct V_27 * V_9 )
{
struct V_31 * V_160 = F_15 ( V_9 ) ;
if ( ! V_160 )
return - V_111 ;
return F_39 ( V_160 -> V_112 ) ;
}
...
struct V_92 * V_99 ;
T_1 V_162 ;
bool V_163 = V_34 -> V_105 & V_106 ;
V_161 = (struct V_84 * ) V_34 -> V_112 ;
V_14 = & V_161 -> V_21 ;
V_162 = F_31 ( struct V_92 ) ;
if ( V_163 )
V_162 += V_164 ;
V_14 -> V_20 = V_33 ;
V_14 -> V_11 = V_34 -> V_65 +
...
V_95 -> V_97 ) ;
V_101 -> V_107 = V_34 -> V_105 & V_165 ;
V_101 -> V_108 = ( V_34 -> V_105 & V_166 ) >> V_109 ;
}
V_34 -> V_64 = true ;
V_34 -> V_67 [ 0 ] . V_68 = F_18 ( V_14 ) >> V_69 ;
V_34 -> V_67 [ 0 ] . V_71 =
( unsigned long ) V_14 & ( V_72 - 1 ) ;
V_34 -> V_67 [ 0 ] . V_70 = V_162 ;
if ( V_34 -> V_67 [ 0 ] . V_71 + V_162 > V_72 ) {
int V_167 ;
for ( V_167 = V_34 -> V_66 ; V_167 > 1 ; V_167 -- )
V_34 -> V_67 [ V_167 ] = V_34 -> V_67 [ V_167 - 1 ] ;
V_34 -> V_66 ++ ;
V_34 -> V_67 [ 0 ] . V_70 = V_72 - V_34 -> V_67 [ 0 ] . V_71 ;
V_34 -> V_67 [ 1 ] . V_68 = F_18 ( ( void * ) ( ( V_96 )
V_14 + V_34 -> V_67 [ 0 ] . V_70 ) ) >> V_69 ;
V_34 -> V_67 [ 1 ] . V_71 = 0 ;
V_34 -> V_67 [ 1 ] . V_70 = V_162 - V_34 -> V_67 [ 0 ] . V_70 ;
}
V_161 -> V_73 = V_34 -> V_73 . V_74 . V_76 ;
V_161 -> V_168 =
V_34 -> V_73 . V_74 . V_75 ;
V_34 -> V_73 . V_74 . V_76 = V_169 ;
V_34 -> V_73 . V_74 . V_75 = V_161 ;
V_61 = F_19 ( V_9 , V_34 ) ;
if ( V_61 != 0 ) {
V_34 -> V_73 . V_74 . V_76 =
V_161 -> V_73 ;
...
static void V_169 ( void * V_170 )
{
struct V_84 * V_161 = V_170 ;
V_161 -> V_73 ( V_161 -> V_168 ) ;
}
static void V_77 ( void * V_170 )
{
}
