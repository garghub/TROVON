...
if ( V_547 == NULL )
return - V_146 ;
V_543 = V_126 -> V_152 . V_552 ;
V_86 = V_543 -> V_86 ;
V_16 = F_197 ( & V_126 -> V_152 , V_544 , V_86 ) ;
V_18 = F_60 ( & V_126 -> V_152 , sizeof( * V_18 ) , V_197 ) ;
if ( ! V_16 || ! V_18 )
return - V_198 ;
#if F_194 ( V_548 )
V_18 -> V_553 = F_60 ( & V_126 -> V_152 ,
sizeof( struct V_554 * ) * V_86 ,
V_197 ) ;
if ( ! V_18 -> V_553 )
return - V_198 ;
#endif
...
V_18 -> V_492 = V_509 ;
V_16 -> V_555 = NULL ;
V_18 -> V_6 = F_198 ( & V_126 -> V_152 , V_547 -> V_121 ,
F_199 ( V_547 ) ) ;
V_18 -> V_6 -= V_8 ;
#if F_194 ( V_548 )
V_18 -> V_554 = F_200 ( & V_126 -> V_152 , NULL ) ;
if ( F_201 ( V_18 -> V_554 ) )
F_202 ( & V_126 -> V_152 , L_59 ) ;
else
F_203 ( V_18 -> V_554 ) ;
for ( V_3 = 0 ; V_3 < V_86 ; V_3 ++ ) {
char V_556 [ 16 ] ;
sprintf ( V_556 , L_60 , V_3 ) ;
V_18 -> V_553 [ V_3 ] = F_200 ( & V_126 -> V_152 , V_556 ) ;
if ( ! F_201 ( V_18 -> V_553 [ V_3 ] ) )
F_203 ( V_18 -> V_553 [ V_3 ] ) ;
}
#endif
V_534 = F_204 () ;
if ( V_534 )
...
if ( V_429 )
goto V_120;
F_205 ( & V_126 -> V_152 , L_61 ,
( unsigned ) V_192 , V_16 -> V_86 ) ;
V_429 = F_206 ( V_16 , F_207 ( V_126 , 0 ) , F_134 ,
V_557 , & V_558 ) ;
if ( ! V_429 )
return 0 ;
V_120:
...
for ( V_3 = 0 ; V_3 < V_86 ; V_3 ++ ) {
if ( ! F_201 ( V_18 -> V_553 [ V_3 ] ) ) {
F_208 ( V_18 -> V_553 [ V_3 ] ) ;
F_209 ( V_18 -> V_553 [ V_3 ] ) ;
}
}
#endif
return V_429 ;
}
static int T_8 F_210 ( struct V_541 * V_126 )
{
struct V_15 * V_16 = F_211 ( V_126 ) ;
#if F_194 ( V_548 )
struct V_17 * V_18 = V_16 -> V_19 ;
int V_3 ;
#endif
...
static int F_213 ( struct V_541 * V_126 , T_9 V_559 )
{
struct V_15 * V_16 = F_211 ( V_126 ) ;
if ( V_16 )
return F_214 ( V_16 , V_559 ) ;
else
return 0 ;
}
static int F_215 ( struct V_541 * V_126 )
{
struct V_15 * V_16 = F_211 ( V_126 ) ;
const struct V_533 * V_534 ;
int V_560 ;
...
static int F_217 ( struct V_125 * V_126 )
{
int V_429 ;
if ( ! F_218 ( V_126 , F_219 ( 64 ) ) ) {
V_429 = F_220 ( V_126 , F_219 ( 64 ) ) ;
if ( V_429 ) {
V_429 = F_220 ( V_126 , F_219 ( 32 ) ) ;
if ( V_429 ) {
F_131 ( & V_126 -> V_152 ,
L_63 ) ;
return V_429 ;
...
V_429 = F_218 ( V_126 , F_219 ( 32 ) ) ;
if ( V_429 ) {
F_131 ( & V_126 -> V_152 , L_64 ) ;
return V_429 ;
}
V_429 = F_220 ( V_126 , F_219 ( 32 ) ) ;
if ( V_429 ) {
...
struct V_17 * V_18 = V_16 -> V_19 ;
T_3 V_561 ;
const char * V_562 , * V_563 ;
F_222 ( V_126 , V_564 , & V_561 ) ;
if ( V_561 == 0 )
V_562 = L_66 ;
else if ( V_561 == 0x01 )
V_562 = L_67 ;
...
V_563 = L_68 ;
F_205 ( & V_126 -> V_152 , L_72 ,
V_563 , ( unsigned ) V_192 , V_16 -> V_86 ,
V_562 , ( V_399 & V_18 -> V_170 ) ? L_73 : L_74 ) ;
}
static int F_223 ( struct V_125 * V_126 ,
const struct V_565 * V_566 )
{
unsigned int V_492 = ( unsigned int ) V_566 -> V_567 ;
...
if ( V_429 )
return V_429 ;
V_429 = F_225 ( V_126 , 1 << V_568 , V_329 ) ;
if ( V_429 == - V_569 )
F_226 ( V_126 ) ;
if ( V_429 )
return V_429 ;
V_16 -> V_555 = F_227 ( V_126 ) ;
V_18 -> V_6 = V_16 -> V_555 [ V_568 ] ;
V_429 = F_217 ( V_126 ) ;
if ( V_429 )
return V_429 ;
V_429 = F_188 ( V_18 , & V_126 -> V_152 ) ;
...
F_228 ( V_21 , V_568 , - 1 , L_75 ) ;
F_228 ( V_21 , V_568 , V_210 , L_76 ) ;
}
V_429 = F_187 ( V_16 ) ;
if ( V_429 )
return V_429 ;
if ( V_570 && F_229 ( V_126 ) == 0 )
V_18 -> V_170 |= V_399 ;
F_37 ( V_126 , 0x68 ) ;
F_221 ( V_16 ) ;
F_230 ( V_126 ) ;
F_231 ( V_126 ) ;
return F_206 ( V_16 , V_126 -> V_396 , F_134 , V_557 ,
F_25 ( V_18 ) ? & V_571 : & V_558 ) ;
}
static int F_232 ( struct V_125 * V_126 )
{
struct V_15 * V_16 = F_233 ( V_126 ) ;
int V_429 ;
V_429 = F_234 ( V_126 ) ;
if ( V_429 )
return V_429 ;
