...
static int F_97 ( struct V_144 * V_144 , void * V_187 , unsigned int * V_26 )
{
struct V_103 * V_104 = V_187 ;
struct V_1 * V_2 = V_104 -> V_2 ;
* V_26 = V_2 -> V_229 ;
...
for ( V_26 = 0 ; V_26 < V_224 ; V_26 ++ ) {
int V_234 = 0 ;
if ( F_96 ( V_26 ) . V_235 == NULL )
continue;
if ( V_26 == V_207 )
V_234 = 1 ;
else
...
return V_48 ;
if ( V_104 -> type == V_137 )
V_48 = F_119 ( & V_104 -> V_159 , V_290 ) ;
else if ( V_104 -> type == V_139 )
V_48 = F_119 ( & V_104 -> V_162 , V_290 ) ;
return V_48 ;
}
...
return V_48 ;
if ( V_104 -> type == V_137 )
V_48 = F_121 ( & V_104 -> V_159 , V_292 ) ;
else if ( V_104 -> type == V_139 )
V_48 = F_121 ( & V_104 -> V_162 , V_292 ) ;
return V_48 ;
}
...
return V_48 ;
if ( V_104 -> type == V_137 )
V_48 = F_123 ( & V_104 -> V_159 , V_292 ) ;
else if ( V_104 -> type == V_139 )
V_48 = F_123 ( & V_104 -> V_162 , V_292 ) ;
return V_48 ;
}
...
if ( V_104 -> type == V_137 )
V_48 = F_125 ( & V_104 -> V_159 , V_292 , V_144 -> V_169 & V_170 ) ;
else if ( V_104 -> type == V_139 )
V_48 = F_125 ( & V_104 -> V_162 , V_292 , V_144 -> V_169 & V_170 ) ;
return V_48 ;
}
...
V_297 = V_294 -> V_300 ;
for ( V_26 = 0 ; V_26 < V_297 -> V_301 . V_303 ; V_26 ++ ) {
V_299 = & V_297 -> V_299 [ V_26 ] . V_301 ;
if ( ( ( V_299 -> V_304 & V_305 )
== V_306 ) &&
( ( V_299 -> V_307 & V_308 )
== V_309 ) ) {
T_7 V_215 = F_127 ( V_299 -> V_310 ) ;
V_2 -> V_43 = ( V_215 & 0x07ff ) *
( ( ( V_215 & 0x1800 ) >> 11 ) + 1 ) ;
...
* V_2 -> V_131 = V_314 ;
V_2 -> V_131 -> V_315 = & V_2 -> V_39 -> V_2 ;
strcpy ( V_2 -> V_131 -> V_196 , L_78 ) ;
* V_2 -> V_132 = V_314 ;
V_2 -> V_132 -> V_315 = & V_2 -> V_39 -> V_2 ;
