...
V_134 [ 2 ] &= ~ 0x20 ;
if ( V_6 -> V_12 . V_136 )
V_134 [ 3 ] = V_6 -> V_12 . V_136 ;
if ( V_6 -> V_12 . V_137 )
V_134 [ 4 ] = V_6 -> V_12 . V_137 ;
...
static int F_24 ( struct V_1 * V_2 , int V_138 )
{
struct V_5 * V_6 = V_2 -> V_7 ;
T_1 V_4 = 0x0a ;
if ( V_6 -> V_12 . V_139 ) {
...
struct V_1 * F_27 ( const struct V_140 * V_12 ,
struct V_141 * V_17 )
{
struct V_5 * V_6 = NULL ;
int V_142 ;
V_6 = F_28 ( sizeof( struct V_5 ) , V_143 ) ;
if ( V_6 == NULL )
goto error;
V_6 -> V_17 = V_17 ;
memcpy ( & V_6 -> V_12 , V_12 , sizeof( struct V_140 ) ) ;
V_142 = F_5 ( V_6 , V_144 ) ;
if ( ( V_142 != V_145 ) && ( V_142 != V_146 ) && ( V_142 != V_147 ) )
goto error;
memcpy ( & V_6 -> V_148 . V_86 , & V_149 , sizeof( struct V_150 ) ) ;
V_6 -> V_148 . V_7 = V_6 ;
return & V_6 -> V_148 ;
error:
F_26 ( V_6 ) ;
