...
int F_70 ( struct V_20 * V_21 , void * V_272 ,
struct V_184 * V_185 )
{
struct V_45 * V_46 = V_21 -> V_47 ;
struct V_273 * V_274 = V_272 ;
struct V_275 * V_276 ;
struct V_48 * V_3 ;
if ( ! V_46 ) {
F_21 ( V_21 -> V_21 , L_22 ) ;
...
int F_74 ( struct V_20 * V_21 , int V_279 )
{
int V_280 = 0 ;
struct V_24 * V_108 ;
int V_281 = 0 ;
