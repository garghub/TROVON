...
V_2 -> V_21 = V_21 ;
F_30 ( & V_2 -> V_15 ) ;
V_2 -> V_15 . V_69 . V_70 = L_9 ;
V_2 -> V_15 . V_69 . V_71 = V_72 ;
V_2 -> V_15 . V_73 = F_9 ;
V_2 -> V_57 . V_73 = F_23 ;
V_2 -> V_15 . V_16 = V_2 -> V_18 . V_74 ;
if ( ! ( V_18 -> V_19 & V_75 ) ) {
V_2 -> V_15 . V_76 = F_22 ;
V_2 -> V_15 . V_69 . V_71 |= V_77 ;
V_2 -> V_57 . V_76 = F_24 ;
}
V_60 = F_31 ( & V_27 -> V_28 . V_32 , & V_2 -> V_15 ) ;
if ( V_60 )
goto V_63;
if ( V_18 -> V_78 )
V_18 -> V_78 ( & V_2 -> V_57 , V_18 -> V_79 ) ;
F_32 ( & V_27 -> V_28 , L_10 ,
( V_2 -> V_15 . V_16 < 1024 )
? V_2 -> V_15 . V_16
: ( V_2 -> V_15 . V_16 / 1024 ) ,
( V_2 -> V_15 . V_16 < 1024 ) ? L_11 : L_12 ,
V_2 -> V_18 . V_70 ,
( V_18 -> V_19 & V_75 ) ? L_13 : L_14 ,
V_2 -> V_18 . V_41 ) ;
return 0 ;
V_63:
F_7 ( & V_27 -> V_28 , L_15 , V_60 ) ;
F_21 ( V_2 ) ;
return V_60 ;
}
static int T_6 F_33 ( struct V_58 * V_27 )
{
struct V_1 * V_2 ;
V_2 = F_11 ( & V_27 -> V_28 ) ;
F_34 ( & V_27 -> V_28 . V_32 , & V_2 -> V_15 ) ;
F_21 ( V_2 ) ;
return 0 ;
}
