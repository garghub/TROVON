...
static int F_17 ( struct V_11 * V_12 , int V_22 , T_1 * V_15 , T_1 V_2 )
{
int V_17 , V_3 ;
T_3 V_19 ;
if ( V_2 == V_5 )
...
V_20 [ 15 ] = V_12 -> V_124 ;
V_22 = F_31 ( 18 , ( int ) F_44 ( V_119 ) ) ;
F_45 ( V_20 , V_22 , V_119 ) ;
return V_71 ;
}
int F_46 ( struct V_118 * V_119 , struct V_11 * V_12 )
{
struct V_60 * V_61 = & ( V_12 -> V_61 ) ;
unsigned int V_57 = F_40 ( V_119 ) ;
int V_17 ;
...
int F_48 ( struct V_118 * V_119 , struct V_11 * V_12 )
{
struct V_60 * V_61 = & ( V_12 -> V_61 ) ;
int V_17 ;
unsigned int V_57 = F_40 ( V_119 ) ;
...
V_59 , V_1 , V_14 , V_77 ,
F_49 ( V_119 ) , F_44 ( V_119 ) ,
F_50 ( V_119 ) ) ;
F_47 ( V_119 , 0 ) ;
return V_17 ;
}
int F_51 ( struct V_118 * V_119 , struct V_11 * V_12 )
{
struct V_60 * V_61 = & ( V_12 -> V_61 ) ;
int V_17 ;
unsigned int V_57 = F_40 ( V_119 ) ;
