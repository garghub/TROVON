...
static int F_73 ( struct V_153 * V_153 , void * V_154 , struct V_195 * V_196 )
{
struct V_71 * V_72 = V_154 ;
struct V_1 * V_2 = V_72 -> V_2 ;
if ( ! V_2 -> V_197 . V_198 )
...
V_2 -> V_313 ) ;
V_72 = F_129 ( sizeof( struct V_71 ) , V_314 ) ;
if ( ! V_72 ) {
F_49 ( L_52 ) ;
return - V_315 ;
}
...
V_94 = V_165 ;
F_132 ( & V_72 -> V_169 , & V_318 ,
NULL , & V_2 -> V_90 ,
V_128 , V_94 ,
sizeof( struct V_5 ) , V_72 , & V_2 -> V_319 ) ;
F_132 ( & V_72 -> V_248 , & V_320 ,
NULL , & V_2 -> V_90 ,
V_130 ,
V_321 ,
sizeof( struct V_5 ) , V_72 , & V_2 -> V_319 ) ;
...
static int F_138 ( struct V_153 * V_304 )
{
struct V_71 * V_72 = V_304 -> V_316 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_305 ;
F_38 ( L_55 , V_2 -> V_313 ) ;
if ( F_39 ( V_72 , V_129 ) ) {
...
F_19 ( & V_2 -> V_86 , 0 , V_174 , V_324 , 0 ) ;
F_142 ( V_2 , V_102 ) ;
F_130 ( V_2 , V_325 ) ;
V_2 -> V_326 = 0 ;
F_38 ( L_56 ) ;
V_305 = F_143 ( V_2 -> V_255 , 0 , 0 ) ;
if ( V_305 < 0 ) {
F_49 ( L_57
L_58 , V_305 ) ;
}
...
static T_3
F_145 ( struct V_153 * V_304 , char T_4 * V_6 , T_5 V_70 ,
T_6 * V_31 )
{
struct V_71 * V_72 = V_304 -> V_316 ;
struct V_1 * V_2 = V_72 -> V_2 ;
...
if ( F_40 ( V_2 , V_129 ) )
return - V_171 ;
return F_146 ( & V_72 -> V_169 , V_6 , V_70 , V_31 , 0 ,
V_304 -> V_300 & V_301 ) ;
}
if ( V_72 -> type == V_130 ) {
if ( ! F_37 ( V_72 , V_131 ) )
return - V_171 ;
return F_146 ( & V_72 -> V_248 , V_6 , V_70 , V_31 , 0 ,
V_304 -> V_300 & V_301 ) ;
}
return 0 ;
}
static unsigned int F_147 ( struct V_153 * V_304 , T_7 * V_327 )
{
struct V_71 * V_72 = V_304 -> V_316 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
if ( ! F_37 ( V_72 , V_129 ) )
return V_328 ;
return F_148 ( V_304 , & V_72 -> V_169 , V_327 ) ;
} else if ( V_72 -> type == V_130 ) {
if ( ! F_37 ( V_72 , V_131 ) )
return V_328 ;
return F_148 ( V_304 , & V_72 -> V_248 , V_327 ) ;
} else {
return V_328 ;
}
}
static int F_149 ( struct V_153 * V_304 , struct V_329 * V_330 )
{
struct V_71 * V_72 = V_304 -> V_316 ;
struct V_1 * V_2 = V_72 -> V_2 ;
int V_53 ;
...
return V_53 ;
if ( V_72 -> type == V_128 )
V_53 = F_150 ( & V_72 -> V_169 , V_330 ) ;
else if ( V_72 -> type == V_130 )
V_53 = F_150 ( & V_72 -> V_248 , V_330 ) ;
F_38 ( L_59 ,
...
static struct V_306 * F_151 ( struct V_1 * V_2 ,
...
V_335 -> V_336 = F_136 ;
V_335 -> V_337 = V_338 ;
V_335 -> V_319 = & V_2 -> V_319 ;
F_153 ( V_339 , & V_335 -> V_89 ) ;
snprintf ( V_335 -> V_187 , sizeof( V_335 -> V_187 ) , L_60 ,
V_2 -> V_187 , V_334 ) ;
F_154 ( V_335 , V_2 ) ;
return V_335 ;
}
...
V_2 -> V_140 = 1 ;
V_2 -> V_142 = 0x1f ;
V_232 = ( T_8 ) F_88 ( V_2 , V_345 ) ;
F_157 ( V_2 , V_345 ,
( V_346 | V_232 ) ) ;
F_158 ( V_2 ) ;
F_159 ( V_2 ) ;
F_160 ( V_2 ) ;
V_2 -> V_193 = F_151 ( V_2 , & V_342 , L_62 ) ;
if ( ! V_2 -> V_193 ) {
F_49 ( L_63 ) ;
return - V_147 ;
}
V_229 = F_161 ( V_2 -> V_193 , V_309 ,
V_347 [ V_2 -> V_348 ] ) ;
if ( V_229 ) {
F_49 ( L_64 ,
V_229 ) ;
...
if ( F_28 ( V_2 ) == 1 ) {
V_2 -> V_262 = F_151 ( V_2 , & V_342 ,
L_65 ) ;
V_229 = F_161 ( V_2 -> V_262 , V_310 ,
V_349 [ V_2 -> V_348 ] ) ;
if ( V_229 < 0 ) {
F_49 ( L_66 ) ;
return V_229 ;
...
if ( V_253 [ V_2 -> V_254 ] . V_83 . type == V_350 ) {
V_2 -> V_322 = F_151 ( V_2 , & V_351 ,
L_67 ) ;
if ( ! V_2 -> V_322 ) {
F_49 ( L_63 ) ;
return - V_147 ;
}
V_229 = F_161 ( V_2 -> V_322 , V_311 ,
V_352 [ V_2 -> V_348 ] ) ;
if ( V_229 < 0 ) {
F_49 ( L_68 ) ;
return V_229 ;
