...
V_2 -> V_7 -= V_34 ;
if ( F_72 ( V_2 ) && V_2 -> V_9 && V_134 && ! V_2 -> V_7 )
V_34 = 0 ;
F_9 ( & V_2 -> V_18 , V_17 ) ;
* V_133 += V_34 ;
* V_44 -= V_34 ;
...
static T_2 F_132 ( struct V_1 * V_2 , struct V_135 * V_135 ,
...
int V_14 ;
T_2 V_42 = 0 ;
if ( F_133 ( V_2 ) && V_135 -> V_136 -> V_40 != V_137 ) {
V_42 = F_134 ( V_2 ) ;
if ( V_42 )
return V_42 ;
}
F_32 ( V_2 ) ;
F_124 ( & V_2 -> V_128 , & V_142 ) ;
while ( 1 ) {
F_125 ( V_154 ) ;
if ( F_127 ( V_112 ) ) {
V_42 = - V_141 ;
...
if ( F_126 ( V_135 ) || ( V_2 -> V_28 && ! V_2 -> V_28 -> V_19 ) ) {
V_42 = - V_139 ;
break;
}
if ( F_33 ( V_2 ) && ! ( F_34 ( V_59 , & V_2 -> V_17 ) ) ) {
while ( V_44 > 0 ) {
T_2 V_161 = F_31 ( V_2 , V_133 , V_44 ) ;
if ( V_161 < 0 ) {
if ( V_161 == - V_151 )
break;
V_42 = V_161 ;
...
V_47:
F_129 ( V_156 ) ;
F_131 ( & V_2 -> V_128 , & V_142 ) ;
if ( V_133 - V_12 != V_44 && V_2 -> V_94 )
F_90 ( V_97 , & V_2 -> V_17 ) ;
return ( V_133 - V_12 ) ? V_133 - V_12 : V_42 ;
}
static unsigned int F_136 ( struct V_1 * V_2 , struct V_135 * V_135 ,
T_4 * V_142 )
{
unsigned int V_162 = 0 ;
F_137 ( V_135 , & V_2 -> V_33 , V_142 ) ;
F_137 ( V_135 , & V_2 -> V_128 , V_142 ) ;
...
static int F_141 ( struct V_1 * V_2 , struct V_135 * V_135 ,
unsigned int V_170 , unsigned long V_171 )
{
int V_42 ;
switch ( V_170 ) {
case V_172 :
return F_3 ( F_139 ( V_2 ) , ( int T_1 * ) V_171 ) ;
case V_173 :
V_42 = V_2 -> V_7 ;
if ( F_104 ( V_2 ) )
V_42 = F_140 ( V_2 ) ;
...
default:
return F_142 ( V_2 , V_135 , V_170 , V_171 ) ;
}
}
void F_143 ( struct V_174 * V_39 )
{
* V_39 = V_175 ;
V_39 -> V_176 = NULL ;
