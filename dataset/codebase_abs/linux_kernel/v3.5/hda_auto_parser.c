...
int V_91 = F_19 ( V_35 ) ;
const char * V_101 = L_30 , * V_102 = L_30 ;
if ( ! strcmp ( V_98 , L_31 ) && V_91 == V_80 )
V_98 = L_32 ;
switch ( V_91 ) {
case V_83 :
V_101 = L_33 ;
...
snprintf ( V_99 , V_100 , L_35 , V_101 , V_98 , V_102 ) ;
return 1 ;
}
...
V_99 , V_100 , V_96 ) ;
case V_45 :
return F_24 ( V_19 , V_1 , V_10 , L_32 ,
V_99 , V_100 , V_96 ) ;
case V_50 :
return F_24 ( V_19 , V_1 , V_10 , L_36 ,
V_99 , V_100 , V_96 ) ;
case V_60 :
case V_61 :
if ( F_13 ( V_35 ) == V_65 )
...
int V_114 = - 1 ;
const char * V_98 = NULL ;
if ( V_19 -> V_116 && ! strcmp ( V_19 -> V_116 , L_43 ) ) {
V_105 -> V_119 = NULL ;
V_105 -> V_115 = - 1 ;
return;
}
