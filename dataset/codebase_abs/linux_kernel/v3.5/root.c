...
static struct V_22 * F_46 ( struct V_47 * V_48 , struct V_22 * V_22 , struct V_49 * V_50 )
{
if ( ! F_47 ( V_48 , V_22 , V_50 ) ) {
return NULL ;
}
return F_48 ( V_48 , V_22 , V_50 ) ;
}
...
int V_57 ;
if ( V_55 < V_58 ) {
int error = F_50 ( V_52 , V_53 , V_54 ) ;
if ( error <= 0 )
return error ;
V_52 -> V_56 = V_58 ;
}
V_57 = F_51 ( V_52 , V_53 , V_54 ) ;
return V_57 ;
}
