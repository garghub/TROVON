...
while ( 1 ) {
F_62 ( & V_100 ) ;
if ( V_100 . V_26 . V_44 . V_33 . V_45 == 0 )
break;
F_68 ( 100 ) ;
}
}
static int
F_69 ( struct V_72 V_21 , void * V_101 )
{
if ( F_30 ( V_21 , & V_100 . V_26 ) != 0 )
return - V_77 ;
if ( ( V_100 . V_26 . V_53 . V_78 == V_79 ) &&
V_100 . V_26 . V_53 . V_102 &&
( V_100 . V_26 . V_53 . V_25 == V_103 ) ) {
V_104 = V_21 . V_23 ;
return 1 ;
}
return 0 ;
...
V_21 . V_23 = V_104 ;
if ( F_30 ( V_21 , & V_100 . V_26 ) != 0 ||
( V_100 . V_26 . V_53 . V_78 != V_79 ) ||
! V_100 . V_26 . V_53 . V_102 )
return - 1 ;
V_103 = V_100 . V_26 . V_53 . V_25 ;
} else if ( V_103 != - 1 ) {
F_72 ( F_69 , NULL ) ;
if ( V_104 == - 1 )
return - 1 ;
...
memset ( & V_100 , 0 , sizeof( struct V_7 ) ) ;
F_71 ( & V_21 ) ;
V_21 . V_23 = V_23 ;
V_64 = F_45 ( & V_100 , V_21 ) ;
if ( V_64 ) {
V_99 = 0 ;
return F_75 ( - V_24 ) ;
}
F_77 ( V_105 ) ;
V_100 . V_54 . V_56 = V_105 ;
V_100 . V_54 . V_34 = ( V_35 ) ( V_36 ) & V_100 ;
V_64 = F_29 ( & V_100 ) ;
if ( V_64 ) {
F_78 ( V_105 ) ;
V_99 = 0 ;
...
for ( V_63 = 0 ; V_63 < 3 ; V_63 ++ ) {
V_26 -> V_53 . V_57 = 0 ;
V_106 = F_32 ( V_21 , V_26 ) ;
if ( V_106 )
return ( V_106 == 3 ? - V_24 : - V_47 ) ;
...
struct V_83 V_107 ;
if ( F_60 ( & V_107 ) ) {
F_36 ( V_107 . V_21 , (struct V_67 * ) & V_87 . V_67 ) ;
if ( F_80 ( & V_107 . V_21 , & V_21 ) )
return 0 ;
}
F_68 ( 100 ) ;
}
...
static int F_86 ( struct V_72 V_21 , struct V_26 * V_109 )
{
int V_110 ;
V_108 = 0 ;
V_111 = F_85 ;
V_110 = F_30 ( V_21 , V_109 ) ;
V_111 = NULL ;
F_87 () ;
if ( V_108 )
return - V_66 ;
...
static int F_88 ( struct V_72 V_21 , void * V_101 )
{
struct V_26 V_26 ;
if ( F_86 ( V_21 , & V_26 ) )
return - V_77 ;
...
struct V_113 V_113 ;
struct V_114 * V_114 ;
V_114 = (struct V_114 * ) & V_87 . V_115 ;
if ( ! V_114 -> V_116 )
return;
while ( F_90 ( & V_113 ) == 0 ) {
if ( V_113 . V_117 && V_113 . V_118 == V_119 )
F_91 ( & V_120 ) ;
}
}
...
static int F_106 ( struct V_72 V_21 , void * V_101 )
{
struct V_26 V_26 ;
struct V_130 * V_131 = V_101 ;
if ( F_86 ( V_21 , & V_26 ) )
return - V_77 ;
if ( ( V_26 . V_53 . V_78 == V_79 ) && V_26 . V_53 . V_102 &&
( V_26 . V_53 . V_25 == V_131 -> V_132 . V_133 ) &&
( V_21 . V_22 == V_131 -> V_132 . V_22 ) ) {
V_131 -> V_21 = V_21 ;
V_131 -> V_110 = 0 ;
return 1 ;
}
...
static int F_107 ( struct V_134 * V_132 ,
struct V_72 * V_21 )
{
struct V_130 V_131 ;
V_131 . V_132 = * V_132 ;
...
void F_108 ( struct V_134 * V_132 )
{
struct V_72 V_21 ;
F_109 ( NULL , NULL ) ;
if ( F_107 ( V_132 , & V_21 ) != 0 )
F_110 ( L_19 ) ;
F_111 ( * ( ( V_43 * ) & V_21 ) ) ;
}
