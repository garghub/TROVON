...
if ( ! F_16 ( V_38 -> V_88 , V_89 ) ) {
F_7 ( & V_38 -> V_68 , L_12 ) ;
V_75 = - V_90 ;
goto V_87;
}
V_30 = F_17 ( sizeof( struct V_29 ) , V_91 ) ;
if ( V_30 == NULL ) {
V_75 = - V_92 ;
goto V_87;
}
...
V_75 = F_23 ( V_30 -> V_59 . V_68 , & V_101 ) ;
if ( V_75 < 0 ) {
...
static int T_6 F_27 ( struct V_37 * V_38 )
{
struct V_29 * V_30 = F_28 ( V_38 ) ;
F_29 ( V_30 -> V_59 . V_68 , & V_101 ) ;
if ( V_30 -> V_66 )
F_11 ( V_30 -> V_67 ) ;
F_25 ( V_30 -> V_67 ) ;
F_24 ( & V_30 -> V_59 ) ;
