...
static int T_5 F_44 ( struct V_88 * V_89 )
{
struct V_1 * V_2 ;
struct V_90 * V_91 ;
struct V_92 * V_93 ;
...
if ( V_73 < 0 )
goto V_96;
V_91 = (struct V_90 * ) V_89 -> V_31 . V_97 ;
V_2 = F_47 ( sizeof( * V_2 ) , V_98 ) ;
if ( ! V_2 )
return - V_99 ;
if ( ! F_48 ( V_93 -> V_100 , F_49 ( V_93 ) , V_89 -> V_101 ) ) {
F_28 ( & V_89 -> V_31 , L_21 ) ;
V_94 = - V_61 ;
goto V_102;
}
V_2 -> V_5 = F_50 ( V_93 -> V_100 , F_49 ( V_93 ) ) ;
if ( ! V_2 -> V_5 ) {
F_28 ( & V_89 -> V_31 , L_22 ) ;
V_94 = - V_84 ;
goto V_103;
...
V_2 -> V_30 . V_31 . V_105 = V_89 -> V_31 . V_105 ;
F_16 ( V_2 ) ;
F_53 ( & V_2 -> V_75 ) ;
F_54 ( & V_2 -> V_49 ) ;
V_94 = F_55 ( V_73 , F_34 , 0 , V_89 -> V_101 , V_2 ) ;
if ( V_94 ) {
F_28 ( & V_89 -> V_31 , L_23 ) ;
goto V_106;
}
...
if ( V_91 ) {
for ( V_28 = 0 ; V_28 < V_91 -> V_108 ; V_28 ++ )
F_57 ( & V_2 -> V_30 , V_91 -> V_109 + V_28 ) ;
}
F_58 ( & V_2 -> V_30 ) ;
return 0 ;
V_107:
...
static int T_6 F_63 ( struct V_88 * V_89 )
{
