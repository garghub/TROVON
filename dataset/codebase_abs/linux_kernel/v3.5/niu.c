...
V_625 = F_275 ( V_624 , sizeof( struct V_492 ) ,
V_800 ) ;
V_10 = - V_506 ;
if ( ! V_625 )
goto V_811;
...
V_587 = F_275 ( V_622 , sizeof( struct V_563 ) ,
V_800 ) ;
V_10 = - V_506 ;
if ( ! V_587 )
goto V_811;
...
static void F_294 ( struct V_3 * V_4 , T_1 V_827 )
{
unsigned long V_87 ;
T_1 V_2 ;
F_165 ( V_4 , V_87 ) ;
...
static int F_299 ( struct V_3 * V_4 , struct V_563 * V_493 )
{
...
F_18 ( F_303 ( V_36 ) , V_493 -> V_788 >> 32 ) ;
F_18 ( F_304 ( V_36 ) , V_493 -> V_788 & V_834 ) ;
F_18 ( F_242 ( V_36 ) , 0 ) ;
V_493 -> V_593 = 0 ;
return 0 ;
}
...
F_18 ( F_306 ( V_841 , V_842 ) ,
V_839 -> V_844 [ V_842 ] ) ;
}
F_18 ( F_307 ( V_4 -> V_30 ) , V_4 -> V_25 -> V_845 [ V_4 -> V_30 ] ) ;
}
...
static int F_325 ( struct V_492 * V_493 , T_1 * V_860 )
{
T_1 V_2 = 0 ;
* V_860 = 0 ;
switch ( V_493 -> V_515 ) {
...
return V_10 ;
F_323 ( V_4 , V_493 ) ;
F_18 ( F_328 ( V_36 ) , V_886 ) ;
F_18 ( F_228 ( V_36 ) ,
( V_615 |
V_780 |
V_781 |
V_887 ) ) ;
F_18 ( F_313 ( V_36 ) , V_493 -> V_788 >> 32 ) ;
F_18 ( F_329 ( V_36 ) ,
( ( V_493 -> V_788 & V_888 ) |
V_889 ) ) ;
F_18 ( F_330 ( V_36 ) ,
...
( V_937 |
( 0 << V_938 ) |
( F_338 ( V_4 -> V_30 ) << V_939 ) ) ) ;
return F_339 ( V_4 , V_936 , V_940 ,
1000 , 100 ) ;
}
static int F_340 ( struct V_3 * V_4 , int V_375 , T_1 * V_35 )
{
int V_10 ;
V_10 = F_339 ( V_4 , V_936 , V_940 ,
1000 , 100 ) ;
if ( V_10 ) {
F_10 ( V_4 -> V_11 , L_89 ,
...
static void F_362 ( struct V_3 * V_4 , T_1 F_230 , T_1 V_944 )
{
T_1 V_2 ;
F_9 ( V_1040 , F_230 ) ;
F_9 ( V_1041 , V_944 ) ;
...
static void F_381 ( struct V_3 * V_4 , struct V_563 * V_493 )
{
( void ) F_282 ( V_4 , V_493 -> V_623 ) ;
}
...
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ ) {
struct V_12 * V_13 = & V_4 -> V_29 [ V_26 ] ;
V_10 = F_392 ( V_13 -> V_782 , F_258 , V_1118 ,
...
static struct V_1130 * F_416 ( struct V_308 * V_11 ,
struct V_1130 * V_1131 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
if ( F_417 ( V_11 ) ) {
...
int V_26 ;
for ( V_26 = 0 ; V_26 < 16 ; V_26 ++ )
F_9 ( F_370 ( V_26 ) , V_1138 [ V_26 ] ) ;
}
static void F_420 ( struct V_3 * V_4 , T_4 * V_1138 )
{
if ( V_4 -> V_87 & V_366 )
F_418 ( V_4 , V_1138 ) ;
else
...
if ( V_11 -> V_87 & V_1142 )
V_4 -> V_87 |= V_1106 ;
if ( ( V_11 -> V_87 & V_1143 ) || ( ! F_422 ( V_11 ) ) )
V_4 -> V_87 |= V_1105 ;
V_1139 = F_423 ( V_11 ) ;
if ( V_1139 > F_117 ( V_4 ) ) {
V_1139 = 0 ;
...
F_426 (ha, dev) {
T_3 V_1145 = F_427 ( V_1146 , V_1141 -> V_362 ) ;
V_1145 >>= 24 ;
...
static int F_430 ( struct V_308 * V_11 , struct V_1150 * V_1151 , int V_1152 )
{
return - V_1153 ;
}
...
T_1 V_458 = V_485 -> V_375 ;
V_458 = V_458 >> V_514 ;
V_493 -> V_513 [ V_1155 ++ ] = F_187 ( V_458 ) ;
V_485 = V_562 ;
}
}
...
static void F_436 ( struct V_1156 * V_1157 )
{
...
static T_1 F_441 ( struct V_483 * V_484 , struct V_1164 * V_1165 ,
...
switch ( V_484 -> V_560 ) {
case F_443 ( V_1177 ) :
V_1172 = F_444 ( V_484 ) -> V_560 ;
V_1171 = F_444 ( V_484 ) -> V_1171 ;
break;
case F_443 ( V_1178 ) :
V_1172 = F_445 ( V_484 ) -> V_1179 ;
V_1171 = ( 40 >> 2 ) ;
V_428 = 1 ;
break;
default:
...
( ( V_1170 / 2 ) << V_1193 ) |
( V_1171 << V_1194 ) |
( ( V_1168 < 1536 ) ? V_1195 : 0 ) |
( ( V_1167 == V_1174 ) ? V_1196 : 0 ) |
( V_428 ? V_1197 : 0 ) |
V_1169 ) ;
return V_860 ;
}
...
if ( V_484 -> V_490 < V_1204 ) {
unsigned int V_1166 = V_1204 - V_484 -> V_490 ;
if ( F_451 ( V_484 , V_1166 ) )
goto V_217;
F_452 ( V_484 , V_1166 ) ;
}
...
V_341 = (struct V_567 * ) F_457 ( V_484 , V_1199 ) ;
V_490 = V_484 -> V_490 - sizeof( struct V_567 ) ;
V_341 -> V_87 = F_440 ( F_441 ( V_484 , V_1165 , V_1198 , V_490 ) ) ;
V_341 -> V_1207 = 0 ;
V_490 = F_208 ( V_484 ) ;
V_502 = V_4 -> V_304 -> V_1208 ( V_4 -> V_508 , V_484 -> V_35 ,
V_490 , V_575 ) ;
V_798 = V_493 -> V_798 ;
V_493 -> V_566 [ V_798 ] . V_484 = V_484 ;
V_493 -> V_566 [ V_798 ] . V_502 = V_502 ;
V_1202 = V_1209 ;
if ( ++ V_493 -> V_1210 == V_493 -> V_804 ) {
V_493 -> V_1210 = 0 ;
V_1202 |= V_577 ;
V_493 -> V_578 ++ ;
}
...
while ( V_490 > 0 ) {
unsigned int V_1211 = V_490 ;
if ( V_1211 > V_579 )
V_1211 = V_579 ;
F_439 ( V_493 , V_798 , V_502 , V_1211 , V_1202 , V_1200 ) ;
V_1202 = V_1200 = 0 ;
...
for ( V_26 = 0 ; V_26 < F_177 ( V_484 ) -> V_489 ; V_26 ++ ) {
const T_11 * V_1212 = & F_177 ( V_484 ) -> V_580 [ V_26 ] ;
V_490 = F_211 ( V_1212 ) ;
V_502 = V_4 -> V_304 -> V_507 ( V_4 -> V_508 , F_458 ( V_1212 ) ,
V_1212 -> V_1213 , V_490 ,
V_575 ) ;
...
V_493 -> V_799 ^= V_1214 ;
V_493 -> V_798 = V_798 ;
F_18 ( F_283 ( V_493 -> V_623 ) , V_493 -> V_799 | ( V_798 << 3 ) ) ;
if ( F_70 ( F_217 ( V_493 ) <= ( V_1215 + 1 ) ) ) {
F_450 ( V_582 ) ;
...
static int F_459 ( struct V_308 * V_11 , int V_1217 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
int V_10 , V_1218 , V_1219 ;
if ( V_1217 < 68 || V_1217 > V_1220 )
return - V_21 ;
V_1218 = ( V_11 -> V_802 > V_806 ) ;
V_1219 = ( V_1217 > V_806 ) ;
V_11 -> V_802 = V_1217 ;
if ( ! F_417 ( V_11 ) ||
( V_1218 == V_1219 ) )
...
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
struct V_1223 * V_1224 = & V_4 -> V_1224 ;
F_461 ( V_1222 -> V_1225 , V_1226 , sizeof( V_1222 -> V_1225 ) ) ;
F_461 ( V_1222 -> V_1227 , V_1228 , sizeof( V_1222 -> V_1227 ) ) ;
snprintf ( V_1222 -> V_1229 , sizeof( V_1222 -> V_1229 ) , L_124 ,
V_1224 -> V_1230 , V_1224 -> V_1231 ) ;
if ( V_4 -> V_25 -> V_339 != V_343 )
F_461 ( V_1222 -> V_1232 , F_462 ( V_4 -> V_1233 ) ,
sizeof( V_1222 -> V_1232 ) ) ;
}
static int F_463 ( struct V_308 * V_11 , struct V_1234 * V_1152 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
struct V_38 * V_13 ;
V_13 = & V_4 -> V_39 ;
memset ( V_1152 , 0 , sizeof( * V_1152 ) ) ;
V_1152 -> V_1235 = V_4 -> V_175 ;
V_1152 -> V_173 = V_13 -> V_173 ;
V_1152 -> V_174 = V_13 -> V_215 ;
V_1152 -> V_285 = V_13 -> V_201 ;
F_464 ( V_1152 , V_13 -> V_160 ) ;
V_1152 -> V_301 = V_13 -> V_161 ;
V_1152 -> V_30 = ( V_4 -> V_87 & V_344 ) ? V_1236 : V_1237 ;
V_1152 -> V_1238 = ( V_4 -> V_87 & V_345 ) ?
V_1239 : V_1240 ;
return 0 ;
}
static int F_465 ( struct V_308 * V_11 , struct V_1234 * V_1152 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
struct V_38 * V_13 = & V_4 -> V_39 ;
V_13 -> V_174 = V_1152 -> V_174 ;
V_13 -> V_302 = F_466 ( V_1152 ) ;
...
static void F_468 ( struct V_308 * V_11 , T_3 V_1242 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
V_4 -> V_1241 = V_1242 ;
}
...
if ( V_486 >= V_4 -> V_1243 )
return - V_21 ;
if ( V_486 + V_490 > V_4 -> V_1243 )
V_490 = V_1245 -> V_490 = V_4 -> V_1243 - V_486 ;
if ( V_486 & 3 ) {
T_3 V_1246 , V_1247 ;
V_1246 = V_486 & 3 ;
V_1247 = 4 - V_1246 ;
if ( V_1247 > V_490 )
V_1247 = V_490 ;
V_2 = F_16 ( F_472 ( ( V_486 - V_1246 ) / 4 ) ) ;
memcpy ( V_35 , ( ( char * ) & V_2 ) + V_1246 , V_1247 ) ;
V_35 += V_1247 ;
V_490 -= V_1247 ;
V_486 += V_1247 ;
}
...
static void F_473 ( int V_1248 , T_5 * V_1249 )
{
switch ( V_1248 ) {
case V_1250 :
case V_1251 :
...
static int F_474 ( T_1 V_421 , int * V_1248 )
{
switch ( V_421 ) {
case V_1263 :
* V_1248 = V_1250 ;
...
static int F_475 ( int V_1248 , T_1 * V_421 )
{
switch ( V_1248 ) {
case V_1250 :
* V_421 = V_1263 ;
...
if ( V_928 & V_1284 )
V_1275 |= V_1285 ;
if ( V_928 & ( V_1286 << V_1287 ) )
V_1275 |= V_1288 ;
if ( V_928 & ( V_1286 << V_1289 ) )
V_1275 |= V_1290 ;
return V_1275 ;
}
static int F_477 ( T_1 V_1275 , T_1 * V_928 )
{
T_1 V_403 = 0 ;
if ( V_1275 & V_1277 )
V_403 |= V_1276 ;
...
static int F_478 ( struct V_3 * V_4 , struct V_1291 * V_1292 )
{
T_1 V_421 ;
V_1292 -> V_35 = 0 ;
if ( ! F_475 ( V_1292 -> V_1248 , & V_421 ) )
return - V_21 ;
if ( V_4 -> V_25 -> V_927 [ V_421 - V_425 ] &
V_1293 )
V_1292 -> V_35 = V_1294 ;
else
V_1292 -> V_35 = F_476 ( V_4 -> V_25 -> V_928 [ V_421 -
V_425 ] ) ;
return 0 ;
}
static void F_479 ( struct V_908 * V_341 ,
struct V_1295 * V_1296 )
{
T_3 V_584 ;
T_4 V_1297 ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1298 ) >> V_1299 ;
V_1296 -> V_1300 . V_1301 . V_1302 = F_480 ( V_584 ) ;
V_584 = ( V_341 -> V_403 [ 3 ] & V_1303 ) >> V_1304 ;
V_1296 -> V_1300 . V_1301 . V_1305 = F_480 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1298 ) >> V_1299 ;
V_1296 -> V_1306 . V_1301 . V_1302 = F_480 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 3 ] & V_1303 ) >> V_1304 ;
V_1296 -> V_1306 . V_1301 . V_1305 = F_480 ( V_584 ) ;
V_1296 -> V_1300 . V_1301 . V_1307 = ( V_341 -> V_403 [ 2 ] & V_1308 ) >>
V_1309 ;
V_1296 -> V_1306 . V_1301 . V_1307 = ( V_341 -> V_911 [ 2 ] & V_1308 ) >>
V_1309 ;
switch ( V_1296 -> V_1248 ) {
case V_1250 :
case V_1252 :
case V_1254 :
V_1297 = ( ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ) >> 16 ;
V_1296 -> V_1300 . V_1301 . V_1312 = F_443 ( V_1297 ) ;
V_1297 = ( ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ) & 0xffff ;
V_1296 -> V_1300 . V_1301 . V_1313 = F_443 ( V_1297 ) ;
V_1297 = ( ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ) >> 16 ;
V_1296 -> V_1306 . V_1301 . V_1312 = F_443 ( V_1297 ) ;
V_1297 = ( ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ) & 0xffff ;
V_1296 -> V_1306 . V_1301 . V_1313 = F_443 ( V_1297 ) ;
break;
case V_1257 :
case V_1260 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1300 . V_1314 . V_1315 = F_480 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1306 . V_1314 . V_1315 = F_480 ( V_584 ) ;
break;
case V_1272 :
V_584 = ( V_341 -> V_403 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1300 . V_1316 . V_1317 = F_480 ( V_584 ) ;
V_584 = ( V_341 -> V_911 [ 2 ] & V_1310 ) >>
V_1311 ;
V_1296 -> V_1306 . V_1316 . V_1317 = F_480 ( V_584 ) ;
V_1296 -> V_1300 . V_1316 . V_1318 =
( V_341 -> V_403 [ 2 ] & V_1319 ) >>
V_1320 ;
V_1296 -> V_1306 . V_1316 . V_1318 =
( V_341 -> V_911 [ 2 ] & V_1319 ) >>
V_1320 ;
V_1296 -> V_1300 . V_1316 . V_1321 = V_1322 ;
break;
default:
break;
}
...
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
struct V_1295 * V_1296 = & V_1292 -> V_1323 ;
T_4 V_386 ;
T_1 V_421 ;
int V_860 = 0 ;
V_386 = F_172 ( V_4 , ( T_4 ) V_1292 -> V_1323 . V_1324 ) ;
V_341 = & V_25 -> V_909 [ V_386 ] ;
if ( ! V_341 -> V_914 ) {
F_482 ( V_4 -> V_11 , L_125 ,
V_25 -> V_375 , ( T_4 ) V_1292 -> V_1323 . V_1324 , V_386 ) ;
return - V_21 ;
}
V_421 = ( V_341 -> V_403 [ 0 ] & V_1325 ) >>
V_1326 ;
V_860 = F_474 ( V_421 , & V_1296 -> V_1248 ) ;
if ( V_860 < 0 ) {
...
if ( V_1296 -> V_1248 == V_1257 || V_1296 -> V_1248 == V_1258 ) {
T_3 V_1318 = ( V_341 -> V_403 [ 2 ] & V_1319 ) >>
V_1320 ;
if ( V_1318 == V_1262 ) {
if ( V_1296 -> V_1248 == V_1257 )
V_1296 -> V_1248 = V_1260 ;
else
V_1296 -> V_1248 = V_1261 ;
}
}
switch ( V_1296 -> V_1248 ) {
case V_1250 :
...
if ( V_860 < 0 )
goto V_217;
if ( V_341 -> V_410 & V_1327 )
V_1296 -> V_1328 = V_1329 ;
else
V_1296 -> V_1328 = ( V_341 -> V_410 & V_1330 ) >>
V_913 ;
V_1292 -> V_35 = F_173 ( V_4 ) ;
V_217:
return V_860 ;
}
...
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
int V_26 , V_386 , V_1332 ;
unsigned long V_87 ;
int V_860 = 0 ;
V_1292 -> V_35 = F_173 ( V_4 ) ;
F_165 ( V_4 , V_87 ) ;
for ( V_1332 = 0 , V_26 = 0 ; V_26 < V_1292 -> V_35 ; V_26 ++ ) {
V_386 = F_172 ( V_4 , V_26 ) ;
V_341 = & V_25 -> V_909 [ V_386 ] ;
if ( ! V_341 -> V_914 )
continue;
if ( V_1332 == V_1292 -> V_1333 ) {
V_860 = - V_1334 ;
break;
}
V_1331 [ V_1332 ] = V_26 ;
...
F_167 ( V_4 , V_87 ) ;
V_1292 -> V_1333 = V_1332 ;
return V_860 ;
}
static int F_484 ( struct V_308 * V_11 , struct V_1291 * V_1152 ,
T_3 * V_1331 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
int V_860 = 0 ;
...
case V_1335 :
V_860 = F_478 ( V_4 , V_1152 ) ;
break;
case V_1336 :
V_1152 -> V_35 = V_4 -> V_624 ;
break;
case V_1337 :
V_1152 -> V_1333 = F_174 ( V_4 ) ;
break;
case V_1338 :
V_860 = F_481 ( V_4 , V_1152 ) ;
break;
case V_1339 :
V_860 = F_483 ( V_4 , V_1152 , V_1331 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static int F_485 ( struct V_3 * V_4 , struct V_1291 * V_1292 )
{
T_1 V_421 ;
T_1 V_928 = 0 ;
unsigned long V_87 ;
...
static void F_486 ( struct V_1295 * V_1296 ,
struct V_908 * V_341 ,
int V_1340 , T_1 V_421 )
{
T_5 V_1249 = 0 ;
T_3 V_1341 , V_1342 , V_1343 , V_1344 , V_1315 , V_1345 ;
T_4 V_1346 , V_1347 , V_1348 , V_1349 ;
V_1341 = F_487 ( V_1296 -> V_1300 . V_1301 . V_1302 ) ;
V_1343 = F_487 ( V_1296 -> V_1306 . V_1301 . V_1302 ) ;
V_1342 = F_487 ( V_1296 -> V_1300 . V_1301 . V_1305 ) ;
V_1344 = F_487 ( V_1296 -> V_1306 . V_1301 . V_1305 ) ;
V_341 -> V_403 [ 0 ] = V_421 << V_1326 ;
V_341 -> V_911 [ 0 ] = V_1325 ;
V_341 -> V_403 [ 1 ] = ( T_1 ) V_1340 << V_1350 ;
V_341 -> V_911 [ 1 ] = V_1351 ;
V_341 -> V_403 [ 3 ] = ( T_1 ) V_1341 << V_1299 ;
V_341 -> V_403 [ 3 ] |= V_1342 ;
V_341 -> V_911 [ 3 ] = ( T_1 ) V_1343 << V_1299 ;
V_341 -> V_911 [ 3 ] |= V_1344 ;
V_341 -> V_403 [ 2 ] |= ( ( T_1 ) V_1296 -> V_1300 . V_1301 . V_1307 <<
V_1309 ) ;
V_341 -> V_911 [ 2 ] |= ( ( T_1 ) V_1296 -> V_1306 . V_1301 . V_1307 <<
V_1309 ) ;
switch ( V_1296 -> V_1248 ) {
case V_1250 :
case V_1252 :
case V_1254 :
V_1346 = F_442 ( V_1296 -> V_1300 . V_1301 . V_1312 ) ;
V_1348 = F_442 ( V_1296 -> V_1306 . V_1301 . V_1312 ) ;
V_1347 = F_442 ( V_1296 -> V_1300 . V_1301 . V_1313 ) ;
V_1349 = F_442 ( V_1296 -> V_1306 . V_1301 . V_1313 ) ;
V_341 -> V_403 [ 2 ] |= ( ( ( T_1 ) V_1346 << 16 ) | V_1347 ) ;
V_341 -> V_911 [ 2 ] |= ( ( ( T_1 ) V_1348 << 16 ) | V_1349 ) ;
F_473 ( V_1296 -> V_1248 , & V_1249 ) ;
break;
case V_1257 :
case V_1260 :
V_1315 = F_487 ( V_1296 -> V_1300 . V_1314 . V_1315 ) ;
V_1345 = F_487 ( V_1296 -> V_1306 . V_1314 . V_1315 ) ;
V_341 -> V_403 [ 2 ] |= V_1315 ;
V_341 -> V_911 [ 2 ] |= V_1345 ;
F_473 ( V_1296 -> V_1248 , & V_1249 ) ;
break;
case V_1272 :
V_1315 = F_487 ( V_1296 -> V_1300 . V_1316 . V_1317 ) ;
V_1345 = F_487 ( V_1296 -> V_1306 . V_1316 . V_1317 ) ;
V_341 -> V_403 [ 2 ] |= V_1315 ;
V_341 -> V_911 [ 2 ] |= V_1345 ;
V_1249 = V_1296 -> V_1300 . V_1316 . V_1318 ;
break;
default:
break;
}
V_341 -> V_403 [ 2 ] |= ( ( T_1 ) V_1249 << V_1320 ) ;
if ( V_1249 ) {
V_341 -> V_911 [ 2 ] |= V_1319 ;
}
}
...
int V_1352 = V_393 -> V_837 ;
T_4 V_386 ;
T_1 V_421 ;
unsigned long V_87 ;
int V_10 , V_860 ;
V_860 = 0 ;
V_386 = V_1292 -> V_1323 . V_1324 ;
if ( V_386 >= F_173 ( V_4 ) )
return - V_21 ;
if ( V_1296 -> V_1248 == V_1272 ) {
int V_26 ;
int V_1353 = 0 ;
struct V_1354 * V_1355 = & V_1296 -> V_1300 . V_1316 ;
struct V_1354 * V_1356 = & V_1296 -> V_1306 . V_1316 ;
if ( V_1355 -> V_1321 != V_1322 )
return - V_21 ;
F_165 ( V_4 , V_87 ) ;
for ( V_26 = 0 ; V_26 < V_1357 ; V_26 ++ ) {
if ( V_25 -> V_1358 [ V_26 ] ) {
if ( V_1355 -> V_1318 == V_25 -> V_1359 [ V_26 ] ) {
V_421 = V_25 -> V_1358 [ V_26 ] ;
V_25 -> V_1360 [ V_26 ] ++ ;
V_1353 = 1 ;
break;
}
...
if ( V_860 )
goto V_217;
V_25 -> V_1358 [ V_26 ] = V_421 ;
V_25 -> V_1359 [ V_26 ] = V_1355 -> V_1318 ;
V_25 -> V_1360 [ V_26 ] ++ ;
V_1353 = 1 ;
break;
}
...
V_25 -> V_375 , V_67 , V_1355 -> V_1318 ) ;
V_860 = - V_21 ;
goto V_217;
}
F_167 ( V_4 , V_87 ) ;
} else {
if ( ! F_475 ( V_1296 -> V_1248 , & V_421 ) ) {
return - V_21 ;
}
}
F_165 ( V_4 , V_87 ) ;
...
case V_1257 :
case V_1260 :
F_486 ( V_1296 , V_341 , V_1352 , V_421 ) ;
break;
case V_1251 :
case V_1253 :
case V_1255 :
...
if ( V_1296 -> V_1328 == V_1329 ) {
V_341 -> V_410 = V_1327 ;
} else {
if ( V_1296 -> V_1328 >= V_4 -> V_624 ) {
F_482 ( V_4 -> V_11 , L_130 ,
V_25 -> V_375 , V_67 ,
( long long ) V_1296 -> V_1328 ) ;
V_860 = - V_21 ;
goto V_217;
}
V_341 -> V_410 = ( V_912 |
...
static int F_489 ( struct V_3 * V_4 , T_3 V_1361 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_908 * V_341 ;
T_4 V_386 ;
...
static int F_490 ( struct V_308 * V_11 , struct V_1291 * V_1152 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
int V_860 = 0 ;
switch ( V_1152 -> V_1152 ) {
case V_1362 :
V_860 = F_485 ( V_4 , V_1152 ) ;
break;
case V_1363 :
V_860 = F_488 ( V_4 , V_1152 ) ;
break;
case V_1364 :
V_860 = F_489 ( V_4 , V_1152 -> V_1323 . V_1324 ) ;
break;
default:
V_860 = - V_21 ;
break;
...
static void F_491 ( struct V_308 * V_11 , T_3 V_1365 , T_5 * V_35 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
int V_26 ;
if ( V_1365 != V_1366 )
...
static int F_492 ( struct V_308 * V_11 , int V_1365 )
{
struct V_3 * V_4 = F_400 ( V_11 ) ;
if ( V_1365 != V_1366 )
return - V_21 ;
...
static int F_500 ( struct V_3 * V_4 , int V_1386 )
{
if ( V_1386 < 0 || V_1386 > V_1387 )
return - V_21 ;
F_18 ( V_1388 , V_1386 ) ;
return 0 ;
}
static int F_501 ( struct V_3 * V_4 , int V_29 , int V_1389 , int V_1390 )
{
if ( ( V_29 < V_1384 || V_29 > V_1385 ) ||
( V_1389 < 0 || V_1389 > 3 ) ||
( V_1390 < 0 || V_1390 > 0x1f ) )
return - V_21 ;
F_18 ( F_502 ( V_29 ) , ( V_1389 << V_1391 ) | V_1390 ) ;
return 0 ;
}
static int T_12 F_503 ( struct V_3 * V_4 , T_3 V_362 )
{
T_1 V_1392 , V_1393 = ( V_1394 |
( V_362 << V_1395 ) ) ;
int V_6 ;
if ( V_362 > ( V_1396 >> V_1395 ) )
return - V_21 ;
V_1392 = V_1393 ;
F_18 ( V_1397 , V_1392 ) ;
V_6 = 64 ;
...
V_1392 = F_16 ( V_1397 ) ;
return ( V_1392 & V_1399 ) >> V_1400 ;
}
static int T_12 F_504 ( struct V_3 * V_4 , T_3 V_335 )
{
...
static int T_12 F_505 ( struct V_3 * V_4 , T_3 V_335 )
{
int V_10 = F_503 ( V_4 , V_335 ) ;
T_4 V_2 ;
if ( V_10 < 0 )
...
static int T_12 F_506 ( struct V_3 * V_4 ,
T_3 V_335 ,
char * V_1401 ,
int V_1402 )
{
int V_26 ;
for ( V_26 = 0 ; V_26 < V_1402 ; V_26 ++ ) {
...
static void T_12 F_507 ( struct V_3 * V_4 )
{
struct V_1223 * V_1224 = & V_4 -> V_1224 ;
int V_490 = strlen ( V_1224 -> V_1227 ) + 1 ;
const char * V_1403 = V_1224 -> V_1227 ;
int V_26 ;
for ( V_26 = 0 ; V_26 < V_490 - 5 ; V_26 ++ ) {
if ( ! strncmp ( V_1403 + V_26 , L_134 , 6 ) )
break;
}
if ( V_26 >= V_490 - 5 )
return;
V_1403 += V_26 + 5 ;
sscanf ( V_1403 , L_124 , & V_1224 -> V_1230 , & V_1224 -> V_1231 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_135 ,
V_1224 -> V_1230 , V_1224 -> V_1231 ) ;
if ( V_1224 -> V_1230 > V_1404 ||
( V_1224 -> V_1230 == V_1404 &&
V_1224 -> V_1231 >= V_1405 ) )
V_4 -> V_87 |= V_1406 ;
}
static int T_12 F_508 ( struct V_3 * V_4 ,
T_3 V_1182 , T_3 V_1407 )
{
unsigned int V_1408 = 0 ;
...
V_490 = V_10 ;
V_1182 += 3 ;
V_1409 = F_503 ( V_4 , V_1182 + 4 ) ;
V_10 = F_506 ( V_4 , V_1182 + 5 , V_1401 , 64 ) ;
if ( V_10 < 0 )
return V_10 ;
V_1410 = NULL ;
V_1411 = 0 ;
if ( ! strcmp ( V_1401 , L_137 ) ) {
V_1410 = V_4 -> V_1224 . V_1412 ;
V_1411 = V_1413 ;
V_1408 |= F_509 ;
} else if ( ! strcmp ( V_1401 , L_138 ) ) {
V_1410 = V_4 -> V_1224 . V_1414 ;
V_1411 = V_1415 ;
V_1408 |= F_510 ;
} else if ( ! strcmp ( V_1401 , L_139 ) ) {
V_1410 = V_4 -> V_1224 . V_1227 ;
V_1411 = V_1416 ;
V_1408 |= F_511 ;
} else if ( ! strcmp ( V_1401 , L_140 ) ) {
V_1410 = V_4 -> V_1224 . V_1417 ;
V_1411 = V_1146 ;
V_1408 |= F_512 ;
} else if ( ! strcmp ( V_1401 , L_141 ) ) {
V_1410 = & V_4 -> V_1224 . V_1418 ;
V_1411 = 1 ;
V_1408 |= F_513 ;
} else if ( ! strcmp ( V_1401 , L_142 ) ) {
V_1410 = V_4 -> V_1224 . V_1419 ;
V_1411 = V_1420 ;
V_1408 |= F_514 ;
}
if ( V_1411 && V_1409 > V_1411 ) {
F_225 ( V_4 -> V_508 , L_143 , V_1401 , V_1409 ) ;
return - V_21 ;
}
if ( V_1410 ) {
...
L_144 ,
V_1401 , V_1409 ) ;
for ( V_26 = 0 ; V_26 < V_1409 ; V_26 ++ )
* V_1410 ++ = F_503 ( V_4 , V_335 + V_26 ) ;
}
V_1182 += V_490 ;
}
return 0 ;
}
static void T_12 F_516 ( struct V_3 * V_4 , T_3 V_1182 )
{
T_3 V_486 ;
int V_10 ;
V_10 = F_505 ( V_4 , V_1182 + 1 ) ;
if ( V_10 < 0 )
return;
V_486 = V_10 + 3 ;
while ( V_1182 + V_486 < V_1421 ) {
T_3 V_1422 = V_1182 + V_486 ;
T_3 V_1407 ;
V_10 = F_503 ( V_4 , V_1422 ) ;
if ( V_10 != 0x90 )
return;
V_10 = F_505 ( V_4 , V_1422 + 1 ) ;
if ( V_10 < 0 )
return;
V_1422 = V_1182 + V_486 + 3 ;
V_1407 = V_1182 + V_486 + V_10 ;
V_486 += V_10 ;
V_10 = F_508 ( V_4 , V_1422 , V_1407 ) ;
if ( V_10 < 0 || V_10 == 1 )
return;
}
}
static T_3 T_12 F_517 ( struct V_3 * V_4 )
{
T_3 V_1182 = 0 , V_1407 = V_1421 , V_860 ;
int V_10 ;
while ( V_1182 < V_1407 ) {
V_860 = V_1182 ;
V_10 = F_504 ( V_4 , V_1182 + 0 ) ;
if ( V_10 != 0x55aa )
return 0 ;
V_10 = F_504 ( V_4 , V_1182 + 23 ) ;
if ( V_10 < 0 )
return 0 ;
V_1182 += V_10 ;
V_10 = F_504 ( V_4 , V_1182 + 0 ) ;
if ( V_10 != 0x5043 )
return 0 ;
V_10 = F_504 ( V_4 , V_1182 + 2 ) ;
if ( V_10 != 0x4952 )
return 0 ;
V_10 = F_503 ( V_4 , V_1182 + 20 ) ;
if ( V_10 < 0 )
return 0 ;
if ( V_10 != 0x01 ) {
V_10 = F_503 ( V_4 , V_860 + 2 ) ;
if ( V_10 < 0 )
return 0 ;
V_1182 = V_860 + ( V_10 * 512 ) ;
continue;
}
V_10 = F_505 ( V_4 , V_1182 + 8 ) ;
if ( V_10 < 0 )
return V_10 ;
V_860 += V_10 ;
V_10 = F_503 ( V_4 , V_860 + 0 ) ;
if ( V_10 != 0x82 )
return 0 ;
return V_860 ;
}
...
const char * V_1423 )
{
if ( ! strcmp ( V_1423 , L_145 ) ) {
V_4 -> V_87 &= ~ ( V_344 |
V_88 ) ;
V_4 -> V_89 = V_1424 ;
} else if ( ! strcmp ( V_1423 , L_146 ) ) {
V_4 -> V_87 |= ( V_88 |
V_344 ) ;
V_4 -> V_89 = V_1425 ;
} else if ( ! strcmp ( V_1423 , L_147 ) ) {
V_4 -> V_87 &= ~ V_88 ;
V_4 -> V_87 |= V_344 ;
V_4 -> V_89 = V_90 ;
} else if ( ! strcmp ( V_1423 , L_148 ) ) {
V_4 -> V_87 |= V_88 ;
V_4 -> V_87 &= ~ V_344 ;
V_4 -> V_89 = V_1425 ;
} else if ( ! strcmp ( V_1423 , L_149 ) || ! strcmp ( V_1423 , L_150 ) ) {
V_4 -> V_87 |= V_88 ;
V_4 -> V_87 &= ~ V_344 ;
V_4 -> V_87 |= V_345 ;
V_4 -> V_89 = V_1425 ;
...
{
int V_1426 = 0 ;
if ( ( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1427 ) ) ||
( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1428 ) ) ||
( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1429 ) ) ||
( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1430 ) ) ||
( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1431 ) ) ) {
V_1426 = 4 ;
} else if ( ( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1432 ) ) ||
( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1433 ) ) ||
( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1434 ) ) ||
( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1435 ) ) ) {
V_1426 = 2 ;
}
return V_1426 ;
}
static void T_12 F_520 ( struct V_3 * V_4 )
{
struct V_308 * V_11 = V_4 -> V_11 ;
struct V_1223 * V_1224 = & V_4 -> V_1224 ;
T_5 V_1436 ;
if ( ! F_429 ( & V_1224 -> V_1417 [ 0 ] ) ) {
F_225 ( V_4 -> V_508 , L_151 ) ;
V_4 -> V_87 &= ~ V_1406 ;
return;
}
if ( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1431 ) ||
! strcmp ( V_4 -> V_1224 . V_1412 , V_1430 ) ) {
V_4 -> V_87 |= V_88 ;
V_4 -> V_87 &= ~ V_344 ;
V_4 -> V_87 |= V_345 ;
...
if ( V_4 -> V_87 & V_88 )
V_4 -> V_89 = V_1425 ;
} else if ( ! strcmp ( V_4 -> V_1224 . V_1412 , V_1434 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
} else if ( F_518 ( V_4 , V_4 -> V_1224 . V_1419 ) ) {
...
memcpy ( V_11 -> V_1437 , V_1224 -> V_1417 , V_1146 ) ;
V_1436 = V_11 -> V_1437 [ 5 ] ;
V_11 -> V_1437 [ 5 ] += V_4 -> V_30 ;
if ( V_11 -> V_1437 [ 5 ] < V_1436 )
V_11 -> V_1437 [ 4 ] ++ ;
memcpy ( V_11 -> V_1104 , V_11 -> V_1437 , V_11 -> V_1438 ) ;
}
static int T_12 F_521 ( struct V_3 * V_4 )
{
struct V_308 * V_11 = V_4 -> V_11 ;
int V_490 , V_26 ;
T_1 V_2 , V_1439 ;
...
if ( ( V_1439 & 0xff ) != 0xab ) {
F_225 ( V_4 -> V_508 , L_156 , ( int ) ( V_1439 & 0xff ) ) ;
return - V_21 ;
}
V_2 = F_16 ( V_1443 ) ;
switch ( V_4 -> V_30 ) {
...
break;
default:
F_225 ( V_4 -> V_508 , L_159 , V_1436 ) ;
return - V_21 ;
}
V_2 = F_16 ( V_1456 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_160 , ( unsigned long long ) V_2 ) ;
V_11 -> V_1437 [ 0 ] = ( V_2 >> 0 ) & 0xff ;
V_11 -> V_1437 [ 1 ] = ( V_2 >> 8 ) & 0xff ;
V_11 -> V_1437 [ 2 ] = ( V_2 >> 16 ) & 0xff ;
V_11 -> V_1437 [ 3 ] = ( V_2 >> 24 ) & 0xff ;
V_2 = F_16 ( V_1457 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_161 , ( unsigned long long ) V_2 ) ;
V_11 -> V_1437 [ 4 ] = ( V_2 >> 0 ) & 0xff ;
V_11 -> V_1437 [ 5 ] = ( V_2 >> 8 ) & 0xff ;
if ( ! F_429 ( & V_11 -> V_1437 [ 0 ] ) ) {
...
T_1 V_584 = F_16 ( F_472 ( 5 + ( V_26 / 4 ) ) ) ;
V_4 -> V_1224 . V_1412 [ V_26 + 3 ] = ( V_584 >> 0 ) & 0xff ;
V_4 -> V_1224 . V_1412 [ V_26 + 2 ] = ( V_584 >> 8 ) & 0xff ;
V_4 -> V_1224 . V_1412 [ V_26 + 1 ] = ( V_584 >> 16 ) & 0xff ;
V_4 -> V_1224 . V_1412 [ V_26 + 0 ] = ( V_584 >> 24 ) & 0xff ;
}
V_4 -> V_1224 . V_1412 [ V_2 ] = '\0' ;
V_2 = F_16 ( V_1459 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
...
return - V_21 ;
for ( V_26 = 0 ; V_26 < V_2 ; V_26 += 4 ) {
T_1 V_584 = F_16 ( F_472 ( 14 + ( V_26 / 4 ) ) ) ;
V_4 -> V_1224 . V_1414 [ V_26 + 3 ] = ( V_584 >> 0 ) & 0xff ;
V_4 -> V_1224 . V_1414 [ V_26 + 2 ] = ( V_584 >> 8 ) & 0xff ;
V_4 -> V_1224 . V_1414 [ V_26 + 1 ] = ( V_584 >> 16 ) & 0xff ;
V_4 -> V_1224 . V_1414 [ V_26 + 0 ] = ( V_584 >> 24 ) & 0xff ;
}
V_4 -> V_1224 . V_1414 [ V_2 ] = '\0' ;
V_4 -> V_1224 . V_1418 =
F_16 ( V_1460 ) & V_1461 ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_165 , V_4 -> V_1224 . V_1418 ) ;
return 0 ;
}
static int T_12 F_522 ( struct V_3 * V_4 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
if ( V_4 -> V_30 <= 1 )
V_4 -> V_87 |= V_366 ;
...
static int T_12 F_523 ( struct V_24 * V_25 ,
struct V_276 * V_498 ,
int V_1462 , int V_1463 , T_5 V_1464 ,
int type )
{
...
static int T_12 F_525 ( struct V_276 * V_498 , int V_30 )
{
int V_26 ;
...
static int T_12 F_526 ( struct V_276 * V_498 , int * V_1472 )
{
int V_30 , V_1332 ;
V_1332 = 0 ;
* V_1472 = 32 ;
...
static int T_12 F_527 ( struct V_276 * V_498 , int * V_1472 )
{
* V_1472 = 32 ;
...
static void T_12 F_529 ( struct V_24 * V_25 ,
...
static void T_12 F_531 ( struct V_24 * V_25 ,
int V_1474 , int V_1475 )
{
...
V_1491 -> V_844 [ V_842 ] =
V_1486 + V_1490 ;
F_238 ( L_176 , V_1491 -> V_844 [ V_842 ] ) ;
if ( ++ V_1490 == V_1489 )
V_1490 = 0 ;
}
F_238 ( L_177 ) ;
...
V_1492 , V_1494 ) ;
V_10 = F_523 ( V_25 , V_1222 , V_1462 , V_1463 , V_30 ,
V_1466 ) ;
if ( V_10 )
break;
V_1462 = F_29 ( V_4 , V_30 ,
...
static int T_12 F_533 ( struct V_3 * V_4 , struct V_24 * V_25 )
{
struct V_276 * V_1222 = & V_25 -> V_276 ;
int V_1496 , V_1497 ;
int V_1474 , V_1475 ;
T_3 V_2 ;
int V_10 ;
...
V_10 = F_532 ( V_4 , V_25 , V_1222 ) ;
if ( V_10 )
return V_10 ;
V_1474 = F_526 ( V_1222 , & V_1496 ) ;
V_1475 = F_527 ( V_1222 , & V_1497 ) ;
...
static int T_12 F_535 ( struct V_3 * V_4 )
{
struct V_906 * V_907 = & V_4 -> V_478 ;
...
static void T_12 F_536 ( struct V_3 * V_4 )
{
struct V_38 * V_13 = & V_4 -> V_39 ;
V_13 -> V_174 = ( V_288 |
V_290 |
...
static void T_12 F_538 ( struct V_3 * V_4 , T_5 * V_1512 )
{
struct V_1513 V_1514 [ V_1515 ] ;
struct V_24 * V_25 = V_4 -> V_25 ;
struct V_1516 * V_1233 = V_4 -> V_1233 ;
...
V_25 -> V_810 [ V_4 -> V_30 ] +
( V_4 -> V_30 == 0 ? 3 : 1 ) ) ;
F_189 ( V_1517 > ( V_1515 / V_25 -> V_481 ) ) ;
V_1519:
for ( V_26 = 0 ; V_26 < V_1517 ; V_26 ++ ) {
V_1514 [ V_26 ] . V_1390 = 0 ;
V_1514 [ V_26 ] . V_1520 = V_26 ;
}
V_10 = F_539 ( V_1233 , V_1514 , V_1517 ) ;
if ( V_10 < 0 ) {
V_4 -> V_87 &= ~ V_1521 ;
return;
}
...
V_4 -> V_87 |= V_1521 ;
for ( V_26 = 0 ; V_26 < V_1517 ; V_26 ++ )
V_4 -> V_29 [ V_26 ] . V_782 = V_1514 [ V_26 ] . V_1390 ;
V_4 -> V_28 = V_1517 ;
}
static int T_12 F_540 ( struct V_3 * V_4 , T_5 * V_1512 )
{
#ifdef F_541
...
static int T_12 F_543 ( struct V_3 * V_4 )
{
struct V_24 * V_25 = V_4 -> V_25 ;
T_5 V_1512 [ V_1515 ] ;
int V_1528 , V_1529 ;
...
for ( V_26 = 0 ; V_26 < V_4 -> V_28 ; V_26 ++ ) {
struct V_12 * V_13 = & V_4 -> V_29 [ V_26 ] ;
F_544 ( V_4 -> V_11 , & V_13 -> V_535 , F_234 , 64 ) ;
V_13 -> V_4 = V_4 ;
...
static void T_13 F_546 ( struct V_3 * V_4 )
{
if ( V_4 -> V_87 & V_1521 )
F_547 ( V_4 -> V_1233 ) ;
}
...
V_1533 = F_549 ( V_4 -> V_1233 ) ;
V_1419 = F_542 ( V_1533 , L_142 , & V_1409 ) ;
if ( ! V_1419 ) {
F_10 ( V_11 , L_182 ,
V_1533 -> V_1535 ) ;
return - V_21 ;
}
if ( ! strcmp ( V_1419 , L_183 ) )
return - V_8 ;
strcpy ( V_4 -> V_1224 . V_1419 , V_1419 ) ;
if ( F_518 ( V_4 , V_4 -> V_1224 . V_1419 ) ) {
F_10 ( V_11 , L_184 ,
V_1533 -> V_1535 , V_4 -> V_1224 . V_1419 ) ;
return - V_21 ;
}
V_1534 = F_542 ( V_1533 , L_140 , & V_1409 ) ;
if ( ! V_1534 ) {
F_10 ( V_11 , L_185 ,
V_1533 -> V_1535 ) ;
return - V_21 ;
}
if ( V_1409 != V_11 -> V_1438 ) {
F_10 ( V_11 , L_186 ,
V_1533 -> V_1535 , V_1409 ) ;
}
memcpy ( V_11 -> V_1437 , V_1534 , V_11 -> V_1438 ) ;
if ( ! F_429 ( & V_11 -> V_1437 [ 0 ] ) ) {
F_10 ( V_11 , L_187 ,
V_1533 -> V_1535 ) ;
F_10 ( V_11 , L_188 , V_1533 -> V_1535 , V_11 -> V_1437 ) ;
return - V_21 ;
}
memcpy ( V_11 -> V_1104 , V_11 -> V_1437 , V_11 -> V_1438 ) ;
V_1412 = F_542 ( V_1533 , L_137 , & V_1409 ) ;
if ( V_1412 )
strcpy ( V_4 -> V_1224 . V_1412 , V_1412 ) ;
if ( F_550 ( V_1533 , L_189 , & V_1409 ) ) {
V_4 -> V_87 |= ( V_88 | V_344 |
V_134 ) ;
}
return 0 ;
...
static int T_12 F_551 ( struct V_3 * V_4 )
{
int V_10 , V_1536 ;
T_3 V_486 ;
V_10 = F_548 ( V_4 ) ;
...
{
struct V_1522 * V_1542 = F_553 ( V_11 ) ;
...
static T_14 F_556 ( struct V_508 * V_11 ,
struct V_1539 * V_1540 , char * V_1541 )
{
return F_555 ( V_11 , V_1540 , V_1541 , 1 ) ;
}
static T_14 F_557 ( struct V_508 * V_11 ,
struct V_1539 * V_1540 , char * V_1541 )
{
return F_555 ( V_11 , V_1540 , V_1541 , 1 ) ;
}
static T_14 F_558 ( struct V_508 * V_11 ,
struct V_1539 * V_1540 , char * V_1541 )
{
struct V_1522 * V_1542 = F_553 ( V_11 ) ;
struct V_24 * V_498 = V_1542 -> V_11 . V_1543 ;
...
static struct V_24 * T_12 F_559 ( struct V_3 * V_4 ,
union V_1549 * V_1465 ,
T_5 V_543 )
{
...
struct V_24 * V_498 ;
int V_26 ;
V_1542 = F_560 ( L_205 , V_1550 ,
NULL , 0 ) ;
if ( F_561 ( V_1542 ) )
return NULL ;
for ( V_26 = 0 ; F_562 ( V_1551 [ V_26 ] ) ; V_26 ++ ) {
int V_10 = F_563 ( & V_1542 -> V_11 ,
& V_1551 [ V_26 ] ) ;
if ( V_10 )
goto V_1552;
}
V_498 = F_270 ( sizeof( * V_498 ) , V_800 ) ;
if ( ! V_498 )
goto V_1552;
V_498 -> V_375 = V_1550 ++ ;
...
static struct V_24 * T_12 F_569 ( struct V_3 * V_4 ,
union V_1549 * V_1465 ,
T_5 V_543 )
{
...
if ( ! memcmp ( V_1465 , & V_584 -> V_1465 , sizeof( * V_1465 ) ) ) {
V_498 = V_584 ;
break;
}
}
if ( ! V_498 )
V_498 = F_559 ( V_4 , V_1465 , V_543 ) ;
if ( V_498 ) {
char V_1561 [ 6 ] ;
int V_10 ;
...
T_5 V_30 = V_4 -> V_30 ;
char V_1561 [ 6 ] ;
F_189 ( ! V_498 || V_498 -> V_1426 [ V_30 ] != V_4 ) ;
F_166 ( V_4 , V_472 , V_473 , V_4 -> V_11 ,
L_207 , V_67 , V_30 ) ;
sprintf ( V_1561 , L_206 , V_30 ) ;
F_570 ( & V_1560 ) ;
F_576 ( & V_498 -> V_1542 -> V_11 . V_1562 , V_1561 ) ;
V_498 -> V_1426 [ V_30 ] = NULL ;
V_4 -> V_25 = NULL ;
...
static void * F_579 ( struct V_508 * V_11 , T_15 V_487 ,
...
static void F_581 ( struct V_508 * V_11 , T_15 V_487 ,
...
static void T_12 F_591 ( void )
{
static int V_1570 ;
if ( V_1570 ++ == 0 )
F_48 ( L_193 , V_1227 ) ;
}
static struct V_308 * T_12 F_592 (
struct V_508 * V_1571 , struct V_1516 * V_1233 ,
struct V_1522 * V_1523 , const struct V_1572 * V_304 ,
T_5 V_30 )
{
struct V_308 * V_11 ;
struct V_3 * V_4 ;
V_11 = F_593 ( sizeof( struct V_3 ) , V_1483 ) ;
if ( ! V_11 )
return NULL ;
F_594 ( V_11 , V_1571 ) ;
V_4 = F_400 ( V_11 ) ;
...
static void T_12 F_596 ( struct V_308 * V_11 )
{
V_11 -> V_1574 = & V_1575 ;
V_11 -> V_1576 = & V_1577 ;
V_11 -> V_1578 = V_1579 ;
}
static void T_12 F_597 ( struct V_3 * V_4 )
{
struct V_308 * V_11 = V_4 -> V_11 ;
...
static void T_12 F_598 ( struct V_308 * V_11 )
{
V_11 -> V_1580 = V_1581 | V_1582 | V_553 ;
V_11 -> V_552 |= V_11 -> V_1580 | V_1583 ;
}
static int T_12 F_599 ( struct V_1516 * V_1233 ,
...
V_10 = F_600 ( V_1233 ) ;
if ( V_10 ) {
F_225 ( & V_1233 -> V_11 , L_217 ) ;
return V_10 ;
}
if ( ! ( F_601 ( V_1233 , 0 ) & V_1589 ) ||
! ( F_601 ( V_1233 , 2 ) & V_1589 ) ) {
F_225 ( & V_1233 -> V_11 , L_218 ) ;
V_10 = - V_8 ;
goto V_1590;
}
V_10 = F_602 ( V_1233 , V_1226 ) ;
if ( V_10 ) {
F_225 ( & V_1233 -> V_11 , L_219 ) ;
goto V_1590;
}
V_1586 = F_603 ( V_1233 ) ;
if ( V_1586 <= 0 ) {
F_225 ( & V_1233 -> V_11 , L_220 ) ;
goto V_1591;
}
V_11 = F_592 ( & V_1233 -> V_11 , V_1233 , NULL ,
& V_1592 , F_604 ( V_1233 -> V_1593 ) ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1591;
}
...
V_1585 . V_1594 . V_1595 = F_605 ( V_1233 -> V_1596 ) ;
V_1585 . V_1594 . V_1596 = V_1233 -> V_1596 -> V_1597 ;
V_1585 . V_1594 . V_508 = F_606 ( V_1233 -> V_1593 ) ;
...
F_607 ( V_1233 , V_1586 + V_1599 , & V_1588 ) ;
V_1588 &= ~ V_1600 ;
V_1588 |= ( V_1601 |
V_1602 |
V_1603 |
V_1604 |
V_1605 ) ;
F_608 ( V_1233 , V_1586 + V_1599 , V_1588 ) ;
V_1587 = F_609 ( 44 ) ;
V_10 = F_610 ( V_1233 , V_1587 ) ;
if ( ! V_10 ) {
V_11 -> V_552 |= V_1606 ;
V_10 = F_611 ( V_1233 , V_1587 ) ;
if ( V_10 ) {
F_225 ( & V_1233 -> V_11 , L_221 ) ;
goto V_1607;
}
}
if ( V_10 ) {
V_10 = F_610 ( V_1233 , F_609 ( 32 ) ) ;
if ( V_10 ) {
F_225 ( & V_1233 -> V_11 , L_222 ) ;
goto V_1607;
}
}
F_598 ( V_11 ) ;
V_11 -> V_1608 |= V_1609 ;
V_4 -> V_1504 = F_612 ( V_1233 , 0 ) ;
if ( ! V_4 -> V_1504 ) {
F_225 ( & V_1233 -> V_11 , L_223 ) ;
V_10 = - V_506 ;
goto V_1607;
}
F_613 ( V_1233 ) ;
F_614 ( V_1233 ) ;
V_11 -> V_782 = V_1233 -> V_782 ;
F_596 ( V_11 ) ;
V_10 = F_551 ( V_4 ) ;
if ( V_10 ) {
if ( V_10 != - V_8 )
F_225 ( & V_1233 -> V_11 , L_224 ) ;
goto V_1610;
}
V_10 = F_615 ( V_11 ) ;
if ( V_10 ) {
F_225 ( & V_1233 -> V_11 , L_225 ) ;
goto V_1610;
}
F_616 ( V_1233 , V_11 ) ;
F_597 ( V_4 ) ;
...
static void T_13 F_621 ( struct V_1516 * V_1233 )
{
struct V_308 * V_11 = F_622 ( V_1233 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_400 ( V_11 ) ;
F_623 ( V_11 ) ;
if ( V_4 -> V_1504 ) {
...
static int F_624 ( struct V_1516 * V_1233 , T_17 V_1377 )
{
struct V_308 * V_11 = F_622 ( V_1233 ) ;
struct V_3 * V_4 = F_400 ( V_11 ) ;
unsigned long V_87 ;
...
static int F_627 ( struct V_1516 * V_1233 )
{
struct V_308 * V_11 = F_622 ( V_1233 ) ;
struct V_3 * V_4 = F_400 ( V_11 ) ;
unsigned long V_87 ;
...
static void * F_630 ( struct V_508 * V_11 , T_15 V_487 ,
T_1 * V_1611 , T_6 V_1564 )
{
unsigned long V_1612 = F_631 ( V_487 ) ;
unsigned long V_485 = F_632 ( V_1564 , V_1612 ) ;
if ( V_485 == 0UL )
return NULL ;
...
static void F_634 ( struct V_508 * V_11 , T_15 V_487 ,
void * V_1566 , T_1 V_1563 )
{
unsigned long V_1612 = F_631 ( V_487 ) ;
F_635 ( ( unsigned long ) V_1566 , V_1612 ) ;
}
...
static void F_638 ( struct V_508 * V_11 , T_1 V_1569 ,
T_15 V_487 , enum V_1567 V_1568 )
{
}
static T_1 F_639 ( struct V_508 * V_11 , void * V_1566 ,
T_15 V_487 ,
enum V_1567 V_1568 )
{
return F_633 ( V_1566 ) ;
}
static void F_640 ( struct V_508 * V_11 , T_1 V_1569 ,
T_15 V_487 ,
enum V_1567 V_1568 )
{
}
static int T_12 F_641 ( struct V_1522 * V_1523 )
{
union V_1549 V_1585 ;
struct V_308 * V_11 ;
struct V_3 * V_4 ;
...
if ( ! V_1 ) {
F_225 ( & V_1523 -> V_11 , L_227 ,
V_1523 -> V_11 . V_1525 -> V_1535 ) ;
return - V_8 ;
}
V_11 = F_592 ( & V_1523 -> V_11 , NULL , V_1523 ,
& V_1613 , V_1 [ 0 ] & 0x1 ) ;
if ( ! V_11 ) {
V_10 = - V_506 ;
goto V_1614;
...
V_4 = F_400 ( V_11 ) ;
memset ( & V_1585 , 0 , sizeof( V_1585 ) ) ;
V_1585 . V_1615 = F_642 ( V_1523 -> V_11 . V_1525 ) ;
V_4 -> V_25 = F_569 ( V_4 , & V_1585 ,
V_343 ) ;
if ( ! V_4 -> V_25 ) {
V_10 = - V_506 ;
...
F_598 ( V_11 ) ;
V_4 -> V_1504 = F_643 ( & V_1523 -> V_1616 [ 1 ] , 0 ,
F_644 ( & V_1523 -> V_1616 [ 1 ] ) ,
L_228 ) ;
if ( ! V_4 -> V_1504 ) {
F_225 ( & V_1523 -> V_11 , L_223 ) ;
V_10 = - V_506 ;
goto V_1607;
}
V_4 -> V_1617 = F_643 ( & V_1523 -> V_1616 [ 2 ] , 0 ,
F_644 ( & V_1523 -> V_1616 [ 2 ] ) ,
L_229 ) ;
if ( ! V_4 -> V_1617 ) {
F_225 ( & V_1523 -> V_11 , L_230 ) ;
V_10 = - V_506 ;
goto V_1610;
}
V_4 -> V_1618 = F_643 ( & V_1523 -> V_1616 [ 3 ] , 0 ,
F_644 ( & V_1523 -> V_1616 [ 3 ] ) ,
L_231 ) ;
if ( ! V_4 -> V_1618 ) {
F_225 ( & V_1523 -> V_11 , L_232 ) ;
V_10 = - V_506 ;
goto V_1610;
}
F_596 ( V_11 ) ;
...
if ( V_10 ) {
if ( V_10 != - V_8 )
F_225 ( & V_1523 -> V_11 , L_224 ) ;
goto V_1610;
}
V_10 = F_615 ( V_11 ) ;
if ( V_10 ) {
F_225 ( & V_1523 -> V_11 , L_225 ) ;
goto V_1610;
}
F_645 ( & V_1523 -> V_11 , V_11 ) ;
F_597 ( V_4 ) ;
return 0 ;
V_1610:
if ( V_4 -> V_1617 ) {
F_646 ( & V_1523 -> V_1616 [ 2 ] , V_4 -> V_1617 ,
F_644 ( & V_1523 -> V_1616 [ 2 ] ) ) ;
V_4 -> V_1617 = NULL ;
}
if ( V_4 -> V_1618 ) {
F_646 ( & V_1523 -> V_1616 [ 3 ] , V_4 -> V_1618 ,
F_644 ( & V_1523 -> V_1616 [ 3 ] ) ) ;
V_4 -> V_1618 = NULL ;
}
if ( V_4 -> V_1504 ) {
F_646 ( & V_1523 -> V_1616 [ 1 ] , V_4 -> V_1504 ,
F_644 ( & V_1523 -> V_1616 [ 1 ] ) ) ;
V_4 -> V_1504 = NULL ;
}
V_1607:
...
static int T_13 F_647 ( struct V_1522 * V_1523 )
{
struct V_308 * V_11 = F_648 ( & V_1523 -> V_11 ) ;
if ( V_11 ) {
struct V_3 * V_4 = F_400 ( V_11 ) ;
F_623 ( V_11 ) ;
if ( V_4 -> V_1617 ) {
...
F_575 ( V_4 ) ;
F_618 ( V_11 ) ;
F_645 ( & V_1523 -> V_11 , NULL ) ;
}
return 0 ;
}
static int T_18 F_649 ( void )
{
int V_10 = 0 ;
F_269 ( V_509 < 4 * 1024 ) ;
V_1573 = F_650 ( V_1619 , V_1620 ) ;
#ifdef F_541
V_10 = F_651 ( & V_1621 ) ;
#endif
if ( ! V_10 ) {
