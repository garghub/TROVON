...
static int F_63 ( struct V_66 * V_66 , void * V_169 , struct V_170 * V_171 )
{
struct V_33 * V_34 = F_37 ( V_66 ) ;
struct V_1 * V_2 = F_20 ( V_34 ) ;
struct V_96 * V_97 = & V_171 -> V_172 ;
struct V_170 V_173 = { . type = V_80 } ;
struct V_43 * V_12 = & V_2 -> V_12 ;
struct V_117 V_118 ;
struct V_136 V_137 = {
. V_138 = V_139 ,
...
V_118 . V_125 = V_12 -> V_16 ;
V_118 . V_126 = V_12 -> V_17 ;
V_173 . V_172 . V_16 = V_118 . V_130 . V_16 ;
V_173 . V_172 . V_17 = V_118 . V_130 . V_17 ;
...
V_171 -> V_176 . V_105 = 0 ;
V_171 -> V_176 . V_103 = 0 ;
V_171 -> V_176 . V_16 = V_104 ;
V_171 -> V_176 . V_17 = V_148 ;
V_171 -> V_177 . V_105 = 0 ;
V_171 -> V_177 . V_103 = 0 ;
...
static T_4 F_65 ( int V_181 , void * V_182 )
{
...
static int V_184 ;
static int V_185 ;
T_1 V_186 = F_5 ( V_2 , V_60 ) , V_187 ;
T_1 V_188 = F_5 ( V_2 , V_57 ) ;
if ( ! ( V_186 & 0x300 ) ) {
if ( F_66 ( & V_183 , 500 ) )
...
struct V_8 * V_196 = F_72 ( V_2 -> V_55 -> V_52 . V_58 ,
struct V_8 , V_52 ) ;
F_10 ( V_2 , V_196 ) ;
}
F_69 ( & V_2 -> V_63 ) ;
...
F_1 ( V_2 , V_60 , 0 ) ;
F_1 ( V_2 , V_199 , 0x101 ) ;
while ( -- V_123 && ( F_5 ( V_2 , V_199 ) & 0x101 ) )
F_74 ( 1 ) ;
if ( ! V_123 )
return - V_200 ;
...
static int F_82 ( struct V_66 * V_66 )
{
struct V_33 * V_34 = F_37 ( V_66 ) ;
struct V_1 * V_2 = F_20 ( V_34 ) ;
struct V_70 * V_71 = V_66 -> V_207 ;
F_22 ( V_71 -> V_72 . V_39 , L_2 , V_40 ) ;
if ( ! F_83 ( & V_2 -> V_208 ) ) {
V_2 -> V_53 = V_209 ;
...
static int F_85 ( struct V_66 * V_66 , struct V_212 * V_213 )
{
struct V_70 * V_71 = V_66 -> V_207 ;
F_22 ( V_71 -> V_72 . V_39 , L_2 , V_40 ) ;
return F_86 ( & V_71 -> V_72 , V_213 ) ;
}
static unsigned int F_87 ( struct V_66 * V_66 , T_5 * V_214 )
{
struct V_70 * V_71 = V_66 -> V_207 ;
F_22 ( V_71 -> V_72 . V_39 , L_2 , V_40 ) ;
return F_88 ( V_66 , & V_71 -> V_72 , V_214 ) ;
}
static int F_89 ( struct V_66 * V_66 , void * V_169 ,
struct V_215 * V_216 )
{
struct V_33 * V_34 = F_37 ( V_66 ) ;
struct V_1 * V_2 = F_20 ( V_34 ) ;
return F_44 ( & V_2 -> V_85 , 0 , V_217 , V_218 , V_216 ) ;
}
static int F_90 ( struct V_66 * V_66 , void * V_169 ,
struct V_219 * V_3 )
{
struct V_33 * V_34 = F_37 ( V_66 ) ;
struct V_1 * V_2 = F_20 ( V_34 ) ;
return F_44 ( & V_2 -> V_85 , 0 , V_217 , V_220 , V_3 ) ;
}
static int F_91 ( struct V_66 * V_66 , void * V_169 ,
struct V_219 * V_3 )
{
struct V_33 * V_34 = F_37 ( V_66 ) ;
struct V_1 * V_2 = F_20 ( V_34 ) ;
return F_44 ( & V_2 -> V_85 , 0 , V_217 , V_221 , V_3 ) ;
}
static int T_6 F_92 ( struct V_222 * V_223 )
{
struct V_197 * V_224 = V_223 -> V_39 . V_225 ;
struct V_96 * V_97 ;
struct V_43 * V_12 ;
struct V_226 * V_227 ;
struct V_33 * V_34 ;
...
struct V_231 * V_232 ;
int V_181 , V_45 ;
V_229 = F_93 ( V_223 , V_233 , 0 ) ;
V_181 = F_94 ( V_223 , 0 ) ;
if ( ! V_224 || ! V_229 || V_181 <= 0 ) {
F_95 ( & V_223 -> V_39 , L_23 ) ;
return - V_234 ;
}
...
V_12 -> V_42 = V_144 ;
V_12 -> V_238 = V_104 * 2 ;
V_12 -> V_239 = V_104 * 2 * 480 ;
V_12 -> V_141 = V_142 ;
V_230 = F_100 ( V_229 -> V_240 , F_101 ( V_229 ) ,
V_223 -> V_241 ) ;
if ( ! V_230 ) {
F_95 ( & V_223 -> V_39 , L_24 ) ;
V_45 = - V_242 ;
goto V_243;
}
V_2 -> V_5 = F_102 ( V_229 -> V_240 , F_101 ( V_229 ) ) ;
if ( ! V_2 -> V_5 ) {
V_45 = - V_206 ;
goto V_244;
}
V_45 = F_103 ( V_181 , F_65 , 0 , L_25 , V_2 ) ;
if ( V_45 < 0 )
goto V_245;
V_45 = F_104 ( & V_223 -> V_39 , & V_2 -> V_85 ) ;
if ( V_45 < 0 ) {
F_95 ( & V_223 -> V_39 , L_26 ) ;
goto V_246;
}
V_34 = F_105 () ;
if ( V_34 == NULL ) {
...
* V_34 = V_235 ;
if ( V_224 -> V_160 == V_161 )
V_34 -> V_165 |= V_248 ;
V_34 -> V_85 = & V_2 -> V_85 ;
V_34 -> V_249 = V_250 ;
V_34 -> V_63 = & V_2 -> V_211 ;
F_106 ( V_251 , & V_34 -> V_62 ) ;
V_2 -> V_34 = V_34 ;
F_107 ( V_34 , V_2 ) ;
F_108 ( & V_223 -> V_39 ) ;
F_109 ( & V_223 -> V_39 ) ;
V_227 = F_110 ( V_224 -> V_227 ) ;
if ( ! V_227 ) {
V_45 = - V_234 ;
goto V_252;
}
...
F_117 ( V_2 -> V_5 ) ;
V_244:
F_118 ( V_229 -> V_240 , F_101 ( V_229 ) ) ;
V_243:
F_84 ( V_2 ) ;
return V_45 ;
}
static int T_7 F_119 ( struct V_222 * V_223 )
{
int V_181 = F_94 ( V_223 , 0 ) ;
struct V_258 * V_85 = F_120 ( V_223 ) ;
struct V_1 * V_2 = F_121 ( V_85 ,
struct V_1 , V_85 ) ;
struct V_231 * V_259 = F_72 ( V_85 -> V_260 . V_58 ,
struct V_231 , V_261 ) ;
