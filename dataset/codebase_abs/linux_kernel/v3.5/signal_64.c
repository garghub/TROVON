...
V_14 |= F_27 ( & V_87 -> V_96 , NULL , ( unsigned long ) V_87 ) ;
if ( V_14 )
goto V_94;
...
static inline void T_2 * F_31 ( struct V_97 * V_98 , struct V_1 * V_2 , unsigned long V_99 )
{
unsigned long V_100 = V_2 -> V_5 [ V_93 ] + V_63 ;
if ( F_32 ( V_100 ) && ! F_33 ( F_32 ( V_100 - V_99 ) ) )
return ( void T_2 * ) - 1L ;
if ( V_98 -> V_101 . V_102 & V_103 ) {
if ( F_34 ( V_100 ) == 0 )
V_100 = V_79 -> V_104 + V_79 -> V_105 ;
}
V_100 -= V_99 ;
V_100 &= ~ 15UL ;
...
static inline int
F_35 ( struct V_97 * V_98 , struct V_1 * V_2 ,
int V_106 , T_4 * V_107 , T_9 * V_108 )
{
struct V_86 T_2 * V_87 ;
int V_109 , V_14 , V_110 ;
void T_2 * V_111 ;
F_15 () ;
F_36 () ;
V_109 = F_3 () ;
V_110 = sizeof( struct V_86 ) ;
if ( F_10 () -> V_81 [ 0 ] & V_82 )
V_110 += sizeof( T_7 ) ;
if ( V_109 )
V_110 += sizeof( T_8 ) ;
...
T_8 T_2 * V_89 = V_111 ;
V_111 += sizeof( T_8 ) ;
V_14 |= F_38 ( V_109 , V_89 ) ;
V_14 |= F_9 ( ( V_113 ) V_89 , & V_87 -> V_89 ) ;
F_39 ( 0 ) ;
} else {
V_14 |= F_9 ( 0 , & V_87 -> V_89 ) ;
}
V_14 |= F_9 ( V_79 -> V_104 , & V_87 -> V_96 . V_114 ) ;
V_14 |= F_9 ( F_34 ( V_2 -> V_5 [ V_93 ] ) , & V_87 -> V_96 . V_115 ) ;
V_14 |= F_9 ( V_79 -> V_105 , & V_87 -> V_96 . V_116 ) ;
V_14 |= F_18 ( & V_87 -> V_95 , V_107 , sizeof( T_4 ) ) ;
if ( ! V_109 ) {
V_14 |= F_40 ( ( V_113 T_2 * ) V_87 ,
( V_113 T_2 * ) ( V_2 -> V_5 [ V_93 ] +
V_63 ) ,
sizeof( struct V_62 ) ) ;
} else {
struct V_62 * V_117 ;
V_117 = & F_10 () -> V_62 [ V_109 - 1 ] ;
V_14 |= F_18 ( V_87 , V_117 , sizeof( struct V_62 ) ) ;
}
if ( V_108 )
V_14 |= F_41 ( & V_87 -> V_108 , V_108 ) ;
else {
V_14 |= F_9 ( V_106 , & V_87 -> V_108 . V_118 ) ;
V_14 |= F_9 ( V_119 , & V_87 -> V_108 . V_120 ) ;
}
if ( V_14 )
goto V_121;
V_2 -> V_5 [ V_93 ] = ( ( unsigned long ) V_87 ) - V_63 ;
V_2 -> V_5 [ V_6 ] = V_106 ;
V_2 -> V_5 [ V_20 ] = ( unsigned long ) & V_87 -> V_108 ;
V_2 -> V_5 [ V_48 ] = ( unsigned long ) & V_87 -> V_108 ;
V_2 -> V_26 = ( unsigned long ) V_98 -> V_101 . V_122 ;
V_2 -> V_27 = ( V_2 -> V_26 + 4 ) ;
if ( F_8 ( V_25 ) ) {
V_2 -> V_26 &= 0xffffffff ;
V_2 -> V_27 &= 0xffffffff ;
}
V_2 -> V_5 [ V_58 ] = ( unsigned long ) V_98 -> V_123 ;
return 0 ;
V_112:
F_42 ( V_124 ) ;
return - V_125 ;
...
static inline void F_44 ( unsigned long V_127 , struct V_97 * V_98 ,
T_9 * V_108 ,
T_4 * V_107 , struct V_1 * V_2 )
{
int V_14 ;
V_14 = F_35 ( V_98 , V_2 , V_127 , V_107 ,
( V_98 -> V_101 . V_102 & V_128 ) ? V_108 : NULL ) ;
if ( V_14 )
return;
F_45 ( V_127 , V_108 , V_98 , V_2 , 0 ) ;
}
...
#endif
V_127 = F_51 ( & V_108 , & V_98 , V_2 , NULL ) ;
V_140 = 0 ;
if ( F_49 ( V_2 ) &&
( V_2 -> V_10 & ( V_136 | V_135 ) ) ) {
V_140 = 1 ;
...
if ( V_127 > 0 ) {
if ( V_140 )
F_46 ( V_129 , V_2 , & V_98 . V_101 ) ;
F_44 ( V_127 , & V_98 , & V_108 , V_107 , V_2 ) ;
return;
}
if ( V_140 &&
( V_2 -> V_5 [ V_6 ] == V_132 ||
