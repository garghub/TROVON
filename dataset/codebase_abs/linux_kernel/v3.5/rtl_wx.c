...
F_71 ( V_2 , V_186 , V_186 , V_187 , V_182 , 0 , V_146 ) ;
F_72 ( V_2 , V_186 , V_186 , V_187 , V_182 , 0 , V_146 , 0 ) ;
} else if ( V_188 ) {
V_21 -> V_156 = V_187 ;
F_71 ( V_2 , V_186 , V_186 , V_187 , V_181 , 0 , V_146 ) ;
F_72 ( V_2 , V_186 , V_186 , V_187 , V_181 , 0 ,
V_146 , 0 ) ;
} else {
if ( ( V_21 -> V_155 == V_191 ) &&
V_21 -> V_197 -> V_198 )
F_82 ( V_2 , 0x173 , 1 ) ;
F_71 ( V_2 , 4 , V_186 , V_187 , ( T_1 * ) V_21 -> V_199 ,
0 , V_146 ) ;
...
return 0 ;
F_9 ( & V_9 -> V_15 ) ;
V_13 = F_84 ( V_9 -> V_10 , V_11 , & ( V_56 -> V_200 ) , V_12 ) ;
F_11 ( & V_9 -> V_15 ) ;
return V_13 ;
}
...
static struct V_210 * F_94 ( struct V_1 * V_2 )
{
struct V_8 * V_9 = F_2 ( V_2 ) ;
struct V_20 * V_21 = V_9 -> V_10 ;
...
V_211 -> V_63 . V_64 = 0 ;
V_211 -> V_63 . V_65 = - 100 ;
V_211 -> V_63 . V_66 = V_215 | V_216 ;
return V_211 ;
}
V_212 = ( & V_21 -> V_122 ) -> V_217 . V_218 ;
V_213 = ( & V_21 -> V_122 ) -> V_217 . signal ;
V_214 = ( & V_21 -> V_122 ) -> V_217 . V_65 ;
V_211 -> V_63 . V_64 = V_212 ;
V_211 -> V_63 . V_63 = V_213 ;
V_211 -> V_63 . V_65 = V_214 ;
V_211 -> V_63 . V_66 = V_215 | V_216 ;
return V_211 ;
}
